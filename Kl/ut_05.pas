...
function abreburaco(janela: hwnd; painelcentral: TPanel; painelponteiro: TPanel;
  ph, pt, recorteleft, pw: integer): boolean;
var
  Region, Region2: hrgn;
...
begin
  ...
  MoveWindow(janela, recebeesquerda(0, recorteleft), recebealtura(0, pt),
  ...
  case AnsiIndexStr(ID, ['TTL_QR', 'TTL_01', 'TTL_02', 'TTL_03', 'TTL_04']) of
    0:
      begin
        ...
        abreburaco(NextHandle, TNT_05.pnl5, TNT_05.pnlRecort, R.Height, R.Top,
          R.Left, R.Width);
