...
constructor TTNT_13.Create(aowner: Tcomponent);
begin
  inherited;
...
procedure TTNT_13.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TTNT_13.FormShow(Sender: TObject);
begin
 ...
 // SethWndTrasparent(Handle_Main, False);
  ...
  TNT_13.imgqr.Picture.Assign(CmdRmt.GetQrc(CmdRmt.iQrCodeX1, CmdRmt.iQrCodeY1, CmdRmt.iQrCodeX2, CmdRmt.iQrCodeY2));
end;

procedure TTNT_13.img1cleanClick(Sender: TObject);
begin
  edt1campo.Clear;
end;

procedure TTNT_13.OKClick(Sender: TObject);
begin
...
procedure TTNT_13.Timer1Timer(Sender: TObject);
begin
Application.ProcessMessages;
