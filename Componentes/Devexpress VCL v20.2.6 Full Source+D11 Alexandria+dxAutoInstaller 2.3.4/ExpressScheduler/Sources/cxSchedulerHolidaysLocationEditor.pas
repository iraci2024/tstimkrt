...
type
  ...
  public
    ...
    property Location: TcxSchedulerHolidaysLocation read FLocation
      write SetLocation;
...
procedure TfmHolidaysLocationEditor.SetLocation(const AValue
  : TcxSchedulerHolidaysLocation);
begin
  FLocation := AValue;
end;

procedure TfmHolidaysLocationEditor.teLocationPropertiesChange(Sender: TObject);
begin
  FModify := True;
  CheckButtonsState;
end;
