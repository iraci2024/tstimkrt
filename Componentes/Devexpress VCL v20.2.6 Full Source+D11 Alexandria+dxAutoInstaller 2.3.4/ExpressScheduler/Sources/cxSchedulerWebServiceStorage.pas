...
type
  ...
  TdxWebServiceEventStartDateComparer = class(TInterfacedObject,
    IComparer<IdxWebServiceEvent>)
  strict private
  ...
  TdxWebServiceCustomEvent = class abstract(TInterfacedObject,
    IdxWebServiceEvent)
  strict private
  ...
  protected
    ...
    property Provider: TcxSchedulerWebServiceStorageCustomProvider
      read FProvider;
  public
  ...
  protected
    ...
    procedure UpdateRecurrenceIndex(APattern
      : TcxSchedulerWebServiceEvent); overload;
  ...
  TdxWebServiceEventPatternList = class
    (TDictionary<string, TcxSchedulerWebServiceEvent>);

  { TcxSchedulerWebServiceStorageProviderCustomTask }

  TcxSchedulerWebServiceStorageProviderCustomTask = class abstract
    (TInterfacedObject, IdxTask)
  strict private
    FCalendarID: string;
    FHasError: Boolean;
    FHeader: string;
  ...
  protected
    ...
    procedure RunNewTask(const ATask
      : TcxSchedulerWebServiceStorageProviderCustomTask);
  ...
  TcxSchedulerWebServiceStorageProviderSyncEventsCustomTask = class abstract
    (TcxSchedulerWebServiceStorageProviderCustomTask)
  strict private
  ...
  protected
    ...
    function ProcessEvent(const AEvent: IdxWebServiceEvent)
      : TdxTaskCompletedStatus; virtual;
  ...
  TcxSchedulerWebServiceStorageProviderEventCustomTask = class abstract
    (TcxSchedulerWebServiceStorageProviderCustomTask)
  strict private
  ...
  protected
    ...
    function JSONToEventList(const AObject: TdxJSONObject;
      var ASuccess: Boolean): TdxWebServiceEventList;
    function ToJSONObject: TdxJSONObject; overload;
    function ToJSONObject(const AEvent: IdxWebServiceEvent)
      : TdxJSONObject; overload;
  ...
  public
    ...
    constructor Create(AEvent: TcxSchedulerWebServiceEvent;
      const AWebServiceEvent: IdxWebServiceEvent); overload;
    destructor Destroy; override;
  end;

  { TcxSchedulerWebServiceStorageProviderUpdateEventCustomTask }

  TcxSchedulerWebServiceStorageProviderUpdateEventCustomTask = class abstract
    (TcxSchedulerWebServiceStorageProviderEventCustomTask)
  protected
    procedure DoApplyChanges; override;
  end;
  ...
  TcxSchedulerWebServiceStorageProviderDeleteEventCustomTask = class abstract
    (TcxSchedulerWebServiceStorageProviderEventCustomTask)
  protected
    function CanProcessing: Boolean; override;
    procedure DoApplyChanges; override;
  ...
  TcxSchedulerWebServiceStorageProviderModifyEventCustomTask = class abstract
    (TcxSchedulerWebServiceStorageProviderEventCustomTask)
  protected
    procedure DoApplyChanges; override;
  ...
  TcxSchedulerWebServiceStorageProviderPostEventCustomTask = class abstract
    (TcxSchedulerWebServiceStorageProviderModifyEventCustomTask);

    { TcxSchedulerWebServiceStorageCustomProvider }

    TcxSchedulerWebServiceStorageCustomProvider = class abstract
      (TInterfacedPersistent)strict private FAuthorizationAgent
  ...
  protected
    ...
    function CreateDeleteEventTask(AEvent: TcxSchedulerWebServiceEvent)
      : TcxSchedulerWebServiceStorageProviderCustomTask; overload;
    function CreateDeleteEventTask(AEvent: TcxSchedulerWebServiceEvent;
      const AWebServiceEvent: IdxWebServiceEvent)
      : TcxSchedulerWebServiceStorageProviderCustomTask; overload; virtual;
    ...
    function CreatePostEventTask(AEvent: TcxSchedulerWebServiceEvent)
      : TcxSchedulerWebServiceStorageProviderCustomTask; virtual;
    function CreateSyncEventsTask
      : TcxSchedulerWebServiceStorageProviderSyncEventsCustomTask; virtual;
    ...
    procedure PopulateCalendarList(const AList
      : TdxWebServiceCalendarList); virtual;
    ...
    function CreateWebServiceEvent(AEvent: TcxSchedulerWebServiceEvent)
      : IdxWebServiceEvent; overload;

    function AddNewEvent(const AWebServiceEvent: IdxWebServiceEvent)
      : TcxSchedulerWebServiceEvent;
    procedure ClearEvents;
    function FindEvent(const ACloudId: string;
  ...
  TcxSchedulerWebServiceStorageCustomProviderClass = class of
    TcxSchedulerWebServiceStorageCustomProvider;

  { TcxSchedulerWebServiceStorageOAuth2CustomProvider }

  TcxSchedulerWebServiceStorageOAuth2CustomProvider = class abstract
    (TcxSchedulerWebServiceStorageCustomProvider,
...
{$ENDREGION}
  ...
  TcxSchedulerWebServiceStorageDataController = class
  ...
  strict private
    ...
    procedure SetProvider(const Value
      : TcxSchedulerWebServiceStorageCustomProvider);
  ...
  public
    ...
    property ProviderClass: TcxSchedulerWebServiceStorageCustomProviderClass
      read FProviderClass write SetProviderClass;
    property Parent;
    property Resources: TcxSchedulerWebServiceStorageResources
      read GetResources;
  published
    ...
    property Provider: TcxSchedulerWebServiceStorageCustomProvider
      read FProvider write SetProvider;
  end;
  ...
  private
    function GetItem(Index: Integer)
      : TcxSchedulerWebServiceStorageResourceItem; inline;
    function GetResources: TcxSchedulerWebServiceStorageResources; inline;
    function GetStorage: TcxSchedulerWebServiceStorage; inline;
    function GetVisibleResource(Index: Integer)
      : TcxSchedulerWebServiceStorageResourceItem; inline;
    procedure SetItem(Index: Integer;
      const Value: TcxSchedulerWebServiceStorageResourceItem); inline;
  protected
    property Resources: TcxSchedulerWebServiceStorageResources
      read GetResources;
    property Storage: TcxSchedulerWebServiceStorage read GetStorage;
  public
    constructor Create(AOwner: TcxSchedulerWebServiceStorageResources);
      reintroduce;
    function Add: TcxSchedulerWebServiceStorageResourceItem;
    property Items[Index: Integer]: TcxSchedulerWebServiceStorageResourceItem
      read GetItem write SetItem; default;
    property VisibleResources[Index: Integer]
      : TcxSchedulerWebServiceStorageResourceItem read GetVisibleResource;
  end;
  ...
  strict private
    ...
    function GetStorage: TcxSchedulerWebServiceStorage; inline;
    procedure SetItems(const Value
      : TcxSchedulerWebServiceStorageResourceItems); inline;
  protected
    function CreateItems: TcxSchedulerStorageResourceItems; override;
    property Storage: TcxSchedulerWebServiceStorage read GetStorage;
  published
    property Items: TcxSchedulerWebServiceStorageResourceItems read GetItems
      write SetItems;
  end;
  ...
  protected
    ...
    property SchedulerWebServiceEvent: TcxSchedulerWebServiceEvent
      read GetSchedulerWebServiceEvent;
    property Provider: TcxSchedulerWebServiceStorageCustomProvider
      read GetProvider;
  end;
  ...
  public type
    TProviderErrorEvent = procedure(Sender: TObject;
      AProvider: TcxSchedulerWebServiceStorageCustomProvider;
      const AErrorObject) of object;
  private
  ...
  strict private
    ...
    function GetDataController
      : TcxSchedulerWebServiceStorageDataController; inline;
    function GetResources: TcxSchedulerWebServiceStorageResources; inline;
    procedure SetResources(const Value: TcxSchedulerWebServiceStorageResources);
  protected
    class procedure RegisterProvider(AProviderClass
      : TcxSchedulerWebServiceStorageCustomProviderClass); static;
    class procedure UnregisterProvider(AProviderClass
      : TcxSchedulerWebServiceStorageCustomProviderClass); static;
    ...
    procedure DoProviderError(AProvider
      : TcxSchedulerWebServiceStorageCustomProvider;
      const AErrorObject); virtual;

    procedure SynchronizeEvent(AEvent: TcxSchedulerWebServiceEvent;
      const AWebServiceEvent: IdxWebServiceEvent);
    procedure SynchronizeWebServiceEvents(AList: TdxWebServiceEventDictionary;
      AProvider: TcxSchedulerWebServiceStorageCustomProvider);
    procedure UpdateOccurrences(AEvent: TcxSchedulerWebServiceEvent);

    property DataController: TcxSchedulerWebServiceStorageDataController
  ...
  public
    ...
    function CreateProvider(AClass
      : TcxSchedulerWebServiceStorageCustomProviderClass)
      : TcxSchedulerWebServiceStorageCustomProvider;
    ...
    class property RegisteredCalendarProviders: TcxRegisteredClasses
      read GetRegisteredCalendarProviders;
  published
    property Holidays;
    property Reminders;
    property Resources: TcxSchedulerWebServiceStorageResources read GetResources
      write SetResources;
    property OnProviderError: TProviderErrorEvent read FOnProviderError
      write FOnProviderError;
  end;
...
function TdxWebServiceCalendarList.FindByID(const ID: string)
  : TdxWebServiceCalendar;
var
  I: Integer;
begin
...
function TdxWebServiceCalendarList.FindByName(const AName: string)
  : TdxWebServiceCalendar;
var
  I: Integer;
begin
...
function TdxWebServiceEventStartDateComparer.Compare(const Left,
  Right: IdxWebServiceEvent): Integer;
begin
...
constructor TdxWebServiceCustomEvent.Create
  (AProvider: TcxSchedulerWebServiceStorageCustomProvider);
begin
  inherited Create;
  FProvider := AProvider;
...
procedure TdxWebServiceCustomEvent.AssignFrom
...
procedure TdxWebServiceCustomEvent.AssignTo
  (AEvent: TcxSchedulerWebServiceEvent);
var
  I: Integer;
  AReminder: TDateTime;
...
procedure TdxWebServiceCustomEvent.DoAssignFrom
  (AEvent: TcxSchedulerWebServiceEvent);
begin
  // do nothing
end;

procedure TdxWebServiceCustomEvent.DoAssignTo
  (AEvent: TcxSchedulerWebServiceEvent);
begin
  // do nothing
end;
...
constructor TcxSchedulerWebServiceStorageCustomProvider.Create
...
procedure TcxSchedulerWebServiceStorageCustomProvider.Assign
  (Source: TPersistent);
var
...
procedure TcxSchedulerWebServiceStorageCustomProvider.FreeNotificationHandler
  (Sender: TComponent);
begin
...
class function TcxSchedulerWebServiceStorageCustomProvider.
...
function TcxSchedulerWebServiceStorageCustomProvider.GetCalendarList
  : TdxWebServiceCalendarList;
begin
...
procedure TcxSchedulerWebServiceStorageCustomProvider.UpdateOccurrences
  (AEvent: TcxSchedulerWebServiceEvent);
begin
  // do nothing
end;

procedure TcxSchedulerWebServiceStorageCustomProvider.
...
function TcxSchedulerWebServiceStorageCustomProvider.GetJSONObject
  (const AUri: string): TdxJSONObject;
begin
  Result := TdxHttpHelper.GetRequest(AuthorizationAgent.UserAgent, AUri,
    GetHeader);
end;

function TcxSchedulerWebServiceStorageCustomProvider.GetWebServiceEventClass
...
begin
  Result := (AuthorizationAgent <> nil) and TdxCustomAuthorizationAgentAccess
    (AuthorizationAgent).IsReady and HasCalendarId;
end;

procedure TcxSchedulerWebServiceStorageCustomProvider.DismissEvent
...
procedure TcxSchedulerWebServiceStorageCustomProvider.AddTask
  (ATask: TcxSchedulerWebServiceStorageProviderCustomTask);
begin
  Owner.Tasks.Run(ATask);
end;

function TcxSchedulerWebServiceStorageCustomProvider.JSONToWebServiceEvent
  (AItem: TdxJSONValue): IdxWebServiceEvent;
begin
...
function TcxSchedulerWebServiceStorageCustomProvider.CreateSyncEventsTask
  : TcxSchedulerWebServiceStorageProviderSyncEventsCustomTask;
begin
  dxAbstractError;
  Result := nil;
...
class function TcxSchedulerWebServiceStorageCustomProvider.GetJSONItemArray
  (AList: TdxJSONObject): TdxJSONArray;
var
  APair: TdxJSONPair;
begin
...
function TcxSchedulerWebServiceStorageCustomProvider.CreateWebServiceEvent
  : IdxWebServiceEvent;
begin
  Result := GetWebServiceEventClass.Create(Self);
end;
...
function TcxSchedulerWebServiceStorageCustomProvider.CreateWebServiceEvent
  (AEvent: TcxSchedulerWebServiceEvent): IdxWebServiceEvent;
begin
  Result := CreateWebServiceEvent;
  Result.AssignFrom(AEvent);
end;

function TcxSchedulerWebServiceStorageCustomProvider.AddNewEvent
  (const AWebServiceEvent: IdxWebServiceEvent): TcxSchedulerWebServiceEvent;
begin
  BeginSynchronize;
  try
...
function TcxSchedulerWebServiceStorageCustomProvider.FindEvent
  (const ACloudId: string; out AEvent: TcxSchedulerWebServiceEvent): Boolean;
var
  I: Integer;
begin
  Result := False;
...
procedure TcxSchedulerWebServiceStorageCustomProvider.
  SynchronizeWebServiceEvents(AList: TdxWebServiceEventDictionary);
begin
  if not Owner.IsDestroying then
    Owner.SynchronizeWebServiceEvents(AList, Self);
end;

procedure TcxSchedulerWebServiceStorageCustomProvider.DoError
  (const AErrorObject);
begin
...
procedure TcxSchedulerWebServiceStorageCustomProvider.SetAuthorizationAgent
...
procedure TcxSchedulerWebServiceStorageCustomProvider.SetReadOnly
  (const Value: Boolean);
var
  AValue: Boolean;
begin
...
procedure TcxSchedulerWebServiceStorageCustomProvider.SetCalendarID
  (const Value: string);
var
  AList: TdxWebServiceCalendarList;
  AOldCalendarID: string;
...
function TcxSchedulerWebServiceStorageOAuth2CustomProvider.
  IsAuthorizedValid: Boolean;
begin
  AuthorizationAgent.ValidateAccessToken;
  Result := AuthorizationAgent.IsAccessTokenValid;
end;

procedure TcxSchedulerWebServiceStorageOAuth2CustomProvider.
  SubscribeAuthorizationAgent;
begin
...
begin
  Result := TdxHttpHelper.ContentTypeJSONHeader + #13#10 +
    AuthorizationAgent.GetAuthorizationHeader;
end;

function TcxSchedulerWebServiceStorageOAuth2CustomProvider.GetScopes
  : TStringList;
begin
  dxAbstractError;
  Result := nil;
...
function TcxSchedulerWebServiceStorageOAuth2CustomProvider.GetAuthorizationAgent
...
procedure TcxSchedulerWebServiceStorageOAuth2CustomProvider.
  SetAuthorizationAgent(const Value: TdxOAuth2AuthorizationAgent);
begin
...
begin
  Result := inherited GetReadOnly or (Provider = nil) or not Provider.Connected;
end;
...
procedure TcxSchedulerWebServiceEvent.UpdateRecurrenceIndex
  (APattern: TcxSchedulerWebServiceEvent);
var
  ADate: TDate;
begin
  if not IsOccurrence then
  ...
  with TcxSchedulerEventRecurrenceInfoAccess(RecurrenceInfo)
...
function TcxSchedulerWebServiceEvent.GetProvider
  : TcxSchedulerWebServiceStorageCustomProvider;
var
...
constructor TcxSchedulerWebServiceStorageProviderCustomTask.Create
  (AProvider: TcxSchedulerWebServiceStorageCustomProvider);
begin
  inherited Create;
  FProvider := AProvider;
...
function TcxSchedulerWebServiceStorageProviderCustomTask.Run(const ACancelStatus
...
procedure TcxSchedulerWebServiceStorageProviderCustomTask.OnComplete
...
function TcxSchedulerWebServiceStorageProviderCustomTask.
...
procedure TcxSchedulerWebServiceStorageProviderCustomTask.MainThreadSynchronize
...
function TcxSchedulerWebServiceStorageProviderCustomTask.DoExecute
  : TdxTaskCompletedStatus;
begin
  dxAbstractError;
  Result := TdxTaskCompletedStatus.Fail;
...
constructor TcxSchedulerWebServiceStorageProviderEventCustomTask.Create
  (AEvent: TcxSchedulerWebServiceEvent);
begin
...
function TcxSchedulerWebServiceStorageProviderEventCustomTask.
  CanApplyChanges: Boolean;
begin
...
function TcxSchedulerWebServiceStorageProviderEventCustomTask.DoExecute
  : TdxTaskCompletedStatus;
var
...
procedure TcxSchedulerWebServiceStorageProviderEventCustomTask.
  RunDeleteEventTask(const AEvent: IdxWebServiceEvent);
begin
  RunNewTask(Provider.CreateDeleteEventTask(Event, AEvent));
end;

procedure TcxSchedulerWebServiceStorageProviderEventCustomTask.
  RunModifyEventTask(const AEvent: IdxWebServiceEvent);
begin
...
function TcxSchedulerWebServiceStorageProviderEventCustomTask.JSONToEventList
  (const AObject: TdxJSONObject; var ASuccess: Boolean): TdxWebServiceEventList;
var
  AItems: TdxJSONArray;
  AItem: TdxJSONValue;
  I: Integer;
...
function TcxSchedulerWebServiceStorageProviderEventCustomTask.Process
  : TdxJSONObject;
begin
  dxAbstractError;
  Result := nil;
...
function TcxSchedulerWebServiceStorageProviderEventCustomTask.ToJSONObject
  : TdxJSONObject;
begin
...
function TcxSchedulerWebServiceStorageProviderEventCustomTask.ToJSONObject
  (const AEvent: IdxWebServiceEvent): TdxJSONObject;
var
...
procedure TcxSchedulerWebServiceStorageProviderUpdateEventCustomTask.
  DoApplyChanges;
begin
  if Modified and (WebServiceEvent.IsOccurrence or
    not WebServiceEvent.IsCancelled) then
    Provider.Owner.SynchronizeEvent(Event, WebServiceEvent)
  else if Link.Ref <> nil then
    Provider.Owner.DoDeleteEvent(Event);
end;

{ TcxSchedulerWebServiceStorageProviderDeleteEventCustomTask }

function TcxSchedulerWebServiceStorageProviderDeleteEventCustomTask.
  CanProcessing: Boolean;
begin
  Result := inherited CanProcessing or (not WebServiceEvent.IsOccurrence and
    (WebServiceEvent.GetID <> ''));
end;

procedure TcxSchedulerWebServiceStorageProviderDeleteEventCustomTask.
  DoApplyChanges;
begin
...
procedure TcxSchedulerWebServiceStorageProviderModifyEventCustomTask.
  DoApplyChanges;
begin
  if Modified then
    ModifyEvent
...
procedure TcxSchedulerWebServiceStorageProviderSyncEventsCustomTask.
  DoApplyChanges;
begin
  Provider.SynchronizeWebServiceEvents(FList);
end;

function TcxSchedulerWebServiceStorageProviderSyncEventsCustomTask.DoExecute
  : TdxTaskCompletedStatus;
begin
  BeforeProcess;
  repeat
...
function TcxSchedulerWebServiceStorageProviderSyncEventsCustomTask.CanAddEvent
  (const AEvent: IdxWebServiceEvent): Boolean;
begin
  Result := AEvent.IsOccurrence or not AEvent.IsCancelled;
end;

function TcxSchedulerWebServiceStorageProviderSyncEventsCustomTask.GetItemArray
  (AList: TdxJSONObject): TdxJSONArray;
begin
  Result := Provider.GetJSONItemArray(AList);
end;

function TcxSchedulerWebServiceStorageProviderSyncEventsCustomTask.
...
function TcxSchedulerWebServiceStorageProviderSyncEventsCustomTask.
  IsItemListValid(AList: TdxJSONObject): Boolean;
begin
  Result := CanProcessing and Provider.IsItemListValid(AList);
end;

function TcxSchedulerWebServiceStorageProviderSyncEventsCustomTask.IsItemValid
  (AItem: TdxJSONValue): Boolean;
begin
...
function TcxSchedulerWebServiceStorageProviderSyncEventsCustomTask.ItemToEvent
  (AItem: TdxJSONValue): IdxWebServiceEvent;
var
  AResult: IdxWebServiceEvent;
begin
...
function TcxSchedulerWebServiceStorageProviderSyncEventsCustomTask.ProcessEvent
  (const AEvent: IdxWebServiceEvent): TdxTaskCompletedStatus;
begin
...
function TcxSchedulerWebServiceStorageProviderSyncEventsCustomTask.Process
  : TdxTaskCompletedStatus;
var
...
function TcxSchedulerWebServiceStorageProviderSyncEventsCustomTask.Process
  (AObject: TdxJSONObject): TdxTaskCompletedStatus;
var
  AItems: TdxJSONArray;
begin
...
function TcxSchedulerWebServiceStorageProviderSyncEventsCustomTask.ProcessItems
  (AItems: TdxJSONArray): TdxTaskCompletedStatus;
var
  AItem: TdxJSONValue;
  I: Integer;
  AEvent: IdxWebServiceEvent;
...
function TcxSchedulerWebServiceStorageDataController.GetStorage
  : TcxSchedulerWebServiceStorage;
begin
  Result := TcxSchedulerWebServiceStorage(inherited Storage);
end;
...
constructor TcxSchedulerWebServiceStorageResourceItem.Create
...
begin
  Result := (Provider <> nil) and ((inherited CanModify and Provider.Connected)
    or Resources.Storage.IsSynchronizing);
end;
...
procedure TcxSchedulerWebServiceStorageResourceItem.SetReadOnly
...
procedure TcxSchedulerWebServiceStorageResourceItem.SetResourceID
...
function TcxSchedulerWebServiceStorageResourceItem.GetResources
  : TcxSchedulerWebServiceStorageResources;
begin
...
begin
  if ProviderClassName <> Value then
    ProviderClass := TcxSchedulerWebServiceStorageCustomProviderClass
      (TcxSchedulerWebServiceStorage.RegisteredCalendarProviders.
...
function TcxSchedulerWebServiceStorageResourceItems.Add
  : TcxSchedulerWebServiceStorageResourceItem;
begin
  Result := TcxSchedulerWebServiceStorageResourceItem(inherited Add);
end;

function TcxSchedulerWebServiceStorageResourceItems.GetItem(Index: Integer)
  : TcxSchedulerWebServiceStorageResourceItem;
begin
  Result := TcxSchedulerWebServiceStorageResourceItem(inherited Items[Index]);
end;

function TcxSchedulerWebServiceStorageResourceItems.GetResources
  : TcxSchedulerWebServiceStorageResources;
begin
  Result := TcxSchedulerWebServiceStorageResources(inherited Resources)
end;

function TcxSchedulerWebServiceStorageResourceItems.GetStorage
  : TcxSchedulerWebServiceStorage;
begin
  Result := TcxSchedulerWebServiceStorage(inherited Storage);
end;
...
begin
  Result := TcxSchedulerWebServiceStorageResourceItem
    (inherited VisibleResources[Index]);
end;
...
function TcxSchedulerWebServiceStorageResources.CreateItems
  : TcxSchedulerStorageResourceItems;
begin
  Result := TcxSchedulerWebServiceStorageResourceItems.Create(Self);
end;

function TcxSchedulerWebServiceStorageResources.GetItems
  : TcxSchedulerWebServiceStorageResourceItems;
begin
  Result := TcxSchedulerWebServiceStorageResourceItems(inherited Items);
end;

function TcxSchedulerWebServiceStorageResources.GetStorage
  : TcxSchedulerWebServiceStorage;
begin
  Result := TcxSchedulerWebServiceStorage(inherited Storage);
end;
...
procedure TcxSchedulerWebServiceReminder.SnoozeEvent(const ASnoozeTime
  : TDateTime);
begin
  inherited SnoozeEvent(ASnoozeTime);
end;

function TcxSchedulerWebServiceReminder.GetSchedulerWebServiceEvent
  : TcxSchedulerWebServiceEvent;
begin
  Result := TcxSchedulerWebServiceEvent(Event.Source);
end;

function TcxSchedulerWebServiceReminder.GetProvider
  : TcxSchedulerWebServiceStorageCustomProvider;
begin
...
function TcxSchedulerWebServiceReminders.GetReminderClass
  : TcxSchedulerReminderClass;
begin
...
function TcxSchedulerWebServiceStorage.CreateProvider
  (AClass: TcxSchedulerWebServiceStorageCustomProviderClass)
  : TcxSchedulerWebServiceStorageCustomProvider;
begin
  Result := AClass.Create(Self);
end;

class function TcxSchedulerWebServiceStorage.GetRegisteredCalendarProviders
...
function TcxSchedulerWebServiceStorage.GetResources
  : TcxSchedulerWebServiceStorageResources;
begin
  Result := TcxSchedulerWebServiceStorageResources(inherited Resources);
end;

procedure TcxSchedulerWebServiceStorage.DoDeleteEvent
...
begin
  RegisteredCalendarProviders.Register(AProviderClass,
    AProviderClass.GetDisplayName);
end;
...
function TcxSchedulerWebServiceStorage.CreateResources
  : TcxSchedulerStorageResources;
begin
  Result := TcxSchedulerWebServiceStorageResources.Create(Self);
end;

function TcxSchedulerWebServiceStorage.GetDataControllerClass
...
procedure TcxSchedulerWebServiceStorage.UpdateOccurrences
  (AEvent: TcxSchedulerWebServiceEvent);
var
  AProvider: TcxSchedulerWebServiceStorageCustomProvider;
begin
...
procedure TcxSchedulerWebServiceStorage.SynchronizeEvent
  (AEvent: TcxSchedulerWebServiceEvent;
const AWebServiceEvent: IdxWebServiceEvent);
begin
  BeginSynchronize;
...
procedure TcxSchedulerWebServiceStorage.PostEditingData
  (AEvent: TcxSchedulerEvent);
begin
  ModifyEvent(AEvent);
...
procedure TcxSchedulerWebServiceStorage.SynchronizeWebServiceEvents
  (AList: TdxWebServiceEventDictionary;
AProvider: TcxSchedulerWebServiceStorageCustomProvider);
var
...
function TcxSchedulerWebServiceStorage.GetEvents
...
begin
  for I := 0 to ResourceCount - 1 do
    if (VarIsNull(AResourceID) or VarIsArray(AResourceID) or
      (ResourceIDs[I] = AResourceID)) and (Resources.Items[I].Provider <> nil)
    then
      Resources.Items[I].Provider.OccurrencesCheckedTimeBoundsChanged
        (AStart, AFinish);
...
procedure TcxSchedulerWebServiceStorage.DoProviderError
  (AProvider: TcxSchedulerWebServiceStorageCustomProvider; const AErrorObject);
begin
  if Assigned(FOnProviderError) then
    FOnProviderError(Self, AProvider, AErrorObject);
end;

function TcxSchedulerWebServiceStorage.GetDataController
  : TcxSchedulerWebServiceStorageDataController;
begin
  Result := TcxSchedulerWebServiceStorageDataController
