...
{$IFDEF DELPHI16}
  UITypes,
{$ENDIF}
  Classes, Windows, Forms, SysUtils, Registry, Controls, Graphics, Math,
  ImgList,
  Types, DateUtils, dxCoreClasses,
  dxCore, cxGraphics, cxGeometry, cxStyles, cxLookAndFeels,
...
ComboBoxTimeIntervals:
array [1 .. 25] of record P: Pointer;
M:
Integer
end
= ((P: @scxTime0m; M: 0), (P: @scxTime5m; M: 5), (P: @scxTime10m; M: 10),
  (P: @scxTime15m; M: 15), (P: @scxTime20m; M: 20), (P: @scxTime30m; M: 30),
  (P: @scxTime1h; M: MinsPerHour), (P: @scxTime2h; M: 2 * MinsPerHour),
  (P: @scxTime3h; M: 3 * MinsPerHour), (P: @scxTime4h; M: 4 * MinsPerHour),
  (P: @scxTime5h; M: 5 * MinsPerHour), (P: @scxTime6h; M: 6 * MinsPerHour),
  (P: @scxTime7h; M: 7 * MinsPerHour), (P: @scxTime8h; M: 8 * MinsPerHour),
  (P: @scxTime9h; M: 9 * MinsPerHour), (P: @scxTime10h; M: 10 * MinsPerHour),
  (P: @scxTime11h; M: 11 * MinsPerHour), (P: @scxTime12h; M: 12 * MinsPerHour),
  (P: @scxTime18h; M: 18 * MinsPerHour), (P: @scxTime1d; M: MinsPerDay),
  (P: @scxTime2d; M: 2 * MinsPerDay), (P: @scxTime3d; M: 3 * MinsPerDay),
  (P: @scxTime4d; M: 4 * MinsPerDay), (P: @scxTime1w; M: MinsPerWeek),
  (P: @scxTime2w; M: 2 * MinsPerWeek));

sMinutePluralNames:
array [Boolean] of Pointer = (@scxSuffixMinute, @scxSuffixMinutes);
sHourPluralNames:
array [Boolean] of Pointer = (@scxSuffixHour, @scxSuffixHours);
sDayPluralNames:
array [Boolean] of Pointer = (@scxSuffixDay, @scxSuffixDays);
sWeekPluralNames:
array [Boolean] of Pointer = (@scxSuffixWeek, @scxSuffixWeeks);
...
type
  ...
  TSchedulerResourceColor = (srcMinorNonWorkTimeSeparator,
    srcMajorNonWorkTimeSeparator, srcMinorWorkTimeSeparator,
    srcMajorWorkTimeSeparator, srcNonWorkTime, srcWorkTime);
  ...
  protected
    ...
    // internal time zone
    class function AddInternalTimeZone(const ATimeZone
  ...
  public
    ...
    class function AddDSTInfo(const ATimeZone: Integer; const AYear: Integer;
      const AStandardDate, ADaylightDate: TDateTime): Integer; overload;
    ...
    class function ConvertToGlobalTime(const ADateTime: TDateTime;
      ATimeZone: Integer = -1): TDateTime; virtual;
    ...
    class function IsDaylightDateTime(ATimeZone: Integer;
    ...
    class function TimeZoneDaylightBias(ADateTime: TDateTime;
      ATimeZone: Integer): Integer; virtual;
    class function TimeZoneInfo(AIndex: Integer)
      : TcxTimeZoneInformation; virtual;
    // datetime to string conversion
    class function DateToLongDateStr(ADate: TDateTime): string; virtual;
    class function DayToStr(const ADate: TDateTime; AFormat: Integer;
      ACompressed: Boolean): string; virtual;
    class function DayToStrFormatCount: Integer; virtual;
    class function GetDayMonthFormat(AFormat: Integer;
    ...
    class procedure IncMonth(var AYear, AMonth, ADay: Word;
      ANumberOfMonths: Integer = 1);
    class function Intersect(const AStart, AFinish, AStart1,
      AFinish1: TDateTime): Boolean;
  ...
  protected
    ...
    class procedure DrawTimeAreaArrow(AArrow: TdxSkinImage; ACanvas: TcxCanvas;
      const ABounds, AVisibleBounds: TRect; AScaleFactor: TdxScaleFactor);
    class procedure FreeStateBrushes;
    class function GetColorValue(AColor: TColor; ALightValue: Integer)
      : TColor; virtual;
    class procedure GetResourceColors(AColor: TColor;
      ASchedulerViewStyle: TcxSchedulerViewStyle;
      out AResourceColors: TcxSchedulerResourceColors); virtual;
    class function GetResourceStream(const AResName: string): TMemoryStream;
    class procedure InitCachedColors(AColor: TColor;
      ASchedulerViewStyle: TcxSchedulerViewStyle;
      out AColors: TcxSchedulerResourceColors); virtual;
    // system initialization
  ...
  public
    class procedure DrawClock(ACanvas: TcxCanvas; const ARect: TRect;
      AHour, AMinute: Word; const AViewParams: TcxViewParams;
      AScaleFactor: TdxScaleFactor); overload;
    class procedure DrawClock(ACanvas: TcxCanvas; const ARect: TRect;
      ATime: TDateTime; const AViewParams: TcxViewParams;
      AScaleFactor: TdxScaleFactor); overload;
    class procedure DrawGradientRect(ACanvas: TcxCanvas; AStartColor: TColor;
      const ARect: TRect);
    class procedure DrawEndContinueArrow(ACanvas: TcxCanvas;
      const ABounds, AVisibleBounds: TRect;
      AScaleFactor: TdxScaleFactor); virtual;
    class procedure DrawMoreEventButton(ACanvas: TcxCanvas;
      const ABounds: TRect; AScaleFactor: TdxScaleFactor;
      AImageIndex: Integer); virtual;
    class procedure DrawStartContinueArrow(ACanvas: TcxCanvas;
      const ABounds, AVisibleBounds: TRect;
      AScaleFactor: TdxScaleFactor); virtual;
    class procedure DrawIcon(ACanvas: TcxCanvas; const R: TRect;
      AIndex: Integer; AScaleFactor: TdxScaleFactor); overload;
    class procedure DrawIcon(ACanvas: TcxCanvas; const R: TRect;
      AIndex: Integer; const AViewParams: TcxViewParams;
      AIsTransparent: Boolean; AScaleFactor: TdxScaleFactor); overload;
    ...
    class procedure DrawState(ACanvas: TcxCanvas; R: TRect; AState: Integer;
      ...
      AViewStyle: TcxSchedulerViewStyle = svsClassic);
    class procedure DrawTransparentImage(ACanvas: TcxCanvas;
      AImages: TCustomImageList; X, Y, AIndex: Integer); overload; virtual;
    class procedure DrawTransparentImage(ACanvas: TcxCanvas;
      AImages: TCustomImageList; const ARect: TRect; AIndex: Integer;
      AScaleFactor: TdxScaleFactor); overload; virtual;
    class function ExcludeBorders(const ARect: TRect; ABorders: TcxBorders;
      ABorderSize: Integer = 1): TRect;
    class function GetContentColor(AResourceColor: Integer;
      AIsWorkTime: Boolean;
    ...
    class function IncludeBorders(const ARect: TRect; ABorders: TcxBorders;
      ABorderSize: Integer = 1): TRect;
    ...
    class function LoadImages(AWidth, AHeight: Integer; const AResName: string;
      AHasPalette: Boolean = False; AHasTransparent: Boolean = True)
      : TCustomImageList;
    class function MoreButtonHeight(const ASchedulerViewStyle
      : TcxSchedulerViewStyle = svsClassic): Integer;
    class function MoreButtonWidth(const ASchedulerViewStyle
      : TcxSchedulerViewStyle = svsClassic): Integer;
  ...
  public
    ...
    class function DateTimeHelperClass
      : TcxSchedulerDateTimeHelperClass; virtual;
  end;
  ...
  public
    ...
    property Items[Index: Integer]: TDateTime read GetItem
  ...
  public
    constructor Create;
    destructor Destroy; override;
    function Add(AColor: TColor; const ACaption: string)
      : TcxSchedulerEventLabel;
    function IndexOfColor(AColor: TColor): Integer;

    property Items[Index: Integer]: TcxSchedulerEventLabel
  ...
  TdxThreadingListProc = reference to procedure(AObject: Pointer;
    AIndex: Integer);
  ...
  protected
    ...
    procedure DoIterateItems(AList: TdxFastList; AProc: TdxThreadingListProc;
      AReverse: Boolean = False);
  public
    class procedure IterateItems(AList: TdxFastList;
      AProc: TdxThreadingListProc; AReverse: Boolean = False);
  end;

  TcxMinutesToTextProc = function(AMinutes: Integer): string;
  TcxTextToMinutesProc = function(const AText: string;
    out AMinutes: Integer): Boolean;

function GetNearestDivider(ANum, ADenom, AMinDenom, AMaxDenom: Integer)
  : Integer;

  function cxCompareDates(Item1, Item2: Pointer): Integer;

    procedure cxSchedulerError(const ADescription: string); overload;
      procedure cxSchedulerError(const ADescription: string;
        Args: array of const); overload;

        function cxMinutesToText(AMinutes: Integer): string;
          function cxTextToMinutes(const AText: string;
            out AMinutes: Integer): Boolean;
            ...
            function cxDaysToInteger(ADay: TDays): Integer; inline;
              ...
              const
                DateTimeHelper: TcxSchedulerDateTimeHelperClass =
                  TcxSchedulerDateTimeHelper;
                cxMinutesToTextProc: TcxMinutesToTextProc = cxMinutesToText;
                cxTextToMinutesProc: TcxTextToMinutesProc = cxTextToMinutes;

                PredefinedResourceColors: array [0 .. 12]
                  of TcxSchedulerResourceColors = (($B1E4F3, $98D0EA, $C7EFFF,
                  $A2DBF6, $BCF4FF, $D5FFFF), ($FF6E03, $F5BFA0, $FCE5D1,
                  $FADAC4, $F5BFA0, $FEECDD), ($8ACBA8, $68B48C, $B4E4CD,
                  $A2D1BA, $97D4B3, $BCECD5), ($B59380, $987461, $DBC9C1,
                  $CCAFA1, $BF9E8B, $E6D8CF), ($957CB4, $7A659C, $C7BDDA,
                  $ABA3C5, $A186BE, $D6CBE3), ($9CA87B, $808E54, $C3CAAE,
                  $ADB691, $A7B189, $D1D6C1), ($71A7EB, $4783CA, $A3C4EE,
                  $76A6E1, $7FB4F7, $AED0FA), ($8381D2, $6564B3, $BDBBE9,
                  $A6A4DE, $8E8CDD, $C9C8EF), ($7A8A81, $596466, $BFCFC4,
                  $A9B5AC, $849689, $CBD8D0), ($BBBA00, $999700, $E3E290,
                  $CCCB54, $C8C700, $ECECA8), ($C2889B, $9B6376, $E6C7D2,
                  $D8A9B9, $CF94A8, $ECD5DD), ($BDBDBD, $797979, $CCCCCC,
                  $B1B1B1, $CCCCCC, $E6E6E6), ($E1E1E1, $E1E1E1, $E1E1E1,
                  $E1E1E1, $F0F0F0, $FFFFFF));

                ResourceColorIntensityValues: array [TcxSchedulerViewStyle,
                  TSchedulerResourceColor] of Integer =
...
begin
  ...
  begin
    ...
    Result := Format('%d %s',
      [W, cxGetResourceString(sWeekPluralNames[W <> 1])]);
  end
  else if (AMinutes >= MinsPerDay) and ((AMinutes * 100 mod MinsPerDay) = 0)
  then
    Result := Format('%s %s', [FloatToStr(AMinutes / MinsPerDay),
      cxGetResourceString(sDayPluralNames[AMinutes <> MinsPerDay])])
  else if (AMinutes >= MinsPerHour) and ((AMinutes * 10 mod MinsPerHour) = 0)
  then
    Result := Format('%s %s', [FloatToStr(AMinutes / MinsPerHour),
      cxGetResourceString(sHourPluralNames[AMinutes <> MinsPerHour])])
  else
    Result := Format('%d %s',
      [AMinutes, cxGetResourceString(sMinutePluralNames[AMinutes <> 1])]);
end;
...
var
  ...
  begin
    Result := ((Length(S) = 1) and SameText(S, AName1[1]) or
      SameText(S, AName2[1])) or (SameText(S, AName1) or SameText(S, AName2));
  end;
...
begin
  ...
  for I := 1 to Length(S) do
    if S[I] = dxFormatSettings.DecimalSeparator then
      S[I] := '.';
  Val(S, AValue, ACode);
  if ACode = 0 then
  begin
  ...
  begin
    ...
    else if CheckMeasureUnits(cxGetResourceString(sHourPluralNames[True]),
      cxGetResourceString(sHourPluralNames[False])) then
      AMinutes := Round(AValue * MinsPerHour)
    else if CheckMeasureUnits(cxGetResourceString(sDayPluralNames[True]),
      cxGetResourceString(sDayPluralNames[False])) then
      AMinutes := Round(AValue * MinsPerDay)
    else if CheckMeasureUnits(cxGetResourceString(sWeekPluralNames[True]),
...
class function TcxSchedulerDateTimeHelper.AddDSTInfo(var ATimeZoneInfo
  : TcxTimeZoneInformation; const AYear: Integer;
  const AStandardDate, ADaylightDate: TSystemTime): Integer;
begin
  Result := TdxTimeZoneHelper.AddDSTInfo(ATimeZoneInfo, AYear, AStandardDate,
    ADaylightDate);
end;
...
begin
  Result := TdxTimeZoneHelper.AddDSTInfo(ATimeZone, AYear, AStandardDate,
    ADaylightDate);
end;

class function TcxSchedulerDateTimeHelper.CalculateTransitionDate
  (const AYear: Word; const ADSTDateTime: TSystemTime): TDateTime;
begin
...
begin
  ...
  begin
    TimeZoneDeltaBias := ConvertToLocalTime(ConvertToGlobalTime(ADateTime,
      ATimeZone), ANextTimeZone) - ADateTime;
...
class function TcxSchedulerDateTimeHelper.ConvertToGlobalTime(const ADateTime
  : TDateTime; ATimeZone: Integer = -1): TDateTime;
begin
  Result := TdxTimeZoneHelper.ConvertToGlobalTime(ADateTime, ATimeZone);
end;

class function TcxSchedulerDateTimeHelper.ConvertToLocalTime(const ADateTime
  : TDateTime; ATimeZone: Integer = -1): TDateTime;
begin
...
begin
  ...
  for I := 1 to Length(S) do
    if S[I] = '''' then
      F := not F
    else if not F and dxCharInSet(UpCase(S[I]), ['D', 'M']) then
    begin
      Pos := I;
      break;
    end;
...
procedure CutMonth(var S: string; AStartIndex: Integer);
  ...
  begin
    ...
    for I := AStartIndex + 3 to Length(S) do
      if S[I] = '''' then
        F := not F
      else if not F and (UpCase(S[I]) = 'D') then
      begin
        Pos := I;
        break;
      end;
  ...
  begin
    ...
    for I := AStartIndex - 1 downto 1 do
      if S[I] = '''' then
        F := not F
      else if not F and (UpCase(S[I]) <> ' ') then
      begin
        Pos := I;
        break;
      end;
...
class function TcxSchedulerDateTimeHelper.DayToStr(const ADate: TDateTime;
  AFormat: Integer; ACompressed: Boolean): string;
var
...
class function TcxSchedulerDateTimeHelper.GetMeridiem(AIsPM: Boolean;
  AIsUpperCase: Boolean): string;
begin
...
class function TcxSchedulerDateTimeHelper.HourToStr
...
class function TcxSchedulerDateTimeHelper.MonthYearToStr(AMonth,
  AYear: Integer): string;
begin
...
class procedure TcxSchedulerDateTimeHelper.FillAdvanceStrings
  (AStrings: TStrings);
begin
  ...
  try
    ...
    AStrings.AddObject(cxGetResourceString(@scxTime1w),
      Pointer(1 * 7 * 24 * 60));
    AStrings.AddObject(cxGetResourceString(@scxTime2w),
      Pointer(2 * 7 * 24 * 60));
  finally
    AStrings.EndUpdate;
  end;
...
class procedure TcxSchedulerDateTimeHelper.IncMonth(var AYear, AMonth,
  ADay: Word; ANumberOfMonths: Integer = 1);
begin
  IncAMonth(AYear, AMonth, ADay, ANumberOfMonths);
end;

class function TcxSchedulerDateTimeHelper.Intersect(const AStart, AFinish,
...
class function TcxSchedulerDateTimeHelper.IsFreeTime(const ADateTime: TDateTime;
  AWorkDays: TDays; const AWorkStart, AWorkFinish: TDateTime): Boolean;
var
  AHour: Word;
begin
  AHour := HourOf(ADateTime);
  Result := IsWeekEnd(ADateTime, AWorkDays) or (AHour < AWorkStart) or
    (AHour > AWorkFinish);
end;
...
class function TcxSchedulerDateTimeHelper.IsWeekEnd(const ADate: TDateTime;
  AWorkDays: TDays): Boolean;
begin
  Result := not(dxDayOfWeek(ADate) in AWorkDays);
end;

class function TcxSchedulerDateTimeHelper.IsWeeksFull(const AStartDate,
...
class function TcxSchedulerDateTimeHelper.AddInternalTimeZone(const ATimeZone
  : TcxTimeZoneInformation): Integer;
begin
...
class function TcxSchedulerDateTimeHelper.TimeZoneBias(AIndex: Integer)
  : TDateTime;
begin
  Result := TdxTimeZoneHelper.TimeZoneBias(AIndex);
end;

class function TcxSchedulerDateTimeHelper.TimeZoneBiasDelta(AIndex: Integer)
  : TDateTime;
begin
  Result := TdxTimeZoneHelper.TimeZoneBiasDelta(AIndex);
end;

class function TcxSchedulerDateTimeHelper.TimeZoneInfo(AIndex: Integer)
  : TcxTimeZoneInformation;
begin
  Result := TdxTimeZoneHelper.TimeZoneInfo(AIndex);
end;

class function TcxSchedulerDateTimeHelper.RoundTime(const ADateTime: TDateTime)
  : TDateTime;
var
...
begin
  ...
  if Result < 0 then
    Result := Result - (ATimeStamp.Time div (SecsPerMin * MSecsPerSec)) *
      MinuteToTime
  else
    Result := Result + (ATimeStamp.Time div (SecsPerMin * MSecsPerSec)) *
      MinuteToTime;
...
class function TcxSchedulerDateTimeHelper.WeekCount(const AStart,
  AFinish: TDateTime): Integer;
var
  C: Integer;
begin
...
begin
  Result := Pos('H', GetLocaleStr(GetThreadLocale, LOCALE_STIMEFORMAT,
    '')) <> 0;
end;
...
class function TcxSchedulerDateTimeHelper.TimeZoneDaylightBias
  (ADateTime: TDateTime; ATimeZone: Integer): Integer;
begin
...
begin
  ...
  for I := 1 to 12 do
  begin
    dxFormatSettings.ShortMonthNames[I] := GetLocaleStr(DefaultLCID,
      LOCALE_SABBREVMONTHNAME1 + I - 1, dxFormatSettings.ShortMonthNames[I]);
    dxFormatSettings.LongMonthNames[I] := GetLocaleStr(DefaultLCID,
      LOCALE_SMONTHNAME1 + I - 1, dxFormatSettings.LongMonthNames[I]);
  end;
  for I := 1 to 7 do
  begin
    Day := I - 2;
    if Day = -1 then
      Day := 6;
    dxFormatSettings.ShortDayNames[I] := GetLocaleStr(DefaultLCID,
      LOCALE_SABBREVDAYNAME1 + Day, dxFormatSettings.ShortDayNames[I]);
    dxFormatSettings.LongDayNames[I] := GetLocaleStr(DefaultLCID,
      LOCALE_SDAYNAME1 + Day, dxFormatSettings.LongDayNames[I]);
  end;
  GetFormatSettings;
  LongDateOrder := StrToIntDef(GetLocaleStr(GetThreadLocale,
    LOCALE_ILDATE, '1'), 1);
  UpdateDayMonthFormat;
end;
...
class procedure TcxSchedulerPainterHelper.DrawEndContinueArrow
  (ACanvas: TcxCanvas; const ABounds, AVisibleBounds: TRect;
  AScaleFactor: TdxScaleFactor);
begin
  DrawTimeAreaArrow(EndContinueArrow, ACanvas, ABounds, AVisibleBounds,
    AScaleFactor);
end;

class procedure TcxSchedulerPainterHelper.DrawMoreEventButton
...
class procedure TcxSchedulerPainterHelper.DrawStartContinueArrow
  (ACanvas: TcxCanvas; const ABounds, AVisibleBounds: TRect;
  AScaleFactor: TdxScaleFactor);
begin
  DrawTimeAreaArrow(StartContinueArrow, ACanvas, ABounds, AVisibleBounds,
    AScaleFactor);
end;

class procedure TcxSchedulerPainterHelper.DrawTimeAreaArrow
  (AArrow: TdxSkinImage; ACanvas: TcxCanvas;
  const ABounds, AVisibleBounds: TRect; AScaleFactor: TdxScaleFactor);
var
  R: TRect;
begin
...
class procedure TcxSchedulerPainterHelper.DrawGradientRect(ACanvas: TcxCanvas;
...
class procedure TcxSchedulerPainterHelper.DrawIcon(ACanvas: TcxCanvas;
  const R: TRect; AIndex: Integer; AScaleFactor: TdxScaleFactor);
begin
  if ((R.Right - R.Left) < IconsWidth(AScaleFactor)) or
    ((R.Bottom - R.Top) < IconsHeight(AScaleFactor)) then
    Exit;
  DrawTransparentImage(ACanvas, EventImages, R, AIndex, AScaleFactor);
end;

class procedure TcxSchedulerPainterHelper.DrawIcon(ACanvas: TcxCanvas;
  const R: TRect; AIndex: Integer; const AViewParams: TcxViewParams;
  AIsTransparent: Boolean; AScaleFactor: TdxScaleFactor);
begin
...
class procedure TcxSchedulerPainterHelper.DrawState(ACanvas: TcxCanvas;
  R: TRect; AState: Integer; ABorders: TcxBorders = [];
  ...
  begin
    ...
    SetBrushOrgEx(ACanvas.Handle, -ACanvas.BaseOrigin.X,
      -ACanvas.BaseOrigin.Y, @P);
...
class procedure TcxSchedulerPainterHelper.DrawTransparentImage
  (ACanvas: TcxCanvas; AImages: TCustomImageList; const ARect: TRect;
...
class function TcxSchedulerPainterHelper.GetContentColor(AResourceColor
  : Integer; AIsWorkTime: Boolean;
  const ASchedulerViewStyle: TcxSchedulerViewStyle = svsClassic): TColor;
var
  AColors: TcxSchedulerResourceColors;
begin
  TcxSchedulerPainterHelper.GetResourceColors(AResourceColor,
    ASchedulerViewStyle, AColors);
  if AIsWorkTime then
...
class function TcxSchedulerPainterHelper.GetTimeLineBorderColor(AEventCellColor
  : TColor): TColor;
var
  AValue: TdxHSL;
  S_and_L: Double;
begin
  ...
  if InRange(S_and_L, 1.15, 1.3) then
    AValue.S := 0.5
  else if InRange(S_and_L, 1.5, 1.7) then
    AValue.S := 0.6
  else
...
begin
  Result := PredefinedResourceColors
    [AResourceIndex mod Length(PredefinedResourceColors)
    ][High(TcxSchedulerResourceColors)];
end;

class function TcxSchedulerPainterHelper.GetSeparatorColor(const AResourceColor
  : Integer; AIsHourSeparator, AIsWorkTime: Boolean;
  const ASchedulerViewStyle: TcxSchedulerViewStyle = svsClassic): TColor;
var
  AColors: TcxSchedulerResourceColors;
begin
  TcxSchedulerPainterHelper.GetResourceColors(AResourceColor,
    ASchedulerViewStyle, AColors);
  Result := AColors[TSchedulerResourceColor(Byte(AIsWorkTime) * 2 +
    Byte(AIsHourSeparator))];
end;

class function TcxSchedulerPainterHelper.IconsWidth
  (ScaleFactor: TdxScaleFactor): Integer;
begin
  Result := ScaleFactor.Apply(17);
end;

class function TcxSchedulerPainterHelper.IconsHeight
  (ScaleFactor: TdxScaleFactor): Integer;
begin
  Result := ScaleFactor.Apply(17);
end;
...
class procedure TcxSchedulerPainterHelper.InitStyle(AStyle: TcxStyle;
  const AResName: string; AGraphicClass: TGraphicClass);
begin
...
class function TcxSchedulerPainterHelper.LoadImages(AWidth, AHeight: Integer;
  const AResName: string; AHasPalette: Boolean = False;
  AHasTransparent: Boolean = True): TCustomImageList;
const
  ATransparent: array [Boolean] of DWORD = (CLR_NONE, CLR_DEFAULT);
begin
  Result := TImageList.CreateSize(AWidth, AHeight);
  if AHasPalette then
    Result.Handle := ImageList_LoadImage(HInstance, PChar(AResName), AWidth, 16,
      ATransparent[AHasTransparent], IMAGE_BITMAP, LR_CREATEDIBSECTION)
  else
    Result.Handle := ImageList_LoadImage(HInstance, PChar(AResName), AWidth, 16,
      CLR_NONE, IMAGE_BITMAP, LR_DEFAULTCOLOR);
end;

class function TcxSchedulerPainterHelper.MoreButtonHeight
  (const ASchedulerViewStyle: TcxSchedulerViewStyle = svsClassic): Integer;
const
...
class function TcxSchedulerPainterHelper.MoreButtonWidth
  (const ASchedulerViewStyle: TcxSchedulerViewStyle = svsClassic): Integer;
const
...
class function TcxSchedulerPainterHelper.ShadowSize(AScaleFactor
...
class function TcxSchedulerPainterHelper.TextWidth(AFont: TFont;
  const AText: string): Integer;
begin
  Result := TdxTextMeasurer.TextWidthTO(AFont, AText);
end;

class procedure TcxSchedulerPainterHelper.GetResourceColors(AColor: TColor;
  ASchedulerViewStyle: TcxSchedulerViewStyle;
  out AResourceColors: TcxSchedulerResourceColors);
var
  AIndex: Integer;
begin
  ...
  begin
    ...
    if (AColor <> PrevResourceColor) or (ASchedulerViewStyle <> PrevStyle) then
      if AColor = PredefinedResourceColors[High(PredefinedResourceColors),
        High(TcxSchedulerResourceColors)] then
        PrevColorData := PredefinedResourceColors
          [High(PredefinedResourceColors)]
      else
        InitCachedColors(AColor, ASchedulerViewStyle, PrevColorData);
  end
  else if (AColor = clWindow) or (ColorToRGB(AColor) <> PrevResourceColor) or
    (ASchedulerViewStyle <> PrevStyle) then
  begin
    ...
    begin
      ...
      while AIndex >= 0 do
      begin
        if PredefinedResourceColors[AIndex, High(TcxSchedulerResourceColors)] = AColor
        then
          break
        else
          Dec(AIndex);
...
class function TcxSchedulerPainterHelper.GetResourceStream(const AResName
  : string): TMemoryStream;
var
  ASize: Integer;
  AHandle: HGLOBAL;
  AResInfo: HRSRC;
...
var
  I: Integer;
const
  AColors: array [0 .. 4] of TColor = (clWhite, clWhite, clBlue,
    cxSchedulerOutOfOfficeStateColor, clWhite);
  ABrushNames: array [0 .. 9] of string = ('', 'CXTENTATIVE', '', '', '',
    'CXTENTATIVEBW', 'CXBUSYBW', 'CXOUTOFOFFICEBW', 'CXTENTATIVEMODERNBW',
    'CXTENTATIVEMODERNCONTENTBW');
...
begin
  ...
  begin
    ...
    begin
      ...
      StateBrushes[I].Bitmap.Handle :=
        LoadBitmap(HInstance, PChar(ABrushNames[I]));
    end
    else
...
class function TcxSchedulerPainterHelper.GetColorValue(AColor: TColor;
  ALightValue: Integer): TColor;
begin
  Result := Rgb(MulDiv(GetRValue(AColor), ALightValue, 100),
    MulDiv(GetGValue(AColor), ALightValue, 100), MulDiv(GetBValue(AColor),
    ALightValue, 100));
end;

class procedure TcxSchedulerPainterHelper.InitCachedColors(AColor: TColor;
  ASchedulerViewStyle: TcxSchedulerViewStyle;
  out AColors: TcxSchedulerResourceColors);
var
  I: TSchedulerResourceColor;
begin
  for I := Low(TSchedulerResourceColor) to High(TSchedulerResourceColor) do
    AColors[I] := GetColorValue(AColor, ResourceColorIntensityValues
      [ASchedulerViewStyle, I]);
end;
...
begin
  ...
  TimeLinePatterns := TcxSchedulerPainterHelper.LoadImages(12, 12,
    'CXTIMELINEPATTERNS');
  MoreEventButtonGlyphs := TcxSchedulerPainterHelper.LoadImages(MoreButtonWidth,
    MoreButtonHeight, 'CXMOREEVENTS');
  MenuImages := TcxSchedulerPainterHelper.LoadImages(16, 16,
    'CXSCHEDULERMENUIMAGES', True);
  EventImages := TcxSchedulerPainterHelper.LoadImages(17, 17,
    'CXSCHEDULEREVENTICONS', True);
  ...
  ModernMoreEvents.Texture.LoadFromResource(HInstance,
    'MODERNMOREEVENTS', 'PNG');
  ...
  StartContinueArrow.Texture.LoadFromResource(HInstance,
    'STARTCONTINUEARROW', 'PNG');
  StartContinueArrow.Stretch := smNoResize;

  EndContinueArrow := TcxSchedulerSkinImage.Create(nil);
  EndContinueArrow.Texture.LoadFromResource(HInstance,
    'ENDCONTINUEARROW', 'PNG');
...
class function TcxSchedulerHelpersFactory.DateTimeHelperClass
  : TcxSchedulerDateTimeHelperClass;
begin
  Result := DateTimeHelper;
end;

class function TcxSchedulerHelpersFactory.PainterHelperClass
...
procedure TcxSchedulerDateList.SetItem(AIndex: Integer;
...
function TcxSchedulerTimeRanges.Add(const AStart, AFinish: TDateTime)
  : TcxSchedulerTimeRange;
begin
...
function TcxSchedulerEventLabels.Add(AColor: TColor; const ACaption: string)
  : TcxSchedulerEventLabel;
begin
...
function TcxSchedulerEventLabels.GetItem(AIndex: Integer)
  : TcxSchedulerEventLabel;
begin
...
class procedure TdxMultithreadedListHelper.IterateItems(AList: TdxFastList;
  AProc: TdxThreadingListProc; AReverse: Boolean = False);
var
  I: Integer;
...
function TdxMultithreadedListHelper.DoItem(AList: TdxFastList;
...
procedure TdxMultithreadedListHelper.DoIterateItems(AList: TdxFastList;
  AProc: TdxThreadingListProc; AReverse: Boolean = False);
var
