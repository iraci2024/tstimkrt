...
resourcestring
  ...
  // dialogs constants
  scxDeleteRecurringEventDescription =
    'is a recurring event. Do you want to delete only this occurrence or the series?';
  scxEditRecurringEventDescription =
    'is a recurring event. Do you want to open only this occurrence or the series?';
  ...
  scxReplaceOccurrenceDate =
    'Some months have fewer than %s days. For these months, the occurrence will fall on the last day of the month.';
  ...
  scxConfirmLostExceptions =
    'Any exceptions associated with this recurring event will be lost. Is this OK?';
  ...
  scxCannotRescheduleOccurrence =
    'Cannot reschedule an occurrence of the recurring appointment "%s" if it skips over a later occurrence of the same appointment.';
  scxTwoOccurrencesPerDay =
    'Two occurrences of "%s" cannot occur on the same day.';
  ...
  scxTaskWrongTimeBounds =
    'A new date must be entered within the period of %s - %s.';
  ...
  secxSetDateRangeText =
    'Export and create individual occurrences of appointments or ' +
  ...
  // storage
  scxRequiredFieldsNeeded =
    'The following required fields'#13#10'%sare not assigned!';
  ...
  scxGanttEventHint =
    'Task: %s'#13#10'Complete: %d %%'#13#10'Start: %s'#13#10'Finish: %s';
...
const
  sRangeNames: array [0 .. 4] of Pointer = (@scxFirst, @scxSecond, @scxThird,
    @scxFourth, @scxLast);
  sDayNames: array [0 .. 9] of string = (scxDay, scxWeekDay, scxWeekendDay, '',
    '', '', '', '', '', '');
  sEventLabelCaptions: array [0 .. 10] of Pointer = (@scxEventLabelNone,
    @scxEventLabel0, @scxEventLabel1, @scxEventLabel2, @scxEventLabel3,
    @scxEventLabel4, @scxEventLabel5, @scxEventLabel6, @scxEventLabel7,
    @scxEventLabel8, @scxEventLabel9);
  sEventRelations: array [0 .. 3] of Pointer = (@scxFinishToStart,
    @scxStartToStart, @scxFinishToFinish, @scxStartToFinish);
  sEventRelationsShort: array [0 .. 3] of Pointer = (@scxFinishToStartShort,
    @scxStartToStartShort, @scxFinishToFinishShort, @scxStartToFinishShort);
  sEventTaskStatus: array [0 .. 4] of Pointer = (@scxNotStarted, @scxInProgress,
    @scxComplete, @scxWaiting, @scxDeferred);
...
procedure AddcxSchedulerResourceStringNames
...
begin
  ...
  InternalAdd('scxDeleteRecurringEventDescription',
    @scxDeleteRecurringEventDescription);
  InternalAdd('scxEditRecurringEventDescription',
    @scxEditRecurringEventDescription);
  ...
  InternalAdd('scxShedulerEditorFormNotRegistered',
    @scxShedulerEditorFormNotRegistered);
  ...
  InternalAdd('scxShowMoreResourcesButtonHint',
    @scxShowMoreResourcesButtonHint);
  InternalAdd('scxShowFewerResourcesButtonHint',
  ...
  InternalAdd('scxReminderMinutesBeforeStartField',
    @scxReminderMinutesBeforeStartField);
  ...
  InternalAdd('scxHolidaysLocationEditorCaption',
    @scxHolidaysLocationEditorCaption);
  InternalAdd('scxHolidayName', @scxHolidayName);
  InternalAdd('scxHolidayDate', @scxHolidayDate);
  InternalAdd('scxHolidaysLocationHolidayEditorCaption',
    @scxHolidaysLocationHolidayEditorCaption);
...
dxResourceStringsRepository.RegisterProduct('ExpressScheduler',
  @AddcxSchedulerResourceStringNames);
