...
type
  ...
  TcxSchedulerICalendarCustomPropertyClass = class of
  ...
  protected
    class function ConvertPropertyToParameterValue
      (AProperty: TcxSchedulerICalendarCustomProperty; var AValue: Variant)
      : Boolean; virtual;
    class function ConvertPropertyFromParameterValue
      (AProperty: TcxSchedulerICalendarCustomProperty;
      const AParameterValue: string; var AValue: Variant): Boolean; virtual;

    class function GetValue(AProperty: TcxSchedulerICalendarCustomProperty)
      : string; virtual;
  ...
  TcxSchedulerICalendarCustomParameterClass = class of
  ...
  private
    ...
    function GetCustomParameter(Index: Integer)
      : TcxSchedulerICalendarCustomParameterClass;
  protected
    ...
    procedure AddCustomParameter
      (AClass: TcxSchedulerICalendarCustomParameterClass);
    ...
    property CustomParameters[Index: Integer]
      : TcxSchedulerICalendarCustomParameterClass read GetCustomParameter;
    property SchedulerObject: TObject read FSchedulerObject;
    property Value: Variant read GetValue write SetValue;
  public
    constructor Create(AICalendar: TcxSchedulerICalendar;
      AParent: TcxSchedulerICalendarCustomObject); virtual;
  ...
  private
    FProperties: TList;
    function GetProperty(Index: Integer)
      : TcxSchedulerICalendarCustomPropertyClass;
  ...
  protected
    ...
    function CanHaveProperty(AProperty
      : TcxSchedulerICalendarCustomPropertyClass): Boolean; virtual;

    procedure PopulateProperties; virtual;

    property Properties[Index: Integer]
      : TcxSchedulerICalendarCustomPropertyClass read GetProperty;
    property PropertyCount: Integer read GetPropertyCount;
  public
    constructor Create(AICalendar: TcxSchedulerICalendar;
      AParent: TcxSchedulerICalendarCustomObject); override;
    destructor Destroy; override;
  end;

  TcxSchedulerICalendarCustomObjectClass = class of
    TcxSchedulerICalendarCustomObject;

  { Strings }

  TcxSchedulerICalendarLanguageParameter = class
    (TcxSchedulerICalendarCustomParameter)
  protected
    class function ConvertPropertyToParameterValue
      (AProperty: TcxSchedulerICalendarCustomProperty; var AValue: Variant)
  ...
  TcxSchedulerICalendarStringParameter = class
    (TcxSchedulerICalendarCustomParameter)
  protected
    class function FromString(AProperty: TcxSchedulerICalendarCustomProperty;
  ...
  TcxSchedulerICalendarStringCustomProperty = class
    (TcxSchedulerICalendarCustomProperty)
  protected
  ...
  protected
    class function TokenName: string; virtual;
    class function FromString(AProperty
      : TcxSchedulerICalendarRecurrenceCustomProperty; const AValue: string)
      : Boolean; virtual;
    class function ToString(AProperty
      : TcxSchedulerICalendarRecurrenceCustomProperty; out AValue: string)
      : Boolean; reintroduce; virtual;
  end;

  TcxSchedulerICalendarRecurrenceCustomValueClass = class of
    TcxSchedulerICalendarRecurrenceCustomValue;

  TcxSchedulerICalendarRecurrenceTypeValue = class
    (TcxSchedulerICalendarRecurrenceCustomValue)
  protected
    class function TokenName: string; override;
    class function FromString(AProperty
  ...
  TcxSchedulerICalendarRecurrenceCountValue = class
    (TcxSchedulerICalendarRecurrenceCustomValue)
  protected
    class function TokenName: string; override;
    class function FromString(AProperty
  ...
  TcxSchedulerICalendarRecurrenceUntilValue = class
    (TcxSchedulerICalendarRecurrenceCustomValue)
  protected
    class function TokenName: string; override;
    class function FromString(AProperty
  ...
  TcxSchedulerICalendarRecurrenceIntervalValue = class
    (TcxSchedulerICalendarRecurrenceCustomValue)
  protected
    class function TokenName: string; override;
    class function FromString(AProperty
  ...
  TcxSchedulerICalendarRecurrenceByDayValue = class
    (TcxSchedulerICalendarRecurrenceCustomValue)
  protected
    class function TokenName: string; override;
    class function FromString(AProperty
  ...
  TcxSchedulerICalendarRecurrenceByMonthValue = class
    (TcxSchedulerICalendarRecurrenceCustomValue)
  protected
    class function TokenName: string; override;
    class function FromString(AProperty
  ...
  TcxSchedulerICalendarRecurrenceByMonthDayValue = class
    (TcxSchedulerICalendarRecurrenceCustomValue)
  protected
    class function TokenName: string; override;
    class function FromString(AProperty
  ...
  TcxSchedulerICalendarRecurrenceBySetPosValue = class
    (TcxSchedulerICalendarRecurrenceCustomValue)
  protected
    class function TokenName: string; override;
    class function FromString(AProperty
  ...
  private
    ...
    function GetValueParameter(Index: Integer)
      : TcxSchedulerICalendarRecurrenceCustomValueClass;
  ...
  protected
    ...
    procedure AddValueParameter(AParameter
      : TcxSchedulerICalendarRecurrenceCustomValueClass);
    ...
    property ValueParameters[Index: Integer]
      : TcxSchedulerICalendarRecurrenceCustomValueClass read GetValueParameter;
  ...
  public
    ...
    property ByDayWeek[ADay: TDay]: Integer read GetByDayWeek
      write SetByDayWeek;
    ...
    property RecurrenceType: TcxRecurrence read GetRecurrenceType
      write SetRecurrenceType;
    property RecurrenceUntil: TDateTime read GetRecurrenceUntil
      write SetRecurrenceUntil;
  end;

  { DateTime }

  TcxSchedulerICalendarTZIDParameter = class
    (TcxSchedulerICalendarCustomParameter)
  protected
    class function ConvertPropertyToParameterValue
      (AProperty: TcxSchedulerICalendarCustomProperty; var AValue: Variant)
  ...
  TcxSchedulerICalendarDateParameter = class
    (TcxSchedulerICalendarCustomParameter)
  protected
    class function ConvertPropertyToParameterValue
      (AProperty: TcxSchedulerICalendarCustomProperty; var AValue: Variant)
  ...
  TcxSchedulerICalendarDateTimeParameter = class
  ...
  TcxSchedulerICalendarDateTimeCustomProperty = class
    (TcxSchedulerICalendarCustomProperty)
  private
    FTimeZone: Integer;
  ...
  TcxSchedulerICalendarRecurrenceUntilProperty = class
  ...
  TcxSchedulerICalendarTimeZoneStartProperty = class
    (TcxSchedulerICalendarDateTimeCustomProperty)
  private
  ...
  TcxSchedulerICalendarTimeZoneRuleCustomProperty = class
    (TcxSchedulerICalendarCustomProperty)
  private
    function GetParent: TcxSchedulerICalendarTimeZoneCustomRule;
  protected
  ...
  TcxSchedulerICalendarTZOffsetToProperty = class
  ...
  TcxSchedulerICalendarTZOffsetFromProperty = class
    (TcxSchedulerICalendarTimeZoneRuleCustomProperty)
  protected
    class function TokenName: string; override;
    function GetValue: Variant; override;
  ...
  TcxSchedulerICalendarTimeZoneRuleRecurrence = class
  ...
  TcxSchedulerICalendarTimeZoneStandardRule = class
    (TcxSchedulerICalendarTimeZoneCustomRule)
  protected
    class function TokenName: string; override;
  end;

  TcxSchedulerICalendarTimeZoneDaylightRule = class
    (TcxSchedulerICalendarTimeZoneCustomRule)
  protected
    class function TokenName: string; override;
  ...
  TcxSchedulerICalendarEventDateTimeProperty = class
    (TcxSchedulerICalendarDateTimeCustomProperty)
  private
  ...
  TcxSchedulerICalendarEventStampProperty = class
  ...
  TcxSchedulerICalendarEventStartProperty = class
    (TcxSchedulerICalendarEventDateTimeProperty)
  protected
    class function TokenName: string; override;
    function GetValue: Variant; override;
  ...
  TcxSchedulerICalendarEventEndProperty = class
    (TcxSchedulerICalendarEventDateTimeProperty)
  protected
    class function TokenName: string; override;
    function GetValue: Variant; override;
  ...
  TcxSchedulerICalendarEventCustomProperty = class
    (TcxSchedulerICalendarCustomProperty)
  private
    function GetEvent: TcxSchedulerEvent;
    function GetParent: TcxSchedulerICalendarEventObject;
  ...
  TcxSchedulerICalendarEventUIDProperty = class
  ...
  TcxSchedulerICalendarEventSequenceProperty = class
    (TcxSchedulerICalendarEventCustomProperty)
  protected
    class function TokenName: string; override;
    function GetValue: Variant; override;
  ...
  TcxSchedulerICalendarEventExDateProperty = class
    (TcxSchedulerICalendarEventDateTimeProperty)
  protected
    function CanExport: Boolean; override;
    class function TokenName: string; override;
  ...
  TcxSchedulerICalendarEventRecurrenceIDProperty = class
    (TcxSchedulerICalendarEventDateTimeProperty)
  protected
    function CanExport: Boolean; override;
    class function TokenName: string; override;
  ...
  TcxSchedulerICalendarEventRecurrenceProperty = class
    (TcxSchedulerICalendarRecurrenceCustomProperty)
  private
    function GetParent: TcxSchedulerICalendarEventObject;
  ...
  protected
    ...
    property RecurrenceInfo: TcxSchedulerEventRecurrenceInfo
      read GetRecurrenceInfo;
  end;

  TcxSchedulerICalendarEventStringProperty = class
  ...
  TcxSchedulerICalendarEventDescriptionProperty = class
  ...
  TcxSchedulerICalendarEventLocationProperty = class
    (TcxSchedulerICalendarEventStringProperty)
  protected
    class function TokenName: string; override;
    function GetValue: Variant; override;
  ...
  TcxSchedulerICalendarEventSummaryProperty = class
    (TcxSchedulerICalendarEventStringProperty)
  protected
    class function TokenName: string; override;
    function GetValue: Variant; override;
  ...
  TcxSchedulerICalendarEventBusyStatusProperty = class
    (TcxSchedulerICalendarEventCustomProperty)
  protected
    class function TokenName: string; override;
    function GetValue: Variant; override;
  ...
  TcxSchedulerICalendarEventStatusProperty = class
    (TcxSchedulerICalendarEventCustomProperty)
  protected
    class function TokenName: string; override;
    function GetValue: Variant; override;
  ...
  TcxSchedulerICalendarEventLabelProperty = class
    (TcxSchedulerICalendarEventCustomProperty)
  protected
    class function TokenName: string; override;
    function GetValue: Variant; override;
  ...
  TcxSchedulerICalendarEventResourcesProperty = class
    (TcxSchedulerICalendarEventStringProperty)
  protected
    class function TokenName: string; override;
    function GetValue: Variant; override;
  ...
  TcxSchedulerICalendarAlarmCustomProperty = class
    (TcxSchedulerICalendarCustomProperty)
  private
    function GetEvent: TcxSchedulerEvent;
  ...
  TcxSchedulerICalendarAlarmTriggerParameter = class
    (TcxSchedulerICalendarCustomParameter)
  protected
    class function FromString(AProperty: TcxSchedulerICalendarCustomProperty;
      const ATranslateValue: string; out AValue: Variant): Boolean; override;
  ...
  TcxSchedulerICalendarAlarmTriggerProperty = class
  ...
  TcxSchedulerICalendarAlarmActionProperty = class
    (TcxSchedulerICalendarAlarmCustomProperty)
  protected
    class function TokenName: string; override;
    function GetValue: Variant; override;
  ...
  protected
    ...
    class function GetRecurrenceDate(APattern: TcxSchedulerEvent;
      ARecurrenceIndex: Integer): TDateTime; static;

    property Event: TcxSchedulerEvent read GetEvent;
    property Exceptions: TList<TDateTime> read FExceptions;
    property IsAllDayEvent: Boolean read GetIsAllDayEvent
      write SetIsAllDayEvent;
    ...
    property Status: TcxSchedulerICalendarEventStatus read FStatus
      write FStatus;
  ...
  TcxSchedulerICalendarVersionProperty = class
    (TcxSchedulerICalendarCustomProperty)
  protected
    class function TokenName: string; override;
    function GetValue: Variant; override;
  ...
  TcxSchedulerICalendarProdIDProperty = class
    (TcxSchedulerICalendarCustomProperty)
  protected
    class function TokenName: string; override;
    function GetValue: Variant; override;
  ...
  protected
    ...
    function CanHaveProperty(AProperty
      : TcxSchedulerICalendarCustomPropertyClass): Boolean; override;
    procedure PopulateProperties; override;
  ...
  protected
    function CanExport(AObject: TcxSchedulerICalendarCustomObject)
      : Boolean; virtual;
    function CanImport(AObject: TcxSchedulerICalendarCustomObject)
      : Boolean; virtual;
    procedure ExportObject(AObject: TObject;
      AParent: TcxSchedulerICalendarCustomObject; AStrings: TStringList);
    procedure ImportObject(AParent: TcxSchedulerICalendarCustomObject;
...
procedure cxSchedulerICalendarExport(AStorage: TcxCustomSchedulerStorage;
  const AFileName: string);
procedure cxSchedulerICalendarImport(AStorage: TcxCustomSchedulerStorage;
  const AFileName: string);
...
type
  TcxSchedulerEventRecurrenceInfoAccess = class
  ...
  protected
    ...
    property Items[Index: Integer]: TcxSchedulerICalendarCustomPropertyClass
      read GetItem;
  ...
  public
    ...
    function GetICalendarPropertyClass(ASchedulerObject: TObject)
      : TcxSchedulerICalendarCustomPropertyClass; overload;
    function GetICalendarPropertyClass(const S: string;
      AParent: TcxSchedulerICalendarCustomObject = nil)
      : TcxSchedulerICalendarCustomPropertyClass; overload;

    procedure Add(AICalendarPropertyClass
      : TcxSchedulerICalendarCustomPropertyClass);
    procedure Remove(AICalendarPropertyClass
      : TcxSchedulerICalendarCustomPropertyClass); overload;
  end;
...
function cxSchedulerICalendarPropertyManager
...
function ConvertDateToGlobalTime(const ADate: TDateTime; ATimeZone: Integer)
  : TDateTime;
begin
  Result := TcxSchedulerDateTimeHelper.ConvertToGlobalTime(ADate, ATimeZone) +
    TcxSchedulerDateTimeHelper.TimeZoneDaylightBias(ADate, ATimeZone) *
    MinuteToTime;
end;

function ConvertDateToLocalTime(const ADate: TDateTime; ATimeZone: Integer)
  : TDateTime;
begin
...
function ConvertDateToAnotherTimeZone(const ADate: TDateTime;
  ADateTimeZone, ATimeZone: Integer): TDateTime;
begin
...
function TcxSchedulerICalendarPropertyManager.GetICalendarPropertyClass
  (ASchedulerObject: TObject): TcxSchedulerICalendarCustomPropertyClass;
var
  I: Integer;
begin
  Result := nil;
...
function TcxSchedulerICalendarPropertyManager.GetICalendarPropertyClass
  (const S: string; AParent: TcxSchedulerICalendarCustomObject = nil)
  : TcxSchedulerICalendarCustomPropertyClass;
var
  I: Integer;
begin
  Result := nil;
  for I := 0 to Count - 1 do
    if Items[I].IsBegin(S) and
      ((AParent = nil) or AParent.CanHaveProperty(Items[I])) then
    begin
      Result := Items[I];
      Break;
    end;
...
procedure TcxSchedulerICalendarPropertyManager.Add(AICalendarPropertyClass
  : TcxSchedulerICalendarCustomPropertyClass);
begin
  FList.Add(AICalendarPropertyClass);
end;

procedure TcxSchedulerICalendarPropertyManager.Remove(AICalendarPropertyClass
  : TcxSchedulerICalendarCustomPropertyClass);
begin
...
function TcxSchedulerICalendarPropertyManager.GetItem(Index: Integer)
  : TcxSchedulerICalendarCustomPropertyClass;
begin
  Result := TcxSchedulerICalendarCustomPropertyClass(FList[Index]);
end;

function TcxSchedulerICalendarPropertyManager.GetSchedulerClass
  (Index: Integer): TClass;
begin
...
begin
  ...
  begin
    ...
    try
      ...
      VerQueryValue(ABuf, '\VarFileInfo\Translation', Pointer(ALangAndCodePage),
        ATranslationSize);

      if ATranslationSize >= 4 then
      begin
        FLanguageInfo := Format('%4.4x%4.4x', [ALangAndCodePage.wLanguage,
          ALangAndCodePage.wCodePage]);
        FLanguage := UpperCase(GetLocaleStr(ALangAndCodePage.wLanguage,
          LOCALE_SISO639LANGNAME, ''));
        FCompanyName := GetStringParam('\StringFileInfo\' + LanguageInfo +
          '\CompanyName');
        FFileDescription := GetStringParam('\StringFileInfo\' + LanguageInfo +
          '\FileDescription');
        FFileVersion := GetStringParam('\StringFileInfo\' + LanguageInfo +
          '\FileVersion');
        FInternalName := GetStringParam('\StringFileInfo\' + LanguageInfo +
          '\InternalName');
        FLegalCopyright := GetStringParam('\StringFileInfo\' + LanguageInfo +
          '\LegalCopyright');
        FOriginalFilename := GetStringParam('\StringFileInfo\' + LanguageInfo +
          '\OriginalFilename');
        FProductName := GetStringParam('\StringFileInfo\' + LanguageInfo +
          '\ProductName');
        FProductVersion := GetStringParam('\StringFileInfo\' + LanguageInfo +
          '\ProductVersion');
        FComments := GetStringParam('\StringFileInfo\' + LanguageInfo +
          '\Comments');
      end;
    finally
      FreeMem(ABuf, ASize);
...
class function TcxSchedulerICalendarCustomParameter.
  ConvertPropertyToParameterValue(AProperty
  : TcxSchedulerICalendarCustomProperty; var AValue: Variant): Boolean;
begin
  Result := False;
end;

class function TcxSchedulerICalendarCustomParameter.
  ConvertPropertyFromParameterValue(AProperty
  : TcxSchedulerICalendarCustomProperty; const AParameterValue: string;
  var AValue: Variant): Boolean;
begin
  Result := False;
end;

class function TcxSchedulerICalendarCustomParameter.GetValue
...
class function TcxSchedulerICalendarCustomParameter.FromString
  (AProperty: TcxSchedulerICalendarCustomProperty;
...
class function TcxSchedulerICalendarCustomParameter.ToString
  (AProperty: TcxSchedulerICalendarCustomProperty; AValue: Variant;
  out ATranslateValue: string): Boolean;
begin
  Result := False;
end;
...
constructor TcxSchedulerICalendarCustomProperty.Create
  (AICalendar: TcxSchedulerICalendar;
...
class function TcxSchedulerICalendarCustomProperty.IsBegin
  (const S: string): Boolean;
begin
  Result := StrLComp(PChar(S), PChar(TokenName), Length(TokenName)) = 0;
end;

class function TcxSchedulerICalendarCustomProperty.IsEnd
  (const S: string): Boolean;
begin
  Result := False;
end;
...
procedure TcxSchedulerICalendarCustomProperty.AfterExport
  (AStrings: TStringList);
begin
  // do nothing
end;

procedure TcxSchedulerICalendarCustomProperty.AfterImport
  (AStrings: TStringList);
begin
  FSchedulerObject := nil;
end;

procedure TcxSchedulerICalendarCustomProperty.BeforeExport
  (AStrings: TStringList);
begin
  // do nothing
end;

procedure TcxSchedulerICalendarCustomProperty.BeforeImport
  (AStrings: TStringList);
begin
...
function TcxSchedulerICalendarCustomProperty.FromString(const AValue,
  AParameters: string): Variant;
    ...
    if ParameterSplit(S, AParameterName, AParameterValue) then
      for I := 0 to CustomParameterCount - 1 do
        if CompareText(AParameterName, CustomParameters[I].TokenName) = 0 then
          CustomParameters[I].ConvertPropertyFromParameterValue(Self,
            AParameterValue, AValue);
  end;
...
begin
  ...
  for I := 0 to CustomParameterCount - 1 do
    if CustomParameters[I].ConvertPropertyToParameterValue(Self, AValue) then
      AParameters := AParameters +
        Format(cxSchedulerICalendarPropertyParameterFormat,
  ...
  for I := 0 to CustomParameterCount - 1 do
    if CustomParameters[I].ToString(Self, AValue, ATranslateValue) then
      Break;
  Result := Format(cxSchedulerICalendarPropertyFormat,
    [TokenName + AParameters, ATranslateValue]);
end;
...
procedure TcxSchedulerICalendarCustomProperty.AddCustomParameter
  (AClass: TcxSchedulerICalendarCustomParameterClass);
begin
...
function TcxSchedulerICalendarCustomProperty.GetCustomParameter(Index: Integer)
  : TcxSchedulerICalendarCustomParameterClass;
begin
...
constructor TcxSchedulerICalendarCustomObject.Create
  (AICalendar: TcxSchedulerICalendar;
  AParent: TcxSchedulerICalendarCustomObject);
begin
  inherited;
...
class function TcxSchedulerICalendarCustomObject.IsBegin
  (const S: string): Boolean;
begin
  Result := CompareText(S, Format(cxSchedulerICalendarObjectBeginFormat,
    [TokenName])) = 0;
end;

class function TcxSchedulerICalendarCustomObject.IsEnd(const S: string)
  : Boolean;
begin
  Result := CompareText(S, Format(cxSchedulerICalendarObjectEndFormat,
    [TokenName])) = 0;
end;
...
procedure TcxSchedulerICalendarCustomObject.AddProperty
  (AProperty: TcxSchedulerICalendarCustomPropertyClass);
begin
  FProperties.Add(AProperty);
end;

function TcxSchedulerICalendarCustomObject.CanHaveProperty
  (AProperty: TcxSchedulerICalendarCustomPropertyClass): Boolean;
begin
...
function TcxSchedulerICalendarCustomObject.GetProperty(Index: Integer)
  : TcxSchedulerICalendarCustomPropertyClass;
begin
...
class function TcxSchedulerICalendarTZIDParameter.
  ConvertPropertyToParameterValue(AProperty
  : TcxSchedulerICalendarCustomProperty; var AValue: Variant): Boolean;
var
...
begin
  ...
  Result := (ADateTimeProperty.TimeZone <> ADateTimeProperty.ICalendar.TimeZone)
    and (ADateTimeProperty.TimeZone <> -1);
  if Result then
    AValue := ConvertDateToAnotherTimeZone(AValue,
      ADateTimeProperty.ICalendar.TimeZone, ADateTimeProperty.TimeZone);
end;
...
begin
  ...
  Result := ADateTimeProperty.TimeZone <> ADateTimeProperty.ICalendar.TimeZone;
  if Result then
    AValue := ConvertDateToAnotherTimeZone(AValue, ADateTimeProperty.TimeZone,
      ADateTimeProperty.ICalendar.TimeZone);
end;

class function TcxSchedulerICalendarTZIDParameter.GetValue
  (AProperty: TcxSchedulerICalendarCustomProperty): string;
var
  ADateTimeProperty: TcxSchedulerICalendarDateTimeCustomProperty;
begin
  ADateTimeProperty := TcxSchedulerICalendarDateTimeCustomProperty(AProperty);
  Result := cxSchedulerICalendarQuote + TcxSchedulerDateTimeHelper.TimeZoneInfo
    (ADateTimeProperty.TimeZone).StandardName + cxSchedulerICalendarQuote;
end;
...
class function TcxSchedulerICalendarLanguageParameter.
  ConvertPropertyToParameterValue(AProperty
  : TcxSchedulerICalendarCustomProperty; var AValue: Variant): Boolean;
begin
  Result := True;
...
class function TcxSchedulerICalendarStringParameter.FromString
  (AProperty: TcxSchedulerICalendarCustomProperty;
  const ATranslateValue: string; out AValue: Variant): Boolean;
begin
  Result := True;
...
class function TcxSchedulerICalendarStringParameter.ToString
  (AProperty: TcxSchedulerICalendarCustomProperty; AValue: Variant;
  out ATranslateValue: string): Boolean;
begin
  Result := True;
...
class function TcxSchedulerICalendarDateParameter.
  ConvertPropertyToParameterValue(AProperty
  : TcxSchedulerICalendarCustomProperty; var AValue: Variant): Boolean;
begin
  Result := TcxSchedulerICalendarDateTimeCustomProperty(AProperty)
    .UseDateFormat;
  if Result then
    AValue := dxDateOf(AValue);
end;

class function TcxSchedulerICalendarDateParameter.GetValue
  (AProperty: TcxSchedulerICalendarCustomProperty): string;
begin
  Result := 'DATE';
end;
...
class function TcxSchedulerICalendarDateParameter.FromString
  (AProperty: TcxSchedulerICalendarCustomProperty;
  const ATranslateValue: string; out AValue: Variant): Boolean;
var
  AResult: TDateTime;
...
begin
  ...
  if ATranslateValue[Length(ATranslateValue)] = cxSchedulerICalendarUtcDateTimePostfix
  then
    TcxSchedulerICalendarDateTimeCustomProperty(AProperty).TimeZone := -1
  else
    TcxSchedulerICalendarDateTimeCustomProperty(AProperty).TimeZone :=
      AProperty.ICalendar.TimeZone;
  ...
  begin
    ...
    begin
      if TcxSchedulerICalendarDateTimeCustomProperty(AProperty).TimeZone = -1
      then
        AResult := ConvertDateToLocalTime(AResult,
          AProperty.ICalendar.GetStorageTimeZone)
      else if AProperty.ICalendar.TimeZone <> AProperty.ICalendar.GetStorageTimeZone
      then
      begin
  ...
  TcxSchedulerICalendarDateTimeCustomProperty(AProperty).UseDateFormat :=
    AUseDateFormat;
end;

class function TcxSchedulerICalendarDateParameter.ToString
  (AProperty: TcxSchedulerICalendarCustomProperty; AValue: Variant;
  out ATranslateValue: string): Boolean;
begin
  Result := TcxSchedulerICalendarDateTimeCustomProperty(AProperty)
...
class function TcxSchedulerICalendarDateTimeParameter.
  ConvertPropertyToParameterValue(AProperty
  : TcxSchedulerICalendarCustomProperty; var AValue: Variant): Boolean;
begin
  Result := False;
...
class function TcxSchedulerICalendarDateTimeParameter.ToString
  (AProperty: TcxSchedulerICalendarCustomProperty; AValue: Variant;
  out ATranslateValue: string): Boolean;
const
  FormatMap: array [Boolean] of string =
    (cxSchedulerICalendarIso8601DateTimeFormat,
    cxSchedulerICalendarIso8601UtcDateTimeFormat);
var
  AUseUtcFormat: Boolean;
begin
  Result := True;
  AUseUtcFormat := TcxSchedulerICalendarDateTimeCustomProperty(AProperty)
    .TimeZone = -1;
  if TcxSchedulerICalendarDateTimeCustomProperty(AProperty).UseTimeZone and AUseUtcFormat
  then
    AValue := ConvertDateToGlobalTime(AValue,
      AProperty.ICalendar.GetStorageTimeZone);
...
procedure TcxSchedulerICalendarTimeZoneStartProperty.SetValue
...
function TcxSchedulerICalendarTimeZoneStartProperty.GetParent
  : TcxSchedulerICalendarTimeZoneCustomRule;
begin
...
function TcxSchedulerICalendarTZIDProperty.GetParent
  : TcxSchedulerICalendarTimeZoneObject;
begin
...
function TcxSchedulerICalendarTimeZoneRuleCustomProperty.
  GetCurrentTimeZone: Integer;
begin
  Result := Parent.Parent.GetCurrentTimeZone;
end;

function TcxSchedulerICalendarTimeZoneRuleCustomProperty.GetTimeZoneInformation
  : TcxTimeZoneInformation;
begin
  Result := Parent.Parent.GetTimeZoneInformation;
end;

function TcxSchedulerICalendarTimeZoneRuleCustomProperty.FromUtcOffset
...
function TcxSchedulerICalendarTimeZoneRuleCustomProperty.GetParent
  : TcxSchedulerICalendarTimeZoneCustomRule;
begin
  Result := TcxSchedulerICalendarTimeZoneCustomRule(inherited Parent);
end;
...
function TcxSchedulerICalendarTZOffsetToProperty.GetBiasFromStr
...
begin
  ...
  Result := GetHourValue(ADateString) * MinsPerHour +
    GetMinuteValue(ADateString);
  if AIsMinus then
    Result := -Result;
end;
...
procedure TcxSchedulerICalendarTZOffsetToProperty.SetValue
  (const AValue: Variant);
begin
  inherited SetValue(AValue);
  if ICalendar.TimeZone <> -1 then
...
function TcxSchedulerICalendarTimeZoneRuleRecurrence.GetByDayWeek
  (ADay: TDay): Integer;
begin
...
function TcxSchedulerICalendarTimeZoneRuleRecurrence.GetRecurrenceType
  : TcxRecurrence;
begin
  Result := cxreYearly;
end;

function TcxSchedulerICalendarTimeZoneRuleRecurrence.GetRecurrenceUntil
  : TDateTime;
begin
  Result := 0;
end;
...
procedure TcxSchedulerICalendarTimeZoneRuleRecurrence.SetByDayWeek(ADay: TDay;
  AValue: Integer);
begin
  // do nothing
end;

procedure TcxSchedulerICalendarTimeZoneRuleRecurrence.SetByMonth
  (AValue: Integer);
begin
  // do nothing
end;

procedure TcxSchedulerICalendarTimeZoneRuleRecurrence.SetByMonthDay
  (AValue: Integer);
begin
  // do nothing
end;

procedure TcxSchedulerICalendarTimeZoneRuleRecurrence.SetBySetPos
  (AValue: Integer);
begin
  // do nothing
end;
...
procedure TcxSchedulerICalendarTimeZoneRuleRecurrence.SetInterval
  (AValue: Integer);
begin
  // do nothing
end;

procedure TcxSchedulerICalendarTimeZoneRuleRecurrence.SetRecurrenceType
  (AValue: TcxRecurrence);
begin
  // do nothing
end;

procedure TcxSchedulerICalendarTimeZoneRuleRecurrence.SetRecurrenceUntil
  (AValue: TDateTime);
begin
  // do nothing
end;

function TcxSchedulerICalendarTimeZoneRuleRecurrence.GetParent
  : TcxSchedulerICalendarTimeZoneCustomRule;
begin
  Result := TcxSchedulerICalendarTimeZoneCustomRule(inherited Parent);
end;
...
begin
  Result := inherited CanExport and
    (IsStandardRule or not Parent.UseOnlyStandardTime);
end;
...
function TcxSchedulerICalendarTimeZoneCustomRule.GetParent
  : TcxSchedulerICalendarTimeZoneObject;
begin
  Result := TcxSchedulerICalendarTimeZoneObject(inherited Parent);
end;
...
begin
  Result := InternalSystemTimeToDateTime
    (GetTimeZoneInformation.TZI.DaylightDate);
end;

function TcxSchedulerICalendarTimeZoneObject.GetStandardDate: TDateTime;
begin
  Result := InternalSystemTimeToDateTime
    (GetTimeZoneInformation.TZI.StandardDate);
end;
...
begin
  ...
  if ICalendar.TimeZone = -1 then
  begin
    if (FInternalTimeZone.TZI.DaylightBias <> 0) and
      (FInternalTimeZone.TZI.Bias <> 0) then
      FInternalTimeZone.TZI.DaylightBias := FInternalTimeZone.TZI.DaylightBias -
        FInternalTimeZone.TZI.Bias;
    ICalendar.TimeZone := TcxSchedulerICalendarDateTimeHelper.
      AddInternalTimeZone(FInternalTimeZone);
  end;
end;
...
function TcxSchedulerICalendarTimeZoneObject.GetTimeZoneInformation
  : TcxTimeZoneInformation;
begin
...
function TcxSchedulerICalendarTimeZoneObject.InternalSystemTimeToDateTime
  (ADate: TSystemTime): TDateTime;
begin
...
function TcxSchedulerICalendarEventDateTimeProperty.GetParent
  : TcxSchedulerICalendarEventObject;
begin
...
procedure TcxSchedulerICalendarEventStartProperty.SetValue
  (const AValue: Variant);
begin
...
function TcxSchedulerICalendarEventCustomProperty.GetParent
  : TcxSchedulerICalendarEventObject;
begin
  Result := TcxSchedulerICalendarEventObject(inherited Parent);
end;
...
var
  AResult: string;
begin
  if (Event.EventType in [etException, etCustom]) and
    ICalendar.PatternIDs.TryGetValue(Event.Pattern.ID, AResult) then
    Result := AResult
  else
  begin
...
procedure TcxSchedulerICalendarEventExDateProperty.SetValue
  (const AValue: Variant);
begin
...
procedure TcxSchedulerICalendarEventRecurrenceIDProperty.SetValue
  (const AValue: Variant);
begin
...
class function TcxSchedulerICalendarRecurrenceCustomValue.FromString
  (AProperty: TcxSchedulerICalendarRecurrenceCustomProperty;
...
const
  RecurrenceTypeMap: array [TcxRecurrence] of string = ('DAILY', 'WEEKLY',
    'MONTHLY', 'YEARLY');
...
var
  ...
  ADate: Variant;
begin
  ADateProperty := TcxSchedulerICalendarRecurrenceUntilProperty.Create
    (AProperty.ICalendar, nil);
  try
    ADateProperty.TimeZone := -1;
    Result := TcxSchedulerICalendarDateTimeParameter.FromString(ADateProperty,
      AValue, ADate);
    if Result then
...
begin
  ...
  begin
    ...
    try
      ADateProperty.TimeZone := -1;
      Result := TcxSchedulerICalendarDateTimeParameter.ToString(ADateProperty,
        AProperty.RecurrenceUntil, AValue);
    finally
      ADateProperty.Free;
    end;
  end;
...
class function TcxSchedulerICalendarRecurrenceByDayValue.FromString
  ...
  function GetDay(const S: string; out ADay: TDay;
    out AWeekNumber: Integer): Boolean;
  var
    I: Integer;
    AWeek: string;
    ADayName: string;
...
begin
  ...
  for I := 0 to ValueParameterCount - 1 do
    ...
    begin
      ...
      Result := Result +
        Format(cxSchedulerICalendarPropertyValueParameterFormat,
        [ValueParameters[I].TokenName, S]);
    end;
end;

procedure TcxSchedulerICalendarRecurrenceCustomProperty.SetValue
  (const AValue: Variant);
...
var
  ...
  I: Integer;
begin
  AStrings := StrSplit(cxSchedulerICalendarParameterDelimiter,
    VarToStr(AValue));
  try
    for I := 0 to AStrings.Count - 1 do
...
function TcxSchedulerICalendarRecurrenceCustomProperty.GetByDayWeek
  (ADay: TDay): Integer;
begin
  Result := cxSchedulerICalendarBySetPosInvalidValue;
end;

procedure TcxSchedulerICalendarRecurrenceCustomProperty.SetByDayWeek(ADay: TDay;
  AValue: Integer);
begin
  // do nothing
end;
...
begin
  Result := TcxSchedulerICalendarRecurrenceCustomValueClass
    (FValueParameters[Index]);
end;

function TcxSchedulerICalendarRecurrenceCustomProperty.
  GetValueParameterCount: Integer;
begin
...
procedure TcxSchedulerICalendarEventRecurrenceProperty.SetValue
  (const AValue: Variant);
begin
...
begin
  Result := [];
  if (RecurrenceInfo.Recurrence <> cxreWeekly) and
  ...
  if RecurrenceInfo.Recurrence = cxreWeekly then
    ...
    case RecurrenceInfo.DayType of
      cxdtWeekDay:
        Result := TcxSchedulerDateTimeHelper.WorkDays;
      cxdtWeekEndDay:
        Result := [dSunday .. dSaturday] - TcxSchedulerDateTimeHelper.WorkDays;
    else
...
begin
  if (RecurrenceInfo.Recurrence in [cxreMonthly, cxreYearly]) and
    (RecurrenceInfo.DayNumber > 0) and (RecurrenceInfo.DayType = cxdtDay) then
...
function TcxSchedulerICalendarEventRecurrenceProperty.GetRecurrenceType
  : TcxRecurrence;
begin
...
function TcxSchedulerICalendarEventRecurrenceProperty.GetRecurrenceUntil
  : TDateTime;
begin
...
procedure TcxSchedulerICalendarEventRecurrenceProperty.SetByMonth
  (AValue: Integer);
begin
  if RecurrenceInfo.Recurrence = cxreYearly then
...
procedure TcxSchedulerICalendarEventRecurrenceProperty.SetByMonthDay
  (AValue: Integer);
begin
...
procedure TcxSchedulerICalendarEventRecurrenceProperty.SetBySetPos
  (AValue: Integer);
begin
...
procedure TcxSchedulerICalendarEventRecurrenceProperty.SetCount
  (AValue: Integer);
begin
  RecurrenceInfo.Count := AValue;
end;

procedure TcxSchedulerICalendarEventRecurrenceProperty.SetInterval
  (AValue: Integer);
begin
...
procedure TcxSchedulerICalendarEventRecurrenceProperty.SetRecurrenceType
  (AValue: TcxRecurrence);
begin
...
procedure TcxSchedulerICalendarEventRecurrenceProperty.SetRecurrenceUntil
  (AValue: TDateTime);
begin
...
function TcxSchedulerICalendarEventRecurrenceProperty.GetEvent
  : TcxSchedulerEvent;
begin
  Result := Parent.Event;
end;

function TcxSchedulerICalendarEventRecurrenceProperty.GetParent
  : TcxSchedulerICalendarEventObject;
begin
  Result := TcxSchedulerICalendarEventObject(inherited Parent);
end;

function TcxSchedulerICalendarEventRecurrenceProperty.GetRecurrenceInfo
  : TcxSchedulerEventRecurrenceInfo;
begin
...
function TcxSchedulerICalendarEventStringProperty.GetParent
  : TcxSchedulerICalendarEventObject;
begin
  Result := TcxSchedulerICalendarEventObject(inherited Parent);
end;
...
procedure TcxSchedulerICalendarEventDescriptionProperty.SetValue
  (const AValue: Variant);
begin
...
procedure TcxSchedulerICalendarEventLocationProperty.SetValue
  (const AValue: Variant);
begin
...
procedure TcxSchedulerICalendarEventSummaryProperty.SetValue
  (const AValue: Variant);
begin
...
const
  StatusMap: array [tlsFree .. tlsOutOfOffice] of string = ('FREE', 'TENTATIVE',
    'BUSY', 'OOF');
...
procedure TcxSchedulerICalendarEventBusyStatusProperty.SetValue
  (const AValue: Variant);
var
  AStatus: Integer;
  I: Integer;
...
procedure TcxSchedulerICalendarEventStatusProperty.SetValue
  (const AValue: Variant);
begin
...
procedure TcxSchedulerICalendarEventLabelProperty.SetValue
  (const AValue: Variant);
begin
...
begin
  ...
  begin
    ...
    Result := Result + ICalendar.Storage.Resources.GetResourceNameByID
      (Event.ResourceIDs[I]);
  end;
end;

procedure TcxSchedulerICalendarEventResourcesProperty.SetValue
  (const AValue: Variant);
  ...
  begin
    ...
    for I := 0 to ICalendar.Storage.ResourceCount - 1 do
      if CompareText(AName, ICalendar.Storage.Resources.GetResourceNameByID
        (ICalendar.Storage.ResourceIDs[I])) = 0 then
      begin
...
function TcxSchedulerICalendarAlarmCustomProperty.GetParent
...
const
  FormatMap: array [Boolean] of string =
    (cxSchedulerICalendarBeforeAlarmTriggerFormat,
    cxSchedulerICalendarAfterAlarmTriggerFormat);
begin
...
procedure TcxSchedulerICalendarAlarmTriggerProperty.SetValue
  (const AValue: Variant);
begin
...
function TcxSchedulerICalendarAlarmObject.GetParent
  : TcxSchedulerICalendarEventObject;
begin
  Result := TcxSchedulerICalendarEventObject(inherited Parent);
end;
...
procedure TcxSchedulerICalendarEventObject.AfterImport(AStrings: TStringList);
  ...
  function GetRecurrenceIndex(APattern: TcxSchedulerEvent;
    ADate: TDateTime): Integer;
  begin
    Result := -1;
    ADate := dxDateOf(ADate);
    with TcxSchedulerEventRecurrenceInfoAccess(APattern.RecurrenceInfo)
      .GetCalculatorClass.Create(APattern, ADate, ADate + 1) do
      try
...
begin
  ...
  if (RecurrenceDate <> InvalidDate) and not VarIsNull(UID) and
    ICalendar.Patterns.TryGetValue(UID, APattern) then
  begin
...
begin
  Result := inherited CanExport and
    (Event.EventType in [etNone, etPattern, etCustom]);
end;
...
class function TcxSchedulerICalendarEventObject.GetRecurrenceDate
  (APattern: TcxSchedulerEvent; ARecurrenceIndex: Integer): TDateTime;
begin
  if ARecurrenceIndex > -1 then
  begin
    with TcxSchedulerEventRecurrenceInfoAccess(APattern.RecurrenceInfo)
      .GetCalculatorClass.Create(APattern, APattern.RecurrenceInfo.Start,
      APattern.RecurrenceInfo.Finish) do
      try
...
function TcxSchedulerICalendarEventObject.GetParent
...
function TcxSchedulerICalendarStorageObject.CanHaveProperty
  (AProperty: TcxSchedulerICalendarCustomPropertyClass): Boolean;
begin
  Result := inherited CanHaveProperty(AProperty) or
    (AProperty = TcxSchedulerICalendarEventObject);
end;
...
function TcxSchedulerICalendarStorageObject.GetStorage
...
function TcxSchedulerICalendar.CanExport
  (AObject: TcxSchedulerICalendarCustomObject): Boolean;
begin
  Result := True;
end;

function TcxSchedulerICalendar.CanImport
  (AObject: TcxSchedulerICalendarCustomObject): Boolean;
begin
  Result := True;
end;

procedure TcxSchedulerICalendar.ExportObject(AObject: TObject;
  AParent: TcxSchedulerICalendarCustomObject; AStrings: TStringList);
var
  AICalendarProperty: TcxSchedulerICalendarCustomProperty;
begin
  AICalendarProperty := cxSchedulerICalendarPropertyManager.
    GetICalendarPropertyClass(AObject).Create(Self, AParent);
  try
...
procedure TcxSchedulerICalendar.ImportObject
  (AParent: TcxSchedulerICalendarCustomObject; AStrings: TStringList);
var
  AImportPropertyClass: TcxSchedulerICalendarCustomPropertyClass;
  AImportProperty: TcxSchedulerICalendarCustomProperty;
begin
  AImportPropertyClass := cxSchedulerICalendarPropertyManager.
    GetICalendarPropertyClass(AStrings[0], AParent);
...
begin
  for Result := 0 to TcxSchedulerDateTimeHelper.TimeZoneCount - 1 do
    if (CompareText(AName, TcxSchedulerDateTimeHelper.TimeZoneInfo(Result)
      .Display) = 0) or
      (CompareText(AName, TcxSchedulerDateTimeHelper.TimeZoneInfo(Result)
      .StandardName) = 0) or
      (CompareText(AName, TcxSchedulerDateTimeHelper.TimeZoneInfo(Result)
      .DaylightName) = 0) then
      Exit;
...
begin
  ...
  try
    cxSchedulerICalendarProdID := '-//' + AInfo.CompanyName + '//' +
      AInfo.ProductName + '//' + AInfo.Language;
  finally
    AInfo.Free;
  end;
end;
