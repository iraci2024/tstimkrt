...
uses
  ...
  dxCore, cxLookAndFeelPainters, cxButtons, cxRadioGroup, cxSchedulerStorage,
  cxGraphics, cxLookAndFeels,
  cxControls, cxContainer, cxEdit, cxLabel, dxLayoutLookAndFeels, cxClasses,
...
begin
  ...
  begin
    ...
    lbMessage.Caption := AEventCaption + cxGetResourceString
