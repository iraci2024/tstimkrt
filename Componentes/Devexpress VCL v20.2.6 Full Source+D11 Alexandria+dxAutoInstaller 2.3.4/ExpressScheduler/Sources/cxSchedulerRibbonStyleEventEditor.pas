...
{$ENDIF}
  ...
  dxRibbonSkins, cxSchedulerEditorFormManager, dxLayoutContainer,
  dxLayoutControl,
...
type
  ...
  TcxShedulerRibbonStyleEventEditorFormStyleInfo = class
  ...
  public
    ...
    class procedure InitialRibbonStyle
      (AEditor: IcxSchedulerEventEditorForm); virtual;
  end;

  { TcxShedulerRibbon2010StyleEventEditorFormStyleInfo }

  TcxShedulerRibbon2010StyleEventEditorFormStyleInfo = class
    (TcxShedulerRibbonStyleEventEditorFormStyleInfo)
  public
    class function GetName: string; override;
    class procedure InitialRibbonStyle
      (AEditor: IcxSchedulerEventEditorForm); override;
  end;

  { TcxShedulerRibbon2013StyleEventEditorFormStyleInfo }

  TcxShedulerRibbon2013StyleEventEditorFormStyleInfo = class
    (TcxShedulerRibbonStyleEventEditorFormStyleInfo)
  public
    class function GetName: string; override;
    class procedure InitialRibbonStyle
  ...
  TcxShedulerRibbon2016StyleEventEditorFormStyleInfo = class
    (TcxShedulerRibbonStyleEventEditorFormStyleInfo)
  public
    class function GetName: string; override;
    class procedure InitialRibbonStyle
  ...
  TcxShedulerRibbon2016TabletStyleEventEditorFormStyleInfo = class
    (TcxShedulerRibbonStyleEventEditorFormStyleInfo)
  public
    class function GetName: string; override;
    class procedure InitialRibbonStyle
  ...
  TcxShedulerRibbon2019StyleEventEditorFormStyleInfo = class
    (TcxShedulerRibbonStyleEventEditorFormStyleInfo)
  public
    class function GetName: string; override;
    class procedure InitialRibbonStyle
  ...
  TcxSchedulerEventRibbonStyleEditorFormHelper = class
    (TcxSchedulerEventEditorFormHelper);
  TcxSchedulerEventRibbonStyleEditorFormHelperClass = class of
    TcxSchedulerEventRibbonStyleEditorFormHelper;

  { TcxSchedulerEventRibbonEditorForm }

  TcxSchedulerEventRibbonStyleEditorForm = class(TdxRibbonForm,
  ...
  protected
    ...
    function GetHelperClass
      : TcxSchedulerEventRibbonStyleEditorFormHelperClass; virtual;
  ...
  TcxSchedulerEventRibbonStyleEditor = TcxSchedulerEventRibbonStyleEditorForm;
  // workaround for Delphi 2005

  TcxSchedulerEventRibbonStyleEditorClass = class of
    TcxSchedulerEventRibbonStyleEditorForm;
...
class procedure TcxShedulerRibbonStyleEventEditorFormStyleInfo.
  InitialRibbonStyle(AEditor: IcxSchedulerEventEditorForm);
begin
end;

{ TcxShedulerRibbon2010StyleEventEditorFormStyleInfo }

class function TcxShedulerRibbon2010StyleEventEditorFormStyleInfo.
  GetName: string;
begin
  Result := 'Ribbon2010';
end;

class procedure TcxShedulerRibbon2010StyleEventEditorFormStyleInfo.
  InitialRibbonStyle(AEditor: IcxSchedulerEventEditorForm);
begin
...
class function TcxShedulerRibbon2013StyleEventEditorFormStyleInfo.
  GetName: string;
begin
  Result := 'Ribbon2013';
end;

class procedure TcxShedulerRibbon2013StyleEventEditorFormStyleInfo.
  InitialRibbonStyle(AEditor: IcxSchedulerEventEditorForm);
begin
...
class function TcxShedulerRibbon2016StyleEventEditorFormStyleInfo.
  GetName: string;
begin
  Result := 'Ribbon2016';
end;

class procedure TcxShedulerRibbon2016StyleEventEditorFormStyleInfo.
  InitialRibbonStyle(AEditor: IcxSchedulerEventEditorForm);
begin
  TcxSchedulerEventRibbonStyleEditorForm(AEditor.Form).DisableAero := True;
...
class function TcxShedulerRibbon2016TabletStyleEventEditorFormStyleInfo.
  GetName: string;
begin
  Result := 'Ribbon2016Tablet';
end;

class procedure TcxShedulerRibbon2016TabletStyleEventEditorFormStyleInfo.
  InitialRibbonStyle(AEditor: IcxSchedulerEventEditorForm);
begin
  TcxSchedulerEventRibbonStyleEditorForm(AEditor.Form).DisableAero := True;
  TcxSchedulerEventRibbonStyleEditorForm(AEditor.Form).Ribbon.Style :=
    rs2016Tablet;
  TcxSchedulerEventRibbonStyleEditorForm(AEditor.Form).beiLabel.Links[0]
    .BeginGroup := True;
end;

{ TcxShedulerRibbon2019StyleEventEditorFormStyleInfo }

class function TcxShedulerRibbon2019StyleEventEditorFormStyleInfo.
  GetName: string;
begin
  Result := 'Ribbon2019';
end;

class procedure TcxShedulerRibbon2019StyleEventEditorFormStyleInfo.
  InitialRibbonStyle(AEditor: IcxSchedulerEventEditorForm);
begin
  TcxSchedulerEventRibbonStyleEditorForm(AEditor.Form).DisableAero := True;
...
constructor TcxSchedulerEventRibbonStyleEditorForm.CreateEx
...
procedure TcxSchedulerEventRibbonStyleEditorForm.acCloseExecute
  (Sender: TObject);
begin
  Helper.ExecuteAction(mrCancel);
end;

procedure TcxSchedulerEventRibbonStyleEditorForm.acDeleteExecute
  (Sender: TObject);
begin
...
function TcxSchedulerEventRibbonStyleEditorForm.CheckTimeRange(var AStart,
...
procedure TcxSchedulerEventRibbonStyleEditorForm.CreateParams
...
procedure TcxSchedulerEventRibbonStyleEditorForm.GetEditingEventTime(var AStart,
...
function TcxSchedulerEventRibbonStyleEditorForm.GetHelperClass
  : TcxSchedulerEventRibbonStyleEditorFormHelperClass;
begin
  Result := TcxSchedulerEventRibbonStyleEditorFormHelper;
end;

function TcxSchedulerEventRibbonStyleEditorForm.
...
function TcxSchedulerEventRibbonStyleEditorForm.
  GetResourcesPanelVisible: Boolean;
begin
  Result := Helper.ShowResources;
end;

function TcxSchedulerEventRibbonStyleEditorForm.GetStorage
  : TcxCustomSchedulerStorage;
begin
  Result := Helper.Storage;
end;

procedure TcxSchedulerEventRibbonStyleEditorForm.Initialize
...
procedure TcxSchedulerEventRibbonStyleEditorForm.
  InitializationRibbonColorScheme;
begin
...
procedure TcxSchedulerEventRibbonStyleEditorForm.DoApplyEventTime
  (Sender: TObject);
begin
  ApplyEventTime;
end;
...
function TcxSchedulerEventRibbonStyleEditorForm.GetEvent
...
procedure TcxSchedulerEventRibbonStyleEditorForm.HelperChangedHandler
  (Sender: TObject);
begin
  DoHelperChanged;
end;
...
procedure TcxSchedulerEventRibbonStyleEditorForm.HelperSaveChangesHandler
  (Sender: TObject);
begin
...
procedure TcxSchedulerEventRibbonStyleEditorForm.SetForceSeries
  (AValue: Boolean);
begin
...
procedure TcxSchedulerEventRibbonStyleEditorForm.WMActivate
...
procedure TcxSchedulerEventRibbonStyleEditorForm.EditorsChanged
  (Sender: TObject);
begin
...
procedure TcxSchedulerEventRibbonStyleEditorForm.FormClose(Sender: TObject;
...
procedure TcxSchedulerEventRibbonStyleEditorForm.FormKeyDown(Sender: TObject;
...
procedure TcxSchedulerEventRibbonStyleEditorForm.cbAllDayEventPropertiesChange
  (Sender: TObject);
var
  ACanCorrect: Boolean;
begin
  ACanCorrect := beiShowTimeAs.EditValue = cxOriginalEventStates
    [Event.AllDayEvent];
  Event.AllDayEvent := cbAllDayEvent.Checked;
  if ACanCorrect then
...
procedure TcxSchedulerEventRibbonStyleEditorForm.StartDateChanged
  (Sender: TObject);
begin
  EditorsChanged(nil);
...
procedure TcxSchedulerEventRibbonStyleEditorForm.cbReminderClick
  (Sender: TObject);
begin
  Modified := True;
  cbReminderMinutesBeforeStart.Enabled := cbReminder.Checked;
...
procedure TcxSchedulerEventRibbonStyleEditorForm.EventTimeChanged
  (Sender: TObject);
begin
  EditorsChanged(Sender);
end;

procedure TcxSchedulerEventRibbonStyleEditorForm.OnResourceIDChanged
  (Sender: TObject);
begin
  Modified := True;
end;

procedure TcxSchedulerEventRibbonStyleEditorForm.btnFindTimeClick
  (Sender: TObject);
begin
