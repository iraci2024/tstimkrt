...
uses
  Types, Windows, Classes, SysUtils, Graphics, DB, RTLConsts, dxCoreClasses,
  cxDB, cxDBData, cxSchedulerStorage,
...
type
  ...
  public
    constructor Create(ADataController
      : TcxSchedulerDBStorageDataController); virtual;

    property DataController: TcxSchedulerDBStorageDataController
  ...
  private
    ...
    procedure SetItem(AIndex: Integer;
      const AValue: TcxSchedulerDBStorageField);
  protected
    function FindFieldByName(const AName: string)
      : TcxCustomSchedulerStorageField; override;
  public
    function Add: TcxSchedulerDBStorageField;
    function ItemByFieldName(const AFieldName: string)
      : TcxSchedulerDBStorageField;

    property Items[Index: Integer]: TcxSchedulerDBStorageField read GetItem
      write SetItem;
  end;
  ...
  protected
    ...
    property ReminderTime: TcxFieldName index 10 read GetFieldName
      write SetFieldName;
  public
    ...
    property DataController: TcxSchedulerDBStorageDataController
      read GetDataController;
  published
    property ActualFinish: TcxFieldName index 15 read GetFieldName
      write SetFieldName;
    property ActualStart: TcxFieldName index 16 read GetFieldName
      write SetFieldName;
    property Caption: TcxFieldName index 0 read GetFieldName write SetFieldName;
    property GroupID: TcxFieldName index 22 read GetFieldName
      write SetFieldName;
    property EventType: TcxFieldName index 1 read GetFieldName
      write SetFieldName;
    ...
    property LabelColor: TcxFieldName index 3 read GetFieldName
      write SetFieldName;
    property Location: TcxFieldName index 4 read GetFieldName
      write SetFieldName;
    ...
    property ParentID: TcxFieldName index 7 read GetFieldName
      write SetFieldName;
    property RecurrenceIndex: TcxFieldName index 8 read GetFieldName
      write SetFieldName;
    property RecurrenceInfo: TcxFieldName index 9 read GetFieldName
      write SetFieldName;
    property ReminderDate: TcxFieldName index 10 read GetFieldName
      write SetFieldName;
    property ReminderMinutesBeforeStart: TcxFieldName index 11 read GetFieldName
      write SetFieldName;
    property ReminderResourcesData: TcxFieldName index 21 read GetFieldName
      write SetFieldName;
    property ResourceID: TcxFieldName index 12 read GetFieldName
      write SetFieldName;
    ...
    property TaskCompleteField: TcxFieldName index 17 read GetFieldName
      write SetFieldName;
    property TaskIndexField: TcxFieldName index 18 read GetFieldName
      write SetFieldName;
    property TaskLinksField: TcxFieldName index 19 read GetFieldName
      write SetFieldName;
    property TaskStatusField: TcxFieldName index 20 read GetFieldName
      write SetFieldName;
  end;
  ...
  protected
    function CreateDataController
      : TcxSchedulerDBStorageResourceDataController; virtual;
    ...
    procedure InitDataItem(AItem: TcxSchedulerStorageResourceItem;
      AIndex: Integer); virtual;
    procedure SetInternalFieldName(var AFieldName: TcxFieldName;
      const AValue: TcxFieldName; var AField: TcxDBDataField);
    procedure UpdateResourceItems; virtual;
    property DataController: TcxSchedulerDBStorageResourceDataController
      read FDataController;
    ...
    property ResourceImageIndexField: TcxDBDataField
      read FResourceImageIndexField;
    ...
    property ResourceWorkFinishField: TcxDBDataField
      read FResourceWorkFinishField;
    property ResourceWorkStartField: TcxDBDataField
      read FResourceWorkStartField;
  public
  ...
  published
    ...
    property ResourceColor: TcxFieldName read FResourceColorFieldName
      write SetResourceColorFieldName;
    property ResourceID: TcxFieldName read FResourceIDFieldName
      write SetResourceIDFieldName;
    property ResourceImageIndex: TcxFieldName read FResourceImageIndexFieldName
      write SetResourceImageIndexFieldName;
    property ResourceName: TcxFieldName read FResourceNameFieldName
      write SetResourceNameFieldName;
    property ResourceVisible: TcxFieldName read FResourceVisibleFieldName
      write SetResourceVisibleFieldName;
    property ResourceWorkDays: TcxFieldName read FResourceWorkDaysFieldName
      write SetResourceWorkDaysFieldName;
    property ResourceWorkFinish: TcxFieldName read FResourceWorkFinishFieldName
      write SetResourceWorkFinishFieldName;
    property ResourceWorkStart: TcxFieldName read FResourceWorkStartFieldName
      write SetResourceWorkStartFieldName;
    property Images;
    property Items;
    property OnGetResourceImageIndex;
    property OnGetResourceName;
    property OnResourceLoaded: TcxSchedulerResourceEvent read FOnResourceLoaded
      write FOnResourceLoaded;
  end;

  TcxSchedulerGetEventGeneratedIDEvent = procedure
    (Sender: TcxSchedulerDBStorage; AEvent: TcxSchedulerEvent;
    var EventID: Variant) of object;
  ...
  protected
    ...
    function DoGetEventGeneratedID(AEvent: TcxSchedulerEvent;
      const AEventID: Variant): Variant; virtual;
    ...
    function GetFieldValueTypeClass(AField: TcxCustomSchedulerStorageField)
      : TcxValueTypeClass; override;
    procedure Notification(AComponent: TComponent;
      Operation: TOperation); override;
    function MakeFocused(AEvent: TcxSchedulerEvent): Boolean;
    procedure RelateFields(AStorageField: TcxSchedulerDBStorageField;
      AField: TField);
    ...
    property UpdatingEvent: TcxSchedulerEvent read FUpdatingEvent
      write FUpdatingEvent;
  public
    procedure Assign(Source: TPersistent); override;
  ...
  published
    property GenerateGUIDForID: Boolean read FGenerateGUIDForID
      write FGenerateGUIDForID default False;
    property Reminders;
    property Resources: TcxSchedulerDBStorageResources read GetResources
      write SetResources;
    property SmartRefresh: Boolean read FSmartRefresh write SetSmartRefresh
      default False;
    property CustomFields: TcxSchedulerDBStorageFields read GetCustomFields
      write SetCustomFields;
    property Holidays;
    property DataSource: TDataSource read GetDataSource write SetDataSource;
    property FieldNames: TcxSchedulerDBStorageFieldNames read FFieldNames
      write SetFieldNames;
    property UseIndexedID: Boolean read FUseIndexedID write SetUseIndexedID
      default False;
    ...
    property OnGetEventGeneratedID: TcxSchedulerGetEventGeneratedIDEvent
...
type
  ...
  TcxSchedulerStorageResourceItemAccess = class
    (TcxSchedulerStorageResourceItem);

function CheckAndSetFieldValue(AField: TField; const AValue: Variant): Boolean;
begin
  Result := (AField <> nil) and AField.CanModify and
    ((VarType(AField.Value) <> VarType(AValue)) or VarIsSoftNull(AField.Value)
    or not VarEqualsSoft(AField.Value, AValue));
  if Result then
...
function cxFindEvent(AList: TdxFastList; const ID: Variant;
  var AEvent: TcxSchedulerEvent): Boolean;
var
  L, H, I, C: Integer;
begin
  Result := False;
...
constructor TcxSchedulerDataLink.Create(ADataController
  : TcxSchedulerDBStorageDataController);
begin
  inherited Create;
...
function TcxSchedulerDBStorageDataController.GetItem(Index: Integer): TObject;
begin
...
function TcxSchedulerDBStorageDataController.GetItemID(AItem: TObject): Integer;
begin
...
function TcxSchedulerDBStorageField.GetDataController
  : TcxSchedulerDBStorageDataController;
begin
...
procedure TcxSchedulerDBStorageField.SetFieldName(const AValue: string);
begin
...
function TcxSchedulerDBStorageFields.ItemByFieldName(const AFieldName: string)
  : TcxSchedulerDBStorageField;
begin
  Result := TcxSchedulerDBStorageField(FindFieldByName(AFieldName));
end;

function TcxSchedulerDBStorageFields.FindFieldByName(const AName: string)
...
begin
  ...
  begin
    ...
    if AnsiSameText(AName, TcxSchedulerDBStorageField(Result).FieldName) then
      Exit;
  end;
  Result := nil;
end;

function TcxSchedulerDBStorageFields.GetItem(AIndex: Integer)
  : TcxSchedulerDBStorageField;
begin
  Result := TcxSchedulerDBStorageField(inherited Items[AIndex])
end;

procedure TcxSchedulerDBStorageFields.SetItem(AIndex: Integer;
  const AValue: TcxSchedulerDBStorageField);
begin
...
procedure TcxSchedulerDBStorageFieldNames.Assign(Source: TPersistent);
var
  I: Integer;
begin
...
function TcxSchedulerDBStorageFieldNames.GetDataController
  : TcxSchedulerDBStorageDataController;
begin
  Result := FOwner.DataController;
end;

function TcxSchedulerDBStorageFieldNames.GetFieldName(AIndex: Integer)
  : TcxFieldName;
begin
  Result := TcxSchedulerDBStorageField(Storage.InternalFields.Items[AIndex])
    .FieldName;
end;
...
procedure TcxSchedulerDBStorageFieldNames.SetFieldName(AIndex: Integer;
  const AValue: TcxFieldName);
begin
  TcxSchedulerDBStorageField(Storage.InternalFields.Items[AIndex]).FieldName
    := AValue;
end;
...
procedure TcxSchedulerDBStorageResources.Assign(Source: TPersistent);
begin
  ...
  begin
    ...
    ResourceImageIndex := TcxSchedulerDBStorageResources(Source)
      .ResourceImageIndex;
    ...
    ResourceWorkFinish := TcxSchedulerDBStorageResources(Source)
      .ResourceWorkFinish;
    ResourceWorkStart := TcxSchedulerDBStorageResources(Source)
      .ResourceWorkStart;
  end;
end;

function TcxSchedulerDBStorageResources.CreateDataController
  : TcxSchedulerDBStorageResourceDataController;
begin
  Result := TcxSchedulerDBStorageResourceDataController.Create(Storage);
end;

procedure TcxSchedulerDBStorageResources.DoResourceLoaded
...
function TcxSchedulerDBStorageResources.GetResourceItems
...
begin
  ...
  begin
    ...
    FWorkDays := cxIntegerToDays(GetValueDef(AIndex, ResourceWorkDaysField,
      cxDaysToInteger(DateTimeHelper.WorkDays)));
    FWorkFinish := GetValueDef(AIndex, ResourceWorkFinishField,
      DateTimeHelper.WorkFinish);
    FWorkStart := GetValueDef(AIndex, ResourceWorkStartField,
      DateTimeHelper.WorkStart);
  end;
end;
        ...
        for J := 0 to APrevItems.Count - 1 do
          ...
          begin
            ...
            begin
              ...
              FWorkDays := cxIntegerToDays(GetValueDef(I, ResourceWorkDaysField,
                cxDaysToInteger(WorkDays)));
              FWorkFinish := GetValueDef(I, ResourceWorkFinishField,
                WorkFinish);
...
procedure TcxSchedulerDBStorageResources.SetDataSource(AValue: TDataSource);
begin
...
procedure TcxSchedulerDBStorageResources.SetResourceImageIndexFieldName
  (const AValue: TcxFieldName);
begin
  SetInternalFieldName(FResourceImageIndexFieldName, AValue,
    FResourceImageIndexField);
end;
...
procedure TcxSchedulerDBStorageResources.SetResourceVisibleFieldName
  (const AValue: TcxFieldName);
begin
  SetInternalFieldName(FResourceVisibleFieldName, AValue,
    FResourceVisibleField);
end;

procedure TcxSchedulerDBStorageResources.SetResourceWorkDaysFieldName
  (const AValue: TcxFieldName);
begin
  SetInternalFieldName(FResourceWorkDaysFieldName, AValue,
    FResourceWorkDaysField);
end;

procedure TcxSchedulerDBStorageResources.SetResourceWorkFinishFieldName
  (const AValue: TcxFieldName);
begin
  SetInternalFieldName(FResourceWorkFinishFieldName, AValue,
    FResourceWorkFinishField);
end;

procedure TcxSchedulerDBStorageResources.SetResourceWorkStartFieldName
  (const AValue: TcxFieldName);
begin
  SetInternalFieldName(FResourceWorkStartFieldName, AValue,
    FResourceWorkStartField);
end;
...
function TcxSchedulerDBStorage.AddEventRecord
...
procedure TcxSchedulerDBStorage.BeforePostEditingData
  (AEvent: TcxSchedulerEvent);
begin
  MakeFocused(AEvent);
...
function TcxSchedulerDBStorage.CreateFieldNames
  : TcxSchedulerDBStorageFieldNames;
begin
...
function TcxSchedulerDBStorage.GetFieldLink(AField: TField)
  : TcxSchedulerDBFieldLink;
var
  I: Integer;
begin
  ...
  begin
    ...
    if Result.Field = AField then
      Exit;
  end;
  Result := nil;
end;

function TcxSchedulerDBStorage.GetFieldLinkByIndex(AFieldIndex: Integer)
  : TcxSchedulerDBFieldLink;
begin
...
function TcxSchedulerDBStorage.GetDataControllerClass
...
procedure TcxSchedulerDBStorage.Notification(AComponent: TComponent;
  Operation: TOperation);
var
  I: Integer;
begin
  inherited Notification(AComponent, Operation);
  if (Operation <> opRemove) or IsDestroying then
    Exit;
...
function TcxSchedulerDBStorage.MakeFocused(AEvent: TcxSchedulerEvent): Boolean;
begin
...
procedure TcxSchedulerDBStorage.RelateFields(AStorageField
  : TcxSchedulerDBStorageField; AField: TField);
var
...
begin
  ...
  if (ALink = nil) or (ALink.RefCount = 1) then
    Exit;
  for I := 0 to FieldCount - 1 do
    if (I <> AFieldIndex) and (TcxSchedulerDBStorageField(Fields[I])
      .FieldLink = ALink) then
      inherited SetValue(ARecordHandle, I, AValue);
end;

procedure TcxSchedulerDBStorage.SetValueBeforePost(AEvent: TcxSchedulerEvent;
  AItemIndex: Integer);
var
...
begin
  ...
  begin
    if not IsLoading and not IsDestroying and DataController.DataLink.Active
    then
      DataController.Initialize;
    if not IsDataSettingsValid then
    begin
...
procedure TcxSchedulerDBStorage.UpdateEventFieldValue(AEvent: TcxSchedulerEvent;
  AField: TField);
var
  I: Integer;
  AValue: Variant;
  ...
  begin
    ...
    begin
      ...
      if AUpdateField.GetIsTextStored then
        TcxDataStorageHelper.SetDisplayText(AEvent.RecordHandle,
          AUpdateField.ValueDef, AField.DisplayText);
    end;
  end;
end;

function TcxSchedulerDBStorage.GetDataController
  : TcxSchedulerDBStorageDataController;
begin
  Result := TcxSchedulerDBStorageDataController(inherited DataController);
end;
...
procedure TcxSchedulerDBStorage.SetDataSource(AValue: TDataSource);
begin
  DataController.DataLink.DataSource := AValue;
end;

procedure TcxSchedulerDBStorage.SetCustomFields(const AValue
  : TcxSchedulerDBStorageFields);
begin
