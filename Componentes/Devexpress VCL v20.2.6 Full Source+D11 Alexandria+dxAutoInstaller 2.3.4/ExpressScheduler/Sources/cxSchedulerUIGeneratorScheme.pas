...
begin
  ...
  ACategory.Add(TdxSchedulerGoToToday, dxUIGeneratorItemDefaultViewLevels,
    ugigpNone, ugipBeginsNewRow, True);
  ACategory.Add(TdxSchedulerGoToDate);

  ACategory.Add(TdxSchedulerNextSevenDays, dxUIGeneratorItemDefaultViewLevels,
    ugigpNone, ugipBeginsNewRow, True);
end;
...
begin
  ACommand := ACategory.Add('Scheduling\SwitchTimeScalesTo.png',
    sdxSchedulerSubItemViewTimeScaleTimeScale);
...
begin
  ...
  ACategory.Add(TdxSchedulerDateNavigator, dxUIGeneratorItemDefaultViewLevels,
    ugigpNone, ugipBeginsNewRow, True);
...
begin
  AComponent := TdxUIGenerator.RegisterComponent(TcxScheduler,
    sdxSchedulerActionsCategoryName);

  RegisterCategoryEvent(AComponent.Add(sdxSchedulerTabHome,
    sdxSchedulerBarHomeEvent, 'Scheduling\Appointment_16x16.png', 0));
  RegisterCategoryNavigation(AComponent.Add(sdxSchedulerTabHome,
    sdxSchedulerBarHomeNavigation, 'Scheduling\GoToDate_16x16.png', 0));
  RegisterCategoryArrange(AComponent.Add(sdxSchedulerTabHome,
    sdxSchedulerBarHomeArrange, 'Scheduling\FullWeekView_16x16.png', 0));
  RegisterCategoryGroupBy(AComponent.Add(sdxSchedulerTabHome,
    sdxSchedulerBarHomeGroupBy, 'Scheduling\GroupByDate_16x16.png', 0));

  RegisterCategoryTimeScale(AComponent.Add(sdxSchedulerTabView,
    sdxSchedulerBarViewTimeScale,
    'Scheduling\SwitchTimeScalesTo_16x16.png', 1));
  RegisterCategoryLayout(AComponent.Add(sdxSchedulerTabView,
    sdxSchedulerBarViewLayout,
    'Scheduling\ResourcesLayoutEditor_16x16.png', 1));
end;
