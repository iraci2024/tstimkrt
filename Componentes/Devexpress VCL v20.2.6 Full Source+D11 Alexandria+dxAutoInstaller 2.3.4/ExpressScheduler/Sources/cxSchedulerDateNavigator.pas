...
{$ENDIF}
  ...
  dxCore, cxLookAndFeels, cxSchedulerCustomControls, cxSchedulerUtils,
...
type
  ...
  TcxSchedulerDateNavigatorViewInfoClass = class of
  ...
  private
    ...
    function DrawHeaderBackground(ACanvas: TcxCanvas;
      const ABounds: TRect): Boolean;
    function GetHolidayTextColor(ADayInfo
      : TcxSchedulerDateNavigatorDayNumberViewInfo): TColor;
    function GetLookAndFeelPainter: TcxCustomLookAndFeelPainter;
    function GetViewStyle: TcxSchedulerViewStyle;
  protected
    procedure DoDrawDayCaptions(AViewInfo
      : TcxSchedulerDateNavigatorMonthContentViewInfo); virtual;
    procedure DoDrawDayNumbers(AViewInfo
      : TcxSchedulerDateNavigatorMonthContentViewInfo); virtual;
    procedure DoDrawMonthContent(AViewInfo
      : TcxSchedulerDateNavigatorMonthContentViewInfo); virtual;
    procedure DoDrawMonthHeader(AViewInfo
      : TcxSchedulerDateNavigatorMonthHeaderViewInfo); virtual;
    procedure DrawBackground; virtual;
    procedure DrawDayNumber(ADayInfo
      : TcxSchedulerDateNavigatorDayNumberViewInfo);
    procedure DrawMonthHeader(AViewInfo
      : TcxSchedulerDateNavigatorMonthHeaderViewInfo); virtual;
    procedure DrawMonthHeaderClassic(AViewInfo
      : TcxSchedulerDateNavigatorMonthHeaderViewInfo); virtual;
    procedure DrawMonthHeaderModern(AViewInfo
      : TcxSchedulerDateNavigatorMonthHeaderViewInfo); virtual;
    procedure DrawSeparators(AViewInfo
      : TcxSchedulerDateNavigatorMonthContentViewInfo); virtual;
    procedure DrawWeekNumbers(AViewInfo
      : TcxSchedulerDateNavigatorMonthContentViewInfo); virtual;
  ...
  TcxSchedulerDateNavigatorPainterClass = class of
    TcxSchedulerDateNavigatorPainter;
  ...
  TcxSchedulerDateNavigatorMonthHeaderViewInfo = class
    (TcxSchedulerDateNavigatorCaptionViewInfo, IcxMouseTrackingCaller)
  private
  ...
  private
    ...
    FDate: TcxDateTime;
    FDateNavigator: TcxSchedulerDateNavigator;
    FDays: array [0 .. cxMaxMonthViewInfoDays - 1]
      of TcxSchedulerDateNavigatorDayNumberViewInfo;
    FDayCount: Integer;
    ...
    function GetCalendar: TcxCustomCalendarTable;
    function GetDayCaptionInfo(Index: Byte)
      : TcxSchedulerDateNavigatorDayCaptionViewInfo;
    function GetDayRectFromColAndRow(ACol, ARow: Integer): TRect;
    function GetDayNumberViewInfo(Index: Byte)
      : TcxSchedulerDateNavigatorDayNumberViewInfo;
    function GetEra: Integer;
    function GetGrayed(ADate: TDateTime): Boolean;
    function GetMonth: Integer;
    function GetSelectionSideBounds(const ADayBounds: TRect;
      ACol: Integer): TRect;
    function GetYear: Integer;
  ...
  protected
    ...
    procedure DoRightToLeftConversion(const AClientBounds: TRect); virtual;
    function GetDateViewParams(ADate: TDateTime; ASelected: Boolean)
  ...
  public
    ...
    property Days[Index: Byte]: TcxSchedulerDateNavigatorDayNumberViewInfo
      read GetDayNumberViewInfo;
    property DayCaptions[Index: Byte]
      : TcxSchedulerDateNavigatorDayCaptionViewInfo read GetDayCaptionInfo;
    property Era: Integer read GetEra;
  ...
  public
    ...
    property Bounds: TRect read FBounds;
    property Col: Integer read FCol;
    property Content: TcxSchedulerDateNavigatorMonthContentViewInfo
      read FContent;
    property Era: Integer read GetEra;
  ...
  private
    ...
    function GetCalendar: TcxCustomCalendarTable;
    function GetMonthViewInfo(ACol, ARow: Integer)
      : TcxSchedulerDateNavigatorMonthViewInfo;
  protected
  ...
  public
    ...
    property MonthViewInfo[ACol, ARow: Integer]
      : TcxSchedulerDateNavigatorMonthViewInfo read GetMonthViewInfo;
  end;
  ...
  published
    property Background: TcxStyle index cxdnBackground read GetValue
      write SetValue;
    ...
    property Selection: TcxStyle index cxdnSelection read GetValue
      write SetValue;
  end;
  ...
  public
    ...
    property HitAtTime;
    property HitAtWeekSelectionBar: Boolean index htcWeekSelectionBar
      read GetBitState;
    property HitDate: TDateTime read FHitDate;
    property MonthViewInfo: TcxSchedulerDateNavigatorMonthViewInfo
      read FMonthViewInfo;
    property Time;
  end;
  ...
  TcxSchedulerDateNavigatorCustomDrawBackgroundEvent = procedure
    (Sender: TObject; ACanvas: TcxCanvas; const ABounds: TRect;
    var AViewParams: TcxViewParams; var ADone: Boolean) of object;
  ...
  TcxSchedulerDateNavigatorCustomDrawDayCaptionEvent = procedure
    (Sender: TObject; ACanvas: TcxCanvas;
    AViewInfo: TcxSchedulerDateNavigatorDayCaptionViewInfo; var ADone: Boolean)
    of object;
  ...
  protected
    ...
    //
    function AllowDesignHitTest(X, Y: Integer; Shift: TShiftState)
      : Boolean; override;
    ...
    procedure ShowMonthPopup(AMonthInfo
      : TcxSchedulerDateNavigatorMonthViewInfo); virtual;
    ...
    // support custom draw
    procedure AfterCustomDraw(ACanvas: TcxCanvas;
      var AParams: TcxViewParams); virtual;
    procedure BeforeCustomDraw(ACanvas: TcxCanvas;
      const AParams: TcxViewParams); virtual;
    function DoCustomDrawBackground(ACanvas: TcxCanvas; const ABounds: TRect;
      var AViewParams: TcxViewParams): Boolean; virtual;
    ...
    function DoCustomDrawDayCaption(ACanvas: TcxCanvas;
      ADayCaptionInfo: TcxSchedulerDateNavigatorDayCaptionViewInfo)
      : Boolean; virtual;
    ...
    property UnlimitedSelection: Boolean read FUnlimitedSelection
      write SetUnlimitedSelection;
    property ViewInfo: TcxSchedulerDateNavigatorViewInfo read GetViewInfo;
  public
    ...
    property ActualFirstWeekOfYear: TcxFirstWeekOfYear
      read FActualFirstWeekOfYear;
    ...
    property SelectionIsWeeks: Boolean read FSelectionIsWeeks
      write FSelectionIsWeeks;
  ...
  published
    ...
    property FirstWeekOfYear: TcxFirstWeekOfYear read FFirstWeekOfYear
      write SetFirstWeekOfYear default fwySystem;
    property HolidayColor: TColor read FHolidayColor write SetHolidayColor
      default cxSchedulerDefaultHolidayColor;
    ...
    property ShowDatesContainingEventsInBold: Boolean
      ...
      write SetShowDatesContainingEventsInBold default True;
    property ShowDatesContainingHolidaysInColor: Boolean
      read FShowDatesContainingHolidaysInColor
      write SetShowDatesContainingHolidaysInColor default False;
    property ShowWeekNumbers: Boolean read FShowWeekNumbers
      write SetShowWeekNumbers default True;
    property Styles: TcxSchedulerDateNavigatorStyles read FStyles
      write SetStyles;
    property Visible default True;

    property OnCustomDrawBackground
      : TcxSchedulerDateNavigatorCustomDrawBackgroundEvent
      read FOnCustomDrawBackground write FOnCustomDrawBackground;
    property OnCustomDrawDayCaption
      : TcxSchedulerDateNavigatorCustomDrawDayCaptionEvent
      read FOnCustomDrawDayCaption write FOnCustomDrawDayCaption;
    property OnCustomDrawDayNumber
      : TcxSchedulerDateNavigatorCustomDrawDayNumberEvent
      read FOnCustomDrawDayNumber write FOnCustomDrawDayNumber;
    property OnCustomDrawContent
      : TcxSchedulerDateNavigatorCustomDrawContentEvent
    ...
    property OnPeriodChanged: TcxSchedulerPeriodChangedEvent
      read FOnPeriodChanged write FOnPeriodChanged;
    property OnSelectionChanged: TcxSchedulerPeriodChangedEvent
...
begin
  ...
  if AFirstDay then
    ...
    AConvertDate.Day := ACalendar.GetDaysInMonth(AConvertDate.Year,
      AConvertDate.Month);
  Result := Trunc(ACalendar.ToDateTime(AConvertDate));
end;

function CheckDay(ADate: TcxDateTime;
  ACalendar: TcxCustomCalendarTable): Integer;
begin
  with ADate do
    if Day < 1 then
      Result := 1
    else if Day > ACalendar.GetDaysInMonth(Era, Year, Month) then
...
begin
  ...
  TopDate := ADate;
  FOrigin.X := Max(GetDesktopRect.Left, (R.Left + R.Right) div 2 - Width div 2);
  FOrigin.Y := Max(GetDesktopRect.Top, (R.Top + R.Bottom) div 2 - Height div 2);
  FItemIndex := 3;
end;
...
function TcxSchedulerMonthListBox.GetViewInfo
  : TcxSchedulerDateNavigatorViewInfo;
begin
...
begin
  ...
  SetBounds(Left, Top, BorderWidths[bLeft] + BorderWidths[bRight] + 6 *
    ViewInfo.ColWidth, BorderWidths[bTop] + BorderWidths[bBottom] + 7 *
    FItemHeight);
end;

procedure TcxSchedulerMonthListBox.MouseUp(Button: TMouseButton;
...
begin
  ...
  begin
    ...
    begin
      ...
      Owner.LookAndFeelPainter.DrawDateNavigatorCellSelection(Canvas, R,
        ViewInfo.SelectedParams.Color);
    end
    else
...
constructor TcxSchedulerDateNavigatorController.Create
...
procedure TcxSchedulerDateNavigatorController.DragOver(Source: TObject;
...
procedure TcxSchedulerDateNavigatorController.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
...
procedure TcxSchedulerDateNavigatorController.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
  if FIgnoreMouseMove or (FTimer <> nil) then
    Exit;
  if CanProcessMouseMove and (ssLeft in Shift) then
    ProcessSelectionOnMouseMove(Shift);
  if (Owner.Scheduler <> nil) and not Owner.Scheduler.IsDesigning then
    ShowHint;
end;

procedure TcxSchedulerDateNavigatorController.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  DoCancelMode;
  if Button = mbLeft then
  begin
    if (Owner.SelectionList.Count > 0) and
      cxRectPtIn(ViewInfo.GetInternalRect(ViewInfo.GetCol(X), ViewInfo.GetRow(Y)
      ), X, Y) then
    begin
      if Owner.SelectionList[Owner.SelectionList.Count - 1] < Owner.FirstDate
      then
        Owner.StepToPast;
...
var
  ...
  ACursor: TPoint;
begin
  if (HitTest.HitDate = NullDate) or (Owner.Scheduler = nil) or
  ...
  begin
    AHintText := '';
    if TcxCustomSchedulerAccess(Scheduler).DoShowDateHint(HitTest.HitDate,
      AHintText) then
    begin
...
procedure TcxSchedulerDateNavigatorController.CalculateSelection
  (AConcatenate: Boolean);
...
begin
  ...
  begin
    ...
    else if FUnselect and (Owner.SelectionList.Count > AMin) then
...
procedure TcxSchedulerDateNavigatorController.ProcessSelectionOnMouseDown
  ...
  begin
    if not Owner.SelectPeriod or (Owner.SelectionIsWeeks and FUnselect and
      (Owner.SelectionList.Count = 7)) then
      Exit;
...
begin
  ...
  begin
    ...
    FSelFinish := ADate;
    Owner.SelectionIsWeeks := HitTest.HitAtWeekSelectionBar or
      (Owner.SelectionList.Count > 14);
...
procedure TcxSchedulerDateNavigatorController.ProcessSelectionOnMouseMove
  ...
  begin
    ...
    else if ADate <> FSelFinish then
    begin
      FSelFinish := ADate;
      if not Owner.SelectPeriod then
        FSelStart := FSelFinish;
      // DELPHI8! check Trunc()
      if not FExtSelect and (Abs(Trunc(FSelStart) - Trunc(ADate)) + 1 >
        cxDaysCalendarMaxColCount) then
        Owner.SelectionIsWeeks := True;
  ...
  begin
    if Owner.SelectionIsWeeks and Owner.SelectPeriod and (ADate <> FSelFinish)
    then
    begin
      FSelFinish := ADate;
...
function TcxSchedulerDateNavigatorController.GetHitTest
  : TcxSchedulerDateNavigatorHitTest;
begin
  Result := TcxSchedulerDateNavigatorHitTest(inherited HitTest);
end;

function TcxSchedulerDateNavigatorController.GetOwner
  : TcxSchedulerDateNavigator;
begin
  Result := TcxSchedulerDateNavigator(inherited Owner);
end;

function TcxSchedulerDateNavigatorController.GetViewInfo
  : TcxSchedulerDateNavigatorViewInfo;
begin
  Result := Owner.ViewInfo;
end;

procedure TcxSchedulerDateNavigatorController.SetDragDate
...
begin
  if Assigned(FTimer) or (GetCapture <> Owner.Scheduler.Handle) then
    Exit;
...
begin
  ...
  case TcxTimer(Sender).Tag of
    0:
      if HitTest.HitAtPrevMonth then
        Owner.StepToPast;
  else
...
begin
  ...
  FShowDatesContainingHolidaysInColor :=
    ASource.ShowDatesContainingHolidaysInColor;
...
begin
  ...
  SetBounds(Left, Top, ColCount * ViewInfo.MonthSize.cx,
...
begin
  ...
  if AName = 'DNColCount' then
    AValue := ColCount
  else if AName = 'DNRowCount' then
    AValue := RowCount
  else if AName = 'DNWidth' then
    AValue := Width
  else if AName = 'DNHeight' then
    AValue := Height
end;
...
begin
  ...
  begin
    Result := HitTest.HitAtTime or HitTest.HitAtWeekSelectionBar or
      HitTest.HitAtMonthName or HitTest.HitAtNextMonth or
      HitTest.HitAtPrevMonth;
  end;
end;
...
begin
  ...
  begin
    ViewInfo.CalculateInternalSizes;
    SetBounds(Left, Top, Max(ViewInfo.MonthSize.cx, FSavedSize.cx),
...
function TcxSchedulerDateNavigator.CreateController
...
function TcxSchedulerDateNavigator.CreateViewInfo
...
var
  ...
  begin
    ...
    begin
      ...
      AConvertDate.Day := dxGetCalendarDateElement(AFirstSelectedDate, deDay,
        Calendar);
...
begin
  ...
  begin
    ...
    else if (AFirstSelectedDate > ALastDate) or
      ((ASelectionCount > 7) and
      (ASelectionCount <= Trunc(ALastDate - AFirstDate)) and
...
begin
  if Assigned(FOnSelectionChanged) then
    FOnSelectionChanged(Self, SelectionList[0],
      SelectionList[SelectionList.Count - 1]);
end;

procedure TcxSchedulerDateNavigator.DoScrollSelection(AScrollDelta: Integer);
begin
  if AScrollDelta = 0 then
    Exit;
  IsLocked := True;
  try
...
begin
  ...
  try
    if (SelectionList.Count = 0) or SelectionList.ExistDate(ANeedDate) then
      Exit;
    if SelectionIsWeeks then
      ScrollWeeks
    else
...
begin
  ...
  else if SelectionList[0] < AMinDate then
    FirstDate := RealFirstDate
  else
    DoSelectionChanged;
end;

procedure TcxSchedulerDateNavigator.GetCalendarDimension(out AColCount,
  ARowCount: Integer);
begin
  AColCount := ColCount;
  ARowCount := RowCount;
...
function TcxSchedulerDateNavigator.
  GetShowDatesContainingHolidaysInColor: Boolean;
begin
...
begin
  if SelectionList.Count = 0 then
    Exit;
  if (SelectionList[0] < RealFirstDate) or (SelectionList[0] > RealLastDate)
  then
...
begin
  // DELPHI8! check
  Value := dxDateOf(Value) - (dxGetCalendarDateElement(Value, deDay,
    Calendar) - 1);
...
begin
  if AMonthInfo = nil then
    Exit;
  FListBoxDelta := AMonthInfo.Row * ColCount + AMonthInfo.Col;
  TcxSchedulerMonthListBox(FListBox).UpdateScaleFactor;
  TcxSchedulerMonthListBox(FListBox)
    .SetupMonth(AMonthInfo.Header.MonthNameBounds,
    ChangeMonthByCalendar(FirstDate, True, FListBoxDelta - 3, Calendar));
...
begin
  if LastDate >= LastAvailableDate then
    Exit;
  FirstDate := Calendar.AddMonths(FirstDate, 1);
end;
...
function TcxSchedulerDateNavigator.DoCustomDrawDayNumber(ACanvas: TcxCanvas;
  ADayInfo: TcxSchedulerDateNavigatorDayNumberViewInfo): Boolean;
begin
  Result := False;
...
begin
  if FFirstWeekOfYear = fwySystem then
    Result := TcxFirstWeekOfYear(StrToInt(GetLocaleChar(GetUserDefaultLCID,
...
function TcxSchedulerDateNavigator.GetController
  : TcxSchedulerDateNavigatorController;
begin
...
begin
  Result := ChangeMonthByCalendar(FirstDate, False, ColCount * RowCount - 1,
    Calendar);
end;

procedure TcxSchedulerDateNavigator.GetLimitDates(var AFirstDate,
  ALastDate: TDateTime);
begin
  if SelectionIsWeeks then
  begin
...
begin
  ...
  if (ACol = 0) and (ColCount * RowCount = 1) then
    Result := Result - 7;
end;
...
function TcxSchedulerDateNavigator.GetViewInfo
  : TcxSchedulerDateNavigatorViewInfo;
begin
...
procedure TcxSchedulerDateNavigator.SetShowDatesContainingEventsInBold
  (Value: Boolean);
begin
...
procedure TcxSchedulerDateNavigator.SetShowDatesContainingHolidaysInColor
  (Value: Boolean);
begin
...
procedure TcxSchedulerDateNavigator.SetStyles(const Value
  : TcxSchedulerDateNavigatorStyles);
begin
...
procedure TcxSchedulerDateNavigator.UpdateDimensions(AColCount,
  ARowCount: Integer);
begin
...
constructor TcxSchedulerDateNavigatorPainter.Create
  (AOwner: TcxSchedulerSubControl);
begin
  inherited Create(AOwner);
  ...
  begin
    ...
    begin
      ...
      if not AInfo.Transparent then
        Canvas.FillRect(GetRealBounds(AInfo.Bounds,
          DateNavigator.ViewInfo.Bounds), AInfo.ViewParams);
      Canvas.Brush.Style := bsClear;
      ATextBounds := cxRectCenterHorizontally(AInfo.Bounds,
        3 * ATextExtent - 1);
      Canvas.DrawText(AInfo.Text, GetRealBounds(cxRectOffset(ATextBounds, -2,
        0), DateNavigator.ViewInfo.Bounds), GetRealTextFlags);
      Canvas.Brush.Style := bsSolid;
    end;
    AInfo.RestoreParams;
  end;
...
begin
  ...
  if DateNavigator.IsDateToday(ADayInfo.Date) then
    Canvas.Font.Color := cxGetActualColor
      (LookAndFeelPainter.DefaultDateNavigatorTodayTextColor(ADayInfo.Selected),
      Canvas.Font.Color);
  ...
  if not cxRectIsEmpty(ASelectionSideBounds) then
    ASelectionSideBounds := GetRealBounds(ASelectionSideBounds,
      DateNavigator.ViewInfo.Bounds);
  if not ADayInfo.Transparent then
  begin
    if ADayInfo.Selected then
      LookAndFeelPainter.DrawDateNavigatorCellSelection(Canvas, ABounds,
        ADayInfo.ViewParams.Color)
    else
      Canvas.FillRect(ABounds, ADayInfo.ViewParams);
    if not cxRectIsEmpty(ASelectionSideBounds) then
      LookAndFeelPainter.DrawDateNavigatorCellSelection(Canvas,
        ASelectionSideBounds, ADayInfo.ViewParams.Color);
  end;
...
procedure TcxSchedulerDateNavigatorPainter.DrawMonthHeaderClassic
  (AViewInfo: TcxSchedulerDateNavigatorMonthHeaderViewInfo);
begin
  ...
  if not Canvas.UseRightToLeftAlignment then
    LookAndFeelPainter.DrawScaledMonthHeader(Canvas, AViewInfo.Bounds,
      ...
      AViewInfo.Arrows, DateNavigator.ViewInfo.SideWidth, ScaleFactor,
  ...
  begin
    ...
    if adLeft in AViewInfo.Arrows then
      TcxCustomLookAndFeelPainterAccess(LookAndFeelPainter)
        .DrawMonthHeaderRightArrow(Canvas, AViewInfo.Bounds,
        LookAndFeelPainter.DefaultSchedulerDateNavigatorArrowColor(False));
    if adRight in AViewInfo.Arrows then
      TcxCustomLookAndFeelPainterAccess(LookAndFeelPainter)
        .DrawMonthHeaderLeftArrow(Canvas, AViewInfo.Bounds,
        LookAndFeelPainter.DefaultSchedulerDateNavigatorArrowColor(False));
  end;
end;

procedure TcxSchedulerDateNavigatorPainter.DrawMonthHeaderModern
  (AViewInfo: TcxSchedulerDateNavigatorMonthHeaderViewInfo);
var
  ABounds: TRect;
...
begin
  ...
  if LookAndFeelPainter.LookAndFeelStyle = lfsSkin then
    LookAndFeelPainter.DrawScaledHeader(Canvas, AViewInfo.Bounds,
      AViewInfo.Bounds, AViewInfo.GetRealNeighbors,
      LookAndFeelPainter.HeaderBorders(AViewInfo.GetRealNeighbors), cxbsNormal,
      taCenter, vaCenter, False, False, AViewInfo.Text, FHeaderParams.Font,
      FHeaderParams.TextColor, FHeaderParams.Color, ScaleFactor,
      DrawHeaderBackground)
  else
  begin
    ABounds := LookAndFeelPainter.ScaledHeaderContentBounds(AViewInfo.Bounds,
      [], ScaleFactor);
    if nRight in AViewInfo.GetRealNeighbors then
    begin
      Canvas.FillRect(cxRect(ABounds.Right - 1, ABounds.Top, ABounds.Right,
        ABounds.Bottom),
        LookAndFeelPainter.DefaultSchedulerDayHeaderBorderColor);
      ABounds := TcxSchedulerPainterHelper.ExcludeBorders(ABounds, [bRight]);
    end;
    APainter.DrawContent(Canvas, ABounds, ABounds, cxbsNormal, taCenter,
      vaCenter, False, False, AViewInfo.Text, FHeaderParams.Font,
      FHeaderParams.TextColor, FHeaderParams.Color, DrawHeaderBackground);
  end;
  if adLeft in AViewInfo.Arrows then
  begin
    if Canvas.UseRightToLeftAlignment then
      APainter.DrawMonthHeaderRightArrow(Canvas, AViewInfo.Bounds,
        LookAndFeelPainter.DefaultSchedulerDateNavigatorArrowColor
        (AViewInfo.HitArrow = htcPrevMonth))
    else
  ...
  begin
    if Canvas.UseRightToLeftAlignment then
      APainter.DrawMonthHeaderLeftArrow(Canvas, AViewInfo.Bounds,
        LookAndFeelPainter.DefaultSchedulerDateNavigatorArrowColor
        (AViewInfo.HitArrow = htcNextMonth))
    else
      APainter.DrawMonthHeaderRightArrow(Canvas, AViewInfo.Bounds,
        LookAndFeelPainter.DefaultSchedulerDateNavigatorArrowColor
        (AViewInfo.HitArrow = htcNextMonth));
...
var
  ...
  AColor: TColor;
begin
  AIsModern := (ViewStyle = svsModern) and
    (LookAndFeelPainter.LookAndFeelStyle <> lfsSkin);
  if not AIsModern then
    Canvas.FillRect(GetRealBounds(AViewInfo.HorzSeparatorBound,
      DateNavigator.ViewInfo.Bounds),
  ...
  begin
    ...
    Canvas.FillRect(GetRealBounds(cxRectSetWidth(AViewInfo.VertSeparatorBound,
      1), DateNavigator.ViewInfo.Bounds));
    Canvas.FillRect(GetRealBounds(cxRectSetWidth(AViewInfo.VertSeparatorBound,
      AViewInfo.VertSeparatorBound.Left + 1, 1), DateNavigator.ViewInfo.Bounds),
  ...
  begin
    ...
    with AViewInfo do
      for I := 0 to FWeekCount - 1 do
        DrawText(FWeekTexts[I], GetRealBounds(FWeekBounds[I],
          DateNavigator.ViewInfo.Bounds), GetRealTextFlags);
    Brush.Style := bsSolid;
...
function TcxSchedulerDateNavigatorPainter.GetRealBounds(const ABounds,
  AClientBounds: TRect): TRect;
begin
  Result := ABounds;
  if Canvas.UseRightToLeftAlignment then
...
function TcxSchedulerDateNavigatorPainter.GetLookAndFeelPainter
...
procedure TcxSchedulerDateNavigatorCaptionViewInfo.DoRightToLeftConversion
...
procedure TcxSchedulerDateNavigatorCaptionViewInfo.SaveParams
...
procedure TcxSchedulerDateNavigatorMonthHeaderViewInfo.Calculate
  (const ABounds: TRect);
var
  ADate: TcxDateTime;
begin
...
function TcxSchedulerDateNavigatorMonthHeaderViewInfo.GetRealNeighbors
  : TcxNeighbors;
begin
  Result := FNeighbors;
  if Owner.Owner.UseRightToLeftAlignment then
    if Result = [nLeft] then
      Result := [nRight]
    else if Result = [nRight] then
      Result := [nLeft];
end;

function TcxSchedulerDateNavigatorMonthHeaderViewInfo.GetCalendar
...
procedure TcxSchedulerDateNavigatorMonthHeaderViewInfo.SetHitArrow
  (AArrow: Integer);
var
...
begin
  ...
  begin
    ...
    BeginMouseTracking(ADateNavigator.Scheduler,
      cxRectOffset(Bounds, ADateNavigator.Bounds.Left,
      ADateNavigator.Bounds.Top), Self);
  end;
end;
...
begin
  ...
  begin
    ...
    if FGrayed then
      FViewParams.TextColor := DateNavigator.LookAndFeelPainter.
        DefaultDateNavigatorInactiveTextColor;
  end;
  Inc(FDayCount);
end;

procedure TcxSchedulerDateNavigatorMonthContentViewInfo.Calculate(ACol,
  ARow: Integer; ADate: TcxDateTime);
begin
...
var
  ...
  begin
    if DateNavigator.ShowWeekNumbers then
    begin
      FWeekBounds[FWeekCount] := cxRect(R.Left - ViewInfo.SideWidth, R.Top - 1,
        R.Left - 3, R.Bottom);
      FWeekTexts[FWeekCount] :=
        IntToStr(Calendar.GetWeekNumber(ADate, DateNavigator.StartOfWeek,
        DateNavigator.FActualFirstWeekOfYear));
    end;
    Inc(FWeekCount);
  end;
...
begin
  ...
  if (ADayBase = 1) and (FCol + FRow = 0) then
    Dec(ADayBase, 7);
...
procedure TcxSchedulerDateNavigatorMonthContentViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  FBounds := TdxRightToLeftLayoutConverter.ConvertRect(FBounds, AClientBounds);
end;
...
function TcxSchedulerDateNavigatorMonthContentViewInfo.GetDayCaptionText
  (ADay: TdxDayOfWeek): string;
var
  ADayOfWeek: TDay;
begin
...
function TcxSchedulerDateNavigatorMonthContentViewInfo.GetWeekBound
  (Index: Byte): TRect;
begin
...
function TcxSchedulerDateNavigatorMonthContentViewInfo.GetDayText
...
function TcxSchedulerDateNavigatorMonthContentViewInfo.GetWeekText
  (Index: Byte): string;
begin
  if IsValidWeekIndex(Index) then
...
procedure TcxSchedulerDateNavigatorMonthContentViewInfo.
  UpdateElementsAfterCustomDraw(ACanvas: TcxCanvas);
var
  I: Integer;
begin
...
function TcxSchedulerDateNavigatorMonthContentViewInfo.GetCalendar
  : TcxCustomCalendarTable;
begin
...
function TcxSchedulerDateNavigatorMonthContentViewInfo.GetGrayed
...
function TcxSchedulerDateNavigatorMonthContentViewInfo.IsValidDayIndex
  (Index: Byte): Boolean;
begin
  Result := Index < FDayCount;
end;

function TcxSchedulerDateNavigatorMonthContentViewInfo.IsValidDayCaptionIndex
  (Index: Byte): Boolean;
begin
  Result := Index in [0 .. 6];
end;

function TcxSchedulerDateNavigatorMonthContentViewInfo.IsValidWeekIndex
  (Index: Byte): Boolean;
begin
  Result := Index < FWeekCount;
end;

procedure TcxSchedulerDateNavigatorMonthContentViewInfo.SetWeekText(Index: Byte;
  const Value: string);
begin
  if IsValidWeekIndex(Index) then
...
procedure TcxSchedulerDateNavigatorMonthViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  FBounds := TdxRightToLeftLayoutConverter.ConvertRect(FBounds, AClientBounds);
...
function TcxSchedulerDateNavigatorMonthViewInfo.GetHeaderArrows
  : TcxArrowDirections;
begin
  Result := [];
  if Row = 0 then
...
function TcxSchedulerDateNavigatorMonthViewInfo.GetHeaderNeighbors
  : TcxNeighbors;
begin
...
procedure TcxSchedulerDateNavigatorStyles.GetDefaultViewParams(Index: Integer;
...
function TcxSchedulerDateNavigatorStyles.GetDateNavigator
  : TcxSchedulerDateNavigator;
begin
  Result := TcxSchedulerDateNavigator(inherited Owner);
end;
...
var
  ...
  dX: Integer;
begin
  if CheckMonthHeader or CheckWeekSelectionBar or CheckDayCaptions then
    Exit;
  R := GetDatesBounds;
  ...
  begin
    ...
    if Owner.UseRightToLeftAlignment then
      dX := R.Right - HitX;
    ADate := AFirstWeekSelectableDate + ((HitY - R.Top) div ViewInfo.RowHeight)
      * 7 + (dX div ViewInfo.ColWidth);
    FHitDate := dxDateOf(ADate);
    if (ADate < FTime) and (MonthViewInfo.Col + MonthViewInfo.Row > 0) then
      Exit;
    ...
    if (ADate > FTime) and not((MonthViewInfo.Col = Owner.ColCount - 1) and
      (MonthViewInfo.Row = Owner.RowCount - 1)) then
      Exit;
    FTime := ADate;
  end;
end;
...
begin
  ...
  else if cxRectPtIn(ViewInfo.GetLeftArrowRect, HitPoint) then
  begin
    SetBitState(htcPrevMonth, True);
    Result := True;
    MonthViewInfo.Header.HitArrow := htcPrevMonth;
  end
  else if cxRectPtIn(ViewInfo.GetRightArrowRect, HitPoint) then
  begin
...
begin
  Result := HitX;
  if Owner.UseRightToLeftAlignment then
    Result := TdxRightToLeftLayoutConverter.ConvertPoint(cxPoint(Result, 0),
      Owner.ViewInfo.Bounds).X;
end;
...
function TcxSchedulerDateNavigatorHitTest.GetViewInfo
  : TcxSchedulerDateNavigatorViewInfo;
begin
  Result := Owner.ViewInfo;
end;
...
constructor TcxSchedulerDateNavigatorViewInfo.Create
  (AOwner: TcxSchedulerSubControl);
begin
  inherited Create(AOwner);
...
begin
  ...
  FColCount := Max(1, Min(cxDaysCalendarMaxColCount,
    Owner.Width div MonthSize.cx));
  FRowCount := Max(1, Owner.Height div MonthSize.cy);
  FCalendarBounds := cxRect(0, 0, ColCount * MonthSize.cx,
    RowCount * MonthSize.cy);
...
begin
  ...
  FMonthSize.cy := (FHeaderHeight + FDayCaptionsHeight + 6 * FRowHeight +
    ScaleFactor.Apply(1));
end;
...
function TcxSchedulerDateNavigatorViewInfo.GetHeaderRect(ACol,
  ARow: Integer): TRect;
begin
  with MonthSize do
...
function TcxSchedulerDateNavigatorViewInfo.GetInternalRect(ACol,
  ARow: Integer): TRect;
begin
  with MonthSize do
...
begin
  Result := cxRectBounds(CalendarBounds.Left + ScaleFactor.Apply(1),
    CalendarBounds.Top + ScaleFactor.Apply(1), FColWidth - ScaleFactor.Apply(2),
    FHeaderHeight - ScaleFactor.Apply(2));
  if UseRightToLeftAlignment then
    Result := TdxRightToLeftLayoutConverter.ConvertRect(Result, CalendarBounds);
end;

function TcxSchedulerDateNavigatorViewInfo.GetMonthRect(ACol,
  ARow: Integer): TRect;
begin
  with MonthSize do
    Result := cxRectOffset(cxRect(0, 0, cx, cy), CalendarBounds.Left + ACol *
      cx, CalendarBounds.Top + ARow * cy);
end;
...
function TcxSchedulerDateNavigatorViewInfo.GetMonthViewInfo(ACol, ARow: Integer)
  : TcxSchedulerDateNavigatorMonthViewInfo;
begin
