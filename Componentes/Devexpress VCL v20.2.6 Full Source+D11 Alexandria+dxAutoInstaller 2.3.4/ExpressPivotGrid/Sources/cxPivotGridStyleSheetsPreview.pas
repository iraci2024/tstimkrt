...
class function TcxPivotGridStyleSheetEditorPreview.GetStyleSheetClass
  : TcxCustomStyleSheetClass;
begin
  Result := TcxPivotGridStyleSheet;
end;

procedure TcxPivotGridStyleSheetEditorPreview.SetStyleSheet
...
begin
  ...
  try
    ...
    AddColumn('Shipped Quarter', faColumn, TcxDateTimeValueType).GroupInterval
      := giDateQuarter;
