...
resourcestring
  sdxWizardControlErrorWrongChild =
    'You can only insert a TdxWizardControlPage into TdxWizardControl.';
  sdxWizardControlErrorWrongParent =
    'You can insert a TdxWizardControlPage only into TdxWizardControl.';
  ...
  sdxWizardControlPageDefaultDescription =
    'Page description: this should help the user complete a subtask';
...
procedure AddWizardControlResourceStringNames
  (AProduct: TdxProductResourceStrings);
begin
  AProduct.Add('sdxWizardControlErrorWrongChild',
    @sdxWizardControlErrorWrongChild);
  AProduct.Add('sdxWizardControlErrorWrongParent',
    @sdxWizardControlErrorWrongParent);
  AProduct.Add('sdxWizardControlErrorWrongPageIndex',
    @sdxWizardControlErrorWrongPageIndex);
  ...
  AProduct.Add('sdxWizardControlPageDefaultTitle',
    @sdxWizardControlPageDefaultTitle);
  AProduct.Add('sdxWizardControlPageDefaultDescription',
    @sdxWizardControlPageDefaultDescription);
end;

initialization

dxResourceStringsRepository.RegisterProduct('ExpressWizardControl',
  @AddWizardControlResourceStringNames);
