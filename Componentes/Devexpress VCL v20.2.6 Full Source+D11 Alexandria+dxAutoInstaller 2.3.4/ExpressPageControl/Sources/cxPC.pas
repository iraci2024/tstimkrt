...
{$ENDIF}
  ...
  Contnrs, Menus, Themes,
  dxCore, dxCoreGraphics, dxCoreClasses, cxClasses, cxControls, cxContainer,
...
type
  ...
  TcxPCPropertiesDrawTabEvent = procedure(AProperties
    : TcxCustomTabControlProperties; ATab: TcxTab; var DefaultDraw: Boolean)
    of object;
  TcxPCPropertiesDrawTabExEvent = procedure(AProperties
    : TcxCustomTabControlProperties; ATab: TcxTab; Font: TFont) of object;
  TcxGetTabImageEvent = procedure(Sender: TObject; TabIndex: Integer;
    var ImageIndex: Integer) of object;
  TcxGetTabHintEvent = procedure(Sender: TObject; ATabIndex: Integer;
    var AHint: string; var ACanShow: Boolean) of object;
  TcxPageChangingEvent = procedure(Sender: TObject; NewPage: TcxTabSheet;
    var AllowChange: Boolean) of object;
  TcxPCCanCloseEventEx = procedure(Sender: TObject; ATabIndex: Integer;
    var ACanClose: Boolean) of object;
  TcxPCCloseEvent = procedure(Sender: TObject; ATabIndex: Integer) of object;
  TcxPCTabClickEvent = procedure(Sender: TObject; ATabVisibleIndex: Integer;
    AShift: TShiftState) of object;
  TcxTabChangedEvent = procedure(Sender: TObject; TabID: Integer) of object;
  TcxTabChangingEvent = procedure(Sender: TObject; var AllowChange: Boolean)
    of object;

  TcxTabAfterPaintEvent = procedure(ACanvas: TcxCanvas; ATab: TcxTab;
    AImageAndTextData: TcxPCOutTabImageAndTextData) of object;
  // for cxGrid6 compatibility
  ...
  TcxPCImageListRotatedImagesElementArray = array of
    TcxPCImageListRotatedImagesElement; // for internal use
  ...
  public
    ...
    property ControlViewInfo: TcxCustomTabControlViewInfo
  ...
  public
    ...
    function IsNavigatorButton(AButtonTypes: TcxPCNavigatorButtons): Boolean;
      overload; virtual;
  end;
  ...
  public
    ...
    function GetWidth: Integer; override;
    function IsNavigatorButton(AButtonTypes: TcxPCNavigatorButtons)
      : Boolean; override;
  ...
  public
    ...
    property Items[Index: Integer]: TcxPCCustomTabButtonViewInfo
  ...
  protected
    ...
    function GetContentHorizontalOffset(ATabWidth, AContentWidth
      : Integer): Integer;
  ...
  public
    ...
    property CloseButtonInfo: TcxPCTabCloseButtonViewInfo
      read GetCloseButtonInfo;
  ...
  protected
    ...
    procedure DoRightToLeftConversion(const AClientBounds: TRect); virtual;
    procedure RepaintTab(ATabVisibleIndex: Integer;
  ...
  public
    constructor Create(ATabs: TcxTabs;
      AControlViewInfo: TcxCustomTabControlViewInfo); virtual;
    destructor Destroy; override;
    ...
    property ViewInfos[Index: Integer]: TcxTabViewInfo
      read GetViewInfo; default;
  end;
  ...
  private
    ...
    function GetNavigatorButtonInfos(Index: Integer)
      : TcxPCCustomHeaderButtonViewInfo;
    ...
    procedure SetHotTrackNavigatorButton(const Value
      : TcxPCCustomHeaderButtonViewInfo);
    ...
    procedure SetPressedNavigatorButton(const Value
      : TcxPCCustomHeaderButtonViewInfo);
  ...
  protected
    ...
    function GetNavigatorButtonInfoByType(AType: TcxPCNavigatorButton)
      : TcxPCNavigatorButtonViewInfo;
    function GetNextFocusedTabVisibleIndex(ACurrentTabVisibleIndex,
      ADelta: Integer; ACycle: Boolean;
      AOnlyAllowSelectedTabs: Boolean): Integer;
    function GetTabColor(ATabVisibleIndex: Integer): TColor; virtual;
    function GetTabExtendedTabsRect(ATabViewInfo: TcxTabViewInfo)
      : TRect; overload;
    ...
    procedure InitializeLineBoundsA(var ALineIndexBoundsA
    ...
    function PtInScrollingArea(const P: TPoint;
      var ADirection: Integer): Boolean;

    property Controller: TcxCustomTabControlController read GetController;
    property HotTrackNavigatorButton: TcxPCCustomHeaderButtonViewInfo
      read FHotTrackNavigatorButton write SetHotTrackNavigatorButton;
    property HotTrackTabButton: TcxPCCustomTabButtonViewInfo
      read FHotTrackTabButton write SetHotTrackTabButton;
    property HotTrackTabVisibleIndex: Integer read FHotTrackTabVisibleIndex
      write SetHotTrackTabVisibleIndex;
    property LastTabVisibleIndex: Integer read FLastTabVisibleIndex
      write FLastTabVisibleIndex;
    ...
    property Painter: TcxPCCustomPainter read GetPainter;
    property PressedNavigatorButton: TcxPCCustomHeaderButtonViewInfo
      read FPressedNavigatorButton write SetPressedNavigatorButton;
    property PressedTabButton: TcxPCCustomTabButtonViewInfo
      read FPressedTabButton write SetPressedTabButton;
    property PressedTabVisibleIndex: Integer read FPressedTabVisibleIndex
      write SetPressedTabVisibleIndex;
    property RowHeight: Integer read FRowHeight;
    property TrackingTabVisibleIndex: Integer read FTrackingTabVisibleIndex
      write SetTrackingTabVisibleIndex;
    property OnAfterPaintTab: TcxTabAfterPaintEvent read FOnAfterPaintTab
      write FOnAfterPaintTab; // for cxGrid6 compatibility
  public
    ...
    function CanDrawParentBackground: Boolean;
    function GetHeaderButtonsDistance(AButtonInfo1, AButtonInfo2
      : TcxPCCustomHeaderButtonViewInfo): Integer;
    function GetLookAndFeel: TcxLookAndFeel;
    ...
    procedure InitializeLineBoundsArray(var ALineIndexBoundsA
      : TcxPCLineIndexBoundsArray);
    ...
    procedure PrepareTabCanvasFont(ATabViewInfo: TcxTabViewInfo;
    ...
    property FirstTabVisibleIndex: Integer read FFirstTabVisibleIndex
      write FFirstTabVisibleIndex;
    property FocusedTabVisibleIndex: Integer read GetFocusedTabVisibleIndex
      write SetFocusedTabVisibleIndex;
    ...
    property MainTabVisibleIndex: Integer read FMainTabVisibleIndex
      write SetMainTabVisibleIndex;
    ...
    property NavigatorButtonInfoByType[AType: TcxPCNavigatorButton]
      : TcxPCNavigatorButtonViewInfo read GetNavigatorButtonInfoByType;
    property NavigatorButtonInfos[Index: Integer]
      : TcxPCCustomHeaderButtonViewInfo read GetNavigatorButtonInfos;
    property NavigatorButtons: TcxPCNavigatorButtons read GetNavigatorButtons;
    property NavigatorPosition: TcxPCNavigatorPosition
      read GetNavigatorPosition;
  ...
  TcxTab = class(TPersistent, IUnknown, IdxAdornerTargetElement)
  private
  ...
  public
    ...
    property AllowCloseButton: Boolean read FAllowCloseButton
      write SetAllowCloseButton;
  ...
  protected
    ...
    procedure Changed(ATab: TcxTab = nil;
  ...
  protected
    ...
    function CalculateTabNormalWidth(ATabViewInfo: TcxTabViewInfo): Integer;
      virtual; abstract;
    function CanDrawParentBackground: Boolean; virtual;
    procedure CorrectTabContentVerticalOffset(ATabVisibleIndex: Integer;
      var ADrawOffset: TRect); virtual;
    procedure CorrectTabNormalWidth(var AValue: Integer); virtual;
    ...
    procedure DirectionalPolyline(ACanvas: TcxCanvas; const R: TRect;
    ...
    function DoGetButtonWidth(Button: TcxPCNavigatorButton): Integer;
      virtual; abstract;
    function DoGetCloseButtonSize: TSize; virtual;
    procedure DrawBackground(ACanvas: TcxCanvas);
    procedure DrawHeaderButtonGlyph(ACanvas: TcxCanvas;
    ...
    procedure DrawTabImage(ACanvas: TcxCanvas; const ARect: TRect;
      AImageIndex: Integer; AEnabled: Boolean; AColor: TColor;
      ATabVisibleIndex: Integer); virtual;
    procedure DrawTabImageAndText(ACanvas: TcxCanvas;
      ATabVisibleIndex: Integer); virtual;
    procedure DrawTabText(ACanvas: TcxCanvas; const ARect: TRect;
      const AText: string; AEnabled: Boolean; AColor: TColor;
      ATabVisibleIndex: Integer); virtual;
    procedure ExcludeTabContentClipRegion(ACanvas: TcxCanvas;
      ATabVisibleIndex: Integer);
    procedure FillFreeSpaceArea(ACanvas: TcxCanvas;
    ...
    function GetButtonsDistance(AButton1, AButton2: TcxPCNavigatorButton)
      : Integer; virtual;
    ...
    function GetCloseButtonAreaHeight(ATabVisibleIndex: Integer)
      : Integer; virtual;
    function GetCloseButtonAreaWidth(ATabVisibleIndex: Integer)
      : Integer; virtual;
    ...
    function GetHeaderButtonGlyphPalette(AState: TcxPCNavigatorButtonState)
    ...
    function GetDrawImageOffset(TabVisibleIndex: Integer): TRect;
      virtual; abstract;
    function GetScaledDrawImageOffset(ATabVisibleIndex: Integer): TRect;
    function GetDrawImageWithoutTextWOffset(TabVisibleIndex: Integer)
      : TcxPCWOffset; virtual; abstract;
    function GetDrawTextHOffset(TabVisibleIndex: Integer): TRect;
      virtual; abstract;
    ...
    function GetExtendedRect(const ARect, AExtension: TRect;
      ATabPosition: TcxTabPosition): TRect;
    function GetFrameWidth: Integer; virtual;

    function GetTabButtonColorPalette(AState: TcxPCNavigatorButtonState)
      : IdxColorPalette; virtual;
    function GetTabButtonDistance: Integer; virtual;
    function GetTabButtonGlyphOffset: TRect; virtual;
    function GetTabButtonsAreaWidth(ATabVisibleIndex: Integer)
      : Integer; virtual;

    procedure AfterPaintTab(ACanvas: TcxCanvas;
      ATabVisibleIndex: Integer); virtual;
    function AlwaysColoredTabs: Boolean; virtual;
    function GetGoDialogPosition(GoDialogSize: TSize): TPoint; virtual;
      abstract;
    function GetHighlightedTextColor(ATabVisibleIndex: Integer;
      ATextColor: TColor): TColor;
    function GetHotTrackColor: TColor;
    function GetImageTextDistance(ATabVisibleIndex: Integer): Integer;
      virtual; abstract;
    function GetMaxTabCaptionHeight: Integer;
    function GetMinTabNormalWidth(ATabVisibleIndex: Integer): Integer;
      virtual; abstract;
    ...
    function GetTabBodyColor(TabVisibleIndex: Integer): TColor;
      virtual; abstract;
    function GetTabColor(ATabVisibleIndex: Integer): TColor; virtual;
    function GetTabClipRgn(ACanvas: TcxCanvas; ATabVisibleIndex: Integer)
      : TcxRegion; virtual;
    function GetTabClipRgnOperation(ATabVisibleIndex: Integer)
      : TcxRegionOperation; virtual;
    function GetTabContentWOffset(ATabVisibleIndex: Integer): TcxPCWOffset;
      virtual; abstract;
    function GetTabImageAreaHeight: Integer;
    function GetTabImageAreaWidth: Integer;
    ...
    function GetTooNarrowTabContentWOffset(ATabVisibleIndex: Integer)
      : TcxPCWOffset; virtual; abstract;
    ...
    procedure InternalPaintDragImage(ACanvas: TcxCanvas;
      ATabVisibleIndex: Integer); virtual; abstract;
    ...
    function InternalSetClipRect(ACanvas: TcxCanvas; ClipR: TRect;
    ...
    procedure PaintDragImage(ACanvas: TcxCanvas; const R: TRect;
      ATabVisibleIndex: Integer);
    ...
    procedure DrawTabContentBackground(ACanvas: TcxCanvas; const ABounds: TRect;
      ABackgroundColor: TColor; ATabVisibleIndex: Integer); virtual;
    procedure RepaintButtonsRegion; virtual;
    procedure RepaintTab(TabVisibleIndex: Integer;
      TabPropertyChanged: TcxPCTabPropertyChanged); virtual;
  ...
  public
    ...
    class function HasLookAndFeel(ALookAndFeel: TcxLookAndFeel)
      : Boolean; virtual;
    ...
    property HeaderButtonImagePainter: TcxPCImageList
      read GetHeaderButtonImagePainter;
    property ImagePainter: TcxPCImageList read GetImagePainter;
    property ScaleFactor: TdxScaleFactor read GetScaleFactor;
    property TabButtonImagePainter: TcxPCImageList
      read GetTabButtonImagePainter;
  ...
  public
    ...
    property BaseHotImages: TCustomImageList read FBaseHotImages
      write SetBaseHotImages;
    ...
    property ImageRotationAngle: TcxRotationAngle read FImageRotationAngle
      write FImageRotationAngle default ra0;
  ...
  published
    ...
    property Positions: TcxTabSlantPositions read FPositions write SetPositions
      default cxTabSlantDefaultPositions;
  end;
  ...
  protected
    ...
    property DestinationTabVisibleIndex: Integer
      read FDestinationTabVisibleIndex write SetDestinationTabVisibleIndex;
    property Properties: TcxCustomTabControlProperties read GetProperties;
  ...
  public
    ...
    property HitAtNavigatorButton: Boolean index pchtNavigatorButton
      read GetBitState;
    property HitAtTab: Boolean index pchtTab read GetBitState;
    property HitAtTabCloseButton: Boolean index pchtTabCloseButton
      read GetBitState;
  ...
  protected
    ...
    procedure TabButtonDown(ATabButtonInfo
      : TcxPCCustomTabButtonViewInfo); virtual;

    // Drag and drop
    procedure EndDragAndDrop(Accepted: Boolean); virtual;
    function GetDragAndDropObjectClass
      : TcxTabControlDragAndDropObjectClass; virtual;
    ...
    property MouseDownTabVisibleIndex: Integer read FMouseDownTabVisibleIndex
      write FMouseDownTabVisibleIndex;
    property Owner: TObject read FOwner;
    property Properties: TcxCustomTabControlProperties read GetProperties;
    property ViewInfo: TcxCustomTabControlViewInfo read GetViewInfo;
  public
  ...
  TcxCustomTabControlPropertiesChangedType = (pctHard, pctMedium, pctSimple,
    pctLight); // for internal use

  TcxCustomTabControlPropertiesChangedEvent = procedure(Sender: TObject;
    AType: TcxCustomTabControlPropertiesChangedType) of object;
  TcxPCPrepareTabCanvasFontEvent = procedure(ATab: TcxTab; ACanvas: TcxCanvas)
    of object;

  TcxPCNewTabButtonClickEvent = procedure(Sender: TObject;
    var AHandled: Boolean) of object;
  TcxPCNewTabCreateEvent = procedure(Sender: TObject; AIndex: Integer)
    of object;
  TcxPCPaintDragImageEvent = procedure(Sender: TObject; ABitmap: TBitmap;
    var ADone: Boolean) of object;

  TcxPCNewEvent = procedure(Sender: TObject; AIndex: Integer) of object;
  // deprecated

  TcxPCButtonCanShowEvent = procedure(AButton: TcxPCButton; ATabIndex: Integer;
  ...
  published
    ...
    property Position: TcxPCButtonPosition read FPosition write SetPosition
      default pcbpHeader;
    property TabImageIndex: TcxImageIndex read FTabImageIndex
      write SetTabImageIndex default -1;
    property Visible: Boolean read FVisible write SetVisible default True;
    property OnCanShow: TcxPCButtonCanShowEvent read FOnCanShow
      write FOnCanShow;
  ...
  public
    ...
    property Items[Index: Integer]: TcxPCButton read GetItem
  ...
  published
    ...
    property HeaderImages: TCustomImageList read GetHeaderImages
      write SetHeaderImages;
  ...
  protected
    ...
    procedure Changed(AType: TcxCustomTabControlPropertiesChangedType =
      pctHard);
    ...
    procedure DoGetTabHint(ATab: TcxTab; var AHint: string;
      var ACanShow: Boolean); virtual;
    ...
    function InternalGetTabHint(ATab: TcxTab; var ACanShow: Boolean)
      : string; virtual;
    function GetButtonHint(AButtonViewInfo: TcxPCCustomButtonViewInfo)
      : string; virtual;
    function GetImageIndex(ATab: TcxTab): Integer; virtual;
    function GetNavigatorButtons(AOnlyObligatoryButtons: Boolean)
      : TcxPCNavigatorButtons;
    function GetTabHint(ATab: TcxTab): string; virtual;
    function TabIndexTabMustBeVisible: Boolean; virtual;

    property ActivateFocusedTab: Boolean read FActivateFocusedTab
      write SetActivateFocusedTab default True;
    property NewButtonMode: TcxPCNewButtonMode read GetNewButtonMode
      write SetNewButtonMode default nbmNone;
    property AllowDisabledTabAccess: Boolean read FAllowDisabledTabAccess
      write SetAllowDisabledTabAccess default False;
    property AllowTabDragDrop: Boolean read FAllowTabDragDrop
      write FAllowTabDragDrop default False;
    property CloseButtonMode: TcxPCButtonMode read FCloseButtonMode
      write SetCloseButtonMode default cbmNone;
    property CloseTabWithMiddleClick: Boolean read FCloseTabWithMiddleClick
      write FCloseTabWithMiddleClick default False;
    property CustomButtons: TcxPCCustomButtons read FCustomButtons
      write SetCustomButtons;
    ...
    property ImageBorder: Integer read FImageBorder write SetImageBorder
      default 0;
    ...
    property MultiLine: Boolean read FMultiLine write SetMultiLine
      default False;
    property MultiLineTabCaptions: Boolean read FMultiLineTabCaptions
      write SetMultiLineTabCaptions default False;
    ...
    property RotatedTabsMaxWidth: Integer read FRotatedTabsMaxWidth
      write SetRotatedTabsMaxWidth default 0;
    property ScrollOpposite: Boolean read FScrollOpposite
      write SetScrollOpposite default False;
    property ShowButtonHints: Boolean read FShowButtonHints
      write FShowButtonHints default False;
    property ShowFrame: Boolean read FShowFrame write SetShowFrame
      default False;
    property ShowTabHints: Boolean read FShowTabHints write FShowTabHints
      default False;
    property Style: TcxPCStyleID read FStyle write SetStyle
      default cxPCDefaultStyle;
    ...
    property TabsScroll: Boolean read FTabsScroll write SetTabsScroll
      default True;
    ...
    property OnCanClose: TcxPCCanCloseEventEx read FOnCanClose
      write FOnCanClose;
    property OnClose: TcxPCCloseEvent read FOnClose write FOnClose;
    property OnChange: TNotifyEvent read FOnChange write FOnChange;
    property OnChanged: TcxCustomTabControlPropertiesChangedEvent
      read FOnChanged write FOnChanged;
    property OnChanging: TcxTabChangingEvent read FOnChanging write FOnChanging;
    property OnDrawTab: TcxPCPropertiesDrawTabEvent read FOnDrawTab
      write FOnDrawTab;
    property OnDrawTabEx: TcxPCPropertiesDrawTabExEvent read FOnDrawTabEx
      write FOnDrawTabEx;
    property OnGetImageIndex: TcxGetTabImageEvent read FOnGetImageIndex
      write FOnGetImageIndex;
    property OnGetTabHint: TcxGetTabHintEvent read FOnGetTabHint
      write FOnGetTabHint;
    property OnNewTabButtonClick: TcxPCNewTabButtonClickEvent
      read FOnNewTabButtonClick write FOnNewTabButtonClick;
    property OnNewTabCreate: TcxPCNewTabCreateEvent read FOnNewTabCreate
      write FOnNewTabCreate;
    property OnStyleChanged: TNotifyEvent read FOnStyleChanged
      write FOnStyleChanged;
    property OnPaintDragImage: TcxPCPaintDragImageEvent read FOnPaintDragImage
      write FOnPaintDragImage;
    property OnPrepareTabCanvasFont: TcxPCPrepareTabCanvasFontEvent
      read FOnPrepareTabCanvasFont write FOnPrepareTabCanvasFont;
  ...
  TcxPCCanCloseEvent = procedure(Sender: TObject; var ACanClose: Boolean)
    of object;
  TcxTabControlTabDragAndDropEvent = procedure(AControl: TcxCustomTabControl;
    AIndex, ADestinationIndex: Integer; var AAccept: Boolean) of object;
  TcxTabControlTabStartDragEvent = procedure(AControl: TcxCustomTabControl;
    AIndex: Integer) of object;
  TcxTabControlTabEndDragEvent = procedure(AControl: TcxCustomTabControl;
    ANewIndex: Integer) of object;

  { TcxCustomTabControl }

  TcxCustomTabControl = class(TcxControl, IcxTabControl,
    IcxControlComponentState, IcxMouseTrackingCaller, IcxMouseTrackingCaller2,
    IdxSkinSupport)
  private
    FController: TcxCustomTabControlController;
    FFocusable: Boolean;
  ...
  protected
    ...
    // Event Handlers
    procedure PropertiesCanCloseHandler(Sender: TObject; AIndex: Integer;
    ...
    procedure PropertiesChangingHandler(Sender: TObject;
      var AllowChange: Boolean);
    procedure PropertiesDrawTabExHandler
    ...
    procedure PropertiesNewTabButtonClickHandler(Sender: TObject;
      var AHandled: Boolean);
    procedure PropertiesNewTabCreateHandler(Sender: TObject; AIndex: Integer);
    procedure PropertiesPaintDragImageHandler(Sender: TObject; ABitmap: TBitmap;
      var ADone: Boolean);
    procedure PropertiesPrepareTabCanvasFontHandler(ATab: TcxTab;
      ACanvas: TcxCanvas); virtual;
    procedure PropertiesTabClickHandler(Sender: TObject;
      ATabVisibleIndex: Integer; AShift: TShiftState); virtual;
    function PropertiesTabDragAndDrop(AIndex, ADestinationIndex
      : Integer): Boolean;
    ...
    procedure IcxMouseTrackingCaller2.MouseLeave =
      MouseTrackingCallerMouseLeave;
    procedure MouseTrackingCallerMouseLeave;

    // Adorners
    procedure GetAdornerTargetElements(AList: TStrings); override;

    property FirstVisibleTab: Integer read GetFirstVisibleTab
      write SetFirstVisibleTab;
    ...
    property IsTabsContainer: Boolean read GetIsTabsContainer
      write SetIsTabsContainer stored False;
    property ImageBorder: Integer read GetImageBorder write SetImageBorder
      stored False;
    property Images: TCustomImageList read GetImages write SetImages
      stored False;
    property MainTabIndex: Integer read GetMainTabIndex;
    ...
    property NavigatorPosition: TcxPCNavigatorPosition read GetNavigatorPosition
      write SetNavigatorPosition stored False;
    property Options: TcxPCOptions read GetOptions write SetOptions
      stored False;
    ...
    property PageClientRect: TRect read GetPageClientRect;
    property PageClientRectOffset: TRect read GetPageClientRectOffset;
    property RaggedRight: Boolean read GetRaggedRight write SetRaggedRight
      stored False;
    ...
    property MaxRotatedTabWidth: Integer read GetMaxRotatedTabWidth
      write SetMaxRotatedTabWidth stored False;
    property ScrollOpposite: Boolean read GetScrollOpposite
      write SetScrollOpposite stored False;
    ...
    property TabCaptionAlignment: TAlignment read GetTabCaptionAlignment
      write SetTabCaptionAlignment stored False;
    property TabHeight: Smallint read GetTabHeight write SetTabHeight
      stored False;
    property TabIndex: Integer read GetTabIndex write SetTabIndex stored False;
    property TabPosition: TcxTabPosition read GetTabPosition
      write SetTabPosition stored False;
    ...
    property OnCanCloseEx: TcxPCCanCloseEventEx read FOnCanCloseEx
      write FOnCanCloseEx;
    property OnChange: TNotifyEvent read FOnChange write FOnChange;
    property OnChanging: TcxTabChangingEvent read FOnChanging write FOnChanging;
    property OnDrawTab: TcxDrawTabEvent read FOnDrawTab write FOnDrawTab;
    property OnDrawTabEx: TcxDrawTabExEvent read FOnDrawTabEx
      write FOnDrawTabEx;
    property OnGetImageIndex: TcxGetTabImageEvent read FOnGetImageIndex
      write FOnGetImageIndex;
    property OnGetTabHint: TcxGetTabHintEvent read FOnGetTabHint
    ...
    property OnNewTabCreate: TcxPCNewTabCreateEvent read FOnNewTabCreate
      write FOnNewTabCreate;
    property OnNew: TcxPCNewEvent read GetOnNew write SetOnNew stored False;
    // deprecated
    property OnTabDragAndDrop: TcxTabControlTabDragAndDropEvent
      read FOnTabDragAndDrop write FOnTabDragAndDrop;
    property OnTabEndDrag: TcxTabControlTabEndDragEvent read FOnTabEndDrag
      write FOnTabEndDrag;
    property OnTabStartDrag: TcxTabControlTabStartDragEvent read FOnTabStartDrag
      write FOnTabStartDrag;
  public
  ...
  protected
    ...
    procedure DoPageChanging(NewPage: TcxTabSheet;
  ...
  public
    ...
    property TabIndex;
    property TabSheetClass: TcxTabSheetClass read FTabSheetClass
  ...
  private
    ...
    // handlers
    procedure PropertiesPageChangingHandler(Sender: TObject;
  ...
  protected
    ...
    function DoUnDock(NewTarget: TWinControl; Client: TControl)
      : Boolean; override;
    function DockClient(DockSource: TDragDockObject; MousePos: TPoint)
      : Integer; virtual;
  ...
  published
    property AllowCloseButton: Boolean read FAllowCloseButton
      write SetAllowCloseButton default True;
  ...
  published
    ...
    property Properties: TcxTabControlProperties read GetProperties
      write SetProperties;
    property HideTabs;
    property HotTrack;
    property ImageBorder;
...
function DistanceGetter(const Distance: TcxPCDistance;
  const LongitudinalDistance: Boolean): Integer;
function InternalGetTextRotationAngle(AViewInfo: TcxCustomTabControlViewInfo)
  : TcxRotationAngle;
function InternalIsVerticalText(AViewInfo: TcxCustomTabControlViewInfo)
  : Boolean;
function IsBottomToTopAlignment(TabControl: TcxCustomTabControl): Boolean;
function IsOneOfButtons(AButton1, AButton2,
  AButton: TcxPCNavigatorButton): Boolean;
...
function RotateRectBack(const ARect: TRect;
  ATabPosition: TcxTabPosition): TRect;
procedure ValidateRect(var R: TRect);

function cxPCGetRightToLeftTabPosition(ATabPosition: TcxTabPosition)
  : TcxTabPosition;

function GetPCStyleName(AStyleID: TcxPCStyleID): string;

const
  NavigatorBtnStateToLookAndFeelBtnState: array [TcxPCNavigatorButtonState]
    of TcxButtonState = (cxbsNormal, cxbsPressed, cxbsHot, cxbsDisabled);
  dxPCOptionsNames: array [TcxPCOption] of string = ('AlwaysShowGoDialogButton',
    'CloseButton', 'FixedTabWidthWhenRotated', 'GoDialog', 'Gradient',
    'GradientClientArea', 'NoArrows', 'RedrawOnResize', 'Sort',
    'TopToBottomText', 'UsePageColorForTab');
...
uses
  Math, StrUtils, Types,
  dxThemeConsts, dxThemeManager, dxUxTheme, cxPCConsts, cxPCPainters,
  cxPCPaintersFactory, cxPCGoDialog, dxDPIAwareUtils,
  dxSkinscxPCPainter, dxMessages, cxCustomCanvas;
...
begin
  with TabControl do
  begin
    Result := (TabPosition in [tpLeft, tpRight]) and
      (not ViewInfo.ActuallyRotate) and not(pcoTopToBottomText in Options);
  end;
end;
...
begin
  ...
  begin
    Result := (TabPosition in [tpLeft, tpRight]) and
      (not ViewInfo.ActuallyRotate);
    Result := Result or (TabPosition in [tpTop, tpBottom]) and
...
begin
  case ATabPosition of
    tpLeft:
      Result := Rect(ARect.Top, ARect.Right, ARect.Bottom, ARect.Left);
    tpTop:
      Result := ARect;
    tpRight:
      Result := Rect(ARect.Bottom, ARect.Left, ARect.Top, ARect.Right);
    tpBottom:
      Result := Rect(ARect.Right, ARect.Bottom, ARect.Left, ARect.Top);
  end;
end;
...
begin
  case ATabPosition of
    tpLeft:
      Result := RotateRect(ARect, tpRight);
    tpTop:
      Result := ARect;
    tpRight:
      Result := RotateRect(ARect, tpLeft);
    tpBottom:
      Result := RotateRect(ARect, tpBottom);
  end;
end;
...
begin
  ...
  try
    ...
    if not Properties.IsLoading and (Properties.TabIndex = -1) and (Count = 1)
    then
...
procedure TcxTabs.Changed(ATab: TcxTab = nil;
  ATabPropertyChanged: TcxPCTabPropertyChanged = tpcLayout);
var
...
procedure TcxPCImageList.Draw(ACanvas: TcxCanvas; const R: TRect;
  AIndex: Integer; ABackgroundColor: TColor; AIsNativePainting, AEnabled,
  AHot: Boolean; APalette: IdxColorPalette);
  ...
  begin
    ...
    if (AIndex < 0) or (AIndex >= AImages.Count) then
      OutError('Draw', Format(cxGetResourceString(@scxPCImageListIndexError),
        [AIndex, AImages.Count - 1]));
  end;
...
begin
  Result := dxGetImageSize(GetImages(FBaseImages = nil),
    dxGetScaleFactor(FProperties.Owner));
end;
...
begin
  if AComponent = BaseImages then
    BaseImages := nil
  else if AComponent = BaseHotImages then
    BaseHotImages := nil;
end;
...
begin
  cxSetImageList(Value, FBaseHotImages, FBaseHotImageChangeLink,
    FFreeNotificator);
end;

procedure TcxPCImageList.SetBaseImages(const Value: TCustomImageList);
begin
...
procedure TcxTabControlDragAndDropObject.DragAndDrop(const P: TPoint;
  ...
  begin
    ...
    if (Result <> -1) and ((Result = FTabVisibleIndex) or ViewInfo.TabsViewInfo
      [Result].IsNewButton) then
      Result := -1;
    if (Result <> -1) then
    begin
      ...
      AIsAfter := (Result < FTabVisibleIndex) and
        (((Properties.TabPosition in [tpLeft, tpRight]) and
        (ViewInfo.IsBottomToTopAlignment xor AIsTop)) or
        ((Properties.TabPosition in [tpTop, tpBottom]) and
        (ViewInfo.IsRightToLeftAlignment xor AIsLeft)));
      if AIsAfter then
        Inc(Result);

      AIsBefore := (Result > FTabVisibleIndex) and
        (((Properties.TabPosition in [tpLeft, tpRight]) and
        not(ViewInfo.IsBottomToTopAlignment xor AIsTop)) or
        ((Properties.TabPosition in [tpTop, tpBottom]) and
        not(ViewInfo.IsRightToLeftAlignment xor AIsLeft)));
      if AIsBefore then
        Dec(Result);
...
begin
  ...
  CheckScrolling(P);
  Accepted := Accepted and (DestinationTabVisibleIndex <> -1) and
    (DestinationTabVisibleIndex <> FTabVisibleIndex);
...
procedure TcxTabControlDragAndDropObject.Init(ATabVisibleIndex: Integer;
  const P: TPoint);
begin
  FTabVisibleIndex := ATabVisibleIndex;
  FDragPointOffset := cxPointOffset(ViewInfo.TabsViewInfo[FTabVisibleIndex]
    .FullRect.TopLeft, P, False);
end;

function TcxTabControlDragAndDropObject.GetDragAndDropCursor
...
procedure TcxTabControlDragAndDropObject.CheckScrolling(const P: TPoint);
  ...
  begin
    Result := not ViewInfo.MultiLine and ViewInfo.PtInScrollingArea(P,
      FScrollingDirection);
  end;
...
const
  ArrowPlaceMap: array [Boolean, Boolean] of TcxArrowPlace =
    ((apRight, apBottom), (apLeft, apTop));
var
...
begin
  ...
  SetLength(R, 2);
  try
    R := ViewInfo.Painter.GetDropArrowRects(FTabVisibleIndex,
      FHitTabVisibleIndex, DestinationTabVisibleIndex);
    FDestinationArrowFirst := TcxDragAndDropArrow.Create(True);
    FDestinationArrowFirst.Init(AControlOrigin, cxNullRect, R[0],
      ArrowPlaceMap[True, ViewInfo.TabPosition in [tpTop, tpBottom]]);
    FDestinationArrowSecond := TcxDragAndDropArrow.Create(True);
    FDestinationArrowSecond.Init(AControlOrigin, cxNullRect, R[1],
      ArrowPlaceMap[False, ViewInfo.TabPosition in [tpTop, tpBottom]]);
...
begin
  FScrollingTimer := cxCreateTimer(ScrollingTimerHandler,
    TabScrollingStartDelay);
end;
...
begin
  ...
  begin
    ...
    ADestinationIndex := ViewInfo.TabsViewInfo
      [DestinationTabVisibleIndex].Index;
...
function TcxTabControlDragAndDropObject.GetProperties
  : TcxCustomTabControlProperties;
begin
  Result := FIControl.Properties;
end;

function TcxTabControlDragAndDropObject.GetViewInfo
  : TcxCustomTabControlViewInfo;
begin
...
begin
  ViewInfo.FirstTabVisibleIndex := ViewInfo.FirstTabVisibleIndex +
    FScrollingDirection;
...
procedure TcxTabControlDragAndDropObject.SetDestinationTabVisibleIndex
  (Value: Integer);
begin
...
constructor TcxCustomTabControlHitTest.Create
  (AOwner: TcxCustomTabControlController);
begin
  inherited Create;
  FController := AOwner;
end;
...
procedure TcxCustomTabControlHitTest.Update(AShift: TShiftState;
  const APoint: TPoint);
begin
  FShift := AShift;
  FHitPoint := APoint;
...
constructor TcxCustomTabControlHintHelper.Create(AController
  : TcxCustomTabControlController);
begin
  inherited Create;
...
begin
  Result := ControlViewInfo.MultiLineTabCaptions and
    Painter.AllowMultiLineTabCaptions;
end;
...
begin
  Result := CheckHasButton(Properties.CustomButtons.Mode) and
    AButton.DoCanShow(Tab.Index);
end;
...
begin
  ...
  begin
    ...
    if AButton.Visible and (AButton.Position in [pcbpTabs, pcbpTabsAndHeader])
      and HasButton(AButton) then
...
const
  ARotatePosition: array [TcxRotationAngle] of TcxTabPosition = (tpTop, tpRight,
    tpLeft, tpBottom);
  ...
  procedure InternalCalculateButtonHorizontalPositions(APosition: Integer;
  ...
  begin
    ...
    begin
      APosition := NextPosition(APosition, AAngle,
        IfThen(I > 0, Painter.GetTabButtonDistance));
      FButtonInfos[I].Bounds := SetRectCoordinate(FButtonInfos[I].Bounds,
        AAngle, rtcRight, APosition);
      APosition := NextPosition(APosition, AAngle, FButtonInfos[I].GetWidth);
      FButtonInfos[I].Bounds := SetRectCoordinate(FButtonInfos[I].Bounds,
        AAngle, rtcLeft, APosition);
    end;
  end;
  ...
  begin
    if InternalIsVerticalText(ControlViewInfo) then
      if (AAngle = raPlus90) xor IsButtonsPlacedFirst then
        ...
        Result := raMinus90
    else if IsButtonsPlacedFirst then
      Result := ra180
    else
      Result := ra0;
  end;
...
var
  ...
  APosition: Integer;
begin
  AAbsoluteAngle := GetAbsoluteAngle
    (InternalGetTextRotationAngle(ControlViewInfo));
...
begin
  ...
  begin
    ...
    CalculateAngleDependentPartBounds(AButtonRect,
      ControlViewInfo.TabButtonHeight,
...
begin
  ...
  AIsAssignedImagesAndRotate := IsImagesAssigned and
    ControlViewInfo.ActuallyRotate;
  AIsTabHasImage := HasImage;
  AIsTabHasImageArea := AIsAssignedImagesAndRotate or AIsTabHasImage;
  AImageTextDistance := IfThen(AIsTabHasImageArea,
    Painter.GetImageTextDistance(VisibleIndex));
  AImageAreaWidth := IfThen(AIsTabHasImageArea, GetImageAreaWidth);

  ATextWidth := GetVisibleTextWidth(AContentWidth - AImageAreaWidth -
    AImageTextDistance);
    ...
    ra0:
      begin
        ...
        begin
          ...
          FImageRect.Right := FImageRect.Left +
            ControlViewInfo.GetTabImageSize.cx;
        end;
        ...
        if ControlViewInfo.UseRightToLeftAlignment and
          (ControlViewInfo.TabPosition in [tpRight, tpLeft]) and
    ...
    raPlus90:
      begin
        ...
        begin
          ...
          FImageRect.Top := FImageRect.Bottom -
            ControlViewInfo.GetTabImageSize.cx;
        end;
        Dec(R.Bottom, AImageAreaWidth + AImageTextDistance);

        if not FIsTextTooLong and AIsAssignedImagesAndRotate then
          Dec(R.Bottom, GetContentHorizontalOffset(cxRectHeight(R),
            ATextWidth));
    ...
    raMinus90:
      begin
        ...
        begin
          ...
          FImageRect.Bottom := FImageRect.Top +
            ControlViewInfo.GetTabImageSize.cx;
        end;
        Inc(R.Top, AImageAreaWidth + AImageTextDistance);

        if not FIsTextTooLong and AIsAssignedImagesAndRotate then
          Inc(R.Top, GetContentHorizontalOffset(cxRectHeight(R), ATextWidth));
        FTextRect.Top := R.Top;
...
begin
  ...
  CalculateAngleDependentPartBounds(FImageRect,
    ControlViewInfo.GetTabImageSize.cy,
...
begin
  ...
  AIsTabHasImageArea := HasImage or IsImagesAssigned and
    ControlViewInfo.ActuallyRotate;
  AImageTextDistance := IfThen(AIsTabHasImageArea,
    Painter.GetImageTextDistance(VisibleIndex));
  AImageAreaWidth := IfThen(AIsTabHasImageArea, GetImageAreaWidth);
  AButtonsAreaWidth := IfThen(HasButtons,
    Painter.GetTabButtonsAreaWidth(VisibleIndex));
  FIsTextTooLong := TextWidth > (AContentWidth - AImageAreaWidth -
...
begin
  ...
  CalculateAngleDependentPartBounds(FTextRect, TextHeight,
...
begin
  ...
  else if not ControlViewInfo.ActuallyRotate or (GetDefinedWidth > 0) or
  ...
  begin
    ...
    case ACaptionAlignment of
      ...
      Result := (ATabWidth - AMaxTabCaptionWidth) div 2 + AMaxTabCaptionWidth -
        AContentWidth;
    end;
  end;
end;
...
begin
  Result := NormalRect;
  if ControlViewInfo.FIsLastTabFullyVisible or
    (VisibleIndex <> ControlViewInfo.LastTabVisibleIndex) then
  begin
...
begin
  ...
  FNormalPosition := TdxRightToLeftLayoutConverter.ConvertRect(NormalRect,
    AClientBounds).TopLeft;
  if not ControlViewInfo.IsNativePainting then
    FContentRect := TdxRightToLeftLayoutConverter.ConvertRect(FContentRect,
      AClientBounds);
...
begin
  Result := ShowAccelChar and IsAccel(Key, Caption) and
    ControlViewInfo.IsTabAccessible(VisibleIndex);
  if Result then
...
begin
  Result := ((AShowMode = cbmEveryTab) or (AShowMode = cbmActiveTab) and
    IsActive or (AShowMode = cbmActiveAndHoverTabs) and
    (IsActive or IsHotTrack));
end;
...
begin
  if ControlViewInfo.IsNativePainting then
    ...
    AParentRect := R;
  if not ControlViewInfo.IsNativePainting or
    (GetRelativeTextRotationAngle in [ra0, ra180]) then
  begin
    FImageRect := TdxRightToLeftLayoutConverter.ConvertRect(FImageRect,
      AParentRect);
    FTextRect := TdxRightToLeftLayoutConverter.ConvertRect(FTextRect,
...
const
  PaintingPositionIndexMap: array [TcxTabPosition, TcxRotationAngle]
    of Integer = (
    // 0  +90 -90 180
    (1, 2, 3, 0), // Top
    (10, 11, 12, 0), // Bottom
...
begin
  Result := PaintingPositionIndexMap[PaintingPosition,
    ControlViewInfo.GetTextRotationAngle];
end;
...
begin
  ...
  begin
    ATabRect := FullRect;
    if IsMainTab then
      ATabRect := Painter.GetExtendedRect(ATabRect, Rect(0, 0, 0, -1),
        PaintingPosition);
    case ControlViewInfo.GetTextRotationAngle of
      raPlus90:
        with Result do
          Result := Rect(Top, cxRectHeight(FullRect) - Right, Bottom,
            cxRectHeight(FullRect) - Left);
      raMinus90:
        with Result do
          Result := Rect(cxRectWidth(FullRect) - Bottom, Left,
            cxRectWidth(FullRect) - Top, Right);
    end;
...
begin
  Result := FContentRect;
  ACloseButtonAreaWidth := IfThen(HasButtons,
    Painter.GetTabButtonsAreaWidth(VisibleIndex));
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        ATabWidthCorrection := AContentOffset.Left + AContentOffset.Right +
          ATabCorrection.Left - ATabCorrection.Right;
        R := Rect(0, 0, GetLimitedWidth - ATabWidthCorrection, 1);
        cxDrawText(cxScreenCanvas.Handle, Caption, R,
          Painter.GetCTFlags(VisibleIndex));
        FTextSize := cxSize(R);
      end
      else
        FTextSize := cxSize(cxGetTextRect(cxScreenCanvas.Font, Caption,
          ALineCount, True))
    end
    else
      FTextSize := cxTextSize(cxScreenCanvas.Font, Caption,
        Painter.GetCTFlags(VisibleIndex));
...
begin
  if not ActuallyVisible then
    ...
    IntersectRect(Result, FullRect,
      ControlViewInfo.GetTabExtendedTabsRect(Self));
end;
...
constructor TcxTabsViewInfo.Create(ATabs: TcxTabs;
  AControlViewInfo: TcxCustomTabControlViewInfo);
begin
  inherited Create;
...
begin
  ...
  if not ControlViewInfo.Properties.IsDesigning and
    ControlViewInfo.Properties.NewButton.Visible then
...
begin
  ...
  else if FNeedRecreateViewInfos then
  begin
    DestroyViewInfos;
    CreateViewInfos;
...
begin
  ...
  begin
    if ControlViewInfo.MainTabVisibleIndex <> -1 then
      ControlViewInfo.TabIndex :=
        ViewInfos[ControlViewInfo.MainTabVisibleIndex].Index;
    FNeedCheckTabIndex := False;
  end;
end;

function TcxTabsViewInfo.CalculateHitTest
...
begin
  ...
  begin
    FNeedCheckTabIndex := FNeedCheckTabIndex or
      (ATab.Properties.TabIndexTabMustBeVisible and ViewInfos[AVisibleIndex]
      .IsMainTab);
...
begin
  ...
  FTabsViewInfo := Properties.Tabs.GetViewInfoClass.Create
    (Properties.Tabs, Self);
...
procedure TcxCustomTabControlViewInfo.Calculate;
  ...
  begin
    ...
    else if pcoTopToBottomText in Properties.Options then
      AHeaderImagesAngle := raMinus90
    else
      AHeaderImagesAngle := raPlus90;
    Properties.CustomButtons.FHeaderImages.ImageRotationAngle :=
      AHeaderImagesAngle;
  end;
...
procedure TcxCustomTabControlViewInfo.CalculateHitTest
  (AHitTest: TcxCustomTabControlHitTest);

  function CalculateNavigatorButtonsHitTest
    (AHitTest: TcxCustomTabControlHitTest): Boolean;
  var
    I: Integer;
  begin
...
procedure TcxCustomTabControlViewInfo.CalculateLongitudinalTabPositions;
  ...
  procedure InternalCalculateLongitudinalTabPositions(AFirstIndex,
    ALastIndex: Integer; ACalculateAll: Boolean = False;
    Row: Integer = 0); overload;
  var
    I: Integer;
  ...
  begin
    ...
    ALineStartPosition :=
      PointGetter(FTabsPosition.NormalTabsRect.TopLeft, AIsY);
    ASign := 1;
    ...
    begin
      ...
      ALineFinishPosition := ALineStartPosition +
        FTabsPosition.NormalRowWidth - 1;
    ADistanceBetweenTabs := DistanceGetter(Painter.GetTabsNormalDistance,
      not ActuallyRotate);
    ...
    begin
      ...
      ATabStartPosition := ATabFinishPosition +
        (1 + ADistanceBetweenTabs) * ASign;
      if (ATabStartPosition * ASign > ALineFinishPosition) and
        (not ACalculateAll) then
        Break;
    end;
    FIsLastTabFullyVisible :=
      (ATabFinishPosition * ASign <= ALineFinishPosition) and
      (FLastTabVisibleIndex = ALastIndex);
  end;

  procedure InternalCalculateLongitudinalTabPositions(const ABounds
    : TcxPCIndexInterval; ARow: Integer = 0); overload;
  begin
    InternalCalculateLongitudinalTabPositions(ABounds.Left, ABounds.Right,
      False, ARow);
  end;
  ...
  begin
    ...
    if IsTooSmallControlSize then
      Exit;
    InternalCalculateLongitudinalTabPositions(FFirstTabVisibleIndex,
      TabsViewInfo.ViewInfoCount - 1, True);
  ...
  procedure StretchTabWidths(const ABounds: TcxPCIndexInterval;
    AFreeSpace, ATotalTabsNormalWidth: Integer);
  var
  ...
  begin
    ...
    begin
      ...
      if I <> ABounds.Right then
        ATabWidthDelta := ATabViewInfo.NormalWidth *
          AFreeSpace div ATotalTabsNormalWidth
      else
  ...
  begin
    ...
    ADistanceBetweenTabs := DistanceGetter(Painter.GetTabsNormalDistance,
      not ActuallyRotate);
    ALineFreeSpaceWidth := FTabsPosition.NormalRowWidth -
      GetLineWidth(ALineIndexBoundsA, 0, ADistanceBetweenTabs);
    if ActuallyRotate or (ALineFreeSpaceWidth >= 0) then
      SingleLineCalculateLongitudinalTabPositions
    else
    begin
      FFirstTabVisibleIndex := 0;
      StretchTabWidths(ALineIndexBoundsA[0], ALineFreeSpaceWidth,
        GetLineWidth(ALineIndexBoundsA, 0, 0));
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        ALineFreeSpaceWidth := FTabsPosition.NormalRowWidth -
          GetLineWidth(ALineIndexBoundsA, ARow, ADistanceBetweenTabs);
        if ALineFreeSpaceWidth > 0 then
          StretchTabWidths(ALineIndexBoundsA[ARow], ALineFreeSpaceWidth,
            ATotalTabsNormalWidth);
      end;
  ...
  begin
    if TabPosition in [tpTop, tpBottom] then
    begin
      FExtendedBottomOrRightTabsRect.Left :=
        FTabsPosition.ExtendedTabsRect.Left;
      FExtendedBottomOrRightTabsRect.Right :=
        FTabsPosition.ExtendedTabsRect.Right;
    ...
    begin
      ...
      FExtendedBottomOrRightTabsRect.Bottom :=
        FTabsPosition.ExtendedTabsRect.Bottom;
      FExtendedTopOrLeftTabsRect.Top := FTabsPosition.ExtendedTabsRect.Top;
      FExtendedTopOrLeftTabsRect.Bottom :=
        FTabsPosition.ExtendedTabsRect.Bottom;
    end;
  end;
...
var
  ...
  begin
    ATabsDistance := DistanceGetter(Painter.GetTabsNormalDistance,
      ActuallyRotate);
  ...
  procedure SetDiametricalExtendedTabsRectsBorders;
    ...
    begin
      ...
      ABorder := ANormalTopBorder + FTopOrLeftPartRowCount *
        (RowHeight + ATabsDistance);
      Dec(ABorder, ATabsDistance);
      Inc(ABorder,
        FTabsPosition.ExtendedTopOrLeftTabsRectBottomOrRightBorderOffset);
      ...
      ABorder := ANormalBottomBorder - ABottomOrRightPartRowCount *
        (RowHeight + ATabsDistance);
      Inc(ABorder, ATabsDistance);
      Inc(ABorder,
        FTabsPosition.ExtendedBottomOrRightTabsRectTopOrLeftBorderOffset);
    ...
    begin
      ...
      begin
        ASecondaryBorderBound :=
          PointGetter(FExtendedTopOrLeftTabsRect.BottomRight, AIsY) +
          FTabsPosition.
          MinDistanceBetweenTopOrLeftAndBottomOrRightExtendedTabsRects;
        ASecondaryBorderBound := Min(ASecondaryBorderBound,
          AExtendedBottomBorder);
        if PointGetter(FExtendedBottomOrRightTabsRect.TopLeft, AIsY) < ASecondaryBorderBound
        then
          RectSetter(FExtendedBottomOrRightTabsRect, True, AIsY,
            ASecondaryBorderBound);
      end
      else
      begin
        ASecondaryBorderBound :=
          PointGetter(FExtendedBottomOrRightTabsRect.TopLeft, AIsY) -
          FTabsPosition.
          MinDistanceBetweenTopOrLeftAndBottomOrRightExtendedTabsRects;
        ASecondaryBorderBound := Max(ASecondaryBorderBound, AExtendedTopBorder);
        if PointGetter(FExtendedTopOrLeftTabsRect.BottomRight, AIsY) > ASecondaryBorderBound
        then
          RectSetter(FExtendedTopOrLeftTabsRect, False, AIsY,
            ASecondaryBorderBound);
      end;
    end;
  ...
  begin
    ...
    RectSetter(FExtendedBottomOrRightTabsRect, False, AIsY,
      AExtendedBottomBorder);
    SetInternalBorders;
    if (FTopOrLeftPartRowCount <> 0) and (FTopOrLeftPartRowCount <> FRowCount)
    then
...
begin
  ...
  begin
    if TabsViewInfo[I].VisibleRow < FTopOrLeftPartRowCount then
      C := ANormalTopBorder + TabsViewInfo[I].VisibleRow *
        (RowHeight + ATabsDistance)
    else
    begin
      C := ANormalBottomBorder - (RowCount - TabsViewInfo[I].VisibleRow) *
        RowHeight;
...
var
  ...
  begin
    if not InitializeVariables then
      Exit;
  ...
  begin
    ...
    begin
      if FFirstTabVisibleIndex = -1 then
        ...
        FFirstTabVisibleIndex := Min(FFirstTabVisibleIndex,
          TabsViewInfo.ViewInfoCount - 1);
    end
    else
      FFirstTabVisibleIndex := -1;
...
begin
  ...
  if (APrevTabIndex = TabIndex) and
    (APrevMainTabVisibleIndex <> MainTabVisibleIndex) and
...
procedure TcxCustomTabControlViewInfo.AfterPaintTab(ACanvas: TcxCanvas;
  ATab: TcxTab; AImageAndTextData: TcxPCOutTabImageAndTextData);
begin
end;

function TcxCustomTabControlViewInfo.ArrowButtonClick(ANavigatorButton
  : TcxPCNavigatorButton): Boolean;
...
procedure TcxCustomTabControlViewInfo.ButtonDestroying
  (AElementInfo: TcxPCCustomElementViewInfo);
begin
...
procedure TcxCustomTabControlViewInfo.ElementDestroying
  (AElementInfo: TcxPCCustomElementViewInfo);
begin
...
procedure TcxCustomTabControlViewInfo.CorrectFirstTabVisibleIndex
  (ATabVisibleIndex: Integer);
var
  C: Integer;
  ADistanceBetweenTabs: Integer;
begin
  ...
  else if (ATabVisibleIndex > FLastTabVisibleIndex) or
    ((ATabVisibleIndex = FLastTabVisibleIndex) and not FIsLastTabFullyVisible)
  then
  begin
    UpdateTabPosition(True);
    ADistanceBetweenTabs := DistanceGetter(Painter.GetTabsNormalDistance,
    ...
    begin
      ...
      FFirstTabVisibleIndex := ATabVisibleIndex;
      while (C + ADistanceBetweenTabs < FTabsPosition.NormalRowWidth) and
        (FFirstTabVisibleIndex > 0) do
      begin
        Dec(FFirstTabVisibleIndex);
...
function TcxCustomTabControlViewInfo.GetNextFocusedTabVisibleIndex
  (ACurrentTabVisibleIndex, ADelta: Integer; ACycle: Boolean;
  AOnlyAllowSelectedTabs: Boolean): Integer;
  ...
  begin
    ...
    Result := (AllowDisabledTabAccess or ATabViewInfo.ActuallyEnabled) and
      ATabViewInfo.CanFocus and (not AOnlyAllowSelectedTabs or
      ATabViewInfo.CanSelect);
  end;
...
begin
  ...
  begin
    ...
    while GetNextIndex(I) and not IsFocusable(I) and
      (I <> ACurrentTabVisibleIndex) do;
    if IsTabVisibleIndexValid(I) and IsFocusable(I) then
      Result := I;
  end;
end;

function TcxCustomTabControlViewInfo.GetTabColor(ATabVisibleIndex
  : Integer): TColor;
begin
  Result := TabsViewInfo[ATabVisibleIndex].Color;
end;

function TcxCustomTabControlViewInfo.GetTabExtendedTabsRect
  (ATabViewInfo: TcxTabViewInfo): TRect;
begin
...
function TcxCustomTabControlViewInfo.GetTabExtendedTabsRect(ATabVisibleIndex
  : Integer): TRect;
begin
...
procedure TcxCustomTabControlViewInfo.InitializeLineBoundsA
  (var ALineIndexBoundsA: TcxPCLineIndexBoundsArray;
...
procedure TcxCustomTabControlViewInfo.PlaceVisibleTabsOnRows(ATabsWidth,
  ATabsDistance: Integer);

  procedure InternalImproveTabsLayout(var ALineBoundsA
    : TcxPCLineIndexBoundsArray);

    function Deviation(const ALineBoundsA: TcxPCLineIndexBoundsArray;
      ALineIndex: Integer): Double;
    begin
      Result := Power(ATabsWidth - GetLineWidth(ALineBoundsA, ALineIndex,
        ATabsDistance), 2);
    end;

    function TotalDeviation(const ALineBoundsA
      : TcxPCLineIndexBoundsArray): Double;
    var
      I: Integer;
    begin
      Result := 0;
    ...
    function DoBest(var ALineBoundsA: TcxPCLineIndexBoundsArray;
      ALineIndex: Integer; ADirection: Integer): Boolean;

      procedure ChangeLineIndex(var ALineBoundsA: TcxPCLineIndexBoundsArray;
        ALineIndex: Integer);
      begin
        case ADirection of
          - 1:
    ...
    begin
      ...
      Result := (ANewError < APrevError) and
        (GetLineWidth(ATempLineBoundsA, ALineIndex, ATabsDistance) <=
        ATabsWidth);
      if Result then
        CopyBounds(ATempLineBoundsA, ALineBoundsA);
    end;

    function DoComplexBest(ACurrentError: Double;
      var ALineBoundsA: TcxPCLineIndexBoundsArray): Boolean;
    var
      I: Integer;
      ATempLineBoundsA: TcxPCLineIndexBoundsArray;
    ...
    begin
      ...
      begin
        ...
        until not DoBest(ATempLineBoundsA, I, -1) or
          (APrevDeviation < TotalDeviation(ATempLineBoundsA));
    ...
    function DoSimpleBest(var ALineBoundsA: TcxPCLineIndexBoundsArray;
    ...
    begin
      ...
      Result := DoComplexBest(ACurrentError, ALineBoundsA) or
        DoSimpleBest(ALineBoundsA, 1) or DoSimpleBest(ALineBoundsA, -1);
    end;
  ...
  var
    ALineIndexBoundsA: TcxPCLineIndexBoundsArray;
  begin
    if ActuallyRotate and Properties.RaggedRight then
      Exit;
...
begin
  ...
  begin
    ...
    begin
      ...
      if (I > AFirstIndex { guarantees that FVisibleTabList[AFirstIndex].FRow had been set } )
        and ((FRowCount - 1) - TabsViewInfo[AFirstIndex].FRow > 1) then
        ImproveTabsLayout(AFirstIndex, I - 1);
      AFirstIndex := I + 1;
      if (not ActuallyRotate) and (ATabsWidth > Painter.GetMinTabNormalWidth(I))
      then
    ...
    else if C + ATabViewInfo.NormalLongitudinalSize > ATabsWidth then
    begin
      Inc(FRowCount);
      ATabViewInfo.FRow := FRowCount - 1;
  ...
  if (TabsViewInfo.ViewInfoCount - 1 > AFirstIndex) and
    ((FRowCount - 1) - TabsViewInfo[AFirstIndex].FRow > 0) then
    ImproveTabsLayout(AFirstIndex, TabsViewInfo.ViewInfoCount - 1);
end;

procedure TcxCustomTabControlViewInfo.RepaintTab(ATabVisibleIndex: Integer;
  ATabPropertyChanged: TcxPCTabPropertyChanged);
begin
...
procedure TcxCustomTabControlViewInfo.TabDestroying(ATabViewInfo
  : TcxTabViewInfo);
begin
...
procedure TcxCustomTabControlViewInfo.TabDown(ATabVisibleIndex: Integer;
  AShift: TShiftState);
begin
  if ATabVisibleIndex <> -1 then
  begin
    if TabsViewInfo[ATabVisibleIndex].HasPressedState and not IControl.IsDesigning
    then
...
procedure TcxCustomTabControlViewInfo.TabUp(ATabVisibleIndex: Integer;
  AShift: TShiftState);
begin
  if (ATabVisibleIndex <> -1) and TabsViewInfo[ATabVisibleIndex]
    .HasPressedState and (ATabVisibleIndex = FPressedTabVisibleIndex) then
...
function TcxCustomTabControlViewInfo.GetHeaderButtonsDistance(AButtonInfo1,
  AButtonInfo2: TcxPCCustomHeaderButtonViewInfo): Integer;

  function GetButtonTypeForDistance(AButtonInfo
    : TcxPCCustomHeaderButtonViewInfo): TcxPCNavigatorButton;
  begin
...
begin
  if Supports(IControl, IInterfaceComponentReference, AComponentReference) and
    (AComponentReference.GetComponent is TWinControl) then
...
function TcxCustomTabControlViewInfo.CanMouseWheel(const AMousePos
  : TPoint): Boolean;
var
  R: TRect;
begin
  ...
  begin
    ...
    Result := (TabPosition in [tpTop, tpBottom]) and (AMousePos.Y >= R.Top) and
      (AMousePos.Y < R.Bottom) or (TabPosition in [tpLeft, tpRight]) and
      (AMousePos.X >= R.Left) and (AMousePos.X < R.Right);
  end;
end;

function TcxCustomTabControlViewInfo.HasNavigatorButton
  (AType: TcxPCNavigatorButton): Boolean;
begin
...
function TcxCustomTabControlViewInfo.PtInTab(ATabVisibleIndex: Integer;
  X, Y: Integer): Boolean;
begin
...
function TcxCustomTabControlViewInfo.IsTabFullVisible(ATabVisibleIndex
  : Integer): Boolean;
begin
...
function TcxCustomTabControlViewInfo.IsTabActuallyVisible
  (ATabViewInfo: TcxTabViewInfo): Boolean;
begin
...
begin
  Result := IsTabVisibleIndexValid(AIndex) and
    (TabsViewInfo[AIndex].ActuallyEnabled or AllowDisabledTabAccess or
    IControl.IsDesigning);
end;
...
function TcxCustomTabControlViewInfo.IsTabVisibleIndexValid
  (AIndex: Integer): Boolean;
begin
  Result := InRange(AIndex, 0, TabsViewInfo.ViewInfoCount - 1);
end;

function TcxCustomTabControlViewInfo.PtInScrollingArea(const P: TPoint;
  var ADirection: Integer): Boolean;
var
  ATabVisibleIndex: Integer;
begin
  ...
  begin
    ADirection := 0;
    if (ATabVisibleIndex = FirstTabVisibleIndex) and (FirstTabVisibleIndex > 0)
    then
      ADirection := -1;
    if (ATabVisibleIndex = LastTabVisibleIndex) and
      ((LastTabVisibleIndex < TabsViewInfo.ViewInfoCount - 1) or
      not FIsLastTabFullyVisible) then
      ADirection := 1;
    Result := (ADirection <> 0) and
      PtInRect(TabsViewInfo[ATabVisibleIndex].GetScrollingArea, P);
  end;
end;

function TcxCustomTabControlViewInfo.GetOptimalSize: Integer;
var
  ADistanceBetweenTabs, ATabFinishPosition, ATabStartPosition, ATabWidth,
    I: Integer;
  AIsY: Boolean;
...
procedure TcxCustomTabControlViewInfo.InitializeLineBoundsArray
  (var ALineIndexBoundsA: TcxPCLineIndexBoundsArray);
var
...
procedure TcxCustomTabControlViewInfo.InitializeVisibleTabRange(var AFirstIndex,
  ALastIndex: Integer);
begin
  if MultiLine then
  begin
...
procedure TcxCustomTabControlViewInfo.InvalidateRect(const R: TRect;
...
begin
  Result := (TabPosition in [tpTop, tpLeft]) and
    (TopOrLeftPartRowCount <> RowCount) or (TabPosition in [tpBottom, tpRight])
    and (TopOrLeftPartRowCount <> 0);
end;
...
procedure TcxCustomTabControlViewInfo.PrepareTabCanvasFont
  (ATabViewInfo: TcxTabViewInfo; ACanvas: TcxCanvas);
var
  AColor: TColor;
begin
  ACanvas.Lock;
...
function TcxCustomTabControlViewInfo.VisibleIndexOfTabAt(X, Y: Integer)
  : Integer;
var
  AFirstIndex, ALastIndex, I: Integer;
begin
...
function TcxCustomTabControlViewInfo.CanPressButton
  (AButton: TcxPCNavigatorButton): Boolean;
begin
  Result := True;
  case AButton of
    nbTopLeft, nbBottomRight:
      if IsSpecialAlignment and (AButton = nbTopLeft) or
        ...
        Result := (FLastTabVisibleIndex < TabsViewInfo.ViewInfoCount - 1) or
          not FIsLastTabFullyVisible and
          (FLastTabVisibleIndex <> FFirstTabVisibleIndex)
      else
...
function TcxCustomTabControlViewInfo.GetController
  : TcxCustomTabControlController;
begin
...
function TcxCustomTabControlViewInfo.GetLineWidth(const ALineIndexBoundsA
  : TcxPCLineIndexBoundsArray; ALineNumber, ATabsDistance: Integer): Integer;
var
  I: Integer;
begin
  Result := 0;
...
function TcxCustomTabControlViewInfo.GetNavigatorButtonInfos(Index: Integer)
  : TcxPCCustomHeaderButtonViewInfo;
begin
...
function TcxCustomTabControlViewInfo.GetNavigatorPosition
...
function TcxCustomTabControlViewInfo.GetProperties
  : TcxCustomTabControlProperties;
begin
...
begin
  ...
  if FMainTabVisibleIndex <> -1 then
    if Properties.ScrollOpposite then
      ARelativeTopPartRowCount := TabsViewInfo[FMainTabVisibleIndex]
        .FVisibleRow + 1
    else if Painter.IsMainTabBoundWithClient then
    begin
...
procedure TcxCustomTabControlViewInfo.SetHotTrackTabVisibleIndex
  (Value: Integer);
  ...
  begin
    ...
    if UseRightToLeftAlignment and (TabPosition in [tpTop, tpBottom]) then
      TabsViewInfo[ATabIndex].DoRightToLeftContentConversion
        (TabsViewInfo[ATabIndex].FContentRect);
...
procedure TcxCustomTabControlViewInfo.CreateHeaderButtons;
  ...
  begin
    ...
    begin
      AButton := Properties.CustomButtons.Buttons[I];
      if AButton.Visible and
        (AButton.Position in [pcbpHeader, pcbpTabsAndHeader]) then
        FNavigatorButtonInfos.Add(TcxPCHeaderButtonViewInfo.Create(Self,
          AButton));
    end;
  ...
  const
    ButtonsOrder: array [Boolean, TcxPCNavigatorButton]
      of TcxPCNavigatorButton = ((nbGoDialog, nbTopLeft, nbBottomRight,
      nbClose), (nbClose, nbTopLeft, nbBottomRight, nbGoDialog));
  var
  ...
  begin
    ...
    begin
      ...
      if ANextButton in FNavigatorButtons then
        FNavigatorButtonInfos.Add(TcxPCNavigatorButtonViewInfo.Create(Self,
          ANextButton));
    end;
  end;
...
begin
  ...
  begin
    if FPressedNavigatorButton <> nil then
      if AllowHotTrack and (FPressedNavigatorButton = FHotTrackNavigatorButton)
      then
...
procedure TcxCustomTabControlViewInfo.SetTrackingTabVisibleIndex
  (Value: Integer);
begin
...
procedure TcxCustomTabControlViewInfo.SynchronizeHotTrackStates
  (Shift: TShiftState);
var
  AMousePos: TPoint;
  ...
  AHitObject: TObject;
begin
  if Controller.FIsGoDialogShowing then
    Exit;
  ...
  if IsEnabled and (IControl.GetDragAndDropState = ddsNone) then
    ...
    begin
      ...
      begin
        ANewHotTrackTabVisibleIndex := VisibleIndexOfTabAt(AMousePos.X,
          AMousePos.Y);
        if (ANewHotTrackTabVisibleIndex <> -1) and
          (not TabsViewInfo[ANewHotTrackTabVisibleIndex].Enabled) then
          ANewHotTrackTabVisibleIndex := -1;
      end;
    end;
  ...
  if Controller.HitTest.HitAtTabButton then
    HotTrackTabButton := Controller.HitTest.HitObject as
      TcxPCCustomTabButtonViewInfo
  else
    HotTrackTabButton := nil;
end;
...
procedure TcxCustomTabControlViewInfo.UpdateButtonsState;
  ...
  procedure InternalUpdateButtonState(AButtonInfo
    : TcxPCNavigatorButtonViewInfo);
  var
  ...
  begin
    ...
    begin
      if (ANewButtonState = nbsDisabled) and
        (AButtonInfo = FHotTrackNavigatorButton) then
        FHotTrackNavigatorButton := nil;
      if (ANewButtonState = nbsDisabled) and
        (AButtonInfo = FPressedNavigatorButton) then
        FPressedNavigatorButton := nil;
...
begin
  for I := 0 to NavigatorButtonCount - 1 do
    if NavigatorButtonInfos[I].IsNavigatorButton([nbTopLeft, nbBottomRight,
      nbClose]) then
      InternalUpdateButtonState
        (TcxPCNavigatorButtonViewInfo(NavigatorButtonInfos[I]));
end;

procedure TcxCustomTabControlViewInfo.UpdateNavigatorButtons
  (AOnlyObligatoryButtons: Boolean);
begin
...
procedure TcxCustomTabControlViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
var
  I: Integer;
begin
  FExtendedBottomOrRightTabsRect := TdxRightToLeftLayoutConverter.ConvertRect
    (FExtendedBottomOrRightTabsRect, AClientBounds);
  FExtendedTopOrLeftTabsRect := TdxRightToLeftLayoutConverter.ConvertRect
    (FExtendedTopOrLeftTabsRect, AClientBounds);
  for I := 0 to FNavigatorButtonInfos.Count - 1 do
...
function TcxCustomTabControlViewInfo.GetTabViewInfo(ATab: TcxTab)
  : TcxTabViewInfo;
var
  I: Integer;
begin
...
constructor TcxPCCustomPainter.Create(AViewInfo: TcxCustomTabControlViewInfo);
begin
  inherited Create;
  FViewInfo := AViewInfo;
end;
...
begin
  ...
  begin
    Result := GetExtendedRect(ViewInfo.ControlBounds, GetPageClientRectOffset,
...
class function TcxPCCustomPainter.HasLookAndFeel(ALookAndFeel
  : TcxLookAndFeel): Boolean;
begin
  Result := False;
end;

class function TcxPCCustomPainter.IsDefault(ALookAndFeel
  : TcxLookAndFeel): Boolean;
begin
  Result := False;
end;
...
procedure TcxPCCustomPainter.CorrectTabContentVerticalOffset(ATabVisibleIndex
  : Integer; var ADrawOffset: TRect);

  procedure CorrectTabContentVerticalOffset;
  begin
    if HasTabPressedState then
    begin
      if (InternalGetTextRotationAngle(ViewInfo) = raMinus90)
        xor IsTabBorderThick(ATabVisibleIndex) then
      begin
        Inc(ADrawOffset.Top);
...
begin
  ...
  if IsMainTabBoundWithClient and
    (TabViewInfo[ATabVisibleIndex].GetRelativeTextRotationAngle = ra180) then
...
function TcxPCCustomPainter.GetDropArrowRects(ADragTabVisibleIndex,
  AHitTabVisibleIndex, ADestinationTabVisibleIndex: Integer): TRects;
const
...
begin
  ...
  ANextTabVisibleIndex := AIndex + DirectionMap
    [(AIndex < ADestinationTabVisibleIndex)
    xor ((AIndex = ADestinationTabVisibleIndex) and
    (ADragTabVisibleIndex < ADestinationTabVisibleIndex))];
  ...
  if ViewInfo.IsTabVisibleIndexValid(ANextTabVisibleIndex) and
    (ViewInfo.TabsViewInfo[AIndex].VisibleRow = ViewInfo.TabsViewInfo
    [ANextTabVisibleIndex].VisibleRow) then
  ...
  if AIsAfterInsert then
    if ViewInfo.UseRightToLeftAlignment and
      (ViewInfo.TabPosition in [tpTop, tpBottom]) then
  ...
  else if ViewInfo.UseRightToLeftAlignment and
    (ViewInfo.TabPosition in [tpTop, tpBottom]) then
...
procedure TcxPCCustomPainter.DirectionalPolyline(ACanvas: TcxCanvas;
  const R: TRect; APoints: array of TPoint; ATabPosition: TcxTabPosition;
  AColor: TColor);
begin
...
begin
  ...
  begin
    if CanDrawParentBackground then
      cxDrawTransparentControlBackground(ViewInfo.IControl.GetControl,
        ACanvas, R, False)
  end
  else
...
var
  AGlyphRect: TRect;
begin
  if IsImageAssigned(ViewInfo.Properties.HeaderButtonImages,
    AHeaderButtonInfo.ImageIndex) then
  begin
    AGlyphRect := cxRectCenter(AHeaderButtonInfo.Bounds,
      HeaderButtonImagePainter.RotatedImageSize);
    HeaderButtonImagePainter.Draw(ACanvas, AGlyphRect,
...
procedure TcxPCCustomPainter.DrawFocusRect(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
begin
end;

procedure TcxPCCustomPainter.DrawNativeTabBackground(DC: HDC;
  ATab: TcxTabSheet);
begin
end;

procedure TcxPCCustomPainter.DrawTabButtons(ACanvas: TcxCanvas;
  TabVisibleIndex: Integer);

  function NeedDrawImage(AButtonInfo: TcxPCCustomTabButtonViewInfo): Boolean;
  begin
    Result := IsImageAssigned(ViewInfo.Properties.TabButtonImages,
      AButtonInfo.ImageIndex);
  end;

  procedure InternalDrawTabButton(ACanvas: TcxCanvas; const ARect: TRect;
  ...
  begin
    ...
    begin
      if UseLookAndFeelTabButton then
        GetLookAndFeelPainter.DrawScaledSmallButton(ACanvas,
      ...
      begin
        TabButtonImagePainter.Draw(ACanvas,
          cxRectCenter(ARect, dxGetImageSize(nil,
          ViewInfo.Properties.TabButtonImages, AButtonInfo.ImageIndex,
          ScaleFactor)), AButtonInfo.ImageIndex, clNone, IsNativePainting,
    ...
    begin
      ...
      try
        ...
        try
          ...
          InternalDrawTabButton(ABitmap.cxCanvas, ABitmap.ClientRect,
            AButtonInfo);
...
procedure TcxPCCustomPainter.DrawTabImage(ACanvas: TcxCanvas;
  const ARect: TRect; AImageIndex: Integer; AEnabled: Boolean; AColor: TColor;
  ATabVisibleIndex: Integer);
begin
  ImagePainter.Draw(ACanvas, ARect, AImageIndex, AColor, IsNativePainting,
    AEnabled, TabViewInfo[ATabVisibleIndex].IsHotTrack,
    GetTabImageColorPalette);
end;

procedure TcxPCCustomPainter.DrawTabImageAndText(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
  ...
  begin
    ...
    AHasImage := IsImageAssigned(ViewInfo.Properties.Images,
      ATabViewInfo.ImageIndex);
    AHasHotImage := IsImageAssigned(ViewInfo.Properties.HotImages,
      ATabViewInfo.ImageIndex);
    AHotImagesAssigned := ViewInfo.Properties.HotImages <> nil;

    Result := not ATabViewInfo.IsHotTrack and AHasImage or
      ATabViewInfo.IsHotTrack and (AHotImagesAssigned and AHasHotImage or
      not AHotImagesAssigned and AHasImage);
  end;
...
procedure TcxPCCustomPainter.DrawTabText(ACanvas: TcxCanvas; const ARect: TRect;
  const AText: string; AEnabled: Boolean; AColor: TColor;
  ATabVisibleIndex: Integer);
const
  ATextOffset: array [TcxRotationAngle] of TPoint = ((X: 1; Y: 1), (X: 1;
    Y: - 1), (X: - 1; Y: 1), (X: 1; Y: 1));
begin
...
procedure TcxPCCustomPainter.ExcludeTabContentClipRegion(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
var
...
procedure TcxPCCustomPainter.FillFreeSpaceArea(ACanvas: TcxCanvas;
  const ARect: TRect);
begin
...
function TcxPCCustomPainter.GetButtonsDistance(AButton1,
  AButton2: TcxPCNavigatorButton): Integer;
begin
  Result := 0;
end;
...
function TcxPCCustomPainter.GetButtonWidth
...
function TcxPCCustomPainter.GetCloseButtonAreaHeight(ATabVisibleIndex
  : Integer): Integer;
begin
  Result := ViewInfo.TabButtonHeight + GetCloseButtonOffset(ATabVisibleIndex)
    .Top + GetCloseButtonOffset(ATabVisibleIndex).Bottom;
end;

function TcxPCCustomPainter.GetCloseButtonAreaWidth(ATabVisibleIndex
  : Integer): Integer;
begin
...
function TcxPCCustomPainter.GetCloseButtonOffset(ATabVisibleIndex
  : Integer): TRect;
var
...
function TcxPCCustomPainter.GetHeaderButtonGlyphPalette
  (AState: TcxPCNavigatorButtonState): IdxColorPalette;
begin
  Result := nil;
end;
...
begin
  ...
  if IsEnoughSpaceForClientPage then
  begin
    Result := GetExtendedRect(ViewInfo.ControlBounds, GetPageFrameRectOffset,
      ViewInfo.TabPosition);
    ValidateRect(Result);
  end;
end;
...
function TcxPCCustomPainter.GetScaledDrawImageOffset(ATabVisibleIndex
  : Integer): TRect;
begin
  Result := ScaleFactor.Apply(GetDrawImageOffset(ATabVisibleIndex));
end;

function TcxPCCustomPainter.GetScaledDrawTextHOffset(ATabVisibleIndex
  : Integer): TRect;
begin
...
function TcxPCCustomPainter.GetExtendedRect(const ARect, AExtension: TRect;
  ATabPosition: TcxTabPosition): TRect;
begin
...
function TcxPCCustomPainter.GetTabButtonsAreaWidth(ATabVisibleIndex
  : Integer): Integer;
var
  I: Integer;
begin
  ...
  Inc(Result, GetTabButtonDistance * (TabViewInfo[ATabVisibleIndex].ButtonsCount
    - 1) + cxMarginsWidth(GetCloseButtonOffset(ATabVisibleIndex)));
end;

function TcxPCCustomPainter.GetTabButtonColorPalette
  (AState: TcxPCNavigatorButtonState): IdxColorPalette;
begin
  if UseLookAndFeelTabButton then
    Result := GetLookAndFeelPainter.GetSmallButtonColorPalette
...
procedure TcxPCCustomPainter.AfterPaintTab(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
var
...
begin
  ATabViewInfo := TabViewInfo[ATabVisibleIndex];
  AImageAndTextData.TabImageRect := ATabViewInfo.GetAbsolutePartRect
    (ATabViewInfo.ImageRect);
  AImageAndTextData.TabTextRect := ATabViewInfo.GetAbsolutePartRect
    (ATabViewInfo.TextRect);
  AImageAndTextData.TabVisibleIndex := ATabVisibleIndex;
  ViewInfo.AfterPaintTab(ACanvas, TabViewInfo[ATabVisibleIndex].Tab,
    AImageAndTextData);
end;
...
begin
  if IsNativePainting then
  begin
    if cxGetThemeColor(totTab, TABP_TABITEM,
      GetTabNativeState(ATabVisibleIndex), TMT_TEXTCOLOR, AColor) then
      Result := AColor
    else
      Result := ATextColor;
  end
...
begin
  R := Rect(0, 0, 100, 100);
  GetThemeBackgroundContentRect(OpenTheme(totTab, ScaleFactor), 0, TABP_PANE, 0,
    R, Result);
...
function TcxPCCustomPainter.GetTabClipRgn(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer): TcxRegion;
begin
  Result := TcxRegion.Create(TabViewInfo[ATabVisibleIndex].VisibleRect);
end;

function TcxPCCustomPainter.GetTabClipRgnOperation(ATabVisibleIndex: Integer)
  : TcxRegionOperation;
begin
  Result := roIntersect;
end;
...
function TcxPCCustomPainter.GetTabNativeState(ATabVisibleIndex
  : Integer): Integer;
var
  ATabViewInfo: TcxTabViewInfo;
begin
  ...
  if ATabViewInfo.IsMainTab then
    Result := TIS_SELECTED
  else if ATabViewInfo.IsHotTrack then
    Result := TIS_HOT
  else
    Result := TIS_NORMAL;
end;
...
begin
  ...
  if IsNativePainting and TabViewInfo[ATabVisibleIndex].ActuallyEnabled and AreVisualStylesAvailable
  then
  begin
    if not ViewInfo.IsCustomTextColorAssigned then
    begin
      GetTabNativePartAndState(ATabVisibleIndex, APartId, AStateId);
      DrawThemeText(OpenTheme(totTab, ScaleFactor), ACanvas.Canvas.Handle,
        APartId, AStateId, ACaption, -1, GetDTFlags(ATabVisibleIndex),
        0, ARect);
    end
    else
    ...
    cxDrawText(ACanvas, ACaption, ARect, GetDTFlags(ATabVisibleIndex),
      clDefault, InternalGetTextRotationAngle(ViewInfo));
end;
      ...
      begin
        ...
        if ViewInfo.TopOrLeftPartRowCount <> ViewInfo.RowCount then
          Result.Bottom := ViewInfo.Height -
            ViewInfo.FExtendedBottomOrRightTabsRect.Top;
      end;
    tpLeft:
      begin
        Result.Top := ViewInfo.FExtendedTopOrLeftTabsRect.Right;
        if ViewInfo.TopOrLeftPartRowCount <> ViewInfo.RowCount then
          Result.Bottom := ViewInfo.Width -
            ViewInfo.FExtendedBottomOrRightTabsRect.Left;
      end;
    tpBottom:
      begin
...
function TcxPCCustomPainter.InternalSetClipRect(ACanvas: TcxCanvas;
  ClipR: TRect; IntersectWithCurrentClipRegion: Boolean = True): Boolean;
begin
  Result := False;
  ...
  begin
    if IntersectWithCurrentClipRegion and
      (not Windows.RectVisible(Handle, ClipR)) then
      Exit;
    SaveClipRegion;
...
procedure TcxPCCustomPainter.InvalidateTabExtendedTabsRect(TabVisibleIndex
  : Integer);
var
...
function TcxPCCustomPainter.PtInTab(TabVisibleIndex: Integer;
  X, Y: Integer): Boolean;
begin
  Result := True;
end;
...
function TcxPCCustomPainter.IsTabTransparent(ATabVisibleIndex: Integer)
  : Boolean;
begin
  Result := False;
end;
...
begin
  ...
  begin
    ...
    Result := ACanvas.RectVisible(R1) or ACanvas.RectVisible(R2) or
      ACanvas.RectVisible(R3) or ACanvas.RectVisible(R4);
  end;
end;
...
procedure TcxPCCustomPainter.PaintDragImage(ACanvas: TcxCanvas; const R: TRect;
  ATabVisibleIndex: Integer);
begin
...
procedure TcxPCCustomPainter.PaintTab(ACanvas: TcxCanvas;
  TabVisibleIndex: Integer);
begin
  // do nothing
end;
...
begin
  case ATabPosition of
    ...
    tpLeft:
      P := Point(R.Right - 1 - (R.Bottom - 1 - P.Y),
        R.Bottom - 1 - (P.X - R.Left));
    tpRight:
      P := Point(R.Bottom - 1 - P.Y + R.Left, R.Bottom - 1 - (P.X - R.Left));
  end;
end;

procedure TcxPCCustomPainter.RotatePolyline(const R: TRect;
  var APoints: array of TPoint; ATabPosition: TcxTabPosition);
var
  I: Integer;
begin
...
procedure TcxPCCustomElementViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
...
procedure TcxPCCustomElementViewInfo.SetHitTest
  (AHitTest: TcxCustomTabControlHitTest);
begin
...
function TcxPCCustomTabButtonViewInfo.GetControlViewInfo
  : TcxCustomTabControlViewInfo;
begin
...
begin
  ...
  begin
    Result := cxMarginsWidth(ControlViewInfo.Painter.GetTabButtonGlyphOffset) +
      dxGetImageSize(ControlViewInfo.Properties.TabButtonImages,
      ScaleFactor).cx;
  end
  else
...
begin
  Result := ControlViewInfo.Painter.GetCloseButtonSize.cx;
  if ControlViewInfo.TabButtonHeight >
    ControlViewInfo.Painter.GetCloseButtonSize.cy then
    Result := MulDiv(Result, ControlViewInfo.TabButtonHeight,
      ControlViewInfo.Painter.GetCloseButtonSize.cy);
end;
...
constructor TcxPCCustomHeaderButtonViewInfo.Create(ATabControlViewInfo
  : TcxCustomTabControlViewInfo);
begin
  inherited Create;
...
function TcxPCCustomHeaderButtonViewInfo.IsNavigatorButton
  (AButtonTypes: TcxPCNavigatorButtons): Boolean;
begin
  Result := False;
end;
...
function TcxPCCustomHeaderButtonViewInfo.GetControlViewInfo
  : TcxCustomTabControlViewInfo;
begin
...
constructor TcxPCHeaderButtonViewInfo.Create(ATabControlViewInfo
  : TcxCustomTabControlViewInfo; AButton: TcxPCButton);
begin
...
begin
  ...
  begin
    Result := cxMarginsWidth(ControlViewInfo.Painter.GetHeaderButtonGlyphOffset)
      + dxGetImageSize(ControlViewInfo.Properties.HeaderButtonImages,
      ScaleFactor).cx;
  end
  else
...
constructor TcxPCNavigatorButtonViewInfo.Create(ATabControlViewInfo
  : TcxCustomTabControlViewInfo; AButtonType: TcxPCNavigatorButton);
begin
  inherited Create(ATabControlViewInfo);
...
begin
  ...
  if ControlViewInfo.HeaderButtonHeight > ControlViewInfo.Painter.GetButtonHeight
  then
    Result := MulDiv(Result, ControlViewInfo.HeaderButtonHeight,
      ControlViewInfo.Painter.GetButtonHeight);
end;

function TcxPCNavigatorButtonViewInfo.IsNavigatorButton
  (AButtonTypes: TcxPCNavigatorButtons): Boolean;
begin
...
begin
  Result := inherited AllowHotTrack or
    (ButtonType in [nbTopLeft, nbBottomRight]);
end;
...
procedure TcxPCButtonViewInfos.Add(AButtonViewInfo
  : TcxPCCustomTabButtonViewInfo);
begin
...
function TcxPCButtonViewInfos.GetItems(Index: Integer)
  : TcxPCCustomTabButtonViewInfo;
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      else if Value and (GetSelectedTabCount > 0) and
        (not Properties.MultiSelect) then
  ...
  begin
    ...
    begin
      ...
      try
        ...
        OffsetWindowOrgEx(Message.DC, APageOffset.X, APageOffset.Y, nil);
        // B158825
...
begin
  if (PageControl <> nil) then
    PageControl.InvalidateControl(Self, Message.WParam = 0,
      PageControl.NeedRedrawOnResize);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if not(csLoading in Value.ComponentState) and (Value.ActivePage = nil) and TabVisible
      then
...
begin
  ...
  begin
    if Value > PageControl.PageCount - 1 then
      raise EListError.CreateFmt(cxGetResourceString(@scxPCPageIndexError),
        [Value, PageControl.PageCount - 1]);
...
begin
  ...
  begin
    FTabVisible := Value;
    PagePropertyChanged;
    if Value and (PageControl <> nil) and (PageControl.PageCount = 1) and
...
function TcxPageControlProperties.FindNextPage(ACurrentPage: TcxTabSheet;
  AGoForward, ACheckTabAccessibility, ACircular: Boolean): TcxTabSheet;
  ...
  function InternalGetNextPage(APagesCount: Integer; APageIndex: Integer)
    : TcxTabSheet;
  var
    I: Integer;
  begin
    ...
    begin
      if not ACheckTabAccessibility or Pages[APageIndex].TabVisible and
        (Pages[APageIndex].Enabled or AllowDisabledTabAccess) then
      begin
        Result := Pages[APageIndex];
        Break;
      end
      else if not IncrementIndex(APageIndex) then
        Break;
    end;
  end;
...
begin
  ...
  begin
    ...
    else if IncrementIndex(APageIndex) then
...
procedure TcxPageControlProperties.DoChanging(ANewTabIndex: Integer;
...
function TcxPageControlProperties.InternalGetTabHint(ATab: TcxTab;
...
procedure TcxPageControlProperties.RemovePage(APage: TcxTabSheet);
  ...
  function InternalFindNextPage(ACurrentPage: TcxTabSheet;
    AGoForward, ACheckTabAccessibility: Boolean): TcxTabSheet;
  begin
    Result := FindNextPage(ACurrentPage, AGoForward,
      ACheckTabAccessibility, False);
    if Result = nil then
      Result := FindNextPage(ACurrentPage, not AGoForward,
        ACheckTabAccessibility, False);
  end;
...
function TcxPageControlProperties.CanChangeActivePage
  (ANewPage: TcxTabSheet): Boolean;
begin
...
procedure TcxPageControlProperties.DoPageChanging(NewPage: TcxTabSheet;
  var AllowChange: Boolean);
begin
...
procedure TcxPageControlProperties.ChangeActivePage(APage: TcxTabSheet);
  ...
  begin
    ...
    begin
      if APage.Enabled and Control.Visible and Control.Enabled and
        Control.Parent.CanFocus then
        Result := APage
      else
        Result := Control;
    end
  ...
  procedure DoSetActiveControl(AParentForm: TCustomForm;
    AActiveControl: TWinControl);
  begin
    if AActiveControl <> nil then
      AParentForm.ActiveControl := AActiveControl;
    if (AParentForm <> nil) and (APage <> nil) and
      (AParentForm.ActiveControl = APage) then
      APage.SelectFirst;
  end;
...
begin
  if FActivePageSetting or Control.IsDestroying or (APage <> nil) and
    (APage.PageControl <> Control) then
    Exit;
...
begin
  ...
  if (Result = clDefault) and (ATabSheet <> nil) and
    ((pcoUsePageColorForTab in Properties.Options) or Painter.AlwaysColoredTabs)
    and not ATabSheet.ParentColor then
...
function TcxPageControl.FindNextPage(ACurrentPage: TcxTabSheet;
  AGoForward, ACheckTabAccessibility: Boolean): TcxTabSheet;
begin
  Result := FindNextPageEx(ACurrentPage, AGoForward,
    ACheckTabAccessibility, True);
end;

function TcxPageControl.FindNextPageEx(ACurrentPage: TcxTabSheet;
  AGoForward, ACheckTabAccessibility, ACircular: Boolean): TcxTabSheet;
begin
  Result := Properties.FindNextPage(ACurrentPage, AGoForward,
    ACheckTabAccessibility, ACircular);
end;
...
procedure TcxPageControl.SelectNextPage(GoForward: Boolean;
  CheckTabVisible: Boolean = True);
var
  Page: TcxTabSheet;
begin
...
procedure TcxPageControl.DoAddDockClient(Client: TControl; const ARect: TRect);
begin
...
procedure TcxPageControl.GetSiteInfo(Client: TControl; var InfluenceRect: TRect;
...
procedure TcxPageControl.PropertiesPageChangingHandler(Sender: TObject;
  NewPage: TcxTabSheet; var AllowChange: Boolean);
begin
...
begin
  ...
  begin
    Child.SetBounds(Child.Left + Left, Child.Top + Top, Child.Width,
      Child.Height);
    Child.Parent := Parent;
  end;
end;
...
function TcxCustomTabControlController.DoMouseWheelDown(Shift: TShiftState;
...
function TcxCustomTabControlController.DoMouseWheelUp(Shift: TShiftState;
  MousePos: TPoint): Boolean;
begin
  Result := ViewInfo.CanMouseWheel(MousePos);
  if Result then
...
procedure TcxCustomTabControlController.MouseDown(Button: TMouseButton;
  ...
  begin
    ...
    if AButtonInfo.IsNavigatorButton([nbTopLeft, nbBottomRight]) then
      ArrowButtonMouseDown((AButtonInfo as TcxPCNavigatorButtonViewInfo)
        .ButtonType);
  end;
  ...
  if IControl.IsDesigning or ViewInfo.IsTabsVisible then
    if (Button = mbLeft) then
      ...
      begin
        ...
        if (not AGoDialogJustClosed or not AButtonInfo.IsNavigatorButton
          ([nbGoDialog])) and (AButtonInfo.State <> nbsDisabled) then
          NavigatorButtonDown(AButtonInfo)
      end
      else if HitTest.HitAtTabButton then
        TabButtonDown(TcxPCCustomTabButtonViewInfo(HitTest.HitObject))
      else
        TabDown(ViewInfo.VisibleIndexOfTabAt(X, Y), Shift)
    else if not IControl.IsDesigning and Properties.CloseTabWithMiddleClick and
...
procedure TcxCustomTabControlController.MouseMove(Shift: TShiftState;
  X, Y: Integer);

  procedure CheckTabsScrolling(APrevButtonInfo
    : TcxPCCustomHeaderButtonViewInfo);
  var
    AButtonInfo: TcxPCCustomHeaderButtonViewInfo;
  begin
    ...
    if not IsScrollTimerStarted and (APrevButtonInfo <> AButtonInfo) and
      (AButtonInfo <> nil) and
      (AButtonInfo.IsNavigatorButton([nbTopLeft, nbBottomRight])) and
...
procedure TcxCustomTabControlController.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
...
begin
  ...
  begin
    StopScrollTimer;
    AButtonClick := (FHitTest.HitAtHeaderButton and
      (FHitTest.HitObject = ViewInfo.PressedNavigatorButton)) or
      (HitTest.HitAtTabButton and
      (FHitTest.HitObject = ViewInfo.PressedTabButton));
...
begin
  Result := ViewInfo.IsTabsVisible and
    ViewInfo.TabsViewInfo.HandleDialogChar(Key);
end;

function TcxCustomTabControlController.KeyDown(var Key: Word;
  ...
  begin
    ...
    case Key of
      ...
      VK_RETURN, VK_SPACE:
        begin
          ...
          else if ViewInfo.FocusedTabVisibleIndex <> ViewInfo.MainTabVisibleIndex
          then
          begin
    ...
    begin
      ...
      begin
        ...
        if ViewInfo.TrackingTabVisibleIndex <> -1 then
          Result := ViewInfo.TrackingTabVisibleIndex
        else if ViewInfo.FocusedTabVisibleIndex <> -1 then
          Result := ViewInfo.FocusedTabVisibleIndex
      ...
      else if not ViewInfo.IsTabAccessible(Result) then
        Result := ViewInfo.GetNextFocusedTabVisibleIndex(Result, ADelta, ACycle,
          Key in [VK_TAB, VK_RETURN, VK_SPACE]);
    end;
  end;
...
begin
  Result := False;
  if not ViewInfo.IsTabsVisible or (Shift = [ssAlt]) or
    (Shift = [ssAlt, ssShift]) then
    Exit;
...
procedure TcxCustomTabControlController.TabClick(ATabVisibleIndex: Integer;
  AShift: TShiftState; AMouseEvent: Boolean);
var
  ATabViewInfo: TcxTabViewInfo;
  ATab: TcxTab;
  ALink: TcxObjectLink;
...
procedure TcxCustomTabControlController.DoTabClick(ATabVisibleIndex: Integer;
  AShift: TShiftState);
begin
  Properties.DoTabClick(ATabVisibleIndex, AShift);
end;

procedure TcxCustomTabControlController.TabDown(ATabVisibleIndex: Integer;
  AShift: TShiftState);
begin
  if ViewInfo.IsTabAccessible(ATabVisibleIndex) then
  begin
...
procedure TcxCustomTabControlController.TabUp(ATabVisibleIndex: Integer;
  AShift: TShiftState);
begin
...
procedure TcxCustomTabControlController.TabButtonDown(ATabButtonInfo
  : TcxPCCustomTabButtonViewInfo);
begin
...
function TcxCustomTabControlController.StartDragAndDrop
  (const P: TPoint): Boolean;
begin
  Result := Properties.AllowTabDragDrop and HitTest.HitAtTab and
    not HitTest.HitAtTabButton and HitTest.HitTab.CanDrag;
  if Result then
    (IControl.GetDragAndDropObject as TcxTabControlDragAndDropObject)
      .Init(TcxTabViewInfo(HitTest.HitObject).VisibleIndex, P);
end;
...
function TcxCustomTabControlController.GetDragAndDropObjectClass
  : TcxTabControlDragAndDropObjectClass;
begin
...
var
  P: TPoint;
begin
  P := GetClientToScreen(cxRectLeftBottom(ViewInfo.NavigatorButtonInfoByType
    [nbGoDialog].Bounds));
  FGoDialog.Popup(P.X, P.Y);
  HideGoDialog(-1);
end;

function TcxCustomTabControlController.GetClientToScreen
...
function TcxCustomTabControlController.GetScreenToClient
  (const APoint: TPoint): TPoint;
begin
  Result := APoint;
...
procedure TcxCustomTabControlController.GoDialogClickEventHandler
  (ATabVisibleIndex: Integer);
begin
...
procedure TcxCustomTabControlController.HideGoDialog(ATabVisibleIndex: Integer);
  ...
  begin
    ...
    Result := (AOwnerWnd <> 0) and
      (dxMessagesController.IsMessageInQueue(AOwnerWnd, WM_LBUTTONDOWN) or
...
function TcxCustomTabControlController.GetHintHelperClass
  : TcxCustomTabControlHintHelperClass;
begin
  Result := TcxCustomTabControlHintHelper;
end;

procedure TcxCustomTabControlController.ArrowButtonMouseDown(ANavigatorButton
...
procedure TcxCustomTabControlController.ArrowButtonClick(ANavigatorButton
  : TcxPCNavigatorButton);
var
...
function TcxCustomTabControlController.GetProperties
  : TcxCustomTabControlProperties;
begin
  Result := IControl.Properties;
end;
...
begin
  ...
  AArrowButtonInfo := ViewInfo.FPressedNavigatorButton as
    TcxPCNavigatorButtonViewInfo;
...
procedure TcxPCButtons.SetItem(Index: Integer; Value: TcxPCButton);
begin
...
procedure TcxCustomTabControlProperties.AddDeferredEvent(AEvent: TNotifyEvent;
  ASender: TObject);
var
...
begin
  for I := 0 to FLockedEvents.Count - 1 do
    CallNotify(TEventInfo(FLockedEvents[I]).Event,
      TEventInfo(FLockedEvents[I]).Sender);
  FLockedEvents.Clear;
end;
...
function TcxCustomTabControlProperties.CanCloseButtonShow(ATab: TcxTab)
  : Boolean;
begin
  Result := ATab.AllowCloseButton;
end;

procedure TcxCustomTabControlProperties.Changed
...
function TcxCustomTabControlProperties.DoCanChange(ANewTabIndex
  : Integer): Boolean;
begin
  Result := True;
...
procedure TcxCustomTabControlProperties.DoChanging(ANewTabIndex: Integer;
  var AAllowChange: Boolean);
begin
...
procedure TcxCustomTabControlProperties.DoChanged
  (AType: TcxCustomTabControlPropertiesChangedType = pctHard);
begin
...
function TcxCustomTabControlProperties.DoPaintDragImage
  (AImage: TcxDragImage): Boolean;
var
  ABitmap: TBitmap;
begin
  ...
  try
    ...
    begin
      ...
      TcxDragImageAccess(AImage).TransparentColorValue :=
        ABitmap.TransparentColor;
      TcxDragImageAccess(AImage).TransparentColor := True;
      cxBitBlt(AImage.Canvas.Handle, ABitmap.Canvas.Handle, AImage.ClientRect,
        cxNullPoint, SRCCOPY);
    end;
  finally
    ABitmap.Free;
...
procedure TcxCustomTabControlProperties.DoPrepareTabCanvasFont(ATab: TcxTab;
  ACanvas: TcxCanvas);
begin
...
function TcxCustomTabControlProperties.DoCustomDraw(TabVisibleIndex
  : Integer): Boolean;
begin
...
procedure TcxCustomTabControlProperties.MoveTab(ACurrentIndex,
  ANewIndex: Integer);
begin
...
procedure TcxCustomTabControlProperties.DoDrawTabEx(ATabVisibleIndex: Integer;
  AFont: TFont);
begin
...
procedure TcxCustomTabControlProperties.DoTabClick(ATabVisibleIndex: Integer;
  AShift: TShiftState);
begin
...
begin
  Result := Supports(Owner, IcxControlComponentState, AIntf) and
    AIntf.IsDesigning;
end;
...
function TcxCustomTabControlProperties.InternalGetTabHint(ATab: TcxTab;
  var ACanShow: Boolean): string;
begin
  Result := ATab.Caption;
...
function TcxCustomTabControlProperties.GetButtonHint(AButtonViewInfo
  : TcxPCCustomButtonViewInfo): string;
var
...
begin
  ...
  if not IsImageAssigned(Images, Result) and not IsImageAssigned(HotImages,
    Result) then
    Result := -1;
end;

function TcxCustomTabControlProperties.GetNavigatorButtons
  (AOnlyObligatoryButtons: Boolean): TcxPCNavigatorButtons;
begin
  Result := [];
...
procedure TcxCustomTabControlProperties.TabSlantsChangedHandler
  (Sender: TObject);
begin
  Changed;
end;
...
procedure TcxCustomTabControlProperties.SetDragImage
  (const Value: TdxSmartGlyph);
begin
...
procedure TcxCustomTabControlProperties.SetImages
...
procedure TcxCustomTabControlProperties.SetNavigatorPosition
...
procedure TcxCustomTabControlProperties.SetNewButtonMode
  (Value: TcxPCNewButtonMode);
begin
...
const
  ...
  LayoutOptionsMap: TcxPCOptions = [pcoAlwaysShowGoDialogButton, pcoCloseButton,
    pcoFixedTabWidthWhenRotated, pcoGoDialog, pcoGradient,
    pcoGradientClientArea, pcoNoArrows, pcoTopToBottomText];
var
...
begin
  ...
  begin
    ...
    if AChangedOptions * LayoutOptionsMap <> [] then
      Changed
    else if AChangedOptions * GraphicOptionsMap <> [] then
      Changed(pctLight);
  end;
end;
...
procedure TcxCustomTabControlProperties.SetStyle(const Value: TcxPCStyleID);
begin
...
procedure TcxCustomTabControlProperties.SetTabCaptionAlignment
  (Value: TAlignment);
begin
...
begin
  ...
  if (Value <> -1) and (Value < 0) or (Value >= Tabs.Count) then
    Exit;
  if (Value <> -1) and TabIndexTabMustBeVisible and (not Tabs[Value].Visible)
  then
    Value := -1;
...
procedure TcxCustomTabControl.SetProperties(const Value
  : TcxCustomTabControlProperties);
begin
...
begin
  if Focused or HandleAllocated and Windows.IsChild(Handle, Windows.GetFocus)
  then
  begin
    if Controller.KeyDown(Message.CharCode, KeyDataToShiftState(Message.KeyData))
    then
    begin
      Message.Result := 1;
      Exit;
...
procedure TcxCustomTabControl.SetStandardStyle(StandardStyle
  : TcxPCStandardStyle);
const
  StandardStyleNameMap: array [TcxPCStandardStyle] of string = ('tsTabs',
...
begin
  ...
  if NewPainterClass = nil then
    OutError('SetStandardStyle',
      Format(cxGetResourceString(@scxPCStandardStyleError),
...
begin
  ...
  begin
    ...
    if NewPainterClass = nil then
      OutError('SetStyleByName',
        Format(cxGetResourceString(@scxPCStyleNameError), [StyleName]))
    else
      Style := NewPainterClass.GetStyleID;
  end;
end;
...
procedure TcxCustomTabControl.ChangeScaleEx(M, D: Integer;
  isDpiChange: Boolean);
begin
  if (M <> D) and (not(csLoading in ComponentState) or (FScalingFlags <> []))
  then
  begin
...
procedure TcxCustomTabControl.DefineProperties(Filer: TFiler);
  ...
  begin
    if Assigned(Filer.Ancestor) then
      Result := InternalGetClientRect.Bottom <> TcxCustomTabControl
        (Filer.Ancestor).InternalGetClientRect.Bottom
    else
  ...
  begin
    if Assigned(Filer.Ancestor) then
      Result := InternalGetClientRect.Left <> TcxCustomTabControl
        (Filer.Ancestor).InternalGetClientRect.Left
    else
  ...
  begin
    if Assigned(Filer.Ancestor) then
      Result := InternalGetClientRect.Right <> TcxCustomTabControl
        (Filer.Ancestor).InternalGetClientRect.Right
    else
      Result := True;
  end;
  ...
  begin
    if Assigned(Filer.Ancestor) then
      Result := InternalGetClientRect.Top <> TcxCustomTabControl(Filer.Ancestor)
        .InternalGetClientRect.Top
    else
      Result := True;
  end;
...
begin
  ...
  Filer.DefineProperty('ClientRectTop', ReadClientRectTop, WriteClientRectTop,
    IsClientRectTopStored);
  FIsClientRectLoaded := True;
end;

function TcxCustomTabControl.GetDesignHitTest(X, Y: Integer;
  Shift: TShiftState): Boolean;
begin
  ...
  begin
    ...
    Result := Controller.HitTest.HitAtNavigatorButton and
      not(TcxPCNavigatorButtonViewInfo(Controller.HitTest.HitObject).ButtonType
      in [nbGoDialog, nbClose]) or Controller.HitTest.HitAtTab and
      (TcxTabViewInfo(Controller.HitTest.HitObject).Index <> TabIndex);
  end;
end;
...
procedure TcxCustomTabControl.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
...
procedure TcxCustomTabControl.PropertiesTabClickHandler(Sender: TObject;
  ATabVisibleIndex: Integer; AShift: TShiftState);
begin
  // do nothing
end;

function TcxCustomTabControl.PropertiesTabDragAndDrop(AIndex, ADestinationIndex
  : Integer): Boolean;
begin
  Result := True;
...
begin
  ...
  else if (AIndex = TabIndex) and Assigned(FOnCanClose) then
...
procedure TcxCustomTabControl.PropertiesChangedHandler(Sender: TObject;
  AType: TcxCustomTabControlPropertiesChangedType);
begin
  case AType of
    pctLight:
...
procedure TcxCustomTabControl.PropertiesGetImageIndexHandler(Sender: TObject;
...
procedure TcxCustomTabControl.PropertiesNewTabButtonClickHandler
  (Sender: TObject; var AHandled: Boolean);
begin
  if Assigned(FOnNewTabButtonClick) then
    FOnNewTabButtonClick(Self, AHandled);
end;

procedure TcxCustomTabControl.PropertiesNewTabCreateHandler(Sender: TObject;
  AIndex: Integer);
begin
  if Assigned(FOnNewTabCreate) then
    FOnNewTabCreate(Self, AIndex);
...
procedure TcxCustomTabControl.PropertiesPaintDragImageHandler(Sender: TObject;
  ABitmap: TBitmap; var ADone: Boolean);
begin
  if Assigned(FOnPaintDragImage) then
...
function TcxCustomTabControl.GetControllerClass
  : TcxCustomTabControlControllerClass;
begin
...
function TcxCustomTabControl.GetPropertiesClass
  : TcxCustomTabControlPropertiesClass;
begin
...
class procedure TcxCustomTabControl.OutError(SourceMethodName: TCaption;
  Msg: TCaption);
begin
  raise EdxException.Create('TcxCustomTabControl.' + SourceMethodName +
    ': ' + Msg);
end;
...
procedure TcxCustomTabControl.PropertiesPrepareTabCanvasFontHandler
  (ATab: TcxTab; ACanvas: TcxCanvas);
begin
  // do nothing
end;
...
begin
  ...
  begin
    ...
    begin
      FPainter := nil;
      OutError('GetPainterInstance',
        cxGetResourceString(@scxPCPainterClassError));
    end
    else
...
begin
  if IsLoading or IsDestroying or ViewInfo.IsUpdating then
    Exit;
  LayoutChanged(True);
end;
...
function TcxCustomTabControl.InternalKeyDown(Key: Word;
  Shift: TShiftState): Boolean;
begin
  Result := Controller.KeyDown(Key, Shift);
end;

function TcxCustomTabControl.AllowAutoDragAndDropAtDesignTime(X, Y: Integer;
  Shift: TShiftState): Boolean;
begin
  Result := False;
end;
...
procedure TcxCustomTabControl.DragAndDrop(const P: TPoint;
  var Accepted: Boolean);
var
...
begin
  ...
  Accepted := (ADragAndDropObject.DestinationTabVisibleIndex <> -1) and
    PropertiesTabDragAndDrop(ADragAndDropObject.GetDragTabIndex,
    ADragAndDropObject.GetDragDestinationTabIndex);
  inherited DragAndDrop(P, Accepted);
end;
...
begin
  ...
  Accepted := (ADragAndDropObject.DestinationTabVisibleIndex <> -1) and
    (ADragAndDropObject.TabVisibleIndex <> -1) and
    (ADragAndDropObject.DestinationTabVisibleIndex <>
    ADragAndDropObject.TabVisibleIndex) and
    PropertiesTabDragAndDrop(ADragAndDropObject.GetDragTabIndex,
    ADragAndDropObject.GetDragDestinationTabIndex);
  inherited EndDragAndDrop(Accepted);
...
begin
  ...
  if Result then
    PropertiesTabStartDrag(TcxTabControlDragAndDropObject(DragAndDropObject)
      .GetDragTabIndex);
end;
