...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Windows, Classes, Controls, Graphics, SysUtils, cxGraphics,
  cxLookAndFeels,
...
type
  ...
  protected
    function CalculateTabNormalWidth(ATabViewInfo: TcxTabViewInfo)
      : Integer; override;
    ...
    procedure DoDrawTabCloseButton(ACanvas: TcxCanvas; const ARect: TRect;
      AState: TcxPCNavigatorButtonState); override;
    procedure DrawButtonFrameAndBackground(ACanvas: TcxCanvas;
      const ARect: TRect; AState: TcxPCNavigatorButtonState); virtual;
    ...
    function GetTabContentWOffset(ATabVisibleIndex: Integer)
      : TcxPCWOffset; override;
    ...
    function GetTooNarrowTabContentWOffset(ATabVisibleIndex: Integer)
      : TcxPCWOffset; override;
    function InternalCalculateTabNormalWidth(ATabVisibleIndex: Integer)
      : Integer; virtual;
    ...
    procedure RepaintTab(TabVisibleIndex: Integer;
      TabPropertyChanged: TcxPCTabPropertyChanged); override;
    ...
    procedure DoPaintButton(ACanvas: TcxCanvas;
      AButtonInfo: TcxPCCustomHeaderButtonViewInfo); virtual;
    ...
    function GetButtonCenteredContentPosition(const ARect: TRect;
      AButton: TcxPCNavigatorButton; AState: TcxPCNavigatorButtonState): TPoint;
    function GetButtonColor(AButtonState: TcxPCNavigatorButtonState)
      : TColor; virtual;
    function GetButtonContentColor(AButtonState: TcxPCNavigatorButtonState)
      : TColor; virtual;
    function GetButtonContentPosition(const ARect: TRect;
    ...
    function GetTabNormalContentOffset(ATabVisibleIndex: Integer)
      : Integer; virtual;
    function GetTabNormalImageAreaWidth(ATabVisibleIndex: Integer)
      : Integer; virtual;
    ...
    procedure InternalDrawFocusRect(ACanvas: TcxCanvas;
      TabVisibleIndex: Integer; R: TRect); virtual;
    procedure InternalPaintDragImage(ACanvas: TcxCanvas;
      ATabVisibleIndex: Integer); override;
    procedure InternalPaintTab(ACanvas: TcxCanvas;
    ...
    procedure PaintHeaderButton(ACanvas: TcxCanvas;
      AButtonInfo: TcxPCHeaderButtonViewInfo); virtual;
    procedure DoPaintPageFrame(ACanvas: TcxCanvas); override;
    function GetRightToLeftDependentButtonType(AButton: TcxPCNavigatorButton)
      : TcxPCNavigatorButton;
    procedure PaintFrameBorder(ACanvas: TcxCanvas; R: TRect); virtual;
    procedure PaintTabShape(ACanvas: TcxCanvas; ATabVisibleIndex: Integer);
      virtual; abstract;
  ...
  strict private
    ...
    procedure CorrectContentWOffset(ATabVisibleIndex: Integer;
      var AOffset: TcxPCWOffset);
  protected
    function GetButtonContentPosition(const ARect: TRect;
      AButton: TcxPCNavigatorButton; AState: TcxPCNavigatorButtonState)
      : TPoint; override;
  ...
  protected
    ...
    function PtInTab(TabVisibleIndex: Integer; X, Y: Integer): Boolean;
      override;
    function NeedShowFrame: Boolean; override;
    procedure PaintButton(ACanvas: TcxCanvas; const ARect: TRect;
      AState: TcxPCNavigatorButtonState; AType: TcxPCNavigatorButton); override;
    procedure PaintHeaderButton(ACanvas: TcxCanvas;
      AButtonInfo: TcxPCHeaderButtonViewInfo); override;
    ...
    procedure DoPaintPageFrame(ACanvas: TcxCanvas); override;
    procedure PaintTabShape(ACanvas: TcxCanvas;
      ATabVisibleIndex: Integer); override;
    procedure PaintTabsRegion(ACanvas: TcxCanvas); override;
    procedure PaintNativeTabBackground(DC: HDC; ATabVisibleIndex: Integer;
      const ABounds: TRect); virtual;
    procedure PrepareTabBackground(ABitmap: TcxBitmap;
      ATabVisibleIndex: Integer); virtual;
    procedure PrepareTabBitmapBackground(ABitmap: TcxBitmap; const ARect: TRect;
      ATabViewInfo: TcxTabViewInfo); virtual;
    procedure RepaintTab(TabVisibleIndex: Integer;
      TabPropertyChanged: TcxPCTabPropertyChanged); override;
    function GetButtonsDistance(AButton1, AButton2: TcxPCNavigatorButton)
      : Integer; override;
    function GetMinFrameRectSize: Integer; override;
    function GetNativeButtonsDistance(AButton1, AButton2: TcxPCNavigatorButton)
      : Integer; virtual;
    procedure GetTabCornersColor(ATabVisibleIndex: Integer;
      out AColor1, AColor2: TColor); virtual;
    procedure PaintTabCorners(ACanvas: TcxCanvas;
      ATabVisibleIndex: Integer); virtual;
    procedure PaintTabFrame(ACanvas: TcxCanvas;
      ATabVisibleIndex: Integer); virtual;
  ...
  protected
    ...
    function GetTabsNormalDistance: TcxPCDistance; override;
    function GetTabsPosition: TcxPCTabsPosition; override;
    function GetTabTextNormalWidth(ATabVisibleIndex: Integer): Integer;
      override;
    function GetTooNarrowTabContentWOffset(ATabVisibleIndex: Integer)
      : TcxPCWOffset; override;
    function InternalCalculateTabNormalHeight: Integer; override;
    ...
    procedure DrawTabBackground(ACanvas: TcxCanvas; ARect: TRect;
      ATabVisibleIndex: Integer); virtual;
    procedure DrawFocusRect(ACanvas: TcxCanvas;
      ATabVisibleIndex: Integer); override;
    ...
    procedure InternalPaintFrame(ACanvas: TcxCanvas;
      ALeftTopColor, ARightBottomColor: TColor);
    procedure InternalPaintMainTabFrame(ACanvas: TcxCanvas; var R: TRect;
      ALightColor, ADarkColor: TColor);
    procedure InternalPaintTabsRowsDelimiter(ACanvas: TcxCanvas;
      var ARowRect: TRect; AColors: array of TColor);
    ...
    procedure PaintTabsDelimiter(ACanvas: TcxCanvas;
      const ARect: TRect); virtual;
    procedure PaintTabsRowsDelimiter(ACanvas: TcxCanvas; var ARowRect: TRect;
  ...
  protected
    ...
    procedure DrawTabContentBackground(ACanvas: TcxCanvas; const ABounds: TRect;
      ABackgroundColor: TColor; ATabVisibleIndex: Integer); override;
  ...
  strict private
    ...
    function GetTabsLineRect(ATabIndexInterval: TcxPCIndexInterval;
      AFullRect: Boolean): TRect;
  ...
  protected
    ...
    function PtInTab(TabVisibleIndex: Integer; X, Y: Integer): Boolean;
      override;
    function IsTabBorderThick(ATabVisibleIndex: Integer): Boolean; override;
    function IsCloseButtonOnSlantedSide(ATabVisibleIndex: Integer)
      : Boolean; virtual;
    procedure PaintButtonFrame(ACanvas: TcxCanvas; var ARect: TRect;
      AButtonState: TcxPCNavigatorButtonState); override;
    procedure DoPaintPageFrame(ACanvas: TcxCanvas); override;
    ...
    function DirectionalGetFigureRegion(const R: TRect;
    ...
    procedure DrawBackground(ACanvas: TcxCanvas; R: TRect;
      ATabVisibleIndex: Integer; AHorizontalGradient, AInverseGradient
      : Boolean); virtual;
    procedure DrawTabUnderline(ACanvas: TcxCanvas;
      ATabVisibleIndex: Integer); virtual;
    ...
    function InternalGetTabClipRegion(ACanvas: TcxCanvas;
      ATabVisibleIndex: Integer; AForContent: Boolean): TcxRegion; virtual;
    procedure PaintTabFrame(ACanvas: TcxCanvas; ATabVisibleIndex: Integer;
      const R: TRect); virtual;
    procedure PaintTabStateMark(ACanvas: TcxCanvas;
      ATabVisibleIndex: Integer); virtual;
  ...
  protected
    ...
    function InternalGetTabClipRegion(ACanvas: TcxCanvas;
      ATabVisibleIndex: Integer; AForContent: Boolean): TcxRegion; override;
    function IsCloseButtonOnSlantedSide(ATabVisibleIndex: Integer)
      : Boolean; override;
    procedure PaintTabFrame(ACanvas: TcxCanvas; ATabVisibleIndex: Integer;
...
procedure DrawBorder(ACanvas: TcxCanvas; var ARect: TRect;
  ASides: array of TcxBorder; AColors: array of TColor;
  AExcludeBorder: Boolean = False);
...
const
  ButtonsPainterTabContentWOffsetA: array [Boolean] of TcxPCWOffset = ((Left: 4;
    Right: 4), (Left: 3; Right: 4));

  StandardNativePainterButtonHeight = 17;
  StandardNativePainterButtonWidth = 17;
  StandardPainterButtonHeight = 20;
  StandardPainterButtonWidthA: array [Boolean, TcxPCNavigatorButton]
    of Integer = ((20, 20, 12, 20), // TabPosition in [tpLeft, tpRight]
    (20, 20, 13, 20) // TabPosition in [tpTop, tpBottom]
    );
  StandardPainterTabBorderWidth = 2;
  StandardPainterDefaultTabNormalHeightA: array [TcxPCStandardStyle]
    of Integer = (18, 20, 20);
  StandardPainterDefaultTabNormalHTextOffsetA: array [TcxPCStandardStyle]
    of Integer = (2, 4, 4);
  StandardPainterDrawImageOffsetA: array [Boolean, TcxPCStandardStyle]
    of TRect = (((Left: 6; Top: 1; Right: 0; Bottom: 0), (Left: 6; Top: - 1;
    Right: 0; Bottom: 1), (Left: 6; Top: - 1; Right: 0; Bottom: 1)),
    ((Left: 8; Top: 1; Right: 0; Bottom: 3), (Left: 7; Top: - 1; Right: 0;
    Bottom: 1), (Left: 7; Top: - 1; Right: 0; Bottom: 1)));
  StandardPainterDrawTextHOffsetA: array [Boolean, TcxPCStandardStyle]
    of TRect = (((Left: 5; Top: 1; Right: 5; Bottom: - 1), (Left: 6; Top: 0;
    Right: 4; Bottom: 1), (Left: 6; Top: 0; Right: 4; Bottom: 1)),
    ((Left: 5; Top: 1; Right: 5; Bottom: 2), (Left: 6; Top: 0; Right: 4;
    Bottom: 1), (Left: 6; Top: 0; Right: 4; Bottom: 1)));
  StandardPainterTabContentWOffsetA: array [Boolean, TcxPCStandardStyle]
    of TcxPCWOffset = (((Left: 2; Right: 2), (Left: 3; Right: 3), (Left: 2;
    Right: 2)), ((Left: 4; Right: 4), (Left: 3; Right: 3), (Left: 4;
    Right: 2)));
  StandardPainterTabsNormalDistanceA: array [TcxPCStandardStyle]
    of TcxPCDistance = ((dw: 0; dh: 0), (dw: 3; dh: 3), (dw: 10; dh: 3));
  StandardPainterMaxTabBorderWidth = 2;
  StandardPainterWDistanceBetweenImageBorderAndText = 1;
  StandardPainterTooNarrowTabContentWOffsetA
    : array [Boolean, TcxPCStandardStyle] of TcxPCWOffset =
    (((Left: 2; Right: 2), (Left: 3; Right: 3), (Left: 2; Right: 2)),
    ((Left: 4; Right: 4), (Left: 3; Right: 3), (Left: 3; Right: 2)));

  TabsPainterContentWOffsetA: array [Boolean, Boolean] of TcxPCWOffset =
    (((Left: 3; Right: 3), (Left: 3; Right: 3)), ((Left: 5; Right: 5), (Left: 4;
    Right: 5)));
  TabsPainterDrawImageWithoutTextRotatedMainTabWOffset
    : array [Boolean] of TcxPCWOffset = ((Left: 1; Right: 2), (Left: 2;
    Right: 1));
  ...
  ExtraFlatPainterDrawImageOffsetA: array [Boolean] of TRect = ((Left: 2;
    Top: 0; Right: 0; Bottom: 0), (Left: 3; Top: 0; Right: 0; Bottom: 0));
  ExtraFlatPainterDrawTextHOffsetA: array [Boolean] of TRect = ((Left: 5;
    Top: 2; Right: 3; Bottom: 0), (Left: 6; Top: 2; Right: 3; Bottom: 0));
  ExtraFlatPainterMainTabBorderWidth = 1;
  ExtraFlatPainterMainTabRectCorrection: TRect = (Left: - 1; Top: - 1; Right: 1;
    Bottom: 1);
  ...
  cxPCArrowConversionA: array [nbTopLeft .. nbBottomRight, Boolean]
    of TcxPCArrow = ((aLeft, aTop), (aRight, aBottom));
  cxPCArrowSizeA: array [nbTopLeft .. nbGoDialog] of Integer = (5, 5, 4);

  UltraFlatPainterButtonWidthA: array [TcxPCNavigatorButton] of Integer = (15,
    15, 11, 14);
  UltraFlatPainterButtonHeight = 15;

  FlatPainterButtonBorderWidth = 1;

  SlantedPainterButtonWidthA: array [TcxPCNavigatorButton] of Integer = (17,
    17, 13, 16);
...
procedure AddPoints(var APoints: TPoints; const ANewPoints: array of TPoint;
  var ALinePositions: TLinePositions;
  const ANewLinePositions: array of TLinePosition);
var
...
begin
  ...
  begin
    ...
    case ASides[I] of
      ...
      bRight:
        begin
          ACanvas.Polyline([Point(ARect.Right - 1, ARect.Top),
            Point(ARect.Right - 1, ARect.Bottom)]);
          Dec(ARect.Right);
        end;
      bBottom:
        begin
          ACanvas.Polyline([Point(ARect.Left, ARect.Bottom - 1),
...
function GetFigureRegion(APoints: array of TPoint;
  const ALinePositions: array of TLinePosition; AForContent: Boolean)
  : TcxRegion;
...
begin
  ...
  Result := TcxRegion.Create(CreatePolygonRgn(APoints, Length(APoints),
    WINDING));
end;
...
const
  TabRectCorrectionA: array [TcxTabPosition] of TRect = ((Left: - 2; Top: - 2;
    Right: 2; Bottom: 1), (Left: - 2; Top: - 1; Right: 2; Bottom: 2),
    (Left: - 2; Top: - 2; Right: 1; Bottom: 2), (Left: - 1; Top: - 2; Right: 2;
    Bottom: 2));
begin
...
procedure TcxPCTabsPainter.GetButtonNativePartAndState
  (AState: TcxPCNavigatorButtonState; AType: TcxPCNavigatorButton;
...
const
  ...
  AArrowButtonStateIdMapXP: array [TcxPCArrow, TcxPCNavigatorButtonState]
    of Integer = ((UPS_NORMAL, UPS_PRESSED, UPS_HOT, UPS_DISABLED),
  ...
  AArrowButtonStateIdMap: array [TcxPCArrow, TcxPCNavigatorButtonState]
    of Integer = ((ABS_UPNORMAL, ABS_UPPRESSED, ABS_UPHOT, ABS_UPDISABLED),
...
function TcxPCTabsPainter.DoGetButtonWidth
...
begin
  ...
  begin
    ...
    begin
      ...
      else if GetThemeScaledPartSize(totComboBox, ScaleFactor,
        CP_DROPDOWNBUTTON, ASize, CBXS_NORMAL) then
        Result := ASize.cx;
    end;
  end
  else
...
function TcxPCTabsPainter.GetCloseButtonOffset(ATabVisibleIndex
  : Integer): TRect;
begin
...
function TcxPCTabsPainter.GetDrawImageWithoutTextWOffset(TabVisibleIndex
  : Integer): TcxPCWOffset;
begin
  if ViewInfo.ActuallyRotate and TabViewInfo[TabVisibleIndex].IsMainTab then
    Result := TabsPainterDrawImageWithoutTextRotatedMainTabWOffset
      [TabViewInfo[TabVisibleIndex].GetRelativeTextRotationAngle = raMinus90]
  else
    Result := inherited GetDrawImageWithoutTextWOffset(TabVisibleIndex);
  if IsNativePainting and
    (TabViewInfo[TabVisibleIndex].GetRelativeTextRotationAngle = raPlus90) then
...
class function TcxPCTabsPainter.HasLookAndFeel(ALookAndFeel
  : TcxLookAndFeel): Boolean;
begin
  Result := ALookAndFeel.GetAvailablePainter([totTab]).LookAndFeelStyle
    in [lfsStandard, lfsNative];
end;

class function TcxPCTabsPainter.IsDefault(ALookAndFeel: TcxLookAndFeel)
  : Boolean;
begin
...
function TcxPCTabsPainter.GetTabClipRgn(ACanvas: TcxCanvas;
...
begin
  ...
  if ATabViewInfo.IsMainTab then
    ATabRect := GetExtendedRect(ATabViewInfo.VisibleRect, Rect(0, 0, 0, -1),
      ATabViewInfo.PaintingPosition);

  Result := TcxRegion.Create(ATabRect);
end;

function TcxPCTabsPainter.GetTabContentWOffset(ATabVisibleIndex: Integer)
  : TcxPCWOffset;
var
  ATabViewInfo: TcxTabViewInfo;
...
begin
  Result := cxRectInflate(ATabBounds,
    -ScaleFactor.Apply(StandardPainterTabBorderWidth));
end;
...
begin
  ...
  begin
    ...
    else if ALineIndexBoundsA[ATabViewInfo.VisibleRow].Left = ATabViewInfo.VisibleIndex
    then
      ATabPositionWithinRow := tprLeftMost
    else if (ALineIndexBoundsA[ATabViewInfo.VisibleRow]
      .Right = ATabViewInfo.VisibleIndex) and (ViewInfo.RowCount > 1) then
      ATabPositionWithinRow := tprRightMost
    else
      ATabPositionWithinRow := tprMiddle;
  end
  else if ViewInfo.IsTabsContainer then
    ATabPositionWithinRow := tprMiddle
  else if ALineIndexBoundsA[ATabViewInfo.VisibleRow].Left = ATabViewInfo.VisibleIndex
  then
    ATabPositionWithinRow := tprLeftMost
  else if (ATabViewInfo.VisibleIndex = ViewInfo.TabsViewInfo.ViewInfoCount - 1)
    and not ATabViewInfo.IsMainTab then
    ATabPositionWithinRow := tprRightMost
  else
    ATabPositionWithinRow := tprMiddle;
...
begin
  Result := Rect(TabsContainerOffset, TabsContainerOffset,
    TabsContainerOffset, 0);
end;
...
var
  ...
  begin
    ...
    NormalTabsRectCorrection := RotateRect(Rect(0, 2 + ATabsContainerOffset.Top,
      0, 0), ViewInfo.TabPosition);
    ATabsPosition.ExtendedTabsRect :=
      cxRectContent(ATabsPosition.ExtendedTabsRect,
      RotateRect(Rect(0, ATabsContainerOffset.Top, 0, 0),
    ...
    begin
      ...
      begin
        ...
        ATabsPosition.ExtendedTabsRect.Right := ViewInfo.Width -
          ATabsContainerOffset.Left;
      ...
      begin
        ...
        NormalTabsRectCorrection.Left :=
          ATabsPosition.ExtendedTabsRect.Left + 2;
        NormalTabsRectCorrection.Right := ViewInfo.Width -
          ATabsPosition.ExtendedTabsRect.Right + 2;
      end;
      ATabsPosition.NormalRowWidth := ViewInfo.Width -
        NormalTabsRectCorrection.Left - NormalTabsRectCorrection.Right;
    end
    else
    begin
      if ViewInfo.MultiLine or (ViewInfo.NavigatorButtonCount = 0) then
      begin
        ...
        ATabsPosition.ExtendedTabsRect.Bottom := ViewInfo.Height -
          ATabsContainerOffset.Left;
      ...
      begin
        ...
        NormalTabsRectCorrection.Bottom := ViewInfo.Height -
          ATabsPosition.ExtendedTabsRect.Bottom + 2;
      end;
      ATabsPosition.NormalRowWidth := ViewInfo.Height -
        NormalTabsRectCorrection.Top - NormalTabsRectCorrection.Bottom;
    end;
  end;
...
begin
  ...
  Result.NormalTabsRect := cxRectContent(Result.NormalTabsRect,
    NormalTabsRectCorrection);
...
function TcxPCTabsPainter.GetTooNarrowTabContentWOffset(ATabVisibleIndex
  : Integer): TcxPCWOffset;
begin
  Result := GetTabContentWOffset(ATabVisibleIndex);
end;

procedure TcxPCTabsPainter.DrawFocusRect(ACanvas: TcxCanvas;
...
begin
  ...
  begin
    ...
    InflateRect(R, -StandardPainterTabBorderWidth,
      -StandardPainterTabBorderWidth);
    R := GetExtendedRect(R, Rect(0, 0, 0, -StandardPainterTabBorderWidth),
      ATabPaintingPosition);
...
procedure TcxPCTabsPainter.InternalPaintTab(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
var
  ABitmap: TcxBitmap;
  ATabRect: TRect;
  ...
  begin
    ...
    try
      ...
      try
        ...
        if ATabViewInfo.IsMainTab then
          ATabRect := GetExtendedRect(ATabRect, Rect(0, 0, 0, -1),
            ATabViewInfo.PaintingPosition);
        cxBitBlt(ACanvas.Handle, ABitmap.Canvas.Handle, ATabRect,
          ATabOrigin, SRCCOPY);
      finally
...
function TcxPCTabsPainter.PtInTab(TabVisibleIndex: Integer;
  X, Y: Integer): Boolean;
begin
  Result := True;
end;
...
procedure TcxPCTabsPainter.PaintHeaderButton(ACanvas: TcxCanvas;
  AButtonInfo: TcxPCHeaderButtonViewInfo);
var
  ATheme: TdxTheme;
  ARect: TRect;
begin
  ...
  begin
    ...
    if ViewInfo.ParentBackground and IsThemeBackgroundPartiallyTransparent
      (ATheme, BP_PUSHBUTTON,
      BtnStateToXPBtnState(NavigatorBtnStateToLookAndFeelBtnState
      [AButtonInfo.State])) then
    ...
    DrawThemeBackground(ATheme, ACanvas.Handle, BP_PUSHBUTTON,
      BtnStateToXPBtnState(NavigatorBtnStateToLookAndFeelBtnState
      [AButtonInfo.State]), ARect);
  end
  else
    inherited;
end;

procedure TcxPCTabsPainter.PaintNativeButton(ACanvas: TcxCanvas;
  const ARect: TRect; AState: TcxPCNavigatorButtonState;
  AType: TcxPCNavigatorButton; ADrawBackground: Boolean);
var
  APartId, AStateId: Integer;
  ...
  AContentRect: TRect;
begin
  GetButtonNativePartAndState(AState, AType, APartId, AStateId,
    AThemeObjectType);
  ATheme := OpenTheme(AThemeObjectType, ScaleFactor);
  if ADrawBackground then
    if ViewInfo.ParentBackground and IsThemeBackgroundPartiallyTransparent
      (ATheme, APartId, AStateId) then
      cxDrawThemeParentBackground(ViewInfo.IControl.GetControl, ACanvas, ARect)
    else
      ACanvas.FillRect(ARect, ViewInfo.Color);
...
begin
  ...
  if ViewInfo.IsTabsContainer then
    ACanvas.FillRect(cxRectInflate(GetPageFrameRect, -GetFrameWidth),
      cxPCTabBodyColor);
end;

procedure TcxPCTabsPainter.PaintTabShape(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
var
  AMainTab: Boolean;
  ATabPaintingPosition: TcxTabPosition;
...
begin
  ...
  begin
    SubtractRect(R, GetExtendedRect(R, Rect(0, 0, 0,
      -StandardPainterTabBorderWidth), ATabPaintingPosition), R);
...
procedure TcxPCTabsPainter.PaintNativeTabBackground(DC: HDC;
...
procedure TcxPCTabsPainter.PrepareTabBackground(ABitmap: TcxBitmap;
  ...
  const
    PlusMinusAngleMap: array [Boolean] of TcxRotationAngle = (raPlus90,
      raMinus90);
  var
...
begin
  ...
  PaintNativeTabBackground(ABitmap.Canvas.Handle, ATabVisibleIndex,
    ABitmap.ClientRect);
  if IsWinSevenOrLater then
  begin
    ...
    begin
      ...
      AFlipVertically := ATabViewInfo.PaintingPositionIndex
        in [1, 2, 6, 7, 5, 12];
    end
    else
    begin
...
procedure TcxPCTabsPainter.PrepareTabBitmapBackground(ABitmap: TcxBitmap;
  ...
  if IsNativePainting and ViewInfo.ParentBackground then
    if CanDrawParentBackground then
      cxDrawTransparentControlBackground(ViewInfo.IControl.GetControl,
        ABitmap.cxCanvas, ARect, cxNullPoint, False)
    else
      cxBitBlt(ABitmap.Canvas.Handle, ViewInfo.Canvas.Handle,
...
begin
  if (TabPropertyChanged = tpcIsMainTab) and not TabViewInfo[TabVisibleIndex].IsMainTab
  then
...
function TcxPCTabsPainter.GetButtonsDistance(AButton1,
...
function TcxPCTabsPainter.GetNativeButtonsDistance(AButton1,
  AButton2: TcxPCNavigatorButton): Integer;
begin
...
begin
  ...
  if (ATabViewInfo.VisibleRow = 0) and (ViewInfo.TopOrLeftPartRowCount > 0) or
    (ATabViewInfo.VisibleRow = ViewInfo.RowCount - 1) and
    (ViewInfo.TopOrLeftPartRowCount <> ViewInfo.RowCount) then
  begin
  ...
  begin
    ...
    begin
      ...
      if ALineIndexBoundsA[ATabViewInfo.VisibleRow].Left = ATabVisibleIndex then
        AColor1 := ViewInfo.Color;
      if ALineIndexBoundsA[ATabViewInfo.VisibleRow].Right = ATabVisibleIndex
      then
...
procedure TcxPCTabsPainter.PaintTabCorners(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
var
...
begin
  ...
  with ATabViewInfo.FullRect do
    case ATabViewInfo.PaintingPosition of
      tpTop:
        begin
          InternalPolyLine([Point(Left, Top + 1), Point(Left, Top),
            Point(Left + 1, Top)], AColor1, ACanvas);
          InternalPolyLine([Point(Right - 2, Top), Point(Right - 1, Top),
            Point(Right - 1, Top + 1)], AColor2, ACanvas);
        end;
      tpBottom:
        begin
          InternalPolyLine([Point(Left, Bottom - 2), Point(Left, Bottom - 1),
            Point(Left + 1, Bottom - 1)], AColor1, ACanvas);
          InternalPolyLine([Point(Right - 2, Bottom - 1),
            Point(Right - 1, Bottom - 1), Point(Right - 1, Bottom - 2)],
            AColor2, ACanvas);
        end;
      tpLeft:
        begin
          InternalPolyLine([Point(Left, Top + 1), Point(Left, Top),
            Point(Left + 1, Top)], AColor1, ACanvas);
          InternalPolyLine([Point(Left, Bottom - 2), Point(Left, Bottom - 1),
            Point(Left + 1, Bottom - 1)], AColor2, ACanvas);
        end;
      tpRight:
        begin
          InternalPolyLine([Point(Right - 2, Top), Point(Right - 1, Top),
            Point(Right - 1, Top + 1)], AColor1, ACanvas);
          InternalPolyLine([Point(Right - 2, Bottom - 1),
            Point(Right - 1, Bottom - 1), Point(Right - 1, Bottom - 2)],
            AColor2, ACanvas);
        end;
...
procedure TcxPCTabsPainter.PaintTabFrame(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
var
...
begin
  ...
  with ATabViewInfo.FullRect do
    case ATabViewInfo.PaintingPosition of
      tpTop:
        begin
          InternalPolyLine([Point(Left, Bottom - 1), Point(Left, Top + 2),
            Point(Left + 2, Top), Point(Right - 3, Top)],
            cxPCLightestEdgeColor, ACanvas);
          InternalPolyLine([Point(Left + 1, Bottom - 1),
            Point(Left + 1, Top + 2), Point(Left + 2, Top + 1),
            Point(Right - 3, Top + 1)], cxPCLightEdgeColor, ACanvas);
          InternalPolyLine([Point(Right - 1, Bottom - 1),
            Point(Right - 1, Top + 2), Point(Right - 2, Top + 1)],
            cxPCDarkestEdgeColor, ACanvas);
          InternalPolyLine([Point(Right - 2, Bottom - 1),
            Point(Right - 2, Top + 2)], cxPCDarkEdgeColor, ACanvas);

          if ATabViewInfo.IsMainTab then
          begin
            if Left = 0 then
            begin
              InternalPolyLine([Point(Left, Bottom), Point(Left, Bottom)],
                cxPCLightestEdgeColor, ACanvas);
              InternalPolyLine([Point(Left + 1, Bottom), Point(Left + 1, Bottom)
                ], cxPCLightEdgeColor, ACanvas);
            end
            else
              InternalPolyLine([Point(Left, Bottom), Point(Left + 1, Bottom)],
                cxPCLightEdgeColor, ACanvas);
            if Right = ViewInfo.Width then
            begin
              InternalPolyLine([Point(Left + 2, Bottom),
                Point(Right - 3, Bottom)], ATabUnderlineColor, ACanvas);
              InternalPolyLine([Point(Right - 2, Bottom),
                Point(Right - 2, Bottom)], cxPCDarkEdgeColor, ACanvas);
              InternalPolyLine([Point(Right - 1, Bottom),
                Point(Right - 1, Bottom)], cxPCDarkestEdgeColor, ACanvas);
            end
            else
              InternalPolyLine([Point(Left + 2, Bottom),
                Point(Right - 1, Bottom)], ATabUnderlineColor, ACanvas);
          end;
        end;
      tpBottom:
        begin
          InternalPolyLine([Point(Left, Top), Point(Left, Bottom - 3),
            Point(Left + 1, Bottom - 2)], cxPCLightestEdgeColor, ACanvas);
          InternalPolyLine([Point(Left + 1, Top), Point(Left + 1, Bottom - 3)],
            cxPCLightEdgeColor, ACanvas);
          InternalPolyLine([Point(Left + 2, Bottom - 1),
            Point(Right - 3, Bottom - 1), Point(Right - 1, Bottom - 3),
            Point(Right - 1, Top)], cxPCDarkestEdgeColor, ACanvas);
          InternalPolyLine([Point(Left + 2, Bottom - 2),
            Point(Right - 3, Bottom - 2), Point(Right - 2, Bottom - 3),
            Point(Right - 2, Top)], cxPCDarkEdgeColor, ACanvas);

          if ATabViewInfo.IsMainTab then
          begin
            if Left = 0 then
            begin
              InternalPolyLine([Point(Left, Top - 1), Point(Left, Top - 1)],
                cxPCLightestEdgeColor, ACanvas);
              InternalPolyLine([Point(Left + 1, Top - 1),
                Point(Left + 1, Top - 1)], cxPCLightEdgeColor, ACanvas);
              InternalPolyLine([Point(Left + 2, Top - 1),
                Point(Right - 3, Top - 1)], ATabUnderlineColor, ACanvas);
            end
            else
              InternalPolyLine([Point(Left, Top - 1), Point(Right - 3, Top - 1)
                ], ATabUnderlineColor, ACanvas);
            if Right = ViewInfo.Width then
            begin
              InternalPolyLine([Point(Right - 2, Top - 1),
                Point(Right - 2, Top - 1)], cxPCDarkEdgeColor, ACanvas);
              InternalPolyLine([Point(Right - 1, Top - 1),
                Point(Right - 1, Top - 1)], cxPCDarkestEdgeColor, ACanvas);
            end
            else
              InternalPolyLine([Point(Right - 2, Top - 1),
                Point(Right - 1, Top - 1)], cxPCDarkEdgeColor, ACanvas);
          end;
        end;
      tpLeft:
        begin
          InternalPolyLine([Point(Left, Bottom - 3), Point(Left, Top + 2),
            Point(Left + 2, Top), Point(Right - 1, Top)],
            cxPCLightestEdgeColor, ACanvas);
          InternalPolyLine([Point(Left + 1, Bottom - 3),
            Point(Left + 1, Top + 2), Point(Left + 2, Top + 1),
            Point(Right - 1, Top + 1)], cxPCLightEdgeColor, ACanvas);
          InternalPolyLine([Point(Left + 2, Bottom - 2),
            Point(Left + 3, Bottom - 1), Point(Right - 1, Bottom - 1)],
            cxPCDarkestEdgeColor, ACanvas);
          InternalPolyLine([Point(Left + 1, Bottom - 2),
            Point(Left + 2, Bottom - 1), Point(Left + 3, Bottom - 2),
            Point(Right - 1, Bottom - 2)], cxPCDarkEdgeColor, ACanvas);

          if ATabViewInfo.IsMainTab then
          begin
            if Top = 0 then
            begin
              InternalPolyLine([Point(Right, Top), Point(Right, Top)],
                cxPCLightestEdgeColor, ACanvas);
              InternalPolyLine([Point(Right, Top + 1), Point(Right, Top + 1)],
                cxPCLightEdgeColor, ACanvas);
            end
            else
              InternalPolyLine([Point(Right, Top), Point(Right, Top + 1)],
                cxPCLightEdgeColor, ACanvas);
            if Bottom = ViewInfo.Height then
            begin
              InternalPolyLine([Point(Right, Top + 2), Point(Right, Bottom - 3)
                ], ATabUnderlineColor, ACanvas);
              InternalPolyLine([Point(Right, Bottom - 2),
                Point(Right, Bottom - 2)], cxPCDarkEdgeColor, ACanvas);
              InternalPolyLine([Point(Right, Bottom - 1),
                Point(Right, Bottom - 1)], cxPCDarkestEdgeColor, ACanvas);
            end
            else
              InternalPolyLine([Point(Right, Top + 2), Point(Right, Bottom - 1)
                ], ATabUnderlineColor, ACanvas);
          end;
        end;
      tpRight:
        begin
          InternalPolyLine([Point(Left, Top), Point(Right - 3, Top),
            Point(Right - 2, Top + 1)], cxPCLightestEdgeColor, ACanvas);
          InternalPolyLine([Point(Left, Top + 1), Point(Right - 3, Top + 1)],
            cxPCLightEdgeColor, ACanvas);
          InternalPolyLine([Point(Left, Bottom - 1), Point(Right - 3,
            Bottom - 1), Point(Right - 1, Bottom - 3), Point(Right - 1, Top + 2)
            ], cxPCDarkestEdgeColor, ACanvas);
          InternalPolyLine([Point(Left, Bottom - 2), Point(Right - 3,
            Bottom - 2), Point(Right - 2, Bottom - 3), Point(Right - 2, Top + 2)
            ], cxPCDarkEdgeColor, ACanvas);

          if ATabViewInfo.IsMainTab then
          begin
            if Top = 0 then
            begin
              InternalPolyLine([Point(Left - 1, Top), Point(Left - 1, Top)],
                cxPCLightestEdgeColor, ACanvas);
              InternalPolyLine([Point(Left - 1, Top + 1),
                Point(Left - 1, Top + 1)], cxPCLightEdgeColor, ACanvas);
              InternalPolyLine([Point(Left - 1, Top + 2),
                Point(Left - 1, Bottom - 3)], ATabUnderlineColor, ACanvas);
            end
            else
              InternalPolyLine([Point(Left - 1, Top),
                Point(Left - 1, Bottom - 3)], ATabUnderlineColor, ACanvas);
            if Bottom = ViewInfo.Height then
            begin
              InternalPolyLine([Point(Left - 1, Bottom - 2),
                Point(Left - 1, Bottom - 2)], cxPCDarkEdgeColor, ACanvas);
              InternalPolyLine([Point(Left - 1, Bottom - 1),
                Point(Left - 1, Bottom - 1)], cxPCDarkestEdgeColor, ACanvas);
            end
            else
              InternalPolyLine([Point(Left - 1, Bottom - 2),
                Point(Left - 1, Bottom - 1)], cxPCDarkEdgeColor, ACanvas);
          end;
        end;
    end;
...
begin
  ...
  begin
    ...
    else if not(ATabViewInfo.PaintingPositionIndex in [1, 2, 4, 5, 6, 10, 11])
    then
      Inc(ARect.Right, 2);
  end;
...
class function TcxPCFlatButtonsPainter.HasLookAndFeel
  (ALookAndFeel: TcxLookAndFeel): Boolean;
begin
  Result := False;
end;

procedure TcxPCFlatButtonsPainter.PaintTab(ACanvas: TcxCanvas;
  ...
  procedure InternalPaintTabsDelimiter;
    ...
    begin
      ...
      with ViewInfo do
        ...
        begin
          if (RowCount = 1) or (ATabViewInfo.VisibleRow = RowCount - 1) then
            Exit;
          ...
          for I := FirstIndex to LastIndex do
            with TabsViewInfo[I] do
              if (VisibleRow = NextRow) and
                (PointGetter(FullRect.TopLeft, IsY) = c) then
              begin
                Result := True;
                Break;
              end;
        end
        else if (TabVisibleIndex < LastIndex) and
          (TabsViewInfo[TabVisibleIndex + 1].VisibleRow = ATabViewInfo.
          VisibleRow) then
          Result := True;
    end;
  ...
  begin
    ...
    with R do
      ...
      begin
        ...
        InternalPolyLine([Point(Left + 1, DelimiterTopBorder),
          Point(Right - 2, DelimiterTopBorder)], cxPCDarkEdgeColor, ACanvas);
        InternalPolyLine([Point(Left + 1, DelimiterTopBorder + 1),
          Point(Right - 2, DelimiterTopBorder + 1)],
          cxPCLightestEdgeColor, ACanvas);
        DelimiterRect := Rect(Left + 1, DelimiterTopBorder, Right - 1,
          DelimiterTopBorder + 2);
      end
      else
      begin
        ...
        InternalPolyLine([Point(DelimiterLeftBorder, Top + 1),
          Point(DelimiterLeftBorder, Bottom - 2)], cxPCDarkEdgeColor, ACanvas);
        InternalPolyLine([Point(DelimiterLeftBorder + 1, Top + 1),
          Point(DelimiterLeftBorder + 1, Bottom - 2)],
          cxPCLightestEdgeColor, ACanvas);
        DelimiterRect := Rect(DelimiterLeftBorder, Top + 1,
          DelimiterLeftBorder + 2, Bottom - 1);
      end;
    with ACanvas do
    begin
      SaveClipRegion;
...
procedure TcxPCFlatButtonsPainter.PaintTabShape(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
var
  ATabViewInfo: TcxTabViewInfo;
  AFullRect: TRect;
...
begin
  ...
  if (not ATabViewInfo.IsTracking) and
    (ATabViewInfo.IsPressed or ATabViewInfo.IsSelected or ATabViewInfo.IsMainTab)
  then
  begin
    InternalDrawEdge(ACanvas, AFullRect, True);
    ABorderWidth := StandardPainterTabBorderWidth;
  end
  else if ATabViewInfo.IsHotTrack or ATabViewInfo.IsTracking then
  begin
    ACanvas.DrawComplexFrame(AFullRect, cxPCLightestEdgeColor,
      cxPCDarkEdgeColor);
    ABorderWidth := 1;
  end;

  ACanvas.FillRect(cxRectInflate(AFullRect, -ABorderWidth),
...
begin
  ...
  begin
    if ViewInfo.NavigatorPosition in [npLeftTop, npLeftBottom] then
      ...
      FButtonsRect.Left := ViewInfo.Width - AButtonsWidth -
        GetButtonsRegionWOffset;

    if ViewInfo.TabPosition = tpTop then
      FButtonsRect.Top := GetButtonsRegionHOffset
    else
      FButtonsRect.Top := ViewInfo.Height - AButtonHeight -
  ...
  begin
    if ViewInfo.TabPosition = tpLeft then
      ...
      FButtonsRect.Left := ViewInfo.Width - AButtonHeight -
        GetButtonsRegionHOffset;

    if ViewInfo.NavigatorPosition in [npLeftTop, npRightTop] then
      FButtonsRect.Top := GetButtonsRegionWOffset
    else
      FButtonsRect.Top := ViewInfo.Height - AButtonsWidth -
        GetButtonsRegionWOffset;
  ...
  begin
    ...
    begin
      ...
      if I < ViewInfo.NavigatorButtonCount - 1 then
        AButtonLeftTopCorner.Y := AButtonBounds.Bottom +
          ViewInfo.GetHeaderButtonsDistance(AButtonInfo,
    ...
    begin
      ...
      if I < ViewInfo.NavigatorButtonCount - 1 then
        AButtonLeftTopCorner.X := AButtonBounds.Right +
          ViewInfo.GetHeaderButtonsDistance(AButtonInfo,
          ViewInfo.NavigatorButtonInfos[I + 1]);
    end;
...
begin
  ...
  if ViewInfo.ActuallyRotate and (ATabImageHeight > 0) and
    Odd(AHeight - ATabImageHeight) then
    Inc(AHeight);
end;
...
begin
  if AButtonInfo.IsNavigatorButton then
    PaintButton(ACanvas, AButtonInfo.Bounds, AButtonInfo.State,
      GetRightToLeftDependentButtonType(TcxPCNavigatorButtonViewInfo
      (AButtonInfo).ButtonType))
  else
  begin
...
function TcxPCStandardPainter.CalculateTabNormalWidth
  (ATabViewInfo: TcxTabViewInfo): Integer;
begin
...
procedure TcxPCStandardPainter.DoDrawTabButton(ACanvas: TcxCanvas;
  const ARect: TRect; AState: TcxPCNavigatorButtonState);
begin
  DrawButtonFrameAndBackground(ACanvas, ARect, AState);
end;

procedure TcxPCStandardPainter.DoDrawTabCloseButton(ACanvas: TcxCanvas;
  const ARect: TRect; AState: TcxPCNavigatorButtonState);
var
...
procedure TcxPCStandardPainter.DrawButtonFrameAndBackground(ACanvas: TcxCanvas;
  const ARect: TRect; AState: TcxPCNavigatorButtonState);
var
  R: TRect;
begin
...
begin
  ...
  Result := Max(Result, IfThen(ViewInfo.HasTabButtons,
    GetCloseButtonAreaHeight(-1)));
end;

function TcxPCStandardPainter.DoGetDefaultTabNormalHeight: Integer;
begin
  Result := ScaleFactor.Apply(StandardPainterDefaultTabNormalHeightA
    [GetStandardStyle]);
end;
...
function TcxPCStandardPainter.GetTabContentWOffset(ATabVisibleIndex: Integer)
  : TcxPCWOffset;
begin
  Result := ScaleFactor.Apply(StandardPainterTabContentWOffsetA
    [IsTabBorderThick(ATabVisibleIndex), GetStandardStyle]);
end;

function TcxPCStandardPainter.GetDrawImageOffset(TabVisibleIndex
  : Integer): TRect;
begin
...
function TcxPCStandardPainter.GetDrawImageWithoutTextWOffset(TabVisibleIndex
  : Integer): TcxPCWOffset;
begin
  Result := cxPCEmptyWOffset;
end;

function TcxPCStandardPainter.GetDrawTextHOffset(TabVisibleIndex
  : Integer): TRect;
begin
...
const
  TabAndNavigatorPosToGoDialogPos: array [TcxTabPosition,
    TcxPCNavigatorPosition] of TcxPCNavigatorPosition =
...
begin
  ...
  AGoDialogPosition := TabAndNavigatorPosToGoDialogPos[ViewInfo.TabPosition,
    ViewInfo.NavigatorPosition];
...
function TcxPCStandardPainter.GetImageTextDistance(ATabVisibleIndex
  : Integer): Integer;
begin
  Result := 6;
end;

function TcxPCStandardPainter.GetMinTabNormalWidth(ATabVisibleIndex
  : Integer): Integer;
begin
...
function TcxPCStandardPainter.GetTabNormalContentOffset(ATabVisibleIndex
  : Integer): Integer;
begin
  Result := ScaleFactor.Apply(12);
end;

function TcxPCStandardPainter.GetTabNormalImageAreaWidth(ATabVisibleIndex
  : Integer): Integer;
begin
  Result := GetTabImageAreaWidth + GetImageTextDistance(ATabVisibleIndex);
end;

function TcxPCStandardPainter.GetTabNormalWidth(ATabVisibleIndex
  : Integer): Integer;
begin
  Result := GetTabNormalContentOffset(ATabVisibleIndex);
  if IsAssignedImages and ((ATabVisibleIndex = -1) or
    IsTabHasImage(ATabVisibleIndex) or ViewInfo.ActuallyRotate) then
...
function TcxPCStandardPainter.GetTabTextNormalWidth(ATabVisibleIndex
  : Integer): Integer;
begin
...
begin
  ...
  if ViewInfo.IsTabsContainer then
    ATabsContainerOffset := GetTabsContainerOffsets;
  Inc(ATabsContainerOffset.Top, GetHeaderButtonHeightCorrection);
  Result.ExtendedTabsRect := cxRectContent(ViewInfo.ControlBounds,
    GetTabsRectOffset);

  if ViewInfo.NavigatorButtonCount > 0 then
  begin
    Result.ExtendedTabsRect := cxRectContent(Result.ExtendedTabsRect,
      RotateRect(Rect(0, ATabsContainerOffset.Top, 0, 0),
      ViewInfo.TabPosition));
    ATabsContainerOffset := RotateRect(ATabsContainerOffset,
      ViewInfo.TabPosition);
    if ViewInfo.TabPosition in [tpTop, tpBottom] then
    begin
      if ViewInfo.NavigatorPosition in [npLeftTop, npLeftBottom] then
    ...
    Result.ExtendedTabsRect := cxRectContent(Result.ExtendedTabsRect,
      RotateRect(ATabsContainerOffset, ViewInfo.TabPosition));
  if ViewInfo.TabPosition in [tpTop, tpBottom] then
    Result.NormalRowWidth :=
      (Result.ExtendedTabsRect.Right - Result.ExtendedTabsRect.Left)
  else
    Result.NormalRowWidth :=
      (Result.ExtendedTabsRect.Bottom - Result.ExtendedTabsRect.Top);
...
function TcxPCStandardPainter.GetTooNarrowTabContentWOffset(ATabVisibleIndex
  : Integer): TcxPCWOffset;
begin
  Result := StandardPainterTooNarrowTabContentWOffsetA
    [IsTabBorderThick(ATabVisibleIndex), GetStandardStyle];
  if IsNativePainting and
    (TabViewInfo[ATabVisibleIndex].GetRelativeTextRotationAngle = raPlus90) then
    ExchangeLongWords(Result.Left, Result.Right);
end;

function TcxPCStandardPainter.InternalCalculateTabNormalWidth(ATabVisibleIndex
  : Integer): Integer;
begin
...
begin
  Result := IfThen(IsAssignedImages, GetTabImageAreaHeight +
    ScaleFactor.Apply(6));
...
const
  ThickFrameLineColorA: array [Boolean, 1 .. 4] of TColor =
    ((cxPCLightEdgeColor, cxPCLightestEdgeColor, cxPCDarkestEdgeColor,
    cxPCDarkEdgeColor), (cxPCDarkEdgeColor, cxPCDarkestEdgeColor,
    cxPCLightestEdgeColor, cxPCLightEdgeColor));
...
begin
  ...
  begin
    ...
    ACanvas.DrawComplexFrame(cxRectInflate(ARect, -1, -1),
      ThickFrameLineColorA[ASunken, 2], ThickFrameLineColorA[ASunken, 4]);
  end;
end;

procedure TcxPCStandardPainter.InternalDrawFocusRect(ACanvas: TcxCanvas;
  TabVisibleIndex: Integer; R: TRect);
begin
...
procedure TcxPCStandardPainter.InternalPaintDragImage(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
begin
...
procedure TcxPCStandardPainter.InternalPaintTab(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
var
  ABitmap: TcxBitmap;
  ATabRect: TRect;
...
procedure TcxPCStandardPainter.PaintButton(ACanvas: TcxCanvas;
  const ARect: TRect; AState: TcxPCNavigatorButtonState;
  AType: TcxPCNavigatorButton);
var
...
begin
  ...
  AContentLeftTopCorner := cxPointOffset(GetButtonContentPosition(ARect, AType,
    AState), ARect.TopLeft);
  DrawButtonContent(ACanvas, AType, AContentParameters, AContentLeftTopCorner);
end;

procedure TcxPCStandardPainter.PaintButtonBackground(ACanvas: TcxCanvas;
  const ARect: TRect; AState: TcxPCNavigatorButtonState);
begin
...
procedure TcxPCStandardPainter.PaintButtonFrame(ACanvas: TcxCanvas;
  var ARect: TRect; AButtonState: TcxPCNavigatorButtonState);
begin
  InternalDrawEdge(ACanvas, ARect, AButtonState = nbsPressed);
  ARect := cxRectInflate(ARect, -StandardPainterTabBorderWidth);
end;

procedure TcxPCStandardPainter.PaintHeaderButton(ACanvas: TcxCanvas;
  AButtonInfo: TcxPCHeaderButtonViewInfo);
begin
...
begin
  ABorders := GetPageBorders;
  ACanvas.DrawComplexFrame(R, cxPCLightestEdgeColor, cxPCDarkestEdgeColor,
    ABorders);
  InflateRect(R, -1, -1);
...
const
  IsMainTabBoundWithClientA: array [TcxPCStandardStyle] of Boolean = (True,
    False, False);
begin
...
const
  IsMultiSelectionAcceptedA: array [TcxPCStandardStyle] of Boolean = (False,
    True, True);
begin
...
function TcxPCStandardPainter.IsTabBorderThick(ATabVisibleIndex
  : Integer): Boolean;
begin
...
begin
  Result := (GetHeaderButtonHeightCorrection <> 0) or cxIsTouchModeEnabled or
    ScaleFactor.Assigned;
end;

class function TcxPCStandardPainter.HasTabPressedState: Boolean;
const
  HasTabPressedStateMap: array [TcxPCStandardStyle] of Boolean = (False,
    True, True);
begin
...
function TcxPCStandardPainter.DoGetButtonWidth
  (Button: TcxPCNavigatorButton): Integer;
begin
  Result := ScaleFactor.Apply(StandardPainterButtonWidthA[ViewInfo.TabPosition
    in [tpLeft, tpRight], Button]);
end;

procedure TcxPCStandardPainter.DrawButtonContent(ACanvas: TcxCanvas;
  AButton: TcxPCNavigatorButton;
  const AParameters: TcxPCNavigatorButtonContentParameters;
  AContentRectLeftTopCorner: TPoint);
type
  ...
  const
    PolygonPointsMultipliersA: array [TcxPCArrow] of TArrowPointA =
      (((X: 0; Y: 1), (X: 1; Y: 0), (X: 2; Y: 1)), ((X: 0; Y: 0), (X: 2;
      Y: 0), (X: 1; Y: 1)), ((X: 0; Y: 1), (X: 1; Y: 0), (X: 1; Y: 2)),
  ...
  begin
    with ALeftTopCorner do
      if AParameters.LiteStyle then
        if ViewInfo.TabPosition in [tpTop, tpBottom] then
        begin
          InternalPolyLine([Point(X + 1, Y), Point(X + ASize - 2, Y + ASize - 3)
            ], ACanvas.Pen.Color, ACanvas);
          InternalPolyLine([Point(X, Y), Point(X + ASize - 3, Y + ASize - 3)],
            ACanvas.Pen.Color, ACanvas);

          InternalPolyLine([Point(X, Y + ASize - 3), Point(X + ASize - 3, Y)],
            ACanvas.Pen.Color, ACanvas);
          InternalPolyLine([Point(X + 1, Y + ASize - 3), Point(X + ASize - 2, Y)
            ], ACanvas.Pen.Color, ACanvas);
        end
        else
        begin
          InternalPolyLine([Point(X, Y), Point(X + ASize - 3, Y + ASize - 3)],
            ACanvas.Pen.Color, ACanvas);
          InternalPolyLine([Point(X, Y + 1), Point(X + ASize - 3, Y + ASize - 2)
            ], ACanvas.Pen.Color, ACanvas);

          InternalPolyLine([Point(X, Y + ASize - 3), Point(X + ASize - 3, Y)],
            ACanvas.Pen.Color, ACanvas);
          InternalPolyLine([Point(X, Y + ASize - 2), Point(X + ASize - 3, Y + 1)
            ], ACanvas.Pen.Color, ACanvas);
        end
      else
      begin
        InternalPolyLine([Point(X + 1, Y), Point(X + ASize - 1, Y + ASize - 2)],
          ACanvas.Pen.Color, ACanvas);
        InternalPolyLine([Point(X, Y), Point(X + ASize - 1, Y + ASize - 1)],
          ACanvas.Pen.Color, ACanvas);
        InternalPolyLine([Point(X, Y + 1), Point(X + ASize - 2, Y + ASize - 1)],
          ACanvas.Pen.Color, ACanvas);

        InternalPolyLine([Point(X, Y + ASize - 2), Point(X + ASize - 2, Y)],
          ACanvas.Pen.Color, ACanvas);
        InternalPolyLine([Point(X, Y + ASize - 1), Point(X + ASize - 1, Y)],
          ACanvas.Pen.Color, ACanvas);
        InternalPolyLine([Point(X + 1, Y + ASize - 1), Point(X + ASize - 1,
          Y + 1)], ACanvas.Pen.Color, ACanvas);
      end;
  end;
...
function TcxPCStandardPainter.Get3DButtonContentPosition
  (AButton: TcxPCNavigatorButton; AState: TcxPCNavigatorButtonState): TPoint;
const
  AArrowButtonArrowRectLeftTopCorners: array [TcxPCArrow] of TPoint = ((X: 5;
    Y: 7), (X: 5; Y: 7), (X: 6; Y: 5), (X: 8; Y: 5));
  ACloseButtonCrossRectLeftTopCorner: TPoint = (X: 5; Y: 5);
  AGoDialogArrowRectLeftTopCorners: array [Boolean] of TPoint = ((X: 2; Y: 8),
    // TabPosition in [tpTop, tpBottom]
    (X: 6; Y: 4));
begin
  case AButton of
    nbGoDialog:
      Result := AGoDialogArrowRectLeftTopCorners
...
function TcxPCStandardPainter.GetButtonArrow(AButton: TcxPCNavigatorButton)
  : TcxPCArrow;
begin
  if AButton = nbGoDialog then
    Result := aBottom
  else
    Result := cxPCArrowConversionA[AButton, ViewInfo.TabPosition
      in [tpLeft, tpRight]];
end;

function TcxPCStandardPainter.GetButtonCenteredContentPosition
  (const ARect: TRect; AButton: TcxPCNavigatorButton;
  AState: TcxPCNavigatorButtonState): TPoint;
...
function TcxPCStandardPainter.GetButtonColor(AButtonState
  : TcxPCNavigatorButtonState): TColor;
begin
  Result := cxPCTabBodyColor;
end;

function TcxPCStandardPainter.GetButtonContentColor(AButtonState
  : TcxPCNavigatorButtonState): TColor;
begin
...
procedure TcxPCStandardPainter.PaintTab(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
var
...
function TcxPCStandardPainter.GetRightToLeftDependentButtonType
  (AButton: TcxPCNavigatorButton): TcxPCNavigatorButton;
begin
  Result := AButton;
  if ViewInfo.UseRightToLeftAlignment and
    (ViewInfo.TabPosition in [tpTop, tpBottom]) then
...
class function TcxPCButtonsPainter.HasLookAndFeel(ALookAndFeel
  : TcxLookAndFeel): Boolean;
begin
  Result := False;
end;

function TcxPCButtonsPainter.IsTabBorderThick(ATabVisibleIndex
  : Integer): Boolean;
begin
...
procedure TcxPCButtonsPainter.PaintTabShape(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
const
  ABorderWidth = 2;
var
...
begin
  ...
  begin
    ACanvas.DrawComplexFrame(AOuterRect, cxPCDarkestEdgeColor,
      cxPCLightestEdgeColor);
    ACanvas.DrawComplexFrame(AInnerRect, cxPCDarkEdgeColor, cxPCLightEdgeColor);
  end
  else
  begin
    ACanvas.DrawComplexFrame(AOuterRect, cxPCLightestEdgeColor,
      cxPCDarkestEdgeColor);
...
function TcxPCButtonedPainter.GetDrawImageWithoutTextWOffset(TabVisibleIndex
  : Integer): TcxPCWOffset;
begin
  Result := inherited GetDrawImageWithoutTextWOffset(TabVisibleIndex);
...
function TcxPCButtonedPainter.GetLookAndFeelPainter
...
function TcxPCButtonedPainter.GetTabContentWOffset(ATabVisibleIndex: Integer)
  : TcxPCWOffset;
begin
  Result := ButtonsPainterTabContentWOffsetA[IsAssignedImages];
  CorrectContentWOffset(ATabVisibleIndex, Result);
  if HasTabPressedState and IsAssignedImages and
    (InternalGetTextRotationAngle(ViewInfo) = raPlus90) then
  begin
    Inc(Result.Left);
    Dec(Result.Right);
  end;
...
function TcxPCButtonedPainter.GetTooNarrowTabContentWOffset(ATabVisibleIndex
  : Integer): TcxPCWOffset;
begin
  Result := GetTabContentWOffset(ATabVisibleIndex);
end;

procedure TcxPCButtonedPainter.DrawFocusRect(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
begin
  InternalDrawFocusRect(ACanvas, ATabVisibleIndex,
    cxRectInflate(TabViewInfo[ATabVisibleIndex].FullRect,
    -ScaleFactor.Apply(1)));
end;
...
function TcxPCButtonedPainter.IsTabBorderThick(ATabVisibleIndex
  : Integer): Boolean;
begin
  with TabViewInfo[ATabVisibleIndex] do
...
procedure TcxPCButtonedPainter.CorrectContentWOffset(ATabVisibleIndex: Integer;
  var AOffset: TcxPCWOffset);
begin
...
function TcxPCExtraFlatPainter.CalculateTabNormalWidth
  (ATabViewInfo: TcxTabViewInfo): Integer;
begin
...
function TcxPCExtraFlatPainter.GetTabCorrection(ATabVisibleIndex
  : Integer): TRect;
begin
...
function TcxPCExtraFlatPainter.GetButtonColor(AButtonState
  : TcxPCNavigatorButtonState): TColor;
begin
...
function TcxPCExtraFlatPainter.GetButtonContentColor(AButtonState
  : TcxPCNavigatorButtonState): TColor;
begin
  if not ViewInfo.IsEnabled or (AButtonState = nbsDisabled) then
    Result := cxPCDarkEdgeColor
  else if AButtonState = nbsPressed then
    Result := cxPCLightestEdgeColor
  else
    Result := clBtnText;
end;
...
function TcxPCExtraFlatPainter.GetButtonContentPosition(const ARect: TRect;
  ...
  const
    AArrowButtonArrowRectLeftTopCorners: array [TcxPCArrow] of TPoint = ((X: 2;
      Y: 5), (X: 2; Y: 3), (X: 5; Y: 2), (X: 3; Y: 2));
    ACloseButtonCrossRectLeftTopCorners: array [Boolean] of TPoint = ((X: 3;
      Y: 2), (X: 2; Y: 3));
  ...
  begin
    case AButton of
      ...
      nbClose:
        Result := ACloseButtonCrossRectLeftTopCorners
          [ViewInfo.TabPosition in [tpTop, tpBottom]];
    else
      Result := AArrowButtonArrowRectLeftTopCorners[GetButtonArrow(AButton)];
    end;
  end;
...
function TcxPCExtraFlatPainter.DoGetButtonWidth
  (Button: TcxPCNavigatorButton): Integer;
begin
  Result := ScaleFactor.Apply(ExtraFlatPainterButtonSize);
end;

function TcxPCExtraFlatPainter.GetCloseButtonOffset(ATabVisibleIndex
  : Integer): TRect;
begin
  Result := inherited GetCloseButtonOffset(ATabVisibleIndex);
  Inc(Result.Left);
...
function TcxPCExtraFlatPainter.GetDrawImageOffset(TabVisibleIndex
  : Integer): TRect;
begin
  Result := ExtraFlatPainterDrawImageOffsetA
    [TabViewInfo[TabVisibleIndex].IsMainTab];
end;

function TcxPCExtraFlatPainter.GetDrawTextHOffset(TabVisibleIndex
  : Integer): TRect;
var
  AIsMainTab: Boolean;
begin
...
function TcxPCExtraFlatPainter.GetMinTabNormalWidth(ATabVisibleIndex
  : Integer): Integer;
begin
  Result := GetTabNormalWidth(ATabVisibleIndex);
end;
...
begin
  ...
  if (ATabHeight - 4 >= ADefaultTabNormalHeight) and (ATabHeight - 4 > Result)
  then
    Result := ATabHeight - 4;
  Result := Max(Result, IfThen(ViewInfo.HasTabButtons,
    GetCloseButtonAreaHeight(-1)));
...
class function TcxPCExtraFlatPainter.HasLookAndFeel(ALookAndFeel
  : TcxLookAndFeel): Boolean;
begin
  Result := False;
end;

function TcxPCExtraFlatPainter.GetTabBodyColor(TabVisibleIndex
  : Integer): TColor;
var
  ATabViewInfo: TcxTabViewInfo;
begin
...
function TcxPCExtraFlatPainter.GetTabContentWOffset(ATabVisibleIndex: Integer)
  : TcxPCWOffset;
begin
  Result := ScaleFactor.Apply(ExtraFlatPainterTabContentWOffset
    [TabViewInfo[ATabVisibleIndex].IsMainTab]);
end;

function TcxPCExtraFlatPainter.GetTabNormalContentOffset(ATabVisibleIndex
  : Integer): Integer;
begin
  Result := 0;
end;

function TcxPCExtraFlatPainter.GetTabNormalImageAreaWidth(ATabVisibleIndex
  : Integer): Integer;
begin
...
begin
  ...
  Result.dh := GetTabsRowsDelimiterWidth +
    ExtraFlatPainterTabsRowFreeSpaceWidth;
  if ViewInfo.ActuallyRotate then
...
const
  ...
  NormalTabsRectCorrection: TRect = (Left: TabsRegionWOffset;
    Top: TabsRegionHOffset; Right: TabsRegionWOffset; Bottom: 0);
  ExtendedTabsRectCorrection: TRect = (Left: - 1; Top: - 1; Right: - 1;
    Bottom: 0);
  ...
  begin
    ...
    begin
      ...
      if ViewInfo.TabPosition in [tpTop, tpBottom] then
      begin
        NormalRowWidth := ViewInfo.Width - 2 * TabsRegionWOffset -
          AButtonsWidth;
        if ViewInfo.NavigatorPosition in [npLeftTop, npLeftBottom] then
      ...
      begin
        NormalRowWidth := ViewInfo.Height - 2 * TabsRegionWOffset -
          AButtonsWidth;
        if ViewInfo.NavigatorPosition in [npLeftTop, npRightTop] then
...
begin
  ...
  with Result do
  begin
    ExtendedTabsRect := GetExtendedRect(NormalTabsRect,
      ExtendedTabsRectCorrection, ViewInfo.TabPosition);
...
function TcxPCExtraFlatPainter.GetTabTextNormalWidth(ATabVisibleIndex
  : Integer): Integer;
begin
  Result := inherited GetTabTextNormalWidth(ATabVisibleIndex) - 3;
end;

function TcxPCExtraFlatPainter.GetTooNarrowTabContentWOffset(ATabVisibleIndex
  : Integer): TcxPCWOffset;
begin
  Result := GetTabContentWOffset(ATabVisibleIndex);
end;
...
procedure TcxPCExtraFlatPainter.PaintButtonFrame(ACanvas: TcxCanvas;
  var ARect: TRect; AButtonState: TcxPCNavigatorButtonState);
begin
  if AButtonState in [nbsHotTrack, nbsPressed] then
  begin
...
procedure TcxPCExtraFlatPainter.PaintTabShape(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
var
  ATabViewInfo: TcxTabViewInfo;
  R: TRect;
...
procedure TcxPCExtraFlatPainter.PaintTabsRegion(ACanvas: TcxCanvas);
  ...
  procedure PaintDelimiter(TabVisibleIndex: Integer);
    ...
    begin
      ...
      if ATabViewInfo.IsMainTab then
        Exit;
      ViewInfo.InitializeVisibleTabRange(AFirstIndex, ALastIndex);
      if TabVisibleIndex = ALastIndex then
        Exit;
      ANextTabViewInfo := TabViewInfo[TabVisibleIndex + 1];
      if ANextTabViewInfo.IsMainTab then
        Exit;
  ...
  begin
    ...
    if ViewInfo.UseRightToLeftAlignment and
      (ViewInfo.TabPosition in [tpTop, tpBottom]) then
      ADelimiterRect := TdxRightToLeftLayoutConverter.ConvertRect
        (ADelimiterRect, ATabFullRect);
...
function TcxPCExtraFlatPainter.GetButtonsDistance(AButton1,
  AButton2: TcxPCNavigatorButton): Integer;
begin
  if IsOneOfButtons(AButton1, AButton2, nbClose) or
    not IsOneOfButtons(AButton1, AButton2, nbGoDialog) then
    Result := 3
  else
    Result := 0;
...
const
  AFocusRectCorrectionA: array [TcxTabPosition] of TRect = ((Left: 0; Top: 0;
    Right: - 1; Bottom: 1), (Left: 1; Top: - 1; Right: - 1; Bottom: - 1),
    (Left: 0; Top: 0; Right: 1; Bottom: - 1), (Left: - 1; Top: 1; Right: - 1;
    Bottom: - 1));
begin
  Result := cxRectTransform(TabViewInfo[ViewInfo.FocusedTabVisibleIndex]
    .FullRect, AFocusRectCorrectionA[ViewInfo.TabPosition]);
end;

function TcxPCExtraFlatPainter.GetTabsDelimiterOffsets
  : TcxPCTabsDelimiterOffsets;
begin
  Result.Top := 2;
  Result.Bottom := 2;
end;

procedure TcxPCExtraFlatPainter.DrawTabBackground(ACanvas: TcxCanvas;
  ARect: TRect; ATabVisibleIndex: Integer);
begin
  if (ATabVisibleIndex <> -1) and
    (ATabVisibleIndex <> ViewInfo.MainTabVisibleIndex) then
  begin
...
procedure TcxPCExtraFlatPainter.DrawFocusRect(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
begin
  if TabViewInfo[ATabVisibleIndex].IsFocused then
...
begin
  ...
  SubtractRect(Result, GetExtendedRect(Result,
    Rect(0, -ExtraFlatPainterMainTabRowUnderlineWidth, 0, 0),
    ViewInfo.TabPosition), Result);
end;
...
begin
  ATabViewInfo := TabViewInfo[ATabVisibleIndex];
  if not AForNormalState and (ATabVisibleIndex = ViewInfo.MainTabVisibleIndex)
  then
    Result := GetExtendedRect(ATabViewInfo.FullRect, Rect(1, 1, 1, 0),
      ATabViewInfo.PaintingPosition)
  else
  begin
    Result := GetExtendedRect(ATabViewInfo.NormalRect,
      Rect(0, -ExtraFlatPainterTabsRowFreeSpaceWidth -
      GetHeaderButtonHeightCorrection, 0, -GetTabsRowsDelimiterWidth),
      ViewInfo.TabPosition);
  end;
end;
...
begin
  ...
  if not ViewInfo.IsTabsVisible then
    ...
    case ViewInfo.TabPosition of
      tpTop:
        DrawBorder(ACanvas, R, [bRight, bBottom, bLeft],
          [ARightBottomColor, ARightBottomColor, ALeftTopColor]);
      tpBottom:
        DrawBorder(ACanvas, R, [bRight, bTop, bLeft],
          [ARightBottomColor, ALeftTopColor, ALeftTopColor]);
      tpLeft:
        DrawBorder(ACanvas, R, [bBottom, bRight, bTop],
          [ARightBottomColor, ARightBottomColor, ALeftTopColor]);
      tpRight:
        DrawBorder(ACanvas, R, [bBottom, bLeft, bTop],
          [ARightBottomColor, ALeftTopColor, ALeftTopColor]);
    end;
end;

procedure TcxPCExtraFlatPainter.InternalPaintMainTabFrame(ACanvas: TcxCanvas;
  var R: TRect; ALightColor, ADarkColor: TColor);
var
  ...
  case AMainTabViewInfo.PaintingPosition of
    tpTop:
      if ViewInfo.UseRightToLeftAlignment then
        DrawBorder(ACanvas, R, [bLeft, bTop, bRight],
          [ADarkColor, ALightColor, ALightColor])
      else
        DrawBorder(ACanvas, R, [bLeft, bTop, bRight],
          [ALightColor, ALightColor, ADarkColor]);
    tpBottom:
      begin
        if ViewInfo.UseRightToLeftAlignment then
        begin
          DrawBorder(ACanvas, R, [bLeft, bBottom, bRight],
            [ADarkColor, ADarkColor, ALightColor]);
        ...
        begin
          DrawBorder(ACanvas, R, [bLeft, bBottom, bRight],
            [ALightColor, ADarkColor, ADarkColor]);
          ACanvas.Pixels[R.Left - 1, R.Top] := ADarkColor;
        end;
      end;
    tpLeft:
      DrawBorder(ACanvas, R, [bTop, bLeft, bBottom], [ALightColor, ALightColor,
        ADarkColor]);
    tpRight:
      begin
        DrawBorder(ACanvas, R, [bTop, bRight, bBottom],
          [ALightColor, ADarkColor, ADarkColor]);
...
const
  BordersMap: array [TcxTabPosition] of TcxBorder = (bBottom, bTop,
    bRight, bLeft);
var
  AWidth: Integer;
  I: Integer;
begin
  ...
  for I := 0 to AWidth - 1 do
    DrawBorder(ACanvas, ARowRect, [BordersMap[ViewInfo.TabPosition]],
      [AColors[(I * Length(AColors)) div AWidth]]);
end;
...
begin
  ...
  else if ViewInfo.TabPosition in [tpTop, tpLeft] then
...
procedure TcxPCExtraFlatPainter.PaintMainTabFrame(ACanvas: TcxCanvas;
  var R: TRect);
begin
...
procedure TcxPCExtraFlatPainter.PaintTabsDelimiter(ACanvas: TcxCanvas;
  const ARect: TRect);
begin
...
procedure TcxPCExtraFlatPainter.PaintTabsRowsDelimiter(ACanvas: TcxCanvas;
  var ARowRect: TRect; ARowIndex: Integer);
begin
  if ViewInfo.TabPosition in [tpTop, tpLeft] then
    InternalPaintTabsRowsDelimiter(ACanvas, ARowRect,
      [cxPCTabBodyColor, cxPCTabBodyColor, clWhite])
  else
    InternalPaintTabsRowsDelimiter(ACanvas, ARowRect,
...
class function TcxPCUltraFlatPainter.HasLookAndFeel(ALookAndFeel
  : TcxLookAndFeel): Boolean;
begin
  Result := ALookAndFeel.GetAvailablePainter([totTab])
    .LookAndFeelStyle = lfsUltraFlat;
end;
...
function TcxPCUltraFlatPainter.GetButtonColor(AButtonState
  : TcxPCNavigatorButtonState): TColor;
begin
  if AButtonState = nbsHotTrack then
    Result := clBtnFace
...
function TcxPCUltraFlatPainter.GetButtonsDistance(AButton1,
  AButton2: TcxPCNavigatorButton): Integer;
begin
  Result := ScaleFactor.Apply(1 + 2 * Ord(IsOneOfButtons(AButton1, AButton2,
    nbClose)));
end;
...
function TcxPCUltraFlatPainter.DoGetButtonWidth
  (Button: TcxPCNavigatorButton): Integer;
begin
...
begin
  Result := GetExtendedRect(TabViewInfo[ViewInfo.FocusedTabVisibleIndex]
    .FullRect, ScaleFactor.Apply(Rect(1, 1, 1, 0)), ViewInfo.TabPosition);
end;
...
procedure TcxPCUltraFlatPainter.PaintButtonFrame(ACanvas: TcxCanvas;
  var ARect: TRect; AButtonState: TcxPCNavigatorButtonState);
...
procedure TcxPCUltraFlatPainter.PaintMainTabFrame(ACanvas: TcxCanvas;
  var R: TRect);
begin
  InternalPaintMainTabFrame(ACanvas, R, clBlack, clBlack);
end;

procedure TcxPCUltraFlatPainter.PaintTabsRowsDelimiter(ACanvas: TcxCanvas;
  var ARowRect: TRect; ARowIndex: Integer);
begin
  if IsMainTabRow(ARowIndex) then
    ...
    InternalPaintTabsRowsDelimiter(ACanvas, ARowRect,
      [cxPCTabBodyColor, clBlack, cxPCTabBodyColor])
end;
...
class function TcxPCFlatPainter.HasLookAndFeel(ALookAndFeel
  : TcxLookAndFeel): Boolean;
begin
  Result := ALookAndFeel.GetAvailablePainter([totTab])
    .LookAndFeelStyle = lfsFlat;
end;
...
begin
  Result := inherited DoGetButtonHeight - ScaleFactor.Apply
    (TabsPainterButtonBorderWidth - FlatPainterButtonBorderWidth) * 2;
end;

function TcxPCFlatPainter.DoGetButtonWidth
  (Button: TcxPCNavigatorButton): Integer;
begin
  Result := inherited DoGetButtonWidth(Button) -
    ScaleFactor.Apply(TabsPainterButtonBorderWidth -
    FlatPainterButtonBorderWidth) * 2;
end;
...
function TcxPCFlatPainter.GetTabClipRgn(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer): TcxRegion;
begin
...
procedure TcxPCFlatPainter.PaintButtonFrame(ACanvas: TcxCanvas;
  var ARect: TRect; AButtonState: TcxPCNavigatorButtonState);
begin
...
begin
  ACanvas.DrawComplexFrame(R, cxPCLightestEdgeColor, cxPCDarkEdgeColor,
    GetPageBorders);
end;

procedure TcxPCFlatPainter.PaintTabFrame(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
      ...
      tpTop:
        begin
          InternalPolyLine([Point(Left, Bottom - 1), Point(Left, Top + 2),
            Point(Left + 2, Top), Point(Right - 3, Top),
            Point(Right - 2, Top + 1)], cxPCLightestEdgeColor, ACanvas);
          InternalPolyLine([Point(Right - 1, Top + 2),
            Point(Right - 1, Bottom - 1)], cxPCDarkEdgeColor, ACanvas);
          InternalPolyLine([Point(Left + 1, Bottom - 1),
            Point(Left + 1, Top + 2), Point(Left + 2, Top + 1),
            Point(Right - 3, Top + 1), Point(Right - 2, Top + 2),
            Point(Right - 2, Bottom - 1)], AContrastColor, ACanvas);
        end;
      tpBottom:
        begin
          InternalPolyLine([Point(Left, Top), Point(Left, Bottom - 3),
          ...
          InternalPolyLine([Point(Left + 2, Bottom - 1),
            Point(Right - 3, Bottom - 1), Point(Right - 1, Bottom - 3),
            Point(Right - 1, Top)], cxPCDarkEdgeColor, ACanvas);
          InternalPolyLine([Point(Left + 1, Top), Point(Left + 1, Bottom - 3)],
            AContrastColor, ACanvas);
          InternalPolyLine([Point(Left + 2, Bottom - 2),
            Point(Right - 3, Bottom - 2), Point(Right - 2, Bottom - 3),
            Point(Right - 2, Top)], clBtnFace, ACanvas);
        end;
      tpLeft:
        begin
          InternalPolyLine([Point(Right - 1, Bottom - 1),
            Point(Left + 2, Bottom - 1)], cxPCDarkEdgeColor, ACanvas);
          InternalPolyLine([Point(Left + 1, Bottom - 2),
            Point(Left, Bottom - 3), Point(Left, Top + 2), Point(Left + 2, Top),
            Point(Right - 1, Top)], cxPCLightestEdgeColor, ACanvas);
          InternalPolyLine([Point(Right - 1, Bottom - 2),
            Point(Left + 2, Bottom - 2), Point(Left + 1, Bottom - 3),
            Point(Left + 1, Top + 2), Point(Left + 2, Top + 1),
            Point(Right - 1, Top + 1)], AContrastColor, ACanvas);
        end;
      tpRight:
        begin
          InternalPolyLine([Point(Left, Top), Point(Right - 3, Top),
            Point(Right - 2, Top + 1)], cxPCLightestEdgeColor, ACanvas);
          InternalPolyLine([Point(Right - 1, Top + 2),
            Point(Right - 1, Bottom - 3), Point(Right - 3, Bottom - 1),
            Point(Left, Bottom - 1)], cxPCDarkEdgeColor, ACanvas);
          InternalPolyLine([Point(Left, Top + 1), Point(Right - 3, Top + 1)],
            AContrastColor, ACanvas);
          InternalPolyLine([Point(Right - 2, Top + 2),
            Point(Right - 2, Bottom - 3), Point(Right - 3, Bottom - 2),
            Point(Left, Bottom - 2)], clBtnFace, ACanvas);
        end;
    end;
  PaintTabCorners(ACanvas, ATabVisibleIndex);
end;
...
class function TcxPCOffice11Painter.HasLookAndFeel(ALookAndFeel
  : TcxLookAndFeel): Boolean;
begin
  with ALookAndFeel do
    Result := (ALookAndFeel.SkinPainter = nil) and
      (GetAvailablePainter([totTab]).LookAndFeelStyle = lfsOffice11);
end;
...
procedure TcxPCOffice11Painter.DrawTabBackground(ACanvas: TcxCanvas;
  ARect: TRect; ATabVisibleIndex: Integer);
begin
  DrawGradientBackground(ACanvas, ARect, ATabVisibleIndex, ViewInfo.TabPosition
    in [tpLeft, tpRight], False);
end;
...
begin
  if UseActivePageColor or not IsGradientClientArea then
    ...
    FillGradientRect(ACanvas.Handle, GetPageClientRect,
      dxOffice11ToolbarsColor1, dxOffice11ToolbarsColor2, ViewInfo.TabPosition
      in [tpLeft, tpRight]);
end;

function TcxPCOffice11Painter.GetButtonContentColor(AButtonState
  : TcxPCNavigatorButtonState): TColor;
begin
...
begin
  if (ViewInfo.MainTabVisibleIndex <> -1) and
    ...
    Result := GetTabColor(ViewInfo.MainTabVisibleIndex)
  else if not(pcoGradient in ViewInfo.Options) then
...
begin
  ...
  Result := GetPageFrameRect;
  SubtractRect(Result, Result, GetExtendedRect(Result,
    Rect(0, ExtraFlatPainterMainTabRowUnderlineWidth, 0, 0),
    ViewInfo.TabPosition));
end;
...
function TcxPCOffice11Painter.GetTabsDelimiterOffsets
  : TcxPCTabsDelimiterOffsets;
begin
  if ViewInfo.TabPosition in [tpTop, tpLeft] then
  begin
...
function TcxPCOffice11Painter.IsTabTransparent(ATabVisibleIndex
  : Integer): Boolean;
begin
...
procedure TcxPCOffice11Painter.PaintButtonBackground(ACanvas: TcxCanvas;
  const ARect: TRect; AState: TcxPCNavigatorButtonState);
var
  AColor1, AColor2: TColor;
  ATabsRowRect: TRect;
...
procedure TcxPCOffice11Painter.PaintButtonFrame(ACanvas: TcxCanvas;
  var ARect: TRect; AButtonState: TcxPCNavigatorButtonState);
...
begin
  ACanvas.FrameRect(cxRectInflate(GetPageClientRect, GetFrameWidth),
    GetFrameColor, GetFrameWidth);
end;

procedure TcxPCOffice11Painter.PaintMainTabFrame(ACanvas: TcxCanvas;
  var R: TRect);
begin
  InternalPaintMainTabFrame(ACanvas, R, GetFrameColor, GetFrameColor);
end;

procedure TcxPCOffice11Painter.PaintTabsDelimiter(ACanvas: TcxCanvas;
  const ARect: TRect);
...
procedure TcxPCOffice11Painter.PaintTabsRowsDelimiter(ACanvas: TcxCanvas;
  var ARowRect: TRect; ARowIndex: Integer);
begin
...
begin
  ...
  else if not ViewInfo.ActuallyRotate and
    (ViewInfo.GetTextRotationAngle = raMinus90) then
    OffsetRect(R, -P.X, -R.Top - (R.Bottom - P.Y - ABitmap.Height))
  else
    OffsetRect(R, -P.X, -P.Y);

  DrawGradientBackground(ABitmap.cxCanvas, R, ATabVisibleIndex,
    ViewInfo.ActuallyRotate, not ViewInfo.ActuallyRotate and
    (ViewInfo.GetTextRotationAngle = raMinus90) or ViewInfo.ActuallyRotate and
    (ViewInfo.GetTextRotationAngle = raPlus90));
end;

procedure TcxPCOffice11Painter.DrawTabContentBackground(ACanvas: TcxCanvas;
...
begin
  ...
  try
    ...
    DrawGradientBackground(ACanvas, R, ATabVisibleIndex, ViewInfo.TabPosition
      in [tpLeft, tpRight], False);
  finally
    ACanvas.RestoreClipRegion;
  end;
  ...
  begin
    ...
    if ATabVisibleIndex <> ViewInfo.MainTabVisibleIndex then
      case TabViewInfo[ATabVisibleIndex].PaintingPosition of
        tpTop:
          begin
            InternalPolyLine([Point(ARect.Left, ARect.Bottom - 1),
              Point(ARect.Right - 1, ARect.Bottom - 1)], AColor2, ACanvas);
            Dec(ARect.Bottom);
          end;
        tpBottom:
          begin
            InternalPolyLine([Point(ARect.Left, ARect.Top),
              Point(ARect.Right - 1, ARect.Top)], AColor1, ACanvas);
            Inc(ARect.Top);
          end;
        tpLeft:
          begin
            InternalPolyLine([Point(ARect.Right - 1, ARect.Top),
              Point(ARect.Right - 1, ARect.Bottom - 1)], AColor2, ACanvas);
            Dec(ARect.Right);
          end;
        tpRight:
          begin
            InternalPolyLine([Point(ARect.Left, ARect.Top),
              Point(ARect.Left, ARect.Bottom - 1)], AColor1, ACanvas);
            Inc(ARect.Left);
          end;
      end;
    ACanvas.Brush.Color := GetTabBodyColor(ATabVisibleIndex);
...
begin
  if (ATabVisibleIndex <> -1) and
    (GetTabBodyColor(ATabVisibleIndex) <> clDefault) then
...
function TcxPCOffice11Painter.GetLookAndFeelPainter
  : TcxCustomLookAndFeelPainter;
begin
...
begin
  Result := ViewInfo.Options * [pcoGradient, pcoGradientClientArea] =
    [pcoGradient, pcoGradientClientArea];
end;

function TcxPCOffice11Painter.NeedShowMainTabOppositeRowLine: Boolean;
begin
  Result := not NeedShowFrame and ((ViewInfo.TabPosition in [tpTop, tpLeft]) and
    (ViewInfo.TopOrLeftPartRowCount <> ViewInfo.RowCount) or
    (ViewInfo.TabPosition in [tpBottom, tpRight]) and
    (ViewInfo.TopOrLeftPartRowCount <> 0));
end;
...
begin
  if NeedShowMainTabOppositeRowLine then
  begin
    R := GetExtendedRect(GetPageClientRect, Rect(0, 0, 0, -1),
      ViewInfo.TabPosition);
    GetRectSize(R, ViewInfo.TabPosition in [tpTop, tpBottom], ARWidth,
      ARHeight);
    DirectionalPolyline(ACanvas, R, [Point(R.Left, R.Bottom - 1),
      Point(R.Left + ARWidth - 1, R.Bottom - 1)], ViewInfo.TabPosition,
      GetFrameColor);
  end;
end;
...
class function TcxPCSlantedPainter.HasLookAndFeel(ALookAndFeel
  : TcxLookAndFeel): Boolean;
begin
  Result := False;
end;
...
function TcxPCSlantedPainter.CalculateTabNormalWidth(ATabViewInfo
  : TcxTabViewInfo): Integer;
begin
  Result := Max(inherited CalculateTabNormalWidth(ATabViewInfo),
    GetMinTabNormalWidth(ATabViewInfo.VisibleIndex));
end;
...
function TcxPCSlantedPainter.GetButtonColor(AButtonState
  : TcxPCNavigatorButtonState): TColor;
begin
  if AButtonState = nbsHotTrack then
...
function TcxPCSlantedPainter.GetButtonContentColor(AButtonState
  : TcxPCNavigatorButtonState): TColor;
begin
...
function TcxPCSlantedPainter.GetButtonsDistance(AButton1,
  AButton2: TcxPCNavigatorButton): Integer;
begin
  Result := ScaleFactor.Apply(1 + 2 * Ord(IsOneOfButtons(AButton1, AButton2,
    nbClose)));
...
function TcxPCSlantedPainter.DoGetButtonWidth
  (Button: TcxPCNavigatorButton): Integer;
begin
...
function TcxPCSlantedPainter.GetDrawImageOffset(TabVisibleIndex
  : Integer): TRect;
begin
  if ViewInfo.ActuallyRotate then
    if (ViewInfo.TabSlants.Kind = skSlant) or (ViewInfo.TabSlants.Positions = [])
    then
    begin
...
function TcxPCSlantedPainter.GetDrawTextHOffset(TabVisibleIndex
  : Integer): TRect;
begin
  if ViewInfo.ActuallyRotate then
    Result := Rect(0, GetFrameWidth + 3, 0, GetFrameWidth + 1)
  else
    Result := Rect(0, SlantedPainterTabStateMarkWidth + GetFrameWidth +
      1, 0, 1);
end;
...
begin
  ...
  if ViewInfo.IsTabsContainer then
    Result := cxRectContent(Result, RotateRect(Rect(0, -TabsContainerOffset, 0,
      0), ViewInfo.TabPosition));
end;
...
function TcxPCSlantedPainter.GetImageTextDistance(ATabVisibleIndex
  : Integer): Integer;
begin
  Result := 3;
end;

function TcxPCSlantedPainter.GetMinTabNormalWidth(ATabVisibleIndex
  : Integer): Integer;
begin
  Result := GetTabNormalWidth(ATabVisibleIndex);
end;

function TcxPCSlantedPainter.GetTabBodyColor(TabVisibleIndex: Integer): TColor;
var
  ATabViewInfo: TcxTabViewInfo;
begin
  ATabViewInfo := TabViewInfo[TabVisibleIndex];
...
function TcxPCSlantedPainter.GetTabClipRgn(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer): TcxRegion;
var
  ATabViewInfo: TcxTabViewInfo;
begin
...
function TcxPCSlantedPainter.GetTabContentWOffset(ATabVisibleIndex: Integer)
  : TcxPCWOffset;
const
  AContentOffset = 2;
var
...
begin
  ...
  begin
    ...
    Result.Right := AContentOffset + SlantedPainterTabStateMarkWidth +
      GetFrameWidth;
    if (ViewInfo.TabSlants.Kind = skCutCorner) and
      (ViewInfo.TabSlants.Positions <> []) then
      Inc(Result.Right);
...
function TcxPCSlantedPainter.GetTabNormalContentOffset(ATabVisibleIndex
  : Integer): Integer;
begin
...
function TcxPCSlantedPainter.GetTabNormalImageAreaWidth(ATabVisibleIndex
  : Integer): Integer;
begin
  Result := GetTabImageSize.cx;
end;

function TcxPCSlantedPainter.GetTabNormalWidth(ATabVisibleIndex
  : Integer): Integer;
begin
  Result := Max(inherited GetTabNormalWidth(ATabVisibleIndex),
    GetGeometricalMinTabWidth);
end;
...
function TcxPCSlantedPainter.GetTabTextNormalWidth(ATabVisibleIndex
  : Integer): Integer;
begin
  Result := inherited GetTabTextNormalWidth(ATabVisibleIndex);
  if IsTabHasImage(ATabVisibleIndex) or IsAssignedImages and ViewInfo.ActuallyRotate
  then
    Inc(Result, GetImageTextDistance(ATabVisibleIndex));
end;

function TcxPCSlantedPainter.GetTooNarrowTabContentWOffset(ATabVisibleIndex
  : Integer): TcxPCWOffset;
begin
  Result := GetTabContentWOffset(ATabVisibleIndex);
end;

procedure TcxPCSlantedPainter.DrawFocusRect(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
var
  R: TRect;
  ATabViewInfo: TcxTabViewInfo;
...
function TcxPCSlantedPainter.PtInTab(TabVisibleIndex: Integer;
  X, Y: Integer): Boolean;
var
  ARegion: TcxRegion;
  AFirstIndex, ALastIndex: Integer;
begin
  ...
  begin
    ViewInfo.InitializeVisibleTabRange(AFirstIndex, ALastIndex);
    if (TabVisibleIndex + 1 <= ALastIndex) and TabViewInfo[TabVisibleIndex + 1].IsMainTab
    then
    begin
...
function TcxPCSlantedPainter.IsTabBorderThick(ATabVisibleIndex
  : Integer): Boolean;
begin
  Result := False;
end;

function TcxPCSlantedPainter.IsCloseButtonOnSlantedSide(ATabVisibleIndex
  : Integer): Boolean;
var
  ATabViewInfo: TcxTabViewInfo;
begin
  ...
  begin
    ATabViewInfo := TabViewInfo[ATabVisibleIndex];
    Result := (ATabViewInfo.PaintingPositionIndex in [5, 8]) and
      (spLeft in ViewInfo.TabSlants.Positions) or
      not(ATabViewInfo.PaintingPositionIndex in [5, 8]) and
      (spRight in ViewInfo.TabSlants.Positions);
  end;
end;

procedure TcxPCSlantedPainter.PaintButtonFrame(ACanvas: TcxCanvas;
  var ARect: TRect; AButtonState: TcxPCNavigatorButtonState);
...
begin
  ...
  if ViewInfo.IsTabsContainer then
    AFrameRect := cxRectContent(AFrameRect,
      RotateRect(Rect(0, -TabsContainerOffset, 0, 0), ViewInfo.TabPosition));
  ACanvas.FrameRect(AFrameRect, GetFrameColor);
end;

procedure TcxPCSlantedPainter.PaintTabShape(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
var
  ATabViewInfo: TcxTabViewInfo;
begin
  ...
  try
    ...
    ACanvas.SetClipRegion(InternalGetTabClipRegion(ACanvas, ATabVisibleIndex,
      True), roIntersect);
...
procedure TcxPCSlantedPainter.PaintTabsRegion(ACanvas: TcxCanvas);
  ...
  procedure DrawLineBorder(ATabIndexInterval: TcxPCIndexInterval;
    AIsUpperLine, AIsLowerLine: Boolean);
  var
    ALineRect: TRect;
  ...
  begin
    ...
    ALineRect := GetExtendedRect(GetTabsLineRect(ATabIndexInterval,
      AIsLowerLine), Rect(0, -GetTabsNormalDistance.dh, 0, -1),
      ATabViewInfo.PaintingPosition);
  ...
  procedure PaintLine(ATabIndexInterval: TcxPCIndexInterval;
    AIsUpperLine, AIsLowerLine: Boolean);
  var
    I: Integer;
  begin
...
begin
  ...
  for J := ViewInfo.TopOrLeftPartRowCount - 1 downto 0 do
    PaintLine(ALineIndexBoundsA[J], J = 0,
      J = ViewInfo.TopOrLeftPartRowCount - 1);

  for J := ViewInfo.TopOrLeftPartRowCount to ViewInfo.RowCount - 1 do
    PaintLine(ALineIndexBoundsA[J], J = ViewInfo.RowCount - 1,
      J = ViewInfo.TopOrLeftPartRowCount);
end;

procedure TcxPCSlantedPainter.PrepareDrawTabContentBitmapBackground
  (ABitmap: TcxBitmap; const ABitmapPos: TPoint; ATabVisibleIndex: Integer);
var
  P: TPoint;
  R: TRect;
begin
  ...
  DrawBackground(ABitmap.cxCanvas, R, ATabVisibleIndex, ViewInfo.ActuallyRotate,
    not ViewInfo.ActuallyRotate and (ViewInfo.GetTextRotationAngle = raMinus90)
    or ViewInfo.ActuallyRotate and (ViewInfo.GetTextRotationAngle = raPlus90));
end;

procedure TcxPCSlantedPainter.DrawTabContentBackground(ACanvas: TcxCanvas;
  const ABounds: TRect; ABackgroundColor: TColor; ATabVisibleIndex: Integer);
begin
  ACanvas.SaveClipRegion;
  try
...
function TcxPCSlantedPainter.DirectionalGetFigureRegion(const R: TRect;
  ...
  const
    ALinePositionConversionTable: array [TcxTabPosition, TLinePosition]
      of TLinePosition = ((lpL, lpLT, lpT, lpRT, lpR, lpRB, lpB, lpLB),
      (lpL, lpLB, lpB, lpRB, lpR, lpRB, lpB, lpLB), (lpB, lpLB, lpL, lpLT, lpT,
      lpRB, lpB, lpLB), (lpB, lpRB, lpR, lpRT, lpT, lpRB, lpB, lpLB));
  var
  ...
  begin
    ...
    for I := 0 to High(ALinePositions) do
      ALinePositions[I] := ALinePositionConversionTable[ATabPosition,
        ALinePositions[I]];
  end;
...
begin
  ATabViewInfo := TabViewInfo[ATabVisibleIndex];
  if ATabViewInfo.IsMainTab and not(CanLightMainTab and ATabViewInfo.IsHotTrack)
  then
  begin
    ACanvas.Brush.Color := GetTabBodyColor(ATabVisibleIndex);
    ACanvas.FillRect(R);
  ...
  begin
    ...
    if CanLightMainTab and ATabViewInfo.IsMainTab and
      ATabViewInfo.IsHotTrack and
...
procedure TcxPCSlantedPainter.DrawTabUnderline(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
var
  AFrameColor: TColor;
...
begin
  ...
  begin
    ...
    begin
      GetRectSize(R, ATabViewInfo.PaintingPosition in [tpTop, tpBottom],
        ARWidth, ARHeight);
...
procedure TcxPCSlantedPainter.GetBackgroundGradientColors(ATabVisibleIndex
  : Integer; out AColor1, AColor2: TColor);
var
  ATabColor: TColor;
begin
...
begin
  ATabViewInfo := TabViewInfo[ATabVisibleIndex];
  R := ATabViewInfo.FullRect;
  GetRectSize(R, ATabViewInfo.PaintingPosition in [tpTop, tpBottom], ARWidth,
    ARHeight);

  SetLength(APoints, 0);
  SetLength(ALinePositions, 0);
  if (spLeft in ViewInfo.TabSlantPositions) and
    (not ViewInfo.ActuallyRotate or (ViewInfo.TabSlants.Kind = skCutCorner))
  then
  begin
    if ViewInfo.TabSlants.Kind = skSlant then
      AddPoints(APoints, [Point(R.Left, R.Bottom - 1),
        Point(R.Left + (ARHeight - 1), R.Bottom - ARHeight)],
        ALinePositions, [lpLT])
    else
      AddPoints(APoints, [Point(R.Left, R.Bottom - 1),
        Point(R.Left, R.Bottom - ARHeight + CutCornerSize),
        Point(R.Left + CutCornerSize, R.Bottom - ARHeight)], ALinePositions,
        [lpL, lpLT]);
  end
  else if (ViewInfo.TabSlants.Kind = skSlant) or
    (ViewInfo.TabSlantPositions = []) then
    AddPoints(APoints, [Point(R.Left, R.Bottom - 1),
      Point(R.Left, R.Bottom - ARHeight + 2), Point(R.Left + 2,
      R.Bottom - ARHeight)], ALinePositions, [lpL, lpLT])
  else
    AddPoints(APoints, [Point(R.Left, R.Bottom - 1),
      Point(R.Left, R.Bottom - ARHeight)], ALinePositions, [lpL]);

  if (spRight in ViewInfo.TabSlantPositions) and
    (not ViewInfo.ActuallyRotate or (ViewInfo.TabSlants.Kind = skCutCorner))
  then
  begin
    if ViewInfo.TabSlants.Kind = skSlant then
      AddPoints(APoints, [Point(ARWidth + R.Left - 1 - (ARHeight - 1),
        R.Bottom - ARHeight), Point(ARWidth + R.Left - 1, R.Bottom - 1)],
        ALinePositions, [lpT, lpRT])
    else
      AddPoints(APoints, [Point(ARWidth + R.Left - CutCornerSize - 1,
        R.Bottom - ARHeight), Point(ARWidth + R.Left - 1,
        R.Bottom - ARHeight + CutCornerSize), Point(ARWidth + R.Left - 1,
        R.Bottom - 1)], ALinePositions, [lpT, lpRT, lpR]);
  end
  else if (ViewInfo.TabSlants.Kind = skSlant) or
    (ViewInfo.TabSlantPositions = []) then
    AddPoints(APoints, [Point(ARWidth + R.Left - 3, R.Bottom - ARHeight),
      Point(ARWidth + R.Left - 1, R.Bottom - ARHeight + 2),
      Point(ARWidth + R.Left - 1, R.Bottom - 1)], ALinePositions,
      [lpT, lpRT, lpR])
  else
...
function TcxPCSlantedPainter.InternalGetTabClipRegion(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer; AForContent: Boolean): TcxRegion;
var
...
begin
  ...
  Result := DirectionalGetFigureRegion(ATabViewInfo.FullRect, APoints,
    ALinePositions, ATabViewInfo.PaintingPosition, AForContent);
end;

procedure TcxPCSlantedPainter.PaintTabFrame(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer; const R: TRect);
var
  ALinePositions: TLinePositions;
  APoints: TPoints;
  ATabViewInfo: TcxTabViewInfo;
begin
  ATabViewInfo := TabViewInfo[ATabVisibleIndex];
  GetTabFramePolyline(ATabVisibleIndex, APoints, ALinePositions);
  DirectionalPolyline(ACanvas, R, APoints, ATabViewInfo.PaintingPosition,
    GetFrameColor);
end;

procedure TcxPCSlantedPainter.PaintTabStateMark(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
var
  R: TRect;
  ATabViewInfo: TcxTabViewInfo;
begin
  ...
  begin
    SubtractRect(R, ATabViewInfo.FullRect,
      GetExtendedRect(ATabViewInfo.FullRect,
      Rect(0, GetFrameWidth + SlantedPainterTabStateMarkWidth, 0, 0),
      ATabViewInfo.PaintingPosition));
...
function TcxPCSlantedPainter.GetTabsLineRect(ATabIndexInterval
  : TcxPCIndexInterval; AFullRect: Boolean): TRect;

  procedure ExchangeTabs(var ALeftTabViewInfo, ARightTabViewInfo
    : TcxTabViewInfo);
  var
...
function TcxPCSlantedPainter.GetTabUnderlineRect(ATabViewInfo
  : TcxTabViewInfo): TRect;
begin
  SubtractRect(Result, GetExtendedRect(ATabViewInfo.VisibleRect,
    Rect(0, 0, 0, -1), ATabViewInfo.PaintingPosition),
...
class function TcxPCOneNotePainter.HasLookAndFeel(ALookAndFeel
  : TcxLookAndFeel): Boolean;
begin
  Result := False;
end;
...
procedure TcxPCOneNotePainter.DrawTabUnderline(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
var
  AColor: TColor;
  ARWidth, ARHeight: Integer;
...
begin
  ATabViewInfo := TabViewInfo[ATabVisibleIndex];
  if ATabViewInfo.IsMainTab then
    AColor := GetTabBodyColor(ATabVisibleIndex)
    // ViewInfo.PageColors[ATabVisibleIndex]
  else
    AColor := GetFrameColor;
  R := ATabViewInfo.FullRect;
  GetRectSize(R, ATabViewInfo.PaintingPosition in [tpTop, tpBottom], ARWidth,
    ARHeight);
  DirectionalPolyline(ACanvas, R, [Point(R.Left, R.Bottom),
    Point(R.Left, R.Bottom)], ATabViewInfo.PaintingPosition,
    dxGetMiddleRGB(GetFrameColor, AColor, 50));
  DirectionalPolyline(ACanvas, R, [Point(R.Left + 1, R.Bottom),
    Point(R.Left + ARWidth - 1, R.Bottom)],
    ATabViewInfo.PaintingPosition, AColor);
end;

procedure TcxPCOneNotePainter.GetBackgroundGradientColors(ATabVisibleIndex
  : Integer; out AColor1, AColor2: TColor);
var
  ATabColor: TColor;
begin
...
function TcxPCOneNotePainter.GetDrawImageOffset(TabVisibleIndex
  : Integer): TRect;
begin
  Result := Rect(0, OneNotePainterTabFrameWidth + 1, 0, 1);
end;

function TcxPCOneNotePainter.GetDrawTextHOffset(TabVisibleIndex
  : Integer): TRect;
begin
...
function TcxPCOneNotePainter.GetTabContentWOffset(ATabVisibleIndex: Integer)
  : TcxPCWOffset;
const
  AContentOffset = 2;
begin
...
function TcxPCOneNotePainter.InternalGetTabClipRegion(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer; AForContent: Boolean): TcxRegion;
var
      ...
      case APaintingPosition of
        tpTop:
          begin
            ...
            DirectionalPolyline(ACanvas, R, [Point(R.Left + 2, R.Bottom - 1),
              Point(R.Left + (R.Bottom - R.Top - 2), R.Top + 3),
              Point(R.Left + (R.Bottom - R.Top + 2), R.Top + 1),
              Point(R.Right - 2, R.Top + 1), Point(R.Right - 2, R.Bottom - 1)],
              tpTop, clWhite);
          end;
        tpBottom:
          begin
            Inc(R.Left);
            DirectionalPolyline(ACanvas, R, [Point(R.Left + 2, R.Bottom - 1),
              Point(R.Left + (R.Bottom - R.Top - 3), R.Top + 4),
              Point(R.Left + (R.Bottom - R.Top + 2), R.Top + 1),
              Point(R.Right - 2, R.Top + 1), Point(R.Right - 2, R.Bottom - 1)],
              tpBottom, clWhite);
          end;
        tpLeft:
          begin
            ...
            DirectionalPolyline(ACanvas, R, [Point(R.Left + 2, R.Bottom - 1),
              Point(R.Left + (ARHeight - 2), R.Bottom - ARHeight + 3),
              Point(R.Left + (ARHeight + 2), R.Bottom - ARHeight + 1),
              Point(ARWidth + R.Left - 2, R.Bottom - ARHeight + 1),
              Point(ARWidth + R.Left - 2, R.Bottom - 1)], tpLeft, clWhite);
          end;
        tpRight:
          begin
            Inc(R.Top);
            GetRectSize(R, False, ARWidth, ARHeight);
            DirectionalPolyline(ACanvas, R, [Point(R.Left + 2, R.Bottom - 1),
              Point(R.Left + (ARHeight - 1), R.Bottom - ARHeight + 3),
              Point(R.Left + (ARHeight + 3), R.Bottom - ARHeight + 1),
              Point(ARWidth + R.Left - 2, R.Bottom - ARHeight + 1),
              Point(ARWidth + R.Left - 2, R.Bottom - 1)], tpRight, clWhite);
          end;
      end
    else
    begin
      ...
      case APaintingPosition of
        tpTop:
          DirectionalPolyline(ACanvas, R, [Point(R.Left, R.Bottom - 2),
            Point(R.Left + 1, R.Bottom - 2), Point(R.Left + (ARHeight - 3),
            R.Bottom - ARHeight + 3), Point(R.Left + (ARHeight + 2),
            R.Bottom - ARHeight), Point(ARWidth + R.Left - 4,
            R.Bottom - ARHeight), Point(ARWidth + R.Left - 1,
            R.Bottom - ARHeight + 3), Point(ARWidth + R.Left - 1, R.Bottom - 1)
            ], tpTop, $9C613B);
        tpBottom:
          DirectionalPolyline(ACanvas, R, [Point(R.Left, R.Bottom - 2),
            Point(R.Left + 1, R.Bottom - 2), Point(R.Left + (ARHeight - 3),
        ...
        tpLeft:
          DirectionalPolyline(ACanvas, R, [Point(R.Left, R.Bottom - 2),
            Point(R.Left + 1, R.Bottom - 2), Point(R.Left + (ARHeight - 3),
            R.Bottom - ARHeight + 3), Point(R.Left + (ARHeight + 2),
            R.Bottom - ARHeight), Point(ARWidth + R.Left - 5,
            R.Bottom - ARHeight), Point(ARWidth + R.Left - 1,
            R.Bottom - ARHeight + 4), Point(ARWidth + R.Left - 1, R.Bottom - 1)
            ], tpLeft, $9C613B);
        tpRight:
          DirectionalPolyline(ACanvas, R, [Point(R.Left - 1, R.Bottom - 1),
            Point(R.Left - 1, R.Bottom - 3), Point(R.Left + 2, R.Bottom - 3),
            Point(R.Left + (ARHeight - 2), R.Bottom - ARHeight + 2),
            Point(R.Left + (ARHeight + 2), R.Bottom - ARHeight),
            Point(ARWidth + R.Left - 4, R.Bottom - ARHeight),
            Point(ARWidth + R.Left - 1, R.Bottom - ARHeight + 3),
...
function TcxPCOneNotePainter.IsCloseButtonOnSlantedSide(ATabVisibleIndex
  : Integer): Boolean;
var
  ATabViewInfo: TcxTabViewInfo;
begin
...
procedure TcxPCOneNotePainter.PaintTabFrame(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer; const R: TRect);

  procedure PrepareColors(out ABorderColor, AInnerBorderColor1,
    AInnerBorderColor2: TColor);
  var
    ATabViewInfo: TcxTabViewInfo;
  begin
    ATabViewInfo := TabViewInfo[ATabVisibleIndex];
    ...
    else if ATabViewInfo.IsMainTab then
    begin
      ABorderColor := OneNoteMainTabBorderColor;
      AInnerBorderColor1 := dxGetMiddleRGB(clWhite,
        GetTabBodyColor(ATabVisibleIndex), 60);
      AInnerBorderColor2 := dxGetMiddleRGB(AInnerBorderColor1,
        GetTabBodyColor(ATabVisibleIndex), 70);
    end
    else
    begin
      ABorderColor := OneNoteTabBorderColor;
      AInnerBorderColor1 := dxGetMiddleRGB(clWhite,
        OneNoteTabInnerBorderColor2, 50);
      AInnerBorderColor1 := dxGetMiddleRGB(AInnerBorderColor1,
        GetTabBodyColor(ATabVisibleIndex), 50);
      AInnerBorderColor2 := dxGetMiddleRGB(OneNoteTabInnerBorderColor2,
        GetTabBodyColor(ATabVisibleIndex), 50);
    end;
  end;
...
begin
  ...
  DirectionalPolyline(ACanvas, R, [Point(R.Left, R.Bottom - 1),
    Point(R.Left, R.Bottom - 1)], ATabPaintingPosition,
    dxGetMiddleRGB(ABorderColor, GetColorAt(Point(R.Left - 1,
    R.Bottom - 1)), 25));
  DirectionalPolyline(ACanvas, R, [Point(R.Left + 1, R.Bottom - 1),
    Point(R.Left + 1, R.Bottom - 1), Point(R.Left + (ARHeight - 3),
    R.Bottom - ARHeight + 3), Point(R.Left + (ARHeight + 2),
    R.Bottom - ARHeight), Point(ARWidth + R.Left - 3, R.Bottom - ARHeight),
    Point(ARWidth + R.Left - 1, R.Bottom - ARHeight + 2),
    Point(ARWidth + R.Left - 1, R.Bottom - 1)], ATabPaintingPosition,
    ABorderColor);
  DirectionalPolyline(ACanvas, R,
    [Point(R.Left + (ARHeight + 2), R.Bottom - ARHeight),
    Point(R.Left + (ARHeight + 2), R.Bottom - ARHeight)], ATabPaintingPosition,
    dxGetMiddleRGB(ABorderColor, GetColorAt(Point(R.Left + (ARHeight + 1),
    R.Bottom - ARHeight)), 60));
  DirectionalPolyline(ACanvas, R, [Point(R.Left + 2, R.Bottom - 1),
    Point(R.Left + (ARHeight - 3), R.Bottom - ARHeight + 4),
    Point(R.Left + (ARHeight + 2), R.Bottom - ARHeight + 1),
    Point(ARWidth + R.Left - 4, R.Bottom - ARHeight + 1)], ATabPaintingPosition,
    AInnerBorderColor1);
  DirectionalPolyline(ACanvas, R,
    [Point(ARWidth + R.Left - 3, R.Bottom - ARHeight + 1),
    Point(ARWidth + R.Left - 2, R.Bottom - ARHeight + 2),
    Point(ARWidth + R.Left - 2, R.Bottom - 1)], ATabPaintingPosition,
    AInnerBorderColor2);
end;

procedure TcxPCOneNotePainter.PaintTabStateMark(ACanvas: TcxCanvas;
  ATabVisibleIndex: Integer);
begin
  // do nothing
end;
