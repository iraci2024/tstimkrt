...
uses
  Variants, Windows, Messages, SysUtils, Classes, Controls, Graphics, DB,
  DBCtrls,
...
type
  ...
  published
    ...
    property ListColumns: TcxLookupDBGridColumns read GetListColumns
      write SetListColumns;
    property ListFieldNames;
    property ListFieldIndex;
    property ListOptions: TcxLookupDBGridOptions read GetListOptions
...
begin
  ...
  begin
    ...
    try
      ...
      AIsSourceDefinedByLookup := TcxLookupComboBoxProperties(Source)
        .IsDefinedByLookup;
...
function TcxLookupComboBoxProperties.GetLookupGridClass
  : TcxCustomLookupDBGridClass;
begin
...
function TcxLookupComboBoxProperties.GetLookupGridColumnProperties
...
function TcxLookupComboBoxProperties.GetLookupGridDataController
  : TcxCustomDataController;
begin
  Result := Grid.DataController;
end;

function TcxLookupComboBoxProperties.
...
function TcxLookupComboBoxProperties.GetLookupGridPopupHeight(ADropDownRowCount
  : Integer): Integer;
begin
  Result := Grid.GetPopupHeight(ADropDownRowCount);
end;

function TcxLookupComboBoxProperties.IsLookupGridMouseOverList
  (const P: TPoint): Boolean;
begin
  Result := Grid.IsMouseOverList(P);
end;

procedure TcxLookupComboBoxProperties.LookupGridInitEvents(AOnClick,
...
procedure TcxLookupComboBoxProperties.LookupGridInitLookAndFeel
...
procedure TcxLookupComboBoxProperties.DBLookupGridCheckColumnByFieldName
  (const AFieldName: string);
begin
  if (AFieldName <> '') and (ListColumns.ColumnByFieldName(AFieldName) = nil)
  then
...
procedure TcxLookupComboBoxProperties.DBLookupGridCreateColumnsByFieldNames
...
function TcxLookupComboBoxProperties.GetDBLookupGridColumnField
  (AIndex: Integer): TField;
begin
  Result := ListColumns[AIndex].Field;
end;

function TcxLookupComboBoxProperties.GetDBLookupGridColumnFieldName
  (AIndex: Integer): string;
begin
  Result := ListColumns[AIndex].FieldName;
end;

function TcxLookupComboBoxProperties.GetDBLookupGridColumnIndexByFieldName
...
function TcxLookupComboBoxProperties.GetDBLookupGridDataController
  : TcxDBDataController;
begin
  if Grid <> nil then
    Result := Grid.DataController
...
procedure TcxLookupComboBoxProperties.SetIncrementalFilteringOptions
...
procedure TcxLookupComboBoxProperties.SetListColumns
  (Value: TcxLookupDBGridColumns);
begin
...
procedure TcxLookupComboBoxProperties.SetListOptions
  (Value: TcxLookupDBGridOptions);
begin
  Grid.Options := Value;
end;
...
class function TcxCustomLookupComboBox.GetPropertiesClass
...
function TcxCustomLookupComboBox.GetActiveProperties
  : TcxLookupComboBoxProperties;
begin
  Result := TcxLookupComboBoxProperties(InternalGetActiveProperties);
end;

procedure TcxCustomLookupComboBox.SetProperties
...
class function TcxFilterLookupComboBoxHelper.GetFilterDataType(AValueTypeClass
  : TcxValueTypeClass): TcxFilterDataType;
begin
  Result := fdtLookup;
end;

class function TcxFilterLookupComboBoxHelper.GetFilterEditClass
  : TcxCustomEditClass;
begin
  Result := TcxLookupComboBox;
end;

class procedure TcxFilterLookupComboBoxHelper.GetFilterValue
...
class function TcxFilterLookupComboBoxHelper.IsValueValid(AValueTypeClass
...
GetRegisteredEditProperties.Register(TcxLookupComboBoxProperties,
...
FilterEditsController.Unregister(TcxLookupComboBoxProperties,
  TcxFilterLookupComboBoxHelper);
