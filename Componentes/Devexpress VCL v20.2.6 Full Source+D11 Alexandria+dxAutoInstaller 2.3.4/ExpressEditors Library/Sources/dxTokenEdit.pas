...
uses
  Windows, Types, SysUtils, Classes, Graphics, Controls, Math, Variants,
  StdCtrls, Forms, Messages, ImgList,
  dxCore, dxCoreGraphics, dxCoreClasses, cxClasses, cxControls, cxGraphics,
  cxGeometry, cxLookAndFeelPainters,
  cxContainer, cxEdit, cxTextEdit, cxGroupBox, dxAutoCompleteWindow, dxFading,
  dxSmartImage, dxGDIPlusClasses,
...
type
  ...
  public
    ...
    function Add(const AText: string; const ADisplayText: string = '';
      const AHint: string = ''; AGlyph: TdxSmartGlyph = nil;
      AImageIndex: TcxImageIndex = -1): TdxTokenEditToken; overload;
    function FindByDisplayText(const AText: string): TdxTokenEditToken;
    function FindByText(const AText: string): TdxTokenEditToken;
    //
    property Items[Index: Integer]: TdxTokenEditToken read GetItem
  ...
  published
    ...
    property DropDownRows: Integer read FDropDownRows write SetDropDownRows
      default dxTokenEditDefaultDropDownRows;
    property FilterMode: TdxTokenEditLookupFilterMode read FFilterMode
      write SetFilterMode default tefmContains;
    property FilterSources: TdxTokenEditLookupFilterSources read FFilterSources
      write SetFilterSources default [tefsDisplayText, tefsText];
  ...
  TdxTokenEditCustomDrawTokenEvent = procedure(Sender: TObject;
    ACanvas: TcxCanvas; AViewInfo: TdxTokenEditCustomTokenViewInfo;
  ...
  TdxTokenEditTokenCollectionChangingEvent = procedure(Sender: TObject;
    const ATokenText: string; AToken: TdxTokenEditToken; var AAllow: Boolean)
    of object;
  ...
  protected
    ...
    function EditValueToTokens(const AString, ADelimiters: string): TStrings;
      overload; virtual;
  ...
  public
    constructor Create(AOwner: TPersistent); override;
    destructor Destroy; override;
    function EditValueToTokens(const AEditValue: TcxEditValue)
      : TStrings; overload;
    ...
    procedure ValidateDisplayValue(var ADisplayValue: TcxEditValue;
      ...
      override;
  published
    property AllowAddCustomTokens: Boolean read FAllowAddCustomTokens
      write SetAllowAddCustomTokens default True;
    property AssignedValues;
    property ClearKey;
    property CloseGlyphPosition: TdxTokenEditElementPosition
      read FCloseGlyphPosition write SetCloseGlyphPosition default teepRight;
    property EditValueDelimiter: Char read FEditValueDelimiter
      write SetEditValueDelimiter default dxTokenEditDefaultEditValueDelimiter;
    property GlyphPosition: TdxTokenEditElementPosition read FGlyphPosition
      write SetGlyphPosition default teepLeft;
    property Images;
    property ImeMode;
    property ImeName;
    property ImmediatePost;
    property InputDelimiters: string read FInputDelimiters
      write SetInputDelimiters stored IsInputDelimitersStored;
    property Lookup: TdxTokenEditPropertiesOptionsLookup read FLookup
      write SetLookup;
    property MaxLength;
    property MaxLineCount: Integer read FMaxLineCount write SetMaxLineCount
      default 0;
    property PostEditValueOnFocusLeave: Boolean read FPostEditValueOnFocusLeave
      write SetPostEditValueOnFocusLeave default False;
    property ReadOnly;
    ...
    property OnCustomDrawToken: TdxTokenEditCustomDrawTokenEvent
      read FOnCustomDrawToken write FOnCustomDrawToken;
    property OnTokenAdd: TdxTokenEditTokenCollectionChangingEvent
      read FOnTokenAdd write FOnTokenAdd;
    property OnTokenClick: TdxTokenEditTokenClickEvent read FOnTokenClick
      write FOnTokenClick;
    property OnTokenDelete: TdxTokenEditTokenCollectionChangingEvent
      read FOnTokenDelete write FOnTokenDelete;
    property OnTokenGlyphClick: TdxTokenEditTokenClickEvent
      read FOnTokenGlyphClick write FOnTokenGlyphClick;
    property OnValidate;
  end;
  ...
  public
    ...
    procedure EditValueToDrawValue(const AEditValue: Variant;
      AViewInfo: TcxCustomEditViewInfo); override;
    function GetClientExtent(Canvas: TcxCanvas; ViewInfo: TcxCustomEditViewInfo)
      : TRect; override;
    //
  ...
  TdxTokenEditTokenViewInfo = class(TdxTokenEditCustomTokenViewInfo,
    IdxFadingObject)
  strict private
  const
    GlyphOffset = 4;
  ...
  protected
    procedure CalculateGlyphBounds(var ABounds: TRect; const ASize: TSize;
      APosition: TdxTokenEditElementPosition); virtual;
    procedure CalculateStates(AController: TdxTokenEditController;
      out AState, ACloseGlyphState: TcxButtonState); virtual;
  ...
  public
    ...
    function Equals(Obj: TObject): Boolean; override;
    procedure Initialize(const AText: string; ATokenIndex: Integer;
      AItem: TdxTokenEditToken);
  ...
  public
    ...
    //
    property Items[Index: Integer]: TdxTokenEditTokenViewInfo read GetItem
  ...
  protected
    ...
    procedure CalculateLayoutCore(const AContentRect: TRect;
      ARowHeight, AMaxRowCount, AMinItemSize: Integer); virtual;
    procedure CalculateMoreTokensItem(const AContentRect: TRect;
      ARowHeight, AMinItemSize: Integer); virtual;
    function CalculateRowHeight: Integer; virtual;
    function CanGrowByHeight(AMinItemWidth: Integer): Boolean;
    function IsTooSmallForDisplay(const R, AArea: TRect;
      AMeasuredSize, AMinSize: Integer): Boolean;
  ...
  public
    ...
    function GetItemByPart(APart: Integer;
      out AItem: TdxTokenEditCustomTokenViewInfo): Boolean; virtual;
    ...
    property MoreTokensItem: TdxTokenEditCustomTokenViewInfo
      read FMoreTokensItem;
    property Properties: TdxTokenEditProperties read GetProperties;
  ...
  protected
    ...
    procedure ReplaceToken(const ATokenIndex: Integer;
      const ATokenText: string); virtual;
  ...
  public
    ...
    //
    property EditingTokenIndex: Integer read GetEditingTokenIndex
      write SetEditingTokenIndex;
  ...
  protected
    ...
    procedure RefreshAutoCompleteSuggestions(const ASearchText: string;
      const AMode: TdxTokenEditLookupFilterMode;
      const ASources: TdxTokenEditLookupFilterSources); overload;
  ...
  TdxTokenEditInnerEditHelper = class(TcxCustomInnerTextEditHelper,
    IdxInnerTokenEdit)
  public
    // IdxInnerTokenEdit
    procedure LockChanges(ALock: Boolean);
  ...
  protected
    function IsItemWithText(AItem: TdxCustomListBoxItem; const AText: string)
      : Boolean; override;
  end;
  ...
  protected
    ...
    // Events
    function CanAddToken(AProperties: TdxTokenEditProperties;
      const ATokenText: string; AToken: TdxTokenEditToken): Boolean; virtual;
    function DoTokenAdd(const ATokenText: string; AToken: TdxTokenEditToken)
      : Boolean; virtual;
    procedure DoTokenClick(const ATokenText: string;
      AToken: TdxTokenEditToken); virtual;
    function DoTokenDelete(const ATokenText: string; AToken: TdxTokenEditToken)
      : Boolean; virtual;
    procedure DoTokenGlyphClick(const ATokenText: string;
      AToken: TdxTokenEditToken); virtual;
    ...
    // Data
    procedure ReplaceToken(const AText: string;
      ATokenIndex: Integer = -1); virtual;
...
function dxCallCustomDrawItemEvent(AEvent: TdxTokenEditCustomDrawTokenEvent;
  ASender: TObject; ACanvas: TcxCanvas;
  AViewInfo: TdxTokenEditCustomTokenViewInfo): Boolean;
begin
  Result := False;
...
function dxCallTokenCollectionChangingEvent
  (AEvent: TdxTokenEditTokenCollectionChangingEvent; ASender: TObject;
  const ATokenText: string; AToken: TdxTokenEditToken): Boolean;
begin
  Result := True;
  if Assigned(AEvent) then
...
function TdxTokenEditTokens.Add(const AText: string;
  const ADisplayText: string = ''; const AHint: string = '';
  AGlyph: TdxSmartGlyph = nil; AImageIndex: TcxImageIndex = -1)
  : TdxTokenEditToken;
begin
  BeginUpdate;
  try
...
function TdxTokenEditTokens.FindByDisplayText(const AText: string)
  : TdxTokenEditToken;
var
  I: Integer;
begin
...
procedure TdxTokenEditTokens.SetItem(AIndex: Integer;
  const AValue: TdxTokenEditToken);
begin
...
procedure TdxTokenEditPropertiesOptionsLookup.SetFilterMode
  (AValue: TdxTokenEditLookupFilterMode);
begin
...
procedure TdxTokenEditPropertiesOptionsLookup.SetFilterSources
  (AValue: TdxTokenEditLookupFilterSources);
begin
...
procedure TdxTokenEditPropertiesOptionsLookup.SetDisplayMask
  (const AValue: string);
begin
...
function TdxTokenEditProperties.EditValueToTokens(const AEditValue: Variant)
  : TStrings;
begin
...
function TdxTokenEditProperties.GetEditValueSource(AEditFocused: Boolean)
...
class function TdxTokenEditProperties.GetViewInfoClass
  : TcxContainerViewInfoClass;
begin
  Result := TdxTokenEditViewInfo;
end;

procedure TdxTokenEditProperties.PrepareDisplayValue(const AEditValue: Variant;
...
function TdxTokenEditProperties.TokensToEditValue(const ATokens: TStrings)
  : TcxEditValue;
var
...
procedure TdxTokenEditProperties.ValidateDisplayValue(var ADisplayValue
  ...
  begin
    ...
    try
      ...
      begin
        ...
        begin
          AToken := ATokens[I];
          DoValidate(AToken, AErrorText, AError, AEdit,
...
begin
  ...
  begin
    ...
    AllowAddCustomTokens := TdxTokenEditProperties(AProperties)
      .AllowAddCustomTokens;
    CloseGlyphPosition := TdxTokenEditProperties(AProperties)
      .CloseGlyphPosition;
    GlyphPosition := TdxTokenEditProperties(AProperties).GlyphPosition;
    EditValueDelimiter := TdxTokenEditProperties(AProperties)
      .EditValueDelimiter;
    ...
    PostEditValueOnFocusLeave := TdxTokenEditProperties(AProperties)
...
function TdxTokenEditProperties.EditValueToTokens(const AString,
  ADelimiters: string): TStrings;
var
  P, P1: PChar;
  S: string;
  L: Integer;
...
class function TdxTokenEditProperties.GetViewDataClass
...
procedure TdxTokenEditProperties.SetCloseGlyphPosition
  (const AValue: TdxTokenEditElementPosition);
begin
...
procedure TdxTokenEditProperties.SetGlyphPosition(const AValue
...
procedure TdxTokenEditProperties.SetLookup
  (AValue: TdxTokenEditPropertiesOptionsLookup);
begin
...
procedure TdxTokenEditProperties.SetPostEditValueOnFocusLeave
...
procedure TdxTokenEditProperties.TokensChanged(Sender: TObject;
  AToken: TCollectionItem);
begin
  Changed;
end;
...
procedure TdxTokenEditViewData.Calculate(ACanvas: TcxCanvas;
...
begin
  inherited Calculate(ACanvas, ABounds, P, Button, Shift, AViewInfo,
    AIsMouseEvent);
  TdxTokenEditViewInfo(AViewInfo).UseRightToLeftAlignment :=
    UseRightToLeftAlignment;
  TdxTokenEditViewInfo(AViewInfo).UseRightToLeftReading :=
    UseRightToLeftReading;
  TdxTokenEditViewInfo(AViewInfo).Calculate;

  if (Edit = nil) and AIsMouseEvent then
  begin
    AController := TdxTokenEditController.Create
      (TdxTokenEditViewInfo(AViewInfo));
    try
...
procedure TdxTokenEditViewData.EditValueToDrawValue(const AEditValue: Variant;
...
function TdxTokenEditViewData.InternalGetEditConstantPartSize
...
begin
  ...
  if (AViewInfo <> nil) and (TdxTokenEditViewInfo(AViewInfo).Painter <> nil)
  then
    MinContentSize := cxSizeMax(MinContentSize, TdxTokenEditViewInfo(AViewInfo)
      .CalculateClientMinSize);
end;
...
begin
  ...
  try
    ...
    inherited Calculate(ACanvas, cxRect(ASize), cxInvalidPoint, cxmbNone, [],
      AViewInfo, False);
...
function TdxTokenEditViewData.ParseEditValue(const AEditValue: Variant)
  : TStrings;
begin
  Result := Properties.EditValueToTokens(AEditValue);
end;

function TdxTokenEditViewData.GetClientExtent(Canvas: TcxCanvas;
  ViewInfo: TcxCustomEditViewInfo): TRect;
var
...
constructor TdxTokenEditCustomTokenViewInfo.Create
  (AOwner: TdxTokenEditViewInfo);
begin
  inherited Create;
  FOwner := AOwner;
  FState := cxbsNormal;
...
procedure TdxTokenEditCustomTokenViewInfo.Calculate(const ALeft, ATop, AWidth,
  AHeight: Integer);
begin
  Calculate(cxRectBounds(ALeft, ATop, AWidth, AHeight));
end;

function TdxTokenEditCustomTokenViewInfo.CalculateHitTest
  (AHitTest: TdxTokenEditHitTest): Boolean;
begin
...
begin
  Result := (Obj.ClassType = ClassType) and
    ...
    cxRectIsEqual(TdxTokenEditCustomTokenViewInfo(Obj).CaptionBounds,
    CaptionBounds) and (State = TdxTokenEditCustomTokenViewInfo(Obj).State);
end;
...
procedure TdxTokenEditCustomTokenViewInfo.UpdateState
  (AController: TdxTokenEditController);
begin
  // do nothing
end;

function TdxTokenEditCustomTokenViewInfo.DoCustomDraw
  (ACanvas: TcxCanvas): Boolean;
begin
  Result := dxCallCustomDrawItemEvent(Owner.Properties.OnCustomDrawToken, Owner,
    ACanvas, Self);
  if Result and (Owner.Edit <> nil) and (Owner.Edit.RepositoryItem <> nil) then
    Result := dxCallCustomDrawItemEvent
      (TdxTokenEditProperties(Owner.Edit.ActiveProperties).OnCustomDrawToken,
      Owner, ACanvas, Self);
end;
...
const
  CAlignmentTextFlagMap: array [TAlignment] of Cardinal = (DT_LEFT, DT_RIGHT,
    DT_CENTER);
var
  ATextFlags: Cardinal;
begin
  ...
  begin
    ...
    ATextFlags := CAlignmentTextFlagMap[CaptionAlignment] or DT_VCENTER or
      DT_SINGLELINE or DT_END_ELLIPSIS;
    if Owner.UseRightToLeftReading then
      ATextFlags := ATextFlags or DT_RTLREADING;
    cxDrawText(ACanvas, Caption, CaptionBounds, ATextFlags,
      GetTextColor(State));
  end;
end;

function TdxTokenEditCustomTokenViewInfo.GetTextColor
  (const AState: TcxButtonState): TColor;
begin
  Result := Painter.GetTokenTextColor(AState);
  if (Result = clDefault) or
    ((Owner.Edit <> nil) and (TdxCustomTokenEdit(Owner.Edit)
    .IsStyleAssigned(csvTextColor))) then
...
function TdxTokenEditCustomTokenViewInfo.GetPainter
...
begin
  ...
  if IsCloseGlyphVisible then
    CalculateGlyphBounds(FCloseGlyphBounds,
      Painter.GetScaledTokenCloseGlyphSize(ScaleFactor), CloseGlyphPosition)
  else
  ...
  begin
    ...
    FGlyphBounds := cxRectCenter(FGlyphBounds,
      cxSizeProportionalStretch(cxSize(FGlyphBounds), ASize));
  end
  else
    FGlyphBounds := cxNullRect;
end;

function TdxTokenEditTokenViewInfo.CalculateHitTest
  (AHitTest: TdxTokenEditHitTest): Boolean;
begin
  ...
  begin
    ...
    else if PtInRect(GlyphBounds, AHitTest.Point) then
...
begin
  Result := inherited Equals(Obj) and cxRectIsEqual(CloseGlyphBounds,
    TdxTokenEditTokenViewInfo(Obj).CloseGlyphBounds) and
...
procedure TdxTokenEditTokenViewInfo.Initialize(const AText: string;
  ATokenIndex: Integer; AItem: TdxTokenEditToken);
begin
...
procedure TdxTokenEditTokenViewInfo.UpdateState(AController
  : TdxTokenEditController);
var
...
begin
  ...
  begin
    ...
    begin
      ...
      FState := AState;
      dxFader.Fade(Self, APrevStateSnapshot, CreateFadeImage,
        dxTokenEditDefaultFadeFrameCount, dxFadeOutDefaultAnimationFrameDelay);
    end
    else
    begin
      FState := AState;
...
procedure TdxTokenEditTokenViewInfo.CalculateGlyphBounds(var ABounds: TRect;
  const ASize: TSize; APosition: TdxTokenEditElementPosition);
begin
...
procedure TdxTokenEditTokenViewInfo.CalculateStates
  (AController: TdxTokenEditController;
  out AState, ACloseGlyphState: TcxButtonState);
begin
  if not Owner.Enabled then
    AState := cxbsDisabled
  else if (AController.FocusedObject = Self) and
    (AController.PressedObject = Self) then
    AState := cxbsPressed
  else if (AController.FocusedObject = Self) and
    (AController.PressedObject <> Self) then
    AState := cxbsHot
...
begin
  ...
  if not cxRectIsEmpty(CloseGlyphBounds) then
    Painter.DrawScaledTokenCloseGlyph(ACanvas, CloseGlyphBounds,
      CloseGlyphState, ScaleFactor);
  if not cxRectIsEmpty(GlyphBounds) then
    DrawGlyph(ACanvas, GlyphBounds);
end;

procedure TdxTokenEditTokenViewInfo.DrawGlyph(ACanvas: TcxCanvas;
  const R: TRect);
const
...
begin
  cxDrawImage(ACanvas, R, Item.Glyph, Images, Item.ImageIndex, ifmFit,
    DrawMode[State = cxbsDisabled], False, Painter.GetTokenColorPalette(State),
    ScaleFactor);
end;
...
begin
  if Item <> nil then
    Result := dxGetImageSize(Item.Glyph, Images, Item.ImageIndex,
      Owner.ScaleFactor)
  else
    Result := cxNullSize;
end;
...
begin
  Result := Supports(Owner.Owner, IcxEditOwner) and
    not Assigned(Owner.Properties.OnCustomDrawToken);
end;
...
procedure TdxTokenEditTokenViewInfo.GetFadingImages(out AFadeOutImage,
...
function TdxTokenEditTokenViewInfo.GetCloseGlyphPosition
  : TdxTokenEditElementPosition;
begin
  Result := Owner.Properties.CloseGlyphPosition;
end;

function TdxTokenEditTokenViewInfo.GetGlyphPosition
  : TdxTokenEditElementPosition;
begin
...
procedure TdxTokenEditTokenViewInfoList.Assign
  (ASource: TdxTokenEditTokenViewInfoList);
var
  I: Integer;
begin
  Clear;
...
procedure TdxTokenEditTokenViewInfoList.CalculateHitTest
...
begin
  Result := (Obj.ClassType = ClassType) and
    (Count = TdxTokenEditTokenViewInfoList(Obj).Count);
  if Result then
  begin
    for I := 0 to Count - 1 do
      Result := Result and Items[I].Equals(TdxTokenEditTokenViewInfoList(Obj)
        .Items[I]);
  end;
end;

function TdxTokenEditTokenViewInfoList.IndexOf
  (AToken: TdxTokenEditToken): Integer;
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
...
function TdxTokenEditTokenViewInfoList.GetItem(Index: Integer)
  : TdxTokenEditTokenViewInfo;
begin
  Result := TdxTokenEditTokenViewInfo(inherited Items[Index]);
end;

procedure TdxTokenEditTokenViewInfoList.SetItem(Index: Integer;
  AValue: TdxTokenEditTokenViewInfo);
begin
...
function TdxTokenEditMoreTokensViewInfo.CalculateHitTest
  (AHitTest: TdxTokenEditHitTest): Boolean;
begin
  Result := inherited CalculateHitTest(AHitTest);
  if Result then
...
begin
  ...
  try
    ...
    Result := Format(cxGetResourceString(@sdxTokenEditMoreTokensHint),
      [AHiddenTokenCount, AHiddenTokens.ToString]);
  finally
...
begin
  Result := CalculateClientSize(cxSizeMax(ContentSize,
    GetDefaultTokenItemSize));
end;
...
procedure TdxTokenEditViewInfo.CalculateHitTest(const AHitTest
  : TdxTokenEditHitTest);
begin
  ...
  begin
    ...
    try
      ...
      else if not MoreTokensItem.CalculateHitTest(AHitTest) then
...
begin
  Result := (Obj.ClassType = ClassType) and cxRectIsEqual(ClientRect,
    TdxTokenEditViewInfo(Obj).ClientRect) and cxPointIsEqual(ContentOffset,
    TdxTokenEditViewInfo(Obj).ContentOffset) and
...
function TdxTokenEditViewInfo.GetItemByPart(APart: Integer;
  out AItem: TdxTokenEditCustomTokenViewInfo): Boolean;
var
  ATokenIndex: Integer;
begin
  ...
  begin
    ...
    else if InRange(ATokenIndex, 0, Tokens.Count - 1) then
    ...
    try
      ...
      case AHitTest.HitObjectPartID of
        tehtToken, tehtTokenCloseGlyph, tehtTokenGlyph:
          Result := ecpTokenSignature or
            Word(TdxTokenEditTokenViewInfo(AHitTest.HitObject).TokenIndex);
        tehtMoreTokensItem:
...
function TdxTokenEditViewInfo.NeedShowHint(ACanvas: TcxCanvas; const P: TPoint;
...
begin
  ...
  try
    ...
    begin
      ...
      if AText <> '' then
      begin
        ATextRect.TopLeft := cxPointOffset(P, 0, cxGetCursorSize.cy +
          cxTextOffset);
...
begin
  Result := inherited Repaint(AControl, AInnerEditRect, AViewInfo) or
    (AViewInfo <> nil) and not Equals(AViewInfo);
end;
...
procedure TdxTokenEditViewInfo.CalculateLayoutCore(const AContentRect: TRect;
  ARowHeight, AMaxRowCount, AMinItemSize: Integer);

  function IsNewRowNeeded(const AOffset: TPoint;
    const AItemWidth: Integer): Boolean;
  begin
    Result := (AOffset.X <> AContentRect.Left) and
      (AOffset.X + AItemWidth > AContentRect.Right) and (AMaxRowCount > 1);
  end;

  function IsInnerEditStretchNeeded(const AOffset: TPoint): Boolean;
  begin
    Result := (EditingTokenIndex = (Tokens.Count - 1)) or
      IsNewRowNeeded(AOffset, Max(Tokens[EditingTokenIndex + 1].MeasureSize.cx,
      InnerEditSize.cx));
  end;
...
begin
  ...
  begin
    ...
    begin
      InnerEditRect := CalculateItemBounds(AOffset,
        Max(AItem.MeasureSize.cx, InnerEditSize.cx));
  ...
  begin
    ...
    begin
      InnerEditRect := cxRectCenterVertically(CalculateItemBounds(AOffset,
        InnerEditSize.cx), InnerEditSize.cy);
      StretchInnerEditToTheEndOfTheLine;
    end;
  end;
end;

procedure TdxTokenEditViewInfo.CalculateMoreTokensItem(const AContentRect
  : TRect; ARowHeight, AMinItemSize: Integer);

  function GetFreeSpaceForMoreTokensItem(AToken: TdxTokenEditTokenViewInfo;
    ARequiredSpace: Integer): Boolean;
    ...
    begin
      if not UseRightToLeftAlignment then
        ...
        ATokenBounds := cxRectSetRight(ATokenBounds,
          ATokenBounds.Right, AWidth);
    end;
  ...
  begin
    ...
    begin
      ...
      SetTokenWidth(ATokenBounds,
        Max(0, cxRectWidth(ATokenBounds) - GetNeededSpace));
      if IsTooSmallForDisplay(ATokenBounds, AContentRect, AToken.MeasureSize.cx,
        AMinItemSize) then
...
begin
  ...
  begin
    ...
    begin
      if not UseRightToLeftAlignment then
        ALeft := AToken.Bounds.Right + IfThen(AToken.IsVisible,
          IndentBetweenItems)
      else
        ALeft := AToken.Bounds.Left - IfThen(AToken.IsVisible,
          IndentBetweenItems);
    ...
    if not UseRightToLeftAlignment then
      ...
      AItemBounds := cxRectSetHeight(cxRectSetRight(AItemBounds,
        AItemBounds.Right, AItemSize.cx), ARowHeight);
...
begin
  Result := (Edit <> nil) and (TdxCustomTokenEdit(Edit).IsAutoHeight and
    (MaxLineCount = 0) or (AMinItemWidth <= cxRectWidth(Bounds) -
    cxMarginsHeight(BorderExtent) - 2 * ScaleFactor.Apply(Padding) -
    dxGetSystemMetrics(SM_CXVSCROLL, ScaleFactor)));
end;

function TdxTokenEditViewInfo.IsTooSmallForDisplay(const R, AArea: TRect;
  AMeasuredSize, AMinSize: Integer): Boolean;
begin
  Result := (R.Bottom > AArea.Bottom) or (cxRectWidth(R) < AMinSize) and
    (cxRectWidth(R) < AMeasuredSize);
end;
...
function TdxTokenEditViewInfo.GetTokenItemViewInfoClass
  : TdxTokenEditTokenViewInfoClass;
begin
...
begin
  ...
  try
    cxBitBlt(ABufferBitmap.Canvas.Handle, ACanvas.Handle,
      ABufferBitmap.ClientRect, Bounds.TopLeft, SRCCOPY);
    ...
    cxBitBlt(ACanvas.Handle, ABufferBitmap.Canvas.Handle, Bounds,
      cxNullPoint, SRCCOPY);
  finally
    ABufferBitmap.Free;
  end;
...
begin
  ...
  try
    ...
    for I := 0 to Tokens.Count - 1 do
      Tokens[I].Initialize(ATokens[I], I,
        TdxTokenEditToken(ATokens.Objects[I]));
  finally
    ATokens.Free;
  end;
end;
...
function TdxTokenEditViewInfo.CalculateClientSize(const AContentSize
  : TSize): TSize;
var
  AMargins: TRect;
begin
...
begin
  FContentOffset.X := 0;
  FContentOffset.Y := Min(0, Max(Value.Y, cxRectHeight(ContentDisplayRect) -
    ContentSize.cy));
end;
...
procedure TdxTokenEditController.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  UpdateHitTest(Point(X, Y));

  if (Edit <> nil) and not Edit.InnerControlMouseDown and
    not((FocusedObject is TdxTokenEditViewInfo) and (EditingTokenIndex = -1))
  then
    StopEditing(False);
...
procedure TdxTokenEditController.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  UpdateHitTest(Point(X, Y));
...
procedure TdxTokenEditController.ReplaceToken(const ATokenIndex: Integer;
...
begin
  case HitTest.HitObjectPartID of
    tehtToken:
      Edit.DoTokenClick(TdxTokenEditTokenViewInfo(HitTest.HitObject).Text,
    ...
    tehtTokenGlyph:
      Edit.DoTokenGlyphClick(TdxTokenEditTokenViewInfo(HitTest.HitObject).Text,
        TdxTokenEditTokenViewInfo(HitTest.HitObject).Item);
  end;
end;
...
begin
  case Key of
    ...
    VK_RETURN:
      ...
      else if ProcessKeyReturn(Shift) then
        Key := 0;

    VK_ESCAPE:
      if FAutoCompleteWindow <> nil then
        HideAutoCompleteWindow
      else if ProcessKeyEscape(Shift) then
        Key := 0;
      ...
      begin
        ...
        begin
          if not FAutoCompleteWindow.HasSelectedItem then
            TdxTokenEditAutoCompleteWindow(FAutoCompleteWindow)
              .InnerListBox.ItemIndex := 0;
          Key := VK_RETURN;
...
var
  APostToken: Boolean;
begin
  Result := CheckShiftState(Shift) and
    ((Text <> '') or (Controller.EditingTokenIndex >= 0) or
    not Container.IsInplace);
  if Result then
  begin
...
begin
  ...
  begin
    LockChanges(True);
    try
      Result := (Text <> '') or (Controller.EditingTokenIndex >= 0) or
        not Container.IsInplace;
      PostToken;
      if Result then
      begin
...
begin
  RefreshAutoCompleteSuggestions(Text, ActiveProperties.Lookup.FilterMode,
    ActiveProperties.Lookup.FilterSources);
end;

procedure TdxTokenEditInnerEdit.RefreshAutoCompleteSuggestions(const ASearchText
  : string; const AMode: TdxTokenEditLookupFilterMode;
  const ASources: TdxTokenEditLookupFilterSources);

  function IsValidSuggestion(const AText: string): Boolean;
  begin
    if AText = '' then
      Result := False
    else if AMode = tefmStartsWith then
      ...
      begin
        ...
        begin
          if ((tefsText in ASources) and IsValidSuggestion(AToken.Text)) or
            ((tefsDisplayText in ASources) and
            IsValidSuggestion(AToken.DisplayText)) then
          begin
            ASuggestion := StringReplace(ActiveProperties.Lookup.DisplayMask,
              dxTokenEditDefaultDisplayMaskText, AToken.Text, [rfReplaceAll]);
            ASuggestion := StringReplace(ASuggestion,
              dxTokenEditDefaultDisplayMaskDisplayText, AToken.DisplayText,
              [rfReplaceAll]);
        ...
        begin
          ...
          if (tefsDisplayText in ASources) and
            IsValidSuggestion(AToken.DisplayText) then
...
procedure TdxTokenEditInnerEdit.RefreshAutoCompleteWindow
  (ASuggestions: TStrings);
begin
  if FLockCount <> 0 then
    Exit;
  ...
  begin
    ...
    FAutoCompleteWindow.Adjustable :=
      cxSizeIsEmpty(FAutoCompleteWindowCustomSize);
...
procedure TdxTokenEditInnerEdit.AutoCompleteWindowSelectItemHandler
  (Sender: TObject);
begin
  if FAutoCompleteWindow.HasSelectedItem then
  begin
...
procedure TdxTokenEditInnerEdit.AutoCompleteWindowStoreSizeHandler
  (Sender: TObject);
begin
  if FAutoCompleteWindow <> nil then
...
function TdxTokenEditAutoCompleteListBox.IsItemWithText
  (AItem: TdxCustomListBoxItem; const AText: string): Boolean;
begin
...
constructor TdxTokenEditAutoCompleteWindow.Create
  (AInnerEdit: TdxTokenEditInnerEdit);
begin
...
function TdxTokenEditAutoCompleteWindow.CreateInnerListBox
...
class function TdxCustomTokenEdit.GetPropertiesClass
...
begin
  Result := HasInnerEdit and (InnerEdit.Control as TdxTokenEditInnerEdit)
    .IsAutoCompleteWindowVisible;
end;
...
begin
  ...
  begin
    ...
    InnerEdit.Control.SetBounds(ARect.Left, ARect.Top, cxRectWidth(ARect),
      cxRectHeight(ARect));
    SetWindowRegion(InnerEdit.Control, cxRectOffset(AClipRect,
      ARect.TopLeft, False));
...
function TdxCustomTokenEdit.CanAddToken(AProperties: TdxTokenEditProperties;
  const ATokenText: string; AToken: TdxTokenEditToken): Boolean;
begin
  Result := (AProperties.AllowAddCustomTokens or (AToken <> nil)) and
    dxCallTokenCollectionChangingEvent(AProperties.OnTokenAdd, Self,
    ATokenText, AToken);
end;

function TdxCustomTokenEdit.DoTokenAdd(const ATokenText: string;
...
procedure TdxCustomTokenEdit.DoTokenClick(const ATokenText: string;
  AToken: TdxTokenEditToken);
begin
  DisableUserAction;
  try
    ...
    if RepositoryItem <> nil then
      dxCallTokenClickEvent(ActiveProperties.OnTokenClick, Self,
        ATokenText, AToken);
  finally
    EnableUserAction;
  end;
...
function TdxCustomTokenEdit.DoTokenDelete(const ATokenText: string;
  AToken: TdxTokenEditToken): Boolean;
begin
  DisableUserAction;
  try
    Result := dxCallTokenCollectionChangingEvent(Properties.OnTokenDelete, Self,
      ATokenText, AToken);
    if Result and (RepositoryItem <> nil) then
      Result := dxCallTokenCollectionChangingEvent
        (ActiveProperties.OnTokenDelete, Self, ATokenText, AToken);
  finally
    EnableUserAction;
  end;
end;

procedure TdxCustomTokenEdit.DoTokenGlyphClick(const ATokenText: string;
  AToken: TdxTokenEditToken);
begin
  DisableUserAction;
  try
    dxCallTokenClickEvent(Properties.OnTokenGlyphClick, Self,
      ATokenText, AToken);
    if RepositoryItem <> nil then
      dxCallTokenClickEvent(ActiveProperties.OnTokenGlyphClick, Self,
        ATokenText, AToken);
  finally
    EnableUserAction;
  end;
...
procedure TdxCustomTokenEdit.Scroll(AScrollBarKind: TScrollBarKind;
...
procedure TdxCustomTokenEdit.ScrollToInnerEdit;
  ...
  begin
    ...
    else if AInnerEditRect.Bottom > AContentRect.Bottom then
      Result := Min(AInnerEditRect.Bottom - AContentRect.Bottom,
        AInnerEditRect.Top - AContentRect.Top)
    else
      Result := 0;
  end;
...
begin
  ...
  begin
    ...
    begin
      AScrollPos := VScrollBar.Position + GetScrollDelta(ViewInfo.InnerEditRect,
        ViewInfo.ContentDisplayRect);
...
procedure TdxCustomTokenEdit.MouseDown(Button: TMouseButton; Shift: TShiftState;
  X: Integer; Y: Integer);
begin
...
procedure TdxCustomTokenEdit.MouseMove(Shift: TShiftState; X: Integer;
  Y: Integer);
begin
  inherited;
...
procedure TdxCustomTokenEdit.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X: Integer; Y: Integer);
begin
  inherited;
...
procedure TdxCustomTokenEdit.ReplaceToken(const AText: string;
  ATokenIndex: Integer = -1);

  procedure InsertToken(ATokens: TStrings; var AIndex: Integer;
    const AText: string; AToken: TdxTokenEditToken);
  begin
...
var
  ...
  I: Integer;
begin
  if ActiveProperties.ReadOnly or IsUserActionDisabled then
    Exit;
  ...
  try
    ...
    try
      ATokensToAdd := ActiveProperties.EditValueToTokens(AText,
        ActiveProperties.InputDelimiters);
      try
        for I := 0 to ATokensToAdd.Count - 1 do
          if ATokensToAdd.Objects[I] = nil then
          begin
            AToken := ActiveProperties.Tokens.FindByDisplayText
              (ATokensToAdd[I]);
            if AToken <> nil then
            begin
        ...
        begin
          if (ATokensToAdd.Count = 1) and
            (ATokens[ATokenIndex] = ATokensToAdd[0]) and
            (ATokenIndex <> ActiveProperties.FirstInvalidTokenIndex) then
            Exit;
          if DoTokenDelete(ATokens[ATokenIndex],
            TdxTokenEditToken(ATokens.Objects[ATokenIndex])) then
        ...
        for I := 0 to ATokensToAdd.Count - 1 do
          InsertToken(ATokens, ATokenIndex, ATokensToAdd[I],
            TdxTokenEditToken(ATokensToAdd.Objects[I]));
      finally
        ATokensToAdd.Free;
      end;
...
begin
  ...
  begin
    ...
    try
      ...
      if ActiveProperties.ImmediatePost and CanPostEditValue and InternalValidateEdit
      then
      begin
...
procedure TdxCustomTokenEdit.PopulateSizeProperties(var AEditSizeProperties
...
GetRegisteredEditProperties.Register(TdxTokenEditProperties,
  scxSEditRepositoryTokenItem);
