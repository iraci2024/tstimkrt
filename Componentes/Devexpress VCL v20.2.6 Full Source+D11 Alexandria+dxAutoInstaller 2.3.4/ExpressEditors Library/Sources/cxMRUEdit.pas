...
type
  ...
  TcxMRUEditDeleteLookupItemEvent = procedure(AProperties
    : TcxCustomMRUEditProperties; AItemIndex: Integer) of object;
  ...
  public
    ...
    property ActiveProperties: TcxCustomMRUEditProperties
...
procedure TcxCustomMRUEditProperties.DoUpdate(AProperties
...
procedure TcxCustomMRUEditProperties.DoAssign(AProperties
  : TcxCustomEditProperties);
begin
  inherited;
...
procedure TcxCustomMRUEdit.InternalValidateDisplayValue(const ADisplayValue
  : TcxEditValue);
begin
  AddItem(Text);
...
class function TcxCustomMRUEdit.GetPropertiesClass
...
GetRegisteredEditProperties.Register(TcxMRUEditProperties,
