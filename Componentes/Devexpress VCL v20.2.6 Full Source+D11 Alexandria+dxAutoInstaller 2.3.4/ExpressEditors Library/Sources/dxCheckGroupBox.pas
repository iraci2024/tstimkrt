...
type
  ...
  protected
    ...
    class function GetCheckBoxClass
      : TdxCustomCheckGroupBoxCheckBoxClass; virtual;
    ...
    property CheckBox: TdxCustomCheckGroupBoxCheckBox read FCheckBox
      write SetCheckBox;
  ...
  public
    ...
    property ActiveProperties: TdxCheckGroupBoxProperties
  ...
  protected
    class function GetCheckBoxClass
      : TdxCustomCheckGroupBoxCheckBoxClass; override;
  published
    property Alignment;
    property Anchors;
    property BiDiMode;
...
constructor TdxCustomCheckGroupBoxCheckBox.Create
...
class function TdxCustomCheckGroupBox.GetPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TdxCheckGroupBoxProperties;
end;

procedure TdxCustomCheckGroupBox.PrepareEditValue(const ADisplayValue
...
begin
  Result := inherited CanFocusOnClick(X, Y) and
    PtInRect(ViewInfo.MouseFocusingRect, Point(X, Y));
end;

procedure TdxCustomCheckGroupBox.DoCheckBoxCheckedChanged;
begin
  if not IsDesigning and (CheckBox.CheckAction = cbaToggleChildrenEnabledState)
  then
    EnableChildControls(Self, CheckBox.Checked);
end;

procedure TdxCustomCheckGroupBox.EnableChildControls(AControl: TControl;
  AEnabled: Boolean);
var
  I: Integer;
...
procedure TdxCustomCheckGroupBox.SetCheckBox
  (AValue: TdxCustomCheckGroupBoxCheckBox);
begin
  FCheckBox.Assign(AValue);
end;

procedure TdxCustomCheckGroupBox.SetProperties
  (Value: TdxCheckGroupBoxProperties);
begin
...
class function TdxCheckGroupBox.GetCheckBoxClass
  : TdxCustomCheckGroupBoxCheckBoxClass;
begin
