...
uses
  ...
  dxCore, cxClasses, dxCoreClasses, cxControls, cxContainer, cxGraphics,
  cxLookAndFeels,
  cxLookAndFeelPainters, cxDataUtils, cxDataStorage, cxCustomData, cxData,
  cxEdit,
...
type
  ...
  public
    property Items[Index: Integer]: TcxLookupGridColumnViewInfo read GetItem;
  ...
  public
    ...
    IsFocused: Boolean;
    destructor Destroy; override;
    function CreateEditViewInfo(AProperties: TcxCustomEditProperties)
  ...
  protected
    function AddCell(AIndex: Integer; const AInitBounds: TRect;
  ...
  public
    ...
    RecordIndex: Integer;
    RowIndex: Integer;
    property Items[Index: Integer]: TcxLookupGridCellViewInfo read GetItem;
    default; // for internal use
  end;
  ...
  public
    ...
    property Items[Index: Integer]: TcxLookupGridRowViewInfo read GetItem;
    default; // for internal use
  end;
  ...
  protected
    function AddRow(ARowIndex: Integer; const AInitBounds: TRect)
    ...
    property TopRowIndexCalculation: TcxLookupGridTopRowIndexCalculation
      read FTopRowIndexCalculation write FTopRowIndexCalculation;
  public
    BorderSize: Integer;
    HeadersRect: TRect;
    ...
    destructor Destroy; override;
    procedure CalcCellColors(ARowIsSelected, ACellIsSelected: Boolean;
    ...
    procedure CreateEditStyle(AColumnViewInfo: TcxLookupGridColumnViewInfo;
      AColumn: TcxLookupGridColumn); virtual;
    function CreateEditViewData(AColumnViewInfo: TcxLookupGridColumnViewInfo;
      AColumn: TcxLookupGridColumn): TcxCustomEditViewData; virtual;
    procedure DestroyEditViewData(AColumnViewInfo: TcxLookupGridColumnViewInfo;
      AColumn: TcxLookupGridColumn); virtual;
    procedure DoColumnsRightToLeftConversion; virtual;
    procedure DoEmptyAreasRightToLeftConversion; virtual;
    procedure DoRowRightToLeftConversion(ARowViewInfo
      : TcxLookupGridRowViewInfo); virtual;
  ...
  public
    ...
    property Canvas: TcxCanvas read GetCanvas;
    property Grid: TcxCustomLookupGrid read FGrid; // for internal use
    property LFPainterClass: TcxCustomLookAndFeelPainter read FLFPainterClass
      write FLFPainterClass;
  end;
  ...
  TcxLookupGridColumn = class(TcxInterfacedCollectionItem,
  ...
  public
    ...
    property DefaultValuesProvider: TcxCustomEditDefaultValuesProvider
      read FDefaultValuesProvider; // for internal use
  ...
  published
    ...
    property MinWidth: Integer read GetMinWidth write SetMinWidth
      default cxLookupGridColumnDefaultMinWidth;
  ...
  public
    constructor Create(AGrid: TcxCustomLookupGrid;
      AColumnClass: TcxLookupGridColumnClass); virtual;
    function Add: TcxLookupGridColumn;
    procedure BeginUpdate; override;
    procedure EndUpdate; override;
    procedure RestoreDefaults; virtual;
    property Grid: TcxCustomLookupGrid read FGrid; // for internal use
    property Items[Index: Integer]: TcxLookupGridColumn read GetColumn
  ...
  published
    ...
    property ColumnSorting: Boolean read FColumnSorting write FColumnSorting
      default True;
  ...
  TcxLookupGridCloseUpEvent = procedure(Sender: TObject; AAccept: Boolean)
    of object;
  ...
  protected
    ...
    procedure DoCellClick(ARowIndex, AColumnIndex: Integer;
      AShift: TShiftState); virtual;
    procedure DoHeaderClick(AColumnIndex: Integer;
      AShift: TShiftState); virtual;
    ...
    procedure FocusedRowChanged(APrevFocusedRowIndex, AFocusedRowIndex
      : Integer); virtual;
  ...
  public
    ...
    property FocusedColumn: TcxLookupGridColumn read GetFocusedColumn
    ...
    property IsPopupControl: Boolean read FIsPopupControl
      write SetIsPopupControl;
    ...
    property OnCloseUp: TcxLookupGridCloseUpEvent read FOnCloseUp
      write FOnCloseUp;
...
uses
  Math, Variants, cxEditRegisteredRepositoryItems,
  cxEditDataRegisteredRepositoryItems, cxTextEdit, cxGeometry;
...
function TcxLookupGridColumnViewInfo.CreateEditStyle
  (AProperties: TcxCustomEditProperties): TcxCustomEditStyle;
begin
...
function TcxLookupGridColumnViewInfo.CreateEditViewData
...
function TcxLookupGridColumnsViewInfo.GetItem(Index: Integer)
  : TcxLookupGridColumnViewInfo;
begin
...
function TcxLookupGridCellViewInfo.CreateEditViewInfo
  (AProperties: TcxCustomEditProperties): TcxCustomEditViewInfo;
begin
...
function TcxLookupGridRowViewInfo.AddCell(AIndex: Integer;
  const AInitBounds: TRect; AIsFocused: Boolean): TcxLookupGridCellViewInfo;
begin
...
function TcxLookupGridRowViewInfo.GetItem(Index: Integer)
  : TcxLookupGridCellViewInfo;
begin
...
function TcxLookupGridRowsViewInfo.FindByRowIndex(ARowIndex: Integer)
  : TcxLookupGridRowViewInfo;
var
  I: Integer;
begin
...
function TcxLookupGridRowsViewInfo.GetItem(Index: Integer)
  : TcxLookupGridRowViewInfo;
begin
    ...
    try
      ...
      begin
        ...
        begin
          ...
          ALeft := Bounds.Right;
          ContentBounds := Grid.Painter.LFPainterClass.ScaledHeaderContentBounds
            (Bounds, Borders, Grid.ScaleFactor);
        end;
      end;
...
procedure TcxLookupGridViewInfo.CalcCellColors(ARowIsSelected, ACellIsSelected
  : Boolean; var AColor, AFontColor: TColor);
begin
...
procedure TcxLookupGridViewInfo.CalcRows;
  ...
  begin
    ARowViewInfo := AddRow(ARowIndex, Rect(RowsRect.Left, ATop,
      RowsRect.Right, ATop));
    // Init Cells
    ARowHeight := 0;
    for I := 0 to Grid.Columns.Count - 1 do
    ...
    if (GridLines in [glBoth, glHorizontal]) or
      ((GridLines = glVertical) and (ARowIndex = (RowCount - 1)) and
      ExistEmptyArea) then
    begin
...
begin
  ...
  begin
    ...
    RowsRect := Rect(HeadersRect.Left, HeadersRect.Bottom, HeadersRect.Right,
      HeadersRect.Bottom);
...
function TcxLookupGridViewInfo.AddRow(ARowIndex: Integer;
  const AInitBounds: TRect): TcxLookupGridRowViewInfo;
begin
...
begin
  ...
  try
    Result := 2 * cxGridEditOffset + AEditViewData.GetEditSize(Canvas, Null,
      cxDefaultEditSizeProperties).cy;
  finally
...
procedure TcxLookupGridViewInfo.CalculateCells(ARowViewInfo
  : TcxLookupGridRowViewInfo);
  ...
  begin
    ...
    CalcCellColors(ASelected and ARowViewInfo.IsFocused, ASelected and
      ACellViewInfo.IsFocused, AColor, AFontColor);
    ...
    // Calculate
    AEditViewInfo := ACellViewInfo.CreateEditViewInfo
      (Grid.Columns[ACellViewInfo.Index].Properties);
    AEditViewData := CreateEditViewData(Columns[ACellViewInfo.Index],
      Grid.Columns[ACellViewInfo.Index]);
    try
      ...
      // Value
      if Grid.Columns[ACellViewInfo.Index].Properties.GetEditValueSource(False)
        = evsValue then
        ADisplayValue := Grid.FDataController.Values[ARowViewInfo.RecordIndex,
          ACellViewInfo.Index]
      else
        ADisplayValue := Grid.FDataController.DisplayTexts
          [ARowViewInfo.RecordIndex, ACellViewInfo.Index];
      // Calculate
      ARect := ACellViewInfo.ContentBounds;
      InflateRect(ARect, -cxGridEditOffset, -cxGridEditOffset);
      if Grid.Options.HighlightIncrementalFilteringText and
        (AEditViewData is TcxCustomTextEditViewData) then
      begin
        ATextEditViewData := TcxCustomTextEditViewData(AEditViewData);
        if Grid.DataController.HasIncrementalFilter and
          (ACellViewInfo.Index = Grid.DataController.GetIncrementalFilterField.
          Index) then
        begin
      ...
      AEditViewData.Calculate(Canvas, ARect, Point(-1, -1), cxmbNone, [],
        AEditViewInfo, False);
    finally
      DestroyEditViewData(Columns[ACellViewInfo.Index],
        Grid.Columns[ACellViewInfo.Index]);
    end;
  end;
...
function TcxLookupGridViewInfo.GetCellHeight(ARowIndex,
...
procedure TcxLookupGridViewInfo.CreateEditStyle(AColumnViewInfo
  : TcxLookupGridColumnViewInfo; AColumn: TcxLookupGridColumn);
begin
...
function TcxLookupGridViewInfo.CreateEditViewData(AColumnViewInfo
  : TcxLookupGridColumnViewInfo; AColumn: TcxLookupGridColumn)
  : TcxCustomEditViewData;
begin
...
procedure TcxLookupGridViewInfo.DestroyEditViewData(AColumnViewInfo
  : TcxLookupGridColumnViewInfo; AColumn: TcxLookupGridColumn);
begin
...
begin
  ...
  begin
    ...
    AColumnViewInfo.Borders := TdxRightToLeftLayoutConverter.ConvertBorders
      (AColumnViewInfo.Borders);
    AColumnViewInfo.Bounds := TdxRightToLeftLayoutConverter.ConvertRect
      (AColumnViewInfo.Bounds, ClientBounds);
    AColumnViewInfo.ContentBounds := TdxRightToLeftLayoutConverter.ConvertRect
      (AColumnViewInfo.ContentBounds, ClientBounds);
    AColumnViewInfo.Neighbors := TdxRightToLeftLayoutConverter.ConvertNeighbors
      (AColumnViewInfo.Neighbors);
  end;
end;

procedure TcxLookupGridViewInfo.DoEmptyAreasRightToLeftConversion;
begin
  EmptyRectBottom := TdxRightToLeftLayoutConverter.ConvertRect(EmptyRectBottom,
    ClientBounds);
  EmptyRectRight := TdxRightToLeftLayoutConverter.ConvertRect(EmptyRectRight,
    ClientBounds);
end;

procedure TcxLookupGridViewInfo.DoRowRightToLeftConversion
  (ARowViewInfo: TcxLookupGridRowViewInfo);
var
  ACellViewInfo: TcxLookupGridCellViewInfo;
  I: Integer;
begin
  ARowViewInfo.Borders := TdxRightToLeftLayoutConverter.ConvertBorders
    (ARowViewInfo.Borders);
  ARowViewInfo.Bounds := TdxRightToLeftLayoutConverter.ConvertRect
    (ARowViewInfo.Bounds, ClientBounds);
  ARowViewInfo.ContentBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (ARowViewInfo.ContentBounds, ClientBounds);
  for I := 0 to ARowViewInfo.Count - 1 do
  begin
    ACellViewInfo := ARowViewInfo[I];
    ACellViewInfo.Borders := TdxRightToLeftLayoutConverter.ConvertBorders
      (ACellViewInfo.Borders);
    ACellViewInfo.Bounds := TdxRightToLeftLayoutConverter.ConvertRect
      (ACellViewInfo.Bounds, ClientBounds);
    ACellViewInfo.ContentBounds := TdxRightToLeftLayoutConverter.ConvertRect
      (ACellViewInfo.ContentBounds, ClientBounds);
  end;
end;
...
begin
  Result := Grid.Painter.LFPainterClass.DefaultSelectionTextColor;
  // clHighlightText;
end;

function TcxLookupGridViewInfo.GetHeaderHeight: Integer;
begin
  Result := Grid.Painter.LFPainterClass.ScaledHeaderHeight
    (Canvas.FontHeight(GetHeaderFont), Grid.ScaleFactor);
end;
...
procedure TcxLookupGridPainter.DrawCell(ACellViewInfo
  : TcxLookupGridCellViewInfo);
begin
  ACellViewInfo.EditViewInfo.Paint(Canvas);
  Canvas.FrameRect(ACellViewInfo.ContentBounds,
    ACellViewInfo.EditViewInfo.BackgroundColor, cxGridEditOffset);
...
begin
  with ViewInfo do
    ...
    begin
      ...
      begin
        R := Columns[I].Bounds;
        ATextRect := LFPainterClass.ScaledHeaderContentBounds(R,
          Columns[I].Borders, Grid.ScaleFactor);
        InflateRect(ATextRect, -cxHeaderTextOffset, -cxHeaderTextOffset);
        ASortOrder := Columns[I].SortOrder;
        if ASortOrder <> soNone then
        begin
          ASortRect :=
            Rect(ATextRect.Right - LFPainterClass.ScaledSortingMarkAreaSize
            (Grid.ScaleFactor).X, ATextRect.Top, ATextRect.Right,
            ATextRect.Bottom);
        ...
        LFPainterClass.DrawScaledHeader(Canvas, R, ATextRect,
          Columns[I].Neighbors, Columns[I].Borders, cxbsNormal, AAlignment,
          vaCenter, False, True, Columns[I].Text, GetHeaderFont,
          GetHeaderFontColor, GetHeaderColor, Grid.ScaleFactor);
        if ASortOrder <> soNone then
          LFPainterClass.DrawScaledSortingMark(Canvas, ASortRect,
            ASortOrder = soAscending, Grid.ScaleFactor);
      end;
    end;
end;
...
function TcxLookupGridDefaultValuesProvider.IsDisplayFormatDefined
...
begin
  ...
  begin
    ...
    Result := Result and (Caption = ASource.Caption) and
      (HeaderAlignment = ASource.HeaderAlignment) and
      (MinWidth = ASource.MinWidth) and (Fixed = ASource.Fixed) and
      (Sorting = ASource.Sorting) and (SortOrder = ASource.SortOrder) and
      (RepositoryItem = ASource.RepositoryItem) and (Width = ASource.Width);
  end;
end;
...
function TcxLookupGridColumn.GetInternalDefaultRepositoryItem
...
function TcxLookupGridColumn.GetDefaultValuesProviderClass
...
procedure TcxLookupGridColumns.SetColumn(Index: Integer;
  Value: TcxLookupGridColumn);
begin
...
begin
  ...
  begin
    if Value then
      ...
      Grid.DataController.Options := Grid.DataController.Options -
        [dcoAnsiSort];
  end;
end;
...
begin
  ...
  if not PtInRect(ViewInfo.ClientBounds, P) then
    Exit;
  ...
  else if PtInRect(ViewInfo.RowsRect, P) then
  begin
...
begin
  ...
  if ARowCount <= 0 then
    ARowCount := 1
  else if ARowCount > GetRowCount then
...
function TcxCustomLookupGrid.GetPopupHeight(ADropDownRowCount: Integer)
  : Integer;
begin
...
begin
  ...
  begin
    ...
    else if ARowIndex > ViewInfo.Rows[ViewInfo.VisibleRowCount - 1].RowIndex
    then
...
procedure TcxCustomLookupGrid.MouseDown(Button: TMouseButton;
...
begin
  ...
  else if AHitInfo.HitTest = htCell then
  begin
...
procedure TcxCustomLookupGrid.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
var
  AHitInfo: TcxLookupGridHitInfo;
begin
...
begin
  SetScrollBarInfo(sbVertical, 0, ViewInfo.RowCount - 1 + ScrollBarOffsetBegin +
    ScrollBarOffsetEnd, 1, ViewInfo.VisibleRowCount, ScrollBarOffsetBegin +
    ViewInfo.TopRowIndex, True, True);
end;
...
procedure TcxCustomLookupGrid.ChangeScaleEx(M, D: Integer;
  isDpiChange: Boolean);
begin
  inherited;
...
procedure TcxCustomLookupGrid.CheckTopRowIndex(ATopRowIndex: Integer;
  ANotUpdate: Boolean);
var
...
function TcxCustomLookupGrid.GetDataControllerClass
...
procedure TcxCustomLookupGrid.DoCellClick(ARowIndex, AColumnIndex: Integer;
  AShift: TShiftState);
begin
  if ARowIndex <> -1 then
...
procedure TcxCustomLookupGrid.DoHeaderClick(AColumnIndex: Integer;
  AShift: TShiftState);
var
  ASortOrder: TcxDataSortOrder;
begin
  if not Options.ColumnSorting or (AColumnIndex = -1) or
    not Columns[AColumnIndex].Sorting then
    Exit;
  try
    BeginUpdate;
    try
...
procedure TcxCustomLookupGrid.LookAndFeelChanged(Sender: TcxLookAndFeel;
...
procedure TcxCustomLookupGrid.UpdateRowInfo(ARowIndex: Integer;
...
procedure TcxCustomLookupGrid.FocusedRowChanged(APrevFocusedRowIndex,
  AFocusedRowIndex: Integer);
begin
...
begin
  if AInfo is TcxDataChangedInfo then
    ...
    DataLayoutChanged
  else if AInfo is TcxFocusedRowChangedInfo then
...
begin
  ...
  else if P.Y > ViewInfo.VisibleRowsRect.Bottom then
