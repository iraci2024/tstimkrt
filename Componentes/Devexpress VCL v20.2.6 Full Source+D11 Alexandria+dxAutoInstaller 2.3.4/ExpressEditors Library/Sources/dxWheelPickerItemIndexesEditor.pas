...
uses
  Variants, Windows, Classes, Controls, Dialogs, ExtCtrls, Forms, Graphics,
  Messages, Menus, StdCtrls, SysUtils,
  cxButtons, cxContainer, cxControls, cxLookAndFeelPainters, cxGraphics,
  cxLookAndFeels, cxEdit, dxWheelPicker;
...
begin
  ...
  try
    if AWheelPicker.Owner <> nil then
      ...
      AOwnerCaption := '';
    AForm.Caption := Format('%s%s - Item indexes editor',
      [AOwnerCaption, AWheelPicker.Name]);
