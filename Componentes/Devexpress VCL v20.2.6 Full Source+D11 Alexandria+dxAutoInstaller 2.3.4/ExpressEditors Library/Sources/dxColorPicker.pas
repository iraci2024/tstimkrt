...
{$IFDEF DELPHI17}
  UITypes,
{$ENDIF}
  Types, Windows, Classes, Messages, Controls, Graphics, cxControls, cxGraphics,
  dxCoreClasses,
  dxGDIPlusClasses, dxGDIPlusAPI, cxLookAndFeelPainters, cxLookAndFeels, dxCore,
  dxCoreGraphics,
...
type
  ...
  public
    ...
    property HitObjectAsViewInfoCell: TdxColorPickerCustomViewInfoCell
      read GetHitObjectAsViewInfoCell;
  ...
  TdxColorPickerCustomViewInfoCellClass = class of
    TdxColorPickerCustomViewInfoCell;
  ...
  public
    ...
    procedure Draw(ACanvas: TcxCanvas);
    //
    property Items[AIndex: Integer]: TdxColorPickerCustomViewInfoCell
      read GetItem; default;
  end;

  { TdxColorPickerCustomContainerViewInfoCell }

  TdxColorPickerCustomContainerViewInfoCell = class
    (TdxColorPickerCustomViewInfoCell)
  private
    FCells: TdxColorPickerCustomViewInfoCells;
  protected
    procedure CreateCell(ACellClass
      : TdxColorPickerCustomViewInfoCellClass); overload;
    procedure CreateCell(ACellClass: TdxColorPickerCustomViewInfoCellClass;
      var ACell); overload;
  ...
  TdxColorPickerCustomColorModifierViewInfoCell = class
    (TdxColorPickerCustomViewInfoCell, IdxColorPickerChangeListener)
  private
  ...
  TdxColorPickerCustomVisualColorModifierViewInfoCell = class
    (TdxColorPickerCustomColorModifierViewInfoCell)
  private
  ...
  protected
    ...
    procedure UpdateContentCache(ACanvas: TcxCanvas; AWidth, AHeight: Integer);
  ...
  public
    ...
    property CursorPosition: TPoint read FCursorPosition
      write SetCursorPosition;
  end;

  { TdxColorPickerCustomGamutViewInfoCell }

  TdxColorPickerCustomGamutViewInfoCell = class
    (TdxColorPickerCustomVisualColorModifierViewInfoCell)
  protected
  ...
  TdxColorPickerCustomSliderViewInfoCell = class
    (TdxColorPickerCustomVisualColorModifierViewInfoCell)
  protected
    procedure DoDraw(ACanvas: TcxCanvas); override;
    function DoMeasureHeight: Integer; override;
  ...
  TdxColorPickerAlphaSliderViewInfoCell = class
    (TdxColorPickerCustomSliderViewInfoCell)
  protected
    function CalculateCursorPosition: TPoint; override;
    procedure UpdateContentCache(ACanvas: TcxCanvas; AWidth: Integer;
  ...
  TdxColorPickerGamutAndLightnessSliderStyleGamutViewInfoCell = class
    (TdxColorPickerCustomGamutViewInfoCell)
  protected
    function CalculateCursorPosition: TPoint; override;
    procedure UpdateContentCache(ACanvas: TcxCanvas; AWidth: Integer;
  ...
  TdxColorPickerGamutAndLightnessSliderStyleSliderViewInfoCell = class
    (TdxColorPickerCustomSliderViewInfoCell)
  protected
    function CalculateCursorPosition: TPoint; override;
    procedure UpdateContentCache(ACanvas: TcxCanvas; AWidth: Integer;
  ...
  TdxColorPickerGamutAndHueSliderStyleGamutViewInfoCell = class
    (TdxColorPickerCustomGamutViewInfoCell)
  protected
    function CalculateCursorPosition: TPoint; override;
  ...
  TdxColorPickerGamutAndHueSliderStyleSliderViewInfoCell = class
    (TdxColorPickerCustomSliderViewInfoCell)
  protected
    function CalculateCursorPosition: TPoint; override;
    procedure UpdateContentCache(ACanvas: TcxCanvas; AWidth: Integer;
  ...
  TdxColorPickerPreviewViewInfoCell = class
    (TdxColorPickerCustomColorModifierViewInfoCell)
  protected
    procedure DoDraw(ACanvas: TcxCanvas); override;
    function DoMeasureHeight: Integer; override;
  ...
  TdxColorPickerCustomEditViewInfoCell = class
    (TdxColorPickerCustomColorModifierViewInfoCell)
  private
  ...
  TdxColorPickerCustomEditBoxViewInfoCell = class
    (TdxColorPickerCustomContainerViewInfoCell)
  protected
    function DoMeasureHeight: Integer; override;
    function DoMeasureWidth: Integer; override;
  ...
  TdxColorPickerCustomSpinEditViewInfoCell = class
    (TdxColorPickerCustomEditViewInfoCell)
  private
  ...
  TdxColorPickerAlphaEditViewInfoCell = class
    (TdxColorPickerCustomSpinEditViewInfoCell)
  protected
  ...
  TdxColorPickerHueEditViewInfoCell = class
    (TdxColorPickerCustomSpinEditViewInfoCell)
  protected
    procedure EditValueChanged; override;
    function GetCaption: string; override;
  ...
  TdxColorPickerSaturationEditViewInfoCell = class
    (TdxColorPickerCustomSpinEditViewInfoCell)
  protected
    procedure EditValueChanged; override;
    function GetCaption: string; override;
  ...
  TdxColorPickerLightnessEditViewInfoCell = class
    (TdxColorPickerCustomSpinEditViewInfoCell)
  protected
    procedure EditValueChanged; override;
    function GetCaption: string; override;
  ...
  TdxColorPickerRedEditViewInfoCell = class
    (TdxColorPickerCustomSpinEditViewInfoCell)
  protected
    procedure EditValueChanged; override;
    function GetCaption: string; override;
  ...
  TdxColorPickerGreenEditViewInfoCell = class
    (TdxColorPickerCustomSpinEditViewInfoCell)
  protected
    procedure EditValueChanged; override;
    function GetCaption: string; override;
  ...
  TdxColorPickerBlueEditViewInfoCell = class
    (TdxColorPickerCustomSpinEditViewInfoCell)
  protected
    procedure EditValueChanged; override;
    function GetCaption: string; override;
  ...
  TdxColorPickerHSLEditViewInfoCell = class
    (TdxColorPickerCustomEditBoxViewInfoCell)
  protected
  ...
  TdxColorPickerRGBEditViewInfoCell = class
    (TdxColorPickerCustomEditBoxViewInfoCell)
  protected
    procedure CreateSubCells; override;
  end;
  ...
  TdxColorPickerRGBHexEditViewInfoCell = class
    (TdxColorPickerCustomEditViewInfoCell)
  private
  ...
  public
    ...
    procedure MouseUp(AButton: TMouseButton; AShift: TShiftState;
      X, Y: Integer); virtual;
    //
    property CapturedCell: TdxColorPickerCustomViewInfoCell read FCapturedCell
      write FCapturedCell;
  ...
  published
    property AllowEditAlpha: Boolean read FAllowEditAlpha
      write SetAllowEditAlpha default True;
    property RGBHexNotation: TdxColorPickerRGBHexNotation read FRGBHexNotation
      write SetRGBHexNotation default cphnHTML;
    property ShowHSLEditors: Boolean read FShowHSLEditors
      write SetShowHSLEditors default True;
    property ShowPreview: Boolean read FShowPreview write SetShowPreview
      default True;
    property ShowRGBEditors: Boolean read FShowRGBEditors
      write SetShowRGBEditors default True;
    property ShowRGBHexEditor: Boolean read FShowRGBHexEditor
      write SetShowRGBHexEditor default True;
    property Style: TdxColorPickerStyle read FStyle write SetStyle
      default cpsGamutAndLightnessSlider;
  end;
  ...
  protected
    ...
    property OptionsView: TdxColorPickerOptionsView read FOptionsView
...
begin
  ...
  begin
    FHSL := TdxColorSpaceConverter.ColorToHSL
      (dxAlphaColorToColor(AValue, FAlpha));
    Changed;
  end;
end;
...
function TdxColorPickerHitTest.GetHitObjectAsViewInfoCell
  : TdxColorPickerCustomViewInfoCell;
begin
...
constructor TdxColorPickerCustomViewInfoCell.Create
  (AControl: TdxCustomColorPicker);
begin
...
procedure TdxColorPickerCustomViewInfoCell.CalculateHitTest
  (AHitTest: TdxColorPickerHitTest);
begin
...
function TdxColorPickerCustomViewInfoCell.GetController
  : TdxColorPickerController;
begin
...
function TdxColorPickerCustomViewInfoCell.GetPainter
...
procedure TdxColorPickerCustomViewInfoCells.Add
...
procedure TdxColorPickerCustomViewInfoCells.CalculateHitTest
  (AHitTest: TdxColorPickerHitTest);
var
  I: Integer;
begin
...
function TdxColorPickerCustomViewInfoCells.GetItem(AIndex: Integer)
  : TdxColorPickerCustomViewInfoCell;
begin
...
constructor TdxColorPickerCustomContainerViewInfoCell.Create
  (AControl: TdxCustomColorPicker);
begin
  inherited Create(AControl);
...
procedure TdxColorPickerCustomContainerViewInfoCell.Calculate
  (AType: TdxChangeType);
begin
...
procedure TdxColorPickerCustomContainerViewInfoCell.CalculateHitTest
  (AHitTest: TdxColorPickerHitTest);
begin
...
procedure TdxColorPickerCustomContainerViewInfoCell.CreateCell
  (ACellClass: TdxColorPickerCustomViewInfoCellClass);
var
  ACell: TObject;
begin
...
procedure TdxColorPickerCustomContainerViewInfoCell.CreateCell
  (ACellClass: TdxColorPickerCustomViewInfoCellClass; var ACell);
var
...
constructor TdxColorPickerCustomColorModifierViewInfoCell.Create
  (AControl: TdxCustomColorPicker);
begin
  inherited Create(AControl);
...
procedure TdxColorPickerCustomColorModifierViewInfoCell.Calculate
  (AType: TdxChangeType);
begin
  inherited Calculate(AType);
  if AType >= ctMedium then
...
function TdxColorPickerCustomColorModifierViewInfoCell.GetColorInfo
  : TdxColorPickerColorInfo;
begin
...
procedure TdxColorPickerCustomVisualColorModifierViewInfoCell.Calculate
  (AType: TdxChangeType);
begin
  inherited Calculate(AType);
...
procedure TdxColorPickerCustomVisualColorModifierViewInfoCell.DoDraw
  (ACanvas: TcxCanvas);
begin
...
procedure TdxColorPickerCustomVisualColorModifierViewInfoCell.DrawContent
  (ACanvas: TcxCanvas);
begin
...
function TdxColorPickerCustomVisualColorModifierViewInfoCell.
  GetContentBounds: TRect;
begin
  Result := cxRectInflate(Bounds, -Painter.BorderSize);
end;

function TdxColorPickerCustomVisualColorModifierViewInfoCell.
  GetContentFrameRect: TRect;
begin
  Result := cxRectInflate(ContentBounds, Painter.BorderSize);
end;

function TdxColorPickerCustomVisualColorModifierViewInfoCell.
  GetCursorColor: TColor;
begin
  Result := clBlack;
end;

procedure TdxColorPickerCustomVisualColorModifierViewInfoCell.
  UpdateContentCache;
begin
  FlushContentCache;
  FContentCache := TcxBitmap32.CreateSize(cxRectWidth(ContentBounds),
    cxRectHeight(ContentBounds), True);
  UpdateContentCache(FContentCache.cxCanvas, FContentCache.Width,
    FContentCache.Height);
end;
...
procedure TdxColorPickerCustomVisualColorModifierViewInfoCell.SetCursorPosition
  (const AValue: TPoint);
begin
...
var
  R: TRect;
begin
  R := cxRectBounds(CursorPosition.X - AreaSize div 2,
  ...
  ACanvas.FillRect(cxRectSetWidth(cxRectCenterVertically(R, LineThin),
    LineWidth));
  ACanvas.FillRect(cxRectSetRight(cxRectCenterVertically(R, LineThin), R.Right,
    LineWidth));
  ACanvas.FillRect(cxRectSetHeight(cxRectCenterHorizontally(R, LineThin),
    LineWidth));
  ACanvas.FillRect(cxRectSetBottom(cxRectCenterHorizontally(R, LineThin),
    R.Bottom, LineWidth));
end;
...
begin
  Result := cxRectSetRight(Bounds, Bounds.Right,
    ScaleFactor.Apply(dxcpSliderArrowWidth));
  Result := cxRectSetHeight(Result,
    ScaleFactor.Apply(dxcpSliderArrowWidth) * 2 - 1);
...
begin
  ...
  Result := cxRectInflate(Result, 0, -ScaleFactor.Apply(dxcpSliderArrowWidth) +
    Painter.BorderSize);
  Result.Right := ArrowBounds.Left - ScaleFactor.Apply(cxTextOffset) -
    Painter.BorderSize;
end;
...
begin
  Result := Point(0, MulDiv(cxRectHeight(ContentBounds), ColorInfo.Alpha,
    MaxByte));
end;
...
procedure TdxColorPickerAlphaSliderViewInfoCell.UpdateContentCache
  (ACanvas: TcxCanvas; AWidth, AHeight: Integer);
begin
  cxDrawTransparencyCheckerboard(ACanvas, Rect(0, 0, AWidth, AHeight), 2);
  dxGpFillRectByGradient(ACanvas.Handle, Rect(0, 0, AWidth, AHeight), clNone,
    ColorInfo.Color, LinearGradientModeVertical, 0);
end;

{ TdxColorPickerGamutAndLightnessSliderStyleGamutViewInfoCell }

procedure TdxColorPickerGamutAndLightnessSliderStyleGamutViewInfoCell.DragMove
  (X, Y: Integer);
begin
...
function TdxColorPickerGamutAndLightnessSliderStyleGamutViewInfoCell.
  CalculateCursorPosition: TPoint;
begin
  Result := Point(Round(cxRectWidth(ContentBounds) * ColorInfo.H),
    Round(cxRectHeight(ContentBounds) * (1 - ColorInfo.S)));
end;

procedure TdxColorPickerGamutAndLightnessSliderStyleGamutViewInfoCell.
  UpdateContentCache(ACanvas: TcxCanvas; AWidth: Integer; AHeight: Integer);
var
  I: Integer;
begin
  for I := 0 to AWidth - 1 do
  begin
    dxGpFillRectByGradient(ACanvas.Handle, Rect(I, 0, I + 1, AHeight),
...
procedure TdxColorPickerGamutAndLightnessSliderStyleSliderViewInfoCell.DragMove
  (X, Y: Integer);
begin
  Y := Min(cxRectHeight(ContentBounds), Max(0, Y - ContentBounds.Top));
...
function TdxColorPickerGamutAndLightnessSliderStyleSliderViewInfoCell.
  CalculateCursorPosition: TPoint;
begin
  Result := Point(0, Round((1 - ColorInfo.L) * cxRectHeight(ContentBounds)));
end;

procedure TdxColorPickerGamutAndLightnessSliderStyleSliderViewInfoCell.
  UpdateContentCache(ACanvas: TcxCanvas; AWidth, AHeight: Integer);
var
  AColor: TColor;
begin
  AColor := TdxColorSpaceConverter.HSLToColor(ColorInfo.H, ColorInfo.S, 0.5);
  dxGpFillRectByGradient(ACanvas.Handle, Rect(0, 0, AWidth, AHeight div 2),
    clWhite, AColor, LinearGradientModeVertical);
  dxGpFillRectByGradient(ACanvas.Handle, Rect(0, AHeight div 2, AWidth,
    AHeight), AColor, clBlack, LinearGradientModeVertical);
end;

{ TdxColorPickerGamutAndHueSliderStyleGamutViewInfoCell }

procedure TdxColorPickerGamutAndHueSliderStyleGamutViewInfoCell.DragMove(X,
  Y: Integer);
begin
  X := Min(cxRectWidth(ContentBounds), Max(0, X - ContentBounds.Left));
  Y := Min(cxRectHeight(ContentBounds), Max(0, Y - ContentBounds.Top));
  ColorInfo.S := X / cxRectWidth(ContentBounds);
  ColorInfo.L := (1 - ColorInfo.S * 0.5) *
    (1 - Y / cxRectHeight(ContentBounds));
  CursorPosition := Point(X, Y);
end;

function TdxColorPickerGamutAndHueSliderStyleGamutViewInfoCell.
  CalculateCursorPosition: TPoint;
begin
  Result.X := Round(cxRectWidth(ContentBounds) * ColorInfo.S);
  Result.Y := Round(cxRectHeight(ContentBounds) *
    (1 - ColorInfo.L / (1 - ColorInfo.S * 0.5)));
end;
...
procedure TdxColorPickerGamutAndHueSliderStyleGamutViewInfoCell.
  UpdateContentCache(ACanvas: TcxCanvas; AWidth, AHeight: Integer);
var
  I: Integer;
begin
...
procedure TdxColorPickerGamutAndHueSliderStyleSliderViewInfoCell.DragMove(X,
  Y: Integer);
begin
  Y := Min(cxRectHeight(ContentBounds), Max(0, Y - ContentBounds.Top));
...
function TdxColorPickerGamutAndHueSliderStyleSliderViewInfoCell.
  CalculateCursorPosition: TPoint;
begin
  Result := Point(0, Round(ColorInfo.H * cxRectHeight(ContentBounds)));
end;

procedure TdxColorPickerGamutAndHueSliderStyleSliderViewInfoCell.
  UpdateContentCache(ACanvas: TcxCanvas; AWidth, AHeight: Integer);
var
  I: Integer;
begin
...
constructor TdxColorPickerPreviewViewInfoCell.Create
  (AControl: TdxCustomColorPicker);
begin
  inherited Create(AControl);
  Controller.ListenerAdd(Self);
...
begin
  ...
  dxGpFillRect(ACanvas.Handle, R, Controller.ColorInfo.Color,
    Controller.ColorInfo.Alpha);
end;
...
constructor TdxColorPickerCustomEditViewInfoCell.Create
  (AControl: TdxCustomColorPicker);
begin
  inherited Create(AControl);
...
function TdxColorPickerCustomEditViewInfoCell.CalculateTextFieldSize
  (ADigits: Integer): Integer;
const
  AllowedChars: array [0 .. 21] of Char = ('0', '1', '2', '3', '4', '5', '6',
...
begin
  ...
  begin
    ...
    try
      ...
      ACanvas.DrawTexT(Caption, CaptionRect, AlignMap[UseRightToLeftAlignment],
        vaCenter, False, False);
    finally
...
procedure TdxColorPickerCustomEditBoxViewInfoCell.CalculateSubCellsBounds
  (R: TRect);
var
  ACell: TdxColorPickerCustomViewInfoCell;
  I: Integer;
...
function TdxColorPickerCustomSpinEditViewInfoCell.GetEditClass
  : TcxCustomEditClass;
begin
  Result := TcxSpinEdit;
end;
...
procedure TdxColorPickerCustomSpinEditViewInfoCell.SetEditValue
  (AValue: Integer);
begin
  Edit.Value := AValue;
end;
...
begin
  ColorInfo.AlphaColor := TdxColorHelper.HexCodeToAlphaColor(Edit.EditingValue,
    HexNotation = cphnDelphi);
end;
...
const
  MaskMap: array [Boolean] of string = ('(\d | [A-F] | [a-f]){1,6}',
    '(\d | [A-F] | [a-f]){1,8}');
begin
  inherited InitializeEdit;
...
begin
  Edit.HandleNeeded;
  Result := CalculateTextFieldSize
    (6 + 2 * Ord(Control.OptionsView.AllowEditAlpha)) + cxTextOffset +
    cxRectWidth(TcxCustomEditAccess(Edit).ViewInfo.Bounds) -
    cxRectWidth(TcxCustomEditAccess(Edit).ViewInfo.InnerEditRect);
end;
...
begin
  ...
  begin
    Edit.EditValue := TdxColorHelper.AlphaColorToHexCode(ColorInfo.AlphaColor,
      HexNotation = cphnDelphi, Control.OptionsView.AllowEditAlpha);
  end;
end;
...
function TdxColorPickerRGBHexEditViewInfoCell.GetHexNotation
...
procedure TdxColorPickerViewInfo.CalculateSubCellsBounds(R: TRect);
  ...
  procedure PlaceSlider(ASlider: TdxColorPickerCustomSliderViewInfoCell;
    var R: TRect; AIndent: Integer);
  var
    R1: TRect;
  begin
    if ASlider <> nil then
    begin
      R1 := cxRectInflate(R, 0, ScaleFactor.Apply(dxcpSliderArrowWidth) -
        Painter.BorderSize);
      if UseRightToLeftAlignment then
      begin
...
procedure TdxColorPickerViewInfo.CalculateEditBoxes(var R: TRect);
  ...
  procedure CalculateEditBox(var R: TRect;
    AEdit: TdxColorPickerCustomViewInfoCell);
  begin
    if AEdit <> nil then
    begin
      AEdit.Bounds := cxRectSetHeight(R, AEdit.MeasureHeight);
      R.Top := AEdit.Bounds.Bottom + 2 * ScaleFactor.Apply
        (dxcpIndentBetweenElements);
    end;
  end;
...
begin
  ...
  begin
    ...
    ARect.Top := FPreview.Bounds.Bottom + 2 * ScaleFactor.Apply
      (dxcpIndentBetweenElements);
  end;
...
procedure TdxColorPickerViewInfo.CreateSubCells;
  ...
  procedure InternalCreateCell(AVisible: Boolean;
    ACellClass: TdxColorPickerCustomViewInfoCellClass; var ACell);
  begin
    if AVisible then
      CreateCell(ACellClass, ACell)
...
begin
  ...
  case OptionsView.Style of
    cpsGamutAndLightnessSlider:
      begin
        CreateCell
          (TdxColorPickerGamutAndLightnessSliderStyleGamutViewInfoCell, FGamut);
        CreateCell(TdxColorPickerGamutAndLightnessSliderStyleSliderViewInfoCell,
          FSlider1);
      end;
    ...
    cpsGamutAndHueSlider:
      begin
        CreateCell
          (TdxColorPickerGamutAndHueSliderStyleGamutViewInfoCell, FGamut);
        CreateCell(TdxColorPickerGamutAndHueSliderStyleSliderViewInfoCell,
          FSlider1);
      end;
  end;

  InternalCreateCell(OptionsView.AllowEditAlpha,
    TdxColorPickerAlphaSliderViewInfoCell, FSlider2);
  InternalCreateCell(OptionsView.ShowPreview, TdxColorPickerPreviewViewInfoCell,
    FPreview);
  InternalCreateCell(OptionsView.AllowEditAlpha and
    (OptionsView.ShowRGBEditors or OptionsView.ShowHSLEditors),
    TdxColorPickerAlphaEditViewInfoCell, FAlphaEdit);
  InternalCreateCell(OptionsView.ShowHSLEditors,
    TdxColorPickerHSLEditViewInfoCell, FHSLEditors);
  InternalCreateCell(OptionsView.ShowRGBEditors,
    TdxColorPickerRGBEditViewInfoCell, FRGBEditors);
  InternalCreateCell(OptionsView.ShowRGBHexEditor,
    TdxColorPickerRGBHexEditViewInfoCell, FRGBHexEdit);
end;
...
begin
  ...
  if FPreview <> nil then
    Inc(Result, GetEditBoxWidth + 2 * ScaleFactor.Apply
      (dxcpIndentBetweenElements));
  if FAlphaEdit <> nil then
    Inc(Result, FAlphaEdit.MeasureHeight + 2 *
      ScaleFactor.Apply(dxcpIndentBetweenElements));
  if FHSLEditors <> nil then
    Inc(Result, FHSLEditors.MeasureHeight + 2 *
      ScaleFactor.Apply(dxcpIndentBetweenElements));
  if FRGBEditors <> nil then
    Inc(Result, FRGBEditors.MeasureHeight + 2 *
      ScaleFactor.Apply(dxcpIndentBetweenElements));
  if FRGBHexEdit <> nil then
    Inc(Result, FRGBHexEdit.MeasureHeight + 2 *
      ScaleFactor.Apply(dxcpIndentBetweenElements));
  if FGamut <> nil then
...
begin
  ...
  if FSlider1 <> nil then
    Inc(Result, FSlider1.MeasureWidth + ScaleFactor.Apply
      (dxcpIndentBetweenElements));
  if FSlider2 <> nil then
    Inc(Result, FSlider2.MeasureWidth + ScaleFactor.Apply
      (dxcpIndentBetweenElements));
end;
...
procedure TdxColorPickerController.ListenerAdd
  (AListener: IdxColorPickerChangeListener);
begin
  FListeners.Add(AListener);
end;

procedure TdxColorPickerController.ListenerRemove
  (AListener: IdxColorPickerChangeListener);
begin
  FListeners.Remove(AListener);
end;

procedure TdxColorPickerController.MouseDown(AButton: TMouseButton;
...
procedure TdxColorPickerController.MouseMove(AShift: TShiftState;
  X, Y: Integer);
begin
  if CapturedCell <> nil then
    CapturedCell.DragMove(X, Y);
...
procedure TdxColorPickerController.MouseUp(AButton: TMouseButton;
  AShift: TShiftState; X, Y: Integer);
begin
  CapturedCell := nil;
...
procedure TdxColorPickerOptionsView.SetRGBHexNotation
  (AValue: TdxColorPickerRGBHexNotation);
begin
...
function TdxCustomColorPicker.CanAutoSize(var NewWidth,
...
function TdxCustomColorPicker.CanResize(var NewWidth,
  NewHeight: Integer): Boolean;
begin
  Result := True;
...
procedure TdxCustomColorPicker.DrawOpaqueBackground(ACanvas: TcxCanvas;
  const ARect: TRect);
begin
...
procedure TdxCustomColorPicker.LookAndFeelChanged(Sender: TcxLookAndFeel;
  AChangedValues: TcxLookAndFeelValues);
begin
  LayoutChanged(ctMedium);
end;

procedure TdxCustomColorPicker.MouseDown(Button: TMouseButton;
...
procedure TdxCustomColorPicker.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
...
procedure TdxCustomColorPicker.SetOptionsView
  (AValue: TdxColorPickerOptionsView);
begin
