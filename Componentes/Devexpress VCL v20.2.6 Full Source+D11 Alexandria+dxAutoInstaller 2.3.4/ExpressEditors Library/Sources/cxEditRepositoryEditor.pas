...
procedure RegisterEditRepositoryItem(AEditRepositoryItemClass
  : TcxEditRepositoryItemClass; const ADescription: string);
procedure UnRegisterEditRepositoryItem(AEditRepositoryItemClass
  : TcxEditRepositoryItemClass);
...
begin
  ...
  try
    ...
    for I := 0 to EditRepository.Count - 1 do
      LBItems.Items.AddObject(EditRepository.Items[I].Name,
        EditRepository.Items[I]);
  finally
...
procedure TcxEditRepositoryEditor.SelectionsChanged(const ASelection
