...
class function TdxDBDateTimeWheelPicker.GetPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TdxDateTimeWheelPickerProperties;
end;

class function TdxDBDateTimeWheelPicker.GetDataBindingClass
...
function TdxDBDateTimeWheelPicker.GetActiveProperties
...
function TdxDBDateTimeWheelPicker.GetProperties
  : TdxDateTimeWheelPickerProperties;
begin
...
procedure TdxDBDateTimeWheelPicker.SetProperties
