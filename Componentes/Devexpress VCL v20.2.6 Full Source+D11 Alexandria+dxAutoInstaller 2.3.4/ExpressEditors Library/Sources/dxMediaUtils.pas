...
const
  ...
  IID_IAMCopyCaptureFileProgress
    : TGUID = '{670D1D20-A068-11D0-B3F0-00AA003761C5}';
  IID_IPin: TGUID = '{56A86891-0Ad4-11CE-B03A-0020AF0BA770}';

  CLSID_VideoInputDeviceCategory
    : TGUID = '{860BB310-5D01-11d0-BD3B-00A0C911CE86}';
...
type
  ...
  IEnumFilters = interface(IUnknown)
    ...
    function Next(cFilters: ULONG; out ppFilter: IBaseFilter; pcFetched: PULONG)
      : HResult; stdcall;
  ...
  IFilterGraph = interface(IUnknown)
    ...
    function AddFilter(pFilter: IBaseFilter; pName: PWideChar)
      : HResult; stdcall;
  ...
  IFileSinkFilter = interface(IUnknown)
    ...
    function GetCurFile(out ppszFileName: PWideChar; pmt: PAMMediaType)
      : HResult; stdcall;
    function SetFileName(pszFileName: PWideChar; pmt: PAMMediaType)
      : HResult; stdcall;
  end;
  ...
  IPin = interface(IUnknown)
    ...
    function Connect(pReceivePin: IPin; const pmt: PAMMediaType)
      : HResult; stdcall;
  ...
  ICaptureGraphBuilder2 = interface(IUnknown)
    ...
    function SetOutputFileName(const pType: TGUID; lpstrFile: PWideChar;
      out ppf: IBaseFilter; out ppSink: IFileSinkFilter): HResult; stdcall;
    function FindInterface(pCategory, pType: PGUID; pf: IBaseFilter;
      const riid: TGUID; out ppint): HResult; stdcall;
    function RenderStream(pCategory, pType: PGUID; pSource: IUnknown;
      pIntermediate, pSink: IBaseFilter): HResult; stdcall;
    function ControlStream(pCategory, pType: PGUID; pFilter: IBaseFilter;
      pstart, pstop: PReferenceTime; wStartCookie, wStopCookie: WORD)
      : HResult; stdcall;
    function AllocCapFile(lpwstr: PWCHAR; dwlSize: Int64): HResult; stdcall;
    function CopyCaptureFile(lpwstrOld, lpwstrNew: PWCHAR;
      fAllowEscAbort: Integer; pCallback: IAMCopyCaptureFileProgress)
      : HResult; stdcall;
    function FindPin(pSource: IUnknown; pindir: TPinDirection;
      pCategory, pType: PGUID; fUnconnected: BOOL; num: Integer;
  ...
  ISampleGrabber = interface(IUnknown) // use IMediaSample instead
    ...
    function GetCurrentBuffer(var pBufferSize: Integer; pBuffer: Pointer)
      : HResult; stdcall;
    // other methods
  end;
  ...
  IMediaEvent = interface(IDispatch)
    ...
    function GetEvent(out lEventCode, lParam1, lParam2: Longint;
    ...
    function FreeEventParams(lEvCode, lParam1, lParam2: Longint)
      : HResult; stdcall;
  end;

  IMediaEventEx = interface(IMediaEvent)
    ['{56A868C0-0AD4-11CE-B03A-0020AF0BA770}']
    function SetNotifyWindow(hwnd: hwnd; lMsg, lInstanceData: Longint)
      : HResult; stdcall;
    // other methods
  end;
  ...
  IVideoWindow = interface(IDispatch)
    ...
    function put_BackgroundPalette(BackgroundPalette: Longint)
      : HResult; stdcall;
    function get_BackgroundPalette(out pBackgroundPalette: Longint)
      : HResult; stdcall;
    ...
    function NotifyOwnerMessage(hwnd: Longint; uMsg, wParam, lParam: Longint)
      : HResult; stdcall;
    function SetWindowPosition(Left, Top, Width, Height: Longint)
      : HResult; stdcall;
    // other methods
  end;
  ...
  IVMRWindowlessControl = interface(IUnknown)
    ...
    function GetNativeVideoSize(out lpWidth, lpHeight, lpARWidth,
      lpARHeight: Longint): HResult; stdcall;
    function GetMinIdealVideoSize(out lpWidth, lpHeight: Longint)
      : HResult; stdcall;
    function GetMaxIdealVideoSize(out lpWidth, lpHeight: Longint)
      : HResult; stdcall;
    function SetVideoPosition(lpSRCRect, lpDSTRect: PRect): HResult; stdcall;
    function GetVideoPosition(out lpSRCRect, lpDSTRect: TRect)
      : HResult; stdcall;
  ...
  IVMRFilterConfig = interface(IUnknown)
    ...
    function SetImageCompositor(lpVMRImgCompositor: IVMRImageCompositor)
      : HResult; stdcall;
  ...
  IAMStreamConfig = interface(IUnknown)
    ...
    function GetNumberOfCapabilities(out piCount, piSize: Integer)
      : HResult; stdcall;
    function GetStreamCaps(iIndex: Integer; out pmt: PAMMediaType; out pSCC)
      : HResult; stdcall;
  end;
