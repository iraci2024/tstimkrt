...
uses
  Windows, Classes, Dialogs, Controls, cxClasses, dxCoreGraphics, dxColorPicker,
...
const
  dxColorDialogDefaultBasicColors: TdxColorDialogBasicColors = ($FFFF8080,
    $FFFFFF80, $FF80FF80, $FF00FF80, $FF80FFFF, $FF0080FF, $FFFF80C0, $FFFF80FF,
    $FFFF0000, $FFFFFF00, $FF80FF00, $FF00FF40, $FF00FFFF, $FF0080C0, $FF8080C0,
    $FFFF00FF, $FF804040, $FFFF8040, $FF00FF00, $FF008080, $FF004080, $FF8080FF,
    $FF800040, $FFFF0080, $FF800000, $FFFF8000, $FF008000, $FF008040, $FF0000FF,
    $FF0000A0, $FF800080, $FF8000FF, $FF400000, $FF804000, $FF004000, $FF004040,
    $FF000080, $FF000040, $FF400040, $FF400080, $FF000000, $FF808000, $FF808040,
    $FF808080, $FF408080, $FFC0C0C0, $FF400040, $FFFFFFFF);
...
type
  ...
  published
    property AllowEditColor: Boolean read FAllowEditColor write FAllowEditColor
      default True;
    property ColorPicker: TdxColorDialogColorPickerOptions read FColorPicker
  ...
  public
    class procedure LoadCustomColors(AList: TStrings;
      out ACustomColors: TdxColorDialogCustomColors);
    class procedure SaveCustomColors(AList: TStrings;
      const ACustomColors: TdxColorDialogCustomColors; AAllowAlpha: Boolean);
  end;

  { TdxCustomColorDialog }

  TdxColorDialogGetBasicColorsEvent = procedure(Sender: TObject;
    var BasicColors: TdxColorDialogBasicColors) of object;

  TdxCustomColorDialog = class(TcxCustomComponent, IcxLookAndFeelContainer,
    IdxSkinSupport)
  private
  ...
  protected
    ...
    procedure DoGetBasicColors(var ABasicColors
      : TdxColorDialogBasicColors); virtual;
    ...
    property OnGetBasicColors: TdxColorDialogGetBasicColorsEvent
      read FOnGetBasicColors write FOnGetBasicColors;
...
function TdxColorDialogOptions.CreateColorPicker
  : TdxColorDialogColorPickerOptions;
begin
...
procedure TdxColorDialogOptions.SetColorPicker
  (AValue: TdxColorDialogColorPickerOptions);
begin
...
class procedure TdxColorDialogHelper.LoadCustomColors(AList: TStrings;
  out ACustomColors: TdxColorDialogCustomColors);
var
  AValue: string;
  I: Integer;
    ...
    for I := 0 to Length(ACustomColors) - 1 do
      ...
      begin
        AList.Values[sdxCustomColorPrefix + Char(Ord('A') + I)] :=
          TdxColorHelper.AlphaColorToHexCode(ACustomColors[I], True,
          AAllowAlpha);
      end;
  finally
    AList.EndUpdate;
    ...
    try
      ...
      try
        ...
        begin
          ...
          TdxColorDialogHelper.SaveCustomColors(CustomColors, ACustomColors,
            Options.ColorPicker.AllowEditAlpha);
        end;
      finally
        DoClose;
      end;
...
procedure TdxCustomColorDialog.DoGetBasicColors(var ABasicColors
