...
class function TcxEditRepositoryShellComboBoxItem.GetEditPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TcxShellComboBoxProperties;
end;

function TcxEditRepositoryShellComboBoxItem.GetProperties
  : TcxShellComboBoxProperties;
begin
  Result := TcxShellComboBoxProperties(inherited Properties);
end;

procedure TcxEditRepositoryShellComboBoxItem.SetProperties
  (Value: TcxShellComboBoxProperties);
begin
