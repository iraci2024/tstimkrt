...
uses
  ...
  cxContainer, cxDataUtils, cxEdit, cxTreeView, cxShellListView, cxShellCommon,
  cxShellControls;
...
type
  ...
  private
    ...
    procedure TVMEnsureVisible(var Message: TMessage);
  ...
  TcxCustomShellTreeView = class(TcxTreeViewContainer, IcxShellDependedControls,
    IcxShellRoot)
  private
  ...
  protected
    ...
    property ShellListView: TcxCustomShellListView read GetShellListView
      write SetShellListView;
    property ShowInfoTips: Boolean read GetShowInfoTips write SetShowInfoTips
      default False;
    property TreeHotTrack: Boolean read GetTreeHotTrack write SetTreeHotTrack
      default False;
    ...
    property OnCollapsing: TTVCollapsingEvent read FOnCollapsing
      write FOnCollapsing;
    ...
    property OnExpanding: TTVExpandingEvent read FOnExpanding
      write FOnExpanding;
...
function TcxCustomShellTreeView.GetNodeAbsolutePIDL(ANode: TTreeNode)
  : PItemIDList;
var
...
function TcxCustomShellTreeView.GetViewOptions(AForNavigation: Boolean = False)
  : TcxShellViewOptions;
begin
  with InnerTreeView do
  begin
...
procedure TcxCustomShellTreeView.ChangeHandler(Sender: TObject;
  Node: TTreeNode);
begin
  try
...
procedure TcxCustomShellTreeView.ChangingHandler(Sender: TObject;
...
procedure TcxCustomShellTreeView.EditedHandler(Sender: TObject; Node: TTreeNode;
  var S: string);
begin
  try
...
procedure TcxCustomShellTreeView.EditingHandler(Sender: TObject;
...
procedure TcxCustomShellTreeView.SetDragDropSettings
...
procedure TcxCustomShellTreeView.SetShellListView
