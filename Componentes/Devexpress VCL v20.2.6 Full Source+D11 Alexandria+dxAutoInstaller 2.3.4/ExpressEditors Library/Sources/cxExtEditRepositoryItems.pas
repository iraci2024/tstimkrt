...
type
  ...
  public
    class function GetEditPropertiesClass
      : TcxCustomEditPropertiesClass; override;
  published
    property Properties: TdxColorEditProperties read GetProperties
      write SetProperties;
  end;
...
class function TcxEditRepositoryLabel.GetEditPropertiesClass
...
class function TcxEditRepositoryProgressBar.GetEditPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
procedure TcxEditRepositoryProgressBar.SetProperties
...
class function TcxEditRepositoryFontNameComboBox.GetEditPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TcxFontNameComboBoxProperties;
end;

function TcxEditRepositoryFontNameComboBox.GetProperties
  : TcxFontNameComboBoxProperties;
begin
  Result := inherited Properties as TcxFontNameComboBoxProperties;
end;

procedure TcxEditRepositoryFontNameComboBox.SetProperties
...
class function TcxEditRepositoryColorComboBox.GetEditPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TcxColorComboBoxProperties;
end;

function TcxEditRepositoryColorComboBox.GetProperties
  : TcxColorComboBoxProperties;
begin
  Result := inherited Properties as TcxColorComboBoxProperties;
end;

procedure TcxEditRepositoryColorComboBox.SetProperties
  (Value: TcxColorComboBoxProperties);
begin
  inherited Properties := Value;
end;
...
class function TcxEditRepositoryColorEdit.GetEditPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
procedure TcxEditRepositoryColorEdit.SetProperties
  (Value: TdxColorEditProperties);
begin
  inherited Properties := Value;
end;
...
class function TcxEditRepositoryTrackBar.GetEditPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
class function TcxEditRepositoryRangeTrackBar.GetEditPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TdxRangeTrackBarProperties;
end;

function TcxEditRepositoryRangeTrackBar.GetProperties
...
class function TcxEditRepositoryCheckComboBox.GetEditPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TcxCheckComboBoxProperties;
end;

function TcxEditRepositoryCheckComboBox.GetProperties
  : TcxCheckComboBoxProperties;
begin
  Result := inherited Properties as TcxCheckComboBoxProperties;
end;

procedure TcxEditRepositoryCheckComboBox.SetProperties
  (Value: TcxCheckComboBoxProperties);
begin
  inherited Properties := Value;
end;
...
class function TcxEditRepositoryCheckGroupItem.GetEditPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
class function TcxEditRepositoryRichItem.GetEditPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
class function TcxEditRepositoryRatingControl.GetEditPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TdxRatingControlProperties;
end;

function TcxEditRepositoryRatingControl.GetProperties
  : TdxRatingControlProperties;
begin
  Result := inherited Properties as TdxRatingControlProperties;
end;

procedure TcxEditRepositoryRatingControl.SetProperties
  (Value: TdxRatingControlProperties);
begin
  inherited Properties := Value;
end;
...
RegisterClasses([TcxEditRepositoryLabel, TcxEditRepositoryProgressBar,
  ...
  TcxEditRepositoryColorEdit, TcxEditRepositoryTrackBar,
  TcxEditRepositoryCheckComboBox, TcxEditRepositoryCheckGroupItem,
  TcxEditRepositoryRichItem, TcxEditRepositoryRatingControl,
  TcxEditRepositoryRangeTrackBar]);
