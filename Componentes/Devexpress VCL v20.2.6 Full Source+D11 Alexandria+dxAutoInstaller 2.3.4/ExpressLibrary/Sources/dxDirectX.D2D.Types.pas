...
{$EXTERNALSYM DXGI_USAGE}
  ...
  TDXGIModeRotation = (DXGI_MODE_ROTATION_UNSPECIFIED = 0,
  ...
  TDXGIModeScanlineOrder = (DXGI_MODE_SCANLINE_ORDER_UNSPECIFIED = 0,
    DXGI_MODE_SCANLINE_ORDER_PROGRESSIVE = 1,
    DXGI_MODE_SCANLINE_ORDER_UPPER_FIELD_FIRST = 2,
    DXGI_MODE_SCANLINE_ORDER_LOWER_FIELD_FIRST = 3);

  TDXGIModeScaling = (DXGI_MODE_SCALING_UNSPECIFIED = 0,
    DXGI_MODE_SCALING_CENTERED = 1, DXGI_MODE_SCALING_STRETCHED = 2);
  ...
  TDXGIResidency = (DXGI_RESIDENCY_FULLY_RESIDENT = 1,
    DXGI_RESIDENCY_RESIDENT_IN_SHARED_MEMORY = 2,
    DXGI_RESIDENCY_EVICTED_TO_DISK = 3);

  TDXGISwapEffect = (DXGI_SWAP_EFFECT_DISCARD = 0,
    DXGI_SWAP_EFFECT_SEQUENTIAL = 1, DXGI_SWAP_EFFECT_FLIP_SEQUENTIAL = 3,
...
type
  ...
  TDXGIScaling = (DXGI_SCALING_STRETCH = 0, DXGI_SCALING_NONE = 1,
    DXGI_SCALING_ASPECT_RATIO_STRETCH = 2);

  TDXGIAlphaMode = (DXGI_ALPHA_MODE_UNSPECIFIED = 0,
    DXGI_ALPHA_MODE_PREMULTIPLIED = 1, DXGI_ALPHA_MODE_STRAIGHT = 2,
  ...
  IDXGIObject = interface(IUnknown)
    ...
    function SetPrivateData(const Name: TGUID; DataSize: UINT; pData: Pointer)
      : HResult; stdcall;
    function SetPrivateDataInterface(const Name: TGUID;
      const pUnknown: IUnknown): HResult; stdcall;
    function GetPrivateData(const Name: TGUID; var pDataSize: UINT;
      pData: Pointer): HResult; stdcall;
    function GetParent(const riid: TIID; out ppParent { IUnknown } )
      : HResult; stdcall;
  end;

  IDXGIDeviceSubObject = interface(IDXGIObject)
    ['{3d3e0379-f9de-4d58-bb6c-18d62992f1a6}']
    function GetDevice(const riid: TIID; out ppDevice { IUnknown } )
      : HResult; stdcall;
  end;
  ...
  IDXGISurface = interface(IDXGIDeviceSubObject)
    ...
    function Map(out pLockedRect: TDXGIMappedRect; MapFlags: UINT)
      : HResult; stdcall;
  ...
  IDXGIOutput = interface(IDXGIObject)
    ...
    function GetDisplayModeList(EnumFormat: DXGI_FORMAT; Flags: UINT;
      var pNumModes: UINT; pDesc: PDXGIModeDesc): HResult; stdcall;
    function FindClosestMatchingMode(const pModeToMatch: TDXGIModeDesc;
      out pClosestMatch: TDXGIModeDesc; const pConcernedDevice: IUnknown)
      : HResult; stdcall;
    function WaitForVBlank: HResult; stdcall;
    function TakeOwnership(const pDevice: IUnknown; Exclusive: BOOL)
      : HResult; stdcall;
    function ReleaseOwnership: HResult; stdcall;
    function GetGammaControlCapabilities(out pGammaCaps
      : TDXGIGammaControlCapabilities): HResult; stdcall;
    ...
    function SetDisplaySurface(const pScanoutSurface: IDXGISurface)
      : HResult; stdcall;
    function GetDisplaySurfaceData(const pDestination: IDXGISurface)
      : HResult; stdcall;
    function GetFrameStatistics(out pStats: TDXGIFrameStatistics)
      : HResult; stdcall;
  end;

  IDXGIAdapter = interface(IDXGIObject)
    ['{2411e7e1-12ac-4ccf-bd14-9798e8534dc0}']
    function EnumOutputs(Output: UINT; out ppOutput: IDXGIOutput)
      : HResult; stdcall;
  ...
  IDXGIDevice = interface(IDXGIObject)
    ...
    function CreateSurface(const pDesc: TDXGISurfaceDesc; NumSurfaces: UINT;
      Usage: TDXGIUsage; const pSharedResource: TDXGISharedResource;
      out ppSurface: IDXGISurface): HResult; stdcall;
    function QueryResourceResidency(const ppResources: PIUnknown;
      out pResidencyStatus: PDXGIResidency; NumResources: UINT)
      : HResult; stdcall;
  ...
  IDXGISwapChain = interface(IDXGIDeviceSubObject)
    ...
    function GetBuffer(Buffer: UINT; const riid: TGUID; out ppSurface)
      : HResult; stdcall;
    function SetFullscreenState(Fullscreen: LongBool; pTarget: IDXGIOutput)
      : HResult; stdcall;
    function GetFullscreenState(out pFullscreen: LongBool;
      out ppTarget: IDXGIOutput): HResult; stdcall;
    function GetDesc(out pDesc: TDXGISwapChainDesc): HResult; stdcall;
    function ResizeBuffers(BufferCount: UINT; Width: UINT; Height: UINT;
      NewFormat: DXGI_FORMAT; SwapChainFlags: UINT): HResult; stdcall;
    function ResizeTarget(const pNewTargetParameters: PDXGIModeDesc)
      : HResult; stdcall;
  ...
  IDXGISwapChain1 = interface(IDXGISwapChain)
    ...
    function GetFullscreenDesc(out pDesc: TDXGISwapChainFullscreenDesc)
      : HResult; stdcall;
    ...
    function Present1(SyncInterval: UINT; PresentFlags: UINT;
      pPresentParameters: PDXGIPresentParameters): HResult; stdcall;
    function IsTemporaryMonoSupported: LongBool; stdcall;
    function GetRestrictToOutput(out ppRestrictToOutput: IDXGIOutput)
      : HResult; stdcall;
  ...
  IDXGIFactory = interface(IDXGIObject)
    ...
    function EnumAdapters(Adapter: UINT; out ppAdapter: IDXGIAdapter)
      : HResult; stdcall;
    function MakeWindowAssociation(WindowHandle: HWND; Flags: UINT)
      : HResult; stdcall;
    function GetWindowAssociation(out pWindowHandle: HWND): HResult; stdcall;
    function CreateSwapChain(pDevice: IUnknown; pDesc: PDXGISwapChainDesc;
      out ppSwapChain: IDXGISwapChain): HResult; stdcall;
    function CreateSoftwareAdapter(Module: HMODULE; out ppAdapter: IDXGIAdapter)
      : HResult; stdcall;
  end;
  ...
  IDXGIFactory1 = interface(IDXGIFactory)
    ...
    function EnumAdapters1(Adapter: UINT; out ppAdapter: IDXGIAdapter1)
      : HResult; stdcall;
  ...
  IDXGIFactory2 = interface(IDXGIFactory1)
    ...
    function CreateSwapChainForHwnd(pDevice: IUnknown; HWND: HWND;
      pDesc: PDXGISwapChainDesc1; pFullscreenDesc: PDXGISwapChainFullscreenDesc;
      pRestrictToOutput: IDXGIOutput; out ppSwapChain: IDXGISwapChain1)
      : HResult; stdcall;
    function CreateSwapChainForCoreWindow(pDevice: IUnknown; pWindow: IUnknown;
      pDesc: PDXGISwapChainDesc1; pRestrictToOutput: IDXGIOutput;
      out ppSwapChain: IDXGISwapChain1): HResult; stdcall;
    function GetSharedResourceAdapterLuid(hResource: THandle; out pLuid: TLUID)
      : HResult; stdcall;

    function RegisterStereoStatusWindow(WindowHandle: HWND; wMsg: UINT;
      out pdwCookie: DWORD): HResult; stdcall;
    function RegisterStereoStatusEvent(hEvent: THandle; out pdwCookie: DWORD)
      : HResult; stdcall;
    procedure UnregisterStereoStatus(dwCookie: DWORD); stdcall;
    function RegisterOcclusionStatusWindow(WindowHandle: HWND; wMsg: UINT;
      out pdwCookie: DWORD): HResult; stdcall;
    function RegisterOcclusionStatusEvent(hEvent: THandle; out pdwCookie: DWORD)
      : HResult; stdcall;
...
type
  TD2D1ColorSpace = (D2D1_COLOR_SPACE_CUSTOM = 0, D2D1_COLOR_SPACE_SRGB = 1,
  ...
  TD2D1PropertyType = (D2D1_PROPERTY_TYPE_UNKNOWN = 0,
    D2D1_PROPERTY_TYPE_STRING = 1, D2D1_PROPERTY_TYPE_BOOL = 2,
    D2D1_PROPERTY_TYPE_UINT32 = 3, D2D1_PROPERTY_TYPE_INT32 = 4,
    D2D1_PROPERTY_TYPE_FLOAT = 5, D2D1_PROPERTY_TYPE_VECTOR2 = 6,
    D2D1_PROPERTY_TYPE_VECTOR3 = 7, D2D1_PROPERTY_TYPE_VECTOR4 = 8,
    D2D1_PROPERTY_TYPE_BLOB = 9, D2D1_PROPERTY_TYPE_IUNKNOWN = 10,
    D2D1_PROPERTY_TYPE_ENUM = 11, D2D1_PROPERTY_TYPE_ARRAY = 12,
    D2D1_PROPERTY_TYPE_CLSID = 13, D2D1_PROPERTY_TYPE_MATRIX_3X2 = 14,
    D2D1_PROPERTY_TYPE_MATRIX_4X3 = 15, D2D1_PROPERTY_TYPE_MATRIX_4X4 = 16,
    D2D1_PROPERTY_TYPE_MATRIX_5X4 = 17, D2D1_PROPERTY_TYPE_COLOR_CONTEXT = 18);
...
type
  TD2D1BufferPrecision = (D2D1_BUFFER_PRECISION_UNKNOWN = 0,
  ...
  TD2D1ColorInterpolationMode = (D2D1_COLOR_INTERPOLATION_MODE_STRAIGHT = 0,
    D2D1_COLOR_INTERPOLATION_MODE_PREMULTIPLIED = 1);

  TD2D1MapOptions = (D2D1_MAP_OPTIONS_NONE = 0, D2D1_MAP_OPTIONS_READ = 1,
    D2D1_MAP_OPTIONS_WRITE = 2, D2D1_MAP_OPTIONS_DISCARD = 4);

  TD2D1InterpolationMode = (D2D1_INTERPOLATION_MODE_NEAREST_NEIGHBOR =
  ...
  TD2D1PrimitiveBlend = (D2D1_PRIMITIVE_BLEND_SOURCE_OVER = 0,
    D2D1_PRIMITIVE_BLEND_COPY = 1, D2D1_PRIMITIVE_BLEND_MIN = 2,
    D2D1_PRIMITIVE_BLEND_ADD = 3, D2D1_PRIMITIVE_BLEND_MAX = 4);

  TD2D1CompositeMode = (D2D1_COMPOSITE_MODE_SOURCE_OVER = 0,
    D2D1_COMPOSITE_MODE_DESTINATION_OVER = 1, D2D1_COMPOSITE_MODE_SOURCE_IN = 2,
    D2D1_COMPOSITE_MODE_DESTINATION_IN = 3, D2D1_COMPOSITE_MODE_SOURCE_OUT = 4,
    D2D1_COMPOSITE_MODE_DESTINATION_OUT = 5,
    D2D1_COMPOSITE_MODE_SOURCE_ATOP = 6,
    D2D1_COMPOSITE_MODE_DESTINATION_ATOP = 7, D2D1_COMPOSITE_MODE_XOR = 8,
    D2D1_COMPOSITE_MODE_PLUS = 9, D2D1_COMPOSITE_MODE_SOURCE_COPY = 10,
    D2D1_COMPOSITE_MODE_BOUNDED_SOURCE_COPY = 11,
    D2D1_COMPOSITE_MODE_MASK_INVERT = 12);

  TD2D1DeviceContextOptions = (D2D1_DEVICE_CONTEXT_OPTIONS_NONE = 0,
    D2D1_DEVICE_CONTEXT_OPTIONS_ENABLE_MULTITHREADED_OPTIMIZATIONS = 1);

  TD2D1UnitMode = (D2D1_UNIT_MODE_DIPS = 0, D2D1_UNIT_MODE_PIXELS = 1);
  ...
  TD2D1StrokeTransformType = (D2D1_STROKE_TRANSFORM_TYPE_NORMAL = 0,
  ...
  TD2D1PropertySetFunc = function(effect: IUnknown; Data: PByte;
    DataSize: UINT32): HResult; stdcall;
  TD2D1PropertyGetFunc = function(effect: IUnknown; out Data: PByte;
    DataSize: UINT32; out actualSize: UINT32): HResult; stdcall;
  ...
  ID2D1ColorContext = interface(ID2D1Resource)
    ...
    function GetProfile(out profile: PByte; profileSize: UINT32)
      : HResult; stdcall;
  end;
  ...
  ID2D1Bitmap = interface(ID2D1Image)
    ...
    function CopyFromBitmap(const destPoint: PD2D1Point2U; bitmap: ID2D1Bitmap;
      const srcRect: PD2D1RectU): HResult; stdcall;
    function CopyFromRenderTarget(const destPoint: PD2D1Point2U;
      renderTarget: ID2D1RenderTarget; const srcRect: PD2D1RectU)
      : HResult; stdcall;
    function CopyFromMemory(const dstRect: PD2D1RectU; srcData: Pointer;
      Pitch: UINT32): HResult; stdcall;
  end;
  ...
  ID2D1Bitmap1 = interface(ID2D1Bitmap)
    ...
    function Map(options: TD2D1MapOptions; out mappedRect: TD2D1MappedRect)
      : HResult; stdcall;
    function Unmap: HResult; stdcall;
  end;
  ...
  ID2D1Properties = interface(IUnknown)
    ...
    function GetPropertyName(index: UINT32; out Name: PWideChar;
    ...
    function SetValueByName(Name: PWideChar; _type: TD2D1PropertyType;
      Data: PByte; DataSize: UINT32): HResult; stdcall;
    function SetValue(index: UINT32; _type: TD2D1PropertyType; Data: PByte;
      DataSize: UINT32): HResult; stdcall;
    function GetValueByName(Name: PWideChar; _type: TD2D1PropertyType;
      out Data: PByte; DataSize: UINT32): HResult; stdcall;
    function GetValue(index: UINT32; _type: TD2D1PropertyType; out Data: PByte;
      DataSize: UINT32): HResult; stdcall;
    function GetValueSize(index: UINT32): UINT32; stdcall;
    function GetSubProperties(index: UINT32; out subProperties: ID2D1Properties)
      : HResult; stdcall;
  end;

  ID2D1Effect = interface(ID2D1Properties)
    ['{28211a43-7d89-476f-8181-2d6159b220ad}']
    procedure SetInput(index: UINT32; input: ID2D1Image;
      invalidate: LongBool = True); stdcall;
  ...
  ID2D1GradientStopCollection1 = interface(ID2D1GradientStopCollection)
    ...
    procedure GetGradientStops1(out gradientStops: PD2D1GradientStop;
  ...
  ID2D1ImageBrush = interface(ID2D1Brush)
    ...
    procedure SetInterpolationMode(interpolationMode
      : TD2D1InterpolationMode); stdcall;
  ...
  ID2D1BitmapBrush1 = interface(ID2D1BitmapBrush)
    ...
    procedure SetInterpolationMode1(interpolationMode
      : TD2D1InterpolationMode); stdcall;
  ...
  ID2D1Device = interface(ID2D1Resource)
    ...
    function CreateDeviceContext(options: TD2D1DeviceContextOptions;
      out deviceContext: ID2D1DeviceContext): HResult; stdcall;
    function CreatePrintControl(wicFactory: IWICImagingFactory;
      documentTarget: { IPrintDocumentPackageTarget } IUnknown;
      printControlProperties: Pointer { PD2D1_PRINT_CONTROL_PROPERTIES };
      out printControl: IUnknown { ID2D1PrintControl } ): HResult; stdcall;
  ...
  ID2D1DeviceContext = interface(ID2D1RenderTarget)
    ...
    function CreateBitmap(size: TD2D1SizeU; sourceData: Pointer; Pitch: UINT32;
      bitmapProperties: PD2D1BitmapProperties1; out bitmap: ID2D1Bitmap1)
      : HResult; stdcall;
    ...
    function CreateColorContext(space: TD2D1ColorSpace; profile: PByte;
      profileSize: UINT32; out colorContext: ID2D1ColorContext)
      : HResult; stdcall;
    function CreateColorContextFromFilename(filename: PWideChar;
      out colorContext: ID2D1ColorContext): HResult; stdcall;
    function CreateColorContextFromWicColorContext(wicColorContext
      : IWICColorContext; out colorContext: ID2D1ColorContext)
      : HResult; stdcall;
    function CreateBitmapFromDxgiSurface(surface: IDXGISurface;
      const bitmapProperties: TD2D1BitmapProperties1; out bitmap: ID2D1Bitmap1)
      : HResult; stdcall;
    function CreateEffect(const effectId: TGUID; out effect: ID2D1Effect)
      : HResult; stdcall;
    function CreateGradientStopCollection2(straightAlphaGradientStops
      : PD2D1GradientStop; straightAlphaGradientStopsCount: UINT32;
      preInterpolationSpace: TD2D1ColorSpace;
      postInterpolationSpace: TD2D1ColorSpace;
      bufferPrecision: TD2D1BufferPrecision; extendMode: TD2D1ExtendMode;
    ...
    function CreateImageBrush(image: ID2D1Image;
      imageBrushProperties: PD2D1ImageBrushProperties;
      brushProperties: PD2D1BrushProperties; out imageBrush: ID2D1ImageBrush)
      : HResult; stdcall;
    function CreateBitmapBrush(bitmap: ID2D1Bitmap;
      bitmapBrushProperties: PD2D1BitmapBrushProperties1;
      brushProperties: PD2D1BrushProperties; out bitmapBrush: ID2D1BitmapBrush1)
      : HResult; stdcall;
    function CreateCommandList(out commandList: IUnknown { ID2D1CommandList } )
      : HResult; stdcall;
    function IsDxgiFormatSupported(Format: DXGI_FORMAT): LongBool; stdcall;
    function IsBufferPrecisionSupported(bufferPrecision: TD2D1BufferPrecision)
      : LongBool; stdcall;
    function GetImageLocalBounds(image: ID2D1Image; out localBounds: TD2D1RectF)
      : HResult; stdcall;
    function GetImageWorldBounds(image: ID2D1Image; out worldBounds: TD2D1RectF)
      : HResult; stdcall;
    ...
    procedure SetRenderingControls(renderingControls
      : PD2D1RenderingControls); stdcall;
    procedure GetRenderingControls(out renderingControls
      : TD2D1RenderingControls); stdcall;
    ...
    procedure DrawGlyphRun(baselineOrigin: TD2D1Point2F;
      ...
      DWRITE_MEASURING_MODE_NATURAL); stdcall;
    procedure DrawImage(image: ID2D1Image; targetOffset: PD2D1Point2F = nil;
      imageRectangle: PD2D1RectF = nil;
      interpolationMode: TD2D1InterpolationMode =
      D2D1_INTERPOLATION_MODE_LINEAR;
      compositeMode: TD2D1CompositeMode =
      D2D1_COMPOSITE_MODE_SOURCE_OVER); stdcall;
    procedure DrawGdiMetafile(gdiMetafile: IUnknown { ID2D1GdiMetafile };
      targetOffset: PD2D1Point2F = nil); stdcall;
    procedure DrawBitmap(bitmap: ID2D1Bitmap; destinationRectangle: PD2D1RectF;
      opacity: Single; interpolationMode: TD2D1InterpolationMode;
      sourceRectangle: PD2D1RectF = nil;
      perspectiveTransform: Pointer { PD2D1_MATRIX_4X4_F } = nil); stdcall;
    procedure PushLayer(layerParameters: PD2D1LayerParameters1;
      layer: ID2D1Layer); stdcall;
    function InvalidateEffectInputRectangle(effect: ID2D1Effect; input: UINT32;
      inputRectangle: PD2D1RectF): HResult; stdcall;
    ...
    function GetEffectInvalidRectangles(effect: ID2D1Effect;
      out rectangles: PD2D1RectF; rectanglesCount: UINT32): HResult; stdcall;
    function GetEffectRequiredInputRectangles(renderEffect: ID2D1Effect;
      ...
      out requiredInputRects: PD2D1RectF; inputCount: UINT32): HResult; stdcall;
  ...
  ID2D1PathGeometry1 = interface(ID2D1PathGeometry)
    ...
    function ComputePointAndSegmentAtLength(length: Single;
      startSegment: UINT32; worldTransform: PD2D1Matrix3x2F;
      flatteningTolerance: Single; out pointDescription: TD2D1PointDescription)
      : HResult; stdcall;
  end;

  ID2D1DrawingStateBlock1 = interface(ID2D1DrawingStateBlock)
    ['{689f1f85-c72e-4e33-8f19-85754efd5ace}']
    procedure GetDescription(out stateDescription
      : TD2D1DrawingStateDescription1); stdcall;
    procedure SetDescription(stateDescription
      : PD2D1DrawingStateDescription1); stdcall;
  end;

  TD2D1EffectFactoryCallback = function(out effectImpl: IUnknown): HResult;
    stdcall; // callback

  ID2D1Factory1 = interface(ID2D1Factory)
    [SID_ID2D1Factory1]
    function CreateDevice(dxgiDevice: IDXGIDevice; out d2dDevice: ID2D1Device)
      : HResult; stdcall;
    function CreateStrokeStyle(strokeStyleProperties
      : PD2D1StrokeStyleProperties1; dashes: Psingle; dashesCount: UINT32;
      out strokeStyle: ID2D1StrokeStyle1): HResult; stdcall;
    function CreatePathGeometry(out pathGeometry: ID2D1PathGeometry1)
      : HResult; stdcall;
    function CreateDrawingStateBlock(drawingStateDescription
      : PD2D1DrawingStateDescription1;
    ...
    function CreateGdiMetafile(metafileStream: IStream;
      out metafile: IUnknown { ID2D1GdiMetafile } ): HResult; stdcall;
    function RegisterEffectFromStream(classId: TGUID; propertyXml: IStream;
      bindings: PD2D1PropertyBinding; bindingsCount: UINT32;
      effectFactory: TD2D1EffectFactoryCallback): HResult; stdcall;
    function RegisterEffectFromString(classId: TGUID; propertyXml: PWideChar;
      bindings: PD2D1PropertyBinding; bindingsCount: UINT32;
      effectFactory: TD2D1EffectFactoryCallback): HResult; stdcall;
    ...
    function GetRegisteredEffects(out effects: PGUID; effectsCount: UINT32;
      out effectsReturned: UINT32; out effectsRegistered: UINT32)
      : HResult; stdcall;
...
const
  CLSID_D2D1ArithmeticComposite
    : TGUID = '{fc151437-049a-4784-a24a-f1c4daf20987}';
  ...
  CLSID_D2D13DPerspectiveTransform
    : TGUID = '{C2844D0B-3D86-46e7-85BA-526C9240F3FB}';
...
type
  TD3DDriveType = (D3D_DRIVER_TYPE_UNKNOWN = 0, D3D_DRIVER_TYPE_HARDWARE = 1,
    D3D_DRIVER_TYPE_REFERENCE = 2, D3D_DRIVER_TYPE_NULL = 3,
    D3D_DRIVER_TYPE_SOFTWARE = 4, D3D_DRIVER_TYPE_WARP = 5);

  PD3DFeatureLevel = ^TD3DFeatureLevel;
  TD3DFeatureLevel = (D3D_FEATURE_LEVEL_9_1 = $9100,
    D3D_FEATURE_LEVEL_9_2 = $9200, D3D_FEATURE_LEVEL_9_3 = $9300,
    D3D_FEATURE_LEVEL_10_0 = $A000, D3D_FEATURE_LEVEL_10_1 = $A100,
    D3D_FEATURE_LEVEL_11_0 = $B000, D3D_FEATURE_LEVEL_11_1 = $B100,
    D3D_FEATURE_LEVEL_12_0 = $C000, D3D_FEATURE_LEVEL_12_1 = $C100);

  TD3D11_RESOURCE_DIMENSION = (D3D11_RESOURCE_DIMENSION_UNKNOWN = 0,
    D3D11_RESOURCE_DIMENSION_BUFFER = 1, D3D11_RESOURCE_DIMENSION_TEXTURE1D = 2,
    D3D11_RESOURCE_DIMENSION_TEXTURE2D = 3,
    D3D11_RESOURCE_DIMENSION_TEXTURE3D = 4);

  TD3D11_MAP = (D3D11_MAP_READ = 1, D3D11_MAP_WRITE = 2,
    D3D11_MAP_READ_WRITE = 3, D3D11_MAP_WRITE_DISCARD = 4,
    D3D11_MAP_WRITE_NO_OVERWRITE = 5);

  TD3D11_USAGE = (D3D11_USAGE_DEFAULT = 0, D3D11_USAGE_IMMUTABLE = 1,
    D3D11_USAGE_DYNAMIC = 2, D3D11_USAGE_STAGING = 3);

  TD3D_PRIMITIVE_TOPOLOGY = (D3D_PRIMITIVE_TOPOLOGY_UNDEFINED = 0,
  ...
  TD3D11_DEVICE_CONTEXT_TYPE = (D3D11_DEVICE_CONTEXT_IMMEDIATE = 0,
  ...
  TD3D11Box = record
    ...
    class function Create(const ALeft, ATop, ARight, ABottom: longint;
      AFront: longint = 0; ABack: longint = 1): TD3D11Box; overload; static;
  ...
  ID3D11DeviceChild = interface(IUnknown)
    ...
    function GetPrivateData(guid: TGUID; var pDataSize: UINT;
      out pData: Pointer): HResult; stdcall;
    function SetPrivateData(guid: TGUID; DataSize: UINT; pData: Pointer)
      : HResult; stdcall;
    function SetPrivateDataInterface(guid: TGUID; pData: IUnknown)
      : HResult; stdcall;
  end;
  ...
  ID3D11Resource = interface(ID3D11DeviceChild)
    ...
    procedure GetType(out pResourceDimension
      : TD3D11_RESOURCE_DIMENSION); stdcall;
  ...
  TD3D11BufferDesc = record
    ...
    procedure Init(AByteWidth: UINT; ABindFlags: UINT;
      AUsage: TD3D11_USAGE = D3D11_USAGE_DEFAULT; ACPUAccessFlags: UINT = 0;
  ...
  ID3D11Device = interface(IUnknown)
    [SID_ID3D11Device]
    function CreateBuffer(const pDesc: TD3D11BufferDesc;
      pInitialData: PD3D11SubResourceData; out ppBuffer: ID3D11Buffer)
      : HResult; stdcall;
    function CreateTexture1D(pDesc: Pointer { PD3D11_TEXTURE1D_DESC };
      pInitialData: PD3D11SubResourceData;
      out ppTexture1D: IUnknown { ID3D11Texture1D } ): HResult; stdcall;
    function CreateTexture2D(const pDesc: TD3D11Texture2DDesc;
      pInitialData: PD3D11SubResourceData; out ppTexture2D: ID3D11Texture2D)
      : HResult; stdcall;
  end;
  ...
  ID3D11DeviceContext = interface(ID3D11DeviceChild)
    ...
    procedure VSSetConstantBuffers(StartSlot: UINT; NumBuffers: UINT;
      ppConstantBuffers: PID3D11Buffer); stdcall;
    procedure PSSetShaderResources(StartSlot: UINT; NumViews: UINT;
      ppShaderResourceViews: PID3D11ShaderResourceView); stdcall;
    procedure PSSetShader(pPixelShader: ID3D11PixelShader;
      ppClassInstances: PID3D11ClassInstance; NumClassInstances: UINT); stdcall;
    procedure PSSetSamplers(StartSlot: UINT; NumSamplers: UINT;
      ppSamplers: PID3D11SamplerState); stdcall;
    procedure VSSetShader(pVertexShader: ID3D11VertexShader;
      ppClassInstances: PID3D11ClassInstance; NumClassInstances: UINT); stdcall;
    procedure DrawIndexed(IndexCount: UINT; StartIndexLocation: UINT;
      BaseVertexLocation: Integer); stdcall;
    procedure Draw(VertexCount: UINT; StartVertexLocation: UINT); stdcall;
    function Map(pResource: ID3D11Resource; Subresource: UINT;
      MapType: TD3D11_MAP; MapFlags: UINT;
      out pMappedResource: TD3D11MappedSubResource): HResult; stdcall;
    procedure Unmap(pResource: ID3D11Resource; Subresource: UINT); stdcall;
    procedure PSSetConstantBuffers(StartSlot: UINT; NumBuffers: UINT;
      ppConstantBuffers: PID3D11Buffer); stdcall;
    procedure IASetInputLayout(pInputLayout: ID3D11InputLayout); stdcall;
    procedure IASetVertexBuffers(StartSlot: UINT; NumBuffers: UINT;
      ppVertexBuffers: PID3D11Buffer; pStrides: PUINT;
      pOffsets: PUINT); stdcall;
    procedure IASetIndexBuffer(pIndexBuffer: ID3D11Buffer; Format: DXGI_FORMAT;
      Offset: UINT); stdcall;
    ...
    procedure DrawInstanced(VertexCountPerInstance: UINT; InstanceCount: UINT;
      StartVertexLocation: UINT; StartInstanceLocation: UINT); stdcall;
    procedure GSSetConstantBuffers(StartSlot: UINT; NumBuffers: UINT;
      ppConstantBuffers: PID3D11Buffer); stdcall;
    procedure GSSetShader(pShader: ID3D11GeometryShader;
      ppClassInstances: PID3D11ClassInstance; NumClassInstances: UINT); stdcall;
    procedure IASetPrimitiveTopology(Topology
      : TD3D_PRIMITIVE_TOPOLOGY); stdcall;
    procedure VSSetShaderResources(StartSlot: UINT; NumViews: UINT;
      ppShaderResourceViews: PID3D11ShaderResourceView); stdcall;
    procedure VSSetSamplers(StartSlot: UINT; NumSamplers: UINT;
      ppSamplers: PID3D11SamplerState); stdcall;
    procedure _Begin(pAsync: ID3D11Asynchronous); stdcall;
    procedure _End(pAsync: ID3D11Asynchronous); stdcall;
    function GetData(pAsync: ID3D11Asynchronous; out pData: Pointer;
      DataSize: UINT; GetDataFlags: UINT): HResult; stdcall;
    procedure SetPredication(pPredicate: IUnknown { ID3D11Predicate };
      PredicateValue: LongBool); stdcall;
    procedure GSSetShaderResources(StartSlot: UINT; NumViews: UINT;
      ppShaderResourceViews: PID3D11ShaderResourceView); stdcall;
    procedure GSSetSamplers(StartSlot: UINT; NumSamplers: UINT;
      ppSamplers: PID3D11SamplerState); stdcall;
    ...
    procedure OMSetRenderTargetsAndUnorderedAccessViews(NumRTVs: UINT;
      ppRenderTargetViews: PID3D11RenderTargetView;
      pDepthStencilView: ID3D11DepthStencilView; UAVStartSlot: UINT;
      NumUAVs: UINT; ppUnorderedAccessViews: PID3D11UnorderedAccessView;
      pUAVInitialCounts: PUINT); stdcall;
    procedure OMSetBlendState(pBlendState: ID3D11BlendState;
      BlendFactor: TFloatArray4; SampleMask: UINT); stdcall;
    procedure OMSetDepthStencilState(pDepthStencilState
      : IUnknown { ID3D11DepthStencilState }; StencilRef: UINT); stdcall;
    procedure SOSetTargets(NumBuffers: UINT; ppSOTargets: PID3D11Buffer;
      pOffsets: PUINT); stdcall;
    ...
    procedure DrawInstancedIndirect(pBufferForArgs: ID3D11Buffer;
      AlignedByteOffsetForArgs: UINT); stdcall;
    procedure Dispatch(ThreadGroupCountX: UINT; ThreadGroupCountY: UINT;
      ThreadGroupCountZ: UINT); stdcall;
    procedure DispatchIndirect(pBufferForArgs: ID3D11Buffer;
      AlignedByteOffsetForArgs: UINT); stdcall;
    procedure RSSetState(pRasterizerState
      : IUnknown { ID3D11RasterizerState } ); stdcall;
    procedure RSSetViewports(NumViewports: UINT;
      pViewports: PD3D11ViewPort); stdcall;
    ...
    procedure CopySubresourceRegion(pDstResource: ID3D11Resource;
      DstSubresource: UINT; DstX, DstY, DstZ: UINT;
      pSrcResource: ID3D11Resource; SrcSubresource: UINT;
      pSrcBox: PD3D11Box); stdcall;
    ...
    procedure UpdateSubresource(pDstResource: ID3D11Resource;
      DstSubresource: UINT; pDstBox: PD3D11Box; pSrcData: Pointer;
      SrcRowPitch: UINT; SrcDepthPitch: UINT); stdcall;
    procedure CopyStructureCount(pDstBuffer: ID3D11Buffer;
      DstAlignedByteOffset: UINT; pSrcView: ID3D11UnorderedAccessView); stdcall;
    procedure ClearRenderTargetView(pRenderTargetView
      : IUnknown { ID3D11RenderTargetView }; ColorRGBA: TFloatArray4); stdcall;
    procedure ClearUnorderedAccessViewUINT(pUnorderedAccessView
      : ID3D11UnorderedAccessView; Values: TUINTArray4); stdcall;
    procedure ClearUnorderedAccessViewFloat(pUnorderedAccessView
      : ID3D11UnorderedAccessView; Values: TFloatArray4); stdcall;
    procedure ClearDepthStencilView(pDepthStencilView: ID3D11DepthStencilView;
      ClearFlags: UINT; Depth: Single; Stencil: UINT8); stdcall;
    procedure GenerateMips(pShaderResourceView
      : ID3D11ShaderResourceView); stdcall;
    ...
    procedure ResolveSubresource(pDstResource: ID3D11Resource;
      DstSubresource: UINT; pSrcResource: ID3D11Resource; SrcSubresource: UINT;
      Format: DXGI_FORMAT); stdcall;
    procedure ExecuteCommandList(pCommandList: ID3D11CommandList;
      RestoreContextState: LongBool); stdcall;
    procedure HSSetShaderResources(StartSlot: UINT; NumViews: UINT;
      ppShaderResourceViews: PID3D11ShaderResourceView); stdcall;
    procedure HSSetShader(pHullShader: ID3D11HullShader;
      ppClassInstances: PID3D11ClassInstance; NumClassInstances: UINT); stdcall;
    procedure HSSetSamplers(StartSlot: UINT; NumSamplers: UINT;
      ppSamplers: PID3D11SamplerState); stdcall;
    procedure HSSetConstantBuffers(StartSlot: UINT; NumBuffers: UINT;
      ppConstantBuffers: PID3D11Buffer); stdcall;
    procedure DSSetShaderResources(StartSlot: UINT; NumViews: UINT;
      ppShaderResourceViews: PID3D11ShaderResourceView); stdcall;
    procedure DSSetShader(pDomainShader: ID3D11DomainShader;
      ppClassInstances: PID3D11ClassInstance; NumClassInstances: UINT); stdcall;
    procedure DSSetSamplers(StartSlot: UINT; NumSamplers: UINT;
      ppSamplers: ID3D11SamplerState); stdcall;
    procedure DSSetConstantBuffers(StartSlot: UINT; NumBuffers: UINT;
      ppConstantBuffers: PID3D11Buffer); stdcall;
    procedure CSSetShaderResources(StartSlot: UINT; NumViews: UINT;
      ppShaderResourceViews: ID3D11ShaderResourceView); stdcall;
    procedure CSSetUnorderedAccessViews(StartSlot: UINT; NumUAVs: UINT;
      ppUnorderedAccessViews: PID3D11UnorderedAccessView;
      pUAVInitialCounts: PUINT); stdcall;
    procedure CSSetShader(pComputeShader: ID3D11ComputeShader;
      ppClassInstances: PID3D11ClassInstance; NumClassInstances: UINT); stdcall;
    procedure CSSetSamplers(StartSlot: UINT; NumSamplers: UINT;
      ppSamplers: PID3D11SamplerState); stdcall;
    procedure CSSetConstantBuffers(StartSlot: UINT; NumBuffers: UINT;
      ppConstantBuffers: PID3D11Buffer); stdcall;
    procedure VSGetConstantBuffers(StartSlot: UINT; NumBuffers: UINT;
      out ppConstantBuffers: PID3D11Buffer); stdcall;
    procedure PSGetShaderResources(StartSlot: UINT; NumViews: UINT;
    ...
    procedure PSGetSamplers(StartSlot: UINT; NumSamplers: UINT;
      out ppSamplers: PID3D11SamplerState); stdcall;
    procedure VSGetShader(out ppVertexShader: ID3D11VertexShader;
      out ppClassInstances: PID3D11ClassInstance;
      var pNumClassInstances: UINT); stdcall;
    procedure PSGetConstantBuffers(StartSlot: UINT; NumBuffers: UINT;
      out ppConstantBuffers: PID3D11Buffer); stdcall;
    procedure IAGetInputLayout(out ppInputLayout: ID3D11InputLayout); stdcall;
    procedure IAGetVertexBuffers(StartSlot: UINT; NumBuffers: UINT;
      out ppVertexBuffers: PID3D11Buffer; out pStrides: PUINT;
      out pOffsets: PUINT); stdcall;
    procedure IAGetIndexBuffer(out pIndexBuffer: ID3D11Buffer;
      out Format: DXGI_FORMAT; out Offset: UINT); stdcall;
    procedure GSGetConstantBuffers(StartSlot: UINT; NumBuffers: UINT;
      out ppConstantBuffers: PID3D11Buffer); stdcall;
    procedure GSGetShader(out ppGeometryShader: ID3D11GeometryShader;
      out ppClassInstances: PID3D11ClassInstance;
      var pNumClassInstances: UINT); stdcall;
    procedure IAGetPrimitiveTopology(out pTopology
      : TD3D_PRIMITIVE_TOPOLOGY); stdcall;
    procedure VSGetShaderResources(StartSlot: UINT; NumViews: UINT;
      out ppShaderResourceViews: PID3D11ShaderResourceView); stdcall;
    procedure VSGetSamplers(StartSlot: UINT; NumSamplers: UINT;
      out ppSamplers: PID3D11SamplerState); stdcall;
    procedure GetPredication(out ppPredicate: IUnknown { ID3D11Predicate };
      out pPredicateValue: LongBool); stdcall;
    procedure GSGetShaderResources(StartSlot: UINT; NumViews: UINT;
      out ppShaderResourceViews: PID3D11ShaderResourceView); stdcall;
    procedure GSGetSamplers(StartSlot: UINT; NumSamplers: UINT;
      out ppSamplers: PID3D11SamplerState); stdcall;
    ...
    procedure OMGetRenderTargetsAndUnorderedAccessViews(NumRTVs: UINT;
      out ppRenderTargetViews: PID3D11RenderTargetView;
      out ppDepthStencilView: ID3D11DepthStencilView; UAVStartSlot: UINT;
      NumUAVs: UINT; out ppUnorderedAccessViews
      : PID3D11UnorderedAccessView); stdcall;
    procedure OMGetBlendState(out ppBlendState: ID3D11BlendState;
      out BlendFactor: TFloatArray4; out pSampleMask: UINT); stdcall;
    procedure OMGetDepthStencilState(out ppDepthStencilState
      : IUnknown { ID3D11DepthStencilState }; out pStencilRef: UINT); stdcall;
    procedure SOGetTargets(NumBuffers: UINT;
      out ppSOTargets: PID3D11Buffer); stdcall;
    procedure RSGetState(out ppRasterizerState
      : IUnknown { ID3D11RasterizerState } ); stdcall;
    procedure RSGetViewports(var pNumViewports: UINT;
      out pViewports: PD3D11ViewPort); stdcall;
    procedure RSGetScissorRects(var pNumRects: UINT;
      out pRects: PD3D11Rect); stdcall;
    procedure HSGetShaderResources(StartSlot: UINT; NumViews: UINT;
      out ppShaderResourceViews: PID3D11ShaderResourceView); stdcall;
    procedure HSGetShader(out ppHullShader: ID3D11HullShader;
      out ppClassInstances: PID3D11ClassInstance;
      var pNumClassInstances: UINT); stdcall;
    procedure HSGetSamplers(StartSlot: UINT; NumSamplers: UINT;
      out ppSamplers: PID3D11SamplerState); stdcall;
    procedure HSGetConstantBuffers(StartSlot: UINT; NumBuffers: UINT;
      out ppConstantBuffers: PID3D11Buffer); stdcall;
    procedure DSGetShaderResources(StartSlot: UINT; NumViews: UINT;
      out ppShaderResourceViews: PID3D11ShaderResourceView); stdcall;
    procedure DSGetShader(out ppDomainShader: ID3D11DomainShader;
      out ppClassInstances: PID3D11ClassInstance;
      var pNumClassInstances: UINT); stdcall;
    procedure DSGetSamplers(StartSlot: UINT; NumSamplers: UINT;
      out ppSamplers: PID3D11SamplerState); stdcall;
    procedure DSGetConstantBuffers(StartSlot: UINT; NumBuffers: UINT;
      out ppConstantBuffers: PID3D11Buffer); stdcall;
    procedure CSGetShaderResources(StartSlot: UINT; NumViews: UINT;
      out ppShaderResourceViews: PID3D11ShaderResourceView); stdcall;
    procedure CSGetUnorderedAccessViews(StartSlot: UINT; NumUAVs: UINT;
    ...
    procedure CSGetShader(out ppComputeShader: ID3D11ComputeShader;
      out ppClassInstances: PID3D11ClassInstance;
      var pNumClassInstances: UINT); stdcall;
    procedure CSGetSamplers(StartSlot: UINT; NumSamplers: UINT;
      out ppSamplers: PID3D11SamplerState); stdcall;
    procedure CSGetConstantBuffers(StartSlot: UINT; NumBuffers: UINT;
      out ppConstantBuffers: PID3D11Buffer); stdcall;
...
function D2D1CreateFactoryNew(factoryType: D2D1_FACTORY_TYPE; const riid: TGUID;
  pFactoryOptions: PD2D1FactoryOptions; out ppIFactory): HResult;
function D3D11CreateDevice(pAdapter: IDXGIAdapter; DriverType: TD3DDriveType;
  Software: HMODULE; Flags: UINT; pFeatureLevels: PD3DFeatureLevel;
  FeatureLevels: UINT; SDKVersion: UINT; out ppDevice: ID3D11Device;
  pFeatureLevel: PD3DFeatureLevel;
  out ppImmediateContext: ID3D11DeviceContext): HResult;
...
type
  ...
  IDCompositionVisual = interface(IUnknown)
    ...
    function SetOffsetX(animation: IUnknown { IDCompositionAnimation } )
      : HResult; stdcall; overload;
    function SetOffsetX(offsetX: Single): HResult; stdcall; overload;
    function SetOffsetY(animation: IUnknown { IDCompositionAnimation } )
      : HResult; stdcall; overload;
    ...
    function _SetTransform(transform: IUnknown { IDCompositionTransform } )
      : HResult; stdcall;
    ...
    function SetBitmapInterpolationMode(interpolationMode
      : TDCompositionBitmapInterpolation): HResult; stdcall;
    function SetBorderMode(borderMode: TDCompositionBorderMode)
      : HResult; stdcall;
    ...
    function AddVisual(visual: IDCompositionVisual; insertAbove: boolean;
      referenceVisual: IDCompositionVisual): HResult; stdcall;
    function RemoveVisual(visual: IDCompositionVisual): HResult; stdcall;
    function RemoveAllVisuals: HResult; stdcall;
    function SetCompositeMode(compositeMode: TDCompositionCompositeMode)
      : HResult; stdcall;
  end;
  ...
  IDCompositionVisual2 = interface(IDCompositionVisual)
    ...
    function SetBackFaceVisibility(visibility: TDCompositionBackfaceVisibility)
      : HResult; stdcall;
  end;
  ...
  IDCompositionDevice = interface(IUnknown)
    ...
    function GetFrameStatistics(out statistics: TDCompositionFrameStatistics)
      : HResult; stdcall;
    function CreateTargetForHwnd(HWND: HWND; topmost: boolean;
    ...
    function CreateVirtualSurface(initialWidth: UINT; initialHeight: UINT;
      pixelFormat: DXGI_FORMAT; AlphaMode: TDXGIAlphaMode;
      out virtualSurface: IUnknown { IDCompositionVirtualSurface } )
      : HResult; stdcall;
    function CreateSurfaceFromHandle(Handle: THandle; out surface: IUnknown)
      : HResult; stdcall;
    function CreateSurfaceFromHwnd(HWND: HWND; out surface: IUnknown)
      : HResult; stdcall;
    function CreateTranslateTransform(out translateTransform
      : IUnknown { IDCompositionTranslateTransform } ): HResult; stdcall;
    function CreateScaleTransform(out scaleTransform
      : IUnknown { IDCompositionScaleTransform } ): HResult; stdcall;
    function CreateRotateTransform(out rotateTransform
      : IUnknown { IDCompositionRotateTransform } ): HResult; stdcall;
    function CreateSkewTransform(out skewTransform
      : IUnknown { IDCompositionSkewTransform } ): HResult; stdcall;
    function CreateMatrixTransform(out matrixTransform
      : IUnknown { IDCompositionMatrixTransform } ): HResult; stdcall;
    function CreateTransformGroup(transforms
      : Pointer { PIDCompositionTransform }; elements: UINT;
      out transformGroup: IUnknown { IDCompositionTransform } )
      : HResult; stdcall;
    function CreateTranslateTransform3D(out translateTransform3D
      : IUnknown { IDCompositionTranslateTransform3D } ): HResult; stdcall;
    function CreateScaleTransform3D(out scaleTransform3D
      : IUnknown { IDCompositionScaleTransform3D } ): HResult; stdcall;
    function CreateRotateTransform3D(out rotateTransform3D
      : IUnknown { IDCompositionRotateTransform3D } ): HResult; stdcall;
    function CreateMatrixTransform3D(out matrixTransform3D
      : IUnknown { IDCompositionMatrixTransform3D } ): HResult; stdcall;
    function CreateTransform3DGroup(transforms3D
      : Pointer { PIDCompositionTransform3D }; elements: UINT;
      out transform3DGroup: IUnknown { IDCompositionTransform3D } )
      : HResult; stdcall;
    function CreateEffectGroup(out effectGroup
      : IUnknown { IDCompositionEffectGroup } ): HResult; stdcall;
    function CreateRectangleClip(out clip
      : IUnknown { IDCompositionRectangleClip } ): HResult; stdcall;
    function CreateAnimation(out animation
      : IUnknown { IDCompositionAnimation } ): HResult; stdcall;
  ...
  IDCompositionDevice2 = interface(IUnknown)
    ...
    function CreateSurfaceFactory(renderingDevice: IUnknown;
      out surfaceFactory: { IDCompositionSurfaceFactory } IUnknown)
      : HResult; stdcall;
    function CreateSurface(Width: UINT; Height: UINT; pixelFormat: DXGI_FORMAT;
      AlphaMode: TDXGIAlphaMode; out surface: { IDCompositionSurface } IUnknown)
      : HResult; stdcall;
    function CreateVirtualSurface(initialWidth: UINT; initialHeight: UINT;
      pixelFormat: DXGI_FORMAT; AlphaMode: TDXGIAlphaMode;
      out virtualSurface: IUnknown { IDCompositionVirtualSurface } )
...
function CheckNeedSwitchToGdiRenderMode(const AException: Exception)
  : boolean; overload;
function CheckNeedSwitchToGdiRenderMode(const AErrorCode: HResult)
  : boolean; overload;
...
type
  TD2D1CreateFactoryFunc = function(factoryType: D2D1_FACTORY_TYPE;
    const riid: TGUID; pFactoryOptions: PD2D1FactoryOptions; out ppIFactory)
    : HResult; stdcall;

  TD3D11CreateDeviceFunc = function(pAdapter: IDXGIAdapter;
    DriverType: TD3DDriveType; Software: HMODULE; Flags: UINT;
    pFeatureLevels: PD3DFeatureLevel; FeatureLevels: UINT; SDKVersion: UINT;
    out ppDevice: ID3D11Device; pFeatureLevel: PD3DFeatureLevel;
...
begin
  ...
  if Assigned(FD3D11CreateDevice) then
    Result := FD3D11CreateDevice(pAdapter, DriverType, Software, Flags,
...
begin
  if FIsDirect2DAvailable = bDefault then
    FIsDirect2DAvailable := dxBooleanToDefaultBoolean((D2D1Factory1 <> nil) and
      (DWriteFactory <> nil));
...
begin
  ...
  begin
    if Failed(D2D1CreateFactoryNew(D2D1_FACTORY_TYPE_SINGLE_THREADED,
      ID2D1Factory1, nil, AFactory)) then
      AFactory := nil;
    if InterlockedCompareExchangePointer(Pointer(FSharedD2D1Factory1),
      Pointer(AFactory), nil) = nil then
    begin
...
begin
  ...
  begin
    if Failed(DWriteCreateFactory(DWRITE_FACTORY_TYPE_SHARED, IDWriteFactory,
      AFactory)) then
      AFactory := nil;
    if InterlockedCompareExchangePointer(Pointer(FSharedDirectWriteFactory),
      Pointer(AFactory), nil) = nil then
    begin
      if AFactory <> nil then
        AFactory._AddRef;
...
class function TD3D11Box.Create(const ALeft, ATop, ARight, ABottom: longint;
  AFront, ABack: longint): TD3D11Box;
begin
  Result.left := ALeft;
  Result.top := ATop;
  Result.front := AFront;
...
begin
  Result := (A.left = B.left) and (A.top = B.top) and (A.front = B.front) and
    (A.right = B.right) and (A.bottom = B.bottom) and (A.back = B.back);
end;
