...
type
  ...
  TDay = (dSunday, dMonday, dTuesday, dWednesday, dThursday, dFriday,
    dSaturday);
  TDays = set of TDay;
...
SmartTextToDateFunc:
function(const AText: string; var ADate: TDateTime): Boolean = nil;
...
{$EXTERNALSYM TcxCALID}
  ...
  TcxDateEditSmartInput = (deiToday, deiYesterday, deiTomorrow, deiSunday,
    deiMonday, deiTuesday, deiWednesday, deiThursday, deiFriday, deiSaturday,
  ...
  protected
    ...
    procedure AdjustYear(var AYear, AEra: Integer; AMonth, ADay: Integer);
      overload; virtual;
    function GetCalendarAlgorithmType: TcxCalendarAlgorithmType;
      virtual; abstract;
  ...
  public
    ...
    function AddDays(ADate: TcxDateTime; ACountDays: Integer): TDateTime;
      overload; virtual;

    function AddMonths(ADate: TDateTime; ACountMonths: Integer): TDateTime;
      overload; virtual;
    function AddMonths(ADate: TcxDateTime; ACountMonths: Integer): TDateTime;
      overload; virtual;

    function AddYears(ADate: TDateTime; ACountYears: Integer): TDateTime;
      overload; virtual;
    function AddYears(ADate: TcxDateTime; ACountYears: Integer): TDateTime;
      overload; virtual;

    function AddWeeks(ADate: TDateTime; ACountWeeks: Integer): TDateTime;
      overload; virtual;
    function AddWeeks(ADate: TcxDateTime; ACountWeeks: Integer): TDateTime;
      overload; virtual;

    function FromDateTime(ADate: TDateTime): TcxDateTime; overload;
      virtual; abstract;
    function FromDateTime(AYear, AMonth, ADay: Cardinal): TcxDateTime;
      overload; virtual;
    function FromDateTime(AYear, AMonth, ADay: Cardinal;
      AHours, AMinutes, ASeconds: Byte; AMilliseconds: Word): TcxDateTime;
      overload; virtual;
    ...
    function GetDaysInMonth(AYear, AMonth: Cardinal): Cardinal;
      overload; virtual;
    function GetDaysInMonth(AEra: Integer; AYear, AMonth: Cardinal): Cardinal;
      overload; virtual; abstract;
    function GetDaysInYear(AYear: Cardinal): Cardinal; overload; virtual;
    function GetDaysInYear(AEra: Integer; AYear: Cardinal): Cardinal; overload;
      virtual; abstract;
    ...
    function GetFirstDayOfWeek(ADate: TDateTime; AStartDayOfWeek: TDay)
      : TDateTime; overload; virtual;
    function GetFirstDayOfWeek(ADate: TcxDateTime): TcxDateTime;
      overload; virtual;
    function GetFirstDayOfWeek(ADate: TcxDateTime; AStartDayOfWeek: TDay)
      : TcxDateTime; overload; virtual;
    function GetFirstDayOfMonth(const ADate: TDateTime): TDateTime;
      overload; virtual;
    function GetFirstDayOfMonth(const ADate: TcxDateTime): TcxDateTime;
      overload; virtual;
    function GetFirstDayOfYear(const ADate: TDateTime): TDateTime;
      overload; virtual;
    function GetFirstDayOfYear(const ADate: TcxDateTime): TcxDateTime;
      overload; virtual;
    function GetFirstWeekDay: Byte; virtual; abstract;
    function GetFullWeeksInYear(AYear: Cardinal): Cardinal; virtual; abstract;
    function GetLastDayOfMonth(const ADate: TDateTime): TDateTime;
      overload; virtual;
    function GetLastDayOfMonth(const ADate: TcxDateTime): TcxDateTime;
      overload; virtual;
    function GetLastDayOfYear(const ADate: TDateTime): TDateTime;
      overload; virtual;
    function GetLastDayOfYear(const ADate: TcxDateTime): TcxDateTime;
      overload; virtual;
    function GetMonthsInYear(AYear: Cardinal): Cardinal; overload; virtual;
    function GetMonthsInYear(AEra: Integer; AYear: Cardinal): Cardinal;
      overload; virtual; abstract;
    ...
    function GetWeekNumber(ADate: TcxDateTime; AStartOfWeek: TDay;
      AFirstWeekOfYear: TcxFirstWeekOfYear): Cardinal; overload;
      virtual; abstract;
    function IsLeapDay(AYear, AMonth, ADay: Cardinal): Boolean;
      overload; virtual;
    function IsLeapDay(AEra: Integer; AYear, AMonth, ADay: Cardinal): Boolean;
      overload; virtual; abstract;
    function IsLeapMonth(AYear, AMonth: Cardinal): Boolean; overload; virtual;
    function IsLeapMonth(AEra: Integer; AYear, AMonth: Cardinal): Boolean;
      overload; virtual; abstract;
    function IsLeapYear(AYear: Cardinal): Boolean; overload; virtual;
    function IsLeapYear(AEra: Integer; Year: Cardinal): Boolean; overload;
      virtual; abstract;

    function IsValidYear(AYear: Cardinal): Boolean; overload; virtual;
    function IsValidYear(AEra: Integer; AYear: Cardinal): Boolean;
      overload; virtual;
    function IsValidMonth(AYear, AMonth: Cardinal): Boolean; overload; virtual;
    function IsValidMonth(AEra: Integer; AYear, AMonth: Cardinal): Boolean;
      overload; virtual;
    function IsValidDay(AYear, AMonth, ADay: Cardinal): Boolean;
      overload; virtual;
    function IsValidDay(AEra: Integer; AYear, AMonth, ADay: Cardinal): Boolean;
      overload; virtual;
    function IsValidDate(ADate: TDateTime): Boolean; virtual;

    function ToDateTime(ADate: TcxDate): TDateTime; overload; virtual;
    function ToDateTime(AYear, AMonth, ADay: Cardinal): TDateTime;
      overload; virtual;
    function ToDateTime(AYear, AMonth, ADay: Cardinal;
      AHours, AMinutes, ASeconds: Byte; AMilliseconds: Word): TDateTime;
      overload; virtual;
    function ToDateTime(ADateTime: TcxDateTime): TDateTime; overload;
      virtual; abstract;
    ...
    property AlgorithmType: TcxCalendarAlgorithmType
      read GetCalendarAlgorithmType;
  ...
  class var
    ...
    class function cxTZInfoToTZInfo(const AInfo: TcxTimeZoneInformation)
      : TTimeZoneInformation; static;
    class function TZInfoTocxTZInfo(const AInfo: TTimeZoneInformation)
      : TcxTimeZoneInformation; static;
    class procedure ReadTimeZoneInfoFromRegistry(ARegistry: TRegistry;
      out AInfo: TcxTimeZoneInformation); static;
  private
    class procedure InitTimeZoneInformation; static;
    class procedure DoneTimeZoneInformation; static;
  public
    // internal time zone
    class function AddInternalTimeZone(const ATimeZone: TcxTimeZoneInformation)
      : Integer; static;
    // time zone conversion
    class function AddDSTInfo(var ATimeZoneInfo: TcxTimeZoneInformation;
      const AYear: Integer; const AStandardDate, ADaylightDate: TSystemTime)
      : Integer; overload; static;
    class function AddDSTInfo(var ATimeZoneInfo: TcxTimeZoneInformation;
      const AYear: Integer; const AStandardDate, ADaylightDate: TDateTime)
      : Integer; overload; static;
    class function AddDSTInfo(const ATimeZone: Integer; const AYear: Integer;
      const AStandardDate, ADaylightDate: TDateTime): Integer; overload; static;
    class function CalculateTransitionDate(const AYear: Word;
      const ADSTDateTime: TSystemTime): TDateTime; static;
    class function ConvertToGlobalTime(const ADateTime: TDateTime;
      ATimeZone: Integer = -1): TDateTime; static;
    class function ConvertToLocalTime(const ADateTime: TDateTime;
      ATimeZone: Integer = -1): TDateTime; static;
    class function CurrentTimeZone: Integer; static;
    class function CurrentTimeZoneBias: Double; static;
    class function IsDaylightDateTime(ATimeZone: Integer; ADateTime: TDateTime)
      : Boolean; static;
    ...
    class function TimeZoneDaylightBias(ADateTime: TDateTime;
      ATimeZone: Integer): Integer; static;
    class function TimeZoneInfo(AIndex: Integer)
      : TcxTimeZoneInformation; static;
  end;
  ...
  public
    ...
    class function StringToDateTime(const AValue: string;
      out AIsUtcTimeZone: Boolean): TDateTime; overload; static;
    class function StringToDateTime(const AValue: string): TDateTime;
      overload; static;
  end;
...
function dxGetEndDateOfMonth(const ADate: TDateTime; AIgnoreTime: Boolean)
  : TDateTime;
function dxGetStartDateOfYear(const ADate: TDateTime): TDateTime;
function dxGetEndDateOfYear(const ADate: TDateTime; AIgnoreTime: Boolean)
  : TDateTime;
...
function dxDayOfWeekOffset(const AValue: TDateTime; AStartOfWeek: TDay)
  : TdxDayOfWeek; overload;
...
function dxGetStartDateOfWeek(const AValue: TDateTime; AStartOfWeek: TDay)
  : TDateTime; overload;
...
function cxGetCalendarInfo(Locale: LCID; Calendar: CALID; CalendType: CALTYPE;
  lpCalData: PChar; cchData: Integer; lpValue: PDWORD): Integer;
...
function cxDateToStr(ADate: TDateTime; const AFormat: TFormatSettings)
  : string; overload;
function cxDayNumberToLocalFormatStr(ADate: TDateTime): string; overload;
function cxDayNumberToLocalFormatStr(ADay: Integer;
  ACalendar: TcxCustomCalendarTable = nil): string; overload;
...
function cxGetLocalMonthName(ADate: TDateTime;
  ACalendar: TcxCustomCalendarTable): string; overload;
function cxGetLocalMonthName(AYear, AMonth: Integer;
  ACalendar: TcxCustomCalendarTable): string; overload;
function cxGetLocalMonthYear(ADate: TDateTime;
  ACalendar: TcxCustomCalendarTable = nil): string;
function cxGetLocalYear(ADate: TDateTime;
  ACalendar: TcxCustomCalendarTable = nil): string;
...
function cxTimeToStr(ATime: TDateTime; const ATimeFormat: string)
  : string; overload;
function cxTimeToStr(ATime: TDateTime; const AFormatSettings: TFormatSettings)
  : string; overload;

procedure AddDateRegExprMaskSmartInput(var AMask: string;
  ACanEnterTime: Boolean);

function dxGetCalendarDateElement(ADate: TDateTime; AElement: TcxDateElement;
  ACalendar: TcxCustomCalendarTable): Integer;

function cxGetDateFormat(ADate: TDateTime; out AFormatDate: string;
  AFlags: Integer; const AFormat: string = ''): Boolean;
function DateToLongDateStr(ADate: TDateTime): string;

function cxDateTimeToText(ADate: TDateTime;
  AFourDigitYearNeeded: Boolean = False;
  AUseDelphiDateTimeFormats: Boolean = False): string;
function cxTextToDateTime(const AText: string;
  AUseDelphiDateTimeFormats: Boolean = False): TDateTime;
function DateTimeToText(ADate: TDateTime;
  AFourDigitYearNeeded: Boolean = False): string;
function DateTimeToTextEx(const ADate: TDateTime; AIsMasked: Boolean;
  AIsDateTimeEdit: Boolean = False;
  AFourDigitYearNeeded: Boolean = False): string;
function TextToDateEx(AText: string; var ADate: TDateTime;
  const AFormatString: string = ''): Boolean;
...
const
  dxDayConvertTableSystem: array [TdxDayOfWeekSystem] of TDay = (dMonday,
    dTuesday, dWednesday, dThursday, dFriday, dSaturday, dSunday);
  dxDayConvertTableVCL: array [TdxDayOfWeekVCL] of TDay = (dSunday, dMonday,
    dTuesday, dWednesday, dThursday, dFriday, dSaturday);
...
function GetDateOrder(const AFormatInfo: TcxDateTimeFormatInfo)
  : TcxDateOrder; overload;
var
  I: Integer;
begin
  Result := doMDY;
...
function GetMonthView(const ADateFormat: string; var APos: Integer)
  : TcxMonthView;
var
  ACount: Integer;
begin
...
function cxDateToStrByFormat(const ADate: TDateTime; const ADateFormat: string;
  const ADateSeparator: Char): string;
  ...
  function GetYearView(const ADateFormat: string; var APos: Integer)
    : TcxYearView;
  var
    ACount: Integer;
  begin
  ...
  const
    AAllowChars = ['d', 'm', 'y', '"', ''''];
  begin
    while (APos <= Length(S)) and not dxCharInSet(AnsiLowerCase(S[APos])[1],
      AAllowChars) do
      Inc(APos);
    Result := (APos <= Length(S)) and dxCharInSet(AnsiLowerCase(S[APos])[1],
      AAllowChars);
  end;

  procedure AddPart(var ADateString: string; const APart: string;
    ...
    case AnsiLowerCase(ADateFormat[APos])[1] of
      '''', '"':
        begin
          ...
          Inc(APos);
          while (APos <= Length(ADateFormat)) and
            (ADateFormat[APos] <> AQuote) do
          begin
      ...
      'd':
        begin
          ...
          if ACountChar = 3 then
            AddPart(Result, dxFormatSettings.ShortDayNames[ADayOfWeek],
              ACurrentSeparator)
          else if ACountChar = 4 then
            AddPart(Result, dxFormatSettings.LongDayNames[ADayOfWeek],
              ACurrentSeparator)
          else if ACountChar = 2 then
            AddPart(Result, AddZeros(IntToStr(ASystemDate.wDay), 2),
              ACurrentSeparator)
          else
      ...
      'y':
        begin
          AddPart(Result, YearToStr(ASystemDate.wYear, GetYearView(ADateFormat,
            APos)), ACurrentSeparator);
          ACurrentSeparator := '';
        end;
      'm':
        begin
          AddPart(Result, MonthToStr(ASystemDate.wMonth,
            GetMonthView(ADateFormat, APos)), ACurrentSeparator);
          ACurrentSeparator := '';
        end;
      'e':
        begin
...
begin
  Result := cxDateToStrByFormat(ADate, dxFormatSettings.ShortDateFormat,
    dxFormatSettings.DateSeparator);
end;

function cxDateToStr(ADate: TDateTime; const AFormat: TFormatSettings): string;
begin
  Result := cxDateToStrByFormat(ADate, AFormat.ShortDateFormat,
...
function cxGetLocalMonthName(ADate: TDateTime;
  ACalendar: TcxCustomCalendarTable): string;
var
  AFormat: string;
...
begin
  ...
  AConvertDate.Day := 1;
  AFormat := 'MMMM';
  if (cxIsGregorianCalendar(ACalendar) and
    cxFormatController.UseDelphiDateTimeFormats) or
    not cxGetDateFormat(ACalendar.ToDateTime(AConvertDate), Result, 0, AFormat)
  then
...
var
  ADate: TcxDate;
begin
  if cxIsGregorianCalendar(ACalendar) and cxFormatController.UseDelphiDateTimeFormats
  then
  begin
    Result := dxFormatSettings.LongMonthNames[AMonth];
  end
...
begin
  ...
  AConvertDate := ACalendar.FromDateTime(ADate);
  AConvertDate.Day := 1;
  if cxGetCalendarInfo(GetThreadLocale, ACalendar.GetCalendarID, CAL_SYEARMONTH,
    ABuf, Length(ABuf), nil) > 0 then
    AFormat := ABuf
  else
    AFormat := ADefaultFormat;
  if not cxGetDateFormat(ACalendar.ToDateTime(AConvertDate), Result, 0, AFormat)
  then
    Result := cxGetLocalMonthName(AConvertDate.Year, AConvertDate.Month,
      ACalendar) + ' ' + cxGetLocalYear(ADate, ACalendar);
end;
...
const
  cxDayNameLCType: array [Boolean, TDay] of Cardinal =
    ...
    LOCALE_SABBREVDAYNAME6), (CAL_SSHORTESTDAYNAME7, CAL_SSHORTESTDAYNAME1,
    CAL_SSHORTESTDAYNAME2, CAL_SSHORTESTDAYNAME3, CAL_SSHORTESTDAYNAME4,
    CAL_SSHORTESTDAYNAME5, CAL_SSHORTESTDAYNAME6));
begin
  if cxFormatController.LocalIsGregorianCalendar and cxFormatController.UseDelphiDateTimeFormats
  then
    Result := dxFormatSettings.ShortDayNames[dxDayOfWeekToVCL(ADay)]
  else
    Result := dxGetLocaleInfo(GetThreadLocale,
      cxDayNameLCType[IsWinVistaOrLater, ADay]);
...
function ScanPart(const S: string; var APos: Integer;
  AEndScan: TdxAnsiCharSet): string;
begin
  Result := '';
...
begin
  Result := cxStrToDate(ADateStr, cxFormatController.LocalFormatSettings,
    ACalendar);
end;
...
{$ENDIF}
  ...
  begin
    ...
    Result := (AFormat.DateSeparator = ' ') and
      ((APos < Length(ADateStr)) and not dxCharInSet(ADateStr[APos],
      ['0' .. '9']));
  end;
...
begin
  APos := 1;
  AEraYearOffset := 0;
  if (AFormat.ShortDateFormat <> '') and (AFormat.ShortDateFormat[1] = 'g') then
...
{$IFDEF DELPHI19}
    if (AnsiPos('e', FormatSettings.ShortDateFormat) > 0) and
      ...
      AEraYearOffset := FormatSettings.EraInfo[High(FormatSettings.EraInfo)
        ].EraOffset;
{$ELSE}
...
function cxTimeToStr(ATime: TDateTime;
...
var
  AKernelDLL: Integer;
  AGetCalendarInfo: function(Locale: LCID; Calendar: CALID; CalendType: CALTYPE;
    lpCalData: PChar; cchData: Integer; lpValue: lpDWord): Integer; stdcall;
begin
  Result := 0;
  ...
  begin
    ...
    if Assigned(AGetCalendarInfo) then
      Result := AGetCalendarInfo(Locale, Calendar, CalendType, lpCalData,
        cchData, lpValue);
  end;
end;
...
function cxGetCalendarID(Locale: LCID): TcxCALID;
begin
  GetLocaleInfo(Locale, LOCALE_ICALENDARTYPE or CAL_RETURN_NUMBER, @Result,
    SizeOf(Result));
end;
...
procedure CorrectTextForDateTimeConversion(var AText: string;
  ...
  begin
    if AOleConversion then
      Result := GetDateOrder
        (cxFormatController.LocalFormatSettings.ShortDateFormat)
    else
  ...
  var
    I: Integer;
  begin
    if AOleConversion or not cxFormatController.DateFormatInfo.DefinedItems
      [dtikDateSeparator] then
      Result := cxFormatController.LocalFormatSettings.DateSeparator
    else
    begin
      Result := '';
      for I := 0 to cxFormatController.DateFormatInfo.ItemCount - 1 do
        if cxFormatController.DateFormatInfo.Items[I].Kind = dtikDateSeparator
        then
        begin
  ...
  begin
    for I := 1 to 7 do
    begin
      S := StringReplace(S, dxFormatSettings.LongDayNames[I], '',
        [rfIgnoreCase, rfReplaceAll]);
      S := StringReplace(S, dxFormatSettings.ShortDayNames[I], '',
        [rfIgnoreCase, rfReplaceAll]);
    end;
  end;
    ...
    begin
      ...
      begin
        case ADateTimeFormatInfo.Items[I].Kind of
          dtikMonth:
            AMonth := ScanPart(S, APos,
              [' ', cxFormatController.LocalFormatSettings.DateSeparator,
              dxFormatSettings.DateSeparator]);
          dtikDay:
            begin
              ABeginPos := APos;
      ...
      if AMonth = '' then
        AMonth := '1';
      S := Format(AFormatMap[AOleDateOrder], [AOleDateSeparator, ADay, AMonth,
        AYear, Copy(S, APos, Length(S) - APos + 1)]);
    end;
  end;
...
begin
  ...
  if AOleConversion then
  begin
    InternalStringReplace(S,
      cxFormatController.LocalFormatSettings.DateSeparator);
    if S[Length(S)] = cxFormatController.LocalFormatSettings.TimeSeparator then
      S := S + '00';
  end;
  AText := S;
end;
...
begin
  ...
  begin
    ...
    if Length(AFormat) = 0 then
      AFormatDate := cxDateToStrByFormat(ADate,
        dxFormatSettings.LongDateFormat, #0)
    else
  ...
  begin
    ...
    if Length(AFormat) = 0 then
      ...
      P := PChar(AFormat);
    L := GetDateFormat(GetThreadLocale, AFlags, @ASystemDate, P, Buffer,
      Length(Buffer));
    Result := L > 0;
    if Result then
      SetString(AFormatDate, Buffer, L - 1)
    else
      AFormatDate := '';
  end;
end;
...
begin
  ...
  begin
    case I of
      ...
      deiTomorrow:
        ADate := Date + 1;
      deiSunday, deiMonday, deiTuesday, deiWednesday, deiThursday, deiFriday,
        deiSaturday:
        begin
          ADate := Date;
...
begin
  ...
  begin
    ...
    ADate := cxTextToDateTime(AText,
      cxFormatController.UseDelphiDateTimeFormats);

  Result := ADate <> NullDate;
end;

function InternalDateTimeToText(ADateTime: TDateTime;
  AFourDigitYearNeeded, AUseDelphiDateTimeFormats, AShowZeroTime
  : Boolean): string;
...
begin
  if ADateTime = NullDate then
    Result := ''
  else if AUseDelphiDateTimeFormats then
    DateTimeToString(Result, GetDateTimeFormat, ADateTime)
  else
  begin
    DateTimeToSystemTime(ADateTime, ASystemTime);
    if GetDateFormat(GetThreadLocale, 0, @ASystemTime, PChar(GetDateTimeFormat),
      ADateStr, 100) <> 0 then
    begin
      Result := ADateStr;
      if AShowZeroTime or (dxTimeOf(ADateTime) <> 0) then
...
function cxDateTimeToText(ADate: TDateTime;
  ...
  AUseDelphiDateTimeFormats: Boolean = False): string;
begin
  Result := InternalDateTimeToText(ADate, AFourDigitYearNeeded,
    AUseDelphiDateTimeFormats, False);
end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if (Result >= MaxInt) or (Result <= MinInt) or (ADay <= 0) or
          (AYear > dxMaxYear) then
          Result := NullDate;
      end
      else
...
function DateTimeToText(ADate: TDateTime;
  AFourDigitYearNeeded: Boolean = False): string;
begin
  Result := cxDateTimeToText(ADate, AFourDigitYearNeeded,
    cxFormatController.UseDelphiDateTimeFormats);
end;
      ...
      begin
        if AIsDateTimeEdit then
          Result := FormatDateTime
            (cxFormatController.MaskedDateTimeEditFormat, ADate)
        else
          Result := FormatDateTime(cxFormatController.MaskedDateEditFormat,
            dxDateOf(ADate));
      end
      else
        Result := InternalDateTimeToText(ADate, AFourDigitYearNeeded,
          cxFormatController.UseDelphiDateTimeFormats, AIsDateTimeEdit and
          cxFormatController.DateEditShowZeroTime);
    end
    else
...
function TcxCustomCalendarTable.IsNotValid(ADate: TcxDateTime;
...
begin
  ...
  else if (AEra >= 0) and (AEra < Eras.Count) then
    AYear := Integer(AYear) + Eras[AEra].YearOffset;
end;

function TcxCustomCalendarTable.AddDays(ADate: TcxDateTime; ACountDays: Integer)
  : TDateTime;
begin
...
begin
  ...
  if ACurrentMonth > Integer(GetMonthsInYear(ACurrentEra, ACurrentYear)) then
    ...
    ASwap := 1;
  while (ACurrentMonth > Integer(GetMonthsInYear(ACurrentEra, ACurrentYear))) or
    (ACurrentMonth <= 0) do
  begin
    if ASwap > 0 then
      Inc(ACurrentMonth, ASwap * Integer(GetMonthsInYear(ACurrentEra,
        ACurrentYear - 1)))
    else
      Inc(ACurrentMonth, ASwap * Integer(GetMonthsInYear(ACurrentEra,
        ACurrentYear)));
...
function TcxCustomCalendarTable.AddWeeks(ADate: TDateTime; ACountWeeks: Integer)
  : TDateTime;
begin
...
function TcxCustomCalendarTable.AddYears(ADate: TDateTime; ACountYears: Integer)
  : TDateTime;
begin
...
function TcxCustomCalendarTable.FromDateTime(AYear, AMonth, ADay: Cardinal)
  : TcxDateTime;
begin
...
function TcxCustomCalendarTable.FromDateTime(AYear, AMonth, ADay: Cardinal;
  AHours, AMinutes, ASeconds: Byte; AMilliseconds: Word): TcxDateTime;
begin
  Result := FromDateTime(EncodeDateTime(AYear, AMonth, ADay, AHours, AMinutes,
    ASeconds, AMilliseconds));
end;
...
function TcxCustomCalendarTable.GetDaysInMonth(AYear, AMonth: Cardinal)
  : Cardinal;
begin
...
function TcxCustomCalendarTable.GetFirstDayOfWeek(ADate: TDateTime;
  AStartDayOfWeek: TDay): TDateTime;
var
  ADays: Integer;
begin
...
function TcxCustomCalendarTable.GetFirstDayOfWeek(ADate: TcxDateTime)
  : TcxDateTime;
var
  I: Integer;
begin
...
function TcxCustomCalendarTable.GetFirstDayOfWeek(ADate: TcxDateTime;
  AStartDayOfWeek: TDay): TcxDateTime;
begin
  Result := FromDateTime(GetFirstDayOfWeek(ToDateTime(ADate), AStartDayOfWeek));
end;

function TcxCustomCalendarTable.GetFirstDayOfMonth(const ADate: TDateTime)
  : TDateTime;
begin
  Result := ToDateTime(GetFirstDayOfMonth(FromDateTime(ADate)));
end;

function TcxCustomCalendarTable.GetFirstDayOfMonth(const ADate: TcxDateTime)
  : TcxDateTime;
begin
  Result := ADate;
  Result.Day := 1;
...
function TcxCustomCalendarTable.GetFirstDayOfYear(const ADate: TDateTime)
  : TDateTime;
begin
  Result := ToDateTime(GetFirstDayOfYear(FromDateTime(ADate)));
end;

function TcxCustomCalendarTable.GetFirstDayOfYear(const ADate: TcxDateTime)
  : TcxDateTime;
begin
  Result := ADate;
  Result.Month := 1;
...
function TcxCustomCalendarTable.GetLastDayOfMonth(const ADate: TcxDateTime)
  : TcxDateTime;
begin
  Result := ADate;
...
function TcxCustomCalendarTable.GetLastDayOfMonth(const ADate: TDateTime)
  : TDateTime;
begin
  Result := ToDateTime(GetLastDayOfMonth(FromDateTime(ADate)));
end;

function TcxCustomCalendarTable.GetLastDayOfYear(const ADate: TcxDateTime)
  : TcxDateTime;
begin
  Result := ADate;
...
function TcxCustomCalendarTable.GetLastDayOfYear(const ADate: TDateTime)
  : TDateTime;
begin
...
function TcxCustomCalendarTable.GetWeekNumber(ADate: TDateTime;
...
function TcxCustomCalendarTable.IsLeapDay(AYear, AMonth,
...
function TcxCustomCalendarTable.IsValidDay(AEra: Integer;
  AYear, AMonth, ADay: Cardinal): Boolean;
begin
  Result := IsValidMonth(AEra, AYear, AMonth) and (ADay > 0) and
    (ADay <= GetDaysInMonth(AEra, AYear, AMonth));
end;
...
function TcxCustomCalendarTable.IsValidMonth(AEra: Integer;
  AYear, AMonth: Cardinal): Boolean;
begin
  Result := IsValidYear(AEra, AYear) and (AMonth > 0) and
    (AMonth <= GetMonthsInYear(AEra, AYear));
end;
...
function TcxCustomCalendarTable.IsValidYear(AEra: Integer;
  AYear: Cardinal): Boolean;
begin
...
function TcxCustomCalendarTable.GetMonthNumber(AYear: Integer;
...
class function TdxTimeZoneHelper.AddInternalTimeZone(const ATimeZone
  : TcxTimeZoneInformation): Integer;
var
  ALength: Integer;
begin
...
class function TdxTimeZoneHelper.AddDSTInfo(var ATimeZoneInfo
  : TcxTimeZoneInformation; const AYear: Integer;
  const AStandardDate, ADaylightDate: TSystemTime): Integer;
begin
  if AStandardDate.wMonth <> 0 then
    Result := AddDSTInfo(ATimeZoneInfo, AYear, CalculateTransitionDate(AYear,
      AStandardDate), CalculateTransitionDate(AYear, ADaylightDate))
  else
...
class function TdxTimeZoneHelper.AddDSTInfo(var ATimeZoneInfo
  : TcxTimeZoneInformation; const AYear: Integer;
  const AStandardDate, ADaylightDate: TDateTime): Integer;
begin
...
begin
  Result := AddDSTInfo(FTimeZoneInformations[CheckTimeIndex(ATimeZone)], AYear,
    AStandardDate, ADaylightDate);
end;
...
begin
  ...
  begin
    ...
    Result := EncodeDate(AYear, ADSTDateTime.wMonth, ADay) +
      EncodeTime(ADSTDateTime.wHour, ADSTDateTime.wMinute, ADSTDateTime.wSecond,
      ADSTDateTime.wMilliseconds);
  end;
end;

class function TdxTimeZoneHelper.ConvertToGlobalTime(const ADateTime: TDateTime;
  ATimeZone: Integer = -1): TDateTime;
begin
  Result := ADateTime + TimeZoneBias(CheckTimeIndex(ATimeZone));
end;

class function TdxTimeZoneHelper.ConvertToLocalTime(const ADateTime: TDateTime;
  ATimeZone: Integer = -1): TDateTime;
begin
  Result := ADateTime - TimeZoneBias(CheckTimeIndex(ATimeZone));
end;
...
class function TdxTimeZoneHelper.CheckTimeIndex(const AIndex: Integer): Integer;
begin
  Result := AIndex;
  if AIndex = -1 then
...
begin
  ...
  Move(AInfo.StandardName[1], Result.StandardName,
    Length(AInfo.StandardName) shl 1);
  Move(AInfo.DaylightName[1], Result.DaylightName,
    Length(AInfo.DaylightName) shl 1);
end;
...
begin
  ...
  Result := (AInfo^.TZI.StandardDate.wMonth <> 0) and not(ADateTime = NullDate)
    and (AYear > 0);
  if Result then
  begin
    ...
    while (AIndex >= 0) and (AInfo^.DynamicDST[AIndex].Year <> AYear) do
      Dec(AIndex);
    if AIndex < 0 then
      AIndex := AddDSTInfo(AInfo^, AYear, AInfo^.TZI.StandardDate,
...
class function TdxTimeZoneHelper.TimeZoneInfo(AIndex: Integer)
  : TcxTimeZoneInformation;
begin
...
type
  ...
  TdxGetDynamicTZIProc = function(var AInfo: TdxDynamicTimeZoneInformation)
    : DWORD; stdcall;

function dxGetDynamicTimeZoneInformation(var AInfo
  : TdxDynamicTimeZoneInformation): Boolean;
var
...
begin
  ...
  if not ARegistry.HasSubKeys then
    Exit;
  ...
  begin
    ...
    for I := AFirstEntry to ALastEntry do
      if ARegistry.GetDataInfo(IntToStr(I), ARegDataInfo) and
        (ARegDataInfo.RegData = rdBinary) and
        (ARegDataInfo.DataSize >= SizeOf(ADSTInfo)) and
        (ARegistry.ReadBinaryData(IntToStr(I), ADSTInfo, SizeOf(ADSTInfo))
        = SizeOf(ADSTInfo)) then
      ...
      try
        ...
        for I := 0 to ASubKeys.Count - 1 do
          ...
          begin
            ...
            if ((ACurrentZoneKeyName = '') and CompareMem(@ATimeZoneInfo,
              @ACurTimeZoneInfo, SizeOf(ATimeZoneInfo.Bias) +
              SizeOf(ATimeZoneInfo.StandardName))) or
              SameText(ACurrentZoneKeyName, ASubKeys[I]) then
              FCurrentTimeZone := I;
          end;
      finally
        ASubKeys.Free;
...
class function TdxISO8601Helper.StringToDateTime(const AValue: string;
  out AIsUtcTimeZone: Boolean): TDateTime;
var
  S: string;
...
function DaysPerMonth(AYear, AMonth: Integer): Integer;
const
  ADaysInMonth: array [1 .. 12] of Integer = (31, 28, 31, 30, 31, 30, 31, 31,
    30, 31, 30, 31);
begin
...
begin
  if ADay < 1 then
    Result := 1
  else if ADay > DaysPerMonth(AYear, AMonth) then
...
function dxGetLocalFirstWeekOfYear: TcxFirstWeekOfYear;
begin
  Result := TcxFirstWeekOfYear(StrToInt(dxGetLocaleInfo(GetThreadLocale,
    LOCALE_IFIRSTWEEKOFYEAR, '0')[1]) + 1);
end;

function dxGetLocalStartOfWeek: TDay;
begin
  Result := dxDayOfWeekFromSystem(StrToInt(dxGetLocaleInfo(GetThreadLocale,
