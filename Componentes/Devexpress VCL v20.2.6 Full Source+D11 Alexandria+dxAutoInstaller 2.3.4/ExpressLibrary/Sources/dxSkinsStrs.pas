...
resourcestring
  sdxOldFormat =
    ...
    + #13#10 + 'Skins cannot be loaded due to a version mismatch.';
...
const
  ...
  sdxSkinsPDFViewerNavigationPaneButtonMinimized =
    'NavigationPaneButtonMinimized';
  sdxSkinsPDFViewerNavigationPanePageBackground =
    'NavigationPanePageBackground';
  ...
  sdxSkinsCalcEditArithmeticOperationTextColor =
    'CalcEditArithmeticOperationTextColor';
  sdxSkinsCalcEditEditingOperationTextColor =
    'CalcEditEditingOperationTextColor';
  ...
  sdxBreadcrumbEditBackgroundDisabledColor =
    'BreadcrumbEditBackgroundDisabledColor';
  sdxBreadcrumbEditBackgroundFocusedColor =
    'BreadcrumbEditBackgroundFocusedColor';
  ...
  sdxSupportsNavigationControlExtensionToFormCaption =
    'SupportsNavigationControlExtensionToFormCaption';
  ...
  sdxLayoutViewGroupWithoutBordersPadding =
    'LayoutViewGroupWithoutBordersPadding';
  sdxLayoutViewGroupWithoutBordersSpacing =
    'LayoutViewGroupWithoutBordersSpacing';
  ...
  sdxLayoutViewRootGroupWithoutBordersPadding =
    'LayoutViewRootGroupWithoutBordersPadding';
  sdxLayoutViewRootGroupWithoutBordersSpacing =
    'LayoutViewRootGroupWithoutBordersSpacing';
  ...
  sdxNavBarAccordionControlGroupCloseButton =
    'AccordionControlGroupCloseButton';
  ...
  sdxNavBarAccordionControlRootGroupCloseButton =
    'AccordionControlRootGroupCloseButton';
  sdxNavBarAccordionControlRootGroupOpenButton =
    'AccordionControlRootGroupOpenButton';
...
const
  dxDefaultColorPaletteItems: array [0 .. 21] of string = ('Paint',
    'Paint High', 'Paint Shadow', 'Brush', 'Brush Light', 'Brush High',
    'Brush Minor', 'Brush Major', 'Accent Paint', 'Accent Paint Light',
    'Accent Brush', 'Accent Brush Light', 'Key Paint', 'Key Brush',
    'Key Brush Light', 'Black', 'Blue', 'Gray', 'Green', 'Red', 'White',
    'Yellow');

  dxDefaultGlyphColorPaletteItems: array [0 .. 5] of string = ('Yellow',
...
const
  ...
  BreadcrumbEditBackgroundColorsMap: array [TdxBreadcrumbEditState]
    of string = (sdxBreadcrumbEditBackgroundColor,
    sdxBreadcrumbEditBackgroundFocusedColor,
    sdxBreadcrumbEditBackgroundHotColor,
    sdxBreadcrumbEditBackgroundDisabledColor);

  BreadcrumbEditBordersColorsMap: array [TdxBreadcrumbEditState]
    of string = (sdxBreadcrumbEditBorderColor,
    sdxBreadcrumbEditBorderFocusedColor, sdxBreadcrumbEditBorderHotColor,
    sdxBreadcrumbEditBorderDisabledColor);

  CommonGroup: array [0 .. 25] of string = (sdxSkinGroupCommon, sdxButton,
    sdxGroupPanel, sdxGroupPanelBottom, sdxGroupPanelCaptionBottom,
    sdxGroupPanelCaptionLeft, sdxGroupPanelCaptionRight,
    sdxGroupPanelCaptionTop, sdxGroupPanelLeft, sdxGroupPanelRight,
    sdxGroupPanelTop, sdxFilterBoolOperatorBackground,
    sdxFilterItemCaptionBackground, sdxFilterOperatorBackground,
    sdxFilterPanelBrackets, sdxFilterAddButton, sdxFilterRemoveButton,
    sdxFilterValueBackground, sdxScrollButton, sdxScrollContentHorz,
    sdxScrollContentVert, sdxScrollThumbButtonHorz, sdxScrollThumbButtonVert,
    sdxSizeGrip, sdxSplitterHorz, sdxSplitterVert);

  EditorsGroup: array [0 .. 22] of string = (sdxSkinGroupEditors, sdxCheckbox,
    sdxCloseButton, sdxComboButtonGlyph, sdxEditorButton, sdxNavigatorGlyphs,
    sdxProgressBorder, sdxProgressBorderVert, sdxProgressChunk,
    sdxProgressChunkVert, sdxRadioGroup, sdxSpinDownGlyph, sdxSpinLeftGlyph,
    sdxSpinRightGlyph, sdxSpinUpGlyph, sdxTrackBarThumb, sdxTrackBarThumbBoth,
    sdxTrackBarThumbUp, sdxTrackBarThumbVert, sdxTrackBarThumbVertBoth,
    sdxTrackBarThumbVertUp, sdxTrackBarTrack, sdxTrackBarTrackVert);

  GanttGroup: array [0 .. 10] of string = (sdxSkinGroupGantt,
    sdxGanttDependencyEditPointLeft, sdxGanttDependencyEditPointRight,
    sdxGanttFocusedRow, sdxGanttMilestone, sdxGanttSummaryTask,
    sdxGanttSummaryTaskProgress, sdxGanttTask, sdxGanttTaskProgress,
    sdxGanttTaskTextLabel, sdxGanttTaskTextLabelHorizontalIndent);

  GridGroup: array [0 .. 14] of string = (sdxSkinGroupGrid, sdxFilterButton,
    sdxFilterButtonActive, sdxFilterPanel, sdxFooterCell, sdxFooterPanel,
    sdxGroupByBox, sdxGroupRow, sdxHeader, sdxHeaderLeft, sdxHeaderRight,
    sdxHeaderSpecial, sdxIndicatorImages, sdxPlusMinus, sdxPlusMinusEx);

  VGridGroup: array [0 .. 4] of string = (sdxSkinGroupVGrid, sdxVGridBandLine,
    sdxVGridLine, sdxVGridRowHeader, sdxVGridCategory);

  FormGroup: array [0 .. 13] of string = (sdxFormFrameLeft, sdxFormCaption,
    sdxFormFrameRight, sdxFormFrameBottom, sdxSmallFormFrameLeft,
    sdxSmallFormCaption, sdxSmallFormFrameRight, sdxSmallFormFrameBottom,
    sdxSmallFormButtonClose, sdxFormButtonClose, sdxFormButtonMinimize,
    sdxFormButtonMaximize, sdxFormButtonRestore, sdxFormButtonHelp);

  EditButtonsMap: array [TcxEditBtnKind] of string = (sdxCloseButton,
    sdxComboButtonGlyph, sdxEditorButton, sdxEditorButton, sdxSpinUpGlyph,
    sdxSpinDownGlyph, sdxSpinLeftGlyph, sdxSpinRightGlyph);

  FormFrameMap: array [Boolean, TcxBorder] of string =
    ((sdxFormFrameLeft, sdxSmallFormCaption, sdxFormFrameRight,
    sdxFormFrameBottom), (sdxFormFrameLeft, sdxFormCaption, sdxFormFrameRight,
    sdxFormFrameBottom));
  ...
  EditBackgroundColorsMap: array [TcxEditStateColorKind] of string =
    ...
    sdxSkinsEditorBackgroundInactiveColor,
    sdxSkinsEditorBackgroundReadOnlyColor);
