...
type
  ...
  protected
    function DoGet(const AUri: string; AResponseContent: TStream)
      : Boolean; virtual;
    procedure DoRequest(AHttpRequestMode: TdxHttpRequestMode;
      AWorkCount: Int64);
  public
    function Get(const AUri: string; AResponseContent: TStream)
      : Boolean; override;
...
begin
  AHTTP.Request.UserAgent := StringReplace(AHTTP.Request.UserAgent,
    'Indy Library', Application.Title, []);
end;
...
procedure TdxHttpIndyRequest.DoRequest(AHttpRequestMode: TdxHttpRequestMode;
  AWorkCount: Int64);
begin
...
procedure TdxHttpIndyRequest.DoWork(ASender: TObject; AWorkMode: TWorkMode;
  AWorkCount: Int64);
const
  WorkModeToRequestMode: array [TWorkMode] of TdxHttpRequestMode = (mhrmRead,
    mhrmWrite);
begin
