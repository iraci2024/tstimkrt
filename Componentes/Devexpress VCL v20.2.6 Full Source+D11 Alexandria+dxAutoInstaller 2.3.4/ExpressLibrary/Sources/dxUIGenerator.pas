...
{$IFDEF DELPHI16}
  UITypes,
{$ENDIF}
  Windows, Types, TypInfo, Menus, Classes, Generics.Defaults,
  Generics.Collections, Graphics, ImgList, ActnList,
...
type
  ...
  TdxUIGeneratorItemPosition = (ugipBeginsNewRow, ugipBeginsNewColumn,
    ugipContinuesRow);
...
const
  dxUIGeneratorItemDefaultViewLevels = [ugivlLargeIcon, ugivlSmallIcon,
    ugivlText];
...
type
  ...
  TdxUIGeneratorCommandsEnumProc = reference to procedure
    (AInfo: TdxUIGeneratorCommandInfo);
  ...
  public
    ...
    function Add(AAction: TdxBasicActionClass;
      AViewLevels: TdxUIGeneratorItemViewLevels =
      dxUIGeneratorItemDefaultViewLevels;
    ...
    function Add(const AImageFileName, ACaption: string;
      ...
      APosition: TdxUIGeneratorItemPosition = ugipBeginsNewRow;
      ABeginGroup: Boolean = False): TdxUIGeneratorCommandInfo; overload;
    function Add(AGalleryClientAction: TdxBasicActionClass;
      AShowItemCaption, AShowItemDescription: Boolean;
      ACollapsed: Boolean = False; AResizable: Boolean = True;
      AColumnCount: Integer = 5; AItemDescriptionRowCount: Integer = 2;
      AUseLargeImages: Boolean = True;
  ...
  public
    constructor Create(AOwner: TdxUIGeneratorComponentInfo;
      const ATabName, ABarName, ABarGlyphFileName: string;
      ARowIndex: Integer = -1);
  ...
  TdxUIGeneratorGalleryInfo = class(TdxUIGeneratorCommandInfo,
  ...
  public
    ...
    procedure Add(AActionIndex: Variant; const AGroupCaption, ACaption: string;
      const ADescription: string = ''; const AImageFileName: string = '';
      AExternalImageIndex: Integer = -1); overload;
    function GetGroups: TObject;
    procedure SetExternalImageList(AImageList: TCustomImageList);

    property GroupItems: TObjectList<TdxUIGeneratorGalleryGroupItemInfo>
      read FGroupItems;
  end;
  ...
  public
    constructor Create;
    destructor Destroy; override;
    function Add(const ATabName, ABarName: string; ARowIndex: Integer = -1)
      : TdxUIGeneratorCategoryInfo; overload;
    function Add(const ATabName, ABarName, ABarGlyphFileName: string;
      ARowIndex: Integer = -1): TdxUIGeneratorCategoryInfo; overload;
    //
    property Categories: TObjectList<TdxUIGeneratorCategoryInfo>
      read FCategories;
  ...
  protected
    procedure AddImage(AAction: TAction; const AImageFileName: string;
      out ASmallImageIndex, ALargeImageIndex: Integer); overload;
    function AddImage(ATargetImageList: TCustomImageList;
      const AImageFileName: string): Integer; overload;
    function GetAction(AItem: TdxUIGeneratorCommandInfo): TAction;
    procedure PlaceCommand(AAction: TAction; AItem: TdxUIGeneratorCommandInfo);
      virtual; abstract;
  ...
  public
    ...
    property LargeImageList: TCustomImageList read FLargeImageList
      write FLargeImageList;
    property SmallImageList: TCustomImageList read FSmallImageList
      write FSmallImageList;
  end;
  ...
  public
    class function AddImage(ATargetImageList: TCustomImageList;
      const AImageFileName, AImageSet: string): Integer;
    class function CreateComponent(AOwner: TComponent; AClass: TComponentClass)
      : TComponent; static;
    class function CreateImageList(AOwner: TComponent; ASize: Integer)
      : TCustomImageList; static;
    class function FindComponentByClass(AParent: TComponent;
      AClass: TComponentClass): TComponent; static;
    class function GenerateCategoryName(ACategory
      : TdxUIGeneratorCategoryInfo): string;
    class function GenerateName(AComponent: TComponent;
      const AUseCaption: Boolean = True): string;
    class procedure LoadImage(ATarget: TdxSmartImage;
      const AImageFileName, AImageSet: string); overload;
    class function LoadImage(const AImageFileName, AImageSet: string)
  ...
  strict private
    ...
    class var FComponents: TObjectDictionary<TComponentClass,
      TdxUIGeneratorComponentInfo>;

    class function GetAdapterCount: Integer; static;
    class function GetAdapterItem(Index: Integer)
      : TdxUIGeneratorAdapterClass; static;
  protected
    class procedure FreeResources;
  public
    class function GetAdapter(ATargetComponent: TComponent;
      out AAdapter: TdxUIGeneratorAdapterClass): Boolean;
    class function GetComponentInfo(ASourceComponent: TComponent;
      out AInfo: TdxUIGeneratorComponentInfo): Boolean; overload;
    class function GetComponentInfo(ASourceComponent: TComponent;
      out AInfoList: TdxUIGeneratorComponentInfoList): Boolean; overload;
    class function GetComponentInfo(ASourceComponentClass: TComponentClass;
      out AInfo: TdxUIGeneratorComponentInfo): Boolean; overload;
    class function GetComponentInfo(ASourceComponentClass: TComponentClass;
      out AInfoList: TdxUIGeneratorComponentInfoList): Boolean; overload;

    class procedure RegisterAdapter(AAdapterClass: TdxUIGeneratorAdapterClass);
    class function RegisterComponent(AComponentClass: TComponentClass;
      const ADisplayName: string): TdxUIGeneratorComponentInfo;
    class procedure UnregisterAdapter(AAdapterClass
      : TdxUIGeneratorAdapterClass);
    class procedure UnregisterComponent(AComponentClass: TComponentClass);
    //
    class property Adapters[Index: Integer]: TdxUIGeneratorAdapterClass
      read GetAdapterItem;
...
constructor TdxUIGeneratorCategoryInfo.Create
  (AOwner: TdxUIGeneratorComponentInfo; const ATabName, ABarName,
  ABarGlyphFileName: string; ARowIndex: Integer = -1);
begin
  inherited Create;
  FOwner := AOwner;
...
procedure TdxUIGeneratorGalleryInfo.Add(AActionIndex: Variant;
  const AGroupCaption, ACaption: string; const ADescription: string = '';
  const AImageFileName: string = ''; AExternalImageIndex: Integer = -1);
var
...
procedure TdxUIGeneratorGalleryInfo.SetExternalImageList
...
function TdxUIGeneratorCommands.Add(AGalleryClientAction: TdxBasicActionClass;
  AShowItemCaption, AShowItemDescription: Boolean; ACollapsed: Boolean = False;
  AResizable: Boolean = True; AColumnCount: Integer = 5;
...
begin
  ...
  else if Parent is TdxUIGeneratorCommandInfo then
...
function TdxUIGeneratorComponentInfo.Add(const ATabName, ABarName: string;
  ARowIndex: Integer = -1): TdxUIGeneratorCategoryInfo;
begin
  Result := Add(ATabName, ABarName, '', ARowIndex);
end;

function TdxUIGeneratorComponentInfo.Add(const ATabName, ABarName,
  ABarGlyphFileName: string; ARowIndex: Integer = -1)
  : TdxUIGeneratorCategoryInfo;
begin
  Result := TdxUIGeneratorCategoryInfo.Create(Self, ATabName, ABarName,
    ABarGlyphFileName, ARowIndex);
...
procedure TdxUIGeneratorAdapter.Generate(AComponent
  : TdxUIGeneratorComponentInfo);
var
  I: Integer;
begin
...
class function TdxUIGeneratorAdapter.CanCreateComponent
  (AOwner: TComponent): Boolean;
begin
  Result := TdxUIGeneratorHelper.FindComponentByClass(AOwner,
    GetComponentClass) = nil;
end;

class function TdxUIGeneratorAdapter.CreateComponent(AOwner: TComponent)
  : TComponent;
begin
...
procedure TdxUIGeneratorAdapter.AddImage(AAction: TAction;
  const AImageFileName: string; out ASmallImageIndex, ALargeImageIndex
  : Integer);
begin
  ...
  else if SmallImageList = LargeImageList then
    ALargeImageIndex := ASmallImageIndex
  else
    ALargeImageIndex := AddImage(LargeImageList, AImageFileName)
end;

function TdxUIGeneratorAdapter.AddImage(ATargetImageList: TCustomImageList;
  const AImageFileName: string): Integer;
begin
  Result := TdxUIGeneratorHelper.AddImage(ATargetImageList, AImageFileName,
    ImageSet);
end;

function TdxUIGeneratorAdapter.GetAction
  (AItem: TdxUIGeneratorCommandInfo): TAction;
begin
  Result := nil;
  if AItem.Action <> nil then
  begin
    Result := TdxUIGeneratorHelper.FindComponentByClass(OwnerForm, AItem.Action)
      as TAction;
    if Result = nil then
    begin
      ...
      if AItem.ImageFileName = '' then
        AItem.ImageFileName := TdxBasicActionAccess(Result)
          .FDefaultImageNameInIconLibrary;
      Result.ImageIndex := AddImage(ActionList.Images, AItem.ImageFileName);
      Result.Category := TdxUIGeneratorHelper.GenerateCategoryName
        (AItem.Category);
...
begin
  if ActionList = nil then
    ActionList := TActionList(TdxUIGeneratorHelper.CreateComponent(OwnerForm,
      TActionList));
end;
...
class function TdxUIGeneratorHelper.AddImage(ATargetImageList: TCustomImageList;
  const AImageFileName, AImageSet: string): Integer;
var
...
begin
  ...
  begin
    AImage := LoadImage(ChangeFileExt(AImageFileName, Format('_%dx%d%s',
      [ATargetImageList.Width, ATargetImageList.Height,
      ExtractFileExt(AImageFileName)])), AImageSet);
    if AImage <> nil then
      try
...
class function TdxUIGeneratorHelper.CreateComponent(AOwner: TComponent;
...
class function TdxUIGeneratorHelper.CreateImageList(AOwner: TComponent;
  ASize: Integer): TCustomImageList;
begin
...
class function TdxUIGeneratorHelper.FindComponentByClass(AParent: TComponent;
  AClass: TComponentClass): TComponent;
var
  I: Integer;
begin
...
class function TdxUIGeneratorHelper.GenerateCategoryName
  (ACategory: TdxUIGeneratorCategoryInfo): string;
begin
  Result := ACategory.Owner.DisplayName + '.' + ACategory.TabName + '.' +
    ACategory.BarName;
end;

class function TdxUIGeneratorHelper.GenerateName(AComponent: TComponent;
  const AUseCaption: Boolean = True): string;
var
  AInfo: PPropInfo;
  ASuffix: string;
begin
  ...
  Result := CreateUniqueName(AComponent.Owner, nil, AComponent, '',
    Copy(AComponent.ClassName + ASuffix, 2, MaxInt),
    Ord(AUseCaption and (ASuffix = '')));
end;

class procedure TdxUIGeneratorHelper.LoadImage(ATarget: TdxSmartImage;
  const AImageFileName, AImageSet: string);
var
...
class function TdxUIGeneratorHelper.LoadImage(const AImageFileName,
  AImageSet: string): TdxSmartImage;
var
  AFileName: string;
begin
  Result := nil;
...
class function TdxUIGenerator.GetAdapter(ATargetComponent: TComponent;
  out AAdapter: TdxUIGeneratorAdapterClass): Boolean;
var
...
class function TdxUIGenerator.GetComponentInfo(ASourceComponent: TComponent;
  out AInfo: TdxUIGeneratorComponentInfo): Boolean;
begin
  Result := GetComponentInfo
    (TComponentClass(ASourceComponent.ClassType), AInfo);
end;

class function TdxUIGenerator.GetComponentInfo(ASourceComponent: TComponent;
  out AInfoList: TdxUIGeneratorComponentInfoList): Boolean;
begin
  Result := GetComponentInfo(TComponentClass(ASourceComponent.ClassType),
    AInfoList);
end;

class function TdxUIGenerator.GetComponentInfo(ASourceComponentClass
  : TComponentClass; out AInfo: TdxUIGeneratorComponentInfo): Boolean;
var
...
class function TdxUIGenerator.GetComponentInfo(ASourceComponentClass
  : TComponentClass; out AInfoList: TdxUIGeneratorComponentInfoList): Boolean;
var
  AClassParent: TClass;
...
class procedure TdxUIGenerator.RegisterAdapter(AAdapterClass
  : TdxUIGeneratorAdapterClass);
begin
...
class function TdxUIGenerator.RegisterComponent(AComponentClass
  : TComponentClass; const ADisplayName: string): TdxUIGeneratorComponentInfo;
begin
  Result := TdxUIGeneratorComponentInfo.Create;
  Result.DisplayName := ADisplayName;
  if FComponents = nil then
    FComponents := TObjectDictionary<TComponentClass,
      TdxUIGeneratorComponentInfo>.Create([doOwnsValues]);
  FComponents.AddOrSetValue(AComponentClass, Result);
end;

class procedure TdxUIGenerator.UnregisterAdapter(AAdapterClass
  : TdxUIGeneratorAdapterClass);
begin
  if FAdapters <> nil then
  begin
...
class procedure TdxUIGenerator.UnregisterComponent(AComponentClass
  : TComponentClass);
begin
  if FComponents <> nil then
  begin
...
class function TdxUIGenerator.GetAdapterItem(Index: Integer)
  : TdxUIGeneratorAdapterClass;
begin
