...
{$IFDEF DELPHI16}
  UITypes,
{$ENDIF}
  Types, Menus, Classes, Graphics, cxControls, cxClasses, dxCore, ImgList,
  cxGraphics, cxLookAndFeels, ActnList, Forms;

type

  { TdxCustomBuiltInPopupMenuAdapter }

  TdxCustomBuiltInPopupMenuAdapterClass = class of
    TdxCustomBuiltInPopupMenuAdapter;
  ...
  public
    function Add(const ACaption: string; AClickEvent: TNotifyEvent;
      ATag: TcxTag = 0; AImageIndex: TcxImageIndex = -1;
      AEnabled: Boolean = True; AShortCut: TShortCut = 0;
      AParentItem: TComponent = nil): TComponent; virtual; abstract;
    function AddSubMenu(const ACaption: string; AClickEvent: TNotifyEvent;
      ATag: TcxTag = 0; AImageIndex: TcxImageIndex = -1;
      AEnabled: Boolean = True; AShortCut: TShortCut = 0;
      AParentItem: TComponent = nil): TComponent; virtual; abstract;
    ...
    procedure SetAction(AItem: TComponent; AValue: TBasicAction);
      virtual; abstract;
    ...
    procedure SetImages(AItem: TComponent; AImages: TCustomImageList); overload;
      virtual; abstract;
  ...
  public
    class procedure AddMenu(AAdapter: TdxCustomBuiltInPopupMenuAdapter;
      AMenu: TPopupMenu; AClickEvent: TNotifyEvent);
    class function AddMenuItem(AAdapter: TdxCustomBuiltInPopupMenuAdapter;
      AMenuItem: TMenuItem; AClickEvent: TNotifyEvent; ATag: TcxTag = 0;
...
procedure TdxCustomBuiltInPopupMenuAdapter.SetLookAndFeel
...
class procedure TdxBuiltInPopupMenuAdapterHelper.AddMenu
  (AAdapter: TdxCustomBuiltInPopupMenuAdapter; AMenu: TPopupMenu;
  ...
  begin
    ...
    begin
      AParentItem := AddMenuItem(AAdapter, AMenuItem, AClickEvent,
        TcxTag(AMenuItem), AParentItem);
...
class function TdxBuiltInPopupMenuAdapterHelper.AddMenuItem
  (AAdapter: TdxCustomBuiltInPopupMenuAdapter; AMenuItem: TMenuItem;
  AClickEvent: TNotifyEvent; ATag: TcxTag; AParentItem: TComponent): TComponent;
begin
  ...
  begin
    if AMenuItem.Count > 0 then
      Result := AAdapter.AddSubMenu(AMenuItem.Caption, AClickEvent, ATag,
        AMenuItem.ImageIndex, AMenuItem.Enabled, AMenuItem.ShortCut,
        AParentItem)
    else
...
function TdxStandardBuiltInPopupMenuAdapter.Add(const ACaption: string;
  AClickEvent: TNotifyEvent; ATag: TcxTag = 0; AImageIndex: TcxImageIndex = -1;
  AEnabled: Boolean = True; AShortCut: TShortCut = 0;
  AParentItem: TComponent = nil): TComponent;
var
  AMenuItem: TMenuItem;
...
function TdxStandardBuiltInPopupMenuAdapter.AddSubMenu(const ACaption: string;
  AClickEvent: TNotifyEvent; ATag: TcxTag = 0; AImageIndex: TcxImageIndex = -1;
  AEnabled: Boolean = True; AShortCut: TShortCut = 0;
  AParentItem: TComponent = nil): TComponent;
begin
  Result := Add(ACaption, AClickEvent, ATag, AImageIndex, AEnabled, AShortCut,
    AParentItem);
end;
...
procedure TdxStandardBuiltInPopupMenuAdapter.SetAction(AItem: TComponent;
  AValue: TBasicAction);
begin
  (AItem as TMenuItem).Action := AValue;
end;

procedure TdxStandardBuiltInPopupMenuAdapter.SetChecked(AItem: TComponent;
  AValue: Boolean);
begin
  (AItem as TMenuItem).Checked := AValue;
end;

procedure TdxStandardBuiltInPopupMenuAdapter.SetDefault(AItem: TComponent;
  AValue: Boolean);
begin
  (AItem as TMenuItem).Default := AValue;
end;

procedure TdxStandardBuiltInPopupMenuAdapter.SetGlyph(AItem: TComponent;
  AGlyph: TGraphic);
var
  ABitmap: TBitmap;
  AMenuItem: TMenuItem;
...
procedure TdxStandardBuiltInPopupMenuAdapter.SetImages
  (AImages: TCustomImageList);
begin
  TPopupMenu(PopupMenu).Images := AImages;
end;

procedure TdxStandardBuiltInPopupMenuAdapter.SetImages(AItem: TComponent;
  AImages: TCustomImageList);
begin
...
class function TdxBuiltInPopupMenuAdapterManager.GetActualAdapterClass
  : TdxCustomBuiltInPopupMenuAdapterClass;
begin
  Result := TdxCustomBuiltInPopupMenuAdapterClass(FRegisteredClasses.Last);
end;

class function TdxBuiltInPopupMenuAdapterManager.
  IsActualAdapterStandard: Boolean;
begin
  Result := GetActualAdapterClass = TdxStandardBuiltInPopupMenuAdapter;
end;

class procedure TdxBuiltInPopupMenuAdapterManager.Register
  (AClass: TdxCustomBuiltInPopupMenuAdapterClass);
begin
...
class procedure TdxBuiltInPopupMenuAdapterManager.Unregister
  (AClass: TdxCustomBuiltInPopupMenuAdapterClass);
begin
...
TdxBuiltInPopupMenuAdapterManager.Unregister
  (TdxStandardBuiltInPopupMenuAdapter);
