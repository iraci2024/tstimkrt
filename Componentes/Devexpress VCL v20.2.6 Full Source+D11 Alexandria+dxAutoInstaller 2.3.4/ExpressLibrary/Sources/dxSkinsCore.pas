...
{$ENDIF}
  ...
  Forms, ActiveX, Contnrs, cxClasses, cxLookAndFeels, dxGDIPlusApi,
  dxGDIPlusClasses, dxSkinsStrs, dxOffice11, dxCore,
  dxCoreGraphics, cxLookAndFeelPainters, dxSmartImage, dxDPIAwareUtils,
  cxCustomCanvas;
...
type
  ...
  TdxSkinChangeNotify = procedure(Sender: TObject; AChanges: TdxSkinChanges)
    of object;
  ...
  protected
    ...
    procedure DataRead(Stream: TStream;
      const AVersion: TdxSkinVersion); virtual;
  ...
  strict private
    ...
    class function CompareByName(AItem1, AItem2: TdxSkinCustomObject)
      : Integer; static;
  protected
    procedure Changed(AChanges: TdxSkinChanges); virtual;
    ...
    procedure DataReadItem(AStream: TStream; const AVersion: TdxSkinVersion);
      virtual; abstract;
    procedure DataWrite(AStream: TStream);
    procedure DataWriteItem(AStream: TStream; AItem: TdxSkinCustomObject);
      virtual; abstract;
    //
    property OnChange: TdxSkinChangeNotify read FOnChange write FOnChange;
  public
    ...
    constructor CreateEx(AOwner: TPersistent;
      AChangeHandler: TdxSkinChangeNotify);
    procedure BeginUpdate;
    procedure EndUpdate;
  ...
  protected
    procedure DataReadItem(AStream: TStream;
      const AVersion: TdxSkinVersion); override;
    procedure DataWriteItem(AStream: TStream;
      AItem: TdxSkinCustomObject); override;
  public
    function Add(const AName: string; AClass: TdxSkinPropertyClass)
      : TdxSkinProperty;
  ...
  protected
    ...
    procedure SortChildren; override;
  public
    function Add(const AName: string; AClass: TdxSkinElementClass)
      : TdxSkinElement;
  ...
  private
    ...
    procedure DataWrite(AStream: TStream);
  public
    constructor Create(AOwner: TdxSkinCustomObject;
      ADefaultValue: TColor = clDefault);
    ...
    property ValueReference: string read FValueReference
      write SetValueReference;
  end;
  ...
  public
    ...
    function AddPropertyBool(const AName: string; AValue: Boolean)
      : TdxSkinBooleanProperty;
    function AddPropertyColor(const AName: string; AValue: TColor)
      : TdxSkinColor;
    function AddPropertyInteger(const AName: string; AValue: Integer)
      : TdxSkinIntegerProperty;
    //
    procedure Clear; virtual;
    procedure DeleteProperty(const AProperty: TdxSkinProperty);
      overload; virtual;
    ...
    function GetPropertyByName(const AName: string;
      out AProperty: TdxSkinProperty): Boolean; overload;
  ...
  published
    property Value: TColor read GetValue write SetValue;
    property ValueReference: string read GetValueReference
      write SetValueReference;
  end;
  ...
  public
    ...
    function Compare(AProperty: TdxSkinProperty): Boolean; override;
  published
    property ValueAlpha: Byte read FValueAlpha write SetValueAlpha
      default MaxByte;
  end;
  ...
  published
    property Left: Integer index 0 read GetValueByIndex write SetValueByIndex
      default 0;
    property Top: Integer index 1 read GetValueByIndex write SetValueByIndex
      default 0;
    property Right: Integer index 2 read GetValueByIndex write SetValueByIndex
      default 0;
    property Bottom: Integer index 3 read GetValueByIndex write SetValueByIndex
      default 0;
  end;
  ...
  published
    property cx: Integer index 0 read GetValueByIndex write SetValueByIndex
      default 0;
    property cy: Integer index 1 read GetValueByIndex write SetValueByIndex
      default 0;
  end;
  ...
  protected
    ...
    procedure FlushCache; override;
  public
    constructor Create(AOwner: TPersistent; AKind: TcxBorder);
      reintroduce; virtual;
    function Compare(AProperty: TdxSkinProperty): Boolean; override;
  ...
  published
    ...
    property ColorReference: string read GetColorReference
      write SetColorReference;
  ...
  protected
    ...
    procedure DataRead(AStream: TStream;
      const AVersion: TdxSkinVersion); override;
  ...
  published
    property Left: TdxSkinBorder index 0 read GetBorderByIndex
      write SetBorderByIndex;
    property Top: TdxSkinBorder index 1 read GetBorderByIndex
      write SetBorderByIndex;
    property Right: TdxSkinBorder index 2 read GetBorderByIndex
      write SetBorderByIndex;
    property Bottom: TdxSkinBorder index 3 read GetBorderByIndex
      write SetBorderByIndex;
  end;
  ...
  published
    ...
    property BordersInner: TdxSkinBorders read FBordersInner
      write SetBordersInner;
    property ContentOffsets: TcxRect read FContentOffsets
      write SetContentOffsets;
    property Gradient: TdxSkinGradientMode read FGradient write SetGradientMode
      default gmHorizontal;
    property GradientBeginColor: TColor read GetGradientBeginColor
      write SetGradientBeginColor default clNone;
    property GradientBeginColorReference: string
      read GetGradientBeginColorReference write SetGradientBeginColorReference;
    property GradientEndColor: TColor read GetGradientEndColor
      write SetGradientEndColor default clNone;
    property GradientEndColorReference: string read GetGradientEndColorReference
      write SetGradientEndColorReference;
  end;
  ...
  protected
    ...
    procedure DataWrite(Stream: TStream); override;
    procedure FlushCache; override;
    procedure HandlerPropertiesChanged(Sender: TObject;
      Changes: TdxSkinChanges);
  public
    constructor Create(AOwner: TPersistent; const AName: string); override;
    destructor Destroy; override;
  ...
  protected
    ...
    function AddCore(const AName: string; AValue: TColor;
      AValueReference: string): TdxSkinColor;
  ...
  public
    ...
    function AddElementEx(const AName: string;
      AElementClass: TdxSkinElementClass): TdxSkinElement;
    function GetElementByName(const AName: string): TdxSkinElement; overload;
    function GetElementByName(const AName: string; out AElement: TdxSkinElement)
      : Boolean; overload;
    procedure Clear; override;
    ...
    //
    property Count: Integer read GetCount;
    property Elements[Index: Integer]: TdxSkinElement read GetElement
      write SetElement;
  ...
  TdxSkinImagePart = (sipTopLeft, sipTop, sipTopRight, sipLeft, sipCenter,
    sipRight, sipBottomLeft, sipBottom, sipBottomRight);
  ...
  strict private
    ...
    function GetStateBounds(AImageIndex: Integer;
      AState: TdxSkinElementState): TRect;
    ...
    procedure HandlerColorPaletteChanged(Sender: TObject;
      Changes: TdxSkinChanges);
  ...
  protected
    ...
    procedure FlushCache; virtual;
    function GetPalette(AState: TdxSkinElementState;
      ACanUseGlobalPalette: Boolean = True): IdxColorPalette;
  ...
  public
    ...
    procedure Draw(DC: HDC; const ARect: TRect; AImageIndex: Integer = 0;
      AState: TdxSkinElementState = esNormal); overload;
    procedure Draw(DC: HDC; const ARect: TRect; AScaleFactor: TdxScaleFactor;
      ...
      overload; virtual;
    procedure Draw(ACanvas: TcxCustomCanvas; const ARect: TRect;
      AScaleFactor: TdxScaleFactor; AImageIndex: Integer = 0;
      AState: TdxSkinElementState = esNormal); overload; virtual;
    ...
    procedure DrawEx(ACanvas: TdxGPCanvas; const ARect: TRect;
      AScaleFactor: TdxScaleFactor; AImageIndex: Integer = 0;
      AState: TdxSkinElementState = esNormal); overload; virtual;
    procedure RightToLeftDependentDraw(DC: HDC; ARect: TRect;
      AScaleFactor: TdxScaleFactor; AIsRightToLeftLayout: Boolean;
      AImageIndex: Integer = 0;
      AState: TdxSkinElementState = esNormal); overload;
    procedure RightToLeftDependentDraw(ACanvas: TcxCustomCanvas; ARect: TRect;
      AScaleFactor: TdxScaleFactor; AIsRightToLeftLayout: Boolean;
      AImageIndex: Integer = 0;
      AState: TdxSkinElementState = esNormal); overload;
    ...
    procedure LoadFromResource(AInstance: THandle; const AName: string;
      AType: PChar);
    ...
    property StateBounds[ImageIndex: Integer; State: TdxSkinElementState]: TRect
      read GetStateBounds;
  ...
  published
    ...
    property ImageLayout: TdxSkinImageLayout read FImageLayout
      write SetImageLayout default ilHorizontal;
  ...
  TdxSkinAlternateImageSet = array [TdxSkinElementState]
    of TdxSkinAlternateImageAttributes;
  ...
  protected
    ...
    procedure AssignCore(Source: TPersistent); override;
    function CanUseAlternateImageSet(AImageIndex: Integer;
      AState: TdxSkinElementState; ALowColorsMode: Boolean;
    ...
    procedure FlushCache; override;
    //
    property AlternateImageSetDirty: Boolean read FAlternateImageSetDirty
      write FAlternateImageSetDirty;
  ...
  public
    ...
    function GetTextColor(AState: TcxButtonState;
      const APropertyPrefix: string = ''): TColor; overload; virtual;
    function GetTextColor(const AName: string): TColor; overload; virtual;
    procedure Dormant; virtual;
    ...
    procedure Draw(ACanvas: TcxCustomCanvas; const ARect: TRect;
      AScaleFactor: TdxScaleFactor; AImageIndex: Integer = 0;
      AState: TdxSkinElementState = esNormal); overload;
    procedure Draw(ACanvas: TdxGPCanvas; const ARect: TRect;
      AScaleFactor: TdxScaleFactor; AImageIndex: Integer = 0;
      AState: TdxSkinElementState = esNormal); overload;
    procedure DrawEx(ACanvas: TdxGPCanvas; const ARect: TRect;
      AImageIndex: Integer = 0;
    ...
    procedure DrawEx(ACanvas: TdxGPCanvas; const ARect: TRect;
      AScaleFactor: TdxScaleFactor; AImageIndex: Integer = 0;
      AState: TdxSkinElementState = esNormal); overload; virtual;
    procedure RightToLeftDependentDraw(DC: HDC; const ARect: TRect;
      AScaleFactor: TdxScaleFactor; AIsRightToLeftLayout: Boolean;
      AImageIndex: Integer = 0;
      AState: TdxSkinElementState = esNormal); overload;
    procedure RightToLeftDependentDraw(ACanvas: TcxCustomCanvas;
      const ARect: TRect; AScaleFactor: TdxScaleFactor;
      AIsRightToLeftLayout: Boolean; AImageIndex: Integer = 0;
      AState: TdxSkinElementState = esNormal); overload;
    procedure RightToLeftDependentDraw(ACanvas: TdxGPCanvas; ARect: TRect;
      AScaleFactor: TdxScaleFactor; AIsRightToLeftLayout: Boolean;
      AImageIndex: Integer = 0;
      AState: TdxSkinElementState = esNormal); overload;

    function GetImage(AImageIndex: Integer; ASize: TSize;
      AScaleFactor: TdxScaleFactor; AState: TdxSkinElementState = esNormal)
      : TdxSmartImage; overload;
    function GetImage(AImageIndex: Integer; const ASize: TSize;
      AState: TdxSkinElementState = esNormal): TdxSmartImage; overload;
  ...
  published
    ...
    property TextColor: TColor read GetTextColorPropertyValue
      write SetTextColorPropertyValue default clDefault;
    property TextColorReference: string read GetTextColorReference
      write SetTextColorReference;
  end;
  ...
  strict private
    ...
    procedure InternalRightToLeftDependentDraw(DC: HDC; const R: TRect;
      AIsRightToLeftLayout: Boolean);
  protected
  ...
  public
    ...
    procedure CheckCacheState(AElement: TdxSkinElement; const R: TRect;
      ...
      AImageIndex: Integer = 0); overload;
    procedure CheckCacheState(AElement: TdxSkinElement; const R: TRect;
      AScaleFactor: TdxScaleFactor; AState: TdxSkinElementState = esNormal;
      AImageIndex: Integer = 0); overload;
    ...
    procedure DrawEx(DC: HDC; AElement: TdxSkinElement; const R: TRect;
      AScaleFactor: TdxScaleFactor; AState: TdxSkinElementState = esNormal;
      AImageIndex: Integer = 0); overload;
    procedure DrawEx(ACanvas: TdxGPCanvas; AElement: TdxSkinElement;
      const R: TRect; AScaleFactor: TdxScaleFactor;
      AState: TdxSkinElementState = esNormal;
      AImageIndex: Integer = 0); overload;
    procedure Flush;
    procedure RightToLeftDependentDraw(DC: HDC; AElement: TdxSkinElement;
      const R: TRect; AScaleFactor: TdxScaleFactor;
      AIsRightToLeftLayout: Boolean; AState: TdxSkinElementState = esNormal;
      AImageIndex: Integer = 0);
  end;
  ...
  protected
    ...
    function TryGet(AElement: TdxSkinElement; const R: TRect;
      AState: TdxSkinElementState; AImageIndex: Integer;
  ...
  public
    ...
    procedure DrawElement(DC: HDC; AElement: TdxSkinElement; const R: TRect;
      AScaleFactor: TdxScaleFactor; AState: TdxSkinElementState = esNormal;
      AImageIndex: Integer = 0); overload;
    procedure DrawElement(ACanvas: TdxGPCanvas; AElement: TdxSkinElement;
      const R: TRect; AScaleFactor: TdxScaleFactor;
      AState: TdxSkinElementState = esNormal;
      AImageIndex: Integer = 0); overload;
    procedure Flush;
  ...
  public
    ...
    function LoadSkin(ASkin: TdxSkin; const ASkinName: string)
      : Boolean; overload;
    //
    property Count: Integer read GetCount;
  ...
  TdxSkin = class(TdxSkinPersistent, IdxColorPalette, IdxSkinColorPalette)
  strict private
    ...
    procedure HandlerColorPalettesChanged(Sender: TObject;
      AChanges: TdxSkinChanges);
  ...
  protected
    ...
    function GetGlyphColorPalette(AState: TdxSkinElementState): IdxColorPalette;
    procedure NotifyListener(AChanges: TdxSkinChanges;
      const ACustomListener: IUnknown);
  ...
  public
    constructor Create(const AName: string; ALoadOnCreate: Boolean;
      hInst: THandle); reintroduce; virtual;
    destructor Destroy; override;
    function AddColor(const AName: string; const AColor: TColor = clDefault)
      : TdxSkinColor;
    ...
    function GetGroupByName(const AName: string;
      out AGroup: TdxSkinControlGroup): Boolean; overload;
    procedure Sort(ASortChildren: Boolean = False); override;
    //
    ...
    //
    property ActiveColorPalette: TdxSkinColorPalette read FColorPalette
      implements IdxColorPalette;
    property ActiveColorPaletteName: string read GetActiveColorPaletteName
      write SetActiveColorPaletteName;
...
const
  dxSkinElementTextColorPropertyNames: array [TcxButtonState] of string = ('',
    sdxTextColorNormal, sdxTextColorHot, sdxTextColorPressed,
    sdxTextColorDisabled);

  dxSkinElementStateNames: array [TdxSkinElementState] of string = ('Normal',
    'Hot', 'Pressed', 'Disabled', 'Active', 'Focused', 'DroppedDown', 'Checked',
    'HotCheck', 'ActiveDisabled', 'CheckPressed');

  dxSkinsGradientModeMap: array [TdxSkinGradientMode]
    of TdxGPLinearGradientMode = (LinearGradientModeHorizontal,
...
function dxSkinCheckSignature(AStream: TStream;
  out AVersion: TdxSkinVersion): Boolean;
...
function dxSkinGetAlternateImageAttrsPropertyName(AState: TdxSkinElementState;
  AImageIndex: Integer = 0): string;
...
procedure dxSkinWriteWideStringToStream(AStream: TStream;
  const AValue: WideString);

function dxSkinElementCheckState(AElement: TdxSkinElement;
  AState: TdxSkinElementState): TdxSkinElementState;
function dxSkinGetElementSize(AElement: TdxSkinElement;
...
type
  ...
  public
    constructor Create(ASource: TStream;
      const APosStart, ASize: Longint); virtual;
...
function dxSkinGetAlternateImageAttrsPropertyName(AState: TdxSkinElementState;
  AImageIndex: Integer = 0): string;
begin
  Result := sdxAlternateImage + IntToStr(AImageIndex + 1) +
    dxSkinElementStateNames[AState]
end;
...
procedure dxSkinReadSmartImageFromStream(AStream: TStream;
...
procedure dxSkinWriteSmartImageToStream(AStream: TStream;
  AImage: TdxSmartImage);
var
...
begin
  ...
  TdxSkinElementPartBounds(AParts)[sipTop] :=
    Rect(R1.Left, R.Top, R1.Right, R1.Top);
  TdxSkinElementPartBounds(AParts)[sipTopRight] :=
    Rect(R1.Right, R.Top, R.Right, R1.Top);
  TdxSkinElementPartBounds(AParts)[sipLeft] := Rect(R.Left, R1.Top, R1.Left,
    R1.Bottom);
  TdxSkinElementPartBounds(AParts)[sipRight] := Rect(R1.Right, R1.Top, R.Right,
    R1.Bottom);
  TdxSkinElementPartBounds(AParts)[sipBottomLeft] :=
    Rect(R.Left, R1.Bottom, R1.Left, R.Bottom);
  TdxSkinElementPartBounds(AParts)[sipBottom] :=
    Rect(R1.Left, R1.Bottom, R1.Right, R.Bottom);
  TdxSkinElementPartBounds(AParts)[sipBottomRight] :=
    Rect(R1.Right, R1.Bottom, R.Right, R.Bottom);
end;
...
procedure dxSkinChangeNotify(ASender: TObject;
  ANotifyEvent: TdxSkinChangeNotify; AChanges: TdxSkinChanges);
begin
...
begin
  ...
  if AElement <> nil then
    Result := AScaleFactor.Apply(cxSizeMax(AElement.Size,
      AElement.MinSize.Size))
  else
    Result := cxNullSize;
end;
...
constructor TdxSkinCustomObjectList.CreateEx(AOwner: TPersistent;
  AChangeHandler: TdxSkinChangeNotify);
begin
  Create(AOwner);
...
function TdxSkinCustomObjectList.Find(const AName: string; var AObject)
  : Boolean;
var
  L, H, I, C: Integer;
begin
...
procedure TdxSkinCustomObjectList.DataRead(AStream: TStream;
  const AVersion: TdxSkinVersion);
var
  ACount: Integer;
begin
  BeginUpdate;
...
procedure TdxSkinCustomObjectList.SubItemChanged(ASender: TObject;
  AChanges: TdxSkinChanges);
begin
  Changed(AChanges);
end;
...
procedure TdxSkinCustomObjectList.Notify(Ptr: Pointer;
...
class function TdxSkinCustomObjectList.CompareByName(AItem1,
  AItem2: TdxSkinCustomObject): Integer;
begin
...
procedure TdxSkinControlGroups.DataReadItem(AStream: TStream;
  const AVersion: TdxSkinVersion);
begin
  Add(dxSkinReadStringFromStream(AStream)).DataRead(AStream, AVersion);
end;

procedure TdxSkinControlGroups.DataWriteItem(AStream: TStream;
  AItem: TdxSkinCustomObject);
begin
...
function TdxSkinElements.Add(const AName: string; AClass: TdxSkinElementClass)
  : TdxSkinElement;
begin
...
begin
  ...
  try
    ...
    begin
      AElement := ASource[I];
      Add(AElement.Name, TdxSkinElementClass(AElement.ClassType))
        .Assign(AElement);
    end;
  finally
    EndUpdate;
...
procedure TdxSkinElements.DataReadItem(AStream: TStream;
  const AVersion: TdxSkinVersion);
begin
  Add(dxSkinReadStringFromStream(AStream), TdxSkinElement)
    .DataRead(AStream, AVersion);
end;

procedure TdxSkinElements.DataWriteItem(AStream: TStream;
  AItem: TdxSkinCustomObject);
begin
  dxSkinWriteStringToStream(AStream, AItem.Name);
  AItem.DataWrite(AStream);
...
constructor TdxSkinColorValue.Create(AOwner: TdxSkinCustomObject;
  ADefaultValue: TColor = clDefault);
begin
  FOwner := AOwner;
...
procedure TdxSkinColorValue.DataRead(AStream: TStream;
  const AVersion: TdxSkinVersion);
begin
...
begin
  Result := (FDefaultValue = ASource.FDefaultValue) and
    (ASource.ValueReference = ValueReference) and
    ((ValueReference <> '') or (ASource.Value = Value));
end;

function TdxSkinColorValue.GetColorPalette(out APalette
  : IdxSkinColorPalette): Boolean;
var
  AOwner: TPersistent;
begin
  AOwner := FOwner;
...
begin
  ...
  begin
    if not((ValueReference <> '') and GetColorPalette(APalette) and
      APalette.GetColor(ValueReference, FValue)) then
      FValue := FDefaultValue;
  end;
  Result := FValue;
end;
...
function TdxSkinProperties.Add(const AName: string;
  AClass: TdxSkinPropertyClass): TdxSkinProperty;
begin
  Result := AClass.Create(Owner, AName);
  Result.OnChange := SubItemChanged;
  inherited Add(Result);
...
begin
  ...
  try
    ...
    begin
      ...
      Add(AProperty.Name, TdxSkinPropertyClass(AProperty.ClassType))
        .Assign(AProperty);
    end;
  finally
    EndUpdate;
...
procedure TdxSkinProperties.DataReadItem(AStream: TStream;
  const AVersion: TdxSkinVersion);
var
  AClass: TClass;
begin
  AClass := FindClass(dxSkinReadStringFromStream(AStream));
  Add(dxSkinReadStringFromStream(AStream), TdxSkinPropertyClass(AClass))
    .DataRead(AStream, AVersion);
end;

procedure TdxSkinProperties.DataWriteItem(AStream: TStream;
  AItem: TdxSkinCustomObject);
begin
...
function TdxSkinPersistent.AddProperty(const AName: string;
  APropertyClass: TdxSkinPropertyClass): TdxSkinProperty;
begin
  Result := FProperties.Add(AName, APropertyClass);
end;

function TdxSkinPersistent.AddPropertyBool(const AName: string; AValue: Boolean)
  : TdxSkinBooleanProperty;
begin
  BeginUpdate;
  try
    Result := TdxSkinBooleanProperty(AddProperty(AName,
      TdxSkinBooleanProperty));
    Result.Value := AValue;
  finally
    EndUpdate;
...
function TdxSkinPersistent.AddPropertyColor(const AName: string; AValue: TColor)
  : TdxSkinColor;
begin
  BeginUpdate;
  try
...
function TdxSkinPersistent.AddPropertyInteger(const AName: string;
  AValue: Integer): TdxSkinIntegerProperty;
begin
  BeginUpdate;
  try
    Result := TdxSkinIntegerProperty(AddProperty(AName,
      TdxSkinIntegerProperty));
    Result.Value := AValue;
  finally
    EndUpdate;
...
procedure TdxSkinPersistent.SubItemChanged(ASender: TObject;
  AChanges: TdxSkinChanges);
begin
  Changed(AChanges);
end;

function TdxSkinPersistent.GetPropertyByName(const AName: string)
  : TdxSkinProperty;
begin
...
function TdxSkinPersistent.GetPropertyByName(const AName: string;
  out AProperty: TdxSkinProperty): Boolean;
begin
...
constructor TdxSkin.Create(const AName: string; ALoadOnCreate: Boolean;
  hInst: THandle);
begin
  ...
  FColorPalette := TdxSkinGeneralColorPalette.Create(Self,
    sdxDefaultColorPaletteName);
...
function TdxSkin.AddColor(const AName: string; const AColor: TColor = clDefault)
  : TdxSkinColor;
begin
...
procedure TdxSkin.HandlerColorPalettesChanged(Sender: TObject;
  AChanges: TdxSkinChanges);
begin
  if FDestroying then
    Exit;
...
function TdxSkin.GetGroupByName(const AName: string;
  out AGroup: TdxSkinControlGroup): Boolean;
begin
...
function TdxSkin.GetGlyphColorPalette(AState: TdxSkinElementState)
  : IdxColorPalette;
var
  APalette: TdxSkinColorPalette;
  AProperty: TdxSkinProperty;
begin
  if GetPropertyByName(sdxDefaultGlyphColorPalettes, AProperty) and
    (AProperty is TdxSkinColorPalettes) then
  begin
    if TdxSkinColorPalettes(AProperty).Find(dxSkinElementStateNames[AState],
      APalette) then
      Exit(APalette);
    if (AState <> esNormal) and TdxSkinColorPalettes(AProperty)
      .Find(dxSkinElementStateNames[esNormal], APalette) then
      Exit(APalette);
  end;
  Result := ActiveColorPalette;
end;

procedure TdxSkin.NotifyListener(AChanges: TdxSkinChanges;
  const ACustomListener: IUnknown);
var
...
begin
  ...
  else if Supports(ACustomListener, IdxSkinChangeListener, AListener) then
...
function TdxSkin.PaletteGetColor(const AKey: string;
...
procedure TdxSkinImage.GetBitmap(AImageIndex: Integer;
  AState: TdxSkinElementState; ABitmap: TBitmap;
...
function TdxSkinImage.GetPalette(AState: TdxSkinElementState;
  ACanUseGlobalPalette: Boolean = True): IdxColorPalette;
var
  APalette: TdxSkinColorPalette;
begin
  if ColorPalettes.Find(dxSkinElementStateNames[AState], APalette) then
    Result := APalette
  else if AState <> esNormal then
    Result := GetPalette(esNormal, ACanUseGlobalPalette)
  else if (Owner <> nil) and ACanUseGlobalPalette then
...
procedure TdxSkinImage.LoadFromResource(AInstance: THandle; const AName: string;
  AType: PChar);
var
  AStream: TStream;
begin
...
procedure TdxSkinImage.SetStateMapping(ATargetStateOrder
  : array of TdxSkinElementState);
var
  ABitmap: TBitmap;
        ...
        begin
          if ATargetStateOrder[AStateIndex] in States then
            Texture.StretchDraw(ABitmap.Canvas.Handle, R,
              StateBounds[AImageIndex, ATargetStateOrder[AStateIndex]]);
...
begin
  Result := (AImage.ImageLayout = ImageLayout) and (AImage.Empty = Empty) and
    ...
    (AImage.Stretch = Stretch) and (AImage.Size.cx = Size.cx) and
    (AImage.Size.cy = Size.cy) and AImage.FColorPalettes.Compare(FColorPalettes)
    and AImage.Margins.IsEqual(Margins) and Texture.Compare(AImage.Texture) and
...
procedure TdxSkinImage.Draw(DC: HDC; const ARect: TRect;
  AScaleFactor: TdxScaleFactor; AImageIndex: Integer;
  AState: TdxSkinElementState);
begin
...
procedure TdxSkinImage.Draw(ACanvas: TcxCustomCanvas; const ARect: TRect;
  ...
  AState: TdxSkinElementState = esNormal);
begin
  ACanvas.DrawNativeObject(ARect, TcxCanvasBasedResourceCacheKey.Create(Self,
    cxSize(ARect), Ord(AState), AImageIndex, AScaleFactor.TargetDPI),
...
AState: TdxSkinElementState);
  ...
  procedure DoDrawPart(const ATargetRect, ASourceRect: TRect;
  APart: TdxSkinImagePart; AImageHandle: TdxGPImageHandle);
  begin
    if (APart = sipCenter) and IsGradientParamsAssigned then
      TdxSkinRender.FillRectByGradient(ACanvas, ATargetRect, GradientBeginColor,
        GradientEndColor, Gradient)
    else if Stretch = smStretch then
      dxGpDrawImage(ACanvas.Handle, ATargetRect, ASourceRect,
        AImageHandle.Handle)
    else
      dxGpTilePartEx(ACanvas.Handle, ATargetRect, ASourceRect,
        AImageHandle.Handle);
  end;
  ...
  begin
    ...
    if Stretch <> smTile then
      Result := AScaleFactor.Apply(Result, GetSourceDPI, dxDefaultDPI);
  end;

  procedure DrawStretched(const AImageHandle: TdxGPImageHandle;
  const ASourceOrigin: TPoint; AMargins: TRect);
  var
  ...
  begin
    ...
    begin
      dxSkinsCalculatePartsBounds(ARect, GetActualMargins(AMargins),
        ADestParts);
      for APart := Low(TdxSkinImagePart) to High(TdxSkinImagePart) do
      begin
        if PartVisible[APart] then
          DoDrawPart(ADestParts[APart], cxRectOffset(FPartsBounds[APart],
            ASourceOrigin), APart, AImageHandle);
      end;
    end
    else
      DoDrawPart(ARect, cxRectOffset(FPartsBounds[sipCenter], ASourceOrigin),
        sipCenter, AImageHandle);
  end;
  ...
  begin
    ...
    begin
      ...
      Result := TdxSVGImageHandle(AHandle).GetRasterizedImage(ARasterSize,
        GetPalette(AState));
    end
    else
  ...
  try
    ...
    begin
      ...
      try
        ...
        dxGpDrawImage(ACanvas.Handle, cxRectCenter(ARect, GetActualSize),
          StateBounds[AImageIndex, AState], AImageHandle.Handle);
      finally
        ACanvas.PixelOffsetMode := APrevPixelOffsetMode;
      end;
    end
    else
      DrawStretched(AImageHandle, StateBounds[AImageIndex, AState].TopLeft,
        Margins.Margin);
  finally
...
procedure TdxSkinImage.RightToLeftDependentDraw(DC: HDC; ARect: TRect;
AScaleFactor: TdxScaleFactor; AIsRightToLeftLayout: Boolean;
AImageIndex: Integer = 0; AState: TdxSkinElementState = esNormal);
begin
  dxGPPaintCanvas.BeginPaint(DC, ARect);
...
procedure TdxSkinImage.RightToLeftDependentDraw(ACanvas: TcxCustomCanvas;
ARect: TRect; AScaleFactor: TdxScaleFactor; AIsRightToLeftLayout: Boolean;
AImageIndex: Integer = 0; AState: TdxSkinElementState = esNormal);
begin
  ACanvas.DrawNativeObject(ARect, TcxCanvasBasedResourceCacheKey.Create(Self,
    cxSize(ARect), MakeWord(Ord(AIsRightToLeftLayout), Ord(AState)),
    AImageIndex, AScaleFactor.TargetDPI),
    procedure(ACanvas: TcxGdiBasedCanvas; const ARect: TRect)
    begin
      RightToLeftDependentDraw(ACanvas.Handle, ARect, AScaleFactor,
        AIsRightToLeftLayout, AImageIndex, AState);
    end);
end;
...
begin
  if Empty or (Owner = nil) then
    ...
    Result := Owner.Name + IfThen(Self = Owner.Glyph, '_Glyph', '_Image') +
      GetFileExt;
end;
...
function TdxSkinImage.GetStateBounds(AImageIndex: Integer;
AState: TdxSkinElementState): TRect;
var
...
begin
  ...
  begin
    ...
    if ImageLayout = ilHorizontal then
      OffsetRect(Result, AFramesPerState * AImageIndex *
        FPartsBoundsSourceSize.cx, 0)
    else
      OffsetRect(Result, 0, AFramesPerState * AImageIndex *
        FPartsBoundsSourceSize.cy)
  end;
end;
...
procedure TdxSkinImage.DataRead(AStream: TStream;
const AVersion: TdxSkinVersion);
begin
...
procedure TdxSkinImage.HandlerColorPaletteChanged(Sender: TObject;
Changes: TdxSkinChanges);
begin
  Changed;
end;
...
constructor TdxSkinCustomObject.Create(AOwner: TPersistent;
const AName: string);
begin
  inherited Create;
  FName := AName;
...
procedure TdxSkinCustomObject.DataRead(Stream: TStream;
const AVersion: TdxSkinVersion);
begin
end;
...
begin
  Result := StringReplace(ClassName, 'TdxSkin', '',
...
begin
  Result := inherited Compare(AProperty) and
    (AProperty is TdxSkinIntegerProperty) and
    (TdxSkinIntegerProperty(AProperty).Value = Value);
end;

procedure TdxSkinIntegerProperty.DataRead(Stream: TStream;
const AVersion: TdxSkinVersion);
begin
...
begin
  Result := inherited Compare(AProperty) and
    (AProperty is TdxSkinBooleanProperty) and
    (TdxSkinBooleanProperty(AProperty).Value = Value)
end;

procedure TdxSkinBooleanProperty.DataRead(Stream: TStream;
const AVersion: TdxSkinVersion);
begin
  Stream.ReadBuffer(FValue, SizeOf(FValue));
end;
...
begin
  Result := inherited Compare(AProperty) and (AProperty is TdxSkinColor) and
    TdxSkinColor(AProperty).FValue.Equals(FValue);
end;

procedure TdxSkinColor.DataRead(Stream: TStream;
const AVersion: TdxSkinVersion);
begin
...
begin
  Result := inherited and (AProperty is TdxSkinAlphaColor) and
    (TdxSkinAlphaColor(AProperty).ValueAlpha = ValueAlpha);
end;
...
constructor TdxSkinRectProperty.Create(AOwner: TPersistent;
const AName: string);
begin
  inherited Create(AOwner, AName);
...
begin
  Result := inherited Compare(AProperty) and (AProperty is TdxSkinRectProperty)
    and TdxSkinRectProperty(AProperty).Value.IsEqual(Value);
end;

procedure TdxSkinRectProperty.DataRead(Stream: TStream;
const AVersion: TdxSkinVersion);
var
  ARect: TRect;
begin
...
begin
  Result := inherited Compare(AProperty) and (AProperty is TdxSkinSizeProperty)
    and cxSizeIsEqual(Value, TdxSkinSizeProperty(AProperty).Value);
end;
...
procedure TdxSkinSizeProperty.DataRead(Stream: TStream;
const AVersion: TdxSkinVersion);
begin
  Stream.ReadBuffer(FValue, SizeOf(FValue));
end;
...
const
  BorderNames: array [TcxBorder] of string = (sdxLeft, sdxTop, sdxRight,
    sdxBottom);
begin
...
begin
  ...
  case Kind of
    bLeft:
      ACanvas.FillRectangle(Rect(ABounds.Left, ABounds.Top, ABounds.Left + Thin,
        ABounds.Bottom), dxColorToAlphaColor(Color));
    bTop:
      ACanvas.FillRectangle(Rect(ABounds.Left, ABounds.Top, ABounds.Right,
        ABounds.Top + Thin), dxColorToAlphaColor(Color));
    bRight:
      ACanvas.FillRectangle(Rect(ABounds.Right - Thin, ABounds.Top,
        ABounds.Right, ABounds.Bottom), dxColorToAlphaColor(Color));
    bBottom:
      ACanvas.FillRectangle(Rect(ABounds.Left, ABounds.Bottom - Thin,
        ABounds.Right, ABounds.Bottom), dxColorToAlphaColor(Color));
  end;
end;

procedure TdxSkinBorder.DataRead(Stream: TStream;
const AVersion: TdxSkinVersion);
begin
...
begin
  ...
  begin
    for ASide := Low(TcxBorder) to High(TcxBorder) do
      Result := Result and Items[ASide].Compare(TdxSkinBorders(AProperty)
        .Items[ASide]);
  end;
end;
...
procedure TdxSkinBorders.DataRead(AStream: TStream;
const AVersion: TdxSkinVersion);
var
  ASide: TcxBorder;
begin
...
procedure TdxSkinBorders.SubItemChanged(ASender: TObject;
AChanges: TdxSkinChanges);
begin
  Changed(AChanges);
end;
...
begin
  Result := Rect(Left.ContentMargin, Top.ContentMargin, Right.ContentMargin,
    Bottom.ContentMargin);
end;

procedure TdxSkinBorders.SetBorderByIndex(Index: Integer;
AValue: TdxSkinBorder);
begin
...
procedure TdxSkinWideStringProperty.DataRead(Stream: TStream;
const AVersion: TdxSkinVersion);
begin
...
begin
  Result := inherited Compare(AProperty) and
    (AProperty is TdxSkinStringProperty) and
    (AnsiCompareStr(TdxSkinStringProperty(AProperty).Value, Value) = 0);
end;

procedure TdxSkinStringProperty.DataRead(Stream: TStream;
const AVersion: TdxSkinVersion);
begin
...
constructor TdxSkinAlternateImageAttributes.Create(AOwner: TPersistent;
const AName: string);
begin
  inherited Create(AOwner, AName);
  FAlpha := MaxByte;
...
begin
  ...
  begin
    ...
    FGradientBeginColor.Assign(TdxSkinAlternateImageAttributes(Source)
      .FGradientBeginColor);
    FGradientEndColor.Assign(TdxSkinAlternateImageAttributes(Source)
      .FGradientEndColor);
    ContentOffsets.Rect := TdxSkinAlternateImageAttributes(Source)
      .ContentOffsets.Rect;
  end
  else
    inherited;
...
procedure TdxSkinAlternateImageAttributes.BordersChanged(ASender: TObject;
AChanges: TdxSkinChanges);
begin
  Changed(AChanges);
end;

function TdxSkinAlternateImageAttributes.Compare
  (AProperty: TdxSkinProperty): Boolean;
begin
  Result := inherited Compare(AProperty) and
    (AProperty is TdxSkinAlternateImageAttributes) and
    (TdxSkinAlternateImageAttributes(AProperty).Alpha = Alpha) and
    (TdxSkinAlternateImageAttributes(AProperty).Gradient = Gradient) and
    (TdxSkinAlternateImageAttributes(AProperty).FGradientBeginColor.Equals
    (FGradientBeginColor)) and (TdxSkinAlternateImageAttributes(AProperty)
    .FGradientEndColor.Equals(FGradientEndColor)) and
    (TdxSkinAlternateImageAttributes(AProperty).Borders.Compare(Borders)) and
    (TdxSkinAlternateImageAttributes(AProperty).BordersInner.Compare
    (BordersInner)) and (TdxSkinAlternateImageAttributes(AProperty)
    .ContentOffsets.IsEqual(ContentOffsets.Rect));
end;

procedure TdxSkinAlternateImageAttributes.ContentOffsetsChanged
  (ASender: TObject);
begin
  Changed([scContent]);
end;

procedure TdxSkinAlternateImageAttributes.DataRead(AStream: TStream;
const AVersion: TdxSkinVersion);
begin
...
procedure TdxSkinAlternateImageAttributes.Draw(ACanvas: TdxGPCanvas;
const R: TRect);
var
  ARect: TRect;
begin
  ARect := cxRectContent(R, ContentOffsets.Rect);
  TdxSkinRender.FillRectByGradient(ACanvas, ARect, GradientBeginColor,
    GradientEndColor, Gradient, Alpha);
...
begin
  Result := (Alpha < MaxByte) or not cxRectIsEqual(ContentOffsets.Rect,
    cxNullRect);
end;
...
procedure TdxSkinAlternateImageAttributes.SetBordersInner
  (AValue: TdxSkinBorders);
begin
...
procedure TdxSkinAlternateImageAttributes.SetGradientBeginColorReference
  (const Value: string);
begin
  FGradientBeginColor.ValueReference := Value;
end;
...
procedure TdxSkinAlternateImageAttributes.SetGradientEndColorReference
  (const Value: string);
begin
  FGradientEndColor.ValueReference := Value;
end;

procedure TdxSkinAlternateImageAttributes.SetGradientMode
...
constructor TdxSkinControlGroup.Create(AOwner: TPersistent;
const AName: string);
begin
  inherited Create(AOwner, AName);
...
function TdxSkinControlGroup.AddElementEx(const AName: string;
AElementClass: TdxSkinElementClass): TdxSkinElement;
begin
...
function TdxSkinControlGroup.GetElementByName(const AName: string)
  : TdxSkinElement;
begin
...
procedure TdxSkinControlGroup.DataRead(AStream: TStream;
const AVersion: TdxSkinVersion);
begin
...
procedure TdxSkinControlGroup.SetElement(AIndex: Integer;
AElement: TdxSkinElement);
begin
...
function TdxSkinElement.AddAlternateImageAttributes(AState: TdxSkinElementState;
AImageIndex: Integer): TdxSkinAlternateImageAttributes;
begin
  Result := TdxSkinAlternateImageAttributes
    (AddProperty(dxSkinGetAlternateImageAttrsPropertyName(AState, AImageIndex),
    TdxSkinAlternateImageAttributes));
end;
...
function TdxSkinElement.CanUseAlternateImageSet(AImageIndex: Integer;
AState: TdxSkinElementState; ALowColorsMode: Boolean;
out AStateAttributes: TdxSkinAlternateImageAttributes): Boolean;
begin
...
var
  ...
  AState: TdxSkinElementState;
begin
  AlternateImageSetDirty := AlternateImageSetDirty or
    (AlternateImageSetIndex <> AIndex);
  if AlternateImageSetDirty then
  begin
    for AState := Low(TdxSkinElementState) to High(TdxSkinElementState) do
    begin
      if GetPropertyByName(dxSkinGetAlternateImageAttrsPropertyName(AState,
        AIndex), AProperty) and (AProperty is TdxSkinAlternateImageAttributes)
      then
...
begin
  Result := SameText(AElement.Name, Name) and (Color = AElement.Color) and
    ...
    MinSize.IsEqual(AElement.MinSize) and
    ContentOffset.IsEqual(AElement.ContentOffset.Rect) and
    Borders.Compare(AElement.Borders) and
    FProperties.Compare(AElement.FProperties) and Image.Compare(AElement.Image)
    and Glyph.Compare(AElement.Glyph);
end;
...
function TdxSkinElement.GetGlyphColorPalette(AState: TdxSkinElementState)
  : IdxColorPalette;
begin
...
function TdxSkinElement.GetTextColor(AState: TcxButtonState;
const APropertyPrefix: string = ''): TColor;
begin
  Result := FindColor(dxSkinElementTextColorPropertyNames[AState],
    APropertyPrefix);
...
begin
  ACanvas.DrawNativeObject(ARect, TcxCanvasBasedResourceCacheKey.Create(Self,
    ...
    procedure(ACanvas: TdxGPCanvas; const R: TRect)
    begin
      Draw(ACanvas, R, AScaleFactor, AImageIndex, AState);
    end);
end;
...
begin
  if UseCache then
    FCache.DrawElement(ACanvas, Self, ARect, AScaleFactor, AState, AImageIndex)
  else
    DrawEx(ACanvas, ARect, AScaleFactor, AImageIndex, AState);
end;
...
begin
  ...
  if CanUseAlternateImageSet(AImageIndex, AState, ACanvas.IsLowColorsMode,
    AAttributes) then
  ...
  Borders.Draw(ACanvas, ARect);
  Glyph.DrawEx(ACanvas, cxRectContent(ARect, ContentOffset.Rect), AScaleFactor,
    AImageIndex, AState);
end;

procedure TdxSkinElement.RightToLeftDependentDraw(DC: HDC; const ARect: TRect;
AScaleFactor: TdxScaleFactor; AIsRightToLeftLayout: Boolean;
AImageIndex: Integer = 0; AState: TdxSkinElementState = esNormal);
begin
  ...
  begin
    dxGPPaintCanvas.BeginPaint(DC, ARect);
    try
      RightToLeftDependentDraw(dxGPPaintCanvas, ARect, AScaleFactor,
        AIsRightToLeftLayout, AImageIndex, AState);
    finally
      dxGPPaintCanvas.EndPaint;
    end;
...
procedure TdxSkinElement.RightToLeftDependentDraw(ACanvas: TcxCustomCanvas;
const ARect: TRect; AScaleFactor: TdxScaleFactor; AIsRightToLeftLayout: Boolean;
AImageIndex: Integer = 0; AState: TdxSkinElementState = esNormal);
begin
  ACanvas.DrawNativeObject(ARect, TcxCanvasBasedResourceCacheKey.Create(Self,
    cxSize(ARect), MakeWord(Ord(AIsRightToLeftLayout), Ord(AState)),
    ...
    begin
      RightToLeftDependentDraw(ACanvas, ARect, AScaleFactor,
        AIsRightToLeftLayout, AImageIndex, AState);
    end);
end;

procedure TdxSkinElement.RightToLeftDependentDraw(ACanvas: TdxGPCanvas;
ARect: TRect; AScaleFactor: TdxScaleFactor; AIsRightToLeftLayout: Boolean;
AImageIndex: Integer = 0; AState: TdxSkinElementState = esNormal);
begin
  if not cxRectIsEmpty(ARect) then
    dxGpRightToLeftDependentDraw(ACanvas, ARect, AIsRightToLeftLayout, procedure
      begin
...
function TdxSkinElement.GetImage(AImageIndex: Integer; const ASize: TSize;
AState: TdxSkinElementState = esNormal): TdxSmartImage;
begin
  Result := GetImage(AImageIndex, ASize, dxSystemScaleFactor, AState);
end;

procedure TdxSkinElement.SetStateMapping(AStateOrder
  : array of TdxSkinElementState);
begin
...
procedure TdxSkinElement.DataRead(AStream: TStream;
const AVersion: TdxSkinVersion);
begin
...
var
  AProperty: TdxSkinProperty;
begin
  if (AName <> '') and GetPropertyByName(ANamePrefix + AName, AProperty) and
    (AProperty is TdxSkinColor) then
...
procedure TdxSkinElement.BordersChanged(ASender: TObject;
AChanges: TdxSkinChanges);
begin
  Changed(AChanges);
end;
...
const R: TRect; AColor1, AColor2: TColor; AMode: TdxSkinGradientMode;
AAlpha: Byte = 255);
begin
  ...
  begin
    if (AColor1 = AColor2) or not cxColorIsValid(AColor2) then
      ...
      ACanvas.FillRectangleByGradient(R, dxColorToAlphaColor(AColor1, AAlpha),
        dxColorToAlphaColor(AColor2, AAlpha), dxSkinsGradientModeMap[AMode]);
  end;
end;
...
begin
  if (AElement <> Element) or (AState <> FState) or (FImageIndex <> AImageIndex)
    or (FImageSet <> dxSkinsUseImageSet) or not cxSizeIsEqual(R, FRect) or
    not FScaleFactor.Equals(AScaleFactor) then
  begin
    FRect := R;
    FState := AState;
    FElement := AElement;
...
begin
  FCacheOpaque := TcxBitmap.CreateSize(cxRectWidth(R), cxRectHeight(R),
    pf32bit);
  dxGPPaintCanvas.BeginPaint(FCacheOpaque.Canvas.Handle,
    FCacheOpaque.ClientRect);
  try
    Element.DrawEx(dxGPPaintCanvas, FCacheOpaque.ClientRect, FScaleFactor,
      ImageIndex, State);
  finally
    dxGPPaintCanvas.EndPaint;
  end;
...
procedure TdxSkinElementCache.InternalRightToLeftDependentDraw(DC: HDC;
const R: TRect; AIsRightToLeftLayout: Boolean);
var
  ARect: TRect;
begin
  ARect := R;
  if FCacheOpaque <> nil then
    cxRightToLeftDependentDraw(DC, ARect, AIsRightToLeftLayout, procedure
      begin
        cxBitBlt(DC, FCacheOpaque.Canvas.Handle, ARect, cxNullPoint, SRCCOPY)
      end)
  else if FCache <> nil then
  begin
    dxGPPaintCanvas.BeginPaint(DC, ARect);
    try
      dxGpRightToLeftDependentDraw(dxGPPaintCanvas, ARect, AIsRightToLeftLayout,
...
begin
  ...
  begin
    ...
    try
      GdipCheck(GdipDrawImageRectI(dxGPPaintCanvas.Handle, FCache, R.Left,
...
begin
  if FCacheOpaque <> nil then
    ...
    GdipCheck(GdipDrawImageRectI(ACanvas.Handle, FCache, R.Left, R.Top,
      R.Right - R.Left, R.Bottom - R.Top));
end;

procedure TdxSkinElementCache.DrawEx(DC: HDC; AElement: TdxSkinElement;
const R: TRect; AScaleFactor: TdxScaleFactor; AState: TdxSkinElementState;
AImageIndex: Integer);
begin
...
procedure TdxSkinElementCache.DrawEx(ACanvas: TdxGPCanvas;
...
constructor TdxSkinElementCacheList.Create
  (ACapacity: Integer = DefaultCapacity);
begin
  inherited Create;
...
AState: TdxSkinElementState = esNormal; AImageIndex: Integer = 0);
begin
  GetCacheItem(AElement, R, AState, AImageIndex).DrawEx(DC, AElement, R,
    AScaleFactor, AState, AImageIndex);
end;

procedure TdxSkinElementCacheList.DrawElement(ACanvas: TdxGPCanvas;
AElement: TdxSkinElement; const R: TRect; AScaleFactor: TdxScaleFactor;
AState: TdxSkinElementState = esNormal; AImageIndex: Integer = 0);
begin
  GetCacheItem(AElement, R, AState, AImageIndex).DrawEx(ACanvas, AElement, R,
    AScaleFactor, AState, AImageIndex);
end;
...
function TdxSkinElementCacheList.TryGet(AElement: TdxSkinElement;
const R: TRect; AState: TdxSkinElementState; AImageIndex: Integer;
out AElementCache: TdxSkinElementCache): Boolean;
var
  I: Integer;
begin
  ...
  begin
    ...
    if (AElementCache.Element = AElement) and
      (AImageIndex = AElementCache.ImageIndex) and
  ...
  begin
    AElementCache := TdxSkinElementCache(FData.List[I]);
    if (AElementCache.Element = AElement) and
      cxSizeIsEqual(R, AElementCache.Rect) then
      Exit(True);
  end;
  Result := False;
end;
...
function TdxSkinBinaryReader.LoadSkin(ASkin: TdxSkin;
ASkinIndex: Integer): Boolean;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        ASavedPosition := AStream.Position;
        if not ReadBinarySkin(AStream) then
          Exit;
...
procedure TdxSkinDetails.DataRead(AStream: TStream;
const AVersion: TdxSkinVersion);
var
  ASize: TdxSkinIconSize;
begin
...
const
  SkinIconNames: array [TdxSkinIconSize] of string = (sdxSkinDefaultSkinIcon,
    sdxSkinDefaultSkinIconLarge);
begin
  Icons[ASize].LoadFromResource(HInstance, SkinIconNames[ASize],
    sdxResourceType);
end;
...
constructor TdxSkinCustomListProperty.Create(AOwner: TPersistent;
const AName: string);
begin
  inherited;
...
begin
  Result := inherited Compare(AProperty) and
    (AProperty is TdxSkinCustomListProperty) and
...
function TdxSkinCustomListProperty.Find(const AName: string;
var AProperty): Boolean;
begin
  Result := FProperties.Find(AName, AProperty);
end;
...
procedure TdxSkinCustomListProperty.DataRead(Stream: TStream;
const AVersion: Double);
begin
  inherited;
...
procedure TdxSkinCustomListProperty.HandlerPropertiesChanged(Sender: TObject;
Changes: TdxSkinChanges);
begin
  Changed(Changes);
end;
...
constructor TdxSkinColorPalette.Create(AOwner: TPersistent;
const AName: string);
begin
  inherited;
...
function TdxSkinColorPalette.Add(const AName: string; AValue: TColor)
  : TdxSkinColor;
begin
  Result := AddCore(AName, AValue, '');
end;

function TdxSkinColorPalette.Add(const AName, AValueReference: string)
  : TdxSkinColor;
begin
  Result := AddCore(AName, clDefault, AValueReference);
end;

function TdxSkinColorPalette.AddCore(const AName: string; AValue: TColor;
AValueReference: string): TdxSkinColor;
begin
  BeginUpdate;
  try
...
constructor TdxSkinColorPalettes.Create(AOwner: TPersistent;
const AName: string);
begin
  inherited;
  FDefaultColorClass := TdxSkinColor;
...
begin
  ...
  RegisterClasses([TdxSkinControlGroup, TdxSkinElement, TdxSkinImage,
    TdxSkinColorPalette, TdxSkinAlphaColor]);
