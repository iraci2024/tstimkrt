...
procedure TdxShapeFakeBrushReader.ReadChildNodes(AParentShape: TdxShapeObject;
  ANode: TdxXMLNode);
var
...
begin
  ...
  begin
    AParent := TdxShapeObjectAccess(AParentShape)
      .Parent as TdxCustomVectorShape;
...
procedure TdxShapeFakeGradientStopsReader.ReadChildNodes
  (AParentShape: TdxShapeObject; ANode: TdxXMLNode);
begin
...
procedure TdxShapeGradientStopReader.ReadChildNodes(AParentShape
  : TdxShapeObject; ANode: TdxXMLNode);
var
  ABrush: TdxShapeCustomGradientBrush;
  AGradientStop: TdxShapeBrushGradientStop;
begin
  ABrush := TdxShapeObjectAccess(AParentShape)
    .Parent as TdxShapeCustomGradientBrush;
  AGradientStop := AParentShape as TdxShapeBrushGradientStop;
  ABrush.GradientPoints.Add(AGradientStop.Offset,
    dxColorNameToAlphaColor(AGradientStop.Color));
end;

{ TdxShapeCanvasReader }

procedure TdxShapeCanvasReader.ReadChildNodes(AParentShape: TdxShapeObject;
  ANode: TdxXMLNode);
var
...
begin
  ...
  ANode.ForEach(procedure(ANode: TdxXMLNode; AUserData: Pointer)
    begin
      ACanvasShape.Add(CreateShapeFromNode(AParentShape, ANode)
        as TdxCustomVectorShape);
    end);
end;

{ TdxShapeTransformationReader }

procedure TdxShapeTransformationReader.ReadChildNodes
  (AParentShape: TdxShapeObject; ANode: TdxXMLNode);
var
  AParent: TdxCustomVectorShape;
...
begin
  ...
  begin
    ...
    AParent := TdxShapeObjectAccess(AParentShape)
      .Parent as TdxCustomVectorShape;
    ATransformations := TdxShapeTransformationsAccess
      (TdxShapeObjectAccess(AParent).Transformations);
    ANode.ForEach(procedure(ANode: TdxXMLNode; AUserData: Pointer)
      begin
