...
function dxLayoutControlSelectLookAndFeel(var ALookAndFeelClass
  : TdxCustomLayoutLookAndFeelClass): Boolean;
...
begin
  ...
  if Result then
    ALookAndFeelClass := dxLayoutLookAndFeelDefs.GetItemByDescription
      (ADescription);
end;
