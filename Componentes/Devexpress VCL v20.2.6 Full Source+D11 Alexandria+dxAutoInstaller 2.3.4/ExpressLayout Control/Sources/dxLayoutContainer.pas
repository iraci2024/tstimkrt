...
{$ENDIF}
  ...
  dxLayoutLookAndFeels, dxLayoutCommon, dxLayoutSelection, cxPC, cxScrollbar,
  dxFormattedText, dxCheckGroupBox;
...
type
  ...
  TdxLayoutControlItemControlPainterClass = class of
  ...
  TdxCustomLayoutItemCaptionPainterClass = class of
  ...
  TdxLayoutDirectionalItemPainterClass = class of
  ...
  TdxLayoutEmptySpaceItemViewInfoClass = class of
  ...
  TdxLayoutDropAreaPart = (apNone, apLeft, apTop, apRight, apBottom, apBefore,
    apAfter, apBetween, apNewLayout, apLastChild);
  TdxLayoutActionType = (atNone, atInsert, atCreateGroup, atContentInsert);
  TdxLayoutCustomizeFormUpdateType = (cfutCaption, cfutAvailableItems,
    cfutVisibleItems, cfutSelection, cfutView, cfutDragAndDropState);
  TdxLayoutCustomizeFormUpdateTypes = set of TdxLayoutCustomizeFormUpdateType;
  TdxLayoutCustomizeFormMenuItem = (cfmiAlignHorz, cfmiAlignVert, cfmiDirection,
    cfmiCaptionLayout, cfmiCaptionAlignHorz, cfmiCaptionAlignVert, cfmiCaption,
    cfmiBorder, cfmiExpandButton, cfmiGrouping, cfmiRename);
  ...
  TdxLayoutItemCanResizeEvent = procedure(Sender: TObject;
  ...
  TdxLayoutControlCustomCustomizeFormClass = class of
  ...
  protected
    ...
    function GetCustomizationCaption(AItem: TdxCustomLayoutItem)
      : string; virtual;
    procedure SetCustomizationCaption(AItem: TdxCustomLayoutItem;
      const ACaption: string); virtual;

    procedure Changed; virtual;

    property IsLocked: Boolean read GetIsLocked;
    property LayoutLookAndFeel: TdxCustomLayoutLookAndFeel
      read FLayoutLookAndFeel;
  ...
  protected
    function GetCurrentImage(out AGlyph: TdxSmartGlyph;
  ...
  TdxLayoutItemCaptionVisibleElements = set of
  ...
  protected
    ...
    // storing
    procedure GetStoredPropertyValue(const AName: string;
      var AValue: Variant); virtual;
    procedure GetStoredProperties(AProperties: TStrings); virtual;
    procedure SetStoredPropertyValue(const AName: string;
    ...
    property EllipsisPosition: TEllipsisPosition read FEllipsisPosition
      write SetEllipsisPosition default epNone;
    ...
    property ImageIndex: Integer read GetImageIndex write SetImageIndex
      default -1;
    property ImageOptions: TdxCustomLayoutItemImageOptions read FImageOptions
      write SetImageOptions;
    ...
    property ShowAccelChar: Boolean read GetShowAccelChar write SetShowAccelChar
      default True;
    property VisibleElements: TdxLayoutItemCaptionVisibleElements
      read FVisibleElements write SetVisibleElements
      default [cveImage, cveText];
    property UserCaption: string read FUserCaption write SetUserCaption;
    property DefaultCaption: string read FDefaultCaption
      write SetDefaultCaption;
  public
    constructor Create(AItem: TdxCustomLayoutItem); override;
    destructor Destroy; override;

    property AlignHorz: TAlignment read FAlignHorz write SetAlignHorz
  ...
  TdxCustomLayoutItemCaptionOptionsClass = class of
  ...
  published
    property AssignedValues: TdxLayoutSizeOptionsValues read FAssignedValues
      write SetAssignedValues default [];
    property SizableHorz: Boolean read GetSizableHorz write SetSizableHorz
      stored IsSizableHorzStored;
    property SizableVert: Boolean read GetSizableVert write SetSizableVert
      stored IsSizableVertStored;
  ...
  published
    property AssignedValues: TdxLayoutPaddingAssignedValues read FAssignedValues
      write SetAssignedValues default [];
  ...
  protected
    FIsFloat: Boolean;
    procedure ShowFloat(const APosition: TPoint; ANeedActivate: Boolean;
  ...
  TdxCustomLayoutItem = class(TcxCustomComponent, IdxLayoutLookAndFeelUser,
    IdxLayoutSelectableItem, IdxScaleFactor, IcxStoredObject)
  private
    // Align
  ...
  protected
    ...
    procedure IdxLayoutLookAndFeelUser.BeginLookAndFeelDestroying =
      BeginLayoutLookAndFeelUserDestroying;
    procedure IdxLayoutLookAndFeelUser.EndLookAndFeelDestroying =
      EndLayoutLookAndFeelUserDestroying;
    procedure IdxLayoutLookAndFeelUser.LookAndFeelChanged =
      LayoutLookAndFeelUserChanged;
    procedure IdxLayoutLookAndFeelUser.LookAndFeelDestroyed =
      LayoutLookAndFeelUserDestroyed;
    ...
    function InternalMove(AParent: TdxCustomLayoutGroup; AIndex: Integer;
      APack, AKeepAlign: Boolean): Boolean;
    procedure CheckAutoSize(ADropOnly: Boolean); virtual;

    procedure StopFloat;
    procedure LandingFloat;
    procedure MakeFloat(const APosition: TPoint;
      ANeedActivate: Boolean = False);
    ...
    property AllowQuickCustomize: Boolean read FAllowQuickCustomize
      write FAllowQuickCustomize default False;
    ...
    property TakeoffParent: TdxCustomLayoutGroup read FTakeoffParent
      write SetTakeoffParent;

    property OnCaptionClick: TNotifyEvent read FOnCaptionClick
      write FOnCaptionClick;
  ...
  public
    ...
    function Move(AParent: TdxCustomLayoutGroup; AIndex: Integer;
      APack: Boolean = False): Boolean;
    function MoveTo(AParent: TdxCustomLayoutGroup; AVisibleIndex: Integer;
      APack: Boolean = False): Boolean;
    procedure Pack;
    function PutIntoHiddenGroup(ALayoutDirection: TdxLayoutDirection)
      : TdxLayoutAutoCreatedGroup;

    procedure ToggleHotTrackState;

    property ActuallyVisible: Boolean read GetActuallyVisible;
    property AllowRemove: Boolean read FAllowRemove write FAllowRemove
      default True;
    property CaptionForCustomizeForm: string read GetCaptionForCustomizeForm;
    property Container: TdxLayoutContainer read FContainer write SetContainer;
    property Data: Pointer read FData write FData;
    property DefaultCaption: string read GetDefaultCaption
      write SetDefaultCaption; // for localization
    ...
    property AlignmentConstraint: TdxLayoutAlignmentConstraint
      read FAlignmentConstraint write SetAlignmentConstraint;
    property CaptionOptions: TdxCustomLayoutItemCaptionOptions
      read FCaptionOptions write SetCaptionOptions;
    property LayoutLookAndFeel: TdxCustomLayoutLookAndFeel
      read FLayoutLookAndFeel write SetLayoutLookAndFeel;
    property Offsets: TdxLayoutOffsets read FOffsets write SetOffsets;
    property SizeOptions: TdxLayoutSizeOptions read FSizeOptions
      write SetSizeOptions;
    property Visible: Boolean read FVisible write SetVisible default True;
  published
    property AutoAligns: TdxLayoutAutoAligns read GetAutoAligns
      write SetAutoAligns stored False; // obsolete
    property Caption: string read GetCaption write SetCaption stored False;
    property LookAndFeel: TdxCustomLayoutLookAndFeel read FLayoutLookAndFeel
      write SetLayoutLookAndFeel stored False; // obsolete
  ...
  private
    ...
    procedure SetCaptionOptions
      (Value: TdxLayoutNonLabeledItemCaptionOptions); inline;
  protected
    class function GetCaptionOptionsClass
      : TdxCustomLayoutItemCaptionOptionsClass; override;
  published
    property Enabled;
    property CaptionOptions: TdxLayoutNonLabeledItemCaptionOptions
  ...
  protected
    ...
    function DoCanResize(AItem: TdxCustomLayoutItem;
      var ANewSize: Integer): Boolean;
  ...
  published
    property AllowCloseOnClick: Boolean read FAllowCloseOnClick
      write SetAllowCloseOnClick default False;

    property OnCanResize: TdxLayoutItemCanResizeEvent read FOnCanResize
      write FOnCanResize;
  end;
  ...
  TdxLayoutLabeledItemCustomCaptionOptions = class
  ...
  private
    function GetCaptionOptions
      : TdxLayoutLabeledItemCustomCaptionOptions; inline;
    procedure SetCaptionOptions
      (Value: TdxLayoutLabeledItemCustomCaptionOptions); inline;
  protected
  ...
  private
    ...
    procedure SetCaptionOptions
      (Value: TdxLayoutSeparatorItemCaptionOptions); inline;
  protected
    function GetBaseName: string; override;
    class function GetCaptionOptionsClass
      : TdxCustomLayoutItemCaptionOptionsClass; override;
  ...
  public
    property IsVertical;
  published
    property CaptionOptions: TdxLayoutSeparatorItemCaptionOptions
      read GetCaptionOptions write SetCaptionOptions;
  end;
  ...
  private
    ...
    procedure SetCaptionOptions
      (Value: TdxLayoutLabeledItemCaptionOptions); inline;
  protected
    function GetBaseName: string; override;
    class function GetCaptionOptionsClass
      : TdxCustomLayoutItemCaptionOptionsClass; override;
  ...
  published
    ...
    property CaptionOptions: TdxLayoutLabeledItemCaptionOptions
      read GetCaptionOptions write SetCaptionOptions;
    property Enabled;
  ...
  protected
    ...
    property ImageFitMode: TcxImageFitMode read FImageFitMode
      write SetImageFitMode default ifmFit;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
  ...
  TdxLayoutCheckBoxItemCheckBoxOptions = class(TdxCustomLayoutItemOptions,
  ...
  TdxLayoutCheckBoxItemCheckBoxOptionsClass = class of
    TdxLayoutCheckBoxItemCheckBoxOptions;
  ...
  TdxCustomLayoutCheckableItemActionLinkClass = class of
    TdxCustomLayoutCheckableItemActionLink;

  { TdxLayoutCheckBoxItemActionLink }

  TdxLayoutCheckBoxItemActionLink = class
    (TdxCustomLayoutCheckableItemActionLink);

  { TdxLayoutRadioButtonItemActionLink }

  TdxLayoutRadioButtonItemActionLink = class
    (TdxCustomLayoutCheckableItemActionLink)
  strict private
  ...
  protected
    procedure ActionChange(Sender: TObject;
      const ACheckDefaults: Boolean); virtual;
    function CanFocus: Boolean; override;
    function CanProcessAccel: Boolean; override;
    procedure Click;
    procedure DoGetTabOrderList(List: TList); override;
    class function GetActionLinkClass
      : TdxCustomLayoutCheckableItemActionLinkClass; virtual;
    ...
    property ActionLink: TdxCustomLayoutCheckableItemActionLink read FActionLink
      write FActionLink;
  ...
  strict private
    ...
    procedure SetCaptionOptions
      (AValue: TdxLayoutCheckBoxItemCaptionOptions); inline;
    procedure SetCheckBoxOptions
      (AValue: TdxLayoutCheckBoxItemCheckBoxOptions); inline;
  ...
  protected
    ...
    class function GetActionLinkClass
      : TdxCustomLayoutCheckableItemActionLinkClass; override;
    function GetBaseName: string; override;
    class function GetCaptionOptionsClass
      : TdxCustomLayoutItemCaptionOptionsClass; override;
    class function GetCheckBoxOptionsClass
      : TdxLayoutCheckBoxItemCheckBoxOptionsClass; virtual;
  ...
  published
    property Action;
    property AllowRemove;
    property CaptionOptions: TdxLayoutCheckBoxItemCaptionOptions
      read GetCaptionOptions write SetCaptionOptions;
    property CheckBoxOptions: TdxLayoutCheckBoxItemCheckBoxOptions
  ...
  strict private
    ...
    procedure SetCaptionOptions
      (AValue: TdxLayoutRadioButtonItemCaptionOptions); inline;
    procedure TurnLayoutSiblingsOff(AGroup: TdxCustomLayoutGroup);
  protected
    procedure ActionChange(Sender: TObject;
      const ACheckDefaults: Boolean); override;
    class function GetActionLinkClass
      : TdxCustomLayoutCheckableItemActionLinkClass; override;
    function GetBaseName: string; override;
    class function GetCaptionOptionsClass
  ...
  published
    property Action;
    property AllowRemove;
    property CaptionOptions: TdxLayoutRadioButtonItemCaptionOptions
      read GetCaptionOptions write SetCaptionOptions;
    property Checked stored IsCheckedStored default False;
    property Enabled;
    property GroupIndex: Integer read FGroupIndex write FGroupIndex
      stored IsGroupIndexStored default 0;
  ...
  protected
    ...
    property ControlAutoWidth: Boolean read GetControlAutoWidth
      write SetControlAutoWidth;
    property ControlAutoHeight: Boolean read GetControlAutoHeight
      write SetControlAutoHeight;
  ...
  published
    property AlignHorz: TdxLayoutItemControlAlignHorz read FAlignHorz
      write SetAlignHorz default ahClient;
    property AlignVert: TdxLayoutItemControlAlignVert read FAlignVert
      write SetAlignVert default avClient;
    property AutoAlignment: Boolean read FAutoControlAreaAlignment
      write SetAutoControlAreaAlignment stored False; // obsolete
    property AutoControlAreaAlignment: Boolean read FAutoControlAreaAlignment
      write SetAutoControlAreaAlignment default True;
    property AutoColor: Boolean read FAutoColor write SetAutoColor
      default False;
    property FixedSize: Boolean read GetFixedSize write SetFixedSize
      stored False; // deprecated 'Use AlignHorz and AlignVert';
    property MinHeight: Integer read FMinHeight write SetMinHeight
      default dxLayoutItemControlDefaultMinHeight;
    property MinWidth: Integer read FMinWidth write SetMinWidth
      default dxLayoutItemControlDefaultMinWidth;
    property Opaque: Boolean read FOpaque write SetOpaque default False;
    property OriginalHeight: Integer read FOriginalHeight
      write SetOriginalHeight default 0;
  ...
  protected
    ...
    property ControlOptions: TdxLayoutItemControlOptions read FControlOptions
      write SetControlOptions;
    property ControlAdapter: TdxCustomLayoutControlAdapter read FControlAdapter;
  public
    property OriginalControlSize: TPoint read GetOriginalControlSize
      write SetOriginalControlSize;
  ...
  public
    ...
    class function GetSpecificClass
      : TdxLayoutGroupViewInfoSpecificClass; virtual;
  end;
  ...
  public
    ...
    class function GetSpecificClass
      : TdxLayoutGroupViewInfoSpecificClass; override;
  end;
  ...
  protected
    procedure DoChanged(AType: TcxCustomTabControlPropertiesChangedType =
      pctHard); override;
  ...
  private
    ...
    procedure ToggleChildrenEnabledState(AGroup: TdxCustomLayoutGroup;
  ...
  public
    ...
    property Items[Index: Integer]: TdxCustomLayoutGroupButton read GetItem
  ...
  public
    property Items[Index: Integer]: TdxLayoutGroupButton read GetItem
      write SetItem; default;
  end;
  ...
  published
    property Alignment: TdxLayoutGroupButtonsAlignment read FAlignment
      write SetAlignment default gbaRight;
    property Buttons: TdxLayoutGroupButtons read FButtons write SetButtons;
    property CheckBox: TdxLayoutGroupCheckBoxButton read FCheckBox
      write SetCheckBox;
    property DefaultHeight: Cardinal read FDefaultHeight write SetDefaultHeight
      default 16;
    property DefaultWidth: Cardinal read FDefaultWidth write SetDefaultWidth
      default 16;
    property ShowExpandButton: Boolean read GetShowExpandButton
      write SetShowExpandButton default False;
    property Visible: Boolean read FVisible write SetVisible default True;
  end;

  TdxLayoutGroupCaptionOptions = class
    (TdxCustomLayoutItemStorableCaptionOptions)
  public
    constructor Create(AItem: TdxCustomLayoutItem); override;
  published
  ...
  published
    property Horizontal: TdxLayoutGroupScrollMode read FHorizontal
      write SetHorizontalScroll default smNone;
    property Vertical: TdxLayoutGroupScrollMode read FVertical
      write SetVerticalScroll default smNone;
  end;

  TdxLayoutGroupExpandingEvent = procedure(Sender: TObject; var Allow: Boolean)
    of object;
  TdxLayoutGroupCheckBoxStateChangingEvent = procedure(Sender: TObject;
    const ANewState: TcxCheckBoxState; var Allow: Boolean) of object;
  TdxLayoutGroupTabChangingEvent = procedure(Sender: TObject;
    ANewTabIndex: Integer; var Allow: Boolean) of object;

  TdxLayoutGroupWrapItemsMode = (wmNone, wmParentManaged, wmImmediateChildren,
    wmAllChildren);
  ...
  private
    ...
    procedure TabChangedHandler(Sender: TObject;
      AType: TcxCustomTabControlPropertiesChangedType);
    procedure TabChangeHandler(Sender: TObject);
    procedure TabCanCloseHandler(Sender: TObject; ATabIndex: Integer;
      var ACanClose: Boolean);
    procedure TabClickHandler(Sender: TObject; ATabVisibleIndex: Integer;
      AShift: TShiftState);
    ...
    procedure SetItemControlAreaAlignment
      (Value: TdxLayoutItemControlAreaAlignment);
    ...
    procedure ItemListChanged(Sender: TObject; AComponent: TComponent;
  ...
  protected
    ...
    procedure ChangeItemVisibleIndex(AItem: TdxCustomLayoutItem;
      Value: Integer);
    ...
    property AllowScroll: Boolean read GetAllowScroll write SetAllowScroll
      stored False;
    property AllowWrapItems: Boolean read GetAllowWrapItems
      write SetAllowWrapItems stored False; // obsolete
    ...
    property ScrollOptions: TdxLayoutGroupScrollOptions read FScrollOptions
      write SetScrollOptions;
    property WrapItemsMode: TdxLayoutGroupWrapItemsMode read FWrapItemsMode
      write SetWrapItemsMode default wmParentManaged;
    property OnCheckBoxStateChanging: TdxLayoutGroupCheckBoxStateChangingEvent
      read FOnCheckBoxStateChanging write FOnCheckBoxStateChanging;
  ...
  public
    ...
    function CreateGroup(AGroupClass: TdxCustomLayoutGroupClass)
      : TdxCustomLayoutGroup; overload;
    ...
    property VisibleItems[Index: Integer]: TdxCustomLayoutItem
      read GetVisibleItem;

    // published
    property AllowQuickCustomize;
    property AllowRemove;
    property ButtonOptions: TdxLayoutGroupButtonOptions read FButtonOptions
      write SetButtonOptions;
    property CaptionOptions: TdxLayoutGroupCaptionOptions read GetCaptionOptions
      write SetCaptionOptions;
    property Enabled;
    property Expanded: Boolean read FExpanded write SetExpanded default True;
    property Hidden: Boolean read FHidden write SetHidden default False;
    property ItemControlAreaAlignment: TdxLayoutItemControlAreaAlignment
      read FItemControlAreaAlignment write SetItemControlAreaAlignment
      default catDefault;
    property ItemIndex: Integer read FItemIndex write SetItemIndex
      stored IsItemIndexStored;
    ...
    property LookAndFeelException: Boolean read FLayoutLookAndFeelException
      write SetLayoutLookAndFeelException stored False; // obsolete
    property LayoutLookAndFeelException: Boolean
      read FLayoutLookAndFeelException write SetLayoutLookAndFeelException
      default False;
    property Padding;
    property ShowBorder: Boolean read GetShowBorder write SetShowBorder
      default True;
    property TabbedOptions: TdxLayoutTabbedOptions read FTabbedOptions
      write SetTabbedOptions;
    property UseIndent: Boolean read FUseIndent write SetUseIndent default True;
    property OnCaptionClick;
    property OnCheckBoxStateChanged: TNotifyEvent read FOnCheckBoxStateChanged
      write FOnCheckBoxStateChanged;
    property OnCollapsed: TNotifyEvent read FOnCollapsed write FOnCollapsed;
    property OnCollapsing: TdxLayoutGroupExpandingEvent read FOnCollapsing
      write FOnCollapsing;
    property OnExpanded: TNotifyEvent read FOnExpanded write FOnExpanded;
    property OnExpanding: TdxLayoutGroupExpandingEvent read FOnExpanding
      write FOnExpanding;
    property OnTabChanged: TNotifyEvent read FOnTabChanged write FOnTabChanged;
    property OnTabChanging: TdxLayoutGroupTabChangingEvent read FOnTabChanging
      write FOnTabChanging;
  end;
  ...
  published
    property Kind: TdxLayoutAlignmentConstraintKind read FKind write SetKind
      default ackLeft;
  end;
  ...
  protected
    ...
    function FindNextControl(ACurrentControl: TWinControl; AGoForward: Boolean)
      : TWinControl;
    ...
    property CurrentTabOrder: Integer read GetCurrentTabOrder
      write SetCurrentTabOrder;
    property FocusedItem: TdxCustomLayoutItem read FFocusedItem
      write SetFocusedItem;
  public
    function SelectNext(AFocusedControl: TWinControl;
      const ACharCode: Word = VK_TAB): Boolean;
  end;

  TdxLayoutContainerFocusControllerClass = class of
    TdxLayoutContainerFocusController;
  ...
  TdxLayoutContainerCustomizationHelperClass = class of
    TdxLayoutContainerCustomizationHelper;
  ...
  private
    ...
    procedure SetImageList(var ANewValue, AOldValue: TCustomImageList;
      const AChangeLink: TChangeLink);
  protected
    procedure Changed;
    procedure BeginUpdate;
    procedure EndUpdate;
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property DisabledImages: TCustomImageList read FDisabledImages
  ...
  TdxLayoutContainer = class(TcxCustomComponent, IdxLayoutContainerOwner,
    IdxLayoutDesignerHelper, IdxLayoutLookAndFeelUser, IcxScalableComponent,
    IcxStoredObject, IcxStoredParent, IdxScaleFactor, IdxSelectionChanged)
  private
    ...
    procedure AbsoluteItemListChanged(Sender: TObject; AComponent: TComponent;
      AAction: TcxComponentCollectionNotification);
    procedure AvailableItemListChanged(Sender: TObject; AComponent: TComponent;
      AAction: TcxComponentCollectionNotification);
    procedure FloatContainersListChanged(Sender: TObject;
      AComponent: TComponent; AAction: TcxComponentCollectionNotification);
    function GetAlignmentConstraint(Index: Integer)
    ...
    procedure SetCustomizeAvailableItemsViewKind
  ...
  protected
    ...
    procedure IcxStoredObject.GetPropertyValue = GetStoredPropertyValue;
    procedure IcxStoredObject.SetPropertyValue = SetStoredPropertyValue;
    procedure DoGetStoredPropertyValue(const AName: string;
      var AValue: Variant); virtual;
    procedure DoSetStoredPropertyValue(const AName: string;
      const AValue: Variant); virtual;
    function GetStoredObjectName: string; virtual;
    function GetStoredProperties(AProperties: TStrings): Boolean; virtual;
    procedure GetStoredPropertyValue(const AName: string;
    ...
    procedure SetStoredPropertyValue(const AName: string;
      const AValue: Variant); virtual;
    // IcxStoredParent
    function CreateChild(const AObjectName, AClassName: string)
      : TObject; virtual;
    ...
    // CustomizeForm
    function CalculateCustomizeFormBounds(const AFormBounds: TRect)
      : TRect; virtual;
    ...
    // Classes
    function GetAlignmentConstraintClass
      : TdxLayoutAlignmentConstraintClass; virtual;
    function GetCustomizationHelperClass
      : TdxLayoutContainerCustomizationHelperClass; virtual;
    ...
    function GetFocusControllerClass
      : TdxLayoutContainerFocusControllerClass; virtual;
    function GetPainterClass: TdxLayoutContainerPainterClass; virtual;
    function GetSelectionHelperClass
      : TdxLayoutRunTimeSelectionHelperClass; virtual;
    ...
    function GetStatusHint(const APoint: TPoint;
      const AOriginalHint: string): string;
    ...
    // Wrap functions
    function AddWrapLevel(AGroup: TdxCustomLayoutGroup;
      ALayoutDirection: TdxLayoutDirection): TdxLayoutAutoCreatedWrappingGroup;
    function SimpleWrap(AGroup: TdxCustomLayoutGroup;
    ...
    procedure CustomizationChanged; virtual;
    procedure CustomizeFormPostUpdate(AUpdateTypes
      : TdxLayoutCustomizeFormUpdateTypes); virtual;
    procedure CustomizeFormUpdateList(AItem: TdxCustomLayoutItem);
    function DoGetCustomizationMenuItems(const ASelectedItems: TList)
      : TdxLayoutCustomizeFormMenuItems; virtual;
    ...
    // Customize/Rename
    procedure BeginRename(AItem: TdxCustomLayoutItem; const ABounds: TRect;
      const AFont: TFont); virtual;
    ...
    procedure GetItemStoredProperties(AItem: TdxCustomLayoutItem;
    ...
    procedure RemoveAlignmentConstraint(AConstraint
      : TdxLayoutAlignmentConstraint);
    ...
    procedure BiDiModeChanged; virtual;
    function CreateItemSelectorHelper(AItem: TdxLayoutItem)
      : TdxControlsDesignSelectorHelper; virtual;
    ...
    property AllowGroupWrapItems: Boolean read FAllowGroupWrapItems
      write SetAllowGroupWrapItems;
    property AllowOptimizeWrappedItems: Boolean read FAllowOptimizeWrappedItems
      write FAllowOptimizeWrappedItems;
    property AllowRename: Boolean read FAllowRename write FAllowRename;
    property CustomizationHelper: TdxLayoutContainerCustomizationHelper
      read FCustomizationHelper;
    property FloatContainers: TcxComponentList read FFloatContainers;
    property FocusController: TdxLayoutContainerFocusController
      read FFocusController;
    ...
    property ManagedItems[Index: Integer]: TdxCustomLayoutItem
      read GetManagedItem;
    property MasterContainer: TdxLayoutContainer read FMasterContainer
      write FMasterContainer;
    property MenuItems: TdxLayoutCustomizeFormMenuItems read FMenuItems
      write FMenuItems;
    property Painter: TdxLayoutContainerPainter read FPainter;
    property QuickCustomization: Boolean read FQuickCustomization
      write SetQuickCustomization;
    property RenamingItem: TdxCustomLayoutItem read FRenamingItem
      write SetRenamingItem;
    property RealContainer: TdxLayoutContainer read GetRealContainer;
    property ScaleFactor: TdxScaleFactor read GetScaleFactor;
    property SelectionHelper: IdxLayoutDesignerHelper read GetSelectionHelper;
    property ShowQuickCustomizationToolbar: Boolean
      read FShowQuickCustomizationToolbar write FShowQuickCustomizationToolbar;
    property StoredVersion: Integer read FStoredVersion;
    property OnItemChanged: TdxLayoutItemChangedEvent read FOnItemChanged
      write SetOnItemChanged;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    ...
    procedure Clear;
    function CloneItem(AItem: TdxCustomLayoutItem;
      AParent: TdxCustomLayoutGroup = nil): TdxCustomLayoutItem; virtual;
    function CreateAlignmentConstraint: TdxLayoutAlignmentConstraint;
    function CreateGroup: TdxLayoutGroup; overload;
    function CreateGroup(AGroupClass: TdxCustomLayoutGroupClass;
      AParent: TdxCustomLayoutGroup = nil): TdxCustomLayoutGroup; overload;
    function CreateItem(AItemClass: TdxCustomLayoutItemClass = nil;
    ...
    procedure CustomizeFormUpdate(AUpdateTypes
    ...
    procedure RestoreFromStream(AStream: TStream;
      const ARestoreName: string = '');
    procedure RestoreFromStorage(const AStorageName: string;
      AReaderClass: TcxCustomReaderClass; const ARestoreName: string = '');

    procedure StoreToIniFile(const AStorageName: string;
      AReCreate: Boolean = True; const ASaveName: string = '');
    procedure StoreToRegistry(const AStorageName: string;
      AReCreate: Boolean = True; const ASaveName: string = '');
    procedure StoreToStream(AStream: TStream; const ASaveName: string = '');
    procedure StoreToStorage(const AStorageName: string;
      AWriterClass: TcxCustomWriterClass; AReCreate: Boolean = True;
      const ASaveName: string = '');

    property Customization: Boolean read GetCustomization
      write SetCustomization;
    property CustomizeAvailableItemsViewKind: TdxLayoutAvailableItemsViewKind
      read FCustomizeAvailableItemsViewKind
      write SetCustomizeAvailableItemsViewKind;
    property CustomizeForm: TdxLayoutControlCustomCustomizeForm
      read GetCustomizeForm;
    property CustomizeFormBounds: TRect read FCustomizeFormBounds
      write FCustomizeFormBounds;
    property CustomizeFormClass: TdxLayoutControlCustomCustomizeFormClass
      read FCustomizeFormClass write FCustomizeFormClass;
    property CustomizeFormTabbedView: Boolean read FCustomizeFormTabbedView
      write SetCustomizeFormTabbedView;
    property DragDropMode: TdxLayoutDragDropMode read GetDragDropMode
      write FDragDropMode;
    property HighlightRoot: Boolean read FHighlightRoot write SetHighlightRoot;
    property ImageOptions: TdxLayoutImageOptions read FImageOptions
      write SetImageOptions;
    property LayoutLookAndFeel: TdxCustomLayoutLookAndFeel
      read FLayoutLookAndFeel write SetLayoutLookAndFeel;
    property ShowDesignSelectors: Boolean read FShowDesignSelectors
      write SetShowDesignSelectors;
    ...
    property AbsoluteItems[Index: Integer]: TdxCustomLayoutItem
      read GetAbsoluteItem;
    property AvailableItemCount: Integer read GetAvailableItemCount;
    property AvailableItems[Index: Integer]: TdxCustomLayoutItem
      read GetAvailableItem;
  ...
  private
    ...
    FPos: TPoint;
  public
    function CanDragAndDrop(AItem: TdxCustomLayoutItem; const P: TPoint)
      : Boolean; virtual;
    ...
    property ViewInfo: TdxCustomLayoutItemViewInfo read FViewInfo
      write FViewInfo; // for internal use
  ...
  public
    ...
    property DropAreaPart: TdxLayoutDropAreaPart read FDropAreaPart
      write FDropAreaPart;
    property Container: TdxLayoutContainer read FContainer write FContainer;
  end;

  TdxLayoutCustomizeFormAvailableItemsHitTest = class
    (TdxLayoutCustomizeFormHitTest)
  public
    function HitTestCode: Integer; override;
  end;

  TdxLayoutCustomizeFormTreeViewItemsHitTest = class
    (TdxLayoutCustomizeFormHitTest)
  public
    function HitTestCode: Integer; override;
  end;
  ...
  private
    ...
    function GetViewInfo: TdxCustomLayoutItemViewInfo;
  protected
    function GetCaptionPainterClass: TdxCustomLayoutItemCaptionPainterClass;
      virtual; abstract;
  ...
  protected
    ...
    function GetCaptionPainterClass
      : TdxCustomLayoutItemCaptionPainterClass; override;
  end;
  ...
  TdxLayoutCheckBoxItemPainter = class(TdxLayoutLabeledItemPainter)
  strict private
  ...
  TdxLayoutRadioButtonItemPainter = class(TdxLayoutLabeledItemPainter)
  strict private
  ...
  protected
    ...
    function GetControlPainterClass
      : TdxLayoutControlItemControlPainterClass; virtual;
  ...
  protected
    function CreateInternalGlyph(APainter: TcxCustomLookAndFeelPainter)
      : TcxBitmap32;
    procedure DrawButton(ACanvas: TcxCanvas;
      APainter: TcxCustomLookAndFeelPainter; AGlyph: TGraphic);
  ...
  protected
    ...
    function CanAssignBounds(ASource: TdxCustomLayoutElementViewInfo)
      : Boolean; virtual;
  ...
  protected
    ...
    function CalculateTextFlags(AForDrawing: Boolean = True): Integer; virtual;
    ...
    procedure CalculateFormattedText(AFormattedText: TdxFormattedText;
      const AFlags: Integer; const ARect: TRect; ACanvas: TCanvas;
      const AForDrawing: Boolean);
    procedure CalculateImageTextAreaBounds; virtual;
    function GetColor: TColor; virtual;
    function GetFont: TFont; virtual;
    function GetFormattedTextSize(ACanvas: TcxCanvas; const AFlags: Integer;
    ...
    function GetTextSize(ACanvas: TcxCanvas): TSize; overload; virtual;
  ...
  TdxCustomLayoutItemCaptionViewInfoClass = class of
  ...
  protected
    ...
    property ViewInfo: TdxCustomLayoutItemViewInfo read FViewInfo
      write FViewInfo;
  public
    constructor Create(AOwner: TdxLayoutItemViewDataList;
  ...
  protected
    procedure Changed;
  public
    property Items[Index: Integer]: TdxCustomLayoutItemViewData read GetItem
      write SetItem; default; // for internal use
    property OnChanged: TNotifyEvent read FOnChanged write FOnChanged;
  end;
  ...
  private
    ...
    function CreateHitTest(AHitTestClass: TdxCustomLayoutItemHitTestClass;
  ...
  protected
    ...
    procedure PopulateControlViewInfoList(AControls, AWinControls
      : TList); virtual;
    ...
    function GetCaptionViewInfoClass: TdxCustomLayoutItemCaptionViewInfoClass;
      virtual; abstract;
    function GetHitTestClass: TdxCustomLayoutItemHitTestClass; virtual;
      abstract;
    function GetPainterClass: TdxCustomLayoutItemPainterClass; virtual;
      abstract;
    ...
    function DoCalculateHeight(ACalcSizeType: TdxLayoutCalcSizeType)
      : Integer; virtual;
    function DoCalculateWidth(ACalcSizeType: TdxLayoutCalcSizeType)
      : Integer; virtual;
    ...
    function GetMarkerIndex(AMarkers: TRects; const P: TPoint)
      : Integer; overload;
    ...
    procedure CustomizationMouseDown(Button: TMouseButton; Shift: TShiftState;
      X, Y: Integer); virtual;
    function DoMouseWheel(Shift: TShiftState; WheelDelta: Integer;
      MousePos: TPoint): Boolean; virtual;
    function IsMouseWheelHandleNeeded(Shift: TShiftState; WheelDelta: Integer;
    ...
    procedure PaintContent(ADestImage: TcxAlphaBitmap;
      ANeedDrawFrame, AExtractLayer: Boolean);
    ...
    property ElementWithMouse: TdxCustomLayoutItemElementViewInfo
      read FElementWithMouse write SetElementWithMouse;
    property Item: TdxCustomLayoutItem read GetItem;
  ...
  public
    constructor Create(AContainerViewInfo: TdxLayoutContainerViewInfo;
    ...
    procedure CalculateInternalTabOrders(var AAvailableTabOrder
      : Integer); virtual;
    ...
    property CaptionViewInfo: TdxCustomLayoutItemCaptionViewInfo
      read FCaptionViewInfo; // for internal use
    property Color: TColor read GetColor;
    property ContainerViewInfo: TdxLayoutContainerViewInfo
      read FContainerViewInfo; // for internal use
    ...
    property Offsets[ASide: TdxLayoutSide]: Integer read GetOffset
      write SetOffset;
  ...
  TdxLayoutEmptySpaceItemCaptionViewInfo = class
    (TdxLayoutBasicItemCaptionViewInfo)
  protected
  ...
  TdxLayoutControlItemCaptionViewInfo = class
    (TdxLayoutLabeledItemCaptionViewInfo)
  private
  ...
  public
    procedure Calculate(const ABounds: TRect); override;
    procedure CalculateInternalTabOrder(var AAvailableTabOrder
      : Integer); virtual;
  ...
  TdxLayoutControlItemControlViewInfoClass = class of
  ...
  protected
    function GetCaptionViewInfoClass
      : TdxCustomLayoutItemCaptionViewInfoClass; override;
  ...
  protected
    ...
    procedure InitViewInfoBounds(AElementViewInfo
      : TdxCustomLayoutItemElementViewInfo; out ABounds: TRect;
    ...
    function GetContentHeight(ACalcSizeType: TdxLayoutCalcSizeType)
      : Integer; virtual;
    function GetContentWidth(ACalcSizeType: TdxLayoutCalcSizeType)
      : Integer; virtual;
    function DoCalculateHeight(ACalcSizeType: TdxLayoutCalcSizeType)
      : Integer; override;
    function DoCalculateWidth(ACalcSizeType: TdxLayoutCalcSizeType)
  ...
  TdxLayoutSeparatorItemCaptionViewInfo = class
    (TdxLayoutLabeledItemCaptionViewInfo)
  protected
  ...
  protected
    ...
    property SeparatorBounds: TRect read FCellAreaBounds write FCellAreaBounds;
  public
  ...
  TdxCustomLayoutCheckableItemCaptionViewInfo = class
    (TdxLayoutLabeledItemCaptionViewInfo)
  protected
  ...
  protected
    ...
    procedure CalculateCheckAreaBounds; virtual; abstract;
    function GetCheckAreaSize: TSize; virtual; abstract;
    function GetFocusRect(ACanvas: TcxCanvas): TRect; virtual;
    procedure UpdateCaptionAreaBounds; virtual; abstract;
    procedure CorrectFocusRect(var AFocusRect: TRect);
  ...
  strict private
    function GetItem: TdxLayoutCheckBoxItem;
  protected
    procedure CalculateCheckAreaBounds; override;
    function GetAvailableTextAreaWidth: Integer; override;
    ...
    function GetPainterClass: TdxCustomLayoutItemPainterClass; override;
    procedure UpdateCaptionAreaBounds; override;

    function GetContentOffsets: TRect;
    function GetIsTextEnabled: Boolean;
    function GetTextGap: Integer;
  public
    property Item: TdxLayoutCheckBoxItem read GetItem;
  end;
  ...
  protected
    ...
    function GetCaptionAreaOffsets: TRect;
  public
  ...
  protected
    ...
    function GetControlViewInfoClass
      : TdxLayoutControlItemControlViewInfoClass; virtual;
    function GetPainterClass: TdxCustomLayoutItemPainterClass; override;
  ...
  public
    ...
    property CaptionLayout: TdxCaptionLayout read GetCaptionLayout;
    property CaptionViewInfo: TdxLayoutControlItemCaptionViewInfo
      read GetCaptionViewInfo; // for internal use
    property ControlViewInfo: TdxLayoutControlItemControlViewInfo
      read FControlViewInfo; // for internal use
  end;
  ...
  protected
    ...
    property Item: TdxLayoutItem read GetItem;
  public
    property CaptionViewInfo: TdxLayoutItemCaptionViewInfo
      read GetCaptionViewInfo; // for internal use
    property ControlViewInfo: TdxLayoutItemControlViewInfo
      read GetControlViewInfo; // for internal use
  end;
  ...
  protected
    ...
    procedure CalculateImageTextAreaBounds; override;
    function CalculateTextFlags(AForDrawing: Boolean = True): Integer; override;
  ...
  protected
    ...
    function GetMajorAlign(const AAlign: TdxLayoutRealAlign)
      : TdxLayoutAlignAbs; virtual;
    function GetMinorAlign(const AAlign: TdxLayoutRealAlign)
      : TdxLayoutAlignAbs; virtual;

    procedure SetMajorNear(var R: TRect; AValue: Integer); virtual;
    procedure SetMajorFar(var R: TRect; AValue: Integer); virtual;
    procedure SetMajorAlign(var AAlign: TdxLayoutRealAlign;
      AValue: TdxLayoutAlignAbs); virtual;
    procedure SetMinorAlign(var AAlign: TdxLayoutRealAlign;
      AValue: TdxLayoutAlignAbs); virtual;
    procedure CorrectMajorAlignForLocale(var AAlign
      : TdxLayoutRealAlign); virtual;
    procedure CorrectMinorAlignForLocale(var AAlign
      : TdxLayoutRealAlign); virtual;
    ...
    procedure CalculateItemsMajorBounds(const AItemsAreaBounds
      : TdxAbsRect); virtual;
    procedure CalculateItemsMinorBounds(const AItemsAreaBounds
      : TdxAbsRect); virtual;
    ...
    // Dragging
    procedure CorrectDropAreaPart(const P: TPoint;
      var AAreaPart: TdxLayoutDropAreaPart); virtual;
    ...
    // Dragging1
    function CutItemRect(AItem: TdxCustomLayoutItem; const R: TRect): TRect;
      virtual; abstract;
    function GetDropActionType(AAreaPart: TdxLayoutDropAreaPart)
      : TdxLayoutActionType; virtual; abstract;
    // Dragging2
    function GetDropAlignOutsideArea(const ADefaultAlign: TdxLayoutRealAlign;
      const ABounds: TRect; const ADropAreaInfo: TdxLayoutDragDropInfo)
      : TdxLayoutRealAlign;
    function GetDropAlignOutsideItem(const ADropAreaInfo: TdxLayoutDragDropInfo)
      : TdxLayoutRealAlign;
    function GetDropAlignInsideArea(const ADefaultAlign: TdxLayoutRealAlign;
      const ABounds: TRect; const ADropAreaInfo: TdxLayoutDragDropInfo)
      : TdxLayoutRealAlign;
    // Dragging3
    function GetDropAreaPart(var P: TPoint): TdxLayoutDropAreaPart; virtual;
    function GetDropExpectedBounds(const ADropAreaInfo: TdxLayoutDragDropInfo)
      : TRect; virtual;
    function GetDropExpectedAlign(const ADropAreaInfo: TdxLayoutDragDropInfo)
      : TdxLayoutRealAlign; virtual;
    function GetDropRectOutsideItem(const ADropAreaInfo: TdxLayoutDragDropInfo)
      : TRect; virtual;
    function GetDropRectInsideRect(const ARect: TRect;
      const ADropAreaInfo: TdxLayoutDragDropInfo): TRect;
    function IsDropPositionHasProperAlign(const ADropAreaInfo
      : TdxLayoutDragDropInfo): Boolean; virtual;
    function IsDropPositionHasOppositeAlign(const ADropAreaInfo
      : TdxLayoutDragDropInfo): Boolean; virtual;
    // Dragging4
    ...
    function GetMinorSize(ACalcSizeType: TdxLayoutCalcSizeType)
      : Integer; virtual;
    function GetMajorSize(ACalcSizeType: TdxLayoutCalcSizeType)
      : Integer; virtual;
    function GetItemOriginalMinorSize(AViewInfo: TdxCustomLayoutItemViewInfo)
      : Integer; virtual; abstract;
    function GetItemOriginalMajorSize(AViewInfo: TdxCustomLayoutItemViewInfo)
      : Integer; virtual; abstract;
    function GetItemSufficientMinorSize(AViewInfo: TdxCustomLayoutItemViewInfo)
      : Integer; virtual; abstract;
    function GetItemSufficientMajorSize(AViewInfo: TdxCustomLayoutItemViewInfo)
      : Integer; virtual; abstract;
    function GetItemMinMinorSize(AViewInfo: TdxCustomLayoutItemViewInfo)
      : Integer; virtual; abstract;
    function GetItemMinMajorSize(AViewInfo: TdxCustomLayoutItemViewInfo)
      : Integer; virtual; abstract;
    function GetItemMaxMinorSize(AViewInfo: TdxCustomLayoutItemViewInfo)
      : Integer; virtual; abstract;
    function GetItemMaxMajorSize(AViewInfo: TdxCustomLayoutItemViewInfo)
      : Integer; virtual; abstract;
    function GetItemsAreaOffset(ASide: TdxLayoutSide): Integer; virtual;

    function IsItemMajorSizeUsual(AViewInfo
      : TdxCustomLayoutItemViewInfo): Boolean;
    function IsItemMinorSizeUsual(AViewInfo
      : TdxCustomLayoutItemViewInfo): Boolean;
    ...
    // Specific Objects
    procedure InitializeMajorScrollBar(AContentSize,
      AClientSize: Integer); virtual;
    procedure InitializeMinorScrollBar(AContentSize,
      AClientSize: Integer); virtual;
    ...
    function CanAssignBounds(ASource: TdxLayoutGroupViewInfoSpecific)
      : Boolean; virtual;
    procedure DoAssignBounds(ASource: TdxLayoutGroupViewInfoSpecific); virtual;
    procedure DoRightToLeftConversion(const AClientBounds: TRect); virtual;
    procedure MakeVisible(const ARect: TRect; AFully: Boolean); virtual;
    function GetNewScrollPosMajor(const ARect: TRect; AFully: Boolean;
      AScrollPos: Integer): Integer;
    function GetNewScrollPosMinor(const ARect: TRect; AFully: Boolean;
      AScrollPos: Integer): Integer;
    ...
    property ItemViewInfos[Index: Integer]: TdxCustomLayoutItemViewInfo
      read GetItemViewInfo;
  ...
  public
    ...
    function GetItemsAreaHeight(ACalcSizeType: TdxLayoutCalcSizeType)
      : Integer; virtual;
    function GetItemsAreaWidth(ACalcSizeType: TdxLayoutCalcSizeType)
      : Integer; virtual;
    function IsAtInsertionPos(const R: TRect; const P: TPoint): Boolean;
      virtual; abstract;

    function AllowDrawChild(AChildViewInfo: TdxCustomLayoutItemViewInfo)
      : Boolean; virtual;
    function AllowChildHasBorder: Boolean; virtual;
    function GetChildInplaceRenameBounds(AChildViewInfo
      : TdxCustomLayoutItemViewInfo): TRect; virtual;
    function GetDefaultItemControlAreaAlignment
      : TdxLayoutItemControlAreaAlignment; virtual;
    function ProcessDialogChar(ACharCode: Word): Boolean; virtual;
    function ProcessDialogKey(ACharCode: Word; AKeyData: Integer;
      AFocusedItem: TdxCustomLayoutItem): Boolean; virtual;
  end;

  TdxLayoutGroupViewInfoHorizontalSpecific = class
  ...
  protected
    ...
    procedure InitializeMajorScrollBar(AContentSize,
      AClientSize: Integer); override;
    procedure InitializeMinorScrollBar(AContentSize,
      AClientSize: Integer); override;

    // Dragging
    function CutItemRect(AItem: TdxCustomLayoutItem; const R: TRect)
      : TRect; override;
    function GetLastChildDropArea: TRect; override;
    function GetDropActionType(AAreaPart: TdxLayoutDropAreaPart)
      : TdxLayoutActionType; override;
  ...
  public
    function IsAtInsertionPos(const R: TRect; const P: TPoint)
      : Boolean; override;
  end;
  ...
  protected
    ...
    function GetDropActionType(AAreaPart: TdxLayoutDropAreaPart)
      : TdxLayoutActionType; override;
    function IsDropPositionHasProperAlign(const ADropAreaInfo
      : TdxLayoutDragDropInfo): Boolean; override;
    function IsDropPositionHasOppositeAlign(const ADropAreaInfo
      : TdxLayoutDragDropInfo): Boolean; override;
  ...
  TdxLayoutGroupViewInfoTabbedSpecific = class
    (TdxLayoutGroupViewInfoHorizontalSpecific, IcxTabControl,
  ...
  private
    ...
    procedure DoCalculateTabControl(const ATabBounds: TRect;
  ...
  protected
    ...
    // Dragging
    procedure CorrectDropAreaPart(const P: TPoint;
      var AAreaPart: TdxLayoutDropAreaPart); override;
    function GetDropActionType(AAreaPart: TdxLayoutDropAreaPart)
      : TdxLayoutActionType; override;
  ...
  public
    ...
    function GetChildInplaceRenameBounds(AChildViewInfo
      : TdxCustomLayoutItemViewInfo): TRect; override;
    function GetDefaultItemControlAreaAlignment
      : TdxLayoutItemControlAreaAlignment; override;
    function ProcessDialogChar(ACharCode: Word): Boolean; override;
    function ProcessDialogKey(ACharCode: Word; AKeyData: Integer;
      AFocusedItem: TdxCustomLayoutItem): Boolean; override;
  end;
  ...
  public
    constructor Create(AButtonsViewInfo: TdxLayoutGroupButtonsViewInfo;
      AButton: TdxCustomLayoutGroupButton); reintroduce; virtual;

    function CalculateHeight: Integer; override;
    function CalculateWidth: Integer; override;

    property Button: TdxCustomLayoutGroupButton read FButton;
    property ButtonsViewInfo: TdxLayoutGroupButtonsViewInfo
      read FButtonsViewInfo; // for internal use
  ...
  public
    ...
    property ButtonViewInfos[Index: Integer]: TdxLayoutGroupButtonViewInfo
      read GetButtonViewInfos; // for internal use
    property GroupViewInfo: TdxLayoutGroupViewInfo read GetGroupViewInfo;
    // for internal use
  end;
  ...
  public
    constructor Create(AOwner: TdxLayoutItemViewDataList;
      AItem: TdxCustomLayoutItem); override;
    destructor Destroy; override;
  ...
  TdxLayoutGroupViewInfo = class(TdxCustomLayoutItemViewInfo,
    IdxTouchScrollUIOwner, IdxHybridScrollbarOwner, IcxScrollBarOwner,
  ...
  private
    ...
    function GetGroup: TdxCustomLayoutGroup;
    function GetItemViewInfo(Index: Integer)
      : TdxCustomLayoutItemViewInfo; inline;
    function GetItemViewInfoCount: Integer;
    function GetLayoutDirection: TdxLayoutDirection;
    ...
    procedure CheckScrollPos(AScrollBar: TdxScrollBarWrapper;
      var AScrollPos: Integer);
    procedure SetScrollBounds(AScrollBar: TdxScrollBarWrapper;
      const ABounds: TRect);
  ...
  protected
    ...
    function GetDestinationItem(const ADropAreaInfo: TdxLayoutDragDropInfo)
      : TdxCustomLayoutItem;
    function GetDropActionType(AAreaPart: TdxLayoutDropAreaPart)
      : TdxLayoutActionType;
    function GetDropAreaPart(var P: TPoint): TdxLayoutDropAreaPart; override;
    function GetDropExpectedBounds(const ADropAreaInfo
      : TdxLayoutDragDropInfo): TRect;
    function GetDropExpectedAlign(const ADropAreaInfo: TdxLayoutDragDropInfo)
      : TdxLayoutAlign; // override;
    function GetDropHorzAlignForLocale(const AHorzAlign: TdxLayoutAlignHorz)
      : TdxLayoutAlignHorz;
    ...
    function GetLevelingItemCaptionWidth(AItemViewInfo
      : TdxLayoutControlItemViewInfo; AMaxCaptionSize: Integer)
      : Integer; virtual;
    ...
    function CanHandleMouseWheel(Shift: TShiftState; WheelDelta: Integer;
      MousePos: TPoint): Boolean;
    procedure DoMajorScroll(Sender: TObject; AScrollCode: TScrollCode;
      var AScrollPos: Integer);
    procedure DoMinorScroll(Sender: TObject; AScrollCode: TScrollCode;
      var AScrollPos: Integer);
    function DoMouseWheel(Shift: TShiftState; WheelDelta: Integer;
    ...
    function GetChildInplaceRenameBounds(AChildViewInfo
      : TdxCustomLayoutItemViewInfo): TRect; virtual;
    function GetRotationAngle: TcxRotationAngle;
    function IsChildActuallyVisible(AChildViewInfo
      : TdxCustomLayoutItemViewInfo): Boolean;
    ...
    property ItemsAreaOffsetHorz: Integer index 1 read GetOffset
      write FItemsAreaOffsetHorz;
    property ItemsAreaOffsetVert: Integer index 2 read GetOffset
      write FItemsAreaOffsetVert;
  ...
  public
    constructor Create(AContainerViewInfo: TdxLayoutContainerViewInfo;
      AParentViewInfo: TdxLayoutGroupViewInfo;
      AViewData: TdxCustomLayoutItemViewData); override;
    destructor Destroy; override;
    ...
    function FindItemViewInfo(AItem: TdxCustomLayoutItem)
  ...
  private
    ...
    procedure SelectionLayerHitTest(ASender: TObject;
      var AIsTransparent: Boolean);
    procedure SelectionLayerUpdate(Sender: TObject);
    procedure SelectionLayerEndRename(ASender: TObject; const AText: string;
      AAccept: Boolean);
  ...
  protected
    ...
    FItemViewInfoDictionary
      : TDictionary<TdxCustomLayoutItem, TdxCustomLayoutItemViewInfo>;

    function CanShowGroupScrollBars: Boolean; virtual;
    procedure CreateViewInfos; virtual;
    function CreateItemViewInfo(AParentViewInfo: TdxLayoutGroupViewInfo;
      AItem: TdxCustomLayoutItem): TdxCustomLayoutItemViewInfo;
    procedure DestroyViewInfos; virtual;
    function GetRootViewInfoClass: TdxLayoutRootViewInfoClass; virtual;
    function GetLayoutLookAndFeel: TdxCustomLayoutLookAndFeel; virtual;
    function GetItemLayoutLookAndFeel(AViewInfo: TdxCustomLayoutItemViewInfo)
      : TdxCustomLayoutLookAndFeel; virtual;
    function GetItemOptions(AViewInfo: TdxCustomLayoutItemViewInfo)
      : TdxCustomLayoutLookAndFeelOptions; virtual;
    ...
    function CanAssignBounds(ASource: TdxLayoutContainerViewInfo)
      : Boolean; virtual;
    procedure DoAssignBounds(ASource: TdxLayoutContainerViewInfo); virtual;

    function GetViewData(AItem: TdxCustomLayoutItem)
      : TdxCustomLayoutItemViewData;
    function GetViewDataClass(AItem: TdxCustomLayoutItem)
      : TdxCustomLayoutItemViewDataClass; virtual;
    function FindCloneData(AItem: TdxCustomLayoutItem;
      out ACloneData: TdxCustomLayoutItemViewData): Boolean;
  ...
  public
    ...
    function FindItemViewInfo(AItem: TdxCustomLayoutItem;
      out AViewInfo: TdxCustomLayoutItemViewInfo): Boolean;
    function GetHitTest(const P: TPoint): TdxCustomLayoutHitTest; virtual;
    function GetItemViewInfo(AItem: TdxCustomLayoutItem)
      : TdxCustomLayoutItemViewInfo; virtual;
...
procedure dxDrawItemGlyph(ACanvas: TcxCanvas; AItem: TdxCustomLayoutItem;
  R: TRect; ARotationAngle: TcxRotationAngle;
  AColorPalette: IdxColorPalette = nil);

procedure dxLayoutSetItemStates(AContainer: TdxLayoutContainer;
  AUnwrapTabs, AActiveTabToTop, ASkipEmptyGroups, AExpandGroups: Boolean);
procedure dxLayoutStoreItemStates(AList: TList; AContainer: TdxLayoutContainer);
procedure dxLayoutRestoreItemStates(AList: TList;
  AContainer: TdxLayoutContainer);

function dxLayoutIsSameAlign(AAlign1, AAlign2: TdxLayoutAlign): Boolean;
function dxLayoutAlign(AHorz: TdxLayoutAlignHorz; AVert: TdxLayoutAlignVert)
  : TdxLayoutAlign;
...
uses
  ...
  cxContainer, dxOffice11, cxButtons, dxDPIAwareUtils, cxCheckBox,
  dxThemeManager, cxPCPaintersFactory,
  dxLayoutControlAdapters, dxLayoutCustomizeForm, dxLayoutStrs,
  dxLayoutDragAndDrop, cxDrawTextUtils, cxEditUtils,
  dxLayoutControl, dxFormattedTextConverterBBCode, dxFormattedTextConverterRTF,
...
type
  ...
  TdxLayoutCustomDragAndDropControllerAccess = class
...
const
  ...
  lcStoredProperties: array [0 .. 11] of string = ('IsUserDefined',
    'ParentName', 'Index', 'AlignHorz', 'AlignVert', 'Width', 'Height',
    'IsFloat', 'FloatPosX', 'FloatPosY', 'TakeoffParent', 'TakeoffIndex');
...
type
  ...
  protected
    class procedure LoadCaption(AItem: TdxCustomLayoutItem;
      AIniFile: TCustomIniFile; const ASection: string); virtual;
  public
    class procedure LoadFromIni(AItem: TdxCustomLayoutItem;
      AIniFile: TCustomIniFile; const ASection: string); virtual;
  end;
  ...
  public
    class procedure LoadFromIni(AItem: TdxCustomLayoutItem;
      AIniFile: TCustomIniFile; const ASection: string); override;
  end;
  ...
  public
    class procedure LoadFromIni(AGroup: TdxCustomLayoutGroup;
      AIniFile: TCustomIniFile; const ASection: string); virtual;
  end;
  ...
  protected
    class procedure SaveCaption(AItem: TdxCustomLayoutItem;
      AIniFile: TCustomIniFile; const ASection: string); virtual;
  public
    class procedure SaveToIni(AItem: TdxCustomLayoutItem;
  ...
  public
    class procedure SaveToIni(AGroup: TdxCustomLayoutGroup;
      AIniFile: TCustomIniFile; const ASection: string);
  end;
...
begin
  ...
  else if AItem.ViewInfo <> nil then
    Result := AItem.ViewInfo.CalculateWidth
  else
    Result := 0;
end;
...
begin
  Result := cxRectWidth(AGroup.ViewInfo.ItemsAreaBounds) -
    GetGroupContentWidth(AGroup);
end;

function GetFreeSpaceForItem(AItem: TdxCustomLayoutItem): Integer;

  function FindNearestVerticalParent(AGroup: TdxCustomLayoutGroup)
  ...
  begin
    if AItem.Parent.LayoutDirection = ldVertical then
      Result := cxRectWidth(AItem.Parent.ViewInfo.ItemsAreaBounds) -
        AItem.ViewInfo.MinWidth
    else
      Result := cxRectWidth(AItem.Parent.ViewInfo.ItemsAreaBounds) -
        GetGroupContentWidth(AItem.Parent) +
        (AItem.ViewInfo.UsualWidth - AItem.ViewInfo.MinWidth);
  end;
...
begin
  Result := cxRectInflate(cxRect(P, P), (AMarkerWidth - 1) div 2,
    (AMarkerWidth - 1) div 2);
  Inc(Result.Bottom);
  Inc(Result.Right);
end;

function dxGetSelectionMarkers(const ABorderBounds: TRect;
  AMarkerWidth: Integer): TRects;
var
...
begin
  ...
  begin
    ...
    Result[4] := dxGetSelectionMarker(Point(Right - 1, Bottom - 1),
      AMarkerWidth);
    Result[5] := dxGetSelectionMarker(Point(AMiddleX, Bottom - 1),
      AMarkerWidth);
...
procedure dxDrawItemGlyph(ACanvas: TcxCanvas; AItem: TdxCustomLayoutItem;
  ...
  function GetDrawMode(AGlyph: TdxSmartGlyph; AImages: TCustomImageList)
    : TcxImageDrawMode;
  var
    ADrawEnabled: Boolean;
  begin
    ADrawEnabled := AItem.Enabled or
      (not IsGlyphAssigned(AGlyph) and
      (AImages = AItem.Container.GetDisabledImages));
...
begin
  if AItem.CaptionOptions.ImageOptions.GetCurrentImage(AGlyph, AImages,
    AImageIndex) then
  begin
    ...
    begin
      ...
      try
        cxDrawImage(ABitmap.cxCanvas.Handle, ABitmap.ClientRect,
          ABitmap.ClientRect, AGlyph, AImages, AImageIndex,
          GetDrawMode(AGlyph, AImages), True, 0, clNone, True, AColorPalette);
    ...
    begin
      ...
      if ASkipEmptyGroups then
        for I := 0 to AGroup.VisibleCount - 1 do
          if AGroup.VisibleItems[I].IsGroup and
            (AGroup.VisibleItems[I].AsGroup.VisibleCount = 0) then
...
function dxIsValueInDiapason(AValue, ABound1, ABound2: Integer;
  AIncludeBounds: Boolean = True): Boolean;
begin
...
type
  ...
  public
    constructor Create;
    destructor Destroy; override;
    function GetAdapterClass(AControl: TControl)
...
function dxLayoutGetCenterAreaBounds(const AItemBounds: TRect;
  APart: Integer = 4): TRect;
begin
  Result := AItemBounds;
  with Result do
...
function TdxLayoutControlAdapterDefs.GetItem(Index: Integer)
  : TControlAdapterRecord;
begin
...
function TdxLayoutControlAdapterDefs.GetAdapterClass(AControl: TControl)
  : TdxCustomLayoutControlAdapterClass;
var
  I: Integer;
...
class procedure TdxLayoutBasicItemReader.LoadCaption(AItem: TdxCustomLayoutItem;
  AIniFile: TCustomIniFile; const ASection: string);
begin
  AItem.Caption := AIniFile.ReadString(ASection, 'Caption', AItem.Caption);
end;

class procedure TdxLayoutBasicItemReader.LoadFromIni(AItem: TdxCustomLayoutItem;
  AIniFile: TCustomIniFile; const ASection: string);
begin
...
class procedure TdxLayoutBasicItemReader2.LoadFromIni
  (AItem: TdxCustomLayoutItem; AIniFile: TCustomIniFile;
  const ASection: string);

  function ReadScaledValue(const ASection, AIdent: string;
    ADefaultValue: Integer): Integer;
  begin
    if AIniFile.ValueExists(ASection, AIdent) then
      Result := AItem.ScaleFactor.Apply(AIniFile.ReadInteger(ASection, AIdent,
        AItem.ScaleFactor.Revert(ADefaultValue)))
    else
...
begin
  inherited;
  AItem.AlignHorz := TdxLayoutAlignHorz(AIniFile.ReadInteger(ASection,
    'AlignHorz', Integer(AItem.AlignHorz)));
  AItem.AlignVert := TdxLayoutAlignVert(AIniFile.ReadInteger(ASection,
    'AlignVert', Integer(AItem.AlignVert)));

  AItem.Width := ReadScaledValue(ASection, 'Width', AItem.Width);
  AItem.Height := ReadScaledValue(ASection, 'Height', AItem.Height);

  AItem.CaptionOptions.AlignHorz :=
    TAlignment(AIniFile.ReadInteger(ASection, 'CaptionAlignHorz',
    Integer(AItem.CaptionOptions.AlignHorz)));
  AItem.CaptionOptions.AlignVert :=
    TdxAlignmentVert(AIniFile.ReadInteger(ASection, 'CaptionAlignVert',
    Integer(AItem.CaptionOptions.AlignVert)));
  AItem.CaptionOptions.Layout := TdxCaptionLayout(AIniFile.ReadInteger(ASection,
    'CaptionLayout', Integer(AItem.CaptionOptions.Layout)));
end;

{ TdxLayoutBasicItemReader3 }

class procedure TdxLayoutBasicItemReader3.LoadCaption
  (AItem: TdxCustomLayoutItem; AIniFile: TCustomIniFile;
  const ASection: string);
var
  ACaption: string;
...
class procedure TdxLayoutBasicItemReader3.LoadFromIni
  (AItem: TdxCustomLayoutItem; AIniFile: TCustomIniFile;
  const ASection: string);
begin
  inherited;
  AItem.CaptionOptions.Visible := AIniFile.ReadBool(ASection, 'ShowCaption',
    AItem.CaptionOptions.Visible);
end;

{ TdxLayoutGroupReader }

class procedure TdxLayoutGroupReader.LoadFromIni(AGroup: TdxCustomLayoutGroup;
  AIniFile: TCustomIniFile; const ASection: string);
begin
  AGroup.Hidden := AIniFile.ReadBool(ASection, 'Hidden', AGroup.Hidden);
  AGroup.LayoutDirection := TdxLayoutDirection(AIniFile.ReadInteger(ASection,
    'LayoutDirection', Integer(AGroup.LayoutDirection)));
end;

{ TdxLayoutGroupReader2 }

class procedure TdxLayoutGroupReader2.LoadFromIni(AGroup: TdxCustomLayoutGroup;
  AIniFile: TCustomIniFile; const ASection: string);
begin
  inherited;
  AGroup.ItemIndex := AIniFile.ReadInteger(ASection, 'ItemIndex',
    AGroup.ItemIndex);
  AGroup.Expanded := AIniFile.ReadBool(ASection, 'Expanded', AGroup.Expanded);
  AGroup.ShowBorder := AIniFile.ReadBool(ASection, 'ShowBorder',
    AGroup.ShowBorder);
end;

{ TdxLayoutGroupReader3 }

class procedure TdxLayoutGroupReader3.LoadFromIni(AGroup: TdxCustomLayoutGroup;
  AIniFile: TCustomIniFile; const ASection: string);
begin
  inherited;
  AGroup.ButtonOptions.ShowExpandButton := AIniFile.ReadBool(ASection,
    'ShowExpandButton', False);
  AGroup.ButtonOptions.CheckBox.Checked := AIniFile.ReadBool(ASection,
    'CheckBoxChecked', True);
end;

{ TdxLayoutBasicItemWriter }

class procedure TdxLayoutBasicItemWriter.SaveCaption(AItem: TdxCustomLayoutItem;
  AIniFile: TCustomIniFile; const ASection: string);
begin
  AIniFile.WriteString(ASection, 'Caption', cxQuotedStr(AItem.Caption));
end;

class procedure TdxLayoutBasicItemWriter.SaveToIni(AItem: TdxCustomLayoutItem;
  AIniFile: TCustomIniFile; const ASection: string);
...
begin
  ...
  AIniFile.WriteInteger(ASection, 'Width',
    AItem.ScaleFactor.Revert(AItem.Width));
  AIniFile.WriteInteger(ASection, 'Height',
    AItem.ScaleFactor.Revert(AItem.Height));
  AIniFile.WriteInteger(ASection, 'ItemClassKind', AItem.GetItemClassKind);

  if (AItem.CaptionOptions is TdxLayoutLabeledItemCaptionOptions) or
    (AItem.CaptionOptions is TdxLayoutGroupCaptionOptions) then
  begin
    AIniFile.WriteBool(ASection, 'ShowCaption', AItem.CaptionOptions.Visible);
    AIniFile.WriteInteger(ASection, 'CaptionAlignHorz',
      Integer(AItem.CaptionOptions.AlignHorz));
    AIniFile.WriteInteger(ASection, 'CaptionAlignVert',
      Integer(AItem.CaptionOptions.AlignVert));
    AIniFile.WriteInteger(ASection, 'CaptionLayout',
      Integer(AItem.CaptionOptions.Layout));
  end;
end;

{ TdxLayoutGroupWriter }

class procedure TdxLayoutGroupWriter.SaveToIni(AGroup: TdxCustomLayoutGroup;
  AIniFile: TCustomIniFile; const ASection: string);
begin
  AIniFile.WriteBool(ASection, 'Hidden', AGroup.Hidden);
  AIniFile.WriteInteger(ASection, 'LayoutDirection',
    Integer(AGroup.LayoutDirection));
  ...
  AIniFile.WriteBool(ASection, 'ShowExpandButton',
    AGroup.ButtonOptions.ShowExpandButton);
  AIniFile.WriteBool(ASection, 'CheckBoxChecked',
    AGroup.ButtonOptions.CheckBox.Checked);
end;
...
class function TdxLayoutGroupHelper.GetChildItemsAlignVert
...
class function TdxLayoutGroupHelper.GetSpecificClass
  : TdxLayoutGroupViewInfoSpecificClass;
begin
...
class function TdxLayoutHorizontalGroupHelper.GetChildItemsAlignHorz
  : TdxLayoutRealAlignHorz;
begin
  Result := ahLeft;
end;

class function TdxLayoutHorizontalGroupHelper.GetChildItemsAlignVert
  : TdxLayoutRealAlignVert;
begin
  Result := avClient;
end;

class function TdxLayoutHorizontalGroupHelper.GetOrthogonalDirection
  : TdxLayoutDirection;
begin
  Result := ldVertical;
end;

class function TdxLayoutHorizontalGroupHelper.GetSpecificClass
  : TdxLayoutGroupViewInfoSpecificClass;
begin
...
class function TdxLayoutVerticalGroupHelper.GetChildItemsAlignHorz
  : TdxLayoutRealAlignHorz;
begin
  Result := ahClient;
end;

class function TdxLayoutVerticalGroupHelper.GetChildItemsAlignVert
  : TdxLayoutRealAlignVert;
begin
  Result := avTop;
end;

class function TdxLayoutVerticalGroupHelper.GetOrthogonalDirection
  : TdxLayoutDirection;
begin
  Result := ldHorizontal;
end;

class function TdxLayoutVerticalGroupHelper.GetSpecificClass
  : TdxLayoutGroupViewInfoSpecificClass;
begin
...
class function TdxLayoutTabbedGroupHelper.GetChildItemsAlignHorz
  : TdxLayoutRealAlignHorz;
begin
  Result := ahClient;
end;

class function TdxLayoutTabbedGroupHelper.GetChildItemsAlignVert
  : TdxLayoutRealAlignVert;
begin
  Result := avClient;
end;

class function TdxLayoutTabbedGroupHelper.GetOrthogonalDirection
  : TdxLayoutDirection;
begin
  Result := ldTabbed;
end;

class function TdxLayoutTabbedGroupHelper.GetSpecificClass
  : TdxLayoutGroupViewInfoSpecificClass;
begin
...
procedure TdxLayoutTabbedOptions.DoChanged
  (AType: TcxCustomTabControlPropertiesChangedType = pctHard);
begin
...
procedure TdxLayoutTabbedOptions.DoChanging(ANewTabIndex: Integer;
...
procedure TdxLayoutTabbedOptions.RefreshImages;
  ...
  begin
    AItem.CaptionOptions.ImageOptions.GetCurrentImage(AGlyph, AImages,
      AImageIndex);
    Result := InternalImages.Add(cxPrepareBitmapForDrawing(AGlyph, AImages,
      AImageIndex, True, clNone,
      Group.GetLayoutLookAndFeel.GetTabbedGroupCaptionColorPalette
      (TabIndex = AIndex), InternalImages.Width, InternalImages.Height, False,
      AMask, AIsAlphaUsed), nil);
  end;
...
begin
  ...
  try
    ...
    begin
      ...
      if AItem.IsImageVisible and AItem.CaptionOptions.ImageOptions.IsImageAssigned
      then
...
begin
  ...
  try
    ...
    begin
      ...
      TcxTabAccess(Tabs[I]).ShowAccelChar := GetItem(I)
...
function TdxLayoutTabbedOptions.GetItemCaption
  (AItem: TdxCustomLayoutItem): string;
begin
  if AItem.IsTextVisible then
  begin
    if AItem.CaptionOptions.FormattedText.HasFormatting then
    begin
      if AItem.CaptionOptions.ShowAccelChar and
        TdxStringHelper.Contains(AItem.Caption, '&') then
      begin
        AItem.BeginUpdate;
        try
          AItem.CaptionOptions.FormattedText.ShowAccelChar := False;
          AItem.CaptionOptions.FormattedText.Import
            (AItem.CaptionOptions.FormattedText.Text);
...
class function TdxLayoutItem.GetCaptionOptionsClass
...
begin
  Result := TdxControlsDesignSelectorHelper.CalculateBounds(Control.ClientRect,
    0, SelectorRectWidth, ScaleFactor);
...
procedure TdxLayoutItem.SetControl(Value: TControl);
  ...
  begin
    ...
    begin
      ...
      if AItem <> nil then
        raise EdxException.Create(Format(sdxLayoutControlControlIsUsed,
          [Value.Name, AItem.Name]))
    end;
  end;
...
begin
  Result := not Container.IsCustomization and
    Container.IsFocusControlOnItemCaptionClick and CanFocusControl;
end;

procedure TdxLayoutItem.CreateControlAdapter;
begin
  FControlAdapter := dxLayoutControlAdapterDefs.GetAdapterClass(FControl)
    .Create(Self);
end;
...
begin
  ...
  begin
    ...
    else if not(csDestroying in FControlAdapter.Control.ComponentState) then
...
begin
  ...
  if not IsLoading or cxPointIsNull(Point(ControlOptions.OriginalWidth,
    ControlOptions.OriginalHeight)) then
  ...
  begin
    ...
    try
      if ActuallyVisible then
        Control.SetBounds(Control.Left, Control.Top,
          ControlOptions.OriginalWidth, ControlOptions.OriginalHeight)
      else
        Control.SetBounds(10000, 10000, ControlOptions.OriginalWidth,
          ControlOptions.OriginalHeight);
    finally
...
begin
  if HasWinControl and not WinControl.HandleAllocated and
    CanAllocateHandle(WinControl) then
...
begin
  Result := inherited CanDragAndDrop(P) and
    not(HasControl and IsViewInfoValid and IsDesignSelectorVisible and
...
begin
  Result := HasWinControl and WinControl.CanFocus and
    (not ACheckTabStop or WinControl.TabStop);
end;
...
begin
  ...
  begin
    FControlAdapter.SetControlAutoWidth(FControlAdapter.ControlAutoWidth and
      ((GetRealAlignHorz <> ahClient) or (ControlOptions.AlignHorz <>
      ahClient)));
    FControlAdapter.SetControlAutoHeight(FControlAdapter.ControlAutoHeight and
      ((GetRealAlignVert <> avClient) or (ControlOptions.AlignVert <>
      avClient)));
  end;
end;
...
procedure TdxLayoutItem.ControlWndProc(var Message: TMessage);
  ...
  begin
    Result := (Message.LParam = 0) or (PWindowPos(Message.LParam)^.flags and
      SWP_NOMOVE = 0);
  end;
  ...
  begin
    Result := not cxPointIsEqual(Point(Control.Width, Control.Height),
      OriginalControlSize);
  end;

  function NeedSaveOriginalControlSize: Boolean;
  begin
    Result := IsControlResized and FControlAdapter.AllowCheckSize and
      ControlSizeChanged;
  end;

begin
  if (Message.Msg = DXM_UPDATEWINDOWREGION) and IsViewInfoValid and
    (ControlAdapter <> nil) and (ControlAdapter.FNeedSetRegion or
    ControlAdapter.FIsRegionUsed) then
  begin
  ...
  if not ControlLocked then
    case Message.Msg of
      ...
      WM_WINDOWPOSCHANGING:
        if not FIsInternalHandleCreating then
        begin
          if not Container.IsPlacingControls and
            not Container.IsScalingControls and IsControlResized then
          begin
            FNewControlSize := Point(PWindowPos(Message.LParam)^.cx,
              PWindowPos(Message.LParam)^.cy);
      ...
      WM_WINDOWPOSCHANGED:
        ...
        begin
          if not Container.IsPlacingControls and
            not Container.IsScalingControls and
            (IsControlResized and FControlAdapter.AllowCheckSize or
            IsControlMoved) then
          begin
            SaveOriginalControlSize(False, False);
            if (FNewControlSize.Y <> -1) or (FNewControlSize.X <> -1) or IsControlMoved
            then
              Changed;
          end;
...
begin
  Result := HasControl and Container.IsDesignSelectorsVisible and
    IsViewInfoValid;
  if Result then
  begin
    ...
    Result := cxSizeIsEqual(ARectInParent, ARect) and not cxRectIsInvalid(ARect)
      and cxRectContain(Control.ClientRect, ARect);
  end;
end;
...
procedure TdxLayoutItem.SaveOriginalControlSize(ASaveAnyway,
  ANeedChanges: Boolean);
var
  ASize: TPoint;
begin
  if HasControl then
  begin
    if HasWinControl and Control.Parent.HandleAllocated and
      CanAllocateHandle(WinControl) then
    begin
    ...
    begin
      ASize.X := IfThen((GetRealAlignHorz = ahClient) and
        (ControlOptions.AlignHorz = ahClient) and
        (ControlOptions.FOriginalWidth > 0), ControlOptions.FOriginalWidth,
        FControl.Width);
      ASize.Y := IfThen((GetRealAlignVert = avClient) and
        (ControlOptions.AlignVert = avClient) and
        (ControlOptions.FOriginalHeight > 0), ControlOptions.FOriginalHeight,
        FControl.Height);
    end;
    ...
    begin
      ...
      try
        ...
        begin
          ...
          if not cxSizeIsEqual(Control.BoundsRect,
            ViewInfo.FControlViewInfo.ControlBounds) then
          begin
            SaveOriginalControlSize(False, False);
...
begin
  ...
  Inc(FIndex);
  dxTestCheck(FIndex = FRestorePoints.Count,
    'TdxUndoRedoManager.AddAction fails');
end;
...
function TdxLayoutControlCustomCustomizeForm.GetHitTest(const P: TPoint)
...
procedure TdxLayoutControlCustomCustomizeForm.ToggleHotTrackState
  (AItem: TdxCustomLayoutItem);
begin
end;
...
procedure TdxLayoutControlCustomCustomizeForm.AssignFont(AFont: TFont;
  ASourceScaling: TdxScaleFactor);
begin
  Font := AFont;
  Font.Height := MulDiv(Font.Height, ASourceScaling.Denominator * PixelsPerInch,
    ASourceScaling.Numerator * dxDefaultDPI);
end;

procedure TdxLayoutControlCustomCustomizeForm.CreateParams
...
begin
  ...
  Result := (Container <> nil) and
    ((AItemsOwner = nil) or not(Container.IsDesigning and
    (csInline in AItemsOwner.ComponentState)));
end;
...
function TdxLayoutControlCustomCustomizeForm.CanShowItem
  (AItem: TdxCustomLayoutItem): Boolean;
begin
  Result := AItem.IsVisibleForCustomization;
end;

function TdxLayoutControlCustomCustomizeForm.DoGetMenuItems(AList: TList)
...
begin
  if (Container <> nil) and (Container.ItemsParentControl <> nil) and
    Container.ItemsParentControl.HandleAllocated then
...
begin
  ...
  begin
    ...
    if FLayoutLookAndFeel = nil then
      FLayoutLookAndFeel := TdxCustomLayoutLookAndFeelClass
        (ALookAndFeel.ClassType).Create(Self);
...
procedure TdxLayoutControlCustomCustomizeForm.SetCustomizationCaption
  (AItem: TdxCustomLayoutItem; const ACaption: string);
begin
...
function TdxLayoutControlCustomCustomizeForm.GetCustomizationCaption
  (AItem: TdxCustomLayoutItem): string;
begin
  if AItem.IsDesigning or (AItem.Caption = '') then
    Result := AItem.Name
  else if (AItem.ViewInfo <> nil) and AItem.ViewInfo.CaptionViewInfo.IsTextFormatted
  then
    Result := AItem.Caption
  else
...
procedure TdxLayoutControlCustomCustomizeForm.ItemChanged
  (AItem: TdxCustomLayoutItem);
begin
end;
...
procedure TdxLayoutControlCustomCustomizeForm.SetContainer
  (AValue: TdxLayoutContainer);
...
function TdxCustomLayoutItemImageOptions.GetCurrentImage
  (out AGlyph: TdxSmartGlyph; out AImages: TCustomImageList;
...
begin
  ...
  begin
    Result := cxGraphics.IsImageAssigned(GetImageList(Item.Enabled),
      ImageIndex);
    if Result then
    begin
...
function TdxCustomLayoutItemImageOptions.GetImageList(AEnabled: Boolean)
  : TCustomImageList;
begin
  if AEnabled then
...
constructor TdxCustomLayoutItemCaptionOptions.Create
  (AItem: TdxCustomLayoutItem);
begin
  inherited;
...
procedure TdxCustomLayoutItemCaptionOptions.GetStoredPropertyValue
...
procedure TdxCustomLayoutItemCaptionOptions.GetStoredProperties
...
procedure TdxCustomLayoutItemCaptionOptions.SetStoredPropertyValue
...
procedure TdxCustomLayoutItemCaptionOptions.SetAlignVert
  (Value: TdxAlignmentVert);
begin
...
procedure TdxCustomLayoutItemCaptionOptions.SetEllipsisPosition
  (Value: TEllipsisPosition);
begin
...
procedure TdxCustomLayoutItemCaptionOptions.SetImageOptions
  (Value: TdxCustomLayoutItemImageOptions);
begin
...
begin
  ...
  begin
    ...
    VisibleElements := TdxCustomLayoutItemCaptionOptions(Source)
      .VisibleElements;
...
procedure TdxCustomLayoutItemCaptionOptions.SetDefaultCaption
  (const Value: string);
begin
...
procedure TdxCustomLayoutItemCaptionOptions.SetVisibleElements
  (Value: TdxLayoutItemCaptionVisibleElements);
begin
...
begin
  if (sovSizableHorz in AssignedValues) then
    Result := FSizableHorz
  else if Item.Container <> nil then
...
procedure TdxLayoutSizeOptions.SetAssignedValues
  (Value: TdxLayoutSizeOptionsValues);
var
...
constructor TdxLayoutContainerPainter.Create
  (AViewInfo: TdxLayoutContainerViewInfo);
begin
  inherited Create;
  FViewInfo := AViewInfo;
end;
...
procedure TdxLayoutContainerPainter.PlaceControls(AItemViewInfo
  : TdxCustomLayoutItemViewInfo);
var
  AControlViewInfos, AWinControlViewInfos: TList;

  function CheckControlSize(AControlViewInfo
    : TdxLayoutItemControlViewInfo): Boolean;
  begin
    Result := True;
    if not cxSizeIsEqual(AControlViewInfo.ControlBounds,
      AControlViewInfo.Control.BoundsRect) then
    begin
      if cxSizeIsEqual(AControlViewInfo.FPrevControlSize,
        cxSize(AControlViewInfo.Control.BoundsRect)) then
  ...
  begin
    ...
    begin
      AControlViewInfo := TdxLayoutItemControlViewInfo
        (AControlViewInfos.List[I]);
      AControlViewInfo.FPrevControlSize :=
        cxSize(AControlViewInfo.Control.BoundsRect);
  ...
  begin
    ...
    try
      ...
      begin
        AControlViewInfo := TdxLayoutItemControlViewInfo
          (AWinControlViewInfos.List[I]);
        AControlViewInfo.FPrevControlSize :=
          cxSize(AControlViewInfo.Control.BoundsRect);
        R := AControlViewInfo.ControlBounds;
        DeferWindowPos(AWindowsStruct, (AControlViewInfo.Control as TWinControl)
          .Handle, 0, R.Left, R.Top, cxRectWidth(R), cxRectHeight(R),
          SWP_NOZORDER or SWP_NOACTIVATE);

        if (AControlViewInfo.Item.ControlAdapter <> nil) and
          (AControlViewInfo.Item.ControlAdapter.FNeedSetRegion or
          AControlViewInfo.Item.ControlAdapter.FIsRegionUsed) then
        begin
          if AControlViewInfo.Item.ControlAdapter.FIsRegionUsed and
            not AControlViewInfo.Item.ControlAdapter.FNeedSetRegion then
            SetWindowRgn((AControlViewInfo.Control as TWinControl)
              .Handle, 0, True)
          else
            SetWindowRegion(AControlViewInfo.Control as TWinControl,
              AControlViewInfo.FControlWindowRect);
          AControlViewInfo.Item.ControlAdapter.FIsRegionUsed :=
            AControlViewInfo.Item.ControlAdapter.FNeedSetRegion;
        end;
      end;
    finally
...
var
  AHasChanges: Boolean;
begin
  if FPlaceControlsCounter = 3 then
    Exit;
  ...
  try
    ...
    try
      ...
      try
        AItemViewInfo.PopulateControlViewInfoList(AControlViewInfos,
          AWinControlViewInfos);
        ProcessControls;
        ProcessWinControls;
        AHasChanges := not CheckControlSizes(AControlViewInfos) or
          not CheckControlSizes(AWinControlViewInfos);
      finally
...
begin
  ...
  case Index of
    1:
      Result := APadding.Bottom;
    2:
      Result := APadding.Left;
    3:
      Result := APadding.Right;
    4:
      Result := APadding.Top;
  else
    Result := 0;
...
procedure TdxLayoutPadding.SetAssignedValues
  (Value: TdxLayoutPaddingAssignedValues);
begin
  if FAssignedValues <> Value then
  begin
    FAssignedValues := Value;
...
procedure TdxLayoutCustomFloatForm.ShowFloat(const APosition: TPoint;
  ANeedActivate: Boolean; AHidden: Boolean = False);
begin
  if not AHidden then
...
begin
  ...
  begin
    ...
    FIsUserDefined := (IsDesigning xor TdxCustomLayoutItem(Source).IsDesigning)
      or TdxCustomLayoutItem(Source).IsUserDefined;
  end
  else
    inherited;
end;
...
begin
  ...
  begin
    ...
    begin
      TakeoffParent := Container.FindItem(FLoadedTakeoffParentName)
        as TdxCustomLayoutGroup;
...
begin
  ...
  begin
    ...
    if { #Q477217 not IsLoading and } (Parent <> nil) and Parent.Hidden and
      (Parent.Width = 0) then
    begin
      AParentAlignHorz := Parent.GetRealAlignHorz;
      if ((Parent.Count = 1) and (AParentAlignHorz in [ahLeft, ahCenter,
        ahRight]) or (Result = ahClient) and
        (Parent.LayoutDirection = ldHorizontal) and (AParentAlignHorz = ahLeft))
      then
...
begin
  ...
  begin
    ...
    begin
      ...
      if ((Parent.Count = 1) and (AParentAlignVert in [avTop, avCenter,
        avBottom]) or (Result = avClient) and
        (Parent.LayoutDirection = ldVertical) and (AParentAlignVert = avTop))
      then
...
begin
  Result := (dxLayoutDragAndDropObject <> nil) and
    (dxLayoutDragAndDropObject.SourceItem = Self);
end;

function TdxCustomLayoutItem.IsDragged: Boolean;
begin
  Result := IsGrabbed and (TcxDragAndDropObjectAccess(dxLayoutDragAndDropObject)
    .Control.DragAndDropState = ddsInProcess);
end;

function TdxCustomLayoutItem.IsImageVisible: Boolean;
begin
  Result := (cveImage in CaptionOptions.VisibleElements) and
    CaptionOptions.ImageOptions.IsImageAssigned;
end;
...
begin
  Result := IsDesigning or Visible and ((Parent = nil) or not IsParentLocked or
    Container.IsShowLockedGroupChildren);
end;
...
begin
  Result := (Parent = nil) or (Parent.LayoutDirection = ldHorizontal) and
    (GetRealAlignHorz in [ahLeft, ahCenter, ahRight]);
end;
...
procedure TdxCustomLayoutItem.SetAlignmentConstraint
  (Value: TdxLayoutAlignmentConstraint);
begin
...
procedure TdxCustomLayoutItem.SetCaptionOptions(const Value
  : TdxCustomLayoutItemCaptionOptions);
begin
...
begin
  ...
  begin
    ...
    try
      dxTestCheck(not IsRoot and ((Container = nil) or
        not Container.IsRoot(Self)) and ((Value = nil) or not Value.IsRoot(Self)
        ), 'SetContainer for Root fails');
      ...
      begin
        ...
        if not((csLoading in ComponentState) or
          APrevScaleFactor.Equals(ScaleFactor)) then
        begin
          ChangeScale(ScaleFactor.Numerator * APrevScaleFactor.Denominator,
...
procedure TdxCustomLayoutItem.SetLayoutLookAndFeel
  (Value: TdxCustomLayoutLookAndFeel);
begin
...
procedure TdxCustomLayoutItem.DefineProperties(Filer: TFiler);
  ...
  begin
    Result := (Filer.Ancestor = nil) or
      (TdxCustomLayoutItem(Filer.Ancestor).Index <> Index);
  end;
...
procedure TdxCustomLayoutItem.Notification(AComponent: TComponent;
...
begin
  ...
  else if Supports(Value, IdxLayoutContainerOwner, AIntf) then
...
begin
  Result := (Parent <> nil) and Parent.CanQuickCustomized or IsRoot and
    CanQuickCustomized or CanFloat;
end;

function TdxCustomLayoutItem.CanQuickCustomized: Boolean;
begin
  Result := not IsLocked and (AllowQuickCustomize or (Parent <> nil) and
    Parent.CanQuickCustomized or (Parent = nil) and
    FInternalCanQuickCustomized);
end;
...
begin
  Result := (GetVisible or IsDesigning) and IsViewInfoValid and
    (IsRoot or (Parent <> nil) and Parent.AllowShowChild(Self) and
    Parent.CanBeActuallyVisible);
end;
...
function TdxCustomLayoutItem.InternalMove(AParent: TdxCustomLayoutGroup;
  AIndex: Integer; APack, AKeepAlign: Boolean): Boolean;
var
  ASourceContainer, ADestinationContainer: TdxLayoutContainer;
  ARealAlign: TdxLayoutRealAlign;
begin
  Result := CanMoveTo(AParent) and
    (APack or (AParent <> Parent) or (Index <> AIndex));
  if not Result then
    Exit;
...
procedure TdxCustomLayoutItem.MakeFloat(const APosition: TPoint;
...
begin
  ...
  begin
    ...
    begin
      ...
      if (ATakeoffParent <> nil) and
        (not ATakeoffParent.IsRoot or (RealContainer.Root = ATakeoffParent))
      then
      begin
...
begin
  ...
  case Parent.LayoutDirection of
    ldHorizontal:
      begin
        if (GetRealAlignHorz in [ahLeft, ahClient]) and
          (Index < Parent.Count - 1) then
          for I := Index + 1 to FParent.Count - 1 do
            if Parent.Items[I].Visible and
              (Parent.Items[I].GetRealAlignHorz in [ahLeft, ahClient]) then
            begin
              if (Parent.Items[I] is TdxLayoutSplitterItem) and
                TdxLayoutSplitterItem(Parent.Items[I]).IsClosed then
                Result := TdxLayoutSplitterItem(Parent.Items[I]);
              Break;
            end;
        if (Result = nil) and (GetRealAlignHorz in [ahRight, ahClient]) and
          (Index > 0) then
          for I := Index - 1 downto 0 do
            if Parent.Items[I].Visible and
              (Parent.Items[I].GetRealAlignHorz in [ahRight, ahClient]) then
            begin
              if (Parent.Items[I] is TdxLayoutSplitterItem) and
                TdxLayoutSplitterItem(Parent.Items[I]).IsClosed then
                Result := TdxLayoutSplitterItem(Parent.Items[I]);
    ...
    ldVertical:
      begin
        if (GetRealAlignVert in [avTop, avClient]) and
          (Index < FParent.Count - 1) then
          for I := Index + 1 to Parent.Count - 1 do
            if Parent.Items[I].Visible and
              (Parent.Items[I].GetRealAlignVert in [avTop, avClient]) then
            begin
              if (Parent.Items[I] is TdxLayoutSplitterItem) and
                TdxLayoutSplitterItem(Parent.Items[I]).IsClosed then
                Result := TdxLayoutSplitterItem(Parent.Items[I]);
        ...
        if (Result = nil) and (GetRealAlignVert in [avBottom, avClient]) and
          (Index > 0) then
          for I := Index - 1 downto 0 do
            if Parent.Items[I].Visible and
              (Parent.Items[I].GetRealAlignVert in [avBottom, avClient]) then
            begin
              if (Parent.Items[I] is TdxLayoutSplitterItem) and
                TdxLayoutSplitterItem(Parent.Items[I]).IsClosed then
                Result := TdxLayoutSplitterItem(Parent.Items[I]);
...
begin
  Result := Superfluous or ((LoadedIndex = dxLayoutInitialLoadedItemIndex) and
    CanDelete);
end;
...
begin
  Result := not IsDesigning and Container.IsCustomization and (Parent <> nil)
    and (Parent.Locked or Parent.IsParentLocked);
end;
...
procedure TdxCustomLayoutItem.LoadFromIni(AIniFile: TCustomIniFile;
  const ASection: string; AVersion: Integer);
var
  AReader: TdxLayoutBasicItemReaderClass;
begin
  case AVersion of
    3:
      AReader := TdxLayoutBasicItemReader3;
    2:
      AReader := TdxLayoutBasicItemReader2;
  else
...
procedure TdxCustomLayoutItem.SaveToIni(AIniFile: TCustomIniFile;
  const ASection: string);
begin
...
begin
  Result := (FVisible and not IsClosedBySplitter or IsDesigning or IsDragged)
    and ((Parent = nil) or Parent.AllowShowChild(Self))
end;
...
begin
  FSuperfluous := False;
  CaptionOptions.ResetUserCaption;
...
procedure TdxCustomLayoutItem.SetLoadedInfo(const AParentName: string;
  AIndex: Integer);
begin
...
function TdxCustomLayoutItem.IsParentGroup(AParentGroup
  : TdxCustomLayoutGroup): Boolean;
begin
  Result := AParentGroup.IsChildItem(Self);
end;

function TdxCustomLayoutItem.IsChildItem(AChildItem
  : TdxCustomLayoutItem): Boolean;
begin
...
begin
  Result := (Parent.LayoutDirection in [ldVertical, ldTabbed]) or
    (VisibleIndex < 1) or
    (Parent.VisibleItems[VisibleIndex - 1].GetRealAlignHorz in [ahLeft, ahRight]
    ) and Parent.VisibleItems[VisibleIndex - 1].IsHorzPositionStable;
end;

function TdxCustomLayoutItem.IsVertLocalPositionStable: Boolean;
begin
  Result := (Parent.LayoutDirection in [ldHorizontal, ldTabbed]) or
    (VisibleIndex < 1) or
    (Parent.VisibleItems[VisibleIndex - 1].GetRealAlignVert in [avTop, avBottom]
    ) and Parent.VisibleItems[VisibleIndex - 1].IsVertPositionStable;
end;

function TdxCustomLayoutItem.IsHorzPositionStable: Boolean;
begin
  Result := IsRoot or IsHorzLocalPositionStable and
    (Parent.IsHorzPositionStable or
    (Parent.ViewInfo.GetRealItemControlAreaAlignment = catOwn));
end;

function TdxCustomLayoutItem.IsVertPositionStable: Boolean;
begin
  Result := IsRoot or IsVertLocalPositionStable and
    (Parent.IsVertPositionStable or
    (Parent.ViewInfo.GetRealItemControlAreaAlignment = catOwn));
end;
...
function TdxCustomLayoutItem.ProcessDialogKey(ACharCode: Word;
  AKeyData: Integer; AFocusedItem: TdxCustomLayoutItem): Boolean;
begin
  Result := False;
end;
...
class function TdxCustomLayoutItem.GetCaptionOptionsClass
  : TdxCustomLayoutItemCaptionOptionsClass;
begin
...
begin
  Result := (IsDesigning and not(csAncestor in ComponentState)) or
    IsUserDefined;
end;
...
function TdxCustomLayoutItem.GetStoredProperties(AProperties: TStrings)
  : Boolean;
begin
  Result := True;
...
procedure TdxCustomLayoutItem.GetStoredPropertyValue(const AName: string;
  var AValue: Variant);
...
begin
  case GetPropertyIndex(AName) of
    ...
    9 { FloatPosY } :
      AValue := FFloatPos.Y;
    10 { TakeoffParent } :
      AValue := GetParentName(TakeoffParent);
    11 { TakeoffIndex } :
      AValue := FTakeoffIndex;
  else
    CaptionOptions.GetStoredPropertyValue(AName, AValue);
  end;
end;

procedure TdxCustomLayoutItem.SetStoredPropertyValue(const AName: string;
  const AValue: Variant);
begin
  case GetPropertyIndex(AName) of
    0 { IsUserDefined } :
    ...
    9 { FloatPosY } :
      FFloatPos.Y := AValue;
    10 { TakeoffParent } :
      FLoadedTakeoffParentName := AValue;
    11 { TakeoffIndex } :
      FTakeoffIndex := AValue;
  else
...
procedure TdxCustomLayoutItem.DoChanged(AType: TdxLayoutItemChangeType);
  ...
  procedure ComplexLayoutChanged(AItem: TdxCustomLayoutItem);
    ...
    function GetMostChangedItem(AItem: TdxCustomLayoutItem; APrevBounds: TRects)
      : TdxCustomLayoutItem;
    var
      I: Integer;
    begin
...
begin
  Result := (AParent <> Self) and
    ((AParent = nil) or AParent.CanAcceptItem(Self));
end;
...
function TdxCustomLayoutItem.Move(AParent: TdxCustomLayoutGroup;
  AIndex: Integer; APack: Boolean = False): Boolean;
begin
  Result := InternalMove(AParent, AIndex, APack, False);
end;

function TdxCustomLayoutItem.MoveTo(AParent: TdxCustomLayoutGroup;
  AVisibleIndex: Integer; APack: Boolean = False): Boolean;
var
  AIndex: Integer;
begin
  if AParent = nil then
...
function TdxCustomLayoutItem.PutIntoHiddenGroup(ALayoutDirection
  : TdxLayoutDirection): TdxLayoutAutoCreatedGroup;
var
  AIndex: Integer;
begin
  if FParent = nil then
  ...
  begin
    ...
    case ALayoutDirection of
      ldHorizontal:
        Result.AlignVert := AlignVert;
      ldVertical:
        Result.AlignHorz := AlignHorz;
    end;
    Result.Index := AIndex;
...
function TdxLayoutNonLabeledItem.GetCaptionOptions
  : TdxLayoutNonLabeledItemCaptionOptions;
begin
  Result := TdxLayoutNonLabeledItemCaptionOptions(inherited CaptionOptions);
end;

class function TdxLayoutNonLabeledItem.GetCaptionOptionsClass
  : TdxCustomLayoutItemCaptionOptionsClass;
begin
  Result := TdxLayoutNonLabeledItemCaptionOptions;
end;

procedure TdxLayoutNonLabeledItem.SetCaptionOptions
  (Value: TdxLayoutNonLabeledItemCaptionOptions);
begin
  inherited CaptionOptions := Value;
end;
...
function TdxLayoutEmptySpaceItem.GetViewInfoClass
...
function TdxLayoutDirectionalItem.GetViewInfoClass
  : TdxCustomLayoutItemViewInfoClass;
begin
...
constructor TdxLayoutSeparatorItemCaptionOptions.Create
  (AItem: TdxCustomLayoutItem);
begin
  inherited;
  FVisible := False;
...
class function TdxLayoutSeparatorItem.GetCaptionOptionsClass
  : TdxCustomLayoutItemCaptionOptionsClass;
begin
...
function TdxLayoutSeparatorItem.GetViewInfoClass
  : TdxCustomLayoutItemViewInfoClass;
begin
  Result := TdxLayoutSeparatorItemViewInfo;
end;

function TdxLayoutSeparatorItem.GetCaptionOptions
  : TdxLayoutSeparatorItemCaptionOptions;
begin
...
begin
  if IsViewInfoValid and not cxRectIsEmpty(ViewInfo.Bounds) then
    Result := cxRectWidth(ViewInfo.ContentBounds) <
      cxRectHeight(ViewInfo.ContentBounds)
  else
    Result := inherited;
end;

procedure TdxLayoutSeparatorItem.SetCaptionOptions
  (Value: TdxLayoutSeparatorItemCaptionOptions);
begin
  inherited CaptionOptions := Value;
end;
...
function TdxLayoutSplitterItem.GetStoredProperties
...
procedure TdxLayoutSplitterItem.GetStoredPropertyValue(const AName: string;
  var AValue: Variant);
begin
  if AName = 'AllowCloseOnClick' then
    AValue := AllowCloseOnClick
  else if AName = 'IsClosed' then
    AValue := IsClosed
  else
    inherited;
end;

procedure TdxLayoutSplitterItem.SetStoredPropertyValue(const AName: string;
  const AValue: Variant);
begin
  if AName = 'AllowCloseOnClick' then
...
function TdxLayoutSplitterItem.GetViewInfoClass
  : TdxCustomLayoutItemViewInfoClass;
begin
  Result := TdxLayoutSplitterItemViewInfo;
end;

function TdxLayoutSplitterItem.DoCanResize(AItem: TdxCustomLayoutItem;
  var ANewSize: Integer): Boolean;
begin
  Result := True;
...
begin
  if AName = 'ShowCaption' then
    AValue := Visible
  else if AName = 'CaptionAlignHorz' then
    AValue := Variant(AlignHorz)
  else if AName = 'CaptionAlignVert' then
    AValue := Variant(AlignVert)
  else if AName = 'CaptionLayout' then
...
procedure TdxLayoutLabeledItemCustomCaptionOptions.DoAssign
  (Source: TPersistent);
begin
  inherited;
...
function TdxCustomLayoutLabeledItem.GetParentManagedAlignVert
  : TdxLayoutAlignVert;
begin
  Result := avTop;
end;

class function TdxCustomLayoutLabeledItem.GetCaptionOptionsClass
  : TdxCustomLayoutItemCaptionOptionsClass;
begin
  Result := TdxLayoutLabeledItemCustomCaptionOptions;
end;

function TdxCustomLayoutLabeledItem.GetViewInfoClass
  : TdxCustomLayoutItemViewInfoClass;
begin
  Result := TdxLayoutLabeledItemViewInfo;
end;

function TdxCustomLayoutLabeledItem.GetCaptionOptions
  : TdxLayoutLabeledItemCustomCaptionOptions;
begin
  Result := TdxLayoutLabeledItemCustomCaptionOptions(inherited CaptionOptions);
end;

procedure TdxCustomLayoutLabeledItem.SetCaptionOptions
  (Value: TdxLayoutLabeledItemCustomCaptionOptions);
begin
  inherited CaptionOptions := Value;
end;
...
function TdxLayoutLabeledItem.GetCaptionOptions
  : TdxLayoutLabeledItemCaptionOptions;
begin
  Result := TdxLayoutLabeledItemCaptionOptions(inherited CaptionOptions);
end;

class function TdxLayoutLabeledItem.GetCaptionOptionsClass
  : TdxCustomLayoutItemCaptionOptionsClass;
begin
...
class function TdxLayoutImageItem.GetCaptionOptionsClass
  : TdxCustomLayoutItemCaptionOptionsClass;
begin
  Result := TdxLayoutItemCaptionOptions;
end;
...
procedure TdxLayoutImageItem.SetCaptionOptions
  (Value: TdxLayoutItemCaptionOptions);
begin
  inherited CaptionOptions := Value;
end;
...
constructor TdxCustomLayoutCheckableItemCaptionOptions.Create
  (AItem: TdxCustomLayoutItem);
begin
  inherited Create(AItem);
  Layout := clRight;
...
begin
  Result := inherited IsTextStored and
    ((Item.ActionLink = nil) or not Item.ActionLink.IsCaptionLinked);
end;

function TdxCustomLayoutCheckableItemCaptionOptions.GetItem
  : TdxCustomLayoutCheckableItem;
begin
...
constructor TdxLayoutCheckBoxItemCheckBoxOptions.Create
  (AItem: TdxCustomLayoutItem);
begin
  inherited Create(AItem);
  FAllowGrayed := False;
...
procedure TdxLayoutCheckBoxItemCheckBoxOptions.GlyphChangeHandler
  (Sender: TObject);
begin
  Changed;
end;

function TdxLayoutCheckBoxItemCheckBoxOptions.GetStateCaption
...
begin
  Result := inherited IsHintLinked and
    (FClient.CaptionOptions.Hint = TCustomAction(Action).Hint);
end;
...
procedure TdxCustomLayoutCheckableItemActionLink.SetCaption
  (const Value: string);
begin
...
procedure TdxCustomLayoutCheckableItemActionLink.SetOnExecute
  (Value: TNotifyEvent);
begin
...
begin
  Result := inherited IsGroupIndexLinked and
    (Client.GroupIndex = (Action as TCustomAction).GroupIndex);
end;
...
procedure TdxCustomLayoutCheckableItem.ActionChange(Sender: TObject;
  const ACheckDefaults: Boolean);
begin
  if Sender is TCustomAction then
  begin
    if not ACheckDefaults or (Caption = '') then
      Caption := TCustomAction(Sender).Caption;
    if not ACheckDefaults or (Checked = False) then
    begin
      FIsClickLocked := True;
      Checked := TCustomAction(Sender).Checked;
      FIsClickLocked := False;
    end;
    if not ACheckDefaults or (Enabled = True) then
    ...
    if not ACheckDefaults or (Visible = True) then
      Visible := TCustomAction(Sender).Visible;
    if not ACheckDefaults or (@OnClick = nil) then
      OnClick := TCustomAction(Sender).OnExecute;
  end;
end;

function TdxCustomLayoutCheckableItem.CanFocus: Boolean;
begin
  Result := ActuallyVisible and Enabled and TabStop;
end;
...
begin
  ...
  begin
    if Assigned(FOnClick) and (Action <> nil) and not DelegatesEqual(@FOnClick,
      @Action.OnExecute) then
      FOnClick(Self)
    else if not IsDesigning and (ActionLink <> nil) then
...
class function TdxCustomLayoutCheckableItem.GetActionLinkClass
  : TdxCustomLayoutCheckableItemActionLinkClass;
begin
...
class function TdxLayoutCheckBoxItem.GetActionLinkClass
  : TdxCustomLayoutCheckableItemActionLinkClass;
begin
...
class function TdxLayoutCheckBoxItem.GetCaptionOptionsClass
  : TdxCustomLayoutItemCaptionOptionsClass;
begin
  Result := TdxLayoutCheckBoxItemCaptionOptions;
end;

class function TdxLayoutCheckBoxItem.GetCheckBoxOptionsClass
  : TdxLayoutCheckBoxItemCheckBoxOptionsClass;
begin
...
function TdxLayoutCheckBoxItem.GetViewInfoClass
  : TdxCustomLayoutItemViewInfoClass;
begin
...
function TdxLayoutCheckBoxItem.GetCaptionOptions
  : TdxLayoutCheckBoxItemCaptionOptions;
begin
  Result := TdxLayoutCheckBoxItemCaptionOptions(inherited CaptionOptions);
end;

procedure TdxLayoutCheckBoxItem.SetCaptionOptions
  (AValue: TdxLayoutCheckBoxItemCaptionOptions);
begin
  inherited CaptionOptions := AValue;
end;

procedure TdxLayoutCheckBoxItem.SetCheckBoxOptions
  (AValue: TdxLayoutCheckBoxItemCheckBoxOptions);
begin
...
procedure TdxLayoutRadioButtonItem.ActionChange(Sender: TObject;
  const ACheckDefaults: Boolean);
begin
...
class function TdxLayoutRadioButtonItem.GetActionLinkClass
  : TdxCustomLayoutCheckableItemActionLinkClass;
begin
...
class function TdxLayoutRadioButtonItem.GetCaptionOptionsClass
  : TdxCustomLayoutItemCaptionOptionsClass;
begin
...
function TdxLayoutRadioButtonItem.GetViewInfoClass
  : TdxCustomLayoutItemViewInfoClass;
begin
...
function TdxLayoutRadioButtonItem.GetCaptionOptions
  : TdxLayoutRadioButtonItemCaptionOptions;
begin
  Result := TdxLayoutRadioButtonItemCaptionOptions(inherited CaptionOptions);
end;

procedure TdxLayoutRadioButtonItem.SetCaptionOptions
  (AValue: TdxLayoutRadioButtonItemCaptionOptions);
begin
  inherited CaptionOptions := AValue;
end;

procedure TdxLayoutRadioButtonItem.TurnLayoutSiblingsOff
  (AGroup: TdxCustomLayoutGroup);
var
  ...
  if AGroup <> nil then
    ...
    begin
      ...
      begin
        ...
        if (ARadioButtonItem <> Self) and
          (ARadioButtonItem.GroupIndex = GroupIndex) then
        begin
          if Assigned(ARadioButtonItem.Action) and
            (ARadioButtonItem.Action is TCustomAction) then
          begin
...
function TdxLayoutAlignmentConstraint.GetItem(Index: Integer)
  : TdxCustomLayoutItem;
begin
  Result := TdxCustomLayoutItem(FItems.List[Index]);
end;

procedure TdxLayoutAlignmentConstraint.SetKind
  (Value: TdxLayoutAlignmentConstraintKind);
begin
  if FKind <> Value then
  begin
    FKind := Value;
...
procedure TdxLayoutAlignmentConstraint.InternalAddItem
  (AItem: TdxCustomLayoutItem);
begin
  FItems.Add(AItem);
end;

procedure TdxLayoutAlignmentConstraint.InternalRemoveItem
  (AItem: TdxCustomLayoutItem);
begin
  FItems.Remove(AItem);
...
function TdxLayoutAlignmentConstraint.AreItemViewInfosAligned
...
begin
  ...
  Result := True;
  for I := 0 to ACount - 1 do
    Result := Result and ((Items[I].ViewInfo = nil) or
      (GetBorderValue(I) = ABorderValue));
end;
...
function TdxLayoutAlignmentConstraint.CanAddItem
  (AItem: TdxCustomLayoutItem): Boolean;
begin
  ...
  if AViewInfo = nil then
    ...
    case Kind of
      ...
      raise EdxException.Create
        ('TdxLayoutAlignmentConstraint.GetBorderValue fails');
    end;
end;

function TdxLayoutAlignmentConstraint.GetMostBorderValue
...
function TdxLayoutContainerFocusController.SelectNext(AFocusedControl
  : TWinControl; const ACharCode: Word = VK_TAB): Boolean;
  ...
  begin
    ...
    if TWinControlAccess(AParentForm).FindNextControl(AFocusedControl,
      AGoForward, True, False) = Container.ItemsParentControl then
    begin
      AList := TList.Create;
      try
...
begin
  AGoForward := ((ACharCode = VK_TAB) and (GetKeyState(VK_SHIFT) >= 0)) or
    (ACharCode in [VK_RIGHT, VK_DOWN]);
...
function TdxLayoutContainerFocusController.FindItem(ATabOrder: Integer)
  : TdxCustomLayoutItem;

  function CheckTabOrder(AItem: TdxCustomLayoutItem): Boolean;
  begin
    Result := AItem.IsViewInfoValid and AItem.CanFocus and
      (AItem.ViewInfo.TabOrder = ATabOrder);
  end;
...
function TdxLayoutContainerFocusController.FindNextControl(ACurrentControl
  : TWinControl; AGoForward: Boolean): TWinControl;
...
function TdxLayoutContainerFocusController.IsFocused
  (AItem: TdxCustomLayoutItem): Boolean;
begin
  Result := Container.ItemsParentControl.Focused and
    not Container.IsCustomization and AItem.IsViewInfoValid and
    (AItem.ViewInfo.TabOrder = CurrentTabOrder);
end;
...
begin
  ...
  if (APrevCurrentTabOrder = CurrentTabOrder) and (APrevCurrentTabOrder <> -1)
  then
...
procedure TdxLayoutContainerFocusController.SetItemFocus
  (AItem: TdxCustomLayoutItem);
begin
  Container.ItemsParentControl.SetFocus;
  FocusedItem := AItem;
...
procedure TdxLayoutContainerFocusController.SetFocusedItem
...
begin
  ...
  begin
    ...
    if APrevFocusedItem <> nil then
      APrevFocusedItem.Changed(ictLight);
    if FocusedItem <> nil then
      FocusedItem.Changed(ictLight);
  end;
end;

constructor TdxLayoutContainerCustomizationHelper.Create
  (AContainer: TdxLayoutContainer);
begin
  inherited Create;
  FContainer := AContainer;
...
procedure TdxLayoutContainerCustomizationHelper.CopyStructure
  (AContainer: TdxLayoutContainer);
begin
  // do nothing
end;
...
procedure TdxLayoutImageOptions.SetImageList(var ANewValue,
  AOldValue: TCustomImageList; const AChangeLink: TChangeLink);
begin
...
begin
  ...
  begin
    ...
    AutoControlAreaAlignment := TdxLayoutItemControlOptions(Source)
      .AutoControlAreaAlignment;
...
begin
  Result := ((Item.CaptionOptions.Layout in [clLeft, clRight]) and IsWidthUsual)
    or ((Item.CaptionOptions.Layout in [clTop, clBottom]) and IsHeightUsual);
end;

procedure TdxLayoutItemControlOptions.SetAlignHorz
  (Value: TdxLayoutItemControlAlignHorz);
begin
  if FAlignHorz <> Value then
  begin
    FAlignHorz := Value;
...
procedure TdxLayoutItemControlOptions.SetAlignVert
  (Value: TdxLayoutItemControlAlignVert);
begin
  if FAlignVert <> Value then
  begin
    FAlignVert := Value;
...
procedure TdxLayoutItemControlOptions.SetAutoControlAreaAlignment
  (Value: Boolean);
begin
...
class function TdxLayoutControlItem.GetCaptionOptionsClass
  : TdxCustomLayoutItemCaptionOptionsClass;
begin
  Result := TdxLayoutItemCaptionOptions;
end;

function TdxLayoutControlItem.GetViewInfoClass
  : TdxCustomLayoutItemViewInfoClass;
begin
...
function TdxLayoutControlItem.GetControlOptionsClass
  : TdxLayoutItemControlOptionsClass;
begin
...
var
  ...
  function IsCommonValue(AValueIndex: Integer;
    var ACommonValue: Variant): Boolean;
  var
    I: Integer;
    AValue: Variant;
    ...
    begin
      case AValueIndex of
        0:
          Result := TdxLayoutItem(AItem).CaptionOptions.Layout;
        1:
          Result := TdxLayoutItem(AItem).CaptionOptions.AlignHorz;
        2:
          Result := TdxLayoutItem(AItem).CaptionOptions.AlignVert;
      else
        Result := Null;
      end;
    end;
...
procedure TdxLayoutControlItem.SetControlOptions
  (Value: TdxLayoutItemControlOptions);
begin
...
var
  AHasChanges: Boolean;
begin
  AHasChanges := not cxPointIsEqual(Point(ControlOptions.OriginalWidth,
    ControlOptions.OriginalHeight), Value);
  if AHasChanges then
  begin
...
procedure TdxCustomLayoutElementViewInfo.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  State := State + [levsPressed];
end;

procedure TdxCustomLayoutElementViewInfo.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
end;

procedure TdxCustomLayoutElementViewInfo.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  State := State - [levsPressed];
end;

procedure TdxCustomLayoutElementViewInfo.KeyDown(var Key: Word;
  Shift: TShiftState);
begin
  // do nothing
end;

procedure TdxCustomLayoutElementViewInfo.AssignBounds
  (ASource: TdxCustomLayoutElementViewInfo);
begin
  if CanAssignBounds(ASource) then
    DoAssignBounds(ASource);
end;

function TdxCustomLayoutElementViewInfo.CanAssignBounds
  (ASource: TdxCustomLayoutElementViewInfo): Boolean;
begin
  Result := ASource is ClassType;
end;

procedure TdxCustomLayoutElementViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  FBounds := TdxRightToLeftLayoutConverter.ConvertRect(FBounds, AClientBounds);
  FOriginalBounds := TdxRightToLeftLayoutConverter.ConvertRect(FOriginalBounds,
    AClientBounds);
end;

procedure TdxCustomLayoutElementViewInfo.DoAssignBounds
  (ASource: TdxCustomLayoutElementViewInfo);
begin
...
procedure TdxCustomLayoutElementViewInfo.DoSetOffset(const AValue,
  ADiff: TPoint);
begin
...
procedure TdxCustomLayoutElementViewInfo.SetState
  (AValue: TdxLayoutElementViewInfoStates);
begin
...
constructor TdxCustomLayoutItemElementViewInfo.Create(AItemViewInfo
  : TdxCustomLayoutItemViewInfo);
begin
  inherited Create;
...
function TdxCustomLayoutItemElementViewInfo.GetLayoutLookAndFeel
...
procedure TdxCustomLayoutItemElementViewInfo.DoAssignBounds
  (ASource: TdxCustomLayoutElementViewInfo);
begin
  inherited;
...
function TdxCustomLayoutItemElementViewInfo.ShowHint(var AHintInfo
  : THintInfo): Boolean;
begin
  Result := False;
end;
...
begin
  Result := ItemViewInfo.HasCaption or (ItemViewInfo.IsDragImagePainting and
    not ItemViewInfo.ActuallyVisible);
end;
...
function TdxCustomLayoutItemCaptionViewInfo.ShowHint(var AHintInfo
  : THintInfo): Boolean;
begin
...
function TdxCustomLayoutItemCaptionViewInfo.GetFormattedTextSize
  (ACanvas: TcxCanvas; const AFlags: Integer; const ARect: TRect): TSize;
begin
...
function TdxCustomLayoutItemCaptionViewInfo.GetHotTrackStyles
  : TdxLayoutHotTrackStyles;
begin
  Result := Options.HotTrackStyles;
end;

function TdxCustomLayoutItemCaptionViewInfo.CalculateTextFlags
  (AForDrawing: Boolean): Integer;
const
  AlignsVert: array [TdxAlignmentVert] of Integer = (cxAlignTop, cxAlignVCenter,
    cxAlignBottom);
  MultiLinesMap: array [Boolean] of Integer = (0, cxWordBreak);
  EllipsisMap: array [TEllipsisPosition] of Integer = (0, cxShowPathEllipsis,
    cxShowEndEllipsis, cxShowWordEllipsis);

  function GetRealAlignHorz: TAlignment;
  const
    ra180AlignHorzMap: array [TAlignment] of TAlignment = (taRightJustify,
      taLeftJustify, taCenter);
    raMinus90AlignHorzMap: array [TdxAlignmentVert] of TAlignment =
      (taRightJustify, taCenter, taLeftJustify);
    raPlus90AlignHorzMap: array [TdxAlignmentVert] of TAlignment =
  ...
  const
    ra180AlignVertMap: array [TdxAlignmentVert] of TdxAlignmentVert =
      (tavBottom, tavCenter, tavTop);
    raPlus90AlignVertMap: array [TAlignment] of TdxAlignmentVert = (tavBottom,
      tavTop, tavCenter);
    raMinus90AlignVertMap: array [TAlignment] of TdxAlignmentVert = (tavTop,
      tavBottom, tavCenter);
  begin
    case GetRotationAngle of
      ra180:
...
begin
  if AForDrawing then
    Result := EllipsisMap[GetEllipsisPosition(AForDrawing)] or
      MultiLinesMap[IsMultiLine] or cxAlignmentsHorz[GetRealAlignHorz] or
      AlignsVert[GetRealAlignVert]
  else
    Result := (EllipsisMap[GetEllipsisPosition(AForDrawing)] or
      MultiLinesMap[IsMultiLine] or cxAlignmentsHorz[GetRealAlignHorz] or
      cxDontPrint) and not cxAlignRight;
...
function TdxCustomLayoutItemCaptionViewInfo.CanDoCaptionClick(X,
  Y: Integer): Boolean;
begin
...
function TdxCustomLayoutItemCaptionViewInfo.GetOptions
...
procedure TdxCustomLayoutItemCaptionViewInfo.DoSetOffset(const AValue,
  ADiff: TPoint);
begin
  inherited;
...
procedure TdxCustomLayoutItemCaptionViewInfo.DoAssignBounds
  (ASource: TdxCustomLayoutElementViewInfo);
begin
  inherited DoAssignBounds(ASource);
  FTextAreaBounds := TdxCustomLayoutItemCaptionViewInfo(ASource).TextAreaBounds;
  FImageAreaBounds := TdxCustomLayoutItemCaptionViewInfo(ASource)
    .ImageAreaBounds;
end;
...
procedure TdxCustomLayoutItemCaptionViewInfo.CalculateFormattedText
  (AFormattedText: TdxFormattedText; const AFlags: Integer; const ARect: TRect;
...
begin
  ...
  AFormattedText.CalculateLayout(ACanvas, ACanvas.Font, ARect, AFormat,
    Item.ScaleFactor);
end;
...
begin
  ...
  FTextAreaBounds.Left := FTextAreaBounds.Left + AImageSize.cx +
    GetSpaceBetweenImageText;
  ATextSize := GetTextSize;
  ATextSize.cx := Min(ATextSize.cx, FTextAreaBounds.Width);
  ...
  case AlignHorz of
    taLeftJustify:
      begin
        ...
        FTextAreaBounds.Left := FImageAreaBounds.Right +
          GetSpaceBetweenImageText;
    ...
    taRightJustify:
      begin
        ...
        FTextAreaBounds.Right := FImageAreaBounds.Left -
          GetSpaceBetweenImageText;
        FTextAreaBounds.Left := FTextAreaBounds.Right - ATextSize.cx;
      end;
    taCenter:
      begin
        AHeaderWidth := Min(AImageSize.cx + GetSpaceBetweenImageText +
          ATextSize.cx, AContentBounds.Width);
        FImageAreaBounds.Left := AContentBounds.Left +
          (cxRectWidth(AContentBounds) - AHeaderWidth) div 2;
        FImageAreaBounds.Right := FImageAreaBounds.Left + AImageSize.cx;
        FTextAreaBounds.Left := FImageAreaBounds.Right +
          GetSpaceBetweenImageText;
        FTextAreaBounds.Right := FTextAreaBounds.Left + ATextSize.cx;
  ...
  case AlignVert of
    tavTop:
      begin
        AHeaderHeight := Min(AContentBounds.Height,
          Max(AImageSize.cy, ATextSize.cy));
        FImageAreaBounds.Top := AContentBounds.Top +
          (AHeaderHeight - AImageSize.cy) div 2;
        FImageAreaBounds.Bottom := FImageAreaBounds.Top + AImageSize.cy;
        FTextAreaBounds.Top := AContentBounds.Top +
          (AHeaderHeight - ATextSize.cy) div 2;
    ...
    tavBottom:
      begin
        ...
        FTextAreaBounds.Bottom := AContentBounds.Bottom -
          (AHeaderHeight - ATextSize.cy) div 2;
    ...
    tavCenter:
      begin
        FImageAreaBounds.Top := AContentBounds.Top +
          (cxRectHeight(AContentBounds) - AImageSize.cy) div 2;
        FImageAreaBounds.Bottom := FImageAreaBounds.Top + AImageSize.cy;
        FTextAreaBounds.Top := AContentBounds.Top +
          (cxRectHeight(AContentBounds) - ATextSize.cy) div 2;
        FTextAreaBounds.Bottom := FTextAreaBounds.Top + ATextSize.cy;
      end;
  end;
end;
...
function TdxCustomLayoutItemCaptionViewInfo.GetTextSize
  (ACanvas: TcxCanvas): TSize;
...
begin
  ...
  begin
    ...
    if IsTextFormatted then
      FTextSizeCache.TextSize := GetFormattedTextSize(ACanvas,
        CalculateTextFlags(False), R)
    else if Pos(#13, Text) > 0 then
    begin
      ACanvas.TextExtent(Text, R, CalculateTextFlags(False) or
        cxDontBreakChars);
      FTextSizeCache.TextSize := cxRectSize(R);
    end
    else
      FTextSizeCache.TextSize := ACanvas.TextExtent(GetVisibleText);
  end;
...
function TdxCustomLayoutItemCaptionViewInfo.IsEllipsisAllowed
  (AForDrawing: Boolean = False): Boolean;
begin
  if AForDrawing then
...
function TdxCustomLayoutItemCaptionViewInfo.IsNeedSpaceBetweenImageText
  : Boolean;
begin
  Result := IsTextVisible and IsImageVisible;
end;

function TdxCustomLayoutItemCaptionViewInfo.IsPointInHotTrackBounds
  (const P: TPoint): Boolean;
begin
  Result := IsImageVisible and PtInRect(ImageAreaBounds, P);
  if not Result and IsTextVisible then
    Result := PtInRect(TextAreaBounds, P);
end;
...
begin
  Result := IsHotTrackable and not HotTracked and
    (htsUnderlineCold in HotTrackStyles) or HotTracked and
    (htsUnderlineHot in HotTrackStyles);
end;
...
constructor TdxCustomLayoutItemCaptionViewInfo.Create(AItemViewInfo
  : TdxCustomLayoutItemViewInfo);
begin
  inherited;
...
procedure TdxCustomLayoutItemCaptionViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited;
  FTextAreaBounds := TdxRightToLeftLayoutConverter.ConvertRect(FTextAreaBounds,
    AClientBounds);
  FImageAreaBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (FImageAreaBounds, AClientBounds);
end;

{ TdxCustomLayoutItemViewData }

constructor TdxCustomLayoutItemViewData.Create
  (AOwner: TdxLayoutItemViewDataList; AItem: TdxCustomLayoutItem);
begin
  inherited Create;
  FItem := AItem;
...
procedure TdxCustomLayoutItemViewData.Assign
  (Source: TdxCustomLayoutItemViewData);
begin
end;
...
procedure TdxCustomLayoutItemViewData.WriteBoolean(AStream: TStream;
  AValue: Boolean);
begin
...
function TdxLayoutItemViewDataList.GetItem(Index: Integer)
  : TdxCustomLayoutItemViewData;
begin
  Result := TdxCustomLayoutItemViewData(List[Index]);
end;

procedure TdxLayoutItemViewDataList.SetItem(Index: Integer;
  Value: TdxCustomLayoutItemViewData);
begin
...
constructor TdxCustomLayoutItemViewInfo.Create(AContainerViewInfo
  : TdxLayoutContainerViewInfo; AParentViewInfo: TdxLayoutGroupViewInfo;
...
begin
  dxTestCheck((ViewData <> nil) and not FDestroyForbidden,
    'TdxCustomLayoutItemViewInfo.Destroy fails');
...
begin
  Result := ActuallyVisible or IsDragImagePainting and
    (IsDragged or IsDraggedWithParent and ParentViewInfo.CanPaint and
...
begin
  Result := (ParentViewInfo = nil) or
    (ParentViewInfo.IsExpanded and ParentViewInfo.IsParentExpanded);
end;
...
begin
  Result := (ParentViewInfo <> nil) and
    (ParentViewInfo.IsDragged or ParentViewInfo.IsDraggedWithParent);
end;
...
begin
  Result := FIsValid and
    ((Item <> nil) and ((Item.Parent = nil) and (ParentViewInfo = nil) or
    (ContainerViewInfo.GetItemViewInfo(Item.Parent) = ParentViewInfo) and
    ParentViewInfo.IsValid));
end;
...
function TdxCustomLayoutItemViewInfo.IsEllipsisAllowed
  (AForDrawing: Boolean = False): Boolean;
begin
  Result := (CaptionViewInfo.EllipsisPosition <> epNone) and
    (CaptionViewInfo.IsWidthFixed or IsWidthLimited and
    not Item.Parent.CanWrapItems or (CaptionViewInfo.TextLayout in [clTop,
    clBottom]));
end;

function TdxCustomLayoutItemViewInfo.IsHeightLimited: Boolean;
begin
  Result := Item.IsHeightFixed or (GetAlignVert = avClient) and
    ((ParentViewInfo = nil) or ParentViewInfo.IsHeightLimited);
end;

function TdxCustomLayoutItemViewInfo.IsWidthLimited: Boolean;
begin
  Result := FIsMaxWidth or Item.IsWidthFixed or (GetAlignHorz = ahClient) and
    ((ParentViewInfo = nil) or ParentViewInfo.IsWidthLimited);
end;
...
function TdxCustomLayoutItemViewInfo.GetLayoutLookAndFeel
  : TdxCustomLayoutLookAndFeel;
begin
  if FLayoutLookAndFeel = nil then
...
function TdxCustomLayoutItemViewInfo.CanAssignBounds
  (ASource: TdxCustomLayoutElementViewInfo): Boolean;
begin
  Result := inherited CanAssignBounds(ASource) and
    (TdxCustomLayoutItemViewInfo(ASource).Item = Item);
  dxTestCheck(Result, 'AssignBounds fails');
end;

function GetElement(AElements: TList; AIndex: Integer)
  : TdxCustomLayoutItemElementViewInfo;
begin
  Result := TdxCustomLayoutItemElementViewInfo(AElements.List[AIndex]);
end;

procedure TdxCustomLayoutItemViewInfo.DoAssignBounds
  (ASource: TdxCustomLayoutElementViewInfo);
var
  I: Integer;
...
var
  ...
  AAllMarkers, ASizableMarkers, ANonSizableMarkers: TRects;
  ASelectionBorderRect, AFullRect: TRect;
begin
  ...
  begin
    ...
    try
      ABackgroundBitmap.cxCanvas.FillRect(ABackgroundBitmap.ClientRect,
        dxLayoutSelectionBackgroundColor);
    ...
    dxDrawSelectionMarkers(ABitmap.cxCanvas, ASizableMarkers,
      dxLayoutSelectionBorderColor, dxLayoutSelectionBorderColor);
    dxDrawSelectionMarkers(ABitmap.cxCanvas, ANonSizableMarkers,
      dxLayoutSelectionBorderColor,
      dxLayoutSelectionBorderMarkerBackgroundColor);

    ABitmap.cxCanvas.FrameRect(SelectionBorderRect,
      dxLayoutSelectionBorderColor, 1, cxBordersAll, True);

    AAllMarkers := dxGetSelectionMarkers(SelectionBorderRect,
      dxLayoutSelectionMarkerWidth);
    AFullRect := cxRect(AAllMarkers[0].TopLeft, AAllMarkers[4].BottomRight);
    ABitmap.RecoverAlphaChannel(AFullRect, 0);
  end;
end;

procedure TdxCustomLayoutItemViewInfo.PaintLockedState(ABitmap: TcxAlphaBitmap);
begin
  cxDrawHatch(ABitmap.cxCanvas.Handle, SelectionBorderRect, clBlack, clBtnFace,
    2, 20, 170);
end;

procedure TdxCustomLayoutItemViewInfo.PaintInvisibleState
  (ABitmap: TcxAlphaBitmap);
begin
  cxDrawHatch(ABitmap.cxCanvas.Handle, SelectionBorderRect, clBlack, clred,
    8, 20, 20);
end;
...
begin
  ...
  begin
    if IsDragged then
      TdxLayoutCustomDragAndDropControllerAccess(dxLayoutDragAndDropController)
        .PaintDraggedItem(ABitmap, Self)
    else
...
procedure TdxCustomLayoutItemViewInfo.PaintContent(ADestImage: TcxAlphaBitmap;
  ANeedDrawFrame, AExtractLayer: Boolean);
begin
...
function TdxCustomLayoutItemViewInfo.ShowHint(var AHintInfo: THintInfo)
  : Boolean;
begin
...
begin
  Result := not Item.IsDesigning and not Item.IsRoot and
    (CaptionViewInfo <> nil) and CaptionViewInfo.IsTextVisible and
...
begin
  if not HasCaption and (ParentViewInfo <> nil) and not ParentViewInfo.AllowChildHasBorder
  then
...
begin
  Result := (ParentViewInfo <> nil) and
    (ParentViewInfo.Selected or ParentViewInfo.IsParentSelected);
end;
...
function TdxCustomLayoutItemViewInfo.GetMarkerIndex(AMarkers: TRects;
...
begin
  Result := GetMarkerIndex(dxGetSelectionMarkers(SelectionBorderRect,
    dxLayoutSelectionMarkerWidth), P);
end;
...
const
  ...
  begin
    ...
    Result := ((ParentViewInfo = nil) and
      (not Item.IsRoot or ((ARootViewInfo.ItemsAreaOffsetHorz > SelectionGab)
      and (ARootViewInfo.ItemsAreaOffsetVert > SelectionGab)))) or
      ((ParentViewInfo <> nil) and (ParentViewInfo.UseItemOffset and
      (ParentViewInfo.ItemOffset > SelectionGab)));
  end;
...
procedure TdxCustomLayoutItemViewInfo.GetSelectionMarkers(out ASelectable,
  ANonSelectable: TRects);

  function GetWorkAlignHorz(AItem: TdxCustomLayoutItem): TdxLayoutAlignHorz;
  begin
    Result := AItem.GetRealAlignHorz;
    if (Result = ahClient) and (AItem.Parent <> nil) and (AItem.Parent.Width = 0)
    then
  ...
  begin
    ...
    if (Result = avClient) and (AItem.Parent <> nil) and
      (AItem.Parent.Height = 0) then
...
begin
  ...
  begin
    ASelectable := dxGetSelectionMarkers(SelectionBorderRect,
      dxLayoutSelectionMarkerWidth);
    SetLength(ANonSelectable, Length(ASelectable));

    if (GetWorkAlignHorz(Item) in [ahLeft, ahClient]) or not Item.CanResizeHorz
    then
    begin
      MoveRect(0);
      MoveRect(6);
    ...
    if (GetWorkAlignHorz(Item) in [ahRight, ahClient]) or not Item.CanResizeHorz
    then
    begin
      MoveRect(2);
      MoveRect(3);
    ...
    if (GetWorkAlignVert(Item) in [avTop, avClient]) or not Item.CanResizeVert
    then
    begin
      MoveRect(0);
      MoveRect(1);
    ...
    if (GetWorkAlignVert(Item) in [avBottom, avClient]) or not Item.CanResizeVert
    then
    begin
      MoveRect(4);
      MoveRect(5);
  ...
  begin
    ANonSelectable := dxGetSelectionMarkers(SelectionBorderRect,
      dxLayoutSelectionMarkerWidth);
...
begin
  Result := SelectionBorderRect;
  InflateRect(Result, dxLayoutSelectionMarkerWidth div 2,
    dxLayoutSelectionMarkerWidth div 2);
end;

procedure TdxCustomLayoutItemViewInfo.SetElementWithMouse
  (Value: TdxCustomLayoutItemElementViewInfo);
begin
...
procedure TdxCustomLayoutItemViewInfo.SetOffset(ASide: TdxLayoutSide;
  Value: Integer);
begin
  FOffsets[ASide] := Value;
end;

function TdxCustomLayoutItemViewInfo.CreateHitTest(AHitTestClass
  : TdxCustomLayoutItemHitTestClass; const P: TPoint)
...
procedure TdxCustomLayoutItemViewInfo.PopulateAutoAlignControlList
  (AList: TList);
begin
  // do nothing
end;

procedure TdxCustomLayoutItemViewInfo.PopulateControlViewInfoList(AControls,
  AWinControls: TList);
begin
  // do nothing
end;
...
procedure TdxCustomLayoutItemViewInfo.MakeVisible(const ARect: TRect;
  AFully: Boolean);
var
  AParentViewInfo: TdxLayoutGroupViewInfo;
begin
...
begin
  if IsDragImagePainting then
    Result := TdxLayoutCustomDragAndDropControllerAccess
      (dxLayoutDragAndDropController).GetDragImageBackgroundColor(Self)
  else
    Result := Color;
end;
...
begin
  ...
  FIsMaxWidth := (Item.SizeOptions.MaxWidth > 0) and
    (Result >= Item.SizeOptions.MaxWidth);
  if FIsMaxWidth then
    Result := Item.SizeOptions.MaxWidth;
end;

function TdxCustomLayoutItemViewInfo.CalculateOffset
...
function TdxCustomLayoutItemViewInfo.GetDropAreaPart(var P: TPoint)
  : TdxLayoutDropAreaPart;
const
  Parts: array [Boolean, Boolean] of TdxLayoutDropAreaPart =
  ...
  begin
    TdxLayoutCustomDragAndDropControllerAccess(dxLayoutDragAndDropController)
      .CorrectDropAreaPart(Item, Result);
    if ParentViewInfo <> nil then
...
begin
  Result := ContainerViewInfo.IsActuallyVisible and Item.GetVisible and
    (Item.IsRoot or (FParentViewInfo <> nil) and
    FParentViewInfo.IsChildActuallyVisible(Self)) and IsParentExpanded;
end;
...
function TdxCustomLayoutItemViewInfo.DoCalculateHeight(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
begin
  Result := OffsetsHeight;
end;

function TdxCustomLayoutItemViewInfo.DoCalculateWidth(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
begin
  Result := OffsetsWidth;
end;
...
begin
  Result := Max(0, cxRectWidth(Bounds));
end;
...
procedure TdxCustomLayoutItemViewInfo.SetItemHeight(AHeight: Integer;
  ADirectAccess: Boolean);
begin
  Item.Height := AHeight;
end;

procedure TdxCustomLayoutItemViewInfo.SetItemWidth(AWidth: Integer;
  ADirectAccess: Boolean);
begin
  Item.Width := AWidth;
end;
...
begin
  if (dxLayoutDragAndDropObject <> nil) and
    (TcxDragAndDropObjectAccess(dxLayoutDragAndDropObject)
    .Control.DragAndDropState in [ddsNone, ddsInProcess]) then
    Result := SelectionArea
  else
    Result := GetVisibleBounds;
end;

function TdxCustomLayoutItemViewInfo.GetOptions
...
begin
  Result := (IsDragImagePainting and IsGrabbed) or (ParentViewInfo = nil)
  { IsRoot } and (not IsTransparent or Item.IsDesigning and
    Item.Container.HighlightRoot) or not IsTransparent and
    (ParentViewInfo <> nil) and
    (LayoutLookAndFeel <> ParentViewInfo.LayoutLookAndFeel);
end;
...
procedure TdxCustomLayoutItemViewInfo.CustomizationMouseDown
...
function TdxCustomLayoutItemViewInfo.DoMouseWheel(Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
  Result := False;
end;

function TdxCustomLayoutItemViewInfo.IsMouseWheelHandleNeeded
...
procedure TdxCustomLayoutItemViewInfo.MouseMove(Shift: TShiftState;
  X, Y: Integer);
var
  I: Integer;
  AElements: TList;
...
procedure TdxCustomLayoutItemViewInfo.CalculateInternalTabOrders
  (var AAvailableTabOrder: Integer);
begin
  // do nothing
end;

procedure TdxCustomLayoutItemViewInfo.CalculateTabOrders(var AAvailableTabOrder
  : Integer);
begin
  // do nothing
end;

procedure TdxCustomLayoutItemViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
...
function TdxCustomLayoutItemViewInfo.GetHitTest(const P: TPoint)
  : TdxCustomLayoutHitTest;
var
...
begin
  Result := nil;
  if IsValid and (not IsParentLocked or Item.IsDesigning) and ActuallyVisible
  then
  begin
...
function TdxCustomLayoutItemViewInfo.GetItemWithMouse(const P: TPoint)
  : TdxCustomLayoutItem;
begin
  if IsValid and not IsParentLocked and PtInRect(GetVisibleBounds, P) and ActuallyVisible
  then
    Result := Item
  else
    Result := nil;
...
function TdxLayoutEmptySpaceItemCaptionViewInfo.CanDoCaptionClick(X,
  Y: Integer): Boolean;
begin
  Result := False;
end;
...
procedure TdxLayoutEmptySpaceItemCaptionViewInfo.PrepareCanvas
  (ACanvas: TcxCanvas; AForDrawing: Boolean);
begin
  // do nothing
end;
...
constructor TdxLayoutLabeledItemCaptionViewInfo.Create(AItemViewInfo
  : TdxCustomLayoutItemViewInfo);
begin
  inherited;
...
function TdxLayoutLabeledItemCaptionViewInfo.GetItem
  : TdxCustomLayoutLabeledItem;
begin
  Result := TdxCustomLayoutLabeledItem(inherited GetItem);
end;

function TdxLayoutLabeledItemCaptionViewInfo.GetItemViewInfo
  : TdxLayoutLabeledItemViewInfo;
begin
  Result := TdxLayoutLabeledItemViewInfo(inherited ItemViewInfo);
end;

function TdxLayoutLabeledItemCaptionViewInfo.GetTextSize
  (ACanvas: TcxCanvas): TSize;
var
  R: TRect;
  AFlags: Integer;
...
begin
  ...
  begin
    ...
    if AIsWidthFixed then
      ...
      R := Rect(0, 0, Max(1, ItemViewInfo.GetAvailableTextAreaWidth -
        1 { for disabling } ), 1);
    if R.Right <> FTextSizeCache.TextAreaWidth then
    begin
      if AIsWidthFixed then
        AFlags := CalculateTextFlags(False)
      else
        AFlags := CalculateTextFlags(False) or cxDontBreakChars;
...
begin
  Result := IsWidthFixed and not IsEllipsisAllowed or
    ItemViewInfo.IsWordWrapAllowed;
end;
...
function TdxLayoutControlItemCaptionViewInfo.GetItemViewInfo
  : TdxLayoutControlItemViewInfo;
begin
...
function TdxLayoutControlItemControlViewInfo.GetBorderStyle
  : TdxLayoutBorderStyle;
begin
...
function TdxLayoutControlItemControlViewInfo.GetItemViewInfo
  : TdxLayoutControlItemViewInfo;
begin
  Result := TdxLayoutControlItemViewInfo(inherited ItemViewInfo);
end;
...
procedure TdxLayoutControlItemControlViewInfo.DoSetOffset(const AValue,
  ADiff: TPoint);
begin
  inherited;
...
begin
  ...
  begin
    ...
    begin
      ...
      Item.ControlAdapter.FNeedSetRegion := not cxRectIsEqual(FControlBounds,
        FControlWindowRect);
      FControlWindowRect := cxRectOffset(FControlWindowRect,
        FControlBounds.TopLeft, False);
    end;
  end
  else
...
function TdxLayoutControlItemControlViewInfo.GetBorderWidth
  (ASide: TdxLayoutSide): Integer;
begin
  if HasBorder then
...
function TdxLayoutControlItemControlViewInfo.GetControlAreaHeight
  (AControlHeight: Integer): Integer;
begin
  Result := BorderWidths[sdTop] + AControlHeight + BorderWidths[sdBottom];
end;

function TdxLayoutControlItemControlViewInfo.GetControlAreaWidth
  (AControlWidth: Integer): Integer;
begin
...
procedure TdxLayoutControlItemControlViewInfo.CalculateInternalTabOrder
  (var AAvailableTabOrder: Integer);
begin
  // do nothing
end;

procedure TdxLayoutControlItemControlViewInfo.CalculateTabOrder
  (var AAvailableTabOrder: Integer);
begin
  // do nothing
end;
...
procedure TdxLayoutControlItemControlViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited DoRightToLeftConversion(AClientBounds);
  CalculateControlBounds;
...
procedure TdxLayoutItemControlViewInfo.CalculateTabOrder(var AAvailableTabOrder
  : Integer);
begin
...
function TdxLayoutBasicItemViewInfo.GetCaptionViewInfoClass
  : TdxCustomLayoutItemCaptionViewInfoClass;
begin
  Result := TdxLayoutBasicItemCaptionViewInfo;
end;

function TdxLayoutBasicItemViewInfo.GetHitTestClass
  : TdxCustomLayoutItemHitTestClass;
begin
  Result := TdxLayoutBasicItemHitTest;
end;

function TdxLayoutBasicItemViewInfo.GetPainterClass
  : TdxCustomLayoutItemPainterClass;
begin
  Result := TdxCustomLayoutItemPainterClass
    (LayoutLookAndFeel.GetBasicItemPainterClass);
end;
...
function TdxLayoutEmptySpaceItemViewInfo.GetCaptionViewInfoClass
  : TdxCustomLayoutItemCaptionViewInfoClass;
begin
  Result := TdxLayoutEmptySpaceItemCaptionViewInfo;
end;

function TdxLayoutEmptySpaceItemViewInfo.GetPainterClass
  : TdxCustomLayoutItemPainterClass;
begin
  Result := TdxCustomLayoutItemPainterClass
    (LayoutLookAndFeel.GetEmptySpaceItemPainterClass);
end;

function TdxLayoutEmptySpaceItemViewInfo.DoCalculateHeight
  (ACalcSizeType: TdxLayoutCalcSizeType): Integer;
begin
...
function TdxLayoutEmptySpaceItemViewInfo.DoCalculateWidth
  (ACalcSizeType: TdxLayoutCalcSizeType): Integer;
begin
  if Item.IsDragged and HasCaption then
...
function TdxLayoutDirectionalItemViewInfo.DoCalculateHeight
  (ACalcSizeType: TdxLayoutCalcSizeType): Integer;
begin
  if Item.IsDragged and HasCaption then
    Result := CaptionViewInfo.GetTextSize.cy
...
function TdxLayoutDirectionalItemViewInfo.DoCalculateWidth
  (ACalcSizeType: TdxLayoutCalcSizeType): Integer;
begin
  if Item.IsDragged and HasCaption then
    Result := CaptionViewInfo.GetTextSize.cx
...
function TdxLayoutSeparatorItemCaptionViewInfo.GetRotationAngle
  : TcxRotationAngle;
begin
...
begin
  ...
  begin
    ...
    AHeaderHeight := AImageAreaHeight + GetSpaceBetweenImageText +
      ATextAreaHeight;

    // AlignHorz ignored
    FImageAreaBounds.Left := AContentBounds.Left +
      (cxRectWidth(AContentBounds) - AImageAreaWidth) div 2;
    FImageAreaBounds.Right := FImageAreaBounds.Left + AImageAreaWidth;
    FTextAreaBounds.Left := AContentBounds.Left +
      (cxRectWidth(AContentBounds) - ATextAreaWidth) div 2;
    ...
    case AlignVert of
      ...
      tavCenter:
        FImageAreaBounds.Bottom := AContentBounds.Bottom -
          (cxRectHeight(AContentBounds) - AHeaderHeight) div 2;
    end;
  ...
  begin
    ...
    // AlignVert ignored
    FImageAreaBounds.Top := AContentBounds.Top +
      (cxRectHeight(AContentBounds) - AImageAreaHeight) div 2;
    FImageAreaBounds.Bottom := FImageAreaBounds.Top + AImageAreaHeight;
    FTextAreaBounds.Top := AContentBounds.Top +
      (cxRectHeight(AContentBounds) - ATextAreaHeight) div 2;
...
begin
  InitViewInfoBounds(CaptionViewInfo, FCaptionAreaBounds, ACaptionSize,
    ACaptionVisible);
  ...
  if ACaptionVisible then
    if IsVertical then
      case Separator.CaptionOptions.AlignVert of
        tavTop:
          begin
            FCaptionAreaBounds.Bottom := CaptionAreaBounds.Top + ACaptionSize.Y;
            ASeparatorBounds.Top := CaptionAreaBounds.Bottom + 1;
          end;
        tavBottom:
          begin
            FCaptionAreaBounds.Top := CaptionAreaBounds.Bottom - ACaptionSize.Y;
            ASeparatorBounds.Bottom := CaptionAreaBounds.Top - 1;
          end;
        tavCenter:
          FCaptionAreaBounds := cxRectCenterVertically(CaptionAreaBounds,
            ACaptionSize.Y);
      end
    else
      case Separator.CaptionOptions.AlignHorz of
        taLeftJustify:
          begin
            FCaptionAreaBounds.Right := CaptionAreaBounds.Left + ACaptionSize.X;
            ASeparatorBounds.Left := CaptionAreaBounds.Right + 1;
          end;
        taRightJustify:
          begin
            FCaptionAreaBounds.Left := CaptionAreaBounds.Right - ACaptionSize.X;
            ASeparatorBounds.Right := CaptionAreaBounds.Left - 1;
          end;
        taCenter:
          FCaptionAreaBounds := cxRectCenterHorizontally(CaptionAreaBounds,
            ACaptionSize.X);
      end;
  FCellAreaBounds := ASeparatorBounds;
end;

function TdxLayoutSeparatorItemViewInfo.DoCalculateHeight
  (ACalcSizeType: TdxLayoutCalcSizeType): Integer;
begin
  Result := Max(inherited DoCalculateHeight(ACalcSizeType),
    GetSeparatorMinHeight);
end;

function TdxLayoutSeparatorItemViewInfo.DoCalculateWidth(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
begin
  Result := Max(inherited DoCalculateWidth(ACalcSizeType),
    GetSeparatorMinWidth);
end;

function TdxLayoutSeparatorItemViewInfo.GetCaptionViewInfoClass
  : TdxCustomLayoutItemCaptionViewInfoClass;
begin
  Result := TdxLayoutSeparatorItemCaptionViewInfo;
end;

function TdxLayoutSeparatorItemViewInfo.GetPainterClass
  : TdxCustomLayoutItemPainterClass;
begin
  Result := TdxCustomLayoutItemPainterClass
    (LayoutLookAndFeel.GetSeparatorItemPainterClass);
end;
...
begin
  ...
  else if cxRectHeight(Result) < MinHitTestSize then
    InflateRect(Result, 0, 1);
end;

function TdxLayoutSplitterItemViewInfo.GetHitTestClass
  : TdxCustomLayoutItemHitTestClass;
begin
...
function TdxLayoutSplitterItemViewInfo.GetPainterClass
  : TdxCustomLayoutItemPainterClass;
begin
  Result := TdxCustomLayoutItemPainterClass
    (LayoutLookAndFeel.GetSplitterItemPainterClass);
end;
...
procedure TdxLayoutSplitterItemViewInfo.MouseUp(Button: TMouseButton;
...
function TdxLayoutLabeledItemViewInfo.GetCaptionViewInfoClass
  : TdxCustomLayoutItemCaptionViewInfoClass;
begin
  Result := TdxLayoutLabeledItemCaptionViewInfo;
end;

function TdxLayoutLabeledItemViewInfo.GetPainterClass
  : TdxCustomLayoutItemPainterClass;
begin
  Result := TdxCustomLayoutItemPainterClass
    (LayoutLookAndFeel.GetLabeledItemPainterClass);
end;

procedure TdxLayoutLabeledItemViewInfo.InitViewInfoBounds(AElementViewInfo
  : TdxCustomLayoutItemElementViewInfo; out ABounds: TRect; out ASize: TPoint;
  out AVisible: Boolean);

  procedure CalculateElementViewInfoSize(AElementViewInfo
    : TdxCustomLayoutItemElementViewInfo; out ASize: TPoint;
    out AVisible: Boolean);
  begin
...
begin
  Result := CaptionViewInfo.WordWrap and
    (IsWidthLimited and not Item.Parent.CanWrapItems or
    (CaptionViewInfo.TextLayout in [clTop, clBottom]));
end;
...
begin
  ...
  if Result > 0 then
    Result := Result - CaptionViewInfo.ImageWidth -
      CaptionViewInfo.GetSpaceBetweenImageText
  else
    Result := 0;
end;

function TdxLayoutLabeledItemViewInfo.GetContentHeight(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
begin
  Result := CaptionViewInfo.Height + Padding.Top + Padding.Bottom;
end;

function TdxLayoutLabeledItemViewInfo.GetContentWidth(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
begin
...
function TdxLayoutLabeledItemViewInfo.DoCalculateHeight(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
begin
  Result := inherited DoCalculateHeight(ACalcSizeType) +
    GetContentHeight(ACalcSizeType);
end;

function TdxLayoutLabeledItemViewInfo.DoCalculateWidth(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
begin
  Result := inherited DoCalculateWidth(ACalcSizeType) +
    GetContentWidth(ACalcSizeType);
end;

procedure TdxLayoutLabeledItemViewInfo.DoAssignBounds
  (ASource: TdxCustomLayoutElementViewInfo);
begin
  inherited;
  FCaptionAreaBounds := TdxLayoutLabeledItemViewInfo(ASource)
    .FCaptionAreaBounds;
end;

procedure TdxLayoutLabeledItemViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited;
  FCaptionAreaBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (FCaptionAreaBounds, AClientBounds);
end;
...
procedure TdxLayoutCellItemViewInfo.DoAssignBounds
  (ASource: TdxCustomLayoutElementViewInfo);
begin
  inherited;
...
procedure TdxLayoutCellItemViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited;
  FCellAreaBounds := TdxRightToLeftLayoutConverter.ConvertRect(CellAreaBounds,
    AClientBounds);
end;
...
function TdxLayoutImageItemViewInfo.GetPainterClass
  : TdxCustomLayoutItemPainterClass;
begin
...
begin
  ...
  AImageAreaBounds := cxRectContent(Bounds, Padding);
  if CaptionViewInfo.Visible and IsImageAssigned(Item.Image) then
  begin
    case CaptionLayout of
      clLeft:
        begin
          FCaptionAreaBounds.Right := CaptionAreaBounds.Left +
            CaptionViewInfo.Width;
          AImageAreaBounds.Left := CaptionAreaBounds.Right + ElementOffsetHorz;
        end;
      clRight:
        begin
          FCaptionAreaBounds.Left := CaptionAreaBounds.Right -
            CaptionViewInfo.Width;
          AImageAreaBounds.Right := CaptionAreaBounds.Left - ElementOffsetHorz;
        end;
      clTop:
        begin
          FCaptionAreaBounds.Bottom := CaptionAreaBounds.Top +
            CaptionViewInfo.Height;
          AImageAreaBounds.Top := CaptionAreaBounds.Bottom + ElementOffsetVert;
        end;
      clBottom:
        begin
          FCaptionAreaBounds.Top := CaptionAreaBounds.Bottom -
            CaptionViewInfo.Height;
          AImageAreaBounds.Bottom := CaptionAreaBounds.Top - ElementOffsetVert;
        end;
    end;
  end;
  FCellAreaBounds := AImageAreaBounds;
end;
...
begin
  ...
  if (Result > 0) and (Item.CaptionOptions.Layout in [clLeft, clRight]) then
    Result := Result - ElementOffsetHorz - dxGetImageSize(Item.Image,
      Item.ScaleFactor).cx;
end;

function TdxLayoutImageItemViewInfo.GetContentHeight(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
var
...
function TdxLayoutImageItemViewInfo.GetContentWidth(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
var
  AImageWidth: Integer;
begin
  if (ACalcSizeType = cstMin) and not IsWordWrapAllowed then
  begin
    Result := CaptionViewInfo.CalculateMinWidth;
...
procedure TdxCustomLayoutCheckableItemViewInfo.CalculateInternalTabOrders
  (var AAvailableTabOrder: Integer);
begin
  inherited CalculateInternalTabOrders(AAvailableTabOrder);
  if Item.CanFocus then
  begin
...
procedure TdxCustomLayoutCheckableItemViewInfo.CalculateViewInfoBounds;
begin
  inherited CalculateViewInfoBounds;
  CalculateCheckAreaBounds;
  if CaptionViewInfo.Visible then
    UpdateCaptionAreaBounds;
end;

function TdxCustomLayoutCheckableItemViewInfo.GetCaptionViewInfoClass
  : TdxCustomLayoutItemCaptionViewInfoClass;
begin
  Result := TdxCustomLayoutCheckableItemCaptionViewInfo;
end;

function TdxCustomLayoutCheckableItemViewInfo.GetFocusRect
  (ACanvas: TcxCanvas): TRect;
begin
  Result := FCaptionAreaBounds;
  ACanvas.SaveState;
  try
    CaptionViewInfo.PrepareCanvas(ACanvas, True);
    if CaptionViewInfo.IsTextFormatted then
      Result := cxRectSetSize(Result, CaptionViewInfo.GetFormattedTextSize
        (ACanvas, CaptionViewInfo.CalculateTextFlags, Result))
    else
      ACanvas.TextExtent(CaptionViewInfo.Text, Result,
        CaptionViewInfo.CalculateTextFlags);
  finally
    ACanvas.RestoreState;
  end;
  CorrectFocusRect(Result);
  InflateRect(Result, 1, 1);
end;
...
procedure TdxCustomLayoutCheckableItemViewInfo.KeyDown(var Key: Word;
  Shift: TShiftState);
begin
...
procedure TdxCustomLayoutCheckableItemViewInfo.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  APressed: Boolean;
begin
...
procedure TdxCustomLayoutCheckableItemViewInfo.CorrectFocusRect
  (var AFocusRect: TRect);
var
  AWidth: Integer;
begin
  if not cxRectIsEmpty(CaptionViewInfo.ImageAreaBounds) then
  begin
    AWidth := CaptionViewInfo.ImageWidth + ElementOffsetHorz;
    case CaptionViewInfo.AlignHorz of
      taLeftJustify:
        AFocusRect := cxRectInflate(AFocusRect, 0, 0, AWidth, 0);
      taRightJustify:
        AFocusRect := cxRectInflate(AFocusRect, AWidth, 0, 0, 0);
      taCenter:
        AFocusRect := cxRectInflate(AFocusRect, AWidth div 2, 0,
          AWidth div 2, 0);
    end;
  end;
end;
...
function TdxCustomLayoutCheckableItemCaptionViewInfo.IsPointInHotTrackBounds
  (const P: TPoint): Boolean;
begin
...
function TdxCustomLayoutCheckableItemCaptionViewInfo.WantsMouse(X,
  Y: Integer): Boolean;
begin
  Result := inherited WantsMouse(X, Y) or
    (Visible and PtInRect(TdxLayoutCheckBoxItemViewInfo(ItemViewInfo)
    .CheckAreaBounds, Point(X, Y)));
end;

{ TdxLayoutCheckBoxItemViewInfo }

procedure TdxLayoutCheckBoxItemViewInfo.CalculateCheckAreaBounds;
var
  ACheckAreaBounds, AOffsets: TRect;
begin
  ACheckAreaBounds := cxRectCenter(ContentBounds,
    Min(CheckAreaSize.cx, cxRectWidth(ContentBounds)),
    Min(CheckAreaSize.cy, cxRectHeight(ContentBounds)));
  if CaptionViewInfo.Visible then
  begin
    AOffsets := GetContentOffsets;
    case CaptionViewInfo.TextLayout of
      clRight:
        begin
          ACheckAreaBounds.Left := ContentBounds.Left + AOffsets.Left;
          ACheckAreaBounds.Right := ACheckAreaBounds.Left + CheckAreaSize.cx;
        end;
      clLeft:
        begin
          ACheckAreaBounds.Right := ContentBounds.Right - AOffsets.Right - 1;
          ACheckAreaBounds.Left := ACheckAreaBounds.Right - CheckAreaSize.cx;
        end;
      clTop:
        begin
          ACheckAreaBounds.Bottom := ContentBounds.Bottom - AOffsets.Bottom;
          ACheckAreaBounds.Top := ACheckAreaBounds.Bottom - CheckAreaSize.cy;
        end;
      clBottom:
        begin
          ACheckAreaBounds.Top := ContentBounds.Top + AOffsets.Top;
          ACheckAreaBounds.Bottom := ACheckAreaBounds.Top + CheckAreaSize.cy;
        end;
    end;
  end;
  FCellAreaBounds := ACheckAreaBounds;
end;

function TdxLayoutCheckBoxItemViewInfo.GetAvailableTextAreaWidth: Integer;
begin
  Result := inherited GetAvailableTextAreaWidth;
  if Result > 0 then
  begin
    Result := Result - cxMarginsWidth(Padding) -
      cxMarginsWidth(GetContentOffsets);
    if CaptionViewInfo.TextLayout in [clRight, clLeft] then
      Result := Result - CheckAreaSize.cx - GetTextGap;
    if not GetIsTextEnabled and not Assigned(LookAndFeel.SkinPainter) then
      Dec(Result);
  end;
end;
...
begin
  Result := GetScaledEditCheckSize(ContainerViewInfo.Canvas,
    LookAndFeel.NativeStyle, Item.CheckBoxOptions.Glyph,
    Item.CheckBoxOptions.GlyphCount, LookAndFeel.Painter, Item.ScaleFactor);
end;

function TdxLayoutCheckBoxItemViewInfo.GetContentHeight(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
var
  AHeight: Integer;
begin
  Result := CheckAreaSize.cy;
  if CaptionViewInfo.Visible then
  begin
    AHeight := CaptionViewInfo.CalculateHeight;
    ...
    case CaptionViewInfo.TextLayout of
      ...
      clTop:
        Result := Result + GetContentOffsets.Bottom + GetTextGap + AHeight;
      clBottom:
        Result := Result + GetContentOffsets.Top + GetTextGap + AHeight;
    end;
  end;
  Result := Result + Padding.Top + Padding.Bottom +
    Item.ScaleFactor.Apply(4) - 2;
  if LookAndFeel.NativeStyle then
    Result := Result + 1;
  if Assigned(LookAndFeel.SkinPainter) then
    Result := Result + 2;
end;

function TdxLayoutCheckBoxItemViewInfo.GetContentOffsets: TRect;
begin
  if not CaptionViewInfo.Visible then
    Result := Rect(0, 2, 0, 2)
  else
    case CaptionViewInfo.TextLayout of
      clRight:
  ...
  Result := Item.ScaleFactor.Apply(Result);
end;

function TdxLayoutCheckBoxItemViewInfo.GetContentWidth(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
var
  AWidth: Integer;
begin
  Result := CheckAreaSize.cx;
  if CaptionViewInfo.Visible then
  begin
    if (ACalcSizeType = cstMin) and not IsWordWrapAllowed then
      AWidth := CaptionViewInfo.CalculateMinWidth
    else
      AWidth := CaptionViewInfo.CalculateWidth;
    Inc(AWidth, GetContentOffsets.Left);
    case CaptionViewInfo.TextLayout of
      clRight:
        Result := Result + GetContentOffsets.Left + GetTextGap + AWidth;
      clLeft:
        Result := Result + GetContentOffsets.Right + GetTextGap + AWidth;
      clTop, clBottom:
...
function TdxLayoutCheckBoxItemViewInfo.GetFocusRect(ACanvas: TcxCanvas): TRect;
begin
  if CaptionViewInfo.TextLayout in [clTop, clBottom] then
  begin
    Result := ContentBounds;
    InflateRect(Result, -1, -1);
  end
  else if CaptionViewInfo.Visible then
  begin
    Result := inherited GetFocusRect(ACanvas);
    if not LookAndFeel.NativeStyle then
      Inc(Result.Bottom);
    if Assigned(LookAndFeel.SkinPainter) then
      OffsetRect(Result, 0, Item.ScaleFactor.Apply(1) - 2)
    else
...
function TdxLayoutCheckBoxItemViewInfo.GetIsTextEnabled: Boolean;
begin
  Result := Enabled or LookAndFeel.NativeStyle;
end;

function TdxLayoutCheckBoxItemViewInfo.GetPainterClass
  : TdxCustomLayoutItemPainterClass;
begin
  Result := TdxLayoutCheckBoxItemPainter;
end;

function TdxLayoutCheckBoxItemViewInfo.GetTextGap: Integer;
const
  CCheckTextGap: array [Boolean] of Integer = (5, 3);
begin
  Result := Item.ScaleFactor.Apply(CCheckTextGap[LookAndFeel.NativeStyle]);
end;

procedure TdxLayoutCheckBoxItemViewInfo.UpdateCaptionAreaBounds;
begin
  FCaptionAreaBounds := ContentBounds;
  InflateRect(FCaptionAreaBounds, -GetContentOffsets.Left, 0);

  if not LookAndFeel.NativeStyle then
    OffsetRect(FCaptionAreaBounds, 0, -1);

  if CaptionViewInfo.Visible then
    case CaptionViewInfo.TextLayout of
      clRight:
        FCaptionAreaBounds.Left := CheckAreaBounds.Right + GetTextGap;
      clLeft:
        FCaptionAreaBounds.Right := CheckAreaBounds.Left - GetTextGap;
      clTop:
        FCaptionAreaBounds.Bottom := CheckAreaBounds.Top - GetTextGap;
      clBottom:
        FCaptionAreaBounds.Top := CheckAreaBounds.Bottom + GetTextGap;
    end
  else
    FCaptionAreaBounds.Right := FCaptionAreaBounds.Left;
...
procedure TdxLayoutRadioButtonItemViewInfo.CalculateCheckAreaBounds;
var
  ACheckAreaBounds: TRect;
begin
  ACheckAreaBounds := cxRectCenter(ContentBounds,
    Min(CheckAreaSize.cx, cxRectWidth(ContentBounds)),
    Min(CheckAreaSize.cy, cxRectHeight(ContentBounds)));
  if CaptionViewInfo.Visible then
    case CaptionViewInfo.TextLayout of
      clLeft:
        begin
          ACheckAreaBounds.Right := ContentBounds.Right;
          if not LookAndFeel.NativeStyle and
            not Assigned(LookAndFeel.SkinPainter) then
            Dec(ACheckAreaBounds.Right);
          ACheckAreaBounds.Left := ACheckAreaBounds.Right - CheckAreaSize.cx;
        end;
      clRight:
        begin
          ACheckAreaBounds.Left := ContentBounds.Left;
          if not LookAndFeel.NativeStyle and
            not Assigned(LookAndFeel.SkinPainter) then
            Inc(ACheckAreaBounds.Left);
          ACheckAreaBounds.Right := ACheckAreaBounds.Left + CheckAreaSize.cx;
        end;
      clTop:
        begin
          ACheckAreaBounds.Bottom := ContentBounds.Bottom;
          if not LookAndFeel.NativeStyle and
            not Assigned(LookAndFeel.SkinPainter) then
            Dec(ACheckAreaBounds.Bottom);
          ACheckAreaBounds.Top := ACheckAreaBounds.Bottom - CheckAreaSize.cy;
        end;
      clBottom:
        begin
          ACheckAreaBounds.Top := ContentBounds.Top;
          if not LookAndFeel.NativeStyle and
            not Assigned(LookAndFeel.SkinPainter) then
            Dec(ACheckAreaBounds.Top);
          ACheckAreaBounds.Bottom := ACheckAreaBounds.Top + CheckAreaSize.cy;
        end;
    end;
  FCellAreaBounds := ACheckAreaBounds;
...
function TdxLayoutRadioButtonItemViewInfo.GetAvailableTextAreaWidth: Integer;
begin
  Result := inherited GetAvailableTextAreaWidth;
  if Result > 0 then
  begin
    Result := Result - cxMarginsWidth(Padding) -
      cxMarginsWidth(GetCaptionAreaOffsets);
    if CaptionViewInfo.TextLayout in [clRight, clLeft] then
    begin
      Result := Result - CheckAreaSize.cx;
      if not LookAndFeel.NativeStyle and (CaptionViewInfo.TextLayout <> clLeft)
      then
        Dec(Result);
    end;
  end;
...
function TdxLayoutRadioButtonItemViewInfo.GetCaptionAreaOffsets: TRect;
const
  CTextRectCorrection: array [Boolean, Boolean] of TRect = (((Left: 2; Top: - 1;
    Right: 1; Bottom: 0), (Left: 5; Top: - 1; Right: 0; Bottom: 0)),
    ((Left: 2; Top: - 1; Right: 6; Bottom: 0), (Left: 5; Top: - 1; Right: 2;
    Bottom: 0)));
  CNativeStyleTextRectCorrection: array [Boolean, Boolean]
    of TRect = (((Left: 2; Top: 0; Right: 1; Bottom: 0), (Left: 3; Top: 0;
    Right: 0; Bottom: 0)), ((Left: 2; Top: 0; Right: 3; Bottom: 0), (Left: 3;
...
begin
  ...
  begin
    if LookAndFeel.NativeStyle then
      Result := CNativeStyleTextRectCorrection[CaptionViewInfo.WordWrap,
        CaptionViewInfo.TextLayout = clRight]
    else
      Result := CTextRectCorrection[CaptionViewInfo.WordWrap,
        CaptionViewInfo.TextLayout = clRight];
    if UseRightToLeftAlignment then
...
begin
  Result := LookAndFeel.GetAvailablePainter(totButton).ScaledRadioButtonSize
    (Item.ScaleFactor);
end;

function TdxLayoutRadioButtonItemViewInfo.GetContentHeight
  (ACalcSizeType: TdxLayoutCalcSizeType): Integer;
var
  AHeight: Integer;
begin
  ...
  begin
    if not LookAndFeel.NativeStyle and
      (CaptionViewInfo.TextLayout in [clTop, clBottom]) then
      Inc(Result);
    AHeight := CaptionViewInfo.CalculateHeight +
      cxMarginsHeight(GetCaptionAreaOffsets);
    case CaptionViewInfo.TextLayout of
      clLeft, clRight:
        Result := Max(Result, AHeight);
      clTop, clBottom:
  ...
  Result := Result + Padding.Top + Padding.Bottom + Item.ScaleFactor.Apply(4);
  if LookAndFeel.NativeStyle then
    Result := Result - Item.ScaleFactor.Apply(1);
  if Assigned(LookAndFeel.SkinPainter) then
    Result := Result - Item.ScaleFactor.Apply(2);
end;

function TdxLayoutRadioButtonItemViewInfo.GetContentWidth
  (ACalcSizeType: TdxLayoutCalcSizeType): Integer;
var
  AWidth: Integer;
begin
  ...
  if CaptionViewInfo.Visible then
  begin
    if not LookAndFeel.NativeStyle and (CaptionViewInfo.TextLayout = clRight)
    then
      Inc(Result);
    if (ACalcSizeType = cstMin) and not IsWordWrapAllowed then
      AWidth := CaptionViewInfo.CalculateMinWidth
      ...
      AWidth := CaptionViewInfo.CalculateWidth;
    AWidth := AWidth + cxMarginsWidth(GetCaptionAreaOffsets);
    case CaptionViewInfo.TextLayout of
      clLeft, clRight:
        Inc(Result, AWidth);
      clTop, clBottom:
...
function TdxLayoutRadioButtonItemViewInfo.GetFocusRect
  (ACanvas: TcxCanvas): TRect;
begin
  Result := inherited GetFocusRect(ACanvas);
  if LookAndFeel.NativeStyle then
...
function TdxLayoutRadioButtonItemViewInfo.GetPainterClass
  : TdxCustomLayoutItemPainterClass;
begin
  Result := TdxLayoutRadioButtonItemPainter;
end;

procedure TdxLayoutRadioButtonItemViewInfo.UpdateCaptionAreaBounds;
begin
  case CaptionViewInfo.TextLayout of
    clLeft:
      FCaptionAreaBounds.Right := CheckAreaBounds.Left;
    clRight:
      FCaptionAreaBounds.Left := CheckAreaBounds.Right;
    clTop:
      FCaptionAreaBounds.Bottom := CheckAreaBounds.Top;
    clBottom:
      FCaptionAreaBounds.Top := CheckAreaBounds.Bottom;
  end;
  FCaptionAreaBounds := cxRectContent(FCaptionAreaBounds,
    GetCaptionAreaOffsets);
  if LookAndFeel.NativeStyle then
    FCaptionAreaBounds := cxRectOffsetVert(FCaptionAreaBounds,
      2 - Item.ScaleFactor.Apply(1));
end;
...
function TdxLayoutControlItemViewInfo.GetCaptionViewInfo
  : TdxLayoutControlItemCaptionViewInfo;
begin
...
function TdxLayoutControlItemViewInfo.GetOptions
...
procedure TdxLayoutControlItemViewInfo.PopulateAutoAlignControlList
  (AList: TList);
begin
...
function TdxLayoutControlItemViewInfo.GetCaptionViewInfoClass
  : TdxCustomLayoutItemCaptionViewInfoClass;
begin
  Result := TdxLayoutControlItemCaptionViewInfo;
end;

function TdxLayoutControlItemViewInfo.GetControlViewInfoClass
  : TdxLayoutControlItemControlViewInfoClass;
begin
  Result := TdxLayoutControlItemControlViewInfo;
end;

function TdxLayoutControlItemViewInfo.GetPainterClass
  : TdxCustomLayoutItemPainterClass;
begin
...
procedure TdxLayoutControlItemViewInfo.CalculateViewInfoBounds;
  ...
  procedure CalculateWithFixedCaption(var AControlAreaBounds: TRect;
    const ACaptionSize, AControlSize: TPoint);
  begin
    case CaptionLayout of
      clLeft:
        begin
          FCaptionAreaBounds.Right := FCaptionAreaBounds.Left + ACaptionSize.X;
          AControlAreaBounds.Left := FCaptionAreaBounds.Right +
            ElementOffsetHorz;
        end;
      clTop:
        begin
          FCaptionAreaBounds.Bottom := FCaptionAreaBounds.Top + ACaptionSize.Y;
          AControlAreaBounds.Top := FCaptionAreaBounds.Bottom +
            ElementOffsetVert;
        end;
      clRight:
        begin
          FCaptionAreaBounds.Left := FCaptionAreaBounds.Right - ACaptionSize.X;
          AControlAreaBounds.Right := FCaptionAreaBounds.Left -
            ElementOffsetHorz;
        end;
      clBottom:
        begin
          FCaptionAreaBounds.Top := FCaptionAreaBounds.Bottom - ACaptionSize.Y;
          AControlAreaBounds.Bottom := FCaptionAreaBounds.Top -
            ElementOffsetVert;
        end;
    end;
  end;
...
const
  AlignHorzMap: array [TdxLayoutItemControlAlignHorz] of TAlignment =
    (taLeftJustify, taCenter, taRightJustify, taCenter);
  AlignVertMap: array [TdxLayoutItemControlAlignVert] of TdxAlignmentVert =
    (tavTop, tavCenter, tavBottom, tavCenter);
var
  ACaptionSize, AControlSize: TPoint;
  ACaptionVisible, AControlVisible: Boolean;
  AControlAreaBounds: TRect;
begin
  InitViewInfoBounds(CaptionViewInfo, FCaptionAreaBounds, ACaptionSize,
    ACaptionVisible);
  InitViewInfoBounds(ControlViewInfo, AControlAreaBounds, AControlSize,
    AControlVisible);

  if ACaptionVisible then
  begin
    CalculateWithFixedCaption(AControlAreaBounds, ACaptionSize, AControlSize);
    case CaptionLayout of
      clLeft, clRight:
        CalculateRestVert(FCaptionAreaBounds, ACaptionSize,
          Item.CaptionOptions.AlignVert);
      clTop, clBottom:
        CalculateRestHorz(FCaptionAreaBounds, ACaptionSize,
          Item.CaptionOptions.AlignHorz);
    end;
  end;
  if AControlVisible then
  begin
    if Item.ControlOptions.IsWidthUsual then
      CalculateRestHorz(AControlAreaBounds, AControlSize,
        AlignHorzMap[Item.ControlOptions.AlignHorz]);
    if Item.ControlOptions.IsHeightUsual then
      CalculateRestVert(AControlAreaBounds, AControlSize,
        AlignVertMap[Item.ControlOptions.AlignVert]);
  end;
  FCellAreaBounds := AControlAreaBounds;
end;

procedure TdxLayoutControlItemViewInfo.CalculateInternalViewInfos;
begin
  inherited;
  ControlViewInfo.Calculate(ControlAreaBounds);
end;
...
function TdxLayoutControlItemViewInfo.GetContentHeight(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
var
  AHeight: Integer;
begin
...
function TdxLayoutControlItemViewInfo.GetContentWidth(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
var
  AWidth: Integer;
begin
  ...
  case CaptionLayout of
    clLeft, clRight:
      begin
        if (Result <> 0) and CaptionViewInfo.Visible and
          ControlViewInfo.Visible { (AWidth <> 0) } then
          Inc(Result, ElementOffsetHorz);
        Inc(Result, AWidth);
      end;
    clTop, clBottom:
...
function TdxLayoutControlItemViewInfo.GetAutoControlAreaAlignment: Boolean;
  ...
  begin
    Result := (Item.AlignmentConstraint = nil) or
      (Item.AlignmentConstraint.Kind in [ackTop, ackBottom]) and
      (CaptionLayout in [clLeft, clRight]) or
      (Item.AlignmentConstraint.Kind in [ackLeft, ackRight]) and
      (CaptionLayout in [clTop, clBottom]);
  end;

begin
  Result := Item.ControlOptions.AutoControlAreaAlignment and HasCaption and
    HasControl and IsAlignmentAndCaptionLayoutLinked and
    IsConstraintAndCaptionLayoutLinked;
end;
...
procedure TdxLayoutControlItemViewInfo.CalculateInternalTabOrders
  (var AAvailableTabOrder: Integer);
begin
  ControlViewInfo.CalculateInternalTabOrder(AAvailableTabOrder);
end;

procedure TdxLayoutControlItemViewInfo.CalculateTabOrders(var AAvailableTabOrder
  : Integer);
begin
  ControlViewInfo.CalculateTabOrder(AAvailableTabOrder);
end;

procedure TdxLayoutControlItemViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited DoRightToLeftConversion(AClientBounds);
...
begin
  Result := not(Item.CanFocusControlOnCaptionClick and
    CaptionViewInfo.CanDoCaptionClick(X, Y));
end;

function TdxLayoutItemViewInfo.GetCaptionViewInfoClass
  : TdxCustomLayoutItemCaptionViewInfoClass;
begin
  Result := TdxLayoutItemCaptionViewInfo;
end;

function TdxLayoutItemViewInfo.GetControlViewInfoClass
  : TdxLayoutControlItemControlViewInfoClass;
begin
...
begin
  Result := TdxCustomLayoutItemPainterClass
    (LayoutLookAndFeel.GetItemPainterClass);
end;

procedure TdxLayoutItemViewInfo.PopulateControlViewInfoList(AControls,
  AWinControls: TList);
var
  AControlViewInfo: TdxLayoutItemControlViewInfo;
begin
...
procedure TdxLayoutItemViewInfo.SetItemHeight(AHeight: Integer;
  ADirectAccess: Boolean);
begin
...
procedure TdxLayoutItemViewInfo.SetItemWidth(AWidth: Integer;
  ADirectAccess: Boolean);
begin
  if ADirectAccess and HasControl then
...
procedure TdxLayoutItemViewInfo.CustomizationMouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);

  function NeedSelectControl: Boolean;
  begin
    Result := HasControl and ContainerViewInfo.Container.Customization and
      Item.IsDesignSelectorVisible and PtInDesignSelectorRect(Point(X, Y));
  end;
...
begin
  if FAvailableTextSizeCache.cy = 0 then
  begin
    PrepareCanvas(Canvas, False);
    FAvailableTextSizeCache := Canvas.TextExtent(dxMeasurePattern);
    Inc(FAvailableTextSizeCache.cx); // for disabling
    Inc(FAvailableTextSizeCache.cy); // for disabling
  end;
  Result := FAvailableTextSizeCache.cy;
end;

function TdxLayoutGroupCaptionViewInfo.GetAvailableHorzTextWidth: Integer;
begin
  if FAvailableTextSizeCache.cx = 0 then
  begin
    PrepareCanvas(Canvas, False);
    FAvailableTextSizeCache := Canvas.TextExtent(dxMeasurePattern);
    Inc(FAvailableTextSizeCache.cx); // for disabling
  ...
  Result := FAvailableTextSizeCache.cx;
end;
...
function TdxLayoutGroupCaptionViewInfo.CalculateTextFlags
  (AForDrawing: Boolean): Integer;
begin
...
begin
  ...
  if GroupViewInfo.Group.IsCheckBoxVisible and not IsCustomization and Enabled
  then
    State := State + [levsHot]
  else
    inherited;
...
procedure TdxLayoutGroupCaptionViewInfo.MouseMove(Shift: TShiftState;
  X: Integer; Y: Integer);
var
...
begin
  ...
  begin
    ...
    for I := 0 to AButtonsViewInfo.ButtonViewInfoCount - 1 do
      if AButtonsViewInfo.ButtonViewInfos[I].Button = AButtonsViewInfo.Options.CheckBox
      then
      begin
...
constructor TdxLayoutGroupViewInfoSpecific.Create(AGroupViewInfo
...
procedure TdxLayoutGroupViewInfoSpecific.Calculate
  (const AItemsAreaBounds: TRect);
begin
  CalculateItemsBounds(AItemsAreaBounds);
end;

procedure TdxLayoutGroupViewInfoSpecific.CorrectItemsAreaBounds
  (var AItemsAreaBounds: TRect);
begin
...
procedure TdxLayoutGroupViewInfoSpecific.CalculateItemsAreaBounds
  (var AItemsAreaBounds: TRect);
begin
  CorrectItemsAreaBounds(AItemsAreaBounds);
end;

procedure TdxLayoutGroupViewInfoSpecific.CalculateItemsBounds
  (AItemsAreaBounds: TRect);
  ...
  begin
    ...
    begin
      ...
      FItemInfos[I].OriginalMajorSize := GetItemOriginalMajorSize
        (FItemInfos[I].ViewInfo);
      ...
      FItemInfos[I].SufficientMajorSize := GetItemSufficientMajorSize
        (FItemInfos[I].ViewInfo);

      FItemInfos[I].MinorAlign := GetMinorAlign(FItemInfos[I].ViewInfo.Align);
      FItemInfos[I].OriginalMinorSize := GetItemOriginalMinorSize
        (FItemInfos[I].ViewInfo);
      FItemInfos[I].SufficientMinorSize := GetItemSufficientMinorSize
        (FItemInfos[I].ViewInfo);
    end;
  end;
...
procedure TdxLayoutGroupViewInfoSpecific.CalculateItemsMajorBounds
  (const AItemsAreaBounds: TdxAbsRect);
var
  ...
  begin
    ...
    if (AAvailableSpace < AContentSpace) and GroupViewInfo.AllowMajorScroll and
      GroupViewInfo.IsExpanded then
    begin
      ...
      for I := 0 to ItemViewInfoCount - 1 do
        ...
        begin
          FItemInfos[I].CalculatedMajorSize :=
            FItemInfos[I].SufficientMajorSize;
          if FItemInfos[I].MajorAlign <> aaCenter then
          begin
    ...
    begin
      repeat
        ...
        for I := 0 to ItemViewInfoCount - 1 do
          ...
          begin
            FItemInfos[I].CalculatedMajorSize :=
              MulDiv(AAvailableSpace,
              AOffset + FItemInfos[I].SufficientMajorSize, AUsualSpace) -
              MulDiv(AAvailableSpace, AOffset, AUsualSpace);

            if (FItemInfos[I].CalculatedMajorSize < FItemInfos[I].MinMajorSize)
              or (FItemInfos[I].CalculatedMajorSize > FItemInfos[I].MaxMajorSize)
            then
            begin
              if FItemInfos[I].CalculatedMajorSize < FItemInfos[I].MinMajorSize
              then
  ...
  procedure InternalCalculateItemsBounds;
        ...
        case FItemInfos[I].MajorAlign of
          aaNear, aaClient:
            begin
              ...
              FItemInfos[I].AbsBounds.FarMajor := AOffset + FItemInfos[I]
                .CalculatedMajorSize;
              Inc(AOffset, FItemInfos[I].CalculatedMajorSize + ItemOffset);
            end;
          aaCenter:
            begin
              FItemInfos[I].AbsBounds.NearMajor :=
                (AItemsAreaBounds.NearMajor + AItemsAreaBounds.FarMajor -
                FItemInfos[I].CalculatedMajorSize) div 2;
              FItemInfos[I].AbsBounds.FarMajor :=
                FItemInfos[I].AbsBounds.NearMajor + FItemInfos[I]
                .CalculatedMajorSize;
            end;
        end;
    end;
    ...
    begin
      if GroupViewInfo.FMajorScrollBar <> nil then
        AOffset := AItemsAreaBounds.NearMajor + ANecessarySpace -
          GroupViewInfo.GetScrollPos.Major
      else
      ...
      for I := ItemViewInfoCount - 1 downto 0 do
        ...
        begin
          ...
          FItemInfos[I].AbsBounds.NearMajor := AOffset - FItemInfos[I]
            .CalculatedMajorSize;
...
procedure TdxLayoutGroupViewInfoSpecific.CalculateItemsMinorBounds
  (const AItemsAreaBounds: TdxAbsRect);
var
  I: Integer;
...
begin
  ...
  begin
    ...
    case FItemInfos[I].MinorAlign of
      aaNear:
        begin
          R.NearMinor := AItemsAreaBounds.NearMinor -
            GroupViewInfo.GetScrollPos.Minor;
          R.FarMinor := R.NearMinor + AMinorSize;
        end;
      aaCenter:
        begin
          R.NearMinor := (AItemsAreaBounds.NearMinor + AItemsAreaBounds.FarMinor
            - AMinorSize) div 2;
          R.FarMinor := R.NearMinor + AMinorSize;
        end;
      aaFar:
      ...
      aaClient:
        if not GroupViewInfo.AllowMinorScroll or
          (AMinorSize < AItemsAreaBounds.Size.Minor) then
        begin
          R.NearMinor := AItemsAreaBounds.NearMinor;
          R.FarMinor := AItemsAreaBounds.FarMinor;
        end
  ...
  if (AMaxMinorSize > AItemsAreaBounds.Size.Minor) and
    GroupViewInfo.AllowMinorScroll and GroupViewInfo.IsExpanded then
  begin
    ...
    GroupViewInfo.InitializeMinorScrollBar(AMaxMinorSize,
      AItemsAreaBounds.Size.Minor);
  end
  else
  begin
    if GroupViewInfo.FMinorScrollBar <> nil then
...
procedure TdxLayoutGroupViewInfoSpecific.CalculateInternalTabOrders
  (var ATabOrder: Integer);
begin
  // do nothing
end;
...
begin
  ...
  begin
    ...
    GroupViewInfo.ContainerViewInfo.FNeedRecalculate :=
      GroupViewInfo.ContainerViewInfo.FNeedRecalculate or
      AViewInfo.ViewInfo.IsWordWrapAllowed and
      not cxRectCompare(AViewInfo.PrevBounds, AViewInfo.ViewInfo.Bounds);
  end;
end;
...
function TdxLayoutGroupViewInfoSpecific.GetItemViewInfo(Index: Integer)
  : TdxCustomLayoutItemViewInfo;
begin
...
procedure TdxLayoutGroupViewInfoSpecific.InitializeMajorScrollBar(AContentSize,
  AClientSize: Integer);
begin
  // do nothing
end;

procedure TdxLayoutGroupViewInfoSpecific.InitializeMinorScrollBar(AContentSize,
  AClientSize: Integer);
begin
  // do nothing
end;
...
procedure TdxLayoutGroupViewInfoSpecific.AssignBounds
  (ASource: TdxLayoutGroupViewInfoSpecific);
begin
  if CanAssignBounds(ASource) then
    DoAssignBounds(ASource);
end;

function TdxLayoutGroupViewInfoSpecific.CanAssignBounds
  (ASource: TdxLayoutGroupViewInfoSpecific): Boolean;
begin
  Result := ASource is ClassType;
end;

procedure TdxLayoutGroupViewInfoSpecific.DoAssignBounds
  (ASource: TdxLayoutGroupViewInfoSpecific);
begin
...
procedure TdxLayoutGroupViewInfoSpecific.KeyDown(var Key: Word;
  Shift: TShiftState);
begin
  // do nothing
end;
...
function TdxLayoutGroupViewInfoSpecific.GetAbsPoint(const P: TPoint)
  : TdxAbsPoint;
begin
...
function TdxLayoutGroupViewInfoSpecific.GetAbsSize(const ASize: TSize)
  : TdxAbsSize;
begin
...
function TdxLayoutGroupViewInfoSpecific.GetRectFromAbsRect
  (const R: TdxAbsRect): TRect;
begin
...
function TdxLayoutGroupViewInfoSpecific.GetMajorValue
  (const ASize: TSize): Integer;
begin
  Result := ASize.cx;
end;

function TdxLayoutGroupViewInfoSpecific.GetMinorValue
  (const ASize: TSize): Integer;
begin
  Result := ASize.cy;
end;

function TdxLayoutGroupViewInfoSpecific.GetMajorAlign
  (const AAlign: TdxLayoutRealAlign): TdxLayoutAlignAbs;
begin
  Result := TdxLayoutAlignAbs(AAlign.Horz);
end;

function TdxLayoutGroupViewInfoSpecific.GetMinorAlign
  (const AAlign: TdxLayoutRealAlign): TdxLayoutAlignAbs;
begin
  Result := TdxLayoutAlignAbs(AAlign.Vert);
end;

procedure TdxLayoutGroupViewInfoSpecific.SetMajorNear(var R: TRect;
  AValue: Integer);
begin
  R.Left := AValue;
end;

procedure TdxLayoutGroupViewInfoSpecific.SetMajorFar(var R: TRect;
  AValue: Integer);
begin
  R.Right := AValue;
end;

procedure TdxLayoutGroupViewInfoSpecific.SetMajorAlign
  (var AAlign: TdxLayoutRealAlign; AValue: TdxLayoutAlignAbs);
begin
  AAlign.Horz := TdxLayoutRealAlignHorz(AValue);
end;

procedure TdxLayoutGroupViewInfoSpecific.SetMinorAlign
  (var AAlign: TdxLayoutRealAlign; AValue: TdxLayoutAlignAbs);
begin
  AAlign.Vert := TdxLayoutRealAlignVert(AValue);
end;

procedure TdxLayoutGroupViewInfoSpecific.CorrectMajorAlignForLocale
  (var AAlign: TdxLayoutRealAlign);
begin
  AAlign.Horz := GroupViewInfo.GetDropHorzAlignForLocale(AAlign.Horz);
end;

procedure TdxLayoutGroupViewInfoSpecific.CorrectMinorAlignForLocale
  (var AAlign: TdxLayoutRealAlign);
begin
  // do nothing
end;
...
procedure TdxLayoutGroupViewInfoSpecific.DrawSpecificControls
  (ACanvas: TcxCanvas);
begin
  // do nothing
end;

function TdxLayoutGroupViewInfoSpecific.GetMaxItemsMajorSize
  (AIsMinWidth: Boolean): Integer;
var
  I: Integer;
begin
  Result := 0;
...
function TdxLayoutGroupViewInfoSpecific.GetMaxItemsMinorSize
  (AIsMinSize: Boolean): Integer;
var
  I: Integer;
begin
  Result := 0;
...
function TdxLayoutGroupViewInfoSpecific.GetMinorSize(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
begin
  if not GroupViewInfo.ContainerViewInfo.FIsOccupiedSizeCalculating and
    GroupViewInfo.AllowMinorScroll and (ACalcSizeType in [cstMin, cstOriginal])
  then
...
function TdxLayoutGroupViewInfoSpecific.GetMajorSize(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
var
  AIsFirstItem: Boolean;
  I: Integer;
...
begin
  if not GroupViewInfo.ContainerViewInfo.FIsOccupiedSizeCalculating and
    GroupViewInfo.AllowMajorScroll and (ACalcSizeType in [cstMin, cstOriginal])
  then
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        else if GetMajorAlign(AItemViewInfo.Align) = aaClient then
          Inc(Result, Max(GetItemMinMajorSize(AItemViewInfo),
            GetItemOriginalMajorSize(AItemViewInfo)))
        else
...
procedure TdxLayoutGroupViewInfoSpecific.CorrectDropAreaPart(const P: TPoint;
  var AAreaPart: TdxLayoutDropAreaPart);
begin
  // do nothing
end;

function TdxLayoutGroupViewInfoSpecific.GetDropExactItem(const P: TPoint)
  : TdxCustomLayoutItem;
var
  I: Integer;
begin
...
function TdxLayoutGroupViewInfoSpecific.GetDropNearestItem(const P: TPoint)
  : TdxCustomLayoutItem;
var
  I: Integer;
  R: TRect;
...
begin
  ...
  begin
    ...
    begin
      ADistance := Min(Abs(GetMajorValue(R.TopLeft) - GetMajorValue(P)),
        Abs(GetMajorValue(R.BottomRight) - GetMajorValue(P)));
...
procedure TdxLayoutGroupViewInfoSpecific.MakeVisible(const ARect: TRect;
  AFully: Boolean);
var
  ANewScrollPos: Integer;
begin
  ANewScrollPos := GetNewScrollPosMajor(ARect, AFully,
    GroupViewInfo.GetScrollPos.Major);
  GroupViewInfo.DoMajorScroll(nil, scPosition, ANewScrollPos);

  ANewScrollPos := GetNewScrollPosMinor(ARect, AFully,
    GroupViewInfo.GetScrollPos.Minor);
  GroupViewInfo.DoMinorScroll(nil, scPosition, ANewScrollPos);
end;

function TdxLayoutGroupViewInfoSpecific.GetNewScrollPosMajor(const ARect: TRect;
  AFully: Boolean; AScrollPos: Integer): Integer;
var
...
begin
  ...
  begin
    ...
    else if AAbsRect.FarMajor > AAbsItemsAreaBounds.FarMajor then
      AOffset := Min(AAbsRect.FarMajor - AAbsItemsAreaBounds.FarMajor,
        AAbsRect.NearMajor - AAbsItemsAreaBounds.NearMajor);
  end
  else if AAbsRect.NearMajor > AAbsItemsAreaBounds.FarMajor then
...
function TdxLayoutGroupViewInfoSpecific.GetNewScrollPosMinor(const ARect: TRect;
  AFully: Boolean; AScrollPos: Integer): Integer;
var
  AAbsRect, AAbsItemsAreaBounds: TdxAbsRect;
  AOffset: Integer;
begin
  ...
  begin
    ...
    else if AAbsRect.FarMinor > AAbsItemsAreaBounds.FarMinor then
      AOffset := Min(AAbsRect.FarMinor - AAbsItemsAreaBounds.FarMinor,
        AAbsRect.NearMinor - AAbsItemsAreaBounds.NearMinor);
  end
  else if AAbsRect.NearMinor > AAbsItemsAreaBounds.FarMinor then
    AOffset := AAbsRect.FarMinor - AAbsItemsAreaBounds.FarMinor
  else if AAbsRect.FarMinor < AAbsItemsAreaBounds.NearMinor then
    AOffset := AAbsRect.NearMinor - AAbsItemsAreaBounds.NearMinor;
  if GroupViewInfo.UseRightToLeftAlignment then
    AOffset := -AOffset;
  Result := Result + AOffset;
...
function TdxLayoutGroupViewInfoSpecific.GetDropExactItemInRow(const P: TPoint)
  : TdxCustomLayoutItem;
var
  I: Integer;
  AItem: TdxCustomLayoutItem;
...
function TdxLayoutGroupViewInfoSpecific.GetDropAlignOutsideArea
  (const ADefaultAlign: TdxLayoutRealAlign; const ABounds: TRect;
  const ADropAreaInfo: TdxLayoutDragDropInfo): TdxLayoutRealAlign;
var
  ACenter: TRect;
begin
  ...
  if (Result.Horz = ahClient) or (LayoutDirection = ldHorizontal) and
    (ADropAreaInfo.DropAreaPart in [apTop, apBottom]) then
  begin
    if (ADropAreaInfo.DropClientPoint.X < ACenter.Left)
    { or (ADropAreaInfo.DropClientPoint.X > ACenter.Right) and (LayoutDirection = ldHorizontal) }
    then
      Result.Horz := ahLeft
    else if ADropAreaInfo.DropClientPoint.X > ACenter.Right then
      Result.Horz := ahRight
    else
  ...
  begin
    if (ADropAreaInfo.DropClientPoint.Y < ACenter.Top) or
      (ADropAreaInfo.DropClientPoint.Y > ACenter.Bottom) and
      (LayoutDirection = ldVertical) then
      Result.Vert := avTop
    else if ADropAreaInfo.DropClientPoint.Y > ACenter.Bottom then
...
function TdxLayoutGroupViewInfoSpecific.GetDropAlignOutsideItem
  (const ADropAreaInfo: TdxLayoutDragDropInfo): TdxLayoutRealAlign;
var
  AItemBounds: TRect;
...
begin
  if ADropAreaInfo.DestinationItem.IsRoot then
    AItemBounds := ADropAreaInfo.DestinationItem.AsGroup.ViewInfo.
      ItemsAreaBounds
  else
  ...
  // Proper Align
  if IsDropPositionHasProperAlign(ADropAreaInfo) and
  ...
  begin
    ...
    else if GetMajorValue(ADropAreaInfo.DropClientPoint) > AAbsCenter.FarMajor
    then
    begin
  ...
  else if (GetMajorAlign(ADropAreaInfo.DestinationItem.RealAlign) = aaClient)
    and (AAbsItemBounds.Size.Major > dxLayoutItemControlDefaultMinSize) and
    (dxIsValueInDiapason(GetMajorValue(ADropAreaInfo.DropClientPoint),
    AAbsCenter.NearMajor, AAbsCenter.FarMajor)) then
    SetMajorAlign(Result, aaClient)
  else if GetMajorAlign(ADropAreaInfo.DestinationItem.RealAlign) <> aaClient
  then
    SetMajorAlign(Result,
      GetMajorAlign(ADropAreaInfo.DestinationItem.RealAlign))
  else
    SetMajorAlign(Result, aaNear);

  // Opposite Align
  if IsDropPositionHasOppositeAlign(ADropAreaInfo) and
    (GetAbsRect(GroupViewInfo.ItemsAreaBounds)
    .Size.Minor = AAbsItemBounds.Size.Minor) then
  begin
    ...
    else if GetMinorValue(ADropAreaInfo.DropClientPoint) > AAbsCenter.FarMinor
    then
    begin
  ...
  else if (GetMinorAlign(ADropAreaInfo.DestinationItem.RealAlign) = aaClient)
    and (AAbsItemBounds.Size.Minor > dxLayoutItemControlDefaultMinSize) and
    dxIsValueInDiapason(GetMinorValue(ADropAreaInfo.DropClientPoint),
    AAbsCenter.NearMinor, AAbsCenter.FarMinor) then
    SetMinorAlign(Result, aaClient)
  else if GetMinorAlign(ADropAreaInfo.DestinationItem.RealAlign) <> aaClient
  then
    SetMinorAlign(Result,
      GetMinorAlign(ADropAreaInfo.DestinationItem.RealAlign))
  else
    SetMinorAlign(Result, aaNear);
end;
...
function TdxLayoutGroupViewInfoSpecific.GetDropAlignInsideArea
  (const ADefaultAlign: TdxLayoutRealAlign; const ABounds: TRect;
  const ADropAreaInfo: TdxLayoutDragDropInfo): TdxLayoutRealAlign;
var
  ACenter: TRect;
begin
  ...
  if cxRectWidth(ABounds) < ADropAreaInfo.SourceItemSize.cx then
    Result.Horz := ADefaultAlign.Horz
  else if ADropAreaInfo.DropClientPoint.X < ACenter.Left then
  ...
  if cxRectHeight(ABounds) < ADropAreaInfo.SourceItemSize.cy then
    Result.Vert := ADefaultAlign.Vert
  else if ADropAreaInfo.DropClientPoint.Y < ACenter.Top then
    Result.Vert := avTop
  else if ADropAreaInfo.DropClientPoint.Y > ACenter.Bottom then
    Result.Vert := avBottom
  else
...
function TdxLayoutGroupViewInfoSpecific.GetDropAreaPart(var P: TPoint)
  : TdxLayoutDropAreaPart;
...
begin
  ...
  begin
    if PtInRect(GetLastChildDropArea, P) then
      Result := apLastChild
    else if GetDropExactItemInRow(P) <> nil then
      Result := apNewLayout
    else
      Result := apBetween;
  end
...
function TdxLayoutGroupViewInfoSpecific.GetDropExpectedBounds
  (const ADropAreaInfo: TdxLayoutDragDropInfo): TRect;
var
  R: TRect;
begin
  case ADropAreaInfo.DropAreaPart of
    ...
    apBetween:
      Result := GetDropRectInsideRect
        (GetBetweenItemsDropArea(ADropAreaInfo.DropClientPoint), ADropAreaInfo);
    apNewLayout:
      begin
        R := GetNewLayoutDropArea(ADropAreaInfo.DestinationItem);
        if GetMajorValue(ADropAreaInfo.SourceItemSize) > GetAbsRect(R).Size.Major
        then
...
function TdxLayoutGroupViewInfoSpecific.GetDropExpectedAlign(const ADropAreaInfo
  : TdxLayoutDragDropInfo): TdxLayoutRealAlign;
var
  AItem: TdxCustomLayoutItem;
begin
  ...
  case ADropAreaInfo.DropAreaPart of
    ...
    apBetween:
      Result := GetDropAlignOutsideArea(AItem.RealAlign, AItem.ViewInfo.Bounds,
        ADropAreaInfo);
    apLastChild:
      Result := GetDropAlignInsideArea(Result, GetLastChildDropArea,
        ADropAreaInfo);
    apNewLayout:
      Result := GetDropAlignInsideArea(AItem.RealAlign,
        GetNewLayoutDropArea(AItem), ADropAreaInfo);
  end;
end;

function TdxLayoutGroupViewInfoSpecific.GetDropRectOutsideItem
  (const ADropAreaInfo: TdxLayoutDragDropInfo): TRect;
var
...
begin
  ...
  if (ADropAreaInfo.ExpectedAlign.Horz = ahClient) and
    (ADropAreaInfo.DropAreaPart in [apLeft, apRight]) or
    (ADropAreaInfo.ExpectedAlign.Vert = avClient) and
    (ADropAreaInfo.DropAreaPart in [apTop, apBottom]) then
  begin
  ...
  begin
    if ADropAreaInfo.DestinationItem.IsRoot or
      (ADropAreaInfo.DropAreaPart in [apLeft, apRight]) and
      (LayoutDirection = ldHorizontal) or
      (ADropAreaInfo.DropAreaPart in [apTop, apBottom]) and
      (LayoutDirection = ldVertical) then
    ...
    case ADropAreaInfo.DropAreaPart of
      apLeft:
        AWorkRect.Right := Max(AItemBounds.Left, AItemExtendedBounds.Left +
          AMinSize);
      apRight:
        AWorkRect.Left := Min(AItemBounds.Right, AItemExtendedBounds.Right -
          AMinSize);
      apTop:
        AWorkRect.Bottom := Max(AItemBounds.Top, AItemExtendedBounds.Top +
          AMinSize);
      apBottom:
        AWorkRect.Top := Min(AItemBounds.Bottom, AItemExtendedBounds.Bottom -
          AMinSize);
    end;
  end;
...
function TdxLayoutGroupViewInfoSpecific.GetDropRectInsideRect
  (const ARect: TRect; const ADropAreaInfo: TdxLayoutDragDropInfo): TRect;

  function GetRectVertPart(const ARect: TRect;
    const ADropAreaInfo: TdxLayoutDragDropInfo): TRect;
  var
    AHeight: Integer;
  begin
    AHeight := Max(Min(cxRectHeight(ARect), ADropAreaInfo.SourceItemSize.cy),
      ADropAreaInfo.DropPartSize * 2);

    case ADropAreaInfo.ExpectedAlign.Vert of
      avTop:
        Result := Rect(ARect.Left, ARect.Top, ARect.Right, ARect.Top + AHeight);
      avBottom:
        Result := Rect(ARect.Left, ARect.Bottom - AHeight, ARect.Right,
          ARect.Bottom);
    else
      Result := ARect;
    end;
  ...
  function GetRectHorzPart(const ARect: TRect;
    const ADropAreaInfo: TdxLayoutDragDropInfo): TRect;
  var
    AWidth: Integer;
  begin
    AWidth := Max(Min(cxRectWidth(ARect), ADropAreaInfo.SourceItemSize.cx),
      ADropAreaInfo.DropPartSize * 2);
    case GroupViewInfo.GetDropHorzAlignForLocale
      (ADropAreaInfo.ExpectedAlign.Horz) of
      ahLeft:
        Result := Rect(ARect.Left, ARect.Top, ARect.Left + AWidth,
          ARect.Bottom);
      ahRight:
        Result := Rect(ARect.Right - AWidth, ARect.Top, ARect.Right,
          ARect.Bottom);
    else
      Result := ARect;
    end;
...
begin
  Result := GetRectHorzPart(GetRectVertPart(ARect, ADropAreaInfo),
    ADropAreaInfo);
end;

function TdxLayoutGroupViewInfoSpecific.IsDropPositionHasProperAlign
  (const ADropAreaInfo: TdxLayoutDragDropInfo): Boolean;
begin
  Result := ADropAreaInfo.DropAreaPart in [apTop, apBottom];
end;

function TdxLayoutGroupViewInfoSpecific.IsDropPositionHasOppositeAlign
  (const ADropAreaInfo: TdxLayoutDragDropInfo): Boolean;
begin
  Result := ADropAreaInfo.DropAreaPart in [apLeft, apRight];
end;

function TdxLayoutGroupViewInfoSpecific.GetDropNearestPoint
  (const P: TPoint): TPoint;
begin
  Result.X := Max(Min(P.X, GroupViewInfo.ItemsAreaBounds.Right - 1),
    GroupViewInfo.ItemsAreaBounds.Left + 1);
  Result.Y := Max(Min(P.Y, GroupViewInfo.ItemsAreaBounds.Bottom - 1),
    GroupViewInfo.ItemsAreaBounds.Top + 1);
end;

function TdxLayoutGroupViewInfoSpecific.GetBetweenItemsDropArea
...
begin
  ...
  begin
    ...
    if GetMajorValue(P) < GetMajorValue(R.TopLeft) then
      SetMajorFar(Result, Min(GetMajorValue(Result.BottomRight),
        GetMajorValue(R.TopLeft)));
    if GetMajorValue(P) >= GetMajorValue(R.BottomRight) then
      SetMajorNear(Result, Max(GetMajorValue(Result.TopLeft),
        GetMajorValue(R.BottomRight)));
  end;
end;
...
begin
  ...
  begin
    W := Min(Result.Left - GroupViewInfo.Bounds.Left, GroupViewInfo.Bounds.Right
      - Result.Right) div 2;
    Result := Rect(Result.Left - W, Result.Top, Result.Right + W, Result.Bottom)
  end;
  if cxRectHeight(Result) = 0 then
  begin
    H := Min(Result.Top - GroupViewInfo.Bounds.Top, GroupViewInfo.Bounds.Bottom
      - Result.Bottom) div 2;
    Result := Rect(Result.Left, Result.Top - H, Result.Right,
      Result.Bottom + H);
  end;
end;

function TdxLayoutGroupViewInfoSpecific.GetNewLayoutDropArea
  (AItem: TdxCustomLayoutItem): TRect;
begin
  Result := CutItemRect(AItem, GetItemEnlargedBounds(AItem));
end;

function TdxLayoutGroupViewInfoSpecific.GetNewLayoutExtendedDropArea
  (AItem: TdxCustomLayoutItem): TRect;
begin
  Result := CutItemRect(AItem, GetItemExtendedBounds(AItem));
end;

function TdxLayoutGroupViewInfoSpecific.GetItemEnlargedBounds
  (AItem: TdxCustomLayoutItem): TRect;
var
...
function TdxLayoutGroupViewInfoSpecific.GetItemExtendedBounds
  (AItem: TdxCustomLayoutItem): TRect;
var
  I: Integer;
  AItemBounds: TRect;
begin
  ...
  begin
    ...
    begin
      if GetMajorValue(GroupViewInfo.ItemViewInfos[I].Bounds.BottomRight) <=
        GetMajorValue(AItemBounds.TopLeft) then
        SetMajorNear(Result, Max(GetMajorValue(Result.TopLeft),
          GetMajorValue(GroupViewInfo.ItemViewInfos[I].Bounds.BottomRight)));
      if GetMajorValue(GroupViewInfo.ItemViewInfos[I].Bounds.TopLeft) >=
        GetMajorValue(AItemBounds.BottomRight) then
        SetMajorFar(Result, Min(GetMajorValue(Result.BottomRight),
          GetMajorValue(GroupViewInfo.ItemViewInfos[I].Bounds.TopLeft)));
    end;
  end;
end;

function TdxLayoutGroupViewInfoSpecific.GetItemsAreaOffset
  (ASide: TdxLayoutSide): Integer;
begin
  Result := 0;
end;

function TdxLayoutGroupViewInfoSpecific.IsItemMajorSizeUsual
  (AViewInfo: TdxCustomLayoutItemViewInfo): Boolean;
begin
  Result := (GetMajorAlign(AViewInfo.Align) <> aaClient) or
    not AViewInfo.IsExpanded;
end;

function TdxLayoutGroupViewInfoSpecific.IsItemMinorSizeUsual
  (AViewInfo: TdxCustomLayoutItemViewInfo): Boolean;
begin
  Result := (GetMinorAlign(AViewInfo.Align) <> aaClient) or
    not AViewInfo.IsExpanded;
end;
...
function TdxLayoutGroupViewInfoSpecific.GetItemsAreaHeight
  (ACalcSizeType: TdxLayoutCalcSizeType): Integer;
begin
  Result := GetMinorSize(ACalcSizeType);
end;

function TdxLayoutGroupViewInfoSpecific.GetItemsAreaWidth
  (ACalcSizeType: TdxLayoutCalcSizeType): Integer;
begin
  Result := GetMajorSize(ACalcSizeType);
end;

function TdxLayoutGroupViewInfoSpecific.AllowDrawChild(AChildViewInfo
  : TdxCustomLayoutItemViewInfo): Boolean;
begin
  Result := True;
end;
...
procedure TdxLayoutGroupViewInfoSpecific.DoRightToLeftConversion
  (const AClientBounds: TRect);
var
  I: Integer;
begin
...
function TdxLayoutGroupViewInfoSpecific.GetChildInplaceRenameBounds
  (AChildViewInfo: TdxCustomLayoutItemViewInfo): TRect;
begin
  Result := cxNullRect;
end;

function TdxLayoutGroupViewInfoSpecific.GetDefaultItemControlAreaAlignment
...
function TdxLayoutGroupViewInfoSpecific.ProcessDialogChar
  (ACharCode: Word): Boolean;
begin
  Result := False;
end;

function TdxLayoutGroupViewInfoSpecific.ProcessDialogKey(ACharCode: Word;
  AKeyData: Integer; AFocusedItem: TdxCustomLayoutItem): Boolean;
begin
  Result := False;
end;
...
procedure TdxLayoutGroupViewInfoHorizontalSpecific.CalculateItemsBounds
  (AItemsAreaBounds: TRect);
  ...
  begin
    for AViewInfo in FItemInfos do
      AViewInfo.ViewInfo.FBounds := GetRectFromAbsRect(AViewInfo.AbsBounds);
  end;
...
begin
  ...
  begin
    ...
    if FItemInfos[I].ViewInfo.Item.Width > 0 then
      FItemInfos[I].ViewInfo.FBounds := cxNullRect
    else
      FItemInfos[I].ViewInfo.FBounds :=
        Rect(FItemInfos[I].ViewInfo.FBounds.Left, 0,
        FItemInfos[I].ViewInfo.FBounds.Right, 0);
  end;
...
procedure TdxLayoutGroupViewInfoHorizontalSpecific.InitializeMajorScrollBar
  (AContentSize, AClientSize: Integer);
var
  R: TRect;
  AScrollBarSize: Size;
begin
  ...
  if not IsTouchScrollUIMode then
    R.Top := R.Top + GroupViewInfo.LayoutLookAndFeel.GetGroupBorderOffset
      (GroupViewInfo.Item.Container, sdBottom, GroupViewInfo.CaptionSide);
  R.Bottom := R.Top + AScrollBarSize.cy;
  GroupViewInfo.FMajorScrollBarBounds := R;
end;

procedure TdxLayoutGroupViewInfoHorizontalSpecific.InitializeMinorScrollBar
  (AContentSize, AClientSize: Integer);
var
  R: TRect;
  AScrollBarSize: Size;
begin
  ...
  if not IsTouchScrollUIMode then
    R.Left := R.Left + GroupViewInfo.LayoutLookAndFeel.GetGroupBorderOffset
      (GroupViewInfo.Item.Container, sdRight, GroupViewInfo.CaptionSide);
  R.Right := R.Left + AScrollBarSize.cx;
  GroupViewInfo.FMinorScrollBarBounds := R;
end;

function TdxLayoutGroupViewInfoHorizontalSpecific.CutItemRect
  (AItem: TdxCustomLayoutItem; const R: TRect): TRect;
begin
...
begin
  ...
  begin
    case GroupViewInfo.GetDropHorzAlignForLocale
      (GroupViewInfo.ItemViewInfos[I].Item.GetRealAlignHorz) of
      ahLeft:
        Result.Left := Max(GroupViewInfo.ItemViewInfos[I].Bounds.Right,
          Result.Left);
      ahRight:
        Result.Right := Min(GroupViewInfo.ItemViewInfos[I].Bounds.Left,
          Result.Right);
    end;
  end;
end;

function TdxLayoutGroupViewInfoHorizontalSpecific.GetDropActionType
  (AAreaPart: TdxLayoutDropAreaPart): TdxLayoutActionType;
begin
...
function TdxLayoutGroupViewInfoHorizontalSpecific.GetItemOriginalMajorSize
  (AViewInfo: TdxCustomLayoutItemViewInfo): Integer;
begin
  Result := AViewInfo.UsualWidth;
end;

function TdxLayoutGroupViewInfoHorizontalSpecific.GetItemOriginalMinorSize
  (AViewInfo: TdxCustomLayoutItemViewInfo): Integer;
begin
  Result := AViewInfo.UsualHeight;
end;

function TdxLayoutGroupViewInfoHorizontalSpecific.GetItemSufficientMinorSize
  (AViewInfo: TdxCustomLayoutItemViewInfo): Integer;
begin
  Result := AViewInfo.SufficientHeight;
end;

function TdxLayoutGroupViewInfoHorizontalSpecific.GetItemSufficientMajorSize
  (AViewInfo: TdxCustomLayoutItemViewInfo): Integer;
begin
  Result := AViewInfo.SufficientWidth;
end;

function TdxLayoutGroupViewInfoHorizontalSpecific.GetItemMinMinorSize
  (AViewInfo: TdxCustomLayoutItemViewInfo): Integer;
begin
  Result := AViewInfo.MinHeight;
end;

function TdxLayoutGroupViewInfoHorizontalSpecific.GetItemMinMajorSize
  (AViewInfo: TdxCustomLayoutItemViewInfo): Integer;
begin
  Result := AViewInfo.MinWidth;
end;

function TdxLayoutGroupViewInfoHorizontalSpecific.GetItemMaxMinorSize
  (AViewInfo: TdxCustomLayoutItemViewInfo): Integer;
begin
  Result := AViewInfo.MaxHeight;
end;

function TdxLayoutGroupViewInfoHorizontalSpecific.GetItemMaxMajorSize
  (AViewInfo: TdxCustomLayoutItemViewInfo): Integer;
begin
  Result := AViewInfo.MaxWidth;
end;

function TdxLayoutGroupViewInfoHorizontalSpecific.GetItemsAreaOffset
  (ASide: TdxLayoutSide): Integer;
begin
  Result := 0;
  ...
  begin
    ...
    begin
      ...
      Inc(Result, GroupViewInfo.LayoutLookAndFeel.GetGroupBorderOffset
        (Container, sdBottom, GroupViewInfo.CaptionSide));
    end;
  end;
  ...
  begin
    ...
    begin
      ...
      Inc(Result, GroupViewInfo.LayoutLookAndFeel.GetGroupBorderOffset
        (Container, sdRight, GroupViewInfo.CaptionSide));
    end
  end;
end;
...
function TdxLayoutGroupViewInfoHorizontalSpecific.IsAtInsertionPos
...
procedure TdxLayoutGroupViewInfoVerticalSpecific.InitializeMajorScrollBar
  (AContentSize, AClientSize: Integer);
var
  R: TRect;
  AScrollBarSize: Size;
...
procedure TdxLayoutGroupViewInfoVerticalSpecific.InitializeMinorScrollBar
  (AContentSize, AClientSize: Integer);
var
  R: TRect;
  AScrollBarSize: Size;
...
function TdxLayoutGroupViewInfoVerticalSpecific.GetRectFromAbsRect
  (const R: TdxAbsRect): TRect;
begin
  Result := Rect(R.NearMinor, R.NearMajor, R.FarMinor, R.FarMajor);
end;

function TdxLayoutGroupViewInfoVerticalSpecific.GetMajorValue
  (const P: TPoint): Integer;
begin
  Result := P.Y
end;

function TdxLayoutGroupViewInfoVerticalSpecific.GetMinorValue
  (const P: TPoint): Integer;
begin
  Result := P.X
end;
...
function TdxLayoutGroupViewInfoVerticalSpecific.GetMajorAlign
  (const AAlign: TdxLayoutRealAlign): TdxLayoutAlignAbs;
begin
  Result := TdxLayoutAlignAbs(AAlign.Vert);
end;

function TdxLayoutGroupViewInfoVerticalSpecific.GetMinorAlign
  (const AAlign: TdxLayoutRealAlign): TdxLayoutAlignAbs;
begin
  Result := TdxLayoutAlignAbs(AAlign.Horz);
end;

procedure TdxLayoutGroupViewInfoVerticalSpecific.SetMajorNear(var R: TRect;
  AValue: Integer);
begin
  R.Top := AValue;
end;

procedure TdxLayoutGroupViewInfoVerticalSpecific.SetMajorFar(var R: TRect;
  AValue: Integer);
begin
  R.Bottom := AValue;
end;

procedure TdxLayoutGroupViewInfoVerticalSpecific.SetMajorAlign
  (var AAlign: TdxLayoutRealAlign; AValue: TdxLayoutAlignAbs);
begin
  AAlign.Vert := TdxLayoutRealAlignVert(AValue);
end;

procedure TdxLayoutGroupViewInfoVerticalSpecific.SetMinorAlign
  (var AAlign: TdxLayoutRealAlign; AValue: TdxLayoutAlignAbs);
begin
  AAlign.Horz := TdxLayoutRealAlignHorz(AValue);
end;

procedure TdxLayoutGroupViewInfoVerticalSpecific.CorrectMajorAlignForLocale
  (var AAlign: TdxLayoutRealAlign);
begin
  // do nothing
end;

procedure TdxLayoutGroupViewInfoVerticalSpecific.CorrectMinorAlignForLocale
  (var AAlign: TdxLayoutRealAlign);
begin
  AAlign.Horz := GroupViewInfo.GetDropHorzAlignForLocale(AAlign.Horz);
end;

function TdxLayoutGroupViewInfoVerticalSpecific.CutItemRect
  (AItem: TdxCustomLayoutItem; const R: TRect): TRect;
begin
...
begin
  ...
  begin
    if GroupViewInfo.ItemViewInfos[I].Item.GetRealAlignVert = avTop then
      Result.Top := Max(GroupViewInfo.ItemViewInfos[I].Bounds.Bottom,
        Result.Top);
    if GroupViewInfo.ItemViewInfos[I].Item.GetRealAlignVert = avBottom then
      Result.Bottom := Min(GroupViewInfo.ItemViewInfos[I].Bounds.Top,
        Result.Bottom);
  end;
end;

function TdxLayoutGroupViewInfoVerticalSpecific.GetDropActionType
  (AAreaPart: TdxLayoutDropAreaPart): TdxLayoutActionType;
begin
...
function TdxLayoutGroupViewInfoVerticalSpecific.IsDropPositionHasProperAlign
  (const ADropAreaInfo: TdxLayoutDragDropInfo): Boolean;
begin
  Result := ADropAreaInfo.DropAreaPart in [apLeft, apRight];
end;

function TdxLayoutGroupViewInfoVerticalSpecific.IsDropPositionHasOppositeAlign
  (const ADropAreaInfo: TdxLayoutDragDropInfo): Boolean;
begin
  Result := ADropAreaInfo.DropAreaPart in [apTop, apBottom];
end;

function TdxLayoutGroupViewInfoVerticalSpecific.GetItemOriginalMinorSize
  (AViewInfo: TdxCustomLayoutItemViewInfo): Integer;
begin
  Result := AViewInfo.UsualWidth;
end;

function TdxLayoutGroupViewInfoVerticalSpecific.GetItemSufficientMinorSize
  (AViewInfo: TdxCustomLayoutItemViewInfo): Integer;
begin
  Result := AViewInfo.SufficientWidth;
end;

function TdxLayoutGroupViewInfoVerticalSpecific.GetItemSufficientMajorSize
  (AViewInfo: TdxCustomLayoutItemViewInfo): Integer;
begin
  Result := AViewInfo.SufficientHeight;
end;

function TdxLayoutGroupViewInfoVerticalSpecific.GetItemOriginalMajorSize
  (AViewInfo: TdxCustomLayoutItemViewInfo): Integer;
begin
  Result := AViewInfo.UsualHeight;
end;

function TdxLayoutGroupViewInfoVerticalSpecific.GetItemMinMinorSize
  (AViewInfo: TdxCustomLayoutItemViewInfo): Integer;
begin
  Result := AViewInfo.MinWidth;
end;

function TdxLayoutGroupViewInfoVerticalSpecific.GetItemMinMajorSize
  (AViewInfo: TdxCustomLayoutItemViewInfo): Integer;
begin
  Result := AViewInfo.MinHeight;
end;

function TdxLayoutGroupViewInfoVerticalSpecific.GetItemMaxMinorSize
  (AViewInfo: TdxCustomLayoutItemViewInfo): Integer;
begin
  Result := AViewInfo.MaxWidth;
end;

function TdxLayoutGroupViewInfoVerticalSpecific.GetItemMaxMajorSize
  (AViewInfo: TdxCustomLayoutItemViewInfo): Integer;
begin
  Result := AViewInfo.MaxHeight;
end;

function TdxLayoutGroupViewInfoVerticalSpecific.GetItemsAreaOffset
  (ASide: TdxLayoutSide): Integer;
begin
  Result := 0;
...
function TdxLayoutGroupViewInfoVerticalSpecific.GetItemsAreaHeight
  (ACalcSizeType: TdxLayoutCalcSizeType): Integer;
begin
  Result := GetMajorSize(ACalcSizeType);
end;

function TdxLayoutGroupViewInfoVerticalSpecific.GetItemsAreaWidth
  (ACalcSizeType: TdxLayoutCalcSizeType): Integer;
begin
  Result := GetMinorSize(ACalcSizeType);
end;
...
function TdxLayoutTabbedController.GetClientToScreen(const APoint
  : TPoint): TPoint;
begin
...
function TdxLayoutTabbedController.GetScreenToClient(const APoint
  : TPoint): TPoint;
begin
...
begin
  Result := ((TdxLayoutTabbedOptions(Properties).TabPosition in [tpTop,
    tpBottom]) or FIsRightToLeftConsider) and inherited UseRightToLeftAlignment;
end;
...
procedure TdxTabControlElementViewInfo.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  P: TPoint;
begin
  ...
  if FTabViewInfo.CanFocusOnClick(P.X, P.Y) then
    ItemViewInfo.ContainerViewInfo.Container.FocusController.CurrentTabOrder :=
      ItemViewInfo.FTabOrder;
  FTabController.MouseDown(Button, Shift, P.X, P.Y);
end;

procedure TdxTabControlElementViewInfo.MouseMove(Shift: TShiftState;
  X, Y: Integer);
var
  ATabIndex: Integer;
  AClientPoint: TPoint;
begin
  FTabController.MouseMove(Shift, X - FTabViewInfo.BoundsRect.Left,
    Y - FTabViewInfo.BoundsRect.Top);
  if (dxLayoutDragAndDropObject <> nil) and dxLayoutDragAndDropObject.CanDrop
  then
  begin
    AClientPoint := cxPointOffset(Point(X, Y),
      FTabViewInfo.BoundsRect.TopLeft, False);
...
procedure TdxTabControlElementViewInfo.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  FTabController.MouseUp(Button, Shift, X - FTabViewInfo.BoundsRect.Left,
    Y - FTabViewInfo.BoundsRect.Top);
end;
...
function TdxLayoutGroupViewInfoTabbedSpecific.AllowDrawChild(AChildViewInfo
  : TdxCustomLayoutItemViewInfo): Boolean;
begin
  Result := inherited AllowDrawChild(AChildViewInfo) and
    (AChildViewInfo.Item.Index = GroupViewInfo.ItemIndex);
end;
...
function TdxLayoutGroupViewInfoTabbedSpecific.GetChildInplaceRenameBounds
  (AChildViewInfo: TdxCustomLayoutItemViewInfo): TRect;
begin
  if HasTabControl then
    Result := cxRectOffset(FTabViewInfo.TabsViewInfo
      [AChildViewInfo.Item.VisibleIndex].VisibleRect, FTabControlBounds.TopLeft)
  else
    Result := cxNullRect;
end;

function TdxLayoutGroupViewInfoTabbedSpecific.GetDefaultItemControlAreaAlignment
  : TdxLayoutItemControlAreaAlignment;
begin
  Result := catNone;
end;

function TdxLayoutGroupViewInfoTabbedSpecific.ProcessDialogChar
  (ACharCode: Word): Boolean;
begin
  Result := HasTabControl and FTabController.HandleDialogChar(ACharCode);
end;

function TdxLayoutGroupViewInfoTabbedSpecific.ProcessDialogKey(ACharCode: Word;
  AKeyData: Integer; AFocusedItem: TdxCustomLayoutItem): Boolean;
var
  AGroup: TdxCustomLayoutGroup;
begin
  AGroup := GroupViewInfo.Group;
  Result := AGroup.IsChildItem(AFocusedItem) and
    FTabController.KeyDown(ACharCode, KeyDataToShiftState(AKeyData));
end;

procedure TdxLayoutGroupViewInfoTabbedSpecific.CalculateItemsAreaBounds
  (var AItemsAreaBounds: TRect);
begin
...
procedure TdxLayoutGroupViewInfoTabbedSpecific.CalculateItemsMajorBounds
  (const AItemsAreaBounds: TdxAbsRect);
var
  I: Integer;
begin
...
procedure TdxLayoutGroupViewInfoTabbedSpecific.CalculateInternalTabOrders
  (var ATabOrder: Integer);
begin
  if CanFocus then
  begin
...
begin
  inherited;
  FTabSheetContentOffset.X := GroupViewInfo.LayoutLookAndFeel.
    GetTabSheetContentOffsetHorz(Container);
  FTabSheetContentOffset.Y := GroupViewInfo.LayoutLookAndFeel.
    GetTabSheetContentOffsetVert(Container);
end;
...
procedure TdxLayoutGroupViewInfoTabbedSpecific.CalculateTabControl;
  ...
  const
    ATabPositionMap: array [Boolean, TcxTabPosition] of TcxTabPosition =
      ((tpTop, tpBottom, tpLeft, tpRight), (tpBottom, tpTop, tpRight, tpLeft));
  begin
  ...
  procedure CalculateElementViewInfo(AElementViewInfo
    : TdxTabControlElementViewInfo; const ABounds: TRect);
  begin
...
begin
  ...
  begin
    ...
    if TabbedOptions.ScrollOpposite and TabbedOptions.MultiLine and
      (FTabViewInfo.RowCount > 1) then
      CalculateElementViewInfo(FTabControlElementViewInfoOpposite,
        GetTabsRect(True))
    else
...
function TdxLayoutGroupViewInfoTabbedSpecific.GetDropActionType
  (AAreaPart: TdxLayoutDropAreaPart): TdxLayoutActionType;
begin
  Result := atInsert;
end;

procedure TdxLayoutGroupViewInfoTabbedSpecific.CorrectDropAreaPart
  (const P: TPoint; var AAreaPart: TdxLayoutDropAreaPart);
var
  AIndex: Integer;
  AClientPoint, C: TPoint;
begin
  AClientPoint := cxPointOffset(P, Point(FTabControlBounds.Left,
    FTabControlBounds.Top), False);
  ...
  begin
    ...
    if (TabbedOptions.TabPosition in [tpTop, tpBottom]) and
      (AClientPoint.X > C.X) or (TabbedOptions.TabPosition in [tpLeft, tpRight])
      and (TabbedOptions.Rotate xor (AClientPoint.Y < C.Y)) then
      AAreaPart := apAfter
    else
      AAreaPart := apBefore;
    if FTabViewInfo.UseRightToLeftAlignment and
      (TabbedOptions.TabPosition in [tpTop, tpBottom]) then
      case AAreaPart of
        apAfter:
          AAreaPart := apBefore;
        apBefore:
...
function TdxLayoutGroupViewInfoTabbedSpecific.GetDropAreaPart(var P: TPoint)
  : TdxLayoutDropAreaPart;
begin
...
function TdxLayoutGroupViewInfoTabbedSpecific.GetDropExpectedAlign
  (const ADropAreaInfo: TdxLayoutDragDropInfo): TdxLayoutRealAlign;
begin
  Result.Horz := ahClient;
  Result.Vert := avClient;
...
function TdxLayoutGroupViewInfoTabbedSpecific.GetDropExpectedBounds
  (const ADropAreaInfo: TdxLayoutDragDropInfo): TRect;

  function GetBorder: TcxBorder;
  const
    ResultMap: array [Boolean, TcxTabPosition] of TcxBorder =
      ((bLeft, bLeft, bTop, bTop), (bRight, bRight, bBottom, bBottom));
  begin
    Result := ResultMap[not HasTabControl or
      ((ADropAreaInfo.DropAreaPart = apBefore)
      xor not(FTabViewInfo.IsRightToLeftAlignment or
      FTabViewInfo.IsBottomToTopAlignment)), FTabViewInfo.TabPosition];
    if FTabViewInfo.UseRightToLeftAlignment and
      (TabbedOptions.TabPosition in [tpTop, tpBottom]) then
      case Result of
        bLeft:
...
begin
  case ADropAreaInfo.DropAreaPart of
    apBefore, apAfter:
      Result := ProcessTabRect(FTabViewInfo.GetTabViewInfo(TabbedOptions.Tabs
        [GroupViewInfo.ItemIndex]).VisibleRect);
    apLastChild:
      if ItemViewInfoCount = 0 then
        Result := inherited GetDropExpectedBounds(ADropAreaInfo)
      else
        Result := ProcessTabRect(FTabViewInfo.TabsViewInfo
          [FTabViewInfo.TabsViewInfo.ViewInfoCount - 1].VisibleRect);
  else
    Result := inherited GetDropExpectedBounds(ADropAreaInfo);
  end;
end;
...
procedure TdxLayoutGroupViewInfoTabbedSpecific.DrawSpecificControls
  (ACanvas: TcxCanvas);
begin
...
function TdxLayoutGroupViewInfoTabbedSpecific.GetMinorSize
  (ACalcSizeType: TdxLayoutCalcSizeType): Integer;
begin
  Result := GetMaxItemsMinorSize(ACalcSizeType = cstMin);

  if (TabbedOptions.TabPosition in [tpLeft, tpRight]) and (ItemViewInfoCount > 0)
  then
  begin
...
function TdxLayoutGroupViewInfoTabbedSpecific.GetMajorSize
  (ACalcSizeType: TdxLayoutCalcSizeType): Integer;
  ...
  begin
    ...
    ATabControlSize := FMinContentSize + GetItemsAreaOffset(sdLeft) +
      GetItemsAreaOffset(sdRight);
  ...
  begin
    if ADeficit < 0 then
      Exit;
    FMinContentSize := FMinContentSize + ADeficit;
    ATabControlSize := FMinContentSize + GetItemsAreaOffset(sdTop) +
      GetItemsAreaOffset(sdBottom);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        CalculateHorzTabs(cxRectWidth(FTabViewInfo.TabsViewInfo[0].FullRect) + 4
          - cxRectWidth(FTabViewInfo.TabsAreaRect));
      end
      else
      begin
        CalculateVertTabs(0);
        ...
        CalculateVertTabs(cxRectHeight(FTabViewInfo.TabsViewInfo[0].FullRect) +
          4 - cxRectHeight(FTabViewInfo.TabsAreaRect));
      end;
...
procedure TdxLayoutGroupViewInfoTabbedSpecific.DoAssignBounds
  (ASource: TdxLayoutGroupViewInfoSpecific);
begin
  inherited;
  DoCalculateTabControl(TdxLayoutGroupViewInfoTabbedSpecific(ASource)
    .FTabControlBounds, False);
end;

procedure TdxLayoutGroupViewInfoTabbedSpecific.DoSetOffset(const AValue,
  ADiff: TPoint);
var
  ATabBounds: TRect;
begin
...
function TdxLayoutGroupViewInfoTabbedSpecific.GetItemsAreaOffset
  (ASide: TdxLayoutSide): Integer;
begin
  Result := inherited GetItemsAreaOffset(ASide);
  if HasTabControl then
  begin
    Inc(Result, GroupViewInfo.LayoutLookAndFeel.GetTabControlBorderOffset
      (Container, ASide, GroupViewInfo.CaptionSide));
    case ASide of
      sdLeft, sdRight:
...
function TdxLayoutGroupViewInfoTabbedSpecific.GetHitTabIndex
  (const P: TPoint): Integer;
var
  AClientPoint: TPoint;
begin
...
begin
  Result := HasTabControl and FTabViewInfo.IsTabsVisible and
    (FTabViewInfo.TabsViewInfo.ViewInfoCount > 0);
end;

function TdxLayoutGroupViewInfoTabbedSpecific.CanFocusOnClick(X,
  Y: Integer): Boolean;
var
  P: TPoint;
begin
...
procedure TdxLayoutGroupViewInfoTabbedSpecific.KeyDown(var Key: Word;
  Shift: TShiftState);
begin
  if HasTabControl then
...
begin
  inherited;
  FTabControlElementViewInfo := TdxTabControlElementViewInfo.Create
    (GroupViewInfo);
  FTabControlElementViewInfoOpposite := TdxTabControlElementViewInfo.Create
    (GroupViewInfo);
end;
...
function TdxLayoutGroupViewInfoTabbedSpecific.GetTabController
...
function TdxLayoutGroupViewInfoTabbedSpecific.GetTabProperties
  : TcxCustomTabControlProperties;
begin
  Result := TabbedOptions;
end;

function TdxLayoutGroupViewInfoTabbedSpecific.GetTabViewInfo
  : TcxCustomTabControlViewInfo;
begin
  Result := FTabViewInfo;
end;

function TdxLayoutGroupViewInfoTabbedSpecific.
  CanDrawTabParentBackground: Boolean;
begin
  Result := False;
end;

procedure TdxLayoutGroupViewInfoTabbedSpecific.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited DoRightToLeftConversion(AClientBounds);
  DoCalculateTabControl(TdxRightToLeftLayoutConverter.ConvertRect
    (FTabControlBounds, AClientBounds), True);
end;
...
function TdxLayoutGroupViewInfoTabbedSpecific.GetDragAndDropObject
  : TcxDragAndDropObject;
begin
  Result := nil;
end;

function TdxLayoutGroupViewInfoTabbedSpecific.GetDragAndDropState
  : TcxDragAndDropState;
begin
  Result := ddsNone;
end;
...
begin
  Result := TdxCustomLayoutLookAndFeelAccess(GroupViewInfo.GetLayoutLookAndFeel)
    .LookAndFeel;
end;

procedure TdxLayoutGroupViewInfoTabbedSpecific.InvalidateTabRect(const R: TRect;
...
procedure TdxLayoutGroupViewInfoTabbedSpecific.DoCalculateTabControl
  (const ATabBounds: TRect; AIsRightToLeftConsider: Boolean);
begin
  if HasTabControl then
...
procedure TdxLayoutGroupViewInfoTabbedSpecific.DrawTabControl
  (ACanvas: TcxCanvas);
var
  P: TPoint;
begin
  ...
  try
    ...
    ACanvas.SetClipRegion(TcxRegion.Create(FTabViewInfo.ClientRect),
      roIntersect);
    if not TdxCustomLayoutLookAndFeelAccess(GroupViewInfo.LayoutLookAndFeel).CanDrawSpecificBackground
    then
      ACanvas.SetClipRegion(TcxRegion.Create(FTabViewInfo.PageClientRect),
        roSubtract);
...
function TdxLayoutGroupViewInfoTabbedSpecific.GetTabbedOptions
  : TdxLayoutTabbedOptions;
begin
...
constructor TdxLayoutGroupButtonViewInfo.Create(AButtonsViewInfo
  : TdxLayoutGroupButtonsViewInfo; AButton: TdxCustomLayoutGroupButton);
begin
...
procedure TdxLayoutGroupButtonViewInfo.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  AExecuteClick: Boolean;
begin
  AExecuteClick := (levsPressed in State) and IsEnabled and
    not ItemViewInfo.Item.Container.IsCustomization;
  inherited;
...
function TdxLayoutGroupButtonViewInfo.ShowHint(var AHintInfo
  : THintInfo): Boolean;
begin
  if IsEnabled then
  begin
...
function TdxLayoutGroupButtonViewInfo.GetPainterClass
  : TdxLayoutGroupButtonPainterClass;
begin
...
begin
  ...
  if not IsEnabled then
    Result := cxbsDisabled
  else if levsPressed in State then
    Result := cxbsPressed
  else if levsHot in State then
    Result := cxbsHot;
end;
...
begin
  ...
  begin
    if ButtonsViewInfo.GroupViewInfo.Group.Parent.LayoutDirection = ldHorizontal
    then
      if Item.Container.UseRightToLeftAlignment then
        Result := raMinus90
      else
...
function TdxLayoutGroupCheckBoxButtonViewInfo.GetCheckBoxSize
  (ACanvas: TcxCanvas): TSize;
begin
  Result := GetScaledEditCheckSize(ACanvas, LookAndFeel.NativeStyle, nil, 0,
    LookAndFeel.Painter, Item.ScaleFactor);
end;

function TdxLayoutGroupCheckBoxButtonViewInfo.GetEditCheckState
  : TcxEditCheckState;

  function IsState(AState: TdxLayoutElementViewInfoState): Boolean;
  begin
    Result := (AState in State) or
      (TdxLayoutGroupCaptionViewInfo(ItemViewInfo.CaptionViewInfo)
      .CanClickOnCaption and (AState in ItemViewInfo.CaptionViewInfo.State));
  end;
...
begin
  ...
  if not IsEnabled then
    Result := ecsDisabled
  else if IsState(levsPressed) then
    Result := ecsPressed
  else if IsState(levsHot) then
    Result := ecsHot;
end;

function TdxLayoutGroupCheckBoxButtonViewInfo.GetPainterClass
  : TdxLayoutGroupButtonPainterClass;
begin
...
constructor TdxLayoutGroupButtonsViewInfo.Create(AItemViewInfo
  : TdxCustomLayoutItemViewInfo);
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      Inc(AOffsetX, ButtonViewInfos[I].Width +
        GroupViewInfo.GetSpaceBetweenButtons);
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      ButtonViewInfos[I].Calculate(R);
      Inc(AOffsetY, ButtonViewInfos[I].Height +
        GroupViewInfo.GetSpaceBetweenButtons);
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      Options.RefreshVisibleButtons;
      for I := 0 to Options.FVisibleButtons.Count - 1 do
        Inc(Result, Options.GetVisibleButton(I).GetWidth + IfThen(I > 0,
          GroupViewInfo.GetSpaceBetweenButtons));
    end;
...
procedure TdxLayoutGroupButtonsViewInfo.DoAssignBounds
  (ASource: TdxCustomLayoutElementViewInfo);
var
  I: Integer;
begin
  inherited;
  for I := 0 to ButtonViewInfoCount - 1 do
    ButtonViewInfos[I].AssignBounds(TdxLayoutGroupButtonsViewInfo(ASource)
      .ButtonViewInfos[I]);
end;

procedure TdxLayoutGroupButtonsViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
var
  I: Integer;
begin
...
procedure TdxLayoutGroupButtonsViewInfo.DoSetOffset(const AValue,
  ADiff: TPoint);
var
  I: Integer;
begin
...
function TdxLayoutGroupButtonsViewInfo.GetButtonViewInfos(Index: Integer)
  : TdxLayoutGroupButtonViewInfo;
begin
...
constructor TdxLayoutGroupViewData.Create(AOwner: TdxLayoutItemViewDataList;
  AItem: TdxCustomLayoutItem);
begin
...
procedure TdxLayoutGroupViewData.DoButtonClick
  (AViewInfo: TdxLayoutGroupButtonViewInfo);
begin
...
function TdxLayoutGroupViewInfo.GetBorderRestSpaceBounds
  (ASide: TdxLayoutSide): TRect;
begin
...
const
  ResultMap: array [TdxCaptionLayout] of TdxLayoutSide = (sdLeft, sdTop,
    sdRight, sdBottom);
begin
  Result := ResultMap[Group.CaptionOptions.Layout];
end;

function TdxLayoutGroupViewInfo.GetCaptionViewInfo
  : TdxLayoutGroupCaptionViewInfo;
begin
...
function TdxLayoutGroupViewInfo.GetItemViewInfo(Index: Integer)
  : TdxCustomLayoutItemViewInfo;
begin
...
function TdxLayoutGroupViewInfo.GetRealItemControlAreaAlignment
  : TdxLayoutItemControlAreaAlignment;
begin
  ...
  if (Group.FWrappingState = wsNone) and (Result = catAuto) and
    ((ParentViewInfo = nil) or
    (ParentViewInfo.GetRealItemControlAreaAlignment = catNone) or
    not Group.IsHorzLocalPositionStable) then
    Result := catOwn
  else if Group.AutoCreated then
    Result := catAuto
  else
  ...
  if (Result = catAuto) and ((FMajorScrollBar <> nil) or
    (FMinorScrollBar <> nil) or (Group.ScrollOptions.Horizontal <> smNone) and
    (LayoutDirection = ldHorizontal)) then
    Result := catOwn;
end;
...
begin
  ...
  case Index of
    0:
      Result := FItemOffset;
    1:
      Result := FItemsAreaOffsetHorz;
    2:
      Result := FItemsAreaOffsetVert;
  else
    Result := -1;
  end;
end;

constructor TdxLayoutGroupViewInfo.Create(AContainerViewInfo
  : TdxLayoutContainerViewInfo; AParentViewInfo: TdxLayoutGroupViewInfo;
  AViewData: TdxCustomLayoutItemViewData);
begin
  inherited;
...
procedure TdxLayoutGroupViewInfo.InitializeMajorScrollBar(AContentSize,
  AClientSize: Integer);
begin
  ...
  if ContainerViewInfo.Container.ItemsParentControl.HandleAllocated then
    PostMessage(ContainerViewInfo.Container.ItemsParentControl.Handle,
      DXM_LAYOUT_UPDATESCROLLPOS, TdxNativeInt(ViewData), 0);
...
procedure TdxLayoutGroupViewInfo.InitializeMinorScrollBar(AContentSize,
  AClientSize: Integer);
begin
  ...
  if ContainerViewInfo.Container.ItemsParentControl.HandleAllocated then
    PostMessage(ContainerViewInfo.Container.ItemsParentControl.Handle,
      DXM_LAYOUT_UPDATESCROLLPOS, TdxNativeInt(ViewData), 1);
...
procedure TdxLayoutGroupViewInfo.CheckScrollPos(AScrollBar: TdxScrollBarWrapper;
  var AScrollPos: Integer);
begin
  if AScrollBar = nil then
    ...
    AScrollPos :=
      Max(Min(AScrollPos, AScrollBar.Max + 1 - AScrollBar.PageSize), 0);
end;

procedure TdxLayoutGroupViewInfo.SetScrollBounds
  (AScrollBar: TdxScrollBarWrapper; const ABounds: TRect);
begin
  AScrollBar.InitControl;
  TdxScrollBarWrapperAccess(AScrollBar).UpdateBounds(ABounds,
    GetVisiblePart(ABounds));
end;
...
procedure TdxLayoutGroupViewInfo.DestroyScrollBar(var AScrollBar
  : TdxScrollBarWrapper);
begin
...
function TdxLayoutGroupViewInfo.GetClientAreaBounds(const ABounds
  : TRect): TRect;
var
  AMargins: TRect;
begin
  AMargins := Rect(GetBorderWidth(sdLeft), GetBorderWidth(sdTop),
    GetBorderWidth(sdRight), GetBorderWidth(sdBottom));
  Result := cxRectContent(ABounds, AMargins);
end;

function TdxLayoutGroupViewInfo.GetItemsAreaBounds(const AClientRect
  : TRect): TRect;
var
  AMargins: TRect;
begin
...
procedure TdxLayoutGroupViewInfo.PopulateControlViewInfoList(AControls,
  AWinControls: TList);
var
  I: Integer;
begin
...
function TdxLayoutGroupViewInfo.GetCaptionViewInfoClass
  : TdxCustomLayoutItemCaptionViewInfoClass;
begin
  Result := TdxLayoutGroupCaptionViewInfo;
end;

function TdxLayoutGroupViewInfo.GetHitTestClass
  : TdxCustomLayoutItemHitTestClass;
begin
  if Group.IsFloatingRoot then
    Result := TdxLayoutFloatingRootHitTest
  else if Group.LayoutDirection = ldTabbed then
    Result := TdxLayoutTabbedGroupHitTest
  else
    Result := TdxLayoutGroupHitTest;
end;

function TdxLayoutGroupViewInfo.GetPainterClass
  : TdxCustomLayoutItemPainterClass;
begin
  Result := TdxCustomLayoutItemPainterClass
    (LayoutLookAndFeel.GetGroupPainterClass);
end;
...
procedure TdxLayoutGroupViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited DoRightToLeftConversion(AClientBounds);
  ...
  begin
    FMajorScrollBarBounds := TdxRightToLeftLayoutConverter.ConvertRect
      (FMajorScrollBarBounds, AClientBounds);
    SetScrollBounds(FMajorScrollBar, FMajorScrollBarBounds);
  end;
  if (FMinorScrollBar <> nil) and not cxRectIsNull(FMinorScrollBarBounds) then
  begin
    FMinorScrollBarBounds := TdxRightToLeftLayoutConverter.ConvertRect
      (FMinorScrollBarBounds, AClientBounds);
    SetScrollBounds(FMinorScrollBar, FMinorScrollBarBounds);
  end;
  FCaptionAreaBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (FCaptionAreaBounds, AClientBounds);
  FButtonsAreaBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (FButtonsAreaBounds, AClientBounds);
  FClientAreaBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (FClientAreaBounds, AClientBounds);
  FItemsAreaBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (FItemsAreaBounds, AClientBounds);
...
begin
  if IsVerticalCaption then
    Result := Max(0, cxRectHeight(Bounds))
  else
    Result := inherited;
  ...
  begin
    ...
    Result := Result - CaptionViewInfo.GetContentOffsetSize.cx -
      cxMarginsWidth(Padding) - ButtonsViewInfo.CalculateWidth - AOffset;
  end;
end;
...
function TdxLayoutGroupViewInfo.DoCalculateHeight(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
begin
  Result := inherited DoCalculateHeight(ACalcSizeType) +
    GetHeight(Specific.GetItemsAreaHeight(ACalcSizeType));
end;

function TdxLayoutGroupViewInfo.DoCalculateWidth(ACalcSizeType
  : TdxLayoutCalcSizeType): Integer;
begin
  Result := inherited DoCalculateWidth(ACalcSizeType) +
    GetWidth(Specific.GetItemsAreaWidth(ACalcSizeType));
end;
...
procedure TdxLayoutGroupViewInfo.CorrectDropAreaPart(const P: TPoint;
  var AAreaPart: TdxLayoutDropAreaPart);
begin
  Specific.CorrectDropAreaPart(P, AAreaPart);
end;

function TdxLayoutGroupViewInfo.GetDestinationItem(const ADropAreaInfo
  : TdxLayoutDragDropInfo): TdxCustomLayoutItem;
begin
  case ADropAreaInfo.DropAreaPart of
    apNewLayout:
    ...
    if Group.IsRoot and not cxRectPtIn(ItemsAreaBounds,
      ADropAreaInfo.DropClientPoint) and
      ((ADropAreaInfo.DropAreaPart in [apLeft, apRight]) and
      (LayoutDirection = ldHorizontal) or (ADropAreaInfo.DropAreaPart in [apTop,
      apBottom]) and (LayoutDirection = ldVertical)) then
    begin
      Result := Specific.GetDropExactItem
        (Specific.GetDropNearestPoint(ADropAreaInfo.DropClientPoint));
      if Result = nil then
        Result := Group;
    end
    else
...
function TdxLayoutGroupViewInfo.GetDropActionType
  (AAreaPart: TdxLayoutDropAreaPart): TdxLayoutActionType;
begin
  if AAreaPart = apNone then
    Result := atNone
  else if (AAreaPart in [apBefore, apAfter, apBetween, apLastChild]) then
    Result := atInsert
  else
    Result := Specific.GetDropActionType(AAreaPart);
end;

function TdxLayoutGroupViewInfo.GetDropAreaPart(var P: TPoint)
  : TdxLayoutDropAreaPart;
begin
  if cxRectIsEmpty(ItemsAreaBounds) then
  begin
    if PtInRect(dxLayoutGetCenterAreaBounds(Bounds), P) and IsExpanded or Group.IsRoot
    then
      Result := apLastChild
    else
      Result := inherited GetDropAreaPart(P)
...
function TdxLayoutGroupViewInfo.GetDropExpectedBounds(const ADropAreaInfo
  : TdxLayoutDragDropInfo): TRect;
begin
  if (ADropAreaInfo.DropAreaPart in [apLeft .. apBottom]) and
    not ADropAreaInfo.DestinationItem.IsRoot and
    (ADropAreaInfo.DestinationItem = ADropAreaInfo.DestinationGroup) then
    raise Exception.Create('GetDropExpectedBounds fails');

  Result := Specific.GetDropExpectedBounds(ADropAreaInfo);
end;

function TdxLayoutGroupViewInfo.GetDropExpectedAlign(const ADropAreaInfo
  : TdxLayoutDragDropInfo): TdxLayoutAlign;
begin
  Result := TdxLayoutAlign(Specific.GetDropExpectedAlign(ADropAreaInfo));
end;

function TdxLayoutGroupViewInfo.GetDropHorzAlignForLocale(const AHorzAlign
  : TdxLayoutAlignHorz): TdxLayoutAlignHorz;

  function GetRightToLeftAlignHorz(const AHorzAlign: TdxLayoutAlignHorz)
    : TdxLayoutAlignHorz;
  begin
    case AHorzAlign of
      ahLeft:
...
begin
  Result := Group.ShowBorder and
    ((ParentViewInfo = nil) or ParentViewInfo.AllowChildHasBorder or
    IsDragImagePainting and IsDragged);
end;
...
function CompareLayoutItemViewInfos(Item1,
  Item2: TdxLayoutItemViewInfo): Integer;
begin
  Result := Ord(Item2.CaptionLayout) - Ord(Item1.CaptionLayout);
end;

function IsCaptionLayoutHorizontal(AItemViewInfo
  : TdxLayoutControlItemViewInfo): Boolean;
begin
  Result := AItemViewInfo.CaptionLayout in [clLeft, clRight];
end;

function IsCaptionLayoutVertical(AItemViewInfo
  : TdxLayoutControlItemViewInfo): Boolean;
begin
  Result := AItemViewInfo.CaptionLayout in [clTop, clBottom];
end;

function ComparePositionItemViewInfos(Item1,
  Item2: TdxLayoutControlItemViewInfo): Integer;
begin
  if Item1 = Item2 then
    Result := 0
  else
  begin
    if IsCaptionLayoutHorizontal(Item1) and Item1.Item.IsHorzPositionStable and
      Item2.Item.IsHorzPositionStable or IsCaptionLayoutVertical(Item1) and
      Item1.Item.IsVertPositionStable and Item2.Item.IsVertPositionStable then
...
function TdxLayoutGroupViewInfo.AutoAlignControls: Boolean;
  ...
  function GetViewInfo(AList: TList; AIndex: Integer)
    : TdxLayoutControlItemViewInfo;
  begin
    Result := TdxLayoutControlItemViewInfo(AList.List[AIndex]);
  end;

  procedure ExtractSameLayoutItemViewInfos(AOriginalList, AList: TdxList;
  ...
  procedure ExtractSamePositionItemViewInfos(AOriginalList, AList: TdxList;
    ...
    begin
      ...
      begin
        ...
        if IsCaptionLayoutHorizontal(AItemViewInfo) then
          ACaptionSize := AItemViewInfo.CaptionViewInfo.Width +
            AItemViewInfo.ElementOffsetHorz
        else
          ACaptionSize := AItemViewInfo.CaptionViewInfo.Height +
            AItemViewInfo.ElementOffsetVert;
      ...
      begin
        ...
        if IsCaptionLayoutHorizontal(AItemViewInfo) then
          AItemViewInfo.CaptionViewInfo.Width :=
            AItemViewInfo.ParentViewInfo.GetLevelingItemCaptionWidth
            (AItemViewInfo, AMaxCaptionSize - AItemViewInfo.ElementOffsetHorz)
        else
          AItemViewInfo.CaptionViewInfo.Height := AMaxCaptionSize -
            AItemViewInfo.ElementOffsetVert;
      end;
    end;
...
var
  AAllItemViewInfos, ASameLayoutItemViewInfos,
    ASamePositionItemViewInfos: TdxList;
  I: Integer;
begin
  Result := False;
  for I := 0 to ItemViewInfoCount - 1 do
  ...
  begin
    ...
    try
      ...
      begin
        Result := True;
        ExtractSameLayoutItemViewInfos(AAllItemViewInfos,
          ASameLayoutItemViewInfos, AAllItemViewInfos[0]);
        while ASameLayoutItemViewInfos.Count > 0 do
        begin
          ExtractSamePositionItemViewInfos(ASameLayoutItemViewInfos,
            ASamePositionItemViewInfos, ASameLayoutItemViewInfos[0]);
...
begin
  ...
  case CaptionSide of
    sdLeft, sdRight:
      begin
        if CaptionSide = sdLeft then
          FButtonsAreaBounds.Right := FButtonsAreaBounds.Left +
            ButtonsViewInfo.CalculateWidth
        else
          FButtonsAreaBounds.Left := FButtonsAreaBounds.Right -
            ButtonsViewInfo.CalculateWidth;
        ...
        begin
          ...
          FButtonsAreaBounds.Bottom := FButtonsAreaBounds.Top +
            ButtonsViewInfo.CalculateHeight;
        end
        else
        begin
          FButtonsAreaBounds.Bottom := FButtonsAreaBounds.Bottom -
            ButtonsOffset;
          FButtonsAreaBounds.Top := FButtonsAreaBounds.Bottom -
            ButtonsViewInfo.CalculateHeight;
        end;
      end;
    sdTop, sdBottom:
...
begin
  FItemsAreaBounds := cxRectInflate(ClientBounds, -ItemsAreaOffsetHorz,
    -ItemsAreaOffsetVert);
...
begin
  if UseItemsAreaOffsets then
    ...
    begin
      ItemsAreaOffsetHorz := LayoutLookAndFeel.GetRootItemsAreaOffsetHorz
        (Item.Container);
      ItemsAreaOffsetVert := LayoutLookAndFeel.GetRootItemsAreaOffsetVert
        (Item.Container);
    end
    else
    begin
      ItemsAreaOffsetHorz := LayoutLookAndFeel.GetItemsAreaOffsetHorz
        (Item.Container);
      ItemsAreaOffsetVert := LayoutLookAndFeel.GetItemsAreaOffsetVert
        (Item.Container);
    end
  else
  begin
...
begin
  ...
  begin
    if IsVerticalCaption then
    begin
      AOffsetX := (cxRectWidth(FButtonsAreaBounds) -
        cxRectWidth(FCaptionAreaBounds)) div 2;
      if AOffsetX > 0 then
        FCaptionAreaBounds := cxRectOffset(FCaptionAreaBounds, AOffsetX, 0,
          CaptionSide = sdLeft)
      else
        FButtonsAreaBounds := cxRectOffset(FButtonsAreaBounds, -AOffsetX, 0,
          CaptionSide = sdLeft);

      if HasCaption and HasButtons then
      begin
        if ((CaptionSide = sdLeft) xor ButtonsViewInfo.IsLeftAlignment) and
          (FCaptionAreaBounds.Top < FButtonsAreaBounds.Bottom) then
          FCaptionAreaBounds := cxRectOffset(FCaptionAreaBounds, 0,
            FCaptionAreaBounds.Top - FButtonsAreaBounds.Bottom, False);
        if ((CaptionSide = sdRight) xor ButtonsViewInfo.IsLeftAlignment) and
          (FCaptionAreaBounds.Bottom > FButtonsAreaBounds.Top) then
          FCaptionAreaBounds := cxRectOffset(FCaptionAreaBounds, 0,
            FCaptionAreaBounds.Bottom - FButtonsAreaBounds.Top, False);
      end;
    end
    else
    begin
      AOffsetY := (cxRectHeight(FButtonsAreaBounds) -
        cxRectHeight(FCaptionAreaBounds)) div 2;
      if AOffsetY > 0 then
      ...
      if HasCaption and HasButtons then
      begin
        if not ButtonsViewInfo.IsLeftAlignment and
          (FCaptionAreaBounds.Right > FButtonsAreaBounds.Left) then
          FCaptionAreaBounds := cxRectOffset(FCaptionAreaBounds,
            FCaptionAreaBounds.Right - FButtonsAreaBounds.Left, 0, False);
        if ButtonsViewInfo.IsLeftAlignment and
          (FButtonsAreaBounds.Right > FCaptionAreaBounds.Left) then
          FCaptionAreaBounds := cxRectOffset(FCaptionAreaBounds,
            FButtonsAreaBounds.Right - FCaptionAreaBounds.Left, 0);
      end;
    end;
  end;
...
function TdxLayoutGroupViewInfo.GetInscribedRect(const AInscribeRect
  : TRect): TRect;
begin
...
begin
  ...
  if HasBorder then
  begin
    Result := LayoutLookAndFeel.GetGroupBorderWidth(Item.Container, ASide,
      CaptionSide, HasCaption or HasButtons, IsExpanded);
    ...
    begin
      ...
      begin
        ...
        Inc(Result, Max(ACaptionWidth, ButtonsViewInfo.CalculateWidth) -
          ACaptionWidth);
      end
      else
      begin
        ATextHeight := CaptionViewInfo.GetAvailableTextHeight;
        Inc(Result, Max(ATextHeight, CaptionViewInfo.ImageHeight) -
          ATextHeight);
        ACaptionHeight := CaptionViewInfo.GetAvailableHeight;
        Inc(Result, Max(ACaptionHeight, ButtonsViewInfo.CalculateHeight) -
          ACaptionHeight);
      end;
    end;
  end;
...
begin
  Result := TdxCustomLayoutLookAndFeelAccess(LayoutLookAndFeel)
    .IsSkinPainterUsed;
end;
...
begin
  Result := TdxCustomLayoutLookAndFeelAccess(LayoutLookAndFeel)
    .IsGroupTransparent(Self);
end;

function TdxLayoutGroupViewInfo.IsEllipsisAllowed
  (AForDrawing: Boolean = False): Boolean;
begin
...
function TdxLayoutGroupViewInfo.CanAssignBounds
  (ASource: TdxCustomLayoutElementViewInfo): Boolean;
begin
  Result := inherited CanAssignBounds(ASource) and
    (ItemViewInfoCount = TdxLayoutGroupViewInfo(ASource).ItemViewInfoCount);
end;

procedure TdxLayoutGroupViewInfo.DoAssignBounds
  (ASource: TdxCustomLayoutElementViewInfo);
var
  I: Integer;
...
begin
  ...
  begin
    ...
    InitializeMajorScrollBar(AGroupViewInfo.FMajorScrollBar.Max + 1,
      AGroupViewInfo.FMajorScrollBar.PageSize);
    if UseRightToLeftAlignment then
    begin
      FMajorScrollBarBounds := TdxRightToLeftLayoutConverter.ConvertRect
        (FMajorScrollBarBounds, ItemsAreaBounds);
      SetScrollBounds(FMajorScrollBar, FMajorScrollBarBounds);
    end;
    FMajorScrollBar.Visible := IsScrollBarsVisible;
  end;
  ...
  begin
    ...
    InitializeMinorScrollBar(AGroupViewInfo.FMinorScrollBar.Max + 1,
      AGroupViewInfo.FMinorScrollBar.PageSize);
    if UseRightToLeftAlignment then
    begin
      FMinorScrollBarBounds := TdxRightToLeftLayoutConverter.ConvertRect
        (FMinorScrollBarBounds, ItemsAreaBounds);
      SetScrollBounds(FMinorScrollBar, FMinorScrollBarBounds);
    end;
    FMinorScrollBar.Visible := IsScrollBarsVisible;
  end;
...
begin
  ...
  if FMajorScrollBar <> nil then
  begin
    SetScrollBounds(FMajorScrollBar,
      cxRectOffset(FMajorScrollBarBounds, ADiff));
  ...
  if FMinorScrollBar <> nil then
  begin
    SetScrollBounds(FMinorScrollBar,
      cxRectOffset(FMinorScrollBarBounds, ADiff));
    FMinorScrollBarBounds := FMinorScrollBar.BoundsRect;
    FMinorScrollBar.Visible := IsScrollBarsVisible;
  end;
end;

function TdxLayoutGroupViewInfo.CanHandleMouseWheel(Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
  Result := PtInRect(Bounds, MousePos) and ActuallyVisible and
    ((LayoutDirection = ldHorizontal) and (FMinorScrollBar <> nil) or
    ((LayoutDirection = ldVertical) and (FMajorScrollBar <> nil)));
end;

procedure TdxLayoutGroupViewInfo.DoMajorScroll(Sender: TObject;
...
begin
  ...
  begin
    ...
    ViewData.ScrollPos :=
      TdxAbsPoint(Point(AScrollPos, ViewData.FScrollPos.Minor));
    ContainerViewInfo.Container.DoGroupScroll(Self);
  end;
end;

procedure TdxLayoutGroupViewInfo.DoMinorScroll(Sender: TObject;
  AScrollCode: TScrollCode; var AScrollPos: Integer);
...
begin
  ...
  begin
    ...
    ViewData.ScrollPos := TdxAbsPoint(Point(ViewData.FScrollPos.Major,
      AScrollPos));
    ContainerViewInfo.Container.DoGroupScroll(Self);
  end;
end;

function TdxLayoutGroupViewInfo.DoMouseWheel(Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint): Boolean;
...
begin
  ...
  for I := 0 to ItemViewInfoCount - 1 do
    Result := Result or ItemViewInfos[I].DoMouseWheel(Shift, WheelDelta,
      MousePos);
...
function TdxLayoutGroupViewInfo.IsMouseWheelHandleNeeded(Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint): Boolean;
var
  I: Integer;
begin
  ...
  for I := 0 to ItemViewInfoCount - 1 do
    Result := Result or ItemViewInfos[I].IsMouseWheelHandleNeeded(Shift,
      WheelDelta, MousePos);
...
function TdxLayoutGroupViewInfo.AllowDrawChild(AChildViewInfo
  : TdxCustomLayoutItemViewInfo): Boolean;
begin
  Result := Group.AllowShowChild(AChildViewInfo.Item) and
    Specific.AllowDrawChild(AChildViewInfo) and IsExpanded;
end;
...
begin
  Result := Specific.AllowMajorScroll and
    ...
    (Group.ScrollOptions.MajorScroll = smAuto) and (Specific.IsMajorSizeFixed or
    ((ParentViewInfo = nil) or
    ((ParentViewInfo.LayoutDirection = LayoutDirection) and
    not ParentViewInfo.AllowMajorScroll or (ParentViewInfo.LayoutDirection <>
    LayoutDirection) and not ParentViewInfo.AllowMinorScroll))));
end;
...
begin
  Result := Specific.AllowMinorScroll and
    ...
    (Group.ScrollOptions.MinorScroll = smAuto) and (Specific.IsMinorSizeFixed or
    ((ParentViewInfo = nil) or
    ((ParentViewInfo.LayoutDirection = LayoutDirection) and
    not ParentViewInfo.AllowMinorScroll or (ParentViewInfo.LayoutDirection <>
    LayoutDirection) and not ParentViewInfo.AllowMajorScroll))));
end;

function TdxLayoutGroupViewInfo.GetChildInplaceRenameBounds(AChildViewInfo
  : TdxCustomLayoutItemViewInfo): TRect;
begin
...
const
  ResultMap: array [TdxLayoutSide] of TcxRotationAngle = (raPlus90, raMinus90,
    ra0, ra0);
begin
  Result := ResultMap[CaptionSide];
end;

function TdxLayoutGroupViewInfo.IsChildActuallyVisible(AChildViewInfo
  : TdxCustomLayoutItemViewInfo): Boolean;
begin
...
function TdxLayoutGroupViewInfo.GetSpecificClass
  : TdxLayoutGroupViewInfoSpecificClass;
begin
...
begin
  Result := Max(MinVisibleHeight, BorderWidths[sdTop] + BorderWidths[sdBottom] +
    IfThen(AllowCollapsedHeight, 0, ItemsAreaOffsetVert +
    Specific.GetItemsAreaOffset(sdTop) + AItemsAreaHeight + ItemsAreaOffsetVert
    + Specific.GetItemsAreaOffset(sdBottom) + Padding.Top + Padding.Bottom));
end;
...
begin
  Result := Max(MinVisibleWidth, BorderWidths[sdLeft] + BorderWidths[sdRight] +
    IfThen(AllowCollapsedWidth, 0, ItemsAreaOffsetHorz +
    Specific.GetItemsAreaOffset(sdLeft) + AItemsAreaWidth + ItemsAreaOffsetHorz
    + Specific.GetItemsAreaOffset(sdRight) + Padding.Left + Padding.Right));
end;

function TdxLayoutGroupViewInfo.GetLevelingItemCaptionWidth
  (AItemViewInfo: TdxLayoutControlItemViewInfo;
  AMaxCaptionSize: Integer): Integer;
...
begin
  if Group.FWrappingState = wsPopulated then
    if Group.LayoutDirection = ldVertical then
      ...
      Result := Min(GetComplexLevelingItemCaptionWidth,
        GetSimpleLevelingItemCaptionWidth)
  else
    Result := AMaxCaptionSize;
end;
...
procedure TdxLayoutGroupViewInfo.CalculateInternalTabOrders
  (var AAvailableTabOrder: Integer);
var
  I: Integer;
begin
...
procedure TdxLayoutGroupViewInfo.CalculateTabOrders(var AAvailableTabOrder
  : Integer);
var
  I: Integer;
begin
...
function TdxLayoutGroupViewInfo.FindItemViewInfo(AItem: TdxCustomLayoutItem)
  : TdxCustomLayoutItemViewInfo;
var
  I: Integer;
  AViewInfo: TdxCustomLayoutItemViewInfo;
begin
  ...
  begin
    ...
    begin
      ...
      else if AViewInfo.Item = AItem then
        Result := AViewInfo;
      if Result <> nil then
        Break;
    end;
...
function TdxLayoutGroupViewInfo.GetHitTest(const P: TPoint)
  : TdxCustomLayoutHitTest;
var
  I: Integer;
begin
...
function TdxLayoutGroupViewInfo.GetItemWithMouse(const P: TPoint)
  : TdxCustomLayoutItem;
var
  I: Integer;
begin
...
begin
  if PtInRect(Bounds, P) then
    ...
    begin
      ...
      if Specific.IsAtInsertionPos(R, P) then
        Exit;
    end;
...
procedure TdxLayoutGroupViewInfo.MakeVisible(const ARect: TRect;
  AFully: Boolean);
begin
...
begin
  ...
  FContainer := AContainer;
  FItemViewInfoDictionary :=
    TDictionary<TdxCustomLayoutItem, TdxCustomLayoutItemViewInfo>.Create;
...
function TdxLayoutContainerViewInfo.FindItemViewInfo(AItem: TdxCustomLayoutItem;
  out AViewInfo: TdxCustomLayoutItemViewInfo): Boolean;
begin
  Result := FItemViewInfoDictionary.TryGetValue(AItem, AViewInfo);
end;

function TdxLayoutContainerViewInfo.GetHitTest(const P: TPoint)
  : TdxCustomLayoutHitTest;
begin
  Result := nil;
...
function TdxLayoutContainerViewInfo.GetItemViewInfo(AItem: TdxCustomLayoutItem)
  : TdxCustomLayoutItemViewInfo;
begin
  FindItemViewInfo(AItem, Result);
end;

function TdxLayoutContainerViewInfo.GetItemWithMouse(const P: TPoint)
  : TdxCustomLayoutItem;
begin
...
procedure TdxLayoutContainerViewInfo.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  AViewInfo: TdxCustomLayoutItemViewInfo;
...
begin
  ...
  begin
    ...
    if not(AHitTest is TdxCustomLayoutItemHitTest) or
      not FindItemViewInfo(TdxCustomLayoutItemHitTest(AHitTest).GetSourceItem,
      AHitItemViewInfo) or AHitItemViewInfo.IsParentLocked then
...
procedure TdxLayoutContainerViewInfo.MouseMove(Shift: TShiftState;
  X, Y: Integer);
var
  AViewInfo: TdxCustomLayoutItemViewInfo;
begin
...
procedure TdxLayoutContainerViewInfo.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  AViewInfo: TdxCustomLayoutItemViewInfo;
begin
...
begin
  if LayoutLookAndFeel <> nil then
    FRootViewInfo := CreateItemViewInfo(nil, FContainer.Root)
      as TdxLayoutRootViewInfo;
end;

function TdxLayoutContainerViewInfo.CreateItemViewInfo(AParentViewInfo
  : TdxLayoutGroupViewInfo; AItem: TdxCustomLayoutItem)
  : TdxCustomLayoutItemViewInfo;
var
  AViewData: TdxCustomLayoutItemViewData;
begin
...
function TdxLayoutContainerViewInfo.GetRootViewInfoClass
  : TdxLayoutRootViewInfoClass;
begin
...
procedure TdxLayoutContainerViewInfo.RecreateViewInfos(ARecreateViewData
  : Boolean = False);
begin
  DestroyViewInfos;
...
begin
  ...
  FContentBounds := cxRectBounds(FOffset.X, FOffset.Y, AContentWidth,
    AContentHeight);
end;
...
function TdxLayoutContainerViewInfo.ShowHint(var AHintInfo: THintInfo;
  X, Y: Integer): Boolean;
var
  AViewInfo: TdxCustomLayoutItemViewInfo;
begin
  AssignItemWithMouse(X, Y);
  Result := (ItemWithMouse <> nil) and FindItemViewInfo(ItemWithMouse,
    AViewInfo) and AViewInfo.ShowHint(AHintInfo);
end;
...
function TdxLayoutContainerViewInfo.IsMouseWheelHandleNeeded(Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
  Result := RootViewInfo.IsMouseWheelHandleNeeded(Shift, WheelDelta, MousePos);
end;

function TdxLayoutContainerViewInfo.DoMouseWheel(Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
  Result := RootViewInfo.DoMouseWheel(Shift, WheelDelta, MousePos);
end;

function TdxLayoutContainerViewInfo.GetTouchScrollUIOwner(const APoint: TPoint)
  : IdxTouchScrollUIOwner;

  function FindScrollBarOwner(AGroupViewInfo: TdxLayoutGroupViewInfo)
    : TdxLayoutGroupViewInfo;
  begin
...
begin
  ...
  else if AHitTest is TdxCustomLayoutItemHitTest then
    Result := FindScrollBarOwner(AHitTest.ViewInfo.ParentViewInfo)
  else
    Result := nil;
end;

procedure TdxLayoutContainerViewInfo.AssignBounds
  (ASource: TdxLayoutContainerViewInfo);
begin
  if CanAssignBounds(ASource) then
    DoAssignBounds(ASource);
end;

function TdxLayoutContainerViewInfo.CanAssignBounds
  (ASource: TdxLayoutContainerViewInfo): Boolean;
begin
  Result := ASource is ClassType;
end;

procedure TdxLayoutContainerViewInfo.DoAssignBounds
  (ASource: TdxLayoutContainerViewInfo);
begin
  FOffset := ASource.FOffset;
...
function TdxLayoutContainerViewInfo.GetViewData(AItem: TdxCustomLayoutItem)
  : TdxCustomLayoutItemViewData;
begin
...
function TdxLayoutContainerViewInfo.GetViewDataClass(AItem: TdxCustomLayoutItem)
  : TdxCustomLayoutItemViewDataClass;
begin
...
function TdxLayoutContainerViewInfo.FindCloneData(AItem: TdxCustomLayoutItem;
  out ACloneData: TdxCustomLayoutItemViewData): Boolean;
var
  I: Integer;
begin
  ...
  begin
    ...
    begin
      ...
      try
        ...
        for I := 0 to AList.Count - 1 do
        begin
          if Supports(TObject(AList.List[I]), IdxLayoutSelectableItem, AIntf)
            and AIntf.IsOwner(Container) then
          begin
            Result := True;
            AIntf := nil;
            Break;
...
begin
  ...
  begin
    ...
    MoveWindowOrg(SelectionLayer.SelectionImage.Canvas.Handle,
      -ClientBounds.Left, -ClientBounds.Top);
    ItemsViewInfo.PaintSelectionLayer(SelectionLayer.SelectionImage);

    if (dxLayoutDragAndDropObject <> nil) and
      (TcxDragAndDropObjectAccess(dxLayoutDragAndDropObject)
      .Control.DragAndDropState in [ddsInProcess]) and
      (TdxLayoutCustomDragAndDropControllerAccess(dxLayoutDragAndDropController)
      .DestinationContainer = Container) then
      TdxLayoutCustomDragAndDropControllerAccess(dxLayoutDragAndDropController)
        .PaintDestinationArea(SelectionLayer.SelectionImage);
...
function TdxLayoutContainerViewInfo.GetLayoutLookAndFeel
  : TdxCustomLayoutLookAndFeel;
begin
  Result := Container.GetLayoutLookAndFeel;
end;

function TdxLayoutContainerViewInfo.GetItemLayoutLookAndFeel
  (AViewInfo: TdxCustomLayoutItemViewInfo): TdxCustomLayoutLookAndFeel;
begin
  Result := AViewInfo.Item.GetLayoutLookAndFeel;
end;

function TdxLayoutContainerViewInfo.GetItemOptions
  (AViewInfo: TdxCustomLayoutItemViewInfo): TdxCustomLayoutLookAndFeelOptions;
begin
...
procedure TdxLayoutContainerViewInfo.MakeVisible(const ARect: TRect;
  AFully: Boolean);
begin
  Container.MakeVisible(ARect, AFully);
end;

procedure TdxLayoutContainerViewInfo.SelectionLayerHitTest(ASender: TObject;
  var AIsTransparent: Boolean);
begin
...
procedure TdxLayoutContainerViewInfo.SelectionLayerEndRename(ASender: TObject;
  const AText: string; AAccept: Boolean);
begin
  if AAccept then
...
procedure TdxLayoutContainerViewInfo.SetItemWithMouse
  (Value: TdxCustomLayoutItem);
var
  AViewInfo: TdxCustomLayoutItemViewInfo;
begin
  ...
  begin
    if (FItemWithMouse <> nil) and FindItemViewInfo(FItemWithMouse, AViewInfo)
      and (AViewInfo.Item <> nil) then
...
begin
  if not Item.IsDesigning and Supports(Control, IdxTouchModeSupport,
    ATouchModeSupport) then
...
function TdxCustomLayoutControlAdapter.GetLayoutLookAndFeel
  : TdxCustomLayoutLookAndFeel;
begin
...
begin
  ...
  if IsPublishedProp(Control, 'BevelInner') and
    IsPublishedProp(Control, 'BevelKind') and
    IsPublishedProp(Control, 'BevelOuter') then
  begin
...
begin
  ...
  if FItem.IsDesigning and (FItem.Caption = '') then
    FItem.Caption := Control.Name;
  // GetPlainString(TControlAccess(Control).Caption);
...
begin
  Result := IsPublishedProp(Control, 'BorderStyle') and
    (GetPropInfo(Control, 'BorderStyle').PropType^ = TypeInfo
    (Forms.TBorderStyle));
end;
...
begin
  Result := TControlAccess(Control).ParentColor and
    IsPublishedProp(Control, 'Color');
end;
...
begin
  ...
  begin
    LayoutLookAndFeel.InitializeSubControlCxLookAndFeel
      (ALookAndFeelContainer.GetLookAndFeel);
  end;
end;

class procedure TdxCustomLayoutControlAdapter.Register(AControlClass
  : TControlClass);
begin
  dxLayoutControlAdapterDefs.Register(AControlClass, Self);
end;

class procedure TdxCustomLayoutControlAdapter.Unregister(AControlClass
  : TControlClass);
begin
...
constructor TdxCustomLayoutElementPainter.Create
  (AViewInfo: TdxCustomLayoutElementViewInfo);
begin
  inherited Create;
  FViewInfo := AViewInfo;
end;
...
function TdxCustomLayoutItemElementPainter.GetLayoutLookAndFeel
  : TdxCustomLayoutLookAndFeel;
begin
...
function TdxCustomLayoutItemElementPainter.GetViewInfo
  : TdxCustomLayoutItemElementViewInfo;
begin
...
function TdxCustomLayoutItemCaptionPainter.GetViewInfo
  : TdxCustomLayoutItemCaptionViewInfo;
begin
...
procedure TdxCustomLayoutItemCaptionPainter.DoDrawFormattedText
  (ACanvas: TcxCanvas; ARect: TRect);

  procedure DoActuallyDrawFormattedText;
  begin
    ViewInfo.CalculateFormattedText(ViewInfo.FormattedText,
      ViewInfo.CalculateTextFlags, ARect, ACanvas.Canvas, True);
    ...
    begin
      ...
      try
        ABitmap.cxCanvas.FillRect(ABitmap.ClientRect,
          ViewInfo.ItemViewInfo.GetBackgroundColor);
        ...
        cxDrawImage(ACanvas.Handle, ARect, ARect, ABitmap, nil, -1, idmNormal);
      finally
        ABitmap.Free;
      end;
    end;
  end
  else if ViewInfo.IsOnGlass then
    dxDrawTextOnGlass(ACanvas, ViewInfo.Text, ARect,
      ViewInfo.CalculateTextFlags, True, ViewInfo.GetRotationAngle)
  else
    ACanvas.DrawText(ViewInfo.Text, ARect, ViewInfo.CalculateTextFlags,
      DrawEnabled, ViewInfo.GetRotationAngle);
end;
...
function TdxCustomLayoutItemPainter.GetLayoutLookAndFeel
  : TdxCustomLayoutLookAndFeel;
begin
  Result := ViewInfo.LayoutLookAndFeel;
end;
...
begin
  FrameRectByColor(ACanvas.Handle, ViewInfo.SelectionBorderRect,
    TdxLayoutCustomDragAndDropControllerAccess(dxLayoutDragAndDropController)
    .GetDragImageFrameColor(ViewInfo));
end;
...
function TdxLayoutControlItemControlPainter.GetViewInfo
  : TdxLayoutControlItemControlViewInfo;
begin
...
begin
  LayoutLookAndFeel.DrawItemControlBorder(ACanvas,
    ViewInfo.ItemViewInfo.Options, ViewInfo.Bounds);
end;
...
begin
  LookAndFeel.Painter.DrawSeparator(ACanvas, ViewInfo.SeparatorBounds,
    ViewInfo.IsVertical);
end;
...
begin
  ...
  begin
    ...
    try
      ACanvas.ExcludeClipRect(cxRectInflate(ViewInfo.CaptionViewInfo.Bounds,
        cxTextOffset, cxTextOffset));
      DoDrawContent(ACanvas);
    finally
...
function TdxLayoutSeparatorItemPainter.GetViewInfo
  : TdxLayoutSeparatorItemViewInfo;
begin
...
procedure TdxLayoutSplitterItemPainter.DoDrawContent(ACanvas: TcxCanvas);
  ...
  const
    ArrowDirectionHorizontal: array [Boolean, ahLeft .. ahRight]
      of TcxArrowDirection = ((adLeft, adLeft, adRight),
      (adRight, adRight, adLeft));
    ArrowDirectionVertical: array [Boolean, avTop .. avBottom]
      of TcxArrowDirection = ((adUp, adUp, adDown), (adDown, adDown, adUp));
  begin
    case ViewInfo.Splitter.Parent.LayoutDirection of
      ldHorizontal:
        Result := ArrowDirectionHorizontal
          [ViewInfo.Splitter.IsClosed xor ViewInfo.Splitter.Container.
          UseRightToLeftAlignment, ViewInfo.AlignHorz];
    else { ldVertical: }
      Result := ArrowDirectionVertical[ViewInfo.Splitter.IsClosed,
        ViewInfo.AlignVert];
    end;
  end;
  ...
  begin
    Result := ViewInfo.Splitter.AllowCloseOnClick and
      ((not ViewInfo.IsVertical and (ViewInfo.AlignVert in [avTop, avBottom]))
      or (ViewInfo.IsVertical and (ViewInfo.AlignHorz in [ahLeft, ahRight])));
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      try
        if ViewInfo.IsVertical then
          ACanvas.SetClipRegion(TcxRegion.Create(cxRectInflate(ViewInfo.Bounds,
            ViewInfo.Splitter.ScaleFactor.Apply(4), 0)), roSet)
        else
          ACanvas.SetClipRegion(TcxRegion.Create(cxRectInflate(ViewInfo.Bounds,
            0, ViewInfo.Splitter.ScaleFactor.Apply(4))), roSet);

        LookAndFeel.Painter.DrawScaledSplitter(ACanvas, ViewInfo.Bounds,
          levsHot in ViewInfo.State, levsPressed in ViewInfo.State,
          not ViewInfo.IsVertical, ViewInfo.Splitter.ScaleFactor, True,
          GetArrowDirection);
      finally
    ...
    LookAndFeel.Painter.DrawScaledSplitter(ACanvas, ViewInfo.Bounds,
      levsHot in ViewInfo.State, levsPressed in ViewInfo.State,
      not ViewInfo.IsVertical, ViewInfo.Splitter.ScaleFactor);
end;

function TdxLayoutSplitterItemPainter.GetViewInfo
  : TdxLayoutSplitterItemViewInfo;
begin
...
begin
  Result := inherited CanDrawCaption or
    (ViewInfo.IsDragImagePainting and not ViewInfo.ActuallyVisible);
end;

function TdxLayoutLabeledItemPainter.GetCaptionPainterClass
  : TdxCustomLayoutItemCaptionPainterClass;
begin
...
begin
  ...
  ARect := cxGetImageRect(ViewInfo.ImageAreaBounds, AImageSize,
    AItem.ImageFitMode);
...
begin
  ...
  if TdxCustomLayoutLookAndFeelAccess(LayoutLookAndFeel).DoesCxLookAndFeelHavePriority
  then
    APainter := LookAndFeel.Painter
  else
    APainter := nil;

  DrawScaledEditCheck(ACanvas, ViewInfo.CheckAreaBounds, ViewInfo.Item.State,
    GetEditCheckState, ViewInfo.Item.CheckBoxOptions.Glyph,
    ViewInfo.Item.CheckBoxOptions.GlyphCount,
    TcxEditCheckBoxBorderStyle.ebsNone, LookAndFeel.NativeStyle, clNone, clNone,
    False, ViewInfo.Item.IsDesigning, ViewInfo.Item.IsFocused,
    ViewInfo.Item.CheckBoxOptions.AllowGrayed, APainter,
    ViewInfo.Item.ScaleFactor);
  AFocusRect := ViewInfo.GetFocusRect(ACanvas);
  if ViewInfo.Item.CanFocus and ViewInfo.Item.IsFocused and
    not cxRectIsEmpty(AFocusRect) then
...
begin
  ...
  if not ViewInfo.Enabled then
    Result := ecsDisabled
  else if levsPressed in ViewInfo.State then
    Result := ecsPressed
  else if levsHot in ViewInfo.State then
    Result := ecsHot;
end;

function TdxLayoutCheckBoxItemPainter.GetViewInfo
  : TdxLayoutCheckBoxItemViewInfo;
begin
...
begin
  ...
  LookAndFeel.GetAvailablePainter(totButton).DrawScaledRadioButton(ACanvas,
    ViewInfo.CheckAreaBounds.Left, ViewInfo.CheckAreaBounds.Top, GetButtonState,
    ViewInfo.Item.Checked, ViewInfo.Item.IsFocused,
    CBrushColorMap[Assigned(LookAndFeel.SkinPainter)],
    ViewInfo.Item.ScaleFactor, ViewInfo.Item.IsDesigning);
  if ViewInfo.Item.CanFocus and ViewInfo.Item.IsFocused then
    ACanvas.DrawFocusRect(ViewInfo.GetFocusRect(ACanvas));
end;
...
function TdxLayoutRadioButtonItemPainter.GetViewInfo
  : TdxLayoutRadioButtonItemViewInfo;
begin
...
function TdxLayoutControlItemPainter.GetCaptionPainterClass
  : TdxCustomLayoutItemCaptionPainterClass;
begin
  Result := TdxLayoutControlItemCaptionPainter;
end;

function TdxLayoutControlItemPainter.GetControlPainterClass
...
function TdxLayoutItemPainter.GetCaptionPainterClass
  : TdxCustomLayoutItemCaptionPainterClass;
begin
  Result := TdxLayoutItemCaptionPainter;
end;

function TdxLayoutItemPainter.GetControlPainterClass
  : TdxLayoutControlItemControlPainterClass;
begin
...
begin
  ...
  try
    ...
    begin
      ...
      ViewInfo.Item.Control.Perform(WM_ERASEBKGND, ACanvas.Handle,
        ACanvas.Handle);
...
begin
  ...
  if (ViewInfo.IsExpandButton or ViewInfo.IsHomeButton) or
    IsGlyphAssigned(ViewInfo.Glyph) then
  begin
...
function TdxLayoutGroupButtonPainter.CreateInternalGlyph
  (APainter: TcxCustomLookAndFeelPainter): TcxBitmap32;

  procedure DrawGroupHomeButtonMark(ACanvas: TcxCanvas;
    APainter: TcxCustomLookAndFeelPainter; R: TRect);
  begin
  ...
  begin
    AIsAlphaSupported := (APainter.LookAndFeelStyle = lfsSkin) and
      ViewInfo.IsExpandButton;
    ...
    if ViewInfo.IsExpandButton then
      APainter.DrawGroupBoxScaledExpandGlyph(Result.cxCanvas, Result.ClientRect,
        ViewInfo.GetState, ViewInfo.IsGroupExpanded, dxDefaultScaleFactor)
...
begin
  ...
  begin
    Result := TcxBitmap32.CreateSize
      (ScaleFactor.Apply(ViewInfo.Glyph.ClientRect), True);
    cxDrawImage(Result.cxCanvas, Result.ClientRect, ViewInfo.Glyph, ifmNormal,
      GetLayoutLookAndFeel.GetGroupButtonColorPalette(ViewInfo.GetState),
      ScaleFactor)
  end
  else if ViewInfo.IsExpandButton or ViewInfo.IsHomeButton then
  begin
    ...
    begin
      ...
      try
        Result := TcxBitmap32.CreateSize
          (ScaleFactor.Apply(ATempBitmap.ClientRect));
...
procedure TdxLayoutGroupButtonPainter.DrawButton(ACanvas: TcxCanvas;
  APainter: TcxCustomLookAndFeelPainter; AGlyph: TGraphic);
var
  ABitmap: TcxBitmap;
begin
  APainter.DrawGroupBoxScaledButton(ACanvas, ViewInfo.Bounds, ViewInfo.GetState,
    ScaleFactor);
  if AGlyph <> nil then
  begin
    ABitmap := TcxAlphaBitmap.CreateSize(AGlyph.Width, AGlyph.Height, True);
    try
      cxDrawImage(ABitmap.Canvas.Handle, ABitmap.ClientRect, ABitmap.ClientRect,
        AGlyph, nil, -1, idmNormal, False, 0, clNone, True,
        GetLayoutLookAndFeel.GetGroupButtonColorPalette(ViewInfo.GetState));
      ACanvas.RotateBitmap(ABitmap, ViewInfo.GetRotationAngle);
      cxDrawImage(ACanvas, cxRectCenter(ViewInfo.Bounds, ABitmap.Width,
        ABitmap.Height), ABitmap, nil, -1, ViewInfo.IsEnabled);
    finally
      ABitmap.Free;
    end;
  end;
...
begin
  ...
  then
    ...
    APainter := nil;
  DrawScaledEditCheck(ACanvas, cxRectCenter(ViewInfo.Bounds, ASize),
    TdxLayoutGroupCheckBoxButton(ViewInfo.Button).State,
    AViewInfo.GetEditCheckState, nil, 0, TcxEditCheckBoxBorderStyle.ebsNone,
    LookAndFeel.NativeStyle, clNone, clNone, False, ViewInfo.Item.IsDesigning,
    ViewInfo.Item.IsFocused, False, APainter, ViewInfo.Item.ScaleFactor);
end;
...
function TdxLayoutGroupPainter.GetCaptionPainterClass
  : TdxCustomLayoutItemCaptionPainterClass;
begin
...
type
  ...
  private
    FItems: TList;
    function GetCount: Integer;
    function GetInstance(AClass: TdxCustomLayoutHitTestClass)
      : TdxCustomLayoutHitTest;
    function GetItem(Index: Integer): TdxCustomLayoutHitTest;
  protected
    function GetObjectByClass(AClass: TdxCustomLayoutHitTestClass)
      : TdxCustomLayoutHitTest;
    property Count: Integer read GetCount;
  ...
  public
    constructor Create;
    destructor Destroy; override;
    property Instances[AClass: TdxCustomLayoutHitTestClass]
      : TdxCustomLayoutHitTest read GetInstance; default;
  end;
...
function THitTests.GetInstance(AClass: TdxCustomLayoutHitTestClass)
  : TdxCustomLayoutHitTest;
begin
...
function THitTests.GetObjectByClass(AClass: TdxCustomLayoutHitTestClass)
  : TdxCustomLayoutHitTest;
var
  I: Integer;
begin
...
function TdxCustomLayoutHitTest.CanDragAndDrop(AItem: TdxCustomLayoutItem;
  const P: TPoint): Boolean;
begin
  Result := (AItem <> nil) and (AItem.Container.IsCustomization or
    AItem.CanQuickDragAndDrop) and AItem.CanDragAndDrop(P);
end;
...
function TdxCustomLayoutHitTest.GetDragAndDropObjectClass
...
function TdxLayoutTabbedGroupHitTest.GetSpecific
  : TdxLayoutGroupViewInfoTabbedSpecific;
begin
...
function TdxLayoutSizeHitTest.GetDragAndDropObjectClass
  : TcxDragAndDropObjectClass;
begin
...
function TdxLayoutSplitterHitTest.CanDragAndDrop(AItem: TdxCustomLayoutItem;
  const P: TPoint): Boolean;
begin
...
function TdxLayoutSplitterHitTest.GetDragAndDropObjectClass
  : TcxDragAndDropObjectClass;
begin
  if (Item as TdxLayoutSplitterItem).IsVertical then
...
begin
  Result := Buttons.Options.Group.GetNamePath + '.' +
    Format('Button[%d]', [Index]);
end;
...
function TdxCustomLayoutGroupButton.GetViewInfoClass
  : TdxLayoutGroupButtonViewInfoClass;
begin
...
function TdxLayoutGroupCheckBoxButton.GetViewInfoClass
  : TdxLayoutGroupButtonViewInfoClass;
begin
...
procedure TdxLayoutGroupCheckBoxButton.ToggleChildrenEnabledState
  (AGroup: TdxCustomLayoutGroup; const AEnabled: Boolean);
var
  I: Integer;
begin
  AGroup.BeginUpdate;
  try
    ...
    begin
      ...
      if AGroup[I].IsGroup and
        (not AEnabled or AGroup[I].AsGroup.ButtonOptions.CheckBox.Checked) then
...
begin
  if (FState <> AValue) and Buttons.Options.Group.DoCheckBoxStateChanging(AValue)
  then
  begin
    FState := AValue;
    if not Buttons.Options.Group.IsDesigning and
      (CheckAction = cbaToggleChildrenEnabledState) then
...
constructor TdxCustomLayoutGroupButtons.Create
...
function TdxCustomLayoutGroupButtons.GetItemClass
  : TdxCustomLayoutGroupButtonClass;
begin
...
function TdxCustomLayoutGroupButtons.GetItem(Index: Integer)
  : TdxCustomLayoutGroupButton;
begin
...
procedure TdxCustomLayoutGroupButtons.SetItem(Index: Integer;
  const AValue: TdxCustomLayoutGroupButton);
begin
...
procedure TdxLayoutGroupButtons.SetItem(Index: Integer;
  const AValue: TdxLayoutGroupButton);
begin
  inherited Items[Index] := AValue;
end;
...
function TdxLayoutGroupButtonOptions.GetVisibleButton(AIndex: Integer)
  : TdxCustomLayoutGroupButton;
begin
...
begin
  if FHomeButton <> nil then
    FHomeButton.Enabled := (Group.TakeoffParent <> nil) and
      Group.CanMoveTo(Group.TakeoffParent);
end;

procedure TdxLayoutGroupButtonOptions.GetStoredPropertyValue
  (const AName: string; var AValue: Variant);
begin
  if AName = 'ShowExpandButton' then
    AValue := ShowExpandButton
  else if AName = 'CheckBoxChecked' then
    AValue := CheckBox.Checked;
end;

procedure TdxLayoutGroupButtonOptions.GetStoredProperties
  (AProperties: TStrings);
begin
...
procedure TdxLayoutGroupButtonOptions.SetStoredPropertyValue
  (const AName: string; const AValue: Variant);
begin
  if AName = 'ShowExpandButton' then
...
procedure TdxLayoutGroupButtonOptions.GetExpandButtonHintHandler
...
procedure TdxLayoutGroupButtonOptions.SetCheckBox
  (AValue: TdxLayoutGroupCheckBoxButton);
begin
...
procedure TdxLayoutGroupButtonOptions.SetAlignment
  (AValue: TdxLayoutGroupButtonsAlignment);
begin
...
procedure TdxLayoutGroupScrollOptions.SetHorizontalScroll
  (Value: TdxLayoutGroupScrollMode);
begin
...
procedure TdxLayoutGroupScrollOptions.SetVerticalScroll
  (Value: TdxLayoutGroupScrollMode);
begin
...
procedure TdxCustomLayoutGroup.TabChangedHandler(Sender: TObject;
  AType: TcxCustomTabControlPropertiesChangedType);
begin
...
procedure TdxCustomLayoutGroup.TabCanCloseHandler(Sender: TObject;
  ATabIndex: Integer; var ACanClose: Boolean);
begin
  ACanClose := not Container.IsCustomization;
end;

procedure TdxCustomLayoutGroup.TabClickHandler(Sender: TObject;
  ATabVisibleIndex: Integer; AShift: TShiftState);
begin
  VisibleItems[ATabVisibleIndex].DoCaptionClick;
end;

procedure TdxCustomLayoutGroup.TabCloseHandler(Sender: TObject;
  ATabIndex: Integer);
begin
...
function TdxCustomLayoutGroup.GetVisibleItem(Index: Integer)
  : TdxCustomLayoutItem;
begin
...
procedure TdxCustomLayoutGroup.SetScrollOptions
  (Value: TdxLayoutGroupScrollOptions);
begin
...
procedure TdxCustomLayoutGroup.SetButtonOptions
  (Value: TdxLayoutGroupButtonOptions);
begin
  FButtonOptions.Assign(Value);
end;

procedure TdxCustomLayoutGroup.SetCaptionOptions
  (Value: TdxLayoutGroupCaptionOptions);
begin
  inherited CaptionOptions := Value;
end;
...
procedure TdxCustomLayoutGroup.SetItemControlAreaAlignment
  (Value: TdxLayoutItemControlAreaAlignment);
begin
...
begin
  ANeedFocusItem := not(Container.IsCustomization or IsLoading or IsRestoring)
    and (FItemIndex >= 0) and (Value >= 0);
...
procedure TdxCustomLayoutGroup.SetWrapItemsMode
  (Value: TdxLayoutGroupWrapItemsMode);
begin
...
procedure TdxCustomLayoutGroup.ItemListChanged(Sender: TObject;
  AComponent: TComponent; AAction: TcxComponentCollectionNotification);
begin
  Container.CustomizeFormUpdateList(Self);
end;
...
function TdxCustomLayoutGroup.GetChildLayoutLookAndFeel
  : TdxCustomLayoutLookAndFeel;
begin
...
function TdxCustomLayoutGroup.CanAcceptItem(AItem: TdxCustomLayoutItem)
  : Boolean;
begin
...
var
  I: Integer;
begin
  Result := IsDesigning and inherited CanDelete or
    (not IsRoot and not Locked and IsUserDefined);
  if Result then
    for I := 0 to Count - 1 do
    begin
...
begin
  Result := inherited CanDragAndDrop(P) and
    (not IsViewInfoValid or (ViewInfo.ElementWithMouse = nil) or
    ViewInfo.ElementWithMouse.AllowDragDrop);
end;
...
begin
  if IsCheckBoxVisible and ButtonOptions.CheckBox.Enabled and
    ((Parent = nil) or (Parent.LayoutDirection <> ldTabbed)) then
...
begin
  ...
  try
    for I := 0 to VisibleCount - 1 do
      if (LayoutDirection = ldTabbed) or (LayoutDirection = ldHorizontal) and
        (VisibleItems[I].AlignHorz <> ahRight) or (LayoutDirection = ldVertical)
        and (VisibleItems[I].AlignVert <> avBottom) then
...
class function TdxCustomLayoutGroup.GetCaptionOptionsClass
  : TdxCustomLayoutItemCaptionOptionsClass;
begin
...
begin
  inherited;
  if (Count > 0) and
    (ButtonOptions.CheckBox.CheckAction = cbaToggleChildrenEnabledState) and
...
begin
  Result := inherited GetVisible and
    (IsRoot or not Hidden or (VisibleCount > 0) or IsDragged);
end;

function TdxCustomLayoutGroup.GetViewInfoClass
  : TdxCustomLayoutItemViewInfoClass;
begin
  if IsRoot then
...
procedure TdxCustomLayoutGroup.LoadFromIni(AIniFile: TCustomIniFile;
  const ASection: string; AVersion: Integer);
var
...
begin
  ...
  case AVersion of
    3:
      AReader := TdxLayoutGroupReader3;
    2:
      AReader := TdxLayoutGroupReader2;
  else
...
procedure TdxCustomLayoutGroup.SaveToIni(AIniFile: TCustomIniFile;
  const ASection: string);
begin
  inherited;
...
var
  I: Integer;
begin
  Result := inherited ProcessDialogChar(ACharCode) or
    ViewInfo.Specific.ProcessDialogChar(ACharCode);
  if not Result then
    for I := 0 to VisibleCount - 1 do
    begin
...
function TdxCustomLayoutGroup.ProcessDialogKey(ACharCode: Word;
  AKeyData: Integer; AFocusedItem: TdxCustomLayoutItem): Boolean;
var
  I: Integer;
begin
  Result := (AFocusedItem <> Self) and ViewInfo.Specific.ProcessDialogKey
    (ACharCode, AKeyData, AFocusedItem);
  if not Result then
    for I := 0 to VisibleCount - 1 do
    begin
      Result := VisibleItems[I].ProcessDialogKey(ACharCode, AKeyData,
        AFocusedItem);
      if Result then
        Break;
    end;
...
begin
  if not(csAncestor in ComponentState) and
    ...
    ((AIntf.GetContainer.Root = nil) or not AIntf.GetContainer.Root.IsLoading)
  then
...
function TdxCustomLayoutGroup.GetStoredProperties
  (AProperties: TStrings): Boolean;
begin
  Result := inherited GetStoredProperties(AProperties);
...
procedure TdxCustomLayoutGroup.GetStoredPropertyValue(const AName: string;
  var AValue: Variant);
begin
  if AName = 'Hidden' then
    AValue := Hidden
  else if AName = 'LayoutDirection' then
    AValue := Variant(LayoutDirection)
  else if AName = 'ItemIndex' then
    AValue := ItemIndex
  else if AName = 'Expanded' then
    AValue := Expanded
  else if AName = 'ShowBorder' then
    AValue := ShowBorder
  else
  begin
...
procedure TdxCustomLayoutGroup.SetStoredPropertyValue(const AName: string;
  const AValue: Variant);
begin
  if AName = 'Hidden' then
    Hidden := AValue
...
begin
  Result := TdxCustomLayoutItem(AItem1).FLoadedIndex -
    TdxCustomLayoutItem(AItem2).FLoadedIndex;
  if Result = 0 then
    Result := TdxCustomLayoutItem(AItem1).Index - TdxCustomLayoutItem
      (AItem2).Index;
end;
...
procedure TdxCustomLayoutGroup.ApplyCalculatedChanges;
  ...
  begin
    ...
    if (AViewInfo <> nil) and (AViewInfo.FMajorScrollBar <> nil) then
      AViewInfo.FMajorScrollBar.Visible := ActuallyVisible and
        AViewInfo.IsScrollBarsVisible;
    if (AViewInfo <> nil) and (AViewInfo.FMinorScrollBar <> nil) then
      AViewInfo.FMinorScrollBar.Visible := ActuallyVisible and
        AViewInfo.IsScrollBarsVisible;
  end;
...
begin
  Result := (ScrollOptions.Horizontal <> smNone) or
    (ScrollOptions.Vertical <> smNone);
end;
...
function TdxCustomLayoutGroup.DoCheckBoxStateChanging
  (ANewState: TcxCheckBoxState): Boolean;
begin
  Result := True;
...
begin
  ...
  else if (VisibleCount = 0) and (ItemIndex >= 0) then
    FItemIndex := dxLayoutPseudoActiveItem
...
begin
  case LayoutDirection of
    ldHorizontal:
      Result := TdxLayoutHorizontalGroupHelper;
    ldVertical:
      Result := TdxLayoutVerticalGroupHelper;
    ldTabbed:
      Result := TdxLayoutTabbedGroupHelper;
  else
...
begin
  Result := (LayoutDirection <> ldTabbed) and not IsFloatingRoot and
    (WrapItemsMode <> wmNone) and (Count > 1) and
    (CanWrapImmediateChildItems or (Parent <> nil) and
    Parent.CanWrapAllChildItems) and not IsAvailable;
end;
...
begin
  Result := ((WrapItemsMode in [wmImmediateChildren, wmAllChildren]) or
    (WrapItemsMode = wmParentManaged) and
    (IsRoot and Container.AllowGroupWrapItems or (Parent <> nil) and
    Parent.CanWrapAllChildItems));
end;
...
function TdxCustomLayoutGroup.AllowShowChild
  (AChild: TdxCustomLayoutItem): Boolean;
begin
...
procedure TdxCustomLayoutGroup.ChangeItemVisibleIndex
  (AItem: TdxCustomLayoutItem; Value: Integer);
begin
...
function TdxCustomLayoutGroup.VisibleIndexOf
  (AItem: TdxCustomLayoutItem): Integer;
begin
...
function TdxCustomLayoutGroup.CreateGroup(AGroupClass
  : TdxCustomLayoutGroupClass): TdxCustomLayoutGroup;
begin
  Result := Container.CreateGroup(AGroupClass, Self);
end;

function TdxCustomLayoutGroup.CreateItem(AItemClass
  : TdxCustomLayoutItemClass = nil): TdxCustomLayoutItem;
begin
  Result := Container.CreateItem(AItemClass, Self);
end;

function TdxCustomLayoutGroup.CreateItemForControl(AControl: TControl)
  : TdxLayoutItem;
begin
...
begin
  Result := (AParent = nil) or inherited CanMoveTo(AParent) and
    not IsChildItem(AParent);
end;
...
procedure TdxCustomLayoutGroup.MoveChildrenIntoHiddenGroup
  (AGroup: TdxCustomLayoutGroup);
var
  I: Integer;
begin
...
function TdxCustomLayoutGroup.PutChildrenIntoHiddenGroup
  : TdxLayoutAutoCreatedGroup;
begin
  Result := Container.GetAutoCreatedGroup;
  Result.Parent := Self;
...
function TdxLayoutAutoCreatedGroup.IsSuperfluous(AForDestroy: Boolean): Boolean;
  ...
  begin
    Result := (LayoutDirection <> ldTabbed) and
      ((AChild.GetRealAlignVert = GetRealAlignVert) or
      (GetRealAlignVert = avClient) and (Parent.LayoutDirection = ldHorizontal))
      and ((AChild.GetRealAlignHorz = GetRealAlignHorz) or
      (GetRealAlignHorz = ahClient) and (Parent.LayoutDirection = ldVertical));
  end;
...
begin
  if AForDestroy and IsTakeoffParent or FIsFloat or IsDragged or IsLoading or
    Container.IsLoading or (Count > 1) and (WrapItemsMode <> wmParentManaged)
  then
    Result := False
  else
  begin
    Result := not IsRoot and not Locked and not IsSignificantOptionAssigned and
      ((Count = 0) or (Parent <> nil) and
      ((Count = 1) and (not Items[0].IsGroup or
      not Items[0].AsGroup.AutoCreatedForWrap) and
      (IsChildAlignSuperfluous(Items[0]) or IsAlignPushInside or
      IsAlignSuperfluous) or not Parent.AutoCreated and ((Parent.Count = 1) and
      dxLayoutIsSameAlign(TdxLayoutAlign(RealAlign),
      TdxLayoutAlign(Parent.RealAlign)) or
      ((Parent.LayoutDirection = LayoutDirection) or (Parent.Count = 1)) and
      (IsAlignPushInside or IsAlignSuperfluous))));
  end;
end;
...
function TdxLayoutAutoCreatedWrappingGroup.GetChildItemsAlignHorz
  : TdxLayoutRealAlignHorz;
begin
  if Parent <> nil then
    Result := Parent.GetChildItemsAlignHorz
...
function TdxLayoutAutoCreatedWrappingGroup.GetChildItemsAlignVert
  : TdxLayoutRealAlignVert;
begin
  if Parent <> nil then
    Result := Parent.GetChildItemsAlignVert
...
function TdxLayoutAutoCreatedWrappingGroup.IsSuperfluous
  (AForDestroy: Boolean): Boolean;
begin
  if { AForDestroy and IsTakeoffParent or } FIsFloat or IsDragged or
    IsLoading or Container.IsLoading then
    Result := False
  else
    Result := (Parent = nil) or (Count = 0) or
      (Parent.LayoutDirection = LayoutDirection) or (Count = 1) and
      (LayoutDirection = ldVertical) or (Count = 1) and
      (LayoutDirection = ldHorizontal) and
      (Align.Horz in [ahClient, ahParentManaged]) and
      (Items[0].Align.Vert in [avTop, avClient, avParentManaged]);
end;
...
begin
  Result := not Hidden and not IsParentLocked and
    (AllowFloating or Container.AllowFloatingGroups);
end;
...
function TdxLayoutContainer.CloneItem(AItem: TdxCustomLayoutItem;
  AParent: TdxCustomLayoutGroup = nil): TdxCustomLayoutItem;
begin
  if AItem = nil then
    Result := nil
...
function TdxLayoutContainer.CreateAlignmentConstraint
  : TdxLayoutAlignmentConstraint;
begin
...
function TdxLayoutContainer.GetStatusHint(const APoint: TPoint;
  const AOriginalHint: string): string;
var
  AHintInfo: THintInfo;
begin
...
function TdxLayoutContainer.GetHitTest(const P: TPoint): TdxCustomLayoutHitTest;
  ...
  function IsCustomizeFormHitTest(const AScreenPos: TPoint;
    var AHitCustomizeForm: TdxLayoutControlCustomCustomizeForm;
    out AClientPos: TPoint): Boolean;
    ...
    begin
      ...
      begin
        ...
        if not IsDesigning then
          Result := (AHitCustomizeForm.Container = Self) or
            (AHitCustomizeForm.Container = MasterContainer);
      end;
      if Result then
  ...
  begin
    ...
    Result := Check(AControl) or
      ((AControl <> nil) and Check(GetParentForm(AControl)));
  end;
...
begin
  if ([csLoading, csReading, csDestroying] * ComponentState = []) and not IsUpdateLocked
  then
  begin
...
procedure TdxLayoutContainer.CustomizeFormUpdate(AUpdateTypes
  : TdxLayoutCustomizeFormUpdateTypes);
begin
  ...
  if [cfutAvailableItems, cfutVisibleItems] * FCustomizeFormUpdateTypes =
    [cfutAvailableItems, cfutVisibleItems] then
  ...
  if FCustomizeFormUpdateTypes * [cfutSelection, cfutAvailableItems,
    cfutVisibleItems] <> [] then
...
begin
  ...
  begin
    RenameComponents(Self, ItemsParentComponent.Owner, ANewName, AOldName,
      1 + AbsoluteItemCount, @GetItem);
    RenameComponents(Self, ItemsParentComponent.Owner, ANewName, AOldName,
      AlignmentConstraintCount, @GetAlignmentConstraints);
    CustomizeFormPostUpdate([cfutCaption]);
  end;
end;

procedure TdxLayoutContainer.RestoreFromIniFile(const AStorageName: string;
  const ARestoreName: string = '');
begin
  RestoreFrom(AStorageName, nil, TcxIniFileReader, ARestoreName);
end;

procedure TdxLayoutContainer.RestoreFromRegistry(const AStorageName: string;
  const ARestoreName: string = '');
begin
...
procedure TdxLayoutContainer.StoreToStream(AStream: TStream;
  const ASaveName: string = '');
begin
...
procedure TdxLayoutContainer.StoreToStorage(const AStorageName: string;
  AWriterClass: TcxCustomWriterClass; AReCreate: Boolean = True;
  const ASaveName: string = '');
begin
...
procedure TdxLayoutContainer.InvalidateRect(const R: TRect;
...
procedure TdxLayoutContainer.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited;
...
function TdxLayoutContainer.ShowHint(var AHintInfo: THintInfo;
  X, Y: Integer): Boolean;
begin
  Result := ViewInfo.ShowHint(AHintInfo, X, Y);
end;

procedure TdxLayoutContainer.MouseDown(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
...
procedure TdxLayoutContainer.MouseMove(Shift: TShiftState; X, Y: Integer);
  ...
  procedure InternalMouseMove(AContainer: TdxLayoutContainer;
    AScreenPoint: TPoint);
  var
    AClientPoint: TPoint;
  begin
...
begin
  ...
  begin
    ...
    begin
      ...
      for I := 0 to FFloatContainers.Count - 1 do
        InternalMouseMove(TdxLayoutContainer(FFloatContainers[I]),
          AScreenPoint);
    end;
  end;
end;

procedure TdxLayoutContainer.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
...
function TdxLayoutContainer.CalculateCustomizeFormBounds(const AFormBounds
  : TRect): TRect;
var
  AControlBounds, ADesktopBounds: TRect;
begin
  AControlBounds := dxMapWindowRect(ItemsParentControl.Parent.Handle, 0,
    ItemsParentControl.BoundsRect);
  ...
  begin
    ...
    OffsetRect(Result, 0, (Top + Bottom - (Result.Bottom - Result.Top)) div 2 -
      Result.Top);
  end;
...
begin
  ...
  FCustomizeForm.AssignFont(TcxControlAccess(ItemsParentControl).Font,
    TcxControlAccess(ItemsParentControl).ScaleFactor);
  FCustomizeForm.Container := RealContainer;
end;

function TdxLayoutContainer.GetCustomizeForm
  : TdxLayoutControlCustomCustomizeForm;
begin
...
function TdxLayoutContainer.DoMouseWheel(Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
...
begin
  ...
  Result := Result or ((Message.CharCode in [VK_UP, VK_DOWN, VK_LEFT, VK_RIGHT])
    and ((FocusController.FocusedItem is TdxCustomLayoutCheckableItem) or
    ((FocusController.FocusedItem = nil) and
    ((Message.Sender is TCustomCheckBox) or
    (Message.Sender is TcxCustomCheckBox) or
    (Message.Sender is TRadioButton)))));
end;

function TdxLayoutContainer.IsMouseWheelHandleNeeded(Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
  Result := not IsUpdateLocked and ViewInfo.IsMouseWheelHandleNeeded(Shift,
    WheelDelta, MousePos);
end;
...
function TdxLayoutContainer.GetAlignmentConstraintClass
  : TdxLayoutAlignmentConstraintClass;
begin
  Result := TdxLayoutAlignmentConstraint;
end;

function TdxLayoutContainer.GetCustomizationHelperClass
  : TdxLayoutContainerCustomizationHelperClass;
begin
...
function TdxLayoutContainer.GetFocusControllerClass
  : TdxLayoutContainerFocusControllerClass;
begin
...
function TdxLayoutContainer.GetSelectionHelperClass
...
begin
  Result := not IsGlobalDestroying and not IsLoading and not IsUpdateLocked and
    CanUpdate and (GetLayoutLookAndFeel <> nil) and (ItemsParentControl <> nil);
end;
...
begin
  if (IsContainerReady or FCalculationDireNeeded) and not IsProcessingControls
  then
  begin
...
begin
  Result := GetHeight(TdxCustomLayoutItem(AItem1)) -
    GetHeight(TdxCustomLayoutItem(AItem2));
end;
...
begin
  ...
  for I := 0 to AItem.Parent.Count - 1 do
    if (AItem <> AItem.Parent[I]) and
      (GetHeight(AItem) < GetHeight(AItem.Parent[I])) then
    begin
      Result := False;
      Break;
    end;
...
function TdxLayoutContainer.AddWrapLevel(AGroup: TdxCustomLayoutGroup;
  ALayoutDirection: TdxLayoutDirection): TdxLayoutAutoCreatedWrappingGroup;
begin
  Result := TdxLayoutAutoCreatedWrappingGroup
    (CreateGroup(TdxLayoutAutoCreatedWrappingGroup, AGroup));
  Result.LayoutDirection := ALayoutDirection;
end;

function TdxLayoutContainer.SimpleWrap(AGroup: TdxCustomLayoutGroup;
  AMaxWidth: Integer): Boolean;

  function GetWidthForItem(AGroup: TdxCustomLayoutGroup;
    AItem: TdxCustomLayoutItem): Integer;
  begin
  ...
  function GetItemsWidth(AGroup: TdxCustomLayoutGroup;
  ...
  function SimpleOptimize(AGroup: TdxCustomLayoutGroup; AMaxWidth: Integer;
    AHeightInc: Integer): Boolean;
  var
    I: Integer;
  ...
  begin
    ...
    begin
      ANewWidth := GetItemsWidth(AGroup, I - 1) + Max(GetWidth(AGroup[I - 1]),
        GetWidth(AGroup[I]));
      if I > 1 then
        Inc(ANewWidth, GetItemOffset(AGroup));
      if ANewWidth > AMaxWidth then
        Break;
      if not IsItemHighest(AGroup[I - 1]) and
        (GetHeight(AGroup[I - 1]) + GetHeight(AGroup[I]) < AGroupHeight) then
      begin
  ...
  procedure OptimizeWrapY(AGroup: TdxCustomLayoutGroup; AMaxWidth: Integer;
    AHeightInc: Integer);
  begin
    while (GetWidth(AGroup) > AMaxWidth) and SimpleOptimize(AGroup, AMaxWidth,
      AHeightInc) do
      { loop };
  end;

  procedure OptimizeWrap(AGroup1, AGroup2: TdxCustomLayoutGroup;
    AMaxWidth: Integer);
  var
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if AllowOptimizeWrappedItems and IsItemMostHighest(ACurrentItem) and
          (ACurrentLevel.Index > 0) and
          (GetHeight(AGroup[ACurrentLevel.Index - 1]) * 1.5 <
          GetHeight(ACurrentItem)) then
        begin
          OptimizeWrap(AGroup[ACurrentLevel.Index - 1] as TdxCustomLayoutGroup,
            ACurrentLevel, AMaxWidth);
          if ACurrentLevel.Count = 0 then
          begin
            ANewLevel := AGroup[ACurrentLevel.Index - 1]
              as TdxCustomLayoutGroup;
            ACurrentLevel.Free;
        ...
        begin
          ...
          begin
            if ACurrentLevel.Index = AGroup.Count - 1 then
              OptimizeWrapY(ACurrentLevel, AMaxWidth,
                GetHeight(ACurrentItem) div 2)
            else
              OptimizeWrapY(ACurrentLevel, AMaxWidth, 0);

            if (GetWidth(ACurrentLevel) > AMaxWidth) and
              (IsItemHighest(ACurrentLevel[ACurrentLevel.Count - 1])) then
            // rollback
            begin
              I := 0;
              while I < ACurrentLevel.Count do
              begin
                if ACurrentLevel.Items[0].IsGroup and ACurrentLevel.Items[0]
                  .AsGroup.AutoCreatedForWrap and
                  (ACurrentLevel.Items[0].AsGroup.FWrappingState = wsPopulated)
                then
          ...
          if (GetWidth(ACurrentLevel) > AMaxWidth) and (ACurrentLevel.Count > 1)
          then
          begin
...
procedure TdxLayoutContainer.PopulateWrappingGroups;
  ...
  function GetCorrectedMaxWidth(AGroup: TdxCustomLayoutGroup;
    AMaxWidth: Integer): Integer;
  var
    I, AVisibleIndex: Integer;
    AItemMaxWidth, AGroupCurrentWidth, AGroupMaxWidth, AGroupSpace: Integer;
    AUsedWidth, ARequiredMaxWidth, ARequiredSpace, AFreeSpace,
      ARequiredMinWidth: Integer;
    AItem: TdxCustomLayoutItem;
  begin
    Result := AMaxWidth;
    if (AGroup.Parent <> nil) and (AGroup.Parent.LayoutDirection = ldHorizontal)
      and (AGroup.Parent.VisibleCount > 1) then
    begin
      ...
      AFreeSpace := AMaxWidth - AUsedWidth - GetItemOffset(AGroup.Parent) *
        (AGroup.Parent.VisibleCount - 1);
    ...
    if not AGroup.Hidden then
      Result := Result - (cxRectWidth(AGroup.ViewInfo.Bounds) -
        cxRectWidth(AGroup.ViewInfo.ItemsAreaBounds));
  end;
  ...
  begin
    ...
    begin
      ...
      begin
        AItem := AGroup.VisibleItems[I];
        if AItem.IsGroup then
          PopulateWrappingGroup(AItem.AsGroup,
            GetCorrectedMaxWidth(AItem.AsGroup, AMaxWidth));
      end;
      AGroup.FWrappingState := wsPopulated;
    end
    else
...
begin
  PopulateWrappingGroup(Root, cxRectWidth(ClientBounds) -
    (cxRectWidth(Root.ViewInfo.Bounds) -
    cxRectWidth(Root.ViewInfo.ItemsAreaBounds)));
  Root.DoChildPack;
...
procedure TdxLayoutContainer.UnclenchWrappingGroup
  (AGroup: TdxCustomLayoutGroup);
var
  I: Integer;
  AItem: TdxCustomLayoutItem;
begin
  ...
  begin
    ...
    if AItem.IsGroup and
      AItem.AsGroup.AutoCreatedForWrap { and not AGroup[I].IsDragged } then
...
function TdxLayoutContainer.GetFloatDock(AItem: TdxCustomLayoutItem)
  : TdxLayoutGroup;
begin
  Result := nil;
end;
...
procedure TdxLayoutContainer.CustomizeFormPostUpdate(AUpdateTypes
  : TdxLayoutCustomizeFormUpdateTypes);
begin
  // do nothing
end;

procedure TdxLayoutContainer.CustomizeFormUpdateList
  (AItem: TdxCustomLayoutItem);
const
  UpdateTypeMap: array [Boolean] of TdxLayoutCustomizeFormUpdateType =
    (cfutVisibleItems, cfutAvailableItems);
begin
  RealContainer.CustomizeFormPostUpdate([UpdateTypeMap[AItem.IsAvailable]]);
end;

function TdxLayoutContainer.DoGetCustomizationMenuItems(const ASelectedItems
  : TList): TdxLayoutCustomizeFormMenuItems;
begin
  if IsDesigning then
...
begin
  Result := FQuickCustomization or (MasterContainer <> nil) and
    MasterContainer.IsQuickCustomization;
end;
...
begin
  ...
  try
    GetSelection(AList);
    if (AList.Count > 0) and Supports(AList[0], IdxLayoutSelectableItem, AIntf)
    then
      AIntf.SelectParent;
  finally
    AList.Free;
...
procedure TdxLayoutContainer.BeginRename(AItem: TdxCustomLayoutItem;
  const ABounds: TRect; const AFont: TFont);
begin
  RenamingItem := AItem;
  ViewInfo.SelectionLayer.BeginRename(ABounds,
    FRenamingItem.GetInplaceRenameCaption, AFont);
end;
...
procedure TdxLayoutContainer.PlaceControls(AItemViewInfo
  : TdxCustomLayoutItemViewInfo = nil);
begin
...
procedure TdxLayoutContainer.UnprepareControl(AControl: TControl);
  ...
  function GetControlWithTopPos(AWinControl: TWinControl;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if IsDesigning and not(csDestroying in AControl.ComponentState) and
          GetAllowedParent(AParent) then
        begin
    ...
    procedure TdxLayoutContainer.BeforeRestoring;
      ...
      begin
        for I := ManagedItemCount - 1 downto 0 do
          ...
          begin
            dxTestCheck(ManagedItems[I].AsGroup.Count = 0,
              'TdxLayoutContainer.BeforeRestoring fails');
            ManagedItems[I].Free;
          end;
      end;
    ...
    function TdxLayoutContainer.GetRootSectionName
    ...
    function TdxLayoutContainer.LoadPreviousVersions
      (AIniFile: TCustomIniFile): Boolean;
    var
      ...
      procedure LoadItem(const ASection: string);
        ...
        function GetItemClass(AItemClassKind: Integer)
          : TdxCustomLayoutItemClass;
        const
          AClasses: array [0 .. ickItemClassCount - 1]
            of TdxCustomLayoutItemClass = (TdxLayoutItem, TdxLayoutGroup,
            TdxLayoutEmptySpaceItem, TdxLayoutSeparatorItem,
            TdxLayoutSplitterItem, TdxLayoutLabeledItem, TdxLayoutImageItem,
            TdxLayoutAutoCreatedGroup, TdxLayoutCheckBoxItem,
            TdxLayoutRadioButtonItem);
        var
          I: Integer;
        begin
      ...
      begin
        ...
        if AItem = nil then
        begin
          AItemClassKind := AIniFile.ReadInteger(ASection, 'ItemClassKind',
            TdxLayoutGroup.GetItemClassKind);
          AItem := CreateItem(GetItemClass(AItemClassKind));
          AItem.Name := AName;
          AItem.IsUserDefined := AIniFile.ReadBool(ASection,
            'IsUserDefined', True);
          AItem.Superfluous := not AItem.IsUserDefined or
            ((AVersion < 3) and (AItemClassKind = ickControlItem));
        end
        else
    ...
    function TdxLayoutContainer.CanSetItemName
      (AItem: TdxCustomLayoutItem): Boolean;
    begin
      Result := (ItemsParentComponent <> nil) and not IsLoading and
    ...
    function TdxLayoutContainer.GetLayoutLookAndFeel
      : TdxCustomLayoutLookAndFeel;
    begin
      Result := FLayoutLookAndFeel;
      if Result = nil then
    ...
    begin
      ...
      else if Assigned(FOnItemChanged) then
        FOnItemChanged(AItem);
    end;

    procedure TdxLayoutContainer.ExtractAbsoluteItem
      (AItem: TdxCustomLayoutItem);
    begin
      FAbsoluteItems.Extract(AItem);
    end;

    procedure TdxLayoutContainer.ExtractAvailableItem
      (AItem: TdxCustomLayoutItem);
    begin
    ...
    begin
      SetComponentName(AItem, AItem.GetBaseName, AItem.IsDesigning,
        AItem.IsLoading);
    end;
    ...
    begin
      ...
      begin
        ...
        if (AItem is TdxLayoutItem) and (TdxLayoutItem(AItem).Control = AControl)
        then
        begin
    ...
    function TdxLayoutContainer.FindItem(AControlHandle: THandle)
      : TdxLayoutItem;
    var
      I: Integer;
      AItem: TdxCustomLayoutItem;
    ...
    function TdxLayoutContainer.FindItem(const AName: string)
      : TdxCustomLayoutItem;
    var
      I: Integer;
    begin
    ...
    procedure TdxLayoutContainer.SelectionChanged(ASelection: TList;
      AAction: TdxSelectionAction);
      ...
      begin
        ...
        try
          GetSelection(AList);
          if (AList.Count > 0) and Supports(TObject(AList.Last),
            IdxLayoutSelectableItem, AIntf) then
          begin
            AIntf.MakeVisible;
            AIntf := nil;
          end;
    ...
    begin
      ...
      if not IsDestroying and (AAction in [saAdded, saChanged]) and not IsUpdateLocked
      then
      begin
    ...
    procedure TdxLayoutContainer.AddSelectionChangedListener
    ...
    function TdxLayoutContainer.CanDeleteComponent
      (AComponent: TComponent): Boolean;
    begin
      Result := (SelectionHelper <> nil) and SelectionHelper.CanDeleteComponent
        (AComponent);
    end;
    ...
    function TdxLayoutContainer.IsComponentSelected
      (AComponent: TPersistent): Boolean;
    begin
      Result := (SelectionHelper <> nil) and SelectionHelper.IsComponentSelected
        (AComponent);
    end;

    procedure TdxLayoutContainer.RemoveSelectionChangedListener
      (AListener: TPersistent);
    begin
      if SelectionHelper <> nil then
    ...
    procedure TdxLayoutContainer.SelectComponent(AComponent: TPersistent;
      AShift: TShiftState = []);
    begin
      if SelectionHelper <> nil then
    ...
    procedure TdxLayoutContainer.DoGetStoredPropertyValue(const AName: string;
      var AValue: Variant);
    begin
      // do nothing
    end;

    procedure TdxLayoutContainer.DoSetStoredPropertyValue(const AName: string;
      const AValue: Variant);
    begin
      // do nothing
    end;
    ...
    function TdxLayoutContainer.GetStoredProperties
      (AProperties: TStrings): Boolean;
    begin
      Result := True;
    ...
    procedure TdxLayoutContainer.GetStoredPropertyValue(const AName: string;
      var AValue: Variant);
    begin
    ...
    procedure TdxLayoutContainer.SetStoredPropertyValue(const AName: string;
      const AValue: Variant);
    begin
      if AName = 'Version' then
    ...
    function TdxLayoutContainer.CreateChild(const AObjectName,
    ...
    procedure TdxLayoutContainer.DeleteChild(const AObjectName: string;
      AObject: TObject);
    begin
    end;
    ...
    procedure TdxLayoutContainer.GetStoredChildren(AChildren: TStringList);
      ...
      begin
        for I := 0 to AContainer.ManagedItemCount - 1 do
          AChildren.AddObject(AContainer.ManagedItems[I].Name,
            AContainer.ManagedItems[I])
      end;
    ...
    procedure TdxLayoutContainer.GetItemStoredProperties
    ...
    procedure TdxLayoutContainer.RestoreFrom(const AStorageName: string;
      AStream: TStream; AReaderClass: TcxCustomReaderClass;
      const ARestoreName: string);
    var
      AStorage: TcxStorage;
    begin
    ...
    procedure TdxLayoutContainer.StoreTo(const AStorageName: string;
    ...
    begin
      AWnd := GetFocus;
      if ItemsParentControl.HandleAllocated and
        (AWnd = ItemsParentControl.Handle) then
    ...
    function TdxLayoutContainer.ProcessDialogKey(ACharCode: Word;
      AKeyData: Integer): Boolean;
    var
      AFocusedItem: TdxCustomLayoutItem;
    begin
      AFocusedItem := FindFocusedItem;
      Result := not IsUpdateLocked and (AFocusedItem <> nil) and
        Root.ProcessDialogKey(ACharCode, AKeyData, AFocusedItem);
    end;
    ...
    function TdxLayoutContainer.CreateItemSelectorHelper(AItem: TdxLayoutItem)
    ...
    procedure TdxLayoutContainer.MakeVisible(const ARect: TRect;
      AFully: Boolean);
    begin
      // do nothing
    end;
    ...
    begin
      ...
      try
        ...
        begin
          ...
          if (AItem is TdxLayoutItem) and (TdxLayoutItem(AItem).Control <> nil)
          then
    ...
    function TdxLayoutContainer.CreateGroup(AGroupClass
      : TdxCustomLayoutGroupClass; AParent: TdxCustomLayoutGroup = nil)
      : TdxCustomLayoutGroup;
    begin
    ...
    function TdxLayoutContainer.CreateItem(AItemClass
      : TdxCustomLayoutItemClass = nil; AParent: TdxCustomLayoutGroup = nil)
      : TdxCustomLayoutItem;
    begin
    ...
    function TdxLayoutContainer.CreateItemForControl(AControl: TControl;
      AParent: TdxCustomLayoutGroup = nil): TdxLayoutItem;
    begin
    ...
    procedure TdxLayoutContainer.TryDestroySuperfluousGroup
      (AGroup: TdxCustomLayoutGroup);
    begin
    ...
    begin
      Result := TdxLayoutAutoCreatedGroup
        (CreateGroup(TdxLayoutAutoCreatedGroup));
    end;

    procedure TdxLayoutContainer.AbsoluteItemListChanged(Sender: TObject;
      AComponent: TComponent; AAction: TcxComponentCollectionNotification);
    var
      AGroup: TdxCustomLayoutGroup;
    begin
      // FIsManagedItemsValid := False;
      if (AAction in [ccnExtracting, ccnExtracted, ccnDeleting]) and
        (ViewInfo <> nil) and (ViewInfo.ItemWithMouse = AComponent) then
        ViewInfo.ItemWithMouse := nil;
      if IsDesigning and not IsDestroying and
        (AComponent.ComponentState * [csAncestor, csDestroying] = [csAncestor,
        csDestroying]) then
      begin
    ...
    procedure TdxLayoutContainer.AvailableItemListChanged(Sender: TObject;
      AComponent: TComponent; AAction: TcxComponentCollectionNotification);
    begin
      CustomizeFormPostUpdate([cfutAvailableItems]);
    end;

    procedure TdxLayoutContainer.FloatContainersListChanged(Sender: TObject;
      AComponent: TComponent; AAction: TcxComponentCollectionNotification);
    begin
      CustomizeFormPostUpdate([cfutVisibleItems]);
    end;
    ...
    function TdxLayoutContainer.GetAlignmentConstraint(Index: Integer)
      : TdxLayoutAlignmentConstraint;
    begin
    ...
    procedure TdxLayoutContainer.AddAlignmentConstraint
      (AConstraint: TdxLayoutAlignmentConstraint);
    begin
      FAlignmentConstraints.Add(AConstraint);
      AConstraint.FContainer := Self;
      SetComponentName(AConstraint, Name + 'AlignmentConstraint', IsDesigning,
        IsLoading);
    end;

    procedure TdxLayoutContainer.RemoveAlignmentConstraint
      (AConstraint: TdxLayoutAlignmentConstraint);
    begin
    ...
    function TdxLayoutContainer.GetAbsoluteItem(AIndex: Integer)
      : TdxCustomLayoutItem;
    begin
    ...
    function TdxLayoutContainer.GetAvailableItem(AIndex: Integer)
      : TdxCustomLayoutItem;
    begin
    ...
    function TdxLayoutContainer.GetManagedItem(AIndex: Integer)
      : TdxCustomLayoutItem;
    begin
    ...
    begin
      if MasterContainer <> nil then
        Exit;
      if (FCustomization <> AValue) and
        (not AValue or CanAllocateHandle(ItemsParentControl)) then
      begin
        if AValue then
        begin
          ItemsParentControl.HandleNeeded;
          if not(IsDestroying or IsDesigning) and
            IsChildWindow(ItemsParentControl, GetFocus) then
          begin
    ...
    procedure TdxLayoutContainer.SetLayoutLookAndFeel
      (Value: TdxCustomLayoutLookAndFeel);
    begin
      if FLayoutLookAndFeel <> Value then
      begin
    ...
    begin
      ...
      else if (FQuickCustomization <> Value) and
        (QuickCustomization = Customization) then
      begin
    ...
    procedure TdxLayoutContainer.SetOnItemChanged
      (AValue: TdxLayoutItemChangedEvent);
    var
      I: Integer;
    begin
...
RegisterClasses([TdxLayoutContainer, TdxLayoutItem, TdxLayoutEmptySpaceItem,
  TdxLayoutLabeledItem, TdxLayoutSeparatorItem, TdxLayoutSplitterItem,
  TdxLayoutImageItem, TdxLayoutCheckBoxItem, TdxLayoutRadioButtonItem,
  TdxLayoutGroup, TdxLayoutAutoCreatedGroup, TdxLayoutAutoCreatedWrappingGroup,
  TdxLayoutAlignmentConstraint, TdxLayoutCheckBoxItem]);
