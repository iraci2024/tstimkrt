...
{$ENDIF}
  ...
  Forms,
  dxCore, cxGraphics, cxClasses, cxControls, dxCoreClasses, cxVariants,
  cxStorage,
...
type
  ...
  TdxSpreadSheetCustomConditionalFormattingRuleClass = class of
  ...
  strict private
    function GetCellStyles: TdxSpreadSheetCellStyles;
    function GetRule(Index: Integer)
      : TdxSpreadSheetCustomConditionalFormattingRule; inline;
    function GetRuleCount: Integer;
    procedure RulesChangeHandler(Sender: TObject;
      const AItem: TdxSpreadSheetCustomConditionalFormattingRule;
      AAction: TCollectionNotification);
  protected
    FAreaInfoCache: TObjectDictionary<string,
    ...
    function CreateAreaInfo(AAreas: TdxSpreadSheetAreaList)
      : TdxSpreadSheetConditionalFormattingAreaInfo; virtual;
    function GetAreaInfo(AAreas: TdxSpreadSheetAreaList)
      : TdxSpreadSheetConditionalFormattingAreaInfo;
    ...
    procedure DoRuleAdded
      (ARule: TdxSpreadSheetCustomConditionalFormattingRule); virtual;
  ...
  public
    constructor Create(const AOwner
      : IdxSpreadSheetConditionalFormattingOwner); virtual;
    destructor Destroy; override;
    procedure Add(ARuleClass
      : TdxSpreadSheetCustomConditionalFormattingRuleClass; out ARule);
      overload;
    procedure Add(const AArea: TRect;
      ARuleClass: TdxSpreadSheetCustomConditionalFormattingRuleClass;
      out ARule); overload;
    procedure Assign(ASource
      : TdxSpreadSheetCustomConditionalFormatting); virtual;
    ...
    function CalculateStyle(const AStyle: TdxSpreadSheetCellDisplayStyle;
      ARow, AColumn: Integer; ACell: IdxSpreadSheetCellData): Boolean;
    procedure Clear;
    ...
    // Utilities
    function ReferencesToString(const AAreas: TdxSpreadSheetAreaList)
      : string; virtual;

    property CellStyles: TdxSpreadSheetCellStyles read GetCellStyles;
    property RuleCount: Integer read GetRuleCount;
    property Rules[Index: Integer]
      : TdxSpreadSheetCustomConditionalFormattingRule read GetRule; default;
  ...
  protected
    ...
    procedure DoAssign(Source
      : TdxSpreadSheetCustomConditionalFormattingRule); virtual;
    ...
    procedure Apply(const AStyle: TdxSpreadSheetCellDisplayStyle;
      ARow, AColumn: Integer; const ACell: IdxSpreadSheetCellData = nil);
      virtual; abstract;
    function CanApply(ARow, AColumn: Integer;
      const ACell: IdxSpreadSheetCellData = nil): Boolean;
    function CanApplyCore(ARow, AColumn: Integer;
      const ACell: IdxSpreadSheetCellData = nil): Boolean; virtual; abstract;
...
{$ENDREGION}
  ...
  public
    ...
    constructor Create(AOwner: TdxSpreadSheetCustomConditionalFormatting;
      const AArea: TRect); reintroduce; overload;
    destructor Destroy; override;
    ...
    function Clone(const AArea: TRect)
      : TdxSpreadSheetCustomConditionalFormattingRule; overload;
    function Clone(const AAreas: TdxSpreadSheetAreaList)
      : TdxSpreadSheetCustomConditionalFormattingRule; overload;
    //
  ...
  TdxSpreadSheetConditionalFormattingDataCacheAssignedValue = (dcavMinMax,
    dcavAverage, dcavNumericValueCount, dcavStandardDeviation);
  TdxSpreadSheetConditionalFormattingDataCacheAssignedValues = set of
    TdxSpreadSheetConditionalFormattingDataCacheAssignedValue;
  ...
  strict private
    ...
    function CalculateBoundValueForPercentile(APercentile: Integer;
    ...
    function CheckTopBottomValues(var AList: TList<Double>;
      var AListRank: Integer; ATargetRank: Integer): Boolean;
  ...
  public
    constructor Create(const AOwner: IdxSpreadSheetConditionalFormattingOwner;
  ...
  TdxSpreadSheetConditionalFormattingCustomRuleClass = class of
    TdxSpreadSheetConditionalFormattingCustomRule;
  ...
  protected
    property AreaInfo: TdxSpreadSheetConditionalFormattingAreaInfo
      read GetAreaInfo;
  end;
  ...
  public
    constructor Create(AStyle: TdxSpreadSheetCellDisplayStyle;
    ...
    procedure Draw(ACanvas: TcxCanvas; AStage: TdxSpreadSheetDrawingStage);
      overload; virtual;
    ...
    property SupportedDrawingStages: TdxSpreadSheetDrawingStages
      read GetSupportedDrawingStages;
    property UseRightToLeftLayout: Boolean read FUseRightToLeftLayout
      write FUseRightToLeftLayout;
  end;
...
constructor TdxSpreadSheetCustomConditionalFormatting.Create
  (const AOwner: IdxSpreadSheetConditionalFormattingOwner);
begin
  inherited Create;
  FOwner := AOwner;
...
begin
  TdxSpreadSheetCustomConditionalFormattingRule(ARule) :=
    ARuleClass.Create(Self);
end;

procedure TdxSpreadSheetCustomConditionalFormatting.Add(const AArea: TRect;
  ARuleClass: TdxSpreadSheetCustomConditionalFormattingRuleClass; out ARule);
begin
  TdxSpreadSheetCustomConditionalFormattingRule(ARule) :=
    ARuleClass.Create(Self, AArea);
end;

procedure TdxSpreadSheetCustomConditionalFormatting.Assign
...
begin
  ...
  try
    ...
    begin
      ...
      Add(TdxSpreadSheetConditionalFormattingCustomRuleClass
        (ASourceRule.ClassType), ATargetRule);
...
procedure TdxSpreadSheetCustomConditionalFormatting.Remove
    ...
    try
      ...
      try
        ...
        for I := AList.Count - 1 downto 0 do
          TdxSpreadSheetCustomConditionalFormattingRule(AList[I])
            .Apply(AStyle, ARow, AColumn, ACell);
      finally
        AList.Free;
      end;
    finally
...
procedure TdxSpreadSheetCustomConditionalFormatting.EndEditing
  (ACancel: Boolean);
begin
  EndUpdate;
end;

function TdxSpreadSheetCustomConditionalFormatting.ReferencesToString
...
function TdxSpreadSheetCustomConditionalFormatting.
...
function TdxSpreadSheetCustomConditionalFormatting.
  IsStyleBorderSupported: Boolean;
begin
  Result := True;
end;
...
procedure TdxSpreadSheetCustomConditionalFormatting.DoRuleAdded
  (ARule: TdxSpreadSheetCustomConditionalFormattingRule);
begin
  FRules.Add(ARule);
end;

procedure TdxSpreadSheetCustomConditionalFormatting.DoRuleChanging
  (ARule: TdxSpreadSheetCustomConditionalFormattingRule);
begin
  // do nothing
end;

procedure TdxSpreadSheetCustomConditionalFormatting.DoRuleIndexChanged
  (AOldIndex, ANewIndex: Integer);
begin
  // do nothing
end;

procedure TdxSpreadSheetCustomConditionalFormatting.DoRuleDeleted
  (ARule: TdxSpreadSheetCustomConditionalFormattingRule);
begin
  if FRules <> nil then
...
function TdxSpreadSheetCustomConditionalFormatting.GetCellStyles
  : TdxSpreadSheetCellStyles;
begin
  Result := Owner.CellStyles;
end;

function TdxSpreadSheetCustomConditionalFormatting.GetRule(Index: Integer)
  : TdxSpreadSheetCustomConditionalFormattingRule;
begin
  Result := FRules[Index];
end;
...
procedure TdxSpreadSheetCustomConditionalFormatting.RulesChangeHandler
  (Sender: TObject; const AItem: TdxSpreadSheetCustomConditionalFormattingRule;
  AAction: TCollectionNotification);
begin
  DoChanged;
end;
...
procedure TdxSpreadSheetCustomConditionalFormattingRule.Assign
  (Source: TPersistent);
begin
  if (Source is TdxSpreadSheetCustomConditionalFormattingRule) and
    (Source <> Self) then
  begin
    BeginUpdate;
    try
...
function TdxSpreadSheetCustomConditionalFormattingRule.Clone(const AArea: TRect)
  : TdxSpreadSheetCustomConditionalFormattingRule;
var
...
function TdxSpreadSheetCustomConditionalFormattingRule.Clone
  (const AAreas: TdxSpreadSheetAreaList)
  : TdxSpreadSheetCustomConditionalFormattingRule;
begin
  Result := TdxSpreadSheetCustomConditionalFormattingRuleClass(ClassType)
    .Create(Owner);
  Result.BeginUpdate;
  try
    Result.Assign(Self);
...
procedure TdxSpreadSheetCustomConditionalFormattingRule.LoadFromStream
  (AReader: TcxReader);
begin
  BeginUpdate;
  try
...
procedure TdxSpreadSheetCustomConditionalFormattingRule.SaveToStream
  (AWriter: TcxWriter);
begin
  DoSaveToStream(AWriter);
end;

procedure TdxSpreadSheetCustomConditionalFormattingRule.AreasChangeHandler
  (Sender: TObject);
begin
  Changed;
end;
...
function TdxSpreadSheetCustomConditionalFormattingRule.CanApply(ARow,
  AColumn: Integer; const ACell: IdxSpreadSheetCellData = nil): Boolean;
begin
  try
    Result := Areas.Contains(ARow, AColumn) and
      CanApplyCore(ARow, AColumn, ACell);
  except
    Result := False;
  end;
end;

procedure TdxSpreadSheetCustomConditionalFormattingRule.DoAssign
...
procedure TdxSpreadSheetCustomConditionalFormattingRule.DoLoadFromStream
  (AReader: TcxReader);
var
  ACount: Integer;
  I: Integer;
...
procedure TdxSpreadSheetCustomConditionalFormattingRule.DoSaveToStream
  (AWriter: TcxWriter);
var
  I: Integer;
begin
...
function TdxSpreadSheetCustomConditionalFormattingRule.
...
function TdxSpreadSheetCustomConditionalFormattingRule.GetProperties
...
procedure TdxSpreadSheetCustomConditionalFormattingRule.GetPropertyValue
...
procedure TdxSpreadSheetCustomConditionalFormattingRule.SetPropertyValue
...
procedure TdxSpreadSheetCustomConditionalFormattingRule.SetArea
  (const AValue: TRect);
begin
  BeginUpdate;
  try
...
procedure TdxSpreadSheetCustomConditionalFormattingRule.SetAreas
  (AAreas: TdxSpreadSheetAreaList);
begin
  BeginUpdate;
  try
...
procedure TdxSpreadSheetCustomConditionalFormattingRule.SetIndex
  (AValue: Integer);
var
  AIndex: Integer;
begin
...
procedure TdxSpreadSheetCustomConditionalFormattingRule.SetStopIfTrue
...
function TdxSpreadSheetConditionalFormattingAreaInfo.GetLimitValueForPercent
  (APercent: Integer): Double;
begin
  Result := MinValue + (MaxValue - MinValue) * APercent / 100;
end;

function TdxSpreadSheetConditionalFormattingAreaInfo.GetLimitValueForPercentile
  (APercentile: Integer): Double;
begin
  Result := 0;
  if (FPercentiles = nil) or not FPercentiles.TryGetValue(APercentile, Result)
  then
  begin
...
function TdxSpreadSheetConditionalFormattingAreaInfo.IsBottomValue
  (const AValue: Double; ARank: Integer): Boolean;
begin
  Result := CheckTopBottomValues(FBottomValues, FBottomValuesRank, ARank) and
    (AValue <= FBottomValues[ARank - 1]);
end;

function TdxSpreadSheetConditionalFormattingAreaInfo.IsTopValue
  (const AValue: Double; ARank: Integer): Boolean;
begin
  Result := CheckTopBottomValues(FTopValues, FTopValuesRank, ARank) and
    (AValue >= FTopValues[ARank - 1]);
end;

function TdxSpreadSheetConditionalFormattingAreaInfo.IsUniqueValue
  (const AValue: Variant): Boolean;
begin
  if FDuplicates = nil then
  begin
    FDuplicates := TdxVariantSet.Create(Min(GetCellCountInAreas,
      MaxInitialCapacity));
...
begin
  ...
  begin
    ...
    EnumCells(procedure(const ACell: IdxSpreadSheetCellData)
      begin
...
function TdxSpreadSheetConditionalFormattingAreaInfo.
  CalculateBoundValueForPercentile(APercentile: Integer;
out AValue: Double): Boolean;
var
  AIndex: Integer;
...
procedure TdxSpreadSheetConditionalFormattingAreaInfo.
...
begin
  ...
  begin
    ...
    EnumCells(procedure(const ACell: IdxSpreadSheetCellData)
      begin
        if ACell.IsNumericValue then
          FStandardDeviation := FStandardDeviation + AScaleFactor *
            Sqr(ACell.AsFloat - AAverageValue);
      end);
  ...
  if GetSortedNumericValuesInArea(AValues) then
    try
      ...
      begin
        ...
        for I := AValues.Count - 1 downto Max(0,
          AValues.Count - FTopValuesRank - 2) do
      ...
      if (FBottomValues <> nil) and (FBottomValuesRank <> FBottomValues.Count)
      then
      begin
        FBottomValues.Clear;
        ...
        while (FBottomValues.Count > 0) and
          (FBottomValues.Count < FBottomValuesRank) do
...
function TdxSpreadSheetConditionalFormattingAreaInfo.CheckTopBottomValues
  (var AList: TList<Double>; var AListRank: Integer;
ATargetRank: Integer): Boolean;
begin
  ...
  Result := (AList <> nil) and (ATargetRank > 0) and
    (ATargetRank <= AList.Count);
end;

procedure TdxSpreadSheetConditionalFormattingAreaInfo.EnumCells
  (const AProc: TdxSpreadSheetViewForEachCellProc);
var
  I: Integer;
begin
  for I := 0 to Areas.Count - 1 do
...
function TdxSpreadSheetConditionalFormattingAreaInfo.
  GetSortedNumericValuesInArea(out AValues: TList<Double>): Boolean;
var
  AList: TList<Double>;
begin
...
begin
  ATempList := TdxVariantSet.Create(Min(GetCellCountInAreas,
    MaxInitialCapacity));
  try
    EnumCells(procedure(const ACell: IdxSpreadSheetCellData)
      var
...
function TdxSpreadSheetConditionalFormattingCustomRule.GetAreaInfo
  : TdxSpreadSheetConditionalFormattingAreaInfo;
begin
...
procedure TdxSpreadSheetConditionalFormattingStyleViewInfo.Calculate
  (const ABounds: TRect);
begin
...
procedure TdxSpreadSheetConditionalFormattingStyleViewInfo.
  CalculateDataBarBounds(const R: TRect);
...
procedure TdxSpreadSheetConditionalFormattingStyleViewInfo.CalculateIconBounds
  (var R: TRect);
var
  AImageSetSize: TSize;
begin
  ...
  begin
    AImageSetSize := dxGetImageSize(ConditionalFormattingIconSet.Icons,
      FScaleFactor);
    if UseRightToLeftLayout then
    begin
...
procedure TdxSpreadSheetConditionalFormattingStyleViewInfo.Draw
  (ACanvas: TcxCanvas);
begin
  ...
  begin
    if DataBar.AxisColor <> clNone then
      dxSpreadSheetDrawBackground(ACanvas, DataBarAxisBounds,
        cxGetActualColor(BackgroundColor, ACanvas.Brush.Color),
        DataBar.AxisColor, sscfsGray75);

    if DataBar.Color1 <> clNone then
    begin
      dxGpFillRectByGradient(ACanvas.Handle, DataBarBounds, DataBar.Color1,
        DataBar.Color2, LinearGradientModeHorizontal);
      if DataBar.Border <> clNone then
        ACanvas.FrameRect(DataBarBounds, DataBar.Border);
    end;
  end;
  if AStage = dsSecond then
    cxDrawImage(ACanvas, IconBounds, nil, ConditionalFormattingIconSet.Icons,
      Style.IconIndex, True, nil, ScaleFactor);
end;

procedure TdxSpreadSheetConditionalFormattingStyleViewInfo.Offset
...
function TdxSpreadSheetConditionalFormattingStyleViewInfo.
  GetSupportedDrawingStages: TdxSpreadSheetDrawingStages;
begin
  Result := [];
...
function TdxSpreadSheetConditionalFormattingStyleViewInfo.GetDataBar
