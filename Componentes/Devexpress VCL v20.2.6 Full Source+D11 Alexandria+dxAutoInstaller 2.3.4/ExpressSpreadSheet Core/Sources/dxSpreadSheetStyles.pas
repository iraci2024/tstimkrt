...
{$ENDIF}
  ...
  dxCore, dxCoreClasses, cxGraphics, dxHashUtils, cxClasses, cxFormats,
  cxVariants,
  dxSpreadSheetTypes,
...
type
  ...
  IdxSpreadSheetCellStyleOwner = interface
    ...
    property FormatSettings: TdxSpreadSheetCustomFormatSettings
  ...
  protected
    procedure ChangeBorder(AStyle: TdxSpreadSheetCellBorderStyle;
      AColor: TColor);
    //
    property Handle: TdxSpreadSheetBordersHandle read GetHandle write SetHandle;
    property Kind: TcxBorder read FKind;
  public
    constructor Create(AOwner: TdxSpreadSheetCellStyle; AKind: TcxBorder);
      reintroduce;
  ...
  strict private
    ...
    procedure SetBorder(ABorder: TcxBorder;
      const AValue: TdxSpreadSheetCellBorder);
  ...
  protected
    ...
    procedure ProcessStyleChanges(APrevStyle,
      ANewStyle: TdxSpreadSheetCellStyleHandle); virtual;
  ...
  public
    constructor Create(const AOwner: IdxSpreadSheetCellStyleOwner);
      overload; virtual;
    constructor Create(const AOwner: IdxSpreadSheetCellStyleOwner;
      AHandle: TdxSpreadSheetCellStyleHandle); overload; virtual;
    ...
    property AlignHorz: TdxSpreadSheetDataAlignHorz read GetAlignHorz
      write SetAlignHorz;
    property AlignHorzIndent: Integer read GetAlignHorzIndent
      write SetAlignHorzIndent;
    property AlignVert: TdxSpreadSheetDataAlignVert read GetAlignVert
      write SetAlignVert;
    property Borders[ABorder: TcxBorder]: TdxSpreadSheetCellBorder
      read GetBorder write SetBorder;
    property Brush: TdxSpreadSheetCellBrush read GetBrush write SetBrush;
    property DataFormat: TdxSpreadSheetCellDataFormat read GetDataFormat
      write SetDataFormat;
  ...
  public
    constructor Create(const AOwner: IdxSpreadSheetCellStyleOwner;
      AHandle: TdxSpreadSheetCellStyleHandle); override;
    destructor Destroy; override;
    procedure Reset;
    //
...
constructor TdxSpreadSheetCellBorder.Create(AOwner: TdxSpreadSheetCellStyle;
  AKind: TcxBorder);
begin
  inherited Create;
  FOwner := AOwner;
...
procedure TdxSpreadSheetCellBorder.ChangeBorder
...
procedure TdxSpreadSheetCellBorder.SetHandle(const AValue
...
procedure TdxSpreadSheetCellBorder.SetStyle(const AValue
...
procedure TdxSpreadSheetCellBrush.SetHandle(const AValue
...
constructor TdxSpreadSheetCellDataFormat.Create
...
procedure TdxSpreadSheetCellDataFormat.SetHandle
...
procedure TdxSpreadSheetCellFont.SetHandle(const AValue
...
constructor TdxSpreadSheetCellStyle.Create(const AOwner
  : IdxSpreadSheetCellStyleOwner);
begin
...
constructor TdxSpreadSheetCellStyle.Create(const AOwner
  : IdxSpreadSheetCellStyleOwner; AHandle: TdxSpreadSheetCellStyleHandle);
begin
  inherited Create;
  FOwner := AOwner;
...
procedure TdxSpreadSheetCellStyle.Merge(AColumnStyle,
...
begin
  ...
  else if UpdateLockCount = 0 then
...
procedure TdxSpreadSheetCellStyle.SetState(const AValue
  : TdxSpreadSheetCellStates);
begin
...
procedure TdxSpreadSheetCellStyle.SetHandle(const AHandle
...
procedure TdxSpreadSheetCellStyle.ProcessStyleChanges(APrevStyle,
  ANewStyle: TdxSpreadSheetCellStyleHandle);
begin
...
procedure TdxSpreadSheetCellStyle.ChangeState(AState: TdxSpreadSheetCellState;
  AValue: Boolean);
begin
  if AValue then
    State := State + [AState]
...
function TdxSpreadSheetCellStyle.GetBorder(ABorder: TcxBorder)
  : TdxSpreadSheetCellBorder;
begin
...
function TdxSpreadSheetCellStyle.GetFormatSettings
...
procedure TdxSpreadSheetCellStyle.SetAlignHorz(const AValue
...
procedure TdxSpreadSheetCellStyle.SetAlignVert(const AValue
...
procedure TdxSpreadSheetCellStyle.SetBorder(ABorder: TcxBorder;
  const AValue: TdxSpreadSheetCellBorder);
begin
  Borders[ABorder].Assign(AValue);
end;

procedure TdxSpreadSheetCellStyle.SetBrush(const AValue
  : TdxSpreadSheetCellBrush);
begin
  Brush.Assign(AValue);
end;

procedure TdxSpreadSheetCellStyle.SetDataFormat(const AValue
  : TdxSpreadSheetCellDataFormat);
begin
...
constructor TdxSpreadSheetCellDisplayStyle.Create(const AOwner
  : IdxSpreadSheetCellStyleOwner; AHandle: TdxSpreadSheetCellStyleHandle);
begin
...
function TdxSpreadSheetCellDisplayStyle.CreateDataBar
  : TdxSpreadSheetCellDataBar;
begin
...
constructor TdxSpreadSheetCellStyleMergeHelper.Create(APrevStyle,
  ANewStyle: TdxSpreadSheetCellStyleHandle);
begin
  inherited Create;
  FNewStyle := ANewStyle;
...
procedure TdxSpreadSheetCellStyleMergeHelper.ProcessCellStyle
...
begin
  FIsUpdateBestFitNeeded := (PrevStyle.DataFormat <> NewStyle.DataFormat) or
    (PrevStyle.Font <> NewStyle.Font) or (PrevStyle.States <> NewStyle.States)
    or (PrevStyle.Borders <> NewStyle.Borders);
end;

procedure TdxSpreadSheetCellStyleMergeHelper.MergeAlignment
  (ACellStyle: TdxSpreadSheetCellStyle);
begin
...
procedure TdxSpreadSheetCellStyleMergeHelper.MergeBorders
  (ACellStyle: TdxSpreadSheetCellStyle);
var
  ABorder: TcxBorder;
begin
  for ABorder := Low(ABorder) to High(ABorder) do
  begin
    if PrevStyle.Borders.BorderColor[ABorder] <> NewStyle.Borders.BorderColor
      [ABorder] then
      ACellStyle.Borders[ABorder].Color := NewStyle.Borders.BorderColor
        [ABorder];
    if PrevStyle.Borders.BorderStyle[ABorder] <> NewStyle.Borders.BorderStyle
      [ABorder] then
      ACellStyle.Borders[ABorder].Style := NewStyle.Borders.BorderStyle
        [ABorder];
  end;
end;

procedure TdxSpreadSheetCellStyleMergeHelper.MergeBrush
  (ACellStyle: TdxSpreadSheetCellStyle);
begin
...
procedure TdxSpreadSheetCellStyleMergeHelper.MergeFont
  (ACellStyle: TdxSpreadSheetCellStyle);
...
procedure TdxSpreadSheetCellStyleMergeHelper.MergeStates
  (ACellStyle: TdxSpreadSheetCellStyle);
var
  AState: TdxSpreadSheetCellState;
begin
  if PrevStyle.States <> NewStyle.States then
    for AState := Low(TdxSpreadSheetCellState)
      to High(TdxSpreadSheetCellState) do
