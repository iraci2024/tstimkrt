...
resourcestring
  ...
  sdxErrorCannotRenameSheet =
    'Cannot rename a sheet to the same name as existing sheet.';
  sdxErrorCellProtected =
  ...
  sdxErrorCommentAlreadyExists =
    'Comment container for the "%s" cell already exists';
  sdxErrorDefinedNameAlreadyExists = 'Duplicate name "%s" is found';
  sdxErrorDocumentIsCorrupted = 'Document is corrupted';
  sdxErrorExternalLinkAlreadyExists =
    'An external link named "%s" already exists';
  sdxErrorFieldNotFound = 'The %s field was not found';
  sdxErrorFileCannotBeFoundInPackage =
    'File "%s" cannot be found in the package';
  ...
  sdxErrorInvalidDefinedNameSyntax = 'The syntax of this name is incorrect.' +
    dxCRLF + dxCRLF + 'Verify that the name:' + dxCRLF +
  ...
  sdxErrorInvalidSelection =
    'This command cannot be used on multiple selections or an empty selection';
  sdxErrorInvalidPasteArea =
    'Cannot paste into selected area because its size is not the same as the copied area''s size';
  ...
  sdxErrorMaxOutlineLevel =
    'The number of outline levels for both rows and columns cannot be more than 8.';
  sdxErrorPictureCannotBeFound = 'Picture "%s" cannot be found';
  sdxErrorCannotExecuteActionOnProtectedSheet =
  ...
  sdxErrorCircularMessage = 'Warning' + #13#10 +
    ...
    + 'circular references.' + #13#10#13#10 +
  ...
  sdxConditionalFormattingAboveAverageOnStandardDeviation =
    '%d std dev above average for the selected range';
  sdxConditionalFormattingAboveOrEqualAverage =
    'Above or equal average for the selected range';
  ...
  sdxConditionalFormattingBelowAverageOnStandardDeviation =
    '%d std dev below average for the selected range';
  sdxConditionalFormattingBelowOrEqualAverage =
    'Below or equal average for the selected range';
...
begin
  ...
  AProduct.Add('sdxErrorCannotChangePartOfArray',
    @sdxErrorCannotChangePartOfArray);
  AProduct.Add('sdxErrorCellProtected', @sdxErrorCellProtected);
  AProduct.Add('sdxErrorColorValueIsNotSpecified',
    @sdxErrorColorValueIsNotSpecified);
  AProduct.Add('sdxErrorCommentAlreadyExists', @sdxErrorCommentAlreadyExists);
  AProduct.Add('sdxErrorDefinedNameAlreadyExists',
    @sdxErrorDefinedNameAlreadyExists);
  AProduct.Add('sdxErrorDocumentIsCorrupted', @sdxErrorDocumentIsCorrupted);
  AProduct.Add('sdxErrorExternalLinkAlreadyExists',
    @sdxErrorExternalLinkAlreadyExists);
  AProduct.Add('sdxErrorFieldNotFound', @sdxErrorFieldNotFound);
  AProduct.Add('sdxErrorFileCannotBeFoundInPackage',
    @sdxErrorFileCannotBeFoundInPackage);
  ...
  AProduct.Add('sdxErrorInvalidAnchorDefinition',
    @sdxErrorInvalidAnchorDefinition);
  ...
  AProduct.Add('sdxErrorInvalidDefinedNameSyntax',
  ...
  AProduct.Add('sdxErrorInvalidSharedStringIndex',
    @sdxErrorInvalidSharedStringIndex);
  ...
  AProduct.Add('sdxErrorCannotExecuteActionOnProtectedSheet',
    @sdxErrorCannotExecuteActionOnProtectedSheet);
  AProduct.Add('sdxErrorUnsupportedDocumentFormat',
    @sdxErrorUnsupportedDocumentFormat);
  ...
  AProduct.Add('sdxErrorCannotMoveBecauseOfMergedCells',
    @sdxErrorCannotMoveBecauseOfMergedCells);
  AProduct.Add('sdxReplaceCellsDataConfirmation',
    @sdxReplaceCellsDataConfirmation);
  ...
  AProduct.Add('sdxConditionalFormattingCellIsRuleDetailsBetween',
    @sdxConditionalFormattingCellIsRuleDetailsBetween);
  AProduct.Add('sdxConditionalFormattingCellIsRuleDetailsEqual',
    @sdxConditionalFormattingCellIsRuleDetailsEqual);
  AProduct.Add('sdxConditionalFormattingCellIsRuleDetailsGreaterThan',
    @sdxConditionalFormattingCellIsRuleDetailsGreaterThan);
  AProduct.Add('sdxConditionalFormattingCellIsRuleDetailsGreaterThanOrEqual',
    @sdxConditionalFormattingCellIsRuleDetailsGreaterThanOrEqual);
  AProduct.Add('sdxConditionalFormattingCellIsRuleDetailsLessThan',
    @sdxConditionalFormattingCellIsRuleDetailsLessThan);
  AProduct.Add('sdxConditionalFormattingCellIsRuleDetailsLessThanOrEqual',
    @sdxConditionalFormattingCellIsRuleDetailsLessThanOrEqual);
  AProduct.Add('sdxConditionalFormattingCellIsRuleDetailsNotBetween',
    @sdxConditionalFormattingCellIsRuleDetailsNotBetween);
  AProduct.Add('sdxConditionalFormattingCellIsRuleDetailsNotEqual',
    @sdxConditionalFormattingCellIsRuleDetailsNotEqual);
  AProduct.Add('sdxConditionalFormattingDuplicateValuesRuleDetails',
    @sdxConditionalFormattingDuplicateValuesRuleDetails);
  AProduct.Add('sdxConditionalFormattingExpressionRuleDetails',
    @sdxConditionalFormattingExpressionRuleDetails);
  AProduct.Add('sdxConditionalFormattingUniqueValuesRuleDetails',
    @sdxConditionalFormattingUniqueValuesRuleDetails);

  AProduct.Add('sdxConditionalFormattingCellIsRuleComparisonOperatorBetween',
    @sdxConditionalFormattingCellIsRuleComparisonOperatorBetween);
  AProduct.Add('sdxConditionalFormattingCellIsRuleComparisonOperatorEqual',
  ...
  AProduct.Add
    ('sdxConditionalFormattingCellIsRuleComparisonOperatorGreaterThanOrEqual',
    @sdxConditionalFormattingCellIsRuleComparisonOperatorGreaterThanOrEqual);
  AProduct.Add('sdxConditionalFormattingCellIsRuleComparisonOperatorLessThan',
    @sdxConditionalFormattingCellIsRuleComparisonOperatorLessThan);
  AProduct.Add
    ('sdxConditionalFormattingCellIsRuleComparisonOperatorLessThanOrEqual',
    @sdxConditionalFormattingCellIsRuleComparisonOperatorLessThanOrEqual);
  AProduct.Add('sdxConditionalFormattingCellIsRuleComparisonOperatorNotBetween',
    @sdxConditionalFormattingCellIsRuleComparisonOperatorNotBetween);
  AProduct.Add('sdxConditionalFormattingCellIsRuleComparisonOperatorNotEqual',
    @sdxConditionalFormattingCellIsRuleComparisonOperatorNotEqual);

  AProduct.Add('sdxConditionalFormattingAboveAverage',
    @sdxConditionalFormattingAboveAverage);
  AProduct.Add('sdxConditionalFormattingAboveAverageOnStandardDeviation',
    @sdxConditionalFormattingAboveAverageOnStandardDeviation);
  AProduct.Add('sdxConditionalFormattingAboveOrEqualAverage',
    @sdxConditionalFormattingAboveOrEqualAverage);
  AProduct.Add('sdxConditionalFormattingBelowAverage',
    @sdxConditionalFormattingBelowAverage);
  AProduct.Add('sdxConditionalFormattingBelowAverageOnStandardDeviation',
    @sdxConditionalFormattingBelowAverageOnStandardDeviation);
  AProduct.Add('sdxConditionalFormattingBelowOrEqualAverage',
    @sdxConditionalFormattingBelowOrEqualAverage);

  AProduct.Add('sdxConditionalFormattingBottomValues',
    @sdxConditionalFormattingBottomValues);
  AProduct.Add('sdxConditionalFormattingTopValues',
    @sdxConditionalFormattingTopValues);
  AProduct.Add('sdxConditionalFormattingColorScale',
    @sdxConditionalFormattingColorScale);
  AProduct.Add('sdxConditionalFormattingIconSet',
    @sdxConditionalFormattingIconSet);
  AProduct.Add('sdxConditionalFormattingDataBar',
