...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Forms, Windows, Classes, Types, SysUtils, Graphics, Controls, DB,
  Generics.Defaults, Generics.Collections, Variants,
  cxTreeView, ComCtrls, Math, dxCore, cxClasses, cxControls, cxDB, cxDBData,
  cxGeometry, cxGraphics, dxSpreadSheetTypes,
  dxSpreadSheetCore, dxSpreadSheetFunctions, dxSpreadSheetFormulas,
  dxGDIPlusClasses, cxLookAndFeelPainters, dxHashUtils,
  dxSpreadSheetGraphics, dxSpreadSheetSelection, dxSpreadSheetClasses,
  dxSpreadSheetUtils, dxSpreadSheetContainers, cxVariants,
  dxSpreadSheetFormatBinary, cxCustomData, cxDataStorage, cxFilter,
  cxFilterControl, cxEdit, cxEditDBRegisteredRepositoryItems,
  dxCustomTree, dxForms, dxSpreadSheetStyles, dxSpreadSheetCoreStyles,
  dxSpreadSheetCoreFormulas, dxSpreadSheetCoreReferences,
...
type
  ...
  TdxSpreadSheetReportSectionType = (rstHeader, rstDetail, rstFooter,
    rstDetailLevel, rstGroupHeader, rstGroupFooter);

  TdxSpreadSheetReportOrientation = (roHorizontal, roVertical);
  TdxSpreadSheetReportMode = (rmSingleSheet, rmMultipleSheets,
    rmMultipleDocuments);
  ...
  published
    property DesignView: Boolean read FDesignView write SetDesignView
      default True;
    property Orientation: TdxSpreadSheetReportOrientation read FOrientation
      write SetOrientation default roVertical;
    property ReportMode: TdxSpreadSheetReportMode read FReportMode
      write SetReportMode default rmSingleSheet;
  end;
  ...
  protected
    ...
    procedure CalculateCache(ASheet: TdxSpreadSheetTableView;
      ADetails: TObjectList<TdxSpreadSheetReportLevelBuildInfo>;
      AIsVerticalLayout: Boolean);
    procedure ClearCache;
  public
    Name: TdxSpreadSheetDefinedName;
    SectionType: TdxSpreadSheetReportSectionType;

    constructor Create(AName: TdxSpreadSheetDefinedName;
  ...
  public
    ...
    function Find(const AName: string;
      out ASection: TdxSpreadSheetReportSection): Boolean;
    function FindByCell(const ARow, AColumn: Integer;
      out ASection: TdxSpreadSheetReportSection): Boolean;
  ...
  public
    ...
    property DataController: TdxSpreadSheetReportDataController
  ...
  public
    ...
    property Designer: TdxSpreadSheetReportDesigner read GetDesigner;
    property Items[Index: Integer]: TdxSpreadSheetReportSortedField read GetItem
  ...
  public
    property Items[Index: Integer]: TdxSpreadSheetReportDataGroup read GetItem
      write SetItem; default;
  end;

  { TdxSpreadSheetReportDataController }

  TdxSpreadSheetReportDataController = class(TcxDBDataController,
    IcxFilterControl)
  strict private
    FDisplayName: string;
    ...
    procedure SetField(AIndex: Integer;
      AValue: TdxSpreadSheetReportDesignerDataField);
  protected
    ...
    procedure Changed; virtual;
    function CreateItemByField(AField: TField)
      : TdxSpreadSheetReportDesignerDataField; virtual;
    procedure DoDataSourceChanged; override;
    function GetFieldName(const AFieldName: string;
      AUseStorageName: Boolean = True): string;
    procedure MasterDetailRelationsInitialize;
    procedure MasterDetailRelationsFinalize;

    procedure PopulateFields(AFields
      : TDictionary<string, TdxSpreadSheetReportDesignerDataField>);
    ...
    property MasterDataController: TdxSpreadSheetReportDataController
      read GetDataControllerFromOwner;
  ...
  public
    ...
    function AddField: TdxSpreadSheetReportDesignerDataField;
    ...
    property Fields[AIndex: Integer]: TdxSpreadSheetReportDesignerDataField
  ...
  published
    ...
    property DisplayName: string read GetDisplayName write SetDisplayName
      stored IsDisplayNameStored;
  end;

  { TdxSpreadSheetReportDetail }

  TdxSpreadSheetReportDetail = class(TcxComponentCollectionItem,
    IcxFilterControl)
  strict private
    FDataController: TdxSpreadSheetReportDataController;
  ...
  public
    ...
    property Designer: TdxSpreadSheetReportDesigner read GetDesigner;
  published
    property DataGroups: TdxSpreadSheetReportDataGroups read FDataGroups
      write SetDataGroups;
    property DataSource: TDataSource read GetDataSource write SetDataSource;
    property Details: TdxSpreadSheetReportDetails read FDetails
      write SetDetails;
    property MasterKeyFieldName: string read GetMasterKeyFieldName
      write SetMasterKeyFieldName;
    property DetailKeyFieldName: string read GetDetailKeyFieldName
      write SetDetailKeyFieldName;
    property Options: TdxSpreadSheetReportDataControllerOptions read FOptions
      write SetOptions;
    property SectionID: Integer read FSectionID write SetSectionID;
    property SortedFields: TdxSpreadSheetReportSortedFields read FSortedFields
      write SetSortedFields;
  end;
  ...
  protected
    ...
    property MasterDataController: TdxSpreadSheetReportDataController
      read GetMasterDataController;
  public
    function Add: TdxSpreadSheetReportDetail;

    property Designer: TdxSpreadSheetReportDesigner read GetDesigner;
    property Items[AIndex: Integer]: TdxSpreadSheetReportDetail read GetItem
      write SetItem; default;
  end;
  ...
  protected
    ...
    property Fields: TDictionary<string, TdxSpreadSheetReportDesignerDataField>
      read FFields;
  public
  ...
  TdxSpreadSheetReportFormulaController = class(TdxSpreadSheetFormulaController,
    IdxSpreadSheetDataBinding)
  strict private
  ...
  protected
    ...
    procedure PopulateLevel(AParent: TTreeNode;
      ADataController: TdxSpreadSheetReportDataController;
      ADetails: TdxSpreadSheetReportDetails);
    procedure PopulateTableItems(AParent: TTreeNode;
      ADataController: TdxSpreadSheetReportDataController);
    procedure ProcessDetails(AParent: TTreeNode;
      ADetails: TdxSpreadSheetReportDetails);
  public
    constructor Create(AOwner: TdxSpreadSheetReportDesignerFieldChooser);
      reintroduce; overload;
    destructor Destroy; override;
  ...
  protected
    function CreateFieldChooserForm
      : TdxSpreadSheetReportDesignerFieldChooserForm; virtual;
  ...
  strict private
    ...
    FStyles: TDictionary<TdxSpreadSheetCellStyleHandle,
      TdxSpreadSheetCellStyleHandle>;

    function GetDataBinding: TdxSpreadSheetReportDataBinding;
    procedure SetProgressValue(AValue: Integer);
  protected
    function CheckAndExpandRange(AInfo: TdxSpreadSheetReportLevelBuildInfo;
      var R: TRect): Boolean;
    procedure CopyCell(ASource: TdxSpreadSheetCell;
      ADestRow: TdxSpreadSheetTableItem; ADestIndex: Integer); virtual;
    procedure CopySettingsForTableItem(ASource: TdxSpreadSheetTableItem;
      ADestItems: TdxSpreadSheetTableItems; ADestIndex: Integer;
      ACheckItemExist: Boolean); virtual;
    ...
    procedure DoBuildDetailLevel
      (AInfo: TdxSpreadSheetReportLevelBuildInfo); virtual;
    procedure DoBuildDetailSection(AInfo: TdxSpreadSheetReportLevelBuildInfo;
      var ARowIndex: Integer); virtual;
    procedure DoBuildDetailSectionDataGroups
      (AInfo: TdxSpreadSheetReportLevelBuildInfo; var ARowIndex: Integer);
    procedure DoBuildDetailSectionDataRow
      (AInfo: TdxSpreadSheetReportLevelBuildInfo; var ARowIndex: Integer);
    procedure DoBuildDetailSectionDetails
      (AInfo: TdxSpreadSheetReportLevelBuildInfo; var ARowIndex: Integer);
    procedure DoBuildSection(ASection: TdxSpreadSheetReportSection);
      overload; virtual;
    procedure DoBuildSection(ASection: TdxSpreadSheetReportSection;
      ADetails: TObjectList<TdxSpreadSheetReportLevelBuildInfo>;
      AIsFirstStage: Boolean); overload; virtual;
    procedure DoBuildSectionFormulas(ASection: TdxSpreadSheetReportSection;
      AIsFirstStage: Boolean);

    function GetDesignerSection(const ARootBounds: TRect;
      AType: TdxSpreadSheetReportSectionType; AIndex: Integer;
      var ASectionBounds: TRect): TdxSpreadSheetReportSection;
    ...
    function MakeGroupLevelInfo(AParent: TdxSpreadSheetReportLevelBuildInfo;
      AIndex: Integer): TdxSpreadSheetReportLevelBuildInfo;
    function MakeLevelInfo(AParent: TdxSpreadSheetReportLevelBuildInfo;
      ADetail: TdxSpreadSheetReportDetail)
      : TdxSpreadSheetReportLevelBuildInfo; overload;
    function MakeLevelInfo(AParent: TdxSpreadSheetReportLevelBuildInfo;
      ADataController: TdxSpreadSheetReportDataController;
      ADetails: TdxSpreadSheetReportDetails; AIndex: Integer)
      : TdxSpreadSheetReportLevelBuildInfo; overload;
    function MakeLocalArea(const AArea, ASourceArea, ADestArea: TRect;
      var ALocalArea: TRect): Boolean;
    procedure NewSheet;
    procedure PostProcessFormulas; virtual;
    procedure PostProcessSection(var ASection: TdxSpreadSheetReportSection;
      AIndex: Integer; ANeedAutoHeight: Boolean);
    ...
    property PostProcessFormulasList: TList<TdxSpreadSheetCustomFormula>
      read FPostProcessFormulasList;
  ...
  public
    ...
    property ActiveDataController: TdxSpreadSheetReportDataController
      read FActiveDataController;
    property CurrentColumnIndex: Integer read FCurrentColumnIndex;
    property CurrentLevel: TdxSpreadSheetReportLevelBuildInfo
      read FCurrentLevel;
    ...
    property DataBinding: TdxSpreadSheetReportDataBinding read GetDataBinding;
    property Designer: TdxSpreadSheetReportDesigner read FDesigner;
    property Destination: TdxCustomSpreadSheet read FDestination
      write FDestination;
    ...
    property Styles: TDictionary<TdxSpreadSheetCellStyleHandle,
      TdxSpreadSheetCellStyleHandle> read FStyles;
  end;

  { TdxSpreadSheetReport }

  TdxSpreadSheetReportDesignerPopulateFieldEvent = procedure
    (Sender: TdxSpreadSheetReportDesigner; AField: TField; var Allow: Boolean)
    of object;
  TdxSpreadSheetReportDesignerNewDocumentEvent = procedure
    (Sender: TdxSpreadSheetReportDesigner;
    var ADestination: TdxCustomSpreadSheet) of object;
  TdxSpreadSheetReportDesignerNewReportSheetEvent = procedure
    (Sender: TdxSpreadSheetReportDesigner; ANewSheet: TdxSpreadSheetTableView)
    of object;
  ...
  protected
    procedure AddFormulaInfo(AFormula: TdxSpreadSheetCustomFormula;
      AIsDBFormula: Boolean);
    function AddPicture(AFormula: TdxSpreadSheetCustomFormula;
      APictureInfo: TObject): Integer;
    ...
    function CreateFieldChooser
      : TdxSpreadSheetReportDesignerFieldChooser; virtual;
    ...
    procedure DragOverCore(const P: TPoint; ADragObject: TDragObject;
      var AAccept: Boolean);
    procedure ForceRefreshFormulas; virtual;
    function GetDataControllerForSection(ASection: TdxSpreadSheetReportSection)
      : TdxSpreadSheetReportDataController;
    ...
    procedure SetSectionInfo(const AName: string; const ABounds: TRect;
      ALevel: Integer = -1);

    property Builder: TdxSpreadSheetReportBuilder read FBuilder;
    property CurrentDataController: TdxSpreadSheetReportDataController
      read GetCurrentDataController;
    property CurrentSection: TdxSpreadSheetReportSection read GetCurrentSection;
    property DBCells: TDictionary<TdxSpreadSheetCustomFormula, Boolean>
      read FDBCells;
    ...
    property FieldPictures: TDictionary<TdxSpreadSheetCustomFormula, TObject>
      read FFieldPictures;
    ...
    property TextCells: TDictionary<TdxSpreadSheetCell, TdxDefaultBoolean>
      read FTextCells;

    property OnNewReportSheet: TdxSpreadSheetReportDesignerNewReportSheetEvent
      read FOnNewReportSheet write FOnNewReportSheet;
  public
    procedure Assign(Source: TPersistent); override;
    procedure Build(ADestination: TdxCustomSpreadSheet);
    procedure DragDrop(Source: TObject; X, Y: Integer); override;
    function FindSection(const AType: TdxSpreadSheetReportSectionType;
      AIndex: Integer; var ASection: TdxSpreadSheetReportSection): Boolean;
    function FindSectionByCell(const ARow, AColumn: Integer;
      var ASection: TdxSpreadSheetReportSection): Boolean;
    procedure GetChildren(Proc: TGetChildProc; Root: TComponent); override;
    function GetSection(const AType: TdxSpreadSheetReportSectionType;
      AIndex: Integer = -1): TdxSpreadSheetReportSection; overload;
    function GetSection(const AName: string; AIndex: Integer = -1)
      : TdxSpreadSheetReportSection; overload;
    function GetSectionByCell(const ARow, AColumn: Integer)
      : TdxSpreadSheetReportSection;
    procedure RemoveSection(ASection: TdxSpreadSheetReportSection); overload;
    procedure RemoveSection(AType: TdxSpreadSheetReportSectionType;
      AIndex: Integer = -1); overload;
  ...
  published
    ...
    property FieldChooser: TdxSpreadSheetReportDesignerFieldChooser
      read FFieldChooser write SetFieldChooser;
    property Options: TdxSpreadSheetReportDesignerOptions read FOptions
      write SetOptions;
    property Align;
    property Anchors;
    ...
    property OnBeforeBuild: TNotifyEvent read FOnBeforeBuild
      write FOnBeforeBuild;
    property OnChange: TNotifyEvent read FOnChange write FOnChange;
    property OnHideFieldChooser: TNotifyEvent read FOnHideFieldChooser
      write FOnHideFieldChooser;
    property OnNewDocument: TdxSpreadSheetReportDesignerNewDocumentEvent
      read FOnNewDocument write FOnNewDocument;
    property OnPopulateField: TdxSpreadSheetReportDesignerPopulateFieldEvent
      read FOnPopulateField write FOnPopulateField;
    property OnShowFieldChooser: TNotifyEvent read FOnShowFieldChooser
      write FOnShowFieldChooser;
    //
  ...
  TdxSpreadSheetReportDragDropFieldAreaCell = class
  ...
  protected
    ...
    function CreateCellViewInfo(ACell: TdxSpreadSheetCell)
      : TdxSpreadSheetTableViewCellViewInfo; override;
    function CreateMergedCellViewInfo(AMergedCell: TdxSpreadSheetMergedCell)
      : TdxSpreadSheetTableViewMergedCellViewInfo; override;
    ...
    procedure UpdateDragDropAreaCell(ARowIndex, AColumnIndex: Integer;
      AAccepted: Boolean); virtual;
  ...
  TdxSpreadSheetReportCellStyleViewInfo = class
  ...
  public
    constructor Create(ADataCell
      : TdxSpreadSheetTableViewCustomDataCellViewInfo); reintroduce; virtual;
  ...
  protected
    function CreateStyleViewInfo
      : TdxSpreadSheetConditionalFormattingStyleViewInfo; override;
  end;

  { TdxSpreadSheetReportMergedCellViewInfo }

  TdxSpreadSheetReportMergedCellViewInfo = class
...
const
  AreaCaptions: array [TdxSpreadSheetReportSectionType] of Pointer =
    (@sHeaderCaption, @sDetailCaption, @sFooterCaption, @sDetailLevelCaption,
    @sGroupHeaderCaption, @sGroupFooterCaption);
...
uses
  dxSpreadSheetPopupMenu, dxSpreadSheetCoreFormulasTokens, dxDPIAwareUtils,
  dxSpreadSheetCoreHelpers, StrUtils;
...
type
  ...
  TdxSpreadSheetFormulaReferenceTokenAccess = class
  ...
  TdxSpreadSheetReportSizingArea = (saNone, saLeft, saTop, saRight, saBottom,
    saBottomRight, saBottomLeft);
  ...
  TdxSpreadSheetTableViewResizeAreaDragAndDropObject = class
  ...
  TdxSpreadSheetReportSectionViewInfo = class
    (TdxSpreadSheetTableViewSelectionFrameViewInfo)
  strict private
  const
    HitTestZoneSize = 6;
  ...
  public
    constructor Create(ASection: TdxSpreadSheetReportSection;
      AView: TdxSpreadSheetCustomView); reintroduce;
    procedure Draw(ACanvas: TcxCanvas;
      AStage: TdxSpreadSheetDrawingStage); override;
  ...
  strict private
    class procedure CopyContainer(AContainer: TdxSpreadSheetContainer;
      ATarget: TdxSpreadSheetTableView;
      const ASourceArea, ASourceAreaBounds: TRect; const ATargetCell: TPoint);
    class procedure LoadContainer(AStream: TStream;
      ATarget: TdxSpreadSheetTableView; const ATargetCell: TPoint);
    class procedure SaveContainer(AStream: TStream;
      AContainer: TdxSpreadSheetContainer;
      const ASourceArea, ASourceAreaBounds: TRect);
  public
    class procedure CopyContainers(ASource, ATarget: TdxSpreadSheetTableView;
      const ASourceCellsArea: TRect; const ATargetCell: TPoint);
    class procedure CopyFormulas(ASource, ATarget: TdxSpreadSheetCell;
      var AIsRangeFormula: Boolean);
    class procedure MakePicture(ATarget: TdxSpreadSheetTableView;
  ...
  TdxSpreadSheetReportDesignerHistoryChangeSectionAction = class
  ...
  TdxSpreadSheetDesignerChangeSectionCommand = class
...
var
  FDatabaseGlyph: TdxSmartImage;
  FFieldChooserBounds: TDictionary<TdxSpreadSheetReportDesigner, TRect>;

procedure ExcludeArea(const ABounds, AExtractBounds: TRect;
  var AArea1, AArea2: TRect; ACheckVertically: Boolean);
begin
  AArea1 := ABounds;
...
begin
  ...
  begin
    ...
    Result := (ANamePtr = @sfnField) or (ANamePtr = @sfnParameter) or
      (ANamePtr = @sfnFieldPicture);
  end;
...
begin
  ...
  if AToken = nil then
    Exit;
  if AToken is TdxSpreadSheetFormulaFunctionToken then
    Result := TdxSpreadSheetFormulaFunctionToken(AToken)
      .Information.NamePtr = @sfnFieldPicture;
  Result := Result or IsPictureFormula(AToken.FirstChild) or
    IsPictureFormula(AToken.Next);
end;
...
begin
  ...
  begin
    FDatabaseGlyph := TdxSmartImage.Create;
...
function ActuallySectionName(const AName: string; ALevel: Integer = -1): string;
  overload; inline;
begin
  Result := AName;
  if ALevel >= 0 then
...
function ActuallySectionName(AType: TdxSpreadSheetReportSectionType;
ALevel: Integer = -1): string; overload; inline;
const
  NameMap: array [TdxSpreadSheetReportSectionType] of string = (sanHeaderRange,
    sanDetailRange, sanFooterRange, sanDetailLevelRange, sanGroupHeaderRange,
    sanGroupFooterRange);
begin
  Result := ActuallySectionName(NameMap[AType], ALevel);
end;

function GetDataBinding(Sender: TdxSpreadSheetFormulaResult;
out AIntf: IdxSpreadSheetDataBinding): Boolean;
begin
  Result := Supports(Sender.Owner.Controller, IdxSpreadSheetDataBinding, AIntf)
    and AIntf.IsActive;
end;

procedure fnField(Sender: TdxSpreadSheetFormulaResult;
...
procedure fnFieldPicture(Sender: TdxSpreadSheetFormulaResult;
const AParams: TdxSpreadSheetFormulaToken);
...
begin
  ADesigner := TdxSpreadSheetReportDesigner
    (TdxSpreadSheetReportFormulaController(Sender.Owner.Controller)
    .SpreadSheet);
  if GetDataBinding(Sender, AIntf) and (ADesigner.Builder <> nil) then
  begin
    S := Sender.ExtractStringParameter(AParams);
    if (Sender.GetParamsCount(AParams) >= 3) and
      ADesigner.DataBinding.GetFieldValue(S, AValue) then
    begin
      ...
      else if SameText(S, UpperCase(cxGetResourceString(@sTopLeft))) then
      ...
      if AToken is TdxSpreadSheetFormulaReferenceToken then
        TdxSpreadSheetFormulaReferenceTokenAccess(AToken)
          .ExtractReference(ASheet, APictureInfo.Range);
      AToken := AToken.Parent.Next;
      if GetNextValue(AToken, TdxSpreadSheetFormulaBooleanValueToken, AValue)
      then
        APictureInfo.LockAspectRatio := AValue;
      if not APictureInfo.CornerAlign and not APictureInfo.LockAspectRatio then
      begin
        if GetNextValue(AToken, TdxSpreadSheetFormulaIntegerValueToken, AValue)
        then
...
procedure fnParameters(Sender: TdxSpreadSheetFormulaResult;
const AParams: TdxSpreadSheetFormulaToken);
begin
...
procedure fnRange(Sender: TdxSpreadSheetFormulaResult;
const AParams: TdxSpreadSheetFormulaToken);
begin
  Sender.SetError(ecValue);
end;

procedure fpiField(var AParamCount: Integer;
var AParamKind: TdxSpreadSheetFunctionParamKindInfo);
begin
  dxSpreadSheetInitializeParamInfo(1, AParamCount, AParamKind);
end;

procedure fpiFieldPicture(var AParamCount: Integer;
var AParamKind: TdxSpreadSheetFunctionParamKindInfo);
begin
  dxSpreadSheetInitializeParamInfo(8, AParamCount, AParamKind);
end;

procedure fpiRange(var AParamCount: Integer;
var AParamKind: TdxSpreadSheetFunctionParamKindInfo);
begin
  dxSpreadSheetInitializeParamInfo(1, AParamCount, AParamKind);
end;
...
procedure TdxSpreadSheetReportFieldList.DoEndDrag(Target: TObject;
X, Y: Integer);
begin
  TdxSpreadSheetReportDesignerFieldChooserForm(Owner).Owner.DragObject := nil;
end;

procedure TdxSpreadSheetReportFieldList.DoStartDrag(var DragObject
  : TDragObject);
var
  P: TPoint;
  ANode: TTreeNode;
begin
  ...
  if (ANode <> nil) and
    (TObject(ANode.Data) is TdxSpreadSheetReportDesignerDataField) then
    DragObject := TdxSpreadSheetReportFieldDragObject.Create(Self,
      TdxSpreadSheetReportDesignerFieldChooserForm(Owner).Designer,
      TdxSpreadSheetReportDesignerDataField(ANode.Data))
  else
    CancelDrag;
end;
...
class function TdxSpreadSheetReportSectionsNameController.IsSectionName
  (AName: TdxSpreadSheetDefinedName; var AType: TdxSpreadSheetReportSectionType;
...
class function TdxSpreadSheetReportSectionsNameController.TryGetType
  (const AName: string; var AType: TdxSpreadSheetReportSectionType;
var AIndex: Integer): Boolean;
var
  ACandidate: string;
  I: Integer;
...
constructor TdxSpreadSheetTableViewResizeAreaDragAndDropObject.Create
  (AControl: TcxControl);
begin
  inherited Create(AControl);
  ...
  begin
    FSection := TdxSpreadSheetReportSectionViewInfo
      (View.HitTest.HitObject).Section;
...
procedure TdxSpreadSheetTableViewResizeAreaDragAndDropObject.DragAndDrop
...
begin
  ...
  if Accepted then
  begin
    UpdateSectionBounds(TdxSpreadSheetTableViewCellViewInfo
      (View.HitTest.HitObject).Row, TdxSpreadSheetTableViewCellViewInfo
      (View.HitTest.HitObject).Column);
  end;
  inherited DragAndDrop(P, Accepted);
end;

procedure TdxSpreadSheetTableViewResizeAreaDragAndDropObject.EndDragAndDrop
  (Accepted: Boolean);
var
  R: TRect;
begin
  ...
  begin
    ...
    Designer.SetSectionInfo(ActuallySectionName(Section.SectionType,
      Section.Index), R, Section.Index);
  end
  else
...
function TdxSpreadSheetTableViewResizeAreaDragAndDropObject.GetDragAndDropCursor
...
function TdxSpreadSheetTableViewResizeAreaDragAndDropObject.
  GetSelectionArea: TRect;
begin
  Result := Section.Bounds;
end;

function TdxSpreadSheetTableViewResizeAreaDragAndDropObject.MakeBounds(ALeft,
  ATop, ARight, ABottom: Integer): TRect;
begin
  Result := cxRect(Min(ALeft, ARight), Min(ATop, ABottom), Max(ALeft, ARight),
    Max(ATop, ABottom));
end;

procedure TdxSpreadSheetTableViewResizeAreaDragAndDropObject.UpdateSectionBounds
  (ABounds: TRect);
begin
...
begin
  case FSizingArea of
    saLeft:
      UpdateSectionBounds(MakeBounds(AColumn, FSourceArea.Top,
        FSourceArea.Right, FSourceArea.Bottom));
    saTop:
      UpdateSectionBounds(MakeBounds(FSourceArea.Left, ARow, FSourceArea.Right,
        FSourceArea.Bottom));
    saRight:
      UpdateSectionBounds(MakeBounds(FSourceArea.Left, FSourceArea.Top, AColumn,
        FSourceArea.Bottom));
    saBottom:
      UpdateSectionBounds(MakeBounds(FSourceArea.Left, FSourceArea.Top,
        FSourceArea.Right, ARow));
    saBottomRight:
      UpdateSectionBounds(MakeBounds(FSourceArea.Left, FSourceArea.Top,
        AColumn, ARow));
    saBottomLeft:
...
function TdxSpreadSheetTableViewResizeAreaDragAndDropObject.GetDesigner
  : TdxSpreadSheetReportDesigner;
begin
  Result := TdxSpreadSheetReportDesigner(Control);
end;

function TdxSpreadSheetTableViewResizeAreaDragAndDropObject.GetViewInfo
  : TdxSpreadSheetReportTableViewInfo;
begin
...
constructor TdxSpreadSheetReportSectionViewInfo.Create
  (ASection: TdxSpreadSheetReportSection; AView: TdxSpreadSheetCustomView);
begin
...
procedure TdxSpreadSheetReportSectionViewInfo.Draw(ACanvas: TcxCanvas;
...
begin
  ...
  try
    ...
    try
      TdxSpreadSheetSelectionHelper.Draw(ACanvas, Bounds, AColor,
        ViewInfo.ContentParams.Color, [ssseFrame], [Corner]);
    finally
    ...
    TdxSpreadSheetSelectionHelper.Draw(ACanvas, Bounds, AColor,
      ViewInfo.ContentParams.Color, [ssseCorners], [Corner]);
  finally
...
function TdxSpreadSheetReportSectionViewInfo.GetCursor
  (AHitTest: TdxSpreadSheetCustomHitTest): TCursor;
const
  CursorMap: array [TdxSpreadSheetReportSizingArea] of TCursor = (crDefault,
    crSizeWE, crSizeNS, crSizeWE, crSizeNS, crSizeNWSE, crSizeNESW);
begin
...
function TdxSpreadSheetReportSectionViewInfo.GetDragAndDropObjectClass
...
function TdxSpreadSheetReportSectionViewInfo.InitHitTest
...
const
  BorderToArea: array [TcxBorder] of TdxSpreadSheetReportSizingArea = (saLeft,
    saTop, saRight, saBottom);
  CornerToArea: array [TdxCorner] of TdxSpreadSheetReportSizingArea =
    (saBottomLeft, saBottomRight, saBottomLeft, saBottomRight);
var
  ABorder: TcxBorder;
  ACornerBounds: TRect;
begin
  Result := TdxSpreadSheetSelectionHelper.IsInFrame(Bounds,
    AHitTest.ActualHitPoint);
  if Result then
  begin
    ACornerBounds := TdxSpreadSheetSelectionHelper.GetCornerBounds
      (Bounds, Corner);
    ACornerBounds := cxRectCenter(ACornerBounds,
      dxSpreadSheetCornetHitTestZoneSize, dxSpreadSheetCornetHitTestZoneSize);
...
procedure TdxSpreadSheetReportSectionViewInfo.RightToLeftConversion
...
begin
  Result := TdxSpreadSheetFontAccess(SpreadSheet.DefaultCellStyle.Font)
    .Handle.GraphicObject;
end;

function TdxSpreadSheetReportSectionViewInfo.GetViewInfo
...
procedure TdxSpreadSheetReportDragDropFieldAreaCell.Draw(ACanvas: TcxCanvas;
AStage: TdxSpreadSheetDrawingStage);
begin
  TdxSpreadSheetSelectionHelper.Draw(ACanvas, Bounds, clRed, clWhite,
    [ssseFrame], []);
end;
...
class procedure TdxSpreadSheetReportHelper.CopyContainers(ASource,
  ATarget: TdxSpreadSheetTableView; const ASourceCellsArea: TRect;
const ATargetCell: TPoint);
var
...
begin
  ASourceAreaBounds :=
    cxRect(ASource.Columns.GetPosition(ASourceCellsArea.Left),
  ...
  try
    ...
    begin
      ...
      if cxRectIntersect(ASourceAreaBounds,
        AContainer.Calculator.CalculateBounds) then
        CopyContainer(AContainer, ATarget, ASourceCellsArea, ASourceAreaBounds,
          ATargetCell);
    end;
  finally
    ATarget.EndUpdate;
...
class procedure TdxSpreadSheetReportHelper.CopyFormulas(ASource,
  ATarget: TdxSpreadSheetCell; var AIsRangeFormula: Boolean);
var
  AWriter: TcxWriter;
  AReader: TcxReader;
...
begin
  ...
  try
    ...
    AStream.Position := 0;
    AFormulaRefs := TdxSpreadSheetFormulaAsTextInfoList.Create
      (ASource.SpreadSheet);
    try
  ...
  AIsRangeFormula := (ATarget.AsFormula <> nil) and
    HasRange(ATarget.AsFormula.Tokens);
end;

class procedure TdxSpreadSheetReportHelper.MakePicture
  (ATarget: TdxSpreadSheetTableView; ASection: TdxSpreadSheetReportSection;
APictureInfo: TdxSpreadSheetReportPictureInfo);
var
  ADestBounds, AImageBounds, ADestArea: TRect;
  APicture: TdxSpreadSheetPictureContainer;
const
  AFitMode: array [Boolean] of TcxImageFitMode = (ifmFit,
...
begin
  ...
  ADestBounds := IdxSpreadSheetTableView(ATarget).GetAbsoluteCellBounds
    (ADestArea.Top, ADestArea.Left);
  AImageBounds := cxRectSetSize(ADestBounds, APictureInfo.Image.Size);
  if not APictureInfo.CornerAlign then
  begin
    ADestBounds.BottomRight := IdxSpreadSheetTableView(ATarget)
      .GetAbsoluteCellBounds(ADestArea.Bottom, ADestArea.Right).BottomRight;
    ...
    ADestBounds := cxRectSetSize(ADestBounds, APictureInfo.Height,
      APictureInfo.Image.Width);
  ...
  try
    ...
    APicture.AnchorPoint1.Cell := ATarget.CreateCell(ADestArea.Top,
      ADestArea.Left);
    APicture.AnchorPoint1.Offset := Point(APictureInfo.OffsetX,
      APictureInfo.OffsetY);
    if APictureInfo.CornerAlign then
    begin
      APicture.AnchorType := catOneCell;
      APicture.AnchorPoint2.Cell := APicture.AnchorPoint1.Cell;
      APicture.AnchorPoint2.Offset :=
        cxPointOffset(APicture.AnchorPoint1.Offset, APictureInfo.Height,
        APictureInfo.Image.Width);
    end
    else
    begin
      APicture.AnchorType := catTwoCell;
      APicture.AnchorPoint2.Cell := ATarget.CreateCell(ADestArea.Bottom + 1,
        ADestArea.Right + 1);
...
class procedure TdxSpreadSheetReportHelper.CopyContainer
  (AContainer: TdxSpreadSheetContainer; ATarget: TdxSpreadSheetTableView;
const ASourceArea, ASourceAreaBounds: TRect; const ATargetCell: TPoint);
var
  AStream: TMemoryStream;
begin
...
class procedure TdxSpreadSheetReportHelper.LoadContainer(AStream: TStream;
ATarget: TdxSpreadSheetTableView; const ATargetCell: TPoint);
var
  AClass: TClass;
  AContainer: TdxSpreadSheetContainerAccess;
  ...
  ATargetPoint: TPoint;
begin
  ATargetPoint := cxPoint(ATarget.Columns.GetPosition(ATargetCell.X),
    ATarget.Rows.GetPosition(ATargetCell.Y));
    ...
    if (AClass <> nil) and AClass.InheritsFrom(TdxSpreadSheetContainer) then
      try
        ...
        begin
          ...
          try
            AContainer.AnchorType := TdxSpreadSheetContainerAnchorType
              (AReader.ReadWord);
            TdxSpreadSheetCommentContainerAccess(AContainer)
              .LoadFromStream(AReader, AReader.ReadWord, ATargetCell.Y,
              ATargetCell.X);
            AContainer.Calculator.UpdateAnchors(cxRectOffset(AContainerBounds,
              ATargetPoint));
          finally
        ...
        begin
          AContainer := TdxSpreadSheetContainerAccess
            (ATarget.Containers.Add(TdxSpreadSheetContainerClass(AClass)));
          AContainer.BeginChanging;
          try
...
class procedure TdxSpreadSheetReportHelper.SaveContainer(AStream: TStream;
AContainer: TdxSpreadSheetContainer;
const ASourceArea, ASourceAreaBounds: TRect);
var
  AWriter: TcxWriter;
begin
  AWriter := TcxWriter.Create(AStream, dxSpreadSheetBinaryFormatVersion);
  try
    AWriter.WriteRect(cxRectOffset(TdxSpreadSheetContainerAccess(AContainer)
      .Calculator.CalculateBounds, ASourceAreaBounds.TopLeft, False));
    AWriter.WriteAnsiString(dxStringToAnsiString(AContainer.ClassName));
    if AContainer is TdxSpreadSheetCommentContainer then
      TdxSpreadSheetCommentContainerAccess(AContainer).SaveToStream(AWriter,
        ASourceArea.Top, ASourceArea.Left)
    else
...
class function TdxSpreadSheetReportDesignerHistoryChangeSectionAction.
...
constructor TdxSpreadSheetDesignerChangeSectionCommand.Create
  (ASection: TdxSpreadSheetReportSection; const AName: string;
const ABounds: TRect; ALevel: Integer = -1);
begin
  Level := ALevel;
  ...
  begin
    ...
    TdxSpreadSheetReportSectionsNameController.TryGetType(AName,
      SectionType, ALevel);
end;
...
begin
  ...
  try
    if cxRectIsInvalid(Bounds) then
      ...
      Designer.SetSectionInfo(ActuallySectionName(SectionType, Level),
        Bounds, Level);
  finally
    Bounds := R;
  end;
...
function TdxSpreadSheetDesignerChangeSectionCommand.GetDesigner
  : TdxSpreadSheetReportDesigner;
begin
...
function TdxSpreadSheetReportSections.Find(const AName: string;
out ASection: TdxSpreadSheetReportSection): Boolean;
var
  I: Integer;
begin
...
function TdxSpreadSheetReportSections.FindByCell(const ARow, AColumn: Integer;
out ASection: TdxSpreadSheetReportSection): Boolean;
var
...
function TdxSpreadSheetReportSections.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
  begin
    if TdxSpreadSheetCellViewInfoAccess(Items[I].ViewInfo).InitHitTest(AHitTest)
    then
      Exit(True);
  end;
  Result := False;
...
procedure TdxSpreadSheetReportSections.RightToLeftConversion
  (const AClientBounds: TRect);
var
  I: Integer;
begin
...
constructor TdxSpreadSheetReportDesignerDataField.Create
  (AOwner: TdxSpreadSheetReportDataController);
begin
...
procedure TdxSpreadSheetReportDesignerDataField.SetFieldName
  (const AValue: string);
begin
...
procedure TdxSpreadSheetReportDesignerDataField.SetSortOrder
  (AValue: TdxSortOrder);
begin
...
begin
  if Collection <> nil then
    TdxSpreadSheetReportSortedFields(Collection).Designer.AddChanges
      (sscLayoutAndData);
end;
...
procedure TdxSpreadSheetReportSortedField.SetSortOrder
  (const AValue: TdxSortOrder);
begin
...
function TdxSpreadSheetReportSortedFields.GetItem(AIndex: Integer)
  : TdxSpreadSheetReportSortedField;
begin
  Result := inherited Items[AIndex] as TdxSpreadSheetReportSortedField;
end;

procedure TdxSpreadSheetReportSortedFields.SetItem(AIndex: Integer;
AValue: TdxSpreadSheetReportSortedField);
begin
...
function TdxSpreadSheetReportDataGroups.GetItem(AIndex: Integer)
  : TdxSpreadSheetReportDataGroup;
begin
  Result := inherited Items[AIndex] as TdxSpreadSheetReportDataGroup;
end;

procedure TdxSpreadSheetReportDataGroups.SetItem(AIndex: Integer;
AValue: TdxSpreadSheetReportDataGroup);
begin
  inherited Items[AIndex].Assign(AValue);
end;
...
begin
  ...
  FFieldNames :=
    TDictionary<string, TdxSpreadSheetReportDesignerDataField>.Create;
end;
...
function TdxSpreadSheetReportDataController.AddField
  : TdxSpreadSheetReportDesignerDataField;
begin
  Result := TdxSpreadSheetReportDesignerDataField.Create(Self);
end;

procedure TdxSpreadSheetReportDataController.CreateAllItems(AMissingItemsOnly
  : Boolean = False);
var
  I: Integer;
begin
    ...
    try
      ...
      for I := 0 to DataSet.FieldCount - 1 do
        if not AMissingItemsOnly or
          (GetItemByFieldName(DataSet.Fields[I].FieldName) = nil) then
...
procedure TdxSpreadSheetReportDataController.UpdateItems(AUpdateFields
  : Boolean);
begin
  inherited UpdateItems(AUpdateFields);
  if (DataControllerInfo.LockCount = 0) and (Designer <> nil) and
    (FieldsList <> nil) then
...
procedure TdxSpreadSheetReportDataController.AddFieldObject
  (AField: TdxSpreadSheetReportDesignerDataField);
begin
...
procedure TdxSpreadSheetReportDataController.BeforeBuildReport;
  ...
  procedure ApplySortingAndGrouping(ASortedFields,
    ADataGroups: TdxSpreadSheetReportSortedFields);
  var
    AIndex: Integer;
  ...
  begin
    ...
    try
      for AIndex := 0 to ADataGroups.Count - 1 do
        if FieldNames.TryGetValue(UpperCase(ADataGroups[AIndex].FieldName),
          ADataField) then
        begin
          ChangeSorting(ADataField.Index, ADataGroups[AIndex].SortOrder);
          DataControllerInfo.ChangeGrouping
            (inherited Fields.FieldByItem(ADataField), AIndex);
        end;
      for AIndex := 0 to ASortedFields.Count - 1 do
        if FieldNames.TryGetValue(UpperCase(ASortedFields[AIndex].FieldName),
          ADataField) then
...
begin
  ...
  begin
    ...
    FieldNames.AddOrSetValue(UpperCase(GetFieldName(AField.GetDisplayName, True)
      ), AField);
  end;
  if Owner is TdxSpreadSheetReportDetail then
    ApplySortingAndGrouping(TdxSpreadSheetReportDetail(Owner).SortedFields,
      TdxSpreadSheetReportDetail(Owner).DataGroups)
  else
    ApplySortingAndGrouping(Designer.DataBinding.SortedFields,
      Designer.DataBinding.DataGroups);
end;
...
function TdxSpreadSheetReportDataController.CreateItemByField(AField: TField)
  : TdxSpreadSheetReportDesignerDataField;
begin
  Result := AddField;
...
function TdxSpreadSheetReportDataController.GetFieldName(const AFieldName
  : string; AUseStorageName: Boolean = True): string;
begin
  Result := AFieldName;
...
procedure TdxSpreadSheetReportDataController.RemoveFieldObject
  (AField: TdxSpreadSheetReportDesignerDataField);
begin
...
function TdxSpreadSheetReportDataController.GetFilterFieldName
...
function TdxSpreadSheetReportDataController.GetItemLink(Index: Integer)
  : TObject;
begin
  Result := TdxSpreadSheetReportDesignerDataField(FilterableItems[Index]);
end;

function TdxSpreadSheetReportDataController.GetItemLinkID
  (Index: Integer): Integer;
begin
  Result := TdxSpreadSheetReportDesignerDataField(FilterableItems[Index]).ID;
end;

function TdxSpreadSheetReportDataController.GetItemLinkName
  (Index: Integer): string;
begin
  Result := TdxSpreadSheetReportDesignerDataField(FilterableItems[Index])
    .FieldName;
...
function TdxSpreadSheetReportDataController.GetProperties(Index: Integer)
...
function TdxSpreadSheetReportDataController.GetValueType(Index: Integer)
  : TcxValueTypeClass;
begin
  Result := GetItemValueTypeClass(TdxSpreadSheetReportDesignerDataField
    (FilterableItems[Index]).Index);
end;

function TdxSpreadSheetReportDataController.GetDataControllerFromOwner
  : TdxSpreadSheetReportDataController;
begin
  Result := nil;
  if Owner is TdxSpreadSheetReportDetail then
    Result := TdxSpreadSheetReportDetails(TdxSpreadSheetReportDetail(Owner)
      .Collection).MasterDataController;
end;

function TdxSpreadSheetReportDataController.GetDataGroups
  : TdxSpreadSheetReportDataGroups;
begin
  if Owner is TdxSpreadSheetReportDetail then
...
function TdxSpreadSheetReportDataController.GetDesigner
  : TdxSpreadSheetReportDesigner;
begin
  Result := nil;
  if Owner is TdxSpreadSheetReportDetail then
    Result := TdxSpreadSheetReportDetail(Owner).Designer
  else if Owner is TdxSpreadSheetReportDesigner then
...
function TdxSpreadSheetReportDataController.GetField(AIndex: Integer)
  : TdxSpreadSheetReportDesignerDataField;
begin
...
procedure TdxSpreadSheetReportDataController.SetDisplayName
  (const AValue: string);
begin
...
procedure TdxSpreadSheetReportDataController.SetField(AIndex: Integer;
AValue: TdxSpreadSheetReportDesignerDataField);
begin
...
constructor TdxSpreadSheetReportDataControllerOptions.Create
  (AOwner: TPersistent);
begin
  FOwner := AOwner;
end;
...
begin
  ...
  begin
    ...
    CaseInsensitive := TdxSpreadSheetReportDataControllerOptions(Source)
      .CaseInsensitive;
    DisplayName := TdxSpreadSheetReportDataControllerOptions(Source)
      .DisplayName;
  end;
end;
...
function TdxSpreadSheetReportDataControllerOptions.GetDataController
  : TdxSpreadSheetReportDataController;
begin
  if GetOwner is TdxSpreadSheetReportDataBinding then
    Result := TdxSpreadSheetReportDataBinding(GetOwner).DataController
  else if GetOwner is TdxSpreadSheetReportDetail then
...
procedure TdxSpreadSheetReportDataControllerOptions.SetAnsiSort
  (AValue: Boolean);
begin
...
procedure TdxSpreadSheetReportDataControllerOptions.SetCaseInsensitive
  (AValue: Boolean);
begin
...
procedure TdxSpreadSheetReportDataControllerOptions.SetDisplayName
  (const AValue: string);
begin
...
function TdxSpreadSheetReportDetail.CreateDataController
  : TdxSpreadSheetReportDataController;
begin
  Result := TdxSpreadSheetReportDataController.Create(Self);
end;

function TdxSpreadSheetReportDetail.CreateDataGroups
  : TdxSpreadSheetReportDataGroups;
begin
  Result := TdxSpreadSheetReportDataGroups.Create(Self,
    TdxSpreadSheetReportDataGroup);
end;

function TdxSpreadSheetReportDetail.CreateDetails: TdxSpreadSheetReportDetails;
begin
  Result := TdxSpreadSheetReportDetails.Create(Self,
    TdxSpreadSheetReportDetail);
end;

function TdxSpreadSheetReportDetail.CreateOptions
  : TdxSpreadSheetReportDataControllerOptions;
begin
  Result := TdxSpreadSheetReportDataControllerOptions.Create(Self);
end;

function TdxSpreadSheetReportDetail.CreateSortedFields
  : TdxSpreadSheetReportSortedFields;
begin
  Result := TdxSpreadSheetReportSortedFields.Create(Self,
    TdxSpreadSheetReportSortedField);
end;

procedure TdxSpreadSheetReportDetail.GetChildren(Proc: TGetChildProc;
Root: TComponent);
...
function TdxSpreadSheetReportDetail.GetCollectionFromParent(AParent: TComponent)
  : TcxComponentCollection;
begin
  Result := nil;
  if AParent is TdxSpreadSheetReportDetail then
    Result := TdxSpreadSheetReportDetail(AParent).Details
  else if AParent is TdxSpreadSheetReportDesigner then
...
procedure TdxSpreadSheetReportDetail.SetCollection
  (AValue: TcxComponentCollection);
begin
...
procedure TdxSpreadSheetReportDetail.SetDataGroups
  (AValue: TdxSpreadSheetReportDataGroups);
begin
...
procedure TdxSpreadSheetReportDetail.SetDetailKeyFieldName
  (const AValue: string);
begin
...
procedure TdxSpreadSheetReportDetail.SetDetails
  (AValue: TdxSpreadSheetReportDetails);
begin
  Details.Assign(AValue);
end;

procedure TdxSpreadSheetReportDetail.SetMasterKeyFieldName
  (const AValue: string);
begin
...
procedure TdxSpreadSheetReportDetail.SetOptions
  (AValue: TdxSpreadSheetReportDataControllerOptions);
begin
...
procedure TdxSpreadSheetReportDetail.SetSortedFields
  (AValue: TdxSpreadSheetReportSortedFields);
begin
...
function TdxSpreadSheetReportDetails.GetItem(AIndex: Integer)
  : TdxSpreadSheetReportDetail;
begin
  Result := inherited Items[AIndex] as TdxSpreadSheetReportDetail;
end;

function TdxSpreadSheetReportDetails.GetMasterDataController
  : TdxSpreadSheetReportDataController;
begin
  Result := nil;
  ...
  else if ParentComponent is TdxSpreadSheetReportDetail then
    Result := TdxSpreadSheetReportDetail(ParentComponent).DataController;
end;

procedure TdxSpreadSheetReportDetails.SetItem(AIndex: Integer;
AValue: TdxSpreadSheetReportDetail);
begin
...
procedure TdxSpreadSheetReportDetails.SetItemName
  (AItem: TcxComponentCollectionItem; ABaseIndex: Integer = -1);
begin
  if GetParentForm(Designer) = nil then
    Exit;
  AItem.Name := CreateUniqueName(GetParentForm(Designer), Designer, AItem,
    'TdxSpreadSheetReport', '', Designer.DetailID);
end;
...
begin
  ...
  ViewInfo := TdxSpreadSheetReportSectionViewInfo.Create(Self,
    AName.SpreadSheet.ActiveSheetAsTable);
end;
...
begin
  Result := cxGetResourceString(AreaCaptions[SectionType]) +
...
procedure TdxSpreadSheetReportSection.CalculateCache
...
begin
  if MergedCells[True] <> nil then
    Exit;
  ExcludeArea(ActuallyBounds, ExtractBounds, CachedBounds[True],
    CachedBounds[False], AIsVerticalLayout);
  ...
  begin
    ...
    begin
      ...
      for AIndex := MergedCells[AStage].Count - 1 downto 0 do
        if dxSpreadSheetIntersects(MergedCells[AStage][AIndex].Area,
          ExtractBounds) then
  ...
  begin
    ...
    begin
      ...
      if (ACell <> nil) and ACell.IsFormula and TdxSpreadSheetReportDesigner
        (ACell.SpreadSheet).IsDBFormula(ACell.AsFormula) then
      begin
        if dxSpreadSheetContains(CachedBounds[True], ARowIndex - 1, AColumnIndex)
        then
          Formulas[True].Add(ACell.AsFormula)
        else if dxSpreadSheetContains(CachedBounds[False], ARowIndex - 1,
          AColumnIndex) then
...
constructor TdxSpreadSheetReportDataBinding.Create
  (AOwner: TdxSpreadSheetReportDesigner);
begin
  FDesigner := AOwner;
  FDetails := CreateDetails;
  FDataController := CreateDataController;
  ...
  FSortedFields := CreateSortedFields;
  FOptions := CreateOptions;
  FFields := TDictionary<string,
    TdxSpreadSheetReportDesignerDataField>.Create();
end;
...
function TdxSpreadSheetReportDataBinding.CreateDataController
  : TdxSpreadSheetReportDataController;
begin
  Result := TdxSpreadSheetReportDataController.Create(Designer);
end;

function TdxSpreadSheetReportDataBinding.CreateDataGroups
  : TdxSpreadSheetReportDataGroups;
begin
  Result := TdxSpreadSheetReportDataGroups.Create(Self,
    TdxSpreadSheetReportDataGroup);
...
function TdxSpreadSheetReportDataBinding.CreateDetails
  : TdxSpreadSheetReportDetails;
begin
  Result := TdxSpreadSheetReportDetails.Create(Designer,
    TdxSpreadSheetReportDetail);
end;

function TdxSpreadSheetReportDataBinding.CreateOptions
  : TdxSpreadSheetReportDataControllerOptions;
begin
  Result := TdxSpreadSheetReportDataControllerOptions.Create(Self);
end;

function TdxSpreadSheetReportDataBinding.CreateSortedFields
  : TdxSpreadSheetReportSortedFields;
begin
  Result := TdxSpreadSheetReportSortedFields.Create(Self,
    TdxSpreadSheetReportSortedField);
...
function TdxSpreadSheetReportDataBinding.GetFieldValue(const AFieldName: string;
var AValue: Variant): Boolean;
var
  AName: string;
  AField: TdxSpreadSheetReportDesignerDataField;
...
begin
  ...
  begin
    ...
    if not Result then
      Result := Fields.TryGetValue(UpperCase(DataController.DisplayName + '.' +
        AName), AField);
  end;
  if Result then
...
procedure TdxSpreadSheetReportDataBinding.SetDataGroups
  (AValue: TdxSpreadSheetReportDataGroups);
begin
  DataGroups.Assign(AValue);
end;
...
procedure TdxSpreadSheetReportDataBinding.SetDetails
  (AValue: TdxSpreadSheetReportDetails);
begin
  FDetails.Assign(AValue);
end;

procedure TdxSpreadSheetReportDataBinding.SetOptions
  (AValue: TdxSpreadSheetReportDataControllerOptions);
begin
  Options.Assign(AValue);
end;

procedure TdxSpreadSheetReportDataBinding.SetSortedFields
  (AValue: TdxSpreadSheetReportSortedFields);
begin
  SortedFields.Assign(AValue);
end;
...
constructor TdxSpreadSheetReportFormulaController.Create
...
function TdxSpreadSheetReportFormulaController.GetDesigner
  : TdxSpreadSheetReportDesigner;
begin
  Result := TdxSpreadSheetReportDesigner(SpreadSheet);
end;

function TdxSpreadSheetReportFormulaController.GetFieldValue(const AFieldName
  : string): Variant;
begin
...
constructor TdxSpreadSheetReportDesignerFieldChooserForm.Create
  (AOwner: TdxSpreadSheetReportDesignerFieldChooser);
var
  R: TRect;
begin
  FOwner := AOwner;
  ...
  if Owner.Site <> nil then
    Align := alClient
  else if FFieldChooserBounds.TryGetValue(Designer, R) then
    BoundsRect := R
  else
  begin
    ...
    R := cxRectSetSize(R,
      ScaleFactor.Apply(dxSpreadSheetReportDefaultFieldChooserWidth),
...
begin
  ...
  begin
    ...
    else if (Designer <> nil) and not Designer.IsDestroying then
...
begin
  Fields.BoundsRect := cxRectInflate(ClientRect,
    -ScaleFactor.Apply(dxSpreadSheetReportDefaultControlsIndent));
  Fields.Parent := Self;
...
ADetails: TdxSpreadSheetReportDetails);
begin
  AParent := Fields.Items.AddChildObject(AParent, ADataController.DisplayName,
    ADataController);
...
function TdxSpreadSheetReportDesignerFieldChooserForm.GetDesigner
  : TdxSpreadSheetReportDesigner;
begin
  Result := Owner.Designer;
end;

function TdxSpreadSheetReportDesignerFieldChooserForm.GetDataBinding
  : TdxSpreadSheetReportDataBinding;
begin
...
function TdxSpreadSheetReportDesignerFieldChooser.CreateFieldChooserForm
  : TdxSpreadSheetReportDesignerFieldChooserForm;
begin
  Result := TdxSpreadSheetReportDesignerFieldChooserForm.Create(Self);
end;

function TdxSpreadSheetReportDesignerFieldChooser.CanAssignedSite
  (ASite: TWinControl): Boolean;
begin
...
procedure TdxSpreadSheetReportDesignerFieldChooser.Notification
...
function TdxSpreadSheetReportDesignerFieldChooser.GetDesigner
  : TdxSpreadSheetReportDesigner;
begin
  Result := TdxSpreadSheetReportDesigner(SpreadSheet);
end;

procedure TdxSpreadSheetReportDesignerFieldChooser.SetDragObject
  (AValue: TDragObject);
var
  AAccepted: Boolean;
begin
  ...
  begin
    ...
    FDragObject := AValue;
    Designer.DragOverCore(Designer.GetMouseCursorClientPos, FDragObject,
      AAccepted);
    if AValue = nil then
      Designer.Invalidate;
  end;
...
constructor TdxSpreadSheetReportLevelBuildInfo.Create
...
procedure TdxSpreadSheetReportLevelBuildInfo.CheckSectionsIntersection
  (AIsVerticalLayout: Boolean);
begin
  if (Detail <> nil) and (Footer <> nil) then
    CheckIntersection(Detail.ActuallyBounds, Footer.ActuallyBounds,
      AIsVerticalLayout);
  if Header <> nil then
  begin
    if Detail <> nil then
      CheckIntersection(Header.ActuallyBounds, Detail.ActuallyBounds,
        AIsVerticalLayout)
    else if Footer <> nil then
      CheckIntersection(Header.ActuallyBounds, Footer.ActuallyBounds,
        AIsVerticalLayout);
  end;
  if Detail <> nil then
...
procedure TdxSpreadSheetReportLevelBuildInfo.ExpandDetailBounds
  (ASection: TdxSpreadSheetReportSection);
begin
  if dxSpreadSheetIntersects(Detail.Bounds, ASection.Bounds) then
  begin
    Detail.DestBounds := dxSpreadSheetCellsUnion(Detail.DestBounds,
      ASection.DestBounds);
    if Parent <> nil then
...
procedure TdxSpreadSheetReportLevelBuildInfo.CheckIntersection(var R1,
  R2: TRect; AIsVerticalLayout: Boolean);
begin
  ...
  else if R1.Right >= R2.Right then
    R1.Right := R2.Right - 1;
end;

{ TdxSpreadSheetReportBuilder }

constructor TdxSpreadSheetReportBuilder.Create
  (ADesigner: TdxSpreadSheetReportDesigner);
begin
  FDesigner := ADesigner;
  FStyles := TDictionary<TdxSpreadSheetCellStyleHandle,
    TdxSpreadSheetCellStyleHandle>.Create();
...
begin
  ...
  Result := CheckSection(AInfo.Header) or CheckSection(AInfo.Detail) or
    CheckSection(AInfo.Footer);
  if not Result then
...
begin
  ...
  AIsRangeFormula := False;
  ADest.StyleHandle := ADest.SpreadSheet.CellStyles.AddClone
    (ASource.StyleHandle);
    ...
    cdtFormula:
      begin
        ...
        begin
          ...
          begin
            if Designer.FieldPictures.TryGetValue(ASource.AsFormula,
              APictureInfo) then
              TdxSpreadSheetReportHelper.MakePicture(CurrentSheet,
                CurrentSection, TdxSpreadSheetReportPictureInfo(APictureInfo));
          end
          else if (ASource.AsFormula <> nil) and
            not VarIsNull(ASource.AsFormula.Value) then
            ADest.AsVariant := ASource.AsVariant
        end
        else
          TdxSpreadSheetReportHelper.CopyFormulas(ASource, ADest,
            AIsRangeFormula);
...
procedure TdxSpreadSheetReportBuilder.CopySettingsForTableItem
  (ASource: TdxSpreadSheetTableItem; ADestItems: TdxSpreadSheetTableItems;
ADestIndex: Integer; ACheckItemExist: Boolean);
begin
  if ASource = nil then
    Exit;
...
function TdxSpreadSheetReportBuilder.CheckSection
    ...
    while ARowIndex < ActiveDataController.RowCount do
      try
        ...
        begin
          ...
          AIndex := IfThen(IsVerticalLayout, CurrentRowIndex,
            CurrentColumnIndex);
          RowsAutoHeight := True;
        end;
        DoBuildDetailSection(Root, ARowIndex);
      finally
        if ANewSheetOnEachRecord or
          (ARowIndex = DataBinding.DataController.RowCount) then
          try
...
begin
  ...
  for I := 0 to ASection.Formulas[AIsFirstStage].Count - 1 do
    TdxSpreadSheetCustomFormulaAccess(ASection.Formulas[AIsFirstStage][I])
      .ForceRefresh;
end;

procedure TdxSpreadSheetReportBuilder.DoBuildSection
  (ASection: TdxSpreadSheetReportSection);
begin
...
begin
  ...
  for AColumnIndex := 0 to cxRectWidth(ASection.ActuallyBounds) do
    CopySettingsForTableItem(ASource.Columns[ASection.ActuallyBounds.Left +
      AColumnIndex], CurrentSheet.Columns, CurrentColumnIndex + AColumnIndex,
      IsVerticalLayout);
  for ARowIndex := 0 to cxRectHeight(ASection.ActuallyBounds) do
    CopySettingsForTableItem(ASource.Rows[ASection.ActuallyBounds.Top +
      ARowIndex], CurrentSheet.Rows, CurrentRowIndex + ARowIndex,
      not IsVerticalLayout);
  //
  ...
  ASection.DestBounds := cxRectSetOrigin(cxRectSetLeft(ASection.ActuallyBounds,
    ASection.ActuallyBounds.Left - Origin.X), cxPoint(AStartColumnIndex,
    AStartRowIndex));
  try
    ...
    begin
      ...
      begin
        FCurrentRow := CurrentSheet.Rows.CreateItem(CurrentRowIndex + ARowIndex
          - ASection.ActuallyBounds.Top);
        AddIndex := ASection.ActuallyBounds.Left - ASection.Bounds.Left + 1;
        for AColumnIndex := 0 to ASection.ActuallyBounds.Right -
          ASection.ActuallyBounds.Left do
        begin
          if ASection.DataMap[AMapRowIndex, AColumnIndex + AddIndex] = nil then
            Continue;
          if IsVerticalLayout then
            CopyCell(TdxSpreadSheetCell(ASection.DataMap[AMapRowIndex,
              AColumnIndex + AddIndex]), FCurrentRow,
              CurrentColumnIndex + AColumnIndex + (ASection.ActuallyBounds.Left
              - Origin.X))
          else
            CopyCell(TdxSpreadSheetCell(ASection.DataMap[AMapRowIndex,
              AColumnIndex + AddIndex]), FCurrentRow,
              CurrentColumnIndex + AColumnIndex);
        end;
    ...
    for I := 0 to ASection.MergedCells[AIsFirstStage].Count - 1 do
      if MakeLocalArea(ASection.MergedCells[AIsFirstStage][I].Area,
        ASection.ActuallyBounds, ASection.DestBounds, R) then
        CurrentSheet.MergedCells.Add(R);
    //
    TdxSpreadSheetReportHelper.CopyContainers(ASource, CurrentSheet,
      ASection.ActuallyBounds, ASection.DestBounds.TopLeft);
    //
  finally
    ...
    if not AIsFirstStage then
      ASection.DestBounds := dxSpreadSheetCellsUnion(ASection.DestBounds,
        ASaveDestBounds);
...
procedure TdxSpreadSheetReportBuilder.DoBuildDetailLevel
...
begin
  ...
  try
    ...
    begin
      AInfo.Detail.DestBounds :=
        cxRectSetOrigin(cxRectSetLeft(AInfo.Detail.ActuallyBounds,
        AInfo.Detail.ActuallyBounds.Left - Origin.X),
        cxPoint(CurrentColumnIndex, CurrentRowIndex));
...
begin
  ...
  while (AInfo.Parent <> nil) and
    (AInfo.Parent.DataController = ADataGroupInfo.DataController) do
...
begin
  ...
  begin
    ...
    AInfo.Detail.CalculateCache(Designer.ActiveSheetAsTable, AInfo.Details,
      IsVerticalLayout);
    AInfo.Detail.CachedBounds[True] := AInfo.DataGroupBounds;
    try
      DoBuildSection(AInfo.Detail);
    finally
      AInfo.Detail.DestBounds := dxSpreadSheetCellsUnion(ADestBounds,
        AInfo.Detail.DestBounds);
    end;
  end;
  DoBuildDetailSectionDetails(AInfo, ARowIndex);
...
function TdxSpreadSheetReportBuilder.GetDesignerSection(const ARootBounds
  : TRect; AType: TdxSpreadSheetReportSectionType; AIndex: Integer;
var ASectionBounds: TRect): TdxSpreadSheetReportSection;
begin
  ...
  begin
    ...
    if not cxRectIsInvalid(ARootBounds) and not dxSpreadSheetIntersects
      (ASectionBounds, ARootBounds, ASectionBounds) then
      Result := nil;
  end;
...
function TdxSpreadSheetReportBuilder.IsBoundsValid(const ABounds
  : TRect): Boolean;
begin
...
function TdxSpreadSheetReportBuilder.IsSectionValid
  (ASection: TdxSpreadSheetReportSection): Boolean;
begin
...
function TdxSpreadSheetReportBuilder.MakeGroupLevelInfo
  (AParent: TdxSpreadSheetReportLevelBuildInfo; AIndex: Integer)
  : TdxSpreadSheetReportLevelBuildInfo;
var
  R: TRect;
begin
  ...
  Result.Header := GetDesignerSection(AParent.DetailBounds, rstGroupHeader,
    Result.DataGroup.SectionID, R);
  if Result.Header <> nil then
    Result.DataGroupBounds.Top := Result.Header.Bounds.Bottom + 1;
  Result.Footer := GetDesignerSection(AParent.DetailBounds, rstGroupFooter,
    Result.DataGroup.SectionID, R);
  ...
  if (Result.Header = nil) and (Result.Footer = nil) then
    FreeAndNil(Result)
  else if IsBoundsValid(Result.DataGroupBounds) then
    Result.DataGroupInfo := MakeGroupLevelInfo(Result, AIndex + 1);
end;

function TdxSpreadSheetReportBuilder.MakeLevelInfo
  (AParent: TdxSpreadSheetReportLevelBuildInfo;
ADetail: TdxSpreadSheetReportDetail): TdxSpreadSheetReportLevelBuildInfo;
begin
  Result := MakeLevelInfo(AParent, ADetail.DataController, ADetail.Details,
    ADetail.SectionID);
end;
...
begin
  ...
  if AParent = nil then
    Result.Detail := GetDesignerSection(ABounds, rstDetail, AIndex,
      Result.DetailBounds)
  else
    Result.Detail := GetDesignerSection(ABounds, rstDetailLevel, AIndex,
      Result.DetailBounds);
    ...
    begin
      ...
      begin
        ...
        if I = 0 then
          ...
          Result.ExtractBounds := dxSpreadSheetCellsUnion(Result.ExtractBounds,
            AInfo.Bounds);
      end
    end;
...
function TdxSpreadSheetReportBuilder.MakeLocalArea(const AArea, ASourceArea,
  ADestArea: TRect; var ALocalArea: TRect): Boolean;
begin
  Result := dxSpreadSheetIntersects(AArea, ASourceArea, ALocalArea);
  if not Result then
    Exit;
  ALocalArea := cxRectOffset(cxRectOffset(ALocalArea, ASourceArea.TopLeft,
    False), ADestArea.TopLeft);
  ALocalArea.Top := Max(0, ALocalArea.Top);
  ALocalArea.Left := Max(0, ALocalArea.Left);
  Result := (ALocalArea.Left <= ALocalArea.Right) and
    (ALocalArea.Top <= ALocalArea.Bottom);
end;
...
begin
  if (Designer.Options.ReportMode = rmMultipleDocuments) and
    (DataBinding.DataController.FocusedRowIndex > 0) then
  begin
    ADoc := FDestination;
...
procedure TdxSpreadSheetReportBuilder.PostProcessFormulas;
  ...
  begin
    ...
    if CheckAndExpandRange(CurrentLevel, R) or
      CheckAndExpandRange(CurrentLevel.Parent, R) or CheckAndExpandRange(Root, R)
    then
    begin
      OffsetRect(R, -(AToken.Owner.AnchorColumn + Origin.X),
        -AToken.Owner.AnchorRow);
      R.Top := Min(R.Top, R.Bottom);
      R.Left := Min(R.Left, R.Right);
      TdxSpreadSheetFormulaTokenAccess(AToken)
        .Replace(AToken, AreaToReference(R));
    end
  end;
...
procedure TdxSpreadSheetReportBuilder.PostProcessSection
  (var ASection: TdxSpreadSheetReportSection; AIndex: Integer;
ANeedAutoHeight: Boolean);
begin
  if IsVerticalLayout then
...
procedure TdxSpreadSheetReportBuilder.PostRowsAutoHeight
  (ASection: TdxSpreadSheetReportSection);
var
  ...
  ARowIndex, AIndex: Integer;
begin
  for ARowIndex := ASection.ActuallyBounds.Top to ASection.
    ActuallyBounds.Bottom do
  begin
    ARow := Designer.ActiveSheetAsTable.Rows[ARowIndex];
    if ARow <> nil then
    begin
      AIsPictureRow := False;
      for AIndex := ASection.ActuallyBounds.Left to ASection.
        ActuallyBounds.Right do
      begin
      ...
      if not AIsPictureRow and RowsAutoHeight then
        if CurrentSheet.Rows[ARowIndex - ASection.ActuallyBounds.Top +
          ASection.DestBounds.Top] <> nil then
          CurrentSheet.Rows[ARowIndex - ASection.ActuallyBounds.Top +
            ASection.DestBounds.Top].ApplyBestFit;
    end;
  end;
end;
...
begin
  FRoot := MakeLevelInfo(nil, DataBinding.DataController,
    DataBinding.Details, -1);
  if Root <> nil then
  begin
...
begin
  ...
  Destination.ActiveSheetAsTable.CreateCell(0, 0)
...
begin
  ...
  if ActiveDataController = DataBinding.DataController then
    ProgressValue := MulDiv(Max(0, ActiveDataController.FocusedRowIndex), 100,
      ActiveDataController.RowCount);
end;

function TdxSpreadSheetReportBuilder.GetDataBinding
  : TdxSpreadSheetReportDataBinding;
begin
  Result := Designer.DataBinding;
end;
...
constructor TdxSpreadSheetReportDesignerOptions.Create
...
function TdxSpreadSheetReportDesignerOptions.GetDesigner
  : TdxSpreadSheetReportDesigner;
begin
  Result := TdxSpreadSheetReportDesigner(SpreadSheet);
end;
...
procedure TdxSpreadSheetReportDesignerOptions.SetOrientation
  (AValue: TdxSpreadSheetReportOrientation);
begin
...
procedure TdxSpreadSheetReportDesignerOptions.SetReportMode
  (AValue: TdxSpreadSheetReportMode);
begin
...
procedure TdxSpreadSheetReportDesigner.Build(ADestination
...
begin
  ...
  begin
    P := cxPointScale(GetMouseCursorClientPos, 100,
      TdxSpreadSheetReportTableView(ActiveSheetAsTable).ZoomFactor);
    TdxSpreadSheetReportTableView(ActiveSheetAsTable)
      .CellAtPoint(P, ARow, AColumn);
    if (ARow >= 0) and (AColumn >= 0) then
    begin
      P := TdxSpreadSheetReportTableView(ActiveSheetAsTable)
        .MergedCells.CheckCell(ARow, AColumn).TopLeft;
...
function TdxSpreadSheetReportDesigner.FindSection
  (const AType: TdxSpreadSheetReportSectionType; AIndex: Integer;
var ASection: TdxSpreadSheetReportSection): Boolean;
begin
  Result := Sections.Find(ActuallySectionName(AType, AIndex), ASection);
end;

function TdxSpreadSheetReportDesigner.FindSectionByCell(const ARow,
  AColumn: Integer; var ASection: TdxSpreadSheetReportSection): Boolean;
begin
  Result := Sections.FindByCell(ARow, AColumn, ASection);
end;

procedure TdxSpreadSheetReportDesigner.GetChildren(Proc: TGetChildProc;
Root: TComponent);
var
  I: Integer;
begin
...
function TdxSpreadSheetReportDesigner.GetSection(const AName: string;
AIndex: Integer = -1): TdxSpreadSheetReportSection;
var
  ID: Integer;
  AType: TdxSpreadSheetReportSectionType;
begin
  ID := AIndex;
  if TdxSpreadSheetReportSectionsNameController.TryGetType(AName, AType, AIndex)
  then
  begin
...
function TdxSpreadSheetReportDesigner.GetSection(const AType
  : TdxSpreadSheetReportSectionType; AIndex: Integer = -1)
  : TdxSpreadSheetReportSection;
begin
  FindSection(AType, AIndex, Result);
end;

function TdxSpreadSheetReportDesigner.GetSectionByCell(const ARow,
  AColumn: Integer): TdxSpreadSheetReportSection;
begin
  FindSectionByCell(ARow, AColumn, Result);
end;

procedure TdxSpreadSheetReportDesigner.RemoveSection
  (ASection: TdxSpreadSheetReportSection);
begin
  if ASection = nil then
    Exit;
  ...
  try
    if History.CanAddCommand then
      History.AddCommand(TdxSpreadSheetDesignerChangeSectionCommand.Create
        (ASection, '', cxInvalidRect, ASection.Index));
    ASection.Name.Free;
...
procedure TdxSpreadSheetReportDesigner.RemoveSection
  (AType: TdxSpreadSheetReportSectionType; AIndex: Integer = -1);
var
  ASection: TdxSpreadSheetReportSection;
begin
...
procedure TdxSpreadSheetReportDesigner.SetDetailSection(const ABounds: TRect;
ALevel: Integer);
begin
  if ALevel < 0 then
...
procedure TdxSpreadSheetReportDesigner.SetGroupHeaderSection
  (const ABounds: TRect; ALevel: Integer);
begin
  SetSectionInfo(sanGroupHeaderRange, ABounds, ALevel);
end;

procedure TdxSpreadSheetReportDesigner.SetGroupFooterSection
  (const ABounds: TRect; ALevel: Integer);
begin
...
procedure TdxSpreadSheetReportDesigner.AddFormulaInfo
  (AFormula: TdxSpreadSheetCustomFormula; AIsDBFormula: Boolean);
begin
...
function TdxSpreadSheetReportDesigner.AddPicture
  (AFormula: TdxSpreadSheetCustomFormula; APictureInfo: TObject): Integer;
begin
...
begin
  ...
  if not(IsLocked or ProcessingChanges) and
    (sscLayoutAndData * Changes = sscLayoutAndData) then
  begin
...
procedure TdxSpreadSheetReportDesigner.CheckFormula
  (AFormula: TdxSpreadSheetCustomFormula);
var
  ACell: TdxSpreadSheetCell;
...
begin
  ...
  begin
    ...
    if ACell <> nil then
    begin
      if (AFormula.ResultValue.ErrorCode <> ecNone) and
        (ACell.ShowFormula <> bTrue) then
...
function TdxSpreadSheetReportDesigner.CreateDataBinding
  : TdxSpreadSheetReportDataBinding;
begin
  Result := TdxSpreadSheetReportDataBinding.Create(Self);
end;

function TdxSpreadSheetReportDesigner.CreateFieldChooser
  : TdxSpreadSheetReportDesignerFieldChooser;
begin
  Result := TdxSpreadSheetReportDesignerFieldChooser.Create(Self);
end;

function TdxSpreadSheetReportDesigner.CreateFormulaController
  : TdxSpreadSheetFormulaController;
begin
  Result := TdxSpreadSheetReportFormulaController.Create(Self);
end;

function TdxSpreadSheetReportDesigner.CreateReportBuilder
  : TdxSpreadSheetReportBuilder;
begin
  Result := TdxSpreadSheetReportBuilder.Create(Self);
end;

function TdxSpreadSheetReportDesigner.CreateOptions
  : TdxSpreadSheetReportDesignerOptions;
begin
...
function TdxSpreadSheetReportDesigner.DoCreateSheet
  (var ASheet: TdxSpreadSheetCustomView; const ACaption: string = '';
...
procedure TdxSpreadSheetReportDesigner.DoNewDocument(var ADocument
  : TdxCustomSpreadSheet);
begin
...
procedure TdxSpreadSheetReportDesigner.DoNewSheet
  (ASheet: TdxSpreadSheetTableView);
begin
...
procedure TdxSpreadSheetReportDesigner.DragOver(Source: TObject; X, Y: Integer;
...
begin
  ...
  if Source is TdxSpreadSheetReportFieldDragObject then
  begin
    Accept := ControllerFromPoint(X, Y, AController) and
      (AController is TdxSpreadSheetTableViewController);
    if Accept then
      DragOverCore(Point(X, Y), TdxSpreadSheetReportFieldDragObject
        (Source), Accept);
  end;
end;

procedure TdxSpreadSheetReportDesigner.DragOverCore(const P: TPoint;
ADragObject: TDragObject; var AAccept: Boolean);
var
...
begin
  ...
  AAccept := (ADragObject <> nil) and (FieldChooser.DragObject = ADragObject)
    and ATableView.HitTest.HitAtCell;

  if AAccept then
  begin
    ACellViewInfo := ATableView.HitTest.HitObject as
  ...
  ATableView.ViewInfo.UpdateDragDropAreaCell(ACellReference.Y,
    ACellReference.X, AAccept);
end;
...
function TdxSpreadSheetReportDesigner.IsDBFormula
  (AFormula: TdxSpreadSheetCustomFormula): Boolean;
begin
...
procedure TdxSpreadSheetReportDesigner.Notification(AComponent: TComponent;
...
var
  ...
  procedure PopulateDataControllers(ADataController
    : TdxSpreadSheetReportDataController; ID: Integer;
  ADetails: TdxSpreadSheetReportDetails);
  var
    I: Integer;
  ...
  begin
    ...
    for I := 0 to ADetails.Count - 1 do
      PopulateDataControllers(ADetails[I].DataController, ADetails[I].SectionID,
        ADetails[I].Details);
  end;
...
begin
  Sections.Clear;
  ADataControllers :=
    TDictionary<Integer, TdxSpreadSheetReportDataController>.Create;
  try
    PopulateDataControllers(DataBinding.DataController, -1,
      DataBinding.Details);
    for I := 0 to DefinedNames.Count - 1 do
      if TdxSpreadSheetReportSectionsNameController.IsSectionName
        (DefinedNames[I], AType, AIndex) then
      begin
        ASection := TdxSpreadSheetReportSection.Create(DefinedNames[I],
          AType, AIndex);
        if not ADataControllers.TryGetValue(AIndex, ASection.DataController)
        then
...
procedure TdxSpreadSheetReportDesigner.SetSectionInfo(const AName: string;
const ABounds: TRect; ALevel: Integer = -1);
var
...
begin
  ...
  try
    if History.CanAddCommand then
      History.AddCommand(TdxSpreadSheetDesignerChangeSectionCommand.Create
        (ASection, AName, ABounds, ALevel));
    if (ASection <> nil) and cxRectIsInvalid(ABounds) then
      ASection.Name.Free
      // todo: check rebuild sections after remove name also need check undo/redo operation
    else
    begin
      if ASection = nil then
      ...
      // todo: need check undo/redo operation when section area was changed
      begin
        ADefinedName.Reference := dxReferenceToString(ABounds,
          OptionsView.R1C1Reference, 0, 0);
...
function TdxSpreadSheetReportDesigner.GetCurrentDataController
  : TdxSpreadSheetReportDataController;
begin
  Result := GetDataControllerForSection(CurrentSection);
end;

function TdxSpreadSheetReportDesigner.GetCurrentSection
  : TdxSpreadSheetReportSection;
begin
...
procedure TdxSpreadSheetReportDesigner.SetDataBinding
  (AValue: TdxSpreadSheetReportDataBinding);
begin
  DataBinding.Assign(AValue);
end;

procedure TdxSpreadSheetReportDesigner.SetFieldChooser
  (AValue: TdxSpreadSheetReportDesignerFieldChooser);
begin
  FFieldChooser.Assign(AValue);
end;

procedure TdxSpreadSheetReportDesigner.SetOptions
  (AValue: TdxSpreadSheetReportDesignerOptions);
begin
  FOptions.Assign(AValue);
end;
...
function TdxSpreadSheetReportTableView.CreateViewInfo
  : TdxSpreadSheetCustomViewViewInfo;
begin
  Result := TdxSpreadSheetReportTableViewInfo.Create(Self);
end;

function TdxSpreadSheetReportTableView.GetViewInfo
  : TdxSpreadSheetReportTableViewInfo;
begin
...
constructor TdxSpreadSheetReportTableViewInfo.Create
...
function TdxSpreadSheetReportTableViewInfo.CreateCellViewInfo
  (ACell: TdxSpreadSheetCell): TdxSpreadSheetTableViewCellViewInfo;
begin
  Result := TdxSpreadSheetReportCellViewInfo.Create(Self);
end;

function TdxSpreadSheetReportTableViewInfo.CreateMergedCellViewInfo
...
procedure TdxSpreadSheetReportTableViewInfo.CalculateHitTest
...
procedure TdxSpreadSheetReportTableViewInfo.CalculateSection
  (ASection: TdxSpreadSheetReportSection);
var
...
procedure TdxSpreadSheetReportTableViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited;
...
procedure TdxSpreadSheetReportTableViewInfo.UpdateDragDropAreaCell(ARowIndex,
  AColumnIndex: Integer; AAccepted: Boolean);
var
  AArea: TRect;
...
begin
  ...
  else if AVisibleChanged then
    View.Invalidate;
end;

function TdxSpreadSheetReportTableViewInfo.GetDesigner
  : TdxSpreadSheetReportDesigner;
begin
  Result := TdxSpreadSheetReportDesigner(SpreadSheet);
end;

function TdxSpreadSheetReportTableViewInfo.GetHitTest
  : TdxSpreadSheetTableViewHitTest;
begin
  Result := View.HitTest;
end;

function TdxSpreadSheetReportTableViewInfo.GetSections
  : TdxSpreadSheetReportSections;
begin
  Result := Designer.Sections;
end;

function TdxSpreadSheetReportTableViewInfo.GetView
  : TdxSpreadSheetReportTableView;
begin
...
constructor TdxSpreadSheetReportCellStyleViewInfo.Create
  (ADataCell: TdxSpreadSheetTableViewCustomDataCellViewInfo);
begin
  inherited Create(ADataCell.Style, dxDefaultScaleFactor);
  FDataCell := ADataCell;
end;

procedure TdxSpreadSheetReportCellStyleViewInfo.Calculate(const ABounds,
...
begin
  ...
  begin
    ...
    if (ACell <> nil) and (ACell.DisplayText <> '') and
      Designer.IsDBFormula(ACell.AsFormula) then
    begin
      FDatabaseGlyphBounds := cxRectSetTop(AContentBounds,
        AContentBounds.Top + cxTextOffset, DatabaseGlyph.Height);
      if UseRightToLeftLayout then
        FDatabaseGlyphBounds := cxRectSetLeft(FDatabaseGlyphBounds,
          FDatabaseGlyphBounds.Left + cxTextOffset, DatabaseGlyph.Width)
      else
        FDatabaseGlyphBounds := cxRectSetRight(FDatabaseGlyphBounds,
          FDatabaseGlyphBounds.Right - cxTextOffset, DatabaseGlyph.Width);
    end;
  end;
end;

procedure TdxSpreadSheetReportCellStyleViewInfo.Draw(ACanvas: TcxCanvas;
AStage: TdxSpreadSheetDrawingStage);
begin
  inherited;
...
function TdxSpreadSheetReportCellStyleViewInfo.GetSupportedDrawingStages
...
function TdxSpreadSheetReportCellStyleViewInfo.GetDesigner
  : TdxSpreadSheetReportDesigner;
begin
...
function TdxSpreadSheetReportCellViewInfo.CreateStyleViewInfo
  : TdxSpreadSheetConditionalFormattingStyleViewInfo;
begin
...
function TdxSpreadSheetReportMergedCellViewInfo.CreateStyleViewInfo
  : TdxSpreadSheetConditionalFormattingStyleViewInfo;
begin
  Result := TdxSpreadSheetReportCellStyleViewInfo.Create(Self);
end;
...
procedure AddSpreadSheetReportResourceStringNames
...
begin
  FFieldChooserBounds := TDictionary<TdxSpreadSheetReportDesigner,
    TRect>.Create;

  ARepository := TdxSpreadSheetFunctionsRepositoryAccess
    (dxSpreadSheetFunctionsRepository);
  ARepository.InternalAdd(@sfnField, fnField, fpiField, frkValue, 255,
    ftDatabase);
  ARepository.InternalAdd(@sfnParameter, fnParameters, fpiField, frkValue, 255,
    ftDatabase);
  ARepository.InternalAdd(@sfnFieldPicture, fnFieldPicture, fpiFieldPicture,
    frkValue, 255, ftDatabase);
  ARepository.InternalAdd(@sfnRange, fnRange, fpiRange, frkValue, 255,
    ftDatabase);

  RegisterClasses([TdxSpreadSheetReportDesigner, TdxSpreadSheetReportTableView,
    TdxSpreadSheetReportDetail]);
  TdxSpreadSheetReportSectionsNameController.Register;

  dxResourceStringsRepository.RegisterProduct
    ('ExpressSpreadSheet Report Designer',
    @AddSpreadSheetReportResourceStringNames);
end;
