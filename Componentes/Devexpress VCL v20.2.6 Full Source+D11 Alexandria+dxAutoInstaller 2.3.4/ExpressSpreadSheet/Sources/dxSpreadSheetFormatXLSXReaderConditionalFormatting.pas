...
{$ENDIF}
  ...
  dxCore, dxCoreClasses, cxClasses, dxCustomTree, dxXMLDoc, dxZIPUtils,
...
type
  TdxSpreadSheetXLSXReaderConditionalFormattingCustomRuleParserClass = class of
  ...
  TdxSpreadSheetXLSXReaderConditionalFormattingParser = class
    (TdxSpreadSheetXLSXReaderCustomNodeParser)
  strict private
    FConditionalFormatting: TdxSpreadSheetCustomConditionalFormatting;
    FRuleMap: TDictionary<string,
      TdxSpreadSheetCustomConditionalFormattingRule>;
    FRulePriorities: TList;
  protected
    procedure ProcessConditionalFormatting(ANode: TdxXMLNode;
      AUserData: Pointer); virtual;
    procedure ProcessConditionalFormattingEx(ANode: TdxXMLNode;
      AUserData: Pointer); virtual;
    procedure ProcessExtListItem(ANode: TdxXMLNode;
      AUserData: Pointer); virtual;
  public
    ...
    property RuleMap
      : TDictionary<string, TdxSpreadSheetCustomConditionalFormattingRule>
      read FRuleMap;
  ...
  TdxSpreadSheetXLSXReaderConditionalFormattingAreaParser = class
    (TdxSpreadSheetXLSXReaderCustomNodeParser)
  strict private
    FAreas: TdxSpreadSheetAreaList;
    FConditionalFormattingParser
      : TdxSpreadSheetXLSXReaderConditionalFormattingParser;
  ...
  protected
    FRuleParsers
      : TDictionary<string,
      TdxSpreadSheetXLSXReaderConditionalFormattingCustomRuleParserClass>;
  ...
  public
    constructor Create(ANode: TdxXMLNode;
      AConditionalFormattingParser
      : TdxSpreadSheetXLSXReaderConditionalFormattingParser);
    destructor Destroy; override;
    procedure Execute; override;
    //
    property Areas: TdxSpreadSheetAreaList read FAreas;
    property ConditionalFormattingParser
      : TdxSpreadSheetXLSXReaderConditionalFormattingParser
      read FConditionalFormattingParser;
  end;

  { TdxSpreadSheetXLSXReaderConditionalFormattingAreaExParser }

  TdxSpreadSheetXLSXReaderConditionalFormattingAreaExParser = class
    (TdxSpreadSheetXLSXReaderConditionalFormattingAreaParser)
  protected
  ...
  public
    constructor Create(ANode: TdxXMLNode;
      AAreaParser: TdxSpreadSheetXLSXReaderConditionalFormattingAreaParser);
    procedure Execute; override;
    //
    property AreaParser: TdxSpreadSheetXLSXReaderConditionalFormattingAreaParser
      read FAreaParser;
    property ConditionalFormatting: TdxSpreadSheetCustomConditionalFormatting
  ...
  protected
    ...
    procedure ReadConditions
      (ARule: TdxSpreadSheetConditionalFormattingRuleStyleBased); virtual;
  end;
  ...
  protected
    procedure ReadConditions
      (ARule: TdxSpreadSheetConditionalFormattingRuleStyleBased); override;
  public
  ...
  protected
    ...
    procedure ParseIconSetStop(ANode: TdxXMLNode;
...
constructor TdxSpreadSheetXLSXReaderConditionalFormattingParser.Create
  (AOwner: TdxSpreadSheetXLSXReaderWorksheetParser);
begin
  inherited Create(AOwner.Document.Root.First, AOwner.Owner);
  FConditionalFormatting := AOwner.View.ConditionalFormatting;
  FRuleMap := TDictionary<string,
    TdxSpreadSheetCustomConditionalFormattingRule>.Create;
...
begin
  ...
  for I := 0 to RulePriorities.Count - 1 do
    TdxSpreadSheetCustomConditionalFormattingRule(RulePriorities.List[I]).
      Index := I;
end;

procedure TdxSpreadSheetXLSXReaderConditionalFormattingParser.
  ProcessConditionalFormatting(ANode: TdxXMLNode; AUserData: Pointer);
begin
  if ANode.Name = sdxXLSXNodeConditionalFormatting then
    ExecuteSubTask(TdxSpreadSheetXLSXReaderConditionalFormattingAreaParser.
      Create(ANode, Self));
end;

procedure TdxSpreadSheetXLSXReaderConditionalFormattingParser.
  ProcessConditionalFormattingEx(ANode: TdxXMLNode; AUserData: Pointer);
begin
  ExecuteSubTask(TdxSpreadSheetXLSXReaderConditionalFormattingAreaExParser.
    Create(ANode, Self));
end;

procedure TdxSpreadSheetXLSXReaderConditionalFormattingParser.ProcessExtListItem
  (ANode: TdxXMLNode; AUserData: Pointer);
begin
  if ANode.Name = sdxXLSXNodeExt then
  begin
    if ANode.FindChild(sdxXLSXNamespaceX14 + ':' +
      sdxXLSXNodeConditionalFormattings, ANode) then
...
constructor TdxSpreadSheetXLSXReaderConditionalFormattingAreaParser.Create
  (ANode: TdxXMLNode; AConditionalFormattingParser
  : TdxSpreadSheetXLSXReaderConditionalFormattingParser);
begin
  ...
  FRuleParsers :=
    TDictionary<string,
    TdxSpreadSheetXLSXReaderConditionalFormattingCustomRuleParserClass>.Create;
  RegisterRuleParsers;
end;
...
procedure TdxSpreadSheetXLSXReaderConditionalFormattingAreaParser.ProcessRule
  (ANode: TdxXMLNode; AUserData: Pointer);
var
  AParserClass
    : TdxSpreadSheetXLSXReaderConditionalFormattingCustomRuleParserClass;
begin
  ...
  begin
    if FRuleParsers.TryGetValue(ANode.Attributes.GetValueAsString
      (sdxXLSXAttrTypeLC), AParserClass) then
      ExecuteSubTask(AParserClass.Create(ANode, Self));
  end;
end;

function TdxSpreadSheetXLSXReaderConditionalFormattingAreaParser.
  ReadReferences: string;
begin
  Result := Node.Attributes.GetValueAsString(sdxXLSXAttrSqRef);
end;

procedure TdxSpreadSheetXLSXReaderConditionalFormattingAreaParser.
  RegisterRuleParsers;
begin
  FRuleParsers.Add(sdxXLSXValueAboveAverage,
    TdxSpreadSheetXLSXReaderConditionalFormattingAboveAverageRuleParser);
  FRuleParsers.Add(sdxXLSXValueCellIs,
    TdxSpreadSheetXLSXReaderConditionalFormattingCellIsRuleParser);
  FRuleParsers.Add(sdxXLSXValueColorScale,
    TdxSpreadSheetXLSXReaderConditionalFormattingColorScaleRuleParser);
  FRuleParsers.Add(sdxXLSXValueExpression,
    TdxSpreadSheetXLSXReaderConditionalFormattingExpressionRuleParser);
  FRuleParsers.Add(sdxXLSXValueTop10,
    TdxSpreadSheetXLSXReaderConditionalFormattingTopBottomRuleParser);
  FRuleParsers.Add(sdxXLSXValueTypeDataBar,
    TdxSpreadSheetXLSXReaderConditionalFormattingDataBarParser);
  FRuleParsers.Add(sdxXLSXValueTypeIconSet,
    TdxSpreadSheetXLSXReaderConditionalFormattingIconSetRuleParser);

  FRuleParsers.Add('beginsWith',
    TdxSpreadSheetXLSXReaderConditionalFormattingExpressionRuleParser);
  FRuleParsers.Add('containsText',
    TdxSpreadSheetXLSXReaderConditionalFormattingExpressionRuleParser);
  FRuleParsers.Add('duplicateValues',
    TdxSpreadSheetXLSXReaderConditionalFormattingDuplicateValuesRuleParser);
  FRuleParsers.Add('endsWith',
    TdxSpreadSheetXLSXReaderConditionalFormattingExpressionRuleParser);
  FRuleParsers.Add('notContainsBlanks',
    TdxSpreadSheetXLSXReaderConditionalFormattingExpressionRuleParser);
  FRuleParsers.Add('notContainsErrors',
    TdxSpreadSheetXLSXReaderConditionalFormattingExpressionRuleParser);
  FRuleParsers.Add('uniqueValues',
    TdxSpreadSheetXLSXReaderConditionalFormattingUniqueValuesRuleParser);
end;

procedure TdxSpreadSheetXLSXReaderConditionalFormattingAreaParser.ParseAreas
  (const S: string);
var
  AArea: TRect;
  AList: TStringList;
...
begin
  ...
  try
    ...
    begin
      AArea := dxStringToReferenceArea(StringReplace(AList[I], '$', '',
        [rfReplaceAll]));
...
function TdxSpreadSheetXLSXReaderConditionalFormattingAreaExParser.
  ReadReferences: string;
var
  ANode: TdxXMLNode;
begin
...
procedure TdxSpreadSheetXLSXReaderConditionalFormattingAreaExParser.
  RegisterRuleParsers;
begin
  FRuleParsers.Add(sdxXLSXValueTypeDataBar,
    TdxSpreadSheetXLSXReaderConditionalFormattingDataBarParser);
...
begin
  ...
  begin
    ...
    if Node.FindChild([sdxXLSXNodeExtList, sdxXLSXNodeExt, sdxXLSXNodeX14ID],
      ASubNode) then
      RuleMap.AddOrSetValue(ASubNode.TextAsString, FRule);
  end;
end;

function TdxSpreadSheetXLSXReaderConditionalFormattingCustomRuleParser.
...
procedure TdxSpreadSheetXLSXReaderConditionalFormattingStyleBasedRuleParser.
  CreateRule(AAreas: TdxSpreadSheetAreaList);
var
...
begin
  ...
  try
    ARule.StopIfTrue := Node.Attributes.GetValueAsBoolean
      (sdxXLSXAttrStopIfTrue);
    if Node.Attributes.Exists(sdxXLSXAttrDfxID) then
    begin
      AStyleIndex := Node.Attributes.GetValueAsInteger(sdxXLSXAttrDfxID);
      if CheckListIndex(AStyleIndex, Owner.ConditionalFormattingStyles,
        sdxErrorInvalidStyleIndex, ssmtError) then
        ARule.Style.Handle := TdxSpreadSheetCellStyleHandle
          (Owner.ConditionalFormattingStyles[AStyleIndex]);
    end;
    ARule.Areas := AAreas;
...
procedure TdxSpreadSheetXLSXReaderConditionalFormattingStyleBasedRuleParser.
  ReadConditions(ARule: TdxSpreadSheetConditionalFormattingRuleStyleBased);
begin
  // do nothing
end;
...
procedure TdxSpreadSheetXLSXReaderConditionalFormattingAboveAverageRuleParser.
  AfterConstruction;
begin
...
procedure TdxSpreadSheetXLSXReaderConditionalFormattingAboveAverageRuleParser.
  ...
  function DecodeComparisonOperator(AIsAbove, AIsEquals: Boolean)
    : TdxSpreadSheetConditionalFormattingRuleAboveOrBelowAverageComparisonOperator;
  const
    Map: array [Boolean, Boolean]
      of TdxSpreadSheetConditionalFormattingRuleAboveOrBelowAverageComparisonOperator =
      ((abacoBelowAverage, abacoAboveAverage), (abacoBelowOrEqualAverage,
...
begin
  ...
  AAverageRule.StandardDeviationLevel := Node.Attributes.GetValueAsInteger
    (sdxXLSXAttrStdDev, 1);
end;

{ TdxSpreadSheetXLSXReaderConditionalFormattingExpressionRuleParser }

procedure TdxSpreadSheetXLSXReaderConditionalFormattingExpressionRuleParser.
  AfterConstruction;
begin
  inherited AfterConstruction;
...
begin
  ...
  if Node.HasChildren then
    TdxSpreadSheetConditionalFormattingRuleExpression(ARule).Expression :=
      Node.First.TextAsString;
end;

{ TdxSpreadSheetXLSXReaderConditionalFormattingCellIsRuleParser }

procedure TdxSpreadSheetXLSXReaderConditionalFormattingCellIsRuleParser.
  AfterConstruction;
begin
  inherited AfterConstruction;
...
begin
  ...
  TdxSpreadSheetConditionalFormattingRuleCellIs(ARule).ComparisonOperator :=
    TdxSpreadSheetXLSXHelper.StringToCfCellIsRuleOperator
    (Node.Attributes.GetValue(sdxXLSXAttrOperator));
  if Node.Count > 1 then
    TdxSpreadSheetConditionalFormattingRuleCellIs(ARule).Expression2 :=
      Node[1].TextAsString;
end;

{ TdxSpreadSheetXLSXReaderConditionalFormattingCustomScaleRuleParser }

procedure TdxSpreadSheetXLSXReaderConditionalFormattingCustomScaleRuleParser.
  ParseStop(AStop: TdxSpreadSheetConditionalFormattingRuleCustomScaleStop;
  ANode: TdxXMLNode);
...
var
  ASubNode: TdxXMLNode;
begin
  AStop.ValueType := TdxSpreadSheetXLSXHelper.StringToColorScaleStopValueType
    (ANode.Attributes.GetValue(sdxXLSXAttrTypeLC));
  if ANode.FindChild(sdxXLSXNodeXMFunc, ASubNode) then
    AStop.Value := DecodeValue(ASubNode.TextAsString)
  else
    AStop.Value := DecodeValue(ANode.Attributes.GetValueAsString
      (sdxXLSXAttrVal));
end;

{ TdxSpreadSheetXLSXReaderConditionalFormattingColorScaleRuleParser }

procedure TdxSpreadSheetXLSXReaderConditionalFormattingColorScaleRuleParser.
  AfterConstruction;
begin
  inherited AfterConstruction;
...
destructor
  TdxSpreadSheetXLSXReaderConditionalFormattingColorScaleRuleParser.Destroy;
begin
...
begin
  case FStopsInfo.Count of
    2:
      FRule := TdxSpreadSheetConditionalFormattingRuleTwoColorScale.Create
        (ConditionalFormatting);
    3:
      FRule := TdxSpreadSheetConditionalFormattingRuleThreeColorScale.Create
        (ConditionalFormatting);
  end;
  if FRule <> nil then
    FRule.Areas := AAreas;
...
begin
  ...
  begin
    AIndex := 0;
    while (AIndex < ASubNode.Count) and
      (ASubNode[AIndex].Name = sdxXLSXNodeCFVO) do
    begin
      FStopsInfo.Add(TPair<TdxXMLNode, TdxXMLNode>.Create
        (ASubNode[AIndex], nil));
      Inc(AIndex);
    end;

    while (AIndex < ASubNode.Count) and
      (ASubNode[AIndex].Name = sdxXLSXNodeColor) do
    begin
...
procedure TdxSpreadSheetXLSXReaderConditionalFormattingDuplicateValuesRuleParser.
  AfterConstruction;
begin
  inherited AfterConstruction;
...
procedure TdxSpreadSheetXLSXReaderConditionalFormattingTopBottomRuleParser.
  AfterConstruction;
begin
  inherited AfterConstruction;
...
begin
  ...
  ATopBottomRule.Value := Node.Attributes.GetValueAsInteger
    (sdxXLSXAttrRank, 10);
...
procedure TdxSpreadSheetXLSXReaderConditionalFormattingUniqueValuesRuleParser.
  AfterConstruction;
begin
  inherited AfterConstruction;
...
procedure TdxSpreadSheetXLSXReaderConditionalFormattingIconSetRuleParser.
  CreateRule(AAreas: TdxSpreadSheetAreaList);
begin
  FRule := TdxSpreadSheetConditionalFormattingRuleIconSet.Create
    (ConditionalFormatting);
  FRule.Areas := AAreas;
end;
...
function TdxSpreadSheetXLSXReaderConditionalFormattingIconSetRuleParser.GetRule
...
procedure TdxSpreadSheetXLSXReaderConditionalFormattingIconSetRuleParser.
  ParseIconSet(ANode: TdxXMLNode);
const
  OrderMap: array [Boolean]
    of TdxSpreadSheetConditionalFormattingRuleIconSetOrder = (isioNormal,
    isioReversed);
var
  I: Integer;
begin
  Rule.BeginUpdate;
  try
    Rule.PresetName := dxXMLStringToString
      (ANode.Attributes.GetValue(sdxXLSXAttrIconSet, '3TrafficLights1'));
    Rule.ShowValue := ANode.Attributes.GetValueAsBoolean
      (sdxXLSXAttrShowValue, True);
    Rule.Order := OrderMap
      [ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrReverse)];
...
procedure TdxSpreadSheetXLSXReaderConditionalFormattingIconSetRuleParser.
  ParseIconSetCustomIcons(ANode: TdxXMLNode);
var
  AIndex: Integer;
...
begin
  AIndex := 0;
  while (AIndex < ANode.Count) and
    (ANode[AIndex].NameWithoutNameScope <> sdxXLSXNodeCFIcon) do
    Inc(AIndex);
  ...
  begin
    ...
    if ASubNode.NameWithoutNameScope <> sdxXLSXNodeCFIcon then
      Break;
    if ConditionalFormattingIconSet.Presets.FindByName
      (ASubNode.Attributes.GetValueAsString(sdxXLSXAttrIconSet), APreset) then
      Rule.Stops[AStopIndex].IconIndex := APreset.IconIndexes
        [ASubNode.Attributes.GetValueAsInteger(sdxXLSXAttrIconId)];
    Inc(AStopIndex);
    Inc(AIndex);
  end;
end;
...
procedure TdxSpreadSheetXLSXReaderConditionalFormattingIconSetRuleParser.
  ParseIconSetStop(ANode: TdxXMLNode;
  AStop: TdxSpreadSheetConditionalFormattingRuleIconSetStop);
begin
...
procedure TdxSpreadSheetXLSXReaderConditionalFormattingDataBarParser.CreateRule
  (AAreas: TdxSpreadSheetAreaList);
begin
  if not RuleMap.TryGetValue(Node.Attributes.GetValueAsString(sdxXLSXAttrIdLC),
    FRule) then
  begin
    FRule := TdxSpreadSheetConditionalFormattingRuleDataBar.Create
      (ConditionalFormatting);
    FRule.Areas := AAreas;
  end;
end;
...
begin
  ...
  begin
    ...
    Rule.ShowValue := ASubNode.Attributes.GetValueAsBoolean
      (sdxXLSXAttrShowValue, Rule.ShowValue);

    if ASubNode.Attributes.GetValueAsBoolean
      (sdxXLSXAttrNegativeBarColorSameAsPositive) then
      Rule.Style.NegativeBarColor := clDefault;

    if ASubNode.Attributes.GetValueAsBoolean
      (sdxXLSXAttrNegativeBarBorderColorSameAsPositive, True) then
    ...
    Rule.Style.AxisPosition := TdxSpreadSheetXLSXHelper.StringToAxisPosition
      (ASubNode.Attributes.GetValue(sdxXLSXAttrAxisPosition));
    Rule.Style.Direction := TdxSpreadSheetXLSXHelper.StringToDataBarDirection
      (ASubNode.Attributes.GetValue(sdxXLSXAttrDirection));
  end;
end;

function TdxSpreadSheetXLSXReaderConditionalFormattingDataBarParser.GetRule
  : TdxSpreadSheetConditionalFormattingRuleDataBar;
begin
  Result := TdxSpreadSheetConditionalFormattingRuleDataBar(FRule);
end;

procedure TdxSpreadSheetXLSXReaderConditionalFormattingDataBarParser.
  ProcessSubNode(ANode: TdxXMLNode; AUserData: Pointer);
begin
  if ANode.NameWithoutNameScope = sdxXLSXNodeCFVO then
  begin
  ...
  else if ANode.NameWithoutNameScope = sdxXLSXNodeBorderColor then
    ...
    (ANode.NameWithoutNameScope = sdxXLSXNodeFillColor) then
