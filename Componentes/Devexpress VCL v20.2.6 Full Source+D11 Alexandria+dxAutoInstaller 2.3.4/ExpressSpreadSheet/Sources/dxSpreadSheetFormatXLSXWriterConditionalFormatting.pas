...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Variants, Types, Windows, SysUtils, Classes, Graphics, dxCore, dxCoreClasses,
  cxClasses, dxCustomTree,
  dxXMLDoc, dxZIPUtils,
...
type
  ...
  TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingCustomRuleBuilderClass =
    class of TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingCustomRuleBuilder;

  TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingCustomRuleBuilder =
    class(TdxSpreadSheetCustomPackedWriterBuilder)
  strict private
    FNamePrefix: string;
  ...
  public
    constructor Create(AOwner: TdxSpreadSheetCustomFiler; AWriter: TdxXmlWriter;
      ...
      const ANamePrefix: string); virtual;
  ...
  TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingBuilder = class
  ...
  protected
    ...
    function IsCustomFormattedRule
    ...
    function IsValidRule(ARule
      : TdxSpreadSheetCustomConditionalFormattingRule): Boolean;
  ...
  public
    ...
    property Rules[Index: Integer]
      : TdxSpreadSheetCustomConditionalFormattingRule read GetRule;
    property Writer: TdxXmlWriter read FWriter;
  end;
  ...
  TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingStyleBasedRuleBuilder =
    class(TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingCustomRuleBuilder)
  protected
  ...
  public
    ...
    //
    property Rule: TdxSpreadSheetConditionalFormattingRuleAboveOrBelowAverage
      read GetRule;
  end;
  ...
  TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingExpressionRuleBuilder =
    class(TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingStyleBasedRuleBuilder)
  strict private
  ...
  public
    ...
    //
    property Rule: TdxSpreadSheetConditionalFormattingRuleExpression
      read GetRule;
  end;
  ...
  TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingCellIsRuleBuilder =
    class(TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingExpressionRuleBuilder)
  strict private
  ...
  strict private
    ...
    function GetStop(Index: Integer)
      : TdxSpreadSheetConditionalFormattingRuleColorScaleStop;
    function GetStopCount: Integer;
  protected
    function GetRuleType: TdxXMLString; override;
    procedure WriteStop(AStop
      : TdxSpreadSheetConditionalFormattingRuleColorScaleStop);
  public
    procedure WriteChildren; override;
    //
    property Rule: TdxSpreadSheetConditionalFormattingRuleCustomColorScale
      read GetRule;
  ...
  TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingIconSetRuleBuilder =
    class(TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingCustomRuleBuilder)
  strict private
    function EncodeValue(const AStop
      : TdxSpreadSheetConditionalFormattingRuleIconSetStop): string;
  ...
  public
    procedure WriteAttributes; override;
    //
    property Rule: TdxSpreadSheetConditionalFormattingRuleTopBottomValues
      read GetRule;
  end;
...
uses
  ...
  dxSpreadSheetConditionalFormattingIconSet, dxSpreadSheetCoreFormulasParser,
...
constructor
  TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingCustomRuleBuilder.Create
...
procedure TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingCustomRuleBuilder.
  Execute;
begin
  Writer.WriteStartElement(FNamePrefix,
    sdxXLSXNodeConditionalFormattingRule, '');
  try
    if NamePrefix <> '' then
...
procedure TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingCustomRuleBuilder.
  AddColorNode(const ANodeName: string; AColor: TColor);
begin
  if cxColorIsValid(AColor) then
  begin
    Writer.WriteStartElement(FNamePrefix, ANodeName, '');
    Writer.WriteAttributeString(sdxXLSXAttrRGB,
      TdxColorHelper.AlphaColorToHexCode(dxColorToAlphaColor(AColor), False));
    Writer.WriteEndElement;
  end;
end;

function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingCustomRuleBuilder.
  GetRuleStyleID(out ID: Integer): Boolean;
begin
  Result := False;
end;

function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingCustomRuleBuilder.
  GetConditionalFormattingStyles: TdxSpreadSheetXLSXWriterResourceList;
begin
  Result := Owner.ConditionalFormattingStyles;
end;

function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingCustomRuleBuilder.
  GetOwner: TdxSpreadSheetXLSXWriter;
begin
...
destructor
  TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingBuilder.Destroy;
begin
...
begin
  ...
  begin
    ARule := Rules[I];
    if IsValidRule(ARule) and not IsCustomFormattedRule(ARule) and
      FRuleBuilders.TryGetValue(ARule.ClassType, AClass) then
    begin
      ...
      begin
        ...
        Writer.WriteAttributeString(sdxXLSXAttrSqRef,
          EncodeReferences(ARule.Areas));
...
function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingBuilder.
  EncodeReferences(AAreas: TdxSpreadSheetAreaList): string;
begin
  Result := StringReplace(AAreas.ToString, AAreas.ValueSeparator, ' ',
    [rfReplaceAll]);
end;

function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingBuilder.
  IsCustomFormattedRule(ARule
  : TdxSpreadSheetCustomConditionalFormattingRule): Boolean;
begin
  Result := (ARule is TdxSpreadSheetConditionalFormattingRuleDataBar) or
    ...
    IsExtraIconSetPreset(TdxSpreadSheetConditionalFormattingRuleIconSet(ARule)
    .PresetName);
end;

function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingBuilder.
  IsExtraIconSetPreset(const APresetName: string): Boolean;
begin
  Result := (APresetName = '') or (APresetName = '3Triangles') or
    (APresetName = '5Boxes');
end;

function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingBuilder.
  IsValidRule(ARule: TdxSpreadSheetCustomConditionalFormattingRule): Boolean;
begin
  Result := ARule.Areas.Count > 0;
end;

procedure TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingBuilder.
  RegisterRulesBuilders;
begin
...
procedure TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingExBuilder.
  RegisterRulesBuilders;
begin
  FRuleBuilders.AddOrSetValue(TdxSpreadSheetConditionalFormattingRuleIconSet,
    TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingIconSetRuleBuilder);
...
begin
  ...
  begin
    ARule := Rules[I];
    if IsValidRule(ARule) and IsCustomFormattedRule(ARule) and
      FRuleBuilders.TryGetValue(ARule.ClassType, AClass) then
    begin
      ...
      begin
        ...
        Writer.WriteAttributeString('xmlns', 'x14', '',
          'http://schemas.microsoft.com/office/spreadsheetml/2009/9/main');
        Writer.WriteAttributeString('uri',
          '{78C0D931-6437-407d-A8EE-F0AAD7539E65}');
        Writer.WriteStartElement(sdxXLSXNamespaceX14,
          sdxXLSXNodeConditionalFormattings, '');
        ANodeStarted := True;
      end;

      Writer.WriteStartElement(sdxXLSXNamespaceX14,
        sdxXLSXNodeConditionalFormatting, '');
      try
        Writer.WriteAttributeString('xmlns', 'xm', '',
          'http://schemas.microsoft.com/office/excel/2006/main');
        ExecuteSubTask(AClass.Create(Owner, Writer, ARule,
          sdxXLSXNamespaceX14));
        Writer.WriteElementString('xm', 'sqref', '',
          EncodeReferences(ARule.Areas));
      finally
        Writer.WriteEndElement;
      end;
...
function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingStyleBasedRuleBuilder.
  GetRuleStyleID(out ID: Integer): Boolean;
begin
  ID := ConditionalFormattingStyles.Add
    (TdxSpreadSheetConditionalFormattingRuleStyleBased(Rule).Style.Handle);
  Result := True;
end;

{ TdxSpreadSheetXLSXWriterConditionalFormattingAboveAverageRuleBuilder }

procedure TdxSpreadSheetXLSXWriterConditionalFormattingAboveAverageRuleBuilder.
  WriteAttributes;
begin
  inherited;
  if Rule.ComparisonOperator in [abacoAboveOrEqualAverage,
    abacoBelowOrEqualAverage] then
    Writer.WriteAttributeInteger(sdxXLSXAttrEqualAverage, 1);
  if Rule.ComparisonOperator in [abacoBelowAverage, abacoBelowOrEqualAverage,
    abacoBelowAverageOnStandardDeviation] then
    Writer.WriteAttributeInteger(sdxXLSXAttrAboveAverage, 0);
  if Rule.ComparisonOperator in [abacoAboveAverageOnStandardDeviation,
    abacoBelowAverageOnStandardDeviation] then
    Writer.WriteAttributeInteger(sdxXLSXAttrStdDev,
      Rule.StandardDeviationLevel);
end;

function TdxSpreadSheetXLSXWriterConditionalFormattingAboveAverageRuleBuilder.
  GetRule: TdxSpreadSheetConditionalFormattingRuleAboveOrBelowAverage;
begin
...
procedure TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingExpressionRuleBuilder.
  WriteChildren;
begin
  inherited;
  Writer.WriteElementString(sdxXLSXNodeFormula,
    dxSpreadSheetFormulaExcludeEqualSymbol(Rule.Expression));
end;

function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingExpressionRuleBuilder.
  GetRuleType: TdxXMLString;
begin
...
function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingExpressionRuleBuilder.
  GetRule: TdxSpreadSheetConditionalFormattingRuleExpression;
begin
...
procedure TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingCellIsRuleBuilder.
  WriteAttributes;
begin
  inherited;
  Writer.WriteAttributeString(sdxXLSXAttrOperator,
    dxXLSXCfCellIsRuleOperator[Rule.ComparisonOperator]);
  if Rule.ComparisonOperator in [cicoBetween, cicoNotBetween] then
    Writer.WriteElementString(sdxXLSXNodeFormula,
      dxSpreadSheetFormulaExcludeEqualSymbol(Rule.Expression2));
end;

function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingCellIsRuleBuilder.
  GetRuleType: TdxXMLString;
begin
...
function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingCellIsRuleBuilder.
  GetRule: TdxSpreadSheetConditionalFormattingRuleCellIs;
begin
...
procedure TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingColorScaleBuilder.
  WriteChildren;
var
  I: Integer;
begin
...
function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingColorScaleBuilder.
  GetRuleType: TdxXMLString;
begin
...
function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingColorScaleBuilder.
  GetRule: TdxSpreadSheetConditionalFormattingRuleCustomColorScale;
begin
  Result := TdxSpreadSheetConditionalFormattingRuleCustomColorScale
    (inherited Rule);
end;

function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingColorScaleBuilder.
  GetStop(Index: Integer)
  : TdxSpreadSheetConditionalFormattingRuleColorScaleStop;
begin
  Result := TdxSpreadSheetConditionalFormattingRuleCustomColorScaleAccess(Rule)
    .Stops[Index];
end;
...
function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingDuplicateValuesRuleBuilder.
  GetRuleType: TdxXMLString;
begin
...
procedure TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingDataBarRuleBuilder.
  WriteChildren;
begin
  inherited;
  ...
  try
    ...
    Writer.WriteAttributeBoolean(sdxXLSXAttrBorder,
      cxColorIsValid(Rule.Style.PositiveBarBorderColor));
    Writer.WriteAttributeBoolean(sdxXLSXAttrGradient,
      Rule.Style.FillMode = dbfmGradient);
    Writer.WriteAttributeString(sdxXLSXAttrDirection,
      dxXLSXDataBarDirectionMap[Rule.Style.Direction]);
    Writer.WriteAttributeBoolean(sdxXLSXAttrNegativeBarColorSameAsPositive,
      Rule.Style.NegativeBarColor = clDefault);
    Writer.WriteAttributeBoolean
      (sdxXLSXAttrNegativeBarBorderColorSameAsPositive,
      Rule.Style.NegativeBarBorderColor = clDefault);
    Writer.WriteAttributeString(sdxXLSXAttrAxisPosition,
      dxXLSXAxisPosition[Rule.Style.AxisPosition]);
    ...
    AddColorNode(sdxXLSXNodeNegativeBorderColor,
      Rule.Style.NegativeBarBorderColor);
...
function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingDataBarRuleBuilder.
  GetRuleType: TdxXMLString;
begin
...
procedure TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingDataBarRuleBuilder.
  WriteStop(AStop: TdxSpreadSheetConditionalFormattingRuleCustomScaleStop);

  function GetValueType: AnsiString;
  begin
    if AStop.ValueType <> cssvtLimitValue then
      Result := dxXLSXScaleStopValueTypeMap[AStop.ValueType]
    else if AStop = Rule.MinValue then
...
begin
  ...
  try
    ...
    begin
      if NamePrefix <> '' then
        Writer.WriteElementString(sdxXLSXNamespaceXM, sdxXLSXNodeFunction, '',
          AStop.Value)
      else
        Writer.WriteAttributeString(sdxXLSXAttrVal, AStop.Value);
    end;
...
function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingDataBarRuleBuilder.
  GetRule: TdxSpreadSheetConditionalFormattingRuleDataBar;
begin
...
procedure TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingIconSetRuleBuilder.
  WriteChildren;
var
  I: Integer;
begin
  ...
  try
    ...
    if Rule.PresetName = '' then
      ...
      Writer.WriteAttributeBoolean(sdxXLSXAttrReverse,
        Rule.Order = isioReversed);
...
function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingIconSetRuleBuilder.
  GetRuleType: TdxXMLString;
begin
...
procedure TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingIconSetRuleBuilder.
  WriteStop(AStop: TdxSpreadSheetConditionalFormattingRuleIconSetStop);
begin
  Writer.WriteStartElement(NamePrefix, sdxXLSXNodeCFVO, '');
  try
    Writer.WriteAttributeString(sdxXLSXAttrTypeLC,
      dxXLSXScaleStopValueTypeMap[AStop.ValueType]);
    if NamePrefix <> '' then
      Writer.WriteElementString(sdxXLSXNamespaceXM, sdxXLSXNodeFunction, '',
        EncodeValue(AStop))
    else
...
procedure TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingIconSetRuleBuilder.
  WriteStopCustomIcon(AStop
  : TdxSpreadSheetConditionalFormattingRuleIconSetStop);
var
  AIndexInPreset: Integer;
  APreset: TdxSpreadSheetConditionalFormattingIconSetPreset;
begin
  if not ConditionalFormattingIconSet.Presets.FindByIconIndex(AStop.IconIndex,
    APreset, AIndexInPreset) then
    raise EdxSpreadSheetFormatError.CreateFmt
      (cxGetResourceString(@sdxErrorInternal), [ClassName]);
...
begin
  ...
  if Result = '' then
  begin
    if ConditionalFormattingIconSet.Presets.FindByCount(Rule.StopCount, APreset)
    then
      Result := APreset.Name
    else
      raise EdxSpreadSheetFormatError.CreateFmt
...
function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingIconSetRuleBuilder.
  GetRule: TdxSpreadSheetConditionalFormattingRuleIconSet;
begin
...
procedure TdxSpreadSheetXLSXWriterConditionalFormattingTopBottomRuleBuilder.
  WriteAttributes;
begin
  inherited;
...
function TdxSpreadSheetXLSXWriterConditionalFormattingTopBottomRuleBuilder.
  GetRule: TdxSpreadSheetConditionalFormattingRuleTopBottomValues;
begin
...
function TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingUniqueValuesRuleBuilder.
  GetRuleType: TdxXMLString;
begin
