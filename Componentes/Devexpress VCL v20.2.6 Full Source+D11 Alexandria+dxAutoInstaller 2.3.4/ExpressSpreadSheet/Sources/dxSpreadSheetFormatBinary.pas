...
{$ENDIF}
  ...
  dxSpreadSheetHyperlinks, dxSpreadSheetProtection,
...
type
  ...
  protected
    ...
    procedure ReadTableViewConditionalFormatting
      (AView: TdxSpreadSheetTableView); virtual;
    procedure ReadTableViewItems(AItems: TdxSpreadSheetTableItems); virtual;
    procedure ReadTableViewItemsGroupChildren
      (AGroup: TdxSpreadSheetTableItemGroup); virtual;
    procedure ReadTableViewMergedCells(AView: TdxSpreadSheetTableView); virtual;
    procedure ReadTableViewOptionsPrint
      (AOptions: TdxSpreadSheetTableViewOptionsPrint); virtual;
    ...
    property ContainerHyperlinks: TDictionary<Integer, TdxSpreadSheetContainer>
      read FContainerHyperlinks;
  ...
  strict private
    ...
    procedure WriteCount(const ACount: Integer;
      const ACountFieldPosition: Int64);
    procedure WriteNullCount(out ACount: Integer;
      out ACountFieldPosition: Int64);
  protected
    function CreateProgressHelper
      : TdxSpreadSheetCustomFilerProgressHelper; override;
    ...
    procedure WriteProtectionInfo(AProtectionInfo
    ...
    procedure WriteTableViewConditionalFormatting
      (AView: TdxSpreadSheetTableView); virtual;
    procedure WriteTableViewItems(AItems: TdxSpreadSheetTableItems); virtual;
    procedure WriteTableViewItemsGroupChildren
      (AGroup: TdxSpreadSheetTableItemGroup); virtual;
    procedure WriteTableViewMergedCells
      (AView: TdxSpreadSheetTableView); virtual;
    procedure WriteTableViewOptionsPrint
      (AOptions: TdxSpreadSheetTableViewOptionsPrint); virtual;
...
uses
  ...
  dxSpreadSheetConditionalFormatting, cxGraphics, dxSpreadSheetCoreStrs,
...
begin
  Result := (ID = dxSpreadSheetBinaryFormatHeaderID) and
    InRange(Version, 1, dxSpreadSheetBinaryFormatVersion);
end;

{ TdxSpreadSheetBinaryFormat }

class function TdxSpreadSheetBinaryFormat.CanReadFromStream
...
class function TdxSpreadSheetBinaryFormat.CreateFormatSettings
...
class function TdxSpreadSheetBinaryFormat.GetReader
  : TdxSpreadSheetCustomReaderClass;
begin
  Result := TdxSpreadSheetBinaryReader;
end;

class function TdxSpreadSheetBinaryFormat.GetWriter
...
constructor TdxSpreadSheetBinaryReader.Create(AOwner: TdxCustomSpreadSheet;
  AStream: TStream);
begin
...
function TdxSpreadSheetBinaryReader.CreateProgressHelper
...
function TdxSpreadSheetBinaryReader.ReadProtectionInfo
  : IdxSpreadSheetProtectionInfo;
begin
...
procedure TdxSpreadSheetBinaryReader.ReadTableView
...
procedure TdxSpreadSheetBinaryReader.ReadTableViewCells
  (AView: TdxSpreadSheetTableView);
var
...
procedure TdxSpreadSheetBinaryReader.ReadTableViewConditionalFormatting
  (AView: TdxSpreadSheetTableView);
var
  ...
  begin
    ...
    try
      ...
      begin
        ...
        begin
          ARule := TdxSpreadSheetConditionalFormattingCustomRuleClass(AClass)
            .Create(AView.ConditionalFormatting);
...
procedure TdxSpreadSheetBinaryReader.ReadTableViewItems
...
begin
  ...
  begin
    AItem := TdxSpreadSheetTableItemAccess
      (AItems.CreateItem(Reader.ReadInteger));
  ...
  begin
    CheckSectionHeader;
    ReadTableViewItemsGroupChildren(TdxSpreadSheetTableItemGroupsAccess
      (AItems.Groups).Root);
  end;
end;

procedure TdxSpreadSheetBinaryReader.ReadTableViewItemsGroupChildren
...
begin
  ...
  try
    ...
    begin
      ...
      ASubGroup := TdxSpreadSheetTableItemGroup.Create(AGroup.Owner, AGroup,
        AStartIndex, AFinishIndex);
      TdxSpreadSheetTableItemGroupAccess(ASubGroup).FCollapsedByUser :=
        Reader.ReadBoolean;
...
procedure TdxSpreadSheetBinaryReader.ReadTableViewMergedCells
  (AView: TdxSpreadSheetTableView);
var
  ACount: Integer;
begin
...
procedure TdxSpreadSheetBinaryReader.ReadTableViewOptionsPrint
  (AOptions: TdxSpreadSheetTableViewOptionsPrint);

  procedure ReadText(AValue
...
begin
  ...
  AOptions.Page.Orientation :=
    TdxSpreadSheetTableViewOptionsPrintPageOrientation(Reader.ReadByte);
  AOptions.Page.Scale := Reader.ReadInteger;
  AOptions.Page.ScaleMode := TdxSpreadSheetTableViewOptionsPrintPageScaleMode
    (Reader.ReadByte);
  ...
  AOptions.Printing.PageOrder :=
    TdxSpreadSheetTableViewOptionsPrintPrintingPageOrder(Reader.ReadByte);
  ...
  AOptions.Source.CellComments :=
    TdxSpreadSheetTableViewOptionsPrintSourceCellComments(Reader.ReadByte);
  ...
  AOptions.Source.ErrorIndication :=
    TdxSpreadSheetTableViewOptionsPrintSourceErrorIndication(Reader.ReadByte);
  AOptions.Source.GridLines := TdxDefaultBoolean(Reader.ReadByte);
  AOptions.Source.Headers := TdxDefaultBoolean(Reader.ReadByte);
end;

procedure TdxSpreadSheetBinaryReader.ReadTableViewProperties
  (AView: TdxSpreadSheetTableView);
begin
...
procedure TdxSpreadSheetBinaryReader.ReadTableViewSelection
  (AView: TdxSpreadSheetTableView);
var
  ACount: Integer;
begin
...
procedure TdxSpreadSheetBinaryReader.ReadViewContainers
...
var
  I: Integer;
begin
  if Reader.Version <= 6 then
    Exit;
  for I := 0 to SpreadSheet.SheetCount - 1 do
    if SpreadSheet.Sheets[I] is TdxSpreadSheetTableView then
      TdxSpreadSheetHyperlinksAccess
        (TdxSpreadSheetTableView(SpreadSheet.Sheets[I]).Hyperlinks)
...
begin
  ...
  try
    ...
    begin
      ...
      AClass := GetClass(Reader.ReadWideString);
      if (AClass = nil) or not AClass.InheritsFrom(TdxSpreadSheetCustomView)
      then
      begin
        DoError(cxGetResourceString(@sdxErrorUnsupportedSheetType), ssmtError);
        Abort;
      ...
      ReadView(SpreadSheet.AddSheet(Reader.ReadWideString,
        TdxSpreadSheetCustomViewClass(AClass)));
      ProgressHelper.NextTask;
      Dec(ACount);
    end;
  finally
...
begin
  ...
  begin
    ...
    AContainer.Hyperlink := TdxSpreadSheetTableView(AContainer.Parent)
      .Hyperlinks[I];
  end;
end;
...
constructor TdxSpreadSheetBinaryWriter.Create(AOwner: TdxCustomSpreadSheet;
  AStream: TStream);
begin
  inherited Create(AOwner, AStream);
  FCellStyles := TList<TdxSpreadSheetCellStyleHandle>.Create;
...
function TdxSpreadSheetBinaryWriter.CreateProgressHelper
  : TdxSpreadSheetCustomFilerProgressHelper;
begin
...
begin
  ...
  for I := 0 to SpreadSheet.DefinedNames.Count - 1 do
    TdxSpreadSheetDefinedNameAccess(SpreadSheet.DefinedNames[I])
      .SaveToStream(Writer);
end;
...
procedure TdxSpreadSheetBinaryWriter.WriteProtectionInfo(AProtectionInfo
  : IdxSpreadSheetProtectionInfo);
begin
  if AProtectionInfo is TdxSpreadSheetCustomProtectionInfo then
  begin
    Writer.WriteBoolean(True);
    Writer.WriteWideString(TdxSpreadSheetCustomProtectionInfo(AProtectionInfo)
      .Password);
  end
  else
...
procedure TdxSpreadSheetBinaryWriter.WriteTableView
  (AView: TdxSpreadSheetTableView);
begin
...
procedure TdxSpreadSheetBinaryWriter.WriteTableViewCells
  (AView: TdxSpreadSheetTableView);
var
  ARowCount: Integer;
...
begin
  ...
  TdxDynamicItemListAccess(AView.Rows).ForEach(
    ...
    begin
      ...
      TdxDynamicItemListAccess(TdxSpreadSheetTableRowAccess(Item).RowCells)
        .ForEach(procedure(Item: TdxDynamicListItem)
        var
          ACell: TdxSpreadSheetCellAccess;
        begin
...
procedure TdxSpreadSheetBinaryWriter.WriteTableViewConditionalFormatting
  (AView: TdxSpreadSheetTableView);
var
  ACount: Integer;
...
procedure TdxSpreadSheetBinaryWriter.WriteTableViewItems
  (AItems: TdxSpreadSheetTableItems);
var
  ACount: Integer;
  ACountPosition: Int64;
begin
  ...
  TdxDynamicItemListAccess(AItems).ForEach(procedure(Item: TdxDynamicListItem)
    var
      AItem: TdxSpreadSheetTableItemAccess;
    begin
  ...
  WriteSectionHeader;
  WriteTableViewItemsGroupChildren(TdxSpreadSheetTableItemGroupsAccess
    (AItems.Groups).Root);
end;

procedure TdxSpreadSheetBinaryWriter.WriteTableViewItemsGroupChildren
  (AGroup: TdxSpreadSheetTableItemGroup);
var
...
begin
  ...
  begin
    ...
    Writer.WriteBoolean(TdxSpreadSheetTableItemGroupAccess(AChildGroup)
      .IsCollapsedByUser);
    WriteTableViewItemsGroupChildren(AChildGroup);
  end;
end;

procedure TdxSpreadSheetBinaryWriter.WriteTableViewMergedCells
  (AView: TdxSpreadSheetTableView);
var
  I: Integer;
begin
...
procedure TdxSpreadSheetBinaryWriter.WriteTableViewOptionsPrint
  (AOptions: TdxSpreadSheetTableViewOptionsPrint);

  procedure WriteText(AValue
    : TdxSpreadSheetTableViewOptionsPrintHeaderFooterText);
  begin
...
procedure TdxSpreadSheetBinaryWriter.WriteTableViewProperties
  (AView: TdxSpreadSheetTableView);
begin
...
procedure TdxSpreadSheetBinaryWriter.WriteTableViewSelection
  (AView: TdxSpreadSheetTableView);
var
  I: Integer;
begin
...
procedure TdxSpreadSheetBinaryWriter.WriteViewContainer
  (AContainer: TdxSpreadSheetContainer);
begin
...
procedure TdxSpreadSheetBinaryWriter.WriteViewContainers
  (AView: TdxSpreadSheetCustomView);
var
  I: Integer;
begin
...
procedure TdxSpreadSheetBinaryWriter.WriteCount(const ACount: Integer;
const ACountFieldPosition: Int64);
var
  APosition: Int64;
begin
...
procedure TdxSpreadSheetBinaryWriter.WriteNullCount(out ACount: Integer;
out ACountFieldPosition: Int64);
begin
  ACount := 0;
