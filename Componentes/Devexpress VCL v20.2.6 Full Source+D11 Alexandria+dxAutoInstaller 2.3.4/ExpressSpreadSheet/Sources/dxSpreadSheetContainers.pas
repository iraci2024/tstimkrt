...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Windows, Classes, Graphics, Controls, cxVariants, dxGDIPlusClasses,
  cxGeometry, cxLibraryConsts, dxCore,
  dxSpreadSheetCore, dxSpreadSheetClasses, dxSpreadSheetTypes,
  dxSpreadSheetGraphics, dxSpreadSheetUtils,
  dxCoreClasses, dxCoreGraphics, cxDrawTextUtils, cxGraphics,
...
type
  ...
  public
    ...
    property ShapeType: TdxSpreadSheetShapeType read FShapeType
      write SetShapeType;
  end;
  ...
  protected
    ...
    procedure LoadFromStream(AReader: TcxReader; AVersion: Word;
      ACanReadContent: Boolean = True); override;
    ...
    procedure SaveToStream(AWriter: TcxWriter;
      ACanSaveContent: Boolean = True); override;
  public
    destructor Destroy; override;
    //
  ...
  protected
    ...
    function DoInitHitTest(const P: TPoint;
      AHitTest: TdxSpreadSheetCustomHitTest): Boolean; override;
  ...
  protected
    property ImageHandle: TdxSpreadSheetSharedImageHandle read FImageHandle
      write SetImageHandle;
  public
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
  ...
  TdxSpreadSheetPictureContainerViewInfo = class
    (TdxSpreadSheetShapeContainerViewInfo)
  strict private
  ...
  protected
    procedure LoadFromStream(AReader: TcxReader; AVersion: Word;
      ACanReadContent: Boolean = True); virtual;
    procedure SaveToStream(AWriter: TcxWriter;
  ...
  public
    ...
    property AlignVert: TVerticalAlignment read FAlignVert write SetAlignVert
      default taAlignTop;
  ...
  protected
    ...
    procedure SaveToStream(AWriter: TcxWriter;
      ACanSaveContent: Boolean = True); override;
    //
    property Calculator: TdxSpreadSheetCustomTextBoxContainerCalculator
      read GetCalculator;
    property TextBox: TdxSpreadSheetCustomTextBox read FTextBox
      write SetTextBox;
  public
  ...
  protected
    ...
    function KeepAutoSize(const APrevBounds, ANewBounds: TRect)
      : Boolean; virtual;
  ...
  TdxSpreadSheetCustomTextBoxContainerViewInfo = class
    (TdxSpreadSheetShapeContainerViewInfo)
  strict private
  ...
  public
    ...
    property TextBox: TdxSpreadSheetCustomTextBox read GetTextBox;
    property TextBoxViewInfo: TdxSpreadSheetTextBoxViewInfo
      read FTextBoxViewInfo;
  end;
  ...
  TdxSpreadSheetTextBoxContainerCalculator = class
    (TdxSpreadSheetCustomTextBoxContainerCalculator)
  protected
    function KeepAutoSize(const APrevBounds, ANewBounds: TRect)
      : Boolean; override;
  ...
  protected
    ...
    procedure LoadFromStream(AReader: TcxReader; AVersion: Word;
      ACanReadContent: Boolean = True); overload; override;
    procedure LoadFromStream(AReader: TcxReader; AVersion: Word;
      AAnchorRow, AAnchorColumn: Integer; ACanReadContent: Boolean = True);
      reintroduce; overload;
    procedure SaveToStream(AWriter: TcxWriter; ACanSaveContent: Boolean = True);
      overload; override;
    procedure SaveToStream(AWriter: TcxWriter;
      AAnchorRow, AAnchorColumn: Integer; ACanSaveContent: Boolean = True);
      reintroduce; overload;

    property Calculator: TdxSpreadSheetCommentContainerCalculator
      read GetCalculator;
  public
    class function GetDefaultPosition(ACell: TdxSpreadSheetCell): TRect; static;
    // for internal use only

    property Author: string read FAuthor write FAuthor;
    property Cell: TdxSpreadSheetCell read FCell write SetCell;
    property TextBox: TdxSpreadSheetCommentTextBox read GetTextBox
      write SetTextBox;
  end;
  ...
  TdxSpreadSheetCommentContainerConnectionViewInfo = class
  ...
  const
    ...
    ArrowSize = 6;
  strict private
    function GetContainerViewInfo
      : TdxSpreadSheetCommentContainerViewInfo; inline;
  protected
    ...
    procedure CalculateLinePoints(const ACellBounds, AContainerBounds: TRect;
      AMarkPosition: TLeftRight); virtual;
  ...
  public
    ...
    property ContainerViewInfo: TdxSpreadSheetCommentContainerViewInfo
  ...
  public
    property ConnectionViewInfo
      : TdxSpreadSheetCommentContainerConnectionViewInfo
      read FConnectionViewInfo write FConnectionViewInfo;
    property Owner: TdxSpreadSheetCommentContainer read GetOwner;
  end;

  { TdxSpreadSheetContainerCustomMoveDragAndDropObject }

  TdxSpreadSheetContainerCustomMoveDragAndDropObject = class
  ...
  TdxSpreadSheetClonedContainerMoveDragAndDropObject = class
    (TdxSpreadSheetContainerCustomMoveDragAndDropObject)
  strict private
  ...
  TdxSpreadSheetContainerMoveDragAndDropObject = class
    (TdxSpreadSheetContainerCustomMoveDragAndDropObject)
  strict private
    FClonedContainer: TdxSpreadSheetContainer;
    FClonedContainerDragAndDropObject
      : TdxSpreadSheetClonedContainerMoveDragAndDropObject;

    function GetMoveClone: Boolean;
    procedure SetMoveClone(AValue: Boolean);
  protected
    function CreateDragAndDropObjectForClonedContainer
      : TdxSpreadSheetClonedContainerMoveDragAndDropObject; virtual;
    procedure DragAndDrop(const P: TPoint; var Accepted: Boolean); override;
    procedure EndDragAndDrop(Accepted: Boolean); override;
    //
    property ClonedContainer: TdxSpreadSheetContainer read FClonedContainer;
    property ClonedContainerDragAndDropObject
      : TdxSpreadSheetClonedContainerMoveDragAndDropObject
      read FClonedContainerDragAndDropObject;
  public
  ...
  TdxSpreadSheetContainerResizeDragAndDropObject = class
    (TdxSpreadSheetContainerCustomDragAndDropObject)
  strict private
  ...
  TdxSpreadSheetContainerRotateDragAndDropObject = class
    (TdxSpreadSheetContainerCustomDragAndDropObject)
  protected
    procedure BeginDragAndDrop; override;
...
uses
  Math, SysUtils, dxSpreadSheetCoreHistory, dxHashUtils, dxTypeHelpers,
  dxGDIPlusAPI, dxSpreadSheetStrs,
  dxSpreadSheetCoreStrs, RTLConsts, cxControls;
...
type
  ...
  TdxSpreadSheetTableViewControllerAccess = class
...
procedure TdxSpreadSheetShape.SetShapeType(const AValue
...
function TdxSpreadSheetShapeContainer.CreateViewInfo
...
procedure TdxSpreadSheetShapeContainer.LoadBrushFromStream(ABrush: TdxGPBrush;
  AReader: TcxReader);
var
...
procedure TdxSpreadSheetShapeContainer.LoadImageFromStream(AImage: TdxGPImage;
  AReader: TcxReader);
var
...
procedure TdxSpreadSheetShapeContainer.LoadFromStream(AReader: TcxReader;
...
procedure TdxSpreadSheetShapeContainer.SaveBrushToStream(ABrush: TdxGPBrush;
  AWriter: TcxWriter);
var
  I: Integer;
begin
...
procedure TdxSpreadSheetShapeContainer.SaveImageToStream(AImage: TdxGPImage;
  AWriter: TcxWriter);
var
  AImageData: TMemoryStream;
begin
...
procedure TdxSpreadSheetShapeContainer.SaveToStream(AWriter: TcxWriter;
...
begin
  Result := DoCreateShapePath(cxRectInflate(ContentBounds,
    Shape.Pen.Width / 2));
end;
...
function TdxSpreadSheetShapeContainerViewInfo.DoCreateShapePath
  (const R: TdxRectF): TdxGPPath;
var
  ARadius: Single;
begin
...
function TdxSpreadSheetShapeContainerViewInfo.DoInitHitTest(const P: TPoint;
  AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
begin
  Result := inherited DoInitHitTest(P, AHitTest) and
    (ShapePath.IsPointInPath(P) or ShapeOutlinePath.IsPointInPathOutline(P,
    Shape.Pen));
end;

procedure TdxSpreadSheetShapeContainerViewInfo.DrawBackground
  (ACanvas: TdxGPCanvas);
begin
...
function TdxSpreadSheetShapeContainerViewInfo.GetOwner
  : TdxSpreadSheetShapeContainer;
begin
...
begin
  if AValue <> nil then
    ImageHandle := TdxCustomSpreadSheetAccess(SpreadSheet)
      .SharedImages.Add(AValue)
  else
    ImageHandle := nil;
end;

procedure TdxSpreadSheetPicture.SetImageHandle(const AValue
...
function TdxSpreadSheetPictureContainer.CreateViewInfo
  : TdxSpreadSheetContainerViewInfo;
begin
...
procedure TdxSpreadSheetPictureContainer.SetPicture
  (AValue: TdxSpreadSheetPicture);
begin
...
procedure TdxSpreadSheetPictureContainerViewInfo.DrawContent
  (ACanvas: TdxGPCanvas);
begin
  ...
  begin
    ...
    try
      ...
      ACanvas.Draw(Picture.ImageHandle.Image, cxRectInflate(ContentBounds,
        dxRectF(Picture.CropMargins)));
    finally
...
function TdxSpreadSheetPictureContainerViewInfo.GetOwner
  : TdxSpreadSheetPictureContainer;
begin
  Result := TdxSpreadSheetPictureContainer(inherited Owner);
end;

function TdxSpreadSheetPictureContainerViewInfo.GetPicture
  : TdxSpreadSheetPicture;
begin
...
constructor TdxSpreadSheetCustomTextBox.Create(ASpreadSheet
...
procedure TdxSpreadSheetCustomTextBox.LoadFromStream(AReader: TcxReader;
  AVersion: Word; ACanReadContent: Boolean = True);
begin
  ...
  begin
    if AReader.ReadBoolean then
      Text := TdxCustomSpreadSheetAccess(SpreadSheet)
        .StringTable.LoadItemFromStream(AReader)
    else
      Text := nil;
  end;
end;

procedure TdxSpreadSheetCustomTextBox.SaveToStream(AWriter: TcxWriter;
  ACanSaveContent: Boolean = True);
begin
...
procedure TdxSpreadSheetCustomTextBox.SetText
...
constructor TdxSpreadSheetTextBoxFont.Create
  (AOwner: TdxSpreadSheetCustomTextBox);
begin
...
constructor TdxSpreadSheetTextBoxViewInfo.Create
...
begin
  ACanvas.DrawString(TextBox.TextAsString, Font, FontBrush, Bounds,
    StringFormat);
end;

function TdxSpreadSheetTextBoxViewInfo.MeasureSize(const AWidth: Double)
  : TdxSizeF;
begin
...
procedure TdxSpreadSheetTextBoxViewInfo.CalculateFont;
  ...
  begin
    ...
    Result := (GdipCreateFontFromLogfont(cxScreenCanvas.Handle, @ALogFont,
      AFontHandle) = OK) and (AFontHandle <> nil);
    cxScreenCanvas.Dormant;
  end;
...
begin
  ...
  try
    ...
    FFontBrush.Color := dxMakeAlphaColor(cxGetActualColor(ATempFont.Color,
      clWindowText));
  finally
    ATempFont.Free;
  end;
...
begin
  ...
  StringFormat.LineAlignment := dxGpVerticalAlignmentToLineAlignment
    [TextBox.AlignVert];
  StringFormat.FormatFlags := Integer(dxGpWordWrapFlagsMap[TextBox.WordWrap]);
end;

procedure TdxSpreadSheetTextBoxViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
  StringFormat.FormatFlags := StringFormat.FormatFlags or
    Integer(StringFormatFlagsDirectionRightToLeft);
end;
...
procedure TdxSpreadSheetCustomTextBoxContainer.Changed
...
function TdxSpreadSheetCustomTextBoxContainer.CreateTextBox
  : TdxSpreadSheetCustomTextBox;
begin
  Result := TdxSpreadSheetTextBox.Create(SpreadSheet);
end;

function TdxSpreadSheetCustomTextBoxContainer.CreateViewInfo
  : TdxSpreadSheetContainerViewInfo;
begin
...
procedure TdxSpreadSheetCustomTextBoxContainer.DoChanged
  (AChanges: TdxSpreadSheetContainerChanges);
begin
...
procedure TdxSpreadSheetCustomTextBoxContainer.LoadFromStream
  (AReader: TcxReader; AVersion: Word; ACanReadContent: Boolean = True);
begin
  inherited LoadFromStream(AReader, AVersion, ACanReadContent);
  TextBox.LoadFromStream(AReader, AVersion, ACanReadContent);
end;

procedure TdxSpreadSheetCustomTextBoxContainer.SaveToStream(AWriter: TcxWriter;
  ACanSaveContent: Boolean = True);
begin
  inherited SaveToStream(AWriter, ACanSaveContent);
...
function TdxSpreadSheetCustomTextBoxContainer.GetCalculator
  : TdxSpreadSheetCustomTextBoxContainerCalculator;
begin
  Result := TdxSpreadSheetCustomTextBoxContainerCalculator
    (inherited Calculator);
end;

procedure TdxSpreadSheetCustomTextBoxContainer.TextBoxChangeHandler
  (Sender: TObject);
begin
  Changed([ccContent]);
end;

procedure TdxSpreadSheetCustomTextBoxContainer.SetTextBox
  (AValue: TdxSpreadSheetCustomTextBox);
begin
...
procedure TdxSpreadSheetCustomTextBoxContainerCalculator.UpdateAnchors
  (const ABounds: TRect);
  ...
  begin
    ...
    begin
      BeginAutoSize;
      try
        UpdateAnchors(ValidateBounds(cxRectCenter(ABounds,
          CalculateAutoSize(cxRectWidth(ABounds)))));
      finally
        EndAutoSize;
      end;
    end
...
function TdxSpreadSheetCustomTextBoxContainerCalculator.CalculateAutoSize
  (AWidth: Integer): TSize;
var
  AViewInfo: TdxSpreadSheetCustomTextBoxContainerViewInfo;
begin
  AViewInfo := TdxSpreadSheetContainerAccess(Owner)
    .CreateViewInfo as TdxSpreadSheetCustomTextBoxContainerViewInfo;
  try
    AViewInfo.Calculate;
...
function TdxSpreadSheetCustomTextBoxContainerCalculator.KeepAutoSize
  (const APrevBounds, ANewBounds: TRect): Boolean;
begin
...
constructor TdxSpreadSheetCustomTextBoxContainerViewInfo.Create
...
begin
  ...
  ATextBoxBounds := cxRectContent(ContentBounds,
    dxRectF(TextBox.ContentOffsets));
...
function TdxSpreadSheetCustomTextBoxContainerViewInfo.CreateTextBoxViewInfo
  : TdxSpreadSheetTextBoxViewInfo;
begin
...
procedure TdxSpreadSheetCustomTextBoxContainerViewInfo.DrawContent
  (ACanvas: TdxGPCanvas);
begin
  ...
  begin
    ...
    try
      ...
      begin
        ...
        try
          ACanvas.FlipWorldTransform(FlipHorz, False,
            cxRectCenter(ContentBounds));
...
procedure TdxSpreadSheetCustomTextBoxContainerViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited;
...
function TdxSpreadSheetCustomTextBoxContainerViewInfo.GetOwner
  : TdxSpreadSheetCustomTextBoxContainer;
begin
  Result := TdxSpreadSheetCustomTextBoxContainer(inherited Owner);
end;

function TdxSpreadSheetCustomTextBoxContainerViewInfo.GetTextBox
  : TdxSpreadSheetCustomTextBox;
begin
...
function TdxSpreadSheetTextBoxContainer.CreateCalculator
  : TdxSpreadSheetContainerCalculator;
begin
  Result := TdxSpreadSheetTextBoxContainerCalculator.Create(Self);
end;

function TdxSpreadSheetTextBoxContainer.CreateTextBox
  : TdxSpreadSheetCustomTextBox;
begin
  Result := TdxSpreadSheetTextBox.Create(SpreadSheet);
end;
...
procedure TdxSpreadSheetTextBoxContainer.SetTextBox
  (AValue: TdxSpreadSheetTextBox);
begin
...
function TdxSpreadSheetTextBoxContainerCalculator.KeepAutoSize
  (const APrevBounds, ANewBounds: TRect): Boolean;
begin
...
function TdxSpreadSheetTextBoxContainerCalculator.GetTextBox
  : TdxSpreadSheetCustomTextBox;
begin
...
constructor TdxSpreadSheetCommentTextBox.Create(ASpreadSheet
  : TdxCustomSpreadSheet);
begin
  inherited Create(ASpreadSheet);
  WordWrap := True;
...
function TdxSpreadSheetCommentTextBoxViewInfo.MeasureSize(const AWidth: Double)
  : TdxSizeF;
begin
  dxGPPaintCanvas.BeginPaint(cxScreenCanvas.Handle, cxSimpleRect);
  try
...
class function TdxSpreadSheetCommentContainer.GetDefaultPosition
  (ACell: TdxSpreadSheetCell): TRect;
begin
  Result := TdxSpreadSheetTableViewAccess(ACell.View).GetAbsoluteCellBounds
    (ACell.RowIndex, ACell.ColumnIndex, True);
...
function TdxSpreadSheetCommentContainer.CreateCalculator
  : TdxSpreadSheetContainerCalculator;
begin
...
function TdxSpreadSheetCommentContainer.CreateTextBox
  : TdxSpreadSheetCustomTextBox;
begin
  Result := TdxSpreadSheetCommentTextBox.Create(SpreadSheet);
end;

function TdxSpreadSheetCommentContainer.CreateViewInfo
  : TdxSpreadSheetContainerViewInfo;
begin
...
procedure TdxSpreadSheetCommentContainer.DoSetParent
  (AValue: TdxSpreadSheetCustomView);
var
...
begin
  ...
  Cell := TdxSpreadSheetCellHelper.GetCell(ASavedCellPos.Y,
    ASavedCellPos.X, Parent);
end;
...
procedure TdxSpreadSheetCommentContainer.CellRemoving
...
function TdxSpreadSheetCommentContainer.IsCellUsed
...
procedure TdxSpreadSheetCommentContainer.LoadFromStream(AReader: TcxReader;
  AVersion: Word; AAnchorRow, AAnchorColumn: Integer;
  ACanReadContent: Boolean = True);
begin
  inherited LoadFromStream(AReader, AVersion, ACanReadContent);
  Cell := TdxSpreadSheetCellHelper.ReadRef(AReader, Parent, AAnchorRow,
    AAnchorColumn);
...
function TdxSpreadSheetCommentContainer.GetCalculator
  : TdxSpreadSheetCommentContainerCalculator;
begin
  Result := TdxSpreadSheetCommentContainerCalculator(inherited Calculator);
end;

function TdxSpreadSheetCommentContainer.GetTextBox
  : TdxSpreadSheetCommentTextBox;
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      if (Parent <> nil) and Parent.Containers.FindCommentContainer(AValue,
        AContainer) then
        raise EdxSpreadSheetError.CreateFmt
          (cxGetResourceString(@sdxErrorCommentAlreadyExists),
          [TdxSpreadSheetCellHelper.EncodeRefAsString(AValue)]);
    end;

    if Parent <> nil then
    begin
      TdxSpreadSheetContainersAccess(Parent.Containers)
        .UnregisterCommentContainer(Self);
      FCell := AValue;
      TdxSpreadSheetContainersAccess(Parent.Containers)
        .RegisterCommentContainer(Self);
    end
    else
      FCell := AValue;
...
procedure TdxSpreadSheetCommentContainer.SetTextBox
  (AValue: TdxSpreadSheetCommentTextBox);
begin
  TextBox.Assign(AValue);
end;
...
function TdxSpreadSheetCommentContainerCalculator.GetTextBox
  : TdxSpreadSheetCustomTextBox;
begin
...
procedure TdxSpreadSheetCommentContainerConnectionViewInfo.Offset(X,
  Y: Integer);
var
  I: Integer;
begin
...
procedure TdxSpreadSheetCommentContainerConnectionViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited;
  FMarkPosition := TdxRightToLeftLayoutConverter.ConvertAlignment
    (FMarkPosition);
  CalculateBounds;
end;
...
begin
  FBounds := cxRect(Min(LinePoint1.X, LinePoint2.X),
...
procedure TdxSpreadSheetCommentContainerConnectionViewInfo.CalculateArrow;
  ...
  begin
    Result := dxPointF(LinePoint1.X + ArrowSize * Sin(AAngle),
      LinePoint1.Y + ArrowSize * Cos(AAngle));
  end;
...
begin
  CalculateLinePoints(ContainerViewInfo.CellBounds,
    cxRect(ContainerViewInfo.ContentBounds), FMarkPosition);
...
begin
  ...
  if cxRectPtIn(AContainerBounds, LinePoint1) and
    cxRectPtIn(AContainerBounds, LinePoint2) then
...
procedure TdxSpreadSheetCommentContainerConnectionViewInfo.DoDraw
  (ACanvas: TcxCanvas);
begin
  dxGPPaintCanvas.BeginPaint(ACanvas.Handle, Bounds);
  try
    dxSpreadSheetSetupGpCanvas(dxGPPaintCanvas,
      ContainerViewInfo.OptionsView.Antialiasing);
    dxGPPaintCanvas.Line(LinePoint1.X, LinePoint1.Y, LinePoint2.X,
      LinePoint2.Y, Color);
    dxGPPaintCanvas.Polygon(FArrowPoints, TdxAlphaColors.Transparent, Color, 1,
      gppsSolid);
  finally
    dxGPPaintCanvas.EndPaint;
  end;
...
function TdxSpreadSheetCommentContainerConnectionViewInfo.GetColor
  : TdxAlphaColor;
begin
  Result := ContainerViewInfo.Shape.Pen.Brush.Color;
  if (Result = TdxAlphaColors.Transparent) or (Result = TdxAlphaColors.Default)
  then
    Result := TdxAlphaColors.WindowText;
end;

function TdxSpreadSheetCommentContainerConnectionViewInfo.GetSpreadSheet
  : TdxCustomSpreadSheet;
begin
  Result := ContainerViewInfo.SpreadSheet;
end;

function TdxSpreadSheetCommentContainerConnectionViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
begin
...
procedure TdxSpreadSheetCommentContainerConnectionViewInfo.InvalidateRect
  (const R: TRect);
begin
  ContainerViewInfo.InvalidateRect(R);
end;

function TdxSpreadSheetCommentContainerConnectionViewInfo.GetContainerViewInfo
  : TdxSpreadSheetCommentContainerViewInfo;
begin
...
function TdxSpreadSheetCommentContainerViewInfo.CreateTextBoxViewInfo
  : TdxSpreadSheetTextBoxViewInfo;
begin
  Result := TdxSpreadSheetCommentTextBoxViewInfo.Create(TextBox);
end;

function TdxSpreadSheetCommentContainerViewInfo.DoCreateShapePath
  (const R: TdxRectF): TdxGPPath;
begin
  Result := TdxGPPath.Create;
  Result.AddRect(R);
...
begin
  ...
  begin
    ...
    Result := AView.ViewInfo.GetAreaBounds
      (AView.MergedCells.ExpandArea(ACell.ColumnIndex, ACell.RowIndex));
  end
  else
    Result := cxNullRect;
end;

function TdxSpreadSheetCommentContainerViewInfo.GetOwner
  : TdxSpreadSheetCommentContainer;
begin
...
procedure TdxSpreadSheetContainerCustomMoveDragAndDropObject.AlignToAxes
  (var R: TRect);
var
  P1, P2: TPoint;
begin
  ...
  if Abs(cxPointDistance(cxPoint(P2.X, P1.Y), P2)) >
    Abs(cxPointDistance(cxPoint(P1.X, P2.Y), P2)) then
...
procedure TdxSpreadSheetContainerCustomMoveDragAndDropObject.DragAndDrop
...
function TdxSpreadSheetContainerCustomMoveDragAndDropObject.GetDragAndDropCursor
...
constructor TdxSpreadSheetClonedContainerMoveDragAndDropObject.Create
  (AContainer: TdxSpreadSheetContainer);
begin
...
function TdxSpreadSheetClonedContainerMoveDragAndDropObject.GetContainerViewInfo
  : TdxSpreadSheetContainerViewInfo;
begin
...
function TdxSpreadSheetClonedContainerMoveDragAndDropObject.TranslateCoords
  (const P: TPoint): TPoint;
begin
  Result := P;
end;

function TdxSpreadSheetClonedContainerMoveDragAndDropObject.GetContainers
  : TdxSpreadSheetCellViewInfoList;
begin
  Result := TdxSpreadSheetCustomViewAccess(FContainer.Parent)
    .ViewInfo.Containers;
end;

{ TdxSpreadSheetContainerMoveDragAndDropObject }

function TdxSpreadSheetContainerMoveDragAndDropObject.
  CreateDragAndDropObjectForClonedContainer
  : TdxSpreadSheetClonedContainerMoveDragAndDropObject;
begin
  Result := TdxSpreadSheetClonedContainerMoveDragAndDropObject.Create
    (ClonedContainer);
end;

procedure TdxSpreadSheetContainerMoveDragAndDropObject.DragAndDrop
  (const P: TPoint; var Accepted: Boolean);
begin
  TdxSpreadSheetTableViewControllerAccess(TdxSpreadSheetTableView(View)
    .Controller).CanClickOnTheCell := False;
  MoveClone := IsControlPressed and TdxSpreadSheetContainerAccess
    (Container).CanClone;
...
procedure TdxSpreadSheetContainerMoveDragAndDropObject.EndDragAndDrop
  (Accepted: Boolean);
begin
  if ClonedContainerDragAndDropObject <> nil then
  begin
...
procedure TdxSpreadSheetContainerMoveDragAndDropObject.SetMoveClone
  (AValue: Boolean);
var
  AAccepted: Boolean;
begin
  ...
  begin
    if AValue then
    begin
      FClonedContainer := TdxSpreadSheetContainerClass(Container.ClassType)
        .Create(View);
...
procedure TdxSpreadSheetContainerResizeDragAndDropObject.AlignToCells
...
begin
  ...
  if Marker in [smLeft, smTopLeft, smBottomLeft, smRight, smTopRight,
    smBottomRight] then
    ADeltaX := ADeltaX + IfThen(dX <> MaxInt, dX);
  if Marker in [smTop, smTopLeft, smTopRight, smBottom, smBottomLeft,
    smBottomRight] then
    ADeltaY := ADeltaY + IfThen(dY <> MaxInt, dY);
end;

function TdxSpreadSheetContainerResizeDragAndDropObject.CalculateContentBounds
...
procedure TdxSpreadSheetContainerResizeDragAndDropObject.
  CheckAspectUsingCornerHandles(var ADeltaX, ADeltaY: Single);
var
  ARatio: Single;
  ARect: TdxRectF;
  ASign: Integer;
begin
  ...
  case Marker of
    smTopLeft, smTopRight:
      ARect.Top := ARect.Top + CapturePoint.Y -
        ToAbsoluteRect(ViewInfo.Bounds).Top;
    smBottomLeft, smBottomRight:
      ARect.Bottom := ARect.Bottom + CapturePoint.Y -
        ToAbsoluteRect(ViewInfo.Bounds).Bottom;
  end;
...
procedure TdxSpreadSheetContainerResizeDragAndDropObject.DragAndDrop
  (const P: TPoint; var Accepted: Boolean);
var
  ADeltaX: Single;
  ADeltaY: Single;
...
begin
  ...
  ViewInfo.ContentBounds :=
    cxRectAdjustF(cxRectOffset(ARect, dxPointF(ContentOrigin), False));

  InvalidateRects(APrevRealDrawingBounds, ViewInfo.RealDrawingBounds);
  inherited DragAndDrop(P, Accepted);
end;

procedure TdxSpreadSheetContainerResizeDragAndDropObject.EndDragAndDrop
  (Accepted: Boolean);
begin
  Control.BeginUpdate;
...
function TdxSpreadSheetContainerResizeDragAndDropObject.GetContainerViewInfo
  : TdxSpreadSheetContainerViewInfo;
begin
  Result := (HitTest.HitObject as TdxSpreadSheetContainerSelectionCellViewInfo)
    .ContainerViewInfo;
end;
...
begin
  ...
  try
    APivotPoint := dxPointF((AResizedPoint.X + AFixedPoint.X) / 2,
      (AResizedPoint.Y + AFixedPoint.Y) / 2);
...
procedure TdxSpreadSheetContainerResizeDragAndDropObject.ApplyBounds
  (const AFixedPoint, AResizedPoint: TdxPointF);
var
  R: TdxRectF;
begin
  case Marker of
    smTopLeft, smTop:
      R := dxRectF(AResizedPoint.X, AResizedPoint.Y, AFixedPoint.X,
        AFixedPoint.Y);
    smTopRight, smRight:
      R := dxRectF(AFixedPoint.X, AResizedPoint.Y, AResizedPoint.X,
        AFixedPoint.Y);
    smBottomRight, smBottom:
      R := dxRectF(AFixedPoint.X, AFixedPoint.Y, AResizedPoint.X,
        AResizedPoint.Y);
  else
    R := dxRectF(AResizedPoint.X, AFixedPoint.Y, AFixedPoint.X,
      AResizedPoint.Y);
  end;
  UpdateViewInfoBounds(cxRect(R, False));
end;

procedure TdxSpreadSheetContainerResizeDragAndDropObject.GetPoints
  (out AFixedPoint, AResizedPoint: TdxPointF);
begin
  case Marker of
    smTopLeft, smTop:
      begin
...
function TdxSpreadSheetContainerResizeDragAndDropObject.GetTransform
...
procedure TdxSpreadSheetContainerRotateDragAndDropObject.CheckScrollArea
  (const P: TPoint);
begin
  // do nothing
end;

procedure TdxSpreadSheetContainerRotateDragAndDropObject.DragAndDrop
  (const P: TPoint; var Accepted: Boolean);
const
  AlignAngle = 15;
var
...
begin
  ...
  ALength := Sqrt(Sqr(AVector1.X) + Sqr(AVector1.Y)) *
    Sqrt(Sqr(AVector2.X) + Sqr(AVector2.Y));
...
procedure TdxSpreadSheetContainerRotateDragAndDropObject.EndDragAndDrop
  (Accepted: Boolean);
begin
  if Accepted and not SameValue(ViewInfo.Transform.RotationAngle,
    ViewInfo.RotationAngle) then
  begin
    History.BeginAction(TdxSpreadSheetHistoryChangeContainerAction);
    try
      History.AddCommand(TdxSpreadSheetHistoryChangeContainerCommand.Create
...
function TdxSpreadSheetContainerRotateDragAndDropObject.GetContainerViewInfo
  : TdxSpreadSheetContainerViewInfo;
begin
  Result := (HitTest.HitObject as TdxSpreadSheetContainerSelectionCellViewInfo)
    .ContainerViewInfo;
...
function TdxSpreadSheetContainerRotateDragAndDropObject.GetDragAndDropCursor
  (Accepted: Boolean): TCursor;
begin
  if Accepted then
