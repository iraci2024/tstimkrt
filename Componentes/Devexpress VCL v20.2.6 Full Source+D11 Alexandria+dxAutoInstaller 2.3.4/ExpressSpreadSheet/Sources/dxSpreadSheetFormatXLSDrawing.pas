...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  ZLib, Windows, Types, Classes, SysUtils, Dialogs, Math, Graphics,
  Generics.Defaults, Generics.Collections,
  dxCore, dxCoreGraphics, cxClasses, cxVariants, dxGDIPlusClasses, dxHash,
  dxHashUtils, cxGeometry,
  dxSpreadSheetFormatXLS, dxSpreadSheetFormatXLSTypes, dxSpreadSheetCore,
  dxSpreadSheetFormulas, dxSpreadSheetTypes,
  dxSpreadSheetFunctions, dxSpreadSheetFormatXLSFormulas,
  dxSpreadSheetFormatUtils, dxSpreadSheetUtils,
  dxSpreadSheetClasses, dxSpreadSheetContainers, dxSpreadSheetHyperlinks,
  dxSpreadSheetFormatXLSWriter,
...
type
  ToaBlipTypes = (btError = 0, btUnknown = 1, btEmf = 2, btWmf = 3,
    btMacPict = 4, btJpeg = 5, btPng = 6, btDib = 7, btTiff = $11,
    btCMYKJpeg = $12);
...
type
  ...
  TdxXLSDrawingProperty = procedure(const AValue: Integer;
    const AComplexData: array of Byte) of object;
  ...
  strict private
    ...
    //
    procedure Property_BooleanProtection(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DiagramBooleanProperties(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingBlackWhiteMode(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingBlipBooleanProperties(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingBlipFlags(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingBlipIdentifier(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingBlipName(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingCropFromBottom(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingCropFromLeft(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingCropFromRight(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingCropFromTop(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillBlipIdentifier(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillStyleBooleanProperties(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingGroupShape2PctHoriz(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingGroupShape2PctHorizPos(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingGroupShape2PctVert(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingGroupShape2PctVertPos(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingGroupShape2SizeRelH(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingGroupShape2SizeRelV(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingGroupShapeBooleanProperties(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingGroupShapePosH(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingGroupShapePosRelH(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingGroupShapePosRelV(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingGroupShapePosV(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingLineCapStyle(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingLineColor(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingLineCompoundType(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingLineDashing(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingLineJoinStyle(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingLineMiterLimit(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingLineStyleBooleanProperties(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingLineWidth(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingRotation(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingShadowColor(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingShadowStyleBooleanProperties
      (const AValue: Integer; const AComplexData: array of Byte);
    procedure Property_DrawingShapeBooleanProperties(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingShapeDescription(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingShapeHyperlink(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingShapeName(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingShapeTooltip(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingTextBottom(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingTextIdentifier(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingTextLeft(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingTextRight(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingTextTop(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingWrapBottomDistance(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingWrapLeftDistance(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingWrapRightDistance(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingWrapText(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingWrapTopDistance(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingConnectionPointsType(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingTextBooleanProperties(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingTextDirection(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillColor(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillOpacity(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillBackColor(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillBackOpacity(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillBWColor(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillBlip(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillBlipName(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillBlipFlags(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillWidth(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillHeight(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillAngle(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillFocus(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillToLeft(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillToTop(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillToRight(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillToBottom(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillRectLeft(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillRectTop(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillRectRight(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillRectBottom(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillDzType(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillShadePreset(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillOriginX(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillOriginY(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillShapeOriginX(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillShapeOriginY(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillShadeColors(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillShadeType(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillColorExt(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillReserved415(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillTintShade(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillReserved417(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillBackColorExt(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillReserved419(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillBackTintShade(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillReserved421(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillReserved422(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingFillReserved423(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_DrawingShapeDocument(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_OfficeDrawingFillType(const AValue: Integer;
      const AComplexData: array of Byte);
    procedure Property_UndefinedComplexProperty(const AValue: Integer;
      const AComplexData: array of Byte);
    //
  ...
  protected
    ...
    function LoadMetaFile(AStream: TMemoryStream; AIsEMF: Boolean)
      : TdxSmartImage;
    function MakeAlphaColor(const AColor: TColor; AAlpha: Byte = 255;
      AReplaceAlpha: Boolean = False): TColor;
  ...
  public
    ...
    function CreateContainer(AContainerType: Integer = -1)
      : TdxSpreadSheetContainer; override;
  ...
  protected
    procedure EndRecord(ARecord: Integer;
      AIncludeSizeOfHeader: Boolean = False);
    ...
    procedure PrepareGradientColors(APoints: TdxGPBrushGradientPoints;
      var AColors: TdxXLSColorRefArray; var ABkColor: TColor);
    ...
    function MakeRecordHeader(AVersion, AInstance: Byte; ARecordType: Word)
      : Integer; overload;
    ...
    procedure WriteProperty_DrawingFillShadeColors(const AValue
      : TdxXLSColorRefArray; ADataWriter: TcxWriter);
    ...
    procedure WriteProperty_Hyperlink(AHyperlink: TdxSpreadSheetHyperlink;
      ADataWriter: TcxWriter);
    procedure WriteProperty_Text(ID: Word; const AName: UnicodeString;
      ADataWriter: TcxWriter);
    ...
    property TextBoxProperties: TdxSpreadSheetCustomTextBox
      read GetTextBoxProperties;
  public
    constructor Create(AOwner: TdxSpreadSheetXLSWriter);
    destructor Destroy; override;
    procedure WriteContainer(AContainer: TdxSpreadSheetContainer;
      AIsFirstOnTheSheet: Boolean; var ASize: Integer);
...
const
  ...
  ImageDataFormat2StoreFormat: array [TdxImageDataFormat]
    of TdxImageDataFormat = (dxImagePng, dxImagePng, dxImageJpeg, dxImagePng,
    dxImagePng, dxImagePng, dxImagePng { dxImageEmf } , dxImagePng, dxImagePng,
    dxImagePng, dxImagePng { dxImageEmf } );

  BlipFormatID: array [TdxImageDataFormat] of Integer = (msoBlipPNG, msoBlipPNG,
    msoBlipJPEG, msoBlipPNG, msoBlipPNG, msoBlipPNG, msoBlipPNG { msoBlipEMF } ,
    msoBlipPNG, msoBlipPNG, msoBlipPNG, msoBlipPNG { msoBlipEMF } );
...
procedure RecreateStreamFromDIB(ADestStream, ASourceStream: TStream;
  ASize: Integer);
var
  ABitmap: TBitmap;
begin
...
constructor TdxSpreadSheetMSODrawingReader.Create
  (AOwner: TdxSpreadSheetXLSReader);
begin
  inherited;
...
function TdxSpreadSheetMSODrawingReader.CreateContainer(AContainerType
  : Integer = -1): TdxSpreadSheetContainer;
var
...
function TdxSpreadSheetMSODrawingReader.LoadMetaFile(AStream: TMemoryStream;
  AIsEMF: Boolean): TdxSmartImage;
var
  ASize, ASave: Integer;
  ACanvasSize: TSize;
  ABounds: TRect;
...
function TdxSpreadSheetMSODrawingReader.MakeAlphaColor(const AColor: TColor;
  AAlpha: Byte = 255; AReplaceAlpha: Boolean = False): TColor;
begin
  with TRGBQuad(AColor) do
    if AReplaceAlpha then
      Result := dxMakeAlphaColor(AAlpha, rgbBlue, rgbGreen, rgbRed)
    else
      Result := dxMakeAlphaColor(Max(0, Min(255, AAlpha - rgbReserved)),
...
begin
  ...
  begin
    ...
    AContainer.AnchorPoint1.Cell := Owner.CurrentSheet.CreateCell(FAnchor.Row1,
      FAnchor.Col1);
    AContainer.AnchorPoint1.Offset := Point(FAnchor.Col1Offset,
      FAnchor.Row1Offset);
    AContainer.AnchorPoint2.Cell := Owner.CurrentSheet.CreateCell(FAnchor.Row2,
      FAnchor.Col2);
    AContainer.AnchorPoint2.Offset := Point(FAnchor.Col2Offset,
      FAnchor.Row2Offset);
    AContainer.Transform.RotationAngle := FRotationAngle;

    if FAnchorType <> catTwoCell then
    begin
      AContainerBounds := TdxSpreadSheetContainerAccess(AContainer)
        .Calculator.CalculateBounds;
      try
  ...
  if AContainer is TdxSpreadSheetPictureContainer then
    TdxSpreadSheetPictureContainer(AContainer).Picture.Image :=
      GetGraphic(FBlipID);

  if AContainer is TdxSpreadSheetTextBoxContainer then
  begin
    TdxSpreadSheetTextBoxContainer(AContainer).TextBox.ContentOffsets :=
      FTextPadding;
  ...
  begin
    ...
    if HasShape then
      AShape.ShapeType := TdxSpreadSheetShapeType(IFThen(FShapeType > 3, 1,
        FShapeType) - 1);
    ...
    begin
      ...
      for I := 0 to FBrushColors.Count - 1 do
        AShape.Brush.GradientPoints.Add
    ...
    begin
      dxSpreadSheetInitializeBrushPattern(AShape.Brush, GetGraphic(FFillBlipID),
        FBrushBottomColor, FBrushColor,
        Owner.Textures.IndexOf(GetGraphic(FFillBlipID)) >= 0);
    end;
...
function TdxSpreadSheetMSODrawingReader.GetGraphic(AIndex: Integer)
  : TdxSmartImage;
begin
...
begin
  Result := (FBlipID >= 0) and (FBlipID < Owner.Images.Count) and
    (Owner.Images[FBlipID] <> nil);
end;
  ...
  begin
    ...
    try
      if AFormat = dxImageMemoryBmp then
        RecreateStreamFromDIB(AStream, Stream, Integer(RecordHeader.recSize)
          - AOffset)
      else
...
begin
  ...
  try
    ...
    begin
      ...
      else if Assigned(FPropertyReaders[AKey]) then
    ...
    begin
      ...
      AComplexProperties[APropIndex](AComplexPropertySize[APropIndex],
        AComplexData);
    end;
  finally
...
procedure TdxSpreadSheetMSODrawingReader.RegisterPropertyReader(AKey: Word;
  AProc: TdxXLSDrawingProperty);
begin
  FPropertyReaders[AKey] := AProc;
end;

function TdxSpreadSheetMSODrawingReader.ComplexDataToString(const AComplexData
...
begin
  ...
  FBrushGradientMode := dxGetNearestGradientMode(P.Fractional,
    FBrushGradientModeInverseOrder);
end;
...
procedure TdxSpreadSheetMSODrawingReader.Property_DrawingFillOpacity
  (const AValue: Integer; const AComplexData: array of Byte);
begin
  FBrushColor := dxMakeAlphaColor(dxAlphaColorToColor(FBrushColor),
    MulDiv(AValue, 255, 65536));
end;
...
procedure TdxSpreadSheetMSODrawingReader.
  Property_DrawingFillStyleBooleanProperties(const AValue: Integer;
  const AComplexData: array of Byte);
begin
  // $100010
end;
...
procedure TdxSpreadSheetMSODrawingReader.
  Property_DrawingGroupShapeBooleanProperties(const AValue: Integer;
  const AComplexData: array of Byte);
begin
...
procedure TdxSpreadSheetMSODrawingReader.Property_DrawingLineDashing
  (const AValue: Integer; const AComplexData: array of Byte);
const
  StyleToGPPenStyle: array [0 .. $A] of TdxGPPenStyle = (gppsSolid, gppsSolid,
    gppsDot, gppsDashDot, gppsDashDotDot, gppsDot, gppsDash, gppsDashDot,
    gppsDashDot, gppsDashDot, gppsDashDot);
begin
...
procedure TdxSpreadSheetMSODrawingReader.
  Property_DrawingLineStyleBooleanProperties(const AValue: Integer;
  const AComplexData: array of Byte);
begin
  // 524296
end;
...
procedure TdxSpreadSheetMSODrawingReader.Property_DrawingRotation
  (const AValue: Integer; const AComplexData: array of Byte);
begin
...
procedure TdxSpreadSheetMSODrawingReader.
  Property_DrawingShadowStyleBooleanProperties(const AValue: Integer;
  const AComplexData: array of Byte);
begin
...
procedure TdxSpreadSheetMSODrawingReader.ReadComplexData(ASize: Integer;
  var AData: array of Byte);
begin
  Stream.ReadBuffer(AData[0], Length(AData));
end;

function TdxSpreadSheetMSODrawingReader.HOffsetToInt(AColumnIndex,
  AOffset: Integer): Integer;
begin
  if TdxSpreadSheetTableView(Owner.CurrentSheet).Columns[AColumnIndex] = nil
  then
    Result := TdxSpreadSheetTableView(Owner.CurrentSheet).Columns.DefaultSize
  else
    Result := TdxSpreadSheetTableView(Owner.CurrentSheet)
      .Columns[AColumnIndex].size;
  Result := Round(Result * AOffset / 1024);
end;

function TdxSpreadSheetMSODrawingReader.VOffsetToInt(ARowIndex,
  AOffset: Integer): Integer;
begin
...
constructor TdxSpreadSheetMSODrawingWriter.Create
  (AOwner: TdxSpreadSheetXLSWriter);
begin
  inherited Create;
  FOwner := AOwner;
...
procedure TdxSpreadSheetMSODrawingWriter.WriteContainer
  (AContainer: TdxSpreadSheetContainer; AIsFirstOnTheSheet: Boolean;
  var ASize: Integer);
var
...
begin
  ...
  try
    ...
    begin
      ABlipContainer := MakeRecordHeader(15, CalcDrawingsCount + 1,
        oaBlipStoreContainer);
      try
...
procedure TdxSpreadSheetMSODrawingWriter.EndRecord(ARecord: Integer;
  AIncludeSizeOfHeader: Boolean = False);
var
  ASize: Integer;
begin
...
begin
  ...
  try
    ...
    CurrentImage.SaveToStreamByCodec(ImageBinaryData,
      ImageDataFormat2StoreFormat[CurrentImage.ImageDataFormat]);
    PInteger(@PByteArray(ImageBinaryData.Memory)^[4])^ :=
      ImageBinaryData.size - 8;
    dxMD4Calc(@PByteArray(ImageBinaryData.Memory)^[DataOffset],
      ImageBinaryData.size - DataOffset, AHash);
...
procedure TdxSpreadSheetMSODrawingWriter.Initialize
  (AContainer: TdxSpreadSheetContainer);
var
...
begin
  ...
  begin
    if AContainer is TdxSpreadSheetPictureContainer then
    begin
      AImageHandle := TdxSpreadSheetPictureAccess
        (TdxSpreadSheetPictureContainer(AContainer).Picture).ImageHandle;
...
procedure TdxSpreadSheetMSODrawingWriter.InitializeShape
  (AContainer: TdxSpreadSheetContainer);
begin
  if AContainer is TdxSpreadSheetShapeContainer then
...
procedure TdxSpreadSheetMSODrawingWriter.PrepareGradientColors
  (APoints: TdxGPBrushGradientPoints; var AColors: TdxXLSColorRefArray;
  var ABkColor: TColor);
var
  I: Integer;
  AOffset: Single;
begin
  ...
  begin
    ...
    AColors[I].Position := Min(MAXWORD + 1,
      Round(APoints.Offsets[I] * (MAXWORD + 1)));
  end;
end;

procedure TdxSpreadSheetMSODrawingWriter.MakeProperty(APropertyID: Word;
  AValue: Integer);
begin
...
function TdxSpreadSheetMSODrawingWriter.MakeRecordHeader(AInstance,
  ARecordType: Word): Integer;
begin
...
function TdxSpreadSheetMSODrawingWriter.MakeRecordHeader(AVersion,
  AInstance: Byte; ARecordType: Word): Integer;
begin
  Result := MakeRecordHeader((AVersion and $0F) or
    ((AInstance and $0FFF) shl 4), ARecordType);
end;
...
var
  ...
  AEntry: TdxMSOBlipStoreEntry;
begin
  ARecord := MakeRecordHeader(2, BlipFormatID[CurrentImage.ImageDataFormat],
    oaFileBlipStoreEntry);
  ...
  // MD4 UID
  MakeImageBinaryData;
  Move(PByteArray(ImageBinaryData.Memory)^[8], AEntry.rgbUid,
    SizeOf(TdxMD4Byte16));
  AEntry.tag := $FF;
  ...
  PLongWord(@PByteArray(Stream.Memory)[ARecord])^ := SizeOf(AEntry) +
    ImageBinaryData.size;
end;

procedure TdxSpreadSheetMSODrawingWriter.WriteClientAnchor;

  procedure CalculateAnchor(AAnchor: TdxSpreadSheetContainerAnchorPoint;
    const P: TPoint; var AAnchorPoint, AAnchorOffset: TPoint;
    ACanUseCell: Boolean);
  var
  ...
  begin
    ...
    else if Supports(CurrentSheet, IdxSpreadSheetTableView, ATableView) then
      if ATableView.GetCellAtAbsolutePoint(P, AAnchorPoint.Y, AAnchorPoint.X)
      then
      begin
        AAnchorPoint.Y := CheckRow(AAnchorPoint.Y);
        AAnchorPoint.X := CheckColumn(AAnchorPoint.X);
        AAnchorOffset := cxPointOffset(P,
          ATableView.GetAbsoluteCellBounds(AAnchorPoint.Y, AAnchorPoint.X,
          False).TopLeft, False);
      end;
  end;
...
begin
  ...
  try
    ...
    AContainerBounds := TdxSpreadSheetContainerAccess(Container)
      .Calculator.CalculateBounds;

    CalculateAnchor(Container.AnchorPoint1, AContainerBounds.TopLeft,
      AAnchorPoint, AAnchorOffset, Container.AnchorType <> catAbsolute);
...
procedure TdxSpreadSheetMSODrawingWriter.WriteFileShape(AWriteContainerSettings
  : Boolean);
...
begin
  ...
  ARecord := MakeRecordHeader(3, 5 + Byte(IsShape) + Byte(BlipID >= 0) +
    Byte(AHasGradient) * 2 + 5 * Byte(IsTextBox) + Byte(AHyperlink <> nil) +
    Byte((AHyperlink <> nil) and (AHyperlink.ScreenTip <> '')) + Byte(AHasName),
    oaPropertiesTable);
  ...
  try
    ...
    WriteProperty_DrawingFillColor(ValidateColor(Shape.Brush.Color,
      clDefaultFillColor));
    if AHasGradient then
    begin
      PrepareGradientColors(Shape.Brush.GradientPoints, AColors, ABkColor);
      WriteProperty_DrawingFillBackColor(ValidateColor(ABkColor,
        clDefaultFillColor));
      WriteProperty_DrawingFillShadeColors(AColors, AComplexDataWriter);
    end;
    WriteProperty_DrawingLineColor(ValidateColor(Shape.Pen.Brush.Color,
      clDefaultLineColor));
...
procedure TdxSpreadSheetMSODrawingWriter.WriteTextBoxProperties
  (ATextBox: TdxSpreadSheetCustomTextBox);
begin
  MakeProperty($0081, dxPixelsToEMU(TdxSpreadSheetCustomTextBoxAccess(ATextBox)
    .ContentOffsets.Left));
  MakeProperty($0082, dxPixelsToEMU(TdxSpreadSheetCustomTextBoxAccess(ATextBox)
    .ContentOffsets.Top));
  MakeProperty($0083, dxPixelsToEMU(TdxSpreadSheetCustomTextBoxAccess(ATextBox)
    .ContentOffsets.Right));
  MakeProperty($0084, dxPixelsToEMU(TdxSpreadSheetCustomTextBoxAccess(ATextBox)
    .ContentOffsets.Bottom));
  MakeProperty($0085, IFThen(TdxSpreadSheetCustomTextBoxAccess(ATextBox)
    .WordWrap, 0, 2));
end;

procedure TdxSpreadSheetMSODrawingWriter.WriteProperty_DrawingBlipIdentifier
  (AIsPicture: Boolean);
const
...
procedure TdxSpreadSheetMSODrawingWriter.
  WriteProperty_DrawingFillBlipIdentifier;
begin
end;

procedure TdxSpreadSheetMSODrawingWriter.WriteProperty_DrawingFillBackColor
  (AValue: Integer);
begin
  MakeProperty($0183, AValue);
end;

procedure TdxSpreadSheetMSODrawingWriter.WriteProperty_DrawingFillColor
  (AValue: Integer);
begin
...
procedure TdxSpreadSheetMSODrawingWriter.WriteProperty_DrawingLineColor
  (AValue: Integer);
begin
  MakeProperty($01C0, AValue);
end;

procedure TdxSpreadSheetMSODrawingWriter.WriteProperty_DrawingLineDashing
  (AValue: TdxGPPenStyle);
const
...
procedure TdxSpreadSheetMSODrawingWriter.WriteProperty_DrawingLineWidth
  (AValue: Double);
begin
...
procedure TdxSpreadSheetMSODrawingWriter.WriteProperty_DrawingRotation
  (AAngle: Double);
begin
  if AAngle > 0 then
    while AAngle > 360 do
...
procedure TdxSpreadSheetMSODrawingWriter.WriteProperty_Hyperlink
  (AHyperlink: TdxSpreadSheetHyperlink; ADataWriter: TcxWriter);
var
  AHelper: TdxBIFFHyperlinkHelper;
  APosition: Int64;
begin
...
procedure TdxSpreadSheetMSODrawingWriter.WriteProperty_Text(ID: Word;
  const AName: string; ADataWriter: TcxWriter);
var
  ABytes: TBytes;
  ALength: Integer;
begin
...
function TdxSpreadSheetMSODrawingWriter.GetCurrentSheet
...
function TdxSpreadSheetMSODrawingWriter.GetTextBoxProperties
...
function TdxSpreadSheetMSODrawingWriter.ValidateColor(AColor,
...
function TdxSpreadSheetMSODrawingWriter.ValueToHOffset(AColumnIndex,
  AOffset: Integer): Integer;
begin
  Result := 0;
  if TdxSpreadSheetTableView(Owner.CurrentSheet).Columns[AColumnIndex] <> nil
...
function TdxSpreadSheetMSODrawingWriter.ValueToVOffset(ARowIndex,
  AOffset: Integer): Integer;
begin
  Result := 0;
  if TdxSpreadSheetTableView(Owner.CurrentSheet).Rows[ARowIndex] <> nil then
