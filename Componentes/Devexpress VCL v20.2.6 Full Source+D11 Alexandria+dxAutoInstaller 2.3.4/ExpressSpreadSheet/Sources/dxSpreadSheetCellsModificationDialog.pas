...
type
  ...
  TdxSpreadSheetCellsModificationDialogFormClass = class of
    TdxSpreadSheetCellsModificationDialogForm;
  ...
  protected
    ...
    procedure InitializeDialogPosition(ASpreadSheet
      : TdxCustomSpreadSheet); virtual;
    function GetCellsModification: TdxSpreadSheetCellsModification;
  public
    property CellsModification: TdxSpreadSheetCellsModification
      read GetCellsModification;
  end;

var
  dxSpreadSheetCellsModificationDialogFormClass
    : TdxSpreadSheetCellsModificationDialogFormClass =
    TdxSpreadSheetCellsModificationDialogForm;

function ShowCellsModificationDialog(out ACellsModification
  : TdxSpreadSheetCellsModification; AIsDeletingMode: Boolean;
  ASpreadSheet: TdxCustomSpreadSheet = nil): Boolean;
...
procedure TdxSpreadSheetCellsModificationDialogForm.Initialize(AIsDeletingMode
  : Boolean);
const
  CaptionMap: array [Boolean] of Pointer =
    (@sdxCellsModificationDialogInsertCaption,
    @sdxCellsModificationDialogDeleteCaption);
  ShiftHorizontallyMap: array [Boolean] of Pointer = (@sdxShiftCellsRight,
    @sdxShiftCellsLeft);
  ShiftVerticallyMap: array [Boolean] of Pointer = (@sdxShiftCellsDown,
    @sdxShiftCellsUp);
begin
  ...
  rbShiftHorizontally.Caption := cxGetResourceString
    (ShiftHorizontallyMap[AIsDeletingMode]);
  rbShiftVertically.Caption := cxGetResourceString
    (ShiftVerticallyMap[AIsDeletingMode]);
...
procedure TdxSpreadSheetCellsModificationDialogForm.InitializeDialogPosition
...
begin
  ...
  if ASpreadSheet <> nil then
  begin
    ASpreadSheetPositionOnScreen := dxMapWindowRect(ASpreadSheet.Handle, 0,
      ASpreadSheet.ClientBounds);
  ...
  begin
    ...
    APosition.X := Min(AMonitorBounds.Right - Width,
      Max(AMonitorBounds.Left, APosition.X));
    APosition.Y := Min(AMonitorBounds.Bottom - Height,
      Max(AMonitorBounds.Top, APosition.Y));
  end;
...
function TdxSpreadSheetCellsModificationDialogForm.GetCellsModification
