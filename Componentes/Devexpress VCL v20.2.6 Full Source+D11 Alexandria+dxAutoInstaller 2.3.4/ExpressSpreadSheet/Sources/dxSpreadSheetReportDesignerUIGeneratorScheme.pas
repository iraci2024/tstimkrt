...
uses
  dxUIGenerator, dxSpreadSheet, dxSpreadSheetActions,
  dxSpreadSheetUIGeneratorScheme, dxSpreadSheetReportDesigner,
...
begin
  ACategory.Add(TdxSpreadSheetReportDesignerSingleSheetReportMode,
    [ugivlSmallIcon, ugivlText], ugigpNone, ugipBeginsNewColumn);
  ACategory.Add(TdxSpreadSheetReportDesignerMultipleSheetsReportMode,
    [ugivlSmallIcon, ugivlText]);
  ACategory.Add(TdxSpreadSheetReportDesignerMultipleDocumentsReportMode,
    [ugivlSmallIcon, ugivlText]);

  ACommand := ACategory.Add('Report Designer\Mode\ReportOrientation.png',
    sdxSpreadSheetDocumentOrientation);
...
var
  ACommand: TdxUIGeneratorCommandInfo;
begin
  ACategory.Add(TdxSpreadSheetReportDesignerHeaderSection,
    [ugivlSmallIcon, ugivlText], ugigpNone, ugipBeginsNewColumn);
  ACategory.Add(TdxSpreadSheetReportDesignerFooterSection,
    [ugivlSmallIcon, ugivlText]);
  ACategory.Add(TdxSpreadSheetReportDesignerDetailSection);

  ACommand := ACategory.Add('Report Designer\TemplateRanges\SetDetailLevel.png',
    sdxSpreadSheetMasterDetail);
...
begin
  ...
  ACategory.Add(TdxSpreadSheetReportDesignerGroupHeaderSection,
    [ugivlSmallIcon, ugivlText], ugigpNone, ugipBeginsNewColumn);
  ACategory.Add(TdxSpreadSheetReportDesignerGroupFooterSection,
    [ugivlSmallIcon, ugivlText]);
end;
...
begin
  AComponent := TdxUIGenerator.RegisterComponent(TdxSpreadSheetReportDesigner,
    sdxReportDesignerCategoryName);
  RegisterCategoryMode(AComponent.Add(sdxSpreadSheetTabReport,
    sdxSpreadSheetReportMode, 'Report Designer\Mode\SingleSheet_16x16.png', 0));

  RegisterCategoryRanges(AComponent.Add(sdxSpreadSheetTabReport,
    sdxSpreadSheetReportTemplateSections,
    'Report Designer\TemplateRanges\SetDetailRange_16x16.png', 0));
  RegisterCategorySortAndGroup(AComponent.Add(sdxSpreadSheetTabReport,
    sdxSpreadSheetReportSortAndGroup,
    'Report Designer\SortAndGroup\GroupHeader_16x16.png', 0));
  RegisterCategoryFilter(AComponent.Add(sdxSpreadSheetTabReport,
    sdxSpreadSheetReportFilter,
    'Report Designer\Filter\EditFilter_16x16.png', 0));
  RegisterCategoryDesign(AComponent.Add(sdxSpreadSheetTabReport,
    sdxSpreadSheetReportDesign,
    'Report Designer\Design\ShowRanges_16x16.png', 0));
end;
