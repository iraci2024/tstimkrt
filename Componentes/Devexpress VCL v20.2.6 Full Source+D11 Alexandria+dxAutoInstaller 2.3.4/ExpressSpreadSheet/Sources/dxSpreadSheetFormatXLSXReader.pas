...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Windows, SysUtils, Classes, Graphics, dxCore, dxCoreClasses, cxClasses,
  dxCustomTree, dxXMLDoc, dxZIPUtils,
  dxSpreadSheetCore, dxSpreadSheetTypes, dxSpreadSheetClasses,
  dxSpreadSheetStrs, dxSpreadSheetPackedFileFormatCore,
  dxSpreadSheetUtils, dxGDIPlusClasses, Generics.Defaults, Generics.Collections,
  dxCoreGraphics, cxGeometry,
  dxSpreadSheetPrinting, dxSpreadSheetConditionalFormattingRules,
  dxSpreadSheetContainers, dxSpreadSheetProtection,
  dxHashUtils, Variants, dxSpreadSheetCoreStyles, dxSpreadSheetFormatUtils;
...
type
  ...
  TdxSpreadSheetXLSXFormulaAsTextInfoList = class
  ...
  protected
    ...
    function GetSharedFormula(AView: TdxSpreadSheetCustomView; AIndex: Integer)
      : TdxSpreadSheetFormulaAsTextInfo;
  public
    constructor Create(ASpreadSheet: TdxCustomSpreadSheet); override;
    destructor Destroy; override;
    procedure Add(ACell: TdxSpreadSheetCell;
      AFunctionNode: TdxXMLNode); overload;
  ...
  public
    ...
    destructor Destroy; override;
    procedure Load(AReader: TdxSpreadSheetXLSXReader;
      const AFileName: AnsiString);
    //
    property ContentType[const AFileName: AnsiString]: AnsiString
      read GetContentType;
  end;
  ...
  public
    ...
    destructor Destroy; override;
    procedure Clear;
    function Find(const ID: AnsiString;
      out AItem: TdxSpreadSheetXLSXReaderRelsItem): Boolean;
    function FindByType(const AType: AnsiString;
      out AItem: TdxSpreadSheetXLSXReaderRelsItem): Boolean;
    procedure Load(AReader: TdxSpreadSheetXLSXReader;
      const AOwnerFileName: AnsiString);

    property Count: Integer read GetCount;
    property Items[const ID: AnsiString]: TdxSpreadSheetXLSXReaderRelsItem
      read GetItem;
    property ItemsByIndex[Index: Integer]: TdxSpreadSheetXLSXReaderRelsItem
      read GetItemByIndex;
  end;

  { TdxSpreadSheetXLSXReaderCustomParser }

  TdxSpreadSheetXLSXReaderCustomParser = class
    (TdxSpreadSheetCustomPackedReaderParser)
  strict private
    procedure ExtractIndexedColor(ANode: TdxXMLNode; AColorIndex: Integer;
      var AColor: TColor);
    procedure ExtractThemedColor(ANode: TdxXMLNode; AThemeIndex: Integer;
      var AColor: TColor);
    function GetOwner: TdxSpreadSheetXLSXReader; inline;
  protected
    function CheckListIndex(AIndex: Integer; AList: TList;
      const AMessage: string; AMessageType: TdxSpreadSheetMessageType)
      : Boolean; overload;
    function CheckListIndex(AIndex: Integer;
      AList: TdxSpreadSheetHashTableItemList; const AMessage: string;
      AMessageType: TdxSpreadSheetMessageType): Boolean; overload;
  ...
  TdxSpreadSheetXLSXReaderCustomNodeParser = class
    (TdxSpreadSheetXLSXReaderCustomParser)
  protected
    FNode: TdxXMLNode;
  public
  ...
  TdxSpreadSheetXLSXReaderCustomDocumentParser = class
    (TdxSpreadSheetXLSXReaderCustomNodeParser)
  protected
  ...
  public
    constructor Create(const AFileName: AnsiString;
      AOwner: TdxSpreadSheetXLSXReader); virtual;
    destructor Destroy; override;
    //
  ...
  TdxSpreadSheetXLSXReaderCustomDocumentSubParser = class
    (TdxSpreadSheetXLSXReaderCustomNodeParser)
  strict private
    FOwnerParser: TdxSpreadSheetXLSXReaderCustomDocumentParser;
  protected
    function ReadEmbeddedImage(const AItem: TdxSpreadSheetXLSXReaderRelsItem;
      out AStream: TStream): Boolean; overload;
    function ReadEmbeddedImage(const AValue: TdxXMLString; out AStream: TStream)
      : Boolean; overload;
    function ReadImage(ANode: TdxXMLNode;
      out AImageHandle: TdxSpreadSheetSharedImageHandle): Boolean; overload;
    function ReadImage(ANode: TdxXMLNode; out AStream: TStream)
      : Boolean; overload;
  public
    constructor Create(ANode: TdxXMLNode;
      AOwnerParser: TdxSpreadSheetXLSXReaderCustomDocumentParser);
    //
    property OwnerParser: TdxSpreadSheetXLSXReaderCustomDocumentParser
      read FOwnerParser;
  end;
  ...
  strict private
    FBorders: TdxSpreadSheetHashTableItemList;
    FConditionalFormattingStyles: TdxSpreadSheetHashTableItemList;
    FFills: TdxSpreadSheetHashTableItemList;
    FFonts: TdxSpreadSheetHashTableItemList;
    FFormats: TdxSpreadSheetHashTableItemList;
    FFormulasRefs: TdxSpreadSheetXLSXFormulaAsTextInfoList;
    FHyperlinks: TStringList;
    FIndexedColors: TList<TColor>;
    FSharedStrings: TdxSpreadSheetHashTableItemList;
    FStyles: TdxSpreadSheetHashTableItemList;
  ...
  protected
    FEmbeddedImageIndex
      : TDictionary<TdxXMLString, TdxSpreadSheetSharedImageHandle>;
    ...
    procedure ForEachNodeChild(ANode: TdxXMLNode; AProc: TdxXMLNodeForEachProc;
      AUserData: Pointer);
  ...
  public
    constructor Create(AOwner: TdxCustomSpreadSheet; AStream: TStream);
      override;
    destructor Destroy; override;
    function FindWorkbookFileName(ARels: TdxSpreadSheetXLSXReaderRels;
      out AFileName: AnsiString): Boolean;
    procedure ReadData; override;

    property Borders: TdxSpreadSheetHashTableItemList read FBorders;
    property ConditionalFormattingStyles: TdxSpreadSheetHashTableItemList
      read FConditionalFormattingStyles;
    property Fills: TdxSpreadSheetHashTableItemList read FFills;
    property Fonts: TdxSpreadSheetHashTableItemList read FFonts;
    property Formats: TdxSpreadSheetHashTableItemList read FFormats;
    property FormulasRefs: TdxSpreadSheetXLSXFormulaAsTextInfoList
      read FFormulasRefs;
    property Hyperlinks: TStringList read FHyperlinks;
    property IndexedColors: TList<TColor> read FIndexedColors;
    property SharedStrings: TdxSpreadSheetHashTableItemList read FSharedStrings;
    property Styles: TdxSpreadSheetHashTableItemList read FStyles;
    ...
    property ColumnWidthHelper: TdxSpreadSheetExcelColumnWidthHelper
      read GetColumnWidthHelper;
    property ContentIndex: TdxSpreadSheetXLSXReaderContentIndex
      read GetContentIndex;
  end;

  { TdxSpreadSheetXLSXReaderBrushParser }

  TdxSpreadSheetXLSXReaderBrushParser = class
    (TdxSpreadSheetXLSXReaderCustomDocumentSubParser)
  strict private
    FBrush: TdxGPBrush;
  protected
    procedure ProcessGradientBrushPoints(ANode: TdxXMLNode;
      AUserData: Pointer); virtual;
  ...
  public
    constructor Create(ANode: TdxXMLNode; ABrush: TdxGPBrush;
      AOwnerParser: TdxSpreadSheetXLSXReaderCustomDocumentParser);
  ...
  TdxSpreadSheetXLSXReaderPenParser = class
    (TdxSpreadSheetXLSXReaderCustomDocumentSubParser)
  strict private
    FPen: TdxGPPen;
  public
    constructor Create(ANode: TdxXMLNode; APen: TdxGPPen;
      AOwnerParser: TdxSpreadSheetXLSXReaderCustomDocumentParser);
    procedure Execute; override;
    //
  ...
  TdxSpreadSheetXLSXReaderExternalLinkParser = class
    (TdxSpreadSheetXLSXReaderCustomDocumentParser)
  protected
  ...
  TdxSpreadSheetXLSXReaderFontParser = class
    (TdxSpreadSheetXLSXReaderCustomParser)
  strict private
  ...
  public
    constructor Create(AFont: TdxSpreadSheetFontHandle; ANode: TdxXMLNode;
      AOwner: TdxSpreadSheetXLSXReader);
    procedure Execute; override;
    //
  ...
  TdxSpreadSheetXLSXReaderFormulasParser = class
    (TdxSpreadSheetXLSXReaderCustomParser)
  public
    procedure Execute; override;
  end;
  ...
  TdxSpreadSheetXLSXReaderHeaderFooterParser = class
    (TdxSpreadSheetXLSXReaderCustomNodeParser)
  strict private
  ...
  public
    ...
    procedure Execute; override;
    //
    property Text: TdxSpreadSheetTableViewOptionsPrintHeaderFooterText
      read FText;
  end;

  { TdxSpreadSheetXLSXReaderSharedStringParser }

  TdxSpreadSheetXLSXReaderSharedStringParser = class
    (TdxSpreadSheetXLSXReaderCustomDocumentParser)
  protected
    procedure ProcessSharedString(ANode: TdxXMLNode; AUserData: Pointer);
  public
    procedure Execute; override;
    class function ParseString(AOwner: TdxSpreadSheetXLSXReader;
      AStringNode: TdxXMLNode): TdxSpreadSheetSharedString;
  end;
  ...
  protected
    function CreateFontParser(AFont: TdxSpreadSheetFontHandle;
      ANode: TdxXMLNode): TdxSpreadSheetXLSXReaderFontParser; virtual;
    function DoParse(ANode: TdxXMLNode): TdxSpreadSheetFormattedSharedString;
  public
    constructor Create(AOwner: TdxSpreadSheetXLSXReader);
    destructor Destroy; override;
    class function Parse(AOwner: TdxSpreadSheetXLSXReader; ANode: TdxXMLNode;
      AMultiline: Boolean = True): TdxSpreadSheetFormattedSharedString;
    //
  ...
  protected
    ...
    function ReadPatternFill(ANode: TdxXMLNode;
      const ADefaultPatternFillType: AnsiString): TdxHashTableItem;
  public
    procedure Execute; override;
  end;
  ...
  strict private
    ...
    function FindAttr(const AAttrName: TdxXMLString;
      ANode, ANodeDefault: TdxXMLNode): TdxXMLNodeAttribute;
    function GetAlignmentNode(ANode: TdxXMLNode): TdxXMLNode;
    function GetCellXfsNode(ANode: TdxXMLNode; const ANodeName: TdxXMLString)
      : TdxXMLNode;
    function GetProtectionNode(ANode: TdxXMLNode): TdxXMLNode;
  public
    constructor Create(ANode: TdxXMLNode);
    function GetAlignmentAttrValue(const AAttrName: TdxXMLString;
      const ADefaultValue: TdxXMLString = ''): TdxXMLString;
    function GetAlignmentAttrValueAsBoolean(const AAttrName: TdxXMLString;
      const ADefaultValue: Boolean = False): Boolean;
    function GetAlignmentAttrValueAsInteger(const AAttrName: TdxXMLString;
      const ADefaultValue: Integer = 0): Integer;
    function GetAttrValue(const AAttrName: TdxXMLString;
      ADefaultValue: Integer = 0): Integer;
    function GetNumberFormatHandle(AReader: TdxSpreadSheetXLSXReader): TObject;
    function GetProtectionAttrValueAsBoolean(const AAttrName: TdxXMLString;
      const ADefaultValue: Boolean = False): Boolean;
    function GetResourceHandle(const AResName, AOptionName: TdxXMLString;
      AResourceCollection: TdxSpreadSheetHashTableItemList): TObject;
  end;

  { TdxSpreadSheetXLSXReaderThemeParser }

  TdxSpreadSheetXLSXReaderThemeParser = class
    (TdxSpreadSheetXLSXReaderCustomDocumentParser)
  protected
  ...
  TdxSpreadSheetXLSXReaderWorkbookParser = class
    (TdxSpreadSheetXLSXReaderCustomParser)
  strict private
  ...
  protected
    ...
    //
    procedure ProcessDefinedName(ANode: TdxXMLNode;
      AUserData: Pointer); virtual;
    procedure ProcessExternalReference(ANode: TdxXMLNode;
      AUserData: Pointer); virtual;
    ...
    function ReadProtectionInfoStandard(ANode: TdxXMLNode)
      : IdxSpreadSheetProtectionInfo;
    function ReadProtectionInfoStrong(ANode: TdxXMLNode)
      : IdxSpreadSheetProtectionInfo;
  public
    constructor Create(const AFileName: AnsiString;
      AOwner: TdxSpreadSheetXLSXReader);
  ...
  { TdxSpreadSheetXLSXReaderMetadataParser }

  TdxSpreadSheetXLSXReaderMetadataParser = class
    (TdxSpreadSheetXLSXReaderCustomDocumentParser)
  strict private
    function GetMetadata: TdxSpreadSheetOptionsMetadata;
    function ReadDateTime(AParentNode: TdxXMLNode;
      const ANamespace, AValueName: AnsiString): TDateTime; inline;
    function ReadText(AParentNode: TdxXMLNode;
      const ANamespace, AValueName: AnsiString): string; inline;
  public
    procedure Execute; override;
    //
  ...
  TdxSpreadSheetXLSXReaderWorksheetParser = class
    (TdxSpreadSheetXLSXReaderCustomDocumentParser)
  strict private
    FView: TdxSpreadSheetTableView;

    function GetCellStyles: TdxSpreadSheetHashTableItemList;
    function GetChild(const AName: TdxXMLString; out ANode: TdxXMLNode)
      : Boolean;
    function GetSharedStrings: TdxSpreadSheetHashTableItemList;
  protected
    ...
    procedure ProcessMergedCells(ANode: TdxXMLNode;
      AUserData: Pointer); virtual;
    ...
    procedure ProcessSelection(ANode: TdxXMLNode;
      ASelection: TdxSpreadSheetTableViewSelection); virtual;
  ...
  public
    ...
    procedure Execute; override;
    //
    property CellStyles: TdxSpreadSheetHashTableItemList read GetCellStyles;
    property SharedStrings: TdxSpreadSheetHashTableItemList
      read GetSharedStrings;
...
uses
  AnsiStrings, Math, cxGraphics, dxSpreadSheetGraphics, dxSpreadSheetFormulas,
  dxSpreadSheetConditionalFormattingIconSet, dxSpreadSheetHyperlinks,
  dxOLECryptoContainer,
  // XLSX
  dxSpreadSheetFormatXLSX, dxSpreadSheetFormatXLSXTags,
  dxSpreadSheetFormatXLSXReaderDrawing,
  dxSpreadSheetFormatXLSXReaderConditionalFormatting,
  dxSpreadSheetFormatXLSXReaderComments,
...
type
  ...
  public
    function FindChild(const AName: TdxXMLString; out ANode: TdxXMLNode)
      : Boolean; override;
  end;
...
constructor TdxSpreadSheetXLSXFormulaAsTextInfo.Create
  (AOwner: TdxSpreadSheetXLSXFormulaAsTextInfoList);
begin
  inherited Create;
  FOwner := AOwner;
end;

procedure TdxSpreadSheetXLSXFormulaAsTextInfo.ResolveReferences
  (Parser: TObject);
begin
  if IsShared then
    Cell.AsFormula := FOwner.GetSharedFormula(Cell.View, SharedIndex)
      .Cell.AsFormula.Clone
  else
...
constructor TdxSpreadSheetXLSXFormulaAsTextInfoList.Create
...
procedure TdxSpreadSheetXLSXFormulaAsTextInfoList.Add(ACell: TdxSpreadSheetCell;
  AFunctionNode: TdxXMLNode);
var
...
begin
  ...
  begin
    AInfo := TdxSpreadSheetXLSXFormulaAsTextInfo
      (Add(ACell, dxSpreadSheetFormulaIncludeEqualSymbol
      (AFunctionNode.TextAsString), SameText(ACellType, sdxXLSXValueArray),
      False, dxStringToReferenceArea(AFunctionNode.Attributes.GetValueAsString
      (sdxXLSXAttrRef))));
    if SameText(ACellType, sdxXLSXValueShared) then
    begin
      AInfo.SharedIndex := AFunctionNode.Attributes.GetValueAsInteger
        (sdxXLSXAttrSharedIndex);
      FSharedFormulas.AddOrSetValue(dxMakeInt64(ACell.View.Index,
        AInfo.SharedIndex), AInfo);
    end;
  end
  else if SameText(ACellType, sdxXLSXValueShared) then
  begin
    AInfo := TdxSpreadSheetXLSXFormulaAsTextInfo(Add(ACell, '', False, True,
      cxInvalidRect));
    AInfo.SharedIndex := AFunctionNode.Attributes.GetValueAsInteger
      (sdxXLSXAttrSharedIndex);
  end;
...
function TdxSpreadSheetXLSXFormulaAsTextInfoList.CreateItem
  : TdxSpreadSheetFormulaAsTextInfo;
begin
...
function TdxSpreadSheetXLSXFormulaAsTextInfoList.GetSharedFormula
  (AView: TdxSpreadSheetCustomView; AIndex: Integer)
  : TdxSpreadSheetFormulaAsTextInfo;
begin
...
procedure TdxSpreadSheetXLSXReaderContentIndex.Load
  (AReader: TdxSpreadSheetXLSXReader; const AFileName: AnsiString);
var
    ...
    begin
      ...
      begin
        if SameText(ANode.Name, sdxXLSXNodeOverride) then
          FData.Values[ANode.Attributes.GetValueAsString(sdxXLSXAttrPartName)]
            := ANode.Attributes.GetValueAsString(sdxXLSXAttrContentType);
        ANode := ANode.Next;
      end;
    end;
  finally
...
function TdxSpreadSheetXLSXReaderContentIndex.GetContentType(const AFileName
...
procedure TdxSpreadSheetXLSXReaderRelsItem.SetValue(const AFileName,
...
function TdxSpreadSheetXLSXReaderRels.Find(const ID: AnsiString;
  out AItem: TdxSpreadSheetXLSXReaderRelsItem): Boolean;
var
  I: Integer;
begin
...
function TdxSpreadSheetXLSXReaderRels.FindByType(const AType: AnsiString;
  out AItem: TdxSpreadSheetXLSXReaderRelsItem): Boolean;
var
  I: Integer;
begin
  AItem := nil;
  for I := 0 to FList.Count - 1 do
    if SameText(AType, TdxSpreadSheetXLSXReaderRelsItem(FList.List[I]).FileType)
    then
    begin
      AItem := TdxSpreadSheetXLSXReaderRelsItem(FList.List[I]);
      Break;
...
procedure TdxSpreadSheetXLSXReaderRels.Load(AReader: TdxSpreadSheetXLSXReader;
  const AOwnerFileName: AnsiString);
var
  ADocument: TdxXMLDocument;
    ...
    try
      ...
      begin
        ...
        begin
          ...
          if not SameText(ANode.Attributes.GetValue(sdxXLSXAttrTargetMode),
            sdxXLSXValueTargetModeExternal) and
            (AType <> sdxXLSXHyperlinkRelationship) then
            AFileName := TdxZIPPathHelper.AbsoluteFileName(ARootPath,
              AFileName);
          Items[ANode.Attributes.GetValue(sdxXLSXAttrId)
            ].SetValue(TdxZIPPathHelper.ExpandFileName(AFileName), AType);
          ANode := ANode.Next;
        end;
      end;
    finally
...
function TdxSpreadSheetXLSXReaderRels.GetItem(const ID: AnsiString)
  : TdxSpreadSheetXLSXReaderRelsItem;
begin
...
function TdxSpreadSheetXLSXReaderRels.GetItemByIndex(Index: Integer)
  : TdxSpreadSheetXLSXReaderRelsItem;
begin
...
function TdxSpreadSheetXLSXReaderCustomParser.CheckListIndex(AIndex: Integer;
  AList: TList; const AMessage: string;
  AMessageType: TdxSpreadSheetMessageType): Boolean;
begin
...
function TdxSpreadSheetXLSXReaderCustomParser.DecodeColor
  (const ANode: TdxXMLNode): TColor;
var
...
function TdxSpreadSheetXLSXReaderCustomParser.DecodeColor(const AHexCode
  : string): TColor;
begin
  Result := dxAlphaColorToColor(TdxColorHelper.HexCodeToAlphaColor
    (AHexCode, False));
end;

procedure TdxSpreadSheetXLSXReaderCustomParser.ExtractIndexedColor
  (ANode: TdxXMLNode; AColorIndex: Integer; var AColor: TColor);
begin
  ...
  begin
    ...
    if (AColorIndex >= Low(dxExcelStandardColors)) and
      (AColorIndex <= High(dxExcelStandardColors)) then
...
procedure TdxSpreadSheetXLSXReaderCustomParser.ExtractThemedColor
  (ANode: TdxXMLNode; AThemeIndex: Integer; var AColor: TColor);
var
  AAttr: TdxXMLNodeAttribute;
begin
  if CheckListIndex(AThemeIndex, Owner.ThemedColors, sdxErrorInvalidColorIndex,
    ssmtWarning) then
  begin
...
function TdxSpreadSheetXLSXReaderCustomParser.GetOwner
  : TdxSpreadSheetXLSXReader;
begin
...
constructor TdxSpreadSheetXLSXReaderCustomNodeParser.Create(ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetXLSXReader);
begin
...
constructor TdxSpreadSheetXLSXReaderCustomDocumentParser.Create(const AFileName
  : AnsiString; AOwner: TdxSpreadSheetXLSXReader);
begin
...
function TdxSpreadSheetXLSXReaderCustomDocumentSubParser.ReadEmbeddedImage
  (const AItem: TdxSpreadSheetXLSXReaderRelsItem; out AStream: TStream)
  : Boolean;
begin
...
function TdxSpreadSheetXLSXReaderCustomDocumentSubParser.ReadEmbeddedImage
  (const AValue: TdxXMLString; out AStream: TStream): Boolean;
var
  AItem: TdxSpreadSheetXLSXReaderRelsItem;
begin
  if OwnerParser.Rels.Find(AValue, AItem) then
    Result := ReadEmbeddedImage(AItem, AStream)
  else
  begin
    DoError(sdxErrorPictureCannotBeFound,
      [OwnerParser.DocumentFileName + ':' + AValue], ssmtWarning);
    Result := False;
  end;
end;

function TdxSpreadSheetXLSXReaderCustomDocumentSubParser.ReadImage
  (ANode: TdxXMLNode;
  out AImageHandle: TdxSpreadSheetSharedImageHandle): Boolean;
var
  AAttr: TdxXMLNodeAttribute;
  AItem: TdxSpreadSheetXLSXReaderRelsItem;
  AStream: TStream;
begin
  ...
  begin
    if OwnerParser.Rels.Find(AAttr.Value, AItem) then
    begin
      if Owner.FEmbeddedImageIndex.TryGetValue(AItem.FileName, AImageHandle)
      then
        Exit(True);
      Result := ReadEmbeddedImage(AItem, AStream);
      if Result then
        try
          AImageHandle := Owner.AddImage(AStream);
          Owner.FEmbeddedImageIndex.Add(AItem.FileName, AImageHandle);
        finally
          AStream.Free;
        end;
    end
      ...
      DoError(sdxErrorPictureCannotBeFound,
        [OwnerParser.DocumentFileName + ':' + AAttr.Value], ssmtWarning);
  end
  else
    DoError(sdxErrorPictureCannotBeFound, [OwnerParser.DocumentFileName],
      ssmtWarning);
end;

function TdxSpreadSheetXLSXReaderCustomDocumentSubParser.ReadImage
  (ANode: TdxXMLNode; out AStream: TStream): Boolean;
var
  AAttr: TdxXMLNodeAttribute;
begin
  Result := False;
...
constructor TdxSpreadSheetXLSXReader.Create(AOwner: TdxCustomSpreadSheet;
  AStream: TStream);
begin
  inherited Create(AOwner, AStream);
  FIndexedColors := TList<TColor>.Create;
  FEmbeddedImageIndex :=
    TDictionary<TdxXMLString, TdxSpreadSheetSharedImageHandle>.Create;
  FFormulasRefs := TdxSpreadSheetXLSXFormulaAsTextInfoList.Create(SpreadSheet);
  FHyperlinks := TStringList.Create;
  FConditionalFormattingStyles := TdxSpreadSheetHashTableItemList.Create;
  FSharedStrings := TdxSpreadSheetHashTableItemList.Create;
  FThemedColors := TList.Create;
  FStyles := TdxSpreadSheetHashTableItemList.Create;
  FFormats := TdxSpreadSheetHashTableItemList.Create;
  FBorders := TdxSpreadSheetHashTableItemList.Create;
  FFills := TdxSpreadSheetHashTableItemList.Create;
  FFonts := TdxSpreadSheetHashTableItemList.Create;
...
function TdxSpreadSheetXLSXReader.FindWorkbookFileName
  (ARels: TdxSpreadSheetXLSXReaderRels; out AFileName: AnsiString): Boolean;
const
...
begin
  ...
  if Result then
  begin
    AContentType := LowerCase(ContentIndex.ContentType[dxUnixPathDelim +
      AItem.FileName]);
    Result := (AContentType = '') or (Pos(WorkbookSheetType, AContentType) > 0)
      or (Pos(WorkbookTemplateType, AContentType) > 0);
    if Result then
...
begin
  ...
  try
    ...
    begin
      ExecuteSubTask(TdxSpreadSheetXLSXReaderWorkbookParser.Create
        (AFileName, Self));
      ...
      if ARels.FindByType(sdxXLSXCorePropertiesRelationship, AItem) then
        ExecuteSubTask(TdxSpreadSheetXLSXReaderMetadataParser.Create
          (AItem.FileName, Self));
    end
    else
...
function TdxSpreadSheetXLSXReader.CreateProgressHelper
...
procedure TdxSpreadSheetXLSXReader.ForEachNodeChild(ANode: TdxXMLNode;
  AProc: TdxXMLNodeForEachProc; AUserData: Pointer);
var
...
function TdxSpreadSheetXLSXReader.GetColumnWidthHelper
...
function TdxSpreadSheetXLSXReader.GetContentIndex
  : TdxSpreadSheetXLSXReaderContentIndex;
begin
...
constructor TdxSpreadSheetXLSXReaderBrushParser.Create(ANode: TdxXMLNode;
  ABrush: TdxGPBrush;
  AOwnerParser: TdxSpreadSheetXLSXReaderCustomDocumentParser);
begin
...
procedure TdxSpreadSheetXLSXReaderBrushParser.ProcessGradientBrushPoints
  (ANode: TdxXMLNode; AUserData: Pointer);
var
  APosition: Double;
begin
  APosition := TdxSpreadSheetXLSXUtils.DecodePercents
    (ANode.Attributes.GetValueAsInteger(sdxXLSXAttrGradientPointPos)) / 100;
  TdxGPBrush(AUserData).GradientPoints.Add(Min(Max(APosition, 0), 1),
    ReadColor(ANode));
end;

function TdxSpreadSheetXLSXReaderBrushParser.ReadColor(AParentNode: TdxXMLNode)
  : TdxAlphaColor;
  ...
  begin
    if AColorNode.FindChild(sdxXLSXNodeColorAlpha, AAlphaNode) then
      Result := TdxSpreadSheetXLSXUtils.DecodeColorAlpha
        (AAlphaNode.Attributes.GetValueAsInteger(sdxXLSXAttrVal))
    else
      Result := MaxByte;
  end;
  ...
  var
    ...
    ANode: TdxXMLNode;
  begin
    if Owner.ColorMap.TryGetValue
      (AColorNode.Attributes.GetValue(sdxXLSXAttrVal), Result) then
    begin
      AColorHSL := TdxColorSpaceConverter.ColorToHSL(Result);
      if AColorNode.FindChild(sdxXLSXNodeLumMod, ANode) then
        AColorHSL.L := AColorHSL.L * TdxSpreadSheetXLSXUtils.DecodePercents
          (ANode.Attributes.GetValueAsInteger(sdxXLSXAttrVal)) / 100;
      ...
      begin
        Result := dxGetMiddleRGB(Result, clGray,
          Trunc(TdxSpreadSheetXLSXUtils.DecodePercents
          (ANode.Attributes.GetValueAsInteger(sdxXLSXAttrVal))));
      end;
    end
    else
      Result := clNone;
...
begin
  ...
  begin
    if SameText(AChildNode.Name, sdxXLSXNodeThemesCustomColor) then
      Exit(dxColorToAlphaColor
        (DecodeColor(AChildNode.Attributes.GetValueAsString(sdxXLSXAttrVal)),
        ReadAlpha(AChildNode)));
    if SameText(AChildNode.Name, sdxXLSXNodeSchemeColor) then
      Exit(dxColorToAlphaColor(ReadSchemeColor(AChildNode),
        ReadAlpha(AChildNode)));
    if SameText(AChildNode.Name, sdxXLSXNodeSystemColor) then
      Exit(dxColorToAlphaColor
        (DecodeColor(AChildNode.Attributes.GetValueAsString
        (sdxXLSXAttrLastColor))));
    AChildNode := AChildNode.Next;
  end;
  Result := clNone;
end;
...
begin
  ...
  begin
    Brush.GradientMode := dxGetNearestGradientMode
      (TdxSpreadSheetXLSXUtils.DecodePositiveFixedAngle
...
begin
  ...
  dxSpreadSheetLoadBrushPattern(Brush, HInstance, 'XLSX_BRUSHPATTERN_' +
    UpperCase(Node.Attributes.GetValueAsString(sdxXLSXAttrPreset)),
...
constructor TdxSpreadSheetXLSXReaderPenParser.Create(ANode: TdxXMLNode;
  APen: TdxGPPen; AOwnerParser: TdxSpreadSheetXLSXReaderCustomDocumentParser);
begin
  inherited Create(ANode, AOwnerParser);
  FPen := APen;
end;
...
begin
  ...
  if Node.FindChild(sdxXLSXNodeLineDash, AChildNode) then
    Pen.Style := TdxSpreadSheetXLSXHelper.StringToPenStyle
      (AChildNode.Attributes.GetValue(sdxXLSXAttrVal));
  if Node.Count > 0 then
    ExecuteSubTask(TdxSpreadSheetXLSXReaderBrushParser.Create(Node.First,
      Pen.Brush, OwnerParser));
end;
...
function TdxSpreadSheetXLSXReaderExternalLinkParser.DecodePath
  (const APath: AnsiString): string;
begin
...
constructor TdxSpreadSheetXLSXReaderFontParser.Create
  (AFont: TdxSpreadSheetFontHandle; ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetXLSXReader);
begin
  inherited Create(AOwner);
  FFont := AFont;
...
procedure TdxSpreadSheetXLSXReaderFontParser.ProcessParam(ANode: TdxXMLNode;
  AUserData: Pointer);
var
  AStyle: TFontStyle;
begin
  ...
  begin
    if SameText(ANode.Attributes.GetValueAsString(sdxXLSXAttrVal),
      sdxXLSXValueSuperscript) then
      Font.Script := fsSuperscript
    else if SameText(ANode.Attributes.GetValueAsString(sdxXLSXAttrVal),
      sdxXLSXValueSubscript) then
    ...
    if SameText(ANode.Name, sdxXLSXNodeName) or
    SameText(ANode.Name, sdxXLSXNodeFontName) then
    ...
    for AStyle := Low(AStyle) to High(AStyle) do
      if SameText(dxXLSXFontStyles[AStyle], ANode.Name) and
        ANode.Attributes.GetValueAsBoolean('val', True) then
      begin
...
class function TdxSpreadSheetXLSXReaderSharedStringParser.ParseString
  (AOwner: TdxSpreadSheetXLSXReader; AStringNode: TdxXMLNode)
...
begin
  if AStringNode.FindChild(sdxXLSXNodeText, ATextNode) then
    ...
    Result := TdxSpreadSheetXLSXReaderRichTextParser.Parse(AOwner,
      AStringNode, False);
end;

procedure TdxSpreadSheetXLSXReaderSharedStringParser.ProcessSharedString
  (ANode: TdxXMLNode; AUserData: Pointer);
begin
...
constructor TdxSpreadSheetXLSXReaderRichTextParser.Create
  (AOwner: TdxSpreadSheetXLSXReader);
begin
  inherited Create;
  FOwner := AOwner;
...
class function TdxSpreadSheetXLSXReaderRichTextParser.Parse
  (AOwner: TdxSpreadSheetXLSXReader; ANode: TdxXMLNode;
  AMultiline: Boolean = True): TdxSpreadSheetFormattedSharedString;
begin
...
function TdxSpreadSheetXLSXReaderRichTextParser.DoParse(ANode: TdxXMLNode)
...
begin
  ...
  repeat
    ...
    if not Multiline or (ANodeNext = nil) or (ANode.Next.Name <> ANode.Name)
    then
      Break;
    FText.Append(#13#10);
    ANode := ANodeNext;
...
procedure TdxSpreadSheetXLSXReaderRichTextParser.ProcessRichTextRun
  (ANode: TdxXMLNode; AUserData: Pointer);
var
...
begin
  ...
  begin
    if ANode.FindChild(FNamespaceURI + sdxXLSXNodeText, ATextNode) and
      (ATextNode.Text <> '') then
    begin
      AFontHandle := nil;
      if ANode.FindChild(FNamespaceURI + sdxXLSXNodeRichTextRunParagraph,
        AParagraphNode) then
      begin
        AFontHandle := FOwner.CreateTempFontHandle;
        FOwner.ExecuteSubTask(CreateFontParser(AFontHandle, AParagraphNode));
      end;
      if (FText.Length > 0) or (AFontHandle <> nil) and
        not AFontHandle.IsEqual(FOwner.CellStyles.Fonts.DefaultFont) then
      begin
        if AFontHandle <> nil then
          AFontHandle := FOwner.AddFont(AFontHandle);
        FRuns.Add(FText.Length + 1, AFontHandle);
      end
      else
        AFontHandle.Free;
...
procedure TdxSpreadSheetXLSXReaderStyleParser.ProcessBorder(ANode: TdxXMLNode;
  AUserData: Pointer);
begin
  Owner.Borders.Add(ReadBorder(ANode));
end;

procedure TdxSpreadSheetXLSXReaderStyleParser.ProcessCellXfs(ANode: TdxXMLNode;
  AUserData: Pointer);
var
...
begin
  ...
  try
    AHandle := Owner.CreateTempCellStyle
      (TdxSpreadSheetFontHandle(AHelper.GetResourceHandle(sdxXLSXAttrFontId,
      sdxXLSXAttrApplyFont, Owner.Fonts)),
      TdxSpreadSheetFormatHandle(AHelper.GetNumberFormatHandle(Owner)),
      TdxSpreadSheetBrushHandle(AHelper.GetResourceHandle(sdxXLSXAttrFillId,
      sdxXLSXAttrApplyFill, Owner.Fills)),
      TdxSpreadSheetBordersHandle(AHelper.GetResourceHandle(sdxXLSXAttrBorderId,
      sdxXLSXAttrApplyBorder, Owner.Borders)));

    AHandle.AlignHorz := TdxSpreadSheetXLSXHelper.StringToAlignHorz
      (AHelper.GetAlignmentAttrValue(sdxXLSXAttrHorizontal));
    AHandle.AlignHorzIndent := AHelper.GetAlignmentAttrValueAsInteger
      (sdxXLSXAttrIndent);
    if AHandle.AlignHorzIndent <> 0 then
      AHandle.AlignHorzIndent := Owner.ColumnWidthHelper.SpacesNumberToPixels
        (AHandle.AlignHorzIndent);
    AHandle.AlignVert := TdxSpreadSheetXLSXHelper.StringToAlignVert
      (AHelper.GetAlignmentAttrValue(sdxXLSXAttrVertical));
    AHandle.Rotation := AHelper.GetAlignmentAttrValueAsInteger
      (sdxXLSXAttrTextRotation);
    AHandle.States := [];
...
procedure TdxSpreadSheetXLSXReaderStyleParser.ProcessConditionalFormattingStyle
  (ANode: TdxXMLNode; AUserData: Pointer);
type
  TReadProc = function(ANode: TdxXMLNode): TdxHashTableItem of object;

  function ReadSubStyle(const AAttrName: TdxXMLString; AProc: TReadProc)
    : TdxHashTableItem;
  var
    ASubNode: TdxXMLNode;
  begin
...
begin
  AStyle := Owner.CreateTempCellStyle
    ...
    TdxSpreadSheetFormatHandle(ReadSubStyle(sdxXLSXNodeStyleNumberFormat,
    ReadFormat)), TdxSpreadSheetBrushHandle(ReadSubStyle(sdxXLSXNodeStyleFill,
    ReadConditionalFormattingFill)),
    TdxSpreadSheetBordersHandle(ReadSubStyle(sdxXLSXNodeStyleBorder,
    ReadBorder)));
  ...
  begin
    ...
    AStyle.AlignVert := TdxSpreadSheetXLSXHelper.StringToAlignVert
      (ASubNode.Attributes.GetValue(sdxXLSXAttrVertical));
    AStyle.AlignHorz := TdxSpreadSheetXLSXHelper.StringToAlignHorz
      (ASubNode.Attributes.GetValue(sdxXLSXAttrHorizontal));
    AStyle.AlignHorzIndent := ASubNode.Attributes.GetValueAsInteger
      (sdxXLSXAttrIndent);
    if AStyle.AlignHorzIndent <> 0 then
      AStyle.AlignHorzIndent := Owner.ColumnWidthHelper.SpacesNumberToPixels
        (AStyle.AlignHorzIndent);
    AStyle.Rotation := ASubNode.Attributes.GetValueAsInteger
      (sdxXLSXAttrTextRotation);
  end;
...
procedure TdxSpreadSheetXLSXReaderStyleParser.ProcessFill(ANode: TdxXMLNode;
  AUserData: Pointer);
begin
  Owner.Fills.Add(ReadFill(ANode));
end;

procedure TdxSpreadSheetXLSXReaderStyleParser.ProcessFont(ANode: TdxXMLNode;
  AUserData: Pointer);
var
...
procedure TdxSpreadSheetXLSXReaderStyleParser.ProcessIndexedColors
  (ANode: TdxXMLNode; AUserData: Pointer);
begin
  Owner.IndexedColors.Add
    (DecodeColor(ANode.Attributes.GetValueAsString(sdxXLSXAttrRGB)));
end;

procedure TdxSpreadSheetXLSXReaderStyleParser.ProcessNumberFormat
  (ANode: TdxXMLNode; AUserData: Pointer);
begin
  Owner.Formats.Add(ReadFormat(ANode));
end;

procedure TdxSpreadSheetXLSXReaderStyleParser.ProcessStyleCollection
  (ANode: TdxXMLNode; AUserData: Pointer);
var
  AName: TdxXMLString;
begin
...
function TdxSpreadSheetXLSXReaderStyleParser.ReadBorder(ANode: TdxXMLNode)
  : TdxHashTableItem;
var
  ABorder: TcxBorder;
  AChildNode: TdxXMLNode;
...
begin
  ...
  begin
    ...
    begin
      AHandle.BorderStyle[ABorder] :=
        TdxSpreadSheetXLSXHelper.StringToBorderStyle
        (AChildNode.Attributes.GetValue(sdxXLSXAttrStyle));
...
function TdxSpreadSheetXLSXReaderStyleParser.ReadConditionalFormattingFill
  (ANode: TdxXMLNode): TdxHashTableItem;
begin
...
function TdxSpreadSheetXLSXReaderStyleParser.ReadFill(ANode: TdxXMLNode)
  : TdxHashTableItem;
begin
  if ANode.FindChild(sdxXLSXNodeCellStylePatternFill, ANode) then
...
function TdxSpreadSheetXLSXReaderStyleParser.ReadFont(ANode: TdxXMLNode)
  : TdxHashTableItem;
var
  AHandle: TdxSpreadSheetFontHandle;
begin
  AHandle := Owner.CreateTempFontHandle;
  ExecuteSubTask(TdxSpreadSheetXLSXReaderFontParser.Create(AHandle,
    ANode, Owner));
  Result := Owner.AddFont(AHandle);
end;

function TdxSpreadSheetXLSXReaderStyleParser.ReadFormat(ANode: TdxXMLNode)
  : TdxHashTableItem;
begin
  Result := Owner.AddNumberFormat(ANode.Attributes.GetValueAsString
    (sdxXLSXAttrFormatCode), ANode.Attributes.GetValueAsInteger
    (sdxXLSXAttrNumFmtId, -1));
end;

function TdxSpreadSheetXLSXReaderStyleParser.ReadPatternFill(ANode: TdxXMLNode;
  const ADefaultPatternFillType: AnsiString): TdxHashTableItem;
var
  AChildNode: TdxXMLNode;
...
begin
  ...
  APatternType := ANode.Attributes.GetValue(sdxXLSXAttrPatternType,
    ADefaultPatternFillType);
  ...
  begin
    ...
    begin
      ...
      if (AHandle.Style = sscfsSolid) and (AHandle.ForegroundColor <> clNone)
      then
...
constructor TdxSpreadSheetXLSXReaderStyleParserCellStyleHelper.Create
  (ANode: TdxXMLNode);
begin
  inherited Create;
  FNodeCellXf := ANode;
...
function TdxSpreadSheetXLSXReaderStyleParserCellStyleHelper.FindAttr
  (const AAttrName: TdxXMLString; ANode, ANodeDefault: TdxXMLNode)
  : TdxXMLNodeAttribute;
begin
  if (ANode = nil) or not ANode.Attributes.Find(AAttrName, Result) then
  begin
    if (ANodeDefault = nil) or not ANodeDefault.Attributes.Find(AAttrName,
      Result) then
      Result := nil;
  end;
end;

function TdxSpreadSheetXLSXReaderStyleParserCellStyleHelper.
  GetAlignmentAttrValue(const AAttrName, ADefaultValue: TdxXMLString)
  : TdxXMLString;
var
  AAttr: TdxXMLNodeAttribute;
begin
...
function TdxSpreadSheetXLSXReaderStyleParserCellStyleHelper.
  GetAlignmentAttrValueAsBoolean(const AAttrName: TdxXMLString;
  const ADefaultValue: Boolean = False): Boolean;
var
  AAttr: TdxXMLNodeAttribute;
begin
...
function TdxSpreadSheetXLSXReaderStyleParserCellStyleHelper.
  GetAlignmentAttrValueAsInteger(const AAttrName: TdxXMLString;
  const ADefaultValue: Integer = 0): Integer;
begin
  Result := StrToIntDef(dxAnsiStringToString(GetAlignmentAttrValue(AAttrName)),
    ADefaultValue);
end;
...
function TdxSpreadSheetXLSXReaderStyleParserCellStyleHelper.GetAlignmentNode
  (ANode: TdxXMLNode): TdxXMLNode;
var
  AAttr: TdxXMLNodeAttribute;
begin
  Result := nil;
  if ANode <> nil then
  begin
    if not ANode.Attributes.Find(sdxXLSXAttrApplyAlignment, AAttr) or AAttr.ValueAsBoolean
    then
      Result := ANode.FindChild(sdxXLSXNodeAlignment);
  end;
end;

function TdxSpreadSheetXLSXReaderStyleParserCellStyleHelper.GetCellXfsNode
  (ANode: TdxXMLNode; const ANodeName: TdxXMLString): TdxXMLNode;
var
  AChildNode: TdxXMLNode;
  AValue: Integer;
begin
...
function TdxSpreadSheetXLSXReaderStyleParserCellStyleHelper.
  GetNumberFormatHandle(AReader: TdxSpreadSheetXLSXReader): TObject;
var
  AResIndex: Integer;
  I: Integer;
begin
  ...
  begin
    ...
    begin
      if TdxSpreadSheetFormatHandle(AReader.Formats[I]).FormatCodeID = AResIndex
      then
        Exit(TdxSpreadSheetFormatHandle(AReader.Formats[I]));
    end;
    Result := AReader.SpreadSheet.CellStyles.Formats.PredefinedFormats.
      GetFormatHandleByID(AResIndex);
  end;
end;

function TdxSpreadSheetXLSXReaderStyleParserCellStyleHelper.
  GetProtectionAttrValueAsBoolean(const AAttrName: TdxXMLString;
  const ADefaultValue: Boolean = False): Boolean;
var
  AAttr: TdxXMLNodeAttribute;
begin
  AAttr := FindAttr(AAttrName, FNodeCellXfProtection,
    FNodeCellStyleXfProtection);
  if AAttr <> nil then
    Result := AAttr.ValueAsBoolean
  else
    Result := ADefaultValue;
...
function TdxSpreadSheetXLSXReaderStyleParserCellStyleHelper.GetProtectionNode
  (ANode: TdxXMLNode): TdxXMLNode;
begin
  Result := nil;
  if ANode <> nil then
...
function TdxSpreadSheetXLSXReaderStyleParserCellStyleHelper.GetResourceHandle
  (const AResName, AOptionName: TdxXMLString;
  AResourceCollection: TdxSpreadSheetHashTableItemList): TObject;
var
  AResIndex: Integer;
begin
...
var
  AChildNode: TdxXMLNode;
begin
  if Node.FindChild([sdxXLSXNodeThemesElements, sdxXLSXNodeThemesColorScheme],
    AChildNode) then
    ReadColorSchema(AChildNode);
  if Node.FindChild([sdxXLSXNodeThemesElements, sdxXLSXNodeThemesFormatScheme,
    sdxXLSXNodeThemesFormatSchemeFillStyleList], AChildNode) then
    AChildNode.ForEach(ProcessFillStyle);
  if Node.FindChild([sdxXLSXNodeThemesElements, sdxXLSXNodeThemesFormatScheme,
    sdxXLSXNodeThemesFormatSchemeLineStyleList], AChildNode) then
    AChildNode.ForEach(ProcessLineStyle);
end;

procedure TdxSpreadSheetXLSXReaderThemeParser.ReadColorSchema
  (ANode: TdxXMLNode);
const
  Names: array [0 .. 11] of AnsiString = ('lt1', 'dk1', 'lt2', 'dk2', 'accent1',
...
begin
  ...
  begin
    if ANode.FindChild('a:' + Names[I], AChildNode) and (AChildNode.First <> nil)
    then
...
function TdxSpreadSheetXLSXReaderThemeParser.ProcessColor
  (ANode: TdxXMLNode): TColor;
begin
  Result := clDefault;
  if SameText(ANode.Name, sdxXLSXNodeThemesSystemColor) then
  begin
    if not IdentToColor('cl' + ANode.Attributes.GetValueAsString
      (sdxXLSXAttrVal), Integer(Result)) then
      DoError(sdxErrorInvalidColor, [ANode.Attributes.GetValue(sdxXLSXAttrVal)],
        ssmtWarning);
  end
  else if SameText(ANode.Name, sdxXLSXNodeThemesCustomColor) then
    try
...
procedure TdxSpreadSheetXLSXReaderThemeParser.ProcessFillStyle
  (ANode: TdxXMLNode; AUserData: Pointer);
var
  ABrush: TdxGPBrush;
begin
  ABrush := TdxGPBrush.Create;
  ExecuteSubTask(TdxSpreadSheetXLSXReaderBrushParser.Create(ANode,
    ABrush, Self));
  ThemedBrushes.Add(ABrush);
end;

procedure TdxSpreadSheetXLSXReaderThemeParser.ProcessLineStyle
  (ANode: TdxXMLNode; AUserData: Pointer);
var
  APen: TdxGPPen;
begin
...
function TdxSpreadSheetXLSXReaderThemeParser.GetColorMap
  : TDictionary<TdxXMLString, TColor>;
begin
  Result := Owner.ColorMap;
end;

function TdxSpreadSheetXLSXReaderThemeParser.GetThemedBrushes
  : TObjectList<TdxGPBrush>;
begin
...
function TdxSpreadSheetXLSXReaderThemeParser.GetThemedPens
  : TObjectList<TdxGPPen>;
begin
...
constructor TdxSpreadSheetXLSXReaderWorkbookParser.Create(const AFileName
  : AnsiString; AOwner: TdxSpreadSheetXLSXReader);
begin
  inherited Create(AOwner);
  FFileName := AFileName;
...
begin
  ...
  try
    ...
    Owner.ForEachNodeChild(AWorkbook.FindChild([sdxXLSXNodeWorkbook,
      sdxXLSXNodeSheets]), ProcessWorksheet, nil);
    Owner.ForEachNodeChild(AWorkbook.FindChild([sdxXLSXNodeWorkbook,
      sdxXLSXNodeExternalReferences]), ProcessExternalReference, nil);
    Owner.ForEachNodeChild(AWorkbook.FindChild([sdxXLSXNodeWorkbook,
      sdxXLSXNodeDefinedNames]), ProcessDefinedName, nil);

    if AWorkbook.FindChild([sdxXLSXNodeWorkbook, sdxXLSXNodeBookViews,
      sdxXLSXNodeWorkBookView], ANode) then
    begin
      SpreadSheet.ActiveSheetIndex := ANode.Attributes.GetValueAsInteger
        (sdxXLSXAttrActiveTab, SpreadSheet.ActiveSheetIndex);
      SpreadSheet.OptionsView.HorizontalScrollBar :=
        ANode.Attributes.GetValueAsBoolean
        (sdxXLSXAttrShowHorizontalScroll, True);
      SpreadSheet.OptionsView.VerticalScrollBar :=
        ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrShowVerticalScroll, True);
      SpreadSheet.PageControl.Visible := ANode.Attributes.GetValueAsBoolean
        (sdxXLSXAttrShowSheetTabs, True);
    end;
  finally
    AWorkbook.Free;
  end;
...
procedure TdxSpreadSheetXLSXReaderWorkbookParser.ParseWorkbookProperties
  (AWorkbook: TdxXMLDocument);
const
...
begin
  ...
  begin
    SpreadSheet.OptionsBehavior.IterativeCalculationMaxCount :=
      ANode.Attributes.GetValueAsInteger(sdxXLSXAttrIterateCount, 100);
    SpreadSheet.OptionsBehavior.IterativeCalculation :=
      ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrIterate);
    SpreadSheet.OptionsView.R1C1Reference :=
      SameText(ANode.Attributes.GetValue(sdxXLSXAttrRefMode), sdxXLSXValueR1C1);
  end
  else
  begin
  ...
  if AWorkbook.FindChild([sdxXLSXNodeWorkbook, sdxXLSXNodeWorkbookPr], ANode)
  then
    SpreadSheet.OptionsView.DateTimeSystem :=
      Map[ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrDate1904)]
  else
  ...
  if AWorkbook.FindChild([sdxXLSXNodeWorkbook, sdxXLSXNodeWorkbookProtection],
    ANode) then
  begin
    SpreadSheet.OptionsProtection.Protected := True;
    SpreadSheet.OptionsProtection.AllowChangeStructure :=
      not ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrLockStructure);
    if ANode.Attributes.Exists(sdxXLSXAttrWorkbookAlgorithmName) then
      SpreadSheet.OptionsProtection.ProtectionInfo :=
        ReadProtectionInfoStrong(ANode)
    else if ANode.Attributes.Exists(sdxXLSXAttrWorkbookPassword) then
      SpreadSheet.OptionsProtection.ProtectionInfo :=
        ReadProtectionInfoStandard(ANode);
  end;
end;

procedure TdxSpreadSheetXLSXReaderWorkbookParser.ProcessDefinedName
  (ANode: TdxXMLNode; AUserData: Pointer);
var
  AAttr: TdxXMLNodeAttribute;
...
begin
  ...
  ADefinedName := SpreadSheet.DefinedNames.AddOrSet
    (ANode.Attributes.GetValueAsString(sdxXLSXAttrName),
    ANode.TextAsString, AScope);
  ADefinedName.Comment := ANode.Attributes.GetValueAsString(sdxXLSXAttrComment);
...
procedure TdxSpreadSheetXLSXReaderWorkbookParser.ProcessExternalReference
  (ANode: TdxXMLNode; AUserData: Pointer);
var
  ARelsItem: TdxSpreadSheetXLSXReaderRelsItem;
begin
  if Rels.Find(ANode.Attributes.GetValue(sdxXLSXAttrRId), ARelsItem) then
    ExecuteSubTask(TdxSpreadSheetXLSXReaderExternalLinkParser.Create
      (ARelsItem.FileName, Owner))
  else
    DoError(sdxErrorInvalidRelationshipId,
      [ANode.Attributes.GetValue(sdxXLSXAttrRId)], ssmtError);
end;

procedure TdxSpreadSheetXLSXReaderWorkbookParser.ProcessWorksheet
  (ANode: TdxXMLNode; AUserData: Pointer);
var
  AItem: TdxSpreadSheetXLSXReaderRelsItem;
...
begin
  if not Rels.Find(ANode.Attributes.GetValue(sdxXLSXAttrRId), AItem) then
    DoError(sdxErrorInvalidRelationshipId,
      [ANode.Attributes.GetValue(sdxXLSXAttrRId)], ssmtError)
  else if SameText(AItem.FileType, sdxXLSXWorksheetRelationship) then
  begin
    AView := Owner.AddTableView(ANode.Attributes.GetValueAsString
      (sdxXLSXAttrName));
    AView.Visible := not SameText(ANode.Attributes.GetValue(sdxXLSXAttrState),
      sdxXLSXValueHidden);
    FLocalSheetIdMap.Add(IntToStr(ANode.Index), AView);
    ExecuteSubTask(TdxSpreadSheetXLSXReaderWorksheetParser.Create
      (AItem.FileName, AView, Owner));
  end;
end;

procedure TdxSpreadSheetXLSXReaderWorkbookParser.ReadSharedStrings
  (const AFileName: AnsiString);
begin
  ExecuteSubTask(TdxSpreadSheetXLSXReaderSharedStringParser.Create
    (AFileName, Owner));
end;

procedure TdxSpreadSheetXLSXReaderWorkbookParser.ReadStyles(const AFileName
  : AnsiString);
begin
  ExecuteSubTask(TdxSpreadSheetXLSXReaderStyleParser.Create(AFileName, Owner));
end;

procedure TdxSpreadSheetXLSXReaderWorkbookParser.ReadTheme(const AFileName
  : AnsiString);
begin
  ExecuteSubTask(TdxSpreadSheetXLSXReaderThemeParser.Create(AFileName, Owner));
end;

function TdxSpreadSheetXLSXReaderWorkbookParser.ReadProtectionInfoStandard
  (ANode: TdxXMLNode): IdxSpreadSheetProtectionInfo;
var
  AProtection: TdxSpreadSheetStandardProtectionInfo;
begin
  AProtection := TdxSpreadSheetStandardProtectionInfo.Create;
  AProtection.KeyWordAsString := ANode.Attributes.GetValueAsString
    (sdxXLSXAttrWorkbookPassword);
  Result := AProtection;
end;

function TdxSpreadSheetXLSXReaderWorkbookParser.ReadProtectionInfoStrong
  (ANode: TdxXMLNode): IdxSpreadSheetProtectionInfo;
var
...
begin
  ...
  AProtection.HashValueAsString := ANode.Attributes.GetValueAsString
    (sdxXLSXAttrWorkbookHashValue);
  AProtection.SaltValueAsString := ANode.Attributes.GetValueAsString
    (sdxXLSXAttrWorkbookSaltValue);
  AProtection.SpinCount := ANode.Attributes.GetValueAsInteger
    (sdxXLSXAttrWorkbookSpinCount);
  Result := AProtection;
end;

{ TdxSpreadSheetXLSXReaderMetadataParser }

procedure TdxSpreadSheetXLSXReaderMetadataParser.Execute;
begin
  Metadata.Created := ReadDateTime(Node, sdxXLSXNamespaceDublinCoreTerms,
    sdxXLSXNodeCreationDate);
  Metadata.CreatedBy := ReadText(Node, sdxXLSXNamespaceDublinCore,
    sdxXLSXNodeCreator);
  Metadata.LastModified := ReadDateTime(Node, sdxXLSXNamespaceDublinCoreTerms,
    sdxXLSXNodeModificationDate);
  Metadata.LastModifiedBy := ReadText(Node, sdxXLSXNamespaceCoreProperties,
    sdxXLSXNodeLastModifiedBy);
  Metadata.LastPrinted := ReadDateTime(Node, sdxXLSXNamespaceCoreProperties,
    sdxXLSXNodeLastPrinted);
  Metadata.Description := ReadText(Node, sdxXLSXNamespaceDublinCore,
    sdxXLSXNodeDescription);
  Metadata.Keywords := ReadText(Node, sdxXLSXNamespaceCoreProperties,
    sdxXLSXNodeKeywords);
  Metadata.Subject := ReadText(Node, sdxXLSXNamespaceDublinCore,
    sdxXLSXNodeSubject);
  Metadata.Title := ReadText(Node, sdxXLSXNamespaceDublinCore,
    sdxXLSXNodeTitle);
end;

function TdxSpreadSheetXLSXReaderMetadataParser.GetMetadata
  : TdxSpreadSheetOptionsMetadata;
begin
  Result := SpreadSheet.OptionsMetadata;
end;

function TdxSpreadSheetXLSXReaderMetadataParser.ReadDateTime
  (AParentNode: TdxXMLNode; const ANamespace, AValueName: AnsiString)
  : TDateTime;
begin
  if AParentNode.FindChild(ANamespace + ':' + AValueName, AParentNode) then
    Result := AParentNode.TextAsDateTime
  else
    Result := 0;
end;

function TdxSpreadSheetXLSXReaderMetadataParser.ReadText
  (AParentNode: TdxXMLNode; const ANamespace, AValueName: AnsiString): string;
begin
  if AParentNode.FindChild(ANamespace + ':' + AValueName, AParentNode) then
...
constructor TdxSpreadSheetXLSXReaderWorksheetParser.Create(const AFileName
  : AnsiString; AView: TdxSpreadSheetTableView;
  AOwner: TdxSpreadSheetXLSXReader);
begin
...
function TdxSpreadSheetXLSXReaderWorksheetParser.ConvertRowHeight
  (const AValue: Double): Integer;
begin
  Result := TdxValueUnitsHelper.PointsToPixels(AValue);
end;

function TdxSpreadSheetXLSXReaderWorksheetParser.ExtractColumnIndex
...
procedure TdxSpreadSheetXLSXReaderWorksheetParser.ProcessBreaks
  (ANode: TdxXMLNode; AUserData: Pointer);
begin
  if ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrBreakManual) then
    TList<Cardinal>(AUserData)
      .Add(ANode.Attributes.GetValueAsInteger(sdxXLSXAttrBreakID));
end;

procedure TdxSpreadSheetXLSXReaderWorksheetParser.ProcessColumn
  (ANode: TdxXMLNode; AUserData: Pointer);
var
  AAttr: TdxXMLNodeAttribute;
...
begin
  ...
  AGroup := TdxSpreadSheetTableItemGroupAccess
    (View.Columns.Groups.Find(AMin - 1));
  if AGroup <> nil then
    AGroup.FCollapsedByUser := ANode.Attributes.GetValueAsBoolean
      (sdxXLSXAttrCollapsed);
  ...
  if (AStyleIndex >= 0) and CheckListIndex(AStyleIndex, CellStyles,
    sdxErrorInvalidStyleIndex, ssmtError) then
  ...
  if (AMax = dxSpreadSheetMaxColumnIndex) and
    ((AMin = 0) or (AMin = View.Columns.Count)) then
  begin
...
procedure TdxSpreadSheetXLSXReaderWorksheetParser.ProcessFixedPane
  (ANode: TdxXMLNode);
var
...
begin
  ...
  if dxTryStringToReference(ANode.Parent.Attributes.GetValueAsString
    (sdxXLSXAttrTopLeftCell), False, ARowIndex, AColumnIndex) then
  begin
  ...
  if dxTryStringToReference(ANode.Attributes.GetValueAsString
    (sdxXLSXAttrTopLeftCell), False, ARowIndex, AColumnIndex) then
  begin
...
procedure TdxSpreadSheetXLSXReaderWorksheetParser.ProcessHeaderFooter
  (ANode: TdxXMLNode);
var
  AHeaderFooter: TdxSpreadSheetTableViewOptionsPrintHeaderFooter;
begin
  AHeaderFooter := View.OptionsPrint.HeaderFooter;
  AHeaderFooter.AlignWithMargins := ANode.Attributes.GetValueAsDefaultBoolean
    (sdxXLSXAttrHeaderFooterAlignWithMargins);
  AHeaderFooter.ScaleWithDocument := ANode.Attributes.GetValueAsDefaultBoolean
    (sdxXLSXAttrHeaderFooterScaleWithDocument);

  ExecuteSubTask(TdxSpreadSheetXLSXReaderHeaderFooterParser.Create
    (ANode.FindChild(sdxXLSXNodeOddFooter), Owner, AHeaderFooter.CommonFooter));
  ExecuteSubTask(TdxSpreadSheetXLSXReaderHeaderFooterParser.Create
    (ANode.FindChild(sdxXLSXNodeOddHeader), Owner, AHeaderFooter.CommonHeader));

  if ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrHeaderFooterDifferentFirst)
  then
  begin
    ExecuteSubTask(TdxSpreadSheetXLSXReaderHeaderFooterParser.Create
      (ANode.FindChild(sdxXLSXNodeFirstFooter), Owner,
      AHeaderFooter.FirstPageFooter));
    ExecuteSubTask(TdxSpreadSheetXLSXReaderHeaderFooterParser.Create
      (ANode.FindChild(sdxXLSXNodeFirstHeader), Owner,
      AHeaderFooter.FirstPageHeader));
  end;

  if ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrHeaderFooterDifferentOddEven)
  then
  begin
    ExecuteSubTask(TdxSpreadSheetXLSXReaderHeaderFooterParser.Create
      (ANode.FindChild(sdxXLSXNodeEvenFooter), Owner,
      AHeaderFooter.EvenPagesFooter));
    ExecuteSubTask(TdxSpreadSheetXLSXReaderHeaderFooterParser.Create
      (ANode.FindChild(sdxXLSXNodeEvenHeader), Owner,
      AHeaderFooter.EvenPagesHeader));
  end;
end;

procedure TdxSpreadSheetXLSXReaderWorksheetParser.ProcessLegacyDrawings
  (ANode: TdxXMLNode);
var
  AItem: TdxSpreadSheetXLSXReaderRelsItem;
begin
  if Rels.FindByType(sdxXLSXCommentsRelationship, AItem) then
    ExecuteSubTask(TdxSpreadSheetXLSXReaderCommentsParser.Create(AItem.FileName,
      View, Owner));
  if Rels.Find(ANode.Attributes.GetValue(sdxXLSXAttrRId), AItem) then
    ExecuteSubTask(TdxSpreadSheetXLSXReaderCommentContainersParser.Create
      (AItem.FileName, View, Owner));
end;

procedure TdxSpreadSheetXLSXReaderWorksheetParser.ProcessHyperlinks
  (ANode: TdxXMLNode; AUserData: Pointer);
var
  AValue: string;
  AAttr: TdxXMLNodeAttribute;
  ...
  ARelsItem: TdxSpreadSheetXLSXReaderRelsItem;
begin
  AHyperlink := View.Hyperlinks.Add
    (dxStringToReferenceArea(ANode.Attributes.GetValueAsString
    (sdxXLSXAttrRef)));
  ...
  else if ANode.Attributes.Find(sdxXLSXAttrRId, AAttr) then
  begin
...
procedure TdxSpreadSheetXLSXReaderWorksheetParser.ProcessMergedCells
  (ANode: TdxXMLNode; AUserData: Pointer);
var
  ARect: TRect;
begin
  ARect := dxStringToReferenceArea(ANode.Attributes.GetValueAsString
    (sdxXLSXAttrRef));
  if (ARect.Left >= 0) and (ARect.Top >= 0) and (ARect.Right >= 0) and
    (ARect.Bottom >= 0) then
    View.MergedCells.Add(ARect);
end;

procedure TdxSpreadSheetXLSXReaderWorksheetParser.ProcessPageMargins
  (ANode: TdxXMLNode);
var
...
begin
  ...
  AMargins.Right := ANode.Attributes.GetValueAsFloat
    (sdxXLSXAttrPageMarginsRight);
  AMargins.Bottom := ANode.Attributes.GetValueAsFloat
    (sdxXLSXAttrPageMarginsBottom);
  AMargins.Header := ANode.Attributes.GetValueAsFloat
    (sdxXLSXAttrPageMarginsHeader);
  AMargins.Footer := ANode.Attributes.GetValueAsFloat
    (sdxXLSXAttrPageMarginsFooter);
  AMargins.Assigned := True;
end;

procedure TdxSpreadSheetXLSXReaderWorksheetParser.ProcessPageSetup
  (ANode: TdxXMLNode);
var
...
begin
  ...
  APage.FitToHeight := ANode.Attributes.GetValueAsInteger
    (sdxXLSXAttrPageSetupFitToHeight, 1);
  APage.FitToWidth := ANode.Attributes.GetValueAsInteger
    (sdxXLSXAttrPageSetupFitToWidth, 1);
  APage.Orientation := TdxSpreadSheetXLSXHelper.StringToPrintPageOrientation
    (ANode.Attributes.GetValue(sdxXLSXAttrPageSetupOrientation));
  APage.Scale := ANode.Attributes.GetValueAsInteger
    (sdxXLSXAttrPageSetupScale, 100);
  if ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrPageSetupUseFirstPageNumber)
  then
    APage.FirstPageNumber := ANode.Attributes.GetValueAsInteger
      (sdxXLSXAttrPageSetupFirstPageNumber);

  APaper := View.OptionsPrint.Page.Paper;
  APaper.SizeID := ANode.Attributes.GetValueAsInteger
    (sdxXLSXAttrPageSetupPaperSize);
  APaper.CustomSize.X := TdxValueUnitsHelper.ValueToInchesF
    (ANode.Attributes.GetValueAsString(sdxXLSXAttrPageSetupPaperWidth));
  APaper.CustomSize.Y := TdxValueUnitsHelper.ValueToInchesF
    (ANode.Attributes.GetValueAsString(sdxXLSXAttrPageSetupPaperHeight));
  APaper.Assigned := (APaper.SizeID <> 0) or (APaper.CustomSize.X > 0) and
    (APaper.CustomSize.Y > 0);

  APrinting := View.OptionsPrint.Printing;
  APrinting.Draft := ANode.Attributes.GetValueAsDefaultBoolean
    (sdxXLSXAttrPageSetupDraft);
  APrinting.BlackAndWhite := ANode.Attributes.GetValueAsDefaultBoolean
    (sdxXLSXAttrPageSetupBlackAndWhite);
  APrinting.Copies := ANode.Attributes.GetValueAsInteger
    (sdxXLSXAttrPageSetupCopies);
  APrinting.PageOrder := TdxSpreadSheetXLSXHelper.StringToPrintPageOrder
    (ANode.Attributes.GetValue(sdxXLSXAttrPageSetupPageOrder));

  View.OptionsPrint.Source.ErrorIndication :=
    TdxSpreadSheetXLSXHelper.StringToPrintErrorIndication
    (ANode.Attributes.GetValue(sdxXLSXAttrPageSetupErrors));
  View.OptionsPrint.Source.CellComments :=
    TdxSpreadSheetXLSXHelper.StringToPrintCellComments
    (ANode.Attributes.GetValue(sdxXLSXAttrPageSetupCellComments));
end;

procedure TdxSpreadSheetXLSXReaderWorksheetParser.ProcessPageSetupExProperties
  (ANode: TdxXMLNode);
begin
...
procedure TdxSpreadSheetXLSXReaderWorksheetParser.ProcessPrintOptions
  (ANode: TdxXMLNode);
var
  ASource: TdxSpreadSheetTableViewOptionsPrintSource;
begin
  View.OptionsPrint.Printing.HorizontalCentered :=
    ANode.Attributes.GetValueAsDefaultBoolean
    (sdxXLSXAttrPrintOptionsHorzCenter);
  View.OptionsPrint.Printing.VerticalCentered :=
    ANode.Attributes.GetValueAsDefaultBoolean
    (sdxXLSXAttrPrintOptionsVertCenter);

  ASource := View.OptionsPrint.Source;
  ASource.Headers := ANode.Attributes.GetValueAsDefaultBoolean
    (sdxXLSXAttrPrintOptionsHeadings);
  ASource.GridLines := ANode.Attributes.GetValueAsDefaultBoolean
    (sdxXLSXAttrPrintOptionsGridLines);
end;

procedure TdxSpreadSheetXLSXReaderWorksheetParser.ProcessProperties
  (ANode: TdxXMLNode);
var
  AAttr: TdxXMLNodeAttribute;
begin
  if ANode.Attributes.Find(sdxXLSXAttrDefaultColumnWidth, AAttr) then
    View.Columns.DefaultSize := Owner.ColumnWidthHelper.WidthToPixels
      (AAttr.ValueAsFloat)
  else
  ...
  if ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrCustomHeight, True) then
    View.Rows.DefaultSize := ConvertRowHeight
      (ANode.Attributes.GetValueAsFloat(sdxXLSXAttrDefaultRowHeight));
end;

procedure TdxSpreadSheetXLSXReaderWorksheetParser.ProcessRow(ANode: TdxXMLNode;
  AUserData: Pointer);
var
  AAttr: TdxXMLNodeAttribute;
  AGroup: TdxSpreadSheetTableItemGroupAccess;
...
begin
  ...
  TdxSpreadSheetOutlineHelper.IncreaseOutlineLevelTo(View.Rows, ARow.Index,
    ANode.Attributes.GetValueAsInteger(sdxXLSXAttrOutlineLevel) - 1);
  AGroup := TdxSpreadSheetTableItemGroupAccess
    (View.Rows.Groups.Find(ARow.Index - 1));
  if AGroup <> nil then
    AGroup.FCollapsedByUser := ANode.Attributes.GetValueAsBoolean
      (sdxXLSXAttrCollapsed);
  ...
  begin
    ...
    ARow.IsCustomSize := ANode.Attributes.GetValueAsBoolean
      (sdxXLSXAttrCustomHeight);
  end;
  ...
  begin
    ...
    if CheckListIndex(AIndex, CellStyles, sdxErrorInvalidStyleIndex, ssmtError)
    then
...
procedure TdxSpreadSheetXLSXReaderWorksheetParser.ProcessRowCell
  (ANode: TdxXMLNode; AUserData: Pointer);
var
  AAttr: TdxXMLNodeAttribute;
...
begin
  ...
  ACellType := TdxSpreadSheetXLSXHelper.StringToCellType
    (ANode.Attributes.GetValue(sdxXLSXAttrCellType));
  if ACellType = sxctRichText then
  begin
    if ANode.FindChild(sdxXLSXNodeCellRichText, AChildNode) or
      ANode.FindChild(sdxXLSXNodeCellValue, ACellValue) and
      ACellValue.FindChild(sdxXLSXNodeCellRichText, AChildNode) then
      ACell.AsSharedString := TdxSpreadSheetXLSXReaderSharedStringParser.
        ParseString(Owner, AChildNode);
  end
  else if ANode.FindChild(sdxXLSXNodeCellValue, ACellValue) then
    case ACellType of
      sxctBoolean:
      ...
      sxctFloat:
        ACell.AsFloat := StrToFloat(ACellValue.TextAsString,
          dxInvariantFormatSettings);
      sxctString:
        if TryStrToFloat(ACellValue.TextAsString, ATempFloat,
          dxInvariantFormatSettings) then
      ...
      sxctSharedString:
        begin
          ...
          if CheckListIndex(AIndex, SharedStrings,
            sdxErrorInvalidSharedStringIndex, ssmtWarning) then
            ACell.AsSharedString := TdxSpreadSheetSharedString
              (SharedStrings[AIndex]);
        end;
    end;
end;
...
begin
  ...
  try
    AParts.Text := StringReplace(ANode.Attributes.GetValueAsString
      (sdxXLSXAttrSqRef), ' ', #13#10, [rfReplaceAll]);
...
begin
  ...
  if GetChild(sdxXLSXNodeSheetPr, ANode) and
    ANode.FindChild(sdxXLSXNodeOutlinePr, ANode) then
  begin
    if not ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrSummaryRight, True)
    then
      View.Columns.Groups.ExpandButtonPosition := gebpGroupStart;
    if not ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrSummaryBelow, True)
    then
...
begin
  if Document.Root.First <> nil then
    ExecuteSubTask(TdxSpreadSheetXLSXReaderConditionalFormattingParser.
      Create(Self));
end;

procedure TdxSpreadSheetXLSXReaderWorksheetParser.ReadDrawing(const AFileName
  : AnsiString);
begin
  ExecuteSubTask(TdxSpreadSheetXLSXReaderDrawingParser.Create(AFileName,
    Owner, View));
end;
...
begin
  ...
  if GetChild(sdxXLSXNodeSheetPr, ANode) and
    ANode.FindChild(sdxXLSXNodePageSetUpPr, ANode) then
...
begin
  ...
  begin
    View.OptionsProtection.AllowDeleteColumns :=
      not ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrDeleteColumns, True);
    View.OptionsProtection.AllowDeleteRows :=
      not ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrDeleteRows, True);
    View.OptionsProtection.AllowFormatCells :=
      not ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrFormatCells, True);
    View.OptionsProtection.AllowResizeColumns :=
      not ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrFormatColumns, True);
    View.OptionsProtection.AllowResizeRows :=
      not ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrFormatRows, True);
    View.OptionsProtection.AllowInsertColumns :=
      not ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrInsertColumns, True);
    View.OptionsProtection.AllowInsertRows :=
      not ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrInsertRows, True);
    View.OptionsProtection.AllowEditHyperlinks :=
      not ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrInsertHyperlinks, True);
    View.OptionsProtection.AllowEditContainers :=
      not ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrObjects);
    View.OptionsProtection.AllowSelectLockedCells :=
      not ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrSelectLockedCells);
    View.OptionsProtection.AllowSelectUnlockedCells :=
      not ANode.Attributes.GetValueAsBoolean(sdxXLSXAttrSelectUnlockedCell);
    View.OptionsProtection.AllowSort := not ANode.Attributes.GetValueAsBoolean
      (sdxXLSXAttrSort);
    View.OptionsProtection.Protected := ANode.Attributes.GetValueAsBoolean
      (sdxXLSXAttrSheet);
...
function TdxSpreadSheetXLSXReaderWorksheetParser.ReadProtectionInfoStandard
  (ANode: TdxXMLNode): IdxSpreadSheetProtectionInfo;
var
  AProtection: TdxSpreadSheetStandardProtectionInfo;
begin
...
function TdxSpreadSheetXLSXReaderWorksheetParser.ReadProtectionInfoStrong
  (ANode: TdxXMLNode): IdxSpreadSheetProtectionInfo;
var
  AProtection: TdxSpreadSheetStrongProtectionInfo;
begin
  AProtection := TdxSpreadSheetStrongProtectionInfo.Create;
  AProtection.HashAlgorithm := TdxSpreadSheetXLSXHelper.StringToHashAlgorithm
    (ANode.Attributes.GetValueAsString(sdxXLSXAttrAlgorithmName));
  AProtection.HashValueAsString := ANode.Attributes.GetValueAsString
    (sdxXLSXAttrHashValue);
  AProtection.SaltValueAsString := ANode.Attributes.GetValueAsString
    (sdxXLSXAttrSaltValue);
  AProtection.SpinCount := ANode.Attributes.GetValueAsInteger
    (sdxXLSXAttrSpinCount);
  Result := AProtection;
end;
...
var
  ...
  ANode: TdxXMLNode;
begin
  if GetChild(sdxXLSXNodeSheetsView, ANode) and
    ANode.FindChild(sdxXLSXNodeSheetView, ANode) then
  begin
    View.Options.ZoomFactor := ANode.Attributes.GetValueAsInteger
      (sdxXLSXAttrZoomScaleNormal, 100);
    ...
    if ANode.Attributes.Find(sdxXLSXAttrRightToLeft, AAttr) then
      View.Options.RightToLeftLayout := TdxDefaultBoolean(AAttr.ValueAsBoolean);

    AActivePane := '';
    if ANode.FindChild(sdxXLSXNodePane, AChildNode) then
    begin
      AActivePane := AChildNode.Attributes.GetValueAsString
        (sdxXLSXAttrActivePane);
    ...
    ANode.ForEach(procedure(ANode: TdxXMLNode; AUserData: Pointer)
      begin
        ...
        begin
          if SameText(ANode.Attributes.GetValueAsString(sdxXLSXAttrPane),
            AActivePane) then
...
function TdxSpreadSheetXLSXReaderWorksheetParser.GetCellStyles
  : TdxSpreadSheetHashTableItemList;
begin
  Result := Owner.Styles;
end;

function TdxSpreadSheetXLSXReaderWorksheetParser.GetChild
  (const AName: TdxXMLString; out ANode: TdxXMLNode): Boolean;
begin
  Result := (Document.Root.First <> nil) and Document.Root.First.FindChild
    (AName, ANode);
end;

function TdxSpreadSheetXLSXReaderWorksheetParser.GetSharedStrings
  : TdxSpreadSheetHashTableItemList;
begin
...
function TdxSpreadSheetOpenXMLNode.FindChild(const AName: TdxXMLString;
out ANode: TdxXMLNode): Boolean;
begin
  ANode := First;
