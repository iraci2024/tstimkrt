...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Windows, Messages, Classes, Types, SysUtils, Graphics, Controls, Variants,
  Forms, Math, Clipbrd, StdCtrls,
  Generics.Defaults, Generics.Collections, Menus,
  // CX
  cxClasses, dxCore, cxGraphics, dxCoreClasses, cxFormats, cxControls,
  cxGeometry, cxVariants, cxLookAndFeels,
  cxLookAndFeelPainters, dxCoreGraphics, cxInplaceContainer, dxGDIPlusClasses,
  cxNavigator, cxLibraryConsts,
  dxHashUtils, cxDateUtils, cxStyles, cxEdit, cxMemo, cxTextEdit, cxRichEdit,
  cxRichEditUtils, dxCustomHint,
  ...
  dxSpreadSheetStyles,
  // SpreadSheet
  dxSpreadSheetTypes, dxSpreadSheetClasses, dxSpreadSheetUtils,
  dxSpreadSheetStrs, dxSpreadSheetGraphics,
  dxSpreadSheetNumberFormat, dxSpreadSheetPrinting, dxSpreadSheetHyperlinks,
  dxSpreadSheetProtection,
  dxSpreadSheetCoreStyles, dxSpreadSheetCoreReferences,
  dxSpreadSheetCoreFormulas, dxSpreadSheetInplaceEdit;
...
type
  ...
  TdxSpreadSheetPageControlButton = (sspcbFirst, sspcbPrev, sspcbNext,
    sspcbLast, sspcbNew);
  TdxSpreadSheetPageControlButtons = set of TdxSpreadSheetPageControlButton;

  TdxSpreadSheetPageControlContextPopupEvent = procedure
    (ASpreadSheet: TdxCustomSpreadSheet; const P: TPoint;
    APopupMenu: TPopupMenu; var AHandled: Boolean) of object;
  TdxSpreadSheetPageControlNewTabButtonClickEvent = procedure
    (ASpreadSheet: TdxCustomSpreadSheet; var AHandled: Boolean) of object;
  TdxSpreadSheetPageControlTabDragAndDropEvent = procedure
    (ASpreadSheet: TdxCustomSpreadSheet; AIndex, ANewIndex: Integer;
    var AAccepted: Boolean) of object;
  TdxSpreadSheetPageControlTabEndDragEvent = procedure
    (ASpreadSheet: TdxCustomSpreadSheet; AOldIndex, AIndex: Integer) of object;
  TdxSpreadSheetPageControlTabStartDragEvent = procedure
    (ASpreadSheet: TdxCustomSpreadSheet; AIndex: Integer) of object;

  TdxSpreadSheetChange = (sscData, sscLayout, sscZoom, sscStyle, sscDimension,
    sscOptionsPrint, sscModified, sscBiDiMode, sscMetadata);
  TdxSpreadSheetChanges = set of TdxSpreadSheetChange;

  TdxSpreadSheetState = (sssReading, sssReadingCells, sssReadingFromClipboard,
    sssWriting, sssExporting, sssBiDiModeChanging);
  TdxSpreadSheetStates = set of TdxSpreadSheetState;

  TdxSpreadSheetTableViewForEachCellProc = reference to procedure
  ...
  TdxSpreadSheetFormulaToken = dxSpreadSheetCoreFormulas.
    TdxSpreadSheetFormulaToken;
  TdxSpreadSheetFormulaResult = dxSpreadSheetCoreFormulas.
  ...
  IdxSpreadSheetKeyboardListener = interface
    ...
    procedure KeyDown(Sender: TdxCustomSpreadSheet; var Key: Word;
      Shift: TShiftState);
  end;
  ...
  IdxSpreadSheetTableViewSelectionModeListener = interface
    (IdxSpreadSheetSelectionListener)
    ['{52B30115-93EC-438C-ACC4-E4E1390B6974}']
    procedure SelectionModeChanged(Sender: TdxSpreadSheetTableView;
      AMode: TdxSpreadSheetTableViewSelectionMode);
  end;
  ...
  IdxSpreadSheetTableView = interface
    ...
    function GetAbsoluteCellBounds(const ARowIndex, AColumnIndex: Integer;
      ACheckMergedCells: Boolean = True): TRect;
    function GetAbsoluteCellsArea: TRect;
    function GetCell(const ARowIndex, AColumnIndex: Integer)
      : TdxSpreadSheetCell;
    function GetCellArea(const ARowIndex, AColumnIndex: Integer): TRect;
    function GetCellAtAbsolutePoint(const P: TPoint;
      out ARowIndex, AColumnIndex: Integer): Boolean;
  end;
  ...
  public
    ...
    procedure NotifyKeyDown(Sender: TdxCustomSpreadSheet; var Key: Word;
    ...
    procedure NotifySelectionModeChanged(Sender: TdxSpreadSheetTableView;
      AMode: TdxSpreadSheetTableViewSelectionMode);
  end;
  ...
  strict private
    ...
    function CheckNeedUpdateValue(const AValue: Variant;
      const AFormatCode: string): Boolean; inline;
  ...
  public
    ...
    constructor Create;
    function Update(const ACell: TdxSpreadSheetCell)
      : TdxSpreadSheetNumberFormatResult;
  end;

  { TdxSpreadSheetCell }

  TdxSpreadSheetCell = class(TdxDynamicListItem, IdxSpreadSheetCellData,
  ...
  protected
    ...
    procedure CheckAreaReferenceTokens(var AParentToken
      : TdxSpreadSheetFormulaToken);
    procedure CheckDefaultCellFormat; virtual;
    procedure Move(ARow: TdxSpreadSheetTableRow;
      AColumn: TdxSpreadSheetTableColumn); overload;
    ...
    function IsPartOfArrayFormula(var AFormulaArea: TRect;
      AFormula: PdxSpreadSheetCustomFormula = nil)
      : TdxSpreadSheetArrayFormulaPart;
    ...
    class function GetContentOffsets(ABottomBorderStyle
      : TdxSpreadSheetCellBorderStyle): TRect; inline;
    ...
    procedure SetTextCore(const AText: string;
      const AFormulaChecking, AArrayFormulaAttributeIsDirty: Boolean); virtual;
    ...
    procedure ProcessStyleChanges(APrevStyle,
      ANewStyle: TdxSpreadSheetCellStyleHandle);
  ...
  public
    ...
    function GetReference(AOptions: TdxSpreadSheetCellReferenceOptions = [])
      : string; overload;
    function GetReference(AR1C1ReferenceStyle: Boolean;
      AOptions: TdxSpreadSheetCellReferenceOptions = []): string; overload;
    ...
    procedure SetText(const AText: string;
      const AFormulaChecking: Boolean = False); virtual;
    ...
    property AsFormula: TdxSpreadSheetFormula read GetAsFormula
      write SetAsFormula;
    property AsInteger: Longint read GetAsInteger write SetAsInteger;
    property AsSharedString: TdxSpreadSheetSharedString read GetAsSharedString
      write SetAsSharedString;
    ...
    property DisplayValue: TdxSpreadSheetNumberFormatResult
      read GetDisplayValue;
    ...
    property ShowFormula: TdxDefaultBoolean read FShowFormula
      write SetShowFormula;
    property SpreadSheet: TdxCustomSpreadSheet read GetSpreadSheet;
    property Style: TdxSpreadSheetCellStyle read GetStyle;
    property StyleHandle: TdxSpreadSheetCellStyleHandle read GetStyleHandle
      write SetStyleHandle;
  ...
  public
    ...
    class function GetCell(ARow, AColumn: Integer;
      AView: TdxSpreadSheetCustomView): TdxSpreadSheetCell;
  ...
  protected
    ...
    property Container: TdxSpreadSheetContainer read GetContainer;
  public
    property FlipHorizontally: Boolean read FFlipHorizontally
      write SetFlipHorizontally;
    property FlipVertically: Boolean read FFlipVertically
      write SetFlipVertically;
  ...
  TdxSpreadSheetContainerChange = (ccContent, ccAnchors, ccPosition,
    ccTransform, ccVisibility);
  TdxSpreadSheetContainerChanges = set of TdxSpreadSheetContainerChange;

  TdxSpreadSheetContainerRestriction = (crNoCrop, crNoMove, crNoResize,
    crNoRotation, crNoChangeAspectUsingCornerHandles);
  TdxSpreadSheetContainerRestrictions = set of
  ...
  protected
    ...
    procedure LoadFromStream(AReader: TcxReader;
      ACanReadContent: Boolean = True); overload;
    procedure LoadFromStream(AReader: TcxReader; AVersion: Word;
      ACanReadContent: Boolean = True); overload; virtual;
    procedure SaveToStream(AWriter: TcxWriter;
      ACanSaveContent: Boolean = True); virtual;
  ...
  public
    ...
    //
    property AnchorPoint1: TdxSpreadSheetContainerAnchorPoint read FAnchorPoint1
      write SetAnchorPoint1;
    property AnchorPoint2: TdxSpreadSheetContainerAnchorPoint read FAnchorPoint2
      write SetAnchorPoint2;
    property AnchorType: TdxSpreadSheetContainerAnchorType read FAnchorType
      write SetAnchorType;
    ...
    property Restrictions: TdxSpreadSheetContainerRestrictions
      read FRestrictions write FRestrictions;
    property Title: string read FTitle write FTitle;
    property Transform: TdxSpreadSheetContainerTransform read FTransform
      write SetTransform;
  ...
  strict private
    ...
    procedure SetAnchorType(const Value
      : TdxSpreadSheetContainerAnchorType); inline;
  protected
    function GetContentRect: TRect;
    function GetNearCells(const R: TRect;
      out ACell1, ACell2: TdxSpreadSheetCell): Boolean; virtual;
    procedure ModifyBounds(ALeftModifier, ATopModifier, ARightModifier,
      ABottomModifier: Integer);
    procedure Resize(ADeltaX, ADeltaY: Integer);
    function TransformCoords(const R: TRect; ABackwardDirection: Boolean)
      : TRect; virtual;
  ...
  public
    ...
    procedure UpdateAnchorsAfterResize(const APrevBounds: TRect;
      AForceUpdate: Boolean = False); virtual;
    //
    property AnchorPoint1: TdxSpreadSheetContainerAnchorPoint
      read GetAnchorPoint1;
    property AnchorPoint2: TdxSpreadSheetContainerAnchorPoint
      read GetAnchorPoint2;
    property AnchorType: TdxSpreadSheetContainerAnchorType read GetAnchorType
      write SetAnchorType;
  ...
  TdxSpreadSheetContainerEnumProc = reference to function
  ...
  strict private
    ...
    function FindNearestVisibleContainer(AStartFromIndex, ADirection: Integer)
      : TdxSpreadSheetContainer;
  protected
    FComments: TDictionary<Int64, TdxSpreadSheetContainer>;

    function FindCommentContainerCore(ARow, AColumn: Integer;
      out AContainer): Boolean;
  ...
  public
    ...
    function Add(AClass: TdxSpreadSheetContainerClass)
      : TdxSpreadSheetContainer; overload;
    procedure Add(AClass: TdxSpreadSheetContainerClass;
      out AContainer); overload;
    function AddCommentContainer(ACell: TdxSpreadSheetCell)
      : TdxSpreadSheetContainer; overload;
    procedure AddCommentContainer(ACell: TdxSpreadSheetCell;
      out AContainer); overload;
    ...
    function GetNextVisibleContainer(ACurrentContainer: TdxSpreadSheetContainer)
      : TdxSpreadSheetContainer;
    function GetPrevVisibleContainer(ACurrentContainer: TdxSpreadSheetContainer)
      : TdxSpreadSheetContainer;
    function IsCellUsed(ACell: TdxSpreadSheetCell): Boolean;

    // Comments
    procedure EnumCommentContainers
      (AProc: TdxSpreadSheetContainerEnumProc); overload;
    procedure EnumCommentContainers(const AArea: TRect;
      AProc: TdxSpreadSheetContainerEnumProc); overload;
    function FindCommentContainer(ACell: TdxSpreadSheetCell)
      : TdxSpreadSheetContainer; overload;
    function FindCommentContainer(ACell: TdxSpreadSheetCell; out AContainer)
      : Boolean; overload;
    function FindCommentContainer(ARow, AColumn: Integer)
      : TdxSpreadSheetContainer; overload;
    function FindCommentContainer(ARow, AColumn: Integer; out AContainer)
      : Boolean; overload;
    function FindNextCommentContainer(ACell: TdxSpreadSheetCell; out AContainer;
      AGoForward: Boolean = True): Boolean; overload;
    function FindNextCommentContainer(ARow, AColumn: Integer; out AContainer;
      AGoForward: Boolean = True): Boolean; overload;
  ...
  public
    ...
    procedure LoadFromStream(AReader: TcxReader);
    procedure SaveToStream(AWriter: TcxWriter);
    class procedure SaveFormulaToStream(AFormula: TdxSpreadSheetFormula;
      AWriter: TcxWriter);
  end;
  ...
  TdxSpreadSheetFormulaAsTextInfoList = class
    (TObjectList<TdxSpreadSheetFormulaAsTextInfo>)
  strict private
    FSpreadSheet: TdxCustomSpreadSheet;
  protected
  ...
  public
    ...
    function Add(ACell: TdxSpreadSheetCell; const AFormula: string;
      AIsArray, AIsShared: Boolean; const AReference: TRect)
      : TdxSpreadSheetFormulaAsTextInfo; overload;
    function Add(ACell: TdxSpreadSheetCell; const AAnchor: TPoint;
      const AFormula: string; AIsArray, AIsShared: Boolean;
      const AReference: TRect): TdxSpreadSheetFormulaAsTextInfo; overload;
    function AddFromStream(ACell: TdxSpreadSheetCell; AReader: TcxReader)
      : TdxSpreadSheetFormulaAsTextInfo;
  ...
  protected
    ...
    function GetView: TObject; override;
  public
    constructor Create(AOwner: TdxSpreadSheetDefinedName); reintroduce;
      overload;
  ...
  protected
    procedure DoNameChanged(AName: TdxSpreadSheetDefinedName;
      const ANewName: string);
    function CreateParser: TObject; override;
    function GetCellFromPath(APath: TdxSpreadSheetReferencePath)
      : TdxSpreadSheetCell;
  ...
  public
    ...
    procedure UpdateReferences(AFormula: TdxSpreadSheetCustomFormula;
      AView: TdxSpreadSheetTableView; const AArea: TRect;
      const ATargetOrigin: TPoint;
      AMode: TdxSpreadSheetFormulaUpdateReferencesMode); overload;
    procedure UpdateReferences(AView: TdxSpreadSheetTableView;
      const AArea: TRect; const ATargetOrigin: TPoint;
      AMode: TdxSpreadSheetFormulaUpdateReferencesMode); overload;
  ...
  protected
    ...
    function GetDragAndDropObjectClass(const ACursorPos: TPoint)
      : TcxDragAndDropObjectClass; virtual;
    function GetHitTest: TdxSpreadSheetCustomHitTest; virtual;
    function GetPopupMenuClass(const ACursorPos: TPoint)
      : TComponentClass; virtual;
  ...
  protected
    ...
    function ContainerProcessKeyDown(Key: Word; Shift: TShiftState)
      : Boolean; virtual;
    procedure FocusContainer(AContainer: TdxSpreadSheetContainer;
      AMakeVisible: Boolean); virtual;
    procedure MoveContainer(AContainer: TdxSpreadSheetContainer;
      ADeltaX, ADeltaY: Integer);
    procedure ResizeContainer(AContainer: TdxSpreadSheetContainer;
      ADeltaX, ADeltaY: Integer);
    procedure RotateContainer(AContainer: TdxSpreadSheetContainer;
      ADelta: Single);
  ...
  public
    ...
    property FocusedContainer: TdxSpreadSheetContainer read FFocusedContainer
      write SetFocusedContainer;
  ...
  protected
    ...
    function GetDragAndDropObjectClass: TcxDragAndDropObjectClass;
      overload; inline;
    function GetDragAndDropObjectClass(const P: TPoint)
      : TcxDragAndDropObjectClass; overload; inline;
  ...
  public
    ...
    property HitObject: TdxSpreadSheetCustomCellViewInfo read FHitObject
      write FHitObject;
    property HitObjectData: TdxNativeInt read FHitObjectData
      write FHitObjectData;
  ...
  TdxSpreadSheetCustomView = class(TdxSpreadSheetPersistentObject,
    IdxSpreadSheetViewCaption, IdxSpreadSheetObjectLink)
  strict private
    FCaption: string;
    FChanges: TdxSpreadSheetChanges;
    ...
    procedure SetVisible(AValue: Boolean);
    //
    procedure ScaleFactorChangeHandler(Sender: TObject; M, D: Integer;
      IsLoading: Boolean);
  protected
    ...
    property BoundsForRightToLeftConversion: TRect
      read GetBoundsForRightToLeftConversion;
    ...
    property FormatSettings: TdxSpreadSheetFormatSettings
      read GetFormatSettings;
    property IsDestroying: Boolean read GetIsDestroying;
    property IsLocked: Boolean read GetIsLocked;
    property LockCount: Integer read FLockCount;
    property Options: TdxSpreadSheetCustomViewOptions read FOptions
      write SetOptions;
    property ReferenceLinkHost: IdxSpreadSheetObjectLink read FReferenceLinkHost
      implements IdxSpreadSheetObjectLink;
  ...
  protected
    ...
    // Containers
    procedure CalculateContainerDependedCells(AContainerViewInfo
      : TdxSpreadSheetContainerViewInfo); virtual;
    procedure CalculateContainers; virtual;
    function CalculateContainersHitTest(AHitTest: TdxSpreadSheetCustomHitTest)
      : Boolean; virtual;
  ...
  public
    ...
    property Items[Index: Integer]: TdxSpreadSheetCustomView
  ...
  TdxSpreadSheetMergedCellListEnumCellsProc = reference to procedure
  ...
  public
    ...
    procedure Enum(AColumn1, AColumn2: Integer;
      AProc: TdxSpreadSheetMergedCellListEnumCellsProc); inline;
  ...
  protected
    procedure Initialize(AOwner: TdxSpreadSheetMergedCellList;
      const AArea: TRect);
  ...
  TdxSpreadSheetMergedCellListEnumRowsProc = reference to procedure
    (ARow: TdxSpreadSheetMergedCellsRow);
  ...
  protected
    ...
    procedure InitializeCell(ACell: TdxSpreadSheetMergedCell;
      const AArea: TRect);
    //
  ...
  public
    ...
    destructor Destroy; override;
    procedure Add(const AArea: TRect); reintroduce; overload;
    procedure Add(const AArea: string); reintroduce; overload;
    ...
    procedure DeleteItemsInArea(const AArea: TRect;
      AEnclosedItemsOnly: Boolean = True);
    procedure EnumCells(AProc
      : TdxSpreadSheetMergedCellListEnumCellsProc); overload;
    procedure EnumCells(const AArea: TRect;
      AProc: TdxSpreadSheetMergedCellListEnumCellsProc); overload;
    procedure EnumRows(AStartIndex, AFinishIndex: Integer;
      AProc: TdxSpreadSheetMergedCellListEnumRowsProc);
    function ExpandArea(const AArea: TRect): TRect; overload;
    function ExpandArea(const AColumn, ARow: Integer): TRect; overload;
    procedure Extract(const AArea: TRect;
      ADest: TList<TdxSpreadSheetMergedCell>); reintroduce; overload;
    ...
    property Items[Index: Integer]: TdxSpreadSheetMergedCell
      read GetItem; default;
  ...
  TdxSpreadSheetTableItemEnumProc = reference to procedure
    (ACell: TdxSpreadSheetCell);
  ...
  protected
    ...
    function MeasureCellSize(ACanvas: TcxCanvas; ACell: TdxSpreadSheetCell)
  ...
  TdxSpreadSheetTableItemGroupExpandButtonPosition = (gebpGroupStart,
    gebpGroupFinish);
  ...
  strict private
    ...
    function GetCount: Integer;
    function GetExpandButtonPosition
  ...
  public
    ...
    //
    procedure DeleteAll;
    function Find(AIndex: Integer; ARecursive: Boolean = True)
      : TdxSpreadSheetTableItemGroup;
    ...
    property Index: Integer read GetIndex;
    property Items[Index: Integer]: TdxSpreadSheetTableItemGroup
      read GetItem; default;
  ...
  TdxSpreadSheetTableItemGroupComparer = class(TInterfacedObject,
  ...
  strict private
    ...
    FLockCount: Integer;
  protected
    procedure Notify(const Item: TdxSpreadSheetTableItemGroup;
  ...
  strict private
    ...
    function GetCount: Integer;
    function GetItem(Index: Integer): TdxSpreadSheetTableItemGroup;
    procedure SetExpandButtonPosition
      (AValue: TdxSpreadSheetTableItemGroupExpandButtonPosition);
  protected
    procedure Validate;
    //
  ...
  public
    ...
    property ExpandButtonPosition
      : TdxSpreadSheetTableItemGroupExpandButtonPosition
      read FExpandButtonPosition write SetExpandButtonPosition
      default gebpGroupFinish;
    property Items[Index: Integer]: TdxSpreadSheetTableItemGroup
      read GetItem; default;
  end;
  ...
  strict private
    ...
    function GetSpreadSheet: TdxCustomSpreadSheet;
    procedure SetItem(AIndex: Integer; const AValue: TdxSpreadSheetTableItem);
    {$IFNDEF VER220} inline; {$ENDIF}
  protected
    ...
    function GetItemDisplayText(const AItem: TdxSpreadSheetTableItem)
      : string; virtual;
    ...
    function GetItemStyleHandle(AIndex: Integer)
      : TdxSpreadSheetCellStyleHandle; inline;
    ...
    function GetNextVisibleItemIndex(AIndex: Integer; AGoForward: Boolean;
      out AResult: Integer): Boolean; overload;
  ...
  public
    ...
    function GetItemIndexFromDistance(AStartIndex: Integer;
      ADistance: Integer): Integer;
    function GetNextVisibleItemIndex(AIndex: Integer; AGoForward: Boolean)
      : Integer; overload;
    ...
    property Items[Index: Integer]: TdxSpreadSheetTableItem read GetItem
  ...
  public
    function CreateItem(const AIndex: Integer)
      : TdxSpreadSheetTableColumn; overload;
    function CreateItem(const AName: string)
      : TdxSpreadSheetTableColumn; overload;
    //
    property Items[Index: Integer]: TdxSpreadSheetTableColumn
      read GetItem; default;
  end;
  ...
  protected
    ...
    procedure ForEachCell(AArea: TRect; AProc: TdxDynamicItemListForEachProcRef;
      AGoForward: Boolean = True);
    function GetDefaultSize: Integer; override;
    function GetFixedItemIndex: Integer; override;
    function GetItemClass: TdxDynamicListItemClass; override;
    function GetItemState(AIndex: Integer): TcxButtonState; override;
  ...
  public
    ...
    //
    property Items[Index: Integer]: TdxSpreadSheetTableRow
      read GetItem; default;
  end;
  ...
  strict private
    ...
    procedure SetHeaderFooter
      (AValue: TdxSpreadSheetTableViewOptionsPrintHeaderFooter);
    procedure SetPage(AValue: TdxSpreadSheetTableViewOptionsPrintPage);
    procedure SetPagination(AValue
  ...
  public
    ...
    procedure Reset;
  published
    property HeaderFooter: TdxSpreadSheetTableViewOptionsPrintHeaderFooter
      read FHeaderFooter write SetHeaderFooter;
    property Page: TdxSpreadSheetTableViewOptionsPrintPage read FPage
      write SetPage;
    property Pagination: TdxSpreadSheetTableViewOptionsPrintPagination
      read FPagination write SetPagination;
    property Printing: TdxSpreadSheetTableViewOptionsPrintPrinting
      read FPrinting write SetPrinting;
    property Source: TdxSpreadSheetTableViewOptionsPrintSource read FSource
      write SetSource;
  end;
  ...
  public
    ...
    property ActualHorizontalScrollBar: Boolean
      read GetActualHorizontalScrollBar;
  ...
  published
    ...
    property GridLines: TdxDefaultBoolean read FGridLines write SetGridLines
      default bDefault;
    property Headers: TdxDefaultBoolean read FHeaders write SetHeaders
      default bDefault;
    property HorizontalScrollBar: TdxDefaultBoolean read FHorizontalScrollBar
      write SetHorizontalScrollBar default bDefault;
    property Protected: Boolean read GetProtected write SetProtected
      stored False; // obsolete
    property RightToLeftLayout: TdxDefaultBoolean read FRightToLeftLayout
      write SetRightToLeftLayout default bDefault;
    property ShowFormulas: TdxDefaultBoolean read FShowFormulas
      write SetShowFormulas default bDefault;
    property VerticalScrollBar: TdxDefaultBoolean read FVerticalScrollBar
      write SetVerticalScrollBar default bDefault;
    property ZeroValues: TdxDefaultBoolean read FZeroValues write SetZeroValues
      default bDefault;
    property ZoomFactor: Integer read FZoomFactor write SetZoomFactor
      default dxSpreadSheetDefaultZoomFactor;
  end;
  ...
  public
    ...
    property HitAtContainerSelection: Boolean index hcContainerSelection
      read GetHitCode;
    property HitAtExpandButton: Boolean index hcExpandButton read GetHitCode;
    property HitAtFrozenPaneSeparator: Boolean index hcFrozenPaneSeparator
      read GetHitCode;
    ...
    property HitAtSelectionFrame: Boolean index hcSelectionFrame
      read GetHitCode;
    property View: TdxSpreadSheetTableView read GetView;
  end;
  ...
  protected
    ...
    procedure GetState(ARow, AColumn: Integer;
      var AFocused, ASelected: Boolean);
  ...
  public
    constructor Create(AOwner: TdxSpreadSheetTableView); virtual;
    destructor Destroy; override;
    procedure Add(AArea: TRect; AShift: TShiftState = [];
      AFocusedRow: Integer = -1; AFocusedColumn: Integer = -1);
    procedure Clear;
    ...
    procedure SelectColumns(AStartColumn, AFinishColumn: Integer;
      AShift: TShiftState = []);
    procedure SelectRows(AStartRow, AFinishRow: Integer;
      AShift: TShiftState = []);
    ...
    property Count: Integer read GetCount;
    property FocusedCell: TdxSpreadSheetCell read GetFocusedCell
      write SetFocusedCell;
  ...
  strict private
    ...
    function GetEditSize(const AText: string;
      ASizeProperties: TcxEditSizeProperties): TSize;
  ...
  protected
    ...
    function CreateReferenceHighlighter
      : TdxSpreadSheetCustomReferenceHighlighter; virtual;
    ...
    procedure EditKeyUp(Sender: TObject; var Key: Word;
      Shift: TShiftState); override;
    function GetAdjustedEditBoundsHorizontally(const AArea,
      ATextRect: TRect): TRect;
    function GetAdjustedEditBoundsVertically(const AArea,
      ATextRect: TRect): TRect;
    ...
    function GetValueFromCell(ACell: TdxSpreadSheetCell;
      AAllowRTF: Boolean = True): TcxEditValue;
    procedure HistoryChanged;
    procedure MultilineEditTextChanged; override;
    procedure SetValue(const AValue: TcxEditValue); override;
    procedure ShowEditWithTopCellValue(const ACurrentRow, ACurrentColumn
      : Integer; const AUseFormula: Boolean);
    ...
    property DefaultEditProperties: TcxCustomMemoProperties
      read FDefaultEditProperties;
    ...
    property ReferenceHighlighter: TdxSpreadSheetCustomReferenceHighlighter
      read FReferenceHighlighter;
    property ReplacementMode: Boolean read FReplacementMode
      write FReplacementMode;
  public
    constructor Create(AOwner: TdxSpreadSheetTableViewController);
      reintroduce; virtual;
    destructor Destroy; override;
    class function CanFinishEditingOnExit(AEdit: TcxCustomEdit): Boolean;
    class function GetActualInplaceEdit(ASheet: TdxSpreadSheetTableView;
      out AEdit: TdxSpreadSheetCustomInplaceEdit): Boolean;
    ...
    property CellViewInfo: TdxSpreadSheetTableViewCellViewInfo
      read GetCellViewInfo;
  ...
  TdxSpreadSheetTableViewCellHintController = class
    (TdxSpreadSheetViewPersistentObject)
  strict private
  ...
  protected
    function GetComment(ACellViewInfo: TdxSpreadSheetCellViewInfo)
      : TdxSpreadSheetContainer;
    function GetHyperlink(ACellViewInfo: TdxSpreadSheetCellViewInfo)
  ...
  strict private
    ...
    function IsColumnPartHasContent(const AColumn, AStartRow,
      AEndRow: Integer): Boolean;
    function IsRowPartHasContent(const ARow, AStartColumn,
    ...
    function GetTableItemsForNavigation(ADirection: TcxArrowDirection)
      : TdxSpreadSheetTableItems; inline;
    function GetView: TdxSpreadSheetTableView; inline;
    function GetViewHitTest: TdxSpreadSheetTableViewHitTest; inline;
    function GetViewInfo: TdxSpreadSheetTableViewInfo; inline;
    procedure SetSelectionModeField
      (AMode: TdxSpreadSheetTableViewSelectionMode);

    procedure SetForcedSelectionMode(const Value
      : TdxSpreadSheetTableViewSelectionMode);
  protected
    procedure ApplyBestFitForSelectedHeaderCells
      (ACells: TdxSpreadSheetCellViewInfoList);
    ...
    function CreateEditingController
      : TdxSpreadSheetTableViewEditingController; virtual;
    procedure DblClick; override;

    function CanFocusMergedCellsPart(const AArea: TRect;
      ACell: TdxSpreadSheetCell; AGoForward: Boolean): Boolean;
    procedure FocusContainer(AContainer: TdxSpreadSheetContainer;
      AMakeVisible: Boolean); override;
    procedure FocusNextPossibleCell(ADirection: TcxArrowDirection;
      AUnlockedCellsOnly: Boolean);
    function GetNextCellInDataBlock(AItem: TdxSpreadSheetTableItem;
      ACellIndex: Integer; AGoForward: Boolean): Integer;
    function GetNextColumn(AColumn: TdxSpreadSheetTableColumn;
      AGoForward: Boolean): TdxSpreadSheetTableColumn;
    function GetNextNonEmptyCell(AItems: TdxSpreadSheetTableItems;
      AFocusedItemIndex, AFocusedCellIndex: Integer;
      AGoForward: Boolean): Integer;
    function GetNextRow(ARow: TdxSpreadSheetTableRow; AGoForward: Boolean)
      : TdxSpreadSheetTableRow;
    function GetNextUnlockedCellByColumn(const AArea: TRect;
      AStartRow, AStartColumn: Integer; AGoForward: Boolean)
      : TdxSpreadSheetCell;
    function GetNextUnlockedCellByRow(const AArea: TRect;
      AStartRow, AStartColumn: Integer; AGoForward: Boolean)
      : TdxSpreadSheetCell;
    function GetNextVisibleCell(AIndex: Integer; ADirection: TcxArrowDirection)
      : Integer; overload;
    function GetNextVisibleCell(AIndex: Integer; ADirection: TcxArrowDirection;
      out AResult: Integer): Boolean; overload;
    function GetSearchAreaFirstColumn(const AArea: TRect)
      : TdxSpreadSheetTableColumn;
    function GetSearchAreaFirstRow(const AArea: TRect): TdxSpreadSheetTableRow;
    function GetSearchAreaLastColumn(const AArea: TRect)
      : TdxSpreadSheetTableColumn;
    function GetSearchAreaLastRow(const AArea: TRect): TdxSpreadSheetTableRow;
    procedure GetNextSelectedAreaCell(AIndex: Integer; AGoForward: Boolean;
      var ARow, AColumn: Integer);
    function GetNextSelectedAreaIndex(AIndex: Integer;
      AGoForward: Boolean): Integer;
    function GetSelectionAreaByFocusedCell(out ARect: TRect;
      out AIndex: Integer): Boolean;
    function GetSelectionItem(ASide: TcxBorder; AShift: TShiftState)
      : Integer; inline;
    function FindUnlockedCellByColumn(const AStartArea: TRect;
      const AStartIndex, AStartRow, AStartColumn: Integer; AGoForward: Boolean)
      : TdxSpreadSheetCell;
    function FindUnlockedCellByRow(const AStartArea: TRect;
      const AStartIndex, AStartRow, AStartColumn: Integer; AGoForward: Boolean)
      : TdxSpreadSheetCell;
    ...
    procedure DoMouseDownAtCellArea(Button: TMouseButton; Shift: TShiftState;
      X, Y: Integer); virtual;
    procedure DoMouseMove(Shift: TShiftState; X, Y: Integer); override;
    procedure DoMouseUp(Button: TMouseButton; Shift: TShiftState;
      X, Y: Integer); override;
    procedure DoMouseUpAtGroupingArea(Button: TMouseButton; Shift: TShiftState;
      X, Y: Integer); virtual;
    function DoMouseWheel(Shift: TShiftState; WheelDelta: Integer;
      const P: TPoint): Boolean; override;
    ...
    procedure SetFocused(ARow, AColumn: Integer; AShift: TShiftState);
    procedure SetSelectionMode(ARow, AColumn: Integer; AShift: TShiftState;
      AMode: TdxSpreadSheetTableViewSelectionMode);

    property CanClickOnTheCell: Boolean read FCanClickOnTheCell
      write FCanClickOnTheCell;
  ...
  public
    ...
    property CellHintController: TdxSpreadSheetTableViewCellHintController
      read FCellHintController;
    property Columns: TdxSpreadSheetTableColumns read GetColumns;
    property EditingController: TdxSpreadSheetTableViewEditingController
    ...
    property ForcedSelectionMode: TdxSpreadSheetTableViewSelectionMode
      read FForcedSelectionMode write SetForcedSelectionMode;
    // for internal use
    ...
    property MergedCells: TdxSpreadSheetMergedCellList read GetMergedCells;
    property OptionsBehavior: TdxSpreadSheetOptionsBehavior
      read GetOptionsBehavior;
    property Rows: TdxSpreadSheetTableRows read GetRows;
    property Selection: TdxSpreadSheetTableViewSelection read GetSelection;
    property SelectionMode: TdxSpreadSheetTableViewSelectionMode
      read FSelectionMode write SetSelectionModeField;
    property View: TdxSpreadSheetTableView read GetView;
    property ViewInfo: TdxSpreadSheetTableViewInfo read GetViewInfo;
  end;
  ...
  TdxSpreadSheetConditionalFormatting = class
  ...
  protected
    procedure DoChanged; override;
    procedure DoRuleAdded
      (ARule: TdxSpreadSheetCustomConditionalFormattingRule); override;
    procedure DoRuleChanging
      (ARule: TdxSpreadSheetCustomConditionalFormattingRule); override;
    procedure DoRuleIndexChanged(AOldIndex, ANewIndex: Integer); override;
    procedure DoRuleDeleted
      (ARule: TdxSpreadSheetCustomConditionalFormattingRule); override;
  ...
  TdxSpreadSheetCellCommentShowEvent = procedure(Sender: TdxSpreadSheetCell;
    ACommentContainer: TdxSpreadSheetContainer; var AHandled: Boolean)
    of object;

  TdxSpreadSheetTableViewClearCellsOption = (ccoValues, ccoHyperlinks,
    ccoComments, ccoStyles, ccoFreeCellInstances);
  TdxSpreadSheetTableViewClearCellsOptions = set of
    TdxSpreadSheetTableViewClearCellsOption;

  TdxSpreadSheetTableViewMergedCellsConflictResolution = (mccrShowConfirmation,
    mccrUnmergeAllAffectedCells, mccrRaiseException);

  TdxSpreadSheetTableView = class(TdxSpreadSheetCustomView,
    IdxSpreadSheetCellStyleOwner, IdxSpreadSheetConditionalFormatting,
    IdxSpreadSheetConditionalFormattingOwner, IdxSpreadSheetViewData,
    IdxSpreadSheetTableView)
  strict private
    ...
    function GetEditingController
      : TdxSpreadSheetTableViewEditingController; inline;
    function GetHistory: TdxSpreadSheetHistory;
    ...
    procedure SetOptionsProtection
      (AValue: TdxSpreadSheetSheetProtectionOptions);
  ...
  protected
    ...
    procedure StringToCellReference(const S: string;
      out ARow, AColumn: Integer);

    procedure AddArrayFormula(AFormula: TdxSpreadSheetFormula;
      const AArea: TRect); overload;
    procedure AddArrayFormula(AFormula: TdxSpreadSheetFormula;
      const AText: string; const AArea: TRect); overload;
    ...
    function CanModifyDataInArrayFormulaArea(AArea: TRect;
      AMode: TdxSpreadSheetCellsModificationMode): Boolean;
    procedure ClearCells(const AArea, AExcludedArea: TRect;
      AOptions: TdxSpreadSheetTableViewClearCellsOptions); overload;

    procedure CheckCopySelection;
    procedure CheckCutToClipboard;
    procedure CheckPasteSelection(const AClipboardArea: TRect;
      AMode: TdxSpreadSheetClipboardCopyMode);
    procedure CheckProtection
      (AMode: TdxSpreadSheetCellsModificationMode); overload;
    procedure CheckProtection(AMode: TdxSpreadSheetCellsModificationMode;
      const AArea: TRect); overload;

    procedure FillCells(ATopDown: Boolean);

    function GetActiveCell(const ARow, AColumn: Integer): TdxSpreadSheetCell;
    function GetArrayFormulaArea(const ASenderRowIndex, ASenderColumnIndex
      : Integer): TRect; inline;
    function GetTopCell(const ACurrentRow, ACurrentColumn: Integer)
      : TdxSpreadSheetCell;
    procedure PopulateAreaByValue(const AValue: Variant; const AArea: TRect);

    function GetCellsModification(const AArea: TRect; AIsDeletingMode: Boolean;
      out AModification: TdxSpreadSheetCellsModification): Boolean;
    function GetCellStyle(ARow, AColumn: Integer; ACell: TdxSpreadSheetCell)
      : TdxSpreadSheetCellStyle; inline;
    function GetCellStyleHandle(AMergedCell: TdxSpreadSheetMergedCell)
      : TdxSpreadSheetCellStyleHandle; overload; inline;
    function GetCellStyleHandle(ARow, AColumn: Integer)
      : TdxSpreadSheetCellStyleHandle; overload; inline;
    function GetCellStyleHandle(ARow, AColumn: Integer;
      ACell: TdxSpreadSheetCell): TdxSpreadSheetCellStyleHandle;
      overload; inline;
    function GetFactuallyModifiableArea(const AArea: TRect;
    ...
    function IdxSpreadSheetConditionalFormattingOwner.GetSelectionArea =
      GetConditionalFormattingSelectionArea;
    function IdxSpreadSheetConditionalFormattingOwner.IsRightToLeft =
      IsRightToLeftLayout;
    ...
    procedure ForEachCell(const AArea: TRect;
      AProc: TdxSpreadSheetViewForEachCellProc;
      AGoForward: Boolean = True); overload;
    ...
    function GetNextColumnWithNonEmptyCell(const ARow, AColumn: Integer;
      const AGoForward: Boolean = True): Integer;
    function GetNextRowWithNonEmptyCell(const ARow, AColumn: Integer;
      const AGoForward: Boolean = True): Integer;
    function IsRowVisible(const ARow: Integer): Boolean;
    procedure SetCellData(const ARow, AColumn: Integer; const AValue: Variant;
      const AErrorCode: TdxSpreadSheetFormulaErrorCode);
    ...
    function CreateConditionalFormatting
      : TdxSpreadSheetConditionalFormatting; virtual;
    ...
    function CreateOptionsProtection
      : TdxSpreadSheetSheetProtectionOptions; virtual;
    ...
    procedure DoCompare(const AData1, AData2: TdxSpreadSheetCellData;
      var Compare: Integer); virtual;
    procedure DoDataChanged; override;
    procedure DoEditChanged; virtual;
    procedure DoEdited; virtual;
    procedure DoEditing(var AProperties: TcxCustomEditProperties;
      var ACanEdit: Boolean); virtual;
    procedure DoEditValueChanged; virtual;
    procedure DoInitEdit(AEdit: TcxCustomEdit); virtual;
    procedure DoInitEditValue(AEdit: TcxCustomEdit;
    ...
    procedure ExchangeValues(ACell1, ACell2: TdxSpreadSheetCell);
      overload; virtual;
    procedure ExchangeValues(ARow1, AColumn1, ARow2, AColumn2: Integer);
      overload; virtual;
    function IsRightToLeftLayout: Boolean; override;
    procedure Pack; override;
    procedure PasteFromClipboardCore(AOptions
      : TdxSpreadSheetClipboardPasteOptions; const AViewGUID: string;
      const AClipboardArea: TRect;
      AClipboardCopyMode: TdxSpreadSheetClipboardCopyMode); virtual;
    ...
    property EditingController: TdxSpreadSheetTableViewEditingController
      read GetEditingController;
    property FormulaController: TdxSpreadSheetCustomFormulaController
      read GetFormulaController;
  ...
  public
    ...
    procedure CellAtPoint(const P: TPoint; out ARow, AColumn: Integer;
      AReturnNearestCell: Boolean = False;
      AVisibleAreaOnly: Boolean = True); overload;
    procedure CellAtPoint(const P: TPoint; out ACell: TdxSpreadSheetCell;
      AReturnNearestCell: Boolean = False;
      AVisibleAreaOnly: Boolean = True); overload;
    function CreateCell(const ACellReference: string)
      : TdxSpreadSheetCell; overload;
    function CreateCell(const ARow, AColumn: Integer): TdxSpreadSheetCell;
      overload; virtual;
    procedure GetCellValue(ARow, AColumn: Integer; var AValue: Variant;
    ...
    procedure ClearCells(const AArea: TRect; AClearValues: Boolean = True;
      AClearFormats: Boolean = True); overload; virtual;
    procedure ClearCells(const AArea: TRect;
      AOptions: TdxSpreadSheetTableViewClearCellsOptions); overload;
    procedure ClearCells(const AArea: string; AClearValues: Boolean = True;
      AClearFormats: Boolean = True); overload;
    procedure ClearCells(const AArea: string;
      AOptions: TdxSpreadSheetTableViewClearCellsOptions); overload;
    procedure ClearCellValues;

    function CanDelete: Boolean; overload; virtual;
    function CanDelete(AModification: TdxSpreadSheetCellsModification): Boolean;
      overload; virtual;
    procedure DeleteAllCells;
    procedure DeleteCells; overload; virtual;
    procedure DeleteCells(const AArea: TRect;
      AModification: TdxSpreadSheetCellsModification;
      AMergedCellsConflictResolution
      : TdxSpreadSheetTableViewMergedCellsConflictResolution =
      mccrShowConfirmation); overload; virtual;
    procedure DeleteCells(const AArea: string;
      AModification: TdxSpreadSheetCellsModification;
      AMergedCellsConflictResolution
      : TdxSpreadSheetTableViewMergedCellsConflictResolution =
      mccrShowConfirmation); overload;
    ...
    procedure FillData(const ASourceArea: string; ADirection: TcxDirection;
      ACount: Integer); overload;
    procedure FillData(const ASourceArea: TRect; ADirection: TcxDirection;
      ACount: Integer); overload; virtual;

    procedure AddArrayFormula(const AText: string; const AArea: TRect);
      overload;
    procedure AddArrayFormula(const AText: string;
      const AArea: string); overload;
    function CanModifyDataInArea(const AArea: TRect;
      const AMode: TdxSpreadSheetCellsModificationMode): Boolean; overload;
    function CanModifyDataInArea(const AArea: string;
      const AMode: TdxSpreadSheetCellsModificationMode): Boolean; overload;

    procedure ForEachCell
      (AProc: TdxSpreadSheetTableViewForEachCellProc); overload;
    procedure ForEachCell(const AArea: TRect;
      AProc: TdxSpreadSheetTableViewForEachCellProc;
      AGoForward: Boolean = True); overload;
    procedure ForEachCell(const AArea: string;
      AProc: TdxSpreadSheetTableViewForEachCellProc;
      AGoForward: Boolean = True); overload;
    ...
    function CanInsert(AModification: TdxSpreadSheetCellsModification): Boolean;
      overload; virtual;
    function CanInsertCells(AArea: TRect;
      const AModification: TdxSpreadSheetCellsModification): Boolean; overload;
    function CanInsertCells(const AArea: string;
      const AModification: TdxSpreadSheetCellsModification): Boolean; overload;
    procedure InsertCells; overload; virtual;
    procedure InsertCells(const AArea: TRect;
      AModification: TdxSpreadSheetCellsModification;
      AMergedCellsConflictResolution
      : TdxSpreadSheetTableViewMergedCellsConflictResolution =
      mccrShowConfirmation); overload; virtual;
    procedure InsertCells(const AArea: string;
      AModification: TdxSpreadSheetCellsModification;
      AMergedCellsConflictResolution
      : TdxSpreadSheetTableViewMergedCellsConflictResolution =
      mccrShowConfirmation); overload;
    ...
    function CanPasteFromClipboard(AOptions
      : TdxSpreadSheetClipboardPasteOptions): Boolean; overload; virtual;
    procedure CopyToClipboard; virtual;
    procedure CutToClipboard; virtual;
    procedure PasteFromClipboard; overload; virtual;
    procedure PasteFromClipboard(AOptions: TdxSpreadSheetClipboardPasteOptions);
      overload; virtual;

    procedure CopyCellDataToStream(const AArea: TRect;
      AStream: TStream); overload;
    procedure CopyCellDataToStream(const AArea: string;
      AStream: TStream); overload;
    procedure PasteCellDataFromStream(const ADestination: TPoint;
      AStream: TStream);
    ...
    procedure SortByColumnValues(const AArea: string;
      const ASortOrders: array of TdxSortOrder;
      const AColumns: array of Integer); overload;
    procedure SortByColumnValues(const AArea: TRect;
      const ASortOrders: array of TdxSortOrder;
      const AColumns: array of Integer); overload;
    procedure SortByRowValues(const AArea: string;
      const ASortOrders: array of TdxSortOrder;
      const ARows: array of Integer); overload;
    procedure SortByRowValues(const AArea: TRect;
      const ASortOrders: array of TdxSortOrder;
      const ARows: array of Integer); overload;
    ...
    property FrozenColumn: Integer read FFrozenColumn write SetFrozenColumn
      default -1;
    ...
    property ConditionalFormatting: TdxSpreadSheetConditionalFormatting
      read FConditionalFormatting;
    ...
    property Options: TdxSpreadSheetTableViewOptions read GetOptions
      write SetOptions;
    property OptionsPrint: TdxSpreadSheetTableViewOptionsPrint
      read FOptionsPrint write SetOptionsPrint;
    property OptionsProtection: TdxSpreadSheetSheetProtectionOptions
      read FOptionsProtection write SetOptionsProtection;
  end;
  ...
  protected
    procedure BufferedDraw(ACanvas: TcxCanvas; const R: TRect;
      AProc: TDrawProc);
  public
    procedure FlushCache; override;
    // Grouping
    procedure DrawGroupExpandButton(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState; AVertical, AExpanded: Boolean); virtual;
    procedure DrawGroupLevelExpandButton(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState; ALevel: Integer); virtual;
  ...
  strict private
    ...
    procedure AddOutOfBoundsNonEmptyCell(ARow: TdxSpreadSheetTableRow;
      AIndex: Integer; const ABounds: TRect; AGoForward: Boolean);
    function CalculatePrevPageFirstIndex(APosition: Integer;
      AIsHorizontal: Boolean): Integer; overload;
    function CalculatePrevPageFirstIndex(APosition, ASize, AFixedIndex: Integer;
      AItems: TdxSpreadSheetTableItems): Integer; overload;
    ...
    function RemoveNeighborCellBorder(ASide: TcxBorder;
      AIndex, AStartIndex, AFinishIndex: Integer; var AEndPos: Integer)
      : Boolean; inline;
    procedure SetFirstScrollableColumn(AValue: Integer);
    procedure SetFirstScrollableRow(AValue: Integer);
  protected
    procedure AddCell(ARow: TdxSpreadSheetTableRow;
      ARowIndex, AColumnIndex: Integer; const ABounds: TRect); virtual;
    ...
    procedure AddPageBreakHorz(const ARowIndex: Integer;
      const APrintArea: TRect); virtual;
    procedure AddPageBreakVert(const AColumnIndex: Integer;
      const APrintArea: TRect); virtual;
    ...
    procedure CalculateContainerDependedCells(AContainerViewInfo
      : TdxSpreadSheetContainerViewInfo); override;
    ...
    procedure CalculateLastItemIndex(ASize, AStartIndex, AFixedIndex,
      AFirstScrollableIndex, AMaxIndex: Integer;
      AItems: TdxSpreadSheetTableItems; var ASeparatorPosition,
      ALastIndex: Integer; ASeparatorPositionOffset: Integer);
    ...
    function CreateCellViewInfo(ACell: TdxSpreadSheetCell)
      : TdxSpreadSheetTableViewCellViewInfo; virtual;
    function CreateMergedCellViewInfo(AMergedCell: TdxSpreadSheetMergedCell)
      : TdxSpreadSheetTableViewMergedCellViewInfo; virtual;
    ...
    procedure DrawPart(ACanvas: TcxCanvas; const AOffset: TPoint;
      const AClipRect: TRect); virtual;
    ...
    procedure GetCellAtPoint(P: TPoint; out ARow, AColumn: Integer;
    ...
    function GetNeighborCellStyle(ARow, AColumn: Integer; ASide: TcxBorder;
      ADisplayStyle, ACheckVisibleNeighborsOnly: Boolean)
    ...
    procedure PostProcessRowCells(ARow: TdxSpreadSheetTableRow;
      AStartIndex, AFinishIndex: Integer);
    ...
    procedure ValidateBounds(AStartIndex, AFinishIndex, AFixedIndex,
      ASeparatorPosition: Integer; var AStart, AFinish: Integer);
  public
    constructor Create(AView: TdxSpreadSheetCustomView); override;
    destructor Destroy; override;
    ...
    function GetAreaBounds(ARow, AColumn: Integer;
      const AArea, ACellBounds: TRect): TRect; overload;
    function GetAreaBounds(const AArea: TRect): TRect; overload;
    function GetCellBounds(const ARow, AColumn: Integer): TRect; overload;

    property BackgroundCells: TdxSpreadSheetCellViewInfoList
      read FBackgroundCells;
    ...
    property DefaultCellStyleHandle: TdxSpreadSheetCellStyleHandle
      read FDefaultCellStyleHandle;
    property FirstColumnOrigin: Integer read FFirstColumnOrigin;
    property FirstRowOrigin: Integer read FFirstRowOrigin;
    property FirstScrollableColumn: Integer read GetFirstScrollableColumn
      write SetFirstScrollableColumn;
    property FirstScrollableColumnOffset: Integer
      read FFirstScrollableColumnOffset;
    property FirstScrollableRow: Integer read GetFirstScrollableRow
      write SetFirstScrollableRow;
    property FirstScrollableRowOffset: Integer read FFirstScrollableRowOffset;
    property FocusedCell: TdxSpreadSheetTableViewCellViewInfo
      read GetFocusedCell;
    property FrozenColumn: Integer read GetFrozenColumn;
    property FrozenColumnSeparatorPosition: Integer
      read FFrozenColumnSeparatorPosition;
    property FrozenRow: Integer read GetFrozenRow;
    property FrozenRowSeparatorPosition: Integer
      read FFrozenRowSeparatorPosition;
    property GridLineColor: TColor read FGridLineColor;
    property GroupingAreaLeft: TdxSpreadSheetTableViewCustomGroupingAreaViewInfo
      read FGroupingAreaLeft;
    property GroupingAreas: TdxSpreadSheetCellViewInfoList read FGroupingAreas;
    property GroupingAreaTop: TdxSpreadSheetTableViewCustomGroupingAreaViewInfo
      read FGroupingAreaTop;
    ...
    property LookAndFeelPainter: TcxCustomLookAndFeelPainter
      read GetLookAndFeelPainter;
    property MergedCells: TdxSpreadSheetTableViewMergedCellViewInfoList
      read FMergedCells;
    property Options: TdxSpreadSheetTableViewOptions read GetOptions;
    property OptionsView: TdxSpreadSheetOptionsView read GetOptionsView;
  ...
  protected
    ...
    property Formula: TdxSpreadSheetDefinedNameFormula read FFormula
      write SetFormula;
    property History: TdxSpreadSheetHistory read GetHistory;
  public
    destructor Destroy; override;
    ...
    function IsCellReference(out AArea: TRect;
      out AView: TdxSpreadSheetCustomView): Boolean; overload; virtual;
  ...
  protected
    ...
    procedure CheckForDuplicates(const ACaption: string;
      AScope: TdxSpreadSheetCustomView = nil);
    ...
    function DoCreateItem(const ACaption, AReference: string;
      AScope: TdxSpreadSheetCustomView): TdxSpreadSheetDefinedName;
    procedure DoChangeCaption(AName: TdxSpreadSheetDefinedName;
    ...
    function Find(const ACaption: string; AScope: TdxSpreadSheetCustomView;
      AScopeMaybeEmpty: Boolean; out AItem: TdxSpreadSheetDefinedName)
      : Boolean; inline;
  ...
  public
    ...
    function Add(const ACaption, AReference: string;
    ...
    procedure AddFromSelection(AView: TdxSpreadSheetTableView;
      const ASelectedArea: TRect; AHeaders: TcxBorders); overload;
    procedure AddFromSelection(AView: TdxSpreadSheetTableView;
      ASelectedAreas: TdxRectList; AHeaders: TcxBorders); overload;
    function AddFromStream(AReader: TcxReader): TdxSpreadSheetDefinedName;
    function AddOrSet(const ACaption, AReference: string;
      AScope: TdxSpreadSheetCustomView = nil): TdxSpreadSheetDefinedName;
    function Contains(const ACaption: string;
      AScope: TdxSpreadSheetCustomView): Boolean;
    function GetItemByName(const ACaption: string;
      AScope: TdxSpreadSheetCustomView): TdxSpreadSheetDefinedName;
    function IndexOf(const ACaption: string): Integer; overload;
    function IndexOf(const ACaption: string; AScope: TdxSpreadSheetCustomView)
      : Integer; overload;
    procedure Remove(AItem: TdxSpreadSheetObjectListItem); override;

    property Items[Index: Integer]: TdxSpreadSheetDefinedName
  ...
  public
    ...
    property Items[Index: Integer]: TdxSpreadSheetExternalLink
      read GetItem; default;
  end;
  ...
  protected
    function CreateProgressHelper: TdxSpreadSheetCustomFilerProgressHelper;
      virtual; abstract;
    procedure DoError(const AMessage: string;
      AType: TdxSpreadSheetMessageType); overload;
    procedure DoError(const AFormatString: string;
      const AArguments: array of const;
      AType: TdxSpreadSheetMessageType); overload;
    procedure DoProgress(AProgress: Integer);
    procedure ExecuteSubTask(ASubTask: TdxSpreadSheetCustomFilerSubTask);
    //
    property ProgressHelper: TdxSpreadSheetCustomFilerProgressHelper
      read FProgressHelper;
  public
    constructor Create(AOwner: TdxCustomSpreadSheet; AStream: TStream);
      reintroduce; virtual;
    destructor Destroy; override;
    //
    property IgnoreMessages: TdxSpreadSheetMessageTypes read FIgnoreMessages
      write FIgnoreMessages;
    property InvariantFormatSettings: TFormatSettings
      read FInvariantFormatSettings;
    property Stream: TStream read FStream;
    property StreamAutoFree: Boolean read FStreamAutoFree write FStreamAutoFree;
    //
    property OnProgress: TdxSpreadSheetProgressEvent read FOnProgress
      write FOnProgress;
  end;
  ...
  protected
    procedure DoError(const AFormatString: string;
      const AArguments: array of const;
      AType: TdxSpreadSheetMessageType); overload;
    procedure DoError(const AMessage: string; AType: TdxSpreadSheetMessageType);
      overload; inline;
    procedure ExecuteSubTask(ASubTask
      : TdxSpreadSheetCustomFilerSubTask); inline;
  public
  ...
  strict private
    function GetCellStyles: TdxSpreadSheetCellStyles; {$IFNDEF VER220} inline;
    {$ENDIF}
    function GetStringTable: TdxSpreadSheetSharedStringTable; inline;
  protected
    function AddBorders(ABordersHandle: TdxSpreadSheetBordersHandle)
      : TdxSpreadSheetBordersHandle;
    function AddBrush(ABrushHandle: TdxSpreadSheetBrushHandle)
      : TdxSpreadSheetBrushHandle;
    function AddCellStyle(AStyleHandle: TdxSpreadSheetCellStyleHandle)
      : TdxSpreadSheetCellStyleHandle;
    function AddFont(AFontHandle: TdxSpreadSheetFontHandle)
      : TdxSpreadSheetFontHandle;
    function AddFormattedSharedString(S: TdxSpreadSheetFormattedSharedString)
      : TdxSpreadSheetFormattedSharedString;
    function AddImage(const AStream: TStream): TdxSpreadSheetSharedImageHandle;
    function AddNumberFormat(const AFormatCode: string; ID: Integer = -1)
    ...
    procedure Check(AValue: Boolean; const AMessage: string;
      AMessageType: TdxSpreadSheetMessageType = ssmtError);

    function CreateTempCellStyle(AFont: TdxSpreadSheetFontHandle;
      AFormat: TdxSpreadSheetFormatHandle; AFill: TdxSpreadSheetBrushHandle;
      ABorders: TdxSpreadSheetBordersHandle): TdxSpreadSheetCellStyleHandle;
    ...
    function CreateTempFormattedSharedString(const S: string)
      : TdxSpreadSheetFormattedSharedString;
  ...
  public
    ...
    class function CreateReader(ASpreadSheet: TdxCustomSpreadSheet;
      AStream: TStream): TdxSpreadSheetCustomReader; virtual;
    class function CreateWriter(ASpreadSheet: TdxCustomSpreadSheet;
      AStream: TStream): TdxSpreadSheetCustomWriter; virtual;
  ...
  public
    constructor Create;
    destructor Destroy; override;
    function Find(const AFileName: string;
      out AFormat: TdxSpreadSheetCustomFormatClass): Boolean;
    ...
    property Items[Index: Integer]: TdxSpreadSheetCustomFormatClass
      read GetItem; default;
  end;
  ...
  TdxSpreadSheetCustomCellBasedDragAndDropObject = class
    (TdxSpreadSheetCustomDragAndDropObject)
  protected
    FTableViewIntf: IdxSpreadSheetTableView;

    procedure BeforeBeginDragAndDrop; override;
    function EnsureCellInArea(const ACellRef: TPoint;
      const AArea: TRect): TPoint;
    function GetAbsoluteCellBounds(const ARowIndex, AColumnIndex: Integer;
      ACheckMergedCells: Boolean = True): TRect;
    function GetCellAtAbsolutePoint(const P: TPoint): TPoint; overload;
    function GetCellAtAbsolutePoint(const P: TPoint;
      out ARowIndex, AColumnIndex: Integer): Boolean; overload; virtual;
  ...
  protected
    ...
    function CanDraw(ACanvas: TcxCanvas; AStage: TdxSpreadSheetDrawingStage)
      : Boolean; virtual;
    procedure DoDraw(ACanvas: TcxCanvas); virtual;
    function GetDragAndDropObjectClass(AHitTest: TdxSpreadSheetCustomHitTest)
      : TcxDragAndDropObjectClass; virtual;
    function GetPopupMenuClass(AHitTest: TdxSpreadSheetCustomHitTest)
      : TComponentClass; virtual;
    function GetSpreadSheet: TdxCustomSpreadSheet; virtual; abstract;
    function InitHitTest(AHitTest: TdxSpreadSheetCustomHitTest)
      : Boolean; virtual;
    //
    property Owner: TObject read FOwner;
  public
    ...
    procedure Draw(ACanvas: TcxCanvas;
      AStage: TdxSpreadSheetDrawingStage); virtual;
  ...
  TdxSpreadSheetCellViewInfo = class(TdxSpreadSheetCustomCellViewInfo,
    IcxHintableObject)
  strict private
  ...
  public
    ...
    procedure Draw(ACanvas: TcxCanvas;
      AStage: TdxSpreadSheetDrawingStage); override;
    procedure Invalidate; virtual;
  ...
  TdxSpreadSheetTableViewAbstractCellViewInfo = class
    (TdxSpreadSheetViewAbstractCellViewInfo)
  strict private
  ...
  protected
    procedure CalculateCore(ASelection
      : TdxSpreadSheetTableViewSelection); virtual;
  public
  ...
  TdxSpreadSheetCustomReferenceHighlighter = class
    (TdxSpreadSheetCustomCellViewInfo)
  public
    procedure Calculate(const AEdit: TcxCustomEdit); overload; virtual;
      abstract;
    procedure Calculate(const AFormulaText: string); overload; virtual;
      abstract;
  ...
  public
    ...
    function CalculateHitTest(AHitTest: TdxSpreadSheetCustomHitTest;
      AReverse: Boolean = False): Boolean;
    procedure Clear; override;
    procedure Draw(ACanvas: TcxCanvas); overload;
    procedure Draw(ACanvas: TcxCanvas;
      AStage: TdxSpreadSheetDrawingStage); overload;
    function Find(AItemOwner: TObject; out AItem;
      AIndex: PInteger = nil): Boolean;
    procedure Offset(X, Y: Integer);
    procedure RightToLeftConversion(const AClientBounds: TRect);
    procedure UpdateState;

    property Items[Index: Integer]: TdxSpreadSheetCellViewInfo
      read GetItem; default;
  end;
  ...
  TdxSpreadSheetTableViewGroupCustomExpandButtonViewInfo = class
    (TdxSpreadSheetTableViewAbstractCellViewInfo)
  strict private
  ...
  TdxSpreadSheetTableViewGroupLevelExpandButtonViewInfo = class
    (TdxSpreadSheetTableViewGroupCustomExpandButtonViewInfo)
  strict private
    FLevel: Integer;
  ...
  TdxSpreadSheetTableViewGroupViewInfo = class
    (TdxSpreadSheetTableViewGroupCustomExpandButtonViewInfo)
  strict private
  const
    Thickness = 2;
  ...
  TdxSpreadSheetTableViewCustomGroupingAreaViewInfoClass = class of
    TdxSpreadSheetTableViewCustomGroupingAreaViewInfo;
  ...
  protected
    ...
    procedure AddGroupCell(ACell: TdxSpreadSheetTableViewGroupViewInfo;
      const ABounds: TRect);
    procedure AddGroupLevelExpandButtonCell(ALevel: Integer;
      const ABounds: TRect);
    ...
    procedure CalculateGroupChildren(AGroup: TdxSpreadSheetTableItemGroup;
      const AAreaBounds: TRect; AAreaStartIndex, AAreaFinishIndex: Integer);
    function CalculateGroupLevelMarkBounds(const AAreaBounds: TRect;
      AStartIndex, AIndex: Integer): TRect; virtual; abstract;
    procedure CalculateGroupLevelMarks(AGroup: TdxSpreadSheetTableItemGroup;
      const AAreaBounds: TRect); virtual;
  ...
  TdxSpreadSheetTableViewColumnsGroupingAreaViewInfo = class
    (TdxSpreadSheetTableViewCustomGroupingAreaViewInfo)
  protected
    procedure CalculateGroup(AGroup: TdxSpreadSheetTableItemGroup;
      const AAreaBounds: TRect; AAreaStartIndex, AAreaFinishIndex
      : Integer); override;
    function CalculateGroupLevelMarkBounds(const AAreaBounds: TRect;
      AStartIndex, AIndex: Integer): TRect; override;
  ...
  TdxSpreadSheetTableViewRowsGroupingAreaViewInfo = class
    (TdxSpreadSheetTableViewCustomGroupingAreaViewInfo)
  protected
    procedure CalculateGroup(AGroup: TdxSpreadSheetTableItemGroup;
      const AAreaBounds: TRect; AAreaStartIndex: Integer;
      AAreaFinishIndex: Integer); override;
    function CalculateGroupLevelMarkBounds(const AAreaBounds: TRect;
      AStartIndex, AIndex: Integer): TRect; override;
    procedure CalculateGroupLevelsExpandButtons; override;
    procedure CalculateGroups; override;
  ...
  protected
    ...
    function CreateSelectionViewInfo
      : TdxSpreadSheetContainerSelectionCellViewInfo; virtual;
    procedure DoCalculate; override;
    procedure DoDraw(ACanvas: TcxCanvas); override;
    function DoInitHitTest(const P: TPoint;
      AHitTest: TdxSpreadSheetCustomHitTest): Boolean; virtual;
    ...
    function GetDragAndDropObjectClass(AHitTest: TdxSpreadSheetCustomHitTest)
      : TcxDragAndDropObjectClass; override;
    function GetPopupMenuClass(AHitTest: TdxSpreadSheetCustomHitTest)
      : TComponentClass; override;
  ...
  public
    ...
    procedure Invalidate; override;
    function GetCursor(AHitTest: TdxSpreadSheetCustomHitTest): TCursor;
      override;
    ...
    property CanDrawSelection: Boolean read FCanDrawSelection
      write FCanDrawSelection;
    ...
    property Selection: TdxSpreadSheetContainerSelectionCellViewInfo
      read FSelection;
    property Transform: TdxSpreadSheetContainerTransform read GetTransform;
  ...
  TdxSpreadSheetContainerCustomDragAndDropObject = class
    (TdxSpreadSheetCustomCellBasedDragAndDropObject)
  strict private
    FBounds: TRect;
    FContentRect: TRect;
  ...
  protected
    ...
    function GetSizeMarkerAtLocalPoint(const ALocalPoint: TPoint;
      out AMarker: TdxSpreadSheetSizingMarker): Boolean;
    function GetSizeMarkerRect(AMarker: TdxSpreadSheetSizingMarker)
      : TRect; virtual;
    function GetSpreadSheet: TdxCustomSpreadSheet; override;
    function InitHitTest(AHitTest: TdxSpreadSheetCustomHitTest)
      : Boolean; override;
  ...
  public
    constructor Create(AContainerViewInfo: TdxSpreadSheetContainerViewInfo);
      reintroduce; virtual;
    ...
    procedure RightToLeftConversion(const AClientBounds: TRect); override;
    //
    property ContainerViewInfo: TdxSpreadSheetContainerViewInfo
      read FContainerViewInfo;
    ...
    property SizeMarkerRect[Marker: TdxSpreadSheetSizingMarker]: TRect
      read GetSizeMarkerRect;
    property SizeMarkersArea: TRect read FSizeMarkersArea;
  end;

  { TdxSpreadSheetResizeTableItemDragAndDropObject }

  TdxSpreadSheetResizeTableItemDragAndDropObject = class
    (TdxSpreadSheetCustomDragAndDropObject)
  strict private
  ...
  protected
    ...
    function GetResizeArea(const AResizeAreaSize: Integer): TRect;
      virtual; abstract;
    function GetTextColor: TColor; virtual;
    procedure Initialize(AItem: TdxSpreadSheetTableItem; AIndex: Integer;
      ANeighbors: TcxNeighbors; const ADisplayText: string); virtual;
    function InitHitTest(AHitTest: TdxSpreadSheetCustomHitTest)
      : Boolean; override;
    procedure UpdateState; override;
  ...
  TdxSpreadSheetTableViewColumnHeaderCellViewInfo = class
    (TdxSpreadSheetTableViewHeaderCellViewInfo)
  protected
  ...
  TdxSpreadSheetTableViewHeaderCornerCellViewInfo = class
    (TdxSpreadSheetTableViewColumnHeaderCellViewInfo)
  public
    function GetCursor(AHitTest: TdxSpreadSheetCustomHitTest): TCursor;
      override;
  ...
  TdxSpreadSheetTableViewCellDisplayStyle = class
  ...
  TdxSpreadSheetTableViewCustomDataCellViewInfo = class
    (TdxSpreadSheetTableViewCustomCellViewInfo)
  protected
    ...
    procedure CalculateDisplayTextParameters(const R: TRect;
      ACell: TdxSpreadSheetCell); virtual;
    function CreateStyleViewInfo
      : TdxSpreadSheetConditionalFormattingStyleViewInfo; virtual;
    procedure DoCalculate; override;
    procedure DoDraw(ACanvas: TcxCanvas); override;
  ...
  public
    ...
    property StyleViewInfo: TdxSpreadSheetConditionalFormattingStyleViewInfo
      read FStyleViewInfo;
  ...
  protected
    ...
    procedure MergeBorder(ASide: TcxBorder;
      ANeighborStyle: TdxSpreadSheetCellStyleHandle);
    procedure RemoveBorder(ASide: TcxBorder); inline;
    procedure SetBorderStyle(ASide: TcxBorder;
      AStyle: TdxSpreadSheetCellBorderStyle; AColor: TColor);
  ...
  public
    ...
    function GetCursor(AHitTest: TdxSpreadSheetCustomHitTest): TCursor;
      override;
    procedure Offset(X: Integer; Y: Integer); override;
    procedure SetBounds(const AAbsoluteBounds, AScreenClipRect: TRect);
      override;
    procedure RightToLeftConversion(const AClientBounds: TRect); override;

    property BorderColor[ASide: TcxBorder]: TColor read GetBorderColor;
    property BorderStyle[ASide: TcxBorder]: TdxSpreadSheetCellBorderStyle
      read GetBorderStyle;
    ...
    property MergedCell: TdxSpreadSheetTableViewMergedCellViewInfo
      read FMergedCell;
  ...
  public
    ...
    procedure Clear; override;
    function FindItemForCell(ACell: TdxSpreadSheetCell;
      out AViewInfo: TdxSpreadSheetTableViewCellViewInfo): Boolean; overload;
    function FindItemForCell(ARow, AColumn: Integer;
      out AViewInfo: TdxSpreadSheetTableViewCellViewInfo): Boolean; overload;
    //
    property Items[Index: Integer]: TdxSpreadSheetTableViewCellViewInfo
      read GetItem; default;
  end;
  ...
  protected
    ...
    procedure UpdateSupportedDrawingStages; virtual;
  public
    constructor Create(AViewInfo: TdxSpreadSheetTableViewInfo;
      ACell: TdxSpreadSheetMergedCell); reintroduce; virtual;
  ...
  TdxSpreadSheetTableViewMergedCellViewInfoList = class
    (TdxSpreadSheetCellViewInfoList)
  strict private
    FIndex: TDictionary<TdxSpreadSheetMergedCell,
      TdxSpreadSheetTableViewMergedCellViewInfo>;

    function GetItem(Index: Integer)
      : TdxSpreadSheetTableViewMergedCellViewInfo; inline;
  public
    constructor Create;
    destructor Destroy; override;
    procedure Add(AViewInfo: TdxSpreadSheetCellViewInfo); override;
    ...
    function TryGetValue(ACell: TdxSpreadSheetMergedCell;
      out AViewInfo: TdxSpreadSheetTableViewMergedCellViewInfo)
      : Boolean; inline;
    //
    property Items[Index: Integer]: TdxSpreadSheetTableViewMergedCellViewInfo
      read GetItem; default;
  end;

  { TdxSpreadSheetTableViewFrozenPaneSeparatorCellViewInfo }

  TdxSpreadSheetTableViewFrozenPaneSeparatorCellViewInfo = class
    (TdxSpreadSheetTableViewCustomCellViewInfo)
  strict private
    FColor: TColor;
  protected
  ...
  TdxSpreadSheetPageControlBackgroundCellViewInfo = class
    (TdxSpreadSheetCellViewInfo)
  strict private
    FState: TcxButtonState;
    FViewParams: TcxViewParams;
  ...
  TdxSpreadSheetPageControlButtonCellViewInfo = class
    (TdxSpreadSheetPageControlBackgroundCellViewInfo)
  strict private
  ...
  protected
    ...
    procedure Initialize(const ABounds, AClipRect: TRect;
      AType: TdxSpreadSheetPageControlButton);
    procedure UpdateState; override;
  public
    property State;
  ...
  TdxSpreadSheetPageControlTabCellViewInfo = class
    (TdxSpreadSheetPageControlBackgroundCellViewInfo)
  protected
    FTextFlags: Integer;
    FView: TdxSpreadSheetCustomView;
    ...
    class function GetMeasureTextSize(AActive: Boolean; const AFont: TFont;
      const AText: string): TSize; virtual;
  ...
  TdxSpreadSheetPageControlSplitterCellViewInfo = class
    (TdxSpreadSheetPageControlBackgroundCellViewInfo)
  protected
    procedure DoDraw(ACanvas: TcxCanvas); override;
    function GetDragAndDropObjectClass(AHitTest: TdxSpreadSheetCustomHitTest)
  ...
  TdxSpreadSheetPageControlSplitterDragAndDropObject = class
  ...
  protected
    ...
    procedure DoMouseDown(Button: TMouseButton; Shift: TShiftState;
      X, Y: Integer); override;
    procedure DoMouseClickAtButton(AButton: TMouseButton; X, Y: Integer;
      AButtonViewInfo: TdxSpreadSheetPageControlButtonCellViewInfo); virtual;
    procedure DoMouseClickAtTab(AButton: TMouseButton; X, Y: Integer;
      ATabViewInfo: TdxSpreadSheetPageControlTabCellViewInfo); virtual;
    procedure UpdateStates; override;
  public
    property HitTest: TdxSpreadSheetPageControlHitTest
      read GetPageControlHitTest;
    property PageControl: TdxSpreadSheetPageControl read GetPageControl;
    property PressedObject: TdxSpreadSheetCellViewInfo read FPressedObject
      write SetPressedObject;
  end;
  ...
  protected
    ...
    procedure AddButton(var R: TRect;
      AType: TdxSpreadSheetPageControlButton); virtual;
    procedure AddPageTab(var R: TRect;
      APage: TdxSpreadSheetCustomView); virtual;
    function CreateSplitterCellViewInfo
      : TdxSpreadSheetPageControlSplitterCellViewInfo; virtual;
    function CreateTabCellViewInfo
      : TdxSpreadSheetPageControlTabCellViewInfo; virtual;
    function FindTabViewInfo(AView: TdxSpreadSheetCustomView;
      out ATabViewInfo: TdxSpreadSheetPageControlTabCellViewInfo): Boolean;
    procedure RightToLeftConversion(const AClientBounds: TRect); virtual;
  ...
  public
    ...
    property VisiblePages[Index: Integer]: TdxSpreadSheetCustomView
      read GetVisiblePage;
  published
    property Buttons: TdxSpreadSheetPageControlButtons read FButtons
      write SetButtons stored IsButtonsStored;
    property DropArrowColor: TColor read FDropArrowColor write FDropArrowColor
      default clGreen;
    property FirstVisiblePageIndex: Integer read GetFirstVisiblePageIndex
      write SetFirstVisiblePageIndex default 0;
    property Visible: Boolean read FVisible write SetVisible default True;
  ...
  public
    ...
    property SpreadSheet: TdxCustomSpreadSheet read GetSpreadSheet;
  published
    property Background: TcxStyle index s_Background read GetValue
      write SetValue;
    ...
    property PageControl: TcxStyle index s_PageControl read GetValue
      write SetValue;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property AutomaticCalculation: Boolean read FAutomaticCalculation
      write FAutomaticCalculation default True;
    property Deleting: Boolean read FDeleting write FDeleting default True;
    property DragFilling: Boolean read FDragFilling write FDragFilling
      default True;
    property DragMoving: Boolean read FDragMoving write FDragMoving
      default True;
    property Editing: Boolean read FEditing write FEditing default True;
    property EnterKeyNavigation: TdxSpreadSheetEnterKeyNavigation
      read FEnterKeyNavigation write FEnterKeyNavigation default eknDefault;
    property FormulaAutoComplete: Boolean read FFormulaAutoComplete
      write FFormulaAutoComplete default True;
    property FormulaAutoCompleteShowHint: Boolean
      read FFormulaAutoCompleteShowHint write FFormulaAutoCompleteShowHint
      default True;
    ...
    property HistoryMaxActionCount: Integer read GetHistoryMaxActionCount
      write SetHistoryMaxActionCount default 0;
    property Inserting: Boolean read FInserting write FInserting default True;
    property IterativeCalculation: Boolean read FIterativeCalculation
      write FIterativeCalculation default False;
    property IterativeCalculationMaxCount: Integer
      read FIterativeCalculationMaxCount write SetIterativeCalculationMaxCount
      default 0;
    property Protected: Boolean read GetProtected write SetProtected
      stored False; // obsolete
  end;
  ...
  public
    ...
    property ActualDateTimeSystem: TdxSpreadSheetDateTimeSystem
      read GetActualDateTimeSystem;
  published
    ...
    property CommentMarkColor: TColor read FCommentMarkColor
      write SetCommentMarkColor default clDefault;
    property DateTimeSystem: TdxSpreadSheetDateTimeSystem read FDateTimeSystem
      write SetDateTimeSystem default dts1900;
    property FrozenPaneSeparatorColor: TColor read FFrozenPaneSeparatorColor
      write SetFrozenPaneSeparatorColor default clDefault;
    property FrozenPaneSeparatorWidth: Integer read FFrozenPaneSeparatorWidth
      write SetFrozenPaneSeparatorWidth default 1;
    ...
    property HorizontalScrollBar: Boolean read FHorizontalScrollBar
      write SetHorizontalScrollBar default True;
    property PrintAreaColor: TColor read FPrintAreaColor write SetPrintAreaColor
      default clDefault;
    property PrintAreas: Boolean read FPrintAreas write SetPrintAreas
      default False;
    property R1C1Reference: Boolean read FR1C1Reference write SetR1C1Reference
      default False;
    property ShowFormulas: Boolean read FShowFormulas write SetShowFormulas
      default False;
    property VerticalScrollBar: Boolean read FVerticalScrollBar
      write SetVerticalScrollBar default True;
    property ZeroValues: Boolean read FZeroValues write SetZeroValues
      default True;
  end;
  ...
  public
    ...
    function CompatibleWith(ACommand: TdxSpreadSheetHistoryCustomCommand)
      : Boolean; virtual;
    procedure Redo; virtual;
    procedure Undo; virtual;
  ...
  strict private
    ...
    function GetSpreadSheet: TdxCustomSpreadSheet;
  protected
    function AcceptCommand(ACommand: TdxSpreadSheetHistoryCustomCommand)
      : Boolean; virtual;
    ...
    property Commands[Index: Integer]: TdxSpreadSheetHistoryCustomCommand
      read GetCommand;
    property Count: Integer read GetCount;
  ...
  TdxSpreadSheetHistoryPasteFromClipboardAction = class
    (TdxSpreadSheetHistoryAction)
  protected
    class function GetDescription: string; override;
  end;
  ...
  TdxSpreadSheetHistoryChangeRowColumnItemAction = class
    (TdxSpreadSheetHistoryAction)
  protected
    class function GetDescription: string; override;
  end;
  ...
  TdxSpreadSheetHistoryChangeContainerAction = class
    (TdxSpreadSheetHistoryAction)
  protected
    class function GetDescription: string; override;
  end;
  ...
  TdxSpreadSheetHistoryChangeConditionalFormattingAction = class
    (TdxSpreadSheetHistoryAction)
  protected
    class function GetDescription: string; override;
  end;
  ...
  TdxSpreadSheetHistoryChangePrintingOptionsAction = class
    (TdxSpreadSheetHistoryAction)
  protected
    class function GetDescription: string; override;
  end;
  ...
  TdxSpreadSheetHistoryCreateDefinedNameAction = class
    (TdxSpreadSheetHistoryAction)
  protected
    class function GetDescription: string; override;
  end;
  ...
  TdxSpreadSheetHistoryChangeDefinedNameAction = class
    (TdxSpreadSheetHistoryAction)
  protected
    class function GetDescription: string; override;
  end;
  ...
  TdxSpreadSheetHistoryDeleteDefinedNameAction = class
    (TdxSpreadSheetHistoryAction)
  protected
    class function GetDescription: string; override;
  end;
  ...
  protected
    ...
    property CurrentAction: TdxSpreadSheetHistoryAction read FCurrentAction
      write FCurrentAction;
  ...
  public
    ...
    property MaxActionCount: Integer read FMaxActionCount
      write SetMaxActionCount;
    property RedoActionCount: Integer read GetRedoActionCount;
    property RedoActions[Index: Integer]: TdxSpreadSheetHistoryAction
      read GetRedoAction;
    property UndoActionCount: Integer read GetUndoActionCount;
    property UndoActions[Index: Integer]: TdxSpreadSheetHistoryAction
      read GetUndoAction;
  end;
  ...
  protected
    procedure Process;
  public
    constructor Create(AChangeHandler: TProc; AWaitInterval: Cardinal);
      reintroduce;
    destructor Destroy; override;
    procedure Changed;
    procedure Flush;
  ...
  TdxSpreadSheetViewCompareValuesEvent = procedure
    (Sender: TdxSpreadSheetCustomView;
    const AData1, AData2: TdxSpreadSheetCellData; var Compare: Integer)
    of object;

  TdxSpreadSheetHyperlinkExecuteEvent = procedure(Sender: TdxCustomSpreadSheet;
    AHyperlink: TdxSpreadSheetHyperlink; var AHandled: Boolean) of object;

  TdxSpreadSheetPrepareLockedStateImageEvent = procedure
    (Sender: TdxCustomSpreadSheet; AImage: TcxBitmap32; var ADone: Boolean)
    of object;
  TdxSpreadSheetScrollEvent = procedure(Sender: TdxCustomSpreadSheet;
    AScrollBarKind: TScrollBarKind; AFirstScrollablePosition: Integer)
    of object;
  TdxSpreadSheetViewInitInplaceEditEvent = procedure
    (Sender: TdxSpreadSheetCustomView; AEdit: TcxCustomEdit) of object;
  TdxSpreadSheetViewInitInplaceEditValueEvent = procedure
    (Sender: TdxSpreadSheetCustomView; AEdit: TcxCustomEdit;
    var AValue: TcxEditValue) of object;
  TdxSpreadSheetViewInplaceEditingEvent = procedure
    (Sender: TdxSpreadSheetCustomView; var AProperties: TcxCustomEditProperties;
    var AAllow: Boolean) of object;
  TdxSpreadSheetViewNotifyEvent = procedure(Sender: TdxSpreadSheetCustomView)
    of object;

  TdxSpreadSheetCustomDrawTableViewCellEvent = procedure
    (Sender: TdxSpreadSheetTableView; ACanvas: TcxCanvas;
    AViewInfo: TdxSpreadSheetTableViewCellViewInfo; var AHandled: Boolean)
    of object;
  TdxSpreadSheetCustomDrawTableViewCommonCellEvent = procedure
    (Sender: TdxSpreadSheetTableView; ACanvas: TcxCanvas;
    AViewInfo: TdxSpreadSheetTableViewCustomCellViewInfo; var AHandled: Boolean)
    of object;
  TdxSpreadSheetCustomDrawTableViewHeaderCellEvent = procedure
    (Sender: TdxSpreadSheetTableView; ACanvas: TcxCanvas;
    AViewInfo: TdxSpreadSheetTableViewHeaderCellViewInfo; var AHandled: Boolean)
    of object;

  TdxSpreadSheetTableViewContextPopupEvent = procedure
    (Sender: TdxSpreadSheetTableView; const P: TPoint; APopupMenu: TPopupMenu;
    var AHandled: Boolean) of object;

  TdxSpreadSheetTableViewActiveCellChangingEvent = procedure
    (Sender: TdxSpreadSheetTableView; const ANewActiveCell: TPoint;
    var ACanSelect: Boolean) of object;

  TdxCustomSpreadSheet = class(TcxControl, IcxLockedStateFontChanged,
    IcxLockedStatePaint, IdxDialogOwner, IdxSpreadSheet,
    IdxSpreadSheetCellStyleOwner, IdxSpreadSheetConditionalFormatting,
    IdxSkinSupport)
  strict private
    ...
    FOnCustomDrawTableViewCommonCell
      : TdxSpreadSheetCustomDrawTableViewCommonCellEvent;
    FOnCustomDrawTableViewHeaderCell
    ...
    FOnPageControlNewTabButtonClick
      : TdxSpreadSheetPageControlNewTabButtonClickEvent;
    ...
    procedure SetOptionsLockedStateImage
      (AValue: TdxSpreadSheetLockedStateImageOptions);
    procedure SetOptionsMetadata(AValue: TdxSpreadSheetOptionsMetadata);
    procedure SetOptionsProtection
      (AValue: TdxSpreadSheetWorkbookProtectionOptions);
    ...
    procedure WMChangeCBChain(var AMessage: TWMChangeCBChain);
      message WM_CHANGECBCHAIN;
    procedure WMCopy(var Message: TMessage); message WM_COPY;
    procedure WMCut(var Message: TMessage); message WM_CUT;
    procedure WMDrawClipboard(var AMessage: TWMDrawClipboard);
  ...
  protected
    ...
    procedure ClearModified;
    function ControllerFromPoint(const P: TPoint;
      var AController: TdxSpreadSheetCustomController): Boolean;
      overload; virtual;
    function ControllerFromPoint(X, Y: Integer;
      var AController: TdxSpreadSheetCustomController): Boolean; overload;
    ...
    function CreateFormattedSharedStringCache
      : TdxSpreadSheetFormattedSharedStringCache; virtual;
    ...
    function CreateLockedStatePaintHelper
      : TdxSpreadSheetLockedStatePaintHelper; virtual;
    function CreateOptionsBehavior: TdxSpreadSheetOptionsBehavior; virtual;
    function CreateOptionsLockedStateImage
      : TdxSpreadSheetLockedStateImageOptions; virtual;
    function CreateOptionsMetadata: TdxSpreadSheetOptionsMetadata; virtual;
    function CreateOptionsProtection
      : TdxSpreadSheetWorkbookProtectionOptions; virtual;
    ...
    function CreateUpdateMetadataHelper
      : TdxSpreadSheetChangeAggregator; virtual;
    ...
    function DoActiveCellChanging(AView: TdxSpreadSheetTableView;
      const ANewActiveCell: TPoint): Boolean; virtual;
    procedure DoActiveSheetChanged; virtual;
    procedure DoCompare(AView: TdxSpreadSheetCustomView;
      const AData1, AData2: TdxSpreadSheetCellData;
      var Compare: Integer); virtual;
    procedure DoCommentHide(AContainer: TdxSpreadSheetContainer); virtual;
    function DoCommentShow(AContainer: TdxSpreadSheetContainer)
      : Boolean; virtual;
    ...
    procedure DoEditing(AView: TdxSpreadSheetCustomView;
      var AProperties: TcxCustomEditProperties; var ACanEdit: Boolean); virtual;
    procedure DoEditValueChanged(AView: TdxSpreadSheetCustomView); virtual;
    procedure DoHistoryChanged;
    function DoHyperlinkExecute(ALink: TdxSpreadSheetHyperlink)
      : Boolean; virtual;
    procedure DoInitEdit(AView: TdxSpreadSheetCustomView;
      AEdit: TcxCustomEdit); virtual;
    procedure DoInitEditValue(AView: TdxSpreadSheetCustomView;
      AEdit: TcxCustomEdit; var AValue: Variant); virtual;
    ...
    function DoCreateSheet(var ASheet: TdxSpreadSheetCustomView;
      ...
      AViewClass: TdxSpreadSheetCustomViewClass = nil): Boolean; virtual;
    function InsertSheet(AIndex: Integer = -1; const ACaption: string = '';
      AViewClass: TdxSpreadSheetCustomViewClass = nil)
      : TdxSpreadSheetCustomView;
    ...
    // Custom Draw
    procedure DoCustomDrawTableViewCell(Sender: TdxSpreadSheetTableView;
      ACanvas: TcxCanvas; AViewInfo: TdxSpreadSheetTableViewCellViewInfo;
      var AHandled: Boolean); virtual;
    procedure DoCustomDrawTableViewCommonCell(Sender: TdxSpreadSheetTableView;
      ACanvas: TcxCanvas; AViewInfo: TdxSpreadSheetTableViewCustomCellViewInfo;
      var AHandled: Boolean); virtual;
    procedure DoCustomDrawTableViewHeaderCell(Sender: TdxSpreadSheetTableView;
      ACanvas: TcxCanvas; AViewInfo: TdxSpreadSheetTableViewHeaderCellViewInfo;
      var AHandled: Boolean); virtual;
    ...
    procedure SetSheetIndex(AView: TdxSpreadSheetCustomView;
    ...
    function IcxLockedStatePaint.GetTopmostControl =
      GetLockedStateTopmostControl;
    ...
    procedure InternalSaveToStream(AStream: TStream;
      ...
      AProgressEvent: TdxSpreadSheetProgressEvent); virtual;
    //
    property ActiveController: TdxSpreadSheetCustomController
      read FActiveController write FActiveController;
    property Changes: TdxSpreadSheetChanges read FChanges write FChanges;
    ...
    property FormattedSharedStringCache
      : TdxSpreadSheetFormattedSharedStringCache
      read FFormattedSharedStringCache;
    property IsClipboardListener: Boolean read FIsClipboardListener
      write SetIsClipboardListener;
    property IsLocked: Boolean read GetIsLocked;
    property Listeners: TdxSpreadSheetListeners read FListeners;
    property LockCount: Integer read FLockCount write FLockCount;
    property LockedStatePaintHelper: TdxSpreadSheetLockedStatePaintHelper
      read FLockedStatePaintHelper;
    property ProcessingChanges: Boolean read FProcessingChanges
      write FProcessingChanges;
    ...
    property UpdateMetadataHelper: TdxSpreadSheetChangeAggregator
      read FUpdateMetadataHelper;
    ...
    property OnActiveCellChanging
      ...
      read FOnActiveCellChanging write FOnActiveCellChanging;
    property OnActiveSheetChanged: TNotifyEvent read FOnActiveSheetChanged
      write FOnActiveSheetChanged;
    property OnCommentHide: TdxSpreadSheetCellCommentHideEvent
      read FOnCommentHide write FOnCommentHide;
    property OnCommentShow: TdxSpreadSheetCellCommentShowEvent
      read FOnCommentShow write FOnCommentShow;
    property OnCompare: TdxSpreadSheetViewCompareValuesEvent read FOnCompare
      write FOnCompare;
    property OnCustomDrawTableViewCell
      : TdxSpreadSheetCustomDrawTableViewCellEvent
      read FOnCustomDrawTableViewCell write FOnCustomDrawTableViewCell;
    property OnCustomDrawTableViewCommonCell
      : TdxSpreadSheetCustomDrawTableViewCommonCellEvent
      read FOnCustomDrawTableViewCommonCell
      write FOnCustomDrawTableViewCommonCell;
    property OnCustomDrawTableViewHeaderCell
      : TdxSpreadSheetCustomDrawTableViewHeaderCellEvent
      read FOnCustomDrawTableViewHeaderCell
      write FOnCustomDrawTableViewHeaderCell;
    property OnDataChanged: TNotifyEvent read FOnDataChanged
      write FOnDataChanged;
    property OnEditChanged: TdxSpreadSheetViewNotifyEvent read FOnEditChanged
      write FOnEditChanged;
    property OnEdited: TdxSpreadSheetViewNotifyEvent read FOnEdited
      write FOnEdited;
    property OnEditing: TdxSpreadSheetViewInplaceEditingEvent read FOnEditing
      write FOnEditing;
    property OnEditValueChanged: TdxSpreadSheetViewNotifyEvent
    ...
    property OnHistoryChanged: TNotifyEvent read FOnHistoryChanged
      write FOnHistoryChanged;
    property OnHyperlinkExecute: TdxSpreadSheetHyperlinkExecuteEvent
      read FOnHyperlinkExecute write FOnHyperlinkExecute;
    property OnInitEdit: TdxSpreadSheetViewInitInplaceEditEvent read FOnInitEdit
      write FOnInitEdit;
    property OnInitEditValue: TdxSpreadSheetViewInitInplaceEditValueEvent
      read FOnInitEditValue write FOnInitEditValue;
    ...
    property OnPageControlContextPopup
      : TdxSpreadSheetPageControlContextPopupEvent
      read FOnPageControlContextPopup write FOnPageControlContextPopup;
    property OnPageControlNewTabButtonClick
      : TdxSpreadSheetPageControlNewTabButtonClickEvent
      read FOnPageControlNewTabButtonClick
      write FOnPageControlNewTabButtonClick;
    property OnPageControlTabDragAndDrop
      : TdxSpreadSheetPageControlTabDragAndDropEvent
      read FOnPageControlTabDragAndDrop write FOnPageControlTabDragAndDrop;
    property OnPageControlTabEndDrag: TdxSpreadSheetPageControlTabEndDragEvent
      read FOnPageControlTabEndDrag write FOnPageControlTabEndDrag;
    property OnPageControlTabStartDrag
      : TdxSpreadSheetPageControlTabStartDragEvent
      read FOnPageControlTabStartDrag write FOnPageControlTabStartDrag;
    property OnPrepareLockedStateImage
      : TdxSpreadSheetPrepareLockedStateImageEvent
    ...
    property OnTableViewContextPopup: TdxSpreadSheetTableViewContextPopupEvent
      read FOnTableViewContextPopup write FOnTableViewContextPopup;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    procedure AfterConstruction; override;
    procedure BeforeDestruction; override;
    function AddSheet(const ACaption: string = '';
      AViewClass: TdxSpreadSheetCustomViewClass = nil)
      : TdxSpreadSheetCustomView;
    procedure BeginDragAndDrop; override;
    procedure ClearAll;
    function EvaluateExpression(const AExpression: string;
      AView: TdxSpreadSheetTableView = nil): Variant;
    ...
    procedure LoadFromStream(AStream: TStream;
      AFormat: TdxSpreadSheetCustomFormatClass); overload; virtual;
    procedure SaveToFile(const AFileName: string); virtual;
    procedure SaveToStream(AStream: TStream;
      AFormat: TdxSpreadSheetCustomFormatClass = nil); virtual;
    //
    procedure AddListener(AListener: IdxSpreadSheetListener);
    procedure RemoveListener(AListener: IdxSpreadSheetListener);

    property ActiveSheet: TdxSpreadSheetCustomView read GetActiveSheet
      write SetActiveSheet;
    property ActiveSheetAsTable: TdxSpreadSheetTableView
      read GetActiveSheetAsTable;
    property ActiveSheetIndex: Integer read FActiveSheetIndex
      write SetActiveSheetIndex;
    property BiDiMode: TBiDiMode read FBidiMode write SetBiDiMode
      default bdLeftToRight;
    property CellStyles: TdxSpreadSheetCellStyles read FCellStyles;
    property DefaultCellStyle: TdxSpreadSheetDefaultCellStyle
      read FDefaultCellStyle;
    property DefinedNames: TdxSpreadSheetDefinedNames read FDefinedNames;
    property DialogsLookAndFeel: TcxLookAndFeel read FDialogsLookAndFeel
      write SetDialogsLookAndFeel;
    property ExternalLinks: TdxSpreadSheetExternalLinks read FExternalLinks;
    property FormulaController: TdxSpreadSheetFormulaController
      read FFormulaController;
    property History: TdxSpreadSheetHistory read FHistory;
...
{$WARNINGS ON}
    ...
    property VisibleSheets[Index: Integer]: TdxSpreadSheetCustomView
      read GetVisibleSheet;
    //
    property OptionsBehavior: TdxSpreadSheetOptionsBehavior
      read FOptionsBehavior write SetOptionsBehavior;
    property OptionsLockedStateImage: TdxSpreadSheetLockedStateImageOptions
      read FOptionsLockedStateImage write SetOptionsLockedStateImage;
    property OptionsMetadata: TdxSpreadSheetOptionsMetadata
      read FOptionsMetadata write SetOptionsMetadata;
    property OptionsProtection: TdxSpreadSheetWorkbookProtectionOptions
      read FOptionsProtection write SetOptionsProtection;
    property OptionsView: TdxSpreadSheetOptionsView read FOptionsView
  ...
  protected
    ...
    class procedure ApplyDefaultStyle(ACell: TdxSpreadSheetCell;
      const AEditValue: string); virtual;
  public
    class procedure CalculateSize(ACell: TdxSpreadSheetCell; ACanvas: TcxCanvas;
      const ABounds: TRect; AIsMerged: Boolean;
      AWidth, AHeight: PInteger); virtual;
    class function IsFormattedEditValue(const AEditValue: string)
      : Boolean; virtual;
    class function IsFormattedTextValue(ACell: TdxSpreadSheetCell)
      : Boolean; virtual;
    ...
    class function ForceSetAsRTF(ACell: TdxSpreadSheetCell;
      const AEditValue: string): Boolean; virtual;
    class function GetAsRTF(ACell: TdxSpreadSheetCell; var AValue: string)
      : Boolean; overload;
    class function GetAsRTF(ACell: TdxSpreadSheetCell; var AValue: string;
      ARichEditCompatibility: Boolean): Boolean; overload; virtual;
...
var
  dxSpreadSheetTextService: TdxSpreadSheetTextServiceClass =
    TdxSpreadSheetTextService;
...
uses
  ...
  dxStringHelper,
  // SpreadSheet - Formats
  dxSpreadSheetFormatXLSX, dxSpreadSheetFormatXLS, dxSpreadSheetFormatBinary,
  dxSpreadSheetFormatCSV,
  dxSpreadSheetFormatODS, dxSpreadSheetFormatTXT, dxSpreadSheetFormatHTML,
  dxSpreadSheetFormatXML,
  //
  dxSpreadSheetFormulas, dxSpreadSheetFunctions, dxSpreadSheetCoreHelpers,
  dxSpreadSheetPopupMenu,
  dxSpreadSheetCellsModificationDialog, dxGDIPlusAPI,
  dxSpreadSheetFormatCellsDialog, dxSpreadSheetCoreHistory,
  dxSpreadSheetFindAndReplaceDialog, dxSpreadSheetFormattedTextUtils,
  dxSpreadSheetConditionalFormattingIconSet,
  dxSpreadSheetContainers, dxSpreadSheetContainerCustomizationDialog,
  dxSpreadSheetClipboard, dxSpreadSheetSelection,
  dxSpreadSheetEditHyperlinkDialog, dxSpreadSheetClipboardFormats,
  dxSpreadSheetAutoFilling, dxSpreadSheetCoreStrs,
  dxSpreadSheetPasswordDialog, dxSpreadSheetProtectSheetDialog,
  dxSpreadSheetProtectWorkbookDialog,
  dxSpreadSheetActions, dxSpreadSheetCoreFormulasParser,
  dxSpreadSheetCoreFormulasTokens, dxSpreadSheetFormulasHelpers,
...
type
  ...
  TdxSpreadSheetCustomFormulaControllerAccess = class
    (TdxSpreadSheetCustomFormulaController);
  TdxSpreadSheetFormattedSharedStringAccess = class
    (TdxSpreadSheetFormattedSharedString);
...
function dxSpreadSheetContains(const AArea: TRect; ACell: TdxSpreadSheetCell)
  : Boolean; overload;
begin
  Result := (ACell <> nil) and dxSpreadSheetContains(AArea, ACell.RowIndex,
    ACell.ColumnIndex);
end;
...
constructor TdxSpreadSheetPersistentObject.Create(ASpreadSheet
  : TdxCustomSpreadSheet);
begin
...
procedure TdxSpreadSheetListeners.NotifyActiveSheetChanged
...
procedure TdxSpreadSheetListeners.NotifyDataChanged
  (Sender: TdxCustomSpreadSheet);
var
...
procedure TdxSpreadSheetListeners.NotifyDefinedNamesChanged
  (Sender: TdxCustomSpreadSheet);
var
  AListener: IdxSpreadSheetListener2;
  I: Integer;
...
procedure TdxSpreadSheetListeners.NotifyEdited
  (Sender: TdxSpreadSheetCustomView);
var
...
procedure TdxSpreadSheetListeners.NotifyEditing
  (Sender: TdxSpreadSheetCustomView);
var
  AListener: IdxSpreadSheetEditControllerListener;
  I: Integer;
...
procedure TdxSpreadSheetListeners.NotifyEditingValueChanged
  (Sender: TdxSpreadSheetCustomView);
var
  AListener: IdxSpreadSheetEditControllerListener;
  I: Integer;
...
procedure TdxSpreadSheetListeners.NotifyKeyDown(Sender: TdxCustomSpreadSheet;
  var Key: Word; ShiftState: TShiftState);
var
...
procedure TdxSpreadSheetListeners.NotifyOptionsPrintChanged
  (Sender: TdxSpreadSheetCustomView);
var
...
procedure TdxSpreadSheetListeners.NotifySelectionChanged
  (Sender: TdxSpreadSheetCustomView);
var
...
begin
  for I := Count - 1 downto 0 do
    if Supports(Items[I], IdxSpreadSheetTableViewSelectionModeListener,
      AListener) then
...
constructor TdxSpreadSheetViewPersistentObject.Create
  (AView: TdxSpreadSheetCustomView);
begin
  FView := AView;
end;
...
function TdxSpreadSheetViewPersistentObject.GetSpreadSheet
  : TdxCustomSpreadSheet;
begin
...
constructor TdxSpreadSheetObjectListItem.Create
  (AOwner: TdxSpreadSheetObjectList);
begin
  FOwner := AOwner;
...
function TdxSpreadSheetObjectList.GetItem(AIndex: Integer)
  : TdxSpreadSheetObjectListItem;
begin
...
function TdxSpreadSheetCellDisplayValue.CheckNeedUpdateValue
  (const AValue: Variant; const AFormatCode: string): Boolean;
begin
  Result := (AFormatCode <> FFormatCode) or (VarType(AValue) <> VarType(FValue))
    or not VarEquals(AValue, FValue);
  if Result then
  begin
...
function TdxSpreadSheetCellDisplayValue.Update(const ACell: TdxSpreadSheetCell)
  : TdxSpreadSheetNumberFormatResult;
var
...
begin
  ...
  begin
    ...
    begin
      ...
      ANeedFormatting := CheckNeedUpdateValue(AValue,
        ACell.StyleHandle.DataFormat.FormatCode);
      if dxIsNumericOrDateTime(AValue) and (AValue = 0) and
        (ACell.DataType <> cdtBoolean) and (VarType(AValue) <> varBoolean) then
      begin
      ...
      if ANeedFormatting then
        ACell.StyleHandle.DataFormat.Format(AValue, ACell.DataType,
          ACell.SpreadSheet.FormatSettings, FFormattedValue);
    end;
    if not ACell.IsMultiline and dxDefaultBooleanToBoolean
      (FFormattedValue.IsText, ACell.DataType = cdtString) then
    begin
...
constructor TdxSpreadSheetCell.Create(AOwner: TdxDynamicItemList;
  AIndex: Integer);
begin
...
function TdxSpreadSheetCell.GetReference
  (AOptions: TdxSpreadSheetCellReferenceOptions = []): string;
begin
  Result := GetReference(SpreadSheet.OptionsView.R1C1Reference, AOptions);
end;

function TdxSpreadSheetCell.GetReference(AR1C1ReferenceStyle: Boolean;
  AOptions: TdxSpreadSheetCellReferenceOptions = []): string;
begin
  Result := dxReferenceToString(RowIndex, ColumnIndex, AR1C1ReferenceStyle,
    AOptions, View.Caption);
end;
...
procedure TdxSpreadSheetCell.SetText(const AText: string;
  const AFormulaChecking: Boolean = False);
var
  AFormulaArea: TRect;
begin
  if not SpreadSheet.FormulaController.UpdatingSlaveCells and
    (IsPartOfArrayFormula(AFormulaArea) <> afpNone) and
    dxSpreadSheetIsValidArea(AFormulaArea) and
    not cxPointIsEqual(AFormulaArea.TopLeft, AFormulaArea.BottomRight) then
    raise EdxSpreadSheetCannotChangePartOfArrayError.Create
      (cxGetResourceString(@sdxErrorCannotChangePartOfArray));
  SetTextCore(AText, AFormulaChecking, AFormulaChecking and (AsFormula <> nil)
    and AsFormula.IsArrayFormula);
end;
...
begin
  ...
  if IsPartOfArrayFormula(AFormulaArea) <> afpSlaveCell then
...
begin
  ...
  else if IsFormula then
    PObject(@FData)^.Free;
end;

procedure TdxSpreadSheetCell.CheckAreaReferenceTokens(var AParentToken
  : TdxSpreadSheetFormulaToken);
var
      ...
      begin
        ...
        if not IsZero(AValue) and IsZero(Frac(AValue)) then
          ...
          Style.DataFormat.FormatCode :=
            TdxSpreadSheetDateTimeFormatHelper.GetDefaultFormat(AValue);
      end;
  end;
end;

procedure TdxSpreadSheetCell.Move(ARow: TdxSpreadSheetTableRow;
  AColumn: TdxSpreadSheetTableColumn);
var
  AItem: TdxDynamicListItem;
begin
  if (ARow <> nil) and (AColumn <> nil) and
    ((ARow <> Row) or (AColumn <> Column)) then
  begin
    AItem := ARow.RowCells.FindItem(AColumn.Index);
    if (AItem <> nil) and (AItem.Index = AColumn.Index) then
      raise EdxSpreadSheetError.CreateFmt
        (cxGetResourceString(@sdxErrorCellAlreadyExists), [AColumn.Index]);
...
begin
  ...
  if (ARowIndex <> RowIndex) or (AColumnIndex <> ColumnIndex) then
    Move(View.Rows.CreateItem(ARowIndex),
      View.Columns.CreateItem(AColumnIndex));
end;
...
begin
  ...
  begin
    if IsValueFormattedString then
      History.AddCommand(TdxSpreadSheetHistoryChangeCellCommand.CreateEx(Self));
    History.AddCommand(TdxSpreadSheetHistoryChangeCellStyleCommand.
      Create(Self));
  end;
end;
...
function TdxSpreadSheetCell.GetFormatSettings
  : TdxSpreadSheetCustomFormatSettings;
begin
  Result := SpreadSheet.FormatSettings;
end;

procedure TdxSpreadSheetCell.ProcessStyleChanges(APrevStyle,
  ANewStyle: TdxSpreadSheetCellStyleHandle);
var
...
begin
  ...
  begin
    ...
    if not ANewStyle.Borders.IsEqual(APrevStyle.Borders, bLeft) then
      TdxSpreadSheetCellStyleHelper.MergeBorders
        (AView.Cells[RowIndex, ColumnIndex - 1], nil, nil, Self, nil,
        ACellStyles, False);
    if not ANewStyle.Borders.IsEqual(APrevStyle.Borders, bTop) then
      TdxSpreadSheetCellStyleHelper.MergeBorders(AView.Cells[RowIndex - 1,
        ColumnIndex], nil, nil, nil, Self, ACellStyles, False);
    if not ANewStyle.Borders.IsEqual(APrevStyle.Borders, bRight) then
      TdxSpreadSheetCellStyleHelper.MergeBorders
        (AView.Cells[RowIndex, ColumnIndex + 1], Self, nil, nil, nil,
        ACellStyles, False);
    if not ANewStyle.Borders.IsEqual(APrevStyle.Borders, bBottom) then
      TdxSpreadSheetCellStyleHelper.MergeBorders(AView.Cells[RowIndex + 1,
        ColumnIndex], nil, Self, nil, nil, ACellStyles, False);
  end;
  if (APrevStyle.Font <> ANewStyle.Font) and IsValueFormattedString then
    TdxSpreadSheetFormattedSharedStringAccess(AsSharedString)
      .FontChanged(APrevStyle.Font, ANewStyle.Font);
end;
...
begin
  ...
  else if (DataType = cdtFormula) and (AsFormula.ActualErrorCode <> ecNone) then
...
function TdxSpreadSheetCell.GetAsString: string;
  ...
  begin
    AValue := dxDateTimeToRealDateTime(AValue,
      SpreadSheet.OptionsView.ActualDateTimeSystem);
...
begin
  ...
  begin
    if (AsFormula.ErrorCode <> ecNone) or (AsFormula.ResultValue <> nil) and
      (AsFormula.ResultValue.ErrorCode <> ecNone) then
      Result := cdtError
    else
...
begin
  Result := dxDefaultBooleanToBoolean(ShowFormula,
    View.Options.ActualShowFormulas);
end;
...
begin
  Result := FDataType in [cdtBoolean, cdtCurrency, cdtFloat, cdtDateTime,
    cdtInteger, cdtFormula];
...
begin
  Result := not dxSpreadSheetIsSingleCellArea
    (View.MergedCells.ExpandArea(ColumnIndex, RowIndex));
end;
...
begin
  if (FStyleObject <> nil) and (FStyleObject.ClassType = TdxSpreadSheetCellStyle)
  then
...
procedure TdxSpreadSheetCell.SetStyleHandle(const AValue
  : TdxSpreadSheetCellStyleHandle);
begin
  if (FStyleObject <> nil) and (FStyleObject.ClassType = TdxSpreadSheetCellStyle)
  then
    TdxSpreadSheetCellStyle(FStyleObject).Handle := AValue
  else if FStyleObject <> AValue then
  begin
...
begin
  Result := ((csWordWrap in StyleHandle.States) or
    (StyleHandle.AlignVert in [ssavJustify, ssavDistributed])) and
    not IsNumericValue;
end;

function TdxSpreadSheetCell.IsPartOfArrayFormula(var AFormulaArea: TRect;
  AFormula: PdxSpreadSheetCustomFormula = nil): TdxSpreadSheetArrayFormulaPart;
begin
  Result := SpreadSheet.FormulaController.IsPartOfArrayFormula(View, RowIndex,
    ColumnIndex, AFormulaArea, AFormula);
end;

function TdxSpreadSheetCell.IsValueFormattedString: Boolean;
begin
  Result := (DataType = cdtString) and
    (AsSharedString is TdxSpreadSheetFormattedSharedString);
end;
...
procedure TdxSpreadSheetCell.LoadFromStream(AReader: TcxReader;
  AFormulasRef: TdxSpreadSheetFormulaAsTextInfoList);
var
...
class function TdxSpreadSheetCell.GetContentOffsets(ABottomBorderStyle
  : TdxSpreadSheetCellBorderStyle): TRect;
begin
  Result := cxRect(3, 1, 2, dxSpreadSheetBorderStyleThickness
    [ABottomBorderStyle] div 2);
end;
...
procedure TdxSpreadSheetCell.SetAsError(const AValue
...
procedure TdxSpreadSheetCell.SetAsSharedString
  (AValue: TdxSpreadSheetSharedString);
begin
...
procedure TdxSpreadSheetCell.SetTextCore(const AText: string;
  const AFormulaChecking, AArrayFormulaAttributeIsDirty: Boolean);
  ...
  begin
    if History.InProcess or (AsFormula = nil) or
      (dxSpreadSheetFormulaIncludeEqualSymbol(AsFormula.SourceText) <> AText) or AArrayFormulaAttributeIsDirty
    then
    begin
...
begin
  View.BeginUpdate;
  try
    if dxSpreadSheetIsErrorString(AText, AErrorCode) and (AErrorCode <> ecNone)
    then
      AsError := AErrorCode
...
function TdxSpreadSheetContainerAnchorPoint.GetContainer
  : TdxSpreadSheetContainer;
begin
  Result := Owner as TdxSpreadSheetContainer;
end;

procedure TdxSpreadSheetContainerAnchorPoint.SetCell(const AValue
  : TdxSpreadSheetCell);
begin
  if (AValue <> nil) and (AValue.View <> Container.Parent) then
  begin
    raise EdxSpreadSheetError.CreateFmt
      (cxGetResourceString(@sdxErrorInvalidAnchorCell),
...
begin
  ...
  begin
    FlipHorizontally := TdxSpreadSheetContainerTransform(Source)
      .FlipHorizontally;
...
procedure TdxSpreadSheetContainerTransform.SetRotationAngle
  (const AValue: Double);
var
  ABounds: TRect;
begin
...
begin
  ...
  begin
    ...
    History.AddCommand(TdxSpreadSheetHistoryCreateContainerCommand.
      Create(Self));
    History.EndAction;
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      History.BeginAction(TdxSpreadSheetHistoryChangeContainerAction);
      History.AddCommand(TdxSpreadSheetHistoryDeleteContainerCommand.
        Create(Self));
      History.EndAction;
    end;
    Parent := nil;
...
begin
  ...
  begin
    History.BeginAction(TdxSpreadSheetHistoryChangeContainerAction);
    History.AddCommand(TdxSpreadSheetHistoryChangeContainerCommand.Create
      (Self, True));
  end;
end;
...
procedure TdxSpreadSheetContainer.Changed
  (AChanges: TdxSpreadSheetContainerChanges);
begin
...
function TdxSpreadSheetContainer.CreateAnchorPoint
  : TdxSpreadSheetContainerAnchorPoint;
begin
  Result := TdxSpreadSheetContainerAnchorPoint.Create(Self);
end;

function TdxSpreadSheetContainer.CreateCalculator
  : TdxSpreadSheetContainerCalculator;
begin
  Result := TdxSpreadSheetContainerCalculator.Create(Self);
end;

function TdxSpreadSheetContainer.CreateTransform
  : TdxSpreadSheetContainerTransform;
begin
  Result := TdxSpreadSheetContainerTransform.Create(Self);
end;

function TdxSpreadSheetContainer.CreateViewInfo
  : TdxSpreadSheetContainerViewInfo;
begin
...
begin
  Result := IsTransformsSupported and Parent.CanEditContainers and
    not(crNoRotation in Restrictions);
end;
...
procedure TdxSpreadSheetContainer.LoadFromStream(AReader: TcxReader;
  AVersion: Word; ACanReadContent: Boolean = True);
var
...
procedure TdxSpreadSheetContainer.SetAnchorPoint1(const AValue
  : TdxSpreadSheetContainerAnchorPoint);
begin
  FAnchorPoint1.Assign(AValue);
end;

procedure TdxSpreadSheetContainer.SetAnchorPoint2(const AValue
  : TdxSpreadSheetContainerAnchorPoint);
begin
  FAnchorPoint2.Assign(AValue);
end;

procedure TdxSpreadSheetContainer.SetAnchorType(const AValue
...
procedure TdxSpreadSheetContainer.SetHyperlink(const AValue
  : TdxSpreadSheetHyperlink);
begin
...
begin
  ...
  begin
    ...
    begin
      History.BeginAction(TdxSpreadSheetHistoryChangeContainerAction);
      try
        History.AddCommand(TdxSpreadSheetHistoryChangeContainerIndexCommand.
          Create(Self, AValue));
...
procedure TdxSpreadSheetContainer.SetParent(const AValue
  : TdxSpreadSheetCustomView);
begin
...
procedure TdxSpreadSheetContainer.SetTransform
  (AValue: TdxSpreadSheetContainerTransform);
begin
...
class procedure TdxSpreadSheetCellHelper.DecodeRef(const ARef: Int64;
  out ARow, AColumn: Integer);
begin
...
class function TdxSpreadSheetCellHelper.EncodeRef
  (ACell: TdxSpreadSheetCell): Int64;
begin
  if ACell <> nil then
...
class function TdxSpreadSheetCellHelper.EncodeRef(ARow,
  AColumn: Integer): Int64;
begin
  Result := dxMakeInt64(AColumn, ARow);
end;

class function TdxSpreadSheetCellHelper.EncodeRefAsString
  (ACell: TdxSpreadSheetCell): string;
begin
  Result := ACell.View.Caption + '.' + TdxSpreadSheetColumnReferences.
    NameByIndex(ACell.ColumnIndex) + IntToStr(ACell.RowIndex + 1);
end;

class function TdxSpreadSheetCellHelper.GetCell(ARow, AColumn: Integer;
  AView: TdxSpreadSheetCustomView): TdxSpreadSheetCell;
var
  ATableView: IdxSpreadSheetTableView;
begin
  if (AColumn >= 0) and (ARow >= 0) and Supports(AView, IdxSpreadSheetTableView,
    ATableView) then
...
class function TdxSpreadSheetCellHelper.ReadRef(AReader: TcxReader;
  AView: TdxSpreadSheetCustomView; AAnchorRow: Integer = 0;
  AAnchorColumn: Integer = 0): TdxSpreadSheetCell;
var
...
class procedure TdxSpreadSheetCellHelper.WriteRef(AWriter: TcxWriter;
  ACell: TdxSpreadSheetCell; AAnchorRow: Integer = 0;
  AAnchorColumn: Integer = 0);
begin
  if ACell <> nil then
  begin
...
constructor TdxSpreadSheetContainerCalculator.Create
  (AOwner: TdxSpreadSheetContainer);
begin
  inherited Create;
  FOwner := AOwner;
end;
...
function TdxSpreadSheetContainerCalculator.CalculateBounds: TRect;
  ...
  function CalculateOffset(const ACellBounds: TRect;
    const AOffset: TPoint): TPoint;
  begin
...
begin
  ...
  case AnchorType of
    catOneCell, catTwoCell:
      Result.TopLeft := CalculateOffset(AnchorPoint1.Cell.GetAbsoluteBounds,
        AnchorPoint1.Offset);
    catAbsolute:
  ...
  case AnchorType of
    catAbsolute, catOneCell:
      Result := cxRectSetSize(Result, AnchorPoint2.Offset.X,
        AnchorPoint2.Offset.Y);
    catTwoCell:
      Result.BottomRight := CalculateOffset(AnchorPoint2.Cell.GetAbsoluteBounds,
        AnchorPoint2.Offset);
  end;
    ...
    case AnchorType of
      catOneCell:
        ...
        begin
          ...
          AnchorPoint1.Offset := cxPointOffset(ARect.TopLeft,
            ACell1.GetAbsoluteBounds.TopLeft, False);
          AnchorPoint2.Offset := cxPointOffset(ARect.BottomRight,
            ARect.TopLeft, False);
        end
        else
          AnchorType := catAbsolute;
      ...
      catTwoCell:
        ...
        begin
          ...
          AnchorPoint2.Offset := cxPointOffset(ARect.BottomRight,
            ACell2.GetAbsoluteBounds.TopLeft, False);
        end
        else
          AnchorType := catAbsolute;
    end;
...
procedure TdxSpreadSheetContainerCalculator.UpdateAnchorsAfterResize
  (const APrevBounds: TRect; AForceUpdate: Boolean = False);
var
  ACell: TdxSpreadSheetCell;
  ACellOffset: TPoint;
begin
  ...
  begin
    ...
    else if AForceUpdate then
      UpdateAnchors(APrevBounds);
  end
  else if AForceUpdate or (AnchorType in [catOneCell, catTwoCell]) then
    UpdateAnchors(APrevBounds);
end;
...
function TdxSpreadSheetContainerCalculator.GetNearCells(const R: TRect;
  out ACell1, ACell2: TdxSpreadSheetCell): Boolean;
var
  AColumnIndex: Integer;
  ARowIndex: Integer;
  ATableView: IdxSpreadSheetTableView;
begin
  ...
  if Supports(Owner.Parent, IdxSpreadSheetTableView, ATableView) then
  begin
    if ATableView.GetCellAtAbsolutePoint(R.TopLeft, ARowIndex, AColumnIndex)
    then
      ACell1 := ATableView.GetCell(ARowIndex, AColumnIndex);
    if ATableView.GetCellAtAbsolutePoint(R.BottomRight, ARowIndex, AColumnIndex)
    then
...
procedure TdxSpreadSheetContainerCalculator.ModifyBounds(ALeftModifier,
  ATopModifier, ARightModifier, ABottomModifier: Integer);
var
  ARect: TRect;
begin
  ARect := CalculateBounds;
  ARect.TopLeft := cxPointOffset(ARect.TopLeft, ALeftModifier, ATopModifier);
  ARect.BottomRight := cxPointOffset(ARect.BottomRight, ARightModifier,
    ABottomModifier);
...
begin
  ...
  ModifyBounds(-ADeltaX * AFactorX, -ADeltaY * AFactorY, ADeltaX * AFactorX,
    ADeltaY * AFactorY);
end;

function TdxSpreadSheetContainerCalculator.TransformCoords(const R: TRect;
  ABackwardDirection: Boolean): TRect;
var
  AMatrix: TdxGPMatrix;
begin
  Result := R;
...
function TdxSpreadSheetContainerCalculator.ValidateBounds
  (const R: TRect): TRect;
var
  AContentRect: TRect;
  ADeltaX: Integer;
...
function TdxSpreadSheetContainerCalculator.GetAnchorPoint1
  : TdxSpreadSheetContainerAnchorPoint;
begin
  Result := Owner.AnchorPoint1;
end;

function TdxSpreadSheetContainerCalculator.GetAnchorPoint2
  : TdxSpreadSheetContainerAnchorPoint;
begin
  Result := Owner.AnchorPoint2;
end;

function TdxSpreadSheetContainerCalculator.GetAnchorType
  : TdxSpreadSheetContainerAnchorType;
begin
  Result := Owner.AnchorType;
end;

function TdxSpreadSheetContainerCalculator.GetTransform
  : TdxSpreadSheetContainerTransform;
begin
  Result := Owner.Transform;
end;

procedure TdxSpreadSheetContainerCalculator.SetAnchorType
  (const Value: TdxSpreadSheetContainerAnchorType);
begin
...
function TdxSpreadSheetContainers.Add(AClass: TdxSpreadSheetContainerClass)
  : TdxSpreadSheetContainer;
begin
  Result := AClass.Create(Owner);
end;

procedure TdxSpreadSheetContainers.Add(AClass: TdxSpreadSheetContainerClass;
  out AContainer);
begin
  TdxSpreadSheetContainer(AContainer) := Add(AClass);
end;

function TdxSpreadSheetContainers.AddCommentContainer(ACell: TdxSpreadSheetCell)
  : TdxSpreadSheetContainer;
begin
  ...
  try
    ...
    begin
      ...
      try
        ...
        Result.Calculator.UpdateAnchors
          (TdxSpreadSheetCommentContainer.GetDefaultPosition(ACell));
      finally
        Result.EndChanging;
      end;
    end;
...
procedure TdxSpreadSheetContainers.AddCommentContainer
  (ACell: TdxSpreadSheetCell; out AContainer);
begin
  TdxSpreadSheetContainer(AContainer) := AddCommentContainer(ACell);
end;

function TdxSpreadSheetContainers.FindByName(const AName: string;
  out AContainer: TdxSpreadSheetContainer): Boolean;
var
  I: Integer;
begin
...
function TdxSpreadSheetContainers.GetFirstVisibleContainer
  : TdxSpreadSheetContainer;
begin
  Result := FindNearestVisibleContainer(0, 1);
end;

function TdxSpreadSheetContainers.GetLastVisibleContainer
  : TdxSpreadSheetContainer;
begin
  Result := FindNearestVisibleContainer(Count - 1, -1);
end;

function TdxSpreadSheetContainers.GetNextVisibleContainer(ACurrentContainer
  : TdxSpreadSheetContainer): TdxSpreadSheetContainer;
begin
  Result := FindNearestVisibleContainer(ACurrentContainer.Index + 1, 1);
end;

function TdxSpreadSheetContainers.GetPrevVisibleContainer(ACurrentContainer
  : TdxSpreadSheetContainer): TdxSpreadSheetContainer;
begin
  Result := FindNearestVisibleContainer(ACurrentContainer.Index - 1, -1);
end;

function TdxSpreadSheetContainers.IsCellUsed(ACell: TdxSpreadSheetCell)
  : Boolean;
var
  I: Integer;
begin
...
procedure TdxSpreadSheetContainers.EnumCommentContainers
...
procedure TdxSpreadSheetContainers.EnumCommentContainers(const AArea: TRect;
  AProc: TdxSpreadSheetContainerEnumProc);
var
  AComment: TdxSpreadSheetContainer;
begin
  for AComment in FComments.Values do
    if dxSpreadSheetContains(AArea, TdxSpreadSheetCommentContainer(AComment)
      .Cell) then
    begin
      if not AProc(AComment) then
        Break;
...
function TdxSpreadSheetContainers.FindCommentContainer
  (ACell: TdxSpreadSheetCell): TdxSpreadSheetContainer;
begin
...
function TdxSpreadSheetContainers.FindCommentContainer
  (ACell: TdxSpreadSheetCell; out AContainer): Boolean;
begin
  Result := (ACell <> nil) and FindCommentContainer(ACell.RowIndex,
    ACell.ColumnIndex, AContainer);
end;

function TdxSpreadSheetContainers.FindCommentContainer(ARow, AColumn: Integer)
  : TdxSpreadSheetContainer;
begin
...
begin
  if not Owner.SpreadSheet.History.InProcess and
    Supports(Owner, IdxSpreadSheetTableView, AIntf) then
  begin
...
function TdxSpreadSheetContainers.FindNextCommentContainer
  (ACell: TdxSpreadSheetCell; out AContainer;
  AGoForward: Boolean = True): Boolean;
begin
  if ACell <> nil then
    Result := FindNextCommentContainer(ACell.RowIndex, ACell.ColumnIndex,
      AContainer, AGoForward)
  else
    Result := FindNextCommentContainer(-1, -1, AContainer, AGoForward);
end;

function TdxSpreadSheetContainers.FindNextCommentContainer(ARow,
  AColumn: Integer; out AContainer; AGoForward: Boolean = True): Boolean;
var
...
function TdxSpreadSheetContainers.FindCommentContainerCore(ARow,
  AColumn: Integer; out AContainer): Boolean;
begin
  Result := FComments.TryGetValue(TdxSpreadSheetCellHelper.EncodeRef(ARow,
    AColumn), TdxSpreadSheetContainer(AContainer));
end;
...
procedure TdxSpreadSheetContainers.InternalAdd
  (AContainer: TdxSpreadSheetContainer);
begin
  inherited Add(AContainer);
end;

procedure TdxSpreadSheetContainers.InternalRemove
  (AContainer: TdxSpreadSheetContainer);
begin
  Extract(AContainer);
end;

procedure TdxSpreadSheetContainers.RegisterCommentContainer
  (AContainer: TdxSpreadSheetContainer);
begin
  if (AContainer is TdxSpreadSheetCommentContainer) and
    (TdxSpreadSheetCommentContainer(AContainer).Cell <> nil) then
    FComments.AddOrSetValue(TdxSpreadSheetCellHelper.EncodeRef
      (TdxSpreadSheetCommentContainer(AContainer).Cell), AContainer);
end;

procedure TdxSpreadSheetContainers.UnregisterCommentContainer
  (AContainer: TdxSpreadSheetContainer);
var
  AKey: Int64;
begin
...
begin
  ...
  begin
    for AContainer in FBoundsStorage.Keys do
      AContainer.Calculator.UpdateAnchorsAfterResize
        (FBoundsStorage.Items[AContainer]);
...
function TdxSpreadSheetContainers.FindNearestVisibleContainer(AStartFromIndex,
  ADirection: Integer): TdxSpreadSheetContainer;
begin
  Result := nil;
...
constructor TdxSpreadSheetFormulaAsTextInfo.Create
...
class procedure TdxSpreadSheetFormulaAsTextInfo.SaveFormulaToStream
  (AFormula: TdxSpreadSheetFormula; AWriter: TcxWriter);
begin
...
begin
  if not AParser.ParseFormula(Formula, Cell) then
    raise EdxSpreadSheetError.CreateFmt
      (cxGetResourceString(@sdxErrorInvalidFormula), [Formula]);
...
constructor TdxSpreadSheetFormulaAsTextInfoList.Create
...
function TdxSpreadSheetFormulaAsTextInfoList.Add(ACell: TdxSpreadSheetCell;
  const AFormula: string; AIsArray, AIsShared: Boolean; const AReference: TRect)
  : TdxSpreadSheetFormulaAsTextInfo;
begin
  Result := Add(ACell, cxPoint(ACell.ColumnIndex, ACell.RowIndex), AFormula,
    AIsArray, AIsShared, AReference);
end;

function TdxSpreadSheetFormulaAsTextInfoList.Add(ACell: TdxSpreadSheetCell;
  const AAnchor: TPoint; const AFormula: string; AIsArray, AIsShared: Boolean;
  const AReference: TRect): TdxSpreadSheetFormulaAsTextInfo;
begin
  Result := CreateItem;
  Result.Cell := ACell;
...
function TdxSpreadSheetFormulaAsTextInfoList.AddFromStream
  (ACell: TdxSpreadSheetCell; AReader: TcxReader)
  : TdxSpreadSheetFormulaAsTextInfo;
begin
  Result := CreateItem;
  Result.Cell := ACell;
...
function TdxSpreadSheetFormulaAsTextInfoList.HasCell
...
function TdxSpreadSheetFormulaAsTextInfoList.CreateItem
  : TdxSpreadSheetFormulaAsTextInfo;
begin
...
constructor TdxSpreadSheetDefinedNameFormula.Create
  (AOwner: TdxSpreadSheetDefinedName);
begin
...
function TdxSpreadSheetDefinedNameFormula.GetController
  : TdxSpreadSheetCustomFormulaController;
begin
...
begin
  ...
  try
    ...
    Result.InternalSetOwner(nil);
    // # T138686: relative references incorrect resolves after clone because anchor is lost
...
function TdxSpreadSheetFormula.GetController
  : TdxSpreadSheetCustomFormulaController;
begin
  if Cell <> nil then
...
begin
  if (Cell <> nil) and Cell.SpreadSheet.OptionsBehavior.IterativeCalculation
  then
...
constructor TdxSpreadSheetControlFormatSettings.Create
...
function TdxSpreadSheetControlFormatSettings.GetFunctionName
  (const AName: Pointer): string;
begin
...
constructor TdxSpreadSheetFormulaController.Create
  (AOwner: TdxCustomSpreadSheet);
begin
  inherited Create;
  FOwner := AOwner;
...
procedure TdxSpreadSheetFormulaController.UpdateReferences
  (AFormula: TdxSpreadSheetCustomFormula; AView: TdxSpreadSheetTableView;
  const AArea: TRect; const ATargetOrigin: TPoint;
...
begin
  if AFormula <> nil then
  begin
    if SpreadSheet.History.CanAddCommand and (AMode in [urmDelete, urmMove])
    then
    begin
      AExpression := AFormula.AsText;
      if TdxFormulaAccess(AFormula).UpdateReferences(AView, AArea,
        ATargetOrigin, AMode) then
        SpreadSheet.History.AddCommand
          (TdxSpreadSheetHistoryFormulaChangedCommand.Create(AFormula,
          AExpression));
    end
    else
      TdxFormulaAccess(AFormula).UpdateReferences(AView, AArea,
        ATargetOrigin, AMode);
  end;
end;
...
procedure TdxSpreadSheetFormulaController.DoNameChanged
  (AName: TdxSpreadSheetDefinedName; const ANewName: string);

  function ProcessTokens(AToken: TdxSpreadSheetFormulaToken): Boolean;
  begin
    if AToken is TdxSpreadSheetFormulaDefinedNameToken then
      Result := TdxSpreadSheetFormulaDefinedNameToken(AToken)
        .UpdateValue(AName, ANewName)
    else
      Result := False;
...
function TdxSpreadSheetFormulaController.GetCellFromPath
  (APath: TdxSpreadSheetReferencePath): TdxSpreadSheetCell;
begin
  Result := TdxSpreadSheetTableView(APath.Sheet).Cells[APath.Row, APath.Column];
end;

function TdxSpreadSheetFormulaController.
  NeedAddFeatureFunctionPrefixToFunctionName: Boolean;
begin
...
function TdxSpreadSheetFormulaController.GetFormatSettings
  : TdxSpreadSheetFormatSettings;
begin
  Result := SpreadSheet.FormatSettings;
end;

function TdxSpreadSheetFormulaController.GetItem(Index: Integer)
  : TdxSpreadSheetFormula;
begin
...
begin
  ...
  Result := (FPopupMenu <> nil) and
    (FPopupMenu as TdxSpreadSheetCustomPopupMenu).Popup(P);
end;
...
function TdxSpreadSheetCustomController.GetCursor(const ACursorPos
  : TPoint): TCursor;
begin
  Result := HitTest.GetCursor(ACursorPos);
end;

function TdxSpreadSheetCustomController.GetDragAndDropObjectClass
  (const ACursorPos: TPoint): TcxDragAndDropObjectClass;
begin
...
function TdxSpreadSheetCustomController.GetPopupMenuClass(const ACursorPos
  : TPoint): TComponentClass;
begin
...
function TdxSpreadSheetCustomController.IMEComposition
...
procedure TdxSpreadSheetCustomController.KeyDown(var Key: Word;
  Shift: TShiftState);
begin
end;

procedure TdxSpreadSheetCustomController.KeyUp(var Key: Word;
  Shift: TShiftState);
begin
end;
...
procedure TdxSpreadSheetCustomController.DoMouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  UpdateStates;
end;

procedure TdxSpreadSheetCustomController.DoMouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
  UpdateStates;
end;

procedure TdxSpreadSheetCustomController.DoMouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  UpdateStates;
end;

function TdxSpreadSheetCustomController.DoMouseWheel(Shift: TShiftState;
  WheelDelta: Integer; const P: TPoint): Boolean;
begin
  Result := False;
end;

procedure TdxSpreadSheetCustomController.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  FPressedObject := HitTest.HitObject;
  DoMouseDown(Button, Shift, MulDiv(X, 100, ZoomFactor),
    MulDiv(Y, 100, ZoomFactor));
end;

procedure TdxSpreadSheetCustomController.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
  DoMouseMove(Shift, MulDiv(X, 100, ZoomFactor), MulDiv(Y, 100, ZoomFactor));
end;

procedure TdxSpreadSheetCustomController.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  DoMouseUp(Button, Shift, MulDiv(X, 100, ZoomFactor),
    MulDiv(Y, 100, ZoomFactor));
  FPressedObject := nil;
end;

function TdxSpreadSheetCustomController.MouseWheel(Shift: TShiftState;
  WheelDelta: Integer; const P: TPoint): Boolean;
begin
...
begin
  if not(IsDestroying or IsLocked or (Changes = []) or
    SpreadSheet.FormulaController.CalculationInProcess) then
    DoCheckChanges;
end;
...
begin
  ...
  begin
    ...
    if (ASheet <> Self) and dxSpreadSheetTextIsEqual(ASheet.Caption, FCaption)
    then
      Abort;
  end;
  FIsCaptionMustBeEscaped := TdxSpreadSheetReferenceAsString.
    CheckIfViewNameMustBeEscaped(FCaption, FormatSettings.BreakChars +
    FormatSettings.Data.DecimalSeparator);
end;

function TdxSpreadSheetCustomView.CreateController
  : TdxSpreadSheetCustomViewController;
begin
...
function TdxSpreadSheetCustomView.CreateOptions
  : TdxSpreadSheetCustomViewOptions;
begin
  Result := TdxSpreadSheetCustomViewOptions.Create(Self);
end;

function TdxSpreadSheetCustomView.CreateViewInfo
  : TdxSpreadSheetCustomViewViewInfo;
begin
...
procedure TdxSpreadSheetCustomView.Scroll(AScrollBarKind: TScrollBarKind;
...
function TdxSpreadSheetCustomView.GetFormatSettings
  : TdxSpreadSheetFormatSettings;
begin
  Result := SpreadSheet.FormatSettings;
end;
...
procedure TdxSpreadSheetCustomView.SetOptions
  (AValue: TdxSpreadSheetCustomViewOptions);
begin
...
procedure TdxSpreadSheetCustomView.ScaleFactorChangeHandler(Sender: TObject;
  M, D: Integer; IsLoading: Boolean);
begin
  ChangeScale(M, D);
end;
...
procedure TdxSpreadSheetCustomViewPainter.PrepareCanvasFont(ACanvas: TcxCanvas;
  AFont: TFont);
begin
...
function TdxSpreadSheetCustomViewPainter.GetLookAndFeelPainter
...
constructor TdxSpreadSheetCustomViewViewInfo.Create
  (AView: TdxSpreadSheetCustomView);
begin
...
begin
  ...
  FBounds := View.Bounds;
  if SpreadSheet.UseRightToLeftScrollBar and not SpreadSheet.IsPopupScrollBars
  then
...
begin
  ...
  begin
    ...
    RightToLeftConversion(cxRectScale(View.BoundsForRightToLeftConversion, 100,
      View.ZoomFactor));
  end;
end;
...
begin
  ...
  for AComments := False to True do
    ...
    begin
      ...
      if AContainer.Visible and
        (AContainer is TdxSpreadSheetCommentContainer = AComments) then
      begin
        ...
        begin
          ...
          ACell.SetBounds(cxRectOffset(AContainer.Calculator.CalculateBounds,
            AOrigin, False));
...
function TdxSpreadSheetCustomViewViewInfo.CalculateContainersHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
var
  AViewInfo: TdxSpreadSheetContainerViewInfo;
  I: Integer;
begin
...
procedure TdxSpreadSheetCustomViewViewInfo.RightToLeftConversion
...
function TdxSpreadSheetCustomViewViewInfo.CreatePainter
  : TdxSpreadSheetCustomViewPainter;
begin
...
procedure TdxSpreadSheetCustomViewViewInfo.Scroll(AScrollBarKind
  : TScrollBarKind; AScrollCode: TScrollCode; var AScrollPos: Integer);
begin
end;
...
function TdxSpreadSheetViewList.GetItem(Index: Integer)
  : TdxSpreadSheetCustomView;
begin
...
function TdxSpreadSheetMergedCellsRow.Contains(AColumn: Integer)
  : TdxSpreadSheetMergedCell;
var
...
procedure TdxSpreadSheetMergedCellsRow.Enum(AColumn1, AColumn2: Integer;
  AProc: TdxSpreadSheetMergedCellListEnumCellsProc);
var
  AItem: TdxSpreadSheetMergedCellsRowItem;
begin
  AItem := TdxSpreadSheetMergedCellsRowItem(First);
  while AItem <> nil do
  begin
    if (AItem.Cell.Area.Right >= AColumn1) and (AItem.Cell.Area.Left <= AColumn2)
    then
      AProc(AItem.Cell);
    AItem := TdxSpreadSheetMergedCellsRowItem(AItem.Next);
  end;
...
procedure TdxSpreadSheetMergedCellsRow.RemoveCell
  (ACell: TdxSpreadSheetMergedCell);
var
  AItem: TdxSpreadSheetMergedCellsRowItem;
begin
...
begin
  ...
  begin
    R := AItem.Cell.Area;
    if InRange(AArea.Left, R.Left, R.Right) or InRange(AArea.Right, R.Left,
      R.Right) then
...
begin
  ...
  begin
    ...
    if Owner.History.CanAddCommand then
      Owner.History.AddCommand(TdxSpreadSheetHistoryMergeCellsCommand.Create
        (nil, Area));
  end;
  inherited Destroy;
end;

function TdxSpreadSheetMergedCell.Contains(const ARow,
...
procedure TdxSpreadSheetMergedCell.Initialize
  (AOwner: TdxSpreadSheetMergedCellList; const AArea: TRect);
begin
  if FOwner <> nil then
...
procedure TdxSpreadSheetMergedCell.SetNext(const Value
  : TdxSpreadSheetMergedCell);
begin
  inherited Next := Value;
end;

procedure TdxSpreadSheetMergedCell.SetPrev(const Value
  : TdxSpreadSheetMergedCell);
begin
...
procedure TdxSpreadSheetClipboardArea.Initialize
  (AView: TdxSpreadSheetCustomView; const AArea: TRect);
begin
  View := AView;
  Area := AArea;
  if View <> nil then
...
begin
  inherited Create;
  Rows := TObjectDictionary<Integer, TdxSpreadSheetMergedCellsRow>.Create
    ([doOwnsValues], 1024);
  FView := AView;
end;
...
var
  ACell: TdxSpreadSheetMergedCell;
begin
  if dxSpreadSheetIsValidArea(AArea) and not dxSpreadSheetIsSingleCellArea(AArea)
  then
  begin
    View.BeginUpdate;
    try
      ...
      begin
        ...
        try
          History.AddCommand(TdxSpreadSheetHistoryMergeCellsCommand.Create
            (ACell, AArea));
...
procedure TdxSpreadSheetMergedCellList.Add(const AArea: string);
begin
  Add(View.StringToAreaReference(AArea));
end;
...
procedure TdxSpreadSheetMergedCellList.Delete(ALinkedObject
...
begin
  ...
  try
    ...
    try
      ADeletingArea := AArea;
      EnumCells(ADeletingArea, procedure(ACell: TdxSpreadSheetMergedCell)
        var
          R: TRect;
        begin
          if dxSpreadSheetIntersects(ACell.Area, ADeletingArea, R) and
            (not AEnclosedItemsOnly or cxRectIsEqual(R, ACell.Area)) then
          begin
...
procedure TdxSpreadSheetMergedCellList.DoRemoving
  (ACell: TdxSpreadSheetMergedCell);
begin
  Dec(FCount);
...
function TdxSpreadSheetMergedCellList.Find
  (ACell: TdxSpreadSheetMergedCell): Integer;
var
...
procedure TdxSpreadSheetMergedCellList.InitializeCell
  (ACell: TdxSpreadSheetMergedCell; const AArea: TRect);
begin
  ACell.Initialize(Self, AArea);
  if ([sssReading, sssReadingFromClipboard] * View.State = []) and not History.InProcess
  then
...
procedure TdxSpreadSheetMergedCellList.RemoveRef
  (ACell: TdxSpreadSheetMergedCell);
begin
...
procedure TdxSpreadSheetMergedCellList.EnumCells
  (AProc: TdxSpreadSheetMergedCellListEnumCellsProc);
begin
  EnumCells(cxRect(0, 0, dxSpreadSheetMaxColumnIndex,
    dxSpreadSheetMaxRowIndex), AProc);
end;

procedure TdxSpreadSheetMergedCellList.EnumCells(const AArea: TRect;
AProc: TdxSpreadSheetMergedCellListEnumCellsProc);
var
  ARowIndex: Integer;
begin
...
procedure TdxSpreadSheetMergedCellList.EnumRows(AStartIndex,
  AFinishIndex: Integer; AProc: TdxSpreadSheetMergedCellListEnumRowsProc);
var
  ARowIndex: Integer;
begin
...
begin
  ...
  until ((AResult.Top = R.Top) and (AResult.Bottom = R.Bottom)) or
    (cxRectWidth(AResult) * cxRectHeight(AResult) = 0);
  CachedSourceArea := AArea;
  CachedExpandedArea := AResult;
  Result := AResult;
end;

function TdxSpreadSheetMergedCellList.ExpandArea(const AColumn,
  ARow: Integer): TRect;
var
  ACell: TdxSpreadSheetMergedCell;
begin
...
procedure TdxSpreadSheetMergedCellList.Extract(const AArea: TRect;
ADest: TList<TdxSpreadSheetMergedCell>);
begin
  ADest.Clear;
  ADest.Capacity := Count;
  EnumCells(AArea, procedure(ACell: TdxSpreadSheetMergedCell)
    begin
...
function TdxSpreadSheetMergedCellList.FindCell(ARow, AColumn: Integer)
  : TdxSpreadSheetMergedCell;
var
  APoint: TPoint;
  ARowCells: TdxSpreadSheetMergedCellsRow;
begin
  ...
  if cxPointIsEqual(CachedPoint, APoint) or
    ((CachedCell <> nil) and CachedCell.Contains(ARow, AColumn)) then
    Result := CachedCell
  else
  begin
...
function TdxSpreadSheetMergedCellList.HasItemsInArea
...
function TdxSpreadSheetMergedCellList.GetItem(AIndex: Integer)
  : TdxSpreadSheetMergedCell;
begin
  Result := First;
...
constructor TdxSpreadSheetTableItem.Create(AOwner: TdxDynamicItemList;
AIndex: Integer);
begin
  inherited Create(AOwner, AIndex);
...
begin
  ...
  begin
    ...
    FStyle.Handle := View.CellStyles.AddClone(TdxSpreadSheetTableItem(ASource)
      .Style.Handle);
  end;
end;
...
procedure TdxSpreadSheetTableItem.EnumCells
...
begin
  ...
  APrevDPI := dxSpreadSheetPrepareCanvas(ACanvas, View.SpreadSheet.Font,
    dxDefaultDPI);
  try
    ASize := 0;
    EnumCells(procedure(ACell: TdxSpreadSheetCell)
      begin
...
function TdxSpreadSheetTableItem.GetFormatSettings
  : TdxSpreadSheetCustomFormatSettings;
begin
  Result := View.FormatSettings;
end;

procedure TdxSpreadSheetTableItem.ProcessStyleChanges(APrevStyle,
  ANewStyle: TdxSpreadSheetCellStyleHandle);
var
  ACell: TdxSpreadSheetCell;
  AList: TdxFastList;
...
begin
  ...
  View.BeginUpdate;
  try
    AStyleMergeHelper := TdxSpreadSheetCellStyleMergeHelper.Create(APrevStyle,
      ANewStyle);
    try
      APrevStyleIsDefault := APrevStyle = View.CellStyles.DefaultStyle;
      AList := TdxFastList.Create(CellCount);
      try
        Owner.GetOppositeItems.ForEach(procedure(AItem: TdxDynamicListItem)
          var
        ...
        for I := 0 to AList.Count - 1 do
          AStyleMergeHelper.ProcessCellStyle
            (TdxSpreadSheetCell(AList.List[I]).Style);
      finally
        AList.Free;
      end;
...
constructor TdxSpreadSheetTableItemGroup.Create
  (AOwner: TdxSpreadSheetTableItems; AParent: TdxSpreadSheetTableItemGroup;
AStartIndex, AFinishIndex: Integer);
begin
  inherited Create;
  FOwner := AOwner;
...
function TdxSpreadSheetTableItemGroup.Find(AIndex: Integer;
ARecursive: Boolean = True): TdxSpreadSheetTableItemGroup;
begin
  Result := nil;
...
procedure TdxSpreadSheetTableItemGroup.AddChild(AStartIndex,
...
begin
  ...
  else if AIndex = FinishIndex then
    FinishIndex := AIndex - 1
  else
  begin
    Parent.BeginUpdate;
    try
      ASecondPart := TdxSpreadSheetTableItemGroup.Create(Owner, Parent,
        AIndex + 1, FinishIndex);
      for I := Count - 1 downto 0 do
      begin
...
procedure TdxSpreadSheetTableItemGroup.SetParent
  (AParent: TdxSpreadSheetTableItemGroup);
var
...
begin
  ...
  begin
    if AParent.Level + MaxNestingLevel + 2 > dxSpreadSheetMaxOutlineLevel then
      raise EdxSpreadSheetError.Create
        (cxGetResourceString(@sdxErrorMaxOutlineLevel));
  end;
...
function TdxSpreadSheetTableItemGroup.GetExpandButtonPosition
  : TdxSpreadSheetTableItemGroupExpandButtonPosition;
begin
...
function TdxSpreadSheetTableItemGroup.GetItem(Index: Integer)
  : TdxSpreadSheetTableItemGroup;
begin
...
procedure TdxSpreadSheetTableItemGroup.SetExpanded(AValue: Boolean);
  ...
  procedure ChangeVisibility(AStartIndex, AFinishIndex: Integer;
  AValue: Boolean);
  var
    I: Integer;
  begin
    ...
    begin
      if AValue then
      begin
        Owner.ForEach(procedure(AItem: TdxDynamicListItem)
          begin
...
begin
  ...
  begin
    ...
    try
      ...
      try
        if History.CanAddCommand then
          History.AddCommand(TdxSpreadSheetHistoryChangeGroupRangeCommand.
            Create(Self));
        FFinishIndex := AValue;
...
function TdxSpreadSheetTableItemGroupComparer.Compare(const Left,
  Right: TdxSpreadSheetTableItemGroup): Integer;
begin
...
constructor TdxSpreadSheetTableItemGroupList.Create
  (AOwner: TdxSpreadSheetTableItemGroup);
begin
...
function TdxSpreadSheetTableItemGroupList.Find(AIndex: Integer;
ARecursive: Boolean = True): TdxSpreadSheetTableItemGroup;
var
...
function TdxSpreadSheetTableItemGroupList.GetRange(out AStartIndex,
  AFinishIndex: Integer): Boolean;
var
  AItem: TdxSpreadSheetTableItemGroup;
  I: Integer;
begin
...
procedure TdxSpreadSheetTableItemGroupList.Validate
    ...
    try
      ...
      begin
        ...
        begin
          AItem2.BeginUpdate;
          try
            AItem2.FCollapsedByUser := AItem2.FCollapsedByUser or
              AItem1.FCollapsedByUser;
...
procedure TdxSpreadSheetTableItemGroupList.ValidateRanges(AStartIndex,
  AFinishIndex: Integer);
var
  AItem: TdxSpreadSheetTableItemGroup;
  I: Integer;
...
procedure TdxSpreadSheetTableItemGroupList.Notify
  (const Item: TdxSpreadSheetTableItemGroup; Action: TCollectionNotification);
begin
...
constructor TdxSpreadSheetTableItemGroups.Create
  (AOwner: TdxSpreadSheetTableItems);
begin
  inherited Create;
...
procedure TdxSpreadSheetTableItemGroups.Delete(AStartIndex,
  AFinishIndex: Integer);
var
  AGroup: TdxSpreadSheetTableItemGroup;
begin
...
procedure TdxSpreadSheetTableItemGroups.ExpandToLevel(ALevel: Integer);
  ...
  procedure CheckExpandLevel(AGroup: TdxSpreadSheetTableItemGroup;
  ALevel: Integer);
  var
...
function TdxSpreadSheetTableItemGroups.Find(AIndex: Integer;
ARecursive: Boolean = True): TdxSpreadSheetTableItemGroup;
begin
...
function TdxSpreadSheetTableItemGroups.GetItem(Index: Integer)
  : TdxSpreadSheetTableItemGroup;
begin
  Result := Root.Items[Index];
end;

procedure TdxSpreadSheetTableItemGroups.SetExpandButtonPosition
  (AValue: TdxSpreadSheetTableItemGroupExpandButtonPosition);
begin
...
function TdxSpreadSheetTableItems.CreateItem(const AIndex: Integer)
  : TdxSpreadSheetTableItem;
begin
  Result := TdxSpreadSheetTableItem(inherited CreateItem(AIndex));
end;

function TdxSpreadSheetTableItems.GetDistance(AStartIndex,
  AFinishIndex: Integer): Integer;
var
...
begin
  ...
  begin
    ...
    ForEach(procedure(AItem: TdxDynamicListItem)
      begin
...
function TdxSpreadSheetTableItems.GetItemIndexFromDistance(AStartIndex: Integer;
ADistance: Integer): Integer;
var
  AInc: Integer;
begin
...
function TdxSpreadSheetTableItems.GetNextVisibleItemIndex(AIndex: Integer;
AGoForward: Boolean): Integer;
begin
...
function TdxSpreadSheetTableItems.GetNextVisibleItemIndex(AIndex: Integer;
AGoForward: Boolean; out AResult: Integer): Boolean;
begin
...
function TdxSpreadSheetTableItems.GetItemDisplayText
  (const AItem: TdxSpreadSheetTableItem): string;
begin
...
function TdxSpreadSheetTableItems.GetItemStyle(AIndex: Integer)
...
function TdxSpreadSheetTableItems.GetItemStyleHandle(AIndex: Integer)
  : TdxSpreadSheetCellStyleHandle;
var
  AItem: TdxSpreadSheetTableItem;
begin
...
begin
  ...
  begin
    if AItem.Visible then
      Result := AItem.Size
    else if not AItem.DefaultSize then
...
function TdxSpreadSheetTableItems.GetItem(AIndex: Integer)
  : TdxSpreadSheetTableItem;
begin
...
procedure TdxSpreadSheetTableItems.SetItem(AIndex: Integer;
const AValue: TdxSpreadSheetTableItem);
begin
...
function TdxSpreadSheetTableColumn.CreateCell(ARow: Integer)
  : TdxSpreadSheetCell;
begin
...
function TdxSpreadSheetTableColumn.MeasureCellSize(ACanvas: TcxCanvas;
ACell: TdxSpreadSheetCell): Integer;
begin
...
begin
  if CellCount > 0 then
  begin
    View.Rows.ForEach(procedure(AItem: TdxDynamicListItem)
      var
        ACell: TdxSpreadSheetCell;
      begin
...
function TdxSpreadSheetTableColumns.CreateItem(const AIndex: Integer)
  : TdxSpreadSheetTableColumn;
begin
  Result := TdxSpreadSheetTableColumn(inherited CreateItem(AIndex));
end;

function TdxSpreadSheetTableColumns.CreateItem(const AName: string)
  : TdxSpreadSheetTableColumn;
begin
...
begin
  Result := TdxSpreadSheetColumnReferences.NameByIndex(AIndex,
    View.SpreadSheet.OptionsView.R1C1Reference);
end;

function TdxSpreadSheetTableColumns.GetItemState(AIndex: Integer)
  : TcxButtonState;
begin
...
function TdxSpreadSheetTableColumns.GetItem(AIndex: Integer)
  : TdxSpreadSheetTableColumn;
begin
...
constructor TdxSpreadSheetTableRow.Create(AOwner: TdxDynamicItemList;
AIndex: Integer);
begin
  inherited Create(AOwner, AIndex);
...
function TdxSpreadSheetTableRow.CreateCell(AColumn: Integer)
  : TdxSpreadSheetCell;
begin
  Result := TdxSpreadSheetCell(FCells.CreateItem(AColumn));
end;

procedure TdxSpreadSheetTableRow.EnumCells
  (AEnumProc: TdxSpreadSheetTableItemEnumProc);
begin
  RowCells.ForEach(procedure(AItem: TdxDynamicListItem)
    begin
...
function TdxSpreadSheetTableRow.MeasureCellSize(ACanvas: TcxCanvas;
ACell: TdxSpreadSheetCell): Integer;
begin
...
function TdxSpreadSheetTableRows.CreateItem(const AIndex: Integer)
  : TdxSpreadSheetTableRow;
begin
...
procedure TdxSpreadSheetTableRows.ForEachCell(AArea: TRect;
AProc: TdxDynamicItemListForEachProcRef; AGoForward: Boolean = True);
begin
  ForEach(procedure(AItem: TdxDynamicListItem)
    begin
      TdxSpreadSheetTableRow(AItem).RowCells.ForEach(AProc, AArea.Left,
        AArea.Right, AGoForward);
    end, AArea.Top, AArea.Bottom, AGoForward);
end;
...
function TdxSpreadSheetTableRows.GetItem(AIndex: Integer)
  : TdxSpreadSheetTableRow;
begin
...
procedure TdxSpreadSheetTableViewOptionsPrint.SetHeaderFooter
  (AValue: TdxSpreadSheetTableViewOptionsPrintHeaderFooter);
begin
  FHeaderFooter.Assign(AValue);
end;

procedure TdxSpreadSheetTableViewOptionsPrint.SetPage
  (AValue: TdxSpreadSheetTableViewOptionsPrintPage);
begin
  FPage.Assign(AValue);
end;

procedure TdxSpreadSheetTableViewOptionsPrint.SetPagination
  (AValue: TdxSpreadSheetTableViewOptionsPrintPagination);
begin
  FPagination.Assign(AValue);
end;

procedure TdxSpreadSheetTableViewOptionsPrint.SetPrinting
  (AValue: TdxSpreadSheetTableViewOptionsPrintPrinting);
begin
  FPrinting.Assign(AValue);
end;

procedure TdxSpreadSheetTableViewOptionsPrint.SetSource
  (AValue: TdxSpreadSheetTableViewOptionsPrintSource);
begin
...
begin
  ...
  begin
    ...
    FHorizontalScrollBar := TdxSpreadSheetTableViewOptions(Source)
      .HorizontalScrollBar;
    FShowFormulas := TdxSpreadSheetTableViewOptions(Source).ShowFormulas;
    FRightToLeftLayout := TdxSpreadSheetTableViewOptions(Source)
      .RightToLeftLayout;
    FVerticalScrollBar := TdxSpreadSheetTableViewOptions(Source)
      .VerticalScrollBar;
...
begin
  Result := dxDefaultBooleanToBoolean(HorizontalScrollBar,
    OptionsView.HorizontalScrollBar);
end;
...
begin
  Result := dxDefaultBooleanToBoolean(RightToLeftLayout,
    View.SpreadSheet.BiDiMode = bdRightToLeft);
end;

function TdxSpreadSheetTableViewOptions.GetActualVerticalScrollBar: Boolean;
begin
  Result := dxDefaultBooleanToBoolean(VerticalScrollBar,
    OptionsView.VerticalScrollBar);
end;
...
function TdxSpreadSheetTableViewOptions.GetOptionsView
  : TdxSpreadSheetOptionsView;
begin
...
procedure TdxSpreadSheetTableViewOptions.SetGridLines
...
procedure TdxSpreadSheetTableViewOptions.SetShowFormulas
  (AValue: TdxDefaultBoolean);
begin
...
procedure TdxSpreadSheetTableViewOptions.SetRightToLeftLayout
  (AValue: TdxDefaultBoolean);
begin
...
procedure TdxSpreadSheetTableViewOptions.SetHorizontalScrollBar
  (AValue: TdxDefaultBoolean);
begin
...
procedure TdxSpreadSheetTableViewOptions.SetVerticalScrollBar
  (AValue: TdxDefaultBoolean);
begin
...
procedure TdxSpreadSheetTableViewOptions.SetZeroValues
  (AValue: TdxDefaultBoolean);
begin
...
begin
  AValue := Max(dxSpreadSheetMinimumZoomFactor,
    Min(dxSpreadSheetMaximumZoomFactor, AValue));
...
constructor TdxSpreadSheetTableViewSelection.Create
  (AOwner: TdxSpreadSheetTableView);
begin
  inherited Create;
  FView := AOwner;
...
AShift: TShiftState = []; AFocusedRow: Integer = -1;
AFocusedColumn: Integer = -1);
var
  ARect: TcxRect;
  APrevArea: TRect;
...
begin
  ...
  if (FItems.Count > 1) and not dxSpreadSheetContains(FItems.Last.Rect,
    APrevRow, APrevColumn) then
  begin
  ...
  begin
    ...
    try
      ...
      begin
        if View.Controller.DoActiveCellChanging(AFocusedColumn, AFocusedRow)
        then
        begin
...
function TdxSpreadSheetTableViewSelection.IsCellSelected(ARow,
  AColumn: Integer): Boolean;
var
  I: Integer;
begin
  Result := (ARow = FocusedRow) and (AColumn = FocusedColumn) and
    (FocusedRow >= 0) and (FocusedColumn >= 0);
  I := 0;
...
function TdxSpreadSheetTableViewSelection.IsColumnSelected
  (AColumn: Integer): Boolean;
var
  I: Integer;
begin
...
function TdxSpreadSheetTableViewSelection.IsEntireColumnSelected
  (AColumn: Integer): Boolean;
var
  AItem: TcxRect;
  I: Integer;
...
function TdxSpreadSheetTableViewSelection.IsEntireRowSelected
...
begin
  Add(dxSpreadSheetEntireSheetArea, [], Max(0, FocusedRow),
    Max(0, FocusedColumn));
end;

procedure TdxSpreadSheetTableViewSelection.SelectCell(ARow, AColumn: Integer;
AShift: TShiftState = []);
begin
  Add(Rect(AColumn, ARow, AColumn, ARow), AShift);
end;

procedure TdxSpreadSheetTableViewSelection.SelectColumns(AStartColumn,
  AFinishColumn: Integer; AShift: TShiftState = []);
var
  ARow: Integer;
begin
  ARow := FocusedRow;
  if not(ssShift in AShift) or not cxInRange(ARow, View.TopRow, View.BottomRow)
    or not SelectionByColumns then
    ARow := View.TopRow;
  Add(Rect(Min(AStartColumn, AFinishColumn), 0, Max(AStartColumn,
    AFinishColumn), dxSpreadSheetMaxRowIndex), AShift, ARow);
end;

procedure TdxSpreadSheetTableViewSelection.SelectRows(AStartRow,
  AFinishRow: Integer; AShift: TShiftState = []);
var
  AColumn: Integer;
begin
  AColumn := FocusedColumn;
  if not(ssShift in AShift) and not cxInRange(AColumn, View.LeftColumn,
    View.RightColumn) or not SelectionByRows then
    AColumn := View.LeftColumn;
  Add(Rect(0, Min(AStartRow, AFinishRow), dxSpreadSheetMaxColumnIndex,
    Max(AStartRow, AFinishRow)), AShift, -1, AColumn);
end;

procedure TdxSpreadSheetTableViewSelection.SetFocused(ARow, AColumn: Integer;
AShift: TShiftState);

  function CheckMoveFocus: Boolean;
  begin
    Result := False;
    if IsCellSelected(ARow, AColumn) and View.Controller.DoActiveCellChanging
      (AColumn, ARow) then
    begin
      CheckClear(AShift);
      Result := Count > 0;
...
function TdxSpreadSheetTableViewSelection.CanSelectArea
  (const AArea: TRect): Boolean;
begin
  Result := View.OptionsProtection.ActualAllowSelectLockedCells and
    View.OptionsProtection.ActualAllowSelectUnlockedCells;
  if not Result then
...
procedure TdxSpreadSheetTableViewSelection.CheckClear
...
procedure TdxSpreadSheetTableViewSelection.GetState(ARow, AColumn: Integer;
var AFocused, ASelected: Boolean);
var
  I: Integer;
begin
  ASelected := False;
  AFocused := dxSpreadSheetContains(MergedCells.ExpandArea(FocusedColumn,
    FocusedRow), ARow, AColumn);
  for I := 0 to Count - 1 do
  begin
...
function TdxSpreadSheetTableViewSelection.IsMergedCells
  (const AArea: TRect): Boolean;
var
  I: Integer;
begin
...
function TdxSpreadSheetTableViewSelection.GetFocusedContainer
  : TdxSpreadSheetContainer;
begin
...
function TdxSpreadSheetTableViewSelection.GetMergedCells
  : TdxSpreadSheetMergedCellList;
begin
...
begin
  Result := (Count > 0) and
    (Items[Count - 1].Bottom >= dxSpreadSheetMaxRowIndex);
end;

function TdxSpreadSheetTableViewSelection.GetSelectionByRows: Boolean;
begin
  Result := (Count > 0) and
    (Items[Count - 1].Right >= dxSpreadSheetMaxColumnIndex);
end;

procedure TdxSpreadSheetTableViewSelection.SetFocusedCell
  (AValue: TdxSpreadSheetCell);
begin
  if AValue <> nil then
...
procedure TdxSpreadSheetTableViewSelection.SetFocusedContainer
  (const Value: TdxSpreadSheetContainer);
begin
...
constructor TdxSpreadSheetTableViewEditingController.Create
  (AOwner: TdxSpreadSheetTableViewController);
begin
...
class function TdxSpreadSheetTableViewEditingController.CanFinishEditingOnExit
...
begin
  ...
  begin
    ...
    begin
      if Supports(AEdit.Owner, IdxSpreadSheet, AIntf2) and
        Supports(AFocusedControl.Owner, IdxSpreadSheet, AIntf1) then
...
begin
  ...
  begin
    ...
    begin
      Result := Supports(AFocusedControl.Owner, IdxSpreadSheet, AIntf) and
        (AIntf.GetControl = ASheet.SpreadSheet);
      if Result then
        AEdit := TdxSpreadSheetCustomInplaceEdit(AFocusedControl);
    end
    else if ASheet.EditingController.Edit is TdxSpreadSheetCustomInplaceEdit
    then
    begin
...
class function TdxSpreadSheetTableViewEditingController.GetEditingText
  (AEdit: TcxCustomEdit): string;
begin
...
procedure TdxSpreadSheetTableViewEditingController.ShowEditByMouse(X,
...
begin
  ...
  if ACell <> nil then
    ...
    else if ACell.AsFormula <> nil then
...
begin
  ...
  if Edit.ActiveProperties is TcxCustomRichEditProperties then
    TcxCustomRichEditProperties(Edit.ActiveProperties).ZoomFactor :=
      View.ZoomFactor / 100
  else
    EditStyleFont.Height :=
      MulDiv(dxSystemScaleFactor.Revert(EditStyleFont.Height),
      View.ZoomFactor, 100);
...
begin
  ...
  begin
    ...
    begin
      View.CheckProtection(cmmReplace, cxRectBounds(CellViewInfo.Column,
        CellViewInfo.Row, 0, 0));
...
function TdxSpreadSheetTableViewEditingController.
  CanInsertNewAreaViaMouse: Boolean;
begin
...
begin
  Result := IsEditing and not VarIsNull(RedoValue) and
    VarEquals(Edit.EditValue, EditValue);
end;
...
function TdxSpreadSheetTableViewEditingController.
  CanUpdateMultilineEditHeight: Boolean;
begin
  Result := CanUpdateEditValue and not Edit.IsHiding and Edit.Focused;
end;

function TdxSpreadSheetTableViewEditingController.CreateDefaultEdit
  : TcxCustomMemo;
begin
...
function TdxSpreadSheetTableViewEditingController.CreateDefaultEditProperties
...
function TdxSpreadSheetTableViewEditingController.CreateReferenceHighlighter
  : TdxSpreadSheetCustomReferenceHighlighter;
begin
...
begin
  if IsOurAction(FindControl(GetFocus)) or IsOurAction(Screen.ActiveControl) or
    not CanFinishEditingOnExit(Edit) then
    Exit;
...
procedure TdxSpreadSheetTableViewEditingController.EditFocusChanged
  (Sender: TObject);
begin
...
procedure TdxSpreadSheetTableViewEditingController.EditKeyDown(Sender: TObject;
...
procedure TdxSpreadSheetTableViewEditingController.EditKeyPress(Sender: TObject;
var Key: Char);
begin
...
procedure TdxSpreadSheetTableViewEditingController.EditKeyUp(Sender: TObject;
var Key: Word; Shift: TShiftState);
begin
...
function TdxSpreadSheetTableViewEditingController.
  GetAdjustedMultilineEditBounds: TRect;
var
  AText: string;
  ASizeProperties: TcxEditSizeProperties;
  ATextBounds, AMergedArea: TRect;
const
  AHorzAlignToTextAlign: array [TcxTextAlignX] of TAlignment = (taLeftJustify,
    taCenter, taRightJustify, taLeftJustify, taLeftJustify);
begin
  FAlignment := taLeftJustify;
  AMergedArea := View.MergedCells.ExpandArea(View.Selection.FocusedColumn,
    View.Selection.FocusedRow);
  AText := DefaultEdit.Text;
  if (AText <> '') and dxCharInSet(AText[Length(AText)], dxBreakLineCharacters)
  then
    AText := AText + ' ';
  ATextBounds := cxRectSetSize(cxNullRect,
    GetEditSize(AText, cxDefaultEditSizeProperties));
  if CellViewInfo <> nil then
  begin
  ...
  Result := cxRectSetHeight(Result, View.Rows.GetDistance(AMergedArea.Top,
    AMergedArea.Bottom));
  ATextBounds := Result;
  if AText <> '' then
  begin
    ...
    ATextBounds.Bottom := ATextBounds.Top + Max(cxRectHeight(Result),
      GetEditSize(AText, ASizeProperties).cy);
  end;
...
function TdxSpreadSheetTableViewEditingController.
  GetAdjustedEditBoundsHorizontally(const AArea, ATextRect: TRect): TRect;
var
  AClip, R: TRect;
  AWidth: Integer;
begin
  ...
  AWidth := 0;
  Result := ATextRect;
  if (CellViewInfo <> nil) and not CellViewInfo.Multiline and not CellViewInfo.IsMerged
  then
  begin
  ...
  if (Cell = nil) or not(csWordWrap in Cell.StyleHandle.States) and (AWidth > 0)
  then
  begin
  ...
  begin
    ...
    else if Result.Right > AClip.Right then
    begin
...
function TdxSpreadSheetTableViewEditingController.
  GetAdjustedEditBoundsVertically(const AArea, ATextRect: TRect): TRect;
var
  ARow: Integer;
  ABounds: TRect;
begin
  ...
  while (ARow < dxSpreadSheetMaxRowCount - 1) and
    (ATextRect.Bottom > ABounds.Bottom) do
  begin
    Inc(ARow);
...
function TdxSpreadSheetTableViewEditingController.GetAreaBounds
  (const AArea: TRect): TRect;
begin
  Result := ViewInfo.ContentRectToScreenRect(ViewInfo.GetAreaBounds(AArea));
end;

function TdxSpreadSheetTableViewEditingController.
  GetCancelEditingOnExit: Boolean;
begin
  Result := False;
end;
...
begin
  ...
  Dec(P.X, 2);
  Result.X := 1;
  Result.Y := Min(DefaultEdit.Lines.Count,
    P.Y div cxTextHeight(DefaultEdit.Style.Font));
  S := DefaultEdit.Lines[Result.Y];
  while (Result.X <= Length(S)) and
    (cxTextWidth(DefaultEdit.Style.Font, Copy(S, 1, Result.X)) < P.X) do
    Inc(Result.X);
end;
...
begin
  ...
  if ACellViewInfo.IsMerged then
    ABounds := ATableViewInfo.GetAreaBounds(ACellViewInfo.Row,
      ACellViewInfo.Column, ACellViewInfo.MergedCell.Area, ABounds);

  Result := ATableViewInfo.ContentRectToScreenRect
    (ACellViewInfo.ContentRect(ABounds));
...
begin
  if ACell = nil then
    Result := Null
  else if ACell.IsPartOfArrayFormula(AFormulaArea, @AArrayFormula) = afpSlaveCell
  then
    Result := AArrayFormula.AsText
  else if ACell.IsFormula then
    Result := ACell.AsFormula.AsText
  else if AAllowRTF and dxSpreadSheetTextService.GetAsRTF(ACell, ARTFText) then
    Result := ARTFText
  else
...
procedure TdxSpreadSheetTableViewEditingController.SetValue
...
begin
  ...
  if (ACell <> nil) and (ACell.IsPartOfArrayFormula(AFormulaArea) <> afpNone)
    and dxSpreadSheetIsValidArea(AFormulaArea) and
    not cxPointIsEqual(AFormulaArea.TopLeft, AFormulaArea.BottomRight) then
  begin
    ASelectedArea := View.GetArrayFormulaArea(ACell.RowIndex,
      ACell.ColumnIndex);
    if not(IsArrayFormula and View.CanModifyDataInArrayFormulaArea
      (ASelectedArea, cmmReplace)) then
      raise EdxSpreadSheetCannotChangePartOfArrayError.Create
        (cxGetResourceString(@sdxErrorCannotChangePartOfArray));
    View.AddArrayFormula(ATextValue, ASelectedArea);
  end
  else if VarIsNull(AValue) and (ACell <> nil) then
  ...
  begin
    ...
    try
      if IsArrayFormula then
        View.AddArrayFormula(ATextValue,
          View.GetArrayFormulaArea(ACellPosition.Y, ACellPosition.X))
      else if IsEditValueFormula then
        ACell.SetTextCore(ATextValue, True, (ACell.AsFormula <> nil) and
          ACell.AsFormula.IsArrayFormula)
      else if not dxSpreadSheetTextService.SetAsRTF(ACell, AValue) then
      begin
...
const
  AlignmentMap: array [TAlignment] of TcxParaFormat2Alignment = (pfaLeft,
    pfaRight, pfaCenter);
begin
  if Edit <> nil then
  begin
    Edit.BoundsRect := GetAdjustedMultilineEditBounds;
    if (Edit is TcxCustomRichEdit) and
      (not IsEditValueFormula and ((Cell = nil) or not Cell.IsFormula)) then
...
function TdxSpreadSheetTableViewEditingController.PrepareEdit
...
procedure TdxSpreadSheetTableViewEditingController.ReplaceEditValue
...
function TdxSpreadSheetTableViewEditingController.IsAutoCompleteAllowed
  : Boolean;
begin
...
function TdxSpreadSheetTableViewEditingController.
  IsAutoCompleteSuggestionsHintsAllowed: Boolean;
begin
  Result := SpreadSheet.OptionsBehavior.FormulaAutoCompleteShowHint;
end;

procedure TdxSpreadSheetTableViewEditingController.KeyDown(var Key: Word;
ShiftState: TShiftState);
begin
  Controller.KeyDown(Key, ShiftState);
end;

procedure TdxSpreadSheetTableViewEditingController.Post(AIsArrayFormula
  : Boolean = False);
begin
...
function TdxSpreadSheetTableViewEditingController.GetCellViewInfo
  : TdxSpreadSheetTableViewCellViewInfo;
begin
...
begin
  if (SpreadSheet.FDefaultEdit = nil) or
    (SpreadSheet.FDefaultEdit.Properties.ClassType <>
    DefaultEditProperties.ClassType) then
  begin
    FreeAndNil(SpreadSheet.FDefaultEdit);
...
begin
  ...
  Result := DefaultEditProperties.GetEditContentSize(cxScreenCanvas,
    DefaultEdit.Style, True, AText, ASizeProperties);
...
function TdxSpreadSheetTableViewEditingController.GetSpreadSheet
  : TdxCustomSpreadSheet;
begin
  Result := View.SpreadSheet;
end;

function TdxSpreadSheetTableViewEditingController.GetView
  : TdxSpreadSheetTableView;
begin
  Result := Controller.View;
end;

function TdxSpreadSheetTableViewEditingController.GetViewInfo
  : TdxSpreadSheetTableViewInfo;
begin
...
function TdxSpreadSheetInplaceEdit.GetController
  : IdxSpreadSheetInplaceEditController;
begin
...
procedure TdxSpreadSheetTableViewCellHintController.Show(ACellViewInfo
  : TdxSpreadSheetCellViewInfo);
...
begin
  if (FLockHintCount = 0) and
    ((FHintToDisplay = nil) or NeedShowHint(ACellViewInfo)) then
  begin
    Hide;
    ...
    begin
      ...
      begin
        ...
        if havScreenTip in AHyperlink.AssignedValues then
          ...
          FHintText := Format(GetFormatStringForHint,
            [dxSpreadSheetFormulaExcludeEqualSymbol(AHyperlink.Value)]);
      end;
    end;
...
begin
  ...
  else if ACellViewInfo is TdxSpreadSheetCommentContainerViewInfo then
...
begin
  ...
  else if ACellViewInfo is TdxSpreadSheetContainerViewInfo then
    Result := TdxSpreadSheetContainerViewInfo(ACellViewInfo).Owner.Hyperlink
  else
    Result := nil;
end;

function TdxSpreadSheetTableViewCellHintController.NeedShowHint
  (ACellViewInfo: TdxSpreadSheetCellViewInfo): Boolean;
begin
  Result := (GetComment(ACellViewInfo) <> HintToDisplay.Ref) and
    (HintToDisplay.Ref <> ACellViewInfo);
end;
...
begin
  ...
  else if FHintToDisplay.Ref is TdxSpreadSheetTableViewCellViewInfo then
    ReleaseCellHint(TdxSpreadSheetCellViewInfo(FHintToDisplay.Ref));
end;

function TdxSpreadSheetTableViewCellHintController.GetHintHelper
  : TcxControlHintHelper;
begin
  Result := View.Controller.HintHelper;
end;

function TdxSpreadSheetTableViewCellHintController.GetView
  : TdxSpreadSheetTableView;
begin
  Result := TdxSpreadSheetTableView(inherited View);
end;

procedure TdxSpreadSheetTableViewCellHintController.DelayTimerHandler
  (Sender: TObject);
begin
  FreeAndNil(FDelayTimer);
  FHintVisible := True;
...
procedure TdxSpreadSheetTableViewCellHintController.ReleaseCellHint
...
procedure TdxSpreadSheetTableViewCellHintController.ReleaseContainer
  (AContainer: TdxSpreadSheetContainer);
begin
...
procedure TdxSpreadSheetTableViewCellHintController.ShowCellHint
  (ACell: TdxSpreadSheetCellViewInfo);
var
  AHintBounds: TRect;
...
begin
  ...
  AHintBounds := cxRectOffset(cxRect(AClientMousePos, Point(SpreadSheet.Width,
    SpreadSheet.Height)), 0, cxGetCursorSize.cy);
  if FHintText <> '' then
    HintHelper.ShowHint(AHintBounds, cxTextRect(AHintBounds), HintText,
      True, ACell)
  else
    Hide;
end;

procedure TdxSpreadSheetTableViewCellHintController.ShowContainer
  (AContainer: TdxSpreadSheetContainer);
var
  ARect: TRect;
begin
  ...
  begin
    ...
    begin
      ARect := TdxSpreadSheetCommentContainer.GetDefaultPosition
        (TdxSpreadSheetCommentContainer(AContainer).Cell);
...
constructor TdxSpreadSheetHintHelper.Create
  (AOwner: TdxSpreadSheetTableViewController);
begin
  FOwner := AOwner;
end;
...
begin
  ...
  FClickTimer := cxCreateTimer(ClickTimerHandler, GetDblClickInterval *
    2, False);
...
procedure TdxSpreadSheetTableViewController.ApplyBestFitForSelectedHeaderCells
  (ACells: TdxSpreadSheetCellViewInfoList);
var
...
function TdxSpreadSheetTableViewController.CalculateNewFocusedRowIndex
  (AOffsetFromFirstRow: Integer): Integer;
begin
...
begin
  ...
  case AKey of
    ...
    Chr(186):
      EditingController.ShowEdit(dxGetFormattedResult(Date,
        View.FormatSettings.Data.ShortDateFormat).Text);
    Chr(192):
      View.ToggleShowFormulas;
    Chr(222):
      EditingController.ShowEditWithTopCellValue(FocusedRow,
        FocusedColumn, True);
  end;
end;

procedure TdxSpreadSheetTableViewController.CheckCtrlShiftCommand
  (const AKey: Word);
begin
  if View.OptionsProtection.ActualAllowFormatCells then
    case AKey of
  ...
  case AKey of
    ...
    186:
      EditingController.ShowEdit(dxGetFormattedResult(Time,
        'hh:mm AM/PM').Text);
    187:
      View.InsertCells;
    222:
...
procedure TdxSpreadSheetTableViewController.CheckScrollArea(const P: TPoint);
  ...
  begin
    Result := (SelectionMode <> smNone) or
      (SpreadSheet.DragAndDropState = ddsInProcess);
  end;

  function IsPtInScrollableArea: Boolean;
  begin
    Result := (PtInRect(ViewInfo.ScrollableArea, P) or
      not PtInRect(cxRectOffset(ViewInfo.CellsArea,
      View.GetPartOffsetByPoint(P), False), P)) and
      not PtInRect(cxRectInflate(ViewInfo.ScrollableArea,
      -dxSpreadSheetScrollAreaWidth), P);
  end;
...
function TdxSpreadSheetTableViewController.ContextPopup
  (const P: TPoint): Boolean;
begin
...
function TdxSpreadSheetTableViewController.CreateEditingController
  : TdxSpreadSheetTableViewEditingController;
begin
...
begin
  ...
  begin
    ...
    EditingController.ShowEditByMouse(APos.X, APos.Y,
      KeyboardStateToShiftState);
end;

function TdxSpreadSheetTableViewController.ExpandDataRegion
  (const AArea: TRect): TRect;
begin
  Result := AArea;
  ...
  if IsColumnPartHasContent(AArea.Left - 1, AArea.Top - 1, AArea.Bottom + 1)
  then
    Result.Left := AArea.Left - 1;
  if IsColumnPartHasContent(AArea.Right + 1, AArea.Top - 1, AArea.Bottom + 1)
  then
...
function TdxSpreadSheetTableViewController.IMEComposition
  (var AMessage: TMessage): Boolean;
begin
...
function TdxSpreadSheetTableViewController.IsColumnPartHasContent(const AColumn,
  AStartRow, AEndRow: Integer): Boolean;
var
  ARow: TdxSpreadSheetTableItem;
begin
  Result := False;
  if InRange(AColumn, 0, dxSpreadSheetMaxColumnIndex) then
  begin
    ARow := View.Rows.First;
    while (ARow <> nil) and (ARow.Index < AStartRow) do
      ARow := TdxSpreadSheetTableItem(ARow.FNext);
    while (ARow <> nil) and (ARow.Index <= AEndRow) do
    begin
      if not ARow.Cells[AColumn].IsEmpty then
        Exit(True);
      ARow := TdxSpreadSheetTableItem(ARow.FNext);
    end;
  end;
...
function TdxSpreadSheetTableViewController.IsRowPartHasContent(const ARow,
  AStartColumn, AEndColumn: Integer): Boolean;
var
  ACell: TdxSpreadSheetCell;
  ARowItem: TdxSpreadSheetTableRow;
begin
  Result := False;
  if InRange(ARow, 0, dxSpreadSheetMaxRowIndex) then
  begin
    ARowItem := View.Rows.Items[ARow];
    if ARowItem = nil then
      Exit;

    ACell := TdxSpreadSheetCell(ARowItem.RowCells.First);
    while (ACell <> nil) and (ACell.Index < AStartColumn) do
      ACell := TdxSpreadSheetCell(ACell.FNext);
    while (ACell <> nil) and (ACell.Index <= AEndColumn) do
    begin
...
begin
  ...
  if (dxSpreadSheetAreaWidth(AArea) > 1) or (dxSpreadSheetAreaHeight(AArea) > 1)
  then
    Selection.SelectAll
  else
  begin
    AArea := GetDataRegionAroundActiveCell;
    if (dxSpreadSheetAreaWidth(AArea) = 1) and
      (dxSpreadSheetAreaHeight(AArea) = 1) then
      Selection.SelectAll
    else
...
begin
  ...
  if cxRectIsEqual(R, cxRect(ACell.ColumnIndex, ACell.RowIndex,
    ACell.ColumnIndex, ACell.RowIndex)) then
    Exit;
  ...
  begin
    ...
    begin
      ...
      if not((ARow = ACell.RowIndex) and (AColumn = ACell.ColumnIndex)) then
        Result := not dxSpreadSheetContains(AArea, ARow, AColumn) or
          (not Rows[ARow].Visible) or (not Columns[AColumn].Visible);
      Inc(J);
    end;
    Inc(I);
  end;
...
procedure TdxSpreadSheetTableViewController.FocusContainer
  (AContainer: TdxSpreadSheetContainer; AMakeVisible: Boolean);
begin
...
procedure TdxSpreadSheetTableViewController.FocusNextPossibleCell
  (ADirection: TcxArrowDirection; AUnlockedCellsOnly: Boolean);

  function FindNextCell(var X, Y: Integer; const AArea: TRect;
  ASelectionAreaIndex: Integer; ANextX, ANextY, APrevX,
    APrevY: TcxArrowDirection): Boolean;
  var
    ATempValue: Integer;
  begin
    ...
    begin
      if (X > AArea.Right) or not Result and (X >= AArea.Right) then
        Result := GetNextVisibleCell(AArea.Left - 1, ANextX, X) and
          GetNextVisibleCell(Y, ANextY, Y)
      else if (X < AArea.Left) or not Result and (X <= AArea.Left) then
        Result := GetNextVisibleCell(AArea.Right + 1, APrevX, X) and
          GetNextVisibleCell(Y, APrevY, Y);
...
begin
  ...
  if not(Selection.IsAreaMoreThanOneCell and GetSelectionAreaByFocusedCell
    (ARect, ASelectionAreaIndex)) then
  begin
  ...
  begin
    if ADirection in [adLeft, adRight] then
      ACell := FindUnlockedCellByColumn(ARect, ASelectionAreaIndex, FocusedRow,
        FocusedColumn, AGoForward)
    else
      ACell := FindUnlockedCellByRow(ARect, ASelectionAreaIndex, FocusedRow,
        FocusedColumn, AGoForward);

    if ACell <> nil then
      Selection.SetFocused(ACell.RowIndex, ACell.ColumnIndex,
        ShiftStateForFocusing[ASelectionAreaIndex >= 0]);
  end
  else
  begin
    ARow := FocusedRow;
    AColumn := FocusedColumn;
    if ADirection in [adLeft, adRight] then
      AResult := FindNextCell(AColumn, ARow, ARect, ASelectionAreaIndex,
        adRight, adDown, adLeft, adUp)
    else
      AResult := FindNextCell(ARow, AColumn, cxRectRotate(ARect),
        ASelectionAreaIndex, adDown, adRight, adUp, adLeft);

    if not AResult then
      GetNextSelectedAreaCell(ASelectionAreaIndex, AGoForward, ARow, AColumn);
    Selection.SetFocused(ARow, AColumn,
      ShiftStateForFocusing[ASelectionAreaIndex >= 0]);
  end;
end;

function TdxSpreadSheetTableViewController.GetNextCellInDataBlock
  (AItem: TdxSpreadSheetTableItem; ACellIndex: Integer;
AGoForward: Boolean): Integer;

  function CanSelect(ACell: TdxSpreadSheetCell;
  AAllowSelectLocked, AAllowSelectUnlocked, AIsNavigationByColumn
    : Boolean): Boolean;
  var
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        else if CanSelect(ACell, AAllowSelectLocked, AAllowSelectUnlocked,
          AIsNavigationByColumn) then
        begin
          Result := AIndex;
...
function TdxSpreadSheetTableViewController.GetNextColumn
  (AColumn: TdxSpreadSheetTableColumn; AGoForward: Boolean)
  : TdxSpreadSheetTableColumn;
begin
  if AGoForward then
...
function TdxSpreadSheetTableViewController.GetNextNonEmptyCell
  (AItems: TdxSpreadSheetTableItems; AFocusedItemIndex, AFocusedCellIndex
  : Integer; AGoForward: Boolean): Integer;
var
  AIndex: Integer;
  AItem: TdxSpreadSheetTableItem;
begin
...
function TdxSpreadSheetTableViewController.GetNextRow
  (ARow: TdxSpreadSheetTableRow; AGoForward: Boolean): TdxSpreadSheetTableRow;
begin
  if AGoForward then
...
function TdxSpreadSheetTableViewController.GetNextUnlockedCellByColumn
  (const AArea: TRect; AStartRow, AStartColumn: Integer; AGoForward: Boolean)
  : TdxSpreadSheetCell;

  function IsCellReallyNext(ACell: TdxSpreadSheetCell): Boolean;
  begin
    if AGoForward then
      Result := ((ACell.RowIndex > AStartRow) or (ACell.RowIndex = AStartRow)
        and (ACell.ColumnIndex > AStartColumn)) and
  ...
  if AFirstColumn <> nil then
    ...
    begin
      ...
      begin
        ...
        while (AColumn <> nil) and (Result = nil) and
          dxSpreadSheetContainsColumn(AArea, AColumn.Index) do
        begin
          if AColumn.Visible then
          begin
            ACell := ARow.Cells[AColumn.Index];
            if (ACell <> nil) and not(csLocked in ACell.StyleHandle.States) and
              IsCellReallyNext(ACell) then
              Result := ACell;
          end;
...
function TdxSpreadSheetTableViewController.GetNextUnlockedCellByRow
  ...
  begin
    if AGoForward then
      Result := ((ACell.ColumnIndex > AStartColumn) or
        ((ACell.ColumnIndex = AStartColumn) and (ACell.RowIndex > AStartRow)))
        and CanFocusMergedCellsPart(AArea, ACell, AGoForward)
    else
      Result := ((ACell.ColumnIndex < AStartColumn) or
        ((ACell.ColumnIndex = AStartColumn) and (ACell.RowIndex < AStartRow)))
        and CanFocusMergedCellsPart(AArea, ACell, AGoForward);
...
begin
  ...
  if AFirstRow <> nil then
    ...
    begin
      if AColumn.Visible and dxSpreadSheetContainsColumn(AArea, AColumn.Index)
      then
      begin
        ARow := AFirstRow;
        while (ARow <> nil) and (Result = nil) and
          dxSpreadSheetContainsRow(AArea, ARow.Index) do
        begin
...
function TdxSpreadSheetTableViewController.GetNextVisibleCell(AIndex: Integer;
ADirection: TcxArrowDirection): Integer;
begin
...
function TdxSpreadSheetTableViewController.GetNextVisibleCell(AIndex: Integer;
ADirection: TcxArrowDirection; out AResult: Integer): Boolean;

  function ExpandAreaByMergedCells(AIndex: Integer;
...
begin
  ...
  Result := AItems.GetNextVisibleItemIndex(AIndex,
    ADirection in [adRight, adDown], AResult);
  ...
  begin
    ...
    else if (AResult < AIndex2) and (AIndex - 1 < AIndex2) then
      Result := AItems.GetNextVisibleItemIndex(AIndex1, False, AResult)
  end;
end;

function TdxSpreadSheetTableViewController.GetSearchAreaFirstColumn
  (const AArea: TRect): TdxSpreadSheetTableColumn;
var
  AColumn: TdxSpreadSheetTableColumn;
begin
  Result := nil;
...
function TdxSpreadSheetTableViewController.GetSearchAreaFirstRow
  (const AArea: TRect): TdxSpreadSheetTableRow;
var
  ARow: TdxSpreadSheetTableRow;
begin
  Result := nil;
...
function TdxSpreadSheetTableViewController.GetSearchAreaLastColumn
  (const AArea: TRect): TdxSpreadSheetTableColumn;
var
  AColumn: TdxSpreadSheetTableColumn;
begin
...
function TdxSpreadSheetTableViewController.GetSearchAreaLastRow
  (const AArea: TRect): TdxSpreadSheetTableRow;
var
  ARow: TdxSpreadSheetTableRow;
begin
...
function TdxSpreadSheetTableViewController.GetNextSelectedAreaIndex
  (AIndex: Integer; AGoForward: Boolean): Integer;
begin
...
function TdxSpreadSheetTableViewController.GetSelectionAreaByFocusedCell
  (out ARect: TRect; out AIndex: Integer): Boolean;
begin
  Result := False;
...
function TdxSpreadSheetTableViewController.GetSelectionItem(ASide: TcxBorder;
AShift: TShiftState): Integer;
var
  R: TRect;
begin
  ...
  begin
    ...
    case ASide of
      bLeft:
        Result := IfThen(R.Left < FocusedColumn, R.Left,
          IfThen(FocusedColumn < R.Right, R.Right, FocusedColumn));
      bTop:
        Result := IfThen(R.Top < FocusedRow, R.Top,
          IfThen(FocusedRow < R.Bottom, R.Bottom, FocusedRow));
      bRight:
        Result := IfThen(R.Right > FocusedColumn, R.Right,
          IfThen(FocusedColumn > R.Left, R.Left, FocusedColumn));
    else
      Result := IfThen(R.Bottom > FocusedRow, R.Bottom,
        IfThen(FocusedRow > R.Top, R.Top, FocusedRow));
    end;
  end
  else if ASide in [bLeft, bRight] then
...
function TdxSpreadSheetTableViewController.FindUnlockedCellByColumn
  (const AStartArea: TRect; const AStartIndex, AStartRow, AStartColumn: Integer;
AGoForward: Boolean): TdxSpreadSheetCell;
...
var
  ...
  ANextArea: TRect;
begin
  Result := GetNextUnlockedCellByColumn(AStartArea, AStartRow, AStartColumn,
    AGoForward);
  if Result = nil then
    if AStartIndex < 0 then
      Result := GetNextUnlockedCellByColumn(AStartArea,
        GetAreaStartRow(AStartArea), GetAreaStartColumn(AStartArea), AGoForward)
    else
    begin
      ...
      repeat
        ...
        Result := GetNextUnlockedCellByColumn(ANextArea,
          GetAreaStartRow(ANextArea), GetAreaStartColumn(ANextArea), AGoForward)
...
var
  ...
  ANextArea: TRect;
begin
  Result := GetNextUnlockedCellByRow(AStartArea, AStartRow, AStartColumn,
    AGoForward);
  if Result = nil then
    if AStartIndex < 0 then
      Result := GetNextUnlockedCellByRow(AStartArea,
        GetAreaStartRow(AStartArea), GetAreaStartColumn(AStartArea), AGoForward)
    else
    begin
      ANextIndex := AStartIndex;
      repeat
        ANextIndex := GetNextSelectedAreaIndex(ANextIndex, AGoForward);
        ANextArea := Selection[ANextIndex].Rect;
        Result := GetNextUnlockedCellByRow(ANextArea,
          GetAreaStartRow(ANextArea), GetAreaStartColumn(ANextArea), AGoForward)
      until (AStartIndex = ANextIndex) or (Result <> nil);
    end;
end;
...
procedure TdxSpreadSheetTableViewController.GetCellFromMouseCursor(var ARow,
  AColumn: Integer);
begin
  if HitTest.HitAtColumnHeader then
  begin
    AColumn := TdxSpreadSheetTableViewHeaderCellViewInfo
      (HitTest.HitObject).Index;
    ARow := -1;
  end
  else
...
function TdxSpreadSheetTableViewController.GetHitTest
  : TdxSpreadSheetCustomHitTest;
begin
  Result := HitTest;
end;

procedure TdxSpreadSheetTableViewController.GetRedoActionCount
  (var ARedoCount: Integer);
begin
  if EditingController.IsEditing then
  begin
...
procedure TdxSpreadSheetTableViewController.GetUndoActionCount
  (var AUndoCount: Integer);
begin
  if EditingController.IsEditing then
  begin
...
function TdxSpreadSheetTableViewController.DoActiveCellChanging(AColumn,
  ARow: Integer): Boolean;
begin
  Result := (ForcedSelectionMode <> smNone) or
    View.DoActiveCellChanging(AColumn, ARow);
end;

function TdxSpreadSheetTableViewController.ContainerProcessKeyDown(Key: Word;
...
procedure TdxSpreadSheetTableViewController.KeyDown(var Key: Word;
Shift: TShiftState);
var
  AColumn: Integer;
  ADimensions: TRect;
...
begin
  ...
  case Key of
    ...
    VK_LEFT:
      if ssCtrl in Shift then
        SelectColumn(GetNextCellInDataBlock(Rows[FocusedRow], FocusedColumn,
          False), Shift - [ssCtrl])
      else
        SelectColumn(GetNextVisibleCell(GetSelectionItem(bLeft, Shift),
          adLeft), Shift);

    VK_UP:
      if ssCtrl in Shift then
        SelectRow(GetNextCellInDataBlock(Columns[FocusedColumn], FocusedRow,
          False), Shift - [ssCtrl])
      else
        SelectRow(GetNextVisibleCell(GetSelectionItem(bTop, Shift),
          adUp), Shift);
    ...
    VK_DOWN:
      if ssCtrl in Shift then
        ...
        SelectRow(GetNextVisibleCell(GetSelectionItem(bBottom, Shift),
          adDown), Shift);
    ...
    VK_RIGHT:
      if ssCtrl in Shift then
        ...
        SelectColumn(GetNextVisibleCell(GetSelectionItem(bRight, Shift),
          adRight), Shift);
    ...
    VK_PRIOR:
      ...
      begin
        AFocusedRowOffset := GetFocusedRowOffsetFromTopRow
          (GetSelectionItem(bTop, Shift));
    ...
    VK_NEXT:
      ...
      begin
        AFocusedRowOffset := GetFocusedRowOffsetFromTopRow
          (GetSelectionItem(bBottom, Shift));
    ...
    VK_HOME:
      begin
        ...
        while (View.Columns[AColumn] <> nil) and not View.Columns[AColumn]
          .Visible do
          Inc(AColumn);
        if ssCtrl in Shift then
    ...
    VK_END:
      ...
      begin
        ...
        SetFocused(GetNextVisibleCell(ADimensions.Bottom - 1, adDown),
          GetNextVisibleCell(ADimensions.Right - 1, adRight), Shift - [ssCtrl])
      end
      else if Rows[FocusedRow] = nil then
        SelectColumn(0, Shift)
      else
        SelectColumn(GetNextVisibleCell(Rows[FocusedRow].CellCount - 1,
          adRight), Shift);
    ...
    VK_RETURN:
      if ssShift in Shift then
        FocusNextPossibleCell(adUp, View.Options.Protected and
          (OptionsBehavior.EnterKeyNavigation = eknSkipLockedCells))
      else
        FocusNextPossibleCell(adDown, View.Options.Protected and
          (OptionsBehavior.EnterKeyNavigation = eknSkipLockedCells));

    VK_DELETE:
      if [ssAlt, ssCtrl, ssShift] * Shift = [ssShift] then
        CheckCtrlCommand('X')
      else if [ssAlt, ssShift] * Shift = [] then
      begin
        SpreadSheet.ClearClipboard;
...
begin
  if (Key < #$21) or (ForcedSelectionMode <> smNone) then
    Key := #0
  else if not EditingController.IsEditing then
    EditingController.ShowEditByKey(Key);
end;

procedure TdxSpreadSheetTableViewController.KeyUp(var Key: Word;
Shift: TShiftState);
begin
  inherited;
  if (Key = VK_CONTROL) and (HitTest.HitObject is TdxSpreadSheetCellViewInfo)
  then
    CellHintController.Show(TdxSpreadSheetCellViewInfo(HitTest.HitObject));
end;

procedure TdxSpreadSheetTableViewController.DoMouseDown(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
begin
  ...
  if HitTest.HitAtGroupingArea or HitTest.HitAtResizeArea or
    not PtInRect(ViewInfo.Bounds, Point(X, Y)) or
    EditingController.IsEditing and (SpreadSheet.DragAndDropState <> ddsNone)
  then
  begin
    CanClickOnTheCell := False;
    CellHintController.Hide;
  ...
  else if not HitTest.HitAtContainerSelection then
    FocusedContainer := nil;
...
procedure TdxSpreadSheetTableViewController.DoMouseDownAtCellArea
...
begin
  ...
  begin
    if HitTest.HitAtColumnHeader and (ForcedSelectionMode in [smNone, smCells])
    then
...
procedure TdxSpreadSheetTableViewController.DoMouseMove(Shift: TShiftState;
X, Y: Integer);
var
  AArea: TRect;
  AColumn: Integer;
...
begin
  ...
  if (ssLeft in Shift) and (SelectionMode <> smNone) and (Selection.Count > 0)
  then
  begin
    CellHintController.Hide;
    ...
    case SelectionMode of
      smRows:
        AArea := cxRectAdjust(Rect(0, ARow, dxSpreadSheetMaxColumnIndex,
          FocusedRow));
      smColumns:
        AArea := cxRectAdjust(Rect(AColumn, 0, FocusedColumn,
          dxSpreadSheetMaxRowIndex));
      smCells:
        AArea := MergedCells.ExpandArea
          (cxRectAdjust(Rect(AColumn, ARow, FocusedColumn, FocusedRow)));
    else
      Exit;
    end;

    if Selection.CanSelectArea(AArea) and DoActiveCellChanging(AColumn, ARow)
    then
      Selection.Items[Selection.Count - 1].Rect := AArea;
  end
  else if HitTest.HitAtCell or HitTest.HitAtContainer then
    CellHintController.Show(HitTest.HitObject as TdxSpreadSheetCellViewInfo)
  else
    CellHintController.Hide;
end;

procedure TdxSpreadSheetTableViewController.DoMouseUp(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
var
  ARow, AColumn: Integer;
  AHyperlink: TdxSpreadSheetHyperlink;
begin
  ...
  begin
    AHyperlink.Execute;
    PostMessage(SpreadSheet.Handle, DXM_CANCELHINT, TdxNativeUInt(View),
      TdxNativeInt(AHyperlink));
  end;
...
procedure TdxSpreadSheetTableViewController.DoMouseUpAtGroupingArea
  (Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  if HitTest.HitAtGroup then
    TdxSpreadSheetTableViewGroupViewInfo(HitTest.HitObject).Group.ToggleExpanded
  else if HitTest.HitAtExpandButton then
    TdxSpreadSheetTableViewGroupLevelExpandButtonViewInfo(HitTest.HitObject)
      .Items.Groups.ExpandToLevel(HitTest.HitObjectData - 1);
end;

function TdxSpreadSheetTableViewController.DoMouseWheel(Shift: TShiftState;
WheelDelta: Integer; const P: TPoint): Boolean;
begin
  Result := True;
  if ssCtrl in Shift then
  ...
  begin
    ...
    try
      ...
      ViewInfo.FirstScrollableRow := Rows.GetItemIndexFromDistance
        (View.ViewInfo.FirstScrollableRow, -WheelDelta);
      ViewInfo.Validate;
    finally
...
function TdxSpreadSheetTableViewController.Redo(const ARedoCount
  : Integer = 1): Boolean;
begin
...
function TdxSpreadSheetTableViewController.Undo(const AUndoCount
  : Integer = 1): Boolean;
begin
  Result := EditingController.IsEditing;
  if Result then
...
procedure TdxSpreadSheetTableViewController.ScrollingTimerHandler
  (Sender: TObject);
  ...
  begin
    if ViewInfo.IsRightToLeftLayout then
      APoint := TdxRightToLeftLayoutConverter.ConvertPoint(APoint,
        View.BoundsForRightToLeftConversion);

    AScrollPos := 0;
    AContentArea := cxRectInflate(ViewInfo.ScrollableArea,
      -dxSpreadSheetScrollAreaWidth);
    if (APoint.Y < AContentArea.Top) and not InRange(FocusedRow, 0,
      View.FrozenRow) and (SelectionMode <> smColumns) then
    ...
    if (APoint.X < AContentArea.Left) and not InRange(FocusedColumn, 0,
      View.FrozenColumn) and (SelectionMode <> smRows) then
...
begin
  ...
  ScrollContent(APoint);

  if ViewInfo.IsDirty then
  begin
    ViewInfo.Validate;
    MouseMove(KeyboardStateToShiftState, APoint.X, APoint.Y);
  end;

  if SpreadSheet.DragAndDropState = ddsInProcess then
  begin
    AAccepted := False;
    SpreadSheet.DragAndDrop(APoint, AAccepted);
  end;
end;
...
procedure TdxSpreadSheetTableViewController.SelectColumn(AColumn: Integer;
AShift: TShiftState);
var
  R: TcxRect;
  R1: TRect;
begin
  ...
  begin
    ...
    if dxSpreadSheetIsEntireRowOrColumn(R1) then
      R.Rect := R1
    else if DoActiveCellChanging(AColumn, FocusedRow) then
...
procedure TdxSpreadSheetTableViewController.SelectRow(ARow: Integer;
AShift: TShiftState);
var
  R: TcxRect;
  R1: TRect;
begin
  ...
  begin
    ...
    if dxSpreadSheetIsEntireRowOrColumn(R1) then
      R.Rect := R1
    else if DoActiveCellChanging(FocusedColumn, ARow) then
      R.Rect := MergedCells.ExpandArea(R1);
...
procedure TdxSpreadSheetTableViewController.SetFocused(ARow, AColumn: Integer;
AShift: TShiftState);
var
  R: TcxRect;
begin
  ...
  begin
    ...
    begin
      if R.Right >= dxSpreadSheetMaxColumnIndex then
        R.Rect := cxRectAdjust(Rect(0, ARow, dxSpreadSheetMaxColumnIndex,
          FocusedRow))
      else if R.Bottom >= dxSpreadSheetMaxRowIndex then
        R.Rect := cxRectAdjust(Rect(AColumn, 0, FocusedColumn,
          dxSpreadSheetMaxRowIndex))
      else
        R.Rect := MergedCells.ExpandArea
          (cxRectAdjust(Rect(AColumn, ARow, FocusedColumn, FocusedRow)));
...
procedure TdxSpreadSheetTableViewController.SetForcedSelectionMode
  (const Value: TdxSpreadSheetTableViewSelectionMode);
begin
...
procedure TdxSpreadSheetTableViewController.SetSelectionMode(ARow,
  AColumn: Integer; AShift: TShiftState;
AMode: TdxSpreadSheetTableViewSelectionMode);
begin
  SelectionMode := AMode;
  case AMode of
...
function TdxSpreadSheetTableViewController.GetColumns
  : TdxSpreadSheetTableColumns;
begin
  Result := View.Columns;
end;
...
function TdxSpreadSheetTableViewController.GetFocusedHyperlink
  : TdxSpreadSheetHyperlink;
begin
  if FocusedContainer <> nil then
...
function TdxSpreadSheetTableViewController.GetFocusedRowOffsetFromTopRow
...
function TdxSpreadSheetTableViewController.GetMergedCells
  : TdxSpreadSheetMergedCellList;
begin
  Result := View.MergedCells;
end;

function TdxSpreadSheetTableViewController.GetOptionsBehavior
  : TdxSpreadSheetOptionsBehavior;
begin
...
function TdxSpreadSheetTableViewController.GetSelection
  : TdxSpreadSheetTableViewSelection;
begin
  Result := View.Selection;
end;

function TdxSpreadSheetTableViewController.GetTableItemsForNavigation
  (ADirection: TcxArrowDirection): TdxSpreadSheetTableItems;
begin
  if ADirection in [adLeft, adRight] then
    Result := Columns
  else
...
function TdxSpreadSheetTableViewController.GetViewHitTest
  : TdxSpreadSheetTableViewHitTest;
begin
  Result := View.HitTest;
end;

function TdxSpreadSheetTableViewController.GetViewInfo
  : TdxSpreadSheetTableViewInfo;
begin
  Result := View.ViewInfo;
end;

procedure TdxSpreadSheetTableViewController.SetSelectionModeField
  (AMode: TdxSpreadSheetTableViewSelectionMode);
begin
...
constructor TdxSpreadSheetConditionalFormatting.Create
  (AView: TdxSpreadSheetTableView);
begin
  inherited Create(AView);
  FView := AView;
...
procedure TdxSpreadSheetConditionalFormatting.Add(const AArea: string;
...
begin
  ...
  if not dxSpreadSheetIsValidArea(AAreaAsRect) then
    raise EdxSpreadSheetError.CreateFmt
      (cxGetResourceString(@sdxErrorInvalidCellsReference), [AArea]);
...
procedure TdxSpreadSheetConditionalFormatting.DoRuleAdded
...
procedure TdxSpreadSheetConditionalFormatting.DoRuleChanging
  (ARule: TdxSpreadSheetCustomConditionalFormattingRule);
begin
...
procedure TdxSpreadSheetConditionalFormatting.DoRuleIndexChanged(AOldIndex,
  ANewIndex: Integer);
begin
  inherited DoRuleIndexChanged(AOldIndex, ANewIndex);
  if History.CanAddCommand then
    History.AddCommand
      (TdxSpreadSheetHistoryChangeConditionalFormattingRuleIndexCommand.Create
      (AOldIndex, ANewIndex));
end;

procedure TdxSpreadSheetConditionalFormatting.DoRuleDeleted
  (ARule: TdxSpreadSheetCustomConditionalFormattingRule);
begin
  if History.CanAddCommand then
    History.AddCommand
...
procedure TdxSpreadSheetTableView.CellAtPoint(const P: TPoint;
out ARow, AColumn: Integer; AReturnNearestCell: Boolean = False;
AVisibleAreaOnly: Boolean = True);
begin
  ViewInfo.GetCellAtPoint(P, ARow, AColumn, AReturnNearestCell,
    AVisibleAreaOnly);
end;

procedure TdxSpreadSheetTableView.CellAtPoint(const P: TPoint;
out ACell: TdxSpreadSheetCell; AReturnNearestCell: Boolean = False;
AVisibleAreaOnly: Boolean = True);
var
  ARow, AColumn: Integer;
begin
...
function TdxSpreadSheetTableView.CreateCell(const ACellReference: string)
  : TdxSpreadSheetCell;
var
  ARow, AColumn: Integer;
begin
...
function TdxSpreadSheetTableView.CreateCell(const ARow, AColumn: Integer)
  : TdxSpreadSheetCell;
begin
  if History.CanAddCommand and (Cells[ARow, AColumn] = nil) then
    History.AddCommand(TdxSpreadSheetHistoryCreateCellCommand.Create(Self, ARow,
      AColumn));
...
begin
  TdxSpreadSheetCustomFormulaControllerAccess(FormulaController)
    .GetCellValue(Self, ARow, AColumn, AValue, AErrorCode);
end;

function TdxSpreadSheetTableView.CanClearCells(const AArea: TRect): Boolean;
begin
  Result := SpreadSheet.OptionsBehavior.Editing and
    (not Options.&Protected or (GetLockedStateOfCellsInArea(AArea) <>
    cbChecked));
end;
...
procedure TdxSpreadSheetTableView.ClearCells(const AArea: TRect;
AClearValues: Boolean = True; AClearFormats: Boolean = True);
var
...
begin
  ...
  try
    ...
    begin
      Rows.ForEachCell(AArea, procedure(ACell: TdxDynamicListItem)
        begin
          if not(Options.Protected and (csLocked in TdxSpreadSheetCell(ACell)
            .StyleHandle.States)) then
          begin
...
procedure TdxSpreadSheetTableView.ClearCells(const AArea: string;
AClearValues, AClearFormats: Boolean);
begin
...
begin
  ...
  begin
    if not CanModifyDataInArrayFormulaArea(Selection.Items[I].Rect, cmmClear)
    then
      Exit(False);
  end;
  Result := True;
...
begin
  Result := SpreadSheet.OptionsBehavior.Editing and
    SpreadSheet.OptionsBehavior.Deleting and
    (OptionsProtection.ActualAllowDeleteColumns or
    OptionsProtection.ActualAllowDeleteRows);
end;

function TdxSpreadSheetTableView.CanInsertCellsCore: Boolean;
begin
  Result := SpreadSheet.OptionsBehavior.Editing and
    SpreadSheet.OptionsBehavior.Inserting and
    (OptionsProtection.ActualAllowInsertColumns or
    OptionsProtection.ActualAllowInsertRows);
end;

function TdxSpreadSheetTableView.CanModifyDataInArrayFormulaArea(AArea: TRect;
AMode: TdxSpreadSheetCellsModificationMode): Boolean;
var
  AInnerResult: Boolean;
begin
  if (AArea.Top = AArea.Bottom) and (AArea.Left = AArea.Right) and
    (AMode = cmmReplace) then
    Exit(True);
  ...
  FormulaController.EnumArrayFormulas(Self,
    ...
    begin
      ...
      AInnerResult := not dxSpreadSheetIntersects(AArea, AArrayFormulaArea,
        AIntersection) or cxRectIsEqual(AIntersection, AArrayFormulaArea);
      Result := AInnerResult;
    end);
  Result := AInnerResult;
end;

procedure TdxSpreadSheetTableView.ClearCells(const AArea, AExcludedArea: TRect;
AOptions: TdxSpreadSheetTableViewClearCellsOptions);
...
begin
  ...
  begin
    ...
    try
      ...
      InternalClear(cxRect(R.Right + 1, R.Bottom + 1, AArea.Right,
        AArea.Bottom));
    finally
      EndUpdate;
    end;
...
begin
  ...
  try
    BeginUpdate;
    try
      Rows.ForEach(procedure(AItem: TdxDynamicListItem)
        begin
...
begin
  ...
  begin
    if Selection.Count <> 1 then
      raise EdxSpreadSheetError.Create
        (cxGetResourceString(@sdxErrorInvalidSelection));
...
procedure TdxSpreadSheetTableView.DeleteCells(const AArea: TRect;
AModification: TdxSpreadSheetCellsModification;
AMergedCellsConflictResolution
  : TdxSpreadSheetTableViewMergedCellsConflictResolution =
...
begin
  ...
  begin
    if not CanModifyDataInArrayFormulaArea(GetFactuallyModifiableArea(AArea,
      AModification), cmmDelete) then
      raise EdxSpreadSheetCannotChangePartOfArrayError.Create
        (cxGetResourceString(@sdxErrorCannotChangePartOfArray));
...
procedure TdxSpreadSheetTableView.DeleteCells(const AArea: string;
AModification: TdxSpreadSheetCellsModification;
AMergedCellsConflictResolution
  : TdxSpreadSheetTableViewMergedCellsConflictResolution =
  mccrShowConfirmation);
begin
  DeleteCells(StringToAreaReference(AArea), AModification,
    AMergedCellsConflictResolution);
end;

procedure TdxSpreadSheetTableView.DeleteColumns(AStartColumn: Integer;
ACount: Integer);
begin
  DeleteCells(cxRect(AStartColumn, 0, AStartColumn + ACount - 1, 0),
    cmShiftColumns, mccrRaiseException);
end;

procedure TdxSpreadSheetTableView.DeleteRows(AStartRow: Integer;
ACount: Integer);
begin
  DeleteCells(cxRect(0, AStartRow, 0, AStartRow + ACount - 1), cmShiftRows,
    mccrRaiseException);
end;
...
procedure TdxSpreadSheetTableView.FillData(ADirection: TcxDirection;
ACount: Integer);
begin
  if Selection.Count <> 1 then
    raise EdxSpreadSheetError.Create
...
procedure TdxSpreadSheetTableView.FillData(const ASourceArea,
  ATargetArea: string);
begin
  FillData(StringToAreaReference(ASourceArea),
    StringToAreaReference(ATargetArea));
end;
...
begin
  BeginUpdate;
  try
    ADirection := TdxSpreadSheetTableViewAutoFillDragAndDropObject.
      CalculateDirection(ASourceArea, ATargetArea);
...
procedure TdxSpreadSheetTableView.FillData(const ASourceArea: string;
ADirection: TcxDirection; ACount: Integer);
begin
  FillData(StringToAreaReference(ASourceArea), ADirection, ACount);
end;

procedure TdxSpreadSheetTableView.FillData(const ASourceArea: TRect;
ADirection: TcxDirection; ACount: Integer);
var
...
procedure TdxSpreadSheetTableView.AddArrayFormula
  (AFormula: TdxSpreadSheetFormula; const AText: string; const AArea: TRect);
var
  ACell: TdxSpreadSheetCell;
  ADestArea: TRect;
  ADestSize: TSize;
...
begin
  ...
  try
    ADestArea := AArea;
    if SpreadSheet.FormulaController.IsPartOfArrayFormula(Self, AArea.Top,
      AArea.Left, AFormulaArea, @AExistingFormula) <> afpNone then
    begin
      AExistingArea := AExistingFormula.ArrayFormulaArea;
      if (AExistingArea.Right > ADestArea.Right) or
        (AExistingArea.Bottom > ADestArea.Bottom) then
...
begin
  if not dxTryStringToReferenceArea(S, False, Result) then
    raise EdxSpreadSheetError.CreateFmt
      (cxGetResourceString(@sdxErrorInvalidCellsReference), [S]);
end;
...
begin
  if not TdxSpreadSheetColumnReferences.TryIndexByName(S, Result) then
    raise EdxSpreadSheetError.CreateFmt
      (cxGetResourceString(@sdxErrorInvalidColumnIndex), [S]);
end;

procedure TdxSpreadSheetTableView.StringToCellReference(const S: string;
out ARow, AColumn: Integer);
begin
  if not dxTryStringToReference(S, False, ARow, AColumn) then
    raise EdxSpreadSheetError.CreateFmt
      (cxGetResourceString(@sdxErrorInvalidCellReference), [S]);
end;

procedure TdxSpreadSheetTableView.AddArrayFormula
  (AFormula: TdxSpreadSheetFormula; const AArea: TRect);
begin
  AddArrayFormula(AFormula, '', AArea);
end;

procedure TdxSpreadSheetTableView.AddArrayFormula(const AText: string;
const AArea: TRect);
begin
...
function TdxSpreadSheetTableView.CanModifyDataInArea(const AArea: TRect;
const AMode: TdxSpreadSheetCellsModificationMode): Boolean;
begin
  try
...
function TdxSpreadSheetTableView.CanModifyDataInArea(const AArea: string;
const AMode: TdxSpreadSheetCellsModificationMode): Boolean;
begin
...
procedure TdxSpreadSheetTableView.ForEachCell
  (AProc: TdxSpreadSheetTableViewForEachCellProc);
begin
...
begin
  Rows.ForEachCell(AArea, procedure(AItem: TdxDynamicListItem)
    begin
...
function TdxSpreadSheetTableView.CanInsert(AModification
  : TdxSpreadSheetCellsModification): Boolean;
begin
  Result := CanInsertCellsCore;
  if not OptionsProtection.ActualAllowInsertColumns then
...
function TdxSpreadSheetTableView.CanInsertCells(AArea: TRect;
const AModification: TdxSpreadSheetCellsModification): Boolean;
var
  AInnerResult: Boolean;
begin
  AInnerResult := True;
  FormulaController.EnumArrayFormulas(Self,
    ...
    begin
      ...
      case AModification of
        cmShiftRows:
          AInnerResult := (AArea.Top <= AArrayFormulaArea.Top) or
            (AArea.Top > AArrayFormulaArea.Bottom);
        cmShiftColumns:
          AInnerResult := (AArea.Left <= AArrayFormulaArea.Left) or
            (AArea.Left > AArrayFormulaArea.Right);
      else
        AInnerResult := not dxSpreadSheetIntersects(AArea, AArrayFormulaArea,
          AIntersecting) or cxRectIsEqual(AIntersecting, AArrayFormulaArea);
      end;
      Result := AInnerResult;
    end);
  Result := AInnerResult;
...
function TdxSpreadSheetTableView.CanInsertCells(const AArea: string;
const AModification: TdxSpreadSheetCellsModification): Boolean;
begin
...
procedure TdxSpreadSheetTableView.InsertCells(const AArea: TRect;
AModification: TdxSpreadSheetCellsModification;
AMergedCellsConflictResolution
  : TdxSpreadSheetTableViewMergedCellsConflictResolution =
  mccrShowConfirmation);
...
begin
  ...
  begin
    if not CanInsertCells(GetFactuallyModifiableArea(AArea, AModification),
      AModification) then
      raise EdxSpreadSheetCannotChangePartOfArrayError.Create
        (cxGetResourceString(@sdxErrorCannotChangePartOfArray));
...
procedure TdxSpreadSheetTableView.InsertCells(const AArea: string;
AModification: TdxSpreadSheetCellsModification;
AMergedCellsConflictResolution
  : TdxSpreadSheetTableViewMergedCellsConflictResolution =
  mccrShowConfirmation);
begin
  InsertCells(StringToAreaReference(AArea), AModification,
    AMergedCellsConflictResolution);
end;

procedure TdxSpreadSheetTableView.InsertColumns(AColumn: Integer;
ACount: Integer);
begin
  InsertCells(cxRect(AColumn, 0, AColumn + ACount - 1, 0), cmShiftColumns,
    mccrRaiseException);
end;

procedure TdxSpreadSheetTableView.InsertColumns(const AColumn: string;
ACount: Integer);
begin
...
begin
  InsertCells(cxRect(0, ARow, 0, ARow + ACount - 1), cmShiftRows,
    mccrRaiseException);
end;
...
begin
  MakeVisible(MergedCells.ExpandArea(Selection.FocusedColumn,
    Selection.FocusedRow));
end;

procedure TdxSpreadSheetTableView.MakeVisible
  (AContainer: TdxSpreadSheetContainer);
var
  ACellRef: TPoint;
  ARect: TRect;
begin
  if (AContainer <> nil) and (AContainer.Parent = Self) and AContainer.Visible
  then
  begin
...
begin
  ...
  if InRange(AArea.Top, TopRow, BottomRow) and InRange(AArea.Bottom, TopRow,
    BottomRow) then
  begin
    if AArea.Top > FrozenRow then
      ViewInfo.FirstScrollableRow := Min(ViewInfo.FirstScrollableRow,
        AArea.Top);
  end
  else
  begin
  ...
  if InRange(AArea.Left, LeftColumn, RightColumn) and
    InRange(AArea.Right, LeftColumn, RightColumn) then
  begin
    if AArea.Left > FrozenColumn then
      ViewInfo.FirstScrollableColumn := Min(ViewInfo.FirstScrollableColumn,
        AArea.Left);
  end
  else
  begin
...
function TdxSpreadSheetTableView.CanPasteFromClipboard
...
procedure TdxSpreadSheetTableView.CheckPasteSelection(const AClipboardArea
  : TRect; AMode: TdxSpreadSheetClipboardCopyMode);
var
  I: Integer;
begin
  ...
  for I := 0 to Selection.Count - 1 do
    CheckProtection(cmmReplace, cxRectSetSize(Selection[I].Rect,
      cxSize(AClipboardArea)));
  if not CheckPasteSelectionSizes(AClipboardArea) then
    raise EdxSpreadSheetError.Create
      (cxGetResourceString(@sdxErrorInvalidPasteArea));
end;

function TdxSpreadSheetTableView.CheckPasteSelectionSizes(const AClipboardArea
  : TRect): Boolean;

  function CheckBounds(const AArea: TRect;
  AClipboardAreaWidth, AClipboardAreaHeight: Integer): Boolean;
  begin
    Result := (AArea.Left + AClipboardAreaWidth - 1 <
      dxSpreadSheetMaxColumnCount) and
      (AArea.Top + AClipboardAreaHeight - 1 < dxSpreadSheetMaxRowCount);
  end;

  function CheckAreaSize(const AArea: TRect;
  AClipboardAreaWidth, AClipboardAreaHeight: Integer): Boolean;
  var
    AAreaHeight: Integer;
    AAreaWidth: Integer;
  begin
    ...
    Result := (AAreaWidth = 1) and (AAreaHeight = 1) or (AAreaWidth = 1) and
      (AAreaHeight mod AClipboardAreaHeight = 0) or (AAreaHeight = 1) and
      (AAreaWidth mod AClipboardAreaWidth = 0) or
      (AAreaWidth mod AClipboardAreaWidth = 0) and
      (AAreaHeight mod AClipboardAreaHeight = 0);
  end;
...
begin
  ...
  begin
    ...
    Result := CheckBounds(AArea, AWidth, AHeight) and
      CheckAreaSize(AArea, AWidth, AHeight);
    if not Result then
      Break;
  end;
end;

procedure TdxSpreadSheetTableView.OptionsProtectionChangeHandler
  (Sender: TObject);
begin
...
procedure TdxSpreadSheetTableView.CheckProtection
...
procedure TdxSpreadSheetTableView.CheckProtection
  (AMode: TdxSpreadSheetCellsModificationMode; const AArea: TRect);
begin
  if not SpreadSheet.OptionsBehavior.Editing or Options.&Protected and
    (GetLockedStateOfCellsInArea(AArea) <> cbUnchecked) then
    raise EdxSpreadSheetProtectionError.Create
      (cxGetResourceString(@sdxErrorCellProtected));
...
begin
  ...
  begin
    ...
    TdxSpreadSheetTableViewClipboardHelper.GetDataInfoFromClipboard(AViewGUID,
      AClipboardCopyMode, AClipboardArea);
    if dxSpreadSheetIsEntireColumn(AClipboardArea) then
      Include(AOptions, cpoColumnWidths);
    PasteFromClipboardCore(AOptions, AViewGUID, AClipboardArea,
      AClipboardCopyMode);
  end;
end;
...
procedure TdxSpreadSheetTableView.CopyCellDataToStream(const AArea: TRect;
AStream: TStream);
begin
...
procedure TdxSpreadSheetTableView.CopyCellDataToStream(const AArea: string;
AStream: TStream);
begin
  CopyCellDataToStream(StringToAreaReference(AArea), AStream);
end;

procedure TdxSpreadSheetTableView.PasteCellDataFromStream(const ADestination
  : TPoint; AStream: TStream);
const
...
begin
  ...
  if (AVersion = SFSpreadSheetVersion) or (AVersion = SFSpreadSheetOldVersion)
  then
  begin
    ASelection := TdxRectList.Create;
    dxSpreadSheetStoreSelectionAndScrollPosition(Self, ASelection, AFocusedCell,
      AScrollPos);
    try
      ...
      dxSpreadSheetRestoreSelectionAndScrollPosition(Self, ASelection,
        AFocusedCell, AScrollPos);
...
begin
  Result := OptionsProtection.ActualAllowEditHyperlinks and
    (CanEditContainers or (Controller.FocusedContainer = nil)) and
    not(OptionsProtection.&Protected and IsLocked(Cells[Selection.FocusedRow,
    Selection.FocusedColumn]));
end;
...
function TdxSpreadSheetTableView.CanDelete(AModification
  : TdxSpreadSheetCellsModification): Boolean;
begin
  Result := CanDeleteCore;
  if not OptionsProtection.ActualAllowDeleteColumns then
...
begin
  Result := CanEditContainers and
    ((Selection.FocusedContainer is TdxSpreadSheetCommentContainer) or
    CanDeleteComments(Selection.Area));
end;

function TdxSpreadSheetTableView.CanDeleteComments(const AArea: string)
  : Boolean;
begin
...
begin
  if CanEditContainers then
    ...
    begin
      if dxSpreadSheetContains(AArea, TdxSpreadSheetCommentContainer(AValue)
        .Cell) then
        Exit(True);
    end;
  Result := False;
  ...
  begin
    ...
    try
      ...
      try
        ...
        begin
          ACellPos := MergedCells.CheckCell(Selection.FocusedRow,
            Selection.FocusedColumn).TopLeft;
    ...
    try
      ...
      try
        ...
        begin
          ...
          if AContainer is TdxSpreadSheetCommentContainer then
          begin
            if dxSpreadSheetContains(AArea,
              TdxSpreadSheetCommentContainer(AContainer).Cell) then
              AContainer.Free;
          end;
        end;
      finally
...
procedure TdxSpreadSheetTableView.ShowEditByMouse(X, Y: Integer;
AShift: TShiftState);
begin
...
begin
  Result := SpreadSheet.OptionsBehavior.Editing and
    OptionsProtection.ActualAllowSort;
end;
...
function TdxSpreadSheetTableView.GetActiveCell(const ARow, AColumn: Integer)
  : TdxSpreadSheetCell;
var
  AMergedCell: TdxSpreadSheetMergedCell;
begin
...
function TdxSpreadSheetTableView.GetArrayFormulaArea(const ASenderRowIndex,
  ASenderColumnIndex: Integer): TRect;
begin
  Result := cxRect(ASenderColumnIndex, ASenderRowIndex, ASenderColumnIndex,
    ASenderRowIndex);
  if Selection.Count > 0 then
  begin
    if dxSpreadSheetContains(Selection[Selection.Count - 1].Rect,
      ASenderRowIndex, ASenderColumnIndex) then
      Result := Selection[Selection.Count - 1].Rect;
  end;
end;

procedure TdxSpreadSheetTableView.PopulateAreaByValue(const AValue: Variant;
const AArea: TRect);
var
  ARow, AColumn: Integer;
begin
...
begin
  ...
  else if dxSpreadSheetIsEntireRow(AArea) then
...
function TdxSpreadSheetTableView.GetCellStyle(ARow, AColumn: Integer;
ACell: TdxSpreadSheetCell): TdxSpreadSheetCellStyle;
begin
  if ACell <> nil then
    Exit(ACell.Style);
...
function TdxSpreadSheetTableView.GetCellStyleHandle(ARow, AColumn: Integer;
ACell: TdxSpreadSheetCell): TdxSpreadSheetCellStyleHandle;
begin
  if ACell <> nil then
...
function TdxSpreadSheetTableView.GetCellStyleHandle
  (AMergedCell: TdxSpreadSheetMergedCell): TdxSpreadSheetCellStyleHandle;
begin
  Result := GetCellStyleHandle(AMergedCell.Area.Top, AMergedCell.Area.Left,
    AMergedCell.ActiveCell);
end;
...
var
  ACell: TdxSpreadSheetCell;
begin
  if InRange(ARow, 0, dxSpreadSheetMaxRowIndex) and
    InRange(AColumn, 0, dxSpreadSheetMaxColumnIndex) then
    ACell := Cells[ARow, AColumn]
  else
    ACell := nil;
...
function TdxSpreadSheetTableView.GetFactuallyModifiableArea(const AArea: TRect;
AModification: TdxSpreadSheetCellsModification): TRect;
begin
  case AModification of
    cmShiftCellsHorizontally:
      Result := cxRect(AArea.Left, AArea.Top, dxSpreadSheetMaxColumnIndex,
        AArea.Bottom);
    cmShiftCellsVertically:
      Result := cxRect(AArea.Left, AArea.Top, AArea.Right,
        dxSpreadSheetMaxRowIndex);
    cmShiftColumns:
...
begin
  Result := GetCellStyle(Selection.FocusedRow, Selection.FocusedColumn,
    Selection.FocusedCell);
end;

function TdxSpreadSheetTableView.GetLockedStateOfCellsInArea(const AArea: TRect)
  : TCheckBoxState;
const
...
begin
  ...
  Rows.ForEachCell(AArea, procedure(AItem: TdxDynamicListItem)
    begin
      if (csLocked in TdxSpreadSheetCell(AItem).StyleHandle.States) <> ADefaultLocked
      then
        Inc(AChangedCount);
    end);
  ...
  else if AChangedCount <> (AArea.Width + 1) * (AArea.Height + 1) then
    Result := cbGrayed
  else
    Result := StateMap[not ADefaultLocked];
end;

function TdxSpreadSheetTableView.GetNextVisibleView(AOnCycle: Boolean)
  : TdxSpreadSheetTableView;
var
  AIndex: Integer;
  ASheet: TdxSpreadSheetCustomView;
begin
  ...
  until ASheet.Visible or (ASheet = Self) or
    (AOnCycle and (AIndex = SpreadSheet.SheetCount - 1));
  if ASheet.Visible then
    Result := ASheet as TdxSpreadSheetTableView;
end;

function TdxSpreadSheetTableView.GetConditionalFormatting
  : TdxSpreadSheetCustomConditionalFormatting;
begin
  Result := FConditionalFormatting;
end;

function TdxSpreadSheetTableView.GetFormulaController
  : TdxSpreadSheetCustomFormulaController;
begin
...
function TdxSpreadSheetTableView.GetCellData(const ARow, AColumn: Integer)
  : IdxSpreadSheetCellData;
begin
  Result := Cells[ARow, AColumn];
end;
...
function TdxSpreadSheetTableView.GetNextColumnWithNonEmptyCell(const ARow,
  AColumn: Integer; const AGoForward: Boolean = True): Integer;
const
...
begin
  ...
  begin
    AColumnObject := Controller.GetNextColumn
      (TdxSpreadSheetTableColumn(AColumnObject), AGoForward);
    if AColumnObject <> nil then
...
function TdxSpreadSheetTableView.GetNextRowWithNonEmptyCell(const ARow,
  AColumn: Integer; const AGoForward: Boolean = True): Integer;
const
...
begin
  ...
  begin
    ARowObject := Controller.GetNextRow(TdxSpreadSheetTableRow(ARowObject),
      AGoForward);
    if ARowObject <> nil then
    ...
    Result := Controller.GetNextNonEmptyCell(Columns, AColumn, ARow,
      AGoForward);
end;
...
function TdxSpreadSheetTableView.GetAbsoluteCellBounds(const ARowIndex,
  AColumnIndex: Integer; ACheckMergedCells: Boolean = True): TRect;
begin
...
begin
  ...
  Result.BottomRight := GetAbsoluteCellBounds(dxSpreadSheetMaxRowIndex,
    dxSpreadSheetMaxColumnIndex, False).BottomRight;
end;

function TdxSpreadSheetTableView.GetCellAtAbsolutePoint(const P: TPoint;
out ARowIndex, AColumnIndex: Integer): Boolean;

  function FindItem(X, AMaxIndex: Integer;
  AItems: TdxSpreadSheetTableItems): Integer;
  var
    I: Integer;
  begin
    Result := -1;
...
function TdxSpreadSheetTableView.GetCellArea(const ARowIndex,
  AColumnIndex: Integer): TRect;
begin
...
procedure TdxSpreadSheetTableView.ProcessStyleChanges(APrevStyle,
  ANewStyle: TdxSpreadSheetCellStyleHandle);
begin
  // do nothing
end;
...
function TdxSpreadSheetTableView.GetFormatSettings
  : TdxSpreadSheetCustomFormatSettings;
begin
  Result := SpreadSheet.FormatSettings;
end;
...
function TdxSpreadSheetTableView.CreateConditionalFormatting
  : TdxSpreadSheetConditionalFormatting;
begin
  Result := TdxSpreadSheetConditionalFormatting.Create(Self);
end;

function TdxSpreadSheetTableView.CreateController
  : TdxSpreadSheetCustomViewController;
begin
...
function TdxSpreadSheetTableView.CreateMergedCells
  : TdxSpreadSheetMergedCellList;
begin
...
function TdxSpreadSheetTableView.CreateOptionsPrint
  : TdxSpreadSheetTableViewOptionsPrint;
begin
  Result := TdxSpreadSheetTableViewOptionsPrint.Create(Self);
end;

function TdxSpreadSheetTableView.CreateOptionsProtection
  : TdxSpreadSheetSheetProtectionOptions;
begin
  Result := TdxSpreadSheetSheetProtectionOptions.Create
    (OptionsProtectionChangeHandler);
end;
...
function TdxSpreadSheetTableView.CreateSelection
  : TdxSpreadSheetTableViewSelection;
begin
  Result := TdxSpreadSheetTableViewSelection.Create(Self);
end;

function TdxSpreadSheetTableView.CreateViewInfo
  : TdxSpreadSheetCustomViewViewInfo;
begin
...
function TdxSpreadSheetTableView.DoActiveCellChanging(AColumn,
  ARow: Integer): Boolean;
begin
...
procedure TdxSpreadSheetTableView.DoCompare(const AData1,
  AData2: TdxSpreadSheetCellData; var Compare: Integer);
begin
...
procedure TdxSpreadSheetTableView.DoEditing(var AProperties
  : TcxCustomEditProperties; var ACanEdit: Boolean);
begin
...
procedure TdxSpreadSheetTableView.DoInitEditValue(AEdit: TcxCustomEdit;
var AValue: Variant);
begin
...
procedure TdxSpreadSheetTableView.ExchangeValues(ACell1,
  ACell2: TdxSpreadSheetCell);
  ...
  function GetCellStyle(AStyle1, AStyle2: TdxSpreadSheetCellStyle)
    : TdxSpreadSheetCellStyleHandle;
  begin
    Result := CellStyles.CreateStyle
      (CellStyles.Fonts.AddClone(AStyle2.Handle.Font),
...
procedure TdxSpreadSheetTableView.ExchangeValues(ARow1, AColumn1, ARow2,
  AColumn2: Integer);
begin
...
procedure TdxSpreadSheetTableView.PasteFromClipboardCore
  (AOptions: TdxSpreadSheetClipboardPasteOptions; const AViewGUID: string;
const AClipboardArea: TRect;
AClipboardCopyMode: TdxSpreadSheetClipboardCopyMode);
begin
  ...
  try
    ...
    try
      Include(SpreadSheet.FState, sssReadingFromClipboard);
      try
        TdxSpreadSheetTableViewClipboardHelper.Paste(Self, AClipboardArea,
          AClipboardCopyMode, AViewGUID, AOptions);
      finally
        Exclude(SpreadSheet.FState, sssReadingFromClipboard);
      end;
    finally
...
begin
  ForEachCell(procedure(ACell: TdxSpreadSheetCell)
    begin
...
begin
  Options.ShowFormulas := dxBooleanToDefaultBoolean
    (not dxDefaultBooleanToBoolean(Options.ShowFormulas,
    Options.ShowFormulas = bTrue));
end;
...
begin
  ...
  begin
    ...
    MergedCells.EnumCells(procedure(ACell: TdxSpreadSheetMergedCell)
      begin
...
begin
  if OptionsPrint.Source.Area.Assigned then
    ...
    Result := cxRect(0, 0, dxSpreadSheetMaxColumnIndex,
      dxSpreadSheetMaxRowIndex);
end;
...
function TdxSpreadSheetTableView.GetCell(ARow, AColumn: Integer)
  : TdxSpreadSheetCell;
var
  ARowItem: TdxSpreadSheetTableItem;
begin
...
function TdxSpreadSheetTableView.GetController
  : TdxSpreadSheetTableViewController;
begin
...
function TdxSpreadSheetTableView.GetEditingController
  : TdxSpreadSheetTableViewEditingController;
begin
...
function TdxSpreadSheetTableView.GetStringTable
  : TdxSpreadSheetSharedStringTable;
begin
  Result := SpreadSheet.StringTable;
end;

function TdxSpreadSheetTableView.GetTopCell(const ACurrentRow,
  ACurrentColumn: Integer): TdxSpreadSheetCell;
var
  ACell: TdxSpreadSheetCell;
begin
...
procedure TdxSpreadSheetTableView.SetOptions
  (AValue: TdxSpreadSheetTableViewOptions);
begin
  inherited Options := AValue;
end;

procedure TdxSpreadSheetTableView.SetOptionsPrint
  (AValue: TdxSpreadSheetTableViewOptionsPrint);
begin
  FOptionsPrint.Assign(AValue);
end;

procedure TdxSpreadSheetTableView.SetOptionsProtection
  (AValue: TdxSpreadSheetSheetProtectionOptions);
begin
...
AVertical, AExpanded: Boolean);
begin
  BufferedDraw(ACanvas, R, procedure(ACanvas: TcxCanvas; const R: TRect)
    begin
      LookAndFeelPainter.DrawSpreadSheetScaledGroupExpandButton(ACanvas, R,
        AState, dxDefaultScaleFactor);
      LookAndFeelPainter.DrawSpreadSheetScaledGroupExpandButtonGlyph(ACanvas, R,
        AState, AExpanded, dxDefaultScaleFactor, NavigatorImages);
    end);
end;
...
begin
  ...
  ACanvas.Font.Color :=
    LookAndFeelPainter.SpreadSheetGroupExpandButtonTextColor(AState);
  ACanvas.Brush.Style := bsClear;
  ACanvas.DrawTexT(IntToStr(ALevel + 1),
    cxRectContent(R,
    LookAndFeelPainter.SpreadSheetScaledGroupExpandButtonContentOffsets
    (dxDefaultScaleFactor)), taCenter, vaCenter, False, False);
end;

procedure TdxSpreadSheetTableViewPainter.DrawGroupLevelMark(ACanvas: TcxCanvas;
const R: TRect);
begin
  ACanvas.FillRect(R, LookAndFeelPainter.SpreadSheetGroupLineColor);
end;

procedure TdxSpreadSheetTableViewPainter.DrawGroupLinePart(ACanvas: TcxCanvas;
const R: TRect);
begin
  ACanvas.FillRect(R, LookAndFeelPainter.SpreadSheetGroupLineColor);
end;
...
begin
  Result := LookAndFeelPainter.SpreadSheetScaledGroupLevelMarkSize
...
begin
  ...
  begin
    ...
    FGroupExpandButtonMinSize :=
      LookAndFeelPainter.SpreadSheetScaledGroupExpandButtonGlyphSize
      (dxDefaultScaleFactor);
    FGroupExpandButtonMinSize.cx := Max(FGroupExpandButtonMinSize.cx,
      ATextHeight) + cxMarginsWidth
      (LookAndFeelPainter.SpreadSheetScaledGroupExpandButtonContentOffsets
      (dxDefaultScaleFactor));
    FGroupExpandButtonMinSize.cy := Max(FGroupExpandButtonMinSize.cy,
      ATextHeight) + cxMarginsHeight
      (LookAndFeelPainter.SpreadSheetScaledGroupExpandButtonContentOffsets
      (dxDefaultScaleFactor));

    FGroupExpandButtonMinSize.cx := Max(FGroupExpandButtonMinSize.cx,
      FGroupExpandButtonMinSize.cy);
...
procedure TdxSpreadSheetTableViewPainter.BufferedDraw(ACanvas: TcxCanvas;
const R: TRect; AProc: TDrawProc);
var
  ABitmap: TcxBitmap;
begin
  if View.ZoomFactor <> 100 then
...
begin
  Result := (View.Controller.FocusedContainer = nil) and
    (View.Controller.ForcedSelectionMode = smNone) or
    (SpreadSheet.DragAndDropState <> ddsNone) and
    (SpreadSheet.DragAndDropObject is
...
var
  ...
  I: Integer;
begin
  APrevPixelsPerInch := dxSpreadSheetPrepareCanvas(ACanvas, SpreadSheet.Font,
    dxDefaultDPI);
  try
    ...
    try
      for I := 0 to GetPartCount - 1 do
        DrawPart(ACanvas, cxPointScale(GetPartOffset(I), AZoomFactor, 100),
          GetPartBounds(I));
...
procedure TdxSpreadSheetTableViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest);
var
  AOffset: TPoint;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        AHitTest.FActualHitPoint :=
          cxPointOffset(AHitTest.FActualHitPoint, AOffset);
        CalculateHitTest(AHitTest);
        AHitTest.FActualHitPoint := cxPointOffset(AHitTest.FActualHitPoint,
          AOffset, False);
      end
      else
        CalculateHitTest(AHitTest);
...
function TdxSpreadSheetTableViewInfo.GetAreaAbsoluteBounds
  (const AArea: TRect): TRect;
begin
...
function TdxSpreadSheetTableViewInfo.GetAreaBounds(ARow, AColumn: Integer;
const AArea, ACellBounds: TRect): TRect;
var
  AMargins: TRect;
begin
  AMargins := cxRect(Columns.GetDistance(AArea.Left, AColumn - 1),
    Rows.GetDistance(AArea.Top, ARow - 1), Columns.GetDistance(AColumn + 1,
    AArea.Right), Rows.GetDistance(ARow + 1, AArea.Bottom));
  ...
  begin
    ...
    else if (ARow <= FrozenRow) and (Result.Bottom <> ACellBounds.Bottom) then
  ...
  begin
    ...
    else if (ARow <= FrozenColumn) and (Result.Bottom <> ACellBounds.Right) then
...
begin
  ...
  begin
    ...
    if IsRightToLeftLayout then
    begin
      Result := cxRectSetRight(Result, CellsArea.Right + FirstColumnOrigin -
        Result.Left);
      Result := cxRectOffset(Result, dxSpreadSheetBordersMergingOffset,
        CellsArea.Top - FirstRowOrigin);
    end
    else
      Result := cxRectOffset(Result, CellsArea.Left - FirstColumnOrigin,
        CellsArea.Top - FirstRowOrigin);
  end
  else
    Result := cxNullRect;
...
function TdxSpreadSheetTableViewInfo.GetCellBounds(const ARow,
  AColumn: Integer): TRect;
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      AMergedCellViewInfo.SetBounds(GetAreaBounds(ARowIndex, AColumnIndex,
        AMergedCell.Area, ABounds), CellsArea);
  ...
  if (AMergedCellViewInfo <> nil) and
    (AMergedCellViewInfo.Style.Handle <> ACellStyleHandle) then
  begin
...
procedure TdxSpreadSheetTableViewInfo.AddFrozenPaneSeparator
  (const ABounds: TRect);
var
...
begin
  ...
  ACell.Color := cxGetActualColor(OptionsView.FrozenPaneSeparatorColor,
    LookAndFeelPainter.SpreadSheetFrozenPaneSeparatorColor);
...
procedure TdxSpreadSheetTableViewInfo.AddGroupingAreaCells;
  ...
  AClass: TdxSpreadSheetTableViewCustomGroupingAreaViewInfoClass)
    : TdxSpreadSheetTableViewCustomGroupingAreaViewInfo;
  begin
...
begin
  FGroupingAreaTop := AddGroupingArea(Columns,
    TdxSpreadSheetTableViewColumnsGroupingAreaViewInfo);
  FGroupingAreaLeft := AddGroupingArea(Rows,
    TdxSpreadSheetTableViewRowsGroupingAreaViewInfo);
end;
...
procedure TdxSpreadSheetTableViewInfo.AddPageBreakHorz(const ARowIndex: Integer;
const APrintArea: TRect);
var
  ARect: TRect;
begin
  if (ARowIndex > APrintArea.Top) and (ARowIndex < APrintArea.Bottom) then
  begin
    ARect := GetAreaBounds(cxRect(APrintArea.Left, ARowIndex, APrintArea.Right,
      ARowIndex));
...
procedure TdxSpreadSheetTableViewInfo.AddPageBreakVert(const AColumnIndex
  : Integer; const APrintArea: TRect);
var
  ARect: TRect;
begin
  if (AColumnIndex > APrintArea.Left) and (AColumnIndex < APrintArea.Right) then
  begin
    ARect := GetAreaBounds(cxRect(AColumnIndex, APrintArea.Top, AColumnIndex,
      APrintArea.Bottom));
...
procedure TdxSpreadSheetTableViewInfo.PrepareCanvas(ACanvas: TcxCanvas;
...
procedure TdxSpreadSheetTableViewInfo.CalculateAreas(ABounds: TRect);
  ...
  begin
    Result.cx := cxTextOffset * 2 + LookAndFeelPainter.ScaledHeaderWidth
      (cxScreenCanvas, cxBordersAll, IntToStr(Max(100, VisibleCells.Bottom)),
      cxScreenCanvas.Font, dxDefaultScaleFactor);
    Result.cy := cxTextOffset + LookAndFeelPainter.ScaledHeaderHeight
      (cxTextHeight(cxScreenCanvas.Font), dxDefaultScaleFactor);
  end;
...
begin
  if FocusedCell <> nil then
    FocusedCell.SetBounds(cxRectSetOrigin(FocusedCell.Bounds,
      cxInvisiblePoint), Bounds);
  ...
  begin
    ...
    begin
      AColumn := TdxSpreadSheetTableViewHeaderCellViewInfo
        (ColumnsHeader.List[J]);
      ABounds := cxRect(AColumn.Bounds.Left - dxSpreadSheetBordersMergingOffset,
      ...
      begin
        if J = 1 then
          AddOutOfBoundsNonEmptyCell(TdxSpreadSheetTableRow(ARow.Item),
            AColumn.Index, ABounds, False);
        AddCell(TdxSpreadSheetTableRow(ARow.Item), ARow.Index,
          AColumn.Index, ABounds);
        if J = ColumnsHeader.Count - 1 then
          AddOutOfBoundsNonEmptyCell(TdxSpreadSheetTableRow(ARow.Item),
            AColumn.Index, ABounds, True);
      end;
    end;
  ...
  begin
    ARow := TdxSpreadSheetTableViewRowHeaderCellViewInfo(RowsHeader.List[I]);
    PostProcessRowCells(TdxSpreadSheetTableRow(ARow.Item), ARow.FFirstCellIndex,
      ARow.FLastCellIndex);
  end;
end;
...
begin
  ...
  begin
    if (ACellBounds.Right = FrozenColumnSeparatorPosition) and
      (AIndex <= FirstScrollableColumn) then
    begin
      if OptionsView.FrozenPaneSeparatorWidth > 0 then
      begin
        AddFrozenPaneSeparator(cxRectSetLeft(Bounds,
          FrozenColumnSeparatorPosition - 1,
          OptionsView.FrozenPaneSeparatorWidth));
    ...
    begin
      ...
      ACell.Initialize(AColumn, AIndex, [nLeft, nRight],
        Columns.GetItemText(AIndex));
      ACell.SetBounds(ACellBounds, AClipRect);
      ColumnsHeader.Add(ACell);
...
procedure TdxSpreadSheetTableViewInfo.CalculateContainerDependedCells
  (AContainerViewInfo: TdxSpreadSheetContainerViewInfo);
var
...
begin
  ...
  begin
    ...
    TdxSpreadSheetCommentContainerViewInfo(AContainerViewInfo)
      .ConnectionViewInfo := AConnectionViewInfo;
...
var
  ...
  ARect: TRect;
begin
  AWorkArea := cxRectSetSize(Bounds, cxRectWidth(Bounds) +
    FirstScrollableColumnOffset, cxRectHeight(Bounds) +
    FirstScrollableRowOffset);
...
begin
  ...
  if FrozenColumn >= 0 then
    FScrollableArea.Left := FrozenColumnSeparatorPosition - 1 +
      OptionsView.FrozenPaneSeparatorWidth;
  if FrozenRow >= 0 then
    FScrollableArea.Top := FrozenRowSeparatorPosition - 1 +
      OptionsView.FrozenPaneSeparatorWidth;
  FVisibleColumnCount := Max(FVisibleColumnCount, 1);
  FVisibleRowCount := Max(FVisibleRowCount, 1);
end;

procedure TdxSpreadSheetTableViewInfo.CalculateHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest);
begin
  if not(GroupingAreas.CalculateHitTest(AHitTest) or
    ReferenceHighlighter.InitHitTest(AHitTest) or
    SelectionCell.InitHitTest(AHitTest) or ColumnsHeader.CalculateHitTest
    (AHitTest) or RowsHeader.CalculateHitTest(AHitTest) or
    CalculateContainersHitTest(AHitTest) or CellsOverlay.CalculateHitTest
    (AHitTest) or Cells.CalculateHitTest(AHitTest) or
    BackgroundCells.CalculateHitTest(AHitTest)) then
...
begin
  ...
  begin
    ...
    for I := 0 to AOptionsPrint.Pagination.RowPageBreaks.Count - 1 do
      AddPageBreakHorz(AOptionsPrint.Pagination.RowPageBreaks.Items[I],
        APrintArea);
    for I := 0 to AOptionsPrint.Pagination.ColumnPageBreaks.Count - 1 do
      AddPageBreakVert(AOptionsPrint.Pagination.ColumnPageBreaks.Items[I],
        APrintArea);
  end;
end;
...
begin
  AClipRect := Bounds;
  ACellBounds := cxRectSetHeight(cxRectSetRight(CellsArea, CellsArea.Left,
    HeaderSize.cx), 0);
  ...
  begin
    if (ACellBounds.Bottom = FrozenRowSeparatorPosition) and
      (AIndex <= FirstScrollableRow) then
    begin
      if OptionsView.FrozenPaneSeparatorWidth > 0 then
      begin
        AddFrozenPaneSeparator(cxRectSetTop(Bounds, FrozenRowSeparatorPosition -
          1, OptionsView.FrozenPaneSeparatorWidth));
...
begin
  if not Cells.FindItemForCell(View.Selection.FocusedRow,
    View.Selection.FocusedColumn, FFocusedCell) then
    FFocusedCell := nil;
...
begin
  ...
  CalculateLastItemIndex(cxRectWidth(CellsArea), VisibleCells.Left,
    FrozenColumn, FFirstScrollableColumn, dxSpreadSheetMaxColumnIndex, Columns,
    FFrozenColumnSeparatorPosition, FVisibleCells.Right, FCellsArea.Left);
  CalculateLastItemIndex(cxRectHeight(CellsArea), VisibleCells.Top, FrozenRow,
    FFirstScrollableRow, dxSpreadSheetMaxRowIndex, Rows,
    FFrozenRowSeparatorPosition, FVisibleCells.Bottom, FCellsArea.Top);

  FFirstColumnOrigin := Columns.GetDistance(0, VisibleCells.Left - 1);
  FFirstRowOrigin := Rows.GetDistance(0, VisibleCells.Top - 1);
  FFirstScrollableColumnOffset := Columns.GetDistance(FrozenColumn + 1,
    FirstScrollableColumn - 1);
  FFirstScrollableRowOffset := Rows.GetDistance(FrozenRow + 1,
    FirstScrollableRow - 1);
end;

procedure TdxSpreadSheetTableViewInfo.ChangeVisibleArea(ASide: TcxBorder;
AValue: Integer);
begin
...
procedure TdxSpreadSheetTableViewInfo.ChangeVisibleAreaBounds(ASide: TcxBorder;
AValue: Integer);
var
  AIndex: Integer;
  AScrolled: Boolean;
...
function TdxSpreadSheetTableViewInfo.CreateCellViewInfo
  (ACell: TdxSpreadSheetCell): TdxSpreadSheetTableViewCellViewInfo;
begin
...
function TdxSpreadSheetTableViewInfo.CreatePainter
  : TdxSpreadSheetCustomViewPainter;
begin
  Result := TdxSpreadSheetTableViewPainter.Create(View);
end;

function TdxSpreadSheetTableViewInfo.CreatePageBreakViewInfo
  : TdxSpreadSheetCellViewInfo;
begin
  Result := TdxSpreadSheetTableViewPageBreakViewInfo.Create(View);
end;

function TdxSpreadSheetTableViewInfo.CreatePrintAreaViewInfo
  : TdxSpreadSheetCellViewInfo;
begin
...
begin
  if AScrollCode = scEndScroll then
    Exit;
  SpreadSheet.ShowTouchScrollUI(SpreadSheet, True);
  APosition := IfThen(AScrollBarKind = sbHorizontal, FirstScrollableColumn,
    FirstScrollableRow);
  case AScrollCode of
    scTrack:
      APosition := AScrollPos + (IfThen(AScrollBarKind = sbHorizontal,
        FrozenColumn, FrozenRow) + 1);

    scPageUp:
      if AScrollBarKind = sbHorizontal then
        APosition := CalculatePrevPageFirstIndex
          (View.Controller.GetNextVisibleCell(APosition, adLeft), True)
      else
        APosition := CalculatePrevPageFirstIndex
          (View.Controller.GetNextVisibleCell(APosition, adUp), False);
  ...
  AScrollPos := IfThen(AScrollBarKind = sbHorizontal, HScrollBarPos,
    VScrollBarPos);
end;
...
procedure TdxSpreadSheetTableViewInfo.DrawPart(ACanvas: TcxCanvas;
const AOffset: TPoint; const AClipRect: TRect);
begin
  ACanvas.SaveClipRegion;
  try
...
procedure TdxSpreadSheetTableViewInfo.DrawSelectedAreaFrame(ACanvas: TcxCanvas;
const AArea: TRect);
begin
  dxSpreadSheetDrawBorders(ACanvas, GetAreaBounds(AArea), SelectionParams.Color,
    ContentParams.Color, sscbsMediumDashed);
end;
...
begin
  ...
  if not SpreadSheet.ClipboardArea.IsEmpty and
    (View = SpreadSheet.ClipboardArea.View) then
    DrawSelectedAreaFrame(ACanvas, SpreadSheet.ClipboardArea.Area);
end;

function TdxSpreadSheetTableViewInfo.ContentRectToScreenRect
  (const R: TRect): TRect;
begin
  Result := R;
  ...
  begin
    ...
    else if Result.Left >= FrozenColumnSeparatorPosition then
      Result := cxRectOffsetHorz(Result, -FirstScrollableColumnOffset);
  end;
end;

function TdxSpreadSheetTableViewInfo.GetCellClipArea(ARow,
  AColumn: Integer): TRect;
begin
  Result := CellsArea;
  ...
  begin
    if ARow > FrozenRow then
      Result.Top := FrozenRowSeparatorPosition +
        OptionsView.FrozenPaneSeparatorWidth - 1
    else
  ...
  begin
    ...
    begin
      if AColumn > FrozenColumn then
        Result.Right := FrozenColumnSeparatorPosition +
          OptionsView.FrozenPaneSeparatorWidth + 1
      else
        Result.Left := FrozenColumnSeparatorPosition - 1;
    end
    else if AColumn > FrozenColumn then
      Result.Left := FrozenColumnSeparatorPosition +
        OptionsView.FrozenPaneSeparatorWidth - 1
    else
...
procedure TdxSpreadSheetTableViewInfo.GetCellAtPoint(P: TPoint;
out ARow, AColumn: Integer; AReturnNearestCell: Boolean = False;
AVisibleAreaOnly: Boolean = True);

  function FindItem(APos, AMinPos, AMaxPos, AFirstIndex, ALastIndex,
    AFixedPosition, AFixedOffset: Integer;
  ...
  begin
    ...
    begin
      ...
      begin
        if AIsContentFlipped and
          (APos < AFixedPosition - OptionsView.FrozenPaneSeparatorWidth + 1)
        then
          Dec(APos, AFixedOffset);
        if not AIsContentFlipped and
          (APos > AFixedPosition + OptionsView.FrozenPaneSeparatorWidth - 1)
        then
...
begin
  ...
  begin
    AColumn := FindItem(P.X, CellsArea.Left, CellsArea.Right, View.LeftColumn,
      VisibleCells.Right, FrozenColumnSeparatorPosition,
      FirstScrollableColumnOffset, ColumnsHeader, IsRightToLeftLayout);
    ARow := FindItem(P.Y, CellsArea.Top, CellsArea.Bottom, View.TopRow,
      VisibleCells.Bottom, FrozenRowSeparatorPosition, FirstScrollableRowOffset,
      RowsHeader, False);
  end;
end;

function TdxSpreadSheetTableViewInfo.GetMergedCell(ARow, AColumn: Integer)
  : TdxSpreadSheetMergedCell;
begin
  Result := View.MergedCells.FindCell(ARow, AColumn);
end;

function TdxSpreadSheetTableViewInfo.GetNeighborCellStyle(ARow,
  AColumn: Integer; ASide: TcxBorder; ADisplayStyle, ACheckVisibleNeighborsOnly
  : Boolean): TdxSpreadSheetCellStyleHandle;
  ...
  begin
    ...
    Result := InRange(ARow, 0, dxSpreadSheetMaxRowIndex) and
      InRange(AColumn, 0, dxSpreadSheetMaxColumnIndex);
  end;
...
begin
  Result := 1 + Byte(FrozenColumn >= 0) + Byte(FrozenRow >= 0) +
    Byte((FrozenColumn >= 0) and (FrozenRow >= 0));
end;
...
begin
  ...
  case APart of
    ...
    2:
      if FrozenColumn >= 0 then
        Dec(Result.X, ValueIncr[IsRightToLeftLayout] *
          FirstScrollableColumnOffset);
    3:
      begin
        Inc(Result.Y, FirstScrollableRowOffset);
        Dec(Result.X, ValueIncr[IsRightToLeftLayout] *
...
function TdxSpreadSheetTableViewInfo.GetPartOffsetByPoint
...
begin
  SetScrollBarInfo(sbVertical, 0, TotalRowCount, 1, VisibleRowCount,
    VScrollBarPos, Options.ActualVerticalScrollBar,
    Options.ActualVerticalScrollBar);
  SetScrollBarInfo(sbHorizontal, 0, TotalColumnCount, 1, VisibleColumnCount,
    HScrollBarPos, Options.ActualHorizontalScrollBar,
    Options.ActualHorizontalScrollBar);
end;
...
begin
  ...
  FGridLineColor := cxGetActualColor(OptionsView.GridLineColor,
    LookAndFeelPainter.DefaultGridLineColor);
  FDefaultCellStyleHandle := View.CellStyles.DefaultStyle;
end;

procedure TdxSpreadSheetTableViewInfo.MergeCellsBorders(AStartIndex,
  AFinishIndex: Integer);
var
...
begin
  ...
  begin
    ...
    for ASide := Low(ASide) to High(ASide) do
      ACell.MergeBorder(ASide, GetNeighborCellStyle(ACell.Row, ACell.Column,
        ASide, True, True));
  end;
end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          while RemoveNeighborCellBorder(bRight, I, AStartIndex,
            AFinishIndex, APos) do
            Inc(I);
        ...
        begin
          ...
          while RemoveNeighborCellBorder(bLeft, I, AStartIndex,
            AFinishIndex, APos) do
            Dec(I);
...
procedure TdxSpreadSheetTableViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited;
  ...
  FScrollableArea := TdxRightToLeftLayoutConverter.ConvertRect(FScrollableArea,
    AClientBounds);
  FCellsArea := TdxRightToLeftLayoutConverter.ConvertRect(FCellsArea,
    AClientBounds);
  if FFrozenColumnSeparatorPosition <> -1 then
    FFrozenColumnSeparatorPosition := Bounds.Right -
      FFrozenColumnSeparatorPosition;
  ...
  Cells.Offset(-dxSpreadSheetBordersMergingOffset, 0);
  // rollback the correction
...
procedure TdxSpreadSheetTableViewInfo.SetScrollBarInfo(AScrollBarKind
  : TScrollBarKind; AMin, AMax, AStep, APage, APos: Integer;
AAllowShow, AAllowHide: Boolean);
begin
  SpreadSheet.SetScrollBarInfo(AScrollBarKind, AMin, AMax, AStep, APage, APos,
    AAllowShow, AAllowHide);
end;

procedure TdxSpreadSheetTableViewInfo.ValidateBounds(AStartIndex, AFinishIndex,
  AFixedIndex, ASeparatorPosition: Integer; var AStart, AFinish: Integer);
begin
...
procedure TdxSpreadSheetTableViewInfo.AddOutOfBoundsNonEmptyCell
  (ARow: TdxSpreadSheetTableRow; AIndex: Integer; const ABounds: TRect;
AGoForward: Boolean);
var
  R: TRect;
  I: Integer;
    ...
    for I := AIndex + 1 to ARow.RowCells.LastIndex do
      ...
      begin
        if not(ARow.Cells[I].IsMerged or ARow.IsValueDefined(I - 1)) then
          AddCell(ARow, ARow.Index, I, cxRectSetLeft(ABounds,
            ABounds.Right + Columns.GetDistance(AIndex + 1, I - 1),
            Columns.GetItemSize(I)));
        Break;
      end;
  end
  else
...
procedure TdxSpreadSheetTableViewInfo.CalculateLastItemIndex(ASize, AStartIndex,
  AFixedIndex, AFirstScrollableIndex, AMaxIndex: Integer;
AItems: TdxSpreadSheetTableItems; var ASeparatorPosition, ALastIndex: Integer;
ASeparatorPositionOffset: Integer);
var
  AItemSize: Integer;
begin
...
function TdxSpreadSheetTableViewInfo.CalculatePrevPageFirstIndex
  (APosition: Integer; AIsHorizontal: Boolean): Integer;
begin
  if AIsHorizontal then
    Result := CalculatePrevPageFirstIndex(APosition,
      cxRectWidth(ScrollableArea), FrozenColumn, Columns)
  else
    Result := CalculatePrevPageFirstIndex(APosition,
      cxRectHeight(ScrollableArea), FrozenRow, Rows)
end;

function TdxSpreadSheetTableViewInfo.CalculatePrevPageFirstIndex(APosition,
  ASize, AFixedIndex: Integer; AItems: TdxSpreadSheetTableItems): Integer;
begin
  Result := Max(AFixedIndex + 1, APosition);
  if Result = AFixedIndex + 1 then
    Exit;
...
function TdxSpreadSheetTableViewInfo.GetFocusedCell
  : TdxSpreadSheetTableViewCellViewInfo;
begin
  Validate;
  Result := FFocusedCell;
...
function TdxSpreadSheetTableViewInfo.GetLookAndFeelPainter
  : TcxCustomLookAndFeelPainter;
begin
...
function TdxSpreadSheetTableViewInfo.GetReferenceHighlighter
  : TdxSpreadSheetCustomReferenceHighlighter;
begin
...
begin
  ...
  else if (ASide = bLeft) and (AIndex > AStartIndex) then
  begin
    ANeighborCell := TdxSpreadSheetTableViewCellViewInfo(Cells[AIndex - 1]);
    AHasValue := (ANeighborCell.DisplayText <> '') or ANeighborCell.IsMerged;
    Result := not AHasValue;
    ...
    AEndPos := cxRectGetItem(TdxSpreadSheetTableViewCellViewInfo(Cells[AIndex])
      .ContentBounds, Integer(ASide));
...
begin
  ...
  AValue := EnsureRange(AValue, FrozenColumn + 1, dxSpreadSheetMaxColumnIndex -
    (FrozenColumn + 1));
  if FrozenColumn < 0 then
    FVisibleCells.Left := AValue
  else
...
begin
  ...
  AValue := EnsureRange(AValue, FrozenRow + 1, dxSpreadSheetMaxRowIndex -
    (FrozenRow + 1));
  if FrozenRow < 0 then
    FVisibleCells.Top := AValue
  else
...
begin
  ...
  begin
    ...
    try
      History.AddCommand(TdxSpreadSheetHistoryDeleteDefinedNameCommand.
        Create(Self));
      FreeAndNil(FFormula);
    finally
      History.EndAction;
...
procedure TdxSpreadSheetDefinedName.EnumReferences
...
function TdxSpreadSheetDefinedName.IsCellReference: Boolean;
  ...
  begin
    ...
    begin
      Result := (AToken.ClassType = TdxSpreadSheetFormulaToken) or
...
function TdxSpreadSheetDefinedName.IsCellReference(out AArea: TRect;
out AView: TdxSpreadSheetCustomView): Boolean;
var
  ATempArea: TRect;
...
begin
  ...
  begin
    ...
    EnumReferences(procedure(const AArea: TRect; AView: TObject)
      begin
        ATempArea := AArea;
...
function TdxSpreadSheetDefinedName.ValidateComment(const AValue
  : string): string;
begin
  Result := AValue;
...
procedure TdxSpreadSheetDefinedName.SetFormula(const AValue
  : TdxSpreadSheetDefinedNameFormula);
begin
...
procedure TdxSpreadSheetDefinedName.SetScope(const AValue
  : TdxSpreadSheetCustomView);
begin
...
constructor TdxSpreadSheetDefinedNames.Create(ASpreadSheet
  : TdxCustomSpreadSheet);
begin
  inherited Create(ASpreadSheet);
  FIndex := TObjectDictionary<string, TList>.Create([doOwnsValues],
    TdxIStringComparer.Ordinal);
end;
...
begin
  ...
  try
    AddFromSelection(AView, AAreas, TdxSpreadSheetDefinedNameHelper.GetHeaders
      (AView, AAreas));
  finally
    AAreas.Free;
  end;
...
procedure TdxSpreadSheetDefinedNames.AddFromSelection
  (AView: TdxSpreadSheetTableView; const ASelectedArea: TRect;
AHeaders: TcxBorders);
  ...
  begin
    ...
    if not IsCaptionValid(AName) then
      AName := TdxSpreadSheetDefinedNameHelper.ReplaceIllegalChars(AName,
        SpreadSheet);
    if not IsCaptionValid(AName) then
    ...
    begin
      Add(AName, dxReferenceToString(AArea,
        SpreadSheet.OptionsView.R1C1Reference, [croSheetName, croAbsoluteColumn,
        croAbsoluteRow], AView.Caption), nil);
    end;
  end;
      ...
      try
        ...
        begin
          for I := AContentArea.Left to AContentArea.Right do
            TryCreate(ASelectedArea.Top, I, cxRect(I, AContentArea.Top, I,
              AContentArea.Bottom));
        end;
        ...
        begin
          for I := AContentArea.Left to AContentArea.Right do
            TryCreate(ASelectedArea.Bottom, I, cxRect(I, AContentArea.Top, I,
              AContentArea.Bottom));
        end;
        ...
        begin
          for I := AContentArea.Top to AContentArea.Bottom do
            TryCreate(I, ASelectedArea.Left, cxRect(AContentArea.Left, I,
              AContentArea.Right, I));
        end;

        if bRight in AHeaders then
        begin
          for I := AContentArea.Top to AContentArea.Bottom do
            TryCreate(I, ASelectedArea.Right, cxRect(AContentArea.Left, I,
              AContentArea.Right, I));
        end;
      finally
        History.EndAction;
...
procedure TdxSpreadSheetDefinedNames.AddFromSelection
  (AView: TdxSpreadSheetTableView; ASelectedAreas: TdxRectList;
AHeaders: TcxBorders);
var
  I: Integer;
begin
...
function TdxSpreadSheetDefinedNames.AddFromStream(AReader: TcxReader)
  : TdxSpreadSheetDefinedName;
var
  ACaption: string;
...
function TdxSpreadSheetDefinedNames.Contains(const ACaption: string;
AScope: TdxSpreadSheetCustomView): Boolean;
begin
  Result := GetItemByName(ACaption, AScope) <> nil;
end;

function TdxSpreadSheetDefinedNames.GetItemByName(const ACaption: string;
AScope: TdxSpreadSheetCustomView): TdxSpreadSheetDefinedName;
begin
...
function TdxSpreadSheetDefinedNames.IndexOf(const ACaption: string;
AScope: TdxSpreadSheetCustomView): Integer;
var
  AItem: TdxSpreadSheetDefinedName;
begin
...
procedure TdxSpreadSheetDefinedNames.Remove
...
begin
  if not IsCaptionValid(ACaption) then
    raise EdxSpreadSheetDefinedNameError.Create
      (cxGetResourceString(@sdxErrorInvalidDefinedNameSyntax));
end;

procedure TdxSpreadSheetDefinedNames.CheckForDuplicates(const ACaption: string;
AScope: TdxSpreadSheetCustomView = nil);
begin
  if Contains(ACaption, AScope) then
    raise EdxSpreadSheetDefinedNameError.CreateFmt
      (cxGetResourceString(@sdxErrorDefinedNameAlreadyExists), [ACaption]);
end;
...
function TdxSpreadSheetDefinedNames.IsCaptionValid(const ACaption
  : string): Boolean;
var
  ALength: Integer;
  I: Integer;
...
begin
  ...
  Result := not(dxTryStringToReferenceArea(ACaption, False, R) and
    dxSpreadSheetIsValidArea(dxSpreadSheetGetRealArea(R)));
end;

procedure TdxSpreadSheetDefinedNames.DoAddToIndex
  (AItem: TdxSpreadSheetDefinedName);
var
  AList: TList;
begin
...
function TdxSpreadSheetDefinedNames.DoCreateItem(const ACaption,
  AReference: string; AScope: TdxSpreadSheetCustomView)
  : TdxSpreadSheetDefinedName;
begin
  ...
  Result.reference := AReference;
  if History.CanAddCommand then
    History.AddCommand(TdxSpreadSheetHistoryCreateDefinedNameCommand.
      Create(Result));
  DoAddToIndex(Result);
end;

procedure TdxSpreadSheetDefinedNames.DoChangeCaption
  (AName: TdxSpreadSheetDefinedName; const ANewCaption: string);
begin
  ...
  try
    SpreadSheet.FormulaController.DoNameChanged(AName, ANewCaption);
...
procedure TdxSpreadSheetDefinedNames.DoRemoveFromIndex
  (AItem: TdxSpreadSheetDefinedName);
var
  AList: TList;
begin
...
AScope: TdxSpreadSheetCustomView; AScopeMaybeEmpty: Boolean;
out AItem: TdxSpreadSheetDefinedName): Boolean;
var
  AList: TList;
  I: Integer;
begin
...
procedure TdxSpreadSheetDefinedNames.DoRemoveSheet
  (AScope: TdxSpreadSheetCustomView);
var
  AItem: TdxSpreadSheetDefinedName;
  I: Integer;
...
function TdxSpreadSheetDefinedNames.GetName(AIndex: Integer)
  : TdxSpreadSheetDefinedName;
begin
...
function TdxSpreadSheetExternalLinks.Add(const ATarget: string)
  : TdxSpreadSheetExternalLink;
begin
...
function TdxSpreadSheetExternalLinks.GetLinkByTarget(const ATarget: string)
  : TdxSpreadSheetExternalLink;
var
  I: Integer;
begin
  ...
  begin
    Result := Items[I];
    if dxSpreadSheetTextIsEqual(Result.Target, ATarget) then
      Exit;
  end;
  Result := nil;
end;
...
function TdxSpreadSheetExternalLinks.GetItem(AIndex: Integer)
  : TdxSpreadSheetExternalLink;
begin
...
constructor TdxSpreadSheetCustomFilerProgressHelper.Create
  (AOwner: TdxSpreadSheetCustomFiler; AStageCount: Integer);
begin
...
constructor TdxSpreadSheetCustomFiler.Create(AOwner: TdxCustomSpreadSheet;
AStream: TStream);
begin
  inherited Create(AOwner);
  FStream := AStream;
...
procedure TdxSpreadSheetCustomFiler.DoError(const AMessage: string;
AType: TdxSpreadSheetMessageType);
begin
  if not(AType in IgnoreMessages) then
    raise EdxSpreadSheetReaderError.Create(AMessage);
end;

procedure TdxSpreadSheetCustomFiler.DoError(const AFormatString: string;
const AArguments: array of const; AType: TdxSpreadSheetMessageType);
begin
...
procedure TdxSpreadSheetCustomFiler.ExecuteSubTask
  (ASubTask: TdxSpreadSheetCustomFilerSubTask);
begin
  try
    ASubTask.Execute;
  finally
...
constructor TdxSpreadSheetCustomFilerSubTask.Create
  (AOwner: TdxSpreadSheetCustomFiler);
begin
  inherited Create;
  FOwner := AOwner;
end;

procedure TdxSpreadSheetCustomFilerSubTask.DoError(const AFormatString: string;
const AArguments: array of const; AType: TdxSpreadSheetMessageType);
begin
  Owner.DoError(AFormatString, AArguments, AType);
end;

procedure TdxSpreadSheetCustomFilerSubTask.DoError(const AMessage: string;
AType: TdxSpreadSheetMessageType);
begin
  Owner.DoError(AMessage, AType);
end;

procedure TdxSpreadSheetCustomFilerSubTask.ExecuteSubTask
  (ASubTask: TdxSpreadSheetCustomFilerSubTask);
begin
...
function TdxSpreadSheetCustomReader.AddBorders(ABordersHandle
  : TdxSpreadSheetBordersHandle): TdxSpreadSheetBordersHandle;
begin
  Result := CellStyles.Borders.AddBorders(ABordersHandle);
end;

function TdxSpreadSheetCustomReader.AddCellStyle(AStyleHandle
  : TdxSpreadSheetCellStyleHandle): TdxSpreadSheetCellStyleHandle;
begin
  Result := CellStyles.AddStyle(AStyleHandle);
end;

function TdxSpreadSheetCustomReader.AddBrush(ABrushHandle
  : TdxSpreadSheetBrushHandle): TdxSpreadSheetBrushHandle;
begin
  Result := CellStyles.Brushes.AddBrush(ABrushHandle);
end;

function TdxSpreadSheetCustomReader.AddFont(AFontHandle
  : TdxSpreadSheetFontHandle): TdxSpreadSheetFontHandle;
begin
  Result := CellStyles.Fonts.AddFont(AFontHandle);
end;

function TdxSpreadSheetCustomReader.AddFormattedSharedString
  (S: TdxSpreadSheetFormattedSharedString): TdxSpreadSheetFormattedSharedString;
begin
  Result := TdxSpreadSheetFormattedSharedString(SpreadSheet.StringTable.Add(S));
end;

function TdxSpreadSheetCustomReader.AddImage(const AStream: TStream)
  : TdxSpreadSheetSharedImageHandle;
begin
  Result := SpreadSheet.SharedImages.Add(AStream);
end;

function TdxSpreadSheetCustomReader.AddNumberFormat(const AFormatCode: string;
ID: Integer = -1): TdxSpreadSheetFormatHandle;
begin
...
function TdxSpreadSheetCustomReader.AddSharedString(const S: string)
  : TdxSpreadSheetSharedString;
begin
  Result := SpreadSheet.StringTable.Add(S);
end;

function TdxSpreadSheetCustomReader.AddTableView(const ACaption: string)
  : TdxSpreadSheetTableView;
begin
  Result := TdxSpreadSheetTableView(SpreadSheet.AddSheet(ACaption,
    TdxSpreadSheetTableView));
end;
...
function TdxSpreadSheetCustomReader.CreateTempBordersHandle
  : TdxSpreadSheetBordersHandle;
begin
...
AFill: TdxSpreadSheetBrushHandle; ABorders: TdxSpreadSheetBordersHandle)
  : TdxSpreadSheetCellStyleHandle;
begin
  Result := CellStyles.CreateStyle(AFont, AFormat, AFill, ABorders);
end;

function TdxSpreadSheetCustomReader.CreateTempBrushHandle
  : TdxSpreadSheetBrushHandle;
begin
  Result := CellStyles.Brushes.CreateBrush;
end;

function TdxSpreadSheetCustomReader.CreateTempFontHandle
  : TdxSpreadSheetFontHandle;
begin
  Result := CellStyles.Fonts.CreateFont;
end;

function TdxSpreadSheetCustomReader.CreateTempFormattedSharedString
  (const S: string): TdxSpreadSheetFormattedSharedString;
begin
...
function TdxSpreadSheetCustomReader.GetStringTable
  : TdxSpreadSheetSharedStringTable;
begin
  Result := SpreadSheet.StringTable;
end;
...
class function TdxSpreadSheetCustomFormat.CanReadFromStream
  (AStream: TStream): Boolean;
begin
  Result := False;
end;

class function TdxSpreadSheetCustomFormat.CreateFormatSettings
  : TdxSpreadSheetFormatSettings;
begin
  Result := nil;
end;
...
class function TdxSpreadSheetCustomFormat.CreateReader
  (ASpreadSheet: TdxCustomSpreadSheet; AStream: TStream)
  : TdxSpreadSheetCustomReader;
begin
...
class function TdxSpreadSheetCustomFormat.GetReader
  : TdxSpreadSheetCustomReaderClass;
begin
  Result := nil;
end;

class function TdxSpreadSheetCustomFormat.GetWriter
...
function TdxSpreadSheetFormatsRepository.Find(const AFileName: string;
out AFormat: TdxSpreadSheetCustomFormatClass): Boolean;
var
  AExt: string;
  I: Integer;
...
begin
  ...
  begin
    ...
    begin
      Result := Result + Format('%0:s (*%1:s)|*%1:s|',
        [AItem.GetDescription, AItem.GetExt]);
      AExts := AExts + '*' + AItem.GetExt + ';';
    end;
  end;
  Result := cxGetResourceString(@sdxFileDialogAllSupported) + '|' + AExts +
    '|' + Result;
end;
...
procedure TdxSpreadSheetFormatsRepository.Register
  (AFormat: TdxSpreadSheetCustomFormatClass);
begin
  FList.Add(AFormat);
end;

procedure TdxSpreadSheetFormatsRepository.Unregister
  (AFormat: TdxSpreadSheetCustomFormatClass);
begin
...
function TdxSpreadSheetFormatsRepository.GetDescriptions
...
function TdxSpreadSheetFormatsRepository.GetItem(Index: Integer)
...
function TdxSpreadSheetCustomViewController.ContainerProcessKeyDown(Key: Word;
Shift: TShiftState): Boolean;

  function FindNextContainerForFocusing(AShift: TShiftState;
  AContainer: TdxSpreadSheetContainer): TdxSpreadSheetContainer;
  begin
    Result := AContainer;
    repeat
      if ssShift in AShift then
...
begin
  ...
  case Key of
    ...
    VK_LEFT, VK_RIGHT:
      ...
      else if [ssAlt, ssShift] * Shift = [ssShift] then
...
procedure TdxSpreadSheetCustomViewController.FocusContainer
  (AContainer: TdxSpreadSheetContainer; AMakeVisible: Boolean);
begin
  FocusedContainer := AContainer;
end;

procedure TdxSpreadSheetCustomViewController.MoveContainer
  (AContainer: TdxSpreadSheetContainer; ADeltaX, ADeltaY: Integer);
begin
...
procedure TdxSpreadSheetCustomViewController.ResizeContainer
  (AContainer: TdxSpreadSheetContainer; ADeltaX, ADeltaY: Integer);
begin
...
procedure TdxSpreadSheetCustomViewController.RotateContainer
  (AContainer: TdxSpreadSheetContainer; ADelta: Single);
begin
  if AContainer.CanRotate then
  begin
    AContainer.BeginChanging;
    try
      AContainer.Transform.RotationAngle :=
        AContainer.Transform.RotationAngle + ADelta;
    finally
      AContainer.EndChanging;
    end;
  end;
...
function TdxSpreadSheetCustomViewController.GetContainers
  : TdxSpreadSheetContainers;
begin
  Result := View.Containers;
end;

function TdxSpreadSheetCustomViewController.GetHitTest
  : TdxSpreadSheetCustomHitTest;
begin
  Result := View.HitTest;
end;

function TdxSpreadSheetCustomViewController.GetSpreadSheet
  : TdxCustomSpreadSheet;
begin
  Result := View.SpreadSheet;
end;
...
procedure TdxSpreadSheetCustomViewController.GetRedoActionCount
  (var ARedoCount: Integer);
begin
end;

procedure TdxSpreadSheetCustomViewController.GetUndoActionCount
  (var AUndoCount: Integer);
begin
end;
...
function TdxSpreadSheetCustomViewController.Redo(const ARedoCount
  : Integer = 1): Boolean;
begin
  Result := False;
end;

function TdxSpreadSheetCustomViewController.Undo(const AUndoCount
  : Integer = 1): Boolean;
begin
  Result := False;
end;

procedure TdxSpreadSheetCustomViewController.SetFocusedContainer
  (AValue: TdxSpreadSheetContainer);
var
...
function TdxSpreadSheetCustomHitTest.GetPopupMenuClass(const P: TPoint)
  : TComponentClass;
begin
  Calculate(P);
...
function TdxSpreadSheetCustomHitTest.GetDragAndDropObjectClass
  : TcxDragAndDropObjectClass;
begin
  if HitObject <> nil then
...
function TdxSpreadSheetCustomHitTest.GetDragAndDropObjectClass(const P: TPoint)
  : TcxDragAndDropObjectClass;
begin
  Calculate(P);
...
procedure TdxSpreadSheetCustomHitTest.SetHitCode(ACode: Integer;
AValue: Boolean);
begin
  if AValue then
...
procedure TdxSpreadSheetCustomDragAndDropObject.CheckScrollArea
  (const P: TPoint);
begin
...
function TdxSpreadSheetCustomDragAndDropObject.TranslateCoords
  (const P: TPoint): TPoint;
begin
  Result := cxPointOffset(inherited TranslateCoords(P),
    View.GetPartOffsetByPoint(P));
end;
...
function TdxSpreadSheetCustomDragAndDropObject.GetHitTest
  : TdxSpreadSheetCustomHitTest;
begin
  Result := Control.ActiveController.HitTest;
end;

function TdxSpreadSheetCustomDragAndDropObject.GetView
  : TdxSpreadSheetCustomView;
begin
...
function TdxSpreadSheetCustomCellBasedDragAndDropObject.EnsureCellInArea
  (const ACellRef: TPoint; const AArea: TRect): TPoint;
begin
...
function TdxSpreadSheetCustomCellBasedDragAndDropObject.GetAbsoluteCellBounds
  (const ARowIndex, AColumnIndex: Integer;
ACheckMergedCells: Boolean = True): TRect;
begin
  if FTableViewIntf <> nil then
    Result := FTableViewIntf.GetAbsoluteCellBounds(ARowIndex, AColumnIndex,
      ACheckMergedCells)
  else
    Result := cxNullRect;
end;
...
function TdxSpreadSheetCustomCellBasedDragAndDropObject.
  RightToLeftDependedPointToAbsolutePoint(const P: TPoint): TPoint;
begin
  if IsRightToLeftLayout then
    Result := TdxRightToLeftLayoutConverter.ConvertPoint(P,
      ToAbsoluteRect(RightToLeftClientBounds))
  else
    Result := P;
end;

function TdxSpreadSheetCustomCellBasedDragAndDropObject.ToAbsolutePoint
  (const P: TPoint): TPoint;
begin
  Result := cxPointOffset(P, ContentOrigin);
end;

function TdxSpreadSheetCustomCellBasedDragAndDropObject.ToAbsoluteRect
  (const R: TRect): TRect;
begin
  Result := cxRectOffset(R, ContentOrigin);
end;

function TdxSpreadSheetCustomCellBasedDragAndDropObject.ToContentRect
  (const R: TRect): TRect;
begin
...
procedure TdxSpreadSheetCustomCellViewInfo.Draw(ACanvas: TcxCanvas;
...
function TdxSpreadSheetCustomCellViewInfo.CanDraw(ACanvas: TcxCanvas;
AStage: TdxSpreadSheetDrawingStage): Boolean;
begin
...
procedure TdxSpreadSheetCustomCellViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
  // do nothing
end;

function TdxSpreadSheetCustomCellViewInfo.GetCursor
  (AHitTest: TdxSpreadSheetCustomHitTest): TCursor;
begin
  Result := crDefault;
end;
...
function TdxSpreadSheetCustomCellViewInfo.GetDragAndDropObjectClass
  (AHitTest: TdxSpreadSheetCustomHitTest): TcxDragAndDropObjectClass;
begin
  Result := nil;
end;

function TdxSpreadSheetCustomCellViewInfo.GetPopupMenuClass
  (AHitTest: TdxSpreadSheetCustomHitTest): TComponentClass;
begin
  Result := nil;
end;

function TdxSpreadSheetCustomCellViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
begin
  Result := False;
end;

function TdxSpreadSheetCustomCellViewInfo.GetLookAndFeelPainter
  : TcxCustomLookAndFeelPainter;
begin
  Result := SpreadSheet.LookAndFeelPainter;
end;
...
procedure TdxSpreadSheetCellViewInfo.Draw(ACanvas: TcxCanvas;
AStage: TdxSpreadSheetDrawingStage);
begin
  if CanDraw(ACanvas, AStage) then
  begin
...
procedure TdxSpreadSheetCellViewInfo.SetBounds(const ABounds,
  AClipBounds: TRect);
begin
  FBounds := ABounds;
...
function TdxSpreadSheetCellViewInfo.CanDraw(ACanvas: TcxCanvas;
AStage: TdxSpreadSheetDrawingStage): Boolean;
begin
  Result := Visible and (AStage in FSupportedDrawingStages) and
    ACanvas.RectVisible(ClipRect);
end;
...
procedure TdxSpreadSheetCellViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited;
  FBounds := TdxRightToLeftLayoutConverter.ConvertRect(FBounds, AClientBounds);
  FClipRect := TdxRightToLeftLayoutConverter.ConvertRect(FClipRect,
    AClientBounds);
  if not cxRectIsEqual(FScreenClipRect, cxFullAreaRect) then
    FScreenClipRect := TdxRightToLeftLayoutConverter.ConvertRect
      (FScreenClipRect, AClientBounds);
end;
...
function TdxSpreadSheetCellViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
begin
...
function TdxSpreadSheetViewAbstractCellViewInfo.GetSpreadSheet
  : TdxCustomSpreadSheet;
begin
  Result := View.SpreadSheet;
end;
...
function TdxSpreadSheetTableViewAbstractCellViewInfo.GetTableView
  : TdxSpreadSheetTableView;
begin
  Result := TdxSpreadSheetTableView(inherited View);
end;
...
constructor TdxSpreadSheetTableViewSelectionViewInfo.Create(AOwnerViewInfo
  : TdxSpreadSheetTableViewInfo);
begin
  FOwnerViewInfo := AOwnerViewInfo;
  FFillAreas := TdxRectList.Create;
  FFillBrush := TdxGPBrush.Create;
  FFrameViewInfo := TdxSpreadSheetTableViewSelectionFrameViewInfo.Create
    (AOwnerViewInfo.View);
end;
...
procedure TdxSpreadSheetTableViewSelectionViewInfo.Draw(ACanvas: TcxCanvas;
AStage: TdxSpreadSheetDrawingStage);
var
  AClipRect: TRect;
  ...
  I: Integer;
begin
  if (AStage = dsFirst) and (FillAreas.Count > 0) and
    (GetClipBox(ACanvas.Handle, AClipRect) > NULLREGION) then
  begin
...
function TdxSpreadSheetTableViewSelectionViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
begin
  Result := IsFrameVisible and FrameViewInfo.InitHitTest(AHitTest);
end;

procedure TdxSpreadSheetTableViewSelectionViewInfo.CalculateCore
  (ASelection: TdxSpreadSheetTableViewSelection);
const
...
var
  ...
  I: Integer;
begin
  FillBrush.Color := dxColorToAlphaColor
    (OwnerViewInfo.SelectionParams.Color, 127);

  AFocusedCellArea := cxRectBounds(ASelection.FocusedColumn,
    ASelection.FocusedRow, 0, 0);
  FIsFrameVisible := dxSpreadSheetIsValidArea(AFocusedCellArea);
  if not dxSpreadSheetIsEntireRowOrColumn(AFocusedCellArea) then
    AFocusedCellArea := OwnerViewInfo.View.MergedCells.ExpandArea
      (AFocusedCellArea);
  ...
  AFrameViewInfo :=
    FrameViewInfo as TdxSpreadSheetTableViewSelectionFrameViewInfo;
  AFrameViewInfo.Corner := CornersMap[OwnerViewInfo.IsRightToLeftLayout];
  AFrameViewInfo.SetBounds(OwnerViewInfo.GetAreaBounds(AFrameArea),
    OwnerViewInfo.Bounds);
...
var
  I: Integer;
begin
  Result := cxRectInflate(FrameViewInfo.Bounds,
    dxSpreadSheetSelectionThickness);
  for I := 0 to FillAreas.Count - 1 do
    Result := cxRectUnion(Result, FillAreas[I]);
end;

function TdxSpreadSheetTableViewSelectionViewInfo.GetFillAreaBounds
  (const AArea: TRect): TRect;
begin
  Result := cxRectOffset(OwnerViewInfo.GetAreaBounds(AArea),
    -dxSpreadSheetBordersMergingOffset, -dxSpreadSheetBordersMergingOffset);
end;

{ TdxSpreadSheetCellViewInfoList }

procedure TdxSpreadSheetCellViewInfoList.Add
...
function TdxSpreadSheetCellViewInfoList.Find(AItemOwner: TObject; out AItem;
AIndex: PInteger = nil): Boolean;
var
...
procedure TdxSpreadSheetCellViewInfoList.RightToLeftConversion
  (const AClientBounds: TRect);
var
  I: Integer;
begin
...
function TdxSpreadSheetCellViewInfoList.GetItem(AIndex: Integer)
  : TdxSpreadSheetCellViewInfo;
begin
...
procedure TdxSpreadSheetTableViewCellViewInfoList.Add
  (AViewInfo: TdxSpreadSheetCellViewInfo);
begin
  inherited Add(AViewInfo);
  FIndex.AddOrSetValue(dxMakeInt64(TdxSpreadSheetTableViewCellViewInfo
    (AViewInfo).Column, TdxSpreadSheetTableViewCellViewInfo(AViewInfo).Row),
...
function TdxSpreadSheetTableViewCellViewInfoList.FindItemForCell
  (ACell: TdxSpreadSheetCell;
out AViewInfo: TdxSpreadSheetTableViewCellViewInfo): Boolean;
begin
  Result := (ACell <> nil) and FindItemForCell(ACell.RowIndex,
    ACell.ColumnIndex, AViewInfo)
end;

function TdxSpreadSheetTableViewCellViewInfoList.FindItemForCell(ARow,
  AColumn: Integer; out AViewInfo: TdxSpreadSheetTableViewCellViewInfo)
  : Boolean;
begin
  Result := FIndex.TryGetValue(dxMakeInt64(AColumn, ARow), AViewInfo);
end;

function TdxSpreadSheetTableViewCellViewInfoList.GetItem(Index: Integer)
  : TdxSpreadSheetTableViewCellViewInfo;
begin
...
procedure TdxSpreadSheetTableViewMergedCellViewInfo.
  CalculateDisplayTextParameters(const R: TRect; ACell: TdxSpreadSheetCell);
begin
...
begin
  Calculate;
  FContentBounds := cxRectContent(Bounds,
    TdxSpreadSheetCell.GetContentOffsets(sscbsDefault));
...
constructor TdxSpreadSheetTableViewGroupCustomExpandButtonViewInfo.Create
  (AOwner: TObject);
begin
  inherited Create(AOwner);
  FState := cxbsNormal;
...
function TdxSpreadSheetTableViewGroupCustomExpandButtonViewInfo.GetPainter
  : TdxSpreadSheetTableViewPainter;
begin
  Result := View.ViewInfo.Painter;
end;

procedure TdxSpreadSheetTableViewGroupCustomExpandButtonViewInfo.SetState
  (AValue: TcxButtonState);
begin
...
constructor TdxSpreadSheetTableViewGroupLevelExpandButtonViewInfo.Create
  (AOwner: TObject; ALevel: Integer);
begin
  inherited Create(AOwner);
  FLevel := ALevel;
end;

procedure TdxSpreadSheetTableViewGroupLevelExpandButtonViewInfo.DoDraw
  (ACanvas: TcxCanvas);
begin
  Painter.DrawGroupLevelExpandButton(ACanvas, Bounds, State, FLevel);
end;

function TdxSpreadSheetTableViewGroupLevelExpandButtonViewInfo.GetView
  : TdxSpreadSheetCustomView;
begin
  Result := Items.View;
end;

function TdxSpreadSheetTableViewGroupLevelExpandButtonViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
begin
  Result := inherited;
  if Result then
...
function TdxSpreadSheetTableViewGroupLevelExpandButtonViewInfo.GetItems
  : TdxSpreadSheetTableItems;
begin
...
constructor TdxSpreadSheetTableViewGroupViewInfo.Create(AOwner: TObject;
AVertical: Boolean);
begin
  inherited Create(AOwner);
  FVertical := AVertical;
...
begin
  ...
  begin
    ...
    begin
      ...
      FLineRect := cxRect(FLineRect.Left, FLineTailRect.Bottom,
        FLineRect.Left + Thickness, FExpandButtonRect.Top);
    end
    else
    begin
      FExpandButtonRect := cxRectSetHeight(Bounds, AMinSize.cy);
      FLineTailRect := cxRectSetBottom(FLineRect, FLineRect.Bottom, Thickness);
      FLineRect := cxRect(FLineRect.Left, FExpandButtonRect.Bottom,
        FLineRect.Left + Thickness, FLineTailRect.Top);
    end;
  end
  else
  begin
    ...
    begin
      ...
      FLineRect := cxRect(FLineTailRect.Right, FLineRect.Top,
        FExpandButtonRect.Left, FLineRect.Top + Thickness);
    end
    else
    begin
      FExpandButtonRect := cxRectSetWidth(Bounds, AMinSize.cx);
      FLineTailRect := cxRectSetRight(FLineRect, FLineRect.Right, Thickness);
      FLineRect := cxRect(FExpandButtonRect.Right, FLineRect.Top,
        FLineTailRect.Left, FLineRect.Top + Thickness);
    end;
  end;
end;
...
begin
  ...
  try
    ...
    Painter.DrawGroupExpandButton(ACanvas, ExpandButtonRect, State, Vertical,
      Expanded);
  finally
    ACanvas.RestoreClipRegion;
  end;
...
function TdxSpreadSheetTableViewGroupViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
begin
  Result := inherited and
    (Expanded and PtInRect(LineRect, AHitTest.ActualHitPoint) or
    PtInRect(ExpandButtonRect, AHitTest.ActualHitPoint));

  if Result then
  begin
    AHitTest.SetHitCode(hcGroup, True);
    AHitTest.SetHitCode(hcExpandButton, PtInRect(ExpandButtonRect,
      AHitTest.ActualHitPoint));
  end;
end;
...
procedure TdxSpreadSheetTableViewGroupViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited;
  FExpandButtonRect := TdxRightToLeftLayoutConverter.ConvertRect
    (FExpandButtonRect, AClientBounds);
  FLineTailRect := TdxRightToLeftLayoutConverter.ConvertRect(FLineTailRect,
    AClientBounds);
  FLineRect := TdxRightToLeftLayoutConverter.ConvertRect(FLineRect,
    AClientBounds);
end;

function TdxSpreadSheetTableViewGroupViewInfo.GetGroup
  : TdxSpreadSheetTableItemGroup;
begin
...
constructor TdxSpreadSheetTableViewCustomGroupingAreaViewInfo.Create
  (AOwner: TObject);
begin
  inherited Create(AOwner);
...
begin
  Result := GetGroupLevelSize * Items.Groups.Root.MaxNestingLevel + 2 *
    ContentIndent;
end;

procedure TdxSpreadSheetTableViewCustomGroupingAreaViewInfo.Offset(X,
  Y: Integer);
begin
  inherited;
  Cells.Offset(X, Y);
...
procedure TdxSpreadSheetTableViewCustomGroupingAreaViewInfo.
  RightToLeftConversion(const AClientBounds: TRect);
var
  I: Integer;
begin
  inherited;
  ...
  for I := 0 to Marks.Count - 1 do
    Marks[I] := TdxRightToLeftLayoutConverter.ConvertRect(Marks[I],
      AClientBounds);
end;
...
procedure TdxSpreadSheetTableViewCustomGroupingAreaViewInfo.
  AddGroupLevelExpandButtonCell(ALevel: Integer; const ABounds: TRect);
var
  ACell: TdxSpreadSheetTableViewGroupLevelExpandButtonViewInfo;
begin
  ACell := TdxSpreadSheetTableViewGroupLevelExpandButtonViewInfo.Create
    (Items, ALevel);
  ACell.SetBounds(ABounds, Bounds);
  Cells.Add(ACell);
end;
...
procedure TdxSpreadSheetTableViewCustomGroupingAreaViewInfo.
  CalculateGroupChildren(AGroup: TdxSpreadSheetTableItemGroup;
const AAreaBounds: TRect; AAreaStartIndex, AAreaFinishIndex: Integer);
var
  I: Integer;
begin
...
procedure TdxSpreadSheetTableViewCustomGroupingAreaViewInfo.
  CalculateGroupLevelMarks(AGroup: TdxSpreadSheetTableItemGroup;
const AAreaBounds: TRect);
var
  AIndex: Integer;
  ASubGroup: TdxSpreadSheetTableItemGroup;
begin
  ...
  begin
    ...
    if ASubGroup = AGroup then
      Marks.Add(CalculateGroupLevelMarkBounds(AAreaBounds,
        AGroup.StartIndex, AIndex))
    else
...
procedure TdxSpreadSheetTableViewCustomGroupingAreaViewInfo.DoDraw
  (ACanvas: TcxCanvas);
var
  I: Integer;
begin
...
function TdxSpreadSheetTableViewCustomGroupingAreaViewInfo.
  GetGroupCellsArea: TRect;
begin
  Result := cxRectInflate(Bounds, -ContentIndent);
end;

function TdxSpreadSheetTableViewCustomGroupingAreaViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
begin
...
AAreaStartIndex, AAreaFinishIndex: Integer);
var
  AGroupArea: TRect;
  ARect: TRect;
begin
  if not(InRange(ViewInfo.VisibleCells.Left, AGroup.StartIndex,
    AGroup.FinishIndex) or InRange(ViewInfo.VisibleCells.Right,
    AGroup.StartIndex, AGroup.FinishIndex) or InRange(AGroup.StartIndex,
    ViewInfo.VisibleCells.Left, ViewInfo.VisibleCells.Right) or
    InRange(AGroup.FinishIndex, ViewInfo.VisibleCells.Left,
    ViewInfo.VisibleCells.Right)) then
    Exit;

  AGroupArea := cxRectSetSize(AAreaBounds, Items.GetDistance(AGroup.StartIndex,
    AGroup.FinishIndex), GroupLevelSize);
  AGroupArea := cxRectOffset(AGroupArea,
    cxPoint(Items.GetDistance(AAreaStartIndex, AGroup.StartIndex - 1), 0));

  if AGroup.FinishIndex <> AAreaFinishIndex then
  begin
    ARect := AGroupArea;
    if Items.Groups.ExpandButtonPosition = gebpGroupStart then
      Dec(ARect.Left, (Items.GetItemSize(AGroup.StartIndex - 1) +
        Painter.GetGroupExpandButtonMinSize.cx) div 2)
    else
      Inc(ARect.Right, (Items.GetItemSize(AGroup.FinishIndex + 1) +
        Painter.GetGroupExpandButtonMinSize.cx) div 2);

    ARect.Left := Min(ARect.Left,
      ARect.Right - Painter.GetGroupExpandButtonMinSize.cx);
    AddGroupCell(TdxSpreadSheetTableViewGroupViewInfo.Create(AGroup,
      False), ARect);
  end;
  ...
  begin
    ...
    CalculateGroupChildren(AGroup, AGroupArea, AGroup.StartIndex,
      AGroup.FinishIndex);
    CalculateGroupLevelMarks(AGroup, AGroupArea);
  end;
end;

function TdxSpreadSheetTableViewColumnsGroupingAreaViewInfo.
  CalculateGroupLevelMarkBounds(const AAreaBounds: TRect;
AStartIndex, AIndex: Integer): TRect;
begin
  Result := AAreaBounds;
...
procedure TdxSpreadSheetTableViewColumnsGroupingAreaViewInfo.
  CalculateGroupLevelsExpandButtons;
var
  I: Integer;
  R: TRect;
...
function TdxSpreadSheetTableViewColumnsGroupingAreaViewInfo.
  GetGroupLevelSize: Integer;
begin
  Result := Painter.GetGroupExpandButtonMinSize.cy;
end;

function TdxSpreadSheetTableViewColumnsGroupingAreaViewInfo.GetItems
  : TdxSpreadSheetTableItems;
begin
...
var
  ...
  ARect: TRect;
begin
  if not(InRange(ViewInfo.VisibleCells.Top, AGroup.StartIndex,
    AGroup.FinishIndex) or InRange(ViewInfo.VisibleCells.Bottom,
    AGroup.StartIndex, AGroup.FinishIndex) or InRange(AGroup.StartIndex,
    ViewInfo.VisibleCells.Top, ViewInfo.VisibleCells.Bottom) or
    InRange(AGroup.FinishIndex, ViewInfo.VisibleCells.Top,
    ViewInfo.VisibleCells.Bottom)) then
    Exit;

  AGroupArea := cxRectSetSize(cxRectOffset(AAreaBounds, 0,
    Items.GetDistance(AAreaStartIndex, AGroup.StartIndex - 1)), GroupLevelSize,
    Items.GetDistance(AGroup.StartIndex, AGroup.FinishIndex));

  if AGroup.FinishIndex <> AAreaFinishIndex then
  begin
    ARect := AGroupArea;
    if Items.Groups.ExpandButtonPosition = gebpGroupStart then
      Dec(ARect.Top, (Items.GetItemSize(AGroup.StartIndex - 1) +
        Painter.GetGroupExpandButtonMinSize.cy) div 2)
    else
      Inc(ARect.Bottom, (Items.GetItemSize(AGroup.FinishIndex + 1) +
        Painter.GetGroupExpandButtonMinSize.cy) div 2);

    ARect.Top := Min(ARect.Top, ARect.Bottom -
      Painter.GetGroupExpandButtonMinSize.cy);
    AddGroupCell(TdxSpreadSheetTableViewGroupViewInfo.Create(AGroup,
      True), ARect);
  end;
...
function TdxSpreadSheetTableViewRowsGroupingAreaViewInfo.
  CalculateGroupLevelMarkBounds(const AAreaBounds: TRect;
AStartIndex, AIndex: Integer): TRect;
begin
  Result := AAreaBounds;
...
procedure TdxSpreadSheetTableViewRowsGroupingAreaViewInfo.
  CalculateGroupLevelsExpandButtons;
var
  I: Integer;
  R: TRect;
...
function TdxSpreadSheetTableViewRowsGroupingAreaViewInfo.GetItems
  : TdxSpreadSheetTableItems;
begin
...
constructor TdxSpreadSheetContainerViewInfo.Create
  (AContainer: TdxSpreadSheetContainer);
begin
...
function TdxSpreadSheetContainerViewInfo.GetCursor
  (AHitTest: TdxSpreadSheetCustomHitTest): TCursor;
begin
...
begin
  ...
  begin
    AMargins := dxRectF(ContentBounds.Left - Bounds.Left,
      ContentBounds.Top - Bounds.Top, Bounds.Right - ContentBounds.Right,
...
begin
  if Selected then
  begin
    Selection.SetBounds(cxRectInflate(Bounds, Selection.ContentOffsets),
      ScreenClipRect);
    Selection.Calculate;
  end;
end;
...
function TdxSpreadSheetContainerViewInfo.CreateSelectionViewInfo
  : TdxSpreadSheetContainerSelectionCellViewInfo;
begin
...
function TdxSpreadSheetContainerViewInfo.DoInitHitTest(const P: TPoint;
AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
begin
...
function TdxSpreadSheetContainerViewInfo.GetDragAndDropObjectClass
  (AHitTest: TdxSpreadSheetCustomHitTest): TcxDragAndDropObjectClass;
begin
...
function TdxSpreadSheetContainerViewInfo.GetPopupMenuClass
  (AHitTest: TdxSpreadSheetCustomHitTest): TComponentClass;
begin
...
begin
  Result := cxRect(TransformMatrix.GetBoundingRectangle
    (cxRectInflate(ContentBounds, Ceil(BorderWidth))), False);
end;
...
function TdxSpreadSheetContainerViewInfo.GetTransform
  : TdxSpreadSheetContainerTransform;
begin
  Result := Owner.Transform;
end;
...
function TdxSpreadSheetContainerViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
begin
  Result := HasSelectionFrame and Selection.InitHitTest(AHitTest);
  if not Result then
  begin
    Result := DoInitHitTest(TransformMatrixInv.TransformPoint
      (AHitTest.ActualHitPoint), AHitTest);
    if Result then
    begin
      AHitTest.HitObject := Self;
...
procedure TdxSpreadSheetContainerViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited;
  DoCalculate;
...
function TdxSpreadSheetContainerViewInfo.GetOptionsView
  : TdxSpreadSheetOptionsView;
begin
  Result := SpreadSheet.OptionsView;
end;
...
procedure TdxSpreadSheetContainerViewInfo.SetContentBounds
  (const AValue: TdxRectF);
begin
...
procedure TdxSpreadSheetContainerViewInfo.SetRotationAngle
  (const AValue: Double);
begin
...
procedure TdxSpreadSheetContainerCustomDragAndDropObject.AlignToCell
  (var ADeltaX, ADeltaY: Integer; P: TPoint);
...
begin
  ...
  begin
    ...
    if P.X > cxRectCenter(ACellBounds).X then
      SetDelta(ADeltaX, ValueIncr[IsRightToLeftLayout] *
        (P.X - ACellBounds.Right))
    else
      SetDelta(ADeltaX, ValueIncr[IsRightToLeftLayout] *
        (P.X - ACellBounds.Left));
...
procedure TdxSpreadSheetContainerCustomDragAndDropObject.AlignToCells
  (var R: TRect);
var
  ADeltaX, ADeltaY: Integer;
begin
  ...
  R := cxRectOffset(R, IfThen(ADeltaX <> MaxInt, ADeltaX),
    IfThen(ADeltaY <> MaxInt, ADeltaY));
end;
...
procedure TdxSpreadSheetContainerCustomDragAndDropObject.DragAndDrop
...
procedure TdxSpreadSheetContainerCustomDragAndDropObject.EndDragAndDrop
  (Accepted: Boolean);
begin
  inherited EndDragAndDrop(Accepted);
  if Accepted and not cxRectIsEqual(Bounds, ToAbsoluteRect(ViewInfo.Bounds))
  then
  begin
...
function TdxSpreadSheetContainerCustomDragAndDropObject.GetContainerViewInfo
  : TdxSpreadSheetContainerViewInfo;
begin
...
function TdxSpreadSheetContainerCustomDragAndDropObject.GetDragAndDropCursor
...
function TdxSpreadSheetContainerCustomDragAndDropObject.GetHistory
  : TdxSpreadSheetHistory;
begin
  Result := View.SpreadSheet.History;
end;

function TdxSpreadSheetContainerCustomDragAndDropObject.
  GetImmediateStart: Boolean;
begin
  Result := True;
end;

procedure TdxSpreadSheetContainerCustomDragAndDropObject.InvalidateRects
  (const R1, R2: TRect);
begin
...
function TdxSpreadSheetContainerCustomDragAndDropObject.ProcessKeyDown
  (AKey: Word; AShiftState: TShiftState): Boolean;
begin
  case AKey of
...
function TdxSpreadSheetContainerCustomDragAndDropObject.ProcessKeyUp(AKey: Word;
...
procedure TdxSpreadSheetContainerCustomDragAndDropObject.
  RecalculateDragAndDropInfo;
var
  AAccepted: Boolean;
begin
...
procedure TdxSpreadSheetContainerCustomDragAndDropObject.UpdateViewInfoBounds
  (const AAbsoluteBounds: TRect);
...
function TdxSpreadSheetContainerCustomDragAndDropObject.TranslateCoords
  (const P: TPoint): TPoint;
begin
  Result := ToAbsolutePoint(inherited TranslateCoords(P));
end;

function TdxSpreadSheetContainerCustomDragAndDropObject.CheckIsKeyPressed
  (const Index: Integer): Boolean;
begin
  Result := GetAsyncKeyState(Index) < 0;
end;

function TdxSpreadSheetContainerCustomDragAndDropObject.GetContainer
  : TdxSpreadSheetContainer;
begin
...
constructor TdxSpreadSheetContainerSelectionCellViewInfo.Create
  (AContainerViewInfo: TdxSpreadSheetContainerViewInfo);
begin
...
function TdxSpreadSheetContainerSelectionCellViewInfo.GetCursor
  (AHitTest: TdxSpreadSheetCustomHitTest): TCursor;
const
  CursorMap: array [0 .. 7, TdxSpreadSheetSizingMarker] of TCursor =
    ((crSizeWE, crSizeNWSE, crSizeNS, crSizeNESW, crSizeWE, crSizeNWSE,
    crSizeNS, crSizeNESW), (crSizeNWSE, crSizeNS, crSizeNESW, crSizeWE,
    crSizeNWSE, crSizeNS, crSizeNESW, crSizeWE),
    (crSizeNS, crSizeNESW, crSizeWE, crSizeNWSE, crSizeNS, crSizeNESW, crSizeWE,
    crSizeNWSE), (crSizeNESW, crSizeWE, crSizeNWSE, crSizeNS, crSizeNESW,
    crSizeWE, crSizeNWSE, crSizeNS),

    (crSizeWE, crSizeNWSE, crSizeNS, crSizeNESW, crSizeWE, crSizeNWSE, crSizeNS,
    crSizeNESW), (crSizeNWSE, crSizeNS, crSizeNESW, crSizeWE, crSizeNWSE,
    crSizeNS, crSizeNESW, crSizeWE), (crSizeNS, crSizeNESW, crSizeWE,
    crSizeNWSE, crSizeNS, crSizeNESW, crSizeWE, crSizeNWSE),
    (crSizeNESW, crSizeWE, crSizeNWSE, crSizeNS, crSizeNESW, crSizeWE,
    crSizeNWSE, crSizeNS));
var
  AAngleIndex: Integer;
begin
  ...
  begin
    ...
    if AAngleIndex < 0 then
      Inc(AAngleIndex, 8);
    Result := CursorMap[AAngleIndex,
      TdxSpreadSheetSizingMarker(AHitTest.HitObjectData)];
  end;
end;
...
function TdxSpreadSheetContainerSelectionCellViewInfo.CanDraw
  (ACanvas: TcxCanvas; AStage: TdxSpreadSheetDrawingStage): Boolean;
begin
  Result := (AStage in FSupportedDrawingStages) and
    ContainerViewInfo.CanDrawSelection;
end;
...
function TdxSpreadSheetContainerSelectionCellViewInfo.CreateSizingMarkerBrush
  : TdxGPBrush;
begin
...
function TdxSpreadSheetContainerSelectionCellViewInfo.CreateRotateMarkerBrush
  : TdxGPBrush;
begin
  Result := TdxGPBrush.Create;
  Result.Style := gpbsGradient;
...
procedure TdxSpreadSheetContainerSelectionCellViewInfo.DoDraw
  (ACanvas: TcxCanvas);
const
...
procedure TdxSpreadSheetContainerSelectionCellViewInfo.DrawContent
  (ACanvas: TdxGPCanvas);
var
  APen: TdxGpPen;
begin
...
procedure TdxSpreadSheetContainerSelectionCellViewInfo.DrawRotateMarker
  (ACanvas: TdxGPCanvas; APen: TdxGpPen);
var
  ABrush: TdxGPBrush;
  ARect: TRect;
begin
  ...
  try
    ...
    ACanvas.Line(cxRectCenter(ARect).X, ARect.Bottom, cxRectCenter(ARect).X,
      FrameRect.Top, APen);
  finally
    ABrush.Free;
  end;
...
procedure TdxSpreadSheetContainerSelectionCellViewInfo.DrawSizingMarkers
  (ACanvas: TdxGPCanvas; APen: TdxGpPen);
var
  ABrush: TdxGPBrush;
...
function TdxSpreadSheetContainerSelectionCellViewInfo.
  GetRealDrawingBounds: TRect;
begin
  Result := cxRectInflate
    (cxRect(ContainerViewInfo.TransformMatrix.GetBoundingRectangle
    (dxRectF(Bounds))), 1);
end;
...
begin
  if HasRotateMarker then
    Result := cxRectCenterHorizontally(cxRectSetHeight(Bounds,
      RotateMarkerSize), RotateMarkerSize)
  else
    Result := cxNullRect;
end;
...
begin
  Result := False;
  for AIndex := Low(TdxSpreadSheetSizingMarker)
    to High(TdxSpreadSheetSizingMarker) do
...
function TdxSpreadSheetContainerSelectionCellViewInfo.GetSizeMarkerRect
  (AMarker: TdxSpreadSheetSizingMarker): TRect;
begin
  if HasResizeMarkers then
  begin
    ...
    if AMarker in [smLeft, smRight] then
      Result := cxRectOffset(Result, 0,
        (cxRectHeight(SizeMarkersArea) - SizingPointSize) div 2)
    else if AMarker = smBottom then
      Result := cxRectOffset(Result, 0, cxRectHeight(SizeMarkersArea) -
        SizingPointSize);

    if AMarker in [smTop, smBottom] then
      Result := cxRectOffset(Result,
        (cxRectWidth(SizeMarkersArea) - SizingPointSize) div 2, 0)
    else if AMarker = smRight then
      Result := cxRectOffset(Result, cxRectWidth(SizeMarkersArea) -
        SizingPointSize, 0);
  end
  else
    Result := cxNullRect;
...
function TdxSpreadSheetContainerSelectionCellViewInfo.GetSpreadSheet
  : TdxCustomSpreadSheet;
begin
  Result := ContainerViewInfo.SpreadSheet;
end;

function TdxSpreadSheetContainerSelectionCellViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
var
  ALocalPoint: TPoint;
  AMarker: TdxSpreadSheetSizingMarker;
begin
  ALocalPoint := ContainerViewInfo.TransformMatrixInv.TransformPoint
    (AHitTest.ActualHitPoint);
  ...
  else if GetSizeMarkerAtLocalPoint(ALocalPoint, AMarker) then
  begin
    AHitTest.HitObject := Self;
...
procedure TdxSpreadSheetContainerSelectionCellViewInfo.InvalidateRect
  (const R: TRect);
begin
  ContainerViewInfo.InvalidateRect(R);
end;

procedure TdxSpreadSheetContainerSelectionCellViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited;
  FSizeMarkersArea := TdxRightToLeftLayoutConverter.ConvertRect
    (FSizeMarkersArea, AClientBounds);
end;

{ TdxSpreadSheetResizeTableItemDragAndDropObject }

constructor TdxSpreadSheetResizeTableItemDragAndDropObject.Create
  (AControl: TcxControl);
var
...
begin
  ...
  if HitTest.HitAtColumnHeader then
    Items := View.Columns
  else if HitTest.HitAtRowHeader then
    Items := View.Rows
  else
  begin
  ...
  if Items.GetItemVisible(ItemIndex + 1) then
    ...
    ItemStartPos := cxPoint(AHeaderViewInfo.Bounds.Left,
      AHeaderViewInfo.Bounds.Bottom);

  ItemStartPos := cxPointOffset(ItemStartPos, cxSimplePoint, False);
  ItemStartPos := cxPointOffset(ItemStartPos,
    View.GetPartOffsetByPoint(StartPos), False);
...
function TdxSpreadSheetResizeTableItemDragAndDropObject.CheckPoint
  (const P: TPoint): TPoint;
var
  R: TRect;
begin
...
procedure TdxSpreadSheetResizeTableItemDragAndDropObject.DrawSizingMark
  (const ARect: TRect);
begin
  Canvas.SaveState;
  try
...
function TdxSpreadSheetResizeTableItemDragAndDropObject.GetDistance(const P1,
  P2: TPoint): Integer;
begin
  if Orientation <> orHorizontal then
    Result := P1.Y - P2.Y
  else if View.IsRightToLeftLayout then
    Result := P2.X - P1.X
  else
    Result := P1.X - P2.X;
end;

function TdxSpreadSheetResizeTableItemDragAndDropObject.GetDragAndDropCursor
  (Accepted: Boolean): TCursor;
const
...
function TdxSpreadSheetResizeTableItemDragAndDropObject.
  GetImmediateStart: Boolean;
begin
  Result := True;
end;

function TdxSpreadSheetResizeTableItemDragAndDropObject.GetSizingMarkBounds
...
procedure TdxSpreadSheetResizeTableItemDragAndDropObject.DragAndDrop
  (const P: TPoint; var Accepted: Boolean);
begin
  inherited DragAndDrop(P, Accepted);
  ChangePosition;
...
procedure TdxSpreadSheetResizeTableItemDragAndDropObject.EndDragAndDrop
  (Accepted: Boolean);
var
  I: Integer;
      ...
      begin
        ...
        begin
          ...
          if not AEntireAreaSelected then
            ...
            begin
              ARect := dxSpreadSheetCellsUnion
                (View.Selection.Items[I].Rect, ARect);
              AEntireAreaSelected := AEntireAreaSelected or
                dxSpreadSheetIsEntireArea(View.Selection.Items[I].Rect);
            end;

          if AEntireAreaSelected then
          begin
            Items.ForEach(procedure(AItem: TdxDynamicListItem)
              begin
                TdxSpreadSheetTableItem(AItem).Size := AItemSize;
              end);
            View.History.AddCommand
              (TdxSpreadSheetHistoryChangeDefaultSizeCommand.Create(Items));
          ...
          begin
            ...
            for I := ARect.Left to ARect.Right do
              if (Orientation = orHorizontal) and
                View.Selection.IsEntireColumnSelected(I) or
                (Orientation = orVertical) and
                View.Selection.IsEntireRowSelected(I) then
...
function TdxSpreadSheetResizeTableItemDragAndDropObject.TranslateCoords
  (const P: TPoint): TPoint;
begin
  Result := P;
end;

function TdxSpreadSheetResizeTableItemDragAndDropObject.GetHitTest
  : TdxSpreadSheetTableViewHitTest;
begin
  Result := View.HitTest;
end;

function TdxSpreadSheetResizeTableItemDragAndDropObject.GetOrientation
  : TdxOrientation;
begin
...
function TdxSpreadSheetResizeTableItemDragAndDropObject.GetView
  : TdxSpreadSheetTableView;
begin
...
begin
  inherited Create;
  FIndex := TDictionary<TdxSpreadSheetMergedCell,
    TdxSpreadSheetTableViewMergedCellViewInfo>.Create;
end;
...
procedure TdxSpreadSheetTableViewMergedCellViewInfoList.Add
  (AViewInfo: TdxSpreadSheetCellViewInfo);
begin
  FIndex.Add(TdxSpreadSheetTableViewMergedCellViewInfo(AViewInfo).MergedCell,
...
function TdxSpreadSheetTableViewMergedCellViewInfoList.Contains
  (ACell: TdxSpreadSheetMergedCell): Boolean;
begin
...
function TdxSpreadSheetTableViewMergedCellViewInfoList.TryGetValue
  (ACell: TdxSpreadSheetMergedCell;
out AViewInfo: TdxSpreadSheetTableViewMergedCellViewInfo): Boolean;
begin
  Result := FIndex.TryGetValue(ACell, AViewInfo);
end;

function TdxSpreadSheetTableViewMergedCellViewInfoList.GetItem(Index: Integer)
  : TdxSpreadSheetTableViewMergedCellViewInfo;
begin
...
function TdxSpreadSheetTableViewCustomCellViewInfo.DoCustomDraw
  (ACanvas: TcxCanvas): Boolean;
begin
  SpreadSheet.DoCustomDrawTableViewCommonCell(View, ACanvas, Self, Result);
end;

function TdxSpreadSheetTableViewCustomCellViewInfo.GetPopupMenuClass
  (AHitTest: TdxSpreadSheetCustomHitTest): TComponentClass;
begin
  Result := TdxSpreadSheetBuiltInTableViewPopupMenu;
end;

function TdxSpreadSheetTableViewCustomCellViewInfo.GetPainter
  : TdxSpreadSheetTableViewPainter;
begin
  Result := ViewInfo.Painter;
end;

function TdxSpreadSheetTableViewCustomCellViewInfo.GetViewInfo
  : TdxSpreadSheetTableViewInfo;
begin
  Result := TdxSpreadSheetTableViewInfo(inherited Owner);
end;

function TdxSpreadSheetTableViewCustomCellViewInfo.GetView
  : TdxSpreadSheetCustomView;
begin
...
function TdxSpreadSheetTableViewHeaderCellViewInfo.DoCustomDraw
  (ACanvas: TcxCanvas): Boolean;
begin
...
begin
  ...
  DoPrepareCanvas(ACanvas);
  LookAndFeelPainter.DrawSpreadSheetScaledHeader(ACanvas, Bounds,
    cxTextRect(Bounds), Neighbors, Borders, State, AlignHorz, AlignVert, False,
    False, DisplayText, ACanvas.Font, ViewParams.TextColor, ViewParams.Color,
    ScaleFactor, TcxDrawBackgroundEvent(nil), IsLast);
end;

procedure TdxSpreadSheetTableViewHeaderCellViewInfo.DoPrepareCanvas
  (ACanvas: TcxCanvas);
begin
...
function TdxSpreadSheetTableViewHeaderCellViewInfo.GetDragAndDropObjectClass
  (AHitTest: TdxSpreadSheetCustomHitTest): TcxDragAndDropObjectClass;
begin
  if AHitTest.GetHitCode(hcRowHeader or hcColumnHeader) and
    AHitTest.GetHitCode(hcResizeArea) then
...
procedure TdxSpreadSheetTableViewHeaderCellViewInfo.Initialize
  (AItem: TdxSpreadSheetTableItem; AIndex: Integer; ANeighbors: TcxNeighbors;
...
procedure TdxSpreadSheetTableViewHeaderCellViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited;
...
function TdxSpreadSheetTableViewHeaderCellViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
  ...
  begin
    ...
    if (FNextNeighbor <> nil) and (FNextNeighbor.Item <> nil) and
      (FNextNeighbor.Item.Size < ADelta) then
...
procedure TdxSpreadSheetTableViewHeaderCellViewInfo.SetState
  (AValue: TcxButtonState);
begin
...
function TdxSpreadSheetTableViewColumnHeaderCellViewInfo.GetCursor
  (AHitTest: TdxSpreadSheetCustomHitTest): TCursor;
begin
...
function TdxSpreadSheetTableViewColumnHeaderCellViewInfo.GetItems
  : TdxSpreadSheetTableItems;
begin
  Result := View.Columns;
end;

function TdxSpreadSheetTableViewColumnHeaderCellViewInfo.GetRectEdges
  (const R: TRect): TPoint;
begin
  Result := cxPoint(R.Left, R.Right);
end;

function TdxSpreadSheetTableViewColumnHeaderCellViewInfo.GetResizeArea
  (const AResizeAreaSize: Integer): TRect;
begin
  if ViewInfo.IsRightToLeftLayout then
    Result := cxRectSetRight(Bounds, Bounds.Left + dxSpreadSheetResizeDelta,
      AResizeAreaSize)
  else
    Result := cxRectSetLeft(Bounds, Bounds.Right - dxSpreadSheetResizeDelta,
      AResizeAreaSize);
end;

function TdxSpreadSheetTableViewColumnHeaderCellViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
begin
  Result := inherited InitHitTest(AHitTest);
  if Result then
...
function TdxSpreadSheetTableViewHeaderCornerCellViewInfo.GetCursor
  (AHitTest: TdxSpreadSheetCustomHitTest): TCursor;
begin
  Result := crdxSpreadSheetCross;
end;

function TdxSpreadSheetTableViewHeaderCornerCellViewInfo.GetRectEdges
  (const R: TRect): TPoint;
begin
  Result := cxNullPoint;
end;
...
function TdxSpreadSheetTableViewRowHeaderCellViewInfo.GetCursor
  (AHitTest: TdxSpreadSheetCustomHitTest): TCursor;
begin
  if AHitTest.GetHitCode(hcResizeArea) then
    Result := crcxVertSize
  else if ViewInfo.IsRightToLeftLayout then
...
function TdxSpreadSheetTableViewRowHeaderCellViewInfo.GetItems
  : TdxSpreadSheetTableItems;
begin
  Result := View.Rows;
end;

function TdxSpreadSheetTableViewRowHeaderCellViewInfo.GetRectEdges
  (const R: TRect): TPoint;
begin
  Result := cxPoint(R.Top, R.Bottom);
end;

function TdxSpreadSheetTableViewRowHeaderCellViewInfo.GetResizeArea
  (const AResizeAreaSize: Integer): TRect;
begin
  Result := cxRectSetTop(Bounds, Bounds.Bottom - dxSpreadSheetResizeDelta,
    AResizeAreaSize);
end;

function TdxSpreadSheetTableViewRowHeaderCellViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
begin
  Result := inherited InitHitTest(AHitTest);
  if Result then
...
function TdxSpreadSheetTableViewCellDisplayStyle.CreateDataBar
  : TdxSpreadSheetCellDataBar;
begin
  Result := TdxSpreadSheetTableViewCellDataBar.Create;
end;

function TdxSpreadSheetTableViewCellDisplayStyle.GetDataBar
  : TdxSpreadSheetTableViewCellDataBar;
begin
...
constructor TdxSpreadSheetTableViewCustomDataCellViewInfo.Create
  (AOwner: TObject);
begin
  inherited Create(AOwner);
  FSupportedDrawingStages := [dsSecond];
...
procedure TdxSpreadSheetTableViewCustomDataCellViewInfo.Draw(ACanvas: TcxCanvas;
AStage: TdxSpreadSheetDrawingStage);
begin
...
procedure TdxSpreadSheetTableViewCustomDataCellViewInfo.Offset(X: Integer;
Y: Integer);
begin
  inherited;
...
procedure TdxSpreadSheetTableViewCustomDataCellViewInfo.
  CalculateDisplayTextParameters(const R: TRect; ACell: TdxSpreadSheetCell);
var
...
begin
  ...
  begin
    ...
    begin
      if (ADisplayValue.ShrinkToFitCacheFontSize <> AFont.Size) or
        (R.Width < ADisplayValue.ShrinkToFitCacheContentWidth) then
      begin
  ...
  FTextBounds := R;
  APrevPixelsPerInch := dxSpreadSheetPrepareCanvas(cxScreenCanvas, AFont,
    dxDefaultDPI);
  try
    ...
    begin
      ...
      dxSpreadSheetTextService.CalculateTextBounds(cxScreenCanvas, Self,
        FTextBounds);
  ...
  case AlignHorz of
    ...
    taCenterX:
      FTextBounds := cxRectSetLeft(FTextBounds,
        cxRectCenter(R).X - FTextBounds.Width div 2, FTextBounds.Width);
  else
  ...
  begin
    ...
    FTextBounds := cxRectSetTop(FTextBounds, ATopPos,
      cxRectHeight(FTextBounds));
  end;
...
function TdxSpreadSheetTableViewCustomDataCellViewInfo.CreateStyleViewInfo
  : TdxSpreadSheetConditionalFormattingStyleViewInfo;
begin
  Result := TdxSpreadSheetConditionalFormattingStyleViewInfo.Create(Style,
    dxDefaultScaleFactor);
end;
...
begin
  ...
  FBackgroundColor := dxSpreadSheetGetColorDefault(ABrush.BackgroundColor,
    ViewInfo.ContentParams.Color);
  FForegroundColor := dxSpreadSheetGetColorDefault(ABrush.ForegroundColor,
    ViewInfo.ContentParams.TextColor);
  inherited DoCalculate;
end;

procedure TdxSpreadSheetTableViewCustomDataCellViewInfo.DoDraw
  (ACanvas: TcxCanvas);
begin
...
procedure TdxSpreadSheetTableViewCustomDataCellViewInfo.DrawValue
  (ACanvas: TcxCanvas);
var
  AClipRect: TRect;
  AHasStyle: Boolean;
...
function TdxSpreadSheetTableViewCustomDataCellViewInfo.GetTextOutFormat
  : Integer;
begin
...
procedure TdxSpreadSheetTableViewCustomDataCellViewInfo.InitDrawValueCore
  (ACell: TdxSpreadSheetCell);
const
  GeneralAlignToTextAlign: array [TdxSpreadSheetCellDataType] of TcxTextAlignX =
    (taLeft, taCenterX, taCenterX, taRight, taRight, taRight, taRight,
    taLeft, taLeft);
...
begin
  ...
  if ACell = nil then
  begin
    FTextColor := cxGetActualColor(AFont.Color,
      ViewInfo.ContentParams.TextColor);
  ...
  begin
    ...
    FTextColor := cxGetActualColor(FTextColor,
      ViewInfo.ContentParams.TextColor);
    ...
    else if Style.AlignHorz = ssahFill then
    begin
      FAlignVert := taBottom;
      FMultiline := False;
    end;
...
procedure TdxSpreadSheetTableViewCustomDataCellViewInfo.InitStyle
...
begin
  ...
  begin
    FStyle := TdxSpreadSheetTableViewCellDisplayStyle.Create(View,
      AStyleHandle);
    FStyleViewInfo := CreateStyleViewInfo;
  end;
end;

procedure TdxSpreadSheetTableViewCustomDataCellViewInfo.PrepareCanvasFont
  (ACanvas: TcxCanvas);
var
  AFont: TFont;
begin
...
procedure TdxSpreadSheetTableViewCustomDataCellViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited;

  FAlignHorz := TdxRightToLeftLayoutConverter.ConvertcxTextAlignX(FAlignHorz);
  FContentBounds := TdxRightToLeftLayoutConverter.ConvertRect(FContentBounds,
    AClientBounds);
  FTextBounds := TdxRightToLeftLayoutConverter.ConvertRect(FTextBounds,
    AClientBounds);
...
function TdxSpreadSheetTableViewCellViewInfo.GetCursor
  (AHitTest: TdxSpreadSheetCustomHitTest): TCursor;
begin
  case View.Controller.ForcedSelectionMode of
    ...
    if AHitTest.GetHitCode(hcHyperlink) and View.Controller.CanExecuteHyperlink
    then
      Result := crHandPoint
    else
      Result := inherited;
...
procedure TdxSpreadSheetTableViewCellViewInfo.SetBounds(const AAbsoluteBounds,
  AScreenClipRect: TRect);
begin
  inherited SetBounds(AAbsoluteBounds, AScreenClipRect);
  Calculate;
end;

function TdxSpreadSheetTableViewCellViewInfo.GetDragAndDropObjectClass
  (AHitTest: TdxSpreadSheetCustomHitTest): TcxDragAndDropObjectClass;
begin
...
function TdxSpreadSheetTableViewCellViewInfo.HasBorder
  (ASide: TcxBorder): Boolean;
begin
  Result := FBorderStyle[ASide] <> sscbsNone;
end;

procedure TdxSpreadSheetTableViewCellViewInfo.MergeBorder(ASide: TcxBorder;
ANeighborStyle: TdxSpreadSheetCellStyleHandle);
var
  ABorderColor: TColor;
...
begin
  ...
  begin
    dxSpreadSheetMergeBorderStyle(ASide, Style.Handle, ANeighborStyle,
...
procedure TdxSpreadSheetTableViewCellViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited;
  FCellBounds := TdxRightToLeftLayoutConverter.ConvertRect(FCellBounds,
    AClientBounds);
end;

procedure TdxSpreadSheetTableViewCellViewInfo.SetBorderStyle(ASide: TcxBorder;
AStyle: TdxSpreadSheetCellBorderStyle; AColor: TColor);
begin
...
procedure TdxSpreadSheetTableViewCellViewInfo.InitDrawValueCore
  (ACell: TdxSpreadSheetCell);
begin
  if ACell <> nil then
    View.Containers.FindCommentContainerCore(ACell.RowIndex, ACell.ColumnIndex,
      FComment);
  inherited;
end;

function TdxSpreadSheetTableViewCellViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
begin
  Result := inherited InitHitTest(AHitTest);
  AHitTest.SetHitCode(hcCell, Result);
  if Result then
    AHitTest.SetHitCode(hcHyperlink, View.Hyperlinks.FindItem(Row,
      Column) <> nil);
end;
...
function TdxSpreadSheetTableViewCellViewInfo.IsInternalBorder
  (ASide: TcxBorder): Boolean;
begin
  Result := IsMerged;
  if Result then
...
begin
  ...
  begin
    FSupportedDrawingStages := FSupportedDrawingStages +
      StyleViewInfo.SupportedDrawingStages;
...
begin
  ...
  begin
    ...
    AConditionalFormatting.CalculateStyle(Style, APosition.Y, APosition.X,
      ActualCell);
  end;
end;

procedure TdxSpreadSheetTableViewCellViewInfo.CalculateDisplayTextParameters
  (const R: TRect; ACell: TdxSpreadSheetCell);
begin
  if IsMerged then
    FTextBounds := cxRectSetWidth(R, 0)
  else
...
begin
  Result := cxRectContent(R, TdxSpreadSheetCell.GetContentOffsets
    (FBorderStyle[bBottom]));
end;
...
function TdxSpreadSheetTableViewCellViewInfo.DoCustomDraw
  (ACanvas: TcxCanvas): Boolean;
begin
...
procedure TdxSpreadSheetTableViewCellViewInfo.DrawBackground
  (ACanvas: TcxCanvas);
begin
  dxSpreadSheetDrawBackground(ACanvas, Bounds, BackgroundColor, ForegroundColor,
    Style.Brush.Style);
  if Comment <> nil then
...
begin
  ...
  try
    for ASide := Low(TcxBorder) to High(TcxBorder) do
    begin
      if HasBorder(ASide) and
        ((DrawingStage = dsFirst) = (BorderStyle[ASide] = sscbsDefault)) then
        dxSpreadSheetDrawBorder(ACanvas, ABounds, BorderColor[ASide],
          BackgroundColor, ASide, FBorderStyle);
    end;
  finally
...
procedure TdxSpreadSheetTableViewCellViewInfo.DrawCommentMark
  (ACanvas: TcxCanvas);
const
  Size = 4;
var
...
function TdxSpreadSheetTableViewCellViewInfo.GetBorderColor
  (ASide: TcxBorder): TColor;
begin
  Result := FBorderColor[ASide];
end;

function TdxSpreadSheetTableViewCellViewInfo.GetBorderStyle(ASide: TcxBorder)
...
function TdxSpreadSheetTableViewFrozenPaneSeparatorCellViewInfo.DoCustomDraw
  (ACanvas: TcxCanvas): Boolean;
begin
...
procedure TdxSpreadSheetTableViewFrozenPaneSeparatorCellViewInfo.DoDraw
  (ACanvas: TcxCanvas);
var
  APrevForm: TXForm;
  ARect: TRect;
...
function TdxSpreadSheetTableViewFrozenPaneSeparatorCellViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
begin
  Result := inherited InitHitTest(AHitTest);
...
function TdxSpreadSheetPageControlHitTest.GetPageControl
  : TdxSpreadSheetPageControl;
begin
...
function TdxSpreadSheetPageControlController.GetHitTest
  : TdxSpreadSheetCustomHitTest;
begin
  Result := PageControl.HitTest;
end;

procedure TdxSpreadSheetPageControlController.DoMouseDown(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
begin
  inherited DoMouseDown(Button, Shift, X, Y);
  if HitTest.HitAtPageTab then
    DoMouseClickAtTab(Button, X, Y, TdxSpreadSheetPageControlTabCellViewInfo
      (HitTest.HitObject));
  if HitTest.HitAtButton then
    DoMouseClickAtButton(Button, X, Y,
      TdxSpreadSheetPageControlButtonCellViewInfo(HitTest.HitObject));
end;
...
procedure TdxSpreadSheetPageControlController.DoMouseClickAtButton
  (AButton: TMouseButton; X, Y: Integer;
AButtonViewInfo: TdxSpreadSheetPageControlButtonCellViewInfo);
begin
  ...
  case AButtonViewInfo.ButtonType of
    ...
    sspcbPrev:
      PageControl.FirstVisiblePageIndex :=
        PageControl.FirstVisiblePageIndex - 1;
    sspcbNext:
      PageControl.FirstVisiblePageIndex :=
        PageControl.FirstVisiblePageIndex + 1;
    sspcbLast:
...
procedure TdxSpreadSheetPageControlController.DoMouseClickAtTab
  (AButton: TMouseButton; X, Y: Integer;
ATabViewInfo: TdxSpreadSheetPageControlTabCellViewInfo);
var
...
begin
  ...
  if (AActiveSheet <> nil) and
    (AActiveSheet.IsRightToLeftLayout <> ATargetSheet.IsRightToLeftLayout) then
  begin
    ACursorOffset := cxPointOffset(Mouse.CursorPos,
      SpreadSheet.ClientToScreen(ATabViewInfo.Bounds.TopLeft), False);
    ATargetSheet.Active := True;
    if PageControl.ViewInfo.FindTabViewInfo(ATargetSheet, ATabViewInfo) then
    begin
      ACursorOffset := cxPointOffset(ACursorOffset,
        SpreadSheet.ClientToScreen(ATabViewInfo.Bounds.TopLeft));
...
function TdxSpreadSheetPageControlController.GetPageControlHitTest
  : TdxSpreadSheetPageControlHitTest;
begin
  Result := TdxSpreadSheetPageControlHitTest(inherited HitTest);
end;

function TdxSpreadSheetPageControlController.GetSpreadSheet
  : TdxCustomSpreadSheet;
begin
  Result := PageControl.SpreadSheet;
end;

function TdxSpreadSheetPageControlController.GetPageControl
  : TdxSpreadSheetPageControl;
begin
  Result := TdxSpreadSheetPageControl(Owner);
end;

procedure TdxSpreadSheetPageControlController.SetPressedObject
  (AValue: TdxSpreadSheetCellViewInfo);
begin
...
constructor TdxSpreadSheetPageControlBackgroundCellViewInfo.Create
  (AOwner: TObject);
begin
  inherited Create(AOwner);
  State := cxbsNormal;
...
function TdxSpreadSheetPageControlBackgroundCellViewInfo.DoCustomDraw
  (ACanvas: TcxCanvas): Boolean;
begin
  Result := False;
...
procedure TdxSpreadSheetPageControlBackgroundCellViewInfo.DoDraw
  (ACanvas: TcxCanvas);
begin
  LookAndFeelPainter.DrawScaledScrollBarBackground(ACanvas, Bounds, True,
    ScaleFactor);
end;
...
function TdxSpreadSheetPageControlBackgroundCellViewInfo.GetSpreadSheet
  : TdxCustomSpreadSheet;
begin
  Result := PageControl.SpreadSheet;
end;

function TdxSpreadSheetPageControlBackgroundCellViewInfo.GetState
  : TcxButtonState;
begin
  Result := FState;
end;

function TdxSpreadSheetPageControlBackgroundCellViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
begin
  Result := inherited InitHitTest(AHitTest);
...
begin
  if (PageControl.Controller.PressedObject = Self) and
    (PageControl.HitTest.HitObject = Self) then
    State := cxbsPressed
  else if (PageControl.Controller.PressedObject = nil) and
    (PageControl.HitTest.HitObject = Self) then
    State := cxbsHot
  else
    State := cxbsNormal;
...
function TdxSpreadSheetPageControlBackgroundCellViewInfo.GetPageControl
  : TdxSpreadSheetPageControl;
begin
  Result := TdxSpreadSheetPageControlViewInfo(Owner).PageControl;
end;

procedure TdxSpreadSheetPageControlBackgroundCellViewInfo.SetState
  (AValue: TcxButtonState);
begin
...
procedure TdxSpreadSheetPageControlButtonCellViewInfo.DoDraw
  (ACanvas: TcxCanvas);
const
  GlyphIndexMap: array [TdxSpreadSheetPageControlButton] of Integer = (0,
    2, 3, 5, 7);
var
  AGlyphRect: TRect;
begin
  LookAndFeelPainter.DrawNavigatorScaledButton(ACanvas, Bounds, State,
    ViewParams.Color, ScaleFactor);
  LookAndFeelPainter.DrawNavigatorBorder(ACanvas, Bounds, False);

  ACanvas.SaveState;
  try
    AGlyphRect := cxRectCenter(Bounds,
      LookAndFeelPainter.NavigatorScaledButtonGlyphSize(ScaleFactor));
    if State = cxbsPressed then
      AGlyphRect := cxRectOffset(AGlyphRect,
        LookAndFeelPainter.NavigatorButtonPressedGlyphOffset);

    cxRightToLeftDependentDraw(ACanvas, Bounds, procedure
      begin
        LookAndFeelPainter.DrawNavigatorScaledButtonGlyph(ACanvas,
          NavigatorImages, GlyphIndexMap[ButtonType], AGlyphRect,
          State <> cxbsDisabled, False, ScaleFactor);
      end);
  finally
...
procedure TdxSpreadSheetPageControlButtonCellViewInfo.Initialize(const ABounds,
  AClipRect: TRect; AType: TdxSpreadSheetPageControlButton);
begin
...
begin
  ...
  case ButtonType of
    ...
    sspcbNext, sspcbLast:
      if PageControl.ViewInfo.LastVisiblePageIndex >=
        PageControl.VisiblePageCount - 1 then
        State := cxbsDisabled;
  end;
end;
...
constructor TdxSpreadSheetPageControlTabDragAndDropObject.Create
  (AControl: TcxControl);
begin
  inherited Create(AControl);
...
procedure TdxSpreadSheetPageControlTabDragAndDropObject.DragAndDrop
  (const P: TPoint; var Accepted: Boolean);
const
...
begin
  ...
  if PtInRect(LeftScrollArea, P) then
    InitScrollTimer(-1)
  else if PtInRect(RightScrollArea, P) then
    InitScrollTimer(1)
  else
    ScrollTimer.Enabled := False;
  ...
  begin
    ...
    DropIndex := HitTestView.Index +
      Byte((ASide <> bRight) = PageControl.IsRightToLeftLayout);
...
procedure TdxSpreadSheetPageControlTabDragAndDropObject.EndDragAndDrop
  (Accepted: Boolean);
var
  APrevIndex: Integer;
begin
...
function TdxSpreadSheetPageControlTabDragAndDropObject.GetDragAndDropCursor
  (Accepted: Boolean): TCursor;
const
...
procedure TdxSpreadSheetPageControlTabDragAndDropObject.InitScrollTimer
  (ADelta: Integer);
begin
...
procedure TdxSpreadSheetPageControlTabDragAndDropObject.ScrollTimerHandler
  (ASender: TObject);
var
  AAccepted: Boolean;
begin
  PageControl.FirstVisiblePageIndex := PageControl.FirstVisiblePageIndex +
    ScrollDelta;
  DragAndDrop(CurMousePos, AAccepted);
end;
...
function TdxSpreadSheetPageControlTabDragAndDropObject.GetHitTest
  : TdxSpreadSheetPageControlHitTest;
begin
  Result := PageControl.HitTest;
end;

function TdxSpreadSheetPageControlTabDragAndDropObject.GetHitTestView
  : TdxSpreadSheetCustomView;
begin
  if HitTest.HitAtPageTab then
...
function TdxSpreadSheetPageControlTabDragAndDropObject.GetPageControl
  : TdxSpreadSheetPageControl;
begin
  Result := TdxCustomSpreadSheet(Control).PageControl;
end;

function TdxSpreadSheetPageControlTabDragAndDropObject.
  GetRightScrollArea: TRect;
begin
  Result := PageControl.ViewInfo.RightScrollArea;
end;

function TdxSpreadSheetPageControlTabDragAndDropObject.GetSpreadSheet
  : TdxCustomSpreadSheet;
begin
  Result := PageControl.SpreadSheet;
end;
...
begin
  ...
  begin
    ...
    cxTextOut(ACanvas.Handle, View.Caption, ATextRect, FTextFlags, nil, 0, 0, 0,
      ColorToRGB(ViewParams.TextColor));
  end;
end;

procedure TdxSpreadSheetPageControlTabCellViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited;
...
function TdxSpreadSheetPageControlTabCellViewInfo.GetPopupMenuClass
  (AHitTest: TdxSpreadSheetCustomHitTest): TComponentClass;
begin
...
begin
  ...
  if View = SpreadSheet.ActiveSheet then
    Result := cxbsPressed
  else if (Result = cxbsHot) and (SpreadSheet.DragAndDropState <> ddsNone) then
    Result := cxbsNormal;
end;

procedure TdxSpreadSheetPageControlTabCellViewInfo.Initialize(const ABounds,
  AClipRect: TRect; AView: TdxSpreadSheetCustomView);
begin
  FView := AView;
  FTextFlags := cxMakeFormat(taLeft, taBottom);
  SetBounds(cxRectSetWidth(ABounds, GetMeasureTextSize(View.Active,
    ViewParams.Font, View.Caption).cx), AClipRect);
  UpdateState;
end;
...
begin
  ...
  Result := cxScreenCanvas.TextExtent(AText);
  cxScreenCanvas.Dormant;

  ATextMargins := GetTextMargins;
  Inc(Result.cx, cxMarginsWidth(ATextMargins));
  Inc(Result.cy, cxMarginsHeight(ATextMargins));
end;
...
function TdxSpreadSheetPageControlSplitterCellViewInfo.GetCursor
  (AHitTest: TdxSpreadSheetCustomHitTest): TCursor;
begin
...
procedure TdxSpreadSheetPageControlSplitterCellViewInfo.DoDraw
  (ACanvas: TcxCanvas);
begin
  LookAndFeelPainter.DrawScaledScrollBarSplitter(ACanvas, Bounds, State,
    ScaleFactor);
...
begin
  ...
  if SpreadSheet.DragAndDropState = ddsInProcess then
  begin
    if SpreadSheet.DragAndDropObject is TdxSpreadSheetPageControlSplitterDragAndDropObject
    then
      Result := cxbsHot;
  end;
end;
...
procedure TdxSpreadSheetPageControlSplitterDragAndDropObject.DragAndDrop
  (const P: TPoint; var Accepted: Boolean);
var
  ADelta: Integer;
begin
...
procedure TdxSpreadSheetPageControlSplitterDragAndDropObject.EndDragAndDrop
  (Accepted: Boolean);
begin
  PageControl.Invalidate;
end;

function TdxSpreadSheetPageControlSplitterDragAndDropObject.
  GetImmediateStart: Boolean;
begin
  Result := True;
end;

function TdxSpreadSheetPageControlSplitterDragAndDropObject.GetPageControl
  : TdxSpreadSheetPageControl;
begin
  Result := TdxCustomSpreadSheet(Control).PageControl;
end;
...
constructor TdxSpreadSheetPageControlViewInfo.Create
  (AOwner: TdxSpreadSheetPageControl);
begin
  FPageControl := AOwner;
  FPages := TList.Create;
  FCells := TdxSpreadSheetCellViewInfoList.Create;
...
begin
  ...
  AClientBounds := cxRect(AClientBounds.Left, AClientBounds.Bottom,
    AClientBounds.Right, AClientBounds.Bottom + MeasureHeight);
...
procedure TdxSpreadSheetPageControlViewInfo.InitHitTest
  (AHitTest: TdxSpreadSheetCustomHitTest);
begin
  if PtInRect(Bounds, AHitTest.ActualHitPoint) then
    Cells.CalculateHitTest(AHitTest);
...
begin
  ...
  begin
    InitializeViewParams;
    Result := Max(Result, LookAndFeelPainter.NavigatorScaledButtonMinSize
      (ScaleFactor).cy);
    Result := Max(Result, TdxSpreadSheetPageControlTabCellViewInfo.
      GetMeasureTextSize(True, ViewParams.Font, dxMeasurePattern).cy);
    cxScreenCanvas.Dormant;
  end;
end;
...
begin
  ...
  begin
    if PageControl.Width <> 0 then
      Result := Min(PageControl.Width,
        Result - LookAndFeelPainter.ScaledSizeGripSize(ScaleFactor).cx * 4)
    else
      Result := MulDiv(Result, 2, 3);
  end;
end;
...
begin
  ...
  begin
    ...
    ASplitter.SetBounds(cxRectSetRight(Bounds, Bounds.Right,
      ASplitter.MeasureWidth), Bounds);
    Cells.Add(ASplitter);
  ...
  if PageControl.FirstVisiblePageIndex > 0 then
    FLeftScrollArea := cxRectSetXPos(R, Bounds.Left,
      R.Right + dxSpreadSheetResizeDelta * 3);
  ...
  if FLastVisiblePageIndex < PageCount - 1 then
    FRightScrollArea := cxRectSetXPos(R, FClipRect.Right -
      dxSpreadSheetResizeDelta * 3, SpreadSheet.ClientBounds.Right)
  else
...
procedure TdxSpreadSheetPageControlViewInfo.AddButton(var R: TRect;
AType: TdxSpreadSheetPageControlButton);
var
...
procedure TdxSpreadSheetPageControlViewInfo.AddPageTab(var R: TRect;
APage: TdxSpreadSheetCustomView);
var
...
function TdxSpreadSheetPageControlViewInfo.CreateSplitterCellViewInfo
  : TdxSpreadSheetPageControlSplitterCellViewInfo;
begin
  Result := TdxSpreadSheetPageControlSplitterCellViewInfo.Create(Self);
end;

function TdxSpreadSheetPageControlViewInfo.CreateTabCellViewInfo
  : TdxSpreadSheetPageControlTabCellViewInfo;
begin
...
procedure TdxSpreadSheetPageControlViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
  FBounds := TdxRightToLeftLayoutConverter.ConvertRect(FBounds, AClientBounds);
  FClipRect := TdxRightToLeftLayoutConverter.ConvertRect(FClipRect,
    AClientBounds);
  FLeftScrollArea := TdxRightToLeftLayoutConverter.ConvertRect(FLeftScrollArea,
    AClientBounds);
  FRightScrollArea := TdxRightToLeftLayoutConverter.ConvertRect
    (FRightScrollArea, AClientBounds);
  Cells.RightToLeftConversion(AClientBounds);
end;
...
function TdxSpreadSheetPageControlViewInfo.GetLookAndFeelPainter
  : TcxCustomLookAndFeelPainter;
begin
  Result := SpreadSheet.LookAndFeelPainter;
end;

function TdxSpreadSheetPageControlViewInfo.GetPage(Index: Integer)
  : TdxSpreadSheetCustomView;
begin
...
constructor TdxSpreadSheetPageControl.Create(ASpreadSheet
  : TdxCustomSpreadSheet);
begin
  inherited Create(ASpreadSheet);
  CreateSubClasses;
...
begin
  ...
  begin
    ...
    FirstVisiblePageIndex := TdxSpreadSheetPageControl(Source)
...
procedure TdxSpreadSheetPageControl.MakeVisible
  (APage: TdxSpreadSheetCustomView);
var
  AIndex: Integer;
begin
...
function TdxSpreadSheetPageControl.CreateController
  : TdxSpreadSheetPageControlController;
begin
  Result := TdxSpreadSheetPageControlController.Create(Self);
end;

function TdxSpreadSheetPageControl.CreateHitTest
  : TdxSpreadSheetPageControlHitTest;
begin
  Result := TdxSpreadSheetPageControlHitTest.Create(Self);
end;

function TdxSpreadSheetPageControl.CreateViewInfo
  : TdxSpreadSheetPageControlViewInfo;
begin
...
begin
  if Visible then
    SpreadSheet.InvalidateRect(cxRectSetWidth(ViewInfo.Bounds,
      SpreadSheet.Width), False);
end;
...
function TdxSpreadSheetPageControl.GetVisiblePage(AIndex: Integer)
  : TdxSpreadSheetCustomView;
begin
...
procedure TdxSpreadSheetPageControl.SetButtons
  (AValue: TdxSpreadSheetPageControlButtons);
begin
...
function TdxSpreadSheetViewInfo.GetLookAndFeelPainter
  : TcxCustomLookAndFeelPainter;
begin
  Result := SpreadSheet.LookAndFeelPainter;
end;
...
procedure TdxSpreadSheetStyles.GetDefaultViewParams(Index: Integer;
  ...
  case Index of
    ...
    s_Background:
      begin
        ...
        AParams.TextColor := SpreadSheet.LookAndFeelPainter.
    ...
    s_PageControl:
      begin
        ...
        AParams.TextColor := SpreadSheet.LookAndFeelPainter.
          NavigatorButtonTextColor(cxbsNormal);
      end;
  end;
end;
...
function TdxSpreadSheetStyles.GetContentStyle(AView: TdxSpreadSheetCustomView)
  : TcxViewParams;
begin
  GetViewParams(s_Content, AView, nil, Result);
end;

function TdxSpreadSheetStyles.GetHeaderStyle(AView: TdxSpreadSheetCustomView)
  : TcxViewParams;
begin
...
constructor TdxSpreadSheetOptionsMetadata.Create(ASpreadSheet
  : TdxCustomSpreadSheet);
begin
  inherited Create(nil);
  FSpreadSheet := ASpreadSheet;
...
function TdxSpreadSheetOptionsMetadata.GetDateTime(const Index: Integer)
  : TDateTime;
begin
...
procedure TdxSpreadSheetOptionsMetadata.SetDateTime(const Index: Integer;
...
procedure TdxSpreadSheetOptionsMetadata.SetString(const Index: Integer;
const Value: string);
begin
...
constructor TdxSpreadSheetOptionsBehavior.Create(ASpreadSheet
  : TdxCustomSpreadSheet);
begin
  inherited Create(ASpreadSheet);
...
begin
  ...
  begin
    AutomaticCalculation := TdxSpreadSheetOptionsBehavior(Source)
    ...
    FormulaAutoComplete := TdxSpreadSheetOptionsBehavior(Source)
      .FormulaAutoComplete;
    EnterKeyNavigation := TdxSpreadSheetOptionsBehavior(Source)
      .EnterKeyNavigation;
    Formatting := TdxSpreadSheetOptionsBehavior(Source).Formatting;
    FormulaAutoComplete := TdxSpreadSheetOptionsBehavior(Source)
      .FormulaAutoComplete;
    FormulaAutoCompleteShowHint := TdxSpreadSheetOptionsBehavior(Source)
      .FormulaAutoCompleteShowHint;
    History := TdxSpreadSheetOptionsBehavior(Source).History;
    HistoryMaxActionCount := TdxSpreadSheetOptionsBehavior(Source)
      .HistoryMaxActionCount;
    Inserting := TdxSpreadSheetOptionsBehavior(Source).Inserting;
    IterativeCalculation := TdxSpreadSheetOptionsBehavior(Source)
      .IterativeCalculation;
    IterativeCalculationMaxCount := TdxSpreadSheetOptionsBehavior(Source)
      .IterativeCalculationMaxCount;
  end;
end;
...
procedure TdxSpreadSheetOptionsBehavior.SetHistoryMaxActionCount
  (AValue: Integer);
begin
  SpreadSheet.History.MaxActionCount := AValue;
end;

procedure TdxSpreadSheetOptionsBehavior.SetIterativeCalculationMaxCount
  (AValue: Integer);
begin
...
constructor TdxSpreadSheetOptionsView.Create(ASpreadSheet
  : TdxCustomSpreadSheet);
begin
  inherited Create(ASpreadSheet);
  FAntialiasing := True;
...
begin
  ...
  begin
    ...
    FFrozenPaneSeparatorColor := TdxSpreadSheetOptionsView(Source)
      .FrozenPaneSeparatorColor;
    FFrozenPaneSeparatorWidth := TdxSpreadSheetOptionsView(Source)
      .FrozenPaneSeparatorWidth;
    ...
    FHorizontalScrollBar := TdxSpreadSheetOptionsView(Source)
...
function TdxSpreadSheetOptionsView.GetActualDateTimeSystem
...
procedure TdxSpreadSheetOptionsView.SetDateTimeSystem
  (AValue: TdxSpreadSheetDateTimeSystem);
begin
...
procedure TdxSpreadSheetOptionsView.SetFrozenPaneSeparatorWidth
  (AValue: Integer);
begin
...
class function TdxSpreadSheetHistoryCustomCommand.ActionClass
  : TdxSpreadSheetHistoryActionClass;
begin
  Result := TdxSpreadSheetHistoryAction;
end;

function TdxSpreadSheetHistoryCustomCommand.CompatibleWith
  (ACommand: TdxSpreadSheetHistoryCustomCommand): Boolean;
begin
  Result := False;
end;
...
function TdxSpreadSheetHistoryAction.AcceptCommand
  (ACommand: TdxSpreadSheetHistoryCustomCommand): Boolean;
begin
  Result := True;
end;

procedure TdxSpreadSheetHistoryAction.AddCommand
...
begin
  ...
  try
    ...
    try
      ...
      AView.MakeVisible(AView.Selection.FocusedRow,
        AView.Selection.FocusedColumn);
    finally
      AReader.Free;
    end;
  finally
...
function TdxSpreadSheetHistoryAction.GetCommand(AIndex: Integer)
  : TdxSpreadSheetHistoryCustomCommand;
begin
...
function TdxSpreadSheetHistoryInsertCellsAction.AcceptCommand
  (ACommand: TdxSpreadSheetHistoryCustomCommand): Boolean;
begin
...
class function TdxSpreadSheetHistoryPasteFromClipboardAction.
...
class function TdxSpreadSheetHistoryChangeRowColumnItemAction.
  GetDescription: string;
begin
...
class function TdxSpreadSheetHistoryChangeContainerAction.
  GetDescription: string;
begin
...
class function TdxSpreadSheetHistoryChangeConditionalFormattingAction.
  GetDescription: string;
begin
...
class function TdxSpreadSheetHistoryChangePrintingOptionsAction.
  GetDescription: string;
begin
...
class function TdxSpreadSheetHistoryCreateDefinedNameAction.
  GetDescription: string;
begin
...
class function TdxSpreadSheetHistoryChangeDefinedNameAction.
  GetDescription: string;
begin
...
class function TdxSpreadSheetHistoryDeleteDefinedNameAction.
  GetDescription: string;
begin
...
procedure TdxSpreadSheetHistory.AddCommand
  (ACommand: TdxSpreadSheetHistoryCustomCommand);
begin
  if not CanAddCommand or ((FCurrentAction <> nil) and
    not FCurrentAction.AcceptCommand(ACommand)) then
  begin
    ACommand.Free;
    Exit;
  end;
  ...
  begin
    ...
    begin
      ...
      if (FCurrentAction.Count = 0) or not FCurrentAction.Commands[0]
        .CompatibleWith(ACommand) then
        FCurrentAction := nil;
    end;
    FRedoActions.Clear;
...
procedure TdxSpreadSheetHistory.BeginAction(AActionClass
  : TdxSpreadSheetHistoryActionClass);
begin
...
begin
  if (ARedoCount <= 0) or (RedoActionCount = 0) then
    Exit;
  if (SpreadSheet.ActiveSheet <> nil) and
    SpreadSheet.ActiveSheet.Controller.Redo(ARedoCount) then
    Exit;
  FCurrentAction := nil;
  Inc(FLockCount);
  InProcess := True;
...
begin
  if (AUndoCount <= 0) or (UndoActionCount = 0) then
    Exit;
  if (SpreadSheet.ActiveSheet <> nil) and
    SpreadSheet.ActiveSheet.Controller.Undo(AUndoCount) then
    Exit;
...
begin
  Result := (FLockCount > 0) or SpreadSheet.IsDestroying or
    SpreadSheet.IsLoading or not SpreadSheet.OptionsBehavior.History;
end;

function TdxSpreadSheetHistory.GetRedoAction(AIndex: Integer)
  : TdxSpreadSheetHistoryAction;
begin
...
function TdxSpreadSheetHistory.GetUndoAction(AIndex: Integer)
  : TdxSpreadSheetHistoryAction;
begin
...
function TdxSpreadSheetLockedStatePaintHelper.GetOptions
  : TcxLockedStateImageOptions;
begin
  Result := SpreadSheet.OptionsLockedStateImage;
end;

function TdxSpreadSheetLockedStatePaintHelper.GetSpreadSheet
  : TdxCustomSpreadSheet;
begin
...
constructor TdxSpreadSheetChangeAggregator.Create(AChangeHandler: TProc;
...
function TdxCustomSpreadSheet.DoCreateSheet(var ASheet
  : TdxSpreadSheetCustomView; const ACaption: string = '';
AViewClass: TdxSpreadSheetCustomViewClass = nil): Boolean;
begin
...
function TdxCustomSpreadSheet.InsertSheet(AIndex: Integer = -1;
const ACaption: string = ''; AViewClass: TdxSpreadSheetCustomViewClass = nil)
  : TdxSpreadSheetCustomView;
begin
...
function TdxCustomSpreadSheet.EvaluateExpression(const AExpression: string;
AView: TdxSpreadSheetTableView = nil): Variant;
var
...
function TdxCustomSpreadSheet.GetSheetByName(const ACaption: string)
  : TdxSpreadSheetCustomView;
var
  I: Integer;
begin
  ...
  begin
    if (Result = nil) and (dxSpreadSheetCompareText(ACaption,
      Sheets[I].Caption) = 0) then
      Result := Sheets[I];
  end;
end;
...
procedure TdxCustomSpreadSheet.BeginUpdate
  (AMode: TcxLockedStateImageShowingMode = lsimNever);
begin
...
begin
  ...
  try
    ...
    if dxSpreadSheetFormatsRepository.Find(AFileName, AFormat) and
      (not AFormat.CanCheckByContent or AFormat.CanReadFromStream(AStream)) then
...
begin
  ...
  raise EdxSpreadSheetFormatError.Create
    (cxGetResourceString(@sdxErrorUnsupportedDocumentFormat));
end;
...
procedure TdxCustomSpreadSheet.SaveToStream(AStream: TStream;
AFormat: TdxSpreadSheetCustomFormatClass = nil);
begin
...
procedure TdxCustomSpreadSheet.RemoveListener
  (AListener: IdxSpreadSheetListener);
begin
...
procedure TdxCustomSpreadSheet.ChangeScaleEx(M, D: Integer;
isDpiChange: Boolean);
begin
  inherited;
...
begin
  ...
  try
    ...
    while Changes <> [] do
    begin
      AShouldNotifyListeners := AShouldNotifyListeners or
        ([sscData, sscStyle] * Changes <> []);
...
procedure TdxCustomSpreadSheet.CheckDestroyedView
  (AView: TdxSpreadSheetCustomView);
begin
...
function TdxCustomSpreadSheet.ControllerFromPoint(const P: TPoint;
var AController: TdxSpreadSheetCustomController): Boolean;
begin
  ...
  begin
    ...
    else if PtInRect(PageControl.Bounds, P) then
      AController := PageControl.Controller;
  end;
  Result := AController <> nil;
end;

function TdxCustomSpreadSheet.ControllerFromPoint(X, Y: Integer;
var AController: TdxSpreadSheetCustomController): Boolean;
begin
...
function TdxCustomSpreadSheet.CreateDefaultCellStyle
  : TdxSpreadSheetDefaultCellStyle;
begin
...
function TdxCustomSpreadSheet.CreateFormatSettings
  : TdxSpreadSheetFormatSettings;
begin
  Result := TdxSpreadSheetControlFormatSettings.Create(Self);
end;

function TdxCustomSpreadSheet.CreateFormulaController
  : TdxSpreadSheetFormulaController;
begin
...
function TdxCustomSpreadSheet.CreateLockedStatePaintHelper
  : TdxSpreadSheetLockedStatePaintHelper;
begin
  Result := TdxSpreadSheetLockedStatePaintHelper.Create(Self);
end;

function TdxCustomSpreadSheet.CreateUpdateMetadataHelper
  : TdxSpreadSheetChangeAggregator;
begin
  Result := TdxSpreadSheetChangeAggregator.Create
    (OptionsMetadata.UpdateLastModificationData, 300);
end;

function TdxCustomSpreadSheet.CreateOptionsBehavior
  : TdxSpreadSheetOptionsBehavior;
begin
  Result := TdxSpreadSheetOptionsBehavior.Create(Self);
end;

function TdxCustomSpreadSheet.CreateOptionsLockedStateImage
  : TdxSpreadSheetLockedStateImageOptions;
begin
  Result := TdxSpreadSheetLockedStateImageOptions.Create(Self);
end;

function TdxCustomSpreadSheet.CreateOptionsMetadata
  : TdxSpreadSheetOptionsMetadata;
begin
  Result := TdxSpreadSheetOptionsMetadata.Create(Self);
end;

function TdxCustomSpreadSheet.CreateOptionsProtection
  : TdxSpreadSheetWorkbookProtectionOptions;
begin
  Result := TdxSpreadSheetWorkbookProtectionOptions.Create
    (DoOptionsProtectionChanged);
end;
...
function TdxCustomSpreadSheet.CreateFormattedSharedStringCache
  : TdxSpreadSheetFormattedSharedStringCache;
begin
  Result := TdxSpreadSheetFormattedSharedStringCache.Create;
end;

function TdxCustomSpreadSheet.CreateSharedStringTable
  : TdxSpreadSheetSharedStringTable;
begin
...
function TdxCustomSpreadSheet.DoActiveCellChanging
  (AView: TdxSpreadSheetTableView; const ANewActiveCell: TPoint): Boolean;
begin
  Result := True;
...
procedure TdxCustomSpreadSheet.DoCommentHide(AContainer
  : TdxSpreadSheetContainer);
begin
...
function TdxCustomSpreadSheet.DoCommentShow(AContainer
  : TdxSpreadSheetContainer): Boolean;
begin
  Result := False;
  if Assigned(OnCommentShow) then
    OnCommentShow(TdxSpreadSheetCommentContainer(AContainer).Cell,
      AContainer, Result);
end;

procedure TdxCustomSpreadSheet.DoContextPopup(MousePos: TPoint;
var Handled: Boolean);
begin
  ...
  begin
    if cxPointIsEqual(MousePos, cxInvalidPoint) or (ActiveController = nil) then
      Handled := (ActiveSheet <> nil) and ActiveSheet.Controller.ContextPopup
        (GetMouseCursorClientPos)
    else
      Handled := ActiveController.ContextPopup(MousePos);
  end;
end;

procedure TdxCustomSpreadSheet.DoCustomDrawTableViewCell
  (Sender: TdxSpreadSheetTableView; ACanvas: TcxCanvas;
AViewInfo: TdxSpreadSheetTableViewCellViewInfo; var AHandled: Boolean);
begin
  AHandled := False;
...
procedure TdxCustomSpreadSheet.DoCustomDrawTableViewCommonCell
  (Sender: TdxSpreadSheetTableView; ACanvas: TcxCanvas;
AViewInfo: TdxSpreadSheetTableViewCustomCellViewInfo; var AHandled: Boolean);
begin
  AHandled := False;
...
procedure TdxCustomSpreadSheet.DoCustomDrawTableViewHeaderCell
  (Sender: TdxSpreadSheetTableView; ACanvas: TcxCanvas;
AViewInfo: TdxSpreadSheetTableViewHeaderCellViewInfo; var AHandled: Boolean);
begin
  AHandled := False;
...
procedure TdxCustomSpreadSheet.DoEditValueChanged
  (AView: TdxSpreadSheetCustomView);
begin
...
function TdxCustomSpreadSheet.DoHyperlinkExecute
  (ALink: TdxSpreadSheetHyperlink): Boolean;
begin
  Result := False;
...
procedure TdxCustomSpreadSheet.DoInitEdit(AView: TdxSpreadSheetCustomView;
AEdit: TcxCustomEdit);
begin
...
procedure TdxCustomSpreadSheet.DoInitEditValue(AView: TdxSpreadSheetCustomView;
...
begin
  if Assigned(OnGetPassword) then
    ...
    Result := ShowPasswordDialog(Self,
      TdxSpreadSheetPasswordDialogMode.pdmQuery, APassword);
end;
...
function TdxCustomSpreadSheet.DoPageControlContextPopup(const P: TPoint;
APopupMenu: TPopupMenu): Boolean;
begin
  Result := False;
...
procedure TdxCustomSpreadSheet.DoPageControlTabDragAndDrop(AIndex,
  ANewIndex: Integer; var AAccepted: Boolean);
begin
  if Assigned(OnPageControlTabDragAndDrop) then
    OnPageControlTabDragAndDrop(Self, AIndex, ANewIndex, AAccepted);
end;

procedure TdxCustomSpreadSheet.DoPageControlTabEndDrag(AOldIndex,
  AIndex: Integer);
begin
...
procedure TdxCustomSpreadSheet.DoScroll(AScrollBarKind: TScrollBarKind;
AFirstScrollablePosition: Integer);
begin
...
procedure TdxCustomSpreadSheet.DoSelectionChanged
  (AView: TdxSpreadSheetCustomView);
begin
...
function TdxCustomSpreadSheet.DoTableViewContextPopup(const P: TPoint;
APopupMenu: TPopupMenu): Boolean;
begin
  Result := False;
...
procedure TdxCustomSpreadSheet.DoChangeSheetVisibility
  (ASheet: TdxSpreadSheetCustomView);
begin
  StopEditing;
  BeginUpdate;
...
function TdxCustomSpreadSheet.GetSheetByGUID(const AGUID: string)
  : TdxSpreadSheetTableView;
var
  I: Integer;
  ASheet: TdxSpreadSheetTableView;
...
begin
  Result := inherited CanFocusOnClick and
    ((ActiveController = nil) or ActiveController.CanFocusOnClick);
end;

function TdxCustomSpreadSheet.DoMouseWheel(Shift: TShiftState;
...
begin
  ...
  begin
    AController := ActiveController;
    if (AController <> nil) or ControllerFromPoint(GetMouseCursorClientPos,
      AController) then
      Result := AController.MouseWheel(Shift, WheelDelta,
  ...
  begin
    ...
    begin
      if UseRightToLeftAlignment then
        Result.Right := MulDiv(ActiveSheetAsTable.ViewInfo.CellsArea.Right,
          ActiveSheet.ZoomFactor, 100)
      else
        Result.Left := MulDiv(ActiveSheetAsTable.ViewInfo.CellsArea.Left,
          ActiveSheet.ZoomFactor, 100);
    end;
...
begin
  ...
  begin
    ...
    if ActiveSheet <> nil then
      Inc(Result.Top, MulDiv(ActiveSheetAsTable.ViewInfo.CellsArea.Y,
        ActiveSheet.ZoomFactor, 100));
...
function TdxCustomSpreadSheet.GetDragAndDropObjectClass
  : TcxDragAndDropObjectClass;
begin
  Result := nil;
  if (ActiveController <> nil) and (ActiveController.HitTest.HitObject <> nil)
  then
...
function TdxCustomSpreadSheet.IsMouseWheelHandleNeeded(Shift: TShiftState;
WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
  Result := False;
end;
...
begin
  Result := inherited IsSizeGripVisible or
    (PageControl.Visible and VScrollBarVisible);
end;
...
procedure TdxCustomSpreadSheet.LookAndFeelChanged(Sender: TcxLookAndFeel;
...
procedure TdxCustomSpreadSheet.MouseDown(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
var
  AController: TdxSpreadSheetCustomController;
begin
...
procedure TdxCustomSpreadSheet.MouseUp(Button: TMouseButton; Shift: TShiftState;
X, Y: Integer);
var
  AController: TdxSpreadSheetCustomController;
begin
  ...
  UpdateHitTests(X, Y);
  // # Need update HitTest because after mouse up drag drop can be finished
  if ControllerFromPoint(X, Y, AController) then
...
procedure TdxCustomSpreadSheet.Scroll(AScrollBarKind: TScrollBarKind;
AScrollCode: TScrollCode; var AScrollPos: Integer);
begin
  if ActiveSheet <> nil then
  begin
...
procedure TdxCustomSpreadSheet.SetSheetIndex(AView: TdxSpreadSheetCustomView;
AIndex: Integer);
var
  AActive: Boolean;
begin
...
var
  AController: TdxSpreadSheetCustomController;
begin
  Result := ControllerFromPoint(P, AController) and
    AController.HitTest.CanDrag(P);
end;
...
procedure TdxCustomSpreadSheet.UnprotectCore
  (AOptions: TdxSpreadSheetCustomProtectionOptions);
var
  APassword: string;
begin
  if AOptions.ProtectionInfo <> nil then
  begin
    if ShowPasswordDialog(Self, TdxSpreadSheetPasswordDialogMode.pdmQuery,
      APassword) then
    begin
      if not AOptions.ProtectionInfo.CheckPassword(APassword) then
        raise EdxSpreadSheetInvalidPasswordError.Create
          (cxGetResourceString(@sdxOleCryptoContainerInvalidPassword));
  ...
  begin
    ...
    begin
      ...
      begin
        AIndex := 1;
        repeat
          Result := DoCheckSheetCaption
            (Copy(Result, 1, dxSpreadSheetMaxCaptionLength - AIndex) + '%d');
          Inc(AIndex);
...
begin
  if ACaption = '' then
    ACaption := DoCheckSheetCaption
      (cxGetResourceString(@sdxDefaultSheetCaption));
...
function TdxCustomSpreadSheet.GetFormatSettings
  : TdxSpreadSheetCustomFormatSettings;
begin
  Result := FFormatSettings;
end;

procedure TdxCustomSpreadSheet.ProcessStyleChanges(APrevStyle,
  ANewStyle: TdxSpreadSheetCellStyleHandle);
begin
  // do nothing
end;

function TdxCustomSpreadSheet.GetConditionalFormatting
  : TdxSpreadSheetCustomConditionalFormatting;
begin
...
AFormat: TdxSpreadSheetCustomFormatClass;
AProgressEvent: TdxSpreadSheetProgressEvent);

  procedure ExchangeFormatSettings(var AFormatSettings
    : TdxSpreadSheetFormatSettings);
  begin
...
function TdxCustomSpreadSheet.GetSheet(AIndex: Integer)
  : TdxSpreadSheetCustomView;
begin
...
function TdxCustomSpreadSheet.GetVisibleSheet(Index: Integer)
  : TdxSpreadSheetCustomView;
begin
...
procedure TdxCustomSpreadSheet.SetOptionsBehavior
  (AValue: TdxSpreadSheetOptionsBehavior);
begin
  FOptionsBehavior.Assign(AValue);
end;

procedure TdxCustomSpreadSheet.SetOptionsLockedStateImage
  (AValue: TdxSpreadSheetLockedStateImageOptions);
begin
  FOptionsLockedStateImage.Assign(AValue);
end;

procedure TdxCustomSpreadSheet.SetOptionsMetadata
  (AValue: TdxSpreadSheetOptionsMetadata);
begin
  FOptionsMetadata.Assign(AValue);
end;

procedure TdxCustomSpreadSheet.SetOptionsProtection
  (AValue: TdxSpreadSheetWorkbookProtectionOptions);
begin
  FOptionsProtection.Assign(AValue);
end;

procedure TdxCustomSpreadSheet.SetOptionsView
  (AValue: TdxSpreadSheetOptionsView);
begin
  FOptionsView.Assign(AValue);
end;

procedure TdxCustomSpreadSheet.SetPageControl
  (AValue: TdxSpreadSheetPageControl);
begin
...
begin
  if FNextClipboardListener <> 0 then
    SendMessage(FNextClipboardListener, AMessage.Msg, AMessage.WParam,
      AMessage.LParam);
end;
...
begin
  if (ActiveSheet = nil) or not ActiveSheet.Controller.IMEComposition(Message)
  then
    inherited;
end;
...
constructor TdxSpreadSheetDefaultCellStyle.Create(const AOwner
  : IdxSpreadSheetCellStyleOwner);
begin
  inherited Create(AOwner);
...
procedure TdxSpreadSheetDefaultCellStyle.SetHandle(const AHandle
  : TdxSpreadSheetCellStyleHandle);
begin
...
class function TdxSpreadSheetTextService.GetAsRTF(ACell: TdxSpreadSheetCell;
...
class function TdxSpreadSheetTextService.GetAsRTF(ACell: TdxSpreadSheetCell;
var AValue: string; ARichEditCompatibility: Boolean): Boolean;
begin
  Result := False;
end;
...
class function TdxSpreadSheetTextService.SetAsRTF(ACell: TdxSpreadSheetCell;
const AEditValue: string): Boolean;
begin
  Result := False;
end;

class procedure TdxSpreadSheetTextService.ApplyDefaultStyle
  (ACell: TdxSpreadSheetCell; const AEditValue: string);
begin
  // do nothing
end;

class procedure TdxSpreadSheetTextService.CalculateSize
...
begin
  AFlags := CXTO_CALCROWCOUNT or CXTO_CHARBREAK or CXTO_AUTOINDENTS or
    cxMakeFormat(taLeft, taTop);
  if not(AIsMerged and (AHeight <> nil) and (AWidth = nil)) and ACell.IsMultiline
  then
  ...
  cxMakeTextRows(ACanvas.Handle, PWideChar(AText), Length(AText), ABounds,
  ...
  try
    ...
    begin
      if ALineCount > ALinesInRow then
        AWidth^ := cxRectWidth(cxGetTextRect(ACanvas.Handle, AText, ALinesInRow)
          ) + cxTextOffset
      else
        AWidth^ := cxGetLongestTextRowWidth(ATextRows, ALineCount) +
          cxTextOffset;
    end;
  finally
...
begin
  cxTextOut(ACanvas.Handle, ACell.FDisplayText, ATextBounds,
    ACell.GetTextOutFormat or CXTO_CALCRECT, nil, 0, 0, 0, clDefault,
    ExcelLineSpacing);
end;

class procedure TdxSpreadSheetTextService.DrawValue(ACanvas: TcxCanvas;
ACell: TdxSpreadSheetTableViewCustomDataCellViewInfo; ABounds: TRect);
begin
  cxTextOut(ACanvas.Handle, ACell.DisplayText, ABounds, ACell.GetTextOutFormat,
    nil, 0, 0, 0, ACanvas.Font.Color, ExcelLineSpacing);
end;

class function TdxSpreadSheetTextService.ForceSetAsRTF
...
ACell: TdxSpreadSheetCell; AWidth, AHeight: PInteger);
var
  ABounds: TRect;
  AHasText: Boolean;
  AIndents: TRect;
...
begin
  ...
  if AMergedCell <> nil then
  begin
    if Assigned(AHeight) and (AMergedCell.Area.Top <> AMergedCell.Area.Bottom)
      or Assigned(AWidth) and (AMergedCell.Area.Left <> AMergedCell.Area.Right)
      or (AMergedCell.Area.Left <> ABounds.Left) or
      (AMergedCell.Area.Top <> ABounds.Top) then
      Exit;
    ...
    ABounds := cxRectBounds(0, 0, AView.Columns.GetRealItemSize(ABounds.Left),
      AView.Rows.GetRealItemSize(ABounds.Bottom));

  AIndents := ACell.GetContentOffsets(ACell.StyleHandle.Borders.BorderStyle
    [bBottom]);
  ABounds := cxRectContent(ABounds, AIndents);
  ABounds.Right := Max(ABounds.Left + 1,
    ABounds.Right - ACell.StyleHandle.AlignHorzIndent);
...
class function TdxSpreadSheetTextService.IsFormattedEditValue(const AEditValue
  : string): Boolean;
begin
  Result := False;
end;

class function TdxSpreadSheetTextService.IsFormattedTextValue
  (ACell: TdxSpreadSheetCell): Boolean;
begin
  Result := False;
end;
...
class function TdxSpreadSheetRTFService.CurrentService
...
dxRegisterCursor(crdxSpreadSheetRotate, HInstance,
  'DXSPREADSHEET_ROTATECURSOR');
dxRegisterCursor(crdxSpreadSheetRotation, HInstance,
  'DXSPREADSHEET_ROTATIONCURSOR');
dxRegisterCursor(crdxSpreadSheetDownArrow, HInstance,
  'DXSPREADSHEET_DOWNARROW');
