...
uses
  Types, Classes, Generics.Defaults, Generics.Collections, cxVariants,
  dxHashUtils,
  dxSpreadSheetCore, dxSpreadSheetTypes, dxSpreadSheetClasses,
  dxSpreadSheetCoreStyles, dxSpreadSheetCoreFormulas,
  dxSpreadSheetStyles, dxSpreadSheetConditionalFormatting,
  dxSpreadSheetPrinting, dxGenerics;
...
type
  ...
  TdxSpreadSheetHistoryCreateCellCommand = class
    (TdxSpreadSheetHistoryCellCommand)
  strict private
    FHasCell: Boolean;
    FHasColumn: Boolean;
  ...
  TdxSpreadSheetHistoryChangeCellCommand = class
    (TdxSpreadSheetHistoryCellCommand)
  protected
    FData: TMemoryStream;
  ...
  TdxSpreadSheetHistoryChangeCellStyleCommand = class
  ...
  TdxSpreadSheetHistoryDeleteCellCommand = class
    (TdxSpreadSheetHistoryChangeCellStyleCommand)
  public
    procedure Redo; override;
  end;
  ...
  TdxSpreadSheetHistoryMoveCellCommand = class
    (TdxSpreadSheetHistoryCustomCommand)
  strict private
    FSourceArea: TRect;
    FTargetArea: TRect;
  ...
  TdxSpreadSheetHistoryMergeCellsCommand = class
    (TdxSpreadSheetHistoryCustomCommand)
  strict private
  ...
  TdxSpreadSheetHistoryChangeItemCommand = class
    (TdxSpreadSheetHistoryCustomCommand)
  strict private
  const
    FLAGS_SIZECUSTOM = 1;
  ...
  protected
    ...
    procedure Restore; virtual;
    procedure RestoreItemParams(ASize, AFlags: Integer;
  ...
  public
    ...
    property StyleHandle: TdxSpreadSheetCellStyleHandle read FStyleHandle
      write SetStyleHandle;
  end;

  { TdxSpreadSheetHistoryDeleteItemCommand }

  TdxSpreadSheetHistoryDeleteItemCommand = class
    (TdxSpreadSheetHistoryChangeItemCommand)
  public
  ...
  TdxSpreadSheetHistoryCustomGroupCommand = class
    (TdxSpreadSheetHistoryCustomCommand)
  strict private
  ...
  protected
    ...
    procedure StoreIndexes(AIndexes: TdxIntegerList;
  ...
  TdxSpreadSheetHistoryChangeGroupRangeCommand = class
    (TdxSpreadSheetHistoryCustomGroupCommand)
  strict private
  ...
  TdxSpreadSheetHistoryChangeGroupParentCommand = class
    (TdxSpreadSheetHistoryChangeGroupRangeCommand)
  strict private
  ...
  TdxSpreadSheetHistoryChangeDefaultSizeCommand = class
    (TdxSpreadSheetHistoryCustomCommand)
  strict private
    FSize: Integer;
    FItems: TdxSpreadSheetTableItems;
  ...
  TdxSpreadSheetHistoryCustomContainerCommand = class
    (TdxSpreadSheetHistoryCustomCommand)
  strict private
  ...
  TdxSpreadSheetHistoryCreateContainerCommand = class
    (TdxSpreadSheetHistoryCustomContainerCommand)
  public
    procedure Redo; override;
    procedure Undo; override;
  ...
  TdxSpreadSheetHistoryChangeContainerCommand = class
    (TdxSpreadSheetHistoryCustomContainerCommand)
  strict private
  ...
  protected
    ...
    procedure StoreData(AContainer: TdxSpreadSheetContainer;
      AWriter: TcxWriter); virtual;
  public
    constructor Create(AContainer: TdxSpreadSheetContainer;
      ACanSaveContent: Boolean = False);
    destructor Destroy; override;
    procedure Redo; override;
    procedure Undo; override;
  end;
  ...
  TdxSpreadSheetHistoryChangeContainerIndexCommand = class
    (TdxSpreadSheetHistoryCustomContainerCommand)
  strict private
    FOldIndex: Integer;
  public
  ...
  TdxSpreadSheetHistoryDeleteContainerCommand = class
    (TdxSpreadSheetHistoryChangeContainerCommand)
  protected
  ...
  TdxSpreadSheetHistoryFormulaChangedCommand = class
    (TdxSpreadSheetHistoryCustomCommand)
  private
    ...
    FSourceText: string;
  public
    constructor Create(AFormula: TdxSpreadSheetCustomFormula;
  ...
  TdxSpreadSheetHistoryConditionalFormattingRuleCustomCommand = class
    (TdxSpreadSheetHistoryCustomCommand)
  strict private
  ...
  TdxSpreadSheetHistoryCreateConditionalFormattingRuleCommand = class
    (TdxSpreadSheetHistoryConditionalFormattingRuleCustomCommand)
  protected
  ...
  TdxSpreadSheetHistoryChangeConditionalFormattingRuleCommand = class
    (TdxSpreadSheetHistoryConditionalFormattingRuleCustomCommand)
  protected
    procedure Initialize; override;
    procedure Restore; override;
  ...
  TdxSpreadSheetHistoryChangeConditionalFormattingRuleIndexCommand = class
    (TdxSpreadSheetHistoryCustomCommand)
  strict private
    FNewIndex: Integer;
    FOldIndex: Integer;
  ...
  TdxSpreadSheetHistoryDeleteConditionalFormattingRuleCommand = class
    (TdxSpreadSheetHistoryCreateConditionalFormattingRuleCommand)
  protected
    procedure Initialize; override;
  public
  ...
  TdxSpreadSheetHistoryChangePrintingOptionsCommand = class
    (TdxSpreadSheetHistoryCustomCommand)
  strict private
  ...
  TdxSpreadSheetHistoryCreateDefinedNameCommand = class
    (TdxSpreadSheetHistoryCustomCommand)
  strict private
  ...
  TdxSpreadSheetHistoryChangeDefinedNameCommand = class
    (TdxSpreadSheetHistoryCreateDefinedNameCommand)
  public
    NewCaption: string;
    NewComment: string;
  ...
  TdxSpreadSheetHistoryDeleteDefinedNameCommand = class
    (TdxSpreadSheetHistoryCreateDefinedNameCommand)
  public
    class function ActionClass: TdxSpreadSheetHistoryActionClass; override;
    procedure Redo; override;
...
uses
  Math, SysUtils, cxGeometry, dxCore, dxSpreadSheetCoreHelpers,
...
constructor TdxSpreadSheetHistoryCellCommand.Create
  (ASheet: TdxSpreadSheetTableView; ARow, AColumn: Integer);
begin
  FRow := ARow;
  FColumn := AColumn;
  FSheet := ASheet;
...
constructor TdxSpreadSheetHistoryCellCommand.CreateEx
  (ACell: TdxSpreadSheetCell);
begin
  Create(ACell.View, ACell.RowIndex, ACell.ColumnIndex);
end;

class function TdxSpreadSheetHistoryCellCommand.ActionClass
  : TdxSpreadSheetHistoryActionClass;
begin
  Result := TdxSpreadSheetHistoryEditCellAction;
end;

function TdxSpreadSheetHistoryCellCommand.CompatibleWith
...
begin
  Result := (ACommand is TdxSpreadSheetHistoryCellCommand) and
    ...
    (TdxSpreadSheetHistoryChangeCellStyleCommand(ACommand).FPoint.X = Column)
    and (TdxSpreadSheetHistoryChangeCellStyleCommand(ACommand).FPoint.Y = Row);
end;
...
constructor TdxSpreadSheetHistoryChangeCellCommand.CreateEx
  (ACell: TdxSpreadSheetCell);
begin
...
begin
  ...
  try
    ACell := Cell;
    Store(ACell);
    AFormulaRef := TdxSpreadSheetFormulaAsTextInfoList.Create
      (Sheet.SpreadSheet);
    try
...
class function TdxSpreadSheetHistoryChangeCellStyleCommand.ActionClass
  : TdxSpreadSheetHistoryActionClass;
begin
  Result := TdxSpreadSheetHistoryEditCellAction;
end;

function TdxSpreadSheetHistoryChangeCellStyleCommand.CompatibleWith
  (ACommand: TdxSpreadSheetHistoryCustomCommand): Boolean;
begin
  Result := (ACommand is TdxSpreadSheetHistoryCellCommand) and
    TdxSpreadSheetHistoryCellCommand(ACommand).CompatibleWith(Self) or
    (ACommand is TdxSpreadSheetHistoryChangeCellStyleCommand) and
    (TdxSpreadSheetHistoryChangeCellStyleCommand(ACommand).FOwner = FOwner) and
    (cxPointIsEqual(TdxSpreadSheetHistoryChangeCellStyleCommand(ACommand)
    .FPoint, FPoint));
end;
...
function TdxSpreadSheetHistoryChangeCellStyleCommand.GetStyleHandle
  : TdxSpreadSheetCellStyleHandle;
begin
  if FPoint.Y >= 0 then
    Result := TdxSpreadSheetTableView(FOwner).CreateCell(FPoint.Y, FPoint.X)
      .StyleHandle
  else
    Result := TdxSpreadSheetTableItems(FOwner).CreateItem(FPoint.X).Style.Handle
end;

procedure TdxSpreadSheetHistoryChangeCellStyleCommand.SetHandle
  (AValue: TdxSpreadSheetCellStyleHandle);
begin
  dxChangeHandle(TdxHashTableItem(FHandle), AValue);
end;

procedure TdxSpreadSheetHistoryChangeCellStyleCommand.SetStyleHandle
  (AValue: TdxSpreadSheetCellStyleHandle);
begin
  if FPoint.Y >= 0 then
    TdxSpreadSheetTableView(FOwner).CreateCell(FPoint.Y, FPoint.X)
      .StyleHandle := AValue
  else
...
constructor TdxSpreadSheetHistoryMoveCellCommand.Create(const ASourceArea,
  ATargetArea: TRect);
begin
  inherited Create;
...
class function TdxSpreadSheetHistoryMoveCellCommand.ActionClass
  : TdxSpreadSheetHistoryActionClass;
begin
...
var
  ...
  ATempRect: TRect;
begin
  AHelper := TdxSpreadSheetTableViewMoveCellsModificationHelper.Create
    (View as TdxSpreadSheetTableView);
  try
...
constructor TdxSpreadSheetHistoryMergeCellsCommand.Create
...
class function TdxSpreadSheetHistoryMergeCellsCommand.ActionClass
  : TdxSpreadSheetHistoryActionClass;
begin
...
function TdxSpreadSheetHistoryMergeCellsCommand.GetMergedCells
  : TdxSpreadSheetMergedCellList;
begin
  Result := TdxSpreadSheetTableView(View).MergedCells;
end;

function TdxSpreadSheetHistoryMergeCellsCommand.FindCell
  : TdxSpreadSheetMergedCell;
var
  ACells: TdxSpreadSheetMergedCellListAccess;
begin
  ACells := TdxSpreadSheetMergedCellListAccess(TdxSpreadSheetTableView(View)
    .MergedCells);
  Result := FCell;
...
constructor TdxSpreadSheetHistoryChangeItemCommand.Create
...
procedure TdxSpreadSheetHistoryChangeItemCommand.RestoreItemParams(ASize,
  AFlags: Integer; AHandle: TdxSpreadSheetCellStyleHandle);
begin
  TdxSpreadSheetTableItemAccess(Item).BeforeResize;
  try
    TdxSpreadSheetTableItemAccess(Item).Size := ASize;
    TdxSpreadSheetTableItemAccess(Item).DefaultSize := AFlags and
      FLAGS_SIZEDEFAULT <> 0;
    TdxSpreadSheetTableItemAccess(Item).IsCustomSize := AFlags and
      FLAGS_SIZECUSTOM <> 0;
    TdxSpreadSheetTableItemAccess(Item).Visible := AFlags and
      FLAGS_VISIBLE <> 0;
...
begin
  ...
  FFlags := IfThen(TdxSpreadSheetTableItemAccess(Item).DefaultSize,
    FLAGS_SIZEDEFAULT) or IfThen(TdxSpreadSheetTableItemAccess(Item)
    .IsCustomSize, FLAGS_SIZECUSTOM) or
    IfThen(TdxSpreadSheetTableItemAccess(Item).Visible, FLAGS_VISIBLE);
  FSize := Item.CustomSize;
end;

function TdxSpreadSheetHistoryChangeItemCommand.GetItem
  : TdxSpreadSheetTableItem;
begin
  Result := FItems.CreateItem(FItemIndex);
end;

procedure TdxSpreadSheetHistoryChangeItemCommand.SetStyleHandle
  (AValue: TdxSpreadSheetCellStyleHandle);
begin
...
constructor TdxSpreadSheetHistoryCustomGroupCommand.Create
  (AGroup: TdxSpreadSheetTableItemGroup);
begin
  inherited Create;
...
procedure TdxSpreadSheetHistoryCustomGroupCommand.StoreIndexes
  (AIndexes: TdxIntegerList; AGroup: TdxSpreadSheetTableItemGroup);
var
  AIndex: Integer;
begin
...
function TdxSpreadSheetHistoryCustomGroupCommand.GetRoot
...
constructor TdxSpreadSheetHistoryChangeGroupRangeCommand.Create
  (AGroup: TdxSpreadSheetTableItemGroup);
begin
...
procedure TdxSpreadSheetHistoryChangeGroupRangeCommand.RedoUndo;
  ...
  function Exchange(var AStoreValue: Integer;
    const ACurrentValue: Integer): Integer;
  begin
    Result := AStoreValue;
...
function TdxSpreadSheetHistoryChangeGroupRangeCommand.GetGroup
  : TdxSpreadSheetTableItemGroup;
var
  AGroup: TdxSpreadSheetTableItemGroup;
  I: Integer;
...
constructor TdxSpreadSheetHistoryChangeGroupParentCommand.Create
  (AGroup: TdxSpreadSheetTableItemGroup);
begin
  inherited Create(AGroup);
...
begin
  ...
  else if FIndexes.Count = 0 then
    TdxSpreadSheetTableItemGroup.Create(Root.Owner, GetPrevParent, StartIndex,
      FinishIndex)
  else
    Group.Free;
...
procedure TdxSpreadSheetHistoryChangeGroupParentCommand.Changing
  (AGroup: TdxSpreadSheetTableItemGroup);
begin
  // do nothing
end;

procedure TdxSpreadSheetHistoryChangeGroupParentCommand.Changed
  (AGroup: TdxSpreadSheetTableItemGroup);
begin
...
function TdxSpreadSheetHistoryChangeGroupParentCommand.GetPrevParent
  : TdxSpreadSheetTableItemGroup;
var
  I: Integer;
begin
...
constructor TdxSpreadSheetHistoryChangeDefaultSizeCommand.Create
...
constructor TdxSpreadSheetHistoryCustomContainerCommand.Create
...
procedure TdxSpreadSheetHistoryCustomContainerCommand.Store
  (AContainer: TdxSpreadSheetContainer);
begin
...
function TdxSpreadSheetHistoryCustomContainerCommand.GetContainer
...
procedure TdxSpreadSheetHistoryChangeContainerCommand.RestoreData
  (AReader: TcxReader);
begin
  Store(Container);
...
procedure TdxSpreadSheetHistoryChangeContainerCommand.Store
  (AContainer: TdxSpreadSheetContainer);
var
  AWriter: TcxWriter;
begin
...
procedure TdxSpreadSheetHistoryChangeContainerCommand.StoreData
...
procedure TdxSpreadSheetHistoryDeleteContainerCommand.RestoreData
  (AReader: TcxReader);
begin
  CreateContainer;
  TdxSpreadSheetContainerAccess(Container).LoadFromStream(AReader);
...
constructor TdxSpreadSheetHistoryFormulaChangedCommand.Create
  (AFormula: TdxSpreadSheetCustomFormula; const ASourceText: string);
begin
...
begin
  ...
  else if TdxSpreadSheetDefinedNamesAccess(View.SpreadSheet.DefinedNames)
    .ItemList.IndexOf(FName) >= 0 then
...
class function TdxSpreadSheetHistoryConditionalFormattingRuleCustomCommand.
  ActionClass: TdxSpreadSheetHistoryActionClass;
begin
...
function TdxSpreadSheetHistoryConditionalFormattingRuleCustomCommand.
...
function TdxSpreadSheetHistoryConditionalFormattingRuleCustomCommand.GetRule
...
begin
  FRuleClass.Create(TdxSpreadSheetTableView(View).ConditionalFormatting).Index
    := FRuleIndex;
end;
...
procedure TdxSpreadSheetHistoryChangeConditionalFormattingRuleCommand.
  Initialize;
begin
...
constructor TdxSpreadSheetHistoryChangeConditionalFormattingRuleIndexCommand.
  Create(AOldIndex, ANewIndex: Integer);
begin
  inherited Create;
  FOldIndex := AOldIndex;
  FNewIndex := ANewIndex;
...
class function TdxSpreadSheetHistoryChangeConditionalFormattingRuleIndexCommand.
  ActionClass: TdxSpreadSheetHistoryActionClass;
begin
  Result := TdxSpreadSheetHistoryChangeConditionalFormattingAction;
end;
...
function TdxSpreadSheetHistoryChangeConditionalFormattingRuleIndexCommand.
  GetConditionalFormatting: TdxSpreadSheetCustomConditionalFormatting;
begin
  Result := TdxSpreadSheetTableView(View).ConditionalFormatting;
end;
...
procedure TdxSpreadSheetHistoryDeleteConditionalFormattingRuleCommand.
  Initialize;
begin
  inherited Initialize;
  Store(Rule);
...
class function TdxSpreadSheetHistoryChangePrintingOptionsCommand.ActionClass
  : TdxSpreadSheetHistoryActionClass;
begin
...
function TdxSpreadSheetHistoryChangePrintingOptionsCommand.GetView
...
constructor TdxSpreadSheetHistoryCreateDefinedNameCommand.Create
  (const ADefinedName: TdxSpreadSheetDefinedName);
begin
...
class function TdxSpreadSheetHistoryCreateDefinedNameCommand.ActionClass
  : TdxSpreadSheetHistoryActionClass;
begin
...
begin
  ...
  try
    ...
    if ADefinedName.Index <> FIndex then
      TdxSpreadSheetDefinedNamesAccess(DefinedNames)
        .ItemList.Move(ADefinedName.Index, FIndex);
  finally
...
function TdxSpreadSheetHistoryCreateDefinedNameCommand.GetDefinedNames
...
class function TdxSpreadSheetHistoryChangeDefinedNameCommand.ActionClass
  : TdxSpreadSheetHistoryActionClass;
begin
...
class function TdxSpreadSheetHistoryDeleteDefinedNameCommand.ActionClass
  : TdxSpreadSheetHistoryActionClass;
begin
...
constructor TdxSpreadSheetHistoryDeleteCommand.Create
