...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, SysUtils, StrUtils, Classes, Controls, Graphics, Math, StdCtrls,
  Generics.Collections, Generics.Defaults,
  dxCore, cxClasses, cxGraphics, cxGeometry, dxActions, dxPrinting, dxHashUtils,
  cxRichEdit, dxGallery,
  dxSpreadSheetCore, dxSpreadSheetCoreHelpers, dxSpreadSheetGraphics,
  dxSpreadSheetContainers, dxSpreadSheetStyles,
...
type
  ...
  protected
    ...
    procedure ProcessSelectedCellStyles
    ...
    property ActiveSelection: TdxSpreadSheetTableViewSelection
      read FActiveSelection;
  ...
  TdxSpreadSheetValueAction = class(TdxSpreadSheetCustomFormatCellsAction,
    IdxActionValue)
  strict private
    FValue: Variant;
  protected
    ...
    class function IsValueEquals(const AValue1, AValue2: Variant)
      : Boolean; virtual;
  public
  ...
  TdxSpreadSheetCustomToggleFontStyleAction = class
    (TdxSpreadSheetCustomFormatCellsAction)
  private
  ...
  TdxSpreadSheetCustomLineStyleBordersAction = class
    (TdxSpreadSheetCustomFormatCellsAction)
  protected
    procedure SetEnumCellBottomBorder(ACellStyle: TdxSpreadSheetCellStyle;
      ARow, AColumn: Integer; const AArea: TRect;
      const ABorderStyle: TdxSpreadSheetCellBorderStyle);
  ...
  TdxSpreadSheetBordersBottom = class
    (TdxSpreadSheetCustomLineStyleBordersAction)
  protected
    procedure DoExecute; override;
  public
  ...
  TdxSpreadSheetBordersBottomDouble = class
    (TdxSpreadSheetCustomLineStyleBordersAction)
  protected
    procedure DoExecute; override;
  public
  ...
  TdxSpreadSheetBordersBottomThick = class
    (TdxSpreadSheetCustomLineStyleBordersAction)
  protected
    procedure DoExecute; override;
  public
  ...
  TdxSpreadSheetBordersOutsideThick = class
    (TdxSpreadSheetCustomLineStyleBordersAction)
  protected
    procedure DoExecute; override;
  public
  ...
  TdxSpreadSheetBordersTopAndBottom = class
    (TdxSpreadSheetCustomLineStyleBordersAction)
  protected
    procedure DoExecute; override;
  public
  ...
  TdxSpreadSheetBordersTopAndBottomDouble = class
    (TdxSpreadSheetCustomLineStyleBordersAction)
  protected
    procedure DoExecute; override;
  public
  ...
  TdxSpreadSheetBordersTopAndBottomThick = class
    (TdxSpreadSheetCustomLineStyleBordersAction)
  protected
    procedure DoExecute; override;
  public
  ...
  TdxSpreadSheetCustomAlignHorizontalAction = class
    (TdxSpreadSheetCustomFormatCellsAction)
  protected
  ...
  TdxSpreadSheetCustomAlignVerticalAction = class
    (TdxSpreadSheetCustomFormatCellsAction)
  protected
  ...
  TdxSpreadSheetTextIndentDecrease = class
    (TdxSpreadSheetCustomFormatCellsAction)
  protected
    procedure DoExecute; override;
  public
  ...
  TdxSpreadSheetTextIndentIncrease = class
    (TdxSpreadSheetCustomFormatCellsAction)
  protected
    procedure DoExecute; override;
  public
  ...
  TdxSpreadSheetCustomChangeTableItemsVisibilityAction = class
    (TdxSpreadSheetAction)
  protected
  ...
  TdxSpreadSheetChangeFillColor = class(TdxSpreadSheetValueAction,
    IdxActionColorValue)
  protected
    procedure DoExecute; override;
    procedure DoUpdateState; override;
  ...
  TdxSpreadSheetChangeFontColor = class(TdxSpreadSheetValueAction,
    IdxActionColorValue)
  protected
    procedure DoExecute; override;
    procedure DoUpdateState; override;
  ...
  TdxSpreadSheetChangeFontName = class(TdxSpreadSheetValueAction,
  ...
  TdxSpreadSheetChangeFontSize = class(TdxSpreadSheetValueAction,
  ...
  protected
    ...
    function FindGalleryGroupItem(AGroup: TdxCustomGalleryGroup;
      const AActionIndex: Variant): TdxCustomGalleryItem; virtual;
  ...
  protected const
    CPredefinedNarrowMarginsSet: TMarginsSet = (0.75, 0.75, 0.25, 0.25,
      0.3, 0.3);
    CPredefinedNormalMarginsSet: TMarginsSet = (0.75, 0.75, 0.7, 0.7, 0.3, 0.3);
    CPredefinedWideMarginsSet: TMarginsSet = (1, 1, 1, 1, 0.5, 0.5);
  strict private
    function GetPredefinedMarginsSet(const APredefinedMarginsSet
      : TPredefinedMarginsSet): TMarginsSet;
    function GetPredefinedMarginsSetCaption(const APredefinedMarginsSet
      : TPredefinedMarginsSet): string;
    function GetPredefinedMarginsSetDescription(const APredefinedMarginsSet
      : TPredefinedMarginsSet): string;
  protected
    procedure UpdateGalleryContentResourceStrings; override;
    // IdxActionGalleryClient
  ...
  TdxSpreadSheetCustomFormulasGalleryAction = class
    (TdxSpreadSheetCustomGalleryAction)
  protected
  ...
  TdxSpreadSheetFinancialFormulasGallery = class
    (TdxSpreadSheetCustomFormulasGalleryAction)
  protected
  ...
  TdxSpreadSheetLogicalFormulasGallery = class
    (TdxSpreadSheetCustomFormulasGalleryAction)
  protected
    function GetTypeID: TdxSpreadSheetFunctionType; override;
  public
  ...
  TdxSpreadSheetTextFormulasGallery = class
    (TdxSpreadSheetCustomFormulasGalleryAction)
  protected
    function GetTypeID: TdxSpreadSheetFunctionType; override;
  public
  ...
  TdxSpreadSheetDateAndTimeFormulasGallery = class
    (TdxSpreadSheetCustomFormulasGalleryAction)
  protected
    function GetTypeID: TdxSpreadSheetFunctionType; override;
  public
  ...
  TdxSpreadSheetLookupAndReferenceFormulasGallery = class
    (TdxSpreadSheetCustomFormulasGalleryAction)
  protected
    function GetTypeID: TdxSpreadSheetFunctionType; override;
  public
  ...
  TdxSpreadSheetMathAndTrigFormulasGallery = class
    (TdxSpreadSheetCustomFormulasGalleryAction)
  protected
    function GetTypeID: TdxSpreadSheetFunctionType; override;
  public
  ...
  TdxSpreadSheetStatisticalFormulasGallery = class
    (TdxSpreadSheetCustomFormulasGalleryAction)
  protected
    function GetTypeID: TdxSpreadSheetFunctionType; override;
  public
  ...
  TdxSpreadSheetInformationFormulasGallery = class
    (TdxSpreadSheetCustomFormulasGalleryAction)
  protected
    function GetTypeID: TdxSpreadSheetFunctionType; override;
  public
  ...
  TdxSpreadSheetCompatibilityFormulasGallery = class
    (TdxSpreadSheetCustomFormulasGalleryAction)
  protected
    function GetTypeID: TdxSpreadSheetFunctionType; override;
  public
  ...
  TdxSpreadSheetPageOrientationGallery = class
    (TdxSpreadSheetCustomGalleryAction)
  strict private
    function GetPageOrientationCaption(AOrientation
      : TdxSpreadSheetTableViewOptionsPrintPageOrientation): string;
  protected
    procedure UpdateGalleryContentResourceStrings; override;
  ...
  TdxSpreadSheetUseDefinedNameInFormula = class
    (TdxSpreadSheetCustomGalleryAction, IdxSpreadSheetListener,
...
uses
  Dialogs, ExtDlgs, dxGDIPlusClasses, dxSpreadSheetActionsStrs,
  dxSpreadSheetTypes, dxSpreadSheetFormatCellsDialog,
  dxSpreadSheetClasses, dxSpreadSheetStrs, dxSpreadSheetUnhideSheetDialog,
  dxSpreadSheetFindAndReplaceDialog,
  dxSpreadSheetEditHyperlinkDialog, dxSpreadSheetCoreStrs,
  dxSpreadSheetCoreHistory, dxSpreadSheetUtils,
  dxSpreadSheetPageSetupDialog, dxPrintUtils, dxMeasurementUnits,
  dxSpreadSheetDialogStrs, dxTypeHelpers,
  dxSpreadSheetFormulasHelpers, cxEdit, Variants, dxSpreadSheetInplaceEdit,
  dxSpreadSheetFunctionsStrs,
  dxSpreadSheetDefinedNameManagerDialog, Menus,
  dxSpreadSheetDefinedNameEditDialog,
  dxSpreadSheetDefinedNamesCreateFromSelectionDialog;
...
begin
  Result := (inherited HandlesTarget(Target) or (Target is TdxCustomSpreadSheet)
    ) and (not NeedControlFocus or TdxCustomSpreadSheet(Target).Focused);
end;

procedure TdxSpreadSheetAction.InsertToEditingFormula(const AText: string;
  AIsFunction: Boolean);
var
  AEdit: TcxCustomEdit;
...
begin
  ...
  begin
    AEditingController := TEditingControllerAccess
      (TdxSpreadSheetTableViewAccess(ActiveTable).EditingController);
...
procedure TdxSpreadSheetAction.ProcessSelectedCellStyles
  (AProcRef: TdxSpreadSheetCellStyleEnumProcRef);
var
...
begin
  Result := not FIsSelectionNeeded or
    ((ActiveSelection.Count > 0) and (FIsContainerSelectionSupported or
    (ActiveSelection.FocusedContainer = nil)));
end;
...
begin
  ...
  begin
    if (ActiveSelection <> nil) and (ActiveSelection.FocusedContainer = nil)
    then
      FActiveCellStyle := TdxSpreadSheetTableViewAccess(ActiveTable)
        .GetFocusedCellStyle
    else
...
begin
  Result := inherited IsEnabled and
    (not IsActiveTableProtected or (TdxSpreadSheetTableViewAccess(ActiveTable)
    .GetLockedStateOfCellsInArea(ActiveSelection.Area) = cbUnchecked));
end;

{ TdxSpreadSheetCustomFormatCellsAction }

function TdxSpreadSheetCustomFormatCellsAction.GetEdit
  (out AEdit: TcxCustomRichEdit): Boolean;
begin
  Result := TdxSpreadSheetTableViewEditingController.GetActualInplaceEdit
    (ActiveTable, TdxSpreadSheetCustomInplaceEdit(AEdit));
end;
...
begin
  Result := inherited IsEnabled and
    ActiveTable.OptionsProtection.ActualAllowFormatCells and
    (not ActiveTable.IsEditing or EnabledWhenEditing and
    dxSpreadSheetTextService.IsRTFSupported and GetEdit(AEdit));
end;
...
class function TdxSpreadSheetValueAction.IsValueEquals(const AValue1,
...
begin
  if TdxSpreadSheetTableViewEditingController.GetActualInplaceEdit(ActiveTable,
    AEdit) then
...
begin
  Result := inherited IsEnabled and (ActiveTable.CanCopyToClipboard or
    ActiveTable.IsEditing);
end;
...
begin
  Result := inherited IsEnabled and
    (ActiveTable.CanCutToClipboard or ActiveTable.IsEditing);
end;
...
begin
  Result := inherited IsEnabled and (ActiveTable.CanPasteFromClipboard or
    ActiveTable.IsEditing);
end;
...
begin
  if GetEdit(AEdit) then
    ...
    ProcessSelectedCellStyles(
      procedure(ACellStyle: TdxSpreadSheetCellStyle; ARow, AColumn: Integer;
        const AArea: TRect)
      begin
...
procedure TdxSpreadSheetCustomToggleFontStyleAction.SetFontStyle
  (AValue: TFontStyles);
var
  AEdit: TcxCustomRichEdit;
begin
...
procedure TdxSpreadSheetCustomLineStyleBordersAction.SetEnumCellBottomBorder
  (ACellStyle: TdxSpreadSheetCellStyle; ARow, AColumn: Integer;
const AArea: TRect; const ABorderStyle: TdxSpreadSheetCellBorderStyle);
begin
  if (ARow < dxSpreadSheetMaxRowCount - 1) and
    not ActiveSelection.IsCellSelected(ARow + 1, AColumn) then
    ACellStyle.Borders[bBottom].Style := ABorderStyle;
end;

procedure TdxSpreadSheetCustomLineStyleBordersAction.SetEnumCellLeftBorder
  (ACellStyle: TdxSpreadSheetCellStyle; ARow, AColumn: Integer;
const AArea: TRect; const ABorderStyle: TdxSpreadSheetCellBorderStyle);
begin
...
procedure TdxSpreadSheetCustomLineStyleBordersAction.SetEnumCellRightBorder
  (ACellStyle: TdxSpreadSheetCellStyle; ARow, AColumn: Integer;
const AArea: TRect; const ABorderStyle: TdxSpreadSheetCellBorderStyle);
begin
  if (AColumn < dxSpreadSheetMaxColumnCount - 1) and
    not ActiveSelection.IsCellSelected(ARow, AColumn + 1) then
    ACellStyle.Borders[bRight].Style := ABorderStyle;
end;

procedure TdxSpreadSheetCustomLineStyleBordersAction.SetEnumCellTopBorder
  (ACellStyle: TdxSpreadSheetCellStyle; ARow, AColumn: Integer;
const AArea: TRect; const ABorderStyle: TdxSpreadSheetCellBorderStyle);
begin
    ...
    try
      for I := 0 to ActiveSelection.Count - 1 do
        for ARow := ActiveSelection[I].Top to ActiveSelection[I].Bottom do
          ActiveTable.MergedCells.Add(Rect(ActiveSelection[I].Left, ARow,
            ActiveSelection[I].Right, ARow));
    finally
      ActiveTable.EndUpdate;
    end;
  finally
...
begin
  ...
  try
    ...
    try
      ActiveTable.MergeSelected;
      for I := 0 to ActiveSelection.Count - 1 do
        ActiveTable.CreateCell(ActiveSelection[I].Top, ActiveSelection[I].Left)
...
begin
  ...
  ActiveTable.InsertColumns(ActiveSelection.FocusedColumn,
    cxRectWidth(ActiveSelection.Area) + 1);
end;
...
begin
  if ActiveSelection.Count <> 1 then
    raise EdxSpreadSheetError.Create
      (cxGetResourceString(@sdxErrorInvalidSelection));
  ActiveTable.InsertRows(ActiveSelection.FocusedRow,
    cxRectHeight(ActiveSelection.Area) + 1);
end;
...
begin
  if ActiveSelection.Count <> 1 then
    raise EdxSpreadSheetError.Create
      (cxGetResourceString(@sdxErrorInvalidSelection));
  ActiveTable.DeleteColumns(ActiveSelection.Area.Left,
    cxRectWidth(ActiveSelection.Area) + 1);
end;
...
begin
  if ActiveSelection.Count <> 1 then
    raise EdxSpreadSheetError.Create
      (cxGetResourceString(@sdxErrorInvalidSelection));
  ActiveTable.DeleteRows(ActiveSelection.Area.Top,
    cxRectHeight(ActiveSelection.Area) + 1);
end;
...
begin
  Result := inherited IsEnabled and
    ActiveTable.OptionsProtection.ActualAllowResizeColumns;
end;
...
begin
  Result := inherited IsEnabled and
    ActiveTable.OptionsProtection.ActualAllowResizeRows;
end;

{ TdxSpreadSheetCustomChangeTableItemsVisibilityAction }

procedure TdxSpreadSheetCustomChangeTableItemsVisibilityAction.
  ChangeCellsVisibility(ACollection: TdxSpreadSheetTableItems;
const AFirstIndex, ALastIndex: Integer; const AValue: Boolean);
var
  I: Integer;
begin
...
begin
  ChangeCellsVisibility(ActiveTable.Columns, ActiveSelection.Area.Left,
    ActiveSelection.Area.Right, False);
end;
...
begin
  ChangeCellsVisibility(ActiveTable.Rows, ActiveSelection.Area.Top,
    ActiveSelection.Area.Bottom, False);
end;
...
begin
  ...
  while not Control.Sheets[AFirstVisibleSheet].Visible and
    (AFirstVisibleSheet < Control.SheetCount - 1) do
    Inc(AFirstVisibleSheet);
  while not Control.Sheets[AFirstVisibleSheet].Visible and
    (AFirstVisibleSheet > 0) do
...
begin
  ChangeCellsVisibility(ActiveTable.Columns, ActiveSelection.Area.Left,
    ActiveSelection.Area.Right, True);
end;
...
begin
  ChangeCellsVisibility(ActiveTable.Rows, ActiveSelection.Area.Top,
    ActiveSelection.Area.Bottom, True);
end;
...
begin
  Result := inherited IsEnabled and
    Control.OptionsProtection.ActualAllowChangeStructure and
  ...
  ProcessSelectedCellStyles(
    ...
    begin
      if ActiveTable.Cells[ARow, AColumn] <> nil then
        ActiveTable.Cells[ARow, AColumn].StyleHandle :=
          Control.DefaultCellStyle.Handle;
    end);
end;
...
begin
  ActiveTable.SortByColumnValues(ActiveSelection.Area, [soAscending],
    [ActiveSelection.Area.Left]);
end;
...
begin
  ActiveTable.SortByColumnValues(ActiveSelection.Area, [soDescending],
    [ActiveSelection.Area.Left]);
end;
...
begin
  if ActiveSelection.Count > 0 then
    ActiveTable.Columns.Groups.Add(ActiveSelection.Area.Left,
      ActiveSelection.Area.Right);
end;
...
begin
  if ActiveSelection.Count > 0 then
    ActiveTable.Rows.Groups.Add(ActiveSelection.Area.Top,
      ActiveSelection.Area.Bottom);
end;
...
begin
  if ActiveSelection.Count > 0 then
    ActiveTable.Columns.Groups.Delete(ActiveSelection.Area.Left,
      ActiveSelection.Area.Right);
end;
...
begin
  if ActiveSelection.Count > 0 then
    ActiveTable.Rows.Groups.Delete(ActiveSelection.Area.Top,
      ActiveSelection.Area.Bottom);
end;
...
function TdxSpreadSheetCustomCommentAction.GetContainer
...
begin
  if ActiveSelection.FocusedContainer is TdxSpreadSheetCommentContainer then
    ...
    Result := TdxSpreadSheetCommentContainer
      (ActiveTable.Containers.FindCommentContainer(ActiveSelection.FocusedRow,
      ActiveSelection.FocusedColumn));
end;
...
function TdxSpreadSheetCustomCommentNavigationAction.GetNextContainer
...
begin
  ...
  if AContainer is TdxSpreadSheetCommentContainer then
    ACellRef := Point(TdxSpreadSheetCommentContainer(AContainer)
      .Cell.ColumnIndex, TdxSpreadSheetCommentContainer(AContainer)
      .Cell.RowIndex)
  else
    ACellRef := Point(ActiveSelection.FocusedColumn,
      ActiveSelection.FocusedRow);

  Result := ActiveTable.Containers.FindNextCommentContainer(ACellRef.Y,
    ACellRef.X, AContainer, FGoForward);
end;
...
begin
  Result := inherited IsEnabled and
    (ActiveTable.Options.ZoomFactor < dxSpreadSheetMaximumZoomFactor);
end;
...
begin
  Result := inherited IsEnabled and
    (ActiveTable.Options.ZoomFactor > dxSpreadSheetMinimumZoomFactor);
end;
...
begin
  History.BeginAction(TdxSpreadSheetHistoryChangeRowColumnItemAction);
  try
    if (ActiveSelection.FocusedRow <> 0) or (ActiveSelection.FocusedColumn <> 0)
    then
      ActiveTable.FreezePanes(ActiveSelection.FocusedRow - 1,
        ActiveSelection.FocusedColumn - 1)
    else
      ActiveTable.FreezePanes(cxHalfCoordinate(ActiveTable.TopRow +
        ActiveTable.BottomRow), cxHalfCoordinate(ActiveTable.LeftColumn +
        ActiveTable.RightColumn))
  finally
    History.EndAction;
  end;
end;
...
begin
  Result := inherited IsEnabled and ((ActiveTable.FrozenColumn <> -1) or
    (ActiveTable.FrozenRow <> -1));
end;
...
begin
  ShowHyperlinkEditorDialog(ActiveTable,
    ActiveTable.Hyperlinks.FindItem(ActiveSelection.FocusedRow,
    ActiveSelection.FocusedColumn));
end;
...
begin
  Result := inherited IsEnabled and
    ActiveTable.OptionsProtection.ActualAllowEditHyperlinks;
end;
...
function TdxSpreadSheetInsertPicture.AddPictureContainer(AWidth,
...
procedure TdxSpreadSheetInsertPicture.DoInsertPictureFromFile
...
begin
  ...
  try
    History.AddCommand
      (TdxSpreadSheetHistoryChangePrintingOptionsCommand.Create);
...
function TdxSpreadSheetCustomPrintingAction.GetOptionsPrint
...
begin
  ...
  begin
    if MessageDlg(cxGetResourceString(@sdxSetSingleCellAsPrintAreaConfirmation),
...
begin
  Result := TryAddPageBreak(OptionsPrint.Pagination.ColumnPageBreaks,
    ActiveSelection.Area.Left);
  Result := TryAddPageBreak(OptionsPrint.Pagination.RowPageBreaks,
    ActiveSelection.Area.Top) or Result;
end;
...
begin
  Result := (OptionsPrint.Pagination.ColumnPageBreaks.Remove
    (ActiveSelection.Area.Left) >= 0);
  Result := (OptionsPrint.Pagination.RowPageBreaks.Remove
    (ActiveSelection.Area.Top) >= 0) or Result;
end;
...
constructor TdxSpreadSheetSetLandscapePageOrientation.Create
  (AOwner: TComponent);
begin
  inherited;
  AutoCheck := True;
...
function TdxSpreadSheetCustomGalleryAction.FindGalleryGroup(const AName: string)
...
function TdxSpreadSheetCustomGalleryAction.FindGalleryGroupItem
  (AGroup: TdxCustomGalleryGroup; const AActionIndex: Variant)
...
procedure TdxSpreadSheetCustomGalleryAction.Notification(AComponent: TComponent;
...
procedure TdxSpreadSheetCustomGalleryAction.PopulateGalleryInfo
...
begin
  ...
  if (Control <> nil) and (Control.ActiveSheetAsTable <> nil) then
    Result := Max(Control.ActiveSheetAsTable.OptionsPrint.Page.Paper.
      SizeID, Result);
end;

function TdxSpreadSheetPaperSizeGallery.GetPaperDescription(const AHeight,
...
begin
  ...
  Result := Format('%f %s x %f %s', [AUnitsConverter.FromLoMetric(AHeight),
    AUnitsName, AUnitsConverter.FromLoMetric(AWidth), AUnitsName]);
end;
...
procedure TdxSpreadSheetPaperSizeGallery.PopulateGalleryInfo
  (AInfo: IdxActionGalleryInfo);
...
procedure TdxSpreadSheetPageMarginsGallery.UpdateGalleryContentResourceStrings;
  ...
  begin
    ...
    begin
      ...
      AItem.Description := GetPredefinedMarginsSetDescription
        (APredefinedMarginsSet);
    end;
  end;
...
begin
  if FGalleryGroup <> nil then
  begin
    for APredefinedMarginsSet := Low(TPredefinedMarginsSet)
      to High(TPredefinedMarginsSet) do
...
function TdxSpreadSheetPageMarginsGallery.GetValue: Variant;
  ...
  function AreSameMargins(AMargins
    : TdxSpreadSheetTableViewOptionsPrintPageMargins;
  const AMarginsSet: TMarginsSet): Boolean;
  begin
    Result := (AMargins.Top = AMarginsSet[mpTop]) and
      (AMargins.Bottom = AMarginsSet[mpBottom]) and
      (AMargins.Left = AMarginsSet[mpLeft]) and
      (AMargins.Right = AMarginsSet[mpRight]) and
      (AMargins.Header = AMarginsSet[mpHeader]) and
...
procedure TdxSpreadSheetPageMarginsGallery.PopulateGalleryInfo
  (AInfo: IdxActionGalleryInfo);
begin
  inherited PopulateGalleryInfo(AInfo);

  AInfo.Add(pmsNormal, '', GetPredefinedMarginsSetCaption(pmsNormal),
    GetPredefinedMarginsSetDescription(pmsNormal),
  ...
  AInfo.Add(pmsNarrow, '', GetPredefinedMarginsSetCaption(pmsNarrow),
    GetPredefinedMarginsSetDescription(pmsNarrow),
...
begin
  ...
  Result := Format('%s:'#9'%2.2f %s    %s:'#9'%2.2f %s',
    [GetMarginsPartCaption(mpTop), AMarginsSet[mpTop], AUnitsName,
    GetMarginsPartCaption(mpBottom), AMarginsSet[mpBottom], AUnitsName]) +
    #13#10 + Format('%s:'#9'%2.2f %s    %s:'#9'%2.2f %s',
    [GetMarginsPartCaption(mpLeft), AMarginsSet[mpLeft], AUnitsName,
    GetMarginsPartCaption(mpRight), AMarginsSet[mpRight], AUnitsName]) + #13#10
    + Format('%s:'#9'%2.2f %s    %s:'#9'%2.2f %s',
    [GetMarginsPartCaption(mpHeader), AMarginsSet[mpHeader], AUnitsName,
    GetMarginsPartCaption(mpFooter), AMarginsSet[mpFooter], AUnitsName]);
end;
...
procedure TdxSpreadSheetAutoSumGallery.PopulateGalleryInfo
  (AInfo: IdxActionGalleryInfo);
...
begin
  ...
  for AFormula := Low(TFormula) to High(TFormula) do
    AInfo.Add(AFormula, '', GetFormulaCaption(AFormula),
      GetFormulaDescription(AFormula), GetImageFileName(AFormula));
end;

function TdxSpreadSheetAutoSumGallery.GetFormulaCaption(const AFormula
  : TFormula): string;
begin
  case AFormula of
    fSum:
...
function TdxSpreadSheetAutoSumGallery.GetFormulaDescription(const AFormula
  : TFormula): string;
begin
  case AFormula of
    fSum:
...
constructor TdxSpreadSheetCustomFormulasGalleryAction.Create
  (AOwner: TComponent);
begin
  inherited;
  FDefaultCaptionResString := dxSpreadSheetFunctionTypeNameAsResString
    (GetTypeID);
end;

function TdxSpreadSheetCustomFormulasGalleryAction.GetDefaultCaption: string;
begin
  Result := StringReplace(cxGetResourceString(FDefaultCaptionResString), '&',
    '&&', [rfReplaceAll, rfIgnoreCase]);
end;

procedure TdxSpreadSheetCustomFormulasGalleryAction.
  UpdateGalleryContentResourceStrings;

  procedure UpdateGalleryGroupItemResourceStrings(AFunctionInfo
    : TdxSpreadSheetFunctionInfo);
  var
    AItem: TdxCustomGalleryItem;
  begin
    AItem := FindGalleryGroupItem(FGalleryGroup,
      LoadResString(AFunctionInfo.NamePtr));
    if AItem <> nil then
    begin
...
begin
  if FGalleryGroup <> nil then
    ...
    begin
      ...
      if (AFunctionInfo.TypeID = GetTypeID) and Assigned(AFunctionInfo.Proc)
      then
...
procedure TdxSpreadSheetCustomFormulasGalleryAction.SetValue
...
procedure TdxSpreadSheetCustomFormulasGalleryAction.PopulateGalleryInfo
  (AInfo: IdxActionGalleryInfo);
var
  AFunctionInfo: TdxSpreadSheetFunctionInfo;
  I: Integer;
...
function TdxSpreadSheetFinancialFormulasGallery.GetTypeID
...
function TdxSpreadSheetLogicalFormulasGallery.GetTypeID
  : TdxSpreadSheetFunctionType;
begin
  Result := ftLogical;
end;
...
function TdxSpreadSheetTextFormulasGallery.GetTypeID
  : TdxSpreadSheetFunctionType;
begin
  Result := ftText;
end;
...
function TdxSpreadSheetDateAndTimeFormulasGallery.GetTypeID
  : TdxSpreadSheetFunctionType;
begin
  Result := ftDateTime;
end;
...
constructor TdxSpreadSheetLookupAndReferenceFormulasGallery.Create
  (AOwner: TComponent);
begin
  inherited;
...
function TdxSpreadSheetLookupAndReferenceFormulasGallery.GetTypeID
  : TdxSpreadSheetFunctionType;
begin
...
function TdxSpreadSheetMathAndTrigFormulasGallery.GetTypeID
  : TdxSpreadSheetFunctionType;
begin
  Result := ftMath;
end;
...
function TdxSpreadSheetStatisticalFormulasGallery.GetTypeID
  : TdxSpreadSheetFunctionType;
begin
...
function TdxSpreadSheetInformationFormulasGallery.GetTypeID
  : TdxSpreadSheetFunctionType;
begin
...
constructor TdxSpreadSheetCompatibilityFormulasGallery.Create
  (AOwner: TComponent);
begin
  inherited;
...
function TdxSpreadSheetCompatibilityFormulasGallery.GetTypeID
  : TdxSpreadSheetFunctionType;
begin
...
procedure TdxSpreadSheetPageOrientationGallery.
  UpdateGalleryContentResourceStrings;
var
  AItem: TdxCustomGalleryItem;
begin
...
procedure TdxSpreadSheetPageOrientationGallery.PopulateGalleryInfo
  (AInfo: IdxActionGalleryInfo);
begin
  inherited PopulateGalleryInfo(AInfo);

  AInfo.Add(oppoPortrait, '', GetPageOrientationCaption(oppoPortrait), '',
    'Pages\PageOrientationPortrait.png');
  AInfo.Add(oppoLandscape, '', GetPageOrientationCaption(oppoLandscape), '',
    'Pages\PageOrientationLandscape.png');
end;
...
begin
  Result := (ActiveTable <> nil) and
    not(ActiveTable.IsEditing or IsActiveTableProtected);
end;

{ TdxSpreadSheetCreateDefinedNamesFromSelection }

constructor TdxSpreadSheetCreateDefinedNamesFromSelection.Create
  (AOwner: TComponent);
begin
  inherited;
  FDefaultCaptionResString :=
  ...
  FDefaultImageNameInIconLibrary :=
    'SpreadSheet\DefinedNameCreateFromSelection.png';
end;
...
procedure TdxSpreadSheetUseDefinedNameInFormula.DoPopulateGallery
  (AGroup: TdxCustomGalleryGroup);
var
...
begin
  Result := (FGalleryGroup <> nil) and (FGalleryGroup.ItemCount > 0) and
    inherited IsEnabled and not IsActiveTableProtected;
end;
...
procedure TdxSpreadSheetUseDefinedNameInFormula.ActiveSheetChanged
  (Sender: TdxCustomSpreadSheet);
begin
  FNeedUpdateGallery := True;
end;

procedure TdxSpreadSheetUseDefinedNameInFormula.DataChanged
  (Sender: TdxCustomSpreadSheet);
begin
  // do nothing
end;

procedure TdxSpreadSheetUseDefinedNameInFormula.DefinedNamesChanged
  (Sender: TdxCustomSpreadSheet);
begin
  FNeedUpdateGallery := True;
end;
