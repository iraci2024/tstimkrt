...
uses
  Classes, Types, Variants, StdCtrls, Graphics, dxGallery, dxActions,
  dxSpreadSheetActions, dxSpreadSheetCore,
...
type
  ...
  TdxSpreadSheetShowConditionalFormattingRulesManager = class
  ...
  TdxSpreadSheetCustomConditionalFormattingGalleryAction = class
  ...
  TdxSpreadSheetConditionalFormattingTopBottomRulesGallery = class
    (TdxSpreadSheetCustomConditionalFormattingGalleryAction)
  protected type
    TRule = (rTop10Items, rTop10Percents, rBottom10Items, rBottom10Percents,
      rAboveAverage, rBelowAverage);
  strict private
  ...
  protected
    ...
    procedure AddTopBottomRule(ADirection
      ...
      virtual;
    procedure AddAboveOrBelowAverageRule(AComparisonOperator
  ...
  TdxSpreadSheetConditionalFormattingColorScalesGallery = class
    (TdxSpreadSheetCustomConditionalFormattingGalleryAction)
  protected type
    TColorScale = array [0 .. 2] of TColor;
    TPredefinedColorScale = (pcsGreenYellowRed, pcsRedYellowGreen,
      pcsGreenWhiteRed, pcsRedWhiteGreen, pcsBlueWhiteRed, pcsRedWhiteBlue,
      pcsWhiteRed, pcsRedWhite, pcsGreenWhite, pcsWhiteGreen, pcsGreenYellow,
      pcsYellowGreen);
  protected const
    CPredefinedColorScales: array [TPredefinedColorScale] of TColorScale =
      (($6B69F8, $84EBFF, $7BBE63), ($7BBE63, $84EBFF, $6B69F8),
      ($6B69F8, $FFFFFF, $7BBE63), ($7BBE63, $FFFFFF, $6B69F8),
      ($6B69F8, $FFFFFF, $C68A5A), ($C68A5A, $FFFFFF, $6B69F8),
      ($6B69F8, clDefault, $FFFFFF), ($FFFFFF, clDefault, $6B69F8),
      ($FFFFFF, clDefault, $7BBE63), ($7BBE63, clDefault, $FFFFFF),
      ($84EBFF, clDefault, $7BBE63), ($7BBE63, clDefault, $84EBFF));
  protected
    // IdxActionGalleryClient
    procedure SetValue(const AValue: Variant); override;
    procedure PopulateGalleryInfo(AInfo: IdxActionGalleryInfo); override;
  ...
  TdxSpreadSheetConditionalFormattingDataBarsGallery = class
    (TdxSpreadSheetCustomConditionalFormattingGalleryAction)
  protected type
    TDataBar = (dbGradientBlue, dbGradientGreen, dbGradientRed,
      dbGradientOrange, dbGradientLightBlue, dbGradientPurple, dbSolidBlue,
      dbSolidGreen, dbSolidRed, dbSolidOrange, dbSolidLightBlue, dbSolidPurple);
  ...
  TdxSpreadSheetConditionalFormattingIconSetsGallery = class
    (TdxSpreadSheetCustomConditionalFormattingGalleryAction)
  protected type
  ...
  TdxSpreadSheetConditionalFormattingMoreRules = class
    (TdxSpreadSheetCustomFormatCellsAction)
  protected
    procedure DoExecute; override;
  public
  ...
  TdxSpreadSheetConditionalFormattingNewRule = class
    (TdxSpreadSheetConditionalFormattingMoreRules)
  public
    constructor Create(AOwner: TComponent); override;
  end;
  ...
  TdxSpreadSheetConditionalFormattingClearRulesFromSelectedCells = class
    (TdxSpreadSheetCustomFormatCellsAction)
  protected
    procedure DoExecute; override;
  public
  ...
  TdxSpreadSheetConditionalFormattingClearRulesFromEntireSheet = class
    (TdxSpreadSheetCustomFormatCellsAction)
  protected
    procedure DoExecute; override;
  public
...
uses
  Generics.Collections, dxCore, cxGeometry,
  dxSpreadSheetConditionalFormattingRulesManagerDialog,
  dxSpreadSheetActionsStrs, dxSpreadSheetConditionalFormattingIconSet,
  dxSpreadSheetConditionalFormattingRuleEditDialog,
  dxSpreadSheetCoreHelpers, dxSpreadSheetUtils;

type
  TdxSpreadSheetTableViewAccess = class(TdxSpreadSheetTableView);
  TdxSpreadSheetTableViewCustomCellsModificationHelperAccess = class
...
function TdxSpreadSheetCustomConditionalFormattingGalleryAction.
  GetValue: Variant;
begin
  Result := Null;
end;
...
begin
  Result := inherited IsEnabled and Control.OptionsBehavior.Editing and
    not ActiveTable.IsEditing and
    (not ActiveTable.OptionsProtection.&Protected or
    (TdxSpreadSheetTableViewAccess(ActiveTable).GetLockedStateOfCellsInArea
    (ActiveSelection.Area) = cbUnchecked)) and
    ActiveTable.OptionsProtection.ActualAllowFormatCells;
end;

{ TdxSpreadSheetConditionalFormattingTopBottomRulesGallery }

constructor TdxSpreadSheetConditionalFormattingTopBottomRulesGallery.Create
  (AOwner: TComponent);
begin
  inherited;
  FDefaultCaptionResString :=
...
procedure TdxSpreadSheetConditionalFormattingTopBottomRulesGallery.Assign
  (Source: TPersistent);
begin
  inherited;
  if Source is TdxSpreadSheetConditionalFormattingTopBottomRulesGallery then
    FGalleryGroup := TdxSpreadSheetConditionalFormattingTopBottomRulesGallery
      (Source).FGalleryGroup;
end;

procedure TdxSpreadSheetConditionalFormattingTopBottomRulesGallery.
...
procedure TdxSpreadSheetConditionalFormattingTopBottomRulesGallery.Notification
...
procedure TdxSpreadSheetConditionalFormattingTopBottomRulesGallery.SetValue
...
procedure TdxSpreadSheetConditionalFormattingTopBottomRulesGallery.
  PopulateGalleryInfo(AInfo: IdxActionGalleryInfo);
...
begin
  ActiveTable.History.BeginAction
    (TdxSpreadSheetHistoryChangeConditionalFormattingAction);
  try
    RemoveRulesFromSelectedArea(ActiveTable,
      TdxSpreadSheetConditionalFormattingRuleAboveOrBelowAverage);
    RemoveRulesFromSelectedArea(ActiveTable,
      TdxSpreadSheetConditionalFormattingRuleTopBottomValues);
    ARule := TdxSpreadSheetConditionalFormattingRuleTopBottomValues.Create
      (ActiveTable.ConditionalFormatting, ActiveSelection.Area);
    ARule.BeginUpdate;
    try
...
procedure TdxSpreadSheetConditionalFormattingTopBottomRulesGallery.
  AddAboveOrBelowAverageRule(AComparisonOperator
  : TdxSpreadSheetConditionalFormattingRuleAboveOrBelowAverageComparisonOperator);
var
...
begin
  ...
  try
    ...
    RemoveRulesFromSelectedArea(ActiveTable,
      TdxSpreadSheetConditionalFormattingRuleTopBottomValues);
    ARule := TdxSpreadSheetConditionalFormattingRuleAboveOrBelowAverage.Create
      (ActiveTable.ConditionalFormatting, ActiveSelection.Area);
    ARule.BeginUpdate;
    try
...
function TdxSpreadSheetConditionalFormattingTopBottomRulesGallery.GetRuleCaption
  (const ARule: TRule): string;
begin
  case ARule of
    rTop10Items:
...
procedure TdxSpreadSheetConditionalFormattingTopBottomRulesGallery.
  ReadGalleryGroup(Reader: TReader);
begin
  FGalleryGroup := FindGalleryGroup(Reader.ReadIdent);
end;

procedure TdxSpreadSheetConditionalFormattingTopBottomRulesGallery.
  WriteGalleryGroup(Writer: TWriter);
begin
...
constructor TdxSpreadSheetConditionalFormattingColorScalesGallery.Create
  (AOwner: TComponent);
begin
  inherited;
  FDefaultCaptionResString :=
...
procedure TdxSpreadSheetConditionalFormattingColorScalesGallery.SetValue
  (const AValue: Variant);
begin
  if TPredefinedColorScale(AValue) in [pcsGreenYellowRed, pcsRedYellowGreen,
    pcsGreenWhiteRed, pcsRedWhiteGreen, pcsBlueWhiteRed, pcsRedWhiteBlue] then
    AddThreeColorScaleRule(CPredefinedColorScales
      [TPredefinedColorScale(AValue)])
  else
    AddTwoColorScaleRule(CPredefinedColorScales[TPredefinedColorScale(AValue)]);
end;

procedure TdxSpreadSheetConditionalFormattingColorScalesGallery.
  PopulateGalleryInfo(AInfo: IdxActionGalleryInfo);

  function GetImageFileName(const APredefinedColorScale
    : TPredefinedColorScale): string;
  begin
...
begin
  for AColorScale := Low(TPredefinedColorScale)
    to High(TPredefinedColorScale) do
    AInfo.Add(AColorScale, '', '', '', GetImageFileName(AColorScale));
end;

procedure TdxSpreadSheetConditionalFormattingColorScalesGallery.
  AddThreeColorScaleRule(const AColorScale: TColorScale);
var
...
begin
  ...
  try
    ...
    ARule := TdxSpreadSheetConditionalFormattingRuleThreeColorScale.Create
      (ActiveTable.ConditionalFormatting, ActiveSelection.Area);
    ARule.BeginUpdate;
    try
...
procedure TdxSpreadSheetConditionalFormattingColorScalesGallery.
  AddTwoColorScaleRule(const AColorScale: TColorScale);
var
...
begin
  ...
  try
    RemoveRulesFromSelectedArea(ActiveTable,
      TdxSpreadSheetConditionalFormattingRuleCustomColorScale);
    ARule := TdxSpreadSheetConditionalFormattingRuleTwoColorScale.Create
      (ActiveTable.ConditionalFormatting, ActiveSelection.Area);
    ARule.BeginUpdate;
    try
      ARule.MinValue.Color := AColorScale[0];
...
constructor TdxSpreadSheetConditionalFormattingDataBarsGallery.Create
  (AOwner: TComponent);
begin
  inherited;
  FDefaultCaptionResString :=
...
procedure TdxSpreadSheetConditionalFormattingDataBarsGallery.Assign
  (Source: TPersistent);
begin
  inherited;
  if Source is TdxSpreadSheetConditionalFormattingDataBarsGallery then
  begin
    FGalleryGroupGradientFill :=
      TdxSpreadSheetConditionalFormattingDataBarsGallery(Source)
      .FGalleryGroupGradientFill;
    FGalleryGroupSolidFill := TdxSpreadSheetConditionalFormattingDataBarsGallery
      (Source).FGalleryGroupSolidFill;
  end;
end;

procedure TdxSpreadSheetConditionalFormattingDataBarsGallery.DefineProperties
  (Filer: TFiler);
begin
  inherited;
  Filer.DefineProperty('GalleryGroupGradientFill', ReadGalleryGroupGradientFill,
    WriteGalleryGroupGradientFill, FGalleryGroupGradientFill <> nil);
  Filer.DefineProperty('GalleryGroupSolidFill', ReadGalleryGroupSolidFill,
    WriteGalleryGroupSolidFill, FGalleryGroupSolidFill <> nil);
end;

procedure TdxSpreadSheetConditionalFormattingDataBarsGallery.Notification
  (AComponent: TComponent; Operation: TOperation);
begin
  inherited;
...
procedure TdxSpreadSheetConditionalFormattingDataBarsGallery.
  UpdateGalleryContentResourceStrings;
begin
...
procedure TdxSpreadSheetConditionalFormattingDataBarsGallery.SetValue
  (const AValue: Variant);
var
  ADataBar: TDataBar;
begin
...
procedure TdxSpreadSheetConditionalFormattingDataBarsGallery.PopulateGalleryInfo
  ...
  begin
    if ADataBar in [dbGradientBlue, dbGradientGreen, dbGradientRed,
      dbGradientOrange, dbGradientLightBlue, dbGradientPurple] then
...
begin
  ...
  for ADataBar := Low(TDataBar) to High(TDataBar) do
    AInfo.Add(ADataBar, GetGroupCaption(ADataBar), '', '',
      GetImageFileName(ADataBar));
end;

procedure TdxSpreadSheetConditionalFormattingDataBarsGallery.AddDataBarRule
  (AColor: TColor; AIsSolidFill: Boolean);
var
...
begin
  ...
  try
    ...
    ARule := TdxSpreadSheetConditionalFormattingRuleDataBar.Create
      (ActiveTable.ConditionalFormatting, ActiveSelection.Area);
    ARule.BeginUpdate;
    try
...
function TdxSpreadSheetConditionalFormattingDataBarsGallery.
  GetDataBarGroupCaption(const ADataBarGroup: TDataBarGroup): string;
begin
...
procedure TdxSpreadSheetConditionalFormattingDataBarsGallery.
  ReadGalleryGroupGradientFill(Reader: TReader);
begin
  FGalleryGroupGradientFill := FindGalleryGroup(Reader.ReadIdent);
end;

procedure TdxSpreadSheetConditionalFormattingDataBarsGallery.
  ReadGalleryGroupSolidFill(Reader: TReader);
begin
  FGalleryGroupSolidFill := FindGalleryGroup(Reader.ReadIdent);
end;

procedure TdxSpreadSheetConditionalFormattingDataBarsGallery.
  WriteGalleryGroupGradientFill(Writer: TWriter);
begin
  Writer.WriteIdent(FGalleryGroupGradientFill.Name);
end;

procedure TdxSpreadSheetConditionalFormattingDataBarsGallery.
  WriteGalleryGroupSolidFill(Writer: TWriter);
begin
...
constructor TdxSpreadSheetConditionalFormattingIconSetsGallery.Create
  (AOwner: TComponent);
begin
  inherited;
  FDefaultCaptionResString :=
...
procedure TdxSpreadSheetConditionalFormattingIconSetsGallery.Assign
  (Source: TPersistent);
begin
  inherited;
  if Source is TdxSpreadSheetConditionalFormattingIconSetsGallery then
  begin
    FGalleryGroupDirectional :=
      TdxSpreadSheetConditionalFormattingIconSetsGallery(Source)
      .FGalleryGroupDirectional;
    FGalleryGroupIndicators :=
      TdxSpreadSheetConditionalFormattingIconSetsGallery(Source)
      .FGalleryGroupIndicators;
    FGalleryGroupRatings := TdxSpreadSheetConditionalFormattingIconSetsGallery
      (Source).FGalleryGroupRatings;
    FGalleryGroupShapes := TdxSpreadSheetConditionalFormattingIconSetsGallery
      (Source).FGalleryGroupShapes;
  end;
end;

procedure TdxSpreadSheetConditionalFormattingIconSetsGallery.DefineProperties
  (Filer: TFiler);
begin
  inherited;
  Filer.DefineProperty('GalleryGroupDirectional', ReadGalleryGroupDirectional,
    WriteGalleryGroupDirectional, FGalleryGroupDirectional <> nil);
  Filer.DefineProperty('GalleryGroupIndicators', ReadGalleryGroupIndicators,
    WriteGalleryGroupIndicators, FGalleryGroupIndicators <> nil);
  Filer.DefineProperty('GalleryGroupRatings', ReadGalleryGroupRatings,
    WriteGalleryGroupRatings, FGalleryGroupRatings <> nil);
  Filer.DefineProperty('GalleryGroupShapes', ReadGalleryGroupShapes,
    WriteGalleryGroupShapes, FGalleryGroupShapes <> nil);
end;

procedure TdxSpreadSheetConditionalFormattingIconSetsGallery.Notification
  (AComponent: TComponent; Operation: TOperation);
begin
  inherited;
  if Operation = opRemove then
...
procedure TdxSpreadSheetConditionalFormattingIconSetsGallery.
  UpdateGalleryContentResourceStrings;
begin
...
procedure TdxSpreadSheetConditionalFormattingIconSetsGallery.SetValue
  (const AValue: Variant);
begin
  AddIconSetRule(VarToStr(AValue));
end;

procedure TdxSpreadSheetConditionalFormattingIconSetsGallery.PopulateGalleryInfo
  (AInfo: IdxActionGalleryInfo);
...
procedure TdxSpreadSheetConditionalFormattingIconSetsGallery.AddIconSetRule
  (const APresetName: string);
var
...
begin
  ...
  try
    ...
    ARule := TdxSpreadSheetConditionalFormattingRuleIconSet.Create
      (ActiveTable.ConditionalFormatting, ActiveSelection.Area);
...
function TdxSpreadSheetConditionalFormattingIconSetsGallery.
  GetIconSetGroupCaption(const AIconSet: TIconSet): string;
begin
  case AIconSet of
    isDirectional:
      Result := cxGetResourceString
...
constructor TdxSpreadSheetConditionalFormattingMoreRules.Create
  (AOwner: TComponent);
begin
  inherited;
  FDefaultCaptionResString :=
...
constructor TdxSpreadSheetConditionalFormattingNewRule.Create
  (AOwner: TComponent);
begin
  inherited;
  FDefaultCaptionResString :=
  ...
  FDefaultImageNameInIconLibrary :=
    'Spreadsheet\NewConditionalFormattingRule.png';
end;

{ TdxSpreadSheetConditionalFormattingClearRulesFromSelectedCells }

constructor TdxSpreadSheetConditionalFormattingClearRulesFromSelectedCells.
...
procedure TdxSpreadSheetConditionalFormattingClearRulesFromSelectedCells.
  DoExecute;
var
  AArea: TRect;
...
begin
  ...
  try
    ...
    AHelper := TdxSpreadSheetTableViewCustomCellsModificationHelperAccess.Create
      (ActiveTable);
    try
...
constructor TdxSpreadSheetConditionalFormattingClearRulesFromEntireSheet.Create
  (AOwner: TComponent);
begin
  inherited;
  FDefaultCaptionResString :=
...
procedure TdxSpreadSheetConditionalFormattingClearRulesFromEntireSheet.
  DoExecute;
begin
