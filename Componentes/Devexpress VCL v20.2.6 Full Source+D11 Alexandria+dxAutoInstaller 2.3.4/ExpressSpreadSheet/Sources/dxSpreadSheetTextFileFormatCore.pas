...
uses
  Windows, SysUtils, Classes, dxHashUtils, dxSpreadSheetCore,
...
type
  ...
  public
    constructor Create(Stream: TStream; Encoding: TEncoding;
      WriteEncodingPreamble: Boolean = True); reintroduce;
  end;
  ...
  protected
    ...
    function CreateTableViewWriter(AView: TdxSpreadSheetTableView;
      const AArea: TRect): TdxSpreadSheetCustomFilerSubTask; virtual; abstract;
    ...
    procedure WriteTableView(AView: TdxSpreadSheetTableView;
  ...
  TdxSpreadSheetCustomTextFormatTableViewWriter = class
  ...
  protected
    ...
    procedure WriteCell(ARowIndex, AColumnIndex: Integer;
      ACell: TdxSpreadSheetCell); virtual; abstract;
  ...
  public
    ...
    property EnumBlankCellsInTheEndOfLine: Boolean
      read FEnumBlankCellsInTheEndOfLine;
...
constructor TdxSpreadSheetStreamWriter.Create(Stream: TStream;
  Encoding: TEncoding; WriteEncodingPreamble: Boolean);
var
  APosition: Int64;
begin
...
constructor TdxSpreadSheetCustomTextFormatWriter.Create
...
begin
  FStreamWriter := TdxSpreadSheetStreamWriter.Create(Stream, Encoding,
...
function TdxSpreadSheetCustomTextFormatWriter.CreateProgressHelper
...
begin
  WriteTableView(AView, Rect(0, 0, AView.Dimensions.Right,
    AView.Dimensions.Bottom));
end;
  ...
  try
    ...
    TdxSpreadSheetTableRowsAccess(View.Rows).ForEach(
      ...
      begin
        ...
        ProgressHelper.NextTask;
        Inc(ARowIndex);
      end, Area.Top, Area.Bottom);
  finally
    ProgressHelper.EndStage;
  end;
end;

procedure TdxSpreadSheetCustomTextFormatTableViewWriter.WriteRow
