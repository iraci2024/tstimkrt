...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Windows, Classes, Graphics, ClipBrd, Generics.Defaults,
  ...
  dxSpreadSheetClipboard, dxSpreadSheetContainers,
  dxSpreadSheetFormatXLSX, dxSpreadSheetFormatXLS, dxSpreadSheetFormatCSV,
  dxSpreadSheetFormatXMLSS,
...
type
  ...
  TdxSpreadSheetNativeClipboardFormatData = class
  ...
  protected
    ...
    procedure CopyContainer(AContainer: TdxSpreadSheetContainer);
      virtual; abstract;
    procedure MergeBordersForInsertedCells(AView: TdxSpreadSheetTableView;
      const AArea: TRect);
    procedure PasteCore(AView: TdxSpreadSheetTableView;
      const AActualDataArea: TRect;
      AOptions: TdxSpreadSheetClipboardPasteOptions); virtual; abstract;
    function GetClearCellsOptions(AOptions: TdxSpreadSheetClipboardPasteOptions)
      : TdxSpreadSheetTableViewClearCellsOptions; virtual;
    procedure ValidatePasteOptions(var AOptions
      : TdxSpreadSheetClipboardPasteOptions);
  public
  ...
  TdxSpreadSheetNativeClipboardFormatClass = class of
    TdxSpreadSheetNativeClipboardFormat;

  TdxSpreadSheetNativeClipboardFormat = class
    (TdxSpreadSheetCustomClipboardFormat)
  public
    class function GetInfoFromClipboard(out AViewGUID: string;
      out ACopyMode: TdxSpreadSheetClipboardCopyMode; out AArea: TRect)
      : Boolean; virtual;
  ...
  public
    procedure Initialize(ARowIndex, AColumnIndex: Integer;
  ...
  TdxSpreadSheetBinaryClipboardFormatData = class
    (TdxSpreadSheetNativeClipboardFormatData)
  strict private
  ...
  protected
    ...
    procedure RestoreArrayFormulas(AView: TdxSpreadSheetTableView;
      const AArea: TRect;
      AFormulasInfoList: TdxSpreadSheetFormulaAsTextInfoList);
    ...
    procedure RestoreCells(AView: TdxSpreadSheetTableView;
      ...
      AOptions: TdxSpreadSheetClipboardPasteOptions); virtual;
    procedure RestoreColumnWidths(AView: TdxSpreadSheetTableView;
      const AArea: TRect);
    procedure RestoreComments(AView: TdxSpreadSheetTableView;
      const AArea: TRect);
    procedure RestoreContainers(AView: TdxSpreadSheetTableView;
      const AArea: TRect);
    procedure RestoreHyperlinks(AView: TdxSpreadSheetTableView;
      const AArea: TRect);
    procedure StoreArrayFormulasInfo(AView: TdxSpreadSheetTableView;
      AArea: TRect);
    procedure StoreCells(AView: TdxSpreadSheetTableView; AArea: TRect);
    procedure StoreColumnWidths(AView: TdxSpreadSheetTableView;
      const AArea: TRect);
    procedure StoreComment(AWriter: TcxWriter;
      AComment: TdxSpreadSheetCommentContainer; const AAnchor: TPoint);
    procedure StoreComments(AView: TdxSpreadSheetTableView; AArea: TRect);
    procedure StoreHyperlinks(AView: TdxSpreadSheetTableView;
      const AArea: TRect);
  public
    constructor Create; override;
    destructor Destroy; override;
    //
    property ArrayFormulasInfo
      : TdxSpreadSheetBinaryClipboardFormatArrayFormulasInfo
      read FArrayFormulasInfo;
  ...
  TdxSpreadSheetBinaryClipboardFormatClass = class of
    TdxSpreadSheetBinaryClipboardFormat;

  TdxSpreadSheetBinaryClipboardFormat = class
    (TdxSpreadSheetNativeClipboardFormat)
  strict private
  const
  ...
  protected
    class procedure LoadChunk(AReader: TcxReader; AChunkID, AChunkSize: Integer;
      AData: TdxSpreadSheetBinaryClipboardFormatData);
    class procedure SaveChunk(AWriter: TcxWriter; AChunkID: Integer;
      AData: TdxSpreadSheetBinaryClipboardFormatData);
  public
    class function Build(const AArea: TRect;
      AContainer: TdxSpreadSheetContainer;
      AMode: TdxSpreadSheetClipboardCopyMode; AView: TdxSpreadSheetTableView)
      : IdxSpreadSheetClipboardData; override;
    class function GetFormatID: Word; override;

    class function LoadFromStream(AStream: TStream)
      : IdxSpreadSheetClipboardData; override;
    class procedure SaveToStream(AStream: TStream;
      AData: IdxSpreadSheetClipboardData); override;
  end;
  ...
  public
    ...
    class function GetFormatID: Word; override;
    class procedure SaveToStream(Stream: TStream;
      Data: IdxSpreadSheetClipboardData); override;
  end;

  { TdxSpreadSheetHTMLClipboardFormatData }

  TdxSpreadSheetHTMLClipboardFormatData = class
    (TdxSpreadSheetCustomClipboardData)
  strict private
    FStream: TStream;
  public
  ...
  TdxSpreadSheetHTMLClipboardFormatDataWriter = class
  ...
  public
    ...
    procedure WriteData(AView: TdxSpreadSheetTableView; const AArea: TRect);
      reintroduce;
  end;

  { TdxSpreadSheetImageClipboardFormat }

  TdxSpreadSheetImageClipboardFormat = class
    (TdxSpreadSheetCustomClipboardFormat)
  public
    class function Build(const AArea: TRect;
      AContainer: TdxSpreadSheetContainer;
    ...
    class function LoadFromStream(AStream: TStream)
      : IdxSpreadSheetClipboardData; override;
    class procedure SaveToClipboard
      (AData: IdxSpreadSheetClipboardData); override;
    class procedure SaveToStream(AStream: TStream;
      AData: IdxSpreadSheetClipboardData); override;
  end;
  ...
  TdxSpreadSheetImageClipboardFormatData = class
    (TdxSpreadSheetCustomClipboardData)
  strict private
  ...
  public
    ...
    class function LoadFromStream(AStream: TStream)
      : IdxSpreadSheetClipboardData; override;
    class function LoadFromString(const S: string)
      : IdxSpreadSheetClipboardData; virtual;
    class procedure SaveToClipboard
      (AData: IdxSpreadSheetClipboardData); override;
    class procedure SaveToStream(AStream: TStream;
      AData: IdxSpreadSheetClipboardData); override;
    class function SaveToString(AData: IdxSpreadSheetClipboardData)
      : string; virtual;
  end;

  { TdxSpreadSheetTextClipboardFormatData }

  TdxSpreadSheetTextClipboardFormatData = class
    (TdxSpreadSheetCustomClipboardData)
  strict private
    FText: string;
  ...
  TdxSpreadSheetTextClipboardFormatDataReader = class
  ...
  public
    constructor Create(AView: TdxSpreadSheetTableView; const S: string;
      const AArea: TRect);
    procedure Parse;
    //
  ...
  TdxSpreadSheetXMLSSClipboardData = class
    (TdxSpreadSheetNativeClipboardFormatData)
  strict private
  ...
  protected
    ...
    procedure CopyContainer(AContainer: TdxSpreadSheetContainer); override;
    function GetClearCellsOptions(AOptions: TdxSpreadSheetClipboardPasteOptions)
      : TdxSpreadSheetTableViewClearCellsOptions; override;
    procedure PasteCore(AView: TdxSpreadSheetTableView;
      const AActualDataArea: TRect;
      AOptions: TdxSpreadSheetClipboardPasteOptions); override;
  ...
  TdxSpreadSheetXMLSSClipboardFormat = class
    (TdxSpreadSheetNativeClipboardFormat)
  public
    class function Build(const AArea: TRect;
      AContainer: TdxSpreadSheetContainer;
  ...
  TdxSpreadSheetXMLSSClipboardFormatTableViewReader = class
    (TdxSpreadSheetXMLSSTableViewReader)
  protected
    procedure ReadProperties(ANode: TdxXMLNode); override;
  public
    constructor Create(AReader: TdxSpreadSheetXMLSSClipboardFormatReader;
      ANode: TdxXMLNode); reintroduce;
  end;
  ...
  strict private
    ...
    FView: TdxSpreadSheetTableView;
  protected
    function CanWriteFormula(AFormula: TdxSpreadSheetFormula): Boolean;
      override;
...
uses
  SysUtils, cxGeometry, cxGraphics, dxSpreadSheetGraphics, Math,
  dxSpreadSheetHyperlinks,
  dxSpreadSheetUtils, dxSpreadSheetFormatBinary, StrUtils, dxCore, dxHashUtils,
  dxSpreadSheetStrs, dxSmartImage,
  dxSpreadSheetStyles, dxSpreadSheetCoreStrs, dxSpreadSheetCoreFormulas,
  AnsiStrings;
...
begin
  AFocusedContainer := TdxSpreadSheetTableViewAccess(AView)
    .Controller.FocusedContainer;
  if AFocusedContainer <> nil then
  begin
    Result := TdxSpreadSheetContainerAccess(AFocusedContainer)
      .Calculator.CalculateBounds.TopLeft;
    Result := cxPointOffset(Result, ContainerOffset, ContainerOffset);
  end
  else if (AView.Selection.FocusedColumn > -1) and
    (AView.Selection.FocusedRow > -1) then
    Result := AView.CreateCell(AView.Selection.FocusedRow,
      AView.Selection.FocusedColumn).GetAbsoluteBounds.TopLeft
  else
    Result := cxNullPoint;
end;

procedure CheckDataAreaOrigin(AView: TdxSpreadSheetTableView;
  var ADataArea: TRect; const ADestPoint: TPoint);
var
  AColumn: Integer;
  ARow: Integer;
begin
...
procedure TdxSpreadSheetNativeClipboardFormatData.Paste
  (AView: TdxSpreadSheetTableView; const ADestPoint: TPoint;
  ...
  try
    ...
    begin
      ...
      if not(cpoSkipBlanks in AOptions) then
        TdxSpreadSheetTableViewAccess(AView).ClearCells(AActualOriginalArea,
          GetClearCellsOptions(AOptions));
    end;
...
begin
  AView.ForEachCell(AArea, procedure(ACell: TdxSpreadSheetCell)
    var
    ...
    begin
      for ASide := Low(ASide) to High(ASide) do
        ...
        begin
          ANeighborCell := AView.Cells[ACell.RowIndex + RowOffset[ASide],
            ACell.ColumnIndex + ColumnOffset[ASide]];
          if ANeighborCell <> nil then
            ACell.Style.Borders[ASide].Assign(ANeighborCell.Style.Borders
              [SideMap[ASide]]);
        end;
    end);
end;
...
function TdxSpreadSheetNativeClipboardFormatData.GetClearCellsOptions
  (AOptions: TdxSpreadSheetClipboardPasteOptions)
  : TdxSpreadSheetTableViewClearCellsOptions;
begin
  Result := [];
...
procedure TdxSpreadSheetNativeClipboardFormatData.ValidatePasteOptions
  (var AOptions: TdxSpreadSheetClipboardPasteOptions);
begin
...
class function TdxSpreadSheetNativeClipboardFormat.GetInfoFromClipboard
  (out AViewGUID: string; out ACopyMode: TdxSpreadSheetClipboardCopyMode;
...
class function TdxSpreadSheetNativeClipboardFormat.
  IsPasteOptionsSupported: Boolean;
begin
  Result := True;
end;
...
procedure TdxSpreadSheetBinaryClipboardFormatArrayFormulaInfo.Initialize
  (ARowIndex, AColumnIndex: Integer; const AAnchor: TPoint;
...
procedure TdxSpreadSheetBinaryClipboardFormatArrayFormulaInfo.ReadData
  (AReader: TcxReader);
var
  L: Integer;
begin
...
procedure TdxSpreadSheetBinaryClipboardFormatArrayFormulaInfo.WriteData
  (AWriter: TcxWriter);
var
  L: Integer;
begin
...
function TdxSpreadSheetBinaryClipboardFormatArrayFormulasInfo.GetItem
  (AIndex: Integer): TdxSpreadSheetBinaryClipboardFormatArrayFormulaInfo;
begin
  Result := TdxSpreadSheetBinaryClipboardFormatArrayFormulaInfo
...
procedure TdxSpreadSheetBinaryClipboardFormatArrayFormulasInfo.ReadData
  (AReader: TcxReader);
var
...
procedure TdxSpreadSheetBinaryClipboardFormatArrayFormulasInfo.WriteData
  (AWriter: TcxWriter);
var
  ASize: Integer;
  I: Integer;
...
begin
  ...
  FArrayFormulasInfo :=
    TdxSpreadSheetBinaryClipboardFormatArrayFormulasInfo.Create;
...
procedure TdxSpreadSheetBinaryClipboardFormatData.CopyCells
  (AView: TdxSpreadSheetTableView);
var
  I: Integer;
begin
...
procedure TdxSpreadSheetBinaryClipboardFormatData.CopyContainer
  (AContainer: TdxSpreadSheetContainer);
var
  AWriter: TcxWriter;
begin
  ...
  begin
    ...
    try
      StoreComment(AWriter, TdxSpreadSheetCommentContainer(AContainer),
        cxPoint(TdxSpreadSheetCommentContainer(AContainer).Cell.ColumnIndex,
  ...
  begin
    ...
    try
      AWriter.WriteAnsiString
        (dxStringToAnsiString(TdxSpreadSheetContainerAccess(AContainer)
        .ClassName));
      TdxSpreadSheetContainerAccess(AContainer).SaveToStream(AWriter);
      AWriter.WriteRect(TdxSpreadSheetContainerAccess(AContainer)
...
procedure TdxSpreadSheetBinaryClipboardFormatData.PasteCore
  (AView: TdxSpreadSheetTableView; const AActualDataArea: TRect;
AOptions: TdxSpreadSheetClipboardPasteOptions);
begin
  Cells.Position := 0;
  Comments.Position := 0;
  ...
  if (Containers.Size > 0) and AView.OptionsProtection.ActualAllowEditContainers
  then
    ...
    try
      ...
      try
        while Styles.Position < Styles.Size do
          AStyles.Add(AView.SpreadSheet.CellStyles.CreateStyleFromStream
            (AStylesReader));
      finally
        AStylesReader.Free;
      end;
...
procedure TdxSpreadSheetBinaryClipboardFormatData.RestoreColumnWidths
  (AView: TdxSpreadSheetTableView; const AArea: TRect);
var
  AIndex: Integer;
  ASize: Integer;
begin
  ...
  begin
    ...
    if TdxSpreadSheetTableItemsAccess(AView.Columns).GetItemSize(AIndex) <> ASize
    then
...
procedure TdxSpreadSheetBinaryClipboardFormatData.RestoreComments
  (AView: TdxSpreadSheetTableView; const AArea: TRect);
var
  ABounds: TRect;
...
begin
  ...
  try
    ...
    begin
      AView.Containers.FindCommentContainer
        (TdxSpreadSheetCellHelper.ReadRef(ACommentReader, AView, AArea.Top,
        AArea.Left)).Free;
      ...
      try
        ...
        try
          AComment.AnchorType := TdxSpreadSheetContainerAnchorType
            (ACommentReader.ReadWord);
          AComment.LoadFromStream(ACommentReader, ACommentReader.ReadWord,
            AArea.Top, AArea.Left);
          if AComment.Cell <> nil then
          begin
            ABounds := AComment.Calculator.CalculateBounds;
            ABounds := cxRectSetSize
...
procedure TdxSpreadSheetBinaryClipboardFormatData.RestoreContainers
  (AView: TdxSpreadSheetTableView; const AArea: TRect);
var
  AClass: TClass;
...
begin
  ...
  try
    ...
    begin
      AContainer := TdxSpreadSheetContainerAccess
        (AView.Containers.Add(TdxSpreadSheetContainerClass(AClass)));
      AContainer.BeginChanging;
      try
        AContainer.LoadFromStream(AContainersReader);
        AContainer.Calculator.UpdateAnchors
          (cxRectSetOrigin(AContainersReader.ReadRect,
          CalculateTargetOrigin(AView)));
...
procedure TdxSpreadSheetBinaryClipboardFormatData.RestoreHyperlinks
  (AView: TdxSpreadSheetTableView; const AArea: TRect);
var
...
procedure TdxSpreadSheetBinaryClipboardFormatData.StoreArrayFormulasInfo
  (AView: TdxSpreadSheetTableView; AArea: TRect);
begin
  TdxSpreadSheetTableViewAccess(AView).FormulaController.EnumArrayFormulas
    (AView, function(AFormula: TdxSpreadSheetCustomFormula): Boolean
    var
      AInfo: TdxSpreadSheetBinaryClipboardFormatArrayFormulaInfo;
      ARect: TRect;
    begin
      ...
      begin
        ...
        AInfo.Initialize(ARect.Top - AArea.Top, ARect.Left - AArea.Left,
          AFormula.ArrayFormulaArea.TopLeft, AFormula.AsText,
          dxSpreadSheetAreaSize(ARect));
...
procedure TdxSpreadSheetBinaryClipboardFormatData.StoreCells
  (AView: TdxSpreadSheetTableView; AArea: TRect);
var
...
begin
  AView.MergedCells.EnumCells(AArea, procedure(ACell: TdxSpreadSheetMergedCell)
    var
      R: TRect;
    begin
      if dxSpreadSheetIntersects(AArea, ACell.Area, R) and cxRectIsEqual(R,
        ACell.Area) then
      begin
...
procedure TdxSpreadSheetBinaryClipboardFormatData.StoreColumnWidths
  (AView: TdxSpreadSheetTableView; const AArea: TRect);
var
  I: Integer;
begin
  for I := AArea.Left to AArea.Right do
    WriteIntegerProc(ColumnWidths, TdxSpreadSheetTableItemsAccess(AView.Columns)
      .GetItemSize(I));
end;

procedure TdxSpreadSheetBinaryClipboardFormatData.StoreComment
  (AWriter: TcxWriter; AComment: TdxSpreadSheetCommentContainer;
const AAnchor: TPoint);
begin
  TdxSpreadSheetCellHelper.WriteRef(AWriter, AComment.Cell, AAnchor.Y,
    AAnchor.X);
  TdxSpreadSheetCommentContainerAccess(AComment).SaveToStream(AWriter,
    AAnchor.Y, AAnchor.X);
end;

procedure TdxSpreadSheetBinaryClipboardFormatData.StoreComments
  (AView: TdxSpreadSheetTableView; AArea: TRect);
var
...
begin
  ...
  try
    AView.Containers.EnumCommentContainers(AArea,
      ...
      begin
        StoreComment(ACommentsWriter,
          TdxSpreadSheetCommentContainer(AContainer), AArea.TopLeft);
        Result := True;
      end);
  finally
...
procedure TdxSpreadSheetBinaryClipboardFormatData.StoreHyperlinks
  (AView: TdxSpreadSheetTableView; const AArea: TRect);
var
  AColumn: Integer;
  AHyperlink: TdxSpreadSheetHyperlinkAccess;
...
begin
  ...
  try
    for ARow := AArea.Top to AArea.Bottom do
      ...
      begin
        AHyperlink := TdxSpreadSheetHyperlinkAccess
          (AView.HyperLinks.FindItem(ARow, AColumn));
...
class function TdxSpreadSheetBinaryClipboardFormat.Build(const AArea: TRect;
AContainer: TdxSpreadSheetContainer; AMode: TdxSpreadSheetClipboardCopyMode;
AView: TdxSpreadSheetTableView): IdxSpreadSheetClipboardData;
var
  AData: TdxSpreadSheetBinaryClipboardFormatData;
begin
...
class function TdxSpreadSheetBinaryClipboardFormat.LoadFromStream
  (AStream: TStream): IdxSpreadSheetClipboardData;
var
  AChunkID: Cardinal;
  AChunkSize: Cardinal;
  APosition: Int64;
...
class procedure TdxSpreadSheetBinaryClipboardFormat.SaveToStream
  (AStream: TStream; AData: IdxSpreadSheetClipboardData);
const
  Chunks: array [0 .. 7] of Cardinal = (CHUNK_INFO, CHUNK_CELLS,
    CHUNK_MERGED_CELLS, CHUNK_COLUMN_WIDTHS, CHUNK_ARRAY_FORMULAS,
    CHUNK_CONTAINERS, CHUNK_COMMENTS, CHUNK_HYPERLINKS);
var
  AChunkID: Cardinal;
  AMarker: Int64;
  ARawData: TdxSpreadSheetBinaryClipboardFormatData;
...
class procedure TdxSpreadSheetBinaryClipboardFormat.LoadChunk
  (AReader: TcxReader; AChunkID, AChunkSize: Integer;
AData: TdxSpreadSheetBinaryClipboardFormatData);
var
  I: Integer;
begin
...
class procedure TdxSpreadSheetBinaryClipboardFormat.SaveChunk
  (AWriter: TcxWriter; AChunkID: Integer;
AData: TdxSpreadSheetBinaryClipboardFormatData);
var
  I: Integer;
begin
...
class function TdxSpreadSheetHTMLClipboardFormat.Build(const AArea: TRect;
AContainer: TdxSpreadSheetContainer; AMode: TdxSpreadSheetClipboardCopyMode;
AView: TdxSpreadSheetTableView): IdxSpreadSheetClipboardData;
var
...
begin
  ...
  begin
    ...
    with TdxSpreadSheetHTMLClipboardFormatDataWriter.Create(AView.SpreadSheet,
      AData.Stream) do
      try
...
class procedure TdxSpreadSheetHTMLClipboardFormat.SaveToStream(Stream: TStream;
Data: IdxSpreadSheetClipboardData);
const
  OffsetTemplate = '0000000000';
  HeaderTemplate: AnsiString = 'Version:0.9' + #13#10 + 'StartHTML:%0:s' +
    #13#10 + 'EndHTML:%1:s' + #13#10 + 'StartFragment:%0:s' + #13#10 +
    'EndFragment:%1:s' + #13#10#13#10;

  function BuildHeader(const AValue1, AValue2: AnsiString): AnsiString;
    overload;
  begin
  ...
  begin
    ...
    Result := BuildHeader(AnsiString(FormatFloat(OffsetTemplate, AOffset)),
...
procedure TdxSpreadSheetHTMLClipboardFormatDataWriter.AfterConstruction;
begin
  inherited;
  FUseInlineStyles := True;
end;

procedure TdxSpreadSheetHTMLClipboardFormatDataWriter.WriteData
  (AView: TdxSpreadSheetTableView; const AArea: TRect);
begin
  FView := AView;
  FArea := AArea;
...
class function TdxSpreadSheetImageClipboardFormat.Build(const AArea: TRect;
AContainer: TdxSpreadSheetContainer; AMode: TdxSpreadSheetClipboardCopyMode;
AView: TdxSpreadSheetTableView): IdxSpreadSheetClipboardData;
var
  ABitmap: TcxBitmap32;
...
begin
  Result := nil;
  if (AContainer <> nil) and not(AContainer is TdxSpreadSheetCommentContainer)
  then
  begin
    if TdxSpreadSheetTableViewAccess(AView).ViewInfo.Containers.Find(AContainer,
      AViewInfo) then
    begin
...
class function TdxSpreadSheetImageClipboardFormat.LoadFromClipboard
...
class function TdxSpreadSheetImageClipboardFormat.LoadFromStream
  (AStream: TStream): IdxSpreadSheetClipboardData;
begin
  Result := TdxSpreadSheetImageClipboardFormatData.Create(AStream);
end;

class procedure TdxSpreadSheetImageClipboardFormat.SaveToClipboard
  (AData: IdxSpreadSheetClipboardData);
var
  AFormat: Word;
  APalette: HPALETTE;
  AStream: THandle;
begin
  TdxSpreadSheetImageClipboardFormatData(AData).Image.SaveToClipboardFormat
    (AFormat, AStream, APalette);
  Clipboard.SetAsHandle(AFormat, AStream);
end;

class procedure TdxSpreadSheetImageClipboardFormat.SaveToStream
  (AStream: TStream; AData: IdxSpreadSheetClipboardData);
begin
  TdxSpreadSheetImageClipboardFormatData(AData).Image.SaveToStreamByCodec
    (AStream, dxImagePng);
end;
...
procedure TdxSpreadSheetImageClipboardFormatData.Paste
  (AView: TdxSpreadSheetTableView; const ADestPoint: TPoint;
AOptions: TdxSpreadSheetClipboardPasteOptions);
var
  ...
  begin
    ...
    try
      ...
      TdxSpreadSheetContainerAccess(AContainer).Calculator.UpdateAnchors
        (cxRectBounds(CalculateTargetOrigin(AView),
        AContainer.Picture.Image.Width, AContainer.Picture.Image.Height));
      AContainer.Focused := True;
    finally
      AContainer.EndChanging;
    end;
...
class function TdxSpreadSheetTextClipboardFormat.Build(const AArea: TRect;
AContainer: TdxSpreadSheetContainer; AMode: TdxSpreadSheetClipboardCopyMode;
AView: TdxSpreadSheetTableView): IdxSpreadSheetClipboardData;
var
...
class function TdxSpreadSheetTextClipboardFormat.LoadFromClipboard
  : IdxSpreadSheetClipboardData;
var
  AData: HGLOBAL;
begin
    ...
    if AData <> 0 then
      try
        Result := LoadFromString
          (dxAnsiStringToString(PAnsiChar(GlobalLock(AData))));
      finally
        GlobalUnlock(AData);
      end;
  end;
...
class function TdxSpreadSheetTextClipboardFormat.LoadFromStream
  (AStream: TStream): IdxSpreadSheetClipboardData;
var
  ALength: Integer;
  S: UnicodeString;
...
class function TdxSpreadSheetTextClipboardFormat.LoadFromString(const S: string)
  : IdxSpreadSheetClipboardData;
var
  AData: TdxSpreadSheetTextClipboardFormatData;
begin
...
class procedure TdxSpreadSheetTextClipboardFormat.SaveToClipboard
  (AData: IdxSpreadSheetClipboardData);
var
  S: string;
begin
...
class procedure TdxSpreadSheetTextClipboardFormat.SaveToStream(AStream: TStream;
AData: IdxSpreadSheetClipboardData);
var
  S: UnicodeString;
begin
...
class function TdxSpreadSheetTextClipboardFormat.SaveToString
  (AData: IdxSpreadSheetClipboardData): string;
begin
...
procedure TdxSpreadSheetTextClipboardFormatData.Copy(const AArea: TRect;
AView: TdxSpreadSheetTableView);
var
...
begin
  ...
  try
    AWriter := TdxSpreadSheetTextClipboardFormatDataWriter.Create
      (AView.SpreadSheet, AStream);
    try
...
procedure TdxSpreadSheetTextClipboardFormatData.Paste
  (AView: TdxSpreadSheetTableView; const ADestPoint: TPoint;
AOptions: TdxSpreadSheetClipboardPasteOptions);
  ...
  begin
    AReader := TdxSpreadSheetTextClipboardFormatDataReader.Create(AView,
      Text, AArea);
    try
...
procedure TdxSpreadSheetTextClipboardFormatData.SetupSettings
  (ASettings: TdxSpreadSheetCSVFormatSettings);
begin
...
function TdxSpreadSheetTextClipboardFormatDataReader.CreateFormatSettings
...
procedure TdxSpreadSheetTextClipboardFormatDataReader.DoValue
  (const AValue: string; AIsQuotedValue: Boolean);
begin
...
procedure TdxSpreadSheetTextClipboardFormatDataWriter.WriteData
  (AView: TdxSpreadSheetTableView; const AArea: TRect);
begin
  FArea := AArea;
  FView := AView;
...
procedure TdxSpreadSheetXMLSSClipboardData.CopyCells
  (AView: TdxSpreadSheetTableView);
begin
  with TdxSpreadSheetXMLSSClipboardFormatWriter.Create(AView.SpreadSheet,
    Document) do
    try
...
procedure TdxSpreadSheetXMLSSClipboardData.CopyContainer
  (AContainer: TdxSpreadSheetContainer);
begin
...
procedure TdxSpreadSheetXMLSSClipboardData.PasteCore
  (AView: TdxSpreadSheetTableView; const AActualDataArea: TRect;
AOptions: TdxSpreadSheetClipboardPasteOptions);
var
  AReader: TdxSpreadSheetXMLSSClipboardFormatReader;
begin
  AReader := TdxSpreadSheetXMLSSClipboardFormatReader.Create(AView.SpreadSheet,
    Document);
  try
...
begin
  FDataArea := cxNullRect;
  if Document.FindChild([sXMLSSNodeWorkbook, sXMLSSNodeWorksheet,
    sXMLSSNodeTable], ANode) then
  begin
    FDataArea.Right := ANode.Attributes.GetValueAsInteger
      (sXMLSSAttrExpandedColumnCount, 1) - 1;
    FDataArea.Bottom := ANode.Attributes.GetValueAsInteger
      (sXMLSSAttrExpandedRowCount, 1) - 1;
  end;
...
class function TdxSpreadSheetXMLSSClipboardFormat.Build(const AArea: TRect;
AContainer: TdxSpreadSheetContainer; AMode: TdxSpreadSheetClipboardCopyMode;
AView: TdxSpreadSheetTableView): IdxSpreadSheetClipboardData;
var
...
class function TdxSpreadSheetXMLSSClipboardFormat.
  IsPasteOptionsSupported: Boolean;
begin
  Result := True;
end;

class function TdxSpreadSheetXMLSSClipboardFormat.LoadFromStream
  (AStream: TStream): IdxSpreadSheetClipboardData;
var
  AData: TdxSpreadSheetXMLSSClipboardData;
begin
...
class procedure TdxSpreadSheetXMLSSClipboardFormat.SaveToStream
  (AStream: TStream; AData: IdxSpreadSheetClipboardData);
begin
...
procedure TdxSpreadSheetXMLSSClipboardFormatReader.ReadWorksheet
  (ANode: TdxXMLNode);
begin
  if ANode.FindChild(sXMLSSNodeTable, ANode) then
    ExecuteSubTask(TdxSpreadSheetXMLSSClipboardFormatTableViewReader.Create
      (Self, ANode));
end;

procedure TdxSpreadSheetXMLSSClipboardFormatReader.SetAnchor
  (const Value: TPoint);
begin
...
begin
  inherited Create(AReader, AReader.View, ANode, AReader.Anchor,
    AReader.Options);
end;

procedure TdxSpreadSheetXMLSSClipboardFormatTableViewReader.ReadProperties
  (ANode: TdxXMLNode);
begin
  // do nothing
end;
...
procedure TdxSpreadSheetXMLSSClipboardFormatWriter.WriteData
  (AView: TdxSpreadSheetTableView; const AArea: TRect);
begin
  FArea := AArea;
  FView := AView;
...
function TdxSpreadSheetXMLSSClipboardFormatWriter.CanWriteFormula
  (AFormula: TdxSpreadSheetFormula): Boolean;
var
  AResult: Boolean;
begin
  AResult := True;
  AFormula.EnumReferences(procedure(const AArea: TRect; AView: TObject)
    var
      R: TRect;
    begin
      AResult := AResult and ((AView = nil) or (AView = FView)) and
        dxSpreadSheetIntersects(AArea, FArea, R) and cxRectIsEqual(R, AArea);
    end, True);
  Result := AResult;
end;

procedure TdxSpreadSheetXMLSSClipboardFormatWriter.WriteViews
