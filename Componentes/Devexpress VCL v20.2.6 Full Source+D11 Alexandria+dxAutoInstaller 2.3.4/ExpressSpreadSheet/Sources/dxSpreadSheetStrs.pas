...
resourcestring
  ...
  sdxBuiltInPopupMenuPasteSpecialFormulasAndFormatting =
    'F&ormulas and Number Formatting';
  ...
  sdxBuiltInPopupMenuPasteSpecialValuesAndFormatting =
    'V&alues and Number Formatting';
  sdxBuiltInPopupMenuPasteSpecialValuesAndStyles =
    'Valu&es and Source Formatting';
  ...
  sdxDefaultHyperlinkScreenTip =
    '%s - Click once to follow.'#13#10'Click and hold to select this cell.';
...
begin
  AProduct.Add('sdxBuiltInPopupMenuBringToFront',
    @sdxBuiltInPopupMenuBringToFront);
  AProduct.Add('sdxBuiltInPopupMenuClearContents',
  ...
  AProduct.Add('sdxBuiltInPopupMenuDeleteDialog',
    @sdxBuiltInPopupMenuDeleteDialog);
  AProduct.Add('sdxBuiltInPopupMenuFormatCells',
  ...
  AProduct.Add('sdxBuiltInPopupMenuInsertDialog',
  ...
  AProduct.Add('sdxBuiltInPopupMenuPasteSpecial',
    @sdxBuiltInPopupMenuPasteSpecial);
  AProduct.Add('sdxBuiltInPopupMenuPasteSpecialAll',
    @sdxBuiltInPopupMenuPasteSpecialAll);
  AProduct.Add('sdxBuiltInPopupMenuPasteSpecialFormulas',
    @sdxBuiltInPopupMenuPasteSpecialFormulas);
  AProduct.Add('sdxBuiltInPopupMenuPasteSpecialFormulasAndColumnWidths',
    @sdxBuiltInPopupMenuPasteSpecialFormulasAndColumnWidths);
  AProduct.Add('sdxBuiltInPopupMenuPasteSpecialFormulasAndFormatting',
    @sdxBuiltInPopupMenuPasteSpecialFormulasAndFormatting);
  AProduct.Add('sdxBuiltInPopupMenuPasteSpecialFormulasAndStyles',
    @sdxBuiltInPopupMenuPasteSpecialFormulasAndStyles);
  AProduct.Add('sdxBuiltInPopupMenuPasteSpecialShowDialog',
    @sdxBuiltInPopupMenuPasteSpecialShowDialog);
  AProduct.Add('sdxBuiltInPopupMenuPasteSpecialValues',
    @sdxBuiltInPopupMenuPasteSpecialValues);
  AProduct.Add('sdxBuiltInPopupMenuPasteSpecialValuesAndFormatting',
    @sdxBuiltInPopupMenuPasteSpecialValuesAndFormatting);
  AProduct.Add('sdxBuiltInPopupMenuPasteSpecialValuesAndStyles',
    @sdxBuiltInPopupMenuPasteSpecialValuesAndStyles);
  ...
  AProduct.Add('sdxBuiltInPopupMenuUnhideDialog',
    @sdxBuiltInPopupMenuUnhideDialog);
  AProduct.Add('sdxBuiltInPopupMenuCreateHyperlink',
    @sdxBuiltInPopupMenuCreateHyperlink);
  AProduct.Add('sdxBuiltInPopupMenuEditHyperlink',
    @sdxBuiltInPopupMenuEditHyperlink);
  AProduct.Add('sdxBuiltInPopupMenuOpenHyperlink',
    @sdxBuiltInPopupMenuOpenHyperlink);
  AProduct.Add('sdxBuiltInPopupMenuRemoveHyperlink',
    @sdxBuiltInPopupMenuRemoveHyperlink);
  AProduct.Add('sdxBuiltInPopupMenuInsertComment',
    @sdxBuiltInPopupMenuInsertComment);
  AProduct.Add('sdxBuiltInPopupMenuDeleteComment',
    @sdxBuiltInPopupMenuDeleteComment);
  AProduct.Add('sdxBuiltInPopupMenuEditComment',
    @sdxBuiltInPopupMenuEditComment);
  AProduct.Add('sdxBuiltInPopupMenuHideComment',
    @sdxBuiltInPopupMenuHideComment);
  AProduct.Add('sdxBuiltInPopupMenuShowComment',
    @sdxBuiltInPopupMenuShowComment);
  AProduct.Add('sdxBuiltInPopupMenuProtectSheet',
    @sdxBuiltInPopupMenuProtectSheet);
  AProduct.Add('sdxBuiltInPopupMenuUnprotectSheet',
  ...
  AProduct.Add('sdxActionChangeConditionalFormatting',
    @sdxActionChangeConditionalFormatting);
  AProduct.Add('sdxActionChangePrintingOptions',
  ...
  AProduct.Add('sdxDefaultHyperlinkShortScreenTip',
  ...
  AProduct.Add('sdxSetSingleCellAsPrintAreaConfirmation',
    @sdxSetSingleCellAsPrintAreaConfirmation);
  ...
  AProduct.Add('sdxFormulaBarInsertFunctionHint',
