...
{$ENDIF}
  ...
  dxCore, cxGraphics, cxControls, cxLookAndFeels, cxLookAndFeelPainters,
  dxLayoutContainer, dxLayoutControl, cxClasses,
  dxLayoutLookAndFeels, dxLayoutControlAdapters, cxButtons, dxSpreadSheetCore,
  cxRadioGroup, dxColorDialog,
  dxCoreGraphics, dxGDIPlusClasses, dxLayoutcxEditAdapters, cxContainer, cxEdit,
  cxImage, cxTextEdit, cxMaskEdit,
  cxDropDownEdit, cxImageComboBox, ExtCtrls,
  dxSpreadSheetContainerCustomizationDialogHelpers, cxGroupBox, cxCalc,
...
type
  ...
  TdxSpreadSheetContainerCustomizationDialogFormClass = class of
    TdxSpreadSheetContainerCustomizationDialogForm;
  ...
  protected
    ...
    procedure SelectGradientStopColor(AStops: TdxSpreadSheetGradientStopsEdit;
      AButton: TcxButton);
    ...
    procedure UpdateColorButtonGlyph(AButton: TcxButton;
      AColor: TdxAlphaColor); overload;
  ...
  public
    ...
    property ContainerAsComment: TdxSpreadSheetCommentContainer
      read GetContainerAsComment;
    property ContainerAsPicture: TdxSpreadSheetPictureContainer
      read GetContainerAsPicture;
    property ContainerAsShape: TdxSpreadSheetShapeContainer
      read GetContainerAsShape;
    property ContainerAsTextBox: TdxSpreadSheetTextBoxContainer
      read GetContainerAsTextBox;
    property CropMargins: TRect read GetCropMargins write SetCropMargins;
    property GradientFillStops: TdxSpreadSheetGradientStopsEdit
      read FGradientFillStops;
    property GradientLineStops: TdxSpreadSheetGradientStopsEdit
      read FGradientLineStops;
    property TextBox: TdxSpreadSheetCustomTextBox read GetTextBox;
  end;

var
  dxSpreadSheetContainerCustomizationDialogClass
    : TdxSpreadSheetContainerCustomizationDialogFormClass =
    TdxSpreadSheetContainerCustomizationDialogForm;

function ShowContainerCustomizationDialog(AContainer: TdxSpreadSheetContainer;
  AActivePage: Integer = 0): Boolean;

implementation

uses
  Types, dxSpreadSheetDialogStrs, Math, dxTypeHelpers, cxGeometry,
  dxSpreadSheetCoreHistory, dxDPIAwareUtils;
...
begin
  ADialog := dxSpreadSheetContainerCustomizationDialogClass.Create
    (GetParentForm(AContainer.SpreadSheet));
  try
...
constructor TdxSpreadSheetContainerCustomizationDialogForm.Create
  (AOwner: TComponent);
begin
  inherited Create(AOwner);
  FGradientFillStops := TdxSpreadSheetGradientStopsEdit.Create(lcMain);
  FGradientFillStops.OnSelectionChanged :=
    GradientFillStopsSelectionChangedHandler;
  ...
  FGradientLineStops.OnSelectionChanged :=
    GradientLineStopsSelectionChangedHandler;
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.Initialize
  (AContainer: TdxSpreadSheetContainer);
begin
  FContainer := AContainer;
  SetControlLookAndFeel(Self, AContainer.SpreadSheet.DialogsLookAndFeel);
  lciRotation.Visible := TdxSpreadSheetContainerAccess(AContainer)
    .IsTransformsSupported;
...
begin
  Container.SpreadSheet.History.BeginAction
    (TdxSpreadSheetHistoryChangeContainerAction);
  try
    Container.SpreadSheet.History.AddCommand
      (TdxSpreadSheetHistoryChangeContainerCommand.Create(Container, True));
    SaveSizeParams;
    if ContainerAsShape <> nil then
...
begin
  ...
  btnOK.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogButtonOK);
  btnCancel.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogButtonCancel);

  // Fill
  acTextureFillLoad.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogButtonLoad);
  acTextureFillSave.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogButtonSave);
  btnGradientFillAddStop.Caption :=
    cxGetResourceString(@sdxContainerCustomizationDialogButtonAdd);
  btnGradientFillColor.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogButtonColor);
  btnGradientFillRemoveStop.Caption :=
    cxGetResourceString(@sdxContainerCustomizationDialogButtonRemove);
  btnSolidFillColor.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogButtonColor);
  lcgFill.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogGroupFill);
  lciGradientFillDirection.Caption :=
    cxGetResourceString(@sdxContainerCustomizationDialogDirection);
  lciGradientFillStops.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogStops);
  rbGradientFill.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogGradientFill);
  rbNoFill.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogNoFill);
  rbSolidFill.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogSolidFill);
  rbTextureFill.Caption := cxGetResourceString
  ...
  lciLineStyle.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogLineStyle);
  lciLineWidth.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogLineWidth);
  rbGradientLine.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogGradientLine);
  rbNoLine.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogNoLine);
  rbSolidLine.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogSolidLine);
  btnGradientLineAddStop.Caption :=
    cxGetResourceString(@sdxContainerCustomizationDialogButtonAdd);
  btnGradientLineColor.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogButtonColor);
  btnGradientLineRemoveStop.Caption :=
    cxGetResourceString(@sdxContainerCustomizationDialogButtonRemove);
  btnSolidLineColor.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogButtonColor);
  lciGradientLineDirection.Caption :=
    cxGetResourceString(@sdxContainerCustomizationDialogDirection);
  lciGradientLineStops.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogStops);
  PopulateGradientDirection(ccbGradientLineDirection);
  PopulatePenStyle(ccbLineStyle);

  // Properties
  lcgProperties.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogGroupProperties);
  lbPosition.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogPositioning);
  rbAbsolute.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogAbsolute);
  rbOneCell.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogOneCells);
  rbTwoCells.Caption := cxGetResourceString
  ...
  cbRelativeToPictureSize.Caption :=
    cxGetResourceString(@sdxContainerCustomizationDialogRelativeToPictureSize);
  lbCrop.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogCropFrom);
  lbScale.Caption := cxGetResourceString(@sdxContainerCustomizationDialogScale);
  lbSizeAndRotate.Caption := cxGetResourceString
    (SizeAndRotateGroupMap[lciRotation.Visible]);
  lcgSize.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogGroupSize);
  lciCropBottom.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogCropBottom);
  lciCropTop.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogCropTop);
  lciCropLeft.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogCropLeft);
  lciCropRight.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogCropRight);
  lciHeight.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogHeight);
  lciRotation.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogRotation);
  lciScaleHeight.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogScaleHeight);
  lciScaleWidth.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogScaleWidth);
  lciWidth.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogWidth);
  lbOriginalSize.Caption := cxGetResourceString
  ...
  // Text
  lcgText.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogTextCaption);
  btnTextFont.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogTextButtonFont);

  // TextBox
  lcgTextBox.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogTextBoxCaption);
  lbTextAlignment.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogTextBoxAlignment);
  lbTextPadding.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogTextBoxPadding);
  lciTextBoxHorzAlign.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogTextBoxHorizontal);
  lciTextBoxVertAlign.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogTextBoxVertical);
  lciTextPaddingBottom.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogTextBoxPaddingBottom);
  lciTextPaddingLeft.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogTextBoxPaddingLeft);
  lciTextPaddingRight.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogTextBoxPaddingRight);
  lciTextPaddingTop.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogTextBoxPaddingTop);
  cbTextBoxAutoSize.Caption := cxGetResourceString
    (@sdxContainerCustomizationDialogTextBoxAutoSize);
  cbTextBoxWordWrap.Caption := cxGetResourceString
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.
  GradientFillStopsDblClickHandler(Sender: TObject);
begin
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.
  GradientFillStopsSelectionChangedHandler(Sender: TObject);
begin
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.
  GradientLineStopsDblClickHandler(Sender: TObject);
begin
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.
  GradientLineStopsSelectionChangedHandler(Sender: TObject);
begin
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.LoadShape
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.LoadShapeBrush
  (ABrush: TdxGPBrush);
begin
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.LoadShapePen
  (APen: TdxGPPen);
begin
  ...
  rbGradientLine.Checked := rbGradientLine.Visible and
...
begin
  ...
  cbLockAspectRatio.Checked := TdxSpreadSheetContainerAccess(Container)
    .KeepAspectUsingCornerHandles;
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.LoadTextBox
  (ATextBox: TdxSpreadSheetCustomTextBox);
begin
  meText.Text := ATextBox.TextAsString;
  ATextBox.Font.AssignToFont(fdTextBoxFont.Font);
  cbTextBoxHorzAlign.ItemIndex := cbTextBoxHorzAlign.Properties.Items.
    IndexOfObject(TObject(ATextBox.AlignHorz));
  cbTextBoxVertAlign.ItemIndex := cbTextBoxVertAlign.Properties.Items.
    IndexOfObject(TObject(ATextBox.AlignVert));
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.SaveShape
  (AShape: TdxSpreadSheetShape);
begin
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.SaveShapeBrush
  (ABrush: TdxGPBrush);
begin
  if rbSolidFill.Checked then
  begin
  ...
  begin
    ...
    if rbGradientFill.Checked and
    (GradientFillStops.Brush.GradientPoints.Count > 0) then
  begin
    ABrush.Style := gpbsGradient;
    ABrush.GradientPoints.Assign(GradientFillStops.Brush.GradientPoints);
    ABrush.GradientMode := TdxGPBrushGradientMode
      (ccbGradientFillDirection.ItemObject);
  end
  else
    ABrush.Style := gpbsClear
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.SaveShapePen
  (APen: TdxGPPen);
begin
  ...
  begin
    ...
    if rbGradientLine.Checked and
    (GradientLineStops.Brush.GradientPoints.Count > 0) then
  begin
    APen.Brush.Style := gpbsGradient;
    APen.Brush.GradientPoints.Assign(GradientLineStops.Brush.GradientPoints);
    APen.Brush.GradientMode := TdxGPBrushGradientMode
      (ccbGradientLineDirection.ItemObject);
  end
  else
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.SaveTextBox
  (ATextBox: TdxSpreadSheetCustomTextBox);
begin
  ...
  ATextBox.ContentOffsets := Rect(seTextPaddingLeft.Value,
    seTextPaddingTop.Value, seTextPaddingRight.Value,
    seTextPaddingBottom.Value);
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.
  PopulateGradientDirection(ACombobox: TcxComboBox);
var
...
begin
  ...
  try
    ...
    for AMode := Low(AMode) to High(AMode) do
      ACombobox.Properties.Items.AddObject
        (cxGetResourceString(dxGradientModeNames[AMode]), TObject(AMode));
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.PopulateHorzAlignment
...
begin
  ...
  try
    ...
    for AIndex := Low(TAlignment) to High(TAlignment) do
      ACombobox.Properties.Items.AddObject(cxGetResourceString(Map[AIndex]),
        TObject(AIndex));
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.PopulatePenStyle
  (ACombobox: TcxComboBox);
var
...
begin
  ...
  try
    ...
    for AStyle := Low(AStyle) to High(AStyle) do
      ACombobox.Properties.Items.AddObject
        (cxGetResourceString(dxPenStyleNames[AStyle]), TObject(AStyle));
    ACombobox.ItemIndex := Max(ASavedIndex, 0);
  finally
    ACombobox.Properties.Items.EndUpdate;
  end;
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.PopulateVertAlignment
  (ACombobox: TcxComboBox);
const
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.SelectColor
  (AButton: TcxButton);
begin
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.ScaleFactorChanged(M,
  D: Integer);
begin
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.SelectPage
  (AActivePage: Integer);
begin
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.SetSpinValue
  (ASpinEdit: TcxSpinEdit; const AValue: Variant);
begin
  ASpinEdit.Value := TcxSpinEditPropertiesAccess(ASpinEdit.Properties)
    .CheckValueBounds(AValue);
end;

function TdxSpreadSheetContainerCustomizationDialogForm.GetContainerAsComment
...
function TdxSpreadSheetContainerCustomizationDialogForm.GetContainerAsPicture
...
function TdxSpreadSheetContainerCustomizationDialogForm.GetContainerAsShape
...
function TdxSpreadSheetContainerCustomizationDialogForm.GetContainerAsTextBox
...
function TdxSpreadSheetContainerCustomizationDialogForm.GetTextBox
  : TdxSpreadSheetCustomTextBox;
begin
  if ContainerAsComment <> nil then
    Result := ContainerAsComment.TextBox
  else if ContainerAsTextBox <> nil then
...
begin
  Result := cxRect(seCropLeft.Value, seCropTop.Value, seCropRight.Value,
    seCropBottom.Value);
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.SetCropMargins
  (const Value: TRect);
begin
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.
  seCropHorzPropertiesChange(Sender: TObject);
begin
  if (Sender as TcxSpinEdit).Focused then
    SetSpinValue(seWidth, seWidth.Value + cxMarginsWidth(FPrevCropMargins) -
      cxMarginsWidth(CropMargins));
  FPrevCropMargins := CropMargins;
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.
  seCropVertPropertiesChange(Sender: TObject);
begin
  if (Sender as TcxSpinEdit).Focused then
    SetSpinValue(seHeight, seHeight.Value + cxMarginsHeight(FPrevCropMargins) -
      cxMarginsHeight(CropMargins));
  FPrevCropMargins := CropMargins;
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.
  seHeightPropertiesChange(Sender: TObject);
var
...
begin
  ...
  if cbLockAspectRatio.Checked then
    SetSpinValue(seWidth, MulDiv(seHeight.Value + AMarginHeight,
      FScaleNumerator, FScaleDenominator) - cxMarginsWidth(CropMargins));
  if not seScaleHeight.Focused then
    SetSpinValue(seScaleHeight, MulDiv(100, seHeight.Value + AMarginHeight,
      seHeight.Tag));
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.seWidthPropertiesChange
  (Sender: TObject);
var
...
begin
  ...
  if cbLockAspectRatio.Checked then
    SetSpinValue(seHeight, MulDiv(seWidth.Value + AMarginWidth,
      FScaleDenominator, FScaleNumerator) - cxMarginsHeight(CropMargins));
  if not seScaleWidth.Focused then
    SetSpinValue(seScaleWidth, MulDiv(100, seWidth.Value + AMarginWidth,
      seWidth.Tag));
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.
  seScaleHeightPropertiesChange(Sender: TObject);
begin
  if seScaleHeight.Focused then
    SetSpinValue(seHeight, MulDiv(seHeight.Tag, seScaleHeight.Value, 100) -
      cxMarginsHeight(CropMargins));
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.
  seScaleWidthPropertiesChange(Sender: TObject);
begin
  if seScaleWidth.Focused then
    SetSpinValue(seWidth, MulDiv(seWidth.Tag, seScaleWidth.Value, 100) -
      cxMarginsWidth(CropMargins));
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.UpdateColorButtonGlyph
  (AButton: TcxButton);
begin
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.UpdateColorButtonGlyph
  (AButton: TcxButton; AColor: TdxAlphaColor);
var
  ABitmap32: TcxBitmap32;
begin
  ABitmap32 := TcxBitmap32.CreateSize(ScaleFactor.Apply(18),
    ScaleFactor.Apply(18), False);
  try
    cxDrawTransparencyCheckerboard(ABitmap32.cxCanvas, ABitmap32.ClientRect,
      ScaleFactor.Apply(4));
    dxGPPaintCanvas.BeginPaint(ABitmap32.Canvas.Handle, ABitmap32.ClientRect);
    try
      dxGPPaintCanvas.Rectangle(ABitmap32.ClientRect,
        dxColorToAlphaColor(clBlack), AColor);
    finally
...
begin
  ...
  begin
    ...
    lclOriginalSize.Caption :=
      Format(cxGetResourceString
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.
  acTextureFillLoadExecute(Sender: TObject);
var
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.
  acTextureFillSaveExecute(Sender: TObject);
var
  AImageExt: string;
begin
  AImageExt := cxGraphicExtension(imTextureFill.Picture.Graphic);
  TextureSaveDialog.DefaultExt := AImageExt;
  TextureSaveDialog.Filter := UpperCase(Copy(AImageExt, 2, MaxInt)) + ' Image|*'
    + AImageExt + ';';
  if TextureSaveDialog.Execute(Handle) then
    imTextureFill.Picture.Graphic.SaveToFile
      (ChangeFileExt(TextureSaveDialog.FileName, AImageExt));
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.acTextureFillSaveUpdate
  (Sender: TObject);
begin
  acTextureFillSave.Enabled := rbTextureFill.Checked and
    (imTextureFill.Picture.Graphic <> nil);
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.
  btnGradientFillAddStopClick(Sender: TObject);
begin
  GradientFillStops.Add;
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.
  btnGradientFillColorClick(Sender: TObject);
begin
  SelectGradientStopColor(GradientFillStops, btnGradientFillColor);
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.
  btnGradientFillRemoveStopClick(Sender: TObject);
begin
  GradientFillStops.DeleteSelected;
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.
  btnGradientLineAddStopClick(Sender: TObject);
begin
  GradientLineStops.Add;
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.
  btnGradientLineColorClick(Sender: TObject);
begin
  SelectGradientStopColor(GradientLineStops, btnGradientLineColor);
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.
  btnGradientLineRemoveStopClick(Sender: TObject);
begin
  GradientLineStops.DeleteSelected;
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.btnResetClick
  (Sender: TObject);
begin
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.btnTextFontClick
  (Sender: TObject);
begin
  fdTextBoxFont.Execute(Handle);
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.btnColorClick
  (Sender: TObject);
begin
  SelectColor(Sender as TcxButton);
end;

procedure TdxSpreadSheetContainerCustomizationDialogForm.cbLockAspectRatioClick
  (Sender: TObject);
begin
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.
  cbRelativeToPictureSizeClick(Sender: TObject);
var
  ARect: TRect;
begin
  if cbRelativeToPictureSize.Checked then
  ...
  begin
    ARect := TdxSpreadSheetContainerAccess(Container)
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.FormShow
  (Sender: TObject);
begin
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.rbGradientLineClick
  (Sender: TObject);
begin
...
procedure TdxSpreadSheetContainerCustomizationDialogForm.rbTextureFillClick
  (Sender: TObject);
begin
