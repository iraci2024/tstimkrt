...
uses
  ...
  cxDBLookupComboBox, cxHyperLinkEdit, cxImage, cxImageComboBox, cxMaskEdit,
  cxMemo,
...
type
  ...
  protected
    function AddRow(AcxRowParent: TcxCustomRow; const AdxRowName: string)
      : TcxCustomRow;
    procedure AssignCaptionProperties(AdxRow: TObject;
      AProperties: TcxCaptionRowProperties);
    procedure AssignEditorDataBinding(AdxRow: TObject;
      AProperties: TcxCustomEditorRowProperties); virtual;
    procedure AssignEditorProperties(AdxRow: TObject;
    ...
    function CreateMultiEditorRowItem(AcxRow: TcxCustomRow)
      : TcxCollectionItemEditorRowProperties; virtual;
    ...
    procedure ImportMultiEditorRow(AdxRow: TObject;
      AcxRow: TcxCustomRow); virtual;
  ...
  protected
    procedure AssignEditorDataBinding(AdxRow: TObject;
      AProperties: TcxCustomEditorRowProperties); override;
    procedure AssignVerticalGridOptions; override;
    function CreateMultiEditorRowItem(AcxRow: TcxCustomRow)
      : TcxCollectionItemEditorRowProperties; override;
...
const
ConverterTable:
array [0 .. 17] of record RowClassName: string;
DBRowClassName:
string;
PropertiesClass:
...
= ((RowClassName: 'TdxInspectorTextRow'; DBRowClassName: 'TdxInspectorDBRow';
  PropertiesClass: TcxTextEditProperties;
  ConverterClass: TcxTextEditPropertiesConverter; ValueType: nil),
  (RowClassName: 'TdxInspectorTextMaskRow';
  DBRowClassName: 'TdxInspectorDBMaskRow';
  PropertiesClass: TcxMaskEditProperties;
  ConverterClass: TcxMaskEditPropertiesConverter; ValueType: nil),
  ...
  ValueType: TcxVariantValueType), (RowClassName: 'TdxInspectorTextTimeRow';
  ...
  ConverterClass: TcxHyperLinkEditPropertiesConverter; ValueType: nil),
  (RowClassName: 'TdxInspectorTextBlobRow';
  DBRowClassName: 'TdxInspectorBlobRow'; PropertiesClass: TcxBlobEditProperties;
  ConverterClass: TcxBlobEditPropertiesConverter;
  ValueType: TcxVariantValueType), (RowClassName: 'TdxInspectorTextMRURow';
  DBRowClassName: 'TdxInspectorDBMRURow'; PropertiesClass: TcxMRUEditProperties;
  ConverterClass: TcxMRUEditPropertiesConverter; ValueType: nil),
  (RowClassName: 'TdxInspectorTextPopupRow';
  DBRowClassName: 'TdxInspectorDBPopupRow';
  PropertiesClass: TcxPopupEditProperties;
  ConverterClass: TcxPopupEditPropertiesConverter; ValueType: nil),
  (RowClassName: 'TdxInspectorTextMemoRow';
  DBRowClassName: 'TdxInspectorDBMemoRow'; PropertiesClass: TcxMemoProperties;
  ConverterClass: TcxMemoPropertiesConverter; ValueType: nil),
  (RowClassName: 'TdxInspectorTextGraphicRow';
  DBRowClassName: 'TdxInspectorDBGraphicRow';
  PropertiesClass: TcxImageProperties;
  ConverterClass: TcxImagePropertiesConverter; ValueType: TcxVariantValueType),
  (RowClassName: ''; DBRowClassName: 'TdxInspectorLookupRow';
  PropertiesClass: TcxLookupComboBoxProperties;
  ConverterClass: TcxLookupComboBoxPropertiesConverter; ValueType: nil));

function InheritsFromEx(AObject: TObject;
...
procedure TcxCustomDXInspConverter.AssignEditorDataBinding(AdxRow: TObject;
  AProperties: TcxCustomEditorRowProperties);
begin
end;

procedure TcxCustomDXInspConverter.AssignEditorProperties(AdxRow: TObject;
  AProperties: TcxCustomEditorRowProperties);
var
...
begin
  ...
  AConverter := ConverterTable[Index].ConverterClass.Create
...
begin
  ...
  begin
    if FDefaultRowHeight <> 17 then
      RowHeight := FDefaultRowHeight;
    CellTextMaxLineCount := GetIntegerProperty(Source,
...
function TcxCustomDXInspConverter.CreateMultiEditorRowItem(AcxRow: TcxCustomRow)
...
function TcxCustomDXInspConverter.GetRowClassType(AdxRow: TObject)
  : TcxCustomRowClass;
begin
  Result := nil;
end;
...
type
  ...
  public
    ...
    procedure CreateVisibleRows(AStream: TStream;
    ...
    procedure DefineBinaryProperty(const Name: string;
      AReadData, AWriteData: TStreamProc; HasData: Boolean); override;
...
procedure TcxConverterFiler.DefineProperty(const Name: string;
...
procedure TcxDXInspConverter.AssignEditorDataBinding(AdxRow: TObject;
  AProperties: TcxCustomEditorRowProperties);
var
  Index: Integer;
  S: string;
...
function TcxDXInspConverter.CreateMultiEditorRowItem(AcxRow: TcxCustomRow)
  : TcxCollectionItemEditorRowProperties;
begin
  Result := TcxMultiEditorRow(AcxRow).Properties.Editors.Add;
end;

function TcxDXInspConverter.GetRowClassType(AdxRow: TObject): TcxCustomRowClass;
begin
  Result := nil;
  if AdxRow = nil then
    Exit;
...
procedure TcxDXDBInspConverter.AssignEditorDataBinding(AdxRow: TObject;
  AProperties: TcxCustomEditorRowProperties);
begin
  TcxDBVerticalGridItemDataBinding(TcxCustomEditorRowPropertiesAccess
    (AProperties).DataBinding).FieldName := GetStringProperty(AdxRow,
    'FieldName');
end;
...
function TcxDXDBInspConverter.CreateMultiEditorRowItem(AcxRow: TcxCustomRow)
  : TcxCollectionItemEditorRowProperties;
begin
...
function TcxDXDBInspConverter.GetRowClassType(AdxRow: TObject)
  : TcxCustomRowClass;
begin
  Result := nil;
  if AdxRow = nil then
...
ConverterFactory(cxVGGroupConverterName).RegisterConverter
  ('DX Inspector Converter', TcxDXInspConverter);
ConverterFactory(cxDBVGGroupConverterName).RegisterConverter
  ('DX DBInspector Converter', TcxDXDBInspConverter);
ConverterFactory(cxRTTIVGGroupConverterName).RegisterConverter
  ('DX RTTIInspector Converter', TcxDXRTTIConverter);
