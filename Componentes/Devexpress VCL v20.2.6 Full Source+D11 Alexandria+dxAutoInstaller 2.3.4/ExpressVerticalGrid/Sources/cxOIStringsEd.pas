...
uses
  ...
  dxCore, cxLookAndFeels, cxLookAndFeelPainters, cxButtons, cxControls,
  cxContainer, cxEdit, cxTextEdit, cxMemo,
  cxGraphics, dxLayoutcxEditAdapters, dxLayoutControlAdapters,
...
begin
  Label1.Caption := IntToStr(Memo1.InnerControl.Perform(EM_GETLINECOUNT, 0, 0))
    + ' line(s)';
end;
...
begin
  ...
  FSizeGripBounds.Left := FSizeGripBounds.Right -
    GetSystemMetrics(SM_CXVSCROLL);
  FSizeGripBounds.Top := FSizeGripBounds.Bottom -
