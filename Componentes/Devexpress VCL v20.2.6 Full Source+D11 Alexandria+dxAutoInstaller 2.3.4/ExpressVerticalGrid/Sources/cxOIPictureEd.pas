...
uses
  ...
  dxCore, cxLookAndFeelPainters, cxControls, cxContainer, cxEdit, cxImage,
  cxButtons, cxLookAndFeels, cxGraphics,
...
uses
  Types, ClipBrd, cxVGridConsts, cxEditConsts, dxThemeConsts, dxThemeManager,
