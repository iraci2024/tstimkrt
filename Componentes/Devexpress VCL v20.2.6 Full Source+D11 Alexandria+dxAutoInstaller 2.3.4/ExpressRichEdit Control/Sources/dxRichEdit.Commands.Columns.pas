...
type
  ...
  TdxSetSectionColumnCountCommandBase = class abstract
    (TdxSelectionBasedPropertyChangeCommandBase)
  protected
    function ChangeProperty(const AStart: TdxDocumentModelPosition;
      const AEnd: TdxDocumentModelPosition; const AState: IdxCommandUIState)
    ...
    procedure UpdateUIStateCore(const AState: IdxCommandUIState;
      ASection: TdxSection); reintroduce; overload; virtual;
  ...
  TdxSetSectionColumnsPlaceholderCommand = class
    (TdxSetSectionColumnCountCommandBase)
  protected
    function GetActualColumnCount: Integer; override;
    procedure ModifyDocumentModelCore(const AState: IdxCommandUIState);
...
begin
  ...
  begin
    ...
    APieceTable.ApplyChanges(TdxDocumentModelChangeType.ModifySection,
      AParagraphs[AStartParagraphIndex].FirstRunIndex,
      AParagraphs[AEndParagraphIndex].LastRunIndex);
  end;
end;
...
begin
  ...
  AColumns := ASection.Columns;
  AState.Enabled := IsContentEditable and (ASection <> nil) and
    DocumentModel.CanEditSection(ASection);
  AState.Checked := AColumns.EqualWidthColumns and
    (AColumns.ColumnCount = ActualColumnCount);
  AState.Visible := True;
...
procedure TdxSetSectionColumnsPlaceholderCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState; ASection: TdxSection);
begin
