...
{$ENDIF}
  ...
  Generics.Defaults, Generics.Collections, cxGraphics, cxControls, cxButtons,
  cxImageComboBox, cxClasses, dxCoreGraphics,
...
type
  TdxBorderLineState = (Known, Unknown, No);

  TdxTableCellBorderLine = (Up, Down, HorizontalIn, Left, Right, VerticalIn);
  ...
  private
    ...
    function GetBorderLineState(const Index: TdxTableCellBorderLine)
      : TdxBorderLineState; inline;
    procedure SetBorderLineState(const Index: TdxTableCellBorderLine;
  ...
  protected
    procedure DoChange;
    procedure DrawRectangles(AGraphics: TdxGraphics;
      AWidth, AHeight, AX, AY: Integer);
  public
    procedure Draw(ACanvas: TcxCanvas);
    property DocumentModel: TdxDocumentModel read FDocumentModel
      write FDocumentModel;
    ...
    property DrawPageBorderHorizontalDown: Boolean
      read FDrawPageBorderHorizontalDown write SetDrawPageBorderHorizontalDown;
    property DrawPageBorderHorizontalUp: Boolean
      read FDrawPageBorderHorizontalUp write SetDrawPageBorderHorizontalUp;
    property DrawPageBorderVerticalRight: Boolean
      read FDrawPageBorderVerticalRight write SetDrawPageBorderVerticalRight;
    property DrawPageBorderVerticalLeft: Boolean
      read FDrawPageBorderVerticalLeft write SetDrawPageBorderVerticalLeft;
    property FillColor: TdxAlphaColor read FFillColor write SetFillColor;
    property HorizontalLineUp: TdxBorderLineState
      index TdxTableCellBorderLine.Up read GetBorderLineState
      write SetBorderLineState;
    property HorizontalLineDown: TdxBorderLineState
      index TdxTableCellBorderLine.Down read GetBorderLineState
      write SetBorderLineState;
    property HorizontalLineIn: TdxBorderLineState
      index TdxTableCellBorderLine.HorizontalIn read GetBorderLineState
      write SetBorderLineState;
    property VerticalLineRight: TdxBorderLineState
      index TdxTableCellBorderLine.Right read GetBorderLineState
      write SetBorderLineState;
    property VerticalLineLeft: TdxBorderLineState
      index TdxTableCellBorderLine.Left read GetBorderLineState
      write SetBorderLineState;
    property VerticalLineIn: TdxBorderLineState
      index TdxTableCellBorderLine.VerticalIn read GetBorderLineState
      write SetBorderLineState;

    property Bounds: TRect read GetBounds write SetBounds;
    property BorderInfoSource: TdxBorderShadingUserControlHelper
      read FBorderInfoSource write FBorderInfoSource;
  ...
  TdxBorderShadingUserControlHelper = class
  private type
    TdxTableCellBorderLineInfos = array [TdxTableCellBorderLine]
      of TdxBorderInfo;
    TdxTableCellBorderLineBtns = array [TdxTableCellBorderLine] of TcxButton;
    TdxTableCellBorderLineBtnOnChanges = array [TdxTableCellBorderLine]
      of TNotifyEvent;
  private
    ...
    function GetBorderLineInfo(const Index: TdxTableCellBorderLine)
      : TdxBorderInfo;
    procedure SetBorderLineInfo(const Index: TdxTableCellBorderLine;
    ...
    function GetOnBorderLineChanged(const Index: TdxTableCellBorderLine)
      : TNotifyEvent; inline;
    procedure SetOnBorderLineChanged(const Index: TdxTableCellBorderLine;
      const Value: TNotifyEvent); inline;
    ...
    procedure SetDrawParagraph(const Value: Boolean);
    procedure SetBtnBorderLineVisible(const Index: TdxTableCellBorderLine;
      const Value: Boolean);
  protected
  ...
  public
    constructor Create(APreviewBorderShadingControl
      : TdxPreviewBorderShadingControlHelper);
    destructor Destroy; override;
    procedure BeginUpdate;
    procedure EndUpdate;
    procedure Initialize(ABtnLineUp, ABtnLineDown, ABtnLineHorizontalIn,
      ABtnLineLeft, ABtnLineRight, ABtnLineVerticalIn: TcxButton);
    procedure SetMode(const Value: TdxSetMode);
    class procedure SetButtonDown(AButton: TcxButton; ADown: Boolean);

    property BorderLineUp: TdxBorderInfo index TdxTableCellBorderLine.Up
      read GetBorderLineInfo write SetBorderLineInfo;
    property BorderLineDown: TdxBorderInfo index TdxTableCellBorderLine.Down
      read GetBorderLineInfo write SetBorderLineInfo;
    property BorderLineHorizontalIn: TdxBorderInfo
      index TdxTableCellBorderLine.HorizontalIn read GetBorderLineInfo
      write SetBorderLineInfo;
    property BorderLineLeft: TdxBorderInfo index TdxTableCellBorderLine.Left
      read GetBorderLineInfo write SetBorderLineInfo;
    property BorderLineRight: TdxBorderInfo index TdxTableCellBorderLine.Right
      read GetBorderLineInfo write SetBorderLineInfo;
    property BorderLineVerticalIn: TdxBorderInfo
      index TdxTableCellBorderLine.VerticalIn read GetBorderLineInfo
      write SetBorderLineInfo;
    property BorderLineHorizontalInVisible: Boolean
      read FBorderLineHorizontalInVisible
      write SetBorderLineHorizontalInVisible;
    property BorderLineVerticalInVisible: Boolean
      read FBorderLineVerticalInVisible write SetBorderLineVerticalInVisible;
    property ButtonsVisible: Boolean read FButtonsVisible
      write SetButtonsVisible;
    property CurrentBorderInfo: TdxBorderInfo read FCurrentBorderInfo
      write SetCurrentBorderInfo;
    property DocumentModel: TdxDocumentModel read GetDocumentModel
      write SetDocumentModel;
    property DrawColumns: Boolean read GetDrawColumns write SetDrawColumns;
    property DrawParagraph: Boolean read GetDrawParagraph
      write SetDrawParagraph;
    ...
    property OnBorderLineUpChanged: TNotifyEvent index TdxTableCellBorderLine.Up
      read GetOnBorderLineChanged write SetOnBorderLineChanged;
    property OnBorderLineDownChanged: TNotifyEvent
      index TdxTableCellBorderLine.Down read GetOnBorderLineChanged
      write SetOnBorderLineChanged;
    property OnBorderLineHorizontalInChanged: TNotifyEvent
      index TdxTableCellBorderLine.HorizontalIn read GetOnBorderLineChanged
      write SetOnBorderLineChanged;
    property OnBorderLineVerticalInChanged: TNotifyEvent
      index TdxTableCellBorderLine.VerticalIn read GetOnBorderLineChanged
      write SetOnBorderLineChanged;
    property OnBorderLineLeftChanged: TNotifyEvent
      index TdxTableCellBorderLine.Left read GetOnBorderLineChanged
      write SetOnBorderLineChanged;
    property OnBorderLineRightChanged: TNotifyEvent
      index TdxTableCellBorderLine.Right read GetOnBorderLineChanged
      write SetOnBorderLineChanged;
  end;
  ...
  public const
    BordersLineWeights: array [0 .. 8] of Single = (0.25, 0.5, 0.75, 1.0, 1.5,
      2.25, 3.0, 4.5, 6.0);
  private
  ...
  protected
    function GetActualBorderWidth(ABorder: TdxBorderInfo;
      DocumentModel: TdxDocumentModel): Integer;
    class function GetBorderLineStyleTypeName(ABorderLineStyle
      : TdxBorderLineStyle): string;
    function ShouldSkipBorderStyle(AStyle: TdxBorderLineStyle;
      ASkipNone: Boolean): Boolean;
  public
    constructor Create;
    destructor Destroy; override;

    function DrawVerticalLineRight(ABorderInfoSource
      : TdxBorderShadingUserControlHelper; ADocumentModel: TdxDocumentModel;
      AToLayoutUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
      const AExporter: TdxGraphicsDocumentLayoutExporterTableBorder;
      AWidth, AHeight: Integer): Integer;
    function DrawVerticalLineLeft(ABorderInfoSource
      : TdxBorderShadingUserControlHelper; ADocumentModel: TdxDocumentModel;
      AToLayoutUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
      const AExporter: TdxGraphicsDocumentLayoutExporterTableBorder;
      AWidth, AHeight: Integer): Integer;
    function DrawVerticalLineIn(ABorderInfoSource
      : TdxBorderShadingUserControlHelper; ADocumentModel: TdxDocumentModel;
      AToLayoutUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
      const AExporter: TdxGraphicsDocumentLayoutExporterTableBorder;
      AWidth, AHeight: Integer): Integer;
    function DrawHorizontalLineIn(ABorderInfoSource
      : TdxBorderShadingUserControlHelper; ADocumentModel: TdxDocumentModel;
      AToLayoutUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
      const AExporter: TdxGraphicsDocumentLayoutExporterTableBorder;
      AWidth, AHeight: Integer): Integer;
    function DrawHorizontalLineUp(ABorderInfoSource
      : TdxBorderShadingUserControlHelper; ADocumentModel: TdxDocumentModel;
      AToLayoutUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
      const AExporter: TdxGraphicsDocumentLayoutExporterTableBorder;
      AWidth, AHeight: Integer): Integer;
    function DrawHorizontalLineDown(ABorderInfoSource
      : TdxBorderShadingUserControlHelper; ADocumentModel: TdxDocumentModel;
      AToLayoutUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
      const AExporter: TdxGraphicsDocumentLayoutExporterTableBorder;
      AWidth, AHeight: Integer): Integer;

    procedure PopulateBorderLineStyle(AImageList: TcxImageList;
      AStrings: TStrings; ASkipNone: Boolean = True);
...
function TdxRichEditBorderShadingDialogHelper.DrawHorizontalLineDown
  (ABorderInfoSource: TdxBorderShadingUserControlHelper;
...
begin
  ...
  try
    ...
    ARightCorner := TdxCornerViewInfoBase.CreateCorner
      (TdxCornerViewInfoType.InnerBottomRight, AToLayoutUnitConverter,
      ABorderInfoSource.BorderLineDown, ABorderInfoSource.BorderLineRight,
      nil, nil, 0);
    try
      ALeftCorner := TdxCornerViewInfoBase.CreateCorner
        (TdxCornerViewInfoType.InnerBottomLeft, AToLayoutUnitConverter, nil,
        ABorderInfoSource.BorderLineLeft,
        ABorderInfoSource.BorderLineDown, nil, 0);
      try
        AMiddleCorner := TdxCornerViewInfoBase.CreateCorner
          (TdxCornerViewInfoType.InnerBottomMiddle, AToLayoutUnitConverter,
          ABorderInfoSource.BorderLineDown,
          ABorderInfoSource.BorderLineVerticalIn,
          ABorderInfoSource.BorderLineDown, nil, 0);
        try
          AViewInfo.StartCorner := ALeftCorner;
          AViewInfo.EndCorner := AMiddleCorner;
          AExporter.ExportTableBorderCorner(ALeftCorner, 0,
            AHeight - ABorderWidth);
          AExporter.ExportTableBorderCorner(AMiddleCorner,
            (AWidth - ABorderWidth) div 2, AHeight - ABorderWidth);
          AExporter.ExportTableBorder(AViewInfo.Border,
            TRect.Create(0, 0, (AWidth - ABorderWidth) div 2,
            AHeight - ABorderWidth), AToLayoutUnitConverter, AViewInfo);
          ...
          try
            ...
            AExporter.ExportTableBorderCorner(AMiddleCorner,
              (AWidth - ABorderWidth) div 2, AHeight - ABorderWidth);
            AExporter.ExportTableBorderCorner(ARightCorner,
              AWidth - ABorderWidth, AHeight - ABorderWidth);
            AExporter.ExportTableBorder(AViewInfoRight.Border,
              TRect.CreateSize((AWidth - ABorderWidth) div 2, 0,
              (AWidth - ABorderWidth) div 2, AHeight - ABorderWidth),
              AToLayoutUnitConverter, AViewInfoRight);
            Result := ABorderWidth;
          finally
            AViewInfoRight.Free;
          end;
...
function TdxRichEditBorderShadingDialogHelper.DrawHorizontalLineIn
  (ABorderInfoSource: TdxBorderShadingUserControlHelper;
  ADocumentModel: TdxDocumentModel;
  AToLayoutUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
  const AExporter: TdxGraphicsDocumentLayoutExporterTableBorder;
...
begin
  ...
  try
    ...
    ALeftCorner := TdxCornerViewInfoBase.CreateCorner
      (TdxCornerViewInfoType.InnerLeftMiddle, AToLayoutUnitConverter, nil,
      ABorderInfoSource.BorderLineLeft,
      ABorderInfoSource.BorderLineHorizontalIn,
      ABorderInfoSource.BorderLineLeft, 0);
    try
      ARightCorner := TdxCornerViewInfoBase.CreateCorner
        (TdxCornerViewInfoType.InnerRightMiddle, AToLayoutUnitConverter,
        ABorderInfoSource.BorderLineHorizontalIn,
        ABorderInfoSource.BorderLineRight, nil,
        ABorderInfoSource.BorderLineRight, 0);
      try
        AMiddleCorner := TdxCornerViewInfoBase.CreateCorner
          (TdxCornerViewInfoType.InnerNormal, AToLayoutUnitConverter,
          ABorderInfoSource.BorderLineHorizontalIn,
          ABorderInfoSource.BorderLineVerticalIn,
          ABorderInfoSource.BorderLineHorizontalIn,
        ...
        try
          ...
          AExporter.ExportTableBorderCorner(ALeftCorner, 0,
            (AHeight - ABorderWidth) div 2);
          AExporter.ExportTableBorderCorner(AMiddleCorner,
            (AWidth - ABorderWidth) div 2, (AHeight - ABorderWidth) div 2);
          AExporter.ExportTableBorder(AViewInfoLeft.Border,
            TRect.Create(0, 0, (AWidth - ABorderWidth) div 2,
            (AHeight - ABorderWidth) div 2), AToLayoutUnitConverter,
            AViewInfoLeft);
          ...
          try
            ...
            AExporter.ExportTableBorderCorner(AMiddleCorner,
              (AWidth - ABorderWidth) div 2, (AHeight - ABorderWidth) div 2);
            AExporter.ExportTableBorderCorner(ARightCorner,
              AWidth - ABorderWidth, (AHeight - ABorderWidth) div 2);
            AExporter.ExportTableBorder(AViewInfoRight.Border,
              TRect.CreateSize((AWidth - ABorderWidth) div 2, 0,
              (AWidth - ABorderWidth) div 2, (AHeight - ABorderWidth) div 2),
              AToLayoutUnitConverter, AViewInfoRight);
...
function TdxRichEditBorderShadingDialogHelper.DrawHorizontalLineUp
  (ABorderInfoSource: TdxBorderShadingUserControlHelper;
  ADocumentModel: TdxDocumentModel;
  AToLayoutUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
  const AExporter: TdxGraphicsDocumentLayoutExporterTableBorder;
...
begin
  ...
  try
    ...
    ABorderWidth := GetActualBorderWidth(AViewInfo.Border, ADocumentModel);
    ARightCorner := TdxCornerViewInfoBase.CreateCorner
      (TdxCornerViewInfoType.InnerTopRight, AToLayoutUnitConverter,
      ABorderInfoSource.BorderLineUp, nil, nil,
      ABorderInfoSource.BorderLineRight, 0);
    try
      ALeftCorner := TdxCornerViewInfoBase.CreateCorner
        (TdxCornerViewInfoType.InnerTopLeft, AToLayoutUnitConverter, nil, nil,
        ABorderInfoSource.BorderLineUp, ABorderInfoSource.BorderLineLeft, 0);
      try
        AMiddleCorner := TdxCornerViewInfoBase.CreateCorner
          (TdxCornerViewInfoType.InnerTopMiddle, AToLayoutUnitConverter,
          ABorderInfoSource.BorderLineUp, nil, ABorderInfoSource.BorderLineUp,
          ABorderInfoSource.BorderLineVerticalIn, 0);
        try
          AViewInfo.StartCorner := ALeftCorner;
          AViewInfo.EndCorner := AMiddleCorner;
...
function TdxRichEditBorderShadingDialogHelper.DrawVerticalLineIn
  (ABorderInfoSource: TdxBorderShadingUserControlHelper;
  ADocumentModel: TdxDocumentModel;
  AToLayoutUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
  const AExporter: TdxGraphicsDocumentLayoutExporterTableBorder;
...
begin
  ...
  try
    ...
    ATopCorner := TdxCornerViewInfoBase.CreateCorner
      (TdxCornerViewInfoType.InnerTopMiddle, AToLayoutUnitConverter,
      ABorderInfoSource.BorderLineUp, nil, ABorderInfoSource.BorderLineUp,
      ABorderInfoSource.BorderLineVerticalIn, 0);
    try
      ...
      try
        ...
        AExporter.ExportTableBorderCorner(ATopCorner, (AWidth - ABorderWidth)
          div 2, 0);
        AExporter.ExportTableBorderCorner(AMiddleCorner, (AWidth - ABorderWidth)
          div 2, (AHeight - ABorderWidth) div 2);
        AExporter.ExportTableBorder(AViewInfoTop.Border,
          TRect.Create(0, 0, (AWidth - ABorderWidth) div 2,
          (AHeight - ABorderWidth) div 2), AToLayoutUnitConverter,
          AViewInfoTop);
        ...
        try
          ...
          ABottomCorner := TdxCornerViewInfoBase.CreateCorner
            (TdxCornerViewInfoType.InnerBottomMiddle, AToLayoutUnitConverter,
            ABorderInfoSource.BorderLineDown,
            ABorderInfoSource.BorderLineVerticalIn,
            ABorderInfoSource.BorderLineDown, nil, 0);
          try
            ...
            AExporter.ExportTableBorderCorner(AMiddleCorner,
              (AWidth - ABorderWidth) div 2, (AHeight - ABorderWidth) div 2);
            AExporter.ExportTableBorderCorner(ABottomCorner,
              (AWidth - ABorderWidth) div 2, AHeight - ABorderWidth);
            AExporter.ExportTableBorder(AViewInfoBottom.Border,
              TRect.CreateSize(0, (AHeight - ABorderWidth) div 2,
              (AWidth - ABorderWidth) div 2, (AHeight - ABorderWidth) div 2),
              AToLayoutUnitConverter, AViewInfoBottom);
            Result := ABorderWidth;
          finally
            ABottomCorner.Free;
          end;
...
function TdxRichEditBorderShadingDialogHelper.DrawVerticalLineLeft
  (ABorderInfoSource: TdxBorderShadingUserControlHelper;
  ADocumentModel: TdxDocumentModel;
  AToLayoutUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
  const AExporter: TdxGraphicsDocumentLayoutExporterTableBorder;
    ...
    try
      ...
      try
        ...
        try
          ...
          AExporter.ExportTableBorderCorner(AMiddleCorner, 0,
            (AHeight - ABorderWidth) div 2);
          AExporter.ExportTableBorder(AViewInfo.Border,
            TRect.Create(0, 0, (AWidth - ABorderWidth) div 2,
          ...
          try
            ...
            AExporter.ExportTableBorderCorner(AMiddleCorner, 0,
              (AHeight - ABorderWidth) div 2);
            AExporter.ExportTableBorderCorner(ABottomCorner, 0,
              AHeight - ABorderWidth);
            AExporter.ExportTableBorder(AViewInfoBottom.Border,
              TRect.CreateSize(0, (AHeight - ABorderWidth) div 2,
              (AWidth - ABorderWidth) div 2, (AHeight - ABorderWidth) div 2),
    ...
    try
      ...
      try
        ...
        try
          AViewInfo.StartCorner := ATopCorner;
          AViewInfo.EndCorner := AMiddleCorner;
          AExporter.ExportTableBorderCorner(ATopCorner,
            AWidth - ABorderWidth, 0);
          AExporter.ExportTableBorderCorner(AMiddleCorner,
            AWidth - ABorderWidth, (AHeight - ABorderWidth) div 2);
          AExporter.ExportTableBorder(AViewInfo.Border,
            TRect.Create(0, 0, AWidth - ABorderWidth, (AHeight - ABorderWidth)
            div 2), AToLayoutUnitConverter, AViewInfo);
          AViewInfoBottom := TdxPreviewBorderViewInfo.Create;
          try
...
function TdxRichEditBorderShadingDialogHelper.GetActualBorderWidth
  (ABorder: TdxBorderInfo; DocumentModel: TdxDocumentModel): Integer;
var
...
begin
  ...
  try
    AScaleFactor := 1;
    AThickness := Math.Max(1, DocumentModel.UnitConverter.ModelUnitsToPixels
      (ABorder.Width * AScaleFactor, DocumentModel.Dpi));
...
function TdxRichEditBorderShadingDialogHelper.GetDocumentModel
  : TdxDocumentModel;
begin
  Result := Control.DocumentModel;
end;

function TdxRichEditBorderShadingDialogHelper.GetUnitConverter
...
procedure TdxRichEditBorderShadingDialogHelper.PopulateBorderLineStyle
  (AImageList: TcxImageList; AStrings: TStrings; ASkipNone: Boolean);
var
  ABitmap: TcxBitmap;
  ...
  begin
    ...
    TdxBorderLineWeightPainter.DrawBorderLineItem(ABorderInfo, ABitmap.cxCanvas,
      ABitmap.ClientRect, TdxAlphaColors.White, TdxAlphaColors.Black,
      UnitConverter);
...
procedure TdxRichEditBorderShadingDialogHelper.SetBorder
  (const Value: TdxBorderInfo);
begin
...
procedure TdxRichEditBorderShadingDialogHelper.SetColor
...
function TdxRichEditBorderShadingDialogHelper.ShouldSkipBorderStyle
  (AStyle: TdxBorderLineStyle; ASkipNone: Boolean): Boolean;
begin
  if ASkipNone and ((AStyle = TdxBorderLineStyle.None) or
    (AStyle = TdxBorderLineStyle.&Nil)) then
    Result := True
  else
    Result := (AStyle = TdxBorderLineStyle.Disabled) or
      (AStyle = TdxBorderLineStyle.DashDotStroked) or
      (AStyle = TdxBorderLineStyle.ThreeDEmboss) or
      (AStyle = TdxBorderLineStyle.ThreeDEngrave) or
      (AStyle = TdxBorderLineStyle.Inset) or
      (AStyle = TdxBorderLineStyle.Outset);
end;
...
procedure TdxBorderShadingUserControlHelper.btnHorizontBorderDownChecked
  (Sender: TObject);
begin
...
procedure TdxBorderShadingUserControlHelper.btnHorizontBorderInChecked
  (Sender: TObject);
begin
  if InsideSetProperties then
    Exit;
  if FBorderLineBtns[TdxTableCellBorderLine.HorizontalIn]
    .SpeedButtonOptions.Down and FBorderLineHorizontalInVisible then
  begin
    ...
    begin
      ...
      BorderLineHorizontalIn.Width :=
        DocumentModel.UnitConverter.TwipsToModelUnits(15);
    end;
...
procedure TdxBorderShadingUserControlHelper.btnHorizontBorderUpChecked
  (Sender: TObject);
begin
  if InsideSetProperties then
    Exit;
...
procedure TdxBorderShadingUserControlHelper.btnVerticalBorderInChecked
  (Sender: TObject);
begin
  if InsideSetProperties then
    Exit;
  if FBorderLineBtns[TdxTableCellBorderLine.VerticalIn]
    .SpeedButtonOptions.Down and BorderLineVerticalInVisible then
  begin
    BorderLineVerticalIn := FCurrentBorderInfo;
    if Mode = TdxSetMode.Grid then
    begin
      BorderLineVerticalIn.Style := TdxBorderLineStyle.Single;
      BorderLineVerticalIn.Width :=
        DocumentModel.UnitConverter.TwipsToModelUnits(15);
    end;
...
procedure TdxBorderShadingUserControlHelper.btnVerticalBorderLeftChecked
  (Sender: TObject);
begin
  if InsideSetProperties then
    Exit;
...
procedure TdxBorderShadingUserControlHelper.btnVerticalBorderRightChecked
  (Sender: TObject);
begin
  if InsideSetProperties then
    Exit;
...
constructor TdxBorderShadingUserControlHelper.Create
  (APreviewBorderShadingControl: TdxPreviewBorderShadingControlHelper);
begin
  inherited Create;
...
procedure TdxBorderShadingUserControlHelper.DoButtonBorderLineChecked
  (AIndex: TdxTableCellBorderLine);
begin
...
function TdxBorderShadingUserControlHelper.GetBorderLineInfo
  (const Index: TdxTableCellBorderLine): TdxBorderInfo;
begin
...
function TdxBorderShadingUserControlHelper.GetOnBorderLineChanged
  (const Index: TdxTableCellBorderLine): TNotifyEvent;
begin
  Result := FBorderLineBtnOnChanges[Index];
end;

procedure TdxBorderShadingUserControlHelper.Initialize(ABtnLineUp, ABtnLineDown,
  ABtnLineHorizontalIn, ABtnLineLeft, ABtnLineRight, ABtnLineVerticalIn
  : TcxButton);
begin
...
procedure TdxBorderShadingUserControlHelper.SetBorderLineInfo
  (const Index: TdxTableCellBorderLine; const Value: TdxBorderInfo);
begin
  if Value = nil then
    FBorderLines[Index] := nil
  else if FBorderLines[Index] = nil then
...
procedure TdxBorderShadingUserControlHelper.SetBorderLineHorizontalInVisible
  (const Value: Boolean);
begin
...
procedure TdxBorderShadingUserControlHelper.SetBorderLineVerticalInVisible
  (const Value: Boolean);
begin
...
procedure TdxBorderShadingUserControlHelper.SetBtnBorderLineVisible
  (const Index: TdxTableCellBorderLine; const Value: Boolean);
begin
...
class procedure TdxBorderShadingUserControlHelper.SetButtonDown
  (AButton: TcxButton; ADown: Boolean);
begin
...
procedure TdxBorderShadingUserControlHelper.SetButtonsVisible
  (const Value: Boolean);
begin
...
procedure TdxBorderShadingUserControlHelper.SetCurrentBorderInfo
  (const Value: TdxBorderInfo);
begin
...
procedure TdxBorderShadingUserControlHelper.SetDocumentModel
  (const Value: TdxDocumentModel);
begin
  FPreviewBSUserControl.DocumentModel := Value;
end;

procedure TdxBorderShadingUserControlHelper.SetDrawColumns
  (const Value: Boolean);
begin
  FPreviewBSUserControl.DrawColumns := Value;
end;

procedure TdxBorderShadingUserControlHelper.SetDrawParagraph
  (const Value: Boolean);
begin
  FPreviewBSUserControl.DrawParagraph := Value;
end;

procedure TdxBorderShadingUserControlHelper.SetFillColor
  (const Value: TdxAlphaColor);
begin
...
procedure TdxBorderShadingUserControlHelper.SetOnBorderLineChanged
  (const Index: TdxTableCellBorderLine; const Value: TNotifyEvent);
begin
...
begin
  FBorderLineBtns[TdxTableCellBorderLine.Down].OnClick :=
    btnHorizontBorderDownChecked;
  FBorderLineBtns[TdxTableCellBorderLine.Up].OnClick :=
    btnHorizontBorderUpChecked;
  FBorderLineBtns[TdxTableCellBorderLine.Right].OnClick :=
    btnVerticalBorderRightChecked;
  FBorderLineBtns[TdxTableCellBorderLine.Left].OnClick :=
    btnVerticalBorderLeftChecked;
  FBorderLineBtns[TdxTableCellBorderLine.HorizontalIn].OnClick :=
    btnHorizontBorderInChecked;
  FBorderLineBtns[TdxTableCellBorderLine.VerticalIn].OnClick :=
    btnVerticalBorderInChecked;
end;
...
procedure TdxPreviewBorderShadingControlHelper.Draw(ACanvas: TcxCanvas);
  ...
  function DrawLine(ALeft, ATop, ARight, ABottom: Integer;
    AColor: TdxAlphaColor; AWidth: Integer = 10): Integer;
  begin
...
var
  ...
  AVerticalLineRightWidth, AVerticalLineLeftWidth, AVerticalLineInWidth
    : Integer;
  AHorizontalLineInWidth, AHorizontalLineUpWidth,
    AHorizontalLineDownWidth: Integer;
begin
  if not Assigned(DocumentModel) then
    Exit;
  ADpiX := DocumentModel.DpiX;
  AGraphics := TdxGraphics.CreateFromHdc(ACanvas.Handle);
  APainter := TdxPainter(TdxCustomRichEditControlAccess(FControl)
    .MeasurementAndDrawingStrategy.CreateDocumentPainter(AGraphics));

  AConverter := TdxDocumentLayoutUnitPixelsConverter.Create(ADpiX);
  AHorizontalLinePainter := TdxRichEditHorizontalPatternLinePainter.Create
    (APainter, AConverter);
  AVerticalLinePainter := TdxRichEditVerticalPatternLinePainter.Create(APainter,
    AConverter);
  AExporter := TdxGraphicsDocumentLayoutExporterTableBorder.Create
    (DocumentModel, APainter, AHorizontalLinePainter, AVerticalLinePainter);
  AToLayoutUnitConverter := DocumentModel.UnitConverter.
    CreateConverterToLayoutUnits(TdxDocumentLayoutUnit.Pixel, ADpiX);
  ...
  try
    ...
    if not TdxAlphaColors.IsEmpty(FillColor) then
      AGraphics.FillRectangle(TRect.Create(0, 0, Width - 1, Height - 1),
        FillColor);

    if VerticalLineRight = TdxBorderLineState.Known then
      AVerticalLineRightWidth := AHelper.DrawVerticalLineRight(BorderInfoSource,
        DocumentModel, AToLayoutUnitConverter, AExporter, Width, Height);

    if VerticalLineRight = TdxBorderLineState.Unknown then
      AVerticalLineRightWidth := DrawLine(Width - 1, 0, Width - 1, Height,
        TdxAlphaColors.Silver);
    if VerticalLineLeft = TdxBorderLineState.Known then
      AVerticalLineLeftWidth := AHelper.DrawVerticalLineLeft(BorderInfoSource,
        DocumentModel, AToLayoutUnitConverter, AExporter, Width, Height)
    else if VerticalLineLeft = TdxBorderLineState.Unknown then
      AVerticalLineLeftWidth := DrawLine(0, 0, 0, Height,
        TdxAlphaColors.Silver);

    if VerticalLineIn = TdxBorderLineState.Known then
      AVerticalLineInWidth := AHelper.DrawVerticalLineIn(BorderInfoSource,
        DocumentModel, AToLayoutUnitConverter, AExporter, Width, Height)
    else if VerticalLineIn = TdxBorderLineState.Unknown then
      AVerticalLineInWidth := DrawLine(Width div 2, 0, Width div 2, Height,
        TdxAlphaColors.Silver);

    if HorizontalLineIn = TdxBorderLineState.Known then
      AHorizontalLineInWidth := AHelper.DrawHorizontalLineIn(BorderInfoSource,
        DocumentModel, AToLayoutUnitConverter, AExporter, Width, Height)
    else if HorizontalLineIn = TdxBorderLineState.Unknown then
      AHorizontalLineInWidth := DrawLine(0, Height div 2, Width, Height div 2,
        TdxAlphaColors.Silver);

    if HorizontalLineUp = TdxBorderLineState.Known then
      AHorizontalLineUpWidth := AHelper.DrawHorizontalLineUp(BorderInfoSource,
        DocumentModel, AToLayoutUnitConverter, AExporter, Width, Height)
    else if HorizontalLineUp = TdxBorderLineState.Unknown then
      AHorizontalLineUpWidth := DrawLine(0, 0, Width, 0, TdxAlphaColors.Silver);

    if HorizontalLineDown = TdxBorderLineState.Known then
      AHorizontalLineDownWidth := AHelper.DrawHorizontalLineDown
        (BorderInfoSource, DocumentModel, AToLayoutUnitConverter, AExporter,
        Width, Height)
    else if HorizontalLineDown = TdxBorderLineState.Unknown then
      AHorizontalLineDownWidth := DrawLine(0, Height - 1, Width, Height - 1,
        TdxAlphaColors.Silver);

    if DrawColumns then
    begin
      DrawRectangles(AGraphics, (Width - AVerticalLineRightWidth) div 2 -
        AVerticalLineLeftWidth - (AVerticalLineInWidth div 2),
        (Height) div 2 - AHorizontalLineUpWidth -
        (AHorizontalLineInWidth div 2), AVerticalLineLeftWidth,
        AHorizontalLineUpWidth);
      DrawRectangles(AGraphics, (Width - AVerticalLineRightWidth) div 2 -
        AVerticalLineLeftWidth - (AVerticalLineInWidth div 2),
        (Height) div 2 - AHorizontalLineDownWidth -
        (AHorizontalLineInWidth div 2), AVerticalLineLeftWidth,
        (Height { - horizontalLineDownWidth } ) div 2 +
        (AHorizontalLineInWidth div 2));
      DrawRectangles(AGraphics, (Width - AVerticalLineRightWidth) div 2 -
        (AVerticalLineInWidth div 2) - AVerticalLineRightWidth,
        (Height) div 2 - AHorizontalLineUpWidth -
        (AHorizontalLineInWidth div 2), (Width { - verticalLineRightWidth } )
        div 2 + (AVerticalLineInWidth div 2), AHorizontalLineUpWidth);
      DrawRectangles(AGraphics, (Width - AVerticalLineRightWidth) div 2 -
        (AVerticalLineInWidth div 2) - AVerticalLineRightWidth,
        (Height) div 2 - AHorizontalLineDownWidth -
        (AHorizontalLineInWidth div 2), (Width { - verticalLineRightWidth } )
        div 2 + (AVerticalLineInWidth div 2),
        (Height { - horizontalLineDownWidth } ) div 2 +
        (AHorizontalLineInWidth div 2));
    end
    else if DrawParagraph then
    begin
      DrawRectangles(AGraphics, Width - AVerticalLineLeftWidth -
        AVerticalLineRightWidth, Height div 2 - AHorizontalLineUpWidth -
        (AHorizontalLineInWidth div 2), AVerticalLineLeftWidth,
        AHorizontalLineUpWidth);
      DrawRectangles(AGraphics, Width - AVerticalLineLeftWidth -
        AVerticalLineRightWidth, Height div 2 - AHorizontalLineDownWidth -
        (AHorizontalLineInWidth div 2), AVerticalLineLeftWidth,
        Height div 2 + (AHorizontalLineInWidth div 2));
    end
    else
      DrawRectangles(AGraphics, Width - AVerticalLineLeftWidth -
        AVerticalLineRightWidth, Height - AHorizontalLineUpWidth -
        AHorizontalLineDownWidth, AVerticalLineLeftWidth,
        AHorizontalLineUpWidth);
  finally
    AHelper.Free;
...
procedure TdxPreviewBorderShadingControlHelper.DrawRectangles
  (AGraphics: TdxGraphics; AWidth, AHeight, AX, AY: Integer);
const
  HeightRectangle = 3;
...
begin
  ACountRectangle := (AHeight - PageBorder[0] - PageBorder[1])
    div (2 * HeightRectangle);
  for I := 0 to ACountRectangle - 1 do
    AGraphics.FillRectangle(TRect.CreateSize(AX + PageBorder[2],
      AY + I * 2 * HeightRectangle + PageBorder[0], AWidth - PageBorder[3] -
      PageBorder[2], HeightRectangle),
      TdxAlphaColors.FromColor(BrushesLightGray));
end;

function TdxPreviewBorderShadingControlHelper.GetBorderLineState
  (const Index: TdxTableCellBorderLine): TdxBorderLineState;
begin
...
procedure TdxPreviewBorderShadingControlHelper.SetBorderLineState
  (const Index: TdxTableCellBorderLine; const Value: TdxBorderLineState);
begin
...
procedure TdxPreviewBorderShadingControlHelper.SetDrawColumns
  (const Value: Boolean);
begin
  FDrawColumns := Value;
  DoChange;
...
procedure TdxPreviewBorderShadingControlHelper.SetDrawPageBorderHorizontalDown
  (const Value: Boolean);
begin
...
procedure TdxPreviewBorderShadingControlHelper.SetDrawPageBorderHorizontalUp
  (const Value: Boolean);
begin
...
procedure TdxPreviewBorderShadingControlHelper.SetDrawPageBorderVerticalLeft
  (const Value: Boolean);
begin
...
procedure TdxPreviewBorderShadingControlHelper.SetDrawPageBorderVerticalRight
  (const Value: Boolean);
begin
...
procedure TdxPreviewBorderShadingControlHelper.SetDrawParagraph
  (const Value: Boolean);
begin
...
procedure TdxPreviewBorderShadingControlHelper.SetFillColor
  (const Value: TdxAlphaColor);
begin
  FFillColor := Value;
  DoChange;
...
function TdxPreviewBorderViewInfo.GetBounds(ATableViewInfo
  : TdxTableViewInfo): TRect;
begin
  Result := Rect(0, 0, 0, 0);
end;

function TdxPreviewBorderViewInfo.GetConverter
