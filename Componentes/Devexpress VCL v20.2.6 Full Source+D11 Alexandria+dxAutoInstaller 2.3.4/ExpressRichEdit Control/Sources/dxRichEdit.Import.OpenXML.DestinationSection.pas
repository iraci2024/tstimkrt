...
type
  ...
  protected
    class function OnColumns(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnLineNumbering(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnPageNumbering(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnPaperSource(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnMargins(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnPageSize(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnTextDirectionOpenXml
      (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
    class function OnTextDirectionWordML(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnVerticalAlignment(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnSectionStartType(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnSectionDifferentFirstPage
      (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
    class function OnFootNoteProperties(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnEndNoteProperties(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  end;
  ...
  protected
    ...
    class function OnSectionHeaderReference
      (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
    class function OnSectionFooterReference
      (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
  end;
...
class function TdxSectionDestinationBase.OnColumns
...
class function TdxSectionDestinationBase.OnLineNumbering
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxSectionDestinationBase.OnPageNumbering
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxSectionDestinationBase.OnPaperSource
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxSectionDestinationBase.OnMargins
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxSectionDestinationBase.OnPageSize
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxSectionDestinationBase.OnTextDirectionOpenXml
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxWordProcessingMLBaseImporter(AImporter)
    .CreateOpenXmlSectionTextDirectionDestination;
end;

class function TdxSectionDestinationBase.OnTextDirectionWordML
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxWordProcessingMLBaseImporter(AImporter)
    .CreateWordMLSectionTextDirectionDestination;
end;

class function TdxSectionDestinationBase.OnVerticalAlignment
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxSectionDestinationBase.OnSectionStartType
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxSectionDestinationBase.OnSectionDifferentFirstPage
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxSectionDestinationBase.OnFootNoteProperties
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxSectionLevelFootNotePropertiesDestination.Create(AImporter,
    AImporter.CurrentSection.FootNote);
end;

class function TdxSectionDestinationBase.OnEndNoteProperties
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxSectionLevelEndNotePropertiesDestination.Create(AImporter,
    AImporter.CurrentSection.EndNote);
end;
...
class function TdxSectionDestination.CreateElementHandlerTable
...
class function TdxSectionDestination.OnSectionHeaderReference
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxSectionDestination.OnSectionFooterReference
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  if AImporter.DocumentModel.DocumentCapabilities.HeadersFootersAllowed then
...
class function TdxColumnsDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
class function TdxColumnsDestination.GetThis
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter): TdxColumnsDestination;
begin
...
begin
  Columns.EqualWidthColumns := Importer.GetWpSTOnOffValue(AReader,
    'equalWidth', False);
  Columns.DrawVerticalSeparator := Importer.GetWpSTOnOffValue(AReader,
    'sep', False);
...
class function TdxColumnsDestination.OnColumn
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
var
  AColumnInfos: TdxColumnInfoCollection;
...
constructor TdxColumnDestination.Create(AImporter
...
begin
  ...
  try
    ...
    AColumnInfo.Space :=
      Max(0, UnitConverter.TwipsToModelUnits(AColumnInfo.Space));
...
procedure TdxSectionLineNumberingDestination.ProcessElementOpen
...
begin
  ...
  ALineNumbering.StartingLineNumber :=
    Max(1, Importer.GetWpSTIntegerValue(AReader, 'start', MinInt));
  ACountByAttribute := TdxWordProcessingMLValue.Create('countBy', 'count-by');
  ALineNumbering.Step := Max(0, Importer.GetWpSTIntegerValue(AReader,
    Importer.GetWordProcessingMLValue(ACountByAttribute), MinInt));
  ALineNumbering.Distance := UnitConverter.TwipsToModelUnits
    (Math.Max(0, Importer.GetWpSTIntegerValue(AReader, 'distance', MinInt)));
  ALineNumbering.NumberingRestartType := TdxWordProcessingMLBaseImporter
    (Importer).GetWpEnumValue<TdxLineNumberingRestart>(AReader, 'restart',
    TdxOpenXmlExporter.LineNumberingRestartTable,
    TdxLineNumberingRestart.NewPage);
end;

{ TdxSectionPageNumberingDestination }

procedure TdxSectionPageNumberingDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
var
...
begin
  ...
  APageNumbering.NumberingFormat := TdxWordProcessingMLBaseImporter(Importer)
    .GetWpEnumValue<TdxNumberingFormat>(AReader, 'fmt',
  ...
  APageNumbering.ChapterSeparator := TdxWordProcessingMLBaseImporter(Importer)
    .GetWpEnumValue<Char>(AReader, Importer.GetWordProcessingMLValue
    (AChapSepAttribute), TdxOpenXmlExporter.ChapterSeparatorsTable, '.');
end;

{ TdxSectionPaperSourceDestination }

procedure TdxSectionPaperSourceDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
var
...
begin
  ...
  ASettings.FirstPagePaperSource :=
    Max(1, Importer.GetWpSTIntegerValue(AReader, 'first', MinInt));
  ASettings.OtherPagePaperSource :=
    Max(1, Importer.GetWpSTIntegerValue(AReader, 'other', MinInt));
end;

{ TdxSectionMarginsDestination }

procedure TdxSectionMarginsDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
var
  AValue: Integer;
...
procedure TdxSectionPageSizeDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
var
  AValue: Integer;
...
begin
  ...
  try
    ...
    AOrientation := AReader.GetAttribute('orient',
...
procedure TdxSectionTextDirectionDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
  Importer.CurrentSection.GeneralSettings.TextDirection :=
    TdxWordProcessingMLBaseImporter(Importer).GetWpEnumValue<TdxTextDirection>
    (AReader, 'val', TdxOpenXmlExporter.TextDirectionTable,
    TdxTextDirection.LeftToRightTopToBottom);
end;

{ TdxSectionVerticalAlignmentDestination }

procedure TdxSectionVerticalAlignmentDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
  Importer.CurrentSection.GeneralSettings.VerticalTextAlignment :=
    TdxWordProcessingMLBaseImporter(Importer)
    .GetWpEnumValue<TdxVerticalAlignment>(AReader, 'val',
    TdxOpenXmlExporter.VerticalAlignmentTable, TdxVerticalAlignment.Top);
end;

{ TdxSectionStartTypeDestination }

procedure TdxSectionStartTypeDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
  Importer.CurrentSection.GeneralSettings.StartType :=
    TdxWordProcessingMLBaseImporter(Importer)
    .GetWpEnumValue<TdxSectionStartType>(AReader, 'val',
    TdxOpenXmlExporter.SectionStartTypeTable, TdxSectionStartType.NextPage);
end;

{ TdxSectionDifferentFirstPageDestination }

procedure TdxSectionDifferentFirstPageDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
  Importer.CurrentSection.GeneralSettings.DifferentFirstPage :=
