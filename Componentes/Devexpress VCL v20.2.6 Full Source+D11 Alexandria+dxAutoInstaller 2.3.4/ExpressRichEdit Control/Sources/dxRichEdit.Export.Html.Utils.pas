...
{$ENDREGION}
  ...
  strict private
    class function CreateUnitTable
      : TdxEnumeratedDictionary<TdxGraphicUnit, string>; static;
    class function CreateHorizontalAlignmentTable
      : TdxEnumeratedDictionary<TdxGPStringAlignment, string>; static;
  ...
  public
    ...
    class function FontSizeToString(ASize: Single; AUnit: TdxGraphicUnit)
      : string; overload; static;
    class function FontSizeToStringInPixels(ASize: Single;
      AUnit: TdxGraphicUnit): string; static;
  end;
  ...
  protected
    ...
    class function CollapsePercentUFromStringInternal(const AStr: string;
      AEncoding: TEncoding): string; static;
    class function IndexOfHtmlAttributeEncodingChars(const AHtml: string;
      AStartPosition: Integer): Integer; static;
    class function IndexOfHtmlEncodingChars(const AHtml: string;
      AStartPosition: Integer): Integer; static;
    class function IsDirectorySeparatorChar(AValue: Char): Boolean; static;
    class function UrlDecodeBytesFromBytesInternal(const ABuffer: TArray<Byte>;
      AOffset, ACount: Integer): TArray<Byte>; static;
    class function UrlDecodeStringFromBytesInternal(const ABuffer: TArray<Byte>;
      AOffset, ACount: Integer; AEncoding: TEncoding): string; static;
    class function UrlDecodeStringFromStringInternal(const AUrl: string;
      AEncoding: TEncoding): string; static;
    class function UrlEncodeBytesToBytesInternal(const ABytes: TArray<Byte>;
      AOffset, ACount: Integer; AAlwaysCreateReturnValue: Boolean)
      : TArray<Byte>; static;
    class function UrlEncodeBytesToBytesInternalNonAscii
      (const ABytes: TArray<Byte>; AOffset, ACount: Integer;
      AAlwaysCreateReturnValue: Boolean): TArray<Byte>; static;
    class function UrlEncodeUnicodeStringToStringInternal(const AUrl: string;
      AIgnoreAscii: Boolean): string; static;
  public
    class function HexToInt(AValue: Char): Integer; static;
    class function HtmlAttributeEncode(const AValue: string): string;
      overload; static;
    class procedure HtmlAttributeEncode(const AHtml: string;
      AOutput: TTextWriter); overload; static;
    class procedure HtmlAttributeEncodeInternal(const AHtml: string;
      AWriter: TTextWriter); static;
    class function HtmlDecode(const AValue: string): string; overload; static;
    class procedure HtmlDecode(const AValue: string; AOutput: TTextWriter);
      overload; static;
    class function HtmlEncode(const AValue: string): string; overload; static;
    class procedure HtmlEncode(const AHtml: string; AOutput: TTextWriter);
      overload; static;
    ...
    class function UrlDecode(const ABytes: TArray<Byte>; AEncoding: TEncoding)
      : string; overload; static;
    class function UrlDecode(const AUrl: string; AEncoding: TEncoding): string;
      overload; static;
    class function UrlDecode(const ABytes: TArray<Byte>;
      AOffset, ACount: Integer; AEncoding: TEncoding): string; overload; static;
    class function UrlDecodeToBytes(const AValue: TArray<Byte>): TArray<Byte>;
      overload; static;
    class function UrlDecodeToBytes(const AUrl: string): TArray<Byte>;
      overload; static;
    class function UrlDecodeToBytes(const AUrl: string; AEncoding: TEncoding)
      : TArray<Byte>; overload; static;
    class function UrlDecodeToBytes(const ABytes: TArray<Byte>;
      AOffset, ACount: Integer): TArray<Byte>; overload; static;
    class function UrlEncode(const ABytes: TArray<Byte>): string;
      overload; static;
    class function UrlEncode(const AUrl: string): string; overload; static;
    class function UrlEncode(const AUrl: string; AEncoding: TEncoding): string;
      overload; static;
    class function UrlEncode(const ABytes: TArray<Byte>;
      AOffset, ACount: Integer): string; overload; static;
    class function UrlEncodeNonAscii(const AUrl: string; AEncoding: TEncoding)
      : string; static;
    class function UrlEncodeSpaces(const AUrl: string): string; static;
    class function UrlEncodeToBytes(const AUrl: string): TArray<Byte>;
      overload; static;
    class function UrlEncodeToBytes(const ABytes: TArray<Byte>): TArray<Byte>;
      overload; static;
    class function UrlEncodeToBytes(const AUrl: string; AEncoding: TEncoding)
      : TArray<Byte>; overload; static;
    class function UrlEncodeToBytes(const ABytes: TArray<Byte>;
      AOffset, ACount: Integer): TArray<Byte>; overload; static;
    class function UrlEncodeUnicode(const AUrl: string): string; static;
    class function UrlEncodeUnicodeToBytes(const AUrl: string)
      : TArray<Byte>; static;
    class function UrlPathEncode(const AUrl: string): string; static;
    class function UrlEncodeToUnicodeCompatible(const AStringData: string)
      : string; static;
  ...
  public
    constructor Create;
    property Items[const AKey: string]: TValue read GetItem
...
begin
  if FNumBytes <= 0 then
    Exit;
  FNumChars := FNumChars + FEncoding.GetChars(FByteBuffer, 0, FNumBytes,
    FCharBuffer, FNumChars);
  FNumBytes := 0;
end;
...
begin
  FEntitiesList := TArray<string>.Create('"-quot', '&-amp', '<-lt', '>-gt',
    #$00A0'-nbsp', #$00A1'-iexcl', #$00A2'-cent', #$00A3'-pound',
    #$00A4'-curren', #$00A5'-yen', #$00A6'-brvbar', #$00A7'-sect', #$00A8'-uml',
    #$00A9'-copy', #$00AA'-ordf', #$00AB'-laquo', #$00AC'-not', #$00AD'-shy',
    #$00AE'-reg', #$00AF'-macr', #$00B0'-deg', #$00B1'-plusmn', #$00B2'-sup2',
    #$00B3'-sup3', #$00B4'-acute', #$00B5'-micro', #$00B6'-para',
    #$00B7'-middot', #$00B8'-cedil', #$00B9'-sup1', #$00BA'-ordm',
    #$00BB'-raquo', #$00BC'-frac14', #$00BD'-frac12', #$00BE'-frac34',
    #$00BF'-iquest', #$00C0'-Agrave', #$00C1'-Aacute', #$00C2'-Acirc',
    #$00C3'-Atilde', #$00C4'-Auml', #$00C5'-Aring', #$00C6'-AElig',
    #$00C7'-Ccedil', #$00C8'-Egrave', #$00C9'-Eacute', #$00CA'-Ecirc',
    #$00CB'-Euml', #$00CC'-Igrave', #$00CD'-Iacute', #$00CE'-Icirc',
    #$00CF'-Iuml', #$00D0'-ETH', #$00D1'-Ntilde', #$00D2'-Ograve',
    #$00D3'-Oacute', #$00D4'-Ocirc', #$00D5'-Otilde', #$00D6'-Ouml',
    #$00D7'-times', #$00D8'-Oslash', #$00D9'-Ugrave', #$00DA'-Uacute',
    #$00DB'-Ucirc', #$00DC'-Uuml', #$00DD'-Yacute', #$00DE'-THORN',
    #$00DF'-szlig', #$00E0'-agrave', #$00E1'-aacute', #$00E2'-acirc',
    #$00E3'-atilde', #$00E4'-auml', #$00E5'-aring', #$00E6'-aelig',
    #$00E7'-ccedil', #$00E8'-egrave', #$00E9'-eacute', #$00EA'-ecirc',
    #$00EB'-euml', #$00EC'-igrave', #$00ED'-iacute', #$00EE'-icirc',
    #$00EF'-iuml', #$00F0'-eth', #$00F1'-ntilde', #$00F2'-ograve',
    #$00F3'-oacute', #$00F4'-ocirc', #$00F5'-otilde', #$00F6'-ouml',
    #$00F7'-divide', #$00F8'-oslash', #$00F9'-ugrave', #$00FA'-uacute',
    #$00FB'-ucirc', #$00FC'-uuml', #$00FD'-yacute', #$00FE'-thorn',
    #$00FF'-yuml', #$0152'-OElig', #$0153'-oelig', #$0160'-Scaron',
    #$0161'-scaron', #$0178'-Yuml', #$0192'-fnof', #$02C6'-circ',
    #$02DC'-tilde', #$0391'-Alpha', #$0392'-Beta', #$0393'-Gamma',
    #$0394'-Delta', #$0395'-Epsilon', #$0396'-Zeta', #$0397'-Eta',
    #$0398'-Theta', #$0399'-Iota', #$039A'-Kappa', #$039B'-Lambda', #$039C'-Mu',
    #$039D'-Nu', #$039E'-Xi', #$039F'-Omicron', #$03A0'-Pi', #$03A1'-Rho',
    #$03A3'-Sigma', #$03A4'-Tau', #$03A5'-Upsilon', #$03A6'-Phi', #$03A7'-Chi',
    #$03A8'-Psi', #$03A9'-Omega', #$03B1'-alpha', #$03B2'-beta', #$03B3'-gamma',
    #$03B4'-delta', #$03B5'-epsilon', #$03B6'-zeta', #$03B7'-eta',
    #$03B8'-theta', #$03B9'-iota', #$03BA'-kappa', #$03BB'-lambda', #$03BC'-mu',
    #$03BD'-nu', #$03BE'-xi', #$03BF'-omicron', #$03C0'-pi', #$03C1'-rho',
    #$03C2'-sigmaf', #$03C3'-sigma', #$03C4'-tau', #$03C5'-upsilon',
    #$03C6'-phi', #$03C7'-chi', #$03C8'-psi', #$03C9'-omega', #$03D1'-thetasym',
    #$03D2'-upsih', #$03D6'-piv', #$2002'-ensp', #$2003'-emsp', #$2009'-thinsp',
    #$200C'-zwnj', #$200D'-zwj', #$200E'-lrm', #$200F'-rlm', #$2013'-ndash',
    #$2014'-mdash', #$2018'-lsquo', #$2019'-rsquo', #$201A'-sbquo',
    #$201C'-ldquo', #$201D'-rdquo', #$201E'-bdquo', #$2020'-dagger',
    #$2021'-Dagger', #$2022'-bull', #$2026'-hellip', #$2030'-permil',
    #$2032'-prime', #$2033'-Prime', #$2039'-lsaquo', #$203A'-rsaquo',
    #$203E'-oline', #$2044'-frasl', #$20AC'-euro', #$2111'-image',
    #$2118'-weierp', #$211C'-real', #$2122'-trade', #$2135'-alefsym',
    #$2190'-larr', #$2191'-uarr', #$2192'-rarr', #$2193'-darr', #$2194'-harr',
    #$21B5'-crarr', #$21D0'-lArr', #$21D1'-uArr', #$21D2'-rArr', #$21D3'-dArr',
    #$21D4'-hArr', #$2200'-forall', #$2202'-part', #$2203'-exist',
    #$2205'-empty', #$2207'-nabla', #$2208'-isin', #$2209'-notin', #$220B'-ni',
    #$220F'-prod', #$2211'-sum', #$2212'-minus', #$2217'-lowast',
    #$221A'-radic', #$221D'-prop', #$221E'-infin', #$2220'-ang', #$2227'-and',
    #$2228'-or', #$2229'-cap', #$222A'-cup', #$222B'-int', #$2234'-there4',
    #$223C'-sim', #$2245'-cong', #$2248'-asymp', #$2260'-ne', #$2261'-equiv',
    #$2264'-le', #$2265'-ge', #$2282'-sub', #$2283'-sup', #$2284'-nsub',
    #$2286'-sube', #$2287'-supe', #$2295'-oplus', #$2297'-otimes',
    #$22A5'-perp');
    ...
    try
      ...
      begin
        ...
        for I := Low(FEntitiesList) to High(FEntitiesList) do
          FEntitiesLookup.Add(TdxStringHelper.Substring(FEntitiesList[I], 2),
            FEntitiesList[I][1]);
      end;
    finally
      TMonitor.Exit(FLock);
...
class function TdxHtmlConvert.CreateUnitTable
  : TdxEnumeratedDictionary<TdxGraphicUnit, string>;
begin
...
class function TdxHtmlConvert.CreateHorizontalAlignmentTable
  : TdxEnumeratedDictionary<TdxGPStringAlignment, string>;
begin
...
class function TdxHtmlConvert.CreateVerticalAlignmentTable
  : TdxEnumeratedDictionary<TdxGPStringAlignment, string>;
begin
  Result := TdxEnumeratedDictionary<TdxGPStringAlignment, string>.Create;
...
class function TdxHtmlConvert.FontSizeToString(ASize: Single;
  AUnit: TdxGraphicUnit): string;
var
  AUnitType: string;
begin
  if (AUnit = TdxGraphicUnit.guDocument) or not not FUnitHT.TryGetValue(AUnit,
    AUnitType) then
    AUnitType := 'pt';
  ...
  if AUnitType = 'px' then
    ...
    Result := FloatToStr(SimpleRoundTo(ASize, -1),
      TdxCultureInfo.InvariantCulture.FormatSettings) + AUnitType;
end;

class function TdxHtmlConvert.FontSizeToStringInPixels(ASize: Single;
  AUnit: TdxGraphicUnit): string;
// var
...
class function TdxHttpUtility.CollapsePercentUFromStringInternal
  (const AStr: string; AEncoding: TEncoding): string;
var
...
var
  AHtmlAttributeEncodingIndex, AHtmlAttributeEncodingStartIndex,
    AValueLen: Integer;
  ...
  try
    ...
    begin
      if AHtmlAttributeEncodingIndex > AHtmlAttributeEncodingStartIndex then
        ABuilder.Append(AValue, AHtmlAttributeEncodingStartIndex,
          AHtmlAttributeEncodingIndex - AHtmlAttributeEncodingStartIndex);
      ...
      AHtmlAttributeEncodingIndex := IndexOfHtmlAttributeEncodingChars(AValue,
        AHtmlAttributeEncodingStartIndex);
      if AHtmlAttributeEncodingIndex <> -1 then
        Continue;
      ABuilder.Append(AValue, AHtmlAttributeEncodingStartIndex,
        AValueLen - AHtmlAttributeEncodingStartIndex);
      Break;
    end;
...
class procedure TdxHttpUtility.HtmlAttributeEncode(const AHtml: string;
  AOutput: TTextWriter);
var
...
class procedure TdxHttpUtility.HtmlAttributeEncodeInternal(const AHtml: string;
  AWriter: TTextWriter);
var
  ANum, AIndex: Integer;
begin
  ...
  begin
    ...
    begin
      ...
      if ANum <> -1 then
        Continue;
      AWriter.Write(TdxStringHelper.Substring(AHtml, AIndex,
        Length(AHtml) - AIndex));
    end;
    Break;
  end;
...
class procedure TdxHttpUtility.HtmlDecode(const AValue: string;
  AOutput: TTextWriter);
var
...
begin
  ...
  begin
    ...
    if C = '&' then
    begin
      AEntityEndingIndex := TdxStringHelper.IndexOfAny(AValue,
        EntityEndingChars, I + 1);
      if (AEntityEndingIndex > 0) and (P[AEntityEndingIndex] = ';') then
      begin
        AEntity := TdxStringHelper.Substring(AValue, I + 1,
          (AEntityEndingIndex - I) - 1);
        if (Length(AEntity) > 1) and (AEntity[1] = '#') then
        begin
          try
            if (AEntity[2] = 'x') or (AEntity[2] = 'X') then
            begin
              if TdxNumber.TryParse(TdxStringHelper.Substring(AEntity, 2),
                TdxNumberStyles.AllowHexSpecifier, AIntValue) then
              begin
                C := Char(AIntValue);
            ...
            begin
              if TdxNumber.TryParse(TdxStringHelper.Substring(AEntity, 1),
                AIntValue) then
              begin
                C := Char(AIntValue);
                I := AEntityEndingIndex;
...
class procedure TdxHttpUtility.HtmlEncode(const AHtml: string;
  AOutput: TTextWriter);
var
...
class function TdxHttpUtility.IndexOfHtmlAttributeEncodingChars
  (const AHtml: string; AStartPosition: Integer): Integer;
begin
  Result := TdxStringHelper.IndexOfAny(AHtml, ['"', '&', '<'], AStartPosition);
end;

class function TdxHttpUtility.IndexOfHtmlEncodingChars(const AHtml: string;
  AStartPosition: Integer): Integer;
var
  ALen: Integer;
  P: PChar;
  C: Char;
...
begin
  if ((AValue >= 'a') and (AValue <= 'z')) or
    ((AValue >= 'A') and (AValue <= 'Z')) or
    ((AValue >= '0') and (AValue <= '9')) then
    Exit(True);
...
class function TdxHttpUtility.UrlDecode(const ABytes: TArray<Byte>;
...
class function TdxHttpUtility.UrlDecode(const AUrl: string;
  AEncoding: TEncoding): string;
begin
  if AUrl = '' then
    Exit('');
...
class function TdxHttpUtility.UrlDecode(const ABytes: TArray<Byte>;
  AOffset, ACount: Integer; AEncoding: TEncoding): string;
begin
  if ACount = 0 then
    Exit('');
  ...
  Result := UrlDecodeStringFromBytesInternal(ABytes, AOffset, ACount,
    AEncoding);
end;

class function TdxHttpUtility.UrlDecodeBytesFromBytesInternal
  (const ABuffer: TArray<Byte>; AOffset, ACount: Integer): TArray<Byte>;
var
...
begin
  ...
  begin
    ...
    if ACurrentByte = $2B then
      ACurrentByte := $20
    else if (ACurrentByte = $25) and (I < ACount - 2) then
    begin
...
class function TdxHttpUtility.UrlDecodeStringFromBytesInternal
  (const ABuffer: TArray<Byte>; AOffset, ACount: Integer;
  AEncoding: TEncoding): string;
var
  ADecoder: TdxUrlDecoder;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          AChr := Char((AByte1 shl 12) or (AByte2 shl 8) or (AByte3 shl 4)
            or AByte4);
          Inc(I, 5 + 1);
...
class function TdxHttpUtility.UrlDecodeStringFromStringInternal
  (const AUrl: string; AEncoding: TEncoding): string;
var
  ADecoder: TdxUrlDecoder;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          ACh := Char((ANum1 shl 12) or (ANum2 shl 8) or (ANum3 shl 4)
            or ANum4);
          Inc(I, 5 + 1);
          ADecoder.AddChar(ACh);
          Continue;
...
class function TdxHttpUtility.UrlDecodeToBytes(const AValue: TArray<Byte>)
  : TArray<Byte>;
begin
  if AValue = nil then
    Exit(nil);
...
class function TdxHttpUtility.UrlDecodeToBytes(const AUrl: string)
  : TArray<Byte>;
begin
  if AUrl = '' then
    Exit(nil);
...
class function TdxHttpUtility.UrlDecodeToBytes(const AUrl: string;
  AEncoding: TEncoding): TArray<Byte>;
begin
  if AUrl = '' then
    Exit(nil);
...
class function TdxHttpUtility.UrlDecodeToBytes(const ABytes: TArray<Byte>;
  AOffset, ACount: Integer): TArray<Byte>;
begin
  if ACount = 0 then
    Exit(nil);
...
class function TdxHttpUtility.UrlEncode(const AUrl: string;
  AEncoding: TEncoding): string;
var
  AUrlBytes: TArray<Byte>;
begin
...
class function TdxHttpUtility.UrlEncode(const ABytes: TArray<Byte>;
...
class function TdxHttpUtility.UrlEncodeBytesToBytesInternal
  (const ABytes: TArray<Byte>; AOffset, ACount: Integer;
...
begin
  ...
  begin
    ...
    if ACh = ' ' then
      Inc(ASpacesCount)
    else if not IsSafe(ACh) then
      Inc(AUnsafeCharsCount);
  end;
  if not AAlwaysCreateReturnValue and (ASpacesCount = 0) and
    (AUnsafeCharsCount = 0) then
    Exit(ABytes);
...
class function TdxHttpUtility.UrlEncodeBytesToBytesInternalNonAscii
  (const ABytes: TArray<Byte>; AOffset, ACount: Integer;
  AAlwaysCreateReturnValue: Boolean): TArray<Byte>;
var
  I, ANum: Integer;
...
class function TdxHttpUtility.UrlEncodeNonAscii(const AUrl: string;
  AEncoding: TEncoding): string;
var
  ABytes: TArray<Byte>;
begin
  ...
  ABytes := UrlEncodeBytesToBytesInternalNonAscii(ABytes, 0,
    Length(ABytes), False);
...
class function TdxHttpUtility.UrlEncodeToBytes(const AUrl: string)
  : TArray<Byte>;
begin
  if AUrl = '' then
    Exit(nil);
...
class function TdxHttpUtility.UrlEncodeToBytes(const ABytes: TArray<Byte>)
  : TArray<Byte>;
begin
  if ABytes = nil then
    Exit(nil);
...
class function TdxHttpUtility.UrlEncodeUnicodeStringToStringInternal
  (const AUrl: string; AIgnoreAscii: Boolean): string;
var
  ABuilder: TStringBuilder;
  C: Char;
begin
...
class function TdxHttpUtility.UrlEncodeUnicodeToBytes(const AUrl: string)
  : TArray<Byte>;
begin
  if AUrl = '' then
    Exit(nil);
...
begin
  ...
  if AArgumentsIndex >= 0 then
    Exit(UrlPathEncode(TdxStringHelper.Substring(AUrl, 0, AArgumentsIndex)) +
      TdxStringHelper.Substring(AUrl, AArgumentsIndex));
  Result := UrlEncodeSpaces(UrlEncodeNonAscii(AUrl, TdxEncoding.UTF8));
end;

class function TdxHttpUtility.UrlEncodeToUnicodeCompatible(const AStringData
  : string): string;
var
  ABuilder: TStringBuilder;
  C: Char;
...
begin
  Result := (Length(APath) > 2) and IsDirectorySeparatorChar(APath[1]) and
    IsDirectorySeparatorChar(APath[2]);
end;
