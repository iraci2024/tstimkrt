...
type
  ...
  protected
    ...
    class property SwitchesWithArgument: TdxStringBooleanDictionary
      read FSwitchesWithArgument;
  public
    ...
    property EnableConversionForVerticalFormatting: Boolean
      read FEnableConversionForVerticalFormatting;
  end;
...
function TdxMergefieldField.GetSwitchesWithArguments
...
procedure TdxMergefieldField.Initialize(APieceTable: TdxCustomPieceTable;
...
function TdxMergefieldField.GetCalculatedValueCore(ASourcePieceTable
...
begin
  ...
  AValue := AFieldDataService.GetFieldValue
    (ATable.DocumentModel.MailMergeProperties, FDataFieldName, FMappedField,
    AMailMergeDataMode, ATable, ADocumentField);
  if AValue.IsEmpty or (not AValue.IsObject and (VarIsNull(AValue.AsVariant) or
  ...
  Result := TdxCalculatedFieldValue.Create(FTextBeforeIfFieldNotBlank +
    AValue.ToString + FTextAfterIfFieldNotBlank);
end;
