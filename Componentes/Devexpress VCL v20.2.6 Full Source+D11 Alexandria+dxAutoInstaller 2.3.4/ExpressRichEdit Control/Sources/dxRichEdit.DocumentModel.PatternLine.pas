...
uses
  dxCore, Generics.Defaults, Generics.Collections, dxCoreClasses, Graphics,
  Types, cxGeometry, dxCoreGraphics,
...
type
  ...
  public
    function CalcLineBounds(const ARect: TRect; AThickness: Integer): TRect;
      virtual; abstract;
    procedure Draw(const APainter: IdxPatternLinePainter;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); virtual; abstract;
    function CalcLinePenVerticalOffset(const ALineBounds: TdxRectF)
      : Single; virtual;
  ...
  public
    procedure Draw(const APainter: IdxPatternLinePainter;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); reintroduce;
      overload; override;
    procedure Draw(const APainter: IdxStrikeoutPainter; const ABounds: TdxRectF;
      AColor: TdxAlphaColor); reintroduce; overload; virtual; abstract;
  end;
  ...
  public
    procedure Draw(const APainter: IdxStrikeoutPainter; const ABounds: TdxRectF;
      AColor: TdxAlphaColor); override;
    function CalcLineBounds(const ARect: TRect; AThickness: Integer)
      : TRect; override;
    function CalcLinePenVerticalOffset(const ALineBounds: TdxRectF)
      : Single; override;
  end;
  ...
  public
    procedure Draw(const APainter: IdxPatternLinePainter;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload; override;
    procedure Draw(const APainter: IdxUnderlinePainter; const ABounds: TdxRectF;
      AColor: TdxAlphaColor); reintroduce; overload; virtual; abstract;
  ...
  public
    function CalcLineBounds(const R: TRect; AThickness: Integer)
      : TRect; override;
    procedure Draw(const APainter: IdxPatternLinePainter;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); override;
    procedure Draw(const APainter: IdxUnderlinePainter; const ABounds: TdxRectF;
      AColor: TdxAlphaColor); override;
  end;
...
function TdxPatternLine<T>.CalcLinePenVerticalOffset(const ALineBounds
  : TdxRectF): Single;
begin
...
procedure TdxStrikeout.Draw(const APainter: IdxPatternLinePainter;
...
function TdxPatternLineRepository.GetPatternLineByTypeInternal
  (AType: TClass): TObject;
begin
...
function TdxPatternLineRepository.UnregisterPatternLine(ALine: TObject)
  : Boolean;
begin
  Assert(ALine <> nil, 'ALine = nil');
...
function TdxStrikeoutRepository.GetPatternLineByType
  (ALine: TdxStrikeoutType): Pointer;
var
  AType: TClass;
begin
  case ALine of
...
function TdxNoneUnderline.CalcLineBounds(const R: TRect;
  AThickness: Integer): TRect;
begin
  Result.Empty;
end;
...
function TdxStrikeoutSingle.CalcLineBounds(const ARect: TRect;
  AThickness: Integer): TRect;
begin
  Result.InitSize(ARect.Left, ARect.Top, ARect.Width, AThickness);
end;

function TdxStrikeoutSingle.CalcLinePenVerticalOffset(const ALineBounds
  : TdxRectF): Single;
begin
  Result := ALineBounds.Height / 2;
end;

procedure TdxStrikeoutSingle.Draw(const APainter: IdxStrikeoutPainter;
  const ABounds: TdxRectF; AColor: TdxAlphaColor);
begin
...
function TdxStrikeoutDouble.CalcLineBounds(const ARect: TRect;
  AThickness: Integer): TRect;
begin
  Result.InitSize(ARect.Left, ARect.Top - (3 * AThickness) div 2, ARect.Width,
    3 * AThickness)
end;

function TdxStrikeoutDouble.CalcLinePenVerticalOffset(const ALineBounds
  : TdxRectF): Single;
begin
  Result := 0;
end;
...
function TdxUnderlineThinSize.CalcLineBounds(const ARect: TRect;
  AThickness: Integer): TRect;
begin
  Result.InitSize(ARect.Left, ARect.Bottom - AThickness, cxRectWidth(ARect),
    AThickness);
end;

{ TdxUnderlineFullSize }

function TdxUnderlineFullSize.CalcLineBounds(const ARect: TRect;
  AThickness: Integer): TRect;
begin
  Result := ARect;
end;
...
function TdxUnderlineThickSize.CalcLineBounds(const R: TRect;
  AThickness: Integer): TRect;
begin
...
function TdxUnderlineNone.CalcLineBounds(const R: TRect;
  AThickness: Integer): TRect;
begin
  Result := TRect.Null;
end;
...
function TdxUnderlineDouble.CalcLinePenVerticalOffset(const ALineBounds
  : TdxRectF): Single;
begin
  Result := 0;
end;
...
function TdxUnderlineHeavyWave.CalcLinePenVerticalOffset(const ALineBounds
  : TdxRectF): Single;
begin
  Result := 0;
end;
...
procedure TdxUnderlineThickDashDotDotted.Draw(const APainter
  : IdxUnderlinePainter; const ABounds: TdxRectF; AColor: TdxAlphaColor);
begin
  APainter.DrawUnderline(Self, ABounds, AColor);
end;
...
function TdxUnderlineDoubleWave.CalcLinePenVerticalOffset(const ALineBounds
  : TdxRectF): Single;
begin
  Result := 0;
end;
...
function TdxUnderlineWave.CalcLinePenVerticalOffset(const ALineBounds
  : TdxRectF): Single;
begin
  Result := 0;
end;
...
function TdxUnderlineRepository.GetPatternLineByType
  (ALine: TdxUnderlineType): Pointer;
var
  AType: TClass;
begin
  case ALine of
