...
type
  ...
  strict private
    ...
    FMergedParagraphFrameFormattingInfoCache
  ...
  public
    ...
    property GeneralSectionInfoCache: TdxGeneralSectionInfoCache
      read FGeneralSectionInfoCache;
    property PageNumberingInfoCache: TdxPageNumberingInfoCache
      read FPageNumberingInfoCache;
    property LineNumberingInfoCache: TdxLineNumberingInfoCache
      read FLineNumberingInfoCache;
    property ParagraphFrameFormattingInfoCache
      : TdxParagraphFrameFormattingInfoCache
      read FParagraphFrameFormattingInfoCache;
    property MergedParagraphFrameFormattingInfoCache
      : TdxParagraphFrameFormattingInfoCache
      read FMergedParagraphFrameFormattingInfoCache;
    property TableFloatingPositionInfoCache: TdxTableFloatingPositionInfoCache
      read FTableFloatingPositionInfoCache;
    property TableCellGeneralSettingsInfoCache
      : TdxTableCellGeneralSettingsInfoCache
      read FTableCellGeneralSettingsInfoCache;
    property TableGeneralSettingsInfoCache: TdxTableGeneralSettingsInfoCache
      read FTableGeneralSettingsInfoCache;
    property TablePropertiesOptionsCache: TdxTablePropertiesOptionsCache
      read FTablePropertiesOptionsCache;
    property TableRowPropertiesOptionsCache: TdxTableRowPropertiesOptionsCache
      read FTableRowPropertiesOptionsCache;
    property TableRowGeneralSettingsInfoCache
      : TdxTableRowGeneralSettingsInfoCache
      read FTableRowGeneralSettingsInfoCache;
    property TableCellPropertiesOptionsCache: TdxTableCellPropertiesOptionsCache
      read FTableCellPropertiesOptionsCache;
    property RangePermissionInfoCache: TdxRangePermissionInfoCache
      read FRangePermissionInfoCache;
    property DocumentProtectionInfoCache: TdxDocumentProtectionInfoCache
      read FDocumentProtectionInfoCache;
    property FootNoteInfoCache: TdxFootNoteInfoCache read FFootNoteInfoCache;
    property FloatingObjectInfoCache: TdxFloatingObjectInfoCache
      read FFloatingObjectInfoCache;
    property ListLevelInfoCache: TdxListLevelInfoCache read FListLevelInfoCache;
    property FloatingObjectFormattingCache: TdxFloatingObjectFormattingCache
      read FFloatingObjectFormattingCache;
    property ShapeInfoCache: TdxShapeInfoCache read FShapeInfoCache;
    property ShapeFormattingCache: TdxShapeFormattingCache
      read FShapeFormattingCache;
    property TextBoxInfoCache: TdxTextBoxInfoCache read FTextBoxInfoCache;
    property TextBoxFormattingCache: TdxTextBoxFormattingCache
      read FTextBoxFormattingCache;
  end;
...
begin
  ...
  FParagraphFrameFormattingInfoCache :=
    TdxParagraphFrameFormattingInfoCache.Create(AUnitConverter);
  FMergedParagraphFrameFormattingInfoCache :=
    TdxParagraphFrameFormattingInfoCache.Create(AUnitConverter);

  FTablePropertiesOptionsCache := TdxTablePropertiesOptionsCache.Create
    (AUnitConverter);
  FListLevelInfoCache := TdxListLevelInfoCache.Create(AUnitConverter);
  FTableGeneralSettingsInfoCache := TdxTableGeneralSettingsInfoCache.Create
    (AUnitConverter);

  FTableFloatingPositionInfoCache := TdxTableFloatingPositionInfoCache.Create
    (AUnitConverter);
  FTableCellGeneralSettingsInfoCache :=
    TdxTableCellGeneralSettingsInfoCache.Create(AUnitConverter);
  FTableCellPropertiesOptionsCache := TdxTableCellPropertiesOptionsCache.Create
    (AUnitConverter);

  FTableRowGeneralSettingsInfoCache :=
    TdxTableRowGeneralSettingsInfoCache.Create(AUnitConverter);
  FTableRowPropertiesOptionsCache := TdxTableRowPropertiesOptionsCache.Create
    (AUnitConverter);

  FRangePermissionInfoCache := TdxRangePermissionInfoCache.Create
    (AUnitConverter);
  FDocumentProtectionInfoCache := TdxDocumentProtectionInfoCache.Create
    (AUnitConverter);
  ...
  FFloatingObjectFormattingCache := TdxFloatingObjectFormattingCache.Create
    (ADocumentModel);
