...
{$ENDIF}
  ...
  dxCoreClasses, cxDropDownEdit, cxCheckBox, cxLookAndFeelPainters,
  dxCoreGraphics,
  dxRichEdit.Options,
...
type
  ...
  TdxNullableCharacterFormattingScript =
    TdxNullableValue<TdxCharacterFormattingScript>;
  ...
  IdxRichEditFontDialogForm = interface
    ...
    property FontNameAllowed: Boolean read GetFontNameAllowed
      write SetFontNameAllowed;
    property FontForeColor: TdxNullableColor read GetFontForeColor
      write SetFontForeColor;
    property FontSize: TdxNullableSingle read GetFontSize write SetFontSize;
    property FontUnderlineType: TdxNullableUnderlineType
      read GetFontUnderlineType write SetFontUnderlineType;
    property FontUnderlineColor: TdxNullableColor read GetFontUnderlineColor
      write SetFontUnderlineColor;
    property FontStyleEdit: TdxFontStyleEditHelper read GetFontStyleEdit;
    property FontEffectsEdit: TdxRichEditFontEffectsHelper
      read GetFontEffectsEdit;
    property Controller: TdxFontFormController read GetController;
    property OnFontSizeValidating: TcxEditValidateEvent
      read GetOnFontSizeValidating write SetOnFontSizeValidating;
    property OnFontStyleValidating: TcxEditValidateEvent
      read GetOnFontStyleValidating write SetOnFontStyleValidating;
    property OnSomeChildControlEditValueChanged: TNotifyEvent
      read GetOnSomeChildControlEditValueChanged
      write SetOnSomeChildControlEditValueChanged;
  end;
  ...
  protected
    procedure PopulateFontStyleNames(AItems: TStrings;
      const AFontFamilyName: TFontName);
  ...
  public
    ...
    class function ToSupportedFontStyle(ABold, AItalic: Boolean)
      : TdxSupportedFontStyle; static;

    property FontFamilyName: TFontName read GetFontFamilyName
      write SetFontFamilyName;
    property FontStyles: TdxNullableFontDialogFontStyle read GetFontStyles
      write SetFontStyles;
    property FontBold: TdxNullableBoolean read FFontBold write SetFontBold;
    property FontItalic: TdxNullableBoolean read FFontItalic
      write SetFontItalic;
  end;
  ...
  private
    ...
    function CheckStateToNullableBool(ACheckState: TcxCheckBoxState)
      : TdxNullableBoolean;
    procedure SetCharacterFormattingDetailedOptions
  ...
  protected
    ...
    procedure UpdateCheckEdit(ACheckBox: TdxLayoutCheckBoxItem;
      const AState: TdxNullableBoolean);
    { IdxBatchUpdateHandler }
    procedure OnLastEndUpdate; override;
  public
    constructor Create(const AAllCaps, ADoubleStrikethrough, AHidden,
      AStrikethrough, ASubscript, ASuperscript, AUnderlineWordsOnly
      : TdxLayoutCheckBoxItem);
    property CharacterFormattingDetailedOptions
      : TdxCharacterFormattingDetailedOptions
      read FCharacterFormattingDetailedOptions
      write SetCharacterFormattingDetailedOptions;
    ...
    property Strikeout: TdxNullableStrikeoutType read FStrikeout
      write SetStrikeout;
    property Script: TdxNullableCharacterFormattingScript read FScript
      write SetScript;
    property UnderlineWordsOnly: TdxNullableBoolean read FUnderlineWordsOnly
      write SetUnderlineWordsOnly;
    property OnEffectsChanged: TNotifyEvent read FOnEffectsChanged
  ...
  protected
    ...
    procedure FontSizeValidating(Sender: TObject; var DisplayValue: Variant;
      var ErrorText: TCaption; var Error: Boolean);
    procedure FontStyleValidating(Sender: TObject; var DisplayValue: Variant;
      var ErrorText: TCaption; var Error: Boolean);
  ...
  public
    ...
    property FontItalic: TdxNullableBoolean read GetFontItalic
      write SetFontItalic;
    property FontForeColor: TdxNullableColor read GetFontForeColor
      write SetFontForeColor;
    property FontUnderlineType: TdxNullableUnderlineType
    ...
    property UnderlineWordsOnly: TdxNullableBoolean read GetUnderlineWordsOnly
      write SetUnderlineWordsOnly;
    property Strikeout: TdxNullableStrikeoutType read GetStrikeout
      write SetStrikeout;
    property Script: TdxNullableCharacterFormattingScript read GetScript
      write SetScript;
    property FontSize: TdxNullableSingle read GetFontSize write SetFontSize;

    property OnFontControlChanged: TNotifyEvent read FOnFontControlChanged
      write FOnFontControlChanged;
  end;
  ...
  public
    property RichEditControl: IdxRichEditControl read FRichEditControl
      write SetRichEditControl;
    class function TryGetHalfSizeValue(const AEditValue: Variant;
      out AValue: Integer): Boolean; static;
...
const
  dxFontStyleNames: array [TdxFontDialogFontStyle] of Pointer =
    ...
    @sdxRichEditFontDialogFontStyleItalic, @sdxRichEditFontDialogFontStyleBold,
    @sdxRichEditFontDialogFontStyleBoldItalic);

  { TdxFontStyleEditHelper }

procedure TdxFontStyleEditHelper.PopulateFontStyleNames(AItems: TStrings;
  const AFontFamilyName: TFontName);

  procedure AddItem(AItems: TStrings; AFontStyle: TdxFontDialogFontStyle);
  begin
    AItems.AddObject(cxGetResourceString(dxFontStyleNames[AFontStyle]),
      TObject(AFontStyle));
  end;
...
function TdxFontStyleEditHelper.IsFontStyleAllowable
  (AFontStyle: TdxFontDialogFontStyle): Boolean;
begin
...
constructor TdxFontStyleEditHelper.Create(AEditControl: TcxTextEdit;
  AListControl: TcxListBox);
begin
...
class function TdxFontStyleEditHelper.ToSupportedFontStyle(ABold,
  AItalic: Boolean): TdxSupportedFontStyle;
begin
...
begin
  ...
  begin
    ...
    FontItalic := AFontStyle in [TdxFontDialogFontStyle.Italic,
      TdxFontDialogFontStyle.BoldItalic];
    FontBold := AFontStyle in [TdxFontDialogFontStyle.Bold,
      TdxFontDialogFontStyle.BoldItalic];
  end;
...
procedure TdxFontStyleEditHelper.SetFontStyles(const Value
  : TdxNullableFontDialogFontStyle);
var
  AIndex: Integer;
begin
  ...
  begin
    ...
    while AIndex >= 0 do
    begin
      if TdxFontDialogFontStyle(ListControl.Items.Objects[AIndex]) = Value.Value
      then
        Break;
      Dec(AIndex);
    end;
...
begin
  if (FontItalic = True) and (FontBold = True) and
    IsFontStyleAllowable(TdxFontDialogFontStyle.BoldItalic) then
    AFontStyles := TdxFontDialogFontStyle.BoldItalic
  else if (FontItalic = True) and IsFontStyleAllowable
    (TdxFontDialogFontStyle.Italic) then
    AFontStyles := TdxFontDialogFontStyle.Italic
  else if (FontBold = True) and IsFontStyleAllowable(TdxFontDialogFontStyle.Bold)
  then
    AFontStyles := TdxFontDialogFontStyle.Bold
  else if (FontItalic = False) and (FontBold = False) and
    IsFontStyleAllowable(TdxFontDialogFontStyle.Regular) then
...
function TdxRichEditFontEffectsHelper.CheckStateToNullableBool
...
constructor TdxRichEditFontEffectsHelper.Create(const AAllCaps,
  ADoubleStrikethrough, AHidden, AStrikethrough, ASubscript, ASuperscript,
  AUnderlineWordsOnly: TdxLayoutCheckBoxItem);
begin
  inherited Create;
...
procedure TdxRichEditFontEffectsHelper.DoubleStrikethroughCheckedChanged
  (Sender: TObject);
begin
...
procedure TdxRichEditFontEffectsHelper.SetAllCaps
...
procedure TdxRichEditFontEffectsHelper.SetHidden(const Value
  : TdxNullableBoolean);
begin
...
procedure TdxRichEditFontEffectsHelper.SetScript(const Value
  : TdxNullableCharacterFormattingScript);
begin
...
procedure TdxRichEditFontEffectsHelper.SetStrikeout
  (const Value: TdxNullableStrikeoutType);
begin
...
procedure TdxRichEditFontEffectsHelper.SetUnderlineWordsOnly
  (const Value: TdxNullableBoolean);
begin
...
procedure TdxRichEditFontEffectsHelper.StrikethroughCheckedChanged
  (Sender: TObject);
begin
...
procedure TdxRichEditFontEffectsHelper.SuperscriptCheckedChanged
  (Sender: TObject);
begin
...
procedure TdxRichEditFontEffectsHelper.UnderlineWordsOnlyCheckedChanged
  (Sender: TObject);
begin
  UnderlineWordsOnly := CheckStateToNullableBool
    (FUnderlineWordsOnlyCheckBox.State);
end;
...
procedure TdxRichEditFontEffectsHelper.UpdateCheckEdit
  (ACheckBox: TdxLayoutCheckBoxItem; const AState: TdxNullableBoolean);
begin
...
begin
  ...
  FStrikethroughCheckBox.Enabled := CharacterFormattingDetailedOptions.
    StrikeoutWordsOnlyAllowed;
  FUnderlineWordsOnlyCheckBox.Enabled :=
    CharacterFormattingDetailedOptions.UnderlineWordsOnlyAllowed;
  FSubscriptCheckBox.Enabled := CharacterFormattingDetailedOptions.
    ScriptAllowed;
  FSuperscriptCheckBox.Enabled := CharacterFormattingDetailedOptions.
    ScriptAllowed;
  FHiddenCheckBox.Enabled := CharacterFormattingDetailedOptions.HiddenAllowed;
  FStrikethroughCheckBox.Enabled := CharacterFormattingDetailedOptions.
    FontStrikeoutAllowed;
  FDoubleStrikethroughCheckBox.Enabled :=
    CharacterFormattingDetailedOptions.FontStrikeoutAllowed;
end;

procedure TdxRichEditFontEffectsHelper.
  UpdateStrikethroughAndDoubleStrikethroughCheckEdits;
begin
...
procedure TdxRichEditFontHelper.FontSizeValidating(Sender: TObject;
...
procedure TdxRichEditFontHelper.FontStyleValidating(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  Error := False;
  if VarIsSoftNull(DisplayValue) then
...
procedure TdxRichEditFontHelper.SetFontUnderlineType
  (Value: TdxNullableUnderlineType);
begin
  SetProperty(procedure
    begin
...
procedure TdxRichEditFontHelper.SetRichEditControl
  (const Value: TdxCustomRichEditControl);
begin
  SetProperty(procedure
    begin
...
procedure TdxRichEditFontHelper.SetScript
  (Value: TdxNullableCharacterFormattingScript);
begin
  SetProperty(procedure
    begin
...
procedure TdxRichEditFontHelper.SetUnderlineWordsOnly
...
procedure TdxRichEditFontHelper.SomeChildControlEditValueChanged
  (Sender: TObject);
begin
  UpdateControl;
  FontControlChanged;
...
constructor TdxRichEditFontHelper.Create(const AOwner
  : IdxRichEditFontDialogForm);
begin
  inherited Create;
  FOwner := AOwner;
...
class function TdxRichEditFontSizeHelper.IsValidFontSize
  (AFontSize: Integer): Boolean;
begin
  Result := (AFontSize >= TdxPredefinedFontSizeCollection.MinFontSize) and
    (AFontSize <= TdxPredefinedFontSizeCollection.MaxFontSize);
end;
...
procedure TdxRichEditFontSizeHelper.SetRichEditControl
  (const Value: IdxRichEditControl);
begin
...
class function TdxRichEditFontSizeHelper.TryGetHalfSizeValue(const AEditValue
  : Variant; out AValue: Integer): Boolean;
var
  AEditFloat: Single;
  AEditText: string;
begin
  ...
  begin
    ...
    if ((AEditText <> '') and TryStrToFloat(AEditText, AEditFloat)) or
      (AEditFloat > 0) then
    begin
