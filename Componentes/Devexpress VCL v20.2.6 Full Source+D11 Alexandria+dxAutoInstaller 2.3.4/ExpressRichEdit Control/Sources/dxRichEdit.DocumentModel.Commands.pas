...
type
  ...
  TdxPieceTableInsertFieldSymbolResultAtInputPositionCommand = class
  ...
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      ALogPosition: TdxDocumentLogPosition; const ASymbol: Char); reintroduce;
  ...
  protected
    ...
    function CalculateInsertionParagraphIndex: TdxParagraphIndex;
      virtual; abstract;
  ...
  TdxDocumentModelInsertObjectAtLogPositionCommand = class abstract
    (TdxDocumentModelInsertObjectCommand)
  private
  ...
  TdxDocumentModelInsertObjectAtInputPositionCommand = class abstract
    (TdxDocumentModelInsertObjectCommand)
  private
  ...
  TdxPieceTablePasteContentConvertedToDocumentModelCommandBase = class abstract
    (TdxPieceTablePasteContentCommand)
  private
  ...
  protected
    ...
    function CreateSourceDocumentModel(const ASizeCollection: string)
      : TdxDocumentModel; virtual; abstract;
    function CreatePasteDocumentModelCommand(APos: TdxDocumentLogPosition;
      ASource: TdxDocumentModel; ASuppressFieldsUpdate, APasteFromIE: Boolean)
      : TdxPieceTableInsertContentConvertedToDocumentModelCommand; virtual;
    function GetAdditionalContentString: string; virtual;
    function GetDocumentModelSingleFloatingObjectAnchorRun
      (AModel: TdxDocumentModel): TdxFloatingObjectAnchorRun;
    procedure OffsetNewlyInsertedFloatingObjectIfNeed
      (ANewRun: TdxFloatingObjectAnchorRun; AParagraph: TdxParagraph);
    procedure OffsetNewlyInsertedFloatingObject
      (ANewRun: TdxFloatingObjectAnchorRun; ARun: TdxFloatingObjectAnchorRun);
    procedure PasteContent(ASource: TdxDocumentModel;
      APos: TdxDocumentLogPosition; const ASizeCollection: string); virtual;
    procedure PasteDocumentModel(APos: TdxDocumentLogPosition;
      ASource: TdxDocumentModel; APasteFromIE: Boolean;
      ASuppressFieldsUpdate: Boolean = False);
    function PreprocessSingleFloatingObjectInsertion
      (ARun: TdxFloatingObjectAnchorRun): TdxParagraph;
    procedure SetSuppressStoreImageSize(ADocumentModel: TdxDocumentModel;
      const ASizeCollection: string); virtual;
    function ShouldOffsetNewRun(ANewRun: TdxFloatingObjectAnchorRun;
      ARun: TdxFloatingObjectAnchorRun): Boolean;
    function SuppressCopySectionProperties(ASource: TdxDocumentModel)
      : Boolean; virtual;
  public
    constructor Create(APieceTable: TdxPieceTable); overload;
    constructor Create(APieceTable: TdxPieceTable;
      AInsertOptions: TdxInsertOptions); overload;

    property CopyBetweenInternalModels: Boolean read FCopyBetweenInternalModels
      write FCopyBetweenInternalModels;
    property ForceInsertFloatingObjectAtParagraphStart: Boolean
      read FForceInsertFloatingObjectAtParagraphStart
      write FForceInsertFloatingObjectAtParagraphStart;
  ...
  TdxPieceTablePasteTextContentConvertedToDocumentModelCommandBase = class
    abstract(TdxPieceTablePasteContentConvertedToDocumentModelCommandBase)
  protected
    function CreateSourceDocumentModel(const ASizeCollection: string)
      : TdxDocumentModel; override;
    function CreateDocumentModelFromContentString
      (AContent: TdxClipboardStringContent; const ASizeCollection: string)
      : TdxDocumentModel; virtual;
    function GetContent: TdxClipboardStringContent; virtual; abstract;
    procedure PopulateDocumentModelFromContentStringCore(ADocumentModel
      : TdxDocumentModel; AContent: TdxClipboardStringContent;
      const ASizeCollection: string); virtual; abstract;
    procedure PasteContent(AContent: TdxClipboardStringContent;
      APos: TdxDocumentLogPosition; const ASizeCollection: string); reintroduce;
      overload; virtual;
  end;

  { TdxPieceTablePasteRtfTextCommand }

  TdxPieceTablePasteRtfTextCommand = class
    (TdxPieceTablePasteTextContentConvertedToDocumentModelCommandBase)
  private
  ...
  protected
    ...
    procedure PopulateDocumentModelFromContentStringCore(ADocumentModel
      : TdxDocumentModel; AContent: TdxClipboardStringContent;
      const ASizeCollection: string); override;
  ...
  public
    constructor Create(APieceTable: TdxPieceTable;
      ...
      const AText: string; const ARule: IdxSpellCheckerAutoCorrectCustomRule);
      reintroduce;
  end;

  { TdxPieceTableInsertFloatingObjectAnchorAtLogPositionCommand }

  TdxPieceTableInsertFloatingObjectAnchorAtLogPositionCommand = class sealed
  ...
  protected
    ...
    property IsMergingTableCell: Boolean read FIsMergingTableCell
      write FIsMergingTableCell;
  public
    constructor Create(ATargetPieceTable: TdxPieceTable;
      ASourceModel: TdxDocumentModel; ALogPosition: TdxDocumentLogPosition;
      AInsertOptions: TdxInsertOptions; AForceVisible: Boolean); overload;
    constructor Create(ATargetPieceTable: TdxPieceTable;
      ASourceModel: TdxDocumentModel; ALogPosition: TdxDocumentLogPosition;
      AForceVisible: Boolean); overload;
    procedure CopyDocumentModelContent(ACopyManager
      : TdxDocumentModelCopyManager; ALength: Integer);
    function GetDocumentLength(ADocumentModel: TdxDocumentModel): Integer;

    property InsertOptions: TdxInsertOptions read FInsertOptions;
    property SuppressParentFieldsUpdate: Boolean
      read FSuppressParentFieldsUpdate write FSuppressParentFieldsUpdate;
    property SuppressFieldsUpdate: Boolean read FSuppressFieldsUpdate
      write FSuppressFieldsUpdate;
    property CopyBetweenInternalModels: Boolean read FCopyBetweenInternalModels
      write FCopyBetweenInternalModels;
    property CopyLastParagraph: Boolean read FCopyLastParagraph
      write FCopyLastParagraph;
    property PasteFromIE: Boolean read FPasteFromIE write FPasteFromIE;
    property SuppressCopySectionProperties: Boolean
      read FSuppressCopySectionProperties write FSuppressCopySectionProperties;
    property RemoveLeadingPageBreak: Boolean read FRemoveLeadingPageBreak
      write FRemoveLeadingPageBreak;
  end;
  ...
  public
    function GetEntireBookmarks(ASourcePieceTable: TdxPieceTable;
      AStart: TdxDocumentLogPosition; ALength: Integer): TdxBookmarkBaseList;
      virtual; abstract;
    procedure InsertBookmark(ATargetPieceTable: TdxPieceTable;
      AStart: TdxDocumentLogPosition; ALength: Integer;
  ...
  public
    function GetEntireBookmarks(ASourcePieceTable: TdxPieceTable;
      AStart: TdxDocumentLogPosition; ALength: Integer)
      : TdxBookmarkBaseList; override;
    procedure InsertBookmark(ATargetPieceTable: TdxPieceTable;
      AStart: TdxDocumentLogPosition; ALength: Integer;
      ABookmark: TdxBookmarkBase; APositionOffset: Integer); override;

    property ForceUpdateInterval: Boolean read FForceUpdateInterval
      write FForceUpdateInterval;
  end;
  ...
  protected
    procedure CopyBookmarksToTargetModelCore(ARunInfo: TdxRunInfo;
      const APositionToInsert: TdxDocumentModelPosition); overload; virtual;
    procedure CopyBookmarksToTargetModelCore(ARunInfo: TdxRunInfo;
      const APositionToInsert: TdxDocumentLogPosition; AIsAllowed: Boolean;
      ABookmarkCopyOperation: TdxBookmarkCopyOperationBase); overload;
  public
    procedure CopyBookmarksToTargetModel(ARunInfo: TdxRunInfo;
      const APositionToInsert: TdxDocumentModelPosition); overload; virtual;
    function ExecuteCore(AInfo: TdxRunInfo;
      ADocumentLastParagraphSelected: Boolean): Boolean; override;

    property TargetBookmarksPosition: TdxDocumentModelPosition
      read FTargetBookmarksPosition write FTargetBookmarksPosition;
  end;
  ...
  protected
    procedure ExecuteCore; override;
    function CreateCopyBookmarkOperation(ACopyManager
      : TdxDocumentModelCopyManager): TdxCopyBookmarksOperation; virtual;
    procedure NormalizeTables(APieceTable: TdxPieceTable);
    class procedure CopyStyles(ATargetModel, ASourceModel: TdxDocumentModel;
      AWithId: Boolean = False); static;
    procedure CopyDocumentVariables(ATargetModel, ASourceModel
      : TdxDocumentModel);
    class procedure ReplaceStylesCore(ATargetStyles, ASourceStyles
      : TdxStyleCollectionBase); static;
    class procedure CopyStylesCore(ATargetStyles, ASourceStyles
      : TdxStyleCollectionBase; AWithId: Boolean); static;
    procedure CalculateExecutionParameters; override;
    procedure ApplyChanges; override;
    procedure CalculateApplyChangesParameters; override;
  ...
  public
    constructor Create(ASourcePieceTable: TdxPieceTable;
      ATargetModel: TdxDocumentModel; AOptions: TdxDocumentModelCopyOptions);
      reintroduce;

    class procedure ReplaceDefaultProperties(ATargetModel: TdxDocumentModel;
      ASourceModel: TdxDocumentModel); static;
    class procedure ReplaceDefaultStyles(ATargetModel,
      ASourceModel: TdxDocumentModel); static;

    property FixLastParagraph: Boolean read FFixLastParagraph
      write FFixLastParagraph;
    property TableCopyFromNestedLevel: Integer read FTableCopyFromNestedLevel
      write FTableCopyFromNestedLevel;
    ...
    property UpdateIntervals: Boolean read FUpdateIntervals
      write FUpdateIntervals;
  end;

  { TdxPieceTableInsertSeparatorAtLogPositionCommand }

  TdxPieceTableInsertSeparatorAtLogPositionCommand = class
    (TdxPieceTableInsertObjectAtLogPositionCommand)
  protected
    function GetChangeType: TdxDocumentModelChangeType; override;
    procedure ExecuteCore; override;
  ...
  TdxDocumentModelInsertSectionAtLogPositionCommand = class
    (TdxDocumentModelInsertObjectAtLogPositionCommand)
  protected
    function GetChangeType: TdxDocumentModelChangeType; override;
    procedure ExecuteCore; override;
  ...
  TdxPieceTableTableDocumentServerOwnerCommand = class abstract
    (TdxPieceTableTableBaseCommand)
  private
    FServer: IdxInnerRichEditDocumentServerOwner;
  public
    constructor Create(APieceTable: TdxPieceTable;
      const AServer: IdxInnerRichEditDocumentServerOwner); reintroduce;
  ...
  protected
    procedure ExecuteCore; override;
  public
    constructor Create(APieceTable: TdxPieceTable; ASourceCell: TdxTableCell);
      reintroduce;
  ...
  protected
    procedure ExecuteCore; override;
  public
    constructor Create(APieceTable: TdxPieceTable; ATable: TdxTable;
  ...
  protected
    procedure ExecuteCore; override;
  public
    constructor Create(APieceTable: TdxPieceTable; ARow: TdxTableRow;
      AInsertedIndex: Integer; AStart, AEnd: TdxParagraphIndex); reintroduce;
  ...
  protected
    procedure ExecuteCore; override;
    procedure CorrectVerticalMerging(ARow: TdxTableRow; I: Integer;
      ASourceCell: TdxTableCell; ATargetCell: TdxTableCell); virtual; abstract;
    procedure CopyPropertiesFromPatternCell(ASource: TdxTableCell;
      ATarget: TdxTableCell); virtual; abstract;
    procedure CopyCharacterAndParagraphFormattingFromPatternCell
      (ASource: TdxTableCell; ATarget: TdxTableCell); virtual;
    ...
    property NewRowStartParagraphIndex: TdxParagraphIndex
      read FNewRowStartParagraphIndex write FNewRowStartParagraphIndex;
    property PositionToParagraphsInsert: TdxDocumentLogPosition
      read FPositionToParagraphsInsert write FPositionToParagraphsInsert;
    property NewRowIndex: Integer read FNewRowIndex write FNewRowIndex;
  public
    constructor Create(APieceTable: TdxPieceTable; APatternRow: TdxTableRow;
      AForceVisible: Boolean); reintroduce;
  ...
  TdxPieceTableInsertTableRowBelowCommand = class
    (TdxPieceTableInsertTableRowCommand)
  protected
    procedure CalculateExecutionParameters; override;
    procedure AfterParagraphsInserted; override;
    function GetNextRow(ARow: TdxTableRow): TdxTableRow; override;
    procedure CorrectVerticalMerging(ACreatedRow: TdxTableRow; I: Integer;
      ASourceCell, ATargetCell: TdxTableCell); override;
    procedure CopyPropertiesFromPatternCell(ASourceCell,
      ATargetCell: TdxTableCell); override;
  end;

  { TdxPieceTableInsertTableRowAboveCommand }

  TdxPieceTableInsertTableRowAboveCommand = class
    (TdxPieceTableInsertTableRowCommand)
  protected
    procedure CalculateExecutionParameters; override;
    procedure AfterParagraphsInserted; override;
  ...
  TdxPieceTableMergeTableCellsCommandBase = class abstract
    (TdxPieceTableTableBaseCommand)
  private
    FCell: TdxTableCell;
  ...
  protected
    ...
    function CalculateSelectionRange(ACell: TdxTableCell)
      : TdxSelectionRange; virtual;
    ...
    procedure DeleteTableCellWithContent(ANextCell: TdxTableCell;
      ADeletingRange: TdxSelectionRange); virtual;
    procedure CopyToPieceTable; virtual;
    procedure FixParagraphsInPatternCell(ANeedDeleteFirstParagraphInCell,
      ANeedDeleteLastParagraphInCell: Boolean); virtual;
    ...
    property CopyManager: TdxDocumentModelCopyManager read FCopyManager
      write FCopyManager;
    property NeedDeleteNextTableCell: Boolean read FNeedDeleteNextTableCell
      write FNeedDeleteNextTableCell;
    property PatternCell: TdxTableCell read FCell write FCell;
    property SuppressNormalizeTableRows: Boolean
      read FSuppressNormalizeTableRows write FSuppressNormalizeTableRows;
  public
  ...
  TdxPieceTableMergeTableCellsHorizontallyCommand = class
    (TdxPieceTableTableBaseCommand)
  private
    FCell: TdxTableCell;
    FCount: Integer;
  protected
    function CalculateCellIndex(ARow: TdxTableRow;
      AStartCellIndex, AColumnSpan: Integer): Integer; virtual;
    procedure ExecuteCore; override;
  public
    constructor Create(APieceTable: TdxPieceTable; ACell: TdxTableCell;
  ...
  TdxPieceTableMergeTableCellsVerticallyCommand = class
    (TdxPieceTableTableBaseCommand)
  private
    FCell: TdxTableCell;
    FCount: Integer;
  ...
  TdxPieceTableDeleteTableCellWithNestedTablesCommand = class
    (TdxPieceTableTableBaseCommand)
  private
    FTableIndex: Integer;
    FRowIndex: Integer;
  ...
  public
    constructor Create(APieceTable: TdxPieceTable;
      ATableIndex, ARowIndex, ACellIndex: Integer); reintroduce;
  end;
  ...
  protected
    ...
    procedure CopyToPieceTable; virtual;
    procedure InsertParagraphWithDefaultProperties
      (APosition: TdxDocumentLogPosition); virtual;
  ...
  public
    constructor Create(APieceTable: TdxPieceTable;
      ATableIndex, ARowIndex: Integer; AForceVisible: Boolean); reintroduce;
    destructor Destroy; override;
  end;

  { TdxPieceTablePieceTableInsertColumnBase }

  TdxPieceTablePieceTableInsertColumnBase = class abstract
    (TdxPieceTableTableBaseCommand)
  private
    FForceVisible: Boolean;
  ...
  protected
    procedure ExecuteCore; override;
    procedure InsertColumnToTheLeft(ACurrentRow: TdxTableRow;
      ACurrentCell: TdxTableCell); virtual;
    procedure ChangeStartParagraphIndexInCells(ACells: TdxTableCellList);
    procedure InsertColumnToTheRight(ACurrentRow: TdxTableRow;
      ACurrentCell: TdxTableCell); virtual;
    function InsertColumnCore(ARow: TdxTableRow; AInsertedIndex: Integer;
      AStart, AEnd: TdxParagraphIndex): TdxTableCell; virtual;
    function GetColumnIndex: Integer; virtual; abstract;
    function GetCurrentCell(AColumnIndex: Integer; ACurrentRow: TdxTableRow)
      : TdxTableCell; virtual; abstract;
    procedure Modify(ACurrentRow: TdxTableRow; ACurrentCell: TdxTableCell);
      virtual; abstract;
  ...
  TdxPieceTableInsertColumnToTheLeft = class
    (TdxPieceTablePieceTableInsertColumnBase)
  protected
    function GetColumnIndex: Integer; override;
    function GetCurrentCell(AColumnIndex: Integer; ACurrentRow: TdxTableRow)
      : TdxTableCell; override;
    procedure Modify(ACurrentRow: TdxTableRow;
      ACurrentCell: TdxTableCell); override;
  end;

  TdxPieceTableInsertColumnToTheRight = class
    (TdxPieceTablePieceTableInsertColumnBase)
  protected
    function GetColumnIndex: Integer; override;
    function GetCurrentCell(AColumnIndex: Integer; ACurrentRow: TdxTableRow)
  ...
  TdxPieceTableDeleteTableColumnsCommand = class
    (TdxPieceTableTableDocumentServerOwnerCommand)
  private
    FSelectedCells: TdxSelectedCellsCollection;
    FEndColumnIndex: Integer;
    FStartColumnIndex: Integer;
    function CalculateTableGridIntervals(ATableGridColumnCollection
      : TdxTableGridColumnCollection): TdxTableGridIntervalList;
  protected
    procedure ExecuteCore; override;
    ...
    function IsAllCellsVerticalMergingContinue(ACells: TdxTableCellCollection)
      : Boolean; virtual;

    property StartColumnIndex: Integer read FStartColumnIndex
      write FStartColumnIndex;
  ...
  TdxPieceTableDeleteTableCellsWithShiftToTheUpCommand = class
    (TdxPieceTableTableBaseCommand)
  private
    FSelectedCells: TdxSelectedCellsCollection;
  protected
    procedure ExecuteCore; override;
    procedure DeleteSelectedCells(ASelectedCells
      : TdxSelectedCellsIntervalInRow);
  public
    constructor Create(APieceTable: TdxPieceTable;
      ASelectedCells: TdxSelectedCellsCollection); reintroduce;
  end;

  { TdxPieceTableDeleteTableCellWithShiftToTheUpCoreCommand }

  TdxPieceTableDeleteTableCellWithShiftToTheUpCoreCommand = class
    (TdxPieceTableTableBaseCommand)
  private
    FCell: TdxTableCell;
  protected
  ...
  TdxPieceTableDeleteOneTableCellWithShiftToTheUpCommand = class
    (TdxPieceTableMergeTwoTableCellsVerticallyCommand)
  private
    FRunInfo: TdxRunInfo;
  protected
  ...
  TdxPieceTableDeleteTableCellWithContentCommand = class
    (TdxPieceTableTableDocumentServerOwnerCommand)
  private
  ...
  protected
    procedure ExecuteCore; override;
    function CreateTableColumnWidthCalculator(ATable: TdxTable)
      : TdxCustomTableColumnWidthCalculator; virtual;
  public
    constructor Create(APieceTable: TdxPieceTable; ADeletedCell: TdxTableCell;
      const AServer: IdxInnerRichEditDocumentServerOwner);

    property CanNormalizeCellVerticalMerging: Boolean
      read FCanNormalizeCellVerticalMerging
      write FCanNormalizeCellVerticalMerging;
    property CollectVerticalSpanCells: Boolean read FCollectVerticalSpanCells
      write FCollectVerticalSpanCells;
    property UseDeltaBetweenColumnsUpdate: Boolean
      read FUseDeltaBetweenColumnsUpdate write FUseDeltaBetweenColumnsUpdate;
  end;

  { TdxPieceTableDeleteTableCellWithContentKnownWidthsCommand }

  TdxPieceTableDeleteTableCellWithContentKnownWidthsCommand = class
    (TdxPieceTableDeleteTableCellWithContentCommand)
  strict private
    FContainer: TdxTableWidthsContainer;
  protected
    function CreateTableColumnWidthCalculator(ATable: TdxTable)
      : TdxCustomTableColumnWidthCalculator; override;
  public
    constructor Create(APieceTable: TdxPieceTable; ADeletedCell: TdxTableCell;
      const AServer: IdxInnerRichEditDocumentServerOwner;
      const AContainer: TdxTableWidthsContainer); reintroduce;
  end;

  { TdxPieceTableInsertTableCellsBase }

  TdxPieceTableInsertTableCellsBase = class abstract
    (TdxPieceTableTableDocumentServerOwnerCommand)
  private
    FPatternCell: TdxTableCell;
  ...
  protected
    ...
    property CanNormalizeTable: Boolean read FCanNormalizeTable
      write FCanNormalizeTable;
    property CanCopyProperties: Boolean read FCanCopyProperties
      write FCanCopyProperties;
    property CanNormalizeVerticalMerging: Boolean
      read FCanNormalizeVerticalMerging write FCanNormalizeVerticalMerging;
    property ForceVisible: Boolean read FForceVisible;
  public
    constructor Create(APieceTable: TdxPieceTable; APatternCell: TdxTableCell;
  ...
  TdxPieceTableInsertTableCellToTheLeft = class
    (TdxPieceTableInsertTableCellsBase)
  protected
  ...
  TdxPieceTableInsertTableCellToTheRight = class
    (TdxPieceTableInsertTableCellsBase)
  protected
    function Modify(ACell: TdxTableCell): TdxTableCell; override;
  end;
  ...
  TdxPieceTableInsertTableCellWithShiftToTheDownCommand = class
    (TdxPieceTableTableDocumentServerOwnerCommand)
  private
    FPatternCell: TdxTableCell;
    FForceVisible: Boolean;
  protected
    procedure ExecuteCore; override;
    procedure InsertTableCells(APatternCell: TdxTableCell;
      AInsertedCellsCount: Integer; AWidth: TdxPreferredWidth); virtual;
  ...
  TdxPieceTableInsertTableCellWithShiftToTheDownCoreCommand = class
    (TdxPieceTableMergeTableCellsCommandBase)
  protected
    function CalculateNextCell: TdxTableCell; override;
    procedure UpdateProperties(ANextCell: TdxTableCell); override;
  ...
  TdxPieceTableSplitTableCellsHorizontally = class
    (TdxPieceTableTableDocumentServerOwnerCommand)
  private
    FPatternCell: TdxTableCell;
    FPartsCount: Integer;
  ...
  protected
    ...
    procedure SplitMergedCellsVertically(ACellsInRow
      : TdxTableCellCollection); virtual;
    function GetSelectedCellsEndIndex: Integer; virtual;
    procedure SplitMergedCellsVerticallyCore(ARestartCell
      : TdxTableCell); virtual;
  public
    constructor Create(APieceTable: TdxPieceTable; APatternCell: TdxTableCell;
  ...
  protected
    function GetPositions(const APositionInfo: TArray<TdxPositionInfo>)
      : TArray<Integer>;
    function CalculateMergedPositions(const ATables: array of TdxTable;
      const ATableGrids: array of TdxTableGrid; ATotalPositions: TdxIntegerList;
      const ASourceTableRowsCount: array of Integer): TList<TArray<Integer>>;
    function CalculateAbsolutePositions(ATable: TdxTable;
      AColumns: TdxTableGridColumnCollection; ARowCount: Integer)
      : TArray<TdxPositionInfo>;
    procedure AdjustNearestPositions(const AAbsolutePositions
      : TList<TArray<TdxPositionInfo>>; ALayoutDelta: Integer;
      const ATotalPositions: TdxIntegerList);
    function AdjustRight(ATotalPositions: TdxIntegerList;
      ATotalPositionIndex: Integer; const APositions: TArray<TdxPositionInfo>;
      APositionIndex: Integer; ALayoutDelta: Integer;
      APos: TdxPositionInfo): Boolean;
    function AdjustLeft(ATotalPositions: TdxIntegerList;
      ATotalPositionIndex: Integer; const APositions: TArray<TdxPositionInfo>;
      APositionIndex: Integer; ALayoutDelta: Integer;
      APos: TdxPositionInfo): Boolean;
    procedure AdjustPosition(const ATotalPositions: TdxIntegerList;
      ATotalPositionIndex: Integer; const APositions: TArray<TdxPositionInfo>;
      APositionIndex: Integer; ALayoutDelta: Integer);
    procedure MergedGridCore(ATable: TdxTable; AStartRowIndex: Integer;
      AEndRowIndex: Integer; const ATablePositions: TArray<Integer>;
      ATotalPositions: TdxIntegerList);
    function CalculateColumnSpan(const ATotalPositions: TdxIntegerList;
      AStartPos: Integer; AEndPos: Integer): Integer;
  public
    constructor Create(const ATables: array of TdxTable);
    procedure MergeGrids(const ATableGrids: array of TdxTableGrid;
  ...
  protected
    ...
    function GetTableGrid(ATable: TdxTable; APercentWidthBase: Integer)
      : TdxTableGrid;
    function CalculateColumnIndex(APosition: Integer;
      AColumnWidthCollection: TdxIntegerList; var ACorrection: Integer)
      : Integer; virtual;
  public
    constructor Create(APieceTable: TdxPieceTable;
      const ATables: TdxTableArray);
  end;
  ...
  public
    constructor Create(APieceTable: TdxPieceTable;
      ATopTable, ABottomTable: TdxTable); reintroduce;
  end;
  ...
  TdxTableCellParameters = record
    ...
    constructor Create(AIndexInRow, ARowIndex, AStartColumnIndex,
  ...
  strict private
    ...
    function GetDocumentModel: TdxDocumentModel;
  protected
    function CalculatePatternCellsParameters(ACells: TdxTableCellList)
      : TList<TdxTableCellParameters>; virtual;
    procedure NormalizeColumnSpans;
    procedure SnapDistanceToColumnGrid(AMergedDistances: TdxIntegerList;
      ADistancesToNewCells: TdxList<TdxDistanceCollection>); virtual;
    function CalculateDistancesToNewCells
      : TdxList<TdxDistanceCollection>; virtual;
    function CalculateDistancesToNewCellsCore(ACellParameters
      : TdxTableCellParameters): TdxDistanceCollection; virtual;
    function GetColumnIndex(AIndex: Integer; ACell: TdxTableCell)
      : Integer; virtual;
    function CalculateDistance(ADistanceToCell: Integer; ACellWidth: Integer)
      : Integer; virtual;
    function MergeDistances(ADistances: TdxList<TdxDistanceCollection>)
      : TdxIntegerList;
    function GetRowContainsPatternCellIndexes: TdxIntegerList; virtual;
    procedure NormalizeColumnSpansCore(ADistances: TdxIntegerList;
      ATableRow: TdxTableRow);
    function GetWidthConsiderUnitType(AWidthUnit: TdxWidthUnit)
      : Integer; virtual;
    procedure RecalculateGridIntervals(AMergedDistances: TdxIntegerList);
    procedure NormalizeColumnSpansInRowContainingPatternCell
      (ADistances: TdxList<TdxDistanceCollection>);
    procedure NormalizeColumnSpansInRowContainingPatternCellCore
      (AColumnSpans: TdxIntegerList; ACellParameters: TdxTableCellParameters);
    function GetIndex(AIndex: Integer): Integer; virtual;
    function CalculateColumnSpansForNewCells(ADistances: TdxIntegerList;
      ACellParameters: TdxTableCellParameters): TdxIntegerList; virtual;
    function CalculateColumnIndexParameters(ADistanceToCell: Integer)
      : TdxColumnIndexParameters;
  ...
  public
    constructor Create(ATable: TdxTable; ACells: TdxTableCellList;
      AGridColumns: TdxTableGridColumnCollection;
      AUseDeltaBetweenColumns: Boolean);
    destructor Destroy; override;

    property Table: TdxTable read FTable;
    property PatternCellsParameters: TList<TdxTableCellParameters>
      read FPatternCellsParameters;
    property DocumentModel: TdxDocumentModel read GetDocumentModel;
  ...
  TdxNormalizeTableGridAfterSplitCellHelper = class
    (TdxNormalizeTableGridHelperBase)
  strict private
    FPartsCount: Integer;
  protected
    function CalculateDistancesToNewCellsCore(ACellParameters
      : TdxTableCellParameters): TdxDistanceCollection; override;
    procedure SnapDistanceToColumnGrid(AMergedDistances: TdxIntegerList;
      ADistancesToNewCells: TdxList<TdxDistanceCollection>); override;
    procedure ChangeDistance(ADistancesToNewCells
      : TdxList<TdxDistanceCollection>; AOldDistance: Integer;
      ANewDistance: Integer; const AStartIndices: TArray<Integer>);
  public
    constructor Create(ATable: TdxTable; ACells: TdxTableCellList;
      APartsCount: Integer; AGridColumns: TdxTableGridColumnCollection;
      AUseDeltaBetweenColumns: Boolean);
  end;

  { TdxNormalizeTableGridAfterInsertCellHelper }

  TdxNormalizeTableGridAfterInsertCellHelper = class
    (TdxNormalizeTableGridHelperBase)
  protected
    function GetIndex(AIndex: Integer): Integer; override;
    function CalculateColumnSpansForNewCells(ADistances: TdxIntegerList;
      ACellParameters: TdxTableCellParameters): TdxIntegerList; override;
  end;

  { TdxNormalizeTableGridAfterDeleteCellHelper }

  TdxNormalizeTableGridAfterDeleteCellHelper = class
    (TdxNormalizeTableGridHelperBase)
  protected
    function GetColumnIndex(AIndex: Integer; ACell: TdxTableCell)
      : Integer; override;
  ...
  public
    ...
    property OldOwnNumberingListIndex: TdxNumberingListIndex
      read FOldOwnNumberingListIndex write FOldOwnNumberingListIndex;
  end;
  ...
  public
    class procedure NotifyParagraphAdded(ADocumentModel: TdxDocumentModel;
      AIndex: TdxNumberingListIndex); static;
    class procedure NotifyParagraphRemoved(ADocumentModel: TdxDocumentModel;
      AIndex: TdxNumberingListIndex); static;
  end;
...
constructor TdxPieceTableInsertFieldSymbolResultAtInputPositionCommand.Create
...
procedure TdxPieceTableInsertFieldSymbolResultAtInputPositionCommand.
  ExecuteCore;
begin
  TdxPieceTable(PieceTable).InsertInsertFieldSymbolResultCore(ParagraphIndex,
    LogPosition, Symbol, ForceVisible);
end;
...
begin
  ...
  PieceTable.ApplyChanges(ChangeType, AParagraph.FirstRunIndex,
...
begin
  ...
  if (ASection.LastParagraphIndex = ParagraphIndex) and (ParagraphIndex > 0)
  then
...
constructor TdxDocumentModelInsertObjectAtLogPositionCommand.Create
  (ADocumentModel: TdxDocumentModel; ALogPosition: TdxDocumentLogPosition;
  AForceVisible: Boolean);
begin
...
function TdxDocumentModelInsertObjectAtLogPositionCommand.
  CalculateInsertionParagraphIndex: TdxParagraphIndex;
begin
...
constructor TdxDocumentModelInsertObjectAtInputPositionCommand.Create
  (ADocumentModel: TdxDocumentModel; APosition: TdxInputPosition);
begin
  inherited Create(ADocumentModel);
  if APosition.LogPosition < 0 then
    TdxRichEditExceptions.ThrowArgumentException('logPosition',
      APosition.LogPosition);
  FPosition := APosition;
end;

function TdxDocumentModelInsertObjectAtInputPositionCommand.
  CalculateInsertionParagraphIndex: TdxParagraphIndex;
begin
...
constructor TdxPieceTableApplyAutoCorrectCommand.Create
  (APieceTable: TdxPieceTable; ALogPosition: TdxDocumentLogPosition;
...
begin
  ACommand := TdxPieceTableDeleteTextCommand.Create(PieceTable,
    FLogPosition, FLength);
  try
...
begin
  ACommand := TdxPieceTableInsertPlainTextAtLogPositionCommand.Create
    (PieceTable, FLogPosition, FText, False);
  try
    ACommand.Execute;
  finally
    ACommand.Free;
...
procedure TdxPieceTableInsertFloatingObjectAnchorAtLogPositionCommand.
  ExecuteCore;
begin
  TdxPieceTable(PieceTable).InsertFloatingObjectAnchorCore(ParagraphIndex,
    LogPosition, ForceVisible);
end;

function TdxPieceTableInsertFloatingObjectAnchorAtLogPositionCommand.
  GetChangeType: TdxDocumentModelChangeType;
begin
...
constructor TdxPieceTableInsertContentConvertedToDocumentModelCommand.Create
  (ATargetPieceTable: TdxPieceTable; ASourceModel: TdxDocumentModel;
  ALogPosition: TdxDocumentLogPosition; AInsertOptions: TdxInsertOptions;
  AForceVisible: Boolean);
begin
...
constructor TdxPieceTableInsertContentConvertedToDocumentModelCommand.Create
  ...
  ALogPosition: TdxDocumentLogPosition; AForceVisible: Boolean);
begin
  Create(ATargetPieceTable, ASourceModel, ALogPosition,
    TdxInsertOptions.MatchDestinationFormatting, AForceVisible);
end;

procedure TdxPieceTableInsertContentConvertedToDocumentModelCommand.
  CopyDocumentModelContent(ACopyManager: TdxDocumentModelCopyManager;
  ALength: Integer);
var
  AOperation: TdxCopySectionOperation;
begin
  ACopyManager.TableCopyHelper.TargetStartParagraphIndex :=
    ACopyManager.TargetPosition.ParagraphIndex;
  ACopyManager.TableCopyHelper.SuppressCopyTables := True;
  AOperation := TdxCopySectionOperation(SourceModel.CreateCopySectionOperation
    (ACopyManager));
  try
    ...
    if FPasteFromIE then
      AOperation.UpdateFieldOperationType :=
        TdxUpdateFieldOperationType.PasteFromIE;
...
begin
  ...
  ACopyManager := TdxDocumentModelCopyManager
    (ATargetPieceTable.GetCopyManager(SourceModel.MainPieceTable,
    InsertOptions));
  try
    ACopyManager.IsInserted := True;
    ACopyManager.TargetPosition.LogPosition := LogPosition;
    ACopyManager.TargetPosition.ParagraphIndex :=
      ATargetPieceTable.FindParagraphIndex(LogPosition);
    ARangeStartLogPosition := ATargetPieceTable.FindRunStartLogPosition
      (ATargetPieceTable.Paragraphs[ACopyManager.TargetPosition.ParagraphIndex],
      LogPosition, ARunIndex);
    if ARangeStartLogPosition <> LogPosition then
    begin
      ATargetPieceTable.SplitTextRun(ACopyManager.TargetPosition.ParagraphIndex,
        ARunIndex, LogPosition - ARangeStartLogPosition);
...
function TdxPieceTableInsertContentConvertedToDocumentModelCommand.GetChangeType
  : TdxDocumentModelChangeType;
begin
  Result := TdxDocumentModelChangeType.None;
end;

function TdxPieceTableInsertContentConvertedToDocumentModelCommand.
  GetDocumentLength(ADocumentModel: TdxDocumentModel): Integer;
var
...
function TdxBookmarkCopyOperation.GetEntireBookmarks(ASourcePieceTable
  : TdxPieceTable; AStart: TdxDocumentLogPosition; ALength: Integer)
  : TdxBookmarkBaseList;
begin
  Result := ASourcePieceTable.GetEntireBookmarks(AStart, ALength);
end;

procedure TdxBookmarkCopyOperation.InsertBookmark(ATargetPieceTable
  : TdxPieceTable; AStart: TdxDocumentLogPosition; ALength: Integer;
  ABookmark: TdxBookmarkBase; APositionOffset: Integer);
begin
  ATargetPieceTable.CreateBookmarkCore(AStart, ALength,
    TdxBookmark(ABookmark).Name, FForceUpdateInterval);
end;

{ TdxCopyBookmarksOperation }

function TdxCopyBookmarksOperation.ExecuteCore(AInfo: TdxRunInfo;
...
procedure TdxCopyBookmarksOperation.CopyBookmarksToTargetModel
  (ARunInfo: TdxRunInfo; const APositionToInsert: TdxDocumentModelPosition);
begin
...
procedure TdxCopyBookmarksOperation.CopyBookmarksToTargetModelCore
  (ARunInfo: TdxRunInfo; const APositionToInsert: TdxDocumentModelPosition);
var
...
begin
  ...
  try
    ...
    CopyBookmarksToTargetModelCore(ARunInfo, APositionToInsert.LogPosition,
      ABookmarksAllowed, ABookmarkCopyOperation);
  finally
  ...
  try
    CopyBookmarksToTargetModelCore(ARunInfo, APositionToInsert.LogPosition,
      ABookmarksAllowed, ARangePermissionCopyOperation);
  finally
...
procedure TdxCopyBookmarksOperation.CopyBookmarksToTargetModelCore
  (ARunInfo: TdxRunInfo; const APositionToInsert: TdxDocumentLogPosition;
  AIsAllowed: Boolean; ABookmarkCopyOperation: TdxBookmarkCopyOperationBase);
var
...
begin
  ...
  ABookmarks := ABookmarkCopyOperation.GetEntireBookmarks(SourcePieceTable,
    AStartPos, ALength);
  try
    ...
    for I := 0 to ACount - 1 do
      ABookmarkCopyOperation.InsertBookmark(TargetPieceTable,
        ABookmarks[I].Start + AOffset, ABookmarks[I].Length,
...
function TdxRangePermissionCopyOperation.GetEntireBookmarks(ASourcePieceTable
  : TdxPieceTable; AStart: TdxDocumentLogPosition; ALength: Integer)
  : TdxBookmarkBaseList;
begin
...
procedure TdxRangePermissionCopyOperation.InsertBookmark(ATargetPieceTable
  : TdxPieceTable; AStart: TdxDocumentLogPosition; ALength: Integer;
  ABookmark: TdxBookmarkBase; APositionOffset: Integer);
var
...
begin
  ...
  if (ATargetModel.ModelForExport) or ATargetModel.IntermediateModel or
    not ASourceModel.IsDocumentProtectionEnabled then
    ATargetPieceTable.ApplyDocumentPermission(AStart, AStart + ALength,
      TdxRangePermission(ABookmark).Properties.Info);
end;

{ TdxDocumentModelCopyCommand }

constructor TdxDocumentModelCopyCommand.Create(ASourcePieceTable: TdxPieceTable;
  ATargetModel: TdxDocumentModel; AOptions: TdxDocumentModelCopyOptions);
begin
...
procedure TdxDocumentModelCopyCommand.CopyDocumentVariables(ATargetModel,
  ASourceModel: TdxDocumentModel);
var
...
class procedure TdxDocumentModelCopyCommand.CopyStyles(ATargetModel,
  ASourceModel: TdxDocumentModel; AWithId: Boolean = False);
begin
  ATargetModel.BeginUpdate;
  CopyStylesCore(ATargetModel.CharacterStyles,
    ASourceModel.CharacterStyles, AWithId);
  CopyStylesCore(ATargetModel.ParagraphStyles,
    ASourceModel.ParagraphStyles, AWithId);
  CopyStylesCore(ATargetModel.TableStyles, ASourceModel.TableStyles, AWithId);
  CopyStylesCore(ATargetModel.TableCellStyles,
    ASourceModel.TableCellStyles, AWithId);
  CopyStylesCore(ATargetModel.NumberingListStyles,
    ASourceModel.NumberingListStyles, AWithId);
...
begin
  if FOptions.DefaultPropertiesCopyOptions = TdxDefaultPropertiesCopyOptions.Always
  then
  ...
  ACopyManager := TdxDocumentModelCopyManager.Create(PieceTable,
    TargetModel.MainPieceTable, FOptions.ParagraphNumerationCopyOptions,
    FOptions.FormattingCopyOptions);
  try
    ACopyManager.TableCopyHelper.CopyFromNestedLevel :=
      TableCopyFromNestedLevel;
    AOperation := TdxCopySectionOperation
      (DocumentModel.CreateCopySectionOperation(ACopyManager));
    try
      ...
      try
        ...
        begin
          ...
          try
            ACopyBookmarksOperation.TargetBookmarksPosition :=
              ATargetBookmarksPositions[I];
            ACopyBookmarksOperation.Execute(ACurrentRange.From,
              ACurrentRange.Length, False);
          finally
...
procedure TdxDocumentModelCopyCommand.NormalizeTables
  (APieceTable: TdxPieceTable);
var
...
class procedure TdxDocumentModelCopyCommand.ReplaceDefaultProperties
  (ATargetModel, ASourceModel: TdxDocumentModel);
begin
  ATargetModel.DefaultCharacterProperties.Info.CopyFrom
    (ASourceModel.DefaultCharacterProperties.Info);
  ATargetModel.DefaultParagraphProperties.Info.CopyFrom
    (ASourceModel.DefaultParagraphProperties.Info);
  ATargetModel.DefaultTableCellProperties.Info.CopyFrom
    (ASourceModel.DefaultTableCellProperties.Info);
  ATargetModel.DefaultTableProperties.Info.CopyFrom
    (ASourceModel.DefaultTableProperties.Info);
  ATargetModel.DefaultTableRowProperties.Info.CopyFrom
    (ASourceModel.DefaultTableRowProperties.Info);
  ATargetModel.DocumentProperties.Info.CopyFrom
    (ASourceModel.DocumentProperties.Info);
end;

class procedure TdxDocumentModelCopyCommand.ReplaceDefaultStyles(ATargetModel,
  ASourceModel: TdxDocumentModel);
begin
  ...
  ReplaceStylesCore(ATargetModel.NumberingListStyles,
    ASourceModel.NumberingListStyles);
end;

class procedure TdxDocumentModelCopyCommand.ReplaceStylesCore(ATargetStyles,
  ASourceStyles: TdxStyleCollectionBase);
var
  I: Integer;
...
class procedure TdxDocumentModelCopyCommand.CopyStylesCore(ATargetStyles,
  ASourceStyles: TdxStyleCollectionBase; AWithId: Boolean);
var
  I: Integer;
  ATargetStyle, ASourceStyle: TdxStyleBase;
  AStyleIndex: Integer;
...
begin
  TdxPieceTable(PieceTable).InsertSeparatorTextRunCore(ParagraphIndex,
    LogPosition);
end;

function TdxPieceTableInsertSeparatorAtLogPositionCommand.GetChangeType
  : TdxDocumentModelChangeType;
begin
...
begin
  if DocumentModel.DocumentCapabilities.SectionsAllowed then
    DocumentModel.SafeEditor.InsertSectionCore(ParagraphIndex, LogPosition,
      ForceVisible)
  else
    PieceTable.InsertParagraphCore(ParagraphIndex, LogPosition, ForceVisible);
  DocumentModel.MainPieceTable.ApplyNumberingToInsertedParagraph
    (ParagraphIndex);
end;

function TdxDocumentModelInsertSectionAtLogPositionCommand.GetChangeType
  : TdxDocumentModelChangeType;
begin
...
constructor TdxPieceTableTableDocumentServerOwnerCommand.Create
  (APieceTable: TdxPieceTable;
  const AServer: IdxInnerRichEditDocumentServerOwner);
begin
  inherited Create(APieceTable);
...
constructor TdxPieceTableCreateEmptyTableCommand.Create
  (APieceTable: TdxPieceTable; ASourceCell: TdxTableCell);
begin
  inherited Create(APieceTable);
...
constructor TdxPieceTableCreateRowEmptyCommand.Create
  (APieceTable: TdxPieceTable; ATable: TdxTable; AIndex: Integer);
begin
  inherited Create(APieceTable);
  Assert(ATable <> nil);
  Assert(AIndex >= 0);
...
begin
  ATransaction := TdxHistoryTransaction.Create(DocumentModel.History);
  try
    AItem := TdxInsertEmptyTableRowHistoryItem.Create(PieceTable,
      FTable, FIndex);
    DocumentModel.History.Add(AItem);
    AItem.Execute;
...
constructor TdxPieceTableCreateCellEmptyCommand.Create
  (APieceTable: TdxPieceTable; ARow: TdxTableRow; AInsertedIndex: Integer;
...
begin
  ATransaction := TdxHistoryTransaction.Create(DocumentModel.History);
  try
    AItem := TdxInsertEmptyTableCellHistoryItem.Create(PieceTable, Row,
      InsertedIndex, StartParagraphIndex, EndParagraphIndex);
    DocumentModel.History.Add(AItem);
    AItem.Execute;
...
constructor TdxPieceTableInsertTableRowCommand.Create
  (APieceTable: TdxPieceTable; APatternRow: TdxTableRow;
  AForceVisible: Boolean);
begin
  inherited Create(APieceTable);
...
begin
  ...
  PieceTable.ConvertParagraphsIntoTableRow(ARow, NewRowStartParagraphIndex,
    ACellCount);
  ...
  begin
    ...
    CopyCharacterAndParagraphFormattingFromPatternCell(ASourceCell,
      ATargetCell);
    CorrectVerticalMerging(ARow, I, ASourceCell, ATargetCell);
  end;
end;

procedure TdxPieceTableInsertTableRowCommand.
  CopyCharacterAndParagraphFormattingFromPatternCell(ASource: TdxTableCell;
...
begin
  ...
  if PieceTable.Runs[ATargetParagraph.FirstRunIndex] is TdxParagraphRun then
    AFirstRunFromTargetParagraph :=
      TdxParagraphRun(PieceTable.Runs[ATargetParagraph.FirstRunIndex])
  else
    AFirstRunFromTargetParagraph := nil;
  if (AFirstRunFromPatternParagraph <> nil) and
    (AFirstRunFromTargetParagraph <> nil) then
  begin
    AOptions := DocumentModel.DocumentCapabilities;
    if AOptions.CharacterFormattingAllowed then
      AFirstRunFromTargetParagraph.CharacterProperties.CopyFrom
        (AFirstRunFromPatternParagraph.CharacterProperties.Info);
    if AOptions.CharacterStyleAllowed then
      AFirstRunFromTargetParagraph.CharacterStyleIndex :=
        AFirstRunFromPatternParagraph.CharacterStyle.Copy(DocumentModel);
  end;
end;

procedure TdxPieceTableInsertTableRowCommand.InsertParagraphs
  (ALogPosition: TdxDocumentLogPosition; ACells: TdxTableCellCollection);
var
  ACount, I: Integer;
...
begin
  ...
  PieceTable.ChangeCellEndParagraphIndex(PatternRow.LastCell,
    AIndex - PatternRow.Cells.Count);
end;
...
procedure TdxPieceTableInsertTableRowBelowCommand.CopyPropertiesFromPatternCell
  (ASourceCell, ATargetCell: TdxTableCell);
var
...
begin
  ...
  begin
    AFirstCellInVerticalMergeGroup :=
      ASourceCell.Table.GetFirstCellInVerticalMergingGroup(ASourceCell);
...
procedure TdxPieceTableInsertTableRowBelowCommand.CorrectVerticalMerging
  (ACreatedRow: TdxTableRow; I: Integer;
  ASourceCell, ATargetCell: TdxTableCell);
var
...
begin
  ...
  begin
    ...
    begin
      ASourceCellStartColumnIndex :=
        ASourceCell.GetStartColumnIndexConsiderRowGrid;
      AIndexInNextRow := ANextRow.Table.GetAbsoluteCellIndexInRow(ANextRow,
        ASourceCellStartColumnIndex, False);
      if ANextRow.Cells[AIndexInNextRow].VerticalMerging <> TdxMergingState.Continue
      then
        ATargetCell.VerticalMerging := TdxMergingState.None;
    end;
  end
  else if ASourceCell.VerticalMerging = TdxMergingState.Restart then
    ATargetCell.VerticalMerging := TdxMergingState.Continue;
end;

function TdxPieceTableInsertTableRowBelowCommand.GetNextRow(ARow: TdxTableRow)
  : TdxTableRow;
begin
  Result := ARow.Next;
end;
...
begin
  ...
  PieceTable.ChangeCellStartParagraphIndex(PatternRow.FirstCell,
    AIndex + PatternRow.Cells.Count);
  while AMostNestedCell.Table.ParentCell <> nil do
  begin
    PieceTable.ChangeCellStartParagraphIndex(AMostNestedCell,
      AIndex + PatternRow.Cells.Count);
...
procedure TdxPieceTableInsertTableRowAboveCommand.CopyPropertiesFromPatternCell
  (ASourceCell, ATargetCell: TdxTableCell);
begin
  ATargetCell.Properties.CopyFrom(ASourceCell.Properties);
end;

procedure TdxPieceTableInsertTableRowAboveCommand.CorrectVerticalMerging
  (ARow: TdxTableRow; I: Integer; ASourceCell, ATargetCell: TdxTableCell);
begin
...
function TdxPieceTableInsertTableRowAboveCommand.GetNextRow(ARow: TdxTableRow)
  : TdxTableRow;
begin
...
constructor TdxPieceTableMergeTableCellsCommandBase.Create
  (APieceTable: TdxPieceTable; ACell: TdxTableCell);
begin
  inherited Create(APieceTable);
...
function TdxPieceTableMergeTableCellsCommandBase.GetCopyPieceTable
  : TdxPieceTable;
begin
...
function TdxPieceTableMergeTableCellsCommandBase.CalculateSelectionRange
  (ACell: TdxTableCell): TdxSelectionRange;
var
  AStartLogPosition, AEndLogPosition: TdxDocumentLogPosition;
  ALength: Integer;
begin
  AStartLogPosition := PieceTable.Paragraphs[ACell.StartParagraphIndex]
    .LogPosition;
  AEndLogPosition := PieceTable.Paragraphs[ACell.EndParagraphIndex]
    .EndLogPosition;
  ALength := AEndLogPosition - AStartLogPosition + 1;
  Result := TdxSelectionRange.Create(AStartLogPosition, ALength);
end;

function TdxPieceTableMergeTableCellsCommandBase.IsEmptyCell
  (ACell: TdxTableCell): Boolean;
var
  AStartParagraph: TdxParagraph;
begin
  AStartParagraph := PieceTable.Paragraphs[ACell.StartParagraphIndex];
  Result := (ACell.StartParagraphIndex = ACell.EndParagraphIndex) and
    (AStartParagraph.Length = 1);
end;

procedure TdxPieceTableMergeTableCellsCommandBase.CopyToCopyPieceTable
  (ACopyingRange: TdxSelectionRange);
var
...
begin
  ...
  try
    AOptions := TdxDocumentModelCopyOptions.Create(ACopyingRange.Start,
      ACopyingRange.Length);
    try
      ACopyCommand := TdxDocumentModelCopyCommand
        (PieceTable.DocumentModel.CreateDocumentModelCopyCommand(PieceTable,
        FCopyDocumentModel, AOptions));
      try
...
procedure TdxPieceTableMergeTableCellsCommandBase.DeleteTableCellWithContent
  (ANextCell: TdxTableCell; ADeletingRange: TdxSelectionRange);
var
  ATable: TdxTable;
begin
  ATable := ANextCell.Table;
  if NeedDeleteNextTableCell then
    PieceTable.DeleteTableCellWithNestedTables(ATable.Index, ANextCell.RowIndex,
      ANextCell.IndexInRow);
...
begin
  APosition := PieceTable.Paragraphs[PatternCell.EndParagraphIndex]
    .EndLogPosition;
  ACommand := TdxPieceTableInsertContentConvertedToDocumentModelCommand.Create
    (PieceTable, FCopyDocumentModel, APosition, False);
  try
...
procedure TdxPieceTableMergeTableCellsCommandBase.FixParagraphsInPatternCell
  (ANeedDeleteFirstParagraphInCell: Boolean;
  ANeedDeleteLastParagraphInCell: Boolean);
var
  AOperation: TdxDeleteParagraphOperation;
  AParagraphs: TdxParagraphCollection;
begin
  if not ANeedDeleteFirstParagraphInCell and not ANeedDeleteLastParagraphInCell
  then
    Exit;
  ...
  try
    ...
    begin
      AOperation.Execute(AParagraphs[PatternCell.StartParagraphIndex]
        .LogPosition, 1, False);
      Exit;
    end;
    if ANeedDeleteLastParagraphInCell then
      AOperation.Execute(AParagraphs[PatternCell.EndParagraphIndex].LogPosition,
        1, False);
  finally
    AOperation.Free;
  end;
...
function TdxPieceTableMergeTwoTableCellsHorizontallyCommand.CalculateNextCell
  : TdxTableCell;
var
  ARow: TdxTableRow;
  ACells: TdxTableCellCollection;
...
procedure TdxPieceTableMergeTwoTableCellsHorizontallyCommand.
  DeleteTableCellWithContent(ANextCell: TdxTableCell;
...
procedure TdxPieceTableMergeTwoTableCellsHorizontallyCommand.UpdateProperties
  (ANextCell: TdxTableCell);
begin
  PatternCell.ColumnSpan := PatternCell.ColumnSpan + ANextCell.ColumnSpan;
  PatternCell.PreferredWidth.Value := PatternCell.PreferredWidth.Value +
    ANextCell.PreferredWidth.Value;
end;

{ TdxPieceTableMergeTwoTableCellsVerticallyCommand }

function TdxPieceTableMergeTwoTableCellsVerticallyCommand.CalculateNextCell
  : TdxTableCell;
var
  ATable: TdxTable;
...
procedure TdxPieceTableMergeTwoTableCellsVerticallyCommand.UpdateProperties
  (ANextCell: TdxTableCell);
begin
...
constructor TdxPieceTableMergeTableCellsHorizontallyCommand.Create
  (APieceTable: TdxPieceTable; ACell: TdxTableCell; ACount: Integer);
begin
  inherited Create(APieceTable);
  Assert(ACell <> nil);
  Assert(ACount > 0);
...
function TdxPieceTableMergeTableCellsHorizontallyCommand.CalculateCellIndex
  (ARow: TdxTableRow; AStartCellIndex, AColumnSpan: Integer): Integer;
var
  ACells: TdxTableCellCollection;
  ACount: Integer;
begin
...
begin
  ...
  try
    ...
    begin
      ...
      ACommand := TdxPieceTableMergeTwoTableCellsHorizontallyCommand.Create
        (PieceTable, AMergeCell);
      try
...
constructor TdxPieceTableMergeTableCellsVerticallyCommand.Create
  (APieceTable: TdxPieceTable; ACell: TdxTableCell; ACount: Integer);
begin
  inherited Create(APieceTable);
  Assert(ACell <> nil);
...
begin
  ...
  try
    ...
    begin
      ...
      ACommand := TdxPieceTableMergeTwoTableCellsVerticallyCommand.Create
        (PieceTable, AMergeCell);
      try
        ACommand.SuppressNormalizeTableRows := True;
        ACommand.Execute;
...
constructor TdxPieceTableDeleteTableCellWithNestedTablesCommand.Create
  (APieceTable: TdxPieceTable; ATableIndex, ARowIndex, ACellIndex: Integer);
begin
  inherited Create(APieceTable);
...
begin
  ATransaction := TdxHistoryTransaction.Create(DocumentModel.History);
  try
    ADeletedCell := PieceTable.Tables[FTableIndex].Rows[FRowIndex].Cells
      [FCellIndex];
...
constructor TdxPieceTableSplitTableCommand.Create(APieceTable: TdxPieceTable;
  ATableIndex, ARowIndex: Integer; AForceVisible: Boolean);
begin
  inherited Create(APieceTable);
  Assert(ATableIndex >= 0);
  Assert(ARowIndex >= 0);
...
function TdxPieceTableSplitTableCommand.CalculateSelectionRange
  : TdxSelectionRange;
var
...
procedure TdxPieceTableSplitTableCommand.CopyToCopyPieceTable
  (ACopyingRange: TdxSelectionRange);
var
  AOptions: TdxDocumentModelCopyOptions;
  ACopyCommand: TdxDocumentModelCopyCommand;
begin
  ...
  try
    AOptions := TdxDocumentModelCopyOptions.Create(ACopyingRange.Start,
      ACopyingRange.Length);
    try
      ACopyCommand := PieceTable.DocumentModel.CreateDocumentModelCopyCommand
        (PieceTable, FCopyDocumentModel, AOptions)
        as TdxDocumentModelCopyCommand;
      try
        ACopyCommand.Execute;
      finally
        ACopyCommand.Free;
...
begin
  ...
  ACommand := TdxPieceTableInsertContentConvertedToDocumentModelCommand.Create
    (PieceTable, FCopyDocumentModel, APosition + 2, FForceVisible);
  try
    ACommand.CopyBetweenInternalModels := True;
    ACommand.Execute;
  finally
...
procedure TdxPieceTableSplitTableCommand.DeleteContent(ADeletingRange
  : TdxSelectionRange);
var
...
begin
  ...
  begin
    PieceTable.ChangeCellStartParagraphIndex(ANestedCell,
      ANestedCell.StartParagraphIndex + 1);
    ANestedCell := PieceTable.Paragraphs[AStartParagraphIndex].GetCell;
  end;
  PieceTable.ChangeCellStartParagraphIndex(AFirstCell,
    AStartParagraphIndex + 1);
end;

procedure TdxPieceTableSplitTableCommand.InsertParagraphWithDefaultProperties
  (APosition: TdxDocumentLogPosition);
var
...
begin
  ...
  AInsertedParagraph.ParagraphStyleIndex :=
    AParagraphStales.IndexOf(AParagraphStales.DefaultItem);
...
constructor TdxPieceTablePieceTableInsertColumnBase.Create
  (APieceTable: TdxPieceTable; APatternCell: TdxTableCell;
  AForceVisible: Boolean);
begin
  inherited Create(APieceTable);
...
procedure TdxPieceTablePieceTableInsertColumnBase.
  ChangeStartParagraphIndexInCells(ACells: TdxTableCellList);
var
...
begin
  ...
  begin
    ...
    PieceTable.ChangeCellStartParagraphIndex(ACurrentCell,
      ACurrentCell.StartParagraphIndex + 1);
  end;
end;
...
function TdxPieceTablePieceTableInsertColumnBase.InsertColumnCore
  (ARow: TdxTableRow; AInsertedIndex: Integer; AStart, AEnd: TdxParagraphIndex)
  : TdxTableCell;
begin
  Result := PieceTable.CreateTableCellCore(ARow, AInsertedIndex, AStart, AEnd);
end;

procedure TdxPieceTablePieceTableInsertColumnBase.InsertColumnToTheLeft
  (ACurrentRow: TdxTableRow; ACurrentCell: TdxTableCell);
var
...
begin
  ...
  ACells := PieceTable.TableCellsManager.GetCellsByParagraphIndex
    (AParagraphIndex, ACurrentCell.Table.NestedLevel);
  try
  ...
  ANewCell := InsertColumnCore(ACurrentRow, ACurrentCell.IndexInRow,
    AParagraphIndex, AParagraphIndex);
...
procedure TdxPieceTablePieceTableInsertColumnBase.InsertColumnToTheRight
  (ACurrentRow: TdxTableRow; ACurrentCell: TdxTableCell);
var
  AParagraphIndex: TdxParagraphIndex;
  ALogPosition: TdxDocumentLogPosition;
...
begin
  ...
  PieceTable.InsertParagraph(ALogPosition, ForceVisible);
  PieceTable.ChangeCellEndParagraphIndex(ACurrentCell,
    ACurrentCell.EndParagraphIndex - 1);

  Inc(AParagraphIndex, 1);
  ANextCell := ACurrentCell.NextCellInRow;
  ANewCell := InsertColumnCore(ACurrentRow, ACurrentCell.IndexInRow + 1,
    AParagraphIndex, AParagraphIndex);
  ANewCell.StyleIndex := ACurrentCell.StyleIndex;
...
procedure TdxPieceTablePieceTableInsertColumnBase.NormalizeTableCellWidth
  (ATable: TdxTable);
var
...
begin
  Result := TdxTableCellVerticalBorderCalculator.GetStartColumnIndex
    (PatternCell, False);
end;

function TdxPieceTableInsertColumnToTheLeft.GetCurrentCell
  (AColumnIndex: Integer; ACurrentRow: TdxTableRow): TdxTableCell;
begin
  Result := TdxTableCellVerticalBorderCalculator.GetCellByColumnIndex
    (ACurrentRow, AColumnIndex);
end;

procedure TdxPieceTableInsertColumnToTheLeft.Modify(ACurrentRow: TdxTableRow;
  ACurrentCell: TdxTableCell);
begin
...
begin
  Result := TdxTableCellVerticalBorderCalculator.GetStartColumnIndex
    (PatternCell, False) + PatternCell.ColumnSpan - 1;
end;

function TdxPieceTableInsertColumnToTheRight.GetCurrentCell
  (AColumnIndex: Integer; ACurrentRow: TdxTableRow): TdxTableCell;
begin
  Result := TdxTableCellVerticalBorderCalculator.GetCellByEndColumnIndex
    (ACurrentRow, AColumnIndex);
end;

procedure TdxPieceTableInsertColumnToTheRight.Modify(ACurrentRow: TdxTableRow;
  ACurrentCell: TdxTableCell);
begin
  if ACurrentCell = nil then
...
constructor TdxPieceTableDeleteTableColumnsCommand.Create
  (APieceTable: TdxPieceTable; ASelectedCells: TdxSelectedCellsCollection;
  const AServer: IdxInnerRichEditDocumentServerOwner);
begin
...
procedure TdxPieceTableDeleteTableColumnsCommand.DeleteCellsWithContent
  (ACells: TdxTableCellList; AContainer: TdxTableWidthsContainer);
var
...
begin
  ...
  begin
    ACurrentCell := ACells[I];
    if (ACurrentCell.VerticalMerging = TdxMergingState.Continue) and
      (ACurrentCell.IndexInRow = -1) then
      Continue;

    ACommand := TdxPieceTableDeleteTableCellWithContentKnownWidthsCommand.Create
      (PieceTable, ACurrentCell, DocumentServer, AContainer);
    try
...
begin
  ...
  try
    ...
    try
      ACalculator := TdxTableColumnWidthCalculator.Create(ATable,
        DocumentServer);
      try
        ...
        try
          ...
          begin
            ACurrentRow := ARows[I];
            ACells := TdxTableCellVerticalBorderCalculator.
              GetCellsByIntervalColumnIndex(ACurrentRow, StartColumnIndex,
              EndColumnIndex);
          ...
          ANewCalculator := TdxTableColumnKnownWidthCalculator.Create(ATable,
            AContainer);
          try
            ...
            try
              ...
              try
                ATableGridIntervals := CalculateTableGridIntervals
                  (AColumnCollection);
                try
...
function TdxPieceTableDeleteTableColumnsCommand.GetEndColumnIndex
  (ALastCell: TdxTableCell): Integer;
begin
  Result := TdxTableCellVerticalBorderCalculator.GetStartColumnIndex(ALastCell,
    False) + ALastCell.ColumnSpan - 1;
end;

function TdxPieceTableDeleteTableColumnsCommand.GetStartColumnIndex
  (AFirstCell: TdxTableCell): Integer;
begin
  Result := TdxTableCellVerticalBorderCalculator.GetStartColumnIndex
    (AFirstCell, False);
end;

function TdxPieceTableDeleteTableColumnsCommand.
  IsAllCellsVerticalMergingContinue(ACells: TdxTableCellCollection): Boolean;
var
  I, ACellsCount: Integer;
begin
  ACellsCount := ACells.Count;
...
function TdxPieceTableDeleteTableColumnsCommand.IsSelectedEntireRow
  (ACells: TdxTableCellList): Boolean;
var
  ARow: TdxTableRow;
  AFirstCell, ALastCell: TdxTableCell;
begin
...
procedure TdxPieceTableDeleteTableColumnsCommand.NormalizeCellVerticalMerging
  (ATable: TdxTable);
var
  ARows: TdxTableRowCollection;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        ANextCell := TdxTableCellVerticalBorderCalculator.
          GetCellByStartColumnIndex(ANextRow, AColumnIndex, False);
        if (ANextCell = nil) or
      ...
      begin
        ...
        if APrevRow <> nil then
          APrevCell := TdxTableCellVerticalBorderCalculator.
            GetCellByStartColumnIndex(APrevRow, AColumnIndex, False)
        else
          APrevCell := nil;
        if ANextRow <> nil then
          ANextCell := TdxTableCellVerticalBorderCalculator.
        ...
        if ((APrevCell = nil) or
          (APrevCell.VerticalMerging = TdxMergingState.None)) and
          ((ANextCell = nil) or (ANextCell.VerticalMerging <>
          TdxMergingState.Continue)) then
        begin
          ACurrentCell.Properties.VerticalMerging := TdxMergingState.None;
          Continue;
        end;
...
function TdxPieceTableDeleteTableColumnsCommand.CalculateTableGridIntervals
  (ATableGridColumnCollection: TdxTableGridColumnCollection)
  : TdxTableGridIntervalList;
var
  ACount, I: Integer;
begin
  ...
  for I := 0 to ACount - 1 do
    Result.Add(TdxTableGridInterval.Create(ATableGridColumnCollection[I].Width,
      1, TdxTableGridIntervalType.ModelUnit));
end;

{ TdxPieceTableDeleteTableCellsWithShiftToTheUpCommand }

constructor TdxPieceTableDeleteTableCellsWithShiftToTheUpCommand.Create
  (APieceTable: TdxPieceTable; ASelectedCells: TdxSelectedCellsCollection);
begin
  inherited Create(APieceTable);
  Assert(ASelectedCells <> nil);
...
procedure TdxPieceTableDeleteTableCellsWithShiftToTheUpCommand.
  DeleteSelectedCells(ASelectedCells: TdxSelectedCellsIntervalInRow);
var
...
begin
  ...
  begin
    ...
    ACommand := TdxPieceTableDeleteTableCellWithShiftToTheUpCoreCommand.Create
      (PieceTable, ADeletedCell);
    try
      ACommand.Execute;
    finally
      ACommand.Free;
...
constructor TdxPieceTableDeleteTableCellWithShiftToTheUpCoreCommand.Create
  (APieceTable: TdxPieceTable; ACell: TdxTableCell);
begin
  inherited Create(APieceTable);
  FCell := ACell;
...
begin
  ...
  begin
    ...
    ACommand := TdxPieceTableDeleteOneTableCellWithShiftToTheUpCommand.Create
      (PieceTable, ADeletedCell);
    try
      ACommand.Execute;
    finally
...
constructor TdxPieceTableDeleteOneTableCellWithShiftToTheUpCommand.Create
  (APieceTable: TdxPieceTable; ACell: TdxTableCell);
begin
...
procedure TdxPieceTableDeleteOneTableCellWithShiftToTheUpCommand.
  DeleteContentInCell;
var
  AStartLogPosition: TdxDocumentLogPosition;
begin
  AStartLogPosition := FRunInfo.Start.LogPosition;
  PieceTable.DeleteContent(AStartLogPosition, FRunInfo.&End.LogPosition -
    AStartLogPosition + 1, False);
end;
...
procedure TdxPieceTableDeleteOneTableCellWithShiftToTheUpCommand.
  FixParagraphsInPatternCell(ANeedDeleteFirstParagraphInCell,
  ANeedDeleteLastParagraphInCell: Boolean);
begin
  DeleteContentInCell;
end;
...
procedure TdxPieceTableDeleteOneTableCellWithShiftToTheUpCommand.
  UpdateProperties(ANextCell: TdxTableCell);
begin
end;

{ TdxPieceTableDeleteTableCellWithContentCommand }

constructor TdxPieceTableDeleteTableCellWithContentCommand.Create
...
function TdxPieceTableDeleteTableCellWithContentCommand.
  CreateTableColumnWidthCalculator(ATable: TdxTable)
  : TdxCustomTableColumnWidthCalculator;
begin
...
begin
  ...
  try
    ...
    APatternCellStartColumnIndex :=
      FDeletedCell.GetStartColumnIndexConsiderRowGrid;
    if CollectVerticalSpanCells then
      AVerticalSpanCells := TdxTableCellVerticalBorderCalculator.
        GetVerticalSpanCells(FDeletedCell, APatternCellStartColumnIndex, False)
    else
    begin
    ...
    try
      ...
      try
        ...
        ANormalizeHelper := TdxNormalizeTableGridAfterDeleteCellHelper.Create
          (ATable, AVerticalSpanCells, AColumns, UseDeltaBetweenColumnsUpdate);
        try
          ...
          begin
            ...
            try
              ...
              PieceTable.DeleteContent(AStartLogPosition,
                ARunInfo.&End.LogPosition - AStartLogPosition + 1, False, True);
            finally
              ARunInfo.Free;
            end;
          end;
...
constructor TdxPieceTableDeleteTableCellWithContentKnownWidthsCommand.Create
  (APieceTable: TdxPieceTable; ADeletedCell: TdxTableCell;
  const AServer: IdxInnerRichEditDocumentServerOwner;
  const AContainer: TdxTableWidthsContainer);
begin
  inherited Create(APieceTable, ADeletedCell, AServer);
  FContainer := AContainer;
end;

function TdxPieceTableDeleteTableCellWithContentKnownWidthsCommand.
  CreateTableColumnWidthCalculator(ATable: TdxTable)
  : TdxCustomTableColumnWidthCalculator;
begin
...
constructor TdxPieceTableInsertTableCellsBase.Create(APieceTable: TdxPieceTable;
...
begin
  ...
  try
    ...
    APatternCellStartColumnIndex := ATable.GetCellColumnIndexConsiderRowGrid
      (PatternCell);
    ...
    ACells := TdxTableCellVerticalBorderCalculator.GetVerticalSpanCells
      (ARestartCell, APatternCellStartColumnIndex, False);
    try
      ...
      try
        ...
        begin
          ...
          ANormalizeHelper := TdxNormalizeTableGridAfterInsertCellHelper.Create
            (ATable, ACells, ATableGridColumns, True);
        end;
...
procedure TdxPieceTableInsertTableCellsBase.NormalizeTableGridAfter
  (ATable: TdxTable);
var
...
begin
  ...
  begin
    ACurrentRow := ARows[I];
    ACurrentEndColumnIndex :=
      ACurrentRow.LastCell.GetEndColumnIndexConsiderRowGrid +
      ACurrentRow.GridAfter;
  ...
  begin
    ...
    ACurrentEndColumnIndex :=
      ACurrentRow.LastCell.GetEndColumnIndexConsiderRowGrid +
      ACurrentRow.GridAfter;
    ACurrentRow.GridAfter := ACurrentRow.GridAfter -
      (ACurrentEndColumnIndex - AMinEndColumnIndex);
  end;
end;

{ TdxPieceTableInsertTableCellToTheLeft }

function TdxPieceTableInsertTableCellToTheLeft.Modify(ACell: TdxTableCell)
  : TdxTableCell;
var
  AParagraphIndex: TdxParagraphIndex;
  ALogPosition: TdxDocumentLogPosition;
...
begin
  ...
  ACells := PieceTable.TableCellsManager.GetCellsByParagraphIndex
    (AParagraphIndex, ACell.Table.NestedLevel);
  try
    PieceTable.InsertParagraph(ALogPosition, ForceVisible);
    ChangeStartParagraphIndexInCells(ACells);
    Result := PieceTable.CreateTableCellCore(ACell.Row, ACell.IndexInRow,
      AParagraphIndex, AParagraphIndex);
  finally
    ACells.Free;
  end;
...
procedure TdxPieceTableInsertTableCellToTheLeft.ChangeStartParagraphIndexInCells
  (ACells: TdxTableCellList);
var
  I, ACellsCount: Integer;
  ACurrentCell: TdxTableCell;
...
function TdxPieceTableInsertTableCellToTheRight.Modify(ACell: TdxTableCell)
  : TdxTableCell;
var
  AParagraphIndex: TdxParagraphIndex;
  ALogPosition: TdxDocumentLogPosition;
...
begin
  ...
  Result := PieceTable.CreateTableCellCore(ACell.Row, AInsertedIndex,
    AParagraphIndex + 1, AParagraphIndex + 1);
end;

{ TdxPieceTableInsertTableCellWithShiftToTheDownCommand }

constructor TdxPieceTableInsertTableCellWithShiftToTheDownCommand.Create
  (APieceTable: TdxPieceTable; APatternCell: TdxTableCell;
...
procedure TdxPieceTableInsertTableCellWithShiftToTheDownCommand.
...
begin
  ...
  try
    AStartLogPosition := ARunInfo.Start.LogPosition;
    PieceTable.DeleteContent(AStartLogPosition, ARunInfo.&End.LogPosition -
      AStartLogPosition + 1, False);
  finally
    ARunInfo.Free;
  end;
...
var
  ATransaction: TdxHistoryTransaction;
  ARows: TdxTableRowCollection;
  I, AStartRowIndex, AEndRowIndex, APatternCellIndexInRow,
    ACellsCountInCurrentRow: Integer;
  ...
  try
    ...
    begin
      ...
      if APatternCellIndexInRow >= ACellsCountInCurrentRow then
        InsertTableCells(ACurrentRow.LastCell, APatternCellIndexInRow -
          ACellsCountInCurrentRow + 1, APreviousRow.LastCell.PreferredWidth);

      ACurrentCell := ACurrentRow.Cells[APatternCellIndexInRow];
      ACommand := TdxPieceTableInsertTableCellWithShiftToTheDownCoreCommand.
        Create(PieceTable, ACurrentCell);
      try
        ACommand.Execute;
      finally
        ACommand.Free;
...
procedure TdxPieceTableInsertTableCellWithShiftToTheDownCommand.InsertTableCells
  (APatternCell: TdxTableCell; AInsertedCellsCount: Integer;
...
begin
  ...
  begin
    ...
    ACommand := TdxPieceTableInsertTableCellToTheRight.Create(PieceTable,
      ACellsInRow[AIndexLastCell], FForceVisible, DocumentServer);
    try
...
function TdxPieceTableInsertTableCellWithShiftToTheDownCoreCommand.
  CalculateNextCell: TdxTableCell;
begin
  Result := PatternCell.Table.Rows[PatternCell.Row.IndexInTable - 1].Cells
    [PatternCell.IndexInRow];
end;

procedure TdxPieceTableInsertTableCellWithShiftToTheDownCoreCommand.
  DeleteTableCellWithContent(ANextCell: TdxTableCell;
  ADeletingRange: TdxSelectionRange);
var
...
begin
  ...
  try
    PieceTable.DeleteContent(ASelectionRangeForPatternCell.Start,
      ASelectionRangeForPatternCell.Length, False);
  finally
...
constructor TdxPieceTableSplitTableCellsHorizontally.Create
  (APieceTable: TdxPieceTable; APatternCell: TdxTableCell; APartsCount: Integer;
  AForceVisible: Boolean; const AServer: IdxInnerRichEditDocumentServerOwner);
begin
  inherited Create(APieceTable, AServer);
  FPatternCell := APatternCell;
...
var
  ATransaction: TdxHistoryTransaction;
  ATableGridColumns: TdxTableGridColumnCollection;
  APatternCellStartColumnIndex, AOldWidthPatternCell, ALastCellIndex,
    I: Integer;
  AVerticalSpanCells: TdxTableCellList;
  ACalculator: TdxTableColumnWidthCalculator;
...
begin
  ...
  try
    APatternCellStartColumnIndex :=
      FPatternCell.GetStartColumnIndexConsiderRowGrid;
    AVerticalSpanCells := TdxTableCellVerticalBorderCalculator.
      GetVerticalSpanCells(FPatternCell, APatternCellStartColumnIndex, False);
    try
      ACalculator := TdxTableColumnWidthCalculator.Create(FPatternCell.Table,
        DocumentServer);
      try
        ATableGridColumns := ACalculator.GetTableGridColumns;
        ANormalizeHelper := TdxNormalizeTableGridAfterSplitCellHelper.Create
          (FPatternCell.Table, AVerticalSpanCells, FPartsCount,
        ...
        try
          ...
          for I := ALastCellIndex downto 0 do
            AVerticalSpanCells[I].PreferredWidth.Value := AVerticalSpanCells[I]
              .PreferredWidth.Value div FPartsCount;

          for I := 0 to FPartsCount - 1 - 1 do
          begin
            ACommand := TdxPieceTableInsertTableCellToTheRight.Create
              (PieceTable, FPatternCell, FForceVisible, DocumentServer);
            try
              ACommand.CanNormalizeTable := False;
...
procedure TdxPieceTableSplitTableCellsHorizontally.NormalizeTableCellsWidth
  (AOldWidth: Integer);
var
  ACells: TdxTableCellCollection;
  ACurrentCell: TdxTableCell;
...
constructor TdxPieceTableSplitTableCellsVertically.Create
  (APieceTable: TdxPieceTable; APatternCell: TdxTableCell;
...
begin
  ...
  try
    ...
    if ACellsInRow[ANormStartIndex].VerticalMerging = TdxMergingState.Restart
    then
    begin
    ...
    for I := 0 to ACellsCount - 1 do
      ...
      begin
        ...
        AMergeCell := ACurrentCell.Table.GetFirstCellInVerticalMergingGroup
          (ACurrentCell);
...
function TdxPieceTableSplitTableCellsVertically.
  GetSelectedCellsEndIndex: Integer;
begin
...
procedure TdxPieceTableSplitTableCellsVertically.SplitMergedCellsVertically
  (ACellsInRow: TdxTableCellCollection);
var
  AEndIndex, I: Integer;
begin
...
procedure TdxPieceTableSplitTableCellsVertically.SplitMergedCellsVerticallyCore
...
begin
  AColumnIndex := TdxTableCellVerticalBorderCalculator.GetStartColumnIndex
    (ARestartCell, False);
  AMergedCells := TdxTableCellVerticalBorderCalculator.GetVerticalSpanCells
    (ARestartCell, AColumnIndex, False);
  try
...
function TdxTableGridMerger.GetPositions(const APositionInfo
  : TArray<TdxPositionInfo>): TArray<Integer>;
var
  I: Integer;
begin
...
procedure TdxTableGridMerger.MergeGrids(const ATableGrids
  : array of TdxTableGrid; const ASourceTableRowsCount: array of Integer);
var
...
begin
  ...
  try
    AAbsolutePositions := CalculateMergedPositions(FTables, ATableGrids,
      ATotalPosition, ASourceTableRowsCount);
    try
      ...
      for I := 0 to ACount - 1 do
      begin
        MergedGridCore(AResultTable, ARowIndex,
          ARowIndex + ASourceTableRowsCount[I] - 1, AAbsolutePositions[I],
          ATotalPosition);
...
function TdxTableGridMerger.CalculateMergedPositions(const ATables
  : array of TdxTable; const ATableGrids: array of TdxTableGrid;
  ATotalPositions: TdxIntegerList;
  const ASourceTableRowsCount: array of Integer): TList<TArray<Integer>>;
var
...
begin
  ...
  try
    ...
    for I := 0 to ACount - 1 do
      AAbsolutePositions.Add(CalculateAbsolutePositions(ATables[I],
        ATableGrids[I].Columns, ASourceTableRowsCount[I]));
...
function TdxTableGridMerger.CalculateAbsolutePositions(ATable: TdxTable;
  AColumns: TdxTableGridColumnCollection; ARowCount: Integer)
  : TArray<TdxPositionInfo>;
var
...
begin
  ...
  begin
    ...
    APositions[I + 1] := TdxPositionInfo.Create(ACurrentPosition,
      MaxInt, MaxInt);
  end;
  ARows := ATable.Rows;
...
function TdxTableGridMerger.AdjustLeft(ATotalPositions: TdxIntegerList;
  ATotalPositionIndex: Integer; const APositions: TArray<TdxPositionInfo>;
  APositionIndex, ALayoutDelta: Integer; APos: TdxPositionInfo): Boolean;
var
...
begin
  ...
  if ((APos.Position - APrevPosition < ALayoutDelta) and
    ((APositionIndex = 0) or (APrevPosition >= APositions[APositionIndex - 1]
    .Position))) and ((APos.MinLeft < 0) or
    (APrevPosition > APositions[APos.MinLeft].Position)) then
  begin
...
procedure TdxTableGridMerger.AdjustNearestPositions(const AAbsolutePositions
  : TList<TArray<TdxPositionInfo>>; ALayoutDelta: Integer;
  const ATotalPositions: TdxIntegerList);
var
...
procedure TdxTableGridMerger.AdjustPosition(const ATotalPositions
  : TdxIntegerList; ATotalPositionIndex: Integer;
  const APositions: TArray<TdxPositionInfo>; APositionIndex: Integer;
  ALayoutDelta: Integer);
var
  APos: TdxPositionInfo;
begin
  APos := APositions[APositionIndex];
  if AdjustRight(ATotalPositions, ATotalPositionIndex, APositions,
    APositionIndex, ALayoutDelta, APos) then
    Exit;
  if AdjustLeft(ATotalPositions, ATotalPositionIndex, APositions,
    APositionIndex, ALayoutDelta, APos) then
    Exit;
  ATotalPositions.Insert(ATotalPositionIndex, APos.Position);
end;

function TdxTableGridMerger.AdjustRight(ATotalPositions: TdxIntegerList;
  ATotalPositionIndex: Integer; const APositions: TArray<TdxPositionInfo>;
  APositionIndex, ALayoutDelta: Integer; APos: TdxPositionInfo): Boolean;
var
...
begin
  ...
  if ((ANextPosition - APos.Position < ALayoutDelta) and
    ((APositionIndex + 1 >= Length(APositions)) or
    (ANextPosition < APositions[APositionIndex + 1].Position))) and
    ((APos.MaxRight >= Length(APositions)) or
    (ANextPosition < APositions[APos.MaxRight].Position)) then
  begin
...
procedure TdxTableGridMerger.MergedGridCore(ATable: TdxTable;
  AStartRowIndex: Integer; AEndRowIndex: Integer;
  const ATablePositions: TArray<Integer>; ATotalPositions: TdxIntegerList);
var
  ARowIndex, AStartIndex, ARowGridBefore, AEndIndex, ACellsCount, ACellIndex,
    ARowGridAfter: Integer;
  ARow: TdxTableRow;
  ACells: TdxTableCellCollection;
  ACell: TdxTableCell;
begin
  ...
  begin
    ...
    begin
      ...
      ARow.GridBefore := CalculateColumnSpan(ATotalPositions,
        ATablePositions[0], ATablePositions[AEndIndex]);
      AStartIndex := AEndIndex;
    end;
    ACells := ARow.Cells;
    ...
    begin
      ...
      ACell.ColumnSpan := CalculateColumnSpan(ATotalPositions,
        ATablePositions[AStartIndex], ATablePositions[AEndIndex]);
      AStartIndex := AEndIndex;
    end;
    ...
    begin
      ...
      ARow.GridAfter := CalculateColumnSpan(ATotalPositions,
        ATablePositions[AStartIndex], ATablePositions[AEndIndex]);
    end;
  end;
end;

function TdxTableGridMerger.CalculateColumnSpan(const ATotalPositions
  : TdxIntegerList; AStartPos: Integer; AEndPos: Integer): Integer;
var
  AStartIndex, AEndIndex: Integer;
begin
  if ATotalPositions.BinarySearch(AEndPos, AEndIndex) and
    ATotalPositions.BinarySearch(AStartPos, AStartIndex) then
...
constructor TdxPieceTableJoinSeveralTablesCommand.Create
  (APieceTable: TdxPieceTable; const ATables: TdxTableArray);
var
...
begin
  ...
  FTables := ATables;
  AFirstTableLastEndParagraphIndex :=
    ATables[0].LastRow.LastCell.EndParagraphIndex;
  FJoinPosition := PieceTable.Paragraphs[AFirstTableLastEndParagraphIndex]
    .EndLogPosition;
end;
...
begin
  ...
  try
    ...
    for ATableIndex := 0 to ACount - 1 do
      ATableGrids[ATableIndex] := GetTableGrid(FTables[ATableIndex],
        AColumnWidth);
...
begin
  ...
  try
    ...
    try
      ...
      try
        ABounds := AColumnsBoundsCalculator.Calculate(ASection,
          APageBoundsCalculator.CalculatePageClientBounds(ASection));
        try
...
function TdxPieceTableJoinSeveralTablesCommand.GetTableGrid(ATable: TdxTable;
  APercentWidthBase: Integer): TdxTableGrid;
var
  AWidthsCalculator: TdxJoinTableWidthsCalculator;
  ACalculator: TdxTableGridCalculator;
begin
  AWidthsCalculator := TdxJoinTableWidthsCalculator.Create
    (DocumentModel.ToDocumentLayoutUnitConverter, APercentWidthBase);
  try
    ACalculator := TdxTableGridCalculator.Create(AWidthsCalculator,
      APercentWidthBase);
    try
...
function TdxPieceTableJoinSeveralTablesCommand.CalculateColumnIndex
  (APosition: Integer; AColumnWidthCollection: TdxIntegerList;
  var ACorrection: Integer): Integer;
var
...
constructor TdxPieceTableJoinTablesCommand.Create(APieceTable: TdxPieceTable;
...
constructor TdxColumnIndexParameters.Create(AColumnIndex: Integer;
  AIsExactly: Boolean);
begin
...
constructor TdxTableCellParameters.Create(AIndexInRow, ARowIndex,
...
constructor TdxNormalizeTableGridHelperBase.Create(ATable: TdxTable;
  ACells: TdxTableCellList; AGridColumns: TdxTableGridColumnCollection;
  AUseDeltaBetweenColumns: Boolean);
begin
  inherited Create;
  Assert(ACells <> nil);
...
function TdxNormalizeTableGridHelperBase.CalculatePatternCellsParameters
  (ACells: TdxTableCellList): TList<TdxTableCellParameters>;
var
  ACell: TdxTableCell;
...
begin
  ...
  begin
    ...
    AEndColumnIndex := ACell.GetEndColumnIndexConsiderRowGrid
      (AStartColumnIndex);
    AParameters := TdxTableCellParameters.Create(ACell.IndexInRow,
      ACell.RowIndex, AStartColumnIndex, AEndColumnIndex);
...
procedure TdxNormalizeTableGridHelperBase.SnapDistanceToColumnGrid
  (AMergedDistances: TdxIntegerList;
  ADistancesToNewCells: TdxList<TdxDistanceCollection>);
begin
end;

function TdxNormalizeTableGridHelperBase.CalculateDistancesToNewCells
  : TdxList<TdxDistanceCollection>;
var
  I, ACellsCount: Integer;
begin
...
var
  ACell: TdxTableCell;
  ACells: TdxTableCellCollection;
  I, AIndexInRow, APatternCellWidth, ADistanceToCell, AStartColumnIndex,
    AEndColumnIndex, AColumnIndex, AGridIntervalsCount, ACurrentWidth: Integer;
begin
...
function TdxNormalizeTableGridHelperBase.GetColumnIndex(AIndex: Integer;
  ACell: TdxTableCell): Integer;
begin
  Result := AIndex;
end;

function TdxNormalizeTableGridHelperBase.CalculateDistance(ADistanceToCell
  : Integer; ACellWidth: Integer): Integer;
begin
  Result := ADistanceToCell + ACellWidth;
end;

function TdxNormalizeTableGridHelperBase.MergeDistances
  (ADistances: TdxList<TdxDistanceCollection>): TdxIntegerList;
var
...
function TdxNormalizeTableGridHelperBase.GetRowContainsPatternCellIndexes
  : TdxIntegerList;
var
  ACount, I: Integer;
begin
...
procedure TdxNormalizeTableGridHelperBase.NormalizeColumnSpansCore
  (ADistances: TdxIntegerList; ATableRow: TdxTableRow);
var
...
begin
  ...
  begin
    ...
    ACell := TdxTableCellVerticalBorderCalculator.GetCellByColumnIndex
      (ATableRow, AColumnIndex);
    if ACell = nil then
      Continue;
...
function TdxNormalizeTableGridHelperBase.GetWidthConsiderUnitType
  (AWidthUnit: TdxWidthUnit): Integer;
begin
  Result := AWidthUnit.Value;
  if AWidthUnit.&Type = TdxWidthUnitType.ModelUnits then
    Result := Table.DocumentModel.ToDocumentLayoutUnitConverter.
      ToLayoutUnits(Result);
end;

procedure TdxNormalizeTableGridHelperBase.RecalculateGridIntervals
  (AMergedDistances: TdxIntegerList);
var
  ACurrentColumn, ANewInterval: TdxTableGridColumn;
  I, J, AGridIntervalsCount, ATotalLength, ACurrentColumnWidth, AColumnWidth,
    APreviousNewColumnWidth, ADistancesCount, ADistance, ADelta,
    APreviousTotalWidth, ADeltaPrevious, ANewWidth: Integer;
begin
  AGridIntervalsCount := GridColumns.Count;
  ATotalLength := 0;
  I := 0;
  ...
  begin
    ...
    begin
      ...
      if (ADelta <= FDeltaBetweenColumnsUpdate) or
        (ADeltaPrevious <= FDeltaBetweenColumnsUpdate) or
        (ADistance > ATotalLength) or (ADistance < APreviousTotalWidth) then
        Continue;

      ANewWidth := ADistance - APreviousTotalWidth - APreviousNewColumnWidth;
      ACurrentColumn.Width := AColumnWidth - ANewWidth -
        APreviousNewColumnWidth;
...
procedure TdxNormalizeTableGridHelperBase.
  NormalizeColumnSpansInRowContainingPatternCell
  (ADistances: TdxList<TdxDistanceCollection>);
var
  ACount, I: Integer;
...
begin
  ...
  for I := 0 to ACount - 1 do
  begin
    AColumnSpans := CalculateColumnSpansForNewCells(ADistances[I],
      PatternCellsParameters[I]);
    try
      NormalizeColumnSpansInRowContainingPatternCellCore(AColumnSpans,
        PatternCellsParameters[I]);
    finally
      AColumnSpans.Free;
    end;
...
procedure TdxNormalizeTableGridHelperBase.
  NormalizeColumnSpansInRowContainingPatternCellCore(AColumnSpans
  : TdxIntegerList; ACellParameters: TdxTableCellParameters);
var
  ACells: TdxTableCellCollection;
...
function TdxNormalizeTableGridHelperBase.CalculateColumnSpansForNewCells
  (ADistances: TdxIntegerList; ACellParameters: TdxTableCellParameters)
  : TdxIntegerList;
var
...
var
  ...
  I, AGridIntervalsCount, ATotalLength, APreviousTotalLength, APreviousDelta,
    AColumnIndex: Integer;
begin
  ...
  begin
    ...
    begin
      if (not AIsExactly and AIsPreviousExactly) and (APreviousTotalLength > 0)
      then
        AColumnIndex := I - 1
      else
        AColumnIndex := I;
      Result.ColumnIndex := AColumnIndex;
      Result.IsExactly := (AIsExactly) or
        ((AIsPreviousExactly and (APreviousTotalLength > 0)));
      Exit;
    end;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        if (AWidthAfter.&Type <> TdxWidthUnitType.&Nil) or
          (AWidthAfter.Value <> 0) then
...
function TdxNormalizeTableGridHelperBase.GetActualWidthValue
  (AWidthUnit: TdxWidthUnit): Integer;
var
  AUnitType: TdxWidthUnitType;
begin
  AUnitType := AWidthUnit.&Type;
  if (AUnitType = TdxWidthUnitType.ModelUnits) or
    (AUnitType = TdxWidthUnitType.FiftiethsOfPercent) then
    Result := AWidthUnit.Value
  else
    Result := 0;
end;

procedure TdxNormalizeTableGridHelperBase.ResetWidthAfter(ARowProperties
...
procedure TdxNormalizeTableGridHelperBase.CheckTableWidthTypeIntegrity
  (ATable: TdxTable);
begin
end;

procedure TdxNormalizeTableGridHelperBase.NormalizeVerticalMerging
  (ACell: TdxTableCell);
var
  AVerticalSpanCells: TdxTableCellList;
  ACurrentCellVerticalMerging: TdxMergingState;
  ACurrentCell, AFirstCellInMergingGroup: TdxTableCell;
  I, ACellsCount, AStartColumnIndex, AVerticalSpanCellsCount,
    ACurrentCellIndexInMergingGroup: Integer;
begin
  ...
  begin
    ...
    AFirstCellInMergingGroup :=
      ACurrentCell.Table.GetFirstCellInVerticalMergingGroup(ACurrentCell);
    AStartColumnIndex := AFirstCellInMergingGroup.
      GetStartColumnIndexConsiderRowGrid;
    AVerticalSpanCells := TdxTableCellVerticalBorderCalculator.
      GetVerticalSpanCells(AFirstCellInMergingGroup, AStartColumnIndex, False);
    try
      ...
      begin
        if AVerticalSpanCellsCount > 2 then
          AVerticalSpanCells[1].Properties.VerticalMerging :=
            TdxMergingState.Restart
        else
        begin
          AVerticalSpanCells[0].Properties.VerticalMerging :=
      ...
      begin
        ACurrentCellIndexInMergingGroup := AVerticalSpanCells.IndexOf
          (ACurrentCell);
        ...
        if AVerticalSpanCellsCount - 2 = ACurrentCellIndexInMergingGroup then
          AVerticalSpanCells[AVerticalSpanCellsCount - 1]
            .Properties.VerticalMerging := TdxMergingState.None
        else if AVerticalSpanCellsCount - 1 <> ACurrentCellIndexInMergingGroup
        then
          AVerticalSpanCells[ACurrentCellIndexInMergingGroup + 1]
            .Properties.VerticalMerging := TdxMergingState.Restart;
      end;
    finally
      AVerticalSpanCells.Free;
    end;
...
constructor TdxNormalizeTableGridAfterSplitCellHelper.Create(ATable: TdxTable;
  ACells: TdxTableCellList; APartsCount: Integer;
...
function TdxNormalizeTableGridAfterSplitCellHelper.
  CalculateDistancesToNewCellsCore(ACellParameters: TdxTableCellParameters)
  : TdxDistanceCollection;
var
  ACells: TdxTableCellCollection;
  I, APatternCellWidth, ADistanceToPatternCell, AStartColumnIndex,
    AEndColumnIndex, ACurrentWidth, APartWidth, ADistanceToCell: Integer;
begin
  Result := TdxDistanceCollection.Create;
  ACells := Table.Rows[ACellParameters.RowIndex].Cells;
...
procedure TdxNormalizeTableGridAfterSplitCellHelper.SnapDistanceToColumnGrid
  (AMergedDistances: TdxIntegerList;
  ADistancesToNewCells: TdxList<TdxDistanceCollection>);
var
  I, AGridColumnsCount, ADistanceCount, AGridColumnIndex, AColumnDistance,
    ANextAllowedDistance, ADistance, AOldDistance: Integer;
...
begin
  ...
  AGridColumnIndex := 0;
  AColumnDistance := 0;
  while (AGridColumnIndex < AGridColumnsCount) and
    (AColumnDistance + GridColumns[AGridColumnIndex].Width <
    AMergedDistances[0]) do
  begin
  ...
  begin
    while (AGridColumnIndex < AGridColumnsCount) and
      (AColumnDistance < ANextAllowedDistance) do
    begin
      Inc(AColumnDistance, GridColumns[AGridColumnIndex].Width);
      Inc(AGridColumnIndex);
    end;
    ...
    if (AGridColumnIndex < AGridColumnsCount) and
      (Abs(ADistance - AColumnDistance) <= DeltaBetweenColumnsUpdate) then
      ADistance := AColumnDistance;
    if AOldDistance <> ADistance then
    begin
      ChangeDistance(ADistancesToNewCells, AOldDistance, ADistance,
        AStartIndices);
...
procedure TdxNormalizeTableGridAfterSplitCellHelper.ChangeDistance
  (ADistancesToNewCells: TdxList<TdxDistanceCollection>; AOldDistance: Integer;
  ANewDistance: Integer; const AStartIndices: TArray<Integer>);
var
...
function TdxNormalizeTableGridAfterInsertCellHelper.GetIndex
  (AIndex: Integer): Integer;
begin
  Result := AIndex + 1;
end;

function TdxNormalizeTableGridAfterInsertCellHelper.
  CalculateColumnSpansForNewCells(ADistances: TdxIntegerList;
...
function TdxNormalizeTableGridAfterDeleteCellHelper.GetColumnIndex
  (AIndex: Integer; ACell: TdxTableCell): Integer;
begin
  Result := AIndex + ACell.ColumnSpan;
end;

function TdxNormalizeTableGridAfterDeleteCellHelper.CalculateDistance
  (ADistanceToCell: Integer; ACellWidth: Integer): Integer;
begin
  Result := ADistanceToCell - ACellWidth;
end;
...
constructor TdxAddParagraphToListHistoryItem.Create
...
begin
  ...
  TdxNumberingListNotifier.NotifyParagraphAdded(DocumentModel,
    NumberingListIndex);
  TdxNumberingListNotifier.NotifyParagraphRemoved(DocumentModel,
    OldOwnNumberingListIndex);
end;
...
class procedure TdxNumberingListNotifier.NotifyParagraphAdded
  (ADocumentModel: TdxDocumentModel; AIndex: TdxNumberingListIndex);
begin
  if AIndex >= NumberingListIndexMinValue then
    ADocumentModel.NumberingLists[AIndex].OnParagraphAdded;
end;

class procedure TdxNumberingListNotifier.NotifyParagraphRemoved
  (ADocumentModel: TdxDocumentModel; AIndex: TdxNumberingListIndex);
begin
  if AIndex >= NumberingListIndexMinValue then
...
procedure TdxPieceTablePasteContentConvertedToDocumentModelCommandBase.
  ApplyChanges;
begin
end;
...
function TdxPieceTablePasteContentConvertedToDocumentModelCommandBase.
  CreatePasteDocumentModelCommand(APos: TdxDocumentLogPosition;
  ASource: TdxDocumentModel; ASuppressFieldsUpdate, APasteFromIE: Boolean)
  : TdxPieceTableInsertContentConvertedToDocumentModelCommand;
begin
  Result := TdxPieceTableInsertContentConvertedToDocumentModelCommand.Create
    (PieceTable, ASource, APos, InsertOptions, False);
  ...
  Result.SuppressCopySectionProperties := SuppressCopySectionProperties
    (ASource);
end;
...
function TdxPieceTablePasteContentConvertedToDocumentModelCommandBase.
  GetAdditionalContentString: string;
begin
  Result := '';
end;

function TdxPieceTablePasteContentConvertedToDocumentModelCommandBase.
  GetDocumentModelSingleFloatingObjectAnchorRun(AModel: TdxDocumentModel)
  : TdxFloatingObjectAnchorRun;
var
  APieceTable: TdxPieceTable;
begin
  APieceTable := AModel.MainPieceTable;
  if (APieceTable.Runs.Count = 2) and
    (APieceTable.Runs[0] is TdxFloatingObjectAnchorRun) then
...
procedure TdxPieceTablePasteContentConvertedToDocumentModelCommandBase.
  OffsetNewlyInsertedFloatingObjectIfNeed(ANewRun: TdxFloatingObjectAnchorRun;
  AParagraph: TdxParagraph);
var
...
procedure TdxPieceTablePasteContentConvertedToDocumentModelCommandBase.
  OffsetNewlyInsertedFloatingObject(ANewRun: TdxFloatingObjectAnchorRun;
  ARun: TdxFloatingObjectAnchorRun);
var
...
begin
  ...
  AProperties.ZOrder := Math.Max(AProperties.ZOrder,
    ARun.FloatingObjectProperties.ZOrder + 1);
end;

procedure TdxPieceTablePasteContentConvertedToDocumentModelCommandBase.
  PasteContent(ASource: TdxDocumentModel; APos: TdxDocumentLogPosition;
...
begin
  ...
  begin
    ...
    begin
      AAnchorRunParagraph := PreprocessSingleFloatingObjectInsertion
        (AAnchorRun);
...
procedure TdxPieceTablePasteContentConvertedToDocumentModelCommandBase.
  PasteDocumentModel(APos: TdxDocumentLogPosition; ASource: TdxDocumentModel;
  APasteFromIE: Boolean; ASuppressFieldsUpdate: Boolean = False);
var
  ACommand: TdxPieceTableInsertContentConvertedToDocumentModelCommand;
begin
  ACommand := CreatePasteDocumentModelCommand(APos, ASource,
    ASuppressFieldsUpdate, APasteFromIE);
  try
    ACommand.Execute;
  finally
    ACommand.Free;
...
function TdxPieceTablePasteContentConvertedToDocumentModelCommandBase.
  PreprocessSingleFloatingObjectInsertion(ARun: TdxFloatingObjectAnchorRun)
  : TdxParagraph;
var
...
procedure TdxPieceTablePasteContentConvertedToDocumentModelCommandBase.
  SetSuppressStoreImageSize(ADocumentModel: TdxDocumentModel;
  const ASizeCollection: string);
var
  ARuns: TdxTextRunCollection;
  ASizeIndex: Integer;
...
function TdxPieceTablePasteContentConvertedToDocumentModelCommandBase.
  ShouldOffsetNewRun(ANewRun, ARun: TdxFloatingObjectAnchorRun): Boolean;
var
...
begin
  ...
  Result := PointsEqual(ANewFloatingObjectProperties.Offset,
    AFloatingObjectProperties.Offset) and
    (ANewFloatingObjectProperties.HorizontalPositionType =
    AFloatingObjectProperties.HorizontalPositionType) and
    (ANewFloatingObjectProperties.VerticalPositionType =
    AFloatingObjectProperties.VerticalPositionType);
end;

function TdxPieceTablePasteContentConvertedToDocumentModelCommandBase.
  SuppressCopySectionProperties(ASource: TdxDocumentModel): Boolean;
var
  AParagraphs: TdxParagraphCollection;
  ALastParagraph: TdxParagraph;
...
begin
  ...
  AShouldPreserveTableProperties := (AParagraphs.Count > 1) and
    (AParagraphs[AParagraphs.Count - 2].GetCell <> nil);
  Result := not ALastParagraph.IsEmpty or AShouldPreserveTableProperties or
    DocumentModel.CopyPasteOptions.MaintainDocumentSectionSettings;
end;
...
begin
  Result := PasteSource.GetDataAsText
    (TdxOfficeDataFormats.SuppressStoreImageSize);
end;
...
procedure TdxPieceTablePasteRtfTextCommand.
  PopulateDocumentModelFromContentStringCore(ADocumentModel: TdxDocumentModel;
  AContent: TdxClipboardStringContent; const ASizeCollection: string);
var
...
begin
  ...
  try
    ...
    AOptions.CopySingleCellAsText :=
      DocumentModel.BehaviorOptions.PasteSingleCellAsText;
    AOptions.LineBreakSubstitute :=
      DocumentModel.BehaviorOptions.PasteLineBreakSubstitution;
    AOptions.PasteFromIE := GetIsPasteFromIe;
    PasteFromIE := AOptions.PasteFromIE;
    AImporter := TdxImportFileFormats.GetImporter(TdxRichEditDocumentFormat.Rtf,
      ADocumentModel, AOptions);
    try
      AStream := PrepareInputStream(AContent.StringContent);
      try
        AImporter.UpdateFields :=
          ADocumentModel.FieldOptions.UpdateFieldsOnPaste;
...
function TdxPieceTablePasteTextContentConvertedToDocumentModelCommandBase.
  CreateDocumentModelFromContentString(AContent: TdxClipboardStringContent;
...
begin
  ...
  begin
    ...
    begin
      Result.DocumentCapabilities.HeadersFooters :=
        TdxDocumentCapability.Disabled;
      Result.DocumentCapabilities.Sections := TdxDocumentCapability.Disabled;
    end;
    PopulateDocumentModelFromContentStringCore(Result, AContent,
      ASizeCollection);
  end;
end;

function TdxPieceTablePasteTextContentConvertedToDocumentModelCommandBase.
  CreateSourceDocumentModel(const ASizeCollection: string): TdxDocumentModel;
var
...
procedure TdxPieceTablePasteTextContentConvertedToDocumentModelCommandBase.
  PasteContent(AContent: TdxClipboardStringContent;
  APos: TdxDocumentLogPosition; const ASizeCollection: string);
var
  ASource: TdxDocumentModel;
begin
