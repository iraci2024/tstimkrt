...
type
  ...
  IdxVisibleTextFilter = interface
    ...
    function FindVisibleParagraphRunForward(ARunIndex: TdxRunIndex)
      : TdxRunIndex;
    function GetNextVisibleLogPosition(const APosition
      : TdxDocumentModelPosition; ASkipFieldBoundaryRanges: Boolean)
      : TdxDocumentLogPosition; overload;
    function GetNextVisibleLogPosition(const APosition
      : TdxDocumentModelPosition; ASkipFieldBoundaryRanges,
      AInsureNextLogPositionVisible: Boolean): TdxDocumentLogPosition; overload;
    function GetPrevVisibleLogPosition(const APosition
      : TdxDocumentModelPosition; ASkipFieldBoundaryRanges: Boolean)
      : TdxDocumentLogPosition; overload;
    function GetVisibleLogPosition(const APosition: TdxDocumentModelPosition;
      ASkipFieldBoundaryRanges: Boolean): TdxDocumentLogPosition; overload;
    function GetNextVisibleLogPosition(ALogPosition: TdxDocumentLogPosition;
      ASkipFieldResultEnd: Boolean): TdxDocumentLogPosition; overload;
    function GetNextVisibleLogPosition(ALogPosition: TdxDocumentLogPosition;
      ASkipFieldResultEnd, AInsureNextLogPositionVisible: Boolean)
      : TdxDocumentLogPosition; overload;
    function GetPrevVisibleLogPosition(ALogPosition: TdxDocumentLogPosition;
      ASkipFieldBoundaryRanges: Boolean): TdxDocumentLogPosition; overload;
    function GetVisibleLogPosition(const APosition: TdxDocumentModelPosition)
      : TdxDocumentLogPosition; overload;
  end;
  ...
  public
    ...
    function IsRunVisibleCore(const ARunIndex: TdxRunIndex)
      : TdxRunVisibility; virtual;
    function HasVisibleRunInParagraph(ALastParagraphRun: TdxRunIndex): Boolean;
    function IsFieldRunVisibleCore(ARunIndex: TdxRunIndex;
      AField: TdxField): Boolean;
    function IsFieldRunVisible(ARunIndex: TdxRunIndex; AField: TdxField)
      : TdxRunVisibility; virtual;
    function FindVisibleParagraphRunForward(ARunIndex: TdxRunIndex)
      : TdxRunIndex; virtual;
    function GetNextVisibleRunIndex(ARunIndex: TdxRunIndex)
      : TdxRunIndex; virtual;
    function GetPrevVisibleRunIndex(ARunIndex: TdxRunIndex)
      : TdxRunIndex; virtual;
    function GetRunVisibilityInField(ARunIndex: TdxRunIndex): TdxRunVisibility;
    function FindVisibleRunForward(ARunIndex: TdxRunIndex)
      : TdxRunIndex; virtual;
    function GetNextVisibleLogPosition(const APosition
      : TdxDocumentModelPosition; ASkipFieldBoundaryRanges: Boolean)
      : TdxDocumentLogPosition; overload;
    function GetNextVisibleLogPosition(const APosition
      : TdxDocumentModelPosition; ASkipFieldBoundaryRanges,
      AInsureNextLogPositionVisible: Boolean): TdxDocumentLogPosition; overload;
    function IsPositionOnInvisibleCellParagraph(const APosition
      : TdxDocumentModelPosition): Boolean;
    function IsPositionAfterFieldCodeEndRun(const APosition
      : TdxDocumentModelPosition): Boolean; virtual;
    function IsPositionBeforeInvisibleFieldCodeEndRun(const APosition
      : TdxDocumentModelPosition): Boolean; virtual;
    function IsPositionVisible(AFieldCodeStartRunIndex: TdxRunIndex)
      : Boolean; virtual;
    function IsPositionBeforeInvisibleFieldCodeStartRun(const APosition
      : TdxDocumentModelPosition): Boolean; virtual;
    function IsPositionBeforeFieldResultEndRun(const APosition
      : TdxDocumentModelPosition): Boolean; virtual;
    function GetNextVisibleLogPositionCore(const APosition
      : TdxDocumentModelPosition; ABreakAfterFieldResultEndRun: Boolean;
    ...
    function GetVisibleLogPosition(const APosition: TdxDocumentModelPosition;
      ...
      overload; virtual;
    function GetPrevVisiblePositionCore(const APosition
      : TdxDocumentModelPosition; ABreakOnFieldCodeStart: Boolean;
      out AVisibleCharSkipped: Boolean): TdxDocumentModelPosition;
    function GetVisibleLogPosition(const APosition: TdxDocumentModelPosition)
      : TdxDocumentLogPosition; overload; virtual;
    function GetNextVisibleLogPosition(ALogPosition: TdxDocumentLogPosition;
      ASkipFieldResultEnd: Boolean): TdxDocumentLogPosition; overload; virtual;
    function GetNextVisibleLogPosition(ALogPosition: TdxDocumentLogPosition;
      ASkipFieldResultEnd, AInsureNextLogPositionVisible: Boolean)
      : TdxDocumentLogPosition; overload;
    function GetPrevVisibleLogPosition(ALogPosition: TdxDocumentLogPosition;
      ASkipFieldBoundaryRanges: Boolean): TdxDocumentLogPosition;
      overload; virtual;
    function GetModelPosition(ALogPosition: TdxDocumentLogPosition)
...
function TdxVisibleTextFilterBase.FindVisibleParagraphRunForward
...
begin
  ...
  while (ARunIndex < AMaxRunIndex) and
    not(IsRunVisible(ARunIndex) and (ARuns[ARunIndex] is TdxParagraphRun)) do
    Inc(ARunIndex);
  Result := ARunIndex;
end;

function TdxVisibleTextFilterBase.FindVisibleRunForward(ARunIndex: TdxRunIndex)
  : TdxRunIndex;
var
  AMaxRunIndex: TdxRunIndex;
begin
...
function TdxVisibleTextFilterBase.GetNextVisibleLogPosition(const APosition
  : TdxDocumentModelPosition; ASkipFieldBoundaryRanges: Boolean)
  : TdxDocumentLogPosition;
begin
  Result := GetNextVisibleLogPosition(APosition,
    ASkipFieldBoundaryRanges, False);
end;

function TdxVisibleTextFilterBase.GetNextVisibleLogPosition(const APosition
  : TdxDocumentModelPosition; ASkipFieldBoundaryRanges,
  AInsureNextLogPositionVisible: Boolean): TdxDocumentLogPosition;
var
...
begin
  ...
  ACharSkipped := False;
  repeat
    APos := GetNextVisibleLogPositionCore(APos, ASkipFieldBoundaryRanges,
      AVisibleCharSkipped);
    ACharSkipped := ACharSkipped or AVisibleCharSkipped;
  until not(((ASkipFieldBoundaryRanges and
    (IsPositionBeforeFieldResultEndRun(APos) or not ACharSkipped or
    IsPositionAfterFieldCodeEndRun(APos))) or
...
function TdxVisibleTextFilterBase.GetModelPosition(ALogPosition
...
begin
  ...
  Result.RunStartLogPosition := PieceTable.FindRunStartLogPosition
    (PieceTable.Paragraphs[Result.ParagraphIndex], ALogPosition, ARunIndex);
  Result.RunIndex := ARunIndex;
  Result.LogPosition := ALogPosition;
end;

function TdxVisibleTextFilterBase.GetNextVisibleLogPosition
  (ALogPosition: TdxDocumentLogPosition; ASkipFieldResultEnd: Boolean)
  : TdxDocumentLogPosition;
begin
...
begin
  ...
  Result := GetNextVisibleLogPosition(AModelPosition, ASkipFieldResultEnd,
    AInsureNextLogPositionVisible);
end;

function TdxVisibleTextFilterBase.GetNextVisibleLogPositionCore(const APosition
  : TdxDocumentModelPosition; ABreakAfterFieldResultEndRun: Boolean;
  out AVisibleCharSkipped: Boolean): TdxDocumentModelPosition;
var
  ARuns: TdxRunCollection;
...
begin
  ...
  begin
    ...
    begin
      ...
      if (APosition.LogPosition > APosition.RunEndLogPosition) and
        (ARuns.Count - 1 <> ARunIndex) then
      begin
  ...
  begin
    ...
    if ABreakAfterFieldResultEndRun and
      (ARuns[ARunIndex] is TdxFieldResultEndRun) then
      Break;
  end;
...
function TdxVisibleTextFilterBase.GetNextVisibleRunIndex(ARunIndex: TdxRunIndex)
  : TdxRunIndex;
var
...
function TdxVisibleTextFilterBase.GetPrevVisibleLogPosition(const APosition
  : TdxDocumentModelPosition; ASkipFieldBoundaryRanges: Boolean)
  : TdxDocumentLogPosition;
var
  APos: TdxDocumentModelPosition;
...
begin
  ...
  ACharSkipped := False;
  repeat
    APos := GetPrevVisiblePositionCore(APos, ASkipFieldBoundaryRanges,
      AVisibleCharSkipped);
    ACharSkipped := ACharSkipped or AVisibleCharSkipped;
  ...
  until not((ASkipFieldBoundaryRanges and
    (IsPositionBeforeFieldResultEndRun(APos) or not ACharSkipped or
    IsPositionAfterFieldCodeEndRun(APos) or
    IsPositionBeforeInvisibleFieldCodeEndRun(APos))) or
    IsPositionOnInvisibleCellParagraph(APos));
  Result := APos.LogPosition;
end;

function TdxVisibleTextFilterBase.GetPrevVisibleLogPosition
  (ALogPosition: TdxDocumentLogPosition; ASkipFieldBoundaryRanges: Boolean)
  : TdxDocumentLogPosition;
var
  AModelPosition: TdxDocumentModelPosition;
begin
...
function TdxVisibleTextFilterBase.GetPrevVisiblePositionCore(const APosition
  : TdxDocumentModelPosition; ABreakOnFieldCodeStart: Boolean;
  out AVisibleCharSkipped: Boolean): TdxDocumentModelPosition;
var
...
begin
  ...
  begin
    ...
    if IsRunVisible(ARunIndex) then
      Break;
    APos := APos - ARuns[ARunIndex].Length;
    if ABreakOnFieldCodeStart and (ARuns[ARunIndex] is TdxFieldCodeStartRun)
    then
      Break;
  end;
  APosition.LogPosition := APos;
...
function TdxVisibleTextFilterBase.GetPrevVisibleRunIndex(ARunIndex: TdxRunIndex)
  : TdxRunIndex;
begin
  Result := ARunIndex;
  while Result > 0 do
...
function TdxVisibleTextFilterBase.GetVisibleLogPosition(const APosition
...
begin
  APos := APosition;
  while (ASkipFieldBoundaryRanges and (IsPositionBeforeFieldResultEndRun(APos)
    or IsPositionAfterFieldCodeEndRun(APos) or
...
function TdxVisibleTextFilterBase.HasVisibleRunInParagraph(ALastParagraphRun
  : TdxRunIndex): Boolean;
var
  ARunIndex: TdxRunIndex;
begin
...
function TdxVisibleTextFilterBase.IsFieldRunVisible(ARunIndex: TdxRunIndex;
  AField: TdxField): TdxRunVisibility;
begin
...
function TdxVisibleTextFilterBase.IsFieldRunVisibleCore(ARunIndex: TdxRunIndex;
  AField: TdxField): Boolean;
begin
...
function TdxVisibleTextFilterBase.IsPositionAfterFieldCodeEndRun(const APosition
  : TdxDocumentModelPosition): Boolean;
var
  ARunIndex: TdxRunIndex;
  ARuns: TdxRunCollection;
begin
  ...
  ARunIndex := APosition.RunIndex;
  ARuns := PieceTable.Runs;
  if (ARuns[ARunIndex] is TdxFieldCodeEndRun) and
    (APosition.RunOffset = ARuns[ARunIndex].Length) then
    Result := True
  else if (ARunIndex > 0) and
    (APosition.RunStartLogPosition = APosition.LogPosition) and
    (ARuns[ARunIndex - 1] is TdxFieldCodeEndRun) then
    Result := True;
end;

function TdxVisibleTextFilterBase.IsPositionBeforeFieldResultEndRun
...
begin
  ...
  if (APosition.LogPosition = APosition.RunStartLogPosition) and
    ...
    Result := True
  else if (APosition.RunIndex + 1 < ARuns.Count) and
...
function TdxVisibleTextFilterBase.IsPositionOnInvisibleCellParagraph
  (const APosition: TdxDocumentModelPosition): Boolean;
var
  ARunOffset: Integer;
  ARunLength: Integer;
...
function TdxVisibleTextFilterBase.IsPositionVisible(AFieldCodeStartRunIndex
  : TdxRunIndex): Boolean;
var
  AField, AParent: TdxField;
begin
  AField := TdxSimplePieceTable(PieceTable).FindFieldByRunIndex
    (AFieldCodeStartRunIndex);
...
function TdxVisibleTextFilterBase.IsRunVisible(const ARunIndex
  : TdxRunIndex): Boolean;
begin
  Result := IsRunVisibleCore(ARunIndex) <> TdxRunVisibility.Hidden;
end;

function TdxVisibleTextFilterBase.IsRunVisibleCore(const ARunIndex: TdxRunIndex)
  : TdxRunVisibility;
var
  ARun: TdxTextRunBase;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if HasVisibleRunInParagraph(Min(ARunIndex, AParagraph.LastRunIndex))
        then
          Exit(TdxRunVisibility.ForceVisible)
        else
