...
type
  ...
  TdxPieceTableInsertObjectAtLogPositionCommand = class abstract
    (TdxPieceTableInsertObjectCommand)
  private
...
begin
  ...
  PieceTable.ApplyChanges(ChangeType, AFirstParagraph.FirstRunIndex,
...
function TdxPieceTableInsertObjectAtLogPositionCommand.
  CalculateInsertionParagraphIndex: TdxParagraphIndex;
begin
  Result := PieceTable.FindParagraphIndex(LogPosition);
end;

constructor TdxPieceTableInsertObjectAtLogPositionCommand.Create
