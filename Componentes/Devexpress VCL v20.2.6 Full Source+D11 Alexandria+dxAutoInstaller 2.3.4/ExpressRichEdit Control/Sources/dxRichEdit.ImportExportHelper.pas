...
type
  ...
  protected
    function CreateFilterString(AFilters
      : TdxFileDialogFilterCollection): string;
  public
...
constructor TdxImportExportHelper.Create(const ADocumentModel
...
function TdxImportExportHelper.CreateFilterString
  (AFilters: TdxFileDialogFilterCollection): string;
begin
