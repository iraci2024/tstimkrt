...
type
  ...
  protected
    ...
    function CalculateMainPieceTableStartRunIndex(ARunIndex: TdxRunIndex)
      : TdxRunIndex;
    function CalculateMainPieceTableEndRunIndex(ARunIndex: TdxRunIndex)
      : TdxRunIndex;
  ...
  public
    ...
    procedure ApplyChanges(AChangeType: TdxDocumentModelChangeType;
      AStartRunIndex: TdxRunIndex; AEndRunIndex: TdxRunIndex); override;
    ...
    property RequestSectionIndex: TdxRequestSectionIndexEventHandler
      read FOnRequestSectionIndex;
  end;

  { TdxHeaderFooterCollectionBase }

  TdxHeaderFooterCollectionBase<T: TdxContentTypeBase; U> = class abstract
    (TdxObjectList<T>)
  public
  ...
  public
    ...
    function CanLinkToPrevious(AType: TdxHeaderFooterType): Boolean;
      virtual; abstract;
    function IsLinkedToPrevious(AType: TdxHeaderFooterType): Boolean;
      virtual; abstract;
    function IsLinkedToNext(AType: TdxHeaderFooterType): Boolean;
      virtual; abstract;
    ...
    function ShouldRelinkNextSection(AType: TdxHeaderFooterType): Boolean;
      virtual; abstract;
    function ShouldRelinkPreviousSection(AType: TdxHeaderFooterType): Boolean;
      virtual; abstract;
    ...
    function GetObjectCore(AType: TdxHeaderFooterType)
      : TdxSectionHeaderFooterBase; virtual; abstract;
    function CalculateActualObjectCore(AFirstPageOfSection: Boolean;
      AIsEvenPage: Boolean): TdxSectionHeaderFooterBase;
    function CalculateActualObjectType(AFirstPageOfSection: Boolean;
      AIsEvenPage: Boolean): TdxHeaderFooterType;
  end;

  { TdxSectionHeaderFooterIndexChangedHistoryItem }

  TdxSectionHeaderFooterIndexChangedHistoryItem<T> = class abstract
    (TdxHistoryItem)
  strict private
    ...
    FPreviousIndex: T;
    FNextIndex: T;
    class function GetMainPieceTable(ASection: TdxSection)
  ...
  protected
    ...
    procedure SetCurrentHeaderFooterIndex(ASection: TdxSection; AIndex: T);
      virtual; abstract;
  public
  ...
  TdxSectionPageHeaderIndexChangedHistoryItem = class
    (TdxSectionHeaderFooterIndexChangedHistoryItem<TdxHeaderIndex>)
  protected
    procedure SetCurrentHeaderFooterIndex(ASection: TdxSection;
      AIndex: TdxHeaderIndex); override;
  end;

  { TdxSectionHeadersFooters }

  TdxSectionHeadersFooters<TObj: TdxSectionHeaderFooterBase> = class abstract
    (TdxSectionHeadersFootersBase)
  public type
    TdxLinkObjectDelegate = reference to procedure(ATargetObject
      : TdxSectionHeadersFooters<TObj>; AType: TdxHeaderFooterType;
      ASectionObjectIndex: TdxSectionIndex);
  strict private
    FIndices: array [0 .. 2] of TdxSectionIndex;
  protected
    function GetInvalidIndex: TdxSectionIndex; virtual; abstract;
    function GetObjectCache
      : TdxHeaderFooterCollectionBase<TObj, TdxSectionIndex>; virtual; abstract;
    function CreateEmptyObjectCore(AType: TdxHeaderFooterType): TObj;
      virtual; abstract;
    function CreateIndex(AValue: Integer): TdxSectionIndex; virtual; abstract;
    function CreateHistoryItem
      : TdxSectionHeaderFooterIndexChangedHistoryItem<TdxSectionIndex>;
      virtual; abstract;
    function GetObjectProvider(ASection: TdxSection)
      : TdxSectionHeadersFooters<TObj>; virtual; abstract;
    ...
    procedure OnRequestSectionIndex(ASender: TObject;
      AArgs: TdxRequestSectionIndexEventArgs);
    function GetValidUniqueObjectIndices: TdxIntegerList;
    procedure PerformLinkToPrevious(AType: TdxHeaderFooterType; ALink: Boolean;
      const ALinkAction: TdxLinkObjectDelegate);
    procedure PerformLinkToNext(AType: TdxHeaderFooterType; ALink: Boolean;
      const ALinkAction: TdxLinkObjectDelegate);
    class procedure LinkCore(ATargetObject: TdxSectionHeadersFooters<TObj>;
      AType: TdxHeaderFooterType; ASectionObjectIndex: TdxSectionIndex); static;
    class procedure UnlinkCore(ATargetObject: TdxSectionHeadersFooters<TObj>;
      AType: TdxHeaderFooterType; ASectionObjectIndex: TdxSectionIndex);
      overload; static;
    procedure UnlinkCore(AType: TdxHeaderFooterType;
      ASectionObjectIndex: TdxSectionIndex); overload;
    function GetObjectIndex(AType: TdxHeaderFooterType): TdxSectionIndex;
    procedure SetObjectIndex(AType: TdxHeaderFooterType;
    ...
    procedure CopyObjectContent(ASourceHeaderFooter: TObj;
      ATargetHeaderFooter: TObj);
    procedure ChangeObjectIndex(AType: TdxHeaderFooterType;
      ANewIndex: TdxSectionIndex);

    property InvalidIndex: TdxSectionIndex read GetInvalidIndex;
    property ObjectCache: TdxHeaderFooterCollectionBase<TObj, TdxSectionIndex>
      read GetObjectCache;
  public
    constructor Create(ASection: TdxSection); overload;
    ...
    function CalculateActualObject(AFirstPageOfSection: Boolean;
      AIsEvenPage: Boolean): TObj;
    function ShouldRelinkNextSection(AType: TdxHeaderFooterType)
      : Boolean; override;
    function ShouldRelinkPreviousSection(AType: TdxHeaderFooterType)
      : Boolean; override;
  ...
  TdxHeaderCollection = class(TdxHeaderFooterCollectionBase<TdxSectionHeader,
    TdxHeaderIndex>);
  ...
  protected
    ...
    function GetObjectCache: TdxHeaderFooterCollectionBase<TdxSectionHeader,
      TdxHeaderIndex>; override;
    function CreateEmptyObjectCore(AType: TdxHeaderFooterType)
      : TdxSectionHeader; override;
    function CreateIndex(AValue: Integer): TdxHeaderIndex; override;
    function CreateHistoryItem
      : TdxSectionHeaderFooterIndexChangedHistoryItem<TdxHeaderIndex>; override;
    function GetObjectProvider(ASection: TdxSection)
      : TdxSectionHeadersFooters<TdxSectionHeader>; override;
  end;
  ...
  TdxFooterCollection = class(TdxHeaderFooterCollectionBase<TdxSectionFooter,
    TdxFooterIndex>);

  { TdxSectionPageFooterIndexChangedHistoryItem }

  TdxSectionPageFooterIndexChangedHistoryItem = class
    (TdxSectionHeaderFooterIndexChangedHistoryItem<TdxFooterIndex>)
  protected
    procedure SetCurrentHeaderFooterIndex(ASection: TdxSection;
      AIndex: TdxFooterIndex); override;
  end;
  ...
  protected
    ...
    function GetObjectCache: TdxHeaderFooterCollectionBase<TdxSectionFooter,
      TdxFooterIndex>; override;
    function CreateEmptyObjectCore(AType: TdxHeaderFooterType)
      : TdxSectionFooter; override;
    function CreateIndex(AValue: Integer): TdxFooterIndex; override;
    function CreateHistoryItem
      : TdxSectionHeaderFooterIndexChangedHistoryItem<TdxFooterIndex>; override;
    function GetObjectProvider(ASection: TdxSection)
      : TdxSectionHeadersFooters<TdxSectionFooter>; override;
  end;
  ...
  protected
    class function GetMainPieceTable(ADocumentModel: TdxCustomDocumentModel)
      : TdxCustomPieceTable; { TdxPieceTable; } static;
    ...
    function GetPreviousSectionHeader(AHeader: TdxSectionFooter)
      : TdxSectionHeader;
    function GetPreviousSectionFooter(AFooter: TdxSectionFooter)
      : TdxSectionFooter;
  public
    ...
    function GetCorrespondingHeader(AFooter: TdxSectionFooter)
      : TdxSectionHeader;
    function GetCorrespondingFooter(AHeader: TdxSectionHeader)
      : TdxSectionFooter;
    procedure Reset;
    ...
    property HasNonEmptyHeadersOrFooters: Boolean
      read GetHasNonEmptyHeadersOrFooters;
    ...
    property InnerFirstPageHeader: TdxSectionHeader
      read GetInnerFirstPageHeader;
    property InnerFirstPageHeaderIndex: TdxHeaderIndex
      read GetInnerFirstPageHeaderIndex write SetInnerFirstPageHeaderIndex;
    ...
    property InnerOddPageHeaderIndex: TdxHeaderIndex
      read GetInnerOddPageHeaderIndex write SetInnerOddPageHeaderIndex;
    ...
    property InnerEvenPageHeaderIndex: TdxHeaderIndex
      read GetInnerEvenPageHeaderIndex write SetInnerEvenPageHeaderIndex;
    property FirstPageFooter: TdxSectionFooter read GetFirstPageFooter;
    property InnerFirstPageFooter: TdxSectionFooter
      read GetInnerFirstPageFooter;
    property InnerFirstPageFooterIndex: TdxFooterIndex
      read GetInnerFirstPageFooterIndex write SetInnerFirstPageFooterIndex;
    ...
    property InnerOddPageFooterIndex: TdxFooterIndex
      read GetInnerOddPageFooterIndex write SetInnerOddPageFooterIndex;
    ...
    property InnerEvenPageFooterIndex: TdxFooterIndex
      read GetInnerEvenPageFooterIndex write SetInnerEvenPageFooterIndex;
  ...
  public
    ...
    property Items[Index: Integer]: TdxSection read GetItem
  ...
  TdxSectionEvent = procedure(Sender: TObject; E: TdxSectionEventArgs)
    of object;
  ...
  public
    ...
    property Section: TdxSection read FSection;
    property ColumnInfoCollection: TdxColumnInfoCollection
      read FColumnInfoCollection;
...
procedure TdxSection.OnObtainAffectedRange(ASender: TObject;
  E: TdxObtainAffectedRangeEventArgs);
var
...
procedure TdxSection.AddPieceTables(AResult: TdxFastList { <TdxPieceTable> };
  AIncludeUnreferenced: Boolean);
begin
  if InnerFirstPageHeader <> nil then
    InnerFirstPageHeader.PieceTable.AddPieceTables(AResult,
      AIncludeUnreferenced);
  ...
  if InnerEvenPageHeader <> nil then
    InnerEvenPageHeader.PieceTable.AddPieceTables(AResult,
      AIncludeUnreferenced);

  if InnerFirstPageFooter <> nil then
    InnerFirstPageFooter.PieceTable.AddPieceTables(AResult,
      AIncludeUnreferenced);
  ...
  if InnerEvenPageFooter <> nil then
    InnerEvenPageFooter.PieceTable.AddPieceTables(AResult,
      AIncludeUnreferenced);
end;
...
class function TdxSection.GetMainPieceTable(ADocumentModel
  : TdxCustomDocumentModel): TdxCustomPieceTable;
begin
...
begin
  ...
  ASectionIndex := ATargetModel.MainPieceTable.
    LookupSectionIndexByParagraphIndex(ATargetPosition.ParagraphIndex);
  AResultSection := ATargetModel.Sections[ASectionIndex];
  AResultSection.CopyFromCore(Self);
  ALastParagraph := ATargetModel.MainPieceTable.Paragraphs
    [AResultSection.LastParagraphIndex];
  TdxDocumentModel(DocumentModel).MainPieceTable.Paragraphs[LastParagraphIndex]
    .CopyFrom(ATargetModel, ALastParagraph);
...
begin
  if TdxDocumentModel(DocumentModel).DocumentProperties.DifferentOddAndEvenPages
  then
...
begin
  ...
  FootNote.CopyFrom(ACache.FootNoteInfoCache
    [TdxFootNoteInfoCache.DefaultFootNoteItemIndex]);
  EndNote.CopyFrom(ACache.FootNoteInfoCache
...
function TdxSection.GetCorrespondingHeader(AFooter: TdxSectionFooter)
  : TdxSectionHeader;
begin
  Result := Headers.GetObject(AFooter.&Type);
end;

function TdxSection.GetCorrespondingFooter(AHeader: TdxSectionHeader)
  : TdxSectionFooter;
begin
  Result := Footers.GetObject(AHeader.&Type);
end;

function TdxSection.GetPreviousSectionHeader(AHeader: TdxSectionFooter)
  : TdxSectionHeader;
var
...
function TdxSection.GetPreviousSectionFooter(AFooter: TdxSectionFooter)
  : TdxSectionFooter;
var
  APreviousSection: TdxSection;
begin
...
constructor TdxSectionProperties.Create(ASectionProperties
  : TdxSectionProperties);
begin
  inherited Create;
...
constructor TdxSectionHeaderFooterBase.Create(ADocumentModel
  : TdxCustomDocumentModel; AType: TdxHeaderFooterType);
begin
  inherited Create(ADocumentModel);
  FType := AType;
end;
...
var
  AIndex: TdxSectionIndex;
begin
  if DocumentModel.IsUpdateLocked and TdxDocumentModel(DocumentModel)
    .DeferredChanges.IsSetContentMode then
    Exit(0);
...
function TdxSectionHeaderFooterBase.CalculateMainPieceTableStartRunIndex
...
begin
  ...
  Result := APieceTable.Paragraphs[AActualSection.FirstParagraphIndex]
    .FirstRunIndex;
end;

function TdxSectionHeaderFooterBase.CalculateMainPieceTableEndRunIndex
  (ARunIndex: TdxRunIndex): TdxRunIndex;
var
...
begin
  ...
  APieceTable := TdxDocumentModel(DocumentModel).MainPieceTable;
  Result := APieceTable.Paragraphs[AActualSection.LastParagraphIndex]
    .LastRunIndex;
end;
...
function TdxSectionHeaderFooterBase.LookupSectionIndexByParagraphIndex
  (AParagraphIndex: TdxParagraphIndex): TdxSectionIndex;
begin
  Result := inherited LookupSectionIndexByParagraphIndex
    (GetSection.FirstParagraphIndex);
end;

procedure TdxSectionHeaderFooterBase.ApplyChanges
  (AChangeType: TdxDocumentModelChangeType; AStartRunIndex: TdxRunIndex;
  AEndRunIndex: TdxRunIndex);
begin
  inherited ApplyChanges(AChangeType, CalculateMainPieceTableStartRunIndex
    (AStartRunIndex), CalculateMainPieceTableEndRunIndex(AEndRunIndex));
end;

procedure TdxSectionHeaderFooterBase.ApplyChangesCore
...
begin
  ...
  begin
    inherited ApplyChangesCore([TdxDocumentModelChangeAction.SplitRunByCharset],
      AStartRunIndex, AEndRunIndex);
    Exclude(AActions, TdxDocumentModelChangeAction.SplitRunByCharset);
  end;
  inherited ApplyChangesCore(AActions,
    CalculateMainPieceTableStartRunIndex(AStartRunIndex),
    CalculateMainPieceTableEndRunIndex(AEndRunIndex));
end;

procedure TdxSectionHeaderFooterBase.ApplySectionFormatting(ALogPositionStart
  : TdxDocumentLogPosition; ALength: Integer;
  AModifier: TdxSectionPropertyModifierBase);
begin
  DocumentModel.ApplySectionFormatting(TdxDocumentModel(DocumentModel)
    .MainPieceTable.Paragraphs[GetSection.FirstParagraphIndex].LogPosition, 1,
    AModifier);
end;

procedure TdxSectionHeaderFooterBase.FixLastParagraphOfLastSection
...
function TdxSectionHeadersFootersBase.CalculateActualObjectCore
  (AFirstPageOfSection: Boolean; AIsEvenPage: Boolean)
  : TdxSectionHeaderFooterBase;
begin
...
function TdxSectionHeadersFootersBase.CalculateActualObjectType
  (AFirstPageOfSection: Boolean; AIsEvenPage: Boolean): TdxHeaderFooterType;
var
...
constructor TdxSectionHeaderFooterIndexChangedHistoryItem<T>.Create
  (ASection: TdxSection);
begin
...
class function TdxSectionHeaderFooterIndexChangedHistoryItem<T>.
  GetMainPieceTable(ASection: TdxSection): TdxCustomPieceTable;
begin
  Assert(ASection <> nil);
...
procedure TdxSectionHeaderFooterIndexChangedHistoryItem<T>.ReplaceHeaderFooter
  (AIndex: T);
var
  ASection: TdxSection;
begin
...
procedure TdxSectionHeaderFooterIndexChangedHistoryItem<T>.ApplyChanges
  (ASection: TdxSection);
var
  ...
  try
    ...
    if AArgs.Start >= 0 then
      TdxPieceTable(PieceTable).ApplyChangesCore
        (TdxSectionMarginsChangeActionsCalculator.CalculateChangeActions
        (TdxSectionMarginsChangeType.Top), AArgs.Start, AArgs.&End);
  finally
    AArgs.Free;
  end;
end;
...
procedure TdxSectionPageHeaderIndexChangedHistoryItem.
  SetCurrentHeaderFooterIndex(ASection: TdxSection; AIndex: TdxHeaderIndex);
begin
...
procedure TdxSectionHeadersFooters<TObj>.CopyFrom
...
function TdxSectionHeadersFooters<TObj>.CanLinkToPrevious
  (AType: TdxHeaderFooterType): Boolean;
begin
  Result := Section.GetPreviousSection <> nil;
end;

function TdxSectionHeadersFooters<TObj>.IsLinkedToPrevious
  (AType: TdxHeaderFooterType): Boolean;
var
  APreviousSection: TdxSection;
begin
  ...
  if APreviousSection = nil then
    Exit(False);
  Result := GetObjectProvider(APreviousSection).GetObjectIndex(AType)
    = GetObjectIndex(AType);
end;

function TdxSectionHeadersFooters<TObj>.IsLinkedToNext
  (AType: TdxHeaderFooterType): Boolean;
var
...
begin
  ...
  if ANextSection = nil then
    Exit(False);
  Result := GetObjectProvider(ANextSection).GetObjectIndex(AType)
    = GetObjectIndex(AType);
end;

procedure TdxSectionHeadersFooters<TObj>.LinkToPrevious
  (AType: TdxHeaderFooterType);
begin
  PerformLinkToPrevious(AType, True, LinkCore);
end;

procedure TdxSectionHeadersFooters<TObj>.UnlinkFromPrevious
  (AType: TdxHeaderFooterType);
begin
...
procedure TdxSectionHeadersFooters<TObj>.UnlinkFromNext
  (AType: TdxHeaderFooterType);
begin
...
procedure TdxSectionHeadersFooters<TObj>.OnRequestSectionIndex(ASender: TObject;
  AArgs: TdxRequestSectionIndexEventArgs);
var
  AIndex: TdxSectionIndex;
begin
...
function TdxSectionHeadersFooters<TObj>.GetValidUniqueObjectIndices
  : TdxIntegerList;
var
  I: Integer;
  AIndex: TdxSectionIndex;
...
procedure TdxSectionHeadersFooters<TObj>.PerformLinkToPrevious
  (AType: TdxHeaderFooterType; ALink: Boolean;
  const ALinkAction: TdxLinkObjectDelegate);
var
  APreviousSection: TdxSection;
...
begin
  ...
  APreviousSectionObjectIndex := GetObjectProvider(APreviousSection)
    .GetObjectIndex(AType);
  ...
  if ARelinkNextSection then
    GetObjectProvider(Section.GetNextSection).PerformLinkToPrevious(AType, True,
      LinkCore);
end;

function TdxSectionHeadersFooters<TObj>.ShouldRelinkNextSection
  (AType: TdxHeaderFooterType): Boolean;
var
  ANextSection: TdxSection;
begin
...
procedure TdxSectionHeadersFooters<TObj>.PerformLinkToNext
  (AType: TdxHeaderFooterType; ALink: Boolean;
  const ALinkAction: TdxLinkObjectDelegate);
var
  ANextSection: TdxSection;
...
begin
  ...
  ANextSectionObjectIndex := GetObjectProvider(ANextSection)
    .GetObjectIndex(AType);
  ...
  if ARelinkPrevSection then
    GetObjectProvider(Section.GetPreviousSection).PerformLinkToNext(AType, True,
      LinkCore);
end;

function TdxSectionHeadersFooters<TObj>.ShouldRelinkPreviousSection
  (AType: TdxHeaderFooterType): Boolean;
var
...
begin
  ...
  if APrevSection <> nil then
    Result := GetObjectProvider(APrevSection).GetObjectIndex(AType)
      = GetObjectIndex(AType)
  else
    Result := False;
end;

class procedure TdxSectionHeadersFooters<TObj>.LinkCore(ATargetObject
  : TdxSectionHeadersFooters<TObj>; AType: TdxHeaderFooterType;
  ASectionObjectIndex: TdxSectionIndex);
begin
...
class procedure TdxSectionHeadersFooters<TObj>.UnlinkCore
  (ATargetObject: TdxSectionHeadersFooters<TObj>; AType: TdxHeaderFooterType;
  ASectionObjectIndex: TdxSectionIndex);
begin
  ATargetObject.UnlinkCore(AType, ASectionObjectIndex);
end;

procedure TdxSectionHeadersFooters<TObj>.UnlinkCore(AType: TdxHeaderFooterType;
  ASectionObjectIndex: TdxSectionIndex);
var
  ASectionObject: TObj;
begin
...
function TdxSectionHeadersFooters<TObj>.GetObjectIndex
  (AType: TdxHeaderFooterType): TdxSectionIndex;
begin
  Result := FIndices[Integer(AType)];
end;

procedure TdxSectionHeadersFooters<TObj>.SetObjectIndex
  (AType: TdxHeaderFooterType; AIndex: TdxSectionIndex);
begin
  UnsubscribeEvents;
  try
...
function TdxSectionHeadersFooters<TObj>.GetObject
  (AType: TdxHeaderFooterType): TObj;
var
  AIndex: TdxSectionIndex;
begin
...
function TdxSectionHeadersFooters<TObj>.GetObjectCore
  (AType: TdxHeaderFooterType): TdxSectionHeaderFooterBase;
begin
  Result := GetObject(AType);
end;

function TdxSectionHeadersFooters<TObj>.CalculateActualObject
  (AFirstPageOfSection: Boolean; AIsEvenPage: Boolean): TObj;
begin
  Result := TObj(CalculateActualObjectCore(AFirstPageOfSection, AIsEvenPage));
end;

function TdxSectionHeadersFooters<TObj>.CreateEmptyObject
  (AType: TdxHeaderFooterType): TdxSectionIndex;
var
  ANewObject: TObj;
begin
  ANewObject := CreateEmptyObjectCore(AType);
  TdxDocumentModel(DocumentModel).UnsafeEditor.InsertFirstParagraph
    (TdxPieceTable(ANewObject.PieceTable));
  Result := CreateIndex(ObjectCache.Count);
  ObjectCache.Add(ANewObject);
end;

function TdxSectionHeadersFooters<TObj>.CreateObjectDeepCopy
  (ASourceObject: TObj): TdxSectionIndex;
begin
  Result := CreateEmptyObject(ASourceObject.&Type);
  CopyObjectContent(ASourceObject, ObjectCache[Result]);
end;

procedure TdxSectionHeadersFooters<TObj>.CopyObjectContent(ASourceHeaderFooter
  : TObj; ATargetHeaderFooter: TObj);
var
...
begin
  ...
  ACopyManager := TdxDocumentModelCopyManager.Create(ASource, ATarget,
    TdxParagraphNumerationCopyOptions.CopyAlways);
  try
    AOperation := TdxCopySectionOperation
      (ASource.DocumentModel.CreateCopySectionOperation(ACopyManager));
    try
      AOperation.FixLastParagraph := True;
      AOperation.Execute(ASource.DocumentStartLogPosition,
        ASource.DocumentEndLogPosition - ASource.DocumentStartLogPosition +
        1, False);
    finally
      AOperation.Free;
    end;
...
procedure TdxSectionHeadersFooters<TObj>.ChangeObjectIndex
  (AType: TdxHeaderFooterType; ANewIndex: TdxSectionIndex);
var
...
function TdxSectionHeader.GetContainer(ASection: TdxSection)
  : TdxSectionHeadersFootersBase;
begin
...
function TdxSectionHeaders.GetObjectCache
  : TdxHeaderFooterCollectionBase<TdxSectionHeader, TdxHeaderIndex>;
begin
  Result := TdxDocumentModel(DocumentModel).Headers;
end;

function TdxSectionHeaders.CreateEmptyObjectCore(AType: TdxHeaderFooterType)
  : TdxSectionHeader;
begin
...
function TdxSectionHeaders.CreateHistoryItem
  : TdxSectionHeaderFooterIndexChangedHistoryItem<TdxHeaderIndex>;
begin
  Result := TdxSectionPageHeaderIndexChangedHistoryItem.Create(Section);
end;

function TdxSectionHeaders.GetObjectProvider(ASection: TdxSection)
  : TdxSectionHeadersFooters<TdxSectionHeader>;
begin
  Result := ASection.Headers;
end;
...
function TdxSectionFooter.GetContainer(ASection: TdxSection)
  : TdxSectionHeadersFootersBase;
begin
...
procedure TdxSectionPageFooterIndexChangedHistoryItem.
  SetCurrentHeaderFooterIndex(ASection: TdxSection; AIndex: TdxFooterIndex);
begin
...
function TdxSectionFooters.GetObjectCache
  : TdxHeaderFooterCollectionBase<TdxSectionFooter, TdxFooterIndex>;
begin
  Result := TdxDocumentModel(DocumentModel).Footers;
end;

function TdxSectionFooters.CreateEmptyObjectCore(AType: TdxHeaderFooterType)
  : TdxSectionFooter;
begin
...
function TdxSectionFooters.CreateHistoryItem
  : TdxSectionHeaderFooterIndexChangedHistoryItem<TdxFooterIndex>;
begin
  Result := TdxSectionPageFooterIndexChangedHistoryItem.Create(Section);
end;

function TdxSectionFooters.GetObjectProvider(ASection: TdxSection)
  : TdxSectionHeadersFooters<TdxSectionFooter>;
begin
  Result := ASection.Footers;
end;
