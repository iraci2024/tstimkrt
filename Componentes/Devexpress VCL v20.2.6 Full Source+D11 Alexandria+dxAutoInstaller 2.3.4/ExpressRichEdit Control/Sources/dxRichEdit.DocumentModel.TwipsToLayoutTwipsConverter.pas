...
type
  ...
  TdxDocumentModelTwipsToLayoutTwipsConverter = class
...
function TdxDocumentModelTwipsToLayoutTwipsConverter.ToLayoutUnits
...
function TdxDocumentModelTwipsToLayoutTwipsConverter.ToModelUnits
  (value: Integer): Integer;
begin
  Result := value;
end;
