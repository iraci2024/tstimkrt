...
uses
  Types, Classes, SysUtils, Contnrs, Graphics, Windows, Generics.Defaults,
...
type
  ...
  private
    ...
    procedure TryToHandleFinishOfListLevelDestination(ANestedDestination
      : TdxRichEditRtfDestinationBase);
    procedure TryToHandleFinishOfListNameDestination(ANestedDestination
      : TdxRichEditRtfDestinationBase);
    procedure TryToHandleFinishOfListStyleNameDestination(ANestedDestination
      : TdxRichEditRtfDestinationBase);
    class procedure ListHybridKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ListIdKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ListKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ListLevelKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure ListNameKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ListRestartAtEachSectionKeywordHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); inline; static;
    class procedure ListSimpleKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ListStyleIdKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ListStyleNameKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ListTemplateIdKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
  protected
  ...
  private
    ...
    class procedure ListOverrideCountKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ListOverrideIdKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ListOverrideKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ListOverrideLevelKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ListOverrideListIdKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
  protected
    function CreateClone: TdxRichEditRtfDestinationBase; override;
    class function GetKeywordHT: TdxKeywordTranslatorTable; override;

    property CurrentOverride: TdxRtfNumberingListOverride read FCurrentOverride
      write FCurrentOverride;
  end;
...
function TdxListStyleNameDestination.CreateEmptyClone
...
class function TdxListTableDestination.CreateKeywordHT
...
procedure TdxListTableDestination.NestedGroupFinished
...
procedure TdxListTableDestination.TryToHandleFinishOfListLevelDestination
...
procedure TdxListTableDestination.TryToHandleFinishOfListNameDestination
  (ANestedDestination: TdxRichEditRtfDestinationBase);
var
  ACurrentDestination: TdxListTableDestination;
...
procedure TdxListTableDestination.TryToHandleFinishOfListStyleNameDestination
  (ANestedDestination: TdxRichEditRtfDestinationBase);
var
  ACurrentDestination: TdxListTableDestination;
...
begin
  ...
  AImporter.Position.CharacterFormatting.ResetUse
...
function TdxListOverrideTableDestination.CreateClone
  : TdxRichEditRtfDestinationBase;
begin
...
class function TdxListOverrideTableDestination.GetKeywordHT
  : TdxKeywordTranslatorTable;
begin
  Result := FKeywordHT;
end;
...
class function TdxListOverrideTableDestination.CreateKeywordHT
  : TdxKeywordTranslatorTable;
begin
  Result := TdxKeywordTranslatorTable.Create;
...
class procedure TdxListOverrideTableDestination.ListOverrideCountKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  // do nothing
end;

class procedure TdxListOverrideTableDestination.ListOverrideIdKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
...
class procedure TdxListOverrideTableDestination.ListOverrideKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
  ADestination: TdxListOverrideTableDestination;
begin
  ...
  AImporter.DocumentProperties.ListOverrideTable.Add
    (ADestination.CurrentOverride);
end;

class procedure TdxListOverrideTableDestination.ListOverrideLevelKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
  ADestination: TdxListOverrideTableDestination;
...
class procedure TdxListOverrideTableDestination.ListOverrideListIdKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
  ADestination: TdxListOverrideTableDestination;
begin
