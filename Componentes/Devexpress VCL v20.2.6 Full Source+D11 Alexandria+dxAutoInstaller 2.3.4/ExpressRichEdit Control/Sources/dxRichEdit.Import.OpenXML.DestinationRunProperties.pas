...
type
  ...
  protected
    ...
    class function OnBold(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
    class function OnItalic(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnCaps(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
    class function OnHiddenText(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnUnderline(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnSingleStrikeThrough(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnDoubleStrikeThrough(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnForeColor(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnBackColor(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnShading(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnFontSize(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnScript(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnFontName(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnLanguage(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnNoProof(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  public
    ...
    property CharacterProperties: IdxCharacterProperties
  ...
  TdxCharacterFormattingLeafElementDestination = class abstract
  ...
  TdxSingleStrikeThroughDestination = class
    (TdxCharacterFormattingLeafElementDestination)
  public
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;
  end;
  ...
  TdxDoubleStrikeThroughDestination = class
    (TdxCharacterFormattingLeafElementDestination)
  public
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;
  end;
  ...
  TdxRunStyleReferenceBaseDestination = class abstract
    (TdxLeafElementDestination)
  protected
...
constructor TdxRunPropertiesBaseDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  const ACharacterProperties: IdxCharacterProperties);
begin
...
class function TdxRunPropertiesBaseDestination.CreateElementHandlerTable
...
function TdxRunPropertiesBaseDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;

class function TdxRunPropertiesBaseDestination.GetCharacterProperties
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter)
...
class function TdxRunPropertiesBaseDestination.OnBold
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxBoldDestination.Create(AImporter,
    GetCharacterProperties(AImporter));
end;

class function TdxRunPropertiesBaseDestination.OnItalic
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxItalicDestination.Create(AImporter,
    GetCharacterProperties(AImporter));
end;

class function TdxRunPropertiesBaseDestination.OnCaps
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxAllCapsDestination.Create(AImporter,
    GetCharacterProperties(AImporter));
end;

class function TdxRunPropertiesBaseDestination.OnHiddenText
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxHiddenTextDestination.Create(AImporter,
    GetCharacterProperties(AImporter));
end;

class function TdxRunPropertiesBaseDestination.OnUnderline
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxUnderlineDestination.Create(AImporter,
    GetCharacterProperties(AImporter));
end;

class function TdxRunPropertiesBaseDestination.OnSingleStrikeThrough
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxSingleStrikeThroughDestination.Create(AImporter,
    GetCharacterProperties(AImporter));
end;

class function TdxRunPropertiesBaseDestination.OnDoubleStrikeThrough
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDoubleStrikeThroughDestination.Create(AImporter,
    GetCharacterProperties(AImporter));
end;

class function TdxRunPropertiesBaseDestination.OnForeColor
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxForeColorDestination.Create(AImporter,
    GetCharacterProperties(AImporter));
end;

class function TdxRunPropertiesBaseDestination.OnBackColor
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxBackColorDestination.Create(AImporter,
    GetCharacterProperties(AImporter));
end;

class function TdxRunPropertiesBaseDestination.OnShading
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxShadingDestination.Create(AImporter,
    GetCharacterProperties(AImporter));
end;

class function TdxRunPropertiesBaseDestination.OnFontSize
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxFontSizeDestination.Create(AImporter,
    GetCharacterProperties(AImporter));
end;

class function TdxRunPropertiesBaseDestination.OnScript
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxFontScriptDestination.Create(AImporter,
    GetCharacterProperties(AImporter));
end;

class function TdxRunPropertiesBaseDestination.OnFontName
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxFontNameDestination.Create(AImporter,
    GetCharacterProperties(AImporter));
end;

class function TdxRunPropertiesBaseDestination.OnLanguage
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxLanguageDestination.Create(AImporter,
    GetCharacterProperties(AImporter));
end;

class function TdxRunPropertiesBaseDestination.OnNoProof
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxNoProofDestination.Create(AImporter,
    GetCharacterProperties(AImporter));
end;

{ TdxRunPropertiesDestination }

constructor TdxRunPropertiesDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  ACharacterFormatting: TdxCharacterFormattingBase);
begin
...
class function TdxRunPropertiesDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
...
function TdxRunPropertiesDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;
...
procedure TdxRunPropertiesDestination.ProcessElementClose
...
class function TdxRunPropertiesDestination.OnStyle
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
constructor TdxCharacterFormattingLeafElementDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  const ACharacterProperties: IdxCharacterProperties);
begin
  inherited Create(AImporter);
...
begin
  ...
  begin
    ...
    begin
      ...
      CharacterProperties.FontUnderlineType := TdxWordProcessingMLBaseImporter
        (Importer).GetWpEnumValueCore<TdxUnderlineType>(AValue,
...
procedure TdxSingleStrikeThroughDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
var
  AValue: Boolean;
begin
...
procedure TdxDoubleStrikeThroughDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
var
  AValue: Boolean;
begin
...
begin
  ...
  begin
    AColor := TdxWordProcessingMLBaseImporter(Importer)
      .GetWpEnumValueCore<TdxAlphaColor>(AValue,
...
begin
  AColor := TdxWordProcessingMLBaseImporter(Importer)
    .GetWpSTColorValue(AReader, 'fill');
  if AColor <> TdxAlphaColors.Empty then
  begin
...
begin
  Result := AReader.GetAttribute('ascii',
    Importer.WordProcessingNamespaceConst);
  if Result <> '' then
    Exit;
  AAttribute := TdxWordProcessingMLValue.Create('hAnsi', 'h-ansi');
  Result := AReader.GetAttribute(Importer.GetWordProcessingMLValue(AAttribute),
    Importer.WordProcessingNamespaceConst);
end;

{ TdxDefaultFontNameDestination }

function TdxDefaultFontNameDestination.ReadFontName
  (AReader: TdxXmlReader): string;
var
  AAttribute: TdxWordProcessingMLValue;
begin
  Result := AReader.GetAttribute('ascii',
...
procedure TdxRunStyleReferenceBaseDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
var
  AValue: string;
  AStyleIndex: Integer;
...
function TdxRunStyleReferenceBaseDestination.LookupStyleIndex
...
procedure TdxRunStyleReferenceDestination.AssignCharacterStyleIndex
  (AValue: Integer);
begin
