...
type
  ...
  TdxParagraphFrameTextWrapType = (Auto, Around, None, NotBeside,
    Through, Tight);

  TdxParagraphFrameHorizontalPositionType = (Page, Column, Margin);

  TdxParagraphFrameHorizontalPositionAlignment = (None, Left, Center, Right,
    Inside, Outside);

  TdxParagraphFrameVerticalPositionType = (Page, Paragraph, Margin);

  TdxParagraphFrameVerticalPositionAlignment = (None, Top, Center, Bottom,
  ...
  IdxParagraphFrameLocation = interface
    ...
    property HorizontalPositionType: TdxParagraphFrameHorizontalPositionType
      read GetHorizontalPositionType;
    property VerticalPositionType: TdxParagraphFrameVerticalPositionType
  ...
  strict private
    ...
    function GetHorizontalPositionAlignment
      : TdxParagraphFrameHorizontalPositionAlignment;
    procedure SetHorizontalPositionAlignment(const AValue
      : TdxParagraphFrameHorizontalPositionAlignment);
    function GetVerticalPositionAlignment
      : TdxParagraphFrameVerticalPositionAlignment;
    procedure SetVerticalPositionAlignment(const AValue
      : TdxParagraphFrameVerticalPositionAlignment);
    function GetHorizontalPositionType: TdxParagraphFrameHorizontalPositionType;
    procedure SetHorizontalPositionType(const AValue
      : TdxParagraphFrameHorizontalPositionType);
    function GetVerticalPositionType: TdxParagraphFrameVerticalPositionType;
    procedure SetVerticalPositionType(const AValue
  ...
  public
    ...
    property HorizontalPosition: Integer read FHorizontalPosition
      write FHorizontalPosition;
    property VerticalPosition: Integer read FVerticalPosition
      write FVerticalPosition;
    property HorizontalPadding: Integer read FHorizontalPadding
      write FHorizontalPadding;
    property VerticalPadding: Integer read FVerticalPadding
      write FVerticalPadding;
    property HorizontalRule: TdxParagraphFrameHorizontalRule
      read GetHorizontalRule write SetHorizontalRule;
    property TextWrapType: TdxParagraphFrameTextWrapType read GetTextWrapType
    ...
    property DropCapVerticalHeightInLines: Integer
      read FDropCapVerticalHeightInLines write FDropCapVerticalHeightInLines;
    property LockFrameAnchorToParagraph: Boolean
      read GetLockFrameAnchorToParagraph write SetLockFrameAnchorToParagraph;
  end;
  ...
  public type
    TMask = (UseHorizontalPosition, UseVerticalPosition, UseHorizontalPadding,
      UseVerticalPadding, UseHorizontalRule, UseTextWrapType, UseX, UseY,
      UseWidth, UseHeight, UseHorizontalPositionAlignment,
      UseVerticalPositionAlignment, UseHorizontalPositionType,
      UseVerticalPositionType, UseDropCap, UseDropCapVerticalHeightInLines,
  ...
  private
    class function GetEmptyParagraphFrameFormattingOption
      : TdxParagraphFrameFormattingOptions; static;
    class function GetRootParagraphFrameFormattingOption
      : TdxParagraphFrameFormattingOptions; static;
  public
    class function Create: TdxParagraphFrameFormattingOptions; overload; static;
    class property RootParagraphFrameFormattingOption
      : TdxParagraphFrameFormattingOptions
      read GetRootParagraphFrameFormattingOption;
    class property EmptyParagraphFrameFormattingOption
      : TdxParagraphFrameFormattingOptions
      read GetEmptyParagraphFrameFormattingOption;
    constructor Create(AValue: TMasks); overload;

    property Value: TMasks read FValue write FValue;

    property UseHorizontalPosition: Boolean index TMask.UseHorizontalPosition
      read GetValue write SetValue;
    property UseVerticalPosition: Boolean index TMask.UseVerticalPosition
      read GetValue write SetValue;
    property UseHorizontalPadding: Boolean index TMask.UseHorizontalPadding
      read GetValue write SetValue;
    property UseVerticalPadding: Boolean index TMask.UseVerticalPadding
      read GetValue write SetValue;
    property UseHorizontalRule: Boolean index TMask.UseHorizontalRule
      read GetValue write SetValue;
    property UseTextWrapType: Boolean index TMask.UseTextWrapType read GetValue
      write SetValue;
    ...
    property UseWidth: Boolean index TMask.UseWidth read GetValue
      write SetValue;
    property UseHeight: Boolean index TMask.UseHeight read GetValue
      write SetValue;
    property UseHorizontalPositionAlignment: Boolean
      index TMask.UseHorizontalPositionAlignment read GetValue write SetValue;
    property UseVerticalPositionAlignment: Boolean
      index TMask.UseVerticalPositionAlignment read GetValue write SetValue;
    property UseHorizontalPositionType: Boolean
      index TMask.UseHorizontalPositionType read GetValue write SetValue;
    property UseVerticalPositionType: Boolean
      index TMask.UseVerticalPositionType read GetValue write SetValue;
    property UseDropCap: Boolean index TMask.UseDropCap read GetValue
      write SetValue;
    property UseDropCapVerticalHeightInLines: Boolean
      index TMask.UseDropCapVerticalHeightInLines read GetValue write SetValue;
    property UseLockFrameAnchorToParagraph: Boolean
      index TMask.UseLockFrameAnchorToParagraph read GetValue write SetValue;
  end;

  { TdxParagraphFrameFormattingBase }

  TdxParagraphFrameFormattingBase = class
    (TdxIndexBasedObjectB<TdxParagraphFrameFormattingInfo,
    TdxParagraphFrameFormattingOptions>, IdxParagraphFrameLocation)
  strict private
    function GetDropCap: TdxDropCapLocation;
    ...
    procedure SetLockFrameAnchorToParagraph(const AValue: Boolean);
    procedure SetTextWrapType(const AValue: TdxParagraphFrameTextWrapType);
    procedure SetUseValue(const AValue
      : TdxParagraphFrameFormattingOptions.TMasks);
  ...
  protected
    ...
    function PropertyEquals(const AOther
      : TdxIndexBasedObject<TdxParagraphFrameFormattingInfo,
      TdxParagraphFrameFormattingOptions>): Boolean; override;
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      const ADocumentModel: TdxCustomDocumentModel;
      const AFormattingInfo: TdxParagraphFrameFormattingInfo;
      const AFormattingOptions: TdxParagraphFrameFormattingOptions);
      reintroduce;

    procedure SetHorizontalPositionCore(const AInfo
      : TdxParagraphFrameFormattingInfo; const AValue: Integer);
    procedure SetVerticalPositionCore(const AInfo
      : TdxParagraphFrameFormattingInfo; const AValue: Integer);
    procedure SetHorizontalPaddingCore(const AInfo
      : TdxParagraphFrameFormattingInfo; const AValue: Integer);
    procedure SetVerticalPaddingCore(const AInfo
      : TdxParagraphFrameFormattingInfo; const AValue: Integer);
    procedure SetHorizontalRuleCore(const AInfo
      : TdxParagraphFrameFormattingInfo;
      const AValue: TdxParagraphFrameHorizontalRule);
    procedure SetTextWrapTypeCore(const AInfo: TdxParagraphFrameFormattingInfo;
      const AValue: TdxParagraphFrameTextWrapType);
    procedure SetXCore(const AInfo: TdxParagraphFrameFormattingInfo;
      const AValue: Integer);
    procedure SetYCore(const AInfo: TdxParagraphFrameFormattingInfo;
      const AValue: Integer);
    ...
    procedure SetHorizontalPositionTypeCore(const AInfo
      : TdxParagraphFrameFormattingInfo;
      const AValue: TdxParagraphFrameHorizontalPositionType);
    procedure SetVerticalPositionTypeCore(const AInfo
      : TdxParagraphFrameFormattingInfo;
      const AValue: TdxParagraphFrameVerticalPositionType);
    procedure SetWidthCore(const AInfo: TdxParagraphFrameFormattingInfo;
      const AValue: Integer);
    procedure SetHeightCore(const AInfo: TdxParagraphFrameFormattingInfo;
      const AValue: Integer);
    procedure SetDropCapCore(const AInfo: TdxParagraphFrameFormattingInfo;
      const AValue: TdxDropCapLocation);
    procedure SetDropCapVerticalHeightInLinesCore
      (const AInfo: TdxParagraphFrameFormattingInfo; const AValue: Integer);
    procedure SetLockFrameAnchorToParagraphCore(const AInfo
      : TdxParagraphFrameFormattingInfo; const AValue: Boolean);

    procedure CopyFrom(Source: TdxCloneable); overload; override;
    procedure CopyFrom(const AInfo: TdxParagraphFrameFormattingInfo;
      const AOptions: TdxParagraphFrameFormattingOptions); reintroduce;
      overload; inline;
    function Clone: TdxCloneable; override;

    property HorizontalPosition: Integer read GetHorizontalPosition
      write SetHorizontalPosition;
    property VerticalPosition: Integer read GetVerticalPosition
      write SetVerticalPosition;
    property HorizontalPadding: Integer read GetHorizontalPadding
      write SetHorizontalPadding;
    property VerticalPadding: Integer read GetVerticalPadding
    ...
    property DropCap: TdxDropCapLocation read GetDropCap write SetDropCap;
    property DropCapVerticalHeightInLines: Integer
      read GetDropCapVerticalHeightInLines
      write SetDropCapVerticalHeightInLines;
    property LockFrameAnchorToParagraph: Boolean
      read GetLockFrameAnchorToParagraph write SetLockFrameAnchorToParagraph;
    property UseValue: TdxParagraphFrameFormattingOptions.TMasks
      read GetUseValue write SetUseValue;
  end;

  { TdxParagraphFrameFormattingInfoCache }

  TdxParagraphFrameFormattingInfoCache = class
    (TdxUniqueItemsCache<TdxParagraphFrameFormattingInfo>)
  strict private
    FDefaultItem: TdxParagraphFrameFormattingInfo;
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter)
      : TdxParagraphFrameFormattingInfo; override;
  ...
  TdxParagraphFrameFormattingCache = class
    (TdxUniqueItemsCache<TdxParagraphFrameFormattingBase>)
  public const
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter)
      : TdxParagraphFrameFormattingBase; override;
  public
    ...
    property DefaultParagraphFrameFormattingInfo
      : TdxParagraphFrameFormattingInfo
      read FDefaultParagraphFrameFormattingInfo;
    property EmptyParagraphFrameFormattingInfo: TdxParagraphFrameFormattingInfo
      read FEmptyParagraphFrameFormattingInfo;
  end;

  { TdxParagraphFrameFormattingChangeActionsCalculator }

  TdxParagraphFrameFormattingChangeType = (None, HorizontalPosition,
    VerticalPosition, HorizontalPadding, VerticalPadding, HorizontalRule,
    TextWrapType, X, Y, Width, Height, HorizontalPositionAlignment,
    VerticalPositionAlignment, HorizontalPositionType, VerticalPositionType,
    DropCap, DropCapVerticalHeightInLines, LockFrameAnchorToParagraph,
    BatchUpdate);

  TdxParagraphFrameFormattingChangeActionsCalculator = class
    class function CalculateChangeActions
      (AChange: TdxParagraphFrameFormattingChangeType)
      : TdxDocumentModelChangeActions; static;
  end;

  { TdxFrameProperties }

  TdxFrameProperties = class
    (TdxRichEditIndexBasedObject<TdxParagraphFrameFormattingBase>,
  ...
  strict protected
    function SetVerticalPositionCore(const AInfo
      : TdxParagraphFrameFormattingBase; const AValue: Integer)
      : TdxDocumentModelChangeActions; virtual;
    function SetHorizontalPositionCore(const AInfo
      : TdxParagraphFrameFormattingBase; const AValue: Integer)
      : TdxDocumentModelChangeActions; virtual;
    function SetHorizontalPaddingCore(const AInfo
      : TdxParagraphFrameFormattingBase; const AValue: Integer)
      : TdxDocumentModelChangeActions; virtual;
    function SetVerticalPaddingCore(const AInfo
      : TdxParagraphFrameFormattingBase; const AValue: Integer)
      : TdxDocumentModelChangeActions; virtual;
    function SetHorizontalRuleCore(const AInfo: TdxParagraphFrameFormattingBase;
      const AValue: TdxParagraphFrameHorizontalRule)
      : TdxDocumentModelChangeActions; virtual;
    function SetTextWrapTypeCore(const AInfo: TdxParagraphFrameFormattingBase;
      const AValue: TdxParagraphFrameTextWrapType)
      : TdxDocumentModelChangeActions; virtual;
    function SetXCore(const AInfo: TdxParagraphFrameFormattingBase;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetYCore(const AInfo: TdxParagraphFrameFormattingBase;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    ...
    function SetVerticalPositionTypeCore(const AInfo
      ...
      const AValue: TdxParagraphFrameVerticalPositionType)
      : TdxDocumentModelChangeActions; virtual;
    function SetWidthCore(const AInfo: TdxParagraphFrameFormattingBase;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetHeightCore(const AInfo: TdxParagraphFrameFormattingBase;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetLockFrameAnchorToParagraphCore(const AInfo
      : TdxParagraphFrameFormattingBase; const AValue: Boolean)
      : TdxDocumentModelChangeActions; virtual;
    function SetDropCapCore(const AInfo: TdxParagraphFrameFormattingBase;
      const AValue: TdxDropCapLocation): TdxDocumentModelChangeActions; virtual;
    function SetDropCapVerticalHeightInLinesCore(const AInfo
      : TdxParagraphFrameFormattingBase; const AValue: Integer)
      : TdxDocumentModelChangeActions; virtual;

    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxParagraphFrameFormattingBase>; override;
    ...
    function GetObtainAffectedRangeListener
      : IdxObtainAffectedRangeListener; override;
  public
    constructor Create(const AOwner: IdxParagraphPropertiesContainer);
      reintroduce; overload;
    class procedure ApplyPropertiesDiff(ATarget: TdxFrameProperties;
      ATargetMergedInfo: TdxParagraphFrameFormattingInfo;
    ...
    procedure CopyFrom(AFrameProperties
      : TdxMergedProperties<TdxParagraphFrameFormattingInfo,
      TdxParagraphFrameFormattingOptions>); overload;
{$IFNDEF DELPHI17}
    procedure CopyFrom(const Source: TdxParagraphFrameFormattingBase); override;
    procedure CopyFrom(const Source
      : TdxUndoableIndexBasedObject<TdxParagraphFrameFormattingBase>); override;
{$ENDIF}
    property VerticalPosition: Integer read GetVerticalPosition
      write SetVerticalPosition;
    ...
    property LockFrameAnchorToParagraph: Boolean
      read GetLockFrameAnchorToParagraph write SetLockFrameAnchorToParagraph;
    property UseLockFrameAnchorToParagraph: Boolean
      read GetUseLockFrameAnchorToParagraph;
    property DropCap: TdxDropCapLocation read GetDropCap write SetDropCap;
    ...
    property DropCapVerticalHeightInLines: Integer
      ...
      write SetDropCapVerticalHeightInLines;
    property UseDropCapVerticalHeightInLines: Boolean
      read GetUseDropCapVerticalHeightInLines;
  end;

  { TdxMergedFrameProperties }

  TdxMergedFrameProperties = class
    (TdxMergedProperties<TdxParagraphFrameFormattingInfo,
    TdxParagraphFrameFormattingOptions>, IdxParagraphFrameLocation)
  strict private
    function GetX: Integer;
    ...
    function GetHeight: Integer;
  protected
    procedure MergeCore(AInfo: TdxParagraphFrameFormattingInfo;
      AOptions: TdxParagraphFrameFormattingOptions);
  public
    constructor Create(AInitialProperties: TdxFrameProperties);
      reintroduce; overload;
    constructor Create(AInitial: TdxMergedFrameProperties);
      reintroduce; overload;
...
function TdxParagraphFrameFormattingInfo.GetHorizontalRule
  : TdxParagraphFrameHorizontalRule;
begin
  Result := TdxParagraphFrameHorizontalRule(FPackedValues and
    MaskHorizontalRule);
end;

procedure TdxParagraphFrameFormattingInfo.SetHorizontalRule
  (const AValue: TdxParagraphFrameHorizontalRule);
begin
...
function TdxParagraphFrameFormattingInfo.GetTextWrapType
  : TdxParagraphFrameTextWrapType;
begin
  Result := TdxParagraphFrameTextWrapType
    ((FPackedValues and MaskWrapType) shr 2);
end;

procedure TdxParagraphFrameFormattingInfo.SetTextWrapType
  (const AValue: TdxParagraphFrameTextWrapType);
begin
...
function TdxParagraphFrameFormattingInfo.GetHorizontalPositionAlignment
  : TdxParagraphFrameHorizontalPositionAlignment;
begin
  Result := TdxParagraphFrameHorizontalPositionAlignment
    ((FPackedValues and MaskHorizontalPositionAlignment) shr 9);
end;

procedure TdxParagraphFrameFormattingInfo.SetHorizontalPositionAlignment
  (const AValue: TdxParagraphFrameHorizontalPositionAlignment);
begin
  FPackedValues := FPackedValues and not MaskHorizontalPositionAlignment;
  FPackedValues := FPackedValues or (Integer(AValue) shl 9) and
    MaskHorizontalPositionAlignment;
end;

function TdxParagraphFrameFormattingInfo.GetVerticalPositionAlignment
  : TdxParagraphFrameVerticalPositionAlignment;
begin
  Result := TdxParagraphFrameVerticalPositionAlignment
    ((FPackedValues and MaskVerticalPositionAlignment) shr 12);
end;

procedure TdxParagraphFrameFormattingInfo.SetVerticalPositionAlignment
  (const AValue: TdxParagraphFrameVerticalPositionAlignment);
begin
  FPackedValues := FPackedValues and not MaskVerticalPositionAlignment;
  FPackedValues := FPackedValues or (Integer(AValue) shl 12) and
    MaskVerticalPositionAlignment;
end;

function TdxParagraphFrameFormattingInfo.GetHorizontalPositionType
  : TdxParagraphFrameHorizontalPositionType;
begin
  Result := TdxParagraphFrameHorizontalPositionType
    ((FPackedValues and MaskHorizontalPositionType) shr 5);
end;

procedure TdxParagraphFrameFormattingInfo.SetHorizontalPositionType
  (const AValue: TdxParagraphFrameHorizontalPositionType);
begin
  FPackedValues := FPackedValues and not MaskHorizontalPositionType;
  FPackedValues := FPackedValues or (Integer(AValue) shl 5) and
    MaskHorizontalPositionType;
end;

function TdxParagraphFrameFormattingInfo.GetVerticalPositionType
  : TdxParagraphFrameVerticalPositionType;
begin
  Result := TdxParagraphFrameVerticalPositionType
    ((FPackedValues and MaskVerticalPositionType) shr 7);
end;

procedure TdxParagraphFrameFormattingInfo.SetVerticalPositionType
  (const AValue: TdxParagraphFrameVerticalPositionType);
begin
  FPackedValues := FPackedValues and not MaskVerticalPositionType;
  FPackedValues := FPackedValues or (Integer(AValue) shl 7) and
    MaskVerticalPositionType;
end;
...
procedure TdxParagraphFrameFormattingInfo.SetDropCap(const AValue
  : TdxDropCapLocation);
begin
...
procedure TdxParagraphFrameFormattingInfo.SetLockFrameAnchorToParagraph
  (const AValue: Boolean);
begin
  SetBooleanValue(MaskLockFrameAnchorToParagraph, AValue);
end;

procedure TdxParagraphFrameFormattingInfo.SetBooleanValue(AMask: Integer;
  ABitVal: Boolean);
begin
  if ABitVal then
...
function TdxParagraphFrameFormattingInfo.GetBooleanValue
...
begin
  ...
  Result := (FPackedValues = AInfo.FPackedValues) and
    ...
    (VerticalPadding = AInfo.VerticalPadding) and (Height = AInfo.Height) and
    (Width = AInfo.Width) and (X = AInfo.X) and (Y = AInfo.Y) and
...
begin
  Result := FPackedValues xor FVerticalPosition xor FHorizontalPosition xor
    FHorizontalPadding xor FVerticalPadding xor FHeight xor FWidth xor FX xor FY
    xor FDropCapVerticalHeightInLines;
end;

{ TdxParagraphFrameFormattingInfoCache }

class function TdxParagraphFrameFormattingInfoCache.CreateDefaultInfo
  : TdxParagraphFrameFormattingInfo;
begin
  ...
  Result.HorizontalPositionAlignment :=
    TdxParagraphFrameHorizontalPositionAlignment.Left;
  Result.VerticalPositionAlignment :=
    TdxParagraphFrameVerticalPositionAlignment.Inline;
end;

function TdxParagraphFrameFormattingInfoCache.CreateDefaultItem
...
procedure TdxParagraphFrameFormattingInfoCache.InitItems(const AUnitConverter
  : IdxDocumentModelUnitConverter);
begin
...
constructor TdxParagraphFrameFormattingCache.Create(ADocumentModel
...
begin
  ...
  FDefaultParagraphFrameFormattingInfo :=
    TdxParagraphFrameFormattingInfoCache.CreateDefaultInfo;
...
function TdxParagraphFrameFormattingCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxParagraphFrameFormattingBase;
begin
  Result := nil;
end;
...
class function TdxParagraphFrameFormattingOptions.Create
  : TdxParagraphFrameFormattingOptions;
begin
  Result.FValue := MaskUseNone;
end;

procedure TdxParagraphFrameFormattingOptions.SetValue(AMask: TMask;
  AValue: Boolean);
begin
  if AValue then
...
class function TdxParagraphFrameFormattingOptions.
  GetEmptyParagraphFrameFormattingOption: TdxParagraphFrameFormattingOptions;
begin
  Result := TdxParagraphFrameFormattingOptions.Create;
end;

class function TdxParagraphFrameFormattingOptions.
  GetRootParagraphFrameFormattingOption: TdxParagraphFrameFormattingOptions;
begin
  Result := TdxParagraphFrameFormattingOptions.Create
    (TdxParagraphFrameFormattingOptions.MaskUseAll);
end;
...
constructor TdxParagraphFrameFormattingBase.Create
...
procedure TdxParagraphFrameFormattingBase.SetHorizontalPosition
  (const AValue: Integer);
begin
...
procedure TdxParagraphFrameFormattingBase.SetHorizontalPositionCore
  (const AInfo: TdxParagraphFrameFormattingInfo; const AValue: Integer);
begin
...
procedure TdxParagraphFrameFormattingBase.SetVerticalPosition
  (const AValue: Integer);
begin
...
procedure TdxParagraphFrameFormattingBase.SetVerticalPositionCore
  (const AInfo: TdxParagraphFrameFormattingInfo; const AValue: Integer);
begin
...
procedure TdxParagraphFrameFormattingBase.SetHorizontalPadding
  (const AValue: Integer);
begin
...
procedure TdxParagraphFrameFormattingBase.SetHorizontalPaddingCore
  (const AInfo: TdxParagraphFrameFormattingInfo; const AValue: Integer);
begin
...
procedure TdxParagraphFrameFormattingBase.SetVerticalPadding
  (const AValue: Integer);
begin
...
procedure TdxParagraphFrameFormattingBase.SetVerticalPaddingCore
  (const AInfo: TdxParagraphFrameFormattingInfo; const AValue: Integer);
begin
...
function TdxParagraphFrameFormattingBase.GetHorizontalRule
  : TdxParagraphFrameHorizontalRule;
begin
  Result := Info.HorizontalRule;
end;

procedure TdxParagraphFrameFormattingBase.SetHorizontalRule
  (const AValue: TdxParagraphFrameHorizontalRule);
begin
  if (Info.HorizontalRule = AValue) and Options.UseHorizontalRule then
    Exit;
  SetPropertyValue<TdxParagraphFrameHorizontalRule>
    (SetHorizontalRuleCore, AValue);
end;

procedure TdxParagraphFrameFormattingBase.SetHorizontalRuleCore
  (const AInfo: TdxParagraphFrameFormattingInfo;
  const AValue: TdxParagraphFrameHorizontalRule);
begin
...
function TdxParagraphFrameFormattingBase.GetTextWrapType
  : TdxParagraphFrameTextWrapType;
begin
  Result := Info.TextWrapType;
end;

procedure TdxParagraphFrameFormattingBase.SetTextWrapType
  (const AValue: TdxParagraphFrameTextWrapType);
begin
...
procedure TdxParagraphFrameFormattingBase.SetTextWrapTypeCore
  (const AInfo: TdxParagraphFrameFormattingInfo;
  const AValue: TdxParagraphFrameTextWrapType);
begin
...
procedure TdxParagraphFrameFormattingBase.SetXCore
  (const AInfo: TdxParagraphFrameFormattingInfo; const AValue: Integer);
begin
  AInfo.X := AValue;
  Options.UseX := True;
...
procedure TdxParagraphFrameFormattingBase.SetYCore
  (const AInfo: TdxParagraphFrameFormattingInfo; const AValue: Integer);
begin
  AInfo.Y := AValue;
  Options.UseY := True;
...
function TdxParagraphFrameFormattingBase.GetHorizontalPositionAlignment
  : TdxParagraphFrameHorizontalPositionAlignment;
begin
  Result := Info.HorizontalPositionAlignment;
end;

procedure TdxParagraphFrameFormattingBase.SetHorizontalPositionAlignment
  (const AValue: TdxParagraphFrameHorizontalPositionAlignment);
begin
  if (Info.HorizontalPositionAlignment = AValue) and Options.UseHorizontalPositionAlignment
  then
    Exit;
  SetPropertyValue<TdxParagraphFrameHorizontalPositionAlignment>
    (SetHorizontalPositionAlignmentCore, AValue);
end;

procedure TdxParagraphFrameFormattingBase.SetHorizontalPositionAlignmentCore
  (const AInfo: TdxParagraphFrameFormattingInfo;
  const AValue: TdxParagraphFrameHorizontalPositionAlignment);
begin
...
function TdxParagraphFrameFormattingBase.GetVerticalPositionAlignment
  : TdxParagraphFrameVerticalPositionAlignment;
begin
  Result := Info.VerticalPositionAlignment;
end;

procedure TdxParagraphFrameFormattingBase.SetVerticalPositionAlignment
  (const AValue: TdxParagraphFrameVerticalPositionAlignment);
begin
  if (Info.VerticalPositionAlignment = AValue) and Options.UseVerticalPositionAlignment
  then
    Exit;
  SetPropertyValue<TdxParagraphFrameVerticalPositionAlignment>
    (SetVerticalPositionAlignmentCore, AValue);
end;

procedure TdxParagraphFrameFormattingBase.SetVerticalPositionAlignmentCore
  (const AInfo: TdxParagraphFrameFormattingInfo;
  const AValue: TdxParagraphFrameVerticalPositionAlignment);
begin
...
function TdxParagraphFrameFormattingBase.GetHorizontalPositionType
  : TdxParagraphFrameHorizontalPositionType;
begin
  Result := Info.HorizontalPositionType;
end;

procedure TdxParagraphFrameFormattingBase.SetHorizontalPositionType
  (const AValue: TdxParagraphFrameHorizontalPositionType);
begin
  if (Info.HorizontalPositionType = AValue) and Options.UseHorizontalPositionType
  then
    Exit;
  SetPropertyValue<TdxParagraphFrameHorizontalPositionType>
    (SetHorizontalPositionTypeCore, AValue);
end;

procedure TdxParagraphFrameFormattingBase.SetHorizontalPositionTypeCore
  (const AInfo: TdxParagraphFrameFormattingInfo;
  const AValue: TdxParagraphFrameHorizontalPositionType);
begin
...
function TdxParagraphFrameFormattingBase.GetVerticalPositionType
  : TdxParagraphFrameVerticalPositionType;
begin
  Result := Info.VerticalPositionType;
end;

procedure TdxParagraphFrameFormattingBase.SetVerticalPositionType
  (const AValue: TdxParagraphFrameVerticalPositionType);
begin
  if (Info.VerticalPositionType = AValue) and Options.UseVerticalPositionType
  then
    Exit;
  SetPropertyValue<TdxParagraphFrameVerticalPositionType>
    (SetVerticalPositionTypeCore, AValue);
end;

procedure TdxParagraphFrameFormattingBase.SetVerticalPositionTypeCore
  (const AInfo: TdxParagraphFrameFormattingInfo;
  const AValue: TdxParagraphFrameVerticalPositionType);
begin
...
procedure TdxParagraphFrameFormattingBase.SetWidthCore
  (const AInfo: TdxParagraphFrameFormattingInfo; const AValue: Integer);
begin
  AInfo.Width := AValue;
...
procedure TdxParagraphFrameFormattingBase.SetHeightCore
  (const AInfo: TdxParagraphFrameFormattingInfo; const AValue: Integer);
begin
  AInfo.Height := AValue;
...
procedure TdxParagraphFrameFormattingBase.SetDropCap(const AValue
  : TdxDropCapLocation);
begin
...
procedure TdxParagraphFrameFormattingBase.SetDropCapCore
  (const AInfo: TdxParagraphFrameFormattingInfo;
  const AValue: TdxDropCapLocation);
begin
...
function TdxParagraphFrameFormattingBase.
  GetDropCapVerticalHeightInLines: Integer;
begin
  Result := Info.DropCapVerticalHeightInLines;
end;

procedure TdxParagraphFrameFormattingBase.SetDropCapVerticalHeightInLines
  (const AValue: Integer);
begin
  if (Info.DropCapVerticalHeightInLines = AValue) and Options.UseDropCapVerticalHeightInLines
  then
    Exit;
  SetPropertyValue<Integer>(SetDropCapVerticalHeightInLinesCore, AValue);
end;

procedure TdxParagraphFrameFormattingBase.SetDropCapVerticalHeightInLinesCore
  (const AInfo: TdxParagraphFrameFormattingInfo; const AValue: Integer);
begin
...
procedure TdxParagraphFrameFormattingBase.SetLockFrameAnchorToParagraph
  (const AValue: Boolean);
begin
  if (Info.LockFrameAnchorToParagraph = AValue) and Options.UseLockFrameAnchorToParagraph
  then
    Exit;
  SetPropertyValue<Boolean>(SetLockFrameAnchorToParagraphCore, AValue);
end;

procedure TdxParagraphFrameFormattingBase.SetLockFrameAnchorToParagraphCore
  (const AInfo: TdxParagraphFrameFormattingInfo; const AValue: Boolean);
begin
  AInfo.LockFrameAnchorToParagraph := AValue;
  Options.UseLockFrameAnchorToParagraph := True;
end;

function TdxParagraphFrameFormattingBase.GetUseValue
  : TdxParagraphFrameFormattingOptions.TMasks;
begin
  Result := Options.Value;
end;

procedure TdxParagraphFrameFormattingBase.SetUseValue
  (const AValue: TdxParagraphFrameFormattingOptions.TMasks);
begin
...
procedure TdxParagraphFrameFormattingBase.CopyFrom
  (const AInfo: TdxParagraphFrameFormattingInfo;
...
function TdxParagraphFrameFormattingBase.PropertyEquals
  (const AOther: TdxIndexBasedObject<TdxParagraphFrameFormattingInfo,
  TdxParagraphFrameFormattingOptions>): Boolean;
begin
...
class function TdxParagraphFrameFormattingChangeActionsCalculator.
  CalculateChangeActions(AChange: TdxParagraphFrameFormattingChangeType)
  : TdxDocumentModelChangeActions;
const
  ParagraphFrameFormattingChangeActionsMap
    : array [TdxParagraphFrameFormattingChangeType]
...
constructor TdxMergedFrameProperties.Create(AInitialProperties
  : TdxFrameProperties);
var
...
procedure TdxMergedFrameProperties.MergeCore
  (AInfo: TdxParagraphFrameFormattingInfo;
  AOptions: TdxParagraphFrameFormattingOptions);
begin
  ...
  if not Options.UseHorizontalPositionAlignment and AOptions.UseHorizontalPositionAlignment
  then
  begin
    Info.HorizontalPositionAlignment := AInfo.HorizontalPositionAlignment;
    Options.UseHorizontalPositionAlignment := True;
  end;
  if not Options.UseVerticalPositionAlignment and AOptions.UseVerticalPositionAlignment
  then
  begin
    Info.VerticalPositionAlignment := AInfo.VerticalPositionAlignment;
    Options.UseVerticalPositionAlignment := True;
  end;
  if not Options.UseHorizontalPositionType and AOptions.UseHorizontalPositionType
  then
  begin
    Info.HorizontalPositionType := AInfo.HorizontalPositionType;
    Options.UseHorizontalPositionType := True;
  end;
  if not Options.UseVerticalPositionType and AOptions.UseVerticalPositionType
  then
  begin
  ...
  if not Options.UseDropCapVerticalHeightInLines and AOptions.UseDropCapVerticalHeightInLines
  then
  begin
    Info.DropCapVerticalHeightInLines := AInfo.DropCapVerticalHeightInLines;
    Options.UseDropCapVerticalHeightInLines := True;
  end;
  if not Options.UseLockFrameAnchorToParagraph and AOptions.UseLockFrameAnchorToParagraph
  then
  begin
...
function TdxMergedFrameProperties.GetHorizontalPositionAlignment
  : TdxParagraphFrameHorizontalPositionAlignment;
begin
  Result := Info.HorizontalPositionAlignment;
end;

function TdxMergedFrameProperties.GetVerticalPositionAlignment
  : TdxParagraphFrameVerticalPositionAlignment;
begin
  Result := Info.VerticalPositionAlignment;
end;

function TdxMergedFrameProperties.GetHorizontalPositionType
  : TdxParagraphFrameHorizontalPositionType;
begin
  Result := Info.HorizontalPositionType;
end;

function TdxMergedFrameProperties.GetVerticalPositionType
  : TdxParagraphFrameVerticalPositionType;
begin
  Result := Info.VerticalPositionType;
end;
...
function TdxMergedFrameProperties.CanMerge(AProperties
  : TdxMergedFrameProperties): Boolean;
begin
  Result := (Info.TextWrapType = AProperties.Info.TextWrapType) and
    ...
    (Width = AProperties.Width) and (X = AProperties.X) and (Y = AProperties.Y);
  ...
  if not Options.UseX and not AProperties.Options.UseX then
    Result := Result and
      (HorizontalPositionAlignment = AProperties.HorizontalPositionAlignment);

  if not Options.UseY and not AProperties.Options.UseY then
    Result := Result and
      (VerticalPositionAlignment = AProperties.VerticalPositionAlignment);
end;
...
begin
  Result := (Width <> 0) or
    ((Height <> 0) and (Info.HorizontalRule <>
    TdxParagraphFrameHorizontalRule.Auto)) or (X <> 0) or (Y <> 0) or
    (HorizontalPositionType <> TdxParagraphFrameHorizontalPositionType.Column)
    or (VerticalPositionType = TdxParagraphFrameVerticalPositionType.Paragraph)
    or (Options.UseHorizontalPositionAlignment and
    (HorizontalPositionAlignment <>
    TdxParagraphFrameHorizontalPositionAlignment.Left)) or
    (Options.UseVerticalPositionAlignment and
    (VerticalPositionAlignment <> TdxParagraphFrameVerticalPositionAlignment.
    Inline)) or (Info.TextWrapType <> TdxParagraphFrameTextWrapType.Auto);
end;

{ TdxFrameProperties }

constructor TdxFrameProperties.Create(const AOwner
...
class procedure TdxFrameProperties.ApplyPropertiesDiff
  (ATarget: TdxFrameProperties;
  ATargetMergedInfo: TdxParagraphFrameFormattingInfo;
  ASourceMergedInfo: TdxParagraphFrameFormattingInfo);
begin
  if ATargetMergedInfo.HorizontalPosition <> ASourceMergedInfo.HorizontalPosition
  then
    ATarget.HorizontalPosition := ASourceMergedInfo.HorizontalPosition;

  if ATargetMergedInfo.VerticalPosition <> ASourceMergedInfo.VerticalPosition
  then
    ATarget.VerticalPosition := ASourceMergedInfo.VerticalPosition;

  if ATargetMergedInfo.HorizontalPadding <> ASourceMergedInfo.HorizontalPadding
  then
  ...
  if ATargetMergedInfo.HorizontalPositionAlignment <> ASourceMergedInfo.HorizontalPositionAlignment
  then
    ATarget.HorizontalPositionAlignment :=
      ASourceMergedInfo.HorizontalPositionAlignment;

  if ATargetMergedInfo.VerticalPositionAlignment <> ASourceMergedInfo.VerticalPositionAlignment
  then
    ATarget.VerticalPositionAlignment :=
      ASourceMergedInfo.VerticalPositionAlignment;

  if ATargetMergedInfo.HorizontalPositionType <> ASourceMergedInfo.HorizontalPositionType
  then
    ATarget.HorizontalPositionType := ASourceMergedInfo.HorizontalPositionType;

  if ATargetMergedInfo.VerticalPositionType <> ASourceMergedInfo.VerticalPositionType
  then
  ...
  if ATargetMergedInfo.DropCapVerticalHeightInLines <> ASourceMergedInfo.DropCapVerticalHeightInLines
  then
    ATarget.DropCapVerticalHeightInLines :=
      ASourceMergedInfo.DropCapVerticalHeightInLines;

  if ATargetMergedInfo.LockFrameAnchorToParagraph <> ASourceMergedInfo.LockFrameAnchorToParagraph
  then
    ATarget.LockFrameAnchorToParagraph :=
      ASourceMergedInfo.LockFrameAnchorToParagraph;
end;
...
function TdxFrameProperties.SetVerticalPositionCore
  (const AInfo: TdxParagraphFrameFormattingBase; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.VerticalPosition := AValue;
  Result := TdxParagraphFrameFormattingChangeActionsCalculator.
    CalculateChangeActions(TdxParagraphFrameFormattingChangeType.
    VerticalPosition);
end;
...
function TdxFrameProperties.SetHorizontalPositionCore
  (const AInfo: TdxParagraphFrameFormattingBase; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.HorizontalPosition := AValue;
...
function TdxFrameProperties.SetHorizontalPaddingCore
  (const AInfo: TdxParagraphFrameFormattingBase; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.HorizontalPadding := AValue;
...
function TdxFrameProperties.SetVerticalPaddingCore
  (const AInfo: TdxParagraphFrameFormattingBase; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.VerticalPadding := AValue;
...
procedure TdxFrameProperties.SetHorizontalRule(const AValue
  : TdxParagraphFrameHorizontalRule);
begin
...
function TdxFrameProperties.SetHorizontalRuleCore
  (const AInfo: TdxParagraphFrameFormattingBase;
...
procedure TdxFrameProperties.SetTextWrapType(const AValue
  : TdxParagraphFrameTextWrapType);
begin
...
function TdxFrameProperties.SetTextWrapTypeCore(const AInfo
  : TdxParagraphFrameFormattingBase;
  const AValue: TdxParagraphFrameTextWrapType): TdxDocumentModelChangeActions;
begin
  AInfo.TextWrapType := AValue;
  Result := TdxParagraphFrameFormattingChangeActionsCalculator.
    CalculateChangeActions(TdxParagraphFrameFormattingChangeType.TextWrapType);
end;
...
function TdxFrameProperties.SetXCore(const AInfo
  : TdxParagraphFrameFormattingBase; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.X := AValue;
  Result := TdxParagraphFrameFormattingChangeActionsCalculator.
    CalculateChangeActions(TdxParagraphFrameFormattingChangeType.X);
end;
...
function TdxFrameProperties.SetYCore(const AInfo
  : TdxParagraphFrameFormattingBase; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.Y := AValue;
  Result := TdxParagraphFrameFormattingChangeActionsCalculator.
    CalculateChangeActions(TdxParagraphFrameFormattingChangeType.Y);
end;

function TdxFrameProperties.GetHorizontalPositionAlignment
  : TdxParagraphFrameHorizontalPositionAlignment;
begin
  Result := Info.HorizontalPositionAlignment;
end;

procedure TdxFrameProperties.SetHorizontalPositionAlignment
  (const AValue: TdxParagraphFrameHorizontalPositionAlignment);
begin
  if (Info.HorizontalPositionAlignment = AValue) and UseHorizontalPositionAlignment
  then
    Exit;
  SetPropertyValue<TdxParagraphFrameHorizontalPositionAlignment>
    (SetHorizontalPositionAlignmentCore, AValue);
...
function TdxFrameProperties.SetHorizontalPositionAlignmentCore
  (const AInfo: TdxParagraphFrameFormattingBase;
  const AValue: TdxParagraphFrameHorizontalPositionAlignment)
  : TdxDocumentModelChangeActions;
begin
...
function TdxFrameProperties.GetVerticalPositionAlignment
  : TdxParagraphFrameVerticalPositionAlignment;
begin
  Result := Info.VerticalPositionAlignment;
end;

procedure TdxFrameProperties.SetVerticalPositionAlignment
  (const AValue: TdxParagraphFrameVerticalPositionAlignment);
begin
  if (Info.VerticalPositionAlignment = AValue) and UseVerticalPositionAlignment
  then
    Exit;
  SetPropertyValue<TdxParagraphFrameVerticalPositionAlignment>
    (SetVerticalPositionAlignmentCore, AValue);
...
function TdxFrameProperties.SetVerticalPositionAlignmentCore
  (const AInfo: TdxParagraphFrameFormattingBase;
  const AValue: TdxParagraphFrameVerticalPositionAlignment)
  : TdxDocumentModelChangeActions;
begin
...
function TdxFrameProperties.GetHorizontalPositionType
  : TdxParagraphFrameHorizontalPositionType;
begin
  Result := Info.HorizontalPositionType;
end;

procedure TdxFrameProperties.SetHorizontalPositionType
  (const AValue: TdxParagraphFrameHorizontalPositionType);
begin
...
function TdxFrameProperties.SetHorizontalPositionTypeCore
  (const AInfo: TdxParagraphFrameFormattingBase;
  const AValue: TdxParagraphFrameHorizontalPositionType)
  : TdxDocumentModelChangeActions;
begin
...
function TdxFrameProperties.GetVerticalPositionType
  : TdxParagraphFrameVerticalPositionType;
begin
  Result := Info.VerticalPositionType;
end;

procedure TdxFrameProperties.SetVerticalPositionType(const AValue
  : TdxParagraphFrameVerticalPositionType);
begin
...
function TdxFrameProperties.SetVerticalPositionTypeCore
  (const AInfo: TdxParagraphFrameFormattingBase;
  const AValue: TdxParagraphFrameVerticalPositionType)
  : TdxDocumentModelChangeActions;
begin
...
function TdxFrameProperties.SetWidthCore(const AInfo
  : TdxParagraphFrameFormattingBase; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.Width := AValue;
  Result := TdxParagraphFrameFormattingChangeActionsCalculator.
    CalculateChangeActions(TdxParagraphFrameFormattingChangeType.Width);
end;
...
function TdxFrameProperties.SetHeightCore(const AInfo
  : TdxParagraphFrameFormattingBase; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.Height := AValue;
  Result := TdxParagraphFrameFormattingChangeActionsCalculator.
    CalculateChangeActions(TdxParagraphFrameFormattingChangeType.Height);
end;
...
procedure TdxFrameProperties.SetLockFrameAnchorToParagraph
  (const AValue: Boolean);
begin
  if (Info.LockFrameAnchorToParagraph = AValue) and UseLockFrameAnchorToParagraph
  then
    Exit;
  SetPropertyValue<Boolean>(SetLockFrameAnchorToParagraphCore, AValue);
end;
...
function TdxFrameProperties.SetLockFrameAnchorToParagraphCore
  (const AInfo: TdxParagraphFrameFormattingBase; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.LockFrameAnchorToParagraph := AValue;
  Result := TdxParagraphFrameFormattingChangeActionsCalculator.
...
function TdxFrameProperties.SetDropCapCore(const AInfo
  : TdxParagraphFrameFormattingBase; const AValue: TdxDropCapLocation)
  : TdxDocumentModelChangeActions;
begin
  AInfo.DropCap := AValue;
  Result := TdxParagraphFrameFormattingChangeActionsCalculator.
    CalculateChangeActions(TdxParagraphFrameFormattingChangeType.DropCap);
end;
...
procedure TdxFrameProperties.SetDropCapVerticalHeightInLines
  (const AValue: Integer);
begin
  if (Info.DropCapVerticalHeightInLines = AValue) and UseDropCapVerticalHeightInLines
  then
    Exit;
  SetPropertyValue<Integer>(SetDropCapVerticalHeightInLinesCore, AValue);
end;
...
function TdxFrameProperties.SetDropCapVerticalHeightInLinesCore
  (const AInfo: TdxParagraphFrameFormattingBase; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.DropCapVerticalHeightInLines := AValue;
...
function TdxFrameProperties.GetCache(const ADocumentModel
  : TdxCustomDocumentModel)
  : TdxUniqueItemsCache<TdxParagraphFrameFormattingBase>;
begin
  Result := TdxSimpleDocumentCache(ADocumentModel.Cache)
    .ParagraphFrameFormattingCache;
end;

function TdxFrameProperties.UseVal
  (AMask: TdxParagraphFrameFormattingOptions.TMask): Boolean;
begin
...
begin
  ...
  AEmptyInfo := GetCache(DocumentModel)
    [TdxParagraphFrameFormattingCache.EmptyParagraphFrameFormattingIndex];
...
procedure TdxFrameProperties.ResetUse(const AMask
  : TdxParagraphFrameFormattingOptions.TMasks);
var
  AInfo: TdxParagraphFrameFormattingBase;
  AOptions: TdxParagraphFrameFormattingOptions;
...
begin
  ChangeIndexCore(TdxParagraphFrameFormattingCache.
    DefaultParagraphFrameFormattingIndex, GetBatchUpdateChangeActions);
end;

function TdxFrameProperties.CanMerge(AProperties: TdxFrameProperties): Boolean;
begin
  Result := (TextWrapType = AProperties.TextWrapType) and
    (HorizontalPositionType = AProperties.HorizontalPositionType) and
    (VerticalPositionType = AProperties.VerticalPositionType) and
...
function TdxFrameProperties.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxParagraphFrameFormattingChangeActionsCalculator.
    CalculateChangeActions(TdxParagraphFrameFormattingChangeType.BatchUpdate);
end;
...
function TdxFrameProperties.CreateIndexChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
  Result := TdxIndexChangedHistoryItem.Create(DocumentModel.MainPart, Self);
end;

procedure TdxFrameProperties.CopyFrom(AFrameProperties
  : TdxMergedProperties<TdxParagraphFrameFormattingInfo,
  TdxParagraphFrameFormattingOptions>);
var
  AInfo: TdxParagraphFrameFormattingBase;
...
procedure TdxFrameProperties.CopyFrom(const Source
  : TdxParagraphFrameFormattingBase);
begin
...
procedure TdxFrameProperties.CopyFrom(const Source
  : TdxUndoableIndexBasedObject<TdxParagraphFrameFormattingBase>);
begin
  inherited CopyFrom(Source);
end;
{$ENDIF}

function TdxFrameProperties.GetObtainAffectedRangeListener
