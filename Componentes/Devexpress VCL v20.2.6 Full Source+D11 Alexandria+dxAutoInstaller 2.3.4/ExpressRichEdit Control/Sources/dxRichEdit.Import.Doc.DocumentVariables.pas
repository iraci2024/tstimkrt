...
type
  ...
  protected
    ...
    procedure GetVariables(AVariables: TdxDocumentVariableCollection;
      ADocumentProperties: TdxDocumentProperties);
  public
    constructor Create;
    destructor Destroy; override;
    class function FromStream(AReader: TBinaryReader; AOffset: Integer;
      ASize: Integer): TdxDocumentVariables; static;
    class function FromVariablesCollection(AVariables
      : TdxDocumentVariableCollection;
      ADocumentProperties: TdxDocumentProperties): TdxDocumentVariables; static;
    procedure Write(AWriter: TBinaryWriter);
    procedure SetVariables(AVariables: TdxDocumentVariableCollection;
      ADocumentProperties: TdxDocumentProperties);
...
class function TdxDocumentVariables.FromStream(AReader: TBinaryReader;
  AOffset: Integer; ASize: Integer): TdxDocumentVariables;
begin
  Result := TdxDocumentVariables.Create;
  Result.Read(AReader, AOffset, ASize);
end;

class function TdxDocumentVariables.FromVariablesCollection
...
procedure TdxDocumentVariables.Read(AReader: TBinaryReader; AOffset: Integer;
  ASize: Integer);
var
...
procedure TdxDocumentVariables.GetVariables(AVariables
  : TdxDocumentVariableCollection; ADocumentProperties: TdxDocumentProperties);
var
  AName: string;
  AValue: TValue;
...
begin
  ...
  begin
    AName := FNames[I];
    if AName <> TdxDocumentProperties.UpdateDocVariableFieldsBeforePrintDocVarName
    then
