...
function TdxEmptyTextFilterSkipFloatingObjects.IsRunVisible(const ARunIndex
  : TdxRunIndex): Boolean;
begin
...
function TdxVisibleTextFilterSkipFloatingObjects.IsRunVisible(const ARunIndex
  : TdxRunIndex): Boolean;
begin
  Result := (inherited IsRunVisible(ARunIndex)) and
    not(PieceTable.Runs[ARunIndex] is TdxFloatingObjectAnchorRun);
