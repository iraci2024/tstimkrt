...
type
  ...
  TdxDocumentLevelEndNotePropertiesDestination = class
  ...
  TdxSectionLevelEndNotePropertiesDestination = class
    (TdxFootNotePropertiesDestinationBase)
  protected
    function CreatePlacementDestination(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter): TdxDestination; override;
...
function TdxDocumentLevelEndNotePropertiesDestination.CreatePlacementDestination
...
function TdxDocumentLevelEndNotePropertiesDestination.
...
function TdxSectionLevelEndNotePropertiesDestination.CreatePlacementDestination
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter): TdxDestination;
begin
  Result := TdxFootNotePlacementDestination.Create(AImporter, FootNote,
    TdxFootNotePosition.EndOfDocument);
...
function TdxSectionLevelEndNotePropertiesDestination.
  CreateNumberingFormatDestination(AImporter
  : TdxRichEditDestinationAndXmlBasedImporter): TdxDestination;
begin
  Result := TdxFootNoteNumberingFormatDestination.Create(AImporter, FootNote,
...
class function TdxEndNotesDestination.CreateElementHandlerTable
...
class function TdxEndNotesDestination.OnFootNote
...
function TdxEndNoteDestination.RegisterNote(ANote: TdxFootNoteBase;
  const AId: string): Integer;
begin
  Result := TdxWordProcessingMLBaseImporter(Importer)
    .RegisterEndNote(TdxEndNote(ANote), AId);
end;

function TdxEndNoteDestination.OnFootNoteReference(AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := nil;
end;

function TdxEndNoteDestination.OnEndNoteReference(AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxEndNoteSelfReferenceDestination.Create(Importer,
    SelfReferenceRuns);
end;

{ TdxEndNoteReferenceDestination }

procedure TdxEndNoteReferenceDestination.ProcessElementOpen
...
constructor TdxEndNoteSelfReferenceDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  ASelfReferenceRuns: TdxFootNoteRunBaseList);
begin
...
procedure TdxEndNoteSelfReferenceDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
var
  ARun: TdxEndNoteRun;
begin
