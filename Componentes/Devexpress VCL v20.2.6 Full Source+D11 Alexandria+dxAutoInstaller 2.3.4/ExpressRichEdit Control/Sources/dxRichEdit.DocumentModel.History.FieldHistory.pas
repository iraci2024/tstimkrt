...
type
  ...
  public
    ...
    property CodeStartRunIndex: TdxRunIndex read FCodeStartRunIndex
      write FCodeStartRunIndex;
    property CodeEndRunIndex: TdxRunIndex read FCodeEndRunIndex
      write FCodeEndRunIndex;
    property ResultEndRunIndex: TdxRunIndex read FResultEndRunIndex
      write FResultEndRunIndex;
    property InsertedFieldIndex: Integer read FInsertedFieldIndex;
  end;
  ...
  public
    ...
    property RemovedFieldIndex: Integer read FRemovedFieldIndex
      write FRemovedFieldIndex;
  end;
...
procedure TdxRichEditFieldHistoryItem.SetAsParentForAllChildren
  (AField: TdxField);
var
...
procedure TdxRichEditFieldHistoryItem.RemoveParentFromAllChildren
...
begin
  ...
  TdxDocumentModelStructureChangedNotifier.NotifyFieldInserted(PieceTable,
    PieceTable, FInsertedFieldIndex);
end;
...
begin
  ...
  TdxDocumentModelStructureChangedNotifier.NotifyFieldRemoved(PieceTable,
    PieceTable, FInsertedFieldIndex);
...
begin
  ...
  DocumentModel.ApplyChanges(PieceTable, TdxDocumentModelChangeType.Fields,
...
begin
  ...
  try
    ...
    DocumentModel.ApplyChanges(PieceTable,
      TdxDocumentModelChangeType.Fields, 0, 0);
    TdxDocumentModelStructureChangedNotifier.NotifyFieldRemoved(PieceTable,
      PieceTable, FInsertedFieldIndex);
  finally
    ARemovedField.Free;
...
constructor TdxToggleFieldCodesHistoryItem.Create(const ADocumentModelPart
...
begin
  ...
  PieceTable.ApplyChanges(TdxDocumentModelChangeType.ToggleFieldCodes,
    AField.FirstRunIndex, AField.LastRunIndex);
end;

{ TdxToggleFieldLockedHistoryItem }

constructor TdxToggleFieldLockedHistoryItem.Create(const ADocumentModelPart
  : TdxCustomPieceTable; AFieldIndex: Integer);
begin
  inherited Create(ADocumentModelPart);
  FFieldIndex := AFieldIndex;
...
begin
  ...
  DocumentModel.ApplyChanges(PieceTable, TdxDocumentModelChangeType.Fields,
    FDeletedField.FirstRunIndex, FDeletedField.LastRunIndex);
  TdxDocumentModelStructureChangedNotifier.NotifyFieldInserted(PieceTable,
    PieceTable, FRemovedFieldIndex);
  FDeletedField := nil;
  FChildFields.Clear;
...
constructor TdxDisableUpdateChangedHistoryItem.Create(const ADocumentModelPart
  : TdxCustomPieceTable; AIndex: Integer);
begin
  inherited Create(ADocumentModelPart);
  FFieldIndex := AIndex;
end;
