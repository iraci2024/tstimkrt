...
type
  ...
  protected
    ...
    class function GetInsertObjectCommandClass
      : TdxRichEditCommandClass; virtual;
    ...
    property InsertObjectCommand: TdxRichEditCommand
      read GetInsertObjectCommand;
    property KeepLastParagraphMarkInSelection: Boolean
      read GetKeepLastParagraphMarkInSelection;
  public
  ...
  private
    function CalculateTableCellToAdjustIndex(AParagraph: TdxParagraph;
  ...
  TdxInsertParagraphIntoNonEmptyParagraphCoreCommand = class
    (TdxInsertParagraphCoreCommand)
  protected
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
  end;
  ...
  protected
    ...
    procedure OnTextInserted(APos: TdxDocumentLogPosition;
  ...
  protected
    ...
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
  public
    constructor Create(const AControl: IdxRichEditControl; const AText: string);
      reintroduce;
    class function GetDescription: string; override;
    class function GetMenuCaption: string; override;
  ...
  TdxInsertSectionBreakCoreCommand = class abstract
    (TdxInsertParagraphCoreCommand)
  protected
  ...
  TdxInsertSectionBreakNextPageCoreCommand = class
    (TdxInsertSectionBreakCoreCommand)
  protected
  ...
  TdxInsertSectionBreakOddPageCoreCommand = class
    (TdxInsertSectionBreakCoreCommand)
  protected
    function GetStartType: TdxSectionStartType; override;
  public
  ...
  TdxInsertSectionBreakEvenPageCoreCommand = class
    (TdxInsertSectionBreakCoreCommand)
  protected
    function GetStartType: TdxSectionStartType; override;
  public
  ...
  TdxInsertSectionBreakContinuousCoreCommand = class
    (TdxInsertSectionBreakCoreCommand)
  protected
    function GetStartType: TdxSectionStartType; override;
  public
  ...
  TdxInsertSectionBreakContinuousCommand = class
    (TdxTransactedInsertObjectCommand)
  protected
    function CreateInsertObjectCommand: TdxRichEditCommand; override;
  public
  ...
  TdxInsertSpecialCharacterCommandBase = class abstract
    (TdxInsertTextCoreBaseCommand)
  protected
    function GetInsertedText: string; override;
  ...
  TdxInsertNonBreakingSpaceCoreCommand = class
    (TdxInsertSpecialCharacterCommandBase)
  protected
    function GetCharacter: Char; override;
  public
  ...
  private
    ...
    function CalculateDeletedLength(AFirstDeletePos: TdxDocumentLogPosition;
  ...
  TdxInsertTabToParagraphCommand = class
  ...
  public
    constructor Create(const AControl: IdxRichEditControl;
      const ATab: TdxTabInfo); reintroduce;
  ...
  protected
    function ExecuteDialog(const AState: IdxCommandUIState): Boolean;
      virtual; abstract;
  public
  ...
  protected
    ...
    property ImportSource: TdxImportSource<TdxOfficeImageFormat,
      TdxOfficeImageReference> read FImportSource write FImportSource;
  public
    class function Id: TdxRichEditCommandId; override;
    procedure UpdateUIState(const AState: IdxCommandUIState); override;
  end;
  ...
  protected
    ...
    function CalculateImageScale(AImage: TdxOfficeImageReference)
      : Integer; overload;
  ...
  public
    destructor Destroy; override;
    class function CalculateImageScale(AImage: TdxOfficeImageReference;
      const APos: TdxDocumentLayoutPosition): Integer; overload; static;
    class function GetImageName: string; override;
    class function GetDescription: string; override;
    class function GetMenuCaption: string; override;
  end;
  ...
  IdxInsertSymbolCommandUIState = interface
    (IdxValueBasedCommandUIState<TdxSymbolProperties>)
    ['{1FD259EE-E981-4B66-93AA-D03A4BE384F0}']
  end;

  { TdxInsertSymbolCommandUIState }

  TdxInsertSymbolCommandUIState = class(TdxDefaultCommandUIState,
    IdxInsertSymbolCommandUIState, IdxCommandUIState)
  private
...
class function TdxTransactedInsertObjectCommand.GetInsertObjectCommandClass
...
begin
  if GetKeepLastParagraphMarkInSelection then
    ACommand := TdxDeleteSelectionKeepLastParagraphCommand.Create
      (RichEditControl)
  else
...
function TdxTransactedInsertObjectCommand.CreateInsertObjectCommand
  : TdxRichEditCommand;
begin
...
function TdxTransactedInsertObjectCommand.GetExecutionMode
...
function TdxTransactedInsertObjectCommand.GetInsertObjectCommand
  : TdxRichEditCommand;
begin
...
function TdxTransactedInsertObjectCommand.
  GetKeepLastParagraphMarkInSelection: Boolean;
begin
  Result := True;
end;

procedure TdxTransactedInsertObjectCommand.UpdateUIState
...
function TdxTransactedInsertObjectCommand.GetUpdateUIStateMode
...
class function TdxInsertTextCommand.GetInsertObjectCommandClass
  : TdxRichEditCommandClass;
begin
...
class function TdxInsertParagraphCommand.GetInsertObjectCommandClass
  : TdxRichEditCommandClass;
begin
...
begin
  if AllowAutoCorrect then
    ActivePieceTable.ApplyChangesCore
      ([TdxDocumentModelChangeAction.ApplyAutoCorrect], -1, -1);
  ...
  if (AInputPosition <> nil) and (DocumentModel.Selection.Length = 0) then
    AParagraph := ActivePieceTable.InsertParagraph(AInputPosition, APos,
      GetForceVisible)
  else
  ...
  begin
    ...
    if (ANextParagraphStyle <> nil) and (ANextParagraphStyle <> AParagraphStyle)
    then
    begin
      ANewParagraph.ParagraphProperties.ResetAllUse;
      ANewParagraph.ParagraphStyleIndex := DocumentModel.ParagraphStyles.IndexOf
        (ANextParagraphStyle);
    end;
  end;
  ...
  begin
    DocumentModel.Selection.ActiveSelection.Start :=
      DocumentModel.Selection.ActiveSelection.Start - 1;
    DocumentModel.Selection.ActiveSelection.&End :=
      DocumentModel.Selection.ActiveSelection.&End - 1;
    TdxParagraph(AParagraph).PieceTable.ChangeCellStartParagraphIndex(ACell,
      AParagraph.Index + 1);
...
procedure TdxInsertParagraphCoreCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  inherited UpdateUIStateCore(AState);
  ApplyCommandRestrictionOnEditableControl(AState,
    DocumentModel.DocumentCapabilities.Paragraphs, AState.Enabled);
...
begin
  ...
  if (AParentCell <> nil) and
    (AParentCell.StartParagraphIndex = Result.StartParagraphIndex) then
    Exit;
  ...
  if (APrevParagraphCell.Table <> Result.Table) and
    (APrevParagraphCell.Table.NestedLevel = Result.Table.NestedLevel) then
    Exit;
...
class function TdxInsertLineBreakCommand.GetInsertObjectCommandClass
  : TdxRichEditCommandClass;
begin
...
procedure TdxInsertBreakCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
begin
  ApplyCommandRestrictionOnEditableControl(AState,
...
begin
  ...
  try
    ...
    if ASectionIndex >= 0 then
      DocumentModel.Sections[ASectionIndex].GeneralSettings.StartType :=
        StartType;
  finally
    ASplitTable.Free;
  end;
...
procedure TdxInsertSectionBreakCoreCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  inherited UpdateUIStateCore(AState);
...
function TdxInsertSectionBreakNextPageCoreCommand.GetStartType
  : TdxSectionStartType;
begin
...
class function TdxInsertSectionBreakNextPageCommand.GetInsertObjectCommandClass
  : TdxRichEditCommandClass;
begin
  Result := TdxInsertSectionBreakNextPageCoreCommand;
end;

function TdxInsertSectionBreakNextPageCommand.CreateInsertObjectCommand
  : TdxRichEditCommand;
begin
...
function TdxInsertSectionBreakOddPageCoreCommand.GetStartType
  : TdxSectionStartType;
begin
...
class function TdxInsertSectionBreakOddPageCommand.GetInsertObjectCommandClass
  : TdxRichEditCommandClass;
begin
  Result := TdxInsertSectionBreakOddPageCoreCommand;
end;

function TdxInsertSectionBreakOddPageCommand.CreateInsertObjectCommand
  : TdxRichEditCommand;
begin
...
function TdxInsertSectionBreakEvenPageCoreCommand.GetStartType
  : TdxSectionStartType;
begin
...
class function TdxInsertSectionBreakEvenPageCommand.GetInsertObjectCommandClass
  : TdxRichEditCommandClass;
begin
  Result := TdxInsertSectionBreakEvenPageCoreCommand;
end;

function TdxInsertSectionBreakEvenPageCommand.CreateInsertObjectCommand
  : TdxRichEditCommand;
begin
...
class function TdxInsertSectionBreakContinuousCoreCommand.
...
function TdxInsertSectionBreakContinuousCoreCommand.GetStartType
  : TdxSectionStartType;
begin
...
function TdxInsertSectionBreakContinuousCommand.CreateInsertObjectCommand
  : TdxRichEditCommand;
begin
...
begin
  Commands.Add(TdxInsertParagraphIntoNonEmptyParagraphCoreCommand.Create
    (RichEditControl));
  inherited CreateInsertObjectCommands;
end;

class function TdxInsertPageBreakCommand.GetInsertObjectCommandClass
  : TdxRichEditCommandClass;
begin
...
procedure TdxInsertPageBreakCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  inherited UpdateUIStateCore(AState);
  if AState.Enabled then
...
procedure TdxInsertPageBreakCoreCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  inherited UpdateUIStateCore(AState);
  if AState.Enabled then
...
function TdxInsertNonBreakingSpaceCommand.CreateInsertObjectCommand
  : TdxRichEditCommand;
begin
...
procedure TdxInsertColumnBreakCoreCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  inherited UpdateUIStateCore(AState);
  if AState.Enabled then
...
class function TdxInsertColumnBreakCommand.GetInsertObjectCommandClass
  : TdxRichEditCommandClass;
begin
...
function TdxInsertColumnBreakCommand.CreateInsertObjectCommand
  : TdxRichEditCommand;
begin
  Result := TdxInsertColumnBreakCoreCommand.Create(RichEditControl);
end;

procedure TdxInsertColumnBreakCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  inherited UpdateUIStateCore(AState);
  if AState.Enabled then
...
procedure TdxInsertParagraphIntoNonEmptyParagraphCoreCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
var
...
function TdxInsertObjectCommandBase.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := IsContentEditable and CanEditSelection;
end;

function TdxInsertObjectCommandBase.ChangePosition
...
function TdxInsertObjectCommandBase.
...
begin
  ...
  begin
    ...
    ActivePieceTable.InsertText(DocumentModel.Selection.&End, AInsertedText,
      AForceVisible);
...
begin
  if not ActivePieceTable.Runs[DocumentModel.Selection.Interval.&End.RunIndex].CanPlaceCaretBefore
  then
    Exit;
  if AllowAutoCorrect then
    ActivePieceTable.ApplyChangesCore
...
procedure TdxInsertTextCoreBaseCommand.OnTextInserted
  (APos: TdxDocumentLogPosition; ALength: Integer);
begin
end;

{ TdxInsertTextCoreCommand }

constructor TdxInsertTextCoreCommand.Create(const AControl: IdxRichEditControl;
  const AText: string);
begin
...
procedure TdxInsertTextCoreCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
begin
  inherited UpdateUIStateCore(AState);
  if AState.Enabled then
...
class function TdxOvertypeTextCommand.GetInsertObjectCommandClass
  : TdxRichEditCommandClass;
begin
...
function TdxOvertypeTextCoreCommand.CalculateDeletedLength(AFirstDeletePos
  : TdxDocumentLogPosition; ALength: Integer): Integer;
var
  ...
  ARun: TdxTextRunBase;
begin
  AStartPos := TdxPositionConverter.ToDocumentModelPosition(ActivePieceTable,
    AFirstDeletePos);
...
begin
  ...
  Result := DocumentModel.ActivePieceTable.CanEditRangeLength(AStart,
    ADeletedLength);
end;
...
begin
  ...
  if ADeleteLength > 0 then
    ActivePieceTable.DeleteContent(APos + ALength, ADeleteLength, False, False,
      False, True, False);
end;

{ TdxInsertTabToParagraphCommand }

constructor TdxInsertTabToParagraphCommand.Create(const AControl
  : IdxRichEditControl; const ATab: TdxTabInfo);
begin
  inherited Create(AControl);
  FTab := ATab;
end;
...
function TdxInsertTabToParagraphCommand.ChangeProperty(const AStart,
...
function TdxInsertTabToParagraphCommand.CalculateStartPosition
  (AItem: TdxSelectionItem; AAllowSelectionExpanding: Boolean)
  : TdxDocumentModelPosition;
begin
  Result := TdxDocumentModelPosition.FromParagraphStart(AItem.PieceTable,
    AItem.GetStartParagraphIndex);
end;

function TdxInsertTabToParagraphCommand.CalculateEndPosition
  (AItem: TdxSelectionItem; AAllowSelectionExpanding: Boolean)
  : TdxDocumentModelPosition;
begin
  Result := TdxDocumentModelPosition.FromParagraphEnd(AItem.PieceTable,
    AItem.GetEndParagraphIndex);
end;

procedure TdxInsertTabToParagraphCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  ApplyCommandRestrictionOnEditableControl(AState,
...
class function TdxInsertPictureCommand.GetInsertObjectCommandClass
  : TdxRichEditCommandClass;
begin
  Result := TdxInsertPictureCoreCommand;
end;

function TdxInsertPictureCommand.ExecuteDialog(const AState
  : IdxCommandUIState): Boolean;
var
...
begin
  ...
  try
    FImportSource := AImportHelper.InvokeImportDialog(Control,
...
procedure TdxInsertPictureCommand.ForceExecuteCore(const AState
  : IdxCommandUIState);
var
...
procedure TdxInsertPictureCommand.UpdateUIState(const AState
  : IdxCommandUIState);
begin
  inherited UpdateUIState(AState);
  ApplyCommandRestrictionOnEditableControl(AState,
    Options.DocumentCapabilities.InlinePictures, AState.Enabled);
  ApplyDocumentProtectionToSelectedCharacters(AState);
end;
...
begin
  ...
  if not APos.PieceTable.IsMain then
    AColumnBounds.Height := Max(AColumnBounds.Height,
      APos.Page.ClientBounds.Height div 3);
  AImageSize := AImage.Image.SizeInTwips;
  AScaleX := 100 * AUnitConverter.ToModelUnits(AColumnBounds.Width)
    div Max(1, AImageSize.cx);
  AScaleY := 100 * AUnitConverter.ToModelUnits(AColumnBounds.Height)
    div Max(1, AImageSize.cy);
...
function TdxInsertPictureCoreCommand.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
...
begin
  ...
  ActivePieceTable.InsertInlinePicture(DocumentModel.Selection.&End, FImage,
    AScale, AScale, GetForceVisible);
end;
...
function TdxInsertSymbolCoreCommand.CreateDefaultCommandUIState
  : IdxCommandUIState;
begin
  Result := TdxInsertSymbolCommandUIState.Create;
end;

procedure TdxInsertSymbolCoreCommand.ForceExecute(const AState
  : IdxCommandUIState);
var
...
procedure TdxInsertSymbolCoreCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
var
  AValueState: TdxInsertSymbolCommandUIState;
begin
...
class function TdxInsertSymbolCommand.GetInsertObjectCommandClass
  : TdxRichEditCommandClass;
begin
...
procedure TdxInsertSymbolCommandUIState.SetValue(const Value
  : TdxSymbolProperties);
begin
  FValue := Value;
end;
