...
uses
  Types, Classes, SysUtils, Graphics, Windows, Generics.Defaults,
...
type
  ...
  IdxRtfExportHelper = interface
    ...
    function GetCharacterStylesCollectionIndex
      : TdxNamedOrdinalDictionary<Integer>;
    ...
    function GetParagraphStylesCollectionIndex
      : TdxNamedOrdinalDictionary<Integer>;
    ...
    property CharacterStylesCollectionIndex: TdxNamedOrdinalDictionary<Integer>
      read GetCharacterStylesCollectionIndex;
    property ColorCollection: TdxAlphaColorList read GetColorCollection;
    property DefaultCharacterProperties: string
      read GetDefaultCharacterProperties write SetDefaultCharacterProperties;
    property DefaultFontIndex: Integer read GetDefaultFontIndex;
    property DefaultParagraphProperties: string
      read GetDefaultParagraphProperties write SetDefaultParagraphProperties;
    ...
    property ListCollection: TDictionary<Integer, string>
      read GetListCollection;
    property ListOverrideCollection: TdxStringList
      read GetListOverrideCollection;
    property ListOverrideCollectionIndex: TdxIntegersDictionary
      read GetListOverrideCollectionIndex;
    property ParagraphStylesCollectionIndex: TdxNamedOrdinalDictionary<Integer>
      read GetParagraphStylesCollectionIndex;
    property StylesCollection: TdxStringList read GetStylesCollection;
    property SupportStyle: Boolean read GetSupportStyle;
    property TableStylesCollectionIndex: TdxNamedOrdinalDictionary<Integer>
      read GetTableStylesCollectionIndex;
  ...
  protected
    ...
    procedure WriteWidthUnit(AUnit: TdxWidthUnitInfo;
      const ATypeKeyword, AValueKeyword: string;
      AWriteValueAnyway: Boolean = False);
    procedure WriteWidthUnitInTwips(AUnit: TdxWidthUnitInfo;
      const ATypeKeyword, AValueKeyword: string);
  public
  ...
  private
    function CalcRtfFirstLineIndent(AFirstLineIndentType
      : TdxParagraphFirstLineIndent; AFirstLineIndent: Integer): Integer;
    function CalcRtfLeftIndent(AFirstLineIndentType
      : TdxParagraphFirstLineIndent;
      AFirstLineIndent, ALeftIndent: Integer): Integer;
  ...
  protected
    ...
    procedure WriteParagraphIndents(AMergedParagraphProperties
      : TdxMergedParagraphProperties);
    procedure WriteParagraphSuppressHyphenation(AParagraphSuppressHyphenation
      : Boolean);
    procedure WriteParagraphSuppressLineNumbers(AParagraphSuppressLineNumbers
      : Boolean);
    ...
    procedure WriteParagraphLineSpacing(AParagraphLineSpacingType
      : TdxParagraphLineSpacing; AParagraphLineSpacing: Single);
    procedure WriteParagraphSpacingBefore(ASpacingBefore: Integer);
    procedure WriteParagraphSpacingAfter(ASpacingAfter: Integer);
    procedure WriteRtfLineSpacing(ARtfLineSpacingValue, ARtfLineSpacingMultiple
      : Integer);
    ...
    procedure WriteParagraphTableProperties(AParagraph: TdxParagraph;
      ANestingLevel: Integer);
    procedure WriteTabPosition(APosition: Integer);

    procedure WriteParagraphBorder(ATopBorder: TdxBorderInfo;
      const ACommand: string);
    procedure WriteFrameProperties(AProperties: TdxFrameProperties);
    procedure WriteParagraphVerticalPositionType(APositionType
      : TdxParagraphFrameVerticalPositionType);
    procedure WriteParagraphHorizontalPositionType(APositionType
      : TdxParagraphFrameHorizontalPositionType);
    procedure WriteParagraphWrapType(AWrapType
      : TdxParagraphFrameTextWrapType); virtual;
  public
    procedure ExportParagraphPropertiesCore(AProperties
      : TdxMergedParagraphProperties; ACheckDefaultAlignment: Boolean = False);
    procedure ExportParagraphProperties(AParagraph: TdxParagraph;
...
{$REGION 'DefaultUnderlineTypes'}
    DefaultUnderlineTypes: array [TdxUnderlineType] of string = ('',
      TdxRtfExportSR.FontUnderline, TdxRtfExportSR.FontUnderlineDotted,
      TdxRtfExportSR.FontUnderlineDashed,
      TdxRtfExportSR.FontUnderlineDashDotted,
      TdxRtfExportSR.FontUnderlineDashDotDotted,
      TdxRtfExportSR.FontUnderlineDouble, TdxRtfExportSR.FontUnderlineHeavyWave,
...
{$ENDREGION}
  ...
  protected
    procedure ExportCharacterProperties(ACharacterProperties
      : TdxMergedCharacterProperties; ACheckDefaultColor: Boolean = False;
      ACheckUseFontSize: Boolean = False; ACheckUseFontName: Boolean = False);
    procedure ExportCharacterPropertiesCore(ACharacterProperties
      : TdxMergedCharacterProperties; ACheckUseFontSize, ACheckUseFontName
      : Boolean);
    procedure ExportParagraphCharacterProperties(ACharacterProperties
      : TdxMergedCharacterProperties);

    procedure RegisterFontCharset(AInfo: TdxCharacterFormattingInfo;
    ...
    procedure WriteForegroundColor(AForeColor: TdxAlphaColor;
      ACheckDefaultColor: Boolean = False);
    procedure WriteForegroundColorCore(AForeColor: TdxAlphaColor;
      ACheckDefaultColor: Boolean = False);
    procedure WriteUnderlineColor(AUnderlineColor: TdxAlphaColor);
  public
    constructor Create(ADocumentModel: TdxDocumentModel;
      const ARtfExportHelper: IdxRtfExportHelper; ARtfBuilder: TdxRtfBuilder;
      const AOptions: TdxRtfDocumentExporterOptions);
  end;
  ...
  protected
    ...
    property TableCellMarginsBottomType: string
      read GetTableCellMarginsBottomType;
    property TableCellMarginsBottom: string read GetTableCellMarginsBottom;
    property TableCellMarginsRightType: string
      read GetTableCellMarginsRightType;
  ...
  public
    ...
    procedure WriteTableBorders(ATopBorder, ALeftBorder, ABottomBorder,
      ARightBorder, AInnerHorizontalBorder, AInnerVerticalBorder
      : TdxBorderInfo);
    ...
    procedure WriteTableCellMargins(ALeftMargin, ARightMargin, ABottomMargin,
      ATopMargin: TdxWidthUnitInfo);
    procedure WriteTableLook(AValue: TdxTableLookTypes);
    procedure WriteTableIndent(ATableIndent: TdxWidthUnitInfo);
    procedure WriteTableFloatingPosition(AFloatingPosition
  ...
  protected
    ...
    procedure ExportTableProperties(AMergedTableProperties
      : TdxMergedTableProperties; AExportRowBand: Boolean;
      AExportColBand: Boolean);
  ...
  protected
    ...
    property TableCellTextTopAlignment: string
      read GetTableCellTextTopAlignment;
    property TableCellTextCenterAlignment: string
      read GetTableCellTextCenterAlignment;
    property TableCellTextBottomAlignment: string
      read GetTableCellTextBottomAlignment;
    property TableCellUpperLeftToLowerRightBorder: string
      read GetTableCellUpperLeftToLowerRightBorder;
    property TableCellUpperRightToLowerLeftBorder: string
      read GetTableCellUpperRightToLowerLeftBorder;
  ...
  public
    ...
    procedure WriteCellBackgroundColor(AColor: TdxAlphaColor;
      ATable: TdxTable = nil); overload;
    ...
    procedure WriteCellVerticalMerging(AValue: TdxMergingState;
      ADefaultValue: TdxMergingState);
    procedure WriteCellVerticalAlignment(AVerticalAlignment
      : TdxVerticalAlignment);
    procedure WriteCellTextDirection(AValue: TdxTextDirection);
    procedure WriteCellBasicBorders(ATopBorder, ALeftBorder, ARightBorder,
      ABottomBorder: TdxBorderInfo); virtual;
    procedure WriteCellPreferredWidth(APreferredWidth: TdxWidthUnitInfo);
    procedure WriteCellMargins(ACell: TdxTableCell); overload;
    procedure WriteCellMargins(ATopMargin, ALeftMargin, ARightMargin,
      ABottomMargin: TdxWidthUnitInfo); overload;
    ...
    procedure WriteCellForegroundColor(AColor: TdxAlphaColor;
      ATable: TdxTable); overload;
  ...
  TdxRtfTableStyleTableCellPropertiesExporter = class
    (TdxRtfTableCellPropertiesExporter)
  protected
  ...
  public
    procedure WriteCellBasicBorders(ATopBorder: TdxBorderInfo;
      ALeftBorder: TdxBorderInfo; ARightBorder: TdxBorderInfo;
      ABottomBorder: TdxBorderInfo); override;
  end;
  ...
  strict private
    ...
    FDocumentModel: TdxDocumentModel;
    function ObtainStyleIndex(const AStyle: IdxStyle;
  ...
  protected
    procedure ExportCharacterProperties(const ACharacterProperties
      : TdxMergedCharacterProperties);
    procedure ExportCharacterStyle(AStyle: TdxCharacterStyle);
    procedure ExportParagraphStyle(AStyle: TdxParagraphStyle; I: Integer);
    procedure ExportParagraphStyles(AParagraphStyles
      : TdxParagraphStyleCollection);
    procedure ExportParagraphProperties(AParagraphProperties
      : TdxParagraphProperties;
      AMergedParagraphProperties: TdxMergedParagraphProperties);
    procedure ExportCharacterStyles(ACharacterStyles
      : TdxCharacterStyleCollection);
    procedure ExportTableCellProperties(ATableCellProperties
      : TdxTableCellProperties;
      AMergedTableCellProperties: TdxMergedTableCellProperties);
    procedure ExportTableConditionalStyle(AConditionalStyle
      : TdxTableConditionalStyle; const AStyleName: string;
      AStyleIndex: Integer);
    procedure ExportTableProperties(ATableProperties: TdxTableProperties;
      AMergedTableProperties: TdxMergedTableProperties;
      AExportRowProperties, AExportColProperties: Boolean);
    procedure ExportTableRowProperties(ATableRowProperties
    ...
    procedure WriteConditionalStyleType(AConditionType
      : TdxConditionalTableStyleFormattingType);
  ...
  public
    ...
    property RtfBuilder: TdxRtfBuilder read FRtfBuilder;
    property RtfExportHelper: IdxRtfExportHelper read FRtfExportHelper;
    property CharacterExporter: TdxRtfCharacterPropertiesExporter
      read FCharacterPropertiesExporter;
    property DocumentModel: TdxDocumentModel read FDocumentModel;
  end;
  ...
  strict private
    ...
    FTextLength: Integer;
  private
    function GetAbstractNumberingLists(ANumberingLists
      : TdxNumberingListCollection; AStartIndex: TdxNumberingListIndex;
      ACount: Integer): TdxAbstractNumberingListCollection;
  protected
    procedure ExportAbstractNumberingList
      (AList: TdxAbstractNumberingList); virtual;
    procedure ExportListLevels(AListLevelCollection
      : TdxListLevelCollection); virtual;
    procedure ExportListLevel(const AListLevel: IdxListLevel);
    function GetNumberingListFormat(ANumberingFormat
      : TdxNumberingFormat): Integer;
    function GetListLevelSeparator(ASeparator: Char): Integer;
    procedure ExportListLevelTextAndNumber(const ADisplayFormatString: string;
      ALevelTemplateId: Integer); virtual;
    procedure GetTextAndNumber(const ADisplayFormatString: string);
    function AddLevelNumber(const ADisplayFormatString: string;
      I: Integer): Integer;
    function AddLevelNumberCore(const ADisplayFormatString: string;
      I: Integer): Integer;
    class function DoubleBrackets(const ADisplayFormatString: string;
      I: Integer): Boolean;
    function AddChar(ACh: Char; I: Integer): Integer;
    function AddEscapedChar(ACh: Char; I: Integer): Integer;
    procedure ExportListLevelCharacterAndParagraphProperties(const AListLevel
      : IdxListLevel);
    procedure ExportAbstractListLevelParagraphStyleIndex(AAbstractListLevel
      : TdxListLevel);
  ...
  public
    ...
    procedure Export(ANumberingLists: TdxNumberingListCollection;
      AStartIndex, ACount: Integer);
    procedure ExportNumberingListTable(AAbstractNumberingLists
      : TdxAbstractNumberingListCollection); virtual;
    procedure ExportAbstractNumberingLists(AAbstractNumberingLists
      : TdxAbstractNumberingListCollection); virtual;
    procedure ExportListOverrideTable(ANumberingLists
      : TdxNumberingListCollection; AStartIndex: TdxNumberingListIndex;
      ACount: Integer); overload; virtual;
    procedure ExportListOverrideTable(ANumberingLists
      : TdxNumberingListCollection); overload; virtual;
...
{$IFDEF DELPHIXE2}
    ConditionalStylesTypes
      : array [TdxConditionalTableStyleFormattingType.BottomLeftCell ..
      TdxConditionalTableStyleFormattingType.FirstRow] of string = (
{$ELSE}
    ConditionalStylesTypes
      : array [Ord(TdxConditionalTableStyleFormattingType.BottomLeftCell)
      .. Ord(TdxConditionalTableStyleFormattingType.FirstRow)] of string = (
{$ENDIF}
...
{$IFDEF DELPHIXE2}
    BorderLineStyles: array
      [TdxBorderLineStyle.&Nil .. TdxBorderLineStyle.Inset] of string = (
{$ELSE}
    BorderLineStyles: array [Ord(TdxBorderLineStyle.&Nil)
      .. Ord(TdxBorderLineStyle.Inset)] of string = (
{$ENDIF}
      TdxRtfExportSR.NoBorder, TdxRtfExportSR.BorderNone,
      TdxRtfExportSR.BorderSingle, '', TdxRtfExportSR.BorderDouble,
      TdxRtfExportSR.BorderDotted, TdxRtfExportSR.BorderDashed,
      TdxRtfExportSR.BorderDotDashed, TdxRtfExportSR.BorderDotDotDashed,
      TdxRtfExportSR.BorderTriple, TdxRtfExportSR.BorderThinThickSmall,
      ...
      TdxRtfExportSR.BorderThinThickLarge, TdxRtfExportSR.BorderThickThinLarge,
      TdxRtfExportSR.BorderThinThickThinLarge, TdxRtfExportSR.BorderWavy,
      TdxRtfExportSR.BorderDoubleWavy, TdxRtfExportSR.BorderDashedSmall,
      TdxRtfExportSR.BorderDashDotStroked, TdxRtfExportSR.BorderThreeDEmboss,
      TdxRtfExportSR.BorderThreeDEngrave, TdxRtfExportSR.BorderOutset,
...
{$ENDREGION}
  ...
  class var
    ...
    FSectionFootNoteNumberingTypes
      : TdxEnumeratedDictionary<TdxNumberingFormat, string>;
    FSectionEndNoteNumberingTypes
      : TdxEnumeratedDictionary<TdxNumberingFormat, string>;
    FFootNoteNumberingTypes
      : TdxEnumeratedDictionary<TdxNumberingFormat, string>;
    ...
    class function CreateChapterSeparatorTypesTable
      : TdxCharStringDictionary; static;
    class function CreatePageNumberingTypesTable
      : TdxEnumeratedDictionary<TdxNumberingFormat, string>; static;
    class function CreateSectionFootNoteNumberingTypesTable
      : TdxEnumeratedDictionary<TdxNumberingFormat, string>; static;
    class function CreateSectionEndNoteNumberingTypesTable
      : TdxEnumeratedDictionary<TdxNumberingFormat, string>; static;
    class function CreateFootNoteNumberingTypesTable
      : TdxEnumeratedDictionary<TdxNumberingFormat, string>; static;
    class function CreateEndNoteNumberingTypesTable
      : TdxEnumeratedDictionary<TdxNumberingFormat, string>; static;
    class function CreatePredefinedUserGroups
      : TDictionary<Integer, string>; static;
  strict private
    ...
    FCharacterPropertiesExporter: TdxRtfCharacterPropertiesExporter;
    FOptions: TdxRtfDocumentExporterOptions;
    FGetMergedCharacterPropertiesCachedResult
      : TdxRunMergedCharacterPropertiesCachedResult;
    function CalculateFirstExportedNumberingListsIndex(ANumberingLists
      : TdxNumberingListCollection): Integer;
    function CalculateFirstExportedNumberingListsIndexForStyles
      (AParagraphStyleCollection: TdxParagraphStyleCollection): Integer;
    function CalculateFirstExportedNumberingListsIndexForNumberingListStyles
      (ANumberingListStyleCollection: TdxNumberingListStyleCollection)
  ...
  protected
    class function ConditionalStylesTypesTryGetValue
      (AKey: TdxConditionalTableStyleFormattingType; var AResult: string)
      : Boolean; static; inline;
    class function BorderLineStylesTryGetValue(AKey: TdxBorderLineStyle;
    ...
    function CreateNumberingListExporter(AExporter: TdxRtfContentExporter)
      : TdxRtfNumberingListExporter;

    function CreateRtfBuilder: TdxRtfBuilder; virtual;
    function CreateParagraphPropertiesExporter
      : TdxRtfParagraphPropertiesExporter; virtual;
    ...
    procedure PopulateUserList(APieceTable: TdxPieceTable;
      AUsers: TdxStringList); virtual;
    procedure StartNewParagraph(AParagraph: TdxParagraph;
      ATableNestingLevel: Integer);
    procedure StartNewInnerParagraph(AParagraph: TdxParagraph;
      ATableNestingLevel: Integer);
    ...
    procedure WriteEnumValueCommand<T>(ATable: TDictionary<T, string>;
      const AValue: T; const ADefaultCommand: string); overload;
    procedure WriteEnumValueCommand<T>
      (ATable: TdxEnumeratedDictionary<T, string>; const AValue: T;
      const ADefaultCommand: string); overload;
    ...
    procedure ExportRangePermissionStart(ARangePermission
      : TdxRangePermission); override;
    procedure ExportRangePermissionEnd(ARangePermission
      : TdxRangePermission); override;
    function GenerateRangePermissionData(ARangePermission
      : TdxRangePermission): string;
    function IntToShortString(AValue: Integer): string;

    procedure ExportFloatingObjectAnchorRun
      (ARun: TdxFloatingObjectAnchorRun); override;
    procedure ExportShapeInstanceProperties(AFloatingObjectProperties
      : TdxFloatingObjectProperties; ARotation: Integer);
    procedure ExportFloatingObjectShape(AShape: TdxShape);
    procedure ExportFloatingObjectHorizontalPositionAlignment
      (AFloatingObjectProperties: TdxFloatingObjectProperties);
    procedure ExportFloatingObjectHorizontalPositionTypeProperty
      (AFloatingObjectProperties: TdxFloatingObjectProperties);
    procedure ExportFloatingObjectVerticalPositionAlignment
      (AFloatingObjectProperties: TdxFloatingObjectProperties);
    procedure ExportFloatingObjectVerticalPositionTypeProperty
      (AFloatingObjectProperties: TdxFloatingObjectProperties);
    procedure ExportFloatingObjectLayoutInTableCell(AFloatingObjectProperties
      : TdxFloatingObjectProperties);
    procedure ExportFloatingObjectAllowOverlap(AFloatingObjectProperties
      : TdxFloatingObjectProperties);
    procedure ExportFloatingObjectLockAspectRatio(AFloatingObjectProperties
      : TdxFloatingObjectProperties);
    procedure ExportFloatingObjectHidden(AFloatingObjectProperties
      : TdxFloatingObjectProperties);
    procedure ExportFloatingObjectBehindDocument(AFloatingObjectProperties
      : TdxFloatingObjectProperties);
    procedure ExportFloatingObjectLeftDistance(AFloatingObjectProperties
      : TdxFloatingObjectProperties);
    procedure ExportFloatingObjectRightDistance(AFloatingObjectProperties
      : TdxFloatingObjectProperties);
    procedure ExportFloatingObjectTopDistance(AFloatingObjectProperties
      : TdxFloatingObjectProperties);
    procedure ExportFloatingObjectBottomDistance(AFloatingObjectProperties
      : TdxFloatingObjectProperties);
    procedure ExportFloatingObjectRelativeSize(AFloatingObjectProperties
      : TdxFloatingObjectProperties);
    procedure ExportPicture(ARun: TdxFloatingObjectAnchorRun;
      AContent: TdxPictureFloatingObjectContent);
    procedure ExportTextBoxContent(ARun: TdxFloatingObjectAnchorRun;
      AContent: TdxTextBoxFloatingObjectContent);
    procedure ExportFloatingObjectTextWrapType(AFloatingObjectProperties
      : TdxFloatingObjectProperties);
    procedure ExportFloatingObjectHorizontalPositionType
      (AFloatingObjectProperties: TdxFloatingObjectProperties);
    procedure ExportFloatingObjectVerticalPositionType(AFloatingObjectProperties
      : TdxFloatingObjectProperties);
    procedure ExportTextBoxProperties(AProperties: TdxTextBoxProperties);
    procedure ExportFloatingObjectRotation(AShape: TdxShape);

    procedure ExportFootNoteRunCore(ARun: TdxFootNoteRunBase;
      const ASuffixKeyword: string);
    ...
    procedure ExportPageBackground(ADocumentProperties
      : TdxDocumentProperties); virtual;
    ...
    function ShouldExportDocumentProtectionPasswordHashInWord2007Format
      : Boolean; virtual;
    ...
    procedure ExportSectionGeneralSettings
      (ASettings: TdxSectionGeneralSettings);
    procedure ExportSectionPageNumbering(APageNumbering
      : TdxSectionPageNumbering);
    procedure ExportSectionLineNumbering(ALineNumbering
    ...
    procedure ExportSectionColumn(AColumn: TdxColumnInfo;
      AColumnIndex: Integer);
    procedure ExportLegacyPageProperties(ASection: TdxSection;
      ASectionCount: Integer);
    function ExportParagraph(AParagraph: TdxParagraph)
      : TdxParagraphIndex; override;
    procedure ExportSingleParagraph(AParagraph: TdxParagraph);
    procedure ExportParagraphTableStyleProperties
  ...
  public
    ...
    procedure ExportFirstPageHeader(ASectionHeader: TdxSectionHeader;
      ALinkedToPrevious: Boolean); override;
    procedure ExportOddPageHeader(ASectionHeader: TdxSectionHeader;
      ALinkedToPrevious: Boolean); override;
    procedure ExportEvenPageHeader(ASectionHeader: TdxSectionHeader;
      ALinkedToPrevious: Boolean); override;
    procedure ExportFirstPageFooter(ASectionFooter: TdxSectionFooter;
      ALinkedToPrevious: Boolean); override;
    procedure ExportOddPageFooter(ASectionFooter: TdxSectionFooter;
      ALinkedToPrevious: Boolean); override;
    procedure ExportEvenPageFooter(ASectionFooter: TdxSectionFooter;
      ALinkedToPrevious: Boolean); override;

    procedure ExportParagraphCore(AParagraph: TdxParagraph;
      ATableNestingLevel: Integer;
      ACondTypes: TdxConditionalTableStyleFormattingTypes;
      ATableStyleIndex: Integer);
    ...
    class property ChapterSeparatorTypes: TdxCharStringDictionary
      read FChapterSeparatorTypes;
    class property PageNumberingTypes
      : TdxEnumeratedDictionary<TdxNumberingFormat, string>
      read FPageNumberingTypes;
    class property SectionFootNoteNumberingTypes
      : TdxEnumeratedDictionary<TdxNumberingFormat, string>
      read FSectionFootNoteNumberingTypes;
    class property SectionEndNoteNumberingTypes
      : TdxEnumeratedDictionary<TdxNumberingFormat, string>
      read FSectionEndNoteNumberingTypes;
    class property FootNoteNumberingTypes
      : TdxEnumeratedDictionary<TdxNumberingFormat, string>
      read FFootNoteNumberingTypes;
    class property EndNoteNumberingTypes
      : TdxEnumeratedDictionary<TdxNumberingFormat, string>
      read FEndNoteNumberingTypes;
    class property PredefinedUserGroups: TDictionary<Integer, string>
      read FPredefinedUserGroups;
  ...
  class var
    ...
    class constructor Initialize;
    class destructor Finalize;
    class procedure AddHexToMarkTable(ATable: TdxCharStringDictionary;
      ACh: Char);
  ...
  protected
    procedure AppendUnicodeCompatibleCharCore(ACode: Integer;
      ACh: Char); virtual;
    ...
    procedure WriteTextDirect(const AText: string;
      AMakeStringUnicodeCompatible: Boolean = False);
    procedure WriteTextCore(const AText: string;
    ...
    procedure WriteByteArrayAsHex(ABuffer: TBytes; AOffset: Integer = 0;
      ALength: Integer = -1);
    ...
    class property SpecialPCDataMarks: TdxCharStringDictionary
      read FSpecialPCDataMarks;
  public
    ...
    procedure WriteShapeBoolProperty(const APropertyName: string;
      APropertyValue: Boolean);
    procedure WriteShapeIntegerProperty(const APropertyName: string;
      APropertyValue: Integer);
    procedure WriteShapeColorProperty(const APropertyName: string;
  ...
  protected
    function CreateContentExporter(ADocumentModel: TdxDocumentModel;
      ...
      : TdxRtfContentExporter; virtual;

    function CalculateFontNameEncoding(const AFontName: string;
      AFontIndex: Integer): TEncoding;
    function EscapeFontName(const AFontName: string;
    ...
    procedure ExportFontTableEntry(const AFontName: string;
      AFontIndex: Integer);
  ...
  public
    constructor Create(ADocumentModel: TdxCustomDocumentModel;
      const AOptions: IdxExporterOptions); override;
    destructor Destroy; override;
    ...
    property LastParagraphRunNotSelected: Boolean
      read GetLastParagraphRunNotSelected write SetLastParagraphRunNotSelected;
    property KeepFieldCodeViewState: Boolean read GetKeepFieldCodeViewState
      write SetKeepFieldCodeViewState;
  end;
...
{$REGION 'LineStyles'}
    LineStyles: array [0 .. 163] of TdxBorderLineStyle =
      (TdxBorderLineStyle.Apples, TdxBorderLineStyle.ArchedScallops,
      TdxBorderLineStyle.BabyPacifier, TdxBorderLineStyle.BabyRattle,
      TdxBorderLineStyle.Balloons3Colors, TdxBorderLineStyle.BalloonsHotAir,
      TdxBorderLineStyle.BasicBlackDashes, TdxBorderLineStyle.BasicBlackDots,
      TdxBorderLineStyle.BasicBlackSquares, TdxBorderLineStyle.BasicThinLines,
      TdxBorderLineStyle.BasicWhiteDashes, TdxBorderLineStyle.BasicWhiteDots,
      TdxBorderLineStyle.BasicWhiteSquares, TdxBorderLineStyle.BasicWideInline,
      TdxBorderLineStyle.BasicWideMidline, TdxBorderLineStyle.BasicWideOutline,
      TdxBorderLineStyle.Bats, TdxBorderLineStyle.Birds,
      TdxBorderLineStyle.BirdsFlight, TdxBorderLineStyle.Cabins,
      TdxBorderLineStyle.CakeSlice, TdxBorderLineStyle.CandyCorn,
      TdxBorderLineStyle.CelticKnotwork, TdxBorderLineStyle.CertificateBanner,
      TdxBorderLineStyle.ChainLink, TdxBorderLineStyle.ChampagneBottle,
      TdxBorderLineStyle.CheckedBarBlack, TdxBorderLineStyle.CheckedBarColor,
      TdxBorderLineStyle.Checkered, TdxBorderLineStyle.ChristmasTree,
      TdxBorderLineStyle.CirclesLines, TdxBorderLineStyle.CirclesRectangles,
      TdxBorderLineStyle.ClassicalWave, TdxBorderLineStyle.Clocks,
      TdxBorderLineStyle.Compass, TdxBorderLineStyle.Confetti,
      TdxBorderLineStyle.ConfettiGrays, TdxBorderLineStyle.ConfettiOutline,
      TdxBorderLineStyle.ConfettiStreamers, TdxBorderLineStyle.ConfettiWhite,
      TdxBorderLineStyle.CornerTriangles, TdxBorderLineStyle.CouponCutoutDashes,
      TdxBorderLineStyle.CouponCutoutDots, TdxBorderLineStyle.CrazyMaze,
      TdxBorderLineStyle.CreaturesButterfly, TdxBorderLineStyle.CreaturesFish,
      TdxBorderLineStyle.CreaturesInsects, TdxBorderLineStyle.CreaturesLadyBug,
      TdxBorderLineStyle.CrossStitch, TdxBorderLineStyle.Cup,
      TdxBorderLineStyle.DecoArch, TdxBorderLineStyle.DecoArchColor,
      TdxBorderLineStyle.DecoBlocks, TdxBorderLineStyle.DiamondsGray,
      TdxBorderLineStyle.DoubleD, TdxBorderLineStyle.DoubleDiamonds,
      TdxBorderLineStyle.Earth1, TdxBorderLineStyle.Earth2,
      TdxBorderLineStyle.EclipsingSquares1,
      TdxBorderLineStyle.EclipsingSquares2, TdxBorderLineStyle.EggsBlack,
      TdxBorderLineStyle.Fans, TdxBorderLineStyle.Film,
      TdxBorderLineStyle.Firecrackers, TdxBorderLineStyle.FlowersBlockPrint,
      TdxBorderLineStyle.FlowersDaisies, TdxBorderLineStyle.FlowersModern1,
      TdxBorderLineStyle.FlowersModern2, TdxBorderLineStyle.FlowersPansy,
      TdxBorderLineStyle.FlowersRedRose, TdxBorderLineStyle.FlowersRoses,
      TdxBorderLineStyle.FlowersTeacup, TdxBorderLineStyle.FlowersTiny,
      TdxBorderLineStyle.Gems, TdxBorderLineStyle.GingerbreadMan,
      TdxBorderLineStyle.Gradient, TdxBorderLineStyle.Handmade1,
      TdxBorderLineStyle.Handmade2, TdxBorderLineStyle.HeartBalloon,
      TdxBorderLineStyle.HeartGray, TdxBorderLineStyle.Hearts,
      TdxBorderLineStyle.HeebieJeebies, TdxBorderLineStyle.Holly,
      TdxBorderLineStyle.HouseFunky, TdxBorderLineStyle.Hypnotic,
      TdxBorderLineStyle.IceCreamCones, TdxBorderLineStyle.LightBulb,
      TdxBorderLineStyle.Lightning1, TdxBorderLineStyle.Lightning2,
      TdxBorderLineStyle.MapPins, TdxBorderLineStyle.MapleLeaf,
      TdxBorderLineStyle.MapleMuffins, TdxBorderLineStyle.Marquee,
      TdxBorderLineStyle.MarqueeToothed, TdxBorderLineStyle.Moons,
      TdxBorderLineStyle.Mosaic, TdxBorderLineStyle.MusicNotes,
      TdxBorderLineStyle.Northwest, TdxBorderLineStyle.Ovals,
      TdxBorderLineStyle.Packages, TdxBorderLineStyle.PalmsBlack,
      TdxBorderLineStyle.PalmsColor, TdxBorderLineStyle.PaperClips,
      TdxBorderLineStyle.Papyrus, TdxBorderLineStyle.PartyFavor,
      TdxBorderLineStyle.PartyGlass, TdxBorderLineStyle.Pencils,
      TdxBorderLineStyle.People, TdxBorderLineStyle.PeopleWaving,
      TdxBorderLineStyle.PeopleHats, TdxBorderLineStyle.Poinsettias,
      TdxBorderLineStyle.PostageStamp, TdxBorderLineStyle.Pumpkin1,
      TdxBorderLineStyle.PushPinNote2, TdxBorderLineStyle.PushPinNote1,
      TdxBorderLineStyle.Pyramids, TdxBorderLineStyle.PyramidsAbove,
      TdxBorderLineStyle.Quadrants, TdxBorderLineStyle.Rings,
      TdxBorderLineStyle.Safari, TdxBorderLineStyle.Sawtooth,
      TdxBorderLineStyle.SawtoothGray, TdxBorderLineStyle.ScaredCat,
      TdxBorderLineStyle.Seattle, TdxBorderLineStyle.ShadowedSquares,
      TdxBorderLineStyle.SharksTeeth, TdxBorderLineStyle.ShorebirdTracks,
      TdxBorderLineStyle.Skyrocket, TdxBorderLineStyle.SnowflakeFancy,
      TdxBorderLineStyle.Snowflakes, TdxBorderLineStyle.Sombrero,
      TdxBorderLineStyle.Southwest, TdxBorderLineStyle.Stars,
      TdxBorderLineStyle.StarsTop, TdxBorderLineStyle.Stars3d,
      TdxBorderLineStyle.StarsBlack, TdxBorderLineStyle.StarsShadowed,
      TdxBorderLineStyle.Sun, TdxBorderLineStyle.Swirligig,
      TdxBorderLineStyle.TornPaper, TdxBorderLineStyle.TornPaperBlack,
      TdxBorderLineStyle.Trees, TdxBorderLineStyle.TriangleParty,
      TdxBorderLineStyle.Triangles, TdxBorderLineStyle.Tribal1,
      TdxBorderLineStyle.Tribal2, TdxBorderLineStyle.Tribal3,
      TdxBorderLineStyle.Tribal4, TdxBorderLineStyle.Tribal5,
      TdxBorderLineStyle.Tribal6, TdxBorderLineStyle.TwistedLines1,
      TdxBorderLineStyle.TwistedLines2, TdxBorderLineStyle.Vine,
      TdxBorderLineStyle.Waveline, TdxBorderLineStyle.WeavingAngles,
      TdxBorderLineStyle.WeavingBraid, TdxBorderLineStyle.WeavingRibbon,
      TdxBorderLineStyle.WeavingStrips, TdxBorderLineStyle.WhiteFlowers,
      TdxBorderLineStyle.Woodwork, TdxBorderLineStyle.XIllusions,
      TdxBorderLineStyle.ZanyTriangles, TdxBorderLineStyle.ZigZag,
      TdxBorderLineStyle.ZigZagStitch);
{$ENDREGION}
  public
    class function GetBorderArtIndex(ABorderLineStyle: TdxBorderLineStyle)
      : Integer; static; inline;
    class function GetBorderLineStyle(ABorderArtIndex: Integer)
      : TdxBorderLineStyle; static; inline;
  end;
  ...
  public
    constructor Create(ARtfBuilder: TdxRtfBuilder;
      const ARun: IdxPictureContainerRun);
    class function CreateRtfPictureExporter(ARtfBuilder: TdxRtfBuilder;
      const ARun: IdxPictureContainerRun; AImageFormat: TdxOfficeImageFormat)
      : TdxRtfPictureExporter;
    procedure Export;
  end;
  ...
  public
    ...
    function GetExporter(ADocumentModel: TdxCustomDocumentModel;
      const AOptions: IdxExporterOptions)
      : TdxCustomDocumentModelExporter; override;
...
type
  TdxRtfDocumentExporterCompatibilityOptionsAccess = class
  ...
  protected
    procedure ExportShapePicturePrefix(ARtfBuilder: TdxRtfBuilder);
      virtual; abstract;
    procedure ExportShapePicturePostfix(ARtfBuilder: TdxRtfBuilder);
      virtual; abstract;
    procedure ExportNonShapePicturePrefix(ARtfBuilder: TdxRtfBuilder);
      virtual; abstract;
    procedure ExportNonShapePicturePostfix(ARtfBuilder: TdxRtfBuilder);
      virtual; abstract;
  public
    procedure Export(ARtfBuilder: TdxRtfBuilder;
      const ARun: IdxPictureContainerRun; ADuplicateObjectAsMetafile: Boolean);
  end;
...
procedure TdxRtfPictureExportStrategy.Export(ARtfBuilder: TdxRtfBuilder;
  const ARun: IdxPictureContainerRun; ADuplicateObjectAsMetafile: Boolean);
var
...
begin
  ...
  begin
    ...
    AExporter := TdxRtfPictureExporter.CreateRtfPictureExporter(ARtfBuilder,
      ARun, AFormat);
    try
      AExporter.Export;
      ExportShapePicturePostfix(ARtfBuilder);
      if ADuplicateObjectAsMetafile and
        ARun.PictureContent.Image.CanGetImageBytes(TdxOfficeImageFormat.Wmf)
      then
      begin
        AWmfExporter := TdxRtfPictureExporter.CreateRtfPictureExporter
          (ARtfBuilder, ARun, TdxOfficeImageFormat.Wmf);
        try
  ...
  begin
    AWmfExporter := TdxRtfPictureExporter.CreateRtfPictureExporter(ARtfBuilder,
      ARun, TdxOfficeImageFormat.Wmf);
    try
      if AWmfExporter <> nil then
        AWmfExporter.Export;
    finally
...
procedure TdxRtfFloatingObjectPictureExportStrategy.ExportShapePicturePrefix
...
procedure TdxRtfFloatingObjectPictureExportStrategy.ExportShapePicturePostfix
  (ARtfBuilder: TdxRtfBuilder);
begin
...
procedure TdxRtfFloatingObjectPictureExportStrategy.ExportNonShapePicturePrefix
  (ARtfBuilder: TdxRtfBuilder);
begin
  ARtfBuilder.OpenGroup;
...
procedure TdxRtfFloatingObjectPictureExportStrategy.ExportNonShapePicturePostfix
  (ARtfBuilder: TdxRtfBuilder);
begin
  ARtfBuilder.CloseGroup;
end;
...
procedure TdxRtfInlinePictureExportStrategy.ExportShapePicturePrefix
  (ARtfBuilder: TdxRtfBuilder);
begin
  ARtfBuilder.OpenGroup;
...
procedure TdxRtfInlinePictureExportStrategy.ExportShapePicturePostfix
  (ARtfBuilder: TdxRtfBuilder);
begin
  ARtfBuilder.CloseGroup;
end;

procedure TdxRtfInlinePictureExportStrategy.ExportNonShapePicturePrefix
  (ARtfBuilder: TdxRtfBuilder);
begin
  ARtfBuilder.OpenGroup;
...
procedure TdxRtfInlinePictureExportStrategy.ExportNonShapePicturePostfix
  (ARtfBuilder: TdxRtfBuilder);
begin
  ARtfBuilder.CloseGroup;
end;
...
class function TdxRtfPictureExporter.CreateRtfPictureExporter
  (ARtfBuilder: TdxRtfBuilder; const ARun: IdxPictureContainerRun;
...
begin
  if not ARun.PictureContent.Image.IsExportSupported(AImageFormat) then
    Result := nil
  else if AImageFormat = TdxOfficeImageFormat.Wmf then
    Result := TdxRtfWmfPictureExporter.Create(ARtfBuilder, ARun)
  else if AImageFormat = TdxOfficeImageFormat.Emf then
    Result := TdxRtfEmfPictureExporter.Create(ARtfBuilder, ARun)
  else if AImageFormat = TdxOfficeImageFormat.Jpeg then
...
begin
  ...
  RtfBuilder.WriteCommand(TdxRtfExportSR.PictureWidth,
    Math.Max(APirctureSize.cx, 1));
  RtfBuilder.WriteCommand(TdxRtfExportSR.PictureHeight,
    Math.Max(APirctureSize.cy, 1));

  RtfBuilder.WriteCommand(TdxRtfExportSR.PictureDesiredWidth,
    Math.Max(ADesiredPictureSize.cx, 1));
  RtfBuilder.WriteCommand(TdxRtfExportSR.PictureDesiredHeight,
    Math.Max(ADesiredPictureSize.cy, 1));

  RtfBuilder.WriteCommand(TdxRtfExportSR.PictureScaleX,
    Math.Max(Round(APictureScale.cx), 1));
  RtfBuilder.WriteCommand(TdxRtfExportSR.PictureScaleY,
    Math.Max(Round(APictureScale.cy), 1));
...
begin
  Result := UnitConverter.ModelUnitsToHundredthsOfMillimeter
    (Run.PictureContent.OriginalSize);
end;
...
class function TdxRtfArtBorderConverter.GetBorderArtIndex(ABorderLineStyle
  : TdxBorderLineStyle): Integer;
begin
  if ABorderLineStyle
    in [TdxBorderLineStyle.Apples .. TdxBorderLineStyle.ZigZagStitch] then
    Result := Ord(ABorderLineStyle) - Ord(TdxBorderLineStyle.Apples) + 1
  else
    Result := 0;
end;

class function TdxRtfArtBorderConverter.GetBorderLineStyle(ABorderArtIndex
  : Integer): TdxBorderLineStyle;
begin
  Dec(ABorderArtIndex);
  if (ABorderArtIndex >= Low(LineStyles)) and
    (ABorderArtIndex <= High(LineStyles)) then
...
begin
  ...
  FContentExporter := CreateContentExporter(DocumentModel, AOptions,
    RtfExportHelper);
...
begin
  ...
  if not RtfExportHelper.FontCharsetTable.TryGetValue(AFontIndex, AFontCharset)
  then
    AFontCharset := -1;
  ...
  if FContentExporter.Options.ActualEncoding.CanBeLosslesslyEncoded(AFontName)
  then
...
begin
  Result := TdxRtfContentExporter.Create(ADocumentModel, AOptions,
    ARtfExportHelper);
end;
...
begin
  ...
  begin
    ...
    RtfBuilder.WriteCommand(TdxRtfExportSR.ColorGreen,
      TdxAlphaColors.G(AColor));
...
begin
  ...
  RtfBuilder.WriteCommand(TdxRtfExportSR.DefaultFontIndex,
    RtfExportHelper.DefaultFontIndex);
...
begin
  ...
  AUpdateDocVariablesBeforePrint :=
    ContentExporter.DocumentModel.DocumentProperties.
    UpdateDocVariablesBeforePrint;
  if (AVariables.Count = 0) and
    (AUpdateDocVariablesBeforePrint = TdxUpdateDocVariablesBeforePrint.Auto)
  then
    Exit;
  ...
  if AUpdateDocVariablesBeforePrint <> TdxUpdateDocVariablesBeforePrint.Auto
  then
  begin
    RtfBuilder.OpenGroup;
    RtfBuilder.WriteCommand(TdxRtfExportSR.DocumentVariable);
    ...
    RtfBuilder.OpenGroup;
    RtfBuilder.WriteText
      (TdxDocumentProperties.UpdateDocVariableFieldsBeforePrintDocVarName);
    RtfBuilder.CloseGroup;

    RtfBuilder.OpenGroup;
    RtfBuilder.WritePCData(ContentExporter.DocumentModel.DocumentProperties.
      GetUpdateFieldsBeforePrintDocVarValue);
    RtfBuilder.CloseGroup;
...
begin
  ...
  begin
    ...
    if AFontCharset = 0 then
      if not RtfExportHelper.FontCharsetTable.TryGetValue(AFontIndex,
        AFontCharset) then
        AFontCharset := 0;
  ...
  if { (AEncoding = ContentExporter.Options.ActualEncoding) or } TdxEncoding.
    ASCII.CanBeLosslesslyEncoded(S) then
...
function TdxRtfExporter.EscapeSpecialCharacters(const AFontName
  : string): string;
var
...
begin
  ...
  begin
    ...
    begin
      FFontNameStringBuilder.Clear;
      if I > 0 then
        FFontNameStringBuilder.Append(TdxStringHelper.Substring(AFontName,
          0, I - 1));
...
function TdxRtfContentExporter.
  CalculateFirstExportedNumberingListsIndexForNumberingListStyles
  (ANumberingListStyleCollection: TdxNumberingListStyleCollection)
  : TdxNumberingListIndex;
var
...
function TdxRtfContentExporter.
  CalculateFirstExportedNumberingListsIndexForStyles(AParagraphStyleCollection
  : TdxParagraphStyleCollection): Integer;
var
  I: Integer;
...
class function TdxRtfContentExporter.ConditionalStylesTypesTryGetValue
  (AKey: TdxConditionalTableStyleFormattingType; var AResult: string): Boolean;
begin
{$IFDEF DELPHIXE2}
  if AKey in [TdxConditionalTableStyleFormattingType.BottomLeftCell ..
    TdxConditionalTableStyleFormattingType.FirstRow] then
    AResult := ConditionalStylesTypes[AKey]
{$ELSE}
  if Ord(AKey) in [Ord(TdxConditionalTableStyleFormattingType.BottomLeftCell)
    .. Ord(TdxConditionalTableStyleFormattingType.FirstRow)] then
...
begin
  ...
  FCharacterPropertiesExporter := TdxRtfCharacterPropertiesExporter.Create
    (ADocumentModel, ARtfExportHelper, RtfBuilder, FOptions);
  FGetMergedCharacterPropertiesCachedResult :=
    TdxRunMergedCharacterPropertiesCachedResult.Create;
end;

class function TdxRtfContentExporter.CreateChapterSeparatorTypesTable
  : TdxCharStringDictionary;
begin
  Result := TdxCharStringDictionary.Create;
  Result.Add(TdxCharacters.Hyphen,
    TdxRtfExportSR.SectionChapterSeparatorHyphen);
  Result.Add('.', TdxRtfExportSR.SectionChapterSeparatorPeriod);
  Result.Add(':', TdxRtfExportSR.SectionChapterSeparatorColon);
  Result.Add(TdxCharacters.EmDash,
    TdxRtfExportSR.SectionChapterSeparatorEmDash);
  Result.Add(TdxCharacters.EnDash,
    TdxRtfExportSR.SectionChapterSeparatorEnDash);
end;

class function TdxRtfContentExporter.CreateEndNoteNumberingTypesTable
  : TdxEnumeratedDictionary<TdxNumberingFormat, string>;
begin
  Result := TdxEnumeratedDictionary<TdxNumberingFormat, string>.Create;
  Result.Add(TdxNumberingFormat.Decimal,
    TdxRtfExportSR.EndNoteNumberingFormatDecimal);
  Result.Add(TdxNumberingFormat.UpperRoman,
    TdxRtfExportSR.EndNoteNumberingFormatUpperRoman);
  Result.Add(TdxNumberingFormat.LowerRoman,
    TdxRtfExportSR.EndNoteNumberingFormatLowerRoman);
  Result.Add(TdxNumberingFormat.UpperLetter,
    TdxRtfExportSR.EndNoteNumberingFormatUpperLetter);
  Result.Add(TdxNumberingFormat.LowerLetter,
    TdxRtfExportSR.EndNoteNumberingFormatLowerLetter);
  Result.Add(TdxNumberingFormat.Chicago,
    TdxRtfExportSR.EndNoteNumberingFormatChicago);
  Result.Add(TdxNumberingFormat.Chosung,
    TdxRtfExportSR.EndNoteNumberingFormatChosung);
  Result.Add(TdxNumberingFormat.DecimalEnclosedCircle,
    TdxRtfExportSR.EndNoteNumberingFormatDecimalEnclosedCircle);
  Result.Add(TdxNumberingFormat.DecimalFullWidth,
    TdxRtfExportSR.EndNoteNumberingFormatDecimalFullWidth);
  Result.Add(TdxNumberingFormat.Ganada,
    TdxRtfExportSR.EndNoteNumberingFormatGanada);
end;

class function TdxRtfContentExporter.CreateFootNoteNumberingTypesTable
  : TdxEnumeratedDictionary<TdxNumberingFormat, string>;
begin
  Result := TdxEnumeratedDictionary<TdxNumberingFormat, string>.Create;
  Result.Add(TdxNumberingFormat.Decimal,
    TdxRtfExportSR.FootNoteNumberingFormatDecimal);
  Result.Add(TdxNumberingFormat.UpperRoman,
    TdxRtfExportSR.FootNoteNumberingFormatUpperRoman);
  Result.Add(TdxNumberingFormat.LowerRoman,
    TdxRtfExportSR.FootNoteNumberingFormatLowerRoman);
  Result.Add(TdxNumberingFormat.UpperLetter,
    TdxRtfExportSR.FootNoteNumberingFormatUpperLetter);
  Result.Add(TdxNumberingFormat.LowerLetter,
    TdxRtfExportSR.FootNoteNumberingFormatLowerLetter);
  Result.Add(TdxNumberingFormat.Chicago,
    TdxRtfExportSR.FootNoteNumberingFormatChicago);
  Result.Add(TdxNumberingFormat.Chosung,
    TdxRtfExportSR.FootNoteNumberingFormatChosung);
  Result.Add(TdxNumberingFormat.DecimalEnclosedCircle,
    TdxRtfExportSR.FootNoteNumberingFormatDecimalEnclosedCircle);
  Result.Add(TdxNumberingFormat.DecimalFullWidth,
    TdxRtfExportSR.FootNoteNumberingFormatDecimalFullWidth);
  Result.Add(TdxNumberingFormat.Ganada,
    TdxRtfExportSR.FootNoteNumberingFormatGanada);
end;
...
procedure TdxRtfContentExporter.ExportFirstPageHeader(ASectionHeader
  : TdxSectionHeader; ALinkedToPrevious: Boolean);
begin
...
procedure TdxRtfContentExporter.ExportOddPageHeader(ASectionHeader
  : TdxSectionHeader; ALinkedToPrevious: Boolean);
begin
  if ALinkedToPrevious then
    Exit;
...
procedure TdxRtfContentExporter.ExportEvenPageHeader(ASectionHeader
  : TdxSectionHeader; ALinkedToPrevious: Boolean);
begin
  if ALinkedToPrevious then
    Exit;
...
procedure TdxRtfContentExporter.ExportFirstPageFooter(ASectionFooter
  : TdxSectionFooter; ALinkedToPrevious: Boolean);
begin
  if ALinkedToPrevious then
    Exit;
  if not DocumentModel.DocumentCapabilities.HeadersFootersAllowed then
...
procedure TdxRtfContentExporter.ExportOddPageFooter(ASectionFooter
  : TdxSectionFooter; ALinkedToPrevious: Boolean);
begin
  if ALinkedToPrevious then
    Exit;
...
procedure TdxRtfContentExporter.ExportEvenPageFooter(ASectionFooter
  : TdxSectionFooter; ALinkedToPrevious: Boolean);
begin
  if ALinkedToPrevious then
    Exit;
...
begin
  if RtfExportHelper.DefaultCharacterProperties <> '' then
    Exit;
  RtfBuilder.Clear;
  ACharacterPropertiesExporter := TdxRtfCharacterPropertiesExporter.Create
    (DocumentModel, RtfExportHelper, RtfBuilder, FOptions);
  try
    ACharacterFormatting := DocumentModel.DefaultCharacterProperties.Info;
    if not TdxAlphaColors.IsTransparentOrEmpty(ACharacterFormatting.ForeColor)
      and (ACharacterFormatting.ForeColor <> TdxAlphaColors.Black) then
      RtfExportHelper.GetColorIndex(TdxAlphaColors.Black);

    EnsureValidFirstColor(ACharacterFormatting.ForeColor);
    AMergedCharacterProperties := TdxMergedCharacterProperties.Create
      (ACharacterFormatting.Info, ACharacterFormatting.Options);
    try
      ACharacterPropertiesExporter.ExportCharacterProperties
        (AMergedCharacterProperties, True, False, False);
      RtfExportHelper.DefaultCharacterProperties :=
        RtfBuilder.RtfContent.ToString;
    finally
...
begin
  if RtfExportHelper.DefaultParagraphProperties <> '' then
    Exit;
  RtfBuilder.Clear;
  AParagraphPropertiesExporter := TdxRtfParagraphPropertiesExporter.Create
    (DocumentModel, RtfExportHelper, RtfBuilder);
  try
    AParagraphFormatting := DocumentModel.DefaultParagraphProperties.Info;
    AMergedParagraphProperties := TdxMergedParagraphProperties.Create
      (AParagraphFormatting.Info, AParagraphFormatting.Options);
    try
      AParagraphPropertiesExporter.ExportParagraphPropertiesCore
        (AMergedParagraphProperties, True);
      RtfExportHelper.DefaultParagraphProperties :=
        RtfBuilder.RtfContent.ToString;
    finally
...
begin
  ...
  if ADocumentProperties.DefaultTabWidth <> ADefaultDocumentInfo.DefaultTabWidth
  then
    RtfBuilder.WriteCommand(TdxRtfExportSR.DefaultTabWidth,
      UnitConverter.ModelUnitsToTwips(ADocumentProperties.DefaultTabWidth));
  if ADocumentProperties.HyphenateDocument <> TdxDocumentInfo.HyphenateDocumentDefaultValue
  then
  begin
  ...
  if ADocumentProperties.DifferentOddAndEvenPages <> ADefaultDocumentInfo.DifferentOddAndEvenPages
  then
  ...
  if not TdxAlphaColors.IsTransparentOrEmpty(ADocumentProperties.PageBackColor)
  then
...
begin
  ACharacterProperties := ARun.GetMergedCharacterProperties
    (FGetMergedCharacterPropertiesCachedResult);
  try
    AShouldExportCharacterProperties :=
      TdxInlinePictureRun.ShouldExportInlinePictureRunCharacterProperties
      (ACharacterProperties.Info, ACharacterProperties.Options);
    if AShouldExportCharacterProperties then
    begin
      RtfBuilder.OpenGroup;
      FCharacterPropertiesExporter.ExportCharacterProperties
        (ACharacterProperties);
    end;
  finally
  end;
  AExportStrategy := TdxRtfInlinePictureExportStrategy.Create;
  try
    AExportStrategy.Export(FRtfBuilder, ARun,
      FOptions.Compatibility.DuplicateObjectAsMetafile);
  finally
...
begin
  ...
  try
    ...
    AStartIndex := Min(AStartIndex,
      CalculateFirstExportedNumberingListsIndexForStyles
      (DocumentModel.ParagraphStyles));
    AStartIndex := Min(AStartIndex,
      CalculateFirstExportedNumberingListsIndexForNumberingListStyles
      (DocumentModel.NumberingListStyles));
...
function TdxRtfContentExporter.ExportParagraph(AParagraph: TdxParagraph)
  : TdxParagraphIndex;
var
...
begin
  ...
  AProperties := ARun.GetMergedCharacterProperties
    (FGetMergedCharacterPropertiesCachedResult);
  try
    FCharacterPropertiesExporter.ExportParagraphCharacterProperties
      (AProperties);
  finally
  end;
end;
...
begin
  ...
  for ACondType := Low(TdxConditionalTableStyleFormattingType)
    to High(TdxConditionalTableStyleFormattingType) do
  begin
    if (ACondType in ACondTypes) and ConditionalStylesTypesTryGetValue
      (ACondType, AKeyWord) then
      RtfBuilder.WriteCommand(AKeyWord);
  end;
  RtfBuilder.WriteCommand(TdxRtfExportSR.TableStyleCellIndex, ATableStyleIndex);
end;

function TdxRtfContentExporter.ExportRtfTable(ATable: TdxTable)
  : TdxParagraphIndex;
var
...
begin
  ...
  RtfBuilder.WriteCommand(TdxRtfExportSR.SectionColumnWidth,
    UnitConverter.ModelUnitsToTwips(AColumn.Width));
  RtfBuilder.WriteCommand(TdxRtfExportSR.SectionColumnSpace,
    UnitConverter.ModelUnitsToTwips(AColumn.Space));
end;

procedure TdxRtfContentExporter.ExportLegacyPageProperties(ASection: TdxSection;
  ASectionCount: Integer);
var
...
begin
  ...
  if ASection.Page.Width <> ADefaultPage.Width then
    FRtfBuilder.WriteCommand(TdxRtfExportSR.LegacyPaperWidth,
      UnitConverter.ModelUnitsToTwips(ASection.Page.Width));
  if ASection.Page.Height <> ADefaultPage.Height then
    FRtfBuilder.WriteCommand(TdxRtfExportSR.LegacyPaperHeight,
      UnitConverter.ModelUnitsToTwips(ASection.Page.Height));
  if (ASection.Page.PaperKind <> ADefaultPage.PaperKind) and
    (ASection.Page.PaperKind <> TdxPaperKind.Custom) then
    FRtfBuilder.WriteCommand(TdxRtfExportSR.PaperKind,
      Integer(ASection.Page.PaperKind));
  ...
  if not ASection.PageNumbering.ContinueNumbering then
    FRtfBuilder.WriteCommand(TdxRtfExportSR.LegacyPageNumberingStart,
      ASection.PageNumbering.FirstPageNumber);

  if ASection.Margins.Left <> ADefaultMargins.Left then
    FRtfBuilder.WriteCommand(TdxRtfExportSR.LegacyMarginsLeft,
      UnitConverter.ModelUnitsToTwips(ASection.Margins.Left));
  if ASection.Margins.Right <> ADefaultMargins.Right then
    FRtfBuilder.WriteCommand(TdxRtfExportSR.LegacyMarginsRight,
      UnitConverter.ModelUnitsToTwips(ASection.Margins.Right));
  if ASection.Margins.Top <> ADefaultMargins.Top then
    FRtfBuilder.WriteCommand(TdxRtfExportSR.LegacyMarginsTop,
      UnitConverter.ModelUnitsToTwips(ASection.Margins.Top));
  if ASection.Margins.Bottom <> ADefaultMargins.Bottom then
    FRtfBuilder.WriteCommand(TdxRtfExportSR.LegacyMarginsBottom,
      UnitConverter.ModelUnitsToTwips(ASection.Margins.Bottom));
  if ASection.Margins.Gutter <> ADefaultMargins.Gutter then
    FRtfBuilder.WriteCommand(TdxRtfExportSR.LegacyMarginsGutter,
      UnitConverter.ModelUnitsToTwips(ASection.Margins.Gutter));
...
begin
  ADefaultColumns := PieceTable.DocumentModel.Cache.ColumnsInfoCache.
    DefaultItem;
  if AColumns.EqualWidthColumns then
  begin
    if AColumns.ColumnCount <> ADefaultColumns.ColumnCount then
      RtfBuilder.WriteCommand(TdxRtfExportSR.SectionColumnsCount,
        AColumns.ColumnCount);
    if AColumns.Space <> ADefaultColumns.Space then
      RtfBuilder.WriteCommand(TdxRtfExportSR.SectionSpaceBetweenColumns,
        UnitConverter.ModelUnitsToTwips(AColumns.Space));
  end
  else
  begin
...
begin
  ...
  ADefaultInfo := DocumentModel.Cache.FootNoteInfoCache
    [TdxFootNoteInfoCache.DefaultEndNoteItemIndex];

  if ANote.StartingNumber <> ADefaultInfo.StartingNumber then
    FRtfBuilder.WriteCommand(TdxRtfExportSR.SectionEndNoteNumberingStart,
      ANote.StartingNumber);

  if ANote.NumberingFormat <> ADefaultInfo.NumberingFormat then
    WriteEnumValueCommand<TdxNumberingFormat>(FSectionEndNoteNumberingTypes,
      ANote.NumberingFormat,
      TdxRtfExportSR.SectionEndNoteNumberingFormatLowerRoman);
  ...
  begin
    if ANote.NumberingRestartType = TdxLineNumberingRestart.Continuous then
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.SectionEndNoteNumberingRestartContinuous)
    else
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.SectionEndNoteNumberingRestartEachSection);
  end;
end;
...
begin
  ...
  ADefaultInfo := DocumentModel.Cache.FootNoteInfoCache
    [TdxFootNoteInfoCache.DefaultFootNoteItemIndex];
  ...
  begin
    if ANote.Position = TdxFootNotePosition.BelowText then
      ...
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.SectionFootNotePlacementPageBottom);
  end;

  if ANote.StartingNumber <> ADefaultInfo.StartingNumber then
    FRtfBuilder.WriteCommand(TdxRtfExportSR.SectionFootNoteNumberingStart,
      ANote.StartingNumber);

  if ANote.NumberingFormat <> ADefaultInfo.NumberingFormat then
    WriteEnumValueCommand<TdxNumberingFormat>(FSectionFootNoteNumberingTypes,
      ANote.NumberingFormat,
      TdxRtfExportSR.SectionFootNoteNumberingFormatDecimal);

  if ANote.NumberingRestartType <> ADefaultInfo.NumberingRestartType then
  begin
    if ANote.NumberingRestartType = TdxLineNumberingRestart.Continuous then
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.SectionFootNoteNumberingRestartContinuous)
    else if ANote.NumberingRestartType = TdxLineNumberingRestart.NewSection then
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.SectionFootNoteNumberingRestartEachSection)
    else
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.SectionFootNoteNumberingRestartEachPage);
  end;
end;
...
begin
  ADefaultSettings := PieceTable.DocumentModel.Cache.GeneralSectionInfoCache.
    DefaultItem;
  if ASettings.StartType <> ADefaultSettings.StartType then
    WriteSectionBreakType(ASettings.StartType);
  if ASettings.FirstPagePaperSource <> ADefaultSettings.FirstPagePaperSource
  then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionFirstPagePaperSource,
      ASettings.FirstPagePaperSource);
  if ASettings.OtherPagePaperSource <> ADefaultSettings.OtherPagePaperSource
  then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionOtherPagePaperSource,
      ASettings.OtherPagePaperSource);
  ...
  if ASettings.TextDirection <> ADefaultSettings.TextDirection then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionTextFlow,
      Ord(ASettings.TextDirection));
  if ASettings.VerticalTextAlignment <> ADefaultSettings.VerticalTextAlignment
  then
...
procedure TdxRtfContentExporter.ExportSectionLineNumbering(ALineNumbering
  : TdxSectionLineNumbering);
var
  ADefaultLineNumbering: TdxLineNumberingInfo;
begin
  ADefaultLineNumbering := PieceTable.DocumentModel.Cache.
    LineNumberingInfoCache.DefaultItem;
  if ALineNumbering.Distance <> ADefaultLineNumbering.Distance then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionLineNumberingDistance,
      UnitConverter.ModelUnitsToTwips(ALineNumbering.Distance));
  if ALineNumbering.Step <> ADefaultLineNumbering.Step then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionLineNumberingStep,
      ALineNumbering.Step);

  if ALineNumbering.NumberingRestartType <> TdxLineNumberingRestart.NewPage then
  begin
    RtfBuilder.WriteCommand
      (TdxRtfExportSR.SectionLineNumberingStartingLineNumber,
      ALineNumbering.StartingLineNumber);
    if ALineNumbering.NumberingRestartType = TdxLineNumberingRestart.Continuous
    then
      RtfBuilder.WriteCommand(TdxRtfExportSR.SectionLineNumberingContinuous)
    else
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.SectionLineNumberingRestartNewSection);
  end;
end;
...
var
  ADefaultMargins: TdxMarginsInfo;
begin
  ADefaultMargins := PieceTable.DocumentModel.Cache.MarginsInfoCache.
    DefaultItem;
  if AMargins.Left <> ADefaultMargins.Left then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionMarginsLeft,
      UnitConverter.ModelUnitsToTwips(AMargins.Left));
  if AMargins.Right <> ADefaultMargins.Right then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionMarginsRight,
      UnitConverter.ModelUnitsToTwips(AMargins.Right));
  if AMargins.Top <> ADefaultMargins.Top then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionMarginsTop,
      UnitConverter.ModelUnitsToTwips(AMargins.Top));
  if AMargins.Bottom <> ADefaultMargins.Bottom then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionMarginsBottom,
      UnitConverter.ModelUnitsToTwips(AMargins.Bottom));
  if AMargins.HeaderOffset <> ADefaultMargins.HeaderOffset then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionMarginsHeaderOffset,
      UnitConverter.ModelUnitsToTwips(AMargins.HeaderOffset));
  if AMargins.FooterOffset <> ADefaultMargins.FooterOffset then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionMarginsFooterOffset,
      UnitConverter.ModelUnitsToTwips(AMargins.FooterOffset));
  if AMargins.Gutter <> ADefaultMargins.Gutter then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionMarginsGutter,
      UnitConverter.ModelUnitsToTwips(AMargins.Gutter));
end;
...
begin
  ...
  if APage.Width <> ADefaultPage.Width then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionPageWidth,
      UnitConverter.ModelUnitsToTwips(APage.Width));
  if APage.Height <> ADefaultPage.Height then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionPageHeight,
      UnitConverter.ModelUnitsToTwips(APage.Height));
  if APage.Landscape then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionPageLandscape);
  if (APage.PaperKind <> ADefaultPage.PaperKind) and
    (APage.PaperKind <> TdxPaperKind.Custom) then
    RtfBuilder.WriteCommand(TdxRtfExportSR.PaperKind, Ord(APage.PaperKind));
end;

procedure TdxRtfContentExporter.ExportSectionPageNumbering(APageNumbering
  : TdxSectionPageNumbering);
var
  ADefaultPageNumbering: TdxPageNumberingInfo;
begin
  ADefaultPageNumbering := PieceTable.DocumentModel.Cache.
    PageNumberingInfoCache.DefaultItem;
  if APageNumbering.ChapterSeparator <> ADefaultPageNumbering.ChapterSeparator
  then
    WriteChapterSeparator(APageNumbering.ChapterSeparator);
  if APageNumbering.ChapterHeaderStyle <> ADefaultPageNumbering.ChapterHeaderStyle
  then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionChapterHeaderStyle,
      APageNumbering.ChapterHeaderStyle);

  if not APageNumbering.ContinueNumbering then
  begin
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionPageNumberingStart,
      APageNumbering.FirstPageNumber);
    RtfBuilder.WriteCommand(TdxRtfExportSR.SectionPageNumberingRestart);
  end;

  if APageNumbering.NumberingFormat <> ADefaultPageNumbering.NumberingFormat
  then
...
begin
  ...
  if not(IsLastParagraph(AParagraph) and SuppressExportLastParagraph(AParagraph))
  then
...
begin
  ...
  try
    AStyleExporter.ExportStyleSheet(ADocumentModel.ParagraphStyles,
      ADocumentModel.CharacterStyles, ADocumentModel.TableStyles);
  finally
    AStyleExporter.Free;
  end;
end;
...
begin
  ...
  begin
    AKerning := TdxRtfDocumentExporterCompatibilityOptionsAccess
      (RtfOptions.Compatibility).Kerning;
    if AKerning then
...
procedure TdxRtfContentExporter.PopulateUserList(APieceTable: TdxPieceTable;
  AUsers: TdxStringList);
var
...
begin
  if (ARun.CharacterStyleIndex = TdxCharacterStyleCollection.
    EmptyCharacterStyleIndex) or not RtfExportHelper.SupportStyle then
    Result := False
  else
  begin
    if ARun.Paragraph.ParagraphStyleIndex = TdxParagraphStyleCollection.EmptyParagraphStyleIndex
    then
      Result := True
    else
    begin
      AParagraphStyle := ARun.Paragraph.ParagraphStyle;
      Result := not(AParagraphStyle.HasLinkedStyle and
        (AParagraphStyle.LinkedStyle = ARun.CharacterStyle));
    end;
  end;
end;
...
begin
  ...
  FParagraphPropertiesExporter.ExportParagraphProperties(AParagraph,
    ATableNestingLevel);
end;
...
function TdxRtfContentExporter.SuppressExportLastParagraph
  (AParagraph: TdxParagraph): Boolean;
begin
  if not AParagraph.PieceTable.IsMain then
    Exit(False);
  Result := (FOptions.ExportFinalParagraphMark = TdxExportFinalParagraphMark.
    Never) or ((FOptions.ExportFinalParagraphMark = TdxExportFinalParagraphMark.
    SelectedOnly) and FLastParagraphRunNotSelected);
end;
...
begin
  ...
  AProperties := TdxMergedCharacterProperties.Create
    (ANumberingList.Levels[AParagraph.GetListLevelIndex].CharacterProperties);
  try
    ...
    try
      ...
      FCharacterPropertiesExporter.ExportCharacterPropertiesCore(AProperties,
        True, True);
    finally
...
begin
  WriteEnumValueCommand<Char>(FChapterSeparatorTypes, ASeparator,
    TdxRtfExportSR.SectionChapterSeparatorHyphen);
end;

procedure TdxRtfContentExporter.WriteCharacterStyle(ACharacterStyle
  : TdxCharacterStyle);
var
...
begin
  ...
  if AStyleCollection.ContainsKey(AStyleName) then
    RtfBuilder.WriteCommand(TdxRtfExportSR.CharacterStyleIndex,
      AStyleCollection[AStyleName]);
end;
...
procedure TdxRtfContentExporter.ExportRangePermissionStart(ARangePermission
  : TdxRangePermission);
var
  AData: string;
begin
...
procedure TdxRtfContentExporter.ExportRangePermissionEnd(ARangePermission
  : TdxRangePermission);
var
  AData: string;
begin
...
function TdxRtfContentExporter.GenerateRangePermissionData(ARangePermission
  : TdxRangePermission): string;
var
  AHelper: TdxRtfExportHelper;
...
begin
  ...
  Result := IntToShortString(AUserIndex) + '0100' +
    IntToShortString(ARangeIndex) + '0000';
end;
...
procedure TdxRtfContentExporter.ExportFloatingObjectAnchorRun
...
begin
  ...
  try
    ...
    try
      ...
      ExportShapeInstanceProperties(AFloatingObjectProperties,
        IfThen(ARun.Shape.UseRotation, ARun.Shape.Rotation, 0));
      ExportFloatingObjectShape(ARun.Shape);
      ExportFloatingObjectHorizontalPositionAlignment
        (AFloatingObjectProperties);
      ExportFloatingObjectHorizontalPositionTypeProperty
        (AFloatingObjectProperties);
      ExportFloatingObjectVerticalPositionAlignment(AFloatingObjectProperties);
      ExportFloatingObjectVerticalPositionTypeProperty
        (AFloatingObjectProperties);
      ...
      APictureContent := Safe<TdxPictureFloatingObjectContent>.Cast
        (ARun.Content);
...
procedure TdxRtfContentExporter.ExportShapeInstanceProperties
  (AFloatingObjectProperties: TdxFloatingObjectProperties; ARotation: Integer);
var
  AOffsetX, AOffsetY, ARtfRoation, AWidth, AHeight, ATemp: Integer;
begin
  AOffsetX := UnitConverter.ModelUnitsToTwips
    (AFloatingObjectProperties.Offset.X);
  AOffsetY := UnitConverter.ModelUnitsToTwips
    (AFloatingObjectProperties.Offset.Y);
  ARtfRoation := UnitConverter.ModelUnitsToFD(ARotation);
  AWidth := UnitConverter.ModelUnitsToTwips
    (AFloatingObjectProperties.ActualSize.Width);
  AHeight := UnitConverter.ModelUnitsToTwips
    (AFloatingObjectProperties.ActualSize.Height);
  ...
  if AFloatingObjectProperties.ZOrder <> 0 then
    RtfBuilder.WriteCommand(TdxRtfExportSR.ShapeZOrder,
      AFloatingObjectProperties.ZOrder);
  if AFloatingObjectProperties.UseTextWrapSide then
    RtfBuilder.WriteCommand(TdxRtfExportSR.ShapeWrapTextSide,
      TdxRtfExportSR.FloatingObjectTextWrapSideTable
      [AFloatingObjectProperties.TextWrapSide]);
  if AFloatingObjectProperties.UseLocked and
    (AFloatingObjectProperties.Locked = True) then
...
begin
  ...
  begin
    RtfBuilder.WriteShapeIntegerProperty('lineWidth',
      UnitConverter.ModelUnitsToEmu(AShape.OutlineWidth));
    if AShape.UseOutlineColor and not TdxAlphaColors.IsTransparentOrEmpty
      (AShape.OutlineColor) then
      RtfBuilder.WriteShapeColorProperty('lineColor', AShape.OutlineColor);
  end;

  if AShape.UseFillColor and not TdxAlphaColors.IsTransparentOrEmpty
    (AShape.FillColor) then
  begin
...
procedure TdxRtfContentExporter.ExportFloatingObjectHorizontalPositionAlignment
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  if AFloatingObjectProperties.UseHorizontalPositionAlignment then
    RtfBuilder.WriteShapeIntegerProperty('posh',
      TdxRtfExportSR.FloatingObjectHorizontalPositionAlignmentTable
      [AFloatingObjectProperties.HorizontalPositionAlignment]);
end;

procedure TdxRtfContentExporter.
...
begin
  if AFloatingObjectProperties.UseHorizontalPositionType then
    RtfBuilder.WriteShapeIntegerProperty('posrelh',
      TdxRtfExportSR.FloatingObjectHorizontalPositionTypeTable
      [AFloatingObjectProperties.HorizontalPositionType]);
end;

procedure TdxRtfContentExporter.ExportFloatingObjectVerticalPositionAlignment
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  if AFloatingObjectProperties.UseVerticalPositionAlignment then
    RtfBuilder.WriteShapeIntegerProperty('posv',
      TdxRtfExportSR.FloatingObjectVerticalPositionAlignmentTable
      [AFloatingObjectProperties.VerticalPositionAlignment]);
end;

procedure TdxRtfContentExporter.ExportFloatingObjectVerticalPositionTypeProperty
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  if AFloatingObjectProperties.UseVerticalPositionType then
    RtfBuilder.WriteShapeIntegerProperty('posrelv',
      TdxRtfExportSR.FloatingObjectVerticalPositionTypeTable
      [AFloatingObjectProperties.VerticalPositionType]);
end;

procedure TdxRtfContentExporter.ExportFloatingObjectLayoutInTableCell
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  if AFloatingObjectProperties.UseLayoutInTableCell then
    RtfBuilder.WriteShapeBoolProperty('fLayoutInCell',
      AFloatingObjectProperties.LayoutInTableCell);
end;

procedure TdxRtfContentExporter.ExportFloatingObjectAllowOverlap
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  if AFloatingObjectProperties.UseAllowOverlap then
    RtfBuilder.WriteShapeBoolProperty('fAllowOverlap',
      AFloatingObjectProperties.AllowOverlap);
end;

procedure TdxRtfContentExporter.ExportFloatingObjectLockAspectRatio
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  if AFloatingObjectProperties.UseLockAspectRatio then
    RtfBuilder.WriteShapeBoolProperty('fLockAspectRatio',
      AFloatingObjectProperties.LockAspectRatio);
end;

procedure TdxRtfContentExporter.ExportFloatingObjectHidden
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  if AFloatingObjectProperties.UseHidden then
    RtfBuilder.WriteShapeBoolProperty('fHidden',
      AFloatingObjectProperties.Hidden);
end;

procedure TdxRtfContentExporter.ExportFloatingObjectBehindDocument
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  RtfBuilder.WriteShapeBoolProperty('fBehindDocument',
    AFloatingObjectProperties.IsBehindDoc);
end;

procedure TdxRtfContentExporter.ExportFloatingObjectLeftDistance
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  if AFloatingObjectProperties.UseLeftDistance and
    (AFloatingObjectProperties.LeftDistance <> UnitConverter.EmuToModelUnits
    (TdxShapeInstanceDestination.DistanceFromText)) then
    RtfBuilder.WriteShapeIntegerProperty('dxWrapDistLeft',
      UnitConverter.ModelUnitsToEmu(AFloatingObjectProperties.LeftDistance));
end;

procedure TdxRtfContentExporter.ExportFloatingObjectRightDistance
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  if AFloatingObjectProperties.UseRightDistance and
    (AFloatingObjectProperties.RightDistance <> UnitConverter.EmuToModelUnits
    (TdxShapeInstanceDestination.DistanceFromText)) then
    RtfBuilder.WriteShapeIntegerProperty('dxWrapDistRight',
      UnitConverter.ModelUnitsToEmu(AFloatingObjectProperties.RightDistance));
end;

procedure TdxRtfContentExporter.ExportFloatingObjectTopDistance
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  if AFloatingObjectProperties.UseTopDistance then
    RtfBuilder.WriteShapeIntegerProperty('dyWrapDistTop',
      UnitConverter.ModelUnitsToEmu(AFloatingObjectProperties.TopDistance));
end;

procedure TdxRtfContentExporter.ExportFloatingObjectBottomDistance
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  if AFloatingObjectProperties.UseBottomDistance then
    RtfBuilder.WriteShapeIntegerProperty('dyWrapDistBottom',
      UnitConverter.ModelUnitsToEmu(AFloatingObjectProperties.BottomDistance));
end;

procedure TdxRtfContentExporter.ExportFloatingObjectRelativeSize
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
var
...
begin
  ...
  begin
    ...
    RtfBuilder.WriteShapeIntegerProperty('sizerelh',
      TdxRtfExportSR.FloatingObjectRelativeFromHorizontalTable[AWidth.From]);
  ...
  begin
    ...
    RtfBuilder.WriteShapeIntegerProperty('sizerelv',
      TdxRtfExportSR.FloatingObjectRelativeFromVerticalTable[AHeight.From]);
  ...
  begin
    if AFloatingObjectProperties.PercentOffsetX <> 0 then
      RtfBuilder.WriteShapeIntegerProperty('pctHorizPos',
        AFloatingObjectProperties.PercentOffsetX div 100);
    if AFloatingObjectProperties.PercentOffsetY <> 0 then
      RtfBuilder.WriteShapeIntegerProperty('pctVertPos',
        AFloatingObjectProperties.PercentOffsetY div 100);
  end;
end;

procedure TdxRtfContentExporter.ExportPicture(ARun: TdxFloatingObjectAnchorRun;
  AContent: TdxPictureFloatingObjectContent);
var
...
procedure TdxRtfContentExporter.ExportTextBoxContent
  (ARun: TdxFloatingObjectAnchorRun; AContent: TdxTextBoxFloatingObjectContent);
begin
  ExportTextBoxProperties(AContent.TextBoxProperties);
  RtfBuilder.OpenGroup;
  try
    RtfBuilder.WriteCommand(TdxRtfExportSR.ShapeText);
    PerformExportPieceTable(TdxPieceTable(AContent.TextBox.PieceTable),
      ExportPieceTable);
  finally
    RtfBuilder.CloseGroup;
  end;
...
procedure TdxRtfContentExporter.ExportFloatingObjectTextWrapType
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
var
...
begin
  ...
  begin
    ...
    RtfBuilder.WriteCommand(TdxRtfExportSR.ShapeWrapTextType,
      TdxRtfExportSR.FloatingObjectTextWrapTypeTable[ATextWrapType]);
end;

procedure TdxRtfContentExporter.ExportFloatingObjectHorizontalPositionType
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
var
  ...
  begin
    ...
    case AHorizontalPositionType of
      TdxFloatingObjectHorizontalPositionType.Page:
        AShapeHorizontalPositionType :=
          TdxRtfExportSR.ShapeLegacyHorizontalPositionTypePage;
      TdxFloatingObjectHorizontalPositionType.Margin:
        AShapeHorizontalPositionType :=
          TdxRtfExportSR.ShapeLegacyHorizontalPositionTypeMargin;
      TdxFloatingObjectHorizontalPositionType.Column:
        AShapeHorizontalPositionType :=
          TdxRtfExportSR.ShapeLegacyHorizontalPositionTypeColumn;
    else
      AShapeHorizontalPositionType :=
        TdxRtfExportSR.ShapeLegacyHorizontalPositionTypeMargin;
    end;
    ...
    RtfBuilder.WriteCommand
      (TdxRtfExportSR.ShapeIgnoreLegacyHorizontalPositionType);
  end;
end;

procedure TdxRtfContentExporter.ExportFloatingObjectVerticalPositionType
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
var
  ...
  begin
    ...
    case AVerticalPositionType of
      TdxFloatingObjectVerticalPositionType.Page:
        AShapeVerticalPositionType :=
          TdxRtfExportSR.ShapeLegacyVerticalPositionTypePage;
      TdxFloatingObjectVerticalPositionType.Margin:
        AShapeVerticalPositionType :=
          TdxRtfExportSR.ShapeLegacyVerticalPositionTypeMargin;
      TdxFloatingObjectVerticalPositionType.Paragraph:
        AShapeVerticalPositionType :=
          TdxRtfExportSR.ShapeLegacyVerticalPositionTypeParagraph;
    else
      AShapeVerticalPositionType :=
        TdxRtfExportSR.ShapeLegacyVerticalPositionTypeParagraph;
    end;
    ...
    RtfBuilder.WriteCommand
      (TdxRtfExportSR.ShapeIgnoreLegacyVerticalPositionType);
  end;
end;

procedure TdxRtfContentExporter.ExportTextBoxProperties
  (AProperties: TdxTextBoxProperties);
begin
  if AProperties.UseLeftMargin then
    RtfBuilder.WriteShapeIntegerProperty('dxTextLeft',
      UnitConverter.ModelUnitsToEmu(AProperties.LeftMargin));
  if AProperties.UseRightMargin then
    RtfBuilder.WriteShapeIntegerProperty('dxTextRight',
      UnitConverter.ModelUnitsToEmu(AProperties.RightMargin));
  if AProperties.UseTopMargin then
    RtfBuilder.WriteShapeIntegerProperty('dyTextTop',
      UnitConverter.ModelUnitsToEmu(AProperties.TopMargin));
  if AProperties.UseBottomMargin then
    RtfBuilder.WriteShapeIntegerProperty('dyTextBottom',
      UnitConverter.ModelUnitsToEmu(AProperties.BottomMargin));
  if AProperties.UseResizeShapeToFitText then
    RtfBuilder.WriteShapeBoolProperty('fFitShapeToText',
      AProperties.ResizeShapeToFitText);
...
begin
  if AShape.UseRotation then
    RtfBuilder.WriteShapeIntegerProperty('rotation',
      UnitConverter.ModelUnitsToFD(AShape.Rotation));
end;

procedure TdxRtfContentExporter.ExportFootNoteRunCore(ARun: TdxFootNoteRunBase;
  const ASuffixKeyword: string);
var
...
begin
  ...
  try
    FCharacterPropertiesExporter.ExportCharacterProperties
      (ARun.GetMergedCharacterProperties
      (FGetMergedCharacterPropertiesCachedResult));
    WriteRunCharacterStyle(ARun);
    ...
    try
      PerformExportPieceTable(TdxPieceTable(ARun.Note.PieceTable),
        ExportPieceTable);
    finally
...
class function TdxRtfContentExporter.BorderLineStylesTryGetValue
  (AKey: TdxBorderLineStyle; var AResult: string): Boolean;
begin
{$IFDEF DELPHIXE2}
  if AKey in [TdxBorderLineStyle.&Nil .. TdxBorderLineStyle.Inset] then
    AResult := BorderLineStyles[AKey]
{$ELSE}
  if Ord(AKey) in [Ord(TdxBorderLineStyle.&Nil) .. Ord(TdxBorderLineStyle.Inset)]
  then
...
begin
  ...
  if ANote.StartingNumber <> ADefaultInfo.StartingNumber then
    FRtfBuilder.WriteCommand(TdxRtfExportSR.FootNoteNumberingStart,
      ANote.StartingNumber);

  if ANote.NumberingFormat <> ADefaultInfo.NumberingFormat then
    WriteEnumValueCommand<TdxNumberingFormat>(FFootNoteNumberingTypes,
      ANote.NumberingFormat, TdxRtfExportSR.FootNoteNumberingFormatDecimal);
  ...
  begin
    if ANote.NumberingRestartType = TdxLineNumberingRestart.Continuous then
      ...
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.FootNoteNumberingRestartEachSection)
    else
...
begin
  ...
  if ANote.StartingNumber <> ADefaultInfo.StartingNumber then
    FRtfBuilder.WriteCommand(TdxRtfExportSR.EndNoteNumberingStart,
      ANote.StartingNumber);

  if ANote.NumberingFormat <> ADefaultInfo.NumberingFormat then
    WriteEnumValueCommand<TdxNumberingFormat>(FEndNoteNumberingTypes,
      ANote.NumberingFormat, TdxRtfExportSR.EndNoteNumberingFormatLowerRoman);
  ...
  begin
    if ANote.NumberingRestartType = TdxLineNumberingRestart.Continuous then
      ...
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.EndNoteNumberingRestartEachSection);
  end;
end;
...
procedure TdxRtfContentExporter.ExportPageBackground(ADocumentProperties
...
begin
  ...
  try
    ...
    try
      ...
      try
        RtfBuilder.WriteCommand(TdxRtfExportSR.ShapeInstance);
        RtfBuilder.WriteShapeColorProperty('fillColor',
          ADocumentProperties.PageBackColor);
      finally
        RtfBuilder.CloseGroup;
      end;
    finally
...
begin
  ...
  Result := AProperties.EnforceProtection and
    ((AProperties.PasswordHash <> nil) or
    (AProperties.Word2003PasswordHash <> nil));
end;
...
begin
  AProperties := DocumentModel.ProtectionProperties;
  Result := (AProperties.PasswordHash <> nil) and
    (AProperties.HashAlgorithmType <> TdxHashAlgorithmType.None);
end;
...
function TdxRtfContentExporter.GetDocumentProtectionPasswordHashWord2007Bytes
  : TArray<Byte>;
var
  AProperties: TdxDocumentProtectionProperties;
...
procedure TdxRtfContentExporter.WritePageNumberingFormat(ANumberingFormat
  : TdxNumberingFormat);
begin
  WriteEnumValueCommand<TdxNumberingFormat>(FPageNumberingTypes,
    ANumberingFormat, TdxRtfExportSR.SectionPageNumberingDecimal);
end;

procedure TdxRtfContentExporter.WriteParagraphStyle(AParagraphStyle
  : TdxParagraphStyle);
var
  AStyleCollection: TdxNamedOrdinalDictionary<Integer>;
  AStyleName: string;
begin
  ...
  if AStyleCollection.ContainsKey(AStyleName) then
    RtfBuilder.WriteCommand(TdxRtfExportSR.ParagraphStyle,
      AStyleCollection[AStyleName]);
end;
...
procedure TdxRtfContentExporter.WriteVerticalAlignment
  (AAlignment: TdxVerticalAlignment);
begin
  if AAlignment in [Low(TdxVerticalAlignment) .. High(TdxVerticalAlignment)]
  then
...
procedure TdxRtfContentExporter.WriteFieldInstructionStart
  (ARun: TdxFieldCodeStartRun);
var
  AField: TdxField;
begin
  ...
  if not DocumentModel.FieldOptions.UpdateFieldsOnPaste and KeepFieldCodeViewState
  then
  begin
...
class function TdxRtfContentExporter.CreatePageNumberingTypesTable
  : TdxEnumeratedDictionary<TdxNumberingFormat, string>;
begin
  Result := TdxEnumeratedDictionary<TdxNumberingFormat, string>.Create;
  Result.Add(TdxNumberingFormat.Decimal,
    TdxRtfExportSR.SectionPageNumberingDecimal);
  Result.Add(TdxNumberingFormat.UpperRoman,
    TdxRtfExportSR.SectionPageNumberingUpperRoman);
  Result.Add(TdxNumberingFormat.LowerRoman,
    TdxRtfExportSR.SectionPageNumberingLowerRoman);
  Result.Add(TdxNumberingFormat.UpperLetter,
    TdxRtfExportSR.SectionPageNumberingUpperLetter);
  Result.Add(TdxNumberingFormat.LowerLetter,
    TdxRtfExportSR.SectionPageNumberingLowerLetter);
  Result.Add(TdxNumberingFormat.ArabicAbjad,
    TdxRtfExportSR.SectionPageNumberingArabicAbjad);
  Result.Add(TdxNumberingFormat.ArabicAlpha,
    TdxRtfExportSR.SectionPageNumberingArabicAlpha);
  Result.Add(TdxNumberingFormat.Chosung,
    TdxRtfExportSR.SectionPageNumberingChosung);
  Result.Add(TdxNumberingFormat.DecimalEnclosedCircle,
    TdxRtfExportSR.SectionPageNumberingDecimalEnclosedCircle);
  Result.Add(TdxNumberingFormat.DecimalFullWidth,
    TdxRtfExportSR.SectionPageNumberingDecimalFullWidth);
  Result.Add(TdxNumberingFormat.Ganada,
    TdxRtfExportSR.SectionPageNumberingGanada);
  Result.Add(TdxNumberingFormat.HindiVowels,
    TdxRtfExportSR.SectionPageNumberingHindiVowels);
  Result.Add(TdxNumberingFormat.HindiConsonants,
    TdxRtfExportSR.SectionPageNumberingHindiConsonants);
  Result.Add(TdxNumberingFormat.HindiNumbers,
    TdxRtfExportSR.SectionPageNumberingHindiNumbers);
  Result.Add(TdxNumberingFormat.HindiDescriptive,
    TdxRtfExportSR.SectionPageNumberingHindiDescriptive);
  Result.Add(TdxNumberingFormat.ThaiLetters,
    TdxRtfExportSR.SectionPageNumberingThaiLetters);
  Result.Add(TdxNumberingFormat.ThaiNumbers,
    TdxRtfExportSR.SectionPageNumberingThaiNumbers);
  Result.Add(TdxNumberingFormat.ThaiDescriptive,
    TdxRtfExportSR.SectionPageNumberingThaiDescriptive);
  Result.Add(TdxNumberingFormat.VietnameseDescriptive,
    TdxRtfExportSR.SectionPageNumberingVietnameseDescriptive);
end;

function TdxRtfContentExporter.CreateParagraphPropertiesExporter
  : TdxRtfParagraphPropertiesExporter;
begin
  Result := TdxRtfParagraphPropertiesExporter.Create(DocumentModel,
    RtfExportHelper, RtfBuilder)
end;

class function TdxRtfContentExporter.CreatePredefinedUserGroups
...
class function TdxRtfContentExporter.CreateSectionEndNoteNumberingTypesTable
  : TdxEnumeratedDictionary<TdxNumberingFormat, string>;
begin
  Result := TdxEnumeratedDictionary<TdxNumberingFormat, string>.Create;
  Result.Add(TdxNumberingFormat.Decimal,
    TdxRtfExportSR.SectionEndNoteNumberingFormatDecimal);
  Result.Add(TdxNumberingFormat.UpperRoman,
    TdxRtfExportSR.SectionEndNoteNumberingFormatUpperRoman);
  Result.Add(TdxNumberingFormat.LowerRoman,
    TdxRtfExportSR.SectionEndNoteNumberingFormatLowerRoman);
  Result.Add(TdxNumberingFormat.UpperLetter,
    TdxRtfExportSR.SectionEndNoteNumberingFormatUpperLetter);
  Result.Add(TdxNumberingFormat.LowerLetter,
    TdxRtfExportSR.SectionEndNoteNumberingFormatLowerLetter);
  Result.Add(TdxNumberingFormat.Chicago,
    TdxRtfExportSR.SectionEndNoteNumberingFormatChicago);
  Result.Add(TdxNumberingFormat.Chosung,
    TdxRtfExportSR.SectionEndNoteNumberingFormatChosung);
  Result.Add(TdxNumberingFormat.DecimalEnclosedCircle,
    TdxRtfExportSR.SectionEndNoteNumberingFormatDecimalEnclosedCircle);
  Result.Add(TdxNumberingFormat.DecimalFullWidth,
    TdxRtfExportSR.SectionEndNoteNumberingFormatDecimalFullWidth);
  Result.Add(TdxNumberingFormat.Ganada,
    TdxRtfExportSR.SectionEndNoteNumberingFormatGanada);
end;

class function TdxRtfContentExporter.CreateSectionFootNoteNumberingTypesTable
  : TdxEnumeratedDictionary<TdxNumberingFormat, string>;
begin
  Result := TdxEnumeratedDictionary<TdxNumberingFormat, string>.Create;
  Result.Add(TdxNumberingFormat.Decimal,
    TdxRtfExportSR.SectionFootNoteNumberingFormatDecimal);
  Result.Add(TdxNumberingFormat.UpperRoman,
    TdxRtfExportSR.SectionFootNoteNumberingFormatUpperRoman);
  Result.Add(TdxNumberingFormat.LowerRoman,
    TdxRtfExportSR.SectionFootNoteNumberingFormatLowerRoman);
  Result.Add(TdxNumberingFormat.UpperLetter,
    TdxRtfExportSR.SectionFootNoteNumberingFormatUpperLetter);
  Result.Add(TdxNumberingFormat.LowerLetter,
    TdxRtfExportSR.SectionFootNoteNumberingFormatLowerLetter);
  Result.Add(TdxNumberingFormat.Chicago,
    TdxRtfExportSR.SectionFootNoteNumberingFormatChicago);
  Result.Add(TdxNumberingFormat.Chosung,
    TdxRtfExportSR.SectionFootNoteNumberingFormatChosung);
  Result.Add(TdxNumberingFormat.DecimalEnclosedCircle,
    TdxRtfExportSR.SectionFootNoteNumberingFormatDecimalEnclosedCircle);
  Result.Add(TdxNumberingFormat.DecimalFullWidth,
    TdxRtfExportSR.SectionFootNoteNumberingFormatDecimalFullWidth);
  Result.Add(TdxNumberingFormat.Ganada,
    TdxRtfExportSR.SectionFootNoteNumberingFormatGanada);
end;

function TdxRtfContentExporter.CreateStyleExporter: TdxRtfStyleExporter;
begin
  Result := TdxRtfStyleExporter.Create(PieceTable.DocumentModel,
    CreateRtfBuilder, RtfExportHelper, FOptions);
end;
...
function TdxRtfPropertiesExporter.GetUnitConverter
  : TdxDocumentModelUnitConverter;
begin
  Result := DocumentModel.UnitConverter;
end;

procedure TdxRtfPropertiesExporter.WriteWidthUnit(AUnit: TdxWidthUnitInfo;
  const ATypeKeyword, AValueKeyword: string;
  AWriteValueAnyway: Boolean = False);
var
  ...
  begin
    ...
    case AUnit.&Type of
      TdxWidthUnitType.ModelUnits:
        begin
          RtfBuilder.WriteCommand(ATypeKeyword,
            Ord(TdxWidthUnitType.ModelUnits));
          AVal := UnitConverter.ModelUnitsToTwips(AVal);
        end;
      TdxWidthUnitType.FiftiethsOfPercent:
        RtfBuilder.WriteCommand(ATypeKeyword,
          Ord(TdxWidthUnitType.FiftiethsOfPercent));
...
begin
  Result := (AMarginUnit.&Type <> TdxWidthUnitType.Nil) or
    (AMarginUnit.Value <> 0);
end;
...
begin
  ...
  if ABorder.Offset <> ADefaultBorder.Offset then
    RtfBuilder.WriteCommand(TdxRtfExportSR.BorderSpace,
      UnitConverter.ModelUnitsToTwips(ABorder.Offset));
  if (ABorder.Color <> ADefaultBorder.Color) and
    not TdxAlphaColors.IsEmpty(ABorder.Color) then
  begin
...
begin
  ...
  begin
    if TdxRtfContentExporter.BorderLineStylesTryGetValue(AValue, ABorderCommand)
    then
...
constructor TdxRtfCharacterPropertiesExporter.Create(ADocumentModel
  : TdxDocumentModel; const ARtfExportHelper: IdxRtfExportHelper;
...
procedure TdxRtfCharacterPropertiesExporter.ExportCharacterProperties
  (ACharacterProperties: TdxMergedCharacterProperties;
  ACheckDefaultColor: Boolean = False; ACheckUseFontSize: Boolean = False;
  ACheckUseFontName: Boolean = False);
var
  AInfo: TdxCharacterFormattingInfo;
  AColor: TdxAlphaColor;
begin
  ExportCharacterPropertiesCore(ACharacterProperties, ACheckUseFontSize,
    ACheckUseFontName);
...
begin
  ...
  if AInfo.UnderlineWordsOnly and
    (AInfo.FontUnderlineType = TdxUnderlineType.Single) then
  ...
  if not ACheckUseFontSize or ACharacterProperties.Options.UseDoubleFontSize
  then
...
begin
  if not RtfExportHelper.FontCharsetTable.TryGetValue(AFontNameIndex, ACharset)
  then
  begin
    AFontStyle := [];
    if AInfo.FontBold then
...
begin
  ...
  else if AMode = TdxRtfRunBackColorExportMode.Highlight then
...
function TdxRtfCharacterPropertiesExporter.WriteFontName(const AFontName
  : string): Integer;
begin
...
procedure TdxRtfCharacterPropertiesExporter.WriteUnderlineColor(AUnderlineColor
  : TdxAlphaColor);
var
  AIndex: Integer;
begin
...
procedure TdxRtfTablePropertiesExporter.WriteTableFloatingPosition
  (AFloatingPosition: TdxTableFloatingPositionInfo);
var
  ADefaultFloatingPosition: TdxTableFloatingPositionInfo;
begin
  if AFloatingPosition.TextWrapping <> TdxTextWrapping.Around then
    Exit;
  ADefaultFloatingPosition :=
    DocumentModel.Cache.TableFloatingPositionInfoCache.DefaultItem;
  ...
  if AFloatingPosition.HorizontalAlign <> ADefaultFloatingPosition.HorizontalAlign
  then
  ...
  if AFloatingPosition.VerticalAlign <> ADefaultFloatingPosition.VerticalAlign
  then
    WriteTableVerticalAlign(AFloatingPosition.VerticalAlign);
  if AFloatingPosition.LeftFromText <> ADefaultFloatingPosition.LeftFromText
  then
    RtfBuilder.WriteCommand(TdxRtfExportSR.TableRowLeftFromText,
      UnitConverter.ModelUnitsToTwips(AFloatingPosition.LeftFromText));
  if AFloatingPosition.BottomFromText <> ADefaultFloatingPosition.BottomFromText
  then
    RtfBuilder.WriteCommand(TdxRtfExportSR.TableRowBottomFromText,
      UnitConverter.ModelUnitsToTwips(AFloatingPosition.BottomFromText));
  if AFloatingPosition.RightFromText <> ADefaultFloatingPosition.RightFromText
  then
    RtfBuilder.WriteCommand(TdxRtfExportSR.TableRowRightFromText,
      UnitConverter.ModelUnitsToTwips(AFloatingPosition.RightFromText));
  if AFloatingPosition.TopFromText <> ADefaultFloatingPosition.TopFromText then
    RtfBuilder.WriteCommand(TdxRtfExportSR.TableRowTopFromText,
      UnitConverter.ModelUnitsToTwips(AFloatingPosition.TopFromText));
end;

procedure TdxRtfTablePropertiesExporter.WriteTableHorizontalAnchor
  (AValue: TdxHorizontalAnchorTypes);
begin
  case AValue of
...
procedure TdxRtfTablePropertiesExporter.WriteTableVerticalAnchor
  (AValue: TdxVerticalAnchorTypes);
begin
  case AValue of
...
procedure TdxRtfTablePropertiesExporter.WriteTableHorizontalAlign
  (AValue: TdxHorizontalAlignMode);
begin
  case AValue of
...
procedure TdxRtfTablePropertiesExporter.WriteTableVerticalAlign
  (AValue: TdxVerticalAlignMode);
begin
  case AValue of
...
procedure TdxRtfTablePropertiesExporter.WriteTableHorizontalPosition
  (AValue: Integer);
begin
  if AValue >= 0 then
    RtfBuilder.WriteCommand(TdxRtfExportSR.TableRowHorizontalPosition,
      UnitConverter.ModelUnitsToTwips(AValue))
  else
    RtfBuilder.WriteCommand(TdxRtfExportSR.TableRowHorizontalPositionNeg,
      UnitConverter.ModelUnitsToTwips(AValue));
end;

procedure TdxRtfTablePropertiesExporter.WriteTableVerticalPosition
  (AValue: Integer);
begin
  if AValue >= 0 then
    RtfBuilder.WriteCommand(TdxRtfExportSR.TableRowVerticalPosition,
      UnitConverter.ModelUnitsToTwips(AValue))
  else
    RtfBuilder.WriteCommand(TdxRtfExportSR.TableRowVerticalPositionNeg,
      UnitConverter.ModelUnitsToTwips(AValue));
end;

procedure TdxRtfTablePropertiesExporter.WriteRowLeft(ALeft: Integer);
begin
  RtfBuilder.WriteCommand(TdxRtfExportSR.TableRowLeft,
    UnitConverter.ModelUnitsToTwips(ALeft));
end;

procedure TdxRtfTablePropertiesExporter.WriteTableBorders(ATopBorder,
  ALeftBorder, ABottomBorder, ARightBorder, AInnerHorizontalBorder,
  AInnerVerticalBorder: TdxBorderInfo);
var
  ADefaultBorder: TdxBorderInfo;
begin
  ADefaultBorder := DocumentModel.Cache.BorderInfoCache.DefaultItem;
...
procedure TdxRtfTablePropertiesExporter.WriteTableWidth(APreferredWidth
  : TdxWidthUnitInfo);
begin
  WriteWidthUnit(APreferredWidth, TdxRtfExportSR.TablePreferredWidthType,
    TdxRtfExportSR.TablePreferredWidth);
end;

procedure TdxRtfTablePropertiesExporter.WriteTableLayout
  (AValue: TdxTableLayoutType);
begin
  if AValue <> TdxTableLayoutType.Fixed then
    RtfBuilder.WriteCommand(TdxRtfExportSR.TableLayout, Ord(AValue));
end;

procedure TdxRtfTablePropertiesExporter.WriteTableCellMargins
  (ALeftMargin: TdxWidthUnitInfo; ARightMargin: TdxWidthUnitInfo;
  ABottomMargin: TdxWidthUnitInfo; ATopMargin: TdxWidthUnitInfo);
begin
  if ShouldExportCellMargin(ALeftMargin) then
    WriteWidthUnitInTwips(ALeftMargin, TableCellMarginsLeftType,
      TableCellMarginsLeft);
  if ShouldExportCellMargin(ABottomMargin) then
    WriteWidthUnitInTwips(ABottomMargin, TableCellMarginsBottomType,
      TableCellMarginsBottom);
  if ShouldExportCellMargin(ARightMargin) then
    WriteWidthUnitInTwips(ARightMargin, TableCellMarginsRightType,
      TableCellMarginsRight);
  if ShouldExportCellMargin(ATopMargin) then
    WriteWidthUnitInTwips(ATopMargin, TableCellMarginsTopType,
      TableCellMarginsTop);
end;

procedure TdxRtfTablePropertiesExporter.WriteTableLook
  (AValue: TdxTableLookTypes);
var
  ADefaultGeneralSettings: TdxTableGeneralSettingsInfo;
begin
  ADefaultGeneralSettings := DocumentModel.Cache.TableGeneralSettingsInfoCache.
    DefaultItem;
...
procedure TdxRtfTablePropertiesExporter.WriteTableIndent
  (ATableIndent: TdxWidthUnitInfo);
begin
  WriteWidthUnit(ATableIndent, TdxRtfExportSR.TableIndentType,
    TdxRtfExportSR.TableIndent, True);
end;

procedure TdxRtfTablePropertiesExporter.WriteBandSizes
  (AInfo: TdxTableGeneralSettingsInfo; AExportRowBand: Boolean;
  AExportColBand: Boolean);
begin
  if (AInfo.TableStyleRowBandSize <> 0) and
    (AExportRowBand or (AInfo.TableStyleRowBandSize > 1)) then
    RtfBuilder.WriteCommand(TdxRtfExportSR.TableStyleRowBandSize,
      AInfo.TableStyleRowBandSize);
  if (AInfo.TableStyleColBandSize <> 0) and
    (AExportColBand or (AInfo.TableStyleColBandSize > 1)) then
    RtfBuilder.WriteCommand(TdxRtfExportSR.TableStyleColumnBandSize,
      AInfo.TableStyleColBandSize);
end;

{ TdxRtfTableStyleTablePropertiesExporter }

function TdxRtfTableStyleTablePropertiesExporter.
  GetTableStyleRowBandSize: string;
begin
  Result := TdxRtfExportSR.TableStyleRowBandSize;
end;

function TdxRtfTableStyleTablePropertiesExporter.
  GetTableStyleColumnBandSize: string;
begin
  Result := TdxRtfExportSR.TableStyleColumnBandSize;
end;

function TdxRtfTableStyleTablePropertiesExporter.
  GetTableCellMarginsLeftType: string;
begin
  Result := TdxRtfExportSR.TableStyleTableLeftCellMarginUnitType;
end;

function TdxRtfTableStyleTablePropertiesExporter.
  GetTableCellMarginsLeft: string;
begin
  Result := TdxRtfExportSR.TableStyleTableLeftCellMargin;
end;

function TdxRtfTableStyleTablePropertiesExporter.
  GetTableCellMarginsBottomType: string;
begin
  Result := TdxRtfExportSR.TableStyleTableBottomCellMarginUnitType;
end;

function TdxRtfTableStyleTablePropertiesExporter.
  GetTableCellMarginsBottom: string;
begin
  Result := TdxRtfExportSR.TableStyleTableBottomCellMargin;
end;

function TdxRtfTableStyleTablePropertiesExporter.
  GetTableCellMarginsRightType: string;
begin
  Result := TdxRtfExportSR.TableStyleTableRightCellMarginUnitType;
end;

function TdxRtfTableStyleTablePropertiesExporter.
  GetTableCellMarginsRight: string;
begin
  Result := TdxRtfExportSR.TableStyleTableRightCellMargin;
end;

function TdxRtfTableStyleTablePropertiesExporter.
  GetTableCellMarginsTopType: string;
begin
...
procedure TdxRtfTableStyleTablePropertiesExporter.ExportTableProperties
  (AMergedTableProperties: TdxMergedTableProperties; AExportRowBand: Boolean;
  AExportColBand: Boolean);
var
...
begin
  ...
  WriteTableBorders(AInfo.Borders.TopBorder, AInfo.Borders.LeftBorder,
    AInfo.Borders.BottomBorder, AInfo.Borders.RightBorder,
    AInfo.Borders.InsideHorizontalBorder, AInfo.Borders.InsideVerticalBorder);
  WriteTableFloatingPosition(AInfo.FloatingPosition);
  WriteTableWidth(AInfo.PreferredWidth);
  WriteTableCellMargins(AInfo.CellMargins.Left, AInfo.CellMargins.Right,
    AInfo.CellMargins.Bottom, AInfo.CellMargins.Top);
...
procedure TdxRtfTableRowPropertiesExporter.WriteHalfSpaceBetweenCells
  (AVal: Integer);
begin
  if AVal > 0 then
...
procedure TdxRtfTableRowPropertiesExporter.WriteRowAlignment
  (AValue: TdxTableRowAlignment);
var
  ADefaultGeneralSettings: TdxTableRowGeneralSettingsInfo;
begin
  ADefaultGeneralSettings :=
    DocumentModel.Cache.TableRowGeneralSettingsInfoCache.DefaultItem;
...
procedure TdxRtfTableRowPropertiesExporter.WriteRowCantSplit
  (ACantSplit: Boolean);
var
  ADefaultGeneralSettings: TdxTableRowGeneralSettingsInfo;
begin
...
procedure TdxRtfTableRowPropertiesExporter.WriteRowHeight
...
begin
  ...
  case AHeight.&Type of
    ...
    TdxHeightUnitType.Minimum:
      RtfBuilder.WriteCommand(TdxRtfExportSR.TableRowHeight,
        UnitConverter.ModelUnitsToTwips(AHeight.Value));
...
procedure TdxRtfTableRowPropertiesExporter.WriteWidthBefore
  (AWidthBefore: TdxWidthUnitInfo);
begin
  WriteWidthUnit(AWidthBefore, TdxRtfExportSR.TableRowWidthBeforeType,
    TdxRtfExportSR.TableRowWidthBefore);
end;

procedure TdxRtfTableRowPropertiesExporter.WriteWidthAfter
  (AWidthAfter: TdxWidthUnitInfo);
begin
  WriteWidthUnit(AWidthAfter, TdxRtfExportSR.TableRowWidthAfterType,
    TdxRtfExportSR.TableRowWidthAfter);
end;

procedure TdxRtfTableRowPropertiesExporter.WriteRowCellSpacing
  (ACellSpacing: TdxWidthUnitInfo);
begin
  WriteWidthUnitInTwips(ACellSpacing, TdxRtfExportSR.TableCellSpacingLeftType,
    TdxRtfExportSR.TableCellSpacingLeft);
  WriteWidthUnitInTwips(ACellSpacing, TdxRtfExportSR.TableCellSpacingBottomType,
    TdxRtfExportSR.TableCellSpacingBottom);
  WriteWidthUnitInTwips(ACellSpacing, TdxRtfExportSR.TableCellSpacingRightType,
    TdxRtfExportSR.TableCellSpacingRight);
  WriteWidthUnitInTwips(ACellSpacing, TdxRtfExportSR.TableCellSpacingTopType,
    TdxRtfExportSR.TableCellSpacingTop);
end;
...
function TdxRtfTableCellPropertiesExporter.
  GetTableCellTextCenterAlignment: string;
begin
  Result := TdxRtfExportSR.TableCellTextCenterAlignment;
end;

function TdxRtfTableCellPropertiesExporter.
  GetTableCellTextBottomAlignment: string;
begin
  Result := TdxRtfExportSR.TableCellTextBottomAlignment;
end;

function TdxRtfTableCellPropertiesExporter.
  GetTableCellUpperLeftToLowerRightBorder: string;
begin
  Result := TdxRtfExportSR.TableCellUpperLeftToLowerRightBorder;
end;

function TdxRtfTableCellPropertiesExporter.
  GetTableCellUpperRightToLowerLeftBorder: string;
begin
...
procedure TdxRtfTableCellPropertiesExporter.WriteCellBackgroundColor
  (ACell: TdxTableCell);
begin
...
procedure TdxRtfTableCellPropertiesExporter.WriteCellBackgroundColor
  (AColor: TdxAlphaColor; ATable: TdxTable);
var
  ADefaultGeneralSetting: TdxTableCellGeneralSettingsInfo;
  AColorIndex: Integer;
begin
  ADefaultGeneralSetting :=
    DocumentModel.Cache.TableCellGeneralSettingsInfoCache.DefaultItem;
  if (AColor <> ADefaultGeneralSetting.BackgroundColor) and
    not TdxAlphaColors.IsTransparentOrEmpty(AColor) then
    AColor := RtfExportHelper.BlendColor(AColor)
  else if (ATable <> nil) and
    (ATable.BackgroundColor <> ADefaultGeneralSetting.BackgroundColor) and
...
procedure TdxRtfTableCellPropertiesExporter.WriteCellHideCellMark
  (AHideCellMark: Boolean);
var
  ADefaultGeneralSetting: TdxTableCellGeneralSettingsInfo;
begin
  ADefaultGeneralSetting :=
...
procedure TdxRtfTableCellPropertiesExporter.WriteCellMerging
  (AMergingState: TdxMergingState);
var
  ADefaultGeneralSetting: TdxTableCellGeneralSettingsInfo;
begin
  ADefaultGeneralSetting :=
    DocumentModel.Cache.TableCellGeneralSettingsInfoCache.DefaultItem;
  WriteCellVerticalMerging(AMergingState,
    ADefaultGeneralSetting.VerticalMerging);
end;

procedure TdxRtfTableCellPropertiesExporter.WriteCellVerticalMerging
  (AValue: TdxMergingState; ADefaultValue: TdxMergingState);
begin
  if AValue = ADefaultValue then
    Exit;
  if AValue = TdxMergingState.Restart then
    RtfBuilder.WriteCommand(TdxRtfExportSR.TableCellStartVerticalMerging)
  else if AValue = TdxMergingState.Continue then
    RtfBuilder.WriteCommand(TdxRtfExportSR.TableCellContinueVerticalMerging);
end;

procedure TdxRtfTableCellPropertiesExporter.WriteCellVerticalAlignment
...
procedure TdxRtfTableCellPropertiesExporter.WriteCellTextDirection
  (AValue: TdxTextDirection);
begin
  case AValue of
    TdxTextDirection.LeftToRightTopToBottom:
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.TableCellLeftToRightTopToBottomTextDirection);
    TdxTextDirection.TopToBottomRightToLeft:
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.TableCellTopToBottomRightToLeftTextDirection);
    TdxTextDirection.BottomToTopLeftToRight:
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.TableCellBottomToTopLeftToRightTextDirection);
    TdxTextDirection.LeftToRightTopToBottomRotated:
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.TableCellLeftToRightTopToBottomVerticalTextDirection);
    TdxTextDirection.TopToBottomRightToLeftRotated:
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.TableCellTopToBottomRightToLeftVerticalTextDirection);
  end;
end;

procedure TdxRtfTableCellPropertiesExporter.WriteCellBasicBorders(ATopBorder,
  ALeftBorder, ARightBorder, ABottomBorder: TdxBorderInfo);
begin
...
procedure TdxRtfTableCellPropertiesExporter.WriteCellPreferredWidth
  (APreferredWidth: TdxWidthUnitInfo);
begin
  WriteWidthUnit(APreferredWidth, TdxRtfExportSR.TableCellPreferredWidthType,
    TdxRtfExportSR.TableCellPreferredWidth);
end;

procedure TdxRtfTableCellPropertiesExporter.WriteCellMargins
  (ACell: TdxTableCell);
begin
  WriteCellMargins(ACell.GetActualTopMargin.Info,
    ACell.GetActualLeftMargin.Info, ACell.GetActualRightMargin.Info,
    ACell.GetActualBottomMargin.Info);
end;

procedure TdxRtfTableCellPropertiesExporter.WriteCellMargins(ATopMargin,
  ALeftMargin, ARightMargin, ABottomMargin: TdxWidthUnitInfo);
begin
  if ShouldExportCellMargin(ABottomMargin) then
    WriteWidthUnitInTwips(ABottomMargin,
      TdxRtfExportSR.TableCellBottomMarginType,
      TdxRtfExportSR.TableCellBottomMargin);
  if ShouldExportCellMargin(ATopMargin) then
    WriteWidthUnitInTwips(ATopMargin, TdxRtfExportSR.TableCellLeftMarginType,
      TdxRtfExportSR.TableCellLeftMargin);
  if ShouldExportCellMargin(ARightMargin) then
    WriteWidthUnitInTwips(ARightMargin, TdxRtfExportSR.TableCellRightMarginType,
      TdxRtfExportSR.TableCellRightMargin);
  if ShouldExportCellMargin(ALeftMargin) then
    WriteWidthUnitInTwips(ALeftMargin, TdxRtfExportSR.TableCellTopMarginType,
      TdxRtfExportSR.TableCellTopMargin);
end;

procedure TdxRtfTableCellPropertiesExporter.WriteCellRight(ACellRight: Integer);
begin
  RtfBuilder.WriteCommand(TdxRtfExportSR.TableCellRight,
    UnitConverter.ModelUnitsToTwips(ACellRight));
end;

procedure TdxRtfTableCellPropertiesExporter.WriteCellForegroundColor
  (ACell: TdxTableCell);
begin
...
begin
  ...
  if (AColor <> ADefaultGeneralSetting.ForegroundColor) and
    (AColor <> TdxAlphaColors.Empty) and (AColor <> TdxAlphaColors.Transparent)
  then
    AColor := RtfExportHelper.BlendColor(AColor)
  else
    Exit;
...
procedure TdxRtfTableCellPropertiesExporter.WriteCellShading
  (ACell: TdxTableCell);
begin
...
function TdxRtfTableStyleTableCellPropertiesExporter.
  GetTableCellBackgroundColor: string;
begin
...
function TdxRtfTableStyleTableCellPropertiesExporter.
  GetTableCellTextTopAlignment: string;
begin
...
procedure TdxRtfTableStyleTableCellPropertiesExporter.WriteCellBasicBorders
  (ATopBorder: TdxBorderInfo; ALeftBorder: TdxBorderInfo;
  ARightBorder: TdxBorderInfo; ABottomBorder: TdxBorderInfo);
var
  ADefaultBorder: TdxBorderInfo;
begin
  ADefaultBorder := DocumentModel.Cache.BorderInfoCache.DefaultItem;
...
class function TdxRtfBuilder.CreateSpecialPCDataMarksTable
  : TdxCharStringDictionary;
var
  I: Integer;
begin
...
begin
  ...
  FUnicodeTextBuilder.AppendFormat('\u%d\''%s',
    [ACode, TdxStringHelper.ToHex(ABytes[0])]);
end;
...
procedure TdxRtfBuilder.WriteByteArrayAsHex(ABuffer: TBytes;
  AOffset: Integer = 0; ALength: Integer = -1);
var
  ACount: Integer;
  I: Integer;
  AValue: Byte;
...
var
  AColor: string;
begin
  AColor := IntToStr(dxGetRed(APropertyValue) or dxGetGreen(APropertyValue)
    shl 8 or dxGetBlue(APropertyValue) shl 16);
...
procedure TdxDBCSRtfBuilder.AppendUnicodeCompatibleCharCore(ACode: Integer;
  ACh: Char);
begin
...
function TdxRtfExportHelper.GetUserIndex(ARangePermission
  : TdxRangePermission): Integer;
var
  AIndex, AId: Integer;
...
function TdxRtfExportHelper.GetCharacterStylesCollectionIndex
  : TdxNamedOrdinalDictionary<Integer>;
begin
...
function TdxRtfExportHelper.GetListOverrideCollectionIndex
  : TdxIntegersDictionary;
begin
  Result := FListOverrideCollectionIndex;
end;

function TdxRtfExportHelper.GetParagraphStylesCollectionIndex
  : TdxNamedOrdinalDictionary<Integer>;
begin
...
function TdxRtfExportHelper.GetTableStylesCollectionIndex
  : TdxNamedOrdinalDictionary<Integer>;
begin
...
constructor TdxRtfNumberingListExporter.Create(ARtfExporter
  : TdxRtfContentExporter);
begin
  inherited Create;
  ...
  FCharacterPropertiesExporter := TdxRtfCharacterPropertiesExporter.Create
    (FRtfExporter.DocumentModel, FRtfExporter.RtfExportHelper, FRtfBuilder,
    FRtfExporter.RtfOptions);
  FParagraphPropertiesExporter := TdxRtfParagraphPropertiesExporter.Create
    (FRtfExporter.DocumentModel, FRtfExporter.RtfExportHelper, FRtfBuilder);
end;
...
function TdxRtfNumberingListExporter.AddEscapedChar(ACh: Char;
  I: Integer): Integer;
begin
...
function TdxRtfNumberingListExporter.AddLevelNumber(const ADisplayFormatString
...
function TdxRtfNumberingListExporter.AddLevelNumberCore
  (const ADisplayFormatString: string; I: Integer): Integer;
var
  AValue: string;
  AIndex: Integer;
begin
  ...
  Text := Text + '\'#$27 + Format('%s',
    [LowerCase(IntToHex(StrToInt(AValue), 2))]);
  TextLength := TextLength + Length(AValue);
  Number := Number + '\'#$27 + Format('%s',
    [LowerCase(IntToHex(TextLength, 2))]);
  Result := I + Length(AValue) + 1 + 1;
  if ADisplayFormatString[AIndex + 1] = ':' then
    Inc(Result);
end;

class function TdxRtfNumberingListExporter.DoubleBrackets
  (const ADisplayFormatString: string; I: Integer): Boolean;
begin
  Result := ((ADisplayFormatString[I] = '%') and
    (ADisplayFormatString[I + 1] = '%')) or
    ((ADisplayFormatString[I] = '}') and (ADisplayFormatString[I + 1] = '}')) or
    ((ADisplayFormatString[I] = '{') and (ADisplayFormatString[I + 1] = '{'));
end;

procedure TdxRtfNumberingListExporter.Export(ANumberingLists
  : TdxNumberingListCollection; AStartIndex, ACount: Integer);
var
  AAbstractNumberingLists: TdxAbstractNumberingListCollection;
begin
  if ANumberingLists.Count <= 0 then
    Exit;
  AAbstractNumberingLists := GetAbstractNumberingLists(ANumberingLists,
    AStartIndex, ACount);
  try
...
procedure TdxRtfNumberingListExporter.ExportAbstractListLevelParagraphStyleIndex
  (AAbstractListLevel: TdxListLevel);
var
...
begin
  ...
  if (AParagraphStyleIndex < 0) or
    (AParagraphStyleIndex >= AParagraphStyles.Count) then
    Exit;
  FRtfExporter.WriteParagraphStyle
    (AParagraphStyles[AAbstractListLevel.ParagraphStyleIndex]);
end;

procedure TdxRtfNumberingListExporter.ExportAbstractNumberingList
...
begin
  ...
  begin
    FRtfBuilder.OpenGroup;
    FRtfBuilder.WriteCommand(TdxRtfExportSR.NumberingListStyleName,
      AList.StyleLink.StyleName);
    FRtfBuilder.CloseGroup;
  end
  else
  begin
    if AList.NumberingStyleReferenceIndex >= 0 then
      FRtfBuilder.WriteCommand(TdxRtfExportSR.NumberingListStyleId,
        AList.NumberingStyleReference.NumberingList.AbstractNumberingList.Id);
  end;
  FRtfBuilder.CloseGroup;
  if not FRtfExporter.RtfExportHelper.ListCollection.ContainsKey(AList.Id) then
    FRtfExporter.RtfExportHelper.ListCollection.Add(AList.Id,
      FRtfBuilder.RtfContent.ToString);
end;
...
procedure TdxRtfNumberingListExporter.ExportListLevel(const AListLevel
  : IdxListLevel);
var
  ANumberingListFormat: Integer;
begin
  ANumberingListFormat := GetNumberingListFormat
    (AListLevel.ListLevelProperties.Format);
  FRtfBuilder.OpenGroup;
  FRtfBuilder.WriteCommand(TdxRtfExportSR.ListLevel);
  FRtfBuilder.WriteCommand(TdxRtfExportSR.ListLevelNumberingFormat,
    ANumberingListFormat);
  FRtfBuilder.WriteCommand(TdxRtfExportSR.ListLevelNumberingFormatN,
    ANumberingListFormat);
  FRtfBuilder.WriteCommand(TdxRtfExportSR.ListLevelAlignment,
    Ord(AListLevel.ListLevelProperties.Alignment));
  FRtfBuilder.WriteCommand(TdxRtfExportSR.ListLevelAlignmentN,
    Ord(AListLevel.ListLevelProperties.Alignment));
  FRtfBuilder.WriteCommand(TdxRtfExportSR.ListLevelFollow,
    GetListLevelSeparator(AListLevel.ListLevelProperties.Separator));
  FRtfBuilder.WriteCommand(TdxRtfExportSR.ListLevelStart,
    AListLevel.ListLevelProperties.Start);
  ...
  begin
    ...
    FRtfBuilder.WriteCommand(TdxRtfExportSR.ListLevelLegacySpace,
      AListLevel.DocumentModel.UnitConverter.ModelUnitsToTwips
      (AListLevel.ListLevelProperties.LegacySpace));
    FRtfBuilder.WriteCommand(TdxRtfExportSR.ListLevelLegacyIndent,
      AListLevel.DocumentModel.UnitConverter.ModelUnitsToTwips
      (AListLevel.ListLevelProperties.LegacyIndent));
  end;
  ExportListLevelTextAndNumber
    (AListLevel.ListLevelProperties.DisplayFormatString,
    AListLevel.ListLevelProperties.TemplateCode);
...
procedure TdxRtfNumberingListExporter.
  ExportListLevelCharacterAndParagraphProperties(const AListLevel
  : IdxListLevel);
var
  AMergedCharacterProperties: TdxMergedCharacterProperties;
  AMergedParagraphProperties: TdxMergedParagraphProperties;
begin
  AMergedCharacterProperties := TdxMergedCharacterProperties.Create
    (AListLevel.CharacterProperties);
  try
    AMergedCharacterProperties.Merge
      (FRtfExporter.DocumentModel.DefaultCharacterProperties);
    AMergedCharacterProperties.Options.UseDoubleFontSize :=
      AListLevel.CharacterProperties.UseDoubleFontSize;
    AMergedCharacterProperties.Options.UseFontName :=
      AListLevel.CharacterProperties.UseFontName;
    FCharacterPropertiesExporter.ExportCharacterProperties
      (AMergedCharacterProperties, True, True, True);
  finally
    AMergedCharacterProperties.Free;
  end;
  ...
  AMergedParagraphProperties := TdxMergedParagraphProperties.Create
    (AListLevel.ParagraphProperties);
  try
    AMergedParagraphProperties.Merge
      (FRtfExporter.DocumentModel.DefaultParagraphProperties);
    FParagraphPropertiesExporter.WriteParagraphIndents
      (AMergedParagraphProperties);
  finally
    AMergedParagraphProperties.Free;
  end;
end;

procedure TdxRtfNumberingListExporter.ExportListLevels(AListLevelCollection
...
procedure TdxRtfNumberingListExporter.ExportListLevelTextAndNumber
  (const ADisplayFormatString: string; ALevelTemplateId: Integer);
begin
  FText := EmptyStr;
  FNumber := EmptyStr;
  ...
  FRtfBuilder.WriteTextDirect(Format('\''%s',
    [LowerCase(IntToHex(FTextLength, 2))]));
...
procedure TdxRtfNumberingListExporter.ExportListOverride(ANumberingList
  : TdxNumberingList);
var
...
begin
  ...
  FRtfBuilder.WriteCommand(TdxRtfExportSR.NumberingListId,
    ANumberingList.AbstractNumberingList.Id);
  AListOverrideCount := GetListOverrideCount(ANumberingList);
  FRtfBuilder.WriteCommand(TdxRtfExportSR.ListOverrideCount,
    AListOverrideCount);
  ...
  FRtfExporter.RtfExportHelper.ListOverrideCollection.Add
    (FRtfBuilder.RtfContent.ToString);
  if FRtfExporter.RtfExportHelper.ListOverrideCollectionIndex.ContainsKey
    (ANumberingList.Id) then
    FRtfExporter.RtfExportHelper.ListOverrideCollectionIndex.Add
      (ANumberingList.Id, AIndex);
end;

procedure TdxRtfNumberingListExporter.ExportListOverrideLevel
...
procedure TdxRtfNumberingListExporter.ExportListOverrideLevels
  (ANumberingList: TdxNumberingList);
var
  I: Integer;
...
procedure TdxRtfNumberingListExporter.ExportListOverrideTable(ANumberingLists
  : TdxNumberingListCollection; AStartIndex: TdxNumberingListIndex;
  ACount: Integer);
var
  I: Integer;
...
function TdxRtfNumberingListExporter.GetAbstractNumberingLists(ANumberingLists
  : TdxNumberingListCollection; AStartIndex: TdxNumberingListIndex;
  ACount: Integer): TdxAbstractNumberingListCollection;
var
  I: Integer;
...
function TdxRtfNumberingListExporter.GetListLevelSeparator
...
function TdxRtfNumberingListExporter.GetListOverrideCount(ANumberingList
  : TdxNumberingList): Integer;
var
  I: Integer;
  ALevels: TdxListLevelCollection;
begin
...
function TdxRtfNumberingListExporter.GetNumberingListFormat(ANumberingFormat
  : TdxNumberingFormat): Integer;
begin
...
procedure TdxRtfNumberingListExporter.GetTextAndNumber
...
function TdxRtfNumberingListExporter.IsOverrideLevel
  (AListLevel: TdxAbstractListLevel): Boolean;
begin
...
procedure TdxRtfNumberingListExporter.WriteListOverrideId(ANumberingList
  : TdxNumberingList);
begin
...
begin
  if Value <> DefaultKeepLinesTogether then
    RtfBuilder.WriteCommand(TdxRtfExportSR.KeepLinesTogether,
      IfThen(Value, 1, 0));
end;
...
begin
  case AFirstLineIndentType of
    TdxParagraphFirstLineIndent.Indented:
      Result := UnitConverter.ModelUnitsToTwips(AFirstLineIndent);
...
begin
  if not AParagraph.ShouldExportNumbering then
    Exit;
  RtfBuilder.WriteCommand(TdxRtfExportSR.LevelIndex,
    AParagraph.GetListLevelIndex);
...
begin
  ...
  if RtfExportHelper.SupportStyle and
    (AParagraph.ParagraphStyleIndex <> TdxParagraphStyleCollection.
    EmptyParagraphStyleIndex) then
    WriteParagraphStyle(AParagraph.ParagraphStyle);
  if AParagraph.TopBorder.Style <> TdxBorderLineStyle.None then
    WriteParagraphBorder(AParagraph.TopBorder,
      TdxRtfExportSR.TopParagraphBorder);
  if AParagraph.LeftBorder.Style <> TdxBorderLineStyle.None then
    WriteParagraphBorder(AParagraph.LeftBorder,
      TdxRtfExportSR.LeftParagraphBorder);
  if AParagraph.BottomBorder.Style <> TdxBorderLineStyle.None then
    WriteParagraphBorder(AParagraph.BottomBorder,
      TdxRtfExportSR.BottomParagraphBorder);
  if AParagraph.RightBorder.Style <> TdxBorderLineStyle.None then
    WriteParagraphBorder(AParagraph.RightBorder,
      TdxRtfExportSR.RightParagraphBorder);
...
begin
  ...
  if AInfo.BottomBorder.Style <> TdxBorderLineStyle.None then
    WriteParagraphBorder(AInfo.BottomBorder,
      TdxRtfExportSR.BottomParagraphBorder);
  if AInfo.RightBorder.Style <> TdxBorderLineStyle.None then
    WriteParagraphBorder(AInfo.RightBorder,
      TdxRtfExportSR.RightParagraphBorder);
  if not ACheckDefaultAlignment or
    (AInfo.Alignment <> TdxParagraphAlignment.Left) then
...
begin
  if Value <> DefaultAfterAutoSpacing then
    RtfBuilder.WriteCommand(TdxRtfExportSR.AfterAutoSpacing,
      IfThen(Value, 1, 0));
end;
...
begin
  case Alignment of
    TdxParagraphAlignment.Left:
      RtfBuilder.WriteCommand(TdxRtfExportSR.LeftAlignment);
    TdxParagraphAlignment.Center:
      RtfBuilder.WriteCommand(TdxRtfExportSR.CenterAlignment);
    TdxParagraphAlignment.Justify:
      RtfBuilder.WriteCommand(TdxRtfExportSR.JustifyAlignment);
    TdxParagraphAlignment.Right:
      RtfBuilder.WriteCommand(TdxRtfExportSR.RightAlignment);
  end;
end;
...
begin
  if Value <> DefaultBeforeAutoSpacing then
    RtfBuilder.WriteCommand(TdxRtfExportSR.BeforeAutoSpacing,
      IfThen(Value, 1, 0));
end;
...
begin
  ...
  AFirstLineIndent := CalcRtfFirstLineIndent
    (AParagraphPropertiesInfo.FirstLineIndentType,
    AParagraphPropertiesInfo.FirstLineIndent);
  if AFirstLineIndent <> DefaultParagraphFirstLineIndent then
    RtfBuilder.WriteCommand(TdxRtfExportSR.FirstLineIndentInTwips,
      AFirstLineIndent);
  ...
  begin
    ...
    RtfBuilder.WriteCommand(TdxRtfExportSR.RightIndentInTwips_Rin,
      ARightIndent);
  end;
end;
...
begin
  case AParagraphLineSpacingType of
    TdxParagraphLineSpacing.AtLeast:
      WriteRtfLineSpacing(UnitConverter.ModelUnitsToTwips
        (Trunc(AParagraphLineSpacing)), AtLeastLineSpacingMultiple);
    TdxParagraphLineSpacing.Exactly:
      WriteRtfLineSpacing(-UnitConverter.ModelUnitsToTwips
        (Trunc(AParagraphLineSpacing)), ExactlyLineSpacingMultiple);
    TdxParagraphLineSpacing.Double:
      WriteRtfLineSpacing(DoubleIntervalRtfLineSpacingValue,
        MultipleLineSpacing);
    TdxParagraphLineSpacing.Sesquialteral:
      WriteRtfLineSpacing(SesquialteralIntervalRtfLineSpacingValue,
        MultipleLineSpacing);
    TdxParagraphLineSpacing.Multiple:
      WriteRtfLineSpacing(Trunc(AParagraphLineSpacing *
        SingleIntervalRtfLineSpacingValue), MultipleLineSpacing);
  end;
end;
...
begin
  RtfBuilder.WriteCommand(TdxRtfExportSR.ListIndex,
    DocumentModel.NumberingLists[AIndex].Id);
end;
...
begin
  if Value <> DefaultPageBreakBefore then
    RtfBuilder.WriteCommand(TdxRtfExportSR.PageBreakBefore,
      IfThen(Value, 1, 0));
end;
...
begin
  if ASpacingAfter <> DefaultParagraphSpacingAfter then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SpaceAfter,
      UnitConverter.ModelUnitsToTwips(ASpacingAfter));
end;
...
begin
  if ASpacingBefore <> DefaultParagraphSpacingBefore then
    RtfBuilder.WriteCommand(TdxRtfExportSR.SpaceBefore,
      UnitConverter.ModelUnitsToTwips(ASpacingBefore));
end;

procedure TdxRtfParagraphPropertiesExporter.WriteParagraphStyle(AParagraphStyle
  : TdxParagraphStyle);
var
  AStyleName: string;
  AStyleCollection: TdxNamedOrdinalDictionary<Integer>;
...
begin
  if AParagraphSuppressHyphenation <> DefaultSuppressHyphenation then
    RtfBuilder.WriteCommand(TdxRtfExportSR.AutomaticParagraphHyphenation,
      IfThen(AParagraphSuppressHyphenation, 0, 1));
end;
...
procedure TdxRtfParagraphPropertiesExporter.WriteTabInfo(const ATabInfo
  : TdxTabInfo);
begin
...
begin
  ...
  if ANestingLevel > 1 then
    RtfBuilder.WriteCommand(TdxRtfExportSR.ParagraphNestingLevel,
      ANestingLevel);
end;

procedure TdxRtfParagraphPropertiesExporter.WriteTabs(ATabFormattingInfo
...
begin
  RtfBuilder.WriteCommand(TdxRtfExportSR.RtfLineSpacingValue,
    ARtfLineSpacingValue);
  RtfBuilder.WriteCommand(TdxRtfExportSR.RtfLineSpacingMultiple,
    ARtfLineSpacingMultiple);
end;

procedure TdxRtfParagraphPropertiesExporter.WriteTabKind(AlignmentType
  : TdxTabAlignmentType);
begin
...
procedure TdxRtfParagraphPropertiesExporter.WriteTabPosition
  (APosition: Integer);
begin
  RtfBuilder.WriteCommand(TdxRtfExportSR.TabPosition,
    UnitConverter.ModelUnitsToTwips(APosition));
end;

procedure TdxRtfParagraphPropertiesExporter.WriteParagraphBorder
  (ATopBorder: TdxBorderInfo; const ACommand: string);
var
  ADefaultBorder: TdxBorderInfo;
begin
  ADefaultBorder := DocumentModel.Cache.BorderInfoCache.DefaultItem;
...
procedure TdxRtfParagraphPropertiesExporter.WriteFrameProperties
  (AProperties: TdxFrameProperties);
begin
  ...
  if AProperties.UseHorizontalPosition then
    RtfBuilder.WriteCommand(TdxRtfExportSR.FrameHorizontalPosition,
      AProperties.HorizontalPosition);
  if AProperties.UseVerticalPosition then
    RtfBuilder.WriteCommand(TdxRtfExportSR.FrameVerticalPosition,
      AProperties.VerticalPosition);
...
procedure TdxRtfParagraphPropertiesExporter.WriteParagraphVerticalPositionType
  (APositionType: TdxParagraphFrameVerticalPositionType);
begin
  case APositionType of
    TdxParagraphFrameVerticalPositionType.Margin:
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.ParagraphVerticalPositionTypeMargin);
...
procedure TdxRtfParagraphPropertiesExporter.WriteParagraphHorizontalPositionType
  (APositionType: TdxParagraphFrameHorizontalPositionType);
begin
  case APositionType of
    TdxParagraphFrameHorizontalPositionType.Margin:
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.ParagraphHorizontalPositionTypeMargin);
    TdxParagraphFrameHorizontalPositionType.Page:
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.ParagraphHorizontalPositionTypePage);
    TdxParagraphFrameHorizontalPositionType.Column:
      RtfBuilder.WriteCommand
        (TdxRtfExportSR.ParagraphHorizontalPositionTypeColumn);
  end;
end;

procedure TdxRtfParagraphPropertiesExporter.WriteParagraphWrapType
  (AWrapType: TdxParagraphFrameTextWrapType);
begin
  case AWrapType of
...
begin
  ...
  FRtfBuilder := ARtfBuilder;
  FCharacterPropertiesExporter := TdxRtfCharacterPropertiesExporter.Create
    (ADocumentModel, RtfExportHelper, RtfBuilder, AOptions);
  FParagraphPropertiesExporter := TdxRtfParagraphPropertiesExporter.Create
    (ADocumentModel, RtfExportHelper, RtfBuilder);
end;
...
begin
  AMergedProperties := TdxMergedCharacterProperties.Create
    (ACharacterProperties);
  try
    AMergedProperties.Merge(DocumentModel.DefaultCharacterProperties);
    CharacterExporter.ExportCharacterProperties(AMergedProperties, True,
      False, False);
  finally
...
var
  ...
  AMergedCharacterProperties: TdxMergedCharacterProperties;
begin
  if AStyle.Deleted or RtfExportHelper.CharacterStylesCollectionIndex.
    ContainsKey(AStyle.StyleName) then
    Exit;

  AStyleIndex := GetNextFreeStyleIndex;
  RtfExportHelper.CharacterStylesCollectionIndex.Add(AStyle.StyleName,
    AStyleIndex);
  RtfBuilder.OpenGroup;
...
procedure TdxRtfStyleExporter.ExportCharacterStyles(ACharacterStyles
  : TdxCharacterStyleCollection);
var
  ACount: Integer;
  I: Integer;
...
procedure TdxRtfStyleExporter.ExportParagraphProperties(AParagraphProperties
  : TdxParagraphProperties; AMergedParagraphProperties
  : TdxMergedParagraphProperties);
var
...
begin
  ...
  try
    ...
    if AInfo.TopBorder.Style <> TdxBorderLineStyle.None then
      FParagraphPropertiesExporter.WriteParagraphBorder(AInfo.TopBorder,
        TdxRtfExportSR.TopParagraphBorder);
    if AInfo.LeftBorder.Style <> TdxBorderLineStyle.None then
      FParagraphPropertiesExporter.WriteParagraphBorder(AInfo.LeftBorder,
        TdxRtfExportSR.LeftParagraphBorder);
    if AInfo.BottomBorder.Style <> TdxBorderLineStyle.None then
      FParagraphPropertiesExporter.WriteParagraphBorder(AInfo.BottomBorder,
        TdxRtfExportSR.BottomParagraphBorder);
    if AInfo.RightBorder.Style <> TdxBorderLineStyle.None then
      FParagraphPropertiesExporter.WriteParagraphBorder(AInfo.RightBorder,
        TdxRtfExportSR.RightParagraphBorder);
    FParagraphPropertiesExporter.WriteParagraphAlignment(AInfo.Alignment);
    FParagraphPropertiesExporter.WriteParagraphIndents
      (AMergedParagraphProperties);
    FParagraphPropertiesExporter.WriteParagraphSuppressHyphenation
      (AInfo.SuppressHyphenation);
    FParagraphPropertiesExporter.WriteParagraphSuppressLineNumbers
      (AInfo.SuppressLineNumbers);
    FParagraphPropertiesExporter.WriteParagraphContextualSpacing
      (AInfo.ContextualSpacing);
    FParagraphPropertiesExporter.WriteParagraphPageBreakBefore
      (AInfo.PageBreakBefore);
    ...
    FParagraphPropertiesExporter.WriteParagraphLineSpacing
      (AInfo.LineSpacingType, AInfo.LineSpacing);
    FParagraphPropertiesExporter.WriteParagraphSpacingBefore
      (AParagraphProperties.SpacingBefore);
    FParagraphPropertiesExporter.WriteParagraphSpacingAfter
      (AParagraphProperties.SpacingAfter);
  finally
    AMergedProperties.Free;
  end;
end;
...
begin
  ...
  try
    ExportParagraphProperties(AStyle.ParagraphProperties,
      AMergedParagraphProperties);
  finally
    AMergedParagraphProperties.Free;
  end;
  ...
  begin
    RtfBuilder.WriteCommand(TdxRtfExportSR.ListIndex,
      GetListId(AStyle.GetNumberingListIndex));
...
procedure TdxRtfStyleExporter.ExportParagraphStyles(AParagraphStyles
  : TdxParagraphStyleCollection);
var
...
begin
  ...
  try
    ...
    AStyles := TdxTopologicalSorter<TdxParagraphStyle>.Sort(AList,
      TdxStyleTopologicalComparer<TdxParagraphStyle>.Create);
    try
      ...
      try
        ...
        begin
          AStyle := AStyles[I];
          if not AStyle.Deleted and
            not RtfExportHelper.ParagraphStylesCollectionIndex.ContainsKey
            (AStyle.StyleName) then
          begin
            AStylesToWrite.Add(AStyle);
            AStyleIndex := GetNextFreeStyleIndex;
            RtfExportHelper.ParagraphStylesCollectionIndex.Add(AStyle.StyleName,
              AStyleIndex);
          end;
        end;
...
procedure TdxRtfStyleExporter.ExportStyleSheet(AParagraphStyles
  : TdxParagraphStyleCollection; ACharacterStyles: TdxCharacterStyleCollection;
  ATableStyles: TdxTableStyleCollection);
begin
...
procedure TdxRtfStyleExporter.ExportTableCellProperties(ATableCellProperties
  : TdxTableCellProperties; AMergedTableCellProperties
  : TdxMergedTableCellProperties);
var
  AMergedProperties: TdxMergedTableCellProperties;
  AInfo: TdxCombinedCellPropertiesInfo;
begin
  AMergedProperties := TdxMergedTableCellProperties.Create
    (AMergedTableCellProperties);
  try
    AMergedProperties.Merge(DocumentModel.DefaultTableCellProperties);
    AInfo := AMergedProperties.Info;

    FTableCellPropertiesExporter.WriteCellMerging
      (ATableCellProperties.VerticalMerging);

    FTableCellPropertiesExporter.WriteCellVerticalAlignment
      (AInfo.GeneralSettings.VerticalAlignment);
    FTableCellPropertiesExporter.WriteCellBackgroundColor
      (AInfo.GeneralSettings.BackgroundColor);
    FTableCellPropertiesExporter.WriteCellForegroundColor
      (AInfo.GeneralSettings.ForegroundColor);
    FTableCellPropertiesExporter.WriteCellShading
      (AInfo.GeneralSettings.Shading);
    FTableCellPropertiesExporter.WriteCellBasicBorders(AInfo.Borders.TopBorder,
      AInfo.Borders.LeftBorder, AInfo.Borders.RightBorder,
      AInfo.Borders.BottomBorder);
    FTableCellPropertiesExporter.WriteCellTextDirection
      (AInfo.GeneralSettings.TextDirection);
    FTableCellPropertiesExporter.WriteCellFitText
      (AInfo.GeneralSettings.FitText);
    FTableCellPropertiesExporter.WriteCellNoWrap(AInfo.GeneralSettings.NoWrap);
    FTableCellPropertiesExporter.WriteCellHideCellMark
      (AInfo.GeneralSettings.HideCellMark);
    FTableCellPropertiesExporter.WriteCellPreferredWidth(AInfo.PreferredWidth);
    FTableCellPropertiesExporter.WriteCellMargins(AInfo.CellMargins.Top,
      AInfo.CellMargins.Left, AInfo.CellMargins.Right,
      AInfo.CellMargins.Bottom);
  finally
    AMergedProperties.Free;
  end;
end;

procedure TdxRtfStyleExporter.ExportTableConditionalStyle(AConditionalStyle
  : TdxTableConditionalStyle; const AStyleName: string; AStyleIndex: Integer);
var
  AMergedCharacterProperties: TdxMergedCharacterProperties;
  AMergedParagraphProperties: TdxMergedParagraphProperties;
  AMergedTableRowProperties: TdxMergedTableRowProperties;
...
begin
  ...
  try
    ExportParagraphProperties(AConditionalStyle.ParagraphProperties,
      AMergedParagraphProperties);
  finally
    AMergedParagraphProperties.Free;
  end;
  ...
  try
    ExportTableRowProperties(AConditionalStyle.TableRowProperties,
      AMergedTableRowProperties);
  finally
    AMergedTableRowProperties.Free;
  end;
  AMergedTableCellProperties := AConditionalStyle.GetMergedTableCellProperties;
  try
    ExportTableCellProperties(AConditionalStyle.TableCellProperties,
      AMergedTableCellProperties);
  finally
...
procedure TdxRtfStyleExporter.ExportTableProperties(ATableProperties
  : TdxTableProperties; AMergedTableProperties: TdxMergedTableProperties;
  AExportRowProperties, AExportColProperties: Boolean);
var
...
begin
  ...
  try
    ...
    FTablePropertiesExporter.ExportTableProperties(AMergedProperties,
      AExportRowProperties, AExportColProperties);
  finally
    AMergedProperties.Free;
  end;
end;

procedure TdxRtfStyleExporter.ExportTableRowProperties(ATableRowProperties
  : TdxTableRowProperties; AMergedTableRowProperties
  : TdxMergedTableRowProperties);
var
  AMergedProperties: TdxMergedTableRowProperties;
  AProp: TdxCombinedTableRowPropertiesInfo;
begin
  AMergedProperties := TdxMergedTableRowProperties.Create
    (AMergedTableRowProperties);
  try
    AMergedProperties.Merge(DocumentModel.DefaultTableRowProperties);
    AProp := AMergedProperties.Info;

    FTableRowPropertiesExporter.WriteRowAlignment
      (AProp.GeneralSettings.TableRowAlignment);
    ...
    FTableRowPropertiesExporter.WriteRowCantSplit
      (ATableRowProperties.CantSplit);
...
begin
  if AStyle.Deleted then
    Exit;
  if RtfExportHelper.TableStylesCollectionIndex.ContainsKey(AStyle.StyleName)
  then
    Exit;
  AStyleIndex := GetNextFreeStyleIndex;
  ...
  try
    ExportTableProperties(AStyle.TableProperties, AMergedTableProperties,
      AStyle.HasRowBandingStyleProperties,
      AStyle.HasColumnBandingStyleProperties);
  finally
  ...
  begin
    AStyle.ConditionalStyleProperties.ForEachStyle(
      procedure(const Sender: TdxTableConditionalStyle)
      begin
...
procedure TdxRtfStyleExporter.ExportTableStyles(ATableStyles
  : TdxTableStyleCollection);
var
  ACount, I: Integer;
begin
  RtfBuilder.Clear;
  FTablePropertiesExporter := TdxRtfTableStyleTablePropertiesExporter.Create
    (DocumentModel, RtfExportHelper, RtfBuilder);
  FTableRowPropertiesExporter := TdxRtfTableRowPropertiesExporter.Create
    (DocumentModel, RtfExportHelper, RtfBuilder);
  FTableCellPropertiesExporter := TdxRtfTableStyleTableCellPropertiesExporter.
    Create(DocumentModel, RtfExportHelper, RtfBuilder);
  try
...
begin
  Result := ObtainStyleIndex(AStyle,
    RtfExportHelper.CharacterStylesCollectionIndex);
end;
...
begin
  Result := ObtainStyleIndex(AStyle,
    RtfExportHelper.ParagraphStylesCollectionIndex);
end;
...
function TdxRtfStyleExporter.ObtainTableStyleIndex
  (AStyle: TdxTableStyle): Integer;
begin
  Result := ObtainStyleIndex(AStyle,
    RtfExportHelper.TableStylesCollectionIndex);
end;

procedure TdxRtfStyleExporter.WriteConditionalStyleType(AConditionType
  : TdxConditionalTableStyleFormattingType);
var
  AKeyWord: string;
begin
  if TdxRtfContentExporter.ConditionalStylesTypesTryGetValue(AConditionType,
    AKeyWord) then
    RtfBuilder.WriteCommand(AKeyWord);
end;
