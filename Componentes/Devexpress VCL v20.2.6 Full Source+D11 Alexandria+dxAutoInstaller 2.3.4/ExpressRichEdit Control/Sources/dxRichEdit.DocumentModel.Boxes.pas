...
type
  ...
  protected
    ...
    function CreateDetailRowForBoxCore(ARow: TdxRow; ABox: TdxBox)
      : TdxDetailRow;
  ...
  public
    ...
    destructor Destroy; override;
    function CreateLayoutPosition(APieceTable: TdxCustomPieceTable;
      ALogPosition: TdxDocumentLogPosition; APreferredPageIndex: Integer)
      : TObject;
    function CreateDetailRow(ARow: TdxRow): TdxDetailRow;
    function CreateDetailRowForBox(ARow: TdxRow; ABox: TdxBox;
      ASuppressSuspendFormatting: Boolean): TdxDetailRow;

    property DocumentModel: TdxCustomDocumentModel read FDocumentModel;
    property UnitConverter: TdxDocumentLayoutUnitConverter
      read GetUnitConverter;
    ...
    property FirstVisiblePageIndex: Integer read FFirstVisiblePageIndex
      write FFirstVisiblePageIndex;
    property LastVisiblePageIndex: Integer read FLastVisiblePageIndex
      write FLastVisiblePageIndex;
    property OnAfterCreateDetailRow: TdxNotifyEventHandler
      read FOnAfterCreateDetailRow;
    property OnBeforeCreateDetailRow: TdxNotifyEventHandler
      read FOnBeforeCreateDetailRow;
  end;
  ...
  public
    ...
    procedure ExportTo(const AExporter
      : IdxSimpleDocumentLayoutExporter); override;
    function CreateHitTestManager(const ACalculator
      : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager; override;
  ...
  strict private
    class var FZOrderComparer: TdxBoxBaseComparer;
  ...
  public
    ...
    function CalcAscentAndFree(APieceTable: TdxCustomPieceTable)
      : Integer; override;
    function CalcBaseAscentAndFree(APieceTable: TdxCustomPieceTable)
      : Integer; override;
    function CalcBaseDescent(APieceTable: TdxCustomPieceTable)
      : Integer; override;
    procedure ExportTo(const AExporter
      : IdxSimpleDocumentLayoutExporter); override;
    function CreateHitTestManager(const ACalculator
    ...
    class function CreateTransformUnsafe(const AAngle: Single;
      const ABounds: TRect): TdxTransformMatrix; overload;
    ...
    property CanPutTextAtLeft: Boolean read FCanPutTextAtLeft
      write FCanPutTextAtLeft;
    property CanPutTextAtRight: Boolean read FCanPutTextAtRight
      write FCanPutTextAtRight;
    property PutTextAtLargestSide: Boolean read FPutTextAtLargestSide
      write FPutTextAtLargestSide;
  ...
  strict private
    class var FIndexComparer: TdxBoxBaseComparer;
    class constructor Initialize;
    class destructor Finalize;
  strict private
    FCanPutTextAtLeft: Boolean;
  ...
  public
    ...
    constructor Create(APieceTable: TdxSimplePieceTable;
      AParagraphIndex: TdxParagraphIndex); overload;
    destructor Destroy; override;
    ...
    function CreateHitTestManager(const ACalculator
      : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager; override;
    class function CreateTransformUnsafe(AAngle: Single; const ABounds: TRect)
      : TdxTransformMatrix; overload;
    function CreateBackwardTransformUnsafe: TdxTransformMatrix;
    function CreateTransformUnsafe: TdxTransformMatrix; overload;
    ...
    property LastParagraphIndex: TdxParagraphIndex read FLastParagraphIndex
      write FLastParagraphIndex;
  ...
  private
    ...
    function FindFloatingObject(AObjects: TdxFloatingObjectBoxList;
      ARun: TdxFloatingObjectAnchorRun): TdxFloatingObjectBox; overload;
  protected
  ...
  public
    ...
    procedure ClearInvalidatedContent(ARunIndex: TdxRunIndex;
      APieceTable: TdxCustomPieceTable);
    procedure ClearFloatingObjects(APieceTable: TdxCustomPieceTable;
      ARunIndex: TdxRunIndex; AObjects: TdxFloatingObjectBoxList); overload;
    procedure ClearFootNotes(ARunIndex: TdxRunIndex);
    procedure ClearComments(APieceTable: TdxCustomPieceTable;
      ARunIndex: TdxRunIndex);
    procedure ClearParagraphFrames; overload;
    procedure ClearParagraphFrames(APieceTable: TdxCustomPieceTable;
      ARunIndex: TdxRunIndex; AItems: TdxParagraphFrameBoxList); overload;
    function FindFloatingObject(ARun: TdxFloatingObjectAnchorRun)
    ...
    function GetFirstPosition(APieceTable: TdxCustomPieceTable)
      : TdxDocumentModelPosition; override; final;
    function GetLastPosition(APieceTable: TdxCustomPieceTable)
      : TdxDocumentModelPosition; override; final;

    function CreateHitTestManager(const ACalculator
      : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
      override; final;
    procedure ExportTo(const AExporter
      : IdxSimpleDocumentLayoutExporter); override;
    procedure MoveVertically(ADeltaY: Integer); override; final;
    ...
    property PrimaryFormattingComplete: Boolean read FPrimaryFormattingComplete
      write FPrimaryFormattingComplete;
    property SecondaryFormattingComplete: Boolean
      read FSecondaryFormattingComplete write FSecondaryFormattingComplete;
    property CheckSpellingComplete: Boolean read FCheckSpellingComplete
      write FCheckSpellingComplete;
    property PageIndex: Integer read FPageIndex write FPageIndex;
    property NumPages: Integer read FNumPages write FNumPages;
    property NumSkippedPages: Integer read FNumSkippedPages
      write FNumSkippedPages;
    ...
    property InnerFloatingObjects: TdxFloatingObjectBoxList
      read FInnerFloatingObjects;
    property FloatingObjects: TdxFloatingObjectBoxList read GetFloatingObjects;
    property InnerForegroundFloatingObjects: TdxFloatingObjectBoxList
      read FInnerForegroundFloatingObjects;
    property ForegroundFloatingObjects: TdxFloatingObjectBoxList
      read GetForegroundFloatingObjects;
    property InnerBackgroundFloatingObjects: TdxFloatingObjectBoxList
      read FInnerBackgroundFloatingObjects;
    property BackgroundFloatingObjects: TdxFloatingObjectBoxList
      read GetBackgroundFloatingObjects;
    property InnerParagraphFrames: TdxParagraphFrameBoxList
      read FInnerParagraphFrames;
    property ParagraphFrames: TdxParagraphFrameBoxList
      read GetParagraphFramesProperty;
  ...
  public
    procedure RegisterSuccessfulItemHitTest(ACalculator
      : TdxBoxHitTestCustomCalculator; AItem: TdxBox); override;
    procedure RegisterFailedItemHitTest(ACalculator
      : TdxBoxHitTestCustomCalculator); override;
  end;
  ...
  public
    ...
    function GetFirstPosition(APieceTable: TdxCustomPieceTable)
      : TdxDocumentModelPosition; override;
    function GetLastPosition(APieceTable: TdxCustomPieceTable)
      : TdxDocumentModelPosition; override;
    class function CreateBox: TdxBox; override;
    procedure ExportTo(const AExporter
  ...
  public
    procedure RegisterSuccessfulItemHitTest(ACalculator
      : TdxBoxHitTestCustomCalculator; AItem: TdxBox); override; final;
    procedure RegisterFailedItemHitTest(ACalculator
      : TdxBoxHitTestCustomCalculator); override; final;
  end;
  ...
  public
    constructor Create(AFootNote: TdxFootNote; ASection: TdxSection;
      AReferenceRunIndex: TdxRunIndex);
  ...
  private
    function GetItem(Index: Integer): TdxFootNotePageArea; inline;
  public
  ...
  TdxParagraphFrameBoxCollection = class sealed
    (TdxObjectList<TdxParagraphFrameBox>) // for internal use
  public
  ...
  public
    ...
    property InnerParagraphFrames: TdxParagraphFrameBoxCollection
      read FParagraphFrames;
    property ParagraphFrames: TdxParagraphFrameBoxCollection
  ...
  public
    ...
    procedure ClearInvalidatedParagraphFramesCore(AFrom,
    ...
    property ParagraphFrames: TdxParagraphFrameBoxCollection
      read GetParagraphFrames;
    property ShouldProcessParagraphFrames: Boolean
      read GetShouldProcessParagraphFrames;
    property InnerParagraphFrames: TdxParagraphFrameBoxCollection
      read GetInnerParagraphFrames;
    property Tables: TdxTableViewInfoCollection read GetTables;
    property IsEmpty: Boolean read GetIsEmpty;
  ...
  public
    ...
    procedure IncreaseHeight(ADelta: Integer);
    function CalcDescent(APieceTable: TdxCustomPieceTable): Integer; override;
    function GetFloatingObjectRun(APieceTable: TdxCustomPieceTable)
    ...
    property ActualBounds: TRect read FActualBounds write FActualBounds;
    property ContentBounds: TRect read FContentBounds write FContentBounds;
    property FloatingObjectBox: TdxFloatingObjectBox read FFloatingObjectBox
      write SetFloatingObjectBox;
    property ShapeBounds: TRect read FShapeBounds write FShapeBounds;
  end;
  ...
  public
    function GetFontInfo(APieceTable: TdxCustomPieceTable)
      : TdxFontInfo; override;

    property ForceUpdateCurrentRowHeight: Boolean
      read GetForceUpdateCurrentRowHeight;
  end;
  ...
  public
    class function CreateBox: TdxBox; override;
    function GetNumerationCharacterProperties(APieceTable: TdxCustomPieceTable)
    ...
    function GetDocumentPosition(APieceTable: TdxCustomPieceTable;
      const APos: TdxFormatterPosition): TdxDocumentModelPosition; override;
    function GetFirstFormatterPosition: TdxFormatterPosition; override;
    function GetLastFormatterPosition: TdxFormatterPosition; override;
    function GetFirstPosition(APieceTable: TdxCustomPieceTable)
      : TdxDocumentModelPosition; override;
    ...
    function GetFontInfo(APieceTable: TdxCustomPieceTable)
      : TdxFontInfo; override;
    function GetActualForeColor(APieceTable: TdxCustomPieceTable;
      ATextColors: TdxTextColors; ABackColor: TdxAlphaColor)
      : TdxAlphaColor; override;
    function GetUnderlineColorCore(APieceTable: TdxCustomPieceTable)
      : TdxAlphaColor; override;
    function GetStrikeoutColorCore(APieceTable: TdxCustomPieceTable)
      : TdxAlphaColor; override;
    function GetFontStrikeoutType(APieceTable: TdxCustomPieceTable)
      : TdxStrikeoutType; override;
    function GetFontUnderlineType(APieceTable: TdxCustomPieceTable)
    ...
    property NumberingListText: string read FNumberingListText
      write FNumberingListText;
  end;
  ...
  public
    ...
    function ExactPageAreaAndLogPositionCompare(const Value
      : TdxBoxBase): Integer;
  ...
  public
    ...
    property NumberingListBox: TdxNumberingListBox read FNumberingListBox
      write SetNumberingListBox;
  end;
  ...
  public
    ...
    procedure ExportTo(const AExporter
      : IdxSimpleDocumentLayoutExporter); virtual;
  ...
  strict private
    ...
    FText: string;
  public
    constructor Create(ARun: TdxLineNumberCommonRun; ARow: TdxRow;
      const AText: string);
    function CreateHitTestManager(const ACalculator
      : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager; override;
    class function CreateBox: TdxBox; override;
  ...
  protected
    property InnerBookmarkBoxes: TdxVisitableDocumentIntervalBoxCollection
      read FBookmarkBoxes;
    property InnerCommentBoxes: TdxVisitableDocumentIntervalBoxCollection
      read FCommentBoxes;
    property InnerCommentHighlightAreas: TdxHighlightAreaCollection
      read FCommentHighlightAreas;
    property InnerCustomMarkBoxes: TdxCustomMarkBoxCollection
      read FCustomMarkBoxes;
    property InnerFieldHighlightAreas: TdxHighlightAreaCollection
      read FFieldHighlightAreas;
    property InnerRangePermissionBoxes
      : TdxVisitableDocumentIntervalBoxCollection read FRangePermissionBoxes;
    property InnerRangePermissionHighlightAreas: TdxHighlightAreaCollection
      read FRangePermissionHighlightAreas;
  public
    destructor Destroy; override;
    ...
    property BookmarkBoxes: TdxVisitableDocumentIntervalBoxCollection
      read GetBookmarkBoxes;
    property CommentBoxes: TdxVisitableDocumentIntervalBoxCollection
      read GetCommentBoxes;
    property CommentHighlightAreas: TdxHighlightAreaCollection
      read GetCommentHighlightAreas;
    property CustomMarkBoxes: TdxCustomMarkBoxCollection
      read GetCustomMarkBoxes;
    property FieldHighlightAreas: TdxHighlightAreaCollection
      read GetFieldHighlightAreas;
    property RangePermissionBoxes: TdxVisitableDocumentIntervalBoxCollection
      read GetRangePermissionBoxes;
    property RangePermissionHighlightAreas: TdxHighlightAreaCollection
  ...
  strict private
    ...
    function GetInnerRangePermissionBoxes
      : TdxVisitableDocumentIntervalBoxCollection;
    function GetFieldHighlightAreas: TdxHighlightAreaCollection;
    function GetParagraph: TdxSimpleParagraph;
    function GetRangePermissionHighlightAreas: TdxHighlightAreaCollection;
    function GetCommentHighlightAreas: TdxHighlightAreaCollection;
  ...
  public
    ...
    procedure ClearCommentBoxes;
    procedure ClearCustomMarkBoxes;
    function GetBookmarkBoxesCore
      : TdxVisitableDocumentIntervalBoxCollection; override;
    function GetRangePermissionBoxesCore
      : TdxVisitableDocumentIntervalBoxCollection; override;
    ...
    property InnerBookmarkBoxes: TdxVisitableDocumentIntervalBoxCollection
      read GetInnerBookmarkBoxes;
    property InnerFieldHighlightAreas: TdxHighlightAreaCollection
      read GetInnerFieldHighlightAreas;
    property InnerRangePermissionBoxes
      : TdxVisitableDocumentIntervalBoxCollection
      read GetInnerRangePermissionBoxes;
    property FieldHighlightAreas: TdxHighlightAreaCollection
      read GetFieldHighlightAreas;
    property RangePermissionHighlightAreas: TdxHighlightAreaCollection
      read GetRangePermissionHighlightAreas;
    ...
    property CommentHighlightAreas: TdxHighlightAreaCollection
      read GetCommentHighlightAreas;
    property InnerCommentHighlightAreas: TdxHighlightAreaCollection
      read GetInnerCommentHighlightAreas;
    property InnerRangePermissionHighlightAreas: TdxHighlightAreaCollection
      read GetInnerRangePermissionHighlightAreas;
    property NumberingListBox: TdxNumberingListBox read FNumberingListBox
      write SetNumberingListBox;
    property RangePermissionBoxes: TdxVisitableDocumentIntervalBoxCollection
      read GetRangePermissionBoxes;
  ...
  public
    ...
    property CellViewInfo: TdxTableCellViewInfo read FCellViewInfo
      write FCellViewInfo;
  end;
  ...
  public
    ...
    class function GetRows(ARows: TdxRowCollection; ACell: TdxTableCell)
      : TdxRowCollection; overload; static;
    ...
    property InitialContentTop: TdxLayoutUnit read FInitialContentTop
      write FInitialContentTop;
  ...
  TdxTableCellViewInfoCollection = class
    (TdxReferencedObjectList<TdxTableCellViewInfo>) // for internal use
  public
  ...
  protected
    ...
    function GetConverter: TdxDocumentModelUnitToLayoutUnitConverter;
      virtual; abstract;
  public
    function GetBounds(ATableViewInfo: TdxTableViewInfo): TRect;
      virtual; abstract;
    ...
    property Converter: TdxDocumentModelUnitToLayoutUnitConverter
      read GetConverter;
    procedure ExportTo(ATableViewInfo: TdxTableViewInfo;
  ...
  public
    constructor Create(ABorderInfo: TdxBorderInfo;
      AConverter: TdxDocumentModelUnitToLayoutUnitConverter;
      ACornerAtLeft: TdxCornerViewInfoBase;
  ...
  public
    ...
    class function CreateCorner(AConverter
      : TdxDocumentModelUnitToLayoutUnitConverter;
      ABorderAtLeft, ABorderAtTop, ABorderAtRight, ABorderAtBottom
      : TdxBorderInfo; ACellSpacing: TdxModelUnit): TdxCornerViewInfoBase;
      overload; static;
    ...
    procedure Export(const AExporter: IdxDocumentLayoutExporter; X, Y: Integer);
      virtual; abstract;

    property CornerType: TdxCornerViewInfoType read FCornerType
      write FCornerType;
  ...
  public
    constructor Create;
    procedure Export(const AExporter: IdxDocumentLayoutExporter;
  ...
  protected
    ...
    class constructor Initialize;
  public
    constructor Create(ALeftBorder, ARightBorder, ATopBorder,
      ABottomBorder: TdxBorderInfo; const AWidth, AHeight: Single;
      ACornerType: TdxCornerViewInfoType);
    destructor Destroy; override;
    procedure Export(const AExporter: IdxDocumentLayoutExporter;
      X, Y: Integer); override;
  end;
  ...
  TdxTableCellVerticalAnchor = class(TcxIUnknownObject) // for internal use
  strict private
  ...
  public
    constructor Create(AVerticalPosition, ABottomTextIndent: TdxLayoutUnit;
      ACellBorders: TdxHorizontalCellBordersInfoList);
    destructor Destroy; override;

    function CloneWithNewVerticalPosition(ANewVerticalPosition: TdxLayoutUnit)
      : TdxTableCellVerticalAnchor;
    procedure MoveVertically(ADeltaY: TdxLayoutUnit); virtual;

    property VerticalPosition: TdxLayoutUnit read FVerticalPosition
      write FVerticalPosition;
    ...
    property TopTextIndent: TdxLayoutUnit read FTopTextIndent
      write FTopTextIndent;
  end;

  TdxTableCellVerticalAnchorList = class sealed
    (TdxList<TdxTableCellVerticalAnchor>); // for internal use

    { TdxTableCellVerticalAnchorCollection }

    TdxTableCellVerticalAnchorCollection = class sealed // for internal use
      strict private FAnchors: TdxTableCellVerticalAnchorList;
  ...
  public
    ...
    property Self[Index: Integer]: TdxTableCellVerticalAnchor read GetItem
  ...
  protected
    ...
    function GetEndCorner: TdxCornerViewInfoBase; override;
  public
    constructor Create(ARow: TdxTableRowViewInfoBase; ABorder: TdxBorderInfo;
      ALayoutBorderIndex, AModelBorderIndex: Integer;
      AConverter: TdxDocumentModelUnitToLayoutUnitConverter);
    function GetBounds(ATableViewInfo: TdxTableViewInfo): TRect; override;

    property CornerAtTop: TdxCornerViewInfoBase read FCornerAtTop
      write FCornerAtTop;
    property CornerAtBottom: TdxCornerViewInfoBase read FCornerAtBottom
      write FCornerAtBottom;
    property LayoutBorderIndex: Integer read FLayoutBorderIndex;
    property ModelBorderIndex: Integer read FModelBorderIndex;
  end;

  TdxTableCellVerticalBorderViewInfoList = class sealed
    (TdxObjectList<TdxTableCellVerticalBorderViewInfo>); // for internal use

    { TableRowViewInfoBase }

    TdxTableRowViewInfoBase = class abstract(TdxReferencedObject)
    // for internal use
      strict private FCells: TdxTableCellViewInfoCollection;
    FTableViewInfo: TdxTableViewInfo;
  ...
  protected
    function CalculateVerticalBorders: TdxTableCellVerticalBorderViewInfoList;
      virtual; abstract;
  ...
  public
    ...
    function GetVerticalBorderBounds(ALayoutBorderIndex: Integer): TRect;
      virtual; abstract;
    ...
    property VerticalBorders: TdxTableCellVerticalBorderViewInfoList
      read FVerticalBorders;
  ...
  strict private
    ...
    function GetConverter: TdxDocumentModelUnitToLayoutUnitConverter;
  protected
    function CalculateVerticalBorders
      : TdxTableCellVerticalBorderViewInfoList; override;
    procedure ExportTableBorders(const AExporter
      : IdxDocumentLayoutExporter); virtual;
  ...
  public
    ...
    function GetVerticalBorderBounds(ALayoutBorderIndex: Integer)
      : TRect; override;
  ...
  TdxTableRowViewInfoCollection = class sealed
    (TdxReferencedObjectList<TdxTableRowViewInfoBase>) // for internal use
  strict private
    FTableViewInfo: TdxTableViewInfo;
  public
  ...
  protected
    function CalculateVerticalBorders
      : TdxTableCellVerticalBorderViewInfoList; override;
    function GetBorderIndexByColumnIndex(ALayoutBorderIndex: Integer)
      : Integer; virtual;
  public
    procedure ExportTo(const AExporter: IdxDocumentLayoutExporter); override;
    function GetBounds: TRect; override;
  ...
  strict private
    ...
    procedure CreateAnchorCorner(AConverter
      : TdxDocumentModelUnitToLayoutUnitConverter;
      AAnchor: TdxTableCellVerticalAnchor;
      ATopRow: TdxTableRowViewInfoNoCellSpacing;
      ABottomRow: TdxTableRowViewInfoNoCellSpacing);
    procedure ExportBackgroundCore(const AExporter: IdxDocumentLayoutExporter;
      const ARowAction: TdxAction<TdxTableRowViewInfoBase>);
    procedure ExportCellsVerticalBorders(ATableRowViewInfoBase
      : TdxTableRowViewInfoBase; const AExporter: IdxDocumentLayoutExporter);
    procedure ExportRowCells(ARow: TdxTableRowViewInfoBase;
      const AExporter: IdxDocumentLayoutExporter);
    function GetTopAnchor: TdxTableCellVerticalAnchor;
    function GetBottomAnchor: TdxTableCellVerticalAnchor;
    ...
    function GetSingleColumn: Boolean;
    function GetVerticalBorderByColumnIndex(ARowViewInfo
      : TdxTableRowViewInfoNoCellSpacing; ACornerColumnIndex: Integer)
      : TdxTableCellVerticalBorderViewInfo;
    procedure RemoveInnerTablesFromTopLevelColumn(ATableCellViewInfo
      : TdxTableCellViewInfo);
    procedure RemoveTableViewInfoFromTopLevelColumn(ATableViewInfo
      : TdxTableViewInfo);
    procedure SetIsNested(const Value: Boolean);
  protected
    FAssociatedFloatingObjectsLayout: TObject;
    procedure ExportAnchorBorders(AAnchor: TdxTableCellVerticalAnchor;
      const AExporter: IdxDocumentLayoutExporter); virtual;
    procedure NestedChanged; virtual;

    property IsNested: Boolean read FIsNested write SetIsNested;
  public
    constructor Create(ATable: TdxTable; ATopLevelColumn: TdxColumn;
      AColumn: TdxColumn; AVerticalBorderPositions: TdxVerticalBorderPositions;
      ATopRowIndex: Integer; AParentTableCellViewInfo: TdxTableCellViewInfo;
    ...
    procedure ExportTo(const AExporter: IdxDocumentLayoutExporter);
    procedure ExportAnchorCorner(const AExporter: IdxDocumentLayoutExporter;
      AAnchor: TdxTableCellVerticalAnchor);
    ...
    procedure Complete(ATopBorderHeight: TdxLayoutUnit;
      ABottomBorderHeight: TdxLayoutUnit);
    ...
    function GetAlignedPosition(AHorizontalPositionIndex: Integer)
      : Integer; virtual;
    ...
    property ParentTableCellViewInfo: TdxTableCellViewInfo
      read FParentTableCellViewInfo;
    property Table: TdxTable read FTable;
    property MinBottomVerticalOffset: TdxLayoutUnit
      read FMinBottomVerticalOffset write FMinBottomVerticalOffset;
    property TopAnchor: TdxTableCellVerticalAnchor read GetTopAnchor;
    property BottomAnchor: TdxTableCellVerticalAnchor read GetBottomAnchor;
    ...
    property ModelRelativeIndent: TdxModelUnit read FModelRelativeIndent
      write FModelRelativeIndent;
    property TopRowIndex: Integer read FTopRowIndex;
    property RowCount: Integer read GetRowCount;
    property BottomRowIndex: Integer read GetBottomRowIndex;
    property PrevTableViewInfo: TdxTableViewInfo read FPrevTableViewInfo
      write FPrevTableViewInfo;
    property NextTableViewInfo: TdxTableViewInfo read FNextTableViewInfo
      write FNextTableViewInfo;
    property FirstContentInParentCell: Boolean read FFirstContentInParentCell;
    property VerticalBorderPositions: TdxVerticalBorderPositions
      read FVerticalBorderPositions write FVerticalBorderPositions;
    property TextAreaOffset: TdxLayoutUnit read FTextAreaLeft
      write FTextAreaLeft;
  end;

  { TdxTableViewInfoCollection }

  TdxTableViewInfoCollection = class sealed
    (TdxReferencedObjectList<TdxTableViewInfo>) // for internal use
  public
    procedure ExportTo(const AExporter: IdxDocumentLayoutExporter);
    procedure MoveVertically(ADeltaY: TdxLayoutUnit);
    procedure ExportBackground(const AExporter: IdxDocumentLayoutExporter);
  ...
  public
    ...
    constructor Create(const ACompoundArray: TArray<Integer>;
      AWidthDivider: Integer);
  ...
  class var
{$IFDEF DELPHIXE2}
    LineStyleInfos: array [TdxBorderLineStyle.Single .. TdxBorderLineStyle.
      Inset] of TdxTableBorderInfo;
{$ELSE}
    LineStyleInfos: array [Ord(TdxBorderLineStyle.Single)
      .. Ord(TdxBorderLineStyle.Inset)] of TdxTableBorderInfo;
{$ENDIF}
  strict private
    function CalculateWeight(ABorder: TdxBorderInfo): Integer;
    class function LineStyleInfosContainsKey(AKey: TdxBorderLineStyle)
      : Boolean; static;
    class function LineStyleInfosTryGetValue(AKey: TdxBorderLineStyle;
      var AInfo: TdxTableBorderInfo): Boolean; static;
  protected
    class procedure AddLineStyleInfo(ALineStyle: TdxBorderLineStyle;
      const ACompoundArray: TArray<Integer>; AWidthDivider: Integer); static;
  private
    class constructor Initialize;
  protected
    function GetActualBorderLineStyle(ABorderLineStyle: TdxBorderLineStyle)
      : TdxBorderLineStyle;
  public
    ...
    function GetActualWidth(AStyle: TdxBorderLineStyle; AWidth: Integer)
      : Integer; overload;
    function GetLineCount(ABorder: TdxBorderInfo): Integer;
    function GetDrawingCompoundArray(ABorderLineStyle: TdxBorderLineStyle)
      : TArray<Single>; overload;
    function GetDrawingCompoundArray(ABorder: TdxBorderInfo)
      : TArray<Single>; overload;
    function GetDrawingCompoundArray(ABorder: TdxBorderBase)
      : TArray<Single>; overload;
    function GetVerticalBorderSource(ATable: TdxTable;
      AFirstCellBorder, ASecondCellBorder: TdxBorderInfo): TdxBorderInfo;
    function IsVisuallyAdjacentBorder(ABorder1, ABorder2: TdxBorderInfo;
  ...
  private
    FTable: TdxTable;
    function GetLeftBorder(ABorderCalculator: TdxTableBorderCalculator;
      ACell: TdxTableCell): TdxBorderInfo;
    function GetRightBorder(ABorderCalculator: TdxTableBorderCalculator;
      ACell: TdxTableCell): TdxBorderInfo;
  public
    constructor Create(ATable: TdxTable);
    class function GetStartColumnIndex(ACell: TdxTableCell;
      ALayoutIndex: Boolean): Integer; static;
    class function GetVerticalSpanCells(ACell: TdxTableCell;
      AStartColumnIndex: Integer; ALayoutIndex: Boolean): TdxTableCellList;
      overload; static;
    class function GetVerticalSpanCells(ACell: TdxTableCell;
      ALayoutIndex: Boolean): TdxTableCellList; overload; static;
    class function GetCellByStartColumnIndex(ARow: TdxTableRow;
      AStartColumnIndex: Integer; ALayoutIndex: Boolean): TdxTableCell; static;
    class function GetCellByColumnIndex(ARow: TdxTableRow;
      AStartColumnIndex: Integer): TdxTableCell; static;
    class function GetCellByEndColumnIndex(ARow: TdxTableRow;
      AEndColumnIndex: Integer): TdxTableCell; static;
    class function GetCellsByIntervalColumnIndex(ARow: TdxTableRow;
      AStartColumnIndex, AEndColumnIndex: Integer): TdxTableCellList; static;
    function GetLeftBorderWidth(ABorderCalculator: TdxTableBorderCalculator;
      ACell: TdxTableCell; ALayoutIndex: Boolean): TdxModelUnit;
    function GetRightBorderWidth(ABorderCalculator: TdxTableBorderCalculator;
...
type
  ...
  public
    ...
    function CompareTo(const AOther
      : TdxTableCellVerticalBorderViewInfo): Integer;
  end;
  ...
  TdxTableCellVerticalBorderViewInfoBase = class abstract
    (TdxTableCellBorderViewInfoBase)
  strict private
  ...
  public
    ...
    property BottomCorner: TdxCornerViewInfoBase read FBottomCorner
      write FBottomCorner;
  end;
  ...
  TdxRightTableCellBorderViewInfo = class
    (TdxTableCellVerticalBorderViewInfoBase)
  protected
    function GetBorder: TdxBorderInfo; override;
    function GetBorderType: TdxBorderTypes; override;
  ...
  TdxTableCellHorizontalBorderViewInfoBase = class
    (TdxTableCellBorderViewInfoBase)
  strict private
  ...
  protected
    ...
    function GetEndCorner: TdxCornerViewInfoBase; override;
  public
    property LeftCorner: TdxCornerViewInfoBase read FLeftCorner
      write FLeftCorner;
    property RightCorner: TdxCornerViewInfoBase read FRightCorner
      write FRightCorner;
  end;

  { TdxTopTableCellBorderViewInfo }

  TdxTopTableCellBorderViewInfo = class
    (TdxTableCellHorizontalBorderViewInfoBase)
  protected
    function GetBorder: TdxBorderInfo; override;
    function GetBorderType: TdxBorderTypes; override;
  ...
  TdxBottomTableCellBorderViewInfo = class
    (TdxTableCellHorizontalBorderViewInfoBase)
  protected
    function GetBorder: TdxBorderInfo; override;
    function GetBorderType: TdxBorderTypes; override;
  ...
  protected
    function GetColor: TdxAlphaColor; override;
    function CreatePattern(ABorderAtLeft, ABorderAtTop, ABorderAtRight,
      ABorderAtBottom: TdxBorderInfo): TArray<TArray<Boolean>>; virtual;
    function IntersectPattern(const APattern1, APattern2: TArray < TArray <
      Boolean >> ): TArray<TArray<Boolean>>;

    function GetVerticalBordersMask: TArray<TArray<Boolean>>; virtual; abstract;
    function GetHorizontalBordersMask: TArray<TArray<Boolean>>;
      virtual; abstract;
    ...
    property VerticalBordersMask: TArray < TArray < Boolean >>
      read GetVerticalBordersMask;
    property HorizontalBordersMask: TArray < TArray < Boolean >>
      read GetHorizontalBordersMask;
    property CommonBorderMask: TArray < TArray < Boolean >>
      read GetCommonBorderMask;
    property LeftBorderMask: TArray < TArray < Boolean >>
      read GetLeftBorderMask;
    property RightBorderMask: TArray < TArray < Boolean >>
      read GetRightBorderMask;
    property TopBorderMask: TArray < TArray < Boolean >> read GetTopBorderMask;
    property BottomBorderMask: TArray < TArray < Boolean >>
      read GetBottomBorderMask;
  public
    constructor Create(ABorderAtLeft, ABorderAtTop, ABorderAtRight,
      ABorderAtBottom: TdxBorderInfo; const AWidth, AHeight: Single;
      ACornerType: TdxCornerViewInfoType);
    destructor Destroy; override;
  ...
  protected
    function CreatePattern(ABorderAtLeft, ABorderAtTop, ABorderAtRight,
      ABorderAtBottom: TdxBorderInfo): TArray<TArray<Boolean>>; override;
  ...
  TdxTableBorderWithSpacingViewInfoBase = class abstract
    (TdxTableBorderViewInfoBase) // for internal use
  strict private
  ...
  public
    ...
    property RowViewInfo: TdxTableRowViewInfoWithCellSpacing read FRowViewInfo
      write FRowViewInfo;
    property LeftCorner: TdxCornerViewInfoBase read FLeftCorner
      write FLeftCorner;
    property RightCorner: TdxCornerViewInfoBase read FRightCorner
  ...
  TdxLeftRightTableBorderWithSpacingViewInfoBase = class
    (TdxTableBorderWithSpacingViewInfoBase)
  public
    function GetBounds(ATableViewInfo: TdxTableViewInfo): TRect; override;
  end;
  ...
  TdxLeftTableBorderWithSpacingViewInfo = class
    (TdxLeftRightTableBorderWithSpacingViewInfoBase)
  protected
    function GetBorder: TdxBorderInfo; override;
    function GetBorderType: TdxBorderTypes; override;
  ...
  TdxRightTableBorderWithSpacingViewInfo = class
    (TdxLeftRightTableBorderWithSpacingViewInfoBase)
  protected
    function GetBorder: TdxBorderInfo; override;
    function GetBorderType: TdxBorderTypes; override;
  ...
  TdxTopTableBorderWithSpacingViewInfo = class
    (TdxTableBorderWithSpacingViewInfoBase)
  protected
    function GetBorder: TdxBorderInfo; override;
    function GetBorderType: TdxBorderTypes; override;
  ...
  TdxBottomTableBorderWithSpacingViewInfo = class
    (TdxTableBorderWithSpacingViewInfoBase)
  protected
    function GetBorder: TdxBorderInfo; override;
    function GetBorderType: TdxBorderTypes; override;
  ...
  protected
    ...
    function GetConverter: TdxDocumentModelUnitToLayoutUnitConverter; override;
  public
    constructor Create(AAnchor: TdxTableCellVerticalAnchor;
...
constructor TdxVerticalBorderAndColumnIndexComparable.Create(ALayoutBorderIndex
  : Integer);
begin
  FLayoutBorderIndex := ALayoutBorderIndex;
end;

function TdxVerticalBorderAndColumnIndexComparable.CompareTo
  (const AOther: TdxTableCellVerticalBorderViewInfo): Integer;
begin
...
constructor TdxCounterItemAndLogPositionComparable.Create
  (ALogPosition: TdxDocumentLogPosition);
begin
  FLogPosition := ALogPosition;
end;

function TdxCounterItemAndLogPositionComparable.CompareTo
  (const AItem: TdxCounterItem): Integer;
var
...
begin
  ...
  if FLogPosition < AItemLogPosition then
    Result := 1
  else if FLogPosition > AItemLogPosition then
    Result := -1
  else
    Result := 0;
end;
...
procedure TdxTabSpaceBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
  (AExporter as IdxDocumentLayoutExporter).ExportTabSpaceBox(Self);
end;

function TdxTabSpaceBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
  Result := (ACalculator as IdxBoxHitTestCalculator)
    .CreateTabSpaceBoxHitTestManager(Self);
end;
...
function TdxRowExtendedBoxes.GetCommentHighlightAreas
...
function TdxRowExtendedBoxes.GetRangePermissionHighlightAreas
  : TdxHighlightAreaCollection;
begin
...
function TdxRowExtendedBoxes.GetBookmarkBoxes
  : TdxVisitableDocumentIntervalBoxCollection;
begin
...
function TdxRowExtendedBoxes.GetRangePermissionBoxes
  : TdxVisitableDocumentIntervalBoxCollection;
begin
...
function TdxRowExtendedBoxes.GetCommentBoxes
  : TdxVisitableDocumentIntervalBoxCollection;
begin
...
function TdxRow.GetInnerBookmarkBoxes
  : TdxVisitableDocumentIntervalBoxCollection;
begin
...
function TdxRow.GetInnerRangePermissionBoxes
  : TdxVisitableDocumentIntervalBoxCollection;
begin
  if InnerExtendedBoxes <> nil then
...
function TdxRow.GetInnerRangePermissionHighlightAreas
  : TdxHighlightAreaCollection;
begin
  if InnerExtendedBoxes <> nil then
...
function TdxRow.GetRangePermissionBoxes
  : TdxVisitableDocumentIntervalBoxCollection;
begin
...
function TdxRow.GetRangePermissionBoxesCore
  : TdxVisitableDocumentIntervalBoxCollection;
begin
...
constructor TdxTableCellViewInfo.Create(ATableViewInfo: TdxTableViewInfo;
  ACell: TdxTableCell; ALeft, AWidth, ATextLeft, ATextWidth,
  ATextOffset: TdxLayoutUnit; ATopAnchorIndex, ABottomAnchorIndex,
  AStartRowIndex, ARowSpan: Integer);
begin
  inherited Create;
  Assert(ATextWidth >= 0);
...
procedure TdxTableCellViewInfo.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
...
begin
  ...
  if (StartRowIndex = TableViewInfo.TopRowIndex) and
    (TableViewInfo.TopRowIndex = TableViewInfo.PrevTableViewInfo.BottomRowIndex)
  then
    Exit(True);
  Result := False;
end;
...
begin
  ...
  if (AEndRowIndex = TableViewInfo.BottomRowIndex) and
    (TableViewInfo.BottomRowIndex = TableViewInfo.NextTableViewInfo.TopRowIndex)
  then
    Exit(True);
  Result := False;
end;
...
begin
  ...
  begin
    Dec(AColumnIndex, FCell.Table.Rows[ABottomRowIndex].Cells[ACellIndex]
      .ColumnSpan);
    Inc(ACellIndex);
  end;
...
class function TdxTableCellViewInfo.GetRows(ARows: TdxRowCollection;
  ACell: TdxTableCell): TdxRowCollection;
var
...
begin
  ...
  if not TdxAlgorithms1<TdxBoxBase>.BinarySearch(ARows,
    AComparable.BoxAndLogPositionCompare, AFirstRowIndex) then
    Assert((AFirstRowIndex >= ARows.Count) or (ARows[AFirstRowIndex].Paragraph.
      Index >= ACell.StartParagraphIndex));

  AComparable := TdxBoxLogPositionComparable.Create(APieceTable,
    APieceTable.Paragraphs[ACell.EndParagraphIndex].EndLogPosition);
  if not TdxAlgorithms1<TdxBoxBase>.BinarySearch(ARows,
    AComparable.BoxAndLogPositionCompare, ALastRowIndex) then
  begin
    Dec(ALastRowIndex);
    Assert((AFirstRowIndex >= ARows.Count) or (ARows[AFirstRowIndex].Paragraph.
      Index >= ACell.StartParagraphIndex));
...
begin
  ...
  if not TdxAlgorithms1<TdxBoxBase>.BinarySearch(AColumn.Rows,
    AComparable.BoxAndLogPositionCompare, Result) then
  begin
...
procedure TdxTableCellViewInfo.RemoveInnerTable(ATableViewInfo
  : TdxTableViewInfo);
begin
...
begin
  Result := (not IsStartOnPreviousTableViewInfo) and
    (not IsEndOnNextTableViewInfo);
end;
...
procedure TdxParagraphBoxCollection.SetNumberingListBox
  (const Value: TdxNumberingListBox);
begin
  if FNumberingListBox = Value then
    Exit;
  TdxNumberingListBox.Release(FNumberingListBox);
...
class function TdxTableCellVerticalBorderCalculator.GetCellByColumnIndex
  (ARow: TdxTableRow; AStartColumnIndex: Integer): TdxTableCell;
var
...
begin
  ...
  begin
    ...
    if (AStartColumnIndex >= AColumnIndex) and
      (AStartColumnIndex < AColumnIndex + ACurrentCell.ColumnSpan) then
      Exit(ACurrentCell);
...
class function TdxTableCellVerticalBorderCalculator.GetCellByEndColumnIndex
  (ARow: TdxTableRow; AEndColumnIndex: Integer): TdxTableCell;
var
...
begin
  ...
  if GetStartColumnIndex(ACellByColumnIndex, False) +
    ACellByColumnIndex.ColumnSpan - 1 <= AEndColumnIndex then
...
class function TdxTableCellVerticalBorderCalculator.GetCellByStartColumnIndex
  (ARow: TdxTableRow; AStartColumnIndex: Integer; ALayoutIndex: Boolean)
  : TdxTableCell;
var
  ACell: TdxTableCell;
...
begin
  if ALayoutIndex then
    ...
    AColumnIndex := ARow.GridBefore;
  ACellIndex := 0;
  while (AColumnIndex < AStartColumnIndex) and
    (ACellIndex < ARow.Cells.Count) do
  begin
...
class function TdxTableCellVerticalBorderCalculator.
  GetCellsByIntervalColumnIndex(ARow: TdxTableRow;
  AStartColumnIndex, AEndColumnIndex: Integer): TdxTableCellList;
var
  ACell: TdxTableCell;
...
begin
  ...
  begin
    ...
    Inc(AStartColumnIndex, AStartColumnIndex - ACellStartColumnIndex +
      ACell.ColumnSpan);
  end;
end;

function TdxTableCellVerticalBorderCalculator.GetLeftBorder(ABorderCalculator
  : TdxTableBorderCalculator; ACell: TdxTableCell): TdxBorderInfo;
var
  ACellIndex: Integer;
  APrevCellBorder: TdxBorderBase;
begin
  if (ACell.Row.CellSpacing.&Type = TdxWidthUnitType.ModelUnits) and
    (ACell.Row.CellSpacing.Value > 0) then
  ...
  begin
    ...
    Result := ABorderCalculator.GetVerticalBorderSource(FTable,
      APrevCellBorder.Info, ACell.GetActualLeftCellBorder.Info);
  end
  else
    Result := ACell.GetActualLeftCellBorder.Info;
end;

function TdxTableCellVerticalBorderCalculator.GetLeftBorderWidth
  (ABorderCalculator: TdxTableBorderCalculator; ACell: TdxTableCell;
  ALayoutIndex: Boolean): TdxModelUnit;
var
  I, AStartColumnIndex: Integer;
  AVerticalSpanCells: TdxTableCellList;
begin
  AStartColumnIndex := GetStartColumnIndex(ACell, ALayoutIndex);
  AVerticalSpanCells := GetVerticalSpanCells(ACell, AStartColumnIndex,
    ALayoutIndex);
  try
    Result := 0;
    for I := 0 to AVerticalSpanCells.Count - 1 do
      Result := Math.Max(ABorderCalculator.GetActualWidth
        (GetLeftBorder(ABorderCalculator, AVerticalSpanCells[I])), Result);
  finally
    AVerticalSpanCells.Free;
  end;
end;

function TdxTableCellVerticalBorderCalculator.GetRightBorder(ABorderCalculator
  : TdxTableBorderCalculator; ACell: TdxTableCell): TdxBorderInfo;
var
  ACellIndex: Integer;
...
begin
  ...
  begin
    ANextCellBorder := ACell.Row.Cells[ACellIndex + 1]
      .GetActualLeftCellBorder.Info;
    Result := ABorderCalculator.GetVerticalBorderSource(FTable, ANextCellBorder,
      ACell.GetActualRightCellBorder.Info);
  end
  else
    Result := ACell.GetActualRightCellBorder.Info;
end;

function TdxTableCellVerticalBorderCalculator.GetRightBorderWidth
  (ABorderCalculator: TdxTableBorderCalculator; ACell: TdxTableCell)
  : TdxModelUnit;
var
  I, AStartColumnIndex: Integer;
...
begin
  ...
  try
    ...
    for I := 0 to AVerticalSpanCells.Count - 1 do
      Result := Math.Max(ABorderCalculator.GetActualWidth
        (GetRightBorder(ABorderCalculator, AVerticalSpanCells[I])), Result);
  finally
    AVerticalSpanCells.Free;
  end;
end;

class function TdxTableCellVerticalBorderCalculator.GetStartColumnIndex
  (ACell: TdxTableCell; ALayoutIndex: Boolean): Integer;
var
  ARow: TdxTableRow;
  ACurrentCell: TdxTableCell;
  ACells: TdxTableCellCollection;
...
class function TdxTableCellVerticalBorderCalculator.GetVerticalSpanCells
  (ACell: TdxTableCell; ALayoutIndex: Boolean): TdxTableCellList;
var
...
class function TdxTableCellVerticalBorderCalculator.GetVerticalSpanCells
  (ACell: TdxTableCell; AStartColumnIndex: Integer; ALayoutIndex: Boolean)
  : TdxTableCellList;
var
  ATable: TdxTable;
  ARowIndex: Integer;
...
begin
  ...
  if ACell.VerticalMerging <> TdxMergingState.Restart then
    Exit;
  ATable := ACell.Table;
  for ARowIndex := ATable.Rows.IndexOf(ACell.Row) +
    1 to ATable.Rows.Count - 1 do
  begin
    ARow := ATable.Rows[ARowIndex];
    ARowCell := GetCellByStartColumnIndex(ARow, AStartColumnIndex,
      ALayoutIndex);
    if (ARowCell <> nil) and
      (ARowCell.VerticalMerging = TdxMergingState.Continue) then
      Result.Add(ARowCell)
    else
      Break;
  end;
...
procedure TdxTableViewInfoCollection.ExportTo(const AExporter
  : IdxDocumentLayoutExporter);
var
  I: Integer;
begin
...
procedure TdxTableViewInfoCollection.ExportBackground(const AExporter
  : IdxDocumentLayoutExporter);
var
  I: Integer;
begin
...
constructor TdxTableRowViewInfoCollection.Create(ATableViewInfo
  : TdxTableViewInfo);
begin
  inherited Create;
...
procedure TdxTableRowViewInfoCollection.RemoveRows(AStartRowIndex,
  ARowCount: Integer);
var
  I: Integer;
begin
...
begin
  Result := (StartCorner <> nil) and
    not(StartCorner is TdxNoneLineCornerViewInfo);
end;

{ TdxParagraphHorizontalBorderViewInfo }

constructor TdxParagraphHorizontalBorderViewInfo.Create
...
function TdxParagraphHorizontalBorderViewInfo.GetConverter
  : TdxDocumentModelUnitToLayoutUnitConverter;
begin
  Result := FConverter;
end;

function TdxParagraphHorizontalBorderViewInfo.GetStartCorner
  : TdxCornerViewInfoBase;
begin
  Result := FCornerAtLeft;
end;

function TdxParagraphHorizontalBorderViewInfo.GetEndCorner
  : TdxCornerViewInfoBase;
begin
  Result := FCornerAtRight;
end;

function TdxParagraphHorizontalBorderViewInfo.GetBounds(ATableViewInfo
  : TdxTableViewInfo): TRect;
begin
  Result.Empty;
end;
...
constructor TdxTableCellHorizontalBorderViewInfo.Create
  (AAnchor: TdxTableCellVerticalAnchor;
  ABorderInfo: TdxHorizontalCellBordersInfo;
  AConverter: TdxDocumentModelUnitToLayoutUnitConverter;
  ACornerAtLeft, ACornerAtRight: TdxCornerViewInfoBase);
...
function TdxTableCellHorizontalBorderViewInfo.GetBounds(ATableViewInfo
  : TdxTableViewInfo): TRect;
var
...
function TdxTableCellHorizontalBorderViewInfo.GetStartCorner
  : TdxCornerViewInfoBase;
begin
  Result := FCornerAtLeft;
end;

function TdxTableCellHorizontalBorderViewInfo.GetEndCorner
  : TdxCornerViewInfoBase;
begin
  Result := FCornerAtRight;
end;

function TdxTableCellHorizontalBorderViewInfo.GetConverter
  : TdxDocumentModelUnitToLayoutUnitConverter;
begin
  Result := FConverter;
end;
...
constructor TdxTableBorderWithSpacingViewInfoBase.Create
  (ARowViewInfo: TdxTableRowViewInfoWithCellSpacing);
begin
  inherited Create;
...
function TdxTableBorderWithSpacingViewInfoBase.GetConverter
  : TdxDocumentModelUnitToLayoutUnitConverter;
begin
  Result := FRowViewInfo.Row.DocumentModel.ToDocumentLayoutUnitConverter;
end;

function TdxTableBorderWithSpacingViewInfoBase.GetEndCorner
  : TdxCornerViewInfoBase;
begin
  Result := RightCorner;
end;

function TdxTableBorderWithSpacingViewInfoBase.GetStartCorner
  : TdxCornerViewInfoBase;
begin
  Result := LeftCorner;
end;

function TdxTableBorderWithSpacingViewInfoBase.GetTableViewInfo
  : TdxTableViewInfo;
begin
...
constructor TdxTableCellVerticalBorderViewInfo.Create
  (ARow: TdxTableRowViewInfoBase; ABorder: TdxBorderInfo;
  ALayoutBorderIndex, AModelBorderIndex: Integer;
  AConverter: TdxDocumentModelUnitToLayoutUnitConverter);
begin
  inherited Create;
...
function TdxTableCellVerticalBorderViewInfo.GetBounds(ATableViewInfo
  : TdxTableViewInfo): TRect;
var
...
function TdxTableCellVerticalBorderViewInfo.GetConverter
  : TdxDocumentModelUnitToLayoutUnitConverter;
begin
  Result := FConverter;
end;
...
function TdxTableCellVerticalBorderViewInfo.GetStartCorner
  : TdxCornerViewInfoBase;
begin
  Result := CornerAtTop;
end;
...
function TdxLeftRightTableBorderWithSpacingViewInfoBase.GetBounds
  (ATableViewInfo: TdxTableViewInfo): TRect;
var
...
begin
  ...
  begin
    ACellSpacing := Converter.ToLayoutUnits
      (TdxTableRowViewInfoWithCellSpacing(RowViewInfo.Previous).CellSpacing);
...
function TdxTopTableBorderWithSpacingViewInfo.GetBounds(ATableViewInfo
  : TdxTableViewInfo): TRect;
var
...
function TdxBottomTableBorderWithSpacingViewInfo.GetBounds(ATableViewInfo
  : TdxTableViewInfo): TRect;
var
...
constructor TdxTableCellBorderViewInfoBase.Create
...
function TdxTableCellBorderViewInfoBase.GetBounds(ATableViewInfo
  : TdxTableViewInfo): TRect;
begin
  Result := GetBoundsCore(ATableViewInfo);
end;

function TdxTableCellBorderViewInfoBase.GetBoundsCore(ATableViewInfo
  : TdxTableViewInfo): TRect;
begin
  Result := ATableViewInfo.GetCellBounds(FSourceCell);
end;

function TdxTableCellBorderViewInfoBase.GetConverter
  : TdxDocumentModelUnitToLayoutUnitConverter;
begin
...
function TdxTableCellVerticalBorderViewInfoBase.GetEndCorner
  : TdxCornerViewInfoBase;
begin
  Result := BottomCorner;
end;

function TdxTableCellVerticalBorderViewInfoBase.GetStartCorner
  : TdxCornerViewInfoBase;
begin
  Result := TopCorner;
end;
...
function TdxTableCellHorizontalBorderViewInfoBase.GetEndCorner
  : TdxCornerViewInfoBase;
begin
  Result := RightCorner;
end;

function TdxTableCellHorizontalBorderViewInfoBase.GetStartCorner
  : TdxCornerViewInfoBase;
begin
  Result := LeftCorner;
end;
...
constructor TdxTableBorderInfo.Create(const ACompoundArray: TArray<Integer>;
  AWidthDivider: Integer);
var
...
class procedure TdxTableBorderCalculator.AddLineStyleInfo
  (ALineStyle: TdxBorderLineStyle; const ACompoundArray: TArray<Integer>;
  AWidthDivider: Integer);
begin
{$IFDEF DELPHIXE2}
  LineStyleInfos[ALineStyle] := TdxTableBorderInfo.Create(ACompoundArray,
    AWidthDivider);
{$ELSE}
  LineStyleInfos[Ord(ALineStyle)] := TdxTableBorderInfo.Create(ACompoundArray,
    AWidthDivider);
{$ENDIF}
end;

function TdxTableBorderCalculator.CalculateWeight
  (ABorder: TdxBorderInfo): Integer;
var
  AInfo: TdxTableBorderInfo;
  ABorderStyle: TdxBorderLineStyle;
begin
  ABorderStyle := ABorder.Style;
  if not LineStyleInfosTryGetValue(GetActualBorderLineStyle(ABorderStyle), AInfo)
  then
  begin
...
function TdxTableBorderCalculator.GetActualBorderLineStyle(ABorderLineStyle
  : TdxBorderLineStyle): TdxBorderLineStyle;
begin
  if (ABorderLineStyle = TdxBorderLineStyle.None) or
    (ABorderLineStyle = TdxBorderLineStyle.Nil) or
    (ABorderLineStyle = TdxBorderLineStyle.Disabled) or
    LineStyleInfosContainsKey(ABorderLineStyle) then
    Result := ABorderLineStyle
  else
    Result := TdxBorderLineStyle.Single;
end;

class function TdxTableBorderCalculator.LineStyleInfosContainsKey
  (AKey: TdxBorderLineStyle): Boolean;
begin
  Result := (TdxBorderLineStyle.Single <= AKey) and
    (AKey <= TdxBorderLineStyle.Inset);
end;

class function TdxTableBorderCalculator.LineStyleInfosTryGetValue
  (AKey: TdxBorderLineStyle; var AInfo: TdxTableBorderInfo): Boolean;
begin
...
function TdxTableBorderCalculator.GetActualWidth
  (ABorder: TdxBorderBase): Integer;
begin
  Result := GetActualWidth(ABorder.Info);
end;

function TdxTableBorderCalculator.GetActualWidth(AStyle: TdxBorderLineStyle;
...
begin
  ...
  AddLineStyleInfo(TdxBorderLineStyle.Double, TArray<Integer>.Create(0, 1,
    2, 3), 1);
  ...
  AddLineStyleInfo(TdxBorderLineStyle.DotDotDash,
    TArray<Integer>.Create(0, 1), 1);
  AddLineStyleInfo(TdxBorderLineStyle.Triple, TArray<Integer>.Create(0, 1, 2, 3,
    4, 5), 1);
  AddLineStyleInfo(TdxBorderLineStyle.ThinThickSmallGap,
    TArray<Integer>.Create(0, 1, 2, 10), 8);
  AddLineStyleInfo(TdxBorderLineStyle.ThickThinSmallGap,
    TArray<Integer>.Create(0, 8, 9, 10), 8);
  AddLineStyleInfo(TdxBorderLineStyle.ThinThickThinSmallGap,
    TArray<Integer>.Create(0, 1, 2, 10, 11, 12), 8);
  AddLineStyleInfo(TdxBorderLineStyle.ThinThickMediumGap,
    TArray<Integer>.Create(0, 1, 2, 4), 2);
  AddLineStyleInfo(TdxBorderLineStyle.ThickThinMediumGap,
    TArray<Integer>.Create(0, 2, 3, 4), 2);
  AddLineStyleInfo(TdxBorderLineStyle.ThinThickThinMediumGap,
    TArray<Integer>.Create(0, 1, 2, 4, 5, 6), 2);
  AddLineStyleInfo(TdxBorderLineStyle.ThinThickLargeGap,
    TArray<Integer>.Create(0, 1, 9, 11), 8);
  AddLineStyleInfo(TdxBorderLineStyle.ThickThinLargeGap,
    TArray<Integer>.Create(0, 2, 10, 11), 8);
  AddLineStyleInfo(TdxBorderLineStyle.ThinThickThinLargeGap,
    TArray<Integer>.Create(0, 1, 9, 11, 19, 20), 8);
  AddLineStyleInfo(TdxBorderLineStyle.Wave, TArray<Integer>.Create(0, 1), 1);
  AddLineStyleInfo(TdxBorderLineStyle.DoubleWave, TArray<Integer>.Create(0, 1,
    1, 2), 1);
  AddLineStyleInfo(TdxBorderLineStyle.DashSmallGap,
    TArray<Integer>.Create(0, 1), 1);
  AddLineStyleInfo(TdxBorderLineStyle.DashDotStroked,
    TArray<Integer>.Create(0, 1), 1);
  AddLineStyleInfo(TdxBorderLineStyle.ThreeDEmboss, TArray<Integer>.Create(0, 1,
    1, 5, 6), 4);
  AddLineStyleInfo(TdxBorderLineStyle.ThreeDEngrave,
    TArray<Integer>.Create(0, 1, 1, 5, 6), 4);
...
function TdxTableBorderCalculator.IsVisuallyAdjacentBorder(ABorder1,
  ABorder2: TdxBorderInfo; ASameDirection: Boolean): Boolean;
var
...
begin
  ...
  if ABorder1 = ABorder2 then
    Exit(True);
  if not LineStyleInfosTryGetValue(GetActualBorderLineStyle(ABorder1.Style),
    ABorderInfo1) then
    Exit(False);
  if not LineStyleInfosTryGetValue(GetActualBorderLineStyle(ABorder2.Style),
    ABorderInfo2) then
    Exit(False);
  if ABorderInfo1.GetActualWidth(ABorder1.Width) <> ABorderInfo2.GetActualWidth
    (ABorder2.Width) then
    Exit(False);
...
function TdxTableBorderCalculator.GetDrawingCompoundArray
  (ABorder: TdxBorderInfo): TArray<Single>;
begin
  Result := GetDrawingCompoundArray(ABorder.Style);
end;

function TdxTableBorderCalculator.GetDrawingCompoundArray(ABorderLineStyle
  : TdxBorderLineStyle): TArray<Single>;
var
  AInfo: TdxTableBorderInfo;
begin
  if not LineStyleInfosTryGetValue(GetActualBorderLineStyle(ABorderLineStyle),
    AInfo) then
    Result := nil
  else
...
var
  AInfo: TdxTableBorderInfo;
begin
  if not LineStyleInfosTryGetValue(GetActualBorderLineStyle(ABorder.Style),
    AInfo) then
    Result := 0
  else
...
function TdxTableBorderCalculator.GetVerticalBorderSource(ATable: TdxTable;
  AFirstCellBorder, ASecondCellBorder: TdxBorderInfo): TdxBorderInfo;
var
  ALeftCellBorderWeight, ARightCellBorderWeight, ALeftCellStyleWeight,
    ARightCellStyleWeight, ALeftCellBrightness, ARightCellBrightness: Integer;
begin
  ...
  if ALeftCellBorderWeight > ARightCellBorderWeight then
    Exit(AFirstCellBorder)
  else if ARightCellBorderWeight > ALeftCellBorderWeight then
    Exit(ASecondCellBorder);
  ...
  if ALeftCellStyleWeight > ARightCellStyleWeight then
    Exit(AFirstCellBorder)
  else if ARightCellStyleWeight > ALeftCellStyleWeight then
    Exit(ASecondCellBorder);

  ALeftCellBrightness := dxGetRed(AFirstCellBorder.Color) +
    dxGetBlue(AFirstCellBorder.Color) + 2 * dxGetGreen(AFirstCellBorder.Color);
  ARightCellBrightness := dxGetRed(ASecondCellBorder.Color) +
    dxGetBlue(ASecondCellBorder.Color) + 2 *
    dxGetGreen(ASecondCellBorder.Color);
  if ALeftCellBrightness = ARightCellBrightness then
  begin
    ALeftCellBrightness := dxGetRed(AFirstCellBorder.Color) + 2 *
      dxGetGreen(AFirstCellBorder.Color);
    ARightCellBrightness := dxGetBlue(ASecondCellBorder.Color) + 2 *
      dxGetGreen(ASecondCellBorder.Color);
    if ALeftCellBrightness = ARightCellBrightness then
    begin
  ...
  if ALeftCellBrightness < ARightCellBrightness then
    Exit(AFirstCellBorder)
  else if ARightCellBrightness < ALeftCellBrightness then
    Exit(ASecondCellBorder);
  Result := AFirstCellBorder;
end;

function TdxTableBorderCalculator.GetDrawingCompoundArray
  (ABorder: TdxBorderBase): TArray<Single>;
begin
  Result := GetDrawingCompoundArray(ABorder.Style);
end;
...
procedure TdxTableCellVerticalAnchorCollection.RemoveAnchors(AStartAnchorIndex,
  AAnchorCount: Integer);
var
  I: Integer;
begin
...
procedure TdxTableCellVerticalAnchorCollection.ShiftForward(AFrom,
  ADelta: Integer);
var
...
function TdxTableCellVerticalAnchorCollection.GetAnchorIndex
  (ALogicalVerticalPoint: Integer): Integer;
var
  AComparable: TdxTableCellVerticalAnchorYComparable;
begin
  AComparable := TdxTableCellVerticalAnchorYComparable.Create
    (ALogicalVerticalPoint);
  if not TdxAlgorithms1<TdxTableCellVerticalAnchor>.BinarySearch(FAnchors,
    AComparable.CompareTo, Result) then
    Dec(Result);
  if Result >= FAnchors.Count then
    Result := FAnchors.Count - 1;
end;

function TdxTableCellVerticalAnchorCollection.GetItem(Index: Integer)
  : TdxTableCellVerticalAnchor;
begin
  if Index < Count then
...
function TdxTableCellVerticalAnchorCollection.GetItems
  : TdxTableCellVerticalAnchorList;
begin
  Result := FAnchors;
end;

procedure TdxTableCellVerticalAnchorCollection.SetItem(Index: Integer;
  const Value: TdxTableCellVerticalAnchor);
begin
...
class function TdxCornerViewInfoBase.CreateCorner
  (AConverter: TdxDocumentModelUnitToLayoutUnitConverter;
  ABorderAtLeft, ABorderAtTop, ABorderAtRight, ABorderAtBottom: TdxBorderInfo;
  ACellSpacing: TdxModelUnit): TdxCornerViewInfoBase;
begin
  Result := CreateCorner(TdxCornerViewInfoType.Normal, AConverter,
    ABorderAtLeft, ABorderAtTop, ABorderAtRight, ABorderAtBottom, ACellSpacing);
end;
...
var
  ...
  ABorderInfo, AActualBorderAtLeft, AActualBorderAtRight, AActualBorderAtTop,
    AActualBorderAtBottom: TdxBorderInfo;
begin
  ATableBorderCalculator := TdxTableBorderCalculator.Create;
  try
    ABorderInfo := ATableBorderCalculator.GetVerticalBorderSource(nil,
      ABorderAtLeft, ABorderAtTop);
    ABorderInfo := ATableBorderCalculator.GetVerticalBorderSource(nil,
      ABorderInfo, ABorderAtRight);
    ABorderInfo := ATableBorderCalculator.GetVerticalBorderSource(nil,
      ABorderInfo, ABorderAtBottom);
    if ABorderInfo = nil then
      Exit(TdxNoneLineCornerViewInfo.Create);
    AIsResultHorizontal := (ABorderInfo = ABorderAtLeft) or
      (ABorderInfo = ABorderAtRight);
    ...
    if not ATableBorderCalculator.IsVisuallyAdjacentBorder(ABorderInfo,
      ABorderAtLeft, AIsResultHorizontal) then
      AActualBorderAtLeft := nil;
    if not ATableBorderCalculator.IsVisuallyAdjacentBorder(ABorderInfo,
      ABorderAtRight, AIsResultHorizontal) then
      AActualBorderAtRight := nil;
    if not ATableBorderCalculator.IsVisuallyAdjacentBorder(ABorderInfo,
      ABorderAtTop, not AIsResultHorizontal) then
      AActualBorderAtTop := nil;
    if not ATableBorderCalculator.IsVisuallyAdjacentBorder(ABorderInfo,
      ABorderAtBottom, not AIsResultHorizontal) then
      AActualBorderAtBottom := nil;
    AWidth := 0;
    if (AActualBorderAtTop = nil) and (AActualBorderAtBottom = nil) then
    begin
      if ABorderAtTop <> nil then
        AWidth := Math.Max(AWidth, ATableBorderCalculator.GetActualWidth
          (ABorderAtTop));
    ...
    begin
      ...
      if AActualBorderAtBottom <> nil then
        AWidth := Math.Max(AWidth, ATableBorderCalculator.GetActualWidth
          (AActualBorderAtBottom));
    end;
    AHeight := 0;
    if (AActualBorderAtLeft = nil) and (AActualBorderAtRight = nil) then
    begin
      if ABorderAtLeft <> nil then
        AHeight := Math.Max(AHeight, ATableBorderCalculator.GetActualWidth
          (ABorderAtLeft));
    ...
    case ALineCount of
      0:
        Result := TdxNoneLineCornerViewInfo.Create;
      1:
        Result := TdxSingleLineCornerViewInfo.Create(AActualBorderAtLeft,
          AActualBorderAtTop, AActualBorderAtRight, AActualBorderAtBottom,
          ALayoutBorderWidth, ALayoutBorderHeight, ACornerType);
      2:
        Result := TdxDoubleLineCornerViewInfo.Create(AActualBorderAtLeft,
          AActualBorderAtTop, AActualBorderAtRight, AActualBorderAtBottom,
          ALayoutBorderWidth, ALayoutBorderHeight, ACornerType);
      3:
        Result := TdxTripleLineCornerViewInfo.Create(AActualBorderAtLeft,
          AActualBorderAtTop, AActualBorderAtRight, AActualBorderAtBottom,
          ALayoutBorderWidth, ALayoutBorderHeight, ACornerType);
    else
      Result := nil;
...
procedure TdxNoneLineCornerViewInfo.Export(const AExporter
  : IdxDocumentLayoutExporter; X, Y: Integer);
begin
end;
...
constructor TdxSingleLineCornerViewInfo.Create(ALeftBorder, ARightBorder,
  ATopBorder, ABottomBorder: TdxBorderInfo; const AWidth, AHeight: Single;
  ACornerType: TdxCornerViewInfoType);
var
...
begin
  ...
  if ALeftBorder <> nil then
    ABorder := ALeftBorder
  else if ARightBorder <> nil then
    ABorder := ARightBorder
  else if ATopBorder <> nil then
    ABorder := ATopBorder
  else if ABottomBorder <> nil then
...
procedure TdxSingleLineCornerViewInfo.Export(const AExporter
  : IdxDocumentLayoutExporter; X, Y: Integer);
begin
...
constructor TdxMultiLineCornerViewInfoBase.Create(ABorderAtLeft, ABorderAtTop,
  ABorderAtRight, ABorderAtBottom: TdxBorderInfo; const AWidth, AHeight: Single;
  ACornerType: TdxCornerViewInfoType);
begin
  inherited Create(ACornerType);
  WidthF := AWidth;
  ...
  else if ABorderAtTop <> nil then
    FColor := ABorderAtTop.Color
  else if ABorderAtRight <> nil then
    FColor := ABorderAtRight.Color
  else if ABorderAtBottom <> nil then
    FColor := ABorderAtBottom.Color
  else
    Assert(False);
  Pattern := CreatePattern(ABorderAtLeft, ABorderAtTop, ABorderAtRight,
    ABorderAtBottom);
end;
...
function TdxMultiLineCornerViewInfoBase.CreatePattern(ABorderAtLeft,
  ABorderAtTop, ABorderAtRight, ABorderAtBottom: TdxBorderInfo)
...
begin
  ...
  try
    ...
    begin
      Widths := ATableBorderCalculator.GetDrawingCompoundArray
        (ATopOrBottomBorderInfo);
      SetLength(Heights, 2);
      Heights[0] := 0;
      Heights[1] := 1;
    ...
    begin
      ...
      Widths[0] := 0;
      Widths[1] := 1;
      Heights := ATableBorderCalculator.GetDrawingCompoundArray
        (ALeftOrRightBorderInfo);
...
procedure TdxMultiLineCornerViewInfoBase.Export(const AExporter
  : IdxDocumentLayoutExporter; X, Y: Integer);
begin
  AExporter.ExportTableBorderCorner(Self, X, Y);
end;
...
function TdxDoubleLineCornerViewInfo.GetBottomBorderMask
  : TArray<TArray<Boolean>>;
begin
  Result := FBottomBorderMask;
end;

function TdxDoubleLineCornerViewInfo.GetCommonBorderMask
  : TArray<TArray<Boolean>>;
begin
  Result := FCommonBorderMask;
end;

function TdxDoubleLineCornerViewInfo.GetHorizontalBordersMask
  : TArray<TArray<Boolean>>;
begin
...
function TdxDoubleLineCornerViewInfo.GetRightBorderMask
  : TArray<TArray<Boolean>>;
begin
...
function TdxDoubleLineCornerViewInfo.GetVerticalBordersMask
  : TArray<TArray<Boolean>>;
begin
...
function TdxTripleLineCornerViewInfo.CreatePattern(ABorderAtLeft, ABorderAtTop,
  ABorderAtRight, ABorderAtBottom: TdxBorderInfo): TArray<TArray<Boolean>>;
begin
  Result := inherited CreatePattern(ABorderAtLeft, ABorderAtTop, ABorderAtRight,
    ABorderAtBottom);
...
function TdxTripleLineCornerViewInfo.GetBottomBorderMask
  : TArray<TArray<Boolean>>;
begin
  Result := FBottomBorderMask;
end;

function TdxTripleLineCornerViewInfo.GetCommonBorderMask
  : TArray<TArray<Boolean>>;
begin
  Result := FCommonBorderMask;
end;

function TdxTripleLineCornerViewInfo.GetHorizontalBordersMask
  : TArray<TArray<Boolean>>;
begin
  Result := FHorizontalBordersMask;
end;
...
function TdxTripleLineCornerViewInfo.GetRightBorderMask
  : TArray<TArray<Boolean>>;
begin
  Result := FRightBorderMask;
end;
...
function TdxTripleLineCornerViewInfo.GetVerticalBordersMask
  : TArray<TArray<Boolean>>;
begin
  Result := FVerticalBordersMask;
end;
...
constructor TdxTableRowViewInfoBase.Create(ATableViewInfo: TdxTableViewInfo;
  ARowIndex: Integer);
begin
  inherited Create;
...
function TdxTableRowViewInfoNoCellSpacing.CalculateVerticalBorders
  : TdxTableCellVerticalBorderViewInfoList;
var
  ARow: TdxTableRow;
  ACells: TdxTableCellCollection;
...
begin
  ...
  try
    ...
    begin
      ...
      AResultBorder := ACalculator.GetVerticalBorderSource(ATable,
        ALeftCellBorder, ARightCellBorder);

      Result.Add(TdxTableCellVerticalBorderViewInfo.Create(Self, AResultBorder,
        ALayoutBorderIndex, AModelBorderIndex,
        TableViewInfo.Table.DocumentModel.ToDocumentLayoutUnitConverter));
      if I < ACount then
      begin
...
function TdxTableRowViewInfoNoCellSpacing.GetBorderIndexByColumnIndex
  (ALayoutBorderIndex: Integer): Integer;
var
  AComparer: TdxVerticalBorderAndColumnIndexComparable;
begin
  AComparer := TdxVerticalBorderAndColumnIndexComparable.Create
    (ALayoutBorderIndex);
  TdxAlgorithms1<TdxTableCellVerticalBorderViewInfo>.BinarySearch
    (VerticalBorders, AComparer.CompareTo, Result);
end;

procedure TdxTableRowViewInfoNoCellSpacing.ExportTo(const AExporter
  : IdxDocumentLayoutExporter);
var
  I, ACount: Integer;
begin
...
begin
  ...
  ALeft := TableViewInfo.GetVerticalBorderPosition
    (Row.LayoutProperties.GridBefore);
  ARight := TableViewInfo.GetVerticalBorderPosition
    (Row.Table.GetLastCellColumnIndexConsiderRowGrid(Row, True));
  Result.Init(ALeft, ATop, ARight, ABottom);
end;

function TdxTableRowViewInfoNoCellSpacing.GetVerticalBorderBounds
  (ALayoutBorderIndex: Integer): TRect;
var
...
begin
  ...
  ALayoutActualWidth := Row.DocumentModel.ToDocumentLayoutUnitConverter.
    ToLayoutUnits(AActualWidth);
  Result.InitSize(Result.Left - ALayoutActualWidth div 2, Result.Top,
    ALayoutActualWidth, Result.Height);
end;

{ TdxTableRowViewInfoWithCellSpacing }

constructor TdxTableRowViewInfoWithCellSpacing.Create(ATableViewInfo
  : TdxTableViewInfo; ARowIndex: Integer; ACellSpacing: TdxModelUnit);
begin
  inherited Create(ATableViewInfo, ARowIndex);
  FCellSpacing := ACellSpacing;
end;

function TdxTableRowViewInfoWithCellSpacing.GetVerticalBorderBounds
  (ALayoutBorderIndex: Integer): TRect;
var
  ...
  ACells: TdxTableCellCollection;
begin
  APosition := TableViewInfo.VerticalBorderPositions.AlignedPosition
    [ALayoutBorderIndex] + TableViewInfo.Column.Bounds.Left;
  ATop := TopAnchor.VerticalPosition;
  ABottom := BottomAnchor.VerticalPosition;
  ACellIndex := Row.Table.GetAbsoluteCellIndexInRow(Row,
    ALayoutBorderIndex, True);
  ACalculator := TdxTableBorderCalculator.Create;
  try
    ACells := Row.Cells;
    if ACellIndex > 0 then
      ABorderAtLeftWidth := ACalculator.GetActualWidth
        (ACells[ACellIndex - 1].GetActualRightCellBorder)
    else
      ABorderAtLeftWidth := 0;
    if ACellIndex < ACells.Count then
      ABorderAtRightWidth := ACalculator.GetActualWidth
        (ACells[ACellIndex].GetActualLeftCellBorder)
    else
      ABorderAtRightWidth := 0;
  finally
    ACalculator.Free;
  end;
  AWidth := Converter.ToLayoutUnits(ABorderAtLeftWidth + ABorderAtRightWidth +
    FCellSpacing);
  Result.InitSize(APosition - AWidth div 2, ATop, AWidth, ABottom - ATop);
end;

procedure TdxTableRowViewInfoWithCellSpacing.ExportTo(const AExporter
  : IdxDocumentLayoutExporter);
var
  ...
  ATopLeftCorner, ATopRightCorner, ABottomLeftCorner, ABottomRightCorner
    : TdxCornerViewInfoBase;
begin
  if VerticalBorders = nil then
    Exit;
  ...
  begin
    ...
    ARightBorderViewInfo := TdxRightTableCellBorderViewInfo.Create
      (ACellViewInfo);
    ATopBorderViewInfo := TdxTopTableCellBorderViewInfo.Create(ACellViewInfo);
    ABottomBorderViewInfo := TdxBottomTableCellBorderViewInfo.Create
      (ACellViewInfo);
    try
      ATopBounds := ATopBorderViewInfo.GetBoundsCore(TableViewInfo);
      ATopLeftCorner := TdxCornerViewInfoBase.CreateCorner(Converter, nil, nil,
        ATopBorderViewInfo.Border, ALeftBorderViewInfo.Border, CellSpacing);
      AExporter.ExportTableBorderCorner(ATopLeftCorner, ATopBounds.Left,
        ATopBounds.Top);
      ATopRightCorner := TdxCornerViewInfoBase.CreateCorner(Converter,
        ATopBorderViewInfo.Border, nil, nil, ARightBorderViewInfo.Border,
        CellSpacing);
      AExporter.ExportTableBorderCorner(ATopRightCorner, ATopBounds.Right,
        ATopBounds.Top);

      ABottomBounds := ABottomBorderViewInfo.GetBoundsCore(TableViewInfo);
      ABottomLeftCorner := TdxCornerViewInfoBase.CreateCorner(Converter, nil,
        ALeftBorderViewInfo.Border, ABottomBorderViewInfo.Border, nil,
        CellSpacing);
      AExporter.ExportTableBorderCorner(ABottomLeftCorner, ABottomBounds.Left,
        ABottomBounds.Bottom);
      ABottomRightCorner := TdxCornerViewInfoBase.CreateCorner(Converter,
        ABottomBorderViewInfo.Border, ARightBorderViewInfo.Border, nil, nil,
        CellSpacing);
      AExporter.ExportTableBorderCorner(ABottomRightCorner, ABottomBounds.Right,
        ABottomBounds.Bottom);
...
begin
  ...
  begin
    ACellSpacing := Converter.ToLayoutUnits
      (TdxTableRowViewInfoWithCellSpacing(Previous).CellSpacing);
...
procedure TdxTableRowViewInfoWithCellSpacing.ExportTableBorders(const AExporter
  : IdxDocumentLayoutExporter);
var
...
begin
  ...
  ATopLeftCorner := TdxCornerViewInfoBase.CreateCorner(Converter, nil, nil,
    ATopBorder, ALeftTableBorderViewInfo.Border, 0);
  ATopRightCorner := TdxCornerViewInfoBase.CreateCorner(Converter, ATopBorder,
    nil, nil, ARightTableBorderViewInfo.Border, 0);
  ABottomLeftCorner := TdxCornerViewInfoBase.CreateCorner(Converter, nil,
    ALeftTableBorderViewInfo.Border, ABottomBorder, nil, 0);
  ABottomRightCorner := TdxCornerViewInfoBase.CreateCorner(Converter,
    ABottomBorder, ARightTableBorderViewInfo.Border, nil, nil, 0);
  try
    AExporter.ExportTableBorderCorner(ATopLeftCorner, ALeftBounds.Left,
      ALeftBounds.Top);
    AExporter.ExportTableBorderCorner(ATopRightCorner, ALeftBounds.Right,
      ALeftBounds.Top);
    AExporter.ExportTableBorderCorner(ABottomLeftCorner, ARightBounds.Left,
      ARightBounds.Bottom);
    AExporter.ExportTableBorderCorner(ABottomRightCorner, ARightBounds.Right,
      ARightBounds.Bottom);
...
function TdxTableRowViewInfoWithCellSpacing.GetConverter
  : TdxDocumentModelUnitToLayoutUnitConverter;
begin
  Result := TableViewInfo.Table.DocumentModel.ToDocumentLayoutUnitConverter;
end;

function TdxTableRowViewInfoWithCellSpacing.CalculateVerticalBorders
  : TdxTableCellVerticalBorderViewInfoList;
begin
...
function TdxParagraphIndexComparer.Compare(const X,
  Y: TdxTableCellViewInfo): Integer;
begin
  Result := CompareInteger(X.Cell.StartParagraphIndex,
    Y.Cell.StartParagraphIndex);
end;

{ TdxTableViewInfo }

constructor TdxTableViewInfo.Create(ATable: TdxTable;
  ATopLevelColumn: TdxColumn; AColumn: TdxColumn;
  AVerticalBorderPositions: TdxVerticalBorderPositions; ATopRowIndex: Integer;
...
begin
  Result := VerticalBorderPositions.AlignedPosition[AColumnIndex] +
    Column.Bounds.Left
end;

function TdxTableViewInfo.GetColumnRight(AColumnIndex: Integer): TdxLayoutUnit;
begin
  Result := VerticalBorderPositions.AlignedPosition[AColumnIndex + 1] +
    Column.Bounds.Left;
end;

function TdxTableViewInfo.GetVerticalBorderPosition(ABorderIndex
  : Integer): Integer;
begin
  Result := VerticalBorderPositions.AlignedPosition[ABorderIndex] +
    Column.Bounds.Left;
end;
...
procedure TdxTableViewInfo.ExportAnchorCorner(const AExporter
  : IdxDocumentLayoutExporter; AAnchor: TdxTableCellVerticalAnchor);
var
...
begin
  ...
  begin
    ...
    if I < AAnchor.CellBorders.Count then
      ...
      ALeft := GetColumnRight(AAnchor.CellBorders[AAnchor.CellBorders.Count - 1]
        .EndColumnIndex);
    ACornerViewInfo.Export(AExporter, ALeft, AAnchor.VerticalPosition);
  end;
end;

function TdxTableViewInfo.GetVerticalBorderByColumnIndex
  (ARowViewInfo: TdxTableRowViewInfoNoCellSpacing; ACornerColumnIndex: Integer)
  : TdxTableCellVerticalBorderViewInfo;
var
  ARow: TdxTableRow;
  AColumnIndex, ACellIndex: Integer;
begin
  ...
  AColumnIndex := ARow.LayoutProperties.GridBefore;
  ACellIndex := 0;
  while (ACornerColumnIndex > AColumnIndex) and
    (ACellIndex < ARow.Cells.Count) do
  begin
...
procedure TdxTableViewInfo.ExportCellsVerticalBorders(ATableRowViewInfoBase
  : TdxTableRowViewInfoBase; const AExporter: IdxDocumentLayoutExporter);
begin
  ATableRowViewInfoBase.ExportTo(AExporter);
end;

procedure TdxTableViewInfo.ExportBackground(const AExporter
  : IdxDocumentLayoutExporter);
begin
...
procedure TdxTableViewInfo.ExportBackgroundCore(const AExporter
  : IdxDocumentLayoutExporter;
const ARowAction: TdxAction<TdxTableRowViewInfoBase>);
var
  ARow: TdxTableRowViewInfoBase;
...
procedure TdxTableViewInfo.ExportRowCells(ARow: TdxTableRowViewInfoBase;
const AExporter: IdxDocumentLayoutExporter);
var
  I, ACount: Integer;
...
begin
  ...
  ACount := ACells.Count;
  for I := 0 to ACount - 1 do
    if Anchors[ACells[I].TopAnchorIndex] = TdxTableCellVerticalAnchor
      (ARow.TopAnchor) then
...
procedure TdxTableViewInfo.ExportAnchorBorders
  (AAnchor: TdxTableCellVerticalAnchor;
const AExporter: IdxDocumentLayoutExporter);
var
  ACellBorders: TdxHorizontalCellBordersInfoList;
...
begin
  ...
  begin
    ...
    if ABorderInfo.Border = nil then
      Continue;
    AViewInfo := TdxTableCellHorizontalBorderViewInfo.Create(AAnchor,
      ABorderInfo, Table.DocumentModel.ToDocumentLayoutUnitConverter,
      AAnchor.Corners[I], AAnchor.Corners[I + 1]);
    try
...
function TdxTableViewInfo.GetCellBounds(ACellViewInfo
  : TdxTableCellViewInfo): TRect;
var
  ATopAnchorIndex, ABottomAnchorIndex, ATop, ATopBorder,
    ATopMarginValue: Integer;
...
begin
  ...
  try
    ATopBorder := ABorderCalculator.GetActualWidth
      (ACellViewInfo.Cell.GetActualTopCellBorder);
  finally
  ...
  Dec(ATop, ACellViewInfo.Cell.DocumentModel.ToDocumentLayoutUnitConverter.
    ToLayoutUnits(ATopBorder + ATopMarginValue));
  Result.InitSize(ACellViewInfo.Left, ATop, ACellViewInfo.Width,
    ABottomAnchor.VerticalPosition - ATop);
end;

procedure TdxTableViewInfo.Complete(ATopBorderHeight: TdxLayoutUnit;
ABottomBorderHeight: TdxLayoutUnit);
var
...
begin
  ...
  begin
    Anchors.RemoveAnchors(ALastTableAnchorIndex + 1,
      Anchors.Count - ALastTableAnchorIndex - 1);
...
procedure TdxTableViewInfo.RemoveInnerTablesFromTopLevelColumn
...
procedure TdxTableViewInfo.RemoveTableViewInfoFromTopLevelColumn
  (ATableViewInfo: TdxTableViewInfo);
var
...
begin
  ...
  for I := 0 to ACellCount - 1 do
  begin
    FColumn.TopLevelColumn.RemoveTableCellViewInfoContent
      (ATableViewInfo.Cells[I]);
...
procedure TdxTableViewInfo.CreateAnchorCorner
  (AConverter: TdxDocumentModelUnitToLayoutUnitConverter;
AAnchor: TdxTableCellVerticalAnchor; ATopRow: TdxTableRowViewInfoNoCellSpacing;
ABottomRow: TdxTableRowViewInfoNoCellSpacing);
var
  ABorders: TdxHorizontalCellBordersInfoList;
  I, ABorderCount, ACornerColumnIndex: Integer;
  ALeftBorderInfo, ARightBorderInfo: TdxNullableHorizontalCellBordersInfo;
  ABorderViewInfoAtTop, ABorderViewInfoAtBottom
    : TdxTableCellVerticalBorderViewInfo;
...
begin
  ...
  begin
    ...
    if (not ALeftBorderInfo.IsNull) and (ALeftBorderInfo.Value.Border <> nil)
    then
      ABorderAtLeft := ALeftBorderInfo.Value.Border.Info
    else
      ABorderAtLeft := nil;

    if (not ARightBorderInfo.IsNull) and (ARightBorderInfo.Value.Border <> nil)
    then
    ...
    ABorderViewInfoAtTop := GetVerticalBorderByColumnIndex(ATopRow,
      ACornerColumnIndex);
    ABorderViewInfoAtBottom := GetVerticalBorderByColumnIndex(ABottomRow,
      ACornerColumnIndex);
    ...
    ACornerViewInfo := TdxCornerViewInfoBase.CreateCorner(AConverter,
      ABorderAtLeft, ABorderAtTop, ABorderAtRight, ABorderAtBottom, 0);
...
function TdxTableViewInfo.GetAlignedPosition(AHorizontalPositionIndex
  : Integer): Integer;
begin
  Result := VerticalBorderPositions.AlignedPosition[AHorizontalPositionIndex] +
    Column.Bounds.Left;
end;
...
function TdxNumberingListBox.GetNumerationCharacterProperties
  (APieceTable: TdxCustomPieceTable): TdxMergedCharacterProperties;
var
...
procedure TdxNumberingListBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
  (AExporter as IdxDocumentLayoutExporter).ExportNumberingListBox(Self);
end;

function TdxNumberingListBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
  Result := (ACalculator as IdxBoxHitTestCalculator)
    .CreateNumberingListBoxHitTestManager(Self);
end;

function TdxNumberingListBox.GetDocumentPosition(APieceTable
  : TdxCustomPieceTable; const APos: TdxFormatterPosition)
...
function TdxNumberingListBox.GetFirstPosition(APieceTable: TdxCustomPieceTable)
  : TdxDocumentModelPosition;
begin
  TdxRichEditExceptions.ThrowInternalException;
...
function TdxNumberingListBox.GetFontInfo(APieceTable: TdxCustomPieceTable)
  : TdxFontInfo;
var
  AParagraph: TdxParagraph;
begin
  AParagraph := TdxParagraph(APieceTable.Runs[Self.StartPos.RunIndex]
    .Paragraph);
  Result := AParagraph.GetNumerationFontInfo;
end;

function TdxNumberingListBox.GetActualForeColor(APieceTable
  : TdxCustomPieceTable; ATextColors: TdxTextColors; ABackColor: TdxAlphaColor)
  : TdxAlphaColor;
var
...
begin
  ...
  try
    ...
    Result := TdxAutoColorUtils.GetActualForeColor(ABackColor, AColor,
      ATextColors);
  finally
...
function TdxNumberingListBox.GetFontUnderlineType
  (APieceTable: TdxCustomPieceTable): TdxUnderlineType;
var
  ACharacterProperties: TdxMergedCharacterProperties;
begin
  ACharacterProperties := GetNumerationCharacterProperties(APieceTable);
...
function TdxNumberingListBox.GetFontStrikeoutType
  (APieceTable: TdxCustomPieceTable): TdxStrikeoutType;
var
  ACharacterProperties: TdxMergedCharacterProperties;
begin
  ACharacterProperties := GetNumerationCharacterProperties(APieceTable);
...
function TdxNumberingListBox.GetLastPosition(APieceTable: TdxCustomPieceTable)
  : TdxDocumentModelPosition;
begin
  TdxRichEditExceptions.ThrowInternalException;
...
function TdxNumberingListBox.GetStrikeoutColorCore
  (APieceTable: TdxCustomPieceTable): TdxAlphaColor;
var
  ACharacterProperties: TdxMergedCharacterProperties;
begin
  ACharacterProperties := GetNumerationCharacterProperties(APieceTable);
...
function TdxNumberingListBox.GetUnderlineColorCore
  (APieceTable: TdxCustomPieceTable): TdxAlphaColor;
var
  ACharacterProperties: TdxMergedCharacterProperties;
begin
...
function TdxPageBreakBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
  Result := (ACalculator as IdxBoxHitTestCalculator)
    .CreatePageBreakBoxHitTestManager(Self);
end;

procedure TdxPageBreakBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
...
function TdxColumnBreakBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
  Result := (ACalculator as IdxBoxHitTestCalculator)
    .CreateColumnBreakBoxHitTestManager(Self);
end;

procedure TdxColumnBreakBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
...
function TdxNumberingListBoxInfo.GetFontInfo(APieceTable: TdxCustomPieceTable)
  : TdxFontInfo;
begin
...
procedure TdxRowCollection.RegisterSuccessfulItemHitTest
...
begin
  ...
  ABoxCalculator.HitTestResult.IncreaseDetailsLevel
    (TdxDocumentLayoutDetailsLevel.Row);
end;

procedure TdxRowCollection.RegisterFailedItemHitTest
  (ACalculator: TdxBoxHitTestCustomCalculator);
begin
...
function TdxFloatingObjectAnchorBox.CalcAscentAndFree
  (APieceTable: TdxCustomPieceTable): Integer;
begin
  Result := Bounds.Height;
end;

function TdxFloatingObjectAnchorBox.CalcBaseAscentAndFree
  (APieceTable: TdxCustomPieceTable): Integer;
begin
  Result := CalcAscentAndFree(APieceTable);
end;

function TdxFloatingObjectAnchorBox.CalcBaseDescent
  (APieceTable: TdxCustomPieceTable): Integer;
begin
  Result := CalcDescent(APieceTable);
end;

function TdxFloatingObjectAnchorBox.CalcDescent(APieceTable
  : TdxCustomPieceTable): Integer;
begin
  Result := 0;
end;
...
function TdxFloatingObjectAnchorBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
  Result := nil;
end;

procedure TdxFloatingObjectAnchorBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
end;
...
begin
  Bounds := TRect.CreateSize(Bounds.Left, Bounds.Top, Bounds.Width,
    Bounds.Height + ADelta);
...
function TdxFloatingObjectAnchorBox.GetFloatingObjectRun
  (APieceTable: TdxCustomPieceTable): TdxFloatingObjectAnchorRun;
begin
...
procedure TdxFloatingObjectAnchorBox.SetFloatingObjectBox
  (const Value: TdxFloatingObjectBox);
begin
...
procedure TdxFloatingObjectAnchorBox.SetFloatingObjectRun
...
constructor TdxFootNotePageArea.Create(AFootNote: TdxFootNote;
ASection: TdxSection; AReferenceRunIndex: TdxRunIndex);
begin
...
procedure TdxBookmarkStartBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
...
procedure TdxBookmarkEndBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
...
constructor TdxLineNumberBox.Create(ARun: TdxLineNumberCommonRun; ARow: TdxRow;
const AText: string);
begin
  inherited Create;
  Assert(ARun <> nil);
...
function TdxLineNumberBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
  Result := nil;
end;

procedure TdxLineNumberBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
...
constructor TdxDocumentLayout.Create(ADocumentModel: TdxCustomDocumentModel;
const AMeasurerProvider: IdxBoxMeasurerProvider);
begin
  inherited Create;
...
function TdxDocumentLayout.CreateLayoutPosition(APieceTable
  : TdxCustomPieceTable; ALogPosition: TdxDocumentLogPosition;
APreferredPageIndex: Integer): TObject;
begin
  if APieceTable.ContentType.IsHeaderFooter then
    Result := TdxHeaderFooterDocumentLayoutPosition.Create(Self,
      TdxPieceTable(APieceTable), ALogPosition, APreferredPageIndex)
  else if APieceTable.ContentType.IsTextBox then
    Result := TdxTextBoxDocumentLayoutPosition.Create(Self,
      TdxTextBoxContentType(APieceTable.ContentType), ALogPosition,
      APreferredPageIndex)
  else
...
function TdxDocumentLayout.CreateDetailRowForBox(ARow: TdxRow; ABox: TdxBox;
ASuppressSuspendFormatting: Boolean): TdxDetailRow;
begin
...
begin
  ...
  AExporter := TdxCharacterBoxLevelDocumentLayoutExporter.Create
    (TdxDocumentModel(DocumentModel), AChars, Measurer);
  try
...
function TdxDocumentLayout.CreateDetailRowForBoxCore(ARow: TdxRow; ABox: TdxBox)
  : TdxDetailRow;
var
  AChars: TdxCharacterBoxCollection;
  AExporter: TdxCharacterBoxLevelDocumentLayoutExporter;
...
function TdxSectionMarkBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
  Result := (ACalculator as IdxBoxHitTestCalculator)
    .CreateSectionMarkBoxHitTestManager(Self);
end;

procedure TdxSectionMarkBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
...
procedure TdxLayoutDependentTextBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
  (AExporter as IdxDocumentLayoutExporter).ExportLayoutDependentTextBox(Self);
end;

function TdxLayoutDependentTextBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
  Result := (ACalculator as IdxBoxHitTestCalculator)
    .CreateTextBoxHitTestManager(Self);
end;
...
procedure TdxColumn.ClearInvalidatedParagraphFramesCore(AFrom,
  ATo: TdxParagraphIndex);
begin
...
function TdxColumn.ContainsParagraphFrame(AParagraph: TdxParagraphBase)
  : Boolean;
var
  I, ACount: Integer;
begin
  ...
  for I := 0 to ACount - 1 do
  begin
    if (ParagraphFrames[I].ParagraphIndex = AParagraph.Index) and
      (ParagraphFrames[I].PieceTable = AParagraph.PieceTable) then
      Exit(True);
  end;
  Result := False;
end;
...
function TdxColumn.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
  Result := (ACalculator as IdxBoxHitTestCalculator)
    .CreateColumnHitTestManager(Self);
end;
...
function TdxColumn.GetFirstPosition(APieceTable: TdxCustomPieceTable)
  : TdxDocumentModelPosition;
begin
  if IsEmpty then
...
function TdxColumn.GetLastPosition(APieceTable: TdxCustomPieceTable)
  : TdxDocumentModelPosition;
begin
  if IsEmpty then
    Result := TdxDocumentModelPosition.MaxValue
...
begin
  ...
  while ATopLevelTableViewInfo.ParentTableCellViewInfo <> nil do
    ATopLevelTableViewInfo := ATopLevelTableViewInfo.ParentTableCellViewInfo.
      TableViewInfo;
...
procedure TdxColumn.RemoveTableViewInfoWithContent(ATableViewInfo
  : TdxTableViewInfo);
begin
...
begin
  ...
  ClearInvalidatedParagraphFramesCore(ACell.Cell.StartParagraphIndex,
    ACell.Cell.EndParagraphIndex);
end;
...
procedure TdxColumnCollection.RegisterFailedItemHitTest
  (ACalculator: TdxBoxHitTestCustomCalculator);
begin
...
begin
  ...
  TdxBoxHitTestCalculator(ACalculator).HitTestResult.IncreaseDetailsLevel
...
procedure TdxCustomMarkBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
...
procedure TdxPageAreaCollection.RegisterSuccessfulItemHitTest
  (ACalculator: TdxBoxHitTestCustomCalculator; AItem: TdxBox);
var
  ABoxCalculator: TdxBoxHitTestCalculator;
begin
  ...
  ABoxCalculator.HitTestResult.IncreaseDetailsLevel
    (TdxDocumentLayoutDetailsLevel.PageArea);
end;

procedure TdxPageAreaCollection.RegisterFailedItemHitTest
  (ACalculator: TdxBoxHitTestCustomCalculator);
begin
...
begin
  Result := CompareInteger(TdxParagraphFrameBox(ALeft).ParagraphIndex,
    TdxParagraphFrameBox(ARight).ParagraphIndex);
end;
...
procedure TdxParagraphFrameBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
...
function TdxParagraphFrameBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
  raise TdxNotImplementedException.Create;
end;

class function TdxParagraphFrameBox.CreateTransformUnsafe(AAngle: Single;
...
begin
  Result := CreateTransformUnsafe(-TdxDocumentModel(PieceTable.DocumentModel)
    .GetBoxEffectiveRotationAngleInDegrees(Self), ActualSizeBounds)
end;
...
begin
  ...
  try
    ...
    Result := ((AFrameProperties.Info.Y <> 0) or
      (AVerticalAlignment = TdxParagraphFrameVerticalPositionAlignment.None) or
      (AVerticalAlignment = TdxParagraphFrameVerticalPositionAlignment.Inline))
      and (AFrameProperties.Info.VerticalPositionType =
...
function TdxParagraphFrameBox.TransformPointBackward(const APoint
  : TPoint): TPoint;
var
  ATransform: TdxTransformMatrix;
begin
...
function TdxParagraphFrameBoxAndParagraphIndexComparable.CompareTo
  (const AOther: TdxParagraphFrameBox): Integer;
begin
  if FParagraphIndex < AOther.ParagraphIndex then
    Result := 1
  else if FParagraphIndex > AOther.ParagraphIndex then
    Result := -1
  else
    Result := 0;
end;
...
procedure TdxParagraphFrameBoxCollection.ExportTo(const AExporter
  : IdxDocumentLayoutExporter);
var
  I, ACount: Integer;
begin
...
procedure TdxParagraphFrameBoxCollection.ClearInvalidatedParagraphFrames(AFrom,
  ATo: TdxParagraphIndex);
var
...
begin
  ...
  if not TdxAlgorithms1<TdxParagraphFrameBox>.BinarySearch(Self,
    AComparable.CompareTo, AFirstIndex) then
  begin
...
function TdxColumnExtendedBoxes.GetParagraphFrames
  : TdxParagraphFrameBoxCollection;
begin
...
constructor TdxCounterItem.Create(ALogPosition: TdxDocumentLogPosition;
AValue: Integer);
begin
  FLogPosition := ALogPosition;
  FValue := AValue;
...
begin
  ...
  TdxAlgorithms<TdxCounterItem>.BinarySearch(FItems,
    AComparable.CompareTo, AIndex);
...
begin
  AComparable := TdxCounterItemAndLogPositionComparable.Create(ALogPosition);
  if TdxAlgorithms<TdxCounterItem>.BinarySearch(FItems, AComparable.CompareTo,
    AIndex) then
...
procedure TdxPageCollection.RegisterSuccessfulItemHitTest
  (ACalculator: TdxBoxHitTestCustomCalculator; AItem: TdxBox);
var
  ABoxCalculator: TdxBoxHitTestCalculator;
begin
...
procedure TdxPageCollection.RegisterFailedItemHitTest
  (ACalculator: TdxBoxHitTestCustomCalculator);
var
  ABoxCalculator: TdxBoxHitTestCalculator;
begin
...
constructor TdxPageArea.Create(APieceTable: TdxContentTypeBase;
ASection: TdxSection);
begin
  inherited Create;
...
function TdxPageArea.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
  Result := (ACalculator as IdxBoxHitTestCalculator)
    .CreatePageAreaHitTestManager(Self);
end;

procedure TdxPageArea.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
...
function TdxPageArea.GetFirstPosition(APieceTable: TdxCustomPieceTable)
  : TdxDocumentModelPosition;
begin
  if IsEmpty then
    Result := TdxDocumentModelPosition.MaxValue
...
function TdxPageArea.GetLastPosition(APieceTable: TdxCustomPieceTable)
  : TdxDocumentModelPosition;
begin
  if IsEmpty then
    Result := TdxDocumentModelPosition.MaxValue
...
function TdxPage.FindFloatingObject(AObjects: TdxFloatingObjectBoxList;
ARun: TdxFloatingObjectAnchorRun): TdxFloatingObjectBox;
var
  I: Integer;
begin
  Result := nil;
...
procedure TdxPage.ClearFloatingObjects(APieceTable: TdxCustomPieceTable;
ARunIndex: TdxRunIndex; AObjects: TdxFloatingObjectBoxList);
var
  I: Integer;
begin
  if AObjects = nil then
  ...
  for I := AObjects.Count - 1 downto 0 do
    if (APieceTable = nil) or (AObjects[I].PieceTable = APieceTable) and
      (ARunIndex <= AObjects[I].StartPos.RunIndex) then
      AObjects.Delete(I);
end;
...
procedure TdxPage.ClearComments(APieceTable: TdxCustomPieceTable;
ARunIndex: TdxRunIndex);
begin
...
function TdxPage.FindFloatingObject(ARun: TdxFloatingObjectAnchorRun)
  : TdxFloatingObjectBox;
begin
...
procedure TdxPage.ClearInvalidatedContent(ARunIndex: TdxRunIndex;
APieceTable: TdxCustomPieceTable);
begin
...
procedure TdxPage.ClearParagraphFrames(APieceTable: TdxCustomPieceTable;
ARunIndex: TdxRunIndex; AItems: TdxParagraphFrameBoxList);
var
  I: Integer;
begin
  if AItems = nil then
  ...
  for I := AItems.Count - 1 downto 0 do
    if (APieceTable = nil) or ((AItems[I].PieceTable = APieceTable) and
      (ARunIndex <= AItems[I].StartPos.RunIndex)) then
      AItems.Delete(I);
end;

function TdxPage.GetActiveFirstArea(APieceTable: TdxCustomPieceTable)
  : TdxPageArea;
begin
  Result := nil;
...
function TdxPage.GetActiveLastArea(APieceTable: TdxCustomPieceTable)
  : TdxPageArea;
begin
  Result := nil;
  if (Header <> nil) and (APieceTable = Header.PieceTable) then
...
function TdxPage.GetFirstPosition(APieceTable: TdxCustomPieceTable)
  : TdxDocumentModelPosition;
var
  AArea: TdxPageArea;
begin
...
function TdxPage.GetLastPosition(APieceTable: TdxCustomPieceTable)
  : TdxDocumentModelPosition;
var
  AArea: TdxPageArea;
begin
...
function TdxPage.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
  Result := (ACalculator as IdxBoxHitTestCalculator)
    .CreatePageHitTestManager(Self);
end;
...
function TdxPage.GetSortedNonBackgroundFloatingObjects
...
procedure TdxLineNumberBoxCollection.RegisterSuccessfulItemHitTest
  (ACalculator: TdxBoxHitTestCustomCalculator; AItem: TdxBox);
begin
  // do nothing
end;

procedure TdxLineNumberBoxCollection.RegisterFailedItemHitTest
  (ACalculator: TdxBoxHitTestCustomCalculator);
begin
  // do nothing
end;
...
begin
  Result := CompareInteger(TdxFloatingObjectBox(ALeft)
    .GetFloatingObjectRun.FloatingObjectProperties.ZOrder,
    TdxFloatingObjectBox(ARight)
    .GetFloatingObjectRun.FloatingObjectProperties.ZOrder);
end;
...
function TdxFloatingObjectBox.CalcAscentAndFree(APieceTable
  : TdxCustomPieceTable): Integer;
begin
  Result := Bounds.Height;
end;

function TdxFloatingObjectBox.CalcBaseAscentAndFree
  (APieceTable: TdxCustomPieceTable): Integer;
begin
  Result := CalcAscentAndFree(PieceTable);
end;

function TdxFloatingObjectBox.CalcBaseDescent(APieceTable
  : TdxCustomPieceTable): Integer;
begin
  Result := CalcDescent(PieceTable);
end;

function TdxFloatingObjectBox.CalcDescent(APieceTable
  : TdxCustomPieceTable): Integer;
begin
  Result := 0;
end;
...
function TdxFloatingObjectBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
  Result := nil;
end;
...
procedure TdxFloatingObjectBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
...
function TdxFloatingObjectBox.GetRun(APieceTable: TdxCustomPieceTable)
  : TdxRunBase;
begin
...
begin
  ...
  ASize.cx := ASize.cx - (ALeftMargin + AUnitConverter.ToLayoutUnits
    (ATextBoxProperties.RightMargin));
  ASize.cy := ASize.cy -
    (ATopMargin + AUnitConverter.ToLayoutUnits
...
begin
  Bounds := TRect.Create(Bounds.Left, Bounds.Top, Bounds.Right,
    Bounds.Bottom + ADelta);
  FActualSizeBounds.Height := FActualSizeBounds.Height + ADelta;
...
begin
  ...
  if AVerticalPositionAlignment <> TdxFloatingObjectVerticalPositionAlignment.None
  then
    Exit;
...
procedure TdxFloatingObjectBox.SetDocumentLayout(const Value
  : TdxDocumentLayout);
begin
...
constructor TdxTableCellVerticalAnchor.Create(AVerticalPosition,
...
begin
  ...
  Result := TdxTableCellVerticalAnchor.Create(ANewVerticalPosition,
    BottomTextIndent, ACellBorders);
...
function TdxTableCellVerticalAnchorYComparable.CompareTo(const AAnchor
  : TdxTableCellVerticalAnchor): Integer;
begin
  if FPos < AAnchor.VerticalPosition then
    Result := 1
  else if FPos > AAnchor.VerticalPosition then
    Result := -1
  else
    Result := 0;
end;
...
constructor TdxTableRowAnchorComparable.Create(APos: Integer;
...
function TdxTableRowAnchorComparable.CompareTo(const Value
  : TdxTableRowViewInfoBase): Integer;
var
...
function TdxTableCellAnchorComparable.CompareTo(const Value
  : TdxTableCellViewInfo): Integer;
begin
  if FPos < Value.Left then
    Result := 1
  else if FPos > Value.Left + Value.Width then
    Result := -1
  else
    Result := 0;
end;
...
constructor TdxExactPageComparable.Create(APieceTable: TdxCustomPieceTable;
ALogPosition: TdxDocumentLogPosition);
begin
  FPieceTable := APieceTable;
  FLogPosition := ALogPosition;
...
function TdxExactPageComparable.ExactColumnAndLogPositionCompare
  (const Value: TdxBoxBase): Integer;
var
  AColumn: TdxColumn;
  ACell: TdxTableCell;
  AParagraph: TdxParagraph;
          ...
          begin
            ...
            begin
              ...
              if AFirstRow = nil then
                Exit(1);
              AFirstPosition := AFirstRow.GetFirstPosition(PieceTable)
                .LogPosition;
              ...
              begin
                ALastPosition := ALastRow.GetLastPosition(PieceTable)
                  .LogPosition;
              ...
              Exit(ATableViewInfo.TopRowIndex - ACell.Table.Rows.IndexOf
                (ACell.Row));
          end;
...
function TdxExactPageComparable.ExactPageAndLogPositionCompare
  (const Value: TdxBoxBase): Integer;
var
...
begin
  ...
  if AFirstPos.LogPosition > LogPosition then
    Result := 1
  else if AFirstPos.LogPosition = LogPosition then
    Result := 0
  else
  begin
    APage := Value as TdxPage;
    AFirstAreaCompareResult := ExactPageAreaAndLogPositionCompare
      (APage.Areas[0]);
    if (APage.Areas.Count = 1) or (AFirstAreaCompareResult >= 0) then
      Result := AFirstAreaCompareResult
    else
    begin
      ALastAreaCompareResult := ExactPageAreaAndLogPositionCompare
        (APage.Areas.Last);
...
function TdxExactPageComparable.ExactPageAreaAndLogPositionCompare
  (const Value: TdxBoxBase): Integer;
var
  AFirstPos: TdxDocumentModelPosition;
  AArea: TdxPageArea;
...
begin
  ...
  begin
    ...
    begin
      AFirstBoxCompareResult := ExactColumnAndLogPositionCompare
        (AArea.Columns[0]);
      if (AArea.Columns.Count = 1) or (AFirstBoxCompareResult >= 0) then
        Result := AFirstBoxCompareResult
      else
      begin
        ALastBoxCompareResult := ExactColumnAndLogPositionCompare
          (AArea.Columns.Last);
...
function TdxExactPageComparable.FindTable(ATables: TdxTableViewInfoCollection;
