...
type
  ...
  class var
    ...
    FHorizontalPositionTypeAttributeTable
      : TdxMLDictionary<TdxFloatingObjectHorizontalPositionType>;
    FVerticalPositionTypeAttributeTable
    ...
    class function CreateHorizontalPositionTypeAttributeTable
      : TdxMLDictionary<TdxFloatingObjectHorizontalPositionType>; static;
    class function CreateVerticalPositionTypeAttributeTable
      : TdxMLDictionary<TdxFloatingObjectVerticalPositionType>; static;
  strict private
  ...
  protected
    ...
    FStyle: string;
    class procedure Add<T>(ATable: TDictionary<T, TdxWordProcessingMLValue>;
      AKey: T; const AOpenXmlValue: string); overload; static;
    class procedure Add<T>(ATable: TdxMLDictionary<T>; AKey: T;
      const AOpenXmlValue: string); overload; static;
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    function GetHorizontalPositionTypeAttributeTable
      : TdxMLDictionary<TdxFloatingObjectHorizontalPositionType>; virtual;
    function GetVerticalPositionTypeAttributeTable
      : TdxMLDictionary<TdxFloatingObjectVerticalPositionType>; virtual;
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxInlineObjectDestination; static;
    class function OnShape(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
    procedure AppendImage(APieceTable: TdxPieceTable;
      APosition: TdxImportInputPosition; AImage: TdxOfficeImageReference;
    ...
    function CalculateScale(const AOriginalSize: TSize;
  ...
  public
    ...
    function ConvertToHorizontalPositionType(const AValue: string)
      : TdxFloatingObjectHorizontalPositionType; virtual;
    function ConvertToVerticalPositionType(const AValue: string)
      : TdxFloatingObjectVerticalPositionType; virtual;
    ...
    class property OpenXmlHorizontalPositionTypeAttributeTable
      : TdxMLDictionary<TdxFloatingObjectHorizontalPositionType>
      read FHorizontalPositionTypeAttributeTable;
    class property OpenXmlVerticalPositionTypeAttributeTable
      : TdxMLDictionary<TdxFloatingObjectVerticalPositionType>
      read FVerticalPositionTypeAttributeTable;
  end;
  ...
  public
    ...
    procedure ReadFloatingObjectProperties(AReader: TdxXmlReader;
      AProperties: TdxFloatingObjectProperties); overload;
    procedure ReadShapeProperties(AReader: TdxXmlReader;
      AShape: TdxShape); overload;
    function GetBoolValue(const AValue: string): Boolean; inline;
    class function OnImageData(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnWrap(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
    class function OnLock(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
    class function OnTextBox(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnAnchorLock(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    ...
    property Image: TdxOfficeImageReference read GetImage write SetImage;
    property FloatingObjectImportInfo: TdxFloatingObjectImportInfo
      read GetFloatingObjectImportInfo;
  ...
  public
    constructor Create(AImporter: TdxWordProcessingMLBaseImporter;
      AFloatingObjectProperties: TdxFloatingObjectProperties);
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;
  end;
  ...
  protected
    ...
    procedure CssWidth(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    procedure CssHeight(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    procedure CssVerticalPositionType(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    procedure CssHorizontalPositionType(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    function GetFloatingObjectHorizontalPositionAlignment(const AValue: string)
      : TdxFloatingObjectHorizontalPositionAlignment;
    function GetFloatingObjectVerticalPositionAlignment(const AValue: string)
      : TdxFloatingObjectVerticalPositionAlignment;
    procedure CssHorizontalPositionAlignment(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    procedure CssVerticalPositionAlignment(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    procedure CssTextBoxVerticalAlignment(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    procedure CssTextBoxWrapType(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    function GetWrapText(const AValue: string): Boolean;
    function GetFloatingObjectVerticalAlignment(const AValue: string)
      : TdxVerticalAlignment;
    procedure CssZOrder(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    function GetModelUnitsFromUnitOrEmuValue(ACssUnitConverter
      : TdxDocumentModelUnitConverter; const APropertyValue: string): Integer;
    procedure CssTopDistance(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    procedure CssLeftDistance(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    procedure CssRightDistance(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    procedure CssBottomDistance(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    procedure CssMsoWidthPercent(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    procedure CssMsoHeightPercent(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    procedure CssMsoWidthRelative(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    procedure CssMsoHeightRelative(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    function GetFloatingObjectRelativeFromHorizontal(const AValue: string)
      : TdxFloatingObjectRelativeFromHorizontal;
    function GetFloatingObjectRelativeFromVertical(const AValue: string)
      : TdxFloatingObjectRelativeFromVertical;
    function GetPercentValue(const AValue: string): Integer;
    procedure CssOffsetX(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    procedure CssOffsetY(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
    procedure CssRotation(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>);
  public
    constructor Create(ADocumentModel: TdxDocumentModel;
      const AOriginalSize: TSize);
    destructor Destroy; override;
    ...
    property HorizontalPositionAlignment
      : TdxFloatingObjectHorizontalPositionAlignment
      read FHorizontalPositionAlignment;
    property VerticalPositionAlignment
      : TdxFloatingObjectVerticalPositionAlignment
      read FVerticalPositionAlignment;
    property TextBoxVerticalAlignment: TdxVerticalAlignment
      read FTextBoxVerticalAlignment;
...
begin
  ...
  FHorizontalPositionTypeAttributeTable :=
    CreateHorizontalPositionTypeAttributeTable;
  FVerticalPositionTypeAttributeTable :=
    CreateVerticalPositionTypeAttributeTable;
end;
...
constructor TdxInlineObjectDestination.Create
...
class function TdxInlineObjectDestination.CreateElementHandlerTable
...
class function TdxInlineObjectDestination.
  CreateHorizontalPositionTypeAttributeTable
  : TdxMLDictionary<TdxFloatingObjectHorizontalPositionType>;
begin
  Result := TdxMLDictionary<TdxFloatingObjectHorizontalPositionType>.Create;
  Add<TdxFloatingObjectHorizontalPositionType>(Result,
    TdxFloatingObjectHorizontalPositionType.Column, 'text');
  Add<TdxFloatingObjectHorizontalPositionType>(Result,
    TdxFloatingObjectHorizontalPositionType.Margin, 'margin');
  Add<TdxFloatingObjectHorizontalPositionType>(Result,
    TdxFloatingObjectHorizontalPositionType.Page, 'page');
  Add<TdxFloatingObjectHorizontalPositionType>(Result,
    TdxFloatingObjectHorizontalPositionType.Character, 'char');
  Add<TdxFloatingObjectHorizontalPositionType>(Result,
    TdxFloatingObjectHorizontalPositionType.LeftMargin, 'left-margin-area');
  Add<TdxFloatingObjectHorizontalPositionType>(Result,
    TdxFloatingObjectHorizontalPositionType.RightMargin, 'right-margin-area');
  Add<TdxFloatingObjectHorizontalPositionType>(Result,
    TdxFloatingObjectHorizontalPositionType.InsideMargin, 'inner-margin-area');
  Add<TdxFloatingObjectHorizontalPositionType>(Result,
    TdxFloatingObjectHorizontalPositionType.OutsideMargin, 'outer-margin-area');
end;
...
begin
  ...
  Add<TdxFloatingObjectVerticalPositionType>(Result,
    TdxFloatingObjectVerticalPositionType.Margin, 'margin');
  Add<TdxFloatingObjectVerticalPositionType>(Result,
    TdxFloatingObjectVerticalPositionType.Page, 'page');
  Add<TdxFloatingObjectVerticalPositionType>(Result,
    TdxFloatingObjectVerticalPositionType.Line, 'line');
  Add<TdxFloatingObjectVerticalPositionType>(Result,
    TdxFloatingObjectVerticalPositionType.Paragraph, 'text');
  Add<TdxFloatingObjectVerticalPositionType>(Result,
    TdxFloatingObjectVerticalPositionType.TopMargin, 'top-margin-area');
  Add<TdxFloatingObjectVerticalPositionType>(Result,
    TdxFloatingObjectVerticalPositionType.BottomMargin, 'bottom-margin-area');
  Add<TdxFloatingObjectVerticalPositionType>(Result,
    TdxFloatingObjectVerticalPositionType.InsideMargin, 'inner-margin-area');
  Add<TdxFloatingObjectVerticalPositionType>(Result,
    TdxFloatingObjectVerticalPositionType.OutsideMargin, 'outer-margin-area');
end;

class procedure TdxInlineObjectDestination.Add<T>
  (ATable: TDictionary<T, TdxWordProcessingMLValue>; AKey: T;
  const AOpenXmlValue: string);
begin
  ATable.Add(AKey, TdxWordProcessingMLValue.Create(AOpenXmlValue));
end;

class procedure TdxInlineObjectDestination.Add<T>(ATable: TdxMLDictionary<T>;
  AKey: T; const AOpenXmlValue: string);
begin
  ATable.Add(AKey, TdxWordProcessingMLValue.Create(AOpenXmlValue));
end;

function TdxInlineObjectDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
...
procedure TdxInlineObjectDestination.SetImage(const AValue
  : TdxOfficeImageReference);
begin
  FFloatingObjectImportInfo.Image := AValue;
end;

function TdxInlineObjectDestination.GetFloatingObject
  : TdxFloatingObjectProperties;
begin
  Result := FFloatingObjectImportInfo.FloatingObjectProperties;
end;

function TdxInlineObjectDestination.GetHorizontalPositionTypeAttributeTable
  : TdxMLDictionary<TdxFloatingObjectHorizontalPositionType>;
begin
  Result := FHorizontalPositionTypeAttributeTable;
end;

function TdxInlineObjectDestination.GetVerticalPositionTypeAttributeTable
  : TdxMLDictionary<TdxFloatingObjectVerticalPositionType>;
begin
  Result := FVerticalPositionTypeAttributeTable;
end;

class function TdxInlineObjectDestination.GetThis
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter)
  : TdxInlineObjectDestination;
begin
...
class function TdxInlineObjectDestination.OnShape
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxVMLShapeDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter),
    GetThis(TdxWordProcessingMLBaseImporter(AImporter)));
end;
...
begin
  if (FloatingObjectImportInfo.ShapeType = TdxShapeType.TextBox) and
    (FloatingObjectImportInfo.TextBoxContent <> nil) then
  begin
  ...
  begin
    ...
    try
      ...
      begin
        ...
        AppendImage(Importer.PieceTable, Importer.Position, Image, AScale.Width,
          AScale.Height, AFillColor);
        Exit;
      end;
    finally
      ACssParser.Free;
...
procedure TdxInlineObjectDestination.AppendImage(APieceTable: TdxPieceTable;
  APosition: TdxImportInputPosition; AImage: TdxOfficeImageReference;
  AScaleX: Single; AScaleY: Single; AFillColor: TdxAlphaColor);
begin
  APieceTable.AppendImage(APosition, AImage, AScaleX, AScaleY,
    AFillColor, False);
end;

function TdxInlineObjectDestination.GetCssParser(const ASize: TSize)
  : TdxInlinePictureCssParser;
var
...
procedure TdxInlineObjectDestination.ImportFloatingObject
  (ACssParser: TdxInlinePictureCssParser);
begin
  FloatingObject.ZOrder := ACssParser.ZOrder;
  FloatingObject.ActualSize := TSize.Create(ACssParser.Size.Width,
    ACssParser.Size.Height);
  ...
  if ACssParser.HorizontalPositionAlignment <>
    TdxFloatingObjectHorizontalPositionAlignment.None then
    FloatingObject.HorizontalPositionAlignment :=
      ACssParser.HorizontalPositionAlignment;
  if ACssParser.VerticalPositionAlignment <>
    TdxFloatingObjectVerticalPositionAlignment.None then
    FloatingObject.VerticalPositionAlignment :=
      ACssParser.VerticalPositionAlignment;
  if ACssParser.UseRelativeWidth then
    FloatingObject.RelativeWidth := TdxFloatingObjectRelativeWidth.Create
      (ACssParser.FromWidth, ACssParser.WidthPercent);
  if ACssParser.UseRelativeHeight then
    FloatingObject.RelativeHeight := TdxFloatingObjectRelativeHeight.Create
      (ACssParser.FromHeight, ACssParser.HeightPercent);

  FloatingObject.HorizontalPositionType := ConvertToHorizontalPositionType
    (ACssParser.HorizontalPositionType);
  FloatingObject.VerticalPositionType := ConvertToVerticalPositionType
    (ACssParser.VerticalPositionType);

  if ACssParser.TextBoxVerticalAlignment <> TdxVerticalAlignment.Top then
    FloatingObjectImportInfo.TextBoxProperties.VerticalAlignment :=
      ACssParser.TextBoxVerticalAlignment;
...
function TdxInlineObjectDestination.ConvertToHorizontalPositionType
  (const AValue: string): TdxFloatingObjectHorizontalPositionType;
begin
  Result := HorizontalPositionTypeAttributeTable.GetKeyByOpenXmlStringDef
    (AValue, TdxFloatingObjectHorizontalPositionType.Column);
end;

function TdxInlineObjectDestination.ConvertToVerticalPositionType
  (const AValue: string): TdxFloatingObjectVerticalPositionType;
begin
  Result := VerticalPositionTypeAttributeTable.GetKeyByOpenXmlStringDef(AValue,
...
constructor TdxVMLShapeDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AInlineObjectDestination: TdxInlineObjectDestination);
begin
  inherited Create(AImporter);
...
class function TdxVMLShapeDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
procedure TdxVMLShapeDestination.SetImage(const AValue
  : TdxOfficeImageReference);
begin
  FloatingObjectImportInfo.Image := AValue;
end;

function TdxVMLShapeDestination.GetFloatingObjectImportInfo
...
class function TdxVMLShapeDestination.GetThis
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter)
  : TdxVMLShapeDestination;
begin
...
begin
  ...
  if FOutlineWidth = NullSingleValue then
    FOutlineWidth := 0.75;
  AShape.OutlineWidth :=
    Round(UnitConverter.PointsToModelUnitsF(FOutlineWidth));
end;
...
procedure TdxVMLShapeDestination.ReadFloatingObjectProperties
...
procedure TdxVMLShapeDestination.ReadFloatingObjectProperties
  (AReader: TdxXmlReader; AProperties: TdxFloatingObjectProperties);
var
...
begin
  ...
  if ATypeId <> '' then
  begin
    ALockAspectRatio := Importer.LockAspectRatioTableGetValue(ATypeId,
      AUseLockAspectRatio);
  ...
  if AReader.GetAttribute('side') <> '' then
    AProperties.TextWrapSide :=
      Importer.GetEnumValue<TdxFloatingObjectTextWrapSide>(AReader, 'wrapText',
      TdxOpenXmlExporter.FloatingObjectTextWrapSideTable,
      TdxFloatingObjectTextWrapSide.Both);

  ALayoutInTableCell := AReader.GetAttribute('allowincell',
    TdxOpenXmlExporter.OfficeNamespaceConst);
  ...
  AAllowOverlap := AReader.GetAttribute('allowoverlap',
    TdxOpenXmlExporter.OfficeNamespaceConst);
...
begin
  ...
  FOutlineWidth := Importer.GetFloatValueInPoints(AReader, 'strokeweight',
    NullSingleValue);
end;

class function TdxVMLShapeDestination.OnImageData
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxVMLImageDataDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter),
    GetThis(TdxWordProcessingMLBaseImporter(AImporter))
...
class function TdxVMLShapeDestination.OnWrap
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxWrapDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter), (GetThis(AImporter))
    .FloatingObject);
end;

class function TdxVMLShapeDestination.OnLock
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxShapeLockDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter),
    GetThis(TdxWordProcessingMLBaseImporter(AImporter)).FloatingObject);
end;

class function TdxVMLShapeDestination.OnTextBox
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  GetThis(AImporter).FloatingObjectImportInfo.ShapeType := TdxShapeType.TextBox;
  Result := TdxTextBoxDestination.Create(AImporter,
    GetThis(AImporter).FloatingObjectImportInfo);
end;

class function TdxVMLShapeDestination.OnAnchorLock
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxAnchorLockDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter),
    GetThis(TdxWordProcessingMLBaseImporter(AImporter)).FloatingObject);
end;
...
constructor TdxAnchorLockDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  inherited Create(AImporter);
...
constructor TdxShapeLockDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  inherited Create(AImporter);
...
constructor TdxVMLImageDataDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
...
begin
  ...
  if (AId = '') or
    (not Importer.DocumentModel.DocumentCapabilities.InlinePicturesAllowed) then
    Exit;
...
begin
  ...
  AImage := nil;
  AFileName := AOpenXmlImporter.LookupRelationTargetById
    (AOpenXmlImporter.DocumentRelations, AId,
    AOpenXmlImporter.DocumentRootFolder, '');
  if TPath.GetExtension(AFileName) = '.wmf' then
  begin
    if FStyle <> '' then
    begin
      ACssParser := TdxInlinePictureCssParser.Create(Importer.DocumentModel,
      ...
      try
        ...
        AImage := AOpenXmlImporter.LookupMetafileByRelationId(AId,
          AOpenXmlImporter.DocumentRootFolder, ACssParser.Size.Width,
          ACssParser.Size.Height);
      finally
        ACssParser.Free;
      end;
    ...
    AImage := AOpenXmlImporter.LookupImageByRelationId(AId,
      AOpenXmlImporter.DocumentRootFolder);
  if AImage <> nil then
...
constructor TdxWrapDestination.Create(AImporter
...
begin
  ...
  if TdxWordProcessingMLBaseExporter.FloatingObjectTextWrapTypeTable.
    TryGetKeyByWordMLString(ATextWrapType, AKey) then
...
begin
  ...
  if TdxWordProcessingMLBaseExporter.FloatingObjectTextWrapSideTable.
    TryGetKeyByWordMLString(ATextWrapSide, AKey) then
...
constructor TdxInlinePictureCssParser.Create(ADocumentModel: TdxDocumentModel;
  const AOriginalSize: TSize);
begin
...
function TdxInlinePictureCssParser.GetCssKeywordTable
  : TdxCssKeywordTranslatorTable;
begin
  Result := FCssKeywordTable;
end;

function TdxInlinePictureCssParser.CreateCssKeywordTable
  : TdxCssKeywordTranslatorTable;
begin
  ...
  Result.Add(ConvertKeyToUpper('mso-position-horizontal'),
    CssHorizontalPositionAlignment);
  Result.Add(ConvertKeyToUpper('mso-position-vertical'),
    CssVerticalPositionAlignment);
  Result.Add(ConvertKeyToUpper('mso-position-vertical-relative'),
    CssVerticalPositionType);
  Result.Add(ConvertKeyToUpper('mso-position-horizontal-relative'),
    CssHorizontalPositionType);
...
procedure TdxInlinePictureCssParser.CssWidth(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
var
  AValue: TdxUnit;
...
procedure TdxInlinePictureCssParser.CssHeight(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
var
  AValue: TdxUnit;
  AParameters: TdxUnitConversionParameters;
...
procedure TdxInlinePictureCssParser.CssVerticalPositionType(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  FVerticalPositionType := APropertiesValue[0];
end;

procedure TdxInlinePictureCssParser.CssHorizontalPositionType
  (ACssProperties: TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  FHorizontalPositionType := APropertiesValue[0];
end;

function TdxInlinePictureCssParser.GetFloatingObjectHorizontalPositionAlignment
  (const AValue: string): TdxFloatingObjectHorizontalPositionAlignment;
begin
  Result := TdxWordProcessingMLBaseExporter.
    FloatingObjectHorizontalPositionAlignmentTable.GetKeyByStringDef(AValue,
    TdxFloatingObjectHorizontalPositionAlignment.None);
end;

function TdxInlinePictureCssParser.GetFloatingObjectVerticalPositionAlignment
  (const AValue: string): TdxFloatingObjectVerticalPositionAlignment;
begin
  Result := TdxWordProcessingMLBaseExporter.
    FloatingObjectVerticalPositionAlignmentTable.GetKeyByStringDef(AValue,
    TdxFloatingObjectVerticalPositionAlignment.None);
end;

procedure TdxInlinePictureCssParser.CssHorizontalPositionAlignment
  (ACssProperties: TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  FHorizontalPositionAlignment := GetFloatingObjectHorizontalPositionAlignment
    (APropertiesValue[0]);
end;

procedure TdxInlinePictureCssParser.CssVerticalPositionAlignment
  (ACssProperties: TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  FVerticalPositionAlignment := GetFloatingObjectVerticalPositionAlignment
    (APropertiesValue[0]);
end;

procedure TdxInlinePictureCssParser.CssTextBoxVerticalAlignment
  (ACssProperties: TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  FTextBoxVerticalAlignment := GetFloatingObjectVerticalAlignment
    (APropertiesValue[0]);
end;

procedure TdxInlinePictureCssParser.CssTextBoxWrapType(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
...
function TdxInlinePictureCssParser.GetFloatingObjectVerticalAlignment
  (const AValue: string): TdxVerticalAlignment;
begin
  Result := TdxWordProcessingMLBaseExporter.TextBoxVerticalAlignmentTable.
    GetKeyByStringDef(AValue, TdxVerticalAlignment.Top);
end;

procedure TdxInlinePictureCssParser.CssZOrder(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
var
  AValue: TdxUnit;
begin
...
function TdxInlinePictureCssParser.GetModelUnitsFromUnitOrEmuValue
  (ACssUnitConverter: TdxDocumentModelUnitConverter;
...
begin
  ...
  if not TdxNumber.TryParse(APropertyValue, TdxNumberStyles.Integer, AEmuValue)
  then
  begin
...
procedure TdxInlinePictureCssParser.CssTopDistance(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  FTopDistance := GetModelUnitsFromUnitOrEmuValue(ACssProperties.UnitConverter,
    APropertiesValue[0]);
end;

procedure TdxInlinePictureCssParser.CssLeftDistance(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  FLeftDistance := GetModelUnitsFromUnitOrEmuValue(ACssProperties.UnitConverter,
    APropertiesValue[0]);
end;

procedure TdxInlinePictureCssParser.CssRightDistance(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  FRightDistance := GetModelUnitsFromUnitOrEmuValue
    (ACssProperties.UnitConverter, APropertiesValue[0]);
end;

procedure TdxInlinePictureCssParser.CssBottomDistance(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  FBottomDistance := GetModelUnitsFromUnitOrEmuValue
    (ACssProperties.UnitConverter, APropertiesValue[0]);
end;

procedure TdxInlinePictureCssParser.CssMsoWidthPercent(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
...
procedure TdxInlinePictureCssParser.CssMsoHeightPercent(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
...
procedure TdxInlinePictureCssParser.CssMsoWidthRelative(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
...
procedure TdxInlinePictureCssParser.CssMsoHeightRelative(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
...
function TdxInlinePictureCssParser.GetFloatingObjectRelativeFromHorizontal
  (const AValue: string): TdxFloatingObjectRelativeFromHorizontal;
var
  ATable: TdxMLDictionary<TdxFloatingObjectRelativeFromHorizontal>;
begin
  ATable := TdxWordProcessingMLBaseExporter.
    FloatingObjectCssRelativeFromHorizontalTable;
  Result := ATable.GetKeyByStringDef(AValue,
    TdxFloatingObjectRelativeFromHorizontal.Margin);
end;

function TdxInlinePictureCssParser.GetFloatingObjectRelativeFromVertical
  (const AValue: string): TdxFloatingObjectRelativeFromVertical;
var
  ATable: TdxMLDictionary<TdxFloatingObjectRelativeFromVertical>;
begin
  ATable := TdxWordProcessingMLBaseExporter.
    FloatingObjectCssRelativeFromVerticalTable;
  Result := ATable.GetKeyByStringDef(AValue,
    TdxFloatingObjectRelativeFromVertical.Margin);
end;

function TdxInlinePictureCssParser.GetPercentValue(const AValue
  : string): Integer;
var
  ATrimValue: string;
  AFloatResult: Double;
...
begin
  ...
  begin
    if TdxNumber.TryParse(TdxStringHelper.Substring(ATrimValue, 0, ALength - 1),
      TdxNumberStyles.Float, AFloatResult) then
...
procedure TdxInlinePictureCssParser.CssOffsetX(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
var
  AValue: TdxUnit;
  AConverter: TUnitConverter;
...
procedure TdxInlinePictureCssParser.CssOffsetY(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
var
  AValue: TdxUnit;
  AConverter: TUnitConverter;
...
procedure TdxInlinePictureCssParser.CssRotation(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
