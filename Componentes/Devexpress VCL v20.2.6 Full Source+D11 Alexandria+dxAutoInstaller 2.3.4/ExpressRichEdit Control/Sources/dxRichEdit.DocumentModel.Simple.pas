...
type
  ...
  public
    procedure ModifyTextRun(ARun: TdxTextRunBase; ARunIndex: TdxRunIndex);
      virtual; abstract;
  end;
  ...
  public
    ...
    property LogPosition: TdxDocumentLogPosition read FLogPosition
      write SetLogPosition;
    property ParagraphIndex: TdxParagraphIndex read FParagraphIndex
      write SetParagraphIndex;
    property CharacterFormatting: TdxCharacterFormattingBase
      read FCharacterFormatting;
    property MergedCharacterFormatting: TdxCharacterFormattingInfo
      read FMergedCharacterFormatting;
    property CharacterStyleIndex: Integer read FCharacterStyleIndex
      write FCharacterStyleIndex;
  end;

  { TdxTextRunBase }

  TdxTextRunBase = class(TdxRunBase, IdxCharacterPropertiesContainer,
  ...
  strict private
    ...
    function TryUseMergedCachedResult(ACachedResult
      : TdxRunMergedCharacterPropertiesCachedResult): Boolean;
  protected
    function CalculateFontIndexCore: Integer; overload; override;
    function GetRowProcessingFlags: TdxRowProcessingFlags; virtual;
    procedure SetRowProcessingFlags(const AValue
      : TdxRowProcessingFlags); virtual;
    ...
    function IdxCharacterPropertiesContainer.GetPieceTable =
      GetPropertiesContainerPieceTable;
    function GetPropertiesContainerPieceTable: TdxCustomPieceTable;
    function CreateCharacterPropertiesChangedHistoryItem
    ...
    procedure OnCharacterPropertiesObtainAffectedRange(Sender: TObject;
...
{$ENDREGION}
    ...
    property InnerMergedCharacterFormattingCacheIndex: Integer
      read FMergedCharacterFormattingCacheIndex
      write FMergedCharacterFormattingCacheIndex;
    property IsUpdateLocked: Boolean read GetIsUpdateLocked;
    property MergedCharacterFormattingCacheIndex: Integer
      read GetMergedCharacterFormattingCacheIndex;
  public
    constructor Create(AParagraph: TdxParagraphBase; AStartIndex: Integer = 0;
      ALength: Integer = 1); override;
    destructor Destroy; override;
    ...
    function GetMergedCharacterProperties: TdxMergedCharacterProperties;
      overload; virtual;
    function GetMergedCharacterProperties(ACachedResult
      : TdxRunMergedCharacterPropertiesCachedResult)
      : TdxMergedCharacterProperties; overload; virtual;

    procedure AfterRunInserted; virtual;
    procedure ApplyFormatting(APos: TdxInputPosition;
      AForceVisible: Boolean = False); overload;
    procedure ApplyFormatting(const AInfo: TdxCharacterFormattingInfo;
      const AOptions: TdxCharacterFormattingOptions; AStyleIndex: Integer;
    ...
    function Copy(ACopyManager: TdxCustomDocumentModelCopyManager)
      : TdxTextRunBase; virtual; abstract;
    procedure EnsureMergedCharacterFormattingCacheIndexCalculated
    ...
    function GetParentMergedCharacterProperties
      : TdxMergedCharacterProperties; virtual;
    function GetPlainText(ABuffer: TdxChunkedStringBuilder): string;
      overload; virtual;
    function GetRectangularObject: IdxRectangularObject; virtual;
    function GetText(ABuffer: TdxChunkedStringBuilder; AFrom, ATo: Integer)
      : string; overload; virtual;
    procedure InheritStyleAndFormattingFromCore(ARun: TdxTextRunBase;
      AForceVisible: Boolean = False); virtual;
    ...
    function MatchFormatting(AFormatting: TdxCharacterFormattingInfo;
      const AOptions: TdxCharacterFormattingOptions; AStyleIndex: Integer)
      : Boolean; virtual;
    procedure Measure(ABoxInfo: TdxBoxInfo; const AMeasurer: IdxObjectMeasurer);
      virtual; abstract;
    function TryUseParentMergedCachedResult(ACachedResult
      : TdxRunMergedCharacterPropertiesCachedResult): Boolean;
    // for internal use
    procedure CopyCharacterPropertiesFrom(ACopyManager
      : TdxCustomDocumentModelCopyManager; ASourceRun: TdxTextRunBase);
    function GetPlainText(ABuffer: TdxChunkedStringBuilder; AFrom, ATo: Integer)
      : string; overload; virtual;
    function GetTextFast(ABuffer: TdxChunkedStringBuilder): string; virtual;
    procedure ResetCachedIndices(AResetFormattingCacheType
      : TdxResetFormattingCacheType);
    procedure SetCharacterStyleIndexCore(Value: Integer);
    function TryAdjustEndPositionToFit(ABoxInfo: TdxBoxInfo; AMaxWidth: Integer;
      const AMeasurer: IdxObjectMeasurer): Boolean; virtual; abstract;
    procedure WriteDebugVisualizerData(AWriter: TWriter);

    property CharacterProperties: TdxCharacterProperties
      read FCharacterProperties;
    property CharacterStyleIndex: Integer read FCharacterStyleIndex
      write SetCharacterStyleIndex;
    property MergedCharacterFormatting: TdxCharacterFormattingInfo
      read GetMergedCharacterFormatting;
    property RowProcessingFlags: TdxRowProcessingFlags
      read GetRowProcessingFlags write SetRowProcessingFlags;
{$REGION 'IdxCharacterProperties'}
    ...
    property DoubleFontSize: Integer read GetDoubleFontSize
      write SetDoubleFontSize;
    ...
    property FontStrikeoutType: TdxStrikeoutType read GetFontStrikeoutType
      write SetFontStrikeoutType;
    property FontUnderlineType: TdxUnderlineType read GetFontUnderlineType
      write SetFontUnderlineType;
    property Hidden: Boolean read GetHidden write SetHidden;
    property NoProof: Boolean read GetNoProof write SetNoProof;
    property Script: TdxCharacterFormattingScript read GetScript
      write SetScript;
    property StrikeoutColor: TdxAlphaColor read GetStrikeoutColor
      write SetStrikeoutColor;
    property StrikeoutWordsOnly: Boolean read GetStrikeoutWordsOnly
      write SetStrikeoutWordsOnly;
    property Text: string read GetText;
    property UnderlineColor: TdxAlphaColor read GetUnderlineColor
      write SetUnderlineColor;
    property UnderlineWordsOnly: Boolean read GetUnderlineWordsOnly
      write SetUnderlineWordsOnly;
{$ENDREGION}
  ...
  public
    ...
    property Items[Index: TdxRunIndex]: TdxTextRunBase read GetItem
      write SetItem; default;
  end;

  { TdxSimpleParagraph }

  TdxSimpleParagraph = class(TdxCustomParagraph, IdxObtainAffectedRangeListener)
  strict private
{$REGION 'Interfaces'}
...
{$ENDREGION}
  strict private
    ...
    procedure OnParagraphPropertiesObtainAffectedRange(Sender: TObject;
      E: TdxObtainAffectedRangeEventArgs);
    procedure ResetCharacterFormattingProperties(AProperties
      : TdxCharacterProperties;
      const AStyleFormattingOptions: TdxCharacterFormattingOptions);
  strict protected
    function CreateBoxCollection: TdxSimpleParagraphBoxCollection; virtual;
    function CreateParagraphPropertiesChangedHistoryItem
    ...
    function EqualsMergedCharacterCachedResult(ACachedResult
      : TdxParagraphMergedCharacterPropertiesCachedResult): Boolean; virtual;
    procedure DoUseMergedCharacterCachedResult(ACachedResult
      : TdxParagraphMergedCharacterPropertiesCachedResult); virtual;

    procedure ResetOwnCachedIndices;

    property InnerMergedParagraphFormattingCacheIndex: Integer
      read FMergedParagraphFormattingCacheIndex
      write FMergedParagraphFormattingCacheIndex;
    property MergedParagraphFormatting: TdxParagraphFormattingInfo
      read GetMergedParagraphFormatting;
    property MergedParagraphFormattingCacheIndex: Integer
      read GetMergedParagraphFormattingCacheIndex;
    property OwnListLevelIndex: Integer read FListLevelIndex
      write FListLevelIndex;
    property OwnNumberingListIndex: Integer read FNumberingListIndex
  ...
  public
    ...
    function GetActualFrameProperties(AIgnoreTableFloatingPosition: Boolean)
    ...
    function GetAbstractNumberingListIndex
      : TdxAbstractNumberingListIndex; virtual;
    ...
    procedure InheritStyleAndFormattingFromCore
      (AParagraph: TdxSimpleParagraph); virtual;
    function GetParentMergedParagraphProperties
      : TdxMergedParagraphProperties; virtual;
    function GetMergedCharacterProperties: TdxMergedCharacterProperties;
      overload; virtual;
    function GetMergedParagraphProperties: TdxMergedParagraphProperties;
    procedure ResetRunsCharacterFormatting;
    function TryUseMergedCharacterCachedResult(ACachedResult
    ...
    property NumberingListIndex: TdxNumberingListIndex read FNumberingListIndex
      write SetOwnNumberingListIndex;
    ...
    property ParagraphStyleIndex: Integer read FParagraphStyleIndex
      write SetParagraphStyleIndex;
    property PieceTable: TdxSimplePieceTable read GetPieceTable;
    property Tabs: TdxTabProperties read FTabs;
{$REGION 'IdxParagraphProperties'}
    property AfterAutoSpacing: Boolean read GetAfterAutoSpacing
      write SetAfterAutoSpacing;
    property Alignment: TdxParagraphAlignment read GetAlignment
      write SetAlignment;
    property BackColor: TdxAlphaColor read GetBackColor write SetBackColor;
    property BeforeAutoSpacing: Boolean read GetBeforeAutoSpacing
      write SetBeforeAutoSpacing;
    property ContextualSpacing: Boolean read GetContextualSpacing
      write SetContextualSpacing;
    property FirstLineIndent: Integer read GetFirstLineIndent
      write SetFirstLineIndent;
    property FirstLineIndentType: TdxParagraphFirstLineIndent
      read GetFirstLineIndentType write SetFirstLineIndentType;
    property KeepLinesTogether: Boolean read GetKeepLinesTogether
      write SetKeepLinesTogether;
    ...
    property LineSpacingType: TdxParagraphLineSpacing read GetLineSpacingType
      write SetLineSpacingType;
    property OutlineLevel: Integer read GetOutlineLevel write SetOutlineLevel;
    property PageBreakBefore: Boolean read GetPageBreakBefore
    ...
    property SpacingBefore: Integer read GetSpacingBefore
      write SetSpacingBefore;
    property SuppressHyphenation: Boolean read GetSuppressHyphenation
      write SetSuppressHyphenation;
    property SuppressLineNumbers: Boolean read GetSuppressLineNumbers
      write SetSuppressLineNumbers;
    property WidowOrphanControl: Boolean read GetWidowOrphanControl
      write SetWidowOrphanControl;
    property TopBorder: TdxBorderInfo read GetTopBorder write SetTopBorder;
    property BottomBorder: TdxBorderInfo read GetBottomBorder
      write SetBottomBorder;
    property LeftBorder: TdxBorderInfo read GetLeftBorder write SetLeftBorder;
    property RightBorder: TdxBorderInfo read GetRightBorder
      write SetRightBorder;
{$ENDREGION}
  end;
  ...
  public
    ...
    property Items[Index: Integer]: TdxSimpleParagraph read GetItem
      write SetItem; default;
  end;
  ...
  strict private
    ...
    procedure RecalcParagraphsPositionsCore(AFrom: TdxParagraphIndex;
      ADeltaLength, ADeltaRunIndex: Integer); overload;
    procedure RecalcParagraphsPositionsCore(AFrom: TdxParagraphIndex;
      ATo: TdxParagraphIndex; ADeltaLength, ADeltaRunIndex: Integer); overload;
    procedure RecalcFieldPosition(AField: TdxField; ARunIndex: TdxRunIndex;
      ADeltaRunIndex: Integer);
    procedure RecalcFieldsPositions(ARunIndex: TdxRunIndex;
      ADeltaRunIndex: Integer);
    procedure RecalcFieldsIndices(AFrom, ADeltaIndex: Integer);

    procedure ChangeFieldCode(AField: TdxField; const ACode: string);
    function CreateField(AStartCode, AEndCode: TdxDocumentLogPosition;
      AResultLength: Integer; AForceVisible: Boolean): TdxField; overload;
    function GetDocumentModel: TdxSimpleDocumentModel; inline;
    function GetLastInsertedRunInfo: TdxLastInsertedRunInfo;
    function GetLastInsertedInlinePictureRunInfo
      : TdxLastInsertedInlinePictureRunInfo;
    ...
    function GetFirstSplitChar(AFontCharacterSet: TdxFontCharacterSet;
  ...
  protected
    ...
    procedure ChangeCharacterStyle(ARunInfo: TdxRunInfo;
    ...
    procedure TryToJoinRuns(AParagraph: TdxParagraphBase;
      ARunInfo: TdxRunInfo); overload;
    ...
    procedure RunMergedCore(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ADeltaRunLength: Integer); virtual;
    procedure RunUnmerged(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
...
{$REGION 'IdxDocumentModelStructureChangedListener'}
    ...
    procedure OnBeginMultipleRunSplit(APieceTable
      : TdxCustomPieceTable); virtual;
    procedure OnEndMultipleRunSplit(APieceTable: TdxCustomPieceTable); virtual;
{$ENDREGION}
    function CreateVisibleTextFilter(AShowHiddenText: Boolean)
      : TdxVisibleTextFilterBase;
    procedure RecalcParagraphsPositions(AFrom: TdxParagraphIndex;
  ...
  public
    ...
    procedure AddParagraphToList(AParagraphIndex: TdxParagraphIndex;
      ...
      AListLevelIndex: Integer); virtual;
    procedure ApplyEmptyStyle(ASource: TdxMergedCharacterProperties;
      ARunInfo: TdxRunInfo);
    ...
    function InsertObjectCore(AInserter: TdxObjectInserter;
      AParagraphIndex: TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition;
      AForceVisible: Boolean = False): TdxRunIndex;

    procedure InsertParagraphCore(APos: TdxInputPosition); overload; virtual;
    function InsertParagraphCore(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition; AForceVisible: Boolean = False)
      : TdxRunIndex; overload;

    procedure InsertTextCore(APos: TdxInputPosition; const AText: string;
      AForceVisible: Boolean = False); overload;
    procedure InsertTextCore(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition; const AText: string;
      AForceVisible: Boolean = False); overload;
    procedure InsertTextCore(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition; const AText: Char;
      AForceVisible: Boolean = False); overload;
    procedure InsertTextCoreWithoutSplit(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition; const AText: string;
      AForceVisible: Boolean);

    procedure InsertText(ALogPosition: TdxDocumentLogPosition;
      const AText: string; AForceVisible: Boolean = False); overload;
    procedure InsertText(APosition: TdxInputPosition; const AText: string;
      AForceVisible: Boolean = False); overload;
    procedure InsertPlainText(ALogPosition: TdxDocumentLogPosition;
      const AText: string; AForceVisible: Boolean = False)overload;
    procedure InsertPlainText(APosition: TdxInputPosition;
      const AText: string); overload;
    function InsertParagraph(ALogPosition: TdxDocumentLogPosition;
      AForceVisible: Boolean = False): TdxSimpleParagraph; overload;
    function InsertParagraph(AInputPosition: TdxInputPosition;
      ALogPosition: TdxDocumentLogPosition; AForceVisible: Boolean)
      : TdxSimpleParagraph; overload;
    function InsertInlineImageCore(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition; AImage: TdxOfficeImageReference;
      AScaleX, AScaleY: Single; AUseScreenDpi: Boolean = False;
      AForceVisible: Boolean = False): TdxTextRunBase; overload;
    function InsertInlineImageCore(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition; AImage: TdxOfficeImageReference;
      AScaleX, AScaleY: Single; AFillColor: TdxAlphaColor;
      AUseScreenDpi: Boolean = False; AForceVisible: Boolean = False)
      : TdxTextRunBase; overload;
    function InsertInlinePicture(ALogPosition: TdxDocumentLogPosition;
      AImage: TdxOfficeImageReference; AScaleX: Integer = 100;
      AScaleY: Integer = 100; AForceVisible: Boolean = False)
      : TdxTextRunBase; overload;
    function InsertInlinePicture(ALogPosition: TdxDocumentLogPosition;
      AImage: TdxOfficeImage; AScaleX: Integer = 100; AScaleY: Integer = 100;
      AForceVisible: Boolean = False): TdxTextRunBase; overload;
    procedure InsertInlineCustomObjectCore(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition;
      const ACustomObject: IdxInlineCustomObject; AScaleX, AScaleY: Single;
      AForceVisible: Boolean = False);
    procedure InsertInlineCustomObject(ALogPosition: TdxDocumentLogPosition;
      const ACustomObject: IdxInlineCustomObject; AScaleX: Integer = 100;
      AScaleY: Integer = 100; AForceVisible: Boolean = False);
    procedure InsertSeparatorTextRunCore(APos: TdxInputPosition); overload;
    function InsertSeparatorTextRunCore(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition): TdxRunIndex; overload;

    procedure JoinTextRuns(AParagraphIndex: TdxParagraphIndex;
    ...
    procedure ReplaceText(APosition: TdxDocumentLogPosition; ALength: Integer;
      const AText: string);

    function CreateField(ALogPosition: TdxDocumentLogPosition; ALength: Integer;
      AForceVisible: Boolean = False): TdxField; overload;
    procedure DeleteFieldWithoutResult(AField: TdxField);
    function InsertFieldResultEndRunCore(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition; AForceVisible: Boolean = False)
      : TdxRunIndex; overload;
    function InsertFieldResultEndRunCore(APos: TdxInputPosition)
      : TdxRunIndex; overload;
    function InsertFieldCodeStartRunCore(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition; AForceVisible: Boolean = False)
      : TdxRunIndex; overload;
    function InsertFieldCodeStartRunCore(APos: TdxInputPosition)
      : TdxRunIndex; overload;
    function InsertFieldCodeEndRunCore(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition; AForceVisible: Boolean = False)
      : TdxRunIndex; overload;
    function InsertFieldCodeEndRunCore(APos: TdxInputPosition)
      : TdxRunIndex; overload;
    procedure InsertFieldSymbolResult(ALogPosition: TdxDocumentLogPosition;
      const ASymbol: Char); virtual;
    procedure RemoveField(AField: TdxField);

    procedure ApplyHyperlinkStyle(ARunInfo: TdxRunInfo;
      AApplyDefaultHyperlinkStyle: Boolean); overload;
    procedure ApplyHyperlinkStyle(AHyperlink: TdxField;
      AApplyDefaultHyperlinkStyle: Boolean); overload;
    procedure CreateHyperlink(APosition: TdxDocumentLogPosition;
      ALength: Integer; AInfo: TdxHyperlinkInfo;
      AForceVisible: Boolean = False);
    function CreateHyperlinkField(AStart: TdxDocumentLogPosition;
    ...
    function GetHyperlinkFields(AStart: TdxRunIndex; AEnd: TdxRunIndex)
      : TdxFieldList;
    function InsertHyperlinkInfo(AFieldIndex: Integer; AInfo: TdxHyperlinkInfo)
      : TdxHyperlinkInfo;
    ...
    procedure ReplaceHyperlinkInfo(AFieldIndex: Integer;
      ANewInfo: TdxHyperlinkInfo);
    procedure UpdateHyperlinkFieldCode(AField: TdxField);

    procedure SplitTextRun(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; AOffset: Integer);
    function ObtainAffectedRunInfo(ALogPositionStart: TdxDocumentLogPosition;
      ALength: Integer): TdxRunInfo;
    ...
    function FindFieldIndexByRunIndex(ARunIndex: TdxRunIndex): Integer;
      overload;
    function FindFieldIndexByRunIndex(ARunIndex: TdxRunIndex;
      const APredicate: TdxPredicate<TdxField>): Integer; overload;
    ...
    function CreateDeleteContentOperation
      : TdxCustomDeleteContentOperation; virtual;
    ...
    property LastInsertedRunInfo: TdxLastInsertedRunInfo
      read GetLastInsertedRunInfo;
    property LastInsertedInlinePictureRunInfo
      : TdxLastInsertedInlinePictureRunInfo
      read GetLastInsertedInlinePictureRunInfo;
    property LastInsertedSeparatorRunInfo: TdxLastInsertedSeparatorRunInfo
      read GetLastInsertedSeparatorRunInfo;
  ...
  TdxSortedRunIndexCollection = class(TcxIUnknownObject,
    IdxDocumentModelStructureChangedListener)
  private
...
{$ENDREGION}
  ...
  public
    ...
    procedure DeleteAllRunsInParagraph(APieceTable: TdxSimplePieceTable;
      AParagraphIndex: TdxParagraphIndex);
    procedure DeleteSections(AStartSectionIndex: TdxSectionIndex;
      ACount: Integer);
    procedure DeleteParagraphs(APieceTable: TdxSimplePieceTable;
      AStartParagraphIndex: TdxParagraphIndex; ACount: Integer;
      ACell: TdxCustomTableCell);
    procedure DeleteRuns(APieceTable: TdxSimplePieceTable;
      AStartRunIndex: TdxRunIndex; ACount: Integer);
    procedure MergeParagraphs(APieceTable: TdxSimplePieceTable;
      AFirstParagraph, ASecondParagraph: TdxSimpleParagraph;
      AUseFirstParagraphStyle: Boolean; ACell: TdxCustomTableCell);
    procedure ReplaceSectionRunWithParagraphRun(APieceTable
      : TdxSimplePieceTable; ASectionRun: TdxTextRunBase;
      ARunIndex: TdxRunIndex);
    procedure ReplaceParagraphRunWithSectionRun(APieceTable
      : TdxSimplePieceTable; ASectionRun: TdxTextRunBase;
      ARunIndex: TdxRunIndex);
  ...
  TdxSimpleDocumentModelDeferredChanges = class
    (TdxCustomDocumentModelDeferredChanges)
  strict private
    FOriginalSelectionLength: Integer;
    FRunIndicesForSplit: TObjectDictionary<TdxCustomPieceTable,
      TdxSortedRunIndexCollection>;
    function GetDocumentModel: TdxSimpleDocumentModel;
    function GetSelectionLengthChanged: Boolean;
  protected
    function GetRunIndicesForSplit(APieceTable: TdxCustomPieceTable)
      : TdxSortedRunIndexCollection;
  ...
  public
    ...
    property DocumentModel: TdxSimpleDocumentModel read GetDocumentModel;
    property RunIndicesForSplit
      : TObjectDictionary<TdxCustomPieceTable, TdxSortedRunIndexCollection>
      read FRunIndicesForSplit;
  ...
  TdxSimpleDocumentModel = class(TdxCustomDocumentModel,
    IdxParagraphPropertiesContainer, IdxCharacterPropertiesContainer,
    IdxStylesContainer, IdxDocumentModelStructureChangedListener)
  strict private
...
{$ENDREGION}
    ...
    procedure OnFormattingMarkVisibilityOptionsChanged(ASender: TObject;
      E: TdxRichEditNotificationOptionsChangedArgs);
    procedure OnDefaultCharacterPropertiesObtainAffectedRange(ASender: TObject;
      E: TdxObtainAffectedRangeEventArgs);
    procedure OnDefaultParagraphPropertiesObtainAffectedRange(ASender: TObject;
      E: TdxObtainAffectedRangeEventArgs);
  protected
    ...
    function CreateFormattingMarkVisibilityOptions
      : TdxSimpleFormattingMarkVisibilityOptions; virtual;
    ...
    function GetLastInsertedRunInfo(APieceTable: TdxSimplePieceTable)
      : TdxLastInsertedRunInfo;
    function GetLastInsertedInlinePictureRunInfo(APieceTable
      : TdxSimplePieceTable): TdxLastInsertedInlinePictureRunInfo;
    function GetLastInsertedSeparatorRunInfo(APieceTable: TdxSimplePieceTable)
      : TdxLastInsertedSeparatorRunInfo;
...
{$ENDREGION}
    function IdxCharacterPropertiesContainer.GetPieceTable =
      GetPropertiesContainerPieceTable;
    function IdxParagraphPropertiesContainer.GetPieceTable =
      GetPropertiesContainerPieceTable;
    function GetPropertiesContainerPieceTable: TdxCustomPieceTable;
    function CreateCharacterPropertiesChangedHistoryItem
      : TdxIndexChangedHistoryItemCore;
    ...
    property InnerLastInsertedRunInfo: TdxLastInsertedRunInfo
      read FLastInsertedRunInfo;
    property PieceTable: TdxSimplePieceTable read GetPieceTable;
  public
    ...
    function GetNumberingListIndex(ATarget: TdxCustomDocumentModel;
      ...
      : TdxNumberingListIndex; virtual;
    procedure ResetDocumentFormattingCaches(AResetFormattingCacheType
      : TdxResetFormattingCacheType); override;

    function CreateImage(ANativeImage: TdxOfficeImage)
      : TdxOfficeImageReference; overload;
    ...
    procedure ResetSpellCheck(APieceTable: TdxCustomPieceTable;
      AStartRunIndex, AEndRunIndex: TdxRunIndex;
      AFormattingOnly: Boolean); overload;
    procedure ResetSpellCheck(AStartRunIndex, AEndRunIndex: TdxRunIndex;
      AFormattingOnly: Boolean = False); overload;

    procedure NotifyNumberingListParagraphAdded
      (AIndex: TdxNumberingListIndex); virtual;
    ...
    procedure ResetParagraphFormatting(AParagraphFormatting
      : TdxParagraphFormattingBase);
    procedure ResetCharacterFormatting(ACharacterFormatting
    ...
    property DefaultCharacterProperties: TdxCharacterProperties
      read FDefaultCharacterProperties;
    property DefaultParagraphProperties: TdxParagraphProperties
      read FDefaultParagraphProperties;
    property DeferredChanges: TdxSimpleDocumentModelDeferredChanges
      read GetDeferredChanges;
    property DocumentCapabilities: TdxSimpleDocumentCapabilitiesOptions
      read GetDocumentCapabilities write SetDocumentCapabilities;
    property ForceNotifyStructureChanged: Boolean
      read FForceNotifyStructureChanged write FForceNotifyStructureChanged;
    property FormattingMarkVisibilityOptions
      : TdxSimpleFormattingMarkVisibilityOptions
      read FFormattingMarkVisibilityOptions;
    property ImageCache: TdxImageCache read FImageCache;
    property IsDocumentProtectionEnabled: Boolean
      read GetIsDocumentProtectionEnabled;
    ...
    property InnerSelectionChanged: TdxNotifyEventHandler
      read FOnInnerSelectionChanged;
...
procedure TdxInputPosition.CopyCharacterFormattingFrom
  (AValue: TdxInputPosition);
begin
...
begin
  Result := CharacterFormatting.Options.UseHidden and
    CharacterFormatting.Hidden;
end;

function TdxInputPosition.IsValidLogPosition
  (AValue: TdxDocumentLogPosition): Boolean;
var
...
function TdxInputPosition.IsValidParagraphIndex
  (Value: TdxParagraphIndex): Boolean;
begin
...
constructor TdxTextRunBase.Create(AParagraph: TdxParagraphBase;
  AStartIndex: Integer = 0; ALength: Integer = 1);
begin
...
procedure TdxTextRunBase.ApplyFormatting(APos: TdxInputPosition;
  AForceVisible: Boolean = False);
var
...
begin
  ...
  AShouldResetUseHidden := AForceVisible and AFormatting.Options.UseHidden and
    AFormatting.Info.Hidden;
  if not AShouldResetUseHidden and not IsUpdateLocked then
  begin
    CharacterProperties.ReplaceInfo(AFormatting,
      CharacterProperties.BatchUpdateChangeActions);
...
procedure TdxTextRunBase.ApplyFormatting(const AInfo
  : TdxCharacterFormattingInfo; const AOptions: TdxCharacterFormattingOptions;
  AStyleIndex: Integer; AForceVisible: Boolean);
var
  AShouldResetUseHidden: Boolean;
  AFormatting: TdxCharacterFormattingBase;
begin
  AShouldResetUseHidden := AForceVisible and AOptions.UseHidden and
    AInfo.Hidden;
  AFormatting := TdxCharacterFormattingBase.Create(PieceTable, DocumentModel,
    AInfo, AOptions);
  try
    if not AShouldResetUseHidden and not IsUpdateLocked then
    begin
...
begin
  ...
  begin
    ...
    FMergedCharacterFormattingCacheIndex :=
      Paragraph.DocumentModel.Cache.MergedCharacterFormattingInfoCache.
      GetItemIndex(AMergedCharacterProperties.Info);
    FRowProcessingFlags := CalculateRowProcessingFlags;
  end;
end;

procedure TdxTextRunBase.Export(const AExporter
  : IdxSimpleDocumentModelExporter);
begin
  AExporter.Export(Self);
end;

function TdxTextRunBase.GetNonEmptyText
...
function TdxTextRunBase.GetText(ABuffer: TdxChunkedStringBuilder;
  AFrom, ATo: Integer): string;
begin
  Result := ABuffer.ToString(StartIndex + AFrom, ATo - AFrom + 1);
end;

procedure TdxTextRunBase.InheritStyleAndFormattingFromCore(ARun: TdxTextRunBase;
  AForceVisible: Boolean = False);
begin
  ...
  InnerMergedCharacterFormattingCacheIndex :=
    ARun.InnerMergedCharacterFormattingCacheIndex;
  InheritRowProcessingFlags(ARun);
  if AForceVisible and CharacterProperties.UseHidden and CharacterProperties.Hidden
  then
  begin
...
function TdxTextRunBase.TryUseParentMergedCachedResult(ACachedResult
  : TdxRunMergedCharacterPropertiesCachedResult): Boolean;
begin
  Result := (ACachedResult.CharacterStyleIndex = CharacterStyleIndex) and
...
function TdxTextRunBase.CalculateFontIndexCore(const AFontName: string)
  : Integer;
begin
  Result := Paragraph.PieceTable.DocumentModel.FontCache.CalcFontIndex
    (AFontName, DoubleFontSize, SmallFontStylesMap[FontBold,
    FontItalic], Script);
end;
...
procedure TdxTextRunBase.SetRowProcessingFlags(const AValue
  : TdxRowProcessingFlags);
begin
  FRowProcessingFlags := AValue;
end;

function TdxTextRunBase.GetMergedCharacterProperties
...
function TdxTextRunBase.GetMergedCharacterProperties(ACachedResult
  : TdxRunMergedCharacterPropertiesCachedResult): TdxMergedCharacterProperties;
begin
...
function TdxTextRunBase.GetParentMergedCharacterProperties
  : TdxMergedCharacterProperties;
var
...
function TdxTextRunBase.CreateCharacterPropertiesChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
var
  ARunIndex: TdxRunIndex;
begin
  ARunIndex := GetRunIndex;
  Result := TdxRunCharacterPropertiesChangedHistoryItem.Create
    (Paragraph.PieceTable, ARunIndex);
end;
...
procedure TdxTextRunBase.NotifyObtainAffectedRange
  (AArgs: TdxObtainAffectedRangeEventArgs);
begin
  OnCharacterPropertiesObtainAffectedRange(FCharacterProperties, AArgs);
end;

procedure TdxTextRunBase.OnCharacterPropertiesObtainAffectedRange
  (Sender: TObject; E: TdxObtainAffectedRangeEventArgs);
var
...
begin
  RowProcessingFlags := ARun.RowProcessingFlags -
...
procedure TdxTextRunBase.ResetCachedIndices(AResetFormattingCacheType
  : TdxResetFormattingCacheType);
begin
...
procedure TdxTextRunBase.CopyCharacterPropertiesFrom(ACopyManager
  : TdxCustomDocumentModelCopyManager; ASourceRun: TdxTextRunBase);
begin
  CharacterProperties.CopyFrom(ASourceRun.CharacterProperties.Info);
  CharacterStyleIndex := ASourceRun.CharacterStyle.Copy
    (ACopyManager.TargetModel);
end;

function TdxTextRunBase.GetPlainText(ABuffer: TdxChunkedStringBuilder;
  AFrom, ATo: Integer): string;
begin
  Result := GetText(ABuffer, AFrom, ATo);
end;

function TdxTextRunBase.GetRawTextFast
  (ABuffer: TdxChunkedStringBuilder): string;
begin
  Result := GetTextFast(ABuffer);
end;
  ...
  begin
    ...
    if ARunIndex >= 0 then
      PieceTable.ApplyChangesCore
        (TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
        (TdxCharacterFormattingChangeType.CharacterStyle), ARunIndex,
        ARunIndex);
  end;
end;
...
procedure TdxTextRunBase.WriteDebugVisualizerData(AWriter: TWriter);
  ...
  begin
    Result := Format('A:%d;R:%d;G:%d;B:%d', [A(AColor), R(AColor), G(AColor),
      B(AColor)]);
  end;
...
function TdxTextRunBase.GetMergedCharacterFormatting
  : TdxCharacterFormattingInfo;
begin
  Result := Paragraph.DocumentModel.Cache.MergedCharacterFormattingInfoCache
    [MergedCharacterFormattingCacheIndex];
end;
...
function TdxTextRunBase.TryUseMergedCachedResult(ACachedResult
  : TdxRunMergedCharacterPropertiesCachedResult): Boolean;
begin
  Result := Paragraph.TryUseMergedCharacterCachedResult(ACachedResult) and
...
begin
  ...
  if (AFormatting.FontUnderlineType <> TdxUnderlineType.None) or
    (AFormatting.FontStrikeoutType <> TdxStrikeoutType.None) then
...
begin
  ...
  begin
    ...
    try
      AItem := TdxChangeCharacterStyleIndexHistoryItem.Create(PieceTable,
        GetRunIndex, FCharacterStyleIndex, Value);
...
procedure TdxTextRunCollection.SetItem(Index: TdxRunIndex;
  const Value: TdxTextRunBase);
begin
  List[Index] := Value;
end;
...
function TdxSimpleParagraph.GetActualFrameProperties
  (AIgnoreTableFloatingPosition: Boolean): TdxMergedFrameProperties;
var
  ACell: TdxCustomTableCell;
begin
  Result := nil;
  if PieceTable.ContentType.IsTextBox then
    Exit;
  ACell := GetCellCore;
  if not AIgnoreTableFloatingPosition and (ACell <> nil) and ACell.GetTableCore.UseFloatingPosition
  then
    Exit;
...
begin
  ...
  begin
    if FrameProperties.Index = TdxParagraphFrameFormattingCache.DefaultParagraphFrameFormattingIndex
    then
      Exit(nil);
  ...
  AStyleFrameProperties := ParagraphStyle.GetMergedFrameProperties;
  if (AStyleFrameProperties <> nil) and AStyleFrameProperties.IsParagraphFrame
  then
  begin
    ACell := GetCellCore;
...
begin
  AMergedFrameProperties := GetMergedFrameProperties;
  try
    Result := (AMergedFrameProperties <> nil) and
      AMergedFrameProperties.IsParagraphFrame;
  finally
    AMergedFrameProperties.Free;
  end;
end;
...
function TdxSimpleParagraph.GetAbstractNumberingListIndex
...
procedure TdxSimpleParagraph.ResetCachedIndices(AResetFormattingCacheType
  : TdxResetFormattingCacheType);
var
  AIndex: TdxRunIndex;
begin
  if AResetFormattingCacheType in [TdxResetFormattingCacheType.All,
    TdxResetFormattingCacheType.Paragraph] then
    ResetOwnCachedIndices;
  BoxCollection.InvalidateBoxes;
  if Parent = nil then
    Exit;
  if AResetFormattingCacheType in [TdxResetFormattingCacheType.All,
    TdxResetFormattingCacheType.Character] then
  begin
...
procedure TdxSimpleParagraph.SetParagraphStyleIndexCore(const ANewStyleIndex
  : Integer);
begin
  ...
  if Parent <> nil then
    PieceTable.ApplyChangesCore(TdxParagraphFormattingChangeActionsCalculator.
      CalculateChangeActions(TdxParagraphFormattingChangeType.ParagraphStyle),
      FirstRunIndex, LastRunIndex);
end;

procedure TdxSimpleParagraph.InheritStyleAndFormattingFrom
...
begin
  ...
  InnerMergedParagraphFormattingCacheIndex :=
    AParagraph.InnerMergedParagraphFormattingCacheIndex;
...
procedure TdxSimpleParagraph.InheritStyleAndFormattingFromCore
  (AParagraph: TdxSimpleParagraph);
begin
  if AParagraph = nil then
    TdxRichEditExceptions.ThrowArgumentException('paragraph', AParagraph);
...
function TdxSimpleParagraph.GetParentMergedParagraphProperties
  : TdxMergedParagraphProperties;
begin
  Result := TdxMergedParagraphProperties.Create
    (DocumentModel.DefaultParagraphProperties);
end;

function TdxSimpleParagraph.GetMergedCharacterProperties
  : TdxMergedCharacterProperties;
begin
  Result := TdxMergedCharacterProperties.Create
    (DocumentModel.DefaultCharacterProperties);
end;

function TdxSimpleParagraph.GetMergedParagraphProperties
  : TdxMergedParagraphProperties;
var
...
function TdxSimpleParagraph.TryUseMergedCharacterCachedResult
  (ACachedResult: TdxParagraphMergedCharacterPropertiesCachedResult): Boolean;
begin
...
begin
  AStyleProperties := DocumentModel.ParagraphStyles[ParagraphStyleIndex]
    .GetMergedCharacterProperties;
  try
...
procedure TdxSimpleParagraph.ResetCharacterFormattingProperties
  (AProperties: TdxCharacterProperties;
  const AStyleFormattingOptions: TdxCharacterFormattingOptions);
begin
  ...
  if AProperties.UseDoubleFontSize and AStyleFormattingOptions.UseDoubleFontSize
  then
    AProperties.ResetUse(TdxUsedCharacterFormattingOption.UseDoubleFontSize);
  if AProperties.UseFontUnderlineType and AStyleFormattingOptions.UseFontUnderlineType
  then
  ...
  if AProperties.UseStrikeoutColor and AStyleFormattingOptions.UseStrikeoutColor
  then
    AProperties.ResetUse(TdxUsedCharacterFormattingOption.UseStrikeoutColor);
  if AProperties.UseFontStrikeoutType and AStyleFormattingOptions.UseFontStrikeoutType
  then
    AProperties.ResetUse(TdxUsedCharacterFormattingOption.UseFontStrikeoutType);
  if AProperties.UseStrikeoutWordsOnly and AStyleFormattingOptions.UseStrikeoutWordsOnly
  then
    AProperties.ResetUse
      (TdxUsedCharacterFormattingOption.UseStrikeoutWordsOnly);
  if AProperties.UseUnderlineColor and AStyleFormattingOptions.UseUnderlineColor
  then
    AProperties.ResetUse(TdxUsedCharacterFormattingOption.UseUnderlineColor);
  if AProperties.UseUnderlineWordsOnly and AStyleFormattingOptions.UseUnderlineWordsOnly
  then
    AProperties.ResetUse
...
procedure TdxSimpleParagraph.SetFrameProperties(const Value
  : TdxFrameProperties);
begin
  if Value = nil then
    FreeAndNil(FFrameProperties)
...
function TdxSimpleParagraph.GetMergedParagraphFormatting
  : TdxParagraphFormattingInfo;
begin
  Result := DocumentModel.Cache.MergedParagraphFormattingInfoCache
    [MergedParagraphFormattingCacheIndex];
end;
  ...
  begin
    ...
    try
      FMergedParagraphFormattingCacheIndex :=
        DocumentModel.Cache.MergedParagraphFormattingInfoCache.GetItemIndex
        (AMergedParagraphProperties.Info);
    finally
...
procedure TdxSimpleParagraph.SetOwnNumberingListIndex
...
begin
  ...
  begin
    DocumentModel.BeginUpdate;
    try
      AItem := TdxChangeParagraphStyleIndexHistoryItem.Create(PieceTable, Index,
...
procedure TdxSimpleParagraph.OnParagraphPropertiesObtainAffectedRange
  (Sender: TObject; E: TdxObtainAffectedRangeEventArgs);
begin
...
function TdxSimpleParagraph.CreateBoxCollection
  : TdxSimpleParagraphBoxCollection;
begin
  Result := TdxSimpleParagraphBoxCollection.Create;
end;

function TdxSimpleParagraph.CreateParagraphPropertiesChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
  Result := TdxParagraphParagraphPropertiesChangedHistoryItem.Create
    (PieceTable, Index);
end;
...
procedure TdxSimpleParagraph.SetFirstLineIndentType
  (const Value: TdxParagraphFirstLineIndent);
begin
...
procedure TdxSimpleParagraph.SetLineSpacingType(const Value
  : TdxParagraphLineSpacing);
begin
...
procedure TdxSimpleParagraph.NotifyObtainAffectedRange
  (AArgs: TdxObtainAffectedRangeEventArgs);
begin
...
procedure TdxSimpleParagraphList.SetItem(Index: Integer;
  const Value: TdxSimpleParagraph);
begin
...
function TdxSimpleParagraphCollection.GetItem(Index: Integer)
  : TdxSimpleParagraph;
begin
  Result := TdxSimpleParagraph(inherited Items[Index]);
end;
...
procedure TdxSimpleMainContentType.FixLastParagraphOfLastSection
...
constructor TdxSimplePieceTable.Create(const ADocumentModel
  : TdxCustomDocumentModel; const AContentType: TdxContentTypeBase);
begin
...
procedure TdxSimplePieceTable.ResetFormattingCaches(AResetFormattingCacheType
  : TdxResetFormattingCacheType);
var
  I: Integer;
begin
...
function TdxSimplePieceTable.GetChildFieldIndexes(AField: TdxField)
  : TArray<Integer>;
var
...
function TdxSimplePieceTable.GetTextFromSingleRun(const AStartPos,
  AEndPos: TdxFormatterPosition): string;
var
  ARun: TdxTextRunBase;
begin
...
procedure TdxSimplePieceTable.AddParagraphToList(AParagraphIndex
  : TdxParagraphIndex; ANumberingListIndex: TdxNumberingListIndex;
  AListLevelIndex: Integer);
begin
end;

procedure TdxSimplePieceTable.ApplyEmptyStyle
  (ASource: TdxMergedCharacterProperties; ARunInfo: TdxRunInfo);
var
  AStyleIndex: Integer;
  ATransaction: TdxHistoryTransaction;
  AModifier: TdxRunCharacterStyleModifier;
begin
  AStyleIndex := DocumentModel.CharacterStyles.GetStyleIndexByName
    (TdxCharacterStyleCollection.HyperlinkStyleName);
  if (ARunInfo.Start.RunIndex < 0) or
    (ARunInfo.&End.RunIndex < ARunInfo.Start.RunIndex) then
    Exit;
  AModifier := TdxRunCharacterStyleModifier.
    CreateReplaceRunCharacterStyleProperties(AStyleIndex, ASource);
  try
...
procedure TdxSimplePieceTable.ApplyNumberingToInsertedParagraph(AParagraphIndex
  : TdxParagraphIndex);
begin
end;

procedure TdxSimplePieceTable.RemoveNumberingFromParagraph
  (AParagraph: TdxSimpleParagraph);
begin
end;
...
function TdxSimplePieceTable.InsertObjectCore(AInserter: TdxObjectInserter;
  AParagraphIndex: TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition;
  AForceVisible: Boolean = False): TdxRunIndex;
var
  AParagraph: TdxParagraphBase;
...
function TdxSimplePieceTable.InsertParagraphCore(AParagraphIndex
  : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition;
  AForceVisible: Boolean = False): TdxRunIndex;
begin
  TextBuffer.Append(TdxCharacters.ParagraphMark);
  Result := InsertObjectCore(FParagraphInserter, AParagraphIndex, ALogPosition,
    AForceVisible);
end;

procedure TdxSimplePieceTable.InsertTextCore(APos: TdxInputPosition;
  const AText: string; AForceVisible: Boolean = False);
var
...
begin
  ...
  begin
    if not LastInsertedRunInfo.Run.MatchFormatting
      (APos.CharacterFormatting.Info, APos.CharacterFormatting.Options,
      APos.CharacterStyleIndex) or (AForceVisible and APos.IsHidden) then
...
procedure TdxSimplePieceTable.InsertTextCore(AParagraphIndex: TdxParagraphIndex;
  ALogPosition: TdxDocumentLogPosition; const AText: string;
  AForceVisible: Boolean = False);
begin
  InsertTextCoreWithoutSplit(AParagraphIndex, ALogPosition, AText,
    AForceVisible);
  if not DocumentModel.DeferredChanges.IsSetContentMode then
    if DocumentModel.IsUpdateLocked then
      DocumentModel.DeferredChanges.GetRunIndicesForSplit(Self)
        .Add(LastInsertedRunInfo.RunIndex)
    else
...
procedure TdxSimplePieceTable.InsertTextCoreWithoutSplit(AParagraphIndex
  : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition;
...
function TdxSimplePieceTable.CreateField(ALogPosition: TdxDocumentLogPosition;
  ALength: Integer; AForceVisible: Boolean = False): TdxField;
var
  ACommand: TdxPieceTableCreateFieldCommand;
begin
  ACommand := TdxPieceTableCreateFieldCommand.Create(Self, ALogPosition,
    ALength, AForceVisible);
  try
    ACommand.Execute;
...
function TdxSimplePieceTable.InsertFieldResultEndRunCore(AParagraphIndex
  : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition;
  AForceVisible: Boolean = False): TdxRunIndex;
const
...
function TdxSimplePieceTable.InsertFieldCodeStartRunCore(AParagraphIndex
  : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition;
  AForceVisible: Boolean = False): TdxRunIndex;
var
  AInserter: TdxFieldRunInserterBase;
...
function TdxSimplePieceTable.InsertFieldCodeEndRunCore(AParagraphIndex
  : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition;
  AForceVisible: Boolean = False): TdxRunIndex;
var
  AInserter: TdxFieldRunInserterBase;
...
function TdxSimplePieceTable.InsertFieldCodeEndRunCore(APos: TdxInputPosition)
  : TdxRunIndex;
begin
  Assert(APos.PieceTable = Self);
...
procedure TdxSimplePieceTable.InsertFieldSymbolResult
...
function TdxSimplePieceTable.InsertFieldCodeStartRunCore(APos: TdxInputPosition)
  : TdxRunIndex;
begin
  Assert(APos.PieceTable = Self);
...
function TdxSimplePieceTable.InsertFieldResultEndRunCore(APos: TdxInputPosition)
  : TdxRunIndex;
begin
  Assert(APos.PieceTable = Self);
...
function TdxSimplePieceTable.GetHyperlinkInfo(AField: TdxField)
  : TdxHyperlinkInfo;
begin
...
function TdxSimplePieceTable.GetHyperlinkField(ARunIndex: TdxRunIndex)
  : TdxField;
begin
...
function TdxSimplePieceTable.GetHyperlinkFields(AStart: TdxRunIndex;
  AEnd: TdxRunIndex): TdxFieldList;
var
...
function TdxSimplePieceTable.InsertHyperlinkInfo(AFieldIndex: Integer;
  AInfo: TdxHyperlinkInfo): TdxHyperlinkInfo;
var
...
procedure TdxSimplePieceTable.ModifyHyperlinkCode(AField: TdxField;
...
procedure TdxSimplePieceTable.ModifyHyperlinkResult(AField: TdxField;
...
begin
  ...
  try
    ...
    try
      ...
      AStart := TdxDocumentModelPosition.FromRunStart(Self, AField.Result.Start)
        .LogPosition;
...
procedure TdxSimplePieceTable.ReplaceHyperlinkInfo(AFieldIndex: Integer;
  ANewInfo: TdxHyperlinkInfo);
var
...
function TdxSimplePieceTable.CreateHyperlinkField
  (AStart: TdxDocumentLogPosition; ALength: Integer; AInfo: TdxHyperlinkInfo;
  AForceVisible: Boolean = False): TdxField;
var
...
procedure TdxSimplePieceTable.ApplyHyperlinkStyle(ARunInfo: TdxRunInfo;
  AApplyDefaultHyperlinkStyle: Boolean);
var
  AStyleIndex: Integer;
  AModifier: TdxRunCharacterStyleModifier;
begin
  if (ARunInfo = nil) or (ARunInfo.NormalizedStart.LogPosition >
    ARunInfo.NormalizedEnd.LogPosition) then
  ...
  if AStyleIndex < 0 then
    Exit;
  AModifier := TdxRunCharacterStyleModifier.
    CreateRunCharacterStyleKeepOldStyleProperties(AStyleIndex,
    AApplyDefaultHyperlinkStyle);
  try
    ChangeCharacterStyle(ARunInfo, AModifier);
  finally
    AModifier.Free;
...
procedure TdxSimplePieceTable.ApplyHyperlinkStyle(AHyperlink: TdxField;
  AApplyDefaultHyperlinkStyle: Boolean);
var
  ARunInfo: TdxRunInfo;
begin
...
procedure TdxSimplePieceTable.InsertText(ALogPosition: TdxDocumentLogPosition;
  const AText: string; AForceVisible: Boolean = False);
var
  ACommand: TdxPieceTableInsertTextAtLogPositionCommand;
begin
  ACommand := TdxPieceTableInsertTextAtLogPositionCommand.Create(Self,
    ALogPosition, AText, AForceVisible);
  try
    ACommand.Execute;
  finally
    FreeAndNil(ACommand);
...
procedure TdxSimplePieceTable.InsertText(APosition: TdxInputPosition;
  const AText: string; AForceVisible: Boolean = False);
var
  ACommand: TdxPieceTableInsertTextAtInputPositionCommand;
begin
  Assert(APosition.PieceTable = Self);
  ACommand := TdxPieceTableInsertTextAtInputPositionCommand.Create(Self,
    APosition, AText, AForceVisible);
  try
    ACommand.Execute;
  finally
    ACommand.Free;
...
procedure TdxSimplePieceTable.InsertPlainText(ALogPosition
  : TdxDocumentLogPosition; const AText: string;
  AForceVisible: Boolean = False);
var
  ACommand: TdxPieceTableInsertPlainTextAtLogPositionCommand;
begin
  ACommand := TdxPieceTableInsertPlainTextAtLogPositionCommand.Create(Self,
    ALogPosition, AText, AForceVisible);
  try
    ACommand.Execute;
  finally
...
procedure TdxSimplePieceTable.InsertPlainText(APosition: TdxInputPosition;
  const AText: string);
var
  ACommand: TdxPieceTableInsertPlainTextAtInputPositionCommand;
begin
  ACommand := TdxPieceTableInsertPlainTextAtInputPositionCommand.Create(Self,
    APosition, AText, False);
  try
    ACommand.Execute;
  finally
    ACommand.Free;
...
function TdxSimplePieceTable.InsertParagraph(ALogPosition
  : TdxDocumentLogPosition; AForceVisible: Boolean = False): TdxSimpleParagraph;
var
  ACommand: TdxPieceTableInsertParagraphAtLogPositionCommand;
begin
  ACommand := TdxPieceTableInsertParagraphAtLogPositionCommand.Create(Self,
...
function TdxSimplePieceTable.InsertParagraph(AInputPosition: TdxInputPosition;
  ALogPosition: TdxDocumentLogPosition; AForceVisible: Boolean)
  : TdxSimpleParagraph;
var
  ACommand: TdxPieceTableInsertParagraphAtInputPositionCommand;
begin
  ACommand := TdxPieceTableInsertParagraphAtInputPositionCommand.Create(Self,
    ALogPosition, AForceVisible, AInputPosition);
  try
    ACommand.Execute;
    Result := Paragraphs[ACommand.ParagraphIndex];
  finally
...
function TdxSimplePieceTable.InsertInlineImageCore(AParagraphIndex
  : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition;
  AImage: TdxOfficeImageReference; AScaleX, AScaleY: Single;
  AUseScreenDpi: Boolean = False; AForceVisible: Boolean = False)
  : TdxTextRunBase;
begin
  Result := InsertInlineImageCore(AParagraphIndex, ALogPosition, AImage,
    AScaleX, AScaleY, TdxAlphaColors.Empty, AUseScreenDpi, AForceVisible);
end;

function TdxSimplePieceTable.InsertInlineImageCore(AParagraphIndex
  : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition;
  AImage: TdxOfficeImageReference; AScaleX, AScaleY: Single;
  AFillColor: TdxAlphaColor; AUseScreenDpi: Boolean = False;
  AForceVisible: Boolean = False): TdxTextRunBase;
var
  AInserter: TdxInlinePictureInserter;
  ANewRunIndex: TdxRunIndex;
begin
  TextBuffer.Append(TdxCharacters.ObjectMark);
  AInserter := TdxInlinePictureInserter.Create(Self, AImage, AScaleX, AScaleY,
    AFillColor, AUseScreenDpi);
  try
    ANewRunIndex := InsertObjectCore(AInserter, AParagraphIndex, ALogPosition,
      AForceVisible);
...
function TdxSimplePieceTable.InsertInlinePicture(ALogPosition
  : TdxDocumentLogPosition; AImage: TdxOfficeImageReference;
  AScaleX: Integer = 100; AScaleY: Integer = 100;
  AForceVisible: Boolean = False): TdxTextRunBase;
var
  ACommand: TdxPieceTableInsertInlinePictureAtLogPositionCommand;
begin
  ACommand := TdxPieceTableInsertInlinePictureAtLogPositionCommand.Create(Self,
    ALogPosition, AImage, AScaleX, AScaleY, AForceVisible);
  try
    ACommand.Execute;
...
function TdxSimplePieceTable.InsertInlinePicture(ALogPosition
  : TdxDocumentLogPosition; AImage: TdxOfficeImage; AScaleX: Integer = 100;
  AScaleY: Integer = 100; AForceVisible: Boolean = False): TdxTextRunBase;
var
  AImageReference: TdxOfficeImageReference;
begin
  AImageReference := DocumentModel.CreateImage(AImage);
  try
    Result := InsertInlinePicture(ALogPosition, AImageReference, AScaleX,
      AScaleY, AForceVisible);
  finally
    AImageReference.Free;
  end;
end;

procedure TdxSimplePieceTable.InsertInlineCustomObjectCore(AParagraphIndex
  : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition;
  const ACustomObject: IdxInlineCustomObject; AScaleX, AScaleY: Single;
  AForceVisible: Boolean = False);
var
...
begin
  ...
  AInserter := TdxInlineCustomObjectInserter.Create(Self, ACustomObject,
    AScaleX, AScaleY);
  try
...
begin
  ACommand := TdxPieceTableInsertInlineCustomObjectAtLogPositionCommand.Create
    (Self, ALogPosition, ACustomObject, AScaleX, AScaleY, AForceVisible);
  try
    ACommand.Execute;
  finally
    ACommand.Free;
...
procedure TdxSimplePieceTable.InsertSeparatorTextRunCore
...
function TdxSimplePieceTable.InsertSeparatorTextRunCore(AParagraphIndex
  : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition): TdxRunIndex;
var
...
procedure TdxSimplePieceTable.JoinTextRuns(AParagraphIndex: TdxParagraphIndex;
  AFirstRunIndex: TdxRunIndex);
var
  ...
  try
    ...
    begin
      ...
      if ASourceFontCharacterSet.ContainsChar(AChar) then
        ...
        ASubsFontName := AFontCache.FindSubstituteFont(ASourceRunFontName,
          AChar, ASourceFontCharacterSet);
      if ASubsFontName <> APrevRunFontName then
      begin
        if ASplitOffset - ARunStartOffset > 0 then
        begin
          SplitTextRun(AParagraphIndex, ARunIndex,
            ASplitOffset - ARunStartOffset);
    ...
    if (ASplitOffset - ARunStartOffset > 0) and
      (APrevRunFontName <> ASourceRunFontName) then
      Runs[ARunIndex].FontName := APrevRunFontName;
  finally
...
procedure TdxSimplePieceTable.ReplaceText(APosition: TdxDocumentLogPosition;
...
begin
  ...
  try
    ...
    try
      ...
      ACommand := TdxPieceTableDeleteTextCommand.Create(Self,
        APosition, ALength);
      try
...
procedure TdxSimplePieceTable.SplitTextRun(AParagraphIndex: TdxParagraphIndex;
  ARunIndex: TdxRunIndex; AOffset: Integer);
var
...
begin
  DocumentModel.BeginUpdate;
  try
    AItem := TdxToggleFieldCodesHistoryItem.Create(Self,
      Fields.IndexOf(AField));
    DocumentModel.History.Add(AItem);
    AItem.Redo;
  finally
    DocumentModel.EndUpdate;
...
begin
  DocumentModel.BeginUpdate;
  try
    AItem := TdxToggleFieldLockedHistoryItem.Create(Self,
      Fields.IndexOf(AField));
    DocumentModel.History.Add(AItem);
    AItem.Redo;
  finally
...
function TdxSimplePieceTable.CreateDeleteContentOperation
  : TdxCustomDeleteContentOperation;
begin
  Result := NotImplemented;
end;

function TdxSimplePieceTable.ObtainAffectedRunInfo(ALogPositionStart
  : TdxDocumentLogPosition; ALength: Integer): TdxRunInfo;
begin
  ...
  if Result.&End.RunEndLogPosition <> Result.&End.LogPosition then
    SplitTextRun(Result.&End.ParagraphIndex, Result.&End.RunIndex,
      Result.&End.RunOffset + 1);
  if Result.Start.RunStartLogPosition <> ALogPositionStart then
  begin
    SplitTextRun(Result.Start.ParagraphIndex, Result.Start.RunIndex,
      Result.Start.RunOffset);
...
function TdxSimplePieceTable.GetFieldResultRunInfo(AField: TdxField)
  : TdxRunInfo;
var
...
function TdxSimplePieceTable.FindFieldByRunIndex(ARunIndex: TdxRunIndex)
  : TdxField;
var
  AIndex: Integer;
begin
...
function TdxSimplePieceTable.FindFieldIndexByRunIndex
...
function TdxSimplePieceTable.FindFieldIndexByRunIndex(ARunIndex: TdxRunIndex;
const APredicate: TdxPredicate<TdxField>): Integer;
var
  AIndex: Integer;
  AField: TdxField;
begin
...
function TdxSimplePieceTable.FindFieldIndexByRunIndexCore
  (ARunIndex: TdxRunIndex): Integer;
var
  ACount: Integer;
begin
...
function TdxSimplePieceTable.CreateParagraphCollection
...
function TdxSimplePieceTable.CreateTextRunsDeletedHistoryItem
  : TdxRichEditHistoryItem;
begin
...
procedure TdxSimplePieceTable.ChangeCharacterStyle(ARunInfo: TdxRunInfo;
...
procedure TdxSimplePieceTable.ChangeCharacterStyle(ARunInfo: TdxRunInfo;
AParagraph: TdxParagraphBase; AModifier: TdxRunPropertyModifierBase);
var
...
procedure TdxSimplePieceTable.TryToJoinRuns(AParagraph: TdxParagraphBase;
ARunInfo: TdxRunInfo);
var
...
function TdxSimplePieceTable.CreateVisibleTextFilter(AShowHiddenText: Boolean)
  : TdxVisibleTextFilterBase;
begin
...
procedure TdxSimplePieceTable.RecalcParagraphsPositions
  (AFrom: TdxParagraphIndex; ADeltaLength, ADeltaRunIndex: Integer);
var
  AParagraph: TdxSimpleParagraph;
  ANewLastRunIndex: TdxRunIndex;
begin
  if FMultipleRunSplitCount > 0 then
    RecalcParagraphsPositionsCore(FLastShiftedParagraphIndex + 1, AFrom,
      FLastDeltaLength, FLastDeltaRunIndex);
...
procedure TdxSimplePieceTable.RecalcParagraphsPositionsCore
  (AFrom: TdxParagraphIndex; ADeltaLength, ADeltaRunIndex: Integer);
var
...
procedure TdxSimplePieceTable.RecalcParagraphsPositionsCore
  (AFrom: TdxParagraphIndex; ATo: TdxParagraphIndex;
ADeltaLength, ADeltaRunIndex: Integer);
begin
  Paragraphs.RecalcParagraphsPositionsCore(AFrom, ATo, ADeltaLength,
    ADeltaRunIndex);
end;

procedure TdxSimplePieceTable.RecalcFieldPosition(AField: TdxField;
ARunIndex: TdxRunIndex; ADeltaRunIndex: Integer);
begin
  ...
  else if (AField.&Result.Start <= ARunIndex) and
    (AField.&Result.&End >= ARunIndex) then
...
procedure TdxSimplePieceTable.RecalcFieldsPositions(ARunIndex: TdxRunIndex;
ADeltaRunIndex: Integer);
var
  ACount: Integer;
  I: Integer;
...
procedure TdxSimplePieceTable.ChangeFieldCode(AField: TdxField;
const ACode: string);
var
  ALength: Integer;
  AIsCodeView: Boolean;
...
procedure TdxSimplePieceTable.ChangeFieldResult(AField: TdxField;
const AResult: string);
var
  AIsCodeView: Boolean;
...
begin
  ...
  try
    AStart := TdxDocumentModelPosition.FromRunStart(Self, AField.Result.Start)
      .LogPosition;
    AEnd := TdxDocumentModelPosition.FromRunStart(Self, AField.Result.&End)
      .LogPosition;
...
function TdxSimplePieceTable.CreateField(AStartCode,
  AEndCode: TdxDocumentLogPosition; AResultLength: Integer;
AForceVisible: Boolean): TdxField;
var
  ACommand: TdxPieceTableCreateFieldWithResultCommand;
begin
  ACommand := TdxPieceTableCreateFieldWithResultCommand.Create(Self, AStartCode,
    AEndCode, AResultLength, AForceVisible);
  try
    ACommand.Execute;
    Result := ACommand.InsertedField;
  finally
...
function TdxSimplePieceTable.GetLastInsertedInlinePictureRunInfo
  : TdxLastInsertedInlinePictureRunInfo;
begin
  Result := DocumentModel.GetLastInsertedInlinePictureRunInfo(Self);
end;

function TdxSimplePieceTable.GetLastInsertedSeparatorRunInfo
  : TdxLastInsertedSeparatorRunInfo;
begin
  Result := DocumentModel.GetLastInsertedSeparatorRunInfo(Self);
end;

function TdxSimplePieceTable.GetFirstSplitChar(AFontCharacterSet
  : TdxFontCharacterSet; const AText: string): Integer;
var
  I, ALength: Integer;
begin
  Result := -1;
...
procedure TdxSimplePieceTable.ParagraphInserted(ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ACell: TdxCustomTableCell; AIsParagraphMerged: Boolean;
AActualParagraphIndex: TdxParagraphIndex; AHistoryNotificationId: Integer);
begin
  if not DocumentModel.DeferredChanges.IsSetContentMode or DocumentModel.ForceNotifyStructureChanged
  then
    ParagraphInsertedCore(ASectionIndex, AParagraphIndex, ARunIndex, ACell,
      AIsParagraphMerged, AActualParagraphIndex, AHistoryNotificationId);
  DoParagraphInserted(ASectionIndex, AParagraphIndex, ARunIndex, ACell,
    AIsParagraphMerged, AActualParagraphIndex, AHistoryNotificationId);
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphInserted
    (DocumentModel, Self, ASectionIndex, AParagraphIndex, ARunIndex, ACell,
    AIsParagraphMerged, AActualParagraphIndex, AHistoryNotificationId);
end;

procedure TdxSimplePieceTable.DoParagraphInserted(ASectionIndex
...
procedure TdxSimplePieceTable.ParagraphInsertedCore(ASectionIndex
  : TdxSectionIndex; AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ACell: TdxCustomTableCell; AIsParagraphMerged: Boolean;
AActualParagraphIndex: TdxParagraphIndex; AHistoryNotificationId: Integer);
begin
...
procedure TdxSimplePieceTable.ParagraphRemoved(ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
  if not DocumentModel.DeferredChanges.IsSetContentMode or DocumentModel.ForceNotifyStructureChanged
  then
    ParagraphRemovedCore(ASectionIndex, AParagraphIndex, ARunIndex,
      AHistoryNotificationId);
  DoParagraphRemoved(ASectionIndex, AParagraphIndex, ARunIndex,
    AHistoryNotificationId);
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphRemoved(DocumentModel,
    Self, ASectionIndex, AParagraphIndex, ARunIndex, AHistoryNotificationId);
end;

procedure TdxSimplePieceTable.DoParagraphRemoved(ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
end;

procedure TdxSimplePieceTable.ParagraphRemovedCore(ASectionIndex
  : TdxSectionIndex; AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
end;

procedure TdxSimplePieceTable.ParagraphMerged(ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
  if not DocumentModel.DeferredChanges.IsSetContentMode or DocumentModel.ForceNotifyStructureChanged
  then
    ParagraphMergedCore(ASectionIndex, AParagraphIndex, ARunIndex,
      AHistoryNotificationId);
  DoParagraphMerged(ASectionIndex, AParagraphIndex, ARunIndex,
    AHistoryNotificationId);
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphMerged(DocumentModel,
    Self, ASectionIndex, AParagraphIndex, ARunIndex, AHistoryNotificationId);
end;

procedure TdxSimplePieceTable.DoParagraphMerged(ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
end;

procedure TdxSimplePieceTable.ParagraphMergedCore(ASectionIndex
  : TdxSectionIndex; AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
end;

procedure TdxSimplePieceTable.RunInserted(AParagraphIndex: TdxParagraphIndex;
ANewRunIndex: TdxRunIndex; ALength, AHistoryNotificationId: Integer);
begin
  Assert(ALength > 0);
  ...
  if not DocumentModel.DeferredChanges.IsSetContentMode or DocumentModel.ForceNotifyStructureChanged
  then
    RunInsertedCore(AParagraphIndex, ANewRunIndex, ALength,
      AHistoryNotificationId);
  DoRunInserted(AParagraphIndex, ANewRunIndex, ALength, AHistoryNotificationId);
  TdxDocumentModelStructureChangedNotifier.NotifyRunInserted(DocumentModel,
    Self, AParagraphIndex, ANewRunIndex, ALength, AHistoryNotificationId);
end;

procedure TdxSimplePieceTable.DoRunInserted(AParagraphIndex: TdxParagraphIndex;
ANewRunIndex: TdxRunIndex; ALength, AHistoryNotificationId: Integer);
begin
end;

procedure TdxSimplePieceTable.RunInsertedCore(AParagraphIndex
  : TdxParagraphIndex; ANewRunIndex: TdxRunIndex;
ALength, AHistoryNotificationId: Integer);
begin
end;

procedure TdxSimplePieceTable.RunRemoved(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ALength, AHistoryNotificationId: Integer);
begin
  Assert(ALength > 0);
  RecalcParagraphsPositions(AParagraphIndex, -ALength, -1);
  ...
  TdxDocumentModelStructureChangedNotifier.NotifyRunRemoved(DocumentModel, Self,
    AParagraphIndex, ARunIndex, ALength, AHistoryNotificationId);
end;

procedure TdxSimplePieceTable.DoRunRemoved(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ALength, AHistoryNotificationId: Integer);
begin
end;

procedure TdxSimplePieceTable.RunRemovedCore(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ALength, AHistoryNotificationId: Integer);
begin
end;

procedure TdxSimplePieceTable.RunMerged(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
  RecalcParagraphsPositions(AParagraphIndex, ADeltaRunLength, 0);
  TdxDocumentModelStructureChangedNotifier.NotifyRunMerged(DocumentModel, Self,
...
procedure TdxSimplePieceTable.DoRunMerged(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
end;

procedure TdxSimplePieceTable.RunMergedCore(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
end;

procedure TdxSimplePieceTable.RunUnmerged(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
  RecalcParagraphsPositions(AParagraphIndex, ADeltaRunLength, 0);
  TdxDocumentModelStructureChangedNotifier.NotifyRunUnmerged(DocumentModel,
...
procedure TdxSimplePieceTable.DoRunUnmerged(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
end;

procedure TdxSimplePieceTable.RunUnmergedCore(AParagraphIndex
  : TdxParagraphIndex; ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
end;

procedure TdxSimplePieceTable.RunSplit(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ASplitOffset: Integer);
begin
  ...
  TdxDocumentModelStructureChangedNotifier.NotifyRunSplit(DocumentModel, Self,
    AParagraphIndex, ARunIndex, ASplitOffset);
end;

procedure TdxSimplePieceTable.DoRunSplit(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ASplitOffset: Integer);
begin
end;

procedure TdxSimplePieceTable.RunSplitCore(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ASplitOffset: Integer);
begin
end;

procedure TdxSimplePieceTable.RunJoined(AParagraphIndex: TdxParagraphIndex;
AJoinedRunIndex: TdxRunIndex; ASplitOffset, ATailRunLength: Integer);
begin
  Assert(ASplitOffset > 0);
  ...
  if not DocumentModel.DeferredChanges.IsSetContentMode or DocumentModel.ForceNotifyStructureChanged
  then
    RunJoinedCore(AParagraphIndex, AJoinedRunIndex, ASplitOffset,
      ATailRunLength);
  DoRunJoined(AParagraphIndex, AJoinedRunIndex, ASplitOffset, ATailRunLength);
  TdxDocumentModelStructureChangedNotifier.NotifyRunJoined(DocumentModel, Self,
    AParagraphIndex, AJoinedRunIndex, ASplitOffset, ATailRunLength);
end;

procedure TdxSimplePieceTable.DoRunJoined(AParagraphIndex: TdxParagraphIndex;
AJoinedRunIndex: TdxRunIndex; ASplitOffset, ATailRunLength: Integer);
begin
end;

procedure TdxSimplePieceTable.RunJoinedCore(AParagraphIndex: TdxParagraphIndex;
AJoinedRunIndex: TdxRunIndex; ASplitOffset, ATailRunLength: Integer);
begin
end;
...
begin
  ...
  TdxDocumentModelStructureChangedNotifier.NotifyFieldInserted(DocumentModel,
    Self, AFieldIndex);
end;
...
begin
  ...
  TdxDocumentModelStructureChangedNotifier.NotifyFieldRemoved(DocumentModel,
    Self, AFieldIndex);
end;
...
begin
  ...
  if FMultipleRunSplitCount = 0 then
    RecalcParagraphsPositionsCore(FLastShiftedParagraphIndex + 1,
      FLastDeltaLength, FLastDeltaRunIndex);
...
procedure TdxSimplePieceTable.OnParagraphInserted
...
begin
  ...
  ParagraphInserted(ASectionIndex, AParagraphIndex, ARunIndex, ACell,
    AIsParagraphMerged, AActualParagraphIndex, AHistoryNotificationId);
end;

procedure TdxSimplePieceTable.OnParagraphRemoved(APieceTable
  : TdxCustomPieceTable; ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
  Assert(Self = APieceTable);
  ParagraphRemoved(ASectionIndex, AParagraphIndex, ARunIndex,
    AHistoryNotificationId);
end;

procedure TdxSimplePieceTable.OnParagraphMerged(APieceTable
  : TdxCustomPieceTable; ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
  Assert(Self = APieceTable);
  ParagraphMerged(ASectionIndex, AParagraphIndex, ARunIndex,
    AHistoryNotificationId);
end;

procedure TdxSimplePieceTable.OnRunInserted(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ANewRunIndex: TdxRunIndex;
ALength, AHistoryNotificationId: Integer);
begin
  Assert(Self = APieceTable);
...
procedure TdxSimplePieceTable.OnRunRemoved(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ALength, AHistoryNotificationId: Integer);
begin
  Assert(Self = APieceTable);
...
procedure TdxSimplePieceTable.OnRunSplit(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ASplitOffset: Integer);
begin
  Assert(Self = APieceTable);
...
procedure TdxSimplePieceTable.OnRunJoined(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; AJoinedRunIndex: TdxRunIndex;
ASplitOffset, ATailRunLength: Integer);
begin
  Assert(Self = APieceTable);
...
procedure TdxSimplePieceTable.OnRunMerged(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ADeltaRunLength: Integer);
begin
  Assert(Self = APieceTable);
...
procedure TdxSimplePieceTable.OnRunUnmerged(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ADeltaRunLength: Integer);
begin
  Assert(Self = APieceTable);
...
procedure TdxSimplePieceTable.OnFieldRemoved(APieceTable: TdxCustomPieceTable;
AFieldIndex: Integer);
begin
  Assert(Self = APieceTable);
...
procedure TdxSimplePieceTable.OnFieldInserted(APieceTable: TdxCustomPieceTable;
AFieldIndex: Integer);
begin
  Assert(Self = APieceTable);
...
procedure TdxSimplePieceTable.OnBeginMultipleRunSplit
...
procedure TdxSimplePieceTable.OnEndMultipleRunSplit
  (APieceTable: TdxCustomPieceTable);
begin
  Assert(Self = APieceTable);
  EndMultipleRunSplit;
...
function TdxSimpleSelection.GetSelectionPersistentInfo
...
procedure TdxSimpleSelection.RestoreSelection
  (AInfo: TdxSelectionPersistentInfo);
begin
  BeginUpdate;
  try
    ClearMultiSelection;
...
constructor TdxSortedRunIndexCollection.Create(APieceTable
  : TdxCustomPieceTable);
begin
  inherited Create;
...
procedure TdxSortedRunIndexCollection.OnParagraphInserted
  (APieceTable: TdxCustomPieceTable; ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ACell: TdxCustomTableCell; AIsParagraphMerged: Boolean;
AActualParagraphIndex: TdxParagraphIndex; AHistoryNotificationId: Integer);
...
procedure TdxSortedRunIndexCollection.OnParagraphRemoved
  (APieceTable: TdxCustomPieceTable; ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
...
procedure TdxSortedRunIndexCollection.OnParagraphMerged
  (APieceTable: TdxCustomPieceTable; ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
...
procedure TdxSortedRunIndexCollection.OnRunInserted
...
procedure TdxSortedRunIndexCollection.OnRunRemoved
  (APieceTable: TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
...
procedure TdxSortedRunIndexCollection.OnRunSplit(APieceTable
  : TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ASplitOffset: Integer);
var
  AIndex: Integer;
begin
...
procedure TdxSortedRunIndexCollection.OnRunJoined
  (APieceTable: TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
...
begin
  ...
  begin
    Inc(AIndex);
    if (AIndex < FIndices.Count) and (FIndices[AIndex] = (AJoinedRunIndex + 1))
    then
      FIndices.Delete(AIndex);
  end;
  ShiftRunIndex(AIndex, -1);
...
procedure TdxSortedRunIndexCollection.OnRunMerged
  (APieceTable: TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
end;

procedure TdxSortedRunIndexCollection.OnRunUnmerged
  (APieceTable: TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
end;

procedure TdxSortedRunIndexCollection.OnFieldInserted
  (APieceTable: TdxCustomPieceTable; AFieldIndex: Integer);
begin
end;

procedure TdxSortedRunIndexCollection.OnFieldRemoved
  (APieceTable: TdxCustomPieceTable; AFieldIndex: Integer);
begin
end;

procedure TdxSortedRunIndexCollection.OnBeginMultipleRunSplit
  (APieceTable: TdxCustomPieceTable);
begin
end;

procedure TdxSortedRunIndexCollection.OnEndMultipleRunSplit
  (APieceTable: TdxCustomPieceTable);
begin
end;

procedure TdxSortedRunIndexCollection.ShiftRunIndex(AStartIndex: Integer;
ADelta: Integer);
var
  I: Integer;
  ACount: Integer;
...
constructor TdxUnsafeDocumentModelEditor.Create(ADocumentModel
  : TdxSimpleDocumentModel);
begin
  inherited Create;
...
procedure TdxUnsafeDocumentModelEditor.DeleteAllRunsInParagraph
  (APieceTable: TdxSimplePieceTable; AParagraphIndex: TdxParagraphIndex);
var
...
begin
  ...
  AItem := TdxSimpleTextRunsDeletedHistoryItem
    (APieceTable.CreateTextRunsDeletedHistoryItem);
  AItem.ParagraphIndex := AParagraphIndex;
  AItem.RunIndex := AParagraphs[AParagraphIndex].FirstRunIndex;
  AItem.DeletedRunCount := AParagraphs[AParagraphIndex].LastRunIndex -
    AParagraphs[AParagraphIndex].FirstRunIndex + 1;
  DocumentModel.History.Add(AItem);
  AItem.Execute;
end;

procedure TdxUnsafeDocumentModelEditor.DeleteParagraphs
  (APieceTable: TdxSimplePieceTable; AStartParagraphIndex: TdxParagraphIndex;
ACount: Integer; ACell: TdxCustomTableCell);
var
  AItem: TdxParagraphsDeletedHistoryItem;
begin
  AItem := TdxParagraphsDeletedHistoryItem.Create(APieceTable);
  AItem.SectionIndex := APieceTable.LookupSectionIndexByParagraphIndex
    (AStartParagraphIndex);
...
procedure TdxUnsafeDocumentModelEditor.DeleteRuns
  (APieceTable: TdxSimplePieceTable; AStartRunIndex: TdxRunIndex;
ACount: Integer);
var
  AItem: TdxSimpleTextRunsDeletedHistoryItem;
begin
...
procedure TdxUnsafeDocumentModelEditor.DeleteSections(AStartSectionIndex
...
procedure TdxUnsafeDocumentModelEditor.InsertFirstParagraph
...
procedure TdxUnsafeDocumentModelEditor.MergeParagraphs
  (APieceTable: TdxSimplePieceTable;
AFirstParagraph, ASecondParagraph: TdxSimpleParagraph;
AUseFirstParagraphStyle: Boolean; ACell: TdxCustomTableCell);
var
...
procedure TdxUnsafeDocumentModelEditor.ReplaceParagraphRunWithSectionRun
  (APieceTable: TdxSimplePieceTable; ASectionRun: TdxTextRunBase;
ARunIndex: TdxRunIndex);
var
...
begin
  ...
  begin
    ...
    APieceTable.TextBuffer[AParagraphRun.StartIndex] :=
      TdxCharacters.SectionMark;
  end;
end;

procedure TdxUnsafeDocumentModelEditor.ReplaceSectionRunWithParagraphRun
  (APieceTable: TdxSimplePieceTable; ASectionRun: TdxTextRunBase;
ARunIndex: TdxRunIndex);
var
  AParagraphRun: TdxParagraphRun;
...
constructor TdxSimpleDocumentModelDeferredChanges.Create(ADocumentModel
  : TdxCustomDocumentModel);
begin
  inherited Create(ADocumentModel);
  FRunIndicesForSplit := TObjectDictionary<TdxCustomPieceTable,
    TdxSortedRunIndexCollection>.Create([doOwnsValues]);
end;
...
function TdxSimpleDocumentModelDeferredChanges.GetDocumentModel
  : TdxSimpleDocumentModel;
begin
  Result := TdxSimpleDocumentModel(inherited DocumentModel);
end;

function TdxSimpleDocumentModelDeferredChanges.
  GetSelectionLengthChanged: Boolean;
begin
  Result := FOriginalSelectionLength <> DocumentModel.Selection.Length
end;

function TdxSimpleDocumentModelDeferredChanges.GetRunIndicesForSplit
  (APieceTable: TdxCustomPieceTable): TdxSortedRunIndexCollection;
begin
  Result := nil;
...
function TdxSimpleDocumentModel.GetPieceTables(AIncludeUnreferenced: Boolean)
  : TdxFastList;
begin
...
function TdxSimpleDocumentModel.GetNumberingListIndex
  (ATarget: TdxCustomDocumentModel; ASourceListIndex, AMaxNumberingListIndex
  : TdxNumberingListIndex): TdxNumberingListIndex;
begin
  Result := -1;
end;

procedure TdxSimpleDocumentModel.ResetDocumentFormattingCaches
...
procedure TdxSimpleDocumentModel.ResetCharacterFormatting(ACharacterFormatting
  : TdxCharacterFormattingBase);
begin
  ACharacterFormatting.ReplaceInfo
    (Cache.CharacterFormattingCache.DefaultItem.Info,
    TdxCharacterFormattingOptions.EmptyCharacterFormattingOption);
end;

function TdxSimpleDocumentModel.CreateEmptyCharacterFormatting
  : TdxCharacterFormattingBase;
begin
...
function TdxSimpleDocumentModel.CreateEmptyParagraphFormatting
  : TdxParagraphFormattingBase;
begin
...
procedure TdxSimpleDocumentModel.ResetParagraphFormatting(AParagraphFormatting
  : TdxParagraphFormattingBase);
begin
...
procedure TdxSimpleDocumentModel.SwitchToSelectionCore(ANewSelection
  : TdxSimpleSelection);
begin
...
procedure TdxSimpleDocumentModel.OnSectionInserted(ASectionIndex
  : TdxSectionIndex);
begin
end;

procedure TdxSimpleDocumentModel.OnSectionRemoved(ASectionIndex
  : TdxSectionIndex);
begin
end;

function TdxSimpleDocumentModel.CreateImage(ANativeImage: TdxOfficeImage)
...
function TdxSimpleDocumentModel.CreateImage(AStream: TStream)
  : TdxOfficeImageReference;
var
  AImage: TdxOfficeImage;
begin
...
function TdxSimpleDocumentModel.CreateDeferredChanges
  : TdxCustomDocumentModelDeferredChanges;
begin
  Result := TdxSimpleDocumentModelDeferredChanges.Create(Self);
end;

function TdxSimpleDocumentModel.CreateFormattingMarkVisibilityOptions
  : TdxSimpleFormattingMarkVisibilityOptions;
begin
...
begin
  ...
  FLastInsertedInlinePictureRunInfo :=
    TdxLastInsertedInlinePictureRunInfo.Create;
...
function TdxSimpleDocumentModel.CreateSectionCollection
...
begin
  FDefaultParagraphProperties.SetIndexInitial
    (TdxParagraphFormattingCache.RootParagraphFormattingIndex);
  FDefaultCharacterProperties.SetIndexInitial
    (TdxCharacterFormattingCache.RootCharacterFormattingIndex);
end;

function TdxSimpleDocumentModel.GetLastInsertedRunInfo
  (APieceTable: TdxSimplePieceTable): TdxLastInsertedRunInfo;
begin
...
function TdxSimpleDocumentModel.GetLastInsertedInlinePictureRunInfo
  (APieceTable: TdxSimplePieceTable): TdxLastInsertedInlinePictureRunInfo;
begin
...
function TdxSimpleDocumentModel.GetLastInsertedSeparatorRunInfo
  (APieceTable: TdxSimplePieceTable): TdxLastInsertedSeparatorRunInfo;
begin
...
begin
  if FDefaultCharacterProperties <> nil then
    FDefaultCharacterProperties.OnObtainAffectedRange.Add
      (OnDefaultCharacterPropertiesObtainAffectedRange);
end;

procedure TdxSimpleDocumentModel.UnsubscribeCharacterPropertiesEvents;
begin
  if FDefaultCharacterProperties <> nil then
    FDefaultCharacterProperties.OnObtainAffectedRange.Remove
      (OnDefaultCharacterPropertiesObtainAffectedRange);
end;
...
begin
  if FDefaultParagraphProperties <> nil then
    FDefaultParagraphProperties.OnObtainAffectedRange.Add
      (OnDefaultParagraphPropertiesObtainAffectedRange);
end;

procedure TdxSimpleDocumentModel.UnsubscribeParagraphPropertiesEvents;
begin
  if FDefaultCharacterProperties <> nil then
    FDefaultParagraphProperties.OnObtainAffectedRange.Remove
      (OnDefaultParagraphPropertiesObtainAffectedRange);
end;
...
procedure TdxSimpleDocumentModel.OnSelectionChanged(ASender: TObject;
E: TdxEventArgs);
var
...
begin
  ...
  begin
    AActions := [TdxDocumentModelChangeAction.RaiseSelectionChanged,
      TdxDocumentModelChangeAction.ResetCaretInputPositionFormatting,
      TdxDocumentModelChangeAction.ResetSelectionLayout,
      TdxDocumentModelChangeAction.ForceResetHorizontalRuler,
      TdxDocumentModelChangeAction.ForceResetVerticalRuler];
...
function TdxSimpleDocumentModel.CreateDocumentCapabilitiesOptions
...
procedure TdxSimpleDocumentModel.ResetSpellCheck(APieceTable
  : TdxCustomPieceTable; AStartRunIndex, AEndRunIndex: TdxRunIndex;
AFormattingOnly: Boolean);
var
  AActions: TdxDocumentModelChangeActions;
begin
  AActions := [TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetSelectionLayout,
...
procedure TdxSimpleDocumentModel.ResetSpellCheck(AStartRunIndex,
  AEndRunIndex: TdxRunIndex; AFormattingOnly: Boolean = False);
begin
  ResetSpellCheck(GetActivePieceTableCore, AStartRunIndex, AEndRunIndex,
    AFormattingOnly);
end;

procedure TdxSimpleDocumentModel.NotifyNumberingListParagraphAdded
  (AIndex: TdxNumberingListIndex);
begin
end;

procedure TdxSimpleDocumentModel.NotifyNumberingListParagraphRemoved
  (AIndex: TdxNumberingListIndex);
begin
end;

procedure TdxSimpleDocumentModel.RaiseHyperlinkInfoInserted
  (APieceTable: TdxSimplePieceTable; AFieldIndex: Integer);
begin
end;

procedure TdxSimpleDocumentModel.RaiseHyperlinkInfoDeleted
  (APieceTable: TdxSimplePieceTable; AFieldIndex: Integer);
begin
end;

function TdxSimpleDocumentModel.GetPropertiesContainerPieceTable
  : TdxCustomPieceTable;
begin
  Result := PieceTable;
end;

function TdxSimpleDocumentModel.CreateCharacterPropertiesChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
  Result := TdxIndexChangedHistoryItem.Create(MainPieceTable,
    DefaultCharacterProperties);
end;

function TdxSimpleDocumentModel.CreateParagraphPropertiesChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
  Result := TdxIndexChangedHistoryItem.Create(MainPieceTable,
...
function TdxSimpleDocumentModel.GetDefaultCharacterProperties
  : TdxCharacterProperties;
begin
  Result := FDefaultCharacterProperties;
end;

function TdxSimpleDocumentModel.GetDefaultParagraphProperties
...
function TdxSimpleDocumentModel.GetDeferredChanges
  : TdxSimpleDocumentModelDeferredChanges;
begin
  Result := TdxSimpleDocumentModelDeferredChanges(inherited DeferredChanges);
end;

function TdxSimpleDocumentModel.GetDocumentCapabilities
  : TdxSimpleDocumentCapabilitiesOptions;
begin
  Result := TdxSimpleDocumentCapabilitiesOptions
...
procedure TdxSimpleDocumentModel.SetDocumentCapabilities
  (const Value: TdxSimpleDocumentCapabilitiesOptions);
begin
...
begin
  if FFormattingMarkVisibilityOptions <> nil then
    FFormattingMarkVisibilityOptions.Changed.Add
      (OnFormattingMarkVisibilityOptionsChanged);
end;

procedure TdxSimpleDocumentModel.OnFormattingMarkVisibilityOptionsChanged
  (ASender: TObject; E: TdxRichEditNotificationOptionsChangedArgs);
begin
  if (TdxSimpleFormattingMarkVisibilityOptions.TAction.ShowHiddenText
    in E.Actions) or
    (TdxSimpleFormattingMarkVisibilityOptions.TAction.HiddenText in E.Actions)
  then
    OnShowHiddenTextOptionsChanged;
end;

procedure TdxSimpleDocumentModel.OnDefaultCharacterPropertiesObtainAffectedRange
...
procedure TdxSimpleDocumentModel.OnDefaultParagraphPropertiesObtainAffectedRange
  (ASender: TObject; E: TdxObtainAffectedRangeEventArgs);
begin
  E.Start := 0;
  E.&End := MaxInt;
...
procedure TdxSimpleDocumentModel.OnParagraphInserted
  (APieceTable: TdxCustomPieceTable; ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ACell: TdxCustomTableCell; AIsParagraphMerged: Boolean;
AActualParagraphIndex: TdxParagraphIndex; AHistoryNotificationId: Integer);
...
procedure TdxSimpleDocumentModel.OnParagraphRemoved
  (APieceTable: TdxCustomPieceTable; ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
...
procedure TdxSimpleDocumentModel.OnParagraphMerged
  (APieceTable: TdxCustomPieceTable; ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
...
procedure TdxSimpleDocumentModel.OnRunInserted(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ANewRunIndex: TdxRunIndex;
ALength, AHistoryNotificationId: Integer);
begin
  NotImplemented;
...
procedure TdxSimpleDocumentModel.OnRunRemoved(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ALength, AHistoryNotificationId: Integer);
begin
  NotImplemented;
...
procedure TdxSimpleDocumentModel.OnRunSplit(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ASplitOffset: Integer);
begin
  NotImplemented;
...
procedure TdxSimpleDocumentModel.OnRunJoined(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; AJoinedRunIndex: TdxRunIndex;
ASplitOffset, ATailRunLength: Integer);
begin
  NotImplemented;
...
procedure TdxSimpleDocumentModel.OnRunMerged(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ADeltaRunLength: Integer);
begin
  NotImplemented;
...
procedure TdxSimpleDocumentModel.OnRunUnmerged(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ADeltaRunLength: Integer);
begin
  NotImplemented;
...
procedure TdxSimpleDocumentModel.OnFieldRemoved(APieceTable
  : TdxCustomPieceTable; AFieldIndex: Integer);
begin
  NotImplemented;
end;

procedure TdxSimpleDocumentModel.OnFieldInserted(APieceTable
  : TdxCustomPieceTable; AFieldIndex: Integer);
begin
  NotImplemented;
end;

procedure TdxSimpleDocumentModel.OnBeginMultipleRunSplit
  (APieceTable: TdxCustomPieceTable);
begin
  NotImplemented;
end;

procedure TdxSimpleDocumentModel.OnEndMultipleRunSplit
  (APieceTable: TdxCustomPieceTable);
begin
  NotImplemented;
end;
