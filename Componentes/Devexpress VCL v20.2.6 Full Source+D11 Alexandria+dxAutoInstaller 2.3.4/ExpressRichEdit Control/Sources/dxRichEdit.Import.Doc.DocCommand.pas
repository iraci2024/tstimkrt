...
type
  ...
  public
    ...
    procedure UpdatePropertyContainer(AContainer: TdxDocPropertyContainer;
      AChangeType: TdxChangeActionTypes); override;
  ...
  protected
    procedure SetValueTrue(APropertyContainer: TdxDocPropertyContainer);
      virtual; abstract;
    procedure SetValueFalse(APropertyContainer: TdxDocPropertyContainer);
      virtual; abstract;
    procedure SetUseValueTrue(APropertyContainer: TdxDocPropertyContainer);
      virtual; abstract;
    procedure SetUseValueFalse(APropertyContainer: TdxDocPropertyContainer);
      virtual; abstract;
    procedure LeaveValue(APropertyContainer: TdxDocPropertyContainer);
      virtual; abstract;
    procedure InverseValue(APropertyContainer: TdxDocPropertyContainer);
      virtual; abstract;
  public
    procedure Read(const ASprm: TBytes); override;
    procedure Execute(APropertyContainer: TdxDocPropertyContainer;
      ADataStreamReader: TBinaryReader); override;
  ...
  public
    ...
    property ShadingDescriptor: TdxDocShadingDescriptor read FShadingDescriptor
      write FShadingDescriptor;
  end;
  ...
  protected
    ...
    procedure SetValueTrue(APropertyContainer
      : TdxDocPropertyContainer); override;
    procedure SetValueFalse(APropertyContainer
      : TdxDocPropertyContainer); override;
    procedure LeaveValue(APropertyContainer: TdxDocPropertyContainer); override;
    procedure InverseValue(APropertyContainer
      : TdxDocPropertyContainer); override;
    procedure SetUseValueTrue(APropertyContainer
      : TdxDocPropertyContainer); override;
    procedure SetUseValueFalse(APropertyContainer
      : TdxDocPropertyContainer); override;
  end;
  ...
  public
    ...
    property FontUnderlineType: TdxUnderlineType read FFontUnderlineType
      write SetFontUnderlineType;
    property UnderlyneWordsOnly: Boolean read FUnderlineWordsOnly
      write SetUnderlyneWordsOnly;
  end;
  ...
  TdxDocCommandPictureBulletCharacterPosition = class
    (TdxDocCommandShortPropertyValueBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
  ...
  public
    ...
    property SuppressBulletResize: Boolean read FSuppressBulletResize
      write FSuppressBulletResize;
  end;
  ...
  TdxDocCommandXASPropertyValueBase = class abstract
    (TdxDocCommandShortPropertyValueBase)
  public
    procedure Write(AWriter: TBinaryWriter); override;
  end;
  ...
  TdxDocParagraphTextWrapType = (Auto = $00, NotBeside = $01, Around = $02,
    None = $03, Tight = $04, Through = $05);

  { TdxDocWrapTypeCalculator }

  TdxDocWrapTypeCalculator = class
  public
    class function MapToDocWrapTypeStyle(AWrapType
      : TdxFloatingObjectTextWrapType): TdxDocParagraphTextWrapType;
      overload; static;
    class function MapToWrapTypeStyle(AWrapType: TdxDocParagraphTextWrapType)
      : TdxFloatingObjectTextWrapType; static;
    class function MapToDocWrapTypeStyle(AWrapType
      : TdxParagraphFrameTextWrapType): TdxDocParagraphTextWrapType;
      overload; static;
    class function MapToParagraphFrameWrapTypeStyle
      (AWrapType: TdxDocParagraphTextWrapType)
      : TdxParagraphFrameTextWrapType; static;
  end;
  ...
  public
    ...
    property WrapType: TdxDocParagraphTextWrapType read FWrapType
      write FWrapType;
  end;
  ...
  TdxDocCommandFrameHorizontalPosition = class
    (TdxDocCommandShortPropertyValueBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
  ...
  TdxDocCommandFrameVerticalPosition = class
    (TdxDocCommandShortPropertyValueBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
  ...
  public
    ...
    procedure Execute(APropertyContainer: TdxDocPropertyContainer;
      ADataStreamReader: TBinaryReader); override;
    function DocHorizontalTypeToHorizontalType(AHorizontalAnchor
      : TdxHorizontalAnchorTypes): TdxParagraphFrameHorizontalPositionType;
    function DocVerticalTypeToVerticalType(AVerticalAnchorTypes
      : TdxVerticalAnchorTypes): TdxParagraphFrameVerticalPositionType;
    function HorizontalTypeToDocHorizontalType(AHorizontalType
      : TdxParagraphFrameHorizontalPositionType): TdxHorizontalAnchorTypes;
    function VerticalTypeToDocVerticalType(AVerticalType
      : TdxParagraphFrameVerticalPositionType): TdxVerticalAnchorTypes;
    procedure Write(AWriter: TBinaryWriter); override;
    ...
    property HorizontalAnchor: TdxHorizontalAnchorTypes read FHorizontalAnchor
      write FHorizontalAnchor;
    property VerticalAnchor: TdxVerticalAnchorTypes read FVerticalAnchor
      write FVerticalAnchor;
  end;
  ...
  protected
    ...
    function CreateOperandFromByteArray(const ASprm: TBytes)
      : TdxTabsOperandBase; virtual; abstract;
  public
    destructor Destroy; override;
    procedure Read(const ASprm: TBytes); override;
    procedure Execute(APropertyContainer: TdxDocPropertyContainer;
  ...
  public
    ...
    function CalcLineSpacing(AUnitConverter
      : TdxDocumentModelUnitConverter): Single;

    property LineSpacing: SmallInt read FDocLineSpacing write FDocLineSpacing;
    property LineSpacingType: SmallInt read FDocLineSpacingType
      write FDocLineSpacingType;
  end;
  ...
  public
    ...
    property OverriddenBorders: TdxTableBordersOverrideOperand
      read FBordersOverrideOperand;
  end;
  ...
  protected
    ...
    procedure ApplyCellSpacingOperand(APropertyContainer
      : TdxDocPropertyContainer); virtual; abstract;
  public
    constructor Create; override;
    destructor Destroy; override;
    procedure Read(const ASprm: TBytes); override;
  ...
  TdxDocCommandDefineTableShadingsBase = class abstract
    (TdxDocCommandShadingListBase)
  protected
  ...
  TdxDocCommandDefineTableShadings2nd = class
    (TdxDocCommandDefineTableShadingsBase)
  protected
    function GetStartIndex: Integer; override;
  end;
  ...
  TdxDocCommandDefineTableShadings3rd = class
    (TdxDocCommandDefineTableShadingsBase)
  protected
    function GetStartIndex: Integer; override;
  end;
  ...
  public
    ...
    property CellRangeVerticalAlignment: TdxCellRangeVerticalAlignmentOperand
      read FCellRangeVerticalAlignment write FCellRangeVerticalAlignment;
  end;
  ...
  public
    ...
    property CellHideMark: TdxCellHideMarkOperand read FCellHideMark
      write SetCellHideMark;
  end;
  ...
  protected
    procedure ApplyWidthOperand(APropertyContainer: TdxDocPropertyContainer);
      virtual; abstract;
  public
    constructor Create; override;
    destructor Destroy; override;
  ...
  protected
    function GetChangeAction: TdxChangeActionType; override;
    procedure ApplyWidthOperand(APropertyContainer
      : TdxDocPropertyContainer); override;
  end;
  ...
  TdxDocCommandPreferredTableWidth = class
    (TdxDocCommandWidthUnitPropertyValueBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
    procedure ApplyWidthOperand(APropertyContainer
  ...
  TdxDocCommandCellMarginDefault = class
    (TdxDocCommandCellSpacingPropertyValueBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
    procedure ApplyCellSpacingOperand(APropertyContainer
  ...
  TdxDocCommandTableBackgroundColor = class
    (TdxDocCommandShadingPropertyValueBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
  ...
  TdxDocCommandTableHorizontalPosition = class
    (TdxDocCommandShortPropertyValueBase)
  public const
  ...
  TdxDocCommandTableVerticalPosition = class
    (TdxDocCommandShortPropertyValueBase)
  public const
    &Inline = Integer($0000);
  ...
  TdxDocCommandFootNoteNumberingFormatBase = class abstract
    (TdxDocCommandShortPropertyValueBase)
  strict private
    function GetNumberingFormat: TdxNumberingFormat;
    procedure SetNumberingFormat(const AValue: TdxNumberingFormat);
  public
    property NumberingFormat: TdxNumberingFormat read GetNumberingFormat
      write SetNumberingFormat;
  end;

  { TdxDocCommandFootNoteNumberingFormat }

  TdxDocCommandFootNoteNumberingFormat = class
    (TdxDocCommandFootNoteNumberingFormatBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
  ...
  TdxDocCommandEndNoteNumberingFormat = class
    (TdxDocCommandFootNoteNumberingFormatBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
  ...
  TdxDocCommandFootNoteNumberingRestartTypeBase = class abstract
    (TdxDocCommandBytePropertyValueBase)
  strict private
  ...
  public
    property NumberingRestartType: TdxLineNumberingRestart
      read GetNumberingRestartType write SetNumberingRestartType;
  end;

  { TdxDocCommandFootNoteNumberingRestartType }

  TdxDocCommandFootNoteNumberingRestartType = class
    (TdxDocCommandFootNoteNumberingRestartTypeBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
  ...
  TdxDocCommandEndNoteNumberingRestartType = class
    (TdxDocCommandFootNoteNumberingRestartTypeBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
  ...
  TdxDocCommandFootNoteStartingNumber = class
    (TdxDocCommandShortPropertyValueBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
  ...
  TdxDocCommandEndNoteStartingNumber = class
    (TdxDocCommandShortPropertyValueBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
  ...
  public
    ...
    property GutterAlignment: TdxSectionGutterAlignment read GetGutterAlignment
      write SetGutterAlignment;
  end;
  ...
  public
    procedure Execute(APropertyContainer: TdxDocPropertyContainer;
      ADataStreamReader: TBinaryReader); override;
    property ChapterHeaderStyle: Integer read GetChapterHeaderStyle
      write SetChapterHeaderStyle;
  end;
  ...
  strict private
  const
    ChapterSeparators: array [0 .. 4] of Char = (TdxCharacters.Hyphen,
      TdxCharacters.Dot, TdxCharacters.Colon, TdxCharacters.EmDash,
  ...
  public
    ...
    property ChapterSeparator: Char read GetChapterSeparator
      write SetChapterSeparator;
  end;
  ...
  TdxDocCommandLineNumberingDistance = class
    (TdxDocCommandShortPropertyValueBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
  ...
  TdxDocCommandOnlyAllowEditingOfFormFields = class
    (TdxDocCommandBoolPropertyValueBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
  ...
  strict private
    ...
    procedure SetVerticalTextAlignment(const AValue
      : TdxVerticalAlignment); inline;
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
    procedure Execute(APropertyContainer: TdxDocPropertyContainer;
    ...
    property VerticalTextAlignment: TdxVerticalAlignment
      read GetVerticalTextAlignment write SetVerticalTextAlignment;
  end;
  ...
  TdxDocCommandReadExtendedPropertyModifiers = class
    (TdxDocCommandReadTableProperties);
  ...
  public
    ...
    property ShadingDescriptor: TdxDocShadingDescriptor80
      read FShadingDescriptor write FShadingDescriptor;
  end;

  { TdxDocCommandParagraphShading2 }

  TdxDocCommandParagraphShading2 = class
    (TdxDocCommandShading80PropertyValueBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
  ...
  TdxDocCommandFootNotePositionBase = class abstract
    (TdxDocCommandBytePropertyValueBase)
  strict private
  ...
  TdxDocCommandChangeParagraphTabsClose = class
    (TdxDocCommandChangeParagraphTabsBase)
  protected
    function CreateOperand: TdxTabsOperandBase; override;
    function CreateOperandFromByteArray(const ASprm: TBytes)
  ...
  TdxDocCommandReadExtendedPropertyModifiersNew = class
    (TdxDocCommandReadTableProperties);
  ...
  public
    ...
    property FontFamilyNameIndex: SmallInt read FFontFamilyNameIndex
      write FFontFamilyNameIndex;
  ...
  public
    ...
    property ColumnWidth: TdxColumnWidthOperand read FColumnWidth
      write FColumnWidth;
  end;
  ...
  public
    ...
    property TableAutoformatLookSpecifier: TLP
      read FTableAutoformatLookSpecifier write SetTableAutoformatLookSpecifier;
  end;

  { TdxDocCommandParagraphFormattingRsid }

  TdxDocCommandParagraphFormattingRsid = class
    (TdxDocCommandIntPropertyValueBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
  ...
  TdxDocCommandCharacterFormattingRsid = class
    (TdxDocCommandIntPropertyValueBase)
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
...
procedure TdxDocCommandBoolWrapperPropertyValueBase.SetValue
...
procedure TdxDocCommandBoolWrapperPropertyValueBase.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  case FValue of
...
procedure TdxDocCommandBoolWrapperPropertyValueBase.
  Write(AWriter: TBinaryWriter);
begin
  AWriter.Write(TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType),
    TBytes.Create(Byte(FValue))));
end;
...
procedure TdxDocCommandAllCaps.SetValueTrue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.AllCaps :=
    TdxDocBoolWrapper.True;
end;

procedure TdxDocCommandAllCaps.SetValueFalse(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.AllCaps :=
    TdxDocBoolWrapper.False;
...
procedure TdxDocCommandAllCaps.LeaveValue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.AllCaps :=
    TdxDocBoolWrapper.Leave;
...
procedure TdxDocCommandAllCaps.InverseValue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.AllCaps :=
    TdxDocBoolWrapper.Inverse;
...
procedure TdxDocCommandAllCaps.SetUseValueTrue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingOptions.UseAllCaps := True;
end;

procedure TdxDocCommandAllCaps.SetUseValueFalse(APropertyContainer
  : TdxDocPropertyContainer);
begin
...
var
  ASprm: TBytes;
begin
  ASprm := TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType), FColorReference.GetBytes);
  AWriter.Write(ASprm);
end;
...
procedure TdxDocCommandBackColor.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.BackColor :=
    ShadingDescriptor.BackgroundColor;
...
procedure TdxDocCommandForeColor.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandUnderlineColor.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandBold.SetValueTrue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.FontBold :=
    TdxDocBoolWrapper.True;
end;

procedure TdxDocCommandBold.SetValueFalse(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.FontBold :=
    TdxDocBoolWrapper.False;
...
procedure TdxDocCommandBold.LeaveValue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.FontBold :=
    TdxDocBoolWrapper.Leave;
...
procedure TdxDocCommandBold.InverseValue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.FontBold :=
    TdxDocBoolWrapper.Inverse;
...
procedure TdxDocCommandBold.SetUseValueTrue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingOptions.UseFontBold := True;
end;

procedure TdxDocCommandBold.SetUseValueFalse(APropertyContainer
  : TdxDocPropertyContainer);
begin
...
procedure TdxDocCommandItalic.SetValueTrue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.FontItalic :=
    TdxDocBoolWrapper.True;
end;

procedure TdxDocCommandItalic.SetValueFalse(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.FontItalic :=
    TdxDocBoolWrapper.False;
...
procedure TdxDocCommandItalic.LeaveValue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.FontItalic :=
    TdxDocBoolWrapper.Leave;
...
procedure TdxDocCommandItalic.InverseValue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.FontItalic :=
    TdxDocBoolWrapper.Inverse;
...
procedure TdxDocCommandItalic.SetUseValueTrue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingOptions.UseFontItalic := True;
end;

procedure TdxDocCommandItalic.SetUseValueFalse(APropertyContainer
  : TdxDocPropertyContainer);
begin
...
begin
  AWriter.Write(TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType),
    TdxByteArrayHelper.From<Word>(Word(Value))));
end;
...
procedure TdxDocCommandFontName.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandEastAsianFontName.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
end;
...
procedure TdxDocCommandNonASCIIFontName.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
end;
...
procedure TdxDocCommandFontSize.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.DoubleFontSize :=
    Max(DoubleFontSize, 1);
...
begin
  ASprm := TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType),
    TdxByteArrayHelper.From<Word>(Word(DoubleFontSize)));
  AWriter.Write(ASprm);
end;
...
procedure TdxDocCommandStrike.SetValueTrue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.Strike :=
    TdxDocBoolWrapper.True;
end;

procedure TdxDocCommandStrike.SetValueFalse(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.Strike :=
    TdxDocBoolWrapper.False;
...
procedure TdxDocCommandStrike.LeaveValue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.Strike :=
    TdxDocBoolWrapper.Leave;
...
procedure TdxDocCommandStrike.InverseValue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.Strike :=
    TdxDocBoolWrapper.Inverse;
...
procedure TdxDocCommandStrike.SetUseValueTrue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingOptions.
    UseFontStrikeoutType := True;
end;

procedure TdxDocCommandStrike.SetUseValueFalse(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingOptions.
    UseFontStrikeoutType := False;
end;
...
procedure TdxDocCommandDoubleStrike.SetValueTrue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.DoubleStrike :=
    TdxDocBoolWrapper.True;
end;

procedure TdxDocCommandDoubleStrike.SetValueFalse(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.DoubleStrike :=
    TdxDocBoolWrapper.False;
...
procedure TdxDocCommandDoubleStrike.LeaveValue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.DoubleStrike :=
    TdxDocBoolWrapper.Leave;
...
procedure TdxDocCommandDoubleStrike.InverseValue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.DoubleStrike :=
    TdxDocBoolWrapper.Inverse;
...
procedure TdxDocCommandDoubleStrike.SetUseValueTrue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingOptions.
    UseFontStrikeoutType := True;
...
procedure TdxDocCommandDoubleStrike.SetUseValueFalse(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingOptions.
    UseFontStrikeoutType := False;
...
procedure TdxDocCommandHidden.SetValueTrue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.Hidden :=
    TdxDocBoolWrapper.True;
end;

procedure TdxDocCommandHidden.SetValueFalse(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.Hidden :=
    TdxDocBoolWrapper.False;
...
procedure TdxDocCommandHidden.LeaveValue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.Hidden :=
    TdxDocBoolWrapper.Leave;
...
procedure TdxDocCommandHidden.InverseValue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.Hidden :=
    TdxDocBoolWrapper.Inverse;
...
procedure TdxDocCommandHidden.SetUseValueTrue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.CharacterInfo.FormattingOptions.UseHidden := True;
end;

procedure TdxDocCommandHidden.SetUseValueFalse(APropertyContainer
  : TdxDocPropertyContainer);
begin
...
procedure TdxDocCommandScript.SetScript(const AValue
...
procedure TdxDocCommandScript.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
class constructor TdxDocCommandUnderline.Initialize;
  ...
  procedure AddDocUnderlineInfo(ATypeCode: Byte;
...
procedure TdxDocCommandUnderline.SetFontUnderlineType
  (const AValue: TdxUnderlineType);
begin
...
procedure TdxDocCommandUnderline.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
  AUnderlineType: TdxUnderlineType;
begin
  ...
  begin
    ...
    APropertyContainer.CharacterInfo.FormattingInfo.FontUnderlineType :=
      TdxUnderlineType.Single;
    APropertyContainer.CharacterInfo.FormattingOptions.
      UseUnderlineWordsOnly := True;
  end
  else if FUnderlineTypes.TryGetValue(FUnderlineCode, AUnderlineType) then
  begin
    APropertyContainer.CharacterInfo.FormattingInfo.UnderlineWordsOnly :=
      FUnderlineWordsOnly;
    APropertyContainer.CharacterInfo.FormattingInfo.FontUnderlineType :=
      AUnderlineType;
  end;
  APropertyContainer.CharacterInfo.FormattingOptions.
    UseFontUnderlineType := True;
end;
...
procedure TdxDocCommandChangeCharacterStyle.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
function TdxDocCommandPictureBulletCharacterPosition.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Character;
end;

procedure TdxDocCommandPictureBulletCharacterPosition.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.CharacterInfo.PictureBulletInformation.
    PictureCharacterPosition := Value;
end;

procedure TdxDocCommandPictureBulletCharacterPosition.
  Write(AWriter: TBinaryWriter);
begin
  AWriter.Write(TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType),
...
function TdxDocCommandPictureBulletProperties.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Character;
end;
...
procedure TdxDocCommandPictureBulletProperties.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
  APictureBulletInformation: TdxDocPictureBulletInformation;
begin
  APictureBulletInformation := APropertyContainer.CharacterInfo.
    PictureBulletInformation;
...
begin
  if PictureBullet then
    FPictureBulletInformationBitField :=
      FPictureBulletInformationBitField or $01;
  if SuppressBulletResize then
    FPictureBulletInformationBitField :=
      FPictureBulletInformationBitField or $02;
  if DefaultPicture then
    FPictureBulletInformationBitField :=
      FPictureBulletInformationBitField or $04;
  AWriter.Write(TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType),
...
procedure TdxDocCommandPictureOffset.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandSpecial.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
begin
  AWriter.Write(TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType), TBytes.Create(GetValue)));
end;
...
procedure TdxDocCommandAlignment.SetAlignment(const AValue
  : TdxParagraphAlignment);
begin
...
procedure TdxDocCommandAlignment.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandFirstLineIndent.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
...
procedure TdxDocCommandLogicalLeftIndent.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandLogicalRightIndent.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandSpacingAfter.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandSpacingBefore.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandSuppressHyphenation.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.ParagraphInfo.FormattingInfo.SuppressHyphenation := Value;
  APropertyContainer.ParagraphInfo.FormattingOptions.
    UseSuppressHyphenation := True;
end;
...
procedure TdxDocCommandSuppressLineNumbers.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.ParagraphInfo.FormattingInfo.SuppressLineNumbers := Value;
  APropertyContainer.ParagraphInfo.FormattingOptions.
    UseSuppressLineNumbers := True;
end;
...
procedure TdxDocCommandContextualSpacing.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.ParagraphInfo.FormattingInfo.ContextualSpacing := Value;
  APropertyContainer.ParagraphInfo.FormattingOptions.
    UseContextualSpacing := True;
end;
...
procedure TdxDocCommandPageBreakBefore.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandBeforeAutoSpacing.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.ParagraphInfo.FormattingInfo.BeforeAutoSpacing := Value;
  APropertyContainer.ParagraphInfo.FormattingOptions.
    UseBeforeAutoSpacing := True;
end;
...
procedure TdxDocCommandAfterAutoSpacing.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.ParagraphInfo.FormattingInfo.AfterAutoSpacing := Value;
  APropertyContainer.ParagraphInfo.FormattingOptions.
    UseAfterAutoSpacing := True;
end;
...
procedure TdxDocCommandKeepWithNext.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandKeepLinesTogether.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.ParagraphInfo.FormattingInfo.KeepLinesTogether := Value;
  APropertyContainer.ParagraphInfo.FormattingOptions.
    UseKeepLinesTogether := True;
end;
...
procedure TdxDocCommandWidowOrphanControl.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.ParagraphInfo.FormattingInfo.WidowOrphanControl := Value;
  APropertyContainer.ParagraphInfo.FormattingOptions.
    UseWidowOrphanControl := True;
end;
...
procedure TdxDocCommandOutlineLevel.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
...
procedure TdxDocCommandParagraphShading.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.ParagraphInfo.FormattingInfo.BackColor :=
    ShadingDescriptor.BackgroundColor;
...
class function TdxDocWrapTypeCalculator.MapToDocWrapTypeStyle
  (AWrapType: TdxFloatingObjectTextWrapType): TdxDocParagraphTextWrapType;
begin
  case AWrapType of
...
class function TdxDocWrapTypeCalculator.MapToWrapTypeStyle
  (AWrapType: TdxDocParagraphTextWrapType): TdxFloatingObjectTextWrapType;
begin
  case AWrapType of
...
class function TdxDocWrapTypeCalculator.MapToDocWrapTypeStyle
  (AWrapType: TdxParagraphFrameTextWrapType): TdxDocParagraphTextWrapType;
begin
  case AWrapType of
...
class function TdxDocWrapTypeCalculator.MapToParagraphFrameWrapTypeStyle
  (AWrapType: TdxDocParagraphTextWrapType): TdxParagraphFrameTextWrapType;
begin
  case AWrapType of
...
procedure TdxDocCommandFrameWrapType.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.FrameInfo.FormattingInfo.TextWrapType :=
    TdxDocWrapTypeCalculator.MapToParagraphFrameWrapTypeStyle(WrapType);
...
procedure TdxDocCommandFrameHeight.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  ...
  begin
    if MinHeight then
      APropertyContainer.FrameInfo.FormattingInfo.HorizontalRule :=
...
begin
  ...
  AWriter.Write(TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType),
    TdxByteArrayHelper.From<Word>(FHeightAbs)));
end;
...
procedure TdxDocCommandFrameWidth.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
function TdxDocCommandFrameHorizontalPosition.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Frame;
end;

procedure TdxDocCommandFrameHorizontalPosition.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
function TdxDocCommandFrameVerticalPosition.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Frame;
end;

procedure TdxDocCommandFrameVerticalPosition.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandFramePosition.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
...
begin
  ...
  AFrameFormattingInfo.HorizontalPositionType :=
    DocHorizontalTypeToHorizontalType(HorizontalAnchor);
  AFrameFormattingInfo.VerticalPositionType := DocVerticalTypeToVerticalType
    (VerticalAnchor);
...
function TdxDocCommandFramePosition.DocHorizontalTypeToHorizontalType
  (AHorizontalAnchor: TdxHorizontalAnchorTypes)
...
function TdxDocCommandFramePosition.DocVerticalTypeToVerticalType
  (AVerticalAnchorTypes: TdxVerticalAnchorTypes)
...
function TdxDocCommandFramePosition.HorizontalTypeToDocHorizontalType
  (AHorizontalType: TdxParagraphFrameHorizontalPositionType)
...
function TdxDocCommandFramePosition.VerticalTypeToDocVerticalType
  (AVerticalType: TdxParagraphFrameVerticalPositionType)
...
begin
  ASprm := TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType),
    TBytes.Create(GetAnchorTypeCodes));
  AWriter.Write(ASprm);
end;
...
function TdxDocCommandFramePosition.CalcVerticalAnchor(AOperand: Byte)
  : TdxVerticalAnchorTypes;
var
...
function TdxDocCommandFramePosition.CalcHorizontalAnchor(AOperand: Byte)
  : TdxHorizontalAnchorTypes;
var
...
begin
  Result := Byte((GetVerticalAnchorTypeCode shl 4) or
    (GetHorizontalAnchorTypeCode shl 6));
end;
...
procedure TdxDocCommandInTable.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandTableDepth.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
function TdxDocCommandChangeParagraphTabsBase.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Paragraph;
end;
...
procedure TdxDocCommandChangeParagraphTabsBase.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  FOperand.AddTabs(APropertyContainer.ParagraphInfo.Tabs,
    APropertyContainer.UnitConverter);
end;
...
function TdxDocCommandChangeParagraphTabs.CreateOperandFromByteArray
  (const ASprm: TBytes): TdxTabsOperandBase;
begin
...
procedure TdxDocCommandListInfoIndex.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandListLevel.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandLineSpacing.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.ParagraphInfo.FormattingInfo.LineSpacingType :=
    CalcLineSpacingType;
  APropertyContainer.ParagraphInfo.FormattingInfo.LineSpacing :=
    CalcLineSpacing(APropertyContainer.UnitConverter);
...
begin
  ...
  AWriter.Write(TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType), AOperand));
end;
...
begin
  ...
  else if FDocLineSpacing = 240 then
    Result := TdxParagraphLineSpacing.Single
  else if FDocLineSpacing = 360 then
    Result := TdxParagraphLineSpacing.Sesquialteral
  else if FDocLineSpacing = 480 then
    Result := TdxParagraphLineSpacing.Double
  else
    Result := TdxParagraphLineSpacing.Multiple;
end;

function TdxDocCommandLineSpacing.CalcLineSpacing(AUnitConverter
  : TdxDocumentModelUnitConverter): Single;
begin
  if FDocLineSpacingType = 0 then
...
procedure TdxDocCommandInnerTableCell.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandInnerTableTrailer.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandTableTrailer.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandChangeTableStyle.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandInsertTableCell.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
begin
  ASprm := TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType), Insert.GetBytes);
  AWriter.Write(ASprm);
end;
...
function TdxDocCommandPreferredTableCellWidth.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.TableRow;
end;
...
procedure TdxDocCommandPreferredTableCellWidth.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
begin
  ASprm := TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType), TableCellWidth.GetBytes);
  AWriter.Write(ASprm);
end;
...
procedure TdxDocCommandOverrideCellBorders.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.TableRowInfo.OverrideCellBordersActions.Add
    (OverriddenBorders);
...
procedure TdxDocCommandCellSpacingPropertyValueBase.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  ApplyCellSpacingOperand(APropertyContainer);
end;

procedure TdxDocCommandCellSpacingPropertyValueBase.
  Write(AWriter: TBinaryWriter);
begin
  AWriter.Write(TdxDocCommandFactory.GetOpcodeByType(ClassType));
...
procedure TdxDocCommandCellMargin.ApplyCellSpacingOperand(APropertyContainer
  : TdxDocPropertyContainer);
begin
...
begin
  ...
  begin
    AShadingDescriptor := TdxDocShadingDescriptor.FromByteArray(ASprm,
      I * TdxDocShadingDescriptor.Size);
    try
...
function TdxDocCommandDefineTableShadingsBase.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.TableCell;
end;

procedure TdxDocCommandDefineTableShadingsBase.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
  I: Integer;
begin
  for I := 0 to CellColors.Count - 1 do
    APropertyContainer.TableCellInfo.CellColors.Insert(StartIndex + I,
      CellColors[I]);
end;
...
function TdxDocCommandCellRangeVerticalAlignment.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.TableRow;
end;
...
procedure TdxDocCommandCellRangeVerticalAlignment.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.TableRowInfo.CellRangeVerticalAlignmentActions.Add
    (CellRangeVerticalAlignment);
...
function TdxDocCommandVerticalMergeTableCells.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.TableRow;
end;
...
begin
  CellIndex := ASprm[0];
  VerticalMerging := TdxMergingStateCalculator.CalcVerticalMergingState
    (ASprm[1]);
end;

procedure TdxDocCommandVerticalMergeTableCells.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.TableRowInfo.VerticalMerging.Add
    (TdxVerticalMergeInfo.Create(CellIndex, VerticalMerging));
end;

procedure TdxDocCommandVerticalMergeTableCells.Write(AWriter: TBinaryWriter);
begin
  AWriter.Write(TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType), TBytes.Create(CellIndex,
    TdxMergingStateCalculator.CalcVerticalMergingTypeCode(VerticalMerging))));
end;
...
procedure TdxDocCommandHideCellMark.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandHideCellMark.SetCellHideMark
  (const Value: TdxCellHideMarkOperand);
begin
...
procedure TdxDocCommandTableRowHeight.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.TableRowInfo.TableRowProperties.Height.&Type :=
    CalcHeightUnitType;
  APropertyContainer.TableRowInfo.TableRowProperties.Height.Value :=
    APropertyContainer.UnitConverter.TwipsToModelUnits(Abs(Value));
end;
...
begin
  ...
  ASprm := TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType),
    TdxByteArrayHelper.From<SmallInt>(SmallInt(Value)));
  AWriter.Write(ASprm);
end;
...
procedure TdxDocCommandWidthUnitPropertyValueBase.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  if WidthUnit.&Type = TdxWidthUnitType.ModelUnits then
    WidthUnit.Value :=
      SmallInt(APropertyContainer.UnitConverter.TwipsToModelUnits
      (WidthUnit.Value));
...
begin
  ASprm := TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType), WidthUnit.GetBytes);
  AWriter.Write(ASprm);
end;
...
procedure TdxDocCommandWidthBefore.ApplyWidthOperand(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.TableRowInfo.TableRowProperties.WidthBefore.&Type :=
    WidthUnit.&Type;
  APropertyContainer.TableRowInfo.TableRowProperties.WidthBefore.Value :=
    WidthUnit.Value;
...
procedure TdxDocCommandWidthAfter.ApplyWidthOperand(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.TableRowInfo.TableRowProperties.WidthAfter.&Type :=
    WidthUnit.&Type;
  APropertyContainer.TableRowInfo.TableRowProperties.WidthAfter.Value :=
    WidthUnit.Value;
end;
...
procedure TdxDocCommandTableDxaLeft.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.TableRowInfo.RowLeft :=
    APropertyContainer.UnitConverter.TwipsToModelUnits(Value);
...
procedure TdxDocCommandTableDxaGapHalf.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  if Value < 0 then
    Exit;
  APropertyContainer.TableRowInfo.RowLeftOffset :=
    APropertyContainer.UnitConverter.TwipsToModelUnits(Value);
...
procedure TdxDocCommandPreferredTableWidth.ApplyWidthOperand(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.TableInfo.TableProperties.PreferredWidth.&Type :=
    WidthUnit.&Type;
  APropertyContainer.TableInfo.TableProperties.PreferredWidth.Value :=
    WidthUnit.Value;
end;
...
procedure TdxDocCommandTableAutoFit.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  if Value then
    APropertyContainer.TableInfo.TableProperties.TableLayout :=
...
procedure TdxDocCommandTableBorders.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  TableBorders.ApplyProperties(APropertyContainer.TableInfo.TableProperties.
    Borders, APropertyContainer.UnitConverter);
end;
...
procedure TdxDocCommandCellMarginDefault.ApplyCellSpacingOperand
  (APropertyContainer: TdxDocPropertyContainer);
begin
  CellSpacing.ApplyProperties(APropertyContainer.TableInfo.TableProperties.
    CellMargins, APropertyContainer.UnitConverter);
end;
...
procedure TdxDocCommandWidthIndent.ApplyWidthOperand(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.TableInfo.TableProperties.TableIndent.&Type :=
    WidthUnit.&Type;
  APropertyContainer.TableInfo.TableProperties.TableIndent.Value :=
    WidthUnit.Value;
end;
...
procedure TdxDocCommandTableAlignment.SetTableAlignment
  (const AValue: TdxTableRowAlignment);
begin
...
procedure TdxDocCommandTableAlignment.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  CalcAlignmentType;
...
function TdxDocCommandTableAlignment.CalcAlignmentTypeCode
  (AAlignment: TdxTableRowAlignment): Integer;
begin
  case AAlignment of
...
procedure TdxDocCommandCellSpacing.ApplyCellSpacingOperand(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.TableInfo.TableProperties.CellSpacing.&Type :=
    CellSpacing.WidthUnit.&Type;
  APropertyContainer.TableInfo.TableProperties.CellSpacing.Value :=
    CellSpacing.WidthUnit.Value;
end;
...
procedure TdxDocCommandTableBackgroundColor.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.TableInfo.TableProperties.BackgroundColor :=
    ShadingDescriptor.BackgroundColor;
end;
...
procedure TdxDocCommandTableOverlap.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandBottomFromText.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.TableInfo.TableProperties.FloatingPosition.BottomFromText
    := APropertyContainer.UnitConverter.TwipsToModelUnits(Value);
end;
...
procedure TdxDocCommandLeftFromText.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.TableInfo.TableProperties.FloatingPosition.LeftFromText :=
    APropertyContainer.UnitConverter.TwipsToModelUnits(Value);
end;
...
procedure TdxDocCommandRightFromText.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.TableInfo.TableProperties.FloatingPosition.RightFromText :=
    APropertyContainer.UnitConverter.TwipsToModelUnits(Value);
end;
...
procedure TdxDocCommandTopFromText.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.TableInfo.TableProperties.FloatingPosition.TopFromText :=
    APropertyContainer.UnitConverter.TwipsToModelUnits(Value);
end;

{ TdxDocCommandTableHorizontalPosition }

function TdxDocCommandTableHorizontalPosition.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Table;
end;

procedure TdxDocCommandTableHorizontalPosition.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
  AFloatingPosition: TdxTableFloatingPosition;
begin
  AFloatingPosition := APropertyContainer.TableInfo.TableProperties.
    FloatingPosition;
...
function TdxDocCommandTableVerticalPosition.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Table;
end;

procedure TdxDocCommandTableVerticalPosition.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
  AFloatingPosition: TdxTableFloatingPosition;
begin
...
function TdxDocCommandTableStyleRowBandSize.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Table;
end;

procedure TdxDocCommandTableStyleRowBandSize.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
function TdxDocCommandTableStyleColBandSize.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Table;
end;

procedure TdxDocCommandTableStyleColBandSize.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandColumnCount.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
  I: Integer;
begin
  ...
  for I := 0 to APropertyContainer.SectionInfo.SectionColumns.ColumnCount - 1 do
    APropertyContainer.SectionInfo.SectionColumns.Columns.Add
      (TdxColumnInfo.Create);
end;
...
procedure TdxDocCommandColumnWidth.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
...
function TdxDocCommandNotEvenlyColumnsSpace.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Section;
end;
...
procedure TdxDocCommandNotEvenlyColumnsSpace.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
  AColumns: TdxColumnInfoCollection;
begin
...
function TdxDocCommandDrawVerticalSeparator.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Section;
end;

procedure TdxDocCommandDrawVerticalSeparator.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandEqualWidthColumns.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
...
procedure TdxDocCommandColumnSpace.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
function TdxDocCommandFootNoteNumberingFormatBase.GetNumberingFormat
  : TdxNumberingFormat;
begin
  Result := TdxNumberingFormatCalculator.CalcNumberingFormat(Value);
end;

procedure TdxDocCommandFootNoteNumberingFormatBase.SetNumberingFormat
  (const AValue: TdxNumberingFormat);
begin
...
function TdxDocCommandFootNoteNumberingFormat.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Section;
end;

procedure TdxDocCommandFootNoteNumberingFormat.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
function TdxDocCommandEndNoteNumberingFormat.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Section;
end;

procedure TdxDocCommandEndNoteNumberingFormat.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
function TdxDocCommandFootNoteNumberingRestartTypeBase.GetNumberingRestartType
  : TdxLineNumberingRestart;
begin
  Result := TdxFootNoteNumberingRestartCalculator.
    CalcFootNoteNumberingRestart(Value);
end;

procedure TdxDocCommandFootNoteNumberingRestartTypeBase.SetNumberingRestartType
  (const AValue: TdxLineNumberingRestart);
begin
  Value := TdxFootNoteNumberingRestartCalculator.
    CalcFootNoteNumberingRestartTypeCode(AValue);
end;

{ TdxDocCommandFootNoteNumberingRestartType }

function TdxDocCommandFootNoteNumberingRestartType.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Section;
end;

procedure TdxDocCommandFootNoteNumberingRestartType.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.FootNote.NumberingRestartType :=
    NumberingRestartType;
end;

{ TdxDocCommandEndNoteNumberingRestartType }

function TdxDocCommandEndNoteNumberingRestartType.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Section;
end;

procedure TdxDocCommandEndNoteNumberingRestartType.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.EndNote.NumberingRestartType :=
    NumberingRestartType;
end;

{ TdxDocCommandFootNoteStartingNumber }

function TdxDocCommandFootNoteStartingNumber.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Section;
end;

procedure TdxDocCommandFootNoteStartingNumber.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
function TdxDocCommandEndNoteStartingNumber.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Section;
end;

procedure TdxDocCommandEndNoteStartingNumber.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandLeftMargin.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionMargins.Left :=
    APropertyContainer.UnitConverter.TwipsToModelUnits(Value);
...
procedure TdxDocCommandRightMargin.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionMargins.Right :=
    APropertyContainer.UnitConverter.TwipsToModelUnits(Value);
  APropertyContainer.SectionInfo.SectionPage.PaperKind := TdxPaperKind.Custom;
end;
...
procedure TdxDocCommandTopMargin.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionMargins.Top :=
    APropertyContainer.UnitConverter.TwipsToModelUnits(Value);
  APropertyContainer.SectionInfo.SectionPage.PaperKind := TdxPaperKind.Custom;
end;
...
procedure TdxDocCommandBottomMargin.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionMargins.Bottom :=
    APropertyContainer.UnitConverter.TwipsToModelUnits(Value);
  APropertyContainer.SectionInfo.SectionPage.PaperKind := TdxPaperKind.Custom;
end;
...
procedure TdxDocCommandGutter.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionMargins.Gutter :=
    APropertyContainer.UnitConverter.TwipsToModelUnits(Value);
end;
...
procedure TdxDocCommandRTLGutter.SetGutterAlignment(const AValue
  : TdxSectionGutterAlignment);
begin
...
procedure TdxDocCommandRTLGutter.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  if FRtlGutter = 1 then
    APropertyContainer.SectionInfo.SectionMargins.GutterAlignment :=
      TdxSectionGutterAlignment.Right
  else
    APropertyContainer.SectionInfo.SectionMargins.GutterAlignment :=
      TdxSectionGutterAlignment.Left;
end;
...
begin
  ASprm := TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType),
    TBytes.Create(FRtlGutter));
  AWriter.Write(ASprm);
end;

procedure TdxDocCommandRTLGutter.CalcGutterAlignment
  (AAlignment: TdxSectionGutterAlignment);
begin
...
procedure TdxDocCommandHeaderOffset.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionMargins.HeaderOffset :=
    APropertyContainer.UnitConverter.TwipsToModelUnits(Value);
end;
...
procedure TdxDocCommandFooterOffset.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionMargins.FooterOffset :=
    APropertyContainer.UnitConverter.TwipsToModelUnits(Value);
end;
...
procedure TdxDocCommandPageHeight.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionPage.Height :=
    APropertyContainer.UnitConverter.TwipsToModelUnits(Value);
end;
...
procedure TdxDocCommandPageOrientation.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandPageWidth.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionPage.Width :=
    APropertyContainer.UnitConverter.TwipsToModelUnits(Value);
end;

{ TdxDocCommandChapterHeaderStyle }

procedure TdxDocCommandChapterHeaderStyle.SetChapterHeaderStyle
...
procedure TdxDocCommandChapterHeaderStyle.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionPageNumbering.
    ChapterHeaderStyle := Value;
end;
...
procedure TdxDocCommandChapterSeparator.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  if Value <= High(ChapterSeparators) then
    APropertyContainer.SectionInfo.SectionPageNumbering.ChapterSeparator :=
      ChapterSeparators[Value];
end;

function TdxDocCommandChapterSeparator.CalcChapterSeparatorCode
  (AChapterSeparator: Char): Byte;
begin
...
procedure TdxDocCommandNumberingFormat.SetNumberingFormat
  (const AValue: TdxNumberingFormat);
begin
  Value := TdxNumberingFormatCalculator.CalcNumberingFormatCode(AValue);
end;
...
procedure TdxDocCommandNumberingFormat.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionPageNumbering.NumberingFormat :=
    NumberingFormat;
end;

{ TdxDocCommandUseStartingPageNumber }

function TdxDocCommandUseStartingPageNumber.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Section;
end;

procedure TdxDocCommandUseStartingPageNumber.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionPageNumbering.ContinueNumbering :=
    not Value;
end;
...
procedure TdxDocCommandStartingPageNumber.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
function TdxDocCommandLineNumberingDistance.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Section;
end;

procedure TdxDocCommandLineNumberingDistance.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
function TdxDocCommandNumberingRestartType.GetNumberingRestartType
  : TdxLineNumberingRestart;
begin
  Result := CalcLineNumberingRestart;
end;

procedure TdxDocCommandNumberingRestartType.SetNumberingRestartType
  (const AValue: TdxLineNumberingRestart);
begin
  Value := Ord(AValue);
end;
...
procedure TdxDocCommandNumberingRestartType.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionLineNumbering.NumberingRestartType :=
    NumberingRestartType;
end;

function TdxDocCommandNumberingRestartType.CalcLineNumberingRestart
  : TdxLineNumberingRestart;
begin
  if Value = $00 then
...
procedure TdxDocCommandStartLineNumber.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionLineNumbering.StartingLineNumber :=
    Value + 1;
end;
...
procedure TdxDocCommandStep.Execute(APropertyContainer: TdxDocPropertyContainer;
  ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandDifferentFirstPage.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionGeneralSettings.
...
procedure TdxDocCommandFirstPagePaperSource.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionGeneralSettings.
    FirstPagePaperSource := Value;
end;

{ TdxDocCommandOnlyAllowEditingOfFormFields }

function TdxDocCommandOnlyAllowEditingOfFormFields.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Section;
end;

procedure TdxDocCommandOnlyAllowEditingOfFormFields.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionGeneralSettings.
    OnlyAllowEditingOfFormFields := Value;
end;
...
procedure TdxDocCommandOtherPagePaperSource.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionGeneralSettings.
    OtherPagePaperSource := Value;
end;
...
procedure TdxDocCommandStartType.SetStartType(const AValue
  : TdxSectionStartType);
begin
...
procedure TdxDocCommandStartType.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
begin
  case Value of
    ...
    1:
      Result := TdxSectionStartType.Column;
    2:
...
procedure TdxDocCommandTextDirection.SetTextDirection
  (const AValue: TdxTextDirection);
begin
...
procedure TdxDocCommandTextDirection.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  if Value = 0 then
    APropertyContainer.SectionInfo.SectionGeneralSettings.TextDirection :=
...
begin
  if (FTextDirection = TdxTextDirection.LeftToRightTopToBottom) or
    (FTextDirection = TdxTextDirection.LeftToRightTopToBottomRotated) then
    Value := 0
  else
    Value := 1;
end;
...
function TdxDocCommandVerticalTextAlignment.GetVerticalTextAlignment
  : TdxVerticalAlignment;
begin
  Result := CalcVerticalAlignment;
end;

procedure TdxDocCommandVerticalTextAlignment.SetVerticalTextAlignment
  (const AValue: TdxVerticalAlignment);
begin
  Value := VerticalAlignmentTypes[AValue];
end;

function TdxDocCommandVerticalTextAlignment.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Section;
end;

procedure TdxDocCommandVerticalTextAlignment.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionGeneralSettings.VerticalTextAlignment :=
    VerticalTextAlignment;
end;

function TdxDocCommandVerticalTextAlignment.CalcVerticalAlignment
  : TdxVerticalAlignment;
begin
  case Value of
    0:
...
procedure TdxDocCommandReadTableProperties.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
  ASize: Integer;
  AGrpprl: TBytes;
...
procedure TdxDocCommandEmpty.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
end;
...
class function TdxDocCommandFactory.GetOpcodeByType(ACommandType: TClass)
  : SmallInt;
begin
  if not FCommandOpcodes.TryGetValue(TdxDocCommandClass(ACommandType), Result)
  then
    Result := $0000;
end;
...
procedure TdxDocCommandFactory.UpdatePropertyContainer
  (AContainer: TdxDocPropertyContainer; AChangeType: TdxChangeActionTypes);
begin
  if (AChangeType = []) or (AChangeType = [TdxChangeActionType.None]) then
    Exit;
  if (AContainer.CharacterInfo = nil) and
    (TdxChangeActionType.Character in AChangeType) then
    AContainer.CharacterInfo := TdxCharacterInfo.CreateDefault(Model);
  if (AContainer.ParagraphInfo = nil) and
    (TdxChangeActionType.Paragraph in AChangeType) then
    AContainer.ParagraphInfo := TdxParagraphInfo.CreateDefault(Model);
  if (AContainer.FrameInfo = nil) and
    (AChangeType * [TdxChangeActionType.Frame, TdxChangeActionType.Table] <> [])
  then
    AContainer.FrameInfo := TdxFrameInfo.CreateDefault(Model);
  if (AContainer.SectionInfo = nil) and
    (TdxChangeActionType.Section in AChangeType) then
  begin
  ...
  if (AContainer.TableCellInfo = nil) and
    (TdxChangeActionType.TableCell in AChangeType) then
    AContainer.TableCellInfo := TdxTableCellInfo.CreateDefault(Model);
  if (AContainer.TableRowInfo = nil) and
    (TdxChangeActionType.TableRow in AChangeType) then
    AContainer.TableRowInfo := TdxTableRowInfo.CreateDefault(Model);
  if (AContainer.TableInfo = nil) and (TdxChangeActionType.Table in AChangeType)
  then
    AContainer.TableInfo := TdxDocTableInfo.CreateDefault(Model);
end;

class procedure TdxDocCommandFactory.Add(ACode: Word;
  ACommandClass: TdxDocCommandClass);
begin
...
begin
  AInfo.FootNote.NumberingRestartType :=
    DocumentProperties.FootNoteNumberingRestartType;
  ...
  AInfo.EndNote.NumberingRestartType :=
    DocumentProperties.EndNoteNumberingRestartType;
...
var
  ...
  AIndex: Integer;
begin
  if TArray.BinarySearch<TdxAlphaColor>(TdxDocConstants.DefaultMSWordColor,
    Color, AIndex) then
    AColorIndex := AIndex
  else
    AColorIndex := 0;
...
procedure TdxDocCommandBackColorIco.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandForeColorIco.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.CharacterInfo.FormattingInfo.ForeColor := Color;
...
procedure TdxDocCommandParagraphShading2.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
function TdxDocCommandStartingPageNumberNew.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.Section;
end;

procedure TdxDocCommandStartingPageNumberNew.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.SectionInfo.SectionPageNumbering.FirstPageNumber := Value;
end;
...
procedure TdxDocCommandFootNotePositionBase.SetPosition
  (const AValue: TdxFootNotePosition);
begin
...
procedure TdxDocCommandFootNotePosition.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandEndNotePosition.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandDeleted.SetValueTrue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.IsDeleted := True;
end;

procedure TdxDocCommandDeleted.SetValueFalse(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.IsDeleted := False;
end;

procedure TdxDocCommandDeleted.LeaveValue(APropertyContainer
  : TdxDocPropertyContainer);
begin
end;

procedure TdxDocCommandDeleted.InverseValue(APropertyContainer
  : TdxDocPropertyContainer);
begin
  APropertyContainer.IsDeleted := not APropertyContainer.IsDeleted;
end;

procedure TdxDocCommandDeleted.SetUseValueTrue(APropertyContainer
  : TdxDocPropertyContainer);
begin
end;

procedure TdxDocCommandDeleted.SetUseValueFalse(APropertyContainer
  : TdxDocPropertyContainer);
begin
end;
...
procedure TdxDocCommandChangeParagraphStyle.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
function TdxDocCommandChangeParagraphTabsClose.CreateOperand
  : TdxTabsOperandBase;
begin
  Result := TdxTabsOperandClose.Create;
end;

function TdxDocCommandChangeParagraphTabsClose.CreateOperandFromByteArray
  (const ASprm: TBytes): TdxTabsOperandBase;
begin
...
procedure TdxDocCommandSymbol.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.CharacterInfo.Special := True;
  APropertyContainer.CharacterInfo.SpecialCharactersFontFamilyNameIndex :=
    FontFamilyNameIndex;
  APropertyContainer.CharacterInfo.FormattingOptions.UseFontName := True;
...
class function TdxDocCommandSymbol.ParseUnicodeChar(AParameterValue
  : SmallInt): Char;
begin
...
procedure TdxDocCommandEmbeddedObject.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandBinaryData.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandOle2Object.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandTableDepthIncrement.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.ParagraphInfo.TableDepth :=
    APropertyContainer.ParagraphInfo.TableDepth + Value;
...
procedure TdxDocCommandMergeTableCells.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.TableRowInfo.HorizontalMerging.Add
    (TdxHorizontalMergeInfo.Create(FirstMergedIndex, LastMergedIndex, False));
end;
...
procedure TdxDocCommandSplitTableCells.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.TableRowInfo.HorizontalMerging.Add
    (TdxHorizontalMergeInfo.Create(FirstMergedIndex, LastMergedIndex, True));
end;
...
procedure TdxDocCommandTableCellWidth.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
begin
  ASprm := TdxDocCommandHelper.CreateSinglePropertyModifier
    (TdxDocCommandFactory.GetOpcodeByType(ClassType), ColumnWidth.GetBytes);
  AWriter.Write(ASprm);
end;
...
procedure TdxDocCommandTableBorders80.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  TableBorders.ApplyProperties(APropertyContainer.TableInfo.TableProperties.
    Borders, APropertyContainer.UnitConverter);
...
procedure TdxDocCommandTableDefinition.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
function TdxDocCommandTableRowBorderColorsBase.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.TableRow;
end;
...
begin
  ...
  for I := 0 to ACount - 1 do
    FColors.Add(TdxDocTableBorderColorReference.FromByteArray(ASprm,
      I * TdxDocColorReference.ColorReferenceSize));
end;
...
procedure TdxDocCommandTopBorderColors.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandBottomBorderColors.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandLeftBorderColors.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandRightBorderColors.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandTableShading.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
...
procedure TdxDocCommandTableShading2.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  if APropertyContainer.Factory.Version <= $00D9 then
...
procedure TdxDocCommandTableShading3.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  if APropertyContainer.Factory.Version <= $00D9 then
...
procedure TdxDocCommandDefTableShd80.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  if APropertyContainer.Factory.Version <= $00D9 then
...
function TdxDocCommandDefTableShd80.GetColor(ADescriptor
  : TdxDocShadingDescriptor80): TdxAlphaColor;
begin
...
function TdxDocCommandTablePropertiesException.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.TableRow;
end;
...
procedure TdxDocCommandTablePropertiesException.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
  APropertyContainer.TableRowInfo.TableAutoformatLookSpecifier :=
    TableAutoformatLookSpecifier.Clone;
end;

procedure TdxDocCommandTablePropertiesException.Write(AWriter: TBinaryWriter);
begin
  AWriter.Write(TdxDocCommandFactory.GetOpcodeByType
    (TdxDocCommandTablePropertiesException));
  AWriter.Write(TLP.Size);
  TableAutoformatLookSpecifier.Write(AWriter);
end;

procedure TdxDocCommandTablePropertiesException.SetTableAutoformatLookSpecifier
  (const Value: TLP);
begin
...
function TdxDocCommandParagraphFormattingRsid.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.None;
end;

procedure TdxDocCommandParagraphFormattingRsid.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
end;
...
function TdxDocCommandCharacterFormattingRsid.GetChangeAction
  : TdxChangeActionType;
begin
  Result := TdxChangeActionType.None;
end;

procedure TdxDocCommandCharacterFormattingRsid.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
end;
...
procedure TdxDocCommandInsertTextRsid.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
end;
