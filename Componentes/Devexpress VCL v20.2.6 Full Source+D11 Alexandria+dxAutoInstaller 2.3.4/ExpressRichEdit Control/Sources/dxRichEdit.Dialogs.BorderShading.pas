...
{$ENDIF}
  ...
  Dialogs, ExtCtrls, Menus, Buttons,
  dxCore, dxCoreGraphics, cxGeometry, dxRichEdit.Dialogs.CustomDialog,
  cxGraphics, cxControls, cxLookAndFeels,
  cxLookAndFeelPainters, dxLayoutContainer, dxLayoutControl,
  dxLayoutControlAdapters, StdCtrls, cxButtons,
  cxContainer, cxEdit, cxListBox, dxLayoutcxEditAdapters, cxTextEdit,
...
type
  ...
  private
    ...
    procedure BorderLineStyleDrawItem(AControl: TcxListBox; ACanvas: TcxCanvas;
  ...
  protected
    ...
    procedure InitializePreviewControl
      (AControl: TdxBorderShadingUserControlHelper);
...
begin
  ...
  lblBordersPreview.Caption := cxGetResourceString
    (@sdxRichEditBorderShadingDialogPreview);
  lblBordersPreviewTxt.Caption := cxGetResourceString
    (@sdxRichEditBorderShadingDialogPreviewTxt);
  btnOptions.Caption := cxGetResourceString
    (@sdxRichEditBorderShadingDialogButtonOptions);
  lblShadingFill.Caption := cxGetResourceString
    (@sdxRichEditBorderShadingDialogShadingFill);
  lblShadingPreview.Caption := cxGetResourceString
    (@sdxRichEditBorderShadingDialogPreview);
  lcgBorders.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditBorderShadingDialogBorders);
  lcgShading.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditBorderShadingDialogShading);
  lciNone.CaptionOptions.Text := cxGetResourceString
    (@sdxRichEditBorderShadingDialogNone);
  lciBox.CaptionOptions.Text := cxGetResourceString
    (@sdxRichEditBorderShadingDialogBox);
  lciAll.CaptionOptions.Text := cxGetResourceString
    (@sdxRichEditBorderShadingDialogAll);
  lciGrid.CaptionOptions.Text := cxGetResourceString
    (@sdxRichEditBorderShadingDialogGrid);
  lciCustom.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditBorderShadingDialogCustom);
  lciBorderLineStyle.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditBorderShadingDialogBorderLineStyle);
  lciBorderLineColor.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditBorderShadingDialogBorderLineColor);
  lciBorderLineWeight.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditBorderShadingDialogBorderLineWeight);
  lciApplyTo.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditBorderShadingDialogApplyTo);

  PopulateApplyTo;
end;

procedure TdxRichEditBorderShadingDialogForm.BorderLineColorPropertiesChange
  (Sender: TObject);
var
  AColor: TColor;
begin
...
procedure TdxRichEditBorderShadingDialogForm.BorderLineStyleChange
  (Sender: TObject);
var
  ABorder: TdxBorderInfo;
begin
  ABorder := TdxBorderInfo(lbBorderLineStyle.Items.Objects
    [lbBorderLineStyle.ItemIndex]).Clone;
  try
...
procedure TdxRichEditBorderShadingDialogForm.BorderLineStyleDrawItem
...
procedure TdxRichEditBorderShadingDialogForm.BorderLineWeightPropertiesChange
  (Sender: TObject);
var
...
procedure TdxRichEditBorderShadingDialogForm.
  BorderUserControl_BorderLineDownChanged(Sender: TObject);
begin
  Controller.BorderLineDown := FBorderUserControl.BorderLineDown;
end;

procedure TdxRichEditBorderShadingDialogForm.
  BorderUserControl_BorderLineHorizontalInChanged(Sender: TObject);
begin
  Controller.BorderLineHorizontalIn :=
    FBorderUserControl.BorderLineHorizontalIn;
end;

procedure TdxRichEditBorderShadingDialogForm.
  BorderUserControl_BorderLineLeftChanged(Sender: TObject);
begin
  Controller.BorderLineLeft := FBorderUserControl.BorderLineLeft;
end;

procedure TdxRichEditBorderShadingDialogForm.
  BorderUserControl_BorderLineRightChanged(Sender: TObject);
begin
  Controller.BorderLineRight := FBorderUserControl.BorderLineRight;
end;

procedure TdxRichEditBorderShadingDialogForm.
  BorderUserControl_BorderLineUpChanged(Sender: TObject);
begin
  Controller.BorderLineUp := FBorderUserControl.BorderLineUp;
end;

procedure TdxRichEditBorderShadingDialogForm.
  BorderUserControl_BorderLineVerticalInChanged(Sender: TObject);
begin
...
begin
  Result := TdxBorderShadingFormController.Create
    (AControllerParameters as TdxBorderShadingFormControllerParameters);
end;
...
function TdxRichEditBorderShadingDialogForm.GetController
...
begin
  ...
  FBorderUserControl := TdxBorderShadingUserControlHelper.Create
    (FPreviewBorderControl);
  FBorderUserControl.Initialize(btnHorizontBorderUp, btnHorizontBorderDown,
    btnHorizontBorderIn, btnVerticalBorderLeft, btnVerticalBorderRight,
    btnVerticalBorderIn);
  ...
  cmbShadingColor.ColorValue := TdxAlphaColors.ToColor
    (Controller.GetActiveColor);

  SetButtonState;
  FBorderUserControl.Mode := Controller.SetModeButton;
end;

procedure TdxRichEditBorderShadingDialogForm.InitializePreviewControl
  (AControl: TdxBorderShadingUserControlHelper);
begin
  ...
  try
    ...
    AControl.BorderLineHorizontalInVisible :=
      Controller.BorderLineHorizontalInVisible;
    AControl.BorderLineVerticalInVisible :=
      Controller.BorderLineVerticalInVisible;
...
procedure TdxRichEditBorderShadingDialogForm.lcgTabControlTabChanged
  (Sender: TObject);
begin
...
procedure TdxRichEditBorderShadingDialogForm.pbBordersPreviewPaint
  (Sender: TObject);
var
  APreview: TPaintBox;
begin
...
procedure TdxRichEditBorderShadingDialogForm.PreviewBorderControlChange
  (Sender: TObject);
begin
  pbBordersPreview.Invalidate;
end;

procedure TdxRichEditBorderShadingDialogForm.PreviewShadingControlChange
  (Sender: TObject);
begin
...
procedure TdxRichEditBorderShadingDialogForm.SetInitialBorder
  (const ABorder: TdxBorderInfo);
...
begin
  ...
  TdxBorderLineWeightPainter.PopulateBorderLineWeight
    (cmbBorderLineWeight.Properties, ABorder.Style, ABorder.Color,
...
procedure TdxRichEditBorderShadingDialogForm.ShadingColorPropertiesChange
  (Sender: TObject);
var
  AColor: TColor;
...
begin
  ...
  FBorderUserControl.OnBorderLineUpChanged :=
    BorderUserControl_BorderLineUpChanged;
  FBorderUserControl.OnBorderLineDownChanged :=
    BorderUserControl_BorderLineDownChanged;
  FBorderUserControl.OnBorderLineHorizontalInChanged :=
    BorderUserControl_BorderLineHorizontalInChanged;
  FBorderUserControl.OnBorderLineLeftChanged :=
    BorderUserControl_BorderLineLeftChanged;
  FBorderUserControl.OnBorderLineRightChanged :=
    BorderUserControl_BorderLineRightChanged;
  FBorderUserControl.OnBorderLineVerticalInChanged :=
    BorderUserControl_BorderLineVerticalInChanged;
  FPreviewBorderControl.OnChange := PreviewBorderControlChange;
