...
class function TdxImportPlainTextFormat.GetDocumentFormat
  : TdxRichEditDocumentFormat;
begin
  Result := TdxRichEditDocumentFormat.PlainText;
end;

function TdxImportPlainTextFormat.GetDocumentImporter
  : IdxImporter<TdxRichEditDocumentFormat, Boolean>;
begin
  Result := TdxPlainTextDocumentImporter.Create;
end;

function TdxImportPlainTextFormat.GetImporter(ADocumentModel
