...
uses
  Types, SysUtils, Classes, RegularExpressions, Generics.Defaults,
...
type
  ...
  TdxRegexSearchInfo = (StartExtended, EndExtended);
  ...
  public
    function Match(const APattern: string; AOptions: TdxSearchOptions;
  ...
  protected
    ...
    procedure SetCurrentPosition(const Value: TdxDocumentModelPosition);
      virtual; abstract;
    procedure EnsureStartPositionIsVisible; virtual;
    function IsRunVisible(ARunIndex: TdxRunIndex): Boolean;
    function GetPositionForward(const APosition: TdxDocumentModelPosition;
      AOffset: Integer): TdxDocumentModelPosition;
    function GetPositionBackward(const APosition: TdxDocumentModelPosition;
      AOffset: Integer): TdxDocumentModelPosition;
  ...
  public
    ...
    function GetPosition(const APosition: TdxDocumentModelPosition;
      AOffset: Integer): TdxDocumentModelPosition; overload; virtual; abstract;
    function GetPosition(AOffset: Integer): TdxDocumentModelPosition;
      overload; virtual;
    function Compare(AOffset: Integer; ACh: Char; AIgnoreCase: Boolean)
      : Boolean; overload;
    function Compare(ACh1: Char; ACh2: Char; AIgnoreCase: Boolean)
      : Boolean; overload;
    ...
    property CurrentPosition: TdxDocumentModelPosition read GetCurrentPosition
  ...
  TdxBufferedDocumentCharacterIteratorForward = class
    (TdxBufferedDocumentCharacterIterator)
  protected
    function GetCurrentPosition: TdxDocumentModelPosition; override;
    procedure SetCurrentPosition(const Value
  ...
  public
    constructor Create(AResult: TdxRunInfo;
      AMatchInfo: TdxBufferedRegexSearchResult);
  ...
  protected
    ...
    function GetStartAtPosition(ARunInfo: TdxRunInfo): TdxDocumentLogPosition;
      virtual; abstract;
  ...
  public
    constructor Create(APieceTable: TdxPieceTable;
      AParameters: TdxSearchParameters; AContext: TdxSearchContext);
    class function CreateForwardProvider(APieceTable: TdxPieceTable;
      AParameters: TdxSearchParameters; AContext: TdxSearchContext)
      : TdxTextSearchProvider; static;
    class function CreateBackwardProvider(APieceTable: TdxPieceTable;
      AParameters: TdxSearchParameters; AContext: TdxSearchContext)
      : TdxTextSearchProvider; static;
  ...
  protected
    ...
    function GetModelPosition(AOffset: Integer)
      : TdxDocumentModelPosition; overload;
    function GetModelPosition(const APos: TdxDocumentModelPosition;
      AOffset: Integer): TdxDocumentModelPosition; overload;
    ...
    procedure ShiftModelPosition(var APos: TdxDocumentModelPosition;
      AOffset: Integer);
    procedure MoveToVisiblePosition(var AResult: TdxDocumentModelPosition);
      virtual; abstract;

    property CurrentRun: TdxTextRunBase read GetCurrentRun;
  public
    constructor Create(APieceTable: TdxPieceTable;
      AStart, AEnd: TdxDocumentLogPosition); overload;
    ...
    function GetCharacter(AOffset: Integer; out APos: TdxDocumentLogPosition)
      : Char; overload; virtual;
  ...
  protected
    ...
    procedure MoveToVisiblePosition(var APos
      : TdxDocumentModelPosition); override;
  public
  ...
  protected
    ...
    function GetCharacter(AIterator: TdxDocumentCharacterIterator;
      AOffset: Integer): Char;
    function CreateUnicodeAlphabetTable(AInitialValue: Integer)
      : TArray<Integer>;
    procedure PopulateBadCharacterShiftTable(const APattern: string;
      const ATable: TArray<Integer>);
    ...
    property BadCharacterShiftTable: TArray<Integer>
      read FBadCharacterShiftTable;
    property GoodSuffixShiftTable: TArray<Integer> read FGoodSuffixShiftTable;
  public
    constructor Create(APieceTable: TdxPieceTable; const APattern: string;
      ACaseSensitive: Boolean);
    function Search(const AStart, AEnd: TdxDocumentLogPosition)
      : TdxNullableValue<TdxDocumentModelPosition>; virtual; abstract;
  ...
  TdxBufferedRegexSearchResultCollection = class
    (TdxList<TdxBufferedRegexSearchResult>);

  { TdxBufferedRegexSearchResultTable }

  TdxBufferedRegexSearchResultTable = class
    (TDictionary<Integer, TdxBufferedRegexSearchResult>);
  ...
  public
    ...
    constructor Create(const AInput: string; AStartIndex: Integer;
  ...
  strict private
    ...
    FPieceTable: TdxPieceTable;
  protected
    procedure InitializeSearchInterval(AStart,
      AEnd: TdxDocumentLogPosition); virtual;
    function CreateIterator(const APosition: TdxDocumentModelPosition)
      : TdxBufferedDocumentCharacterIterator; virtual; abstract;
    function CanMoveNext: Boolean; virtual; abstract;
    function CreateResult(const AMatch: TMatch)
      : TdxBufferedRegexSearchResult; overload;
    function CreateResult(AResults: TdxBufferedRegexSearchResultCollection)
      : TdxBufferedRegexSearchResultCollection; overload;
    function CalculateBufferShiftSize(AResult: TdxBufferedRegexSearchResult)
      : Integer; virtual; abstract;
    function CalculateStartPosition: TdxDocumentModelPosition; virtual;
      abstract;
    function ProcessBuffer(AIterator: TdxBufferedDocumentCharacterIterator;
      const ARegEx: TRegex; AResults: TdxBufferedRegexSearchResultCollection)
      : Boolean; virtual;
    procedure ShiftBuffer(AIterator: TdxBufferedDocumentCharacterIterator;
      ADelta: Integer); virtual;
    function CalculateMatchCore(const ARegEx: TRegex;
      const AConditions: TdxSearchConditions): TMatch; virtual; abstract;
    ...
    function ShouldRecalcMatchAtStartOfBuffer(var AConditions
      : TdxSearchConditions): Boolean; virtual;
    function ShouldRecalcMatchAtEndOfBuffer(var AConditions
      : TdxSearchConditions): Boolean; virtual;
    procedure CalculateSearchConditions(const APrevMatch: TMatch;
      var AConditions: TdxSearchConditions); virtual; abstract;
    procedure AppendBuffer(AIterator: TdxBufferedDocumentCharacterIterator);
      virtual; abstract;
    function CalculateMatch(AIterator: TdxBufferedDocumentCharacterIterator;
      const ARegEx: TRegex; var AConditions: TdxSearchConditions): TMatch;
      virtual; abstract;
    function GetMatchAbsolutePosition(const AMatch: TMatch): Integer;
      virtual; abstract;
  ...
  public
    constructor Create(APieceTable: TdxPieceTable;
      const ARegEx: TRegex); overload;
    constructor Create(APieceTable: TdxPieceTable; const ARegEx: TRegex;
      AMaxGuaranteedSearchResultLength: Integer); overload;
    constructor Create(APieceTable: TdxPieceTable; const ARegEx: TRegex;
      ABufferSize, ABufferShiftSize: Integer); overload;
    destructor Destroy; override;
    function Match(AStart, AEnd: TdxDocumentLogPosition)
      : TdxBufferedRegexSearchResult;
    procedure Initialize(AStart, AEnd: TdxDocumentLogPosition;
      const ACurrentPosition: TdxDocumentModelPosition);
    function Matches(AStart, AEnd: TdxDocumentLogPosition)
      : TdxBufferedRegexSearchResultCollection;
    ...
    property Buffer: TStringBuilder read FBuffer;
    property BufferStartPosition: TdxDocumentModelPosition
      read FBufferStartPosition write FBufferStartPosition;
    property BufferInputPosition: TdxDocumentModelPosition
      read FCurrentInputPosition write FCurrentInputPosition;
  ...
  protected
    ...
    function CreateDocumentRange(ARangeInfo: TdxRunInfo)
      : IdxRichEditDocumentRange; virtual;
    ...
    procedure ChangeSearchIntervalAfterReplace(ADeltaLength: Integer);
      virtual; abstract;
  ...
  public
    constructor Create(ADocument: TdxNativeSubDocument; const AFindText: string;
      ASearchOptions: TdxRichEditSearchOptions;
      const ARange: IdxRichEditDocumentRange);
    destructor Destroy; override;
    class function CreateNativeSearchResultBackward
      (ADocument: TdxNativeSubDocument; const AFindText: string;
      ASearchOptions: TdxRichEditSearchOptions;
      const ARange: IdxRichEditDocumentRange)
      : TdxNativeSearchResultBase; static;
    class function CreateNativeSearchResultForward
      (ADocument: TdxNativeSubDocument; const AFindText: string;
      ASearchOptions: TdxRichEditSearchOptions;
      const ARange: IdxRichEditDocumentRange)
      : TdxNativeSearchResultBase; static;
  ...
  TdxNativeGroupCollection = class(TInterfacedObject,
  ...
  public
    ...
    property Items[Index: Integer]: IdxRichEditRegexSearchGroup
  ...
  strict private
    ...
    function GetValue: string;
  protected
    function CreateGroup(const AGroup: TGroup)
      : IdxRichEditRegexSearchGroup; virtual;
  ...
  protected
    function Match(const ARange: IdxRichEditDocumentRange)
      : IdxRichEditRegexSearchMatch;
    function Matches(const ARange: IdxRichEditDocumentRange)
    ...
    class function CreatePosition(const APos: TdxDocumentModelPosition;
      AOffset: Integer): TdxDocumentLogPosition; static;
    function CreateMatch(const AOffset: TdxDocumentModelPosition;
      const AMatch: TMatch): IdxRichEditRegexSearchMatch;
    function CreateRegexSearch: TdxBufferedRegexSearchBase;

    property Document: TdxNativeSubDocument read FDocument;
    property Regex: TRegex read FRegex;
    property MaxGuaranteedSearchResultLength: Integer
      read FMaxGuaranteedSearchResultLength;
  public
    constructor Create(ADocument: TdxNativeSubDocument; const ARegEx: TRegex;
      AMaxGuaranteedSearchResultLength: Integer);
  end;

  { TdxNativeRegexSearchResult }

  TdxNativeRegexSearchResult = class abstract(TInterfacedObject,
  ...
  protected
    function CreateRegexSearch(ADocument: TdxNativeSubDocument;
      const ARegEx: TRegex): TdxNativeRegexSearch;
    property MaxGuaranteedSearchResultLength: Integer
      read FMaxGuaranteedSearchResultLength;
  public
    constructor Create(ADocument: TdxNativeSubDocument; const ARegEx: TRegex;
...
type
  ...
  TdxTextSearchStateBase = class abstract(TInterfacedObject,
    IdxTextSearchStateBase)
  strict private
  ...
  protected
    ...
    function CanSearch(AStartPosition: TdxDocumentLogPosition)
      : Boolean; virtual;
    function DoSearch(AStart, AEnd: TdxDocumentLogPosition)
      : TdxSearchResult; overload;
    function DoSearch(AStartPosition: TdxDocumentLogPosition): TdxSearchResult;
      overload; virtual; abstract;
    function CanSearchFromPosition(AStartPosition: TdxDocumentLogPosition)
  ...
  public
    ...
    function FindNext(AStartPosition: TdxDocumentLogPosition)
      : TdxSearchResult; virtual;
  ...
  protected
    ...
    function DoSearch(AStartPosition: TdxDocumentLogPosition)
      : TdxSearchResult; override;
    function CanSearchFromPosition(AStartPosition: TdxDocumentLogPosition)
      : Boolean; override;
  public
    function FindNext(AStartPosition: TdxDocumentLogPosition)
  ...
  protected
    ...
    function GetType: TdxSearchState; override;
    function GetShouldSearch: Boolean; override;
    function DoSearch(AEndPosition: TdxDocumentLogPosition)
      : TdxSearchResult; override;
    function CanSearchFromPosition(AStartPosition: TdxDocumentLogPosition)
      : Boolean; override;
  public
  ...
  public
    function Search(const AStart, AEnd: TdxDocumentLogPosition)
      : TdxNullableValue<TdxDocumentModelPosition>; override;
  end;
  ...
  protected
    ...
    function MatchCore(ASearcher: T; const AStart, AEnd: TdxDocumentLogPosition)
      : TdxSearchResult; virtual; abstract;
    function CreateIntervalCalculator: TdxSearchIntervalCalculator;
      virtual; abstract;
    function CreateSearcher(const APattern: string; AOptions: TdxSearchOptions)
      : T; virtual; abstract;
    function IsWordWhole(ARunInfo: TdxRunInfo): Boolean; virtual;
    function GetPrevCharacter(const AStart: TdxDocumentModelPosition)
      : Char; virtual;
    function GetNextCharacter(const AEnd: TdxDocumentModelPosition)
      : Char; virtual;
  public
    constructor Create(APieceTable: TdxPieceTable);
    function Match(const APattern: string; AOptions: TdxSearchOptions;
      const AStart, AEnd: TdxDocumentLogPosition): TdxSearchResult; override;
  ...
  TdxTextSearchByStringStrategy = class abstract
    (TdxTextSearchStrategyBase<TdxBMTextSearchBase>)
  protected
    function MatchCore(ASearcher: TdxBMTextSearchBase;
      const AStart, AEnd: TdxDocumentLogPosition): TdxSearchResult; override;
  end;
  ...
  TdxTextSearchByRegexStrategy = class abstract
    (TdxTextSearchStrategyBase<TdxBufferedRegexSearchBase>)
  protected
    function MatchCore(ASearcher: TdxBufferedRegexSearchBase;
      const AStart, AEnd: TdxDocumentLogPosition): TdxSearchResult; override;
  end;
  ...
  protected
    function CreateIntervalCalculator: TdxSearchIntervalCalculator; override;
    function CreateSearcher(const APattern: string; AOptions: TdxSearchOptions)
      : TdxBufferedRegexSearchBase; override;
  end;
  ...
  protected
    function CalculateMatchCore(const ARegEx: TRegex;
      const AConditions: TdxSearchConditions): TMatch; override;
    procedure CalculateSearchConditions(const APrevMatch: TMatch;
      var AConditions: TdxSearchConditions); override;
    procedure AppendBuffer(AIterator
      : TdxBufferedDocumentCharacterIterator); override;
    procedure ShiftBuffer(AIterator: TdxBufferedDocumentCharacterIterator;
      ADelta: Integer); override;
    function CalculateMatch(AIterator: TdxBufferedDocumentCharacterIterator;
      const ARegEx: TRegex; var AConditions: TdxSearchConditions)
      : TMatch; override;
  ...
  protected
    ...
    function GetStartAtPosition(ARunInfo: TdxRunInfo)
      : TdxDocumentLogPosition; override;
    function GetNextVisiblePosition(const APosition: TdxDocumentModelPosition)
      : TdxDocumentLogPosition; overload;
    function GetNextVisiblePosition(APosition: TdxDocumentLogPosition)
      : TdxDocumentLogPosition; overload;
  public
  ...
  protected
    ...
    function GetStartAtPosition(ARunInfo: TdxRunInfo)
      : TdxDocumentLogPosition; override;
    function GetPrevVisiblePosition(const APosition: TdxDocumentModelPosition)
      : TdxDocumentLogPosition; overload;
    function GetPrevVisiblePosition(APosition: TdxDocumentLogPosition)
      : TdxDocumentLogPosition; overload;
  public
    procedure SetState(ASearchType: TdxSearchState); override;
  end;
...
{$IFNDEF DELPHI102TOKYO}
  ...
  TStringBuilderHelper = class helper for TStringBuilder
    function Insert(AIndex: Integer; const AValue: TCharArray;
      AStartIndex, ACharCount: Integer): TStringBuilder; overload;
  end;
{$ENDIF}
...
function TStringBuilderHelper.Insert(AIndex: Integer; const AValue: TCharArray;
  AStartIndex, ACharCount: Integer): TStringBuilder;
begin
  ...
  if AStartIndex < 0 then
    raise ERangeError.CreateResFmt(@SParamIsNegative, ['AStartIndex']);
  // DO NOT LOCALIZE
  if ACharCount < 0 then
    raise ERangeError.CreateResFmt(@SParamIsNegative, ['ACharCount']);
  // DO NOT LOCALIZE
  ...
  Move(FData[AIndex], FData[AIndex + ACharCount], (Length - ACharCount - AIndex)
    * SizeOf(Char));
...
constructor TdxBufferedDocumentCharacterIterator.Create(const AStartPosition
...
function TdxBufferedDocumentCharacterIterator.GetCharacters
  (Index: Integer): Char;
begin
  Result := Buffer[GetCharacterIndex(index)];
end;

procedure TdxBufferedDocumentCharacterIterator.AppendBuffer
  (AMinLength: Integer);
var
  ADelta: Integer;
begin
...
function TdxBufferedDocumentCharacterIterator.IsRunVisible
  (ARunIndex: TdxRunIndex): Boolean;
begin
  Result := PieceTable.VisibleTextFilter.IsRunVisible(ARunIndex);
end;

function TdxBufferedDocumentCharacterIterator.GetPosition(AOffset: Integer)
  : TdxDocumentModelPosition;
begin
  Result := GetPosition(CurrentPosition, AOffset);
end;

function TdxBufferedDocumentCharacterIterator.GetPositionForward(const APosition
  : TdxDocumentModelPosition; AOffset: Integer): TdxDocumentModelPosition;
var
...
function TdxBufferedDocumentCharacterIterator.GetPositionBackward
  (const APosition: TdxDocumentModelPosition; AOffset: Integer)
  : TdxDocumentModelPosition;
var
...
function TdxBufferedDocumentCharacterIterator.GetRunText
...
function TdxBufferedDocumentCharacterIterator.Compare(AOffset: Integer;
  ACh: Char; AIgnoreCase: Boolean): Boolean;
var
  ADocumentChar: Char;
...
begin
  ...
  begin
    if (ADocumentChar = TdxCharacters.ObjectMark) or
      (ADocumentChar = TdxCharacters.FloatingObjectMark) then
    begin
...
function TdxBufferedDocumentCharacterIterator.Compare(ACh1: Char; ACh2: Char;
...
function TdxBufferedDocumentCharacterIteratorForward.GetCurrentPosition
  : TdxDocumentModelPosition;
begin
  Result := StartPosition;
end;

function TdxBufferedDocumentCharacterIteratorForward.GetCharacterIndex
  (AIndex: Integer): Integer;
begin
  Result := AIndex + Offset;
end;

procedure TdxBufferedDocumentCharacterIteratorForward.AppendBufferCore
  (AMinLength: Integer);
var
...
begin
  ...
  ARuns := PieceTable.Runs;
  while (Buffer.Length < AMinLength) and
    (EndPosition.RunIndex < ALastRunIndex) do
  begin
    ARun := ARuns[EndPosition.RunIndex];
    if IsRunVisible(EndPosition.RunIndex) then
    begin
      if EndPosition.RunOffset > 0 then
        Buffer.Append(TdxStringHelper.Substring(GetRunText(ARun),
          EndPosition.RunOffset))
      else
        Buffer.Append(GetRunText(ARun));
    end;
    EndPosition.LogPosition := EndPosition.LogPosition + ARun.Length -
      EndPosition.RunOffset;
...
function TdxBufferedDocumentCharacterIteratorForward.IsCharacterExist
  (AIndex: Integer): Boolean;
begin
  Result := GetCharacterIndex(AIndex) < Buffer.Length;
end;

procedure TdxBufferedDocumentCharacterIteratorForward.SetCurrentPosition
  (const Value: TdxDocumentModelPosition);
begin
  StartPosition.CopyFrom(Value);
end;

function TdxBufferedDocumentCharacterIteratorForward.GetPosition(const APosition
  : TdxDocumentModelPosition; AOffset: Integer): TdxDocumentModelPosition;
begin
...
function TdxBufferedDocumentCharacterIteratorBackward.GetCurrentPosition
  : TdxDocumentModelPosition;
begin
  Result := EndPosition;
end;

function TdxBufferedDocumentCharacterIteratorBackward.GetCharacterIndex
  (AIndex: Integer): Integer;
begin
  Result := (Buffer.Length - 1) - (AIndex + Offset);
end;

procedure TdxBufferedDocumentCharacterIteratorBackward.AppendBufferCore
  (AMinLength: Integer);
var
  ARuns: TdxTextRunCollection;
...
begin
  ...
  begin
    ...
    begin
      ...
      Buffer.Insert(0, TdxStringHelper.Substring(GetRunText(ARun), 0,
        StartPosition.RunOffset));
    end;
...
function TdxBufferedDocumentCharacterIteratorBackward.IsCharacterExist
  (AIndex: Integer): Boolean;
begin
  Result := GetCharacterIndex(AIndex) >= 0;
end;

procedure TdxBufferedDocumentCharacterIteratorBackward.SetCurrentPosition
  (const Value: TdxDocumentModelPosition);
begin
  EndPosition.CopyFrom(Value);
end;

function TdxBufferedDocumentCharacterIteratorBackward.GetPosition
  (const APosition: TdxDocumentModelPosition; AOffset: Integer)
  : TdxDocumentModelPosition;
begin
...
constructor TdxRegexSearchResult.Create(AResult: TdxRunInfo;
  AMatchInfo: TdxBufferedRegexSearchResult);
begin
...
constructor TdxTextSearchStateBase.Create(ASearchProvider
  : TdxTextSearchProvider);
begin
  inherited Create;
...
function TdxTextSearchStateBase.FindNext(AStartPosition: TdxDocumentLogPosition)
  : TdxSearchResult;
begin
...
function TdxTextSearchStateBase.DoSearch(AStart, AEnd: TdxDocumentLogPosition)
  : TdxSearchResult;
begin
  Result := SearchProvider.FindRunInfo(AStart, AEnd);
end;

function TdxTextSearchStateBase.CanSearch(AStartPosition
  : TdxDocumentLogPosition): Boolean;
begin
  Result := SearchContext.StartOfIntervalSearch or
    CanSearchFromPosition(AStartPosition);
end;
...
function TdxFindStartState.FindNext(AStartPosition: TdxDocumentLogPosition)
  : TdxSearchResult;
begin
...
function TdxFindStartState.DoSearch(AStartPosition: TdxDocumentLogPosition)
  : TdxSearchResult;
begin
  TdxRichEditExceptions.ThrowInternalException;
  Result := nil;
...
function TdxFindStartState.CanSearchFromPosition(AStartPosition
  : TdxDocumentLogPosition): Boolean;
begin
  Result := True;
end;
...
function TdxFindInSelectionForwardState.DoSearch(AStartPosition
  : TdxDocumentLogPosition): TdxSearchResult;
begin
...
function TdxFindInSelectionForwardState.CanSearchFromPosition
  (AStartPosition: TdxDocumentLogPosition): Boolean;
begin
...
function TdxFindAfterCaretForwardState.DoSearch(AStartPosition
  : TdxDocumentLogPosition): TdxSearchResult;
begin
  if SearchContext.StartOfIntervalSearch then
    Result := DoSearch(SearchContext.EndSelection,
      PieceTable.DocumentEndLogPosition)
  else
    Result := DoSearch(AStartPosition, PieceTable.DocumentEndLogPosition);
end;

function TdxFindAfterCaretForwardState.CanSearchFromPosition(AStartPosition
  : TdxDocumentLogPosition): Boolean;
begin
...
function TdxFindBeforeCaretForwardState.DoSearch(AStartPosition
  : TdxDocumentLogPosition): TdxSearchResult;
var
  AEndPosition: TdxDocumentLogPosition;
begin
  AEndPosition := Min(SearchContext.EndSelection + SearchLimitOffset,
    PieceTable.DocumentEndLogPosition);
  if SearchContext.StartOfIntervalSearch then
...
function TdxFindBeforeCaretForwardState.CanSearchFromPosition
  (AStartPosition: TdxDocumentLogPosition): Boolean;
begin
  Result := AStartPosition < SearchContext.EndSelection;
end;
...
function TdxFindAfterSelectionForwardState.DoSearch(AStartPosition
  : TdxDocumentLogPosition): TdxSearchResult;
var
...
begin
  if SearchContext.StartOfIntervalSearch then
  begin
    AStartPos := Max(PieceTable.DocumentStartLogPosition,
      SearchContext.EndSelection - SearchLimitOffset);
...
function TdxFindAfterSelectionForwardState.CanSearchFromPosition
  (AStartPosition: TdxDocumentLogPosition): Boolean;
begin
  Result := AStartPosition <= PieceTable.DocumentEndLogPosition;
end;
...
function TdxFindBeforeSelectionForwardState.DoSearch(AStartPosition
  : TdxDocumentLogPosition): TdxSearchResult;
var
  AEndPosition: TdxDocumentLogPosition;
begin
  AEndPosition := Min(SearchContext.StartSelection + SearchLimitOffset,
    PieceTable.DocumentEndLogPosition);
  if SearchContext.StartOfIntervalSearch then
    Result := DoSearch(PieceTable.DocumentStartLogPosition, AEndPosition)
  else
...
function TdxFindBeforeSelectionForwardState.CanSearchFromPosition
  (AStartPosition: TdxDocumentLogPosition): Boolean;
begin
...
function TdxFindFinishState.DoSearch(AStartPosition: TdxDocumentLogPosition)
  : TdxSearchResult;
begin
  TdxRichEditExceptions.ThrowInternalException;
  Result := nil;
...
function TdxFindFinishState.CanSearchFromPosition(AStartPosition
  : TdxDocumentLogPosition): Boolean;
begin
  TdxRichEditExceptions.ThrowInternalException;
  Result := False;
...
function TdxFindInSelectionBackwardState.DoSearch(AStartPosition
  : TdxDocumentLogPosition): TdxSearchResult;
begin
  if SearchContext.StartOfIntervalSearch then
    Result := DoSearch(SearchContext.StartSelection, SearchContext.EndSelection)
...
function TdxFindInSelectionBackwardState.CanSearchFromPosition
  (AStartPosition: TdxDocumentLogPosition): Boolean;
begin
  Result := AStartPosition > SearchContext.StartSelection;
end;
...
function TdxFindAfterCaretBackwardState.DoSearch(AStartPosition
  : TdxDocumentLogPosition): TdxSearchResult;
begin
  if SearchContext.StartOfIntervalSearch then
    Result := DoSearch(PieceTable.DocumentStartLogPosition,
      SearchContext.StartSelection)
  else
    Result := DoSearch(PieceTable.DocumentStartLogPosition, AStartPosition);
end;

function TdxFindAfterCaretBackwardState.CanSearchFromPosition
  (AStartPosition: TdxDocumentLogPosition): Boolean;
begin
...
function TdxFindBeforeCaretBackwardState.DoSearch(AEndPosition
  : TdxDocumentLogPosition): TdxSearchResult;
var
  AStartPos: TdxDocumentLogPosition;
begin
  AStartPos := Max(SearchContext.StartSelection - SearchLimitOffset,
...
function TdxFindBeforeCaretBackwardState.CanSearchFromPosition
  (AStartPosition: TdxDocumentLogPosition): Boolean;
begin
  Result := AStartPosition >= SearchContext.StartSelection;
end;
...
function TdxFindAfterSelectionBackwardState.DoSearch(AStartPosition
  : TdxDocumentLogPosition): TdxSearchResult;
var
...
begin
  if SearchContext.StartOfIntervalSearch then
  begin
    AEndPos := Min(SearchContext.StartSelection + SearchLimitOffset,
      PieceTable.DocumentEndLogPosition);
...
function TdxFindAfterSelectionBackwardState.CanSearchFromPosition
  (AStartPosition: TdxDocumentLogPosition): Boolean;
begin
  Result := AStartPosition >= PieceTable.DocumentStartLogPosition;
end;
...
function TdxFindBeforeSelectionBackwardState.DoSearch(AStartPosition
  : TdxDocumentLogPosition): TdxSearchResult;
var
  AStartPos: TdxDocumentLogPosition;
begin
...
function TdxFindBeforeSelectionBackwardState.CanSearchFromPosition
  (AStartPosition: TdxDocumentLogPosition): Boolean;
begin
  Result := AStartPosition >= SearchContext.EndSelection;
end;
...
constructor TdxTextSearchProvider.Create(APieceTable: TdxPieceTable;
  AParameters: TdxSearchParameters; AContext: TdxSearchContext);
begin
  inherited Create;
...
class function TdxTextSearchProvider.CreateBackwardProvider
  (APieceTable: TdxPieceTable; AParameters: TdxSearchParameters;
  AContext: TdxSearchContext): TdxTextSearchProvider;
begin
  Result := TdxTextSearchBackwardProvider.Create(APieceTable, AParameters,
    AContext);
end;

class function TdxTextSearchProvider.CreateForwardProvider
  (APieceTable: TdxPieceTable; AParameters: TdxSearchParameters;
  AContext: TdxSearchContext): TdxTextSearchProvider;
begin
  Result := TdxTextSearchForwardProvider.Create(APieceTable, AParameters,
    AContext);
end;
...
function TdxTextSearchProvider.FindRunInfo(AStart, AEnd: TdxDocumentLogPosition)
  : TdxSearchResult;
var
...
begin
  ...
  try
    Result := ASearchStrategy.Match(Parameters.SearchString,
      Parameters.SearchOptions, AStart, AEnd);
  finally
...
function TdxTextSearchForwardProvider.GetStartAtPosition(ARunInfo: TdxRunInfo)
...
begin
  ...
  begin
    if Parameters.UseRegularExpression and (Context.MatchInfo <> nil) then
      AOffset := Length(Context.MatchInfo.Match.Result
...
function TdxTextSearchForwardProvider.GetNextVisiblePosition(const APosition
...
function TdxTextSearchForwardProvider.GetNextVisiblePosition
  (APosition: TdxDocumentLogPosition): TdxDocumentLogPosition;
var
...
begin
  ...
  AModelPosition := TdxPositionConverter.ToDocumentModelPosition(PieceTable,
    ANextPosition);
  if PieceTable.VisibleTextFilter.IsRunVisible(AModelPosition.RunIndex) then
    Result := ANextPosition
  else
    Result := PieceTable.VisibleTextFilter.GetNextVisibleLogPosition
      (AModelPosition, False);
end;
...
function TdxTextSearchBackwardProvider.GetStartAtPosition(ARunInfo: TdxRunInfo)
  : TdxDocumentLogPosition;
begin
  if Context.Action = TdxSearchAction.Find then
  begin
...
function TdxTextSearchBackwardProvider.GetPrevVisiblePosition(const APosition
  : TdxDocumentModelPosition): TdxDocumentLogPosition;
begin
...
begin
  ...
  if PieceTable.VisibleTextFilter.IsRunVisible(AModelPosition.RunIndex) then
    ...
    Result := PieceTable.VisibleTextFilter.GetPrevVisibleLogPosition
      (AModelPosition, True);
end;
...
function TdxDocumentCharacterIterator.GetCurrentPosition
  : TdxDocumentModelPosition;
begin
...
procedure TdxDocumentCharacterIterator.SetInterval(AStart,
...
procedure TdxDocumentCharacterIterator.SetCurrentPosition
...
function TdxDocumentCharacterIterator.GetCharacter(AOffset: Integer;
  out APos: TdxDocumentLogPosition): Char;
var
  ACharPosition: TdxDocumentModelPosition;
begin
  ACharPosition := GetModelPosition(AOffset);
...
function TdxDocumentCharacterIterator.GetModelPosition(AOffset: Integer)
  : TdxDocumentModelPosition;
begin
  Result := GetModelPosition(CurrentPosition, AOffset);
end;

function TdxDocumentCharacterIterator.GetModelPosition
  (const APos: TdxDocumentModelPosition; AOffset: Integer)
  : TdxDocumentModelPosition;
begin
  Result := APos;
...
function TdxDocumentCharacterIterator.GetCharacterByPosition
  (const APos: TdxDocumentModelPosition): Char;
var
  ARunText: string;
  AOffset: Integer;
begin
  ARunText := PieceTable.Runs[APos.RunIndex].GetNonEmptyText
...
function TdxDocumentCharacterIterator.IsVisible
...
begin
  ...
  begin
    ...
    FIsCachedRunVisible := FPieceTable.VisibleTextFilter.IsRunVisible
      (ARunIndex);
  end;
...
procedure TdxDocumentCharacterIterator.ShiftModelPosition
  (var APos: TdxDocumentModelPosition; AOffset: Integer);
var
  ACount, I: Integer;
begin
  ACount := Abs(AOffset);
...
begin
  CurrentPosition := TdxPositionConverter.ToDocumentModelPosition(PieceTable,
    StartPosition);
end;

function TdxDocumentCharacterIteratorForward.CanMoveOnOffset
  (AOffset: Integer): Boolean;
begin
  Result := (CurrentPosition.LogPosition + AOffset) <= EndPosition;
end;

procedure TdxDocumentCharacterIteratorForward.MoveToVisiblePosition
...
constructor TdxBMTextSearchBase.Create(APieceTable: TdxPieceTable;
  const APattern: string; ACaseSensitive: Boolean);
begin
  inherited Create;
  Assert(Assigned(APieceTable), 'pieceTable');
  FPieceTable := APieceTable;
...
function TdxBMTextSearchBase.GetCharacter
  (AIterator: TdxDocumentCharacterIterator; AOffset: Integer): Char;
begin
  Result := AIterator.GetCharacter(AOffset);
  if not CaseSensitive then
    Result := {$IFDEF DELPHIXE4}Result.ToLower{$ELSE}TCharacter.ToLower
      (Result){$ENDIF};
end;

function TdxBMTextSearchBase.CreateUnicodeAlphabetTable(AInitialValue: Integer)
  : TArray<Integer>;
var
  I: Integer;
begin
...
procedure TdxBMTextSearchBase.PopulateBadCharacterShiftTable(const APattern
  : string; const ATable: TArray<Integer>);
var
...
begin
  ...
  begin
    PopulateBadCharacterShiftTable
      ({$IFDEF DELPHIXE4}Pattern.ToLower{$ELSE}TCharacter.ToLower
      (Pattern){$ENDIF}, Result);
    PopulateBadCharacterShiftTable
      ({$IFDEF DELPHIXE4}Pattern.ToUpper{$ELSE}TCharacter.ToUpper
      (Pattern){$ENDIF}, Result);
  end;
end;

function TdxBMTextSearchBase.CreateSuffixTable(const APattern: string)
  : TArray<Integer>;
var
...
begin
  ...
  if not CaseSensitive then
    ALPattern :=
    {$IFDEF DELPHIXE4}APattern.ToLower{$ELSE}TCharacter.ToLower
      (APattern){$ENDIF}
  else
    ALPattern := APattern;
  ...
  begin
    ...
    begin
      ...
      F := I;
      while (G >= 0) and
        (ALPattern[G + 1] = ALPattern[G + APatternLength - 1 - F + 1]) do
        Dec(G);
      Result[I] := F - G;
    end;
  end;
...
function TdxBMTextSearchForward.Search(const AStart,
  AEnd: TdxDocumentLogPosition): TdxNullableValue<TdxDocumentModelPosition>;
var
...
begin
  ...
  try
    ...
    begin
      ...
      while (AOffset >= 0) and AIterator.Compare(AOffset, Pattern[AOffset + 1],
        not CaseSensitive) do
      begin
        Dec(AOffset);
      ...
      begin
        ...
        ATurboShift := U - V;
        ABadCharShift := BadCharacterShiftTable[Integer(AIterator[AOffset])] -
          APatternLength + 1 + AOffset;
...
function TdxBMTextSearchBackward.Search(const AStart,
  AEnd: TdxDocumentLogPosition): TdxNullableValue<TdxDocumentModelPosition>;
var
  APosition: TdxDocumentModelPosition;
  AIterator: TdxBufferedDocumentCharacterIterator;
...
function TdxSearchIntervalCalculatorForward.CalculateStartPosition(const AStart,
  AEnd: TdxDocumentLogPosition; APrevResult: TdxSearchResult)
  : TdxDocumentLogPosition;
begin
  if APrevResult <> nil then
    Result := TdxDocumentModelPosition.MoveForward(APrevResult.Value.Start)
      .LogPosition
  else
    Result := AStart;
end;

function TdxSearchIntervalCalculatorForward.CalculateEndPosition(const AStart,
  AEnd: TdxDocumentLogPosition; APrevResult: TdxSearchResult)
  : TdxDocumentLogPosition;
begin
  Result := AEnd;
...
function TdxSearchIntervalCalculatorBackward.CalculateStartPosition
  (const AStart, AEnd: TdxDocumentLogPosition; APrevResult: TdxSearchResult)
  : TdxDocumentLogPosition;
begin
  Result := AStart;
end;

function TdxSearchIntervalCalculatorBackward.CalculateEndPosition(const AStart,
  AEnd: TdxDocumentLogPosition; APrevResult: TdxSearchResult)
  : TdxDocumentLogPosition;
begin
  if APrevResult <> nil then
    Result := TdxDocumentModelPosition.MoveBackward(APrevResult.Value.&End)
      .LogPosition
  else
    Result := AEnd;
end;
...
constructor TdxSearchConditions.Create(const AInput: string;
  AStartIndex: Integer; ALength: Integer);
begin
  Create(AInput);
...
constructor TdxBufferedRegexSearchBase.Create(APieceTable: TdxPieceTable;
  const ARegEx: TRegex; ABufferSize, ABufferShiftSize: Integer);
begin
  inherited Create;
  FPieceTable := APieceTable;
  FRegex := ARegEx;
...
begin
  Create(APieceTable, ARegEx, 2 * AMaxGuaranteedSearchResultLength,
...
function TdxBufferedRegexSearchBase.Match(AStart, AEnd: TdxDocumentLogPosition)
  : TdxBufferedRegexSearchResult;
var
  APosition: TdxDocumentModelPosition;
  AIterator: TdxBufferedDocumentCharacterIterator;
  ...
  try
    ...
    begin
      ...
      if FBuffer.Length = 0 then
        Break;
      AConditions := TdxSearchConditions.Create(Buffer.ToString, 0,
        Buffer.Length);
...
procedure TdxBufferedRegexSearchBase.Initialize(AStart,
  AEnd: TdxDocumentLogPosition;
  const ACurrentPosition: TdxDocumentModelPosition);
begin
...
procedure TdxBufferedRegexSearchBase.InitializeSearchInterval(AStart,
  AEnd: TdxDocumentLogPosition);
var
...
begin
  ...
  begin
    APrevVisiblePosition := PieceTable.VisibleTextFilter.
      GetPrevVisibleLogPosition(AStart, True);
    FStartPosition := Max(PieceTable.DocumentStartLogPosition,
      APrevVisiblePosition);
  ...
  begin
    ANextVisiblePosition := PieceTable.VisibleTextFilter.
      GetNextVisibleLogPosition(AEnd, True);
    FEndPosition := Min(PieceTable.DocumentEndLogPosition,
      ANextVisiblePosition);
...
function TdxBufferedRegexSearchBase.CreateResult(const AMatch: TMatch)
  : TdxBufferedRegexSearchResult;
begin
  Result := TdxBufferedRegexSearchResult.Create(FRegex, AMatch,
    BufferStartPosition);
end;

function TdxBufferedRegexSearchBase.Matches(AStart,
  AEnd: TdxDocumentLogPosition): TdxBufferedRegexSearchResultCollection;
var
  APosition: TdxDocumentModelPosition;
  AIterator: TdxBufferedDocumentCharacterIterator;
...
function TdxBufferedRegexSearchBase.ProcessBuffer
  (AIterator: TdxBufferedDocumentCharacterIterator; const ARegEx: TRegex;
...
begin
  ...
  begin
    ...
    if AResults.Count > 0 then
      ...
      ALastResult := nil;
    if (ALastResult = nil) or (AAbsolutePosition > ALastResult.AbsolutePosition)
    then
    begin
...
function TdxBufferedRegexSearchBase.CreateResult
  (AResults: TdxBufferedRegexSearchResultCollection)
  : TdxBufferedRegexSearchResultCollection;
var
  ACount, I: Integer;
...
procedure TdxBufferedRegexSearchBase.ShiftBuffer
  (AIterator: TdxBufferedDocumentCharacterIterator; ADelta: Integer);
var
  AShiftSize: Integer;
begin
...
function TdxBufferedRegexSearchBase.IsMatchGreatTheEndOfBuffer
  (const AMatch: TMatch): Boolean;
begin
  Result := AMatch.Index + AMatch.Length > Buffer.Length;
end;

function TdxBufferedRegexSearchBase.IsMatchInTheEndOfBuffer
  (const AMatch: TMatch): Boolean;
begin
  Result := AMatch.Index + AMatch.Length = Buffer.Length;
end;

function TdxBufferedRegexSearchBase.IsMatchInTheStartOfBuffer
  (const AMatch: TMatch): Boolean;
begin
  Result := AMatch.Index = 0;
end;

function TdxBufferedRegexSearchBase.ShouldRecalcMatchAtStartOfBuffer
  (var AConditions: TdxSearchConditions): Boolean;
begin
...
function TdxBufferedRegexSearchBase.ShouldRecalcMatchAtEndOfBuffer
  (var AConditions: TdxSearchConditions): Boolean;
begin
...
function TdxBufferedRegexSearchForward.CalculateMatchCore(const ARegEx: TRegex;
  const AConditions: TdxSearchConditions): TMatch;
var
  AInput: string;
begin
  AInput := TdxStringHelper.Substring(AConditions.Input, 0,
    AConditions.StartIndex + AConditions.Length);
  Result := ARegEx.Match(AInput, AConditions.StartIndex + 1);
end;

procedure TdxBufferedRegexSearchForward.CalculateSearchConditions
  (const APrevMatch: TMatch; var AConditions: TdxSearchConditions);
var
  ANewIndex: Integer;
begin
  ANewIndex := APrevMatch.Index + IfThen(APrevMatch.Length > 0,
    APrevMatch.Length, 1);
  AConditions.Length := AConditions.Length -
    (ANewIndex - AConditions.StartIndex);
  AConditions.StartIndex := ANewIndex;
end;

procedure TdxBufferedRegexSearchForward.AppendBuffer
  (AIterator: TdxBufferedDocumentCharacterIterator);
var
...
procedure TdxBufferedRegexSearchForward.ShiftBuffer
  (AIterator: TdxBufferedDocumentCharacterIterator; ADelta: Integer);
var
...
function TdxBufferedRegexSearchForward.CalculateMatch
  (AIterator: TdxBufferedDocumentCharacterIterator; const ARegEx: TRegex;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        else if ShouldRecalcMatchAtStartOfBuffer(AConditions) then
          Continue;
      end;
      ...
      begin
        if CanMoveNext then
          Exit(Default (TMatch))
        else if ShouldRecalcMatchAtEndOfBuffer(AConditions) then
          Continue;
      end
      else if IsMatchGreatTheEndOfBuffer(AResult) then
        Exit(Default (TMatch));
      Exit(AResult);
    end
    else
...
function TdxBufferedRegexSearchForward.GetMatchAbsolutePosition
  (const AMatch: TMatch): Integer;
begin
  Result := AMatch.Index + BufferOffset;
end;

function TdxBufferedRegexSearchForward.CreateIterator(const APosition
  : TdxDocumentModelPosition): TdxBufferedDocumentCharacterIterator;
begin
  Result := TdxBufferedDocumentCharacterIteratorForward.Create(APosition);
end;

function TdxBufferedRegexSearchForward.CalculateStartPosition
  : TdxDocumentModelPosition;
begin
  Result := TdxPositionConverter.ToDocumentModelPosition(PieceTable,
    StartPosition);
end;
...
function TdxBufferedRegexSearchForward.CalculateBufferShiftSize
  (AResult: TdxBufferedRegexSearchResult): Integer;
begin
...
procedure TdxBufferedRegexSearchBackward.CalculateSearchConditions
  (const APrevMatch: TMatch; var AConditions: TdxSearchConditions);
begin
  AConditions.Length := APrevMatch.Index - AConditions.StartIndex;
end;

procedure TdxBufferedRegexSearchBackward.AppendBuffer
  (AIterator: TdxBufferedDocumentCharacterIterator);
var
...
function TdxBufferedRegexSearchBackward.CalculateMatch
  (AIterator: TdxBufferedDocumentCharacterIterator; const ARegEx: TRegex;
  var AConditions: TdxSearchConditions): TMatch;
var
  AResult: TMatch;
...
var
  AMatch: TMatch;
begin
  Result := ARegEx.Match(AConditions.Input, AConditions.StartIndex + 1,
...
function TdxBufferedRegexSearchBackward.GetMatchAbsolutePosition
  (const AMatch: TMatch): Integer;
begin
  Result := (BufferOffset + Buffer.Length) - AMatch.Index;
end;

function TdxBufferedRegexSearchBackward.CreateIterator(const APosition
  : TdxDocumentModelPosition): TdxBufferedDocumentCharacterIterator;
begin
  Result := TdxBufferedDocumentCharacterIteratorBackward.Create(APosition);
end;

function TdxBufferedRegexSearchBackward.CalculateStartPosition
  : TdxDocumentModelPosition;
begin
  Result := TdxPositionConverter.ToDocumentModelPosition(PieceTable,
    EndPosition);
...
function TdxBufferedRegexSearchBackward.CalculateBufferShiftSize
  (AResult: TdxBufferedRegexSearchResult): Integer;
begin
...
function TdxTextSearchStrategyBase<T>.Match(const APattern: string;
  AOptions: TdxSearchOptions; const AStart, AEnd: TdxDocumentLogPosition)
  : TdxSearchResult;
var
  AWholeWord: Boolean;
  ASearcher: T;
...
begin
  ...
  try
    while True do
    begin
      AResult := MatchCore(ASearcher, ACalculator.CalculateStartPosition(AStart,
        AEnd, Result), ACalculator.CalculateEndPosition(AStart, AEnd, Result));
      if Result <> nil then
      begin
        Result.Clear;
        Result.Free;
      ...
      Result := AResult;
      if (not Result.Success) or (not AWholeWord) or (IsWordWhole(Result.Value))
      then
        Break;
    end;
  finally
...
function TdxTextSearchStrategyBase<T>.PreparePattern(const APattern
  : string): string;
begin
  Result := StringReplace(APattern, #10#13, #13, [rfReplaceAll]);
end;

function TdxTextSearchStrategyBase<T>.IsWordWhole(ARunInfo: TdxRunInfo)
  : Boolean;
var
...
begin
  ...
  if (APrevChar <> #0) and
  {$IFDEF DELPHIXE4}APrevChar.IsLetterOrDigit{$ELSE}TCharacter.IsLetterOrDigit
    (APrevChar){$ENDIF} then
    Exit(False);

  ANextChar := GetNextCharacter(ARunInfo.&End);
  if (ANextChar <> #0) and
  {$IFDEF DELPHIXE4}ANextChar.IsLetterOrDigit{$ELSE}TCharacter.IsLetterOrDigit
    (ANextChar){$ENDIF} then
    Result := False
  else
    Result := True;
end;

function TdxTextSearchStrategyBase<T>.GetPrevCharacter
  (const AStart: TdxDocumentModelPosition): Char;
var
  ARunIndex: TdxRunIndex;
  ARunText: string;
begin
  ...
  if AStart.RunOffset > 0 then
    Exit(PieceTable.Runs[AStart.RunIndex].GetNonEmptyText(PieceTable.TextBuffer)
      [AStart.RunOffset - 1 + 1]);
...
function TdxTextSearchStrategyBase<T>.GetNextCharacter
  (const AEnd: TdxDocumentModelPosition): Char;
begin
  if AEnd.LogPosition >= PieceTable.DocumentEndLogPosition then
    Result := #0
  else
    Result := PieceTable.Runs[AEnd.RunIndex].GetNonEmptyText
      (PieceTable.TextBuffer)[AEnd.RunOffset + 1];
end;

{ TdxTextSearchByStringStrategy }

function TdxTextSearchByStringStrategy.MatchCore(ASearcher: TdxBMTextSearchBase;
  const AStart, AEnd: TdxDocumentLogPosition): TdxSearchResult;
var
...
begin
  ...
  AIterator := TdxBufferedDocumentCharacterIteratorForward.Create
    (AResult.Value);
  try
...
function TdxTextSearchByStringForwardStrategy.CreateSearcher(const APattern
  : string; AOptions: TdxSearchOptions): TdxBMTextSearchBase;
var
  ACaseSensitive: Boolean;
begin
...
function TdxTextSearchByStringForwardStrategy.CreateIntervalCalculator
  : TdxSearchIntervalCalculator;
begin
...
function TdxTextSearchByStringBackwardStrategy.CreateIntervalCalculator
  : TdxSearchIntervalCalculator;
begin
  Result := TdxSearchIntervalCalculatorBackward.Create;
end;

function TdxTextSearchByStringBackwardStrategy.CreateSearcher
  (const APattern: string; AOptions: TdxSearchOptions): TdxBMTextSearchBase;
var
  ACaseSensitive: Boolean;
begin
  ACaseSensitive := TdxSearchOption.CaseSensitive in AOptions;
  Result := TdxBMTextSearchBackward.Create(PieceTable, APattern,
    ACaseSensitive);
end;

{ TdxTextSearchByRegexStrategy }

function TdxTextSearchByRegexStrategy.MatchCore
  (ASearcher: TdxBufferedRegexSearchBase;
  const AStart, AEnd: TdxDocumentLogPosition): TdxSearchResult;
var
...
begin
  ...
  try
    ...
    ARunInfo.&End.CopyFrom(AIterator.GetPosition(ARunInfo.Start,
      AResult.Match.Length));
...
function TdxTextSearchByRegexForwardStrategy.CreateIntervalCalculator
  : TdxSearchIntervalCalculator;
begin
  Result := TdxSearchIntervalCalculatorForward.Create;
end;

function TdxTextSearchByRegexForwardStrategy.CreateSearcher(const APattern
  : string; AOptions: TdxSearchOptions): TdxBufferedRegexSearchBase;
var
  AIgnoreCase: Boolean;
...
{$IFNDEF DELPHIBERLIN}
  ARegEx.SetState([]);
{$ENDIF}
  ABufferSize := PieceTable.DocumentModel.SearchOptions.
    RegExResultMaxGuaranteedLength;
  Result := TdxBufferedRegexSearchForward.Create(PieceTable, ARegEx,
    ABufferSize);
end;

{ TdxTextSearchByRegexBackwardStrategy }

function TdxTextSearchByRegexBackwardStrategy.CreateIntervalCalculator
  : TdxSearchIntervalCalculator;
begin
  Result := TdxSearchIntervalCalculatorBackward.Create;
end;

function TdxTextSearchByRegexBackwardStrategy.CreateSearcher(const APattern
  : string; AOptions: TdxSearchOptions): TdxBufferedRegexSearchBase;
var
  AIgnoreCase: Boolean;
  ARegexOptions: TRegexOptions;
...
{$ENDIF}
  ABufferSize := PieceTable.DocumentModel.SearchOptions.
    RegExResultMaxGuaranteedLength;
  Result := TdxBufferedRegexSearchBackward.Create(PieceTable, ARegEx,
    ABufferSize);
end;
...
begin
  ...
  if FStartPosition > FEndPosition then
    Exit(False);
  AResult := FTextSearch.Match(FindText, FOptions, FStartPosition,
    FEndPosition);
  try
...
function TdxNativeSearchResultBase.CreateDocumentRange(ARangeInfo: TdxRunInfo)
...
begin
  ...
  Result := FDocument.CreateRange(APosition, ARangeInfo.&End.LogPosition -
    ARangeInfo.Start.LogPosition);
end;

class function TdxNativeSearchResultBase.CreateNativeSearchResultBackward
  (ADocument: TdxNativeSubDocument; const AFindText: string;
  ASearchOptions: TdxRichEditSearchOptions;
  const ARange: IdxRichEditDocumentRange): TdxNativeSearchResultBase;
begin
  Result := TdxNativeSearchResultBackward.Create(ADocument, AFindText,
    ASearchOptions, ARange);
end;

class function TdxNativeSearchResultBase.CreateNativeSearchResultForward
  (ADocument: TdxNativeSubDocument; const AFindText: string;
  ASearchOptions: TdxRichEditSearchOptions;
  const ARange: IdxRichEditDocumentRange): TdxNativeSearchResultBase;
begin
  Result := TdxNativeSearchResultForward.Create(ADocument, AFindText,
    ASearchOptions, ARange);
end;
...
begin
  ...
  EndPosition := Min(Range.&End.LogPosition,
    Document.PieceTable.DocumentEndLogPosition);
end;

procedure TdxNativeSearchResultForward.ChangeSearchInterval
...
procedure TdxNativeSearchResultForward.ChangeSearchIntervalAfterReplace
  (ADeltaLength: Integer);
begin
...
begin
  ...
  AInitialEnd := Min(Range.&End.LogPosition,
    Document.PieceTable.DocumentEndLogPosition);
  EndPosition := Min(EndPosition, AInitialEnd);
end;

procedure TdxNativeSearchResultBackward.ChangeSearchInterval
  (ARangeInfo: TdxRunInfo);
begin
...
procedure TdxNativeSearchResultBackward.ChangeSearchIntervalAfterReplace
  (ADeltaLength: Integer);
begin
...
function TdxNativeGroupCollection.GetItem(Index: Integer)
...
constructor TdxNativeMatch.Create(ADocument: TdxNativeSubDocument;
  APosition: TdxDocumentLogPosition; const AOffset: TdxDocumentModelPosition;
  const AMatch: TMatch);
begin
  inherited Create;
  FDocument := ADocument;
...
function TdxNativeMatch.CreateGroup(const AGroup: TGroup)
  : IdxRichEditRegexSearchGroup;
var
  APosition: TdxDocumentLogPosition;
begin
...
function TdxNativeRegexSearch.Match(const ARange: IdxRichEditDocumentRange)
  : IdxRichEditRegexSearchMatch;
var
...
begin
  ...
  try
    ...
    AEndPosition := Min(ARange.&End.LogPosition,
      Document.PieceTable.DocumentEndLogPosition);
...
function TdxNativeRegexSearch.Matches(const ARange: IdxRichEditDocumentRange)
  : TArray<IdxRichEditDocumentRange>;
var
  ARegexSearch: TdxBufferedRegexSearchForward;
  AStartPosition, AEndPosition: TdxDocumentLogPosition;
...
function TdxNativeRegexSearch.NextMatch(const AMatch
  : IdxRichEditRegexSearchMatch; const ARange: IdxRichEditDocumentRange)
  : IdxRichEditRegexSearchMatch;
var
...
function TdxNativeRegexSearch.CreateMatch(const AOffset
  : TdxDocumentModelPosition; const AMatch: TMatch)
  : IdxRichEditRegexSearchMatch;
var
  APosition: TdxDocumentLogPosition;
begin
...
begin
  Result := TdxBufferedRegexSearchForward.Create(Document.PieceTable, Regex,
    MaxGuaranteedSearchResultLength);
end;
...
constructor TdxNativeRegexSearchResult.Create(ADocument: TdxNativeSubDocument;
  const ARegEx: TRegex; const ARange: IdxRichEditDocumentRange;
  AMaxGuaranteedSearchResultLength: Integer);
begin
  inherited Create;
  FDocument := ADocument;
...
begin
  Result := TdxNativeRegexSearch.Create(ADocument, ARegEx,
    MaxGuaranteedSearchResultLength)
end;
