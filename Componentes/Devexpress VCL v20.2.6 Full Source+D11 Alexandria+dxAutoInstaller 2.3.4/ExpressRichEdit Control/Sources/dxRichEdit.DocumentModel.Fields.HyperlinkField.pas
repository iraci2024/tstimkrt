...
type
  ...
  protected
    ...
    procedure UpdateVisited(ASourcePieceTable: TdxCustomPieceTable;
      AInfo: TdxHyperlinkInfo);
    function GetHyperlinkInfo(ASourcePieceTable: TdxSimplePieceTable;
      AField: TdxField): TdxHyperlinkInfo; virtual;
  public
...
procedure TdxHyperlinkField.Initialize(APieceTable: TdxCustomPieceTable;
  AInstructions: TdxInstructionCollection);
begin
  inherited Initialize(APieceTable, AInstructions);
  FLocation := TdxHyperlinkUriHelper.ConvertFromHyperlinkUri
    (AInstructions.GetArgumentAsString(0));
...
function TdxHyperlinkField.GetCalculatedValueCore(ASourcePieceTable
...
function TdxHyperlinkField.Update(ASourcePieceTable: TdxCustomPieceTable;
  AMailMergeDataMode: TdxMailMergeDataMode; ADocumentField: TdxField)
...
begin
  ...
  if not APieceTable.DocumentModel.DocumentCapabilities.HyperlinksAllowed then
    Exit(TdxCalculatedFieldValue.Create(nil,
  ...
  Result := TdxCalculatedFieldValue.Create(nil,
    [TdxFieldResultOption.HyperlinkField]);
end;

function TdxHyperlinkField.GetAllowedUpdateFieldTypes(const AOptions
  : TdxFieldUpdateOnLoadOptions): TdxUpdateFieldOperationTypes;
begin
  Result := [TdxUpdateFieldOperationType.Normal,
    TdxUpdateFieldOperationType.Load, TdxUpdateFieldOperationType.Copy,
...
procedure TdxHyperlinkField.UpdateVisited(ASourcePieceTable
  : TdxCustomPieceTable; AInfo: TdxHyperlinkInfo);
begin
  AInfo.Visited := False;
end;

function TdxHyperlinkField.GetHyperlinkInfo(ASourcePieceTable
  : TdxSimplePieceTable; AField: TdxField): TdxHyperlinkInfo;
var
