...
type
  ...
  TdxDestinationAndXmlBasedImporter = class abstract
    (TdxDestinationBasedImporter)
  strict private
    class var FXmlCharDecodingRegex: TRegex;
  ...
  protected
    ...
    function ReadToRootElement(AReader: TdxXmlReader; const AName: string)
      : Boolean; overload; virtual;
    function ReadToRootElement(AReader: TdxXmlReader; const AName: string;
      const ANs: string): Boolean; overload; virtual;
    procedure ImportContent(AReader: TdxXmlReader); overload;
    procedure ProcessCurrentDestination(AReader: TdxXmlReader); virtual;
    procedure ImportMainDocument(AReader: TdxXmlReader; ABaseStream: TStream);
      overload; virtual;
    ...
    function GetWpEnumValueCore<T>(const AValue: string;
      ATable: TdxNamedOrdinalDictionary<T>; ADefaultValue: T): T; overload;

    property BaseStream: TStream read FBaseStream;
    property CreateEmptyDocumentOnLoadError: Boolean
      read GetCreateEmptyDocumentOnLoadError;
  public
    ...
    function GetWpSTOnOffValue(AReader: TdxXmlReader;
      const AAttributeName: string): Boolean; overload;
    function GetWpSTOnOffValue(AReader: TdxXmlReader;
      const AAttributeName: string; ADefaultValue: Boolean): Boolean; overload;

    function GetOnOffValue(AReader: TdxXmlReader; const AAttributeName: string)
      : Boolean; overload;
    function GetOnOffValue(AReader: TdxXmlReader; const AAttributeName: string;
      ADefaultValue: Boolean): Boolean; overload;
    function GetOnOffValue(const AValue: string; ADefaultValue: Boolean)
      : Boolean; overload;
    function GetWpSTOnOffNullValue(AReader: TdxXmlReader;
      const AAttributeName: string): TdxNullableValue<Boolean>;

    function GetWpSTIntegerValue(AReader: TdxXmlReader;
      const AAttributeName: string): Integer; overload;
    function GetWpSTIntegerValue(AReader: TdxXmlReader;
      const AAttributeName: string; ADefaultValue: Integer): Integer; overload;
    function GetWpSTIntegerValue(AReader: TdxXmlReader;
      const AAttributeName: string; ANumberStyles: TdxNumberStyles.TStyles;
      ADefaultValue: Integer): Integer; overload;

    function GetIntegerValue(AReader: TdxXmlReader;
      const AAttributeName: string): Integer; overload;
    function GetIntegerValue(AReader: TdxXmlReader;
      const AAttributeName: string; ADefaultValue: Integer): Integer; overload;
    function GetIntegerValueInPoints(AReader: TdxXmlReader;
      const AAttributeName: string; ADefaultValue: Integer): Integer;
    function GetIntegerValue(AReader: TdxXmlReader;
      const AAttributeName: string; ANumberStyles: TdxNumberStyles.TStyles;
      ADefaultValue: Integer): Integer; overload;
    function GetIntegerValue(const AValue: string;
      ANumberStyles: TdxNumberStyles.TStyles; ADefaultValue: Integer)
      : Integer; overload;

    function GetFloatValueInPoints(AReader: TdxXmlReader;
      const AAttributeName: string; ADefaultValue: Single): Single;
    function GetFloatValue(const AValue: string;
      ANumberStyles: TdxNumberStyles.TStyles; ADefaultValue: Single): Single;

    function GetWpSTFloatValue(AReader: TdxXmlReader;
      const AAttributeName: string; ANumberStyles: TdxNumberStyles.TStyles;
      ADefaultValue: Single; const ANs: string): Single; overload;
    function GetWpSTFloatValue(AReader: TdxXmlReader;
      const AAttributeName: string; ANumberStyles: TdxNumberStyles.TStyles;
      ADefaultValue: Single): Single; overload;
    function GetWpSTFloatValue(const AValue: string;
      ANumberStyles: TdxNumberStyles.TStyles; ADefaultValue: Single)
      : Single; overload;

    function GetWpDoubleValue(AReader: TdxXmlReader;
      const AAttributeName: string; ADefaultValue: Double): Double; virtual;

    function GetLongValue(AReader: TdxXmlReader; const AAttributeName: string)
      : Int64; overload;
    function GetLongValue(const AValue: string; ADefaultValue: Int64)
      : Int64; overload;

    function GetWpEnumValue<T>(AReader: TdxXmlReader;
      const AAttributeName: string; ATable: TDictionary<T, string>;
      ADefaultValue: T): T; overload;
    function GetWpEnumValue<T>(AReader: TdxXmlReader;
      const AAttributeName: string; ATable: TdxEnumeratedDictionary<T, string>;
      ADefaultValue: T): T; overload;
    function GetWpEnumValue<T>(AReader: TdxXmlReader;
      const AAttributeName: string; ATable: TDictionary<T, string>;
      ADefaultValue: T; const ANs: string): T; overload;
    function GetWpEnumValue<T>(AReader: TdxXmlReader;
      const AAttributeName: string; ATable: TdxNamedOrdinalDictionary<T>;
      ADefaultValue: T): T; overload;

    function GetWpEnumOnOffNullValue<T>(AReader: TdxXmlReader;
      const AAttributeName: string; ATable: TdxEnumeratedDictionary<T, string>)
      : TdxNullableValue<T>;
    function GetWpEnumOnOffNullValueCore<T>(const AValue: string;
      ATable: TdxEnumeratedDictionary<T, string>): TdxNullableValue<T>;
    function GetWpEnumValueCore<T>(const AValue: string;
      ATable: TDictionary<T, string>; ADefaultValue: T): T; overload;
    function GetWpEnumValueCore<T>(const AValue: string;
      ATable: TdxEnumeratedDictionary<T, string>; ADefaultValue: T): T;
      overload;

    procedure ImportContent(AReader: TdxXmlReader;
      AInitialDestination: TdxDestination); overload; virtual;

    function ReadAttribute(AReader: TdxXmlReader; const AAttributeName: string)
      : string; overload; virtual; abstract;
    function ReadAttribute(AReader: TdxXmlReader; const AAttributeName: string;
      const ANs: string): string; overload; virtual; abstract;
  ...
  TdxRichEditDestinationAndXmlBasedImporter = class abstract
    (TdxDestinationAndXmlBasedImporter)
  strict private
  ...
  protected
    ...
    property PieceTableInfos: TdxObjectStack<TdxImportPieceTableInfo>
      read FPieceTableInfos;
  ...
  public
    ...
    function GetWordProcessingMLValue(AValue: TdxWordProcessingMLValue): string;
      virtual; abstract;
    function LookupCharacterStyleIndex(const AStyleId: string): Integer;
      virtual; abstract;
    ...
    property DefaultCharacterStyleProcessed: Boolean
      read FDefaultCharacterStyleProcessed
      write FDefaultCharacterStyleProcessed;
    property DefaultParagraphStyleProcessed: Boolean
      read FDefaultParagraphStyleProcessed
      write FDefaultParagraphStyleProcessed;
    property DefaultTableCellStyleProcessed: Boolean
      read FDefaultTableCellStyleProcessed
      write FDefaultTableCellStyleProcessed;
    property DefaultTableStyleProcessed: Boolean
      read FDefaultTableStyleProcessed write FDefaultTableStyleProcessed;
    property DocumentModel: TdxDocumentModel read GetDocumentModel;
    property FieldInfoStack: TdxObjectStack<TdxImportFieldInfo>
      read GetFieldInfoStack;
    ...
    property WordProcessingNamespaceConst: string
      read GetWordProcessingNamespaceConst;
  end;
  ...
  protected
    ...
    function ProcessCurrentElement(AReader: TdxXmlReader): TdxDestination;
      virtual; abstract;
    ...
    property Importer: TdxRichEditDestinationAndXmlBasedImporter
      read GetImporter;
  public
  ...
  protected
    function ProcessCurrentElement(AReader: TdxXmlReader)
      : TdxDestination; override;
  ...
  TdxElementHandler = function(AImporter
  ...
  strict private
    class var FEmpty: TdxElementHandlerTable;
    class constructor Initialize;
  ...
  protected
    ...
    property DocumentModel: TdxDocumentModel read GetDocumentModel;
    property PieceTable: TdxPieceTable read GetPieceTable;
    property ElementHandlerTable: TdxElementHandlerTable
      read GetElementHandlerTable;
  ...
  TdxRangePermissionElementDestination = class abstract
    (TdxLeafElementDestination)
  strict private
    class var FActualGroupNames: TdxStringsDictionary;
  strict private
    class constructor Initialize;
    class destructor Finalize;
  ...
  TdxRangePermissionStartElementDestination = class
    (TdxRangePermissionElementDestination)
  protected
    procedure AssignRangePermissionPosition(ARangePermission
  ...
  TdxRangePermissionEndElementDestination = class
    (TdxRangePermissionElementDestination)
  protected
    procedure AssignRangePermissionPosition(ARangePermission
      : TdxImportRangePermissionInfo); override;
  ...
  strict private
    class var FBorderStyleTable
      : TdxEnumeratedDictionary<TdxBorderLineStyle, string>;
    class constructor Initialize;
    class destructor Finalize;
    class function CreateBorderStyleTable
      : TdxEnumeratedDictionary<TdxBorderLineStyle, string>; static;
  strict protected
    class property BorderStyleTable
      : TdxEnumeratedDictionary<TdxBorderLineStyle, string>
      read FBorderStyleTable;
  end;
...
constructor TdxDestination.Create(AImporter
  : TdxRichEditDestinationAndXmlBasedImporter);
begin
  inherited Create;
...
begin
  ...
  else if AReader.NodeType in [TdxXmlNodeType.Text,
    TdxXmlNodeType.SignificantWhitespace, TdxXmlNodeType.CDATA] then
    Exit(Importer.PeekDestination.ProcessText(AReader));
...
function TdxDestination.ShouldProcessWhitespaces(AReader: TdxXmlReader)
  : Boolean;
begin
  Result := False;
end;
...
constructor TdxTransparentDestination.Create
...
function TdxTransparentDestination.ProcessCurrentElement(AReader: TdxXmlReader)
  : TdxDestination;
begin
...
function TdxStructuredDocumentDestination.ProcessCurrentElement
...
function TdxStructuredDocumentContentDestination.ProcessCurrentElement
  (AReader: TdxXmlReader): TdxDestination;
var
  ALocalName: string;
begin
...
function TdxElementDestination.ProcessCurrentElement(AReader: TdxXmlReader)
  : TdxDestination;
var
  ALocalName: string;
...
function TdxElementDestination.IsChoiceNamespaceSupported
...
constructor TdxAlternateContentDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AParentDestination: TdxElementDestination);
begin
  inherited Create(AImporter);
...
function TdxAlternateContentDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
...
function TdxAlternateContentDestination.ProcessCurrentElement
  (AReader: TdxXmlReader): TdxDestination;
var
...
begin
  ...
  else if (ALocalName = 'Fallback') and not FHasProcessedChoice then
    Exit(FParentDestination);
...
function TdxLeafElementDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
...
class function TdxRangePermissionElementDestination.CreateActualGroupNames
...
begin
  ...
  for AKey in AKeys do
    Result.Add(TdxWordProcessingMLBaseExporter.PredefinedGroupNames
      [AKey], AKey);
end;

procedure TdxRangePermissionElementDestination.ProcessElementOpen
...
begin
  ...
  AValue := AReader.GetAttribute('edGrp',
...
function TdxRangePermissionElementDestination.GetActualGroupName
...
procedure TdxRangePermissionStartElementDestination.
  AssignRangePermissionPosition(ARangePermission: TdxImportRangePermissionInfo);
begin
...
procedure TdxRangePermissionEndElementDestination.AssignRangePermissionPosition
  (ARangePermission: TdxImportRangePermissionInfo);
begin
...
class function TdxBorderDestination.CreateBorderStyleTable
  : TdxEnumeratedDictionary<TdxBorderLineStyle, string>;
begin
  ...
  Result.Add(TdxBorderLineStyle.ThinThickThinMediumGap,
...
constructor TdxDestinationBasedImporter.Create(ADocumentModel
  : TdxCustomDocumentModel; const AOptions: IdxImporterOptions);
begin
...
procedure TdxDestinationBasedImporter.PushDestination
...
function TdxDestinationAndXmlBasedImporter.
  GetCreateEmptyDocumentOnLoadError: Boolean;
begin
  Result := True;
end;

function TdxDestinationAndXmlBasedImporter.CreateXmlReader(AStream: TStream)
  : TdxXmlReader;
var
...
function TdxDestinationAndXmlBasedImporter.CreateXmlReaderSettings
...
function TdxDestinationAndXmlBasedImporter.ReadToRootElement
  (AReader: TdxXmlReader; const AName: string): Boolean;
begin
  try
...
function TdxDestinationAndXmlBasedImporter.ReadToRootElement
  (AReader: TdxXmlReader; const AName: string; const ANs: string): Boolean;
begin
  try
...
procedure TdxDestinationAndXmlBasedImporter.ImportContent(AReader: TdxXmlReader;
  AInitialDestination: TdxDestination);
var
...
procedure TdxDestinationAndXmlBasedImporter.ImportContent
  (AReader: TdxXmlReader);
begin
  while True do
  begin
    ...
    if AReader.ReadState in [TdxXmlReadState.EndOfFile, TdxXmlReadState.Error]
    then
      Break;
...
procedure TdxDestinationAndXmlBasedImporter.ProcessCurrentDestination
  (AReader: TdxXmlReader);
begin
  DestinationStack.Peek.Process(AReader);
end;

procedure TdxDestinationAndXmlBasedImporter.ImportMainDocument
  (AReader: TdxXmlReader; ABaseStream: TStream);
var
  APosition: Integer;
  AMessage: string;
begin
  ...
  begin
    ...
    ProgressIndication.&Begin(AMessage, APosition,
      Integer(ABaseStream.Size - ABaseStream.Position), APosition);
  end
  else
...
function TdxDestinationAndXmlBasedImporter.GetWpSTOnOffValue
  (AReader: TdxXmlReader; const AAttributeName: string): Boolean;
begin
  Result := GetWpSTOnOffValue(AReader, AAttributeName, True);
end;

function TdxDestinationAndXmlBasedImporter.GetWpSTOnOffValue
  (AReader: TdxXmlReader; const AAttributeName: string;
...
function TdxDestinationAndXmlBasedImporter.GetOnOffValue(AReader: TdxXmlReader;
...
function TdxDestinationAndXmlBasedImporter.GetOnOffValue(AReader: TdxXmlReader;
  const AAttributeName: string; ADefaultValue: Boolean): Boolean;
var
  AValue: string;
begin
...
function TdxDestinationAndXmlBasedImporter.GetOnOffValue(const AValue: string;
  ADefaultValue: Boolean): Boolean;
begin
  if AValue <> '' then
...
function TdxDestinationAndXmlBasedImporter.GetWpSTOnOffNullValue
  (AReader: TdxXmlReader; const AAttributeName: string)
...
function TdxDestinationAndXmlBasedImporter.GetWpSTIntegerValue
  (AReader: TdxXmlReader; const AAttributeName: string): Integer;
begin
...
begin
  Result := GetWpSTIntegerValue(AReader, AAttributeName,
    TdxNumberStyles.Integer, ADefaultValue);
end;
...
function TdxDestinationAndXmlBasedImporter.GetIntegerValue
  (AReader: TdxXmlReader; const AAttributeName: string): Integer;
begin
...
function TdxDestinationAndXmlBasedImporter.GetIntegerValue
  ...
  ADefaultValue: Integer): Integer;
begin
  Result := GetIntegerValue(AReader, AAttributeName, TdxNumberStyles.Integer,
    ADefaultValue);
end;

function TdxDestinationAndXmlBasedImporter.GetIntegerValueInPoints
  (AReader: TdxXmlReader; const AAttributeName: string;
  ADefaultValue: Integer): Integer;
var
  AValue: string;
begin
  AValue := AReader.GetAttribute(AAttributeName);
  if AValue <> '' then
    Result := GetIntegerValue(TdxStringHelper.Replace(AValue, 'pt', ''),
      TdxNumberStyles.Integer, ADefaultValue)
  else
    Result := MinInt;
end;
...
function TdxDestinationAndXmlBasedImporter.GetIntegerValue(const AValue: string;
  ANumberStyles: TdxNumberStyles.TStyles; ADefaultValue: Integer): Integer;
var
  AResult: Integer;
  ALongResult: Int64;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if TdxNumber.TryParse(AValue, ANumberStyles +
          TdxNumberStyles.AllowDecimalPoint, AResult) then
          Exit(AResult);
        if TdxNumber.TryParse(AValue, ANumberStyles +
          TdxNumberStyles.AllowDecimalPoint, ADoubleResult) then
...
function TdxDestinationAndXmlBasedImporter.GetFloatValueInPoints
  (AReader: TdxXmlReader; const AAttributeName: string;
...
begin
  AValue := AReader.GetAttribute(AAttributeName, '');
  if AValue <> '' then
    Result := GetFloatValue(TdxStringHelper.Replace(AValue, 'pt', ''),
      TdxNumberStyles.Float, ADefaultValue)
  else
    Result := NullSingleValue;
end;

function TdxDestinationAndXmlBasedImporter.GetFloatValue(const AValue: string;
  ANumberStyles: TdxNumberStyles.TStyles; ADefaultValue: Single): Single;
begin
  if AValue <> '' then
  begin
...
function TdxDestinationAndXmlBasedImporter.GetWpSTFloatValue
  (AReader: TdxXmlReader; const AAttributeName: string;
  ANumberStyles: TdxNumberStyles.TStyles; ADefaultValue: Single;
  const ANs: string): Single;
var
  AValue: string;
begin
...
function TdxDestinationAndXmlBasedImporter.GetWpSTFloatValue
  (const AValue: string; ANumberStyles: TdxNumberStyles.TStyles;
  ADefaultValue: Single): Single;
var
  AResult: Double;
begin
...
function TdxDestinationAndXmlBasedImporter.GetWpDoubleValue
  (AReader: TdxXmlReader; const AAttributeName: string;
...
function TdxDestinationAndXmlBasedImporter.GetLongValue(AReader: TdxXmlReader;
  const AAttributeName: string): Int64;
var
  AValue: string;
begin
  AValue := AReader.GetAttribute(AAttributeName);
...
function TdxDestinationAndXmlBasedImporter.GetLongValue(const AValue: string;
  ADefaultValue: Int64): Int64;
begin
  Result := StrToInt64Def(AValue, ADefaultValue);
end;

function TdxDestinationAndXmlBasedImporter.GetWpEnumValue<T>
  (AReader: TdxXmlReader; const AAttributeName: string;
...
function TdxDestinationAndXmlBasedImporter.GetWpEnumOnOffNullValue<T>
  (AReader: TdxXmlReader; const AAttributeName: string;
  ATable: TdxEnumeratedDictionary<T, string>): TdxNullableValue<T>;
var
  AValue: string;
...
function TdxDestinationAndXmlBasedImporter.GetWpEnumOnOffNullValueCore<T>
  (const AValue: string; ATable: TdxEnumeratedDictionary<T, string>)
  : TdxNullableValue<T>;
var
  AKey: T;
  AValueString: string;
...
function TdxDestinationAndXmlBasedImporter.GetWpEnumValueCore<T>
  (const AValue: string; ATable: TDictionary<T, string>; ADefaultValue: T): T;
var
  AKey: T;
  AValueString: string;
begin
...
function TdxDestinationAndXmlBasedImporter.GetWpEnumValue<T>
  (AReader: TdxXmlReader; const AAttributeName: string;
  ATable: TdxNamedOrdinalDictionary<T>; ADefaultValue: T): T;
var
  AValue: string;
begin
  AValue := ReadAttribute(AReader, AAttributeName);
...
function TdxDestinationAndXmlBasedImporter.GetWpEnumValueCore<T>
  (const AValue: string; ATable: TdxNamedOrdinalDictionary<T>;
  ADefaultValue: T): T;
begin
...
function TdxDestinationAndXmlBasedImporter.DecodeXmlChars
  (const AVal: string): string;
var
...
constructor TdxRichEditDestinationAndXmlBasedImporter.Create(ADocumentModel
  : TdxCustomDocumentModel; const AOptions: IdxImporterOptions);
begin
...
function TdxRichEditDestinationAndXmlBasedImporter.GetDocumentModel
  : TdxDocumentModel;
begin
  Result := TdxDocumentModel(inherited DocumentModel);
end;

function TdxRichEditDestinationAndXmlBasedImporter.GetPieceTableInfo
...
function TdxRichEditDestinationAndXmlBasedImporter.GetPosition
  : TdxImportInputPosition;
begin
  Result := PieceTableInfo.Position;
end;

function TdxRichEditDestinationAndXmlBasedImporter.GetFieldInfoStack
  : TdxObjectStack<TdxImportFieldInfo>;
begin
  Result := PieceTableInfo.FieldInfoStack;
end;

function TdxRichEditDestinationAndXmlBasedImporter.GetBookmarks
  : TdxImportBookmarkInfos;
begin
  Result := PieceTableInfo.Bookmarks;
end;

function TdxRichEditDestinationAndXmlBasedImporter.GetRangePermissions
  : TdxImportRangePermissionInfos;
begin
  Result := PieceTableInfo.RangePermissions;
end;

function TdxRichEditDestinationAndXmlBasedImporter.GetTableStack
  : TdxObjectStack<TdxTable>;
begin
  Result := PieceTableInfo.TableStack;
end;

function TdxRichEditDestinationAndXmlBasedImporter.GetIgnoreParseErrors
  : Boolean;
begin
  Result := InnerOptions.IgnoreParseErrors;
end;

function TdxRichEditDestinationAndXmlBasedImporter.GetOptions
  : TdxXmlBasedDocumentImporterOptions;
begin
  Result := TdxXmlBasedDocumentImporterOptions(inherited Options);
end;

procedure TdxRichEditDestinationAndXmlBasedImporter.
  ResetPositionCharacterProperties;
begin
  Position.CharacterFormatting.ReplaceInfo
    (DocumentModel.Cache.CharacterFormattingInfoCache.DefaultItem,
...
procedure TdxRichEditDestinationAndXmlBasedImporter.PushCurrentPieceTable
  (APieceTable: TdxSimplePieceTable);
begin
  FPieceTableInfos.Push(TdxImportPieceTableInfo.Create(APieceTable));
end;

function TdxRichEditDestinationAndXmlBasedImporter.PopCurrentPieceTable
  : TdxPieceTable;
begin
  ...
  begin
    ...
    if ABookmark.Validate(PieceTable) then
      PieceTable.CreateBookmarkCore(ABookmark.Start,
        ABookmark.&End - ABookmark.Start, ABookmark.Name);
  end;
end;
...
function TdxOpenXmlStyleInfoCollection.LookupStyleById(const AId: string)
  : TdxOpenXmlStyleInfo;
var
  I: Integer;
begin
