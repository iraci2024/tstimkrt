...
uses
  SysUtils, Classes, Graphics, Generics.Defaults, Generics.Collections,
  dxCoreGraphics,
...
type
  ...
  public
    constructor Create(const AControl: IdxRichEditControl;
      ASourceStyle: TdxParagraphStyle;
      AParagraphIndex: TdxParagraphIndex); overload;
    constructor Create(const AControl: IdxRichEditControl;
      ASourceStyle: TdxCharacterStyle;
      AParagraphIndex: TdxParagraphIndex); overload;
    ...
    property ParagraphSourceStyle: TdxParagraphStyle read FParagraphSourceStyle
      write SetParagraphSourceStyle;
    property CharacterSourceStyle: TdxCharacterStyle read FCharacterSourceStyle
      write SetCharacterSourceStyle;
    property TargetParagraphStyle: TdxParagraphStyle read FTargetParagraphStyle
      write FTargetParagraphStyle;
    property TargetCharacterStyle: TdxCharacterStyle read FTargetCharacterStyle
      write FTargetCharacterStyle;
  ...
  protected
    ...
    procedure SetActiveParagraph(ATarget: TdxPieceTable;
      ASourceParagraph: TdxParagraph);
    class procedure ApplyCharacterStyleToParagraph(AIndex: TdxParagraphIndex;
      ATarget: TdxPieceTable; AStyleIndex: Integer;
      ACStyleIndex: Integer); static;
    function GetAvailableStyleName(const ACurrentName: string): string;
    procedure ApplyStyleToParagraphs(const ARichEditControl
      : IdxRichEditControl);
  public
    constructor Create(const APreviewStyleControl: IdxRichEditControl;
      AParameters: TdxEditStyleFormControllerParameters);
    ...
    procedure CopyParagraphStyle(ATargetStyle: TdxParagraphStyle;
      AStyle: TdxParagraphStyle);
    procedure CopyCharacterStyle(ATargetStyle: TdxCharacterStyle;
    ...
    procedure ApplyParagraphStyle(AParagraph: TdxParagraph;
      AStyleIndex: Integer);
    procedure ApplyCharacterStyle(AParagraph: TdxParagraph;
      AStyleIndex: Integer);
    procedure ChangePreviewControlCurrentStyle(const ARichEditControl
      : IdxRichEditControl);
    function GetParagraphText(ASourceParagraph: TdxParagraph;
      AParagraphLength: Integer): string;
    procedure FillTempRichEdit(const ARichEditControl: IdxRichEditControl);
    function GetIntermediateMergedCharacterProperties(AStyle: TdxParagraphStyle)
      : TdxCharacterFormattingInfo; overload;
    function GetIntermediateMergedCharacterProperties(AStyle: TdxCharacterStyle)
      : TdxCharacterFormattingInfo; overload;
    function GetIntermediateMergedParagraphProperties(AStyle: TdxParagraphStyle)
    ...
    property ParagraphIndex: TdxParagraphIndex read FParagraphIndex;
    property ParagraphSourceStyle: TdxParagraphStyle
      read GetParagraphSourceStyle;
    property IntermediateParagraphStyle: TdxParagraphStyle
      read FIntermediateParagraphStyle write FIntermediateParagraphStyle;
    property CharacterSourceStyle: TdxCharacterStyle
      read GetCharacterSourceStyle;
    property IntermediateCharacterStyle: TdxCharacterStyle
      read FIntermediateCharacterStyle write FIntermediateCharacterStyle;
...
constructor TdxEditStyleFormControllerParameters.Create(const AControl
  : IdxRichEditControl; ASourceStyle: TdxParagraphStyle;
  AParagraphIndex: TdxParagraphIndex);
begin
  inherited Create(AControl);
  FParagraphSourceStyle := ASourceStyle;
  FTargetParagraphStyle := TdxParagraphStyle.Create
    (FParagraphSourceStyle.DocumentModel);
  FTargetCharacterStyle := TdxCharacterStyle.Create
    (FParagraphSourceStyle.DocumentModel, nil);
...
constructor TdxEditStyleFormControllerParameters.Create(const AControl
  : IdxRichEditControl; ASourceStyle: TdxCharacterStyle;
  AParagraphIndex: TdxParagraphIndex);
begin
  inherited Create(AControl);
  FCharacterSourceStyle := ASourceStyle;
  FTargetCharacterStyle := TdxCharacterStyle.Create
    (FCharacterSourceStyle.DocumentModel, nil);
  FTargetParagraphStyle := TdxParagraphStyle.Create
    (FCharacterSourceStyle.DocumentModel);
  FEditStyleControl := AControl;
  FParagraphIndex := AParagraphIndex;
...
procedure TdxEditStyleFormControllerParameters.SetParagraphSourceStyle
  (const AValue: TdxParagraphStyle);
begin
  FParagraphSourceStyle := AValue;
  FIsParagraphStyle := True;
end;

procedure TdxEditStyleFormControllerParameters.SetCharacterSourceStyle
  (const AValue: TdxCharacterStyle);
begin
...
constructor TdxEditStyleFormController.Create(const APreviewStyleControl
  : IdxRichEditControl; AParameters: TdxEditStyleFormControllerParameters);
begin
  inherited Create;
  ...
  if IsParagraphStyle then
    FIntermediateParagraphStyle := FIntermediateModel.ParagraphStyles.
      GetStyleByName(ParagraphSourceStyle.StyleName) as TdxParagraphStyle
  else
    FIntermediateCharacterStyle := FIntermediateModel.CharacterStyles.
      GetStyleByName(CharacterSourceStyle.StyleName) as TdxCharacterStyle;

  FIntermediateModel.DefaultCharacterProperties.CopyFrom
    (FModel.DefaultCharacterProperties.Info);
  FIntermediateModel.DefaultParagraphProperties.CopyFrom
    (FModel.DefaultParagraphProperties.Info);
end;
...
function TdxEditStyleFormController.GetCharacterProperties
...
function TdxEditStyleFormController.GetCharacterPropertyAccessor
...
function TdxEditStyleFormController.GetUnitConverter
  : TdxDocumentModelUnitConverter;
begin
  Result := Control.DocumentModel.UnitConverter;
end;

procedure TdxEditStyleFormController.CopyCharacterStyles(APreviewModel
  : TdxDocumentModel);
var
  I: Integer;
...
begin
  ...
  begin
    ...
    ATargetStyle := TdxCharacterStyle
      (APreviewModel.CharacterStyles.GetStyleByName(AStyle.StyleName));
...
procedure TdxEditStyleFormController.CopyParagraphStyles(APreviewModel
  : TdxDocumentModel);
var
  I: Integer;
...
begin
  ...
  begin
    ...
    ATargetStyle := TdxParagraphStyle
      (APreviewModel.ParagraphStyles.GetStyleByName(AStyle.StyleName));
    if ATargetStyle <> nil then
      AStyle.CopyTo(ATargetStyle)
    else
      AStyle.Copy(APreviewModel);
...
procedure TdxEditStyleFormController.CopyParagraphStyle
  (ATargetStyle: TdxParagraphStyle; AStyle: TdxParagraphStyle);
begin
  AStyle.CopyTo(ATargetStyle);
end;

procedure TdxEditStyleFormController.CopyCharacterStyle
  (ATargetStyle: TdxCharacterStyle; AStyle: TdxCharacterStyle);
begin
  AStyle.CopyTo(ATargetStyle);
end;
...
function TdxEditStyleFormController.GetParentParagraphProperties
  : TdxParagraphFormattingInfo;
var
...
begin
  ...
  begin
    AMergedParagraphProperties := IntermediateParagraphStyle.Parent.
    ...
    Result := Control.InnerControl.DocumentModel.DefaultParagraphProperties.
      Info.Info.Clone;
end;

function TdxEditStyleFormController.GetParentCharacterProperties
...
begin
  ...
  begin
    if IntermediateParagraphStyle.Parent <> nil then
    begin
      AMergedCharacterProperties := IntermediateParagraphStyle.Parent.
        GetMergedWithDefaultCharacterProperties;
      try
  ...
  begin
    ...
    begin
      AMergedCharacterProperties := IntermediateCharacterStyle.Parent.
        GetMergedWithDefaultCharacterProperties;
      try
        Exit(AMergedCharacterProperties.Info.Clone);
      finally
  ...
  Result := Control.InnerControl.DocumentModel.DefaultCharacterProperties.Info.
    Info.Clone;
end;

function TdxEditStyleFormController.FillParagraphText(ACount: Integer;
  const AId: Pointer): string;
begin
  Result := DupeString(cxGetResourceString(AId), ACount);
end;

function TdxEditStyleFormController.GetParagraphText(ASourceParagraph
  : TdxParagraph; AParagraphLength: Integer): string;
var
...
begin
  ...
  AStartPosition := TdxPositionConverter.ToDocumentModelPosition(ASource,
    ASourceParagraph.LogPosition);
  AEndPosition := TdxPositionConverter.ToDocumentModelPosition(ASource,
    ASourceParagraph.LogPosition + AParagraphLength - 1);
  Result := ASource.GetPlainText(AStartPosition, AEndPosition);
end;

procedure TdxEditStyleFormController.SetActiveParagraph(ATarget: TdxPieceTable;
  ASourceParagraph: TdxParagraph);
var
...
begin
  ...
  AActiveParagraphText := FillParagraphText(EmptyParagraphRepeatCount,
    @sdxRichEditEditStyleDialogCurrentParagraphText);
  ATarget.InsertPlainText(0, AActiveParagraphText);
end;

class procedure TdxEditStyleFormController.ApplyCharacterStyleToParagraph
  (AIndex: TdxParagraphIndex; ATarget: TdxPieceTable; AStyleIndex: Integer;
  ACStyleIndex: Integer);
var
...
function TdxEditStyleFormController.GetAvailableStyleName(const ACurrentName
  : string): string;
var
...
procedure TdxEditStyleFormController.ApplyStyleToParagraphs
...
begin
  ...
  try
    ATempParagraphStyle.StyleName := GetAvailableStyleName
      ('_TempParagraphStyle');
    ...
    ATempParagraphStyle.CharacterProperties.ForeColor :=
      TdxAlphaColors.FromArgb(191, 191, 191);
    if IsParagraphStyle then
    ...
    try
      ADefaultCharacterStyle.StyleName :=
        GetAvailableStyleName('_DefaultCharacterStyle');
...
procedure TdxEditStyleFormController.ApplyTabsProperties(const ARichEditControl
  : IdxRichEditControl);
var
...
procedure TdxEditStyleFormController.ChangePreviewControlCurrentStyle
  (const ARichEditControl: IdxRichEditControl);
var
  ATableModel: TdxDocumentModel;
  AParagraph: TdxParagraph;
begin
  ...
  try
    if IsParagraphStyle then
    begin
      ApplyParagraphStyle(AParagraph,
        ATableModel.ParagraphStyles.GetStyleIndexByName
        (IntermediateParagraphStyle.StyleName));
    ...
    begin
      ...
      ApplyCharacterStyle(AParagraph,
        ATableModel.CharacterStyles.GetStyleIndexByName
        (IntermediateCharacterStyle.StyleName));
    end;
  finally
...
procedure TdxEditStyleFormController.ApplyParagraphStyle
  (AParagraph: TdxParagraph; AStyleIndex: Integer);
begin
  AParagraph.ParagraphStyleIndex := AStyleIndex;
end;

procedure TdxEditStyleFormController.ApplyCharacterStyle
  (AParagraph: TdxParagraph; AStyleIndex: Integer);
var
...
begin
  ...
  if AParagraph.Length > 0 then
    APieceTable.ApplyCharacterStyle(AParagraph.LogPosition, AParagraph.Length,
      AStyleIndex);
end;

procedure TdxEditStyleFormController.FillTempRichEdit(const ARichEditControl
  : IdxRichEditControl);
var
...
begin
  ...
  ASecondParagraphText := #13 + FillParagraphText(FollowingParagraphRepeatCount,
  ...
  AFirstParagraphText := FillParagraphText(PreviousParagraphRepeatCount,
    @sdxRichEditEditStyleDialogPreviousParagraphText) + #13;
  ...
  try
    ADefaultParagraphStyle.StyleName :=
      GetAvailableStyleName('_DefaultParagraphStyle');
...
procedure TdxEditStyleFormController.CopyCharacterPropertiesFromMerged
...
begin
  ...
  if IsParagraphStyle then
    ACharacterProperties := GetIntermediateMergedCharacterProperties
      (IntermediateParagraphStyle)
  else
    ACharacterProperties := GetIntermediateMergedCharacterProperties
      (IntermediateCharacterStyle);
  try
    AAccessor := GetCharacterPropertyAccessor;
    try
      if ACharacterProperties.FontBold <> AMergedCharacterProperties.FontBold
      then
        AAccessor.ChangeFontBold(AMergedCharacterProperties.FontBold);
      if ACharacterProperties.FontItalic <> AMergedCharacterProperties.FontItalic
      then
        AAccessor.ChangeFontItalic(AMergedCharacterProperties.FontItalic);
      if ACharacterProperties.DoubleFontSize <> AMergedCharacterProperties.DoubleFontSize
      then
        AAccessor.ChangeDoubleFontSize
          (AMergedCharacterProperties.DoubleFontSize);
      if ACharacterProperties.ForeColor <> AMergedCharacterProperties.ForeColor
      then
        AAccessor.ChangeForeColor(AMergedCharacterProperties.ForeColor);
      if CharacterProperties.FontUnderlineType <> AMergedCharacterProperties.FontUnderlineType
      then
        AAccessor.ChangeFontUnderlineType
          (AMergedCharacterProperties.FontUnderlineType);
      if ACharacterProperties.UnderlineColor <> AMergedCharacterProperties.UnderlineColor
      then
        AAccessor.ChangeUnderlineColor
          (AMergedCharacterProperties.UnderlineColor);
      if ACharacterProperties.FontStrikeoutType <> AMergedCharacterProperties.FontStrikeoutType
      then
        AAccessor.ChangeFontStrikeoutType
          (AMergedCharacterProperties.FontStrikeoutType);
      if ACharacterProperties.UnderlineWordsOnly <> AMergedCharacterProperties.UnderlineWordsOnly
      then
...
procedure TdxEditStyleFormController.CopyParagraphPropertiesFromMerged
...
begin
  ...
  AParagraphProperties := GetIntermediateMergedParagraphProperties
    (IntermediateParagraphStyle);
  try
    AAccessor := GetParagraphPropertyAccessor;
    try
      if AParagraphProperties.Alignment <> AMergedParagraphProperties.Alignment
      then
        AAccessor.ChangeAlignment(AMergedParagraphProperties.Alignment);
      if AParagraphProperties.OutlineLevel <> AMergedParagraphProperties.OutlineLevel
      then
        AAccessor.ChangeOutlineLevel(AMergedParagraphProperties.OutlineLevel);
      if AParagraphProperties.LeftIndent <> AMergedParagraphProperties.LeftIndent
      then
        AAccessor.ChangeLeftIndent(AMergedParagraphProperties.LeftIndent);
      if AParagraphProperties.RightIndent <> AMergedParagraphProperties.RightIndent
      then
        AAccessor.ChangeRightIndent(AMergedParagraphProperties.RightIndent);
      if AParagraphProperties.FirstLineIndentType <> AMergedParagraphProperties.FirstLineIndentType
      then
        ParagraphProperties.FirstLineIndentType :=
          AMergedParagraphProperties.FirstLineIndentType;
      if AParagraphProperties.FirstLineIndent <> AMergedParagraphProperties.FirstLineIndent
      then
        AAccessor.ChangeFirstLineIndent
          (AMergedParagraphProperties.FirstLineIndent);
      if AParagraphProperties.SpacingBefore <> AMergedParagraphProperties.SpacingBefore
      then
        AAccessor.ChangeSpacingBefore(AMergedParagraphProperties.SpacingBefore);
      if AParagraphProperties.SpacingAfter <> AMergedParagraphProperties.SpacingAfter
      then
        AAccessor.ChangeSpacingAfter(AMergedParagraphProperties.SpacingAfter);
      if AParagraphProperties.LineSpacingType <> AMergedParagraphProperties.LineSpacingType
      then
        ParagraphProperties.LineSpacingType :=
          AMergedParagraphProperties.LineSpacingType;
      if AParagraphProperties.LineSpacing <> AMergedParagraphProperties.LineSpacing
      then
        AAccessor.ChangeLineSpacing(AMergedParagraphProperties.LineSpacing);
      if AParagraphProperties.BeforeAutoSpacing <> AMergedParagraphProperties.BeforeAutoSpacing
      then
        AAccessor.ChangeBeforeAutoSpacing
          (AMergedParagraphProperties.BeforeAutoSpacing);
      if AParagraphProperties.AfterAutoSpacing <> AMergedParagraphProperties.AfterAutoSpacing
      then
        AAccessor.ChangeAfterAutoSpacing
          (AMergedParagraphProperties.AfterAutoSpacing);
      if AParagraphProperties.ContextualSpacing <> AMergedParagraphProperties.ContextualSpacing
      then
        AAccessor.ChangeContextualSpacing
          (AMergedParagraphProperties.ContextualSpacing);
      if AParagraphProperties.KeepLinesTogether <> AMergedParagraphProperties.KeepLinesTogether
      then
        AAccessor.ChangeKeepLinesTogether
          (AMergedParagraphProperties.KeepLinesTogether);
      if AParagraphProperties.KeepWithNext <> AMergedParagraphProperties.KeepWithNext
      then
        AAccessor.ChangeKeepWithNext(AMergedParagraphProperties.KeepWithNext);
      if AParagraphProperties.PageBreakBefore <> AMergedParagraphProperties.PageBreakBefore
      then
        AAccessor.ChangePageBreakBefore
          (AMergedParagraphProperties.PageBreakBefore);
      if AParagraphProperties.SuppressLineNumbers <> AMergedParagraphProperties.SuppressLineNumbers
      then
        AAccessor.ChangeSuppressLineNumbers
          (AMergedParagraphProperties.SuppressLineNumbers);
      if AParagraphProperties.SuppressHyphenation <> AMergedParagraphProperties.SuppressHyphenation
      then
        AAccessor.ChangeSuppressHyphenation
          (AMergedParagraphProperties.SuppressHyphenation);
      if AParagraphProperties.WidowOrphanControl <> AMergedParagraphProperties.WidowOrphanControl
      then
        AAccessor.ChangeWidowOrphanControl
          (AMergedParagraphProperties.WidowOrphanControl);
      if AParagraphProperties.BackColor <> AMergedParagraphProperties.BackColor
      then
...
begin
  ...
  ParagraphProperties.SpacingBefore := ParagraphProperties.SpacingBefore +
    ANewValue;
  ParagraphProperties.SpacingAfter := ParagraphProperties.SpacingAfter +
    ANewValue;
end;
...
begin
  ...
  begin
    ...
    ParagraphProperties.LeftIndent := ParagraphProperties.LeftIndent -
      ANewValue;
end;
...
function TdxEditStyleFormController.GetIntermediateMergedCharacterProperties
  (AStyle: TdxParagraphStyle): TdxCharacterFormattingInfo;
var
  AMergedProperties: TdxMergedCharacterProperties;
begin
  AMergedProperties := AStyle.GetMergedCharacterProperties;
  try
    AMergedProperties.Merge((AStyle.DocumentModel as TdxDocumentModel)
...
function TdxEditStyleFormController.GetIntermediateMergedCharacterProperties
  (AStyle: TdxCharacterStyle): TdxCharacterFormattingInfo;
var
  AMergedProperties: TdxMergedCharacterProperties;
begin
  AMergedProperties := AStyle.GetMergedCharacterProperties;
...
function TdxEditStyleFormController.GetIntermediateMergedParagraphProperties
  (AStyle: TdxParagraphStyle): TdxParagraphFormattingInfo;
var
...
begin
  ...
  if IsParagraphStyle then
    Result := TdxEditStyleHelper.IsValidStyleName(AName, ParagraphSourceStyle,
      AModel.ParagraphStyles)
  else
    Result := TdxEditStyleHelper.IsValidStyleName(AName, CharacterSourceStyle,
      AModel.CharacterStyles);
end;
