...
type
  ...
  public const
    MaskUseAll = [TdxUsedParagraphFormattingOption.UseAlignment,
  ...
  private
    ...
    class function GetRootParagraphFormattingOption
      : TdxParagraphFormattingOptions; static; inline;
    class function GetEmptyParagraphFormattingOption
      : TdxParagraphFormattingOptions; static; inline;
  public
    ...
    class property RootParagraphFormattingOption: TdxParagraphFormattingOptions
      read GetRootParagraphFormattingOption;
    class property EmptyParagraphFormattingOption: TdxParagraphFormattingOptions
      read GetEmptyParagraphFormattingOption;
    ...
    function GetValue(const Index: TdxUsedParagraphFormattingOption)
      : Boolean; inline;
    procedure SetValue(const Index: TdxUsedParagraphFormattingOption;
      const Value: Boolean);
    property Value: TdxUsedParagraphFormattingOptions read FValue write FValue;
    property UseAlignment: Boolean index TdxUsedParagraphFormattingOption.
      UseAlignment read GetValue write SetValue;
    property UseLeftIndent: Boolean index TdxUsedParagraphFormattingOption.
      UseLeftIndent read GetValue write SetValue;
    property UseRightIndent: Boolean index TdxUsedParagraphFormattingOption.
      UseRightIndent read GetValue write SetValue;
    property UseSpacingBefore: Boolean index TdxUsedParagraphFormattingOption.
      UseSpacingBefore read GetValue write SetValue;
    property UseSpacingAfter: Boolean index TdxUsedParagraphFormattingOption.
      UseSpacingAfter read GetValue write SetValue;
    property UseLineSpacing: Boolean index TdxUsedParagraphFormattingOption.
      UseLineSpacing read GetValue write SetValue;
    property UseFirstLineIndent: Boolean index TdxUsedParagraphFormattingOption.
      UseFirstLineIndent read GetValue write SetValue;
    property UseSuppressHyphenation: Boolean
      index TdxUsedParagraphFormattingOption.UseSuppressHyphenation
      read GetValue write SetValue;
    property UseSuppressLineNumbers: Boolean
      index TdxUsedParagraphFormattingOption.UseSuppressLineNumbers
      read GetValue write SetValue;
    property UseContextualSpacing: Boolean
      index TdxUsedParagraphFormattingOption.UseContextualSpacing read GetValue
      write SetValue;
    property UsePageBreakBefore: Boolean index TdxUsedParagraphFormattingOption.
      UsePageBreakBefore read GetValue write SetValue;
    property UseBeforeAutoSpacing: Boolean
      index TdxUsedParagraphFormattingOption.UseBeforeAutoSpacing read GetValue
      write SetValue;
    property UseAfterAutoSpacing: Boolean
      index TdxUsedParagraphFormattingOption.UseAfterAutoSpacing read GetValue
      write SetValue;
    property UseKeepWithNext: Boolean index TdxUsedParagraphFormattingOption.
      UseKeepWithNext read GetValue write SetValue;
    property UseKeepLinesTogether: Boolean
      index TdxUsedParagraphFormattingOption.UseKeepLinesTogether read GetValue
      write SetValue;
    property UseWidowOrphanControl: Boolean
      index TdxUsedParagraphFormattingOption.UseWidowOrphanControl read GetValue
      write SetValue;
    property UseOutlineLevel: Boolean index TdxUsedParagraphFormattingOption.
      UseOutlineLevel read GetValue write SetValue;
    property UseBackColor: Boolean index TdxUsedParagraphFormattingOption.
      UseBackColor read GetValue write SetValue;
    property UseLeftBorder: Boolean index TdxUsedParagraphFormattingOption.
      UseLeftBorder read GetValue write SetValue;
    property UseRightBorder: Boolean index TdxUsedParagraphFormattingOption.
      UseRightBorder read GetValue write SetValue;
    property UseTopBorder: Boolean index TdxUsedParagraphFormattingOption.
      UseTopBorder read GetValue write SetValue;
    property UseBottomBorder: Boolean index TdxUsedParagraphFormattingOption.
      UseBottomBorder read GetValue write SetValue;
  end;
  ...
  TdxParagraphFormattingBase = class
    (TdxIndexBasedObjectB<TdxParagraphFormattingInfo,
    TdxParagraphFormattingOptions>, IdxParagraphProperties) // for internal use
  private
    ...
    procedure SetAfterAutoSpacing(const Value: Boolean);
    procedure SetAfterAutoSpacingCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: Boolean);
    procedure SetAlignment(const Value: TdxParagraphAlignment);
    procedure SetAlignmentCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: TdxParagraphAlignment);
    procedure SetBackColor(const Value: TdxAlphaColor);
    procedure SetBackColorCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: Integer);
    procedure SetBeforeAutoSpacing(const Value: Boolean);
    procedure SetBeforeAutoSpacingCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: Boolean);
    procedure SetContextualSpacing(const Value: Boolean);
    procedure SetContextualSpacingCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: Boolean);
    procedure SetFirstLineIndent(const Value: Integer);
    procedure SetFirstLineIndentCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: Integer);
    procedure SetFirstLineIndentType(const Value: TdxParagraphFirstLineIndent);
    procedure SetFirstLineIndentTypeCore(const AInfo
      : TdxParagraphFormattingInfo; const Value: TdxParagraphFirstLineIndent);
    procedure SetKeepLinesTogether(const Value: Boolean);
    procedure SetKeepLinesTogetherCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: Boolean);
    procedure SetKeepWithNext(const Value: Boolean);
    procedure SetKeepWithNextCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: Boolean);
    procedure SetLeftIndent(const Value: Integer);
    procedure SetLeftIndentCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: Integer);
    procedure SetLineSpacing(const Value: Single);
    procedure SetLineSpacingCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: Single);
    procedure SetLineSpacingType(const Value: TdxParagraphLineSpacing);
    procedure SetLineSpacingTypeCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: TdxParagraphLineSpacing);
    procedure SetOutlineLevel(const Value: Integer);
    procedure SetOutlineLevelCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: Integer);
    procedure SetPageBreakBefore(const Value: Boolean);
    procedure SetPageBreakBeforeCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: Boolean);
    procedure SetRightIndent(const Value: Integer);
    procedure SetRightIndentCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: Integer);
    procedure SetSpacingAfter(const Value: Integer);
    procedure SetSpacingAfterCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: Integer);
    procedure SetSpacingBefore(const Value: Integer);
    procedure SetSpacingBeforeCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: Integer);
    procedure SetSuppressHyphenation(const Value: Boolean);
    procedure SetSuppressHyphenationCore(const AInfo
      : TdxParagraphFormattingInfo; const Value: Boolean);
    procedure SetSuppressLineNumbers(const Value: Boolean);
    procedure SetSuppressLineNumbersCore(const AInfo
      : TdxParagraphFormattingInfo; const Value: Boolean);
    procedure SetWidowOrphanControl(const Value: Boolean);
    procedure SetWidowOrphanControlCore(const AInfo: TdxParagraphFormattingInfo;
      const Value: Boolean);
    function GetBottomBorder: TdxBorderInfo;
    function GetLeftBorder: TdxBorderInfo;
    function GetRightBorder: TdxBorderInfo;
    ...
    procedure SetBottomBorderCore(const AInfo: TdxParagraphFormattingInfo;
      const AValue: TdxBorderInfo);
    procedure SetLeftBorder(const AValue: TdxBorderInfo);
    procedure SetLeftBorderCore(const AInfo: TdxParagraphFormattingInfo;
      const AValue: TdxBorderInfo);
    procedure SetRightBorder(const AValue: TdxBorderInfo);
    procedure SetRightBorderCore(const AInfo: TdxParagraphFormattingInfo;
      const AValue: TdxBorderInfo);
    procedure SetTopBorder(const AValue: TdxBorderInfo);
    procedure SetTopBorderCore(const AInfo: TdxParagraphFormattingInfo;
      const AValue: TdxBorderInfo);
  protected
    function CloneCore: TdxParagraphFormattingBase; virtual;
    function PropertyEquals(const AOther
      : TdxIndexBasedObject<TdxParagraphFormattingInfo,
      TdxParagraphFormattingOptions>): Boolean; override;
  ...
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      ...
      const AFormattingInfo: TdxParagraphFormattingInfo;
      const AFormattingOptions: TdxParagraphFormattingOptions); reintroduce;

    procedure SetMultipleLineSpacing(ANewLineSpacing: Single);
    procedure CopyFrom(Source: TdxCloneable); overload; override;
    procedure CopyFrom(const AInfo: TdxParagraphFormattingInfo;
      const AOptions: TdxParagraphFormattingOptions); reintroduce; overload;
  ...
  TdxParagraphProperties = class
    (TdxRichEditIndexBasedObject<TdxParagraphFormattingBase>,
  ...
  private
    ...
    function SetAfterAutoSpacingCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Boolean): TdxDocumentModelChangeActions;
    procedure SetAfterAutoSpacing(const Value: Boolean);
    procedure SetAlignment(const Value: TdxParagraphAlignment);
    function SetAlignmentCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Integer): TdxDocumentModelChangeActions;
    procedure SetBackColor(const Value: TdxAlphaColor);
    function SetBackColorCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Integer): TdxDocumentModelChangeActions;
    procedure SetBeforeAutoSpacing(const Value: Boolean);
    function SetBeforeAutoSpacingCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Boolean): TdxDocumentModelChangeActions;
    procedure SetContextualSpacing(const Value: Boolean);
    function SetContextualSpacingCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Boolean): TdxDocumentModelChangeActions;
    procedure SetFirstLineIndent(const Value: Integer);
    function SetFirstLineIndentCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Integer): TdxDocumentModelChangeActions;
    procedure SetFirstLineIndentType(const Value: TdxParagraphFirstLineIndent);
    function SetFirstLineIndentTypeCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Integer): TdxDocumentModelChangeActions;
    procedure SetKeepLinesTogether(const Value: Boolean);
    function SetKeepLinesTogetherCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Boolean): TdxDocumentModelChangeActions;
    procedure SetKeepWithNext(const Value: Boolean);
    function SetKeepWithNextCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Boolean): TdxDocumentModelChangeActions;
    procedure SetLeftIndent(const Value: Integer);
    function SetLeftIndentCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Integer): TdxDocumentModelChangeActions;
    procedure SetLineSpacing(const Value: Single);
    function SetLineSpacingCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Single): TdxDocumentModelChangeActions;
    procedure SetLineSpacingType(const Value: TdxParagraphLineSpacing);
    function SetLineSpacingTypeCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Integer): TdxDocumentModelChangeActions;
    procedure SetOutlineLevel(const Value: Integer);
    function SetOutlineLevelCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Integer): TdxDocumentModelChangeActions;
    procedure SetPageBreakBefore(const Value: Boolean);
    function SetPageBreakBeforeCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Boolean): TdxDocumentModelChangeActions;
    procedure SetRightIndent(const Value: Integer);
    function SetRightIndentCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Integer): TdxDocumentModelChangeActions;
    procedure SetSpacingAfter(const Value: Integer);
    function SetSpacingAfterCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Integer): TdxDocumentModelChangeActions;
    procedure SetSpacingBefore(const Value: Integer);
    function SetSpacingBeforeCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Integer): TdxDocumentModelChangeActions;
    procedure SetSuppressHyphenation(const Value: Boolean);
    function SetSuppressHyphenationCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Boolean): TdxDocumentModelChangeActions;
    procedure SetSuppressLineNumbers(const Value: Boolean);
    function SetSuppressLineNumbersCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Boolean): TdxDocumentModelChangeActions;
    procedure SetWidowOrphanControl(const Value: Boolean);
    function SetWidowOrphanControlCore(const AInfo: TdxParagraphFormattingBase;
      const Value: Boolean): TdxDocumentModelChangeActions;
    function GetLeftBorder: TdxBorderInfo;
    procedure SetLeftBorder(const AValue: TdxBorderInfo);
  ...
  strict protected
    ...
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxParagraphFormattingBase>; override;
    procedure OnIndexChanged; override;
    function CreateIndexChangedHistoryItem
      : TdxIndexChangedHistoryItemCore; override;
    function GetObtainAffectedRangeListener: IdxObtainAffectedRangeListener;
      override;
    function SetLeftBorderCore(const AInfo: TdxParagraphFormattingBase;
      const AValue: TdxBorderInfo): TdxDocumentModelChangeActions; virtual;
    function SetRightBorderCore(const AInfo: TdxParagraphFormattingBase;
      const AValue: TdxBorderInfo): TdxDocumentModelChangeActions; virtual;
    function SetTopBorderCore(const AInfo: TdxParagraphFormattingBase;
      const AValue: TdxBorderInfo): TdxDocumentModelChangeActions; virtual;
    function SetBottomBorderCore(const AInfo: TdxParagraphFormattingBase;
      const AValue: TdxBorderInfo): TdxDocumentModelChangeActions; virtual;
  public
    constructor Create(const AOwner: IdxParagraphPropertiesContainer);
      reintroduce;
    destructor Destroy; override;

    class procedure ApplyPropertiesDiff(ATarget: TdxParagraphProperties;
      ATargetMergedInfo: TdxParagraphFormattingInfo;
      ASourceMergedInfo: TdxParagraphFormattingInfo);
    procedure CopyFrom(const AParagraphProperties
...
{$IFNDEF DELPHI17}
    ...
    procedure CopyFrom(const Source
      : TdxUndoableIndexBasedObject<TdxParagraphFormattingBase>); override;
{$ENDIF}
  ...
  TdxParagraphFormattingInfoCache = class
    (TdxUniqueItemsCache<TdxParagraphFormattingInfo>) // for internal use
  public const
    DefaultItemIndex = 0;
  protected
    class function CreateDefaultItemMSO2007(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxParagraphFormattingInfo;
    class function CreateDefaultItemMSO2003(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxParagraphFormattingInfo;

    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxParagraphFormattingInfo; override;
  end;

  { TdxParagraphFormattingCache }

  TdxParagraphFormattingCache = class
    (TdxUniqueItemsCache<TdxParagraphFormattingBase>) // for internal use
  public const
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxParagraphFormattingBase; override;
    function CreateDefaultParagraphFormattingInfo(ADocumentModel
      : TdxCustomDocumentModel): TdxParagraphFormattingInfo; virtual;
  public
  ...
  TdxMergedParagraphProperties = class
    (TdxMergedProperties<TdxParagraphFormattingInfo,
    TdxParagraphFormattingOptions>)
  public
    constructor Create(const AProperties: TdxParagraphProperties);
      reintroduce; overload;
    constructor Create(const AProperties: TdxMergedParagraphProperties);
      reintroduce; overload;
    ...
    procedure MergeCore(const AInfo: TdxParagraphFormattingInfo;
      const AOptions: TdxParagraphFormattingOptions);
  end;

  { TdxParagraphFormattingChangeActionsCalculator }

  TdxParagraphFormattingChangeType = (None, Alignment, LeftIndent, RightIndent,
    SpacingBefore, SpacingAfter, LineSpacingType, LineSpacing,
    FirstLineIndentType, FirstLineIndent, SuppressHyphenation,
    SuppressLineNumbers, ContextualSpacing, PageBreakBefore, BeforeAutoSpacing,
    AfterAutoSpacing, KeepWithNext, KeepLinesTogether, WidowOrphanControl,
    OutlineLevel, BackColor, ParagraphStyle, BatchUpdate, NumberingListIndex,
    LeftBorder, RightBorder, TopBorder, BottomBorder); // for internal use

  TdxParagraphFormattingChangeActionsCalculator = class sealed
  // for internal use
  public
    class function CalculateChangeActions(const AChange
  ...
  TdxParagraphParagraphPropertiesChangedHistoryItem = class
    (TdxIndexChangedHistoryItemCore) // for internal use
  private
    FParagraphIndex: Integer;
  public
    constructor Create(const APieceTable: TdxCustomPieceTable;
      AParagraphIndex: Integer); reintroduce;
  ...
  public
    ...
    property ParagraphPropertiesIndex: Integer read FParagraphPropertiesIndex
      write FParagraphPropertiesIndex;
    property ParagraphStyleIndex: Integer read FParagraphStyleIndex
      write FParagraphStyleIndex;
    property TableStyleParagraphPropertiesIndex: Integer
      read FTableStyleParagraphPropertiesIndex
      write FTableStyleParagraphPropertiesIndex;
    property OwnListLevelParagraphPropertiesIndex: Integer
      read FOwnListLevelParagraphPropertiesIndex
      write FOwnListLevelParagraphPropertiesIndex;
    property MergedParagraphProperties: TdxMergedParagraphProperties
      read FMergedParagraphProperties write SetMergedParagraphProperties;
  end;
...
type
  ...
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      const ADocumentModel: TdxCustomDocumentModel;
      const AFormattingInfo: TdxParagraphFormattingInfo;
      const AFormattingOptions: TdxParagraphFormattingOptions);
    destructor Destroy; override;
  end;

constructor TdxDefaultParagraphFormattingBase.Create
...
function TdxDefaultParagraphFormattingBase.CloneCore
  : TdxParagraphFormattingBase;
begin
  Result := TdxParagraphFormattingBase.Create(PieceTable, DocumentModel,
    Info, Options);
end;
...
begin
  ...
  Result := (FPackedValues = AInfo.PackedValues) and
    (LeftIndent = AInfo.LeftIndent) and (RightIndent = AInfo.RightIndent) and
    (SpacingAfter = AInfo.SpacingAfter) and
    (SpacingBefore = AInfo.SpacingBefore) and (BackColor = AInfo.BackColor) and
    (SkipCompareFirstLineIndent or (FirstLineIndent = AInfo.FirstLineIndent))
    and (SkipCompareLineSpacing or (LineSpacing = AInfo.LineSpacing)) and
...
begin
  Result := FPackedValues xor FLeftIndent xor FRightIndent xor FSpacingAfter xor
    FSpacingBefore;
  ...
  Result := Result xor Integer(FBackColor)
    xor FTopBorder.GetHashCode xor FBottomBorder.GetHashCode xor FLeftBorder.
    GetHashCode xor FRightBorder.GetHashCode;
end;
...
procedure TdxParagraphFormattingInfo.SetBooleanValue(AMask: Integer;
  AValue: Boolean);
begin
  if AValue then
...
function TdxParagraphFormattingInfo.GetFirstLineIndentType
  : TdxParagraphFirstLineIndent;
begin
  Result := TdxParagraphFirstLineIndent
    ((FPackedValues and MaskFirstLineIndentType) shr 3);
end;
...
procedure TdxParagraphFormattingInfo.SetAlignment
  (const Value: TdxParagraphAlignment);
begin
...
procedure TdxParagraphFormattingInfo.SetFirstLineIndentType
...
begin
  if Value < 0 then
    TdxRichEditExceptions.ThrowArgumentException('LineSpacing',
      FloatToStr(Value));
  FLineSpacing := Value;
end;

procedure TdxParagraphFormattingInfo.SetLineSpacingType
  (const Value: TdxParagraphLineSpacing);
begin
...
begin
  ...
  FPackedValues := FPackedValues or
    ((Integer(Value) shl 7) and MaskOutlineLevel);
end;
...
procedure TdxParagraphFormattingInfo.SetSuppressHyphenation
  (const Value: Boolean);
begin
  SetBooleanValue(MaskSuppressHyphenation, Value);
end;

procedure TdxParagraphFormattingInfo.SetSuppressLineNumbers
  (const Value: Boolean);
begin
  SetBooleanValue(MaskSuppressLineNumbers, Value);
end;

procedure TdxParagraphFormattingInfo.SetWidowOrphanControl
  (const Value: Boolean);
begin
...
procedure TdxParagraphFormattingInfo.SetBottomBorder
  (const Value: TdxBorderInfo);
begin
...
constructor TdxParagraphFormattingOptions.Create(AUsedValues
  : TdxUsedParagraphFormattingOptions);
begin
  FValue := AUsedValues;
end;

class operator TdxParagraphFormattingOptions.Equal(const A,
  B: TdxParagraphFormattingOptions): Boolean;
begin
  Result := A.FValue = B.FValue;
end;

procedure TdxParagraphFormattingOptions.CopyFrom(const Source
  : TdxParagraphFormattingOptions);
begin
...
class function TdxParagraphFormattingOptions.GetEmptyParagraphFormattingOption
  : TdxParagraphFormattingOptions;
begin
...
procedure TdxParagraphFormattingOptions.ResetUse
  (AOptions: TdxUsedParagraphFormattingOptions);
begin
  FValue := FValue - AOptions;
end;

class function TdxParagraphFormattingOptions.GetRootParagraphFormattingOption
  : TdxParagraphFormattingOptions;
begin
...
function TdxParagraphFormattingOptions.GetValue(const Index
  : TdxUsedParagraphFormattingOption): Boolean;
begin
  Result := Index in FValue;
end;

procedure TdxParagraphFormattingOptions.SetValue(const Index
  : TdxUsedParagraphFormattingOption; const Value: Boolean);
begin
  if Value then
...
constructor TdxParagraphFormattingBase.Create(APieceTable: TdxCustomPieceTable;
  const ADocumentModel: TdxCustomDocumentModel;
  const AFormattingInfo: TdxParagraphFormattingInfo;
  const AFormattingOptions: TdxParagraphFormattingOptions);
begin
...
procedure TdxParagraphFormattingBase.CopyFrom(const AInfo
  : TdxParagraphFormattingInfo; const AOptions: TdxParagraphFormattingOptions);
begin
...
function TdxParagraphFormattingBase.PropertyEquals(const AOther
  : TdxIndexBasedObject<TdxParagraphFormattingInfo,
  TdxParagraphFormattingOptions>): Boolean;
begin
  Result := (Options.Value = AOther.Options.Value) and Info.Equals(AOther.Info);
end;

procedure TdxParagraphFormattingBase.SetMultipleLineSpacing
  (ANewLineSpacing: Single);
begin
...
function TdxParagraphFormattingBase.GetFirstLineIndentType
  : TdxParagraphFirstLineIndent;
begin
...
procedure TdxParagraphFormattingBase.SetAfterAutoSpacingCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Boolean);
begin
...
begin
  if not SupportsFormatting or (Info.AfterAutoSpacing = Value) and Options.UseAfterAutoSpacing
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetAlignmentCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: TdxParagraphAlignment);
begin
  AInfo.Alignment := TdxParagraphAlignment(Value);
end;

procedure TdxParagraphFormattingBase.SetAlignment
  (const Value: TdxParagraphAlignment);
begin
  if not SupportsFormatting or (Info.Alignment = Value) and Options.UseAlignment
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetBackColorCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Integer);
begin
...
begin
  if not SupportsFormatting or (Info.BackColor = Value) and Options.UseBackColor
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetBeforeAutoSpacingCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Boolean);
begin
...
begin
  if not SupportsFormatting or (Info.BeforeAutoSpacing = Value) and Options.UseBeforeAutoSpacing
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetContextualSpacingCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Boolean);
begin
...
begin
  if not SupportsFormatting or (Info.ContextualSpacing = Value) and Options.UseContextualSpacing
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetFirstLineIndentCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Integer);
begin
...
begin
  if not SupportsFormatting or (Info.FirstLineIndent = Value) and Options.UseFirstLineIndent
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetFirstLineIndentTypeCore
  (const AInfo: TdxParagraphFormattingInfo;
  const Value: TdxParagraphFirstLineIndent);
begin
...
procedure TdxParagraphFormattingBase.SetFirstLineIndentType
  (const Value: TdxParagraphFirstLineIndent);
begin
  if not SupportsFormatting or (Info.FirstLineIndentType = Value) and Options.UseFirstLineIndent
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetKeepLinesTogetherCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Boolean);
begin
...
begin
  if not SupportsFormatting or (Info.KeepLinesTogether = Value) and Options.UseKeepLinesTogether
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetKeepWithNextCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Boolean);
begin
...
begin
  if not SupportsFormatting or (Info.KeepWithNext = Value) and Options.UseKeepWithNext
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetLeftIndentCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Integer);
begin
...
begin
  if not SupportsFormatting or (Info.LeftIndent = Value) and Options.UseLeftIndent
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetLineSpacingCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Single);
begin
...
begin
  if not SupportsFormatting or (Info.LineSpacing = Value) and Options.UseLineSpacing
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetLineSpacingTypeCore
  (const AInfo: TdxParagraphFormattingInfo;
  const Value: TdxParagraphLineSpacing);
begin
...
procedure TdxParagraphFormattingBase.SetLineSpacingType
  (const Value: TdxParagraphLineSpacing);
begin
  if not SupportsFormatting or (Info.LineSpacingType = Value) and Options.UseLineSpacing
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetOutlineLevelCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Integer);
begin
...
begin
  if not SupportsFormatting or (Info.OutlineLevel = Value) and Options.UseOutlineLevel
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetPageBreakBeforeCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Boolean);
begin
...
begin
  if not SupportsFormatting or (Info.PageBreakBefore = Value) and Options.UsePageBreakBefore
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetRightIndentCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Integer);
begin
...
begin
  if not SupportsFormatting or (Info.RightIndent = Value) and Options.UseRightIndent
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetSpacingAfterCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Integer);
begin
...
begin
  if not SupportsFormatting or (Info.SpacingAfter = Value) and Options.UseSpacingAfter
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetSpacingBeforeCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Integer);
begin
...
begin
  if not SupportsFormatting or (Info.SpacingBefore = Value) and Options.UseSpacingBefore
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetSuppressHyphenationCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Boolean);
begin
  AInfo.SuppressHyphenation := Value;
end;

procedure TdxParagraphFormattingBase.SetSuppressHyphenation
  (const Value: Boolean);
begin
  if not SupportsFormatting or (Info.SuppressHyphenation = Value) and Options.UseSuppressHyphenation
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetSuppressLineNumbersCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Boolean);
begin
  AInfo.SuppressLineNumbers := Value;
end;

procedure TdxParagraphFormattingBase.SetSuppressLineNumbers
  (const Value: Boolean);
begin
  if not SupportsFormatting or (Info.SuppressLineNumbers = Value) and Options.UseSuppressLineNumbers
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetWidowOrphanControlCore
  (const AInfo: TdxParagraphFormattingInfo; const Value: Boolean);
begin
  AInfo.WidowOrphanControl := Value;
end;

procedure TdxParagraphFormattingBase.SetWidowOrphanControl
  (const Value: Boolean);
begin
  if not SupportsFormatting or (Info.WidowOrphanControl = Value) and Options.UseWidowOrphanControl
  then
    Exit;
...
procedure TdxParagraphFormattingBase.SetLeftBorderCore
  (const AInfo: TdxParagraphFormattingInfo; const AValue: TdxBorderInfo);
begin
...
begin
  if not SupportsFormatting or
    (Options.UseLeftBorder and TdxBorderInfo.AreBordersEqual(Info.LeftBorder,
    AValue)) then
    Exit;
...
procedure TdxParagraphFormattingBase.SetRightBorderCore
  (const AInfo: TdxParagraphFormattingInfo; const AValue: TdxBorderInfo);
begin
  AInfo.RightBorder := AValue;
end;

procedure TdxParagraphFormattingBase.SetRightBorder(const AValue
  : TdxBorderInfo);
begin
  if not SupportsFormatting or
    (Options.UseRightBorder and TdxBorderInfo.AreBordersEqual(Info.RightBorder,
    AValue)) then
    Exit;
...
procedure TdxParagraphFormattingBase.SetTopBorderCore
  (const AInfo: TdxParagraphFormattingInfo; const AValue: TdxBorderInfo);
begin
...
begin
  if not SupportsFormatting or
    (Options.UseTopBorder and TdxBorderInfo.AreBordersEqual(Info.TopBorder,
    AValue)) then
    Exit;
...
procedure TdxParagraphFormattingBase.SetBottomBorderCore
  (const AInfo: TdxParagraphFormattingInfo; const AValue: TdxBorderInfo);
begin
  AInfo.BottomBorder := AValue;
end;

procedure TdxParagraphFormattingBase.SetBottomBorder(const AValue
  : TdxBorderInfo);
begin
  if not SupportsFormatting or
    (Options.UseBottomBorder and TdxBorderInfo.AreBordersEqual
    (Info.BottomBorder, AValue)) then
    Exit;
...
constructor TdxParagraphProperties.Create(const AOwner
...
function TdxParagraphProperties.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.BatchUpdate);
end;

class procedure TdxParagraphProperties.ApplyPropertiesDiff
  (ATarget: TdxParagraphProperties; ATargetMergedInfo, ASourceMergedInfo
  : TdxParagraphFormattingInfo);
begin
  ...
  if ATargetMergedInfo.FirstLineIndentType <> ASourceMergedInfo.FirstLineIndentType
  then
  ...
  if ATargetMergedInfo.SuppressHyphenation <> ASourceMergedInfo.SuppressHyphenation
  then
    ATarget.SuppressHyphenation := ASourceMergedInfo.SuppressHyphenation;

  if ATargetMergedInfo.SuppressLineNumbers <> ASourceMergedInfo.SuppressLineNumbers
  then
    ATarget.SuppressLineNumbers := ASourceMergedInfo.SuppressLineNumbers;

  if ATargetMergedInfo.ContextualSpacing <> ASourceMergedInfo.ContextualSpacing
  then
...
procedure TdxParagraphProperties.CopyFrom(const AParagraphProperties
  : TdxMergedParagraphProperties);
var
...
procedure TdxParagraphProperties.CopyFrom(const Source
  : TdxParagraphFormattingBase);
begin
...
procedure TdxParagraphProperties.CopyFrom(const Source
  : TdxUndoableIndexBasedObject<TdxParagraphFormattingBase>);
begin
  inherited CopyFrom(Source);
end;
{$ENDIF}
...
begin
  ...
  AEmptyInfo := GetCache(DocumentModel)
    [TdxParagraphFormattingCache.EmptyParagraphFormattingIndex];
...
procedure TdxParagraphProperties.ResetUse
  (AMask: TdxUsedParagraphFormattingOptions);
var
  AInfo: TdxParagraphFormattingBase;
...
function TdxParagraphProperties.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxParagraphFormattingBase>;
begin
  Result := TdxSimpleDocumentCache(ADocumentModel.Cache)
    .ParagraphFormattingCache;
end;
...
function TdxParagraphProperties.CreateIndexChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
  Result := FOwner.CreateParagraphPropertiesChangedHistoryItem;
end;

function TdxParagraphProperties.GetObtainAffectedRangeListener
...
function TdxParagraphProperties.GetFirstLineIndentType
  : TdxParagraphFirstLineIndent;
begin
  Result := Info.FirstLineIndentType;
end;
...
function TdxParagraphProperties.SetAfterAutoSpacingCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.AfterAutoSpacing := Value;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.AfterAutoSpacing);
end;
...
procedure TdxParagraphProperties.SetAlignment(const Value
...
function TdxParagraphProperties.SetAlignmentCore(const AInfo
  : TdxParagraphFormattingBase; const Value: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.Alignment := TdxParagraphAlignment(Value);
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.Alignment);
end;
...
function TdxParagraphProperties.SetBackColorCore(const AInfo
  : TdxParagraphFormattingBase; const Value: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.BackColor := Value;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.BackColor);
end;
...
begin
  AInfo.BeforeAutoSpacing := Value;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.BeforeAutoSpacing);
end;
...
function TdxParagraphProperties.SetContextualSpacingCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.ContextualSpacing := Value;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.ContextualSpacing);
end;
...
function TdxParagraphProperties.SetFirstLineIndentCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.FirstLineIndent := Value;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.FirstLineIndent);
end;

procedure TdxParagraphProperties.SetFirstLineIndentType
  (const Value: TdxParagraphFirstLineIndent);
begin
...
function TdxParagraphProperties.SetFirstLineIndentTypeCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.FirstLineIndentType := TdxParagraphFirstLineIndent(Value);
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.FirstLineIndentType);
end;
...
function TdxParagraphProperties.SetKeepLinesTogetherCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.KeepLinesTogether := Value;
...
function TdxParagraphProperties.SetKeepWithNextCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.KeepWithNext := Value;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.KeepWithNext);
end;
...
function TdxParagraphProperties.SetLeftIndentCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.LeftIndent := Value;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.LeftIndent);
end;
...
function TdxParagraphProperties.SetLineSpacingCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Single)
  : TdxDocumentModelChangeActions;
begin
  AInfo.LineSpacing := Value;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.LineSpacing);
end;

procedure TdxParagraphProperties.SetLineSpacingType
  (const Value: TdxParagraphLineSpacing);
begin
...
function TdxParagraphProperties.SetLineSpacingTypeCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.LineSpacingType := TdxParagraphLineSpacing(Value);
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.LineSpacingType);
end;
...
function TdxParagraphProperties.SetOutlineLevelCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.OutlineLevel := Value;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.OutlineLevel);
end;
...
function TdxParagraphProperties.SetPageBreakBeforeCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.PageBreakBefore := Value;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.PageBreakBefore);
end;
...
function TdxParagraphProperties.SetRightIndentCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.RightIndent := Value;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.RightIndent);
end;
...
function TdxParagraphProperties.SetSpacingAfterCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.SpacingAfter := Value;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.SpacingAfter);
end;
...
function TdxParagraphProperties.SetSpacingBeforeCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.SpacingBefore := Value;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.SpacingBefore);
end;
...
function TdxParagraphProperties.SetSuppressHyphenationCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.SuppressHyphenation := Value;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.SuppressHyphenation);
end;
...
function TdxParagraphProperties.SetSuppressLineNumbersCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.SuppressLineNumbers := Value;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.SuppressLineNumbers);
end;
...
function TdxParagraphProperties.SetWidowOrphanControlCore
  (const AInfo: TdxParagraphFormattingBase; const Value: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.WidowOrphanControl := Value;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.WidowOrphanControl);
end;

function TdxParagraphProperties.UseVal
  (AMask: TdxUsedParagraphFormattingOption): Boolean;
begin
...
function TdxParagraphProperties.SetLeftBorderCore
  (const AInfo: TdxParagraphFormattingBase; const AValue: TdxBorderInfo)
  : TdxDocumentModelChangeActions;
begin
  AInfo.LeftBorder := AValue;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.LeftBorder);
end;

procedure TdxParagraphProperties.SetLeftBorder(const AValue: TdxBorderInfo);
begin
  if UseLeftBorder and TdxBorderInfo.AreBordersEqual(Info.LeftBorder, AValue)
  then
    Exit;
...
function TdxParagraphProperties.SetRightBorderCore
  (const AInfo: TdxParagraphFormattingBase; const AValue: TdxBorderInfo)
  : TdxDocumentModelChangeActions;
begin
  AInfo.RightBorder := AValue;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.RightBorder);
end;

procedure TdxParagraphProperties.SetRightBorder(const AValue: TdxBorderInfo);
begin
  if UseRightBorder and TdxBorderInfo.AreBordersEqual(Info.RightBorder, AValue)
  then
    Exit;
...
function TdxParagraphProperties.SetTopBorderCore(const AInfo
  : TdxParagraphFormattingBase; const AValue: TdxBorderInfo)
  : TdxDocumentModelChangeActions;
begin
  AInfo.TopBorder := AValue;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.TopBorder);
end;
...
function TdxParagraphProperties.SetBottomBorderCore
  (const AInfo: TdxParagraphFormattingBase; const AValue: TdxBorderInfo)
  : TdxDocumentModelChangeActions;
begin
  AInfo.BottomBorder := AValue;
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.BottomBorder);
end;

procedure TdxParagraphProperties.SetBottomBorder(const AValue: TdxBorderInfo);
begin
  if UseBottomBorder and TdxBorderInfo.AreBordersEqual(Info.BottomBorder, AValue)
  then
    Exit;
...
function TdxParagraphFormattingInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxParagraphFormattingInfo;
begin
...
constructor TdxParagraphFormattingCache.Create(ADocumentModel
...
begin
  ...
  ADefaultParagraphFormattingInfo := TdxSimpleDocumentCache
    (ADocumentModel.Cache).ParagraphFormattingInfoCache.DefaultItem;
...
function TdxParagraphFormattingCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxParagraphFormattingBase;
begin
  Result := nil;
end;

function TdxParagraphFormattingCache.CreateDefaultParagraphFormattingInfo
  (ADocumentModel: TdxCustomDocumentModel): TdxParagraphFormattingInfo;
begin
  Result := TdxParagraphFormattingInfoCache.CreateDefaultItemMSO2007
    (ADocumentModel.UnitConverter);
end;

{ TdxCharacterFormattingChangeActionsCalculator }

class function TdxParagraphFormattingChangeActionsCalculator.
  CalculateChangeActions(const AChange: TdxParagraphFormattingChangeType)
  : TdxDocumentModelChangeActions;
const
  ParagraphFormattingChangeActionsMap: array [TdxParagraphFormattingChangeType]
...
function TdxParagraphParagraphPropertiesChangedHistoryItem.GetObject
  : TdxIndexBasedObject;
begin
  Result := TdxSimpleParagraph(PieceTable.Paragraphs[ParagraphIndex])
    .ParagraphProperties;
end;

{ TdxMergedParagraphProperties }

constructor TdxMergedParagraphProperties.Create(const AProperties
  : TdxParagraphProperties);
var
  AInfo: TdxParagraphFormattingBase;
begin
...
procedure TdxMergedParagraphProperties.Merge(const AProperties
  : TdxParagraphProperties);
var
  AInfo: TdxParagraphFormattingBase;
begin
...
procedure TdxMergedParagraphProperties.MergeCore(const AInfo
  : TdxParagraphFormattingInfo; const AOptions: TdxParagraphFormattingOptions);
begin
...
procedure TdxParagraphMergedParagraphPropertiesCachedResult.
  SetMergedParagraphProperties(Value: TdxMergedParagraphProperties);
begin
