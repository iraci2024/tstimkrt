...
type
  ...
  public
    ...
    property ShowPageNumbers: Boolean read FShowPageNumbers
      write FShowPageNumbers;
    property RightAlignPageNumbers: Boolean read FRightAlignPageNumbers
      write FRightAlignPageNumbers;
...
type
  ...
  public
    constructor Create(const AInterval: TdxDocumentLogInterval;
      const ANewContent: string); overload;
  end;
  ...
  TdxInsertFieldInfo = class abstract
    procedure Insert(APieceTable: TdxPieceTable; APos: TdxDocumentLogPosition);
      virtual; abstract;
  end;
  ...
  public
    ...
    procedure Insert(APieceTable: TdxPieceTable;
  ...
  TdxInsertStringWithDocumentModelFieldInfoBase = class abstract
    (TdxInsertFieldInfo)
  strict private
    FFieldSwitch: string;
    FArgument: TdxDocumentModel;
  protected
    procedure InsertArgument(APieceTable: TdxPieceTable;
  ...
  TdxInsertStringWithDocumentModelAsField = class
    (TdxInsertStringWithDocumentModelFieldInfoBase)
  protected
    procedure InsertArgument(APieceTable: TdxPieceTable;
      APos: TdxDocumentLogPosition); override;
  ...
  TdxInsertStringWithDocumentModel = class
    (TdxInsertStringWithDocumentModelFieldInfoBase)
  protected
    procedure InsertArgument(APieceTable: TdxPieceTable;
      APos: TdxDocumentLogPosition); override;
  ...
  public
    ...
    procedure UpdateSwitch(const AFieldSwitch: string;
      const AInfo: TdxUpdateFieldInfo);
    ...
    procedure AddSwitch(const AFieldSwitch: string;
      AArgument: TdxDocumentModel); overload;
    procedure AddSwitch(const AFieldSwitch: string; AArgument: TdxDocumentModel;
      AWrapToField: Boolean); overload;
    procedure AddArgument(AIndex: Integer; const AArgument: string); overload;
    procedure AddArgument(AIndex: Integer;
      AArgument: TdxDocumentModel); overload;
    function ContainsSwitch(const AFieldSwitch: string): Boolean;
    procedure CheckSwitch(const AFieldSwitch: string;
      const AInsertion: TdxInsertFieldInfo); overload;
    procedure CheckSwitch(const AFieldSwitch: string;
      const AUpdate: TdxUpdateFieldInfo); overload;
    procedure UndoSwitchModifications(const AFieldSwitch: string);
    procedure CheckArgument(AIndex: Integer);

    property DeferredInsertions: TdxObjectList<TdxInsertFieldInfo>
      read FDeferredInsertions;
    property DeferredUpdates: TdxObjectList<TdxUpdateFieldInfo>
      read FDeferredUpdates;
  end;
  ...
  protected
    ...
    procedure UpdateSwitch(const AFieldSwitch: string;
      const AArgument: string); overload;
    procedure UpdateSwitch(const AFieldSwitch: string;
      AArgument: TdxDocumentModel; AWrapToField: Boolean = True); overload;
  ...
  public
    constructor Create(APieceTable: TdxPieceTable;
      AParsedInfo: TdxCalculatedFieldBase; AField: TdxField);
    destructor Destroy; override;
    class function GetEscapedFieldName(const AFieldName: string)
      : string; static;
    class function GetEscapedArgument(const AArgument: string): string;
      overload; static;
    class function GetEscapedArgument(const AArgument: string;
      ATrimArgument: Boolean): string; overload; static;
    ...
    procedure SetSwitch(const AFieldSwitch: string;
      const AArgument: string); overload;
    procedure SetSwitch(const AFieldSwitch: string; const AArgument: string;
      ATrimArgument: Boolean); overload;
    procedure SetSwitch(const AFieldSwitch: string;
      AArgument: TdxDocumentModel); overload;
    procedure SetSwitch(const AFieldSwitch: string; AArgument: TdxDocumentModel;
      AWrapToField: Boolean); overload;
    function ContainsSwitch(const AFieldSwitch: string): Boolean;
    ...
    procedure SetArgument(AIndex: Integer;
      AArgument: TdxDocumentModel); overload;
    procedure UpdateArgument(AIndex: Integer; const AArgument: string);
      overload;
    procedure UpdateArgument(AIndex: Integer;
      AArgument: TdxDocumentModel); overload;
    ...
    property SuppressFieldsUpdateAfterUpdateInstruction: Boolean
      read FSuppressFieldsUpdateAfterUpdateInstruction
      write FSuppressFieldsUpdateAfterUpdateInstruction;
  end;

  { TdxTOCFormControllerParameters }

constructor TdxTOCFormControllerParameters.Create(const AControl
  : IdxRichEditControl; ATocField: TdxField);
begin
...
constructor TdxTableOfContentsFormController.Create
  (AParameters: TdxTOCFormControllerParameters);
var
...
begin
  ...
  try
    FParsedInfo := TdxTocField(AParser.ParseField(FPieceTable,
      AParameters.TocField));
  finally
    AParser.Free;
  end;
  ...
  RightAlignPageNumbers := FParsedInfo.Options.PageNumberSeparator.IsNull or
    (FParsedInfo.Options.PageNumberSeparator.Value = '');
...
begin
  AController := TdxInstructionController.Create(FPieceTable,
    FParsedInfo, FField);
  try
...
constructor TdxUpdateFieldInfoBase.Create(const AInterval
...
begin
  APieceTable.DeleteContent(FInterval.Start, FInterval.Length, False, True,
    True, True);
...
begin
  ...
  try
    ...
    if APieceTable.GetRunPlainText(AStart.RunIndex)[AStart.RunOffset] = ' ' then
      APieceTable.DeleteContent(AStart.RunStartLogPosition + AStart.RunOffset,
        1, False, True, True);
  finally
    AInfo.Free;
  end;
...
constructor TdxUpdateStringFieldInfo.Create(const AInterval
  : TdxDocumentLogInterval; const ANewContent: string);
begin
...
constructor TdxUpdateDocumentModelFieldInfo.Create(const AInterval
  : TdxDocumentLogInterval; AModel: TdxDocumentModel);
begin
  inherited Create(AInterval);
...
var
  AField: TdxField;
begin
  AField := TdxCopyHelper.CopyAndWrapToField(DocumentModel.MainPieceTable,
    APieceTable, TdxDocumentLogInterval.Create(0,
    DocumentModel.MainPieceTable.DocumentEndLogPosition -
    DocumentModel.MainPieceTable.DocumentStartLogPosition), Interval.Start);
...
begin
  TdxCopyHelper.CopyCore(DocumentModel.MainPieceTable, APieceTable,
    TdxDocumentLogInterval.Create(0,
    DocumentModel.MainPieceTable.DocumentEndLogPosition -
    DocumentModel.MainPieceTable.DocumentStartLogPosition), Interval.Start);
end;
...
function TdxUpdateFieldInfoComparer.Compare(const Left,
  Right: TdxUpdateFieldInfo): Integer;
var
...
procedure TdxInsertStringFieldInfo.Insert(APieceTable: TdxPieceTable;
...
procedure TdxInsertDocumentModelFieldInfo.Insert(APieceTable: TdxPieceTable;
  APos: TdxDocumentLogPosition);
var
  AField: TdxField;
begin
  AField := TdxCopyHelper.CopyAndWrapToField(FModel.MainPieceTable, APieceTable,
    TdxDocumentLogInterval.Create(0,
    FModel.MainPieceTable.DocumentEndLogPosition -
    FModel.MainPieceTable.DocumentStartLogPosition), APos);
  AField.DisableUpdate := True;
end;

{ TdxInsertStringWithDocumentModelFieldInfoBase }

constructor TdxInsertStringWithDocumentModelFieldInfoBase.Create
  (const AFieldSwitch: string; AArgument: TdxDocumentModel);
begin
  inherited Create;
...
procedure TdxInsertStringWithDocumentModelFieldInfoBase.Insert
  (APieceTable: TdxPieceTable; APos: TdxDocumentLogPosition);
begin
...
procedure TdxInsertStringWithDocumentModelAsField.InsertArgument
  (APieceTable: TdxPieceTable; APos: TdxDocumentLogPosition);
var
...
begin
  ...
  AField := TdxCopyHelper.CopyAndWrapToField(AArgumentPieceTable, APieceTable,
    TdxDocumentLogInterval.Create(0, AArgumentPieceTable.DocumentEndLogPosition
    - AArgumentPieceTable.DocumentStartLogPosition), APos);
  AField.DisableUpdate := True;
end;

{ TdxInsertStringWithDocumentModel }

procedure TdxInsertStringWithDocumentModel.InsertArgument
  (APieceTable: TdxPieceTable; APos: TdxDocumentLogPosition);
var
  AArgumentPieceTable: TdxPieceTable;
begin
...
procedure TdxDeferredChanges.UpdateSwitch(const AFieldSwitch: string;
  const AInfo: TdxUpdateFieldInfo);
begin
...
procedure TdxDeferredChanges.UpdateArgument(AIndex: Integer;
  const AInfo: TdxUpdateFieldInfo);
begin
...
begin
  ...
  AInsertStringFieldInfo := TdxInsertStringFieldInfo.Create
    (ASwitchWithArgument);
  CheckSwitch(AFieldSwitch, AInsertStringFieldInfo);
  DeferredInsertions.Add(AInsertStringFieldInfo);
end;

procedure TdxDeferredChanges.AddSwitch(const AFieldSwitch: string;
  AArgument: TdxDocumentModel);
begin
  AddSwitch(AFieldSwitch, AArgument, True);
end;

procedure TdxDeferredChanges.AddSwitch(const AFieldSwitch: string;
  AArgument: TdxDocumentModel; AWrapToField: Boolean);
var
  AFieldInfo: TdxInsertFieldInfo;
begin
  if AWrapToField then
    AFieldInfo := TdxInsertStringWithDocumentModelAsField.Create(AFieldSwitch,
      AArgument)
  else
    AFieldInfo := TdxInsertStringWithDocumentModel.Create(AFieldSwitch,
      AArgument);
  CheckSwitch(AFieldSwitch, AFieldInfo);
  DeferredInsertions.Add(AFieldInfo);
end;

procedure TdxDeferredChanges.AddArgument(AIndex: Integer;
...
begin
  Result := (FInsertingSwitches.ContainsKey(AFieldSwitch)) or
    (FUpdatingSwitches.ContainsKey(AFieldSwitch));
end;

procedure TdxDeferredChanges.CheckSwitch(const AFieldSwitch: string;
  const AInsertion: TdxInsertFieldInfo);
begin
...
procedure TdxDeferredChanges.CheckSwitch(const AFieldSwitch: string;
  const AUpdate: TdxUpdateFieldInfo);
begin
  UndoSwitchModifications(AFieldSwitch);
  FUpdatingSwitches.Add(AFieldSwitch, AUpdate);
end;

procedure TdxDeferredChanges.UndoSwitchModifications(const AFieldSwitch
  : string);
begin
...
constructor TdxInstructionController.Create(APieceTable: TdxPieceTable;
  AParsedInfo: TdxCalculatedFieldBase; AField: TdxField);
begin
  inherited Create;
...
begin
  ...
  DeferredChanges.UpdateFieldType(TdxUpdateStringFieldInfo.Create(AInterval,
    AFieldType));
...
var
  ASwitchInterval, AArgumentInterval, ASwitchWithArgument
    : TdxDocumentLogInterval;
begin
  ...
  AArgumentInterval := Instructions.GetSwitchArgumentDocumentInterval
    (AFieldSwitch, True);
  if AArgumentInterval.IsNull then
    ...
    ASwitchWithArgument := TdxDocumentLogInterval.Create(ASwitchInterval.Start,
      AArgumentInterval.Start + AArgumentInterval.Length -
      ASwitchInterval.Start);

  DeferredChanges.UpdateSwitch(AFieldSwitch,
    TdxUpdateStringFieldInfo.Create(ASwitchWithArgument));
end;
...
procedure TdxInstructionController.SetSwitch(const AFieldSwitch: string;
  const AArgument: string; ATrimArgument: Boolean);
begin
  FRemovingSwitches.Exclude(AFieldSwitch);
  if not Instructions.GetBool(AFieldSwitch) then
    DeferredChanges.AddSwitch(AFieldSwitch, GetEscapedArgument(AArgument,
      ATrimArgument))
  else
...
function TdxInstructionController.ContainsSwitch(const AFieldSwitch
  : string): Boolean;
begin
  Result := (Instructions.GetBool(AFieldSwitch)) or
    (DeferredChanges.ContainsSwitch(AFieldSwitch));
end;

function TdxInstructionController.IsSwitchRemoving(const AFieldSwitch
  : string): Boolean;
begin
  Result := FRemovingSwitches.Contains(AFieldSwitch);
end;

function TdxInstructionController.WillContainSwitch(const AFieldSwitch
  : string): Boolean;
begin
  Result := ContainsSwitch(AFieldSwitch) and not FRemovingSwitches.Contains
    (AFieldSwitch);
end;

procedure TdxInstructionController.UpdateSwitch(const AFieldSwitch: string;
  const AArgument: string);
var
...
begin
  ...
  if AArgumentInterval.IsNull then
    Exit;
  DeferredChanges.UpdateSwitch(AFieldSwitch,
    TdxUpdateStringFieldInfo.Create(AArgumentInterval,
    GetEscapedArgument(AArgument)));
end;
...
begin
  ...
  if AArgumentInterval.IsNull then
    Exit;
  if AWrapToField then
    AFieldInfo := TdxUpdateDocumentModelAsField.Create(AArgumentInterval,
      AArgument)
  else
...
procedure TdxInstructionController.SetArgument(AIndex: Integer;
  const AArgument: string);
begin
...
procedure TdxInstructionController.UpdateArgument(AIndex: Integer;
  const AArgument: string);
var
  AInterval: TdxDocumentLogInterval;
begin
  ...
  DeferredChanges.UpdateArgument(AIndex,
    TdxUpdateStringFieldInfo.Create(AInterval, GetEscapedArgument(AArgument)));
end;
...
begin
  ...
  DeferredChanges.UpdateArgument(AIndex,
    TdxUpdateDocumentModelAsField.Create(AInterval, AArgument));
end;

function TdxInstructionController.GetArgumentAsLogInterval(AIndex: Integer)
  : TdxDocumentLogInterval;
var
  AToken: IdxToken;
begin
  ...
  case AToken.ActualKind of
    TdxTokenKind.QuotedText:
      Result := TdxDocumentLogInterval.Create(AToken.Position - 1,
        AToken.Length + 2);
...
class function TdxInstructionController.GetEscapedFieldName(const AFieldName
  : string): string;
var
...
begin
  ...
  begin
    ...
    try
      ...
      ANewFieldName.Replace('(', '\(').Replace(')', '\)').Replace('[', '\[')
        .Replace(']', '\]');
...
class function TdxInstructionController.GetEscapedArgument(const AArgument
  : string): string;
begin
...
class function TdxInstructionController.GetEscapedArgument(const AArgument
  : string; ATrimArgument: Boolean): string;
begin
  if AArgument = '' then
    Exit(AArgument);
...
begin
  ...
  if APlainText[AOffset + 1] = ' ' then
    FPieceTable.DeleteContent(FPieceTable.GetRunLogPosition(AIndex) + AOffset,
      1, False, True, True);
end;
