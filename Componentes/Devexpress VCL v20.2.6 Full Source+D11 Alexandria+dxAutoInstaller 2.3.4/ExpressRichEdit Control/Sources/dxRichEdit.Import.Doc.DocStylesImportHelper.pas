...
type
  ...
  public
    constructor Create(AContentBuilder: TdxDocContentBuilder;
      ADocumentModel: TdxDocumentModel);
    destructor Destroy; override;

    function GetStyleIndex(ADocStyleIndex: Integer;
      AStyleType: TdxStyleType): Integer;
    function GetNumberingStyleIndex(ADocStyleIndex: Integer): Integer;
    function GetStyleIndexCore(ADocStyleIndex: Integer;
      AStyleType: TdxStyleType): Integer;
    ...
    procedure AddParagraphStyle(AStyleDescription
      : TdxParagraphStyleDescription);
    procedure SetParagraphStyleProperties(AStyle: TdxParagraphStyle;
      ADescription: TdxParagraphStyleDescription);
    procedure SetParagraphStyleOutlineLevel(ADescription
      : TdxParagraphStyleDescription;
      APropertyContainer: TdxDocPropertyContainer);
    procedure ProcessParagraphListInfoIndex(AStyle: TdxParagraphStyle;
      AInfo: TdxParagraphInfo);
    procedure AddCharacterStyle(AStyleDescription
      : TdxCharacterStyleDescription);
    procedure SetCharacterStyleProperties(AStyle: TdxCharacterStyle;
      ADescription: TdxCharacterStyleDescription);
    procedure AddTableStyle(AStyleDescription: TdxTableStyleDescription);
    procedure SetTableStyleProperties(AStyle: TdxTableStyle;
      ADescription: TdxTableStyleDescription);
    ...
    function GetCharacterFormattingInfo(AInfo: TdxDocCharacterFormattingInfo)
      : TdxCharacterFormattingInfo;
    function GetCharacterStyleFormattingInfo(ABaseStyleIndex: SmallInt;
      APropertyContainer: TdxDocPropertyContainer): TdxCharacterFormattingInfo;
    function GetFormattingInfoCore(ACharacterStyleIndex: Integer)
      : TdxCharacterFormattingInfo;
    function GetParagraphStyleFormattingInfo(ABaseStyleIndex: SmallInt;
      APropertyContainer: TdxDocPropertyContainer): TdxCharacterFormattingInfo;
    function GetTableStyleFormattingInfo(ABaseStyleIndex: SmallInt;
      APropertyContainer: TdxDocPropertyContainer): TdxCharacterFormattingInfo;
...
constructor TdxDocStylesImportHelper.Create(AContentBuilder
  : TdxDocContentBuilder; ADocumentModel: TdxDocumentModel);
begin
  inherited Create;
...
function TdxDocStylesImportHelper.GetStyleIndex(ADocStyleIndex: Integer;
  AStyleType: TdxStyleType): Integer;
begin
  Result := Max(0, GetStyleIndexCore(ADocStyleIndex, AStyleType));
end;

function TdxDocStylesImportHelper.GetNumberingStyleIndex(ADocStyleIndex
  : Integer): Integer;
begin
  Result := GetStyleIndexCore(ADocStyleIndex, TdxStyleType.NumberingListStyle);
end;

function TdxDocStylesImportHelper.GetStyleIndexCore(ADocStyleIndex: Integer;
  AStyleType: TdxStyleType): Integer;
const
...
begin
  ...
  case AStyleType of
    ...
    TdxStyleType.NumberingListStyle:
      Result := DocumentModel.NumberingListStyles.GetStyleIndexByName
        (AStyleName);
  else
    Result := 0;
  end;
...
begin
  ...
  ACharacterProperties.FontName := ContentBuilder.FontManager.GetFontName
    (ContentBuilder.StyleSheet.StylesInformation.DefaultASCIIFont);
...
begin
  ...
  DeleteStyleLinks;
  ASortedStyles := TdxTopologicalSorter<TdxStyleDescriptionBase>.Sort(AStyles,
    TdxStyleDescriptionTopologicalComparer.Create);
  try
...
begin
  ...
  begin
    if DocumentModel.CharacterStyles[I].HasLinkedStyle then
      DocumentModel.StyleLinkManager.DeleteLink
        (DocumentModel.CharacterStyles[I]);
  end;
end;

procedure TdxDocStylesImportHelper.RegisterStyle(AStyleDescription
...
procedure TdxDocStylesImportHelper.AddParagraphStyle(AStyleDescription
  : TdxParagraphStyleDescription);
var
  AParagraphStyle, AParent: TdxParagraphStyle;
begin
  AParagraphStyle := TdxParagraphStyle
    (DocumentModel.ParagraphStyles.GetStyleByName(AStyleDescription.StyleName));
  ...
  if AStyleDescription.BaseStyleIndex <> TdxStyleDescriptionBase.EmptyStyleIdentifier
  then
  begin
    AParent := TdxParagraphStyle(DocumentModel.ParagraphStyles.GetStyleByName
      (StyleMapping[AStyleDescription.BaseStyleIndex]));
...
procedure TdxDocStylesImportHelper.SetParagraphStyleProperties
  (AStyle: TdxParagraphStyle; ADescription: TdxParagraphStyleDescription);
var
...
begin
  AContainer := TdxDocCommandHelper.Traverse(ADescription.ParagraphUPX,
    ContentBuilder.Factory, ContentBuilder.DataReader);
  ContentBuilder.AddToGC(AContainer);

  TdxDocCommandHelper.Traverse(ADescription.CharacterUPX, AContainer,
    ContentBuilder.DataReader);
  ...
  begin
    ACharacterFormattingInfo := GetParagraphStyleFormattingInfo
      (ADescription.BaseStyleIndex, AContainer);
    try
      AMergedCharacterProperties := TdxMergedCharacterProperties.Create
        (ACharacterFormattingInfo, AContainer.CharacterInfo.FormattingOptions);
      try
...
procedure TdxDocStylesImportHelper.SetParagraphStyleOutlineLevel
  (ADescription: TdxParagraphStyleDescription;
  APropertyContainer: TdxDocPropertyContainer);
var
  AInfo: TdxParagraphInfo;
begin
  ...
  if ((AInfo <> nil) and (ADescription.StyleIndex >= 1)) and
    (ADescription.StyleIndex <= 9) then
  begin
...
procedure TdxDocStylesImportHelper.ProcessParagraphListInfoIndex
  (AStyle: TdxParagraphStyle; AInfo: TdxParagraphInfo);
var
...
begin
  ...
  if (AListInfoIndex < -1) or
    (AListInfoIndex >= DocumentModel.NumberingLists.Count) then
    Exit;
...
procedure TdxDocStylesImportHelper.AddCharacterStyle(AStyleDescription
  : TdxCharacterStyleDescription);
var
  ACharacterStyle, AParent: TdxCharacterStyle;
begin
  ACharacterStyle := TdxCharacterStyle
    (DocumentModel.CharacterStyles.GetStyleByName(AStyleDescription.StyleName));
  ...
  then
  begin
    AParent := TdxCharacterStyle(DocumentModel.CharacterStyles.GetStyleByName
      (StyleMapping[AStyleDescription.BaseStyleIndex]));
...
procedure TdxDocStylesImportHelper.SetCharacterStyleProperties
  (AStyle: TdxCharacterStyle; ADescription: TdxCharacterStyleDescription);
var
  AContainer: TdxDocPropertyContainer;
  AFormattingInfo: TdxCharacterFormattingInfo;
  AMergedCharacterProperties: TdxMergedCharacterProperties;
begin
  AContainer := TdxDocCommandHelper.Traverse(ADescription.CharacterUPX,
    ContentBuilder.Factory, ContentBuilder.DataReader);
  ContentBuilder.AddToGC(AContainer);

  ContentBuilder.FontManager.SetFontName(AContainer);
  AFormattingInfo := GetCharacterStyleFormattingInfo
    (ADescription.BaseStyleIndex, AContainer);
  try
    if AContainer.CharacterInfo <> nil then
    begin
      AMergedCharacterProperties := TdxMergedCharacterProperties.Create
        (AFormattingInfo, AContainer.CharacterInfo.FormattingOptions);
      try
        AStyle.CharacterProperties.CopyFrom(AMergedCharacterProperties);
      finally
        AMergedCharacterProperties.Free;
...
procedure TdxDocStylesImportHelper.AddTableStyle(AStyleDescription
  : TdxTableStyleDescription);
var
  ATableStyle, AParent: TdxTableStyle;
begin
  ATableStyle := TdxTableStyle(DocumentModel.TableStyles.GetStyleByName
    (AStyleDescription.StyleName));
  ...
  then
  begin
    AParent := TdxTableStyle(DocumentModel.TableStyles.GetStyleByName
      (StyleMapping[AStyleDescription.BaseStyleIndex]));
...
procedure TdxDocStylesImportHelper.SetTableStyleProperties
  (AStyle: TdxTableStyle; ADescription: TdxTableStyleDescription);
var
  AContainer: TdxDocPropertyContainer;
  ACharacterFormattingInfo: TdxCharacterFormattingInfo;
  AParagraphInfo: TdxParagraphInfo;
...
begin
  ...
  TdxDocCommandHelper.Traverse(ADescription.ParagraphUPX, AContainer,
    ContentBuilder.DataReader);
  TdxDocCommandHelper.Traverse(ADescription.TableUPX, AContainer,
    ContentBuilder.DataReader);
  ContentBuilder.FontManager.SetFontName(AContainer);

  ACharacterFormattingInfo := GetTableStyleFormattingInfo
    (ADescription.BaseStyleIndex, AContainer);
  try
    if AContainer.CharacterInfo <> nil then
    begin
  ...
  if AContainer.TableRowInfo <> nil then
    AStyle.TableRowProperties.CopyFrom
      (AContainer.TableRowInfo.TableRowProperties);
  if AContainer.TableCellInfo <> nil then
    AStyle.TableCellProperties.CopyFrom
      (AContainer.TableCellInfo.TableCellProperties);
end;

procedure TdxDocStylesImportHelper.AddListStyle(AStyleDescription
...
begin
  AListStyle := TdxNumberingListStyle
    (DocumentModel.NumberingListStyles.GetStyleByName
    (AStyleDescription.StyleName));

  AContainer := TdxDocCommandHelper.Traverse(AStyleDescription.ParagraphUPX,
    ContentBuilder.Factory, ContentBuilder.DataReader);
  ContentBuilder.AddToGC(AContainer);

  TdxDocCommandHelper.Traverse(AStyleDescription.ParagraphUPX, AContainer,
    ContentBuilder.DataReader);
  ...
  begin
    AListStyle := TdxNumberingListStyle.Create(FDocumentModel,
      AStyleDescription.StyleName);
...
begin
  ...
  begin
    AStyle := AStyles[I];
    if (AStyle is TdxParagraphStyleDescription) and
      (AStyle.NextStyleIndex <> TdxStyleDescriptionBase.EmptyStyleIdentifier)
    then
    begin
      ACurrentStyle := TdxParagraphStyle
        (DocumentModel.ParagraphStyles.GetStyleByName(AStyle.StyleName));
      if StyleMapping.TryGetValue(AStyle.NextStyleIndex, ANextStyleName) then
      begin
        ANextStyle := TdxParagraphStyle
          (DocumentModel.ParagraphStyles.GetStyleByName(ANextStyleName));
...
begin
  ...
  begin
    ...
    ACharacterStyle := nil;
    ACurrent := AStyles[I];
    if (ACurrent is TdxParagraphStyleDescription) and
      (ACurrent.LinkedStyleIndex <> 0) then
    begin
      AParagraphStyle := TdxParagraphStyle
        (DocumentModel.ParagraphStyles.GetStyleByName(ACurrent.StyleName));
      if StyleMapping.TryGetValue(ACurrent.LinkedStyleIndex, ACharacterStyleName)
      then
        ACharacterStyle := TdxCharacterStyle
          (DocumentModel.CharacterStyles.GetStyleByName(ACharacterStyleName));
    end
    else if (ACurrent is TdxCharacterStyleDescription) and
      (ACurrent.LinkedStyleIndex <> 0) then
    begin
      ACharacterStyle := TdxCharacterStyle
        (DocumentModel.CharacterStyles.GetStyleByName(ACurrent.StyleName));
      if StyleMapping.TryGetValue(ACurrent.LinkedStyleIndex, AParagraphStyleName)
      then
        AParagraphStyle := TdxParagraphStyle
          (DocumentModel.ParagraphStyles.GetStyleByName(AParagraphStyleName));
    end;
    if (AParagraphStyle <> nil) and (ACharacterStyle <> nil) then
      DocumentModel.StyleLinkManager.CreateLink(AParagraphStyle,
        ACharacterStyle);
  end;
end;
...
function TdxDocStylesImportHelper.GetCharacterFormattingInfo
  (AInfo: TdxDocCharacterFormattingInfo): TdxCharacterFormattingInfo;
var
  ACharacterStyleIndex: Integer;
  AFormattingInfo: TdxCharacterFormattingInfo;
begin
  ACharacterStyleIndex := GetStyleIndex(AInfo.StyleIndex,
    TdxStyleType.CharacterStyle);
  AFormattingInfo := GetFormattingInfoCore(ACharacterStyleIndex);
  try
    Result := TdxDocCharacterFormattingHelper.GetMergedCharacterFormattingInfo
      (AInfo, AFormattingInfo, DocumentModel);
  finally
    AFormattingInfo.Free;
  end;
end;

function TdxDocStylesImportHelper.GetCharacterStyleFormattingInfo
  (ABaseStyleIndex: SmallInt; APropertyContainer: TdxDocPropertyContainer)
  : TdxCharacterFormattingInfo;
var
  AParentStyleIndex: Integer;
  AFormattingInfo: TdxCharacterFormattingInfo;
begin
  AParentStyleIndex := GetStyleIndex(ABaseStyleIndex,
    TdxStyleType.CharacterStyle);
  ...
  try
    Result := TdxDocCharacterFormattingHelper.GetMergedCharacterFormattingInfo
      (APropertyContainer.CharacterInfo.FormattingInfo, AFormattingInfo,
      DocumentModel);
  finally
    AFormattingInfo.Free;
  end;
...
function TdxDocStylesImportHelper.GetFormattingInfoCore(ACharacterStyleIndex
  : Integer): TdxCharacterFormattingInfo;
var
...
begin
  ...
  begin
    ...
    Result := DocumentModel.Cache.CharacterFormattingCache
      [TdxCharacterFormattingInfoCache.DefaultItemIndex].Info.Clone;
end;

function TdxDocStylesImportHelper.GetParagraphStyleFormattingInfo
  (ABaseStyleIndex: SmallInt; APropertyContainer: TdxDocPropertyContainer)
  : TdxCharacterFormattingInfo;
var
  AFormattingInfo: TdxCharacterFormattingInfo;
...
begin
  ...
  begin
    ...
    AFormattingInfo := DocumentModel.Cache.CharacterFormattingCache
      [TdxCharacterFormattingInfoCache.DefaultItemIndex].Info.Clone;
  if APropertyContainer.CharacterInfo = nil then
    Exit(AFormattingInfo);
  try
...
function TdxDocStylesImportHelper.GetTableStyleFormattingInfo(ABaseStyleIndex
  : SmallInt; APropertyContainer: TdxDocPropertyContainer)
  : TdxCharacterFormattingInfo;
var
  AFormattingInfo: TdxCharacterFormattingInfo;
...
begin
  if ABaseStyleIndex <> TdxStyleDescriptionBase.EmptyStyleIdentifier then
  begin
    AParent := DocumentModel.TableStyles
      [GetStyleIndex(ABaseStyleIndex, TdxStyleType.TableStyle)];
    AFormattingInfo := AParent.CharacterProperties.Info.Info.Clone;
  end
  else
    AFormattingInfo := DocumentModel.Cache.CharacterFormattingCache
