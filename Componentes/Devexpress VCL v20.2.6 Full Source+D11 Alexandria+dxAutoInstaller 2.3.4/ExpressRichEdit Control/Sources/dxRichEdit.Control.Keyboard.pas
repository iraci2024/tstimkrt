...
type
  ...
  TdxRichEditKeyboardCustomHandler = class(TInterfacedObject,
  ...
  protected
    ...
    procedure RegisterKeyCommand(AShortCut: TShortCut;
      ACommandClass: TdxRichEditCommandClass); overload;
    procedure RegisterKeyCommand(AKey: Word; const AShiftState: TShiftState;
      ACommandClass: TdxRichEditCommandClass); overload;
    procedure RegisterKeyCommand(AKey: Char; const AShiftState: TShiftState;
      ACommandClass: TdxRichEditCommandClass); overload;
    procedure UnregisterKeyCommand(AKey: Word;
      const AShiftState: TShiftState); overload;
    procedure UnregisterKeyCommand(AShortCut: TShortCut); overload;

    function CreateHandlerCommand(AHandlerId: TdxRichEditCommandId)
      : TdxRichEditCommand; virtual;
    function ExecuteCommand(ACommand: TdxRichEditCommand; AShortCut: TShortCut)
      : Boolean; virtual;
    procedure ExecuteCommandCore(ACommand: TdxRichEditCommand;
      AShortCut: TShortCut); virtual;
    function GetKeyHandler(const Args: TdxKeyEventArgs): TdxRichEditCommand;
      overload; virtual;
    function GetKeyHandlerCore(AShortCut: TShortCut)
      : TdxRichEditCommand; virtual;
    function GetKeyHandlerId(AShortCut: TShortCut)
      : TdxRichEditCommandId; virtual;

    function CanHandleKeyShortCut(ACommand: TdxRichEditCommandId;
    ...
    function HandleKeyPress(AChar: Char; const AShiftState: TShiftState)
    ...
    property KeyHandlerIdTable: TDictionary<TShortCut, TdxRichEditCommandId>
      read FKeyHandlerIdTable;
  public
  ...
  protected
    procedure ExecuteCommandCore(ACommand: TdxRichEditCommand;
      AShortCut: TShortCut); override;
    procedure FlushPendingTextInputByParts(const APendingInput
      : string); virtual;
    function GetCursor: TCursor;
    function GetKeyHandler(const Args: TdxKeyEventArgs)
  ...
  public
    constructor Create(AInnerControl: TdxInnerRichEditControl);
      reintroduce; virtual;
    destructor Destroy; override;
  end;
  ...
  TdxKeyboardHandlerServiceWrapper = class(TInterfacedObject,
    IdxKeyboardHandlerService)
  strict private
  ...
  begin
    case AId of
      TdxRichEditCommandId.InsertParagraph,
        ...
        TdxRichEditCommandId.InsertEnDash, TdxRichEditCommandId.InsertEmDash,
        ...
        TdxRichEditCommandId.InsertEllipsis, TdxRichEditCommandId.InsertPicture,
        ...
        TdxRichEditCommandId.InsertText, TdxRichEditCommandId.Delete,
        TdxRichEditCommandId.BackSpaceKey, TdxRichEditCommandId.DeleteWord,
        TdxRichEditCommandId.DeleteWordBack,
        TdxRichEditCommandId.PasteSelection, TdxRichEditCommandId.CutSelection,
        TdxRichEditCommandId.Replace, TdxRichEditCommandId.TabKey,
        TdxRichEditCommandId.ShiftTabKey, TdxRichEditCommandId.FileNew,
        TdxRichEditCommandId.IncreaseIndent,
        TdxRichEditCommandId.DecreaseIndent,
        TdxRichEditCommandId.ClearFormatting, TdxRichEditCommandId.CreateField,
        TdxRichEditCommandId.UpdateField, TdxRichEditCommandId.EnterKey,
        TdxRichEditCommandId.ProtectDocument,
        TdxRichEditCommandId.UnprotectDocument,
        TdxRichEditCommandId.InsertBreak, TdxRichEditCommandId.CreateHyperlink,
        ...
        TdxRichEditCommandId.UpdateFields, TdxRichEditCommandId.ChangePageColor,
        ...
        TdxRichEditCommandId.ToggleTextCase, TdxRichEditCommandId.ChangeCase,
        ...
        TdxRichEditCommandId.MergeTableCells, TdxRichEditCommandId.SplitTable,
        ...
        TdxRichEditCommandId.InsertFloatingPicture:
        Result := True;
    else
      Result := False;
    end;
...
function TdxRichEditKeyboardCustomHandler.CanHandleKeyShortCut
  (ACommand: TdxRichEditCommandId; AShortCut: TShortCut;
  out AHandled: Boolean): Boolean;
var
  Args: TdxRichEditShortCutEventArgs;
begin
  Args := TdxRichEditShortCutEventArgs.Create(ACommand,
    TdxKeyboardHelper.GetKeyData(AShortCut), TdxKeyboardHelper.IsAltGrPressed,
    TdxKeyboardHelper.GetShiftState(AShortCut));
  try
...
function TdxRichEditKeyboardCustomHandler.HandleKeyShortCut
...
var
  AKey: Word;
begin
  Result := TdxKeyboardHelper.IsValidShortCutChar(AChar, AKey) and
    HandleKeyShortCut(TdxKeyboardHelper.KeysToShortCut(AKey, AShiftState));
end;
...
begin
  RegisterKeyCommand(TdxKeyboardHelper.KeysToShortCut(AKey, AShiftState),
    ACommandClass);
end;
...
procedure TdxRichEditKeyboardCustomHandler.RegisterKeyCommand(AKey: Char;
  const AShiftState: TShiftState; ACommandClass: TdxRichEditCommandClass);
begin
  RegisterKeyCommand(TdxKeyboardHelper.CharToShortCut(AKey, AShiftState),
    ACommandClass);
end;
...
function TdxRichEditKeyboardCustomHandler.CreateHandlerCommand
  (AHandlerId: TdxRichEditCommandId): TdxRichEditCommand;
begin
...
function TdxRichEditKeyboardCustomHandler.IsValidChar
  (const AChar: Char): Boolean;
begin
  Result := Ord(AChar) >= 32;
end;

function TdxRichEditKeyboardCustomHandler.GetKeyHandler
  (const Args: TdxKeyEventArgs): TdxRichEditCommand;
begin
  Result := GetKeyHandlerCore(TdxKeyboardHelper.ArgsToShortCut(Args));
end;

function TdxRichEditKeyboardCustomHandler.GetKeyHandlerCore
  (AShortCut: TShortCut): TdxRichEditCommand;
var
...
function TdxRichEditKeyboardCustomHandler.GetKeyHandlerId(AShortCut: TShortCut)
...
constructor TdxRichEditKeyboardDefaultHandler.Create
  (AController: TdxRichEditKeyboardController);
begin
...
procedure TdxRichEditKeyboardDefaultHandler.ExecuteCommandCore
  (ACommand: TdxRichEditCommand; AShortCut: TShortCut);
begin
...
procedure TdxRichEditKeyboardDefaultHandler.FlushPendingTextInputByParts
  (const APendingInput: string);
var
...
function TdxRichEditKeyboardDefaultHandler.CreateFlushPendingTextCommand
  : TdxInsertTextCommand;
const
  AIDMap: array [Boolean] of TdxRichEditCommandId =
    (TdxRichEditCommandId.InsertText, TdxRichEditCommandId.OvertypeText);
begin
  Result := TdxInsertTextCommand(Controller.InnerControl.CreateCommand
    (AIDMap[Control.Overtype]));
end;
...
function TdxRichEditKeyboardDefaultHandler.HandleKeyDown
  (const Args: TdxKeyEventArgs): Boolean;
begin
...
function TdxRichEditKeyboardDefaultHandler.HandleKeyUp
  (const Args: TdxKeyEventArgs): Boolean;
begin
...
begin
  ...
  if (ASpan > PendingTextFlushMilliseconds) and
    (FBeginProcessMultipleKeyPressCount = 0) then
    FlushPendingTextInput;
end;
...
{$ELSE}
  Result := TCharacter.IsWhiteSpace(ACh) or TCharacter.IsSeparator(ACh) or
    TCharacter.IsPunctuation(ACh);
{$ENDIF}
end;
...
begin
  ...
  RegisterKeyCommand(VK_UP, [ssCtrl, ssShift],
  ...
  RegisterKeyCommand(VK_HOME, [ssCtrl, ssShift],
...
begin
  ...
  RegisterKeyCommand(VK_SPACE, [ssShift, ssCtrl],
  ...
  RegisterKeyCommand('R', [ssCtrl, ssAlt],
  ...
  RegisterKeyCommand('D', [ssCtrl, ssShift],
    TdxToggleFontDoubleUnderlineCommand);
  RegisterKeyCommand(VK_OEM_PERIOD, [ssCtrl, ssShift],
    TdxIncreaseFontSizeCommand);
  RegisterKeyCommand(VK_OEM_COMMA, [ssCtrl, ssShift],
  ...
  RegisterKeyCommand(VK_OEM_PLUS, [ssCtrl, ssShift],
  ...
  RegisterKeyCommand('I', [ssAlt, ssCtrl],
...
function TdxRichEditKeyboardDefaultHandler.ShouldChangeCursor
  (ACursor: TCursor): Boolean;
begin
...
begin
  if not(ShouldChangeCursor(TdxRichEditCursors.Hand) and
    Control.IsHyperlinkActive) then
    Exit;
...
constructor TdxRichEditKeyboardController.Create(AInnerControl
...
function TdxRichEditKeyboardController.CreateDefaultHandler
  : IdxKeyboardHandlerService;
begin
  Result := TdxRichEditKeyboardDefaultHandler.Create(Self);
end;

procedure TdxRichEditKeyboardController.DoShortCut
  (Args: TdxRichEditShortCutEventArgs);
begin
...
constructor TdxKeyboardHandlerServiceWrapper.Create(const AService
  : IdxKeyboardHandlerService);
begin
  inherited Create;
  FService := AService;
