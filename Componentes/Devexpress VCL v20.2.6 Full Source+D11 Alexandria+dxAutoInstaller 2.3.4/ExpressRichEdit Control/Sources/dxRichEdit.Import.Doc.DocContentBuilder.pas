...
type
  ...
  TdxProcessSymbolDelegate = procedure(ADestination: TdxDocObjectCollection;
    var AObjectInfo: TdxDocObjectInfo;
    APropertyContainer: TdxDocPropertyContainer) of object;
  ...
  protected
    function GetFonts(AReader: TBinaryReader; AFontTableOffset: Integer)
      : TdxObjectList<TdxDocFontFamilyName>;

    property DocumentFonts: TdxObjectList<TdxDocFontFamilyName>
      read FDocumentFonts;
  public
    ...
    function TryResetFontName(APropertyContainer
  ...
  public
    ...
    property PropertyContainer: TdxDocPropertyContainer
      read GetPropertyContainer;
  ...
  TdxDocContentBuilder = class(TcxIUnknownObject, IdxDocOfficeImageCreator)
  public const
  ...
  strict private
    ...
    FExpectedSpecialSymbolsProcessors
      : TDictionary<Char, TdxProcessSymbolDelegate>;
    FOptions: TdxDocDocumentImporterOptions;
    FFontManager: TdxDocFontManager;
    FFib: TdxFileInformationBlock;
  protected
    // IdxDocOfficeImageCreator
    function CreateImage(const AStream: TStream)
      : TdxOfficeImageReference; overload;
    function CreateImage(AImage: TdxOfficeImage)
      : TdxOfficeImageReference; overload;
    function CreateMetafile(AStream: TMemoryStream; AMapMode: TdxMapMode;
      APictureWidth, APictureHeight: Integer): TdxOfficeImageReference;

    property PieceTable: TdxDocPieceTable read FPieceTable;
    property FKPHelper: TdxFormattedDiskPageHelper read FFkpHelper;
    property SectionPropertiesHelper: TdxSectionPropertiesHelper
      read FSectionPropertiesHelper;
    property MainStreamReader: TdxVirtualStreamBinaryReader
      read FMainStreamReader;
  public
    ...
    procedure BuildDocumentContent(AStream: TStream; AModel: TdxDocumentModel;
      ALeaveOpen: Boolean = True);
    ...
    procedure GetTableStreamInformation(ATableStreamReader: TBinaryReader;
      AFib: TdxFileInformationBlock);
    procedure CalculateTextRunBorders;
    procedure CheckPieceDescriptorBorders(I: Integer);
    function GetPieceTable(AReader: TBinaryReader;
      AFib: TdxFileInformationBlock): TdxDocPieceTable;
    function GetFormattedDiskPageHelper(AReader: TBinaryReader;
      AFib: TdxFileInformationBlock): TdxFormattedDiskPageHelper;
    procedure GetListInformation(AReader: TBinaryReader;
      AFib: TdxFileInformationBlock);
    procedure ReadTextStream;
    procedure ProcessPieceDescriptor(APcdIndex: Integer);
    procedure ProcessTextRunBorder(APcdIndex: Integer;
      ACurrentBorder: TdxTextRunBorder; ANextBorder: TdxTextRunBorder);
    procedure ProcessObjectInfo(var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    procedure ProcessTextCharacters(ADestination: TdxDocObjectCollection;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    procedure ProcessNonTextCharacters(ADestination: TdxDocObjectCollection;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    function GetBorderDocObjects(AReason: TdxTextRunStartReasons;
      AOffset: Integer; var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer): TdxDocObjectCollection;
    function GetDocObjectByParagraphMark(AOffset: Integer;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer): IdxDocObject;
    function GetDocObjectInfo(APcdIndex: Integer;
      ACurrentBorder: TdxTextRunBorder; ANextBorder: TdxTextRunBorder)
      : TdxDocObjectInfo;
    function GetPictures(var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer): TdxDocImageCollection;
    ...
    function GetFieldData(var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer): TdxDocObjectBase;
    function GetTableUnit(var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer): TdxDocObjectBase;
    function GetSection(var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer): TdxDocSection;
    procedure SkipUnsupportedObject(ADestination: TdxDocObjectCollection;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    procedure InsertFloatingObject(ADestination: TdxDocObjectCollection;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    procedure InsertAutoNumberedFootnoteReference(ADestination
      : TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    procedure InsertAnnotationReference(ADestination: TdxDocObjectCollection;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    procedure InsertInlinePicture(ADestination: TdxDocObjectCollection;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    procedure InsertInlinePictureCore(ADestination: TdxDocObjectCollection;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    procedure InsertFieldData(ADestination: TdxDocObjectCollection;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    procedure InsertFieldBegin(ADestination: TdxDocObjectCollection;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    procedure InsertFieldSeparator(ADestination: TdxDocObjectCollection;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    procedure InsertFieldEnd(ADestination: TdxDocObjectCollection;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    procedure InsertExpectedFieldBegin(ADestination: TdxDocObjectCollection;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    procedure InsertExpectedFieldSeparator(ADestination: TdxDocObjectCollection;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    procedure InsertExpectedFieldEnd(ADestination: TdxDocObjectCollection;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    procedure InsertSpecialSymbol(ADestination: TdxDocObjectCollection;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer);
    function GetInnerBorders(APcdIndex: Integer): TdxList<TdxTextRunBorder>;
    function GetString(AOffset: Integer; ALength: Integer;
      AEncoding: TEncoding): string;
    procedure CorrectParagraphBorderType(AParagraphBorder: TdxTextRunBorder;
      APcdIndex: Integer);
    ...
    property ListOverrideInfo: TdxDocListOverrideFormatInformation
      read FListFormatOverrideInfo;
    property StyleSheet: TdxDocStyleSheet read FStyleSheet;
    property FontManager: TdxDocFontManager read FFontManager
      write FFontManager;
...
function TdxDocFontManager.GetFonts(AReader: TBinaryReader;
  AFontTableOffset: Integer): TdxObjectList<TdxDocFontFamilyName>;
var
  I: Integer;
...
procedure TdxDocFontManager.SetFontName(APropertyContainer
...
function TdxDocFontManager.TryResetFontName(APropertyContainer
  : TdxDocPropertyContainer): Boolean;
var
  ACharacterInfo: TdxCharacterInfo;
begin
  ACharacterInfo := APropertyContainer.CharacterInfo;
  if (ACharacterInfo <> nil) and ACharacterInfo.FormattingOptions.UseFontName
  then
    Exit(False);
...
constructor TdxUnsupportedObject.Create(APosition: Integer;
  APropertyContainer: TdxDocPropertyContainer);
begin
...
constructor TdxDocContentBuilder.Create(AModel: TdxDocumentModel;
  AOptions: TdxDocDocumentImporterOptions);
begin
  inherited Create;
...
procedure TdxDocContentBuilder.BuildDocumentContent(AStream: TStream;
  AModel: TdxDocumentModel; ALeaveOpen: Boolean = True);
var
...
begin
  ...
  FIterator := TdxDocContentIterator.Create(Self, FFib, MainStreamReader,
    FTableStreamReader, AModel);
...
begin
  if AFib.Version <= LastSupportedVersion then
    TdxRichEditExceptions.ThrowInvalidOperationException
      (cxGetResourceString(@sdxRichEditExceptionUnsupportedDocVersion));
  if TdxFileInformationFlag.Encryped in AFib.Flags then
    TdxRichEditExceptions.ThrowInvalidOperationException
      (cxGetResourceString(@sdxRichEditExceptionEncryptedFile));
end;

procedure TdxDocContentBuilder.CreateSpecialSymbolsProcessors;
begin
  FSpecialSymbolProcessors :=
    TDictionary<Char, TdxProcessSymbolDelegate>.Create(7);
  FSpecialSymbolProcessors.Add(TdxTextCodes.InlinePicture, InsertInlinePicture);
  FSpecialSymbolProcessors.Add(TdxTextCodes.AutoNumberedFootNoteReference,
    InsertAutoNumberedFootnoteReference);
  FSpecialSymbolProcessors.Add(TdxTextCodes.AnnotationReference,
    InsertAnnotationReference);
  FSpecialSymbolProcessors.Add(TdxTextCodes.FloatingObjectAnchor,
    InsertFloatingObject);
  FSpecialSymbolProcessors.Add(TdxTextCodes.FieldBegin, InsertFieldBegin);
  FSpecialSymbolProcessors.Add(TdxTextCodes.FieldSeparator,
...
begin
  FExpectedSpecialSymbolsProcessors :=
    TDictionary<Char, TdxProcessSymbolDelegate>.Create;
  FExpectedSpecialSymbolsProcessors.Add
    (TdxTextCodes.AutoNumberedFootNoteReference,
    InsertAutoNumberedFootnoteReference);
  FExpectedSpecialSymbolsProcessors.Add(TdxTextCodes.FieldBegin,
    InsertExpectedFieldBegin);
  FExpectedSpecialSymbolsProcessors.Add(TdxTextCodes.FieldSeparator,
    InsertExpectedFieldSeparator);
  FExpectedSpecialSymbolsProcessors.Add(TdxTextCodes.FieldEnd,
    InsertExpectedFieldEnd);
end;

procedure TdxDocContentBuilder.GetTableStreamInformation(ATableStreamReader
  : TBinaryReader; AFib: TdxFileInformationBlock);
begin
  FPieceTable := GetPieceTable(ATableStreamReader, AFib);
  FFkpHelper := GetFormattedDiskPageHelper(ATableStreamReader, AFib);
  FStyleSheet := TdxDocStyleSheet.FromStream(ATableStreamReader,
    AFib.StyleSheetOffset, AFib.StyleSheetSize);
  if AFib.FontTableSize <> 0 then
    FontManager := TdxDocFontManager.Create(ATableStreamReader,
      AFib.FontTableOffset);
  FSectionPropertiesHelper := SectionPropertiesHelper.FromStream
    (MainStreamReader, ATableStreamReader, AFib.SectionTableOffset,
    AFib.SectionTableSize);
  GetListInformation(ATableStreamReader, AFib);
  FDocProperties := TdxDocDocumentProperties.FromStream(ATableStreamReader,
    AFib.DocumentPropertiesOffset);
  FFactory.DocumentProperties := FDocProperties;
  FDocVariables := TdxDocumentVariables.FromStream(ATableStreamReader,
    AFib.DocumentVariablesOffset, AFib.DocumentVariablesSize);
  FDocFileRecords := TdxDocumentFileRecords.FromStream(ATableStreamReader,
    AFib.DocumentFileRecordsOffset, AFib.DocumentFileRecordsSize);
end;
...
begin
  ...
  if not TdxAlgorithms1<TdxTextRunBorder>.BinarySearch(FTextRunBorders,
    AComparable.CompareTo, AIndex) then
  begin
    ATextRunBorder := TdxTextRunBorder.Create(AOffset,
      [TdxTextRunStartReason.TextRunMark]);
  ...
  if not TdxAlgorithms1<TdxTextRunBorder>.BinarySearch(FTextRunBorders,
    AComparable.CompareTo, AIndex) then
  begin
    ATextRunBorder := TdxTextRunBorder.Create(AOffset + ALength,
      [TdxTextRunStartReason.TextRunMark]);
    FTextRunBorders.Insert(AIndex, ATextRunBorder);
  end;
end;

function TdxDocContentBuilder.GetPieceTable(AReader: TBinaryReader;
  AFib: TdxFileInformationBlock): TdxDocPieceTable;
var
  AClxInfo: TdxComplexFileInformation;
  ALastCharacterPosition: Integer;
begin
  AClxInfo := TdxComplexFileInformation.FromStream(AReader,
    AFib.ComplexFileInformationOffset, AFib.ComplexFileInformationSize);
  try
  ...
  ALastCharacterPosition := AFib.MainDocumentLength + AFib.FootNotesLength +
    AFib.HeadersFootersLength;
  Result := TdxDocPieceTable.CreateDefault(AFib.FirstCharacterFileOffset,
    ALastCharacterPosition);
end;

function TdxDocContentBuilder.GetFormattedDiskPageHelper(AReader: TBinaryReader;
  AFib: TdxFileInformationBlock): TdxFormattedDiskPageHelper;
var
...
begin
  ...
  AParagraphsBinTable := TdxBinTable.FromStream(AReader,
    AFib.ParagraphTableOffset, AFib.ParagraphTableSize, AMainStreamLength);
  ACharactersBinTable := TdxBinTable.FromStream(AReader,
    AFib.CharacterTableOffset, AFib.CharacterTableSize, AMainStreamLength);
  Result := TdxFormattedDiskPageHelper.Create(MainStreamReader, DataReader,
    AParagraphsBinTable, ACharactersBinTable);
end;

procedure TdxDocContentBuilder.GetListInformation(AReader: TBinaryReader;
  AFib: TdxFileInformationBlock);
begin
  FListFormatInfo := TdxDocListFormatInformation.FromStream(AReader,
    AFib.ListFormatInformationOffset, AFib.ListFormatInformationSize);
  FListFormatOverrideInfo := TdxDocListOverrideFormatInformation.FromStream
    (AReader, AFib.ListFormatOverrideInformationOffset,
    AFib.ListFormatOverrideInformationSize);
end;
...
begin
  ...
  ALastPropertiesContainer := Iterator.MainTextDocObjects
    [Iterator.MainTextDocObjects.Count - 1].PropertyContainer;
  SectionPropertiesHelper.UpdateCurrentSectionProperties(MainStreamReader,
    DataReader, ALastPropertiesContainer);
end;
...
procedure TdxDocContentBuilder.ProcessTextRunBorder(APcdIndex: Integer;
  ACurrentBorder: TdxTextRunBorder; ANextBorder: TdxTextRunBorder);
var
  APropertyContainer: TdxDocPropertyContainer;
...
begin
  APropertyContainer := FKPHelper.UpdateCharacterProperties
    (ACurrentBorder.Offset, Factory);
  ...
  begin
    ...
    ABorders := GetBorderDocObjects(ANextBorder.Reason, ACurrentBorder.Offset,
      AObjectInfo, APropertyContainer);
    try
...
procedure TdxDocContentBuilder.ProcessObjectInfo(var AObjectInfo
...
begin
  ...
  if (APropertyContainer.CharacterInfo <> nil) and
    APropertyContainer.CharacterInfo.Special then
...
procedure TdxDocContentBuilder.ProcessTextCharacters(ADestination
  : TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
var
  ACh: Char;
...
begin
  ...
  if FExpectedSpecialSymbolsProcessors.TryGetValue(ACh, AExpectedSymbolDelegate)
  then
    AExpectedSymbolDelegate(ADestination, AObjectInfo, APropertyContainer)
  else
  begin
    ADestination.Add(TdxDocObjectFactory.Instance.CreateDocObject
      (TdxDocObjectType.TextRun, AObjectInfo, APropertyContainer));
    AObjectInfo.Position := AObjectInfo.Position + Length(AObjectInfo.Text);
  end;
end;

procedure TdxDocContentBuilder.ProcessNonTextCharacters
  (ADestination: TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
var
  ACount, I: Integer;
  ACh: Char;
...
begin
  ...
  begin
    ...
    if not FSpecialSymbolProcessors.TryGetValue(ACh, ASpecialCharacterProcessor)
    then
...
function TdxDocContentBuilder.GetBorderDocObjects
  (AReason: TdxTextRunStartReasons; AOffset: Integer;
  var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer): TdxDocObjectCollection;
begin
  Result := TdxDocObjectCollection.Create;
  if TdxTextRunStartReason.ParagraphMark in AReason then
    Result.Add(GetDocObjectByParagraphMark(AOffset, AObjectInfo,
      APropertyContainer) as IdxDocObject);
...
function TdxDocContentBuilder.GetDocObjectByParagraphMark(AOffset: Integer;
  var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer): IdxDocObject;
begin
  FKPHelper.UpdateParagraphProperties(AOffset, APropertyContainer);
  if (APropertyContainer.ParagraphInfo <> nil) and
    APropertyContainer.ParagraphInfo.NestedTableTrailer then
    Exit(TdxDocObjectFactory.Instance.CreateDocObject(TdxDocObjectType.TableRow,
      AObjectInfo, APropertyContainer));
  if (APropertyContainer.ParagraphInfo <> nil) and
    APropertyContainer.ParagraphInfo.InnerTableCell then
    Exit(TdxDocObjectFactory.Instance.CreateDocObject
      (TdxDocObjectType.TableCell, AObjectInfo, APropertyContainer));
  Result := TdxDocObjectFactory.Instance.CreateDocObject
    (TdxDocObjectType.Paragraph, AObjectInfo, APropertyContainer);
end;

function TdxDocContentBuilder.GetDocObjectInfo(APcdIndex: Integer;
  ACurrentBorder: TdxTextRunBorder; ANextBorder: TdxTextRunBorder)
  : TdxDocObjectInfo;
var
  AText: string;
...
begin
  AText := GetString(ACurrentBorder.Offset, ANextBorder.Offset -
    ACurrentBorder.Offset, PieceTable.GetEncoding(APcdIndex));
  APosition := Iterator.AdvanceNext(Length(AText));
  AParagraphOrTableUnitMark := [TdxTextRunStartReason.ParagraphMark,
    TdxTextRunStartReason.TableUnitMark];
...
function TdxDocContentBuilder.GetPictures(var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer): TdxDocImageCollection;
var
  APictureDescriptor: TdxPictureDescriptor;
  ABlip: TdxBlipBase;
begin
  APictureDescriptor := TdxPictureDescriptor.FromStream(DataReader,
    APropertyContainer.DataStreamOffset, Self);
  try
    if Iterator.ShapeField then
    begin
      ABlip := Iterator.FloatingObjectsIterator.GetBlip
        (AObjectInfo.Position - 1);
      if ABlip <> nil then
      begin
    ...
    Result := TdxDocImageCollection.Create(AObjectInfo, APropertyContainer,
      APictureDescriptor);
  finally
...
function TdxDocContentBuilder.GetFloatingObject(var AObjectInfo
  : TdxDocObjectInfo; APropertyContainer: TdxDocPropertyContainer)
...
function TdxDocContentBuilder.GetFieldData(var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer): TdxDocObjectBase;
var
...
begin
  ...
  begin
    AHyperlinkInfo := TdxDocHyperlinkInfo.Create(DataReader,
      APropertyContainer.DataStreamOffset);
    Result := TdxDocHyperlinkFieldData.Create(AObjectInfo, APropertyContainer,
      AHyperlinkInfo);
  end
  else
    Result := nil;
...
function TdxDocContentBuilder.GetTableUnit(var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer): TdxDocObjectBase;
begin
  if (APropertyContainer.ParagraphInfo <> nil) and
    APropertyContainer.ParagraphInfo.TableTrailer then
    Exit(TdxDocTableRow.Create(AObjectInfo, APropertyContainer))
  else
    Exit(TdxDocTableCell.Create(AObjectInfo, APropertyContainer));
end;

function TdxDocContentBuilder.GetSection(var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer): TdxDocSection;
begin
  SectionPropertiesHelper.UpdateCurrentSectionProperties(MainStreamReader,
    DataReader, APropertyContainer);
  Result := TdxDocSection.Create(AObjectInfo, APropertyContainer);
end;

procedure TdxDocContentBuilder.SkipUnsupportedObject(ADestination
  : TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
begin
end;

procedure TdxDocContentBuilder.InsertFloatingObject(ADestination
  : TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
var
...
begin
  ...
  if AFloatingObject <> nil then
    ...
    ADestination.Add(TdxUnsupportedObject.Create(AObjectInfo.Position,
      APropertyContainer));
end;

procedure TdxDocContentBuilder.InsertAutoNumberedFootnoteReference
  (ADestination: TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
begin
...
procedure TdxDocContentBuilder.InsertAnnotationReference
  (ADestination: TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
begin
  ADestination.Add(TdxDocObjectFactory.Instance.CreateDocObject
    (TdxDocObjectType.AnnotationReference, AObjectInfo, APropertyContainer));
end;

procedure TdxDocContentBuilder.InsertInlinePicture(ADestination
  : TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
begin
  if (APropertyContainer.CharacterInfo <> nil) and
    APropertyContainer.CharacterInfo.BinaryData then
  begin
  ...
  if (APropertyContainer.CharacterInfo <> nil) and
    APropertyContainer.CharacterInfo.Ole2Object then
    Exit;
  InsertInlinePictureCore(ADestination, AObjectInfo, APropertyContainer);
end;

procedure TdxDocContentBuilder.InsertInlinePictureCore
  (ADestination: TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
var
...
procedure TdxDocContentBuilder.InsertFieldData(ADestination
  : TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
var
...
procedure TdxDocContentBuilder.InsertFieldBegin(ADestination
  : TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
begin
  if Iterator.AdvanceField(APropertyContainer) then
    ADestination.Add(TdxDocObjectFactory.Instance.CreateDocObject
      (TdxDocObjectType.FieldBegin, AObjectInfo, APropertyContainer));
end;

procedure TdxDocContentBuilder.InsertFieldSeparator(ADestination
  : TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
begin
  if Iterator.AdvanceField(APropertyContainer) then
  begin
    ADestination.Add(TdxDocObjectFactory.Instance.CreateDocObject
      (TdxDocObjectType.FieldSeparator, AObjectInfo, APropertyContainer));
    Iterator.State.FieldIterator.SetShapeField(ADestination);
  end;
end;

procedure TdxDocContentBuilder.InsertFieldEnd(ADestination
  : TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
begin
  if Iterator.AdvanceField(APropertyContainer) then
  begin
    ADestination.Add(TdxDocObjectFactory.Instance.CreateDocObject
      (TdxDocObjectType.FieldEnd, AObjectInfo, APropertyContainer));
    Iterator.CheckFieldCompatibility(ADestination);
    Iterator.State.FieldIterator.ResetShapeField;
  end;
end;

procedure TdxDocContentBuilder.InsertExpectedFieldBegin
  (ADestination: TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
begin
  ADestination.Add(TdxDocObjectFactory.Instance.CreateDocObject
    (TdxDocObjectType.ExpectedFieldBegin, AObjectInfo, APropertyContainer));
end;

procedure TdxDocContentBuilder.InsertExpectedFieldSeparator
  (ADestination: TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
begin
  ADestination.Add(TdxDocObjectFactory.Instance.CreateDocObject
    (TdxDocObjectType.ExpectedFieldSeparator, AObjectInfo, APropertyContainer));
end;

procedure TdxDocContentBuilder.InsertExpectedFieldEnd
  (ADestination: TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
begin
  ADestination.Add(TdxDocObjectFactory.Instance.CreateDocObject
    (TdxDocObjectType.ExpectedFieldEnd, AObjectInfo, APropertyContainer));
end;

procedure TdxDocContentBuilder.InsertSpecialSymbol(ADestination
  : TdxDocObjectCollection; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
var
...
begin
  ...
  ASymbolInfo := TdxDocObjectInfo.Create(AObjectInfo.Position,
    ASpecialCharacter);
  ADestination.Add(TdxDocObjectFactory.Instance.CreateDocObject
    (TdxDocObjectType.TextRun, ASymbolInfo, APropertyContainer));
end;

function TdxDocContentBuilder.GetInnerBorders(APcdIndex: Integer)
  : TdxList<TdxTextRunBorder>;
var
...
begin
  ...
  AComparable := TdxTextRunBorderComparable.Create(AOffset);
  TdxAlgorithms1<TdxTextRunBorder>.BinarySearch(ABorders, AComparable.CompareTo,
    ALowIndex);
  AComparable := TdxTextRunBorderComparable.Create(AOffset + ALength);
  TdxAlgorithms1<TdxTextRunBorder>.BinarySearch(ABorders, AComparable.CompareTo,
    AHighIndex);
...
function TdxDocContentBuilder.GetString(AOffset: Integer; ALength: Integer;
  AEncoding: TEncoding): string;
var
  ABuffer: TBytes;
begin
...
procedure TdxDocContentBuilder.CorrectParagraphBorderType(AParagraphBorder
  : TdxTextRunBorder; APcdIndex: Integer);
var
  AOffset: Integer;
  AMarkType: Char;
begin
  if (PieceTable.GetEncoding(APcdIndex) = TdxEncoding.Unicode) then
    ...
    AOffset := 1;
  MainStreamReader.BaseStream.Seek(AParagraphBorder.Offset - AOffset,
    TSeekOrigin.soBeginning);
  AMarkType := Chr(MainStreamReader.ReadByte);
  if (AMarkType = TdxTextCodes.SectionMark) and
    (AParagraphBorder.Offset <> FTextRunBorders[FTextRunBorders.Count - 1]
    .Offset) then
  begin
    AParagraphBorder.Reason := AParagraphBorder.Reason +
      [TdxTextRunStartReason.SectionMark];
    AParagraphBorder.Reason := AParagraphBorder.Reason -
      [TdxTextRunStartReason.ParagraphMark];
  end;
  if AMarkType = TdxTextCodes.ColumnBreak then
  begin
    AParagraphBorder.Reason := AParagraphBorder.Reason +
      [TdxTextRunStartReason.ColumnBreak];
    AParagraphBorder.Reason := AParagraphBorder.Reason -
      [TdxTextRunStartReason.ParagraphMark];
  end;
...
procedure TdxDocContentBuilder.BeginEmbeddedContent
...
function TdxDocContentBuilder.CreateImage(const AStream: TStream)
...
function TdxDocContentBuilder.CreateImage(AImage: TdxOfficeImage)
  : TdxOfficeImageReference;
begin
...
function TdxDocContentBuilder.CreateMetafile(AStream: TMemoryStream;
  AMapMode: TdxMapMode; APictureWidth, APictureHeight: Integer)
  : TdxOfficeImageReference;
var
  AImage: TdxOfficeImage;
begin
  AImage := TdxMetafileHelper.CreateMetafile(AStream, AMapMode, APictureWidth,
    APictureHeight);
  Result := CreateImage(AImage);
end;
