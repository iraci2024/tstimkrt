...
{$ENDIF}
  ...
  dxLayoutControlAdapters, Menus,
  dxLayoutContainer, StdCtrls, cxButtons, cxTextEdit, dxLayoutLookAndFeels,
...
function TdxRichEditDialogInputBox.CreateController(AControllerParameters
