...
type
  ...
  TdxUpdateFieldResult = (FieldNotUpdated, FieldUpdated,
  ...
  IdxFieldDataService = interface
    ...
    function GetFieldValue(AMailMergeProperties: TdxMailMergeProperties;
      const AFieldName: string; AMapFieldName: Boolean;
      AOptions: TdxMailMergeDataMode; APieceTable: TdxCustomPieceTable;
  ...
  public
    ...
    procedure AddSwitch(const AFieldSwitch: string;
      const AInterval: TdxDocumentLogInterval); overload;
    procedure AddSwitch(const AFieldSwitch: string;
      const AInterval: TdxDocumentLogInterval;
    ...
    function GetDefaultInterval(AIntervals: TdxDocumentLogIntervalList)
      : TdxDocumentLogInterval;
    function GetArgument(AIndex: Integer): IdxToken;
    function GetArgumentAsString(AIndex: Integer): string;
    function GetArgumentAsDocumentInterval(AIndex: Integer)
      : TdxDocumentLogInterval;
    function GetSwitchArgumentDocumentInterval(const AFieldSwitch: string)
      : TdxDocumentLogInterval; overload;
    function GetSwitchArgumentDocumentInterval(const AFieldSwitch: string;
      AIncludeFullInterval: Boolean): TdxDocumentLogInterval; overload;
    function GetSwitchDocumentInterval(const AFieldSwitch: string)
      : TdxDocumentLogInterval;

    property Arguments: TdxTokenList read FArguments;
    property Switches: TdxNamedObjectDictionary<TdxTokenList> read FSwitches;
    property SwitchIntervals
      : TdxNamedObjectDictionary<TdxDocumentLogIntervalList>
      read FSwitchIntervals;
  end;

  { TdxCalculatedFieldBase }

  TdxFieldMailMergeType = (NonMailMerge = 1, MailMerge = 2, Mixed = 3);
  ...
  strict private
    class var FEmptySwitchesWithArgument: TdxStringBooleanDictionary;
  ...
  protected
    class function CreateSwitchesWithArgument(const ASwitches: array of string)
      : TdxStringBooleanDictionary; overload; static;
    class function CreateSwitchesWithArgument: TdxStringBooleanDictionary;
      overload; static;
    class function GetDefaultMailMergeFieldText(const AFieldName: string)
      : string; static;
    ...
    function InsertDefaultMailMergeText(ASourcePieceTable: TdxCustomPieceTable)
      : Boolean; virtual;
    function GetCharacterFormatFlag: TdxFieldResultOptions; virtual;
    function GetShouldApplyFormating: Boolean; virtual;
    function TryApplyCommonStringFormat
      (AValue: TdxCalculatedFieldValue): Boolean;
    function CreateDateTimeFieldFormatter: TdxDateTimeFieldFormatter; virtual;
    function GetDocumentModelStringValue(ADocumentModel: TdxCustomDocumentModel)
      : string; virtual;
    function GetObjectForFormat(AValue: TdxCalculatedFieldValue;
      const ACommonStringFormat: string): TValue;
    function TryApplyDateAndTimeFormatting(AValue: TdxCalculatedFieldValue)
      : Boolean; virtual;
    ...
    function TryConvertToDateTime(AValue: TdxCalculatedFieldValue;
      out AResult: TDateTime): Boolean; virtual;
    function TryConvertToDouble(AValue: TdxCalculatedFieldValue;
      out AResult: Double): Boolean; virtual;
    ...
    property SwitchesWithArguments: TdxStringBooleanDictionary
      read GetSwitchesWithArguments;
  ...
  public
    ...
    function CanUseSwitchWithoutArgument(const AFieldSpecificSwitch: string)
      : Boolean; virtual;
    function IsSwitchWithArgument(const AFieldSpecificSwitch: string)
      : Boolean; virtual;
    procedure Initialize(APieceTable: TdxCustomPieceTable;
      ASwitches: TdxInstructionCollection); virtual;
    procedure BeforeCalculateFields(ASourcePieceTable: TdxCustomPieceTable;
      ADocumentField: TdxField); virtual;
    function Update(ASourcePieceTable: TdxCustomPieceTable;
      AMailMergeDataMode: TdxMailMergeDataMode; ADocumentField: TdxField)
      : TdxCalculatedFieldValue; override;
    ...
    function GetCalculatedValueCore(ASourcePieceTable: TdxCustomPieceTable;
      AMailMergeDataMode: TdxMailMergeDataMode; ADocumentField: TdxField)
      : TdxCalculatedFieldValue; virtual; abstract;
    function GetInvariableSwitches: TArray<string>; virtual;
    function GetNativeSwitches: TArray<string>; virtual;
    function IsSwitchArgumentField(const AFieldSpecificSwitch: string)
      : Boolean; virtual;

    property DateAndTimeFormatting: TdxNullableString
      read FDateAndTimeFormatting;
  ...
  public
    function CalculateCounterValue
      (AField: TdxCalculatedFieldBase { TdxSequenceField };
      ADocumentField: TdxField): Integer; virtual; abstract;
  ...
  public
    ...
    property SequentialFieldManager: TdxSequentialFieldCustomManager
      read FSequentialFieldManager;
  end;
  ...
  protected
    ...
    procedure UpdateInnerCodeFields(AParentField: TdxField;
      AUpdateType: TdxUpdateFieldOperationType);
    procedure UpdateInnerResultFields(AParentField: TdxField;
      AUpdateType: TdxUpdateFieldOperationType);
  ...
  public
    ...
    procedure UpdateFields(const AFields: TdxFieldList; AParent: TdxField;
      AUpdateType: TdxUpdateFieldOperationType); overload;
    procedure UpdateFields(const AFieldsToUpdate: TdxFieldList;
      AUpdateType: TdxUpdateFieldOperationType); overload;
    ...
    procedure UpdateFieldsCore(const AFieldsToUpdate: TdxFieldList;
      AUpdateType: TdxUpdateFieldOperationType);
    function GetFieldsToUpdate(const AFields: TdxFieldList; AParent: TdxField)
      : TdxFieldList; overload;
    ...
    procedure PrepareFieldAndNestedFields(AField: TdxField;
      AUpdateType: TdxUpdateFieldOperationType);
    procedure PrepareNestedFieldsUpdate(AField: TdxField;
      AUpdateType: TdxUpdateFieldOperationType);
    function UpdateField(AField: TdxField;
      AMailMergeDataMode: TdxMailMergeDataMode)
      : TdxUpdateFieldOperationResult; overload;
    function UpdateField(AField: TdxField;
      AMailMergeDataMode: TdxMailMergeDataMode;
      AUpdateType: TdxUpdateFieldOperationType)
      : TdxUpdateFieldOperationResult; overload;
    procedure UpdateFieldRecursive(AField: TdxField;
      AUpdateType: TdxUpdateFieldOperationType);
    function GetInnerCodeFields(const AFields: TdxFieldList;
      AParentField: TdxField): TdxFieldList; virtual;
    function GetInnerResultFields(const AFields: TdxFieldList;
  ...
  public
    constructor Create(AValue: TdxCalculatedFieldValue;
    ...
    property SuppressMergeUseFirstParagraphStyle: Boolean
      read GetSuppressMergeUseFirstParagraphStyle;
  end;
  ...
  TdxUpdateFieldOperationResult = class
  public
    class var DisabledUpdate: TdxUpdateFieldOperationResult;
  strict private
    ...
    class destructor Finalize;
  public
    constructor Create(AUpdateFieldResult: TdxUpdateFieldResult;
      ASuppressUpdateInnerCodeFields: Boolean);

    property UpdateFieldResult: TdxUpdateFieldResult read FUpdateFieldResult;
    property SuppressUpdateInnerCodeFields: Boolean
      read FSuppressUpdateInnerCodeFields;
  end;

  { TdxDocumentVariableCollection }

  TdxDocumentVariableCollection = class(TcxIUnknownObject,
  ...
  protected
    procedure SetVariableValue(const AVariableName: string;
      const AValue: TValue);
  public
    ...
    function GetVariableValue(const AVariableName: string;
      AArguments: TdxArgumentCollection): TValue; overload;
  ...
  protected
    ...
    function GetValueCore(AFormatter: TObject;
      ADocumentModel: TdxCustomDocumentModel): Integer; virtual; abstract;
  public
    constructor Create(const ANumericFormatting: TdxNullableString;
      const AGeneralFormatting: TArray<string>);
    function Clone: TdxFieldResultFormatting; virtual;
    function ApplyImplicitFormatting(AFormatter: TObject; const AValue: string;
      AIntValue: Integer): string; virtual;
    function GetValue(AFormatter: TObject;
      ADocumentModel: TdxCustomDocumentModel): string;

    property NumericFormatting: TdxNullableString read FNumericFormatting;
    property GeneralFormatting: TArray<string> read GetGeneralFormatting;
    property RecalculateOnSecondaryFormatting: Boolean
      read GetRecalculateOnSecondaryFormatting;
  end;
...
type
  ...
  strict private
    ...
    function GetBookmarksByEndPosition(APieceTable: TdxPieceTable;
      APosition: TdxDocumentLogPosition): TdxBookmarkList;
    procedure ModifyBookmarks(APieceTable: TdxPieceTable;
      ABookmarks: TdxBookmarkList; ANewEndLogPosition: TdxDocumentLogPosition);
  ...
  protected
    ...
    function ReplaceFieldResult(AResult: TdxCalculateFieldResult;
      AUpdateType: TdxUpdateFieldOperationType)
      : TdxUpdateFieldOperationResult; virtual;
    function IsFieldSelected(AStartPosition: TdxDocumentLogPosition;
      AEndPosition: TdxDocumentLogPosition): Boolean;
    function MinLogPosition(APos1: TdxDocumentLogPosition;
      APos2: TdxDocumentLogPosition): TdxDocumentLogPosition;
    function MaxLogPosition(APos1: TdxDocumentLogPosition;
      APos2: TdxDocumentLogPosition): TdxDocumentLogPosition;
    ...
    function DeleteOldFieldResult(const AStartPosition,
      AEndPosition: TdxDocumentModelPosition;
      ASuppressMergeUseFirstParagraphStyle: Boolean)
      : TdxDocumentModelPosition; virtual;
    procedure RemoveField; virtual;
    function GetDeleteStart(ADeleteFieldCode: Boolean)
      : TdxDocumentModelPosition; virtual;
    function GetDeleteEnd(ADeleteFieldCode: Boolean)
      : TdxDocumentModelPosition; virtual;
    procedure CopyCharacterFormatToDocumentModel(ATargetModel
      : TdxDocumentModel); virtual;
    procedure CopyFormattingFromCodeFirstChar(const ATargetPos
      : TdxDocumentModelPosition); overload; virtual;
    procedure CopyFormattingFromCodeFirstChar(APieceTable: TdxPieceTable;
      ASourceRun: TdxTextRunBase; ATargetPos: TdxDocumentLogPosition;
    ...
    procedure CopyParagraphFormatToDocumentModel(ATargetModel
      : TdxDocumentModel); virtual;
    procedure TrySplitRun(const ATo: TdxDocumentModelPosition); virtual;
    procedure CopyCharacterFormatToRuns(ASourceRun: TdxTextRunBase;
      const ATargetPos: TdxDocumentModelPosition);
    procedure CopyCharacterFormatCore(ASourceRun: TdxTextRunBase;
      ATargetRun: TdxTextRunBase);
    procedure CopyParagraphFormatCore(ASourceParagraph: TdxParagraph;
    ...
    function GetNextCharacterGroupPosition(const APos: TdxDocumentModelPosition)
      : TdxDocumentModelPosition;
    function GetNextParagraphPosition(const APos: TdxDocumentModelPosition)
      : TdxDocumentModelPosition;
  public
    constructor Create(APieceTable: TdxPieceTable;
      AMailMergeDataMode: TdxMailMergeDataMode);
    function Execute(AField: TdxField; AUpdateType: TdxUpdateFieldOperationType)
      : TdxUpdateFieldOperationResult; virtual;
...
constructor TdxDocumentLogInterval.Create(AStart: TdxDocumentLogPosition;
  ALength: Integer);
begin
  FStart := AStart;
  FLength := ALength;
...
function TdxInstructionCollection.GetString(const AFieldSwitch: string)
  : TdxNullableString;
var
  AResult: TdxTokenList;
  AToken: IdxToken;
...
function TdxInstructionCollection.GetStringArray(const AFieldSwitch: string)
  : TArray<string>;
var
  AResult: TdxTokenList;
  ACount, I: Integer;
...
function TdxInstructionCollection.GetNullableInt(const AFieldSwitch: string)
  : TdxNullableInteger;
var
  AResult: TdxTokenList;
  AToken: IdxToken;
...
function TdxInstructionCollection.GetDefaultToken(const ATokens: TdxTokenList)
  : IdxToken;
begin
  Result := ATokens.Last;
end;

function TdxInstructionCollection.GetDefaultInterval
  (AIntervals: TdxDocumentLogIntervalList): TdxDocumentLogInterval;
begin
...
function TdxInstructionCollection.GetArgumentAsDocumentInterval(AIndex: Integer)
  : TdxDocumentLogInterval;
var
  AToken: IdxToken;
begin
...
function TdxInstructionCollection.GetSwitchArgumentDocumentInterval
  (const AFieldSwitch: string): TdxDocumentLogInterval;
begin
  Result := GetSwitchArgumentDocumentInterval(AFieldSwitch, False);
end;

function TdxInstructionCollection.GetSwitchArgumentDocumentInterval
  (const AFieldSwitch: string; AIncludeFullInterval: Boolean)
  : TdxDocumentLogInterval;
var
  AResult: TdxTokenList;
  AToken: IdxToken;
begin
  ...
  begin
    if AToken.ActualKind = TdxTokenKind.QuotedText then
      Exit(TdxDocumentLogInterval.Create(AToken.Position - 1,
        AToken.Length + 2))
    else if AToken.ActualKind = TdxTokenKind.Template then
      Exit(TdxDocumentLogInterval.Create(AToken.Position - 1,
        AToken.Length + 3));
  end;
  Result := TdxDocumentLogInterval.Create(AToken.Position, AToken.Length);
...
function TdxInstructionCollection.GetSwitchDocumentInterval(const AFieldSwitch
  : string): TdxDocumentLogInterval;
var
...
function TdxCalculatedFieldBase.CanUseSwitchWithoutArgument
  (const AFieldSpecificSwitch: string): Boolean;
begin
  Result := False;
end;
...
class function TdxCalculatedFieldBase.GetDefaultMailMergeFieldText
  (const AFieldName: string): string;
begin
  Result := Format('<<%s>>', [AFieldName]);
end;

class function TdxCalculatedFieldBase.CreateSwitchesWithArgument(const ASwitches
  : array of string): TdxStringBooleanDictionary;
var
  ACount, I: Integer;
begin
...
class function TdxCalculatedFieldBase.CreateSwitchesWithArgument
  : TdxStringBooleanDictionary;
begin
  Result := TdxStringBooleanDictionary.Create;
end;

function TdxCalculatedFieldBase.IsSwitchWithArgument(const AFieldSpecificSwitch
  : string): Boolean;
begin
  Result := SwitchesWithArguments.ContainsKey(AFieldSpecificSwitch);
end;

procedure TdxCalculatedFieldBase.Initialize(APieceTable: TdxCustomPieceTable;
  ASwitches: TdxInstructionCollection);
begin
  FSwitches := ASwitches;
  ...
  FUseCurrentCultureDateTimeFormat := TdxPieceTable(APieceTable)
    .DocumentModel.FieldOptions.UseCurrentCultureDateTimeFormat;
end;
...
function TdxCalculatedFieldBase.InsertDefaultMailMergeText(ASourcePieceTable
  : TdxCustomPieceTable): Boolean;
var
  AFieldDataService: IdxFieldDataService;
begin
  if Ord(MailMergeType) and Ord(TdxFieldMailMergeType.NonMailMerge) <> 0 then
    Exit(False);
  AFieldDataService := TdxPieceTable(ASourcePieceTable)
    .DocumentModel.GetService<IdxFieldDataService>;
  Result := (AFieldDataService = nil) or (not AFieldDataService.BoundMode);
end;

function TdxCalculatedFieldBase.Update(ASourcePieceTable: TdxCustomPieceTable;
  AMailMergeDataMode: TdxMailMergeDataMode; ADocumentField: TdxField)
...
begin
  ...
  if InsertDefaultMailMergeText(ASourcePieceTable) then
    Exit(TdxCalculatedFieldValue.Create(GetDefaultMailMergeFieldText
      (FieldTypeName), GetCharacterFormatFlag));
  AValue := GetCalculatedValueCore(ASourcePieceTable, AMailMergeDataMode,
    ADocumentField);
  try
    if AValue = TdxCalculatedFieldValue.InvalidValue then
      Exit(TdxCalculatedFieldValue.Create(GetDefaultMailMergeFieldText
        (FieldTypeName), GetCharacterFormatFlag));
    ApplyFieldFormatting(AValue, TdxPieceTable(ASourcePieceTable)
      .DocumentModel.MailMergeOptions.CustomSeparators);
    ACharacterFormatFlag := GetCharacterFormatFlag;
    if Ord(MailMergeType) and Ord(TdxFieldMailMergeType.MailMerge) <> 0 then
      ACharacterFormatFlag := ACharacterFormatFlag +
        [TdxFieldResultOption.MailMergeField];
...
function TdxCalculatedFieldBase.GetSwitchesWithArguments
  : TdxStringBooleanDictionary;
begin
  Result := FEmptySwitchesWithArgument;
end;

procedure TdxCalculatedFieldBase.BeforeCalculateFields(ASourcePieceTable
  : TdxCustomPieceTable; ADocumentField: TdxField);
begin
  // do nothing
end;

function TdxCalculatedFieldBase.TryApplyCommonStringFormat
  (AValue: TdxCalculatedFieldValue): Boolean;
var
...
begin
  ...
  AShouldApplyFormatting := AHasCommonStringFormat and
    not AValue.RawValue.IsEmpty;
...
procedure TdxCalculatedFieldBase.ApplyFieldFormatting
  (AValue: TdxCalculatedFieldValue;
  ACustomSeparators: TdxMailMergeCustomSeparators);
var
  ACount, I: Integer;
...
{$ELSE}
        AGeneralFormattingSwitchUpperCase :=
          TCharacter.ToUpper(AGeneralFormattingSwitch);
{$ENDIF}
        ...
        begin
          if AGeneralFieldFormatter.IsGeneralDocumentModelStringFormatter
            (AGeneralFormattingSwitch) then
            AGeneralFieldFormatter.FormatPieceTable
              (TdxDocumentModel(AValue.DocumentModel).MainPieceTable,
              AGeneralFormattingSwitch)
          else
          begin
            AActualValue := GetDocumentModelStringValue(AValue.DocumentModel);
            AActualValue := AGeneralFieldFormatter.Format(AActualValue,
              AActualValue, AGeneralFormattingSwitch);
            AValue.SetValueConvertedToString(AActualValue);
          end;
        end
        else
        begin
          if not AValue.ConvertedToString and not AValue.IsDocumentModelValue
          then
            AValue.SetValueConvertedToString
              (VarToStr(AValue.RawValue.AsVariant));
          AValue.SetValueConvertedToString
            (AGeneralFieldFormatter.Format(AValue.Text, AValue.Text,
            AGeneralFormattingSwitch));
        end;
      end;
    finally
...
procedure TdxCalculatedFieldBase.TryApplyFormatting
  (AValue: TdxCalculatedFieldValue;
  ACustomSeparators: TdxMailMergeCustomSeparators);
begin
...
function TdxCalculatedFieldBase.GetObjectForFormat
  (AValue: TdxCalculatedFieldValue; const ACommonStringFormat: string): TValue;
var
  ADateTime: TDateTime;
  ANumber: Double;
begin
...
function TdxCalculatedFieldBase.TryApplyDateAndTimeFormatting
  (AValue: TdxCalculatedFieldValue): Boolean;
var
...
begin
  ...
  try
    if AHasDateAndTimeFormatting then
      AValue.SetValueConvertedToString(ADateTimeFieldFormatter.Format(ADateTime,
        DateAndTimeFormatting.Value, AHasDateAndTimeFormatting))
    else
      AValue.SetValueConvertedToString(ADateTimeFieldFormatter.Format(ADateTime,
        '', AHasDateAndTimeFormatting));
  finally
...
function TdxCalculatedFieldBase.CreateDateTimeFieldFormatter
...
function TdxCalculatedFieldBase.TryApplyNumericFormatting
  (AValue: TdxCalculatedFieldValue;
  ACustomSeparators: TdxMailMergeCustomSeparators): Boolean;
var
...
begin
  ...
  try
    ...
    if AHasNumericFormatting then
      AValue.SetValueConvertedToString(ANumericFieldFormatter.Format(ADoubleVal,
        NumericFormatting.Value, AHasNumericFormatting))
    else
      AValue.SetValueConvertedToString(ANumericFieldFormatter.Format(ADoubleVal,
        '', AHasNumericFormatting));
    Result := True;
  finally
...
function TdxCalculatedFieldBase.TryConvertToDateTime
  (AValue: TdxCalculatedFieldValue; out AResult: TDateTime): Boolean;
var
  ARawValue: TValue;
begin
...
function TdxCalculatedFieldBase.TryConvertToDouble
  (AValue: TdxCalculatedFieldValue; out AResult: Double): Boolean;
var
  ARawValue: TValue;
  V: Variant;
begin
  ...
  Result := True;
  try
    if not ARawValue.IsEmpty and ARawValue.IsString and
      not IsEmptyString(ARawValue) then
      Result := TryStrToFloat(ARawValue.AsString, AResult)
    else if ARawValue.IsExtended then
...
begin
  Result := AValue.IsEmpty or
    (AValue.IsString and (Length(AValue.AsString) = 0));
end;

function TdxCalculatedFieldBase.GetDocumentModelStringValue(ADocumentModel
  : TdxCustomDocumentModel): string;
begin
  Result := TdxDocumentModel(ADocumentModel)
    .InternalAPI.GetDocumentPlainTextContent;
end;
...
function TdxCalculatedFieldBase.IsSwitchArgumentField(const AFieldSpecificSwitch
  : string): Boolean;
begin
  Result := False;
end;
...
begin
  ...
  FSequentialFieldManager := TdxSequentialFieldManager.Create
    (TdxPieceTable(APieceTable));
end;
...
procedure TdxFieldUpdater.UpdateFields(AUpdateType
  : TdxUpdateFieldOperationType);
begin
  UpdateFields(Fields.InnerList, nil, AUpdateType);
end;

procedure TdxFieldUpdater.UpdateFields(const AFields: TdxFieldList;
  AParent: TdxField; AUpdateType: TdxUpdateFieldOperationType);
var
  AList: TdxFieldList;
begin
...
function TdxFieldUpdater.GetFieldsToUpdate(const AFields: TdxFieldList;
  AParent: TdxField): TdxFieldList;
var
  ACount, I: Integer;
begin
...
procedure TdxFieldUpdater.PrepareFieldsCore(const AFieldsToUpdate: TdxFieldList;
  AUpdateType: TdxUpdateFieldOperationType);
var
  ACount, I: Integer;
begin
...
procedure TdxFieldUpdater.PrepareFieldUpdate(AField: TdxField;
  AUpdateType: TdxUpdateFieldOperationType);
var
...
procedure TdxFieldUpdater.PrepareFieldAndNestedFields(AField: TdxField;
  AUpdateType: TdxUpdateFieldOperationType);
begin
...
procedure TdxFieldUpdater.PrepareNestedFieldsUpdate(AField: TdxField;
  AUpdateType: TdxUpdateFieldOperationType);
var
...
function TdxFieldUpdater.UpdateField(AField: TdxField;
AMailMergeDataMode: TdxMailMergeDataMode): TdxUpdateFieldOperationResult;
begin
  Result := UpdateField(AField, AMailMergeDataMode,
...
begin
  ...
  ADocumentModel.BeginUpdate;
  try
    AOperation := TdxUpdateFieldOperation.Create(TdxPieceTable(PieceTable),
      AMailMergeDataMode);
    try
...
procedure TdxFieldUpdater.UpdateFieldRecursive(AField: TdxField;
AUpdateType: TdxUpdateFieldOperationType);
var
...
begin
  ...
  try
    if AResult.UpdateFieldResult <> TdxUpdateFieldResult.FieldUpdatedAndCodeDeleted
    then
    begin
...
procedure TdxFieldUpdater.UpdateInnerCodeFields(AParentField: TdxField;
AUpdateType: TdxUpdateFieldOperationType);
var
...
procedure TdxFieldUpdater.UpdateInnerResultFields(AParentField: TdxField;
AUpdateType: TdxUpdateFieldOperationType);
var
...
begin
  ...
  try
    ...
    begin
      ...
      try
        AFieldBase := AService.ParseField(TdxPieceTable(PieceTable),
          AInnerResultFields[I]);
        try
...
begin
  ...
  for I := 0 to AFieldsCount - 1 do
    if (AFields[I].Parent = AParentField) and
      (AFields[I].&Result.&End < AParentField.Code.&End) then
      Result.Add(AFields[I]);
end;

function TdxFieldUpdater.GetInnerResultFields(const AFields: TdxFieldList;
AParentField: TdxField): TdxFieldList;
var
  AFieldsCount, I: Integer;
begin
  ...
  for I := 0 to AFieldsCount - 1 do
    if (AFields[I].Parent = AParentField) and
      (AFields[I].Code.Start >= AParentField.&Result.Start) then
      Result.Add(AFields[I]);
end;
...
function TdxCalculateFieldResult.GetSuppressMergeUseFirstParagraphStyle
  : Boolean;
begin
...
begin
  DisabledUpdate := TdxUpdateFieldOperationResult.Create
    (TdxUpdateFieldResult.FieldNotUpdated, True);
end;
...
constructor TdxUpdateFieldOperationResult.Create(AUpdateFieldResult
  : TdxUpdateFieldResult; ASuppressUpdateInnerCodeFields: Boolean);
begin
  inherited Create;
...
constructor TdxUpdateFieldOperation.Create(APieceTable: TdxPieceTable;
AMailMergeDataMode: TdxMailMergeDataMode);
begin
  inherited Create;
  FEndResultLogPos := -1;
...
function TdxUpdateFieldOperation.GetBookmarksByEndPosition
  (APieceTable: TdxPieceTable; APosition: TdxDocumentLogPosition)
  : TdxBookmarkList;
var
...
procedure TdxUpdateFieldOperation.ModifyBookmarks(APieceTable: TdxPieceTable;
ABookmarks: TdxBookmarkList; ANewEndLogPosition: TdxDocumentLogPosition);
var
  ACount, I: Integer;
...
begin
  ...
  ANewEndPosition := TdxPositionConverter.ToDocumentModelPosition(APieceTable,
    ANewEndLogPosition);
  for I := 0 to ACount - 1 do
  begin
...
function TdxUpdateFieldOperation.Execute(AField: TdxField;
AUpdateType: TdxUpdateFieldOperationType): TdxUpdateFieldOperationResult;
var
  AResult: TdxCalculateFieldResult;
begin
  try
    AResult := PieceTable.CalculateFieldResult(AField, FMailMergeDataMode,
      AUpdateType);
    try
    ...
    Result := TdxUpdateFieldOperationResult.Create
      (TdxUpdateFieldResult.FieldNotUpdated, False);
  end;
end;

function TdxUpdateFieldOperation.InsertResult(AField: TdxField;
AResult: TdxCalculateFieldResult; AUpdateType: TdxUpdateFieldOperationType)
  : TdxUpdateFieldOperationResult;
var
  AUpdateResult: TdxUpdateFieldOperationResult;
begin
  if AResult = nil then
    Exit(TdxUpdateFieldOperationResult.Create
      (TdxUpdateFieldResult.FieldNotUpdated, False));
  ...
  begin
    ...
    Exit(TdxUpdateFieldOperationResult.Create(TdxUpdateFieldResult.FieldUpdated,
      TdxFieldResultOption.SuppressUpdateInnerCodeFields in AResult.Options));
  end
  else
  begin
  ...
  try
    ...
    if (AUpdateResult.UpdateFieldResult <>
      TdxUpdateFieldResult.FieldUpdatedAndCodeDeleted) and AField.IsCodeView
    then
      PieceTable.ToggleFieldCodes(AField);
    Exit(AUpdateResult);
  finally
...
begin
  FField := AField;
  FStartResultPos := TdxDocumentModelPosition.FromRunStart(PieceTable,
    AField.Result.Start);
...
function TdxUpdateFieldOperation.ReplaceFieldResult
  (AResult: TdxCalculateFieldResult; AUpdateType: TdxUpdateFieldOperationType)
  : TdxUpdateFieldOperationResult;
var
  AFieldValue: TdxCalculatedFieldValue;
  ATargetModel: TdxDocumentModel;
  AShouldDeleteFieldCode, AEmptyParagraphInserted, AIsFieldSelectedBefore,
    AIsFieldSelectedAfter: Boolean;
  APictureFieldSize: TSize;
  AOldResultStart, AOldResultEnd: TdxDocumentModelPosition;
  AEndPositionBeforeInsert, AEndPositionAfterInsert, ANewResultEnd
    : TdxDocumentLogPosition;
  ABookmarksEndPosition, AOldDocumentEnd, ANewDocumentEnd
    : TdxDocumentLogPosition;
  ...
  begin
    ...
    begin
      ...
      if AFieldValue.Text <> '' then
        ATargetModel.MainPieceTable.InsertPlainText(0,
          AFieldValue.RawValue.ToString);
    end;
  ...
  begin
    ...
    begin
      if ATargetModel <> nil then
        CopyFormattingFromCodeFirstChar
          (TdxDocumentModelPosition.Create(ATargetModel.MainPieceTable));
    end;
  end;
  try
    AShouldDeleteFieldCode :=
      (MailMergeDataMode = TdxMailMergeDataMode.FinalMerging) and
      AResult.MailMergeField;
    ...
    begin
      ...
      begin
        ...
        if AFieldValue.Text <> '' then
        begin
          PieceTable.InsertPlainText(AOldResultEnd.LogPosition + 1,
            AFieldValue.Text);
          ...
          begin
            ...
            CopyFormattingFromCodeFirstChar(PieceTable, ASourceRun,
              AOldResultEnd.LogPosition + 1, ALength);
          end;
        end;
      end
      else
      begin
        AEmptyParagraphInserted := ATargetModel.MainPieceTable.Paragraphs.First.
          IsInCell and not(PieceTable.Runs[AOldResultEnd.RunIndex]
          is TdxParagraphRun);
        ABookmarksEndPosition := AOldResultEnd.LogPosition + 1;
        ABookmarks := GetBookmarksByEndPosition(PieceTable,
          ABookmarksEndPosition);
        try
          AOldDocumentEnd := PieceTable.DocumentEndLogPosition;
          PieceTable.InsertDocumentModelContent(ATargetModel,
            AOldResultEnd.LogPosition + 1, True, False, True);
          ANewDocumentEnd := PieceTable.DocumentEndLogPosition;
          ADelta := ANewDocumentEnd - AOldDocumentEnd;
          ModifyBookmarks(PieceTable, ABookmarks, ABookmarksEndPosition
            + ADelta);
        finally
          ABookmarks.Free;
        end;
      end;
      DeleteOldFieldResult(AOldResultStart, AOldResultEnd,
        AResult.SuppressMergeUseFirstParagraphStyle);
      if AEmptyParagraphInserted then
        DeleteOldFieldResult(AOldResultStart, AOldResultStart,
          AResult.SuppressMergeUseFirstParagraphStyle);
    end
    else
    begin
      ASourceRun := GetSourceRun;
      AIsFieldSelectedBefore := IsFieldSelected(AOldResultStart.LogPosition,
        AOldResultEnd.LogPosition);
      DeleteOldFieldResult(AOldResultStart, AOldResultEnd,
        AResult.SuppressMergeUseFirstParagraphStyle);
      if ATargetModel = nil then
      begin
        ...
        if AFieldValue.Text <> '' then
        begin
          PieceTable.InsertPlainText(AOldResultStart.LogPosition,
            AFieldValue.Text);
          AEndPositionAfterInsert := PieceTable.DocumentEndLogPosition;
          ALength := AEndPositionAfterInsert - AEndPositionBeforeInsert;
          if not AResult.MergeFormat and AResult.ApplyFieldCodeFormatting then
            CopyFormattingFromCodeFirstChar(PieceTable, ASourceRun,
              AOldResultStart.LogPosition, ALength);
          ANewResultEnd := AOldResultStart.LogPosition + ALength;
          AIsFieldSelectedAfter := IsFieldSelected(AOldResultStart.LogPosition,
            ANewResultEnd);
          if AIsFieldSelectedBefore and not AIsFieldSelectedAfter then
          begin
            PieceTable.DocumentModel.Selection.Start :=
              MinLogPosition(PieceTable.DocumentModel.Selection.Start,
              AOldResultStart.LogPosition);
            PieceTable.DocumentModel.Selection.&End :=
              MaxLogPosition(PieceTable.DocumentModel.Selection.&End,
              ANewResultEnd);
          end;
        end;
      end
        ...
        PieceTable.InsertDocumentModelContent(ATargetModel,
          AOldResultStart.LogPosition, True, True, True);
    end;

    if (AUpdateType = TdxUpdateFieldOperationType.Copy) or
      (AUpdateType = TdxUpdateFieldOperationType.Load) or
    ...
    if AShouldDeleteFieldCode then
      Result := TdxUpdateFieldOperationResult.Create
        (TdxUpdateFieldResult.FieldUpdatedAndCodeDeleted,
        TdxFieldResultOption.SuppressUpdateInnerCodeFields in AResult.Options)
    else
      Result := TdxUpdateFieldOperationResult.Create
        (TdxUpdateFieldResult.FieldUpdated,
        TdxFieldResultOption.SuppressUpdateInnerCodeFields in AResult.Options);
  finally
...
function TdxUpdateFieldOperation.IsFieldSelected(AStartPosition
  : TdxDocumentLogPosition; AEndPosition: TdxDocumentLogPosition): Boolean;
begin
...
function TdxUpdateFieldOperation.MinLogPosition(APos1: TdxDocumentLogPosition;
APos2: TdxDocumentLogPosition): TdxDocumentLogPosition;
begin
  if APos1 < APos2 then
    Exit(APos1);
...
function TdxUpdateFieldOperation.MaxLogPosition(APos1: TdxDocumentLogPosition;
APos2: TdxDocumentLogPosition): TdxDocumentLogPosition;
begin
  if APos1 > APos2 then
    Exit(APos1);
...
procedure TdxUpdateFieldOperation.FixLastParagraphFormatting
  (ATargetModel: TdxDocumentModel;
...
begin
  ...
  CopyParagraphFormatCore(ALastParagraph,
    PieceTable.Paragraphs[ALastInsertedParIndex]);
end;

function TdxUpdateFieldOperation.DeleteOldFieldResult(const AStartPosition,
  AEndPosition: TdxDocumentModelPosition;
...
begin
  ...
  try
    AIncludedFields := PieceTable.GetEntireFieldsFromInterval
      (AStartPosition.RunIndex, AEndPosition.RunIndex);
    try
    ...
    AOperation := TdxDeleteContentOperation
      (PieceTable.CreateDeleteContentOperation);
    try
    ...
    PieceTable.ApplyChanges(TdxDocumentModelChangeType.DeleteContent,
      AStartPosition.RunIndex, MaxInt);
  finally
...
function TdxUpdateFieldOperation.GetDeleteStart(ADeleteFieldCode: Boolean)
  : TdxDocumentModelPosition;
begin
  if not ADeleteFieldCode then
    Result := FStartResultPos
  else
    Result := TdxDocumentModelPosition.FromRunStart(PieceTable,
      FField.FirstRunIndex);
end;

function TdxUpdateFieldOperation.GetDeleteEnd(ADeleteFieldCode: Boolean)
  : TdxDocumentModelPosition;
begin
  if not ADeleteFieldCode then
...
procedure TdxUpdateFieldOperation.CopyCharacterFormatToDocumentModel
  (ATargetModel: TdxDocumentModel);
var
...
begin
  ...
  while (ASourcePos.LogPosition <= FEndResultLogPos) and
    (ATargetPos.LogPosition <= ATargetEndLogPos) do
  begin
...
procedure TdxUpdateFieldOperation.CopyFormattingFromCodeFirstChar
  (const ATargetPos: TdxDocumentModelPosition);
var
  ASourceRun: TdxTextRunBase;
...
procedure TdxUpdateFieldOperation.CopyFormattingFromCodeFirstChar
  (APieceTable: TdxPieceTable; ASourceRun: TdxTextRunBase;
ATargetPos: TdxDocumentLogPosition; ALength: Integer);
var
  ARuns: TdxTextRunCollection;
...
begin
  ...
  AStartIndex := TdxPositionConverter.ToDocumentModelPosition(APieceTable,
    ATargetPos).RunIndex;
  AEndIndex := TdxPositionConverter.ToDocumentModelPosition(APieceTable,
    ATargetPos + ALength).RunIndex;
...
begin
  ...
  while {$IFDEF DELPHIXE4}GetCharacter(APos)
    .IsWhiteSpace{$ELSE}TCharacter.IsWhiteSpace(GetCharacter(APos)){$ENDIF} and
    (APos.RunIndex < AEndRunIndex) do
...
function TdxUpdateFieldOperation.GetCharacter
...
procedure TdxUpdateFieldOperation.CopyParagraphFormatToDocumentModel
  (ATargetModel: TdxDocumentModel);
var
  ASourcePos, ATargetPos: TdxDocumentModelPosition;
  ATargetEndLogPos: TdxDocumentLogPosition;
...
begin
  ...
  if (ATargetPos.LogPosition < ATargetEndLogPos) and (ASourceParagraph <> nil)
  then
    CopyParagraphFormatCore(ASourceParagraph,
      ATargetModel.MainPieceTable.Paragraphs.Last);
end;

procedure TdxUpdateFieldOperation.TrySplitRun
  (const ATo: TdxDocumentModelPosition);
var
  ADocumentModel: TdxCustomDocumentModel;
begin
  ...
  ADocumentModel.BeginUpdate;
  try
    TdxPieceTable(ATo.PieceTable).SplitTextRun(ATo.ParagraphIndex, ATo.RunIndex,
      ATo.RunOffset);
  finally
    ADocumentModel.EndUpdate;
  end;
...
procedure TdxUpdateFieldOperation.CopyCharacterFormatToRuns
  (ASourceRun: TdxTextRunBase; const ATargetPos: TdxDocumentModelPosition);
var
...
procedure TdxUpdateFieldOperation.CopyCharacterFormatCore
  (ASourceRun: TdxTextRunBase; ATargetRun: TdxTextRunBase);
begin
  ATargetRun.CharacterProperties.CopyFrom(ASourceRun.CharacterProperties.Info);
  ATargetRun.CharacterStyleIndex := ASourceRun.CharacterStyle.Copy
    (ATargetRun.Paragraph.DocumentModel);
end;

procedure TdxUpdateFieldOperation.CopyParagraphFormatCore(ASourceParagraph
  : TdxParagraph; ATargetParagraph: TdxParagraph);
begin
  ATargetParagraph.ParagraphProperties.CopyFrom
    (ASourceParagraph.ParagraphProperties.Info);
  ATargetParagraph.ParagraphStyleIndex := ASourceParagraph.ParagraphStyle.Copy
    (ATargetParagraph.DocumentModel);
end;

function TdxUpdateFieldOperation.GetTextRun(const APos
  : TdxDocumentModelPosition): TdxTextRunBase;
begin
  Result := TdxTextRunBase(APos.PieceTable.Runs[APos.RunIndex]);
end;

function TdxUpdateFieldOperation.GetParagraph
  (const APos: TdxDocumentModelPosition): TdxParagraph;
begin
  Result := TdxParagraph(APos.PieceTable.Paragraphs[APos.ParagraphIndex]);
end;

function TdxUpdateFieldOperation.GetNextCharacterGroupPosition
  (const APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
var
  AIterator: TdxCharactersGroupIterator;
begin
  AIterator := TdxCharactersGroupIterator.Create
    (TdxPieceTable(APos.PieceTable));
  try
...
function TdxUpdateFieldOperation.GetNextParagraphPosition
  (const APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
var
  AIterator: TdxParagraphsDocumentModelIterator;
begin
  AIterator := TdxParagraphsDocumentModelIterator.Create
    (TdxPieceTable(APos.PieceTable));
  try
...
constructor TdxDocumentVariableCollection.Create(ADocumentModel
...
procedure TdxDocumentVariableCollection.Add(const AName: string;
const AValue: TValue);
begin
...
function TdxDocumentVariableCollection.GetVariableNames
  : TDictionary<string, TValue>.TKeyCollection;
begin
  Result := FVariables.Keys;
end;

function TdxDocumentVariableCollection.GetVariableValue(const AVariableName
  : string; AArguments: TdxArgumentCollection): TValue;
var
  AArgs: TdxCalculateDocumentVariableEventArgs;
  AServer: TdxInternalRichEditDocumentServer;
  AOptions: TdxRichEditMailMergeOptions;
begin
  AArgs := TdxCalculateDocumentVariableEventArgs.Create(AVariableName,
    AArguments);
  try
    if TdxDocumentModel(FDocumentModel).RaiseCalculateDocumentVariable(AArgs)
    then
    begin
      AServer := TdxInternalRichEditDocumentServer.
        TryConvertInternalRichEditDocumentServer(AArgs.Value);
      if AServer <> nil then
      begin
...
procedure TdxDocumentVariableCollection.SetVariableValue(const AVariableName
  : string; const AValue: TValue);
begin
  if not FVariables.ContainsKey(AVariableName) then
    TdxRichEditExceptions.ThrowInvalidOperationException
      (cxGetResourceString(@sdxRichEditExceptionVariableDeletedOrMissed));
...
procedure TdxDocumentVariableCollection.SetItem(const AName: string;
const Value: TValue);
begin
...
constructor TdxFieldResultFormatting.Create(const ANumericFormatting
  : TdxNullableString; const AGeneralFormatting: TArray<string>);
begin
  inherited Create;
...
begin
  if Self = nil then
    Exit(nil);
  Result := TdxFieldResultFormattingClass(ClassType).Create(FNumericFormatting,
    FGeneralFormatting);
end;
...
function TdxFieldResultFormatting.GetValue(AFormatter: TObject;
ADocumentModel: TdxCustomDocumentModel): string;
var
  AGeneralFormattingSwitchUpperCase: string;
  AGeneralFormattingSwitch: string;
...
begin
  ...
  try
      ...
      begin
        ...
        try
          ...
          begin
            AGeneralFormattingSwitch := GeneralFormatting[I];
            AGeneralFormattingSwitchUpperCase :=
              AnsiUpperCase(AGeneralFormattingSwitch);
            if (((AGeneralFormattingSwitchUpperCase = TdxCalculatedFieldBase.
              MergeFormatKeyword) or
              (AGeneralFormattingSwitchUpperCase = TdxCalculatedFieldBase.
              MergeFormatInetKeyword)) or
              (AGeneralFormattingSwitchUpperCase = TdxCalculatedFieldBase.
              CharFormatKeyword)) then
              Continue;
            AValue := AGeneralFieldFormatter.Format(AValue, AValue,
              AGeneralFormattingSwitch);
    ...
    if TdxDocumentModel(ADocumentModel).FieldOptions.ThrowExceptionOnInvalidFormatSwitch
    then
      raise;
