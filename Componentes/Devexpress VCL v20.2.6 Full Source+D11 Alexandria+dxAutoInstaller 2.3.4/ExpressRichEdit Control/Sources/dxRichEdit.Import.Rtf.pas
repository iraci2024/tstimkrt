...
type
  ...
  public
    ...
    procedure LoadMetafileFromStream(AStream: TBytesStream;
      AMapMode: TdxMapMode; APictureWidth, APictureHeight: Integer);
    procedure LoadImageFromStream(AStream: TBytesStream);
    procedure LoadDibFromStream(AStream: TBytesStream;
      AWidth, AHeight, ABytesInLine: Integer);
    procedure LoadBitmapFromStream(AStream: TBytesStream;
    ...
    property SizeInModelUnits: TSize read FSizeInModelUnits
      write FSizeInModelUnits;
  ...
  private
    ...
    function CreateDefaultRtfFontInfo(ADocumentModel: TdxDocumentModel)
      : TdxRtfFontInfo;
  ...
  TdxTranslateKeywordEvent = reference to procedure(AImporter: TdxRtfImporter;
    AParameterValue: Integer; AHasParameter: Boolean);
  TdxKeywordTranslatorTable = class
    (TdxNamedDelegateDictionary<TdxTranslateKeywordEvent>);

  { TdxControlCharTranslatorTable }

  TdxTranslateControlCharEvent = reference to procedure
    (AImporter: TdxRtfImporter; var AChar: Char);
  TdxControlCharTranslatorTable = class
    (TDictionary<Char, TdxTranslateControlCharEvent>);
  ...
  strict private
    ...
    class function CreateDefaultControlCharHT
      : TdxControlCharTranslatorTable; static;
  ...
  private
    ...
    class procedure ColorTableKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure FontTableKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure UserTableKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure AnsiKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure MacKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure PcKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure PcaKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure AnsiCodePageKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure HyphAutoKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;

    class procedure OptionalGroupCharHandler(AImporter: TdxRtfImporter;
  ...
  protected
    ...
    function ProcessKeywordCore(const AKeyword: string;
      AParameterValue: Integer; AHasParameter: Boolean): Boolean; virtual;
    procedure ProcessTextCore(const AText: string); virtual;

    procedure BeforeNestedGroupFinishedCore(ADestination
      : TdxRichEditRtfDestinationBase); virtual;
    function GetPieceTable: TdxPieceTable; virtual;

    class procedure BinKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure EscapedCharHandler(AImporter: TdxRtfImporter;
      var AChar: Char); static;
    class procedure SwitchToHexCharHandler(AImporter: TdxRtfImporter;
      var AChar: Char); static;
    ...
    class property DefaultControlCharHT: TdxControlCharTranslatorTable
      read FDefaultControlCharHT;
    class property DefaultKeywordHT: TdxKeywordTranslatorTable
      read FDefaultKeywordHT;
  ...
  public
    ...
    function ProcessKeyword(const AKeyword: string; AParameterValue: Integer;
    ...
    procedure BeforeNestedGroupFinished(ADestination
      : TdxRichEditRtfDestinationBase);
  ...
  public
    ...
    property ParagraphTableStyles: TdxIntegersDictionary
      read FParagraphTableStyles;
    property Position: TdxRtfInputPosition read FPosition;
    property TableReader: TdxRtfTableReader read FTableReader;
  end;

  TdxRichEditRtfPieceTableInfos = class
    (TdxObjectStack<TdxRichEditRtfPieceTableInfo>);
  ...
  private
    ...
    procedure FlushByString(AImporter: TdxRtfImporter;
      const AChars: TCharArray);
  public
  ...
  protected
    ...
    procedure SetDecoder(Value: TdxCodePageCharacterDecoder;
      ANeedDestroyOldDecoder: Boolean = True);
  public
    ...
    property ParentStyleIndex: Integer read FParentStyleIndex
      write FParentStyleIndex;
    property UnicodeCharacterByteCount: Integer read FUnicodeCharacterByteCount
      write SetUnicodeCharacterByteCount;
  end;
  ...
  public
    ...
    property CharacterProperties: TdxCharacterFormattingBase
      read FCharacterProperties;
    property IncludeInformationFromPreviousLevel: Boolean
      read FIncludeInformationFromPreviousLevel
      write FIncludeInformationFromPreviousLevel;
  ...
  public
    ...
    property Items[Index: Integer]: TdxRtfOldListLevelInfo
      read GetItem; default;
  end;

  TdxRtfOldListLevelInfoCollectionClass = class of
    TdxRtfOldListLevelInfoCollection;

  { TdxRtfInputPositionState }

  TdxRtfFontType = (Undefined, DoubleByteCharactersFont, LowAnsiCharactersFont,
  ...
  public
    ...
    property CurrentOldListSkipNumbering: Boolean
      read FCurrentOldListSkipNumbering;
    property CurrentOldMultiLevelListIndex: TdxNumberingListIndex
      read FCurrentOldMultiLevelListIndex;
    property CurrentOldSimpleList: Boolean read FCurrentOldSimpleList
      write FCurrentOldSimpleList;
    property CurrentOldSimpleListIndex: TdxNumberingListIndex
      read FCurrentOldSimpleListIndex;
    property DoubleByteCharactersFontName: string
      read FDoubleByteCharactersFontName;
    property ParagraphFrameFormattingInfo: TdxParagraphFrameFormattingInfo
      read FParagraphFrameFormattingInfo;
    property LowAnsiCharactersFontName: string read FLowAnsiCharactersFontName
      write FLowAnsiCharactersFontName;
    property HighAnsiCharactersFontName: string read FHighAnsiCharactersFontName
      write FHighAnsiCharactersFontName;
    property ParagraphFormattingInfo: TdxRtfParagraphFormattingInfo
      read FParagraphFormattingInfo;
    ...
    property OldListLevelInfoCollection: TdxRtfOldListLevelInfoCollection
      read FOldListLevelInfoCollection;
  ...
  public
    ...
    property RestartPageNumbering: Boolean read FRestartPageNumbering
      write FRestartPageNumbering;
  end;
  ...
  private
    ...
    procedure SetOldListLevelInfoCollection(const Value
      : TdxRtfOldListLevelInfoCollection);
    procedure SetParagraphFormattingInfo(const Value
      : TdxRtfParagraphFormattingInfo);
    procedure SetRtfFormattingInfo(const Value: TdxRtfFormattingInfo);
    procedure SetParagraphFrameFormattingInfo(const Value
  ...
  public
    constructor Create(APieceTable: TdxSimplePieceTable;
      AImporter: TdxRtfImporter); reintroduce;
    destructor Destroy; override;
    ...
    property CurrentOldMultiLevelListIndex: TdxNumberingListIndex
      read FCurrentOldMultiLevelListIndex write FCurrentOldMultiLevelListIndex;
    property CurrentOldSimpleListIndex: TdxNumberingListIndex
      read FCurrentOldSimpleListIndex write FCurrentOldSimpleListIndex;
    property CurrentOldListSkipNumbering: Boolean
      read FCurrentOldListSkipNumbering write FCurrentOldListSkipNumbering;
    property CurrentOldSimpleList: Boolean read FCurrentOldSimpleList
      write FCurrentOldSimpleList;
    property CurrentOldListLevelNumber: Integer read FCurrentOldListLevelNumber
      write FCurrentOldListLevelNumber;
    property DoubleByteCharactersFontName: string
      read FDoubleByteCharactersFontName write FDoubleByteCharactersFontName;
    property FieldInfo: TdxRtfFieldInfo read FFieldInfo;
    property FontType: TdxRtfFontType read FFontType write FFontType;
    property ParagraphFrameFormattingInfo: TdxParagraphFrameFormattingInfo
      read FParagraphFrameFormattingInfo write SetParagraphFrameFormattingInfo;
    property IsContainsParagraphFrame: Boolean read FIsContainsParagraphFrame
      write FIsContainsParagraphFrame;
    property LowAnsiCharactersFontName: string read FLowAnsiCharactersFontName
      write FLowAnsiCharactersFontName;
    property HighAnsiCharactersFontName: string read FHighAnsiCharactersFontName
      write FHighAnsiCharactersFontName;
    property OldListLevelInfo: TdxRtfOldListLevelInfo read FOldListLevelInfo
      write SetOldListLevelInfo;
    property OldListLevelInfoCollection: TdxRtfOldListLevelInfoCollection
      read GetOldListLevelInfoCollection;
    property ParagraphFormattingInfo: TdxRtfParagraphFormattingInfo
      read FParagraphFormattingInfo write SetParagraphFormattingInfo;
    property RtfFormattingInfo: TdxRtfFormattingInfo read FRtfFormattingInfo
      write SetRtfFormattingInfo;
    property SectionFormattingInfo: TdxRtfSectionFormattingInfo
      read FSectionFormattingInfo;
    property TableStyleIndex: Integer read FTableStyleIndex
      write FTableStyleIndex;
    property UseDoubleByteCharactersFontName: Boolean
      read FUseDoubleByteCharactersFontName
      write FUseDoubleByteCharactersFontName;
    property UseHighAnsiCharactersFontName: Boolean
      read FUseHighAnsiCharactersFontName write FUseHighAnsiCharactersFontName;
    property UseLowAnsiCharactersFontName: Boolean
      read FUseLowAnsiCharactersFontName write FUseLowAnsiCharactersFontName;
  end;
  ...
  public
    constructor Create(AInputPositionState: TdxRtfInputPositionState;
      ADestination: TdxRichEditRtfDestinationBase);

    property Destination: TdxRichEditRtfDestinationBase read FDestination;
    property InputPositionState: TdxRtfInputPositionState
      read FInputPositionState;
  end;

  TdxRichEditRtfParserStateItems = class
    (TdxObjectStack<TdxRichEditRtfParserStateItem>);
  ...
  protected
    ...
    procedure SetDestinationCore(Value: TdxRichEditRtfDestinationBase;
      AUpdatePieceTableInfo: Boolean);
  ...
  public
    ...
    property Importer: TdxRtfImporter read FImporter;
    property ParsingState: TdxRichEditRtfParsingState read FParsingState
      write FParsingState;
    property PieceTableInfo: TdxRichEditRtfPieceTableInfo
      read GetPieceTableInfo;
  ...
  public
    class function CreateDisplayFormatStringCore(APlaceholderIndices
      : TdxIntegerList; const AText: string): string; static;
    class function GetTextRange(APlaceholderIndices: TdxIntegerList;
      AStartPlaceHolderIndex: Integer; const AText: string): string; static;
  end;
  ...
  protected
    ...
    function CreateDisplayFormatStringCore(APlaceholderIndices: TdxIntegerList)
      : string; virtual;
  public
  ...
  public
    ...
    property Name: string read FName write FName;
    property NumberingListType: TdxRtfNumberingListType read FNumberingListType
      write FNumberingListType;
    property ParentStyleID: TdxRtfListID read FParentStyleID
      write FParentStyleID;
  ...
  public
    ...
    property OverrideStartAt: Boolean read FOverrideStartAt
      write FOverrideStartAt;
  ...
  public
    ...
    property DefaultCodePage: Integer read FDefaultCodePage
      write FDefaultCodePage;
    property DefaultFontNumber: Integer read FDefaultFontNumber
      write FDefaultFontNumber;
    property DefaultSectionProperties: TdxRtfSectionFormattingInfo
      read FDefaultSectionProperties;
    ...
    property ListTableComplete: Boolean read FListTableComplete
      write FListTableComplete;
    property ListOverrideTableComplete: Boolean read FListOverrideTableComplete
      write FListOverrideTableComplete;
  ...
  strict private
    ...
    FListOverrideIndexToNumberingListIndexMap
      : TDictionary<Integer, TdxNumberingListIndex>;
    FNextParagraphStyleIndexTable: TdxIntegersDictionary;
    FNumberingListToOldListLevelInfoMap
      : TDictionary<TdxNumberingListIndex, TdxRtfOldListLevelInfo>;
    FOptionalGroupLevel: Integer;
    FParagraphStyleCollectionIndex: TdxIntegersDictionary;
    FParagraphStyleListOverrideIndexMap
      : TObjectDictionary<TdxParagraphStyle, TdxRtfNumberingListInfo>;
    ...
    procedure ApplyParagraphFrameFormatting(AParagraph: TdxParagraph;
      AParagraphFrameFormatting: TdxParagraphFrameFormattingInfo); overload;
    procedure CheckTablesStructure;
    procedure CheckTableStructure(ATable: TdxTable);
    procedure CheckVerticalMerging(APrevRowCellIndices: TArray<Integer>;
      ATableRow: TdxTableRow);
    procedure CalculateRowCellIndices(var ACellIndices: TArray<Integer>;
      ARow: TdxTableRow);
  ...
  protected
    procedure AddNumberingListToParagraph(AParagraph: TdxParagraph;
      AListIndex: TdxNumberingListIndex; ALevelIndex: Integer);
    procedure ApplyParagraphFormattingCore(AParagraph: TdxParagraph;
    ...
    procedure ConvertListLevelsToAnotherTypeCore(const ALevels
      : TdxListLevelCollection; const ADisplayFormat, AFontName: string;
    ...
    procedure TranslateKeyword(const AKeyword: string; AParameterValue: Integer;
      AHasParameter: Boolean);
    class function CheckSignature(AStream: TStream): Boolean; static;

    property OptionalGroupLevel: Integer read FOptionalGroupLevel
      write FOptionalGroupLevel;
  public
    ...
    procedure ApplyCharacterProperties(ACharacterProperties
    ...
    procedure ApplyLineSpacing(AParagraphFormatting
      : TdxRtfParagraphFormattingInfo);
    procedure ApplyParagraphFrameFormatting(AFrameProperties
      : TdxFrameProperties;
      AParagraphFrameFormatting: TdxParagraphFrameFormattingInfo); overload;
    procedure ApplyParagraphProperties(AParagraphProperties
    ...
    procedure ApplyParagraphProperties(AParagraphProperties
      : TdxParagraphProperties; AParentParagraphRtfStyleIndex: Integer;
      AParagraphFormatting: TdxRtfParagraphFormattingInfo); overload;
    procedure ApplyTableProperties(ATableProperties: TdxTableProperties;
      AParentTableProperties: TdxMergedTableProperties);
    procedure ApplyTableRowProperties(ARowProperties: TdxTableRowProperties;
      AParentRowProperties: TdxMergedTableRowProperties);
    procedure ApplyTableCellProperties(ACellProperties: TdxTableCellProperties;
      AParentCellProperties: TdxMergedTableCellProperties);
    procedure ApplyTabs(ATarget: TdxTabProperties;
      AParentParagraphRtfStyleIndex: Integer;
      AImportedTabs: TdxTabFormattingInfo);
    procedure ApplyParagraphFormatting(AParagraphIndex: TdxParagraphIndex;
      ASectionBreak: Boolean);
    ...
    function GetStyleMergedCharacterProperties(ARtfStyleIndex: Integer)
      : TdxMergedCharacterProperties; overload;
    function GetStyleMergedCharacterProperties(AParentMergedProperties
      : TdxMergedCharacterProperties): TdxMergedCharacterProperties; overload;
    function GetStyleMergedParagraphCharacterProperties(ARtfCharacterStyleIndex,
      ARtfParagraphStyleIndex: Integer): TdxMergedCharacterProperties; overload;
    function GetStyleMergedParagraphProperties(ARtfStyleIndex: Integer)
      : TdxMergedParagraphProperties; overload;
    function GetStyleMergedParagraphProperties(AParentMergedProperties
      : TdxMergedParagraphProperties): TdxMergedParagraphProperties; overload;
    function GetStyleMergedTableRowProperties(AParentMergedProperties
      : TdxMergedTableRowProperties): TdxMergedTableRowProperties;
    function GetStyleMergedTableCellProperties(AParentMergedProperties
      : TdxMergedTableCellProperties): TdxMergedTableCellProperties;
    function GetTableStyleIndex(ARtfTableStyleIndex: Integer;
      AUnknowStyleIndex: Integer = 0): Integer;
    ...
    property RangePermissions: TdxImportRangePermissionInfos
      read GetRangePermissions;
    property CharacterStyleCollectionIndex: TdxIntegersDictionary
      read FCharacterStyleCollectionIndex;
    property Destination: TdxRichEditRtfDestinationBase read GetDestination
      write SetDestination;
    property DocumentProperties: TdxRtfDocumentProperties
      read FDocumentProperties;
    property Fields: TdxObjectStack<TdxRtfFieldInfo> read GetFields;
    property IsContainsParagraphFrame: Boolean read FIsContainsParagraphFrame
      write FIsContainsParagraphFrame;
    property LinkParagraphStyleIndexToCharacterStyleIndex: TdxIntegersDictionary
      read FLinkParagraphStyleIndexToCharacterStyleIndex;
    property ListOverrideIndexToNumberingListIndexMap
      : TDictionary<Integer, TdxNumberingListIndex>
      read FListOverrideIndexToNumberingListIndexMap;
    property NextParagraphStyleIndexTable: TdxIntegersDictionary
      read FNextParagraphStyleIndexTable;
    property NumberingListToOldListLevelInfoMap
      : TDictionary<TdxNumberingListIndex, TdxRtfOldListLevelInfo>
      read FNumberingListToOldListLevelInfoMap;
    property Options: TdxRtfDocumentImporterOptions read GetOptions;
    property ParagraphStyleCollectionIndex: TdxIntegersDictionary
      read FParagraphStyleCollectionIndex;
    property ParagraphStyleListOverrideIndexMap
      : TObjectDictionary<TdxParagraphStyle, TdxRtfNumberingListInfo>
      read FParagraphStyleListOverrideIndexMap;
    property PieceTable: TdxPieceTable read GetPieceTable;
    property PieceTableInfo: TdxRichEditRtfPieceTableInfo
      read GetPieceTableInfo;
    ...
    property TableStyleCollectionIndex: TdxIntegersDictionary
      read FTableStyleCollectionIndex;
  ...
  public
    ...
    function GetDocumentImporter
      : IdxImporter<TdxRichEditDocumentFormat, Boolean>; override;
  end;
...
var
  ...
  ASize: TSize;
begin
  CreateImage(TdxMetafileHelper.CreateMetafile(AStream, AMapMode, APictureWidth,
    APictureHeight));
...
begin
  RtfImage := TdxOfficeImageReference.Create(DocumentModel.ImageCache,
    ANativeImage);
end;
...
function TdxRtfFontInfoCollection.GetRtfFontInfoById(AID: Integer)
  : TdxRtfFontInfo;
var
  I: Integer;
begin
...
function TdxRtfFontInfoCollection.CreateDefaultRtfFontInfo(ADocumentModel
  : TdxDocumentModel): TdxRtfFontInfo;
begin
...
begin
  ...
  Importer.Position.RtfFormattingInfo :=
    Importer.Position.RtfFormattingInfo.Clone;
end;
...
function TdxRichEditRtfDestinationBase.ProcessKeyword(const AKeyword: string;
...
procedure TdxRichEditRtfDestinationBase.BeforeNestedGroupFinished
  (ADestination: TdxRichEditRtfDestinationBase);
begin
...
procedure TdxRichEditRtfDestinationBase.NestedGroupFinished
  (ADestination: TdxRichEditRtfDestinationBase);
begin
  // do nothing
end;
...
begin
  if ((ControlCharHT <> nil) and ControlCharHT.TryGetValue(AChar, ATranslator))
    or DefaultControlCharHT.TryGetValue(AChar, ATranslator) then
    ATranslator(Importer, AChar);
end;

function TdxRichEditRtfDestinationBase.ProcessKeywordCore(const AKeyword
  : string; AParameterValue: Integer; AHasParameter: Boolean): Boolean;
var
...
procedure TdxRichEditRtfDestinationBase.BeforeNestedGroupFinishedCore
  (ADestination: TdxRichEditRtfDestinationBase);
begin
end;

class procedure TdxRichEditRtfDestinationBase.BinKeywordHandler
...
class procedure TdxRichEditRtfDestinationBase.UnicodeKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
  AChar: Char;
begin
...
class procedure TdxRichEditRtfDestinationBase.ColorTableKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  AImporter.Destination := TdxColorTableDestination.Create(AImporter);
end;

class procedure TdxRichEditRtfDestinationBase.FontTableKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  AImporter.Destination := TdxFontTableDestination.Create(AImporter);
end;

class procedure TdxRichEditRtfDestinationBase.UserTableKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  AImporter.Destination := TdxUserTableDestination.Create(AImporter);
end;

class procedure TdxRichEditRtfDestinationBase.AnsiKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  AImporter.SetCodePage(TdxEncoding.GetEncodingCodePage
    (TdxRtfDocumentImporterOptions.DefaultEncoding));
end;

class procedure TdxRichEditRtfDestinationBase.MacKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxRichEditRtfDestinationBase.PcKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxRichEditRtfDestinationBase.PcaKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxRichEditRtfDestinationBase.AnsiCodePageKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxRichEditRtfDestinationBase.HyphAutoKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  if not AHasParameter then
    AParameterValue := 1;
  AImporter.DocumentModel.DocumentProperties.HyphenateDocument :=
    AParameterValue <> 0;
end;

class procedure TdxRichEditRtfDestinationBase.EscapedCharHandler
  (AImporter: TdxRtfImporter; var AChar: Char);
begin
...
class procedure TdxRichEditRtfDestinationBase.SwitchToHexCharHandler
  (AImporter: TdxRtfImporter; var AChar: Char);
begin
  AImporter.StateManager.ParsingState := TdxRichEditRtfParsingState.HexData;
end;

class procedure TdxRichEditRtfDestinationBase.OptionalGroupCharHandler
  (AImporter: TdxRtfImporter; var AChar: Char);
begin
...
class function TdxRichEditRtfDestinationBase.CreateDefaultControlCharHT
  : TdxControlCharTranslatorTable;
begin
...
class function TdxRichEditRtfDestinationBase.CreateDefaultKeywordHT
  : TdxKeywordTranslatorTable;
begin
...
class function TdxRichEditRtfDestinationBase.GetControlCharHT
  : TdxControlCharTranslatorTable;
begin
  Result := nil;
end;

class function TdxRichEditRtfDestinationBase.GetKeywordHT
  : TdxKeywordTranslatorTable;
begin
  Result := nil;
end;
...
begin
  ...
  FCharacterFormattingOptions := TdxCharacterFormattingOptions.Create
    (TdxCharacterFormattingOptions.MaskUseAll);
  FPosition := TdxRtfInputPosition.Create(PieceTable, AImporter);
  FPosition.CharacterFormatting.ReplaceInfo
    (APieceTable.DocumentModel.Cache.CharacterFormattingInfoCache.DefaultItem,
    FCharacterFormattingOptions);
...
procedure TdxCodePageCharacterDecoder.ProcessChar(AImporter: TdxRtfImporter;
  AChar: Char);
begin
...
procedure TdxCodePageCharacterDecoder.FlushByChar(AImporter: TdxRtfImporter;
  const AChars: TCharArray);
var
  I: Integer;
  ADestination: TdxRichEditRtfDestinationBase;
...
procedure TdxCodePageCharacterDecoder.FlushByString(AImporter: TdxRtfImporter;
  const AChars: TCharArray);
var
  S: string;
begin
...
begin
  inherited Create(TdxEncoding.GetEncodingCodePage
    (TdxRtfDocumentImporterOptions.DefaultEncoding));
end;

procedure TdxEmptyCharacterDecoder.Flush(AImporter: TdxRtfImporter);
begin
  // do nothing
end;

procedure TdxEmptyCharacterDecoder.ProcessChar(AImporter: TdxRtfImporter;
  AChar: Char);
begin
  AImporter.Destination.ProcessChar(AChar);
end;
...
procedure TdxRtfFormattingInfo.SetDecoder(Value: TdxCodePageCharacterDecoder;
  ANeedDestroyOldDecoder: Boolean = True);
begin
...
begin
  ...
  begin
    ...
    IncludeInformationFromPreviousLevel :=
      Source.IncludeInformationFromPreviousLevel;
...
constructor TdxRtfOldListLevelInfoCollection.Create(ADocumentModel
  : TdxDocumentModel);
begin
  inherited Create;
  FDocumentModel := ADocumentModel;
...
function TdxRtfOldListLevelInfoCollection.Clone
  : TdxRtfOldListLevelInfoCollection;
begin
  if Self = nil then
    Exit(nil);
  Result := TdxRtfOldListLevelInfoCollectionClass(ClassType)
    .Create(FDocumentModel);
  Result.CopyFrom(Self);
end;

procedure TdxRtfOldListLevelInfoCollection.CopyFrom
  (ASource: TdxRtfOldListLevelInfoCollection);
var
  I: Integer;
begin
  Clear;
...
function TdxRtfOldListLevelInfoCollection.GetItem(Index: Integer)
  : TdxRtfOldListLevelInfo;
begin
  if Count <= Index then
...
constructor TdxRtfInputPosition.Create(APieceTable: TdxSimplePieceTable;
  AImporter: TdxRtfImporter);
begin
  inherited Create(APieceTable);
  FRtfFormattingInfo := TdxRtfFormattingInfo.Create
    (TdxEncoding.GetEncodingCodePage
    (TdxRtfDocumentImporterOptions.DefaultEncoding));
  TdxReferencedObject.AddReference(FRtfFormattingInfo);
  ...
  FSectionFormattingInfo := TdxRtfSectionFormattingInfo.Create
    (TdxDocumentModel(APieceTable.DocumentModel));
  SectionFormattingInfo.InitializeDefault
    (TdxDocumentModel(APieceTable.DocumentModel));
...
begin
  ...
  begin
    ...
    else if FontType = TdxRtfFontType.HighAnsiCharactersFont then
      HighAnsiCharactersFontName := AFontName
    else if FontType = TdxRtfFontType.LowAnsiCharactersFont then
...
function TdxRtfInputPosition.GetOldListLevelInfoCollection
  : TdxRtfOldListLevelInfoCollection;
begin
  if FOldListLevelInfoCollection = nil then
  begin
    FOldListLevelInfoCollection := TdxRtfOldListLevelInfoCollection.Create
      (TdxDocumentModel(PieceTable.DocumentModel));
...
procedure TdxRtfInputPosition.SetOldListLevelInfoCollection
  (const Value: TdxRtfOldListLevelInfoCollection);
begin
...
procedure TdxRtfInputPosition.SetParagraphFormattingInfo
  (const Value: TdxRtfParagraphFormattingInfo);
begin
  ParagraphFormattingInfo.CopyFrom(Value);
end;

procedure TdxRtfInputPosition.SetParagraphFrameFormattingInfo
  (const Value: TdxParagraphFrameFormattingInfo);
begin
...
procedure TdxRtfInputPosition.SetRtfFormattingInfo
  (const Value: TdxRtfFormattingInfo);
begin
  TdxReferencedObject.Release(FRtfFormattingInfo);
...
constructor TdxRichEditRtfParserStateItem.Create(AInputPositionState
  : TdxRtfInputPositionState; ADestination: TdxRichEditRtfDestinationBase);
begin
  inherited Create;
...
begin
  FStates.Push(TdxRichEditRtfParserStateItem.Create(Importer.Position.GetState,
    Destination));
...
function TdxRichEditRtfParserStateManager.CreateDefaultDestination
  : TdxRichEditRtfDestinationBase;
begin
...
begin
  FPieceTables.Push(TdxRichEditRtfPieceTableInfo.Create(Importer,
    Importer.DocumentModel.MainPieceTable));
  FDestination := CreateDefaultDestination;
  FStates.Push(TdxRichEditRtfParserStateItem.Create(nil, Destination));
end;

procedure TdxRichEditRtfParserStateManager.SetDestinationCore
  (Value: TdxRichEditRtfDestinationBase; AUpdatePieceTableInfo: Boolean);
begin
  if (Value.PieceTable <> Destination.PieceTable) and AUpdatePieceTableInfo and
    (PieceTables.Count > 0) then
  begin
    PieceTables.Pop;
    PieceTables.Push(TdxRichEditRtfPieceTableInfo.Create(Importer,
      Value.PieceTable));
  end;
  FDestination := Value;
end;

function TdxRichEditRtfParserStateManager.GetPieceTableInfo
  : TdxRichEditRtfPieceTableInfo;
begin
  Result := TdxRichEditRtfPieceTableInfo(PieceTables.Peek);
end;

procedure TdxRichEditRtfParserStateManager.SetDestination
  (const Value: TdxRichEditRtfDestinationBase);
begin
...
class function TdxListLevelDisplayTextHelper.CreateDisplayFormatStringCore
  (APlaceholderIndices: TdxIntegerList; const AText: string): string;
var
  ASb: TStringBuilder;
  I, ACount: Integer;
begin
...
class function TdxListLevelDisplayTextHelper.GetTextRange(APlaceholderIndices
  : TdxIntegerList; AStartPlaceHolderIndex: Integer;
  const AText: string): string;
var
  AIndex: Integer;
begin
  AIndex := APlaceholderIndices[AStartPlaceHolderIndex] + 1;
  Result := TdxStringHelper.Substring(AText, AIndex,
    APlaceholderIndices[AStartPlaceHolderIndex + 1] - AIndex);
...
begin
  ...
  begin
    ...
    try
      Result := TdxStringHelper.RemoveSpecialSymbols
        (CreateDisplayFormatStringCore(APlaceholderIndices));
    finally
...
function TdxRtfListLevel.CreateDisplayFormatStringCore(APlaceholderIndices
  : TdxIntegerList): string;
begin
  Result := TdxListLevelDisplayTextHelper.CreateDisplayFormatStringCore
    (APlaceholderIndices, Text);
end;
...
constructor TdxRtfSectionFormattingInfo.Create(ADocumentModel
  : TdxDocumentModel);
begin
  inherited Create;
...
procedure TdxRtfSectionFormattingInfo.InitializeDefault(ADocumentModel
  : TdxDocumentModel);
var
...
begin
  ...
  FFootNote.CopyFrom(ACache.FootNoteInfoCache
    [TdxFootNoteInfoCache.DefaultFootNoteItemIndex]);
  FEndNote.CopyFrom(ACache.FootNoteInfoCache
...
begin
  ...
  FDefaultCodePage := TdxEncoding.GetEncodingCodePage
    (TdxRtfDocumentImporterOptions.DefaultEncoding);
  ...
  FDefaultSectionProperties := TdxRtfSectionFormattingInfo.Create
    (ADocumentModel);
...
constructor TdxRtfNumberingListInfo.Create(ARtfNumberingListIndex,
...
begin
  ...
  FParagraphStyleListOverrideIndexMap :=
    TObjectDictionary<TdxParagraphStyle, TdxRtfNumberingListInfo>.Create
    ([doOwnsValues]);
  ...
  FListOverrideIndexToNumberingListIndexMap :=
    TDictionary<Integer, TdxNumberingListIndex>.Create;
  ...
  FNumberingListToOldListLevelInfoMap :=
    TObjectDictionary<TdxNumberingListIndex, TdxRtfOldListLevelInfo>.Create
    ([doOwnsValues]);
...
procedure TdxRtfImporter.ApplyCharacterProperties(ACharacterProperties
  : TdxCharacterProperties;
  ACharacterFormattingInfo: TdxCharacterFormattingInfo;
  AParentCharacterFormatting: TdxMergedCharacterProperties;
  AResetUse: Boolean = True);
...
begin
  ...
  try
    ...
    if ACharacterFormattingInfo.FontItalic <> AParentCharacterInfo.FontItalic
    then
    ...
    if ACharacterFormattingInfo.DoubleFontSize <> AParentCharacterInfo.DoubleFontSize
    then
      ACharacterProperties.DoubleFontSize :=
        ACharacterFormattingInfo.DoubleFontSize;
    if ACharacterFormattingInfo.FontUnderlineType <> AParentCharacterInfo.FontUnderlineType
    then
      ACharacterProperties.FontUnderlineType :=
        ACharacterFormattingInfo.FontUnderlineType;
    ...
    if ACharacterFormattingInfo.StrikeoutColor <> AParentCharacterInfo.StrikeoutColor
    then
      ACharacterProperties.StrikeoutColor :=
        ACharacterFormattingInfo.StrikeoutColor;
    if ACharacterFormattingInfo.FontStrikeoutType <> AParentCharacterInfo.FontStrikeoutType
    then
      ACharacterProperties.FontStrikeoutType :=
        ACharacterFormattingInfo.FontStrikeoutType;
    if ACharacterFormattingInfo.StrikeoutWordsOnly <> AParentCharacterInfo.StrikeoutWordsOnly
    then
      ACharacterProperties.StrikeoutWordsOnly :=
        ACharacterFormattingInfo.StrikeoutWordsOnly;
    if ACharacterFormattingInfo.UnderlineColor <> AParentCharacterInfo.UnderlineColor
    then
      ACharacterProperties.UnderlineColor :=
        ACharacterFormattingInfo.UnderlineColor;
    if ACharacterFormattingInfo.UnderlineWordsOnly <> AParentCharacterInfo.UnderlineWordsOnly
    then
      ACharacterProperties.UnderlineWordsOnly :=
        ACharacterFormattingInfo.UnderlineWordsOnly;
...
begin
  Position.ParagraphFormattingInfo.LineSpacing :=
    Position.ParagraphFormattingInfo.CalcLineSpacing(UnitConverter);
  Position.ParagraphFormattingInfo.LineSpacingType :=
    Position.ParagraphFormattingInfo.CalcLineSpacingType;
  AParagraph := PieceTable.Paragraphs.Last;
  ApplyParagraphFormatting(AParagraph.Index, False);
  PieceTable.InheritParagraphRunStyleCore(Position,
    TdxParagraphRun(PieceTable.Runs[AParagraph.LastRunIndex]));
end;

procedure TdxRtfImporter.ApplyLineSpacing(AParagraphFormatting
  : TdxRtfParagraphFormattingInfo);
begin
  AParagraphFormatting.LineSpacingType :=
    AParagraphFormatting.CalcLineSpacingType;
  AParagraphFormatting.LineSpacing := AParagraphFormatting.CalcLineSpacing
    (UnitConverter);
end;

procedure TdxRtfImporter.ApplyParagraphFrameFormatting(AFrameProperties
  : TdxFrameProperties; AParagraphFrameFormatting
  : TdxParagraphFrameFormattingInfo);
var
...
begin
  ...
  AParagraphFrameFormattingCacheIndex :=
    DocumentModel.Cache.ParagraphFrameFormattingInfoCache.GetItemIndex
    (AParagraphFrameFormatting);
  if AParagraphFrameFormattingCacheIndex = FLastParagraphFrameFormattingCacheIndex
  then
    AFrameProperties.SetIndexInitial(FLastParagraphFramePropertiesCacheIndex)
  else
  begin
    AProperties := TdxParagraphFrameFormattingBase.Create(PieceTable,
      DocumentModel, AParagraphFrameFormatting,
  ...
  FLastParagraphFrameFormattingCacheIndex :=
    AParagraphFrameFormattingCacheIndex;
  FLastParagraphFramePropertiesCacheIndex := AFrameProperties.Index;
end;

procedure TdxRtfImporter.ApplyFrameProperties(AParagraphIndex
  : TdxParagraphIndex);
var
  AParagraph: TdxParagraph;
...
begin
  ...
  try
    ...
    begin
      ...
      if (AMergedFrameProperties = nil) or not AParagraphFrameFormatting.Equals
        (AMergedFrameProperties.Info) then
...
procedure TdxRtfImporter.ApplyParagraphProperties(AParagraphProperties
  : TdxParagraphProperties; AParagraphFormatting: TdxParagraphFormattingInfo;
  AParentParagraphProperties: TdxMergedParagraphProperties;
  AResetUse: Boolean = True);
var
...
begin
  ...
  try
    ...
    if AParagraphFormatting.FirstLineIndentType <> AParentParagraphInfo.FirstLineIndentType
    then
      AParagraphProperties.FirstLineIndentType :=
        AParagraphFormatting.FirstLineIndentType;
    ...
    if AParagraphFormatting.FirstLineIndent <> AParentParagraphInfo.FirstLineIndent
    then
      AParagraphProperties.FirstLineIndent :=
        AParagraphFormatting.FirstLineIndent;
    if AParagraphFormatting.SuppressHyphenation <> AParentParagraphInfo.SuppressHyphenation
    then
      AParagraphProperties.SuppressHyphenation :=
        AParagraphFormatting.SuppressHyphenation;
    if AParagraphFormatting.SuppressLineNumbers <> AParentParagraphInfo.SuppressLineNumbers
    then
      AParagraphProperties.SuppressLineNumbers :=
        AParagraphFormatting.SuppressLineNumbers;
    if AParagraphFormatting.ContextualSpacing <> AParentParagraphInfo.ContextualSpacing
    then
      AParagraphProperties.ContextualSpacing :=
        AParagraphFormatting.ContextualSpacing;
    if AParagraphFormatting.PageBreakBefore <> AParentParagraphInfo.PageBreakBefore
    then
      AParagraphProperties.PageBreakBefore :=
        AParagraphFormatting.PageBreakBefore;
    if AParagraphFormatting.BeforeAutoSpacing <> AParentParagraphInfo.BeforeAutoSpacing
    then
      AParagraphProperties.BeforeAutoSpacing :=
        AParagraphFormatting.BeforeAutoSpacing;
    if AParagraphFormatting.AfterAutoSpacing <> AParentParagraphInfo.AfterAutoSpacing
    then
      AParagraphProperties.AfterAutoSpacing :=
        AParagraphFormatting.AfterAutoSpacing;
    if AParagraphFormatting.KeepWithNext <> AParentParagraphInfo.KeepWithNext
    then
      AParagraphProperties.KeepWithNext := AParagraphFormatting.KeepWithNext;
    if AParagraphFormatting.KeepLinesTogether <> AParentParagraphInfo.KeepLinesTogether
    then
      AParagraphProperties.KeepLinesTogether :=
        AParagraphFormatting.KeepLinesTogether;
    if AParagraphFormatting.WidowOrphanControl <> AParentParagraphInfo.WidowOrphanControl
    then
      AParagraphProperties.WidowOrphanControl :=
        AParagraphFormatting.WidowOrphanControl;
    if AParagraphFormatting.OutlineLevel <> AParentParagraphInfo.OutlineLevel
    then
    ...
    if AParagraphFormatting.SpacingBefore <> AParentParagraphInfo.SpacingBefore
    then
      AParagraphProperties.SpacingBefore := AParagraphFormatting.SpacingBefore;
    if AParagraphFormatting.SpacingAfter <> AParentParagraphInfo.SpacingAfter
    then
      AParagraphProperties.SpacingAfter := AParagraphFormatting.SpacingAfter;
    AShouldApplyLineSpacing := (AParagraphFormatting.LineSpacingType <>
      AParentParagraphInfo.LineSpacingType) or
      (AParagraphFormatting.LineSpacing <> AParentParagraphInfo.LineSpacing);
    if AShouldApplyLineSpacing then
    begin
      AParagraphProperties.LineSpacingType :=
        AParagraphFormatting.LineSpacingType;
      AParagraphProperties.LineSpacing := AParagraphFormatting.LineSpacing;
    end;
    if not AParagraphFormatting.LeftBorder.Equals
      (AParentParagraphInfo.LeftBorder) then
      AParagraphProperties.LeftBorder := AParagraphFormatting.LeftBorder;
    if not AParagraphFormatting.RightBorder.Equals
      (AParentParagraphInfo.RightBorder) then
      AParagraphProperties.RightBorder := AParagraphFormatting.RightBorder;
    if not AParagraphFormatting.TopBorder.Equals(AParentParagraphInfo.TopBorder)
    then
      AParagraphProperties.TopBorder := AParagraphFormatting.TopBorder;
    if not AParagraphFormatting.BottomBorder.Equals
      (AParentParagraphInfo.BottomBorder) then
...
var
  AParentParagraphProperties: TdxMergedParagraphProperties;
begin
  AParentParagraphProperties := GetStyleMergedParagraphProperties
    (AParentParagraphRtfStyleIndex);
  try
    ApplyLineSpacing(AParagraphFormatting);
    ApplyParagraphProperties(AParagraphProperties, AParagraphFormatting,
...
procedure TdxRtfImporter.ApplyTableCellProperties(ACellProperties
...
begin
  ...
  try
    if not ACellPropertiesInfo.Borders.TopBorder.Equals
      (AParentCellPropertiesInfo.Borders.TopBorder) then
      ACellProperties.Borders.TopBorder.CopyFrom
        (ACellPropertiesInfo.Borders.TopBorder);
    if not ACellPropertiesInfo.Borders.RightBorder.Equals
      (AParentCellPropertiesInfo.Borders.RightBorder) then
      ACellProperties.Borders.RightBorder.CopyFrom
        (ACellPropertiesInfo.Borders.RightBorder);
    if not ACellPropertiesInfo.Borders.LeftBorder.Equals
      (AParentCellPropertiesInfo.Borders.LeftBorder) then
      ACellProperties.Borders.LeftBorder.CopyFrom
        (ACellPropertiesInfo.Borders.LeftBorder);
    if not ACellPropertiesInfo.Borders.BottomBorder.Equals
      (AParentCellPropertiesInfo.Borders.BottomBorder) then
      ACellProperties.Borders.BottomBorder.CopyFrom
        (ACellPropertiesInfo.Borders.BottomBorder);
    if not ACellPropertiesInfo.Borders.InsideHorizontalBorder.Equals
      (AParentCellPropertiesInfo.Borders.InsideHorizontalBorder) then
      ACellProperties.Borders.InsideHorizontalBorder.CopyFrom
        (ACellPropertiesInfo.Borders.InsideHorizontalBorder);
    if not ACellPropertiesInfo.Borders.InsideVerticalBorder.Equals
      (AParentCellPropertiesInfo.Borders.InsideVerticalBorder) then
      ACellProperties.Borders.InsideVerticalBorder.CopyFrom
        (ACellPropertiesInfo.Borders.InsideVerticalBorder);
    if not ACellPropertiesInfo.Borders.TopLeftDiagonalBorder.Equals
      (AParentCellPropertiesInfo.Borders.TopLeftDiagonalBorder) then
      ACellProperties.Borders.TopLeftDiagonalBorder.CopyFrom
        (ACellPropertiesInfo.Borders.TopLeftDiagonalBorder);
    if not ACellPropertiesInfo.Borders.TopRightDiagonalBorder.Equals
      (AParentCellPropertiesInfo.Borders.TopRightDiagonalBorder) then
      ACellProperties.Borders.TopRightDiagonalBorder.CopyFrom
        (ACellPropertiesInfo.Borders.TopRightDiagonalBorder);

    if not ACellPropertiesInfo.CellMargins.Top.Equals
      (AParentCellPropertiesInfo.CellMargins.Top) then
      ACellProperties.CellMargins.Top.CopyFrom
        (ACellPropertiesInfo.CellMargins.Top);
    if not ACellPropertiesInfo.CellMargins.Right.Equals
      (AParentCellPropertiesInfo.CellMargins.Right) then
      ACellProperties.CellMargins.Right.CopyFrom
        (ACellPropertiesInfo.CellMargins.Right);
    if not ACellPropertiesInfo.CellMargins.Left.Equals
      (AParentCellPropertiesInfo.CellMargins.Left) then
      ACellProperties.CellMargins.Left.CopyFrom
        (ACellPropertiesInfo.CellMargins.Left);
    if not ACellPropertiesInfo.CellMargins.Bottom.Equals
      (AParentCellPropertiesInfo.CellMargins.Bottom) then
      ACellProperties.CellMargins.Bottom.CopyFrom
        (ACellPropertiesInfo.CellMargins.Bottom);

    if ACellPropertiesInfo.GeneralSettings.BackgroundColor <>
      AParentCellPropertiesInfo.GeneralSettings.BackgroundColor then
      ACellProperties.BackgroundColor :=
        ACellPropertiesInfo.GeneralSettings.BackgroundColor;
    if ACellPropertiesInfo.GeneralSettings.ForegroundColor <>
      AParentCellPropertiesInfo.GeneralSettings.ForegroundColor then
      ACellProperties.ForegroundColor :=
        ACellPropertiesInfo.GeneralSettings.ForegroundColor;
    if ACellPropertiesInfo.GeneralSettings.Shading <>
      AParentCellPropertiesInfo.GeneralSettings.Shading then
      ACellProperties.Shading := ACellPropertiesInfo.GeneralSettings.Shading;
    if ACellPropertiesInfo.GeneralSettings.CellConditionalFormatting <>
      AParentCellPropertiesInfo.GeneralSettings.CellConditionalFormatting then
      ACellProperties.CellConditionalFormatting :=
        ACellPropertiesInfo.GeneralSettings.CellConditionalFormatting;
    if ACellPropertiesInfo.GeneralSettings.ColumnSpan <>
      AParentCellPropertiesInfo.GeneralSettings.ColumnSpan then
      ACellProperties.ColumnSpan := ACellPropertiesInfo.GeneralSettings.
        ColumnSpan;
    if ACellPropertiesInfo.GeneralSettings.FitText <>
      AParentCellPropertiesInfo.GeneralSettings.FitText then
      ACellProperties.FitText := ACellPropertiesInfo.GeneralSettings.FitText;
    if ACellPropertiesInfo.GeneralSettings.HideCellMark <>
      AParentCellPropertiesInfo.GeneralSettings.HideCellMark then
      ACellProperties.HideCellMark := ACellPropertiesInfo.GeneralSettings.
        HideCellMark;
    if ACellPropertiesInfo.GeneralSettings.NoWrap <>
      AParentCellPropertiesInfo.GeneralSettings.NoWrap then
      ACellProperties.NoWrap := ACellPropertiesInfo.GeneralSettings.NoWrap;
    if ACellPropertiesInfo.GeneralSettings.TextDirection <>
      AParentCellPropertiesInfo.GeneralSettings.TextDirection then
      ACellProperties.TextDirection :=
        ACellPropertiesInfo.GeneralSettings.TextDirection;
    if ACellPropertiesInfo.GeneralSettings.VerticalAlignment <>
      AParentCellPropertiesInfo.GeneralSettings.VerticalAlignment then
      ACellProperties.VerticalAlignment :=
        ACellPropertiesInfo.GeneralSettings.VerticalAlignment;
    if ACellPropertiesInfo.GeneralSettings.VerticalMerging <>
      AParentCellPropertiesInfo.GeneralSettings.VerticalMerging then
      ACellProperties.VerticalMerging :=
        ACellPropertiesInfo.GeneralSettings.VerticalMerging;

    if not ACellPropertiesInfo.PreferredWidth.Equals
      (AParentCellPropertiesInfo.PreferredWidth) then
      ACellProperties.PreferredWidth.CopyFrom
        (ACellPropertiesInfo.PreferredWidth);
  finally
    ACellPropertiesInfo.Free;
  end;
end;

procedure TdxRtfImporter.ApplyTabs(ATarget: TdxTabProperties;
  AParentParagraphRtfStyleIndex: Integer; AImportedTabs: TdxTabFormattingInfo);
var
  AParentTabs, ANormalizedTabs: TdxTabFormattingInfo;
begin
  AParentTabs := GetStyleMergedTabs(AParentParagraphRtfStyleIndex);
  try
    ANormalizedTabs := TdxTabFormattingInfo.NormalizeTabs(AImportedTabs,
      AParentTabs);
    try
...
function TdxRtfImporter.GetStyleMergedTabs(ARtfStyleIndex: Integer)
...
procedure TdxRtfImporter.ApplyTableProperties(ATableProperties
  : TdxTableProperties; AParentTableProperties: TdxMergedTableProperties);
var
...
begin
  ...
  ATablePropertiesInfo := TdxCombinedTablePropertiesInfo.Create
    (ATableProperties);
  try
    if not ATablePropertiesInfo.Borders.TopBorder.Equals
      (AParentTablePropertiesInfo.Borders.TopBorder) then
      ATableProperties.Borders.TopBorder.CopyFrom
        (ATablePropertiesInfo.Borders.TopBorder);
    if not ATablePropertiesInfo.Borders.RightBorder.Equals
      (AParentTablePropertiesInfo.Borders.RightBorder) then
      ATableProperties.Borders.RightBorder.CopyFrom
        (ATablePropertiesInfo.Borders.RightBorder);
    if not ATablePropertiesInfo.Borders.LeftBorder.Equals
      (AParentTablePropertiesInfo.Borders.LeftBorder) then
      ATableProperties.Borders.LeftBorder.CopyFrom
        (ATablePropertiesInfo.Borders.LeftBorder);
    if not ATablePropertiesInfo.Borders.BottomBorder.Equals
      (AParentTablePropertiesInfo.Borders.BottomBorder) then
      ATableProperties.Borders.BottomBorder.CopyFrom
        (ATablePropertiesInfo.Borders.BottomBorder);
    if not ATablePropertiesInfo.Borders.InsideHorizontalBorder.Equals
      (AParentTablePropertiesInfo.Borders.InsideHorizontalBorder) then
      ATableProperties.Borders.InsideHorizontalBorder.CopyFrom
        (ATablePropertiesInfo.Borders.InsideHorizontalBorder);
    if not ATablePropertiesInfo.Borders.InsideVerticalBorder.Equals
      (AParentTablePropertiesInfo.Borders.InsideVerticalBorder) then
      ATableProperties.Borders.InsideVerticalBorder.CopyFrom
        (ATablePropertiesInfo.Borders.InsideVerticalBorder);
    if not ATablePropertiesInfo.CellMargins.Top.Equals
      (AParentTablePropertiesInfo.CellMargins.Top) then
      ATableProperties.CellMargins.Top.CopyFrom
        (ATablePropertiesInfo.CellMargins.Top);
    if not ATablePropertiesInfo.CellMargins.Right.Equals
      (AParentTablePropertiesInfo.CellMargins.Right) then
      ATableProperties.CellMargins.Right.CopyFrom
        (ATablePropertiesInfo.CellMargins.Right);
    if not ATablePropertiesInfo.CellMargins.Left.Equals
      (AParentTablePropertiesInfo.CellMargins.Left) then
      ATableProperties.CellMargins.Left.CopyFrom
        (ATablePropertiesInfo.CellMargins.Left);
    if not ATablePropertiesInfo.CellMargins.Bottom.Equals
      (AParentTablePropertiesInfo.CellMargins.Bottom) then
      ATableProperties.CellMargins.Bottom.CopyFrom
        (ATablePropertiesInfo.CellMargins.Bottom);
    if not ATablePropertiesInfo.CellSpacing.Equals
      (AParentTablePropertiesInfo.CellSpacing) then
      ATableProperties.CellSpacing.CopyFrom(ATablePropertiesInfo.CellSpacing);
    if not ATablePropertiesInfo.FloatingPosition.Equals
      (AParentTablePropertiesInfo.FloatingPosition) then
      ATableProperties.FloatingPosition.CopyFrom
        (ATablePropertiesInfo.FloatingPosition);
    if ATablePropertiesInfo.GeneralSettings.IsTableOverlap <>
      AParentTablePropertiesInfo.GeneralSettings.IsTableOverlap then
      ATableProperties.IsTableOverlap :=
        ATablePropertiesInfo.GeneralSettings.IsTableOverlap;
    if ATablePropertiesInfo.GeneralSettings.TableLayout <>
      AParentTablePropertiesInfo.GeneralSettings.TableLayout then
      ATableProperties.TableLayout := ATablePropertiesInfo.GeneralSettings.
        TableLayout;
    if ATablePropertiesInfo.GeneralSettings.TableLook <>
      AParentTablePropertiesInfo.GeneralSettings.TableLook then
      ATableProperties.TableLook :=
        ATablePropertiesInfo.GeneralSettings.TableLook;
    if ATablePropertiesInfo.GeneralSettings.TableStyleColBandSize <>
      AParentTablePropertiesInfo.GeneralSettings.TableStyleColBandSize then
      ATableProperties.TableStyleColBandSize :=
        ATablePropertiesInfo.GeneralSettings.TableStyleColBandSize;
    if ATablePropertiesInfo.GeneralSettings.TableStyleRowBandSize <>
      AParentTablePropertiesInfo.GeneralSettings.TableStyleRowBandSize then
      ATableProperties.TableStyleRowBandSize :=
        ATablePropertiesInfo.GeneralSettings.TableStyleRowBandSize;
    if not ATablePropertiesInfo.PreferredWidth.Equals
      (AParentTablePropertiesInfo.PreferredWidth) then
      ATableProperties.PreferredWidth.CopyFrom
        (ATablePropertiesInfo.PreferredWidth);
    if not ATablePropertiesInfo.TableIndent.Equals
      (AParentTablePropertiesInfo.TableIndent) then
...
procedure TdxRtfImporter.ApplyTableRowProperties(ARowProperties
  : TdxTableRowProperties; AParentRowProperties: TdxMergedTableRowProperties);
var
...
begin
  ...
  ARowPropertiesInfo := TdxCombinedTableRowPropertiesInfo.Create
    (ARowProperties);
  try
    if not ARowPropertiesInfo.CellSpacing.Equals
      (AParentRowPropertiesInfo.CellSpacing) then
      ARowProperties.CellSpacing.CopyFrom(ARowPropertiesInfo.CellSpacing);
    if ARowPropertiesInfo.GeneralSettings.CantSplit <>
      AParentRowPropertiesInfo.GeneralSettings.CantSplit then
      ARowProperties.CantSplit := ARowPropertiesInfo.GeneralSettings.CantSplit;
    if ARowPropertiesInfo.GeneralSettings.GridAfter <>
      AParentRowPropertiesInfo.GeneralSettings.GridAfter then
      ARowProperties.GridAfter := ARowPropertiesInfo.GeneralSettings.GridAfter;
    if ARowPropertiesInfo.GeneralSettings.GridBefore <>
      AParentRowPropertiesInfo.GeneralSettings.GridBefore then
      ARowProperties.GridBefore := ARowPropertiesInfo.GeneralSettings.
        GridBefore;
    if ARowPropertiesInfo.GeneralSettings.Header <>
      AParentRowPropertiesInfo.GeneralSettings.Header then
      ARowProperties.Header := ARowPropertiesInfo.GeneralSettings.Header;
    if ARowPropertiesInfo.GeneralSettings.HideCellMark <>
      AParentRowPropertiesInfo.GeneralSettings.HideCellMark then
      ARowProperties.HideCellMark := ARowPropertiesInfo.GeneralSettings.
        HideCellMark;
    if ARowPropertiesInfo.GeneralSettings.TableRowAlignment <>
      AParentRowPropertiesInfo.GeneralSettings.TableRowAlignment then
      ARowProperties.TableRowAlignment :=
        ARowPropertiesInfo.GeneralSettings.TableRowAlignment;

    if not ARowPropertiesInfo.Height.Equals(AParentRowPropertiesInfo.Height)
    then
      ARowProperties.Height.CopyFrom(ARowPropertiesInfo.Height);
    if not ARowPropertiesInfo.WidthAfter.Equals
      (AParentRowPropertiesInfo.WidthAfter) then
      ARowProperties.WidthAfter.CopyFrom(ARowPropertiesInfo.WidthAfter);
    if not ARowPropertiesInfo.WidthBefore.Equals
      (AParentRowPropertiesInfo.WidthBefore) then
...
procedure TdxRtfImporter.ApplyParagraphFormatting(AParagraphIndex
  : TdxParagraphIndex; ASectionBreak: Boolean);
var
  AParagraph: TdxParagraph;
  AParagraphFormatting: TdxRtfParagraphFormattingInfo;
...
begin
  ...
  begin
    ...
    if (AListIndex >= 0) or (AListIndex = NumberingListIndexNoNumberingList)
    then
    begin
      if not(ASectionBreak and AParagraph.IsEmpty) then
      begin
        AListLevelIndex := AParagraphFormatting.ListLevelIndex;
        if (AListLevelIndex < 0) or (AListLevelIndex > 12) or
          (AListLevelIndex = 9) then
          AListLevelIndex := 0;
    ...
    else if not Position.CurrentOldListSkipNumbering then
    begin
      Position.CurrentOldMultiLevelListIndex :=
        NumberingListIndexNoNumberingList;
  ...
  if Position.ParagraphFormattingInfo.RtfTableStyleIndexForRowOrCell <> 0 then
    PieceTableInfo.ParagraphTableStyles.AddOrSetValue(AParagraphIndex,
      Position.ParagraphFormattingInfo.RtfTableStyleIndexForRowOrCell);
end;

procedure TdxRtfImporter.ApplySectionFormatting(ASkipNumbering
  : Boolean = False);
var
...
begin
  ...
  AParagraphFormatting := Position.ParagraphFormattingInfo;
  AListIndex := AParagraphFormatting.NumberingListIndex;
  if not ASkipNumbering and (AListIndex >= 0) and
    TdxDocumentFormatsHelper.ShouldInsertNumbering(DocumentModel) then
  begin
    ...
    if not AParagraph.IsInList then
      AddNumberingListToParagraph(AParagraph,
        AParagraphFormatting.NumberingListIndex,
        AParagraphFormatting.ListLevelIndex);
  end
  else
  begin
    Position.CurrentOldSimpleListIndex := NumberingListIndexNoNumberingList;
  ...
  begin
    ASection.PageNumbering.FirstPageNumber :=
      ASectionFormatting.PageNumbering.FirstPageNumber;
...
begin
  ...
  try
    ...
    try
      DocumentModel.EndSetContent(TdxDocumentModelChangeType.LoadNewDocument,
        UpdateFields, Options.PasteFromIE, AUpdateOptions);
    finally
      AUpdateOptions.Free;
    end;
  end;
...
const
  ResultMap: array [Boolean] of TdxRichEditPopRtfState =
    (TdxRichEditPopRtfState.StackEmpty, TdxRichEditPopRtfState.StackNonEmpty);
var
...
function TdxRtfImporter.GetCharacterStyleIndex(ARtfCharacterStyleIndex
  : Integer): Integer;
begin
...
function TdxRtfImporter.GetParagraphStyleIndex(ARtfParagraphStyleIndex
  : Integer): Integer;
begin
...
function TdxRtfImporter.GetStyleMergedCharacterProperties(ARtfStyleIndex
  : Integer): TdxMergedCharacterProperties;
var
  AStyleIndex: Integer;
  AMergedProperties: TdxMergedCharacterProperties;
begin
  AStyleIndex := GetCharacterStyleIndex(ARtfStyleIndex);
  AMergedProperties := DocumentModel.CharacterStyles[AStyleIndex]
...
function TdxRtfImporter.GetStyleMergedCharacterProperties
  (AParentMergedProperties: TdxMergedCharacterProperties)
...
function TdxRtfImporter.GetStyleMergedParagraphCharacterProperties
  (ARtfCharacterStyleIndex, ARtfParagraphStyleIndex: Integer)
  : TdxMergedCharacterProperties;
var
...
begin
  ...
  Result := DocumentModel.CharacterStyles[ACharacterStyleIndex]
    .GetMergedCharacterProperties;
  AParagraphResult := DocumentModel.ParagraphStyles[AParagraphStyleIndex]
    .GetMergedCharacterProperties;
  try
...
function TdxRtfImporter.GetStyleMergedParagraphProperties(ARtfStyleIndex
  : Integer): TdxMergedParagraphProperties;
var
  AStyleIndex: Integer;
  AParagraphProperties: TdxMergedParagraphProperties;
begin
  AStyleIndex := GetParagraphStyleIndex(ARtfStyleIndex);
  AParagraphProperties := DocumentModel.ParagraphStyles[AStyleIndex]
...
function TdxRtfImporter.GetStyleMergedParagraphProperties
  (AParentMergedProperties: TdxMergedParagraphProperties)
...
function TdxRtfImporter.GetStyleMergedTableCellProperties
  (AParentMergedProperties: TdxMergedTableCellProperties)
...
function TdxRtfImporter.GetStyleMergedTableRowProperties(AParentMergedProperties
  : TdxMergedTableRowProperties): TdxMergedTableRowProperties;
begin
...
function TdxRtfImporter.GetTableStyleIndex(ARtfTableStyleIndex: Integer;
  AUnknowStyleIndex: Integer = 0): Integer;
begin
...
begin
  ...
  begin
    AKeywordProcessed := Destination.ProcessKeyword(AKeyword, AParameterValue,
      AHasParameter);
    ...
    else if OptionalGroupLevel < MaxInt then
      StateManager.Destination := TdxSkipDestination.Create(Self);
  end
  else
    DecreaseSkipCount;
...
procedure TdxRtfImporter.CheckVerticalMerging(APrevRowCellIndices
  : TArray<Integer>; ATableRow: TdxTableRow);
var
  ACells: TdxTableCellCollection;
...
begin
  ...
  begin
    ...
    begin
      ...
      if (ACurrentColumnIndex > 0) and
        (APrevRowCellIndices[ACurrentColumnIndex - 1] = AExpectedIndex) then
        ThrowInvalidFile;
      ALastColumnIndex := ACurrentColumnIndex + ACells[I].ColumnSpan - 1;
      if (ALastColumnIndex + 1 < Length(APrevRowCellIndices)) and
        (APrevRowCellIndices[ALastColumnIndex + 1] = AExpectedIndex) then
        ThrowInvalidFile;
...
procedure TdxRtfImporter.CalculateRowCellIndices(var ACellIndices
  : TArray<Integer>; ARow: TdxTableRow);
var
  ACells: TdxTableCellCollection;
...
begin
  ...
  for I := 0 to ACellCount - 1 do
    AColumnIndex := ApplyCellIndices(ACellIndices, AColumnIndex,
      ACells[I].ColumnSpan, I + 1);
...
begin
  ...
  Result := (ABytesRead = Length(ASignature)) and (ASignature[0] = Ord('{')) and
    (ASignature[1] = Ord('\')) and (ASignature[2] = Ord('r')) and
    (ASignature[3] = Ord('t')) and (ASignature[4] = Ord('f'));
  if not Result then
    ThrowInvalidRtfFile;
end;
...
procedure TdxRtfImporter.AddNumberingListToParagraph(AParagraph: TdxParagraph;
  AListIndex: TdxNumberingListIndex; ALevelIndex: Integer);
begin
  if not TdxDocumentFormatsHelper.ShouldInsertMultiLevelNumbering(DocumentModel)
  then
    ALevelIndex := 0;
...
procedure TdxRtfImporter.ApplyParagraphFormattingCore(AParagraph: TdxParagraph;
  AParagraphFormatting: TdxRtfParagraphFormattingInfo);
var
...
begin
  ...
  if Assigned(FLastParagraphFormatting) and AParagraphFormatting.Equals
    (FLastParagraphFormatting) then
  begin
    AParagraphProperties.SetIndexInitial(FLastParagraphPropertiesCacheIndex);
  end
  else
  begin
    AFormattingBase := TdxParagraphFormattingBase.Create(PieceTable,
      DocumentModel, AParagraphFormatting,
      TdxParagraphFormattingOptions.RootParagraphFormattingOption);
    try
      AParagraphProperties.ReplaceInfo(AFormattingBase,
        AParagraphProperties.BatchUpdateChangeActions);
    finally
      AFormattingBase.Free;
    end;
    FreeAndNil(FLastParagraphFormatting);
    FLastParagraphFormatting :=
      AParagraphFormatting.Clone as TdxRtfParagraphFormattingInfo;
...
begin
  ...
  begin
    AFrameFormattingBase := TdxParagraphFrameFormattingBase.Create(PieceTable,
      DocumentModel, AParagraphFrameFormatting,
      TdxParagraphFrameFormattingOptions.RootParagraphFrameFormattingOption);
    try
...
procedure TdxRtfImporter.ConvertListLevelsToAnotherType
  (AListIndex: TdxNumberingListIndex);
var
...
begin
  ...
  if TdxDocumentFormatsHelper.NeedReplaceSimpleToBulletNumbering(DocumentModel)
    and (AType = TdxNumberingType.Simple) then
    ConvertListLevelsToAnotherTypeCore(AList.Levels, TdxCharacters.MiddleDot,
      'Symbol', TdxNumberingFormat.Bullet)
  else if TdxDocumentFormatsHelper.NeedReplaceBulletedLevelsToDecimal
    (DocumentModel) and (AType = TdxNumberingType.Bullet) then
    ConvertListLevelsToAnotherTypeCore(AList.Levels, '%0:s.',
      DocumentModel.DefaultCharacterProperties.FontName,
      TdxNumberingFormat.Decimal);
end;

procedure TdxRtfImporter.ConvertListLevelsToAnotherTypeCore
  (const ALevels: TdxListLevelCollection;
  const ADisplayFormat, AFontName: string; AFormat: TdxNumberingFormat);
var
  I: Integer;
  ALevel: IdxListLevel;
begin
...
procedure TdxRtfImporter.LinkParagraphStyleWithNumberingLists
...
begin
  if not ParagraphStyleListOverrideIndexMap.TryGetValue(AStyle, AInfo) then
    Exit;
  if not ListOverrideIndexToNumberingListIndexMap.TryGetValue
    (AInfo.RtfNumberingListIndex, AIndex) then
    Exit;
...
procedure TdxRtfImporter.SetDestination(const Value
  : TdxRichEditRtfDestinationBase);
begin
...
function TdxImportRtfFormat.GetDocumentImporter
  : IdxImporter<TdxRichEditDocumentFormat, Boolean>;
begin
