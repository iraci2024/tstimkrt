...
uses
  Types, SysUtils, Graphics, Windows, Controls, Generics.Defaults,
...
procedure TdxSaveDocumentCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
begin
  CheckExecutedAtUIThread;
  ApplyCommandsRestriction(AState, Options.Behavior.Save,
    InnerControl.Modified);
end;
...
procedure TdxSaveDocumentAsCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
begin
  CheckExecutedAtUIThread;
...
procedure TdxLoadDocumentCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
begin
  CheckExecutedAtUIThread;
