...
type
  TdxRichEditDeleteTableCellsDialogForm = class
...
begin
  ...
  rbCellOperationShiftLeft.Caption :=
    cxGetResourceString
    (@sdxRichEditDeleteTableCellsDialogCellOperationShiftLeft);
  rbCellOperationShiftUp.Caption :=
    cxGetResourceString(@sdxRichEditDeleteTableCellsDialogCellOperationShiftUp);
  rbCellOperationDeleteRow.Caption :=
    cxGetResourceString
    (@sdxRichEditDeleteTableCellsDialogCellOperationDeleteRow);
  rbCellOperationDeleteColumn.Caption :=
    cxGetResourceString
...
begin
  Result := TdxDeleteTableCellsFormController.Create
    (AControllerParameters as TdxDeleteTableCellsFormControllerParameters);
end;

function TdxRichEditDeleteTableCellsDialogForm.GetController
