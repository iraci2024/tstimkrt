...
{$IFDEF DELPHIXE2}
  System.UITypes,
{$ENDIF}
  Windows, Classes, Types, SysUtils, Graphics, Generics.Defaults,
  Generics.Collections,
  dxCore, cxGeometry, dxCoreClasses, dxCoreGraphics, cxGraphics, dxGDIPlusAPI,
  dxGDIPlusClasses,
...
type
  ...
  TdxDrawStringProc = procedure(AHdc: THandle; const AText: string;
    AFontInfo: TdxFontInfo; const ABounds: TRect;
    AStringFormat: TdxGPStringFormat) of object;
  ...
  public
    ...
    procedure DrawString(const AText: string; AFontInfo: TdxFontInfo;
      AForeColor: TdxAlphaColor; const ARectangle: TRect); overload;
    procedure DrawString(const AText: string; AFontInfo: TdxFontInfo;
      AForeColor: TdxAlphaColor; const ARectangle: TRect;
      AStringFormat: TdxGPStringFormat); overload;
    procedure DrawString(const AText: string; ABrush: TdxGPBrush; AFont: TFont;
      X, Y: Double); overload; virtual; abstract;
    procedure DrawString(const AText: string; AFontInfo: TdxFontInfo;
      const ARectangle: TRect); overload; virtual; abstract;
    procedure DrawString(const AText: string; AFontInfo: TdxFontInfo;
      const ARectangle: TRect; AStringFormat: TdxGPStringFormat); overload;
      virtual; abstract;

    property RectangularClipBounds: TdxRectF read GetRectangularClipBounds;
    property ClipBounds: TdxRectF read GetRectangularClipBounds
      write SetClipBounds;
    property TextForeColor: TdxAlphaColor read FTextForeColor
      write SetTextForeColor;
    property DpiY: Integer read GetDpiY;
    property AllowChangeTextForeColor: Boolean read FAllowChangeTextForeColor
      write FAllowChangeTextForeColor;

    procedure FillRectangle(ABrush: TdxGPBrush; const ABounds: TdxRectF);
      overload; virtual; abstract;
    procedure FillRectangle(AColor: TdxAlphaColor; const ABounds: TdxRectF);
      overload; virtual;
    procedure FillRectangle(ABrush: TdxGPBrush; const ABounds: TRect); overload;
      virtual; abstract;
    procedure FillRectangle(AColor: TdxAlphaColor; const ABounds: TRect);
      overload; virtual; abstract;

    procedure DrawRectangle(APen: TdxGPPen; const ABounds: TRect);
      virtual; abstract;
    procedure FillEllipse(ABrush: TdxGPBrush; const ABounds: TRect); overload;
      virtual; abstract;
    procedure FillEllipse(ABrush: TdxGPBrush; const ABounds: TdxRectF);
      overload; virtual;
    procedure FillEllipse(ABrush: TdxGPBrush; X, Y, AWidth, AHeight: Single);
      overload; virtual;
    function MeasureString(const AText: string; AFont: TdxGPFont): TdxSizeF;
      virtual; abstract;
    procedure DrawString(const AText: string; ABrush: TdxGPBrush;
      AFont: TdxGPFont; X: Single; Y: Single); overload; virtual; abstract;
    procedure DrawSpacesString(const AText: string; AFontInfo: TdxFontInfo;
      AForeColor: TdxAlphaColor; const ARectangle: TRect); overload; virtual;
    procedure DrawSpacesString(const AText: string; AFontInfo: TdxFontInfo;
      const ARectangle: TRect); overload; virtual; abstract;

    procedure DrawImage(AImg: TdxOfficeImage; const ABounds: TRect;
      ASizing: TdxImageSizeMode = TdxImageSizeMode.Normal); overload;
      virtual; abstract;
    procedure DrawImage(AImg: TdxOfficeImage; const ABounds: TRect;
    ...
    procedure DrawLines(APen: TdxGPPen; const APoints: TArray<TdxPointF>);
      virtual; abstract;
    procedure FillPolygon(ABrush: TdxGPBrush; const APoints: TArray<TdxPointF>);
      virtual; abstract;
    procedure ExcludeCellBounds(const ARect, ARowBounds: TRect);
      virtual; abstract;
    ...
    procedure TransformToPixels(var APoints: TArray<TdxPointF>); virtual;
      abstract;
    procedure TransformToLayoutUnits(var APoints: TArray<TdxPointF>); virtual;
      abstract;

    function GetPen(AColor: TdxAlphaColor): TdxGPColorPen; overload;
      virtual; abstract;
    function GetPen(AColor: TdxAlphaColor; AThickness: Single): TdxGPColorPen;
      overload; virtual; abstract;
    ...
    function TryPushRotationTransform(const ACenter: TPoint;
      AAngleInDegrees: Single): Boolean;
    procedure PushRotationTransform(const ACenter: TPoint;
      AAngleInDegrees: Single); virtual; abstract;
  ...
  public
    ...
    procedure FillRectangle(AColor: TdxAlphaColor;
    ...
    procedure DrawString(const AText: string; AFontInfo: TdxFontInfo;
      const ARectangle: TRect); override;
    procedure DrawString(const AText: string; AFontInfo: TdxFontInfo;
      const ARectangle: TRect; AStringFormat: TdxGPStringFormat); override;
    procedure DrawString(const AText: string; ABrush: TdxGPBrush;
      AFont: TdxGPFont; X: Single; Y: Single); override;
    function MeasureString(const AText: string; AFont: TdxGPFont)
      : TdxSizeF; override;
    procedure DrawSpacesString(const AText: string; AFontInfo: TdxFontInfo;
      const ARectangle: TRect); override;
    procedure DrawImage(AImg: TdxOfficeImage; const ABounds: TRect;
      ASizing: TdxImageSizeMode = TdxImageSizeMode.Normal); override;
    procedure DrawLine(APen: TdxGPPen; AX1: Single; AY1: Single; AX2: Single;
      AY2: Single); override;
    procedure DrawLines(APen: TdxGPPen;
      const APoints: TArray<TdxPointF>); override;
    procedure FillPolygon(ABrush: TdxGPBrush;
      const APoints: TArray<TdxPointF>); override;
    procedure ExcludeCellBounds(const ARect: TRect;
      const ARowBounds: TRect); override;
    ...
    procedure PushRotationTransform(const ACenter: TPoint;
      AAngleInRadians: Single); override;
  ...
  protected
    ...
    function CorrectTextDrawingBounds(AFontInfo: TdxFontInfo;
  ...
  public
    ...
    procedure SnapHeights(var AHeights: TArray<Single>); override;
    procedure SnapWidths(var AWidths: TArray<Single>); override;
    procedure FillRectangle(ABrush: TdxGPBrush;
      const AActualBounds: TRect); override;
    procedure FillRectangle(AColor: TdxAlphaColor;
      const AActualBounds: TRect); override;
    procedure FillEllipse(ABrush: TdxGPBrush; const ABounds: TRect); override;
    procedure DrawRectangle(APen: TdxGPPen; const ABounds: TRect); override;
    ...
    function MeasureString(const AText: string; AFont: TdxGPFont)
      : TdxSizeF; override;
    procedure DrawImageCore(AImg: TdxOfficeImage; const ABounds: TdxRectF;
      ASizing: TdxImageSizeMode); virtual;
    procedure DrawImage(AImg: TdxOfficeImage; const ABounds: TRect;
      ASizing: TdxImageSizeMode = TdxImageSizeMode.Normal); override;
    procedure DrawImage(AImg: TdxOfficeImage; const ABounds: TRect;
      const AImgActualSizeInLayoutUnits: TSize;
      ASizing: TdxImageSizeMode); override;
    procedure DrawLine(APen: TdxGPPen; AX1: Single; AY1: Single; AX2: Single;
      AY2: Single); override;
    procedure DrawLines(APen: TdxGPPen;
      const APoints: TArray<TdxPointF>); override;
    ...
    procedure ResetCellBoundsClip; override;
    procedure FillRectangle(AColor: TdxAlphaColor;
      const ABounds: TdxRectF); override;
    procedure FillRectangle(ABrush: TdxGPBrush;
      const ABounds: TdxRectF); override;
    function GetPen(AColor: TdxAlphaColor): TdxGPColorPen; override;
    function GetPen(AColor: TdxAlphaColor; AThickness: Single)
    ...
    procedure ReleaseBrush(ABrush: TdxGPBrush); override;
    procedure PushRotationTransform(const ACenter: TPoint;
      AAngleInDegrees: Single); override;
    procedure PopTransform; override;
    procedure PushSmoothingMode(AHighQuality: Boolean); override;
    procedure PopSmoothingMode; override;
    procedure PushPixelOffsetMode(AHighQuality: Boolean); override;
  ...
  protected
    ...
    class function SetClipToHDC(const AClipBounds: TRect; AHdc: THandle)
      : TRect; static;
    class function ExcludeClipFromHDC(const ABounds: TRect; AHdc: THandle)
      : TRect; static;
    ...
    procedure DefaultDrawStringImplementation(AHdc: THandle;
      const AText: string; AFontInfo: TdxFontInfo; const ABounds: TRect;
      AStringFormat: TdxGPStringFormat); virtual;
    procedure SpacesPlaceholdersDrawStringImplementation(AHdc: THandle;
      const AText: string; AFontInfo: TdxFontInfo; const ABounds: TRect;
      AStringFormat: TdxGPStringFormat);
    procedure DrawStringImpl(const AText: string; AFontInfo: TdxFontInfo;
      AForeColor: TdxAlphaColor; const ABounds: TRect;
      AStringFormat: TdxGPStringFormat; AImpl: TdxDrawStringProc);
    function GetMeasureHdc(AHdc: THandle): THandle; virtual;
    procedure ReleaseMeasureHdc(AMeasureHdc: THandle); virtual;
    procedure DrawNonCachedString(AHdc: THandle; AFontInfo: TdxFontInfo;
      const AText: string; const ABounds: TRect;
      AStringFormat: TdxGPStringFormat); virtual;
    function GetAlignedTextPosition(const ABounds: TRect;
      const ATextSize: TSize; AStringFormat: TdxGPStringFormat): TPoint;
    function GetAlignedTextLeft(const ABounds: TRect; ATextWidth: Integer;
      AStringFormat: TdxGPStringFormat): Integer;
    function GetAlignedTextTop(const ABounds: TRect; ATextHeight: Integer;
      AStringFormat: TdxGPStringFormat): Integer;
    function GenerateStringViewInfo(AHdc: THandle; const AText: string)
      : TdxGdiStringViewInfo;
  public
    constructor Create(AGraphics
      : TdxGraphics { const ACache: IdxGraphicsCache };
      AUnitConverter: TdxDocumentLayoutUnitConverter); reintroduce;
    destructor Destroy; override;
  ...
  public
    constructor Create(AGraphics: TdxGraphics; AMeasurer: TdxGdiBoxMeasurer);
      reintroduce;
    ...
    procedure DefaultDrawStringImplementation(AHdc: THandle;
      const AText: string; AFontInfo: TdxFontInfo; const ABounds: TRect;
      AStringFormat: TdxGPStringFormat); override;
    procedure DrawImageCore(AImg: TdxOfficeImage; const ABounds: TdxRectF;
      ASizing: TdxImageSizeMode); override;
    procedure DrawStringCore(AHdc: THandle; const AText: string;
      const ABounds: TRect; ATextInfo: TdxTextViewInfo;
  ...
  public
    procedure DrawCorner(const APainter: IdxPainterWrapper; X: Integer;
      Y: Integer; ACorner: TdxCornerViewInfoBase); virtual;
    function GetSnappedWidths(const APainter: IdxPainterWrapper;
      ACorner: TdxCornerViewInfoBase): TArray<Single>;
    function GetSnappedHeights(const APainter: IdxPainterWrapper;
      ACorner: TdxCornerViewInfoBase): TArray<Single>;
    function GetCornerSnappedPoint(const APainter: IdxPainterWrapper; X: Single;
      Y: Single; ACorner: TdxCornerViewInfoBase): TdxPointF;
    function GetCornerWidth(const APainter: IdxPainterWrapper;
      ACorner: TdxCornerViewInfoBase): Single;
    function GetCornerHeight(const APainter: IdxPainterWrapper;
      ACorner: TdxCornerViewInfoBase): Single;
  ...
  protected
    ...
    procedure DrawHorizontalLines(AColor: TdxAlphaColor;
      const AOffsets: TArray<Single>; const ALeft: TdxPointF;
      const AWidth: Single); overload; virtual;
    procedure DrawHorizontalLines(AColor: TdxAlphaColor;
      const AOffsets: TArray<Single>; const ALeft: TdxPointF;
      const AWidth: Single; AUnderline: TdxUnderline); overload; virtual;
    procedure DrawVerticalLines(AColor: TdxAlphaColor;
      const AOffsets: TArray<Single>; const ATop: TdxPointF;
  ...
  public
    ...
    destructor Destroy; override;
    procedure DrawBorder(const ABorderViewInfo: TdxTableBorderViewInfoBase;
      const ACellBounds: TRect); virtual;
    procedure DrawHorizontalBorder(AColor: TdxAlphaColor;
      const ALeft: TdxPointF; AWidth: Single); virtual; abstract;
    procedure DrawVerticalBorder(AColor: TdxAlphaColor; const ATop: TdxPointF;
      AHeight: Single); virtual; abstract;
  ...
  public
    ...
    procedure DrawVerticalBorder(AColor: TdxAlphaColor; const ATop: TdxPointF;
      AHeight: Single); override;
    procedure DrawHorizontalBorder(AColor: TdxAlphaColor;
      const ALeft: TdxPointF; AWidth: Single); override;
  end;
  ...
  private
    FOffsets: TArray<Single>;
  public
    constructor Create(const APainter: IdxPainterWrapper;
      const ACompoundArray: TArray<Single>; AWidth: Single);
    procedure DrawHorizontalBorder(AColor: TdxAlphaColor;
      const ALeft: TdxPointF; AWidth: Single); override;
    procedure DrawVerticalBorder(AColor: TdxAlphaColor; const ATop: TdxPointF;
      AHeight: Single); override;
...
procedure TransformPoints(AGraphics: TdxGraphics;
  ADestSpace, ASourceSpace: TdxGpCoordinateSpace;
  var APoints: TArray<TdxPointF>);
begin
  if Length(APoints) = 0 then
    Exit;
  GdipCheck(GdipTransformPoints(AGraphics.Handle, ADestSpace, ASourceSpace,
    @APoints[0], Length(APoints)));
end;
...
type
  ...
  public
    class function GetCorrectedBounds(AGraphics: TdxGraphics;
      const ASizeInPixel: TSize; const ABounds: TdxRectF): TdxRectF;
  end;

class function TdxSnapToDevicePixelsHelper.GetCorrectedBounds
  (AGraphics: TdxGraphics; const ASizeInPixel: TSize; const ABounds: TdxRectF)
  : TdxRectF;
var
...
begin
  ...
  TransformPoints(AGraphics, TdxGpCoordinateSpace.CoordinateSpaceDevice,
    TdxGpCoordinateSpace.CoordinateSpaceWorld, APoints);
  AScreenWidth := Trunc(APoints[1].X - APoints[0].X);
  AScreenHeight := Trunc(APoints[1].Y - APoints[0].Y);
  if (Abs(ASizeInPixel.cx - AScreenWidth) <= 5) and
    (Abs(ASizeInPixel.cy - AScreenHeight) <= 5) then
  begin
    ...
    TransformPoints(AGraphics, TdxGpCoordinateSpace.CoordinateSpaceWorld,
      TdxGpCoordinateSpace.CoordinateSpaceDevice, APoints);
...
function TdxPainter.TryPushRotationTransform(const ACenter: TPoint;
  AAngleInDegrees: Single): Boolean;
begin
...
procedure TdxPainter.FillEllipse(ABrush: TdxGPBrush;
  X, Y, AWidth, AHeight: Single);
begin
  FillEllipse(ABrush, TRect.CreateSize(Trunc(X), Trunc(Y), Trunc(AWidth),
    Trunc(AHeight)));
end;

procedure TdxPainter.FillRectangle(AColor: TdxAlphaColor;
...
procedure TdxPainter.DrawSpacesString(const AText: string;
  AFontInfo: TdxFontInfo; AForeColor: TdxAlphaColor; const ARectangle: TRect);
begin
  TextForeColor := AForeColor;
  DrawSpacesString(AText, AFontInfo, ARectangle);
end;

procedure TdxPainter.DrawImage(AImg: TdxOfficeImage; const ABounds: TRect;
  const AImgActualSizeInLayoutUnits: TSize; ASizing: TdxImageSizeMode);
begin
end;
...
procedure TdxEmptyPainter.FillRectangle(ABrush: TdxGPBrush;
  const ABounds: TRect);
begin
end;

procedure TdxEmptyPainter.FillRectangle(AColor: TdxAlphaColor;
  const ABounds: TRect);
begin
end;
...
procedure TdxEmptyPainter.DrawString(const AText: string;
  AFontInfo: TdxFontInfo; const ARectangle: TRect);
begin
end;
...
procedure TdxEmptyPainter.DrawString(const AText: string; ABrush: TdxGPBrush;
  AFont: TdxGPFont; X: Single; Y: Single);
begin
end;

function TdxEmptyPainter.MeasureString(const AText: string; AFont: TdxGPFont)
  : TdxSizeF;
begin
  Result := TdxSizeF.Null;
end;

procedure TdxEmptyPainter.DrawSpacesString(const AText: string;
  AFontInfo: TdxFontInfo; const ARectangle: TRect);
begin
end;

procedure TdxEmptyPainter.DrawImage(AImg: TdxOfficeImage; const ABounds: TRect;
  ASizing: TdxImageSizeMode = TdxImageSizeMode.Normal);
begin
end;

procedure TdxEmptyPainter.DrawLine(APen: TdxGPPen; AX1: Single; AY1: Single;
  AX2: Single; AY2: Single);
begin
end;

procedure TdxEmptyPainter.DrawLines(APen: TdxGPPen;
  const APoints: TArray<TdxPointF>);
begin
end;

procedure TdxEmptyPainter.FillPolygon(ABrush: TdxGPBrush;
  const APoints: TArray<TdxPointF>);
begin
end;

procedure TdxEmptyPainter.ExcludeCellBounds(const ARect: TRect;
...
function TdxEmptyPainter.GetPen(AColor: TdxAlphaColor; AThickness: Single)
  : TdxGPColorPen;
begin
...
procedure TdxEmptyPainter.TransformToLayoutUnits(var APoints
  : TArray<TdxPointF>);
begin
end;

procedure TdxEmptyPainter.PushRotationTransform(const ACenter: TPoint;
  AAngleInRadians: Single);
begin
end;
...
begin
  ...
  Result.FormatFlags := (Result.FormatFlags or Ord(StringFormatFlagsNoClip) or
    Ord(StringFormatFlagsNoWrap) or Ord(StringFormatFlagsMeasureTrailingSpaces))
    and not Ord(StringFormatFlagsLineLimit);
end;

function TdxGdiPlusPainter.CorrectTextDrawingBounds(AFontInfo: TdxFontInfo;
  const ATextBounds: TRect): TRect;
begin
  Result := ATextBounds;
...
class function TdxGdiPlusPainter.CalculateGdiPlusYCorrection
...
procedure TdxGdiPlusPainter.FillRectangle(ABrush: TdxGPBrush;
  const AActualBounds: TRect);
begin
  Graphics.FillRectangle(AActualBounds, ABrush);
end;

procedure TdxGdiPlusPainter.FillRectangle(AColor: TdxAlphaColor;
  const AActualBounds: TRect);
begin
  Graphics.FillRectangle(AActualBounds, AColor);
end;

procedure TdxGdiPlusPainter.FillEllipse(ABrush: TdxGPBrush;
  const ABounds: TRect);
begin
...
procedure TdxGdiPlusPainter.DrawString(const AText: string;
  AFontInfo: TdxFontInfo; const ABounds: TRect);
begin
...
begin
  ...
  try
    ...
    try
      Graphics.DrawString(AText, AFont, AForeBrush,
        CorrectTextDrawingBounds(AFontInfo, ABounds).ToRectF, AStringFormat);
    finally
      AFont.Free;
    end;
  finally
...
procedure TdxGdiPlusPainter.DrawString(const AText: string; ABrush: TdxGPBrush;
  AFont: TdxGPFont; X: Single; Y: Single);
begin
  Graphics.DrawString(AText, AFont, ABrush, TdxRectF.CreateSize(X, Y,
    MaxInt div 4, MaxInt div 4), StringFormat);
end;

function TdxGdiPlusPainter.MeasureString(const AText: string; AFont: TdxGPFont)
  : TdxSizeF;
begin
  Result := Graphics.MeasureString(AText, AFont, MaxInt div 4, StringFormat);
end;

procedure TdxGdiPlusPainter.DrawImageCore(AImg: TdxOfficeImage;
  const ABounds: TdxRectF; ASizing: TdxImageSizeMode);
begin
  Graphics.Draw(AImg, ABounds);
end;

procedure TdxGdiPlusPainter.DrawImage(AImg: TdxOfficeImage;
  const ABounds: TRect; ASizing: TdxImageSizeMode = TdxImageSizeMode.Normal);
var
  ACorrectedBounds: TdxRectF;
begin
  ACorrectedBounds := TdxSnapToDevicePixelsHelper.GetCorrectedBounds(Graphics,
    AImg.Size, ABounds.ToRectF);
  DrawImageCore(AImg, ACorrectedBounds, ASizing);
end;

procedure TdxGdiPlusPainter.DrawImage(AImg: TdxOfficeImage;
  const ABounds: TRect; const AImgActualSizeInLayoutUnits: TSize;
...
procedure TdxGdiPlusPainter.DrawLine(APen: TdxGPPen; AX1: Single; AY1: Single;
  AX2: Single; AY2: Single);
begin
  Graphics.Line(AX1, AY1, AX2, AY2, APen);
end;

procedure TdxGdiPlusPainter.DrawLines(APen: TdxGPPen;
  const APoints: TArray<TdxPointF>);
begin
  Graphics.DrawLines(APen, APoints);
end;

procedure TdxGdiPlusPainter.FillPolygon(ABrush: TdxGPBrush;
  const APoints: TArray<TdxPointF>);
var
...
procedure TdxGdiPlusPainter.ExcludeCellBounds(const ARect: TRect;
  const ARowBounds: TRect);
begin
...
function TdxGdiPlusPainter.GetPen(AColor: TdxAlphaColor; AThickness: Single)
  : TdxGPColorPen;
begin
  Result := TdxGPColorPen.Create(AColor, AThickness);
end;
...
begin
  TransformPoints(Graphics, TdxGpCoordinateSpace.CoordinateSpaceDevice,
    TdxGpCoordinateSpace.CoordinateSpaceWorld, APoints);
end;

procedure TdxGdiPlusPainter.TransformToLayoutUnits
  (var APoints: TArray<TdxPointF>);
begin
  TransformPoints(Graphics, TdxGpCoordinateSpace.CoordinateSpaceWorld,
    TdxGpCoordinateSpace.CoordinateSpaceDevice, APoints);
end;

procedure TdxGdiPlusPainter.PushRotationTransform(const ACenter: TPoint;
  AAngleInDegrees: Single);
begin
...
constructor TdxGdiPainter.Create(AGraphics
  : TdxGraphics { const ACache: IdxGraphicsCache };
...
class function TdxGdiPainter.SetClipToHDC(const AClipBounds: TRect;
  AHdc: THandle): TRect;
var
...
begin
  ...
  AHRgn := CreateRectRgn(APoints[0].X, APoints[0].Y, APoints[1].X,
    APoints[1].Y);
  try
...
class function TdxGdiPainter.ExcludeClipFromHDC(const ABounds: TRect;
  AHdc: THandle): TRect;
var
  APoints: array [0 .. 1] of TPoint;
begin
...
procedure TdxGdiPainter.ExcludeCellBounds(const ARect: TRect;
  const ARowBounds: TRect);
begin
...
begin
  if HasTransform then
    ...
    DrawStringImpl(AText, TdxFontInfo(AFontInfo), TextForeColor, ABounds,
      StringFormat, SpacesPlaceholdersDrawStringImplementation);
end;

procedure TdxGdiPainter.DrawString(const AText: string; AFontInfo: TdxFontInfo;
  const ABounds: TRect);
begin
  DrawString(AText, AFontInfo, ABounds, StringFormat);
end;
...
begin
  if HasTransform then
    ...
    DrawStringImpl(AText, AFontInfo, TextForeColor, ABounds, AStringFormat,
      DefaultDrawStringImplementation);
end;

procedure TdxGdiPainter.DefaultDrawStringImplementation(AHdc: THandle;
  const AText: string; AFontInfo: TdxFontInfo; const ABounds: TRect;
  AStringFormat: TdxGPStringFormat);
begin
...
procedure TdxGdiPainter.SpacesPlaceholdersDrawStringImplementation
  (AHdc: THandle; const AText: string; AFontInfo: TdxFontInfo;
  const ABounds: TRect; AStringFormat: TdxGPStringFormat);
var
...
begin
  ...
  ExtTextOut(AHdc, ABounds.Left, ABounds.Top, ETO_GLYPH_INDEX, @AClipRect,
    @AStringViewInfo.Glyphs[0], AStringViewInfo.GlyphCount,
    @AStringViewInfo.CharacterWidths[0]);
end;

procedure TdxGdiPainter.DrawStringImpl(const AText: string;
  AFontInfo: TdxFontInfo; AForeColor: TdxAlphaColor; const ABounds: TRect;
  AStringFormat: TdxGPStringFormat; AImpl: TdxDrawStringProc);
var
  AHdc: THandle;
  ABoundsRect: TRect;
...
procedure TdxGdiPainter.DrawNonCachedString(AHdc: THandle;
  AFontInfo: TdxFontInfo; const AText: string; const ABounds: TRect;
  AStringFormat: TdxGPStringFormat);
var
  AMeasureHdc: THandle;
  AGdiFontInfo: TdxFontInfo absolute AFontInfo;
...
begin
  ...
  try
    ...
    ExtTextOut(AHdc, ADrawBounds.Left, ADrawBounds.Top, ETO_IGNORELANGUAGE,
      ABounds, AText, Length(AText), nil);
...
function TdxGdiPainter.GetAlignedTextPosition(const ABounds: TRect;
  const ATextSize: TSize; AStringFormat: TdxGPStringFormat): TPoint;
begin
  Result.Init(GetAlignedTextLeft(ABounds, ATextSize.Width, AStringFormat),
    GetAlignedTextTop(ABounds, ATextSize.Height, AStringFormat));
end;

function TdxGdiPainter.GetAlignedTextLeft(const ABounds: TRect;
  ATextWidth: Integer; AStringFormat: TdxGPStringFormat): Integer;
begin
...
function TdxGdiPainter.GetAlignedTextTop(const ABounds: TRect;
  ATextHeight: Integer; AStringFormat: TdxGPStringFormat): Integer;
begin
...
function TdxGdiPainter.GenerateStringViewInfo(AHdc: THandle;
  const AText: string): TdxGdiStringViewInfo;
var
...
begin
  ...
  APlacement := GetCharacterPlacement(AHdc, PChar(AText), ALength, 0,
    AGcpResults, GCP_USEKERNING or GCP_LIGATE);
...
constructor TdxRichEditGdiPainter.Create(AGraphics: TdxGraphics;
...
procedure TdxRichEditGdiPainter.DefaultDrawStringImplementation(AHdc: THandle;
  const AText: string; AFontInfo: TdxFontInfo; const ABounds: TRect;
  AStringFormat: TdxGPStringFormat);
var
...
procedure TdxRichEditGdiPainter.DrawImageCore(AImg: TdxOfficeImage;
  const ABounds: TdxRectF; ASizing: TdxImageSizeMode);
var
  ABrush: TdxGPBrush;
begin
...
procedure TdxRichEditGdiPainter.DrawStringCore(AHdc: THandle;
  const AText: string; const ABounds: TRect; ATextInfo: TdxTextViewInfo;
...
begin
  ...
  try
    ExtTextOut(AHdc, ABounds.Left, Y, ETO_GLYPH_INDEX or ETO_IGNORELANGUAGE,
      @ABounds, @ATextInfo.Glyphs[0], ATextInfo.GlyphCount,
      @ATextInfo.CharacterWidths[0]);
  finally
...
procedure TdxTableCornerPainter.DrawCorner(const APainter: IdxPainterWrapper;
  X: Integer; Y: Integer; ACorner: TdxCornerViewInfoBase);
var
  ...
  begin
    ...
    begin
      ...
      if ARowPattern[AColumnIndex] then
        APainter.FillRectangle
          (GetDrawingColor(ACorner.Color { , ACorner.CornerType } ),
          cxRectFBounds(ACurrentX, ACurrentY, AWidths[AColumnIndex + 1],
          AHeights[ARowIndex + 1]));
    end;
  end;
end;

function TdxTableCornerPainter.GetSnappedWidths(const APainter
  : IdxPainterWrapper; ACorner: TdxCornerViewInfoBase): TArray<Single>;
var
  I: Integer;
begin
...
function TdxTableCornerPainter.GetSnappedHeights(const APainter
  : IdxPainterWrapper; ACorner: TdxCornerViewInfoBase): TArray<Single>;
var
  I: Integer;
begin
  ...
  for I := 1 to Length(ACorner.Heights) - 1 do
    Result[I] := (ACorner.Heights[I] - ACorner.Heights[I - 1]) *
      ACorner.HeightF;
  APainter.SnapHeights(Result);
end;

function TdxTableCornerPainter.GetCornerSnappedPoint(const APainter
  : IdxPainterWrapper; X: Single; Y: Single; ACorner: TdxCornerViewInfoBase)
  : TdxPointF;
begin
  case ACorner.CornerType of
    TdxCornerViewInfoType.Normal:
      Result := APainter.GetSnappedPoint
        (dxPointF(X - (ACorner.Width + ACorner.Width mod 2) / 2, Y));
    ...
    TdxCornerViewInfoType.OuterVerticalStart:
      Result := APainter.GetSnappedPoint
        (dxPointF(X - (ACorner.Width + ACorner.Width mod 2) / 2,
        Y - ACorner.Height));
    ...
    TdxCornerViewInfoType.InnerTopMiddle:
      Result := APainter.GetSnappedPoint
        (dxPointF(X - (ACorner.Width + ACorner.Width mod 2) / 2, 0));
    ...
    TdxCornerViewInfoType.InnerLeftMiddle:
      Result := APainter.GetSnappedPoint
        (dxPointF(0, Y - (ACorner.Height + ACorner.Height mod 2) / 2));
    TdxCornerViewInfoType.InnerRightMiddle:
      Result := APainter.GetSnappedPoint(dxPointF(X - ACorner.Width,
        Y - (ACorner.Height + ACorner.Height mod 2) / 2));
...
function TdxTableCornerPainter.GetCornerWidth(const APainter: IdxPainterWrapper;
  ACorner: TdxCornerViewInfoBase): Single;
var
...
function TdxTableCornerPainter.GetCornerHeight(const APainter
  : IdxPainterWrapper; ACorner: TdxCornerViewInfoBase): Single;
var
...
function TdxTableCornerPainter.GetTotalSize(const AWidths
  : TArray<Single>): Single;
var
  I: Integer;
begin
  Result := 0;
...
constructor TdxTableBorderPainter.Create(const APainter: IdxPainterWrapper;
  AWidth: Single);
begin
  inherited Create;
  FWidthF := AWidth;
...
function TdxTableBorderPainter.GetStartSnappedPoint(const X, Y: Single)
  : TdxPointF;
var
  AWidth: Integer;
begin
  AWidth := Trunc(FWidthF);
  Result := FPainter.GetSnappedPoint
    (dxPointF(X - (AWidth + AWidth mod 2) / 2, Y));
end;

procedure TdxTableBorderPainter.DrawBorder(const ABorderViewInfo
  : TdxTableBorderViewInfoBase; const ACellBounds: TRect);
var
...
begin
  ...
  begin
    ...
    if ABorderViewInfo.HasStartCorner then
      ALeft := FCornerPainter.GetCornerSnappedPoint(Painter, X, Y,
        ABorderViewInfo.StartCorner)
    else
      ALeft := Painter.GetSnappedPoint(dxPointF(X, Y));
    if ABorderViewInfo.HasEndCorner then
      ARight := FCornerPainter.GetCornerSnappedPoint(Painter,
        X + ACellBounds.Width, Y, ABorderViewInfo.EndCorner)
    else
      ARight := Painter.GetSnappedPoint(dxPointF(X + ACellBounds.Width, Y));
    AStartCornerWidth := 0;
    if ABorderViewInfo.HasStartCorner then
      AStartCornerWidth := FCornerPainter.GetCornerWidth(Painter,
        ABorderViewInfo.StartCorner);
    ALeft.X := ALeft.X + AStartCornerWidth;

    DrawHorizontalBorder(GetDrawingColor(ABorderViewInfo.Border.Color), ALeft,
      ARight.X - ALeft.X);
  end;
  ...
  begin
    ...
    Y := ACellBounds.Top;
    if ABorderViewInfo.HasStartCorner then
      ATop := FCornerPainter.GetCornerSnappedPoint(Painter, X, Y,
        ABorderViewInfo.StartCorner)
    else
      ATop := Painter.GetSnappedPoint(dxPointF(X, Y));
    if ABorderViewInfo.HasStartCorner and
      (ABorderViewInfo.StartCorner.CornerType <=
      TdxCornerViewInfoType.OuterVerticalEnd) then
      ATop.X := GetStartSnappedPoint(X, Y).X;
    if ABorderViewInfo.HasEndCorner then
      ABottom := FCornerPainter.GetCornerSnappedPoint(Painter, X,
        Y + ACellBounds.Height, ABorderViewInfo.EndCorner)
    else
      ABottom := Painter.GetSnappedPoint(dxPointF(X, Y + ACellBounds.Height));
    AStartCornerHeight := 0;
    if ABorderViewInfo.HasStartCorner then
      AStartCornerHeight := FCornerPainter.GetCornerHeight(Painter,
        ABorderViewInfo.StartCorner);
    ATop.Y := ATop.Y + AStartCornerHeight;
    DrawVerticalBorder(GetDrawingColor(ABorderViewInfo.Border.Color), ATop,
      ABottom.Y - ATop.Y);
  end;
end;

procedure TdxTableBorderPainter.DrawHorizontalLines(AColor: TdxAlphaColor;
  const AOffsets: TArray<Single>; const ALeft: TdxPointF; const AWidth: Single);
begin
...
procedure TdxTableBorderPainter.DrawVerticalLines(AColor: TdxAlphaColor;
  const AOffsets: TArray<Single>; const ATop: TdxPointF; const AHeight: Single);
begin
...
constructor TdxSingleBorderPainter.Create(const APainter: IdxPainterWrapper;
  AWidth: Single; AUnderline: TdxUnderline);
begin
  if AWidth = 0 then
    AWidth := 1;
...
procedure TdxSingleBorderPainter.DrawVerticalBorder(AColor: TdxAlphaColor;
  const ATop: TdxPointF; AHeight: Single);
begin
  DrawVerticalLines(AColor, FOffsets, ATop, AHeight, FUnderline);
end;

procedure TdxSingleBorderPainter.DrawHorizontalBorder(AColor: TdxAlphaColor;
  const ALeft: TdxPointF; AWidth: Single);
begin
...
constructor TdxDoubleBorderPainter.Create(const APainter: IdxPainterWrapper;
  const ACompoundArray: TArray<Single>; AWidth: Single);
var
  I: Integer;
begin
...
procedure TdxDoubleBorderPainter.DrawHorizontalBorder(AColor: TdxAlphaColor;
  const ALeft: TdxPointF; AWidth: Single);
begin
  DrawHorizontalLines(AColor, FOffsets, ALeft, AWidth);
end;

procedure TdxDoubleBorderPainter.DrawVerticalBorder(AColor: TdxAlphaColor;
  const ATop: TdxPointF; AHeight: Single);
begin
