...
type
  ...
  const
    ...
    HtmlToDocumentFontSizeTable: array [1 .. 7] of Single = (7.5, 10, 12, 13.5,
      18, 24, 36);
  strict private
    FFontSize: Integer;
  public
    ...
    function GetLargerDoubleFontSize(ADoubleFontSize: Integer): Single;
      overload;
    ...
    function GetSmallerDoubleFontSize(ADoubleFontSize: Integer)
      : Integer; overload;
  ...
  public
    ...
    property AlignmentValue: TdxParagraphAlignment read FAlignmentValue
      write SetAlignmentValue;
  ...
  public
    ...
    property ParagraphFormatting: TdxParagraphFormattingBase
      read FParagraphFormatting;
    property DefaultAlignment: TdxHtmlParagraphAlignment read FDefaultAlignment
      write FDefaultAlignment;
    property ListLevelProperties: TdxHtmlListLevelProperties
      read FListLevelProperties;
    property AdditionalIndent: Integer read FAdditionalIndent
      write FAdditionalIndent;
    property NextTableRowHeight: Integer read FNextTableRowHeight
      write FNextTableRowHeight;
    property ImageProperties: TdxHtmlImageProperties read FImageProperties
      write FImageProperties;
  ...
  public
    ...
    function GetEnumValue(const AStr: string; const ADefaultValue: T;
      ACaseSensitive: Boolean = False): T; overload;
    function GetStringValue(const AKey, ADefaultKey: T): string;
  end;

  TdxAttributeTranslateKeywordHandler = reference to procedure
    (AImporter: TdxCustomHtmlImporter; const AValue: string; ATag: TdxTagBase);
  TdxAttributeKeywordTranslatorTable = class
    (TdxNamedDelegateDictionary<TdxAttributeTranslateKeywordHandler>);
  ...
  protected
    function ApplyCssProperties(AStyleAttributeProperties: TdxCssProperties)
      : TdxParagraphFormattingOptions;
    function IsFontSizeChanged: Boolean;
    function ApplyCssPropertiesCore(AStyleAttributeProperties: TdxCssProperties)
      : TdxParagraphFormattingOptions;
    function CheckSelector(ASelector: TdxSelector): Boolean;
    function CheckSelectorCore(AElement: TdxSelectorElement;
      ACombinator: TdxCombinator): Boolean;
    ...
    function CheckSelectorName(ASimpleSelector: TdxSimpleSelector;
      ATagBase: TdxTagBase): Boolean;
    function CheckSelectorId(ASimpleSelector: TdxSimpleSelector;
      ATagBase: TdxTagBase): Boolean;
    function CheckSelectorClasses(ASimpleSelector: TdxSimpleSelector;
      ATagBase: TdxTagBase): Boolean;
    function CheckSelectorPseudoClasses(ASimpleSelector: TdxSimpleSelector;
      ATagBase: TdxTagBase): Boolean;
    function CheckSelectorAttributes(ASimpleSelector: TdxSimpleSelector;
      ATagBase: TdxTagBase): Boolean;
    function CheckSelectorAttribute(ASelectorAttribute: TdxSelectorAttribute;
      ATagBase: TdxTagBase): Boolean;
    function CheckSelectorAttributeCore(ASelectorAttributes
      : TdxSelectorAttribute; AAttr: TdxAttribute): Boolean;
    function GetRelativeProperties(AProperties: TdxCssProperties)
      : TdxCssProperties;
    function IsRelative(const ARelativeUnit: string): Boolean;
    function GetRelativeIndentProperties(const ARelativeUnit: string;
      ACssProperties: Integer): Integer;
    function GetRelativeLineSpacingProperties(const ARelativeUnit: string;
      ACssProperties: TdxParagraphFormattingBase): Single;
    function GetRelativeWidthProperties(const ARelativeUnit: string;
      ARelativeValue: Single; AFontSize: Integer): TdxWidthUnitInfo;
    function OverrideProperties(ACssProperties: TdxCssProperties)
      : TdxParagraphFormattingOptions;
    function GetOverriddenCharacterProperties(ACssCharacterProperties
      : TdxCharacterFormattingBase): TdxMergedCharacterProperties;
    function GetOverriddenParagraphProperties(ACssParagraphProperties
      : TdxParagraphFormattingBase): TdxMergedParagraphProperties;
    function GetOverriddenCellProperties(ATableCellProperties
      : TdxTableCellProperties): TdxMergedTableCellProperties;
  ...
  public
    ...
    class function GetRelativeWidth(const AUnitConverter
      : TdxDocumentModelUnitConverter; const ARelativeUnit: string;
      ARelativeValue: Single; AFontSize: Integer; ARootDoubleFontSize: Integer)
      : TdxWidthUnitInfo; static;
  end;
  ...
  strict private
    ...
    class function CreateBorderLineStyleTable
      : TdxTranslationTable<TdxBorderLineStyle>; static;
  ...
  protected
    ...
    function CreateUri(const ABaseUriString: string;
      const AValue: string): TdxUri;
    procedure IgnoredMarginPropertiesFromBlockTags;

    property Importer: TdxCustomHtmlImporter read FImporter;
    property Tag: TdxTag read GetTag;
    property AttributeTable: TdxAttributeKeywordTranslatorTable
      read GetAttributeTable;
  ...
  public
    ...
    class function CreateAttributeTable
      : TdxAttributeKeywordTranslatorTable; static;
    function DecodeStringContent(const AContentText: string;
      out ADecodeContentText: string): Boolean; virtual;
    procedure DeleteOldOpenTag; virtual;
    procedure EmptyTagProcess; virtual;
    procedure FunctionalTagProcess; virtual;
    function GetAbsoluteUri(const ABaseUriString: string; const AValue: string)
      : string; virtual;
    ...
    class procedure StyleAttributeKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure ClassAttributeKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure AddClass(ATag: TdxTagBase; const AVal: string); static;
    class procedure IdAttributeKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    ...
    class function GetColor(const AColorName: string; AStartIndex: Integer)
      : Integer; static;
    class function GetColorByRgb(const AColorName: string)
      : TdxAlphaColor; static;
    class function ParseRGB(const AValue: string): TdxAlphaColor; static;
    class function ParseMediaAttribute(const AValue: string)
      : TdxStringList; static;
    class function ConvertPixelsValueToWidthUnitInfo(AUnitConverter
      : TdxDocumentModelUnitConverter; const AValue: string)
      : TdxWidthUnitInfo; static;
    class function ReadParagraphAlignment(const AValue: string;
      var ATargetAlignment: TdxParagraphAlignment): Boolean; static;
    class function ReadVerticalAlignment(const AValue: string)
      : TdxVerticalAlignment; static;
    class function ImportBorderWidthCore(AUnitConverter
      : TdxDocumentModelUnitConverter; const AValue: string)
      : TdxWidthUnitInfo; static;
    class function ImportColor(AUnitConverter: TdxDocumentModelUnitConverter;
      const AValue: string): TdxAlphaColor; static;
    class procedure ImportBorderLineStyle(AUnitConverter
      : TdxDocumentModelUnitConverter; const AValue: string;
      ABorder: TdxHtmlBorderProperty); static;
    class procedure ImportBordersLineStyles(AUnitConverter
      : TdxDocumentModelUnitConverter; const AValue: string;
      ABordersProperties: TdxHtmlBordersProperties); static;
    class procedure ImportBordersColors(AUnitConverter
      : TdxDocumentModelUnitConverter; const AValue: string;
      ABordersProperties: TdxHtmlBordersProperties); static;
    class procedure ImportBordersWidths(AUnitConverter
      : TdxDocumentModelUnitConverter; const AValue: string;
      ABordersProperties: TdxHtmlBordersProperties); static;
    class function ImportAlignment(const AValue: string;
      var ATargetAlignment: TdxTableRowAlignment): Boolean; static;

    property ApplyStylesToInnerHtml: Boolean read GetApplyStylesToInnerHtml;
    class property BorderLineStyleTable: TdxTranslationTable<TdxBorderLineStyle>
  ...
  TdxNamespaceTagTables = class
    (TObjectDictionary<string, TdxNamespaceTagInfos>);

  { TdxNamespaceTag }

  TdxNamespaceTag = class sealed
  strict private
    class var FNamespaceTable: TdxNamespaceTagTables;
    class constructor Initialize;
    class destructor Finalize;
    class procedure CreateNamespaceTable;
  strict private
    class function FindNamespaceTagInfo(AImporter: TdxCustomHtmlImporter;
      const AName: string; out ANamespaceTagInfo: TdxNamespaceTagInfo): Boolean;
  public
    class function Create(AImporter: TdxCustomHtmlImporter): TdxTagBase;
    class function NamespaceContains(AImporter: TdxCustomHtmlImporter;
      const ATagName: string): Boolean;
    class procedure PopulateNamespaceTranslatorTable(const ANamespace: string;
...
constructor TdxTranslationTableEntry<T>.Create(const AKey: T;
  const AValue: string);
begin
  FKey := AKey;
  FValue := AValue;
...
begin
  ...
  for AHtmlFontSize := Low(HtmlToDocumentFontSizeTable)
    to High(HtmlToDocumentFontSizeTable) do
    if ADocumentFontSize < HtmlToDocumentFontSizeTable[AHtmlFontSize] then
      Break;
  Result := GetFontSize(AHtmlFontSize);
end;

function TdxHtmlFontSize.GetLargerDoubleFontSize(ADoubleFontSize
  : Integer): Single;
begin
...
function TdxHtmlFontSize.GetSmallerDoubleFontSize(ADoubleFontSize
  : Integer): Integer;
begin
...
procedure TdxHtmlParagraphAlignment.SetAlignmentValue
  (const AValue: TdxParagraphAlignment);
begin
...
begin
  ...
  FParagraphFormatting := APieceTable.DocumentModel.
    CreateEmptyParagraphFormatting;
...
function TdxHtmlInputPosition.QueryInterface(const IID: TGUID; out Obj)
  : HResult;
begin
...
procedure TdxHtmlInputPosition.CopyParagraphFormattingFrom
  (AValue: TdxHtmlInputPosition);
begin
  ParagraphFormatting.CopyFrom(AValue.ParagraphFormatting);
end;

function TdxHtmlInputPosition.CreateCellPropertiesChangedHistoryItem
  (AProperties: TdxTableCellProperties): TdxIndexChangedHistoryItemCore;
begin
  Assert(AProperties = CellProperties);
  Result := TdxIndexChangedHistoryItem.Create
    (TdxPieceTable(AProperties.PieceTable), AProperties);
end;
...
function TdxTranslationTable<T>.GetEnumValue(const AStr: string;
  const ADefaultValue: T; ACaseSensitive: Boolean = False): T;
var
  AEntry: TdxTranslationTableEntry<T>;
  S: string;
  I: Integer;
begin
  ...
  begin
    AEntry := FItems{$IFDEF DELPHIXE3}.List{$ENDIF}[I];
...
function TdxTranslationTable<T>.GetStringValue(const AKey,
  ADefaultKey: T): string;
var
...
constructor TdxTagBaseHelper.Create(AImporter: TdxCustomHtmlImporter;
  ATagBase: TdxTagBase);
begin
  FImporter := AImporter;
  FTagBase := ATagBase;
...
function TdxTagBaseHelper.ApplyCssProperties(AStyleAttributeProperties
  : TdxCssProperties): TdxParagraphFormattingOptions;
begin
  Result := ApplyCssPropertiesCore(AStyleAttributeProperties);
  if IsFontSizeChanged then
    Result.Value := Result.Value + ApplyCssPropertiesCore
      (AStyleAttributeProperties).Value;
end;
...
begin
  if OldPosition = nil then
    ...
    Result := OldPosition.CharacterFormatting.DoubleFontSize <>
      Importer.Position.CharacterFormatting.DoubleFontSize;
end;

function TdxTagBaseHelper.ApplyCssPropertiesCore(AStyleAttributeProperties
  : TdxCssProperties): TdxParagraphFormattingOptions;
var
...
begin
  ...
  AParagraphOptions := TdxParagraphFormattingOptions.Create
    (TdxParagraphFormattingOptions.MaskUseNone);
  for I := 0 to ACount - 1 do
  begin
    if CheckSelector(AStyleTagCollection[I].Selector) then
    begin
      ACssProperties := GetRelativeProperties
        (AStyleTagCollection[I].Properties);
      AOverridenOptions := OverrideProperties(ACssProperties);
      AParagraphOptions.Value := AParagraphOptions.Value +
        AOverridenOptions.Value;
    end;
  end;
...
function TdxTagBaseHelper.CheckSelectorCore(AElement: TdxSelectorElement;
  ACombinator: TdxCombinator): Boolean;
begin
  case ACombinator of
    TdxCombinator.None:
...
function TdxTagBaseHelper.CheckAncestorTag
  (AElement: TdxSelectorElement): Boolean;
var
  AIndex, I: Integer;
begin
...
function TdxTagBaseHelper.IsTrueSelector(ASimpleSelector
  : TdxSimpleSelector): Boolean;
var
  ATagBase: TdxTagBase;
begin
  if (FCurrentTagIndex >= Importer.TagsStack.Count) or (FCurrentTagIndex < 0)
  then
    Exit(False);
  ATagBase := Importer.TagsStack[FCurrentTagIndex].Tag;
  Result := (((CheckSelectorName(ASimpleSelector, ATagBase) and
    CheckSelectorId(ASimpleSelector, ATagBase)) and
    CheckSelectorClasses(ASimpleSelector, ATagBase)) and
    CheckSelectorPseudoClasses(ASimpleSelector, ATagBase)) and
    CheckSelectorAttributes(ASimpleSelector, ATagBase);
end;

function TdxTagBaseHelper.CheckSelectorName(ASimpleSelector: TdxSimpleSelector;
  ATagBase: TdxTagBase): Boolean;
var
  ASimpleSelectorName: TdxHtmlTagNameID;
begin
  ASimpleSelectorName := Importer.GetTagNameID(ASimpleSelector.Name);
  Result := (ATagBase.Name = ASimpleSelectorName) or (ASimpleSelector.Name = '')
    or (ASimpleSelector.Name = '*');
end;

function TdxTagBaseHelper.CheckSelectorId(ASimpleSelector: TdxSimpleSelector;
  ATagBase: TdxTagBase): Boolean;
begin
  Result := (ATagBase.Id = ASimpleSelector.Id) or (ASimpleSelector.Id = '');
end;

function TdxTagBaseHelper.CheckSelectorClasses(ASimpleSelector
  : TdxSimpleSelector; ATagBase: TdxTagBase): Boolean;
var
  I: Integer;
begin
...
function TdxTagBaseHelper.CheckSelectorPseudoClasses(ASimpleSelector
  : TdxSimpleSelector; ATagBase: TdxTagBase): Boolean;
begin
...
function TdxTagBaseHelper.CheckSelectorAttributes(ASimpleSelector
  : TdxSimpleSelector; ATagBase: TdxTagBase): Boolean;
var
  I: Integer;
...
function TdxTagBaseHelper.CheckSelectorAttribute(ASelectorAttribute
  : TdxSelectorAttribute; ATagBase: TdxTagBase): Boolean;
var
  I: Integer;
  AAttr: TdxAttribute;
begin
...
function TdxTagBaseHelper.CheckSelectorAttributeCore(ASelectorAttributes
  : TdxSelectorAttribute; AAttr: TdxAttribute): Boolean;
var
...
begin
  ...
  if ASelectorAttributes.AttributeConnector = '=' then
  ...
  else if ASelectorAttributes.AttributeConnector = '^=' then
    ...
    Result := (AAttr.Value = ASelectorAttrValue) or
      (TdxStringHelper.StartsWith(AAttr.Value, ASelectorAttrValue + '-'))
  else
    Result := True;
end;

function TdxTagBaseHelper.GetRelativeProperties(AProperties: TdxCssProperties)
  : TdxCssProperties;
var
...
begin
  ...
  if IsRelative(ARelativeProperties.UnitRelativeFirstLineIndent) then
    ACssParagraphProperties.FirstLineIndent := GetRelativeIndentProperties
      (AResultRelativeProperties.UnitRelativeFirstLineIndent,
      ACssParagraphProperties.FirstLineIndent);
  if IsRelative(ARelativeProperties.UnitRelativeLeftIndent) then
    ACssParagraphProperties.LeftIndent := GetRelativeIndentProperties
      (AResultRelativeProperties.UnitRelativeLeftIndent,
      ACssParagraphProperties.LeftIndent);
  if IsRelative(ARelativeProperties.UnitRelativeRightIndent) then
    ACssParagraphProperties.RightIndent := GetRelativeIndentProperties
      (AResultRelativeProperties.UnitRelativeRightIndent,
      ACssParagraphProperties.RightIndent);
  if IsRelative(ARelativeProperties.UnitRelativeLineSpacing) then
    ACssParagraphProperties.LineSpacing := GetRelativeLineSpacingProperties
      (AResultRelativeProperties.UnitRelativeLineSpacing,
      ACssParagraphProperties);
  if IsRelative(ARelativeProperties.UnitRelativeSpacingAfter) then
    ACssParagraphProperties.SpacingAfter := GetRelativeIndentProperties
      (AResultRelativeProperties.UnitRelativeSpacingAfter,
      ACssParagraphProperties.SpacingAfter);
  if IsRelative(ARelativeProperties.UnitRelativeLineSpacing) then
    ACssParagraphProperties.SpacingBefore := GetRelativeIndentProperties
      (AResultRelativeProperties.UnitRelativeSpacingBefore,
      ACssParagraphProperties.SpacingBefore);
  if IsRelative(ARelativeProperties.UnitRelativeFontSize) then
  begin
    if ARelativeProperties.UnitRelativeFontSize = 'rem' then
      Result.CssCharacterProperties.DoubleFontSize :=
        Max(1, Round(Result.CssCharacterProperties.DoubleFontSize *
        Importer.RootDoubleFontSize / 2.0 / 100.0))
    else
      Result.CssCharacterProperties.DoubleFontSize :=
        Max(1, Round(Result.CssCharacterProperties.DoubleFontSize *
        OldPosition.CharacterFormatting.DoubleFontSize / 2.0 / 100.0));
  end;
  ...
  begin
    AWidth := GetRelativeWidthProperties(ARelativeProperties.UnitRelativeWidth,
      ARelativeProperties.RelativeWidth, AFontSize);
    AHeight := GetRelativeWidthProperties
      (ARelativeProperties.UnitRelativeHeight,
      ARelativeProperties.RelativeHeight, AFontSize);
    try
...
function TdxTagBaseHelper.GetRelativeIndentProperties(const ARelativeUnit
  : string; ACssProperties: Integer): Integer;
var
...
begin
  ...
  AValue := Round(Importer.Position.CharacterFormatting.DoubleFontSize / 2.0 *
    ACssProperties / 100.0);
  Result := Importer.UnitConverter.PointsToModelUnits(AValue);
end;

function TdxTagBaseHelper.GetRelativeLineSpacingProperties(const ARelativeUnit
  : string; ACssProperties: TdxParagraphFormattingBase): Single;
var
...
begin
  ...
  AValue := Importer.Position.CharacterFormatting.DoubleFontSize *
    ACssProperties.LineSpacing / 100.0 / 2;
  Result := Importer.UnitConverter.PointsToModelUnitsF(AValue);
end;

function TdxTagBaseHelper.GetRelativeWidthProperties(const ARelativeUnit
  : string; ARelativeValue: Single; AFontSize: Integer): TdxWidthUnitInfo;
begin
  Result := GetRelativeWidth(FImporter.UnitConverter, ARelativeUnit,
    ARelativeValue, AFontSize, Importer.RootDoubleFontSize);
end;

class function TdxTagBaseHelper.GetRelativeWidth(const AUnitConverter
  : TdxDocumentModelUnitConverter; const ARelativeUnit: string;
  ARelativeValue: Single; AFontSize: Integer; ARootDoubleFontSize: Integer)
  : TdxWidthUnitInfo;
begin
  ...
  begin
    Result.Value := AUnitConverter.PointsToModelUnits
      (Trunc(ARelativeValue * AFontSize));
    Result.&Type := TdxWidthUnitType.ModelUnits;
  end
  else if ARelativeUnit = 'ex' then
  begin
    Result.Value := AUnitConverter.PointsToModelUnits
      (Trunc(ARelativeValue * AFontSize * 2));
    Result.&Type := TdxWidthUnitType.ModelUnits;
  end
  else if ARelativeUnit = '%' then
  begin
    Result.Value := Trunc(ARelativeValue * 50);
    Result.&Type := TdxWidthUnitType.FiftiethsOfPercent;
  end
  else if ARelativeUnit = 'rem' then
  begin
    Result.Value := AUnitConverter.PointsToModelUnits
      (Trunc(ARelativeValue * ARootDoubleFontSize / 100.0));
    Result.&Type := TdxWidthUnitType.ModelUnits;
  end;
end;

function TdxTagBaseHelper.OverrideProperties(ACssProperties: TdxCssProperties)
  : TdxParagraphFormattingOptions;
var
...
begin
  ...
  AOverriddenCharacterProperties := GetOverriddenCharacterProperties
    (ACssProperties.CssCharacterProperties);
  try
    AImporterPosition.CharacterFormatting.CopyFrom
      (AOverriddenCharacterProperties.Info,
      AOverriddenCharacterProperties.Options);
  finally
    AOverriddenCharacterProperties.Free;
  end;
  AOverriddenParagraphProperties := GetOverriddenParagraphProperties
    (ACssProperties.CssParagraphProperties);
  try
    Result := TdxParagraphFormattingOptions.Create
      (ACssProperties.CssParagraphProperties.Options.Value);
    AImporterPosition.ParagraphFormatting.CopyFrom
      (AOverriddenParagraphProperties.Info,
      AOverriddenParagraphProperties.Options);
  finally
    AOverriddenParagraphProperties.Free;
  end;
  AListLevelProperties := ACssProperties.ListLevelProperties.MergeWith
    (AImporterPosition.ListLevelProperties);
  try
    AImporterPosition.ListLevelProperties.CopyFrom(AListLevelProperties);
  finally
    AListLevelProperties.Free;
  end;
  ATableProperties := ACssProperties.TableProperties.MergeWith
    (AImporterPosition.TableProperties);
  try
    AImporterPosition.TableProperties.CopyFrom(ATableProperties);
  finally
    ATableProperties.Free;
  end;
  ABordersProperties := ACssProperties.BordersProperties.MergeWith
    (AImporterPosition.TableProperties.BordersProperties);
  try
    AImporterPosition.TableProperties.BordersProperties.CopyFrom
      (ABordersProperties);
  finally
    ABordersProperties.Free;
  end;
  ATableRowProperties := ACssProperties.RowProperties.MergeWith
    (AImporterPosition.RowProperties);
  try
    AImporterPosition.RowProperties.CopyFrom(ATableRowProperties);
  finally
    ATableRowProperties.Free;
  end;
  AImageProperties := ACssProperties.ImageProperties.MergeWith
    (AImporterPosition.ImageProperties);
  try
    AImporterPosition.ImageProperties.CopyFrom(AImageProperties);
  finally
    AImageProperties.Free;
  end;
  AOverriddenCellProperties := GetOverriddenCellProperties
    (ACssProperties.CellProperties);
  try
    AImporterPosition.CellProperties.CopyFrom(AOverriddenCellProperties);
  finally
    AOverriddenCellProperties.Free;
  end;
  AImporterPositionCellPropertiesBorders :=
    AImporterPosition.CellProperties.Borders;
  ACssBordersProperties := ACssProperties.BordersProperties;
  ACssBordersProperties.TopBorder.Apply
    (AImporterPositionCellPropertiesBorders.TopBorder);
  ACssBordersProperties.LeftBorder.Apply
    (AImporterPositionCellPropertiesBorders.LeftBorder);
  ACssBordersProperties.RightBorder.Apply
    (AImporterPositionCellPropertiesBorders.RightBorder);
  ACssBordersProperties.BottomBorder.Apply
    (AImporterPositionCellPropertiesBorders.BottomBorder);
end;

function TdxTagBaseHelper.GetOverriddenCharacterProperties
  (ACssCharacterProperties: TdxCharacterFormattingBase)
  : TdxMergedCharacterProperties;
var
  ANewMergedCharacterProperties: TdxMergedCharacterProperties;
begin
  Result := TdxMergedCharacterProperties.Create(ACssCharacterProperties.Info,
    ACssCharacterProperties.Options);
  ANewMergedCharacterProperties := TdxMergedCharacterProperties.Create
    (Importer.Position.CharacterFormatting.Info,
...
function TdxTagBaseHelper.GetOverriddenParagraphProperties
  (ACssParagraphProperties: TdxParagraphFormattingBase)
  : TdxMergedParagraphProperties;
var
  ANewMergedParagraphProperties: TdxMergedParagraphProperties;
begin
  ANewMergedParagraphProperties := TdxMergedParagraphProperties.Create
    (ACssParagraphProperties.Info, ACssParagraphProperties.Options);
  try
    Result := TdxMergedParagraphProperties.Create
      (ANewMergedParagraphProperties);
    Result.MergeCore(Importer.Position.ParagraphFormatting.Info,
      Importer.Position.ParagraphFormatting.Options);

    if (ANewMergedParagraphProperties.Options.UseSpacingBefore and
      not ANewMergedParagraphProperties.Options.UseBeforeAutoSpacing) and
      Result.Options.UseBeforeAutoSpacing then
      Result.Info.BeforeAutoSpacing := False;
    if (ANewMergedParagraphProperties.Options.UseSpacingAfter and
      not ANewMergedParagraphProperties.Options.UseAfterAutoSpacing) and
...
function TdxTagBaseHelper.GetOverriddenCellProperties(ATableCellProperties
  : TdxTableCellProperties): TdxMergedTableCellProperties;
var
  ACellPropertiesInfo: TdxCombinedCellPropertiesInfo;
begin
  ACellPropertiesInfo := TdxCombinedCellPropertiesInfo.Create
    (ATableCellProperties);
  try
    Result := TdxMergedTableCellProperties.Create(ACellPropertiesInfo,
      ATableCellProperties.Info);
    Result.Merge(Importer.Position.CellProperties);
    if Importer.Position.CellProperties.GeneralSettings.ColumnSpan > 0 then
      Result.Info.GeneralSettings.ColumnSpan :=
        Importer.Position.CellProperties.GeneralSettings.ColumnSpan;
  finally
...
begin
  ...
  FCharacterFormatting := AImporter.DocumentModel.
    CreateEmptyCharacterFormatting;
...
class function TdxTagBase.CreateBorderLineStyleTable
  : TdxTranslationTable<TdxBorderLineStyle>;
begin
...
class function TdxTagBase.CreateAttributeTable
  : TdxAttributeKeywordTranslatorTable;
begin
...
class procedure TdxTagBase.StyleAttributeKeyword
  (AImporter: TdxCustomHtmlImporter; const AValue: string; ATag: TdxTagBase);
var
  ...
  try
    ...
    try
      ...
      if ACssElementCollection.Count > 0 then
        try
          ATag.FStyleAttributeProperties :=
            TdxCssProperties.Create(AImporter.PieceTable);
          ATag.FStyleAttributeProperties.CopyFrom
            (ACssElementCollection[0].Properties);
        finally
...
class procedure TdxTagBase.ClassAttributeKeyword
  (AImporter: TdxCustomHtmlImporter; const AValue: string; ATag: TdxTagBase);
var
...
class procedure TdxTagBase.IdAttributeKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
...
class function TdxTagBase.GetColor(const AColorName: string;
...
class function TdxTagBase.GetColorByRgb(const AColorName: string)
  : TdxAlphaColor;
var
  R, G, B: Integer;
begin
...
{$ENDIF}
    ...
    if AColors.Count = 3 then
      Exit(TdxAlphaColors.FromArgb(255, Byte(AColors[0]), Byte(AColors[1]),
        Byte(AColors[2])));
  finally
    AColors.Free;
  end;
...
class function TdxTagBase.ParseMediaAttribute(const AValue: string)
  : TdxStringList;
var
...
class function TdxTagBase.ConvertPixelsValueToWidthUnitInfo(AUnitConverter
  : TdxDocumentModelUnitConverter; const AValue: string): TdxWidthUnitInfo;
var
...
begin
  ...
  if TdxNumber.TryParse(AValue, AValueInPixels) then
    AParsedValue := TdxLengthValueParser.Create(AValue + 'px',
      AUnitConverter.ScreenDpi)
  else
    AParsedValue := TdxLengthValueParser.Create(AValue,
      AUnitConverter.ScreenDpi);
  ...
  else if AParsedValue.IsDigit then
  begin
    AConverter := AUnitConverter;
    Result.Value :=
      Max(0, Round(AConverter.PointsToModelUnitsF(AParsedValue.PointsValue)));
    Result.&Type := TdxWidthUnitType.ModelUnits;
  end;
end;
...
class function TdxTagBase.ReadVerticalAlignment(const AValue: string)
...
begin
  ...
  begin
    ...
    if ((AAttribute.Value <> '') or (AAttribute.Name = 'NOWRAP')) and
      AttributeTable.TryGetValue(AAttribute.Name, ATranslator) then
      ATranslator(FImporter, Importer.DecodeStringContent
        (AAttribute.Value), Self);
  end;
end;
...
function TdxTagBase.DecodeStringContent(const AContentText: string;
  out ADecodeContentText: string): Boolean;
begin
  Result := False;
end;
...
begin
  AParagraphsAllowed := Importer.DocumentModel.DocumentCapabilities.
    ParagraphsAllowed;
  if Importer.IsEmptyLine and not Importer.IsEmptyParagraph and AParagraphsAllowed
  then
  begin
...
begin
  ...
  try
    ...
    AParagraphProperties.LeftIndent := AParagraphProperties.LeftIndent +
      Importer.Position.AdditionalIndent;
    AParagraphProperties.RightIndent := AParagraphProperties.RightIndent +
      Importer.Position.AdditionalIndent;
    AParagraphProperties.EndInit;
    APieceTable.Paragraphs[AParagraphIndex].ParagraphProperties.CopyFrom
      (AParagraphProperties);
  finally
    AParagraphProperties.Free;
  end;

  APieceTable.Runs[ARunIndex].CharacterProperties.CopyFrom
    (Importer.Position.CharacterFormatting);

  if Importer.Position.ParagraphTabs.Count > 0 then
    APieceTable.Paragraphs[AParagraphIndex].Tabs.SetTabs
      (Importer.Position.ParagraphTabs);
end;

function TdxTagBase.GetAbsoluteUri(const ABaseUriString: string;
...
function TdxTagBase.CreateUri(const ABaseUriString: string;
  const AValue: string): TdxUri;
var
  ABaseUri: TdxUri;
begin
...
class function TdxTagBase.ImportBorderWidthCore(AUnitConverter
  : TdxDocumentModelUnitConverter; const AValue: string): TdxWidthUnitInfo;
var
  ANamedValue: string;
begin
...
class function TdxTagBase.ImportColor(AUnitConverter
  : TdxDocumentModelUnitConverter; const AValue: string): TdxAlphaColor;
begin
  Result := TdxMarkupLanguageColorParser.ParseColor(AValue);
end;

class procedure TdxTagBase.ImportBorderLineStyle(AUnitConverter
  : TdxDocumentModelUnitConverter; const AValue: string;
  ABorder: TdxHtmlBorderProperty);
var
  AResult: TdxBorderLineStyle;
begin
  AResult := BorderLineStyleTable.GetEnumValue(AValue,
    TdxBorderLineStyle.ThreeDEmboss);
  if AResult <> TdxBorderLineStyle.ThreeDEmboss then
    ABorder.LineStyle := AResult;
end;

class procedure TdxTagBase.ImportBordersLineStyles(AUnitConverter
  : TdxDocumentModelUnitConverter; const AValue: string;
  ABordersProperties: TdxHtmlBordersProperties);
var
...
begin
  ...
  case ALength of
    4:
      begin
        ATop := BorderLineStyleTable.GetEnumValue(ALineStyles[0],
          TdxBorderLineStyle.ThreeDEmboss);
        ARight := BorderLineStyleTable.GetEnumValue(ALineStyles[1],
          TdxBorderLineStyle.ThreeDEmboss);
        ABottom := BorderLineStyleTable.GetEnumValue(ALineStyles[2],
          TdxBorderLineStyle.ThreeDEmboss);
        ALeft := BorderLineStyleTable.GetEnumValue(ALineStyles[3],
          TdxBorderLineStyle.ThreeDEmboss);
      end;
    3:
      begin
        ATop := BorderLineStyleTable.GetEnumValue(ALineStyles[0],
          TdxBorderLineStyle.ThreeDEmboss);
        ALeft := BorderLineStyleTable.GetEnumValue(ALineStyles[1],
          TdxBorderLineStyle.ThreeDEmboss);
        ARight := ALeft;
        ABottom := BorderLineStyleTable.GetEnumValue(ALineStyles[2],
          TdxBorderLineStyle.ThreeDEmboss);
...
class procedure TdxTagBase.ImportBordersColors(AUnitConverter
  : TdxDocumentModelUnitConverter; const AValue: string;
  ABordersProperties: TdxHtmlBordersProperties);
var
  AValueNormalizedSpaces: string;
...
class procedure TdxTagBase.ImportBordersWidths(AUnitConverter
  : TdxDocumentModelUnitConverter; const AValue: string;
  ABordersProperties: TdxHtmlBordersProperties);
var
  AValueNormalizedSpaces: string;
...
begin
  ...
  case ALength of
    4:
      begin
        ATopWidth := ImportBorderWidthCore(AUnitConverter,
          ADifferentBorders[0]);
        ARightWidth := ImportBorderWidthCore(AUnitConverter,
          ADifferentBorders[1]);
        ABottomWidth := ImportBorderWidthCore(AUnitConverter,
          ADifferentBorders[2]);
        ALeftWidth := ImportBorderWidthCore(AUnitConverter,
          ADifferentBorders[3]);
      end;
    3:
      begin
...
begin
  ...
  AParagraphFormatting := ATagsStack[ATagsStack.Count - 1]
    .OldPosition.ParagraphFormatting;
  if ATagsStack.Count > 0 then
  begin
    Importer.Position.ParagraphFormatting.SpacingAfter :=
      AParagraphFormatting.SpacingAfter;
    Importer.Position.ParagraphFormatting.SpacingBefore :=
      AParagraphFormatting.SpacingBefore;
    Importer.Position.ParagraphFormatting.FirstLineIndent :=
      AParagraphFormatting.FirstLineIndent;
    Importer.Position.ParagraphFormatting.LeftIndent :=
      AParagraphFormatting.LeftIndent;
    Importer.Position.ParagraphFormatting.RightIndent :=
      AParagraphFormatting.RightIndent;
  end;
end;

class function TdxTagBase.ImportAlignment(const AValue: string;
  var ATargetAlignment: TdxTableRowAlignment): Boolean;
var
  S: string;
begin
  S := LowerCase(AValue);
...
constructor TdxNamespaceTagInfo.Create(AName: TdxHtmlTagNameID;
  ATagClass: TdxTagBaseClass);
begin
  Name := AName;
  TagClass := ATagClass;
end;
...
class function TdxNamespaceTag.Create(AImporter: TdxCustomHtmlImporter)
  : TdxTagBase;
var
  ATag: TdxTag;
...
begin
  ...
  if not FindNamespaceTagInfo(AImporter, ATag.RawText, ANamespaceTagInfo) then
    ANamespaceTagInfo := TdxNamespaceTagInfo.Create(TdxHtmlTagNameID.Unknown,
      TdxTagBase);
...
class function TdxNamespaceTag.NamespaceContains
  (AImporter: TdxCustomHtmlImporter; const ATagName: string): Boolean;
var
  ANamespaceTagInfo: TdxNamespaceTagInfo;
begin
...
class function TdxNamespaceTag.FindNamespaceTagInfo
  (AImporter: TdxCustomHtmlImporter; const AName: string;
...
begin
  ANamespaceAliasTag := TdxStringHelper.Split(TdxStringHelper.Trim(AName,
    ['<', '>', ' ']), [':']);
  if AHtmlImporter.HtmlNamespaces.TryGetValue(UpperCase(ANamespaceAliasTag[0]),
    ANamespace) then
    Result := FNamespaceTable.TryGetValue(ANamespace, ANamespaceTagInfos) and
      ANamespaceTagInfos.TryGetValue(UpperCase(ANamespaceAliasTag[1]),
      ANamespaceTagInfo)
  else
    Result := False;
end;

class procedure TdxNamespaceTag.PopulateNamespaceTranslatorTable
  (const ANamespace: string; ANamespaceTagInfos: TdxNamespaceTagInfos);
begin
  if FNamespaceTable = nil then
    CreateNamespaceTable;
