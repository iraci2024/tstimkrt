...
type
  TdxSearchFormActivePage = (Find, Replace);

  TdxTextSearchDirection = (All, Down, Up);

  { TdxSearchCompleteMessageHelper }

  TdxSearchCompleteMessageHelper = class abstract
  public
    class function GetFindInSingleDirectionCompleteMessage
      (E: TdxSearchCompleteEventArgs): string; static;
    class function GetFindCompleteMessage(E: TdxSearchCompleteEventArgs)
      : string; static;
    class function CreateFindCompleteMessage(AMatchCount: Integer;
      const AMessageTemplate: string): string; static;
    class function GetReplaceAllInSingleDirectionCompleteMessage
      (E: TdxSearchCompleteEventArgs): string; static;
    class function GetReplaceAllCompleteMessage(E: TdxSearchCompleteEventArgs)
      : string; static;
    class function CreateReplaceAllCompleteMessage(AMatchCount: Integer;
      const AMessageTemplate: string): string; static;
    class function GetCommonMessageTemplate(ASearchScope: TdxSearchScope;
      ADirection: TdxDirection): string; static;
    class function GetIntermediateResultMessage(ASearchScope: TdxSearchScope;
      ADirection: TdxDirection): string; static;
    class function GetContinueSearchQuestion(ASearchScope: TdxSearchScope;
      ADirection: TdxDirection): string; static;
    ...
    class function GetReplacementsCountMessage(AReplacementsCount: Integer)
      : string; static;
  end;
  ...
  protected
    ...
    function ShouldContinueSearch(const AMessage: string): Boolean; overload;
      virtual; abstract;
    function ShouldContinueSearch(ASearchScope: TdxSearchScope;
    ...
    procedure OnSearchComplete(E: TdxSearchCompleteEventArgs);
      overload; virtual;
    procedure OnFindComplete(E: TdxSearchCompleteEventArgs);
    procedure OnReplaceAllComplete(E: TdxSearchCompleteEventArgs);
    function GetFindInSingleDirectionCompleteMessage
      (E: TdxSearchCompleteEventArgs): string;
    function GetFindCompleteMessage(E: TdxSearchCompleteEventArgs): string;
    function GetReplaceAllInSingleDirectionCompleteMessage
      (E: TdxSearchCompleteEventArgs): string;
    function GetReplaceAllCompleteMessage
      (E: TdxSearchCompleteEventArgs): string;
  ...
  public
    ...
    property Direction: TdxTextSearchDirection read FSearchDirection
      write FSearchDirection;
  ...
  public
    constructor Create(const AControl: IdxRichEditControl;
      AActivePage: TdxSearchFormActivePage);
    property ActivePage: TdxSearchFormActivePage read FActivePage
      write FActivePage;
  end;
  ...
  protected
    ...
    function ShouldSearchInSelection(const ASelectedText: string)
      : Boolean; virtual;
  ...
  public
    ...
    property RegularExpression: Boolean read FRegularExpression
      write FRegularExpression;
    property Control: IdxRichEditControl read FControl;
    property Direction: TdxTextSearchDirection read GetDirection
      write SetDirection;
  end;
  ...
  public
    constructor Create(const ARichEditControl: IdxRichEditControl;
      AEditor: TcxCustomEdit; const AMenuCaption, AInsertStr: string;
      AShowInsertStr: Boolean = True); reintroduce;
  ...
  public
    constructor Create(AOwner: TComponent;
      const ARichEditControl: IdxRichEditControl; AEditor: TcxCustomEdit;
      const AMenuCaption, AInsertStr: string; AShowInsertStr: Boolean = True);
      reintroduce;
    destructor Destroy; override;
...
class function TdxSearchCompleteMessageHelper.
  GetFindInSingleDirectionCompleteMessage
  (E: TdxSearchCompleteEventArgs): string;
var
...
class function TdxSearchCompleteMessageHelper.GetFindCompleteMessage
  (E: TdxSearchCompleteEventArgs): string;
var
  AMessageTemplate: string;
begin
...
class function TdxSearchCompleteMessageHelper.CreateFindCompleteMessage
  (AMatchCount: Integer; const AMessageTemplate: string): string;
var
...
class function TdxSearchCompleteMessageHelper.
  GetReplaceAllInSingleDirectionCompleteMessage
  (E: TdxSearchCompleteEventArgs): string;
var
  AMessageTemplate: string;
begin
...
class function TdxSearchCompleteMessageHelper.GetReplaceAllCompleteMessage
  (E: TdxSearchCompleteEventArgs): string;
var
  AMessageTemplate: string;
begin
...
class function TdxSearchCompleteMessageHelper.CreateReplaceAllCompleteMessage
  (AMatchCount: Integer; const AMessageTemplate: string): string;
var
  AResultMessage: string;
begin
...
class function TdxSearchCompleteMessageHelper.GetCommonMessageTemplate
  (ASearchScope: TdxSearchScope; ADirection: TdxDirection): string;
var
  ASearchResultMessage, AContinueSearchQuestion: string;
begin
  ASearchResultMessage := GetIntermediateResultMessage(ASearchScope,
    ADirection);
  AContinueSearchQuestion := GetContinueSearchQuestion(ASearchScope,
    ADirection);
  Result := ASearchResultMessage + ' %s ' + AContinueSearchQuestion;
end;

class function TdxSearchCompleteMessageHelper.GetIntermediateResultMessage
  (ASearchScope: TdxSearchScope; ADirection: TdxDirection): string;
begin
  if ASearchScope = TdxSearchScope.SelectedText then
    Result := GetSearchInSelectionCompleteMessage
  else if (ASearchScope = TdxSearchScope.BelowSelectedText) and
    (ADirection = TdxDirection.Forward) then
    Result := GetSearchInForwardDirectionCompleteMessage
  else if (ASearchScope = TdxSearchScope.AboveSelectedText) and
    (ADirection = TdxDirection.Backward) then
    Result := GetSearchInBackwardDirectionCompleteMessage
  else
    Result := '';
end;

class function TdxSearchCompleteMessageHelper.GetContinueSearchQuestion
  (ASearchScope: TdxSearchScope; ADirection: TdxDirection): string;
begin
  if ASearchScope = TdxSearchScope.SelectedText then
...
class function TdxSearchCompleteMessageHelper.
  GetSearchInSelectionCompleteMessage: string;
begin
  Result := cxGetResourceString(@sdxRichEditExceptionSearchInSelectionComplete);
end;

class function TdxSearchCompleteMessageHelper.
  GetSearchInForwardDirectionCompleteMessage: string;
begin
...
class function TdxSearchCompleteMessageHelper.
  GetSearchInBackwardDirectionCompleteMessage: string;
begin
  Result := cxGetResourceString
...
class function TdxSearchCompleteMessageHelper.
  GetContinueSearchInRemainderQuestion: string;
begin
  Result := cxGetResourceString
...
class function TdxSearchCompleteMessageHelper.
  GetContinueSearchFromBeginningQuestion: string;
begin
  Result := cxGetResourceString
...
class function TdxSearchCompleteMessageHelper.
  GetContinueSearchFromEndQuestion: string;
begin
  Result := cxGetResourceString
...
class function TdxSearchCompleteMessageHelper.
  GetSearchItemNotFoundMessage: string;
begin
  Result := cxGetResourceString(@sdxRichEditExceptionSearchItemNotFound);
end;

class function TdxSearchCompleteMessageHelper.GetReplacementsCountMessage
  (AReplacementsCount: Integer): string;
begin
  Result := Format(cxGetResourceString(@sdxRichEditExceptionReplacementsCount),
    [IntToStr(AReplacementsCount)]);
end;
...
procedure TdxSearchHelperBase.OnReplaceAllComplete
...
function TdxSearchHelperBase.ShouldContinueSearch(ASearchScope: TdxSearchScope;
  const AMessage: string): Boolean;
begin
  if (Direction = TdxTextSearchDirection.All) and
    (ASearchScope <> TdxSearchScope.AboveSelectedText) then
    Result := True
  else
    Result := ShouldContinueSearch(AMessage);
end;

function TdxSearchHelperBase.GetFindInSingleDirectionCompleteMessage
  (E: TdxSearchCompleteEventArgs): string;
begin
  Result := TdxSearchCompleteMessageHelper.
    GetFindInSingleDirectionCompleteMessage(E);
end;

function TdxSearchHelperBase.GetFindCompleteMessage
  (E: TdxSearchCompleteEventArgs): string;
begin
  Result := TdxSearchCompleteMessageHelper.GetFindCompleteMessage(E);
end;

function TdxSearchHelperBase.GetReplaceAllInSingleDirectionCompleteMessage
  (E: TdxSearchCompleteEventArgs): string;
begin
  Result := TdxSearchCompleteMessageHelper.
    GetReplaceAllInSingleDirectionCompleteMessage(E);
end;

function TdxSearchHelperBase.GetReplaceAllCompleteMessage
  (E: TdxSearchCompleteEventArgs): string;
begin
...
constructor TdxSearchFormControllerParameters.Create(const AControl
  : IdxRichEditControl; AActivePage: TdxSearchFormActivePage);
begin
...
constructor TdxSearchFormControllerBase.Create(AControllerParameters
  : TdxSearchFormControllerParameters);
begin
  inherited Create;
...
function TdxSearchFormControllerBase.TryGetSearchStringFromSelection
...
procedure TdxSearchFormControllerBase.SetDirection
  (const Value: TdxTextSearchDirection);
begin
  SearchHelper.Direction := Value;
end;

function TdxSearchFormControllerBase.ShouldSearchInSelection(const ASelectedText
  : string): Boolean;
var
  AChar: Char;
begin
...
begin
  ...
  try
    ...
    begin
      ...
      else if (SearchString[I] = '^') and
        ((I = 1) or (SearchString[I - 1] <> '[')) then
...
function TdxSearchFormControllerBase.IsParagraphExpression(const APattern
  : string): Boolean;
begin
  Result := APattern = '^$';
end;
...
constructor TdxInsertRegexItemCommand.Create(const ARichEditControl
  : IdxRichEditControl; AEditor: TcxCustomEdit;
...
procedure TdxInsertRegexItemCommand.ForceExecute(const AState
  : IdxCommandUIState);
var
  S: string;
begin
...
procedure TdxInsertRegexItemCommand.UpdateUIState(const AState
  : IdxCommandUIState);
begin
end;

procedure TdxInsertRegexItemCommand.UpdateUIStateCore
...
constructor TInsertRegexMenuItem.Create(AOwner: TComponent;
  const ARichEditControl: IdxRichEditControl; AEditor: TcxCustomEdit;
  const AMenuCaption, AInsertStr: string; AShowInsertStr: Boolean);
begin
  inherited Create(AOwner);
  FItemCommand := TdxInsertRegexItemCommand.Create(ARichEditControl, AEditor,
    AMenuCaption, AInsertStr, AShowInsertStr);
