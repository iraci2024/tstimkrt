...
type
  ...
  IdxInnerRichEditDocumentServerOwner = interface
    (IdxInnerRichEditDocumentContainerOwner)
    ['{0513020F-29EA-4D34-B3F4-9004ED3C4493}']
    function GetControl: TWinControl;
    function CreateDocumentServer(ADocumentModel: TdxDocumentModel)
      : IdxRichEditDocumentContainer { IdxRichEditDocumentServer };
    function CreateMeasurementAndDrawingStrategy(ADocumentModel
      : TdxDocumentModel): TdxMeasurementAndDrawingStrategy;
    function CreateOptions(const ADocumentServer
      : TObject { TdxInnerRichEditDocumentServer } )
      : TObject { TdxRichEditControlOptionsBase };
    procedure RaiseDeferredEvents(AChangeActions
      : TdxDocumentModelChangeActions);
  ...
  TdxLastInsertedFloatingObjectAnchorRunInfo = class
  ...
  TdxSelectedCellsIntervalInRowList = class
    (TdxObjectList<TdxSelectedCellsIntervalInRow>);
  ...
  public
    class function IsEntireFieldAffected(ARunInfo: TdxRunInfo;
      AField: TdxField): Boolean;
    class function IsFieldCodeTextAffectedOnly(ARunInfo: TdxRunInfo;
      AField: TdxField): Boolean;
    class function IsFieldResultTextAffectedOnly(ARunInfo: TdxRunInfo;
      AField: TdxField): Boolean;
    class function IsEntireFieldResultAffected(ARunInfo: TdxRunInfo;
      AField: TdxField): Boolean;
    class procedure EnsureIntervalContainsField(AInterval: TdxRunInfo;
      AField: TdxField);
  end;
  ...
  public type
    ...
    private
      ...
      FParent: TdxField;
    public
      constructor Create(const AFields, AFieldsToDelete: TdxFieldList;
        AParent: TdxField);
  ...
  strict private
    ...
    function CalculateCopingFields(AOriginFields: TdxFieldList;
      ARunOffset: Integer): TdxFieldList;
    procedure CalculateFieldsHierarchy(AOriginFields, ANewFields: TdxFieldList;
      AParentFieldIndex: Integer);
    procedure ChangeRunInfo(ARunInfo: TdxRunInfo; AField: TdxField);
    function GetIndexToInsert(AParentFieldIndex: Integer;
      ARunIndex: TdxRunIndex): Integer;

    function GetSourceModel: TdxDocumentModel;
    function GetTargetModel: TdxDocumentModel;
  protected
    function ShouldExtendInterval(ARunInfo: TdxRunInfo; AField: TdxField)
      : Boolean; virtual;
  public
    ...
    property AllowCopyWholeFieldResult: Boolean read FAllowCopyWholeFieldResult
      write FAllowCopyWholeFieldResult;
    property SourcePieceTable: TdxPieceTable read FSourcePieceTable;
    property SourceModel: TdxDocumentModel read GetSourceModel;
    property SuppressFieldsUpdate: Boolean read FSuppressFieldsUpdate
      write FSuppressFieldsUpdate;
    property TargetPieceTable: TdxPieceTable read FTargetPieceTable;
    property TargetModel: TdxDocumentModel read GetTargetModel;
    property UpdateFieldOperationType: TdxUpdateFieldOperationType
      read FUpdateFieldOperationType write FUpdateFieldOperationType;
  end;
  ...
  public
    ...
    procedure OnCalculateDocumentVariable(Sender: TObject;
  ...
  TdxDocumentModelDeferredChanges = class(TdxSimpleDocumentModelDeferredChanges,
  ...
  public
    ...
    destructor Destroy; override;
    procedure ApplyChanges(APieceTable: TdxPieceTable;
      AActions: TdxDocumentModelChangeActions; AStartRunIndex: TdxRunIndex;
      AEndRunIndex: TdxRunIndex);
    procedure AddAdditionalChangedPieceTable(AAdditionalChangedPieceTable
      : TdxPieceTable);
    procedure RegisterSelectionChanged;
    function ShouldUpdatePositions(const AActions
      : TdxDocumentModelChangeActions): Boolean;
...
{$REGION 'IdxDocumentModelStructureChangedListener'}
    procedure OnParagraphInserted(APieceTable: TdxCustomPieceTable;
      ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ACell: TdxCustomTableCell;
      AIsParagraphMerged: Boolean; AActualParagraphIndex: TdxParagraphIndex;
      AHistoryNotificationId: Integer);
    procedure OnParagraphRemoved(APieceTable: TdxCustomPieceTable;
      ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; AHistoryNotificationId: Integer);
    procedure OnParagraphMerged(APieceTable: TdxCustomPieceTable;
      ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; AHistoryNotificationId: Integer);
    procedure OnRunInserted(APieceTable: TdxCustomPieceTable;
      AParagraphIndex: TdxParagraphIndex; ANewRunIndex: TdxRunIndex;
      ALength: Integer; AHistoryNotificationId: Integer);
    procedure OnRunRemoved(APieceTable: TdxCustomPieceTable;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
      ALength: Integer; AHistoryNotificationId: Integer);
    ...
    procedure OnRunSplit(APieceTable: TdxCustomPieceTable;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
      ASplitOffset: Integer);
    procedure OnRunJoined(APieceTable: TdxCustomPieceTable;
      AParagraphIndex: TdxParagraphIndex; AJoinedRunIndex: TdxRunIndex;
      ASplitOffset: Integer; ATailRunLength: Integer);
    procedure OnRunMerged(APieceTable: TdxCustomPieceTable;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
      ADeltaRunLength: Integer);
    procedure OnRunUnmerged(APieceTable: TdxCustomPieceTable;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
      ADeltaRunLength: Integer);
    procedure OnFieldRemoved(APieceTable: TdxCustomPieceTable;
      AFieldIndex: Integer);
    procedure OnFieldInserted(APieceTable: TdxCustomPieceTable;
      AFieldIndex: Integer);
{$ENDREGION}
    property AdditionalChangedPieceTables: TdxPieceTableList
      read FAdditionalChangedPieceTables;
    property ChangeActions: TdxDocumentModelChangeActions read FChangeActions
      write FChangeActions;
    ...
    property EnsureCaretVisible: Boolean read FEnsureCaretVisible
      write FEnsureCaretVisible;
    ...
    property SuppressClearOutdatedSelectionItems: Boolean
      read FSuppressClearOutdatedSelectionItems
      write FSuppressClearOutdatedSelectionItems;
  ...
  public
    ...
    constructor Create(AFrom: TdxDocumentLogPosition;
      ALength: Integer); overload;
    destructor Destroy; override;

    property CopyDocumentVariables: Boolean read FCopyDocumentVariables
      write FCopyDocumentVariables;
    property DefaultPropertiesCopyOptions: TdxDefaultPropertiesCopyOptions
      read FDefaultPropertiesCopyOptions write FDefaultPropertiesCopyOptions;
    property FormattingCopyOptions: TdxFormattingCopyOptions
      read FFormattingCopyOptions write FFormattingCopyOptions;
    property From: TdxDocumentLogPosition read GetFrom write SetFrom;
    property Length: Integer read GetLength write SetLength;
    property ParagraphNumerationCopyOptions: TdxParagraphNumerationCopyOptions
      read FParagraphNumerationCopyOptions
      write FParagraphNumerationCopyOptions;
  ...
  public
    procedure FixLastParagraphOfLastSection(AOriginalParagraphCount
      : Integer); override;
  ...
  TdxHyperlinkInfoEvent = procedure(Sender: TObject;
    E: TdxHyperlinkInfoEventArgs) of object;
  ...
  public
    ...
    property DeferredChanges: TdxDocumentModelDeferredChanges
      read FDeferredChanges;
  end;

  { TdxDocumentUpdateCompleteEventHandler }

  TdxDocumentUpdateCompleteEvent = procedure(ASender: TObject;
    E: TdxDocumentUpdateCompleteEventArgs) of object;

  TdxDocumentUpdateCompleteEventHandler =
    TdxMulticastMethod<TdxDocumentUpdateCompleteEvent>;
  ...
  public
    ...
    procedure InsertSectionCore(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition); overload;
    procedure InsertSectionCore(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition; AForceVisible: Boolean); overload;
    procedure PerformInsertSectionCore(AParagraphIndex
      : TdxParagraphIndex); virtual;
  ...
  public
    constructor Create(const ARegEx: TRegex; const AMatch: TMatch;
      const AOffset: TdxDocumentModelPosition);

    property Match: TMatch read FMatch;
    property Offset: TdxDocumentModelPosition read FOffset;
    property AbsolutePosition: Integer read FAbsolutePosition
      write FAbsolutePosition;
  end;

  { TdxSearchContext }

  TdxSearchContext = class(TcxIUnknownObject,
    IdxDocumentModelStructureChangedListener)
  strict private
  const
    LogicalActionsTable: array [TdxSearchAction] of array [TdxDirection]
      of TdxSearchLogicalAction = ((TdxSearchLogicalAction.FindReplaceForward,
      TdxSearchLogicalAction.FindReplaceBackward),
      (TdxSearchLogicalAction.FindReplaceForward,
      TdxSearchLogicalAction.FindReplaceBackward),
      (TdxSearchLogicalAction.ReplaceAllForward,
      TdxSearchLogicalAction.ReplaceAllBackward));
  strict private
...
{$ENDREGION}
  ...
  public
    ...
    destructor Destroy; override;
    procedure BeginSearch(AAction: TdxSearchAction;
      ADirection: TdxDirection); virtual;
    function CreateEventArgs(const ASearchString: string;
      const AReplaceString: string): TdxSearchCompleteEventArgs;
    ...
    property StartOfIntervalSearch: Boolean read GetStartOfIntervalSearch
      write SetStartOfIntervalSearch;
    property SearchState: TdxSearchState read GetSearchState
      write SetSearchState;
    property SearchScope: TdxSearchScope read GetSearchScope
      write SetSearchScope;
    ...
    property StartSelectionAnchor: TdxDocumentModelPositionAnchor
      read FStartSelectionPosition write FStartSelectionPosition;
    property EndSelectionAnchor: TdxDocumentModelPositionAnchor
      read FEndSelectionPosition write FEndSelectionPosition;
  ...
  TdxDocumentModel = class(TdxSimpleDocumentModel,
    IdxDocumentModelStructureChangedListener, IdxCellPropertiesOwner,
    IdxTableStylesContainer, IdxDefaultTablePropertiesContainer,
  ...
  strict private
    ...
    FLastInsertedFloatingObjectAnchorRunInfo
      : TdxLastInsertedFloatingObjectAnchorRunInfo;
...
{$ENDREGION}
    ...
    procedure EnsureNumberingListStyleValid(AStyle: TdxNumberingListStyle;
    ...
    function GetFormattingMarkVisibilityOptions
    ...
    procedure SetDocumentCapabilities(const Value
  ...
  protected
    ...
    function GetIsDocumentProtectionEnabled: Boolean; override;
    {$IFNDEF CPUX64} final; {$ENDIF}
    procedure RaisePageBackgroundChanged;

    procedure OnMailMergeCurrentRowChanged(Sender: TObject; E: TdxEventArgs);
    procedure OnMailMergeViewMergedDataChanged(Sender: TObject;
      E: TdxEventArgs);
    ...
    function CreateDocumentCapabilitiesOptions
      : TdxCustomDocumentCapabilitiesOptions; override;
    ...
    function CreateFormattingMarkVisibilityOptions
      : TdxSimpleFormattingMarkVisibilityOptions; override;
    ...
    function CreateDeferredChanges
      : TdxCustomDocumentModelDeferredChanges; override;
    ...
    procedure SubscribeDocumentObjectsEvents; override; {$IFNDEF CPUX64} final;
    {$ENDIF}
    function UseFontSubstitution: Boolean; override; {$IFNDEF CPUX64} final;
    {$ENDIF}
    function CreateDocumentCache: TdxCustomDocumentCache; override;
    function CreateDocumentModelCopyOptions(AFrom: TdxDocumentLogPosition;
      ALength: Integer): TdxDocumentModelCopyOptions;
    procedure SetModelForExportCopyOptions(ACopyOptions
      : TdxDocumentModelCopyOptions);
  ...
  public
    ...
    function AutodetectDocumentFormat(const AFileName: string;
      AUseFormatFallback: Boolean = True): TdxRichEditDocumentFormat; override;
    {$IFNDEF CPUX64} final; {$ENDIF}
    // for internal use
    ...
    function CreateMailMergeDataController
      : TdxRichEditDataControllerAdapterBase;

    function CreateMainContentType: TdxSimpleMainContentType; override;
    function CreatePieceTable(AContentType: TdxContentTypeBase)
      : TdxCustomPieceTable { TdxPieceTable }; override;
    procedure OnLayoutUnitChanged; override;
    function GetPieceTables(AIncludeUnreferenced: Boolean)
      : TdxFastList; override;
    function GetBookmarks(AIncludeHiddenBookmarks: Boolean = True)
      : TdxBookmarkList;
    function CreateHyphenator: TdxHyphenator;
    function CreateHyphenationService { (AContainer: IdxServiceContainer; AServiceType: TObject) }
      : IInterface;
    ...
    procedure UpdateFields(AUpdateType: TdxUpdateFieldOperationType;
    ...
    procedure OnTableOptionsChanged(ASender: TObject;
      E: TdxRichEditNotificationOptionsChangedArgs);
    procedure OnLayoutOptionsChanged(ASender: TObject;
      E: TdxRichEditNotificationOptionsChangedArgs);
    procedure OnDocumentPropertiesObtainAffectedRange(ASender: TObject;
      E: TdxObtainAffectedRangeEventArgs);
    procedure OnDocumentPropertiesPageBackgroundChanged(ASender: TObject;
      E: TdxEventArgs);
    procedure OnProtectionPropertiesObtainAffectedRange(ASender: TObject;
      E: TdxObtainAffectedRangeEventArgs);
    procedure OnHistoryOperationCompleted(ASender: TObject;
      E: TdxEventArgs); override;
    procedure OnHistoryModifiedChanged(ASender: TObject;
      E: TdxEventArgs); override;

    function ShouldFormatSpecialEmptyParagraph: Boolean;
    function IsSpecialEmptyParagraphAfterInnerTable(AParagraph: TdxParagraph;
    ...
    procedure SwitchToSelectionCore(ANewSelection: TdxSimpleSelection);
      override;
    procedure BeginSetContent;
    function CreateDocumentModelForExport(const AInitializeEmptyDocumentModel
      : TdxAction<TdxDocumentModel>): TdxDocumentModel;
    ...
    procedure RaiseBeforeExportFromExportModel(ASender: TObject;
      E: TdxBeforeExportEventArgs);
    procedure RaiseCalculateDocumentVariableForExport(ASender: TObject;
      E: TdxCalculateDocumentVariableEventArgs);
    procedure RaiseBeforeExport(AFormat: TdxRichEditDocumentFormat;
    ...
    procedure EndSetContentForExport(AChangeType: TdxDocumentModelChangeType;
      AUpdateFields: Boolean);
    procedure EndSetContent(AChangeType: TdxDocumentModelChangeType;
      AUpdateFields: Boolean;
      AUpdateOptions: TdxFieldUpdateOnLoadOptions); overload;
    procedure EndSetContent(AChangeType: TdxDocumentModelChangeType;
      AUpdateFields, APasteFromIe: Boolean;
      AUpdateOptions: TdxFieldUpdateOnLoadOptions;
      const AAfterPieceTablesEndSetContentAction: TdxAction = nil); overload;
    procedure BeginFieldsUpdate;
    procedure EndFieldsUpdate;
    procedure PreprocessContentBeforeInsert(ADestination: TdxPieceTable;
    ...
    procedure ApplyChanges(APieceTable: TdxCustomPieceTable { TdxPieceTable };
      AChangeType: TdxDocumentModelChangeType;
      AStartRunIndex, AEndRunIndex: TdxRunIndex); override;
    procedure ApplyChangesCore(APieceTable
      : TdxCustomPieceTable { TdxPieceTable };
...
{$REGION 'IdxDocumentModelStructureChangedListener'}
    ...
    procedure OnFieldInserted(APieceTable: TdxCustomPieceTable;
      AFieldIndex: Integer); override;
    procedure OnBeginMultipleRunSplit(APieceTable
      : TdxCustomPieceTable); override;
    procedure OnEndMultipleRunSplit(APieceTable: TdxCustomPieceTable); override;
{$ENDREGION}
    procedure RecalcSectionIndices(AFrom: TdxSectionIndex;
      ADeltaIndex: Integer);
    procedure RecalcSectionIndicesCore(AFrom: TdxSectionIndex;
      ADeltaIndex: Integer);
    function GetActiveSectionBySelectionEnd: TdxSection;
    procedure InsertSection(ALogPosition: TdxDocumentLogPosition;
      AForceVisible: Boolean = False); overload;
    procedure ApplySectionFormatting(ALogPositionStart: TdxDocumentLogPosition;
      ALength: Integer; AModifier: TdxSectionPropertyModifierBase); override;
    procedure ApplySectionFormattingCore(ALogPositionStart
      : TdxDocumentLogPosition; ALength: Integer;
      AModifier: TdxSectionPropertyModifierBase);
    procedure DeleteDefaultNumberingList(ANumberingLists
      : TdxNumberingListCollection);
    function GetNumberingListIndex(ATarget: TdxCustomDocumentModel;
      ASourceListIndex, AMaxNumberingListIndex: TdxNumberingListIndex)
      : TdxNumberingListIndex; override;
    function CheckIsOverrideEquals(ATargetNumberingList, ASourceNumberingList
      : TdxNumberingList): Boolean;
    function GetAbstractNumberingListIndex(ATarget: TdxDocumentModel;
      ASourceListIndex: TdxNumberingListIndex): TdxAbstractNumberingListIndex;
    procedure CreateAbstractNumberingList(ATarget: TdxDocumentModel;
      ATargetList: TdxAbstractNumberingList; ANumberingListId: Integer;
      ASourceListIndex: TdxNumberingListIndex);
    procedure AddAbstractNumberingListUsingHistory(AAbstractList
      : TdxAbstractNumberingList);
    procedure AddNumberingListUsingHistory(ANumberingList: TdxNumberingList);
    function GetSelectionText: string;
    procedure ResetDocumentFormattingCaches(AResetFormattingCacheType
      : TdxResetFormattingCacheType); override;
    procedure ClearModelCachedIndices(AResetFormattingCacheType
      : TdxResetFormattingCacheType);
    function CreateCellPropertiesChangedHistoryItem
      (AProperties: TdxTableCellProperties): TdxIndexChangedHistoryItemCore;
    function GetDatabaseFieldNames: TArray<TdxMergeFieldName>;

    function CreateNumberingListCountersCalculator
      (AList: TdxAbstractNumberingList): TdxNumberingListCountersCalculator;
    function GetLastInsertedFloatingObjectAnchorRunInfo
    ...
    procedure SetActivePieceTable(APieceTable: TdxCustomPieceTable);
      overload; override;
    procedure SetActivePieceTable(APieceTable: TdxPieceTable;
      ASection: TdxSection); overload;
    procedure SetActivePieceTableCore(APieceTable: TdxPieceTable;
      ASection: TdxSection);
    ...
    function CheckDocumentProtectionPassword(const APassword: string)
      : Boolean; virtual;
    function CheckPasswordHash(const AHash, AExpectedHash: TArray<Byte>)
      : Boolean; virtual;
    function CheckLegacyDocumentProtectionPassword
      (ACalculator: TdxPasswordHashCodeCalculatorClass;
      const APassword: string): Boolean;
    function CheckOpenXmlDocumentProtectionPassword
      (ACalculator: TdxPasswordHashCodeCalculatorClass;
      const APassword: string): Boolean;
    function CheckOpenOfficeDocumentProtectionPassword
      (ACalculator: TdxPasswordHashCodeCalculatorClass;
      const APassword: string): Boolean;
    function CheckRtfDocumentProtectionPassword(ACalculator
      : TdxPasswordHashCodeCalculatorClass; const APassword: string): Boolean;
    function CheckDocumentProtectionPasswordCore(ACalculator
      : TdxPasswordHashCodeCalculatorClass; const APassword: string): Boolean;
    procedure ResetParagraphs;
    procedure ResetAdditionalPieceTablesParagraphs
      (APieceTable: TdxPieceTableList);
    procedure InheritDataServices(ADocumentModel: TdxDocumentModel); virtual;
    procedure InheritUriProviderService(ADocumentModel
      : TdxDocumentModel); virtual;
    ...
    function CreateCopySectionOperation(ACopyManager
      : TdxCustomDocumentModelCopyManager): TdxSelectionBasedOperation;
    function CreateDocumentModelCopyCommand(ASourcePieceTable: TdxPieceTable;
      ATarget: TdxDocumentModel; AOptions: TdxDocumentModelCopyOptions)
      : TObject;
    ...
    function CreateDocumentImportHelper: TObject; override;
    {$IFNDEF CPUX64} final; {$ENDIF}
    function CreateDocumentExportHelper(ADocumentFormat
      : TdxRichEditDocumentFormat): TObject; override; {$IFNDEF CPUX64} final;
    {$ENDIF}
    function CreateEmptySpellCheckerManager(APieceTable: TdxCustomPieceTable)
      : TObject { TdxSpellCheckerManager }; override; {$IFNDEF CPUX64} final;
    {$ENDIF}
    function GetImportManagerService: IInterface; override;
    {$IFNDEF CPUX64} final; {$ENDIF}
    function GetExportManagerService: IInterface; override;
    {$IFNDEF CPUX64} final; {$ENDIF}
    ...
    procedure BeforeFloatingObjectDrop(AOldPosition, ANewPosition
      : TdxDocumentLogPosition; APieceTable: TdxPieceTable);

    procedure LoadDocument(AStream: TStream;
      ADocumentFormat: TdxRichEditDocumentFormat; const ASourceUri: string;
      AEncoding: TEncoding = nil); overload;

    procedure SaveDocument(AStream: TStream;
      ADocumentFormat: TdxRichEditDocumentFormat; const ATargetUri: string = '';
      AEncoding: TEncoding = nil); virtual;

    // for internal use
    function CreateSection: TdxCustomSection; override;
    procedure NotifyNumberingListParagraphAdded
      (AIndex: TdxNumberingListIndex); override;
    procedure NotifyNumberingListParagraphRemoved
      (AIndex: TdxNumberingListIndex); override;
    procedure RecreateLineNumberRun;
    function QueryEncryptionPassword(var APassword: string): Boolean; virtual;
    function LookupSectionIndexByParagraphIndex(AParagraphIndex
      : TdxParagraphIndex): TdxSectionIndex; override;

    // Events
    function RaiseMailMergeStarted(const Args
      : TdxMailMergeStartedEventArgs): Boolean;
    function RaiseMailMergeRecordStarted(const Args
      : TdxMailMergeRecordStartedEventArgs): Boolean;
    function RaiseMailMergeRecordFinished(const Args
      : TdxMailMergeRecordFinishedEventArgs): Boolean;
    procedure RaiseMailMergeFinished(const Args: TdxMailMergeFinishedEventArgs);
    procedure RaiseMailMergeGetTargetDocument
    ...
    function RaiseCalculateDocumentVariable
    ...
    procedure RaiseBeforeImport(AFormat: TdxRichEditDocumentFormat;
      const AOptions: IdxImporterOptions);
    procedure RaiseInnerDocumentCleared;
    procedure RaiseDocumentCleared;
    procedure RaiseHyperlinkInfoInserted(APieceTable: TdxSimplePieceTable;
      AFieldIndex: Integer); override;
    procedure RaiseHyperlinkInfoDeleted(APieceTable: TdxSimplePieceTable;
      AFieldIndex: Integer); override;

    class property DefaultStrikeoutRepository: TdxStrikeoutRepository
      read FDefaultStrikeoutRepository;
    class property DefaultUnderlineRepository: TdxUnderlineRepository
      read FDefaultUnderlineRepository;

    property ActivePieceTable: TdxPieceTable read FActivePieceTable;
    property BorderLineRepository: TdxBorderLineRepository
      read FBorderLineRepository;
    property Cache: TdxDocumentCache read GetCache;
    property CommandsCreationStrategy: TdxRichEditCommandsCreationStrategy
      read FCommandsCreationStrategy;
    property DefaultTableCellProperties: TdxTableCellProperties
      read FDefaultTableCellProperties;
    property DefaultTableProperties: TdxTableProperties
      read FDefaultTableProperties;
    property DefaultTableRowProperties: TdxTableRowProperties
      read FDefaultTableRowProperties;
    property DeferredChanges: TdxDocumentModelDeferredChanges
      read GetDeferredChanges;
    property DisableCheckDocumentModelIntegrity: Boolean
      read FDisableCheckDocumentModelIntegrity
      write FDisableCheckDocumentModelIntegrity;
    property DocumentFileName: string read FDocumentFileName
      write FDocumentFileName;
    property DocumentFormat: TdxRichEditDocumentFormat read FDocumentFormat
      write FDocumentFormat;
    ...
    property EncryptionProperties: TdxDocumentEncryptionProperties
      read FEncryptionProperties;
    property EndNotes: TdxEndNoteCollection read FEndNotes;
    property ExtendedDocumentProperties: TdxExtendedDocumentProperties
      read FExtendedDocumentProperties;
    property FieldResultModel: Boolean read FFieldResultModel
      write FFieldResultModel;
    property FloatingObjectBorderInfoRepository: TdxBorderInfoRepository
      read FFloatingObjectBorderInfoRepository;
    ...
    property IntermediateModel: Boolean read FIntermediateModel
      write FIntermediateModel;
    ...
    property MailMergeDataController: TdxRichEditDataControllerAdapterBase
      read FMailMergeDataController;
    property MailMergeProperties: TdxMailMergeProperties
      read FMailMergeProperties;
    property MainPieceTable: TdxPieceTable read GetPieceTable;
    property Modified: Boolean read GetModified write SetModified;
    property NumberDecimalSeparator: string read FNumberDecimalSeparator
      write FNumberDecimalSeparator;
    property NumberGroupSeparator: string read FNumberGroupSeparator
      write FNumberGroupSeparator;
    property NumberingListStyles: TdxNumberingListStyleCollection
      read FNumberingListStyles;
    property ProtectionProperties: TdxDocumentProtectionProperties
      read FProtectionProperties;
    ...
    property SeparateModelForApiExport: Boolean
      read GetSeparateModelForApiExport;
    property ShouldApplyAppearanceProperties: Boolean
      read FShouldApplyAppearanceProperties
      write FShouldApplyAppearanceProperties;
    property StrikeoutRepository: TdxStrikeoutRepository
      read FStrikeoutRepository;
    property SuppressFieldsChangeNotification: Boolean
      read FSuppressFieldsChangeNotification;
    property SyntaxHighlightSuspended: Boolean read GetSyntaxHighlightSuspended;
    property TableBorderInfoRepository: TdxBorderInfoRepository
      read FTableBorderInfoRepository;
    ...
    property UnderlineRepository: TdxUnderlineRepository
      read FUnderlineRepository;
    property Variables: TdxDocumentVariableCollection read FVariables;

    property AbstractNumberingListIdProvider: TdxAbstractNumberingListIdProvider
      read FAbstractNumberingListIdProvider;
    property AbstractNumberingLists: TdxAbstractNumberingListCollection
      read FAbstractNumberingLists;
    property NumberingListIdProvider: TdxNumberingListIdProvider
      read FNumberingListIdProvider;
    property NumberingLists: TdxNumberingListCollection read FNumberingLists;

    // options
    property AuthenticationOptions: TdxAuthenticationOptions
      read FAuthenticationOptions;
    ...
    property DocumentCapabilities: TdxDocumentCapabilitiesOptions
      read GetDocumentCapabilities write SetDocumentCapabilities;
    property DocumentExportOptions: TdxRichEditDocumentExportOptions
      read FDocumentExportOptions;
    property DocumentImportOptions: TdxRichEditDocumentImportOptions
      read FDocumentImportOptions;
    property DocumentSaveOptions: TdxDocumentSaveOptions
      read FDocumentSaveOptions;
    ...
    property FormattingMarkVisibilityOptions: TdxFormattingMarkVisibilityOptions
      read GetFormattingMarkVisibilityOptions;
    property LayoutOptions: TdxRichEditLayoutOptions read FLayoutOptions;
    property MailMergeOptions: TdxRichEditMailMergeOptions
      read FMailMergeOptions;
    property PrintingOptions: TdxPrintingOptions read FPrintingOptions;
    property RangePermissionOptions: TdxRangePermissionOptions
      read FRangePermissionOptions;
    property SearchOptions: TdxDocumentSearchOptions read FSearchOptions;
    property SpellCheckerOptions: TdxSpellCheckerOptions
      read FSpellCheckerOptions;
    property TableOptions: TdxTableOptions read FTableOptions;
    property WebSettings: TdxWebSettings read FHtmlSettings;
    // event handlers
    property AfterEndDocumentUpdate: TdxDocumentUpdateCompleteEventHandler
      read FOnAfterEndDocumentUpdate;
    property AfterExport: TdxNotifyEventHandler read FOnAfterExport;
    property BeforeEndDocumentUpdate: TdxDocumentUpdateCompleteEventHandler
      read FOnBeforeEndDocumentUpdate;
    ...
    property CalculateDocumentVariable: TdxCalculateDocumentVariableEventHandler
      read FOnCalculateDocumentVariable;
    ...
    property EndDocumentUpdate: TdxDocumentUpdateCompleteEventHandler
      read FOnEndDocumentUpdate;
    property HyperlinkInfoDeleted: TdxHyperlinkInfoEventHandler
      read FOnHyperlinkInfoDeleted;
    property HyperlinkInfoInserted: TdxHyperlinkInfoEventHandler
      read FOnHyperlinkInfoInserted;
    ...
    property InvalidFormatException
      : TdxRichEditInvalidFormatExceptionEventHandler
      read FOnInvalidFormatException;
    property MailMergeFinished: TdxMailMergeFinishedEventHandler
      read FOnMailMergeFinished;
    property MailMergeGetTargetDocument
      : TdxMailMergeGetTargetDocumentEventHandler
      read FOnMailMergeGetTargetDocument;
    property MailMergeRecordFinished: TdxMailMergeRecordFinishedEventHandler
      read FOnMailMergeRecordFinished;
    property MailMergeRecordStarted: TdxMailMergeRecordStartedEventHandler
      read FOnMailMergeRecordStarted;
    property MailMergeStarted: TdxMailMergeStartedEventHandler
      read FOnMailMergeStarted;
    property ModifiedChanged: TdxEventHandler read FOnModifiedChanged;
    property PageBackgroundChanged: TdxEventHandler
      read FOnPageBackgroundChanged;
    ...
    property OnEncryptionPasswordQuery: TdxEncryptionPasswordQueryEvent
      read FOnEncryptionPasswordQuery write FOnEncryptionPasswordQuery;
  end;
  ...
  public
    procedure ModifyParagraph(AParagraph: TdxParagraph;
      AParagraphIndex: TdxParagraphIndex); virtual; abstract;
  end;
  ...
  public
    ...
    function CheckPermissionsForDocument(APermissions
      : TdxRangePermissionCollection;
      AStart, AEnd: TdxDocumentLogPosition): Boolean;
    function CheckPermissionsCore(APermissions: TdxRangePermissionCollection;
      AStart, AEnd: TdxDocumentLogPosition;
      const ACheck: TFunc<TdxRangePermission, TdxDocumentLogPosition,
      TdxDocumentLogPosition, Boolean>): Boolean;
    function CheckInsidePermission(ARangePermission: TdxRangePermission;
      AStart, AEnd: TdxDocumentLogPosition): Boolean;
    function CheckIntersectsWithPermission(ARangePermission: TdxRangePermission;
      AStart, AEnd: TdxDocumentLogPosition): Boolean;
  end;
  ...
  strict private
    FCache: TObjectDictionary<TdxAbstractNumberingListIndex,
  ...
  public
    ...
    procedure Clear;
    function GetCacheItem(AListIndex: TdxAbstractNumberingListIndex)
      : TdxNumberingListCountersCalculator;
  end;

  { TdxPieceTable }

  TdxPieceTable = class(TdxSimplePieceTable, IdxDebugVisualizer)
  public type
  ...
  strict private
    ...
    procedure SetPreCalculatedNumberingListTexts(const Value
      : TDictionary<TdxParagraph, string>);
    procedure SetSpellCheckerManager(const Value
      : TdxRichEditSpellCheckerManager);

    procedure ResetTableAllUse(ATable: TdxTable);
  strict protected
    function CreateFieldCollection: TdxFieldCollectionBase; override;
    {$IFNDEF CPUX64} final; {$ENDIF}
    function CreateParagraphCollection: TdxParagraphBaseCollection; override;
    {$IFNDEF CPUX64} final; {$ENDIF}
    function GetDocumentStartLogPosition: TdxDocumentLogPosition; override;
    {$IFNDEF CPUX64} final; {$ENDIF}
    function GetDocumentEndLogPosition: TdxDocumentLogPosition; override;
    {$IFNDEF CPUX64} final; {$ENDIF}
    function CreateObjectInserter: TdxObjectInserter; override;
    {$IFNDEF CPUX64} final; {$ENDIF}
  protected
    ...
    procedure DoParagraphInserted(ASectionIndex: TdxSectionIndex;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
      ACell: TdxCustomTableCell; AIsParagraphMerged: Boolean;
      AActualParagraphIndex: TdxParagraphIndex;
      AHistoryNotificationId: Integer); override;
    procedure ParagraphRemovedCore(ASectionIndex: TdxSectionIndex;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
      AHistoryNotificationId: Integer); override;
    procedure DoParagraphMerged(ASectionIndex: TdxSectionIndex;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
      AHistoryNotificationId: Integer); override;
    procedure ParagraphInsertedCore(ASectionIndex: TdxSectionIndex;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
      ACell: TdxCustomTableCell; AIsParagraphMerged: Boolean;
      AActualParagraphIndex: TdxParagraphIndex;
      AHistoryNotificationId: Integer); override;
    procedure DoParagraphRemoved(ASectionIndex: TdxSectionIndex;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
      AHistoryNotificationId: Integer); override;
    procedure ParagraphMergedCore(ASectionIndex: TdxSectionIndex;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
      AHistoryNotificationId: Integer); override;
    procedure DoRunInserted(AParagraphIndex: TdxParagraphIndex;
      ANewRunIndex: TdxRunIndex; ALength, AHistoryNotificationId
      : Integer); override;
    procedure RunInsertedCore(AParagraphIndex: TdxParagraphIndex;
      ANewRunIndex: TdxRunIndex; ALength, AHistoryNotificationId
      : Integer); override;
    procedure DoRunRemoved(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ALength, AHistoryNotificationId
      : Integer); override;
    procedure RunRemovedCore(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ALength, AHistoryNotificationId
      : Integer); override;
    procedure DoRunMerged(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ADeltaRunLength: Integer); override;
    procedure RunMergedCore(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ADeltaRunLength: Integer); override;
    procedure DoRunUnmerged(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ADeltaRunLength: Integer); override;
    procedure RunUnmergedCore(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ADeltaRunLength: Integer); override;
    procedure DoRunSplit(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ASplitOffset: Integer); override;
    procedure RunSplitCore(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ASplitOffset: Integer); override;
    procedure DoRunJoined(AParagraphIndex: TdxParagraphIndex;
      AJoinedRunIndex: TdxRunIndex;
      ASplitOffset, ATailRunLength: Integer); override;
    procedure RunJoinedCore(AParagraphIndex: TdxParagraphIndex;
      AJoinedRunIndex: TdxRunIndex;
      ASplitOffset, ATailRunLength: Integer); override;
    ...
    property RangeEditableChecker: TdxRangeEditableChecker
      read FRangeEditableChecker;
  public
    constructor Create(const ADocumentModel: TdxCustomDocumentModel;
      const AContentType: TdxContentTypeBase); override;
    destructor Destroy; override;

    procedure AddPieceTables(AResult: TdxFastList;
      AIncludeUnreferenced: Boolean); override; {$IFNDEF CPUX64} final; {$ENDIF}
    ...
    procedure AddParagraphToList(AParagraphIndex: TdxParagraphIndex;
      ANumberingListIndex: TdxNumberingListIndex;
      AListLevelIndex: Integer); override;

    function GetPlainText(const AStartPos,
      AEndPos: TdxDocumentModelPosition): string;
    function GetPlainText2(const AStartPos, AEndPos: TdxFormatterPosition)
      : string; overload;
    function GetPlainText2(const AStartPos, AEndPos: TdxDocumentModelPosition)
      : string; overload;
    function GetFilteredPlainText(const AStart, AEnd: TdxDocumentModelPosition;
    ...
    procedure InsertParagraphCoreNoInheritParagraphRunStyle
      (APos: TdxInputPosition);
    procedure InsertSectionParagraphCore(APos: TdxInputPosition); overload;
    procedure InheritParagraphRunStyleCore(APos: TdxInputPosition;
      AParagraphRun: TdxTextRunBase);
    procedure InheritParagraphRunStyle(APos: TdxInputPosition;
      AParagraphRun: TdxTextRunBase);
    function InsertSectionParagraphCore(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition; AForceVisible: Boolean)
      : TdxRunIndex; overload;
    procedure InsertParagraphCore(APos: TdxInputPosition); override;

    procedure InsertFieldSymbolResult(ALogPosition: TdxDocumentLogPosition;
      const ASymbol: Char); override;
    procedure InsertInsertFieldSymbolResultCore(AParagraphIndex
      : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition;
      const ASymbol: Char; AForceVisible: Boolean);

    function InsertFloatingObjectAnchorCore(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition)
      : TdxFloatingObjectAnchorRun; overload;
    function InsertFloatingObjectAnchorCore(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition; AForceVisible: Boolean)
      : TdxFloatingObjectAnchorRun; overload;
    function InsertFloatingObjectAnchorCore(APos: TdxInputPosition)
      : TdxFloatingObjectAnchorRun; overload;
    procedure ApplyListLevelIndexToParagraph(AParagraph: TdxParagraph;
      ALevelIndex: Integer);
    procedure RemoveParagraphFromList(AParagraphIndex: TdxParagraphIndex);
    procedure InsertLayoutDependentTextRun(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition;
      AFormatting: TdxFieldResultFormatting);
    function InsertFootNoteRun(APos: TdxInputPosition; ANoteIndex: Integer)
      : TdxTextRunBase; overload;
    function InsertFootNoteRun(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition; ANoteIndex: Integer)
      : TdxTextRunBase; overload;
    function InsertEndNoteRun(APos: TdxInputPosition; ANoteIndex: Integer)
      : TdxTextRunBase; overload;
    function InsertEndNoteRun(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition; ANoteIndex: Integer)
      : TdxTextRunBase; overload;
    procedure InsertFootNoteRunCore(AParagraphIndex: TdxParagraphIndex;
      ALogPosition: TdxDocumentLogPosition;
      AFormatting: TdxFieldResultFormatting; ANoteIndex: Integer;
      AInserter: TdxObjectInserter);
    procedure InsertTextCoreNoResetMergeNoApplyFormatting
      (APos: TdxInputPosition; const AText: string; AForceVisible: Boolean);
    ...
    procedure AppendImage(APos: TdxInputPosition;
      AImage: TdxOfficeImageReference; AScaleX, AScaleY: Single;
      AUseScreenDpi: Boolean = False); overload;
    procedure AppendImage(APos: TdxInputPosition;
      AImage: TdxOfficeImageReference; AScaleX, AScaleY: Single;
      AFillColor: TdxAlphaColor; AUseScreenDpi: Boolean); overload;
    procedure ApplyCharacterStyleCore(ALogPositionStart: TdxDocumentLogPosition;
      ALength: Integer; AModifier: TdxRunPropertyModifierBase);
    procedure ApplyParagraphStyleCore(ALogPositionStart: TdxDocumentLogPosition;
      ALength: Integer; AModifier: TdxRunPropertyModifierBase);
    procedure ChangeParagraphStyle(AParagraph: TdxParagraph;
      AModifier: TdxRunPropertyModifierBase);
    function ObtainMergedParagraphsProperties(ALogPositionStart
      : TdxDocumentLogPosition; ALength: Integer;
      AModifier: TdxParagraphPropertyModifierBase)
      : TdxMergedParagraphProperties;
    function ObtainMergedParagraphsTabFormattingInfo(ALogPositionStart
      : TdxDocumentLogPosition; ALength: Integer;
      AModifier: TdxParagraphPropertyModifierBase): TdxTabFormattingInfo;
    function GetLanguageInfo(const AStart, AEnd: TdxDocumentModelPosition)
      : TdxNullableValue<TdxLangInfo>;
    function ShouldCheckWord(const AStart,
      AEnd: TdxDocumentModelPosition): Boolean;
    ...
    procedure SetFont(ALogPositionStart: TdxDocumentLogPosition;
      ALength: Integer; AFont: TFont);
    procedure SetForeColor(ALogPositionStart: TdxDocumentLogPosition;
      ALength: Integer; AForeColor: TdxAlphaColor);
    procedure SetBackColor(ALogPositionStart: TdxDocumentLogPosition;
      ALength: Integer; ABackColor: TdxAlphaColor);
    procedure ApplyCharacterFormatting(ALogPositionStart
      : TdxDocumentLogPosition; ALength: Integer;
      AModifier: TdxRunPropertyModifierBase); overload;
    procedure ApplyParagraphFormatting(ALogPositionStart
      : TdxDocumentLogPosition; ALength: Integer;
      AModifier: TdxParagraphPropertyModifierBase); overload;
    procedure ApplyParagraphFormattingCore(ALogPositionStart
      : TdxDocumentLogPosition; ALength: Integer;
      AModifier: TdxParagraphPropertyModifierBase);
    procedure ApplyCharacterStyle(ALogPositionStart: TdxDocumentLogPosition;
      ALength, AStyleIndex: Integer; AResetProperties: Boolean); overload;
    procedure ApplyCharacterStyle(ALogPositionStart: TdxDocumentLogPosition;
      ALength, AStyleIndex: Integer); overload;
    procedure ApplyParagraphStyle(ALogPositionStart: TdxDocumentLogPosition;
      ALength, AStyleIndex: Integer);

    procedure ApplyTableStyleCore(ATables: TdxList<TdxTable>;
      AStyleIndex: Integer);
    function ShouldApplyStyleToParagraphs(ALogPositionStart
      : TdxDocumentLogPosition; ALength: Integer): Boolean;
    ...
    procedure ProcessFieldsRecursive(AParent: TdxField;
      const AValidateField: TdxValidateFieldFunction);
    function GetEntireFieldsFromInterval(AStart: TdxRunIndex; AEnd: TdxRunIndex)
      : TdxFieldList;
    ...
    procedure ConvertParagraphsToTable(AFirstParagraphIndex: TdxParagraphIndex;
      ARowCount, ACellCount: Integer);
    procedure PerformTextRunSplit(ARunIndices: TdxSortedRunIndexCollection);
    procedure ApplyNumberingToInsertedParagraph(AParagraphIndex
      : TdxParagraphIndex); override;
    procedure DeleteNumerationFromParagraphAndChangeParagraphStyle
      (AParagraph: TdxParagraph; AParagraphStyleIndex: Integer);
    procedure CopyCharacterPropertiesToParagraphMark(ASourceParagraph,
      ATargetParagraph: TdxParagraph);
    procedure InsertFloatingObjectAnchor(ALogPosition
      : TdxDocumentLogPosition); overload;
    procedure InsertFloatingObjectAnchor(ALogPosition: TdxDocumentLogPosition;
      AForceVisible: Boolean); overload;
    ...
    function CreateTableRowCore(ATable: TdxTable; ARowIndex: Integer)
      : TdxTableRow; overload;
    function CreateTableCellCore(ARow: TdxTableRow;
      AStart, AEnd: TdxParagraphIndex): TdxTableCell; overload;
    function CreateTableCellCore(ARow: TdxTableRow; AInsertedIndex: Integer;
      AStart, AEnd: TdxParagraphIndex): TdxTableCell; overload;
    procedure DeleteTableCore(ADeletedTable: TdxTable);
    procedure DeleteEmptyTableRowCore(ATableIndex, ARowIndex: Integer);
    procedure DeleteEmptyTableCellCore(ATableIndex, ARowIndex,
      ACellIndex: Integer);
    procedure ConvertParagraphsIntoTableRow(ARow: TdxTableRow;
      AIndex: TdxParagraphIndex; AParagraphCount: Integer);
    procedure ChangeCellEndParagraphIndex(ATableCell: TdxTableCell;
      AIndex: TdxParagraphIndex);
    procedure ChangeCellStartParagraphIndex(ATableCell: TdxTableCell;
      AIndex: TdxParagraphIndex);
    procedure InsertSeparator(ALogPosition: TdxDocumentLogPosition); overload;
    procedure InsertSeparator(ALogPosition: TdxDocumentLogPosition;
      AForceVisible: Boolean); overload;
    function GetFieldsInsideInterval(AFirstRunIndex, ALastRunIndex: TdxRunIndex)
      : TdxFieldList;
    procedure UpdateTableOfContents(AOperationType
      : TdxUpdateFieldOperationType);
    function CalculateFieldResult(AField: TdxField;
      AMailMergeDataMode: TdxMailMergeDataMode;
      AUpdateType: TdxUpdateFieldOperationType): TdxCalculateFieldResult;
    function ValidateBookmarkName(const AName: string): string;
    function CreateBookmarkCore(APosition: TdxDocumentLogPosition;
      ALength: Integer; const AName: string;
      AForceUpdateInterval: Boolean = False): TdxBookmark;
    procedure CreateBookmark(APosition: TdxDocumentLogPosition;
      ALength: Integer; const AName: string);
    procedure DeleteBookmark(ABookmarkIndex: Integer);
    procedure DeleteBookmarkCore(ABookmarkIndex: Integer);
    function GetEntireBookmarks(AStart: TdxDocumentLogPosition;
      ALength: Integer): TdxBookmarkBaseList;
    function CreateCommentCore(APosition: TdxDocumentLogPosition;
      ALength: Integer; const AName, AId, AAuthor, ATime, ADate,
      AIdParent: string; AContent: TdxCommentContentType): TdxComment;
    procedure CreateComment(APosition: TdxDocumentLogPosition; ALength: Integer;
      const AName, AId, AAuthor, ATime, ADate, AIdParent: string;
      AContent: TdxCommentContentType);
    procedure DeleteComment(ACommentIndex: Integer);
    procedure DeleteCommentCore(ACommentIndex: Integer);
    function GetEntireComments(AStart: TdxDocumentLogPosition; ALength: Integer)
      : TdxCommentList;
    function InsertCustomMark(ACustomMarkIndex: Integer;
      ACustomMark: TdxCustomMark): TdxCustomMark;
    procedure DeleteCustomMark(ACustomMarkIndex: Integer);
    procedure DeleteCustomMarkCore(ACustomMarkIndex: Integer);
    function CreateCustomMarkCore(APosition: TdxDocumentLogPosition;
      AUserData: TObject): TdxCustomMark;
    procedure CreateCustomMark(APosition: TdxDocumentLogPosition;
      AUserData: TObject);
    procedure ApplyDocumentPermission(AStart, AEnd: TdxDocumentLogPosition;
      AInfo: TdxRangePermissionInfo);
    procedure RemoveDocumentPermission(AStart, AEnd: TdxDocumentLogPosition;
      AInfo: TdxRangePermissionInfo);
    procedure DeleteRangePermission(APermission: TdxRangePermission);
    function ApplyDocumentPermissionCore(AStart, AEnd: TdxDocumentLogPosition;
      ARangePermissionInfoIndex: Integer): TdxRunInfo;
    function RemoveDocumentPermissionCore(AStart, AEnd: TdxDocumentLogPosition;
      ARangePermissionInfoIndex: Integer): TdxRunInfo;
    function CreateRangePermission(AStart, AEnd: TdxDocumentLogPosition;
      ARangePermissionInfoIndex: Integer): TdxRangePermission;
    function GetEntireRangePermissions(AStart: TdxDocumentLogPosition;
      ALength: Integer): TdxBookmarkBaseList;
    function ExtractMergedRanges(ARangePermissionInfoIndex: Integer)
    ...
    function CanEditRangeLength(AStart: TdxDocumentLogPosition;
      ALength: Integer): Boolean;
    function CanEditRange(AStart, AEnd: TdxDocumentLogPosition)
      : Boolean; override;
    ...
    procedure ObtainRangePermissionsMatchSelectionItem
      (ATarget: TdxRangePermissionCollection; AItem: TdxSelectionItem);
    function ObtainRangePermissionsWithSelectionInside
      : TdxRangePermissionCollection;
    procedure ObtainRangePermissionsWithSelectionItemInside
      (ATarget: TdxRangePermissionCollection; AItem: TdxSelectionItem);
    procedure AddNumberingListToParagraph(AParagraph: TdxSimpleParagraph;
      ANumberingListIndex: TdxNumberingListIndex; AListLevelIndex: Integer);
    function IsNumberingListLevelIndexValid(AParagraph: TdxSimpleParagraph;
      ANumberingListIndex: TdxNumberingListIndex;
      AListLevelIndex: Integer): Boolean;
    function IsValidNumberingListIndex(ANumberingListIndex
      : TdxNumberingListIndex): Boolean;
    ...
    procedure RemoveNumberingFromParagraph(AParagraph
      : TdxSimpleParagraph); override;
    function InsertTable(ALogPosition: TdxDocumentLogPosition;
      ARowCount, ACellCount: Integer): TdxTable; overload;
    function InsertTable(ALogPosition: TdxDocumentLogPosition;
      ARowCount, ACellCount, AFixedColumnWidths: Integer): TdxTable; overload;
    function InsertTable(ALogPosition: TdxDocumentLogPosition;
      ARowCount, ACellCount: Integer;
      AAutoFitBehavior: TdxTableAutoFitBehaviorType;
      AFixedColumnWidths: Integer): TdxTable; overload;
    function InsertTable(ALogPosition: TdxDocumentLogPosition;
      ARowCount, ACellCount: Integer;
      AAutoFitBehavior: TdxTableAutoFitBehaviorType;
      AFixedColumnWidths, AOuterColumnWidth: Integer; AForceVisible: Boolean)
      : TdxTable; overload;
    function InsertTable(ALogPosition: TdxDocumentLogPosition;
      ARowCount, ACellCount: Integer;
      AAutoFitBehavior: TdxTableAutoFitBehaviorType;
      AFixedColumnWidths, AOuterColumnWidth: Integer; AForceVisible: Boolean;
      AMatchHorizontalTableIndentsToTextEdge: Boolean): TdxTable; overload;
    procedure ValidateTableIndent(ATable: TdxTable);
    function InsertParagraph(ALogPosition: TdxDocumentLogPosition;
      AForceVisible: Boolean = False): TdxParagraph; reintroduce; overload;
    procedure InsertParagraphs(ALogPosition: TdxDocumentLogPosition;
      ACount: Integer; AForceVisible: Boolean);
    procedure InsertTableRowBelow(APatternRow: TdxTableRow;
      AForceVisible: Boolean);
    procedure InsertTableRowAbove(APatternRow: TdxTableRow;
      AForceVisible: Boolean);
    ...
    procedure SplitTable(ATableIndex, ARowIndex: Integer;
      AForceVisible: Boolean);
    procedure InsertColumnToTheLeft(APatternCell: TdxTableCell;
      AForceVisible: Boolean);
    procedure InsertColumnToTheRight(APatternCell: TdxTableCell;
      AForceVisible: Boolean);
    procedure DeleteTableColumns(ASelectedCells
      : TdxSelectedTableStructureBase { TdxSelectedCellsCollection };
      const AServer: IdxInnerRichEditDocumentServerOwner);
    procedure InsertTableCellWithShiftToTheDown(APatternCell: TdxTableCell;
      AForceVisible: Boolean;
      const AServer: IdxInnerRichEditDocumentServerOwner);
    procedure DeleteTableCellWithContent(ADeletedCell: TdxTableCell;
      const AServer: IdxInnerRichEditDocumentServerOwner); overload;
    procedure DeleteTableCellWithContent(ADeletedCell: TdxTableCell;
      ACanNormalizeCellVerticalMerging: Boolean;
      const AServer: IdxInnerRichEditDocumentServerOwner); overload;
    procedure DeleteTableCellsWithShiftToTheUp(ASelectedCells
      : TdxSelectedTableStructureBase { TdxSelectedCellsCollection } );
    procedure InsertTableCellToTheRight(APatternCell: TdxTableCell;
      AForceVisible: Boolean;
      const AServer: IdxInnerRichEditDocumentServerOwner);
    procedure InsertTableCellToTheLeft(APatternCell: TdxTableCell;
      AForceVisible: Boolean;
      const AServer: IdxInnerRichEditDocumentServerOwner);
    procedure DeleteTableCellWithNestedTables(ATableIndex, ARowIndex,
      ACellIndex: Integer);
    procedure SplitTableCellsHorizontally(ACell: TdxTableCell;
      APartsCount: Integer;
      const AServer: IdxInnerRichEditDocumentServerOwner); overload;
    procedure SplitTableCellsHorizontally(ACell: TdxTableCell;
      APartsCount: Integer; AForceVisible: Boolean;
      const AServer: IdxInnerRichEditDocumentServerOwner); overload;
    function JoinTableWithPrevious(ATable: TdxTable): TdxTable;
    procedure JoinTables(ATopTable, ABottomTable: TdxTable);
    procedure MoveTableRowToOtherTable(ATargetTable: TdxTable;
      ARow: TdxTableRow);
    procedure DeleteTableFromTableCollection(ADeletedTable: TdxTable);
    procedure SplitTableCellsVertically(APatternCell: TdxTableCell;
      APartsCount, AColumnsCount: Integer; AForceVisible: Boolean);
    procedure DeleteSelectedTables(ARunInfo: TdxRunInfo;
      ADocumentLastParagraphSelected: Boolean);
    procedure DeleteTablesByNestedLevel(ACurrent: TdxTableCellNode;
      ARunInfo: TdxRunInfo; ADocumentLastParagraphSelected: Boolean);
    function ShouldDeleteTable(ATable: TdxTable; ARunInfo: TdxRunInfo;
    ...
    procedure DeleteBackContent(ALogPosition: TdxDocumentLogPosition;
      ALength: Integer; ADocumentLastParagraphSelected: Boolean);
    procedure DeleteContent(ALogPosition: TdxDocumentLogPosition;
      ALength: Integer; ADocumentLastParagraphSelected: Boolean); overload;
    procedure DeleteContent(ALogPosition: TdxDocumentLogPosition;
      ALength: Integer; ADocumentLastParagraphSelected,
      AAllowPartiallyDeletingField: Boolean); overload;
    procedure DeleteContent(ALogPosition: TdxDocumentLogPosition;
      ALength: Integer; ADocumentLastParagraphSelected,
      AAllowPartiallyDeletingField, AForceRemoveInnerFields: Boolean); overload;
    procedure DeleteContent(ALogPosition: TdxDocumentLogPosition;
      ALength: Integer; ADocumentLastParagraphSelected,
      AAllowPartiallyDeletingField, AForceRemoveInnerFields,
      ALeaveFieldIfResultIsRemoved: Boolean); overload;
    procedure DeleteContent(ALogPosition: TdxDocumentLogPosition;
      ALength: Integer; ADocumentLastParagraphSelected,
      AAllowPartiallyDeletingField, AForceRemoveInnerFields,
      ALeaveFieldIfResultIsRemoved, ABackspacePressed: Boolean); overload;

    function CreateNavigationVisibleTextFilter(AShowHiddenText: Boolean)
      : TdxVisibleTextFilterBase;
    procedure SetShowHiddenText(AValue: Boolean); override;
    procedure InsertDocumentModelContent(ADocumentModel: TdxDocumentModel;
      APos: TdxDocumentLogPosition); overload;
    procedure InsertDocumentModelContent(ADocumentModel: TdxDocumentModel;
      APos: TdxDocumentLogPosition; ASuppressParentFieldsUpdate,
      ASuppressFieldsUpdate, ACopyBetweenInternalModels: Boolean); overload;
    ...
    procedure ReplaceTextWithPicture(APosition: TdxDocumentLogPosition;
      ALength: Integer; AImage: TdxOfficeImageReference);
    procedure ReplaceTextWithMultilineText(APosition: TdxDocumentLogPosition;
      ALength: Integer; const AText: string);
    procedure MovePositionToNext(var APos: TdxDocumentModelPosition;
      AOffset: Integer);
    ...
    procedure MergeCells(ASelectedCellsCollectionInstance
      : TdxSelectedTableStructureBase { TdxSelectedCellsCollection } );
    procedure MergeCellsHorizontally(ASelectedCellsInstance
      : TdxSelectedTableStructureBase { TdxSelectedCellsCollection } );
    function MergeCellsHorizontallyCore(AStartCell: TdxTableCell;
      AMergedCellsColumnSpan: Integer): Integer;
    function CreateDeleteContentOperation
      : TdxCustomDeleteContentOperation; override;
    ...
    function GetCopyManager(ASourcePieceTable: TdxPieceTable;
    ...
    function GetCopyManagerCore(ASourcePieceTable: TdxPieceTable;
      ...
      AFormattingCopyOptions: TdxFormattingCopyOptions)
      : TdxCustomDocumentModelCopyManager;
    function GetRangeListCounters(AParagraph: TdxParagraph)
      : TIntegerDynArray; virtual;
    ...
    property RangePermissions: TdxRangePermissionCollection
      read FRangePermissions;
    ...
    property NavigationVisibleTextFilter: TdxVisibleTextFilterBase
      read FNavigationVisibleTextFilter;
    property FieldUpdater: TdxFieldUpdater read FFieldUpdater;
    property PreCalculatedNumberingListTexts: TDictionary<TdxParagraph, string>
      read FPreCalculatedNumberingListTexts
      write SetPreCalculatedNumberingListTexts;
    property SpellCheckerManager: TdxRichEditSpellCheckerManager
      read FSpellCheckerManager write SetSpellCheckerManager;
    property SuppressTableIntegrityCheck: Boolean
      read FSuppressTableIntegrityCheck write FSuppressTableIntegrityCheck;
    property LastInsertedFloatingObjectAnchorRunInfo
      : TdxLastInsertedFloatingObjectAnchorRunInfo
      read GetLastInsertedFloatingObjectAnchorRunInfo;
    property IsEmpty: Boolean read GetIsEmpty;
  end;
  ...
  strict protected
    ...
    function EqualsMergedCharacterCachedResult(ACachedResult
      : TdxParagraphMergedCharacterPropertiesCachedResult): Boolean; override;
    {$IFNDEF CPUX64} final; {$ENDIF}
    procedure DoUseMergedCharacterCachedResult(ACachedResult
      : TdxParagraphMergedCharacterPropertiesCachedResult); override;
    {$IFNDEF CPUX64} final; {$ENDIF}
  public
    ...
    function Copy(ACopyManager: TdxCustomDocumentModelCopyManager)
      : TdxParagraph;
    procedure CopyFrom(ADocumentModel: TdxDocumentModel;
      AResultParagraph: TdxParagraph);
    procedure CopyNumberingListProperties(ATargetParagraph: TdxParagraph);
    procedure CreateNumberingList(ATarget: TdxDocumentModel;
    ...
    function GetMergedCharacterProperties: TdxMergedCharacterProperties;
      overload; override;
    function GetMergedCharacterProperties(AUseSpecialTableStyle: Boolean;
      ATableStyle: TdxTableStyle): TdxMergedCharacterProperties; overload;

    function GetParentMergedParagraphProperties
      : TdxMergedParagraphProperties; override;
    function GetParentMergedWithTableStyleParagraphProperties
      (AUseSpecialTableStyle: Boolean; ATableStyle: TdxTableStyle)
      : TdxMergedParagraphProperties;
    function GetTableStyleCharacterPropertiesIndex: Integer;
    function TryUseParentMergedCachedResult(ACachedResult
      : TdxParagraphMergedParagraphPropertiesCachedResult;
      ATableStyleIndex: Integer): Boolean;
    function TryUseParentMergedCachedResultCore(ACachedResult
      : TdxParagraphMergedParagraphPropertiesCachedResult;
      AOwnListLevelParagraphPropertiesIndex, ATableStyleParagraphPropertiesIndex
      : Integer): Boolean;
    ...
    function GetNumberingListText(const ACounters: TIntegerDynArray)
      : string; overload;
    ...
    function GetAbstractNumberingListIndex
      : TdxAbstractNumberingListIndex; override;
  ...
  public
    ...
    property Items[Index: Integer]: TdxParagraph read GetItem
  ...
  public
    class function ShouldExportSectionColumns(AColumns: TdxSectionColumns;
      ADocumentModel: TdxDocumentModel): Boolean; static;
    class function ShouldInsertHyperlink(AModel: TdxDocumentModel)
      : Boolean; static;
    class function ShouldInsertHyperlinks(AModel: TdxDocumentModel)
      : Boolean; static;
    class function ShouldInsertNumbering(AModel: TdxDocumentModel)
      : Boolean; static;
    class function ShouldInsertMultiLevelNumbering(AModel: TdxDocumentModel)
      : Boolean; static;
    class function ShouldInsertBulletedNumbering(AModel: TdxDocumentModel)
      : Boolean; static;
    class function ShouldInsertPicture(AModel: TdxDocumentModel)
      : Boolean; static;
    class function ShouldInsertSimpleNumbering(AModel: TdxDocumentModel)
      : Boolean; static;
    class function NeedReplaceSimpleToBulletNumbering(AModel: TdxDocumentModel)
      : Boolean; static;
    class function NeedReplaceBulletedLevelsToDecimal(AModel: TdxDocumentModel)
      : Boolean; static;
  end;
  ...
  TdxSelectionItem = class(TdxChangeableDocumentInterval, IdxBatchUpdateHandler)
  strict private
  ...
  protected
    ...
    procedure SetStart(const Value: TdxDocumentLogPosition); override;
    {$IFNDEF CPUX64} final; {$ENDIF}
    procedure SetEnd(const Value: TdxDocumentLogPosition); override;
    {$IFNDEF CPUX64} final; {$ENDIF}
    property BatchUpdateHelper: TdxBatchUpdateHelper read GetBatchUpdateHelper;
    property IsSelectionInTable: Boolean read FIsSelectionInTable
      write FIsSelectionInTable;
  ...
  public
    ...
    function CalculateStartPosition(AAllowSelectionExpanding: Boolean)
      : TdxDocumentModelPosition;
    function CalculateEndPosition(AAllowSelectionExpanding: Boolean)
      : TdxDocumentModelPosition;
  ...
  protected
    ...
    function InitialSelection(APieceTable: TdxCustomPieceTable)
      : TdxSelectionItem; virtual;
...
{$REGION 'IdxDocumentModelStructureChangedListener'}
    ...
    procedure OnRunUnmerged(APieceTable: TdxCustomPieceTable;
      ...
      ADeltaRunLength: Integer); overload;
    procedure OnFieldInserted(APieceTable: TdxCustomPieceTable;
      AFieldIndex: Integer); overload;
    procedure OnFieldRemoved(APieceTable: TdxCustomPieceTable;
      AFieldIndex: Integer); overload;
{$ENDREGION}
    procedure OnParagraphInserted(ASectionIndex: TdxSectionIndex;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
      ACell: TdxCustomTableCell; AIsParagraphMerged: Boolean;
      AActualParagraphIndex: TdxParagraphIndex;
      AHistoryNotificationId: Integer); overload;
    procedure OnParagraphRemoved(ASectionIndex: TdxSectionIndex;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
      AHistoryNotificationId: Integer); overload;
    procedure OnParagraphMerged(ASectionIndex: TdxSectionIndex;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
      AHistoryNotificationId: Integer); overload;
    procedure OnRunInserted(AParagraphIndex: TdxParagraphIndex;
      ANewRunIndex: TdxRunIndex; ALength: Integer;
      AHistoryNotificationId: Integer); overload;
    procedure OnRunRemoved(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ALength: Integer;
      AHistoryNotificationId: Integer); overload;
    procedure OnBeginMultipleRunSplit; overload;
    procedure OnEndMultipleRunSplit; overload;
    procedure OnRunSplit(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ASplitOffset: Integer); overload;
    procedure OnRunJoined(AParagraphIndex: TdxParagraphIndex;
      AJoinedRunIndex: TdxRunIndex; ASplitOffset: Integer;
      ATailRunLength: Integer); overload;
    procedure OnRunMerged(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ADeltaRunLength: Integer); overload;
    procedure OnRunUnmerged(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ADeltaRunLength: Integer); overload;
    ...
    function GetEndParagraphIndex(ALogPosition: TdxDocumentLogPosition)
      : TdxParagraphIndex;
    function GetStartPositionInTableRow(ARow: TdxTableRow)
      : TdxDocumentLogPosition;
    function CalculateSelectionStart(ALogPosition: TdxDocumentLogPosition)
      : TdxDocumentLogPosition;
    function DetermineStartSelectedCell(ASelectionStart: TdxDocumentLogPosition)
      : TdxTableCell;
    function IsCellSelectedFully(ATableCell: TdxTableCell;
      ASelectionStart: TdxDocumentLogPosition;
      ASelectionEnd: TdxDocumentLogPosition): Boolean;
    function GetCellEndPosition(AStartCell: TdxTableCell)
      : TdxDocumentLogPosition;
    function DetermineEndCellByLogPosition(ASelectionStart
      : TdxDocumentLogPosition; ASelectionEnd: TdxDocumentLogPosition;
      AConsiderCellStart: Boolean): TdxTableCell;
    function DetermineEndCellCore(ASelectionStart: TdxDocumentLogPosition;
      ASelectionEnd: TdxDocumentLogPosition): TdxTableCell;
    function EnsureCellIsSelected(ASelectionStart: TdxDocumentLogPosition;
      ASelectionEnd: TdxDocumentLogPosition; ANextSelectedCell: TdxTableCell;
      APrevSelectedCell: TdxTableCell; AConsiderCellStart: Boolean)
      : TdxTableCell;
    function IsCellSelected(ACell: TdxTableCell;
      ASelectionStart: TdxDocumentLogPosition;
      ASelectionEnd: TdxDocumentLogPosition): Boolean;
    function GetPreviousTableCell(ACell: TdxTableCell;
      AIsLeftToRightDirection: Boolean): TdxTableCell;
    function IsColumnsSelected(APrevSelectedCell: TdxTableCell;
      ANextSelectedCell: TdxTableCell): Boolean;
    function GetLastSelectedCell: TdxTableCell;
    function IsRowsSelected(APrevSelectedCell: TdxTableCell;
      ANextSelectedCell: TdxTableCell): Boolean;
    function GetActualNestedLevelConsiderStartCell
      (AStartCell: TdxTableCell): Integer;
    procedure NormalizeTableCellsToMinNestedLevel(var AStartCell,
      AEndCell: TdxTableCell);
    function GetEndPositionInTableRow(AInitialEnd: TdxDocumentLogPosition;
      ACell: TdxTableCell; ANestedLevel: Integer): TdxDocumentLogPosition;
    function GetLastNonCoveredByVerticalMergingCell(ARow: TdxTableRow)
      : TdxTableCell;
    function GetFirstNonCoveredByVerticalMergingCell(ARow: TdxTableRow)
      : TdxTableCell;
    procedure UpdateSelectionBy(ASelectedCells
      : TdxSelectedTableStructureBase { TdxSelectedCellsCollection } );
    function IsLeftToRightDirection(ASelectedCells
      : TdxSelectedTableStructureBase { TdxSelectedCellsCollection } ): Boolean;
    procedure UpdateInTableSelectionItem(AItem: TdxSelectionItem;
  ...
  public
    ...
    function FirstAndSecondCellHaveCommonTableButSecondCellNotParentForFirstCell
      (AFirst: TdxTableCell; ASecond: TdxTableCell): Boolean;
    function FirstCellIsParentCellForSecondCellsTable(AFirstCell: TdxTableCell;
      ASecondCell: TdxTableCell): Boolean;
    ...
    procedure ManuallySetTableSelectionStructureAndChangeSelection
      (AStartCell: TdxTableCell; AEndCell: TdxTableCell;
      AIsColumnSelected: Boolean); overload;
    procedure ManuallySetTableSelectionStructureAndChangeSelection
      (AStartCell: TdxTableCell; AEndCell: TdxTableCell); overload;
    ...
    procedure UpdateTableSelectionEnd(ALogPosition: TdxDocumentLogPosition;
      AConsiderCellStart: Boolean = False);

    property Interval: TdxRunInfo read GetInterval;
    property IsMultiSelection: Boolean read GetIsMultiSelection;
    property NormalizedVirtualEnd: TdxDocumentLogPosition
      read GetNormalizedVirtualEnd;
    property VirtualEnd: TdxDocumentLogPosition read GetVirtualEnd;
    ...
    property SelectedCells: TdxSelectedTableStructureBase
      read FTableSelectionStructure write SetTableSelectionStructure;
    property PieceTable: TdxPieceTable read GetPieceTable;
    property SelectionGeneration: Integer read FSelectionGeneration
      write FSelectionGeneration;
    property UsePreviousBoxBounds: Boolean read GetUsePreviousBoxBounds
      write SetUsePreviousBoxBounds;
    property IsSelectionChanged: Boolean read GetIsSelectionChanged
      write SetIsSelectionChanged;
  end;
  ...
  public
    ...
    function CreateDocumentPainter(AGraphics: TdxGraphics): TObject; virtual;
      abstract;
  ...
  IdxDocumentExporterFactory = interface
    ...
    function CreateHtmlExporter(ADocumentModel: TdxDocumentModel;
      AOptions: TdxDocumentExporterOptions): TObject;
  end;

  IdxDocumentImporterFactory = interface
    ['{7D845116-E9F1-437B-9304-E38D846BABF3}']
    function CreateHtmlImporter(ADocumentModel: TdxDocumentModel;
      AOptions: TdxDocumentImporterOptions): TObject;
  end;
  ...
  TdxParagraphEvent = procedure(Sender: TObject; E: TdxParagraphEventArgs)
    of object;
  ...
  protected
    ...
    procedure SetExporterFactory(const Value: IdxDocumentExporterFactory);
      virtual; abstract;
    procedure SetImporterFactory(const Value: IdxDocumentImporterFactory);
      virtual; abstract;
    function GetConverter(Index: TdxMeasurementUnit): TdxUnitConverter;
      virtual; abstract;
  public
    ...
    function GetDocumentRtfContent(AOptions
      : TdxRtfDocumentExporterOptions = nil;
      ALastParagraphRunNotSelected: Boolean = False;
      AKeepFieldCodeViewState: Boolean = False;
      AForceRaiseBeforeExport: Boolean = False;
      AForceRaiseAfterExport: Boolean = False): string; virtual; abstract;
    function GetDocumentPlainTextContent
      (AOptions: TdxPlainTextDocumentExporterOptions = nil): string;
      virtual; abstract;
    function GetDocumentOpenXmlContent
      (AOptions: TdxOpenXmlDocumentExporterOptions): TArray<Byte>;
      virtual; abstract;
    function GetDocumentDocContent(AOptions: TdxDocDocumentExporterOptions)
      : TArray<Byte>; virtual; abstract;
    procedure LoadDocumentRtfContent(AStream: TStream;
      AOptions: TdxRtfDocumentImporterOptions); virtual; abstract;
    procedure LoadDocumentPlainTextContent(AStream: TStream;
      AOptions: TdxPlainTextDocumentImporterOptions); virtual; abstract;
    procedure SaveDocumentPlainTextContent(AStream: TStream;
      AOptions: TdxPlainTextDocumentExporterOptions); virtual; abstract;
    procedure SaveDocumentRtfContent(AStream: TStream;
      AOptions: TdxRtfDocumentExporterOptions); virtual; abstract;
    procedure LoadDocumentOpenXmlContent(AStream: TStream;
      AOptions: TdxOpenXmlDocumentImporterOptions); virtual; abstract;
    procedure SaveDocumentOpenXmlContent(AStream: TStream;
      AOptions: TdxOpenXmlDocumentExporterOptions); virtual; abstract;
    procedure LoadDocumentHtmlContent(AStream: TStream;
      AOptions: TdxHtmlDocumentImporterOptions); virtual; abstract;
    procedure SaveDocumentHtmlContent(AStream: TStream;
      AOptions: TdxHtmlDocumentExporterOptions); virtual; abstract;
    procedure LoadDocumentDocContent(AStream: TStream;
      AOptions: TdxDocDocumentImporterOptions); virtual; abstract;
    procedure SaveDocumentDocContent(AStream: TStream;
      AOptions: TdxDocDocumentExporterOptions); virtual; abstract;
    ...
    property Modified: Boolean read GetModified write SetModified;
    property ExporterFactory: IdxDocumentExporterFactory read GetExporterFactory
      write SetExporterFactory;
    property ImporterFactory: IdxDocumentImporterFactory read GetImporterFactory
      write SetImporterFactory;
    property UnitConverters[Index: TdxMeasurementUnit]: TdxUnitConverter
      read GetConverter;
  end;
  ...
  public
    function CreateNumberingListIndexCalculator(AModel: TdxDocumentModel;
      ANumberingListType: TdxNumberingType)
      : TdxNumberingListIndexCalculator; virtual;
  end;
  ...
  protected
    ...
    function BinarySearch(AStart, AEnd: TdxDocumentLogPosition)
      : Integer; overload;
    procedure OnRunRemoved(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ALength: Integer;
    ...
    procedure OnParagraphInserted(ASectionIndex: TdxSectionIndex;
      ...
      AHistoryNotificationId: Integer); virtual;
    procedure OnRunSplit(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ASplitOffset: Integer); virtual;
    procedure OnRunJoined(AParagraphIndex: TdxParagraphIndex;
      AJoinedRunIndex: TdxRunIndex; ASplitOffset: Integer;
  ...
  public
    ...
    function GetIntervals(AStart, AEnd: TdxDocumentLogPosition)
      : TArray<T>; virtual;
    function FindInterval(APosition: TdxDocumentLogPosition): T;
      overload; virtual;
    function FindInterval(AStart, AEnd: TdxDocumentLogPosition): T;
      overload; virtual;

    procedure RemoveRange(const ARange: TArray<T>); overload; virtual;
    procedure RemoveRange(AStart, AEnd: TdxDocumentLogPosition);
      overload; virtual;
    ...
    procedure ExtractRange(AStart, AEnd: TdxDocumentLogPosition);
      overload; virtual;
  ...
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      AErrorType: TdxSpellingError); reintroduce;
    procedure OnChangedCore; override;
  ...
  TdxIgnoredList = class
    (TdxSpellCheckerIntervalCollection<TdxMisspelledInterval>)
  strict private
  ...
  public
    ...
    function Contains(AStart, AEnd: TdxDocumentLogPosition; const AWord: string)
  ...
  TdxMisspelledIntervalCollection = class
    (TdxSpellCheckerIntervalCollection<TdxMisspelledInterval>)
  public
  ...
  TdxUncheckedIntervalCollection = class
    (TdxSpellCheckerIntervalCollection<TdxUncheckedInterval>)
  protected
    function SplitInterval(AIndex: Integer;
      const APosition: TdxDocumentModelPosition): Boolean; virtual;
    ...
    procedure OnRunRemoved(AParagraphIndex: TdxParagraphIndex;
      ...
      AHistoryNotificationId: Integer); override;
  public
    function ObtainIntervals(const AStart, AEnd: TdxDocumentModelPosition)
      : TArray<TdxUncheckedInterval>; virtual;
    procedure Add(ANewInterval: TdxUncheckedInterval); override;
  end;

  { TdxRichEditSpellCheckerManager }

  TdxRichEditSpellCheckerManager = class(TcxIUnknownObject,
    IdxDocumentModelStructureChangedListener)
  strict private
    FPieceTable: TdxSimplePieceTable;
  ...
  protected
    ...
    procedure CalculateUncheckedInterval(const AStart,
      AEnd: TdxDocumentModelPosition); virtual;
    ...
    function IsModifiedWord(const AStart,
      AEnd: TdxDocumentModelPosition): Boolean;
    procedure ProcessModifiedWord;
    function IsRangeEditable(const AStart,
      AEnd: TdxDocumentModelPosition): Boolean;
    function IsRangeVisible(const AStart,
      AEnd: TdxDocumentModelPosition): Boolean;
    procedure CalculateUncheckedIntervalCore(const AStart,
      AEnd: TdxDocumentModelPosition); virtual;
{$REGION 'IdxDocumentModelStructureChangedListener'}
    procedure OnBeginMultipleRunSplit(APieceTable: TdxCustomPieceTable);
    procedure OnEndMultipleRunSplit(APieceTable: TdxCustomPieceTable);
...
{$ENDREGION}
    ...
    procedure OnRunInserted(AParagraphIndex: TdxParagraphIndex;
      ANewRunIndex: TdxRunIndex; ALength: Integer;
      AHistoryNotificationId: Integer); overload; virtual;
    procedure OnRunInsertedCore(AParagraphIndex: TdxParagraphIndex;
      ANewRunIndex: TdxRunIndex; ALength: Integer;
      AHistoryNotificationId: Integer);
    procedure OnRunJoined(AParagraphIndex: TdxParagraphIndex;
      AJoinedRunIndex: TdxRunIndex; ASplitOffset: Integer;
      ATailRunLength: Integer); overload; virtual;
    procedure OnRunMerged(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ADeltaRunLength: Integer); overload; virtual;
    procedure OnRunMergedCore(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
    procedure OnRunRemoved(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ALength: Integer;
      AHistoryNotificationId: Integer); overload; virtual;
    procedure OnRunRemovedCore(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ALength: Integer;
      AHistoryNotificationId: Integer);
    procedure OnRunSplit(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ASplitOffset: Integer); overload; virtual;
    procedure OnRunUnmerged(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ADeltaRunLength: Integer); overload; virtual;
    procedure OnSelectionChanged(ASender: TObject);
  public
    ...
    function CreateInstance(APieceTable: TdxPieceTable)
      : TdxRichEditSpellCheckerManager; virtual;

    function PopUncheckedIntervals(const AStart, AEnd: TdxDocumentModelPosition)
      : TArray<TdxSpellCheckerInterval>; virtual;
    procedure RemoveMisspelledIntervals(AStart,
      AEnd: TdxDocumentLogPosition); virtual;
    procedure CreateMisspelledInterval(const AStart,
      AEnd: TdxDocumentModelPosition; AErrorType: TdxSpellingError); virtual;
    procedure InitializeUncheckedInterval; virtual;

    procedure Initialize; virtual;

    property PieceTable: TdxSimplePieceTable read FPieceTable;
    property MisspelledIntervals: TdxMisspelledIntervalCollection
      read FMisspelledIntervals;
    property UncheckedIntervals: TdxUncheckedIntervalCollection
      read FUncheckedIntervals;
    ...
    property ShouldCheckDocument: Boolean read FShouldCheckDocument
      write FShouldCheckDocument;
  end;
  ...
  public
    function CreateInstance(APieceTable: TdxPieceTable)
      : TdxRichEditSpellCheckerManager; override;
    procedure Initialize; override;
  end;
  ...
  strict private
    FUserData: TObject;
  public
    constructor Create(const APos: PdxDocumentModelPosition;
      AUserData: TObject);

    property UserData: TObject read FUserData;
  end;

function IsFormatterPositionEquals(const APos1,
  APos2: TdxFormatterPosition): Boolean;
...
type
  ...
  public
    class function CalculateChangeActions(AChange: TdxDocumentModelChangeType)
      : TdxDocumentModelChangeActions; static;
  end;
  ...
  protected
    procedure ParagraphInserted(ASectionIndex: TdxSectionIndex;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
      ACell: TdxCustomTableCell; AIsParagraphMerged: Boolean;
      AActualParagraphIndex: TdxParagraphIndex;
      AHistoryNotificationId: Integer); override;
    procedure ParagraphRemoved(ASectionIndex: TdxSectionIndex;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
      AHistoryNotificationId: Integer); override;
    procedure ParagraphMerged(ASectionIndex: TdxSectionIndex;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
      AHistoryNotificationId: Integer); override;
    procedure RunInserted(AParagraphIndex: TdxParagraphIndex;
      ANewRunIndex: TdxRunIndex; ALength, AHistoryNotificationId
      : Integer); override;
    procedure RunRemoved(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ALength, AHistoryNotificationId
      : Integer); override;
    procedure RunSplit(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ASplitOffset: Integer); override;
    procedure RunJoined(AParagraphIndex: TdxParagraphIndex;
      AJoinedRunIndex: TdxRunIndex;
      ASplitOffset, ATailRunLength: Integer); override;
    procedure RunMerged(AParagraphIndex: TdxParagraphIndex;
      ARunIndex: TdxRunIndex; ADeltaRunLength: Integer); override;
    procedure RaiseChanged; override;
    procedure UpdateStartPosition; override;

    function GetStart: TdxDocumentLogPosition; override; {$IFNDEF CPUX64} final;
    {$ENDIF}
    function GetEnd: TdxDocumentLogPosition; override; {$IFNDEF CPUX64} final;
    {$ENDIF}
  public
...
function CalculateFormattingRunIndex(ARuns: TdxTextRunCollection;
  ARunIndex: TdxRunIndex): TdxRunIndex;
var
...
constructor TdxDocumentUpdateCompleteEventArgs.Create(ADeferredChanges
  : TdxDocumentModelDeferredChanges);
begin
  inherited Create;
...
function TdxSafeDocumentModelEditor.GetUnsafeEditor
  : TdxUnsafeDocumentModelEditor;
begin
  Result := DocumentModel.UnsafeEditor;
end;

procedure TdxSafeDocumentModelEditor.InsertSectionCore(AParagraphIndex
  : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition);
begin
...
begin
  ...
  try
    PieceTable.InsertSectionParagraphCore(AParagraphIndex, ALogPosition,
      AForceVisible);
...
procedure TdxSafeDocumentModelEditor.PerformInsertSectionCore(AParagraphIndex
  : TdxParagraphIndex);
var
...
procedure TdxDocumentModel.AddAbstractNumberingListUsingHistory
  (AAbstractList: TdxAbstractNumberingList);
var
  AHistoryItem: TdxAddAbstractNumberingListHistoryItem;
begin
  AHistoryItem := TdxAddAbstractNumberingListHistoryItem.Create
    (ActivePieceTable);
...
function TdxDocumentModel.AutodetectDocumentFormat(const AFileName: string;
  AUseFormatFallback: Boolean = True): TdxRichEditDocumentFormat;
var
  AImportHelper: TdxImportHelper<TdxRichEditDocumentFormat, Boolean>;
  AImportManagerService
    : IdxImportManagerService<TdxRichEditDocumentFormat, Boolean>;
  AImporter: IdxImporter<TdxRichEditDocumentFormat, Boolean>;
begin
  AImportHelper := TdxImportHelper<TdxRichEditDocumentFormat, Boolean>
    (CreateDocumentImportHelper);
  try
    if not Supports(GetImportManagerService,
      IdxImportManagerService<TdxRichEditDocumentFormat, Boolean>,
      AImportManagerService) then
      Exit(AImportHelper.UndefinedFormat);
    if AImportManagerService = nil then
      Exit(AImportHelper.UndefinedFormat);

    AImporter := AImportHelper.AutodetectImporter(AFileName,
      AImportManagerService, AUseFormatFallback);
...
procedure TdxDocumentModel.AddNumberingListUsingHistory(ANumberingList
  : TdxNumberingList);
var
...
begin
  AddService(IdxDocumentImportManagerService,
    CreateDocumentImportManagerService);
  AddService(IdxDocumentExportManagerService,
    CreateDocumentExportManagerService);
  ...
  AddService(IdxRichEditProgressIndicationService,
    TdxRichEditProgressIndicationService.Create(Self));
  AddService(IdxHyphenationService, CreateHyphenationService);
end;

procedure TdxDocumentModel.ApplyChanges(APieceTable
  : TdxCustomPieceTable { TdxPieceTable };
  AChangeType: TdxDocumentModelChangeType;
...
begin
  ...
  AActions := TdxDocumentModelChangeActionsCalculator.CalculateChangeActions
    (AChangeType);
  ApplyChangesCore(APieceTable, AActions, AStartRunIndex, AEndRunIndex);
end;

procedure TdxDocumentModel.ApplyChangesCore(APieceTable
  : TdxCustomPieceTable { TdxPieceTable };
  AActions: TdxDocumentModelChangeActions;
  AStartRunIndex, AEndRunIndex: TdxRunIndex);
begin
  ...
  DeferredChanges.ApplyChanges(TdxPieceTable(APieceTable), AActions,
    AStartRunIndex, AEndRunIndex);
end;

procedure TdxDocumentModel.ApplySectionFormatting(ALogPositionStart
  : TdxDocumentLogPosition; ALength: Integer;
  AModifier: TdxSectionPropertyModifierBase);
begin
  if ALogPositionStart < 0 then
    TdxRichEditExceptions.ThrowArgumentException('logPositionStart',
      ALogPositionStart);
  if ALength <= 0 then
...
procedure TdxDocumentModel.ApplySectionFormattingCore(ALogPositionStart
  : TdxDocumentLogPosition; ALength: Integer;
  AModifier: TdxSectionPropertyModifierBase);
var
  I: Integer;
...
procedure TdxDocumentModel.BeforeFloatingObjectDrop(AOldPosition,
  ANewPosition: TdxDocumentLogPosition; APieceTable: TdxPieceTable);
begin
end;
...
begin
  AExportHelper := CreateDocumentExportHelper(ADocumentFormat)
    as TdxExportHelper;
  try
    ...
    AExportHelper.Export(AStream, ADocumentFormat, ATargetUri,
      AExportManagerService, AEncoding);
  finally
    AExportHelper.Free;
  end;
end;
...
procedure TdxDocumentModel.RaiseHyperlinkInfoDeleted
...
procedure TdxDocumentModel.OnMailMergeCurrentRowChanged(Sender: TObject;
  E: TdxEventArgs);
begin
end;

procedure TdxDocumentModel.OnMailMergeViewMergedDataChanged(Sender: TObject;
  E: TdxEventArgs);
begin
...
procedure TdxDocumentModel.OnMailMergeDataSourceChanged(Sender: TObject;
  E: TdxEventArgs);
begin
...
function TdxDocumentModel.CreateDocumentModelCopyOptions
...
procedure TdxDocumentModel.SetModelForExportCopyOptions
  (ACopyOptions: TdxDocumentModelCopyOptions);
begin
  ACopyOptions.DefaultPropertiesCopyOptions :=
    TdxDefaultPropertiesCopyOptions.Always;
  ACopyOptions.CopyDocumentVariables := True;
end;

procedure TdxDocumentModel.CopyDocumentModelOptions(ADestinationModel
  : TdxDocumentModel);
begin
  ADestinationModel.FieldOptions.CopyFrom(FieldOptions);
  ADestinationModel.PrintingOptions.UpdateDocVariablesBeforePrint :=
    PrintingOptions.UpdateDocVariablesBeforePrint;
end;

function TdxDocumentModel.CreateDocumentModelForExport
  (const AInitializeEmptyDocumentModel: TdxAction<TdxDocumentModel>)
  : TdxDocumentModel;
var
...
begin
  Result := CreateNew;
  Result.DisableCheckDocumentModelIntegrity :=
    DisableCheckDocumentModelIntegrity;
  ...
  Result.LayoutOptions.PrintLayoutView.AllowTablesToExtendIntoMargins :=
    LayoutOptions.PrintLayoutView.AllowTablesToExtendIntoMargins;
  Result.BookmarkOptions.AllowNameResolution :=
    BookmarkOptions.AllowNameResolution;
  AStartLogPosition := MainPieceTable.DocumentStartLogPosition;
  AEndLogPosition := MainPieceTable.DocumentEndLogPosition;
  ACopyOptions := CreateDocumentModelCopyOptions(AStartLogPosition,
    AEndLogPosition - AStartLogPosition + 1);
  try
    ...
    Result.ExtendedDocumentProperties.SetPages
      (ExtendedDocumentProperties.Pages);
    AService := GetService<IdxDocumentLayoutService>;
    if AService <> nil then
      AService.CreateService(Result);
    try
      ACommand := CreateDocumentModelCopyCommand(MainPieceTable, Result,
        ACopyOptions) as TdxDocumentModelCopyCommand;
      try
        ACommand.UpdateFieldOperationType :=
      ...
      Result.EndSetContentForExport
        (TdxDocumentModelChangeType.LoadNewDocument, False);
    end;
    Result.DocumentProperties.CopyFrom(DocumentProperties.Info);
    Result.DocumentExportOptions.CopyFrom(DocumentExportOptions);

    Result.PrintingOptions.EnablePageBackgroundOnPrint :=
      PrintingOptions.EnablePageBackgroundOnPrint;
...
function TdxDocumentModel.CheckDocumentProtectionPassword(const APassword
  : string): Boolean;
var
...
begin
  ...
  case DocumentSaveOptions.CurrentFormat of
    ...
    TdxRichEditDocumentFormat.OpenXml:
      Result := CheckOpenXmlDocumentProtectionPassword(ACalculatorClass,
        APassword);
  else
...
function TdxDocumentModel.CheckDocumentProtectionPasswordCore
  ...
  const APassword: string): Boolean;
begin
  if (ProtectionProperties.OpenOfficePasswordHash <> nil) and
    (Length(ProtectionProperties.OpenOfficePasswordHash) > 0) then
...
function TdxDocumentModel.CheckIsOverrideEquals(ATargetNumberingList,
  ASourceNumberingList: TdxNumberingList): Boolean;
var
  I: Integer;
...
var
  AHash: TArray<Byte>;
begin
  AHash := ACalculator.CalculateRichEditPasswordHash(APassword,
    ProtectionProperties.PasswordPrefix,
    ProtectionProperties.HashIterationCount,
    ProtectionProperties.HashAlgorithmType);
...
function TdxDocumentModel.CheckPasswordHash(const AHash, AExpectedHash
  : TArray<Byte>): Boolean;
begin
...
function TdxDocumentModel.CheckRtfDocumentProtectionPassword
  ...
  const APassword: string): Boolean;
begin
  if (ProtectionProperties.Word2003PasswordHash <> nil) and
    (Length(ProtectionProperties.Word2003PasswordHash) > 0) then
...
begin
  ...
  FNumberDecimalSeparator := TdxCultureInfo.CurrentCulture.NumberFormat.
    NumberDecimalSeparator;
  FNumberGroupSeparator := TdxCultureInfo.CurrentCulture.NumberFormat.
...
begin
  ...
  FDefaultTableCellProperties := TdxTableCellProperties.Create
    (MainPieceTable, Self);
end;
...
procedure TdxDocumentModel.ResetDocumentFormattingCaches
...
procedure TdxDocumentModel.ClearModelCachedIndices(AResetFormattingCacheType
  : TdxResetFormattingCacheType);
begin
  if AResetFormattingCacheType in [TdxResetFormattingCacheType.Paragraph,
    TdxResetFormattingCacheType.All] then
    ParagraphStyles.ResetCachedIndices(AResetFormattingCacheType);
  if AResetFormattingCacheType in [TdxResetFormattingCacheType.Character,
    TdxResetFormattingCacheType.All] then
...
function TdxDocumentModel.CreateCellPropertiesChangedHistoryItem
  (AProperties: TdxTableCellProperties): TdxIndexChangedHistoryItemCore;
begin
  Assert(AProperties = DefaultTableCellProperties);
  Result := TdxIndexChangedHistoryItem.Create
    (AProperties.PieceTable as TdxPieceTable, AProperties);
end;

procedure TdxDocumentModel.CreateAbstractNumberingList
  (ATarget: TdxDocumentModel; ATargetList: TdxAbstractNumberingList;
...
function TdxDocumentModel.CreateCommandCreationStrategy
  : TdxRichEditCommandsCreationStrategy;
begin
  Result := TdxRichEditCommandsCreationStrategy.Create;
end;

function TdxDocumentModel.CreateCopySectionOperation(ACopyManager
  : TdxCustomDocumentModelCopyManager): TdxSelectionBasedOperation;
begin
  Result := TdxCopySectionOperation.Create
    (TdxDocumentModelCopyManager(ACopyManager));
end;

function TdxDocumentModel.CreateDeferredChanges
...
function TdxDocumentModel.CreateDocumentExportHelper(ADocumentFormat
  : TdxRichEditDocumentFormat): TObject;
begin
  Result := TdxDocumentExportHelper.Create(Self);
end;

function TdxDocumentModel.CreateEmptySpellCheckerManager
  (APieceTable: TdxCustomPieceTable): TObject;
begin
  Result := TdxEmptySpellCheckerManager.Create
    (TdxSimplePieceTable(APieceTable));
end;
...
function TdxDocumentModel.CreateDocumentModelCopyCommand(ASourcePieceTable
  : TdxPieceTable; ATarget: TdxDocumentModel;
  AOptions: TdxDocumentModelCopyOptions): TObject;
begin
  Assert(ASourcePieceTable.DocumentModel = Self);
  Result := TdxDocumentModelCopyCommand.Create(ASourcePieceTable, ATarget,
    AOptions);
end;
...
begin
  ...
  FLastInsertedFloatingObjectAnchorRunInfo :=
    TdxLastInsertedFloatingObjectAnchorRunInfo.Create;
  ...
  FAbstractNumberingListIdProvider :=
    TdxAbstractNumberingListIdProvider.Create(Self);
  ...
  FFloatingObjectBorderInfoRepository := TdxBorderInfoRepository.Create
    (UnitConverter);
...
function TdxDocumentModel.
  CreateHyphenationService { (AContainer: IdxServiceContainer; AServiceType: TObject) }
  : IInterface;
begin
...
function TdxDocumentModel.CreateMailMergeDataController
  : TdxRichEditDataControllerAdapterBase;
begin
...
function TdxDocumentModel.CreateDocumentCapabilitiesOptions
  : TdxCustomDocumentCapabilitiesOptions;
begin
  Result := TdxDocumentCapabilitiesOptions.Create;
end;

function TdxDocumentModel.CreateDocumentExportOptions
  : TdxRichEditDocumentExportOptions;
begin
  Result := TdxRichEditDocumentExportOptions.Create;
end;

function TdxDocumentModel.CreateDocumentImportOptions
...
function TdxDocumentModel.CreateFormattingMarkVisibilityOptions
...
function TdxDocumentModel.CreateRangePermissionOptions
...
function TdxDocumentModel.CreatePieceTable(AContentType: TdxContentTypeBase)
  : TdxCustomPieceTable { TdxPieceTable };
begin
  Result := TdxPieceTable.Create(Self, AContentType);
end;

procedure TdxDocumentModel.DeleteDefaultNumberingList(ANumberingLists
  : TdxNumberingListCollection);
begin
...
procedure TdxDocumentModel.EndSetContent(AChangeType
  : TdxDocumentModelChangeType; AUpdateFields: Boolean;
  AUpdateOptions: TdxFieldUpdateOnLoadOptions);
begin
...
procedure TdxDocumentModel.EndSetContent(AChangeType
  : TdxDocumentModelChangeType; AUpdateFields, APasteFromIe: Boolean;
  AUpdateOptions: TdxFieldUpdateOnLoadOptions;
  const AAfterPieceTablesEndSetContentAction: TdxAction = nil);
const
  UpdateFieldOperationTypeMap: array [Boolean] of TdxUpdateFieldOperationType =
    (TdxUpdateFieldOperationType.Load, TdxUpdateFieldOperationType.PasteFromIE);
var
  I: Integer;
  APieceTable: TdxPieceTable;
  APieceTables: TdxFastList;
  ...
  try
    ...
    begin
      ...
      if DocumentCapabilities.Fields = TdxDocumentCapability.Disabled then
        APieceTable.ProcessFieldsRecursive(nil,
          function(AField: TdxField): Boolean
          begin
            Result := False;
          end);
...
procedure TdxDocumentModel.EndSetContentForExport
  (AChangeType: TdxDocumentModelChangeType; AUpdateFields: Boolean);
begin
...
begin
  ...
  try
    ...
    begin
      ...
      ProtectionProperties.PasswordHash :=
        TdxPasswordHashCodeCalculator.CalculateRichEditPasswordHash(APassword,
        ProtectionProperties.PasswordPrefix,
        ProtectionProperties.HashIterationCount,
        ProtectionProperties.HashAlgorithmType);
      ProtectionProperties.Word2003PasswordHash :=
        TdxPasswordHashCodeCalculator.CalculateLegacyPasswordHash(APassword);
      ProtectionProperties.OpenOfficePasswordHash :=
        TdxPasswordHashCodeCalculator.CalculateOpenOfficePasswordHash
        (APassword);
    end;
  finally
    EndUpdate;
...
procedure TdxDocumentModel.EnsurePieceTableImagesLoadComplete
  (APieceTable: TdxPieceTable);
begin
...
begin
  BeginUpdate;
  try
    DeferredChanges.ChangeActions := DeferredChanges.ChangeActions +
      [TdxDocumentModelChangeAction.ForceSyntaxHighlight];
    if not(TdxDocumentModelChangeAction.RaiseContentChanged
      in DeferredChanges.ChangeActions) then
      DeferredChanges.ChangeActions := DeferredChanges.ChangeActions +
...
function TdxDocumentModel.GetAbstractNumberingListIndex
  (ATarget: TdxDocumentModel; ASourceListIndex: TdxNumberingListIndex)
  : TdxAbstractNumberingListIndex;
var
  ANumberingListId: Integer;
  ...
  begin
    ...
    begin
      if ATargetList.Deleted then
        CreateAbstractNumberingList(ATarget, ATargetList, ANumberingListId,
          ASourceListIndex);
      Exit(I);
    end;
  end;
...
begin
  AHeaderFooter := Safe<TdxSectionHeaderFooterBase>.Cast
    (Selection.PieceTable.ContentType);
...
function TdxDocumentModel.GetBookmarks(AIncludeHiddenBookmarks: Boolean = True)
  : TdxBookmarkList;
var
  APieceTables: TdxFastList;
  APieceTable: TdxPieceTable;
...
function TdxDocumentModel.GetBoxEffectiveRotationAngleInDegrees
  (ABox: TdxBox): Single;
begin
  Result := UnitConverter.ModelUnitsToDegreeF
    (GetBoxEffectiveRotationAngle(ABox));
end;
...
function TdxDocumentModel.GetEncryptionProperties
...
procedure TdxDocumentModel.SetDocumentCapabilities
  (const Value: TdxDocumentCapabilitiesOptions);
begin
...
begin
  Result := MainPieceTable.IsEmpty and (Sections.Count <= 1) and
    not Sections.First.HasNonEmptyHeadersOrFooters;
end;
...
procedure TdxDocumentModel.EnsureNumberingListStyleValid
  (AStyle: TdxNumberingListStyle; AMaxListIndex: TdxNumberingListIndex);
var
  ...
  AAbstractList: TdxAbstractNumberingList;
begin
  if (AStyle.NumberingListIndex < NumberingListIndexMinValue) or
    (AStyle.NumberingListIndex > AMaxListIndex) then
    Exit;
  ...
  try
    ...
    begin
      ...
      begin
        AAbstractList.SetStyleLinkIndex
          (AAbstractList.NumberingStyleReferenceIndex);
        Exit;
      end;
...
begin
  ATargetAbstractNumberingListIndex := GetAbstractNumberingListIndex
    (ATargetModel, ASourceListIndex);
  ...
  AMaxNumberingListIndex := Min(AMaxNumberingListIndex,
    ATargetModel.NumberingLists.Count - 1);
  for I := 0 to AMaxNumberingListIndex do
  begin
    ATargetNumberingList := ATargetModel.NumberingLists[I];
    if (AAbstractNumberingListId = ATargetNumberingList.AbstractNumberingList.
      Id) and CheckIsOverrideEquals(ATargetNumberingList, ASourceNumberingList)
    then
      Exit(I);
  end;
  ANumberingList := TdxNumberingList.Create(ATargetModel,
    ATargetAbstractNumberingListIndex);
...
function TdxDocumentModel.GetPieceTables(AIncludeUnreferenced: Boolean)
  : TdxFastList;
var
  I: TdxSectionIndex;
begin
...
begin
  ...
  Result := Selection.PieceTable.GetFilteredPlainText(AStart, AEnd,
    Selection.PieceTable.VisibleTextFilter.IsRunVisible);
end;
...
procedure TdxDocumentModel.InheritDataServices(ADocumentModel
  : TdxDocumentModel);
begin
end;

procedure TdxDocumentModel.InheritServicesForExport(ADocumentModel
  : TdxDocumentModel);
begin
...
procedure TdxDocumentModel.InheritUriProviderService(ADocumentModel
  : TdxDocumentModel);
begin
end;
...
begin
  ...
  FDefaultTableProperties.SetIndexInitial
    (TdxTablePropertiesOptionsCache.RootTableFormattingOptionsItem);
  FDefaultTableRowProperties.SetIndexInitial
    (TdxTableRowPropertiesOptionsCache.RootRowPropertiesOptionsItem);
  FDefaultTableCellProperties.SetIndexInitial
    (TdxTableCellPropertiesOptionsCache.RootCellPropertiesOptionsItem);
end;
...
procedure TdxDocumentModel.InsertSection(ALogPosition: TdxDocumentLogPosition;
AForceVisible: Boolean = False);
var
  ACommand: TdxDocumentModelInsertSectionAtLogPositionCommand;
begin
  ACommand := TdxDocumentModelInsertSectionAtLogPositionCommand.Create(Self,
    ALogPosition, AForceVisible);
  try
    ACommand.Execute;
  finally
    ACommand.Free;
...
begin
  ...
  ActivePieceTable.ApplyChangesCore([TdxDocumentModelChangeAction.Redraw,
    ...
    TdxDocumentModelChangeAction.ForceResetVerticalRuler], 0, MaxInt);
end;
...
begin
  ...
  ActivePieceTable.ApplyChangesCore([TdxDocumentModelChangeAction.Redraw,
    ...
    TdxDocumentModelChangeAction.ResetCaretInputPositionFormatting,
    TdxDocumentModelChangeAction.ForceResetHorizontalRuler,
    TdxDocumentModelChangeAction.ForceResetVerticalRuler], ARunIndex, MaxInt);
end;

function TdxDocumentModel.IsCursorInParagraph(AParagraph: TdxParagraph)
  : Boolean;
var
  APieceTable: TdxPieceTable;
...
begin
  ...
  Result := (APieceTable = ASelection.PieceTable) and
    (ASelection.Items.Count = 1) and (ASelection.Length = 0) and
    (ASelection.Start >= AParagraph.LogPosition) and
    (ASelection.Start <= AParagraph.EndLogPosition);
end;

function TdxDocumentModel.IsSpecialEmptyParagraphAfterInnerTable
  (AParagraph: TdxParagraph; ACell: TdxTableCell): Boolean;
var
...
procedure TdxDocumentModel.LoadDocument(AStream: TStream;
ADocumentFormat: TdxRichEditDocumentFormat; const ASourceUri: string;
AEncoding: TEncoding);
var
  AImportHelper: TdxImportHelper<TdxRichEditDocumentFormat, Boolean>;
...
begin
  ...
  try
    ...
    if not Supports(AService, IdxImportManagerService<TdxRichEditDocumentFormat,
      Boolean>, AImportManagerService) then
      AImportHelper.ThrowUnsupportedFormatException;
    APrevModified := Modified;
    AImportHelper.Import(AStream, ADocumentFormat, ASourceUri,
      AImportManagerService, AEncoding);
...
E: TdxRichEditNotificationOptionsChangedArgs);
begin
  if TdxViewLayoutOptionsBase.TAction.AllowTablesToExtendIntoMargins in E.Actions
  then
    OnLayoutTablesToExtendIntoMarginsOptionsChanged;
  if TdxViewLayoutOptionsBase.TAction.MatchHorizontalTableIndentsToTextEdge
    in E.Actions then
    OnMatchHorizontalTableIndentsToTextEdgeOptionsChanged;
end;

procedure TdxDocumentModel.OnBeginMultipleRunSplit
  (APieceTable: TdxCustomPieceTable);
begin
  Assert(IsUpdateLockedOrOverlapped);
  if not DeferredChanges.IsSetContentMode then
    TdxDocumentModelStructureChangedNotifier.NotifyBeginMultipleRunSplit
      (Selection, APieceTable);
end;
...
procedure TdxDocumentModel.OnDocumentPropertiesObtainAffectedRange
  (ASender: TObject; E: TdxObtainAffectedRangeEventArgs);
begin
  E.Start := 0;
  E.&End := MaxInt;
end;

procedure TdxDocumentModel.OnDocumentPropertiesPageBackgroundChanged
  (ASender: TObject; E: TdxEventArgs);
begin
  RaisePageBackgroundChanged;
end;

procedure TdxDocumentModel.OnEndMultipleRunSplit(APieceTable
  : TdxCustomPieceTable);
begin
  Assert(IsUpdateLockedOrOverlapped);
  if not DeferredChanges.IsSetContentMode then
    TdxDocumentModelStructureChangedNotifier.NotifyEndMultipleRunSplit
      (Selection, APieceTable);
end;
...
procedure TdxDocumentModel.OnFieldInserted(APieceTable: TdxCustomPieceTable;
AFieldIndex: Integer);
begin
  Assert(IsUpdateLocked);
  if not DeferredChanges.IsSetContentMode and not SuppressFieldsChangeNotification
  then
    TdxDocumentModelStructureChangedNotifier.NotifyFieldInserted
      (TdxInternalAPI(InternalAPI), APieceTable, AFieldIndex);
end;

procedure TdxDocumentModel.OnFieldRemoved(APieceTable: TdxCustomPieceTable;
AFieldIndex: Integer);
begin
  if not DeferredChanges.IsSetContentMode and not SuppressFieldsChangeNotification
  then
    TdxDocumentModelStructureChangedNotifier.NotifyFieldRemoved
      (TdxInternalAPI(InternalAPI), APieceTable, AFieldIndex);
end;
...
procedure TdxDocumentModel.OnHistoryModifiedChanged(ASender: TObject;
E: TdxEventArgs);
begin
  if IsUpdateLockedOrOverlapped then
    ActivePieceTable.ApplyChangesCore
      ([TdxDocumentModelChangeAction.RaiseModifiedChanged], dxRunIndexDontCare,
      dxRunIndexDontCare)
  else
    RaiseModifiedChanged;
end;

procedure TdxDocumentModel.OnHistoryOperationCompleted(ASender: TObject;
E: TdxEventArgs);
begin
  RaiseInnerContentChanged;
  if IsUpdateLockedOrOverlapped then
    ActivePieceTable.ApplyChangesCore
      ([TdxDocumentModelChangeAction.RaiseContentChanged], dxRunIndexDontCare,
      dxRunIndexDontCare)
  else
    RaiseContentChanged;
end;
...
var
  APieceTable: TdxCustomPieceTable;
  ADeferredChangesRunIndicesForSplit
    : TDictionary<TdxCustomPieceTable, TdxSortedRunIndexCollection>;
begin
  if TdxDocumentModelChangeAction.RaiseSelectionChanged in DeferredChanges.ChangeActions
  then
  begin
    ...
    begin
      ...
      ActivePieceTable.ApplyChangesCore
        ([TdxDocumentModelChangeAction.ResetPrimaryLayout,
        TdxDocumentModelChangeAction.ResetSecondaryLayout,
        TdxDocumentModelChangeAction.Redraw], FSpecialEmptyParagraphRunIndex,
        FSpecialEmptyParagraphRunIndex);
      FIsLastSelectionInEmptySpecialParagraph := True;
    end
    else if FIsLastSelectionInEmptySpecialParagraph then
    begin
      ActivePieceTable.ApplyChangesCore
        ([TdxDocumentModelChangeAction.ResetPrimaryLayout,
        TdxDocumentModelChangeAction.ResetSecondaryLayout,
  ...
  for APieceTable in ADeferredChangesRunIndicesForSplit.Keys do
    TdxPieceTable(APieceTable).PerformTextRunSplit
      (ADeferredChangesRunIndicesForSplit[APieceTable]);

  if History.HasChangesInCurrentTransaction and
    not(TdxDocumentModelChangeAction.
    SuppressRaiseContentChangedCalculationByCurrentTransactionChanges
    in DeferredChanges.ChangeActions) then
    DeferredChanges.ChangeActions := DeferredChanges.ChangeActions +
  ...
  if TdxDocumentModelChangeAction.ApplyAutoCorrect in DeferredChanges.ChangeActions
  then
    PerformAutoCorrect;
...
const
  ChangeActions = [TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetSelectionLayout,
    TdxDocumentModelChangeAction.ResetCaretInputPositionFormatting,
    TdxDocumentModelChangeAction.ResetAllPrimaryLayout,
    TdxDocumentModelChangeAction.ForceResetHorizontalRuler,
...
procedure TdxDocumentModel.OnParagraphInserted(APieceTable: TdxCustomPieceTable;
ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
...
begin
  ...
  if not DeferredChanges.IsSetContentMode then
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphInserted
      (DeferredChanges, APieceTable, ASectionIndex, AParagraphIndex, ARunIndex,
      ACell, AIsParagraphMerged, AActualParagraphIndex, AHistoryNotificationId);
    if not SuppressFieldsChangeNotification then
      TdxDocumentModelStructureChangedNotifier.NotifyParagraphInserted
        (TdxInternalAPI(InternalAPI), APieceTable, ASectionIndex,
        AParagraphIndex, ARunIndex, ACell, AIsParagraphMerged,
        AActualParagraphIndex, AHistoryNotificationId);
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphInserted(Selection,
      APieceTable, ASectionIndex, AParagraphIndex, ARunIndex, ACell,
      AIsParagraphMerged, AActualParagraphIndex, AHistoryNotificationId);
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphInserted
      (SearchContext, APieceTable, ASectionIndex, AParagraphIndex, ARunIndex,
      ACell, AIsParagraphMerged, AActualParagraphIndex, AHistoryNotificationId);
  end;
...
procedure TdxDocumentModel.OnParagraphMerged(APieceTable: TdxCustomPieceTable;
ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; AHistoryNotificationId: Integer);
begin
  Assert(IsUpdateLocked);
  if not DeferredChanges.IsSetContentMode then
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphMerged
      (DeferredChanges, APieceTable, ASectionIndex, AParagraphIndex, ARunIndex,
    ...
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphMerged(Selection,
      APieceTable, ASectionIndex, AParagraphIndex, ARunIndex,
      AHistoryNotificationId);
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphMerged
      (SearchContext, APieceTable, ASectionIndex, AParagraphIndex, ARunIndex,
      AHistoryNotificationId);
...
procedure TdxDocumentModel.OnParagraphRemoved(APieceTable: TdxCustomPieceTable;
ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; AHistoryNotificationId: Integer);
begin
  Assert(IsUpdateLocked);
  if not DeferredChanges.IsSetContentMode then
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphRemoved
      (DeferredChanges, APieceTable, ASectionIndex, AParagraphIndex, ARunIndex,
      AHistoryNotificationId);
    if not SuppressFieldsChangeNotification then
      TdxDocumentModelStructureChangedNotifier.NotifyParagraphRemoved
        (TdxInternalAPI(InternalAPI), APieceTable, ASectionIndex,
        AParagraphIndex, ARunIndex, AHistoryNotificationId);
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphRemoved(Selection,
      APieceTable, ASectionIndex, AParagraphIndex, ARunIndex,
      AHistoryNotificationId);
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphRemoved
      (SearchContext, APieceTable, ASectionIndex, AParagraphIndex, ARunIndex,
...
procedure TdxDocumentModel.OnProtectionPropertiesObtainAffectedRange
  (ASender: TObject; E: TdxObtainAffectedRangeEventArgs);
begin
  E.Start := 0;
  E.&End := MaxInt;
...
procedure TdxDocumentModel.OnRunInserted(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ANewRunIndex: TdxRunIndex;
...
begin
  ...
  if not DeferredChanges.IsSetContentMode then
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyRunInserted(DeferredChanges,
      APieceTable, AParagraphIndex, ANewRunIndex, ALength,
      AHistoryNotificationId);
    TdxDocumentModelStructureChangedNotifier.NotifyRunInserted
      (TdxInternalAPI(InternalAPI), APieceTable, AParagraphIndex, ANewRunIndex,
      ALength, AHistoryNotificationId);
    TdxDocumentModelStructureChangedNotifier.NotifyRunInserted(Selection,
      APieceTable, AParagraphIndex, ANewRunIndex, ALength,
      AHistoryNotificationId);
    TdxDocumentModelStructureChangedNotifier.NotifyRunInserted(SearchContext,
      APieceTable, AParagraphIndex, ANewRunIndex, ALength,
      AHistoryNotificationId);
  end;
end;

procedure TdxDocumentModel.OnRunJoined(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; AJoinedRunIndex: TdxRunIndex;
...
begin
  ...
  if not DeferredChanges.IsSetContentMode then
    TdxDocumentModelStructureChangedNotifier.NotifyRunJoined(DeferredChanges,
      APieceTable, AParagraphIndex, AJoinedRunIndex, ASplitOffset,
      ATailRunLength);
  if not DeferredChanges.IsSetContentMode then
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyRunJoined(DeferredChanges,
      APieceTable, AParagraphIndex, AJoinedRunIndex, ASplitOffset,
      ATailRunLength);
    TdxDocumentModelStructureChangedNotifier.NotifyRunJoined
      (TdxInternalAPI(InternalAPI), APieceTable, AParagraphIndex,
      AJoinedRunIndex, ASplitOffset, ATailRunLength);
    TdxDocumentModelStructureChangedNotifier.NotifyRunJoined(Selection,
      APieceTable, AParagraphIndex, AJoinedRunIndex, ASplitOffset,
      ATailRunLength);
    TdxDocumentModelStructureChangedNotifier.NotifyRunJoined(SearchContext,
      APieceTable, AParagraphIndex, AJoinedRunIndex, ASplitOffset,
      ATailRunLength);
  end;
end;

procedure TdxDocumentModel.OnRunMerged(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ADeltaRunLength: Integer);
begin
  Assert(IsUpdateLocked);
  if not DeferredChanges.IsSetContentMode then
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyRunMerged(DeferredChanges,
      APieceTable, AParagraphIndex, ARunIndex, ADeltaRunLength);
    TdxDocumentModelStructureChangedNotifier.NotifyRunMerged
      (TdxInternalAPI(InternalAPI), APieceTable, AParagraphIndex, ARunIndex,
      ADeltaRunLength);
    TdxDocumentModelStructureChangedNotifier.NotifyRunMerged(Selection,
      APieceTable, AParagraphIndex, ARunIndex, ADeltaRunLength);
    TdxDocumentModelStructureChangedNotifier.NotifyRunMerged(SearchContext,
      APieceTable, AParagraphIndex, ARunIndex, ADeltaRunLength);
  end;
end;

procedure TdxDocumentModel.OnRunRemoved(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ALength, AHistoryNotificationId: Integer);
begin
  Assert(IsUpdateLockedOrOverlapped);
  ...
  if not DeferredChanges.IsSetContentMode then
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyRunRemoved(DeferredChanges,
      APieceTable, AParagraphIndex, ARunIndex, ALength, AHistoryNotificationId);
    TdxDocumentModelStructureChangedNotifier.NotifyRunRemoved
      (TdxInternalAPI(InternalAPI), APieceTable, AParagraphIndex, ARunIndex,
      ALength, AHistoryNotificationId);
    TdxDocumentModelStructureChangedNotifier.NotifyRunRemoved(Selection,
      APieceTable, AParagraphIndex, ARunIndex, ALength, AHistoryNotificationId);
    TdxDocumentModelStructureChangedNotifier.NotifyRunRemoved(SearchContext,
      APieceTable, AParagraphIndex, ARunIndex, ALength, AHistoryNotificationId);
  end;
end;

procedure TdxDocumentModel.OnRunSplit(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ASplitOffset: Integer);
begin
  Assert(IsUpdateLockedOrOverlapped);
  ...
  if not DeferredChanges.IsSetContentMode then
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyRunSplit(DeferredChanges,
      APieceTable, AParagraphIndex, ARunIndex, ASplitOffset);
    TdxDocumentModelStructureChangedNotifier.NotifyRunSplit
      (TdxInternalAPI(InternalAPI), APieceTable, AParagraphIndex, ARunIndex,
      ASplitOffset);
    TdxDocumentModelStructureChangedNotifier.NotifyRunSplit(Selection,
      APieceTable, AParagraphIndex, ARunIndex, ASplitOffset);
    TdxDocumentModelStructureChangedNotifier.NotifyRunSplit(SearchContext,
      APieceTable, AParagraphIndex, ARunIndex, ASplitOffset);
  end;
end;

procedure TdxDocumentModel.OnRunUnmerged(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ADeltaRunLength: Integer);
begin
  Assert(IsUpdateLocked);
  if not DeferredChanges.IsSetContentMode then
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyRunUnmerged(DeferredChanges,
      APieceTable, AParagraphIndex, ARunIndex, ADeltaRunLength);
    TdxDocumentModelStructureChangedNotifier.NotifyRunUnmerged
      (TdxInternalAPI(InternalAPI), APieceTable, AParagraphIndex, ARunIndex,
      ADeltaRunLength);
    TdxDocumentModelStructureChangedNotifier.NotifyRunUnmerged(Selection,
      APieceTable, AParagraphIndex, ARunIndex, ADeltaRunLength);
    TdxDocumentModelStructureChangedNotifier.NotifyRunUnmerged(SearchContext,
      APieceTable, AParagraphIndex, ARunIndex, ADeltaRunLength);
  end;
end;
...
procedure TdxDocumentModel.OnTableOptionsChanged(ASender: TObject;
E: TdxRichEditNotificationOptionsChangedArgs);
begin
...
procedure TdxDocumentModel.PreprocessContentBeforeExport
...
procedure TdxDocumentModel.PreprocessContentBeforeInsert
  (ADestination: TdxPieceTable; APos: TdxDocumentLogPosition);
begin
...
procedure TdxDocumentModel.RaiseBeforeExportFromExportModel(ASender: TObject;
E: TdxBeforeExportEventArgs);
begin
...
procedure TdxDocumentModel.RaiseCalculateDocumentVariableForExport
  (ASender: TObject; E: TdxCalculateDocumentVariableEventArgs);
begin
  RaiseCalculateDocumentVariable(E);
end;

procedure TdxDocumentModel.RaiseBeforeExport(AFormat: TdxRichEditDocumentFormat;
const AOptions: IdxExporterOptions);
var
...
procedure TdxDocumentModel.RecalcSectionIndices(AFrom: TdxSectionIndex;
ADeltaIndex: Integer);
begin
  Sections[AFrom].LastParagraphIndex := Sections[AFrom].LastParagraphIndex +
    ADeltaIndex;
  RecalcSectionIndicesCore(AFrom + 1, ADeltaIndex);
end;

procedure TdxDocumentModel.RecalcSectionIndicesCore(AFrom: TdxSectionIndex;
ADeltaIndex: Integer);
var
  I: Integer;
  ASection: TdxSection;
...
procedure TdxDocumentModel.NotifyNumberingListParagraphAdded
  (AIndex: TdxNumberingListIndex);
begin
  TdxNumberingListNotifier.NotifyParagraphAdded(Self, AIndex);
end;

procedure TdxDocumentModel.NotifyNumberingListParagraphRemoved
  (AIndex: TdxNumberingListIndex);
begin
...
begin
  FreeAndNil(FLineNumberRun);
  FLineNumberRun := TdxLineNumberCommonRun.Create
    (MainPieceTable.Paragraphs.First);
  AStyleIndex := CharacterStyles.GetStyleIndexByName
    (TdxCharacterStyleCollection.LineNumberingStyleName);
...
function TdxDocumentModel.QueryEncryptionPassword(var APassword
  : string): Boolean;
begin
...
function TdxDocumentModel.LookupSectionIndexByParagraphIndex(AParagraphIndex
  : TdxParagraphIndex): TdxSectionIndex;
begin
...
function TdxDocumentModel.RaiseMailMergeStarted
  (const Args: TdxMailMergeStartedEventArgs): Boolean;
begin
...
function TdxDocumentModel.RaiseMailMergeRecordStarted
  (const Args: TdxMailMergeRecordStartedEventArgs): Boolean;
begin
...
function TdxDocumentModel.RaiseMailMergeRecordFinished
  (const Args: TdxMailMergeRecordFinishedEventArgs): Boolean;
begin
...
procedure TdxDocumentModel.RaiseMailMergeFinished
...
procedure TdxDocumentModel.RaiseMailMergeGetTargetDocument
  (const Args: TdxMailMergeGetTargetDocumentEventArgs);
begin
...
function TdxDocumentModel.RemoveDocumentProtection(const APassword
  : string): Boolean;
begin
...
procedure TdxDocumentModel.ResetAdditionalPieceTablesParagraphs
  (APieceTable: TdxPieceTableList);
var
  I: Integer;
begin
...
begin
  if TdxDocumentModelChangeAction.ResetAllPrimaryLayout in DeferredChanges.ChangeActions
  then
    ResetParagraphs
  else if (TdxDocumentModelChangeAction.ResetPrimaryLayout
    in DeferredChanges.ChangeActions) or
    (TdxDocumentModelChangeAction.ResetSecondaryLayout
    in DeferredChanges.ChangeActions) then
  begin
    MainPieceTable.ResetParagraphs(DeferredChanges.ChangeStart.ParagraphIndex,
      DeferredChanges.ChangeEnd.ParagraphIndex);
    AAdditionalChangedPieceTables :=
      DeferredChanges.AdditionalChangedPieceTables;
...
procedure TdxDocumentModel.SetActivePieceTable(APieceTable
  : TdxCustomPieceTable);
begin
  SetActivePieceTable(TdxPieceTable(APieceTable), nil);
end;

procedure TdxDocumentModel.SetActivePieceTable(APieceTable: TdxPieceTable;
ASection: TdxSection);
const
  ChangeActions = [TdxDocumentModelChangeAction.ActivePieceTableChanged,
...
procedure TdxDocumentModel.SetActivePieceTableCore(APieceTable: TdxPieceTable;
ASection: TdxSection);
var
...
function TdxDocumentModel.GetDocumentCapabilities
  : TdxDocumentCapabilitiesOptions;
begin
  Result := TdxDocumentCapabilitiesOptions(inherited DocumentCapabilities);
end;

function TdxDocumentModel.GetFormattingMarkVisibilityOptions
  : TdxFormattingMarkVisibilityOptions;
begin
  Result := TdxFormattingMarkVisibilityOptions
    (inherited FormattingMarkVisibilityOptions);
end;
...
begin
  ...
  begin
    ...
    if (AParagraphIndex >= 0) and
      (AParagraphIndex < Selection.PieceTable.Paragraphs.Count) then
    begin
      AParagraph := Selection.PieceTable.Paragraphs[AParagraphIndex];
      Exit(IsSpecialEmptyParagraphAfterInnerTable(AParagraph,
        AParagraph.GetCell));
    end;
  end;
  Result := False;
...
begin
  if FDocumentProperties <> nil then
  begin
    FDocumentProperties.OnObtainAffectedRange.Add
      (OnDocumentPropertiesObtainAffectedRange);
    FDocumentProperties.OnPageBackgroundChanged :=
      OnDocumentPropertiesPageBackgroundChanged;
  end;
end;

procedure TdxDocumentModel.SubscribeEventsForExport(AModelForExport
  : TdxDocumentModel);
begin
  AModelForExport.CalculateDocumentVariable.Add
    (RaiseCalculateDocumentVariableForExport);
...
begin
  FMailMergeProperties.ViewMergedDataChanged.Add
    (OnMailMergeViewMergedDataChanged);
...
begin
  if FProtectionProperties <> nil then
    FProtectionProperties.OnObtainAffectedRange.Add
      (OnProtectionPropertiesObtainAffectedRange);
end;
...
procedure TdxDocumentModel.SwitchToSelectionCore(ANewSelection
  : TdxSimpleSelection);
begin
...
begin
  if FDocumentProperties <> nil then
  begin
    FDocumentProperties.OnObtainAffectedRange.Remove
      (OnDocumentPropertiesObtainAffectedRange);
...
begin
  FMailMergeProperties.ViewMergedDataChanged.Remove
    (OnMailMergeViewMergedDataChanged);
...
begin
  if ProtectionProperties <> nil then
    ProtectionProperties.OnObtainAffectedRange.Remove
      (OnProtectionPropertiesObtainAffectedRange);
end;
...
begin
  FMailMergeDataController.CurrentRowChanged.Remove
    (OnMailMergeCurrentRowChanged);
  FMailMergeDataController.DataSourceChanged.Remove
    (OnMailMergeDataSourceChanged);
end;

procedure TdxDocumentModel.UpdateFields(AUpdateType
  : TdxUpdateFieldOperationType; AOptions: TdxFieldUpdateOnLoadOptions = nil);
var
...
begin
  ...
  try
    ...
    if (ACalculatorService <> nil) and
      (AUpdateType = TdxUpdateFieldOperationType.Load) then
...
function TdxRangeEditableChecker.CanEditRange(AStart,
  AEnd: TdxDocumentLogPosition): Boolean;
begin
  if not DocumentModel.IsDocumentProtectionEnabled then
    Exit(True);
  Result := CheckPermissionsForDocument(FPieceTable.RangePermissions,
    AStart, AEnd);
end;

function TdxRangeEditableChecker.CheckPermissionsForDocument
  (APermissions: TdxRangePermissionCollection;
AStart, AEnd: TdxDocumentLogPosition): Boolean;
begin
  Result := CheckPermissionsCore(APermissions, AStart, AEnd,
    CheckInsidePermission);
end;

function TdxRangeEditableChecker.CheckPermissionsCore
  (APermissions: TdxRangePermissionCollection;
AStart, AEnd: TdxDocumentLogPosition;
const ACheck: TFunc<TdxRangePermission, TdxDocumentLogPosition,
  TdxDocumentLogPosition, Boolean>): Boolean;
...
function TdxRangeEditableChecker.CheckInsidePermission(ARangePermission
  : TdxRangePermission; AStart, AEnd: TdxDocumentLogPosition): Boolean;
begin
  Result := ARangePermission.Contains(AStart,
    Min(AEnd, FPieceTable.DocumentEndLogPosition)) and
    FPieceTable.IsPermissionGranted(ARangePermission);
end;

function TdxRangeEditableChecker.CheckIntersectsWithPermission(ARangePermission
  : TdxRangePermission; AStart, AEnd: TdxDocumentLogPosition): Boolean;
begin
  Result := ARangePermission.IntersectsWith(AStart, AEnd) and
    FPieceTable.IsPermissionGranted(ARangePermission);
end;

{ TdxNumberingListCalculatorCache }

constructor TdxNumberingListCalculatorCache.Create(ADocumentModel
  : TdxDocumentModel);
begin
  FCache := TObjectDictionary<TdxAbstractNumberingListIndex,
    TdxNumberingListCountersCalculator>.Create([doOwnsValues]);
  FDocumentModel := ADocumentModel;
...
function TdxNumberingListCalculatorCache.GetRangeListCounters
  (AParagraph: TdxParagraph): TIntegerDynArray;
var
  AIndex: TdxParagraphIndex;
...
begin
  ...
  begin
    ...
    if ACalculator.ShouldAdvanceListLevelCounters(ACurrentParagraph,
      DocumentModel.AbstractNumberingLists[AListIndex]) then
...
function TdxNumberingListCalculatorCache.GetCacheItem
  (AListIndex: TdxAbstractNumberingListIndex)
  : TdxNumberingListCountersCalculator;
var
...
constructor TdxPieceTable.Create(const ADocumentModel: TdxCustomDocumentModel;
const AContentType: TdxContentTypeBase);
begin
  ...
  FFootNoteRunInserter :=
    TdxPieceTableModifiers.CreateFootNoteRunInserter(Self);
...
procedure TdxPieceTable.CreateBookmark(APosition: TdxDocumentLogPosition;
ALength: Integer; const AName: string);
const
  ChangeActions = [TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetSecondaryLayout];
...
begin
  ...
  try
    ...
    ApplyChangesCore(ChangeActions, ARunInfo.NormalizedStart.RunIndex,
      ARunInfo.NormalizedEnd.RunIndex);
  finally
...
function TdxPieceTable.CreateBookmarkCore(APosition: TdxDocumentLogPosition;
ALength: Integer; const AName: string; AForceUpdateInterval: Boolean = False)
  : TdxBookmark;
var
...
procedure TdxPieceTable.CreateComment(APosition: TdxDocumentLogPosition;
ALength: Integer; const AName, AId, AAuthor, ATime, ADate, AIdParent: string;
AContent: TdxCommentContentType);
begin
  NotImplemented;
end;

function TdxPieceTable.CreateCommentCore(APosition: TdxDocumentLogPosition;
ALength: Integer; const AName, AId, AAuthor, ATime, ADate, AIdParent: string;
AContent: TdxCommentContentType): TdxComment;
begin
  Result := NotImplemented;
end;

procedure TdxPieceTable.CreateCustomMark(APosition: TdxDocumentLogPosition;
AUserData: TObject);
begin
  NotImplemented;
end;
...
function TdxPieceTable.CreateDeleteContentOperation
  : TdxCustomDeleteContentOperation;
begin
  Result := TdxDeleteContentOperation.Create(Self);
end;

procedure TdxPieceTable.DeleteBackContent(ALogPosition: TdxDocumentLogPosition;
ALength: Integer; ADocumentLastParagraphSelected: Boolean);
begin
...
begin
  ...
  try
    ...
    AChangeActions := [TdxDocumentModelChangeAction.Redraw,
      TdxDocumentModelChangeAction.ResetSecondaryLayout];
    ARunInfo := ABookmark.Interval;
    ApplyChangesCore(AChangeActions, ARunInfo.NormalizedStart.RunIndex,
      ARunInfo.NormalizedEnd.RunIndex);
  finally
    DocumentModel.EndUpdate;
  end;
...
procedure TdxPieceTable.DeleteContent(ALogPosition: TdxDocumentLogPosition;
ALength: Integer; ADocumentLastParagraphSelected, AAllowPartiallyDeletingField
  : Boolean);
begin
  DeleteContent(ALogPosition, ALength, ADocumentLastParagraphSelected,
    AAllowPartiallyDeletingField, False);
end;
...
procedure TdxPieceTable.DeleteEmptyTableCellCore(ATableIndex, ARowIndex,
  ACellIndex: Integer);
var
  ATransaction: TdxHistoryTransaction;
...
begin
  ATransaction := TdxHistoryTransaction.Create(DocumentModel.History);
  try
    AItem := TdxDeleteEmptyTableCellHistoryItem.Create(Self, ATableIndex,
      ARowIndex, ACellIndex);
    DocumentModel.History.Add(AItem);
    AItem.Execute;
  finally
    ATransaction.Free;
...
procedure TdxPieceTable.DeleteEmptyTableRowCore(ATableIndex,
  ARowIndex: Integer);
var
  ATransaction: TdxHistoryTransaction;
  ATable: TdxTable;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        AColumnIndex := TdxTableCellVerticalBorderCalculator.GetStartColumnIndex
          (ACell, False);
        if ARowIndex + 1 < ARowCount then
          ANextRowCell := TdxTableCellVerticalBorderCalculator.
            GetCellByStartColumnIndex(ARows[ARowIndex + 1], AColumnIndex, False)
        else
          ANextRowCell := nil;
        ...
        begin
          ...
          begin
            ...
            if ARowIndex + 2 < ARowCount then
              AAfterNextRowCell := TdxTableCellVerticalBorderCalculator.
                GetCellByStartColumnIndex(ARows[ARowIndex + 2],
                AColumnIndex, False)
            else
              AAfterNextRowCell := nil;
            if (AAfterNextRowCell <> nil) and
              (AAfterNextRowCell.VerticalMerging = TdxMergingState.Continue)
            then
        ...
        begin
          Assert(ARowIndex > 0);
          APrevRowCell := TdxTableCellVerticalBorderCalculator.
            GetCellByStartColumnIndex(ARows[ARowIndex - 1],
            AColumnIndex, False);
          if (APrevRowCell <> nil) and
            (APrevRowCell.VerticalMerging = TdxMergingState.Restart) then
          begin
            if (ANextRowCell = nil) or
              (ANextRowCell.VerticalMerging <> TdxMergingState.Continue) then
...
procedure TdxPieceTable.DeleteNumerationFromParagraphAndChangeParagraphStyle
  (AParagraph: TdxParagraph; AParagraphStyleIndex: Integer);
begin
  ...
  if AParagraph.GetOwnNumberingListIndex = NumberingListIndexNoNumberingList
  then
  begin
...
procedure TdxPieceTable.DeleteSelectedTables(ARunInfo: TdxRunInfo;
ADocumentLastParagraphSelected: Boolean);
var
  ARoot: TdxTableCellNode;
  AStartParagraphIndex, AEndParagraphIndex: TdxParagraphIndex;
begin
  if (ARunInfo.Start = ARunInfo.&End) and not ADocumentLastParagraphSelected
  then
    Exit;
  AStartParagraphIndex := ARunInfo.Start.ParagraphIndex;
  AEndParagraphIndex := ARunInfo.&End.ParagraphIndex;
  ARoot := TableCellsManager.GetCellSubTree(AStartParagraphIndex,
    AEndParagraphIndex, MinInt);
  try
...
procedure TdxPieceTable.DeleteTablesByNestedLevel(ACurrent: TdxTableCellNode;
ARunInfo: TdxRunInfo; ADocumentLastParagraphSelected: Boolean);
var
  I: Integer;
  ATable: TdxTable;
...
begin
  ...
  begin
    ...
    if ACurrentNode.ChildNodes <> nil then
      DeleteTablesByNestedLevel(ACurrentNode, ARunInfo,
        ADocumentLastParagraphSelected);
    ATable := ACurrentNode.Cell.Table;
    if ((ACurrentNode.Cell <> nil) and
      (ATable.FirstRow.FirstCell = ACurrentNode.Cell)) and
...
procedure TdxPieceTable.DeleteTableCellsWithShiftToTheUp(ASelectedCells
  : TdxSelectedTableStructureBase { TdxSelectedCellsCollection } );
var
  ACommand: TdxPieceTableDeleteTableCellsWithShiftToTheUpCommand;
begin
  ACommand := TdxPieceTableDeleteTableCellsWithShiftToTheUpCommand.Create(Self,
    TdxSelectedCellsCollection(ASelectedCells));
  try
    ACommand.Execute;
  finally
    ACommand.Free;
...
begin
  ACommand := TdxPieceTableDeleteTableCellWithContentCommand.Create(Self,
    ADeletedCell, AServer);
  try
    ACommand.CanNormalizeCellVerticalMerging :=
      ACanNormalizeCellVerticalMerging;
    ACommand.Execute;
  finally
    ACommand.Free;
  end;
...
procedure TdxPieceTable.DeleteTableCellWithNestedTables(ATableIndex, ARowIndex,
  ACellIndex: Integer);
var
  ACommand: TdxPieceTableDeleteTableCellWithNestedTablesCommand;
begin
  ACommand := TdxPieceTableDeleteTableCellWithNestedTablesCommand.Create(Self,
    ATableIndex, ARowIndex, ACellIndex);
  try
    ACommand.Execute;
  finally
    ACommand.Free;
...
procedure TdxPieceTable.DeleteTableColumns(ASelectedCells
  : TdxSelectedTableStructureBase { TdxSelectedCellsCollection };
const AServer: IdxInnerRichEditDocumentServerOwner);
var
...
begin
  ...
  ACommand := TdxPieceTableDeleteTableColumnsCommand.Create(Self,
    TdxSelectedCellsCollection(ASelectedCells), AServer);
  try
    ACommand.Execute;
  finally
    ACommand.Free;
...
begin
  ATransaction := TdxHistoryTransaction.Create(DocumentModel.History);
  try
    AItem := TdxDeleteTableFromTableCollectionHistoryItem.Create(Self,
      ADeletedTable);
    DocumentModel.History.Add(AItem);
    AItem.Execute;
  finally
...
begin
  ATransaction := TdxHistoryTransaction.Create(DocumentModel.History);
  try
    AStart := Paragraphs[ADeletedRow.Cells.First.StartParagraphIndex]
      .LogPosition;
...
begin
  ...
  try
    ...
    DeleteContent(AStartLogPosition, ALength, AStartLogPosition + ALength >=
      DocumentEndLogPosition);
  finally
    ATransaction.Free;
  end;
end;
...
function TdxPieceTable.ExtractMergedRanges(ARangePermissionInfoIndex: Integer)
  : TdxRangePermissionCollectionEx;
var
  I: Integer;
...
procedure TdxPieceTable.AddNumberingListToParagraph
  (AParagraph: TdxSimpleParagraph; ANumberingListIndex: TdxNumberingListIndex;
AListLevelIndex: Integer);
begin
  Assert(IsValidNumberingListIndex(ANumberingListIndex) and
    (ANumberingListIndex < DocumentModel.NumberingLists.Count));
  Assert(IsNumberingListLevelIndexValid(AParagraph, ANumberingListIndex,
    AListLevelIndex));
...
procedure TdxPieceTable.AddPieceTables(AResult: TdxFastList;
AIncludeUnreferenced: Boolean);
var
  I, ACount: Integer;
begin
  if (AIncludeUnreferenced or IsReferenced) and not(AResult.IndexOf(Self) >= 0)
  then
    AResult.Add(Self);
...
procedure TdxPieceTable.AppendImage(APos: TdxInputPosition;
AImage: TdxOfficeImageReference; AScaleX, AScaleY: Single;
AUseScreenDpi: Boolean = False);
begin
  AppendImage(APos, AImage, AScaleX, AScaleY, TdxAlphaColors.Empty,
    AUseScreenDpi);
end;
...
begin
  Assert(APos.PieceTable = Self);
  InsertInlineImageCore(APos.ParagraphIndex, APos.LogPosition, AImage, AScaleX,
    AScaleY, AFillColor, AUseScreenDpi, False);
...
procedure TdxPieceTable.AppendMergedRanges(AMergedRanges
  : TdxRangePermissionCollectionEx);
var
  I: Integer;
begin
...
procedure TdxPieceTable.ApplyCharacterFormatting(ALogPositionStart
  : TdxDocumentLogPosition; ALength: Integer;
AModifier: TdxRunPropertyModifierBase);
begin
  if ALogPositionStart < 0 then
...
procedure TdxPieceTable.ApplyCharacterStyle(ALogPositionStart
  : TdxDocumentLogPosition; ALength, AStyleIndex: Integer;
AResetProperties: Boolean);
var
...
procedure TdxPieceTable.ApplyCharacterStyleCore(ALogPositionStart
  : TdxDocumentLogPosition; ALength: Integer;
AModifier: TdxRunPropertyModifierBase);
var
  ATransaction: TdxHistoryTransaction;
...
begin
  ...
  try
    ...
    try
      if (ARunInfo.Start.RunIndex >= 0) and
        (ARunInfo.&End.RunIndex >= ARunInfo.Start.RunIndex) then
      begin
...
procedure TdxPieceTable.ApplyDocumentPermission(AStart,
  AEnd: TdxDocumentLogPosition; AInfo: TdxRangePermissionInfo);
var
...
begin
  ...
  try
    ...
    AItem.IndexToInsert := DocumentModel.Cache.RangePermissionInfoCache.
      GetItemIndex(AInfo);
    DocumentModel.History.Add(AItem);
    AItem.Execute;
  finally
...
function TdxPieceTable.ApplyDocumentPermissionCore(AStart,
  AEnd: TdxDocumentLogPosition; ARangePermissionInfoIndex: Integer): TdxRunInfo;
var
...
begin
  ...
  try
    ARangePermission := CreateRangePermission(AStart, AEnd,
      ARangePermissionInfoIndex);
...
procedure TdxPieceTable.ApplyListLevelIndexToParagraph(AParagraph: TdxParagraph;
ALevelIndex: Integer);
begin
  NotImplemented;
end;

procedure TdxPieceTable.ApplyNumberingToInsertedParagraph(AParagraphIndex
  : TdxParagraphIndex);
var
  APieceTable: TdxPieceTable;
...
begin
  ...
  begin
    ...
    AddParagraphToList(AParagraphIndex,
      AOriginalParagraph.GetOwnNumberingListIndex,
      AOriginalParagraph.GetOwnListLevelIndex);
    ...
    begin
      ...
      begin
        ANormalStyleIndex := APieceTable.DocumentModel.ParagraphStyles.
          DefaultItemIndex;
        DeleteNumerationFromParagraphAndChangeParagraphStyle(AOriginalParagraph,
          ANormalStyleIndex);
        DeleteNumerationFromParagraphAndChangeParagraphStyle(ANewParagraph,
          ANormalStyleIndex);
      end
      else
      begin
  ...
  else if AOriginalParagraph.GetOwnNumberingListIndex = NumberingListIndexNoNumberingList
  then
    AddParagraphToList(AParagraphIndex,
      AOriginalParagraph.GetOwnNumberingListIndex,
      AOriginalParagraph.GetOwnListLevelIndex);
...
procedure TdxPieceTable.ApplyParagraphFormatting(ALogPositionStart
  : TdxDocumentLogPosition; ALength: Integer;
AModifier: TdxParagraphPropertyModifierBase);
begin
  if ALogPositionStart < 0 then
...
procedure TdxPieceTable.ApplyParagraphFormattingCore(ALogPositionStart
  : TdxDocumentLogPosition; ALength: Integer;
AModifier: TdxParagraphPropertyModifierBase);
var
  I: Integer;
...
procedure TdxPieceTable.ApplyParagraphStyle(ALogPositionStart
  : TdxDocumentLogPosition; ALength, AStyleIndex: Integer);
var
  AModifier: TdxRunCharacterStyleModifier;
begin
...
procedure TdxPieceTable.ApplyParagraphStyleCore(ALogPositionStart
  : TdxDocumentLogPosition; ALength: Integer;
AModifier: TdxRunPropertyModifierBase);
var
  I: Integer;
...
procedure TdxPieceTable.ApplyTableStyleCore(ATables: TdxList<TdxTable>;
AStyleIndex: Integer);
var
  ATransaction: TdxHistoryTransaction;
  ATable: TdxTable;
...
function TdxPieceTable.CalculateFieldResult(AField: TdxField;
AMailMergeDataMode: TdxMailMergeDataMode;
AUpdateType: TdxUpdateFieldOperationType): TdxCalculateFieldResult;
var
  AFieldCalculatorService: IdxFieldCalculatorService;
begin
  AFieldCalculatorService :=
    DocumentModel.GetService<IdxFieldCalculatorService>;
  if AFieldCalculatorService <> nil then
    Result := AFieldCalculatorService.CalculateField(Self, AField,
      AMailMergeDataMode, AUpdateType)
  else
    Result := TdxCalculateFieldResult.Create(TdxCalculatedFieldValue.NullValue,
      [TdxUpdateFieldOperationType.Normal]);
end;
...
function TdxPieceTable.CanEditRangeLength(AStart: TdxDocumentLogPosition;
ALength: Integer): Boolean;
begin
  Result := CanEditRange(AStart, AStart + ALength);
end;

function TdxPieceTable.CanEditRange(AStart,
  AEnd: TdxDocumentLogPosition): Boolean;
begin
...
function TdxPieceTable.CanEditSelectionItems
  (AItems: TdxSelectionItemList): Boolean;
var
  I: Integer;
...
begin
  ...
  begin
    ...
    if not CanEditRange(ASelectionItem.NormalizedStart,
      ASelectionItem.NormalizedEnd) then
      Exit(False);
  end;
end;

procedure TdxPieceTable.ChangeCellEndParagraphIndex(ATableCell: TdxTableCell;
AIndex: TdxParagraphIndex);
var
  ATransaction: TdxHistoryTransaction;
...
begin
  ATransaction := TdxHistoryTransaction.Create(DocumentModel.History);
  try
    AItem := TdxChangeCellEndParagraphIndexHistoryItem.Create(Self,
      ATableCell, AIndex);
    DocumentModel.History.Add(AItem);
    AItem.Execute;
  finally
...
procedure TdxPieceTable.ChangeCellStartParagraphIndex(ATableCell: TdxTableCell;
AIndex: TdxParagraphIndex);
var
...
begin
  ATransaction := TdxHistoryTransaction.Create(DocumentModel.History);
  try
    AItem := TdxChangeCellStartParagraphIndexHistoryItem.Create(Self,
      ATableCell, AIndex);
    DocumentModel.History.Add(AItem);
    AItem.Execute;
  finally
...
procedure TdxPieceTable.ChangeParagraphStyle(AParagraph: TdxParagraph;
AModifier: TdxRunPropertyModifierBase);
var
  I: Integer;
begin
...
procedure TdxPieceTable.ConvertParagraphsIntoTableRow(ARow: TdxTableRow;
AIndex: TdxParagraphIndex; AParagraphCount: Integer);
var
  ATransaction: TdxHistoryTransaction;
...
begin
  ATransaction := TdxHistoryTransaction.Create(DocumentModel.History);
  try
    AItem := TdxConvertParagraphsIntoTableRowHistoryItem.Create(Self, ARow,
      AIndex, AParagraphCount);
    DocumentModel.History.Add(AItem);
    AItem.Execute;
  finally
    ATransaction.Free;
...
procedure TdxPieceTable.ConvertParagraphsToTable(AFirstParagraphIndex
  : TdxParagraphIndex; ARowCount, ACellCount: Integer);
var
  AItem: TdxCreateTableHistoryItem;
begin
  DocumentModel.BeginUpdate;
  try
    AItem := TdxCreateTableHistoryItem.Create(Self, AFirstParagraphIndex,
      ARowCount, ACellCount);
    DocumentModel.History.Add(AItem);
    AItem.Execute;
  finally
    DocumentModel.EndUpdate;
...
function TdxPieceTable.CreateNavigationVisibleTextFilter(AShowHiddenText
  : Boolean): TdxVisibleTextFilterBase;
begin
...
function TdxPieceTable.CreateRangePermission(AStart,
  AEnd: TdxDocumentLogPosition; ARangePermissionInfoIndex: Integer)
  : TdxRangePermission;
begin
...
function TdxPieceTable.CreateSpellCheckerManager
  : TdxRichEditSpellCheckerManager;
begin
  Result := TdxRichEditSpellCheckerManager
    (ContentType.CreateSpellCheckerManager(Self));
end;
...
function TdxPieceTable.CreateTableCellCore(ARow: TdxTableRow;
AStart, AEnd: TdxParagraphIndex): TdxTableCell;
begin
  Result := CreateTableCellCore(ARow, ARow.Cells.Count, AStart, AEnd);
end;

function TdxPieceTable.CreateTableCellCore(ARow: TdxTableRow;
AInsertedIndex: Integer; AStart, AEnd: TdxParagraphIndex): TdxTableCell;
var
  ACommand: TdxPieceTableCreateCellEmptyCommand;
begin
  ACommand := TdxPieceTableCreateCellEmptyCommand.Create(Self, ARow,
    AInsertedIndex, AStart, AEnd);
  try
    ACommand.Execute;
...
function TdxPieceTable.CreateTableRowCore(ATable: TdxTable; ARowIndex: Integer)
  : TdxTableRow;
var
  ACommand: TdxPieceTableCreateRowEmptyCommand;
begin
  ACommand := TdxPieceTableCreateRowEmptyCommand.Create(Self, ATable,
    ARowIndex);
  try
    ACommand.Execute;
...
function TdxPieceTable.FindParagraph(ALogPosition: TdxDocumentLogPosition)
  : TdxParagraph;
begin
...
procedure TdxPieceTable.FixLastParagraphOfLastSection(AOriginalParagraphCount
  : Integer);
begin
...
function TdxPieceTable.GetBookmarks(AIncludeHiddenBookmarks: Boolean)
  : TdxBookmarkList;
var
  I: Integer;
begin
...
begin
  case AInsertOptions of
    TdxInsertOptions.KeepSourceFormatting:
      Result := GetCopyManagerCore(ASourcePieceTable,
    ...
    TdxInsertOptions.MatchDestinationFormatting:
      Result := GetCopyManagerCore(ASourcePieceTable,
        TdxParagraphNumerationCopyOptions.CopyIfWholeSelected,
...
AFormattingCopyOptions: TdxFormattingCopyOptions)
  : TdxCustomDocumentModelCopyManager;
begin
  Result := TdxDocumentModelCopyManager.Create(ASourcePieceTable, Self,
    AParagraphNumerationCopyOptions, AFormattingCopyOptions);
end;
...
function TdxPieceTable.GetEntireBookmarks(AStart: TdxDocumentLogPosition;
ALength: Integer): TdxBookmarkBaseList;
begin
  Result := Bookmarks.GetEntireBookmarksCore(AStart, ALength);
end;

function TdxPieceTable.GetEntireComments(AStart: TdxDocumentLogPosition;
ALength: Integer): TdxCommentList;
begin
  Result := NotImplemented;
end;

function TdxPieceTable.GetEntireFieldsFromInterval(AStart, AEnd: TdxRunIndex)
  : TdxFieldList;
var
  I, ACount: Integer;
  AField: TdxField;
...
function TdxPieceTable.GetEntireRangePermissions(AStart: TdxDocumentLogPosition;
ALength: Integer): TdxBookmarkBaseList;
begin
  Result := RangePermissions.GetEntireBookmarksCore(AStart, ALength);
end;

function TdxPieceTable.GetFieldsInsideInterval(AFirstRunIndex,
  ALastRunIndex: TdxRunIndex): TdxFieldList;
begin
  Result := NotImplemented;
end;
...
begin
  ...
  try
    AScanner := TdxFieldScanner.Create(AIterator,
      DocumentModel.MaxFieldSwitchLength, DocumentModel.EnableFieldNames,
...
function TdxPieceTable.GetFilteredPlainText(const AStart,
...
begin
  ...
  begin
    if APredicate(AStart.RunIndex) then
      Result := AStartRun.GetPlainText(TextBuffer, AStart.RunOffset,
        AEnd.RunOffset - 1)
    else
      Result := '';
  end
  ...
  begin
    ...
    try
      if APredicate(AStart.RunIndex) then
        ABuilder.Append(AStartRun.GetPlainText(TextBuffer, AStart.RunOffset,
          AStartRun.Length - 1));
      ...
      if (AEnd.RunOffset > 0) and APredicate(AEnd.RunIndex) then
        ABuilder.Append(Runs[AEnd.RunIndex].GetPlainText(TextBuffer, 0,
          AEnd.RunOffset - 1));
...
type
  ...
  TdxFloatingObjectZOrderComparer = class(TcxIUnknownObject,
    IComparer<IdxZOrderedObject>)
  public
    function Compare(const AFirst: IdxZOrderedObject;
    const ASecond: IdxZOrderedObject): Integer;
  end;

  { TdxFloatingObjectZOrderComparer }

function TdxFloatingObjectZOrderComparer.Compare(const AFirst
  : IdxZOrderedObject; const ASecond: IdxZOrderedObject): Integer;
begin
...
procedure TdxPieceTable.SetPreCalculatedNumberingListTexts
  (const Value: TDictionary<TdxParagraph, string>);
begin
...
procedure TdxPieceTable.SetSpellCheckerManager(const Value
  : TdxRichEditSpellCheckerManager);
begin
...
function TdxPieceTable.GetLastInsertedFloatingObjectAnchorRunInfo
  : TdxLastInsertedFloatingObjectAnchorRunInfo;
begin
...
procedure TdxPieceTable.GetNumberingListText(AIndex: TdxRunIndex;
ASb: TStringBuilder);
var
...
function TdxPieceTable.GetPlainText(const AStartPos,
  AEndPos: TdxDocumentModelPosition): string;
var
  ARun: TdxTextRunBase;
  SB: TStringBuilder;
...
begin
  ...
  if AStartPos.RunIndex = AEndPos.RunIndex then
    Exit(ARun.GetPlainText(TextBuffer, AStartPos.RunOffset,
      AEndPos.RunOffset - 1));
  SB := TStringBuilder.Create;
  try
    if AStartPos.LogPosition = ARun.Paragraph.LogPosition then
      GetNumberingListText(AStartPos.RunIndex, SB);
    SB.Append(ARun.GetPlainText(TextBuffer, AStartPos.RunOffset,
      ARun.Length - 1));
...
function TdxPieceTable.GetPlainText2(const AStartPos,
  AEndPos: TdxDocumentModelPosition): string;
begin
  NotImplemented;
end;
...
function TdxPieceTable.GetPlainText2(const AStartPos,
  AEndPos: TdxFormatterPosition): string;
begin
  NotImplemented;
end;
...
begin
  ...
  try
    ...
    DeleteContent(AStartLogPosition, GetRunLogPosition(AField.Result.Start) -
      AStartLogPosition, False);
  finally
    DocumentModel.EndUpdate;
  end;
end;

function TdxPieceTable.GetRangeListCounters(AParagraph: TdxParagraph)
  : TIntegerDynArray;
begin
  Assert(AParagraph.IsInList);
...
procedure TdxPieceTable.InheritParagraphRunStyle(APos: TdxInputPosition;
AParagraphRun: TdxTextRunBase);
begin
...
procedure TdxPieceTable.InheritParagraphRunStyleCore(APos: TdxInputPosition;
AParagraphRun: TdxTextRunBase);
var
...
function TdxPieceTable.InsertFloatingObjectAnchorCore(AParagraphIndex
  : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition)
  : TdxFloatingObjectAnchorRun;
begin
  Result := InsertFloatingObjectAnchorCore(AParagraphIndex,
    ALogPosition, False);
end;

function TdxPieceTable.InsertFloatingObjectAnchorCore(AParagraphIndex
  : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition;
AForceVisible: Boolean): TdxFloatingObjectAnchorRun;
var
...
begin
  ...
  Result := TdxFloatingObjectAnchorRun
    (LastInsertedFloatingObjectAnchorRunInfo.Run);
end;

procedure TdxPieceTable.InsertFloatingObjectAnchor(ALogPosition
  : TdxDocumentLogPosition);
begin
...
procedure TdxPieceTable.InsertFloatingObjectAnchor(ALogPosition
  : TdxDocumentLogPosition; AForceVisible: Boolean);
var
  ARunInfo: TdxRunInfo;
...
begin
  ...
  if ContentType.IsTextBox then
    TdxRichEditExceptions.ThrowInternalException;
  ACommand := TdxPieceTableInsertFloatingObjectAnchorAtLogPositionCommand.Create
    (Self, ALogPosition, AForceVisible);
  try
    ACommand.Execute;
  finally
    ACommand.Free;
...
function TdxPieceTable.InsertFloatingObjectAnchorCore(APos: TdxInputPosition)
  : TdxFloatingObjectAnchorRun;
var
  ALastInsertedFloatingObjectAnchorRunInfo
    : TdxLastInsertedFloatingObjectAnchorRunInfo;
begin
  Assert(APos.PieceTable = Self);
  InsertFloatingObjectAnchorCore(APos.ParagraphIndex, APos.LogPosition, False);
  ALastInsertedFloatingObjectAnchorRunInfo :=
    LastInsertedFloatingObjectAnchorRunInfo;
  Result := TdxFloatingObjectAnchorRun
    (ALastInsertedFloatingObjectAnchorRunInfo.Run);
...
begin
  InsertFootNoteRunCore(AParagraphIndex, ALogPosition,
    TdxFootNoteNumberResultFormatting.Instance.Clone, ANoteIndex,
    FFootNoteRunInserter);
  Result := LastInsertedRunInfo.Run;
end;

function TdxPieceTable.InsertFootNoteRun(APos: TdxInputPosition;
ANoteIndex: Integer): TdxTextRunBase;
var
...
procedure TdxPieceTable.InsertLayoutDependentTextRun(AParagraphIndex
  : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition;
AFormatting: TdxFieldResultFormatting);
begin
  TextBuffer.Append('#');
  FLayoutDependentTextInserter.TextLength := 1;
  TdxLayoutDependentTextInserter(FLayoutDependentTextInserter)
    .FieldResultFormatting := AFormatting;
...
begin
  Assert(APos.PieceTable = Self);
  ARunIndex := InsertParagraphCore(APos.ParagraphIndex,
    APos.LogPosition, False);
  InheritParagraphRunStyle(APos, TdxParagraphRun(Runs[ARunIndex]));
end;

procedure TdxPieceTable.InsertFieldSymbolResult(ALogPosition
  : TdxDocumentLogPosition; const ASymbol: Char);
var
  ACommand: TdxPieceTableInsertFieldSymbolResultAtInputPositionCommand;
begin
  ACommand := TdxPieceTableInsertFieldSymbolResultAtInputPositionCommand.Create
    (Self, ALogPosition, ASymbol);
  try
    ACommand.Execute;
  finally
    FreeAndNil(ACommand);
...
procedure TdxPieceTable.InsertInsertFieldSymbolResultCore(AParagraphIndex
  : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition;
const ASymbol: Char; AForceVisible: Boolean);
var
...
procedure TdxPieceTable.InsertParagraphCoreNoInheritParagraphRunStyle
  (APos: TdxInputPosition);
begin
  Assert(APos.PieceTable = Self);
...
function TdxPieceTable.InsertParagraph(ALogPosition: TdxDocumentLogPosition;
AForceVisible: Boolean = False): TdxParagraph;
begin
  Result := TdxParagraph(inherited InsertParagraph(ALogPosition,
    AForceVisible));
end;

procedure TdxPieceTable.InsertParagraphs(ALogPosition: TdxDocumentLogPosition;
ACount: Integer; AForceVisible: Boolean);
var
  I: Integer;
begin
...
function TdxPieceTable.InsertSectionParagraphCore(AParagraphIndex
  : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition;
AForceVisible: Boolean): TdxRunIndex;
var
...
begin
  ...
  try
    Result := InsertObjectCore(AInserter, AParagraphIndex, ALogPosition,
      AForceVisible);
  finally
    AInserter.Free;
  end;
...
begin
  ACommand := TdxPieceTableInsertSeparatorAtLogPositionCommand.Create(Self,
    ALogPosition, AForceVisible);
  try
    ACommand.Execute;
  finally
...
begin
  Assert(APos.PieceTable = Self);
  ARunIndex := InsertSectionParagraphCore(APos.ParagraphIndex,
    APos.LogPosition, False);
  InheritParagraphRunStyle(APos, Runs[ARunIndex] as TdxParagraphRun);
end;

procedure TdxPieceTable.RemoveDocumentPermission(AStart,
  AEnd: TdxDocumentLogPosition; AInfo: TdxRangePermissionInfo);
var
...
function TdxPieceTable.RemoveDocumentPermissionCore(AStart,
  AEnd: TdxDocumentLogPosition; ARangePermissionInfoIndex: Integer): TdxRunInfo;
var
  AMergedRanges: TdxRangePermissionCollectionEx;
  ARangePermission: TdxRangePermission;
...
procedure TdxPieceTable.RemoveNumberingFromParagraph
  (AParagraph: TdxSimpleParagraph);
var
  ALeftIndent: Integer;
  ATransaction: TdxHistoryTransaction;
begin
  ...
  try
    ...
    try
      ...
      begin
        if AParagraph.GetOwnNumberingListIndex = NumberingListIndexListIndexNotSet
        then
        begin
          ALeftIndent := AParagraph.LeftIndent;
          AParagraph.ParagraphProperties.LeftIndent := ALeftIndent;
        end;
        AddNumberingListToParagraph(AParagraph,
          NumberingListIndexNoNumberingList, 0);
      end;
    finally
      FreeAndNil(ATransaction);
    end;
...
procedure TdxPieceTable.RemoveParagraphFromList(AParagraphIndex
  : TdxParagraphIndex);
var
  ATransaction: TdxHistoryTransaction;
...
begin
  ACommand := TdxPieceTableApplyAutoCorrectCommand.Create(Self, APosition,
    ALength, AText, ARule);
  try
    ACommand.Execute;
  finally
...
procedure TdxPieceTable.ReplaceTextWithMultilineText
  (APosition: TdxDocumentLogPosition; ALength: Integer; const AText: string);
begin
  DocumentModel.BeginUpdate;
  try
...
procedure TdxPieceTable.ReplaceTextWithPicture
  (APosition: TdxDocumentLogPosition; ALength: Integer;
...
procedure TdxPieceTable.ResetCharacterStyle(ARun: TdxTextRunBase;
ARunIndex: TdxRunIndex);
var
  AModifier: TdxRunCharacterStyleModifier;
begin
...
begin
  ...
  AFromPosition := TdxRichEditView.EnsurePositionVisibleWhenHiddenTextNotShown
    (DocumentModel, TdxDocumentModelPosition.FromParagraphStart(Self, AFrom));
...
begin
  ...
  try
    ...
    ATableUseValue := ATableUseValue and
      (not TdxTablePropertiesOptions.MaskUsePreferredWidth);
    ATableUseValue := ATableUseValue and
      (not TdxTablePropertiesOptions.MaskUseTableLook);
    ATable.TableProperties.ResetUse(ATableUseValue);
    AResetAllUse := procedure(ACell: TdxTableCell)
      var
        ACellUseValue: Integer;
      begin
        ACellUseValue := ACell.Properties.UseValue;
        ACellUseValue := ACellUseValue and
          (not TdxTableCellPropertiesOptions.MaskUsePreferredWidth);
    ...
    AStart := Paragraphs[ATable.FirstRow.FirstCell.StartParagraphIndex]
      .FirstRunIndex;
    AEnd := Paragraphs[ATable.LastRow.LastCell.EndParagraphIndex].LastRunIndex;
    ApplyChangesCore(TdxTableChangeActionCalculator.CalculateChangeActions
      (TdxTableChangeType.TableStyle), AStart, AEnd);
  finally
    DocumentModel.EndUpdate;
  end;
end;

procedure TdxPieceTable.SetBackColor(ALogPositionStart: TdxDocumentLogPosition;
ALength: Integer; ABackColor: TdxAlphaColor);
var
...
procedure TdxPieceTable.SetFont(ALogPositionStart: TdxDocumentLogPosition;
ALength: Integer; AFont: TFont);
var
...
procedure TdxPieceTable.SetForeColor(ALogPositionStart: TdxDocumentLogPosition;
ALength: Integer; AForeColor: TdxAlphaColor);
var
  AModifier: TdxRunPropertyModifier<TdxAlphaColor>;
begin
...
function TdxPieceTable.ShouldApplyStyleToParagraphs(ALogPositionStart
  : TdxDocumentLogPosition; ALength: Integer): Boolean;
var
  ARunInfo: TdxRunInfo;
  AStartRun, AEndRun: TdxTextRunBase;
  AIsStartRunIndexMatchStartOfParagraph,
    AIsEndPositionMatchEndOfParagraph: Boolean;
begin
  Result := False;
  ARunInfo := FindRunInfo(ALogPositionStart, ALength);
  try
    ...
    begin
      ...
      begin
        if AEndRun is TdxParagraphRun then
          Exit(True);
        AIsEndPositionMatchEndOfParagraph :=
          (ARunInfo.&End.RunEndLogPosition = ARunInfo.&End.LogPosition) and
...
var
  ...
  ATableStartRunIndex, ATableEndRunIndex, ARunStartIndex,
    ARunEndIndex: TdxRunIndex;
begin
  ...
  if (ARunStartIndex < ATableStartRunIndex) and
    ((ATableEndRunIndex < ARunEndIndex) or ADocumentLastParagraphSelected) then
    Exit(True);
  if (ARunStartIndex = ATableStartRunIndex) and
    ((ATableEndRunIndex < ARunEndIndex) or ADocumentLastParagraphSelected) then
    Exit(True);
  if (ARunStartIndex < ATableStartRunIndex) and
    (ATableEndRunIndex = ARunEndIndex) then
    Exit(True);
  Result := False;
end;

procedure TdxPieceTable.SplitTable(ATableIndex, ARowIndex: Integer;
AForceVisible: Boolean);
var
  ACommand: TdxPieceTableSplitTableCommand;
begin
  ACommand := TdxPieceTableSplitTableCommand.Create(Self, ATableIndex,
    ARowIndex, AForceVisible);
  try
    ACommand.Execute;
  finally
    ACommand.Free;
...
procedure TdxPieceTable.SplitTableCellsHorizontally(ACell: TdxTableCell;
APartsCount: Integer; AForceVisible: Boolean;
const AServer: IdxInnerRichEditDocumentServerOwner);
var
  ACommand: TdxPieceTableSplitTableCellsHorizontally;
begin
  ACommand := TdxPieceTableSplitTableCellsHorizontally.Create(Self, ACell,
    APartsCount, AForceVisible, AServer);
  try
    ACommand.Execute;
  finally
    ACommand.Free;
...
procedure TdxPieceTable.SplitTableCellsVertically(APatternCell: TdxTableCell;
APartsCount, AColumnsCount: Integer; AForceVisible: Boolean);
var
  ACommand: TdxPieceTableSplitTableCellsVertically;
begin
  ACommand := TdxPieceTableSplitTableCellsVertically.Create(Self, APatternCell,
    APartsCount, AColumnsCount, AForceVisible);
  try
    ACommand.Execute;
  finally
    ACommand.Free;
...
procedure TdxPieceTable.SplitTableCellsHorizontally(ACell: TdxTableCell;
APartsCount: Integer; const AServer: IdxInnerRichEditDocumentServerOwner);
begin
...
procedure TdxPieceTable.ProcessFieldsRecursive(AParent: TdxField;
const AValidateField: TdxValidateFieldFunction);
var
...
procedure TdxPieceTable.UpdateTableOfContents(AOperationType
  : TdxUpdateFieldOperationType);
begin
end;
...
begin
  ...
  if (ALeftIndent = 0) and (AFirstLineIndent = 0) and
    (AFirstLineIndentType = TdxParagraphFirstLineIndent.None) then
    Exit;
...
begin
  ...
  ALevel := DocumentModel.NumberingLists[AParagraph.GetNumberingListIndex]
    .Levels[AParagraph.GetListLevelIndex];
  if TdxNumberingListHelper.GetListType(ANumberingList) = TdxNumberingType.MultiLevel
  then
  begin
    if AParagraph.FirstLineIndentType = TdxParagraphFirstLineIndent.Hanging then
      AParagraph.LeftIndent := AParagraph.LeftIndent -
        AParagraph.FirstLineIndent
    else
      AParagraph.LeftIndent := AParagraph.LeftIndent -
        ALevel.ListLevelProperties.OriginalLeftIndent;
  end
  else
    AParagraph.LeftIndent := AParagraph.LeftIndent -
      ALevel.ListLevelProperties.OriginalLeftIndent;
...
function TdxPieceTable.ObtainMergedParagraphsProperties(ALogPositionStart
  : TdxDocumentLogPosition; ALength: Integer;
...
var
  ...
  ATypedModifier
    : TdxMergedParagraphPropertyModifier<TdxMergedParagraphProperties>;
begin
  ATypedModifier :=
    TdxMergedParagraphPropertyModifier<TdxMergedParagraphProperties>(AModifier);
  ARunInfo := FindRunInfo(ALogPositionStart, ALength);
  try
    AValue := ATypedModifier.GetParagraphPropertyValue
      (Paragraphs[ARunInfo.Start.ParagraphIndex]);
    for I := ARunInfo.Start.ParagraphIndex +
      1 to ARunInfo.&End.ParagraphIndex do
    begin
      AParagraphValue := ATypedModifier.GetParagraphPropertyValue
        (Paragraphs[I]);
      try
        AOldValue := AValue;
...
function TdxPieceTable.ObtainMergedParagraphsTabFormattingInfo(ALogPositionStart
  : TdxDocumentLogPosition; ALength: Integer;
AModifier: TdxParagraphPropertyModifierBase): TdxTabFormattingInfo;
var
  I: Integer;
...
function TdxPieceTable.GetLanguageInfo(const AStart,
  AEnd: TdxDocumentModelPosition): TdxNullableValue<TdxLangInfo>;
begin
  Exit(TdxNullableValue<TdxLangInfo>.Null);
end;

function TdxPieceTable.ShouldCheckWord(const AStart,
  AEnd: TdxDocumentModelPosition): Boolean;
var
  I: TdxRunIndex;
begin
...
function TdxPieceTable.InsertEndNoteRun(APos: TdxInputPosition;
ANoteIndex: Integer): TdxTextRunBase;
var
  ALastInsertedRunInfo: TdxLastInsertedRunInfo;
begin
...
procedure TdxPieceTable.InsertColumnToTheLeft(APatternCell: TdxTableCell;
AForceVisible: Boolean);
var
  ACommand: TdxPieceTableInsertColumnToTheLeft;
begin
  ACommand := TdxPieceTableInsertColumnToTheLeft.Create(Self, APatternCell,
    AForceVisible);
  try
    ACommand.Execute;
  finally
...
procedure TdxPieceTable.InsertColumnToTheRight(APatternCell: TdxTableCell;
AForceVisible: Boolean);
var
  ACommand: TdxPieceTableInsertColumnToTheRight;
begin
  ACommand := TdxPieceTableInsertColumnToTheRight.Create(Self, APatternCell,
    AForceVisible);
  try
    ACommand.Execute;
  finally
...
function TdxPieceTable.InsertCustomMark(ACustomMarkIndex: Integer;
ACustomMark: TdxCustomMark): TdxCustomMark;
begin
  Result := NotImplemented;
end;

procedure TdxPieceTable.InsertDocumentModelContent(ADocumentModel
  : TdxDocumentModel; APos: TdxDocumentLogPosition;
ASuppressParentFieldsUpdate, ASuppressFieldsUpdate, ACopyBetweenInternalModels
  : Boolean);
var
  ACommand: TdxPieceTableInsertContentConvertedToDocumentModelCommand;
begin
  ACommand := TdxPieceTableInsertContentConvertedToDocumentModelCommand.Create
    (Self, ADocumentModel, APos, False);
  try
...
begin
  InsertFootNoteRunCore(AParagraphIndex, ALogPosition,
    TdxEndNoteNumberResultFormatting.Instance.Clone, ANoteIndex,
    FEndNoteRunInserter);
  Result := LastInsertedRunInfo.Run;
end;

procedure TdxPieceTable.InsertFootNoteRunCore(AParagraphIndex
  : TdxParagraphIndex; ALogPosition: TdxDocumentLogPosition;
AFormatting: TdxFieldResultFormatting; ANoteIndex: Integer;
AInserter: TdxObjectInserter { TdxFootNoteRunInserterBase<T> } );
var
  ATypedInserter: TdxFootNoteRunInserterBase;
begin
  ATypedInserter := TdxFootNoteRunInserterBase(AInserter);
  Assert((AInserter.ClassName = 'TdxFootNoteRunInserter') or
    (AInserter.ClassName = 'TdxEndNoteRunInserter'));
  TextBuffer.Append('#');
...
function TdxPieceTable.IsNumberingListLevelIndexValid
  (AParagraph: TdxSimpleParagraph; ANumberingListIndex: TdxNumberingListIndex;
AListLevelIndex: Integer): Boolean;
var
...
begin
  ...
  begin
    ...
    if ANumberingListIndex < NumberingListIndexMinValue then
      AActualNumberingListIndex :=
        AParagraph.ParagraphStyle.GetNumberingListIndex;
    if AActualNumberingListIndex < NumberingListIndexMinValue then
      Result := ANumberingListIndex = NumberingListIndexNoNumberingList
    else
      Result := AListLevelIndex < DocumentModel.NumberingLists
        [AActualNumberingListIndex].Levels.Count;
  end;
end;

function TdxPieceTable.IsPermissionGranted(ARangePermission
  : TdxRangePermission): Boolean;
var
  AOptions: TdxAuthenticationOptions;
begin
  AOptions := DocumentModel.AuthenticationOptions;
  if ((AOptions.UserName <> '') and SameText(ARangePermission.UserName,
    AOptions.UserName)) or ((AOptions.EMail <> '') and
    SameText(ARangePermission.UserName, AOptions.EMail)) then
    Exit(True);
  if SameText(ARangePermission.Group, 'Everyone') or
    ((AOptions.Group <> '') and SameText(ARangePermission.Group, AOptions.Group))
  then
    Exit(True);
...
function TdxPieceTable.IsValidNumberingListIndex(ANumberingListIndex
  : TdxNumberingListIndex): Boolean;
begin
...
begin
  ...
  begin
    ACommand := TdxPieceTableJoinTablesCommand.Create(Self, ATopTable,
      ABottomTable);
    try
      ACommand.Execute;
    finally
...
procedure TdxPieceTable.MergeCells(ASelectedCellsCollectionInstance
  : TdxSelectedTableStructureBase { TdxSelectedCellsCollection } );
var
  ANormalizedStartCell: TdxTableCell;
  ASelectedCellsCollection: TdxSelectedCellsCollection absolute
    ASelectedCellsCollectionInstance;
begin
  TdxSelectedCellsCollection.AddReference(ASelectedCellsCollection);
  try
    MergeCellsHorizontally(ASelectedCellsCollection);
    ANormalizedStartCell := ASelectedCellsCollection.NormalizedFirst.
      NormalizedStartCell;
    MergeTableCellsVertically(ANormalizedStartCell,
      TdxSelectedCellsCollection(ASelectedCellsCollection).RowsCount);
  finally
    TdxSelectedCellsCollection.Release(ASelectedCellsCollection);
  end;
end;

procedure TdxPieceTable.MergeCellsHorizontally(ASelectedCellsInstance
  : TdxSelectedTableStructureBase { TdxSelectedCellsCollection } );
var
...
function TdxPieceTable.MergeCellsHorizontallyCore(AStartCell: TdxTableCell;
AMergedCellsColumnSpan: Integer): Integer;
var
...
begin
  AColumnIndex := TdxTableCellVerticalBorderCalculator.GetStartColumnIndex
    (AStartCell, False);
  ACells := TdxTableCellVerticalBorderCalculator.GetVerticalSpanCells
    (AStartCell, AColumnIndex, False);
  try
    ACellsCount := ACells.Count;
...
procedure TdxPieceTable.MergeTableCellsHorizontally(ACell: TdxTableCell;
ACount: Integer);
var
  ACommand: TdxPieceTableMergeTableCellsHorizontallyCommand;
begin
  ACommand := TdxPieceTableMergeTableCellsHorizontallyCommand.Create(Self,
    ACell, ACount);
  try
    ACommand.Execute;
  finally
...
procedure TdxPieceTable.MergeTableCellsVertically(ACell: TdxTableCell;
ACount: Integer);
var
  ACommand: TdxPieceTableMergeTableCellsVerticallyCommand;
begin
  ACommand := TdxPieceTableMergeTableCellsVerticallyCommand.Create(Self,
    ACell, ACount);
  try
    ACommand.Execute;
  finally
...
procedure TdxPieceTable.MovePositionToNext(var APos: TdxDocumentModelPosition;
AOffset: Integer);
var
  I: Integer;
begin
...
procedure TdxPieceTable.MoveTableRowToOtherTable(ATargetTable: TdxTable;
ARow: TdxTableRow);
var
  ATransaction: TdxHistoryTransaction;
...
begin
  ATransaction := TdxHistoryTransaction.Create(DocumentModel.History);
  try
    AItem := TdxMoveTableRowToOtherTableHistoryItem.Create(Self,
      ATargetTable, ARow);
    DocumentModel.History.Add(AItem);
    AItem.Execute;
  finally
...
function TdxPieceTable.ObtainRangePermissionsMatchSelection
  : TdxRangePermissionCollection;
var
...
procedure TdxPieceTable.ObtainRangePermissionsMatchSelectionItem
  (ATarget: TdxRangePermissionCollection; AItem: TdxSelectionItem);
var
  ACount, I: Integer;
...
begin
  ...
  begin
    ...
    if (APermission.Start = AItem.NormalizedStart) and
      (APermission.&End = AItem.NormalizedEnd) then
      ATarget.Add(APermission.Clone);
  end;
end;

function TdxPieceTable.ObtainRangePermissionsWithSelectionInside
  : TdxRangePermissionCollection;
var
  AItems: TdxSelectionItemList;
  ACount, I: Integer;
...
procedure TdxPieceTable.ObtainRangePermissionsWithSelectionItemInside
  (ATarget: TdxRangePermissionCollection; AItem: TdxSelectionItem);
var
  ACount, I: Integer;
  APermission: TdxRangePermission;
begin
  ...
  begin
    APermission := RangePermissions[I];
    if (AItem.NormalizedStart >= APermission.Start) and
      (AItem.NormalizedEnd <= APermission.&End) then
      ATarget.Add(APermission.Clone);
  end;
end;
...
begin
  TdxDocumentModelStructureChangedNotifier.NotifyFieldInserted
    (TableCellsManager, Self, AFieldIndex);
end;

procedure TdxPieceTable.DoFieldRemoved(AFieldIndex: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyFieldRemoved(TableCellsManager,
    Self, AFieldIndex);
end;

procedure TdxPieceTable.DoParagraphInserted(ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ACell: TdxCustomTableCell; AIsParagraphMerged: Boolean;
AActualParagraphIndex: TdxParagraphIndex; AHistoryNotificationId: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphInserted
    (TableCellsManager, Self, ASectionIndex, AParagraphIndex, ARunIndex, ACell,
    AIsParagraphMerged, AActualParagraphIndex, AHistoryNotificationId);
end;
...
AActualParagraphIndex: TdxParagraphIndex; AHistoryNotificationId: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphInserted(Bookmarks,
    Self, ASectionIndex, AParagraphIndex, ARunIndex, ACell, AIsParagraphMerged,
    AActualParagraphIndex, AHistoryNotificationId);
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphInserted
    (RangePermissions, Self, ASectionIndex, AParagraphIndex, ARunIndex, ACell,
    AIsParagraphMerged, AActualParagraphIndex, AHistoryNotificationId);
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphInserted
    (SpellCheckerManager, Self, ASectionIndex, AParagraphIndex, ARunIndex,
    ACell, AIsParagraphMerged, AActualParagraphIndex, AHistoryNotificationId);
end;

procedure TdxPieceTable.DoParagraphMerged(ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphMerged
    (TableCellsManager, Self, ASectionIndex, AParagraphIndex, ARunIndex,
    AHistoryNotificationId);
end;
...
AHistoryNotificationId: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphMerged(Bookmarks,
    Self, ASectionIndex, AParagraphIndex, ARunIndex, AHistoryNotificationId);
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphMerged
    (RangePermissions, Self, ASectionIndex, AParagraphIndex, ARunIndex,
    AHistoryNotificationId);
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphMerged
    (SpellCheckerManager, Self, ASectionIndex, AParagraphIndex, ARunIndex,
    AHistoryNotificationId);
...
procedure TdxPieceTable.DoParagraphRemoved(ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphRemoved
...
AHistoryNotificationId: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphRemoved(Bookmarks,
    Self, ASectionIndex, AParagraphIndex, ARunIndex, AHistoryNotificationId);
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphRemoved
    (RangePermissions, Self, ASectionIndex, AParagraphIndex, ARunIndex,
    AHistoryNotificationId);
...
procedure TdxPieceTable.DoRunInserted(AParagraphIndex: TdxParagraphIndex;
ANewRunIndex: TdxRunIndex; ALength, AHistoryNotificationId: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunInserted(TableCellsManager,
    Self, AParagraphIndex, ANewRunIndex, ALength, AHistoryNotificationId);
end;

procedure TdxPieceTable.RunInsertedCore(AParagraphIndex: TdxParagraphIndex;
ANewRunIndex: TdxRunIndex; ALength, AHistoryNotificationId: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunInserted(Bookmarks, Self,
    AParagraphIndex, ANewRunIndex, ALength, AHistoryNotificationId);
  TdxDocumentModelStructureChangedNotifier.NotifyRunInserted(RangePermissions,
    Self, AParagraphIndex, ANewRunIndex, ALength, AHistoryNotificationId);
  TdxDocumentModelStructureChangedNotifier.NotifyRunInserted
    (SpellCheckerManager, Self, AParagraphIndex, ANewRunIndex, ALength,
    AHistoryNotificationId);
end;

procedure TdxPieceTable.DoRunJoined(AParagraphIndex: TdxParagraphIndex;
AJoinedRunIndex: TdxRunIndex; ASplitOffset: Integer; ATailRunLength: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunJoined(TableCellsManager,
    Self, AParagraphIndex, AJoinedRunIndex, ASplitOffset, ATailRunLength);
end;

procedure TdxPieceTable.RunJoinedCore(AParagraphIndex: TdxParagraphIndex;
AJoinedRunIndex: TdxRunIndex; ASplitOffset, ATailRunLength: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunJoined(Bookmarks, Self,
    AParagraphIndex, AJoinedRunIndex, ASplitOffset, ATailRunLength);
  TdxDocumentModelStructureChangedNotifier.NotifyRunJoined(RangePermissions,
    Self, AParagraphIndex, AJoinedRunIndex, ASplitOffset, ATailRunLength);
  TdxDocumentModelStructureChangedNotifier.NotifyRunJoined(SpellCheckerManager,
    Self, AParagraphIndex, AJoinedRunIndex, ASplitOffset, ATailRunLength);
end;

procedure TdxPieceTable.DoRunMerged(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunMerged(TableCellsManager,
    Self, AParagraphIndex, ARunIndex, ADeltaRunLength);
end;

procedure TdxPieceTable.RunMergedCore(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunMerged(Bookmarks, Self,
    AParagraphIndex, ARunIndex, ADeltaRunLength);
  TdxDocumentModelStructureChangedNotifier.NotifyRunMerged(RangePermissions,
    Self, AParagraphIndex, ARunIndex, ADeltaRunLength);
  TdxDocumentModelStructureChangedNotifier.NotifyRunMerged(SpellCheckerManager,
    Self, AParagraphIndex, ARunIndex, ADeltaRunLength);
end;

procedure TdxPieceTable.DoRunRemoved(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ALength, AHistoryNotificationId: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunRemoved(TableCellsManager,
    Self, AParagraphIndex, ARunIndex, ALength, AHistoryNotificationId);
end;

procedure TdxPieceTable.RunRemovedCore(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ALength, AHistoryNotificationId: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunRemoved(Bookmarks, Self,
    AParagraphIndex, ARunIndex, ALength, AHistoryNotificationId);
  TdxDocumentModelStructureChangedNotifier.NotifyRunRemoved(RangePermissions,
    Self, AParagraphIndex, ARunIndex, ALength, AHistoryNotificationId);
  TdxDocumentModelStructureChangedNotifier.NotifyRunRemoved(SpellCheckerManager,
    Self, AParagraphIndex, ARunIndex, ALength, AHistoryNotificationId);
end;

procedure TdxPieceTable.DoRunSplit(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ASplitOffset: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunSplit(TableCellsManager,
    Self, AParagraphIndex, ARunIndex, ASplitOffset);
end;

procedure TdxPieceTable.RunSplitCore(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ASplitOffset: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunSplit(Bookmarks, Self,
    AParagraphIndex, ARunIndex, ASplitOffset);
  TdxDocumentModelStructureChangedNotifier.NotifyRunSplit(RangePermissions,
    Self, AParagraphIndex, ARunIndex, ASplitOffset);
  TdxDocumentModelStructureChangedNotifier.NotifyRunSplit(SpellCheckerManager,
    Self, AParagraphIndex, ARunIndex, ASplitOffset);
end;

procedure TdxPieceTable.DoRunUnmerged(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunUnmerged(TableCellsManager,
    Self, AParagraphIndex, ARunIndex, ADeltaRunLength);
end;

procedure TdxPieceTable.RunUnmergedCore(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunUnmerged(Bookmarks, Self,
    AParagraphIndex, ARunIndex, ADeltaRunLength);
  TdxDocumentModelStructureChangedNotifier.NotifyRunUnmerged(RangePermissions,
    Self, AParagraphIndex, ARunIndex, ADeltaRunLength);
  TdxDocumentModelStructureChangedNotifier.NotifyRunUnmerged
    (SpellCheckerManager, Self, AParagraphIndex, ARunIndex, ADeltaRunLength);
end;

procedure TdxPieceTable.PerformTextRunSplit(ARunIndices
...
procedure TdxPieceTable.PreprocessContentBeforeExport
  (AFormat: TdxRichEditDocumentFormat);
begin
end;

procedure TdxPieceTable.InsertTextCoreNoResetMergeNoApplyFormatting
  (APos: TdxInputPosition; const AText: string; AForceVisible: Boolean);
var
  ALastInsertedRunInfo: TdxLastInsertedRunInfo;
begin
  Assert(APos.PieceTable = Self);
  InsertTextCoreWithoutSplit(APos.ParagraphIndex, APos.LogPosition, AText,
    AForceVisible);
  ALastInsertedRunInfo := LastInsertedRunInfo;
...
function TdxPieceTable.InsertTable(ALogPosition: TdxDocumentLogPosition;
ARowCount, ACellCount: Integer): TdxTable;
begin
  Result := InsertTable(ALogPosition, ARowCount, ACellCount,
    TdxTableAutoFitBehaviorType.AutoFitToContents, MinInt, MinInt, False);
end;

function TdxPieceTable.InsertTable(ALogPosition: TdxDocumentLogPosition;
ARowCount, ACellCount, AFixedColumnWidths: Integer): TdxTable;
begin
  Result := InsertTable(ALogPosition, ARowCount, ACellCount,
    TdxTableAutoFitBehaviorType.FixedColumnWidth, AFixedColumnWidths,
    MinInt, False);
end;

function TdxPieceTable.InsertTable(ALogPosition: TdxDocumentLogPosition;
ARowCount, ACellCount: Integer; AAutoFitBehavior: TdxTableAutoFitBehaviorType;
AFixedColumnWidths: Integer): TdxTable;
begin
  Result := InsertTable(ALogPosition, ARowCount, ACellCount, AAutoFitBehavior,
    AFixedColumnWidths, MinInt, False);
end;
...
begin
  Result := InsertTable(ALogPosition, ARowCount, ACellCount, AAutoFitBehavior,
    AFixedColumnWidths, MinInt, AForceVisible, False);
end;

function TdxPieceTable.InsertTable(ALogPosition: TdxDocumentLogPosition;
ARowCount, ACellCount: Integer; AAutoFitBehavior: TdxTableAutoFitBehaviorType;
AFixedColumnWidths, AOuterColumnWidth: Integer; AForceVisible: Boolean;
AMatchHorizontalTableIndentsToTextEdge: Boolean): TdxTable;
var
...
begin
  ...
  try
    ...
    try
      ...
      ATable.InitializeColumnWidths(AAutoFitBehavior, AFixedColumnWidths,
        AOuterColumnWidth, AMatchHorizontalTableIndentsToTextEdge);
      ValidateTableIndent(ATable);
    finally
      ATransaction.Free;
    end;
    DocumentModel.InvalidateDocumentLayout;
    ATable.TableLook := [TdxTableLookType.ApplyFirstRow,
      TdxTableLookType.ApplyFirstColumn,
      TdxTableLookType.DoNotApplyColumnBanding];
    Result := ATable;
  finally
    DocumentModel.EndUpdate;
  end;
...
procedure TdxPieceTable.InsertTableCellToTheLeft(APatternCell: TdxTableCell;
AForceVisible: Boolean; const AServer: IdxInnerRichEditDocumentServerOwner);
var
  ACommand: TdxPieceTableInsertTableCellToTheLeft;
begin
  ACommand := TdxPieceTableInsertTableCellToTheLeft.Create(Self, APatternCell,
    AForceVisible, AServer);
  try
    ACommand.Execute;
  finally
    ACommand.Free;
...
procedure TdxPieceTable.InsertTableCellToTheRight(APatternCell: TdxTableCell;
AForceVisible: Boolean; const AServer: IdxInnerRichEditDocumentServerOwner);
var
  ACommand: TdxPieceTableInsertTableCellToTheRight;
begin
  ACommand := TdxPieceTableInsertTableCellToTheRight.Create(Self, APatternCell,
    AForceVisible, AServer);
  try
    ACommand.Execute;
  finally
...
procedure TdxPieceTable.InsertTableCellWithShiftToTheDown
  (APatternCell: TdxTableCell; AForceVisible: Boolean;
const AServer: IdxInnerRichEditDocumentServerOwner);
var
  ACommand: TdxPieceTableInsertTableCellWithShiftToTheDownCommand;
begin
  ACommand := TdxPieceTableInsertTableCellWithShiftToTheDownCommand.Create(Self,
    APatternCell, AForceVisible, AServer);
  try
    ACommand.Execute;
  finally
    ACommand.Free;
...
procedure TdxPieceTable.InsertTableRowAbove(APatternRow: TdxTableRow;
AForceVisible: Boolean);
var
  ACommand: TdxPieceTableInsertTableRowAboveCommand;
begin
  ACommand := TdxPieceTableInsertTableRowAboveCommand.Create(Self, APatternRow,
    AForceVisible);
  try
    ACommand.Execute;
  finally
...
procedure TdxPieceTable.InsertTableRowBelow(APatternRow: TdxTableRow;
AForceVisible: Boolean);
var
  ACommand: TdxPieceTableInsertTableRowBelowCommand;
begin
  ACommand := TdxPieceTableInsertTableRowBelowCommand.Create(Self, APatternRow,
    AForceVisible);
  try
    ACommand.Execute;
  finally
...
procedure TdxPieceTable.DeleteContent(ALogPosition: TdxDocumentLogPosition;
ALength: Integer; ADocumentLastParagraphSelected, AAllowPartiallyDeletingField,
  AForceRemoveInnerFields: Boolean);
begin
  DeleteContent(ALogPosition, ALength, ADocumentLastParagraphSelected,
    AAllowPartiallyDeletingField, AForceRemoveInnerFields, False);
end;

procedure TdxPieceTable.DeleteContent(ALogPosition: TdxDocumentLogPosition;
ALength: Integer; ADocumentLastParagraphSelected, AAllowPartiallyDeletingField,
  AForceRemoveInnerFields, ALeaveFieldIfResultIsRemoved: Boolean);
begin
  DeleteContent(ALogPosition, ALength, ADocumentLastParagraphSelected,
    AAllowPartiallyDeletingField, AForceRemoveInnerFields,
    ALeaveFieldIfResultIsRemoved, False);
end;

procedure TdxPieceTable.DeleteContent(ALogPosition: TdxDocumentLogPosition;
ALength: Integer; ADocumentLastParagraphSelected, AAllowPartiallyDeletingField,
  AForceRemoveInnerFields, ALeaveFieldIfResultIsRemoved, ABackspacePressed
  : Boolean);
var
  ACommand: TdxPieceTableDeleteTextCommand;
begin
  ACommand := TdxPieceTableDeleteTextCommand.Create(Self, ALogPosition,
    ALength);
  try
...
function TdxParagraph.Copy(ACopyManager: TdxCustomDocumentModelCopyManager)
  : TdxParagraph;
var
...
procedure TdxParagraph.CopyFrom(ADocumentModel: TdxDocumentModel;
AResultParagraph: TdxParagraph);
var
...
begin
  ...
  if IsInNonStyleList or
    (GetOwnNumberingListIndex = NumberingListIndexNoNumberingList) then
    CopyNumberingListProperties(AResultParagraph)
  else if (AResultParagraph.PieceTable.PreCalculatedNumberingListTexts <> nil)
    and (GetOwnNumberingListIndex = NumberingListIndexListIndexNotSet) and
    (ParagraphStyle.GetNumberingListIndex >= NumberingListIndexMinValue) then
    AResultParagraph.PieceTable.PreCalculatedNumberingListTexts.Add
      (AResultParagraph, GetNumberingListText);
...
procedure TdxParagraph.CopyNumberingListProperties(ATargetParagraph
  : TdxParagraph);
var
...
begin
  ...
  if not ANumbering.BulletedAllowed or not ANumbering.SimpleAllowed or
    not ANumbering.MultiLevelAllowed then
    Exit;
  ...
  begin
    ATargetParagraph.PieceTable.AddNumberingListToParagraph(ATargetParagraph,
      GetOwnNumberingListIndex, GetListLevelIndex);
    Exit;
  end;
  ATargetNumberingListIndex := DocumentModel.GetNumberingListIndex
    (ATargetParagraph.DocumentModel, GetOwnNumberingListIndex,
    NumberingListIndexMaxValue);
  ATargetParagraph.PieceTable.AddNumberingListToParagraph(ATargetParagraph,
    ATargetNumberingListIndex, GetListLevelIndex);
  if ATargetParagraph.PieceTable.PreCalculatedNumberingListTexts <> nil then
    ATargetParagraph.PieceTable.PreCalculatedNumberingListTexts.Add
      (ATargetParagraph, GetNumberingListText);
end;
...
function TdxParagraph.EqualsMergedCharacterCachedResult(ACachedResult
  : TdxParagraphMergedCharacterPropertiesCachedResult): Boolean;
begin
  Result := inherited EqualsMergedCharacterCachedResult(ACachedResult) and
    (ACachedResult.TableCell = GetCell);
end;

procedure TdxParagraph.DoUseMergedCharacterCachedResult(ACachedResult
...
procedure TdxParagraph.CreateNumberingList(ATarget: TdxDocumentModel;
ANumberingListId: Integer);
begin
  NotImplemented;
end;
...
function TdxParagraph.GetAbstractNumberingListIndex
  : TdxAbstractNumberingListIndex;
var
  AListIndex: TdxNumberingListIndex;
begin
  ...
  if AListIndex < NumberingListIndexMinValue then
    ...
    Result := DocumentModel.NumberingLists[AListIndex]
      .AbstractNumberingListIndex;
end;
...
begin
  if Index + 1 >= PieceTable.Paragraphs.Count then
    Result := SpacingAfter
  else if ContextualSpacing and
    (PieceTable.Paragraphs[Index + 1].ParagraphStyleIndex = ParagraphStyleIndex)
  then
    Result := 0
  else
    Result := SpacingAfter;
...
function TdxParagraph.GetMergedCharacterProperties
  : TdxMergedCharacterProperties;
begin
  Result := GetMergedCharacterProperties(False, nil);
end;

function TdxParagraph.GetMergedCharacterProperties(AUseSpecialTableStyle
  : Boolean; ATableStyle: TdxTableStyle): TdxMergedCharacterProperties;
var
  ACell: TdxTableCell;
...
function TdxParagraph.GetNumberingListText(const ACounters
  : TIntegerDynArray): string;
var
  ALevels: TdxListLevelCollection;
...
begin
  ...
  Result := Format(AFormatString, ACounters, ALevels, ALanguageId,
    ALevelProperties.ConvertPreviousLevelNumberingToDecimal);
  if AListLevel.BulletLevel then
    Result := System.Copy(Result, 1,
      TdxListLevel.BulletLevelDisplayFormatStringLength);
end;

function TdxParagraph.GetNumerationCharacterProperties
  : TdxMergedCharacterProperties;
var
  AListLevel: IdxListLevel;
  AProperties: TdxMergedCharacterProperties;
begin
  AListLevel := DocumentModel.NumberingLists[GetNumberingListIndex].Levels
    [GetListLevelIndex];
...
begin
  ...
  try
    ...
    Result := DocumentModel.FontCache.CalcFontIndex(AInfo.FontName,
      AInfo.DoubleFontSize, SmallFontStylesMap[AInfo.FontBold,
      AInfo.FontItalic], AInfo.Script);
  finally
...
class function TdxParagraph.Format(const AFormatString: string;
AArgs: TIntegerDynArray; const ALevels: TdxListLevelCollection;
ALanguageId: Word = TdxLanguageId.English;
ADisplayAllLevelsUsingArabicNumerals: Boolean = False): string;

  procedure ConvertToConstArray(const AStringArray: TArray<string>;
  var AConstArray: TArray<TVarRec>);
  var
    I: Integer;
  begin
...
begin
  ...
  begin
    ...
    if ADisplayAllLevelsUsingArabicNumerals and
      ((AFormat <> TdxNumberingFormat.Decimal) and
      (AFormat <> TdxNumberingFormat.DecimalZero)) then
      AFormat := TdxNumberingFormat.Decimal;
    AConverter := TdxOrdinalBasedNumberConverter.CreateConverter(AFormat,
      ALanguageId);
    try
...
function TdxParagraph.GetOwnListLevelParagraphProperties
...
function TdxParagraph.GetParentMergedParagraphProperties
  : TdxMergedParagraphProperties;
begin
  Result := GetParentMergedWithTableStyleParagraphProperties(False, nil);
end;

function TdxParagraph.GetParentMergedWithTableStyleParagraphProperties
  (AUseSpecialTableStyle: Boolean; ATableStyle: TdxTableStyle)
  : TdxMergedParagraphProperties;
var
...
begin
  ...
  begin
    ...
    Result := TdxMergedParagraphProperties.Create
      (AOwnListLevelParagraphProperties);
  ...
  begin
    ...
    if not AUseSpecialTableStyle then
      ...
      AMergedProperties := ACell.Table.GetMergedParagraphProperties
        (ATableStyle, ACell);
...
function TdxParagraph.TryUseParentMergedCachedResult(ACachedResult
  : TdxParagraphMergedParagraphPropertiesCachedResult;
ATableStyleIndex: Integer): Boolean;
begin
  Result := TryUseParentMergedCachedResultCore(ACachedResult,
    GetOwnListLevelParagraphPropertiesIndex, ATableStyleIndex);
end;

function TdxParagraph.TryUseParentMergedCachedResultCore(ACachedResult
  : TdxParagraphMergedParagraphPropertiesCachedResult;
AOwnListLevelParagraphPropertiesIndex, ATableStyleParagraphPropertiesIndex
  : Integer): Boolean;
var
...
begin
  AShouldUseExistingResult := (ACachedResult.ParagraphPropertiesIndex < 0) and
    (ACachedResult.ParagraphStyleIndex = ParagraphStyleIndex) and
    (ACachedResult.OwnListLevelParagraphPropertiesIndex =
    AOwnListLevelParagraphPropertiesIndex) and
    (ACachedResult.TableStyleParagraphPropertiesIndex =
    ATableStyleParagraphPropertiesIndex);
  ...
  ACachedResult.OwnListLevelParagraphPropertiesIndex :=
    AOwnListLevelParagraphPropertiesIndex;
  ACachedResult.TableStyleParagraphPropertiesIndex :=
    ATableStyleParagraphPropertiesIndex;
  Result := False;
end;
...
begin
  ...
  Result := ANumList.Levels[GetListLevelIndex].ListLevelProperties.Format <>
    TdxRichEditNumberingFormat.None;
end;
...
begin
  ...
  if (Result >= NumberingListIndexMinValue) or
    (Result = NumberingListIndexNoNumberingList) then
    Exit
  else
...
procedure TdxParagraph.SetNumberingListIndex(ANumberingListIndex
  : TdxNumberingListIndex);
begin
  OwnNumberingListIndex := ANumberingListIndex;
  ResetCachedIndices(TdxResetFormattingCacheType.All);
  if Parent <> nil then
    PieceTable.ApplyChangesCore(TdxParagraphFormattingChangeActionsCalculator.
      CalculateChangeActions(TdxParagraphFormattingChangeType.
      NumberingListIndex), FirstRunIndex, MaxInt);
end;
...
begin
  ...
  begin
    ...
    if AStyleNumbering >= NumberingListIndexMinValue then
      ANumberingType := TdxNumberingListHelper.GetListType
        (DocumentModel.NumberingLists[AStyleNumbering])
    else
      Exit(False);
  end
  else
    ANumberingType := TdxNumberingListHelper.GetListType
      (DocumentModel.NumberingLists[AListIndex]);
...
procedure TdxMainContentType.FixLastParagraphOfLastSection
  (AOriginalParagraphCount: Integer);
var
...
begin
  TdxDocumentModel(DocumentModel).ExtendedDocumentProperties.SetPages
    (APageCount);
end;

{ TdxHyperlinkInfoEventArgs }

constructor TdxHyperlinkInfoEventArgs.Create(APieceTable: TdxCustomPieceTable;
AFieldIndex: Integer);
begin
  inherited Create;
  FPieceTable := APieceTable;
...
class function TdxDocumentFormatsHelper.ShouldInsertNumbering
  (AModel: TdxDocumentModel): Boolean;
var
  AOptions: TdxNumberingOptions;
begin
  AOptions := AModel.DocumentCapabilities.Numbering;
  Result := AOptions.BulletedAllowed or AOptions.SimpleAllowed or
    ShouldInsertMultiLevelNumbering(AModel);
end;

class function TdxDocumentFormatsHelper.ShouldInsertMultiLevelNumbering
  (AModel: TdxDocumentModel): Boolean;
begin
  Result := AModel.DocumentCapabilities.Numbering.MultiLevelAllowed;
end;

class function TdxDocumentFormatsHelper.ShouldInsertBulletedNumbering
  (AModel: TdxDocumentModel): Boolean;
begin
  Result := AModel.DocumentCapabilities.Numbering.BulletedAllowed;
end;

class function TdxDocumentFormatsHelper.ShouldExportSectionColumns
  (AColumns: TdxSectionColumns; ADocumentModel: TdxDocumentModel): Boolean;
var
  ADefaultColumns: TdxColumnsInfo;
begin
  ADefaultColumns := ADocumentModel.Cache.ColumnsInfoCache.DefaultItem;
  Result := (AColumns.EqualWidthColumns <> ADefaultColumns.EqualWidthColumns) or
...
class function TdxDocumentFormatsHelper.ShouldInsertHyperlink
  (AModel: TdxDocumentModel): Boolean;
begin
  Result := AModel.DocumentCapabilities.HyperlinksAllowed;
end;

class function TdxDocumentFormatsHelper.ShouldInsertHyperlinks
  (AModel: TdxDocumentModel): Boolean;
begin
  Result := AModel.DocumentCapabilities.HyperlinksAllowed;
end;

class function TdxDocumentFormatsHelper.ShouldInsertPicture
  (AModel: TdxDocumentModel): Boolean;
begin
  Result := AModel.DocumentCapabilities.InlinePicturesAllowed;
end;

class function TdxDocumentFormatsHelper.ShouldInsertSimpleNumbering
  (AModel: TdxDocumentModel): Boolean;
begin
  Result := AModel.DocumentCapabilities.Numbering.SimpleAllowed;
end;

class function TdxDocumentFormatsHelper.NeedReplaceSimpleToBulletNumbering
  (AModel: TdxDocumentModel): Boolean;
begin
  Result := not ShouldInsertSimpleNumbering(AModel) and
    ShouldInsertBulletedNumbering(AModel);
end;

class function TdxDocumentFormatsHelper.NeedReplaceBulletedLevelsToDecimal
  (AModel: TdxDocumentModel): Boolean;
begin
  Result := not ShouldInsertBulletedNumbering(AModel) and
    ShouldInsertSimpleNumbering(AModel);
end;

{ TdxExtendedDocumentProperties }

class function TdxExtendedDocumentProperties.Create
  : TdxExtendedDocumentProperties;
begin
...
constructor TdxDocumentModelDeferredChanges.Create(ADocumentModel
  : TdxCustomDocumentModel);
begin
  inherited Create(ADocumentModel);
  FChangeStart := TdxDocumentModelPosition.FromParagraphEnd
    (ADocumentModel.MainPart,
    ADocumentModel.MainPart.Paragraphs.GetLastCore.Index);
  FChangeEnd := TdxDocumentModelPosition.FromParagraphStart
    (ADocumentModel.MainPart, 0);
...
procedure TdxDocumentModelDeferredChanges.ApplyChanges
  (APieceTable: TdxPieceTable; AActions: TdxDocumentModelChangeActions;
AStartRunIndex: TdxRunIndex; AEndRunIndex: TdxRunIndex);
begin
  if APieceTable.DocumentModel.SuppressPerformLayout then
    AActions := AActions - [TdxDocumentModelChangeAction.ResetAllPrimaryLayout,
      TdxDocumentModelChangeAction.ResetPrimaryLayout,
      TdxDocumentModelChangeAction.ResetSecondaryLayout];

  FChangeActions := FChangeActions + AActions;
  if (TdxDocumentModelChangeAction.SplitRunByCharset in AActions) and not IsSetContentMode
  then
  ...
  begin
    ...
    if (AStartRunIndex < ChangeStart.RunIndex) or
      ((AStartRunIndex = ChangeStart.RunIndex) and
      (ChangeStart.RunStartLogPosition <> ChangeStart.LogPosition)) then
...
procedure TdxDocumentModelDeferredChanges.AddAdditionalChangedPieceTable
  (AAdditionalChangedPieceTable: TdxPieceTable);
begin
...
function TdxDocumentModelDeferredChanges.ShouldUpdatePositions
  (const AActions: TdxDocumentModelChangeActions): Boolean;
begin
  Result := [TdxDocumentModelChangeAction.ResetAllPrimaryLayout,
    TdxDocumentModelChangeAction.ResetPrimaryLayout,
    TdxDocumentModelChangeAction.ResetSecondaryLayout] * AActions <> [];
end;

procedure TdxDocumentModelDeferredChanges.SetChangeParagraphStart
  (AParagraphIndex: TdxParagraphIndex);
begin
  TdxDocumentModelPosition.SetParagraphStart(FChangeStart, AParagraphIndex);
end;

procedure TdxDocumentModelDeferredChanges.SetChangeParagraphEnd(AParagraphIndex
  : TdxParagraphIndex);
begin
...
begin
  FOriginalSelectionUsePreviousBoxBounds :=
    DocumentModel.Selection.UsePreviousBoxBounds;
...
procedure TdxDocumentModelDeferredChanges.OnParagraphInserted
  (APieceTable: TdxCustomPieceTable; ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ACell: TdxCustomTableCell; AIsParagraphMerged: Boolean;
AActualParagraphIndex: TdxParagraphIndex; AHistoryNotificationId: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphInserted
    (GetRunIndicesForSplit(APieceTable), APieceTable, ASectionIndex,
    AParagraphIndex, ARunIndex, ACell, AIsParagraphMerged,
    AActualParagraphIndex, AHistoryNotificationId);
  if APieceTable.IsMain then
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphInserted
      (StartAnchor, APieceTable, ASectionIndex, AParagraphIndex, ARunIndex,
      ACell, AIsParagraphMerged, AActualParagraphIndex, AHistoryNotificationId);
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphInserted(EndAnchor,
      APieceTable, ASectionIndex, AParagraphIndex, ARunIndex, ACell,
      AIsParagraphMerged, AActualParagraphIndex, AHistoryNotificationId);
  end;
end;

procedure TdxDocumentModelDeferredChanges.OnParagraphRemoved
  (APieceTable: TdxCustomPieceTable; ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
  ...
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphRemoved(StartAnchor,
      APieceTable, ASectionIndex, AParagraphIndex, ARunIndex,
      AHistoryNotificationId);
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphRemoved(EndAnchor,
      APieceTable, ASectionIndex, AParagraphIndex, ARunIndex,
      AHistoryNotificationId);
  end;
end;

procedure TdxDocumentModelDeferredChanges.OnParagraphMerged
  (APieceTable: TdxCustomPieceTable; ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
  ...
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphMerged(StartAnchor,
      APieceTable, ASectionIndex, AParagraphIndex, ARunIndex,
      AHistoryNotificationId);
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphMerged(EndAnchor,
      APieceTable, ASectionIndex, AParagraphIndex, ARunIndex,
      AHistoryNotificationId);
  end;
end;

procedure TdxDocumentModelDeferredChanges.OnRunInserted
  (APieceTable: TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
ANewRunIndex: TdxRunIndex; ALength: Integer; AHistoryNotificationId: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunInserted
    (GetRunIndicesForSplit(APieceTable), APieceTable, AParagraphIndex,
    ANewRunIndex, ALength, AHistoryNotificationId);
  if APieceTable.IsMain then
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyRunInserted(StartAnchor,
      APieceTable, AParagraphIndex, ANewRunIndex, ALength,
      AHistoryNotificationId);
    TdxDocumentModelStructureChangedNotifier.NotifyRunInserted(EndAnchor,
      APieceTable, AParagraphIndex, ANewRunIndex, ALength,
      AHistoryNotificationId);
  end;
end;

procedure TdxDocumentModelDeferredChanges.OnRunRemoved
  (APieceTable: TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
...
begin
  ...
  if APieceTable.IsMain then
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyRunRemoved(StartAnchor,
      APieceTable, AParagraphIndex, ARunIndex, ALength, AHistoryNotificationId);
    TdxDocumentModelStructureChangedNotifier.NotifyRunRemoved(EndAnchor,
      APieceTable, AParagraphIndex, ARunIndex, ALength, AHistoryNotificationId);
  end;
end;

procedure TdxDocumentModelDeferredChanges.OnBeginMultipleRunSplit
  (APieceTable: TdxCustomPieceTable);
begin
end;

procedure TdxDocumentModelDeferredChanges.OnEndMultipleRunSplit
  (APieceTable: TdxCustomPieceTable);
begin
end;

procedure TdxDocumentModelDeferredChanges.OnRunSplit
  (APieceTable: TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ASplitOffset: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunSplit
  ...
  if APieceTable.IsMain then
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyRunSplit(StartAnchor,
      APieceTable, AParagraphIndex, ARunIndex, ASplitOffset);
    TdxDocumentModelStructureChangedNotifier.NotifyRunSplit(EndAnchor,
      APieceTable, AParagraphIndex, ARunIndex, ASplitOffset);
  end;
end;

procedure TdxDocumentModelDeferredChanges.OnRunJoined
  (APieceTable: TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
AJoinedRunIndex: TdxRunIndex; ASplitOffset: Integer; ATailRunLength: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunJoined
  ...
  if APieceTable.IsMain then
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyRunJoined(StartAnchor,
      APieceTable, AParagraphIndex, AJoinedRunIndex, ASplitOffset,
      ATailRunLength);
    TdxDocumentModelStructureChangedNotifier.NotifyRunJoined(EndAnchor,
      APieceTable, AParagraphIndex, AJoinedRunIndex, ASplitOffset,
      ATailRunLength);
  end;
end;

procedure TdxDocumentModelDeferredChanges.OnRunMerged
  (APieceTable: TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunMerged
  ...
  if APieceTable.IsMain then
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyRunMerged(StartAnchor,
      APieceTable, AParagraphIndex, ARunIndex, ADeltaRunLength);
    TdxDocumentModelStructureChangedNotifier.NotifyRunMerged(EndAnchor,
      APieceTable, AParagraphIndex, ARunIndex, ADeltaRunLength);
  end;
end;

procedure TdxDocumentModelDeferredChanges.OnRunUnmerged
  (APieceTable: TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
  TdxDocumentModelStructureChangedNotifier.NotifyRunUnmerged
  ...
  if APieceTable.IsMain then
  begin
    TdxDocumentModelStructureChangedNotifier.NotifyRunUnmerged(StartAnchor,
      APieceTable, AParagraphIndex, ARunIndex, ADeltaRunLength);
    TdxDocumentModelStructureChangedNotifier.NotifyRunUnmerged(EndAnchor,
      APieceTable, AParagraphIndex, ARunIndex, ADeltaRunLength);
  end;
end;

procedure TdxDocumentModelDeferredChanges.OnFieldRemoved
  (APieceTable: TdxCustomPieceTable; AFieldIndex: Integer);
begin
end;

procedure TdxDocumentModelDeferredChanges.OnFieldInserted
  (APieceTable: TdxCustomPieceTable; AFieldIndex: Integer);
begin
end;
...
begin
  Result := FSelectionChanged or (FOriginalSelectionUsePreviousBoxBounds <>
    DocumentModel.Selection.UsePreviousBoxBounds);
end;

{ TdxSelectionItems }

function TdxSelectionItems.GetRange(AIndex, ACount: Integer)
...
procedure TdxSelection.SetTableSelectionStructure
  (AValue: TdxSelectedTableStructureBase);
begin
...
function TdxSelection.InitialSelection(APieceTable: TdxCustomPieceTable)
  : TdxSelectionItem;
begin
...
begin
  ...
  try
    ...
    begin
      AItem := Items[I];
      if (AItem.NormalizedStart >= ARange.NormalizedStart) and
        (AItem.NormalizedEnd <= ARange.NormalizedEnd) then
      begin
        Delete(I);
        Continue;
      end;
      ...
      if (AItem.NormalizedStart < ARange.NormalizedStart) and
        (AItem.NormalizedEnd > ARange.NormalizedStart) then
      begin
        AItem.Start := AItem.NormalizedStart;
        AItem.&End := ARange.NormalizedStart;
        Continue;
...
begin
  ...
  begin
    ...
    if (AValue > ACurrentItem.NormalizedStart) and
      (AValue < ACurrentItem.NormalizedEnd) then
      FItems.Remove(ACurrentItem);
  end;
end;

procedure TdxSelection.TryAndMergeSelectionStart
  (AValue: TdxDocumentLogPosition);
var
  I: Integer;
  ACurrentItem: TdxSelectionItem;
begin
  ...
  begin
    ACurrentItem := Items[I];
    if (ActiveSelection.NormalizedStart <= ACurrentItem.NormalizedStart) and
      (ActiveSelection.NormalizedEnd >= ACurrentItem.NormalizedEnd) then
      FItems.Remove(ACurrentItem);
  end;
end;
...
begin
  ...
  begin
    AItem := FItems[I];
    if AItem.IsSelectionInTable and (AItem.Generation = SelectionGeneration)
    then
    begin
...
begin
  Result := (SelectedCells is TdxSelectedCellsCollection) and
    SelectedCells.IsNotEmpty;
end;

function TdxSelection.IsFloatingObjectSelected: Boolean;
begin
  Result := (Length = 1) and (PieceTable.Runs[Interval.NormalizedStart.RunIndex]
    is TdxFloatingObjectAnchorRun);
end;

function TdxSelection.IsInlinePictureSelected: Boolean;
begin
  Result := (Length = 1) and (PieceTable.Runs[Interval.NormalizedStart.RunIndex]
    is TdxInlinePictureRun);
end;
...
function TdxSelection.IsValidSelectedCells: Boolean;
  ...
  function ValidateSelection(AItem: TdxSelectionItem;
  ...
  begin
    ...
    begin
      ...
      if (PieceTable <> ARowPieceTable) or (AFirstCell = nil) or
        (ALastCell = nil) then
        Exit(False);
      AParagraphs := ARowPieceTable.Paragraphs;

      AStartLogPosition := AParagraphs[AFirstCell.StartParagraphIndex]
        .LogPosition;
      AEndLogPosition := AParagraphs[ALastCell.EndParagraphIndex]
        .EndLogPosition;

      if (AItem.Start >= AStartLogPosition) and
        (AItem.&End - 1 <= AEndLogPosition) then
        Exit(True);
    end;
  end;
...
begin
  if PieceTable <> APieceTable then
    Exit;
  OnParagraphInserted(ASectionIndex, AParagraphIndex, ARunIndex, ACell,
    AIsParagraphMerged, AActualParagraphIndex, AHistoryNotificationId);
end;
...
begin
  if PieceTable <> APieceTable then
    Exit;
  OnParagraphRemoved(ASectionIndex, AParagraphIndex, ARunIndex,
    AHistoryNotificationId);
end;
...
begin
  if PieceTable <> APieceTable then
    Exit;
  OnParagraphMerged(ASectionIndex, AParagraphIndex, ARunIndex,
    AHistoryNotificationId);
end;
...
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex; ALength: Integer;
AHistoryNotificationId: Integer);
begin
  if PieceTable <> APieceTable then
    Exit;
...
procedure TdxSelection.OnBeginMultipleRunSplit(APieceTable
  : TdxCustomPieceTable);
begin
  if PieceTable <> APieceTable then
    Exit;
...
procedure TdxSelection.OnRunSplit(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ASplitOffset: Integer);
begin
  if PieceTable <> APieceTable then
...
procedure TdxSelection.OnRunJoined(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; AJoinedRunIndex: TdxRunIndex;
ASplitOffset: Integer; ATailRunLength: Integer);
begin
  if PieceTable <> APieceTable then
...
procedure TdxSelection.OnRunMerged(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ADeltaRunLength: Integer);
begin
  if PieceTable <> APieceTable then
...
procedure TdxSelection.OnRunUnmerged(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ADeltaRunLength: Integer);
begin
  if PieceTable <> APieceTable then
...
procedure TdxSelection.OnFieldInserted(APieceTable: TdxCustomPieceTable;
AFieldIndex: Integer);
begin
  if PieceTable <> APieceTable then
    Exit;
...
procedure TdxSelection.OnFieldRemoved(APieceTable: TdxCustomPieceTable;
AFieldIndex: Integer);
begin
  if PieceTable <> APieceTable then
    Exit;
...
procedure TdxSelection.OnParagraphInserted(ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ACell: TdxCustomTableCell; AIsParagraphMerged: Boolean;
AActualParagraphIndex: TdxParagraphIndex; AHistoryNotificationId: Integer);
var
...
begin
  ...
  for AIndex := 0 to ASelectionsCount - 1 do
    Items[AIndex].ParagraphInserted(ASectionIndex, AParagraphIndex, ARunIndex,
      ACell, AIsParagraphMerged, AActualParagraphIndex, AHistoryNotificationId);
end;

procedure TdxSelection.OnParagraphRemoved(ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
var
  ASelectionsCount, AIndex: Integer;
begin
  ASelectionsCount := Items.Count;
  for AIndex := 0 to ASelectionsCount - 1 do
    Items[AIndex].ParagraphRemoved(ASectionIndex, AParagraphIndex, ARunIndex,
      AHistoryNotificationId);
end;

procedure TdxSelection.OnParagraphMerged(ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
var
  ASelectionsCount, AIndex: Integer;
begin
  ASelectionsCount := Items.Count;
  for AIndex := 0 to ASelectionsCount - 1 do
    Items[AIndex].ParagraphMerged(ASectionIndex, AParagraphIndex, ARunIndex,
      AHistoryNotificationId);
end;

procedure TdxSelection.OnRunInserted(AParagraphIndex: TdxParagraphIndex;
ANewRunIndex: TdxRunIndex; ALength: Integer; AHistoryNotificationId: Integer);
var
  ASelectionsCount, AIndex: Integer;
begin
  ASelectionsCount := Items.Count;
  for AIndex := 0 to ASelectionsCount - 1 do
    Items[AIndex].RunInserted(AParagraphIndex, ANewRunIndex, ALength,
      AHistoryNotificationId);
end;

procedure TdxSelection.OnRunRemoved(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ALength: Integer; AHistoryNotificationId: Integer);
var
  ASelectionsCount, AIndex: Integer;
begin
  ASelectionsCount := Items.Count;
  for AIndex := 0 to ASelectionsCount - 1 do
    Items[AIndex].RunRemoved(AParagraphIndex, ARunIndex, ALength,
      AHistoryNotificationId);
end;
...
procedure TdxSelection.OnRunSplit(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ASplitOffset: Integer);
var
  ASelectionsCount, AIndex: Integer;
begin
...
procedure TdxSelection.OnRunJoined(AParagraphIndex: TdxParagraphIndex;
AJoinedRunIndex: TdxRunIndex; ASplitOffset: Integer; ATailRunLength: Integer);
var
  ASelectionsCount, AIndex: Integer;
begin
  ASelectionsCount := Items.Count;
  for AIndex := 0 to ASelectionsCount - 1 do
    Items[AIndex].RunJoined(AParagraphIndex, AJoinedRunIndex, ASplitOffset,
      ATailRunLength);
end;

procedure TdxSelection.OnRunMerged(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
var
  ASelectionsCount, AIndex: Integer;
begin
...
procedure TdxSelection.OnRunUnmerged(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
var
  ASelectionsCount, AIndex: Integer;
begin
...
begin
  ...
  Result := ((ARuns[ARunIndex] is TdxInlinePictureRun) and
    (ARuns[APrevIndex] is TdxFieldCodeEndRun)) and
    (ARuns[ANextIndex] is TdxFieldResultEndRun);
end;
...
begin
  ASelectionCalculator := TdxTableStructureBySelectionCalculator.Create
    (PieceTable);
  SelectedCells := ASelectionCalculator.SetStartCell(ALogPosition);
end;

procedure TdxSelection.ManuallySetTableSelectionStructureAndChangeSelection
  (AStartCell: TdxTableCell; AEndCell: TdxTableCell);
begin
  ManuallySetTableSelectionStructureAndChangeSelection(AStartCell,
    AEndCell, False);
end;

procedure TdxSelection.ManuallySetTableSelectionStructureAndChangeSelection
  (AStartCell: TdxTableCell; AEndCell: TdxTableCell;
AIsColumnSelected: Boolean);
var
  ASelectionCalculator: TdxTableStructureBySelectionCalculator;
  ASelectedCells: TdxSelectedCellsCollection;
begin
  ASelectionCalculator := TdxTableStructureBySelectionCalculator.Create
    (PieceTable);
  ASelectedCells := ASelectionCalculator.Calculate(AStartCell, AEndCell,
    AIsColumnSelected);
  ASelectedCells.OriginalStartLogPosition :=
    SelectedCells.OriginalStartLogPosition;
  UpdateSelectionBy(ASelectedCells);
  SelectedCells := ASelectedCells;
end;

function TdxSelection.GetEndParagraphIndex(ALogPosition: TdxDocumentLogPosition)
  : TdxParagraphIndex;
begin
  Result := PieceTable.FindParagraphIndex(ALogPosition);
end;

procedure TdxSelection.UpdateTableSelectionStart(ALogPosition
  : TdxDocumentLogPosition);
var
  AStartCell, AEndCell, ACell, AMostParentForFirst, AMostParentForSecond
    : TdxTableCell;
...
begin
  ...
  if (FirstCellIsParentCellForSecondCellsTable(AEndCell, AStartCell)) or
    (AEndCell = nil) then
  begin
    if AEndCell <> nil then
      ...
      ANestedLevel := 0;
    ACell := PieceTable.TableCellsManager.GetCellByNestingLevel
      (AStartCell.StartParagraphIndex, ANestedLevel);
    Start := GetStartPositionInTableRow(ACell.Row);
    Exit;
  end;
  AMostParentForFirst := PieceTable.TableCellsManager.GetCellByNestingLevel
    (AStartCell.StartParagraphIndex, 0);
  AMostParentForSecond := PieceTable.TableCellsManager.GetCellByNestingLevel
    (AEndCell.StartParagraphIndex, 0);
  if AMostParentForFirst.Table <> AMostParentForSecond.Table then
    Start := GetStartPositionInTableRow(AMostParentForFirst.Row);
end;

function TdxSelection.GetStartPositionInTableRow(ARow: TdxTableRow)
  : TdxDocumentLogPosition;
var
  AParagraphs: TdxParagraphCollection;
begin
...
procedure TdxSelection.UpdateTableSelectionEnd(ALogPosition
  : TdxDocumentLogPosition; AConsiderCellStart: Boolean = False);
var
  ASelectionStart: TdxDocumentLogPosition;
...
begin
  ...
  AStartCell := SelectedCells.FirstSelectedCell;
  AEndCell := DetermineEndCellByLogPosition(ASelectionStart, ALogPosition,
    AConsiderCellStart);

  if ((AStartCell <> nil) and (AStartCell = AEndCell)) and
    not IsCellSelected(AStartCell, ASelectionStart, &End) then
  begin
    SelectedCells := TdxSelectedCellsCollection.Create
      (SelectedCells.FirstSelectedCell, SelectedCells.OriginalStartLogPosition);
    Start := ASelectionStart;
    ClearSelectionInTable;
    Exit;
  end;
  if (AEndCell = nil) or FirstCellIsParentCellForSecondCellsTable(AEndCell,
    AStartCell) then
  begin
    if SelectedCells is TdxSelectedCellsCollection then
  ...
  if not SelectedCells.IsNotEmpty or
    (FirstCellIsParentCellForSecondCellsTable(AStartCell, AEndCell)) then
  begin
    if SelectedCells is TdxSelectedCellsCollection then
      SelectedCells := TdxStartSelectedCellInTable.Create(SelectedCells);
    if not AParagraphBeforeTable then
    begin
      AStartCellNestedLevel := GetActualNestedLevelConsiderStartCell
        (AStartCell);
      &End := GetEndPositionInTableRow(ALogPosition, AEndCell,
        AStartCellNestedLevel);
    end;
    Exit;
  end;
  if ((AStartCell <> nil) and (AEndCell <> nil)) and
    (AStartCell.Table = AEndCell.Table) then
  begin
    ManuallySetTableSelectionStructureAndChangeSelection(AStartCell, AEndCell);
    Exit;
  end;
  if FirstAndSecondCellHaveCommonTableButSecondCellNotParentForFirstCell
    (AStartCell, AEndCell) then
  begin
    ...
    begin
      ...
      begin
        ManuallySetTableSelectionStructureAndChangeSelection
          (AParentCellForFirst, AParentCellForSecond);
        Exit;
      end;
  ...
  else if AStartCell.Table <> AEndCell.Table then
  begin
    if SelectedCells is TdxSelectedCellsCollection then
      SelectedCells := TdxStartSelectedCellInTable.Create(SelectedCells);
    if not AParagraphBeforeTable then
...
function TdxSelection.CalculateSelectionStart(ALogPosition
  : TdxDocumentLogPosition): TdxDocumentLogPosition;
var
  AActualStart, ACellStartPos, ACellEndPos, AOriginalStart
    : TdxDocumentLogPosition;
...
begin
  ...
  begin
    ACellStartPos := PieceTable.Paragraphs
      [AFirstSelectedCell.StartParagraphIndex].LogPosition;
    ACellEndPos := PieceTable.Paragraphs[AFirstSelectedCell.EndParagraphIndex]
      .EndLogPosition + 1;
...
function TdxSelection.DetermineStartSelectedCell(ASelectionStart
  : TdxDocumentLogPosition): TdxTableCell;
var
  AParagraphIndex: TdxParagraphIndex;
begin
...
function TdxSelection.IsCellSelectedFully(ATableCell: TdxTableCell;
ASelectionStart: TdxDocumentLogPosition;
ASelectionEnd: TdxDocumentLogPosition): Boolean;
var
  ANormalizeStart, ANormalizeEnd, ACellStartPos, ACellEndPos
    : TdxDocumentLogPosition;
begin
  ANormalizeStart := Min(ASelectionStart, ASelectionEnd);
  ANormalizeEnd := Max(ASelectionStart, ASelectionEnd);
  ACellStartPos := PieceTable.Paragraphs[ATableCell.StartParagraphIndex]
    .LogPosition;
  ACellEndPos := PieceTable.Paragraphs[ATableCell.EndParagraphIndex]
    .EndLogPosition + 1;
  Result := (ANormalizeStart <= ACellStartPos) and
    (ANormalizeEnd >= ACellEndPos);
end;

function TdxSelection.GetCellEndPosition(AStartCell: TdxTableCell)
  : TdxDocumentLogPosition;
var
...
begin
  if Start <= &End then
  begin
    ACellEndPos := PieceTable.Paragraphs[AStartCell.EndParagraphIndex]
      .EndLogPosition;
    Exit(Min(ACellEndPos, &End));
  end
  else
  begin
    ACellStartPos := PieceTable.Paragraphs[AStartCell.StartParagraphIndex]
      .LogPosition;
    Exit(Max(ACellStartPos, &End));
  end;
end;

function TdxSelection.DetermineEndCellByLogPosition(ASelectionStart
  : TdxDocumentLogPosition; ASelectionEnd: TdxDocumentLogPosition;
AConsiderCellStart: Boolean): TdxTableCell;
var
...
begin
  ...
  if (APrevSelectedCell = nil) or
    (IsRowsSelected(APrevSelectedCell, ANextSelectedCell)) then
    Exit(ANextSelectedCell);

  ANextSelectedCell := EnsureCellIsSelected(ASelectionStart, ASelectionEnd,
    ANextSelectedCell, APrevSelectedCell, AConsiderCellStart);
  if IsColumnsSelected(APrevSelectedCell, ANextSelectedCell) then
    Exit(ANextSelectedCell);

  APrevSelectedColumnIndex :=
    APrevSelectedCell.GetStartColumnIndexConsiderRowGrid;
  ANextSelectedColumnIndex :=
    ANextSelectedCell.GetStartColumnIndexConsiderRowGrid;
  ...
  Result := ANextSelectedCell.Table.GetCell(ANextSelectedCell.Row,
    AColumnIndex);
end;

function TdxSelection.DetermineEndCellCore(ASelectionStart
  : TdxDocumentLogPosition; ASelectionEnd: TdxDocumentLogPosition)
  : TdxTableCell;
var
  AParagraphIndex: TdxParagraphIndex;
...
begin
  ...
  if (ASelectionStart > ASelectionEnd) or
    (ASelectionEnd > AParagraph.LogPosition) then
    Exit(nil);
...
function TdxSelection.EnsureCellIsSelected(ASelectionStart
  : TdxDocumentLogPosition; ASelectionEnd: TdxDocumentLogPosition;
ANextSelectedCell: TdxTableCell; APrevSelectedCell: TdxTableCell;
AConsiderCellStart: Boolean): TdxTableCell;
var
  ANormalizeEnd, ACellStartPos: TdxDocumentLogPosition;
  ASelectedCellChanged, ACellShouldBeUnselected, ACellIsNotSelected,
    AIsLeftToRightDirection: Boolean;
  APreviousCell: TdxTableCell;
begin
  ANormalizeEnd := Max(ASelectionStart, ASelectionEnd);
  ACellStartPos := PieceTable.Paragraphs[ANextSelectedCell.StartParagraphIndex]
    .LogPosition;

  ASelectedCellChanged := ANextSelectedCell <> APrevSelectedCell;
  ACellShouldBeUnselected := not ASelectedCellChanged and
    not IsCellSelectedFully(ANextSelectedCell, ASelectionStart, ASelectionEnd);
  ...
  begin
    APreviousCell := GetPreviousTableCell(ANextSelectedCell,
      AIsLeftToRightDirection);
...
function TdxSelection.IsCellSelected(ACell: TdxTableCell;
ASelectionStart: TdxDocumentLogPosition;
ASelectionEnd: TdxDocumentLogPosition): Boolean;
var
...
begin
  ANormalizeStart := Min(ASelectionStart, ASelectionEnd);
  ANormalizeEnd := Max(ASelectionStart, ASelectionEnd);
  ACellEndPos := PieceTable.Paragraphs[ACell.EndParagraphIndex]
    .EndLogPosition + 1;
  Result := (ANormalizeStart < ACellEndPos) and (ANormalizeEnd >= ACellEndPos);
end;

function TdxSelection.GetPreviousTableCell(ACell: TdxTableCell;
AIsLeftToRightDirection: Boolean): TdxTableCell;
var
  AParagraphIndex: TdxParagraphIndex;
begin
...
function TdxSelection.IsColumnsSelected(APrevSelectedCell: TdxTableCell;
ANextSelectedCell: TdxTableCell): Boolean;
begin
...
function TdxSelection.IsRowsSelected(APrevSelectedCell: TdxTableCell;
ANextSelectedCell: TdxTableCell): Boolean;
var
...
begin
  ...
  ANextSelectedColumnIndex :=
    ANextSelectedCell.GetStartColumnIndexConsiderRowGrid;
  Result := (APrevSelectedCell <> ANextSelectedCell) and
    (APrevSelectedColumnIndex = ANextSelectedColumnIndex);
end;

function TdxSelection.GetActualNestedLevelConsiderStartCell
  (AStartCell: TdxTableCell): Integer;
begin
...
function TdxSelection.
  FirstAndSecondCellHaveCommonTableButSecondCellNotParentForFirstCell
  (AFirst: TdxTableCell; ASecond: TdxTableCell): Boolean;
var
...
procedure TdxSelection.NormalizeTableCellsToMinNestedLevel(var AStartCell,
  AEndCell: TdxTableCell);
var
...
begin
  ...
  if AStartCellNestedLevel < AEndCellNestedLevel then
    AEndCell := ATableCellManager.GetCellByNestingLevel
      (AEndCell.StartParagraphIndex, AStartCellNestedLevel)
  else
    AStartCell := ATableCellManager.GetCellByNestingLevel
      (AStartCell.StartParagraphIndex, AEndCellNestedLevel);
end;

function TdxSelection.FirstCellIsParentCellForSecondCellsTable
  (AFirstCell: TdxTableCell; ASecondCell: TdxTableCell): Boolean;
var
  AParentTable: TdxTable;
begin
  if (AFirstCell = nil) or (ASecondCell = nil) or
    (ASecondCell.Table.ParentCell = nil) then
    Exit(False);
...
function TdxSelection.GetEndPositionInTableRow(AInitialEnd
  : TdxDocumentLogPosition; ACell: TdxTableCell; ANestedLevel: Integer)
  : TdxDocumentLogPosition;
var
  ARow: TdxTableRow;
  AFirstCell, ALastCell: TdxTableCell;
...
function TdxSelection.GetLastNonCoveredByVerticalMergingCell(ARow: TdxTableRow)
  : TdxTableCell;
var
...
begin
  ...
  while (ACellIndex >= 0) and
    (Result.VerticalMerging = TdxMergingState.Continue) do
  begin
...
function TdxSelection.GetFirstNonCoveredByVerticalMergingCell(ARow: TdxTableRow)
  : TdxTableCell;
var
  ARowCellsCount, ACellIndex: Integer;
begin
  ...
  ACellIndex := 0;
  while (ACellIndex < ARowCellsCount) and
    (Result.VerticalMerging = TdxMergingState.Continue) do
  begin
    Result := ARow.Cells[ACellIndex];
    Inc(ACellIndex);
...
procedure TdxSelection.UpdateSelectionBy(ASelectedCells
  : TdxSelectedTableStructureBase { TdxSelectedCellsCollection } );
var
  AIsLeftToRightDirection: Boolean;
...
begin
  ...
  begin
    ...
    UpdateInTableSelectionItem(ActiveSelection, ACells[I],
      AIsLeftToRightDirection);
  end;
  RemoveIntersectedSelectionItems(ASelectedRowsCount);
end;

function TdxSelection.IsLeftToRightDirection(ASelectedCells
  : TdxSelectedTableStructureBase { TdxSelectedCellsCollection } ): Boolean;
var
...
procedure TdxSelection.UpdateInTableSelectionItem(AItem: TdxSelectionItem;
ACurrentCellsInterval: TdxSelectedCellsIntervalInRow;
AIsLeftToRightDirection: Boolean);
var
...
procedure TdxSelection.RemoveIntersectedSelectionItems(ALastInsertedItemsCount
  : Integer);
var
  AGenerationsToRemove: TdxIntegerList;
  I, ALastAddedItemsCount, APreviouslyAddedCount, ALastGensIndex,
    ALastAddedItemIndex: Integer;
  ALastAddedItems, APreviouslyAdded: TdxSelectionItemList;
  AItem, ACurrentItem: TdxSelectionItem;
  AItemNormalizedEnd, ACurrentItemNormalizedStart, AItemNormalizedStart,
    ACurrentItemNormalizedEnd: TdxDocumentLogPosition;
  AIsItemNormEndInCurrentInterval, AIsItemNormStartInCurrentInterval,
    AIsCurrentIntervalBelongsItem: Boolean;
begin
  ...
  try
    ALastAddedItems := Items.GetRange(Items.Count - ALastInsertedItemsCount,
      ALastInsertedItemsCount);
    try
      ALastAddedItemsCount := ALastAddedItems.Count;
      APreviouslyAdded := Items.GetRange(0,
        Items.Count - ALastInsertedItemsCount);
      try
        ...
        begin
          ...
          begin
            ...
            if (AGenerationsToRemove.Count > 0) and
              (AGenerationsToRemove[ALastGensIndex] = ACurrentItem.Generation)
            then
              Continue;
            ...
            AIsItemNormEndInCurrentInterval :=
              (AItemNormalizedEnd > ACurrentItemNormalizedStart) and
              (AItemNormalizedEnd < ACurrentItemNormalizedEnd);
            AIsItemNormStartInCurrentInterval :=
              (AItemNormalizedStart > ACurrentItemNormalizedStart) and
              (AItemNormalizedStart < ACurrentItemNormalizedEnd);
            AIsCurrentIntervalBelongsItem :=
              (AItemNormalizedStart <= ACurrentItemNormalizedStart) and
              (AItemNormalizedEnd >= ACurrentItemNormalizedEnd);
            if AIsItemNormEndInCurrentInterval or
              AIsItemNormStartInCurrentInterval or AIsCurrentIntervalBelongsItem
            then
            begin
...
function TdxSelectionItem.CalculateEndPosition(AAllowSelectionExpanding
  : Boolean): TdxDocumentModelPosition;
var
...
begin
  ...
  begin
    ...
    begin
      ...
      try
        if not AIterator.IsInsideWord(Interval.&End) or
          AIterator.IsNewElement(Interval.&End) then
          Result := Interval.&End
        else
...
function TdxSelectionItem.CalculateStartPosition(AAllowSelectionExpanding
  : Boolean): TdxDocumentModelPosition;
var
...
begin
  ...
  begin
    ...
    begin
      AIterator := TdxWordsDocumentModelIterator.Create(PieceTable);
      try
        if not AIterator.IsInsideWord(AStart) or AIterator.IsNewElement(AStart)
        then
          Result := AStart
        else
...
function TdxEmptySelection.InitialSelection(APieceTable: TdxCustomPieceTable)
  : TdxSelectionItem;
begin
...
procedure TdxEmptySelectionItem.ParagraphInserted(ASectionIndex
  : TdxSectionIndex; AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ACell: TdxCustomTableCell; AIsParagraphMerged: Boolean;
AActualParagraphIndex: TdxParagraphIndex; AHistoryNotificationId: Integer);
begin
end;

procedure TdxEmptySelectionItem.ParagraphMerged(ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
end;

procedure TdxEmptySelectionItem.ParagraphRemoved(ASectionIndex: TdxSectionIndex;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
end;

procedure TdxEmptySelectionItem.RunInserted(AParagraphIndex: TdxParagraphIndex;
ANewRunIndex: TdxRunIndex; ALength, AHistoryNotificationId: Integer);
begin
end;

procedure TdxEmptySelectionItem.RunJoined(AParagraphIndex: TdxParagraphIndex;
AJoinedRunIndex: TdxRunIndex; ASplitOffset, ATailRunLength: Integer);
begin
end;

procedure TdxEmptySelectionItem.RunMerged(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
end;

procedure TdxEmptySelectionItem.RunRemoved(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ALength, AHistoryNotificationId: Integer);
begin
end;

procedure TdxEmptySelectionItem.RunSplit(AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ASplitOffset: Integer);
begin
end;
...
procedure TdxChangeableDocumentInterval.SetEnd(const Value
  : TdxDocumentLogPosition);
begin
  SetEndCore(Value);
end;

procedure TdxChangeableDocumentInterval.SetStart(const Value
  : TdxDocumentLogPosition);
begin
  SetStartCore(Value);
end;
...
const
  DocumentModelChangeActionsMap: array [TdxDocumentModelChangeType]
    of TdxDocumentModelChangeActions = ([],
    [TdxDocumentModelChangeAction.ResetPrimaryLayout,
    TdxDocumentModelChangeAction.ResetSecondaryLayout,
    TdxDocumentModelChangeAction.ResetSelectionLayout,
    TdxDocumentModelChangeAction.Redraw,
...
constructor TdxMeasurementAndDrawingStrategy.Create(ADocumentModel
  : TdxDocumentModel);
begin
  inherited Create;
...
constructor TdxFieldEventArgs.Create(APieceTable: TdxCustomPieceTable;
AFieldIndex: Integer);
begin
  inherited Create;
  FPieceTable := APieceTable;
...
constructor TdxDocumentModelCopyOptions.Create(ASelectionRanges
  : TdxSelectionRangeCollection);
begin
  inherited Create;
  FParagraphNumerationCopyOptions :=
    TdxParagraphNumerationCopyOptions.CopyAlways;
...
constructor TdxDocumentModelCopyOptions.Create(AFrom: TdxDocumentLogPosition;
ALength: Integer);
var
...
procedure TdxDocumentModelCopyOptions.SetFrom(const Value
  : TdxDocumentLogPosition);
begin
...
constructor TdxCalculateDocumentVariableEventRouter.Create
  (ATargetModel: TdxDocumentModel);
begin
  FTargetModel := ATargetModel;
end;

procedure TdxCalculateDocumentVariableEventRouter.OnCalculateDocumentVariable
  (Sender: TObject; E: TdxCalculateDocumentVariableEventArgs);
var
  AServer: TdxInternalRichEditDocumentServer;
  AModel: TdxDocumentModel;
begin
  E.Value := FTargetModel.Variables.GetVariableValue(E.VariableName,
    E.Arguments);
  AServer := TdxInternalRichEditDocumentServer.
    TryConvertInternalRichEditDocumentServer(E.Value);
  AModel := Safe<TdxDocumentModel>.Cast(Sender);
  if (AServer <> nil) and (AModel <> nil) then
    AModel.MailMergeOptions.KeepLastParagraph :=
      AServer.DocumentModel.MailMergeOptions.KeepLastParagraph;
  E.Handled := True;
end;

{ TdxSelectedCellsIntervalInRow }

constructor TdxSelectedCellsIntervalInRow.Create(ARow: TdxTableRow;
AStartCellIndex: Integer; AEndCellIndex: Integer);
begin
  inherited Create;
  FRow := ARow;
...
function TdxSelectedCellsIntervalInRow.ContainsCell
  (ACell: TdxTableCell): Boolean;
var
  AEnd, I: Integer;
  ACells: TdxTableCellCollection;
...
class function TdxFieldsOperation.IsEntireFieldAffected(ARunInfo: TdxRunInfo;
AField: TdxField): Boolean;
begin
...
class function TdxFieldsOperation.IsFieldCodeTextAffectedOnly
  (ARunInfo: TdxRunInfo; AField: TdxField): Boolean;
begin
  Result := (ARunInfo.NormalizedStart.RunIndex > AField.Code.Start) and
    (ARunInfo.NormalizedEnd.RunIndex < AField.Code.&End);
end;

class function TdxFieldsOperation.IsFieldResultTextAffectedOnly
  (ARunInfo: TdxRunInfo; AField: TdxField): Boolean;
begin
...
class function TdxFieldsOperation.IsEntireFieldResultAffected
  (ARunInfo: TdxRunInfo; AField: TdxField): Boolean;
var
  AStart, AEnd: TdxRunIndex;
begin
  ...
  if AStart > AEnd then
    Exit(False);
  Result := (ARunInfo.NormalizedStart.RunIndex = AStart) and
    (ARunInfo.NormalizedEnd.RunIndex = AEnd);
end;

class procedure TdxFieldsOperation.EnsureIntervalContainsField
  (AInterval: TdxRunInfo; AField: TdxField);
var
  ANewStart, ANewEnd: TdxDocumentModelPosition;
begin
  ANewStart := TdxDocumentModelPosition.FromRunStart(AInterval.Start.PieceTable,
    AField.FirstRunIndex);
  if ANewStart.LogPosition < AInterval.Start.LogPosition then
    AInterval.Start.CopyFrom(ANewStart);
  ANewEnd := TdxDocumentModelPosition.FromRunStart(AInterval.&End.PieceTable,
    AField.LastRunIndex);
...
constructor TdxCopyFieldsOperation.Create(ASourcePieceTable, ATargetPieceTable
  : TdxPieceTable);
begin
  inherited Create;
...
function TdxCopyFieldsOperation.CalculateCopingFields(AOriginFields
  : TdxFieldList; ARunOffset: Integer): TdxFieldList;
var
  I, ACount: Integer;
  ANewField: TdxField;
begin
...
begin
  FreeAndNil(FUpdateFieldsParameters);
  ASourceFields := SourcePieceTable.GetEntireFieldsFromInterval
    (ARunInfo.Start.RunIndex, ARunInfo.&End.RunIndex);
  try
    ...
    begin
      ...
      if SourcePieceTable.HyperlinkInfos.TryGetHyperlinkInfo(ASourceFields[I].
        Index, AHyperlinkInfo) then
      begin
        if AHyperlinksAllowed then
          TargetPieceTable.InsertHyperlinkInfo(AIndexToInsert,
            AHyperlinkInfo.Clone)
        else
          AFieldsToDelete.Add(AFields[I]);
      end;
      Inc(AIndexToInsert);
    end;
    FUpdateFieldsParameters := TdxUpdateFieldsParameters.Create(AFields,
      AFieldsToDelete, AParent);
  finally
    ASourceFields.Free;
  end;
end;
...
begin
  ARightCopiedField := SourcePieceTable.FindFieldByRunIndex
    (ARunInfo.&End.RunIndex);
  if ARightCopiedField <> nil then
    ChangeRunInfo(ARunInfo, ARightCopiedField);
  ALeftCopiedField := SourcePieceTable.FindFieldByRunIndex
    (ARunInfo.Start.RunIndex);
...
begin
  Result := False;
  if IsEntireFieldAffected(ARunInfo, AField) or
    IsFieldCodeTextAffectedOnly(ARunInfo, AField) then
    Exit;
  if IsFieldResultTextAffectedOnly(ARunInfo, AField) then
    Result := not AllowCopyWholeFieldResult and
      IsEntireFieldResultAffected(ARunInfo, AField)
  else
    Result := True;
end;
...
begin
  ...
  if not SuppressFieldsUpdate then
    TargetPieceTable.FieldUpdater.UpdateFields(AFields,
      FUpdateFieldsParameters.Parent, UpdateFieldOperationType);
end;

{ TdxRichEditCommandsCreationStrategy }

function TdxRichEditCommandsCreationStrategy.CreateNumberingListIndexCalculator
  (AModel: TdxDocumentModel; ANumberingListType: TdxNumberingType)
...
constructor TdxBufferedRegexSearchResult.Create(const ARegEx: TRegex;
const AMatch: TMatch; const AOffset: TdxDocumentModelPosition);
begin
  inherited Create;
  FAbsolutePosition := -1;
  FRegEx := ARegEx;
...
procedure TdxSearchContext.BeginSearch(AAction: TdxSearchAction;
ADirection: TdxDirection);
var
...
procedure TdxSearchContext.SetMatchInfo(const Value
  : TdxBufferedRegexSearchResult);
begin
...
function TdxSearchContext.CreateEventArgs(const ASearchString: string;
const AReplaceString: string): TdxSearchCompleteEventArgs;
var
...
procedure TdxSearchContext.OnParagraphInserted(APieceTable: TdxCustomPieceTable;
ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ACell: TdxCustomTableCell; AIsParagraphMerged: Boolean;
AActualParagraphIndex: TdxParagraphIndex; AHistoryNotificationId: Integer);
begin
  if StartSelectionAnchor <> nil then
    StartSelectionAnchor.OnParagraphInserted(APieceTable, ASectionIndex,
      AParagraphIndex, ARunIndex, ACell, AIsParagraphMerged,
      AActualParagraphIndex, AHistoryNotificationId);
  if EndSelectionAnchor <> nil then
    EndSelectionAnchor.OnParagraphInserted(APieceTable, ASectionIndex,
      AParagraphIndex, ARunIndex, ACell, AIsParagraphMerged,
      AActualParagraphIndex, AHistoryNotificationId);
end;

procedure TdxSearchContext.OnParagraphRemoved(APieceTable: TdxCustomPieceTable;
ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; AHistoryNotificationId: Integer);
begin
  if StartSelectionAnchor <> nil then
    StartSelectionAnchor.OnParagraphRemoved(APieceTable, ASectionIndex,
      AParagraphIndex, ARunIndex, AHistoryNotificationId);
  if EndSelectionAnchor <> nil then
    EndSelectionAnchor.OnParagraphRemoved(APieceTable, ASectionIndex,
      AParagraphIndex, ARunIndex, AHistoryNotificationId);
end;

procedure TdxSearchContext.OnParagraphMerged(APieceTable: TdxCustomPieceTable;
ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; AHistoryNotificationId: Integer);
begin
  if StartSelectionAnchor <> nil then
    StartSelectionAnchor.OnParagraphMerged(APieceTable, ASectionIndex,
      AParagraphIndex, ARunIndex, AHistoryNotificationId);
  if EndSelectionAnchor <> nil then
    EndSelectionAnchor.OnParagraphMerged(APieceTable, ASectionIndex,
      AParagraphIndex, ARunIndex, AHistoryNotificationId);
end;

procedure TdxSearchContext.OnRunInserted(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ANewRunIndex: TdxRunIndex; ALength: Integer;
AHistoryNotificationId: Integer);
begin
  if StartSelectionAnchor <> nil then
    StartSelectionAnchor.OnRunInserted(APieceTable, AParagraphIndex,
      ANewRunIndex, ALength, AHistoryNotificationId);
  if EndSelectionAnchor <> nil then
    EndSelectionAnchor.OnRunInserted(APieceTable, AParagraphIndex, ANewRunIndex,
      ALength, AHistoryNotificationId);
end;

procedure TdxSearchContext.OnRunRemoved(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex; ALength: Integer;
AHistoryNotificationId: Integer);
begin
  if StartSelectionAnchor <> nil then
    StartSelectionAnchor.OnRunRemoved(APieceTable, AParagraphIndex, ARunIndex,
      ALength, AHistoryNotificationId);
  if EndSelectionAnchor <> nil then
    EndSelectionAnchor.OnRunRemoved(APieceTable, AParagraphIndex, ARunIndex,
      ALength, AHistoryNotificationId);
end;

procedure TdxSearchContext.OnBeginMultipleRunSplit
  (APieceTable: TdxCustomPieceTable);
begin
end;

procedure TdxSearchContext.OnEndMultipleRunSplit(APieceTable
  : TdxCustomPieceTable);
begin
end;

procedure TdxSearchContext.OnRunSplit(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ASplitOffset: Integer);
begin
  if StartSelectionAnchor <> nil then
    StartSelectionAnchor.OnRunSplit(APieceTable, AParagraphIndex, ARunIndex,
      ASplitOffset);
  if EndSelectionAnchor <> nil then
    EndSelectionAnchor.OnRunSplit(APieceTable, AParagraphIndex, ARunIndex,
      ASplitOffset);
end;

procedure TdxSearchContext.OnRunJoined(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; AJoinedRunIndex: TdxRunIndex;
ASplitOffset: Integer; ATailRunLength: Integer);
begin
  if StartSelectionAnchor <> nil then
    StartSelectionAnchor.OnRunJoined(APieceTable, AParagraphIndex,
      AJoinedRunIndex, ASplitOffset, ATailRunLength);
  if EndSelectionAnchor <> nil then
    EndSelectionAnchor.OnRunJoined(APieceTable, AParagraphIndex,
      AJoinedRunIndex, ASplitOffset, ATailRunLength);
end;

procedure TdxSearchContext.OnRunMerged(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ADeltaRunLength: Integer);
begin
  if StartSelectionAnchor <> nil then
    StartSelectionAnchor.OnRunMerged(APieceTable, AParagraphIndex, ARunIndex,
      ADeltaRunLength);
  if EndSelectionAnchor <> nil then
    EndSelectionAnchor.OnRunMerged(APieceTable, AParagraphIndex, ARunIndex,
      ADeltaRunLength);
end;

procedure TdxSearchContext.OnRunUnmerged(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ADeltaRunLength: Integer);
begin
  if StartSelectionAnchor <> nil then
    StartSelectionAnchor.OnRunUnmerged(APieceTable, AParagraphIndex, ARunIndex,
      ADeltaRunLength);
  if EndSelectionAnchor <> nil then
    EndSelectionAnchor.OnRunUnmerged(APieceTable, AParagraphIndex, ARunIndex,
      ADeltaRunLength);
end;

procedure TdxSearchContext.OnFieldRemoved(APieceTable: TdxCustomPieceTable;
AFieldIndex: Integer);
begin
  if StartSelectionAnchor <> nil then
...
procedure TdxSearchContext.OnFieldInserted(APieceTable: TdxCustomPieceTable;
AFieldIndex: Integer);
begin
  if StartSelectionAnchor <> nil then
...
constructor TdxSpellCheckerIntervalCollection<T>.Create
...
function TdxSpellCheckerIntervalCollection<T>.GetIntervals
  (AStart: TdxDocumentLogPosition; AEnd: TdxDocumentLogPosition): TArray<T>;
var
...
function TdxSpellCheckerIntervalCollection<T>.FindInterval
  (APosition: TdxDocumentLogPosition): T;
var
  AIndex: Integer;
  AInterval: T;
begin
...
function TdxSpellCheckerIntervalCollection<T>.FindInterval
  (AStart: TdxDocumentLogPosition; AEnd: TdxDocumentLogPosition): T;
var
  AIndex: Integer;
begin
...
procedure TdxSpellCheckerIntervalCollection<T>.RemoveRange
  (const ARange: TArray<T>);
begin
  RemoveRangeCore(ARange, True);
end;

procedure TdxSpellCheckerIntervalCollection<T>.RemoveRange
  (AStart: TdxDocumentLogPosition; AEnd: TdxDocumentLogPosition);
var
  AIntervals: TArray<T>;
begin
...
procedure TdxSpellCheckerIntervalCollection<T>.Remove
...
procedure TdxSpellCheckerIntervalCollection<T>.ExtractRange
  (const ARange: TArray<T>);
begin
  RemoveRangeCore(ARange, False);
end;

procedure TdxSpellCheckerIntervalCollection<T>.ExtractRange(AStart,
...
procedure TdxSpellCheckerIntervalCollection<T>.Extract
  (APosition: TdxDocumentLogPosition);
var
  AInterval: T;
begin
...
function TdxSpellCheckerIntervalCollection<T>.BinarySearch
  (APosition: TdxDocumentLogPosition): Integer;
begin
...
function TdxSpellCheckerIntervalCollection<T>.BinarySearch(AStart,
  AEnd: TdxDocumentLogPosition): Integer;
begin
  if not TdxAlgorithms1<T>.BinarySearch(InnerList,
    function(const AOther: T): Integer
    begin
...
procedure TdxSpellCheckerIntervalCollection<T>.OnRunRemoved(AParagraphIndex
  : TdxParagraphIndex; ARunIndex: TdxRunIndex; ALength: Integer;
AHistoryNotificationId: Integer);
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
    TdxSpellCheckerInterval(InnerList[I]).RunRemoved(AParagraphIndex, ARunIndex,
      ALength, AHistoryNotificationId);
end;

procedure TdxSpellCheckerIntervalCollection<T>.OnRunInserted(AParagraphIndex
  : TdxParagraphIndex; ANewRunIndex: TdxRunIndex; ALength: Integer;
AHistoryNotificationId: Integer);
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
    TdxSpellCheckerInterval(InnerList[I]).RunInserted(AParagraphIndex,
      ANewRunIndex, ALength, AHistoryNotificationId);
end;

procedure TdxSpellCheckerIntervalCollection<T>.OnRunMerged(AParagraphIndex
  : TdxParagraphIndex; ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
    TdxSpellCheckerInterval(InnerList[I]).RunMerged(AParagraphIndex, ARunIndex,
      ADeltaRunLength);
end;

procedure TdxSpellCheckerIntervalCollection<T>.OnParagraphRemoved
  (ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; AHistoryNotificationId: Integer);
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
    TdxSpellCheckerInterval(InnerList[I]).ParagraphRemoved(ASectionIndex,
      AParagraphIndex, ARunIndex, AHistoryNotificationId);
end;

procedure TdxSpellCheckerIntervalCollection<T>.OnParagraphMerged
  (ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; AHistoryNotificationId: Integer);
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
    TdxSpellCheckerInterval(InnerList[I]).ParagraphMerged(ASectionIndex,
      AParagraphIndex, ARunIndex, AHistoryNotificationId);
end;

procedure TdxSpellCheckerIntervalCollection<T>.OnParagraphInserted
  (ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ACell: TdxCustomTableCell; AIsParagraphMerged: Boolean;
AActualParagraphIndex: TdxParagraphIndex; AHistoryNotificationId: Integer);
var
...
begin
  for I := 0 to Count - 1 do
    TdxSpellCheckerInterval(InnerList[I]).ParagraphInserted(ASectionIndex,
      AParagraphIndex, ARunIndex, ACell, AIsParagraphMerged,
      AActualParagraphIndex, AHistoryNotificationId);
end;

procedure TdxSpellCheckerIntervalCollection<T>.OnRunSplit(AParagraphIndex
  : TdxParagraphIndex; ARunIndex: TdxRunIndex; ASplitOffset: Integer);
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
    TdxSpellCheckerInterval(InnerList[I]).RunSplit(AParagraphIndex, ARunIndex,
      ASplitOffset);
end;

procedure TdxSpellCheckerIntervalCollection<T>.OnRunJoined(AParagraphIndex
  : TdxParagraphIndex; AJoinedRunIndex: TdxRunIndex; ASplitOffset: Integer;
ATailRunLength: Integer);
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
    TdxSpellCheckerInterval(InnerList[I]).RunJoined(AParagraphIndex,
      AJoinedRunIndex, ASplitOffset, ATailRunLength);
end;

procedure TdxSpellCheckerIntervalCollection<T>.OnRunUnmerged(AParagraphIndex
  : TdxParagraphIndex; ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
    TdxSpellCheckerInterval(InnerList[I]).RunUnmerged(AParagraphIndex,
      ARunIndex, ADeltaRunLength);
end;

procedure TdxSpellCheckerIntervalCollection<T>.RemoveRangeCore
  (const ARange: TArray<T>; ARangeDestroy: Boolean);
var
...
procedure TdxSpellCheckerIntervalCollection<T>.RemoveCore(AInterval: T;
AIntervalDestroy: Boolean);
begin
...
constructor TdxMisspelledInterval.Create(APieceTable: TdxCustomPieceTable;
...
function TdxIgnoredList.Contains(AStart: TdxDocumentLogPosition;
AEnd: TdxDocumentLogPosition; const AWord: string): Boolean;
begin
...
procedure TdxMisspelledIntervalCollection.AddIfNotExists
  (ANewInterval: TdxMisspelledInterval);
var
  AIndex: Integer;
...
begin
  ...
  begin
    ...
    if (AOldInterval.Start <> ANewInterval.Start) or
      (AOldInterval.&End <> ANewInterval.&End) then
      TdxRichEditExceptions.ThrowInternalException;
  end;
end;
...
function TdxUncheckedIntervalCollection.ObtainIntervals(const AStart,
  AEnd: TdxDocumentModelPosition): TArray<TdxUncheckedInterval>;
var
  AStartIndex, AEndIndex: Integer;
...
begin
  ...
  if AStartIndex < 0 then
    AStartIndex := not AStartIndex
  else if SplitInterval(AStartIndex, AStart) then
    Inc(AStartIndex);
...
function TdxUncheckedIntervalCollection.SplitInterval(AIndex: Integer;
const APosition: TdxDocumentModelPosition): Boolean;
var
  AOldInterval, ANewInterval: TdxUncheckedInterval;
begin
  AOldInterval := InnerList[AIndex];
  if (AOldInterval.Start >= APosition.LogPosition) or
    (APosition.LogPosition >= AOldInterval.&End) then
    Exit(False);
...
procedure TdxUncheckedIntervalCollection.Add(ANewInterval
  : TdxUncheckedInterval);
var
  AIntervals: TArray<TdxUncheckedInterval>;
  AIndex: Integer;
begin
  Assert(PieceTable = ANewInterval.PieceTable);
  AIntervals := ObtainIntervals(ANewInterval.Interval.Start,
    ANewInterval.Interval.&End);
  if AIntervals <> nil then
    RemoveRange(AIntervals);
  AIndex := BinarySearch(ANewInterval.Start);
  if AIndex >= 0 then
...
function TdxUncheckedIntervalCollection.CanMerge(AFirstIndex: Integer;
ALastIndex: Integer): Boolean;
begin
  Result := InnerList[AFirstIndex].&End = InnerList[ALastIndex].Start;
end;

procedure TdxUncheckedIntervalCollection.Merge(AFirstIndex: Integer;
ALastIndex: Integer);
begin
...
procedure TdxUncheckedIntervalCollection.OnRunRemoved(AParagraphIndex
  : TdxParagraphIndex; ARunIndex: TdxRunIndex; ALength: Integer;
AHistoryNotificationId: Integer);
var
  I: Integer;
begin
  ...
  begin
    InnerList[I].RunRemoved(AParagraphIndex, ARunIndex, ALength,
      AHistoryNotificationId);
...
constructor TdxRichEditSpellCheckerManager.Create
  (APieceTable: TdxSimplePieceTable);
begin
  Assert(APieceTable <> nil);
  inherited Create;
...
function TdxRichEditSpellCheckerManager.CreateInstance
  (APieceTable: TdxPieceTable): TdxRichEditSpellCheckerManager;
begin
...
begin
  if (ModifiedWordEnd > ModifiedWordStart) and
    (ModifiedWordEnd <= PieceTable.DocumentEndLogPosition) then
    ProcessModifiedWord;
  ClearModifiedWordInfo;
end;
...
function TdxRichEditSpellCheckerManager.PopUncheckedIntervals(const AStart,
  AEnd: TdxDocumentModelPosition): TArray<TdxSpellCheckerInterval>;
var
  AIntervals: TArray<TdxUncheckedInterval>;
  I: Integer;
begin
...
procedure TdxRichEditSpellCheckerManager.RemoveMisspelledIntervals
  (AStart: TdxDocumentLogPosition; AEnd: TdxDocumentLogPosition);
var
...
begin
  ...
  if (AIntervals = nil) or (Length(AIntervals) = 0) then
    Exit;
  if (AIntervals[0].Start = AStart) and (AIntervals[0].ErrorType = seRepeating)
  then
  begin
...
procedure TdxRichEditSpellCheckerManager.CreateMisspelledInterval(const AStart,
  AEnd: TdxDocumentModelPosition; AErrorType: TdxSpellingError);
var
  AInterval: TdxMisspelledInterval;
begin
...
procedure TdxRichEditSpellCheckerManager.OnRunInserted(AParagraphIndex
  : TdxParagraphIndex; ANewRunIndex: TdxRunIndex; ALength: Integer;
AHistoryNotificationId: Integer);
var
  AStart, AEnd: TdxDocumentModelPosition;
begin
  ...
  OnRunInsertedCore(AParagraphIndex, ANewRunIndex, ALength,
    AHistoryNotificationId);
  CalculateUncheckedInterval(AStart, AEnd);
end;

procedure TdxRichEditSpellCheckerManager.OnRunInsertedCore(AParagraphIndex
  : TdxParagraphIndex; ANewRunIndex: TdxRunIndex; ALength: Integer;
AHistoryNotificationId: Integer);
begin
  MisspelledIntervals.OnRunInserted(AParagraphIndex, ANewRunIndex, ALength,
    AHistoryNotificationId);
  UncheckedIntervals.OnRunInserted(AParagraphIndex, ANewRunIndex, ALength,
    AHistoryNotificationId);
  IgnoredList.OnRunInserted(AParagraphIndex, ANewRunIndex, ALength,
    AHistoryNotificationId);
end;

procedure TdxRichEditSpellCheckerManager.CalculateUncheckedInterval
...
procedure TdxRichEditSpellCheckerManager.CalculateModifiedWordInfo
...
function TdxRichEditSpellCheckerManager.IsModifiedWord(const AStart,
  AEnd: TdxDocumentModelPosition): Boolean;
begin
  Result := (ModifiedWordStart = AStart.LogPosition) and
    (ModifiedWordEnd = AEnd.LogPosition);
end;
...
begin
  ...
  if (PieceTable.DocumentModel.Selection.Length > 0) or
    (((ACaretPosition < ModifiedWordStart) or
    (ACaretPosition > ModifiedWordEnd))) then
  begin
    ProcessModifiedWord;
    ClearModifiedWordInfo;
  end;
...
begin
  ...
  AStart := TdxPositionConverter.ToDocumentModelPosition(PieceTable,
    ModifiedWordStart);
  AEnd := TdxPositionConverter.ToDocumentModelPosition(PieceTable,
    ModifiedWordEnd);
  ...
  CalculateUncheckedIntervalCore(AStart, AEnd);
  PieceTable.DocumentModel.ResetSpellCheck(AStart.RunIndex,
    AEnd.RunIndex, True);
end;

function TdxRichEditSpellCheckerManager.IsRangeEditable(const AStart,
  AEnd: TdxDocumentModelPosition): Boolean;
var
  APieceTable: TdxPieceTable;
begin
  APieceTable := Safe<TdxPieceTable>.Cast(PieceTable);
  Result := (APieceTable = nil) or APieceTable.CanEditRange(AStart.LogPosition,
    AEnd.LogPosition);
end;

function TdxRichEditSpellCheckerManager.IsRangeVisible(const AStart,
  AEnd: TdxDocumentModelPosition): Boolean;
var
...
procedure TdxRichEditSpellCheckerManager.CalculateUncheckedIntervalCore
  (const AStart, AEnd: TdxDocumentModelPosition);
var
...
begin
  ...
  AIntervals := UncheckedIntervals.ObtainIntervals
    (AUncheckedInterval.Interval.Start, AUncheckedInterval.Interval.&End);
  if AIntervals <> nil then
    UncheckedIntervals.RemoveRange(AIntervals);
  UncheckedIntervals.Add(AUncheckedInterval);
end;

procedure TdxRichEditSpellCheckerManager.OnRunRemoved(AParagraphIndex
  : TdxParagraphIndex; ARunIndex: TdxRunIndex; ALength: Integer;
AHistoryNotificationId: Integer);
var
...
procedure TdxRichEditSpellCheckerManager.OnRunRemovedCore(AParagraphIndex
  : TdxParagraphIndex; ARunIndex: TdxRunIndex; ALength: Integer;
AHistoryNotificationId: Integer);
begin
  MisspelledIntervals.OnRunRemoved(AParagraphIndex, ARunIndex, ALength,
    AHistoryNotificationId);
  UncheckedIntervals.OnRunRemoved(AParagraphIndex, ARunIndex, ALength,
    AHistoryNotificationId);
  IgnoredList.OnRunRemoved(AParagraphIndex, ARunIndex, ALength,
    AHistoryNotificationId);
end;

procedure TdxRichEditSpellCheckerManager.OnRunMerged(AParagraphIndex
  : TdxParagraphIndex; ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
var
  AStart, AEnd: TdxDocumentModelPosition;
begin
  AStart := TdxDocumentModelPosition.FromRunStart(PieceTable, ARunIndex);
  AStart.LogPosition := AStart.LogPosition +
    (PieceTable.Runs[ARunIndex].Length - ADeltaRunLength);
...
procedure TdxRichEditSpellCheckerManager.OnRunMergedCore(AParagraphIndex
  : TdxParagraphIndex; ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
...
procedure TdxRichEditSpellCheckerManager.OnParagraphRemoved
  (ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; AHistoryNotificationId: Integer);
begin
  MisspelledIntervals.OnParagraphRemoved(ASectionIndex, AParagraphIndex,
    ARunIndex, AHistoryNotificationId);
  UncheckedIntervals.OnParagraphRemoved(ASectionIndex, AParagraphIndex,
    ARunIndex, AHistoryNotificationId);
  IgnoredList.OnParagraphRemoved(ASectionIndex, AParagraphIndex, ARunIndex,
    AHistoryNotificationId);
end;

procedure TdxRichEditSpellCheckerManager.OnParagraphMerged
  (ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; AHistoryNotificationId: Integer);
begin
  MisspelledIntervals.OnParagraphMerged(ASectionIndex, AParagraphIndex,
    ARunIndex, AHistoryNotificationId);
  UncheckedIntervals.OnParagraphMerged(ASectionIndex, AParagraphIndex,
    ARunIndex, AHistoryNotificationId);
  IgnoredList.OnParagraphMerged(ASectionIndex, AParagraphIndex, ARunIndex,
    AHistoryNotificationId);
end;

procedure TdxRichEditSpellCheckerManager.OnParagraphInserted
  (ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ACell: TdxCustomTableCell; AIsParagraphMerged: Boolean;
AActualParagraphIndex: TdxParagraphIndex; AHistoryNotificationId: Integer);
begin
  MisspelledIntervals.OnParagraphInserted(ASectionIndex, AParagraphIndex,
    ARunIndex, ACell, AIsParagraphMerged, AActualParagraphIndex,
    AHistoryNotificationId);
  UncheckedIntervals.OnParagraphInserted(ASectionIndex, AParagraphIndex,
    ARunIndex, ACell, AIsParagraphMerged, AActualParagraphIndex,
    AHistoryNotificationId);
  IgnoredList.OnParagraphInserted(ASectionIndex, AParagraphIndex, ARunIndex,
    ACell, AIsParagraphMerged, AActualParagraphIndex, AHistoryNotificationId);
end;

procedure TdxRichEditSpellCheckerManager.OnRunSplit(AParagraphIndex
  : TdxParagraphIndex; ARunIndex: TdxRunIndex; ASplitOffset: Integer);
begin
...
procedure TdxRichEditSpellCheckerManager.OnRunJoined(AParagraphIndex
  : TdxParagraphIndex; AJoinedRunIndex: TdxRunIndex; ASplitOffset: Integer;
ATailRunLength: Integer);
begin
  MisspelledIntervals.OnRunJoined(AParagraphIndex, AJoinedRunIndex,
    ASplitOffset, ATailRunLength);
  UncheckedIntervals.OnRunJoined(AParagraphIndex, AJoinedRunIndex, ASplitOffset,
    ATailRunLength);
  IgnoredList.OnRunJoined(AParagraphIndex, AJoinedRunIndex, ASplitOffset,
    ATailRunLength);
end;

procedure TdxRichEditSpellCheckerManager.OnRunUnmerged(AParagraphIndex
  : TdxParagraphIndex; ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
var
  APosition: TdxDocumentModelPosition;
  AStart, AEnd: TdxDocumentLogPosition;
begin
  ...
  MisspelledIntervals.OnRunUnmerged(AParagraphIndex, ARunIndex,
    ADeltaRunLength);
...
procedure TdxRichEditSpellCheckerManager.OnRunInserted
  (APieceTable: TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
ANewRunIndex: TdxRunIndex; ALength: Integer; AHistoryNotificationId: Integer);
begin
  if APieceTable <> PieceTable then
...
procedure TdxRichEditSpellCheckerManager.OnRunRemoved
  (APieceTable: TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ALength: Integer; AHistoryNotificationId: Integer);
begin
  if APieceTable <> PieceTable then
...
procedure TdxRichEditSpellCheckerManager.OnRunSplit
  (APieceTable: TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ASplitOffset: Integer);
begin
  if APieceTable <> PieceTable then
...
procedure TdxRichEditSpellCheckerManager.OnRunJoined
  (APieceTable: TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
AJoinedRunIndex: TdxRunIndex; ASplitOffset: Integer; ATailRunLength: Integer);
begin
  if APieceTable <> PieceTable then
...
procedure TdxRichEditSpellCheckerManager.OnRunMerged
  (APieceTable: TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
  if APieceTable <> PieceTable then
...
procedure TdxRichEditSpellCheckerManager.OnRunUnmerged
  (APieceTable: TdxCustomPieceTable; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
  if APieceTable <> PieceTable then
...
procedure TdxRichEditSpellCheckerManager.OnFieldRemoved
  (APieceTable: TdxCustomPieceTable; AFieldIndex: Integer);
begin
end;

procedure TdxRichEditSpellCheckerManager.OnFieldInserted
  (APieceTable: TdxCustomPieceTable; AFieldIndex: Integer);
begin
end;

procedure TdxRichEditSpellCheckerManager.OnBeginMultipleRunSplit
  (APieceTable: TdxCustomPieceTable);
begin
end;

procedure TdxRichEditSpellCheckerManager.OnEndMultipleRunSplit
  (APieceTable: TdxCustomPieceTable);
begin
end;
...
function TdxEmptySpellCheckerManager.CreateInstance(APieceTable: TdxPieceTable)
  : TdxRichEditSpellCheckerManager;
begin
...
procedure TdxEmptySpellCheckerManager.OnParagraphInserted
  (ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; ACell: TdxCustomTableCell; AIsParagraphMerged: Boolean;
AActualParagraphIndex: TdxParagraphIndex; AHistoryNotificationId: Integer);
begin
...
procedure TdxEmptySpellCheckerManager.OnParagraphMerged(ASectionIndex
  : TdxSectionIndex; AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
end;

procedure TdxEmptySpellCheckerManager.OnParagraphRemoved(ASectionIndex
  : TdxSectionIndex; AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
AHistoryNotificationId: Integer);
begin
end;

procedure TdxEmptySpellCheckerManager.OnRunInserted(AParagraphIndex
  : TdxParagraphIndex; ANewRunIndex: TdxRunIndex; ALength: Integer;
AHistoryNotificationId: Integer);
begin
end;

procedure TdxEmptySpellCheckerManager.OnRunJoined(AParagraphIndex
  : TdxParagraphIndex; AJoinedRunIndex: TdxRunIndex; ASplitOffset: Integer;
ATailRunLength: Integer);
begin
end;

procedure TdxEmptySpellCheckerManager.OnRunMerged(AParagraphIndex
  : TdxParagraphIndex; ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
end;

procedure TdxEmptySpellCheckerManager.OnRunRemoved(AParagraphIndex
  : TdxParagraphIndex; ARunIndex: TdxRunIndex; ALength: Integer;
AHistoryNotificationId: Integer);
begin
end;

procedure TdxEmptySpellCheckerManager.OnRunSplit(AParagraphIndex
  : TdxParagraphIndex; ARunIndex: TdxRunIndex; ASplitOffset: Integer);
begin
end;

procedure TdxEmptySpellCheckerManager.OnRunUnmerged(AParagraphIndex
  : TdxParagraphIndex; ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
end;
...
constructor TdxCustomMark.Create(const APos: PdxDocumentModelPosition;
AUserData: TObject);
begin
