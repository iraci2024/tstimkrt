...
type
  ...
  protected
    ...
    procedure PopulateCommands(ACommands: TdxCommandCollection);
      virtual; abstract;
  ...
  protected
    ...
    function CreateFindCommand: TdxFindAndSelectCoreCommandBase;
      virtual; abstract;
  end;
  ...
  protected
    ...
    procedure ReplaceText(AStartPos: TdxDocumentLogPosition;
  ...
  protected
    function GetAction: TdxSearchAction; override;
    procedure PopulateCommands(ACommands: TdxCommandCollection); override;
    function CreateReplaceAllCommand: TdxReplaceAllCoreCommand;
      virtual; abstract;
  end;
  ...
  strict private
    ...
    function GetSearchContext: TdxSearchContext;
  protected
    function CanEdit(AStart: TdxDocumentLogPosition; ALength: Integer)
      : Boolean; virtual;
    ...
    property SearchParameters: TdxSearchParameters read GetSearchParameters;
    property SearchContext: TdxSearchContext read GetSearchContext;
    property InnerReplaceCommand: TdxReplaceCoreCommand
      read FInnerReplaceCommand;
  public
...
function TdxSearchCommandBase.GetUpdateUIStateMode
...
procedure TdxFindNextAndSelectCommandBase.PopulateCommands
...
function TdxFindAndSelectForwardCommand.CreateFindCommand
  : TdxFindAndSelectCoreCommandBase;
begin
...
function TdxFindAndSelectBackwardCommand.CreateFindCommand
  : TdxFindAndSelectCoreCommandBase;
begin
...
function TdxEndSearchCoreCommand.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;

function TdxEndSearchCoreCommand.ChangePosition
...
function TdxEndSearchCoreCommand.
...
procedure TdxEndSearchCoreCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
begin
...
function TdxFindAndSelectCoreCommandBase.GetTreatStartPositionAsCurrent
  : Boolean;
begin
  Result := True;
end;
...
function TdxFindAndSelectCoreCommandBase.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
  Result := TdxDocumentLayoutDetailsLevel.None;
...
function TdxFindAndSelectCoreCommandBase.GetSearchParameters
  : TdxSearchParameters;
begin
...
procedure TdxFindAndSelectCoreCommandBase.UpdateUIStateCore
...
procedure TdxFindAndSelectCoreCommandBase.ChangeSelection
...
begin
  ...
  begin
    ...
    begin
      AEvent := SearchContext.CreateEventArgs(SearchParameters.SearchString,
        SearchParameters.ReplaceString);
      try
...
function TdxFindAndSelectCoreCommandBase.ChangePosition
  (const APos: TdxDocumentModelPosition): TdxDocumentLogPosition;
begin
  Result := APos.LogPosition;
end;

function TdxFindAndSelectCoreCommandBase.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;
...
function TdxFindAndSelectForwardCoreCommand.CreateTextSearchProvider
  : TdxTextSearchProvider;
begin
  Result := TdxTextSearchProvider.CreateForwardProvider(ActivePieceTable,
    SearchParameters, SearchContext);
end;

{ TdxFindAndSelectBackwardCoreCommand }

function TdxFindAndSelectBackwardCoreCommand.CreateTextSearchProvider
  : TdxTextSearchProvider;
begin
  Result := TdxTextSearchProvider.CreateBackwardProvider(ActivePieceTable,
    SearchParameters, SearchContext);
end;
...
procedure TdxReplaceCommandBase.PopulateCommands
  (ACommands: TdxCommandCollection);
begin
...
function TdxReplaceForwardCommand.CreateFindCommand
  : TdxFindAndSelectCoreCommandBase;
begin
  Result := TdxFindAndSelectForwardCoreCommand.Create(RichEditControl);
end;
...
function TdxReplaceBackwardCommand.CreateFindCommand
  : TdxFindAndSelectCoreCommandBase;
begin
  Result := TdxFindAndSelectBackwardCoreCommand.Create(RichEditControl);
end;
...
begin
  if (DocumentModel.Selection.Length = 0) or (SearchParameters.SearchString = '')
  then
    Exit(False);
  ...
  if not SearchContext.StartOfSearch then
    ...
    Result := (not SearchParameters.UseRegularExpression and
      CompareStringWithSelectedText(SearchParameters.SearchString));
end;

function TdxReplaceCoreCommand.CompareStringWithSelectedText
...
begin
  ...
  try
    ...
    if (not AIterator.IsCharacterExist(ALength - 1)) or
      (AIterator.GetPosition(ALength) <> ASelection.NormalizedEnd^) then
      Exit(False);
...
procedure TdxReplaceCoreCommand.ReplaceText(AStartPos: TdxDocumentLogPosition;
  ALength: Integer);
var
  AReplacement: string;
begin
  AReplacement := SearchParameters.ReplaceString;
  if SearchParameters.UseRegularExpression and (SearchContext.MatchInfo <> nil)
  then
...
procedure TdxReplaceCoreCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
begin
...
procedure TdxReplaceAllCommandBase.PopulateCommands
  (ACommands: TdxCommandCollection);
begin
...
function TdxReplaceAllForwardCommand.CreateReplaceAllCommand
  : TdxReplaceAllCoreCommand;
begin
...
function TdxReplaceAllBackwardCommand.CreateReplaceAllCommand
  : TdxReplaceAllCoreCommand;
begin
...
function TdxBeginReplaceAllCoreCommand.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
  Result := TdxDocumentLayoutDetailsLevel.None;
...
function TdxBeginReplaceAllCoreCommand.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;

function TdxBeginReplaceAllCoreCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): TdxDocumentLogPosition;
begin
  Result := APos.LogPosition;
end;

procedure TdxBeginReplaceAllCoreCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
...
procedure TdxBeginReplaceAllCoreCommand.ChangeSelection
  (ASelection: TdxSelection);
begin
...
function TdxReplaceAllCoreCommand.CanEdit(AStart: TdxDocumentLogPosition;
...
procedure TdxReplaceAllCoreCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
begin
...
function TdxReplaceAllForwardCoreCommand.CreateTextSearchProvider
  : TdxTextSearchProvider;
begin
  Result := TdxTextSearchProvider.CreateForwardProvider(ActivePieceTable,
    SearchParameters, SearchContext);
...
function TdxReplaceAllBackwardCoreCommand.CreateTextSearchProvider
  : TdxTextSearchProvider;
begin
  Result := TdxTextSearchProvider.CreateBackwardProvider(ActivePieceTable,
    SearchParameters, SearchContext);
...
procedure TdxFindPrevNextCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
begin
