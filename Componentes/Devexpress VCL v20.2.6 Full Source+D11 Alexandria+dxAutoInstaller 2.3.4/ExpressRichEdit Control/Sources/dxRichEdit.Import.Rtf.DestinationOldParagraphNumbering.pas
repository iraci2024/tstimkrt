...
uses
  Types, Classes, Math, SysUtils, Graphics, Generics.Defaults,
  Generics.Collections, RTLConsts,
  dxCoreClasses,
  dxRichEdit.Import,
...
type
  ...
  TdxDestinationOldParagraphNumberingBase = class abstract
    (TdxRichEditRtfDestinationBase)
  private
    class procedure SetUnderlineType(AImporter: TdxRtfImporter;
      AUnderlineType: TdxUnderlineType); inline; static;

    class procedure AllCapsKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure CardinalKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure CenterAlignmentKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ContinuousUnderlineKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure DashDotDottedUnderlineKeywordHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); inline; static;
    class procedure DashDottedUnderlineKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure DashedUndrelineKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure DecimalKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure DottedUnderlineKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure DoubleUnderlineKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure FontBoldKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure FontNumberKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure FontSizeKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ForegroundColorKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure HairlineUnderlineKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure HangingIndentKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure IndentKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ItalicKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure LeftAlignmentKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure LowerCaseAlphabeticalKeywordHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); inline; static;
    class procedure LowerCaseRomanKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure NoneUnderlineKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure NumberingInCircleKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure OrdinalKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure OrdinalTextKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure RestartOnSectionBreakKeywordHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); inline; static;
    class procedure RightAlignmentKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure SmallCapsKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure SpaceKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure StartAtKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure StrikeKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure TextAfterKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure TextBeforeKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ThickUnderlineKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure UpperCaseAlphabeticalKeywordHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); inline; static;
    class procedure UpperCaseRomanKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure UsePrevKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure WaveUnderlineKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure WordUnderlineKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
  protected
    FTextAfter: string;
    FTextBefore: string;

    class procedure AppendParagraphNumberingDescKeywords
      (ATable: TdxKeywordTranslatorTable); static;
    class procedure SetNumberingListFormat(AImporter: TdxRtfImporter;
      AFormat: TdxNumberingFormat); inline; static;
  public
  ...
  TdxDestinationOldParagraphNumbering = class
  ...
  private
    ...
    function AreSameInfo(AExistingListLevelInfo: TdxRtfOldListLevelInfo;
      ARtfOldListLevelInfo: TdxRtfOldListLevelInfo): Boolean;
    ...
    procedure SetLegacyProperties(const ALevel: IdxListLevel;
      ALegacyIndent, ALegacySpace: Integer);

    class procedure BulletedParagraphKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ListLevelKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ListOverrideKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ParagraphLevelKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure SimpleNumberingKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure SkipNumberingKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
  protected
    ...
    procedure SetFirstLineIndent(const ALevel: IdxListLevel;
      ALineIndent: Integer);
    procedure SetTemplateCode(const ALevel: IdxListLevel;
      ATemplateCode: Integer);
    function ShouldCreateNewAbstractSimpleList(out AExistingNumberingListIndex
  ...
  public
    ...
    property IsOldNumberingListCreated: Boolean read FIsOldNumberingListCreated
      write FIsOldNumberingListCreated;
    property ListLevelIndex: Integer read FListLevelIndex write FListLevelIndex;
    property MultiLevelListIndex: TdxNumberingListIndex
      read FMultiLevelListIndex write FMultiLevelListIndex;
    ...
    property SimpleListIndex: TdxNumberingListIndex read FSimpleListIndex
      write FSimpleListIndex;
    property SkipNumbering: Boolean read FSkipNumbering write FSkipNumbering;
  end;

  { TdxDestinationOldSectionNumberingLevel }

  TdxDestinationOldSectionNumberingLevel = class
    (TdxDestinationOldParagraphNumberingBase)
  strict private
    class var FKeywordHT: TdxKeywordTranslatorTable;
    class constructor Initialize;
  ...
  public
    constructor Create(AImporter: TdxRtfImporter; ALevelNumber: Integer);
      reintroduce;
    procedure BeforePopRtfState; override;
  end;
...
procedure TdxDestinationOldParagraphNumberingBase.NestedGroupFinished
...
class procedure TdxDestinationOldParagraphNumberingBase.
  AppendParagraphNumberingDescKeywords(ATable: TdxKeywordTranslatorTable);
begin
...
class procedure TdxDestinationOldParagraphNumberingBase.SetNumberingListFormat
  (AImporter: TdxRtfImporter; AFormat: TdxNumberingFormat);
begin
  AImporter.Position.OldListLevelInfo.ListLevelProperties.Format := AFormat;
end;

class procedure TdxDestinationOldParagraphNumberingBase.SetUnderlineType
  (AImporter: TdxRtfImporter; AUnderlineType: TdxUnderlineType);
begin
...
class procedure TdxDestinationOldParagraphNumberingBase.
  CenterAlignmentKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
  AImporter.Position.OldListLevelInfo.ListLevelProperties.Alignment :=
    TdxListNumberAlignment.Center;
end;

class procedure TdxDestinationOldParagraphNumberingBase.
  ContinuousUnderlineKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxDestinationOldParagraphNumberingBase.
  DashDotDottedUnderlineKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxDestinationOldParagraphNumberingBase.
  DashDottedUnderlineKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxDestinationOldParagraphNumberingBase.
  DashedUndrelineKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxDestinationOldParagraphNumberingBase.
  DottedUnderlineKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxDestinationOldParagraphNumberingBase.
  DoubleUnderlineKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxDestinationOldParagraphNumberingBase.
  ForegroundColorKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
var
...
class procedure TdxDestinationOldParagraphNumberingBase.
  HairlineUnderlineKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxDestinationOldParagraphNumberingBase.
  HangingIndentKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
...
begin
  ...
  begin
    AInfo.FirstLineIndent := AImporter.UnitConverter.TwipsToModelUnits
      (-AParameterValue);
...
class procedure TdxDestinationOldParagraphNumberingBase.
  LeftAlignmentKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
  AImporter.Position.OldListLevelInfo.ListLevelProperties.Alignment :=
...
class procedure TdxDestinationOldParagraphNumberingBase.
  LowerCaseAlphabeticalKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxDestinationOldParagraphNumberingBase.
  LowerCaseRomanKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxDestinationOldParagraphNumberingBase.
  NoneUnderlineKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxDestinationOldParagraphNumberingBase.
  NumberingInCircleKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxDestinationOldParagraphNumberingBase.
  OrdinalTextKeywordHandler(AImporter: TdxRtfImporter; AParameterValue: Integer;
...
class procedure TdxDestinationOldParagraphNumberingBase.
  RestartOnSectionBreakKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
  // do nothing
end;
...
class procedure TdxDestinationOldParagraphNumberingBase.
  RightAlignmentKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
  AImporter.Position.OldListLevelInfo.ListLevelProperties.Alignment :=
...
class procedure TdxDestinationOldParagraphNumberingBase.StartAtKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  AImporter.Position.OldListLevelInfo.ListLevelProperties.Start :=
    AParameterValue;
end;
...
class procedure TdxDestinationOldParagraphNumberingBase.StrikeKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
const
  AStrikeoutTypeMap: array [Boolean] of TdxStrikeoutType =
    (TdxStrikeoutType.Single, TdxStrikeoutType.None);
begin
  AImporter.Position.CharacterFormatting.FontStrikeoutType :=
    AStrikeoutTypeMap[not AHasParameter or (AParameterValue <> 0)];
end;
...
class procedure TdxDestinationOldParagraphNumberingBase.
  ThickUnderlineKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
  SetUnderlineType(AImporter, TdxUnderlineType.ThickSingle);
end;
...
class procedure TdxDestinationOldParagraphNumberingBase.
  UpperCaseAlphabeticalKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxDestinationOldParagraphNumberingBase.
  UpperCaseRomanKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxDestinationOldParagraphNumberingBase.UsePrevKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  AImporter.Position.OldListLevelInfo.
    IncludeInformationFromPreviousLevel := True;
end;

class procedure TdxDestinationOldParagraphNumberingBase.
  WaveUnderlineKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxDestinationOldParagraphNumberingBase.
  WordUnderlineKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
...
constructor TdxDestinationOldParagraphNumbering.Create
  (AImporter: TdxRtfImporter);
begin
  inherited Create(AImporter);
  FOldLevelNumber := -1;
  if Importer.Position.OldListLevelInfo = nil then
    Importer.Position.OldListLevelInfo := TdxRtfOldListLevelInfo.Create
      (Importer.DocumentModel);
  if Importer.Position <> nil then
    Importer.Position.CharacterFormatting.ResetUse
...
function TdxDestinationOldParagraphNumbering.AreSameInfo(AExistingListLevelInfo
  : TdxRtfOldListLevelInfo;
  ARtfOldListLevelInfo: TdxRtfOldListLevelInfo): Boolean;
begin
  Result := (AExistingListLevelInfo.TextAfter = ARtfOldListLevelInfo.TextAfter)
    and (AExistingListLevelInfo.TextBefore = ARtfOldListLevelInfo.TextBefore);
end;
...
begin
  ...
  AActualNumberingListIndex := IfThen(IsSimpleList, SimpleListIndex,
    MultiLevelListIndex);
  ...
  begin
    Importer.Position.ParagraphFormattingInfo.NumberingListIndex :=
      FNumberingListIndex;
    Importer.Position.ParagraphFormattingInfo.ListLevelIndex := ListLevelIndex;
  end
  else
    Importer.Position.ParagraphFormattingInfo.NumberingListIndex :=
      IfThen(not SkipNumbering, AActualNumberingListIndex,
...
begin
  ...
  begin
    ...
    FNumberingListIndex := Importer.Position.ParagraphFormattingInfo.
      NumberingListIndex;
  end
  else
...
function TdxDestinationOldParagraphNumbering.
  SectionMultiLevelListCreated: Boolean;
begin
  Result := Importer.Position.CurrentOldMultiLevelListIndex >=
    NumberingListIndexMinValue;
end;

procedure TdxDestinationOldParagraphNumbering.SetDisplayFormatString
...
procedure TdxDestinationOldParagraphNumbering.SetFirstLineIndent
  (const ALevel: IdxListLevel; ALineIndent: Integer);
begin
...
procedure TdxDestinationOldParagraphNumbering.SetTemplateCode
...
function TdxDestinationOldParagraphNumbering.ShouldCreateNewAbstractSimpleList
  (out AExistingNumberingListIndex: TdxNumberingListIndex): Boolean;
var
...
begin
  if Importer.Position.CurrentOldSimpleList and
    (Importer.Position.CurrentOldSimpleListIndex >= NumberingListIndexMinValue)
  then
  begin
    AExistingNumberingListIndex := Importer.Position.CurrentOldSimpleListIndex;
    if not Importer.NumberingListToOldListLevelInfoMap.TryGetValue
      (AExistingNumberingListIndex, AOldListLevelInfo) then
      Result := True
    else
      Result := not AreSameInfo(AOldListLevelInfo,
        Importer.Position.OldListLevelInfo);
    Exit;
  end;
  ...
  begin
    APrevParagraph := Importer.Position.PieceTable.Paragraphs
      [APrevParagraphIndex];
    if not APrevParagraph.IsInList then
    begin
      if APrevParagraph.NumberingListIndex = NumberingListIndexNoNumberingList
      then
      begin
    ...
    if not Importer.NumberingListToOldListLevelInfoMap.TryGetValue
      (ANumberingListIndex, APrevOldListLevelInfo) then
      Exit(True);
    if not AreSameInfo(APrevOldListLevelInfo, Importer.Position.OldListLevelInfo)
    then
      Exit(True);
...
begin
  ...
  else if AOldListLevelInfo.ListLevelProperties.Format = TdxNumberingFormat.Bullet
  then
  begin
...
begin
  ...
  begin
    ...
    AFirstLineIndent := ALevelOffset * I +
      Importer.Position.ParagraphFormattingInfo.FirstLineIndent;
    SetFirstLineIndent(ALevel, AFirstLineIndent);
    SetDisplayFormatString(ALevel, Format('%0:s%1:s',
      [Importer.Position.OldListLevelInfo.TextBefore,
      Importer.Position.OldListLevelInfo.TextAfter]));
    SetTemplateCode(ALevel, TdxNumberingListHelper.GenerateNewTemplateCode
      (ADocumentModel));
    SetLegacyProperties(ALevel, 0, 0);
  end;
  FIsOldNumberingListCreated := True;
  ADocumentModel.AddNumberingListUsingHistory
    (TdxNumberingList.Create(ADocumentModel,
    ADocumentModel.AbstractNumberingLists.Count - 1));
end;

function TdxDestinationOldParagraphNumbering.CreateClone
  : TdxRichEditRtfDestinationBase;
begin
  Result := TdxDestinationOldParagraphNumbering.Create(Importer);
end;

class function TdxDestinationOldParagraphNumbering.GetKeywordHT
...
class function TdxDestinationOldParagraphNumbering.CreateKeywordHT
  : TdxKeywordTranslatorTable;
begin
...
begin
  ...
  begin
    ...
    AFormatString := Format('%0:s%%%1:d:s%2:s', [ALevelInfo.TextBefore, I,
      ALevelInfo.TextAfter]);
    if (I > 0) and ALevelInfo.IncludeInformationFromPreviousLevel then
      AFormatString := AAbstractNumberingList.Levels[I - 1]
        .ListLevelProperties.DisplayFormatString + AFormatString;
...
begin
  ...
  begin
    ...
    begin
      ...
      AAbstractNumberingList.Levels[I] := ALevel;
      ALevel.CharacterProperties.BeginInit;
      ALevel.CharacterProperties.CopyFrom
        (Importer.Position.CharacterFormatting);
      ALevel.CharacterProperties.EndInit;
      AFirstLineIndent := Importer.Position.ParagraphFormattingInfo.
        FirstLineIndent + 150 * I;
      SetFirstLineIndent(ALevel, AFirstLineIndent);
      SetDisplayFormatString(ALevel, Format('%0:s%%%1:d:s%2:s',
        [Importer.Position.OldListLevelInfo.TextBefore, I,
        Importer.Position.OldListLevelInfo.TextAfter]));
      SetTemplateCode(ALevel, TdxNumberingListHelper.GenerateNewTemplateCode
        (ADocumentModel));
      SetLegacyProperties(ALevel, 0, 0);
      ...
      ANumberingFormat := Importer.Position.OldListLevelInfo.
        ListLevelProperties.Format;
    ...
    ADocumentModel.AddNumberingListUsingHistory
      (TdxNumberingList.Create(ADocumentModel,
      ADocumentModel.AbstractNumberingLists.Count - 1));
    Importer.NumberingListToOldListLevelInfoMap.Add
      (ADocumentModel.NumberingLists.Count - 1,
      Importer.Position.OldListLevelInfo.Clone);
  end
  else
  begin
    AAbstractNumberingListIndex := ADocumentModel.NumberingLists
      [AExistingNumberingListIndex].AbstractNumberingListIndex;
    APrevNumberingList := ADocumentModel.NumberingLists.Last;

    ANewList := TdxNumberingList.Create(ADocumentModel,
    ...
    if (APrevNumberingList <> nil) and
      (APrevNumberingList.Levels[0].ListLevelProperties.Format <>
      AOverrideListLevel.ListLevelProperties.Format) then
      AOverrideListLevel.SetOverrideStart(True);
    AOverrideListLevel.CharacterProperties.BeginInit;
    AOverrideListLevel.CharacterProperties.CopyFrom
      (Importer.Position.CharacterFormatting);
    AOverrideListLevel.CharacterProperties.EndInit;
    AFirstLineIndent := Importer.Position.ParagraphFormattingInfo.
      FirstLineIndent;
    SetFirstLineIndent(AOverrideListLevel, AFirstLineIndent);
    SetDisplayFormatString(AOverrideListLevel, Format('%0:s%%%1:d:s%2:s',
      [Importer.Position.OldListLevelInfo.TextBefore, 0,
      Importer.Position.OldListLevelInfo.TextAfter]));
    SetTemplateCode(AOverrideListLevel,
...
procedure TdxDestinationOldParagraphNumbering.SetLegacyProperties
  (const ALevel: IdxListLevel; ALegacyIndent, ALegacySpace: Integer);
begin
...
class procedure TdxDestinationOldParagraphNumbering.
  BulletedParagraphKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
  AImporter.Position.OldListLevelInfo.ListLevelProperties.Format :=
    TdxNumberingFormat.Bullet;
end;

class procedure TdxDestinationOldParagraphNumbering.ListLevelKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  AImporter.Position.ParagraphFormattingInfo.ListLevelIndex := AParameterValue;
  TdxDestinationOldParagraphNumbering(AImporter.Destination)
    .FExplicitListLevelIndex := True;
end;

class procedure TdxDestinationOldParagraphNumbering.ListOverrideKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
...
begin
  ...
  (TdxDestinationOldParagraphNumbering(AImporter.Destination))
    .FExplicitNumberingListIndex := True;
end;

class procedure TdxDestinationOldParagraphNumbering.
  SimpleNumberingKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
  TdxDestinationOldParagraphNumbering(AImporter.Destination).SimpleList := True;
end;

class procedure TdxDestinationOldParagraphNumbering.ParagraphLevelKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  ...
  TdxDestinationOldParagraphNumbering(AImporter.Destination).OldLevelNumber :=
    AParameterValue;
  TdxDestinationOldParagraphNumbering(AImporter.Destination).SimpleList
    := False;
  AImporter.Position.OldListLevelInfo.CopyFrom
    (AImporter.Position.OldListLevelInfoCollection[AParameterValue]);
end;

class procedure TdxDestinationOldParagraphNumbering.SkipNumberingKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
...
constructor TdxDestinationOldSectionNumberingLevel.Create
  (AImporter: TdxRtfImporter; ALevelNumber: Integer);
begin
  inherited Create(AImporter);
  AImporter.Position.OldListLevelInfo := TdxRtfOldListLevelInfo.Create
    (AImporter.DocumentModel);
  FLevelNumber := ALevelNumber;
end;

class function TdxDestinationOldSectionNumberingLevel.CreateKeywordTable
  : TdxKeywordTranslatorTable;
begin
  Result := TdxKeywordTranslatorTable.Create;
  AppendParagraphNumberingDescKeywords(Result);
...
class function TdxDestinationOldSectionNumberingLevel.GetKeywordHT
  : TdxKeywordTranslatorTable;
begin
  Result := FKeywordHT;
end;

function TdxDestinationOldSectionNumberingLevel.CreateClone
  : TdxRichEditRtfDestinationBase;
begin
  if Self = nil then
    Exit(nil);
  Result := TdxDestinationOldSectionNumberingLevel.Create(Importer,
    LevelNumber);
end;
...
function TdxDestinationOldSectionNumberingLevel.CreateRtfOldListLevelInfo
  : TdxRtfOldListLevelInfo;
begin
