...
type
  ...
  TdxRichEditRectangularObjectResizeMouseHandlerState = class
  ...
  protected
    function CreatePlatformStrategy
      : TdxRichEditRectangularObjectResizeMouseHandlerStateStrategy; virtual;
    procedure SetActionCursor; virtual;
    procedure InstallKeyboardHandler; virtual;
    procedure RestoreKeyboardHandler; virtual;
    function CreateKeyboardHandlerService(const AOldKeyboardHandler
      : IdxKeyboardHandlerService): TdxKeyboardHandlerServiceWrapper; virtual;
    ...
    procedure CommitFloatingObjectChanges(AAnchorRun
      : TdxFloatingObjectAnchorRun); virtual;
    procedure CommitFloatingObjectSizeChanges
      (AAnchorRun: TdxFloatingObjectAnchorRun); virtual;
    procedure CommitFloatingObjectSizeChangesCore
      (AAnchorRun: TdxFloatingObjectAnchorRun); virtual;
    procedure ApplySizeChanges(const ARectangularObject
      : IdxRectangularObject); virtual;
    procedure ApplySizeChangesCore(const ARectangularObject
      : IdxRectangularObject); virtual;
  ...
  public
    ...
    property ObjectActualBounds: TRect read FObjectActualBounds
      write FObjectActualBounds;
    property InitialActualSizeBounds: TRect read FInitialActualSizeBounds
      write FInitialActualSizeBounds;
  ...
  public
    class function CalculateAngle(const APoint: TPoint;
      const AObjectBounds: TRect; AInitialRotationAngle: Single): Single;
      overload; static;
    class function CalculateAngle(APoint: TPoint; const AObjectBounds: TRect;
      AInitialRotationAngle: Single; ATransformMatrix: TdxTransformMatrix)
      : Single; overload; static;
    class function SnapAngle(AAngle: Single): Single; overload; static;
    class function SnapAngle(AAngle: Single; AStep: Integer; ADelta: Single)
      : Single; overload; static;
    class function NormalizeAngle(AAngle: Single): Single; static;
    class function CalculateSnap(AAngle: Single; ABaseAngle: Single;
      ADelta: Single): Single; static;
  end;

  { TdxRichEditRectangularObjectRotateMouseHandlerState }

  TdxRichEditRectangularObjectRotateMouseHandlerState = class
    (TdxRichEditRectangularObjectResizeMouseHandlerState)
  strict private
  ...
  protected
    ...
    procedure ApplySizeChanges(const ARectangularObject
      : IdxRectangularObject); override;
    procedure ApplyRunChanges(AAnchorRun: TdxFloatingObjectAnchorRun); override;
    function SnapAngle(AAngle: Single): Single; overload;
    function SnapAngle(AAngle: Single; AStep: Integer; ADelta: Single)
      : Single; overload;

    property InitialRotationAngle: Single read FInitialRotationAngle
      write FInitialRotationAngle;
  public
    constructor Create(AController: TdxRichEditMouseController;
      AHotZone: TdxRectangularObjectHotZone;
      AInitialHitTestResult: TdxRichEditHitTestResult); reintroduce;
    class function NormalizeAngle(AAngle: Single): Single; static;
    function CalculateSnap(AAngle: Single; ABaseAngle: Single;
      ADelta: Single): Single;
  end;

  { TdxRichEditRectangularObjectResizeMouseHandlerStateStrategy }

  TdxRichEditRectangularObjectResizeMouseHandlerStateStrategy = class abstract
  ...
  protected
    ...
    property State: TdxRichEditRectangularObjectResizeMouseHandlerState
      read GetState;
  end;

  { TdxResizeTableRowMouseHandlerState }

  TdxResizeTableRowMouseHandlerState = class
  ...
  protected
    function CreatePlatformStrategy
      : TdxResizeTableRowMouseHandlerStateStrategy; virtual;
    ...
    function ContinueDrag(const APoint: TPoint;
      const AAllowedEffects: TdxDragDropEffects; AShiftState: TShiftState;
    ...
    function SnapVertically(AValue: Integer; AShiftState: TShiftState)
      : Integer; virtual;
    function ShouldSnapVertically(AValue: Integer;
      const AAnchor: TdxTableCellVerticalAnchor): Boolean; virtual;
  ...
  TdxResizeTableRowMouseHandlerStateStrategy = class abstract
    (TdxRichEditMouseHandlerStateStrategyBase)
  strict private
    function GetPageViewInfo: TdxPageViewInfo;
  ...
  TdxResizeTableVirtualColumnMouseHandlerState = class
    (TdxCancellableDragMouseHandlerStateBase)
  strict private
    FInitialHitTestResult: TdxRichEditHitTestResult;
  ...
  protected
    ...
    function GetAutoScrollEnabled: Boolean; override;
    function CreatePlatformStrategy
      : TdxResizeTableVirtualColumnMouseHandlerStateStrategy; virtual;
    function CalculateMouseCursor(AShiftState: TShiftState): TCursor; override;
    function CreateDataObject: IdxDataObject; override;
    function ContinueDrag(const APoint: TPoint;
      const AAllowedEffects: TdxDragDropEffects; AShiftState: TShiftState;
    ...
    function CommitDrag(const APoint: TPoint; AShiftState: TShiftState;
      const ADataObject: IdxDataObject): Boolean; override;
    function SnapHorizontally(AValue: Integer; AShiftState: TShiftState)
      : Integer; virtual;
    function ShouldSnapHorizontally(AValue: Integer;
      ASnapPositionIndex: Integer; ATableViewInfo: TdxTableViewInfo)
      : Boolean; virtual;
    procedure BeginVisualFeedback; override;
    procedure ShowVisualFeedback; override;
    procedure HideVisualFeedback; override;
  ...
  public
    constructor Create(AController: TdxRichEditMouseController;
      AInitialHitTestResult: TdxRichEditHitTestResult;
      AColumn: TdxVirtualTableColumn); reintroduce;
    destructor Destroy; override;
    procedure DrawReversibleLineCore; overload;
  ...
  TdxResizeTableVirtualColumnMouseHandlerStateStrategy = class abstract
    (TdxRichEditMouseHandlerStateStrategyBase)
  strict private
    function GetPageViewInfo: TdxPageViewInfo;
...
type
  ...
  TdxRichEditRectangularObjectResizeKeyboardHandlerService = class
  ...
  public
    constructor Create(AState
      : TdxRichEditRectangularObjectResizeMouseHandlerState;
      const AControl: IdxRichEditControl; ARun: TdxFloatingObjectAnchorRun;
...
begin
  ...
  if AInitialHitTestResult.Page <> nil then
    FMinAffectedRunIndex := AInitialHitTestResult.Page.GetFirstPosition
      (ActivePieceTable).RunIndex
  else
...
function TdxRichEditRectangularObjectResizeMouseHandlerState.
...
begin
  ...
  Result.Location := P;
  Result.Width := Result.Width + ObjectActualBounds.Width -
    FInitialActualSizeBounds.Width;
  Result.Height := Result.Height + ObjectActualBounds.Height -
    FInitialActualSizeBounds.Height;
end;
...
begin
  ...
  FPageViewInfo := Control.InnerControl.ActiveView.LookupPageViewInfoByPage
    (ATopLevelPage);
  BeginVisualFeedback;
...
procedure TdxRichEditRectangularObjectResizeMouseHandlerState.
  InstallKeyboardHandler;
begin
  ...
  begin
    ...
    Control.AddKeyboardService
      (CreateKeyboardHandlerService(FOldKeyboardHandler));
  end;
end;
...
function TdxRichEditRectangularObjectResizeMouseHandlerState.
  CreateKeyboardHandlerService(const AOldKeyboardHandler
  : IdxKeyboardHandlerService): TdxKeyboardHandlerServiceWrapper;
begin
  Result := TdxRichEditRectangularObjectResizeKeyboardHandlerService.Create
    (Self, AOldKeyboardHandler);
end;

procedure TdxRichEditRectangularObjectResizeMouseHandlerState.HandleMouseMove
...
procedure TdxRichEditRectangularObjectResizeMouseHandlerState.
  UpdateLastLogicalPoint(const APhysicalPoint: TPoint);
var
  AViewInfo: TdxPageViewInfo;
begin
  AViewInfo := Control.InnerControl.ActiveView.GetPageViewInfoFromPoint
    (APhysicalPoint, True);
  ...
  FLastLogicalPoint := Control.InnerControl.ActiveView.CreateLogicalPoint
    (FPageViewInfo.ClientBounds, APhysicalPoint);
end;
...
procedure TdxRichEditRectangularObjectResizeMouseHandlerState.HandleMouseWheel
  (const Args: TdxMouseEventArgs);
begin
  // do nothing
end;

procedure TdxRichEditRectangularObjectResizeMouseHandlerState.HandleMouseUp
  (const Args: TdxMouseEventArgs);
begin
  UpdateLastLogicalPoint(Args.MousePos);
  UpdateObjectProperties(FLastLogicalPoint);
...
procedure TdxRichEditRectangularObjectResizeMouseHandlerState.
  CommitFloatingObjectLocationAndSizeChanges(const AOffset: TPoint);
var
  ARun: TdxTextRunBase;
...
begin
  ...
  Control.BeginUpdate;
  try
    AModifier := TdxFloatingObjectResizeLayoutModifier.Create(Self, Control,
      AAnchorRun, AFloatingObjectAnchorRunIndex);
    try
      ...
      ATopLeftPhysicalPoint := Control.InnerControl.ActiveView.
        CreatePhysicalPoint(FPageViewInfo, AModifier.CurrentTopLeftCorner);
...
procedure TdxRichEditRectangularObjectResizeMouseHandlerState.
  CommitFloatingObjectChanges(AAnchorRun: TdxFloatingObjectAnchorRun);
var
  AOffset: TPoint;
begin
  AOffset := CalculateOffset;
  if AAnchorRun.FloatingObjectProperties.HorizontalPositionAlignment <>
    TdxFloatingObjectHorizontalPositionAlignment.None then
    AOffset.X := 0;
  if AAnchorRun.FloatingObjectProperties.VerticalPositionAlignment <>
...
procedure TdxRichEditRectangularObjectResizeMouseHandlerState.
  CommitFloatingObjectSizeChanges(AAnchorRun: TdxFloatingObjectAnchorRun);
begin
...
procedure TdxRichEditRectangularObjectResizeMouseHandlerState.
  CommitFloatingObjectSizeChangesCore(AAnchorRun: TdxFloatingObjectAnchorRun);
begin
  if AAnchorRun.Content is TdxTextBoxFloatingObjectContent then
    TdxTextBoxFloatingObjectContent(AAnchorRun.Content)
      .TextBoxProperties.ResizeShapeToFitText := False;
  ApplySizeChanges(AAnchorRun);
  ApplyRunChanges(AAnchorRun);
end;

procedure TdxRichEditRectangularObjectResizeMouseHandlerState.ApplySizeChanges
  (const ARectangularObject: IdxRectangularObject);
begin
  DocumentModel.BeginUpdate;
  try
...
procedure TdxRichEditRectangularObjectResizeMouseHandlerState.
  ApplySizeChangesCore(const ARectangularObject: IdxRectangularObject);
var
...
begin
  ...
  ARectangularObject.ActualSize :=
    TSize.Create(AUnitConverter.ToModelUnits(FObjectActualBounds.Width),
    AUnitConverter.ToModelUnits(FObjectActualBounds.Height));
end;

procedure TdxRichEditRectangularObjectResizeMouseHandlerState.ApplyRunChanges
  (AAnchorRun: TdxFloatingObjectAnchorRun);
begin
end;

function TdxRichEditRectangularObjectResizeMouseHandlerState.
  CalculateOffset: TPoint;
var
...
begin
  ...
  try
    ATransform.Rotate(RotationAngle,
      FInitialActualSizeBounds.CenterPoint.ToPointF);
  ...
  Result := TPoint.Create(ANewTopLeft.X - FInitialActualSizeBounds.X,
    ANewTopLeft.Y - FInitialActualSizeBounds.Y);
end;

function TdxRichEditRectangularObjectResizeMouseHandlerState.
  CalculateInitialOffset(const APoint: TPoint): TPoint;
begin
  Result := FHotZone.CalculateOffset(APoint);
end;

procedure TdxRichEditRectangularObjectResizeMouseHandlerState.
  UpdateObjectProperties(const APoint: TPoint);
var
  AResult: TRect;
begin
...
function TdxRichEditRectangularObjectResizeMouseHandlerState.
  ForceKeepOriginalAspectRatio(const ABounds: TRect): TRect;
var
  AActualSize: TSize;
begin
...
function TdxRichEditRectangularObjectResizeMouseHandlerState.GetOriginalSize
  (const ABounds: TRect): TSize;
var
  ARectangularObject: IdxRectangularObject;
  ARectangularScalingObject: IdxRectangularScalableObject;
begin
  ARectangularObject := TdxTextRunBase(HotZone.Box.GetRun(ActivePieceTable))
    .GetRectangularObject;
  if ARectangularObject = nil then
    Exit(ABounds.Size);

  if Supports(ARectangularObject, IdxRectangularScalableObject,
    ARectangularScalingObject) then
...
constructor TdxRichEditRectangularObjectResizeKeyboardHandlerService.Create
  (AOwner: TdxRichEditRectangularObjectResizeMouseHandlerState;
...
function TdxRichEditRectangularObjectResizeKeyboardHandlerService.HandleKeyDown
...
begin
  ...
  else if (Args.KeyData = VK_SHIFT) and not FShiftPressed then
  begin
    FOwner.Update;
    FShiftPressed := True;
  end;
...
function TdxRichEditRectangularObjectResizeKeyboardHandlerService.HandleKeyUp
  (const Args: TdxKeyEventArgs): Boolean;
begin
...
function TdxRichEditRectangularObjectResizeKeyboardHandlerService.HandleKeyPress
...
class function TdxObjectRotationAngleCalculator.CalculateAngle
  (const APoint: TPoint; const AObjectBounds: TRect;
  AInitialRotationAngle: Single): Single;
begin
  Result := CalculateAngle(APoint, AObjectBounds, AInitialRotationAngle, nil);
end;

class function TdxObjectRotationAngleCalculator.CalculateAngle(APoint: TPoint;
  const AObjectBounds: TRect; AInitialRotationAngle: Single;
  ATransformMatrix: TdxTransformMatrix): Single;
var
  ACenter: TPoint;
  ADeltaAngle: Single;
begin
...
class function TdxObjectRotationAngleCalculator.SnapAngle
...
class function TdxObjectRotationAngleCalculator.SnapAngle(AAngle: Single;
  AStep: Integer; ADelta: Single): Single;
var
  I: Integer;
begin
...
class function TdxObjectRotationAngleCalculator.NormalizeAngle
  (AAngle: Single): Single;
begin
...
class function TdxObjectRotationAngleCalculator.CalculateSnap(AAngle: Single;
  ABaseAngle: Single; ADelta: Single): Single;
begin
...
constructor TdxRichEditRectangularObjectRotateMouseHandlerState.Create
  (AController: TdxRichEditMouseController;
  AHotZone: TdxRectangularObjectHotZone;
  AInitialHitTestResult: TdxRichEditHitTestResult);
begin
...
procedure TdxRichEditRectangularObjectRotateMouseHandlerState.
  UpdateObjectProperties(const APoint: TPoint);
var
  P: TPoint;
begin
  ...
  RotationAngle := TdxObjectRotationAngleCalculator.CalculateAngle(APoint,
    ObjectActualBounds, InitialRotationAngle, HotZone.HitTestTransform);
end;

procedure TdxRichEditRectangularObjectRotateMouseHandlerState.ApplySizeChanges
  (const ARectangularObject: IdxRectangularObject);
begin
end;

procedure TdxRichEditRectangularObjectRotateMouseHandlerState.ApplyRunChanges
  (AAnchorRun: TdxFloatingObjectAnchorRun);
begin
  AAnchorRun.Shape.Rotation := DocumentModel.UnitConverter.DegreeToModelUnits
    (RotationAngle);
end;

function TdxRichEditRectangularObjectRotateMouseHandlerState.SnapAngle
  (AAngle: Single): Single;
begin
  if TdxKeyboardHelper.IsShiftPressed then
    Result := SnapAngle(AAngle, 15, 7.5)
...
function TdxRichEditRectangularObjectRotateMouseHandlerState.SnapAngle
  (AAngle: Single; AStep: Integer; ADelta: Single): Single;
var
  I: Integer;
begin
  AAngle := NormalizeAngle(AAngle);
...
class function TdxRichEditRectangularObjectRotateMouseHandlerState.
  NormalizeAngle(AAngle: Single): Single;
begin
  AAngle := dxFMod(AAngle, 360);
  if AAngle < 0 then
    AAngle := AAngle + 360;
...
function TdxRichEditRectangularObjectRotateMouseHandlerState.CalculateSnap
  (AAngle: Single; ABaseAngle: Single; ADelta: Single): Single;
begin
  if (ABaseAngle - ADelta <= AAngle) and (AAngle < ABaseAngle + ADelta) then
    Result := ABaseAngle
  else
...
constructor TdxFloatingObjectResizeLayoutModifier.Create
  (AState: TdxRichEditRectangularObjectResizeMouseHandlerState;
  const AControl: IdxRichEditControl; ARun: TdxFloatingObjectAnchorRun;
  AFloatingObjectAnchorRunIndex: TdxRunIndex);
begin
...
procedure TdxFloatingObjectResizeLayoutModifier.CommitCore
...
constructor TdxResizeTableRowMouseHandlerState.Create
  (AController: TdxRichEditMouseController;
  AInitialHitTestResult: TdxRichEditHitTestResult;
...
begin
  ...
  FInitialHitTestResult := AInitialHitTestResult;
  FTableRow := ATableRow;
  FMouseCursorOffset := AInitialHitTestResult.LogicalPoint.Y -
    ATableRow.BottomAnchor.VerticalPosition;
...
function TdxResizeTableRowMouseHandlerState.CreatePlatformStrategy
  : TdxResizeTableRowMouseHandlerStateStrategy;
begin
  Result := TdxVCLResizeTableRowMouseHandlerStateStrategy.Create(Self);
end;

function TdxResizeTableRowMouseHandlerState.GetHitTestDetailsLevel
...
function TdxResizeTableRowMouseHandlerState.CalculateMouseCursor
...
begin
  ...
  try
    ...
    if GetTopLevelPage(FInitialHitTestResult) <> GetTopLevelPage(AHitTestResult)
    then
      Exit(AAllowedEffects);

    HideVisualFeedback;
    ABottom := SnapVertically(AHitTestResult.LogicalPoint.Y -
      FMouseCursorOffset, AShiftState);
...
begin
  ...
  begin
    ...
    AHeight := DocumentModel.ToDocumentLayoutUnitConverter.ToModelUnits
      (ABottom - FReferenceTop);
    ACommand := TdxChangeTableRowHeightCommand.Create(Control, FTableRow.Row,
      AHeight);
    try
      ACommand.Execute;
    finally
...
function TdxResizeTableRowMouseHandlerState.SnapVertically(AValue: Integer;
  AShiftState: TShiftState): Integer;
var
...
begin
  ...
  if TdxAlgorithms1<TdxTableCellVerticalAnchor>.BinarySearch(AItems,
...
function TdxResizeTableRowMouseHandlerState.ShouldSnapVertically
  (AValue: Integer; const AAnchor: TdxTableCellVerticalAnchor): Boolean;
var
  ASnapValue, Y: Integer;
begin
  ASnapValue := DocumentModel.LayoutUnitConverter.PixelsToLayoutUnits(2,
    DocumentModel.DpiY);
...
function TdxResizeTableRowMouseHandlerStateStrategy.GetPageViewInfo
  : TdxPageViewInfo;
begin
  Result := State.PageViewInfo;
end;

function TdxResizeTableRowMouseHandlerStateStrategy.GetState
  : TdxResizeTableRowMouseHandlerState;
begin
...
constructor TdxResizeTableVirtualColumnMouseHandlerState.Create
  (AController: TdxRichEditMouseController;
  AInitialHitTestResult: TdxRichEditHitTestResult;
  AColumn: TdxVirtualTableColumn);
var
  ATopLevelPage: TdxPage;
begin
  inherited Create(AController);
...
function TdxResizeTableVirtualColumnMouseHandlerState.GetHitTestDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
  Result := TdxDocumentLayoutDetailsLevel.Page;
end;

function TdxResizeTableVirtualColumnMouseHandlerState.
  GetAutoScrollEnabled: Boolean;
begin
  Result := False;
end;

function TdxResizeTableVirtualColumnMouseHandlerState.CreatePlatformStrategy
  : TdxResizeTableVirtualColumnMouseHandlerStateStrategy;
begin
  Result := TdxVCLResizeTableVirtualColumnMouseHandlerStateStrategy.
    Create(Self);
end;

function TdxResizeTableVirtualColumnMouseHandlerState.CalculateMouseCursor
  (AShiftState: TShiftState): TCursor;
begin
  Result := TdxRichEditCursors.ResizeTableColumn;
end;

function TdxResizeTableVirtualColumnMouseHandlerState.CreateDataObject
  : IdxDataObject;
begin
  Result := nil;
end;

function TdxResizeTableVirtualColumnMouseHandlerState.ContinueDrag
  (const APoint: TPoint; const AAllowedEffects: TdxDragDropEffects;
...
begin
  ...
  try
    ...
    HideVisualFeedback;
    ARight := SnapHorizontally(AHitTestResult.LogicalPoint.X -
      FMouseCursorOffset, AShiftState);
...
function TdxResizeTableVirtualColumnMouseHandlerState.CommitDrag
...
begin
  ...
  begin
    ...
    FTableColumnRight := Min(Max(FReferenceLeft, ARight), FReferenceRight);
    ACommand := TdxChangeTableVirtualColumnRightCommand.Create(Control, FColumn,
      FTableColumnRight);
    try
      ACommand.Execute;
    finally
...
function TdxResizeTableVirtualColumnMouseHandlerState.SnapHorizontally
  (AValue: Integer; AShiftState: TShiftState): Integer;
var
...
function TdxResizeTableVirtualColumnMouseHandlerState.ShouldSnapHorizontally
  (AValue: Integer; ASnapPositionIndex: Integer;
...
function TdxResizeTableVirtualColumnMouseHandlerStateStrategy.GetPageViewInfo
  : TdxPageViewInfo;
begin
  Result := State.PageViewInfo;
end;

function TdxResizeTableVirtualColumnMouseHandlerStateStrategy.GetState
  : TdxResizeTableVirtualColumnMouseHandlerState;
begin
...
function TdxRichEditRectangularObjectResizeMouseHandlerStateStrategy.
  GetObjectActualBounds: TRect;
begin
  Result := State.ObjectActualBounds;
end;

function TdxRichEditRectangularObjectResizeMouseHandlerStateStrategy.
  GetPageViewInfo: TdxPageViewInfo;
begin
  Result := State.PageViewInfo;
end;

function TdxRichEditRectangularObjectResizeMouseHandlerStateStrategy.GetState
  : TdxRichEditRectangularObjectResizeMouseHandlerState;
begin
  Result := TdxRichEditRectangularObjectResizeMouseHandlerState
    (inherited State);
end;
