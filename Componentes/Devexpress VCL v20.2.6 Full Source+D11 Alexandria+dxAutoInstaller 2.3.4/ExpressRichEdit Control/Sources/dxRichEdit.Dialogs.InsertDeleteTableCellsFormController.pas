...
type
  ...
  TdxInsertDeleteTableCellsFormControllerParameters = class abstract
  ...
  TdxInsertTableCellsFormControllerParameters = class
    (TdxInsertDeleteTableCellsFormControllerParameters);

  { TdxDeleteTableCellsFormControllerParameters }

  TdxDeleteTableCellsFormControllerParameters = class
    (TdxInsertDeleteTableCellsFormControllerParameters);
  ...
  public
    ...
    property CellOperation: TdxTableCellOperation read FCellOperations
      write FCellOperations;
  end;

  { TdxInsertTableCellsFormController }

  TdxInsertTableCellsFormController = class
    (TdxInsertDeleteTableCellsFormController);

  { TdxDeleteTableCellsFormController }

  TdxDeleteTableCellsFormController = class
    (TdxInsertDeleteTableCellsFormController);
...
constructor TdxInsertDeleteTableCellsFormControllerParameters.Create
...
constructor TdxInsertDeleteTableCellsFormController.Create(AControllerParameters
  : TdxInsertDeleteTableCellsFormControllerParameters);
begin
  inherited Create;
