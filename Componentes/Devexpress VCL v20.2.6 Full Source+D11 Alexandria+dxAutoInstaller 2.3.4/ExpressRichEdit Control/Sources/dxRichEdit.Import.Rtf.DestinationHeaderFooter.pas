...
type
  ...
  TdxSectionHeaderFooterDestinationBase = class abstract
...
function TdxSectionPageHeaderDestination.CreateClone
  : TdxRichEditRtfDestinationBase;
begin
  Result := TdxSectionPageHeaderDestination.Create(Importer, Section,
    TdxSectionHeader(PieceTable.ContentType));
end;

{ TdxSectionPageFooterDestination }

function TdxSectionPageFooterDestination.CreateClone
  : TdxRichEditRtfDestinationBase;
begin
  Result := TdxSectionPageFooterDestination.Create(Importer, Section,
    TdxSectionHeader(PieceTable.ContentType));
end;
