...
type
  ...
  public
    class function FromStream(AReader: TBinaryReader)
      : TdxDocListOverrideFormat; static;
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader)
      : TdxDocListOverrideLevelFormat; static;
    procedure Write(AWriter: TBinaryWriter);
    procedure BeforeWrite;

    property StartAt: Integer read FStartAt write FStartAt;
    property OverriddenLevel: Integer read FOverriddenLevel
      write FOverriddenLevel;
    property OverrideStart: Boolean read FOverrideStart write FOverrideStart;
    property OverrideFormatting: Boolean read FOverrideFormatting
      write FOverrideFormatting;
    property OverrideLevelFormatting: TdxDocListLevel
      read FOverrideLevelFormatting write FOverrideLevelFormatting;
  end;
  ...
  public
    constructor Create;
    destructor Destroy; override;
    class function FromStream(AReader: TBinaryReader; ALevelsCount: Integer)
      : TdxDocListOverrideLevelInformation; static;
    procedure Write(AWriter: TBinaryWriter; ALevelsCount: Integer);

    property CharacterPosition: Integer read FCharacterPosition
      write FCharacterPosition;
    property LevelFormatOverrideData
      : TdxObjectList<TdxDocListOverrideLevelFormat>
      read FLevelFormatOverrideData;
  end;
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader; AOffset: Integer;
      ASize: Integer): TdxDocListOverrideFormatInformation; static;
    procedure Write(AWriter: TBinaryWriter;
      AAllowNonLinkedListDefinitions: Boolean);
    procedure BeforeWrite(AAllowNonLinkedListDefinitions: Boolean);

    property FormatOverride: TdxObjectList<TdxDocListOverrideFormat>
      read FListFormatOverride;
    property FormatOverrideData
      : TdxObjectList<TdxDocListOverrideLevelInformation>
      read FListFormatOverrideData;
  end;
...
class function TdxDocListOverrideFormat.FromStream(AReader: TBinaryReader)
  : TdxDocListOverrideFormat;
begin
...
class function TdxDocListOverrideLevelFormat.FromStream(AReader: TBinaryReader)
  : TdxDocListOverrideLevelFormat;
begin
...
begin
  FLevelFormatOverrideData :=
    TdxObjectList<TdxDocListOverrideLevelFormat>.Create;
end;
...
class function TdxDocListOverrideLevelInformation.FromStream
  (AReader: TBinaryReader; ALevelsCount: Integer)
  : TdxDocListOverrideLevelInformation;
begin
...
procedure TdxDocListOverrideLevelInformation.Read(AReader: TBinaryReader;
...
begin
  ...
  for I := 0 to ALevelsCount - 1 do
    FLevelFormatOverrideData.Add(TdxDocListOverrideLevelFormat.FromStream
      (AReader));
end;

procedure TdxDocListOverrideLevelInformation.Write(AWriter: TBinaryWriter;
  ALevelsCount: Integer);
var
  I: Integer;
begin
...
begin
  ...
  FListFormatOverrideData :=
    TdxObjectList<TdxDocListOverrideLevelInformation>.Create;
end;
...
class function TdxDocListOverrideFormatInformation.FromStream
...
procedure TdxDocListOverrideFormatInformation.Read(AReader: TBinaryReader;
...
begin
  ...
  for I := 0 to AListCount - 1 do
    FListFormatOverrideData.Add(TdxDocListOverrideLevelInformation.FromStream
      (AReader, FListFormatOverride[I].LevelsCount));
end;

procedure TdxDocListOverrideFormatInformation.Write(AWriter: TBinaryWriter;
  AAllowNonLinkedListDefinitions: Boolean);
var
  ACount, I: Integer;
begin
  ...
  for I := 0 to ACount - 1 do
    FListFormatOverrideData[I].
      Write(AWriter, FListFormatOverride[I].LevelsCount);
end;

procedure TdxDocListOverrideFormatInformation.BeforeWrite
  (AAllowNonLinkedListDefinitions: Boolean);
var
  ACount, I: Integer;
begin
