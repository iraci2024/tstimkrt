...
type
  ...
  public
    ...
    class function Max(const AValue1, AValue2: TdxWidthsContentInfo)
      : TdxWidthsContentInfo; static;
    class function Empty: TdxWidthsContentInfo; static;

    class operator Equal(const AValue1, AValue2: TdxWidthsContentInfo): Boolean;
    class operator NotEqual(const AValue1,
...
class function TdxWidthsContentInfo.Max(const AValue1,
  AValue2: TdxWidthsContentInfo): TdxWidthsContentInfo;
begin
  Result := TdxWidthsContentInfo.Create(Math.Max(AValue1.MinWidth,
    AValue2.MinWidth), Math.Max(AValue1.MaxWidth, AValue2.MaxWidth));
end;
...
constructor TdxWidthsInfo.Create(AMinWidth, AMaxWidth, ATotalHorizontalMargins
  : Integer);
begin
  FMinWidth := AMinWidth;
  FMaxWidth := AMaxWidth;
