...
type
  ...
  strict private
    class function OnDivsCollection(AImporter
  ...
  strict private
    ...
    class function CreateElementHandlerTable: TdxElementHandlerTable; static;
  strict private
    class function OnDiv(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  ...
  strict private
    ...
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxDivDestination; static;
    class function OnBodyDiv(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnLeftMargin(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnRightMargin(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnTopMargin(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnBottomMargin(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
  ...
  public
    constructor Create(AImporter: TdxWordProcessingMLBaseImporter;
      const ASetter: TdxAction<Integer>);
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;
  end;
...
class function TdxDocumentWebSettingsDestination.CreateElementHandlerTable
...
class function TdxDocumentWebSettingsDestination.OnDivsCollection
...
function TdxDocumentWebSettingsDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
...
class function TdxDivsDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
class function TdxDivsDestination.OnDiv(AImporter
  : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxDivDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
class function TdxDivDestination.GetThis(AImporter
  : TdxRichEditDestinationAndXmlBasedImporter): TdxDivDestination;
begin
...
class function TdxDivDestination.OnBodyDiv
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
var
...
class function TdxDivDestination.OnLeftMargin
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
var
  ASetter: TdxAction<Integer>;
...
class function TdxDivDestination.OnRightMargin
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
var
  ASetter: TdxAction<Integer>;
...
class function TdxDivDestination.OnTopMargin
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
var
  ASetter: TdxAction<Integer>;
...
class function TdxDivDestination.OnBottomMargin
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
var
  ASetter: TdxAction<Integer>;
...
begin
  FId := TdxWordProcessingMLBaseImporter(Importer).GetWpSTIntegerValue(AReader,
    'id', -1);
end;
...
constructor TdxPropertyDestination.Create
