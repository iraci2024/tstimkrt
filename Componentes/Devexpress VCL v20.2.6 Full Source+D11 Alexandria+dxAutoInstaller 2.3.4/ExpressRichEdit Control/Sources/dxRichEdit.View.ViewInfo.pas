...
type
  ...
  TdxFirstPageAnchor = class abstract;
    ...
    TdxRunningHeightFirstPageAnchor = class(TdxFirstPageAnchor)
      strict private FTopInvisibleHeight: Int64;
  public
    property TopInvisibleHeight: Int64 read FTopInvisibleHeight
      write FTopInvisibleHeight;
  end;
...
procedure TdxPageViewInfoCollection.ExportTo(const AExporter
...
constructor TdxRichEditViewPageViewInfoCollection.Create(ADocumentLayout
  : TdxDocumentLayout);
begin
  inherited Create;
...
procedure TdxRichEditViewPageViewInfoCollection.Notify(Ptr: Pointer;
...
procedure TdxRichEditViewPageViewInfoCollection.
  UpdateDocumentLayoutVisiblePages;
begin
