...
type
  ...
  public
    ...
    property AbstractList: TdxAbstractNumberingList read FAbstractList
      write FAbstractList;
    property Color;
    property EnableSelection: Boolean read FEnableSelection
      write FEnableSelection default True;
  end;
  ...
  protected
    ...
    function CreateSpellCheckerController
      : TdxSpellCheckerCustomController; override;
  ...
  TdxSimpleRichEditParagraphFormattingInfoCache = class
  ...
  protected
    function CreateDefaultParagraphFormattingInfo(ADocumentModel
      : TdxCustomDocumentModel): TdxParagraphFormattingInfo; override;
  end;
  ...
  protected
    function CreateParagraphFormattingCache(ADocumentModel
      : TdxCustomDocumentModel): TdxParagraphFormattingCache; override;
    function CreateParagraphFormattingInfoCache(AUnitConverter
      : TdxDocumentModelUnitConverter)
      : TdxParagraphFormattingInfoCache; override;
  end;
...
begin
  ...
  Options.HorizontalScrollbar.Visibility :=
...
function TdxCustomSimpleRichEditControl.CreateInnerControl
...
begin
  ACommand := TdxInsertTextCommand.Create
    (TdxRichEditControlAccess(InnerControl));
  try
...
function TdxSimpleInnerRichEditControl.CreateDocumentModelCore
  : TdxDocumentModel;
begin
  Result := TdxSimpleRichEditDocumentModel.Create;
end;

function TdxSimpleInnerRichEditControl.CreateMouseController
  : TdxRichEditCustomMouseController;
begin
  Result := TdxRichEditMouseController.Create(Owner.RichEditControl);
end;

function TdxSimpleInnerRichEditControl.CreateKeyboardController
  : TdxCustomKeyboardController;
begin
  Result := TdxSimpleRichEditKeyboardController.Create(Self);
end;

function TdxSimpleInnerRichEditControl.CreateSpellCheckerController
  : TdxSpellCheckerCustomController;
begin
  Result := TdxEmptySpellCheckerController.Create;
end;

function TdxSimpleInnerRichEditControl.CreateSpellCheckerManager
...
function TdxSimpleRichEditDocumentModel.CreateDocumentCache
...
function TdxSimpleRichEditKeyboardController.CreateDefaultHandler
...
function TdxSimpleRichEditDocumentCache.CreateParagraphFormattingInfoCache
  ...
  : TdxParagraphFormattingInfoCache;
begin
  Result := TdxSimpleRichEditParagraphFormattingInfoCache.Create
    (AUnitConverter);
end;
...
function TdxSimpleRichEditParagraphFormattingCache.
  CreateDefaultParagraphFormattingInfo(ADocumentModel: TdxCustomDocumentModel)
  : TdxParagraphFormattingInfo;
begin
  Result := TdxSimpleRichEditParagraphFormattingInfoCache.
    CreateDefaultItemMSO2003(ADocumentModel.UnitConverter);
end;
