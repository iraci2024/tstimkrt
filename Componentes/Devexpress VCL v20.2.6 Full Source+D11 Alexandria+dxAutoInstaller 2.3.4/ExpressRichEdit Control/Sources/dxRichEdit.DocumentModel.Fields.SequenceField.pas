...
type
  ...
  protected
    function CalculateValue(AField: TdxField; APieceTable: TdxSimplePieceTable)
      : Integer; virtual;
    function UpdateCounter(AField: TdxField; APieceTable: TdxSimplePieceTable)
      : Integer; virtual;
    function UpdateCounterCore(AField: TdxField; AValue: Integer;
      APieceTable: TdxSimplePieceTable): Integer; virtual;
  public
  ...
  public
    ...
    destructor Destroy; override;
    function CalculateCounterValue(AField: TdxCalculatedFieldBase;
      ADocumentField: TdxField): Integer; override;
...
procedure TdxSequenceField.Initialize(APieceTable: TdxCustomPieceTable;
...
begin
  ...
  if ANewCounterValueString.IsNull then
    FNewCounterValue := MinInt
  else if not TryStrToInt(ANewCounterValueString.Value, FNewCounterValue) then
    FNewCounterValue := MinInt;
end;
...
function TdxSequenceField.GetCalculatedValueCore(ASourcePieceTable
...
var
  ...
  AValue: Integer;
begin
  AValue := ATable.Fields.SequentialFieldManager.CalculateCounterValue(Self,
    ADocumentField);
...
function TdxSequentialFieldCounter.CalculateValue(AField: TdxField;
...
begin
  ...
  if TdxAlgorithms<TdxSequentialCounterItem>.BinarySearch(FValues,
    AComparable.CompareTo, AIndex) then
    Exit(FValues[AIndex].Value);
  Result := UpdateCounter(AField, APieceTable);
end;

function TdxSequentialFieldCounter.UpdateCounter(AField: TdxField;
  APieceTable: TdxSimplePieceTable): Integer;
var
...
function TdxSequentialFieldCounter.UpdateCounterCore(AField: TdxField;
  AValue: Integer; APieceTable: TdxSimplePieceTable): Integer;
var
    ...
    try
      ...
      try
        ...
        if ACalculatedField = nil then
          Exit(AValue);
        AInstructions := TdxFieldCalculatorService.ParseInstructions(AScanner,
          ACalculatedField);
        ...
        else if ACalculatedField.IncrementCounter then
          Inc(AValue);
...
function TdxSequentialCounterItemAndFieldComparable.CompareTo
  (const AOther: TdxSequentialCounterItem): Integer;
var
...
function TdxSequentialFieldManager.CalculateCounterValue
  (AField: TdxCalculatedFieldBase; ADocumentField: TdxField): Integer;
var
