...
begin
  ...
  AMergedCharacterProperties := TdxMergedCharacterProperties.Create(AInfo.Info,
    AInfo.Options);
  try
    Importer.ApplyCharacterProperties
      (Importer.DocumentModel.DefaultCharacterProperties, AFormattingInfo.Info,
      AMergedCharacterProperties, False);
  finally
...
class function TdxDefaultCharacterPropertiesDestination.GetControlCharHT
  : TdxControlCharTranslatorTable;
begin
  Result := nil;
end;

class function TdxDefaultCharacterPropertiesDestination.GetKeywordHT
...
class function TdxDefaultCharacterPropertiesDestination.CreateKeywordHT
  : TdxKeywordTranslatorTable;
begin
...
begin
  ...
  AMergedProperties := TdxMergedParagraphProperties.Create(AInfo.Info,
    AInfo.Options);
  try
    Importer.ApplyLineSpacing(Importer.Position.ParagraphFormattingInfo);
    Importer.ApplyParagraphProperties
      (Importer.DocumentModel.DefaultParagraphProperties, AFormattingInfo,
      AMergedProperties, False);
  finally
...
class function TdxDefaultParagraphPropertiesDestination.GetControlCharHT
  : TdxControlCharTranslatorTable;
begin
  Result := nil;
end;
...
class function TdxDefaultParagraphPropertiesDestination.GetKeywordHT
  : TdxKeywordTranslatorTable;
begin
  Result := FKeywordHT;
end;

class function TdxDefaultParagraphPropertiesDestination.CreateKeywordHT
  : TdxKeywordTranslatorTable;
begin
  Result := TdxKeywordTranslatorTable.Create;
