...
constructor TdxDocMarginsActions.Create(AOutput: TdxMemoryStream;
...
begin
  ...
  try
    ACommand.Value := FMargins.DocumentModel.UnitConverter.ModelUnitsToTwips
      (FMargins.Gutter);
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
...
begin
  if FMargins.GutterAlignment in [TdxSectionGutterAlignment.Top,
    TdxSectionGutterAlignment.Bottom] then
    Exit;
