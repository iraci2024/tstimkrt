...
type
  ...
  TdxNativeRangePermission = class(TInterfacedObject,
  ...
  TdxNativeRangePermissionCollection = class
    (TdxIUnknownList<IdxRichEditRangePermission>,
...
constructor TdxNativeRangePermission.Create(const ARange
