...
type
  ...
  public type
    TStyle = (AllowLeadingWhite, AllowTrailingWhite, AllowLeadingSign,
      AllowTrailingSign, AllowParentheses, AllowDecimalPoint, AllowThousands,
      AllowExponent, AllowCurrencySymbol, AllowHexSpecifier);
  ...
  public const
    ...
    Integer = [TStyle.AllowLeadingWhite, TStyle.AllowTrailingWhite,
      TStyle.AllowLeadingSign];
    Number = [TStyle.AllowLeadingWhite, TStyle.AllowTrailingWhite,
      TStyle.AllowLeadingSign, TStyle.AllowTrailingSign,
      TStyle.AllowDecimalPoint, TStyle.AllowThousands];
    Float = [TStyle.AllowLeadingWhite, TStyle.AllowTrailingWhite,
      TStyle.AllowLeadingSign, TStyle.AllowDecimalPoint, TStyle.AllowExponent];
    Currency = [TStyle.AllowLeadingWhite, TStyle.AllowTrailingWhite,
      TStyle.AllowLeadingSign, TStyle.AllowTrailingSign,
      TStyle.AllowParentheses, TStyle.AllowDecimalPoint, TStyle.AllowThousands,
      TStyle.AllowCurrencySymbol];
    Any = [TStyle.AllowLeadingWhite, TStyle.AllowTrailingWhite,
      TStyle.AllowLeadingSign, TStyle.AllowTrailingSign,
      TStyle.AllowParentheses, TStyle.AllowDecimalPoint, TStyle.AllowThousands,
      TStyle.AllowExponent, TStyle.AllowCurrencySymbol];
    HexNumber = [TStyle.AllowLeadingWhite, TStyle.AllowTrailingWhite,
      TStyle.AllowHexSpecifier];
  end;
  ...
  private
    class function GetValueText(const AText: string;
      AStyle: TdxNumberStyles.TStyles): string; static; inline;
    class function IsWhite(C: Char): Boolean; static; inline;
  public
    class function TryParse(const AText: string; out AValue: Integer): Boolean;
      overload; static;
    class function TryParse(const AText: string;
      AStyle: TdxNumberStyles.TStyles; out AValue: Integer): Boolean;
      overload; static;
    class function TryParse(const AText: string; out AValue: Int64): Boolean;
      overload; static;
    class function TryParse(const AText: string;
      AStyle: TdxNumberStyles.TStyles; out AValue: Int64): Boolean;
      overload; static;
    class function TryParse(const AText: string; out AValue: Double): Boolean;
      overload; static;
    class function TryParse(const AText: string;
      AStyle: TdxNumberStyles.TStyles; out AValue: Double): Boolean;
      overload; static;
    class function TryParse(const AText: string;
      AStyle: TdxNumberStyles.TStyles; const ACultureInfo: TdxCultureInfo;
      out AValue: Double): Boolean; overload; static;
    class function TryParse(const AText: string; out AValue: Single): Boolean;
      overload; static;
    class function TryParse(const AText: string;
      AStyle: TdxNumberStyles.TStyles; out AValue: Single): Boolean;
      overload; static;
  end;
  ...
  public
    ...
    class function GetColorByArgb(const AColorName: string)
      : TdxAlphaColor; static;
...
class function TdxNumber.TryParse(const AText: string;
  AStyle: TdxNumberStyles.TStyles; out AValue: Integer): Boolean;
begin
...
class function TdxNumber.GetValueText(const AText: string;
  AStyle: TdxNumberStyles.TStyles): string;
var
  ALen: Integer;
  AStart, AEnd: PChar;
begin
...
class function TdxMarkupLanguageColorParser.ParseColor(const AValue: string)
  : TdxAlphaColor;
var
...
class function TdxMarkupLanguageColorParser.GetColorByName(const AValue: string)
  : TdxAlphaColor;
var
  AColor: TColor;
begin
...
class function TdxMarkupLanguageColorParser.GetColor(const AColorName: string;
...
class function TdxMarkupLanguageColorParser.GetColorByRgb(const AColorName
  : string): TdxAlphaColor;
var
  R, G, B: Integer;
begin
...
class function TdxMarkupLanguageColorParser.GetColorByArgb(const AColorName
  : string): TdxAlphaColor;
var
  A, R, G, B: Integer;
begin
...
class function TdxMarkupLanguageColorParser.ParseRGB(const AValue: string)
  : TdxAlphaColor;
var
  ARgb: string;
  ACh: Char;
...
{$ENDIF}
    ...
    if AColors.Count = 3 then
      Result := TdxAlphaColors.FromArgb(255, Byte(AColors[0]), Byte(AColors[1]),
        Byte(AColors[2]))
    else
      Result := TdxAlphaColors.Empty;
  finally
