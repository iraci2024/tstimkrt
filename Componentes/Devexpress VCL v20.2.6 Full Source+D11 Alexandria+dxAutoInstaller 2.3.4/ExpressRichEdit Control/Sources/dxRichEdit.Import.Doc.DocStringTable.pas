...
type
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader; AOffset: Integer;
      ASize: Integer): TdxDocStringTable; static;
    procedure Write(AWriter: TBinaryWriter); override;

    property ShouldWriteEmptyTable: Boolean read FShouldWriteEmptyTable
      write FShouldWriteEmptyTable;
...
procedure TdxDocStringTableBase.Read(AReader: TBinaryReader; AOffset: Integer;
  ASize: Integer);
begin
...
function TdxDocStringTableBase.CalcRecordsCount(AReader: TBinaryReader)
  : Integer;
begin
  Result := AReader.ReadSmallInt;
end;

function TdxDocStringTableBase.CalcExtraDataSize
...
procedure TdxDocStringTableBase.WriteString(AWriter: TBinaryWriter;
  AIndex: Integer);
begin
end;

procedure TdxDocStringTableBase.WriteExtraData(AWriter: TBinaryWriter;
  AIndex: Integer);
var
  AExtraData: TBytes;
begin
...
class function TdxDocStringTable.FromStream(AReader: TBinaryReader;
  AOffset: Integer; ASize: Integer): TdxDocStringTable;
begin
...
procedure TdxDocStringTable.WriteString(AWriter: TBinaryWriter;
  AIndex: Integer);
var
  S: string;
begin
