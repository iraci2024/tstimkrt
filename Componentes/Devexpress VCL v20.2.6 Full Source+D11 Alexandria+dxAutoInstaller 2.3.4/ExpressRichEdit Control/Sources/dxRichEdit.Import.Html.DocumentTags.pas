...
type
  ...
  strict private
    ...
    class procedure HrefKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure TypeKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure MediaKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
  ...
  protected
    ...
    property MediaDescriptors: TdxStringList read FMediaDescriptors
      write SetMediaDescriptors;
  public
  ...
  strict private
    FCharset: string;
    class function AddAttributes: TdxAttributeKeywordTranslatorTable; static;
    class procedure CharsetKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure ContentKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure HttpEquivKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure NameKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
  protected
    function GetAttributeTable: TdxAttributeKeywordTranslatorTable; override;
    procedure ApplyTagProperties; override;
  ...
  strict private
    ...
    FUseBgColor: Boolean;
    class function AddAttributes: TdxAttributeKeywordTranslatorTable; static;
    class procedure ActiveLinkKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure BackGroundKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure BackGroundColorKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure OpenLinkColorKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure TextColorKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure LinkColorKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
  protected
    function GetAttributeTable: TdxAttributeKeywordTranslatorTable; override;
    procedure ApplyTagProperties; override;
...
begin
  ...
  begin
    ...
    ANamespaceDelimiterIndex := TdxStringHelper.IndexOf(AAttribute.Name,
      'XMLNS:');
    if ANamespaceDelimiterIndex >= 0 then
    begin
      ANamespace := TdxStringHelper.Substring(AAttribute.Name,
        ANamespaceDelimiterIndex + Length('XMLNS:'));
      TdxHtmlImporter(Importer).HtmlNamespaces.AddOrSetValue(ANamespace,
        AAttribute.Value);
    end;
  end;
end;
...
begin
  ...
  TdxHtmlImporter(Importer).RootDoubleFontSize := TdxHtmlImporter(Importer)
    .Position.CharacterFormatting.DoubleFontSize;
end;
...
class procedure TdxLinkTag.HrefKeyword(AImporter: TdxCustomHtmlImporter;
...
class procedure TdxLinkTag.TypeKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  ALinkTag: TdxLinkTag;
begin
...
class procedure TdxLinkTag.MediaKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  ALinkTag: TdxLinkTag;
begin
...
class procedure TdxMetaTag.CharsetKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  AMetaTag: TdxMetaTag;
begin
...
class procedure TdxMetaTag.ContentKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  AMetaTag: TdxMetaTag;
...
begin
  ...
  begin
    ...
    if (UpperCase(TdxAttributePattern.TryGetGroupValue(AMatch, 'attrName'))
      = 'CHARSET') and (TdxAttributePattern.TryGetGroupValue(AMatch, 'attrEq')
      = '=') then
      AMetaTag.Charset := TdxAttributePattern.TryGetGroupValue(AMatch,
        'attrValue');
  end;
end;

class procedure TdxMetaTag.HttpEquivKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxMetaTag.NameKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;
...
begin
  inherited Create(AImporter);
  if TdxHtmlImporter(Importer).Position.CharacterFormatting.Options.UseForeColor
  then
  begin
    FTextColor := TdxHtmlImporter(Importer)
      .Position.CharacterFormatting.ForeColor;
    FUseTextColor := True;
  end;
end;
...
class procedure TdxBodyTag.ActiveLinkKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxBodyTag.BackGroundKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxBodyTag.BackGroundColorKeyword
...
class procedure TdxBodyTag.OpenLinkColorKeyword
  (AImporter: TdxCustomHtmlImporter; const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxBodyTag.TextColorKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  ABodyTag: TdxBodyTag;
begin
...
class procedure TdxBodyTag.LinkColorKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;
...
begin
  if FUseTextColor then
    TdxHtmlImporter(Importer).Position.CharacterFormatting.ForeColor :=
      FTextColor;
end;
...
begin
  ...
  APageBackColor := TdxHtmlImporter(Importer)
    .Position.TableProperties.BackgroundColor;
  if (not TdxAlphaColors.IsEmpty(APageBackColor)) and TdxHtmlImporter(Importer)
    .Position.TableProperties.UseBackgroundColor then
  begin
...
begin
  ...
  AParagraphFormatting := TdxHtmlImporter(Importer)
    .Position.ParagraphFormatting;
...
begin
  ...
  Result.Add('P', TdxNamespaceTagInfo.Create(TdxHtmlTagNameID.Paragraph,
    TdxOfficeParagraphTag));
end;

initialization

TdxNamespaceTag.PopulateNamespaceTranslatorTable
  ('urn:schemas-microsoft-com:office:office', GetOfficeTranslatorTable);
