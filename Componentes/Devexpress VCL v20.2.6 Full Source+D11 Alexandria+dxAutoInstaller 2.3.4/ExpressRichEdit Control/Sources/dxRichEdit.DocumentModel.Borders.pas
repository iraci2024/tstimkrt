...
uses
  Classes, Types, Graphics, SysUtils, Generics.Defaults, Generics.Collections,
  Contnrs,
...
type
  TdxBorderChangeType = (None = 0, Style, Color, Width, Offset, Frame, Shadow,
    BatchUpdate);

  TdxProperties = (TopMargin, LeftMargin, RightMargin, BottomMargin,
    CellSpacing, PreferredWidth, TableIndent, TableLayout, TableLook,
    TableStyleColumnBandSize, TableStyleRowBandSize, IsTableOverlap,
    AvoidDoubleBorders, LeftBorder, RightBorder, TopBorder, BottomBorder,
    InsideHorizontalBorder, InsideVerticalBorder, TopLeftDiagonalBorder,
    TopRightDiagonalBorder, HideCellMark, NoWrap, FitText, TextDirection,
    VerticalAlignment, ColumnSpan, VerticalMerging, CellConditionalFormatting,
    RowHeight, WidthBefore, WidthAfter, Header, TableRowAlignment,
    TableRowConditionalFormatting, GridAfter, GridBefore, CantSplit,
    TableFloatingPosition, BackgroundColor, ForegroundColor, Shading,
    CellGeneralSettings, Borders, TableAlignment);
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxBorderInfo; override;
  end;
  ...
  public
    class function CalculateChangeActions(AChange: TdxBorderChangeType)
  ...
  strict protected
    function SetStyleCore(const AInfo: TdxBorderInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions;
    function SetColorCore(const AInfo: TdxBorderInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions;
    function SetWidthCore(const AInfo: TdxBorderInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions;
    function SetOffsetCore(const AInfo: TdxBorderInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions;
    function SetFrameCore(const AInfo: TdxBorderInfo; const AValue: Boolean)
      : TdxDocumentModelChangeActions;
    function SetShadowCore(const AInfo: TdxBorderInfo; const AValue: Boolean)
      : TdxDocumentModelChangeActions;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxBorderInfo>; override;
  ...
  private
    ...
    FValue: Integer;
  public
    constructor Create(AType: TdxWidthUnitType; AValue: Integer);
  ...
  strict protected
    ...
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxWidthUnitInfo>; override;
    procedure OnEndAssign; override;
    function GetBatchUpdateChangeActions
      : TdxDocumentModelChangeActions; override;
    procedure RaiseObtainAffectedRange(const AArgs
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxWidthUnitInfo; override;
  end;
  ...
  private
    ...
    FVal: Integer;
  public
    constructor Create(AValue: Integer; AType: TdxHeightUnitType);
      reintroduce; overload;
    function Equals(AObject: TObject): Boolean; override;
    function GetHashCode: Integer; override;
    procedure CopyFrom(Source: TdxCloneable); override;
  ...
  strict protected
    function SetTypeCore(const AUnit: TdxHeightUnitInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions;
    function SetValueCore(const AUnit: TdxHeightUnitInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxHeightUnitInfo>; override;
    procedure OnEndAssign; override;
    function GetBatchUpdateChangeActions
      : TdxDocumentModelChangeActions; override;
    procedure RaiseObtainAffectedRange(const AArgs
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxHeightUnitInfo; override;
  end;
  ...
  private
    ...
    function GetUseBottomMargin: Boolean;
  protected
    function CreateTopMargin(APieceTable: TdxCustomPieceTable)
      : TdxTopMarginUnit; virtual;
    function CreateBottomMargin(APieceTable: TdxCustomPieceTable)
      : TdxBottomMarginUnit; virtual;
    function CreateLeftMargin(APieceTable: TdxCustomPieceTable)
      : TdxLeftMarginUnit; virtual;
    function CreateRightMargin(APieceTable: TdxCustomPieceTable)
      : TdxRightMarginUnit; virtual;

    property Owner: IdxCellMarginsContainer read FOwner;
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      const AOwner: IdxCellMarginsContainer);
    destructor Destroy; override;
  ...
  public type
    ...
    public
      ...
      function GetValue(ACellMargins: TdxCellMargins): TdxMarginUnitBase;
        virtual; abstract;
    end;
  protected
    function GetProperty: TdxProperties; virtual; abstract;
  ...
  public type
    ...
    public
      ...
      function GetValue(ACellMargins: TdxCellMargins)
        : TdxMarginUnitBase; override;
    end;
  protected
    class var FPropertyAccessor
      : TdxMarginUnitBase.TdxMarginPropertyAccessorBase;
    class constructor Initialize;
    class destructor Finalize;
  ...
  public
    class property PropertyAccessor
      : TdxMarginUnitBase.TdxMarginPropertyAccessorBase read FPropertyAccessor;
  end;
  ...
  public type
    TdxRightPropertyAccessor = class
      (TdxMarginUnitBase.TdxMarginPropertyAccessorBase)
    public
      function CellPropertiesMask: Integer; override;
      function TablePropertiesMask: Integer; override;
  ...
  public type
    TdxBottomPropertyAccessor = class
      (TdxMarginUnitBase.TdxMarginPropertyAccessorBase)
    public
      function CellPropertiesMask: Integer; override;
      function TablePropertiesMask: Integer; override;
  ...
  strict private
    class var UnderlineTable: array [TdxBorderLineStyle] of TdxUnderline;
    class constructor Initialize;
    class destructor Finalize;
  ...
  strict private
    class function MapBorderStyleToUnderlineTryGetValue
      (ALineStyle: TdxBorderLineStyle; var AUnderlineClass: TdxUnderlineClass)
      : Boolean; static;
  protected
    procedure PopulateRepository; override;
    function GetUnderlineType(ALineStyle: TdxBorderLineStyle)
      : TdxUnderlineClass;
  public
    destructor Destroy; override;
    function GetCharacterLineByType(ALineStyle: TdxBorderLineStyle)
      : TdxUnderline;
  end;
...
class function TdxBorderInfo.AreBordersEqual(const A, B: TdxBorderInfo)
  : Boolean;
begin
  if A = B then
    Exit(True);
...
begin
  ...
  begin
    Result := (Style = AInfo.Style) and (Color = AInfo.Color) and
      (Width = AInfo.Width) and (Frame = AInfo.Frame) and
...
begin
  Result := ((Ord(Style) shl 20) or (Width shl 15) or (Offset shl 10) or
    (IfThen(Frame, 1, 0) shl 5) or (IfThen(Shadow, 1, 0) shl 4))
    xor Integer(Color);
end;

{ TdxBorderInfoCache }

function TdxBorderInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxBorderInfo;
begin
...
constructor TdxBorderBase.Create(APieceTable: TdxCustomPieceTable;
...
procedure TdxBorderBase.ApplyChanges(const AChangeActions
  : TdxDocumentModelChangeActions);
begin
  if Owner <> nil then
...
function TdxBorderBase.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxBorderChangeActionsCalculator.CalculateChangeActions
    (TdxBorderChangeType.BatchUpdate);
end;

function TdxBorderBase.GetCache(const ADocumentModel: TdxCustomDocumentModel)
  : TdxUniqueItemsCache<TdxBorderInfo>;
begin
...
procedure TdxBorderBase.RaiseObtainAffectedRange(const AArgs
  : TdxObtainAffectedRangeEventArgs);
begin
  if Owner <> nil then
...
function TdxBorderBase.SetColorCore(const AInfo: TdxBorderInfo;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.Color := AValue;
  Result := TdxBorderChangeActionsCalculator.CalculateChangeActions
    (TdxBorderChangeType.Color);
end;
...
function TdxBorderBase.SetFrameCore(const AInfo: TdxBorderInfo;
  const AValue: Boolean): TdxDocumentModelChangeActions;
begin
  AInfo.Frame := AValue;
  Result := TdxBorderChangeActionsCalculator.CalculateChangeActions
    (TdxBorderChangeType.Frame);
end;
...
function TdxBorderBase.SetOffsetCore(const AInfo: TdxBorderInfo;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.Offset := AValue;
  Result := TdxBorderChangeActionsCalculator.CalculateChangeActions
    (TdxBorderChangeType.Offset);
end;
...
function TdxBorderBase.SetShadowCore(const AInfo: TdxBorderInfo;
  const AValue: Boolean): TdxDocumentModelChangeActions;
begin
  AInfo.Shadow := AValue;
  Result := TdxBorderChangeActionsCalculator.CalculateChangeActions
    (TdxBorderChangeType.Shadow);
end;
...
function TdxBorderBase.SetWidthCore(const AInfo: TdxBorderInfo;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.Width := AValue;
  Result := TdxBorderChangeActionsCalculator.CalculateChangeActions
    (TdxBorderChangeType.Width);
end;

{ TdxWidthUnit }

procedure TdxWidthUnit.ApplyChanges(const AChangeActions
  : TdxDocumentModelChangeActions);
begin
  if Owner <> nil then
    Owner.ApplyChanges(AChangeActions)
...
constructor TdxWidthUnit.Create(APieceTable: TdxCustomPieceTable;
  const AOwner: IdxPropertiesContainer);
begin
  Assert(AOwner <> nil);
  inherited Create(APieceTable);
...
function TdxWidthUnit.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := [];
end;

function TdxWidthUnit.GetCache(const ADocumentModel: TdxCustomDocumentModel)
  : TdxUniqueItemsCache<TdxWidthUnitInfo>;
begin
...
procedure TdxWidthUnit.RaiseObtainAffectedRange(const AArgs
  : TdxObtainAffectedRangeEventArgs);
begin
  if Owner <> nil then
    Owner.RaiseObtainAffectedRange(AArgs);
...
function TdxWidthUnit.SetTypeCore(const AUnit: TdxWidthUnitInfo;
...
function TdxWidthUnit.SetValueCore(const AUnit: TdxWidthUnitInfo;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AUnit.Value := AValue;
  Result := [];
...
function TdxWidthUnitInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxWidthUnitInfo;
begin
...
function TdxMarginUnitBase.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
...
function TdxMarginUnitBase.SetValueCore(const AUnit: TdxWidthUnitInfo;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
...
function TdxLeftMarginUnit.TdxLeftPropertyAccessor.GetValue
  (ACellMargins: TdxCellMargins): TdxMarginUnitBase;
begin
...
function TdxRightMarginUnit.TdxRightPropertyAccessor.CellPropertiesMask
  : Integer;
begin
  Result := MaskUseRightMargin;
end;

function TdxRightMarginUnit.TdxRightPropertyAccessor.
  TablePropertiesMask: Integer;
begin
  Result := TableMaskUseRightMargin;
end;

function TdxRightMarginUnit.TdxRightPropertyAccessor.GetValue
  (ACellMargins: TdxCellMargins): TdxMarginUnitBase;
begin
...
function TdxTopMarginUnit.TdxTopPropertyAccessor.GetValue
  (ACellMargins: TdxCellMargins): TdxMarginUnitBase;
begin
...
procedure TdxHeightUnit.ApplyChanges(const AChangeActions
  : TdxDocumentModelChangeActions);
begin
  if Owner <> nil then
    Owner.ApplyChanges(AChangeActions)
...
constructor TdxHeightUnit.Create(APieceTable: TdxCustomPieceTable;
  const AOwner: IdxPropertiesContainer);
begin
  inherited Create(APieceTable);
  Assert(AOwner <> nil);
...
function TdxHeightUnit.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := [];
end;

function TdxHeightUnit.GetCache(const ADocumentModel: TdxCustomDocumentModel)
  : TdxUniqueItemsCache<TdxHeightUnitInfo>;
begin
...
procedure TdxHeightUnit.RaiseObtainAffectedRange(const AArgs
  : TdxObtainAffectedRangeEventArgs);
begin
  if Owner <> nil then
    Owner.RaiseObtainAffectedRange(AArgs);
...
function TdxHeightUnit.SetTypeCore(const AUnit: TdxHeightUnitInfo;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
...
function TdxHeightUnit.SetValueCore(const AUnit: TdxHeightUnitInfo;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AUnit.Value := AValue;
  Result := BatchUpdateChangeActions;
...
function TdxHeightUnitInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxHeightUnitInfo;
begin
...
constructor TdxCombinedCellMarginsInfo.Create(ACellMargins
  : TdxCellMargins = nil);
begin
  inherited Create;
...
constructor TdxCellMargins.Create(APieceTable: TdxCustomPieceTable;
  const AOwner: IdxCellMarginsContainer);
begin
  inherited Create;
  Assert(AOwner <> nil);
...
begin
  Result := (Left.Index = AOther.Left.Index) and
    (Right.Index = AOther.Right.Index) and (Top.Index = AOther.Top.Index) and
...
function TdxCellMargins.CreateBottomMargin(APieceTable: TdxCustomPieceTable)
  : TdxBottomMarginUnit;
begin
  Result := TdxBottomMarginUnit.Create(APieceTable, FOwner);
end;

function TdxCellMargins.CreateLeftMargin(APieceTable: TdxCustomPieceTable)
  : TdxLeftMarginUnit;
begin
  Result := TdxLeftMarginUnit.Create(APieceTable, FOwner);
end;

function TdxCellMargins.CreateRightMargin(APieceTable: TdxCustomPieceTable)
  : TdxRightMarginUnit;
begin
  Result := TdxRightMarginUnit.Create(APieceTable, FOwner);
end;

function TdxCellMargins.CreateTopMargin(APieceTable: TdxCustomPieceTable)
  : TdxTopMarginUnit;
begin
...
const
  BorderChangeActionsMap: array [TdxBorderChangeType]
...
function TdxBottomMarginUnit.TdxBottomPropertyAccessor.
  CellPropertiesMask: Integer;
begin
...
function TdxBottomMarginUnit.TdxBottomPropertyAccessor.GetValue
  (ACellMargins: TdxCellMargins): TdxMarginUnitBase;
begin
...
function TdxPreferredWidth.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := [TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetPrimaryLayout,
...
constructor TdxBorderInfoRepository.Create(AUnitConverter
...
procedure TdxBorderInfoRepository.AddItem(ALineStyle: TdxBorderLineStyle;
...
begin
  ...
  UnderlineTable[TdxBorderLineStyle.DashSmallGap] :=
    TdxUnderlineDashSmallGap.Create;
  ...
  UnderlineTable[TdxBorderLineStyle.DotDotDash] :=
    TdxUnderlineDashDotDotted.Create;
  ...
  UnderlineTable[TdxBorderLineStyle.DoubleWave] :=
    TdxUnderlineDoubleWave.Create;
end;
...
function TdxBorderInfoRepository.GetItemByLineStyle(AStyle: TdxBorderLineStyle)
  : TdxBorderInfo;
var
  AIndex: Integer;
begin
...
function TdxBorderInfoRepository.GetItemIndexByLineStyle
  (AStyle: TdxBorderLineStyle): Integer;
var
  I: Integer;
begin
...
class function TdxBorderInfoRepository.GetUnderlineByBorderLineStyle
  (AStyle: TdxBorderLineStyle): TdxUnderline;
begin
...
function TdxBorderLineRepository.GetCharacterLineByType
  (ALineStyle: TdxBorderLineStyle): TdxUnderline;
var
...
function TdxBorderLineRepository.GetUnderlineType
  (ALineStyle: TdxBorderLineStyle): TdxUnderlineClass;
begin
  MapBorderStyleToUnderlineTryGetValue(ALineStyle, Result);
end;

class function TdxBorderLineRepository.MapBorderStyleToUnderlineTryGetValue
  (ALineStyle: TdxBorderLineStyle;
