...
type
  ...
  public
    ...
    property ReusableChainLength: Integer read FReusableChainLength
      write FReusableChainLength;
  end;
  ...
  public
    ...
    function RegisterTextBoxFloatingObject
      (AContent: TdxTextBoxFloatingObjectContent;
      AShapeIdentifier: Integer): Integer;
    procedure AddTextBoxTableEntry(ACharacterPosition: Integer;
      AShapeIdentifier: Integer; AIsLastInChain: Boolean);
    procedure AddTextBoxPosition(APosition: Integer);
    procedure AddTextBoxReusableInfo(AShapeIdentifier: Integer;
      AIsLastInChain: Boolean);
    ...
    property TextBoxes: TDictionary<Integer, TdxTextBoxContentType>
      read FTextBoxes;
    property Positions: TdxIntegerList read FPositions;
    property TextBoxesIdentifiers: TdxObjectList<TdxFileTextBoxIdentifier>
      read FTextBoxesIdentifiers;
  ...
  public
    ...
    procedure ExportTextBoxesTables(AFib: TdxFileInformationBlock;
      AWriter: TBinaryWriter);
    function ShouldInsertEmptyParagraph: Boolean;
    procedure ExportMainDocumentTextBoxesTable(AFib: TdxFileInformationBlock;
      AWriter: TBinaryWriter);
    procedure ExportHeaderTextBoxesTable(AFib: TdxFileInformationBlock;
      AWriter: TBinaryWriter);
  ...
  protected
    procedure ExportFloatingObjectProperties(AFloatingObjectProperties
      : TdxFloatingObjectProperties; ACharacterPosition: Integer;
      AShapeIdentifier: Integer); virtual;
    procedure ExportFileShapeAddresses(AFib: TdxFileInformationBlock;
      AWriter: TBinaryWriter); virtual;
    procedure SetFileShapeAddressProperties(AFloatingObjectProperties
      : TdxFloatingObjectProperties; AAddress: TdxFileShapeAddress);
    procedure SetLocked(AFloatingObjectProperties: TdxFloatingObjectProperties;
      AAddress: TdxFileShapeAddress);
    procedure SetHorizontalPositionType(AFloatingObjectProperties
      : TdxFloatingObjectProperties; AAddress: TdxFileShapeAddress);
    procedure SetVerticalPositionType(AFloatingObjectProperties
      : TdxFloatingObjectProperties; AAddress: TdxFileShapeAddress);
    procedure SetTextWrapSide(AFloatingObjectProperties
      : TdxFloatingObjectProperties; AAddress: TdxFileShapeAddress);
    procedure SetTextWrapType(AFloatingObjectProperties
      : TdxFloatingObjectProperties; AAddress: TdxFileShapeAddress);
    procedure SetIsBehindText(AFloatingObjectProperties
      : TdxFloatingObjectProperties; AAddress: TdxFileShapeAddress);
    procedure SetLeft(AFloatingObjectProperties: TdxFloatingObjectProperties;
      AAddress: TdxFileShapeAddress);
    procedure SetRight(AFloatingObjectProperties: TdxFloatingObjectProperties;
      AAddress: TdxFileShapeAddress);
    procedure SetTop(AFloatingObjectProperties: TdxFloatingObjectProperties;
      AAddress: TdxFileShapeAddress);
    procedure SetBottom(AFloatingObjectProperties: TdxFloatingObjectProperties;
      AAddress: TdxFileShapeAddress);
    ...
    property MainDocumentAddresses: TdxFileShapeAddressTable
      read FMainDocumentAddresses;
  ...
  public
    ...
    destructor Destroy; override;
    function CreateShapeIdentifier(ARun: TdxFloatingObjectAnchorRun;
      ACharacterPosition: Integer): Integer;
  ...
  protected
    ...
    procedure ExportOfficeArtContent(AFib: TdxFileInformationBlock;
      AWriter: TBinaryWriter; AEmbeddedWriter: TBinaryWriter); virtual;
    procedure PrepareOfficeArtContentForExport;

    property State: TdxDocContentState read FState write SetState;
    property ShapeAddressesExporter: TdxFileShapeAddressesExporter
      read FShapeAddressesExporter;
  public
    constructor Create(AUnitConverter: TdxDocumentModelUnitConverter;
      APageBackColor: TdxAlphaColor);
    destructor Destroy; override;
    procedure RegisterFloatingObject(ARun: TdxFloatingObjectAnchorRun;
      ACharacterPosition: Integer);
    procedure RegisterFloatingObjectCore(ARun: TdxFloatingObjectAnchorRun;
      ACharacterPosition: Integer; AShapeIdentifier: Integer);
    procedure RegisterPictureFloatingObject(AImage: TdxOfficeImageReference;
      AShapeIdentifier: Integer; ARun: TdxFloatingObjectAnchorRun;
      AUnitConverter: TdxDocumentModelUnitConverter);
    procedure RegisterTextBoxFloatingObject
      (AContent: TdxTextBoxFloatingObjectContent; AShapeIdentifier: Integer;
  ...
  public
    constructor Create;
    destructor Destroy; override;
    procedure FinishFootNotePositions(ALastFootNoteEnd: Integer;
      ALastPosition: Integer);
    procedure FinishEndNotePositions(ALastEndNoteEnd: Integer);
    procedure AddFootNoteReferenceEntry(ACharacterPosition: Integer;
      AIsAutoNumbered: Boolean);
    procedure AddEndNoteReferenceEntry(ACharacterPosition: Integer;
      AIsAutoNumbered: Boolean);
    ...
    procedure ExportEndNoteTables(AFib: TdxFileInformationBlock;
      AWriter: TBinaryWriter);
    procedure ExportNoteReferences(AWriter: TBinaryWriter;
      AReferences: TdxIntegerList; AFlags: TBits);
    procedure ExportNotePositions(AWriter: TBinaryWriter;
  ...
  public
    ...
    function GetTableRowPropertyModifiers(ARow: TdxTableRow;
      ATableStyleIndex: Integer): TBytes;
  ...
  public
    ...
    procedure ExportFieldTables(AFib: TdxFileInformationBlock;
      AWriter: TBinaryWriter);
    procedure ExportMainDocumentFieldTable(AFib: TdxFileInformationBlock;
      AWriter: TBinaryWriter);
    procedure ExportHeadersFootersFieldTable(AFib: TdxFileInformationBlock;
      AWriter: TBinaryWriter);
    procedure ExportFootNotesFieldTable(AFib: TdxFileInformationBlock;
      AWriter: TBinaryWriter);
    procedure ExportCommentsFieldTable(AFib: TdxFileInformationBlock;
      AWriter: TBinaryWriter);
    procedure ExportEndNotesFieldTable(AFib: TdxFileInformationBlock;
      AWriter: TBinaryWriter);
    procedure ExportTextBoxesFieldTable(AFib: TdxFileInformationBlock;
      AWriter: TBinaryWriter);
    procedure ExportHeaderTextBoxesFieldTable(AFib: TdxFileInformationBlock;
      AWriter: TBinaryWriter);
  end;
  ...
  strict private
  const
    HeadingStyles: array [1 .. 9] of string = ('Heading 1', 'Heading 2',
  ...
  strict private
    ...
    function GetParagraphStyleInfoForExport(ASourceStyle: TdxParagraphStyle)
  ...
  public
    ...
    destructor Destroy; override;
    function GetParagraphStyleIndex(ADocumentModelParagraphIndex
      : Integer): Integer;
    function GetCharacterStyleIndex(ADocumentModelCharacterStyleIndex
      : Integer): Integer;
    function GetNumberingStyleIndex(ADocumentModelNumberingStyleIndex
      : Integer): Integer;
    function GetStyleIndexByName(const AStyleName: string): Integer;
    function GetFontIndexByName(const AFontName: string): Integer;
    function GetFontNameByIndex(AFontNameIndex: Integer): string;
    function GetCharacterGroupPropertyModifiers(AListLevel: TdxListLevel;
      ACharacterStyleIndex: Integer): TBytes; overload;
    function GetCharacterGroupPropertyModifiers(ARun: TdxTextRunBase;
      ASpecialSymbol: Boolean): TBytes; overload;
    function GetInlinePicturePropertyModifiers(ACharacterProperties
      : TdxCharacterProperties; ACharacterStyleIndex: Integer;
      ADataStreamOffset: Integer): TBytes;
    function GetParagraphGroupPropertyModifiers(AParagraph: TdxParagraph)
      : TBytes; overload;
    function GetParagraphGroupPropertyModifiers(AListLevel: TdxListLevel)
      : TBytes; overload;
    function GetTableParagraphPropertyModifiers(AParagraph: TdxParagraph;
      ATableDepth: Integer): TBytes;
    ...
    property StyleNamesCollection: TDictionary<string, Integer>
      read FStyleNamesCollection;
  ...
  public
    constructor Create(ADocumentModel: TdxDocumentModel;
      ...
      AStylesExportHelper: TdxDocStylesExporter);
    destructor Destroy; override;
    ...
    function CreateListInfo(AStylesExporter: TdxDocStylesExporter)
      : TdxDocListFormatInformation;
    function CreateDocListData(AList: TdxAbstractNumberingList): TdxDocListData;
    function CreateListFormatting(AList: TdxAbstractNumberingList)
      : TdxDocListFormatting;
    function CreateDocListLevel(AListLevel: TdxListLevel;
      AListLevelIndex: Integer): TdxDocListLevel;
    function CreateListLevelProperties(AListLevelProperties
      : TdxListLevelProperties; AListLevelIndex: Integer)
      : TdxDocListLevelProperties;
    function CreateListOverrideInfo: TdxDocListOverrideFormatInformation;
    function CreateDocListOverride(AList: TdxNumberingList;
      AOverrideLevelCount: Integer): TdxDocListOverrideFormat;
    function CreateDocListOverrideData(AList: TdxNumberingList)
      : TdxDocListOverrideLevelInformation;
    function CreateOverrideLevel(const AListLevel: IdxOverrideListLevel;
      ALevelIndex: Integer): TdxDocListOverrideLevelFormat;

    property ListStyles: TList<TdxListStylesRecordItem> read FListStyles;
    property ListOverrideInfo: TdxDocListOverrideFormatInformation
      read FListOverrideInfo;
  end;
  ...
  protected
    ...
    property SectionPropertiesWriter: TdxSectionPropertiesWriter
      read FSepxWriter;
  public
    constructor Create(ADataStreamWriter: TBinaryWriter;
      AOptions: TdxDocDocumentExporterOptions;
    ...
    procedure WriteParagraph(ACharacterPosition: Integer;
      AParagraphStyleIndex: Integer); overload;
    procedure WriteParagraph(ACharacterPosition: Integer;
      AParagraphStyleIndex: Integer; AParagraph: TdxParagraph); overload;
    procedure WriteInTableParagraph(ACharacterPosition: Integer;
      AParagraphStyleIndex: Integer; AParagraph: TdxParagraph);
    procedure WriteParagraph(ACharacterPosition: Integer;
      AParagraphStyleIndex: Integer; ARow: TdxTableRow); overload;
    procedure WriteTextRun(ACharacterPosition: Integer); overload;
    procedure WriteTextRun(ACharacterPosition: Integer;
      ATextRun: TdxTextRunBase; ASpecialSymbol: Boolean); overload;
    procedure WriteInlinePictureRun(ACharacterPosition, ACharacterStyleIndex,
      ADataStreamOffset: Integer; ACharacterProperties: TdxCharacterProperties);
    procedure Finish(ALastCharacterPosition: Integer);
    procedure ExportFieldTables(AFib: TdxFileInformationBlock;
      AWriter: TBinaryWriter);
    ...
    property PermissionIterator: TdxDocRangeEditPermissionIterator
      read FPermissionIterator;
    property FieldTable: TdxDocFieldTable read GetFieldTable;
    property NotesExporter: TdxDocNotesExporter read FNotesExporter;
    property FloatingObjectsExporter: TdxDocFloatingObjectsExporter
      read FFloatingObjectsExporter;
  end;
...
constructor TdxTextBoxReusableInfo.Create(ANextItem: Integer;
  AReusableChainLength: Integer);
begin
  FNextItem := ANextItem;
...
constructor TdxFileTextBoxIdentifier.Create(AShapeIdentifier: Integer;
  AIsLastInChain: Boolean);
begin
  FIsReusable := False;
...
function TdxTextBoxesExporterState.RegisterTextBoxFloatingObject
  (AContent: TdxTextBoxFloatingObjectContent;
  AShapeIdentifier: Integer): Integer;
begin
...
procedure TdxTextBoxesExporterState.AddTextBoxTableEntry(ACharacterPosition
  : Integer; AShapeIdentifier: Integer; AIsLastInChain: Boolean);
begin
...
procedure TdxTextBoxesExporterState.AddTextBoxReusableInfo(AShapeIdentifier
  : Integer; AIsLastInChain: Boolean);
begin
  TextBoxesIdentifiers.Add(TdxFileTextBoxIdentifier.Create(AShapeIdentifier,
    AIsLastInChain));
end;
...
procedure TdxTextBoxesExporterState.FinishState(ALastCharacterPosition
  : Integer);
begin
...
procedure TdxTextBoxesExporterState.FinishDocument(ALastCharacterPosition
  : Integer);
begin
...
begin
  ...
  else if AValue = TdxDocContentState.HeaderTextBoxes then
...
function TdxTextBoxesExporter.RegisterTextBoxFloatingObject
  (AContent: TdxTextBoxFloatingObjectContent;
  AShapeIdentifier: Integer): Integer;
var
...
begin
  ...
  else if State = TdxDocContentState.HeadersFootersStory then
  ...
  Result := AExporterState.RegisterTextBoxFloatingObject(AContent,
    AShapeIdentifier);
end;

procedure TdxTextBoxesExporter.AddTextBoxTableEntry(ACharacterPosition: Integer;
  AShapeIdentifier: Integer; AIsLastInChain: Boolean);
begin
  ActiveExporterState.AddTextBoxTableEntry(ACharacterPosition, AShapeIdentifier,
    AIsLastInChain);
end;

function TdxTextBoxesExporter.GetCurrentTextBoxes
  : TDictionary<Integer, TdxTextBoxContentType>;
begin
...
procedure TdxTextBoxesExporter.ExportTextBoxesTables
  (AFib: TdxFileInformationBlock; AWriter: TBinaryWriter);
begin
...
begin
  Result := (ActiveExporterState <> nil) and
    (ActiveExporterState.TextBoxes.Count > 0);
end;

procedure TdxTextBoxesExporter.ExportMainDocumentTextBoxesTable
  (AFib: TdxFileInformationBlock; AWriter: TBinaryWriter);
var
  ACount, I: Integer;
begin
  ...
  AFib.MainDocumentTextBoxesTextSize :=
    Integer((AWriter.BaseStream.Position -
    AFib.MainDocumentTextBoxesTextOffset));
  AFib.MainTextBoxBreakTableOffset := Integer(AWriter.BaseStream.Position);
  MainDocument.BreakDescriptors.Write(AWriter);
  AFib.MainTextBoxBreakTableSize :=
    Integer((AWriter.BaseStream.Position - AFib.MainTextBoxBreakTableOffset));
end;

procedure TdxTextBoxesExporter.ExportHeaderTextBoxesTable
  (AFib: TdxFileInformationBlock; AWriter: TBinaryWriter);
var
  ACount, I: Integer;
begin
  ...
  AFib.HeaderTextBoxesTextSize :=
    Integer((AWriter.BaseStream.Position - AFib.HeaderTextBoxesTextOffset));
  AFib.HeadersFootersTextBoxBreakTableOffset :=
    Integer(AWriter.BaseStream.Position);
  HeaderDocument.BreakDescriptors.Write(AWriter);
  AFib.HeadersFootersTextBoxBreakTableSize :=
    Integer((AWriter.BaseStream.Position -
    AFib.HeadersFootersTextBoxBreakTableOffset));
end;
...
constructor TdxFileShapeAddressesExporter.Create(AUnitConverter
...
function TdxFileShapeAddressesExporter.CreateShapeIdentifier
  (ARun: TdxFloatingObjectAnchorRun; ACharacterPosition: Integer): Integer;
begin
  Result := CalcShapeIdentifier;
  ExportFloatingObjectProperties(ARun.FloatingObjectProperties,
    ACharacterPosition, Result);
end;

procedure TdxFileShapeAddressesExporter.ExportFloatingObjectProperties
...
procedure TdxFileShapeAddressesExporter.ExportFileShapeAddresses
  (AFib: TdxFileInformationBlock; AWriter: TBinaryWriter);
begin
  if MainDocumentAddresses.AddressesCount > 0 then
  begin
    AFib.MainDocumentFileShapeTableOffset :=
      Integer(AWriter.BaseStream.Position);
    MainDocumentAddresses.Write(AWriter);
    AFib.MainDocumentFileShapeTableSize :=
      Integer((AWriter.BaseStream.Position -
      AFib.MainDocumentFileShapeTableOffset));
  end;
  if HeaderAddresses.AddressesCount > 0 then
  begin
    AFib.HeadersFootersFileShapeTableOffset :=
      Integer(AWriter.BaseStream.Position);
    HeaderAddresses.Write(AWriter);
    AFib.HeadersFootersFileShapeTableSize :=
      Integer((AWriter.BaseStream.Position -
      AFib.HeadersFootersFileShapeTableOffset));
  end;
end;

procedure TdxFileShapeAddressesExporter.SetFileShapeAddressProperties
  (AFloatingObjectProperties: TdxFloatingObjectProperties;
  AAddress: TdxFileShapeAddress);
begin
...
procedure TdxFileShapeAddressesExporter.SetLocked(AFloatingObjectProperties
  : TdxFloatingObjectProperties; AAddress: TdxFileShapeAddress);
begin
...
procedure TdxFileShapeAddressesExporter.SetHorizontalPositionType
  (AFloatingObjectProperties: TdxFloatingObjectProperties;
  AAddress: TdxFileShapeAddress);
begin
  if AFloatingObjectProperties.UseHorizontalPositionType then
    AAddress.HorisontalPositionType :=
      AFloatingObjectProperties.HorizontalPositionType;
end;

procedure TdxFileShapeAddressesExporter.SetVerticalPositionType
  (AFloatingObjectProperties: TdxFloatingObjectProperties;
  AAddress: TdxFileShapeAddress);
begin
  if AFloatingObjectProperties.UseVerticalPositionType then
    AAddress.VericalPositionType :=
      AFloatingObjectProperties.VerticalPositionType;
end;

procedure TdxFileShapeAddressesExporter.SetTextWrapSide
  (AFloatingObjectProperties: TdxFloatingObjectProperties;
  AAddress: TdxFileShapeAddress);
begin
...
procedure TdxFileShapeAddressesExporter.SetTextWrapType
  (AFloatingObjectProperties: TdxFloatingObjectProperties;
  AAddress: TdxFileShapeAddress);
begin
  if AFloatingObjectProperties.TextWrapType = TdxFloatingObjectTextWrapType.None
  then
    AAddress.TextWrapType := TdxDocFloatingObjectTextWrapTypeCalculator.
      WrapTypeBehindText
  else
    AAddress.TextWrapType := AFloatingObjectProperties.TextWrapType;
end;

procedure TdxFileShapeAddressesExporter.SetIsBehindText
  (AFloatingObjectProperties: TdxFloatingObjectProperties;
  AAddress: TdxFileShapeAddress);
begin
...
procedure TdxFileShapeAddressesExporter.SetLeft(AFloatingObjectProperties
  : TdxFloatingObjectProperties; AAddress: TdxFileShapeAddress);
begin
  AAddress.Left := UnitConverter.ModelUnitsToTwips
    (AFloatingObjectProperties.Offset.X);
end;

procedure TdxFileShapeAddressesExporter.SetRight(AFloatingObjectProperties
  : TdxFloatingObjectProperties; AAddress: TdxFileShapeAddress);
begin
  AAddress.Right := UnitConverter.ModelUnitsToTwips
    (AFloatingObjectProperties.Offset.X +
    AFloatingObjectProperties.ActualSize.cx);
end;

procedure TdxFileShapeAddressesExporter.SetTop(AFloatingObjectProperties
  : TdxFloatingObjectProperties; AAddress: TdxFileShapeAddress);
begin
  AAddress.Top := UnitConverter.ModelUnitsToTwips
    (AFloatingObjectProperties.Offset.Y);
end;

procedure TdxFileShapeAddressesExporter.SetBottom(AFloatingObjectProperties
  : TdxFloatingObjectProperties; AAddress: TdxFileShapeAddress);
begin
  AAddress.Bottom := UnitConverter.ModelUnitsToTwips
    (AFloatingObjectProperties.Offset.Y +
    AFloatingObjectProperties.ActualSize.cy);
end;
...
begin
  if State = TdxDocContentState.MainDocument then
    Result := TdxOfficeArtConstants.DefaultMainDocumentShapeIdentifier +
      MainDocumentAddresses.AddressesCount + 1
  else
    Result := TdxOfficeArtConstants.DefaultHeaderShapeIdentifier +
      HeaderAddresses.AddressesCount + 1;
end;

{ TdxDocFloatingObjectsExporter }

constructor TdxDocFloatingObjectsExporter.Create(AUnitConverter
  : TdxDocumentModelUnitConverter; APageBackColor: TdxAlphaColor);
begin
  FShapeAddressesExporter := TdxFileShapeAddressesExporter.Create
    (AUnitConverter);
...
procedure TdxDocFloatingObjectsExporter.RegisterFloatingObject
  (ARun: TdxFloatingObjectAnchorRun; ACharacterPosition: Integer);
var
  AShapeIdentifier: Integer;
begin
  AShapeIdentifier := ShapeAddressesExporter.CreateShapeIdentifier(ARun,
    ACharacterPosition);
  RegisterFloatingObjectCore(ARun, ACharacterPosition, AShapeIdentifier);
end;

procedure TdxDocFloatingObjectsExporter.RegisterFloatingObjectCore
  (ARun: TdxFloatingObjectAnchorRun; ACharacterPosition: Integer;
  AShapeIdentifier: Integer);
var
...
begin
  ...
  if APictureContent <> nil then
    RegisterPictureFloatingObject(APictureContent.Image, AShapeIdentifier, ARun,
      ShapeAddressesExporter.UnitConverter);
  ATextBoxContent := Safe<TdxTextBoxFloatingObjectContent>.Cast(ARun.Content);
  if ATextBoxContent <> nil then
    RegisterTextBoxFloatingObject(ATextBoxContent, AShapeIdentifier, ARun,
      ShapeAddressesExporter.UnitConverter);
end;

procedure TdxDocFloatingObjectsExporter.RegisterPictureFloatingObject
  (AImage: TdxOfficeImageReference; AShapeIdentifier: Integer;
  ARun: TdxFloatingObjectAnchorRun;
  AUnitConverter: TdxDocumentModelUnitConverter);
begin
  OfficeArtContent.InsertPictureFloatingObject(AImage, State, AShapeIdentifier,
    ARun, AUnitConverter);
end;

procedure TdxDocFloatingObjectsExporter.RegisterTextBoxFloatingObject
  (AContent: TdxTextBoxFloatingObjectContent; AShapeIdentifier: Integer;
  ARun: TdxFloatingObjectAnchorRun;
  AUnitConverter: TdxDocumentModelUnitConverter);
var
  ATextBoxId: Integer;
begin
  ATextBoxId := TextBoxesExporter.RegisterTextBoxFloatingObject(AContent,
    AShapeIdentifier);
  OfficeArtContent.InsertTextBoxFloatingObject(State, AShapeIdentifier,
    ATextBoxId, ARun, AUnitConverter);
end;

procedure TdxDocFloatingObjectsExporter.ExportFloatingObjectsInfo
  (AFib: TdxFileInformationBlock; AWriter: TBinaryWriter;
...
procedure TdxDocFloatingObjectsExporter.ExportOfficeArtContent
  (AFib: TdxFileInformationBlock; AWriter: TBinaryWriter;
  AEmbeddedWriter: TBinaryWriter);
begin
  ...
  AFib.DrawingObjectTableSize :=
    Integer((AWriter.BaseStream.Position - AFib.DrawingObjectTableOffset));
end;

procedure TdxDocFloatingObjectsExporter.PrepareOfficeArtContentForExport;
begin
  OfficeArtContent.DrawingContainer.FileDrawingBlock.HeaderFloatingObjectsCount
    := ShapeAddressesExporter.HeaderAddresses.AddressesCount;
  OfficeArtContent.DrawingContainer.FileDrawingBlock.
    MainDocumentFloatingObjectsCount :=
    ShapeAddressesExporter.MainDocumentAddresses.AddressesCount;
  OfficeArtContent.MainDocumentDrawing.DrawingObjectsContainer.
...
procedure TdxDocNotesExporter.FinishFootNotePositions(ALastFootNoteEnd: Integer;
  ALastPosition: Integer);
begin
...
procedure TdxDocNotesExporter.AddFootNoteReferenceEntry(ACharacterPosition
  : Integer; AIsAutoNumbered: Boolean);
begin
  FootNoteReferences.Add(ACharacterPosition);
  FFootNoteFlags[FFootNoteFlags.Size] := AIsAutoNumbered;
end;

procedure TdxDocNotesExporter.AddEndNoteReferenceEntry(ACharacterPosition
  : Integer; AIsAutoNumbered: Boolean);
begin
...
procedure TdxDocNotesExporter.FinishFootNoteReferences(ALastCharacterPosition
  : Integer);
begin
  FootNoteReferences.Add(ALastCharacterPosition);
end;

procedure TdxDocNotesExporter.FinishEndNoteReferences(ALastCharacterPosition
  : Integer);
begin
  EndNoteReferences.Add(ALastCharacterPosition);
end;

procedure TdxDocNotesExporter.ExportFootNoteTables
  (AFib: TdxFileInformationBlock; AWriter: TBinaryWriter);
begin
  ...
  AFib.FootNotesReferenceSize :=
    Integer((AWriter.BaseStream.Position - AFib.FootNotesReferenceOffset));
  AFib.FootNotesTextOffset := Integer(AWriter.BaseStream.Position);
  ExportNotePositions(AWriter, FootNotePositions);
  AFib.FootNotesTextSize :=
    Integer((AWriter.BaseStream.Position - AFib.FootNotesTextOffset));
end;

procedure TdxDocNotesExporter.ExportEndNoteTables(AFib: TdxFileInformationBlock;
  AWriter: TBinaryWriter);
begin
  ...
  AFib.EndNotesReferenceSize :=
    Integer((AWriter.BaseStream.Position - AFib.EndNotesReferenceOffset));
  AFib.EndnotesTextOffset := Integer(AWriter.BaseStream.Position);
  ExportNotePositions(AWriter, EndNotePositions);
  AFib.EndnotesTextSize :=
    Integer((AWriter.BaseStream.Position - AFib.EndnotesTextOffset));
end;

procedure TdxDocNotesExporter.ExportNoteReferences(AWriter: TBinaryWriter;
  AReferences: TdxIntegerList; AFlags: TBits);
var
  ACount, I: Integer;
begin
...
procedure TdxDocNotesExporter.ExportNotePositions(AWriter: TBinaryWriter;
  APositions: TdxIntegerList);
var
  ACount, I: Integer;
begin
...
begin
  ...
  AConverter := AInfo.Table.DocumentModel.UnitConverter.
    CreateConverterToLayoutUnits(TdxDocumentLayoutUnit.Twip);
  try
    ATableWidthsCalculator := TdxDocTableWidthsCalculator.Create(AConverter);
    try
      AGridCalculator := TdxTableGridCalculator.Create
        (ATableWidthsCalculator, MaxInt);
      try
        AParentSectionWidth := GetParentSectionWidthInModelUnits(AInfo.Table);
        Grids.Push(AGridCalculator.CalculateTableGrid(AInfo.Table,
          AParentSectionWidth));
      finally
...
function TdxDocTablesExporter.GetTableCellPropertyModifiers
  (AParagraph: TdxParagraph): TBytes;
var
...
begin
  ...
  try
    AParagraphActions := TdxDocParagraphPropertiesActions.Create(AOutput,
      AParagraph);
    try
      ...
      try
        ACellActions.CreateTableCellPropertyModifiers(TableDepth,
          (ACell <> nil) and (ACell.EndParagraphIndex = AParagraph.Index));
...
function TdxDocTablesExporter.GetTableRowPropertyModifiers(ARow: TdxTableRow;
  ATableStyleIndex: Integer): TBytes;
var
  AOutput: TdxMemoryStream;
...
function TdxDocTablesExporter.GetParentSectionWidthInModelUnits
  (ATable: TdxTable): Integer;
var
  ...
  AMargins: Integer;
begin
  APos := TdxDocumentModelPosition.FromParagraphStart(ATable.PieceTable,
    ATable.FirstRow.FirstCell.StartParagraphIndex);
...
procedure TdxDocFieldsExporter.ExportFieldTables(AFib: TdxFileInformationBlock;
  AWriter: TBinaryWriter);
begin
...
procedure TdxDocFieldsExporter.ExportMainDocumentFieldTable
  (AFib: TdxFileInformationBlock; AWriter: TBinaryWriter);
begin
  if FMainDocumentFieldTable <> nil then
  begin
    ...
    AFib.MainDocumentFieldTableSize :=
      Integer(AWriter.BaseStream.Position - AFib.MainDocumentFieldTableOffset);
  end;
end;

procedure TdxDocFieldsExporter.ExportHeadersFootersFieldTable
  (AFib: TdxFileInformationBlock; AWriter: TBinaryWriter);
begin
  if FHeadersFootersFieldTable <> nil then
  begin
    ...
    AFib.HeadersFootersFieldTableSize :=
      Integer(AWriter.BaseStream.Position -
      AFib.HeadersFootersFieldTableOffset);
  end;
end;

procedure TdxDocFieldsExporter.ExportFootNotesFieldTable
  (AFib: TdxFileInformationBlock; AWriter: TBinaryWriter);
begin
  if FFootNotesFieldTable <> nil then
  begin
    ...
    AFib.FootNotesFieldTableSize :=
      Integer(AWriter.BaseStream.Position - AFib.FootNotesFieldTableOffset);
  end;
end;

procedure TdxDocFieldsExporter.ExportCommentsFieldTable
  (AFib: TdxFileInformationBlock; AWriter: TBinaryWriter);
begin
  if FCommentsFieldTable <> nil then
  begin
    ...
    AFib.CommentsFieldTableSize :=
      Integer(AWriter.BaseStream.Position - AFib.CommentsFieldTableOffset);
  end;
end;

procedure TdxDocFieldsExporter.ExportEndNotesFieldTable
  (AFib: TdxFileInformationBlock; AWriter: TBinaryWriter);
begin
  if FEndNotesFieldTable <> nil then
  begin
    ...
    AFib.EndNotesFieldTableSize :=
      Integer((AWriter.BaseStream.Position - AFib.EndNotesFieldTableOffset));
  end;
end;

procedure TdxDocFieldsExporter.ExportTextBoxesFieldTable
  (AFib: TdxFileInformationBlock; AWriter: TBinaryWriter);
begin
  if FTextBoxesFieldTable <> nil then
  begin
    AFib.MainDocumentTextBoxesFieldTableOffset :=
      Integer(AWriter.BaseStream.Position);
    FTextBoxesFieldTable.Write(AWriter);
    AFib.MainDocumentTextBoxesFieldTableSize :=
      Integer(AWriter.BaseStream.Position -
      AFib.MainDocumentTextBoxesFieldTableOffset);
  end;
end;

procedure TdxDocFieldsExporter.ExportHeaderTextBoxesFieldTable
  (AFib: TdxFileInformationBlock; AWriter: TBinaryWriter);
begin
  if FHeaderTextBoxesFieldTable <> nil then
  begin
    AFib.HeaderTextBoxesFieldTableOffset :=
      Integer((AWriter.BaseStream.Position));
    FHeaderTextBoxesFieldTable.Write(AWriter);
    AFib.HeaderTextBoxesFieldTableSize :=
      Integer(AWriter.BaseStream.Position -
      AFib.HeaderTextBoxesFieldTableOffset);
  end;
end;
...
begin
  ...
  FDefaultFontIndex := GetFontIndexByName
    (TdxDocCharacterFormattingInfo.DefaultFontName);
end;
...
function TdxFontsExportHelper.GetFontIndexByName(const AFontName
  : string): Integer;
var
  ACount, I: Integer;
begin
...
function TdxDocStylesExporter.GetParagraphStyleInfoForExport
  (ASourceStyle: TdxParagraphStyle): TdxDocParagraphStyleInfo;
var
...
begin
  ...
  begin
    ASourceStyleFontNameIndex := FontsExportHelper.GetFontIndexByName
      (ASourceStyle.CharacterProperties.FontName);
    Exit(TdxDocParagraphStyleInfo.Create(ASourceStyle,
      ASourceStyleFontNameIndex));
  end;
  ...
  try
    ...
    try
      ...
      AFontNameIndex := FontsExportHelper.GetFontIndexByName
        (ACharacterProperties.Info.FontName);
      Result := TdxDocParagraphStyleInfo.Create(ACharacterProperties.Info,
        ACharacterProperties.Options, AParagraphProperties.Info,
        AParagraphProperties.Options, ASourceStyle.Tabs.Info,
        ASourceStyle.GetNumberingListIndex, ASourceStyle.GetListLevelIndex,
        AFontNameIndex, ADocumentModel);
    finally
...
function TdxDocStylesExporter.GetParagraphStyleIndex
  (ADocumentModelParagraphIndex: Integer): Integer;
begin
  if not StyleNamesCollection.TryGetValue(DocumentModel.ParagraphStyles
    [ADocumentModelParagraphIndex].StyleName, Result) then
    Result := 0;
end;

function TdxDocStylesExporter.GetCharacterStyleIndex
  (ADocumentModelCharacterStyleIndex: Integer): Integer;
begin
  if not StyleNamesCollection.TryGetValue(DocumentModel.CharacterStyles
    [ADocumentModelCharacterStyleIndex].StyleName, Result) then
    Result := TdxDocStyleIndexes.DefaultCharacterStyleIndex;
end;

function TdxDocStylesExporter.GetNumberingStyleIndex
  (ADocumentModelNumberingStyleIndex: Integer): Integer;
begin
  if not StyleNamesCollection.TryGetValue(DocumentModel.NumberingListStyles
    [ADocumentModelNumberingStyleIndex].StyleName, Result) then
    Result := -1;
end;

function TdxDocStylesExporter.GetStyleIndexByName(const AStyleName
  : string): Integer;
begin
...
function TdxDocStylesExporter.GetFontIndexByName(const AFontName
  : string): Integer;
begin
  Result := FontsExportHelper.GetFontIndexByName(AFontName);
end;

function TdxDocStylesExporter.GetFontNameByIndex(AFontNameIndex
  : Integer): string;
begin
  Result := FontsExportHelper.GetFontNameByIndex(AFontNameIndex);
end;

function TdxDocStylesExporter.GetCharacterGroupPropertyModifiers
  (AListLevel: TdxListLevel; ACharacterStyleIndex: Integer): TBytes;
var
...
begin
  ...
  AOutput := TdxMemoryStream.Create;
  try
    AActions := TdxDocListCharacterPropertiesActions.Create(AOutput, AListLevel,
      AFontNameIndex);
    try
      AActions.CreateCharacterPropertiesModifiers(ACharacterStyleIndex,
        TdxDocStyleIndexes.DefaultParagraphStyleIndex, False);
      Result := AOutput.ToArray;
    finally
      AActions.Free;
    end;
...
function TdxDocStylesExporter.GetCharacterGroupPropertyModifiers
  (ARun: TdxTextRunBase; ASpecialSymbol: Boolean): TBytes;
var
...
begin
  ...
  if ARun <> nil then
    ...
    AFontNameIndex := GetFontIndexByName
      (TdxDocCharacterFormattingInfo.DefaultFontName);
  AOutput := TdxMemoryStream.Create;
  try
    if ARun <> nil then
    ...
    if ARun <> nil then
      AParagraphStyleIndex := GetParagraphStyleIndex
        (ARun.Paragraph.ParagraphStyleIndex)
    else
      AParagraphStyleIndex := TdxDocStyleIndexes.DefaultParagraphStyleIndex;
    AActions := TdxDocCharacterPropertiesActions.Create(AOutput,
      ACharacterProperties, AFontNameIndex);
    try
      AActions.CreateCharacterPropertiesModifiers(ACharacterStyleIndex,
        AParagraphStyleIndex, ASpecialSymbol);
      Result := AOutput.ToArray;
    finally
      AActions.Free;
    end;
...
function TdxDocStylesExporter.GetInlinePicturePropertyModifiers
  (ACharacterProperties: TdxCharacterProperties; ACharacterStyleIndex: Integer;
  ADataStreamOffset: Integer): TBytes;
var
  AFontNameIndex: Integer;
  AOutput: TdxMemoryStream;
...
begin
  ...
  try
    AActions := TdxDocCharacterPropertiesActions.Create(AOutput,
      ACharacterProperties, AFontNameIndex);
    try
      AActions.CreateInlinePicturePropertiesModifiers(ACharacterStyleIndex,
        ADataStreamOffset);
      Result := AOutput.ToArray;
    finally
      AActions.Free;
...
function TdxDocStylesExporter.GetParagraphGroupPropertyModifiers
  (AParagraph: TdxParagraph): TBytes;
var
  AOutput: TdxMemoryStream;
...
function TdxDocStylesExporter.GetParagraphGroupPropertyModifiers
  (AListLevel: TdxListLevel): TBytes;
var
  AOutput: TdxMemoryStream;
  AActions: TdxDocParagraphPropertiesActions;
begin
...
function TdxDocStylesExporter.GetTableParagraphPropertyModifiers
  (AParagraph: TdxParagraph; ATableDepth: Integer): TBytes;
var
  AOutput: TdxMemoryStream;
  AActions: TdxDocParagraphPropertiesActions;
begin
...
begin
  ...
  FStyleSheet.StylesInformation.StylesCount :=
    SmallInt(FStyleSheet.Styles.Count);
end;
...
procedure TdxDocStylesExporter.SetStyleSheetInformation
  (AStyleSheet: TdxDocStyleSheet);
begin
  if FDocumentModel.DefaultCharacterProperties.UseFontName then
    AStyleSheet.StylesInformation.DefaultASCIIFont :=
      SmallInt(FontsExportHelper.GetFontIndexByName
...
procedure TdxDocStylesExporter.AddDefaultParagraphStyle
  (AStyleSheet: TdxDocStyleSheet);
var
...
begin
  ADefaultParagraphStyle := TdxParagraphStyle
    (DocumentModel.ParagraphStyles.GetStyleByName(DefaultParagraphStyleName));
  ...
  try
    ADefaultParagraphStyleDescription := TdxParagraphStyleDescription.Create
      (AParagraphStyleInfo);
    ADefaultParagraphStyleDescription.StyleIdentifier :=
      DefaultParagraphStyleIdentifier;
    ADefaultParagraphStyleDescription.StyleName :=
      ADefaultParagraphStyle.StyleName;
...
begin
  ...
  begin
    ...
    AHeading := TdxParagraphStyle(DocumentModel.ParagraphStyles.GetStyleByName
      (AHeadingStyleName));
    if AHeading <> nil then
    begin
      AParagraphStyleInfo := GetParagraphStyleInfoForExport(AHeading);
      try
        AHeadingStyleDescription := TdxParagraphStyleDescription.Create
          (AParagraphStyleInfo);
        AHeadingStyleDescription.StyleIdentifier := $0001;
        AHeadingStyleDescription.StyleName := AHeadingStyleName;
        AHeadingStyleDescription.BaseStyleIndex :=
          DefaultParagraphStyleIdentifier;
        AHeadingStyleDescription.NextStyleIndex :=
          DefaultParagraphStyleIdentifier;
...
procedure TdxDocStylesExporter.AddDefaultCharacterStyle
  (AStyleSheet: TdxDocStyleSheet);
var
...
begin
  ADefaultCharacterStyle := TdxCharacterStyle
    (DocumentModel.CharacterStyles.GetStyleByName(DefaultCharacterStyleName));
  AFontNameIndex := FontsExportHelper.GetFontIndexByName
    (ADefaultCharacterStyle.CharacterProperties.FontName);
  ADefaultCharacterStyleDescription := TdxCharacterStyleDescription.Create
    (ADefaultCharacterStyle, AStyleSheet.Styles.Count, AFontNameIndex);
  ADefaultCharacterStyleDescription.StyleIdentifier :=
    DefaultCharacterStyleIdentifier;
  ...
  StyleNamesCollection.Add(DefaultCharacterStyleName,
    TdxDocStyleIndexes.DefaultCharacterStyleIndex);
end;

procedure TdxDocStylesExporter.AddDefaultTableStyle
  (AStyleSheet: TdxDocStyleSheet);
var
...
begin
  ADefaultTableStyle := TdxTableStyle(DocumentModel.TableStyles.GetStyleByName
    (DefaultTableStyleName));
  if ADefaultTableStyle <> nil then
  begin
    AFontNameIndex := FontsExportHelper.GetFontIndexByName
      (ADefaultTableStyle.CharacterProperties.FontName);
    ADefaultTableStyleDescription := TdxTableStyleDescription.Create
      (ADefaultTableStyle, AFontNameIndex);
    ADefaultTableStyleDescription.StyleIdentifier :=
      DefaultTableStyleIdentifier;
    ADefaultTableStyleDescription.StyleName := DefaultTableStyleName;
    ADefaultTableStyleDescription.StyleIndex :=
      TdxDocStyleIndexes.DefaultTableStyleIndex;
    StyleNamesCollection.Add(DefaultTableStyleName,
      TdxDocStyleIndexes.DefaultTableStyleIndex);
...
procedure TdxDocStylesExporter.AddDefaultListStyle
  (AStyleSheet: TdxDocStyleSheet);
var
...
begin
  ...
  ADefaultListStyleDescription.StyleIndex :=
    TdxDocStyleIndexes.DefaultListStyleIndex;
  StyleNamesCollection.Add(DefaultListStyleName,
    TdxDocStyleIndexes.DefaultListStyleIndex);
  AStyleSheet.Styles.Add(ADefaultListStyleDescription);
end;

procedure TdxDocStylesExporter.AddParagraphStyles
  (AStyleSheet: TdxDocStyleSheet);
var
...
begin
  ...
  begin
    ...
    begin
      ...
      try
        AStyleDescription := TdxParagraphStyleDescription.Create
          (AParagraphStyleInfo);
        ...
        if ACurrentStyle.LinkedStyle <> nil then
          AStyleDescription.LinkedStyleIndex :=
            SmallInt(GetStyleIndexByName(ACurrentStyle.LinkedStyle.StyleName));
        if ACurrentStyle.Parent <> nil then
          AStyleDescription.BaseStyleIndex :=
            SmallInt(GetStyleIndexByName(ACurrentStyle.Parent.StyleName));
        StyleNamesCollection.Add(AStyleDescription.StyleName,
          AStyleDescription.StyleIndex);
...
begin
  ...
  begin
    ...
    begin
      AStyle := TdxParagraphStyle(DocumentModel.ParagraphStyles.GetStyleByName
        (ADescription.StyleName));
      if AStyle.NextParagraphStyle <> nil then
        ADescription.NextStyleIndex :=
          SmallInt(GetStyleIndexByName(AStyle.NextParagraphStyle.StyleName));
    end;
  end;
end;

procedure TdxDocStylesExporter.AddCharacterStyles
  (AStyleSheet: TdxDocStyleSheet);
var
...
begin
  ...
  begin
    ...
    begin
      AFontNameIndex := GetFontIndexByName
        (ACurrentStyle.CharacterProperties.FontName);
      AStyleDescription := TdxCharacterStyleDescription.Create(ACurrentStyle,
        AStyleSheet.Styles.Count, AFontNameIndex);
      AStyleDescription.StyleName := ACurrentStyle.StyleName;
      AStyleDescription.Hidden := ACurrentStyle.Hidden;
      AStyleDescription.QFormat := ACurrentStyle.Primary;
      AStyleDescription.StyleIndex := AStyleSheet.Styles.Count;
      ...
      if ACurrentStyle.LinkedStyle <> nil then
        AStyleDescription.LinkedStyleIndex :=
          SmallInt(GetStyleIndexByName(ACurrentStyle.LinkedStyle.StyleName));
      AStyleDescription.NextStyleIndex :=
        SmallInt(AStyleDescription.StyleIndex);
      StyleNamesCollection.Add(AStyleDescription.StyleName,
        AStyleDescription.StyleIndex);
...
begin
  ...
  begin
    ...
    begin
      AFontNameIndex := GetFontIndexByName
        (ACurrentStyle.CharacterProperties.FontName);
      AStyleDescription := TdxTableStyleDescription.Create(ACurrentStyle,
        AFontNameIndex);
      AStyleDescription.StyleName := ACurrentStyle.StyleName;
      AStyleDescription.Hidden := ACurrentStyle.Hidden;
      AStyleDescription.QFormat := ACurrentStyle.Primary;
...
constructor TdxDocListsExporter.Create(ADocumentModel: TdxDocumentModel;
  AOptions: TdxDocDocumentExporterOptions;
  AStylesExportHelper: TdxDocStylesExporter);
begin
...
procedure TdxDocListsExporter.WriteListFormatInformation
  (AWriter: TBinaryWriter);
begin
  FListInfo.Write(AWriter);
end;

procedure TdxDocListsExporter.WriteListOverrideFormatInformation
  (AWriter: TBinaryWriter);
begin
  FListOverrideInfo.Write(AWriter,
    Options.Compatibility.AllowNonLinkedListDefinitions);
end;

procedure TdxDocListsExporter.CreateLists(AStylesExporter
  : TdxDocStylesExporter);
begin
...
type
  ...
  public
    constructor Create(ADocumentModel: TdxDocumentModel);
    function Compare(const Left, Right: TdxAbstractNumberingListIndex)
      : Integer; override;
  end;
...
function TListComparer.Compare(const Left,
  Right: TdxAbstractNumberingListIndex): Integer;
begin
  Result := FDocumentModel.AbstractNumberingLists[Left].Id -
    FDocumentModel.AbstractNumberingLists[Right].Id;
end;

function TdxDocListsExporter.CreateListInfo(AStylesExporter
  : TdxDocStylesExporter): TdxDocListFormatInformation;
var
...
begin
  ...
  begin
    ...
    begin
      ADocStyleIndex := AStylesExporter.GetNumberingStyleIndex
        (AList.StyleLinkIndex);
      if ADocStyleIndex >= 0 then
        FListStyles.Add(TdxListStylesRecordItem.Create(I,
          ADocStyleIndex, True));
    end
    else if AList.NumberingStyleReferenceIndex >= 0 then
    begin
      ADocStyleIndex := AStylesExporter.GetNumberingStyleIndex
        (AList.NumberingStyleReferenceIndex);
      if ADocStyleIndex >= 0 then
        FListStyles.Add(TdxListStylesRecordItem.Create(I,
          ADocStyleIndex, False));
    end;
  end;
end;

function TdxDocListsExporter.CreateDocListData(AList: TdxAbstractNumberingList)
  : TdxDocListData;
var
  I: Integer;
begin
  ...
  for I := 0 to TdxDocListFormatting.MaxLevelCount - 1 do
    Result.LevelsFormatting.Add
      (CreateDocListLevel(TdxListLevel(AList.Levels[I]), I));
end;

function TdxDocListsExporter.CreateListFormatting
  (AList: TdxAbstractNumberingList): TdxDocListFormatting;
var
  I: Integer;
begin
  Result := TdxDocListFormatting.Create;
  Result.ListIdentifier := AList.Id;
  if (AList.StyleLinkIndex >= 0) or (AList.NumberingStyleReferenceIndex >= 0)
  then
  ...
  for I := 0 to TdxDocListFormatting.MaxLevelCount - 1 do
    if AList.Levels[I].ParagraphStyle = nil then
      ...
      Result.LevelStyleIdentifiers[I] :=
        SmallInt(StylesExportHelper.GetParagraphStyleIndex
        (TdxListLevel(AList.Levels[I]).ParagraphStyleIndex));
end;

function TdxDocListsExporter.CreateDocListLevel(AListLevel: TdxListLevel;
  AListLevelIndex: Integer): TdxDocListLevel;
begin
  Result := TdxDocListLevel.Create;
  Result.ListLevelProperties := CreateListLevelProperties
    (AListLevel.ListLevelProperties, AListLevelIndex);
  Result.CharacterUPX := StylesExportHelper.GetCharacterGroupPropertyModifiers
    (AListLevel, TdxDocStyleIndexes.DefaultCharacterStyleIndex);
  Result.ListLevelProperties.CharacterUPXSize :=
    Byte(Length(Result.CharacterUPX));
  Result.ParagraphUPX := StylesExportHelper.GetParagraphGroupPropertyModifiers
    (AListLevel);
  Result.ListLevelProperties.ParagraphUPXSize :=
    Byte(Length(Result.ParagraphUPX));
  Result.SetDisplayFormatString
    (AListLevel.ListLevelProperties.DisplayFormatString);
end;

function TdxDocListsExporter.CreateListLevelProperties(AListLevelProperties
  : TdxListLevelProperties; AListLevelIndex: Integer)
  : TdxDocListLevelProperties;
begin
  Result := TdxDocListLevelProperties.Create;
  Result.Alignment := AListLevelProperties.Alignment;
  Result.ConvertPreviousLevelNumberingToDecimal :=
    AListLevelProperties.ConvertPreviousLevelNumberingToDecimal;
  ...
  else if AListLevelProperties.RelativeRestartLevel <> 0 then
  begin
    Result.RestartLevelLimit :=
      Byte(Max(0, AListLevelIndex - AListLevelProperties.RelativeRestartLevel));
    Result.RestartAfterLevelLimit := True;
  end;
...
function TdxDocListsExporter.CreateListOverrideInfo
...
begin
  ...
  begin
    ...
    Result.FormatOverride.Add(CreateDocListOverride(AList,
      ADocListOverrideData.LevelFormatOverrideData.Count));
  end;
end;

function TdxDocListsExporter.CreateDocListOverride(AList: TdxNumberingList;
  AOverrideLevelCount: Integer): TdxDocListOverrideFormat;
begin
...
function TdxDocListsExporter.CreateDocListOverrideData(AList: TdxNumberingList)
  : TdxDocListOverrideLevelInformation;
var
  ACount, I: Integer;
...
begin
  ...
  for I := 0 to ACount - 1 do
  begin
    AOverriddenLevel := CreateOverrideLevel
      (AList.Levels[I] as IdxOverrideListLevel, I);
    if AOverriddenLevel <> nil then
      Result.LevelFormatOverrideData.Add(AOverriddenLevel);
  end;
end;

function TdxDocListsExporter.CreateOverrideLevel(const AListLevel
  : IdxOverrideListLevel; ALevelIndex: Integer): TdxDocListOverrideLevelFormat;
var
...
begin
  ...
  begin
    ...
    ALevelFormat.OverrideLevelFormatting :=
      CreateDocListLevel(AOverrideListLevel, ALevelIndex);
  end;
...
constructor TdxDocDataWriter.Create(ADataStreamWriter: TBinaryWriter;
  AOptions: TdxDocDocumentExporterOptions; ADocumentModel: TdxDocumentModel);
begin
  ...
  FFkpWriter := TdxFKPWriter.Create(TdxFileInformationBlock.FIBSize,
    FFkpMemoryStream, ADataStreamWriter);
  ...
  FListsExporter := TdxDocListsExporter.Create(ADocumentModel, AOptions,
    FStylesExporter);
  ...
  FFloatingObjectsExporter := TdxDocFloatingObjectsExporter.Create
    (ADocumentModel.UnitConverter,
    ADocumentModel.DocumentProperties.PageBackColor);
...
procedure TdxDocDataWriter.WriteSection(ACharacterPosition: Integer;
  ASection: TdxSection);
begin
...
procedure TdxDocDataWriter.WriteParagraph(ACharacterPosition: Integer;
  AParagraphStyleIndex: Integer);
begin
  FormattedDiskPageWriter.WriteParagraph(ACharacterPosition,
    AParagraphStyleIndex);
end;
...
begin
  if TablesExporter.InTable then
    AGrpprl := StylesExporter.GetTableParagraphPropertyModifiers(AParagraph,
      TablesExporter.TableDepth)
  else
    AGrpprl := StylesExporter.GetParagraphGroupPropertyModifiers(AParagraph);
  FormattedDiskPageWriter.WriteParagraph(ACharacterPosition,
    AParagraphStyleIndex, AGrpprl);
end;

procedure TdxDocDataWriter.WriteInTableParagraph(ACharacterPosition: Integer;
  AParagraphStyleIndex: Integer; AParagraph: TdxParagraph);
var
  AGrpprl: TBytes;
begin
...
procedure TdxDocDataWriter.WriteParagraph(ACharacterPosition: Integer;
  AParagraphStyleIndex: Integer; ARow: TdxTableRow);
var
  ATableStyleIndex: Integer;
  AGrpprl: TBytes;
begin
  ATableStyleIndex := StylesExporter.GetStyleIndexByName
    (ARow.Table.TableStyle.StyleName);
  AGrpprl := TablesExporter.GetTableRowPropertyModifiers(ARow,
    ATableStyleIndex);
  FormattedDiskPageWriter.WriteTableProperties(ACharacterPosition,
    AParagraphStyleIndex, AGrpprl);
end;
...
procedure TdxDocDataWriter.WriteTextRun(ACharacterPosition: Integer;
  ATextRun: TdxTextRunBase; ASpecialSymbol: Boolean);
var
  AGrpprl: TBytes;
begin
  AGrpprl := StylesExporter.GetCharacterGroupPropertyModifiers(ATextRun,
    ASpecialSymbol);
  FormattedDiskPageWriter.WriteTextRun(ACharacterPosition, AGrpprl);
end;

procedure TdxDocDataWriter.WriteInlinePictureRun(ACharacterPosition,
  ACharacterStyleIndex, ADataStreamOffset: Integer;
  ACharacterProperties: TdxCharacterProperties);
var
  AGrpprl: TBytes;
begin
  AGrpprl := StylesExporter.GetInlinePicturePropertyModifiers
    (ACharacterProperties, ACharacterStyleIndex, ADataStreamOffset);
  FormattedDiskPageWriter.WriteTextRun(ACharacterPosition, AGrpprl);
end;
...
procedure TdxDocDataWriter.ExportFieldTables(AFib: TdxFileInformationBlock;
  AWriter: TBinaryWriter);
begin
