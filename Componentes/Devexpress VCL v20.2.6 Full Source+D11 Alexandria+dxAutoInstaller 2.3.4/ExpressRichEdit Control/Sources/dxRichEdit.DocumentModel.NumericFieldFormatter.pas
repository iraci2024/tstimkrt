...
type
  ...
  TdxNumberFormatParserState = (Start, IntegerPart, FractionPart,
    EmbedText, Finish);

  TdxDigitProcessResult = (Success, Skip, &End);

  IdxNumberFormatParserStateBase = interface
    function GetType: TdxNumberFormatParserState;
    procedure ProcessChar(AIndex: Integer;
      AFormatInfo: TdxNumberFieldFormatInfo);
  ...
  TdxNumberFormatRangeType = (None, Text, Sign, StartNumberMask, NumberMask,
    DecimalSeparator, GroupSeparator, Terminator);
  ...
  public
    ...
    constructor Create(AIndex: Integer;
      AType: TdxNumberFormatRangeType); overload;
  ...
  protected
    function InternalFormat(const AValue: Double; const AFormat: string)
      : string; override;
    ...
    procedure EndFormat;
    procedure PopulateNumberFormatInfo(AFormatInfo
      : TdxNumberFieldFormatInfo); virtual;
    ...
    procedure FormatIntegerPart(ANumber: Double; APattern: TdxNumberPattern;
      AResult: TStringBuilder); virtual;
    procedure FormatIntegerPartCore(ANumber: Double;
      AIterator: TdxFormatRangeIterator; AResult: TStringBuilder);
    procedure FormatFractionalPart(ANumber: Double; APattern: TdxNumberPattern;
      AResult: TStringBuilder); virtual;
    procedure FormatFractionalPartCore(ANumber: Double; AResult: TStringBuilder;
      AIterator: TdxFormatRangeIterator);
    procedure FormatNumberPart(AIterator: TdxFormatRangeIterator;
      const ANumberString: string; AResult: TStringBuilder);

    property Number: Double read FNumber write FNumber;
    property NumberFormatInfo: TdxNumberFieldFormatInfo read FFormatInfo
      write FFormatInfo;
  ...
  public
    constructor Create(const AFormatString: string;
      const AFormatInfo: TdxNumberFormatInfo);
    destructor Destroy; override;
    function GetPattern(AValue: Double): TdxNumberPattern;

    procedure AddToRange(ACharIndex: Integer;
      ARangeType: TdxNumberFormatRangeType);
  ...
  TdxNumberFormatterStateBase = class abstract(TInterfacedObject,
    IdxNumberFormatterStateBase)
  strict private
    FFormatter: TdxNumericFieldFormatter;
    function GetNumber: Double;
  protected
    function GetCanChangeState: Boolean; virtual; abstract;
    procedure AppendResult(const AStr: string; AResultString: TStringBuilder);
      overload; virtual; abstract;
    procedure AppendResult(ACh: Char; AResultString: TStringBuilder); overload;
      virtual; abstract;
    procedure AppendResult(ARange: TdxNumberFormatRange;
      AResultString: TStringBuilder); overload; virtual;
  ...
  TdxNumberPatternType = (Positive, Negative, Zero);
  ...
  protected
    ...
    property CurrentCharacterIndex: Integer read FCurrentCharacterIndex
      write FCurrentRangeIndex;
    property CurrentRangeIndex: Integer read FCurrentRangeIndex
      write FCurrentRangeIndex;
  public
    constructor Create(APattern: TdxNumberPattern; ARangeIndex: Integer;
  ...
  public
    ...
    procedure ChangeState(const AState
      : IdxNumberFormatParserStateBase); overload;
    procedure ChangeState(AType: TdxNumberFormatParserState); overload;
  end;

  { TdxNumberFormatParserStateBase }

  TdxNumberFormatParserStateBase = class abstract(TInterfacedObject,
    IdxNumberFormatParserStateBase)
  strict private
  ...
  public
    ...
    procedure ProcessChar(AIndex: Integer;
      AFormatInfo: TdxNumberFieldFormatInfo); virtual; abstract;
...
type
  ...
  protected
    function ProcessCharStateSpecific(AIndex: Integer;
      AFormatInfo: TdxNumberFieldFormatInfo): Boolean; virtual; abstract;
    procedure ProcessCharStateCommon(AIndex: Integer;
      AFormatInfo: TdxNumberFieldFormatInfo);
    procedure ProcessDoubleQuotesChar(AIndex: Integer;
      AFormatInfo: TdxNumberFieldFormatInfo);
    procedure ProcessBackslashChar(AIndex: Integer;
      AFormatInfo: TdxNumberFieldFormatInfo);
    function IsDecimalSeparator(ACh: Char;
      AFormatInfo: TdxNumberFieldFormatInfo): Boolean;
    function IsGroupSeparator(ACh: Char;
      AFormatInfo: TdxNumberFieldFormatInfo): Boolean;
  public
    procedure ProcessChar(AIndex: Integer;
      AFormatInfo: TdxNumberFieldFormatInfo); override;
  end;
  ...
  protected
    ...
    function ProcessCharStateSpecific(AIndex: Integer;
      AFormatInfo: TdxNumberFieldFormatInfo): Boolean; override;
  end;
  ...
  protected
    function GetType: TdxNumberFormatParserState; override;
  public
    constructor Create(ACalculator: TdxNumberFormatParser;
      const APrevState: IdxNumberFormatParserStateBase); reintroduce;
    procedure ProcessChar(AIndex: Integer;
      AFormatInfo: TdxNumberFieldFormatInfo); override;
  end;
  ...
  protected
    procedure AppendResult(const AStr: string;
      AResultString: TStringBuilder); override;
    procedure AppendResult(ACh: Char; AResultString: TStringBuilder); override;
    procedure AppendSignIfNeeded(APattern: TdxNumberPattern;
      AResultString: TStringBuilder); virtual;
    procedure AppendGroupSeparator(ADigitCount: Integer;
      AResultString: TStringBuilder); virtual;
  ...
  protected
    ...
    procedure AppendRemainedDigits(AIndex: Integer; const ANumber: string;
      ASeparateGroups: Boolean; AResult: TStringBuilder); virtual;
    procedure AppendCurrentDigit(AIndex: Integer; const ANumber: string;
      ASeparateGroups: Boolean; AResult: TStringBuilder); virtual;
  public
    function FormatNextDigit(AIterator: TdxFormatRangeIterator; AIndex: Integer;
      const ANumber: string; AResult: TStringBuilder)
      : TdxDigitProcessResult; override;
...
procedure TdxNumberFormatParser.ChangeState(const AState
  : IdxNumberFormatParserStateBase);
begin
  FState := AState;
end;
...
constructor TdxNumberFormatParserStateBase.Create
  (AFormatter: TdxNumberFormatParser);
begin
  inherited Create;
...
procedure TdxNumberFormatParserStateBase.ChangeState(const AState
  : IdxNumberFormatParserStateBase);
begin
  Calculator.ChangeState(AState);
end;

procedure TdxNumberFormatParserStateBase.ChangeState
  (AType: TdxNumberFormatParserState);
begin
...
procedure TdxNumberPatternStateBase.ProcessChar(AIndex: Integer;
  AFormatInfo: TdxNumberFieldFormatInfo);
begin
...
procedure TdxNumberPatternStateBase.ProcessCharStateCommon(AIndex: Integer;
  AFormatInfo: TdxNumberFieldFormatInfo);
var
  ACh: Char;
begin
...
procedure TdxNumberPatternStateBase.ProcessDoubleQuotesChar(AIndex: Integer;
  AFormatInfo: TdxNumberFieldFormatInfo);
var
  APrevCharIndex: Integer;
begin
  APrevCharIndex := AIndex - 1;
  if (APrevCharIndex >= 0) and (AFormatInfo.FormatString[APrevCharIndex] = '\')
  then
  begin
    AFormatInfo.ResetRangeMerging;
    AFormatInfo.AddToRange(AIndex, TdxNumberFormatRangeType.Text);
...
procedure TdxNumberPatternStateBase.ProcessBackslashChar(AIndex: Integer;
  AFormatInfo: TdxNumberFieldFormatInfo);
var
  APrevCharIndex: Integer;
begin
  APrevCharIndex := AIndex;
  while (APrevCharIndex >= 0) and
    (AFormatInfo.FormatString[APrevCharIndex] = '\') do
    Dec(APrevCharIndex);
...
function TdxNumberPatternStateBase.IsDecimalSeparator(ACh: Char;
  AFormatInfo: TdxNumberFieldFormatInfo): Boolean;
begin
  Result := ACh = '.';
end;

function TdxNumberPatternStateBase.IsGroupSeparator(ACh: Char;
  AFormatInfo: TdxNumberFieldFormatInfo): Boolean;
begin
  Result := ACh = ',';
end;
...
function TdxStartPatternState.ProcessCharStateSpecific(AIndex: Integer;
  AFormatInfo: TdxNumberFieldFormatInfo): Boolean;
var
  ACh: Char;
begin
...
function TdxNumberMaskStateBase.ProcessCharStateSpecific(AIndex: Integer;
  AFormatInfo: TdxNumberFieldFormatInfo): Boolean;
var
  ACh: Char;
begin
...
function TdxIntegerPartState.ProcessCharStateSpecific(AIndex: Integer;
  AFormatInfo: TdxNumberFieldFormatInfo): Boolean;
begin
...
constructor TdxEmbedTextState.Create(ACalculator: TdxNumberFormatParser;
  const APrevState: IdxNumberFormatParserStateBase);
begin
...
procedure TdxEmbedTextState.ProcessChar(AIndex: Integer;
  AFormatInfo: TdxNumberFieldFormatInfo);
var
  AFormatString: string;
begin
...
procedure TdxFinishState.ProcessChar(AIndex: Integer;
  AFormatInfo: TdxNumberFieldFormatInfo);
begin
end;
...
procedure TdxIntegerFormatterStateBase.AppendResult(const AStr: string;
  AResultString: TStringBuilder);
begin
  AResultString.Insert(0, AStr);
end;

procedure TdxIntegerFormatterStateBase.AppendResult(ACh: Char;
  AResultString: TStringBuilder);
begin
  AResultString.Insert(0, ACh);
end;

procedure TdxIntegerFormatterStateBase.AppendSignIfNeeded
  (APattern: TdxNumberPattern; AResultString: TStringBuilder);
begin
...
procedure TdxIntegerFormatterStateBase.AppendGroupSeparator
  (ADigitCount: Integer; AResultString: TStringBuilder);
begin
...
function TdxIntegerFormatterState.FormatNextDigit
  (AIterator: TdxFormatRangeIterator; AIndex: Integer; const ANumber: string;
  AResult: TStringBuilder): TdxDigitProcessResult;
var
...
begin
  ...
  case AIterator.CurrentRange.&Type of
    TdxNumberFormatRangeType.StartNumberMask:
      begin
        AppendRemainedDigits(AActualIndex, ANumber,
          AIterator.Pattern.HasGroupSeparator, AResult);
    ...
    TdxNumberFormatRangeType.NumberMask:
      begin
        AppendCurrentDigit(AActualIndex, ANumber,
          AIterator.Pattern.HasGroupSeparator, AResult);
...
procedure TdxIntegerFormatterState.AppendRemainedDigits(AIndex: Integer;
  const ANumber: string; ASeparateGroups: Boolean; AResult: TStringBuilder);
var
  I: Integer;
begin
...
procedure TdxIntegerFormatterState.AppendCurrentDigit(AIndex: Integer;
  const ANumber: string; ASeparateGroups: Boolean; AResult: TStringBuilder);
var
  ADigitCount: Integer;
begin
...
function TdxFinalIntegerFormatterState.FormatNextDigit
  (AIterator: TdxFormatRangeIterator; AIndex: Integer; const ANumber: string;
  AResult: TStringBuilder): TdxDigitProcessResult;
var
  AProcessResult: TdxDigitProcessResult;
...
function TdxFinalIntegerFormatterState.GetNextState
  : IdxNumberFormatterStateBase;
begin
  Result := nil;
end;
...
procedure TdxFractionFormatterStateBase.AppendResult(ACh: Char;
  AResultString: TStringBuilder);
begin
  AResultString.Append(ACh);
end;

procedure TdxFractionFormatterStateBase.AppendResult(const AStr: string;
  AResultString: TStringBuilder);
begin
...
function TdxFractionalFormatterState.FormatNextDigit
  (AIterator: TdxFormatRangeIterator; AIndex: Integer; const ANumber: string;
  AResult: TStringBuilder): TdxDigitProcessResult;
var
  AProcessResult: TdxDigitProcessResult;
begin
  AProcessResult := TdxDigitProcessResult.Skip;
  case AIterator.CurrentRange.&Type of
    TdxNumberFormatRangeType.Terminator, TdxNumberFormatRangeType.NumberMask:
      begin
        AppendResult(ANumber[AIndex], AResult);
        AProcessResult := TdxDigitProcessResult.Success;
      end;
...
function TdxFinalFractionalFormatterState.FormatNextDigit
  (AIterator: TdxFormatRangeIterator; AIndex: Integer; const ANumber: string;
  AResult: TStringBuilder): TdxDigitProcessResult;
var
  AProcessResult: TdxDigitProcessResult;
...
function TdxFinalFractionalFormatterState.GetNextState
  : IdxNumberFormatterStateBase;
begin
  Result := nil;
end;
...
constructor TdxNumberFormatRange.Create(AStartIndex: Integer = -1;
  AEndIndex: Integer = -1;
  AType: TdxNumberFormatRangeType = TdxNumberFormatRangeType.None);
begin
  inherited Create;
...
constructor TdxNumberFormatRange.Create(AIndex: Integer;
  AType: TdxNumberFormatRangeType);
begin
...
function TdxNumericFieldFormatter.InternalFormat(const AValue: Double;
...
procedure TdxNumericFieldFormatter.BeginFormat(const ANumber: Double;
  const AFormat: string);
var
  AFormatString: string;
begin
  ...
  if Length(AFormat) > MaxFormatStringLength then
    AFormatString := TdxStringHelper.Substring(AFormat, 0,
      MaxFormatStringLength)
  else
    AFormatString := AFormat;
  FFormatInfo := TdxNumberFieldFormatInfo.Create(AFormatString,
...
procedure TdxNumericFieldFormatter.PopulateNumberFormatInfo
  (AFormatInfo: TdxNumberFieldFormatInfo);
var
...
function InternalRoundTo(const AValue: Double;
...
var
  AFactor: Double;
  AOriginRoundingMode:
  {$IFDEF DELPHIXE2}TRoundingMode{$ELSE}TFPURoundingMode{$ENDIF};
begin
...
begin
  ...
  AFormatSettings.DecimalSeparator :=
    NumberFormatInfo.CustomSeparators.MaskDecimalSeparator[1];
  Result := FloatToStr(ANumber, AFormatSettings);
end;

procedure TdxNumericFieldFormatter.FormatIntegerPart(ANumber: Double;
  APattern: TdxNumberPattern; AResult: TStringBuilder);
var
...
begin
  ...
  AIterator := TdxFormatRangeIteratorBackward.Create(APattern, ARangeIndex,
    FormatString);
  try
...
procedure TdxNumericFieldFormatter.FormatIntegerPartCore(ANumber: Double;
  AIterator: TdxFormatRangeIterator; AResult: TStringBuilder);
var
  AIntegerPart: Double;
...
procedure TdxNumericFieldFormatter.FormatFractionalPart(ANumber: Double;
  APattern: TdxNumberPattern; AResult: TStringBuilder);
var
...
begin
  ...
  if ASeparatorIndex < 0 then
    Exit;
  AIterator := TdxFormatRangeIteratorForward.Create(APattern, ASeparatorIndex,
    FormatString);
  try
...
procedure TdxNumericFieldFormatter.FormatFractionalPartCore(ANumber: Double;
  AResult: TStringBuilder; AIterator: TdxFormatRangeIterator);
var
  ANumberString: string;
...
procedure TdxNumericFieldFormatter.FormatNumberPart
  (AIterator: TdxFormatRangeIterator; const ANumberString: string;
  AResult: TStringBuilder);
var
  ADigitIndex: Integer;
  AProcessResult: TdxDigitProcessResult;
begin
  ...
  begin
    ...
    AProcessResult := FState.FormatNextDigit(AIterator, ADigitIndex,
      ANumberString, AResult);
    if AProcessResult = TdxDigitProcessResult.&End then
      FState := FState.GetNextState
    else if AProcessResult = TdxDigitProcessResult.Success then
      Inc(ADigitIndex);
  end;
end;
...
constructor TdxNumberFieldFormatInfo.Create(const AFormatString: string;
  const AFormatInfo: TdxNumberFormatInfo);
begin
  inherited Create;
  FCustomSeparators := TdxMailMergeCustomSeparators.Create;
...
procedure TdxNumberFieldFormatInfo.AddToRange(ACharIndex: Integer;
  ARangeType: TdxNumberFormatRangeType);
begin
...
constructor TdxNumberFormatterStateBase.Create
  (AFormatter: TdxNumericFieldFormatter);
begin
  inherited Create;
...
procedure TdxNumberFormatterStateBase.AppendResult(ARange: TdxNumberFormatRange;
  AResultString: TStringBuilder);
begin
...
constructor TdxFormatRangeIterator.Create(APattern: TdxNumberPattern;
  ARangeIndex: Integer; const AFormat: string);
begin
  inherited Create;
...
function TdxFormatRangeIterator.IsTextRange
  (ARange: TdxNumberFormatRange): Boolean;
begin
  Result := ARange.&Type = TdxNumberFormatRangeType.Text;
end;

function TdxFormatRangeIterator.IsCharIndexOutOfCurrentRange
