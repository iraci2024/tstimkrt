...
type
  ...
  strict private
    ...
    FTargetMode: string;
  public
    constructor Create(const AId, ATarget, AType: string;
      const ATargetMode: string = ''); overload;
  ...
  public
    ...
    function LookupRelationByTargetAndType(const ATarget, AType: string)
      : TdxOpenXmlRelation;
  end;
  ...
  strict private
    ...
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxRelationshipsDestination; static;
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    class function OnRelation(AImporter
  ...
  public
    constructor Create(AImporter: TdxWordProcessingMLBaseImporter;
      ARelations: TdxOpenXmlRelationCollection);
  end;
  ...
  public
    constructor Create(const ARelationId: string;
      ALogPosition: TdxDocumentLogPosition; APieceTable: TdxPieceTable);
  ...
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxAltChunkDestination; static;
    function CreateAltChunkPropertiesDestination
      : TdxAltChunkPropertiesDestination; virtual;
    class function OnAltChunkProperties(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  public
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;
  ...
  TdxOpenXmlImporter = class
    (TdxWordProcessingMLBaseImporter { , IdxDisposable, IdxOpenXmlImporter } )
  strict private
    ...
    FPackageImagesStack
      : TdxObjectStack<TdxNamedObjectDictionary<TdxOfficeImageReference>>;
    ...
    function GetPackageImages
      : TdxNamedObjectDictionary<TdxOfficeImageReference>;
  protected
    ...
    function GetPackageFiles(AStream: TStream)
      : TdxPackageFileCollection; virtual;
    ...
    function GetPackageFileXmlReader(const AFileName: string)
      : TdxXmlReader; virtual;
    function ImportRelationsCore(AReader: TdxXmlReader)
      : TdxOpenXmlRelationCollection; virtual;
    function LookupRelationTargetByType(ARelations
      : TdxOpenXmlRelationCollection; const AType: string;
      const ARootFolder: string; const ADefaultFileName: string)
      : string; virtual;
    function CreateUriBasedRichEditImageCore(const AUri: string;
      APixelTargetWidth: Integer; APixelTargetHeight: Integer)
      : TdxUriOfficeImage;
    function CreatePackageFileStreamByRelationId(const ARelationId: string;
      const ARootFolder: string): TStream; virtual;
    function CalculateRelationTargetCore(ARelation: TdxOpenXmlRelation;
      const ARootFolder: string; const ADefaultFileName: string)
      : string; virtual;
    ...
    property PackageFileStreams: TdxPackageFileStreams
      read GetPackageFileStreams;
    property PackageImages: TdxNamedObjectDictionary<TdxOfficeImageReference>
      read GetPackageImages;
  public
    ...
    function GetWordProcessingMLValue(AValue: TdxWordProcessingMLValue)
      : string; override;
    function CreateOpenXmlSectionTextDirectionDestination
      : TdxSectionTextDirectionDestination; override;
    function CreateWordMLSectionTextDirectionDestination
      : TdxSectionTextDirectionDestination; override;
    function CreateStyleParagraphPropertiesDestination(AStyleDestination
      : TdxStyleDestinationBase;
      AParagraphFormatting: TdxParagraphFormattingBase;
      ATabs: TdxTabFormattingInfo)
      : TdxParagraphPropertiesBaseDestination; override;

    function RegisterFootNote(ANote: TdxFootNote; const AId: string)
      : Integer; override;
    function RegisterEndNote(ANote: TdxEndNote; const AId: string)
      : Integer; override;
    function LookupImageByRelationId(const ARelationId: string;
      const ARootFolder: string): TdxOfficeImageReference; virtual;
    function LookupExternalImageByRelationId(const ARelationId: string;
      const ARootFolder: string): TdxUriOfficeImage; virtual;
    function LookupRelationTargetById(ARelations: TdxOpenXmlRelationCollection;
      const AId: string; const ARootFolder: string;
      const ADefaultFileName: string): string; virtual;
    function LookupMetafileByRelationId(const ARelationId: string;
      const ARootFolder: string; APictureWidth: Integer;
      APictureHeight: Integer): TdxOfficeImageReference;
    function LookupPackageFileStreamByRelationId(const ARelationId: string;
      const ARootFolder: string; ACacheStream: Boolean): TStream; virtual;
    function ImportRelations(const AFileName: string)
      : TdxOpenXmlRelationCollection; virtual;
    ...
    property DocumentRelationsStack
      : TdxObjectStack<TdxOpenXmlRelationCollection>
      read FDocumentRelationsStack;
    property DocumentRelations: TdxOpenXmlRelationCollection
      read GetDocumentRelations;
    property DocumentRootFolder: string read FDocumentRootFolder
      write FDocumentRootFolder;
    ...
    property PackageFileStreamsStack: TdxObjectStack<TdxPackageFileStreams>
      read FPackageFileStreamsStack;
    property PackageImagesStack: TdxObjectStack < TdxNamedObjectDictionary <
      TdxOfficeImageReference >> read FPackageImagesStack;
  end;
...
constructor TdxOpenXmlRelation.Create(const AId, ATarget, AType: string;
...
function TdxOpenXmlRelationCollection.LookupRelationById(const AId: string)
  : TdxOpenXmlRelation;
var
  I: Integer;
begin
...
function TdxOpenXmlRelationCollection.LookupRelationByType(const AType: string)
  : TdxOpenXmlRelation;
var
  I: Integer;
begin
...
function TdxOpenXmlRelationCollection.LookupRelationByTargetAndType
  (const ATarget, AType: string): TdxOpenXmlRelation;
var
  I: Integer;
begin
  Result := nil;
...
constructor TdxRelationshipsDestination.Create
...
class function TdxRelationshipsDestination.CreateElementHandlerTable
...
class function TdxRelationshipsDestination.GetThis
...
function TdxRelationshipsDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;

class function TdxRelationshipsDestination.OnRelation
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxRelationDestination.Create(AImporter,
    GetThis(AImporter).FRelations);
end;

{ TdxRelationDestination }

constructor TdxRelationDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  ARelations: TdxOpenXmlRelationCollection);
begin
  inherited Create(AImporter);
...
class function TdxRelationDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
end;
...
constructor TdxAltChunkInfo.Create(const ARelationId: string;
  ALogPosition: TdxDocumentLogPosition; APieceTable: TdxPieceTable);
begin
...
class function TdxAltChunkPropertiesDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
end;

function TdxAltChunkPropertiesDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;

procedure TdxAltChunkPropertiesDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
end;

procedure TdxAltChunkPropertiesDestination.ProcessElementClose
  (AReader: TdxXmlReader);
begin
end;
...
class function TdxAltChunkDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
class function TdxAltChunkDestination.GetThis
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter)
  : TdxAltChunkDestination;
begin
...
function TdxAltChunkDestination.CreateAltChunkPropertiesDestination
  : TdxAltChunkPropertiesDestination;
begin
  Result := TdxAltChunkPropertiesDestination.Create(Importer);
end;

class function TdxAltChunkDestination.OnAltChunkProperties
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
begin
  ...
  AOpenXmlImporter.AddAltChunkInfo(TdxAltChunkInfo.Create(FRelId,
    AOpenXmlImporter.Position.LogPosition,
...
constructor TdxOpenXmlImporter.Create(ADocumentModel: TdxCustomDocumentModel;
...
function TdxOpenXmlImporter.GetPackageImages
  : TdxNamedObjectDictionary<TdxOfficeImageReference>;
begin
...
begin
  ...
  if (AStream <> nil) and TdxOLECryptoContainer.Decrypt(AStream, AStream,
    APassword, DocumentModel.QueryEncryptionPassword,
...
begin
  ...
  try
    AFileName := LookupRelationTargetByType(ARootRelations,
      TdxOpenXmlExporter.OfficeDocumentType, '', 'document.xml');
  finally
    ARootRelations.Free;
  end;
  ...
  begin
    ...
    try
      ...
      FPackageFileStreamsStack := TdxObjectStack<TdxPackageFileStreams>.
        Create(True);
      FPackageImagesStack := TdxObjectStack < TdxNamedObjectDictionary <
        TdxOfficeImageReference >>.Create(True);

      FDocumentRelationsStack.Push
        (ImportRelations(FDocumentRootFolder + '/_rels/' +
        TPath.GetFileName(AFileName) + '.rels'));
      FPackageFileStreamsStack.Push(TdxPackageFileStreams.Create);
      FPackageImagesStack.Push
        (TdxNamedObjectDictionary<TdxOfficeImageReference>.Create(True));
  ...
  try
    ...
    if AEncryptionInfo <> nil then
      TdxRichEditExceptions.ThrowInvalidOperationException
        (cxGetResourceString(@sdxRichEditMsg_EncryptedFile));
  finally
    ADocument.Free;
  end;
end;
...
function TdxOpenXmlImporter.GetPackageFiles(AStream: TStream)
  : TdxPackageFileCollection;
var
...
function TdxOpenXmlImporter.GetPackageFileStream(const AFileName
  : string): TStream;
var
...
function TdxOpenXmlImporter.GetPackageFile(const AFileName: string)
  : TdxPackageFile;
var
  ACount, I: Integer;
  AFile: TdxPackageFile;
...
function TdxOpenXmlImporter.GetPackageFileXmlReader(const AFileName: string)
  : TdxXmlReader;
var
  AStream: TStream;
begin
...
function TdxOpenXmlImporter.ImportRelations(const AFileName: string)
  : TdxOpenXmlRelationCollection;
var
  AReader: TdxXmlReader;
begin
...
function TdxOpenXmlImporter.ImportRelationsCore(AReader: TdxXmlReader)
  : TdxOpenXmlRelationCollection;
begin
  Result := TdxOpenXmlRelationCollection.Create;
  if not ReadToRootElement(AReader, 'Relationships',
    TdxOpenXmlExporter.PackageRelsNamespace) then
    Exit(Result);
  ImportContent(AReader, TdxRelationshipsDestination.Create(Self, Result));
end;

function TdxOpenXmlImporter.LookupRelationTargetByType
  (ARelations: TdxOpenXmlRelationCollection; const AType: string;
  const ARootFolder: string; const ADefaultFileName: string): string;
var
  ARelation: TdxOpenXmlRelation;
begin
  ARelation := ARelations.LookupRelationByType(AType);
  Result := CalculateRelationTargetCore(ARelation, ARootFolder,
    ADefaultFileName);
end;

function TdxOpenXmlImporter.LookupRelationTargetById
  (ARelations: TdxOpenXmlRelationCollection; const AId: string;
  const ARootFolder: string; const ADefaultFileName: string): string;
var
  ARelation: TdxOpenXmlRelation;
begin
...
function TdxOpenXmlImporter.LookupImageByRelationId(const ARelationId: string;
  const ARootFolder: string): TdxOfficeImageReference;
var
  AStream: TStream;
begin
  ...
  Result := nil;
  AStream := LookupPackageFileStreamByRelationId(ARelationId,
    ARootFolder, False);
  if AStream <> nil then
    try
...
function TdxOpenXmlImporter.LookupMetafileByRelationId(const ARelationId
  : string; const ARootFolder: string; APictureWidth: Integer;
  APictureHeight: Integer): TdxOfficeImageReference;
var
  AStream: TStream;
  ...
  try
    try
      ...
      try
        ...
        AInfo.LoadMetafileFromStream(APictureStream, TdxMapMode.Anisotropic,
          APictureWidth, APictureHeight);
...
function TdxOpenXmlImporter.LookupExternalImageByRelationId(const ARelationId
  : string; const ARootFolder: string): TdxUriOfficeImage;
var
  ARelation: TdxOpenXmlRelation;
...
begin
  ...
  Result := TdxUriOfficeImage.Create(DocumentModel.ImageCache, DocumentModel,
    AUriList, APixelTargetWidth, APixelTargetHeight, False);
  FUniqueUriBasedImages.Add(AUri, Result);
end;

function TdxOpenXmlImporter.LookupPackageFileStreamByRelationId
  (const ARelationId: string; const ARootFolder: string;
  ACacheStream: Boolean): TStream;
begin
...
function TdxOpenXmlImporter.CreatePackageFileStreamByRelationId
  (const ARelationId: string; const ARootFolder: string): TStream;
var
  AFileName: string;
  AFile: TdxPackageFile;
begin
  AFileName := LookupRelationTargetById(DocumentRelations, ARelationId,
    ARootFolder, '');
  AFile := GetPackageFile(AFileName);
  if AFile = nil then
    Exit(nil);
...
function TdxOpenXmlImporter.CalculateRelationTargetCore
  (ARelation: TdxOpenXmlRelation; const ARootFolder: string;
...
var
  ...
  AReader: TdxXmlReader;
begin
  AFileName := LookupRelationTargetByType(DocumentRelations,
    TdxOpenXmlExporter.OfficeDocumentSettings, DocumentRootFolder,
    'settings.xml');
  AReader := GetPackageFileXmlReader(AFileName);
  if AReader <> nil then
    try
...
begin
  AFileName := LookupRelationTargetByType(DocumentRelations,
    TdxOpenXmlExporter.OfficeWebSettingsType, DocumentRootFolder,
    'webSettings.xml');
  AReader := GetPackageFileXmlReader(AFileName);
  if AReader <> nil then
    try
...
begin
  AFileName := LookupRelationTargetByType(DocumentRelations,
    TdxOpenXmlExporter.OfficeStylesType, DocumentRootFolder, 'styles.xml');
  AReader := GetPackageFileXmlReader(AFileName);
  if AReader <> nil then
    try
...
begin
  AFileName := LookupRelationTargetByType(DocumentRelations,
    TdxOpenXmlExporter.OfficeNumberingType, DocumentRootFolder,
    'numbering.xml');
  AReader := GetPackageFileXmlReader(AFileName);
  if AReader <> nil then
    try
...
begin
  ...
  AFileName := LookupRelationTargetByType(DocumentRelations,
    TdxOpenXmlExporter.OfficeFootNoteType, DocumentRootFolder, 'footnotes.xml');
  AReader := GetPackageFileXmlReader(AFileName);
  if AReader <> nil then
    try
...
begin
  ...
  AFileName := LookupRelationTargetByType(DocumentRelations,
    TdxOpenXmlExporter.OfficeEndNoteType, DocumentRootFolder, 'endnotes.xml');
  AReader := GetPackageFileXmlReader(AFileName);
  if AReader <> nil then
    try
...
begin
  AFileName := LookupRelationTargetByType(DocumentRelations,
    TdxOpenXmlExporter.OfficeCommentType, DocumentRootFolder, 'comments.xml');
  AReader := GetPackageFileXmlReader(AFileName);
  if AReader <> nil then
    try
      BeforeImportComment;
...
begin
  DocumentRelationsStack.Push(ImportRelations(DocumentRootFolder + '/_rels/' +
    'comments.xml' + '.rels'));
  PackageFileStreamsStack.Push(TdxPackageFileStreams.Create);
  PackageImagesStack.Push(TdxNamedObjectDictionary<TdxOfficeImageReference>.
    Create(True));
end;
...
begin
  ...
  ARelationTarget := LookupRelationTargetById(DocumentRelations, ARelId,
    DocumentRootFolder, '');
  if ARelationTarget = '' then
    Exit;

  AStream := LookupPackageFileStreamByRelationId(ARelId,
    DocumentRootFolder, True);
  if AStream = nil then
    Exit;
  ...
  ADocumentFormat := DocumentModel.AutodetectDocumentFormat
    (ARelationTarget, False);
  ...
  begin
    ...
    try
      AAltChunkDocumentModel.LoadDocument(AStream, ADocumentFormat,
        ARelationTarget);
      AAltChunkDocumentModel.MainPieceTable.InsertParagraph
        (AAltChunkDocumentModel.MainPieceTable.DocumentEndLogPosition);
    except
      AInvalidFormat := True;
    end;
  ...
  ATargetPieceTable.InsertDocumentModelContent(AAltChunkDocumentModel,
    AChunkInfo.LogPosition, False, False, True);
end;
...
function TdxOpenXmlImporter.GetWordProcessingMLValue
  (AValue: TdxWordProcessingMLValue): string;
begin
  Result := AValue.OpenXmlValue;
end;

function TdxOpenXmlImporter.CreateOpenXmlSectionTextDirectionDestination
  : TdxSectionTextDirectionDestination;
begin
  Result := TdxSectionTextDirectionDestination.Create(Self);
end;

function TdxOpenXmlImporter.CreateWordMLSectionTextDirectionDestination
  : TdxSectionTextDirectionDestination;
begin
  Result := nil;
end;

function TdxOpenXmlImporter.CreateStyleParagraphPropertiesDestination
...
begin
  Result := TdxStyleParagraphPropertiesDestination.Create(Self,
    AStyleDestination, AParagraphFormatting, ATabs);
end;
...
function TdxOpenXmlImporter.RegisterFootNote(ANote: TdxFootNote;
...
function TdxOpenXmlImporter.RegisterEndNote(ANote: TdxEndNote;
  const AId: string): Integer;
var
  AIndex: Integer;
begin
...
class function TdxImportOpenXmlFormat.GetDocumentFormat
  : TdxRichEditDocumentFormat;
begin
  Result := TdxRichEditDocumentFormat.OpenXML;
end;

function TdxImportOpenXmlFormat.GetDocumentImporter
  : IdxImporter<TdxRichEditDocumentFormat, Boolean>;
begin
  Result := TdxOpenXmlDocumentImporter.Create;
end;

function TdxImportOpenXmlFormat.GetImporter(ADocumentModel
  : TdxCustomDocumentModel; const AOptions: IdxImporterOptions)
  : TdxDocumentModelImporter;
begin
  Result := TdxOpenXmlImporter.Create(ADocumentModel,
    AOptions as TdxOpenXmlDocumentImporterOptions);
end;
