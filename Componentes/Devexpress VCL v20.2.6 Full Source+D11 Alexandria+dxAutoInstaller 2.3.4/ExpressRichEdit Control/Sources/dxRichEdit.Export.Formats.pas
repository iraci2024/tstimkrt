...
type
  ...
  strict private
    class var FExportFileFormats: TdxObjectList<TdxExportFileFormat>;
    class destructor Finalize;
  protected
    class function GetExportFileFormat(ADocumentFormat
      : TdxRichEditDocumentFormat): TdxExportFileFormat;
  public
    class function GetExporter(ADocumentFormat: TdxRichEditDocumentFormat;
      ADocumentModel: TdxCustomDocumentModel;
      const AOptions: IdxExporterOptions): TdxCustomDocumentModelExporter;
    class function GetFileExtension(ADocumentFormat
      : TdxRichEditDocumentFormat): string;
    ...
    class procedure RegisterFileFormat(AFileFormatClass
      : TdxExportFileFormatClass);
    class procedure UnRegisterFileFormat(AFileFormatClass
      : TdxExportFileFormatClass);

    class procedure RegisterDocumentExportFormats(ADocumentImportManager
...
class function TdxExportFileFormats.GetExporter(ADocumentFormat
...
class function TdxExportFileFormats.GetExportFileFormat(ADocumentFormat
  : TdxRichEditDocumentFormat): TdxExportFileFormat;
var
...
class function TdxExportFileFormats.GetFileExtension(ADocumentFormat
  : TdxRichEditDocumentFormat): string;
var
  AExportFileFormat: TdxExportFileFormat;
...
class function TdxExportFileFormats.IsFormatSupported(ADocumentFormat
  : TdxRichEditDocumentFormat): Boolean;
begin
...
class procedure TdxExportFileFormats.RegisterFileFormat(AFileFormatClass
  : TdxExportFileFormatClass);
begin
  if FExportFileFormats = nil then
...
class procedure TdxExportFileFormats.UnRegisterFileFormat(AFileFormatClass
  : TdxExportFileFormatClass);
var
  AFileFormat: TdxExportFileFormat;
begin
