...
type
  ...
  public
    class function FromByteArray(const APieceDescriptor: TBytes)
      : TdxPieceDescriptor; static;
...
class function TdxPieceDescriptor.FromByteArray(const APieceDescriptor: TBytes)
  : TdxPieceDescriptor;
begin
...
class function TdxPieceDescriptor.FromFileOffset(AFc: Integer)
  : TdxPieceDescriptor;
begin
  Result := TdxPieceDescriptor.Create;
  Result.FFc := AFc;
