...
type
  ...
  public
    class function InputBox(const ACaption, APrompt, ADefault: string)
      : string; static;
    class function InputQuery(const ACaption, APrompt: string;
      var Value: string): Boolean; overload; static;
  end;
...
class function TdxRichEditDialogs.InputBox(const ACaption, APrompt,
...
class function TdxRichEditDialogs.InputQuery(const ACaption, APrompt: string;
