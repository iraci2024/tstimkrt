...
type
  ...
  public
    constructor Create(AListIndex: Integer; AStyleIndex: Integer;
  ...
  public type
    TRecordType = (FrameSetRoot, Frame, FrameChildMarker, FrameName,
      FrameFilePath, FrameBorderAttributes, ListStyles);
  strict private
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader; AOffset: Integer;
      ASize: Integer): TdxDocumentFileRecords; static;
    procedure Read(AReader: TBinaryReader; AOffset: Integer; ASize: Integer);
    function ReadDocumentFileRecord(AReader: TBinaryReader;
...
constructor TdxListStylesRecordItem.Create(AListIndex: Integer;
  AStyleIndex: Integer; AStyleDefinition: Boolean);
begin
...
class function TdxDocumentFileRecords.FromStream(AReader: TBinaryReader;
  AOffset: Integer; ASize: Integer): TdxDocumentFileRecords;
begin
  Result := TdxDocumentFileRecords.Create;
  Result.Read(AReader, AOffset, ASize);
end;

procedure TdxDocumentFileRecords.Read(AReader: TBinaryReader; AOffset: Integer;
  ASize: Integer);
var
  ARecordSize: Integer;
begin
...
function TdxDocumentFileRecords.ReadDocumentFileRecord(AReader: TBinaryReader;
  AOffset: Integer): Integer;
var
  AType: TRecordType;
begin
...
begin
  ...
  begin
    ...
    FListStyles.Add(TdxListStylesRecordItem.Create(AListIndex, AStyleIndex,
      AStyleDefinition));
  end;
end;
