...
type
  TdxPictureSourceType = (Emf, Png, Jpeg, Mac, PmmMetafile, Wmf, WindowsDib,
    WindowsBmp);
  ...
  public
    ...
    property BmpBitsPerPixel: Integer read FBmpBitsPerPixel
      write FBmpBitsPerPixel;
    ...
    property PictureSourceType: TdxPictureSourceType read FPictureSourceType
      write FPictureSourceType;
    ...
    property DesiredPictureWidth: Integer read FDesiredPictureWidth
      write FDesiredPictureWidth;
    property DesiredPictureHeight: Integer read FDesiredPictureHeight
      write FDesiredPictureHeight;
  ...
  public type
    ...
    public
      ...
      function UnitsToModelUnits(Value: Integer;
    ...
    public
      ...
      function UnitsToModelUnits(Value: Integer;
        AUnitConverter: TdxDocumentModelUnitConverter): Integer; override;
    end;
  ...
  strict private
    ...
    class procedure EmfFileKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure PngFileKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure JpegFileKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure MacFileKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure WindowsMetafileKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure DeviceIndependentBitmapFileKeywordHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); inline; static;
    class procedure DeviceDependentBitmapFileKeywordHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); inline; static;
    class procedure BitmapBitsPerPixelKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure BitmapPlanesKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure BitmapBytesInLineKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure PictureWidthKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure PictureHeightKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure PictureGoalWidthKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure PictureGoalHeightKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure HorizontalScalingKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure VerticalScalingKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure PicScaledKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure TopCropKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure BottomCropKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure LeftCropKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure RightCropKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure BitmapMetafileKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure BitsPerPixelBitmapMetafileKeywordHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); inline; static;
    class procedure DxImageUriHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ShapePropertiesKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;

    class function FillBytesToConvertFromShortIntToLongInt(AParameterValue
      : Word): Integer; inline; static;
    ...
    procedure LoadImageInUnits(AImageInfo: TdxRtfImageInfo;
      AUnitsConverter: TdxRtfPictureUnitsConverter);
    procedure LoadMetafileImageInUnits(AImageInfo: TdxRtfImageInfo;
      AUnitsConverter: TdxRtfPictureUnitsConverter);
  ...
  protected
    ...
    property BmpBitsPerPixel: Integer read GetBmpBitsPerPixel
      write SetBmpBitsPerPixel;
    property BmpBytesInLine: Integer read GetBmpBytesInLine
      write SetBmpBytesInLine;
    property BmpColorPlanes: Integer read GetBmpColorPlanes
      write SetBmpColorPlanes;
    property DataStream: TdxCrc32Stream read GetDataStream;
    property PictureSourceType: TdxPictureSourceType read GetPictureSourceType
      write SetPictureSourceType;
  ...
  public
    constructor Create(AImporter: TdxRtfImporter;
      APictureDestination: TdxPictureDestination); reintroduce;
    destructor Destroy; override;
...
constructor TdxPictureDestination.Create(AImporter: TdxRtfImporter);
begin
  inherited Create(AImporter);
  FInfo := TdxPictureDestinationInfo.Create;
  FIsInfoOwner := True;
  FOldDecoder := Importer.Position.RtfFormattingInfo.Decoder;
  TdxRtfFormattingInfoAccess(Importer.Position.RtfFormattingInfo)
    .SetDecoder(TdxEmptyCharacterDecoder.Create, False);
end;
...
begin
  ...
  AIsParameterValueCorrect := (AParameterValue = 1) or (AParameterValue = 4) or
    (AParameterValue = 8) or (AParameterValue = 16) or (AParameterValue = 24) or
    (AParameterValue = 32);
...
class procedure TdxPictureDestination.DxImageUriHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  AImporter.Destination := TdxDxImageUriDestination.Create(AImporter,
    TdxPictureDestination(AImporter.Destination));
end;
  ...
  begin
    ...
    begin
      if Info.Properties.HasBoolProperty('fPseudoInline') then
        Result.PseudoInline := Info.Properties.GetBoolPropertyValue
          ('fPseudoInline');
    end;
...
begin
  FRtfHundredthsOfMillimeterConverter :=
    TdxRtfHundredthsOfMillimeterConverter.Create;
...
begin
  if AImageInfo.RtfImage.RawFormat in [TdxOfficeImageFormat.Emf,
    TdxOfficeImageFormat.Wmf] then
  begin
  ...
  if (Info.PictureWidth > 0) and (Info.DesiredPictureWidth > 0) then
    AImageInfo.ScaleX := Round(Info.ScaleX * Info.DesiredPictureWidth /
      Info.PictureWidth);
  if (Info.PictureHeight > 0) and (Info.DesiredPictureHeight > 0) then
    AImageInfo.ScaleY := Round(Info.ScaleY * Info.DesiredPictureHeight /
      Info.PictureHeight);

  AModelUnitConverter := Importer.UnitConverter;
  AWidthInModelUnits :=
    Max(1, AModelUnitConverter.TwipsToModelUnits(Info.PictureWidth));
  AHeightInModelUnits :=
    Max(1, AModelUnitConverter.TwipsToModelUnits(Info.PictureHeight));
  AImageInfo.SizeInModelUnits := cxSize(AWidthInModelUnits,
    AHeightInModelUnits);
end;
...
begin
  ...
  begin
    try
      AInfo.LoadMetafileFromStream(Info.PictureStream, WmfMapMode,
        Info.PictureWidth, Info.PictureHeight);
    except
      Exit;
    end;
  end;
...
begin
  ...
  if Info.DesiredPictureHeight <= 0 then
    Info.DesiredPictureHeight := AUnitsConverter.UnitsToTwips
      (Info.PictureHeight);
  if Info.ScaleX <= 0 then
    Info.ScaleX := 100;
  if Info.ScaleY <= 0 then
  ...
  if (Info.PictureWidth > 0) and (Info.DesiredPictureWidth > 0) then
    AImageInfo.ScaleX := Round(Info.ScaleX * Info.DesiredPictureWidth /
      AUnitsConverter.UnitsToTwips(Info.PictureWidth));
  if (Info.PictureHeight > 0) and (Info.DesiredPictureHeight > 0) then
    AImageInfo.ScaleY := Round(Info.ScaleY * Info.DesiredPictureHeight /
      AUnitsConverter.UnitsToTwips(Info.PictureHeight));

  AModelUnitConverter := Importer.UnitConverter;
  AWidthInModelUnits :=
    Max(1, AUnitsConverter.UnitsToModelUnits(Info.PictureWidth,
    AModelUnitConverter));
  AHeightInModelUnits :=
    Max(1, AUnitsConverter.UnitsToModelUnits(Info.PictureHeight,
    AModelUnitConverter));
  AImageInfo.SizeInModelUnits := cxSize(AWidthInModelUnits,
    AHeightInModelUnits);
end;
  ...
  begin
    try
      AInfo.LoadBitmapFromStream(Info.PictureStream, Info.PictureWidth,
        Info.PictureHeight, Info.BmpColorPlanes, Info.BmpBitsPerPixel,
        Info.BmpBytesInLine);
    except
      Exit;
    end;
...
begin
  ...
  begin
    try
      AInfo.LoadDibFromStream(Info.PictureStream, Info.PictureWidth,
        Info.PictureHeight, Info.BmpBytesInLine);
    except
      Exit;
    end;
  end;
...
begin
  ...
  begin
    AInfo.RtfImage := TdxOfficeImageReference.Create
      (Importer.DocumentModel.ImageCache, ACachedImage);
  end;
...
begin
  ...
  if (AParameterValue < 0) and (AParameterValue = ShortInt(AParameterValue))
  then
    ACorrectedValue := FillBytesToConvertFromShortIntToLongInt
      (Word(AParameterValue));
...
begin
  AImporter.Destination := TdxShapePropertyDestination.Create(AImporter,
    TdxPictureDestination(AImporter.Destination).Info.Properties);
end;
...
procedure TdxPictureDestination.ValidateImageSize
...
constructor TdxPictureDestination.TdxRtfPixelsToTwipsConverter.Create
  (ADpi: Integer);
begin
  inherited Create;
  FDpi := ADpi;
...
function TdxPictureDestination.TdxRtfPixelsToTwipsConverter.UnitsToModelUnits
  (Value: Integer; AUnitConverter: TdxDocumentModelUnitConverter): Integer;
begin
  Result := AUnitConverter.PixelsToModelUnits(Value, FDpi);
end;

function TdxPictureDestination.TdxRtfPixelsToTwipsConverter.UnitsToTwips
...
function TdxPictureDestination.TdxRtfHundredthsOfMillimeterConverter.
  UnitsToModelUnits(Value: Integer;
  AUnitConverter: TdxDocumentModelUnitConverter): Integer;
begin
...
function TdxPictureDestination.TdxRtfHundredthsOfMillimeterConverter.
  UnitsToTwips(Value: Integer): Integer;
begin
