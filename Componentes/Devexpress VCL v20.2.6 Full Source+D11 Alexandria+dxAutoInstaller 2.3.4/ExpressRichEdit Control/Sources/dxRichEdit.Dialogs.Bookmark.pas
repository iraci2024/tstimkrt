...
{$ENDIF}
  ...
  dxLayoutContainer, cxListBox, cxTextEdit,
...
begin
  FBookmarkNameHelper := TdxRichEditBookmarkNameHelper.Create(edtBookmarkName,
    lbBookmarkName);
...
begin
  ...
  Result := Application.MessageBox(PChar(AText), PChar(Application.Title),
...
begin
  ...
  btnAdd.Enabled := (ABookmarkName <> '') and
    Controller.ValidateName(ABookmarkName);
end;
...
procedure TdxRichEditBookmarkDialogForm.UpdateBookmarkNameItems(const ABookmarks
  : TdxBookmarkList);
var
  AItems: TStrings;
...
begin
  ...
  begin
    ...
    btnGoTo.Enabled := Controller.CanSelectBookmark
      (TdxBookmark(lbBookmarkName.ItemObject));
  end;
end;
...
begin
  ...
  rbSortByName.Caption := cxGetResourceString
    (@sdxRichEditBookmarkDialogSortByName);
  rbSortByLocation.Caption := cxGetResourceString
  ...
  btnDelete.Caption := cxGetResourceString
    (@sdxRichEditBookmarkDialogButtonDelete);
  lciBookmarkName.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditBookmarkDialogBookmarkName);
end;
...
function TdxRichEditBookmarkDialogForm.CreateController(AControllerParameters
  : TdxFormControllerParameters): TdxFormController;
begin
  Result := TdxBookmarkFormController.Create
    (AControllerParameters as TdxBookmarkFormControllerParameters);
end;
...
procedure TdxRichEditBookmarkDialogForm.edtBookmarkNamePropertiesChange
  (Sender: TObject);
begin
  UpdateAddButtonEnabled;
end;

procedure TdxRichEditBookmarkDialogForm.FormMouseWheel(Sender: TObject;
