...
type
  ...
  strict protected
    constructor Create(AState: TdxTablesControllerTableState; ATable: TdxTable;
      ARowSeparatorIndex: Integer); overload;
  protected
    function CalculateBottomTextIndentCore(out AHorizontalCellBordersInfo
      : TdxHorizontalCellBordersInfoList): TdxModelUnit; virtual; abstract;

    property State: TdxTablesControllerTableState read FState;
    property BorderCalculator: TdxTableBorderCalculator
      read GetBorderCalculator;
  ...
  public
    class function CreateCalculator(AState: TdxTablesControllerTableState;
      ATable: TdxTable; ARowSeparatorIndex: Integer)
      : TdxBottomTextIndentCalculatorBase; overload;
    function CalculateBottomTextIndent(out AHorizontalCellBordersInfo
      : TdxHorizontalCellBordersInfoList): TdxLayoutUnit;
  end;
...
type
  ...
  TdxNoSpacingBottomTextIndentCalculator = class
    (TdxBottomTextIndentCalculatorBase)
  protected
    function CalculateBottomTextIndentCore(out AHorizontalCellBordersInfo
      : TdxHorizontalCellBordersInfoList): TdxModelUnit; override;
    function GetBordersInfo: TdxHorizontalCellBordersInfoList; virtual;
    function GetBottomTextIndentForCell(ABorderInfo
      : TdxHorizontalCellBordersInfo): TdxModelUnit; virtual;
  end;

  { TdxNoSpacingLastAnchorBottomTextIndentCalculator }

  TdxNoSpacingLastAnchorBottomTextIndentCalculator = class
    (TdxNoSpacingBottomTextIndentCalculator)
  protected
    function GetBottomTextIndentForCell(ABorderInfo
      : TdxHorizontalCellBordersInfo): TdxModelUnit; override;
    function GetBordersInfo: TdxHorizontalCellBordersInfoList; override;
  end;

  { TdxSpacingBottomTextIndentCalculator }

  TdxSpacingBottomTextIndentCalculator = class
    (TdxBottomTextIndentCalculatorBase)
  protected
    function CalculateBottomTextIndentCore(out AHorizontalCellBordersInfo
      : TdxHorizontalCellBordersInfoList): TdxModelUnit; override;
...
constructor TdxBottomTextIndentCalculatorBase.Create
  (AState: TdxTablesControllerTableState; ATable: TdxTable;
...
class function TdxBottomTextIndentCalculatorBase.CreateCalculator
  (AState: TdxTablesControllerTableState; ATable: TdxTable;
...
begin
  ...
  if AHasCellSpacing then
    Result := TdxSpacingBottomTextIndentCalculator.Create(AState, ATable,
      ARowSeparatorIndex)
  else
  begin
    if ARowSeparatorIndex < ALastSeparatorIndex then
      Result := TdxNoSpacingBottomTextIndentCalculator.Create(AState, ATable,
        ARowSeparatorIndex)
    else
      Result := TdxNoSpacingLastAnchorBottomTextIndentCalculator.Create(AState,
        ATable, ARowSeparatorIndex);
  end;
end;

function TdxBottomTextIndentCalculatorBase.CalculateBottomTextIndent
  (out AHorizontalCellBordersInfo: TdxHorizontalCellBordersInfoList)
  : TdxLayoutUnit;
var
...
function TdxBottomTextIndentCalculatorBase.GetBorderCalculator
...
function TdxNoSpacingBottomTextIndentCalculator.GetBordersInfo
  : TdxHorizontalCellBordersInfoList;
begin
  Result := TdxTablesControllerTableStateAccess(State)
    .FHorizontalBordersCalculator.GetTopBorders(Row);
end;
...
function TdxNoSpacingLastAnchorBottomTextIndentCalculator.GetBordersInfo
  : TdxHorizontalCellBordersInfoList;
begin
  Result := TdxTablesControllerTableStateAccess(State)
    .FHorizontalBordersCalculator.GetBottomBorders(Row);
end;

function TdxNoSpacingLastAnchorBottomTextIndentCalculator.
  GetBottomTextIndentForCell(ABorderInfo: TdxHorizontalCellBordersInfo)
  : TdxModelUnit;
var
  ACell: TdxTableCell;
begin
...
function TdxSpacingBottomTextIndentCalculator.GetMaxBottomBorderCell
  (ARowIndex: Integer): TdxModelUnit;
var
  I: Integer;
  ARow: TdxTableRow;
  ACell: TdxTableCell;
...
begin
  ...
  begin
    ACell := ACells[I];
    ABottomTextIndent := BorderCalculator.GetActualWidth
      (ACell.GetActualBottomCellBorder);
    AMaxBorder := Math.Max(ABottomTextIndent, AMaxBorder);
  end;
  Result := AMaxBorder;
end;

function TdxSpacingBottomTextIndentCalculator.GetMaxTopBorderCell
  (ARowIndex: Integer): TdxModelUnit;
var
  I: Integer;
  ARow: TdxTableRow;
...
begin
  ...
  begin
    ACell := ACells[I];
    ABorderWidth := BorderCalculator.GetActualWidth
