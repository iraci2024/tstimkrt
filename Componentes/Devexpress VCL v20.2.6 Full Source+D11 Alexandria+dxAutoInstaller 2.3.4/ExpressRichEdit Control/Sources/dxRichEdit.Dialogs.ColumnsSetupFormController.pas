...
constructor TdxColumnsSetupFormControllerParameters.Create(const AControl
  : IdxRichEditControl; AColumnsInfo: TdxColumnsInfoUI);
begin
...
constructor TdxColumnsSetupFormController.Create(AControllerParameters
  : TdxColumnsSetupFormControllerParameters);
begin
  inherited Create;
...
function TdxColumnsSetupFormController.GetAvailableApplyTypes
  : TdxSectionPropertiesApplyTypes;
begin
  Result := FColumnsInfo.AvailableApplyType;
end;

function TdxColumnsSetupFormController.GetApplyType
...
procedure TdxColumnsSetupFormController.SetApplyType
  (const Value: TdxSectionPropertiesApplyType);
begin
...
procedure TdxColumnsSetupFormController.ApplyPreset
  (APreset: TdxColumnsInfoPreset);
begin
