...
type
  ...
  TdxHyperlinkAttributeHandler = reference to procedure
    (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
    AInfo: TdxHyperlinkInfo; const AValue: string);

  TdxHyperlinkAttributeHandlerTable = class
    (TdxNamedDelegateDictionary<TdxHyperlinkAttributeHandler>);
  ...
  strict private
    ...
    class destructor Finalize;
    class function CreateElementHandlerTable: TdxElementHandlerTable; static;
    class function CreateAttributeHandlerTable
      : TdxHyperlinkAttributeHandlerTable; static;
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    function GetAttributeHandlerTable
      : TdxHyperlinkAttributeHandlerTable; virtual;
    function CreateHyperlinkInfo(AReader: TdxXmlReader)
      : TdxHyperlinkInfo; virtual;
    ...
    class function OnCustomXml(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class procedure OnIdAttribute(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AInfo: TdxHyperlinkInfo;
      const AValue: string); static;
    class procedure OnAnchorAttribute(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AInfo: TdxHyperlinkInfo;
      const AValue: string); static;
    class procedure OnTargetFrameAttribute
      (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AInfo: TdxHyperlinkInfo; const AValue: string); static;
    class procedure OnTooltipAttribute(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AInfo: TdxHyperlinkInfo;
      const AValue: string); static;
    class procedure OnHistoryAttribute(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AInfo: TdxHyperlinkInfo;
      const AValue: string); static;
    class procedure OnDocLocationAttribute
      (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AInfo: TdxHyperlinkInfo; const AValue: string); static;

    property AttributeHandlerTable: TdxHyperlinkAttributeHandlerTable
      read GetAttributeHandlerTable;
  public
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;
    procedure ProcessElementClose(AReader: TdxXmlReader); override;
    class function OnRun(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
...
constructor TdxFieldDestinationBase.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter);
begin
...
class function TdxFieldSimpleDestination.CreateElementHandlerTable
...
function TdxFieldSimpleDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
...
begin
  FFieldCode := AReader.GetAttribute('instr',
...
class function TdxFieldSimpleDestination.OnRun
...
class function TdxFieldSimpleDestination.OnFieldSimple
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxFieldSimpleDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter));
end;

class function TdxFieldSimpleDestination.OnHyperlink
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxHyperlinkDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter));
end;

class function TdxFieldSimpleDestination.OnStructuredDocument
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxFieldSimpleDestination.OnCustomXml
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxFieldCharDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
end;
...
begin
  AType := AReader.GetAttribute('fldCharType',
    Importer.WordProcessingNamespaceConst);
  AAttr := AReader.GetAttribute('disableUpdate',
    Importer.WordProcessingNamespaceConst);
  if AAttr <> '' then
  ...
  else if AType = 'separate' then
    ProcessFieldSeparator
  else if AType = 'end' then
    ProcessFieldEnd;
end;
...
class function TdxHyperlinkDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
  Result.Add('r', OnRun);
...
class function TdxHyperlinkDestination.CreateAttributeHandlerTable
  : TdxHyperlinkAttributeHandlerTable;
begin
...
function TdxHyperlinkDestination.GetAttributeHandlerTable
  : TdxHyperlinkAttributeHandlerTable;
begin
...
begin
  ...
  try
    ImportFieldHelper.InsertHyperlinkInstruction(AHyperlinkInfo,
      Importer.Position);
  finally
    AHyperlinkInfo.Free;
  end;
...
function TdxHyperlinkDestination.CreateHyperlinkInfo(AReader: TdxXmlReader)
  : TdxHyperlinkInfo;
var
  AHyperlinkInfo: TdxHyperlinkInfo;
...
begin
  ...
  begin
    if AttributeHandlerTable.TryGetValue(AReader.LocalName, AHandler) and
      AReader.HasValue then
      AHandler(Importer, AHyperlinkInfo, AReader.Value)
    else if TdxStringHelper.IndexOf(AReader.Name, 'xmlns') < 0 then
...
class function TdxHyperlinkDestination.OnRun
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxWordProcessingMLBaseImporter(AImporter).CreateRunDestination;
...
class function TdxHyperlinkDestination.OnFieldSimple
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxFieldSimpleDestination.Create
...
class function TdxHyperlinkDestination.OnHyperlink
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxHyperlinkDestination.Create
...
class function TdxHyperlinkDestination.OnBookmarkStart
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxHyperlinkDestination.OnBookmarkEnd
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxWordProcessingMLBaseImporter(AImporter)
...
class function TdxHyperlinkDestination.OnRangePermissionStart
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxHyperlinkDestination.OnRangePermissionEnd
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxHyperlinkDestination.OnStructuredDocument
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxStructuredDocumentDestination.Create(AImporter);
...
class function TdxHyperlinkDestination.OnCustomXml
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxCustomXmlDestination.Create(AImporter);
...
class procedure TdxHyperlinkDestination.OnIdAttribute
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AInfo: TdxHyperlinkInfo; const AValue: string);
var
  ARelation: TdxOpenXmlRelation;
begin
  ARelation := (TdxOpenXmlImporter(AImporter))
    .DocumentRelations.LookupRelationById(AValue);
  AInfo.NavigateUri := ARelation.Target;
end;

class procedure TdxHyperlinkDestination.OnAnchorAttribute
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AInfo: TdxHyperlinkInfo; const AValue: string);
begin
  AInfo.Anchor := AValue;
...
class procedure TdxHyperlinkDestination.OnTargetFrameAttribute
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AInfo: TdxHyperlinkInfo; const AValue: string);
begin
  AInfo.Target := AValue;
...
class procedure TdxHyperlinkDestination.OnTooltipAttribute
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AInfo: TdxHyperlinkInfo; const AValue: string);
begin
...
class procedure TdxHyperlinkDestination.OnHistoryAttribute
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AInfo: TdxHyperlinkInfo; const AValue: string);
begin
...
class procedure TdxHyperlinkDestination.OnDocLocationAttribute
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AInfo: TdxHyperlinkInfo; const AValue: string);
begin
end;
