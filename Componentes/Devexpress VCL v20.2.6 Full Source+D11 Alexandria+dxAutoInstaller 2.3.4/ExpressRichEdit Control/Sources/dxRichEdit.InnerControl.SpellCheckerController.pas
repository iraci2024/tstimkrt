...
type
  ...
  IdxSyntaxCheckService = interface
    ...
    function Check(const AStart, AEnd: TdxDocumentModelPosition)
      : TArray<TdxRunInfo>;
  end;

  { TdxSpellCheckerCustomController }

  TdxSpellCheckerCustomController = class abstract
  ...
  protected
    ...
    function CreateErrorBoxCalculator
      : TdxSpellCheckerErrorBoxCalculator; virtual;
    ...
    procedure CheckFloatingObjects(const AFloatingObjects
    ...
    procedure CheckHeaderFooter(AArea: TdxPageArea;
      APageIndex: Integer); virtual;
    procedure CheckContent(const AStart, AEnd: TdxDocumentModelPosition;
      APageIndex: Integer); virtual; abstract;
  ...
  strict private
    class var FZero: IdxSpellCheckerPosition;
  strict private
  ...
  protected
    ...
    procedure SetActualPosition(const AValue
  ...
  public
    ...
    constructor Create(const AActualPosition: TdxDocumentModelPosition);
      overload; override;

    function Clone: IdxSpellCheckerPosition; override;
    function Add(APosition: IdxSpellCheckerPosition)
      : IdxSpellCheckerPosition; override;
    function Subtract(APosition: IdxSpellCheckerPosition)
      : IdxSpellCheckerPosition; override;
  ...
  protected
    ...
    function GetPageIndex(APages: TdxPageCollection; AStartIndex: Integer;
      AEndIndex: Integer): Integer; override;
    function GetPageAreaIndex(AAreas: TdxPageAreaCollection;
      AStartIndex: Integer; AEndIndex: Integer): Integer; override;
    function GetColumnIndex(AColumns: TdxColumnCollection; AStartIndex: Integer;
      AEndIndex: Integer): Integer; override;
    function GetRowIndex(ARows: TdxRowCollection; AStartIndex: Integer;
      AEndIndex: Integer): Integer; override;
    function GetBoxIndex(ABoxes: TdxBoxCollection; AStartIndex: Integer;
      AEndIndex: Integer): Integer; override;
    function GetCharIndex(ACharacters: TdxCharacterBoxCollection;
      AStartIndex: Integer; AEndIndex: Integer): Integer; override;
    function Update(APages: TdxPageCollection; AIndex: Integer;
      ADetailsLevel: TdxDocumentLayoutDetailsLevel): Boolean; overload; virtual;
    function Update(APages: TdxPageCollection;
      AFrom: TdxExpandedDocumentLayoutPosition;
      ADetailsLevel: TdxDocumentLayoutDetailsLevel): Boolean; overload;
    function UpdateCore(APages: TdxPageCollection;
      ADetailsLevel: TdxDocumentLayoutDetailsLevel)
      : TdxDocumentLayoutDetailsLevel; overload; override;
    function UpdateCore(APages: TdxPageCollection; AIndex: Integer;
      ADetailsLevel: TdxDocumentLayoutDetailsLevel)
      : TdxDocumentLayoutDetailsLevel; overload; virtual;
    function UpdateCore(APages: TdxPageCollection;
      AFrom: TdxExpandedDocumentLayoutPosition;
      ADetailsLevel: TdxDocumentLayoutDetailsLevel)
      : TdxDocumentLayoutDetailsLevel; overload; virtual;
    function UpdateBoxRecursive(AFrom: TdxExpandedDocumentLayoutPosition;
      ADetailsLevel: TdxDocumentLayoutDetailsLevel)
      : TdxDocumentLayoutDetailsLevel; overload;
    function UpdateRowRecursive(AFrom: TdxExpandedDocumentLayoutPosition;
      ADetailsLevel: TdxDocumentLayoutDetailsLevel)
      : TdxDocumentLayoutDetailsLevel; overload;
    function UpdateColumnRecursive(AFrom: TdxExpandedDocumentLayoutPosition;
      ADetailsLevel: TdxDocumentLayoutDetailsLevel)
      : TdxDocumentLayoutDetailsLevel; overload;
    function UpdatePageAreaRecursive(AFrom: TdxExpandedDocumentLayoutPosition;
      ADetailsLevel: TdxDocumentLayoutDetailsLevel)
      : TdxDocumentLayoutDetailsLevel; overload;
  public
    constructor Create(ADocumentLayout: TdxDocumentLayout;
      APieceTable: TdxCustomPieceTable;
      ALogPosition: TdxDocumentLogPosition); override;

    procedure CopyFrom(AValue: TdxDocumentLayoutPosition;
      ADetailsLevel: TdxDocumentLayoutDetailsLevel); override;
  ...
  public
    constructor Create(ADocumentLayout: TdxDocumentLayout;
      APieceTable: TdxPieceTable; AStart: TdxDocumentLogPosition;
  ...
  public
    constructor Create(ADocumentLayout: TdxDocumentLayout;
      ...
      AStopInHeaderFooter: Boolean = False); overload;
    function MoveNext(ADetailsLevel: TdxDocumentLayoutDetailsLevel)
      : Boolean; virtual;
  ...
  protected
    function Update(ABoxInfo: TdxBoxLayoutInfo; AIndex: Integer;
      ADetailsLevel: TdxDocumentLayoutDetailsLevel): Boolean; overload;
    function Update(ABoxInfo: TdxBoxLayoutInfo;
      AFrom: TdxExpandedDocumentLayoutPosition;
      ADetailsLevel: TdxDocumentLayoutDetailsLevel): Boolean; overload;
    procedure CalculateCore(ABoxInfo: TdxBoxLayoutInfo;
      AStart: TdxFormatterPosition; AEnd: TdxFormatterPosition;
      AErrorType: TdxSpellingError); virtual;
    procedure CalculateErrorBoxInSomeRows(AIterator: TdxDocumentLayoutIterator;
      AStart: TdxFormatterPosition; AEnd: TdxFormatterPosition;
      AErrorType: TdxSpellingError); virtual;
    procedure CalculateErrorBoxInCurrentRow
      (AIterator: TdxDocumentLayoutIterator; AStart: TdxFormatterPosition;
      AEnd: TdxFormatterPosition; AErrorType: TdxSpellingError); virtual;
    function FirstBox(ABox1: TdxBox; ABox2: TdxBox): TdxBox; virtual;
    function LastBox(ABox1: TdxBox; ABox2: TdxBox): TdxBox; virtual;
    function MaxPosition(APosition1: TdxFormatterPosition;
      APosition2: TdxFormatterPosition): TdxFormatterPosition; virtual;
    function MinPosition(APosition1: TdxFormatterPosition;
      APosition2: TdxFormatterPosition): TdxFormatterPosition; virtual;
    procedure CalculateErrorBox(ARow: TdxRow; AErrorBox: TdxErrorBox;
      AFirst: TdxBox; ALast: TdxBox); virtual;
    procedure CalculateErrorBoxBounds(ARow: TdxRow; AErrorBox: TdxErrorBox;
      AFirst: TdxBox; ALast: TdxBox); virtual;
    function GetFontInfo(ABox: TdxBox): TdxFontInfo; virtual;
    function GetUnderlineLeft(AFirst: TdxBox; AErrorBox: TdxErrorBox)
      : Integer; virtual;
    function GetUnderlineRight(ALast: TdxBox; AErrorBox: TdxErrorBox)
      : Integer; virtual;
    function GetFirstBoxOffset(ABox: TdxBox; AOffset: Integer)
      : Integer; virtual;
    function GetLastBoxOffset(ABox: TdxBox; AOffset: Integer): Integer; virtual;
    function GetCharactersBounds(ABox: TdxBox; const ABoxText: string)
      : TArray<TRect>;
  ...
  public
    constructor Create(ADocumentLayout: TdxDocumentLayout;
      ABoxMeasurer: TdxBoxMeasurer; APieceTable: TdxPieceTable);
    destructor Destroy; override;
    procedure Calculate(APageIndex: Integer;
      const AStartPos, AEndPos: TdxDocumentModelPosition;
      AErrorType: TdxSpellingError); virtual;
    procedure ClearErrorBoxes(AStart: TdxDocumentLogPosition;
  ...
  protected
    procedure CheckContent(const AStart, AEnd: TdxDocumentModelPosition;
      APageIndex: Integer); override;
  public
    constructor Create(const AControl: IdxInnerControl;
      const ASyntaxChecker: IdxSyntaxCheckService);
  end;
  ...
  protected
    procedure AddCore(const AStartPosition, AEndPosition
      : TdxDocumentPosition); virtual;
    procedure RemoveCore(const AStartPosition, AEndPosition
      : TdxDocumentPosition); virtual;
  public
    constructor Create(ADocumentModel: TdxDocumentModel);
    procedure Add(const AStart, AEnd: IdxSpellCheckerPosition;
      const AWord: string); overload; virtual;
    procedure Add(const AWord: string); overload; virtual;
    function Contains(const AWord: string): Boolean; overload; virtual;
    function Contains(const AStart, AEnd: IdxSpellCheckerPosition;
      const AWord: string): Boolean; overload; virtual;
    procedure Remove(const AStart, AEnd: IdxSpellCheckerPosition;
      const AWord: string); overload; virtual;
  ...
  TdxRichEditTextController = class abstract(TcxIUnknownObject,
    IdxSpellCheckTextController { , IdxSupportMultiCulture } )
  strict private
    FControl: IdxInnerControl;
    FGuid: string;
  ...
  protected
    class function GetCharacter(const APos: TdxDocumentModelPosition)
      : Char; static;

    function CanCheckDocument: Boolean; virtual;
    function CanEditRange(APieceTable: TdxPieceTable;
      AStart, AFinish: TdxDocumentLogPosition): Boolean;
    function CreatePosition(ALogPosition: Integer): IdxSpellCheckerPosition;
    function CreateDocumentPosition(const APos: TdxDocumentModelPosition)
      : TdxDocumentPosition;
    function DeleteWordCore(APieceTable: TdxPieceTable;
      AStart: TdxDocumentLogPosition; AFinish: TdxDocumentLogPosition): Boolean;
    function GetModelPosition(APosition: TdxDocumentPosition)
      : TdxDocumentModelPosition;
    function GetPieceTable: TdxPieceTable; virtual;
    function GetRunText(APieceTable: TdxPieceTable; AIndex: TdxRunIndex)
      : string; overload;
    function GetRunText(APieceTable: TdxPieceTable; AIndex: TdxRunIndex;
      AFrom: Integer; ATo: Integer): string; overload;
    function GetVisibleText(APieceTable: TdxPieceTable;
      const AStart, AEnd: TdxDocumentModelPosition): string;
    function GetWordIterator(APieceTable: TdxCustomPieceTable)
      : TdxSpellCheckerWordIterator; virtual;
    function ReplaceWordCore(APieceTable: TdxPieceTable; const AWord: string;
      AStart: TdxDocumentLogPosition; AFinish: TdxDocumentLogPosition): Boolean;
    function TryShiftEndPosition(const APos: TdxDocumentModelPosition;
      AIterator: TdxVisibleCharactersIterator): Boolean;
    function TryShiftStartPosition(const APos: TdxDocumentModelPosition;
      AIterator: TdxVisibleCharactersIterator): Boolean;

    function IsPositionVisible(const APos: IdxSpellCheckerPosition): Boolean;
    function IsRangeEditable(const AStart,
      AFinish: IdxSpellCheckerPosition): Boolean;
  ...
  public
    ...
    function CanDoNextStep(const APosition: IdxSpellCheckerPosition)
      : Boolean; overload;
    function DeleteWord(const AStart, AFinish: IdxSpellCheckerPosition)
      : Boolean; overload;
    function GetNextPosition(const APos: IdxSpellCheckerPosition)
      : IdxSpellCheckerPosition; overload;
    function GetNextWord(var AStart, AFinish: IdxSpellCheckerPosition): Boolean;
    function GetPreviousWord(const APos: IdxSpellCheckerPosition)
      : string; overload;
    function GetPrevPosition(const APos: IdxSpellCheckerPosition)
      : IdxSpellCheckerPosition; overload;
    function GetSentenceFinishPosition(const APos: IdxSpellCheckerPosition)
      : IdxSpellCheckerPosition; virtual;
    function GetSentenceStartPosition(const APos: IdxSpellCheckerPosition)
      : IdxSpellCheckerPosition; virtual;
    function GetTextLength(const AText: string): IdxSpellCheckerPosition;
    function GetWord(const AStart, AFinish: IdxSpellCheckerPosition)
      : string; overload;
    function GetWordFinishPosition(const APos: IdxSpellCheckerPosition)
      : IdxSpellCheckerPosition;
    function GetWordStartPosition(const APos: IdxSpellCheckerPosition)
      : IdxSpellCheckerPosition; overload;
    function HasLetters(const AStart, AFinish: IdxSpellCheckerPosition)
      : Boolean; overload;
    function IsFinishPositionRequest(const AText: string): Boolean;
    procedure PreparePositionsForDelete(const AStart,
      AFinish: TdxDocumentModelPosition);
    function ReplaceWord(const AStart, AFinish: IdxSpellCheckerPosition;
      const AWord: string): Boolean; overload;
    procedure SetSpellingArea(const AStart, AFinish: IdxSpellCheckerPosition);
    function ShouldCheckWord(const AStart, AEnd: IdxSpellCheckerPosition)
      : Boolean; overload;
  ...
  protected
    ...
    procedure ResetSpellCheck(AStartRunIndex: TdxRunIndex;
      AEndRunIndex: TdxRunIndex); overload;
    procedure CheckContent(const AStart, AEnd: TdxDocumentModelPosition;
      APageIndex: Integer); override;
    function CheckContentCore(const AStart,
      AEnd: TdxDocumentModelPosition): Boolean;
    procedure ClearErrorBoxes(AFrom, ATo: TdxDocumentLogPosition); virtual;
    procedure CalculateErrorBoxes(const AStart, AEnd: TdxDocumentModelPosition;
      APageIndex: Integer); virtual;
    function CheckInterval(AInterval: TdxSpellCheckerInterval)
      : Boolean; virtual;
    function IsUpperLimitExceeded: Boolean; virtual;
    procedure CalculateMisspelledInterval(const AStart,
      AEnd: TdxDocumentModelPosition; const AWord: string;
      AError: TdxSpellingError); virtual;
...
type
  ...
  protected
    ...
    function GetWordIterator(APieceTable: TdxCustomPieceTable)
      : TdxSpellCheckerWordIterator; override;
  public
    constructor Create(const AControl: IdxInnerControl); override;
    destructor Destroy; override;
    procedure Reset;
  ...
  public
    ...
    function GetSentenceEndPosition(const APos: TdxDocumentModelPosition)
      : TdxDocumentModelPosition;
    function GetSentenceEndPositionCore(const APos: TdxDocumentModelPosition)
      : TdxDocumentModelPosition;
    function GetSentenceStartPosition(const APos: TdxDocumentModelPosition)
      : TdxDocumentModelPosition;
    function GetSentenceStartPositionCore(const APos: TdxDocumentModelPosition)
      : TdxDocumentModelPosition;
    function FindSentenceStart(const APos: TdxDocumentModelPosition)
      : TdxDocumentModelPosition;
    function ProcessPunctuation(const AStart, AFinish: TdxDocumentModelPosition)
      : TdxDocumentModelPosition;
    function FindSentenceSeparatorAfterThreeDotsWithSpace
      (const APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
    function FindPunctuationAfterThreeDotsWithSpace
      (const APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
    function FindAbbreviation(const AStart, AFinish: TdxDocumentModelPosition)
      : TdxDocumentModelPosition;
    ...
    function FindLetterOrDigitPosition(const AStartPosition
      : TdxDocumentModelPosition): TdxDocumentModelPosition;
    function FindPrevLetterOrDigitPosition(const APos: TdxDocumentModelPosition)
      : TdxDocumentModelPosition;
    function FindSentenceSeparatorWithSpace(const APos
      : TdxDocumentModelPosition): TdxDocumentModelPosition;
    function FindThreeDotsWithSpace(const APos: TdxDocumentModelPosition)
      : TdxDocumentModelPosition;
    ...
    function IsNotWordSymbolAndNotSentenceSeparator(const ACh: Char)
      : Boolean; inline;
    ...
    function IsStartOfDocument(const APos: TdxDocumentModelPosition;
      AWordIterator: TdxSpellCheckerWordIterator): Boolean; inline;
    function IsEndOfDocument(const APos: TdxDocumentModelPosition;
      AWordIterator: TdxSpellCheckerWordIterator): Boolean; inline;
  end;
...
procedure TdxEmptyDocumentPosition.SetActualPosition(const AValue
  : TdxDocumentModelPosition);
begin
end;
...
function TdxEmptyDocumentPosition.Add(APosition: IdxSpellCheckerPosition)
  : IdxSpellCheckerPosition;
begin
...
function TdxEmptyDocumentPosition.Subtract(APosition: IdxSpellCheckerPosition)
  : IdxSpellCheckerPosition;
begin
  TdxRichEditExceptions.ThrowInternalException;
  Result := nil;
...
constructor TdxDocumentPosition.Create(const AActualPosition
  : TdxDocumentModelPosition);
begin
...
procedure TdxDocumentPosition.SetActualPosition(const AValue
  : TdxDocumentModelPosition);
begin
  FPosition := AValue;
end;
...
function TdxDocumentPosition.Add(APosition: IdxSpellCheckerPosition)
  : IdxSpellCheckerPosition;
var
...
begin
  ...
  if APositionOffset = nil then
    TdxRichEditExceptions.ThrowArgumentException('position',
      TObject(APosition));
  ...
  Result := TdxDocumentPosition.Create
    (TdxPositionConverter.ToDocumentModelPosition(PieceTable, ALogPosition));
end;

function TdxDocumentPosition.Subtract(APosition: IdxSpellCheckerPosition)
  : IdxSpellCheckerPosition;
var
...
begin
  ...
  begin
    Result := TdxPositionOffset.Create(Position.LogPosition -
      ADocumentPosition.Position.LogPosition);
    Exit;
  end;
  APositionOffset := TdxPositionOffset(APosition);
  if APositionOffset <> nil then
...
function TdxDocumentPosition.Compare(APosition
  : IdxSpellCheckerPosition): Integer;
var
  ADocumentPosition: TdxDocumentPosition;
begin
  if APosition = nil then
...
begin
  Result := TdxDocumentPosition.Create
    (TdxDocumentModelPosition.MoveForward(Position));
end;

function TdxDocumentPosition.MoveBackward: IdxSpellCheckerPosition;
begin
  Result := TdxDocumentPosition.Create(TdxDocumentModelPosition.MoveBackward
    (Position));
end;
...
constructor TdxExpandedDocumentLayoutPosition.Create(ADocumentLayout
  : TdxDocumentLayout; APieceTable: TdxCustomPieceTable;
  ALogPosition: TdxDocumentLogPosition);
begin
...
function TdxExpandedDocumentLayoutPosition.CreateEmptyClone
  : TdxDocumentLayoutPosition;
begin
  Result := TdxExpandedDocumentLayoutPosition.Create(DocumentLayout, PieceTable,
    LogPosition);
end;

function TdxExpandedDocumentLayoutPosition.GetPageIndex
  (APages: TdxPageCollection; AStartIndex: Integer; AEndIndex: Integer)
  : Integer;
begin
...
function TdxExpandedDocumentLayoutPosition.GetPageAreaIndex
  (AAreas: TdxPageAreaCollection; AStartIndex: Integer;
...
function TdxExpandedDocumentLayoutPosition.GetColumnIndex
  (AColumns: TdxColumnCollection; AStartIndex: Integer;
  AEndIndex: Integer): Integer;
begin
...
function TdxExpandedDocumentLayoutPosition.GetRowIndex(ARows: TdxRowCollection;
  AStartIndex: Integer; AEndIndex: Integer): Integer;
begin
  FRowIndex := inherited GetRowIndex(ARows, AStartIndex, AEndIndex);
  Result := FRowIndex;
end;

function TdxExpandedDocumentLayoutPosition.GetBoxIndex(ABoxes: TdxBoxCollection;
  AStartIndex: Integer; AEndIndex: Integer): Integer;
begin
...
function TdxExpandedDocumentLayoutPosition.GetCharIndex
  (ACharacters: TdxCharacterBoxCollection; AStartIndex: Integer;
  AEndIndex: Integer): Integer;
begin
  FCharacterIndex := inherited GetCharIndex(ACharacters, AStartIndex,
    AEndIndex);
  Result := FCharacterIndex;
end;

function TdxExpandedDocumentLayoutPosition.Update(APages: TdxPageCollection;
  AIndex: Integer; ADetailsLevel: TdxDocumentLayoutDetailsLevel): Boolean;
begin
...
function TdxExpandedDocumentLayoutPosition.UpdateCore(APages: TdxPageCollection;
  AIndex: Integer; ADetailsLevel: TdxDocumentLayoutDetailsLevel)
...
function TdxExpandedDocumentLayoutPosition.UpdateBoxRecursive
  (AFrom: TdxExpandedDocumentLayoutPosition;
  ADetailsLevel: TdxDocumentLayoutDetailsLevel): TdxDocumentLayoutDetailsLevel;
var
  AResultLevel: TdxDocumentLayoutDetailsLevel;
begin
  if not IsValid(TdxDocumentLayoutDetailsLevel.Box) and
    (ADetailsLevel >= TdxDocumentLayoutDetailsLevel.Box) then
  begin
    AResultLevel := UpdateBoxRecursive(AFrom.Row, AFrom.BoxIndex,
      ADetailsLevel);
    if AResultLevel = ADetailsLevel then
    begin
...
function TdxExpandedDocumentLayoutPosition.UpdateRowRecursive
  (AFrom: TdxExpandedDocumentLayoutPosition;
  ADetailsLevel: TdxDocumentLayoutDetailsLevel): TdxDocumentLayoutDetailsLevel;
var
  ...
  ARowIndex: Integer;
begin
  if not IsValid(TdxDocumentLayoutDetailsLevel.Column) and
    (ADetailsLevel >= TdxDocumentLayoutDetailsLevel.Row) then
  begin
...
function TdxExpandedDocumentLayoutPosition.UpdateColumnRecursive
  (AFrom: TdxExpandedDocumentLayoutPosition;
  ADetailsLevel: TdxDocumentLayoutDetailsLevel): TdxDocumentLayoutDetailsLevel;
var
  AResultLevel: TdxDocumentLayoutDetailsLevel;
begin
  if not IsValid(TdxDocumentLayoutDetailsLevel.PageArea) and
    (ADetailsLevel >= TdxDocumentLayoutDetailsLevel.Column) then
  begin
    AResultLevel := UpdateColumnRecursive(AFrom.PageArea.Columns,
      AFrom.ColumnIndex, ADetailsLevel);
    if AResultLevel = ADetailsLevel then
    begin
...
function TdxExpandedDocumentLayoutPosition.UpdatePageAreaRecursive
  (AFrom: TdxExpandedDocumentLayoutPosition;
  ADetailsLevel: TdxDocumentLayoutDetailsLevel): TdxDocumentLayoutDetailsLevel;
var
  AResultLevel: TdxDocumentLayoutDetailsLevel;
begin
  if not IsValid(TdxDocumentLayoutDetailsLevel.Page) and
    (ADetailsLevel >= TdxDocumentLayoutDetailsLevel.PageArea) then
  begin
    AResultLevel := UpdatePageAreaRecursive(AFrom.Page, AFrom.PageAreaIndex,
      ADetailsLevel);
    if AResultLevel = ADetailsLevel then
    begin
...
procedure TdxExpandedDocumentLayoutPosition.CopyFrom
  (AValue: TdxDocumentLayoutPosition;
  ADetailsLevel: TdxDocumentLayoutDetailsLevel);
var
...
constructor TdxSpellCheckerCustomController.Create(const AControl
  : IdxInnerControl);
begin
  Assert(AControl <> nil);
  inherited Create;
...
procedure TdxSpellCheckerCustomController.SetPieceTable
...
function TdxSpellCheckerCustomController.CreateErrorBoxCalculator
  : TdxSpellCheckerErrorBoxCalculator;
begin
  Result := TdxSpellCheckerErrorBoxCalculator.Create(DocumentLayout,
    BoxMeasurer, PieceTable);
end;
...
begin
  AStart := TdxPositionConverter.ToDocumentModelPosition(PieceTable,
    PieceTable.DocumentStartLogPosition);
...
procedure TdxSpellCheckerCustomController.CheckFloatingObjects
  (const AFloatingObjects: TdxFloatingObjectBoxList);
var
  ACount, I: Integer;
...
begin
  ...
  begin
    ...
    if (AFloatingObject.PieceTable = PieceTable) and
      (AFloatingObject.DocumentLayout <> nil) then
      CheckTextBoxContent(AFloatingObject);
  end;
end;

procedure TdxSpellCheckerCustomController.CheckTextBoxContent(AFloatingObject
...
procedure TdxSpellCheckerCustomController.CheckHeaderFooter(AArea: TdxPageArea;
  APageIndex: Integer);
var
  AStart, AEnd: TdxDocumentModelPosition;
begin
...
constructor TdxBoxLayoutInfo.Create(ADocumentLayout: TdxDocumentLayout;
  APieceTable: TdxPieceTable; AStart: TdxDocumentLogPosition;
  AEnd: TdxDocumentLogPosition);
begin
  inherited Create;
  FStart := TdxExpandedDocumentLayoutPosition.Create(ADocumentLayout,
    APieceTable, AStart);
  FEnd := TdxExpandedDocumentLayoutPosition.Create(ADocumentLayout,
    APieceTable, AEnd);
end;
...
function TdxDocumentLayoutIterator.MoveNext(ADetailsLevel
  : TdxDocumentLayoutDetailsLevel): Boolean;
begin
  if (ADetailsLevel = TdxDocumentLayoutDetailsLevel.Box) and (CurrentBox <> nil)
  then
    Exit(MoveBoxToNext);
  if (ADetailsLevel = TdxDocumentLayoutDetailsLevel.Row) and (CurrentRow <> nil)
  then
    Exit(MoveRowToNext);
  if (ADetailsLevel = TdxDocumentLayoutDetailsLevel.Column) and
    (CurrentColumn <> nil) then
    Exit(MoveColumnToNext);
  if (ADetailsLevel = TdxDocumentLayoutDetailsLevel.PageArea) and
    (CurrentPageArea <> nil) then
    Exit(MovePageAreaToNext);
  if (ADetailsLevel = TdxDocumentLayoutDetailsLevel.Page) and
    (CurrentPage <> nil) then
    Exit(MovePageToNext);
  Result := False;
end;
...
begin
  ...
  begin
    FCurrentRowIndex := 0;
    FTableCell := (TdxTableCellRow(CurrentColumn.Rows[ANextRowIndex]))
      .CellViewInfo;
  end
  else
  begin
...
function TdxDocumentLayoutIterator.IsRowLastInCurrentColumn
  (ARow: TdxRow): Boolean;
begin
...
constructor TdxSpellCheckerErrorBoxCalculator.Create(ADocumentLayout
  : TdxDocumentLayout; ABoxMeasurer: TdxBoxMeasurer;
  APieceTable: TdxPieceTable);
begin
  Assert(ADocumentLayout <> nil);
...
procedure TdxSpellCheckerErrorBoxCalculator.Calculate(APageIndex: Integer;
  const AStartPos, AEndPos: TdxDocumentModelPosition;
...
begin
  ...
  ABoxInfo := TdxBoxLayoutInfo.Create(DocumentLayout, PieceTable,
    AStartPos.LogPosition, AEndPos.LogPosition);
  try
    if (FLastCalcLayoutPos <> nil) and
      (APageIndex = FLastCalcLayoutPos.PageIndex) then
    begin
      if not Update(ABoxInfo, FLastCalcLayoutPos,
    ...
    begin
      FreeAndNil(FLastCalcLayoutPos);
      if not Update(ABoxInfo, APageIndex, TdxDocumentLayoutDetailsLevel.Box)
      then
        Exit;
    end;
...
function TdxSpellCheckerErrorBoxCalculator.Update(ABoxInfo: TdxBoxLayoutInfo;
  AIndex: Integer; ADetailsLevel: TdxDocumentLayoutDetailsLevel): Boolean;
var
  APages: TdxPageCollection;
begin
  APages := DocumentLayout.Pages;
  Result := ABoxInfo.Start.Update(APages, AIndex, ADetailsLevel) and
    ABoxInfo.&End.Update(APages, ABoxInfo.Start, ADetailsLevel);
end;
...
begin
  APages := DocumentLayout.Pages;
  Result := ABoxInfo.Start.Update(APages, AFrom, ADetailsLevel) and
    ABoxInfo.&End.Update(APages, ABoxInfo.Start, ADetailsLevel);
end;

procedure TdxSpellCheckerErrorBoxCalculator.CalculateCore
  (ABoxInfo: TdxBoxLayoutInfo; AStart: TdxFormatterPosition;
...
procedure TdxSpellCheckerErrorBoxCalculator.CalculateErrorBoxInSomeRows
  (AIterator: TdxDocumentLayoutIterator; AStart: TdxFormatterPosition;
  AEnd: TdxFormatterPosition; AErrorType: TdxSpellingError);
begin
  repeat
...
procedure TdxSpellCheckerErrorBoxCalculator.ClearErrorBoxes
...
begin
  ...
  try
    if not ABoxInfo.Start.Update(DocumentLayout.Pages,
      TdxDocumentLayoutDetailsLevel.Row) then
      Exit;
    if not ABoxInfo.&End.Update(DocumentLayout.Pages,
      TdxDocumentLayoutDetailsLevel.Row) then
      Exit;

    AIterator := TdxDocumentLayoutIterator.Create(DocumentLayout,
      ABoxInfo, True);
    try
      repeat
...
procedure TdxSpellCheckerErrorBoxCalculator.CalculateErrorBoxInCurrentRow
  (AIterator: TdxDocumentLayoutIterator; AStart: TdxFormatterPosition;
  AEnd: TdxFormatterPosition; AErrorType: TdxSpellingError);
var
  ARow: TdxRow;
...
function TdxSpellCheckerErrorBoxCalculator.FirstBox(ABox1: TdxBox;
  ABox2: TdxBox): TdxBox;
begin
...
function TdxSpellCheckerErrorBoxCalculator.LastBox(ABox1: TdxBox;
  ABox2: TdxBox): TdxBox;
begin
...
function TdxSpellCheckerErrorBoxCalculator.MaxPosition
  (APosition1: TdxFormatterPosition; APosition2: TdxFormatterPosition)
...
function TdxSpellCheckerErrorBoxCalculator.MinPosition
  (APosition1: TdxFormatterPosition; APosition2: TdxFormatterPosition)
  : TdxFormatterPosition;
begin
  if APosition1 <= APosition2 then
...
procedure TdxSpellCheckerErrorBoxCalculator.CalculateErrorBox(ARow: TdxRow;
  AErrorBox: TdxErrorBox; AFirst: TdxBox; ALast: TdxBox);
begin
...
procedure TdxSpellCheckerErrorBoxCalculator.CalculateErrorBoxBounds
  (ARow: TdxRow; AErrorBox: TdxErrorBox; AFirst: TdxBox; ALast: TdxBox);
var
...
begin
  ...
  ABaseLinePosition := ARow.Bounds.Top + ARow.BaseLineOffset +
    AErrorBox.UnderlineBounds.Top;
  AUnderlineTop := ABaseLinePosition + AErrorBox.UnderlinePosition div 2;
  AUnderlineBottom := ABaseLinePosition + AErrorBox.UnderlinePosition +
    AErrorBox.UnderlineThickness;
  ...
  AErrorBox.UnderlineBounds := TRect.Create(ARow.Bounds.Left, AUnderlineTop,
    ARow.Bounds.Right, AUnderlineBottom);
  AErrorBox.ClipBounds := TRect.Create(AUnderlineLeft, AUnderlineTop,
    AUnderlineRight, AUnderlineBottom);
end;

function TdxSpellCheckerErrorBoxCalculator.GetFontInfo(ABox: TdxBox)
  : TdxFontInfo;
begin
  Result := ABox.GetFontInfo(PieceTable);
end;

function TdxSpellCheckerErrorBoxCalculator.GetUnderlineLeft(AFirst: TdxBox;
  AErrorBox: TdxErrorBox): Integer;
var
...
function TdxSpellCheckerErrorBoxCalculator.GetUnderlineRight(ALast: TdxBox;
  AErrorBox: TdxErrorBox): Integer;
var
  AEndOffset: Integer;
begin
...
function TdxSpellCheckerErrorBoxCalculator.GetFirstBoxOffset(ABox: TdxBox;
...
function TdxSpellCheckerErrorBoxCalculator.GetLastBoxOffset(ABox: TdxBox;
  AOffset: Integer): Integer;
var
  ABoxText: string;
  ACharBounds: TArray<TRect>;
...
function TdxSpellCheckerErrorBoxCalculator.GetCharactersBounds(ABox: TdxBox;
  const ABoxText: string): TArray<TRect>;
begin
  Result := BoxMeasurer.MeasureCharactersBounds(ABoxText, GetFontInfo(ABox),
    ABox.Bounds);
end;
...
constructor TdxSyntaxCheckController.Create(const AControl: IdxInnerControl;
  const ASyntaxChecker: IdxSyntaxCheckService);
begin
...
procedure TdxSyntaxCheckController.CheckContent(const AStart,
  AEnd: TdxDocumentModelPosition; APageIndex: Integer);
var
...
begin
  ...
  try
    for I := 0 to ACount - 1 do
      ACalculator.Calculate(APageIndex, AIntervals[I].Start, AIntervals[I].&End,
        seSyntax);
  finally
    ACalculator.Free;
  end;
...
function TdxIgnoreListManager.GetMisspelledIntervals
  : TdxMisspelledIntervalCollection;
begin
  Result := PieceTable.SpellCheckerManager.MisspelledIntervals;
end;

procedure TdxIgnoreListManager.Add(const AStart, AEnd: IdxSpellCheckerPosition;
  const AWord: string);
var
...
procedure TdxIgnoreListManager.AddCore(const AStartPosition,
  AEndPosition: TdxDocumentPosition);
var
  AInterval: TdxMisspelledInterval;
begin
  AInterval := MisspelledIntervals.FindInterval(AStartPosition.LogPosition,
    AEndPosition.LogPosition);
...
function TdxIgnoreListManager.Contains(const AStart,
  AEnd: IdxSpellCheckerPosition; const AWord: string): Boolean;
var
  AStartPosition, AEndPosition: TdxDocumentPosition;
begin
  AStartPosition := TdxDocumentPosition(AStart);
  ...
  if (AStartPosition = nil) or (AEndPosition = nil) then
    Exit(False);
  Result := IgnoredList.Contains(AStartPosition.LogPosition,
    AEndPosition.LogPosition, AWord);
end;

procedure TdxIgnoreListManager.Remove(const AStart,
  AEnd: IdxSpellCheckerPosition; const AWord: string);
var
  AStartPosition, AEndPosition: TdxDocumentPosition;
begin
  AStartPosition := TdxDocumentPosition(AStart);
...
procedure TdxIgnoreListManager.RemoveCore(const AStartPosition,
  AEndPosition: TdxDocumentPosition);
var
  AInterval: TdxMisspelledInterval;
begin
  AInterval := IgnoredList.FindInterval(AStartPosition.LogPosition,
    AEndPosition.LogPosition);
  if AInterval <> nil then
  begin
...
constructor TdxVisibleCharactersIterator.Create(APieceTable
  : TdxSimplePieceTable);
begin
...
function TdxVisibleCharactersIterator.GetVisibleTextFilter
  : IdxVisibleTextFilter;
begin
  Result := PieceTable.VisibleTextFilter;
end;

procedure TdxVisibleCharactersIterator.MoveForwardCore
  (var APos: TdxDocumentModelPosition);
begin
  TdxDocumentModelPosition.MoveForwardCore(APos);
  if not IsRunVisible(APos.RunIndex) then
  begin
    APos.LogPosition := VisibleTextFilter.GetNextVisibleLogPosition
      (APos, False);
    UpdateModelPositionByLogPosition(APos);
  end;
end;

procedure TdxVisibleCharactersIterator.MoveBackCore
  (var APos: TdxDocumentModelPosition);
begin
  TdxDocumentModelPosition.MoveBackwardCore(APos);
  if not IsRunVisible(APos.RunIndex) then
  begin
    APos.LogPosition := VisibleTextFilter.GetPrevVisibleLogPosition
      (APos, False);
    UpdateModelPositionByLogPosition(APos);
  end;
end;

function TdxVisibleCharactersIterator.IsRunVisible
...
constructor TdxSentencePositionCalculator.Create(AWordIterator
...
function TdxSentencePositionCalculator.GetCharacter
  (const APos: TdxDocumentModelPosition): Char;
begin
  Result := FWordIterator.GetCharacter(APos);
end;

function TdxSentencePositionCalculator.IsNotWordSymbolAndNotSentenceSeparator
  (const ACh: Char): Boolean;
begin
  Result := FWordIterator.IsNotLetterOrDigit(ACh) and
    not IsSentenceSeparator(ACh);
end;
...
begin
  Result := (ACh = TdxCharacters.Space) or
    (ACh = TdxCharacters.NonBreakingSpace);
end;

function TdxSentencePositionCalculator.IsSpecialSentenceSeparator
  (const ACh: Char): Boolean;
begin
  Result := CharInSet(ACh, [TdxCharacters.ParagraphMark,
    TdxCharacters.ColumnBreak, TdxCharacters.PageBreak,
    TdxCharacters.SectionMark, TdxCharacters.LineBreak,
    TdxCharacters.FloatingObjectMark]) or (ACh = TdxCharacters.ObjectMark);
end;

function TdxSentencePositionCalculator.IsSimpleSentenceSeparator
  (const ACh: Char): Boolean;
begin
  Result := CharInSet(ACh, ['.', '!', '?']);
end;

function TdxSentencePositionCalculator.IsSentenceSeparator
  (const ACh: Char): Boolean;
begin
  Result := (IsSimpleSentenceSeparator(ACh)) or
    (IsSpecialSentenceSeparator(ACh));
end;

function TdxSentencePositionCalculator.IsStartOfDocument
  (const APos: TdxDocumentModelPosition;
  AWordIterator: TdxSpellCheckerWordIterator): Boolean;
begin
  Result := AWordIterator.IsStartOfDocument(APos);
end;

function TdxSentencePositionCalculator.IsEndOfDocument
  (const APos: TdxDocumentModelPosition;
  AWordIterator: TdxSpellCheckerWordIterator): Boolean;
begin
...
function TdxSentencePositionCalculator.GetSentenceEndPosition
  (const APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
var
...
begin
  ...
  begin
    ...
    if not {$IFDEF DELPHIXE4}GetCharacter(Result)
      .IsLetter{$ELSE}TCharacter.IsLetter(GetCharacter(Result)){$ENDIF} then
    begin
...
function TdxSentencePositionCalculator.GetSentenceEndPositionCore
  (const APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
begin
  if IsEndOfDocument(APos, FWordIterator) then
    Exit(APos);
  Result := FWordIterator.MoveToWordEnd(APos);
  while not IsEndOfDocument(Result, FWordIterator) and
    not IsSentenceSeparator(GetCharacter(Result)) do
  begin
...
function TdxSentencePositionCalculator.GetSentenceStartPosition
  (const APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
var
  AStart, AFinish: TdxDocumentModelPosition;
begin
  ...
  begin
    ...
    AStart := FindPrevLetterOrDigitPosition(Result);
    AFinish := FindLetterOrDigitPosition(Result);
    if not {$IFDEF DELPHIXE4}GetCharacter(ProcessPunctuation(AStart, AFinish))
      .IsLetter{$ELSE}TCharacter.IsLetter
      (GetCharacter(ProcessPunctuation(AStart, AFinish))){$ENDIF} then
      Break
    else
...
function TdxSentencePositionCalculator.GetSentenceStartPositionCore
  (const APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
var
...
function TdxSentencePositionCalculator.FindSentenceStart
  (const APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
begin
  Result := APos;
  FWordIterator.MoveToPrevChar(Result);
...
function TdxSentencePositionCalculator.ProcessPunctuation(const AStart,
  AFinish: TdxDocumentModelPosition): TdxDocumentModelPosition;
var
  ACurrentPosition, ASpacePositionAfterThreeDots, ASeparatorPosition,
    APunctuationPosition, ASpacePositionAfterSimpleSentenceSeparator
    : TdxDocumentModelPosition;
...
begin
  ...
  AIsNextWordStartWithUpperCase :=
  {$IFDEF DELPHIXE4}GetCharacter(AFinish).IsUpper{$ELSE}TCharacter.IsUpper
    (GetCharacter(AFinish)){$ENDIF};
  ASentenceSeparatorsCount := 0;
  while (ACurrentPosition <= AFinish) and not FWordIterator.IsEndOfDocument
    (ACurrentPosition) do
  begin
    ...
    begin
      ASeparatorPosition := FindSentenceSeparatorAfterThreeDotsWithSpace
        (ASpacePositionAfterThreeDots);
      if ASeparatorPosition.IsValid then
        Exit(ASeparatorPosition);
      APunctuationPosition := FindPunctuationAfterThreeDotsWithSpace
        (ASpacePositionAfterThreeDots);
    ...
    ASpacePositionAfterSimpleSentenceSeparator := FindSentenceSeparatorWithSpace
      (ACurrentPosition);
...
function TdxSentencePositionCalculator.
  FindSentenceSeparatorAfterThreeDotsWithSpace
  (const APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
begin
  Result := APos;
...
function TdxSentencePositionCalculator.FindPunctuationAfterThreeDotsWithSpace
  (const APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
begin
  Result := APos;
  FWordIterator.SkipForward(Result, IsSpace);
...
function TdxSentencePositionCalculator.FindAbbreviation(const AStart,
  AFinish: TdxDocumentModelPosition): TdxDocumentModelPosition;
var
  ASentenceSeparatorsCount: Integer;
  ...
  ACh: Char;
begin
  if not {$IFDEF DELPHIXE4}GetCharacter(AStart)
    .IsLetter{$ELSE}TCharacter.IsLetter(GetCharacter(AStart)){$ENDIF} then
    Exit(TdxDocumentModelPosition.Null);
  if not IsStartOfDocument(AStart, FWordIterator) and PrevCharIsLetter(AStart)
  then
    Exit(TdxDocumentModelPosition.Null);
...
function TdxSentencePositionCalculator.PrevCharIsLetter
...
begin
  ...
  Result := {$IFDEF DELPHIXE4}GetCharacter(ANewPos)
    .IsLetter{$ELSE}TCharacter.IsLetter(GetCharacter(ANewPos)){$ENDIF};
end;

function TdxSentencePositionCalculator.NextCharIsDot
  (const APos: TdxDocumentModelPosition): Boolean;
var
  ANewPos: TdxDocumentModelPosition;
begin
...
function TdxSentencePositionCalculator.FindLetterOrDigitPosition
  (const AStartPosition: TdxDocumentModelPosition): TdxDocumentModelPosition;
begin
  Result := AStartPosition;
  FWordIterator.SkipForward(Result, FWordIterator.IsNotLetterOrDigit);
end;

function TdxSentencePositionCalculator.FindPrevLetterOrDigitPosition
  (const APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
begin
  Result := APos;
  if {$IFDEF DELPHIXE4}GetCharacter(APos).IsLetter{$ELSE}TCharacter.IsLetter
    (GetCharacter(APos)){$ENDIF} then
    FWordIterator.MoveToPrevChar(Result);
  FWordIterator.SkipBackward(Result, FWordIterator.IsNotLetterOrDigit);
end;

function TdxSentencePositionCalculator.FindSentenceSeparatorWithSpace
  (const APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
begin
  Result := APos;
...
function TdxSentencePositionCalculator.FindThreeDotsWithSpace
  (const APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
begin
  Result := APos;
...
function TdxSentencePositionCalculator.SkipThreeDots
  (const APos: TdxDocumentModelPosition): Boolean;
var
  ANewPos: TdxDocumentModelPosition;
...
begin
  ...
  while (ARemainingDotsCount > 0) and not IsEndOfDocument(ANewPos,
    FWordIterator) do
  begin
    FWordIterator.MoveToNextChar(ANewPos);
...
function TdxRichEditTextController.DeleteWordCore(APieceTable: TdxPieceTable;
AStart: TdxDocumentLogPosition; AFinish: TdxDocumentLogPosition): Boolean;
begin
  if not CanEditRange(APieceTable, AStart, AFinish) then
    Exit(False);
  APieceTable.DeleteContent(AStart, AFinish - AStart,
    AStart >= APieceTable.DocumentEndLogPosition);
  Result := True;
end;

function TdxRichEditTextController.TryShiftStartPosition
  (const APos: TdxDocumentModelPosition;
AIterator: TdxVisibleCharactersIterator): Boolean;
var
...
begin
  ...
  if {$IFDEF DELPHIXE4}GetCharacter(APrevPos)
    .IsWhiteSpace{$ELSE}TCharacter.IsWhiteSpace(GetCharacter(APrevPos)){$ENDIF} then
  begin
...
function TdxRichEditTextController.IsPositionVisible
  (const APos: IdxSpellCheckerPosition): Boolean;
var
  APieceTable: TdxPieceTable;
...
function TdxRichEditTextController.IsRangeEditable(const AStart,
  AFinish: IdxSpellCheckerPosition): Boolean;
var
  APieceTable: TdxPieceTable;
  AModelPos: TdxDocumentModelPosition;
...
function TdxRichEditTextController.TryShiftEndPosition
  (const APos: TdxDocumentModelPosition;
AIterator: TdxVisibleCharactersIterator): Boolean;
var
  APrevPos: TdxDocumentModelPosition;
begin
  ...
  if {$IFDEF DELPHIXE4}GetCharacter(APos).IsWhiteSpace{$ELSE}TCharacter.
    IsWhiteSpace(GetCharacter(APos)){$ENDIF} then
  begin
    APrevPos := APos;
...
class function TdxRichEditTextController.GetCharacter
  (const APos: TdxDocumentModelPosition): Char;
var
  APieceTable: TdxPieceTable;
  ARunText: string;
begin
  ...
  ARunText := APieceTable.Runs[APos.RunIndex].GetNonEmptyText
    (APieceTable.TextBuffer);
  Result := ARunText[APos.RunOffset];
end;

function TdxRichEditTextController.GetModelPosition
  (APosition: TdxDocumentPosition): TdxDocumentModelPosition;
begin
  if APosition <> nil then
...
function TdxRichEditTextController.CreateDocumentPosition
  (const APos: TdxDocumentModelPosition): TdxDocumentPosition;
begin
  Result := TdxDocumentPosition.Create(APos);
end;

function TdxRichEditTextController.CreatePosition(ALogPosition: Integer)
  : IdxSpellCheckerPosition;
begin
  Result := CreateDocumentPosition(TdxPositionConverter.ToDocumentModelPosition
    (PieceTable, ALogPosition));
end;

function TdxRichEditTextController.GetVisibleText(APieceTable: TdxPieceTable;
const AStart, AEnd: TdxDocumentModelPosition): string;
var
...
begin
  ...
  if AStart.RunIndex = AEnd.RunIndex then
    Exit(GetRunText(APieceTable, AStart.RunIndex, AStart.RunOffset,
      AEnd.RunOffset - 1));
  AResult := TStringBuilder.Create;
  try
    AResult.Append(GetRunText(APieceTable, AStart.RunIndex, AStart.RunOffset,
      AStartRun.Length - 1));
    for I := AStart.RunIndex + 1 to AEnd.RunIndex - 1 do
      AResult.Append(GetRunText(APieceTable, I));
    if AEnd.RunOffset > 0 then
      AResult.Append(GetRunText(APieceTable, AEnd.RunIndex, 0,
        AEnd.RunOffset - 1));
...
function TdxRichEditTextController.GetRunText(APieceTable: TdxPieceTable;
AIndex: TdxRunIndex): string;
begin
  Result := GetRunText(APieceTable, AIndex, 0,
    APieceTable.Runs[AIndex].Length - 1);
end;

function TdxRichEditTextController.GetRunText(APieceTable: TdxPieceTable;
AIndex: TdxRunIndex; AFrom: Integer; ATo: Integer): string;
begin
...
function TdxRichEditTextController.ReplaceWordCore(APieceTable: TdxPieceTable;
const AWord: string; AStart: TdxDocumentLogPosition;
AFinish: TdxDocumentLogPosition): Boolean;
begin
  if not CanEditRange(APieceTable, AStart, AFinish) then
    Exit(False);
...
function TdxRichEditTextController.CanEditRange(APieceTable: TdxPieceTable;
AStart: TdxDocumentLogPosition; AFinish: TdxDocumentLogPosition): Boolean;
begin
...
function TdxRichEditTextController.GetSentenceStartPosition
  (const APos: IdxSpellCheckerPosition): IdxSpellCheckerPosition;
var
...
begin
  ...
  ACalculator := TdxSentencePositionCalculator.Create
    (GetWordIterator(AResult.PieceTable));
  try
...
function TdxRichEditTextController.GetSentenceFinishPosition
  (const APos: IdxSpellCheckerPosition): IdxSpellCheckerPosition;
var
  AResult: TdxDocumentModelPosition;
  ACalculator: TdxSentencePositionCalculator;
...
function TdxRichEditTextController.CanDoNextStep(const APosition
  : IdxSpellCheckerPosition): Boolean;
var
  APieceTable: TdxCustomPieceTable;
begin
  if APosition <> nil then
  begin
    ...
    Exit(TdxDocumentPosition(APosition).Position.LogPosition <
      APieceTable.DocumentEndLogPosition);
  end
  else
    Exit(True);
end;

function TdxRichEditTextController.DeleteWord(const AStart,
  AFinish: IdxSpellCheckerPosition): Boolean;
var
...
begin
  ...
  if not DeleteWordCore(APieceTable, AStartPosition.LogPosition,
    AFinishPosition.LogPosition) then
    Exit(False);
...
function TdxRichEditTextController.GetNextPosition
  (const APos: IdxSpellCheckerPosition): IdxSpellCheckerPosition;
var
...
function TdxRichEditTextController.GetNextWord(var AStart,
  AFinish: IdxSpellCheckerPosition): Boolean;
var
...
begin
  ...
  if APosStart.Compare(ASpellingStart) < 0 then
    Exit(False);
  Result := (APosFinish.Compare(APosStart) > 0) and
    IsPositionVisible(APosFinish) and IsPositionVisible(APosStart);
  if Result then
  begin
    AStart := APosStart;
    AFinish := APosFinish;
...
function TdxRichEditTextController.GetPrevPosition
  (const APos: IdxSpellCheckerPosition): IdxSpellCheckerPosition;
var
  APosition: TdxDocumentModelPosition;
  AIterator: TdxSpellCheckerWordIterator;
...
function TdxRichEditTextController.GetPreviousWord
  (const APos: IdxSpellCheckerPosition): string;
var
...
function TdxRichEditTextController.GetTextLength(const AText: string)
  : IdxSpellCheckerPosition;
var
  APieceTable: TdxPieceTable;
begin
  ...
  begin
    ...
    Exit(TdxDocumentPosition.Create(TdxDocumentModelPosition.FromRunStart
      (APieceTable, APieceTable.Runs.Count - 1)));
  end;
  Result := TdxPositionOffset.Create(Length(AText));
end;

function TdxRichEditTextController.IsFinishPositionRequest
  (const AText: string): Boolean;
begin
  Result := AText = Text;
end;

function TdxRichEditTextController.GetWord(const AStart,
  AFinish: IdxSpellCheckerPosition): string;
var
  APieceTable: TdxPieceTable;
begin
  if (not TdxDocumentPosition(AStart).IsValid) or
    (not TdxDocumentPosition(AFinish).IsValid) then
    Exit('');
  ...
  Result := GetVisibleText(APieceTable, TdxDocumentPosition(AStart).Position,
    TdxDocumentPosition(AFinish).Position);
end;

function TdxRichEditTextController.GetWordFinishPosition
  (const APos: IdxSpellCheckerPosition): IdxSpellCheckerPosition;
var
  APosition: TdxDocumentModelPosition;
  AIterator: TdxSpellCheckerWordIterator;
...
function TdxRichEditTextController.GetWordIterator
  (APieceTable: TdxCustomPieceTable): TdxSpellCheckerWordIterator;
begin
  raise EdxRichEditArgumentException.Create
    ('WordIterator is unavailable for base class');
end;

function TdxRichEditTextController.GetWordStartPosition
  (const APos: IdxSpellCheckerPosition): IdxSpellCheckerPosition;
var
  APosition: TdxDocumentModelPosition;
  AIterator: TdxSpellCheckerWordIterator;
...
function TdxRichEditTextController.HasLetters(const AStart,
  AFinish: IdxSpellCheckerPosition): Boolean;
var
  AWord: string;
...
begin
  ...
  begin
    if {$IFDEF DELPHIXE4}AWord[I].IsLetterOrDigit{$ELSE}TCharacter.
      IsLetterOrDigit(AWord[I]){$ENDIF} then
      Exit(True);
  end;
  Result := False;
end;

procedure TdxRichEditTextController.PreparePositionsForDelete(const AStart,
  AFinish: TdxDocumentModelPosition);
var
  AIterator: TdxVisibleCharactersIterator;
begin
  Assert(AStart.PieceTable = AFinish.PieceTable);
  AIterator := TdxVisibleCharactersIterator.Create
    (TdxPieceTable(AStart.PieceTable));
  try
...
function TdxRichEditTextController.ReplaceWord(const AStart,
  AFinish: IdxSpellCheckerPosition; const AWord: string): Boolean;
var
  AOldWord: string;
  APieceTable: TdxPieceTable;
begin
  ...
  APieceTable := TdxPieceTable(TdxDocumentPosition(AStart).Position.PieceTable);
  if not ReplaceWordCore(APieceTable, AWord, TdxDocumentPosition(AStart)
    .Position.LogPosition, TdxDocumentPosition(AFinish).Position.LogPosition)
  then
    Exit(False);
...
procedure TdxRichEditTextController.SetSpellingArea(const AStart,
...
function TdxRichEditTextController.ShouldCheckWord(const AStart,
  AEnd: IdxSpellCheckerPosition): Boolean;
begin
  Result := True;
end;
...
constructor TdxCheckAsYouTypeTextController.Create(const AControl
  : IdxInnerControl);
begin
  inherited Create(AControl);
...
begin
  Result := Control.IsEditable and
    (TdxSpellCheckerInstance.ISpellChecker3 <> nil) and
...
procedure TdxCheckAsYouTypeTextController.SetPieceTable
  (APieceTable: TdxPieceTable);
begin
  FPieceTable := APieceTable;
  Reset;
...
function TdxCheckAsYouTypeTextController.GetWordIterator
  (APieceTable: TdxCustomPieceTable): TdxSpellCheckerWordIterator;
begin
...
procedure TdxCheckAsYouTypeTextController.ResetSpellCheck(AStartRunIndex
  : TdxRunIndex; AEndRunIndex: TdxRunIndex);
begin
  if FWordIterator = nil then
    Exit;
  if (FWordIterator.CachedRunIndex >= AStartRunIndex) and
    (FWordIterator.CachedRunIndex <= AEndRunIndex) then
    Reset;
end;
...
procedure TdxSpellCheckerController.OnSpellCheckerCultureChanged
  (ASender: TObject);
begin
  ResetSpellCheck(0);
end;
...
procedure TdxSpellCheckerController.ResetSpellCheck(AStartRunIndex
  : TdxRunIndex);
begin
...
begin
  ...
  TdxCheckAsYouTypeTextController(FTextController)
    .ResetSpellCheck(AStartRunIndex, AEndRunIndex);
end;
...
procedure TdxSpellCheckerController.CheckContent(const AStart,
  AEnd: TdxDocumentModelPosition; APageIndex: Integer);
var
...
function TdxSpellCheckerController.CheckContentCore(const AStart,
  AEnd: TdxDocumentModelPosition): Boolean;
var
...
begin
  AIntervals := PieceTable.SpellCheckerManager.PopUncheckedIntervals
    (AStart, AEnd);
  ACount := Length(AIntervals);
  if ACount = 0 then
    Exit(True);
  try
    ...
    begin
      ...
      PieceTable.SpellCheckerManager.RemoveMisspelledIntervals(AInterval.Start,
        AInterval.&End);
...
procedure TdxSpellCheckerController.ClearErrorBoxes
  (AFrom: TdxDocumentLogPosition; ATo: TdxDocumentLogPosition);
var
  ACalculator: TdxSpellCheckerErrorBoxCalculator;
begin
  ACalculator := CreateErrorBoxCalculator;
...
procedure TdxSpellCheckerController.CalculateErrorBoxes(const AStart,
  AEnd: TdxDocumentModelPosition; APageIndex: Integer);
var
...
begin
  AIntervals := PieceTable.SpellCheckerManager.MisspelledIntervals.GetIntervals
    (AStart.LogPosition, AEnd.LogPosition);
  ACount := Length(AIntervals);
  if ACount = 0 then
    Exit;
  ...
  try
    ...
    begin
      ...
      if AEnd < APos then
        ...
        ABoxEndPos := APos;
      ACalculator.Calculate(APageIndex, ABoxStartPos, ABoxEndPos,
        AIntervals[AIndex].ErrorType);
    end;
  finally
    ACalculator.Free;
  end;
...
function TdxSpellCheckerController.CheckInterval
  (AInterval: TdxSpellCheckerInterval): Boolean;
var
...
begin
  ...
  Result := SpellChecker.CheckAsync(AsControl, TextController, AStart, AEnd,
    ...
    begin
      ...
      if PieceTable.CanEditRange(AStart.LogPosition, AEnd.LogPosition) then
        CalculateMisspelledInterval(AStart, AEnd, AErrorInfo.Word,
          AErrorInfo.Error);
...
begin
  Result := PieceTable.SpellCheckerManager.MisspelledIntervals.Count >
    UpperLimit;
end;

procedure TdxSpellCheckerController.CalculateMisspelledInterval(const AStart,
  AEnd: TdxDocumentModelPosition; const AWord: string;
AError: TdxSpellingError);
begin
  if not IgnoreListManager.IgnoredList.Contains(AStart.LogPosition,
    AEnd.LogPosition, AWord) then
    PieceTable.SpellCheckerManager.CreateMisspelledInterval(AStart,
      AEnd, AError);
end;
...
procedure TdxEmptySpellCheckerController.SetPieceTable
  (const AValue: TdxPieceTable);
begin
end;
...
procedure TdxEmptySpellCheckerController.CheckContent(const AStart,
  AEnd: TdxDocumentModelPosition; APageIndex: Integer);
begin
end;
