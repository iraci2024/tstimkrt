...
type
  ...
  TdxCardinalEnglishNumericsProvider = class(TInterfacedObject,
    IdxNumericsProvider)
  strict private
  class var
  ...
  TdxOrdinalEnglishNumericsProvider = class(TInterfacedObject,
    IdxNumericsProvider)
  strict private
  class var
    FBillion: TArray<string>;
  ...
  TdxDescriptiveCardinalEnglishNumberConverter = class
  ...
  TdxDescriptiveOrdinalEnglishNumberConverter = class
    (TdxDescriptiveNumberConverterBase)
  protected
    function GetType: TdxRichEditNumberingFormat; override;
  ...
  strict private
    class var FEnding: TArray<string>;
  strict private
    class constructor Initialize;
  protected
...
begin
  ...
  FGeneralSingles := TArray<string>.Create('one', 'two', 'three', 'four',
    'five', 'six', 'seven', 'eight', 'nine', 'zero');
  FTeens := TArray<string>.Create('ten', 'eleven', 'twelve', 'thirteen',
    'fourteen', 'fifteen', 'sixteen', 'seventeen', 'eighteen', 'nineteen');
  FTenths := TArray<string>.Create('twenty', 'thirty', 'forty', 'fifty',
    'sixty', 'seventy', 'eighty', 'ninety');
  FHundreds := TArray<string>.Create('one hundred', 'two hundred',
...
begin
  FGeneralSingles := TArray<string>.Create('first', 'second', 'third', 'fourth',
    'fifth', 'sixth', 'seventh', 'eighth', 'ninth', 'zeroth');
  FSeparator := TArray<string>.Create(' ', '-');
  FTeens := TArray<string>.Create('tenth', 'eleventh', 'twelfth', 'thirteenth',
    'fourteenth', 'fifteenth', 'sixteenth', 'seventeenth', 'eighteenth',
    'nineteenth');
  FTenths := TArray<string>.Create('twentieth', 'thirtieth', 'fortieth',
    'fiftieth', 'sixtieth', 'seventieth', 'eightieth', 'ninetieth');
  FHundreds := TArray<string>.Create('one hundredth', 'two hundredth',
    'three hundredth', 'four hundredth', 'five hundredth', 'six hundredth',
    'seven hundredth', 'eight hundredth', 'nine hundredth');
...
function TdxDescriptiveCardinalEnglishNumberConverter.GetType
...
function TdxDescriptiveOrdinalEnglishNumberConverter.GetType
  : TdxRichEditNumberingFormat;
begin
  Result := TdxRichEditNumberingFormat.OrdinalText;
end;

procedure TdxDescriptiveOrdinalEnglishNumberConverter.GenerateDigits
...
function TdxOrdinalEnglishNumberConverter.ConvertNumberCore
  (AValue: Int64): string;
var
  ATemp: Int64;
begin
