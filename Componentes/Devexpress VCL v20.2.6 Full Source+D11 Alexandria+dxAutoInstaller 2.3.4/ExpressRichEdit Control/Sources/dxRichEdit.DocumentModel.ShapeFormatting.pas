...
type
  TdxShapeChangeType = (None, FillColor, OutlineColor, OutlineWidth, Rotation,
    BatchUpdate);
  ...
  TdxUsedShapeOption = (UseFillColor, UseOutlineColor, UseOutlineWidth,
    UseRotation);
  ...
  public
    ...
    property UseFillColor: Boolean index TdxUsedShapeOption.UseFillColor
      read GetVal write SetVal;
    property UseOutlineColor: Boolean index TdxUsedShapeOption.UseOutlineColor
      read GetVal write SetVal;
    property UseOutlineWidth: Boolean index TdxUsedShapeOption.UseOutlineWidth
      read GetVal write SetVal;
    property UseRotation: Boolean index TdxUsedShapeOption.UseRotation
      read GetVal write SetVal;
  end;
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxShapeInfo; override;
  end;

  { TdxShapeFormatting }

  TdxShapeFormatting = class(TdxIndexBasedObjectB<TdxShapeInfo,
    TdxShapeOptions>)
  private
    procedure SetFillColorCore(const AInfo: TdxShapeInfo;
      const AValue: TdxAlphaColor);
    procedure SetOutlineColorCore(const AInfo: TdxShapeInfo;
      const AValue: Integer);
    procedure SetOutlineWidthCore(const AInfo: TdxShapeInfo;
      const AValue: Integer);
  ...
  protected
    ...
    function PropertyEquals(const AOther: TdxIndexBasedObject<TdxShapeInfo,
      TdxShapeOptions>): Boolean; override;
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      const ADocumentModel: TdxCustomDocumentModel;
      const AFormattingInfo: TdxShapeInfo;
      const AFormattingOptions: TdxShapeOptions); reintroduce;

    function Clone: TdxCloneable; override;
    procedure CopyFrom(Source: TdxCloneable); overload; override;
    procedure CopyFrom(const AInfo: TdxShapeInfo;
      const AOptions: TdxShapeOptions); reintroduce; overload;
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxShapeFormatting; override;
  public
  ...
  strict protected
    ...
    function SetFillColorCore(const AInfo: TdxShapeFormatting;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetOutlineWidthCore(const AInfo: TdxShapeFormatting;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;

    function SetRotationCore(const AInfo: TdxShapeFormatting;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetOutlineColorCore(const AInfo: TdxShapeFormatting;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxShapeFormatting>; override;
  public
...
type
  ...
  public
    class function CalculateChangeActions(const AChange: TdxShapeChangeType)
...
begin
  Result := (FillColor = AInfo.FillColor) and
    (OutlineColor = AInfo.OutlineColor) and (OutlineWidth = AInfo.OutlineWidth)
    and (Rotation = AInfo.Rotation);
end;
...
function TdxShapeInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxShapeInfo;
begin
...
constructor TdxShapeFormatting.Create(APieceTable: TdxCustomPieceTable;
  const ADocumentModel: TdxCustomDocumentModel;
  const AFormattingInfo: TdxShapeInfo;
  const AFormattingOptions: TdxShapeOptions);
begin
...
function TdxShapeFormatting.PropertyEquals(const AOther
  : TdxIndexBasedObject<TdxShapeInfo, TdxShapeOptions>): Boolean;
begin
  Assert(AOther <> nil);
...
procedure TdxShapeFormatting.SetFillColorCore(const AInfo: TdxShapeInfo;
  const AValue: TdxAlphaColor);
begin
...
procedure TdxShapeFormatting.SetOutlineColorCore(const AInfo: TdxShapeInfo;
  const AValue: Integer);
begin
...
procedure TdxShapeFormatting.SetOutlineWidthCore(const AInfo: TdxShapeInfo;
  const AValue: Integer);
begin
...
procedure TdxShapeFormatting.SetRotationCore(const AInfo: TdxShapeInfo;
  const AValue: Integer);
begin
...
procedure TdxShapeFormatting.CopyFrom(const AInfo: TdxShapeInfo;
  const AOptions: TdxShapeOptions);
begin
...
constructor TdxShapeFormattingCache.Create(ADocumentModel
...
function TdxShapeFormattingCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxShapeFormatting;
begin
  Result := nil;
end;
...
const
  ShapeChangeActionsMap: array [TdxShapeChangeType]
...
begin
  Result := TdxShapeChangeActionsCalculator.CalculateChangeActions
    (TdxShapeChangeType.BatchUpdate);
end;

function TdxShape.GetCache(const ADocumentModel: TdxCustomDocumentModel)
  : TdxUniqueItemsCache<TdxShapeFormatting>;
begin
...
begin
  ...
  AEmptyInfo := GetCache(DocumentModel)
    [TdxShapeFormattingCache.EmptyShapeFormattingIndex];
...
function TdxShape.SetFillColorCore(const AInfo: TdxShapeFormatting;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.FillColor := TdxAlphaColor(AValue);
  Result := TdxShapeChangeActionsCalculator.CalculateChangeActions
    (TdxShapeChangeType.FillColor);
end;
...
function TdxShape.SetOutlineColorCore(const AInfo: TdxShapeFormatting;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.OutlineColor := TdxAlphaColor(AValue);
  Result := TdxShapeChangeActionsCalculator.CalculateChangeActions
    (TdxShapeChangeType.OutlineColor);
end;
...
function TdxShape.SetOutlineWidthCore(const AInfo: TdxShapeFormatting;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.OutlineWidth := AValue;
  Result := TdxShapeChangeActionsCalculator.CalculateChangeActions
    (TdxShapeChangeType.OutlineWidth);
end;
...
function TdxShape.SetRotationCore(const AInfo: TdxShapeFormatting;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.Rotation := AValue;
  Result := TdxShapeChangeActionsCalculator.CalculateChangeActions
    (TdxShapeChangeType.Rotation);
end;
