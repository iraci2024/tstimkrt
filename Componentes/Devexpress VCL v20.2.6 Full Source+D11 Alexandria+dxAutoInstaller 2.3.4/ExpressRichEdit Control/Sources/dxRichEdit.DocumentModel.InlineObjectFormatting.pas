...
type
  TdxInlineObjectChangeType = (None, ScaleX, ScaleY, BatchUpdate, Sizing);
  // for internal use

  TdxInlineCustomObjectChangeType = (None, State, BatchUpdate);
  // for internal use
  ...
  IdxInlineCustomObject = interface // for internal use
    ...
    function CalculateOriginalSize(AUnitConverter
      : TdxDocumentModelUnitConverter): TSize;
  end;
  ...
  public
    class function CalculateChangeActions(AChange: TdxInlineObjectChangeType)
  ...
  TdxInlineObjectProperties<T: TdxInlineObjectInfo> = class abstract
    (TdxRichEditIndexBasedObject<T>) // for internal use
  private
  ...
  TdxInlineCustomObjectProperties = class
    (TdxInlineObjectProperties<TdxInlineCustomObjectInfo>) // for internal use
  protected
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxInlineCustomObjectInfo>; override;
  ...
  TdxInlineCustomObjectInfoCache = class
    (TdxUniqueItemsCache<TdxInlineCustomObjectInfo>) // for internal use
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxInlineCustomObjectInfo; override;
  end;

  TdxResizingShadowDisplayMode = (Content, WireFrame); // for internal use

  TdxInlinePictureChangeType = (None = 0, BatchUpdate); // for internal use
  ...
  public
    ...
    property ResizingShadowDisplayMode: TdxResizingShadowDisplayMode
      read FResizingShadowDisplayMode write FResizingShadowDisplayMode;
  ...
  TdxInlinePictureProperties = class
    (TdxInlineObjectProperties<TdxInlinePictureInfo>) // for internal use
  strict private
  ...
  strict protected
    function SetFillColorCore(const AInfo: TdxInlinePictureInfo;
      const AValue: TdxAlphaColor): TdxDocumentModelChangeActions; virtual;
    function SetSizingCore(const AInfo: TdxInlinePictureInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetResizingShadowDisplayModeCore(const AInfo: TdxInlinePictureInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetLockAspectRatioCore(const AInfo: TdxInlinePictureInfo;
      const AValue: Boolean): TdxDocumentModelChangeActions; virtual;
    function SetPseudoInlineCore(const AInfo: TdxInlinePictureInfo;
      const AValue: Boolean): TdxDocumentModelChangeActions; virtual;
    ...
    function GetBatchUpdateChangeActions
      : TdxDocumentModelChangeActions; override;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxInlinePictureInfo>; override;
    procedure OnIndexChanged; override;

    property Owner: IdxInlinePicturePropertiesContainer read FOwner;
  public
    constructor Create(const AOwner: IdxInlinePicturePropertiesContainer);
      reintroduce;
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxInlinePictureInfo; override;
  end;
...
type
  ...
  public
    class function CalculateChangeActions(AChange: TdxInlinePictureChangeType)
      : TdxDocumentModelChangeActions; static;
  end;
  ...
  public
    class function CalculateChangeActions
      (AChange: TdxInlineCustomObjectChangeType)
      : TdxDocumentModelChangeActions; static;
  end;
...
begin
  Result := (AInfo <> nil) and (FScaleX = AInfo.ScaleX) and
    (FScaleY = AInfo.ScaleY);
end;
...
const
  InlineObjectChangeActionsMap: array [TdxInlineObjectChangeType]
...
begin
  ...
  begin
    ...
    AInfo.ScaleX := AValue;
    AChangeActions := TdxInlineObjectChangeActionsCalculator.
      CalculateChangeActions(TdxInlineObjectChangeType.ScaleX);
...
begin
  ...
  begin
    ...
    AInfo.ScaleY := AValue;
    AChangeActions := TdxInlineObjectChangeActionsCalculator.
      CalculateChangeActions(TdxInlineObjectChangeType.ScaleY);
    ReplaceInfoCore(AInfo, AChangeActions);
    AInfo.Free;
  end;
end;
...
class function TdxInlineCustomObjectChangeActionsCalculator.
  CalculateChangeActions(AChange: TdxInlineCustomObjectChangeType)
  : TdxDocumentModelChangeActions;
const
  InlineCustomObjectChangeActionsMap: array [TdxInlineCustomObjectChangeType]
    of TdxDocumentModelChangeActions = ([],
    [TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetPrimaryLayout,
    TdxDocumentModelChangeAction.ResetSecondaryLayout,
...
function TdxInlineCustomObjectProperties.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxInlineCustomObjectChangeActionsCalculator.CalculateChangeActions
    (TdxInlineCustomObjectChangeType.BatchUpdate);
end;

function TdxInlineCustomObjectProperties.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxInlineCustomObjectInfo>;
begin
  Result := TdxSimpleDocumentCache(ADocumentModel.Cache)
    .InlineCustomObjectInfoCache;
end;
...
function TdxInlineCustomObjectInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxInlineCustomObjectInfo;
begin
...
begin
  Result := Round(ScaleX) or (Round(ScaleY) shl 12) or (Ord(Sizing) shl 24) or
    (Ord(ResizingShadowDisplayMode) shl 28) or (Ord(LockAspectRatio) shl 29) or
    (Ord(PseudoInline) shl 30) or (FillColor shl 31);
end;
...
begin
  ...
  begin
    Result := (AInfo.Sizing = Sizing) and
      ...
      (AInfo.PseudoInline = PseudoInline) and (AInfo.FillColor = FillColor);
  end;
end;
...
const
  InlinePictureChangeActionsMap: array [TdxInlinePictureChangeType]
    of TdxDocumentModelChangeActions = ([],
    [TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetPrimaryLayout,
    TdxDocumentModelChangeAction.ResetSecondaryLayout,
...
constructor TdxInlinePictureProperties.Create(const AOwner
  : IdxInlinePicturePropertiesContainer);
begin
...
function TdxInlinePictureProperties.CreateIndexChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
  Result := FOwner.CreateInlinePicturePropertiesChangedHistoryItem;
end;

function TdxInlinePictureProperties.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxInlinePictureChangeActionsCalculator.CalculateChangeActions
    (TdxInlinePictureChangeType.BatchUpdate);
end;

function TdxInlinePictureProperties.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxInlinePictureInfo>;
begin
...
function TdxInlinePictureProperties.GetResizingShadowDisplayMode
  : TdxResizingShadowDisplayMode;
begin
...
function TdxInlinePictureProperties.SetFillColorCore
  (const AInfo: TdxInlinePictureInfo; const AValue: TdxAlphaColor)
  : TdxDocumentModelChangeActions;
begin
...
function TdxInlinePictureProperties.SetLockAspectRatioCore
  (const AInfo: TdxInlinePictureInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
...
function TdxInlinePictureProperties.SetPseudoInlineCore
  (const AInfo: TdxInlinePictureInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
...
procedure TdxInlinePictureProperties.SetResizingShadowDisplayMode
  (const Value: TdxResizingShadowDisplayMode);
begin
  SetPropertyValue<Integer>(SetResizingShadowDisplayModeCore, Ord(Value));
end;

function TdxInlinePictureProperties.SetResizingShadowDisplayModeCore
  (const AInfo: TdxInlinePictureInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
...
function TdxInlinePictureProperties.SetSizingCore
  (const AInfo: TdxInlinePictureInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.Sizing := TdxImageSizeMode(AValue);
  Result := TdxInlineObjectChangeActionsCalculator.CalculateChangeActions
    (TdxInlineObjectChangeType.Sizing);
end;

{ TdxInlinePictureInfoCache }

function TdxInlinePictureInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxInlinePictureInfo;
begin
