...
type
  ...
  TdxFloatingObjectAnchorRunMovedHistoryItem = class
  ...
  public
    ...
    property NewParagraphIndex: TdxParagraphIndex read FNewParagraphIndex
      write FNewParagraphIndex;
  end;
...
begin
  ...
  TdxDocumentModelStructureChangedNotifier.NotifyRunRemoved(PieceTable,
    PieceTable, ParagraphIndex, RunIndex, 1, FNotificationId1);
  AIndex := NewRunIndex;
  ...
  TdxDocumentModelStructureChangedNotifier.NotifyRunInserted(PieceTable,
    PieceTable, NewParagraphIndex, AIndex, 1, FNotificationId2);
end;
