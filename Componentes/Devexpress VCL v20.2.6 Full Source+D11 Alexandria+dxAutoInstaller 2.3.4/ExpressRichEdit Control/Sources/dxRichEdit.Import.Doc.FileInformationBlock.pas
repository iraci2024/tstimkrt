...
type
  ...
  TdxFileInformationFlag = (TemplateDocument, GlossaryDocument, ComplexFormat,
    HasPictures, QuickSaves, Encryped, TableStreamType, ReadOnlyRecommended,
    WritePreservation, ExtendedCharset, LoadOverride, FarEast, Obfuscated);
  ...
  public
    ...
    property FirstCharacterFileOffset: Integer read FFirstCharacterFileOffset
      write FFirstCharacterFileOffset;
    property LastCharacterFileOffset: Integer read FLastCharacterFileOffset
      write FLastCharacterFileOffset;
    property LastByteFileOffset: Integer read FLastByteFileOffset
      write FLastByteFileOffset;
    property FirstCHPXFormattedDiskPageNumber: Integer
      read FFirstCHPXFormattedDiskPageNumber
      write FFirstCHPXFormattedDiskPageNumber;
    property CharactersFormattedDiskPageCount: Integer
      read FCharactersFormattedDiskPageCount
      write FCharactersFormattedDiskPageCount;
    property FirstPAPXFormattedDiskPageNumber: Integer
      read FFirstPAPXFormattedDiskPageNumber
      write FFirstPAPXFormattedDiskPageNumber;
    property ParagraphsFormattedDiskPageCount: Integer
      read FParagraphsFormattedDiskPageCount
      write FParagraphsFormattedDiskPageCount;
    property MainDocumentLength: Integer read FMainDocumentLength
      write FMainDocumentLength;
    property FootNotesLength: Integer read FFootNotesLength
      write FFootNotesLength;
    property HeadersFootersLength: Integer read FHeadersFootersLength
      write FHeadersFootersLength;
    ...
    property MainDocumentTextBoxesLength: Integer
      read FMainDocumentTextBoxesLength write FMainDocumentTextBoxesLength;
    property HeaderTextBoxesLength: Integer read FHeaderTextBoxesLength
      write FHeaderTextBoxesLength;
    property ComplexFileInformationOffset: Integer
      read FComplexFileInformationOffset write FComplexFileInformationOffset;
    property ComplexFileInformationSize: Integer
      read FComplexFileInformationSize write FComplexFileInformationSize;
    property HeadersFootersPositionsOffset: Integer
      read FHeadersFootersPositionsOffset write FHeadersFootersPositionsOffset;
    property HeadersFootersPositionsSize: Integer
      read FHeadersFootersPositionsSize write FHeadersFootersPositionsSize;
    property CharacterTableOffset: Integer read FCharacterTableOffset
      write FCharacterTableOffset;
    property CharacterTableSize: Integer read FCharacterTableSize
      write FCharacterTableSize;
    property ParagraphTableOffset: Integer read FParagraphTableOffset
      write FParagraphTableOffset;
    property ParagraphTableSize: Integer read FParagraphTableSize
      write FParagraphTableSize;
    property SectionTableOffset: Integer read FSectionTableOffset
      write FSectionTableOffset;
    property SectionTableSize: Integer read FSectionTableSize
      write FSectionTableSize;
    property ParagraphHeightsOffset: Integer read FParagraphHeightsOffset
      write FParagraphHeightsOffset;
    property ParagraphHeightsSize: Integer read FParagraphHeightsSize
      write FParagraphHeightsSize;
    property StyleSheetOffset: Integer read FStyleSheetOffset
      write FStyleSheetOffset;
    property StyleSheetSize: Integer read FStyleSheetSize write FStyleSheetSize;
    property FootNotesReferenceOffset: Integer read FFootNotesReferenceOffset
      write FFootNotesReferenceOffset;
    property FootNotesReferenceSize: Integer read FFootNotesReferenceSize
      write FFootNotesReferenceSize;
    property FootNotesTextOffset: Integer read FFootNotesTextOffset
      write FFootNotesTextOffset;
    property FootNotesTextSize: Integer read FFootNotesTextSize
      write FFootNotesTextSize;
    property CommentsReferenceOffset: Integer read FCommentsReferenceOffset
      write FCommentsReferenceOffset;
    property CommentsReferenceSize: Integer read FCommentsReferenceSize
      write FCommentsReferenceSize;
    property CommentsTextOffset: Integer read FCommentsTextOffset
      write FCommentsTextOffset;
    property CommentsTextSize: Integer read FCommentsTextSize
      write FCommentsTextSize;
    property CommentsNameTableOffset: Integer read FCommentsNameTableOffset
      write FCommentsNameTableOffset;
    property CommentsNameTableSize: Integer read FCommentsNameTableSize
      write FCommentsNameTableSize;
    property CommentsFirstTableOffset: Integer read FCommentsFirstTableOffset
      write FCommentsFirstTableOffset;
    property CommentsFirstTableSize: Integer read FCommentsFirstTableSize
      write FCommentsFirstTableSize;
    property CommentsLimTableOffset: Integer read FCommentsLimTableOffset
      write FCommentsLimTableOffset;
    property CommentsLimTableSize: Integer read FCommentsLimTableSize
      write FCommentsLimTableSize;
    property CommentsAuthorTableOffset: Integer read FCommentsAuthorTableOffset
      write FCommentsAuthorTableOffset;
    property CommentsAuthorTableSize: Integer read FCommentsAuthorTableSize
      write FCommentsAuthorTableSize;
    property MainDocumentTextBoxesTextOffset: Integer
      read FMainDocumentTextBoxesTextOffset
      write FMainDocumentTextBoxesTextOffset;
    property MainDocumentTextBoxesTextSize: Integer
      read FMainDocumentTextBoxesTextSize write FMainDocumentTextBoxesTextSize;
    property HeaderTextBoxesTextOffset: Integer read FHeaderTextBoxesTextOffset
      write FHeaderTextBoxesTextOffset;
    property HeaderTextBoxesTextSize: Integer read FHeaderTextBoxesTextSize
      write FHeaderTextBoxesTextSize;
    property FontTableOffset: Integer read FFontTableOffset
      write FFontTableOffset;
    property FontTableSize: Integer read FFontTableSize write FFontTableSize;
    property MainDocumentFieldTableOffset: Integer
      read FMainDocumentFieldTableOffset write FMainDocumentFieldTableOffset;
    property MainDocumentFieldTableSize: Integer
      read FMainDocumentFieldTableSize write FMainDocumentFieldTableSize;
    property FootNotesFieldTableOffset: Integer read FFootNotesFieldTableOffset
      write FFootNotesFieldTableOffset;
    property FootNotesFieldTableSize: Integer read FFootNotesFieldTableSize
      write FFootNotesFieldTableSize;
    property HeadersFootersFieldTableOffset: Integer
      read FHeadersFootersFieldTableOffset
      write FHeadersFootersFieldTableOffset;
    property HeadersFootersFieldTableSize: Integer
      read FHeadersFootersFieldTableSize write FHeadersFootersFieldTableSize;
    property CommentsFieldTableOffset: Integer read FCommentsFieldTableOffset
      write FCommentsFieldTableOffset;
    property CommentsFieldTableSize: Integer read FCommentsFieldTableSize
      write FCommentsFieldTableSize;
    property EndNotesFieldTableOffset: Integer read FEndNotesFieldTableOffset
      write FEndNotesFieldTableOffset;
    property EndNotesFieldTableSize: Integer read FEndNotesFieldTableSize
      write FEndNotesFieldTableSize;
    property MainDocumentTextBoxesFieldTableOffset: Integer
      read FMainDocumentTextBoxesFieldTableOffset
      write FMainDocumentTextBoxesFieldTableOffset;
    property MainDocumentTextBoxesFieldTableSize: Integer
      read FMainDocumentTextBoxesFieldTableSize
      write FMainDocumentTextBoxesFieldTableSize;
    property HeaderTextBoxesFieldTableOffset: Integer
      read FHeaderTextBoxesFieldTableOffset
      write FHeaderTextBoxesFieldTableOffset;
    property HeaderTextBoxesFieldTableSize: Integer
      read FHeaderTextBoxesFieldTableSize write FHeaderTextBoxesFieldTableSize;
    property BookmarkNamesTableOffset: Integer read FBookmarkNamesTableOffset
      write FBookmarkNamesTableOffset;
    property BookmarkNamesTableSize: Integer read FBookmarkNamesTableSize
      write FBookmarkNamesTableSize;
    property BookmarkStartInfoOffset: Integer read FBookmarkStartInfoOffset
      write FBookmarkStartInfoOffset;
    property BookmarkStartInfoSize: Integer read FBookmarkStartInfoSize
      write FBookmarkStartInfoSize;
    property BookmarkEndInfoOffset: Integer read FBookmarkEndInfoOffset
      write FBookmarkEndInfoOffset;
    property BookmarkEndInfoSize: Integer read FBookmarkEndInfoSize
      write FBookmarkEndInfoSize;
    property MainDocumentFileShapeTableOffset: Integer
      read FMainDocumentFileShapeTableOffset
      write FMainDocumentFileShapeTableOffset;
    property MainDocumentFileShapeTableSize: Integer
      read FMainDocumentFileShapeTableSize
      write FMainDocumentFileShapeTableSize;
    property EndNotesReferenceOffset: Integer read FEndNotesReferenceOffset
      write FEndNotesReferenceOffset;
    property EndNotesReferenceSize: Integer read FEndNotesReferenceSize
      write FEndNotesReferenceSize;
    property EndnotesTextOffset: Integer read FEndnotesTextOffset
      write FEndnotesTextOffset;
    property EndnotesTextSize: Integer read FEndnotesTextSize
      write FEndnotesTextSize;
    property HeadersFootersFileShapeTableOffset: Integer
      read FHeadersFootersFileShapeTableOffset
      write FHeadersFootersFileShapeTableOffset;
    property HeadersFootersFileShapeTableSize: Integer
      read FHeadersFootersFileShapeTableSize
      write FHeadersFootersFileShapeTableSize;
    property DrawingObjectTableOffset: Integer read FDrawingObjectTableOffset
      write FDrawingObjectTableOffset;
    property DrawingObjectTableSize: Integer read FDrawingObjectTableSize
      write FDrawingObjectTableSize;
    property DocumentVariablesOffset: Integer read FDocumentVariablesOffset
      write FDocumentVariablesOffset;
    property DocumentVariablesSize: Integer read FDocumentVariablesSize
      write FDocumentVariablesSize;
    property ListFormatInformationOffset: Integer
      read FListFormatInformationOffset write FListFormatInformationOffset;
    property ListFormatInformationSize: Integer read FListFormatInformationSize
      write FListFormatInformationSize;
    property RangeEditPermissionsInformationOffset: Integer
      read FRangeEditPermissionsInformationOffset
      write FRangeEditPermissionsInformationOffset;
    property RangeEditPermissionsInformationSize: Integer
      read FRangeEditPermissionsInformationSize
      write FRangeEditPermissionsInformationSize;
    property RangeEditPermissionsStartInfoOffset: Integer
      read FRangeEditPermissionsStartInfoOffset
      write FRangeEditPermissionsStartInfoOffset;
    property RangeEditPermissionsStartInfoSize: Integer
      read FRangeEditPermissionsStartInfoSize
      write FRangeEditPermissionsStartInfoSize;
    property RangeEditPermissionsEndInfoOffset: Integer
      read FRangeEditPermissionsEndInfoOffset
      write FRangeEditPermissionsEndInfoOffset;
    property RangeEditPermissionsEndInfoSize: Integer
      read FRangeEditPermissionsEndInfoSize
      write FRangeEditPermissionsEndInfoSize;
    property RangeEditPermissionsUsernamesOffset: Integer
      read FRangeEditPermissionsUsernamesOffset
      write FRangeEditPermissionsUsernamesOffset;
    property RangeEditPermissionsUsernamesSize: Integer
      read FRangeEditPermissionsUsernamesSize
      write FRangeEditPermissionsUsernamesSize;
    property ListFormatOverrideInformationOffset: Integer
      read FListFormatOverrideInformationOffset
      write FListFormatOverrideInformationOffset;
    property ListFormatOverrideInformationSize: Integer
      read FListFormatOverrideInformationSize
      write FListFormatOverrideInformationSize;
    property MainTextBoxBreakTableOffset: Integer
      read FMainTextBoxBreakTableOffset write FMainTextBoxBreakTableOffset;
    property MainTextBoxBreakTableSize: Integer read FMainTextBoxBreakTableSize
      write FMainTextBoxBreakTableSize;
    property HeadersFootersTextBoxBreakTableOffset: Integer
      read FHeadersFootersTextBoxBreakTableOffset
      write FHeadersFootersTextBoxBreakTableOffset;
    property HeadersFootersTextBoxBreakTableSize: Integer
      read FHeadersFootersTextBoxBreakTableSize
      write FHeadersFootersTextBoxBreakTableSize;
    property DocumentPropertiesOffset: Integer read FDocumentPropertiesOffset
      write FDocumentPropertiesOffset;
    property DocumentPropertiesSize: Integer read FDocumentPropertiesSize
      write FDocumentPropertiesSize;
    property RmdThreadingOffset: Integer read FRmdThreadingOffset
      write FRmdThreadingOffset;
    property RmdThreadingSize: Integer read FRmdThreadingSize
      write FRmdThreadingSize;
    property DocumentFileRecordsOffset: Integer read FDocumentFileRecordsOffset
      write FDocumentFileRecordsOffset;
    property DocumentFileRecordsSize: Integer read FDocumentFileRecordsSize
      write FDocumentFileRecordsSize;
    ...
    property MainDocumentTextBoxesStart: Integer
      read GetMainDocumentTextBoxesStart;
  end;
...
class function TdxFileInformationFlagValues.ToFlags(AValue: Word)
  : TdxFileInformationFlags;
begin
  Result := [];
...
procedure TdxFileInformationBlock.ReadFormatSpecificInfo
...
procedure TdxFileInformationBlock.ReadFormattedDiskPagesInfo
  (AReader: TBinaryReader);
begin
  AReader.BaseStream.Seek(FirstCharacterFileOffsetPosition,
  ...
  AReader.BaseStream.Seek(FirstCHPXFormattedDiskPageNumberPosition,
    TSeekOrigin.soBeginning);
  FirstCHPXFormattedDiskPageNumber := AReader.ReadInt32;
  CharactersFormattedDiskPageCount := AReader.ReadInt32;
  AReader.BaseStream.Seek(FirstPAPXFormattedDiskPageNumberPosition,
    TSeekOrigin.soBeginning);
...
begin
  AReader.BaseStream.Seek(ComplexFileInformationOffsetPosition,
    TSeekOrigin.soBeginning);
  ComplexFileInformationOffset := AReader.ReadInt32;
  ComplexFileInformationSize := AReader.ReadInt32;
end;

procedure TdxFileInformationBlock.ReadDocumentStructureInfo
  (AReader: TBinaryReader);
begin
...
begin
  AReader.BaseStream.Seek(FootnotesReferenceOffsetPosition,
    TSeekOrigin.soBeginning);
  ...
  AReader.BaseStream.Seek(CommentsReferenceOffsetAuthor,
    TSeekOrigin.soBeginning);
  ...
  AReader.BaseStream.Seek(CommentsReferenceOffsetPosition,
    TSeekOrigin.soBeginning);
  ...
  AReader.BaseStream.Seek(EndnotesReferenceOffsetPosition,
    TSeekOrigin.soBeginning);
  ...
  AReader.BaseStream.Seek(MainDocumentTextBoxesTextOffsetPosition,
    TSeekOrigin.soBeginning);
  MainDocumentTextBoxesTextOffset := AReader.ReadInt32;
  MainDocumentTextBoxesTextSize := AReader.ReadInt32;
  AReader.BaseStream.Seek(HeaderTextBoxesTextBoxesTextOffsetPosition,
    TSeekOrigin.soBeginning);
...
begin
  AReader.BaseStream.Seek(CharacterTableOffsetPosition,
    TSeekOrigin.soBeginning);
  CharacterTableOffset := AReader.ReadInt32;
  CharacterTableSize := AReader.ReadInt32;
  AReader.BaseStream.Seek(ParagraphTableOffsetPosition,
    TSeekOrigin.soBeginning);
...
procedure TdxFileInformationBlock.ReadHeadersFootersInfo
  (AReader: TBinaryReader);
begin
  AReader.BaseStream.Seek(HeadersFootersPositionsOffsetPosition,
    TSeekOrigin.soBeginning);
...
begin
  AReader.BaseStream.Seek(MainDocumentFieldTablePosition,
    TSeekOrigin.soBeginning);
  ...
  AReader.BaseStream.Seek(MainDocumentTextBoxesFieldTablePosition,
    TSeekOrigin.soBeginning);
  MainDocumentTextBoxesFieldTableOffset := AReader.ReadInt32;
  MainDocumentTextBoxesFieldTableSize := AReader.ReadInt32;
  AReader.BaseStream.Seek(HeaderTextBoxesFieldTablePosition,
    TSeekOrigin.soBeginning);
...
begin
  AReader.BaseStream.Seek(ListFormatInformationOffsetPosition,
    TSeekOrigin.soBeginning);
  ListFormatInformationOffset := AReader.ReadInt32;
  ListFormatInformationSize := AReader.ReadInt32;

  AReader.BaseStream.Seek(ListFormatOverrideInformationOffsetPosition,
    TSeekOrigin.soBeginning);
...
procedure TdxFileInformationBlock.ReadShapesAndDrawingObjectsInfo
  (AReader: TBinaryReader);
begin
  AReader.BaseStream.Seek(MainDocumentFileShapeAddressesOffsetPosition,
    TSeekOrigin.soBeginning);
  MainDocumentFileShapeTableOffset := AReader.ReadInt32;
  MainDocumentFileShapeTableSize := AReader.ReadInt32;

  AReader.BaseStream.Seek(HeadersDocumentFileShapeAddressesOffsetPosition,
    TSeekOrigin.soBeginning);
  HeadersFootersFileShapeTableOffset := AReader.ReadInt32;
  HeadersFootersFileShapeTableSize := AReader.ReadInt32;

  AReader.BaseStream.Seek(DrawingObjectDataOffsetPosition,
    TSeekOrigin.soBeginning);
  DrawingObjectTableOffset := AReader.ReadInt32;
  DrawingObjectTableSize := AReader.ReadInt32;
end;

procedure TdxFileInformationBlock.ReadDocumentVariablesInfo
  (AReader: TBinaryReader);
begin
  AReader.BaseStream.Seek(DocumentVariablesOffsetPosition,
    TSeekOrigin.soBeginning);
  DocumentVariablesOffset := AReader.ReadInt32;
  DocumentVariablesSize := AReader.ReadInt32;
end;

procedure TdxFileInformationBlock.ReadDocumentPropertiesInfo
  (AReader: TBinaryReader);
begin
  AReader.BaseStream.Seek(DocumentPropertiesOffsetPosition,
    TSeekOrigin.soBeginning);
  DocumentPropertiesOffset := AReader.ReadInt32;
  DocumentPropertiesSize := AReader.ReadInt32;
end;

procedure TdxFileInformationBlock.ReadRangeEditPermissionsInfo
  (AReader: TBinaryReader);
begin
  AReader.BaseStream.Seek(RangeEditPermissionsInformationOffsetPosition,
    TSeekOrigin.soBeginning);
...
procedure TdxFileInformationBlock.ReadDocumentFileRecords
  (AReader: TBinaryReader);
begin
...
procedure TdxFileInformationBlock.WriteFormatSpecificInfo
...
begin
  AWriter.BaseStream.Seek(FootnotesReferenceOffsetPosition,
    TSeekOrigin.soBeginning);
  ...
  AWriter.BaseStream.Seek(CommentsReferenceOffsetAuthor,
    TSeekOrigin.soBeginning);
  ...
  AWriter.BaseStream.Seek(CommentsReferenceOffsetPosition,
    TSeekOrigin.soBeginning);
  ...
  AWriter.BaseStream.Seek(EndnotesReferenceOffsetPosition,
    TSeekOrigin.soBeginning);
  ...
  AWriter.BaseStream.Seek(MainDocumentTextBoxesTextOffsetPosition,
    TSeekOrigin.soBeginning);
  AWriter.Write(MainDocumentTextBoxesTextOffset);
  AWriter.Write(Cardinal(MainDocumentTextBoxesTextSize));
  AWriter.BaseStream.Seek(HeaderTextBoxesTextBoxesTextOffsetPosition,
    TSeekOrigin.soBeginning);
  AWriter.Write(HeaderTextBoxesTextOffset);
  AWriter.Write(Cardinal(HeaderTextBoxesTextSize));
end;

procedure TdxFileInformationBlock.WriteHeadersFootersInfo
  (AWriter: TBinaryWriter);
begin
  AWriter.BaseStream.Seek(HeadersFootersPositionsOffsetPosition,
    TSeekOrigin.soBeginning);
  AWriter.Write(HeadersFootersPositionsOffset);
  AWriter.Write(Cardinal(HeadersFootersPositionsSize));
end;

procedure TdxFileInformationBlock.WriteFormattedDiskPagesInfo
  (AWriter: TBinaryWriter);
begin
  AWriter.BaseStream.Seek(FirstCharacterFileOffsetPosition,
    TSeekOrigin.soBeginning);
  ...
  AWriter.BaseStream.Seek(FirstCHPXFormattedDiskPageNumberPosition,
    TSeekOrigin.soBeginning);
  AWriter.Write(FirstCHPXFormattedDiskPageNumber);
  AWriter.Write(CharactersFormattedDiskPageCount);
  AWriter.BaseStream.Seek(FirstPAPXFormattedDiskPageNumberPosition,
    TSeekOrigin.soBeginning);
...
begin
  AWriter.BaseStream.Seek(CharacterTableOffsetPosition,
    TSeekOrigin.soBeginning);
  AWriter.Write(CharacterTableOffset);
  AWriter.Write(Cardinal(CharacterTableSize));
  AWriter.BaseStream.Seek(ParagraphTableOffsetPosition,
    TSeekOrigin.soBeginning);
...
procedure TdxFileInformationBlock.WriteDocumentStructureInfo
  (AWriter: TBinaryWriter);
begin
...
procedure TdxFileInformationBlock.WriteInsufficientMemoryInfo
  (AWriter: TBinaryWriter);
begin
  AWriter.BaseStream.Seek(InsufficientMemoryCHPXPageNumberPosition,
    TSeekOrigin.soBeginning);
  AWriter.Write(InsufficientMemoryPageNumber);
  AWriter.BaseStream.Seek(InsufficientMemoryPAPXPageNumberPosition,
    TSeekOrigin.soBeginning);
  AWriter.Write(InsufficientMemoryPageNumber);
  AWriter.BaseStream.Seek(InsufficientMemoryLVCPageNumberPosition,
    TSeekOrigin.soBeginning);
  AWriter.Write(InsufficientMemoryPageNumber);
end;
...
begin
  AWriter.BaseStream.Seek(StyleSheetOffsetOriginalPosition,
    TSeekOrigin.soBeginning);
...
begin
  AWriter.BaseStream.Seek(MainDocumentFieldTablePosition,
    TSeekOrigin.soBeginning);
  ...
  AWriter.BaseStream.Seek(MainDocumentTextBoxesFieldTablePosition,
    TSeekOrigin.soBeginning);
  AWriter.Write(MainDocumentTextBoxesFieldTableOffset);
  AWriter.Write(Cardinal(MainDocumentTextBoxesFieldTableSize));
  AWriter.BaseStream.Seek(HeaderTextBoxesFieldTablePosition,
    TSeekOrigin.soBeginning);
...
begin
  AWriter.BaseStream.Seek(ComplexFileInformationOffsetPosition,
    TSeekOrigin.soBeginning);
  AWriter.Write(ComplexFileInformationOffset);
  AWriter.Write(Cardinal(ComplexFileInformationSize));
end;

procedure TdxFileInformationBlock.WriteShapesAndDrawingObjectsInfo
  (AWriter: TBinaryWriter);
begin
  AWriter.BaseStream.Seek(MainDocumentFileShapeAddressesOffsetPosition,
    TSeekOrigin.soBeginning);
  AWriter.Write(MainDocumentFileShapeTableOffset);
  AWriter.Write(Cardinal(MainDocumentFileShapeTableSize));
  AWriter.BaseStream.Seek(HeadersDocumentFileShapeAddressesOffsetPosition,
    TSeekOrigin.soBeginning);
  AWriter.Write(HeadersFootersFileShapeTableOffset);
  AWriter.Write(Cardinal(HeadersFootersFileShapeTableSize));

  AWriter.BaseStream.Seek(DrawingObjectDataOffsetPosition,
    TSeekOrigin.soBeginning);
...
begin
  ...
  begin
    AWriter.BaseStream.Seek(DocumentFileRecordsPosition,
      TSeekOrigin.soBeginning);
    AWriter.Write(DocumentFileRecordsOffset);
    AWriter.Write(Cardinal(DocumentFileRecordsSize));
  end;
  AWriter.BaseStream.Seek(ListFormatInformationOffsetPosition,
    TSeekOrigin.soBeginning);
  AWriter.Write(ListFormatInformationOffset);
  AWriter.Write(Cardinal(ListFormatInformationSize));
  AWriter.BaseStream.Seek(ListFormatOverrideInformationOffsetPosition,
    TSeekOrigin.soBeginning);
...
procedure TdxFileInformationBlock.WriteDocumentVariablesInfo
  (AWriter: TBinaryWriter);
begin
  AWriter.BaseStream.Seek(DocumentVariablesOffsetPosition,
    TSeekOrigin.soBeginning);
  AWriter.Write(DocumentVariablesOffset);
  AWriter.Write(DocumentVariablesSize);
end;

procedure TdxFileInformationBlock.WriteDocumentPropertiesInfo
  (AWriter: TBinaryWriter);
begin
  AWriter.BaseStream.Seek(DocumentPropertiesOffsetPosition,
    TSeekOrigin.soBeginning);
  AWriter.Write(DocumentPropertiesOffset);
  AWriter.Write(Cardinal(DocumentPropertiesSize));
end;

procedure TdxFileInformationBlock.WriteRangeEditPermissionsInfo
  (AWriter: TBinaryWriter);
begin
  AWriter.BaseStream.Seek(RangeEditPermissionsInformationOffsetPosition,
    TSeekOrigin.soBeginning);
