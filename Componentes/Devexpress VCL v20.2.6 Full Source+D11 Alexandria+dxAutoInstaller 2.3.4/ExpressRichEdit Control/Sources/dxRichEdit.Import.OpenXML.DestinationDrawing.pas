...
type
  ...
  public
    ...
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxDrawingDestination; static;
    class function OnInline(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnAnchor(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    ...
    property FloatingObjectImportInfo: TdxFloatingObjectImportInfo
      read FFloatingObjectImportInfo;
  end;
  ...
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxDrawingInlineDestination; static;
    class function OnExtent(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnGraphic(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  public
    constructor Create(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  ...
  public
    ...
    class function OnGraphic(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnSimplePosition(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnAnchorHorizontalRelativeSize
      (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
    class function OnAnchorVerticalRelativeSize
      (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
    class function OnHorizontalPosition(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnVerticalPosition(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnWrapNone(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnWrapSquare(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnWrapThrough(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnWrapTight(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnWrapTopAndBottom(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnCNvGraphicFramePr(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnAnchorDocumentProperties
      (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
  ...
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxDrawingAnchorGraphicFramePropertyDestination; static;
    class function OnGraphicFrameLocks(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  public
    constructor Create(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  ...
  TdxDrawingAnchorDocumentPropertiesDestination = class
  ...
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxDrawingInlineGraphicDestination; static;
    class function OnGraphicData(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  ...
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxDrawingInlineGraphicDataDestination; static;
    class function OnPicture(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnWordProcessingShape(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  public
    constructor Create(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  ...
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxDrawingInlineGraphicDataPictureDestination; static;
    class function OnBlipFill(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnShapeProperties(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnAlternateContent(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnChoice(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnFallback(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  public
    constructor Create(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  ...
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxPictureBlipFillDestination; static;
    class function OnBlip(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
  public
    constructor Create(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AFloatingObjectImportInfo: TdxFloatingObjectImportInfo);
  ...
  public
    constructor Create(AImporter: TdxOpenXmlImporter;
      AFloatingObjectImportInfo: TdxFloatingObjectImportInfo);
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;
  ...
  TdxDrawingAnchorRelativeSizeBaseDestination = class abstract
  ...
  public
    constructor Create(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AAnchorDestination: TdxDrawingAnchorDestination);
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxDrawingAnchorRelativeSizeBaseDestination; static;
    procedure ProcessElementClose(AReader: TdxXmlReader); override;

    property Value: Integer read FVal write FVal;
    property AnchorDestination: TdxDrawingAnchorDestination
      read FAnchorDestination;
  end;

  { TdxDrawingAnchorHorizontalRelativeSizeDestination }

  TdxDrawingAnchorHorizontalRelativeSizeDestination = class
    (TdxDrawingAnchorRelativeSizeBaseDestination)
  strict private
    class var FHandlerTable: TdxElementHandlerTable;
    class constructor Initialize;
  ...
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxDrawingAnchorHorizontalRelativeSizeDestination; static;
    procedure ProcessElementCloseCore(AReader: TdxXmlReader); override;
    class function OnPictureWidth(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  public
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;

    property RelativeFrom: TdxFloatingObjectRelativeFromHorizontal
      read FRelativeFrom write FRelativeFrom;
  end;

  { TdxDrawingAnchorVerticalRelativeSizeDestination }

  TdxDrawingAnchorVerticalRelativeSizeDestination = class
    (TdxDrawingAnchorRelativeSizeBaseDestination)
  strict private
    class var FHandlerTable: TdxElementHandlerTable;
    class constructor Initialize;
  ...
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxDrawingAnchorVerticalRelativeSizeDestination; static;
    procedure ProcessElementCloseCore(AReader: TdxXmlReader); override;
    class function OnPictureHeight(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  public
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;

    property RelativeFrom: TdxFloatingObjectRelativeFromVertical
      read FRelativeFrom write FRelativeFrom;
  end;

  { TdxDrawingAnchorRelativeSizeValueDestination }

  TdxDrawingAnchorRelativeSizeValueDestination = class
    (TdxLeafElementDestination)
  strict private
  ...
  TdxDrawingAnchorPositionBaseDestination = class abstract
    (TdxElementDestination)
  strict private
    FAnchorDestination: TdxDrawingAnchorDestination;
    FOffset: Integer;
  ...
  protected
    class function OnPositionOffset(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnPositionPercentOffset
      (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
    procedure ProcessElementCloseCore(AReader: TdxXmlReader); virtual; abstract;
  public
    constructor Create(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AAnchorDestination: TdxDrawingAnchorDestination);
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxDrawingAnchorPositionBaseDestination; static;
    procedure ProcessElementClose(AReader: TdxXmlReader); override;
  ...
  TdxDrawingAnchorHorizontalPositionDestination = class
    (TdxDrawingAnchorPositionBaseDestination)
  strict private
    class var FHandlerTable: TdxElementHandlerTable;
    class constructor Initialize;
  ...
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    procedure ProcessElementCloseCore(AReader: TdxXmlReader); override;
    class function OnHorizontalAlignment(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;

  public
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxDrawingAnchorHorizontalPositionDestination; static;
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;

    property Alignment: TdxFloatingObjectHorizontalPositionAlignment
      read FAlignment write FAlignment;
  end;

  { TdxDrawingAnchorVerticalPositionDestination }

  TdxDrawingAnchorVerticalPositionDestination = class
    (TdxDrawingAnchorPositionBaseDestination)
  strict private
    class var FHandlerTable: TdxElementHandlerTable;
    class constructor Initialize;
  ...
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    procedure ProcessElementCloseCore(AReader: TdxXmlReader); override;
    class function OnVerticalAlignment(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  public
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxDrawingAnchorVerticalPositionDestination; static;
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;

    property Alignment: TdxFloatingObjectVerticalPositionAlignment
      read FAlignment write FAlignment;
  end;
  ...
  TdxDrawingAnchorPositionPercentOffsetDestination = class
    (TdxLeafElementDestination)
  strict private
    FPositionDestination: TdxDrawingAnchorPositionBaseDestination;
  public
  ...
  TdxDrawingAnchorPositionHorizontalAlignmentDestination = class
    (TdxLeafElementDestination)
  strict private
  ...
  TdxDrawingAnchorPositionVerticalAlignmentDestination = class
    (TdxLeafElementDestination)
  strict private
  ...
  TdxDrawingAnchorPolygonDestinationBase = class abstract
    (TdxLeafElementDestination)
  strict private
    FAnchorDestination: TdxDrawingAnchorDestination;
  protected
  ...
  TdxDrawingAnchorWrapSquareDestination = class
    (TdxDrawingAnchorPolygonDestinationBase)
  public
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;
  end;
  ...
  TdxDrawingAnchorWrapThroughDestination = class
    (TdxDrawingAnchorPolygonDestinationBase)
  public
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;
  end;
  ...
  TdxDrawingAnchorWrapTightDestination = class
    (TdxDrawingAnchorPolygonDestinationBase)
  public
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;
  end;
  ...
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxWordProcessingShapeDestination; static;
    class function OnTextBox(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnTextBoxProperties(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnShapeProperties(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  ...
  IdxOutlineAccessor = interface(IdxSolidFillAccessor)
    ...
    property OutlineColor: TdxAlphaColor read GetOutlineColor
  ...
  public type
    TdxShapeSolidFillAccessor = class(TInterfacedObject, IdxColorAccessor,
      IdxSolidFillAccessor)
    strict private
      FShape: TdxShape;
      function GetFillColor: TdxAlphaColor;
  ...
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxWordProcessingShapePropertiesDestination; static;
    class function OnSolidFill(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnNoFill(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnOutline(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnGraphicFrame(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  public
    constructor Create(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  ...
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxSolidFillDestination; static;
    class function OnSRgbColor(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnPresetColor(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnSchemeColor(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  public
    constructor Create(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  ...
  strict private
    ...
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxSRgbColorDestination; static;
    class function OnAlphaColor(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
  ...
  strict private
    ...
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxSchemeColorDestination; static;
    class function OnAlphaOffset(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnAlpha(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
      AReader: TdxXmlReader): TdxDestination; static;
    class function OnAlphaModulation(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  protected
    function GetElementHandlerTable: TdxElementHandlerTable; override;
  public
    ...
    function CalculateColorFactor(const AValue, AModulation,
      AOffset: TdxNullableValue<Single>): Single;
  ...
  public
    ...
    function GetValidMarginValue(AValue: Integer;
      ADefaultValue: Integer): Integer;
    function GetFloatValue(const ANumber: string): Integer;
    class function OnTextBoxContent(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  end;
  ...
  public
    ...
    procedure ProcessElementOpen(AReader: TdxXmlReader); override;
    class function GetThis(AImporter: TdxRichEditDestinationAndXmlBasedImporter)
      : TdxTextBoxPropertiesDestination; static;
    class function OnDisableAutoFit(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnEnableAutoFit(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  end;
  ...
  protected
    ...
    class function OnParagraph(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
    class function OnAltChunk(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  end;
...
constructor TdxDrawingDestination.Create(AImporter
  : TdxRichEditDestinationAndXmlBasedImporter);
begin
  inherited Create(AImporter);
  FFloatingObjectImportInfo := TdxFloatingObjectImportInfo.Create
    (AImporter.PieceTable);
end;
...
class function TdxDrawingDestination.CreateElementHandlerTable
...
procedure TdxDrawingDestination.SetTextBoxContent(const AValue
...
class function TdxDrawingDestination.GetThis
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter): TdxDrawingDestination;
begin
  Result := TdxDrawingDestination(AImporter.PeekDestination);
end;

class function TdxDrawingDestination.OnInline
...
begin
  ...
  Result := TdxDrawingInlineDestination.Create(AImporter,
    GetThis(AImporter).FloatingObjectImportInfo);
end;

class function TdxDrawingDestination.OnAnchor
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  GetThis(AImporter).FloatingObjectImportInfo.IsFloatingObject := True;

  Result := TdxDrawingAnchorDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter),
    GetThis(AImporter).FloatingObjectImportInfo);
end;
...
begin
  ...
  begin
    ...
    AOriginalSize := Image.CalculateImageSizeInModelUnits
      (Importer.DocumentModel.UnitConverter);

    ADesiredSize := TSize.Create(FFloatingObjectImportInfo.Width,
      FFloatingObjectImportInfo.Height);
    AScale := TdxImageScaleCalculator.GetScale(ADesiredSize,
      AOriginalSize, 100.0);
    ...
    PieceTable.AppendImage(Importer.Position, Image, AScale.Width,
      AScale.Height, AFillColor, False);
  end
  else
  begin
    ...
    begin
      ...
      begin
        ...
        FloatingObject.ActualSize := TSize.Create(Max(1, Width),
          Max(1, Height));
    end;
...
constructor TdxDrawingInlineDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AFloatingObjectImportInfo: TdxFloatingObjectImportInfo);
begin
  inherited Create(AImporter);
...
class function TdxDrawingInlineDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
function TdxDrawingInlineDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;

class function TdxDrawingInlineDestination.GetThis
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter)
  : TdxDrawingInlineDestination;
begin
...
class function TdxDrawingInlineDestination.OnExtent
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingInlineExtentDestination.Create(AImporter,
    GetThis(AImporter).FloatingObjectImportInfo);
end;

class function TdxDrawingInlineDestination.OnGraphic
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingInlineGraphicDestination.Create(AImporter,
    GetThis(AImporter).FloatingObjectImportInfo);
end;

{ TdxDrawingAnchorDestination }

constructor TdxDrawingAnchorDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AFloatingObjectImportInfo: TdxFloatingObjectImportInfo);
begin
  inherited Create(AImporter);
...
class function TdxDrawingAnchorDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
  Result.Add('extent', OnExtent);
...
function TdxDrawingAnchorDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;

function TdxDrawingAnchorDestination.GetFloatingObject
  : TdxFloatingObjectProperties;
begin
  Result := FFloatingObjectImportInfo.FloatingObjectProperties;
end;

function TdxDrawingAnchorDestination.IsChoiceNamespaceSupported
  (const ARequeriesNamespaceUri: string): Boolean;
begin
  if CompareText(ARequeriesNamespaceUri, TdxOpenXmlExporter.Wp14Namespace) = 0
  then
    Exit(True);
...
function TdxDrawingAnchorDestination.ConvertEmuToDocumentUnits
  (AValue: Integer): Integer;
begin
  Result := Round(UnitConverter.MillimetersToModelUnitsF(AValue / 36000.0));
end;

class function TdxDrawingAnchorDestination.GetThis
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter)
  : TdxDrawingAnchorDestination;
begin
...
class function TdxDrawingAnchorDestination.OnExtent
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingInlineExtentDestination.Create(AImporter,
...
class function TdxDrawingAnchorDestination.OnGraphic
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingInlineGraphicDestination.Create(AImporter,
...
class function TdxDrawingAnchorDestination.OnSimplePosition
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingAnchorSimplePositionDestination.Create(AImporter,
    GetThis(AImporter));
end;

class function TdxDrawingAnchorDestination.OnAnchorHorizontalRelativeSize
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingAnchorHorizontalRelativeSizeDestination.Create(AImporter,
    GetThis(AImporter));
end;

class function TdxDrawingAnchorDestination.OnAnchorVerticalRelativeSize
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingAnchorVerticalRelativeSizeDestination.Create(AImporter,
    GetThis(AImporter));
end;

class function TdxDrawingAnchorDestination.OnHorizontalPosition
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingAnchorHorizontalPositionDestination.Create(AImporter,
    GetThis(AImporter));
end;

class function TdxDrawingAnchorDestination.OnVerticalPosition
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingAnchorVerticalPositionDestination.Create(AImporter,
    GetThis(AImporter));
end;

class function TdxDrawingAnchorDestination.OnWrapNone
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingAnchorWrapNoneDestination.Create(AImporter,
    GetThis(AImporter));
end;

class function TdxDrawingAnchorDestination.OnWrapSquare
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingAnchorWrapSquareDestination.Create(AImporter,
    GetThis(AImporter));
end;

class function TdxDrawingAnchorDestination.OnWrapThrough
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingAnchorWrapThroughDestination.Create(AImporter,
    GetThis(AImporter));
end;

class function TdxDrawingAnchorDestination.OnWrapTight
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingAnchorWrapTightDestination.Create(AImporter,
    GetThis(AImporter));
end;

class function TdxDrawingAnchorDestination.OnWrapTopAndBottom
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingAnchorWrapTopAndBottomDestination.Create(AImporter,
    GetThis(AImporter));
end;

class function TdxDrawingAnchorDestination.OnCNvGraphicFramePr
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingAnchorGraphicFramePropertyDestination.Create(AImporter,
    GetThis(AImporter));
end;

class function TdxDrawingAnchorDestination.OnAnchorDocumentProperties
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingAnchorDocumentPropertiesDestination.Create(AImporter,
    GetThis(AImporter));
end;

{ TdxDrawingAnchorGraphicFramePropertyDestination }

constructor TdxDrawingAnchorGraphicFramePropertyDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AAnchorDestination: TdxDrawingAnchorDestination);
begin
  inherited Create(AImporter);
...
class function TdxDrawingAnchorGraphicFramePropertyDestination.
  CreateElementHandlerTable: TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
  Result.Add('graphicFrameLocks', OnGraphicFrameLocks);
end;

function TdxDrawingAnchorGraphicFramePropertyDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;
...
class function TdxDrawingAnchorGraphicFramePropertyDestination.GetThis
  ...
  : TdxDrawingAnchorGraphicFramePropertyDestination;
begin
  Result := TdxDrawingAnchorGraphicFramePropertyDestination
    (AImporter.PeekDestination);
end;

class function TdxDrawingAnchorGraphicFramePropertyDestination.
  OnGraphicFrameLocks(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AReader: TdxXmlReader): TdxDestination;
begin
  Result := TdxDrawingGraphicFrameLocksDestination.Create(AImporter,
    GetThis(AImporter));
end;

{ TdxDrawingGraphicFrameLocksDestination }

constructor TdxDrawingGraphicFrameLocksDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AAnchorDestination: TdxDrawingAnchorGraphicFramePropertyDestination);
begin
  inherited Create(AImporter);
...
procedure TdxDrawingGraphicFrameLocksDestination.ProcessElementOpen
...
constructor TdxDrawingInlineExtentDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AFloatingObjectImportInfo: TdxFloatingObjectImportInfo);
begin
  inherited Create(AImporter);
...
procedure TdxDrawingInlineExtentDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
var
  ACx, ACy: string;
begin
  ...
  FloatingObjectImportInfo.Width :=
    Round(UnitConverter.MillimetersToModelUnitsF(Importer.GetIntegerValue(ACx,
    TdxNumberStyles.Integer, 0) / 36000.0));
  FloatingObjectImportInfo.Height :=
    Round(UnitConverter.MillimetersToModelUnitsF(Importer.GetIntegerValue(ACy,
    TdxNumberStyles.Integer, 0) / 36000.0));
end;

{ TdxDrawingAnchorDocumentPropertiesDestination }

constructor TdxDrawingAnchorDocumentPropertiesDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AAnchorDestination: TdxDrawingAnchorDestination);
begin
  inherited Create(AImporter);
...
procedure TdxDrawingAnchorDocumentPropertiesDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
var
  AName: string;
begin
...
constructor TdxDrawingInlineGraphicDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AFloatingObjectImportInfo: TdxFloatingObjectImportInfo);
begin
  inherited Create(AImporter);
...
class function TdxDrawingInlineGraphicDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
function TdxDrawingInlineGraphicDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;
...
class function TdxDrawingInlineGraphicDestination.OnGraphicData
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingInlineGraphicDataDestination.Create(AImporter,
    GetThis(AImporter).FloatingObjectImportInfo);
end;

{ TdxDrawingInlineGraphicDataDestination }

constructor TdxDrawingInlineGraphicDataDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AFloatingObjectImportInfo: TdxFloatingObjectImportInfo);
begin
  inherited Create(AImporter);
...
class function TdxDrawingInlineGraphicDataDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
function TdxDrawingInlineGraphicDataDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;
...
class function TdxDrawingInlineGraphicDataDestination.OnPicture
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingInlineGraphicDataPictureDestination.Create(AImporter,
    GetThis(AImporter).FloatingObjectImportInfo);
end;
...
class function TdxDrawingInlineGraphicDataDestination.OnWordProcessingShape
  ...
  : TdxDestination;
begin
  Result := TdxWordProcessingShapeDestination.Create(AImporter,
    GetThis(AImporter).FloatingObjectImportInfo);
end;

{ TdxDrawingInlineGraphicDataPictureDestination }

constructor TdxDrawingInlineGraphicDataPictureDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AFloatingObjectImportInfo: TdxFloatingObjectImportInfo);
begin
  inherited Create(AImporter);
...
class function TdxDrawingInlineGraphicDataPictureDestination.
  CreateElementHandlerTable: TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
function TdxDrawingInlineGraphicDataPictureDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;
...
class function TdxDrawingInlineGraphicDataPictureDestination.GetThis
  ...
  : TdxDrawingInlineGraphicDataPictureDestination;
begin
  Result := TdxDrawingInlineGraphicDataPictureDestination
    (AImporter.PeekDestination);
end;

class function TdxDrawingInlineGraphicDataPictureDestination.OnBlipFill
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxPictureBlipFillDestination.Create(AImporter,
    GetThis(AImporter).FloatingObjectImportInfo);
end;

class function TdxDrawingInlineGraphicDataPictureDestination.OnShapeProperties
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxWordProcessingShapePropertiesDestination.Create(AImporter,
    GetThis(AImporter).FloatingObjectImportInfo.Shape);
end;

class function TdxDrawingInlineGraphicDataPictureDestination.OnAlternateContent
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxDrawingInlineGraphicDataPictureDestination.OnChoice
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := GetThis(AImporter);
...
class function TdxDrawingInlineGraphicDataPictureDestination.OnFallback
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := GetThis(AImporter);
...
constructor TdxPictureBlipFillDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AFloatingObjectImportInfo: TdxFloatingObjectImportInfo);
begin
  inherited Create(AImporter);
...
class function TdxPictureBlipFillDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
function TdxPictureBlipFillDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;

class function TdxPictureBlipFillDestination.GetThis
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter)
  : TdxPictureBlipFillDestination;
begin
...
class function TdxPictureBlipFillDestination.OnBlip
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
var
...
begin
  ...
  if AOpenXmlImporter = nil then
    Exit(nil);
  Result := TdxPictureBlipDestination.Create(AOpenXmlImporter,
    GetThis(AOpenXmlImporter).FloatingObjectImportInfo);
end;

{ TdxPictureBlipDestination }

constructor TdxPictureBlipDestination.Create(AImporter: TdxOpenXmlImporter;
  AFloatingObjectImportInfo: TdxFloatingObjectImportInfo);
begin
  inherited Create(AImporter);
  Assert(AFloatingObjectImportInfo <> nil, 'FloatingObjectImportInfo');
...
begin
  ...
  if AId <> '' then
  begin
    AImage := Importer.LookupImageByRelationId(AId,
      Importer.DocumentRootFolder);
    if AImage <> nil then
  ...
  if AId = '' then
    Exit;
  AImage := Importer.LookupExternalImageByRelationId(AId,
    Importer.DocumentRootFolder);
  if AImage <> nil then
    FloatingObjectImportInfo.Image := AImage;
end;
...
constructor TdxDrawingAnchorSimplePositionDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AAnchorDestination: TdxDrawingAnchorDestination);
begin
  inherited Create(AImporter);
...
procedure TdxDrawingAnchorSimplePositionDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
var
  X, Y: Integer;
begin
  ...
  begin
    ...
    FAnchorDestination.FloatingObject.HorizontalPositionType :=
      TdxFloatingObjectHorizontalPositionType.Page;
    FAnchorDestination.FloatingObject.VerticalPositionType :=
      TdxFloatingObjectVerticalPositionType.Page;
    FAnchorDestination.FloatingObject.HorizontalPositionAlignment :=
      TdxFloatingObjectHorizontalPositionAlignment.Left;
    FAnchorDestination.FloatingObject.VerticalPositionAlignment :=
...
constructor TdxDrawingAnchorRelativeSizeBaseDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AAnchorDestination: TdxDrawingAnchorDestination);
begin
  inherited Create(AImporter);
...
class function TdxDrawingAnchorRelativeSizeBaseDestination.GetThis
  ...
  : TdxDrawingAnchorRelativeSizeBaseDestination;
begin
  Result := TdxDrawingAnchorRelativeSizeBaseDestination
    (AImporter.PeekDestination);
end;

procedure TdxDrawingAnchorRelativeSizeBaseDestination.ProcessElementClose
  (AReader: TdxXmlReader);
begin
...
class function TdxDrawingAnchorHorizontalRelativeSizeDestination.
  CreateElementHandlerTable: TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
function TdxDrawingAnchorHorizontalRelativeSizeDestination.
  GetElementHandlerTable: TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;
...
class function TdxDrawingAnchorHorizontalRelativeSizeDestination.GetThis
  ...
  : TdxDrawingAnchorHorizontalRelativeSizeDestination;
begin
  Result := TdxDrawingAnchorHorizontalRelativeSizeDestination
    (AImporter.PeekDestination);
end;

procedure TdxDrawingAnchorHorizontalRelativeSizeDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
  RelativeFrom := TdxWordProcessingMLBaseImporter(Importer)
    .GetEnumValue<TdxFloatingObjectRelativeFromHorizontal>(AReader,
    'relativeFrom',
    TdxOpenXmlExporter.FloatingObjectRelativeFromHorizontalTable,
    TdxFloatingObjectRelativeFromHorizontal.Page);
end;

procedure TdxDrawingAnchorHorizontalRelativeSizeDestination.
  ProcessElementCloseCore(AReader: TdxXmlReader);
var
  AObj: TdxFloatingObjectProperties;
begin
  AObj := AnchorDestination.FloatingObject;
  AObj.RelativeWidth := TdxFloatingObjectRelativeWidth.Create
    (RelativeFrom, Value);
end;
...
class function TdxDrawingAnchorHorizontalRelativeSizeDestination.OnPictureWidth
  ...
  : TdxDestination;
begin
  Result := TdxDrawingAnchorRelativeSizeValueDestination.Create(AImporter,
    GetThis(AImporter));
end;
...
class function TdxDrawingAnchorVerticalRelativeSizeDestination.
  CreateElementHandlerTable: TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
function TdxDrawingAnchorVerticalRelativeSizeDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;
...
class function TdxDrawingAnchorVerticalRelativeSizeDestination.GetThis
  ...
  : TdxDrawingAnchorVerticalRelativeSizeDestination;
begin
  Result := TdxDrawingAnchorVerticalRelativeSizeDestination
    (AImporter.PeekDestination);
end;

procedure TdxDrawingAnchorVerticalRelativeSizeDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
  RelativeFrom := TdxWordProcessingMLBaseImporter(Importer)
    .GetEnumValue<TdxFloatingObjectRelativeFromVertical>(AReader,
    'relativeFrom', TdxOpenXmlExporter.floatingObjectRelativeFromVerticalTable,
    TdxFloatingObjectRelativeFromVertical.Page);
end;

procedure TdxDrawingAnchorVerticalRelativeSizeDestination.
  ProcessElementCloseCore(AReader: TdxXmlReader);
var
  AObj: TdxFloatingObjectProperties;
begin
  AObj := AnchorDestination.FloatingObject;
  AObj.RelativeHeight := TdxFloatingObjectRelativeHeight.Create
    (RelativeFrom, Value);
end;
...
constructor TdxDrawingAnchorRelativeSizeValueDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  APositionDestination: TdxDrawingAnchorRelativeSizeBaseDestination);
begin
  inherited Create(AImporter);
...
function TdxDrawingAnchorRelativeSizeValueDestination.ProcessText
  (AReader: TdxXmlReader): Boolean;
var
  AText: string;
begin
  AText := AReader.Value;
  if AText <> '' then
    FSizeDestination.Value := Importer.GetIntegerValue(AText,
      TdxNumberStyles.Integer, 100 * 1000);
  Result := True;
end;

{ TdxDrawingAnchorPositionBaseDestination }

constructor TdxDrawingAnchorPositionBaseDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AAnchorDestination: TdxDrawingAnchorDestination);
begin
  inherited Create(AImporter);
...
procedure TdxDrawingAnchorPositionBaseDestination.ProcessElementClose
  (AReader: TdxXmlReader);
begin
...
class function TdxDrawingAnchorPositionBaseDestination.OnPositionOffset
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingAnchorPositionOffsetDestination.Create(AImporter,
    GetThis(AImporter));
end;

class function TdxDrawingAnchorPositionBaseDestination.OnPositionPercentOffset
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingAnchorPositionPercentOffsetDestination.Create(AImporter,
    GetThis(AImporter));
end;
...
class function TdxDrawingAnchorHorizontalPositionDestination.
  CreateElementHandlerTable: TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
function TdxDrawingAnchorHorizontalPositionDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;
...
class function TdxDrawingAnchorHorizontalPositionDestination.GetThis
  ...
  : TdxDrawingAnchorHorizontalPositionDestination;
begin
  Result := TdxDrawingAnchorHorizontalPositionDestination
    (AImporter.PeekDestination);
end;

procedure TdxDrawingAnchorHorizontalPositionDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
  FRelativeTo := TdxWordProcessingMLBaseImporter(Importer)
    .GetEnumValue<TdxFloatingObjectHorizontalPositionType>(AReader,
    'relativeFrom',
    TdxOpenXmlExporter.FloatingObjectHorizontalPositionTypeTable,
    TdxFloatingObjectHorizontalPositionType.Page);
end;

procedure TdxDrawingAnchorHorizontalPositionDestination.ProcessElementCloseCore
  (AReader: TdxXmlReader);
var
  AObj: TdxFloatingObjectProperties;
...
class function TdxDrawingAnchorHorizontalPositionDestination.
  OnHorizontalAlignment(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AReader: TdxXmlReader): TdxDestination;
begin
  Result := TdxDrawingAnchorPositionHorizontalAlignmentDestination.Create
    (AImporter, GetThis(AImporter));
end;
...
class function TdxDrawingAnchorVerticalPositionDestination.
  CreateElementHandlerTable: TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
  Result.Add('posOffset', OnPositionOffset);
...
function TdxDrawingAnchorVerticalPositionDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;
...
class function TdxDrawingAnchorVerticalPositionDestination.GetThis
  ...
  : TdxDrawingAnchorVerticalPositionDestination;
begin
  Result := TdxDrawingAnchorVerticalPositionDestination
    (AImporter.PeekDestination);
end;

procedure TdxDrawingAnchorVerticalPositionDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
  FRelativeTo := TdxWordProcessingMLBaseImporter(Importer)
    .GetEnumValue<TdxFloatingObjectVerticalPositionType>(AReader,
    'relativeFrom', TdxOpenXmlExporter.floatingObjectVerticalPositionTypeTable,
    TdxFloatingObjectVerticalPositionType.Page);
end;

procedure TdxDrawingAnchorVerticalPositionDestination.ProcessElementCloseCore
  (AReader: TdxXmlReader);
var
  AObj: TdxFloatingObjectProperties;
  APoint, APercentOffset: TPoint;
...
class function TdxDrawingAnchorVerticalPositionDestination.OnVerticalAlignment
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxDrawingAnchorPositionVerticalAlignmentDestination.Create
    (AImporter, GetThis(AImporter));
end;

{ TdxDrawingAnchorPositionOffsetDestination }

constructor TdxDrawingAnchorPositionOffsetDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  APositionDestination: TdxDrawingAnchorPositionBaseDestination);
begin
  inherited Create(AImporter);
...
function TdxDrawingAnchorPositionOffsetDestination.ProcessText
  (AReader: TdxXmlReader): Boolean;
var
  AText: string;
begin
  AText := AReader.Value;
  FPositionDestination.Offset := Importer.GetIntegerValue(AText,
    TdxNumberStyles.Number, 0);
  Result := True;
end;

{ TdxDrawingAnchorPositionPercentOffsetDestination }

constructor TdxDrawingAnchorPositionPercentOffsetDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  APositionDestination: TdxDrawingAnchorPositionBaseDestination);
begin
  inherited Create(AImporter);
...
function TdxDrawingAnchorPositionPercentOffsetDestination.ProcessText
  (AReader: TdxXmlReader): Boolean;
var
  AText: string;
begin
  AText := AReader.Value;
  if AText <> '' then
    FPositionDestination.PercentOffset := Importer.GetIntegerValue(AText,
      TdxNumberStyles.Integer, 0);
  Result := True;
end;

{ TdxDrawingAnchorPositionHorizontalAlignmentDestination }

constructor TdxDrawingAnchorPositionHorizontalAlignmentDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  APositionDestination: TdxDrawingAnchorHorizontalPositionDestination);
begin
  inherited Create(AImporter);
...
function TdxDrawingAnchorPositionHorizontalAlignmentDestination.ProcessText
  (AReader: TdxXmlReader): Boolean;
var
  AText: string;
begin
  AText := AReader.Value;
  if AText <> '' then
    FPositionDestination.Alignment := TdxWordProcessingMLBaseImporter(Importer)
      .GetWpEnumValueCore<TdxFloatingObjectHorizontalPositionAlignment>(AText,
      TdxOpenXmlExporter.FloatingObjectHorizontalPositionAlignmentTable,
      TdxFloatingObjectHorizontalPositionAlignment.Left);
  Result := True;
end;
...
constructor TdxDrawingAnchorPositionVerticalAlignmentDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  APositionDestination: TdxDrawingAnchorVerticalPositionDestination);
begin
  inherited Create(AImporter);
...
function TdxDrawingAnchorPositionVerticalAlignmentDestination.ProcessText
  (AReader: TdxXmlReader): Boolean;
var
  AText: string;
begin
  ...
  if AText <> '' then
    FPositionDestination.Alignment := TdxWordProcessingMLBaseImporter(Importer)
      .GetWpEnumValueCore<TdxFloatingObjectVerticalPositionAlignment>(AText,
      TdxOpenXmlExporter.FloatingObjectVerticalPositionAlignmentTable,
      TdxFloatingObjectVerticalPositionAlignment.Top);
  Result := True;
end;
...
constructor TdxDrawingAnchorWrapNoneDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AAnchorDestination: TdxDrawingAnchorDestination);
begin
  inherited Create(AImporter);
...
procedure TdxDrawingAnchorWrapNoneDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
  FAnchorDestination.FloatingObject.TextWrapType :=
    TdxFloatingObjectTextWrapType.None;
end;

{ TdxDrawingAnchorWrapTopAndBottomDestination }

constructor TdxDrawingAnchorWrapTopAndBottomDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AAnchorDestination: TdxDrawingAnchorDestination);
begin
  inherited Create(AImporter);
...
procedure TdxDrawingAnchorWrapTopAndBottomDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
  FAnchorDestination.FloatingObject.TextWrapType :=
...
constructor TdxDrawingAnchorPolygonDestinationBase.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AAnchorDestination: TdxDrawingAnchorDestination);
begin
  inherited Create(AImporter);
...
procedure TdxDrawingAnchorPolygonDestinationBase.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
  if AReader.GetAttribute('wrapText', '') <> '' then
    AnchorDestination.FloatingObject.TextWrapSide :=
      TdxWordProcessingMLBaseImporter(Importer)
      .GetEnumValue<TdxFloatingObjectTextWrapSide>(AReader, 'wrapText',
      TdxOpenXmlExporter.FloatingObjectTextWrapSideTable,
      TdxFloatingObjectTextWrapSide.Both);
end;

{ TdxDrawingAnchorWrapSquareDestination }

procedure TdxDrawingAnchorWrapSquareDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
  inherited ProcessElementOpen(AReader);
  AnchorDestination.FloatingObject.TextWrapType :=
    TdxFloatingObjectTextWrapType.Square;
end;

{ TdxDrawingAnchorWrapThroughDestination }

procedure TdxDrawingAnchorWrapThroughDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
  inherited ProcessElementOpen(AReader);
  AnchorDestination.FloatingObject.TextWrapType :=
...
procedure TdxDrawingAnchorWrapTightDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
begin
  inherited ProcessElementOpen(AReader);
  AnchorDestination.FloatingObject.TextWrapType :=
...
constructor TdxWordProcessingShapeDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  AFloatingObjectImportInfo: TdxFloatingObjectImportInfo);
begin
  inherited Create(AImporter);
...
class function TdxWordProcessingShapeDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
function TdxWordProcessingShapeDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;

class function TdxWordProcessingShapeDestination.GetThis
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter)
  : TdxWordProcessingShapeDestination;
begin
...
class function TdxWordProcessingShapeDestination.OnTextBox
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxTextBoxDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter),
    GetThis(AImporter).FloatingObjectImportInfo);
end;

class function TdxWordProcessingShapeDestination.OnTextBoxProperties
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxTextBoxPropertiesDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter),
    GetThis(AImporter).FloatingObjectImportInfo.TextBoxProperties);
end;

class function TdxWordProcessingShapeDestination.OnShapeProperties
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxWordProcessingShapePropertiesDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter),
    GetThis(AImporter).FloatingObjectImportInfo.Shape);
end;
...
constructor TdxWordProcessingShapePropertiesDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AShape: TdxShape);
begin
  inherited Create(AImporter);
...
class function TdxWordProcessingShapePropertiesDestination.
  CreateElementHandlerTable: TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
function TdxWordProcessingShapePropertiesDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;
...
class function TdxWordProcessingShapePropertiesDestination.GetThis
  ...
  : TdxWordProcessingShapePropertiesDestination;
begin
  Result := TdxWordProcessingShapePropertiesDestination
    (AImporter.PeekDestination);
end;

class function TdxWordProcessingShapePropertiesDestination.OnSolidFill
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxSolidFillDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter),
    TdxShapeSolidFillAccessor.Create(GetThis(AImporter).Shape));
end;

class function TdxWordProcessingShapePropertiesDestination.OnNoFill
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxNoFillDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter),
    TdxShapeSolidFillAccessor.Create(GetThis(AImporter).Shape));
end;

class function TdxWordProcessingShapePropertiesDestination.OnOutline
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxOutlineDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter),
    TdxShapeOutlineAccessor.Create(GetThis(AImporter).Shape));
end;

class function TdxWordProcessingShapePropertiesDestination.OnGraphicFrame
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxGraphicFrameDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter), GetThis(AImporter).Shape);
end;

{ TdxWordProcessingShapePropertiesDestination.TdxShapeSolidFillAccessor }

constructor TdxWordProcessingShapePropertiesDestination.
  TdxShapeSolidFillAccessor.Create(AShape: TdxShape);
begin
  inherited Create;
  FShape := AShape;
end;

function TdxWordProcessingShapePropertiesDestination.TdxShapeSolidFillAccessor.
  GetFillColor: TdxAlphaColor;
begin
  Result := FShape.FillColor;
end;

procedure TdxWordProcessingShapePropertiesDestination.TdxShapeSolidFillAccessor.
  SetFillColor(const AValue: TdxAlphaColor);
begin
  FShape.FillColor := AValue;
end;

function TdxWordProcessingShapePropertiesDestination.TdxShapeSolidFillAccessor.
  GetColor: TdxAlphaColor;
begin
  Result := FShape.FillColor;
end;

procedure TdxWordProcessingShapePropertiesDestination.TdxShapeSolidFillAccessor.
  SetColor(const AValue: TdxAlphaColor);
begin
  FShape.FillColor := AValue;
end;
...
constructor TdxWordProcessingShapePropertiesDestination.TdxShapeOutlineAccessor.
  Create(AShape: TdxShape);
begin
  inherited Create;
  FShape := AShape;
end;

function TdxWordProcessingShapePropertiesDestination.TdxShapeOutlineAccessor.
  GetOutlineColor: TdxAlphaColor;
begin
  Result := FShape.OutlineColor;
end;

procedure TdxWordProcessingShapePropertiesDestination.TdxShapeOutlineAccessor.
  SetOutlineColor(const AValue: TdxAlphaColor);
begin
  FShape.OutlineColor := AValue;
end;

function TdxWordProcessingShapePropertiesDestination.TdxShapeOutlineAccessor.
  GetOutlineWidth: Integer;
begin
  Result := FShape.OutlineWidth;
end;

procedure TdxWordProcessingShapePropertiesDestination.TdxShapeOutlineAccessor.
  SetOutlineWidth(const AValue: Integer);
begin
...
constructor TdxSolidFillDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  const ASolidFillAccessor: IdxSolidFillAccessor);
begin
  inherited Create(AImporter);
...
class function TdxSolidFillDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
class function TdxSolidFillDestination.GetThis
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter)
  : TdxSolidFillDestination;
begin
...
class function TdxSolidFillDestination.OnSRgbColor
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxSRgbColorDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter),
    GetThis(AImporter).SolidFillAccessor);
end;

class function TdxSolidFillDestination.OnPresetColor
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxPresetColorDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter),
    GetThis(AImporter).SolidFillAccessor);
end;

class function TdxSolidFillDestination.OnSchemeColor
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxSchemeColorDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter),
    GetThis(AImporter).SolidFillAccessor);
end;
...
constructor TdxOutlineDestination.Create(AImporter
  : TdxRichEditDestinationAndXmlBasedImporter;
  const AOutlineAccessor: IdxOutlineAccessor);
begin
  inherited Create(AImporter);
...
class function TdxOutlineDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
  Result.Add('solidFill', OnSolidFill);
...
begin
  ...
  if AValue <> MinInt then
    FOutlineAccessor.OutlineWidth :=
      Importer.UnitConverter.EmuToModelUnits(AValue);
end;

class function TdxOutlineDestination.GetThis
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter): TdxOutlineDestination;
begin
  Result := TdxOutlineDestination(AImporter.PeekDestination);
end;

class function TdxOutlineDestination.OnSolidFill
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxSolidFillDestination.Create(AImporter,
    GetThis(AImporter).OutlineAccessor);
end;

class function TdxOutlineDestination.OnNoFill
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxNoFillDestination.Create(AImporter,
    GetThis(AImporter).OutlineAccessor);
end;

{ TdxSRgbColorDestination }

constructor TdxSRgbColorDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  const AColorAccessor: IdxColorAccessor);
begin
  inherited Create(AImporter);
...
class function TdxSRgbColorDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
class function TdxSRgbColorDestination.GetThis
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter)
  : TdxSRgbColorDestination;
begin
...
class function TdxSRgbColorDestination.OnAlphaColor
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxAlphaColorDestination.Create(AImporter,
    GetThis(AImporter).ColorAccessor);
end;
...
constructor TdxAlphaColorDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  const AColorAccessor: IdxColorAccessor);
begin
  inherited Create(AImporter);
...
constructor TdxPresetColorDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  const AColorAccessor: IdxColorAccessor);
begin
  inherited Create(AImporter);
...
begin
  AColor := TdxWordProcessingMLBaseImporter(Importer)
    .GetPresetColorValue(AReader, 'val');
  if AColor <> TdxAlphaColors.Empty then
    FColorAccessor.Color := AColor;
end;
...
constructor TdxNoFillDestination.Create(AImporter
  : TdxRichEditDestinationAndXmlBasedImporter;
  const AColorAccessor: IdxColorAccessor);
begin
  inherited Create(AImporter);
...
constructor TdxSchemeColorDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  const AColorAccessor: IdxColorAccessor);
begin
  inherited Create(AImporter);
...
class function TdxSchemeColorDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
class function TdxSchemeColorDestination.GetThis
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter)
  : TdxSchemeColorDestination;
begin
...
class function TdxSchemeColorDestination.OnAlphaOffset
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
var
...
begin
  ...
  Result := TdxPropertyDestination.Create
    (TdxWordProcessingMLBaseImporter(AImporter), ASetter);
end;

class function TdxSchemeColorDestination.OnAlpha
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
var
  ASetter: TdxAction<Integer>;
...
class function TdxSchemeColorDestination.OnAlphaModulation
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
var
  ASetter: TdxAction<Integer>;
...
function TdxSchemeColorDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;
...
begin
  ...
  FColorAccessor.Color := TdxAlphaColors.FromArgb(AActualAlpha,
    TdxAlphaColors.R(FBaseColor), TdxAlphaColors.G(FBaseColor),
    TdxAlphaColors.B(FBaseColor));
end;

function TdxSchemeColorDestination.CalculateActualAlpha
  (AValue: Integer): Integer;
var
  AAlphaFactor: Single;
begin
...
function TdxSchemeColorDestination.CalculateColorFactor(const AValue,
  AModulation, AOffset: TdxNullableValue<Single>): Single;
var
...
constructor TdxTextBoxDestination.Create(AImporter
  : TdxRichEditDestinationAndXmlBasedImporter;
  AFloatingObjectImportInfo: TdxFloatingObjectImportInfo);
begin
  inherited Create(AImporter);
  ...
  Importer.PushCurrentPieceTable
    (TdxTextBoxContentType.Create(AImporter.DocumentModel).PieceTable);
end;
...
class function TdxTextBoxDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
begin
  ...
  ATextBoxProperties.LeftMargin := GetValidMarginValue(AMargins[0],
    UnitConverter.DocumentsToModelUnits(30));
  ATextBoxProperties.RightMargin := GetValidMarginValue(AMargins[1],
    UnitConverter.DocumentsToModelUnits(30));
  ATextBoxProperties.TopMargin := GetValidMarginValue(AMargins[2],
    UnitConverter.DocumentsToModelUnits(15));
  ATextBoxProperties.BottomMargin := GetValidMarginValue(AMargins[3],
    UnitConverter.DocumentsToModelUnits(15));
end;
...
function TdxTextBoxDestination.GetMargins(const AStrMargins: string)
  : TArray<Integer>;
var
...
begin
  ...
  if Length(AMargins) < 4 then
    for I := Length(AMargins) to Length(Result) - 1 do
      Result[I] := UnitConverter.DocumentsToModelUnits
        (15 + IfThen(I < 2, 15, 0));
end;

function TdxTextBoxDestination.GetResizeShapeToFitText
  (const AStyle: string): Boolean;
begin
  Result := AStyle[Length(AStyle)] = 't';
end;

function TdxTextBoxDestination.GetValidMarginValue(AValue: Integer;
  ADefaultValue: Integer): Integer;
begin
  if AValue < 0 then
...
class function TdxTextBoxDestination.OnTextBoxContent
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
constructor TdxTextBoxPropertiesDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter;
  ATextBoxProperties: TdxTextBoxProperties);
begin
  inherited Create(AImporter);
...
class function TdxTextBoxPropertiesDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
function TdxTextBoxPropertiesDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;

procedure TdxTextBoxPropertiesDestination.ProcessElementOpen
  (AReader: TdxXmlReader);
var
  AValue: Integer;
  AWrapType: string;
...
begin
  ...
  AVerticalAlignment := TdxWordProcessingMLBaseImporter(Importer)
    .GetEnumValue<TdxVerticalAlignment>(AReader, 'anchor',
    TdxWordProcessingMLBaseExporter.TextBoxVerticalAlignmentTable,
    AInvalidValue);
  if AVerticalAlignment <> AInvalidValue then
    FTextBoxProperties.VerticalAlignment := AVerticalAlignment;
end;

class function TdxTextBoxPropertiesDestination.GetThis
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter)
  : TdxTextBoxPropertiesDestination;
begin
...
class function TdxTextBoxPropertiesDestination.OnDisableAutoFit
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxTextBoxPropertiesDestination.OnEnableAutoFit
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxTextBoxContentDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
function TdxTextBoxContentDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := FHandlerTable;
end;

class function TdxTextBoxContentDestination.OnTable
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxTextBoxContentDestination.OnParagraph
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxTextBoxContentDestination.OnAltChunk
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
constructor TdxGraphicFrameDestination.Create
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AShape: TdxShape);
begin
  inherited Create(AImporter);
  Assert(AShape <> nil, 'shape');
