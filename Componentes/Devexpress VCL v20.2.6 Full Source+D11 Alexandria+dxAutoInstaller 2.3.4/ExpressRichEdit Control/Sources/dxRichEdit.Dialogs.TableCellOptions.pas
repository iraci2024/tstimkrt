...
uses
  ...
  Dialogs,
  dxCore, dxRichEdit.Dialogs.CustomTableOptions, dxCoreClasses, cxGraphics,
...
type
  TdxRichEditTableCellOptionsDialogForm = class
...
begin
  ...
  cbSameAsWholeTable.Caption := cxGetResourceString
  ...
  cbWrapText.Caption := cxGetResourceString
    (@sdxRichEditTableCellOptionsDialogWrapText);
  cbFitText.Caption := cxGetResourceString
    (@sdxRichEditTableCellOptionsDialogFitText);
end;

procedure TdxRichEditTableCellOptionsDialogForm.BottomMarginValueChanged
  (Sender: TObject);
var
  AValue: Integer;
begin
...
procedure TdxRichEditTableCellOptionsDialogForm.SameAsWholeTableChange
  (Sender: TObject);
var
  ACheck: Boolean;
begin
...
begin
  Result := TdxTableCellOptionsFormController.Create
    (AControllerParameters as TdxTableCellOptionsFormControllerParameters);
end;
...
procedure TdxRichEditTableCellOptionsDialogForm.FormCloseQuery(Sender: TObject;
...
function TdxRichEditTableCellOptionsDialogForm.GetController
  : TdxTableCellOptionsFormController;
begin
  Result := TdxTableCellOptionsFormController(inherited Controller);
end;

procedure TdxRichEditTableCellOptionsDialogForm.LeftMarginValueChanged
  (Sender: TObject);
var
  AValue: Integer;
begin
...
procedure TdxRichEditTableCellOptionsDialogForm.RightMarginValueChanged
  (Sender: TObject);
var
  AValue: Integer;
begin
...
procedure TdxRichEditTableCellOptionsDialogForm.TopMarginValueChanged
  (Sender: TObject);
var
  AValue: Integer;
begin
...
procedure TdxRichEditTableCellOptionsDialogForm.WrapTextChanged
  (Sender: TObject);
begin
