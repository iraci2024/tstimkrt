...
type
  ...
  strict private
    FConditionalTableStyleFormattingType
    ...
    procedure SetCharacterFormattingOptions
      (AMask: TdxUsedCharacterFormattingOptions);
    ...
    class procedure StyleQFormatKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure ConditionalStyleFirstRowHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure ConditionalStyleLastRowHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure ConditionalStyleFirstColumnHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); static;
    class procedure ConditionalStyleLastColumnHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure ConditionalStyleOddRowBandingHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); static;
    class procedure ConditionalStyleEvenRowBandingHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); static;
    class procedure ConditionalStyleOddColumnBandingHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); static;
    class procedure ConditionalStyleEvenColumnBandingHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); static;
    class procedure ConditionalStyleTopLeftCellHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); static;
    class procedure ConditionalStyleTopRightCellHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); static;
    class procedure ConditionalStyleBottomLeftCellHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); static;
    class procedure ConditionalStyleBottomRightCellHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); static;
  protected
...
begin
  ...
  AMainStyle := ADocumentModel.TableStyles
    [Importer.GetTableStyleIndex(FRtfStyleIndex)];
  ATableConditionalStyle := AMainStyle.ConditionalStyleProperties.GetStyleSafe
    (FConditionalTableStyleFormattingType);
...
procedure TdxDestinationTableStyle.SetCharacterFormattingOptions
  (AMask: TdxUsedCharacterFormattingOptions);
var
  AOptions: TdxCharacterFormattingOptions;
begin
  AOptions := TdxCharacterFormattingOptions.Create(AMask);
  Importer.Position.CharacterFormatting.ReplaceInfo
    (Importer.Position.CharacterFormatting.Info, AOptions);
end;
...
var
  ...
  AParentCharacterProperties, AParentTableStyleCharacterProperties
    : TdxMergedCharacterProperties;
  AParentParagraphProperties, AParentTableStyleParagraphProperties
    : TdxMergedParagraphProperties;
  AParentTableProperties: TdxMergedTableProperties;
  AParentTableRowProperties, AParentTableStyleTableRowProperties
    : TdxMergedTableRowProperties;
  AParentTableCellProperties, AParentTableStyleTableCellProperties
    : TdxMergedTableCellProperties;
begin
  AName := Trim(FStyleName);
  AParentStyleIndex := Importer.Position.RtfFormattingInfo.ParentStyleIndex;
  AIsConditionalStyle := FConditionalTableStyleFormattingType <>
  ...
  begin
    if not AIsConditionalStyle then
      AParentTableStyle := DocumentModel.TableStyles
        [Importer.GetTableStyleIndex(AParentStyleIndex)]
    else
    begin
      AParentTableStyle := AStyle.Parent;
      if AParentTableStyle = nil then
        AParentTableStyle := DocumentModel.TableStyles
          [Importer.GetTableStyleIndex(-1)];
    end;
    if AIsConditionalStyle then
    begin
      AParentCharacterProperties := nil;
      AStyle.CharacterProperties.CopyFrom
        (Importer.Position.CharacterFormatting);
      AParentParagraphProperties :=
        AParentTableStyle.GetMergedParagraphProperties
        (FConditionalTableStyleFormattingType);
      AParentTableRowProperties := AParentTableStyle.GetMergedTableRowProperties
        (FConditionalTableStyleFormattingType);
      AParentTableCellProperties :=
        AParentTableStyle.GetMergedTableCellProperties
        (FConditionalTableStyleFormattingType);
    end
    else
    begin
      AParentTableStyleCharacterProperties :=
        AParentTableStyle.GetMergedCharacterProperties;
      try
      ...
      AParentTableStyleParagraphProperties :=
        AParentTableStyle.GetMergedParagraphProperties;
      try
        AParentParagraphProperties := Importer.GetStyleMergedParagraphProperties
          (AParentTableStyleParagraphProperties);
      finally
        AParentTableStyleParagraphProperties.Free;
      end;
      AParentTableStyleTableRowProperties :=
        AParentTableStyle.GetMergedTableRowProperties;
      try
        AParentTableRowProperties := Importer.GetStyleMergedTableRowProperties
          (AParentTableStyleTableRowProperties);
      finally
        AParentTableStyleTableRowProperties.Free;
      end;
      AParentTableStyleTableCellProperties :=
        AParentTableStyle.GetMergedTableCellProperties;
      try
        AParentTableCellProperties := Importer.GetStyleMergedTableCellProperties
          (AParentTableStyleTableCellProperties);
      finally
    ...
    try
      ...
      Importer.ApplyParagraphProperties(AStyle.ParagraphProperties,
        Importer.Position.ParagraphFormattingInfo, AParentParagraphProperties);
      Importer.ApplyTableProperties(Importer.TableReader.TableProperties,
        AParentTableProperties);
      AStyle.TableProperties.CopyFrom(Importer.TableReader.TableProperties);

      Importer.ApplyTableRowProperties(Importer.TableReader.RowProperties,
        AParentTableRowProperties);
      AStyle.TableRowProperties.CopyFrom(Importer.TableReader.RowProperties);

      Importer.ApplyTableCellProperties(Importer.TableReader.CellProperties,
        AParentTableCellProperties);
  ...
  if not AIsConditionalStyle and Importer.TableStyleCollectionIndex.ContainsKey
    (AParentStyleIndex) then
    ATableStyle.Parent := DocumentModel.TableStyles
      [Importer.GetTableStyleIndex(AParentStyleIndex)];
end;
...
class function TdxDestinationTableStyle.GetControlCharHT
...
constructor TdxDestinationTableStyle.Create(AImporter: TdxRtfImporter;
  AStyleIndex: Integer);
begin
...
begin
  Result := TdxDestinationTableStyle.Create(Importer,
    Importer.Position.CharacterStyleIndex);
end;

class function TdxDestinationTableStyle.CreateKeywordHT
...
function TdxDestinationTableStyle.GetTableStyleByName(const AStyleName: string)
  : TdxTableStyle;
var
  ADocumentModel: TdxDocumentModel;
...
class function TdxDestinationTableStyle.GetThis(AImporter: TdxRtfImporter)
  : TdxDestinationTableStyle;
begin
...
class procedure TdxDestinationTableStyle.ParentStyleIndexHandler
...
class procedure TdxDestinationTableStyle.StyleQFormatKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).QFormat := True;
end;

class procedure TdxDestinationTableStyle.ConditionalStyleFirstRowHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FConditionalTableStyleFormattingType :=
    TdxConditionalTableStyleFormattingType.FirstRow;
end;

class procedure TdxDestinationTableStyle.ConditionalStyleLastRowHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FConditionalTableStyleFormattingType :=
...
class procedure TdxDestinationTableStyle.ConditionalStyleFirstColumnHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FConditionalTableStyleFormattingType :=
...
class procedure TdxDestinationTableStyle.ConditionalStyleLastColumnHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FConditionalTableStyleFormattingType :=
...
class procedure TdxDestinationTableStyle.ConditionalStyleOddRowBandingHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FConditionalTableStyleFormattingType :=
...
class procedure TdxDestinationTableStyle.ConditionalStyleEvenRowBandingHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FConditionalTableStyleFormattingType :=
...
class procedure TdxDestinationTableStyle.ConditionalStyleOddColumnBandingHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FConditionalTableStyleFormattingType :=
...
class procedure TdxDestinationTableStyle.
  ConditionalStyleEvenColumnBandingHandler(AImporter: TdxRtfImporter;
...
class procedure TdxDestinationTableStyle.ConditionalStyleTopLeftCellHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FConditionalTableStyleFormattingType :=
...
class procedure TdxDestinationTableStyle.ConditionalStyleTopRightCellHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FConditionalTableStyleFormattingType :=
...
class procedure TdxDestinationTableStyle.ConditionalStyleBottomLeftCellHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FConditionalTableStyleFormattingType :=
...
class procedure TdxDestinationTableStyle.ConditionalStyleBottomRightCellHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FConditionalTableStyleFormattingType :=
