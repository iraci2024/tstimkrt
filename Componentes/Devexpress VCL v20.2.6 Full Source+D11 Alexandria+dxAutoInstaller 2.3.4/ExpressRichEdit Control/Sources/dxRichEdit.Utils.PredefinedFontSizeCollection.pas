...
type
  ...
  protected
    ...
    function CalculatePreviousFontSizeCore(AFontSize: Integer)
      : Integer; virtual;
...
class function TdxPredefinedFontSizeCollection.ValidateDoubleFontSize
  (AValue: Integer): Integer;
begin
  Result := Max(Min(AValue, MaxFontSize * 2), MinFontSize * 2);
end;

class function TdxPredefinedFontSizeCollection.ValidateFontSize
...
function TdxPredefinedFontSizeCollection.CalculateNextDoubleFontSize
  (AFontSize: Integer): Integer;
begin
  Result := ValidateDoubleFontSize
    (CalculateNextFontSizeCore(AFontSize div 2) * 2);
end;

function TdxPredefinedFontSizeCollection.CalculateNextFontSizeCore
  (AFontSize: Integer): Integer;
var
...
function TdxPredefinedFontSizeCollection.CalculatePreviousDoubleFontSize
  (AFontSize: Integer): Integer;
begin
  Result := ValidateDoubleFontSize
    (CalculatePreviousFontSizeCore(AFontSize div 2) * 2);
end;

function TdxPredefinedFontSizeCollection.CalculatePreviousFontSizeCore
  (AFontSize: Integer): Integer;
var
  AFontSizeIndex: Integer;
begin
