...
type
  ...
  protected
    ...
    function GetText: string; override;
    procedure SetLength(const Value: Integer); override;
    procedure InsertMarkRange(APieceTable: TdxSimplePieceTable;
      const APos: TdxDocumentModelPosition); virtual; abstract;
    function IsFieldRun: Boolean; override;
  public
    function CanPlaceCaretBefore: Boolean; override;
    function CanJoinWith(ARun: TdxTextRunBase): Boolean; override;
    function Copy(ACopyManager: TdxCustomDocumentModelCopyManager)
      : TdxTextRunBase; override;
    procedure Export(const AExporter: IdxSimpleDocumentModelExporter); override;
    function GetPlainText(ABuffer: TdxChunkedStringBuilder; AFrom: Integer;
  ...
  protected
    function GetRawTextFast(ABuffer: TdxChunkedStringBuilder): string; override;
    procedure InsertMarkRange(APieceTable: TdxSimplePieceTable;
      const APos: TdxDocumentModelPosition); override;
  public
...
function TdxFieldResultEndRun.Copy(ACopyManager
...
begin
  ...
  APieceTable.InsertFieldResultEndRunCore(ATargetPosition.ParagraphIndex,
...
procedure TdxFieldResultEndRun.Export(const AExporter
...
function TdxFieldResultEndRun.TryAdjustEndPositionToFit(ABoxInfo: TdxBoxInfo;
...
function TdxFieldSymbolRun.Copy(ACopyManager: TdxCustomDocumentModelCopyManager)
  : TdxTextRunBase;
var
  APieceTable: TdxSimplePieceTable;
  ATargetPosition: TdxDocumentModelPosition;
...
function TdxFieldCodeRunBase.Copy(ACopyManager
  : TdxCustomDocumentModelCopyManager): TdxTextRunBase;
var
  APieceTable: TdxSimplePieceTable;
  ATargetPosition: TdxDocumentModelPosition;
...
procedure TdxFieldCodeRunBase.Export(const AExporter
  : IdxSimpleDocumentModelExporter);
begin
  AExporter.Export(Self);
end;
...
begin
  APieceTable.InsertFieldCodeStartRunCore(APos.ParagraphIndex,
    APos.LogPosition);
end;
