...
type
  ...
  IdxBoxHitTestCustomCalculator = interface
    ...
    function CreateCharacterBoxHitTestManager(ABox: TdxCharacterBox)
      : TdxBoxHitTestCustomManager;
    function CreateHyphenBoxHitTestManager(ABox: TdxHyphenBox)
      : TdxBoxHitTestCustomManager;
    function CreateRowHitTestManager(ARow: TdxSimpleRow)
      : TdxBoxHitTestCustomManager;
    function CreateTextBoxHitTestManager(ABox: TdxTextBox)
      : TdxBoxHitTestCustomManager;
    function CreateInlinePictureBoxHitTestManager(ABox: TdxInlinePictureBox)
      : TdxBoxHitTestCustomManager;
    function CreateSeparatorMarkBoxHitTestManager(ABox: TdxSeparatorBox)
      : TdxBoxHitTestCustomManager;
    function CreateSpaceBoxHitTestManager(ABox: TdxBox)
      : TdxBoxHitTestCustomManager;
    function CreateLineBreakBoxHitTestManager(ABox: TdxLineBreakBox)
      : TdxBoxHitTestCustomManager;
    function CreateParagraphMarkBoxHitTestManager(ABox: TdxParagraphMarkBox)
      : TdxBoxHitTestCustomManager;
    procedure ProcessBoxCollection(ACollection: TdxBoxCollection);
    procedure ProcessCharacterBoxCollection(ACollection
      : TdxCharacterBoxCollection);
  end;

  { TdxBoxHitTestCustomCalculator }

  TdxBoxHitTestCustomCalculator = class abstract(TcxIUnknownObject,
    IdxBoxHitTestCustomCalculator)
  protected
    procedure RegisterBoxHitTest(ABox: TdxBox); virtual; abstract;
    procedure RegisterCharacterHitTest(ABox: TdxCharacterBox); virtual;
      abstract;
  public
{$REGION 'IdxBoxHitTestCustomCalculator'}
    function CreateCharacterBoxHitTestManager(ABox: TdxCharacterBox)
      : TdxBoxHitTestCustomManager; virtual; abstract;
    function CreateHyphenBoxHitTestManager(ABox: TdxHyphenBox)
      : TdxBoxHitTestCustomManager; virtual; abstract;
    function CreateRowHitTestManager(ARow: TdxSimpleRow)
      : TdxBoxHitTestCustomManager; virtual; abstract;
    ...
    procedure ProcessBoxCollection(ACollection: TdxBoxCollection);
      virtual; abstract;
    procedure ProcessCharacterBoxCollection(ACollection
      : TdxCharacterBoxCollection); virtual; abstract;
{$ENDREGION}
  end;
  ...
  strict private
    ...
    FBox: TdxBoxBase;
  public
    constructor Create(ACalculator: TdxBoxHitTestCustomCalculator;
      ABox: TdxBoxBase);
  ...
  public
    ...
    function GetDocumentPosition(APieceTable: TdxCustomPieceTable;
      const APos: TdxFormatterPosition): TdxDocumentModelPosition; virtual;
    ...
    function GetFontStrikeoutType(APieceTable: TdxCustomPieceTable)
      : TdxStrikeoutType; virtual;
    function GetActualForeColor(APieceTable: TdxCustomPieceTable;
      ATextColors: TdxTextColors; ABackColor: TdxAlphaColor)
      : TdxAlphaColor; virtual;
    function GetActualUnderlineColor(APieceTable: TdxCustomPieceTable;
      ATextColors: TdxTextColors; ABackColor: TdxAlphaColor)
      : TdxAlphaColor; virtual;
    function GetActualStrikeoutColor(APieceTable: TdxCustomPieceTable;
      ATextColors: TdxTextColors; ABackColor: TdxAlphaColor)
      : TdxAlphaColor; virtual;
  ...
  public
    function BinarySearchBoxIndex(const APos: TdxFormatterPosition)
      : Integer; overload;
    function BinarySearchBoxIndex(APieceTable: TdxCustomPieceTable;
      ALogPosition: TdxDocumentLogPosition): Integer; overload;
    procedure RegisterSuccessfulItemHitTest(ACalculator
      : TdxBoxHitTestCustomCalculator; AItem: TdxBox); virtual; abstract;
    procedure RegisterFailedItemHitTest(ACalculator
      : TdxBoxHitTestCustomCalculator); virtual; abstract;
    procedure ExportTo(const AExporter: IdxSimpleDocumentLayoutExporter);
  ...
  TdxHiddenTextUnderlineBoxCollection = class
    (TdxObjectList<TdxHiddenTextUnderlineBox>); // for internal use
  ...
  protected
    function GetImageCore(ARun: TdxRunBase; AReadOnly: Boolean)
      : TdxOfficeImage; virtual;
  public
    ...
    function GetImage(APieceTable: TdxCustomPieceTable; AReadOnly: Boolean)
      : TdxOfficeImage;
    function GetImageActualSizeInLayoutUnits(APieceTable
      : TdxCustomPieceTable): TSize;
    function GetSizing(APieceTable: TdxCustomPieceTable): TdxImageSizeMode;
    function GetResizingShadowDisplayMode(APieceTable: TdxCustomPieceTable)
  ...
  public
    ...
    property UnderlineBounds: TRect read FUnderlineBounds
      write FUnderlineBounds;
    property ClipBounds: TRect read FClipBounds write FClipBounds;
  end;

  { TdxUnderlineBoxCollectionBase }

  TdxUnderlineBoxCollectionBase = class abstract
    (TdxReferencedObjectList<TdxUnderlineBox>) // for internal use
  public
    procedure MoveVertically(ADeltaY: Integer);
  end;
  ...
  TdxUnderlineBoxCollection = class sealed(TdxUnderlineBoxCollectionBase);
    ...
    TdxErrorBox = class sealed(TdxUnderlineBox) // for internal use
      strict private FFirstBoxOffset: Integer;
  ...
  public
    constructor Create; overload;
    constructor Create(AStartAnchorIndex, ABoxCount, AFirstBoxOffset,
      ALastBoxOffset: Integer); overload;
    procedure ExportTo(const AExporter
  ...
  TdxSpecialTextBoxCollection = class
    (TdxReferencedObjectList<TdxSpecialTextBox>); // for internal use
  ...
  protected
    ...
    property InnerHighlightAreas: TdxHighlightAreaCollection
      read FHighlightAreas;
    property InnerHiddenTextBoxes: TdxHiddenTextUnderlineBoxCollection
      read FHiddenTextBoxes;
    property InnerSpecialTextBoxes: TdxSpecialTextBoxCollection
      read FSpecialTextBoxes;
  ...
  public
    ...
    property SpecialTextBoxes: TdxSpecialTextBoxCollection
      read GetSpecialTextBoxes;
    property HiddenTextBoxes: TdxHiddenTextUnderlineBoxCollection
      read GetHiddenTextBoxes;
  ...
  public
    ...
    class function FindLastNonSpaceBoxIndex(ABoxes: TdxBoxCollection;
      AStartIndex: Integer): Integer; overload; static;
    ...
    property LastParagraphRowOriginalHeight: Integer
      read FLastParagraphRowOriginalHeight
      write FLastParagraphRowOriginalHeight;
    property ShouldProcessCharacterLines: Boolean
      read GetShouldProcessCharacterLines;
    property ShouldProcessHiddenText: Boolean read GetShouldProcessHiddenText;
    property ShouldProcessTextHighlight: Boolean
      read GetShouldProcessTextHighlight;
    property ShouldProcessLayoutDependentText: Boolean
      read GetShouldProcessLayoutDependentText;
    property ShouldProcessSpecialTextBoxes: Boolean
      read GetShouldProcessSpecialTextBoxes;
    ...
    property ProcessingFlags: TdxRowProcessingFlags read FProcessingFlags
      write FProcessingFlags;
    // for internal use
    property ExtendedBoxes: TdxSimpleRowExtendedBoxes read GetExtendedBoxes;
    property InnerHiddenTextBoxes: TdxHiddenTextUnderlineBoxCollection
      read GetInnerHiddenTextBoxes;
    property InnerSpecialTextBoxes: TdxSpecialTextBoxCollection
      read GetInnerSpecialTextBoxes;
  end;
  ...
  public
    ...
    procedure RegisterFailedItemHitTest(ACalculator
      : TdxBoxHitTestCustomCalculator); override;
    function BinarySearchBox(APieceTable: TdxCustomPieceTable;
      ALogPosition: TdxDocumentLogPosition): TdxBox;
  ...
  public
    ...
    property ParagraphStartRunIndex: TdxRunIndex read FParagraphStartRunIndex
      write SetParagraphStartRunIndex;
  ...
  strict private
    function GetRowContentRightBounds(const ARowBounds: TRect;
  ...
  protected
    ...
    procedure AlignRowCore(const ARowBounds: TRect; ATextOffset: Integer;
      ABoxes: TdxBoxCollection; AFrom, ATo: Integer;
      AContainsLayoutDependentBox: Boolean); virtual; abstract;
    class function AlignLeft(ABoxes: TdxBoxCollection;
      ALeft, AFrom, ATo: Integer): Integer; static;
    function GetSectionBoxLeft(const ABounds: TRect): Integer; virtual;
    class function FindLastVisibleBoxIndex(ABoxes: TdxBoxCollection;
      AFrom, ATo: Integer): Integer; static;
    class function IsBoxOutsideOfRow(const ARowBounds: TRect; AFrom: Integer;
      ABoxes: TdxBoxCollection; ABoxIndex: Integer): Boolean; static;
  public
    ...
    class function GetAlignmentCalculator(AAlignment: TdxParagraphAlignment)
      : TdxParagraphAlignmentCalculatorBase; static;

    class property LeftAlignmentCalculator: TdxParagraphAlignmentCalculatorBase
      read FLeftAlignmentCalculator;
    class property RightAlignmentCalculator: TdxParagraphAlignmentCalculatorBase
      read FRightAlignmentCalculator;
    class property CenterAlignmentCalculator
      : TdxParagraphAlignmentCalculatorBase read FCenterAlignmentCalculator;
    class property JustifyAlignmentCalculator
      : TdxParagraphAlignmentCalculatorBase read FJustifyAlignmentCalculator;
  end;

  { TdxBoxMeasurer }

  TdxBoxMeasurer = class(TdxCustomBoxMeasurer, IdxObjectMeasurer)
  // for internal use
  strict private
  ...
  public
    ...
    function MeasureText(const AText: string; AFontInfo: TdxFontInfo)
      : TSize; override;
    procedure MeasureText(ABoxInfo: TdxBoxInfo; const AText: string;
      AFontInfo: TdxFontInfo); overload;
    ...
    function GetFontInfo(const APos: TdxFormatterPosition)
      : TdxFontInfo; virtual;
    function MeasureRectangularObject(const AObject
      : IdxRectangularObject): TSize;
    ...
    function MeasureHyphen(const APrevCharacterPos: TdxFormatterPosition;
      AHyphenBoxInfo: TdxBoxInfo): TSize;
    function MeasureCharactersBounds(const AText: string;
      AFontInfo: TdxFontInfo; const ABounds: TRect): TArray<TRect>; overload;
      virtual; abstract;
    function TryAdjustEndPositionToFit(ABoxInfo: TdxBoxInfo;
      const AText: string; AFontInfo: TdxFontInfo; AMaxWidth: Integer): Boolean;
      overload; virtual;
  ...
  TdxVisitableDocumentIntervalBoxCollection = class
    (TdxObjectList<TdxVisitableDocumentIntervalBox>); // for internal use
...
type
  ...
  TdxParagraphLeftAlignmentCalculator = class
    (TdxParagraphAlignmentCalculatorBase)
  protected
    procedure AlignRowCore(const ARowBounds: TRect; ATextOffset: Integer;
      ABoxes: TdxBoxCollection; AFrom, ATo: Integer;
      AContainsLayoutDependentBox: Boolean); override;
  end;

  { TdxParagraphRightAlignmentCalculator }

  TdxParagraphRightAlignmentCalculator = class
    (TdxParagraphAlignmentCalculatorBase)
  protected
    procedure AlignRowCore(const ARowBounds: TRect; ATextOffset: Integer;
      ABoxes: TdxBoxCollection; AFrom, ATo: Integer;
  ...
  TdxParagraphCenterAlignmentCalculator = class
    (TdxParagraphAlignmentCalculatorBase)
  protected
    procedure AlignRowCore(const ARowBounds: TRect; ATextOffset: Integer;
      ABoxes: TdxBoxCollection; AFrom, ATo: Integer;
  ...
  TdxParagraphJustifyAlignmentCalculator = class
    (TdxParagraphAlignmentCalculatorBase)
  strict private
    function FindFirstBoxIndex(ABoxes: TdxBoxCollection;
      AFrom, ATo: Integer): Integer;
    procedure JustifyRow(const ARowBounds: TRect; ATextOffset: Integer;
      ABoxes: TdxBoxCollection; AMinFrom, AFrom, ATo, ATotalSpaceWidth,
      ATotalWidth: Integer);
  protected
    procedure AlignRowCore(const ARowBounds: TRect; ATextOffset: Integer;
      ABoxes: TdxBoxCollection; AFrom, ATo: Integer;
...
constructor TdxBoxHitTestCustomManager.Create(ACalculator
  : TdxBoxHitTestCustomCalculator; ABox: TdxBoxBase);
begin
  inherited Create;
...
function TdxBox.CalcBaseAscentAndFree(APieceTable: TdxCustomPieceTable)
  : Integer;
var
  AFontInfo: TdxFontInfo;
begin
...
function TdxBox.GetActualForeColor(APieceTable: TdxCustomPieceTable;
  ATextColors: TdxTextColors; ABackColor: TdxAlphaColor): TdxAlphaColor;
var
  ARun: TdxTextRunBase;
...
begin
  ...
  if not TdxAlphaColors.IsTransparentOrEmpty(ARunBackColor) then
    Result := TdxAutoColorUtils.GetActualForeColor(ARunBackColor, AColor,
      ATextColors)
  else
...
function TdxBox.GetActualStrikeoutColor(APieceTable: TdxCustomPieceTable;
  ATextColors: TdxTextColors; ABackColor: TdxAlphaColor): TdxAlphaColor;
begin
...
function TdxBox.GetActualUnderlineColor(APieceTable: TdxCustomPieceTable;
  ATextColors: TdxTextColors; ABackColor: TdxAlphaColor): TdxAlphaColor;
begin
...
function TdxBox.GetFontStrikeoutType(APieceTable: TdxCustomPieceTable)
  : TdxStrikeoutType;
begin
  Result := TdxTextRunBase(GetRun(APieceTable)).FontStrikeoutType;
end;

function TdxBox.GetFontUnderlineType(APieceTable: TdxCustomPieceTable)
  : TdxUnderlineType;
begin
...
function TdxBox.GetStrikeoutColorCore(APieceTable: TdxCustomPieceTable)
  : TdxAlphaColor;
begin
  Result := TdxTextRunBase(GetRun(APieceTable)).StrikeoutColor;
end;

function TdxBox.GetUnderlineColorCore(APieceTable: TdxCustomPieceTable)
  : TdxAlphaColor;
begin
...
function TdxCustomBoxCollection.BinarySearchBoxIndex
  (const APos: TdxFormatterPosition): Integer;
var
...
begin
  ...
  TdxAlgorithms1<TdxBoxBase>.BinarySearch(Self,
    AComparable.BoxAndLogPositionCompare, Result);
end;

procedure TdxCustomBoxCollection.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
var
  I: Integer;
begin
...
function TdxSinglePositionBox.GetFirstPosition(APieceTable: TdxCustomPieceTable)
...
function TdxSinglePositionBox.GetLastPosition(APieceTable: TdxCustomPieceTable)
  : TdxDocumentModelPosition;
begin
  Result := GetDocumentPosition(APieceTable, FPos);
end;

function TdxSinglePositionBox.GetRun(APieceTable: TdxCustomPieceTable)
  : TdxRunBase;
begin
...
function TdxInlinePictureBox.CalcAscentAndFree(APieceTable
  : TdxCustomPieceTable): Integer;
begin
  Result := Bounds.Height;
end;

function TdxInlinePictureBox.CalcBaseAscentAndFree
  (APieceTable: TdxCustomPieceTable): Integer;
begin
  Result := CalcAscentAndFree(APieceTable);
end;

function TdxInlinePictureBox.CalcBaseDescent(APieceTable
  : TdxCustomPieceTable): Integer;
begin
  Result := CalcDescent(APieceTable);
end;

function TdxInlinePictureBox.CalcDescent(APieceTable
  : TdxCustomPieceTable): Integer;
begin
  Result := 0;
end;
...
function TdxInlinePictureBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
...
procedure TdxInlinePictureBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
  AExporter.ExportInlinePictureBox(Self);
end;

function TdxInlinePictureBox.GetImage(APieceTable: TdxCustomPieceTable;
  AReadOnly: Boolean): TdxOfficeImage;
var
  ARun: TdxRunBase;
begin
...
function TdxInlinePictureBox.GetImageActualSizeInLayoutUnits
  (APieceTable: TdxCustomPieceTable): TSize;
var
  ATextRun: TdxRunBase;
...
begin
  ...
  Result := cxSize(AConverter.PixelsToLayoutUnits(AImgSizeInPixels.Width,
    AHRes), AConverter.PixelsToLayoutUnits(AImgSizeInPixels.Height, AVRes));
end;

function TdxInlinePictureBox.GetImageCore(ARun: TdxRunBase; AReadOnly: Boolean)
  : TdxOfficeImage;
var
...
function TdxInlinePictureBox.GetResizingShadowDisplayMode
  (APieceTable: TdxCustomPieceTable): TdxResizingShadowDisplayMode;
var
  ARun: TdxRunBase;
begin
  ARun := GetRun(APieceTable);
...
function TdxInlinePictureBox.GetSizing(APieceTable: TdxCustomPieceTable)
  : TdxImageSizeMode;
var
  ARun: TdxRunBase;
begin
...
function TdxMultiPositionBox.GetFirstPosition(APieceTable: TdxCustomPieceTable)
  : TdxDocumentModelPosition;
begin
...
function TdxMultiPositionBox.GetLastPosition(APieceTable: TdxCustomPieceTable)
  : TdxDocumentModelPosition;
begin
  Result := GetDocumentPosition(APieceTable, EndPos);
end;

function TdxMultiPositionBox.GetRun(APieceTable: TdxCustomPieceTable)
  : TdxRunBase;
begin
...
constructor TdxErrorBox.Create(AStartAnchorIndex, ABoxCount, AFirstBoxOffset,
  ALastBoxOffset: Integer);
begin
...
procedure TdxErrorBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
...
function TdxTextBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
...
procedure TdxSpecialTextBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
...
function TdxSimpleRowExtendedBoxes.GetHighlightAreas
...
function TdxSimpleRowExtendedBoxes.GetHiddenTextBoxes
  : TdxHiddenTextUnderlineBoxCollection;
begin
...
function TdxSimpleRowExtendedBoxes.GetSpecialTextBoxes
  : TdxSpecialTextBoxCollection;
begin
...
function TdxSimpleRow.GetInnerHiddenTextBoxes
  : TdxHiddenTextUnderlineBoxCollection;
begin
  if InnerExtendedBoxes <> nil then
...
function TdxSimpleRow.GetBookmarkBoxesCore
  : TdxVisitableDocumentIntervalBoxCollection;
begin
  Result := nil;
end;

function TdxSimpleRow.GetRangePermissionBoxesCore
  : TdxVisitableDocumentIntervalBoxCollection;
begin
  Result := nil;
end;
...
function TdxSimpleRow.GetFirstPosition(APieceTable: TdxCustomPieceTable)
  : TdxDocumentModelPosition;
begin
  Result := FBoxes.First.GetFirstPosition(APieceTable);
end;

function TdxSimpleRow.GetLastPosition(APieceTable: TdxCustomPieceTable)
  : TdxDocumentModelPosition;
begin
...
procedure TdxSimpleRow.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
  AExporter.ExportSimpleRow(Self);
end;

function TdxSimpleRow.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
...
class function TdxSimpleRow.FindLastNonSpaceBoxIndex(ABoxes: TdxBoxCollection;
...
function TdxSingleCharacterMarkBox.GetFontInfo(APieceTable: TdxCustomPieceTable)
  : TdxFontInfo;
var
...
begin
  ...
  if not AFontCache.ShouldUseDefaultFontToDrawInvisibleCharacter(Result,
    MarkCharacter) then
  begin
    ARun := TdxTextRunBase(GetRun(APieceTable));
    AFontIndex := ARun.CalculateFontIndexCore
      (ARun.DocumentModel.DefaultCharacterProperties.FontName);
...
procedure TdxLineBreakBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
  AExporter.ExportLineBreakBox(Self);
end;

function TdxLineBreakBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
...
procedure TdxSeparatorBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
  AExporter.ExportSeparatorBox(Self);
end;

function TdxSeparatorBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
...
function TdxParagraphMarkBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
...
procedure TdxParagraphMarkBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
...
function TdxSingleSpaceBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
  Result := ACalculator.CreateSpaceBoxHitTestManager(Self.Box);
end;

procedure TdxSingleSpaceBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
...
procedure TdxCharacterBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
end;

function TdxCharacterBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
...
procedure TdxCharacterBoxCollection.RegisterFailedItemHitTest
  (ACalculator: TdxBoxHitTestCustomCalculator);
begin
  ACalculator.RegisterCharacterHitTest(nil);
end;

procedure TdxCharacterBoxCollection.RegisterSuccessfulItemHitTest
...
function TdxCharacterMarkBox.GetFontInfo(APieceTable: TdxCustomPieceTable)
  : TdxFontInfo;
var
  ADocumentModel: TdxCustomDocumentModel;
  ARun: TdxTextRunBase;
...
begin
  Result := inherited GetFontInfo(APieceTable);
  ADocumentModel := APieceTable.DocumentModel;
  if not ADocumentModel.FontCache.ShouldUseDefaultFontToDrawInvisibleCharacter
    (Result, MarkCharacter) then
  begin
    ARun := TdxTextRunBase(GetRun(APieceTable));
    AFontIndex := ARun.CalculateFontIndexCore
      (ARun.DocumentModel.Cache.CharacterFormattingCache.DefaultItem.FontName);
...
function TdxSpaceBoxa.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
  Result := ACalculator.CreateSpaceBoxHitTestManager(Self.Box);
end;

procedure TdxSpaceBoxa.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
  AExporter.ExportSpaceBox(Self);
end;
...
function TdxHyphenBox.CreateHitTestManager(const ACalculator
  : IdxBoxHitTestCustomCalculator): TdxBoxHitTestCustomManager;
begin
  Result := ACalculator.CreateHyphenBoxHitTestManager(Self);
end;

procedure TdxHyphenBox.ExportTo(const AExporter
  : IdxSimpleDocumentLayoutExporter);
begin
...
function TdxBoxCollection.GetItem(Index: Integer): TdxBox;
begin
{$IFDEF DEBUG}
  if Cardinal(Index) >= Cardinal(Count) then
    Error(@SListIndexError, Index);
...
function TdxBoxCollection.BinarySearchBox(APieceTable: TdxCustomPieceTable;
  ALogPosition: TdxDocumentLogPosition): TdxBox;
var
  AIndex: Integer;
begin
...
procedure TdxBoxCollection.RegisterSuccessfulItemHitTest
  (ACalculator: TdxBoxHitTestCustomCalculator; AItem: TdxBox);
begin
  ACalculator.RegisterBoxHitTest(AItem);
end;

procedure TdxBoxCollection.RegisterFailedItemHitTest
  (ACalculator: TdxBoxHitTestCustomCalculator);
begin
...
function TdxSimpleParagraphBoxCollection.
  ContainsFloatingObjectAnchorBox: Boolean;
begin
  Result := False;
end;
...
begin
  ...
  for I := 0 to FBoxCollection.Count - 1 do
    if (FBoxCollection[I].StartPos = ABoxInfo.StartPos) and
      (FBoxCollection[I].EndPos = ABoxInfo.EndPos) then
    begin
...
procedure TdxSimpleParagraphBoxCollection.SetParagraphStartRunIndex
  (const Value: TdxRunIndex);
begin
...
procedure TdxParagraphAlignmentCalculatorBase.AlignNumberingListBox
  (ANumberingListBox, AFirstRowBox: TdxBox);
var
  R: TRect;
begin
...
procedure TdxParagraphAlignmentCalculatorBase.AlignMultipartRow(const ARowBounds
  : TRect; ARow: TdxSimpleRow);
var
...
begin
  ...
  begin
    ...
    AlignRowCore(ARange.Bounds, ARow.TextOffset, ABoxes, ARange.FirstBoxIndex,
      ARange.LastBoxIndex, AShouldProcessLayoutDependentText);
  end;
  ALastBox := ABoxes.Last;
  if ALastBox.IsSectionMarkBox or ALastBox.IsPageBreakBox or ALastBox.IsColumnBreakBox
  then
...
procedure TdxParagraphAlignmentCalculatorBase.AlignRow(const ARowBounds: TRect;
  ARow: TdxSimpleRow);
var
  ABoxes: TdxBoxCollection;
  ALastBox: TdxBox;
begin
  ABoxes := ARow.Boxes;
  AlignRowCore(ARowBounds, ARow.TextOffset, ABoxes, 0, ABoxes.Count - 1,
    ARow.ShouldProcessLayoutDependentText);
  ALastBox := ABoxes.Last;
  if ALastBox.IsSectionMarkBox or ALastBox.IsPageBreakBox or ALastBox.IsColumnBreakBox
  then
    AlignBreakBox(ARowBounds, ABoxes);
...
procedure TdxParagraphAlignmentCalculatorBase.AlignBreakBox
  (const ABounds: TRect; ABoxes: TdxBoxCollection);
var
  ASectionBox: TdxBox;
  R: TRect;
...
class function TdxParagraphAlignmentCalculatorBase.AlignLeft
  (ABoxes: TdxBoxCollection; ALeft, AFrom, ATo: Integer): Integer;
var
  I: Integer;
  ABox: TdxBox;
  R: TRect;
...
function TdxParagraphAlignmentCalculatorBase.GetSectionBoxLeft
  (const ABounds: TRect): Integer;
begin
  Result := ABounds.Left;
end;

class function TdxParagraphAlignmentCalculatorBase.FindLastVisibleBoxIndex
  (ABoxes: TdxBoxCollection; AFrom, ATo: Integer): Integer;
var
  I: Integer;
begin
...
class function TdxParagraphAlignmentCalculatorBase.IsBoxOutsideOfRow
  (const ARowBounds: TRect; AFrom: Integer; ABoxes: TdxBoxCollection;
  ABoxIndex: Integer): Boolean;
begin
  Result := (ABoxIndex > AFrom) and
    (ABoxes[ABoxIndex].Bounds.Right > ARowBounds.Right);
end;

function TdxParagraphAlignmentCalculatorBase.GetRowContentRightBounds
  (const ARowBounds: TRect; ABoxes: TdxBoxCollection): Integer;
var
  ACount: Integer;
begin
  ACount := ABoxes.Count;
...
procedure TdxParagraphLeftAlignmentCalculator.AlignRowCore(const ARowBounds
  : TRect; ATextOffset: Integer; ABoxes: TdxBoxCollection; AFrom, ATo: Integer;
  AContainsLayoutDependentBox: Boolean);
begin
...
procedure TdxParagraphRightAlignmentCalculator.AlignRowCore(const ARowBounds
  : TRect; ATextOffset: Integer; ABoxes: TdxBoxCollection; AFrom, ATo: Integer;
  AContainsLayoutDependentBox: Boolean);
var
  ABox: TdxBox;
...
begin
  ...
  begin
    AlignLeft(ABoxes, ARowBounds.Left + ATextOffset, AFrom, ATo);
    if not AContainsLayoutDependentBox or IsBoxOutsideOfRow(ARowBounds, AFrom,
      ABoxes, ALastNotSpaceBoxIndex) then
      Exit;
  end;
...
function TdxParagraphRightAlignmentCalculator.GetSectionBoxLeft(const ARowBounds
  : TRect): Integer;
begin
...
procedure TdxParagraphCenterAlignmentCalculator.AlignRowCore(const ARowBounds
  : TRect; ATextOffset: Integer; ABoxes: TdxBoxCollection; AFrom, ATo: Integer;
  AContainsLayoutDependentBox: Boolean);
var
  ALastNotSpaceBoxIndex: Integer;
...
begin
  ...
  ALeft := Max(ARowBounds.Left, (ARowBounds.Left + ARowBounds.Right -
    ATotalWidth + ATextOffset) div 2);
  for I := AFrom to ALastNotSpaceBoxIndex do
  begin
    ABox := ABoxes[I];
    R := ABox.Bounds;
...
function TdxParagraphCenterAlignmentCalculator.GetSectionBoxLeft
...
procedure TdxParagraphJustifyAlignmentCalculator.AlignRowCore(const ARowBounds
  : TRect; ATextOffset: Integer; ABoxes: TdxBoxCollection; AFrom, ATo: Integer;
  AContainsLayoutDependentBox: Boolean);
var
  ALastNotSpaceBoxIndex: Integer;
...
begin
  ...
  begin
    ...
    begin
      ALastNotSpaceBoxIndex := FindLastVisibleBoxIndex(ABoxes, AFrom, ATo);
      if IsBoxOutsideOfRow(ARowBounds, AFrom, ABoxes, ALastNotSpaceBoxIndex)
      then
      begin
        AlignLeft(ABoxes, ARowBounds.Left + ATextOffset, AFrom, ATo);
        if not AContainsLayoutDependentBox or IsBoxOutsideOfRow(ARowBounds,
          AFrom, ABoxes, ALastNotSpaceBoxIndex) then
          Exit;
      end;
      AlignLeft(ABoxes, ARowBounds.Right, ALastNotSpaceBoxIndex + 1, ATo);
      ...
      if ATotalSpaceWidth = 0 then
        TdxParagraphAlignmentCalculatorBase.LeftAlignmentCalculator.AlignRowCore
          (ARowBounds, ATextOffset, ABoxes, AFrom, ATo,
          AContainsLayoutDependentBox)
      else
        JustifyRow(ARowBounds, ATextOffset, ABoxes, AFrom, AFirstBoxIndex + 1,
          ALastNotSpaceBoxIndex, ATotalSpaceWidth, ATotalWidth);
    end;
  end;
end;

function TdxParagraphJustifyAlignmentCalculator.FindFirstBoxIndex
  (ABoxes: TdxBoxCollection; AFrom, ATo: Integer): Integer;
var
...
begin
  ...
  begin
    ...
    else if not ABoxes[I].HasSpaceBox then
      ALastNonSpace := I;
  end;
end;

procedure TdxParagraphJustifyAlignmentCalculator.JustifyRow(const ARowBounds
  : TRect; ATextOffset: Integer; ABoxes: TdxBoxCollection;
  AMinFrom, AFrom, ATo, ATotalSpaceWidth, ATotalWidth: Integer);
var
  ABox: TdxBox;
  ...
  T, ADelta: Integer;
begin
  ALeft := AlignLeft(ABoxes, ARowBounds.Left + ATextOffset, AMinFrom,
    AFrom - 1);
...
function TdxBoxMeasurer.MeasureText(const AText: string;
...
procedure TdxBoxMeasurer.MeasureText(ABoxInfo: TdxBoxInfo; const AText: string;
  AFontInfo: TdxFontInfo);
begin
...
function TdxBoxMeasurer.GetFontInfo(const APos: TdxFormatterPosition)
  : TdxFontInfo;
var
  ARun: TdxRunBase;
begin
...
function TdxBoxMeasurer.MeasureRectangularObject(const AObject
  : IdxRectangularObject): TSize;
var
...
function TdxBoxMeasurer.MeasureHyphen(const APrevCharacterPos
  : TdxFormatterPosition; AHyphenBoxInfo: TdxBoxInfo): TSize;
var
  ATextViewInfo: TdxTextViewInfo;
  AFontInfo: TdxFontInfo;
begin
  AFontInfo := GetFontInfo(APrevCharacterPos);
  ATextViewInfo := CreateTextViewInfo
    ( { AHyphenBoxInfo, } TdxHyphenBox.HyphenString, AFontInfo);
  try
    Result := ATextViewInfo.Size;
  finally
    ATextViewInfo.Free;
...
begin
  AFontInfo := ABoxInfo.GetFontInfo(PieceTable);
  ABoxInfo.Size := cxSize(AFontInfo.SpaceWidth * (ABoxInfo.EndPos.Offset -
    ABoxInfo.StartPos.Offset + 1), AFontInfo.LineSpacing);
end;
...
function TdxBoxMeasurer.TryAdjustEndPositionToFit(ABoxInfo: TdxBoxInfo;
