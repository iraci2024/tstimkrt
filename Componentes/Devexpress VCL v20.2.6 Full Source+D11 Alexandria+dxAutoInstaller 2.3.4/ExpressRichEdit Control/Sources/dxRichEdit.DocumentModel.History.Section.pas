...
type
  ...
  public
    ...
    property DeletedSectionsCount: Integer read FDeletedSectionsCount
      write FDeletedSectionsCount;
  end;
...
constructor TdxSectionHistoryItem.Create(ADocumentModel
...
begin
  ASectionIndex := DocumentModel.MainPieceTable.
    LookupSectionIndexByParagraphIndex(ParagraphIndex);
...
var
  ...
  ASection: TdxCustomSection;
begin
  ASectionIndex := DocumentModel.MainPart.LookupSectionIndexByParagraphIndex
    (ParagraphIndex);
  Assert(ASectionIndex >= 0);
  ASection := DocumentModel.Sections[ASectionIndex];
...
constructor TdxSectionsDeletedHistoryItem.Create(ADocumentModel
  : TdxCustomDocumentModel);
begin
