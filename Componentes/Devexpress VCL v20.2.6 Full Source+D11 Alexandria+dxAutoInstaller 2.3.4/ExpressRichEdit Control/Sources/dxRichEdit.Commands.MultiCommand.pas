...
type
  ...
  TdxMultiCommandUpdateUIStateMode = (EnableIfAnyAvailable,
  ...
  protected
    ...
    function ExecuteCommand(ACommand: TdxCommand;
      const AState: IdxCommandUIState): Boolean; virtual;
    ...
    function GetUpdateUIStateMode: TdxMultiCommandUpdateUIStateMode;
      virtual; abstract;
    ...
    property UpdateUIStateMode: TdxMultiCommandUpdateUIStateMode
      read GetUpdateUIStateMode;
  public
    constructor Create(const ARichEditControl: IdxRichEditControl);
      overload; override;
    constructor Create(const ARichEditControl: IdxRichEditControl;
      AShouldCreateCommands: Boolean); reintroduce; overload; virtual;
...
function TdxMultiCommand.ExecuteCommand(ACommand: TdxCommand;
...
begin
  ...
  begin
    ...
    begin
      ...
      if AExecuted and
        (ExecutionMode = TdxMultiCommandExecutionMode.ExecuteFirstAvailable)
      then
        Exit;
    end;
  end;
...
procedure TdxMultiCommand.SetCommandSourceType(const Value
  : TdxCommandSourceType);
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      if UpdateUIStateMode = TdxMultiCommandUpdateUIStateMode.EnableIfAnyAvailable
      then
        Exit;
    end
    else
    begin
      if UpdateUIStateMode = TdxMultiCommandUpdateUIStateMode.EnableIfAllAvailable
      then
      begin
        AState.Enabled := ACommandState.Enabled;
        AState.Visible := ACommandState.Visible;
...
procedure TdxTransactedMultiCommand.ForceExecute(const AState
  : IdxCommandUIState);
var
...
constructor TdxCustomTransactedMultiCommand.Create(const AControl
  : IdxRichEditControl; ACommands: TdxCommandCollection;
  AExecutionMode: TdxMultiCommandExecutionMode;
  AUpdateUIStateMode: TdxMultiCommandUpdateUIStateMode);
begin
...
function TdxCustomTransactedMultiCommand.GetExecutionMode
...
function TdxCustomTransactedMultiCommand.GetUpdateUIStateMode
