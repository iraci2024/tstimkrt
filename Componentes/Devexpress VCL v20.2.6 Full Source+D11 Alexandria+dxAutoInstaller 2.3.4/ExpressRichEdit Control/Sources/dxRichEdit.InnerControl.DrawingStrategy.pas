...
type
  ...
  TdxGdiPlusMeasurementAndDrawingStrategyBase = class abstract
  ...
  TdxGdiMeasurementAndDrawingStrategyBase = class
    (TdxGdiPlusMeasurementAndDrawingStrategyBase)
  strict private
  ...
  TdxServerGdiMeasurementAndDrawingStrategy = class
    (TdxGdiMeasurementAndDrawingStrategyBase)
  public
  ...
  TdxGdiMeasurementAndDrawingStrategy = class
    (TdxGdiMeasurementAndDrawingStrategyBase)
  public
    function CreateDocumentPainter(AGraphics: TdxGraphics): TObject; override;
  end;
...
begin
  ...
  FGraphicsModifier := TdxGraphicsToLayoutUnitsModifier.Create(FMeasureGraphics,
    DocumentModel.LayoutUnitConverter);
  inherited OnLayoutUnitChanged;
end;

function TdxGdiPlusMeasurementAndDrawingStrategyBase.CreateMeasureGraphics
  : TdxGraphics;
begin
  Result := TdxGraphics.Create;
  FGraphicsModifier.Free;
  FGraphicsModifier := TdxGraphicsToLayoutUnitsModifier.Create(Result,
    DocumentModel.LayoutUnitConverter);
end;
...
begin
  ...
  FHdcGraphicsModifier := TdxGraphicsToLayoutUnitsModifier.Create
    (FHdcMeasureGraphics, DocumentModel.LayoutUnitConverter);
  inherited Initialize;
end;
...
function TdxGdiMeasurementAndDrawingStrategyBase.CreateBoxMeasurer
  : TdxBoxMeasurer;
begin
  Result := TdxGdiBoxMeasurerLockHdc.Create(DocumentModel, MeasureGraphics,
    FHdcMeasureGraphics);
end;

{ TdxServerGdiMeasurementAndDrawingStrategy }

function TdxServerGdiMeasurementAndDrawingStrategy.CreateDocumentPainter
...
function TdxGdiMeasurementAndDrawingStrategy.CreateDocumentPainter
  (AGraphics: TdxGraphics): TObject;
begin
  Result := TdxRichEditGdiPainter.Create(AGraphics,
    TdxGdiBoxMeasurer(Measurer));
end;
