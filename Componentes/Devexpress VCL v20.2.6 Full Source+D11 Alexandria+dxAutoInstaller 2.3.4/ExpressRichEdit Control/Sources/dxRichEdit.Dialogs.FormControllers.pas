...
type
  ...
  TdxDocumentProtectionSetPasswordFormControllerParameters = class
  ...
  TdxDocumentEncryptQueryPasswordFormControllerParameters = class
    (TdxDocumentProtectionSetPasswordFormControllerParameters);

  { TdxDocumentProtectionQueryPasswordFormControllerParameters }

  TdxDocumentProtectionGetPasswordFormControllerParameters = class
    (TdxDocumentProtectionSetPasswordFormControllerParameters);

  { TdxDocumentProtectionQueryPasswordFormController }

  TdxDocumentProtectionGetQueryPasswordFormController = class
    (TdxDocumentProtectionQuerySetPasswordFormController);

  { TdxInsertMergeFieldFormControllerParameters }

  TdxInsertMergeFieldFormControllerParameters = class
    (TdxFormControllerParameters);
...
constructor TdxDocumentProtectionSetPasswordFormControllerParameters.Create
  (const AControl: IdxRichEditControl; const APassword: string);
begin
...
constructor TdxDocumentProtectionQuerySetPasswordFormController.Create
