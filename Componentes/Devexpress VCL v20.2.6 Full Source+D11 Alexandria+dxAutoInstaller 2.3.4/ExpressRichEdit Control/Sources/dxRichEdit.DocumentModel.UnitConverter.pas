...
type
  ...
  public
    ...
    property UnitPrecisions[Index: TdxRichEditDocumentUnit]: Integer
      read GetUnitPrecision; default;
    class property DefaultPrecisions: TdxUnitPrecisions
      read GetDefaultPrecisions;
  end;
  ...
  private const
    DefaultCaptions: array [TdxRichEditDocumentUnit] of Pointer = (nil,
      @sdxRichEditCaptionUnitInches, @sdxRichEditCaptionUnitMillimeters,
      @sdxRichEditCaptionUnitCentimeters, @sdxRichEditCaptionUnitPoints);
  private
    class function GetUnitCaption(Index: TdxRichEditDocumentUnit)
      : string; static;
  public
    class property UnitCaption[Index: TdxRichEditDocumentUnit]: string
      read GetUnitCaption; default;
  end;
  ...
  private const
    DefaultAbbreviations: array [TdxRichEditDocumentUnit] of Pointer = (nil,
      @sdxRichEditUnitsInches, @sdxRichEditUnitsMillimeters,
      @sdxRichEditUnitsCentimeters, @sdxRichEditUnitsPoints);
  private
    class function GetUnitAbbreviation(Index: TdxRichEditDocumentUnit)
      : string; static;
  public
    class function IsValidUnit(AValue: TdxRichEditDocumentUnit): Boolean;
    class property UnitAbbreviation[Index: TdxRichEditDocumentUnit]: string
      read GetUnitAbbreviation; default;
  end;
  ...
  private
    ...
    FStringValue: string;
    FIsNegative: Boolean;
    procedure Init(const AValue: string; AType: TdxRichEditDocumentUnit;
    ...
    class function GetTextAbbreviation(AUnitType: TdxRichEditDocumentUnit;
      AIsValueInPercent: Boolean): string; static;
    class function GetUnitTypeAndStringValue(const AText: string;
      ADefaultUnitType: TdxRichEditDocumentUnit;
      out AType: TdxRichEditDocumentUnit; AIsValueInPercent: Boolean)
      : string; static;
    class function TryParseFloatValue(const ASourceStringValue: string;
      out AResultStringValue: string; out AIsNegative: Boolean)
      : Boolean; static;
    class function GetValidType(AType: TdxRichEditDocumentUnit)
      : TdxRichEditDocumentUnit; static;
    function GetOperationValidStringValue: string;

    constructor Create(const AValue: string; AType: TdxRichEditDocumentUnit;
      AIsNegative: Boolean); overload;
  public
    constructor Create(const AValue: string;
      ADefaultUnitType: TdxRichEditDocumentUnit;
      const AUnitPrecisions: TdxUnitPrecisions;
      AIsValueInPercent: Boolean = False); overload;
    constructor Create(AValue: Single; AType: TdxRichEditDocumentUnit);
      overload;
    constructor Create(AValue: Single; AType: TdxRichEditDocumentUnit;
      const AUnitPrecisions: TdxUnitPrecisions); overload;
    class function TryParse(const AText: string;
      ADefaultUnitType: TdxRichEditDocumentUnit; out AResult: TdxUIUnit;
      AIsValueInPercent: Boolean = False): Boolean; static;

    function CreateZeroStringValue(AMaxDigitsAfterDecimalSeparator
      : Integer): string;
    function GetRightPart(const AStringValueParts: TArray<string>;
      AMaxDigitsAfterDecimalSeparator: Integer): string;
    function GetValueOfDesiredLength(const AValue: string;
      ADesiredLength: Integer): string;
    function GetValidValueString(const AStringValue: string;
      AMaxDigitsAfterDecimalSeparator: Integer): string;
    ...
    property OperationValidStringValue: string
      read GetOperationValidStringValue;
  ...
  public
    ...
    function CreateUIUnit(const AText: string;
      ADefaultUnitType: TdxRichEditDocumentUnit): TdxUIUnit; overload;
    function CreateUIUnit(const AText: string;
      ADefaultUnitType: TdxRichEditDocumentUnit; AIsValueInPercent: Boolean)
      : TdxUIUnit; overload;
    function ToUIUnit(AValue: Integer; AType: TdxRichEditDocumentUnit)
      : TdxUIUnit; overload;
    function ToUIUnit(AValue: Integer; AType: TdxRichEditDocumentUnit;
      AIsValueInPercent: Boolean): TdxUIUnit; overload;
    function ToUIUnitF(AValue: Single; AType: TdxRichEditDocumentUnit)
      : TdxUIUnit; overload;
    function ToUIUnitF(AValue: Single; AType: TdxRichEditDocumentUnit;
      AIsValueInPercent: Boolean): TdxUIUnit; overload;
    function ToInt(AValue: Double): Integer;
    function ToTwipsUnit(const AValue: TdxUIUnit): Integer; overload;
    function ToTwipsUnit(const AValue: TdxUIUnit; AIsValueInPercent: Boolean)
      : Integer; overload;
    function ToTwipsUnitF(const AValue: TdxUIUnit): Single; overload;
    function ToTwipsUnitF(const AValue: TdxUIUnit; AIsValueInPercent: Boolean)
      : Single; overload;
  end;

  { TdxDocumentModelUnitConverter }

  TdxDocumentModelUnitConverter = class(TdxDpiSupport,
  ...
  public
    ...
    function CreateConverterToLayoutUnits(const AUnit: TdxDocumentLayoutUnit;
      const ADpi: Single): TdxDocumentModelUnitToLayoutUnitConverter; overload;
      virtual; abstract;
    function CreateConverterToLayoutUnits(const AUnit: TdxDocumentLayoutUnit)
    ...
    function PointsToModelUnitsF(const AValue: Single): Single;
      virtual; abstract;
    function PixelsToModelUnits(const AValue: Integer; const ADpi: Single)
      : Integer; overload; virtual; abstract;
    function PixelsToModelUnits(const AValue: Integer): Integer; overload;
    function PixelsToModelUnits(const AValue: TSize; const ADpiX, ADpiY: Single)
      : TSize; overload; virtual; abstract;
    ...
    function HundredthsOfInchToModelUnits(const AValue: Integer): Integer;
      overload; virtual; abstract;
    function HundredthsOfInchToModelUnits(const AValue: TSize): TSize; overload;
      virtual; abstract;
    function HundredthsOfMillimeterToModelUnits(const AValue: Integer): Integer;
      overload; virtual; abstract;
    function HundredthsOfMillimeterToModelUnits(const AValue: TSize): TSize;
      overload; virtual; abstract;
    function HundredthsOfMillimeterToModelUnitsRound(const AValue: Integer)
      : Integer; virtual; abstract;
    function CentimetersToModelUnitsF(const AValue: Single): Single;
      virtual; abstract;
    function InchesToModelUnitsF(const AValue: Single): Single;
      virtual; abstract;
    function PicasToModelUnitsF(const AValue: Single): Single; virtual;
      abstract;
    ...
    function ModelUnitsToTwips(const AValue: Integer): Integer; overload;
      virtual; abstract;
    function ModelUnitsToTwipsF(const AValue: Single): Single; virtual;
      abstract;
    ...
    function ModelUnitsToPointsFRound(const AValue: Single): Single;
      virtual; abstract;
    function ModelUnitsToPixels(const AValue: Integer; const ADpi: Single)
      : Integer; virtual; abstract;
    function ModelUnitsToPixelsF(const AValue: Single; const ADpi: Single)
    ...
    function ModelUnitsToDocumentsF(const AValue: Single): Single;
      virtual; abstract;
    function ModelUnitsToHundredthsOfInch(const AValue: Integer): Integer;
      overload; virtual; abstract;
...
function TdxDocumentModelUnitConverter.ToUIUnit(AValue: Integer;
  AType: TdxRichEditDocumentUnit): TdxUIUnit;
begin
  Result := ToUIUnit(AValue, AType, False);
end;

function TdxDocumentModelUnitConverter.ToUIUnit(AValue: Integer;
  AType: TdxRichEditDocumentUnit; AIsValueInPercent: Boolean): TdxUIUnit;
begin
  Result := ToUIUnitF(AValue, AType, AIsValueInPercent);
end;

function TdxDocumentModelUnitConverter.ToUIUnitF(AValue: Single;
  AType: TdxRichEditDocumentUnit): TdxUIUnit;
begin
...
begin
  ...
  case AType of
    TdxRichEditDocumentUnit.Centimeter:
      Exit(TdxUIUnit.Create(TwipsToCentimetersF(AValue),
        TdxRichEditDocumentUnit.Centimeter));
    TdxRichEditDocumentUnit.Inch:
      Exit(TdxUIUnit.Create(TwipsToInchesF(AValue),
        TdxRichEditDocumentUnit.Inch));
    TdxRichEditDocumentUnit.Millimeter:
      Exit(TdxUIUnit.Create(TwipsToMillimetersF(AValue),
        TdxRichEditDocumentUnit.Millimeter));
    TdxRichEditDocumentUnit.Point:
      Exit(TdxUIUnit.Create(TwipsToPointsF(AValue),
        TdxRichEditDocumentUnit.Point));
  end;
end;
...
begin
  if AValue > MaxInt then
    Result := MaxInt
  else if AValue < MinInt then
    Result := MinInt
  else
    Result := Trunc(AValue);
end;

function TdxDocumentModelUnitConverter.ToTwipsUnit(const AValue
  : TdxUIUnit): Integer;
begin
  Result := ToTwipsUnit(AValue, False);
end;

function TdxDocumentModelUnitConverter.ToTwipsUnit(const AValue: TdxUIUnit;
  AIsValueInPercent: Boolean): Integer;
var
  AResult: Single;
begin
...
function TdxDocumentModelUnitConverter.ToTwipsUnitF(const AValue
  : TdxUIUnit): Single;
begin
  Result := ToTwipsUnitF(AValue, False);
end;

function TdxDocumentModelUnitConverter.ToTwipsUnitF(const AValue: TdxUIUnit;
  AIsValueInPercent: Boolean): Single;
begin
  if AIsValueInPercent then
    Exit(AValue.Value);
...
function TdxDocumentModelUnitConverter.AdjAngleToModelUnits
  (const AValue: Integer): Integer;
begin
  Result := AValue;
end;

function TdxDocumentModelUnitConverter.ModelUnitsToAdjAngle
  (const AValue: Integer): Integer;
begin
  Result := AValue;
end;
...
function TdxDocumentModelUnitConverter.CreateConverterToLayoutUnits
  (const AUnit: TdxDocumentLayoutUnit)
  : TdxDocumentModelUnitToLayoutUnitConverter;
begin
  Result := CreateConverterToLayoutUnits(AUnit, TdxCustomDocumentModel.Dpi);
end;

function TdxDocumentModelUnitConverter.DegreeToModelUnits
  (const AValue: Single): Integer;
begin
  Result := Round(AValue * 60000);
end;

function TdxDocumentModelUnitConverter.ModelUnitsToDegree
  (const AValue: Integer): Integer;
begin
  Result := Trunc(AValue / 60000);
end;

function TdxDocumentModelUnitConverter.ModelUnitsToDegreeF
  (const AValue: Integer): Single;
begin
  Result := AValue / 60000;
end;

function TdxDocumentModelUnitConverter.ModelUnitsToRadians
  (const AValue: Integer): Single;
begin
  Result := PI * (AValue / 60000) / 180;
end;

function TdxDocumentModelUnitConverter.PixelsToModelUnits
  (const AValue: Integer): Integer;
begin
...
constructor TdxUnitConverter.Create(AUnitConverter
  : TdxDocumentModelUnitConverter);
begin
  inherited Create;
...
constructor TdxUnitsConverter.Create(AUnitConverter
  : TdxDocumentModelUnitConverter);
begin
...
function TdxUnitsConverter.ValueUnitToModelUnitsF
  (const AInfo: TdxValueInfo): Single;
var
  AUnit: string;
begin
  if AInfo.&Unit = '' then
  ...
  else if AUnit = 'inch' then
    Result := FUnitConverter.InchesToModelUnitsF(AInfo.Value)
  else if AUnit = 'ft' then
    Result := FUnitConverter.InchesToModelUnitsF(AInfo.Value * 12)
  else if (AUnit = 'mi') or (AUnit = '%') then
...
constructor TdxUIUnit.Create(const AValue: string;
  AType: TdxRichEditDocumentUnit; AIsNegative: Boolean);
begin
  FStringValue := AValue;
  FUnitType := GetValidType(AType);
...
function TdxUIUnit.CreateZeroStringValue(AMaxDigitsAfterDecimalSeparator
  : Integer): string;
var
  SB: TStringBuilder;
begin
...
begin
  ...
  AStringValue := GetUnitTypeAndStringValue(AValue, ADefaultUnitType, AUnitType,
    AIsValueInPercent);
...
function TdxUIUnit.GetRightPart(const AStringValueParts: TArray<string>;
  AMaxDigitsAfterDecimalSeparator: Integer): string;
begin
...
class function TdxUIUnit.GetTextAbbreviation(AUnitType: TdxRichEditDocumentUnit;
  AIsValueInPercent: Boolean): string;
begin
  if AIsValueInPercent then
...
class function TdxUIUnit.GetUnitTypeAndStringValue(const AText: string;
  ADefaultUnitType: TdxRichEditDocumentUnit; out AType: TdxRichEditDocumentUnit;
  AIsValueInPercent: Boolean): string;
var
  AStringValue: string;
  AUnitType: TdxRichEditDocumentUnit;
...
begin
  ...
  AStringValue := AText;
  for AUnitType := Low(TdxRichEditDocumentUnit)
    to High(TdxRichEditDocumentUnit) do
    if TdxUnitAbbreviationDictionary.IsValidUnit(AUnitType) then
    begin
      ATestAbbreviationText :=
        Trim(GetTextAbbreviation(AUnitType, AIsValueInPercent));
...
class function TdxUIUnit.GetValidType(AType: TdxRichEditDocumentUnit)
...
function TdxUIUnit.GetValidValueString(const AStringValue: string;
  AMaxDigitsAfterDecimalSeparator: Integer): string;
var
...
begin
  ...
  ARightPart := GetRightPart(AStringValueParts,
    AMaxDigitsAfterDecimalSeparator);
  if not IsIntegerValue(ALeftPart) or
    ((ARightPart <> '') and not IsIntegerValue(ARightPart)) then
    Exit(CreateZeroStringValue(AMaxDigitsAfterDecimalSeparator));
  ARightPart := GetValueOfDesiredLength(ARightPart,
    AMaxDigitsAfterDecimalSeparator);
...
function TdxUIUnit.GetValueOfDesiredLength(const AValue: string;
  ADesiredLength: Integer): string;
var
  AZeroCount: Integer;
begin
...
begin
  ...
  FStringValue := GetValidValueString(FStringValue,
    UnitPrecisions[UnitType] + 1);
...
function TdxUIUnit.TrimBeginInsignificantZeros(const AStringValue
  : string): string;
var
...
begin
  ...
  begin
    if not {$IFDEF DELPHIXE4}AStringValue[APosition - 1]
      .IsDigit{$ELSE}TCharacter.IsDigit(AStringValue[APosition - 1]){$ENDIF} then
      Dec(APosition);
    Result := TdxStringHelper.Substring(AStringValue, APosition,
      ACount - APosition);
  end;
end;

function TdxUIUnit.TrimEndInsignificantZeros(const AStringValue
  : string): string;
var
  ANewValue: string;
  ALength: Integer;
...
class function TdxUIUnit.TryParse(const AText: string;
  ADefaultUnitType: TdxRichEditDocumentUnit; out AResult: TdxUIUnit;
...
begin
  AUnitType := ADefaultUnitType;
  AStringValue := GetUnitTypeAndStringValue(AText, ADefaultUnitType, AUnitType,
    AIsValueInPercent);
  AIsNegative := False;
  AResultValue := '';
...
class function TdxUIUnit.TryParseFloatValue(const ASourceStringValue: string;
  out AResultStringValue: string; out AIsNegative: Boolean): Boolean;
var
...
begin
  ...
  APattern := Format('^(?<sign>\+|-)?(?<value>\d*%s?(\d+)?)$',
    [ADecimalSeparatorPattern]);
  ...
  if (Length(AResultStringValue) = 0) or
    ((Length(AResultStringValue) = 1) and
    (AResultStringValue[1] = DecimalSeparator)) then
    AIsNegative := False;
  Result := True;
end;
...
function TdxUIUnitConverter.ToUIUnit(AValue: Integer;
  AType: TdxRichEditDocumentUnit): TdxUIUnit;
begin
  Result := ToUIUnit(AValue, AType, False);
end;
...
function TdxUIUnitConverter.ToUIUnitF(AValue: Single;
  AType: TdxRichEditDocumentUnit): TdxUIUnit;
begin
  Result := ToUIUnitF(AValue, AType, False);
end;
...
begin
  ...
  begin
    ...
    case AType of
      TdxRichEditDocumentUnit.Inch:
        Result := TdxUIUnit.Create(TwipsToInchesF(AValue),
          TdxRichEditDocumentUnit.Inch, FUnitPrecisions);
      TdxRichEditDocumentUnit.Millimeter:
        Result := TdxUIUnit.Create(TwipsToMillimetersF(AValue),
          TdxRichEditDocumentUnit.Millimeter, FUnitPrecisions);
      TdxRichEditDocumentUnit.Centimeter:
        Result := TdxUIUnit.Create(TwipsToCentimetersF(AValue),
          TdxRichEditDocumentUnit.Centimeter, FUnitPrecisions);
      TdxRichEditDocumentUnit.Point:
        Result := TdxUIUnit.Create(TwipsToPointsF(AValue),
          TdxRichEditDocumentUnit.Point, FUnitPrecisions);
    else
...
function TdxUIUnitConverter.ToTwipsUnit(const AValue: TdxUIUnit;
  AIsValueInPercent: Boolean): Integer;
var
  AResult: Single;
begin
...
function TdxUIUnitConverter.ToTwipsUnitF(const AValue: TdxUIUnit;
  AIsValueInPercent: Boolean): Single;
begin
  if AIsValueInPercent then
    Result := AValue.Value
...
function TdxUIUnitConverter.CreateUIUnit(const AText: string;
  ADefaultUnitType: TdxRichEditDocumentUnit): TdxUIUnit;
begin
...
function TdxUIUnitConverter.CreateUIUnit(const AText: string;
  ...
  : TdxUIUnit;
begin
  Result := TdxUIUnit.Create(AText, ADefaultUnitType, FUnitPrecisions,
    AIsValueInPercent);
end;

{ TdxUnitPrecisions }

constructor TdxUnitPrecisions.Create(const ADefaultPrecisions
  : array of Integer);
var
...
function TdxUnitPrecisions.GetUnitPrecision
  (Index: TdxRichEditDocumentUnit): Integer;
begin
...
class function TdxUnitCaptionDictionary.GetUnitCaption
  (Index: TdxRichEditDocumentUnit): string;
begin
...
class function TdxUnitAbbreviationDictionary.GetUnitAbbreviation
  (Index: TdxRichEditDocumentUnit): string;
begin
  Result := cxGetResourceString(DefaultAbbreviations[Index]);
end;

class function TdxUnitAbbreviationDictionary.IsValidUnit
  (AValue: TdxRichEditDocumentUnit): Boolean;
begin
