...
type
  ...
  TdxFastComparerType = (Unknown, Shortint, Smallint, Integer, Int64, Single,
  ...
  public
    class function IsValueEquals(var AComparerType: TdxFastComparerType;
      const AValue1, AValue2: T): Boolean; static;
  end;
...
function ShortintEqualityComparer(const Value1, Value2: Pointer)
  : Boolean; inline;
var
...
function SmallintEqualityComparer(const Value1, Value2: Pointer)
  : Boolean; inline;
var
...
function IntegerEqualityComparer(const Value1, Value2: Pointer)
  : Boolean; inline;
var
...
function ExtendedEqualityComparer(const Value1, Value2: Pointer)
  : Boolean; inline;
var
...
function CurrencyEqualityComparer(const Value1, Value2: Pointer)
  : Boolean; inline;
var
...
class function TdxFastComparer<T>.IsValueEquals(var AComparerType
  : TdxFastComparerType; const AValue1, AValue2: T): Boolean;
begin
