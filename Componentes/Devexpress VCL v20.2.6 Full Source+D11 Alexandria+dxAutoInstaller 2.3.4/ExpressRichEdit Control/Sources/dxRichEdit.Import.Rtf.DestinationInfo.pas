...
type
  ...
  private
    class procedure LegacyPasswordHashHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure PasswordHashHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
  protected
...
function TdxLegacyPasswordHashDestination.CreateEmptyClone
  : TdxHexStreamDestination;
begin
