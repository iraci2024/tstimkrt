...
type
  ...
  TdxDocumentModelDocumentsToLayoutPixelsConverter = class
...
constructor TdxDocumentModelDocumentsToLayoutPixelsConverter.Create
  (dpi: Single);
begin
  inherited Create;
  FDpi := dpi;
...
function TdxDocumentModelDocumentsToLayoutPixelsConverter.ToLayoutUnits
...
function TdxDocumentModelDocumentsToLayoutPixelsConverter.ToModelUnits
  (value: Integer): Integer;
begin
