...
uses
  Types, Windows, SysUtils, Graphics, Generics.Defaults, Generics.Collections,
  dxCoreGraphics,
...
type
  ...
  TdxConditionalRowType = (Unknown = 0, FirstRow, LastRow, EvenRowBand,
    OddRowBand, Normal);

  TdxConditionalColumnType = (Unknown = 0, FirstColumn, LastColumn,
    EvenColumnBand, OddColumnBand, Normal);

  TdxShadingPattern = (Clear, DiagCross, DiagStripe, HorzCross, HorzStripe,
    &Nil, Pct5, Pct10, Pct12, Pct15, Pct20, Pct25, Pct30, Pct35, Pct37, Pct40,
    Pct45, Pct50, Pct55, Pct60, Pct62, Pct65, Pct70, Pct75, Pct80, Pct85, Pct87,
    Pct90, Pct95, ReverseDiagStripe, Solid, ThinDiagCross, ThinDiagStripe,
    ThinHorzCross, ThinHorzStripe, ThinReverseDiagStripe, ThinVertStripe,
    VertStripe);
  ...
  TdxSetOptionValueDelegate<T> = reference to procedure(AOptions: T;
    const Value: Boolean);
  ...
  public
    constructor Create(const AGet: TdxGetOptionValueDelegate<T>;
      const ASet: TdxSetOptionValueDelegate<T>);
  ...
  TdxPropertiesBase<T: TdxCloneable> = class abstract
    (TdxRichEditIndexBasedObject<T>, IdxPropertiesContainer)
  private
  ...
  protected
    ...
    procedure ApplyChanges(const AChangeActions
      : TdxDocumentModelChangeActions); override;
    procedure EndChanging;

    function GetAccessor(AChangedProperty: TdxProperties)
      : TdxBoolPropertyAccessor<T>; virtual;

    function ResetOptionsCore(AChangedProperty: TdxProperties;
      out AIsDeferred: Boolean): T; virtual;
    function ChangeOptionsCore(AChangedProperty: TdxProperties;
      out AIsDeferred: Boolean): T; virtual;

    function ChangePropertiesOptions(const AAccessor
      : TdxBoolPropertyAccessor<T>; out AIsDeferred: Boolean): T; virtual;
    function ResetPropertiesOptions(const AAccessor: TdxBoolPropertyAccessor<T>;
      out AIsDeferred: Boolean): T; virtual;
  ...
  protected
    ...
    class function GetOptionsUseLeftBorder(AOptions: TdxTablePropertiesOptions)
      : Boolean; static;
    class procedure SetOptionsUseLeftBorder(AOptions: TdxTablePropertiesOptions;
      const Value: Boolean); static;
    class function GetOptionsUseRightBorder(AOptions: TdxTablePropertiesOptions)
      : Boolean; static;
    class procedure SetOptionsUseRightBorder
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUseTopBorder(AOptions: TdxTablePropertiesOptions)
      : Boolean; static;
    class procedure SetOptionsUseTopBorder(AOptions: TdxTablePropertiesOptions;
      const Value: Boolean); static;
    class function GetOptionsUseBottomBorder
      (AOptions: TdxTablePropertiesOptions): Boolean; static;
    class procedure SetOptionsUseBottomBorder
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUseInsideVerticalBorder
      (AOptions: TdxTablePropertiesOptions): Boolean; static;
    class procedure SetOptionsUseInsideVerticalBorder
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUseInsideHorizontalBorder
      (AOptions: TdxTablePropertiesOptions): Boolean; static;
    class procedure SetOptionsUseInsideHorizontalBorder
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUseLeftMargin(AOptions: TdxTablePropertiesOptions)
      : Boolean; static;
    class procedure SetOptionsUseLeftMargin(AOptions: TdxTablePropertiesOptions;
      const Value: Boolean); static;
    class function GetOptionsUseRightMargin(AOptions: TdxTablePropertiesOptions)
      : Boolean; static;
    class procedure SetOptionsUseRightMargin
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUseTopMargin(AOptions: TdxTablePropertiesOptions)
      : Boolean; static;
    class procedure SetOptionsUseTopMargin(AOptions: TdxTablePropertiesOptions;
      const Value: Boolean); static;
    class function GetOptionsUseBottomMargin
      (AOptions: TdxTablePropertiesOptions): Boolean; static;
    class procedure SetOptionsUseBottomMargin
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUseCellSpacing(AOptions: TdxTablePropertiesOptions)
      : Boolean; static;
    class procedure SetOptionsUseCellSpacing
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUsePreferredWidth
      (AOptions: TdxTablePropertiesOptions): Boolean; static;
    class procedure SetOptionsUsePreferredWidth
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUseTableIndent(AOptions: TdxTablePropertiesOptions)
      : Boolean; static;
    class procedure SetOptionsUseTableIndent
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUseTableLayout(AOptions: TdxTablePropertiesOptions)
      : Boolean; static;
    class procedure SetOptionsUseTableLayout
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUseTableAlignment
      (AOptions: TdxTablePropertiesOptions): Boolean; static;
    class procedure SetOptionsUseTableAlignment
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUseTableLook(AOptions: TdxTablePropertiesOptions)
      : Boolean; static;
    class procedure SetOptionsUseTableLook(AOptions: TdxTablePropertiesOptions;
      const Value: Boolean); static;
    class function GetOptionsUseTableOverlap
      (AOptions: TdxTablePropertiesOptions): Boolean; static;
    class procedure SetOptionsUseTableOverlap
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUseTableStyleColBandSize
      (AOptions: TdxTablePropertiesOptions): Boolean; static;
    class procedure SetOptionsUseTableStyleColBandSize
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUseTableStyleRowBandSize
      (AOptions: TdxTablePropertiesOptions): Boolean; static;
    class procedure SetOptionsUseTableStyleRowBandSize
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUseFloatingPosition
      (AOptions: TdxTablePropertiesOptions): Boolean; static;
    class procedure SetOptionsUseFloatingPosition
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUseBackgroundColor
      (AOptions: TdxTablePropertiesOptions): Boolean; static;
    class procedure SetOptionsUseBackgroundColor
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUseAvoidDoubleBorders
      (AOptions: TdxTablePropertiesOptions): Boolean; static;
    class procedure SetOptionsUseAvoidDoubleBorders
      (AOptions: TdxTablePropertiesOptions; const Value: Boolean); static;
  public
    ...
    class function OuterOrInside(AMask: Integer;
      AIsBorderCell: Boolean): Integer;

    property UseLeftMargin: Boolean index MaskUseLeftMargin read GetValue
      write SetValue;
    property UseRightMargin: Boolean index MaskUseRightMargin read GetValue
      write SetValue;
    property UseTopMargin: Boolean index MaskUseTopMargin read GetValue
      write SetValue;
    property UseBottomMargin: Boolean index MaskUseBottomMargin read GetValue
      write SetValue;
    property UseCellSpacing: Boolean index MaskUseCellSpacing read GetValue
      write SetValue;
    property UseTableIndent: Boolean index MaskUseTableIndent read GetValue
      write SetValue;
    property UseTableLayout: Boolean index MaskUseTableLayout read GetValue
      write SetValue;
    property UseTableAlignment: Boolean index MaskUseTableAlignment
      read GetValue write SetValue;
    property UseTableLook: Boolean index MaskUseTableLook read GetValue
      write SetValue;
    property UsePreferredWidth: Boolean index MaskUsePreferredWidth
      read GetValue write SetValue;
    property UseTableStyleColBandSize: Boolean
      index MaskUseTableStyleColBandSize read GetValue write SetValue;
    property UseTableStyleRowBandSize: Boolean
      index MaskUseTableStyleRowBandSize read GetValue write SetValue;
    property UseIsTableOverlap: Boolean index MaskUseIsTableOverlap
      read GetValue write SetValue;
    property UseFloatingPosition: Boolean index MaskUseFloatingPosition
      read GetValue write SetValue;
    property UseBackgroundColor: Boolean index MaskUseBackgroundColor
      read GetValue write SetValue;
    property UseLeftBorder: Boolean index MaskUseLeftBorder read GetValue
      write SetValue;
    property UseRightBorder: Boolean index MaskUseRightBorder read GetValue
      write SetValue;
    property UseTopBorder: Boolean index MaskUseTopBorder read GetValue
      write SetValue;
    property UseBottomBorder: Boolean index MaskUseBottomBorder read GetValue
      write SetValue;
    property UseInsideHorizontalBorder: Boolean
      index MaskUseInsideHorizontalBorder read GetValue write SetValue;
    property UseInsideVerticalBorder: Boolean index MaskUseInsideVerticalBorder
      read GetValue write SetValue;
    property UseBorders: Boolean index MaskUseBorders read GetValue
      write SetValue;
    property UseAvoidDoubleBorders: Boolean index MaskUseAvoidDoubleBorders
      read GetValue write SetValue;
  ...
  TdxHorizontalAlignMode = (None, Center, Inside, Left, Outside, Right);

  TdxVerticalAlignMode = (None, Bottom, Center, &Inline, Inside, Outside, Top);

  TdxVerticalAnchorTypes = (Margin, Page, Paragraph);

  TdxHorizontalAnchorTypes = (Margin, Page, Column);

  TdxTextWrapping = (Never, Around);
  ...
  public
    ...
    property TableHorizontalPosition: Integer read FTableHorizontalPosition
      write FTableHorizontalPosition;
    property TableVerticalPosition: Integer read FTableVerticalPosition
      write FTableVerticalPosition;
    property HorizontalAlign: TdxHorizontalAlignMode read FHorizAlign
      write FHorizAlign;
    property VerticalAlign: TdxVerticalAlignMode read FVertAlign
      write FVertAlign;
    property HorizontalAnchor: TdxHorizontalAnchorTypes read FHorizAnchor
      write FHorizAnchor;
    property VerticalAnchor: TdxVerticalAnchorTypes read FVertAnchor
      write FVertAnchor;
    property TextWrapping: TdxTextWrapping read FTextWrapping
      write FTextWrapping;
  end;

  TdxTableFloatingPositionChangeType = (None, LeftFromText, RightFromText,
    TopFromText, BottomFromText, TableHorizontalPosition, TableVerticalPosition,
    HorizontalAlign, VerticalAlign, HorizontalAnchor, VerticalAnchor,
    TextWrapping, BatchUpdate);

  { TdxTableFloatingPosition }

  TdxTableFloatingPosition = class
    (TdxRichEditIndexBasedObject<TdxTableFloatingPositionInfo>)
  strict private
  ...
  strict protected
    function SetBottomFromText(const AInfo: TdxTableFloatingPositionInfo;
      const AValue: Integer): TdxDocumentModelChangeActions;
    function SetLeftFromText(const AInfo: TdxTableFloatingPositionInfo;
      const AValue: Integer): TdxDocumentModelChangeActions;
    function SetTopFromText(const AInfo: TdxTableFloatingPositionInfo;
      const AValue: Integer): TdxDocumentModelChangeActions;
    function SetRightFromText(const AInfo: TdxTableFloatingPositionInfo;
      const AValue: Integer): TdxDocumentModelChangeActions;
    function SetTableHorizontalPosition(const AInfo
      : TdxTableFloatingPositionInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions;
    function SetTableVerticalPosition(const AInfo: TdxTableFloatingPositionInfo;
      const AValue: Integer): TdxDocumentModelChangeActions;
    function SetHorizontalAlign(const AInfo: TdxTableFloatingPositionInfo;
      const AValue: TdxHorizontalAlignMode): TdxDocumentModelChangeActions;
    function SetVerticalAlign(const AInfo: TdxTableFloatingPositionInfo;
      const AValue: TdxVerticalAlignMode): TdxDocumentModelChangeActions;
    function SetHorizontalAnchor(const AInfo: TdxTableFloatingPositionInfo;
      const AValue: TdxHorizontalAnchorTypes): TdxDocumentModelChangeActions;
    function SetVerticalAnchor(const AInfo: TdxTableFloatingPositionInfo;
      const AValue: TdxVerticalAnchorTypes): TdxDocumentModelChangeActions;
    function SetTextWrapping(const AInfo: TdxTableFloatingPositionInfo;
      const AValue: TdxTextWrapping): TdxDocumentModelChangeActions;

    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxTableFloatingPositionInfo>; override;
    procedure OnBeginAssign; override;
    procedure OnEndAssign; override;
    function GetBatchUpdateChangeActions
      : TdxDocumentModelChangeActions; override;

    property Owner: IdxPropertiesContainer read FOwner;
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      const AOwner: IdxPropertiesContainer); reintroduce;
    ...
    property BottomFromText: Integer read GetBottomFromText
      write InnerSetBottomFromText;
    property LeftFromText: Integer read GetLeftFromText
      write InnerSetLeftFromText;
    property TopFromText: Integer read GetTopFromText write InnerSetTopFromText;
    property RightFromText: Integer read GetRightFromText
      write InnerSetRightFromText;
    property TableHorizontalPosition: Integer read GetTableHorizontalPosition
      write InnerSetTableHorizontalPosition;
    property TableVerticalPosition: Integer read GetTableVerticalPosition
      write InnerSetTableVerticalPosition;
    property HorizontalAlign: TdxHorizontalAlignMode read GetHorizontalAlign
      write InnerSetHorizontalAlign;
    property VerticalAlign: TdxVerticalAlignMode read GetVerticalAlign
      write InnerSetVerticalAlign;
    property HorizontalAnchor: TdxHorizontalAnchorTypes read GetHorizontalAnchor
      write InnerSetHorizontalAnchor;
    property VerticalAnchor: TdxVerticalAnchorTypes read GetVerticalAnchor
      write InnerSetVerticalAnchor;
    property TextWrapping: TdxTextWrapping read GetTextWrapping
      write InnerSetTextWrapping;
  end;

  { TdxTableFloatingPositionInfoCache }

  TdxTableFloatingPositionInfoCache = class
    (TdxUniqueItemsCache<TdxTableFloatingPositionInfo>)
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxTableFloatingPositionInfo; override;
  end;
  ...
  public
    ...
    property TableStyleColBandSize: Integer read FTableStyleColumnBandSize
      write FTableStyleColumnBandSize;
    property TableStyleRowBandSize: Integer read FTableStyleRowBandSize
      write FTableStyleRowBandSize;
    property IsTableOverlap: Boolean read FIsTableOverlap write FIsTableOverlap;
    property AvoidDoubleBorders: Boolean read FAvoidDoubleBorders
      write FAvoidDoubleBorders;
    property TableLayout: TdxTableLayoutType read FTableLayout
      write FTableLayout;
    property TableAlignment: TdxTableRowAlignment read FTableAlignment
      write FTableAlignment;
  ...
  TdxTableGeneralSettingsChangeType = (None = 0, TableLayout, TableLook,
    TableStyleColumnBandSize, TableStyleRowBandSize, IsTableOverlap,
    BackgroundColor, BatchUpdate, TableAlignment, AvoidDoubleBorders);

  { TdxTableGeneralSettingsInfoCache }

  TdxTableGeneralSettingsInfoCache = class
    (TdxUniqueItemsCache<TdxTableGeneralSettingsInfo>)
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxTableGeneralSettingsInfo; override;
  end;

  { TdxTableGeneralSettings }

  TdxTableGeneralSettings = class
    (TdxRichEditIndexBasedObject<TdxTableGeneralSettingsInfo>)
  strict private
    FOwner: IdxPropertiesContainer;
  ...
  strict protected
    function SetTableLayout(const ASettings: TdxTableGeneralSettingsInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; overload;
    function SetTableAlignment(const ASettings: TdxTableGeneralSettingsInfo;
      const AValue: Integer): TdxDocumentModelChangeActions;
    function SetTableLook(const ASettings: TdxTableGeneralSettingsInfo;
      const AValue: TdxTableLookTypes): TdxDocumentModelChangeActions;
    function SetBackgroundColor(const ASettings: TdxTableGeneralSettingsInfo;
      const AValue: Integer): TdxDocumentModelChangeActions;
    function SetTableStyleColumnBandSize(const ASettings
      : TdxTableGeneralSettingsInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions;
    function SetTableStyleRowBandSize(const ASettings
      : TdxTableGeneralSettingsInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions;
    function SetTableOverlap(const ASettings: TdxTableGeneralSettingsInfo;
      const AValue: Boolean): TdxDocumentModelChangeActions;
    function SetAvoidDoubleBorders(const ASettings: TdxTableGeneralSettingsInfo;
      const AValue: Boolean): TdxDocumentModelChangeActions;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxTableGeneralSettingsInfo>; override;
    ...
    procedure ApplyChanges(const AChangeActions
      : TdxDocumentModelChangeActions); override;
    procedure RaiseObtainAffectedRange(const AArgs
      : TdxObtainAffectedRangeEventArgs); override;
    property Owner: IdxPropertiesContainer read FOwner;
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      const AOwner: IdxPropertiesContainer); reintroduce;
...
{$IFNDEF DELPHI17}
    procedure CopyFrom(const ANewSettings
      : TdxTableGeneralSettingsInfo); override;
    procedure CopyFrom(const Source
      : TdxUndoableIndexBasedObject<TdxTableGeneralSettingsInfo>); override;
{$ENDIF}
    property TableLayout: TdxTableLayoutType read GetTableLayout
      write InnerSetTableLayout;
    property TableAlignment: TdxTableRowAlignment read GetTableAlignment
      write InnerSetTableAlignment;
    property TableLook: TdxTableLookTypes read GetTableLook
      write InnerSetTableLook;
    property BackgroundColor: TdxAlphaColor read GetBackgroundColor
      write InnerSetBackgroundColor;
    property TableStyleColumnBandSize: Integer read GetTableStyleColumnBandSize
      write InnerSetTableStyleColumnBandSize;
    property TableStyleRowBandSize: Integer read GetTableStyleRowBandSize
      write InnerSetTableStyleRowBandSize;
    property IsTableOverlap: Boolean read GetIsTableOverlap
      write InnerSetIsTableOverlap;
    property AvoidDoubleBorders: Boolean read GetAvoidDoubleBorders
      write InnerSetAvoidDoubleBorders;
  end;

  { TdxTableProperties }

  TdxTableProperties = class(TdxPropertiesBase<TdxTablePropertiesOptions>,
    IdxTablePropertiesContainer, IdxPropertiesContainerWithMask,
  ...
  protected
    function GetAccessor(AChangedProperty: TdxProperties)
      : TdxBoolPropertyAccessor<TdxTablePropertiesOptions>; override;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxTablePropertiesOptions>; override;
    function GetBatchUpdateChangeActions
      : TdxDocumentModelChangeActions; override;
  public
...
{$IFNDEF DELPHI17}
    ...
    procedure CopyFrom(const Source
      : TdxUndoableIndexBasedObject<TdxTablePropertiesOptions>); override;
{$ENDIF}
    function GetUse(AMask: Integer): Boolean;
    ...
    property IsTableOverlap: Boolean read GetIsTableOverlap
      write SetIsTableOverlap;
    property TableAlignment: TdxTableRowAlignment read GetTableAlignment
      write SetTableAlignment;
    ...
    property TableStyleColBandSize: Integer read GetTableStyleColBandSize
      write SetTableStyleColBandSize;
    property TableStyleRowBandSize: Integer read GetTableStyleRowBandSize
      write SetTableStyleRowBandSize;
    property PreferredWidth: TdxPreferredWidth read FPreferredWidth;
    property UseLeftMargin: Boolean
      index TdxTablePropertiesOptions.MaskUseLeftMargin read GetUse;
    property UseRightMargin: Boolean
      index TdxTablePropertiesOptions.MaskUseRightMargin read GetUse;
    property UseTopMargin: Boolean
      index TdxTablePropertiesOptions.MaskUseTopMargin read GetUse;
    property UseBottomMargin: Boolean
      index TdxTablePropertiesOptions.MaskUseBottomMargin read GetUse;
    property UseCellSpacing: Boolean
      index TdxTablePropertiesOptions.MaskUseCellSpacing read GetUse;
    property UseTableIndent: Boolean
      index TdxTablePropertiesOptions.MaskUseTableIndent read GetUse;
    property UsePreferredWidth: Boolean
      index TdxTablePropertiesOptions.MaskUsePreferredWidth read GetUse;
    property UseTableLayout: Boolean
      index TdxTablePropertiesOptions.MaskUseTableLayout read GetUse;
    property UseTableAlignment: Boolean
      index TdxTablePropertiesOptions.MaskUseTableAlignment read GetUse;
    property UseTableLook: Boolean
      index TdxTablePropertiesOptions.MaskUseTableLook read GetUse;
    property UseTableStyleColBandSize: Boolean
      index TdxTablePropertiesOptions.MaskUseTableStyleColBandSize read GetUse;
    property UseTableStyleRowBandSize: Boolean
      index TdxTablePropertiesOptions.MaskUseTableStyleRowBandSize read GetUse;
    property UseIsTableOverlap: Boolean
      index TdxTablePropertiesOptions.MaskUseIsTableOverlap read GetUse;
    property UseFloatingPosition: Boolean
      index TdxTablePropertiesOptions.MaskUseFloatingPosition read GetUse;
    property UseBackgroundColor: Boolean
      index TdxTablePropertiesOptions.MaskUseBackgroundColor read GetUse;
    property UseAvoidDoubleBorders: Boolean
      index TdxTablePropertiesOptions.MaskUseAvoidDoubleBorders read GetUse;
  ...
  TdxTablePropertiesOptionsCache = class
    (TdxUniqueItemsCache<TdxTablePropertiesOptions>)
  public const
    EmptyTableFormattingOptionsItem = 0;
    RootTableFormattingOptionsItem = 1;
  protected
    procedure InitItems(const AUnitConverter
      : IdxDocumentModelUnitConverter); override;
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxTablePropertiesOptions; override;
  ...
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      const AOwner: IdxPropertiesContainerWithMask);
    destructor Destroy; override;
    ...
    property InsideHorizontalBorder: TdxInsideHorizontalBorder
      read FInsideHorizontalBorder;
    property InsideVerticalBorder: TdxInsideVerticalBorder
      read FInsideVerticalBorder;
    ...
    property UseInsideHorizontalBorder: Boolean
      read GetUseInsideHorizontalBorder;
  ...
  protected
    ...
    function SetValueCore(const AUnit: TdxWidthUnitInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions; override;
  end;
  ...
  strict private
    FValue: Integer;
  protected
    class function GetOptionsUseCantSplit
      (AOptions: TdxTableRowPropertiesOptions): Boolean; static;
    class function GetOptionsUseCellSpacing
      (AOptions: TdxTableRowPropertiesOptions): Boolean; static;
    class function GetOptionsUseGridAfter
      (AOptions: TdxTableRowPropertiesOptions): Boolean; static;
    class function GetOptionsUseGridBefore
      (AOptions: TdxTableRowPropertiesOptions): Boolean; static;
    class function GetOptionsUseHeader(AOptions: TdxTableRowPropertiesOptions)
      : Boolean; static;
    class function GetOptionsUseHeight(AOptions: TdxTableRowPropertiesOptions)
      : Boolean; static;
    class function GetOptionsUseHideCellMark
      (AOptions: TdxTableRowPropertiesOptions): Boolean; static;
    class function GetOptionsUseTableRowAlignment
      (AOptions: TdxTableRowPropertiesOptions): Boolean; static;
    class function GetOptionsUseWidthAfter
      (AOptions: TdxTableRowPropertiesOptions): Boolean; static;
    class function GetOptionsUseWidthBefore
      (AOptions: TdxTableRowPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseCantSplit
      (AOptions: TdxTableRowPropertiesOptions; const AValue: Boolean); static;
    class procedure SetOptionsUseCellSpacing
      (AOptions: TdxTableRowPropertiesOptions; const AValue: Boolean); static;
    class procedure SetOptionsUseGridAfter
      (AOptions: TdxTableRowPropertiesOptions; const AValue: Boolean); static;
    class procedure SetOptionsUseGridBefore
      (AOptions: TdxTableRowPropertiesOptions; const AValue: Boolean); static;
    class procedure SetOptionsUseHeader(AOptions: TdxTableRowPropertiesOptions;
      const AValue: Boolean); static;
    class procedure SetOptionsUseHeight(AOptions: TdxTableRowPropertiesOptions;
      const AValue: Boolean); static;
    class procedure SetOptionsUseHideCellMark
      (AOptions: TdxTableRowPropertiesOptions; const AValue: Boolean); static;
    class procedure SetOptionsUseTableRowAlignment
      (AOptions: TdxTableRowPropertiesOptions; const AValue: Boolean); static;
    class procedure SetOptionsUseWidthAfter
      (AOptions: TdxTableRowPropertiesOptions; const AValue: Boolean); static;
    class procedure SetOptionsUseWidthBefore
      (AOptions: TdxTableRowPropertiesOptions; const AValue: Boolean); static;
  ...
  public
    ...
    property UseCantSplit: Boolean index MaskUseCantSplit read GetVal
      write SetVal;
    property UseHideCellMark: Boolean index MaskUseHideCellMark read GetVal
      write SetVal;
    property UseHeader: Boolean index MaskUseHeader read GetVal write SetVal;
    property UseGridBefore: Boolean index MaskUseGridBefore read GetVal
      write SetVal;
    property UseGridAfter: Boolean index MaskUseGridAfter read GetVal
      write SetVal;
    property UseWidthBefore: Boolean index MaskUseWidthBefore read GetVal
      write SetVal;
    property UseWidthAfter: Boolean index MaskUseWidthAfter read GetVal
      write SetVal;
    property UseCellSpacing: Boolean index MaskUseCellSpacing read GetVal
      write SetVal;
    property UseTableRowAlignment: Boolean index MaskUseTableRowAlignment
      read GetVal write SetVal;
  ...
  protected
    function GetAccessor(AChangedProperty: TdxProperties)
      : TdxBoolPropertyAccessor<TdxTableRowPropertiesOptions>; override;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxTableRowPropertiesOptions>; override;
    function GetBatchUpdateChangeActions
      : TdxDocumentModelChangeActions; override;
...
{$IFNDEF DELPHI17}
    ...
    procedure CopyFrom(const Source
      : TdxUndoableIndexBasedObject<TdxTableRowPropertiesOptions>); override;
{$ENDIF}
    function GetUse(AMask: Integer): Boolean;
    procedure Reset;
    procedure ResetAllUse;
    ...
    property TableRowAlignment: TdxTableRowAlignment read GetTableRowAlignment
      write SetTableRowAlignment;
    property UseCantSplit: Boolean index TdxTableRowPropertiesOptions.
      MaskUseCantSplit read GetUse;
    property UseCellSpacing: Boolean index TdxTableRowPropertiesOptions.
      MaskUseCellSpacing read GetUse;
    property UseGridAfter: Boolean index TdxTableRowPropertiesOptions.
      MaskUseGridAfter read GetUse;
    property UseGridBefore: Boolean index TdxTableRowPropertiesOptions.
      MaskUseGridBefore read GetUse;
    property UseHeader: Boolean index TdxTableRowPropertiesOptions.MaskUseHeader
      read GetUse;
    property UseHeight: Boolean index TdxTableRowPropertiesOptions.MaskUseHeight
      read GetUse;
    property UseHideCellMark: Boolean
      index TdxTableRowPropertiesOptions.MaskUseHideCellMark read GetUse;
    property UseTableRowAlignment: Boolean
      index TdxTableRowPropertiesOptions.MaskUseTableRowAlignment read GetUse;
    property UseWidthAfter: Boolean index TdxTableRowPropertiesOptions.
      MaskUseWidthAfter read GetUse;
    property UseWidthBefore: Boolean index TdxTableRowPropertiesOptions.
      MaskUseWidthBefore read GetUse;
  ...
  public
    ...
    property TableRowAlignment: TdxTableRowAlignment read FTableRowAlignment
      write FTableRowAlignment;
  end;

  { TdxTableRowGeneralSettingsInfoCache }

  TdxTableRowGeneralSettingsInfoCache = class
    (TdxUniqueItemsCache<TdxTableRowGeneralSettingsInfo>)
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxTableRowGeneralSettingsInfo;
      override;
  end;

  TdxTableRowChangeType = (None = 0, Header, HideCellMark, CantSplit,
    TableRowAlignment, TableRowConditionalFormatting, GridAfter, GridBefore,
    BatchUpdate);

  { TdxTableRowGeneralSettings }

  TdxTableRowGeneralSettings = class
    (TdxRichEditIndexBasedObject<TdxTableRowGeneralSettingsInfo>)
  strict private
    FOwner: IdxPropertiesContainer;
    function GetCantSplit: Boolean;
    function GetGridAfter: Integer;
  ...
  strict protected
    ...
    procedure ApplyChanges(const AChangeActions
      : TdxDocumentModelChangeActions); override;
    function SetHeader(const AInfo: TdxTableRowGeneralSettingsInfo;
      const AValue: Boolean): TdxDocumentModelChangeActions;
    function SetHideCellMark(const AInfo: TdxTableRowGeneralSettingsInfo;
      const AValue: Boolean): TdxDocumentModelChangeActions;
    function SetCantSplit(const AInfo: TdxTableRowGeneralSettingsInfo;
      const AValue: Boolean): TdxDocumentModelChangeActions;
    function SetTableRowAlignment(const AInfo: TdxTableRowGeneralSettingsInfo;
      const AValue: TdxTableRowAlignment): TdxDocumentModelChangeActions;
    function SetGridAfter(const AInfo: TdxTableRowGeneralSettingsInfo;
      const AValue: Integer): TdxDocumentModelChangeActions;
    function SetGridBefore(const AInfo: TdxTableRowGeneralSettingsInfo;
      const AValue: Integer): TdxDocumentModelChangeActions;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxTableRowGeneralSettingsInfo>; override;
...
{$IFNDEF DELPHI17}
    ...
    procedure CopyFrom(const Source
      : TdxUndoableIndexBasedObject<TdxTableRowGeneralSettingsInfo>); override;
{$ENDIF}
    property Header: Boolean read GetHeader write InnerSetHeader;
    property HideCellMark: Boolean read GetHideCellMark
      write InnerSetHideCellMark;
    property CantSplit: Boolean read GetCantSplit write InnerSetCantSplit;
    property TableRowAlignment: TdxTableRowAlignment read GetTableRowAlignment
      write InnerSetTableRowAlignment;
  ...
  TdxCombinedTableRowPropertiesInfo = class(TdxCloneable)
  private
    FIsOwner: Boolean;
  ...
  public
    ...
    constructor Create(ARowProperties: TdxTableRowProperties);
    ...
    property GeneralSettings: TdxTableRowGeneralSettingsInfo
      read FGeneralSettings;
  end;

  { TdxMergedTableRowProperties }

  TdxMergedTableRowProperties = class
    (TdxMergedCloneableOptionsProperties<TdxCombinedTableRowPropertiesInfo,
    TdxTableRowPropertiesOptions>)
  protected
    procedure MergeCore(const AInfo: TdxCombinedTableRowPropertiesInfo;
      const AOptions: TdxTableRowPropertiesOptions);
  public
    constructor Create(AInitialProperties: TdxTableRowProperties);
      reintroduce; overload;
    constructor Create(AInitialProperties: TdxMergedTableRowProperties);
      reintroduce; overload;
  ...
  TdxTableRowPropertiesOptionsCache = class
    (TdxUniqueItemsCache<TdxTableRowPropertiesOptions>)
  public const
  ...
  protected
    procedure InitItems(const AUnitConverter
      : IdxDocumentModelUnitConverter); override;
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxTableRowPropertiesOptions; override;
    procedure AddRootStyleOptions;
  end;
  ...
  private
    FValue: Integer;
  protected
    class function GetOptionsUseCellConditionalFormatting
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseCellConditionalFormatting
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;

    class function GetOptionsUseTopMargin
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseTopMargin
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
    class function GetOptionsUseBottomMargin
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseBottomMargin
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
    class function GetOptionsUseLeftMargin
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseLeftMargin
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
    class function GetOptionsUseRightMargin
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseRightMargin
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;

    class function GetOptionsUseFitText(AOptions: TdxTableCellPropertiesOptions)
      : Boolean; static;
    class procedure SetOptionsUseFitText
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
    class function GetOptionsUseHideCellMark
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseHideCellMark
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
    class function GetOptionsUseNoWrap(AOptions: TdxTableCellPropertiesOptions)
      : Boolean; static;
    class procedure SetOptionsUseNoWrap(AOptions: TdxTableCellPropertiesOptions;
      const AValue: Boolean); static;
    class function GetOptionsUsePreferredWidth
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUsePreferredWidth
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
    class function GetOptionsUseTextDirection
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseTextDirection
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
    class function GetOptionsUseVerticalAlignment
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseVerticalAlignment
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
    class function GetOptionsUseVerticalMerging
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseVerticalMerging
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
    class function GetOptionsUseColumnSpan
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseColumnSpan
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
    class function GetOptionsUseBackgroundColor
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseBackgroundColor
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
    class function GetOptionsUseForegroundColor
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseForegroundColor
      (AOptions: TdxTableCellPropertiesOptions; const Value: Boolean); static;
    class function GetOptionsUseShading(AOptions: TdxTableCellPropertiesOptions)
      : Boolean; static;
    class procedure SetOptionsUseShading
      (AOptions: TdxTableCellPropertiesOptions; const Value: Boolean); static;

    class function GetOptionsUseLeftBorder
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseLeftBorder
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
    class function GetOptionsUseRightBorder
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseRightBorder
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
    class function GetOptionsUseTopBorder
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseTopBorder
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
    class function GetOptionsUseBottomBorder
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseBottomBorder
    ...
    class procedure SetOptionsUseInsideHorizontalBorder
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
    class function GetOptionsUseTopLeftDiagonalBorder
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseTopLeftDiagonalBorder
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
    class function GetOptionsUseTopRightDiagonalBorder
      (AOptions: TdxTableCellPropertiesOptions): Boolean; static;
    class procedure SetOptionsUseTopRightDiagonalBorder
      (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean); static;
  ...
  public
    ...
    property UseLeftBorder: Boolean index MaskUseLeftBorder read GetVal
      write SetVal;
    property UseRightBorder: Boolean index MaskUseRightBorder read GetVal
      write SetVal;
    property UseTopBorder: Boolean index MaskUseTopBorder read GetVal
      write SetVal;
    property UseBottomBorder: Boolean index MaskUseBottomBorder read GetVal
      write SetVal;
    property UseInsideHorizontalBorder: Boolean
      index MaskUseInsideHorizontalBorder read GetVal write SetVal;
    property UseInsideVerticalBorder: Boolean index MaskUseInsideVerticalBorder
      read GetVal write SetVal;
    property UseTopLeftDiagonalBorder: Boolean
      index MaskUseTopLeftDiagonalBorder read GetVal write SetVal;
    property UseTopRightDiagonalBorder: Boolean
      index MaskUseTopRightDiagonalBorder read GetVal write SetVal;

    property UsePreferredWidth: Boolean index MaskUsePreferredWidth read GetVal
      write SetVal;
    property UseHideCellMark: Boolean index MaskUseHideCellMark read GetVal
      write SetVal;
    ...
    property UseLeftMargin: Boolean index MaskUseLeftMargin read GetVal
      write SetVal;
    property UseRightMargin: Boolean index MaskUseRightMargin read GetVal
      write SetVal;
    property UseTopMargin: Boolean index MaskUseTopMargin read GetVal
      write SetVal;
    property UseBottomMargin: Boolean index MaskUseBottomMargin read GetVal
      write SetVal;
    property UseTextDirection: Boolean index MaskUseTextDirection read GetVal
      write SetVal;
    property UseVerticalAlignment: Boolean index MaskUseVerticalAlignment
      read GetVal write SetVal;
    property UseCellConditionalFormatting: Boolean
      index MaskUseCellConditionalFormatting read GetVal write SetVal;
    property UseBackgroundColor: Boolean index MaskUseBackgroundColor
      read GetVal write SetVal;
    property UseForegroundColor: Boolean index MaskUseForegroundColor
      read GetVal write SetVal;
  ...
  TdxTableCellChangeType = (None = 0, HideCellMark, NoWrap, FitText,
    TextDirection, VerticalAlignment, ColumnSpan, HorizontalMerging,
    VerticalMerging, ConditionalFormatting, BackgroundColor, ForegroundColor,
    Shading, BatchUpdate);

  { TdxTableCellPropertiesOptionsCache }

  TdxTableCellPropertiesOptionsCache = class
    (TdxUniqueItemsCache<TdxTableCellPropertiesOptions>)
  public const
  ...
  protected
    procedure InitItems(const AUnitConverter
      : IdxDocumentModelUnitConverter); override;
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxTableCellPropertiesOptions; override;
    procedure AddRootStyleOptions;
  end;

  { TdxTableCellProperties }

  TdxMergingState = (None, Continue, Restart);

  TdxTableCellProperties = class
    (TdxPropertiesBase<TdxTableCellPropertiesOptions>,
    IdxCellPropertiesContainer, IdxCellMarginsContainer)
  private
    FPreferredWidth: TdxPreferredWidth;
    ...
    function GetBackgroundColor: TdxAlphaColor;
    function GetCellConditionalFormatting
      : TdxConditionalTableStyleFormattingTypes;
    ...
    procedure SetBackgroundColor(const Value: TdxAlphaColor);
    procedure SetCellConditionalFormatting(const Value
      : TdxConditionalTableStyleFormattingTypes);
  ...
  protected
    function GetAccessor(AChangedProperty: TdxProperties)
      : TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>; override;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxTableCellPropertiesOptions>; override;
    function GetBatchUpdateChangeActions
      : TdxDocumentModelChangeActions; override;
    function CreateIndexChangedHistoryItem
      : TdxIndexChangedHistoryItemCore; override;
    procedure RaisePropertiesChanged;
    property Owner: IdxCellPropertiesOwner read FOwner;
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      const AOwner: IdxCellPropertiesOwner); reintroduce;
    destructor Destroy; override;
...
{$IFNDEF DELPHI17}
    ...
    procedure CopyFrom(const Source
      : TdxUndoableIndexBasedObject<TdxTableCellPropertiesOptions>); override;
{$ENDIF}
    procedure Reset;
    procedure ResetAllUse;
    procedure ResetUse(AMask: Integer);
    ...
    property CellConditionalFormatting: TdxConditionalTableStyleFormattingTypes
      read GetCellConditionalFormatting write SetCellConditionalFormatting;
    property CellMargins: TdxCellMargins read FCellMargins;
    ...
    property ForegroundColor: TdxAlphaColor read GetForegroundColor
    ...
    property TextDirection: TdxTextDirection read GetTextDirection
      write SetTextDirection;
    property VerticalAlignment: TdxVerticalAlignment read GetVerticalAlignment
      write SetVerticalAlignment;
    property VerticalMerging: TdxMergingState read GetVerticalMerging
      write SetVerticalMerging;
    property UseBackgroundColor: Boolean
      index TdxTableCellPropertiesOptions.MaskUseBackgroundColor read GetUse;
    property UseBottomMargin: Boolean index TdxTableCellPropertiesOptions.
      MaskUseBottomMargin read GetUse;
    property UseCellConditionalFormatting: Boolean
      index TdxTableCellPropertiesOptions.MaskUseCellConditionalFormatting
      read GetUse;
    property UseFitText: Boolean index TdxTableCellPropertiesOptions.
      MaskUseFitText read GetUse;
    property UseForegroundColor: Boolean
      index TdxTableCellPropertiesOptions.MaskUseForegroundColor read GetUse;
    property UseHideCellMark: Boolean index TdxTableCellPropertiesOptions.
      MaskUseHideCellMark read GetUse;
    property UseLeftMargin: Boolean index TdxTableCellPropertiesOptions.
      MaskUseLeftMargin read GetUse;
    property UseNoWrap: Boolean index TdxTableCellPropertiesOptions.
      MaskUseNoWrap read GetUse;
    property UsePreferredWidth: Boolean
      index TdxTableCellPropertiesOptions.MaskUsePreferredWidth read GetUse;
    property UseRightMargin: Boolean index TdxTableCellPropertiesOptions.
      MaskUseRightMargin read GetUse;
    property UseShading: Boolean index TdxTableCellPropertiesOptions.
      MaskUseShading read GetUse;
    property UseTextDirection: Boolean
      index TdxTableCellPropertiesOptions.MaskUseTextDirection read GetUse;
    property UseTopMargin: Boolean index TdxTableCellPropertiesOptions.
      MaskUseTopMargin read GetUse;
    property UseVerticalAlignment: Boolean
      index TdxTableCellPropertiesOptions.MaskUseVerticalAlignment read GetUse;
    property UseValue: Integer read GetUseValue write SetUseValue;
  end;
  ...
  public
    constructor Create; overload; override;
    constructor Create(ATableBorders: TdxTableCellBorders);
      reintroduce; overload;
    destructor Destroy; override;
    procedure CopyFrom(Source: TdxCloneable); override;
  ...
  public
    constructor Create; overload; override;
    constructor Create(ATableProperties: TdxTableProperties);
      reintroduce; overload;
    destructor Destroy; override;
    procedure CopyFrom(Source: TdxCloneable); override;
    ...
    property FloatingPosition: TdxTableFloatingPositionInfo
      read FFloatingPosition;
  end;

  { TdxMergedTableProperties }

  TdxMergedTableProperties = class
    (TdxMergedCloneableOptionsProperties<TdxCombinedTablePropertiesInfo,
    TdxTablePropertiesOptions>)
  protected
    procedure MergeCore(const AInfo: TdxCombinedTablePropertiesInfo;
      const AOptions: TdxTablePropertiesOptions);
  public
    constructor Create(AInitialProperties: TdxTableProperties);
      reintroduce; overload;
    constructor Create(AInitialProperties: TdxMergedTableProperties);
      reintroduce; overload;
  ...
  public
    constructor Create; overload; override;
    constructor Create(ACellProperties: TdxTableCellProperties);
      reintroduce; overload;
    destructor Destroy; override;
    ...
    property GeneralSettings: TdxTableCellGeneralSettingsInfo
      read FGeneralSettings;
  end;
  ...
  TdxMergedTableCellProperties = class
    (TdxMergedCloneableOptionsProperties<TdxCombinedCellPropertiesInfo,
    TdxTableCellPropertiesOptions>)
  protected
    procedure MergeCore(const AInfo: TdxCombinedCellPropertiesInfo;
      const AOptions: TdxTableCellPropertiesOptions);
  public
    constructor Create(AInitialProperties: TdxTableCellProperties);
      reintroduce; overload;
    constructor Create(AInitialProperties: TdxMergedTableCellProperties);
      reintroduce; overload;
  ...
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      const AOwner: IdxCellPropertiesContainer);
    destructor Destroy; override;
    procedure Merge(ABorders: TdxBordersBase); override;
    procedure CopyFrom(const ABorders: TdxCombinedCellBordersInfo); overload;

    property TopLeftDiagonalBorder: TdxTopLeftDiagonalBorder
      read FTopLeftDiagonalBorder;
    property TopRightDiagonalBorder: TdxTopRightDiagonalBorder
      read FTopRightDiagonalBorder;
    property UseTopLeftDiagonalBorder: Boolean read GetUseTopLeftDiagonalBorder;
    property UseTopRightDiagonalBorder: Boolean
      read GetUseTopRightDiagonalBorder;
  end;
  ...
  public
    ...
    property HorizontalMerging: TdxMergingState read FHorizontalMerging
      write FHorizontalMerging;
    property VerticalMerging: TdxMergingState read FVerticalMerging
      write FVerticalMerging;
    property CellConditionalFormatting: TdxConditionalTableStyleFormattingTypes
      read FCellConditionalFormatting write FCellConditionalFormatting;
    property BackgroundColor: TdxAlphaColor read FBackgroundColor
      write FBackgroundColor;
    property ForegroundColor: TdxAlphaColor read FForegroundColor
  ...
  TdxTableCellGeneralSettings = class
    (TdxRichEditIndexBasedObject<TdxTableCellGeneralSettingsInfo>)
  strict private
    FOwner: IdxPropertiesContainer;
    function GetCellConditionalFormatting
      : TdxConditionalTableStyleFormattingTypes;
    ...
    function GetForegroundColor: TdxAlphaColor;
    function GetShading: TdxShadingPattern;
    procedure InnerSetCellConditionalFormatting(const Value
      : TdxConditionalTableStyleFormattingTypes);
  ...
  strict protected
    function SetHideCellMark(const AInfo: TdxTableCellGeneralSettingsInfo;
      const AValue: Boolean): TdxDocumentModelChangeActions;
    function SetNoWrap(const AInfo: TdxTableCellGeneralSettingsInfo;
      const AValue: Boolean): TdxDocumentModelChangeActions;
    function SetFitText(const AInfo: TdxTableCellGeneralSettingsInfo;
      const AValue: Boolean): TdxDocumentModelChangeActions;
    function SetTextDirection(const AInfo: TdxTableCellGeneralSettingsInfo;
      const AValue: TdxTextDirection): TdxDocumentModelChangeActions;
    function SetVerticalAlignment(const AInfo: TdxTableCellGeneralSettingsInfo;
      const AValue: TdxVerticalAlignment): TdxDocumentModelChangeActions;
    function SetColumnSpan(const AInfo: TdxTableCellGeneralSettingsInfo;
      const AValue: Integer): TdxDocumentModelChangeActions;
    function SetVerticalMerging(const AInfo: TdxTableCellGeneralSettingsInfo;
      const AValue: TdxMergingState): TdxDocumentModelChangeActions;
    function SetCellConditionalFormatting(const AInfo
      : TdxTableCellGeneralSettingsInfo;
      const AValue: TdxConditionalTableStyleFormattingTypes)
      : TdxDocumentModelChangeActions;
    function SetBackgroundColor(const AInfo: TdxTableCellGeneralSettingsInfo;
      const AValue: TdxAlphaColor): TdxDocumentModelChangeActions;
    function SetForegroundColor(const AInfo: TdxTableCellGeneralSettingsInfo;
      const AValue: TdxAlphaColor): TdxDocumentModelChangeActions;
    function SetShading(const AInfo: TdxTableCellGeneralSettingsInfo;
      const AValue: TdxShadingPattern): TdxDocumentModelChangeActions;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxTableCellGeneralSettingsInfo>; override;
    procedure BeginChanging(AChangedProperty: TdxProperties); virtual;
    procedure EndChanging; virtual;
    function GetBatchUpdateChangeActions
      : TdxDocumentModelChangeActions; override;
...
{$IFNDEF DELPHI17}
    ...
    procedure CopyFrom(const Source
      : TdxUndoableIndexBasedObject<TdxTableCellGeneralSettingsInfo>); override;
{$ENDIF}
    property HideCellMark: Boolean read GetHideCellMark
      write InnerSetHideCellMark;
    ...
    property TextDirection: TdxTextDirection read GetTextDirection
      write InnerSetTextDirection;
    property VerticalAlignment: TdxVerticalAlignment read GetVerticalAlignment
      write InnerSetVerticalAlignment;
    property ColumnSpan: Integer read GetColumnSpan write InnerSetColumnSpan;
    property VerticalMerging: TdxMergingState read GetVerticalMerging
      write InnerSetVerticalMerging;
    property CellConditionalFormatting: TdxConditionalTableStyleFormattingTypes
      read GetCellConditionalFormatting write InnerSetCellConditionalFormatting;
    property BackgroundColor: TdxAlphaColor read GetBackgroundColor
      write InnerSetBackgroundColor;
    property ForegroundColor: TdxAlphaColor read GetForegroundColor
      write InnerSetForegroundColor;
    property Shading: TdxShadingPattern read GetShading write InnerSetShading;
  end;

  { TdxTableCellGeneralSettingsInfoCache }

  TdxTableCellGeneralSettingsInfoCache = class
    (TdxUniqueItemsCache<TdxTableCellGeneralSettingsInfo>)
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter)
      : TdxTableCellGeneralSettingsInfo; override;
  end;
...
type
  ...
  public
    class function CalculateChangeActions
      (AChange: TdxTableFloatingPositionChangeType)
  ...
  public
    class function CalculateChangeActions
      (AChange: TdxTableGeneralSettingsChangeType)
      : TdxDocumentModelChangeActions; static;
  end;
  ...
  public
    class function CalculateChangeActions(AChange: TdxTableCellChangeType)
      : TdxDocumentModelChangeActions; static;
  end;
  ...
  public
    class function CalculateChangeActions(AChange: TdxTableRowChangeType)
      : TdxDocumentModelChangeActions; static;
  end;

  { TdxPropertiesBase<T> }

procedure TdxPropertiesBase<T>.ApplyChanges(const AChangeActions
  : TdxDocumentModelChangeActions);
begin
...
function TdxPropertiesBase<T>.ChangeOptionsCore(AChangedProperty: TdxProperties;
  out AIsDeferred: Boolean): T;
var
...
function TdxPropertiesBase<T>.ChangePropertiesOptions(const AAccessor
  : TdxBoolPropertyAccessor<T>; out AIsDeferred: Boolean): T;
begin
...
function TdxPropertiesBase<T>.ResetPropertiesOptions(const AAccessor
  : TdxBoolPropertyAccessor<T>; out AIsDeferred: Boolean): T;
begin
  Result := GetInfoForModification(AIsDeferred);
...
function TdxPropertiesBase<T>.GetAccessor(AChangedProperty: TdxProperties)
  : TdxBoolPropertyAccessor<T>;
begin
  raise Exception.Create('ThrowInternalException');
end;

function TdxPropertiesBase<T>.ResetOptionsCore(AChangedProperty: TdxProperties;
  out AIsDeferred: Boolean): T;
var
  AAccessor: TdxBoolPropertyAccessor<T>;
begin
...
procedure TdxPropertiesBase<T>.ResetPropertyUse(AChangedProperty
  : TdxProperties);
var
  AOptions: T;
  AIsDeferred: Boolean;
...
begin
  if AIsBorderCell then
    Exit(AMask);
  if (AMask and (TdxTablePropertiesOptions.MaskUseLeftBorder or
    TdxTablePropertiesOptions.MaskUseRightBorder)) <> 0 then
    AMask := AMask or TdxTablePropertiesOptions.MaskUseInsideVerticalBorder;
  if (AMask and (TdxTablePropertiesOptions.MaskUseTopBorder or
    TdxTablePropertiesOptions.MaskUseBottomBorder)) <> 0 then
    AMask := AMask or TdxTablePropertiesOptions.MaskUseInsideHorizontalBorder;
  Result := AMask and not(TdxTablePropertiesOptions.MaskUseLeftBorder or
    TdxTablePropertiesOptions.MaskUseRightBorder or
    TdxTablePropertiesOptions.MaskUseTopBorder or
    TdxTablePropertiesOptions.MaskUseBottomBorder);
end;
...
class function TdxTablePropertiesOptions.GetOptionsUseLeftBorder
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseLeftBorder;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseLeftBorder
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseLeftBorder := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseRightBorder
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseRightBorder;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseRightBorder
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseRightBorder := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseTopBorder
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseTopBorder;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseTopBorder
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseTopBorder := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseBottomBorder
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseBottomBorder;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseBottomBorder
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseBottomBorder := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseInsideVerticalBorder
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseInsideVerticalBorder;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseInsideVerticalBorder
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseInsideVerticalBorder := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseInsideHorizontalBorder
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseInsideHorizontalBorder;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseInsideHorizontalBorder
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseInsideHorizontalBorder := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseLeftMargin
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseLeftMargin;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseLeftMargin
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseLeftMargin := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseRightMargin
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseRightMargin;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseRightMargin
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseRightMargin := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseTopMargin
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseTopMargin;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseTopMargin
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseTopMargin := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseBottomMargin
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseBottomMargin;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseBottomMargin
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseBottomMargin := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseCellSpacing
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseCellSpacing;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseCellSpacing
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseCellSpacing := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUsePreferredWidth
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UsePreferredWidth;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUsePreferredWidth
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UsePreferredWidth := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseTableIndent
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseTableIndent;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseTableIndent
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseTableIndent := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseTableLayout
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseTableLayout;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseTableLayout
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseTableLayout := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseTableAlignment
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseTableAlignment;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseTableAlignment
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseTableAlignment := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseTableLook
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseTableLook;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseTableLook
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseTableLook := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseTableOverlap
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseIsTableOverlap;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseTableOverlap
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseIsTableOverlap := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseTableStyleColBandSize
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseTableStyleColBandSize;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseTableStyleColBandSize
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseTableStyleColBandSize := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseTableStyleRowBandSize
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseTableStyleRowBandSize;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseTableStyleRowBandSize
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseTableStyleRowBandSize := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseFloatingPosition
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseFloatingPosition;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseFloatingPosition
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseFloatingPosition := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseBackgroundColor
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseBackgroundColor;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseBackgroundColor
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
  AOptions.UseBackgroundColor := Value;
end;

class function TdxTablePropertiesOptions.GetOptionsUseAvoidDoubleBorders
  (AOptions: TdxTablePropertiesOptions): Boolean;
begin
  Result := AOptions.UseAvoidDoubleBorders;
end;

class procedure TdxTablePropertiesOptions.SetOptionsUseAvoidDoubleBorders
  (AOptions: TdxTablePropertiesOptions; const Value: Boolean);
begin
...
constructor TdxBoolPropertyAccessor<T>.Create
  (const AGet: TdxGetOptionValueDelegate<T>;
  const ASet: TdxSetOptionValueDelegate<T>);
begin
  FGet := AGet;
  FSet := ASet;
...
begin
  ...
  begin
    ...
    Result := (BottomFromText = APos.BottomFromText) and
      (LeftFromText = APos.LeftFromText) and (TopFromText = APos.TopFromText)
      and (RightFromText = APos.RightFromText) and
...
constructor TdxTableFloatingPosition.Create(APieceTable: TdxCustomPieceTable;
...
function TdxTableFloatingPosition.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxTableFloatingPositionChangeActionsCalculator.
    CalculateChangeActions(TdxTableFloatingPositionChangeType.BatchUpdate);
end;
...
function TdxTableFloatingPosition.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxTableFloatingPositionInfo>;
begin
  Result := TdxDocumentCache(ADocumentModel.Cache)
    .TableFloatingPositionInfoCache;
end;
...
procedure TdxTableFloatingPosition.InnerSetHorizontalAlign
  (const Value: TdxHorizontalAlignMode);
begin
...
procedure TdxTableFloatingPosition.InnerSetHorizontalAnchor
  (const Value: TdxHorizontalAnchorTypes);
begin
...
procedure TdxTableFloatingPosition.InnerSetTableHorizontalPosition
  (const Value: Integer);
begin
...
procedure TdxTableFloatingPosition.InnerSetTableVerticalPosition
  (const Value: Integer);
begin
...
procedure TdxTableFloatingPosition.InnerSetTextWrapping
  (const Value: TdxTextWrapping);
begin
...
procedure TdxTableFloatingPosition.InnerSetVerticalAlign
  (const Value: TdxVerticalAlignMode);
begin
...
procedure TdxTableFloatingPosition.InnerSetVerticalAnchor
  (const Value: TdxVerticalAnchorTypes);
begin
...
function TdxTableFloatingPosition.SetBottomFromText
  (const AInfo: TdxTableFloatingPositionInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.BottomFromText := AValue;
  Result := TdxTableFloatingPositionChangeActionsCalculator.
    CalculateChangeActions(TdxTableFloatingPositionChangeType.BottomFromText);
end;

function TdxTableFloatingPosition.SetHorizontalAlign
  (const AInfo: TdxTableFloatingPositionInfo;
  const AValue: TdxHorizontalAlignMode): TdxDocumentModelChangeActions;
begin
  AInfo.HorizontalAlign := AValue;
  Result := TdxTableFloatingPositionChangeActionsCalculator.
    CalculateChangeActions(TdxTableFloatingPositionChangeType.HorizontalAlign);
end;

function TdxTableFloatingPosition.SetHorizontalAnchor
  (const AInfo: TdxTableFloatingPositionInfo;
  const AValue: TdxHorizontalAnchorTypes): TdxDocumentModelChangeActions;
begin
  AInfo.HorizontalAnchor := AValue;
  Result := TdxTableFloatingPositionChangeActionsCalculator.
    CalculateChangeActions(TdxTableFloatingPositionChangeType.HorizontalAnchor);
end;

function TdxTableFloatingPosition.SetLeftFromText
  (const AInfo: TdxTableFloatingPositionInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.LeftFromText := AValue;
  Result := TdxTableFloatingPositionChangeActionsCalculator.
    CalculateChangeActions(TdxTableFloatingPositionChangeType.LeftFromText);
end;

function TdxTableFloatingPosition.SetRightFromText
  (const AInfo: TdxTableFloatingPositionInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.RightFromText := AValue;
  Result := TdxTableFloatingPositionChangeActionsCalculator.
    CalculateChangeActions(TdxTableFloatingPositionChangeType.RightFromText);
end;

function TdxTableFloatingPosition.SetTableHorizontalPosition
  (const AInfo: TdxTableFloatingPositionInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.TableHorizontalPosition := AValue;
  Result := TdxTableFloatingPositionChangeActionsCalculator.
    CalculateChangeActions
    (TdxTableFloatingPositionChangeType.TableHorizontalPosition);
end;

function TdxTableFloatingPosition.SetTableVerticalPosition
  (const AInfo: TdxTableFloatingPositionInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  ...
  Result := TdxTableFloatingPositionChangeActionsCalculator.
    CalculateChangeActions
    (TdxTableFloatingPositionChangeType.TableVerticalPosition);
end;

function TdxTableFloatingPosition.SetTextWrapping
  (const AInfo: TdxTableFloatingPositionInfo; const AValue: TdxTextWrapping)
  : TdxDocumentModelChangeActions;
begin
  AInfo.TextWrapping := AValue;
  Result := TdxTableFloatingPositionChangeActionsCalculator.
    CalculateChangeActions(TdxTableFloatingPositionChangeType.TextWrapping);
end;

function TdxTableFloatingPosition.SetTopFromText(const AInfo
  : TdxTableFloatingPositionInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.TopFromText := AValue;
  Result := TdxTableFloatingPositionChangeActionsCalculator.
    CalculateChangeActions(TdxTableFloatingPositionChangeType.TopFromText);
end;

function TdxTableFloatingPosition.SetVerticalAlign
  (const AInfo: TdxTableFloatingPositionInfo;
  const AValue: TdxVerticalAlignMode): TdxDocumentModelChangeActions;
begin
  AInfo.VerticalAlign := AValue;
  Result := TdxTableFloatingPositionChangeActionsCalculator.
    CalculateChangeActions(TdxTableFloatingPositionChangeType.VerticalAlign);
end;

function TdxTableFloatingPosition.SetVerticalAnchor
  (const AInfo: TdxTableFloatingPositionInfo;
  const AValue: TdxVerticalAnchorTypes): TdxDocumentModelChangeActions;
begin
  AInfo.VerticalAnchor := AValue;
  Result := TdxTableFloatingPositionChangeActionsCalculator.
    CalculateChangeActions(TdxTableFloatingPositionChangeType.VerticalAnchor);
end;
...
begin
  ...
  begin
    ...
    Result := (TableLayout = AInfo.TableLayout) and
      (TableLook = AInfo.TableLook) and (IsTableOverlap = AInfo.IsTableOverlap)
      and (TableStyleColBandSize = AInfo.TableStyleColBandSize) and
...
class function TdxTableGeneralSettingsChangeActionsCalculator.
  CalculateChangeActions(AChange: TdxTableGeneralSettingsChangeType)
  : TdxDocumentModelChangeActions;
const
  TableGeneralSettingsChangeActionsMap
    : array [TdxTableGeneralSettingsChangeType]
...
function TdxTableGeneralSettingsInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxTableGeneralSettingsInfo;
begin
...
procedure TdxTableGeneralSettings.ApplyChanges(const AChangeActions
  : TdxDocumentModelChangeActions);
begin
  Owner.ApplyChanges(AChangeActions);
end;

procedure TdxTableGeneralSettings.CopyFrom(const ANewSettings
  : TdxTableGeneralSettings);
begin
...
procedure TdxTableGeneralSettings.BeginChanging(AChangedProperty
  : TdxProperties);
begin
...
constructor TdxTableGeneralSettings.Create(APieceTable: TdxCustomPieceTable;
  const AOwner: IdxPropertiesContainer);
begin
  inherited Create(APieceTable);
  Assert(AOwner <> nil);
...
function TdxTableGeneralSettings.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxTableGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions(TdxTableGeneralSettingsChangeType.BatchUpdate);
end;

function TdxTableGeneralSettings.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxTableGeneralSettingsInfo>;
begin
  Result := TdxDocumentCache(ADocumentModel.Cache)
    .TableGeneralSettingsInfoCache;
end;
...
procedure TdxTableGeneralSettings.InnerSetAvoidDoubleBorders
  (const Value: Boolean);
begin
...
procedure TdxTableGeneralSettings.InnerSetBackgroundColor
  (const Value: TdxAlphaColor);
begin
...
procedure TdxTableGeneralSettings.InnerSetTableAlignment
  (const Value: TdxTableRowAlignment);
begin
...
procedure TdxTableGeneralSettings.InnerSetTableLayout
  (const Value: TdxTableLayoutType);
begin
...
procedure TdxTableGeneralSettings.InnerSetTableLook
  (const Value: TdxTableLookTypes);
begin
...
procedure TdxTableGeneralSettings.InnerSetTableStyleColumnBandSize
  (const Value: Integer);
begin
  if Value < 0 then
    TdxRichEditExceptions.ThrowArgumentException
      ('TableStyleColumnBandSize', Value);
...
procedure TdxTableGeneralSettings.InnerSetTableStyleRowBandSize
  (const Value: Integer);
begin
  if Value < 0 then
    TdxRichEditExceptions.ThrowArgumentException
      ('TableStyleRowBandSize', Value);
...
procedure TdxTableGeneralSettings.RaiseObtainAffectedRange
  (const AArgs: TdxObtainAffectedRangeEventArgs);
begin
  Owner.RaiseObtainAffectedRange(AArgs);
end;

function TdxTableGeneralSettings.SetAvoidDoubleBorders(const ASettings
  : TdxTableGeneralSettingsInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  ASettings.AvoidDoubleBorders := AValue;
  Result := TdxTableGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions
    (TdxTableGeneralSettingsChangeType.AvoidDoubleBorders);
end;

function TdxTableGeneralSettings.SetBackgroundColor(const ASettings
  : TdxTableGeneralSettingsInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  ASettings.BackgroundColor := AValue;
  Result := TdxTableGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions(TdxTableGeneralSettingsChangeType.BackgroundColor);
end;
...
function TdxTableGeneralSettings.SetTableAlignment(const ASettings
  : TdxTableGeneralSettingsInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  ASettings.TableAlignment := TdxTableRowAlignment(AValue);
  Result := TdxTableGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions(TdxTableGeneralSettingsChangeType.TableAlignment);
end;

function TdxTableGeneralSettings.SetTableLayout(const ASettings
  : TdxTableGeneralSettingsInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  ASettings.TableLayout := TdxTableLayoutType(AValue);
  Result := TdxTableGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions(TdxTableGeneralSettingsChangeType.TableLayout);
end;

function TdxTableGeneralSettings.SetTableLook(const ASettings
  : TdxTableGeneralSettingsInfo; const AValue: TdxTableLookTypes)
  : TdxDocumentModelChangeActions;
begin
  ASettings.TableLook := AValue;
  Result := TdxTableGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions(TdxTableGeneralSettingsChangeType.TableLook);
end;

function TdxTableGeneralSettings.SetTableOverlap(const ASettings
  : TdxTableGeneralSettingsInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  ASettings.IsTableOverlap := AValue;
  Result := TdxTableGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions(TdxTableGeneralSettingsChangeType.IsTableOverlap);
end;

function TdxTableGeneralSettings.SetTableStyleColumnBandSize(const ASettings
  : TdxTableGeneralSettingsInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  ...
  Result := TdxTableGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions
    (TdxTableGeneralSettingsChangeType.TableStyleColumnBandSize);
end;

function TdxTableGeneralSettings.SetTableStyleRowBandSize(const ASettings
  : TdxTableGeneralSettingsInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  ...
  Result := TdxTableGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions
    (TdxTableGeneralSettingsChangeType.TableStyleRowBandSize);
end;

{ TdxTableProperties }

constructor TdxTableProperties.Create(const ADocumentModelPart
  : TdxCustomPieceTable);
begin
...
function TdxTableProperties.AreSame(AOtherProperties
  : TdxTableProperties): Boolean;
begin
...
procedure TdxTableProperties.CopyFrom(const Source
  : TdxUndoableIndexBasedObject<TdxTablePropertiesOptions>);
begin
  inherited CopyFrom(Source);
end;
{$ENDIF}
...
function TdxTableProperties.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := [];
end;
...
begin
  DocumentModel.History.BeginTransaction;
  try
    CopyFrom((DocumentModel as IdxDefaultTablePropertiesContainer)
...
begin
  ReplaceInfo(GetCache(DocumentModel)
    [TdxTablePropertiesOptionsCache.EmptyTableFormattingOptionsItem],
    BatchUpdateChangeActions);
end;

function TdxTableProperties.GetAccessor(AChangedProperty: TdxProperties)
  : TdxBoolPropertyAccessor<TdxTablePropertiesOptions>;
begin
  case AChangedProperty of
    TdxProperties.LeftBorder:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseLeftBorder,
        TdxTablePropertiesOptions.SetOptionsUseLeftBorder);
    TdxProperties.RightBorder:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseRightBorder,
        TdxTablePropertiesOptions.SetOptionsUseRightBorder);
    TdxProperties.TopBorder:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseTopBorder,
        TdxTablePropertiesOptions.SetOptionsUseTopBorder);
    TdxProperties.BottomBorder:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseBottomBorder,
        TdxTablePropertiesOptions.SetOptionsUseBottomBorder);
    TdxProperties.InsideHorizontalBorder:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseInsideHorizontalBorder,
        TdxTablePropertiesOptions.SetOptionsUseInsideHorizontalBorder);
    TdxProperties.InsideVerticalBorder:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseInsideVerticalBorder,
        TdxTablePropertiesOptions.SetOptionsUseInsideVerticalBorder);
    TdxProperties.LeftMargin:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseLeftMargin,
        TdxTablePropertiesOptions.SetOptionsUseLeftMargin);
    TdxProperties.RightMargin:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseRightMargin,
        TdxTablePropertiesOptions.SetOptionsUseRightMargin);
    TdxProperties.TopMargin:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseTopMargin,
        TdxTablePropertiesOptions.SetOptionsUseTopMargin);
    TdxProperties.BottomMargin:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseBottomMargin,
        TdxTablePropertiesOptions.SetOptionsUseBottomMargin);
    TdxProperties.CellSpacing:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseCellSpacing,
        TdxTablePropertiesOptions.SetOptionsUseCellSpacing);
    TdxProperties.PreferredWidth:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUsePreferredWidth,
        TdxTablePropertiesOptions.SetOptionsUsePreferredWidth);
    TdxProperties.TableIndent:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseTableIndent,
        TdxTablePropertiesOptions.SetOptionsUseTableIndent);
    TdxProperties.TableLayout:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseTableLayout,
        TdxTablePropertiesOptions.SetOptionsUseTableLayout);
    TdxProperties.TableAlignment:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseTableAlignment,
        TdxTablePropertiesOptions.SetOptionsUseTableAlignment);
    TdxProperties.TableLook:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseTableLook,
        TdxTablePropertiesOptions.SetOptionsUseTableLook);
    TdxProperties.IsTableOverlap:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseTableOverlap,
        TdxTablePropertiesOptions.SetOptionsUseTableOverlap);
    TdxProperties.TableStyleColumnBandSize:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseTableStyleColBandSize,
        TdxTablePropertiesOptions.SetOptionsUseTableStyleColBandSize);
    TdxProperties.TableStyleRowBandSize:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseTableStyleRowBandSize,
        TdxTablePropertiesOptions.SetOptionsUseTableStyleRowBandSize);
    TdxProperties.TableFloatingPosition:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseFloatingPosition,
        TdxTablePropertiesOptions.SetOptionsUseFloatingPosition);
    TdxProperties.BackgroundColor:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseBackgroundColor,
        TdxTablePropertiesOptions.SetOptionsUseBackgroundColor);
    TdxProperties.AvoidDoubleBorders:
      Result := TdxBoolPropertyAccessor<TdxTablePropertiesOptions>.Create
        (TdxTablePropertiesOptions.GetOptionsUseAvoidDoubleBorders,
        TdxTablePropertiesOptions.SetOptionsUseAvoidDoubleBorders);
  else
    Result := inherited GetAccessor(AChangedProperty);
  end;
end;

function TdxTableProperties.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxTablePropertiesOptions>;
begin
...
procedure TdxTableProperties.SetTableAlignment(const Value
  : TdxTableRowAlignment);
begin
  GeneralSettings.TableAlignment := Value;
end;

procedure TdxTableProperties.InnerSetTableLayout(const Value
  : TdxTableLayoutType);
begin
...
begin
  ...
  try
    ...
    if not UseTableStyleColBandSize and AProperties.UseTableStyleColBandSize
    then
      TableStyleColBandSize := AProperties.TableStyleColBandSize;
    if not UseTableStyleRowBandSize and AProperties.UseTableStyleRowBandSize
    then
...
begin
  AppendItem(TdxTablePropertiesOptions.Create
    (TdxTablePropertiesOptions.MaskUseAll));
end;

function TdxTablePropertiesOptionsCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxTablePropertiesOptions;
begin
  Result := TdxTablePropertiesOptions.Create;
end;

procedure TdxTablePropertiesOptionsCache.InitItems(const AUnitConverter
  : IdxDocumentModelUnitConverter);
begin
...
constructor TdxBordersBase.Create(APieceTable: TdxCustomPieceTable;
  const AOwner: IdxPropertiesContainerWithMask);
begin
  inherited Create;
  Assert(AOwner <> nil);
  ...
  FInsideHorizontalBorder := TdxInsideHorizontalBorder.Create
    (APieceTable, AOwner);
...
constructor TdxTableCellBorders.Create(APieceTable: TdxCustomPieceTable;
  const AOwner: IdxCellPropertiesContainer);
begin
  inherited Create(APieceTable, AOwner);
  FTopLeftDiagonalBorder := TdxTopLeftDiagonalBorder.Create
    (APieceTable, AOwner);
  FTopRightDiagonalBorder := TdxTopRightDiagonalBorder.Create
    (APieceTable, AOwner);
end;
...
begin
  Result := Owner.GetUse
    (TdxTableCellPropertiesOptions.MaskUseTopLeftDiagonalBorder);
end;

function TdxTableCellBorders.GetUseTopRightDiagonalBorder: Boolean;
begin
  Result := Owner.GetUse
    (TdxTableCellPropertiesOptions.MaskUseTopRightDiagonalBorder);
end;
...
begin
  ...
  if not UseTopLeftDiagonalBorder and ACellBorders.UseTopLeftDiagonalBorder then
    TopLeftDiagonalBorder.CopyFrom(ACellBorders.TopLeftDiagonalBorder);
  if not UseTopRightDiagonalBorder and ACellBorders.UseTopRightDiagonalBorder
  then
    TopRightDiagonalBorder.CopyFrom(ACellBorders.TopRightDiagonalBorder);
end;
...
procedure TdxTableCellPropertiesOptions.SetVal(AMask: Integer;
  ABitVal: Boolean);
begin
  if ABitVal then
    FValue := FValue or AMask
...
class function TdxTableCellPropertiesOptions.
  GetOptionsUseCellConditionalFormatting
  (AOptions: TdxTableCellPropertiesOptions): Boolean;
begin
...
class procedure TdxTableCellPropertiesOptions.
  SetOptionsUseCellConditionalFormatting
  (AOptions: TdxTableCellPropertiesOptions; const AValue: Boolean);
begin
...
class procedure TdxTableCellPropertiesOptions.
  SetOptionsUseInsideHorizontalBorder(AOptions: TdxTableCellPropertiesOptions;
...
class procedure TdxTableCellPropertiesOptions.
  SetOptionsUseTopRightDiagonalBorder(AOptions: TdxTableCellPropertiesOptions;
  const AValue: Boolean);
begin
...
constructor TdxTableCellProperties.Create(APieceTable: TdxCustomPieceTable;
  const AOwner: IdxCellPropertiesOwner);
begin
  inherited Create(APieceTable);
  Assert(AOwner <> nil);
  FOwner := AOwner;
...
procedure TdxTableCellProperties.CopyFrom(AProperties
  : TdxMergedTableCellProperties);
begin
  BeginPropertiesUpdate;
  try
...
procedure TdxTableCellProperties.CopyFrom(const Source
  : TdxTableCellPropertiesOptions);
begin
  inherited CopyFrom(Source);
end;
...
procedure TdxTableCellProperties.CopyFrom(const Source
  : TdxUndoableIndexBasedObject<TdxTableCellPropertiesOptions>);
begin
  inherited CopyFrom(Source);
end;
{$ENDIF}
...
function TdxTableCellProperties.GetAccessor(AChangedProperty: TdxProperties)
  : TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>;
begin
  case AChangedProperty of
    TdxProperties.CellConditionalFormatting:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseCellConditionalFormatting,
        TdxTableCellPropertiesOptions.SetOptionsUseCellConditionalFormatting);
    TdxProperties.PreferredWidth:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUsePreferredWidth,
        TdxTableCellPropertiesOptions.SetOptionsUsePreferredWidth);
    TdxProperties.HideCellMark:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseHideCellMark,
        TdxTableCellPropertiesOptions.SetOptionsUseHideCellMark);
    TdxProperties.NoWrap:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseNoWrap,
        TdxTableCellPropertiesOptions.SetOptionsUseNoWrap);
    TdxProperties.FitText:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseFitText,
        TdxTableCellPropertiesOptions.SetOptionsUseFitText);
    TdxProperties.TopMargin:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseTopMargin,
        TdxTableCellPropertiesOptions.SetOptionsUseTopMargin);
    TdxProperties.BottomMargin:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseBottomMargin,
        TdxTableCellPropertiesOptions.SetOptionsUseBottomMargin);
    TdxProperties.LeftMargin:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseLeftMargin,
        TdxTableCellPropertiesOptions.SetOptionsUseLeftMargin);
    TdxProperties.RightMargin:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseRightMargin,
        TdxTableCellPropertiesOptions.SetOptionsUseRightMargin);
    TdxProperties.TextDirection:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseTextDirection,
        TdxTableCellPropertiesOptions.SetOptionsUseTextDirection);
    TdxProperties.VerticalAlignment:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseVerticalAlignment,
        TdxTableCellPropertiesOptions.SetOptionsUseVerticalAlignment);
    TdxProperties.VerticalMerging:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseVerticalMerging,
        TdxTableCellPropertiesOptions.SetOptionsUseVerticalMerging);
    TdxProperties.ColumnSpan:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseColumnSpan,
        TdxTableCellPropertiesOptions.SetOptionsUseColumnSpan);
    TdxProperties.BackgroundColor:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseBackgroundColor,
        TdxTableCellPropertiesOptions.SetOptionsUseBackgroundColor);
    TdxProperties.ForegroundColor:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseForegroundColor,
        TdxTableCellPropertiesOptions.SetOptionsUseForegroundColor);
    TdxProperties.Shading:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseShading,
        TdxTableCellPropertiesOptions.SetOptionsUseShading);
    TdxProperties.LeftBorder:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseLeftBorder,
        TdxTableCellPropertiesOptions.SetOptionsUseLeftBorder);
    TdxProperties.RightBorder:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseRightBorder,
        TdxTableCellPropertiesOptions.SetOptionsUseRightBorder);
    TdxProperties.TopBorder:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseTopBorder,
        TdxTableCellPropertiesOptions.SetOptionsUseTopBorder);
    TdxProperties.BottomBorder:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseBottomBorder,
        TdxTableCellPropertiesOptions.SetOptionsUseBottomBorder);
    TdxProperties.InsideHorizontalBorder:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseInsideHorizontalBorder,
        TdxTableCellPropertiesOptions.SetOptionsUseInsideHorizontalBorder);
    TdxProperties.InsideVerticalBorder:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseInsideVerticalBorder,
        TdxTableCellPropertiesOptions.SetOptionsUseInsideVerticalBorder);
    TdxProperties.TopLeftDiagonalBorder:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseTopLeftDiagonalBorder,
        TdxTableCellPropertiesOptions.SetOptionsUseTopLeftDiagonalBorder);
    TdxProperties.TopRightDiagonalBorder:
      Result := TdxBoolPropertyAccessor<TdxTableCellPropertiesOptions>.Create
        (TdxTableCellPropertiesOptions.GetOptionsUseTopRightDiagonalBorder,
        TdxTableCellPropertiesOptions.SetOptionsUseTopRightDiagonalBorder);
  else
    Result := inherited GetAccessor(AChangedProperty);
  end;
end;

function TdxTableCellProperties.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxTableCellPropertiesOptions>;
begin
  Result := TdxDocumentCache(ADocumentModel.Cache)
    .TableCellPropertiesOptionsCache;
end;

function TdxTableCellProperties.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := [];
end;

function TdxTableCellProperties.CreateIndexChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
  Result := FOwner.CreateCellPropertiesChangedHistoryItem(Self);
end;

function TdxTableCellProperties.GetCellConditionalFormatting
  : TdxConditionalTableStyleFormattingTypes;
begin
...
begin
  ...
  try
    Borders.Merge(AProperties.Borders);
    if not UseCellConditionalFormatting and AProperties.UseCellConditionalFormatting
    then
...
begin
  ReplaceInfo(GetCache(DocumentModel)
    [TdxTableCellPropertiesOptionsCache.EmptyCellPropertiesOptionsItem],
    BatchUpdateChangeActions);
end;
...
procedure TdxTableCellProperties.SetCellConditionalFormatting
...
procedure TdxTableCellProperties.SetTextDirection
  (const Value: TdxTextDirection);
begin
  GeneralSettings.TextDirection := Value;
end;

procedure TdxTableCellProperties.SetVerticalAlignment
  (const Value: TdxVerticalAlignment);
begin
  GeneralSettings.VerticalAlignment := Value;
end;

procedure TdxTableCellProperties.SetVerticalMerging
  (const Value: TdxMergingState);
begin
...
procedure TdxTableCellBorders.CopyFrom(const ABorders
  : TdxCombinedCellBordersInfo);
begin
  Owner.BeginPropertiesUpdate;
  try
...
constructor TdxCombinedCellBordersInfo.Create(ATableBorders
  : TdxTableCellBorders);
begin
  inherited Create;
...
constructor TdxCombinedTablePropertiesInfo.Create(ATableProperties
  : TdxTableProperties);
begin
  inherited Create;
  FCellMargins := TdxCombinedCellMarginsInfo.Create
    (ATableProperties.CellMargins);
...
begin
  ...
  if AInfo = nil then
    Exit(False);
  Result := (HideCellMark = AInfo.HideCellMark) and (NoWrap = AInfo.NoWrap) and
    (FitText = AInfo.FitText) and (TextDirection = AInfo.TextDirection) and
    ...
    (BackgroundColor = AInfo.BackgroundColor) and
    (ForegroundColor = AInfo.ForegroundColor) and (Shading = AInfo.Shading);
end;

{ TdxTableCellGeneralSettings }

constructor TdxTableCellGeneralSettings.Create(APieceTable: TdxCustomPieceTable;
  const AOwner: IdxPropertiesContainer);
begin
  inherited Create(APieceTable);
  Assert(AOwner <> nil);
...
procedure TdxTableCellGeneralSettings.ApplyChanges(const AChangeActions
  : TdxDocumentModelChangeActions);
begin
  Owner.ApplyChanges(AChangeActions);
end;

procedure TdxTableCellGeneralSettings.BeginChanging(AChangedProperty
  : TdxProperties);
begin
  Owner.BeginChanging(AChangedProperty);
end;

procedure TdxTableCellGeneralSettings.CopyFrom(ANewSettings
  : TdxTableCellGeneralSettings);
begin
  Owner.BeginPropertiesUpdate;
  try
...
procedure TdxTableCellGeneralSettings.CopyFrom(const Source
  : TdxTableCellGeneralSettingsInfo);
begin
  inherited CopyFrom(Source);
end;
...
procedure TdxTableCellGeneralSettings.CopyFrom(const Source
  : TdxUndoableIndexBasedObject<TdxTableCellGeneralSettingsInfo>);
begin
  inherited CopyFrom(Source);
end;
{$ENDIF}
...
function TdxTableCellGeneralSettings.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxTableCellChangeActionsCalculator.CalculateChangeActions
    (TdxTableCellChangeType.BatchUpdate);
end;

function TdxTableCellGeneralSettings.GetCache(const ADocumentModel
  : TdxCustomDocumentModel)
  : TdxUniqueItemsCache<TdxTableCellGeneralSettingsInfo>;
begin
  Result := TdxDocumentCache(ADocumentModel.Cache)
    .TableCellGeneralSettingsInfoCache;
end;

function TdxTableCellGeneralSettings.GetCellConditionalFormatting
  : TdxConditionalTableStyleFormattingTypes;
begin
...
procedure TdxTableCellGeneralSettings.InnerSetBackgroundColor
  (const Value: TdxAlphaColor);
begin
  BeginChanging(TdxProperties.BackgroundColor);
...
procedure TdxTableCellGeneralSettings.InnerSetForegroundColor
  (const Value: TdxAlphaColor);
begin
...
procedure TdxTableCellGeneralSettings.InnerSetShading
  (const Value: TdxShadingPattern);
begin
...
begin
  ...
  SetPropertyValue<TdxConditionalTableStyleFormattingTypes>
    (SetCellConditionalFormatting, Value);
  EndChanging;
end;

function TdxTableCellGeneralSettings.SetBackgroundColor
  (const AInfo: TdxTableCellGeneralSettingsInfo; const AValue: TdxAlphaColor)
  : TdxDocumentModelChangeActions;
begin
  AInfo.BackgroundColor := AValue;
  Result := TdxTableCellChangeActionsCalculator.CalculateChangeActions
    (TdxTableCellChangeType.BackgroundColor);
end;

function TdxTableCellGeneralSettings.SetForegroundColor
  (const AInfo: TdxTableCellGeneralSettingsInfo; const AValue: TdxAlphaColor)
  : TdxDocumentModelChangeActions;
begin
  AInfo.ForegroundColor := AValue;
  Result := TdxTableCellChangeActionsCalculator.CalculateChangeActions
    (TdxTableCellChangeType.ForegroundColor);
end;

function TdxTableCellGeneralSettings.SetShading(const AInfo
  : TdxTableCellGeneralSettingsInfo; const AValue: TdxShadingPattern)
  : TdxDocumentModelChangeActions;
begin
  AInfo.Shading := AValue;
  Result := TdxTableCellChangeActionsCalculator.CalculateChangeActions
    (TdxTableCellChangeType.Shading);
end;

function TdxTableCellGeneralSettings.SetCellConditionalFormatting
  (const AInfo: TdxTableCellGeneralSettingsInfo;
  const AValue: TdxConditionalTableStyleFormattingTypes)
  : TdxDocumentModelChangeActions;
begin
  AInfo.CellConditionalFormatting := AValue;
  Result := TdxTableCellChangeActionsCalculator.CalculateChangeActions
    (TdxTableCellChangeType.ConditionalFormatting);
end;

function TdxTableCellGeneralSettings.SetColumnSpan
  (const AInfo: TdxTableCellGeneralSettingsInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.ColumnSpan := AValue;
  Result := TdxTableCellChangeActionsCalculator.CalculateChangeActions
    (TdxTableCellChangeType.ColumnSpan);
end;
...
function TdxTableCellGeneralSettings.SetFitText(const AInfo
  : TdxTableCellGeneralSettingsInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.FitText := AValue;
  Result := TdxTableCellChangeActionsCalculator.CalculateChangeActions
    (TdxTableCellChangeType.FitText);
end;
...
function TdxTableCellGeneralSettings.SetHideCellMark
  (const AInfo: TdxTableCellGeneralSettingsInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.HideCellMark := AValue;
  Result := TdxTableCellChangeActionsCalculator.CalculateChangeActions
    (TdxTableCellChangeType.HideCellMark);
end;

function TdxTableCellGeneralSettings.SetNoWrap(const AInfo
  : TdxTableCellGeneralSettingsInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.NoWrap := AValue;
  Result := TdxTableCellChangeActionsCalculator.CalculateChangeActions
    (TdxTableCellChangeType.NoWrap);
end;

function TdxTableCellGeneralSettings.SetTextDirection
  (const AInfo: TdxTableCellGeneralSettingsInfo; const AValue: TdxTextDirection)
  : TdxDocumentModelChangeActions;
begin
  AInfo.TextDirection := AValue;
  Result := TdxTableCellChangeActionsCalculator.CalculateChangeActions
    (TdxTableCellChangeType.TextDirection);
end;

procedure TdxTableCellGeneralSettings.InnerSetHideCellMark
  (const Value: Boolean);
begin
...
procedure TdxTableCellGeneralSettings.InnerSetTextDirection
  (const Value: TdxTextDirection);
begin
...
procedure TdxTableCellGeneralSettings.InnerSetVerticalAlignment
  (const Value: TdxVerticalAlignment);
begin
...
function TdxTableCellGeneralSettings.SetVerticalAlignment
  (const AInfo: TdxTableCellGeneralSettingsInfo;
  const AValue: TdxVerticalAlignment): TdxDocumentModelChangeActions;
begin
  AInfo.VerticalAlignment := AValue;
  Result := TdxTableCellChangeActionsCalculator.CalculateChangeActions
    (TdxTableCellChangeType.VerticalAlignment);
end;

function TdxTableCellGeneralSettings.SetVerticalMerging
  (const AInfo: TdxTableCellGeneralSettingsInfo; const AValue: TdxMergingState)
  : TdxDocumentModelChangeActions;
begin
  AInfo.VerticalMerging := AValue;
  Result := TdxTableCellChangeActionsCalculator.CalculateChangeActions
    (TdxTableCellChangeType.VerticalMerging);
end;

procedure TdxTableCellGeneralSettings.InnerSetVerticalMerging
  (const Value: TdxMergingState);
begin
...
procedure TdxTableCellGeneralSettings.RaiseObtainAffectedRange
  (const AArgs: TdxObtainAffectedRangeEventArgs);
begin
  Owner.RaiseObtainAffectedRange(AArgs);
end;
...
const
  TableCellChangeActionsMap: array [TdxTableCellChangeType]
    of TdxDocumentModelChangeActions = ([],
    [TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetPrimaryLayout,
    TdxDocumentModelChangeAction.ResetSecondaryLayout,
    ...
    Redraw { , TdxDocumentModelChangeActions.ResetSecondaryLayout } ],
    [TdxDocumentModelChangeAction.
    Redraw { , TdxDocumentModelChangeActions.ResetSecondaryLayout } ],
    [TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetPrimaryLayout,
...
begin
  ...
  Result.CellConditionalFormatting :=
...
procedure TdxTableRowPropertiesOptions.SetVal(AMask: Integer;
  ABitValue: Boolean);
begin
  if ABitValue then
    FValue := FValue or AMask
...
constructor TdxCombinedTableRowPropertiesInfo.Create(ARowProperties
  : TdxTableRowProperties);
begin
  inherited Create;
...
function TdxCombinedTableRowPropertiesInfo.Clone
  : TdxCombinedTableRowPropertiesInfo;
begin
...
procedure TdxTableRowProperties.CopyFrom(const Source
  : TdxTableRowPropertiesOptions);
begin
  inherited CopyFrom(Source);
end;
...
procedure TdxTableRowProperties.CopyFrom(const Source
  : TdxUndoableIndexBasedObject<TdxTableRowPropertiesOptions>);
begin
  inherited CopyFrom(Source);
end;
{$ENDIF}

constructor TdxTableRowProperties.Create(const ADocumentModelPart
  : TdxCustomPieceTable);
begin
  inherited Create(ADocumentModelPart);
...
function TdxTableRowProperties.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := [];
end;

function TdxTableRowProperties.GetAccessor(AChangedProperty: TdxProperties)
  : TdxBoolPropertyAccessor<TdxTableRowPropertiesOptions>;
begin
  case AChangedProperty of
    TdxProperties.CantSplit:
      Result := TdxBoolPropertyAccessor<TdxTableRowPropertiesOptions>.Create
        (TdxTableRowPropertiesOptions.GetOptionsUseCantSplit,
        TdxTableRowPropertiesOptions.SetOptionsUseCantSplit);
    TdxProperties.CellSpacing:
      Result := TdxBoolPropertyAccessor<TdxTableRowPropertiesOptions>.Create
        (TdxTableRowPropertiesOptions.GetOptionsUseCellSpacing,
        TdxTableRowPropertiesOptions.SetOptionsUseCellSpacing);
    TdxProperties.GridAfter:
      Result := TdxBoolPropertyAccessor<TdxTableRowPropertiesOptions>.Create
        (TdxTableRowPropertiesOptions.GetOptionsUseGridAfter,
        TdxTableRowPropertiesOptions.SetOptionsUseGridAfter);
    TdxProperties.GridBefore:
      Result := TdxBoolPropertyAccessor<TdxTableRowPropertiesOptions>.Create
        (TdxTableRowPropertiesOptions.GetOptionsUseGridBefore,
        TdxTableRowPropertiesOptions.SetOptionsUseGridBefore);
    TdxProperties.Header:
      Result := TdxBoolPropertyAccessor<TdxTableRowPropertiesOptions>.Create
        (TdxTableRowPropertiesOptions.GetOptionsUseHeader,
        TdxTableRowPropertiesOptions.SetOptionsUseHeader);
    TdxProperties.RowHeight:
      Result := TdxBoolPropertyAccessor<TdxTableRowPropertiesOptions>.Create
        (TdxTableRowPropertiesOptions.GetOptionsUseHeight,
        TdxTableRowPropertiesOptions.SetOptionsUseHeight);
    TdxProperties.HideCellMark:
      Result := TdxBoolPropertyAccessor<TdxTableRowPropertiesOptions>.Create
        (TdxTableRowPropertiesOptions.GetOptionsUseHideCellMark,
        TdxTableRowPropertiesOptions.SetOptionsUseHideCellMark);
    TdxProperties.TableRowAlignment:
      Result := TdxBoolPropertyAccessor<TdxTableRowPropertiesOptions>.Create
        (TdxTableRowPropertiesOptions.GetOptionsUseTableRowAlignment,
        TdxTableRowPropertiesOptions.SetOptionsUseTableRowAlignment);
    TdxProperties.WidthAfter:
      Result := TdxBoolPropertyAccessor<TdxTableRowPropertiesOptions>.Create
        (TdxTableRowPropertiesOptions.GetOptionsUseWidthAfter,
        TdxTableRowPropertiesOptions.SetOptionsUseWidthAfter);
    TdxProperties.WidthBefore:
      Result := TdxBoolPropertyAccessor<TdxTableRowPropertiesOptions>.Create
        (TdxTableRowPropertiesOptions.GetOptionsUseWidthBefore,
        TdxTableRowPropertiesOptions.SetOptionsUseWidthBefore);
  else
    Result := inherited GetAccessor(AChangedProperty);
  end;
end;

function TdxTableRowProperties.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxTableRowPropertiesOptions>;
begin
  Result := TdxDocumentCache(ADocumentModel.Cache)
    .TableRowPropertiesOptionsCache;
end;
...
begin
  ReplaceInfo(GetCache(DocumentModel)
    [TdxTableRowPropertiesOptionsCache.EmptyRowPropertiesOptionsItem],
    BatchUpdateChangeActions);
end;
...
procedure TdxTableRowProperties.SetTableRowAlignment
  (const Value: TdxTableRowAlignment);
begin
...
begin
  ...
  begin
    ...
    Result := (CantSplit = AInfo.CantSplit) and
      (HideCellMark = AInfo.HideCellMark) and (Header = AInfo.Header) and
      (GridBefore = AInfo.GridBefore) and (GridAfter = AInfo.GridAfter) and
      (TableRowAlignment = AInfo.TableRowAlignment);
  end
  else
    Result := False;
...
procedure TdxTableRowGeneralSettings.ApplyChanges(const AChangeActions
  : TdxDocumentModelChangeActions);
begin
  Owner.ApplyChanges(AChangeActions);
end;

procedure TdxTableRowGeneralSettings.BeginChanging(AChangedProperty
  : TdxProperties);
begin
  Owner.BeginChanging(AChangedProperty);
end;

procedure TdxTableRowGeneralSettings.CopyFrom(const ASettings
  : TdxTableRowGeneralSettings);
begin
  Owner.BeginPropertiesUpdate;
  try
...
procedure TdxTableRowGeneralSettings.CopyFrom(const Source
  : TdxTableRowGeneralSettingsInfo);
begin
  inherited CopyFrom(Source);
end;
...
procedure TdxTableRowGeneralSettings.CopyFrom(const Source
  : TdxUndoableIndexBasedObject<TdxTableRowGeneralSettingsInfo>);
begin
  inherited CopyFrom(Source);
end;
{$ENDIF}
...
function TdxTableRowGeneralSettings.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxTableRowChangeActionsCalculator.CalculateChangeActions
    (TdxTableRowChangeType.BatchUpdate);
end;

function TdxTableRowGeneralSettings.GetCache(const ADocumentModel
  : TdxCustomDocumentModel)
  : TdxUniqueItemsCache<TdxTableRowGeneralSettingsInfo>;
begin
  Result := TdxDocumentCache(ADocumentModel.Cache)
    .TableRowGeneralSettingsInfoCache;
end;
...
procedure TdxTableRowGeneralSettings.InnerSetTableRowAlignment
  (const Value: TdxTableRowAlignment);
begin
...
procedure TdxTableRowGeneralSettings.RaiseObtainAffectedRange
  (const AArgs: TdxObtainAffectedRangeEventArgs);
begin
  Owner.RaiseObtainAffectedRange(AArgs);
end;

function TdxTableRowGeneralSettings.SetCantSplit(const AInfo
  : TdxTableRowGeneralSettingsInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.CantSplit := AValue;
  Result := TdxTableRowChangeActionsCalculator.CalculateChangeActions
    (TdxTableRowChangeType.CantSplit);
end;

function TdxTableRowGeneralSettings.SetGridAfter(const AInfo
  : TdxTableRowGeneralSettingsInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.GridAfter := AValue;
  Result := TdxTableRowChangeActionsCalculator.CalculateChangeActions
    (TdxTableRowChangeType.GridAfter);
end;

function TdxTableRowGeneralSettings.SetGridBefore
  (const AInfo: TdxTableRowGeneralSettingsInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.GridBefore := AValue;
  Result := TdxTableRowChangeActionsCalculator.CalculateChangeActions
    (TdxTableRowChangeType.GridBefore);
end;

function TdxTableRowGeneralSettings.SetHeader(const AInfo
  : TdxTableRowGeneralSettingsInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.Header := AValue;
  Result := TdxTableRowChangeActionsCalculator.CalculateChangeActions
    (TdxTableRowChangeType.Header);
end;

function TdxTableRowGeneralSettings.SetHideCellMark
  (const AInfo: TdxTableRowGeneralSettingsInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.HideCellMark := AValue;
  Result := TdxTableRowChangeActionsCalculator.CalculateChangeActions
    (TdxTableRowChangeType.HideCellMark);
end;

function TdxTableRowGeneralSettings.SetTableRowAlignment
  (const AInfo: TdxTableRowGeneralSettingsInfo;
  const AValue: TdxTableRowAlignment): TdxDocumentModelChangeActions;
begin
  AInfo.TableRowAlignment := AValue;
  Result := TdxTableRowChangeActionsCalculator.CalculateChangeActions
    (TdxTableRowChangeType.TableRowAlignment);
end;

{ TdxRowHeight }

function TdxRowHeight.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := [TdxDocumentModelChangeAction.RaiseContentChanged,
    TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetPrimaryLayout,
    TdxDocumentModelChangeAction.ResetRuler,
    TdxDocumentModelChangeAction.ResetSecondaryLayout,
...
begin
  AppendItem(TdxTableRowPropertiesOptions.Create
    (TdxTableRowPropertiesOptions.MaskUseAll));
end;
...
procedure TdxTableRowPropertiesOptionsCache.InitItems(const AUnitConverter
  : IdxDocumentModelUnitConverter);
begin
  inherited InitItems(AUnitConverter);
  AddRootStyleOptions;
...
begin
  AppendItem(TdxTableCellPropertiesOptions.Create
    (TdxTableCellPropertiesOptions.MaskUseAll));
end;
...
procedure TdxTableCellPropertiesOptionsCache.InitItems(const AUnitConverter
  : IdxDocumentModelUnitConverter);
begin
  inherited InitItems(AUnitConverter);
  AddRootStyleOptions;
...
class function TdxTableFloatingPositionChangeActionsCalculator.
  CalculateChangeActions(AChange: TdxTableFloatingPositionChangeType)
  : TdxDocumentModelChangeActions;
const
  TableFloatingPositionChangeActionsMap
    : array [TdxTableFloatingPositionChangeType]
    of TdxDocumentModelChangeActions = ([],
    [TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetPrimaryLayout,
    TdxDocumentModelChangeAction.ResetSecondaryLayout,
...
function TdxTableIndent.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := [TdxDocumentModelChangeAction.RaiseContentChanged,
    TdxDocumentModelChangeAction.Redraw,
...
function TdxCellSpacing.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := [TdxDocumentModelChangeAction.RaiseContentChanged,
    TdxDocumentModelChangeAction.Redraw,
...
constructor TdxCombinedCellPropertiesInfo.Create(ACellProperties
  : TdxTableCellProperties);
begin
  inherited Create;
  FPreferredWidth := ACellProperties.PreferredWidth.Info.Clone;
  FCellMargins := TdxCombinedCellMarginsInfo.Create
    (ACellProperties.CellMargins);
...
const
  TableRowChangeActionsMap: array [TdxTableRowChangeType]
    of TdxDocumentModelChangeActions = ([],
    [TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetPrimaryLayout,
    TdxDocumentModelChangeAction.ResetSecondaryLayout,
...
constructor TdxMergedTableProperties.Create(AInitialProperties
  : TdxTableProperties);
var
...
procedure TdxMergedTableProperties.MergeCore(const AInfo
  : TdxCombinedTablePropertiesInfo; const AOptions: TdxTablePropertiesOptions);
begin
  ...
  if not Options.UseInsideHorizontalBorder and AOptions.UseInsideHorizontalBorder
  then
  begin
    Info.Borders.InsideHorizontalBorder.CopyFrom
      (AInfo.Borders.InsideHorizontalBorder);
    Options.UseInsideHorizontalBorder := True;
  end;
  if not Options.UseInsideVerticalBorder and AOptions.UseInsideVerticalBorder
  then
  begin
    Info.Borders.InsideVerticalBorder.CopyFrom
      (AInfo.Borders.InsideVerticalBorder);
  ...
  if not Options.UseTableStyleColBandSize and AOptions.UseTableStyleColBandSize
  then
  begin
    Info.GeneralSettings.TableStyleColBandSize :=
      AInfo.GeneralSettings.TableStyleColBandSize;
    Options.UseTableStyleColBandSize := True;
  end;
  if not Options.UseTableStyleRowBandSize and AOptions.UseTableStyleRowBandSize
  then
  begin
    Info.GeneralSettings.TableStyleRowBandSize :=
      AInfo.GeneralSettings.TableStyleRowBandSize;
...
constructor TdxMergedTableCellProperties.Create(AInitialProperties
  : TdxTableCellProperties);
var
...
procedure TdxMergedTableCellProperties.Merge(AProperties
  : TdxTableCellProperties);
var
  AInfo: TdxCombinedCellPropertiesInfo;
begin
...
procedure TdxMergedTableCellProperties.MergeCore(const AInfo
  : TdxCombinedCellPropertiesInfo;
  const AOptions: TdxTableCellPropertiesOptions);
begin
  if not Options.UseBottomBorder and AOptions.UseBottomBorder then
  ...
  if not Options.UseTopLeftDiagonalBorder and AOptions.UseTopLeftDiagonalBorder
  then
  begin
    Info.Borders.TopLeftDiagonalBorder.CopyFrom
      (AInfo.Borders.TopLeftDiagonalBorder);
    Options.UseTopLeftDiagonalBorder := True;
  end;
  if not Options.UseTopRightDiagonalBorder and AOptions.UseTopRightDiagonalBorder
  then
  begin
    Info.Borders.TopRightDiagonalBorder.CopyFrom
      (AInfo.Borders.TopRightDiagonalBorder);
  ...
  begin
    Info.GeneralSettings.BackgroundColor :=
      AInfo.GeneralSettings.BackgroundColor;
    Options.UseBackgroundColor := True;
  end;
  if not Options.UseCellConditionalFormatting and AOptions.UseCellConditionalFormatting
  then
  begin
    Info.GeneralSettings.CellConditionalFormatting :=
      AInfo.GeneralSettings.CellConditionalFormatting;
  ...
  begin
    Info.GeneralSettings.VerticalAlignment :=
...
constructor TdxMergedTableRowProperties.Create(AInitialProperties
  : TdxTableRowProperties);
var
...
procedure TdxMergedTableRowProperties.Merge(AProperties
  : TdxMergedTableRowProperties);
begin
  MergeCore(AProperties.Info, AProperties.Options);
end;

procedure TdxMergedTableRowProperties.MergeCore(const AInfo
  : TdxCombinedTableRowPropertiesInfo;
  const AOptions: TdxTableRowPropertiesOptions);
begin
  if not Options.UseCellSpacing and AOptions.UseCellSpacing then
  ...
  begin
    Info.GeneralSettings.TableRowAlignment :=
      AInfo.GeneralSettings.TableRowAlignment;
