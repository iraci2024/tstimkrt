...
type
  ...
  public
    constructor Create(const AControl: IdxRichEditControl;
      const ASourceCharacterProperties: TdxMergedCharacterProperties);
    property SourceCharacterProperties: TdxMergedCharacterProperties
      read FSourceCharacterProperties;
  end;
  ...
  public
    ...
    procedure SetFontUnderline(const AUnderlineType: TdxNullableUnderlineType;
    ...
    property Script: TdxNullableCharacterFormattingScript read FScript
      write FScript;
    property FontStrikeoutType: TdxNullableStrikeoutType read FFontStrikeoutType
      write FFontStrikeoutType;
    ...
    property DoubleFontSize: TdxNullableInteger read FDoubleFontSize
      write FDoubleFontSize;
    property ForeColor: TdxNullableColor read FForeColor write FForeColor;
    property UnderlineColor: TdxNullableColor read FUnderlineColor
      write FUnderlineColor;
    property FontUnderlineType: TdxNullableUnderlineType read FFontUnderlineType
...
constructor TdxFontFormControllerParameters.Create(const AControl
  : IdxRichEditControl; const ASourceCharacterProperties
...
begin
  SourceOptions.UseAllCaps := not AllCaps.IsNull and
    ((SourceInfo.AllCaps <> AllCaps.Value) or not SourceOptions.UseAllCaps);
...
begin
  SourceOptions.UseDoubleFontSize := not DoubleFontSize.IsNull and
    ((SourceInfo.DoubleFontSize <> DoubleFontSize.Value) or
    not SourceOptions.UseDoubleFontSize);
...
begin
  SourceOptions.UseFontBold := not FontBold.IsNull and
    ((SourceInfo.FontBold <> FontBold.Value) or not SourceOptions.UseFontBold);
...
begin
  SourceOptions.UseFontItalic := not FontItalic.IsNull and
    ((SourceInfo.FontItalic <> FontItalic.Value) or
    not SourceOptions.UseFontItalic);
...
begin
  SourceOptions.UseFontName := (FontName <> '') and
    ((SourceInfo.FontName <> FontName) or not SourceOptions.UseFontName);
...
begin
  SourceOptions.UseFontStrikeoutType := not FontStrikeoutType.IsNull and
    ((SourceInfo.FontStrikeoutType <> FontStrikeoutType.Value) or
    not SourceOptions.UseFontStrikeoutType);
...
begin
  SourceOptions.UseFontUnderlineType := not FontUnderlineType.IsNull and
    (not SourceOptions.UseFontUnderlineType or
...
begin
  SourceOptions.UseForeColor := not ForeColor.IsNull and
    ((SourceInfo.ForeColor <> ForeColor.Value) or
    not SourceOptions.UseForeColor);
...
begin
  SourceOptions.UseHidden := not Hidden.IsNull and
    ((SourceInfo.Hidden <> Hidden.Value) or not SourceOptions.UseHidden);
...
begin
  SourceOptions.UseScript := not Script.IsNull and
    ((SourceInfo.Script <> Script.Value) or not SourceOptions.UseScript);
...
begin
  SourceOptions.UseUnderlineColor := not UnderlineColor.IsNull and
    ((SourceInfo.UnderlineColor <> UnderlineColor.Value) or
    not SourceOptions.UseUnderlineColor);
...
begin
  SourceOptions.UseUnderlineWordsOnly := not UnderlineWordsOnly.IsNull and
    ((SourceInfo.UnderlineWordsOnly <> UnderlineWordsOnly.Value) or
    not SourceOptions.UseUnderlineWordsOnly);
  if SourceOptions.UseUnderlineWordsOnly then
    SourceInfo.UnderlineWordsOnly := UnderlineWordsOnly.Value;
end;

constructor TdxFontFormController.Create(const AControllerParameters
  : TdxFontFormControllerParameters);
begin
  inherited Create;
...
begin
  ...
  AllCaps := TdxNullableBoolean.Create(ASourceOptions.UseAllCaps,
    ASourceInfo.AllCaps);
  Script := TdxNullableCharacterFormattingScript.Create
    (ASourceOptions.UseScript, ASourceInfo.Script);
  FontStrikeoutType := TdxNullableStrikeoutType.Create
    (ASourceOptions.UseFontStrikeoutType, ASourceInfo.FontStrikeoutType);
  FontName := IfThen(ASourceOptions.UseFontName, ASourceInfo.FontName);
  FontBold := TdxNullableBoolean.Create(ASourceOptions.UseFontBold and
    ASourceOptions.UseFontItalic, ASourceInfo.FontBold);
  FontItalic := TdxNullableBoolean.Create(ASourceOptions.UseFontBold and
    ASourceOptions.UseFontItalic, ASourceInfo.FontItalic);
  DoubleFontSize := TdxNullableInteger.Create(ASourceOptions.UseDoubleFontSize,
    ASourceInfo.DoubleFontSize);
  ForeColor := TdxNullableColor.Create(ASourceOptions.UseForeColor,
    ASourceInfo.ForeColor);
  UnderlineColor := TdxNullableColor.Create(ASourceOptions.UseUnderlineColor,
    ASourceInfo.UnderlineColor);
  FontUnderlineType := TdxNullableUnderlineType.Create
    (ASourceOptions.UseFontUnderlineType, ASourceInfo.FontUnderlineType);
  UnderlineWordsOnly := TdxNullableBoolean.Create
    (ASourceOptions.UseUnderlineWordsOnly, ASourceInfo.UnderlineWordsOnly);
  Hidden := TdxNullableBoolean.Create(ASourceOptions.UseHidden,
    ASourceInfo.Hidden);
end;

procedure TdxFontFormController.SetFontUnderline(const AUnderlineType
  : TdxNullableUnderlineType; const AUnderlineWordsOnly: TdxNullableBoolean);
begin
  if (AUnderlineType = FontUnderlineType) and
    (UnderlineWordsOnly = AUnderlineWordsOnly) then
    Exit;
...
procedure TdxFontFormController.SetFontUnderlineType
  (const Value: TdxNullableUnderlineType);
begin
  FFontUnderlineType := Value;
  if (UnderlineWordsOnly = True) and
    (FFontUnderlineType <> TdxUnderlineType.Single) then
  begin
...
procedure TdxFontFormController.SetUnderlineWordsOnly
...
begin
  ...
  else if not FPrevFontUnderlineType.IsNull then
