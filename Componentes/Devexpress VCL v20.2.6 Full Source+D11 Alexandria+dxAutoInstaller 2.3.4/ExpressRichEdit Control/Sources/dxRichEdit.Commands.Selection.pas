...
type
  ...
  TdxMoveNextRowDelegate = reference to function(ARow: TdxTableRow)
    : TdxTableRow;
  ...
  protected
    function GetTextBoxContentBounds(AFloatingObjectBox: TdxFloatingObjectBox;
      AContent: TdxTextBoxFloatingObjectContent): TRect;
    function GetNormalizedBorderBounds(const ABounds: TRect;
      ARowViewInfo: TdxTableRowViewInfoBase;
      ABottomRowViewInfo: TdxTableRowViewInfoBase): TRect; virtual;
    function ShouldAppendSelectedCellsOnly(ASelection: TdxSelection;
      AElementAccessor: TdxTableElementAccessorBase): Boolean; virtual;
    procedure AppendCells(ATableViewInfo: TdxTableViewInfo;
      ...
      AIsFirstRow: Boolean;
      const AMoveNextRow: TdxMoveNextRowDelegate); virtual;
    procedure ApplyMaxBorders(AResult: TdxVirtualTableColumn;
      ATableViewInfo: TdxTableViewInfo;
      AElement: TdxTableElementAccessorBase); virtual;
    function ShouldAddElement(AElement: TdxTableElementAccessorBase): Boolean;
    function FindElementByHorizontalPosition(ARow: TdxTableRow;
      AModelHorizontalPosition: Integer): TdxTableElementAccessorBase; virtual;
    ...
    function ExtendSelectionEndToParagraphMark(ASelection: TdxSelection;
      ALogPosition: TdxDocumentLogPosition): TdxDocumentLogPosition; virtual;
    function GetSelectionEndParagraphIndex(ASelection: TdxSelection)
      : TdxParagraphIndex;
    function ExtendSelectionStartToTableRow(ASelection: TdxSelection;
      ALogPosition: TdxDocumentLogPosition): TdxDocumentLogPosition; virtual;
    function ExtendSelectionEndToTableRow(ASelection: TdxSelection;
      ALogPosition: TdxDocumentLogPosition): TdxDocumentLogPosition; virtual;
  ...
  public
    ...
    function CalculateTableRowToResize(AHitTestResult: TdxRichEditHitTestResult)
      : TdxTableRowViewInfoBase; virtual;
    function CalculateTableCellsToResizeHorizontallyCore
      (ATable: TdxTableViewInfo; ATableRow: TdxTableRow;
      AElementAccessor: TdxTableElementAccessorBase;
      ABorderLayoutHorizontalPositionIndex, ABorderModelHorizontalPositionIndex
      : Integer): TdxVirtualTableColumn;
    function CalculateTableCellsToResizeHorizontally(AHitTestResult
      : TdxRichEditHitTestResult): TdxVirtualTableColumn;
    function ExtendSelectionStartToParagraphMark(ASelection: TdxSelection;
      ALogPosition: TdxDocumentLogPosition): TdxDocumentLogPosition; virtual;
    function ShouldResizeTableCellsHorizontally(const AControl
      : IdxRichEditControl; AHitTestResult: TdxRichEditHitTestResult;
      AVirtualColumn: TdxVirtualTableColumn): Boolean;
    function ShouldResizeTableRow(const AControl: IdxRichEditControl;
      AHitTestResult: TdxRichEditHitTestResult;
      ATableRow: TdxTableRowViewInfoBase): Boolean; virtual;
    function ShouldSelectFloatingObject(AHitTestResult
      : TdxRichEditHitTestResult): Boolean; overload; virtual;
    function ShouldSelectFloatingObject(AFloatingObjectBox
      : TdxFloatingObjectBox; const ALogicalPoint: TPoint): Boolean; overload;
    function ShouldSelectComment(AHitTestResult: TdxRichEditHitTestResult)
      : Boolean; virtual;
    function ShouldSelectCommentMoreButton(AHitTestResult
      : TdxRichEditHitTestResult): Boolean; virtual;
    function ShouldSelectEntireTableCell(AHitTestResult
      : TdxRichEditHitTestResult): Boolean; virtual;
    function ShouldSelectToTheEndOfRow(AHitTestResult: TdxRichEditHitTestResult)
      : Boolean; virtual;
    function ShouldSelectEntireTableColumn(AHitTestResult
      : TdxRichEditHitTestResult): Boolean; virtual;
    function ShouldSelectEntireTableRow(AHitTestResult
      : TdxRichEditHitTestResult): Boolean; virtual;
    function ShouldSelectEntireRow(AHitTestResult: TdxRichEditHitTestResult)
      : Boolean; virtual;
  end;

  { TdxExtendSelectionByRangesCommandBase }

  TdxExtendSelectionByRangesCommandBase = class abstract
  ...
  public
    ...
    property InitialLogPosition: TdxDocumentLogPosition
      read FInitialLogPosition;
  end;

  { TdxExtendSelectionByTableRowsCommand }

  TdxExtendSelectionByTableRowsCommand = class
    (TdxExtendSelectionByRangesCommandBase)
  strict private
  ...
  protected
    ...
    procedure ChangeSelectionStart(ASelection: TdxSelection;
      ALogPosition: TdxDocumentLogPosition;
      AHitTestResult: TdxRichEditHitTestResult;
      ASelectionItemCountBeforeChangeEnd: Integer); reintroduce; virtual;
    function GetCurrentTableRow(ALogPosition: TdxDocumentLogPosition)
      : TdxTableRow; virtual;
  public
    constructor Create(const AControl: IdxRichEditControl;
      ANestingLevel: Integer); reintroduce;

    property StartLogPosition: TdxDocumentLogPosition read FStartLogPosition
      write FStartLogPosition;
    property EndLogPosition: TdxDocumentLogPosition read FEndLogPosition
      write FEndLogPosition;
  end;

  { TdxExtendSelectionByStartTableRowsCommand }

  TdxExtendSelectionByStartTableRowsCommand = class
    (TdxExtendSelectionByTableRowsCommand)
  strict private
  ...
  TdxExtendSelectionByTableColumnsCommand = class
    (TdxExtendSelectionByRangesCommandBase)
  strict private
  ...
  public
    constructor Create(const AControl: IdxRichEditControl;
      AStartColumnIndex: Integer; ANestedLevel: Integer); reintroduce;
  end;

  { TdxExtendSelectionByCellsCommand }

  TdxExtendSelectionByCellsCommand = class
    (TdxExtendSelectionByRangesCommandBase)
  strict private
  ...
  public
    constructor Create(const AControl: IdxRichEditControl;
      AStartCell: TdxTableCell); reintroduce;
  end;

  TdxExtendSelectionByCharactersCommand = class
    (TdxExtendSelectionByRangesCommandBase);

  { TdxExtendSelectionByRangesCommand }

  TdxExtendSelectionByRangesCommand = class
    (TdxExtendSelectionByRangesCommandBase)
  protected
    ...
    procedure ChangeSelectionStart(ASelection: TdxSelection;
      ...
      ASelectionItemCountBeforeChangeEnd: Integer); override;

    function CreateIterator: TdxPieceTableIterator; virtual; abstract;
    function ExtendEnd1(ASelection: TdxSelection;
      AHitTestResult: TdxRichEditHitTestResult): Boolean; virtual;
    function ExtendEnd2(AHitTestResult: TdxRichEditHitTestResult)
  ...
  TdxExtendSelectionByParagraphsCommand = class
    (TdxExtendSelectionByRangesCommand)
  protected
    function CreateIterator: TdxPieceTableIterator; override;
  end;
  ...
  TdxExtendSelectionByLinesCommand = class
    (TdxExtendSelectionByRangesCommandBase)
  protected
    function ExtendEnd1(ASelection: TdxSelection;
      AHitTestResult: TdxRichEditHitTestResult): Boolean; virtual;
  ...
  protected
    ...
    function GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
      : TdxDocumentLayoutDetailsLevel; virtual; abstract;
    function GetShouldUpdateCaretY: Boolean; virtual;
    function CanChangePosition(const APos: TdxDocumentModelPosition): Boolean;
      virtual; abstract;
    function ChangePosition(const APos: TdxDocumentModelPosition)
      : TdxDocumentLogPosition; virtual; abstract;
    function CalculateSelectionCurrentPosition(ASelection: TdxSelection)
      : TdxDocumentModelPosition; virtual;
    function ExtendSelectionStartToParagraphMark(ASelection: TdxSelection;
      ALogPosition: TdxDocumentLogPosition): TdxDocumentLogPosition; virtual;
    function ExtendSelectionEndToParagraphMark(ASelection: TdxSelection;
      ALogPosition: TdxDocumentLogPosition): TdxDocumentLogPosition; virtual;
    procedure UpdateTableSelectionAfterSelectionUpdated
      (ALogPosition: TdxDocumentLogPosition); virtual;
    procedure ValidateSelection(ASelection: TdxSelection;
      AIsSelectionExtended: Boolean); virtual;
    function ApplyNewPositionToSelectionEnd(ASelection: TdxSelection;
      ALogPosition: TdxDocumentLogPosition): Boolean; virtual;
    procedure ChangeSelectionStart(ASelection: TdxSelection;
      ALogPosition: TdxDocumentLogPosition); virtual;
    ...
    function CreateEnsureCaretVisibleVerticallyCommand
    ...
    function GetLeftVisibleLogPosition(const APos: TdxDocumentModelPosition)
      : TdxDocumentLogPosition; virtual;
    procedure EnsureCaretVisible;
    procedure PerformModifyModel; virtual;

    property TryToKeepCaretX: Boolean read GetTryToKeepCaretX;
    property TreatStartPositionAsCurrent: Boolean
      read GetTreatStartPositionAsCurrent;
    property ExtendSelection: Boolean read GetExtendSelection;
    property UpdateCaretPositionBeforeChangeSelectionDetailsLevel
      : TdxDocumentLayoutDetailsLevel
      read GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel;
  ...
  public
    ...
    property ShouldEnsureCaretVisibleVerticallyBeforeUpdate: Boolean
      read FShouldEnsureCaretVisibleVerticallyBeforeUpdate
      write FShouldEnsureCaretVisibleVerticallyBeforeUpdate;
    property ShouldEnsureCaretVisibleVerticallyAfterUpdate: Boolean
      read FShouldEnsureCaretVisibleVerticallyAfterUpdate
      write FShouldEnsureCaretVisibleVerticallyAfterUpdate;
  end;
  ...
  protected
    ...
    function GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
      : TdxDocumentLayoutDetailsLevel; override;

    function GetDeletedPosition(ASelection: TdxSelection)
      : TdxDocumentModelPosition; virtual;
    function IsFieldRun(ARun: TdxTextRunBase): Boolean;
    function TryGetVisibleStart(const AStart: TdxDocumentModelPosition;
      out AResult: TdxDocumentLogPosition): Boolean;
    function TryGetVisibleEnd(const AEnd: TdxDocumentModelPosition;
      out AResult: TdxDocumentLogPosition): Boolean;
  ...
  protected
    ...
    function GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
      : TdxDocumentLayoutDetailsLevel; override;
    function CanChangePosition(const APos: TdxDocumentModelPosition)
      : Boolean; override;
    function ChangePosition(const APos: TdxDocumentModelPosition)
      : TdxDocumentLogPosition; override;
  public
  ...
  protected
    ...
    procedure SetSelection(AStart: TdxDocumentLogPosition;
      ALength: Integer); virtual;
  public
    constructor Create(const AControl: IdxRichEditControl;
      ANewActivePieceTable: TdxPieceTable; ASection: TdxSection;
      APreferredPageIndex: Integer); reintroduce;
    class function GetDescription: string; override;
    class function GetMenuCaption: string; override;
    procedure ActivatePieceTable(ANewPieceTable: TdxPieceTable;
  ...
  protected
    ...
    function GetPrevVisibleLogPosition(const APos: TdxDocumentModelPosition)
  ...
  protected
    ...
    function GetNextVisibleLogPosition(const APos: TdxDocumentModelPosition)
      : TdxDocumentLogPosition;
    function GetPrevVisibleLogPosition(const APos: TdxDocumentModelPosition)
      : TdxDocumentLogPosition;
    function GetModelPosition(const APos: TdxDocumentLogPosition)
  ...
  protected
    ...
    function CreateNextCaretPositionCalculator
      : TdxNextCaretPositionVerticalDirectionCalculator; virtual; abstract;
  end;
  ...
  protected
    ...
    function GetTryToKeepCaretX: Boolean; override;
    function CreateNextCaretPositionCalculator
      : TdxNextCaretPositionVerticalDirectionCalculator; override;
  public
    class function Id: TdxRichEditCommandId; override;
    class function GetDescription: string; override;
    class function GetMenuCaption: string; override;
  ...
  protected
    ...
    function GetNextVisiblePosition(ARunIndex: TdxRunIndex)
      : TdxDocumentModelPosition; overload; virtual;
    function GetNextVisiblePosition(const APos: TdxDocumentModelPosition)
      : TdxDocumentLogPosition; overload; virtual;
    function GetPrevVisiblePosition(ARunIndex: TdxRunIndex)
      : TdxDocumentModelPosition; overload; virtual;
    function GetPrevVisiblePosition(const APos: TdxDocumentModelPosition)
      : TdxDocumentLogPosition; overload; virtual;
    function GetValidLogPosition(const ANewPos: TdxDocumentModelPosition;
      AParagraph: TdxParagraph): TdxDocumentLogPosition; virtual;
    function GetVisibleLogPosition(AParagraph: TdxParagraph)
      : TdxDocumentLogPosition; virtual;
  ...
  protected
    ...
    function GetPrevPosition(AParagraphIndex: TdxParagraphIndex)
      : TdxDocumentLogPosition;
  public
    class function Id: TdxRichEditCommandId; override;
    class function GetDescription: string; override;
  ...
  protected
    ...
    function GetLastPosition(APageIndex: Integer)
      : TdxDocumentLogPosition; virtual;
  public
    class function Id: TdxRichEditCommandId; override;
    class function GetDescription: string; override;
  ...
  protected
    ...
    function CalculateCaretNewLogPosition(const APhysicalPoint: TPoint)
      : TdxDocumentLogPosition;
    function CreateCaretPositionCalculator
      : TdxNextCaretPositionVerticalDirectionCalculator; virtual; abstract;
    function CreatePlaceCaretToPhysicalPointCommand
      : TdxPlaceCaretToPhysicalPointCommand; virtual;
    function GetDefaultLogPosition: TdxDocumentLogPosition; virtual; abstract;
    function GetTargetRowAtColumn(AColumn: TdxColumn): TdxRow; virtual;
      abstract;
    function IsNewPositionInCorrectDirection(APreviousLogPosition,
      ACurrentLogPosition: TdxDocumentLogPosition): Boolean; virtual; abstract;
    function ScrollScreen: Boolean; virtual; abstract;
    function ShouldCalculateNewCaretLogPosition(APreviousLogPosition,
      ACurrentLogPosition: TdxDocumentLogPosition): Boolean; virtual; abstract;
    function ShouldUseAnotherPage(AColumn: TdxColumn;
      const ALogicalCaretPoint: TPoint): Boolean; virtual; abstract;
  public
    procedure ChangeSelection(ASelection: TdxSelection); override;
  end;
  ...
  protected
    function CreatePlaceCaretToPhysicalPointCommand
      : TdxPlaceCaretToPhysicalPointCommand; override;
    function GetExtendSelection: Boolean; override;
  public
    class function Id: TdxRichEditCommandId; override;
  end;
  ...
  protected
    function CalculateStartPosition(AItem: TdxSelectionItem;
      AllowSelectionExpanding: Boolean): TdxDocumentModelPosition; virtual;
    function CalculateEndPosition(AItem: TdxSelectionItem;
      AllowSelectionExpanding: Boolean): TdxDocumentModelPosition; virtual;
  end;

  { TdxExtendSelectionToPhysicalPointCommand }

  TdxExtendSelectionToPhysicalPointCommand = class
    (TdxPlaceCaretToPhysicalPointCommand)
  protected
    function ExtendSelection: Boolean; override;
  end;
  ...
  TdxSelectionBasedPropertyChangeCommandBase = class
    (TdxSelectionBasedCommandBase)
  protected
    function ActivePieceTableObtainParagraphsPropertyValue<T>(ALogPositionStart
      : TdxDocumentLogPosition; ALength: Integer;
      AModifier: TdxParagraphPropertyModifier<T>; out AValue: T): Boolean;
    function ActivePieceTableObtainRunsPropertyValue<T>(const ALogPositionStart
      : TdxDocumentLogPosition; ALength: Integer;
    ...
    function ValidateSelectionInterval(AItem: TdxSelectionItem)
      : Boolean; virtual;
  ...
  protected
    ...
    procedure SetPreferredWidth(const AValue: TdxWidthUnitInfo);
      virtual; abstract;
    function IsElementSelected(ASelectedCells: TdxSelectedCellsCollection)
      : Boolean; virtual; abstract;
    function CoercePreferredWidth(AInfo: TdxWidthUnitInfo)
      : TdxWidthUnitInfo; virtual;
    function IsNextElementSelected(ASelectedCells: TdxSelectedCellsCollection)
      : Boolean; virtual;
  public
    ...
    function GetVerticalSpanElements: TdxTableElementAccessorBaseList;
      virtual; abstract;
    function GetEndColumnIndex: Integer; virtual;
    function IsRightBoundarySelected(ASelectedCells: TdxSelectedCellsCollection)
      : Boolean; virtual;
    function GetMinContentWidth: Integer; virtual; abstract;
    function GetMinRightBorderPosition(ATableViewInfo: TdxTableViewInfo)
      : Integer; virtual; abstract;
    function GetMaxRightBorderPosition(ATableViewInfo: TdxTableViewInfo)
      : Integer; virtual; abstract;
    function GetRightBorderPosition(ATableViewInfo: TdxTableViewInfo): Integer;
      virtual; abstract;

    property Row: TdxTableRow read GetRow;
    property LayoutColumnSpan: Integer read GetLayoutColumnSpan;
    property ModelColumnSpan: Integer read GetModelColumnSpan
      write SetModelColumnSpan;
    property PreferredWidth: TdxWidthUnitInfo read GetPreferredWidth
  ...
  public
    ...
    property Items[Index: Integer]: TdxTableElementAccessorBase
  ...
  public
    ...
    function GetMaxRightBorderPosition(ATableViewInfo: TdxTableViewInfo)
      : Integer; override;
    function GetRightBorderPosition(ATableViewInfo: TdxTableViewInfo)
      : Integer; override;
...
begin
  ...
  FMinBorderWidthToHitTest := DocumentModel.LayoutUnitConverter.
    PixelsToLayoutUnits(4, DocumentModel.DpiX);
...
function TdxEnhancedSelectionManager.ShouldSelectFloatingObject
...
begin
  ...
  if AFloatingObjectBox = nil then
    Exit(False);
  Result := ShouldSelectFloatingObject(AFloatingObjectBox,
    AHitTestResult.LogicalPoint);
end;
...
begin
  ...
  Result := not GetTextBoxContentBounds(AFloatingObjectBox,
    TdxTextBoxFloatingObjectContent(ARun.Content)).Contains(APoint);
end;

function TdxEnhancedSelectionManager.GetTextBoxContentBounds(AFloatingObjectBox
  : TdxFloatingObjectBox; AContent: TdxTextBoxFloatingObjectContent): TRect;
var
  AUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
  ALocation: TPoint;
  ATextBoxProperties: TdxTextBoxProperties;
  AHotZoneWidth, AHotZoneHeight, ALeftMargin, ATopMargin, ARightMargin,
    ABottomMargin: Integer;
  ASize: TSize;
begin
  ...
  AHotZoneWidth := DocumentModel.LayoutUnitConverter.PixelsToLayoutUnits
    (TextBoxHotZoneWidthInPixels);
  AHotZoneHeight := DocumentModel.LayoutUnitConverter.PixelsToLayoutUnits
    (TextBoxHotZoneWidthInPixels);

  ALeftMargin := Max(AHotZoneWidth,
    AUnitConverter.ToLayoutUnits(ATextBoxProperties.LeftMargin));
  ATopMargin := Max(AHotZoneHeight,
    AUnitConverter.ToLayoutUnits(ATextBoxProperties.TopMargin));
  ARightMargin := Max(AHotZoneWidth,
    AUnitConverter.ToLayoutUnits(ATextBoxProperties.RightMargin));
  ABottomMargin := Max(AHotZoneHeight,
    AUnitConverter.ToLayoutUnits(ATextBoxProperties.BottomMargin));
...
function TdxEnhancedSelectionManager.ShouldSelectComment(AHitTestResult
  : TdxRichEditHitTestResult): Boolean;
var
...
function TdxEnhancedSelectionManager.ShouldSelectCommentMoreButton
  (AHitTestResult: TdxRichEditHitTestResult): Boolean;
var
...
begin
  ...
  if (AHitTestResult.Accuracy and ExactCharacter) = 0 then
    if AHitTestResult.Character.Bounds.Right < AHitTestResult.LogicalPoint.X
    then
      Exit(True);
...
function TdxEnhancedSelectionManager.ShouldSelectEntireRow(AHitTestResult
  : TdxRichEditHitTestResult): Boolean;
begin
  if AHitTestResult.PieceTable <> FPieceTable then
    Exit(False);
...
function TdxEnhancedSelectionManager.CalculateTableRowToResize
  (AHitTestResult: TdxRichEditHitTestResult): TdxTableRowViewInfoBase;
var
...
begin
  ...
  ABounds.Height := Math.Max(AAnchor.BottomTextIndent,
    FMinBorderWidthToHitTest);

  if ABounds.Contains(AHitTestResult.LogicalPoint) then
    Exit(AHitTestResult.TableRow.Previous);

  if (AHitTestResult.TableRow.Row = ATable.Table.Rows.Last) and
    (ATable.NextTableViewInfo = nil) then
  begin
...
function TdxEnhancedSelectionManager.ShouldResizeTableRow(const AControl
  : IdxRichEditControl; AHitTestResult: TdxRichEditHitTestResult;
  ATableRow: TdxTableRowViewInfoBase): Boolean;
var
...
begin
  ...
  ACommand := TdxChangeTableRowHeightCommand.Create(AControl,
    ATableRow.Row, 100);
  try
...
function TdxEnhancedSelectionManager.CalculateTableCellsToResizeHorizontally
  (AHitTestResult: TdxRichEditHitTestResult): TdxVirtualTableColumn;
var
  ACell, APrevCell: TdxTableCellViewInfo;
  ATable: TdxTableViewInfo;
  ATableCell: TdxTableCell;
  ATableRow: TdxTableRow;
  ATopRowViewInfoIndex, ABottomRowViewInfoIndex,
    AStartLayoutHorizontalPositionIndex, AStartModelHorizontalPositionIndex,
    AEndLayoutHorizontalPositionIndex, AEndModelHorizontalPositionIndex,
    ABorderLayoutHorizontalPositionIndex,
    ABorderModelHorizontalPositionIndex: Integer;
...
begin
  ...
  ATopRowViewInfoIndex :=
    Math.Max(ACell.StartRowIndex - ACell.TableViewInfo.TopRowIndex, 0);
  ABottomRowViewInfoIndex := ATopRowViewInfoIndex + ACell.BottomAnchorIndex -
    ACell.TopAnchorIndex - 1;

  ARowViewInfo := ATable.Rows[ATopRowViewInfoIndex];
  ABottomRowViewInfo := ATable.Rows[ABottomRowViewInfoIndex];
  AStartLayoutHorizontalPositionIndex :=
    TdxTableCellVerticalBorderCalculator.GetStartColumnIndex(ATableCell, True);
  AStartModelHorizontalPositionIndex :=
    ATableCell.GetStartColumnIndexConsiderRowGrid;
  AEndLayoutHorizontalPositionIndex := AStartLayoutHorizontalPositionIndex +
    ATableCell.LayoutProperties.ColumnSpan;
  AEndModelHorizontalPositionIndex :=
    ATableCell.GetStartColumnIndexConsiderRowGrid + ATableCell.ColumnSpan;

  ABounds := ARowViewInfo.GetVerticalBorderBounds
    (AEndLayoutHorizontalPositionIndex);
  ABounds := GetNormalizedBorderBounds(ABounds, ARowViewInfo,
    ABottomRowViewInfo);
  ...
  Result := CalculateTableCellsToResizeHorizontallyCore(ATable, ATableRow,
    AElementAccessor, ABorderLayoutHorizontalPositionIndex,
    ABorderModelHorizontalPositionIndex);
end;

function TdxEnhancedSelectionManager.GetNormalizedBorderBounds
  (const ABounds: TRect; ARowViewInfo: TdxTableRowViewInfoBase;
  ABottomRowViewInfo: TdxTableRowViewInfoBase): TRect;
var
  ADelta: TdxLayoutUnit;
begin
  Result := ABounds;
  if ABottomRowViewInfo <> ARowViewInfo then
    Result.Height := ABottomRowViewInfo.BottomAnchor.VerticalPosition -
      ABounds.Top;
...
begin
  ...
  Result.Position := ATable.GetAlignedPosition
    (ABorderLayoutHorizontalPositionIndex);
  ...
  AAppendSelectedCellsOnly := ShouldAppendSelectedCellsOnly
    (DocumentModel.Selection, AElementAccessor);
  AIsFirstRow := ATableRow.Table.Rows.First = ATableRow;
  AMoveTop := function(ARow: TdxTableRow): TdxTableRow
    begin
      Result := ARow.Previous;
    end;
  AMoveBottom := function(ARow: TdxTableRow): TdxTableRow
    begin
      Result := ARow.Next;
    end;
  AppendCells(ATable, ATableRow, ABorderModelHorizontalPositionIndex, Result,
    AAppendSelectedCellsOnly, AIsFirstRow, AMoveTop);
  AppendCells(ATable, ATableRow, ABorderModelHorizontalPositionIndex, Result,
    AAppendSelectedCellsOnly, AIsFirstRow, AMoveBottom);
end;

function TdxEnhancedSelectionManager.ShouldAppendSelectedCellsOnly
  (ASelection: TdxSelection;
  AElementAccessor: TdxTableElementAccessorBase): Boolean;
begin
...
procedure TdxEnhancedSelectionManager.AppendCells(ATableViewInfo
  : TdxTableViewInfo; AStartRow: TdxTableRow;
  AModelHorizontalPositionIndex: Integer; AResult: TdxVirtualTableColumn;
  AAppendSelectedCellsOnly: Boolean; AIsFirstRow: Boolean;
  const AMoveNextRow: TdxMoveNextRowDelegate);
var
...
begin
  ...
  begin
    if AResult.MaxLeftBorder = AResult.MaxRightBorder then
      Break;
    AElement := FindElementByHorizontalPosition(ARow,
      AModelHorizontalPositionIndex);
...
procedure TdxEnhancedSelectionManager.ApplyMaxBorders
  (AResult: TdxVirtualTableColumn; ATableViewInfo: TdxTableViewInfo;
  AElement: TdxTableElementAccessorBase);
var
  AMiddle: TdxLayoutUnit;
begin
  AResult.MaxLeftBorder := Max(AResult.MaxLeftBorder,
    AElement.GetMinRightBorderPosition(ATableViewInfo) + FMinDistance);
  AResult.MaxRightBorder := Min(AResult.MaxRightBorder,
    AElement.GetMaxRightBorderPosition(ATableViewInfo) - FMinDistance);
  if AResult.MaxLeftBorder > AResult.MaxRightBorder then
  begin
...
function TdxEnhancedSelectionManager.ShouldAddElement
  (AElement: TdxTableElementAccessorBase): Boolean;
var
  ASelection: TdxSelection;
...
begin
  ...
  ASelectedCells := Safe<TdxSelectedCellsCollection>.Cast
    (ASelection.SelectedCells);
...
function TdxEnhancedSelectionManager.FindElementByHorizontalPosition
  (ARow: TdxTableRow; AModelHorizontalPosition: Integer)
  : TdxTableElementAccessorBase;
var
...
function TdxEnhancedSelectionManager.ShouldResizeTableCellsHorizontally
  (const AControl: IdxRichEditControl; AHitTestResult: TdxRichEditHitTestResult;
  AVirtualColumn: TdxVirtualTableColumn): Boolean;
var
...
begin
  ...
  ACommand := TdxChangeTableVirtualColumnRightCommand.Create(AControl,
    AVirtualColumn, 100);
  try
    Result := ACommand.CanExecute;
  finally
...
function TdxEnhancedSelectionManager.ShouldSelectEntireTableColumn
  (AHitTestResult: TdxRichEditHitTestResult): Boolean;
var
...
begin
  ...
  AOffset := Min(ATableRowTopAnchor.BottomTextIndent + DragSize.cy,
    ARowInfo.BottomAnchor.VerticalPosition - ATableRowTopPosition);
  Result := (ALogicalY >= ATableRowTopPosition) and
    (ALogicalY <= ATableRowTopPosition + AOffset);
end;

function TdxEnhancedSelectionManager.ShouldSelectEntireTableRow
  (AHitTestResult: TdxRichEditHitTestResult): Boolean;
begin
  if AHitTestResult.PieceTable <> FPieceTable then
    Exit(False);
  ...
  if (AHitTestResult.Accuracy and ExactTableRow) <> 0 then
    if AHitTestResult.TableRow.Cells.First.Left > AHitTestResult.LogicalPoint.X
    then
...
function TdxEnhancedSelectionManager.ShouldSelectEntireTableCell
  (AHitTestResult: TdxRichEditHitTestResult): Boolean;
var
...
begin
  ...
  begin
    ...
    ACellMargin := GetWidthConsiderUnitType
      (ACellViewInfo.Cell.GetActualLeftMargin);
    ALogicalX := AHitTestResult.LogicalPoint.X;
    if (ACellViewInfoLeft <= ALogicalX) and
      (ALogicalX <= ACellViewInfoLeft + ACellMargin) then
      Exit(True);
  end;
  Result := False;
end;

function TdxEnhancedSelectionManager.GetWidthConsiderUnitType
...
begin
  ...
  if (ALogPosition <= AParagraph.LogPosition) and
    (ASelection.Start = AParagraph.LogPosition + AParagraph.Length - 1) then
  begin
...
function TdxEnhancedSelectionManager.GetSelectionEndParagraphIndex
  (ASelection: TdxSelection): TdxParagraphIndex;
var
...
function TdxEnhancedSelectionManager.ExtendSelectionStartToTableRow
  (ASelection: TdxSelection; ALogPosition: TdxDocumentLogPosition)
  : TdxDocumentLogPosition;
var
...
begin
  ...
  Result := AParagraphs[ATableCell.Row.FirstCell.StartParagraphIndex]
    .LogPosition;
end;

function TdxEnhancedSelectionManager.ExtendSelectionEndToTableRow
  (ASelection: TdxSelection; ALogPosition: TdxDocumentLogPosition)
  : TdxDocumentLogPosition;
var
  AParagraph: TdxParagraph;
...
begin
  ...
  Result := PieceTable.Paragraphs[ATableCell.Row.LastCell.EndParagraphIndex]
    .EndLogPosition + 1;
end;
...
function TdxExtendSelectionByRangesCommandBase.
...
begin
  FInitialBox := Value;
  FInitialLogPosition := InitialBox.GetFirstPosition(ActivePieceTable)
    .LogPosition;
end;

{ TdxExtendSelectionByTableRowsCommand }

constructor TdxExtendSelectionByTableRowsCommand.Create(const AControl
  : IdxRichEditControl; ANestingLevel: Integer);
begin
  inherited Create(AControl);
  FNestingLevel := ANestingLevel;
end;

function TdxExtendSelectionByTableRowsCommand.ChangeSelectionEnd
  (ASelection: TdxSelection; ALogPosition: TdxDocumentLogPosition;
  AHitTestResult: TdxRichEditHitTestResult): Boolean;
var
  AParagraphs: TdxParagraphCollection;
...
procedure TdxExtendSelectionByTableRowsCommand.ChangeSelectionStart
  (ASelection: TdxSelection; ALogPosition: TdxDocumentLogPosition;
  AHitTestResult: TdxRichEditHitTestResult;
...
function TdxExtendSelectionByTableRowsCommand.GetCurrentTableRow
  (ALogPosition: TdxDocumentLogPosition): TdxTableRow;
var
  AParagraphIndex: TdxParagraphIndex;
begin
  AParagraphIndex := ActivePieceTable.FindParagraphIndex(ALogPosition);
  Result := ActivePieceTable.TableCellsManager.GetCellByNestingLevel
    (AParagraphIndex, FNestingLevel).Row;
end;

{ TdxExtendSelectionByStartTableRowsCommand }

constructor TdxExtendSelectionByStartTableRowsCommand.Create(const AControl
  : IdxRichEditControl; ANestingLevel: Integer);
begin
...
procedure TdxExtendSelectionByStartTableRowsCommand.ChangeSelection
  (ASelection: TdxSelection; ALogPosition: TdxDocumentLogPosition;
  AHitTestResult: TdxRichEditHitTestResult);
var
...
constructor TdxExtendSelectionByTableColumnsCommand.Create(const AControl
  : IdxRichEditControl; AStartColumnIndex: Integer; ANestedLevel: Integer);
begin
  inherited Create(AControl);
...
procedure TdxExtendSelectionByTableColumnsCommand.ChangeSelection
  (ASelection: TdxSelection; ALogPosition: TdxDocumentLogPosition;
  AHitTestResult: TdxRichEditHitTestResult);
var
  AParagraphIndex: TdxParagraphIndex;
...
begin
  AParagraphIndex := ActivePieceTable.FindParagraphIndex(ALogPosition);
  ACurrentTableCell := ActivePieceTable.TableCellsManager.GetCellByNestingLevel
    (AParagraphIndex, FNestedLevel);
...
constructor TdxExtendSelectionByCellsCommand.Create(const AControl
  : IdxRichEditControl; AStartCell: TdxTableCell);
begin
  inherited Create(AControl);
...
procedure TdxExtendSelectionByCellsCommand.ChangeSelection
  (ASelection: TdxSelection; ALogPosition: TdxDocumentLogPosition;
  AHitTestResult: TdxRichEditHitTestResult);
var
  AParagraphIndex: TdxParagraphIndex;
...
begin
  AParagraphIndex := ActivePieceTable.FindParagraphIndex(ALogPosition);
  AEndCell := ActivePieceTable.TableCellsManager.GetCellByNestingLevel
    (AParagraphIndex, FStartCell.Table.NestedLevel);
  if AEndCell.Table.NestedLevel <> FStartCell.Table.NestedLevel then
    FStartCell := ActivePieceTable.TableCellsManager.GetCellByNestingLevel
      (FStartCell.StartParagraphIndex, AEndCell.Table.NestedLevel);

  while (FStartCell <> nil) and (AEndCell <> nil) do
  begin
    if FStartCell.Table = AEndCell.Table then
    begin
      ASelection.ManuallySetTableSelectionStructureAndChangeSelection
        (FStartCell, AEndCell);
      Break;
    end;
...
constructor TdxRichEditSelectionCommand.Create(const AControl
  : IdxRichEditControl);
begin
  inherited Create(AControl);
...
function TdxRichEditSelectionCommand.ApplyNewPositionToSelectionEnd
  (ASelection: TdxSelection; ALogPosition: TdxDocumentLogPosition): Boolean;
begin
...
begin
  ...
  begin
    ALogPosition := Min(ALogPosition,
      ActivePieceTable.DocumentEndLogPosition + 1);
    ANewLogPosition := ExtendSelectionEndToParagraphMark(ASelection,
      ALogPosition);
  ...
  AUsePreviousBoxBounds := ApplyNewPositionToSelectionEnd(ASelection,
    ALogPosition) or AUsePreviousBoxBounds;
  ...
  ACurrentLastCell := ARuns[ASelection.Interval.&End.RunIndex]
    .Paragraph.GetCellCore;

  if not((AOldSelectionLength > ASelection.Length) and (ACurrentLastCell <> nil)
    and (APreviousLastCell = nil)) then
    UpdateTableSelectionAfterSelectionUpdated(ALogPosition);
  ValidateSelection(ASelection, ASelection.Length > AOldSelectionLength);
end;

procedure TdxRichEditSelectionCommand.ChangeSelectionStart
  (ASelection: TdxSelection; ALogPosition: TdxDocumentLogPosition);
begin
  if not ExtendSelection then
    ASelection.Start := ASelection.VirtualEnd
  else
    ASelection.Start := ExtendSelectionStartToParagraphMark(ASelection,
      ALogPosition);
end;

function TdxRichEditSelectionCommand.CreateEnsureCaretVisibleVerticallyCommand
  : TdxRichEditCommand;
begin
...
begin
  ...
  begin
    ACommand := TdxEnsureCaretVisibleHorizontallyCommand.Create
      (RichEditControl);
    try
      ACommand.Execute;
    finally
...
begin
  ...
  try
    ...
    AfterUpdate;
    if ShouldEnsureCaretVisibleVerticallyAfterUpdate and
      not DocumentModel.ActivePieceTable.IsComment then
      EnsureCaretVisibleVertically;
    if not TryToKeepCaretX then
    begin
    ...
    if ShouldUpdateCaretY and (CaretPosition.LayoutPosition.TableCell <> nil)
    then
    begin
    ...
    begin
      ...
      RichEditControl.RedrawEnsureSecondaryFormattingComplete
        (TdxRefreshAction.Selection);
    end;
  finally
...
function TdxRichEditSelectionCommand.ExtendSelectionEndToParagraphMark
  (ASelection: TdxSelection; ALogPosition: TdxDocumentLogPosition)
  : TdxDocumentLogPosition;
var
...
begin
  ...
  try
    Result := ASelectionManager.ExtendSelectionEndToParagraphMark(ASelection,
      ALogPosition);
  finally
...
function TdxRichEditSelectionCommand.ExtendSelectionStartToParagraphMark
  (ASelection: TdxSelection; ALogPosition: TdxDocumentLogPosition)
  : TdxDocumentLogPosition;
var
  ASelectionManager: TdxEnhancedSelectionManager;
begin
  ASelectionManager := TdxEnhancedSelectionManager.Create(ActivePieceTable);
  try
    Result := ASelectionManager.ExtendSelectionStartToParagraphMark(ASelection,
      ALogPosition);
  finally
    ASelectionManager.Free;
  end;
...
function TdxRichEditSelectionCommand.GetLeftVisibleLogPosition
...
function TdxRichEditSelectionCommand.GetSelectionEndParagraphIndex
  : TdxParagraphIndex;
var
...
begin
  ...
  try
    AEndParagraphIndex := ActivePieceTable.FindParagraphIndex
      (ASelection.Last.&End);
...
begin
  ...
  if AIndex = 0 then
    Exit(False);
  Result := ActivePieceTable.Paragraphs[AIndex - 1].IsInCell and
    not ActivePieceTable.Paragraphs[AIndex].IsInCell;
end;
...
procedure TdxRichEditSelectionCommand.UpdateTableSelectionAfterSelectionUpdated
  (ALogPosition: TdxDocumentLogPosition);
begin
  DocumentModel.Selection.SetStartCell(ALogPosition);
end;

procedure TdxRichEditSelectionCommand.UpdateUIStateCore
...
procedure TdxRichEditSelectionCommand.ValidateSelection
  (ASelection: TdxSelection; AIsSelectionExtended: Boolean);
var
...
begin
  ...
  AStartSelection := TdxDocumentModelPosition.FromRunStart(ActivePieceTable,
    AField.FirstRunIndex);
  AEndSelection := TdxDocumentModelPosition.FromRunEnd(ActivePieceTable,
    AField.LastRunIndex);
  if not AField.IsCodeView and (AField.Result.Start = AField.Result.&End) then
  begin
    if TryGetVisibleStart(AStartSelection, AStart) or
      TryGetVisibleEnd(AEndSelection, AEnd) then
    begin
...
function TdxSelectFieldNextPrevToCaretCommand.
  GetTreatStartPositionAsCurrent: Boolean;
begin
  Result := False;
end;
...
function TdxSelectFieldNextPrevToCaretCommand.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
  Result := TdxDocumentLayoutDetailsLevel.None;
end;

function TdxSelectFieldNextPrevToCaretCommand.GetVisibleTextFilter
...
function TdxSelectFieldNextPrevToCaretCommand.TryGetVisibleStart
  (const AStart: TdxDocumentModelPosition;
  out AResult: TdxDocumentLogPosition): Boolean;
begin
...
function TdxSelectFieldNextPrevToCaretCommand.TryGetVisibleEnd
...
procedure TdxSelectFieldNextPrevToCaretCommand.UpdateUIState
  (const AState: IdxCommandUIState);
var
  ARunIndex: TdxRunIndex;
begin
  ARunIndex := GetDeletedPosition(DocumentModel.Selection).RunIndex;
  AState.Enabled := (DocumentModel.Selection.Length = 0) and
    IsFieldRun(ActivePieceTable.Runs[ARunIndex]);
end;
...
function TdxShrinkSelectionToStartCommand.
  GetTreatStartPositionAsCurrent: Boolean;
begin
  Result := True;
end;
...
function TdxShrinkSelectionToStartCommand.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;

function TdxShrinkSelectionToStartCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): TdxDocumentLogPosition;
begin
  Result := APos.LogPosition;
end;
...
function TdxSelectFieldPrevToCaretCommand.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;

function TdxSelectFieldPrevToCaretCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): TdxDocumentLogPosition;
begin
  Result := APos.LogPosition;
end;

function TdxSelectFieldPrevToCaretCommand.GetDeletedPosition
  (ASelection: TdxSelection): TdxDocumentModelPosition;
begin
  if ASelection.NormalizedStart > ActivePieceTable.DocumentStartLogPosition then
    Result := TdxDocumentModelPosition.MoveBackward
      (ASelection.Interval.NormalizedStart^)
  else
...
begin
  ...
  begin
    if CaretPosition.LayoutPosition.IsValid(TdxDocumentLayoutDetailsLevel.Page)
    then
    begin
      APos := CaretPosition.LayoutPosition.Page.GetFirstPosition
...
procedure TdxChangeActivePieceTableCommand.SetSelection
...
constructor TdxChangeActivePieceTableCommand.Create(const AControl
  : IdxRichEditControl; ANewActivePieceTable: TdxPieceTable;
...
function TdxChangeActivePieceTableCommand.
  GetTreatStartPositionAsCurrent: Boolean;
begin
  Result := False;
end;
...
procedure TdxChangeActivePieceTableCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  AState.Visible := True;
  AState.Checked := True;
  ...
  begin
    ...
    ApplyCommandRestrictionOnEditableControl(AState,
      Options.DocumentCapabilities.HeadersFooters, AState.Enabled);
    ApplyCommandRestrictionOnEditableControl(AState,
      Options.DocumentCapabilities.Sections, AState.Enabled);
  end
  else if FNewActivePieceTable.IsTextBox then
  begin
    AState.Enabled := True;
    ApplyCommandRestrictionOnEditableControl(AState,
      Options.DocumentCapabilities.FloatingObjects, AState.Enabled);
  end;
end;
...
begin
  ...
  begin
    ATextBoxPieceTable := Safe<TdxTextBoxContentType>.Cast
      (ActivePieceTable.ContentType);
    ...
    SetSelection(AAnchorPieceTable.GetRunLogPosition
      (ATextBoxPieceTable.AnchorRun), 1);
    Exit(True);
  end
  else
  begin
...
function TdxSelectUpperLevelObjectCommand.
  CanResetCurrentObjectSelection: Boolean;
var
  ARunInfo: TdxRunInfo;
  ARun: TdxTextRunBase;
begin
  ...
  ARunInfo := ActivePieceTable.FindRunInfo
    (DocumentModel.Selection.NormalizedStart, 1);
  try
    ARun := ActivePieceTable.Runs[ARunInfo.Start.RunIndex];
  finally
    ARunInfo.Free;
  end;
  if not((ARun is TdxFloatingObjectAnchorRun) or (ARun is TdxInlinePictureRun))
  then
    Exit(False);
...
function TdxSelectUpperLevelObjectCommand.
  GetCurrentSectionFromCaretLayoutPosition: TdxSection;
begin
  UpdateCaretPosition;
  if not CaretPosition.LayoutPosition.IsValid
    (TdxDocumentLayoutDetailsLevel.PageArea) then
    Exit(nil);
  Result := CaretPosition.LayoutPosition.PageArea.Section;
end;

procedure TdxSelectUpperLevelObjectCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
var
  ARunInfo: TdxRunInfo;
  ARun: TdxTextRunBase;
begin
  ...
  begin
    ...
    AState.Enabled := not ActivePieceTable.IsMain or
      (((ARun is TdxFloatingObjectAnchorRun) or (ARun is TdxInlinePictureRun)));
  end
  else
...
function TdxPreviousCharacterCommand.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;

function TdxPreviousCharacterCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): TdxDocumentLogPosition;
begin
...
function TdxPreviousCharacterCommand.GetPrevVisibleLogPosition
  (const APos: TdxDocumentModelPosition): TdxDocumentLogPosition;
var
  ATextFilter: IdxVisibleTextFilter;
begin
...
function TdxPreviousCharacterCommand.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
  Result := TdxDocumentLayoutDetailsLevel.None;
...
function TdxPrevNextWordCommand.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;
...
function TdxPrevNextWordCommand.GetModelPosition
  (const APos: TdxDocumentLogPosition): TdxDocumentModelPosition;
begin
  Assert(False);
end;

function TdxPrevNextWordCommand.GetNextVisibleLogPosition
  (const APos: TdxDocumentModelPosition): TdxDocumentLogPosition;
begin
...
function TdxPrevNextWordCommand.GetPrevVisibleLogPosition
  (const APos: TdxDocumentModelPosition): TdxDocumentLogPosition;
begin
...
function TdxPrevNextWordCommand.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
  Result := TdxDocumentLayoutDetailsLevel.None;
...
function TdxPreviousWordCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
var
...
function TdxNextCharacterCommand.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;

function TdxNextCharacterCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
begin
  if not ExtendSelection and (DocumentModel.Selection.Length > 0) then
  begin
...
function TdxNextCharacterCommand.GetNextVisibleLogPosition
  (const APos: TdxDocumentModelPosition): TdxDocumentLogPosition;
var
  ATextFilter: IdxVisibleTextFilter;
begin
...
function TdxNextCharacterCommand.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
  Result := TdxDocumentLayoutDetailsLevel.None;
...
function TdxNextWordCommand.ChangePosition(const APos
  : TdxDocumentModelPosition): Integer;
var
  AIterator: TdxPieceTableIterator;
begin
  AIterator := TdxVisibleWordsIterator.Create(ActivePieceTable);
...
function TdxLineUpDownCommandBase.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;

function TdxLineUpDownCommandBase.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
var
...
function TdxLineUpDownCommandBase.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
...
function TdxPreviousLineCommand.CreateNextCaretPositionCalculator
...
function TdxNextLineCommand.CreateNextCaretPositionCalculator
  : TdxNextCaretPositionVerticalDirectionCalculator;
begin
...
function TdxExtendPreviousCharacterCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
var
  ACalculator: TdxExtendKeyboardSelectionHorizontalDirectionCalculator;
begin
  Result := inherited ChangePosition(APos);
  ACalculator := TdxExtendKeyboardSelectionHorizontalDirectionCalculator.Create
    (DocumentModel);
...
procedure TdxExtendPreviousCharacterCommand.
  UpdateTableSelectionAfterSelectionUpdated(ALogPosition: Integer);
begin
...
function TdxExtendNextCharacterCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
var
  ACalculator: TdxExtendKeyboardSelectionHorizontalDirectionCalculator;
begin
...
procedure TdxExtendNextCharacterCommand.
  UpdateTableSelectionAfterSelectionUpdated(ALogPosition: Integer);
begin
  DocumentModel.Selection.UpdateTableSelectionEnd(ALogPosition);
end;
...
function TdxExtendPreviousWordCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
var
  ACalculator: TdxExtendKeyboardSelectionHorizontalDirectionCalculator;
begin
...
function TdxExtendNextWordCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
var
  ACalculator: TdxExtendKeyboardSelectionHorizontalDirectionCalculator;
begin
...
function TdxStartOfLineCommand.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;

function TdxStartOfLineCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
var
  APosition: TdxDocumentModelPosition;
begin
  APosition := CaretPosition.LayoutPosition.Row.GetFirstPosition
    (ActivePieceTable);
...
function TdxStartOfLineCommand.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
  Result := TdxDocumentLayoutDetailsLevel.Row;
...
function TdxEndOfLineCommand.ApplyNewPositionToSelectionEnd
  (ASelection: TdxSelection; ALogPosition: Integer): Boolean;
var
...
begin
  ...
  begin
    ...
    begin
      AChar := ActivePieceTable.TextBuffer
        [ARun.StartIndex + ASelectionIntervalEnd.RunOffset];
...
function TdxEndOfLineCommand.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;

function TdxEndOfLineCommand.ChangePosition(const APos
  : TdxDocumentModelPosition): Integer;
begin
  Result := CaretPosition.LayoutPosition.Row.GetLastPosition(ActivePieceTable)
    .LogPosition;
end;
...
function TdxExtendPreviousLineCommand.CreateNextCaretPositionCalculator
  : TdxNextCaretPositionVerticalDirectionCalculator;
begin
...
function TdxExtendNextLineCommand.CreateNextCaretPositionCalculator
  : TdxNextCaretPositionVerticalDirectionCalculator;
begin
  Result := TdxExtendNextCaretPositionLineDownCalculator.Create
    (RichEditControl);
end;
...
procedure TdxExtendNextLineCommand.UpdateTableSelectionAfterSelectionUpdated
  (ALogPosition: Integer);
var
  ASelection: TdxSelection;
begin
...
function TdxPrevNextParagraphCommandBase.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;
...
function TdxPrevNextParagraphCommandBase.GetNextVisiblePosition
  (const APos: TdxDocumentModelPosition): TdxDocumentLogPosition;
begin
...
function TdxPrevNextParagraphCommandBase.GetPrevVisiblePosition
  (const APos: TdxDocumentModelPosition): TdxDocumentLogPosition;
begin
...
function TdxPrevNextParagraphCommandBase.GetNextVisiblePosition
  (ARunIndex: TdxRunIndex): TdxDocumentModelPosition;
var
  AIndex: TdxRunIndex;
begin
...
function TdxPrevNextParagraphCommandBase.GetTreatStartPositionAsCurrent
  : Boolean;
begin
  Result := False;
end;
...
function TdxPrevNextParagraphCommandBase.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
  Result := TdxDocumentLayoutDetailsLevel.None;
...
function TdxPrevNextParagraphCommandBase.GetValidLogPosition
  (const ANewPos: TdxDocumentModelPosition; AParagraph: TdxParagraph)
  : TdxDocumentLogPosition;
begin
  Result := ANewPos.LogPosition;
end;

function TdxPrevNextParagraphCommandBase.GetVisibleLogPosition
...
begin
  ...
  if VisibleTextFilter.IsRunVisible(ARunIndex) then
    ...
    Result := GetValidLogPosition(GetNextVisiblePosition(ARunIndex),
      AParagraph);
end;

function TdxPrevNextParagraphCommandBase.VisibleTextFilter
  : IdxVisibleTextFilter;
begin
  Result := ActivePieceTable.NavigationVisibleTextFilter;
end;
...
function TdxPreviousParagraphCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
var
  AParagraphIndex: TdxParagraphIndex;
  AParagraph: TdxParagraph;
...
function TdxPreviousParagraphCommand.GetPrevPosition(AParagraphIndex
  : TdxParagraphIndex): TdxDocumentLogPosition;
var
  APrevParagraphIndex: TdxParagraphIndex;
begin
  APrevParagraphIndex := AParagraphIndex - 1;
  if APrevParagraphIndex >= 0 then
    Result := GetVisibleLogPosition(ActivePieceTable.Paragraphs
      [APrevParagraphIndex])
  else
    Result := GetMinPosition;
end;

function TdxPreviousParagraphCommand.GetValidLogPosition(const ANewPos
  : TdxDocumentModelPosition; AParagraph: TdxParagraph): Integer;
begin
...
function TdxExtendPreviousParagraphCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
var
...
procedure TdxExtendPreviousParagraphCommand.
  UpdateTableSelectionAfterSelectionUpdated(ALogPosition: Integer);
begin
  DocumentModel.Selection.UpdateTableSelectionEnd(ALogPosition);
end;
...
function TdxNextParagraphCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
var
  AParagraphIndex: TdxParagraphIndex;
  AParagraphs: TdxParagraphCollection;
...
var
  APos: TdxDocumentModelPosition;
begin
  APos := TdxDocumentModelPosition.FromParagraphEnd(ActivePieceTable,
    ActivePieceTable.Paragraphs.Count - 1);
  if VisibleTextFilter.IsRunVisible(APos.RunIndex) then
    Result := APos.LogPosition
  else
...
function TdxExtendNextParagraphCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
var
  APosition: TdxDocumentLogPosition;
  ACalculator: TdxExtendKeyboardSelectionHorizontalDirectionCalculator;
...
procedure TdxExtendNextParagraphCommand.
  UpdateTableSelectionAfterSelectionUpdated(ALogPosition: Integer);
begin
  DocumentModel.Selection.UpdateTableSelectionEnd(ALogPosition);
end;
...
function TdxPrevNextPageCommandBase.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;

function TdxPrevNextPageCommandBase.CreateEnsureCaretVisibleVerticallyCommand
  : TdxRichEditCommand;
var
  ACommand: TdxEnsureCaretVisibleVerticallyForMovePrevNextPageCommand;
begin
  ACommand := TdxEnsureCaretVisibleVerticallyForMovePrevNextPageCommand.Create
    (RichEditControl);
  ACommand.PhysicalOffsetAboveTargetRow :=
    Round(DocumentModel.LayoutUnitConverter.PointsToFontUnitsF(72) /
    ActiveView.ScaleFactor);
  Result := ACommand;
end;
...
function TdxPrevNextPageCommandBase.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
...
function TdxPreviousPageCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
var
...
begin
  ...
  if APageIndex > 0 then
    Dec(APageIndex);
  Result := GetLeftVisibleLogPosition
    (APages[APageIndex].GetFirstPosition(ActivePieceTable));
end;
...
function TdxNextPageCommand.ChangePosition(const APos
  : TdxDocumentModelPosition): Integer;
var
  APages: TdxPageCollection;
  APageIndex: Integer;
...
function TdxNextPageCommand.GetLastPosition(APageIndex: Integer)
  : TdxDocumentLogPosition;
var
  APages: TdxPageCollection;
begin
...
function TdxPrevNextScreenCommandBase.CalculateCaretNewLogPosition
  (const APhysicalPoint: TPoint): TdxDocumentLogPosition;
var
...
begin
  APageViewInfoRow := ActiveView.PageViewInfoGenerator.GetPageRowAtPoint
    (APhysicalPoint, True);
  ...
  begin
    ...
    begin
      X := ActiveView.CreateLogicalPoint(APageViewInfo.ClientBounds,
        APhysicalPoint).X;
      ACalculator := CreateCaretPositionCalculator;
      try
        ALogicalCaretPoint := ActiveView.CreateLogicalPoint
          (APageViewInfo.ClientBounds, APhysicalPoint);
        AColumn := ACalculator.GetTargetColumn(APageViewInfo.Page,
          ALogicalCaretPoint.X);
        if ShouldUseAnotherPage(AColumn, ALogicalCaretPoint) then
        begin
          ATargetRow :=
            ACalculator.ObtainTargetRowFromCurrentPageViewInfoAndCaretX
            (APageViewInfo, nil, X);
...
function TdxPrevNextScreenCommandBase.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := APos.PieceTable.IsMain;
end;

procedure TdxPrevNextScreenCommandBase.ChangeSelection
  (ASelection: TdxSelection);
var
...
begin
  ...
  begin
    ...
    if ShouldCalculateNewCaretLogPosition(ACurrentLogPosition, ASelection.&End)
    then
    begin
...
function TdxPrevNextScreenCommandBase.CreatePlaceCaretToPhysicalPointCommand
  : TdxPlaceCaretToPhysicalPointCommand;
begin
...
function TdxPrevNextScreenCommandBase.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
...
function TdxPreviousScreenCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
begin
  Result := ActivePieceTable.DocumentStartLogPosition;
end;

function TdxPreviousScreenCommand.CreateCaretPositionCalculator
  : TdxNextCaretPositionVerticalDirectionCalculator;
begin
  Result := TdxNextCaretPositionLineUpCalculator.Create(RichEditControl);
end;
...
function TdxPreviousScreenCommand.GetTargetRowAtColumn
...
function TdxPreviousScreenCommand.ShouldCalculateNewCaretLogPosition
  (APreviousLogPosition, ACurrentLogPosition: Integer): Boolean;
begin
  Result := (APreviousLogPosition = ACurrentLogPosition) and
    (APreviousLogPosition <> 0);
end;
...
function TdxExtendPreviousScreenCommand.CreatePlaceCaretToPhysicalPointCommand
  : TdxPlaceCaretToPhysicalPointCommand;
begin
...
function TdxNextScreenCommand.ChangePosition(const APos
  : TdxDocumentModelPosition): Integer;
begin
  Result := ActivePieceTable.DocumentEndLogPosition;
end;

function TdxNextScreenCommand.CreateCaretPositionCalculator
  : TdxNextCaretPositionVerticalDirectionCalculator;
begin
  Result := TdxNextCaretPositionLineDownCalculator.Create(RichEditControl);
end;
...
function TdxNextScreenCommand.ShouldUseAnotherPage(AColumn: TdxColumn;
  const ALogicalCaretPoint: TPoint): Boolean;
begin
...
function TdxExtendNextScreenCommand.CreatePlaceCaretToPhysicalPointCommand
  : TdxPlaceCaretToPhysicalPointCommand;
begin
  Result := TdxExtendSelectionToPhysicalPointCommand.Create(RichEditControl);
end;
...
function TdxStartOfDocumentCommand.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;

function TdxStartOfDocumentCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
begin
  Result := ActivePieceTable.DocumentStartLogPosition;
end;
...
function TdxStartOfDocumentCommand.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
  Result := TdxDocumentLayoutDetailsLevel.None;
...
function TdxEndOfDocumentCommand.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;

function TdxEndOfDocumentCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
begin
  Result := ActivePieceTable.DocumentEndLogPosition;
end;
...
function TdxEndOfDocumentCommand.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
  Result := TdxDocumentLayoutDetailsLevel.None;
...
procedure TdxExtendEndOfDocumentCommand.
  UpdateTableSelectionAfterSelectionUpdated(ALogPosition: Integer);
begin
...
function TdxExtendSelectionByRangesCommand.ChangeSelectionEnd
  ...
  AHitTestResult: TdxRichEditHitTestResult): Boolean;
begin
  if AHitTestResult.Character.GetFirstPosition(ActivePieceTable).LogPosition >= InitialLogPosition
  then
...
function TdxExtendSelectionByRangesCommand.ExtendEnd2(AHitTestResult
  : TdxRichEditHitTestResult): TdxDocumentLogPosition;
var
  AIterator: TdxPieceTableIterator;
  APos: TdxDocumentModelPosition;
begin
...
function TdxSelectAllCommand.ChangePosition(const APos
  : TdxDocumentModelPosition): Integer;
begin
  Result := APos.LogPosition;
end;
...
function TdxDeselectAllCommand.CanChangePosition
  (const APos: TdxDocumentModelPosition): Boolean;
begin
  Result := True;
end;

function TdxDeselectAllCommand.ChangePosition
  (const APos: TdxDocumentModelPosition): Integer;
begin
  Result := APos.LogPosition;
end;
...
function TdxDeselectAllCommand.
  GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
  Result := TdxDocumentLayoutDetailsLevel.None;
...
function TdxExtendSelectionByParagraphsCommand.CreateIterator
...
function TdxExtendSelectionByLinesCommand.ExtendEnd2(AHitTestResult
  : TdxRichEditHitTestResult): TdxDocumentLogPosition;
begin
...
function TdxSelectionBasedCommandBase.CalculateStartPosition
  (AItem: TdxSelectionItem; AllowSelectionExpanding: Boolean)
  : TdxDocumentModelPosition;
begin
  Result := AItem.CalculateStartPosition(AllowSelectionExpanding);
end;

function TdxSelectionBasedCommandBase.CalculateEndPosition
  (AItem: TdxSelectionItem; AllowSelectionExpanding: Boolean)
  : TdxDocumentModelPosition;
begin
...
begin
  ...
  begin
    ...
    if not ActivePieceTable.CanEditRange(AStart.LogPosition, AEnd.LogPosition)
    then
    begin
      Result := False;
      Break;
...
procedure TdxSelectionBasedPropertyChangeCommandBase.ForceExecute
  (const AState: IdxCommandUIState);
begin
  CheckExecutedAtUIThread;
...
function TdxSelectionBasedPropertyChangeCommandBase.GetSelectionItems
  : TdxSelectionItems;
begin
...
function TdxSelectionBasedPropertyChangeCommandBase.
  ActivePieceTableObtainParagraphsPropertyValue<T>(ALogPositionStart
  : TdxDocumentLogPosition; ALength: Integer;
  AModifier: TdxParagraphPropertyModifier<T>; out AValue: T): Boolean;
var
  AInfo: TdxRunInfo;
...
begin
  ...
  try
    AValue := AModifier.GetParagraphPropertyValue
      (AActivePieceTable.Paragraphs[AInfo.Start.ParagraphIndex]);
    Result := True;
    for I := AInfo.Start.ParagraphIndex + 1 to AInfo.&End.ParagraphIndex do
    begin
      AParagraphValue := AModifier.GetParagraphPropertyValue
        (AActivePieceTable.Paragraphs[I]);
...
function TdxSelectionBasedPropertyChangeCommandBase.
  ActivePieceTableObtainRunsPropertyValue<T>(const ALogPositionStart
  : TdxDocumentLogPosition; ALength: Integer;
  AModifier: TdxRunPropertyModifier<T>; out AValue: T): Boolean;
var
  AInfo: TdxRunInfo;
...
begin
  ...
  try
    Result := True;
    AValue := AModifier.GetRunPropertyValue
      (AActivePieceTable.Runs[AInfo.Start.RunIndex]);
...
function TdxTableElementAccessorBase.CoercePreferredWidth
  (AInfo: TdxWidthUnitInfo): TdxWidthUnitInfo;
begin
  if ModelColumnSpan > 0 then
    Result := TdxWidthUnitInfo.Create(TdxWidthUnitType.ModelUnits,
      Math.Max(AInfo.Value, 1))
  else
    Result := TdxWidthUnitInfo.Create(TdxWidthUnitType.Nil, 0);
end;

function TdxTableElementAccessorBase.IsRightBoundarySelected(ASelectedCells
  : TdxSelectedCellsCollection): Boolean;
begin
  Result := IsElementSelected(ASelectedCells) or
    IsNextElementSelected(ASelectedCells);
end;

function TdxTableElementAccessorBase.IsNextElementSelected(ASelectedCells
  : TdxSelectedCellsCollection): Boolean;
var
...
begin
  ...
  try
    Result := (ANextElement <> nil) and ANextElement.IsElementSelected
      (ASelectedCells);
  finally
    ANextElement.Free;
  end;
...
function TdxTableRowAccessorBase.GetVerticalSpanElements
...
constructor TdxTableElementAccessorBaseList.Create(AOwnsObjects
  : Boolean = False);
begin
  inherited Create(AOwnsObjects);
end;

function TdxTableElementAccessorBaseList.GetItem(Index: Integer)
  : TdxTableElementAccessorBase;
begin
...
procedure TdxTableCellAccessor.SetPreferredWidth(const AValue
  : TdxWidthUnitInfo);
var
...
function TdxTableCellAccessor.GetVerticalSpanElements
  : TdxTableElementAccessorBaseList;
var
  ACells: TdxTableCellList;
  ACount, I: Integer;
begin
  ACells := TdxTableCellVerticalBorderCalculator.GetVerticalSpanCells(Cell,
    GetStartColumnIndex, False);
  try
    Result := TdxTableElementAccessorBaseList.Create;
    ACount := ACells.Count;
    for I := 0 to ACount - 1 do
...
function TdxTableCellAccessor.IsElementSelected(ASelectedCells
  : TdxSelectedCellsCollection): Boolean;
begin
...
function TdxTableCellAccessor.GetMinRightBorderPosition(ATableViewInfo
  : TdxTableViewInfo): Integer;
begin
  Result := ATableViewInfo.GetAlignedPosition
    (TdxTableCellVerticalBorderCalculator.GetStartColumnIndex(Cell, True));
end;

function TdxTableCellAccessor.GetMaxRightBorderPosition(ATableViewInfo
  : TdxTableViewInfo): Integer;
var
...
function TdxTableCellAccessor.GetRightBorderPosition(ATableViewInfo
  : TdxTableViewInfo): Integer;
begin
  Result := ATableViewInfo.GetAlignedPosition
    (TdxTableCellVerticalBorderCalculator.GetStartColumnIndex(Cell, True) +
    Cell.LayoutProperties.ColumnSpan);
end;
...
procedure TdxTableRowBeforeAccessor.SetPreferredWidth
  (const AValue: TdxWidthUnitInfo);
var
  AInfo: TdxWidthUnitInfo;
begin
  AInfo := CoercePreferredWidth(AValue);
...
function TdxTableRowBeforeAccessor.IsElementSelected(ASelectedCells
  : TdxSelectedCellsCollection): Boolean;
begin
  Result := False;
end;

function TdxTableRowBeforeAccessor.GetMinRightBorderPosition(ATableViewInfo
  : TdxTableViewInfo): Integer;
begin
  Result := MinInt + 1000;
end;

function TdxTableRowBeforeAccessor.GetMaxRightBorderPosition(ATableViewInfo
  : TdxTableViewInfo): Integer;
var
  ANext: TdxTableElementAccessorBase;
begin
...
function TdxTableRowBeforeAccessor.GetRightBorderPosition(ATableViewInfo
  : TdxTableViewInfo): Integer;
var
  ANext: TdxTableElementAccessorBase;
begin
...
procedure TdxTableRowAfterAccessor.SetPreferredWidth(const AValue
  : TdxWidthUnitInfo);
var
  AInfo: TdxWidthUnitInfo;
begin
...
begin
  ...
  Result := TdxTableCellVerticalBorderCalculator.GetStartColumnIndex(ALastCell,
    False) + ALastCell.ColumnSpan;
end;

function TdxTableRowAfterAccessor.IsElementSelected(ASelectedCells
  : TdxSelectedCellsCollection): Boolean;
begin
  Result := False;
end;

function TdxTableRowAfterAccessor.GetMinRightBorderPosition(ATableViewInfo
  : TdxTableViewInfo): Integer;
var
  ALastCell: TdxTableCell;
begin
  ALastCell := Row.Cells.Last;
  Result := ATableViewInfo.GetAlignedPosition
    (TdxTableCellVerticalBorderCalculator.GetStartColumnIndex(ALastCell, True) +
    ALastCell.LayoutProperties.ColumnSpan);
end;

function TdxTableRowAfterAccessor.GetMaxRightBorderPosition(ATableViewInfo
  : TdxTableViewInfo): Integer;
begin
  Result := MaxInt - 1000;
end;

function TdxTableRowAfterAccessor.GetRightBorderPosition(ATableViewInfo
  : TdxTableViewInfo): Integer;
begin
  Result := MaxInt - 1000;
end;
