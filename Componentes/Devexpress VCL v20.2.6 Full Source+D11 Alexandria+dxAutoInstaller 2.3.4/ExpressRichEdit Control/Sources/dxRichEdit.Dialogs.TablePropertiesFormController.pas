...
type
  ...
  TdxTablePropertiesFormControllerParameters = class
  ...
  protected
    ...
    class function EqualsHeightUnits(const AValue1: TdxHeightUnitInfo;
      const AValue2: TdxHeightUnit): Boolean; overload; static;
    class function EqualsHeightUnits(const AValue1, AValue2: TdxHeightUnit)
      : Boolean; overload; static;
    class function EqualsWidthUnit(const AValue1: TdxWidthUnitInfo;
      AValue2: TdxWidthUnit): Boolean; overload; static;
    class function EqualsWidthUnit(const AValue1, AValue2: TdxWidthUnit)
      : Boolean; overload; static;
    ...
    function GetActualHeight(const AUseDefaultValue: TdxNullableBoolean;
      AHeight: Integer; const AHeightUnitType: TdxHeightUnitType)
      : TdxHeightUnitInfo;
    function GetActualWidth(const AUseDefaultValue: TdxNullableBoolean;
      AWidth: Integer; const AWidthUnitType: TdxWidthUnitType)
      : TdxWidthUnitInfo;
    ...
    function PercentToModelUnit(AWidth: Integer;
      AType: TdxWidthUnitType): Integer;

    property ValueForPercent: Integer read FPageFirstColumnWidth;
  public
    constructor Create(const AControllerParameters
      : TdxTablePropertiesFormControllerParameters);
    destructor Destroy; override;
    procedure ApplyChanges; override;
    function CalculateValue(const AWidth: TdxNullableInteger;
      const AWidthUnitType: TdxNullableValue<TdxWidthUnitType>)
      : TdxNullableInteger;
    function CalculateValueInModelUnits(const AWidth: TdxNullableInteger)
      : TdxNullableInteger;
    function CalculateValueInPercent(const AWidth: TdxNullableInteger)
      : TdxNullableInteger;
    ...
    property SourceSelectedCells: TdxSelectedCellsCollection
      read FSourceSelectedCells;

    property UseDefaultTableWidth: Boolean read FUseDefaultTableWidth
      write FUseDefaultTableWidth;
    property TableWidth: Integer read FTableWidth write FTableWidth;
    property TableWidthUnitType: TdxWidthUnitType read FTableWidthUnitType
      write FTableWidthUnitType;
    ...
    property UseDefaultRowHeight: TdxNullableBoolean read FUseDefaultRowHeight
      write FUseDefaultRowHeight;
    property RowHeight: Integer read FRowHeight write FRowHeight;
    property RowHeightType: TdxHeightUnitType read FRowHeightType
      write FRowHeightType;
    property RowCantSplit: TdxNullableBoolean read FRowCantSplit
      write FRowCantSplit;
    property RowHeader: TdxNullableBoolean read FRowHeader write FRowHeader;

    property UseDefaultColumnWidth: TdxNullableBoolean
      read FUseDefaultColumnWidth write FUseDefaultColumnWidth;
    property ColumnWidth: Integer read FColumnWidth write FColumnWidth;
    property ColumnWidthUnitType: TdxWidthUnitType read FColumnWidthUnitType
      write FColumnWidthUnitType;

    property UseDefaultCellWidth: TdxNullableBoolean read FUseDefaultCellWidth
      write FUseDefaultCellWidth;
    property CellWidth: Integer read FCellWidth write FCellWidth;
    property CellWidthUnitType: TdxWidthUnitType read FCellWidthUnitType
      write FCellWidthUnitType;
    property CellVerticalAlignment: TdxNullableValue<TdxVerticalAlignment>
      read FCellVerticalAlignment write FCellVerticalAlignment;
...
constructor TdxTablePropertiesFormControllerParameters.Create
...
var
  ...
  I: Integer;
begin
  ANewCellWidth := GetActualWidth(UseDefaultCellWidth, CellWidth,
    CellWidthUnitType);
  AIsCellWidthChanged := Assigned(ANewCellWidth) and
    IsCellWidthValueChange(ANewCellWidth);
  try
    for I := 0 to SelectedCells.Count - 1 do
    begin
      ACurrentCell := SelectedCells[I];
      if AIsCellWidthChanged and not EqualsWidthUnit(ANewCellWidth,
        ACurrentCell.PreferredWidth) then
        ACurrentCell.Properties.PreferredWidth.CopyFrom(ANewCellWidth);
      if not CellVerticalAlignment.IsNull and
        (ACurrentCell.VerticalAlignment <> CellVerticalAlignment) then
        ACurrentCell.Properties.VerticalAlignment :=
...
var
  ...
  I: Integer;
begin
  ANewCellWidth := GetActualWidth(UseDefaultColumnWidth, ColumnWidth,
    ColumnWidthUnitType);
  try
...
var
  ...
  I: Integer;
begin
  ANewRowHeight := GetActualHeight(UseDefaultRowHeight, RowHeight,
    RowHeightType);
  try
    ...
    try
      ...
      begin
        ...
        if Assigned(ANewRowHeight) and not EqualsHeightUnits(ANewRowHeight,
          ACurrentRow.Height) then
          ACurrentRowProperties.Height.CopyFrom(ANewRowHeight);
        if not RowCantSplit.IsNull and (ACurrentRow.CantSplit <> RowCantSplit)
        then
...
begin
  if TableAlignment.IsNull or (TableAlignment.Value <> TdxTableRowAlignment.Left)
  then
    ANewTableIndent := TdxWidthUnitInfo.Create(TdxWidthUnitType.ModelUnits, 0)
  else
    ANewTableIndent := TdxWidthUnitInfo.Create(TdxWidthUnitType.ModelUnits,
      TableIndent);
  try
...
begin
  ANewTableWidth := GetActualWidth(UseDefaultTableWidth, TableWidth,
    TableWidthUnitType);
  try
...
begin
  ...
  AFirstCellLogPosition := ADocumentModel.ActivePieceTable.Paragraphs
  ...
  try
    ...
    try
      APageClientBounds := APageBoundsCalculator.CalculatePageClientBounds
        (ASection);
      AColumnsBoundsCalculator := TdxColumnsBoundsCalculator.Create(AConverter);
      try
        AColumnWidthsCollection := AColumnsBoundsCalculator.Calculate(ASection,
          APageClientBounds);
        try
...
function TdxTablePropertiesFormController.CalculateValue
  (const AWidth: TdxNullableInteger;
...
begin
  ...
  else if AWidthUnitType.Value = TdxWidthUnitType.FiftiethsOfPercent then
...
function TdxTablePropertiesFormController.CalculateValueInPercent
  (const AWidth: TdxNullableInteger): TdxNullableInteger;
begin
...
constructor TdxTablePropertiesFormController.Create(const AControllerParameters
  : TdxTablePropertiesFormControllerParameters);
begin
  inherited Create;
...
class function TdxTablePropertiesFormController.EqualsHeightUnits(const AValue1,
  AValue2: TdxHeightUnit): Boolean;
begin
  Result := (AValue1.Value = AValue2.Value) and (AValue1.&Type = AValue2.&Type);
end;

class function TdxTablePropertiesFormController.EqualsWidthUnit
  (const AValue1: TdxWidthUnitInfo; AValue2: TdxWidthUnit): Boolean;
begin
  Result := (AValue1.Value = AValue2.Value) and (AValue1.&Type = AValue2.&Type);
end;

class function TdxTablePropertiesFormController.EqualsHeightUnits
  (const AValue1: TdxHeightUnitInfo; const AValue2: TdxHeightUnit): Boolean;
begin
  Result := (AValue1.Value = AValue2.Value) and (AValue1.&Type = AValue2.&Type);
end;

class function TdxTablePropertiesFormController.EqualsWidthUnit(const AValue1,
  AValue2: TdxWidthUnit): Boolean;
begin
  Result := (AValue1.Value = AValue2.Value) and (AValue1.&Type = AValue2.&Type);
end;

function TdxTablePropertiesFormController.GetActualHeight(const AUseDefaultValue
  : TdxNullableBoolean; AHeight: Integer;
...
function TdxTablePropertiesFormController.GetActualWidth(const AUseDefaultValue
  : TdxNullableBoolean; AWidth: Integer; const AWidthUnitType: TdxWidthUnitType)
  : TdxWidthUnitInfo;
begin
  if AUseDefaultValue.IsNull then
    Exit(nil);
  if AUseDefaultValue.Value then
    ...
    Result := TdxWidthUnitInfo.Create(AWidthUnitType,
      PercentToModelUnit(AWidth, AWidthUnitType));
end;

function TdxTablePropertiesFormController.GetCellsInSelectedColumns
  : TdxTableCellList;
var
...
begin
  ...
  AStartColumnIndex := AFirstSelectedRow.NormalizedStartCell.
    GetStartColumnIndexConsiderRowGrid;
  AEndColumnIndex := AFirstSelectedRow.NormalizedEndCell.
  ...
  begin
    ...
    ACells := TdxTableCellVerticalBorderCalculator.GetCellsByIntervalColumnIndex
      (ACurrentRow, AStartColumnIndex, AEndColumnIndex);
    try
...
function TdxTablePropertiesFormController.
  GetCellWidthMaxValueConsiderWidthUnitType: Integer;
begin
  if CellWidthUnitType = TdxWidthUnitType.FiftiethsOfPercent then
    ...
    Result := TdxRichEditTablePropertiesHelper.
      MaxCellWidthInModelUnitsByDefault;
end;

function TdxTablePropertiesFormController.
  GetColumnWidthMaxValueConsiderWidthUnitType: Integer;
begin
...
function TdxTablePropertiesFormController.GetTableAlignment
...
begin
  ...
  Result := IfThen(ATableIndent.&Type = TdxWidthUnitType.ModelUnits,
    ATableIndent.Value);
end;

function TdxTablePropertiesFormController.
  GetTableWidthMaxValueConsiderWidthUnitType: Integer;
begin
...
begin
  ...
  begin
    ACurrentCell := SelectedCells[I];
    AIdenticalCellWidth := AIdenticalCellWidth and
      EqualsWidthUnit(AFirstCellWidth, ACurrentCell.PreferredWidth);
    AIdenticalVerticalAlignment := AIdenticalVerticalAlignment and
      (AFirstCellVerticalAlignment = ACurrentCell.VerticalAlignment);
  end;

  UseDefaultCellWidth := TdxNullableBoolean.IfThen(AIdenticalCellWidth,
    AFirstCellWidth.&Type = TdxWidthUnitType.Auto);
  CellWidth := ModelUnitToPercent(AFirstCellWidth);
  CellWidthUnitType := AFirstCellWidth.&Type;
  FOldCellWidth := TdxWidthUnitInfo.Create(CellWidthUnitType,
    AFirstCellWidth.Value);

  CellVerticalAlignment := TdxNullableValue<TdxVerticalAlignment>.IfThen
    (AIdenticalVerticalAlignment, AFirstCellVerticalAlignment);
end;
...
begin
  ...
  begin
    AIdenticalCellWidth := EqualsWidthUnit(AFirstCellWidth,
      FCellsInSelectedColumns[I].PreferredWidth);
    if not AIdenticalCellWidth then
      Break;
  end;
  UseDefaultColumnWidth := TdxNullableBoolean.IfThen(AIdenticalCellWidth,
    AFirstCellWidth.&Type = TdxWidthUnitType.Auto);
...
var
  ASelectedRows: TdxTableRowList;
  AIdenticalCantSplit, AIdenticalHeader, AIdenticalRowHeight,
    AFirstRowCantSplit, AFirstRowHeader: Boolean;
...
begin
  ...
  try
    ...
    begin
      ACurrentRow := ASelectedRows[I];
      AIdenticalCantSplit := AIdenticalCantSplit and
        (AFirstRowCantSplit = ACurrentRow.CantSplit);
      AIdenticalHeader := AIdenticalHeader and
        (AFirstRowHeader = ACurrentRow.Header);
      AIdenticalRowHeight := AIdenticalRowHeight and
        EqualsHeightUnits(AFirstRowHeight, ACurrentRow.Height);
    end;
  finally
    ASelectedRows.Free;
  end;
  ...
  RowCantSplit := TdxNullableBoolean.IfThen(AIdenticalCantSplit,
    AFirstRowCantSplit);
...
begin
  ...
  UseDefaultTableWidth := (ATableWidth.&Type = TdxWidthUnitType.Auto) or
    (ATableWidth.&Type = TdxWidthUnitType.&Nil);
...
function TdxTablePropertiesFormController.IsCellWidthValueChange
  (ACellWidth: TdxWidthUnitInfo): Boolean;
var
...
function TdxTablePropertiesFormController.ModelUnitToPercent
  (AWidth: TdxWidthUnit): Integer;
begin
...
function TdxTablePropertiesFormController.PercentToModelUnit(AWidth: Integer;
  AType: TdxWidthUnitType): Integer;
begin
