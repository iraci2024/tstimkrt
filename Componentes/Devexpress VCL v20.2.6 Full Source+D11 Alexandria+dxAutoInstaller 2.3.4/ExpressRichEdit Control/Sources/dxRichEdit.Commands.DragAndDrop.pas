...
type
  ...
  protected
    ...
    procedure UpdateUIStateCore(const AState: IdxCommandUIState;
      ACanDropOnSelection: Boolean); reintroduce;
  ...
  public
    constructor Create(const AControl: IdxRichEditControl;
      ATargetPosition: PdxDocumentModelPosition); reintroduce; virtual;
  ...
  protected
    ...
    procedure SetSelection(ASelection: TdxSelection;
      const AStart: TdxDocumentLogPosition);
  public
    constructor Create(const AControl: IdxRichEditControl;
...
constructor TdxDragMoveContentCommandBase.Create(const AControl
  : IdxRichEditControl; ATargetPosition: PdxDocumentModelPosition);
begin
...
function TdxDragMoveContentCommandBase.CreateCopyContentCommand
...
function TdxDragMoveContentCommandBase.GetExecutionMode
...
begin
  ...
  begin
    ...
    ACanExecute := (AOffset < 0) or (AOffset > ASelection.Length) or
      (ASelection.Length <= 0);
...
function TdxDragMoveContentCommandBase.GetUpdateUIStateMode
...
constructor TdxDragCopyExternalContentCommand.Create(const AControl
  : IdxRichEditControl; ATargetPosition: PdxDocumentModelPosition;
...
function TdxDragCopyExternalContentCommand.CreateCopyContentCommand
  : TdxCopyAndSaveContentCommand;
begin
  Result := nil;
end;

function TdxDragCopyExternalContentCommand.CreatePasteContentCommand
  : TdxCommand;
begin
