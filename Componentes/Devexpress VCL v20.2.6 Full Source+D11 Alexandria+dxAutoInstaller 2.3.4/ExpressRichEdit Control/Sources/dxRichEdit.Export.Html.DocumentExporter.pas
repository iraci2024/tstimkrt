...
function TdxHtmlDocumentExporter.FormatEquals(const AValue
...
function TdxHtmlDocumentExporter.SaveDocument(const ADocumentModel
...
begin
  AModel.InternalAPI.SaveDocumentHtmlContent(AStream,
    TdxHtmlDocumentExporterOptions(AOptions));
  Result := True;
end;
