...
type
  ...
  strict private
    ...
    FCopiedProperties: TDictionary<TdxTableCellProperties,
  ...
  protected
    procedure ProcessTableCore(ANode: TdxTableCellNode;
      ATargetParentCell: TdxTableCell; AParagraphIndexOffset: Integer;
      ARunInfo: TdxRunInfo);
    function IsOneCellCopying(ARoot: TdxTableCellNode): Boolean;
    function GetTargetCell(ARoot: TdxTableCellNode;
    ...
    property TableCopyState: TdxTableCopyInfo read GetTableCopyState
      write SetTableCopyState;
  public
    constructor Create(AOwner: TdxDocumentModelCopyManager);
    destructor Destroy; override;
    function CreateTable(APieceTable: TdxPieceTable;
      ATargetParentCell: TdxTableCell; ASourceCell: TdxTableCell): TdxTable;
    procedure CreateRow(ATable: TdxTable;
      ASourceRowProperties: TdxTableRowProperties;
      ASourceTablePropertiesException: TdxTableProperties);
    function CreateCell(AStartCellParagraphIndex: TdxParagraphIndex;
      AEndParagraphIndex: TdxParagraphIndex; ASourceCell: TdxTableCell)
      : TdxTableCell;
    ...
    property SuppressCopyTables: Boolean read FSuppressCopyTables
      write FSuppressCopyTables;
    property LastSourceTable: TdxTable read GetLastSourceTable
      write SetLastSourceTable;
    property LastSourceRow: TdxTableRow read GetLastSourceRow
      write SetLastSourceRow;
    property LastTargetTable: TdxTable read GetLastTargetTable
      write SetLastTargetTable;
    property LastSourceCell: TdxTableCell read GetLastSourceCell
      write SetLastSourceCell;
    ...
    property TargetStartParagraphIndex: TdxParagraphIndex
      read FTargetStartParagraphIndex write FTargetStartParagraphIndex;
    property CopyFromNestedLevel: Integer read FCopyFromNestedLevel
      write FCopyFromNestedLevel;
  end;
  ...
  strict private
    ...
    function GetTargetPieceTable: TdxPieceTable;
  public
    constructor Create(ASourcePieceTable, ATargetPieceTable
      : TdxCustomPieceTable; AParagraphNumerationCopyOptions
      : TdxParagraphNumerationCopyOptions;
      AFormattingCopyOptions: TdxFormattingCopyOptions =
      TdxFormattingCopyOptions.UseDestinationStyles); reintroduce; virtual;
    destructor Destroy; override;

    procedure OnTargetSectionInserted(ASourceSection, ATargetSection
      : TdxSection);
  ...
  private
    ...
    procedure ProcessSectionHeadCore(AInfo: TdxRunInfo;
  ...
  protected
    ...
    function ShouldProcessContentInSameParent(AInfo: TdxRunInfo)
      : Boolean; override;
    function ShouldProcessRunParent(AInfo: TdxRunInfo): Boolean; override;
    procedure ProcessRunParent(AInfo: TdxRunInfo;
      ADocumentLastParagraphSelected: Boolean); override;
    procedure ProcessContentInsideParent(AInfo: TdxRunInfo;
      AAllowMergeWithNextParagraph, ADocumentLastParagraphSelected
      : Boolean); override;
    function ProcessContentSameParent(AInfo: TdxRunInfo;
      AAllowMergeWithNextParagraph: Boolean;
      ADocumentLastParagraphSelected: Boolean): Boolean; override;
    function ProcessHead(AInfo: TdxRunInfo;
      ADocumentLastParagraphSelected: Boolean): Integer; override;
    function ProcessMiddle(AInfo: TdxRunInfo; AParagraphCount: Integer;
      ADocumentLastParagraphSelected: Boolean): Boolean; override;
    function ProcessTail(AInfo: TdxRunInfo;
      ADocumentLastParagraphSelected: Boolean): Integer; override;

    function CreateBookmarkCopyOperation
      : TdxCopySectionOperation { TdxCopyBookmarksOperation }; virtual;
    function CreateSectionCopy(ASourceSection: TdxSection): TdxSection;
    function IsTargetSectionLast: Boolean;
    procedure ProcessSections(AStartSectionIndex: TdxSectionIndex;
      ASectionCount: Integer);
    procedure ProcessSectionsCore(AIndex: TdxSectionIndex);
    function ShouldCopySection(ASourceSection, ATargetSection
      : TdxSection): Boolean;
    function TryCopyLastSection(AInfo: TdxRunInfo;
  ...
  public
    ...
    property ShouldCopyBookmarks: Boolean read FShouldCopyBookmarks
      write FShouldCopyBookmarks;
    ...
    property SuppressJoinTables: Boolean read FSuppressJoinTables
      write FSuppressJoinTables;
  ...
  strict private
    ...
    function ParagraphContentIsNumberingRunOnly
  ...
  protected
    ...
    procedure ProcessContentInsideParent(AInfo: TdxRunInfo;
      AAllowMergeWithNextParagraph, ADocumentLastParagraphSelected
      : Boolean); override;
    procedure ProcessContentCrossParent(AInfo: TdxRunInfo;
      ADocumentLastParagraphSelected: Boolean); override;
    function ProcessHead(AInfo: TdxRunInfo;
      ADocumentLastParagraphSelected: Boolean): Integer; override;
    function ProcessMiddle(AInfo: TdxRunInfo; AParagraphCount: Integer;
      ADocumentLastParagraphSelected: Boolean): Boolean; override;
    procedure ProcessNumberingRun(AParagraph: TdxParagraph;
      AUseFirstParagraphStyle: Boolean);
    procedure ProcessParagraphsCore(AStartParagraphIndex: TdxParagraphIndex;
      ACount: Integer);
    procedure ProcessParagraphs(AStartParagraphIndex: TdxParagraphIndex;
      ACount: Integer);
    procedure ProcessRunParent(AInfo: TdxRunInfo;
      ADocumentLastParagraphSelected: Boolean); override;
    function ProcessTail(AInfo: TdxRunInfo;
    ...
    function DeleteRunsInsideParagraphCore(AInfo: TdxRunInfo;
      AAllowMergeWithNextParagraph: Boolean): Boolean;
    ...
    function IsNeedJoinTables(ATopParagraphIndex, ABottomParagraphIndex
      : TdxParagraphIndex): Boolean;
    ...
    procedure ProcessContentCrossParentCore(AInfo: TdxRunInfo;
      ADocumentLastParagraphSelected: Boolean);

    function ProcessMiddleTable(AInfo: TdxRunInfo;
      AParagraphCount: Integer): Boolean;
    procedure ProcessTable(AInfo: TdxRunInfo;
      ADocumentLastParagraphSelected: Boolean); virtual;
    procedure ProcessContentCrossParentTable(AInfo: TdxRunInfo;
      ADocumentLastParagraphSelected: Boolean); virtual;
    procedure ProcessParagraphsInTable(AStartParagraphIndex: TdxParagraphIndex;
      ACount: Integer); virtual;

    property IsProcessContentCrossParentExecute: Boolean
      read FIsProcessContentCrossParentExecute;
    property IsDeletedSomeSections: Boolean read FIsDeletedSomeSections
      write FIsDeletedSomeSections;
  public
    property AllowedDeleteLastParagraphInTableCell: Boolean
      read FAllowedDeleteLastParagraphInTableCell
      write FAllowedDeleteLastParagraphInTableCell;
  ...
  private
    ...
    procedure DeleteTail(AInfo: TdxRunInfo; AEndSection: TdxSection;
      ADocumentLastParagraphSelected: Boolean);
  protected
    function ShouldProcessContentInSameParent(AInfo: TdxRunInfo)
      : Boolean; override;
    ...
    procedure ProcessSections(AStartSectionIndex: TdxSectionIndex;
      ACount: Integer); virtual;
    procedure DeleteAllParagraphsInsideSection(AStartSectionIndex,
      AEndSectionIndex: TdxSectionIndex); virtual;
  public
    property DocumentModel: TdxDocumentModel read GetDocumentModel;
    property PieceTable: TdxPieceTable read GetPieceTable;
  end;
  ...
  strict private
    ...
    function GetPieceTable: TdxPieceTable;
  protected
    procedure ExecuteCore(ARunInfo: TdxRunInfo;
      ADocumentLastParagraphSelected: Boolean); override;
    procedure DeleteFieldsWithinInterval(ARunInfo: TdxRunInfo); virtual;
    function CalculateDeletedFields(ARunInfo: TdxRunInfo)
      : TdxFieldList; virtual;
    function CreateDeleteContentOperation: TdxSelectionBasedOperation; override;
    function IsFieldWithinInterval(ARunInfo: TdxRunInfo; AField: TdxField)
      : Boolean; virtual;
    function IsParentShouldBeRemoved(AField: TdxField; ARunInfo: TdxRunInfo)
      : Boolean; virtual;
    function IsFieldHidByParent(AField: TdxField): Boolean; virtual;
    procedure DeleteContentWithFieldsCore(const AStart,
  ...
  TdxCanDeleteBookmarkDelegate = function(AStart, AEnd: TdxDocumentLogPosition;
    ABookmark: TdxBookmarkBase): Boolean of object;
  ...
  protected
    ...
    function ShouldDeleteBookmark(AStart, AEnd: TdxDocumentLogPosition;
      ABookmark: TdxBookmarkBase): Boolean; virtual;
    function CanDeleteRangePermission(AStart: TdxDocumentLogPosition;
      AEnd: TdxDocumentLogPosition; ABookmark: TdxBookmarkBase)
      : Boolean; virtual;
    function CreateDeleteContentOperation: TdxSelectionBasedOperation; override;
    function DeleteFields(ARunInfo: TdxRunInfo;
      ADocumentLastParagraphSelected: Boolean): Boolean; virtual;
    procedure ExecuteCore(ARunInfo: TdxRunInfo;
      ADocumentLastParagraphSelected: Boolean); override;
  public
    property SuppressFieldDelete: Boolean read FSuppressFieldDelete
      write FSuppressFieldDelete;
...
type
  ...
  public
    constructor Create(ADocumentLastParagraphSelected: Boolean;
      AIsDeletedSomeSections: Boolean; ABackspacePressed: Boolean);

    property DocumentLastParagraphSelected: Boolean
      read FDocumentLastParagraphSelected write FDocumentLastParagraphSelected;
    property IsDeletedSomeSections: Boolean read FIsDeletedSomeSections
      write FIsDeletedSomeSections;
    property BackspacePressed: Boolean read FBackspacePressed
      write FBackspacePressed;
  end;
  ...
  public
    class function IsDeleteParagraphsInTable(AInfo: TdxRunInfo;
      ADocumentLastParagraphSelected: Boolean; AIsDeletedSomeSections: Boolean)
      : Boolean; static;
    class function IsSelectedEntireTableRows(AInfo: TdxRunInfo;
      AOptions: TdxDeleteTablesOptions): Boolean; static;
    class procedure GetSelectedRowsCore(ACurrent: TdxTableCellNode;
      AInfo: TdxRunInfo; AResult: TdxTableRowList); static;
    class function IsSelectedEntireTableRow(ARow: TdxTableRow;
      AInfo: TdxRunInfo): Boolean; static;
    class function GetSelectedRows(AInfo: TdxRunInfo): TdxTableRowList; static;
    class procedure DeleteSelectedTableRows(AInfo: TdxRunInfo;
      AOptions: TdxDeleteTablesOptions); overload; static;
    class procedure DeleteSelectedTableRows(ASelectedRows: TdxTableRowList);
      overload; static;
  end;

  { TdxDeleteTablesOptions }

constructor TdxDeleteTablesOptions.Create(ADocumentLastParagraphSelected
  : Boolean; AIsDeletedSomeSections: Boolean; ABackspacePressed: Boolean);
begin
  inherited Create;
...
class function TdxDeleteTablesHelper.IsDeleteParagraphsInTable
  (AInfo: TdxRunInfo; ADocumentLastParagraphSelected: Boolean;
  AIsDeletedSomeSections: Boolean): Boolean;
var
...
begin
  ...
  ARoot := APieceTable.TableCellsManager.GetCellSubTree
    (AInfo.Start.ParagraphIndex, AInfo.&End.ParagraphIndex, 0);
  try
...
class function TdxDeleteTablesHelper.IsSelectedEntireTableRows
  (AInfo: TdxRunInfo; AOptions: TdxDeleteTablesOptions): Boolean;
var
  APieceTable: TdxPieceTable;
...
begin
  ...
  if ((((AStartCell <> nil) and (AEndCell <> nil)) and
    (AStartCell.Table = AEndCell.Table)) and
    not AOptions.DocumentLastParagraphSelected) and not AOptions.IsDeletedSomeSections
  then
    Exit(False);
  AInfoEndRunIndex := AInfo.NormalizedEnd.RunIndex;
  AInfoStartRunIndex := AInfo.NormalizedStart.RunIndex;
  if AStartCell <> nil then
    ASelectWhollyFirstCell := AStartCell.IsFirstCellInRow and
      (AParagraphs[AStartCell.StartParagraphIndex]
      .FirstRunIndex = AInfoStartRunIndex)
  else
    ASelectWhollyFirstCell := False;
  if AEndCell <> nil then
    ASelectWhollyLastCell := AEndCell.IsLastCellInRow and
      (AParagraphs[AEndCell.EndParagraphIndex].LastRunIndex = AInfoEndRunIndex)
  else
    ASelectWhollyLastCell := False;
  ADifferentTable := ((AStartCell <> nil) and (AEndCell <> nil)) and
  ...
  if ((AEndCell = nil) or (ADifferentTable)) and ASelectWhollyFirstCell then
    Exit(True);
  if (((AStartCell <> nil) and (AEndCell <> nil)) and ASelectWhollyFirstCell)
    and ASelectWhollyLastCell then
    Exit(True);
  Result := False;
end;

class procedure TdxDeleteTablesHelper.GetSelectedRowsCore
  (ACurrent: TdxTableCellNode; AInfo: TdxRunInfo; AResult: TdxTableRowList);
var
  I: Integer;
...
class function TdxDeleteTablesHelper.IsSelectedEntireTableRow(ARow: TdxTableRow;
  AInfo: TdxRunInfo): Boolean;
var
...
begin
  ...
  if (ARowStartRunIndex >= AInfo.NormalizedStart.RunIndex) and
    (ARowEndRunIndex <= AInfo.NormalizedEnd.RunIndex) then
    Exit(True);
  Result := False;
end;

class function TdxDeleteTablesHelper.GetSelectedRows(AInfo: TdxRunInfo)
  : TdxTableRowList;
var
  ARoot: TdxTableCellNode;
begin
  Result := TdxTableRowList.Create;
  ARoot := TdxPieceTable(AInfo.&End.PieceTable).TableCellsManager.GetCellSubTree
    (AInfo.NormalizedStart.ParagraphIndex,
    AInfo.NormalizedEnd.ParagraphIndex, -1);
  try
...
class procedure TdxDeleteTablesHelper.DeleteSelectedTableRows(AInfo: TdxRunInfo;
  AOptions: TdxDeleteTablesOptions);
var
  ASelectedRows: TdxTableRowList;
  ATable: TdxTable;
begin
  if not IsSelectedEntireTableRows(AInfo, AOptions) and not AOptions.BackspacePressed
  then
    Exit;
...
class procedure TdxDeleteTablesHelper.DeleteSelectedTableRows
  (ASelectedRows: TdxTableRowList);
var
  APieceTable: TdxPieceTable;
  I: Integer;
...
begin
  ...
  begin
    ...
    APieceTable.DeleteEmptyTableRowCore(ACurrentRow.Table.Index,
      ACurrentRow.IndexInTable);
  end;
end;
...
function TdxTableCopyHelper.CreateTable(APieceTable: TdxPieceTable;
  ATargetParentCell: TdxTableCell; ASourceCell: TdxTableCell): TdxTable;
begin
...
procedure TdxTableCopyHelper.CreateRow(ATable: TdxTable;
  ASourceRowProperties: TdxTableRowProperties;
  ASourceTablePropertiesException: TdxTableProperties);
var
...
begin
  ...
  ALastTargetRow.TablePropertiesException.CopyFrom
    (ASourceTablePropertiesException);
end;

function TdxTableCopyHelper.CreateCell(AStartCellParagraphIndex
  : TdxParagraphIndex; AEndParagraphIndex: TdxParagraphIndex;
  ASourceCell: TdxTableCell): TdxTableCell;
begin
  Result := TargetPieceTable.CreateTableCellCore(LastTargetTable.LastRow,
    AStartCellParagraphIndex, AEndParagraphIndex);
...
begin
  if not TargetModel.DocumentCapabilities.TablesAllowed or
    not TargetModel.DocumentCapabilities.ParagraphsAllowed then
    Exit;
  AStart := ASourceRunInfo.NormalizedStart.ParagraphIndex;
  AEnd := ASourceRunInfo.NormalizedEnd.ParagraphIndex;
  AParagraphIndexOffset := ASourceRunInfo.NormalizedStart.ParagraphIndex -
    TargetStartParagraphIndex;
  ARoot := SourcePieceTable.TableCellsManager.GetCellSubTree(AStart, AEnd,
    CopyFromNestedLevel);
  try
...
begin
  if (ANode = nil) or (ANode.ChildNodes = nil) or (ANode.ChildNodes.Count = 0)
  then
    Exit;
  ...
  try
    ...
    begin
      ...
      begin
        ProcessTableCore(ANode.ChildNodes[I], ATargetParentCell,
          AParagraphIndexOffset, ARunInfo);
        Continue;
      end;
      ...
      if IsNewTable(ANode.ChildNodes[I].Cell.Table) then
        LastTargetTable := CreateTable(TargetPieceTable, ATargetParentCell,
          ANode.ChildNodes[I].Cell);
      ASourceCell := ANode.ChildNodes[I].Cell;
      if IsNewRow(ASourceCell.Row) then
      begin
        LastSourceRow := ASourceCell.Row;
        CreateRow(LastTargetTable, LastSourceRow.Properties,
          LastSourceRow.TablePropertiesException);
      end;
      ...
      ProcessTableCore(ANode.ChildNodes[I], ANewTargetCell,
        AParagraphIndexOffset, ARunInfo);
    end;
  finally
    if ATargetParentCell <> nil then
...
begin
  if (ARoot = nil) or (ARoot.ChildNodes = nil) or (ARoot.ChildNodes.First = nil)
    or (ARoot.ChildNodes.First.Cell = nil) then
    Exit(nil);
  ATargetStart := ARoot.ChildNodes.First.Cell.StartParagraphIndex -
    AParagraphIndexOffset;
...
function TdxTableCopyHelper.CopyCellAllowed(ACell: TdxTableCell;
  AInfo: TdxRunInfo): Boolean;
var
  AParagraphs: TdxParagraphCollection;
...
begin
  ...
  AStartParagraphFirstRunIndex := AParagraphs[ACell.StartParagraphIndex]
    .FirstRunIndex;
  AEndParagraphLastRunIndex := AParagraphs[ACell.EndParagraphIndex]
    .LastRunIndex;
  Result := (AInfo.Start.RunIndex <= AStartParagraphFirstRunIndex) and
    (AInfo.&End.RunIndex >= AEndParagraphLastRunIndex);
end;
...
constructor TdxDocumentModelCopyManager.Create(ASourcePieceTable,
  ATargetPieceTable: TdxCustomPieceTable;
  AParagraphNumerationCopyOptions: TdxParagraphNumerationCopyOptions;
  AFormattingCopyOptions: TdxFormattingCopyOptions = TdxFormattingCopyOptions.
  UseDestinationStyles);
begin
  inherited Create(ASourcePieceTable, ATargetPieceTable,
...
procedure TdxDocumentModelCopyManager.OnTargetSectionInserted(ASourceSection,
...
begin
  ATargetSectionLastRunIndex := TargetPieceTable.Paragraphs
    [ATargetSection.LastParagraphIndex].LastRunIndex;
  ASourceSectionLastRunIndex := SourcePieceTable.Paragraphs
    [ASourceSection.LastParagraphIndex].LastRunIndex;
  FTargetPosition.ParagraphIndex := FTargetPosition.ParagraphIndex + 1;
  ATargetRun := TdxParagraphRun(TargetPieceTable.Runs
    [ATargetSectionLastRunIndex]);
  ASourceRun := TdxParagraphRun(SourcePieceTable.Runs
    [ASourceSectionLastRunIndex]);
...
constructor TdxCopySectionOperation.Create(ACopyManager
  : TdxDocumentModelCopyManager);
begin
...
function TdxCopySectionOperation.CreateBookmarkCopyOperation
  : TdxCopySectionOperation { TdxCopyBookmarksOperation };
begin
...
begin
  ...
  for I := ATransaction.Items.Count -
    1 downto FTransactionItemCountBeforeExecute do
  begin
...
begin
  ...
  try
    ...
    try
      if SourceAndTargetModelAreDifferent and not SourceModel.IntermediateModel
      then
        TargetModel.CalculateDocumentVariable.Add
          (AEventRouter.OnCalculateDocumentVariable);
      AOperation := TdxCopyFieldsOperation.Create(SourcePieceTable,
        TargetPieceTable);
      try
        ...
        if CopyManager.ParagraphWasInsertedBeforeTable or IsMergingTableCell
        then
        begin
        ...
        begin
          ABookmarksCopier := TdxCopyBookmarksOperation
            (CreateBookmarkCopyOperation);
          try
            ABookmarksCopier.CopyBookmarksToTargetModel(AInfo,
              APositionToInsert);
        ...
        begin
          if FUnfinishedCopyOperations = nil then
            FUnfinishedCopyOperations :=
              TdxObjectList<TdxCopyFieldsOperation>.Create;
      ...
      if SourceAndTargetModelAreDifferent and not SourceModel.IntermediateModel
      then
        TargetModel.CalculateDocumentVariable.Remove
          (AEventRouter.OnCalculateDocumentVariable);
    end;
  finally
...
function TdxCopySectionOperation.ShouldProcessContentInSameParent
  (AInfo: TdxRunInfo): Boolean;
var
...
begin
  ...
  begin
    AStartSectionIndex := SourcePieceTable.LookupSectionIndexByParagraphIndex
      (AInfo.Start.ParagraphIndex);
    AEndSectionIndex := SourcePieceTable.LookupSectionIndexByParagraphIndex
      (AInfo.&End.ParagraphIndex);
    ASection := SourceModel.Sections[AStartSectionIndex];
    AStartParagraph := SourcePieceTable.Paragraphs
      [ASection.FirstParagraphIndex];
...
function TdxCopySectionOperation.ShouldProcessRunParent
  (AInfo: TdxRunInfo): Boolean;
var
  AEnd: TdxDocumentModelPosition;
...
begin
  ...
  begin
    AEnd := AInfo.&End;
    ASectionIndex := SourcePieceTable.LookupSectionIndexByParagraphIndex
      (AInfo.Start.ParagraphIndex);
    ASection := SourceModel.Sections[ASectionIndex];
    AEndRun := SourcePieceTable.Runs[AEnd.RunIndex];
    ALastSectionRun := SourcePieceTable.Paragraphs[ASection.LastParagraphIndex]
      .LastRunIndex;
...
begin
  ...
  begin
    ...
    ASelectionContentInfo := SourcePieceTable.ObtainAffectedRunInfo
      (AInfo.Start.LogPosition, AInfo.&End.LogPosition -
      AInfo.Start.LogPosition);
    try
      ProcessContentInsideParent(ASelectionContentInfo, True,
...
procedure TdxCopySectionOperation.ProcessContentInsideParent(AInfo: TdxRunInfo;
...
begin
  CopyManager.TableCopyHelper.TargetStartParagraphIndex :=
    CopyManager.TargetPosition.ParagraphIndex;
...
function TdxCopySectionOperation.ProcessContentSameParent(AInfo: TdxRunInfo;
  ...
  : Boolean): Boolean;
begin
  if not SourceModel.FieldResultModel and TryCopyLastSection(AInfo,
    ADocumentLastParagraphSelected) then
  begin
    ProcessContentInsideParent(AInfo, True, False);
    Result := True
  end
  else
    Result := inherited ProcessContentSameParent(AInfo,
      AAllowMergeWithNextParagraph, ADocumentLastParagraphSelected);
end;
...
begin
  ...
  if SourcePieceTable.Paragraphs[ASection.FirstParagraphIndex]
    .FirstRunIndex = AInfo.Start.RunIndex then
    Result := ASectionCount
  else
  begin
    ProcessSectionHeadCore(AInfo, AStartSectionIndex,
      ADocumentLastParagraphSelected);
    Result := ASectionCount - 1;
  end;
end;

function TdxCopySectionOperation.ProcessMiddle(AInfo: TdxRunInfo;
...
begin
  ...
  ALastRunIndex := SourcePieceTable.Paragraphs
    [SourceModel.Sections[AEndSectionIndex].LastParagraphIndex].LastRunIndex;

  if (AInfo.&End.RunIndex = ALastRunIndex) and
    (ALastRunIndex <> SourcePieceTable.Runs.Count - 1) then
  begin
...
begin
  ASectionIndex := SourcePieceTable.LookupSectionIndexByParagraphIndex
    (AInfo.&End.ParagraphIndex);
  AStartLogPosition := SourcePieceTable.Paragraphs
    [SourceModel.Sections[ASectionIndex].FirstParagraphIndex].LogPosition;
  TryCopyLastSection(AInfo, ADocumentLastParagraphSelected);
  ASelectionContentInfo := SourcePieceTable.ObtainAffectedRunInfo
    (AStartLogPosition, AInfo.&End.LogPosition - AStartLogPosition + 1);
  try
...
function TdxCopySectionOperation.CreateSectionCopy(ASourceSection: TdxSection)
  : TdxSection;
begin
...
begin
  ATargetSectionIndex := TargetPieceTable.LookupSectionIndexByParagraphIndex
...
var
  ...
  ACell: TdxTableCell;
begin
  ASourceFirstCell := SourcePieceTable.Paragraphs
    [ARunInfo.NormalizedStart.ParagraphIndex].GetCell;
  if ASourceFirstCell = nil then
    Exit;

  ATargetStartParagraphIndex :=
    CopyManager.TableCopyHelper.TargetStartParagraphIndex;
  if ATargetStartParagraphIndex = 0 then
    Exit;

  APreviousTargetCell := TargetPieceTable.Paragraphs
    [ATargetStartParagraphIndex - 1].GetCell;
  if APreviousTargetCell = nil then
    Exit;

  APreviousTargetTable := APreviousTargetCell.Table;
  ACell := TargetPieceTable.Paragraphs
    [APreviousTargetTable.LastRow.LastCell.EndParagraphIndex + 1].GetCell;
  if (ACell = nil) or (APreviousTargetTable.NestedLevel <>
    ACell.Table.NestedLevel) then
    Exit;

  TargetPieceTable.JoinTables(APreviousTargetTable, ACell.Table);
end;

procedure TdxCopySectionOperation.ProcessSections(AStartSectionIndex
  : TdxSectionIndex; ASectionCount: Integer);
var
...
begin
  ...
  AStartLogPosition := SourcePieceTable.Paragraphs[ASection.FirstParagraphIndex]
    .LogPosition;
  AEndLogPosition := SourcePieceTable.Paragraphs[ASection.LastParagraphIndex]
    .EndLogPosition;
  if AEndLogPosition <> AStartLogPosition then
  begin
    ASelectionContentInfo := SourcePieceTable.ObtainAffectedRunInfo
      (AStartLogPosition, AEndLogPosition - AStartLogPosition);
    try
      ProcessContentInsideParent(ASelectionContentInfo, True, False);
    finally
      ASelectionContentInfo.Free;
...
begin
  Result := not SuppressCopySectionProperties and
    (TdxDocumentModel(ATargetSection.DocumentModel).ModelForExport or
    IsEmptySection(ATargetSection));
end;
...
begin
  ...
  AIsLastParagraphMarkSelected := (AInfo.&End.RunIndex = ALastRunIndex) or
    ADocumentLastParagraphSelected;
...
function TdxCopySectionOperation.IsEmptySection(ATargetSection
  : TdxSection): Boolean;
var
...
begin
  ...
  Result := ATargetSection.DocumentModel.MainPart.Paragraphs
    [AFirstParagraphIndex].IsEmpty;
end;
...
begin
  ...
  AEndParagraph := SourcePieceTable.Paragraphs[ASection.LastParagraphIndex];
  ASelectionContentInfo := SourcePieceTable.ObtainAffectedRunInfo
    (AInfo.Start.LogPosition, AEndParagraph.EndLogPosition -
    AInfo.Start.LogPosition + 1);
  try
...
function TdxDeleteParagraphOperation.ShouldProcessRunParent
  (AInfo: TdxRunInfo): Boolean;
var
...
begin
  ...
  Result := (AStart.RunIndex = AParagraph.LastRunIndex) and
    (AEnd.RunIndex = AParagraph.LastRunIndex);
end;

function TdxDeleteParagraphOperation.ShouldProcessContentInSameParent
  (AInfo: TdxRunInfo): Boolean;
var
  AStart, AEnd: TdxDocumentModelPosition;
...
procedure TdxDeleteParagraphOperation.ProcessAllParagraphRuns(AParagraphIndex
  : TdxParagraphIndex);
begin
  DocumentModel.UnsafeEditor.DeleteAllRunsInParagraph(PieceTable,
    AParagraphIndex);
end;

function TdxDeleteParagraphOperation.ProcessHead(AInfo: TdxRunInfo;
  ADocumentLastParagraphSelected: Boolean): Integer;
var
...
begin
  ...
  try
    ...
    TdxDocumentModelPosition.SetParagraphEnd(@AStartInfo.&End,
      AStartParagraph.Index);
    ProcessContentSameParent(AStartInfo,
      DocumentModel.EditingOptions.MergeParagraphsContent,
      ADocumentLastParagraphSelected);
    Result := 0;
  finally
    AStartInfo.Free;
...
function TdxDeleteParagraphOperation.ProcessMiddle(AInfo: TdxRunInfo;
  AParagraphCount: Integer; ADocumentLastParagraphSelected: Boolean): Boolean;
var
  AStartParagraph: TdxParagraphBase;
begin
...
procedure TdxDeleteParagraphOperation.ProcessNumberingRun
  (AParagraph: TdxParagraph; AUseFirstParagraphStyle: Boolean);
var
  ANextParagraph: TdxSimpleParagraph;
begin
  ANextParagraph := PieceTable.Paragraphs[AParagraph.Index + 1];
  if ANextParagraph.IsInList and AParagraph.IsInList and AUseFirstParagraphStyle
  then
    Exit;
  ...
  begin
    if not AUseFirstParagraphStyle then
      PieceTable.AddNumberingListToParagraph(AParagraph,
        ANextParagraph.GetNumberingListIndex, ANextParagraph.GetListLevelIndex);
    PieceTable.RemoveNumberingFromParagraph(ANextParagraph);
  end;
end;

procedure TdxDeleteParagraphOperation.ProcessParagraphsCore(AStartParagraphIndex
  : TdxParagraphIndex; ACount: Integer);
var
...
procedure TdxDeleteParagraphOperation.ProcessParagraphs(AStartParagraphIndex
  : TdxParagraphIndex; ACount: Integer);
var
  AIsNeedJoinTables: Boolean;
begin
  ProcessParagraphsCore(AStartParagraphIndex, ACount);
  AIsNeedJoinTables := IsNeedJoinTables(AStartParagraphIndex,
    AStartParagraphIndex + ACount - 1);
  DocumentModel.UnsafeEditor.DeleteParagraphs(PieceTable, AStartParagraphIndex,
    ACount, nil);
  if AIsNeedJoinTables then
    JoinTables(AStartParagraphIndex);
end;

procedure TdxDeleteParagraphOperation.ProcessRunParent(AInfo: TdxRunInfo;
  ADocumentLastParagraphSelected: Boolean);
var
...
begin
  ...
  begin
    ...
    if (ANextCell <> nil) and ((ACell = nil) or (ACell.Table <> ANextCell.Table))
    then
    begin
      AFieldsCounter := 0;
    ...
    ProcessNumberingRun(AParagraph,
      DocumentModel.EditingOptions.MergeUseFirstParagraphStyle);
    ...
    DocumentModel.UnsafeEditor.MergeParagraphs(PieceTable, AParagraph,
      AParagraphInTable, True, ACell);
    if AIsNeedJoinTables then
      JoinTables(AParagraphIndex);
  end;
end;

function TdxDeleteParagraphOperation.ProcessTail(AInfo: TdxRunInfo;
  ADocumentLastParagraphSelected: Boolean): Integer;
var
...
procedure TdxDeleteParagraphOperation.ProcessContentInsideParent
  (AInfo: TdxRunInfo; AAllowMergeWithNextParagraph,
  ADocumentLastParagraphSelected: Boolean);
var
  AShouldMergeParagraphs: Boolean;
begin
  AShouldMergeParagraphs := DeleteRunsInsideParagraphCore(AInfo,
...
procedure TdxDeleteParagraphOperation.ProcessContentCrossParent
  (AInfo: TdxRunInfo; ADocumentLastParagraphSelected: Boolean);
begin
  ...
  if TdxDeleteTablesHelper.IsDeleteParagraphsInTable(AInfo,
    ADocumentLastParagraphSelected, IsDeletedSomeSections) then
    ProcessTable(AInfo, ADocumentLastParagraphSelected)
  else
    ProcessContentCrossParentCore(AInfo, ADocumentLastParagraphSelected);
end;

procedure TdxDeleteParagraphOperation.DeleteRuns(AStartIndex: TdxRunIndex;
  ARunCount: Integer);
begin
...
begin
  ...
  AMergeParagraphs := (AEndRunIndex = AParagraph.LastRunIndex) and
    AAllowMergeWithNextParagraph;
  if AMergeParagraphs then
  begin
    AForbidMergeParagraph := (IsMergeParagraphWithTable(AInfo) and
      not IsProcessContentCrossParentExecute) or
  ...
  if (AEndRunIndex = AParagraph.LastRunIndex) and
    not AAllowMergeWithNextParagraph or (AEndRunIndex = AParagraph.LastRunIndex)
    and AForbidMergeParagraph then
    Dec(ARunCount);
  DeleteRuns(AStartRunIndex, ARunCount);
...
function TdxDeleteParagraphOperation.IsDeletedLastParagraphInCell
  (AInfo: TdxRunInfo): Boolean;
var
  AEndParagraphIndex: TdxParagraphIndex;
  AParagraphs: TdxParagraphCollection;
...
begin
  ...
  if ACell = nil then
    Exit(False);
  Result := AParagraphs[ACell.EndParagraphIndex]
    .LastRunIndex = AInfo.NormalizedEnd.RunIndex;
end;

function TdxDeleteParagraphOperation.IsMergeParagraphWithTable
  (AInfo: TdxRunInfo): Boolean;
var
  AParagraphs: TdxParagraphCollection;
...
begin
  ...
  ASelectOnlyParagraph := AStartParagraph.LastRunIndex = AInfo.
    NormalizedEnd.RunIndex;
  ...
  if ANextCell <> nil then
    ...
    ANextTable := nil;
  if (AStartTable <> nil) and (ANextTable <> nil) and
    (AStartTable <> ANextTable) and
    (AStartTable.NestedLevel <> ANextTable.NestedLevel) and ASelectOnlyParagraph
  then
    Exit(True);
  Result := False;
end;

function TdxDeleteParagraphOperation.IsNeedJoinTables(ATopParagraphIndex,
  ABottomParagraphIndex: TdxParagraphIndex): Boolean;
var
  AParagraphs: TdxParagraphCollection;
...
begin
  Result := False;
  AParagraphs := PieceTable.Paragraphs;
  if (ATopParagraphIndex = 0) or (ABottomParagraphIndex = AParagraphs.Count - 1)
  then
    Exit;
  ...
  ANextCell := PieceTable.TableCellsManager.GetCellByNestingLevel
    (ABottomParagraphIndex + 1, APreviousTableNestedLevel);
  if ANextCell = nil then
    Result := False
  else
  begin
    ANextTable := ANextCell.Table;
    if (APreviousTable <> ANextTable) and
      (APreviousTableNestedLevel = ANextTable.NestedLevel) then
      Result := APreviousTable.ParentCell = ANextTable.ParentCell;
  end;
end;

function TdxDeleteParagraphOperation.IsTheOnlyParagraph(AParagraphIndex
  : TdxParagraphIndex): Boolean;
begin
  Result := AParagraphIndex >= PieceTable.Paragraphs.Count - 1;
end;

procedure TdxDeleteParagraphOperation.JoinTables(AParagraphIndex
  : TdxParagraphIndex);
var
  AParagraphs: TdxParagraphCollection;
...
begin
  ...
  ABottomTable := PieceTable.TableCellsManager.GetCellByNestingLevel
    (AParagraphIndex, ATopTable.NestedLevel).Table;
  ATopTable.NormalizeCellColumnSpans;
  ABottomTable.NormalizeCellColumnSpans;
  PieceTable.JoinTables(ATopTable, ABottomTable);
end;

procedure TdxDeleteParagraphOperation.MergeParagraphWithNext
...
begin
  ...
  AIsNeedJoinTables := IsNeedJoinTables(AParagraphIndex, AParagraphIndex);
  DocumentModel.UnsafeEditor.MergeParagraphs(PieceTable, AParagraph,
    PieceTable.Paragraphs[ANextParagraph],
    DocumentModel.EditingOptions.MergeUseFirstParagraphStyle, ACell);
  if AIsNeedJoinTables then
    JoinTables(AParagraphIndex);
end;

procedure TdxDeleteParagraphOperation.ProcessContentCrossParentCore
  (AInfo: TdxRunInfo; ADocumentLastParagraphSelected: Boolean);
var
  AOptions: TdxDeleteTablesOptions;
...
begin
  AOptions := TdxDeleteTablesOptions.Create(ADocumentLastParagraphSelected,
    IsDeletedSomeSections, BackspacePressed);
  try
    ...
    AShouldDeleteHead := ProcessMiddle(AInfo, AParagraphCount,
      ADocumentLastParagraphSelected);
...
function TdxDeleteParagraphOperation.ProcessMiddleTable(AInfo: TdxRunInfo;
  AParagraphCount: Integer): Boolean;
var
...
procedure TdxDeleteParagraphOperation.ProcessTable(AInfo: TdxRunInfo;
  ADocumentLastParagraphSelected: Boolean);
var
  AOptions: TdxDeleteTablesOptions;
begin
...
procedure TdxDeleteParagraphOperation.ProcessContentCrossParentTable
  (AInfo: TdxRunInfo; ADocumentLastParagraphSelected: Boolean);
var
  AParagraphCount: Integer;
  AShouldDeleteHead: Boolean;
...
procedure TdxDeleteParagraphOperation.ProcessParagraphsInTable
...
begin
  ...
  begin
    ...
    if (ACurrentCell = nil) or (ACurrentCell.EndParagraphIndex <> I) or
      (AllowedDeleteLastParagraphInTableCell) then
    begin
      ProcessParagraphsCore(I, 1);
      DocumentModel.UnsafeEditor.DeleteParagraphs(PieceTable, I, 1,
        ACurrentCell);
    end
    else
    begin
...
function TdxDeleteParagraphOperation.ParagraphContentIsNumberingRunOnly
  (AParagraph: TdxParagraph): Boolean;
begin
...
function TdxDeleteSectionOperation.ShouldProcessContentInSameParent
  (AInfo: TdxRunInfo): Boolean;
var
  AParagraphs: TdxParagraphCollection;
  ASections: TdxSectionCollection;
...
begin
  ...
  AStartSectionIndex := PieceTable.LookupSectionIndexByParagraphIndex
    (AInfo.Start.ParagraphIndex);
  AEndSectionIndex := PieceTable.LookupSectionIndexByParagraphIndex
    (AInfo.&End.ParagraphIndex);
  Result := (AStartSectionIndex = AEndSectionIndex) and
    ((AInfo.Start.RunIndex <> AParagraphs[ASections[AStartSectionIndex]
    .FirstParagraphIndex].FirstRunIndex) or
    (AInfo.&End.RunIndex <> AParagraphs[ASections[AStartSectionIndex]
    .LastParagraphIndex].LastRunIndex));
end;

function TdxDeleteSectionOperation.ShouldProcessRunParent
  (AInfo: TdxRunInfo): Boolean;
var
  ASectionIndex: TdxSectionIndex;
  ASection: TdxSection;
...
begin
  ...
  ALastSectionRun := PieceTable.Paragraphs[ASection.LastParagraphIndex]
    .LastRunIndex;
  Result := (AInfo.&End.RunIndex = ALastSectionRun) and
    (AEndRun is TdxSectionRun);
end;
...
begin
  ...
  try
    ...
    ADeleteParagraphOperation.ExecuteCore(AInfo,
      ADocumentLastParagraphSelected);
  finally
...
begin
  ...
  begin
    ...
    AParagraphCount := ASection.LastParagraphIndex -
      ASection.FirstParagraphIndex + 1;
    ADeleteParagraph := TdxDeleteParagraphOperation.Create(PieceTable);
    try
      AParagraphs := PieceTable.Paragraphs;
      AStartLogPosition := AParagraphs[ASection.FirstParagraphIndex]
        .LogPosition;
      AEndLogPosition := AParagraphs[ASection.FirstParagraphIndex +
        AParagraphCount - 1].EndLogPosition + 1;
      ADeleteParagraph.Execute(AStartLogPosition,
        AEndLogPosition - AStartLogPosition,
...
procedure TdxDeleteSectionOperation.DeleteTail(AInfo: TdxRunInfo;
  AEndSection: TdxSection; ADocumentLastParagraphSelected: Boolean);
var
  AStartLogPosition: TdxDocumentLogPosition;
  ASectionContentInfo: TdxRunInfo;
  AStartSectionIndex, AEndSectionIndex: TdxSectionIndex;
begin
  AStartLogPosition := PieceTable.Paragraphs[AEndSection.FirstParagraphIndex]
    .LogPosition;
  ASectionContentInfo := PieceTable.ObtainAffectedRunInfo(AStartLogPosition,
    AInfo.&End.LogPosition - AStartLogPosition + 1);
  try
    AStartSectionIndex := PieceTable.LookupSectionIndexByParagraphIndex
      (AInfo.NormalizedStart.ParagraphIndex);
    AEndSectionIndex := PieceTable.LookupSectionIndexByParagraphIndex
      (AInfo.NormalizedEnd.ParagraphIndex);
    FIsDeletedSomeSections := AStartSectionIndex <> AEndSectionIndex;
    ProcessContentInsideParent(ASectionContentInfo, True,
      ADocumentLastParagraphSelected);
  finally
...
begin
  ...
  AShouldDeleteHead := ProcessMiddle(AInfo, ASectionCount,
    ADocumentLastParagraphSelected);
  if AShouldDeleteHead then
    ProcessHead(AInfo, ADocumentLastParagraphSelected);
end;

function TdxDeleteSectionOperation.ProcessHead(AInfo: TdxRunInfo;
  ADocumentLastParagraphSelected: Boolean): Integer;
var
  AStartSectionIndex: TdxSectionIndex;
  AParagraph: TdxParagraph;
...
begin
  AStartSectionIndex := PieceTable.LookupSectionIndexByParagraphIndex
    (AInfo.Start.ParagraphIndex);
  AParagraph := PieceTable.Paragraphs[DocumentModel.Sections[AStartSectionIndex]
    .LastParagraphIndex];
  ALength := AParagraph.LogPosition + AParagraph.Length -
    AInfo.Start.LogPosition;
  ASectionContentInfo := PieceTable.ObtainAffectedRunInfo
    (AInfo.Start.LogPosition, ALength);
  try
...
function TdxDeleteSectionOperation.ProcessMiddle(AInfo: TdxRunInfo;
  AParagraphCount: Integer; ADocumentLastParagraphSelected: Boolean): Boolean;
var
  AStartSectionIndex: TdxSectionIndex;
...
begin
  ...
  if AInfo.Start.RunIndex = PieceTable.Paragraphs
    [AStartSection.FirstParagraphIndex].FirstRunIndex then
  begin
    ProcessSections(AStartSectionIndex, AParagraphCount + 1);
    Result := False;
  end
...
function TdxDeleteSectionOperation.ProcessTail(AInfo: TdxRunInfo;
  ADocumentLastParagraphSelected: Boolean): Integer;
var
  AEndSectionIndex: TdxSectionIndex;
  AStartSectionIndex: TdxSectionIndex;
...
begin
  ...
  if AInfo.&End.RunIndex <> PieceTable.Paragraphs
    [AEndSection.LastParagraphIndex].LastRunIndex then
  begin
...
procedure TdxDeleteContentWithFieldsOperation.ExecuteCore(ARunInfo: TdxRunInfo;
  ADocumentLastParagraphSelected: Boolean);
begin
  DeleteFieldsWithinInterval(ARunInfo);
  DeleteContentWithFieldsCore(ARunInfo.Start, ARunInfo.&End,
    ADocumentLastParagraphSelected);
end;
...
procedure TdxDeleteContentWithFieldsOperation.DeleteFieldsWithinInterval
  (ARunInfo: TdxRunInfo);
var
...
function TdxDeleteContentWithFieldsOperation.CalculateDeletedFields
  (ARunInfo: TdxRunInfo): TdxFieldList;
var
  AIndex: Integer;
  AField: TdxField;
...
begin
  ...
  begin
    ...
    AFieldShouldBeRemove := ForceRemoveInnerFields or
      not IsFieldHidByParent(AField) or IsParentShouldBeRemoved(AField,
      ARunInfo);
...
function TdxDeleteContentWithFieldsOperation.IsFieldWithinInterval
...
begin
  ...
  Result := (AField.FirstRunIndex >= AStartIndex) and
    (AField.LastRunIndex <= AEndIndex);
end;

function TdxDeleteContentWithFieldsOperation.IsParentShouldBeRemoved
  (AField: TdxField; ARunInfo: TdxRunInfo): Boolean;
begin
  Result := (AField.Parent <> nil) and IsFieldWithinInterval(ARunInfo,
    AField.Parent);
end;

function TdxDeleteContentWithFieldsOperation.IsFieldHidByParent
...
function TdxDeleteContentWithFieldsOperation.CreateDeleteContentOperation
  : TdxSelectionBasedOperation;
begin
  Result := TdxDeleteSectionOperation.Create(PieceTable);
end;

procedure TdxDeleteContentWithFieldsOperation.DeleteContentWithFieldsCore
...
begin
  ...
  begin
    ...
    if ALength > 0 then
    begin
      DeleteContent(ALogPosition - ALength + 1, ALength,
        ADocumentLastParagraphSelected);
...
function TdxDeleteContentWithFieldsOperation.ShouldSkipRun
...
begin
  ...
  if AField = nil then
    Exit(False);
  AIsFieldMarkRun := (AField.Code.Start = ARunIndex) or
    (AField.Code.&End = ARunIndex) or (AField.Result.&End = ARunIndex);
...
function TdxDeleteContentOperation.CreateDeleteContentOperation
  : TdxSelectionBasedOperation;
begin
  Result := TdxDeleteSectionOperation.Create(PieceTable);
...
begin
  ...
  try
    ...
    begin
      if (ALeftField = ARightField) and ShouldDeleteField(ARunInfo, ALeftField)
      then
...
begin
  DeleteBookmarksCore(PieceTable.Bookmarks.InnerList, ARunInfo,
    ShouldDeleteBookmark);
  DeleteBookmarksCore(PieceTable.RangePermissions.InnerList, ARunInfo,
    CanDeleteRangePermission);
end;
...
function TdxDeleteContentOperation.ShouldDeleteBookmark
...
function TdxDeleteContentOperation.CanDeleteRangePermission
  (AStart: TdxDocumentLogPosition; AEnd: TdxDocumentLogPosition;
  ABookmark: TdxBookmarkBase): Boolean;
begin
  Result := (ABookmark.Start > AStart) and (ABookmark.&End < AEnd);
