...
type
  ...
  protected
    ...
    class procedure NameKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure HrefLangKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure TypeKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure RelKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure RefKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure CharsetKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure TitleKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure TargetKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    ...
    procedure RemoveEmptyHyperlink(AIndexOfDeletedTag: Integer;
  ...
  strict private
    FBaseUri: string;
    class function AddAttributes: TdxAttributeKeywordTranslatorTable; static;
    class procedure BaseUriKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
  protected
    function GetAttributeTable: TdxAttributeKeywordTranslatorTable; override;
    class procedure TargetUriKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    procedure ApplyTagProperties; override;
    procedure OpenTagProcessCore; override;
...
class procedure TdxAnchorTag.HrefKeyword(AImporter: TdxCustomHtmlImporter;
...
class procedure TdxAnchorTag.NameKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
  TdxAnchorTag(ATag).AnchorName := AValue;
end;

class procedure TdxAnchorTag.HrefLangKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxAnchorTag.TypeKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxAnchorTag.RelKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxAnchorTag.RefKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxAnchorTag.CharsetKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxAnchorTag.TitleKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
  TdxAnchorTag(ATag).Tooltip := AValue;
end;

class procedure TdxAnchorTag.TargetKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
...
begin
  ...
  begin
    ...
    AStyleProperties := DocumentModel.CharacterStyles[AStyleIndex]
...
procedure TdxAnchorTag.RemoveEmptyHyperlink(AIndexOfDeletedTag: Integer;
  AFieldInfo: TdxImportFieldInfo);
var
  ACount: Integer;
...
begin
  ...
  Importer.DocumentModel.UnsafeEditor.DeleteRuns(Importer.PieceTable,
    AFieldInfo.CodeStartIndex, ACount);
  APos := TdxDocumentModelPosition.FromRunStart(Importer.PieceTable,
    AFieldInfo.CodeStartIndex);
...
class procedure TdxBaseTag.BaseUriKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  ABaseTag: TdxBaseTag;
begin
...
class procedure TdxBaseTag.TargetUriKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;
