...
type
  ...
  TdxDocumentModelTwipsToLayoutDocumentsConverter = class
...
function TdxDocumentModelTwipsToLayoutDocumentsConverter.ToLayoutUnits
...
function TdxDocumentModelTwipsToLayoutDocumentsConverter.ToModelUnits
  (value: Integer): Integer;
begin
