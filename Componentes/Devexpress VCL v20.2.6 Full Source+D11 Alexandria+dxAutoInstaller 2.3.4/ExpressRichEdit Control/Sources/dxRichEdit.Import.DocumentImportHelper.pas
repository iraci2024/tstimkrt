...
type
  ...
  TdxDocumentImportHelper = class
    (TdxImportHelper<TdxRichEditDocumentFormat, Boolean>)
  strict private
    function GetDocumentModel: TdxDocumentModel;
  protected
    procedure ApplyEncoding(const AOptions: IdxImporterOptions;
      AEncoding: TEncoding); override;
    ...
    function GetPredefinedOptions(AFormat: TdxRichEditDocumentFormat)
      : TObject; override;
    function EqualsFormat(const Value1, Value2: TdxRichEditDocumentFormat)
      : Boolean; override;
  public
  ...
  TdxImageImportHelper = class(TdxImportHelper<TdxOfficeImageFormat,
  ...
  protected
    ...
    function GetPredefinedOptions(AFormat: TdxOfficeImageFormat)
      : TObject; override;
    function EqualsFormat(const Value1, Value2: TdxOfficeImageFormat)
      : Boolean; override;
  end;
...
function TdxDocumentImportHelper.GetPredefinedOptions
  (AFormat: TdxRichEditDocumentFormat): TObject;
begin
...
procedure TdxDocumentImportHelper.ApplyEncoding(const AOptions
  : IdxImporterOptions; AEncoding: TEncoding);
begin
...
procedure TdxImageImportHelper.ApplyEncoding(const AOptions: IdxImporterOptions;
  AEncoding: TEncoding);
begin
  // do nothing
end;
