...
type
  TdxShapeType = (None = -1, PictureFrame = 75, TextBox = 202);

  { TdxFloatingObjectImportInfo }

  TdxFloatingObjectImportInfo = class(TcxIUnknownObject,
    IdxFloatingObjectPropertiesContainer, IdxShapeContainer,
  ...
  public
    ...
    property TextBoxContent: TdxTextBoxContentType read FTextBoxContent
      write FTextBoxContent;
...
begin
  Result := FIsFloatingObject and PieceTable.DocumentModel.DocumentCapabilities.
    FloatingObjectsAllowed;
end;

function TdxFloatingObjectImportInfo.InsertFloatingObject
...
function TdxFloatingObjectImportInfo.InsertFloatingObjectCore
  (APos: TdxInputPosition): Boolean;
var
...
function TdxFloatingObjectImportInfo.
  CreateFloatingObjectPropertiesChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
  Result := TdxIndexChangedHistoryItem.Create(PieceTable,
...
function TdxFloatingObjectImportInfo.CreateShapeChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
  Result := TdxIndexChangedHistoryItem.Create(PieceTable, Shape);
end;

function TdxFloatingObjectImportInfo.CreateTextBoxChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
