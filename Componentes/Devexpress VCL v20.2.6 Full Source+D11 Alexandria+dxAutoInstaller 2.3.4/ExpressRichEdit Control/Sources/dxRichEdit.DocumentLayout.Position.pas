...
type
  ...
  public type
    TdxIsIntersectedWithPrevBoxFunc = function(ABox: TdxBoxBase)
      : Boolean of object;
  strict private
    ...
    function BinarySearchTableCell(ATableViewInfoCollection
      : TdxTableViewInfoCollection): TdxTableCellViewInfo;
    function GetTableViewInfo(ATableViewInfoCollection
      : TdxTableViewInfoCollection): TdxTableViewInfo;
  ...
  protected
    ...
    function UpdatePageRecursive(APages: TdxPageCollection;
      AStartIndex: Integer; ADetailsLevel: TdxDocumentLayoutDetailsLevel)
      : TdxDocumentLayoutDetailsLevel; virtual;
    function LookupPage(APages: TdxPageCollection; AStartIndex: Integer)
      : TdxPage; virtual;
    ...
    function LookupPageArea(APage: TdxPage; AStartIndex: Integer)
      : TdxPageArea; virtual;
    function UpdateColumnRecursive(AColumns: TdxColumnCollection;
      AStartIndex: Integer; ADetailsLevel: TdxDocumentLayoutDetailsLevel)
      : TdxDocumentLayoutDetailsLevel; overload; virtual;
    function UpdateRowRecursive(ARows: TdxRowCollection; AStartIndex: Integer;
      ADetailsLevel: TdxDocumentLayoutDetailsLevel)
      : TdxDocumentLayoutDetailsLevel; overload; virtual;
    function UpdateBoxRecursive(ARow: TdxRow; AStartIndex: Integer;
      ADetailsLevel: TdxDocumentLayoutDetailsLevel)
      : TdxDocumentLayoutDetailsLevel; overload; virtual;
    ...
    function GetPageIndex(APages: TdxPageCollection;
      AStartIndex, AEndIndex: Integer): Integer; overload; virtual;
    function GetPageIndex(APages: TdxPageCollection): Integer;
      overload; virtual;
    function GetPageAreaIndex(AAreas: TdxPageAreaCollection;
      AStartIndex, AEndIndex: Integer): Integer; overload; virtual;
    function GetPageAreaIndex(AAreas: TdxPageAreaCollection): Integer;
      overload; virtual;
    function GetColumnIndex(AColumns: TdxColumnCollection;
      AStartIndex, AEndIndex: Integer): Integer; overload; virtual;
    function GetColumnIndex(AColumns: TdxColumnCollection): Integer;
      overload; virtual;

    function FindBoxIndex(ACollection: TdxBoxList;
      const AExactComparable: TdxBoxComparableFunc;
    ...
    function GetRowIndex(ARows: TdxRowCollection;
      AStartIndex, AEndIndex: Integer): Integer; overload; virtual;
    function GetRowIndex(ARows: TdxRowCollection): Integer; overload; virtual;
    function GetBoxIndex(ABoxes: TdxBoxCollection;
      AStartIndex, AEndIndex: Integer): Integer; overload; virtual;
    ...
    function GetCharIndex(ACharacters: TdxCharacterBoxCollection;
      AStartIndex, AEndIndex: Integer): Integer; overload; virtual;
    function GetCharIndex(ACharacters: TdxCharacterBoxCollection): Integer;
      overload; virtual;
    ...
    property UseLastAvailablePosition: Boolean read GetUseLastAvailablePosition
      write SetUseLastAvailablePosition;
  public
    ...
    procedure CopyFrom(AValue: TdxDocumentLayoutPosition;
      ADetailsLevel: TdxDocumentLayoutDetailsLevel); reintroduce;
      overload; virtual;
    ...
    property FloatingObjectBoxPage: TdxPage read FFloatingObjectBoxPage
      write FFloatingObjectBoxPage;
    ...
    property SuppressSuspendFormatting: Boolean read FSuppressSuspendFormatting
      write FSuppressSuspendFormatting;
  end;
  ...
  protected
    ...
    function GetPageIndex(APages: TdxPageCollection;
      AStartIndex, AEndIndex: Integer): Integer; override;
    function GetPieceTable: TdxPieceTable; override;
    procedure CheckPageAreaPieceTable(APageArea: TdxPageArea); override;
    function LookupPageArea(APage: TdxPage; AStartIndex: Integer): TdxPageArea;
      overload; override;
    function LookupPageArea(AFloatingObjects: TdxFloatingObjectBoxList;
      ARun: TdxFloatingObjectAnchorRun): TdxPageArea; reintroduce;
      overload; virtual;
...
type
  ...
  private
    ...
    FLogPosition: TdxDocumentLogPosition;
    function GetFirstPosition(ACell: TdxTableCellViewInfo)
      : TdxDocumentLogPosition; inline;
    function GetLastPosition(ACell: TdxTableCellViewInfo)
      : TdxDocumentLogPosition; inline;
  public
...
constructor TdxTableCellViewInfoAndLogPositionComparable.Create
  (APieceTable: TdxPieceTable; ALogPosition: TdxDocumentLogPosition);
begin
...
function TdxTableCellViewInfoAndLogPositionComparable.GetFirstPosition
  (ACell: TdxTableCellViewInfo): TdxDocumentLogPosition;
begin
  Result := PieceTable.Paragraphs[ACell.Cell.StartParagraphIndex].LogPosition;
end;

function TdxTableCellViewInfoAndLogPositionComparable.GetLastPosition
  (ACell: TdxTableCellViewInfo): TdxDocumentLogPosition;
begin
  Result := PieceTable.Paragraphs[ACell.Cell.EndParagraphIndex].EndLogPosition;
end;

function TdxTableCellViewInfoAndLogPositionComparable.CompareTo
  (const ACell: TdxTableCellViewInfo): Integer;
var
...
begin
  ...
  if FLogPosition < AFirstPos then
    Result := 1
  else if FLogPosition > AFirstPos then
  begin
...
constructor TdxTableViewInfoAndLogPositionComparable.Create
  (APieceTable: TdxPieceTable; ALogPosition: TdxDocumentLogPosition);
begin
  Assert(APieceTable <> nil);
  FPieceTable := APieceTable;
...
function TdxTableViewInfoAndLogPositionComparable.CompareTo
  (const ATable: TdxTableViewInfo): Integer;
var
...
function TdxTableViewInfoAndLogPositionComparable.GetFirstPosition
  (ATable: TdxTableViewInfo): TdxDocumentLogPosition;
begin
  Result := PieceTable.Paragraphs[ATable.Cells[0].Cell.StartParagraphIndex]
    .LogPosition;
end;

function TdxTableViewInfoAndLogPositionComparable.GetLastPosition
  (ATable: TdxTableViewInfo): TdxDocumentLogPosition;
begin
  Result := PieceTable.Paragraphs[ATable.Cells[ATable.Cells.Count - 1]
    .Cell.EndParagraphIndex].EndLogPosition;
end;

{ TdxDocumentLayoutPosition }

procedure TdxDocumentLayoutPosition.CheckPageAreaPieceTable
  (APageArea: TdxPageArea);
begin
  Assert(APageArea.PieceTable = PieceTable);
end;

constructor TdxDocumentLayoutPosition.Create(ADocumentLayout: TdxDocumentLayout;
  APieceTable: TdxCustomPieceTable; ALogPosition: TdxDocumentLogPosition);
begin
  inherited Create;
...
begin
  Result := TdxDocumentLayoutPosition.Create(DocumentLayout, PieceTable,
    LogPosition);
end;
...
procedure TdxDocumentLayoutPosition.EnsurePageSecondaryFormattingComplete
  (APage: TdxPage);
begin
end;

function TdxDocumentLayoutPosition.GetColumnIndex(AColumns: TdxColumnCollection;
...
begin
  ...
  Result := FindBoxIndex(AColumns, AComparable.ExactColumnAndLogPositionCompare,
    IsIntersectedWithPrevColumn, AStartIndex, AEndIndex);
end;

function TdxDocumentLayoutPosition.GetBoxIndex(ABoxes: TdxBoxCollection;
  AStartIndex, AEndIndex: Integer): Integer;
var
  AComparable: TdxBoxLogPositionComparable;
begin
  AComparable := TdxBoxLogPositionComparable.Create(PieceTable, LogPosition);
  TdxAlgorithms1<TdxBoxBase>.BinarySearch(ABoxes,
    AComparable.BoxAndLogPositionCompare, AStartIndex, AEndIndex, Result);
end;

function TdxDocumentLayoutPosition.GetBoxIndex
  (ABoxes: TdxBoxCollection): Integer;
begin
  Result := GetBoxIndex(ABoxes, 0, ABoxes.Count - 1);
end;

function TdxDocumentLayoutPosition.GetCharIndex(ACharacters
  : TdxCharacterBoxCollection; AStartIndex, AEndIndex: Integer): Integer;
var
  AComparable: TdxBoxLogPositionComparable;
begin
  AComparable := TdxBoxLogPositionComparable.Create(PieceTable, LogPosition);
  TdxAlgorithms1<TdxBoxBase>.BinarySearch(ACharacters,
    AComparable.BoxAndLogPositionCompare, AStartIndex, AEndIndex, Result);
end;

function TdxDocumentLayoutPosition.GetCharIndex(ACharacters
  : TdxCharacterBoxCollection): Integer;
begin
  Result := GetCharIndex(ACharacters, 0, ACharacters.Count - 1);
end;

function TdxDocumentLayoutPosition.GetColumnIndex
  (AColumns: TdxColumnCollection): Integer;
begin
...
begin
  AComparable := TdxBoxLogPositionComparable.Create(PieceTable, LogPosition);
  Result := FindBoxIndex(ACollection, AComparable.BoxStartAndLogPositionCompare,
    AExactComparable, AIsIntersect, AStartIndex, AEndIndex);
end;
...
begin
  if TdxAlgorithms1<TdxBoxBase>.BinarySearch(ACollection, AComparable,
    AStartIndex, AEndIndex, ABoxIndex) then
    Exit(ABoxIndex);
  ...
  while (AStartBoxIndex > 0) and AIsIntersect(ACollection[AStartBoxIndex]) do
    Dec(AStartBoxIndex);
  if TdxAlgorithms1<TdxBoxBase>.BinarySearch(ACollection, AExactComparable,
    AStartBoxIndex, ALastBoxIndex, ABoxIndex) then
    Exit(ABoxIndex);
...
function TdxDocumentLayoutPosition.BinarySearchTableCell
  (ATableViewInfoCollection: TdxTableViewInfoCollection): TdxTableCellViewInfo;
var
...
begin
  ...
  AComparable1 := TdxTableCellViewInfoAndLogPositionComparable.Create
    (PieceTable, LogPosition);
  AStartIndex := 0;
  AEndIndex := ACells.Count - 1;
  if not TdxAlgorithms1<TdxTableCellViewInfo>.BinarySearch(ACells,
    AComparable1.CompareTo, AStartIndex, AEndIndex, ACellIndex) then
  begin
    ...
    AComparable2 := TdxTableCellViewInfoAndLogPositionComparable.Create
      (PieceTable, PieceTable.Paragraphs[AFirstCell.StartParagraphIndex]
      .LogPosition);
    if not TdxAlgorithms1<TdxTableCellViewInfo>.BinarySearch(ACells,
      AComparable2.CompareTo, AStartIndex, AEndIndex, ACellIndex) then
      Exit(nil);
  end;
  Result := ACells[ACellIndex];
end;

function TdxDocumentLayoutPosition.GetTableViewInfo(ATableViewInfoCollection
  : TdxTableViewInfoCollection): TdxTableViewInfo;
var
  ATableIndex: Integer;
  ATableViewInfo: TdxTableViewInfo;
  ATableViewInfoAndLogPositionComparable
    : TdxTableViewInfoAndLogPositionComparable;
begin
  ATableViewInfoAndLogPositionComparable :=
    TdxTableViewInfoAndLogPositionComparable.Create(PieceTable, LogPosition);
  ...
  begin
    ...
    if ATableViewInfo.Cells.Count = 0 then
      Continue;
    if (ATableViewInfoAndLogPositionComparable.GetFirstPosition(ATableViewInfo)
      <= LogPosition) and
      (ATableViewInfoAndLogPositionComparable.GetLastPosition(ATableViewInfo) >=
      LogPosition) then
      Exit(ATableViewInfo);
  end;
  Result := nil;
...
function TdxDocumentLayoutPosition.GetPageAreaIndex
  (AAreas: TdxPageAreaCollection; AStartIndex, AEndIndex: Integer): Integer;
var
  AComparable: TdxExactPageComparable;
begin
  AComparable := TdxExactPageComparable.Create(PieceTable, LogPosition);
  Result := FindBoxIndex(AAreas, AComparable.ExactPageAreaAndLogPositionCompare,
    IsIntersectedWithPrevArea, AStartIndex, AEndIndex);
end;
...
function TdxDocumentLayoutPosition.GetPageIndex
  (APages: TdxPageCollection): Integer;
begin
...
function TdxDocumentLayoutPosition.GetRowIndex(ARows: TdxRowCollection)
  : Integer;
begin
...
begin
  AComparable := TdxBoxLogPositionComparable.Create(PieceTable, LogPosition);
  TdxAlgorithms1<TdxBoxBase>.BinarySearch(ARows,
    AComparable.BoxAndLogPositionCompare, AStartIndex, AEndIndex, Result);

  if (Result >= ARows.Count) and
    (UseLastAvailablePosition or ((TableCell <> nil) and
    IsTableCellVerticalMerged)) then
    Result := ARows.Count - 1;
end;

function TdxDocumentLayoutPosition.GetPageIndex(APages: TdxPageCollection;
  AStartIndex, AEndIndex: Integer): Integer;
var
  AComparable: TdxExactPageComparable;
begin
  AComparable := TdxExactPageComparable.Create(PieceTable, LogPosition);
  Result := FindBoxIndex(APages, AComparable.ExactPageAndLogPositionCompare,
    IsIntersectedWithPrevPage, AStartIndex, AEndIndex);
end;
...
procedure TdxDocumentLayoutPosition.IncreaseDetailsLevel(ADetailsLevel
  : TdxDocumentLayoutDetailsLevel);
begin
...
function TdxDocumentLayoutPosition.IsIntersectedWithPrevArea
  (AArea: TdxBoxBase): Boolean;
begin
  Assert(AArea is TdxPageArea);
  Result := IsIntersectedWithPrevColumn(TdxPageArea(AArea).Columns.First);
end;

function TdxDocumentLayoutPosition.IsIntersectedWithPrevColumn
  (AColumn: TdxBoxBase): Boolean;
begin
  Assert(AColumn is TdxColumn);
  Result := TdxColumn(AColumn).IsIntersectedWithPrevColumn;
end;

function TdxDocumentLayoutPosition.IsIntersectedWithPrevPage
  (APage: TdxBoxBase): Boolean;
begin
  Assert(APage is TdxPage);
  Result := IsIntersectedWithPrevArea(TdxPage(APage).Areas.First);
end;

function TdxDocumentLayoutPosition.IsValid(ADetailsLevel
  : TdxDocumentLayoutDetailsLevel): Boolean;
begin
  Result := ADetailsLevel <= DetailsLevel;
end;

function TdxDocumentLayoutPosition.LookupPage(APages: TdxPageCollection;
  AStartIndex: Integer): TdxPage;
var
  APageIndex: Integer;
begin
...
function TdxDocumentLayoutPosition.LookupPageArea(APage: TdxPage;
  AStartIndex: Integer): TdxPageArea;
var
...
procedure TdxDocumentLayoutPosition.SetLogPosition
...
procedure TdxDocumentLayoutPosition.SetTableCell(const Value
...
procedure TdxDocumentLayoutPosition.SetTableRow(const Value
...
procedure TdxDocumentLayoutPosition.SetUseLastAvailablePosition
  (const Value: Boolean);
begin
end;
...
function TdxDocumentLayoutPosition.UpdateBoxRecursive(ARow: TdxRow;
  AStartIndex: Integer; ADetailsLevel: TdxDocumentLayoutDetailsLevel)
  : TdxDocumentLayoutDetailsLevel;
var
  ABoxIndex: Integer;
...
function TdxDocumentLayoutPosition.UpdateCharacterBoxRecursive(ARow: TdxRow;
  AStartIndex: Integer; ADetailsLevel: TdxDocumentLayoutDetailsLevel)
  : TdxDocumentLayoutDetailsLevel;
var
  ACharIndex: Integer;
...
begin
  ...
  begin
    ADetailRow := DocumentLayout.CreateDetailRowForBox(ARow, Box,
      SuppressSuspendFormatting);
    try
      ACharacters := ADetailRow.Characters;
      ACharIndex := GetCharIndex(ACharacters, AStartIndex,
        ACharacters.Count - 1);
      if ACharIndex >= ADetailRow.Characters.Count then
      begin
        if UseLastAvailablePosition or
          ((TableCell <> nil) and IsTableCellVerticalMerged) then
...
function TdxDocumentLayoutPosition.UpdateColumnRecursive
...
function TdxDocumentLayoutPosition.UpdatePageAreaRecursive(APage: TdxPage;
  AStartIndex: Integer; ADetailsLevel: TdxDocumentLayoutDetailsLevel)
  : TdxDocumentLayoutDetailsLevel;
begin
...
function TdxDocumentLayoutPosition.UpdatePageRecursive
  (APages: TdxPageCollection; AStartIndex: Integer;
  ADetailsLevel: TdxDocumentLayoutDetailsLevel): TdxDocumentLayoutDetailsLevel;
var
  APage: TdxPage;
begin
...
function TdxDocumentLayoutPosition.UpdateRowRecursive(ARows: TdxRowCollection;
  AStartIndex: Integer; ADetailsLevel: TdxDocumentLayoutDetailsLevel)
  : TdxDocumentLayoutDetailsLevel;
var
  ARowIndex: Integer;
...
procedure TdxTextBoxDocumentLayoutPosition.CheckPageAreaPieceTable
  (APageArea: TdxPageArea);
begin
end;

constructor TdxTextBoxDocumentLayoutPosition.Create(ADocumentLayout
  : TdxDocumentLayout; ATextBoxContentType: TdxTextBoxContentType;
  ALogPosition: TdxDocumentLogPosition; APreferredPageIndex: Integer);
begin
  inherited Create(ADocumentLayout,
    TdxPieceTable(ATextBoxContentType.PieceTable), ALogPosition);
  FPreferredPageIndex := APreferredPageIndex;
end;

function TdxTextBoxDocumentLayoutPosition.CreateEmptyClone
  : TdxDocumentLayoutPosition;
begin
  Result := TdxTextBoxDocumentLayoutPosition.Create(DocumentLayout,
    TdxTextBoxContentType(PieceTable.ContentType), LogPosition,
    FPreferredPageIndex);
end;

function TdxTextBoxDocumentLayoutPosition.IsIntersectedWithPrevBox
  (ABox: TdxBoxBase): Boolean;
begin
  Result := TdxPage(ABox).Areas.First.Columns.First.IsIntersectedWithPrevColumn;
end;

function TdxTextBoxDocumentLayoutPosition.GetPageIndex
  (APages: TdxPageCollection; AStartIndex, AEndIndex: Integer): Integer;
var
...
begin
  ...
  try
    AAnchorLogPosition := FAnchorPieceTable.GetRunLogPosition
      (ATextBoxPieceTable.AnchorRun);
    ABoxStartAndLogPositionComparable := TdxBoxLogPositionComparable.Create
      (FAnchorPieceTable, AAnchorLogPosition);
    AExactPageAndLogPositionComparable := TdxExactPageComparable.Create
      (FAnchorPieceTable, AAnchorLogPosition);
    Result := FindBoxIndex(APages,
      ABoxStartAndLogPositionComparable.BoxStartAndLogPositionCompare,
...
function TdxTextBoxDocumentLayoutPosition.LookupPageArea(AFloatingObjects
  : TdxFloatingObjectBoxList; ARun: TdxFloatingObjectAnchorRun): TdxPageArea;
var
  I: Integer;
...
procedure TdxTextBoxDocumentLayoutPosition.SetUseLastAvailablePosition
  (const Value: Boolean);
begin
  FUseLastAvailablePosition := Value;
end;

function TdxTextBoxDocumentLayoutPosition.LookupPageArea(APage: TdxPage;
  AStartIndex: Integer): TdxPageArea;
var
...
constructor TdxHeaderFooterDocumentLayoutPosition.Create(ADocumentLayout
...
procedure TdxHeaderFooterDocumentLayoutPosition.SetPreferredPageIndex
...
function TdxHeaderFooterDocumentLayoutPosition.CreateEmptyClone
  : TdxDocumentLayoutPosition;
begin
  Result := TdxHeaderFooterDocumentLayoutPosition.Create(DocumentLayout,
    PieceTable, LogPosition, PreferredPageIndex);
end;

function TdxHeaderFooterDocumentLayoutPosition.LookupPage
  (APages: TdxPageCollection; AStartIndex: Integer): TdxPage;
begin
  Result := LookupPreferredPage(APages);
end;

function TdxHeaderFooterDocumentLayoutPosition.LookupPageArea(APage: TdxPage;
  AStartIndex: Integer): TdxPageArea;
begin
  if (APage.Header <> nil) and (APage.Header.PieceTable = PieceTable) then
    Exit(APage.Header);
...
function TdxHeaderFooterDocumentLayoutPosition.LookupPreferredPage
  (APages: TdxPageCollection): TdxPage;
var
  APage: TdxPage;
begin
  if LogPosition > PieceTable.DocumentEndLogPosition then
...
function TdxHeaderFooterDocumentLayoutPosition.IsPageMatch
  (APage: TdxPage): Boolean;
begin
  if (APage.Header <> nil) and (APage.Header.PieceTable = PieceTable) then
    Exit(True);
  if (APage.Footer <> nil) and (APage.Footer.PieceTable = PieceTable) then
...
function TdxHeaderFooterDocumentLayoutPosition.LookupPreferredPageBackward
  (APages: TdxPageCollection): TdxPage;
var
  I: Integer;
begin
