...
uses
  ...
  Dialogs, ActnList,
  Generics.Defaults, Generics.Collections, dxCore, cxGraphics, cxControls,
  cxLookAndFeels,
  cxLookAndFeelPainters, Menus, dxLayoutControlAdapters, dxLayoutContainer,
  StdCtrls, cxButtons, dxLayoutControl,
  dxLayoutcxEditAdapters, cxContainer, cxEdit, cxLabel, cxTextEdit, cxMaskEdit,
  cxSpinEdit, dxMeasurementUnitEdit,
  cxCheckBox, cxDropDownEdit, cxRadioGroup, dxLayoutLookAndFeels, cxClasses,
  dxCoreClasses,
  dxRichEdit.Types,
...
type
  ...
  TdxOnSetValueToEditor = procedure(AEditor: TdxMeasurementUnitEdit;
    const AValue: Variant) of object;
  TdxOnGetValueFromEditor = function(AEditor: TdxMeasurementUnitEdit;
    ACorrectRange: Boolean = True): Variant of object;
  ...
  private
    ...
    function CheckStateToNullableBool(ACheckState: TcxCheckBoxState)
      : TdxNullableBoolean;
  ...
  public
    constructor Create(AOwner: TdxRichEditTablePropertiesDialogForm;
      const ACheckBox: TcxCheckBox; const AEditor: TdxMeasurementUnitEdit;
    ...
    property DeferredUpdateControl: Boolean read FDeferredUpdateControl
      write FDeferredUpdateControl;
    property Editor: TdxMeasurementUnitEdit read FEditor;
    property MaxValue: Integer read FMaxValue write SetMaxValue;
    property MinValue: Integer read FMinValue write SetMinValue;
    property ValueType: TdxNullableValue<T> read GetValueType
      write SetValueType;
    property UseDefaultValue: TdxNullableBoolean read FUseDefaultValue
      write SetUseDefaultValue;
    property UnitType: TdxMeasurementUnit read FUnitType write SetUnitType;
    property OnSetValueToEditor: TdxOnSetValueToEditor read FOnSetValueToEditor
      write FOnSetValueToEditor;
    property OnGetValueFromEditor: TdxOnGetValueFromEditor
      read FOnGetValueFromEditor write FOnGetValueFromEditor;
    property OnControlChanged: TNotifyEvent read FOnControlChanged
      write FOnControlChanged;
  end;
  ...
  public
    ...
    property IsValueInPercent: Boolean read FIsValueInPercent
      write SetIsValueInPercent;
    property MaxPercentValue: Integer read FMaxPercentValue
      write SetMaxPercentValue;
    property Width: TdxNullableInteger read GetWidth write SetWidth;
    property WidthType: TdxNullableValue<TdxWidthUnitType> read GetWidthType
      write SetWidthType;
  end;

  TdxTableRowHeightHelper = class
    (TdxCustomTableControlHelper<TdxHeightUnitType>)
  private
  ...
  private
    ...
    procedure SetCellVerticalAlignment(const AValue
      : TdxNullableValue<TdxVerticalAlignment>);
    procedure SetTableAlignment(const AValue
      : TdxNullableValue<TdxTableRowAlignment>);
  ...
  protected
    ...
    class procedure UpdateCheckbox(ACheckBox: TcxCheckBox;
      const ACheck: TdxNullableBoolean); static;
  public
    destructor Destroy; override;
    property Controller: TdxTablePropertiesFormController read GetController;
    property CellVerticalAlignment: TdxNullableValue<TdxVerticalAlignment>
      read GetCellVerticalAlignment write SetCellVerticalAlignment;
    property TableAlignment: TdxNullableValue<TdxTableRowAlignment>
...
begin
  ...
  btnBorder.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogButtonBorder);
  btnCellOptions.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogButtonCellOptions);
  btnTableOptions.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogButtonTableOptions);
  lblTableSize.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogSize);
  cbTablePreferredWidth.Caption :=
    cxGetResourceString(@sdxRichEditTablePropertiesDialogPreferredWidth);
  lblTableAlignment.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogTableAlignment);
  lblRowSize.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogSize);
  cbSpecifyHeight.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogSpecifyHeight);
  lblRowOptions.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogRowOptions);
  cbCantSplit.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogCantSplit);
  cbHeader.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogHeader);
  btnPreviousRow.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogButtonPreviousRow);
  btnNextRow.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogButtonNextRow);
  lblColumnSize.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogSize);
  cbColumnPreferredWidth.Caption :=
    cxGetResourceString(@sdxRichEditTablePropertiesDialogPreferredWidth);
  btnPreviousColumn.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogButtonPreviousColumn);
  btnNextColumn.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogButtonNextColumn);
  lblCellSize.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogSize);
  cbCellPreferredWidth.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogPreferredWidth);
  lblCellVerticalAlighment.Caption :=
    cxGetResourceString(@sdxRichEditTablePropertiesDialogCellVerticalAlighment);
  rbCellVerticalAlignmentTop.Caption :=
    cxGetResourceString
    (@sdxRichEditTablePropertiesDialogCellVerticalAlignmentTop);
  rbCellVerticalAlignmentCenter.Caption :=
    cxGetResourceString
    (@sdxRichEditTablePropertiesDialogCellVerticalAlignmentCenter);
  rbCellVerticalAlignmentBottom.Caption :=
    cxGetResourceString
    (@sdxRichEditTablePropertiesDialogCellVerticalAlignmentBottom);
  rgTableAlignmentLeft.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogTableAlignmentLeft);
  rgTableAlignmenCenter.Caption :=
    cxGetResourceString(@sdxRichEditTablePropertiesDialogTableAlignmenCenter);
  rgTableAlignmenRight.Caption := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogTableAlignmenRight);
  lcgTable.CaptionOptions.Text := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogTable);
  lcgRow.CaptionOptions.Text := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogRow);
  lcgColumn.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditTablePropertiesDialogColumn);
  lcgCell.CaptionOptions.Text := cxGetResourceString
    (@sdxRichEditTablePropertiesDialogCell);
  lciTableWidthType.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditTablePropertiesDialogWidthType);
  lciIndentFromLeft.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditTablePropertiesDialogIndentFromLeft);
  lciRowHeightType.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditTablePropertiesDialogRowHeightType);
  lcilRowNumber.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditTablePropertiesDialogRowNumber);
  lciColumnNumber.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditTablePropertiesDialogColumnNumber);
  lciColumnWidthType.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditTablePropertiesDialogWidthType);
  lciCellWidthType.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditTablePropertiesDialogWidthType);
end;
...
begin
  ...
  begin
    ...
    try
      ...
      ADocumentModel.Selection.
        ManuallySetTableSelectionStructureAndChangeSelection(AFirstCell,
        ALastCell);
      ASelectedCells := ADocumentModel.Selection.SelectedCells as
...
procedure TdxRichEditTablePropertiesDialogForm.btnCellOptionsClick
  (Sender: TObject);
begin
  ShowCellOptionsForm;
end;

procedure TdxRichEditTablePropertiesDialogForm.btnTableOptionsClick
  (Sender: TObject);
begin
  ShowTableOptionsForm;
end;

procedure TdxRichEditTablePropertiesDialogForm.CellSizeControlChanged
  (Sender: TObject);
begin
  ...
  FCellSizeControl.MaxValue :=
    Controller.GetColumnWidthMaxValueConsiderWidthUnitType;
  ...
  begin
    ...
    Controller.ColumnWidth := Controller.CalculateValue(Controller.ColumnWidth,
      Controller.ColumnWidthUnitType).Value;
    UpdateColumnTab;
  end;
end;

procedure TdxRichEditTablePropertiesDialogForm.
  CellVerticalAlignmentSelectedIndexChanged(Sender: TObject);
begin
  Controller.CellVerticalAlignment := CellVerticalAlignment;
end;

procedure TdxRichEditTablePropertiesDialogForm.ColumnSizeControlChanged
  (Sender: TObject);
begin
  ...
  FColumnSizeControl.MaxValue :=
    Controller.GetColumnWidthMaxValueConsiderWidthUnitType;
  if FCellSizeControl.WidthType <> FColumnSizeControl.WidthType then
  begin
    Controller.CellWidthUnitType := FColumnSizeControl.WidthType.Value;
    Controller.CellWidth := Controller.CalculateValue(Controller.CellWidth,
      Controller.CellWidthUnitType).Value;
    UpdateCellTab;
  end;
end;
...
begin
  Result := TdxTablePropertiesFormController.Create
    (AControllerParameters as TdxTablePropertiesFormControllerParameters);
end;
...
procedure TdxRichEditTablePropertiesDialogForm.FormCloseQuery(Sender: TObject;
...
begin
  if ModalResult <> mrOk then
    Exit;
  CanClose := IsValidEdit(seTablePreferredWidth) and
    IsValidEdit(seIndentFromLeft) and IsValidEdit(seHeight) and
    IsValidEdit(seColumnPreferredWidth) and IsValidEdit(seCellPreferredWidth);
  if CanClose then
    Controller.ApplyChanges;
end;

function TdxRichEditTablePropertiesDialogForm.GetCellVerticalAlignment
  : TdxNullableValue<TdxVerticalAlignment>;
begin
  if rbCellVerticalAlignmentTop.Checked then
    Result := TdxVerticalAlignment.Top
  else if rbCellVerticalAlignmentCenter.Checked then
    Result := TdxVerticalAlignment.Center
  else if rbCellVerticalAlignmentBottom.Checked then
    Result := TdxVerticalAlignment.Bottom
  else
    Result := TdxNullableValue<TdxVerticalAlignment>.Null;
end;

function TdxRichEditTablePropertiesDialogForm.GetController
  : TdxTablePropertiesFormController;
begin
  Result := TdxTablePropertiesFormController(inherited Controller);
end;

function TdxRichEditTablePropertiesDialogForm.GetTableAlignment
  : TdxNullableValue<TdxTableRowAlignment>;
begin
  if rgTableAlignmenCenter.Checked then
    Result := TdxTableRowAlignment.Center
  else if rgTableAlignmentLeft.Checked then
    Result := TdxTableRowAlignment.Left
  else if rgTableAlignmenRight.Checked then
    Result := TdxTableRowAlignment.Right
  else
    Result := TdxNullableValue<TdxTableRowAlignment>.Null;
end;

procedure TdxRichEditTablePropertiesDialogForm.IndentFromLeftValueChanged
  (Sender: TObject);
var
  AValue: Variant;
begin
...
begin
  ...
  InitializeMeasurementUnitEdit(seIndentFromLeft, AMeasurementType,
    ...
    ModelUnitsToUIUnit(TdxRichEditTablePropertiesHelper.
    MinTableIndentByDefault),
    ModelUnitsToUIUnit(TdxRichEditTablePropertiesHelper.
    MaxTableIndentByDefault)));
  ...
  FTableSizeControl.MinValue := TdxRichEditTablePropertiesHelper.
    MinTableWidthByDefault;
  FTableSizeControl.MaxValue := TdxRichEditTablePropertiesHelper.
    MaxTableWidthInModelUnitsByDefault;
  FTableSizeControl.MaxPercentValue :=
    TdxRichEditTablePropertiesHelper.MaxTableWidthInPercentByDefault;
  ...
  FRowHeightControl.MinValue := TdxRichEditTablePropertiesHelper.
    MinRowHeightByDefault;
  FRowHeightControl.MaxValue := TdxRichEditTablePropertiesHelper.
    MaxRowHeightByDefault;
  ...
  FColumnSizeControl.MinValue := TdxRichEditTablePropertiesHelper.
    MinColumnWidthByDefault;
  FColumnSizeControl.MaxValue := TdxRichEditTablePropertiesHelper.
    MaxColumnWidthInModelUnitsByDefault;
  FColumnSizeControl.MaxPercentValue :=
    TdxRichEditTablePropertiesHelper.MaxColumnWidthInPercentByDefault;
  ...
  FCellSizeControl.MinValue := TdxRichEditTablePropertiesHelper.
    MinCellWidthByDefault;
  FCellSizeControl.MaxValue := TdxRichEditTablePropertiesHelper.
    MaxCellWidthInModelUnitsByDefault;
  FCellSizeControl.MaxPercentValue :=
    TdxRichEditTablePropertiesHelper.MaxCellWidthInPercentByDefault;
  ...
  begin
    ...
    case AValue.Value of
      TdxVerticalAlignment.Top:
        rbCellVerticalAlignmentTop.Checked := True;
      TdxVerticalAlignment.Center:
        rbCellVerticalAlignmentCenter.Checked := True;
      TdxVerticalAlignment.Bottom:
        rbCellVerticalAlignmentBottom.Checked := True;
    end;
end;

procedure TdxRichEditTablePropertiesDialogForm.SetTableAlignment
  (const AValue: TdxNullableValue<TdxTableRowAlignment>);
begin
  if AValue.IsNull then
  begin
    ...
    case AValue.Value of
      TdxTableRowAlignment.Center:
        rgTableAlignmenCenter.Checked := True;
      TdxTableRowAlignment.Left:
        rgTableAlignmentLeft.Checked := True;
      TdxTableRowAlignment.Right:
        rgTableAlignmenRight.Checked := True;
    end;
end;

procedure TdxRichEditTablePropertiesDialogForm.ShowBorderShadingForm
  (ASelectedCells: TdxSelectedCellsCollection);
var
  AForm: TdxRichEditBorderShadingDialogForm;
  AControllerParameters: TdxBorderShadingFormControllerParameters;
begin
  AControllerParameters := TdxBorderShadingFormControllerParameters.Create
    (Control, TdxDocumentModel(Controller.Table.DocumentModel), ASelectedCells);
  try
...
begin
  AControllerParameters := TdxTableCellOptionsFormControllerParameters.Create
    (Control, Controller.SelectedCells);
  try
...
begin
  ...
  rbCellVerticalAlignmentTop.OnClick :=
    CellVerticalAlignmentSelectedIndexChanged;
  rbCellVerticalAlignmentCenter.OnClick :=
    CellVerticalAlignmentSelectedIndexChanged;
  rbCellVerticalAlignmentBottom.OnClick :=
    CellVerticalAlignmentSelectedIndexChanged;
end;

procedure TdxRichEditTablePropertiesDialogForm.
  TableAlignmentSelectedIndexChanged(Sender: TObject);
begin
  Controller.TableAlignment := TableAlignment;
  UpdateEnabledControls;
end;

procedure TdxRichEditTablePropertiesDialogForm.TableRowHeightControlChanged
  (Sender: TObject);
begin
...
procedure TdxRichEditTablePropertiesDialogForm.TableSizeControlChanged
  (Sender: TObject);
begin
  ...
  FTableSizeControl.MaxValue :=
    Controller.GetTableWidthMaxValueConsiderWidthUnitType;
end;
...
begin
  ...
  try
    ...
    FCellSizeControl.MaxValue :=
      Controller.GetCellWidthMaxValueConsiderWidthUnitType;
  finally
...
class procedure TdxRichEditTablePropertiesDialogForm.UpdateCheckbox
  (ACheckBox: TcxCheckBox; const ACheck: TdxNullableBoolean);
begin
...
begin
  seIndentFromLeft.Enabled :=
    Controller.TableAlignment = TdxTableRowAlignment.Left;
end;
...
procedure TdxCustomTableControlHelper<T>.AddItem(const ADisplayName: string;
  const AValue: T);
begin
...
function TdxCustomTableControlHelper<T>.CheckStateToNullableBool
  (ACheckState: TcxCheckBoxState): TdxNullableBoolean;
begin
  case ACheckState of
    cbsUnchecked:
      Result := False;
...
function TdxCustomTableControlHelper<T>.CheckVariantToNullableInteger
  (AValue: Variant): TdxNullableInteger;
begin
...
constructor TdxCustomTableControlHelper<T>.Create
  (AOwner: TdxRichEditTablePropertiesDialogForm; const ACheckBox: TcxCheckBox;
...
function TdxCustomTableControlHelper<T>.GetController
  : TdxTablePropertiesFormController;
begin
...
begin
  FOwner.InitializeMeasurementUnitEdit(FEditor, FMeasurementType,
    ...
    FOwner.ModelUnitsToUIUnit(MinValue), FOwner.ModelUnitsToUIUnit(MaxValue)));
end;
...
procedure TdxCustomTableControlHelper<T>.SetValueToEditor
...
procedure TdxCustomTableControlHelper<T>.SetValueType
  (const AValue: TdxNullableValue<T>);
{$IFNDEF DELPHIXE3}
var
...
procedure TdxCustomTableControlHelper<T>.SetUnitType(const AValue
  : TdxMeasurementUnit);
begin
  if FUnitType = AValue then
    Exit;
  FUnitType := AValue;
  FMeasurementType := TdxRichEditTablePropertiesDialogForm.
    ToMeasurementType(AValue);
  InternalPopulateComboBox;
  DoPropertiesChanged;
end;

procedure TdxCustomTableControlHelper<T>.SetUseDefaultValue
  (const AValue: TdxNullableBoolean);
begin
...
procedure TdxCustomTableControlHelper<T>.SetValue(const AValue
  : TdxNullableInteger);
begin
...
procedure TdxCustomTableControlHelper<T>.UpdateEnabledControls
  (AEnabled: Boolean);
begin
...
procedure TdxTableSizeHelper.SetWidthType(const Value
  : TdxNullableValue<TdxWidthUnitType>);
begin
...
begin
  UnsubscribeEvents;
  try
    AEnabledControls := not UseDefaultValue.IsNull and
      not UseDefaultValue.Value;
    UpdateEnabledControls(AEnabledControls);
    UpdateCheckbox;

    AWidthType := ValueType;
    if not AWidthType.IsNull and
      (AWidthType.Value = TdxWidthUnitType.FiftiethsOfPercent) then
      AActualWidthUnitType := AWidthType.Value
    else
      AActualWidthUnitType := TdxWidthUnitType.ModelUnits;
    IsValueInPercent := AActualWidthUnitType = TdxWidthUnitType.
      FiftiethsOfPercent;
...
var
  S: string;
begin
  AddItem(cxGetResourceString(@sdxRichEditCaptionUnitPercent),
...
begin
  ...
  if AWidthUnitType.Value = TdxWidthUnitType.FiftiethsOfPercent then
    FOwner.InitializeMeasurementUnitEdit(FEditor, TdxMeasurementType.mtCustom,
      TdxMeasurementUnitEditHelper.Create(' %', 1.0, 2, MinValue,
      MaxPercentValue))
  else
...
begin
  AddItem(cxGetResourceString(@sdxRichEditTablePropertiesHeightTypeExact),
    TdxHeightUnitType.Exact);
  AddItem(cxGetResourceString(@sdxRichEditTablePropertiesHeightTypeMinimum),
...
begin
  ...
  try
    ...
    if not AHeightType.IsNull and (AHeightType.Value = TdxHeightUnitType.Exact)
    then
