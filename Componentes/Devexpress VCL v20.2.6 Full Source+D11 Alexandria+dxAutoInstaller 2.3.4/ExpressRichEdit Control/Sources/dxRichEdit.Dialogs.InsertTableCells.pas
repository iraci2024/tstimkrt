...
uses
  ...
  cxLookAndFeelPainters, Menus, dxLayoutControlAdapters, dxLayoutLookAndFeels,
...
type
  TdxRichEditInsertTableCellsDialogForm = class
...
begin
  ...
  rbCellOperationShiftUp.Caption :=
    cxGetResourceString(@sdxRichEditInsertTableCellsDialogCellOperationShiftUp);
...
begin
  Result := TdxInsertTableCellsFormController.Create
    (AControllerParameters as TdxInsertTableCellsFormControllerParameters);
end;

function TdxRichEditInsertTableCellsDialogForm.GetController
