...
type
  ...
  public
    constructor Create(const AControl: IdxRichEditControl;
      ...
      const AFormOwner: IdxFormOwner = nil);
...
constructor TdxTabsFormControllerParameters.Create(const AControl
  : IdxRichEditControl; ATabInfo: TdxTabFormattingInfo;
  ADefaultTabWidth: Integer; AUnitConverter: TdxDocumentModelUnitConverter;
  const AFormOwner: IdxFormOwner);
begin
...
constructor TdxTabsFormController.Create(AControllerParameters
  : TdxTabsFormControllerParameters);
begin
  inherited Create;
