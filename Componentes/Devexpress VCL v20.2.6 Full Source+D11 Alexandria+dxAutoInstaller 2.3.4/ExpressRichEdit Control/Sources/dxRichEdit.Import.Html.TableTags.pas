...
type
  ...
  strict private
    class var FAttributeTable: TdxAttributeKeywordTranslatorTable;
  ...
  strict private
    ...
    class procedure AlignmentKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure BackgroundImageKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure BackgroundColorKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure BorderWidthKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure BorderColorKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
  ...
  public
    ...
    class procedure ImportBackgroundColor(AConverter
      : TdxDocumentModelUnitConverter; const AValue: string;
      ATableProperties: TdxHtmlTableProperties); static;
    class procedure CellPaddingKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure CellSpacingKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure ColumnsCountKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure TableHeightKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure TableWidthKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    ...
    property TableNotCreated: Boolean read FTableNotCreated
      write FTableNotCreated;
  end;
  ...
  protected
    ...
    procedure OpenTagProcessCore; override;
    function GetStartParagraphIndex(AOpenTag: TdxTableCellTag)
      : TdxParagraphIndex;
    function GetEndParagraphIndex(AOpenTag: TdxTableCellTag;
    ...
    function GetEndParagraphIndexEmptyLastParagraphCase
      (AOpenTag: TdxTableCellTag; AStartParagraphIndex: TdxParagraphIndex)
      : TdxParagraphIndex;
    function GetEndParagraphIndexForCellWithContent(AOpenTag: TdxTableCellTag)
      : TdxParagraphIndex; virtual;
    function GetEndParagraphIndexForEmptyCell(AStartParagraphIndex
      : TdxParagraphIndex): TdxParagraphIndex;
  public
    procedure BeforeDeleteTagFromStack(AIndexOfDeletedTag: Integer); override;
  ...
  strict private
    ...
    class procedure AlignmentKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure BackgroundCellColorKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure VerticalAlignmentKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure BorderColorKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure HeightKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    function GetTablesDisabled: Boolean;
  protected
    function GetAttributeTable: TdxAttributeKeywordTranslatorTable; override;
    procedure ApplyTagProperties; override;
    procedure OpenTagProcessCore; override;
    procedure CreateCellWhenAfterOpenTrTagWasContent(ATrTag: TdxTrTag;
  ...
  private
    ...
    FAlignment: TdxHtmlParagraphAlignment;
    class function AddAttributes: TdxAttributeKeywordTranslatorTable; static;
    class procedure HeadersKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure ScopeKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure AbbrKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure AxisKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure RowspanKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure ColspanKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure NowrapKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure WidthKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class function FindRowTag(AImporter: TdxCustomHtmlImporter)
      : TdxTrTag; static;
    class procedure HeightKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure AlignmentKeyword(AImporter: TdxCustomHtmlImporter;
  ...
  public
    ...
    class procedure SetColorToAllBorders(AColor: TdxAlphaColor;
      ACellProperties: TdxTableCellProperties); static;
    class procedure ImportBorderWidth(AUnitConverter
      : TdxDocumentModelUnitConverter; const AValue: string;
      ABottomBorder: TdxHtmlBorderProperty); static;
    class procedure ImportBorderColor(AConverter: TdxDocumentModelUnitConverter;
      const AValue: string; ABorder: TdxHtmlBorderProperty); static;
    class procedure BackgroundColorKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    class procedure BackgroundImageKeyword(AImporter: TdxCustomHtmlImporter;
      const AValue: string; ATag: TdxTagBase); static;
    ...
    property Alignment: TdxHtmlParagraphAlignment read FAlignment
      write FAlignment;
    property TdTagWithoutOpenedTable: Boolean read FTdTagWithoutOpenedTable
      write FTdTagWithoutOpenedTable;
  end;
...
class procedure TdxTableTag.AlignmentKeyword(AImporter: TdxCustomHtmlImporter;
...
class procedure TdxTableTag.BackgroundImageKeyword
  (AImporter: TdxCustomHtmlImporter; const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxTableTag.BackgroundColorKeyword
  (AImporter: TdxCustomHtmlImporter; const AValue: string; ATag: TdxTagBase);
var
  ATableTag: TdxTableTag;
begin
  ATableTag := TdxTableTag(ATag);
  ImportBackgroundColor(AImporter.DocumentModel.UnitConverter, AValue,
    ATableTag.TableProperties);
end;

class procedure TdxTableTag.BorderWidthKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  ATableTag: TdxTableTag;
begin
  ATableTag := TdxTableTag(ATag);
  ImportBordersWidths(AImporter.DocumentModel.UnitConverter, AValue,
    ATableTag.TableProperties.BordersProperties);
  if ATableTag.TableProperties.BordersProperties.TopBorder.Width > 0 then
  begin
    ATableTag.TableProperties.SetInnerBorders := True;
    if not ATableTag.TableProperties.BordersProperties.TopBorder.UseLineStyle
    then
    begin
      ATableTag.TableProperties.BordersProperties.TopBorder.LineStyle :=
        TdxBorderLineStyle.Single;
      ATableTag.TableProperties.BordersProperties.LeftBorder.LineStyle :=
        TdxBorderLineStyle.Single;
      ATableTag.TableProperties.BordersProperties.RightBorder.LineStyle :=
        TdxBorderLineStyle.Single;
      ATableTag.TableProperties.BordersProperties.BottomBorder.LineStyle :=
        TdxBorderLineStyle.Single;
    end;
  end;
end;

class procedure TdxTableTag.BorderColorKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  ATableTag: TdxTableTag;
begin
  ATableTag := TdxTableTag(ATag);
  ImportBordersColors(AImporter.DocumentModel.UnitConverter, AValue,
    ATableTag.TableProperties.BordersProperties);
end;

class procedure TdxTableTag.ImportBackgroundColor
  (AConverter: TdxDocumentModelUnitConverter; const AValue: string;
...
class procedure TdxTableTag.CellPaddingKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  ATableTag: TdxTableTag;
...
begin
  ATableTag := TdxTableTag(ATag);
  ACellMargin := ConvertPixelsValueToWidthUnitInfo
    (AImporter.DocumentModel.UnitConverter, AValue);
  try
    if (ACellMargin.&Type <> TdxWidthUnitType.&Nil) and (ACellMargin.Value >= 0)
    then
...
class procedure TdxTableTag.CellSpacingKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  ATableTag: TdxTableTag;
...
begin
  ATableTag := TdxTableTag(ATag);
  ACellSpacing := ConvertPixelsValueToWidthUnitInfo
    (AImporter.DocumentModel.UnitConverter, AValue);
  try
    if (ACellSpacing.&Type <> TdxWidthUnitType.&Nil) and
      (ACellSpacing.Value >= 0) then
...
class procedure TdxTableTag.ColumnsCountKeyword
  (AImporter: TdxCustomHtmlImporter; const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxTableTag.TableHeightKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxTableTag.TableWidthKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  ATableTag: TdxTableTag;
...
begin
  ATableTag := TdxTableTag(ATag);
  AWidth := ConvertPixelsValueToWidthUnitInfo
    (AImporter.DocumentModel.UnitConverter, AValue);
  try
...
const
  AAlignmentMap: array [TdxParagraphAlignment] of TdxRichEditTableRowAlignment =
    (TdxRichEditTableRowAlignment.Left, TdxRichEditTableRowAlignment.Right,
    TdxRichEditTableRowAlignment.Center, TdxRichEditTableRowAlignment.Both);
...
begin
  ...
  if Importer.Position.ParagraphFormatting.Alignment
    in [TdxParagraphAlignment.Right, TdxParagraphAlignment.Center] then
    FTableProperties.TableAlignment := AAlignmentMap
      [Importer.Position.ParagraphFormatting.Alignment];
  if Importer.Options.DefaultTableCellSpacing > 0 then
  begin
    ADefaultSpacing := Importer.DocumentModel.UnitConverter.TwipsToModelUnits
      (Importer.Options.DefaultTableCellSpacing);
    AWidth := TdxWidthUnitInfo.Create(TdxWidthUnitType.ModelUnits,
      ADefaultSpacing);
    try
  ...
  begin
    ADefaultMargin := Importer.DocumentModel.UnitConverter.TwipsToModelUnits
      (Importer.Options.DefaultTableCellMarging);
    AWidth := TdxWidthUnitInfo.Create(TdxWidthUnitType.ModelUnits,
      ADefaultMargin);
    try
...
begin
  ...
  AIndent := TdxWidthUnitInfo.Create(TdxWidthUnitType.ModelUnits,
    Importer.Position.TableProperties.Indent.Value +
  ...
  TableProperties.ApplyPropertiesToCharacter
...
begin
  ...
  begin
    if AOptions.UseLeftIndent then
      ...
      ADelta := 0;
    Importer.Position.TableProperties.Indent.Value := Importer.TagsStack
      [ACount - 1].OldPosition.ParagraphFormatting.LeftIndent + ADelta;
  end;
  Result := AOptions;
end;
...
begin
  ...
  Importer.Position.TableProperties.ApplyPropertiesToTable
    (ANewTable.TableProperties);
...
begin
  ...
  begin
    ...
    ATagName := ATag.Name;
    if ATagName in [TdxHtmlTagNameID.TD, TdxHtmlTagNameID.TR,
      TdxHtmlTagNameID.TH] then
      Exit(False);
...
begin
  Importer.DocumentModel.ResetParagraphFormatting
...
var
  AIsIgnored: Boolean;
begin
  AIsIgnored := (TdxTableTag((Importer.TagsStack[AIndexOfDeletedTag].Tag)))
    .TableNotCreated;
...
begin
  Result := (not Importer.TablesImportHelper.TablesAllowed) or
    (not Importer.TablesImportHelper.IsInTable);
end;
...
begin
  ...
  FStartParagraphIndex := Importer.TablesImportHelper.
    FindStartParagraphIndexForCell(Importer.Position.ParagraphIndex);
...
begin
  ...
  Importer.TablesImportHelper.InitializeTableCell
    (Importer.TablesImportHelper.Table.LastRow.LastCell, AStartParagraphIndex,
    AEndParagraphIndex);
end;

function TdxTableCellTag.GetStartParagraphIndex(AOpenTag: TdxTableCellTag)
  : TdxParagraphIndex;
begin
...
begin
  if Importer.IsEmptyParagraph then
    Result := GetEndParagraphIndexEmptyLastParagraphCase(AOpenTag,
      AStartParagraphIndex)
  else
    Result := GetEndParagraphIndexNonEmptyLastParagraphCase;
end;

function TdxTableCellTag.GetEndParagraphIndexNonEmptyLastParagraphCase
  : TdxParagraphIndex;
begin
  Result := Importer.Position.ParagraphIndex;
end;

function TdxTableCellTag.GetEndParagraphIndexEmptyLastParagraphCase
  (AOpenTag: TdxTableCellTag; AStartParagraphIndex: TdxParagraphIndex)
  : TdxParagraphIndex;
var
...
function TdxTableCellTag.GetEndParagraphIndexForCellWithContent
  (AOpenTag: TdxTableCellTag): TdxParagraphIndex;
var
...
function TdxTableCellTag.GetEndParagraphIndexForEmptyCell(AStartParagraphIndex
  : TdxParagraphIndex): TdxParagraphIndex;
var
  AEndParagraphIndex: TdxParagraphIndex;
begin
...
class procedure TdxTdTag.HeadersKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxTdTag.ScopeKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxTdTag.AbbrKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxTdTag.AxisKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxTdTag.RowspanKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
...
class procedure TdxTdTag.ColspanKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
...
class procedure TdxTdTag.NowrapKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  ATdTag: TdxTdTag absolute ATag;
begin
...
class procedure TdxTdTag.WidthKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  ATdTag: TdxTdTag absolute ATag;
  AWidth: TdxWidthUnitInfo;
...
class procedure TdxTdTag.HeightKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  ATrTag: TdxTrTag;
  AResult: Integer;
...
begin
  ...
  AParsedValue := TdxLengthValueParser.Create(AValue + 'px',
    AImporter.DocumentModel.ScreenDpi);
...
class procedure TdxTdTag.AlignmentKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  ATdTag: TdxTdTag;
...
class procedure TdxTdTag.VerticalAlignmentKeyword
  (AImporter: TdxCustomHtmlImporter; const AValue: string; ATag: TdxTagBase);
var
  ATdTag: TdxTdTag;
begin
...
class procedure TdxTdTag.BorderColorKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  ATdTag: TdxTdTag;
begin
  ATdTag := TdxTdTag(ATag);
  SetColorToAllBorders(TdxMarkupLanguageColorParser.ParseColor(AValue),
    ATdTag.CellProperties);
end;

class procedure TdxTdTag.SetColorToAllBorders(AColor: TdxAlphaColor;
...
class procedure TdxTdTag.ImportBorderWidth(AUnitConverter
  : TdxDocumentModelUnitConverter; const AValue: string;
...
class procedure TdxTdTag.ImportBorderColor(AConverter
  : TdxDocumentModelUnitConverter; const AValue: string;
...
class procedure TdxTdTag.BackgroundColorKeyword
  (AImporter: TdxCustomHtmlImporter; const AValue: string; ATag: TdxTagBase);
var
  ATdTag: TdxTdTag;
begin
  ATdTag := TdxTdTag(ATag);
  ATdTag.CellProperties.BackgroundColor :=
    TdxMarkupLanguageColorParser.ParseColor(AValue);
end;

class procedure TdxTdTag.BackgroundImageKeyword
  (AImporter: TdxCustomHtmlImporter; const AValue: string; ATag: TdxTagBase);
begin
end;
...
begin
  ...
  begin
    Importer.Position.DefaultAlignment.AlignmentValue :=
...
begin
  ...
  begin
    AHelper.AddCellToSpanCollection(Importer.Position.TableCellRowSpan,
      Importer.Position.CellProperties.ColumnSpan);
    AHelper.TableInfo.CaptionColSpan := AHelper.TableInfo.CaptionColSpan +
      Importer.Position.CellProperties.ColumnSpan;
  end
  else if AHelper.TableInfo.ColumnIndex + Importer.Position.CellProperties.
    ColumnSpan > AHelper.TableInfo.CellsRowSpanCollection.Count then
  begin
    AHelper.ExpandSpanCollection(Importer.Position.TableCellRowSpan,
      Importer.Position.CellProperties.ColumnSpan);
  end;
  Result := ACell;
end;

procedure TdxTdTag.ApplyHeightToTableRow(ATableRow: TdxTableRow;
  ARowSpan: Integer);
var
  ATrTag: TdxTrTag;
begin
...
begin
  ...
  Importer.TablesImportHelper.UpdateFirstRowSpanCollection
    (AOpenTag.TableCellRowSpan, AOpenTag.CellProperties.ColumnSpan);
  ACount := Importer.TagsStack.Count;
...
begin
  ...
  try
    ...
    begin
      Importer.Position.TableProperties.ApplyBackgroundColorToCell
        (ACell.Properties);
      Importer.Position.RowProperties.ApplyBackgroundColorToCell
        (ACell.Properties);
    end;
    if not ACell.Properties.UseVerticalAlignment then
      Importer.Position.RowProperties.ApplyVerticalAlignmentToCell
        (ACell.Properties);
    if not ACell.Properties.UseVerticalAlignment then
...
function TdxTdTag.GetEndParagraphIndexForCellWithContent
  (AOpenTag: TdxTableCellTag): TdxParagraphIndex;
var
  ATdOpenTag: TdxTdTag;
...
begin
  ...
  if (ATdOpenTag <> nil) and (ATdOpenTag.TablesCountOnOpen < ATablesCountOnClose)
  then
...
function TdxTdTag.GetParagraphIndexForCellContainsNestedTable
  : TdxParagraphIndex;
var
  AEndParagraphIndex: TdxParagraphIndex;
begin
  AEndParagraphIndex := Importer.Position.ParagraphIndex - 1;
  if (AEndParagraphIndex < 0) or
    (Importer.PieceTable.Paragraphs[AEndParagraphIndex].IsInCell) then
  begin
...
function TdxTdTag.CreateCellPropertiesChangedHistoryItem
  (AProperties: TdxTableCellProperties): TdxIndexChangedHistoryItemCore;
begin
...
class procedure TdxTrTag.AlignmentKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  ATrTag: TdxTrTag;
...
class procedure TdxTrTag.BackgroundCellColorKeyword
  (AImporter: TdxCustomHtmlImporter; const AValue: string; ATag: TdxTagBase);
var
  ATrTag: TdxTrTag;
begin
  ...
  ATrTag.RowProperties.BackgroundColor :=
    TdxMarkupLanguageColorParser.ParseColor(AValue);
end;

class procedure TdxTrTag.VerticalAlignmentKeyword
  (AImporter: TdxCustomHtmlImporter; const AValue: string; ATag: TdxTagBase);
var
  ATdTag: TdxTrTag;
begin
...
class procedure TdxTrTag.BorderColorKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
end;

class procedure TdxTrTag.HeightKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
var
  ATrTag: TdxTrTag;
  AValueType: string;
...
begin
  ...
  APar := TdxLengthValueParser.Create(AValueType,
    AImporter.DocumentModel.ScreenDpi);
  ...
  try
    ANewHeight.Value :=
      Round(ATag.DocumentModel.UnitConverter.PointsToModelUnitsF
      (APar.PointsValue));
...
begin
  ...
  RowProperties.ApplyPropertiesToCharacter
    (Importer.Position.CharacterFormatting);
end;
...
procedure TdxTrTag.CreateCellWhenAfterOpenTrTagWasContent(ATrTag: TdxTrTag;
  ALastRow: TdxTableRow);
var
  ACell: TdxTableCell;
...
begin
  ...
  begin
    ...
    ACell.Row.Cells.AddInternal(ACell);
    AStartParagraphIndex := Importer.TablesImportHelper.
      FindStartParagraphIndexForCell(Importer.Position.ParagraphIndex);
    Importer.TablesImportHelper.InitializeTableCell
      (Importer.TablesImportHelper.Table.LastRow.LastCell, AStartParagraphIndex,
...
begin
  ...
  ASizeInPoints :=
    Max(Trunc(DocumentModel.UnitConverter.ModelUnitsToPointsFRound
    (ARow.Properties.Height.Value)), 1);
  ACells := ARow.Cells;
  ACellsCount := ACells.Count;
  for ACellId := 0 to ACellsCount - 1 do
  begin
    ACell := ACells[ACellId];
    AParagraph := Importer.DocumentModel.MainPieceTable.Paragraphs
      [ACell.StartParagraphIndex];
    if (ACell.StartParagraphIndex = ACell.EndParagraphIndex) and
      (AParagraph.FirstRunIndex = AParagraph.LastRunIndex) then
    begin
      ATextRun := Importer.DocumentModel.MainPieceTable.Runs
        [AParagraph.FirstRunIndex];
      ATextRun.DoubleFontSize := Min(ATextRun.DoubleFontSize,
        ASizeInPoints * 2);
    end;
  end;
end;
...
class procedure TdxCaptionTag.AlignmentKeyword(AImporter: TdxCustomHtmlImporter;
  const AValue: string; ATag: TdxTagBase);
begin
