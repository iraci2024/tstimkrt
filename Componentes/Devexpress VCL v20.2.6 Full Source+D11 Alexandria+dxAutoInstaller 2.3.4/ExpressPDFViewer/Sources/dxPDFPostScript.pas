...
uses
  ...
  cxGeometry, dxPDFBase, dxPDFTypes, dxPDFParser;
...
type
  ...
  strict private
    ...
    function InternalContainsKey(const AKey: string;
      out AEntryIndex: Integer): Boolean;
  public
    ...
    function GetInteger(const AKey: string; ADefaultValue: Integer = 0)
      : Integer;
    ...
    function TryGetValue(const AKey: string;
      out AValue: TdxPDFReferencedObject): Boolean;
    ...
    property Items[Index: Integer]: TdxPDFPostScriptDictionaryEntry
...
{$ENDREGION}
  ...
  public
    ...
    function Read(const AData: TBytes; APosition: Integer = 0)
  ...
  public
    ...
    property SystemDictionary: TdxPDFPostScriptDictionary
      read FSystemDictionary;
  ...
  public
    procedure Execute(AInterpreter: TdxPDFPostScriptInterpreter);
      virtual; abstract;
  end;
  ...
  private
    function DoExecute(AInterpreter: TdxPDFPostScriptInterpreter;
      const AToken: string): Boolean; overload;
    function DoExecute(AInterpreter: TdxPDFPostScriptInterpreter;
      ADictionary: TdxPDFPostScriptDictionary; const AToken: string)
      : Boolean; overload;
  protected
  ...
  TdxPDFPostScriptType1FontRDOperator = class
    (TdxPDFPostScriptType1FontCustomOperator)
  public const
    RDToken = 'RD';
    RDAlternativeToken = '-|';
  ...
  TdxPDFPostScriptType1FontRDAlternativeOperator = class
    (TdxPDFPostScriptType1FontRDOperator)
  protected
    class function GetName: string; override;
  end;
  ...
  TdxPDFPostScriptType1FontNDOperator = class
    (TdxPDFPostScriptType1FontCustomOperator)
  public const
    NDToken = 'ND';
    NDAlternativeToken = '|-';
  ...
  TdxPDFPostScriptType1FontNDAlternativeOperator = class
    (TdxPDFPostScriptType1FontNDOperator)
  protected
    class function GetName: string; override;
  end;
  ...
  TdxPDFPostScriptType1FontNPOperator = class
    (TdxPDFPostScriptType1FontCustomOperator)
  public const
    NPToken = 'NP';
    NPAlternativeToken = '|';
  ...
  TdxPDFPostScriptType1FontNPAlternativeOperator = class
    (TdxPDFPostScriptType1FontNPOperator)
  protected
    class function GetName: string; override;
  end;
...
type
  ...
  TdxPDFPostScriptOperatorFactory = class
    (TdxPDFFactory<TdxPDFPostScriptOperatorClass>)
  public
...
procedure TdxPDFPostScriptOperatorFactory.RegisterOperator(AOperatorClass
  : TdxPDFPostScriptOperatorClass);
begin
  if not ContainsKey(AOperatorClass.GetName) then
    Register(AOperatorClass.GetName, AOperatorClass)
end;

procedure TdxPDFPostScriptOperatorFactory.UnregisterOperator(AOperatorClass
  : TdxPDFPostScriptOperatorClass);
begin
...
constructor TdxPDFPostScriptDictionaryEntry.Create(const AKey: string;
...
procedure TdxPDFPostScriptDictionaryEntry.SetValue(const AValue
...
function TdxPDFPostScriptDictionary.GetItem(Index: Integer)
  : TdxPDFPostScriptDictionaryEntry;
begin
  Result := FItems[Index] as TdxPDFPostScriptDictionaryEntry;
end;

function TdxPDFPostScriptDictionary.InternalContainsKey(const AKey: string;
  out AEntryIndex: Integer): Boolean;
var
  I: Integer;
begin
...
function TdxPDFPostScriptDictionary.GetDouble(const AKey: string;
  ADefaultValue: Double = 0): Double;
var
  AObject: TdxPDFReferencedObject;
begin
...
function TdxPDFPostScriptDictionary.GetInteger(const AKey: string;
...
function TdxPDFPostScriptDictionary.GetObject(const AKey: string)
  : TdxPDFReferencedObject;
begin
...
function TdxPDFPostScriptDictionary.TryGetValue(const AKey: string;
  out AValue: TdxPDFReferencedObject): Boolean;
var
  I: Integer;
...
function TdxPDFPostScriptDictionary.Contains
  (AKey: TdxPDFReferencedObject): Boolean;
begin
...
procedure TdxPDFPostScriptDictionary.Add(const AKey: string;
  AValue: TdxPDFReferencedObject);
begin
...
function TdxPDFPostScriptStack.PeekAtIndex(AIndex: Integer)
  : TdxPDFReferencedObject;
begin
...
procedure TdxPDFPostScriptInterpreter.Execute
  (AOperators: TdxPDFReferencedObjects);
var
...
procedure TdxPDFPostScriptInterpreter.InternalExecute
  (AObj: TdxPDFReferencedObject);
begin
...
procedure TdxPDFPostScriptInterpreter.SetParser(const AValue
  : TdxPDFPostScriptFileParser);
begin
...
function TdxPDFPostScriptFileParser.Read(const AData: TBytes;
  APosition: Integer = 0): TdxPDFReferencedObjects;
var
  AObj: TdxPDFReferencedObject;
begin
...
begin
  Result := not TdxPDFUtils.IsSpace(Current) and not TdxPDFUtils.IsWhiteSpace
    (Current) and (Current <> TdxPDFDefinedSymbols.Comment) and
    (Current <> TdxPDFDefinedSymbols.NameIdentifier) and
    (Current <> TdxPDFDefinedSymbols.StartString) and
    (Current <> TdxPDFDefinedSymbols.EndString) and
    (Current <> TdxPDFDefinedSymbols.StartArray) and
    (Current <> TdxPDFDefinedSymbols.EndArray) and (Current <> BeginProcedure)
    and (Current <> EndProcedure);
end;
...
begin
  ...
  begin
    ...
    begin
      if dxPDFPostScriptOperatorFactory.TryGetClass(TdxPDFString(AObject).Value,
        AClass) then
        Result := AClass.Create
      else
        Result := TdxPDFPostScriptGetDictionaryElementOperator.Create
          (TdxPDFString(AObject).Value);
      dxPDFFreeObject(AObject);
      Exit;
    end;
    Result := AObject;
...
function TdxPDFPostScriptFileParser.ReadRadixNumber(AMode: Integer)
  : TdxPDFNumericObject;
var
...
begin
  ...
  begin
    ...
    case AMode of
      2:
        TdxPDFInteger(Result).Value := TdxPDFInteger(Result).Value * 2 +
          TdxPDFUtils.ConvertToDigit(Current);
      8:
        TdxPDFInteger(Result).Value := TdxPDFInteger(Result).Value * 8 +
          TdxPDFUtils.ConvertToDigit(Current);
      16:
        TdxPDFInteger(Result).Value := TdxPDFInteger(Result).Value * 16 +
          TdxPDFUtils.ByteToHexDigit(Current)
    end;
  end;
end;

function TdxPDFPostScriptFileParser.ReadCompositeObject
...
procedure TdxPDFPostScriptStringOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
...
procedure TdxPDFPostScriptComment.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
begin
  // do nothing
end;
...
procedure TdxPDFPostScriptAbsOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  AOperand: TObject;
  AValue: Integer;
begin
  ...
  begin
    ...
    AInterpreter.Stack.Push
      (TdxPDFDouble.Create(Abs(TdxPDFUtils.ConvertToDouble
      (AOperand as TdxPDFBase))));
end;
...
procedure TdxPDFPostScriptAddOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
...
begin
  ...
  if (AOperand1.ObjectType = otInteger) and (AOperand2.ObjectType = otInteger)
  then
    AInterpreter.Stack.Push(TdxPDFDouble.Create(TdxPDFInteger(AOperand1).Value +
      TdxPDFInteger(AOperand2).Value))
  else
    AInterpreter.Stack.Push
      (TdxPDFDouble.Create(TdxPDFUtils.ConvertToDouble(AOperand1) +
      TdxPDFUtils.ConvertToDouble(AOperand2)));
end;
...
procedure TdxPDFPostScriptArrayOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  I: Integer;
  AValue: TObject;
...
procedure TdxPDFPostScriptBeginOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  AObject: TdxPDFReferencedObject;
begin
...
procedure TdxPDFPostScriptCloseFileOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  AParser: TdxPDFPostScriptFileParser;
begin
...
procedure TdxPDFPostScriptCurrentDictionaryOperator.Execute
  (AInterpreter: TdxPDFPostScriptInterpreter);
begin
  if AInterpreter.DictionaryStack.Count <= 0 then
    TdxPDFUtils.RaiseTestException
      ('TdxPDFPostScriptCurrentDictionaryOperator.Execute');
...
procedure TdxPDFPostScriptCurrentFileOperator.Execute
  (AInterpreter: TdxPDFPostScriptInterpreter);
begin
...
procedure TdxPDFPostScriptCvrOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
begin
  AInterpreter.Stack.Push
    (TdxPDFDouble.Create(TdxPDFUtils.ConvertToDouble
    (AInterpreter.Stack.Pop as TdxPDFBase)));
end;
...
procedure TdxPDFPostScriptDefineFontOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
...
begin
  ...
  if (ADictionary = nil) or (AKey = nil) then
    TdxPDFUtils.RaiseTestException
      ('TdxPDFPostScriptDefineFontOperator.Execute');
...
procedure TdxPDFPostScriptIndexOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  AValue: TdxPDFReferencedObject;
begin
  ...
  AInterpreter.Stack.Push(AInterpreter.Stack.PeekAtIndex
    (TdxPDFNumericObjectAccess(AValue).InternalValue));
end;
...
procedure TdxPDFPostScriptRollOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
...
begin
  ...
  if (not(AShiftObject is TdxPDFNumericObject)) or
    (not(ACountObject is TdxPDFNumericObject)) then
...
procedure TdxPDFPostScriptSubOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
...
begin
  ...
  if (AMinuend.ObjectType = otInteger) and (ASubtrahend.ObjectType = otInteger)
  then
    AInterpreter.Stack.Push(TdxPDFInteger.Create(TdxPDFInteger(AMinuend).Value -
      TdxPDFInteger(ASubtrahend).Value))
  else
    AInterpreter.Stack.Push
      (TdxPDFDouble.Create(TdxPDFUtils.ConvertToDouble(AMinuend) -
      TdxPDFUtils.ConvertToDouble(ASubtrahend)));
end;
...
procedure TdxPDFPostScriptExchangeOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
begin
...
procedure TdxPDFPostScriptPopOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
begin
...
procedure TdxPDFPostScriptDupOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
begin
...
procedure TdxPDFPostScriptMulOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
...
begin
  ...
  if (AOperand1 is TdxPDFNumericObject) and (AOperand2 is TdxPDFNumericObject)
  then
    AInterpreter.Stack.Push(TdxPDFNumericObject.Create
      (TdxPDFNumericObjectAccess(AOperand1).GetValue * TdxPDFNumericObjectAccess
      (AOperand2).GetValue))
end;
...
procedure TdxPDFPostScriptDictOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  ADictionary: TdxPDFPostScriptDictionary;
...
begin
  ...
  begin
    ...
    begin
      ADictionary := TdxPDFPostScriptDictionary.Create
        (TdxPDFNumericObjectAccess(AOperand).GetValue);
...
procedure TdxPDFPostScriptDefOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
...
begin
  ...
  begin
    ...
    begin
      ADictionary := AInterpreter.DictionaryStack.Peek as
        TdxPDFPostScriptDictionary;
      ADictionary.Add(AName as TdxPDFReferencedObject,
        AValue as TdxPDFReferencedObject);
    end;
  end;
end;
...
procedure TdxPDFPostScriptReadonlyOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
begin
...
procedure TdxPDFPostScriptPutOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  AValue: TdxPDFReferencedObject;
  ...
  begin
    ...
    begin
      if TdxPDFInteger(AKeyOrIndex).Value < 0 then
        TdxPDFUtils.RaiseTestException;
      TdxPDFArray(AContainer).ElementList[TdxPDFInteger(AKeyOrIndex).Value] :=
        AValue as TdxPDFBase;
    end
    else
      TdxPDFUtils.RaiseTestException;
  end
  else if (AContainer is TdxPDFPostScriptDictionary) and
    (AKeyOrIndex is TdxPDFString) then
    TdxPDFPostScriptDictionary(AContainer)
      .Add(TdxPDFString(AKeyOrIndex), AValue)
  else
    TdxPDFUtils.RaiseTestException;
end;
...
procedure TdxPDFPostScriptForOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);

  procedure DoExecute(ALimit, AInitial, AIncrement: TdxPDFNumericObjectAccess;
    AProcedures: TdxPDFArray; AIsDouble: Boolean);
  var
    AValue: Double;
  begin
    ...
    if AIncrement.GetValue = 0 then
      TdxPDFUtils.RaiseTestException
    else if AIncrement.GetValue > 0 then
...
begin
  ...
  begin
    ...
    AIsDouble := (ALimitValue.ObjectType = otDouble) or
      (AInitialValue.ObjectType = otDouble) or
      (AIncrementValue.ObjectType = otDouble);
    DoExecute(TdxPDFNumericObjectAccess(ALimitValue),
      TdxPDFNumericObjectAccess(AInitialValue),
...
procedure TdxPDFPostScriptEndOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
begin
  if AInterpreter.DictionaryStack.Count > 0 then
...
procedure TdxPDFPostScriptEexecOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
begin
  // do nothing
end;
...
procedure TdxPDFPostScriptReadStringOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  ACompleted: Boolean;
  AData: TBytes;
...
begin
  ...
  if (AValue is TdxPDFString) and (AParserObject is TdxPDFPostScriptFileParser)
  then
  begin
    ...
    AInterpreter.Stack.Push
      (TdxPDFString.Create(TdxPDFUtils.ConvertToStr(AData)));
...
procedure TdxPDFPostScriptExecuteOnlyOperator.Execute
  (AInterpreter: TdxPDFPostScriptInterpreter);
begin
...
procedure TdxPDFPostScriptNoAccessOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  AObject: TdxPDFReferencedObject;
begin
  AObject := AInterpreter.Stack.Peek;
  if not(AObject is TdxPDFPostScriptDictionary) and not(AObject is TdxPDFString)
    and not(AObject is TdxPDFArray) then
    TdxPDFUtils.RaiseTestException;
end;
...
procedure TdxPDFPostScriptType1FontCustomOperator.Execute
  (AInterpreter: TdxPDFPostScriptInterpreter);
var
  I: Integer;
begin
...
function TdxPDFPostScriptType1FontCustomOperator.DoExecute
  (AInterpreter: TdxPDFPostScriptInterpreter; const AToken: string): Boolean;
var
  I: Integer;
  ADictionary: TdxPDFPostScriptDictionary;
begin
  ...
  begin
    ADictionary := AInterpreter.DictionaryStack.List[I]
      as TdxPDFPostScriptDictionary;
...
procedure TdxPDFPostScriptGetOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  AKeyName: string;
  ...
  begin
    ...
    begin
      if AObject is TdxPDFType1FontClassicFontProgram then
        AInterpreter.Stack.Push(TdxPDFType1FontClassicFontProgram(AObject)
          .CharStrings)
      else
        TdxPDFUtils.RaiseTestException;
    end
    else if TdxPDFPostScriptDictionary(AObject).TryGetValue(AKeyName,
      ATempObject) then
...
procedure TdxPDFPostScriptKnownOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
...
begin
  ...
  if (AKeyObject is TdxPDFString) and
    (ADictionaryObject is TdxPDFPostScriptDictionary) then
    AInterpreter.Stack.Push
      (TdxPDFBoolean.Create(TdxPDFPostScriptDictionary(ADictionaryObject)
      .TryGetValue(TdxPDFString(AKeyObject).Value, AKeyObject)))
  else
    TdxPDFUtils.RaiseTestException;
end;
...
procedure TdxPDFPostScriptMarkOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
begin
...
procedure TdxPDFPostScriptFindFontOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  ANameObject, AProgramObject: TdxPDFReferencedObject;
begin
  ANameObject := AInterpreter.Stack.Pop;
  if (ANameObject is TdxPDFString) and AInterpreter.FontDirectory.TryGetValue
    (TdxPDFString(ANameObject).Value, AProgramObject) and
...
procedure TdxPDFPostScriptFontDirectoryOperator.Execute
  (AInterpreter: TdxPDFPostScriptInterpreter);
begin
...
procedure TdxPDFPostScriptGeOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
...
procedure TdxPDFPostScriptGtOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  AOperand1, AOperand2: Double;
begin
...
procedure TdxPDFPostScriptIfElseOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
...
begin
  ...
  if (ACondition is TdxPDFBoolean) and (AProc1 is TdxPDFArray) and
    (AProc1 is TdxPDFArray) then
  begin
...
procedure TdxPDFPostScriptIfOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
...
procedure TdxPDFPostScriptLeOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  AOperand1, AOperand2: Double;
begin
...
procedure TdxPDFPostScriptLtOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  AOperand1, AOperand2: Double;
begin
...
procedure TdxPDFPostScriptStandardEncodingOperator.Execute
  (AInterpreter: TdxPDFPostScriptInterpreter);
var
  AArray: TdxPDFArray;
begin
...
procedure TdxPDFPostScriptSystemDictOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
begin
...
procedure TdxPDFPostScriptUserDictOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
begin
...
constructor TdxPDFPostScriptGetDictionaryElementOperator.Create
  (const AKey: string);
begin
  inherited Create;
  FKey := AKey;
...
procedure TdxPDFPostScriptGetDictionaryElementOperator.Execute
  (AInterpreter: TdxPDFPostScriptInterpreter);
begin
  // do nothing
end;
...
procedure TdxPDFPostScriptCopyOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
...
procedure TdxPDFPostScriptCviOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
begin
  AInterpreter.Stack.Push
    (TdxPDFDouble.Create(TdxPDFUtils.ConvertToInt
    (AInterpreter.Stack.Pop as TdxPDFBase)));
end;
...
procedure TdxPDFPostScriptDivOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  AOperand1, AOperand2: TObject;
begin
...
procedure TdxPDFPostScriptDTransformOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  ADX, ADY: TdxPDFBase;
begin
  ...
  AInterpreter.Stack.Push
    (TdxPDFDouble.Create(TdxPDFUtils.ConvertToDouble(ADX)));
  AInterpreter.Stack.Push
    (TdxPDFDouble.Create(TdxPDFUtils.ConvertToDouble(ADY)));
end;
...
procedure TdxPDFPostScriptNotOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
  AOperand: TdxPDFBase;
begin
  ...
  if AOperand is TdxPDFBoolean then
    AInterpreter.Stack.Push
      (TdxPDFBoolean.Create(not TdxPDFBoolean(AOperand).Value))
  else if AOperand is TdxPDFInteger then
    AInterpreter.Stack.Push
      (TdxPDFBoolean.Create(not TdxPDFInteger(AOperand).Value));
end;
...
procedure TdxPDFPostScriptExpOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
...
begin
  ...
  AOperand := AInterpreter.Stack.Pop as TdxPDFBase;
  if (AOperand is TdxPDFNumericObject) and (AExponent is TdxPDFNumericObject)
  then
    try
      AInterpreter.Stack.Push
        (TdxPDFDouble.Create(Power(TdxPDFNumericObjectAccess(AOperand).GetValue,
        TdxPDFNumericObjectAccess(AExponent).GetValue)));
    except
    end;
end;
...
procedure TdxPDFPostScriptExecOperator.Execute(AInterpreter
  : TdxPDFPostScriptInterpreter);
var
...
dxPDFPostScriptOperatorFactory.RegisterOperator
  (TdxPDFPostScriptExchangeOperator);
