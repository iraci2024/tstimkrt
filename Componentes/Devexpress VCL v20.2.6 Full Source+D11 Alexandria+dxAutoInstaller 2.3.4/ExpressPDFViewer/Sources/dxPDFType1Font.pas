...
uses
  Types, SysUtils, Windows, Classes, Generics.Defaults, Generics.Collections,
  cxGeometry, dxCoreClasses, dxFontFile,
  dxPDFBase, dxPDFTypes, dxPDFCore, dxPDFCharacterMapping, dxPDFFont,
  dxPDFPostScript, dxPDFText, dxPDFFontEncoding;
...
type
  ...
  TdxCompactFontFormatDictIndexOffsetOperatorList = class
    (TList<IdxCompactFontFormatDictIndexOffsetOperator>);
  ...
  TdxType1SupplementDataEntry = record
    Code: Byte;
    GID: SmallInt;
    class function Create(AGID: SmallInt; ACode: Byte)
      : TdxType1SupplementDataEntry; static;
  end;
  ...
  strict private
    ...
    class function IsInvalidBlueValues(const ABlueValues
      : TdxType1FontGlyphZones): Boolean; static;
    class function IsInvalidOtherBlues(const AOtherBlues
      : TdxType1FontGlyphZones): Boolean; static;
    class function IsInvalidStemSnap(const AStemSnap: TDoubleDynArray)
      : Boolean; static;
  protected
    procedure Validate;
  public const
  ...
  public
    ...
    property BlueValues: TdxType1FontGlyphZones read FBlueValues
      write FBlueValues;
    property ExpansionFactor: Double read FExpansionFactor
      write FExpansionFactor;
    property FamilyBlues: TdxType1FontGlyphZones read FFamilyBlues
      write FFamilyBlues;
    property FamilyOtherBlues: TdxType1FontGlyphZones read FFamilyOtherBlues
      write FFamilyOtherBlues;
    property ForceBold: Boolean read FForceBold write FForceBold;
    property ForceBoldThreshold: Double read FForceBoldThreshold
      write FForceBoldThreshold;
    property OtherBlues: TdxType1FontGlyphZones read FOtherBlues
      write FOtherBlues;
  ...
  strict private
    procedure OptionalSerializeDouble(ABuilder: TStringBuilder;
      const AKey: string; AValue: Double);
    procedure SerializeDouble(ABuilder: TStringBuilder; const AKey: string;
      AValue: Double);
    procedure SerializeString(ABuilder: TStringBuilder;
  ...
  protected
    ...
    procedure FillEntry(const AMapping: TSmallIntDynArray; ACode: Byte;
      AGID: SmallInt);
  public
    constructor Create(AStream: TdxFontFileStream); virtual;
    class function Parse(AStream: TdxFontFileStream)
      : TdxType1FontCustomEncoding; static;
    function GetCodeToGIDMapping(ACharset: TdxType1FontCustomCharset;
      AStringIndex: TdxCompactFontFormatStringIndex)
      : TSmallIntDynArray; override;
  ...
  protected
    ...
    procedure ProcessObject(AIndex: Integer; const AData: TBytes);
      virtual; abstract;
    procedure ProcessObjectCount(ACount: Integer); virtual; abstract;
    procedure WriteObject(AStream: TdxFontFileStream; AIndex: Integer);
      virtual; abstract;
  public
  ...
  protected
    ...
    function GetSIDToGIDMapping: TdxPDFSmallIntegerDictionary; virtual;
      abstract;
  ...
  public
    constructor Create; overload;
    constructor Create(AStream: TdxFontFileStream; ASize: Integer);
      overload; virtual;
    destructor Destroy; override;

    class function Parse(AStream: TdxFontFileStream; ASize: Integer)
      : TdxType1FontCustomCharset;
    function IsDefault: Boolean; virtual;
    ...
    property SIDToGIDMapping: TdxPDFSmallIntegerDictionary
      read GetSIDToGIDMapping; // write SetSIDToGIDMapping;
  end;
  ...
  protected
    ...
    procedure SetSIDToGIDMapping(AValue: TdxPDFSmallIntegerDictionary);
      override;
  ...
  protected
    ...
    procedure PopulateRanges(AStream: TdxFontFileStream; ASize: Integer);
      virtual; abstract;
    procedure ProcessRemain(ARange: TdxType1FontCustomRange; var ASID: SmallInt;
      var AIndex: Integer); virtual; abstract;
    procedure WriteRemain(AStream: TdxFontFileStream;
      ARange: TdxType1FontCustomRange); virtual; abstract;
  ...
  protected
    ...
    procedure PopulateRanges(AStream: TdxFontFileStream;
      ASize: Integer); override;
    procedure ProcessRemain(ARange: TdxType1FontCustomRange; var ASID: SmallInt;
      var AIndex: Integer); override;
    procedure WriteRemain(AStream: TdxFontFileStream;
      ARange: TdxType1FontCustomRange); override;
  public
    class function GetID: Integer; override;
  end;
  ...
  strict private
    FExpertCharset: TdxPDFSmallIntegerDictionary;
    FExpertSubsetCharset: TdxPDFSmallIntegerDictionary;
    FID: TdxType1FontPredefinedCharsetID;
    FISOAdobeCharset: TdxPDFSmallIntegerDictionary;
  ...
  public
    ...
    class function Parse(AStream: TdxFontFileStream; ACIDCount: Integer)
      : TdxType1FontCIDGlyphGroupSelector; static;
    procedure Write(AStream: TdxFontFileStream); virtual; abstract;
  ...
  TdxType1FontCIDGlyphGroupRangeSelector = class
    (TdxType1FontCIDGlyphGroupSelector)
  strict private
  type
    TRange = record
      ...
      class function Create(AFirst: SmallInt; AGlyphGroupIndex: Byte)
        : TRange; static;
    end;
  ...
  TdxType1FontCIDGlyphGroupArraySelector = class
    (TdxType1FontCIDGlyphGroupSelector)
  strict private
  ...
  public
    ...
    function GetCompositeMapping(const ACidToGidMap: TSmallIntDynArray)
      : TObject; virtual;
    function GetSimpleMapping(AFontEncoding: TdxPDFSimpleFontEncoding): TObject;
      virtual; abstract;
    ...
    property FontMatrix: TdxCompactFontFormatTarnsformationMatrix
      read FFontMatrix write FFontMatrix;
    property FontName: string read FFontName write FFontName;
    property PaintType: TdxType1FontPaintType read FPaintType write FPaintType;
    property PrivateData: TdxType1FontPrivateData read FPrivateData
      write SetPrivateData;
  ...
  public
    ...
    constructor Create(AMajorVersion, AMinorVersion: Byte;
      const AFontName: string; AStringIndex: TdxCompactFontFormatStringIndex;
      AGlobalSubrs: TList<TBytes>); reintroduce; overload;
    destructor Destroy; override;

    class function DefaultFontBBox: TdxRectF; static;
    class function DefaultFontMatrix
      : TdxCompactFontFormatTarnsformationMatrix; static;
    class function DefaultFontType: TdxType1FontType; static;
    class function Parse(const AData: TBytes)
      : TdxType1FontCompactFontProgram; static;

    function FontType: TdxType1FontType; override;
    function GetSimpleMapping(AFontEncoding: TdxPDFSimpleFontEncoding)
      : TObject; override;

    function Validate: Boolean; virtual;

    property BaseFontBlend: TDoubleDynArray read FBaseFontBlend
      write FBaseFontBlend;
  ...
  strict private
    ...
    FSupplement: Double;
    FUIDBase: Integer;
    procedure SetGlyphGroupData(const AValue
      : TObjectList<TdxType1FontCIDGlyphGroupData>);
    procedure SetGlyphGroupSelector(const AValue
      : TdxType1FontCIDGlyphGroupSelector);
  public const
  ...
  public
    ...
    property GlyphGroupData: TObjectList<TdxType1FontCIDGlyphGroupData>
      read FGlyphGroupData write SetGlyphGroupData;
    property GlyphGroupSelector: TdxType1FontCIDGlyphGroupSelector
      read FGlyphGroupSelector write SetGlyphGroupSelector;
...
{$ENDREGION}
  ...
  public
    ...
    class function Parse(const AFontName: string;
      AFontFileData: TdxPDFType1FontFileData)
      : TdxPDFType1FontClassicFontProgram; static;
    ...
    property CharStrings: TdxPDFPostScriptDictionary read FCharStrings
      write SetCharStrings;
  ...
  TdxCompactFontFormatDictIndexOperatorClass = class of
    TdxCompactFontFormatDictIndexOperator;
  ...
  protected
    ...
    function CalculateGlyphZonesSize(const AValue
      : TdxType1FontGlyphZones): Integer;
    ...
    function ToCIDFontProgram(AFontProgram: TdxType1FontCompactFontProgram)
      : TdxType1FontCompactCIDFontProgram;
    ...
    procedure WriteDoubleArray(AStream: TdxFontFileStream;
      const AValue: TDoubleDynArray);
    procedure WriteGlyphZones(AStream: TdxFontFileStream;
      const AValue: TdxType1FontGlyphZones);
    procedure WriteInteger(AStream: TdxFontFileStream; AValue: Integer);
  public
    constructor Create; overload;
    constructor Create(AStringIndex: TdxCompactFontFormatStringIndex;
      AOperands: TDoubleDynArray); overload; virtual;
    class function Code: Byte; virtual;

    function GetSize(AStringIndex: TdxCompactFontFormatStringIndex)
      : Integer; virtual;
    procedure Execute(AStream: TdxFontFileStream;
      AFontProgram: TdxType1FontCompactFontProgram); overload; virtual;
    procedure Execute(AStream: TdxFontFileStream;
      APrivateData: TdxType1FontCompactFontPrivateData); overload; virtual;
    procedure Execute(AStream: TdxFontFileStream;
      AGlyphGroupData: TdxType1FontCIDGlyphGroupData); overload; virtual;
    procedure Write(AStream: TdxFontFileStream;
      AStringIndex: TdxCompactFontFormatStringIndex); virtual;
  end;

  TdxCompactFontFormatDictIndexOperatorList = class
    (TObjectList<TdxCompactFontFormatDictIndexOperator>);

  { TdxCompactFontFormatDictIndexStringOperator }

  TdxCompactFontFormatDictIndexStringOperator = class
    (TdxCompactFontFormatDictIndexOperator)
  strict private
    FValue: string;
  protected
  ...
  public
    constructor Create(AStringIndex: TdxCompactFontFormatStringIndex;
      AOperands: TDoubleDynArray); overload; override;
    constructor Create(const AValue: string); overload;

    function GetSize(AStringIndex: TdxCompactFontFormatStringIndex)
      : Integer; override;
    procedure Write(AStream: TdxFontFileStream;
      AStringIndex: TdxCompactFontFormatStringIndex); override;
  end;

  { TdxCompactFontFormatDictIndexIntegerOperator }

  TdxCompactFontFormatDictIndexIntegerOperator = class
    (TdxCompactFontFormatDictIndexOperator)
  strict private
    FValue: Integer;
  protected
  ...
  TdxCompactFontFormatDictIndexDoubleOperator = class
    (TdxCompactFontFormatDictIndexOperator)
  strict private
    FValue: Double;
  protected
  ...
  TdxCompactFontFormatDictIndexXUIDOperator = class
    (TdxCompactFontFormatDictIndexOperator)
  strict private
    FXUID: TIntegerDynArray;
  protected
  ...
  public
    ...
    function GetSize(AStringIndex: TdxCompactFontFormatStringIndex)
      : Integer; override;
    procedure Execute(AStream: TdxFontFileStream;
      AFontProgram: TdxType1FontCompactFontProgram); override;
    procedure Write(AStream: TdxFontFileStream;
      AStringIndex: TdxCompactFontFormatStringIndex); override;
  end;
  ...
  TdxCompactFontFormatDictIndexNoticeOperator = class
    (TdxCompactFontFormatDictIndexStringOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexWeightOperator = class
    (TdxCompactFontFormatDictIndexStringOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexFamilyNameOperator = class
    (TdxCompactFontFormatDictIndexStringOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexFontBBoxOperator = class
    (TdxCompactFontFormatDictIndexOperator)
  strict private
    FFontBBox: TdxRectF;
  protected
  ...
  TdxCompactFontFormatDictIndexUniqueIDOperator = class
    (TdxCompactFontFormatDictIndexIntegerOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
      AFontProgram: TdxType1FontCompactFontProgram); override;
    procedure Execute(AStream: TdxFontFileStream;
      AGlyphGroupData: TdxType1FontCIDGlyphGroupData); override;
  end;

  { TdxCompactFontFormatDictIndexTwoByteOperator }

  TdxCompactFontFormatDictIndexTwoByteOperator = class
    (TdxCompactFontFormatDictIndexOperator)
  public const
    Marker = 12;
  public
  ...
  TdxCompactFontFormatDictIndexBaseFontNameOperator = class
    (TdxCompactFontFormatDictIndexStringTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexIntegerTwoByteOperator = class
    (TdxCompactFontFormatDictIndexTwoByteOperator)
  strict private
    FValue: Integer;
  protected
  ...
  TdxCompactFontFormatDictIndexDoubleTwoByteOperator = class
    (TdxCompactFontFormatDictIndexTwoByteOperator)
  strict private
    FValue: Double;
  protected
  ...
  TdxCompactFontFormatDictIndexPaintTypeOperator = class
    (TdxCompactFontFormatDictIndexIntegerTwoByteOperator)
  strict private
    FPaintType: TdxType1FontPaintType;
  public
  ...
  TdxCompactFontFormatDictIndexGlyphZonesOperator = class
    (TdxCompactFontFormatDictIndexOperator)
  strict private
  ...
  TdxCompactFontFormatDictIndexDoubleDynArrayOperator = class
    (TdxCompactFontFormatDictIndexTwoByteOperator)
  strict private
  ...
  TdxCompactFontFormatDictIndexBaseFontBlendOperator = class
    (TdxCompactFontFormatDictIndexDoubleDynArrayOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexCharstringTypeOperator = class
    (TdxCompactFontFormatDictIndexTwoByteOperator)
  strict private
    FFontType: TdxType1FontType;
  protected
  ...
  TdxCompactFontFormatDictIndexCIDCountOperator = class
    (TdxCompactFontFormatDictIndexIntegerTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexCIDFontVersionOperator = class
    (TdxCompactFontFormatDictIndexDoubleTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexCopyrightOperator = class
    (TdxCompactFontFormatDictIndexStringTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexCharsetOperator = class
    (TdxCompactFontFormatDictIndexOperator,
    IdxCompactFontFormatDictIndexOffsetOperator)
  strict private
    FCharset: TdxType1FontCustomCharset;
  ...
  TdxCompactFontFormatDictIndexCharStringsOperator = class
    (TdxCompactFontFormatDictIndexOperator,
    IdxCompactFontFormatDictIndexOffsetOperator)
  strict private
  ...
  TdxCompactFontFormatDictIndexEncodingOperator = class
    (TdxCompactFontFormatDictIndexOperator,
    IdxCompactFontFormatDictIndexOffsetOperator)
  strict private
    FEncoding: TdxType1FontEncoding;
  ...
  TdxCompactFontFormatDictIndexPrivateOperator = class
    (TdxCompactFontFormatDictIndexOperator,
    IdxCompactFontFormatDictIndexOffsetOperator)
  strict private
    FLength: Integer;
  ...
  strict private
    ...
    FStringIndex: TdxCompactFontFormatStringIndex;
  public
    constructor Create(const AData: TdxType1FontCIDGlyphGroupData;
      AStringIndex: TdxCompactFontFormatStringIndex);
    destructor Destroy; override;
    ...
    property PrivateOperator: TdxCompactFontFormatDictIndexPrivateOperator
      read FPrivateOperator;
  end;

  { TdxCompactFontFormatDictIndexFDArrayOperator }

  TdxCompactFontFormatDictIndexFDArrayOperator = class
    (TdxCompactFontFormatDictIndexTwoByteOperator,
    IdxCompactFontFormatDictIndexOffsetOperator)
  strict private
    FGlyphGroupData: TObjectList<TdxType1FontCIDGlyphGroupData>;
    ...
    function GetOffsetOperators
      : TdxCompactFontFormatDictIndexOffsetOperatorList;
  ...
  public
    ...
    property OffsetOperators: TdxCompactFontFormatDictIndexOffsetOperatorList
      read GetOffsetOperators;
  end;

  { TdxCompactFontFormatDictIndexUnderlinePositionOperator }

  TdxCompactFontFormatDictIndexUnderlinePositionOperator = class
    (TdxCompactFontFormatDictIndexDoubleTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexUnderlineThicknessOperator = class
    (TdxCompactFontFormatDictIndexDoubleTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexFontMatrixOperator = class
    (TdxCompactFontFormatDictIndexTwoByteOperator)
  strict private
    FFontMatrix: TdxCompactFontFormatTarnsformationMatrix;
  protected
  ...
  public
    constructor Create(AStringIndex: TdxCompactFontFormatStringIndex;
      AOperands: TDoubleDynArray); overload; override;
    constructor Create(const AFontMatrix
      : TdxCompactFontFormatTarnsformationMatrix); overload;
  ...
  TdxCompactFontFormatPrivateDictIndexSubrsOperator = class
    (TdxCompactFontFormatDictIndexOperator)
  strict private
    FOffset: Integer;
  ...
  public
    ...
    procedure Execute(AStream: TdxFontFileStream;
      APrivateData: TdxType1FontCompactFontPrivateData); override;
    procedure Write(AStream: TdxFontFileStream;
      AStringIndex: TdxCompactFontFormatStringIndex); override;
    procedure WriteData(AStream: TdxFontFileStream);
  end;
  ...
  TdxCompactFontFormatPrivateDictIndexBlueFuzzOperator = class
    (TdxCompactFontFormatDictIndexIntegerTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatPrivateDictIndexBlueScaleOperator = class
    (TdxCompactFontFormatDictIndexDoubleTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatPrivateDictIndexBlueShiftOperator = class
    (TdxCompactFontFormatDictIndexDoubleTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatPrivateDictIndexDefaultWidthXOperator = class
    (TdxCompactFontFormatDictIndexDoubleOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatPrivateDictIndexExpansionFactorOperator = class
    (TdxCompactFontFormatDictIndexDoubleTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatPrivateDictIndexBlueValuesOperator = class
    (TdxCompactFontFormatDictIndexGlyphZonesOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatPrivateDictIndexFamilyBluesOperator = class
    (TdxCompactFontFormatDictIndexGlyphZonesOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatPrivateDictIndexFamilyOtherBluesOperator = class
    (TdxCompactFontFormatDictIndexGlyphZonesOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatPrivateDictIndexBooleanTwoByteOperator = class
    (TdxCompactFontFormatDictIndexTwoByteOperator)
  strict private
    FValue: Boolean;
  protected
  ...
  TdxCompactFontFormatPrivateDictIndexForceBoldOperator = class
    (TdxCompactFontFormatPrivateDictIndexBooleanTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatPrivateDictIndexForceBoldThresholdOperator = class
    (TdxCompactFontFormatDictIndexDoubleTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatPrivateDictIndexLanguageGroupOperator = class
    (TdxCompactFontFormatDictIndexIntegerTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatPrivateDictIndexNominalWidthXOperator = class
    (TdxCompactFontFormatDictIndexDoubleOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatPrivateDictIndexOtherBluesOperator = class
    (TdxCompactFontFormatDictIndexGlyphZonesOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatPrivateDictIndexStdHWOperator = class
    (TdxCompactFontFormatDictIndexDoubleOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatPrivateDictIndexStdVWOperator = class
    (TdxCompactFontFormatDictIndexDoubleOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatPrivateDictIndexStemSnapHOperator = class
    (TdxCompactFontFormatDictIndexDoubleDynArrayOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatPrivateDictIndexStemSnapVOperator = class
    (TdxCompactFontFormatDictIndexDoubleDynArrayOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexVersionOperator = class
    (TdxCompactFontFormatDictIndexStringOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexUIDBaseOperator = class
    (TdxCompactFontFormatDictIndexIntegerTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexStrokeWidthOperator = class
    (TdxCompactFontFormatDictIndexDoubleTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexROSOperator = class
    (TdxCompactFontFormatDictIndexTwoByteOperator)
  strict private
    FOrdering: string;
    FRegistry: string;
  ...
  public
    constructor Create(AStringIndex: TdxCompactFontFormatStringIndex;
      AOperands: TDoubleDynArray); overload; override;
    constructor Create(const ARegistry, AOrdering: string;
      ASupplement: Double); overload;
  ...
  TdxCompactFontFormatDictIndexPostScriptOperator = class
    (TdxCompactFontFormatDictIndexStringTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexItalicAngleOperator = class
    (TdxCompactFontFormatDictIndexDoubleTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexIsFixedPitchOperator = class
    (TdxCompactFontFormatPrivateDictIndexBooleanTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexFontNameOperator = class
    (TdxCompactFontFormatDictIndexStringTwoByteOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexFullNameOperator = class
    (TdxCompactFontFormatDictIndexStringOperator)
  public
    class function Code: Byte; override;
    procedure Execute(AStream: TdxFontFileStream;
  ...
  TdxCompactFontFormatDictIndexFDSelectOperator = class
    (TdxCompactFontFormatDictIndexTwoByteOperator,
    IdxCompactFontFormatDictIndexOffsetOperator)
  strict private
    FOffset: Integer;
  ...
  public
    ...
    constructor Create(const AData: TBytes; AStartPosition: Integer;
      ADataLength: Integer); overload;
  ...
  public
    class function CreateCipher(const AData: TBytes;
      AStartPosition, ADataLength: Integer): TdxPDFType1FontEexecCipher; static;
    class function IsASCIICipher(const AData: TBytes; AStartPosition: Integer)
      : Boolean; static;
  ...
  public
    ...
    class function Write(AFontProgram: TdxType1FontCompactFontProgram)
      : TBytes; static;
    property Name: string read FName;
    property OffsetOperators: TdxCompactFontFormatDictIndexOffsetOperatorList
      read FOffsetOperators;
    property Operators: TdxCompactFontFormatDictIndexOperatorList
      read FOperators;
  end;
...
uses
  Math, dxCore, cxVariants, dxStringHelper, dxPDFFontUtils, dxPDFUtils;
...
type
  ...
  strict private
    FDictionary: TDictionary<Integer,
      TdxCompactFontFormatDictIndexOperatorClass>;
  protected
    procedure RegisterOperator
      (AClass: TdxCompactFontFormatDictIndexOperatorClass);
    procedure UnregisterOperator
      (AClass: TdxCompactFontFormatDictIndexOperatorClass);
  public
    constructor Create;
    destructor Destroy; override;

    function GetOperatorClass(ACode: Byte)
      : TdxCompactFontFormatDictIndexOperatorClass;
  end;
  ...
  protected
    ...
    function ParseOperator(AValue: Byte; AOperands: TDoubleDynArray)
      : TdxCompactFontFormatDictIndexOperator;
  public
  ...
  TdxCompactFontFormatTopDictIndexParser = class
    (TdxCompactFontFormatDictIndexParser)
  strict private
    FStringIndex: TdxCompactFontFormatStringIndex;
  protected
    function CreateOperator(AClass: TdxCompactFontFormatDictIndexOperatorClass;
      ...
      : TdxCompactFontFormatDictIndexOperator; override;
  public
    constructor Create(AStringIndex: TdxCompactFontFormatStringIndex;
      const AData: TBytes);

    class function Parse(AMajorVersion, AMinorVersion: Byte;
      const AFontName: string; AStringIndex: TdxCompactFontFormatStringIndex;
      AGlobalSubrs: TList<TBytes>; AStream: TdxFontFileStream;
      const AObjectData: TBytes): TdxType1FontCompactFontProgram; overload;
    class function Parse(AStream: TdxFontFileStream;
      AStringIndex: TdxCompactFontFormatStringIndex; const AObjectData: TBytes)
      : TdxType1FontCIDGlyphGroupData; overload;
  end;

  { TdxCompactFontFormatPrivateDictIndexParser }

  TdxCompactFontFormatPrivateDictIndexParser = class
    (TdxCompactFontFormatDictIndexParser)
  protected
    function CreateOperator(AClass: TdxCompactFontFormatDictIndexOperatorClass;
      AOperands: TDoubleDynArray)
      : TdxCompactFontFormatDictIndexOperator; override;
  public
    class function Parse(AStream: TdxFontFileStream; const AData: TBytes)
      : TdxType1FontCompactFontPrivateData; static;
  end;
...
var
  dxgPDFCompactFontFormatDictIndexOneByteOperatorFactory
    : TdxCompactFontFormatDictIndexOperatorFactory;
  dxgPDFCompactFontFormatDictIndexTwoByteOperatorFactory
    : TdxCompactFontFormatDictIndexOperatorFactory;
...
function dxCompactFontFormatDictIndexOneByteOperatorFactory
  : TdxCompactFontFormatDictIndexOperatorFactory;
begin
  if dxgPDFCompactFontFormatDictIndexOneByteOperatorFactory = nil then
    dxgPDFCompactFontFormatDictIndexOneByteOperatorFactory :=
      TdxCompactFontFormatDictIndexOperatorFactory.Create;
  Result := dxgPDFCompactFontFormatDictIndexOneByteOperatorFactory;
end;

function dxCompactFontFormatDictIndexTwoByteOperatorFactory
  : TdxCompactFontFormatDictIndexOperatorFactory;
begin
...
constructor TdxCompactFontFormatTopDictIndexWriter.Create
...
begin
  ...
  FGlobalSubrs := TdxCompactFontFormatBinaryIndex.CreateEx
    (AFontProgram.GlobalSubrs);
  ...
  ACidFontProgram := Safe<TdxType1FontCompactCIDFontProgram>.Cast(AFontProgram);
  if ACidFontProgram <> nil then
  begin
    FOperators.Add(TdxCompactFontFormatDictIndexROSOperator.Create
      (ACidFontProgram.Registry, ACidFontProgram.Ordering,
    ...
    if ANumber <> TdxType1FontCompactCIDFontProgram.DefaultCIDFontVersion then
      FOperators.Add(TdxCompactFontFormatDictIndexCIDFontVersionOperator.Create
        (ANumber));
    AInteger := ACidFontProgram.CIDCount;
    if AInteger <> TdxType1FontCompactCIDFontProgram.DefaultCIDCount then
      FOperators.Add(TdxCompactFontFormatDictIndexCIDCountOperator.Create
        (AInteger));
    AUidBase := ACidFontProgram.UIDBase;
    if TdxPDFUtils.IsIntegerValid(AUidBase) then
      FOperators.Add(TdxCompactFontFormatDictIndexUIDBaseOperator.Create
        (AUidBase));
    if ACidFontProgram.GlyphGroupSelector <> nil then
    begin
      AFdSelectOperator := TdxCompactFontFormatDictIndexFDSelectOperator.Create
        (ACidFontProgram.GlyphGroupSelector);
      FOperators.Add(AFdSelectOperator);
      FOffsetOperators.Add(AFdSelectOperator);
    end;
    if (ACidFontProgram.GlyphGroupData <> nil) and
      (ACidFontProgram.GlyphGroupData.Count > 0) then
    begin
      AFdArrayOperator := TdxCompactFontFormatDictIndexFDArrayOperator.Create
        (ACidFontProgram.GlyphGroupData, FStringIndex);
  ...
  if AStr <> '' then
    FOperators.Add(TdxCompactFontFormatDictIndexFamilyNameOperator.
      Create(AStr));
  ...
  if AFontInfo.IsFixedPitch then
    FOperators.Add(TdxCompactFontFormatDictIndexIsFixedPitchOperator.
      Create(True));
  ANumber := AFontInfo.ItalicAngle;
  if ANumber <> TdxType1FontInfo.DefaultItalicAngle then
    FOperators.Add(TdxCompactFontFormatDictIndexItalicAngleOperator.Create
      (ANumber));
  ANumber := AFontInfo.UnderlinePosition;
  if ANumber <> TdxType1FontInfo.DefaultUnderlinePosition then
    FOperators.Add(TdxCompactFontFormatDictIndexUnderlinePositionOperator.Create
      (ANumber));
  ANumber := AFontInfo.UnderlineThickness;
  if ANumber <> TdxType1FontInfo.DefaultUnderlineThickness then
    FOperators.Add(TdxCompactFontFormatDictIndexUnderlineThicknessOperator.
      Create(ANumber));
  AFontType := AFontProgram.FontType;
  if AFontType <> TdxType1FontCompactFontProgram.DefaultFontType then
    FOperators.Add(TdxCompactFontFormatDictIndexCharstringTypeOperator.Create
      (AFontType));
  AFontMatrix := AFontProgram.FontMatrix;
  if not AFontMatrix.IsEqual(AFontMatrix,
    TdxType1FontCompactFontProgram.DefaultFontMatrix) then
    FOperators.Add(TdxCompactFontFormatDictIndexFontMatrixOperator.Create
      (AFontMatrix));
  AInteger := AFontProgram.UniqueID;
  if AInteger <> TdxType1CustomFontProgram.DefaultUniqueID then
    FOperators.Add(TdxCompactFontFormatDictIndexUniqueIDOperator.Create
      (AInteger));
  if AFontProgram.PaintType <> ptFilled then
    FOperators.Add(TdxCompactFontFormatDictIndexPaintTypeOperator.Create
      (AFontProgram.PaintType));
  AFontBBox := AFontProgram.FontBBox;
  if not TdxPDFUtils.RectIsEqual(AFontBBox,
    TdxType1FontCompactFontProgram.DefaultFontBBox, 0.001) then
    FOperators.Add(TdxCompactFontFormatDictIndexFontBBoxOperator.Create
      (AFontBBox));
  ANumber := AFontProgram.StrokeWidth;
  if ANumber <> TdxType1CustomFontProgram.DefaultStrokeWidth then
    FOperators.Add(TdxCompactFontFormatDictIndexStrokeWidthOperator.Create
      (ANumber));
  ...
  begin
    AEncodingOperator := TdxCompactFontFormatDictIndexEncodingOperator.Create
      (AEncoding);
  ...
  begin
    ACharsetOperator := TdxCompactFontFormatDictIndexCharsetOperator.Create
      (ACharset);
  ...
  begin
    APrivateOperator := TdxCompactFontFormatDictIndexPrivateOperator.Create
      (APrivateData);
  ...
  if AStr <> '' then
    FOperators.Add(TdxCompactFontFormatDictIndexPostScriptOperator.
      Create(AStr));
  AStr := AFontInfo.BaseFontName;
  if AStr <> '' then
    FOperators.Add(TdxCompactFontFormatDictIndexBaseFontNameOperator.
      Create(AStr));
  ABaseFontBlend := AFontProgram.BaseFontBlend;
  if ABaseFontBlend <> nil then
    FOperators.Add(TdxCompactFontFormatDictIndexBaseFontBlendOperator.Create
      (ABaseFontBlend));
  ...
  begin
    ...
    AOffset := Length(FName) + FStringIndex.DataLength +
      FGlobalSubrs.DataLength + 26;
    for AOper in FOperators do
      Inc(AOffset, AOper.GetSize(FStringIndex));
    for I := 0 to FOffsetOperators.Count - 1 do
    begin
      AOffsetOperator := FOffsetOperators[I]
        as IdxCompactFontFormatDictIndexOffsetOperator;
...
class function TdxCompactFontFormatTopDictIndexWriter.
  Write(AFontProgram: TdxType1FontCompactFontProgram): TBytes;
var
...
procedure TdxCompactFontFormatTopDictIndexWriter.DoWrite
  (AStream: TdxFontFileStream);
var
  I: Integer;
...
begin
  ...
  try
    ...
    ATopDictIndex := TdxCompactFontFormatTopDictIndex.CreateEx
      (ATopDictIndexStream.Data);
    try
  ...
  for I := 0 to FOffsetOperators.Count - 1 do
    IdxCompactFontFormatDictIndexOffsetOperator(FOffsetOperators[I])
      .WriteData(AStream);
end;

{ TdxCompactFontFormatPrivateDictIndexParser }

class function TdxCompactFontFormatPrivateDictIndexParser.Parse
  (AStream: TdxFontFileStream; const AData: TBytes)
  : TdxType1FontCompactFontPrivateData;
var
...
function TdxCompactFontFormatPrivateDictIndexParser.CreateOperator
  (AClass: TdxCompactFontFormatDictIndexOperatorClass;
  AOperands: TDoubleDynArray): TdxCompactFontFormatDictIndexOperator;
begin
...
constructor TdxCompactFontFormatPrivateDictIndexWriter.Create
  (APrivateData: TdxType1FontPrivateData);
var
...
begin
  ...
  if Length(APrivateData.BlueValues) > 0 then
    FOperators.Add(TdxCompactFontFormatPrivateDictIndexBlueValuesOperator.Create
      (APrivateData.BlueValues));
  if Length(APrivateData.OtherBlues) > 0 then
    FOperators.Add(TdxCompactFontFormatPrivateDictIndexOtherBluesOperator.Create
      (APrivateData.OtherBlues));
  if Length(APrivateData.FamilyBlues) > 0 then
    FOperators.Add(TdxCompactFontFormatPrivateDictIndexFamilyBluesOperator.
      Create(APrivateData.FamilyBlues));
  if Length(APrivateData.FamilyOtherBlues) > 0 then
    FOperators.Add(TdxCompactFontFormatPrivateDictIndexFamilyOtherBluesOperator.
      Create(APrivateData.FamilyOtherBlues));
  if not SameValue(APrivateData.BlueScale,
    TdxType1FontPrivateData.DefaultBlueScale) then
    FOperators.Add(TdxCompactFontFormatPrivateDictIndexBlueScaleOperator.Create
      (APrivateData.BlueScale));
  if not SameValue(APrivateData.BlueShift,
    TdxType1FontPrivateData.DefaultBlueShift) then
    FOperators.Add(TdxCompactFontFormatPrivateDictIndexBlueShiftOperator.Create
      (APrivateData.BlueShift));
  if APrivateData.BlueFuzz <> TdxType1FontCompactFontPrivateData.DefaultBlueFuzz
  then
    FOperators.Add(TdxCompactFontFormatPrivateDictIndexBlueFuzzOperator.Create
      (APrivateData.BlueFuzz));
  if not SameValue(APrivateData.StdHW, dxPDFInvalidValue) then
    FOperators.Add(TdxCompactFontFormatPrivateDictIndexStdHWOperator.Create
      (APrivateData.StdHW));
  if not SameValue(APrivateData.StdVW, dxPDFInvalidValue) then
    FOperators.Add(TdxCompactFontFormatPrivateDictIndexStdVWOperator.Create
      (APrivateData.StdVW));
  if Length(APrivateData.StemSnapH) > 0 then
    FOperators.Add(TdxCompactFontFormatPrivateDictIndexStemSnapHOperator.Create
      (APrivateData.StemSnapH));
  if Length(APrivateData.StemSnapV) > 0 then
    FOperators.Add(TdxCompactFontFormatPrivateDictIndexStemSnapVOperator.Create
      (APrivateData.StemSnapV));
  if APrivateData.ForceBold then
    FOperators.Add(TdxCompactFontFormatPrivateDictIndexForceBoldOperator.Create
      (APrivateData.ForceBold));
  if not SameValue(APrivateData.ForceBoldThreshold, dxPDFInvalidValue) then
    FOperators.Add
      (TdxCompactFontFormatPrivateDictIndexForceBoldThresholdOperator.Create
      (APrivateData.ForceBoldThreshold));
  ...
  begin
    ...
    if ACompactFontPrivateData.LanguageGroup <>
      TdxType1FontCompactFontPrivateData.DefaultLanguageGroup then
      FOperators.Add(TdxCompactFontFormatPrivateDictIndexLanguageGroupOperator.
        Create(ACompactFontPrivateData.LanguageGroup));
    if not SameValue(ACompactFontPrivateData.ExpansionFactor,
      TdxType1FontPrivateData.DefaultExpansionFactor) then
      FOperators.Add
        (TdxCompactFontFormatPrivateDictIndexExpansionFactorOperator.Create
        (ACompactFontPrivateData.ExpansionFactor));
    if (ACompactFontPrivateData.Subrs <> nil) and
      (ACompactFontPrivateData.Subrs.Count > 0) then
    begin
      FSubrsOperator := TdxCompactFontFormatPrivateDictIndexSubrsOperator.Create
        (ACompactFontPrivateData.Subrs);
    ...
    if not SameValue(ANumber, ACompactFontPrivateData.DefaultDefaultWidthX) then
      FOperators.Add(TdxCompactFontFormatPrivateDictIndexDefaultWidthXOperator.
        Create(ANumber));
    ANumber := ACompactFontPrivateData.NominalWidthX;
    if not SameValue(ANumber, ACompactFontPrivateData.DefaultNominalWidthX) then
      FOperators.Add(TdxCompactFontFormatPrivateDictIndexNominalWidthXOperator.
        Create(ANumber));
  end;
...
procedure TdxCompactFontFormatPrivateDictIndexWriter.
  Write(AStream: TdxFontFileStream);
var
  AOperator: TdxCompactFontFormatDictIndexOperator;
begin
...
constructor TdxPDFType1FontCipher.Create(const AData: TBytes;
  AStartPosition: Integer; ADataLength: Integer);
begin
  Create(AData);
...
begin
  ...
  begin
    ...
    if ANextChar < 0 then
      Break
    else if ASkipBytesCount > 0 then
      Dec(ASkipBytesCount)
    else
...
class function TdxPDFType1FontEexecCipher.IsASCIICipher(const AData: TBytes;
...
begin
  ...
  begin
    if IsASCIICipher(AData, AStartPosition) then
      Result := TdxPDFType1FontEexecASCIICipher.Create(AData, AStartPosition,
        ADataLength)
    else
      Result := TdxPDFType1FontEexecBinaryCipher.Create(AData, AStartPosition,
        ADataLength);
  end
  else
    Result := nil;
...
begin
  ...
  if (AHigh < 0) or (ALow < 0) then
    ...
    try
      Result := SmallInt(TdxPDFUtils.ByteToHexDigit(Byte(AHigh)) shl 4 +
        TdxPDFUtils.ByteToHexDigit(Byte(ALow)));
    except
      Result := -1;
    end;
end;
...
begin
  inherited Create;
  FDictionary :=
    TDictionary<Integer, TdxCompactFontFormatDictIndexOperatorClass>.Create;
end;
...
function TdxCompactFontFormatDictIndexOperatorFactory.GetOperatorClass
  (ACode: Byte): TdxCompactFontFormatDictIndexOperatorClass;
begin
  if not FDictionary.TryGetValue(ACode, Result) then
    Result := nil;
end;

procedure TdxCompactFontFormatDictIndexOperatorFactory.RegisterOperator
  (AClass: TdxCompactFontFormatDictIndexOperatorClass);
begin
...
procedure TdxCompactFontFormatDictIndexOperatorFactory.UnregisterOperator
  (AClass: TdxCompactFontFormatDictIndexOperatorClass);
begin
...
function TdxCompactFontFormatNibbleValueConstructor.AddNibble
  (ANibble: Integer): Boolean;
var
  S: string;
begin
  Result := False;
...
function TdxCompactFontFormatDictIndexParser.ParseOperators
  : TdxCompactFontFormatDictIndexOperatorList;
var
  AOperands: TDoubleDynArray;
  AOperand: Integer;
  AValue: Byte;
...
begin
  ...
  begin
    ...
    else if AValue = 30 then
    begin
      ANibbleValueConstructor :=
        TdxCompactFontFormatNibbleValueConstructor.Create;
      try
        while HasMoreData do
        begin
          AValue := GetNextByte;
          if ANibbleValueConstructor.AddNibble(AValue shr 4) or
            ANibbleValueConstructor.AddNibble(AValue and $0F) then
            Break;
        end;
    ...
    else if InRange(AValue, 32, 246) then
      TdxPDFUtils.AddValue(AValue - 139, AOperands)
    else if InRange(AValue, 247, 250) then
      TdxPDFUtils.AddValue((AValue - 247) * 256 + GetNextByte + 108, AOperands)
    else if InRange(AValue, 251, 254) then
...
function TdxCompactFontFormatDictIndexParser.ParseOperator(AValue: Byte;
  AOperands: TDoubleDynArray): TdxCompactFontFormatDictIndexOperator;
var
  AClass: TdxCompactFontFormatDictIndexOperatorClass;
begin
  ...
  begin
    if HasMoreData then
      AClass := dxCompactFontFormatDictIndexTwoByteOperatorFactory.
        GetOperatorClass(GetNextByte);
  end
  else
    AClass := dxCompactFontFormatDictIndexOneByteOperatorFactory.
      GetOperatorClass(AValue);
  if AClass <> nil then
...
constructor TdxCompactFontFormatTopDictIndexParser.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; const AData: TBytes);
begin
  inherited Create(AData);
  FStringIndex := AStringIndex;
end;

class function TdxCompactFontFormatTopDictIndexParser.Parse(AMajorVersion,
  AMinorVersion: Byte; const AFontName: string;
  AStringIndex: TdxCompactFontFormatStringIndex; AGlobalSubrs: TList<TBytes>;
  AStream: TdxFontFileStream; const AObjectData: TBytes)
  : TdxType1FontCompactFontProgram;
var
...
begin
  AParser := TdxCompactFontFormatTopDictIndexParser.Create(AStringIndex,
    AObjectData);
  try
    ...
    AOperators := AParser.ParseOperators;
    try
      if (AOperators.Count > 0) and
        (AOperators[0] is TdxCompactFontFormatDictIndexROSOperator) then
        Result := TdxType1FontCompactCIDFontProgram.Create(AMajorVersion,
          AMinorVersion, AFontName, AStringIndex, AGlobalSubrs)
      else
        Result := TdxType1FontCompactFontProgram.Create(AMajorVersion,
          AMinorVersion, AFontName, AStringIndex, AGlobalSubrs);
      for AOperator in AOperators do
        ...
        begin
          ...
          begin
            if not(AOperator is TdxCompactFontFormatDictIndexFDSelectOperator)
            then
              AOperator.Execute(AStream, Result)
            else
              AFdSelectOperator := TdxCompactFontFormatDictIndexFDSelectOperator
...
class function TdxCompactFontFormatTopDictIndexParser.Parse
  (AStream: TdxFontFileStream; AStringIndex: TdxCompactFontFormatStringIndex;
  const AObjectData: TBytes): TdxType1FontCIDGlyphGroupData;
var
  AOperator: TdxCompactFontFormatDictIndexOperator;
  AOperators: TdxCompactFontFormatDictIndexOperatorList;
  AParser: TdxCompactFontFormatTopDictIndexParser;
...
function TdxCompactFontFormatTopDictIndexParser.CreateOperator
  (AClass: TdxCompactFontFormatDictIndexOperatorClass;
  AOperands: TDoubleDynArray): TdxCompactFontFormatDictIndexOperator;
begin
...
procedure TdxPDFType1FontDescriptor.ReadFontFile(ADictionary
  ...
  begin
    ...
    begin
      ...
      if Length(OpenTypeFontFileData) > 0 then
        CompactFontFileData := TdxFontFileHelper.GetCFFData
          (OpenTypeFontFileData)
      else
        CompactFontFileData := TdxFontFileHelper.GetValidCFFData
          (AStream.UncompressedData);
    end;
  end;
end;

procedure TdxPDFType1FontDescriptor.WriteFontFile(AHelper: TdxPDFWriterHelper;
  ADictionary: TdxPDFWriterDictionary);
begin
  if not FontFileData.IsNull then
    ADictionary.AddReference(TdxPDFKeywords.FontFile,
      WriteFontFileData(AHelper, FontFileData))
  else
...
begin
  if FontDescriptor.CompactFontFileData <> nil then
    Result := TdxPDFCFFFontProgramFacade.CreateForSimpleFont(Self,
      FontDescriptor.CompactFontFileData)
  else if not FontDescriptor.FontFileData.IsNull then
    Result := TdxPDFType1FontProgramFacade.CreateForSimpleFont(Self,
      FontDescriptor.FontFileData)
  else
    Result := TdxPDFNonEmbeddedFontProgramFacade.CreateForSimpleFont(Self);
end;

function TdxPDFType1Font.GetFontDescriptorClass
...
begin
  Result := (BaseFont = TdxPDFKeywords.CourierFontName) or
...
procedure TdxPDFType1Font.ReadFontDescriptor(ADictionary
  : TdxPDFReaderDictionary);
var
...
begin
  ...
  if FUseDefaultFontDescriptor then
    AFontDescriptorDictionary :=
      TdxPDFCustomFontDescriptor.CreateStandardDictionary(Repository, BaseFont)
...
class function TdxType1FontGlyphZone.Create(ABotom, ATop: Double)
  : TdxType1FontGlyphZone;
begin
...
class function TdxType1SupplementDataEntry.Create(AGID: SmallInt; ACode: Byte)
  : TdxType1SupplementDataEntry;
begin
  Result.Code := ACode;
  Result.GID := AGID;
...
class function TdxType1FontPrivateData.IsInvalidStemSnap(const AStemSnap
  : TDoubleDynArray): Boolean;
begin
  Result := (AStemSnap <> nil) and (Length(AStemSnap) > 12);
end;

class function TdxType1FontPrivateData.IsInvalidBlueValues(const ABlueValues
  : TdxType1FontGlyphZones): Boolean;
begin
  Result := (ABlueValues <> nil) and (Length(ABlueValues) > 7);
end;

class function TdxType1FontPrivateData.IsInvalidOtherBlues(const AOtherBlues
  : TdxType1FontGlyphZones): Boolean;
begin
...
begin
  if (IsInvalidBlueValues(FBlueValues)) or (IsInvalidOtherBlues(FOtherBlues)) or
    (IsInvalidBlueValues(FFamilyBlues)) or
    (IsInvalidOtherBlues(FFamilyOtherBlues)) or (IsInvalidStemSnap(FStemSnapH))
    or (IsInvalidStemSnap(FStemSnapV)) then
    TdxPDFUtils.RaiseException;
end;
...
procedure TdxType1FontCompactFontPrivateData.SetSubrs
  (const AValue: TList<TBytes>);
begin
  FSubrs.Clear;
...
procedure TdxPDFType1FontClassicFontInfo.
  Read(ADictionary: TdxPDFPostScriptDictionary);
var
  I: Integer;
...
begin
  ...
  begin
    ...
    if AEntry.Key = ItalicAngleDictionaryKey then
      ItalicAngle := TdxPDFUtils.ConvertToDouble(AEntry.Value,
        dxPDFInvalidValue);
    if AEntry.Key = UnderlinePositionDictionaryKey then
      UnderlinePosition := TdxPDFUtils.ConvertToDouble(AEntry.Value,
        dxPDFInvalidValue);
    if AEntry.Key = UnderlineThicknessDictionaryKey then
      UnderlineThickness := TdxPDFUtils.ConvertToDouble(AEntry.Value,
        dxPDFInvalidValue);
...
begin
  ...
  try
    ...
    SerializeDouble(ABuilder, UnderlinePositionDictionaryKey,
      UnderlinePosition);
    SerializeDouble(ABuilder, UnderlineThicknessDictionaryKey,
      UnderlineThickness);
...
procedure TdxPDFType1FontClassicFontInfo.OptionalSerializeDouble
  (ABuilder: TStringBuilder; const AKey: string; AValue: Double);
begin
  if AValue <> 0 then
    SerializeDouble(ABuilder, AKey, AValue);
end;

procedure TdxPDFType1FontClassicFontInfo.SerializeDouble
  (ABuilder: TStringBuilder; const AKey: string; AValue: Double);
begin
  ABuilder.Append(Format('/%s %s def'#10, [AKey, DoubleAsString(AValue,
    3, 0)]));
end;

procedure TdxPDFType1FontClassicFontInfo.SerializeString
  (ABuilder: TStringBuilder; const AKey, AValue: string);
begin
  if AValue <> '' then
...
constructor TdxType1FontPredefinedEncoding.Create
  (AID: TdxType1FontPredefinedEncodingID);
begin
  inherited Create;
  FID := AID;
...
function TdxType1FontPredefinedEncoding.GetCodeToGIDMapping
  (ACharset: TdxType1FontCustomCharset;
  AStringIndex: TdxCompactFontFormatStringIndex): TSmallIntDynArray;
var
  AGID: SmallInt;
...
class function TdxType1FontCustomEncoding.Parse(AStream: TdxFontFileStream)
  : TdxType1FontCustomEncoding;
var
  AID: Byte;
begin
  ...
  if (Result <> nil) and ((AID and SupplementDataFlag) = SupplementDataFlag)
  then
    Result.ReadSupplementData(AStream);
end;

function TdxType1FontCustomEncoding.GetCodeToGIDMapping
  (ACharset: TdxType1FontCustomCharset;
  AStringIndex: TdxCompactFontFormatStringIndex): TSmallIntDynArray;
var
...
procedure TdxType1FontCustomEncoding.FillEntry(const AMapping
  : TSmallIntDynArray; ACode: Byte; AGID: SmallInt);
begin
...
begin
  ...
  AStream.WriteByte(EncodingID or IfThen(AHasSupplementData,
    SupplementDataFlag, 0));
...
procedure TdxType1FontCustomEncoding.ReadSupplementData
  (AStream: TdxFontFileStream);
var
  ACount, ACode: Byte;
  I: Integer;
begin
  ...
  begin
    ...
    FSupplementData[I] := TdxType1SupplementDataEntry.Create
      (AStream.ReadShort, ACode);
  end;
end;
...
procedure TdxType1FontArrayEncoding.WriteEncodingData
  (AStream: TdxFontFileStream);
begin
...
procedure TdxType1FontRangeEncoding.WriteEncodingData
  (AStream: TdxFontFileStream);
var
  I: Integer;
begin
...
class function TdxType1FontRangeEncoding.TRange.Create(AStart,
  ARemain: Byte): TRange;
begin
  Result.Start := AStart;
...
var
  AObjectsCount, AOffSize, I, AIndex, APreviousOffset, AOffset,
    ALength: Integer;
...
function TdxCompactFontFormatBinaryIndex.GetObjectDataLength
  (AIndex: Integer): Integer;
begin
  Result := Length(FData[AIndex]);
end;

procedure TdxCompactFontFormatBinaryIndex.ProcessObject(AIndex: Integer;
  const AData: TBytes);
begin
  FData.Add(AData);
end;
...
procedure TdxCompactFontFormatBinaryIndex.WriteObject
  (AStream: TdxFontFileStream; AIndex: Integer);
begin
...
function TdxCompactFontFormatNameIndex.GetObjectDataLength
  (AIndex: Integer): Integer;
begin
  Result := Length(TEncoding.UTF8.GetBytes(Strings[AIndex]));
end;

procedure TdxCompactFontFormatNameIndex.ProcessObject(AIndex: Integer;
  const AData: TBytes);
var
...
procedure TdxCompactFontFormatNameIndex.WriteObject(AStream: TdxFontFileStream;
  AIndex: Integer);
begin
...
begin
  if not FStandardSIDMapping.TryGetValue(AValue, Result) and
    not FSIDMapping.TryGetValue(AValue, Result) then
    TdxPDFUtils.RaiseException;
end;

function TdxCompactFontFormatStringIndex.GetString
  (AOperands: TDoubleDynArray): string;
begin
...
function TdxCompactFontFormatStringIndex.TryGetSID(const AValue: string)
  : SmallInt;
begin
...
function TdxCompactFontFormatTopDictIndex.GetObjectDataLength
  (AIndex: Integer): Integer;
begin
  Result := Length(FObjectData);
end;

procedure TdxCompactFontFormatTopDictIndex.ProcessObject(AIndex: Integer;
  const AData: TBytes);
begin
  FObjectData := AData;
end;
...
procedure TdxCompactFontFormatTopDictIndex.WriteObject
  (AStream: TdxFontFileStream; AIndex: Integer);
begin
...
constructor TdxType1FontCustomCharset.Create(AStream: TdxFontFileStream;
  ASize: Integer);
begin
  Create;
end;
...
class function TdxType1FontCustomCharset.Parse(AStream: TdxFontFileStream;
  ASize: Integer): TdxType1FontCustomCharset;
var
...
procedure TdxType1FontCustomCharset.SetSIDToGIDMapping
  (AValue: TdxPDFSmallIntegerDictionary);
begin
  // do nothing
end;
...
constructor TdxType1FontArrayCharset.Create(AStream: TdxFontFileStream;
  ASize: Integer);
begin
...
function TdxType1FontArrayCharset.GetSIDToGIDMapping
...
procedure TdxType1FontArrayCharset.SetSIDToGIDMapping
  (AValue: TdxPDFSmallIntegerDictionary);
begin
...
constructor TdxType1FontCustomRangeCharset.Create(AStream: TdxFontFileStream;
  ASize: Integer);
begin
  inherited Create(AStream, ASize);
...
function TdxType1FontCustomRangeCharset.GetSIDToGIDMapping
  : TdxPDFSmallIntegerDictionary;
var
  I, AIndex: Integer;
  ASID: SmallInt;
...
procedure TdxType1FontCustomRangeCharset.SetSIDToGIDMapping
  (AValue: TdxPDFSmallIntegerDictionary);
begin
  FCIDToGIDMapping := AValue;
end;
...
procedure TdxType1FontCustomRangeCharset.AddToCIDToGIDMapping(AKey,
  AValue: SmallInt);
begin
...
procedure TdxType1FontByteRangeCharset.PopulateRanges
  (AStream: TdxFontFileStream; ASize: Integer);
var
  ASID: SmallInt;
  ARemain: Byte;
begin
...
procedure TdxType1FontByteRangeCharset.ProcessRemain
  (ARange: TdxType1FontCustomRange; var ASID: SmallInt; var AIndex: Integer);
var
  ARemain: Byte;
begin
...
procedure TdxType1FontByteRangeCharset.WriteRemain(AStream: TdxFontFileStream;
  ARange: TdxType1FontCustomRange);
begin
...
procedure TdxType1FontWordRangeCharset.PopulateRanges
  (AStream: TdxFontFileStream; ASize: Integer);
var
  ASID: SmallInt;
  ARemain: SmallInt;
...
procedure TdxType1FontWordRangeCharset.ProcessRemain
  (ARange: TdxType1FontCustomRange; var ASID: SmallInt; var AIndex: Integer);
var
  ARemain: SmallInt;
begin
...
procedure TdxType1FontWordRangeCharset.WriteRemain(AStream: TdxFontFileStream;
  ARange: TdxType1FontCustomRange);
begin
...
constructor TdxType1FontPredefinedCharset.Create
  (AID: TdxType1FontPredefinedCharsetID);
begin
  inherited Create;
  FID := AID;
end;
...
function TdxType1FontPredefinedCharset.GetSIDToGIDMapping
  : TdxPDFSmallIntegerDictionary;
begin
  case FID of
    pcExpert:
...
begin
  inherited CreateSubClasses;
  FExpertCharset := TdxPDFSmallIntegerDictionary.Create;
  FExpertSubsetCharset := TdxPDFSmallIntegerDictionary.Create;
  FISOAdobeCharset := TdxPDFSmallIntegerDictionary.Create;
...
class function TdxType1FontCIDGlyphGroupSelector.Parse
  (AStream: TdxFontFileStream; ACIDCount: Integer)
  : TdxType1FontCIDGlyphGroupSelector;
begin
  case AStream.ReadByte of
    0:
      Result := TdxType1FontCIDGlyphGroupArraySelector.Create(AStream,
        ACIDCount);
    3:
      Result := TdxType1FontCIDGlyphGroupRangeSelector.Create(AStream,
        ACIDCount);
  else
    Result := nil;
  end;
...
constructor TdxType1FontCIDGlyphGroupRangeSelector.Create
  (AStream: TdxFontFileStream; ACIDCount: Integer);
var
...
begin
  ...
  if (FSentinel <> ACIDCount) or (FSentinel <= APreviousCID) or
    (FRanges[0].First <> 0) then
    TdxPDFUtils.RaiseTestException;
end;
...
procedure TdxType1FontCIDGlyphGroupRangeSelector.
  Write(AStream: TdxFontFileStream);
var
  ARange: TRange;
begin
...
class function TdxType1FontCIDGlyphGroupRangeSelector.TRange.Create
  (AFirst: SmallInt; AGlyphGroupIndex: Byte): TRange;
begin
  Result.First := AFirst;
...
constructor TdxType1FontCIDGlyphGroupArraySelector.Create
  (AStream: TdxFontFileStream; ACIDCount: Integer);
begin
  inherited Create;
...
procedure TdxType1FontCIDGlyphGroupArraySelector.
  Write(AStream: TdxFontFileStream);
begin
  AStream.WriteByte(0);
...
function TdxType1CustomFontProgram.GetCompositeMapping(const ACidToGidMap
  : TSmallIntDynArray): TObject;
begin
...
procedure TdxType1CustomFontProgram.SetPrivateData(const AValue
  : TdxType1FontPrivateData);
begin
  FreeAndNil(FPrivateData);
  FPrivateData := AValue;
...
constructor TdxType1FontCompactFontProgram.Create(AMajorVersion,
  AMinorVersion: Byte; const AFontName: string;
  AStringIndex: TdxCompactFontFormatStringIndex; AGlobalSubrs: TList<TBytes>);
begin
  Create;
...
class function TdxType1FontCompactFontProgram.DefaultFontMatrix
  : TdxCompactFontFormatTarnsformationMatrix;
begin
...
class function TdxType1FontCompactFontProgram.Parse(const AData: TBytes)
  : TdxType1FontCompactFontProgram;
...
begin
  ...
  try
    ...
    try
      Result := TdxCompactFontFormatTopDictIndexParser.Parse(AMajorVersion,
        AMinorVersion, AFontName, AStringIndex, ABinaryIndex.Data, AStream,
        ATopDictIndex.ObjectData);
    finally
      ABinaryIndex.Free;
      ATopDictIndex.Free;
    end;
...
procedure TdxType1FontCompactFontProgram.SetFontType(const AValue
  : TdxType1FontType);
begin
  FFontType := AValue;
end;

procedure TdxType1FontCompactFontProgram.SetCharset(const AValue
  : TdxType1FontCustomCharset);
begin
  FreeAndNil(FCharset);
  FCharset := AValue;
...
procedure TdxType1FontCompactFontProgram.SetCharStrings
  (const AValue: TList<TBytes>);
begin
  FCharStrings.Clear;
...
procedure TdxType1FontCompactFontProgram.SetEncoding(const AValue
  : TdxType1FontEncoding);
begin
  FreeAndNil(FEncoding);
  FEncoding := AValue;
...
function TdxType1FontCompactFontProgram.GetSimpleMapping(AFontEncoding
  : TdxPDFSimpleFontEncoding): TObject;
var
...
function TdxType1FontCompactCIDFontProgram.GetCompositeMapping
  (const ACidToGidMap: TSmallIntDynArray): TObject;
var
...
procedure TdxType1FontCompactCIDFontProgram.SetGlyphGroupData
  (const AValue: TObjectList<TdxType1FontCIDGlyphGroupData>);
begin
  FreeAndNil(FGlyphGroupData);
  FGlyphGroupData := AValue;
end;

procedure TdxType1FontCompactCIDFontProgram.SetGlyphGroupSelector
  (const AValue: TdxType1FontCIDGlyphGroupSelector);
begin
  FreeAndNil(FGlyphGroupSelector);
...
class function TdxPDFType1FontClassicFontProgram.Parse(const AFontName: string;
  AFontFileData: TdxPDFType1FontFileData): TdxPDFType1FontClassicFontProgram;
var
...
begin
  ...
  try
    ...
    begin
      AFontProgramDictionary :=
        AInterpreter.Stack.Peek as TdxPDFPostScriptDictionary;
      if AFontProgramDictionary <> nil then
      begin
        ACipher := TdxPDFType1FontEexecCipher.CreateCipher(AData,
          APlainTextLength, AFontFileData.CipherTextLength);
        try
        ...
        begin
          ...
          for I := 0 to AFontDirectory.Count - 1 do
            ...
            begin
              Result := TdxPDFType1FontClassicFontProgram
                (AFontDirectory[I].Value);
              Result.Reference;
            end;
      end;
    end;
...
procedure TdxPDFType1FontClassicFontProgram.
  Read(ADictionary: TdxPDFPostScriptDictionary);
var
  I: Integer;
  AEntry: TdxPDFPostScriptDictionaryEntry;
begin
  ...
  begin
    ...
    if AEntry.Key = StrokeWidthDictionaryKey then
      StrokeWidth := TdxPDFUtils.ConvertToDouble(AEntry.Value,
        DefaultStrokeWidth);
    ...
    begin
      if AEntry.Key = FontMatrixDictionaryKey then
        FontMatrix := TdxPDFUtils.ArrayToMatrix
          (TdxPDFArray(AEntry.Value)).XForm;
...
function TdxPDFType1FontClassicFontProgram.GetSimpleMapping
  (AFontEncoding: TdxPDFSimpleFontEncoding): TObject;
var
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        AGlyphName := AFontEncoding.GetGlyphName(Byte(I));
        if (AGlyphName <> TdxGlyphNames._notdef) and
          AMapping.TryGetValue(AGlyphName, AGlyphIndex) then
          ACharset[Byte(I)] := AGlyphIndex;
      end;
  finally
    AMapping.Free;
  end;
  Result := TdxPDFSimpleFontCodePointMapping.Create(ACharset,
    TdxPDFFontProgramFacade.GetUnicodeMapping(AFontEncoding));
end;
...
begin
  ...
  try
    ...
    if AFontInfo = nil then
      ABuilder.Append('%' + Format('!FontType1-1.0: %s %s'#10,
        [AFontName, '001.001']))
    else
      ABuilder.Append('%' + Format('!FontType1-1.0: %s %s'#10,
        [AFontName, AFontInfo.Version]));
    ABuilder.Append('11 dict begin'#10);
    if AFontInfo <> nil then
      ABuilder.Append(Format('/%s %s readonly def'#10,
        ['FontInfo', AFontInfo.Serialize]));
    ABuilder.Append(Format('/%s /%s def'#10, [FontNameDictionaryKey,
      AFontName]));
    ABuilder.Append
      (Format('/%s 256 array 0 1 255 {1 index exch /.notdef put} for'#10,
    ...
    ABuilder.Append(Format(SerializationPattern, [PaintTypeDictionaryKey,
      Integer(PaintType)]));
    ABuilder.Append(Format(SerializationPattern, [FontTypeDictionaryKey,
      Integer(FontType)]));
    ABuilder.Append(Format('/%s [%s %s %s %s %s %s] readonly def'#10,
      [FontMatrixDictionaryKey, DoubleAsString(FontMatrix.eM11, 3, 0),
      DoubleAsString(FontMatrix.eM12, 3, 0), DoubleAsString(FontMatrix.eM21, 3,
      0), DoubleAsString(FontMatrix.eM22, 3, 0), DoubleAsString(FontMatrix.eDx,
      3, 0), DoubleAsString(FontMatrix.eDy, 3, 0)]));

    AFontBBox := FontBBox;
    ABuilder.Append(Format('/%s {%s %s %s %s} readonly def'#10,
      [FontBBoxDictionaryKey, DoubleAsString(AFontBBox.Left, 5, 0),
      DoubleAsString(AFontBBox.Bottom, 5, 0), DoubleAsString(AFontBBox.Right, 5,
      0), DoubleAsString(AFontBBox.Top, 5, 0)]));

    AUniqueID := UniqueID;
    if AUniqueID <> DefaultUniqueID then
      ABuilder.Append(Format(SerializationPattern, [UniqueIDDictionaryKey,
        AUniqueID]));
    if FMetrics <> nil then
    begin
      ABuilder.Append(Format('/%s 1 dict dup begin'#10,
        [MetricsDictionaryKey]));
      ABuilder.Append('end def'#10);
    end;
    AStrokeWidth := StrokeWidth;
    if AStrokeWidth <> DefaultStrokeWidth then
      ABuilder.Append(Format('/%s %f def'#10, [StrokeWidthDictionaryKey,
        AStrokeWidth]));
    if WMode <> wmHorizontal then
      ABuilder.Append(Format(SerializationPattern, [WModeDictionaryKey,
        Integer(WMode)]));
...
procedure TdxPDFType1FontClassicFontProgram.ReadEncoding
  (AEntry: TdxPDFPostScriptDictionaryEntry);
var
  I: Integer;
  ...
  begin
    ...
    begin
      ...
      for I := 0 to AArray.ElementList.Count - 1 do
        ...
        else if AArray.ElementList[I] is TdxPDFString then
...
procedure TdxPDFType1FontClassicFontProgram.ReadFontInfo
  (AEntry: TdxPDFPostScriptDictionaryEntry);
begin
  if (AEntry.Key = FontInfoDictionaryKey) and
    (AEntry.Value is TdxPDFPostScriptDictionary) then
  begin
...
procedure TdxPDFType1FontClassicFontProgram.ReadFontType
  (AEntry: TdxPDFPostScriptDictionaryEntry);
begin
...
procedure TdxPDFType1FontClassicFontProgram.ReadPaintType
  (AEntry: TdxPDFPostScriptDictionaryEntry);
begin
  if AEntry.Key = PaintTypeDictionaryKey then
    PaintType := TdxType1FontPaintType
      (TdxPDFUtils.ConvertToInt(AEntry.Value, -1));
end;

procedure TdxPDFType1FontClassicFontProgram.SetCharStrings
  (const AValue: TdxPDFPostScriptDictionary);
begin
  dxPDFChangeValue(AValue, TdxPDFReferencedObject(FCharStrings));
end;

procedure TdxPDFType1FontClassicFontProgram.SetEncoding
...
procedure TdxPDFType1FontClassicFontProgram.SetMetrics
  (const AValue: TdxPDFPostScriptDictionary);
begin
...
function TdxCompactFontFormatDictIndexOperator.GetSize
  (AStringIndex: TdxCompactFontFormatStringIndex): Integer;
begin
  Result := 1;
end;

procedure TdxCompactFontFormatDictIndexOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
  TdxPDFUtils.RaiseTestException;
end;
...
procedure TdxCompactFontFormatDictIndexOperator.Execute
  (AStream: TdxFontFileStream; AGlyphGroupData: TdxType1FontCIDGlyphGroupData);
begin
  TdxPDFUtils.RaiseTestException;
end;

procedure TdxCompactFontFormatDictIndexOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
...
function TdxCompactFontFormatDictIndexOperator.GetBoolean
  (AOperands: TDoubleDynArray): Boolean;
begin
  Result := GetInteger(AOperands) = 1;
end;

function TdxCompactFontFormatDictIndexOperator.GetDouble
  (AOperands: TDoubleDynArray): Double;
begin
  Result := AOperands[0];
end;

function TdxCompactFontFormatDictIndexOperator.GetDoubleArray
  (AOperands: TDoubleDynArray): TDoubleDynArray;
var
  I, ALength: Integer;
...
function TdxCompactFontFormatDictIndexOperator.GetInteger
  (AOperands: TDoubleDynArray): Integer;
begin
  Result := -1;
  if Length(AOperands) = 1 then
...
function TdxCompactFontFormatDictIndexOperator.GetGlyphZones
  (AOperands: TDoubleDynArray): TdxType1FontGlyphZones;
var
...
function TdxCompactFontFormatDictIndexOperator.CalculateDoubleArraySize
  (const AArray: TDoubleDynArray): Integer;
var
  I: Integer;
...
function TdxCompactFontFormatDictIndexOperator.CalculateDoubleSize
...
function TdxCompactFontFormatDictIndexOperator.CalculateIntegerSize
...
function TdxCompactFontFormatDictIndexOperator.CalculateGlyphZonesSize
  (const AValue: TdxType1FontGlyphZones): Integer;
var
  I: Integer;
  APrevious, ABottom, ATop: Double;
...
procedure TdxCompactFontFormatDictIndexOperator.WriteBoolean
  (AStream: TdxFontFileStream; AValue: Boolean);
begin
  AStream.WriteByte(IfThen(AValue, 140, 139));
end;

procedure TdxCompactFontFormatDictIndexOperator.WriteDouble
  (AStream: TdxFontFileStream; AValue: Double);
var
...
procedure TdxCompactFontFormatDictIndexOperator.WriteDoubleArray
  (AStream: TdxFontFileStream; const AValue: TDoubleDynArray);
var
  I: Integer;
...
procedure TdxCompactFontFormatDictIndexOperator.WriteInteger
  (AStream: TdxFontFileStream; AValue: Integer);
begin
  ...
  else if (AValue > 1131) or (AValue < -1131) then
  begin
...
procedure TdxCompactFontFormatDictIndexOperator.WriteGlyphZones
  (AStream: TdxFontFileStream; const AValue: TdxType1FontGlyphZones);
var
  I: Integer;
  APrevious, ABottom, ATop: Double;
  AGlyphZone: TdxType1FontGlyphZone;
...
constructor TdxCompactFontFormatDictIndexStringOperator.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; AOperands: TDoubleDynArray);
begin
...
function TdxCompactFontFormatDictIndexStringOperator.GetSize
  (AStringIndex: TdxCompactFontFormatStringIndex): Integer;
begin
  Result := inherited GetSize(AStringIndex) + CalculateIntegerSize
    (AStringIndex.GetSID(FValue));
end;

procedure TdxCompactFontFormatDictIndexStringOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
...
constructor TdxCompactFontFormatDictIndexIntegerOperator.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; AOperands: TDoubleDynArray);
begin
...
procedure TdxCompactFontFormatDictIndexIntegerOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
...
constructor TdxCompactFontFormatDictIndexDoubleOperator.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; AOperands: TDoubleDynArray);
begin
...
procedure TdxCompactFontFormatDictIndexDoubleOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
...
constructor TdxCompactFontFormatDictIndexXUIDOperator.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; AOperands: TDoubleDynArray);
var
  I, ALength: Integer;
begin
...
function TdxCompactFontFormatDictIndexXUIDOperator.GetSize
  (AStringIndex: TdxCompactFontFormatStringIndex): Integer;
var
  I, ASize: Integer;
begin
...
procedure TdxCompactFontFormatDictIndexXUIDOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
  AFontProgram.XUID := FXUID;
end;

procedure TdxCompactFontFormatDictIndexXUIDOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
var
  I: Integer;
...
procedure TdxCompactFontFormatDictIndexNoticeOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
procedure TdxCompactFontFormatDictIndexWeightOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
procedure TdxCompactFontFormatDictIndexFamilyNameOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
constructor TdxCompactFontFormatDictIndexFontBBoxOperator.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; AOperands: TDoubleDynArray);
var
  AFontBBox: TdxRectF;
begin
...
constructor TdxCompactFontFormatDictIndexFontBBoxOperator.Create(const AFontBBox
  : TdxRectF);
begin
  Create;
  FFontBBox := AFontBBox;
...
procedure TdxCompactFontFormatDictIndexFontBBoxOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
  AFontProgram.FontBBox := FFontBBox;
end;

function TdxCompactFontFormatDictIndexFontBBoxOperator.GetSize
  (AStringIndex: TdxCompactFontFormatStringIndex): Integer;
begin
  Result := inherited GetSize(AStringIndex) + CalculateDoubleSize
    (FFontBBox.Left) + CalculateDoubleSize(FFontBBox.Bottom) +
    CalculateDoubleSize(FFontBBox.Right) + CalculateDoubleSize(FFontBBox.Top);
end;

procedure TdxCompactFontFormatDictIndexFontBBoxOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
...
procedure TdxCompactFontFormatDictIndexUniqueIDOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
procedure TdxCompactFontFormatDictIndexBaseFontNameOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
function TdxCompactFontFormatDictIndexTwoByteOperator.GetSize
  (AStringIndex: TdxCompactFontFormatStringIndex): Integer;
begin
  Result := 2;
end;

procedure TdxCompactFontFormatDictIndexTwoByteOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
...
constructor TdxCompactFontFormatDictIndexIntegerTwoByteOperator.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; AOperands: TDoubleDynArray);
begin
  Create(GetInteger(AOperands));
...
procedure TdxCompactFontFormatDictIndexIntegerTwoByteOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
...
procedure TdxCompactFontFormatDictIndexDoubleTwoByteOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
  WriteDouble(AStream, Value);
...
constructor TdxCompactFontFormatDictIndexPaintTypeOperator.Create
  (APaintType: TdxType1FontPaintType);
begin
  inherited Create;
...
procedure TdxCompactFontFormatDictIndexPaintTypeOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
constructor TdxCompactFontFormatDictIndexGlyphZonesOperator.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; AOperands: TDoubleDynArray);
begin
...
procedure TdxCompactFontFormatDictIndexGlyphZonesOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
...
constructor TdxCompactFontFormatDictIndexDoubleDynArrayOperator.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; AOperands: TDoubleDynArray);
begin
...
function TdxCompactFontFormatDictIndexDoubleDynArrayOperator.GetSize
  (AStringIndex: TdxCompactFontFormatStringIndex): Integer;
begin
  Result := inherited GetSize(AStringIndex) + CalculateDoubleArraySize(Value);
end;

procedure TdxCompactFontFormatDictIndexDoubleDynArrayOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
...
procedure TdxCompactFontFormatDictIndexBaseFontBlendOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
procedure TdxCompactFontFormatDictIndexCharstringTypeOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
procedure TdxCompactFontFormatDictIndexCharstringTypeOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
...
procedure TdxCompactFontFormatDictIndexCIDCountOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
var
  ACidFontProgram: TdxType1FontCompactCIDFontProgram;
begin
...
procedure TdxCompactFontFormatDictIndexCIDFontVersionOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
var
  ACidFontProgram: TdxType1FontCompactCIDFontProgram;
begin
...
constructor TdxCompactFontFormatDictIndexStringTwoByteOperator.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; AOperands: TDoubleDynArray);
begin
  Create(AStringIndex.GetString(AOperands));
end;
...
begin
  Result := inherited GetSize(AStringIndex) + CalculateIntegerSize
    (AStringIndex.GetSID(Value));
end;

procedure TdxCompactFontFormatDictIndexStringTwoByteOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
...
procedure TdxCompactFontFormatDictIndexCopyrightOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
constructor TdxCompactFontFormatDictIndexCharsetOperator.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; AOperands: TDoubleDynArray);
begin
  Create;
...
procedure TdxCompactFontFormatDictIndexCharsetOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
var
  ASize: Integer;
begin
  if FOffset in [Integer(pcISOAdobe), Integer(pcExpert), Integer(pcExpertSubset)]
  then
    FCharset := TdxType1FontPredefinedCharset.Create
      (TdxType1FontPredefinedCharsetID(FOffset))
  else
  begin
...
procedure TdxCompactFontFormatDictIndexCharsetOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
...
procedure TdxCompactFontFormatDictIndexCharsetOperator.SetOffset
  (const AValue: Integer);
begin
  FOffset := AValue;
end;

procedure TdxCompactFontFormatDictIndexCharsetOperator.WriteData
  (AStream: TdxFontFileStream);
begin
...
constructor TdxCompactFontFormatDictIndexCharStringsOperator.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; AOperands: TDoubleDynArray);
begin
  Create;
  FOffset := GetInteger(AOperands);
...
procedure TdxCompactFontFormatDictIndexCharStringsOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
  AStream.Position := FOffset;
...
procedure TdxCompactFontFormatDictIndexCharStringsOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
  WriteInteger(AStream, FOffset);
...
procedure TdxCompactFontFormatDictIndexCharStringsOperator.SetOffset
  (const AValue: Integer);
begin
  FOffset := AValue;
end;

procedure TdxCompactFontFormatDictIndexCharStringsOperator.WriteData
  (AStream: TdxFontFileStream);
begin
...
constructor TdxCompactFontFormatDictIndexEncodingOperator.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; AOperands: TDoubleDynArray);
begin
  Create;
  FOffset := GetInteger(AOperands);
...
procedure TdxCompactFontFormatDictIndexEncodingOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
var
  AEncoding: TdxType1FontEncoding;
begin
...
procedure TdxCompactFontFormatDictIndexEncodingOperator.SetOffset
  (const AValue: Integer);
begin
  FOffset := AValue;
end;

procedure TdxCompactFontFormatDictIndexEncodingOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
  WriteInteger(AStream, FOffset);
...
procedure TdxCompactFontFormatDictIndexEncodingOperator.WriteData
  (AStream: TdxFontFileStream);
var
...
constructor TdxCompactFontFormatDictIndexPrivateOperator.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; AOperands: TDoubleDynArray);
begin
  Create;
...
procedure TdxCompactFontFormatDictIndexPrivateOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
function TdxCompactFontFormatDictIndexPrivateOperator.ReadData
  (AStream: TdxFontFileStream): TdxType1FontPrivateData;
var
  AData: TBytes;
begin
  AStream.Position := FOffset;
...
function TdxCompactFontFormatDictIndexPrivateOperator.GetSize
  (AStringIndex: TdxCompactFontFormatStringIndex): Integer;
begin
  Result := inherited GetSize(AStringIndex) + CalculateIntegerSize(FLength) +
    CalculateIntegerSize(FOffset);
end;

procedure TdxCompactFontFormatDictIndexPrivateOperator.SetOffset
  (const AValue: Integer);
begin
  FOffset := AValue;
end;

procedure TdxCompactFontFormatDictIndexPrivateOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
...
procedure TdxCompactFontFormatDictIndexPrivateOperator.WriteData
  (AStream: TdxFontFileStream);
var
  AWriter: TdxCompactFontFormatPrivateDictIndexWriter;
begin
...
constructor TdxCompactFontFormatCIDGlyphGroupDataWriter.Create
  (const AData: TdxType1FontCIDGlyphGroupData;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
  inherited Create;
  FOperators := TdxCompactFontFormatDictIndexOperatorList.Create;
  FStringIndex := AStringIndex;
  if not SameValue(AData.UnderlinePosition,
    TdxType1FontInfo.DefaultUnderlinePosition) then
    FOperators.Add(TdxCompactFontFormatDictIndexUnderlinePositionOperator.Create
      (AData.UnderlinePosition));
  if not SameValue(AData.UnderlineThickness,
    TdxType1FontInfo.DefaultUnderlineThickness) then
    FOperators.Add(TdxCompactFontFormatDictIndexUnderlineThicknessOperator.
      Create(AData.UnderlineThickness));
  ...
  if AData.FontType <> TdxType1FontCompactFontProgram.DefaultFontType then
    FOperators.Add(TdxCompactFontFormatDictIndexCharstringTypeOperator.Create
      (AData.FontType));
  if not TXForm.IsEqual(AData.FontMatrix,
    TdxType1FontCompactFontProgram.DefaultFontMatrix) then
    FOperators.Add(TdxCompactFontFormatDictIndexFontMatrixOperator.Create
      (AData.FontMatrix));
  ...
  begin
    FPrivateOperator := TdxCompactFontFormatDictIndexPrivateOperator.Create
      (AData.PrivateData);
  ...
  if AData.CIDFontName <> '' then
    FOperators.Add(TdxCompactFontFormatDictIndexFontNameOperator.Create
      (AData.CIDFontName));
end;
...
procedure TdxCompactFontFormatCIDGlyphGroupDataWriter.
  Write(AStream: TdxFontFileStream);
var
  AOperator: TdxCompactFontFormatDictIndexOperator;
begin
...
constructor TdxCompactFontFormatDictIndexFDArrayOperator.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; AOperands: TDoubleDynArray);
begin
  Create;
  FOffset := GetInteger(AOperands);
...
constructor TdxCompactFontFormatDictIndexFDArrayOperator.Create
  (ADataArray: TObjectList<TdxType1FontCIDGlyphGroupData>;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
  Create;
...
procedure TdxCompactFontFormatDictIndexFDArrayOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
var
  I: Integer;
  ABinaryIndex: TdxCompactFontFormatBinaryIndex;
  ...
  begin
    ...
    try
      ...
      for I := 0 to AData.Count - 1 do
        FGlyphGroupData.Add(TdxCompactFontFormatTopDictIndexParser.Parse
          (AStream, FStringIndex, AData[I]));
...
function TdxCompactFontFormatDictIndexFDArrayOperator.GetOffsetOperators
  : TdxCompactFontFormatDictIndexOffsetOperatorList;
var
...
begin
  ...
  begin
    if AWriter.PrivateOperator <> nil then
      if Supports(AWriter.PrivateOperator,
        IdxCompactFontFormatDictIndexOffsetOperator, AOperator) then
...
begin
  ...
  begin
    ...
    for I := 0 to FGlyphGroupData.Count - 1 do
      FWriters.Add(TdxCompactFontFormatCIDGlyphGroupDataWriter.Create
        (FGlyphGroupData[I], FStringIndex));
  end;
end;
...
procedure TdxCompactFontFormatDictIndexFDArrayOperator.SetOffset
  (const AValue: Integer);
begin
  FOffset := AValue;
end;

procedure TdxCompactFontFormatDictIndexFDArrayOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
  WriteInteger(AStream, FOffset);
...
procedure TdxCompactFontFormatDictIndexFDArrayOperator.WriteData
  (AStream: TdxFontFileStream);
var
  I: Integer;
  ABinaryIndex: TdxCompactFontFormatBinaryIndex;
...
class function TdxCompactFontFormatDictIndexUnderlinePositionOperator.
  Code: Byte;
begin
  Result := 3;
end;

procedure TdxCompactFontFormatDictIndexUnderlinePositionOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
class function TdxCompactFontFormatDictIndexUnderlineThicknessOperator.
  Code: Byte;
begin
  Result := 4;
end;

procedure TdxCompactFontFormatDictIndexUnderlineThicknessOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
procedure TdxCompactFontFormatDictIndexFontMatrixOperator.Execute
  (AStream: TdxFontFileStream; AGlyphGroupData: TdxType1FontCIDGlyphGroupData);
begin
...
begin
  Result := inherited GetSize(AStringIndex) + CalculateDoubleSize
    (FFontMatrix.eM11) + CalculateDoubleSize(FFontMatrix.eM12) +
    CalculateDoubleSize(FFontMatrix.eM21) + CalculateDoubleSize
    (FFontMatrix.eM22) + CalculateDoubleSize(FFontMatrix.eDx) +
    CalculateDoubleSize(FFontMatrix.eDy);
end;

procedure TdxCompactFontFormatDictIndexFontMatrixOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
...
function TdxCompactFontFormatPrivateDictIndexSubrsOperator.UpdateOffset
...
procedure TdxCompactFontFormatPrivateDictIndexSubrsOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
var
  APosition: Int64;
...
procedure TdxCompactFontFormatPrivateDictIndexSubrsOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
  WriteInteger(AStream, FOffset);
...
procedure TdxCompactFontFormatPrivateDictIndexSubrsOperator.WriteData
  (AStream: TdxFontFileStream);
begin
...
procedure TdxCompactFontFormatPrivateDictIndexBlueFuzzOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
procedure TdxCompactFontFormatPrivateDictIndexBlueScaleOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
procedure TdxCompactFontFormatPrivateDictIndexBlueShiftOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
class function TdxCompactFontFormatPrivateDictIndexDefaultWidthXOperator.
  Code: Byte;
begin
  Result := 20;
end;

procedure TdxCompactFontFormatPrivateDictIndexDefaultWidthXOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
class function TdxCompactFontFormatPrivateDictIndexExpansionFactorOperator.
  Code: Byte;
begin
  Result := 18;
end;

procedure TdxCompactFontFormatPrivateDictIndexExpansionFactorOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
class function TdxCompactFontFormatPrivateDictIndexBlueValuesOperator.
  Code: Byte;
begin
  Result := 6;
end;

procedure TdxCompactFontFormatPrivateDictIndexBlueValuesOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
class function TdxCompactFontFormatPrivateDictIndexFamilyBluesOperator.
  Code: Byte;
begin
  Result := 8;
end;

procedure TdxCompactFontFormatPrivateDictIndexFamilyBluesOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
class function TdxCompactFontFormatPrivateDictIndexFamilyOtherBluesOperator.
  Code: Byte;
begin
  Result := 9;
end;

procedure TdxCompactFontFormatPrivateDictIndexFamilyOtherBluesOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
procedure TdxCompactFontFormatPrivateDictIndexBooleanTwoByteOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
...
procedure TdxCompactFontFormatPrivateDictIndexForceBoldOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
class function TdxCompactFontFormatPrivateDictIndexForceBoldThresholdOperator.
  Code: Byte;
begin
  Result := 15;
end;

procedure TdxCompactFontFormatPrivateDictIndexForceBoldThresholdOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
class function TdxCompactFontFormatPrivateDictIndexLanguageGroupOperator.
  Code: Byte;
begin
  Result := 17;
end;

procedure TdxCompactFontFormatPrivateDictIndexLanguageGroupOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
class function TdxCompactFontFormatPrivateDictIndexNominalWidthXOperator.
  Code: Byte;
begin
  Result := 21;
end;

procedure TdxCompactFontFormatPrivateDictIndexNominalWidthXOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
class function TdxCompactFontFormatPrivateDictIndexOtherBluesOperator.
  Code: Byte;
begin
  Result := 7;
end;

procedure TdxCompactFontFormatPrivateDictIndexOtherBluesOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
procedure TdxCompactFontFormatPrivateDictIndexStdHWOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
procedure TdxCompactFontFormatPrivateDictIndexStdVWOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
procedure TdxCompactFontFormatPrivateDictIndexStemSnapHOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
procedure TdxCompactFontFormatPrivateDictIndexStemSnapVOperator.Execute
  (AStream: TdxFontFileStream;
  APrivateData: TdxType1FontCompactFontPrivateData);
begin
...
procedure TdxCompactFontFormatDictIndexVersionOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
procedure TdxCompactFontFormatDictIndexUIDBaseOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
procedure TdxCompactFontFormatDictIndexStrokeWidthOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
constructor TdxCompactFontFormatDictIndexROSOperator.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; AOperands: TDoubleDynArray);
var
...
constructor TdxCompactFontFormatDictIndexROSOperator.Create(const ARegistry,
  AOrdering: string; ASupplement: Double);
begin
  Create;
  FRegistry := ARegistry;
  FOrdering := AOrdering;
...
procedure TdxCompactFontFormatDictIndexROSOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
var
  ACidFontProgram: TdxType1FontCompactCIDFontProgram;
begin
...
function TdxCompactFontFormatDictIndexROSOperator.GetSize
  (AStringIndex: TdxCompactFontFormatStringIndex): Integer;
begin
  Result := inherited GetSize(AStringIndex) + CalculateIntegerSize
    (AStringIndex.GetSID(FRegistry)) + CalculateIntegerSize
    (AStringIndex.GetSID(FOrdering)) + CalculateDoubleSize(FSupplement);
end;

procedure TdxCompactFontFormatDictIndexROSOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
...
procedure TdxCompactFontFormatDictIndexPostScriptOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
procedure TdxCompactFontFormatDictIndexItalicAngleOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
procedure TdxCompactFontFormatDictIndexIsFixedPitchOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
procedure TdxCompactFontFormatDictIndexFontNameOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
procedure TdxCompactFontFormatDictIndexFullNameOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
...
constructor TdxCompactFontFormatDictIndexFDSelectOperator.Create
  (AStringIndex: TdxCompactFontFormatStringIndex; AOperands: TDoubleDynArray);
begin
  Create;
  FOffset := GetInteger(AOperands);
...
constructor TdxCompactFontFormatDictIndexFDSelectOperator.Create
  (ASelector: TdxType1FontCIDGlyphGroupSelector);
begin
  Create;
  FSelector := ASelector;
end;
...
procedure TdxCompactFontFormatDictIndexFDSelectOperator.Execute
  (AStream: TdxFontFileStream; AFontProgram: TdxType1FontCompactFontProgram);
begin
  AStream.Position := FOffset;
  FSelector := TdxType1FontCIDGlyphGroupSelector.Parse(AStream,
    AFontProgram.CharStrings.Count);
...
procedure TdxCompactFontFormatDictIndexFDSelectOperator.SetOffset
  (const AValue: Integer);
begin
  FOffset := AValue;
end;

procedure TdxCompactFontFormatDictIndexFDSelectOperator.
  Write(AStream: TdxFontFileStream;
  AStringIndex: TdxCompactFontFormatStringIndex);
begin
  WriteInteger(AStream, FOffset);
...
procedure TdxCompactFontFormatDictIndexFDSelectOperator.WriteData
  (AStream: TdxFontFileStream);
begin
...
dxCompactFontFormatDictIndexOneByteOperatorFactory.RegisterOperator
  (TdxCompactFontFormatDictIndexFamilyNameOperator);
dxCompactFontFormatDictIndexOneByteOperatorFactory.RegisterOperator
  (TdxCompactFontFormatDictIndexXUIDOperator);
dxCompactFontFormatDictIndexOneByteOperatorFactory.RegisterOperator
...
dxCompactFontFormatDictIndexTwoByteOperatorFactory.RegisterOperator
  (TdxCompactFontFormatDictIndexBaseFontBlendOperator);
dxCompactFontFormatDictIndexTwoByteOperatorFactory.RegisterOperator
  (TdxCompactFontFormatDictIndexCharstringTypeOperator);
dxCompactFontFormatDictIndexTwoByteOperatorFactory.RegisterOperator
