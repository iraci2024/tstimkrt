...
begin
  ACommand := ACategory.Add('Arrows\DoubleLast.png',
  ...
  ACommand.Add(TdxPDFViewerGoToPrevView, dxUIGeneratorItemDefaultViewLevels,
    ugigpNone, ugipBeginsNewRow, True);
  ACommand.Add(TdxPDFViewerGoToNextView);

  ACommand := ACategory.Add('Actions\Refresh2.png',
...
begin
  ...
  ACommand.Add(TdxPDFViewerZoomActualSize, dxUIGeneratorItemDefaultViewLevels,
    ugigpNone, ugipBeginsNewRow, True);
...
begin
  ...
  ACategory.Add(TdxPDFViewerSelectAll, dxUIGeneratorItemDefaultViewLevels,
    ugigpNone, ugipBeginsNewRow, True);
end;
...
begin
  AComponent := TdxUIGenerator.RegisterComponent(TdxPDFViewer,
    sdxPDFViewerActionsCategoryName);
  RegisterCategoryFile(AComponent.Add(sdxPDFViewerTabPDFViewer,
    sdxPDFViewerBarPDFViewerFile, 'Actions\New_16x16.png', 0));
  RegisterCategoryFind(AComponent.Add(sdxPDFViewerTabPDFViewer,
    sdxPDFViewerBarPDFViewerFind, 'Find\Find_16x16.png', 0));
  RegisterCategoryTools(AComponent.Add(sdxPDFViewerTabPDFViewer,
    sdxPDFViewerBarPDFViewerTools, 'PDF Viewer\SelectTool_16x16.png', 0));
  RegisterCategoryNavigation(AComponent.Add(sdxPDFViewerTabPDFViewer,
    sdxPDFViewerBarPDFViewerNavigation, 'Arrows\DoubleLast_16x16.png', 0));
  RegisterCategoryZoom(AComponent.Add(sdxPDFViewerTabPDFViewer,
    sdxPDFViewerBarPDFViewerZoom, 'Zoom\Zoom_16x16.png', 0));
end;
