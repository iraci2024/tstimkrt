...
type
  ...
  TdxJPXCodeBlockCodingStyle = (bcsSelectiveArithmeticCodingBypass = 1,
    bcsResetContextProbabilities = 2, bcsTerminationOnEachCodingPass = 4,
    bcsVerticallyCausalContext = 8, bcsPredictableTermination = 16,
    bcsUseSegmentationSymbols = 32, bcsUnknown = 0);
  TdxJPXCodingStyleParameter = (cspUsePrecincts = 1, cspUseSOPMarker = 2,
    cspUseEPHMarker = 4);
  TdxJPXProgressionOrder = (poLayerResolutionComponentPosition,
    poResolutionLayerComponentPosition, poResolutionPositionComponentLayer,
    poPositionComponentResolutionLayer, poComponentPositionResolutionLayer);
  ...
  strict private
    ...
    FQe: LongWord;
  public
    class function Create(AQe: LongWord; AMpsXor, ALpsXor, ASwitch: Byte)
      : TdxArithmeticQe; static;
  ...
  public
    constructor Create(AState: TdxArithmeticState;
      const AContext: TBytes); overload;
  ...
  public
    procedure Initialize(AComponent, ALayer, AResolutionLevel,
      APrecinct: Integer);
  ...
  public
    procedure Initialize(ABitsPerComponent, AHorizontalSeparation,
      AVerticalSeparation: Integer);
  ...
  public
    procedure Initialize(AReader: TdxBigEndianStreamReader;
      AUsePrecincts: Boolean);

    property CodeBlockCodingStyle: TdxJPXCodeBlockCodingStyle
      read FCodeBlockCodingStyle;
  ...
  public
    procedure Initialize(const AData: TSingleDynArray;
  ...
  public
    ...
    property DiagonalNeighborSignificance: Byte
      read GetDiagonalNeighborSignificance;
    property IsNotFirstRefinement: Boolean read GetIsNotFirstRefinement
      write SetIsNotFirstRefinement;
    property HorizontalNeighborSignificance: Byte
      read GetHorizontalNeighborSignificance;
    property Sign: Byte read GetSign write SetSign;
    property Significance: Byte read GetSignificance write SetSignificance;
    property VerticalNeighborSignificance: Byte
      read GetVerticalNeighborSignificance;
  end;
  ...
  protected
    ...
    procedure ReadQuantizationParameters(AReader: TdxBigEndianStreamReader;
      ADataLength: Integer);

    property DefaultCodingStyle: TdxJPXDefaultCodingStyle
      read FDefaultCodingStyle write FDefaultCodingStyle;
    property QuantizationParameters
      : TObjectList<TdxJPXQuantizationComponentParameters>
      read FQuantizationParameters;
  ...
  public
    ...
    class function Decode(const AData: TBytes;
      out AComponentCount: Integer): TBytes;
    class function DecodeImage(const AData: TBytes): TdxJPXImage; static;

    function CreateTile(AIndex: Integer): TdxJPXTile;

    property CodingStyleComponents: TdxJPXCodingStyleComponents
      read FCodingStyleComponents write FCodingStyleComponents;
  ...
  protected
    ...
    function ReadInclusion(ABitReader: TdxBitReader;
      X, Y, AMaxValue: Integer): Integer;
  public
  ...
  strict private
    ...
    class function ReadBoxType(AReader: TdxBigEndianStreamReader;
      var ALength: Integer): Integer;
  protected
    class procedure PopulateImage(AReader: TdxBigEndianStreamReader;
      ALength: Integer; AImage: TdxJPXImage); virtual;

    class procedure DoReadImage(AReader: TdxBigEndianStreamReader;
      AImage: TdxJPXImage; out ABoxClass: TdxJPXCustomBoxClass);
  public
    class constructor Create;
    class destructor Destroy;

    class function ID: Integer; virtual;
    class procedure ReadImage(AReader: TdxBigEndianStreamReader;
      AImage: TdxJPXImage);
  end;
  ...
  protected
    class procedure PopulateImage(AReader: TdxBigEndianStreamReader;
      ALength: Integer; AImage: TdxJPXImage); override;
  public
  ...
  strict private
    ...
    class function CreateAndRead(AReader: TdxBigEndianStreamReader;
      AImage: TdxJPXImage; AType: Integer; ATileIndex: Integer)
      : TdxJPXCustomMarker;
  ...
  protected
    ...
    procedure PopulateImage(AReader: TdxBigEndianStreamReader;
      AImage: TdxJPXImage; ATileIndex: Integer); virtual;
  ...
  public
    ...
    class function CreateMarker(AReader: TdxBigEndianStreamReader;
      AImage: TdxJPXImage): TdxJPXCustomMarker; overload;
    class function CreateMarker(AReader: TdxBigEndianStreamReader;
      AImage: TdxJPXImage; ATileIndex: Integer): TdxJPXCustomMarker; overload;
  end;
  ...
  protected
    ...
    procedure PopulateImage(AReader: TdxBigEndianStreamReader;
      AImage: TdxJPXImage; ATileIndex: Integer); override;
  end;
  ...
  const
    R = 0.5;
  protected
    function Apply(const ACoefficient: TdxJPXCoefficient;
      ASubBandGainLog, ARi, ASubBandIndex: Integer): Single; virtual; abstract;
  ...
  public
    ...
    class function CreateParameters(AReader: TdxBigEndianStreamReader;
      AByteCount: Integer): TdxJPXQuantizationComponentParameters;
  end;

  { TdxJPXUnitaryStepSizeQuantizationComponentParameters }

  TdxJPXUnitaryStepSizeQuantizationComponentParameters = class
    (TdxJPXQuantizationComponentParameters)
  strict private
    FStepSizeExponents: TIntegerDynArray;
  protected
    function Apply(const ACoefficient: TdxJPXCoefficient;
      ASubBandGainLog, ARi, ASubBandIndex: Integer): Single; override;
    function Clone: TdxJPXQuantizationComponentParameters; override;
  public
    constructor Create(AGuardBitCount: Integer;
      AReader: TdxBigEndianStreamReader; AByteCount: Integer); reintroduce;
  end;

  { TdxJPXIrreversibleTransformationQuantizationComponentParameters }

  TdxJPXIrreversibleTransformationQuantizationComponentParameters = class
    (TdxJPXQuantizationComponentParameters)
  protected
    function Apply(const ACoefficient: TdxJPXCoefficient;
      ASubBandGainLog, ARi, ASubBandIndex: Integer): Single; override;
    function GetStepSize(ASubBandIndex: Integer): TdxJPXQuantizationStepSize;
      virtual; abstract;
  end;

  { TdxJPXScalarDerivedQuantizationComponentParameters }

  TdxJPXScalarDerivedQuantizationComponentParameters = class
    (TdxJPXIrreversibleTransformationQuantizationComponentParameters)
  strict private
    FStepSize: TdxJPXQuantizationStepSize;
  protected
    function Clone: TdxJPXQuantizationComponentParameters; override;
    function GetStepSize(ASubBandIndex: Integer)
      : TdxJPXQuantizationStepSize; override;

    property StepSize: TdxJPXQuantizationStepSize read FStepSize;
  public
    constructor Create(AGuardBitCount: Integer;
      AReader: TdxBigEndianStreamReader); reintroduce;
  end;

  { TdxJPXScalarExpoundedQuantizationComponentParameters }

  TdxJPXScalarExpoundedQuantizationComponentParameters = class
    (TdxJPXIrreversibleTransformationQuantizationComponentParameters)
  strict private
  ...
  protected
    ...
    property PacketEnumerator: TList<TdxJPXPacketPosition>
      read FPacketEnumerator;
    property Tile: TdxJPXTile read FTile;
  public
    constructor Create(AImage: TdxJPXImage; ATile: TdxJPXTile); overload;
    destructor Destroy; override;

    class function CreatePacket(AOrder: TdxJPXProgressionOrder;
      AImage: TdxJPXImage; ATile: TdxJPXTile): TList<TdxJPXPacketPosition>;
  end;

  { TdxJPXLayerResolutionComponentPrecinctPacketProgressionOrder }

  TdxJPXLayerResolutionComponentPrecinctPacketProgressionOrder = class
    (TdxJPXPacketProgressionOrder)
  protected
  ...
  TdxJPXResolutionLayerComponentPrecinctPacketProgressionOrder = class
    (TdxJPXPacketProgressionOrder)
  protected
    function CreatePacketPositionList: TList<TdxJPXPacketPosition>; override;
  end;
  ...
  TdxJPXResolutionPrecinctComponentLayerPacketProgressionOrder = class
    (TdxJPXPacketProgressionOrder)
  protected
    function CreatePacketPositionList: TList<TdxJPXPacketPosition>; override;
  end;
  ...
  public
    procedure Initialize(ACodeBlock: TdxJPXCodeBlock; ACodingPasses: Byte;
      AChunkLength: Integer);
  ...
  TdxJPXTileQuantizationParametersData = class(TInterfacedObject,
    IdxJPXTileDataAction)
  strict private
  ...
  public
    constructor Create(AComponentIndex: Integer;
      AQuantizationComponentParameters: TdxJPXQuantizationComponentParameters);
    procedure Process(ATile: TdxJPXTile);
  end;
  ...
  public
    ...
    procedure AppendQuantizationParameters(AComponentIndex: Integer;
  ...
  strict private
    ...
    procedure PopulateCodeBlockHeaderDataQueue(AReader: TdxJPXBitReader;
      const ACurrentPosition: TdxJPXPacketPosition;
  ...
  public
    ...
    property ColorTransformation: TdxJPXColorTransformation
      read GetColorTransformation;
  end;
  ...
  protected
    ...
    property IsFirstInclusion: Boolean read FIsFirstInclusion
      write FIsFirstInclusion;
  ...
  public
    constructor Create(ASubBand: TdxJPXSubBand;
      ACodeBlockWidth, ACodeBlockHeight, X, Y, AWidth, AHeight,
      AIndex: Integer);
    destructor Destroy; override;
  ...
  public
    function Interleave(const AHLSubBandCoefficients, ALHSubBandCoefficients,
      AHHSubBandCoefficients: TdxJPXSubBandCoefficients)
      : TdxJPXSubBandCoefficients;
    procedure Initialize(const ACoefficients: TSingleDynArray;
...
{$REGION 'private types'}
    ...
    public
      function Build(ASubBand: TdxJPXSubBand;
        ACodeBlockWidth, ACodeBlockHeight: Integer)
        : TObjectList<TdxJPXCodeBlock>;
    end;
{$ENDREGION}
  strict private
    FCodeBlocks: TObjectList<TdxJPXCodeBlock>;
  ...
  protected
    ...
    function CalculateContextLabel(const ACoefficient: TdxJPXCoefficient)
      : Integer; overload;
  ...
  public
    constructor Create(AComponent: TdxJPXTileComponent;
      AResolutionLevelIndex, ACodeBlockWidth, ACodeBlockHeight
      : Integer); virtual;
    destructor Destroy; override;
  end;
  ...
  strict private
  type
    TCodeBlockProcessingProc = procedure(AIndex, X, Y: Integer;
      var ACoefficient: TdxJPXCoefficient) of object;
  strict private
    ...
    procedure CalculateCurrentCoefficient(X, Y, AIndex: Integer;
      out AVContribution, AHContribution: Integer);
  protected
    class function NormalizeContribution(AContribution: Integer): Integer;
    function DoDecode(ACodeBlockCodingStyle: TdxJPXCodeBlockCodingStyle)
      : TdxJPXCoefficients;
    function GetSignContribution(AIndex: Integer): Integer;
    function GetSignBit(X, Y, AIndex: Integer;
      var ACoefficient: TdxJPXCoefficient): TdxJPXCoefficient;
    procedure CleanUpPass;
    procedure DoMagnitudeRefinementPass(AIndex, X, Y: Integer;
      var ACoefficient: TdxJPXCoefficient);
    procedure DoSignificancePropagationPass(AIndex, X, Y: Integer;
      var ACoefficient: TdxJPXCoefficient);
  ...
  public
    constructor Create(ACodeBlock: TdxJPXCodeBlock; AStream: TStream;
      ASubBand: TdxJPXSubBand);
    destructor Destroy; override;
  ...
  strict private
    ...
    procedure SetQuantizationParameters(const AValue
      : TdxJPXQuantizationComponentParameters);
  protected
    ...
    property QuantizationParameters: TdxJPXQuantizationComponentParameters
      read FQuantizationParameters write SetQuantizationParameters;
  public
    ...
    property ResolutionLevel[Index: Integer]: TdxJPXResolutionLevel
      read GetResolutionLevel; default;
  end;
  ...
  public
    ...
    class function BuildData(ATileComponents: TObjectList<TdxJPXTileComponent>)
      : TdxJPXTileComponentDataArray;
  end;
  ...
  protected
    ...
    procedure Append(const AHlCoefficients, ALhCoefficients, AHhCoefficients
      : TdxJPXSubBandCoefficients);
    procedure HorizontalReconstruction;
    procedure VerticalReconstruction;

    property SubBandCoefficients: TdxJPXSubBandCoefficients
      read FSubBandCoefficients;
  public
    constructor Create; overload;
    constructor Create(const ALLSubBandCoefficients
      : TdxJPXSubBandCoefficients); overload;
  ...
  TdxJPXIrreversibleDiscreteWaveletTransformation = class
    (TdxJPXDiscreteWaveletTransformation)
  protected
  ...
  TdxJPXReversibleDiscreteWaveletTransformation = class
    (TdxJPXDiscreteWaveletTransformation)
  protected
    procedure Filter(const Y: TSingleDynArray; I0, I1: Integer); override;
  end;
  ...
  protected
    ...
    procedure TransformColor(V, H: Integer; const ADestination: TBytes;
      ADestinationOffset: Integer); virtual; abstract;
  ...
  public
    constructor Create(AWidth, AHeight: Integer;
      const AComponentsData: TdxJPXTileComponentDataArray); virtual;
    destructor Destroy; override;
  ...
  protected
    procedure TransformColor(V, H: Integer; const ADestination: TBytes;
      ADestinationOffset: Integer); override;
  end;
  ...
  protected
    procedure Transform(const AData: TBytes; Y0, Y1, Y2: Single;
      ADestinationOffset: Integer); virtual;
    procedure TransformColor(V, H: Integer; const ADestination: TBytes;
      ADestinationOffset: Integer); override;
  public
    constructor Create(AWidth, AHeight: Integer;
      const AComponentData: TdxJPXTileComponentDataArray); override;
  end;

  { TdxJPXReversibleColorTransformation }

  TdxJPXReversibleColorTransformation = class
    (TdxJPXMultipleComponentTransformation)
  protected
    procedure Transform(const AData: TBytes; Y0, Y1, Y2: Single;
      ADestinationOffset: Integer); override;
  ...
  TdxJPXIrreversibleColorTransformation = class
    (TdxJPXMultipleComponentTransformation)
  protected
    procedure Transform(const AData: TBytes; Y0, Y1, Y2: Single;
      ADestinationOffset: Integer); override;
...
begin
  ...
  else if (FA and $80000000) <> 0 then
    Exit(AMpsCX);
  ACx[AIndex] := IfThen(ACLessA xor AALessQe, APqe.MpsXor or AMpsCX,
    APqe.LpsXor or AMpsCX xor APqe.Switch);
  Renormalized;
...
class function TdxArithmeticQe.Create(AQe: LongWord;
  AMpsXor, ALpsXor, ASwitch: Byte): TdxArithmeticQe;
begin
  Result.FQe := AQe;
...
constructor TdxArithmeticContext.Create(AState: TdxArithmeticState;
...
procedure TdxJPXPacketPosition.Initialize(AComponent, ALayer, AResolutionLevel,
  APrecinct: Integer);
begin
...
procedure TdxJPXComponent.Initialize(ABitsPerComponent, AHorizontalSeparation,
  AVerticalSeparation: Integer);
begin
...
procedure TdxJPXDefaultCodingStyle.Initialize
...
procedure TdxJPXCodingStyleComponent.Initialize
  (AReader: TdxBigEndianStreamReader; AUsePrecincts: Boolean);
var
  I: Integer;
  AValue: Byte;
begin
...
procedure TdxJPXCodeBlockChunk.Initialize(const AData: TBytes;
...
procedure TdxJPXTileComponentData.Initialize(const AData: TSingleDynArray;
  ABitsPerComponent: Integer);
var
  L: Integer;
begin
...
var
  I, AComponentCount, ABitsPerComponent, AHorizontalSeparation,
    AVerticalSeparation: Integer;
begin
  ...
  begin
    ...
    FComponents[I].Initialize(ABitsPerComponent, AHorizontalSeparation,
      AVerticalSeparation);
  end;
  if (FGridWidth < 1) or (FGridHeight < 1) or (FTileWidth < 1) or
    (FTileHeight < 1) or (AComponentCount < 1) then
    dxJPXRaiseException;
end;
...
begin
  inherited Create;
  FQuantizationParameters :=
    TObjectList<TdxJPXQuantizationComponentParameters>.Create;
end;
...
class function TdxJPXImage.Decode(const AData: TBytes;
  out AComponentCount: Integer): TBytes;
var
  AImage: TdxJPXImage;
  ...
  try
    ...
    begin
      ...
      try
        ...
        try
          AColorTransformation.Transform(Result,
            AComponentCount * (ATile.X0 + ATile.Y0 * AGridWidth), AGridWidth);
        finally
...
class function TdxJPXImage.DecodeImage(const AData: TBytes): TdxJPXImage;
  ...
  procedure InternalDecode(AImage: TdxJPXImage;
    AReader: TdxBigEndianStreamReader);
  var
  ...
  begin
    ...
    if AIsCodeStream then
      TdxJPXContiguousCodeStreamBox.PopulateImage(AReader,
        AReader.Length, AImage)
    else
...
procedure TdxJPXImage.ReadCodingStyleComponents
  (AReader: TdxBigEndianStreamReader);
var
  I, L: Integer;
...
procedure TdxJPXImage.ReadQuantizationParameters
  (AReader: TdxBigEndianStreamReader; ADataLength: Integer);
var
...
begin
  ...
  AQuantizationParameters := TdxJPXQuantizationComponentParameters.
    CreateParameters(AReader, AByteCount);
  try
...
begin
  ...
  FNumXTiles := Ceil((FSize.GridWidth - Max(FSize.TileHorizontalOffset,
    FSize.GridHorizontalOffset)) / FSize.TileWidth);
  FNumYTiles := Ceil((FSize.GridHeight - Max(FSize.TileVerticalOffset,
    FSize.GridVerticalOffset)) / FSize.TileHeight);
end;
...
function TdxJPXTagTree.ReadInclusion(ABitReader: TdxBitReader;
  X, Y, AMaxValue: Integer): Integer;
var
...
function TdxJPXTagTree.GetPreviousValue(X: Integer; Y: Integer)
  : TdxJPXTagTreeNode;
var
...
begin
  ...
  FDictionary.Add(TdxJPXContiguousCodeStreamBox.ID,
    TdxJPXContiguousCodeStreamBox);
end;
...
class procedure TdxJPXCustomBox.ReadImage(AReader: TdxBigEndianStreamReader;
  AImage: TdxJPXImage);
var
...
class procedure TdxJPXCustomBox.PopulateImage(AReader: TdxBigEndianStreamReader;
  ALength: Integer; AImage: TdxJPXImage);
begin
  // do nothing
end;

class procedure TdxJPXCustomBox.DoReadImage(AReader: TdxBigEndianStreamReader;
  AImage: TdxJPXImage; out ABoxClass: TdxJPXCustomBoxClass);
var
  ALength: Integer;
begin
...
class function TdxJPXCustomBox.GetBoxClass(AType: Integer)
  : TdxJPXCustomBoxClass;
begin
  if not FDictionary.TryGetValue(AType, Result) then
    Result := TdxJPXUnknownBox;
end;

class function TdxJPXCustomBox.ReadBoxType(AReader: TdxBigEndianStreamReader;
  var ALength: Integer): Integer;
var
...
class procedure TdxJPXSignatureBox.PopulateImage
  (AReader: TdxBigEndianStreamReader; ALength: Integer; AImage: TdxJPXImage);
const
  Content = $0D0A870A;
begin
...
class procedure TdxJPXFileTypeBox.PopulateImage
  (AReader: TdxBigEndianStreamReader; ALength: Integer; AImage: TdxJPXImage);
begin
  inherited PopulateImage(AReader, ALength, AImage);
...
class procedure TdxJPXImageHeaderBox.PopulateImage
  (AReader: TdxBigEndianStreamReader; ALength: Integer; AImage: TdxJPXImage);
var
...
class procedure TdxJPXColorSpecificationBox.PopulateImage
  (AReader: TdxBigEndianStreamReader; ALength: Integer; AImage: TdxJPXImage);
var
  AMethod: Byte;
begin
...
class procedure TdxJPXJP2HeaderBox.PopulateImage
  (AReader: TdxBigEndianStreamReader; ALength: Integer; AImage: TdxJPXImage);
...
class procedure TdxJPXContiguousCodeStreamBox.PopulateImage
  (AReader: TdxBigEndianStreamReader; ALength: Integer; AImage: TdxJPXImage);
  ...
  begin
    AMarker := TdxJPXCustomMarker.CreateMarker(AReader, AImage,
      dxcInvalidIntegerValue);
    if AMarker <> nil then
    begin
...
begin
  ...
  try
    ...
    while AReader.Position < AEndPosition do
    begin
      ACurrentMarker := TdxJPXCustomMarker.CreateMarker(AReader, AImage,
        dxcInvalidIntegerValue);
      ...
      begin
        ...
        if ACurrentMarker is TdxJPXCodeStreamEndMarker then
          Break;
        if (ADefaultCodingStyleMarker = nil) and
          (ACurrentMarker is TdxJPXDefaultCodingStyleMarker) then
          ADefaultCodingStyleMarker := TdxJPXDefaultCodingStyleMarker
            (ACurrentMarker);

        if (ADefaultQuantizationMarker = nil) and
          (ACurrentMarker is TdxJPXDefaultQuantizationMarker) then
          ADefaultQuantizationMarker := TdxJPXDefaultQuantizationMarker
            (ACurrentMarker);
      end
      else
    ...
    if (ADefaultCodingStyleMarker = nil) or (ADefaultQuantizationMarker = nil)
      or (AReader.Position > AEndPosition) then
      dxJPXRaiseException;
  finally
    ATempList.Free;
  end;
...
class procedure TdxJPXUnknownBox.PopulateImage
  (AReader: TdxBigEndianStreamReader; ALength: Integer; AImage: TdxJPXImage);
begin
  inherited PopulateImage(AReader, ALength, AImage);
  AReader.Skip(ALength);
...
begin
  ...
  FDictionary.Add(TdxJPXStartOfCodeStreamMarker.ID,
    TdxJPXStartOfCodeStreamMarker);
  ...
  FDictionary.Add(TdxJPXDefaultCodingStyleMarker.ID,
    TdxJPXDefaultCodingStyleMarker);
  FDictionary.Add(TdxJPXCodingStyleComponentMarker.ID,
    TdxJPXCodingStyleComponentMarker);
  FDictionary.Add(TdxJPXStartOfTilePartMarker.ID, TdxJPXStartOfTilePartMarker);
  FDictionary.Add(TdxJPXDefaultQuantizationMarker.ID,
    TdxJPXDefaultQuantizationMarker);
  FDictionary.Add(TdxJPXQuantizationComponentMarker.ID,
    TdxJPXQuantizationComponentMarker);
...
class function TdxJPXCustomMarker.CreateMarker
  (AReader: TdxBigEndianStreamReader; AImage: TdxJPXImage): TdxJPXCustomMarker;
begin
  Result := CreateMarker(AReader, AImage, dxcInvalidIntegerValue);
end;

class function TdxJPXCustomMarker.CreateMarker
  (AReader: TdxBigEndianStreamReader; AImage: TdxJPXImage; ATileIndex: Integer)
  : TdxJPXCustomMarker;
begin
...
procedure TdxJPXCustomMarker.PopulateImage(AReader: TdxBigEndianStreamReader;
  AImage: TdxJPXImage; ATileIndex: Integer);
begin
  DoRead;
end;
...
procedure TdxJPXCustomMarker.ReadAndCheckLength
  (AReader: TdxBigEndianStreamReader);
begin
  Read(AReader);
...
class function TdxJPXCustomMarker.CreateAndRead
  (AReader: TdxBigEndianStreamReader; AImage: TdxJPXImage; AType: Integer;
...
procedure TdxJPXDefaultCodingStyleMarker.PopulateImage
  (AReader: TdxBigEndianStreamReader; AImage: TdxJPXImage; ATileIndex: Integer);
begin
...
procedure TdxJPXStartOfTilePartMarker.PopulateImage
  (AReader: TdxBigEndianStreamReader; AImage: TdxJPXImage; ATileIndex: Integer);
  ...
  procedure PopulatePackets(ATile: Integer; ATileLength: Integer;
    AStartPosition: Int64);
  var
    AData: TBytes;
  begin
    AData := AReader.ReadBytes(ATileLength - DataLength - 6 -
      (AReader.Position - AStartPosition - 2));
...
procedure TdxJPXSizeMarker.PopulateImage(AReader: TdxBigEndianStreamReader;
  AImage: TdxJPXImage; ATileIndex: Integer);
var
  ASize: TdxJPXSize;
begin
...
procedure TdxJPXDefaultQuantizationMarker.PopulateImage
  (AReader: TdxBigEndianStreamReader; AImage: TdxJPXImage; ATileIndex: Integer);
begin
  ReadAndCheckLength(AReader);
...
procedure TdxJPXCodingStyleComponentMarker.PopulateImage
  (AReader: TdxBigEndianStreamReader; AImage: TdxJPXImage; ATileIndex: Integer);
begin
  ReadAndCheckLength(AReader);
...
procedure TdxJPXQuantizationComponentMarker.PopulateImage
  (AReader: TdxBigEndianStreamReader; AImage: TdxJPXImage; ATileIndex: Integer);
var
...
begin
  ...
  if IsValidIntegerValue(ATileIndex) then
    AImage.Tiles[ATileIndex].AppendQuantizationParameters(AComponent,
      TdxJPXQuantizationComponentParameters.CreateParameters(AReader,
      AByteCount))
  else
    AImage.QuantizationParameters[AComponent] :=
      TdxJPXQuantizationComponentParameters.CreateParameters(AReader,
      AByteCount);
end;
...
procedure TdxJPXUnknownMarker.PopulateImage(AReader: TdxBigEndianStreamReader;
  AImage: TdxJPXImage; ATileIndex: Integer);
begin
  Read(AReader);
...
constructor TdxJPXQuantizationComponentParameters.Create(AGuardBitCount
  : Integer);
begin
  inherited Create;
...
class function TdxJPXQuantizationComponentParameters.CreateParameters
...
begin
  ...
  case AQuantizationStyle of
    0:
      Result := TdxJPXUnitaryStepSizeQuantizationComponentParameters.Create
        (AGuardBitCount, AReader, AByteCount - 1);
    1:
      Result := TdxJPXScalarDerivedQuantizationComponentParameters.Create
        (AGuardBitCount, AReader);
    2:
      Result := TdxJPXScalarExpoundedQuantizationComponentParameters.Create
        (AGuardBitCount, AReader, AByteCount - 1);
  else
    Result := nil;
  end;
...
constructor TdxJPXUnitaryStepSizeQuantizationComponentParameters.Create
  (AGuardBitCount: Integer; AReader: TdxBigEndianStreamReader;
  AByteCount: Integer);
var
  I: Integer;
begin
...
function TdxJPXUnitaryStepSizeQuantizationComponentParameters.Apply
  (const ACoefficient: TdxJPXCoefficient;
...
begin
  ...
  if Q <> 0 then
  begin
    AStepSize := Power(2, GuardBitCount + FStepSizeExponents[ASubBandIndex] -
      ACoefficient.BitsDecoded - 1);
    Result := IfThen(AStepSize = 1, Q, (Q + IfThen(Q < 0, -R, R)) * AStepSize);
  end;
end;

function TdxJPXUnitaryStepSizeQuantizationComponentParameters.Clone
  : TdxJPXQuantizationComponentParameters;
var
  L: Integer;
begin
  ...
  SetLength(TdxJPXUnitaryStepSizeQuantizationComponentParameters(Result)
    .FStepSizeExponents, L);
  cxCopyData(@FStepSizeExponents[0],
    @TdxJPXUnitaryStepSizeQuantizationComponentParameters(Result)
    .FStepSizeExponents[0], L * SizeOF(Integer));
end;

{ TdxJPXIrreversibleTransformationQuantizationComponentParameters }

function TdxJPXIrreversibleTransformationQuantizationComponentParameters.Apply
  (const ACoefficient: TdxJPXCoefficient;
  ASubBandGainLog, ARi, ASubBandIndex: Integer): Single;
var
  Q, APow: Integer;
...
begin
  ...
  begin
    ...
    AStepSize := IfThen(APow < 0, AStepSize / (1 shl - APow),
      AStepSize * (1 shl APow));
    APow := GuardBitCount + AQuantizationStepSize.Epsilon -
      ACoefficient.BitsDecoded - 1;
    if APow < 0 then
      dxJPXRaiseException;
...
constructor TdxJPXScalarDerivedQuantizationComponentParameters.Create
  (AGuardBitCount: Integer; AReader: TdxBigEndianStreamReader);
var
  AV1, AV2: Byte;
begin
...
function TdxJPXScalarDerivedQuantizationComponentParameters.Clone
  : TdxJPXQuantizationComponentParameters;
begin
  Result := TdxJPXScalarDerivedQuantizationComponentParameters.Create
    (GuardBitCount, nil);
  TdxJPXScalarDerivedQuantizationComponentParameters(Result).FStepSize :=
    FStepSize;
end;

function TdxJPXScalarDerivedQuantizationComponentParameters.GetStepSize
  (ASubBandIndex: Integer): TdxJPXQuantizationStepSize;
var
  I: Integer;
begin
...
constructor TdxJPXScalarExpoundedQuantizationComponentParameters.Create
  (AGuardBitCount: Integer; AReader: TdxBigEndianStreamReader;
  AByteCount: Integer);
var
  AV1, AV2: Byte;
...
function TdxJPXScalarExpoundedQuantizationComponentParameters.Clone
  : TdxJPXQuantizationComponentParameters;
begin
  Result := TdxJPXScalarExpoundedQuantizationComponentParameters.Create
    (GuardBitCount, nil, 0);
  SetLength(TdxJPXScalarExpoundedQuantizationComponentParameters(Result)
    .FStepSizes, Length(FStepSizes));
  cxCopyData(@FStepSizes[0],
    @TdxJPXScalarExpoundedQuantizationComponentParameters(Result).FStepSizes[0],
    Length(FStepSizes) * SizeOF(TdxJPXQuantizationStepSize));
end;

function TdxJPXScalarExpoundedQuantizationComponentParameters.GetStepSize
  (ASubBandIndex: Integer): TdxJPXQuantizationStepSize;
begin
...
constructor TdxJPXPacketProgressionOrder.Create(AImage: TdxJPXImage;
  ATile: TdxJPXTile);
begin
  inherited Create;
  FImage := AImage;
...
function TdxJPXPacketProgressionOrder.CreatePacketPositionList
  : TList<TdxJPXPacketPosition>;
begin
  Result := TList<TdxJPXPacketPosition>.Create;
end;

class function TdxJPXPacketProgressionOrder.CreatePacket
  (AOrder: TdxJPXProgressionOrder; AImage: TdxJPXImage; ATile: TdxJPXTile)
  : TList<TdxJPXPacketPosition>;
var
...
begin
  case AOrder of
    poLayerResolutionComponentPosition:
      APacketProgressionOrder :=
        TdxJPXLayerResolutionComponentPrecinctPacketProgressionOrder.Create
        (AImage, ATile);
    poResolutionLayerComponentPosition:
      APacketProgressionOrder :=
        TdxJPXResolutionLayerComponentPrecinctPacketProgressionOrder.Create
        (AImage, ATile);
    poResolutionPositionComponentLayer:
      APacketProgressionOrder :=
        TdxJPXResolutionPrecinctComponentLayerPacketProgressionOrder.Create
        (AImage, ATile);
  else
...
begin
  ...
  for I := 0 to Length(Image.CodingStyleComponents) - 1 do
    Result := Max(Image.CodingStyleComponents[I].DecompositionLevelCount +
      1, Result);
end;

{ TdxJPXLayerResolutionComponentPrecinctPacketProgressionOrder }

function TdxJPXLayerResolutionComponentPrecinctPacketProgressionOrder.
  CreatePacketPositionList: TList<TdxJPXPacketPosition>;
var
  APosition: TdxJPXPacketPosition;
  AMaxResolutionLevel, ALayer, AComponent, APrecinct, APrecinctCount,
    AResolutionLevel: Integer;
begin
  ...
  for ALayer := 0 to Image.DefaultCodingStyle.LayerCount - 1 do
    for AResolutionLevel := 0 to AMaxResolutionLevel - 1 do
      for AComponent := 0 to Length(Image.CodingStyleComponents) - 1 do
        if AResolutionLevel <= Image.CodingStyleComponents[AComponent].DecompositionLevelCount
        then
        begin
          APrecinctCount := Tile.Components[AComponent].ResolutionLevel
            [AResolutionLevel].PrecinctCount;
          for APrecinct := 0 to APrecinctCount - 1 do
          begin
            APosition.Initialize(AComponent, ALayer, AResolutionLevel,
              APrecinct);
...
function TdxJPXResolutionLayerComponentPrecinctPacketProgressionOrder.
  CreatePacketPositionList: TList<TdxJPXPacketPosition>;
var
  APosition: TdxJPXPacketPosition;
  AMaxResolutionLevel, AResolution, ALayer, AComponent, APrecinctCount,
    APrecinct: Integer;
begin
  Result := inherited CreatePacketPositionList;
  AMaxResolutionLevel := MaxResolutionLevel;
  for AResolution := 0 to AMaxResolutionLevel - 1 do
    for ALayer := 0 to Image.DefaultCodingStyle.LayerCount - 1 do
      for AComponent := 0 to Length(Image.CodingStyleComponents) - 1 do
        if AResolution <= Image.CodingStyleComponents[AComponent].DecompositionLevelCount
        then
        begin
          APrecinctCount := Tile.Components[AComponent].ResolutionLevel
            [AResolution].PrecinctCount;
          for APrecinct := 0 to APrecinctCount - 1 do
          begin
...
function TdxJPXResolutionPrecinctComponentLayerPacketProgressionOrder.
  CreatePacketPositionList: TList<TdxJPXPacketPosition>;
var
  AMaxPrecinct, AMaxResolutionLevel, AComponent, AResolution, APrecinct,
    ALayer: Integer;
  ...
  begin
    ...
    for AResolution := 0 to AMaxResolutionLevel - 1 do
      if AResolution <= ACodingStyleComponent.DecompositionLevelCount then
        AMaxPrecinct := Max(AMaxPrecinct, Tile.Components[AComponent]
          .ResolutionLevel[AResolution].PrecinctCount);
  end;
  for AResolution := 0 to AMaxResolutionLevel - 1 do
    for APrecinct := 0 to AMaxPrecinct - 1 do
      ...
      begin
        ...
        if (AResolution <= ACodingStyleComponent.DecompositionLevelCount) and
          (APrecinct < Tile.Components[AComponent].ResolutionLevel[AResolution]
          .PrecinctCount) then
          for ALayer := 0 to Image.DefaultCodingStyle.LayerCount - 1 do
          begin
            APosition.Initialize(AComponent, ALayer, AResolution, APrecinct);
...
constructor TdxJPXTileQuantizationParametersData.Create(AComponentIndex
  : Integer; AQuantizationComponentParameters
  : TdxJPXQuantizationComponentParameters);
begin
  inherited Create;
...
begin
  ATile.Components[FComponentIndex].QuantizationParameters :=
    FQuantizationComponentParameters;
end;
...
procedure TdxJPXTileData.AppendQuantizationParameters(AComponentIndex: Integer;
  AParameters: TdxJPXQuantizationComponentParameters);
begin
  FPackets.Add(TdxJPXTileQuantizationParametersData.Create(AComponentIndex,
    AParameters));
end;
...
begin
  ...
  X0 := Max(FImage.Size.TileHorizontalOffset + P * FImage.Size.TileWidth,
    FImage.Size.GridHorizontalOffset);
  Y0 := Max(FImage.Size.TileVerticalOffset + Q * FImage.Size.TileHeight,
    FImage.Size.GridVerticalOffset);
  X1 := Min(FImage.Size.TileHorizontalOffset + (P + 1) * FImage.Size.TileWidth,
    FImage.Size.GridWidth);
  Y1 := Min(FImage.Size.TileVerticalOffset + (Q + 1) * FImage.Size.TileHeight,
    FImage.Size.GridHeight);
  FComponents := TObjectList<TdxJPXTileComponent>.Create;
  for I := 0 to Length(FImage.Size.Components) - 1 do
  begin
    ATileComponent := TdxJPXTileComponent.Create(Self,
      FImage.Size.Components[I], FImage.CodingStyleComponents[I],
      FImage.QuantizationParameters[I]);
    FComponents.Add(ATileComponent);
  end;
  FPacketPositionList := TdxJPXPacketProgressionOrder.CreatePacket
    (AImage.DefaultCodingStyle.ProgressionOrder, FImage, Self);
end;
...
class function TdxJPXTile.ReadCodingPassCount(AReader: TdxJPXBitReader)
  : Integer;
var
  AValue: Integer;
begin
...
begin
  ...
  try
    ...
    begin
      ...
      PopulateCodeBlockHeaderDataQueue(AReader, ACurrentPosition,
        ACodeBlockHeaderDataQueue);
      AReader.AlignToByte;
...
begin
  AResolutionLevel := FComponents[ACurrentPosition.Component].ResolutionLevel
    [ACurrentPosition.ResolutionLevel];
  ...
  begin
    if APrecinct.Index = ACurrentPosition.Precinct then
      ...
      begin
        ...
        J := (ACodeBlock.Y0 - APrecinct.Y0)
          div AResolutionLevel.CodeBlockHeight;
        if ACodeBlock.IsFirstInclusion then
        begin
          if ACurrentPosition.Layer < APrecinct.InclusionTree.ReadInclusion
            (AReader, I, J, ACurrentPosition.Layer) then
            Continue;
          ACodeBlock.IsFirstInclusion := False;
          ACodeBlock.ZeroBitPlanes := APrecinct.ZeroBitPlaneTree.
            Read(AReader, I, J);
        end
        else if AReader.GetBit = 0 then
          Continue;
        ...
        ADataLength := AReader.GetInteger
          (ALBlock + Floor(LogN(2, ACodingPassCount)));
...
constructor TdxJPXCodeBlock.Create(X: Integer; Y: Integer; AWidth: Integer;
  AHeight: Integer);
begin
  inherited Create;
  FLBlock := 3;
...
procedure TdxJPXCodeBlockHeaderData.Initialize(ACodeBlock: TdxJPXCodeBlock;
  ACodingPasses: Byte; AChunkLength: Integer);
begin
...
constructor TdxJPXPrecinct.Create(ASubBand: TdxJPXSubBand;
  ACodeBlockWidth, ACodeBlockHeight, X, Y, AWidth, AHeight, AIndex: Integer);
var
...
begin
  ...
  begin
    FInclusionTree := TdxJPXTagTree.Create(FCodeBlockHorizontalCount,
      FCodeBlockVerticalCount);
    FZeroBitPlaneTree := TdxJPXTagTree.Create(FCodeBlockHorizontalCount,
      FCodeBlockVerticalCount);
  end;
...
function TdxJPXSubBandCoefficients.Interleave(const AHLSubBandCoefficients,
  ALHSubBandCoefficients, AHHSubBandCoefficients: TdxJPXSubBandCoefficients)
  : TdxJPXSubBandCoefficients;
var
...
begin
  ...
  begin
    ...
    begin
      ...
      Inc(ALeft);
      Inc(ASource);
      if (I < ALHSubBandCoefficients.Height) and
        (J < ALHSubBandCoefficients.Width) then
        ACoefficients[ARight] := ALHSubBandCoefficients.Coefficients
          [I * ALHSubBandCoefficients.Width + J];
      Inc(ARight);
      if (I < AHHSubBandCoefficients.Height) and
        (J < AHHSubBandCoefficients.Width) then
        ACoefficients[ARight] := AHHSubBandCoefficients.Coefficients
          [I * AHHSubBandCoefficients.Width + J];
      if (I < AHLSubBandCoefficients.Height) and
        (J < AHLSubBandCoefficients.Width) then
        ACoefficients[ALeft] := AHLSubBandCoefficients.Coefficients
          [I * AHLSubBandCoefficients.Width + J];
      Inc(ALeft);
      Inc(ARight);
    end;
...
procedure TdxJPXSubBandCoefficients.Initialize(const ACoefficients
  : TSingleDynArray; AWidth, AHeight: Integer);
begin
...
begin
  ...
  begin
    ...
    try
      FCodeBlocks := ACodeBlocksBuilder.Build(Self, ACodeBlockWidth,
        ACodeBlockHeight);
    finally
...
function TdxJPXSubBand.CalculateContextLabel(const ACoefficient
  : TdxJPXCoefficient): Integer;
begin
  Result := GetContextLabel(ACoefficient.VerticalNeighborSignificance,
    ACoefficient.HorizontalNeighborSignificance,
...
begin
  ...
  ASubBandIndex := (FComponent.CodingStyle.DecompositionLevelCount -
    FResolutionLevelIndex) * 3 + HorizontalQuantity + 2 * VerticalQuantity;
  SetLength(ACoefficients, AHeight * AWidth);
  for ACodeBlock in FCodeBlocks do
  begin
    AData := TdxJPXCoefficientBitModel.Decode(ACodeBlock, Self,
      ACodeBlockCodingStyle);
    ...
    begin
      ...
      begin
        ACoefficients[I] := FComponent.QuantizationParameters.Apply(AData[H],
          AGainLog, FComponent.BitsPerComponent, ASubBandIndex);
...
function TdxJPXSubBand.TCodeBlocksBuilder.Build(ASubBand: TdxJPXSubBand;
  ACodeBlockWidth, ACodeBlockHeight: Integer): TObjectList<TdxJPXCodeBlock>;
var
  ATop, I: Integer;
begin
  FX0 := ASubBand.X0;
  ...
  FCodeBlocks := TObjectList<TdxJPXCodeBlock>.Create;
  FStartInnerHorizontalOffset := (FX0 div ACodeBlockWidth + 1) *
    ACodeBlockWidth;
  ...
  begin
    AddRow(FY0, Min((FY0 div FCodeBlockHeight + 1) * FCodeBlockHeight - FY0,
      FY1 - FY0));
...
procedure TdxJPXSubBand.TCodeBlocksBuilder.AddRow(ATop, ACodeBlockHeight
  : Integer);
var
  ALeft, J: Integer;
begin
  FCodeBlocks.Add(TdxJPXCodeBlock.Create(FX0, ATop, FActualLeftBlockWidth,
    ACodeBlockHeight));
  Inc(FCodeBlockIndex);
  ALeft := FStartInnerHorizontalOffset;
  for J := 1 to FRightCodeBlockBand - 1 do
  begin
    FCodeBlocks.Add(TdxJPXCodeBlock.Create(ALeft, ATop, FCodeBlockWidth,
      ACodeBlockHeight));
    Inc(FCodeBlockIndex);
  ...
  begin
    FCodeBlocks.Add(TdxJPXCodeBlock.Create(ALeft, ATop, FX1 - ALeft,
      ACodeBlockHeight));
    Inc(FCodeBlockIndex);
  end;
end;
...
constructor TdxJPXCoefficientBitModel.Create(ACodeBlock: TdxJPXCodeBlock;
  AStream: TStream; ASubBand: TdxJPXSubBand);
var
  AContext: TBytes;
  AIndex: Integer;
  AZeroBitPlanes: Byte;
...
class function TdxJPXCoefficientBitModel.Decode(ACodeBlock: TdxJPXCodeBlock;
  ASubBand: TdxJPXSubBand; ACodeBlockCodingStyle: TdxJPXCodeBlockCodingStyle)
  : TdxJPXCoefficients;
var
...
begin
  ...
  try
    ABitModel := TdxJPXCoefficientBitModel.Create(ACodeBlock, AStream,
      ASubBand);
    try
...
class function TdxJPXCoefficientBitModel.NormalizeContribution
  (AContribution: Integer): Integer;
begin
  Result := Min(1, Max(-1, AContribution));
end;

function TdxJPXCoefficientBitModel.DoDecode(ACodeBlockCodingStyle
  : TdxJPXCodeBlockCodingStyle): TdxJPXCoefficients;
var
  I, AState: Integer;
...
function TdxJPXCoefficientBitModel.GetSignContribution(AIndex: Integer)
  : Integer;
var
...
function TdxJPXCoefficientBitModel.GetSignBit(X, Y, AIndex: Integer;
  var ACoefficient: TdxJPXCoefficient): TdxJPXCoefficient;
var
...
begin
  ...
  AXorBit := IfThen((AHContribution < 0) or (AHContribution = 0) and
    (AVContribution < 0), 1, 0);
  D := FArithmeticContext.DecodeBit(FSignContextLabels[AHContribution + 1,
    AVContribution + 1]);
...
procedure TdxJPXCoefficientBitModel.CleanUpPass;
  ...
  procedure DecodeCoefficient(X, Y, AOffset, AMaxOffset, AMaxHeight: Integer;
    var N: Integer);
  var
  ...
  begin
    ...
    begin
      ACoefficientIndex := FArithmeticContext.DecodeBit
        (FUniformContextIndex) shl 1;
      ACoefficientIndex := ACoefficientIndex or FArithmeticContext.DecodeBit
        (FUniformContextIndex);
...
var
  APreviousSignificancePropagationPassIndex, Y, AMaxHeight, X, AOffset,
    AMaxOffset, K, N, I: Integer;
    ...
    begin
      ...
      begin
        ...
        if (ACoefficient.Significance <> 0) or
          (ACoefficient.NotZeroContextLabelPassIndex =
          APreviousSignificancePropagationPassIndex) or
      ...
      begin
        ...
        if (ACoefficient.Significance = 0) and
          (ACoefficient.NotZeroContextLabelPassIndex <>
          APreviousSignificancePropagationPassIndex) then
        begin
          if FArithmeticContext.DecodeBit
            (FSubBand.CalculateContextLabel(ACoefficient)) <> 0 then
            ReadSignBit(X, N);
          FCoefficients[I].BitsDecoded := FCoefficients[I].BitsDecoded + 1;
        end;
...
procedure TdxJPXCoefficientBitModel.DoMagnitudeRefinementPass(AIndex, X,
  Y: Integer; var ACoefficient: TdxJPXCoefficient);
var
  AContextLabelIndex: Integer;
begin
  if (ACoefficient.Significance <> 0) and
    (ACoefficient.CalculatedSignificancesStepIndex <> FPassCount + 1) then
  begin
    ...
    if ACoefficient.IsNotFirstRefinement then
      ACoefficient.Magnitude := ACoefficient.Magnitude or
        SmallInt(FArithmeticContext.DecodeBit(16))
    else
    begin
      ACoefficient.IsNotFirstRefinement := True;
      AContextLabelIndex := ACoefficient.DiagonalNeighborSignificance +
        ACoefficient.VerticalNeighborSignificance +
        ACoefficient.HorizontalNeighborSignificance;
      ACoefficient.Magnitude := ACoefficient.Magnitude or
        SmallInt(FArithmeticContext.DecodeBit(IfThen(AContextLabelIndex = 0,
        14, 15)));
    end;
...
procedure TdxJPXCoefficientBitModel.DoSignificancePropagationPass(AIndex, X,
  Y: Integer; var ACoefficient: TdxJPXCoefficient);
var
...
procedure TdxJPXCoefficientBitModel.IterateCodeBlock
  (AProc: TCodeBlockProcessingProc);
var
...
procedure TdxJPXCoefficientBitModel.CalculateCurrentCoefficient(X, Y,
  AIndex: Integer; out AVContribution, AHContribution: Integer);
var
...
begin
  ...
  begin
    ...
    if AIsNotLeftElement then
      FCoefficients[APreviousRowIndex - 1]
        .IncrementDiagonalNeighborSignificance;
...
constructor TdxJPXTileComponent.Create(ATile: TdxJPXTile;
  const AComponent: TdxJPXComponent;
  const ACodingStyle: TdxJPXCodingStyleComponent;
  AQuantizationParameters: TdxJPXQuantizationComponentParameters);
var
  I: Integer;
begin
  ...
  FBaseResolutionLevel := TdxJPXBaseResolutionLevel.Create(Self, 0,
    ACodingStyle);
  FResolutionLevels := TObjectList<TdxJPXCompositeResolutionLevel>.Create;
  for I := 0 to ACodingStyle.DecompositionLevelCount - 1 do
    FResolutionLevels.Add(TdxJPXCompositeResolutionLevel.Create(Self, I,
      ACodingStyle));
end;
...
begin
  ABaseResolutionLevelCoefficients :=
    FBaseResolutionLevel.LLSubBand.Coefficients;
  if FCodingStyle.UseWaveletTransformation then
    ATransform := TdxJPXDiscreteWaveletTransformation
      (TdxJPXReversibleDiscreteWaveletTransformation.Create
      (ABaseResolutionLevelCoefficients))
  else
    ATransform := TdxJPXIrreversibleDiscreteWaveletTransformation.Create
      (ABaseResolutionLevelCoefficients);
  try
    for AResolutionLevel in FResolutionLevels do
      ATransform.Append(AResolutionLevel.HLSubBand.Coefficients,
        AResolutionLevel.LHSubBand.Coefficients,
...
function TdxJPXTileComponent.GetResolutionLevel(Index: Integer)
  : TdxJPXResolutionLevel;
begin
  if Index = 0 then
...
procedure TdxJPXTileComponent.SetQuantizationParameters
  (const AValue: TdxJPXQuantizationComponentParameters);
begin
...
constructor TdxJPXResolutionLevel.Create(AComponent: TdxJPXTileComponent;
  ALevelIndex: Integer; const ACodingStyle: TdxJPXCodingStyleComponent);
var
  AExp: Int64;
...
begin
  ...
  FCodeBlockWidth := 1 shl Min(ACodingStyle.CodeBlockWidthExponent,
    APrecinctSize.WidthExponent - APrecinctSizeCorrection);
  FCodeBlockHeight := 1 shl Min(ACodingStyle.CodeBlockHeightExponent,
    APrecinctSize.HeightExponent - APrecinctSizeCorrection);
  FPrecinctWideCount := Ceil(X1 / FPrecinctWidth) - Floor(X0 / FPrecinctWidth);
  FPrecinctHighCount := Ceil(Y1 / FPrecinctHeight) -
    Floor(Y0 / FPrecinctHeight);
...
begin
  ...
  for I := 0 to FPrecinctHighCount - 1 do
    ...
    begin
      APrecinct := TdxJPXPrecinct.Create(ASubBand, CodeBlockWidth,
        CodeBlockHeight, J, I, FPrecinctWidth, FPrecinctHeight,
        APrecinctNumber);
      Inc(APrecinctNumber);
      for ACodeBlock in ASubBand.CodeBlocks do
        if (ACodeBlock.X0 >= APrecinct.X0) and (ACodeBlock.X1 <= APrecinct.X1)
          and (ACodeBlock.Y0 >= APrecinct.Y0) and (ACodeBlock.Y1 <= APrecinct.Y1)
        then
...
constructor TdxJPXBaseResolutionLevel.Create(AComponent: TdxJPXTileComponent;
  ALevel: Integer; const ACodingStyle: TdxJPXCodingStyleComponent);
begin
  inherited Create(AComponent, ALevel, ACodingStyle);
  FLLSubBand := TdxJPXLLSubBand.Create(AComponent,
    ACodingStyle.DecompositionLevelCount - LevelIndex, CodeBlockWidth,
    CodeBlockHeight);
...
constructor TdxJPXCompositeResolutionLevel.Create
  (AComponent: TdxJPXTileComponent; ALevel: Integer;
  const ACodingStyle: TdxJPXCodingStyleComponent);
var
  ALevelIndex: Integer;
begin
  ...
  FLHSubBand := TdxJPXLHSubBand.Create(AComponent, ALevelIndex, CodeBlockWidth,
    CodeBlockHeight);
  FHLSubBand := TdxJPXHLSubBand.Create(AComponent, ALevelIndex, CodeBlockWidth,
    CodeBlockHeight);
  FHHSubBand := TdxJPXHHSubBand.Create(AComponent, ALevelIndex, CodeBlockWidth,
    CodeBlockHeight);
...
constructor TdxJPXTileComponentDataConstructor.Create(ATileComponents
  : TObjectList<TdxJPXTileComponent>);
begin
  inherited Create;
...
class function TdxJPXTileComponentDataConstructor.BuildData(ATileComponents
  : TObjectList<TdxJPXTileComponent>): TdxJPXTileComponentDataArray;
var
...
procedure TdxJPXTileComponentDataConstructor.AddTileComponentData
  (AComponentIndex: Integer);
var
  AComponent: TdxJPXTileComponent;
begin
  AComponent := FTileComponents[AComponentIndex];
  FData[AComponentIndex].Initialize(AComponent.Transform,
    AComponent.BitsPerComponent);
end;

function TdxJPXTileComponentDataConstructor.CreateData
  : TdxJPXTileComponentDataArray;
begin
  TdxPDFTask.ForEach(0, FTileComponents.Count, procedure(AIndex: Integer)
    begin
...
constructor TdxJPXDiscreteWaveletTransformation.Create
  (const ALLSubBandCoefficients: TdxJPXSubBandCoefficients);
begin
  Create;
  FSubBandCoefficients := ALLSubBandCoefficients;
end;

class procedure TdxJPXDiscreteWaveletTransformation.Extend
  (const ABuffer: TSingleDynArray; ASize: Integer);
var
...
procedure TdxJPXDiscreteWaveletTransformation.Filter(const Y: TSingleDynArray;
I0, I1: Integer);
begin
  // do nothing
end;

procedure TdxJPXDiscreteWaveletTransformation.Append(const AHlCoefficients,
  ALhCoefficients, AHhCoefficients: TdxJPXSubBandCoefficients);
begin
  FSubBandCoefficients := FSubBandCoefficients.Interleave(AHlCoefficients,
    ALhCoefficients, AHhCoefficients);
...
begin
  ...
  begin
    ...
    begin
      cxCopyData(@FSubBandCoefficients.Coefficients[0], @Y[0], AIndex, AOffset,
        ARowSize);
      Extend(Y, FSubBandCoefficients.Width);
      Filter(Y, FExtendSampleCount, I1);
      cxCopyData(@Y[0], @FSubBandCoefficients.Coefficients[0], AOffset, AIndex,
        ARowSize);
      Inc(AIndex, ARowSize);
    end;
  end;
...
procedure TdxJPXDiscreteWaveletTransformation.VerticalReconstruction;
  ...
  procedure InitializeColumnBuffers(AColumnBuffers: TList<TSingleDynArray>;
  ACount: Integer);
  var
    I: Integer;
...
var
  AFirstTileExtendIndex, I1, AWidth, ACurrentBufferIndex, ABufferCount, U, K, L,
    B: Integer;
...
procedure TdxJPXDiscreteWaveletTransformation.DoExtend(const ABuffer
  : TSingleDynArray; ASize: Integer);
var
  I1, J1, I2, J2: Integer;
begin
...
procedure TdxJPXIrreversibleDiscreteWaveletTransformation.Filter
  (const Y: TSingleDynArray; I0, I1: Integer);
const
...
procedure TdxJPXReversibleDiscreteWaveletTransformation.Filter
  (const Y: TSingleDynArray; I0, I1: Integer);
const
  FastFloorConst = 255;
var
...
begin
  ...
  for J := I to ALength - 1 do
  begin
    Y[I] := Y[I] - (Trunc((Y[I - 1] + Y[I + 1] + 2) / 4 + FastFloorConst) -
      FastFloorConst);
    Inc(I, 2);
    if I >= ALength then
      Break;
  ...
  for J := I to ALength - 1 do
  begin
    Y[I] := Y[I] + (Trunc((Y[I - 1] + Y[I + 1]) / 2 + FastFloorConst) -
      FastFloorConst);
    Inc(I, 2);
    if I >= ALength then
      Break;
...
begin
  ...
  for I := 0 to Length(AComponentsData) - 1 do
    FComponentsData[I].Initialize(AComponentsData[I].Data,
      AComponentsData[I].BitsPerComponent);
...
class function TdxJPXColorTransformation.Parse(ATile: TdxJPXTile)
  : TdxJPXColorTransformation;
var
...
begin
  ...
  case Length(AData) of
    ...
    1:
      Result := TdxJPXGrayColorTransformation.Create(ATile.Width,
        ATile.Height, AData);
  else
    if ATile.MultipleTransformation then
    begin
      if ATile.UseWaveletTransformation then
        Result := TdxJPXReversibleColorTransformation.Create(ATile.Width,
          ATile.Height, AData)
      else
        Result := TdxJPXIrreversibleColorTransformation.Create(ATile.Width,
          ATile.Height, AData);
    end
    else
      Result := TdxJPXMultipleComponentTransformation.Create(ATile.Width,
        ATile.Height, AData);
  end;
end;

procedure TdxJPXColorTransformation.Transform(var AResult: TBytes;
AStartOffset, ARowWidth: Integer);
var
...
procedure TdxJPXColorTransformation.TransformLine(var AResult: TBytes;
AStartOffset, V: Integer);
var
...
procedure TdxJPXGrayColorTransformation.TransformColor(V, H: Integer;
const ADestination: TBytes; ADestinationOffset: Integer);
begin
  ADestination[ADestinationOffset] :=
    Normalize(ComponentsData[0].Data[V * Width + H] + Shift[0]);
end;

{ TdxJPXMultipleComponentTransformation }

constructor TdxJPXMultipleComponentTransformation.Create(AWidth,
  AHeight: Integer; const AComponentData: TdxJPXTileComponentDataArray);
begin
...
procedure TdxJPXMultipleComponentTransformation.TransformColor(V, H: Integer;
const ADestination: TBytes; ADestinationOffset: Integer);
var
  I, AIndex, AOffset: Integer;
begin
  AIndex := V * Width + H;
  Transform(ADestination, FFirstComponentsData[AIndex],
    FSecondComponentData[AIndex], FThirdComponentData[AIndex],
    ADestinationOffset);
  AOffset := ADestinationOffset + 3;
  for I := 3 to Length(ComponentsData) - 1 do
  begin
    ADestination[AOffset] := Normalize(ComponentsData[I].Data[AIndex] +
      Shift[I]);
    Inc(AOffset);
  end;
end;

procedure TdxJPXMultipleComponentTransformation.Transform(const AData: TBytes;
Y0, Y1, Y2: Single; ADestinationOffset: Integer);
var
...
procedure TdxJPXReversibleColorTransformation.Transform(const AData: TBytes;
Y0, Y1, Y2: Single; ADestinationOffset: Integer);
var
  I1, I0, I2: Single;
begin
...
procedure TdxJPXIrreversibleColorTransformation.Transform(const AData: TBytes;
Y0, Y1, Y2: Single; ADestinationOffset: Integer);
var
  I0, I1, I2: Single;
begin
