...
{$ENDIF}
  ...
  dxGDIPlusClasses, cxImage, dxPDFDocumentViewer, dxPDFBase, dxPDFText, dxPDFRecognizedObject, dxPDFCore, Dialogs;
...
uses
  Windows, SysUtils, Types, Forms, Math, IOUtils, dxCore, dxCoreGraphics, AboutDemoForm, dxPDFCommandInterpreter,
  SkinDemoUtils, cxGeometry, dxPDFUtils, uSaveDialog;
...
begin
  ...
  if ADone then
  begin
    ACanvas.Font.Size := Trunc(dxPDFViewer1.Font.Size * AFontSizeFactor * dxPDFViewer1.OptionsZoom.ZoomFactor / 100);
