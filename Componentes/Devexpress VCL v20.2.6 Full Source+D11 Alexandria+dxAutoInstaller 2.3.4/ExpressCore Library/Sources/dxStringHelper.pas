...
type
  ...
  private const
    ByteToHexMap: array [Byte] of string = ('00', '01', '02', '03', '04', '05',
  ...
  private
    ...
    class function CharInArray(const C: Char; const AChars: array of Char)
      : Boolean; static;
    class procedure SetSinglePrecision(var AValue: Extended); static;
  public
    class function Create(const AValue: array of Char;
      AStartIndex, ALength: Integer): string; overload; static;
    class function Create(const AValue: TCharArray;
      AStartIndex, ALength: Integer): string; overload; static;
    class function EndsWith(const AText, APattern: string): Boolean; overload;
      static; inline;
    class function EndsWith(const AText, APattern: string; AIgnoreCase: Boolean)
      : Boolean; overload; static;
    class function Contains(const AText, APattern: string): Boolean; static;
    class function IndexOf(const AText: string; APattern: Char;
      AOffset: Integer = 0): Integer; overload; static; inline;
    class function IndexOf(const AText, APattern: string; AOffset: Integer = 0)
      : Integer; overload; static; inline;
    class function IndexOfAny(const AText: string; const AChars: array of Char;
      AOffset: Integer = 0): Integer; static;
    class function Join(const ASeparator: string; const AValues: TArray<string>)
      : string; overload; static;
    class function Join(const Separator: string; const AValues: array of string;
      AStartIndex, ACount: Integer): string; overload; static;
    class function Remove(const AText: string; AStartIndex: Integer): string;
      overload; static;
    class function Remove(const AText: string; AStartIndex, ACount: Integer)
      : string; overload; static;
    class function RemoveEnclosedPart(const AText: string; ALeft, ARight: Char)
      : string; static;
    class function Replace(const AText: string; AOldChar: Char; ANewChar: Char)
      : string; overload; static; inline;
    class function Replace(const AText: string; const OldValue: string;
      const NewValue: string): string; overload; static; inline;
    class function Split(const AText: string;
      const ADelimiters: array of string): TArray<string>; overload; static;
    class function Split(const AText: string;
      const ADelimiters: array of string; AOptions: TStringSplitOptions)
      : TArray<string>; overload; static;
    class function StartsWithChar(const AText: string; APattern: Char;
      AIgnoreCase: Boolean = True): Boolean; overload; static; inline;
    class function StartsWith(const AText, APattern: string;
      AIgnoreCase: Boolean = True): Boolean; overload; static; inline;
    class function Substring(const AText: string; AStartIndex: Integer): string;
      overload; static;
    class function Substring(const AText: string; AStartIndex, ALength: Integer)
      : string; overload; static;
    class function LastIndexOf(const AText: string; AChar: Char): Integer;
      overload; static; inline;
    class function LastIndexOf(const AText, AValue: string): Integer; overload;
      static; inline;
    class function LastIndexOf(const AText, AValue: string;
      AStartIndex: Integer): Integer; overload; static;
    class function LastIndexOf(const AText, AValue: string;
      AStartIndex: Integer; ACount: Integer): Integer; overload; static; inline;
    class function LastIndexOfAny(const AText: string;
      const AAnyOf: array of Char): Integer; overload; static;
    class function LastIndexOfAny(const AText: string;
      const AAnyOf: array of Char; AStartIndex: Integer): Integer;
      overload; static;
    class function LastIndexOfAny(const AText: string;
      const AAnyOf: array of Char; AStartIndex, ACount: Integer): Integer;
      overload; static;
    class function Trim(const AText: string; const AChars: array of Char)
      : string; static;
    class function TrimEnd(const AText: string; const AChars: array of Char)
      : string; static;
    class function TrimStart(const AText: string; const AChars: array of Char)
      : string; static;
    ...
    class function ToHex(const ASource: TBytes; AOffset, ACount: Integer;
      var ADest: TCharArray): Integer; overload; static;
    class function ToInt32(const AText: string; AFromBase: Cardinal = 10)
      : Integer; static;
    class function ToInt32Def(const AText: string; ADefault: Integer;
      AFromBase: Cardinal = 10): Integer; static;
    ...
    class function Format(const AFormat: string; const Args: array of const)
      : string; overload; static;
    class function Format(const AFormatSettings: TFormatSettings;
      const AFormat: string; const Args: array of const): string;
      overload; static;
    class function PrepareFontNameForDoc(const AOriginalFontName: string)
      : string; static;
    class function RemoveSpecialSymbols(const AText: string): string; static;
    class function ReplaceParagraphMarksWithLineBreaks(const AText: string)
      : string; static;
    class function ContainsParagraphMarksOrUnitSeparators(const AText: string)
      : Boolean; static;
  end;
...
class function TdxStringHelper.Create(const AValue: array of Char;
  AStartIndex, ALength: Integer): string;
begin
  Result := System.Copy(AValue, AStartIndex + 1, ALength);
end;

class function TdxStringHelper.CharInArray(const C: Char;
  const AChars: array of Char): Boolean;
var
  P: PChar;
  ALen: Integer;
begin
...
class function TdxStringHelper.ContainsSpecialSymbols
...
begin
  ...
  begin
    if (P^ <= LastLowSpecial) or (P^ >= FirstHighSpecial) then
      if (P^ <> TdxCharacters.TabMark) and (P^ <> #$000A) and
        (P^ <> TdxCharacters.ParagraphMark) then
        Exit(True);
    Inc(P);
  end;
  Result := False;
...
class function TdxStringHelper.Create(const AValue: TCharArray;
  AStartIndex, ALength: Integer): string;
begin
...
class function TdxStringHelper.EndsWith(const AText, APattern: string;
...
begin
  ...
  if (ASubTextLocation > 0) and (APattern <> '') and
    (ByteType(AText, ASubTextLocation) <> mbTrailByte) then
    Result := CompareString(LOCALE_USER_DEFAULT, CompareOptions[AIgnoreCase],
      PChar(@AText[ASubTextLocation]), APatternLen, PChar(APattern),
      APatternLen) = 2
  else
    Result := False;
end;

class function TdxStringHelper.IndexOf(const AText: string; APattern: Char;
  AOffset: Integer = 0): Integer;
begin
  Result := PosEx(APattern, AText, AOffset + 1) - 1;
end;

class function TdxStringHelper.IndexOf(const AText, APattern: string;
  AOffset: Integer = 0): Integer;
begin
  Result := PosEx(APattern, AText, AOffset + 1) - 1;
end;

class function TdxStringHelper.IndexOfAny(const AText: string;
  const AChars: array of Char; AOffset: Integer = 0): Integer;
var
  P: PChar;
  ALength: Integer;
begin
...
class function TdxStringHelper.Join(const Separator: string;
  const AValues: array of string; AStartIndex, ACount: Integer): string;
var
  I: Integer;
  AMax: Integer;
...
class function TdxStringHelper.Join(const ASeparator: string;
  const AValues: TArray<string>): string;
begin
  Result := Join(ASeparator, AValues, 0, Length(AValues));
end;

class function TdxStringHelper.LastIndexOf(const AText, AValue: string)
  : Integer;
begin
...
class function TdxStringHelper.LastIndexOf(const AText: string;
  AChar: Char): Integer;
begin
...
class function TdxStringHelper.LastIndexOf(const AText, AValue: string;
  AStartIndex, ACount: Integer): Integer;
var
...
class function TdxStringHelper.LastIndexOfAny(const AText: string;
  const AAnyOf: array of Char): Integer;
begin
...
class function TdxStringHelper.Remove(const AText: string;
...
class function TdxStringHelper.Remove(const AText: string;
  AStartIndex, ACount: Integer): string;
begin
  Result := AText;
  Delete(Result, AStartIndex + 1, ACount);
end;

class function TdxStringHelper.RemoveEnclosedPart(const AText: string;
  ALeft, ARight: Char): string;
var
  AFirst, ALast: PChar;
begin
  Result := AText;
...
class function TdxStringHelper.RemoveSpecialSymbols
  ...
  try
    ...
    begin
      if (P^ > LastLowSpecial) and (P^ < FirstHighSpecial) then
        ASb.Append(P^)
      else if (P^ = TdxCharacters.TabMark) or (P^ = #$000A) or
        (P^ = TdxCharacters.ParagraphMark) then
        ASb.Append(P^);
      Inc(P);
    end;
...
class function TdxStringHelper.ReplaceParagraphMarksWithLineBreaks
  (const AText: string): string;
var
  ASb: TStringBuilder;
  ACount, I: Integer;
  ...
  try
    ...
    begin
      ...
      if (ACh <> #13) and (ACh <> #10) and (ACh <> #$1F) and (ACh <> #$1E) then
        ASb.Append(ACh)
      else if (ACh <> #$1F) and (ACh <> #$1E) then
      begin
...
class function TdxStringHelper.ContainsParagraphMarksOrUnitSeparators
  (const AText: string): Boolean;
var
  ACh: Char;
begin
...
class function TdxStringHelper.Replace(const AText, OldValue,
  NewValue: string): string;
begin
  Result := SysUtils.StringReplace(AText, OldValue, NewValue, [rfReplaceAll]);
end;

class function TdxStringHelper.Replace(const AText: string;
  AOldChar, ANewChar: Char): string;
var
  L: Integer;
  P: PChar;
begin
...
class function TdxStringHelper.Split(const AText: string;
  ...
  function IndexOfAny(const AText: string; AOffset: Integer;
    const AValues: array of string; var AIndex: Integer): Integer; overload;
  var
    C, P, I: Integer;
  begin
    P := MaxInt;
...
class function TdxStringHelper.StartsWithChar(const AText: string;
  APattern: Char; AIgnoreCase: Boolean = True): Boolean;
var
  ALength: Integer;
begin
  ALength := Length(AText);
...
class function TdxStringHelper.StartsWith(const AText, APattern: string;
  AIgnoreCase: Boolean = True): Boolean;
begin
  if APattern = '' then
    Result := False
  else if not AIgnoreCase then
...
class function TdxStringHelper.Substring(const AText: string;
  AStartIndex: Integer): string;
begin
...
class function TdxStringHelper.Split(const AText: string;
  const ADelimiters: array of string): TArray<string>;
begin
...
class function TdxStringHelper.ToInt32(const AText: string;
  AFromBase: Cardinal): Integer;
  ...
  begin
    ...
    begin
      ...
      if (ADigit >= 32) and (B <> 0) then
        raise Exception.Create
          ('Value was either too large or too small for a integer');
...
class function TdxStringHelper.ToInt32Def(const AText: string;
  ADefault: Integer; AFromBase: Cardinal): Integer;
...
class function TdxStringHelper.ToBinary(AValue: Cardinal;
  ADigits: Integer): string;
var
...
class function TdxStringHelper.Trim(const AText: string;
...
begin
  L := Length(AText);
  I := 1;
  if (L > 0) and not CharInArray(AText[I], AChars) and
    not CharInArray(AText[L], AChars) then
    Exit(AText);
...
class function TdxStringHelper.TrimEnd(const AText: string;
  const AChars: array of Char): string;
var
  I: Integer;
begin
...
class function TdxStringHelper.TrimStart(const AText: string;
  const AChars: array of Char): string;
var
  I, ALength: Integer;
begin
...
class function TdxStringHelper.ToHex(const ASource: TBytes;
  AOffset, ACount: Integer; var ADest: TCharArray): Integer;
var
  AHex: PCardinal;
  P: PByte;
begin
...
class function TdxStringHelper.Format(const AFormat: string;
...
class function TdxStringHelper.Format(const AFormatSettings: TFormatSettings;
  const AFormat: string; const Args: array of const): string;
var
  I: Integer;
begin
...
class function TdxStringHelper.PrepareFontNameForDoc(const AOriginalFontName
  : string): string;
var
  ATrimIndex: Integer;
begin
