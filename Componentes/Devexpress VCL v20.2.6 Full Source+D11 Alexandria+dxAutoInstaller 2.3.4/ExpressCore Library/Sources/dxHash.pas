...
type
  ...
  public
    ...
    procedure Add(const P: Pointer; ASize: Integer); overload; virtual;
      abstract;
    ...
    class function Calculate(const A: TBytes; AIndex, ALength: Integer)
      : TBytes; overload;
    class function Calculate(const P: Pointer; ASize: Integer): TBytes;
      overload;
    class function Calculate(const S: TStream): TBytes; overload;
    class function Calculate(const S: string): TBytes; overload;

    class function ToBigEndian(AValue: Cardinal): Cardinal; overload;
      static; inline;
    class function ToBigEndian(AValue: UInt64): UInt64; overload;
      static; inline;
...
{$IFDEF MSWINDOWS}
  ...
  protected
    ...
    procedure Initialize(AHashAlgorithm: Integer;
      AProvider: IdxCryptoProvider = nil); virtual;
  ...
  public
    constructor Create(AHashAlgorithm: Integer;
      AProvider: IdxCryptoProvider = nil); reintroduce;
  end;
  ...
  public
    constructor Create(AKey: TBytes; AHashAlgorithm: Integer;
      AProvider: IdxCryptoProvider = nil); reintroduce;
    destructor Destroy; override;
    procedure Reset; override;
  end;
...
function dxCRC32(AData: PByte; ACount: Integer; ACurrentCRC32: Cardinal)
  : Cardinal; overload;
function dxCRC32(AStream: TStream; const APosition: Int64; ACount: Int64)
  : Cardinal; overload;
...
function dxElfHash(const S: AnsiString; ALangID: Cardinal = CP_ACP)
  : Integer; overload;
function dxElfHash(const S: string; ALangID: Cardinal = CP_ACP)
  : Integer; overload;
function dxElfHash(P: PWideChar; ALength: Integer; ALangID: Cardinal = CP_ACP)
  : Integer; overload;
function dxElfHash(P: PWideChar; ALength: Integer; AUpperCaseBuffer: PWideChar;
  AUpperCaseBufferLength: Integer; ALangID: Cardinal = CP_ACP)
  : Integer; overload;
...
procedure dxMD5Calc(AInput: PByteArray; AInputLength: Integer;
  var ADigits: TdxMD5Byte16);
procedure dxMD5Final(var AContext: TdxMD5Context; var ADigits: TdxMD5Byte16);
procedure dxMD5Init(var AContext: TdxMD5Context);
procedure dxMD5Update(var AContext: TdxMD5Context; AInput: PByteArray;
  AInputLength: Integer); overload;
procedure dxMD5Update(var AContext: TdxMD5Context;
  const S: AnsiString); overload;

procedure dxMD4Calc(AInput: PByteArray; AInputLength: Integer;
  var ADigits: TdxMD4Byte16);
...
function dxAdler32(AInitialValue: Cardinal; ABuffer: Pointer; ASize: Integer)
  : Cardinal;
...
procedure dxMDHashFinal(var AContext: TdxMD5Context; var ADigits: TdxMD5Byte16;
  ATransformProc: TdxMDTransform);
var
...
begin
  ...
  for I := 0 to 3 do
  begin
    A := ROL(((B and C) or (D and (B or C))) + A + ABuf^[0 * 4 + I] +
      $5A827999, 3);
    D := ROL(((A and B) or (C and (A or B))) + D + ABuf^[1 * 4 + I] +
      $5A827999, 5);
    C := ROL(((D and A) or (B and (D or A))) + C + ABuf^[2 * 4 + I] +
      $5A827999, 9);
    B := ROL(((C and D) or (A and (C or D))) + B + ABuf^[3 * 4 + I] +
      $5A827999, 13);
  end;
...
procedure dxMD4Update(var AContext: TdxMD5Context; AInput: PByteArray;
  AInputLength: Integer);
begin
...
function dxElfHash(P: PWideChar; ALength: Integer;
  ALangID: Cardinal = CP_ACP): Integer;
var
...
begin
  ...
  begin
    ...
    begin
{$IFDEF MSWINDOWS}
      ALength := LCMapStringW(ALangID, LCMAP_UPPERCASE, P, ALength,
        AUpperCaseBuffer, AUpperCaseBufferLength);
      P := AUpperCaseBuffer;
{$ELSE}
...
class function TdxHashAlgorithm.Calculate(const P: Pointer;
  ASize: Integer): TBytes;
begin
  with Create do
    try
      Add(P, ASize);
...
class function TdxHashAlgorithm.Calculate(const A: TBytes;
  AIndex, ALength: Integer): TBytes;
begin
  if (AIndex < 0) or (AIndex >= ALength) then
    raise ERangeError.Create('AIndex');
  if (ALength < 0) or (AIndex + ALength > Length(A)) then
...
begin
  Result := UInt64(ToBigEndian(Cardinal(AValue))) shl 32 or
    ToBigEndian(Cardinal(AValue shr 32));
end;

class function TdxHashAlgorithm.ToBigEndian(AValue: Cardinal): Cardinal;
begin
  Result := (AValue shr 24) or (AValue shl 24) or ((AValue shr 8) and $FF00) or
    ((AValue shl 8) and $FF0000);
end;
...
begin
  ...
  CryptCheck(CryptDestroyHash(FHandle));
  CryptCheck(CryptCreateHash(FProvider.GetHandle, AHashAlgorithm, 0, 0,
    FHandle));
end;

procedure TdxCustomCryptoHashAlgorithm.Initialize(AHashAlgorithm: Integer;
...
constructor TdxCryptoHashAlgorithm.Create(AHashAlgorithm: Integer;
  AProvider: IdxCryptoProvider = nil);
begin
...
constructor TdxHMACHashAlgorithm.Create(AKey: TBytes; AHashAlgorithm: Integer;
  AProvider: IdxCryptoProvider = nil);
begin
...
begin
  ...
  CryptCheck(CryptCreateHash(Provider.Handle, CALG_HMAC, FKeyHandle, 0,
    FHandle));
...
begin
  ...
  PCardinal(@FBuffer[56])^ := TdxHashAlgorithm.ToBigEndian
    (Cardinal(FBitLength shr 32));
  PCardinal(@FBuffer[60])^ := TdxHashAlgorithm.ToBigEndian
    (Cardinal(FBitLength));
  ProcessBlock;
...
const
  K_256: array [0 .. 63] of Cardinal = ($428A2F98, $71374491, $B5C0FBCF,
    $E9B5DBA5, $3956C25B, $59F111F1, $923F82A4, $AB1C5ED5, $D807AA98, $12835B01,
    $243185BE, $550C7DC3, $72BE5D74, $80DEB1FE, $9BDC06A7, $C19BF174, $E49B69C1,
    $EFBE4786, $0FC19DC6, $240CA1CC, $2DE92C6F, $4A7484AA, $5CB0A9DC, $76F988DA,
    $983E5152, $A831C66D, $B00327C8, $BF597FC7, $C6E00BF3, $D5A79147, $06CA6351,
    $14292967, $27B70A85, $2E1B2138, $4D2C6DFC, $53380D13, $650A7354, $766A0ABB,
    $81C2C92E, $92722C85, $A2BFE8A1, $A81A664B, $C24B8B70, $C76C51A3, $D192E819,
    $D6990624, $F40E3585, $106AA070, $19A4C116, $1E376C08, $2748774C, $34B0BCB5,
    $391C0CB3, $4ED8AA4A, $5B9CCA4F, $682E6FF3, $748F82EE, $78A5636F, $84C87814,
...
begin
  ...
  PCardinal(@FBuffer[120])^ := TdxHashAlgorithm.ToBigEndian
    (Cardinal(FBitLength shr 32));
  PCardinal(@FBuffer[124])^ := TdxHashAlgorithm.ToBigEndian
    (Cardinal(FBitLength));
  ProcessBlock;
  FHash[0] := TdxHashAlgorithm.ToBigEndian(FHash[0]);
  FHash[1] := TdxHashAlgorithm.ToBigEndian(FHash[1]);
...
const
  K_512: array [0 .. 79] of UInt64 = ($428A2F98D728AE22, $7137449123EF65CD,
