...
{$ENDIF}
  ...
  dxCore, dxMessages, cxClasses, cxContainer, cxLookAndFeels, cxControls,
  cxGraphics,
  dxDockConsts, cxPC, cxLookAndFeelPainters, dxCoreClasses, dxForms, cxGeometry,
  dxCoreGraphics;
...
type
  ...
  TdxDockingOption = (doActivateAfterDocking, doDblClickDocking,
    doFloatingOnTop, doFreeOnClose, doUndockOnClose, doTabContainerHasCaption,
    doTabContainerCanClose, doTabContainerCanAutoHide,
    doSideContainerHasCaption, doSideContainerCanClose,
...
const
  ...
  dxDockingDefaultOptions = [doActivateAfterDocking, doDblClickDocking,
    doFloatingOnTop, doTabContainerCanAutoHide, doTabContainerHasCaption,
    doSideContainerCanClose, doSideContainerCanAutoHide,
...
type
  ...
  protected
    ...
    function CanConstrainedResize(NewWidth, NewHeight: Integer)
      : Boolean; virtual;
  public
    ...
    function GetDockingSelection(AControl: TdxCustomDockControl)
      : TRect; virtual;
    ...
    procedure PrepareSelectionRegion(ARegion: TcxRegion;
      AControl: TdxCustomDockControl; const ARect: TRect); virtual;

    class function ValidateDockZone(AOwner, AControl: TdxCustomDockControl)
      : Boolean; virtual;
    class function ValidateResizeZone(AOwner, AControl: TdxCustomDockControl)
      : Boolean; virtual;
  ...
  public
    function FindZone(AOwnerControl: TdxCustomDockControl;
      AType: TdxDockingType): TdxZone;
  ...
  private
    ...
    procedure WMNCLButtonDblClk(var Message: TWMNCMButtonDblClk);
  ...
  TdxActivateEvent = procedure(Sender: TdxCustomDockControl; Active: Boolean)
    of object;
  TdxCanDockingEvent = procedure(Sender, Source: TdxCustomDockControl;
    Zone: TdxZone; X, Y: Integer; var Accept: Boolean) of object;
  TdxCanResizeEvent = procedure(Sender: TdxCustomDockControl;
  ...
  TdxCustomDrawSelectionEvent = procedure(Sender: TdxCustomDockControl; DC: HDC;
    Zone: TdxZone; ARect: TRect; Erasing: Boolean; var Handled: Boolean)
    of object;
  ...
  TdxDockEvent = procedure(Sender, Site: TdxCustomDockControl;
    ADockType: TdxDockingType; AIndex: Integer) of object;
  ...
  TdxUpdateZonesEvent = procedure(Sender: TdxCustomDockControl; AZones: TList)
    of object;

  TdxMakeFloatingEvent = procedure(Sender: TdxCustomDockControl; X, Y: Integer)
    of object;
  TdxResizingEvent = procedure(Sender: TdxCustomDockControl; Zone: TdxZone;
    X, Y: Integer) of object;
  TdxStartDockingEvent = procedure(Sender: TdxCustomDockControl; X, Y: Integer)
    of object;
  TdxUnDockEvent = procedure(Sender, Site: TdxCustomDockControl) of object;

  TdxDockControlInternalState = (dcisCreating, dcisDestroying, dcisDestroyed,
    dcisInternalResizing, dcisFrameChanged, dcisLayoutLoading);
  ...
  protected
    ...
    property HotButton: TdxCustomDockControlButton read FHotButton
      write SetHotButton;
    property PressedButton: TdxCustomDockControlButton read FPressedButton
  ...
  public
    ...
    //
    property Buttons[Index: Integer]: TdxCustomDockControlButton
  ...
  public
    ...
    //
    property Items[Index: Integer]: TdxDockControlCaptionButton read GetItem
  ...
  public
    ...
    destructor Destroy; override;
  published
    property Buttons: TdxDockControlCaptionButtons read FButtons
      write SetButtons;
  ...
  public
    constructor Create(AController: TdxDockControlButtonsController;
      AButton: TdxDockControlCaptionButton);
    //
  ...
  TdxCustomDockControl = class(TcxCustomControl, IcxMouseTrackingCaller,
  ...
  private
    ...
    procedure SetCustomCaptionButtons
      (AValue: TdxDockControlCustomCaptionButtons);
    ...
    procedure WMCheckActiveDockControl(var Message: TMessage);
      message DXM_DOCK_CHECKACTIVEDOCKCONTROL;
  ...
  protected
    ...
    function GetDesignHitTest(const APoint: TPoint; AShift: TShiftState)
      : Boolean; dynamic;
    ...
    function GetDockingTargetControlAtPos(const pt: TPoint)
      : TdxCustomDockControl; virtual;
    ...
    procedure DoCanDocking(Source: TdxCustomDockControl; pt: TPoint;
      TargetZone: TdxZone; var Accept: Boolean);
    procedure DoDocking(pt: TPoint; TargetZone: TdxZone; var Accept: Boolean);
    procedure SetDockingParams(ADockingTargetZone: TdxZone;
      const ADockingPoint: TPoint);

    procedure DrawDockingSelection(AZone: TdxZone; const pt: TPoint;
      AErasing: Boolean);
    ...
    procedure UpdateControlDockZones(AControl: TdxCustomDockControl;
      AZoneWidth: Integer); virtual;
    ...
    procedure CreateLayout(AControl: TdxCustomDockControl;
    ...
    procedure IncludeToDock(AControl: TdxCustomDockControl;
      AType: TdxDockingType; Index: Integer); virtual;
    ...
    procedure LoadLayoutFromCustomIni(AIniFile: TCustomIniFile;
      AParentForm: TCustomForm; AParentControl: TdxCustomDockControl;
      ASection: string); virtual;
    procedure LoadLayoutProcessChildren(AIniFile: TCustomIniFile;
      AParentForm: TCustomForm; const ASection: string);
    procedure LoadLayoutProcessSizes(AIniFile: TCustomIniFile;
      AParentForm: TCustomForm; const ASection: string); virtual;
    procedure SaveLayoutProcessChildren(AIniFile: TCustomIniFile;
      const ASection: string);
    procedure SaveLayoutProcessSizes(AIniFile: TCustomIniFile;
    ...
    // SideContainer site
    procedure AssignSideContainerSiteProperties
      (ASite: TdxSideContainerDockSite); virtual;
    function CanAcceptSideContainerItems(AContainer: TdxSideContainerDockSite)
      : Boolean; virtual;
    function CreateHorizontalContainerDockSite
      : TdxHorizContainerDockSite; virtual;
    ...
    // TabContainer site
    procedure AssignTabContainerSiteProperties
      (ASite: TdxTabContainerDockSite); virtual;
    function CanAcceptTabContainerItems(AContainer: TdxTabContainerDockSite)
      : Boolean; virtual;
    ...
    function GetControlAutoHidePosition(AControl: TdxCustomDockControl)
      : TdxAutoHidePosition; virtual;
    ...
    procedure UpdateControlOriginalSize
      (AControl: TdxCustomDockControl); virtual;
    ...
    procedure Changed; virtual;
    function CreateCustomCaptionButtons
      : TdxDockControlCustomCaptionButtons; virtual;
    ...
    property ButtonsController: TdxDockControlButtonsController
      read FButtonsController;
  ...
  public
    ...
    function CanDockHost(AControl: TdxCustomDockControl; AType: TdxDockingType)
      : Boolean; virtual;
    function CanMaximize: Boolean; virtual;
    function GetDockZoneAtPos(AControl: TdxCustomDockControl; APoint: TPoint)
      : TdxZone; virtual;
    ...
    procedure DockTo(AControl: TdxCustomDockControl; AType: TdxDockingType;
      AIndex: Integer);
    procedure UnDock;

    property Active: Boolean read GetActive;
    property AllowClosing: Boolean read FAllowClosing write SetAllowClosing
      default True;
    property AllowDock: TdxDockingTypes read FAllowDock write SetAllowDock
      default dxDockingDefaultDockingTypes;
    property AllowDockClients: TdxDockingTypes read FAllowDockClients
      write SetAllowDockClients default dxDockingDefaultDockingTypes;
    ...
    property AutoHideContainer: TdxDockSiteAutoHideContainer
    ...
    property Caption;
    property CaptionButtons: TdxCaptionButtons read FCaptionButtons
      write SetCaptionButtons default dxDockingDefaultCaptionButtons;
    property CustomCaptionButtons: TdxDockControlCustomCaptionButtons
      read FCustomCaptionButtons write SetCustomCaptionButtons;
    ...
    property TopMostDockControl: TdxCustomDockControl
      read GetTopMostDockControl;
    property UseDoubleBuffer: Boolean read FUseDoubleBuffer
      write SetUseDoubleBuffer;
    property ValidChildCount: Integer read GetValidChildCount;
    property ValidChildren[Index: Integer]: TdxCustomDockControl
      read GetValidChild;

    property OnActivate: TdxActivateEvent read FOnActivate write FOnActivate;
    property OnAutoHideChanged: TdxDockControlNotifyEvent
      read FOnAutoHideChanged write FOnAutoHideChanged;
    property OnAutoHideChanging: TdxDockControlNotifyEvent
      read FOnAutoHideChanging write FOnAutoHideChanging;
    property OnCanDocking: TdxCanDockingEvent read FOnCanDocking
      write FOnCanDocking;
    property OnCanResize: TdxCanResizeEvent read FOnCanResize
      write FOnCanResize;
    property OnClose: TdxDockControlNotifyEvent read FOnClose write FOnClose;
    property OnCloseQuery: TdxDockControlCloseQueryEvent read FOnCloseQuery
      write FOnCloseQuery;
    property OnCreateFloatSite: TdxCreateFloatSiteEvent read FOnCreateFloatSite
      write FOnCreateFloatSite;
    property OnCreateLayoutSite: TdxCreateLayoutSiteEvent
      read FOnCreateLayoutSite write FOnCreateLayoutSite;
    property OnCreateSideContainer: TdxCreateSideContainerEvent
      read FOnCreateSideContainer write FOnCreateSideContainer;
    property OnCreateTabContainer: TdxCreateTabContainerEvent
      read FOnCreateTabContainer write FOnCreateTabContainer;
    property OnCustomDrawDockingSelection: TdxCustomDrawSelectionEvent
      read FOnCustomDrawDockingSelection write FOnCustomDrawDockingSelection;
    property OnCustomDrawResizingSelection: TdxCustomDrawSelectionEvent
      read FOnCustomDrawResizingSelection write FOnCustomDrawResizingSelection;
    ...
    property OnEndDocking: TdxEndDockingEvent read FOnEndDocking
      write FOnEndDocking;
    property OnEndResizing: TdxResizingEvent read FOnEndResizing
      write FOnEndResizing;
    property OnGetAutoHidePosition: TdxGetAutoHidePositionEvent
      read FOnGetAutoHidePosition write FOnGetAutoHidePosition;
    property OnLayoutChanged: TdxDockControlNotifyEvent read FOnLayoutChanged
      write FOnLayoutChanged;
    property OnMakeFloating: TdxMakeFloatingEvent read FOnMakeFloating
      write FOnMakeFloating;
    property OnResize;
    property OnResizing: TdxResizingEvent read FOnResizing write FOnResizing;
    property OnRestoreDockPosition: TdxDockPositionEvent
      read FOnRestoreDockPosition write FOnRestoreDockPosition;
    property OnStartDocking: TdxStartDockingEvent read FOnStartDocking
      write FOnStartDocking;
    property OnStartResizing: TdxResizingEvent read FOnStartResizing
      write FOnStartResizing;
  ...
  published
    ...
    property ManagerColor: Boolean read FManagerColor write SetManagerColor
      default True;
    property ManagerFont: Boolean read FManagerFont write SetManagerFont
      default True;
    ...
    property OnMouseUp;
    property OnParentChanged: TdxDockControlNotifyEvent read FOnParentChanged
      write FOnParentChanged;
    property OnParentChanging: TdxDockControlNotifyEvent read FOnParentChanging
      write FOnParentChanging;
    property OnVisibleChanged: TdxDockControlNotifyEvent read FOnVisibleChanged
      write FOnVisibleChanged;
    property OnVisibleChanging: TdxDockControlNotifyEvent
      read FOnVisibleChanging write FOnVisibleChanging;
  end;
  ...
  protected
    ...
    // Docking zones
    procedure UpdateControlDockZones(AControl: TdxCustomDockControl;
      AZoneWidth: Integer); override;
    // Site layout
    procedure CreateLayout(AControl: TdxCustomDockControl;
      AType: TdxDockingType; Index: Integer); override;
  ...
  public
    ...
    property SiblingDockControl: TdxCustomDockControl
      read GetSiblingDockControl;
  published
  ...
  TdxActiveChildChangeEvent = procedure(Sender: TdxContainerDockSite;
    Child: TdxCustomDockControl) of object;
  ...
  protected
    ...
    procedure LoadLayoutFromCustomIni(AIniFile: TCustomIniFile;
      AParentForm: TCustomForm; AParentControl: TdxCustomDockControl;
      ASection: string); override;
    procedure SaveLayoutToCustomIni(AIniFile: TCustomIniFile;
      ASection: string); override;
    // AutoHide
    function GetControlAutoHidePosition(AControl: TdxCustomDockControl)
      : TdxAutoHidePosition; override;
    // Control visibility
    ...
    procedure DoActiveChildChanged(APrevActiveChild
      : TdxCustomDockControl); virtual;
    ...
    function IsValidActiveChild(AControl: TdxCustomDockControl)
      : Boolean; virtual;
  ...
  public
    ...
    property ActiveChild: TdxCustomDockControl read FActiveChild
      write SetActiveChild;
  published
    property ActiveChildIndex: Integer read GetActiveChildIndex
      write SetActiveChildIndex;
    property AllowClosing;
    property AllowDock;
    property AllowFloating;

    property OnActiveChildChanged: TdxActiveChildChangeEvent
      read FOnActiveChildChanged write FOnActiveChildChanged;
  ...
  TdxDockingTabControlPropertiesDrawTabEvent = procedure(Sender: TObject;
    AProperties: TdxDockingTabControlProperties; ATab: TcxTab;
    var ADefaultDraw: Boolean) of object;
  TdxDockingTabControlPropertiesDrawTabExEvent = procedure(Sender: TObject;
    AProperties: TdxDockingTabControlProperties; ATab: TcxTab; AFont: TFont)
    of object;
  ...
  protected
    ...
    procedure DoUndock(const APoint: TPoint;
      ADockControl: TdxCustomDockControl); virtual;
  ...
  public
    ...
    //
    property DockControls[Index: Integer]: TdxCustomDockControl
      read GetDockControl;
    ...
    property VisibleDockControls[Index: Integer]: TdxCustomDockControl
      read GetVisibleDockControl;
  end;
  ...
  TdxTabContainerDockSiteTabControlController = class
  ...
  public
    ...
    //
    property ActiveChild: TdxCustomDockControl read GetActiveChild
      write SetActiveChild;
  ...
  TdxTabContainerDockSite = class(TdxContainerDockSite,
    IcxControlComponentState, IcxTabControl)
  strict private
    ...
    procedure SetTabsProperties
      (AValue: TdxTabContainerDockSiteTabControlProperties);

    procedure HandlerDrawTab(AProperties: TcxCustomTabControlProperties;
      ATab: TcxTab; var ADefaultDraw: Boolean);
    procedure HandlerDrawTabEx(AProperties: TcxCustomTabControlProperties;
      ATab: TcxTab; AFont: TFont);
  ...
  protected
    ...
    property TabControlViewInfo: TdxDockingTabControlViewInfo
      read FTabControlViewInfo;
    property TabsController: TdxTabContainerDockSiteTabControlController
      read FTabsController;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    ...
    procedure ActivateNextChild(AGoForward: Boolean;
      AGoOnCycle: Boolean = True);
  published
    property AutoHide;
    property AutoHideBarExpandAllTabs: Boolean read FAutoHideBarExpandAllTabs
      write SetAutoHideBarExpandAllTabs default False;
    property CaptionButtons;
    property CustomCaptionButtons;
    property Dockable;
    property ImageIndex;
    property ShowCaption;
    property TabsProperties: TdxTabContainerDockSiteTabControlProperties
      read FTabsProperties write SetTabsProperties;
    ...
    property OnCustomDrawTab: TdxDockingTabControlPropertiesDrawTabEvent
      read FOnCustomDrawTab write FOnCustomDrawTab;
    property OnCustomDrawTabEx: TdxDockingTabControlPropertiesDrawTabExEvent
      read FOnCustomDrawTabEx write FOnCustomDrawTabEx;
    property OnDock;
    property OnDocking;
  ...
  protected
    ...
    procedure DoActiveChildChanged(APrevActiveChild
      : TdxCustomDockControl); override;
    function CanChildResize(AControl: TdxCustomDockControl;
      ADeltaSize: Integer): Boolean;
    procedure DoChildResize(AControl: TdxCustomDockControl; ADeltaSize: Integer;
      AResizeNextControl: Boolean = True);
    ...
    procedure SetChildBounds(AControl: TdxCustomDockControl;
    ...
    procedure SetDimension(var AWidth, AHeight: Integer; AValue: Integer);
      virtual; abstract;
    procedure SetOriginalSize(Index: Integer; const Value: Integer);
      virtual; abstract;
    ...
    property OriginalSizes[Index: Integer]: Integer read GetOriginalSize
      write SetOriginalSize;
  ...
  protected
    // Resizing
    procedure UpdateControlResizeZones(AControl: TdxCustomDockControl);
      override;
    // SiteBounds
    procedure UpdateControlOriginalSize
      (AControl: TdxCustomDockControl); override;
    // Children layout
    ...
    procedure SetDimension(var AWidth, AHeight: Integer;
  ...
  strict private
    procedure CMControlListChange(var Message: TMessage);
  ...
  public
    ...
    //
    property Items[Index: Integer]: TdxDockSiteHideBarButtonSection
  ...
  public
    constructor Create(ADockControl: TdxCustomDockControl); virtual;
    destructor Destroy; override;
    procedure AddSection(const ABounds: TRect;
      ADockControl: TdxCustomDockControl; AExpanded: Boolean = True);
    procedure ClearSections;
    function HitTest(const P: TPoint;
      out ADockControl: TdxCustomDockControl): Boolean;
  ...
  public
    ...
    procedure Scroll(dX, dY: Integer);
    //
    property Items[Index: Integer]: TdxDockSiteHideBarButton
  ...
  protected
    ...
    procedure CalculateButton(var R: TRect;
      AButton: TdxDockSiteHideBarButton); virtual;
    procedure CalculateButtonsPosition(ASections
      : TdxDockSiteHideBarButtonSectionList); virtual; abstract;
    function CalculateButtonSectionMaxTopIndex
      (ASections: TdxDockSiteHideBarButtonSectionList): Integer;
      virtual; abstract;
    procedure CalculateMultiSectionButton(var R: TRect;
      AButton: TdxDockSiteHideBarButton); virtual; abstract;
    procedure CalculateSingleSectionButton(var R: TRect;
      AButton: TdxDockSiteHideBarButton); virtual; abstract;
    procedure CalculateScrollButtons(const AButtonsFullRect: TRect);
      virtual; abstract;

    function CheckHidingFinish: Boolean; virtual; abstract;
    function CheckShowingFinish: Boolean; virtual; abstract;
    function CreateScrollButton(ADirection: Integer)
      : TdxDockSiteHideBarScrollButton;
    function GetButtonSectionSize(ADockControl: TdxCustomDockControl;
      AExpanded: Boolean = True): Integer; virtual;
    ...
    procedure UpdateOwnerAutoSizeBounds(AControl: TdxCustomDockControl);
      virtual; abstract;

    function GetControlAtPos(const P: TPoint;
      var ASubControl: TdxCustomDockControl): TdxCustomDockControl; virtual;
    ...
    property ButtonSectionTopIndex: Integer read FButtonSectionTopIndex
      write SetButtonSectionTopIndex;
    ...
    property Painter: TdxDockControlPainter read GetPainter;
    property ScrollDownButton: TdxDockSiteHideBarScrollButton
      read FScrollDownButton;
    property ScrollUpButton: TdxDockSiteHideBarScrollButton
      read FScrollUpButton;
  public
  ...
  protected
    ...
    function CalculateButtonSectionMaxTopIndex
      (ASections: TdxDockSiteHideBarButtonSectionList): Integer; override;
    procedure CalculateButtonsPosition(ASections
      : TdxDockSiteHideBarButtonSectionList); override;
    procedure CalculateMultiSectionButton(var R: TRect;
      AButton: TdxDockSiteHideBarButton); override;
    procedure CalculateSingleSectionButton(var R: TRect;
      AButton: TdxDockSiteHideBarButton); override;
    ...
    procedure UpdateOwnerAutoSizeBounds
      (AControl: TdxCustomDockControl); override;
  end;
  ...
  TdxAutoHideControlEvent = procedure(Sender: TdxDockSite;
    AControl: TdxCustomDockControl) of object;
  ...
  protected
    ...
    function GetControlAutoHidePosition(AControl: TdxCustomDockControl)
      : TdxAutoHidePosition; override;
    procedure RegisterAutoHideDockControl(AControl: TdxCustomDockControl;
    ...
    // HideBars
    function GetControlAtPos(pt: TPoint; var SubControl: TdxCustomDockControl)
      : TdxCustomDockControl;
    function GetHideBarAtPos(pt: TPoint): TdxDockSiteHideBar;
    function GetHideBarByControl(AControl: TdxCustomDockControl)
      : TdxDockSiteHideBar;
    function GetHideBarByPosition(APosition: TdxAutoHidePosition)
      : TdxDockSiteHideBar;
    ...
    property MovingContainer: TdxDockSiteAutoHideContainer
      read GetMovingContainer;
    property MovingControl: TdxCustomDockControl read FMovingControl;
    property MovingControlHideBar: TdxDockSiteHideBar
      read FMovingControlHideBar;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    ...
    function CanDockHost(AControl: TdxCustomDockControl; AType: TdxDockingType)
      : Boolean; override;
    function GetPositionByControl(AControl: TdxCustomDockControl)
      : TdxAutoHidePosition;
    function HasAutoHideControls: Boolean;

    property AutoSizeClientControl: TdxCustomDockControl
      read GetAutoSizeClientControl;
    property ShowingControl: TdxCustomDockControl read FShowingControl
      write SetShowingControl;
    property WorkingControl: TdxCustomDockControl read FWorkingControl
      write SetWorkingControl;
  published
    property Align;
    property Anchors;
    ...
    property OnCreateLayoutSite;
    property OnHideControl: TdxAutoHideControlEvent read FOnHideControl
      write FOnHideControl;
    property OnShowControl: TdxAutoHideControlEvent read FOnShowControl
      write FOnShowControl;
  end;

  TdxSetFloatFormCaptionEvent = procedure(Sender: TdxCustomDockControl;
    AFloatForm: TdxFloatForm) of object;
  ...
  published
    ...
    property FloatWidth: Integer read GetFloatWidth write SetFloatWidth
      stored False;
    property FloatHeight: Integer read GetFloatHeight write SetFloatHeight
      stored False;
    //
    property OnSetFloatFormCaption: TdxSetFloatFormCaptionEvent
      read FOnSetFloatFormCaption write FOnSetFloatFormCaption;
  end;

  TdxEdgePosition = (epLeft, epTop, epRight, epBottom, epTopLeft,
    epBottomRight, epRect);
  TdxEdgePositions = set of TdxEdgePosition;
  TdxEdgesType = (etStandard, etFlat, etRaisedInner, etRaisedOuter,
    etSunkenInner, etSunkenOuter);
  ...
  protected
    ...
    class procedure DrawColorEdge(ACanvas: TcxCanvas; ARect: TRect;
      AColor: TColor; AEdgesType: TdxEdgesType;
      AEdgePositions: TdxEdgePositions);
    ...
    function GetCaptionRect(const ARect: TRect; AIsVertical: Boolean)
      : TRect; virtual;
    function GetCaptionSignColor(IsActive: Boolean; AState: TcxButtonState)
      : TColor; virtual;
  ...
  public
    constructor Create(ADockControl: TdxCustomDockControl); virtual;
    class function GetTabsPainter(ATabsStyle: TcxPCStyleID)
      : TcxPCPainterClass; virtual;
    class function HasLookAndFeelStyle(AStyle: TcxLookAndFeelStyle)
      : Boolean; virtual;
    // CustomDockControl
    ...
    function GetCaptionColorPalette(AState: TcxButtonState = cxbsNormal)
    ...
    procedure DrawCaption(ACanvas: TcxCanvas; ARect: TRect;
      IsActive: Boolean); virtual;
    procedure DrawCaptionSeparator(ACanvas: TcxCanvas; ARect: TRect); virtual;
    procedure DrawCaptionText(ACanvas: TcxCanvas; ARect: TRect;
      IsActive: Boolean); virtual;
    procedure DrawCaptionButton(ACanvas: TcxCanvas; ARect: TRect;
    ...
    procedure DrawHideBar(ACanvas: TcxCanvas; ARect: TRect;
      APosition: TdxAutoHidePosition); virtual;
    procedure DrawHideBarButton(ACanvas: TcxCanvas;
      AButton: TdxDockSiteHideBarButton;
      APosition: TdxAutoHidePosition); virtual;
    procedure DrawHideBarButtonBackground(ACanvas: TcxCanvas;
      AButton: TdxDockSiteHideBarButton;
      APosition: TdxAutoHidePosition); virtual;
    procedure DrawHideBarButtonSection(ACanvas: TcxCanvas;
      AButtonSection: TdxDockSiteHideBarButtonSection;
      APosition: TdxAutoHidePosition); virtual;
    ...
    procedure DrawHideBarButtonSectionSeparator(ACanvas: TcxCanvas;
      AButtonSection: TdxDockSiteHideBarButtonSection;
      APosition: TdxAutoHidePosition); virtual;
    procedure DrawHideBarButtonImage(ACanvas: TcxCanvas;
      AControl: TdxCustomDockControl; ARect: TRect); virtual;
    procedure DrawHideBarButtonText(ACanvas: TcxCanvas;
  ...
  private
    ...
    function IsColorStored: Boolean;
    function IsFontStored: Boolean;
    procedure SetCustomCaptionButtons(const Value
      : TdxDockControlCustomCaptionButtons);
  ...
  public
    ...
    property AllowClosing: Boolean read FAllowClosing write FAllowClosing
      default True;
    property AllowDock: TdxDockingTypes read FAllowDock write FAllowDock
      default dxDockingDefaultDockingTypes;
    property AllowDockClients: TdxDockingTypes read FAllowDockClients
      write FAllowDockClients default dxDockingDefaultDockingTypes;
    property AllowFloating: Boolean read FAllowFloating write FAllowFloating
      default True;
    property Caption: string read FCaption write FCaption;
    property CaptionButtons: TdxCaptionButtons read FCaptionButtons
      write FCaptionButtons default dxDockingDefaultCaptionButtons;
    property CustomCaptionButtons: TdxDockControlCustomCaptionButtons
      read FCustomCaptionButtons write SetCustomCaptionButtons;
  ...
  published
    ...
    property AllowFloating;
    property AutoHideBarExpandAllTabs: Boolean read FAutoHideBarExpandAllTabs
      write FAutoHideBarExpandAllTabs default False;
    property CaptionButtons;
    property CustomCaptionButtons;
    property Dockable;
    property ImageIndex;
    property ShowCaption;
    property TabsProperties: TdxDockingTabControlProperties read FTabsProperties
      write SetTabsProperties;
  end;
  ...
  public
    procedure DockingStart(AControl: TdxCustomDockControl;
      const APoint: TPoint); virtual;
    procedure DockingMove(AControl: TdxCustomDockControl;
      const APoint: TPoint); virtual;
    procedure DockingFinish(AControl: TdxCustomDockControl;
      const APoint: TPoint); virtual;
    //
  ...
  private
    ...
    function ControlNeedUpdate(AControl: TdxCustomDockControl;
  ...
  protected
    ...
    procedure WndProc(var Message: TMessage); override;
    // Floating forms
    function IsParentForFloatDockSite(AParentForm: TCustomForm;
      AFloatDockSite: TdxFloatDockSite): Boolean;
    procedure BringToFrontFloatForms(AParentForm: TCustomForm;
      ATopMost: Boolean);
    procedure UpdateEnableStatusFloatForms(AParentForm: TCustomForm;
      AEnable: Boolean);
    procedure UpdateVisibilityFloatForms(AParentForm: TCustomForm;
      AShow: Boolean);
    procedure ValidateFloatFormsDesigners(AParentForm: TCustomForm);
    // Docking
    function CreateDockingControllerHelper(ADockStyle: TdxDockStyle)
      : TdxDockingControllerHelper;
    procedure StartDocking(AControl: TdxCustomDockControl;
      const APoint: TPoint);
    ...
    function FindManager(AForm: TCustomForm; out AManager: TdxDockingManager)
      : Boolean; overload;
    ...
    procedure DoActiveDockControlChanged(ASender: TdxCustomDockControl;
      ACallEvent: Boolean);
    procedure DoCreateFloatSite(ASender: TdxCustomDockControl;
      ASite: TdxFloatDockSite);
    procedure DoCreateLayoutSite(ASender: TdxCustomDockControl;
      ASite: TdxLayoutDockSite);
    procedure DoCreateMissingDockControl(ASender: TdxCustomDockControl);
    procedure DoCreateSideContainerSite(ASender: TdxCustomDockControl;
      ASite: TdxSideContainerDockSite);
    procedure DoCreateTabContainerSite(ASender: TdxCustomDockControl;
    ...
    procedure DoSetFloatFormCaption(ASender: TdxCustomDockControl;
    ...
    procedure LoadLayoutFromCustomIni(AIniFile: TCustomIniFile;
      AForm: TCustomForm);
    procedure LoadControlFromCustomIni(AIniFile: TCustomIniFile;
      AParentForm: TCustomForm; AParentControl: TdxCustomDockControl;
      ASection: string);
    procedure SaveLayoutToCustomIni(AIniFile: TCustomIniFile;
      AForm: TCustomForm);
    procedure SaveControlToCustomIni(AIniFile: TCustomIniFile;
    ...
    procedure DrawResizingSelection(ADockControl: TdxCustomDockControl;
      AZone: TdxZone; const APoint: TPoint; AStyle: TdxDockingResizeStyle;
      AErasing: Boolean);
    ...
    property ApplicationActive: Boolean read FApplicationActive
      write SetApplicationActive;
    property DockingControllerHelper: TdxDockingControllerHelper
      read FDockingControllerHelper;
  ...
  public
    ...
    function GetDockControlForWindow(AWnd: HWND; ADockWindow: HWND = 0)
      : TdxCustomDockControl;
    function GetFloatDockSiteAtPos(const pt: TPoint): TdxCustomDockControl;
    function GetNearestDockSiteAtPos(const pt: TPoint;
      ADockControl: TdxCustomDockControl = nil): TdxCustomDockControl;
    function IsDockControlFocusedEx(ADockControl: TdxCustomDockControl)
      : Boolean;
    // Default sites properties
    function DefaultLayoutSiteProperties(AForm: TCustomForm)
      : TdxLayoutDockSiteProperties;
    function DefaultFloatSiteProperties(AForm: TCustomForm)
      : TdxFloatDockSiteProperties;
    function DefaultHorizContainerSiteProperties(AForm: TCustomForm)
      : TdxSideContainerDockSiteProperties;
    function DefaultVertContainerSiteProperties(AForm: TCustomForm)
      : TdxSideContainerDockSiteProperties;
    function DefaultTabContainerSiteProperties(AForm: TCustomForm)
      : TdxTabContainerDockSiteProperties;
    ...
    property ActiveDockControl: TdxCustomDockControl read FActiveDockControl
      write SetActiveDockControl;
    property DockControlCount: Integer read GetDockControlCount;
    property DockControls[Index: Integer]: TdxCustomDockControl
      read GetDockControl;
    property DockManagerCount: Integer read GetDockManagerCount;
    property DockManagers[Index: Integer]: TdxDockingManager
      read GetDockManager;
    ...
    property ResizingDockControl: TdxCustomDockControl
      read FResizingDockControl;
    property SelectionBrush: TBrush read FSelectionBrush
      write SetSelectionBrush;
  end;

  { TdxDockingManager }

  TdxDockingManager = class(TcxScalableComponent, IdxSkinSupport,
  ...
  private
    ...
    function GetDefaultSiteProperties(Index: Integer)
      : TdxCustomDockControlProperties;
    ...
    function GetDefaultHorizContainerSiteProperties
      : TdxSideContainerDockSiteProperties;
    function GetDefaultVertContainerSiteProperties
      : TdxSideContainerDockSiteProperties;
    function GetDefaultTabContainerSiteProperties
      : TdxTabContainerDockSiteProperties;
    function GetParentForm: TCustomForm;
    procedure SetColor(const Value: TColor);
    procedure SetDefaultFloatSiteProperties(Value: TdxFloatDockSiteProperties);
    procedure SetDefaultHorizContainerSiteProperties
      (Value: TdxSideContainerDockSiteProperties);
    procedure SetDefaultLayoutSiteProperties
      (Value: TdxLayoutDockSiteProperties);
    procedure SetDefaultTabContainerSiteProperties
      (Value: TdxTabContainerDockSiteProperties);
    procedure SetDefaultVertContainerSiteProperties
      (Value: TdxSideContainerDockSiteProperties);
    ...
    procedure DoOnLFChanged(Sender: TcxLookAndFeel;
      AChangedValues: TcxLookAndFeelValues);
  ...
  public
    ...
    property DefaultSitesProperties[Index: Integer]
      : TdxCustomDockControlProperties read GetDefaultSiteProperties;
    property DefaultSitesPropertiesCount: Integer
      read GetDefaultSitesPropertiesCount;
    property PainterClass: TdxDockControlPainterClass read GetPainterClass;
    property ParentForm: TCustomForm read GetParentForm;
  published
    property Scalable;

    property AutoHideInterval: Integer read FAutoHideInterval
      write FAutoHideInterval default dxAutoHideInterval;
    property AutoHideMovingInterval: Integer read FAutoHideMovingInterval
      write FAutoHideMovingInterval default dxAutoHideMovingInterval;
    property AutoHideMovingSize: Integer read FAutoHideMovingSize
      write FAutoHideMovingSize default dxAutoHideMovingSize;
    property AutoShowInterval: Integer read FAutoShowInterval
      write FAutoShowInterval default dxAutoShowInterval;
    property Color: TColor read FColor write SetColor;
    property DefaultLayoutSiteProperties: TdxLayoutDockSiteProperties
      read GetDefaultLayoutSiteProperties write SetDefaultLayoutSiteProperties
      stored IsDefaultSitePropertiesStored;
    property DefaultFloatSiteProperties: TdxFloatDockSiteProperties
      read GetDefaultFloatSiteProperties write SetDefaultFloatSiteProperties
      stored IsDefaultSitePropertiesStored;
    property DefaultHorizContainerSiteProperties
      : TdxSideContainerDockSiteProperties
      read GetDefaultHorizContainerSiteProperties
      write SetDefaultHorizContainerSiteProperties
      stored IsDefaultSitePropertiesStored;
    property DefaultVertContainerSiteProperties
      : TdxSideContainerDockSiteProperties
      read GetDefaultVertContainerSiteProperties
      write SetDefaultVertContainerSiteProperties
      stored IsDefaultSitePropertiesStored;
    property DefaultTabContainerSiteProperties
      : TdxTabContainerDockSiteProperties
      read GetDefaultTabContainerSiteProperties
      write SetDefaultTabContainerSiteProperties
      stored IsDefaultSitePropertiesStored;
    property DockStyle: TdxDockStyle read FDockStyle write SetDockStyle
      default dxDefaultDockStyle;
    property DockZonesWidth: Integer read FDockZonesWidth
      write SetDockZonesWidth default dxDockZonesWidth;
    property Font: TFont read FFont write SetFont;
    property Images: TCustomImageList read FImages write SetImages;
    property LookAndFeel: TcxLookAndFeel read FLookAndFeel write SetLookAndFeel;
    property Options: TdxDockingOptions read FOptions write SetOptions
      default dxDockingDefaultOptions;
    property ResizeStyle: TdxDockingResizeStyle read FResizeStyle
      write FResizeStyle default dxDefaultDockingResizeStyle;
    property ResizeZonesWidth: Integer read FResizeZonesWidth
      write SetResizeZonesWidth default dxResizeZonesWidth;
    property SelectionFrameWidth: Integer read FSelectionFrameWidth
      write FSelectionFrameWidth default dxSelectionFrameWidth;
    property TabsScrollInterval: Integer read FTabsScrollInterval
      write FTabsScrollInterval default dxTabsScrollInterval;
    property UseDefaultSitesProperties: Boolean read FUseDefaultSitesProperties
      write FUseDefaultSitesProperties default True;

    property OnActiveDockControlChanged: TNotifyEvent
      read FOnActiveDockControlChanged write FOnActiveDockControlChanged;
    property OnCreateFloatSite: TdxCreateFloatSiteEvent read FOnCreateFloatSite
      write FOnCreateFloatSite;
    property OnCreateLayoutSite: TdxCreateLayoutSiteEvent
      read FOnCreateLayoutSite write FOnCreateLayoutSite;
    property OnCreateMissingDockControl: TdxDockControlNotifyEvent
      read FOnCreateMissingDockControl write FOnCreateMissingDockControl;
    property OnCreateSideContainer: TdxCreateSideContainerEvent
      read FOnCreateSideContainer write FOnCreateSideContainer;
    property OnCreateTabContainer: TdxCreateTabContainerEvent
      read FOnCreateTabContainer write FOnCreateTabContainer;
  ...
  public
    ...
    function GetAvailablePainterClass(ALookAndFeel: TcxLookAndFeel)
    ...
    //
    property PainterClass[Index: Integer]: TdxDockControlPainterClass
      read GetPainterClass;
...
uses
  ...
  dxDockZones, dxDockControlXPView, dxDockControlNETView,
  dxDockControlOfficeView,
  Math, dxOffice11, dxHooks, cxPCPainters, dxDockStyleVS2005, dxTypeHelpers,
  dxDPIAwareUtils,
...
const
  dxDockingTypeAlign: array [TdxDockingType] of TAlign = (alClient, alLeft,
...
procedure dxIllegalSetParentField(AHackedControl: TWinControl;
  ANewParent: TObject);
var
...
function ReadScaledValue(AIniFile: TCustomIniFile;
  const ASection, AItem: string; ACurrentDPI, ADefaultValue: Integer): Integer;
begin
  if AIniFile.ValueExists(ASection, AItem) then
    Result := MulDiv(AIniFile.ReadInteger(ASection, AItem, 0), ACurrentDPI,
      AIniFile.ReadInteger(ASection, dxDPIValueName, dxDefaultDPI))
  else
    Result := ADefaultValue;
end;

function ReadAllowDockingTypes(AIniFile: TCustomIniFile;
  const ASection, APrefix: string; ADefaultValue: TdxDockingTypes)
  : TdxDockingTypes;
begin
  Result := [];
  ...
  if AIniFile.ReadBool(ASection, APrefix + 'Top', dtTop in ADefaultValue) then
    Result := Result + [dtTop];
  if AIniFile.ReadBool(ASection, APrefix + 'Right', dtRight in ADefaultValue)
  then
    Result := Result + [dtRight];
  if AIniFile.ReadBool(ASection, APrefix + 'Bottom', dtBottom in ADefaultValue)
  then
    Result := Result + [dtBottom];
  if AIniFile.ReadBool(ASection, APrefix + 'Client', dtClient in ADefaultValue)
  then
    Result := Result + [dtClient];
end;

procedure WriteAllowDockingTypes(AIniFile: TCustomIniFile;
  const ASection, APrefix: string; AValue: TdxDockingTypes);
begin
...
function TdxDockingPaintersManager.Find(AStyle: TcxLookAndFeelStyle)
  : TdxDockControlPainterClass;
var
  I: Integer;
begin
...
function TdxDockingPaintersManager.GetAvailablePainterClass
  (ALookAndFeel: TcxLookAndFeel): TdxDockControlPainterClass;
begin
...
procedure TdxDockingPaintersManager.Register(APainterClass
  : TdxDockControlPainterClass);
begin
...
procedure TdxDockingPaintersManager.Unregister(APainterClass
  : TdxDockControlPainterClass);
begin
  if Self <> nil then
  begin
...
function TdxDockingPaintersManager.GetPainterClass(Index: Integer)
  : TdxDockControlPainterClass;
begin
...
begin
  ...
  if (ASideContainer <> nil) and (SideContainerItem = Self) and
    ASideContainer.IsValidChild(Self) and
    not(dcisInternalResizing in FInternalState) then
  begin
    Include(FInternalState, dcisInternalResizing);
    try
      if IsAlignDisabled or IsUpdateLayoutLocked or
        ASideContainer.IsAdjustBoundsLocked or ASideContainer.IsUpdateLayoutLocked
      then
      begin
      ...
      begin
        ASideContainer.DoChildResize(Self,
          ...
          (ASideContainer.GetDimension(Left - ALeft, Top - ATop) = 0) and
          Assigned(ASideContainer.GetNextValidChild(DockIndex)));
      end;
    finally
...
function TdxCustomDockControl.GetDockZoneAtPos(AControl: TdxCustomDockControl;
  APoint: TPoint): TdxZone;
var
  I: Integer;
  AZone: TdxZone;
begin
...
function TdxCustomDockControl.IsValidChild
...
procedure TdxCustomDockControl.DockTo(AControl: TdxCustomDockControl;
  AType: TdxDockingType; AIndex: Integer);
    ...
    begin
      ...
      try
        if ParentDockControl <> nil then
          if (AControl = Container) and Container.CanContainerDockHost(AType)
          then
            ExcludeFromDock
          else
            UnDock;
...
procedure TdxCustomDockControl.AddDockControl(AControl: TdxCustomDockControl;
  AIndex: Integer);
var
  AOldIndex: Integer;
begin
...
procedure TdxCustomDockControl.RemoveDockControl
  (AControl: TdxCustomDockControl);
begin
...
function TdxCustomDockControl.IndexOfControl
  (AControl: TdxCustomDockControl): Integer;
begin
...
begin
  ...
  begin
    if not(Children[I].DockType in AllowDockClients) and Children[I].CanDock
    then
    begin
      if Children[I].AutoHide then
        Children[I].AutoHide := False;
...
procedure TdxCustomDockControl.DrawDockingSelection(AZone: TdxZone;
  const pt: TPoint; AErasing: Boolean);
begin
  Controller.DrawDockingSelection(Self, AZone, pt, AErasing);
end;

procedure TdxCustomDockControl.PrepareSelectionRegion(ARegion: TcxRegion;
  const ARect: TRect);
begin
  ARegion.Combine(ARect, roSet);
end;

function TdxCustomDockControl.CanResizing(NewWidth, NewHeight: Integer)
  : Boolean;
begin
  Result := True;
...
begin
  Result := not(IsDesigning or IsCaptionPoint(P)) and
    (ButtonsController.HitTest(ClientToWindow(P)) = nil);
end;
...
begin
  ...
  if (FStoredPosition.Parent <> nil) and
    (FStoredPosition.Parent.DockState in [dsDocked, dsFloating]) and
    FStoredPosition.Parent.CanDockHost(Self, FStoredPosition.DockType) then
    AParentSite := FStoredPosition.Parent
  else if (FStoredPosition.SiblingBefore <> nil) and
    (FStoredPosition.SiblingBefore.DockState in [dsDocked, dsFloating]) and
    FStoredPosition.SiblingBefore.CanDockHost(Self, FStoredPosition.DockType)
  then
    AParentSite := FStoredPosition.SiblingBefore
  else if (FStoredPosition.SiblingAfter <> nil) and
    (FStoredPosition.SiblingAfter.DockState in [dsDocked, dsFloating]) and
    FStoredPosition.SiblingAfter.CanDockHost(Self, FStoredPosition.DockType)
  then
...
procedure TdxCustomDockControl.AssignLayoutSiteProperties
  (ASite: TdxLayoutDockSite);
var
...
function TdxCustomDockControl.HasAsParent
  (AControl: TdxCustomDockControl): Boolean;
var
...
begin
  Result := (ParentForm <> nil) and
    (ParentForm.Visible or (fsVisible in ParentForm.FormState));
end;
...
procedure TdxCustomDockControl.AlignControls(AControl: TControl;
  var Rect: TRect);
begin
  BeginUpdateNC(False);
  try
...
procedure TdxCustomDockControl.ChangeScaleEx(M, D: Integer;
  isDpiChange: Boolean);
var
...
begin
  ...
  try
    ...
    if not dxDockingController.FindManager(ParentForm, AManager) or
      AManager.ScaleFactor.Equals(ScaleFactor) then
      ManagerFont := APrevManagerFont;
  end;
end;

procedure TdxCustomDockControl.ConstrainedResize(var MinWidth, MinHeight,
...
begin
  inherited;
  Filer.DefineProperty('AutoHidePosition', ReadAutoHidePosition,
    WriteAutoHidePosition, AutoHide);
  ...
  Filer.DefineProperty('OriginalWidth', ReadOriginalWidth,
    WriteOriginalWidth, True);
  Filer.DefineProperty('OriginalHeight', ReadOriginalHeight,
    WriteOriginalHeight, True);
end;
...
procedure TdxCustomDockControl.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited;
  if Operation = opRemove then
  begin
    if AComponent = FStoredPosition.Parent then
      FStoredPosition.Parent := nil;
    if AComponent = FStoredPosition.SiblingAfter then
      FStoredPosition.SiblingAfter := nil;
    if AComponent = FStoredPosition.SiblingBefore then
      FStoredPosition.SiblingBefore := nil;
  end;
end;
...
begin
  ...
  Result := CanFocus and ((AParentForm = nil) or AParentForm.CanFocus and
    AParentForm.Enabled and AParentForm.Visible);
end;
...
begin
  if ParentDockControl = nil then
    Result := TdxControlsDesignSelectorHelper.CalculateBounds(WindowRect,
      ScaleFactor)
  else
    Result := dxMapWindowRect(GetTopMostDockControl.Handle, Handle,
      GetTopMostDockControl.GetDesignRect, False);
end;

function TdxCustomDockControl.GetDesignHitTest(const APoint: TPoint;
  AShift: TShiftState): Boolean;
begin
  Result := (IsCaptionPoint(APoint) and (ssLeft in AShift)) or
    Controller.IsDocking or Controller.IsResizing or FCaptionIsDown or
    (ButtonsController.PressedButton <> nil);
end;

function TdxCustomDockControl.IsSelected: Boolean;
begin
  Result := (cxDesignHelper <> nil) and cxDesignHelper.IsObjectSelected
    (ParentForm, Self);
end;
...
begin
  if (cxDesignHelper <> nil) and not(csDestroying in AComponent.ComponentState)
  then
...
begin
  Result := (csDestroying in (Application.ComponentState + ComponentState)) or
    (dcisDestroyed in FInternalState);
end;
...
begin
  // TODO: IsActive
  if AutoHide and (AutoHideHostSite <> nil) and
    (AutoHideHostSite.ShowingControl = Self) then
...
begin
  ...
  begin
    if AActive then
      TabContainer.ActiveChild := Self; // !!! Flag
  ...
  begin
    SetWindowPos(PopupParent.Handle, 0 { HWND_TOP } , 0, 0, 0, 0,
...
begin
  ...
  begin
    ...
    if (doFreeOnClose in ControllerOptions) then
      DoDestroy
    else if (doUndockOnClose in ControllerOptions) then
      UnDock
    else
      Visible := False;
  end;
...
begin
  Result := not IsDesigning or (FloatDockSite = nil) or
    FloatDockSite.IsDestroying;
end;
...
procedure TdxCustomDockControl.ChildVisibilityChanged
...
begin
  if UpdateVisibilityLock > 0 then
    Exit;
  ...
  BeginUpdateVisibility;
  try
    if not AutoHide and (AutoHideHostSite <> nil) and Visible and StoredAutoHide
    then
    begin
...
function TdxCustomDockControl.CanUndock(AControl: TdxCustomDockControl)
  : Boolean;
begin
  Result := (ValidChildCount > 1) or (ParentDockControl = nil) or
    ParentDockControl.CanUndock(Self);
end;

function TdxCustomDockControl.GetDockingTargetControlAtPos(const pt: TPoint)
  : TdxCustomDockControl;
var
  ADockControlAtPos, ANearestDockSiteAtPos: TdxCustomDockControl;
begin
  ADockControlAtPos := Controller.GetDockControlAtPos(pt);
  if (ADockControlAtPos <> nil) and (ADockControlAtPos.ParentForm = ParentForm)
  then
  ...
  begin
    ...
    begin
      ...
      if (ADockControlAtPos = nil) or (ANearestDockSiteAtPos <> nil) and
        (ANearestDockSiteAtPos.ParentForm = ParentForm) then
...
begin
  Result := Max(Abs(CursorPoint.X - SourcePoint.X),
    Abs(CursorPoint.Y - SourcePoint.Y));
end;

function TdxCustomDockControl.GetFloatDockRect(const pt: TPoint): TRect;
begin
  Result := cxRectOffset(GetDockingRect, pt.X - DockingOrigin.X,
    pt.Y - DockingOrigin.Y);
end;
...
begin
  ...
  begin
    ...
    if FloatDockSite <> nil then
      FDockingOrigin := cxPointOffset(APoint,
        FloatDockSite.FloatForm.BoundsRect.TopLeft, False)
    else
    begin
      FDockingOrigin := cxPointOffset(APoint, cxGetWindowRect(Self)
        .TopLeft, False);
...
procedure TdxCustomDockControl.DoCanDocking(Source: TdxCustomDockControl;
  pt: TPoint; TargetZone: TdxZone; var Accept: Boolean);
begin
  if Assigned(FOnCanDocking) then
    FOnCanDocking(Self, Source, TargetZone, pt.X, pt.Y, Accept);
end;

procedure TdxCustomDockControl.DoDocking(pt: TPoint; TargetZone: TdxZone;
  var Accept: Boolean);
begin
...
procedure TdxCustomDockControl.EndDocking(const APoint: TPoint;
  Cancel: Boolean);
var
  ATargetZone: TdxZone;
begin
...
begin
  ...
  begin
    ...
    Controller.DrawResizingSelection(Self, ResizingSourceZone, P,
      ResizingStyle, False);
    CaptureMouse;
  end;
end;
...
procedure TdxCustomDockControl.ResizeCore(const AStartPoint,
  AFinishPoint: TPoint);
begin
  if ParentDockControl <> nil then
  begin
    ...
    begin
      ...
      if ResizingSourceZone.Owner.AutoHideHostSite <> nil then
        ResizingSourceZone.Owner.AutoHideHostSite.SetFinalPosition
          (ResizingSourceZone.Owner);
    end
    else
    begin
      BeginUpdateNC;
...
begin
  if (ResizingSourceZone <> nil) and ResizingSourceZone.CanResize
    (ResizingOrigin, P) then
  begin
    DoResizing(P);
    Controller.DrawResizingSelection(Self, ResizingSourceZone, ResizingPoint,
      ResizingStyle, True);
    FResizingPoint := P;
    Controller.DrawResizingSelection(Self, ResizingSourceZone, ResizingPoint,
      ResizingStyle, False);
...
function TdxCustomDockControl.CanDockHost(AControl: TdxCustomDockControl;
  AType: TdxDockingType): Boolean;
begin
...
procedure TdxCustomDockControl.CreateContainerLayout
  (AContainer: TdxContainerDockSite; AControl: TdxCustomDockControl;
...
begin
  ...
  begin
    ...
    try
      if AType = AContainer.GetTailDockType then
        Inc(Index);
...
procedure TdxCustomDockControl.AssignSideContainerSiteProperties
  (ASite: TdxSideContainerDockSite);
var
  AProperties: TdxCustomDockControlProperties;
begin
...
function TdxCustomDockControl.CanAcceptSideContainerItems
  (AContainer: TdxSideContainerDockSite): Boolean;
begin
  Result := False;
end;

procedure TdxCustomDockControl.DoCreateSideContainerSite
  (ASite: TdxSideContainerDockSite);
begin
...
function TdxCustomDockControl.CreateHorizontalContainerDockSite
  : TdxHorizContainerDockSite;
begin
  Result := TdxHorizContainerDockSite.Create(Owner);
end;

function TdxCustomDockControl.CreateVerticalContainerDockSite
  : TdxVertContainerDockSite;
begin
  Result := TdxVertContainerDockSite.Create(Owner);
end;

procedure TdxCustomDockControl.CreateSideContainerLayout
  (AControl: TdxCustomDockControl; AType: TdxDockingType; Index: Integer);
var
...
begin
  if not(AType in [dtLeft, dtRight, dtTop, dtBottom]) then
    raise Exception.CreateFmt(sdxInternalErrorCreateLayout,
      [TdxSideContainerDockSite.ClassName]);
    ...
    try
      ...
      begin
        if AType = AContainerSite.GetHeadDockType then
          AControl.IncludeToDock(AContainerSite,
            AContainerSite.GetHeadDockType, 0)
        else
          AControl.IncludeToDock(AContainerSite,
            AContainerSite.GetTailDockType, 1);
      end
      else
        AControl.IncludeToDock(AContainerSite,
          AContainerSite.GetHeadDockType, Index);
...
procedure TdxCustomDockControl.AssignTabContainerSiteProperties
  (ASite: TdxTabContainerDockSite);
var
  AProperties: TdxCustomDockControlProperties;
begin
...
function TdxCustomDockControl.CanAcceptTabContainerItems
  (AContainer: TdxTabContainerDockSite): Boolean;
begin
  Result := False;
end;

procedure TdxCustomDockControl.DoCreateTabContainerSite
  (ASite: TdxTabContainerDockSite);
begin
...
function TdxCustomDockControl.CreateTabContainerDockSite
  : TdxTabContainerDockSite;
begin
...
begin
  if (ParentDockControl is TdxDockSite) and TdxDockSite(ParentDockControl).AutoSize
  then
...
begin
  if IsLoading or (AutoHideHostSite = nil) then
    Exit;
...
function TdxCustomDockControl.GetControlAutoHidePosition
  (AControl: TdxCustomDockControl): TdxAutoHidePosition;
var
...
function TdxCustomDockControl.GetAutoHideContainer
  : TdxDockSiteAutoHideContainer;
begin
...
begin
  ...
  begin
    if (TdxTabContainerDockSite(ParentDockControl).ActiveChild = Self) or AutoHide
    then
      Enabled := True
    else
      Enabled := False;
...
procedure TdxCustomDockControl.IncludeToDock(AControl: TdxCustomDockControl;
  AType: TdxDockingType; Index: Integer);
begin
  if IsLoading then
  begin
...
procedure TdxCustomDockControl.AdjustControlBounds
  (AControl: TdxCustomDockControl);
begin
  FOriginalWidth := ScaleFactor.Apply(AControl.OriginalWidth,
    AControl.ScaleFactor);
  FOriginalHeight := ScaleFactor.Apply(AControl.OriginalHeight,
    AControl.ScaleFactor);
...
begin
  case ChildCount of
    ...
    Assert(False, Format(sdxInternalErrorCreateLayout,
      [TdxCustomDockControl.ClassName]));
  end;
end;
...
begin
  if AutoHide and (AutoHideHostSite <> nil) and not AutoHideHostSite.IsDestroying
  then
    AutoHide := False;
  if ParentDockControl <> nil then
  begin
...
begin
  if not HasCaption then
    ...
    Result := cxMarginsWidth(Painter.GetBorderWidths) +
      ButtonsController.ButtonsCount *
      (2 * Painter.GetSpaceBetweenCaptionButtons +
      Painter.GetCaptionButtonSize.cy)
  else
    Result := Painter.GetCaptionAreaHeight +
      cxMarginsHeight(Painter.GetBorderWidths);
end;
...
begin
  if not HasCaption then
    ...
    Result := cxMarginsWidth(Painter.GetBorderWidths) +
      ButtonsController.ButtonsCount *
      (2 * Painter.GetSpaceBetweenCaptionButtons +
      Painter.GetCaptionButtonSize.cx);
end;

procedure TdxCustomDockControl.UpdateControlOriginalSize
  (AControl: TdxCustomDockControl);
var
...
begin
  if IsLoading or not Visible then
    Exit;
  if FloatDockSite <> nil then
    ...
    UpdateControlOriginalSize(Self);
end;
...
procedure TdxCustomDockControl.UpdateControlDockZones
...
begin
  ...
  AControl.DockZones.RegisterDockZone(Self, AControl, TdxBottomZone,
    AZoneWidth);
end;
...
procedure TdxCustomDockControl.UpdateControlResizeZones
  (AControl: TdxCustomDockControl);
begin
  if AControl.AutoHide and (AControl.AutoHideHostSite <> nil) then
  begin
    AControl.ResizeZones.RegisterResizeZone(Self, AControl,
      TdxAutoHideRightZone, ControllerResizeZonesWidth);
    AControl.ResizeZones.RegisterResizeZone(Self, AControl, TdxAutoHideLeftZone,
      ControllerResizeZonesWidth);
    AControl.ResizeZones.RegisterResizeZone(Self, AControl,
      TdxAutoHideBottomZone, ControllerResizeZonesWidth);
    AControl.ResizeZones.RegisterResizeZone(Self, AControl, TdxAutoHideTopZone,
      ControllerResizeZonesWidth);
  end
  else
  begin
    AControl.ResizeZones.RegisterResizeZone(Self, AControl, TdxRightZone,
      ControllerResizeZonesWidth);
    AControl.ResizeZones.RegisterResizeZone(Self, AControl, TdxLeftZone,
      ControllerResizeZonesWidth);
    AControl.ResizeZones.RegisterResizeZone(Self, AControl, TdxBottomZone,
      ControllerResizeZonesWidth);
    AControl.ResizeZones.RegisterResizeZone(Self, AControl, TdxTopZone,
      ControllerResizeZonesWidth);
  end;
end;
...
procedure TdxCustomDockControl.AssignFloatSiteProperties
  (ASite: TdxFloatDockSite);
var
  AProperties: TdxCustomDockControlProperties;
begin
...
begin
  ...
  for I := 0 to CustomCaptionButtons.Buttons.Count - 1 do
    TdxDockControlCustomButton.Create(ButtonsController,
      CustomCaptionButtons.Buttons[I]);
end;
...
procedure TdxCustomDockControl.CustomCaptionButtonsChangeHandler
  (Sender: TObject);
begin
  DestroyButtons;
  CreateButtons;
...
procedure TdxCustomDockControl.CalculateCaptionHorz(var ARect: TRect);
  ...
  procedure CalculateCaptionButton(var R: TRect;
    AButton: TdxCustomDockControlButton);
  begin
    if AButton.Visible then
    begin
      AButton.Bounds := R;
      OffsetRect(R,
        -(cxRectWidth(R) + Painter.GetSpaceBetweenCaptionButtons), 0);
    end;
  end;
...
begin
  ...
  ACaptionContentRect := cxRectContent(CaptionRect,
    Painter.GetCaptionContentOffsets(False));
  AButtonRect := cxRectCenterVertically(ACaptionContentRect,
    Painter.GetCaptionButtonSize.cy);
  AButtonRect := cxRectSetRight(AButtonRect, AButtonRect.Right,
    Painter.GetCaptionButtonSize.cx);
  ...
  FCaptionSeparatorRect := cxRectSetHeight(ARect,
    Min(cxRectHeight(ARect), Painter.GetCaptionSeparatorSize));
...
begin
  ...
  ACaptionContentRect := cxRectContent(CaptionRect,
    Painter.GetCaptionContentOffsets(True));
  AButtonRect := cxRectCenterHorizontally(ACaptionContentRect,
    Painter.GetCaptionButtonSize.cx);
  ...
  FCaptionSeparatorRect := cxRectSetWidth(ARect,
    Min(cxRectWidth(ARect), Painter.GetBorderWidths.Left));
...
function TdxCustomDockControl.CreateCustomCaptionButtons
  : TdxDockControlCustomCaptionButtons;
begin
...
begin
  ...
  begin
    ...
    try
      cxDrawDesignRect(cxPaintCanvas, GetDesignRect,
        GetTopMostDockControl.IsSelected);
    finally
...
begin
  ...
  if HandleAllocated and not IsInternalDestroying and
    (FRecalculateNCNeeded or CanCalculateNC) then
  begin
...
const
  AFlagMap: array [Boolean] of DWORD = (RDW_FRAME or RDW_INVALIDATE,
    RDW_FRAME or RDW_INVALIDATE or RDW_ALLCHILDREN or RDW_ERASE);
begin
  if HandleAllocated and not IsInternalDestroying then
...
begin
  Result := Controller.CanCalculateNC(Self) or
    (csAlignmentNeeded in ControlState);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      ExcludeClipRect(ACanvas.Handle, Left, Bottom - ABorders.Bottom,
        Right, Bottom);
      ExcludeClipRect(ACanvas.Handle, Right - ABorders.Right, Top,
        Left + Right, Bottom);
...
procedure TdxCustomDockControl.LoadLayoutFromCustomIni(AIniFile: TCustomIniFile;
  ...
  begin
    Result := [];
    if AIniFile.ReadBool(ASection, 'CaptionButtonClose',
      cbClose in CaptionButtons) then
      Result := Result + [cbClose];
    if AIniFile.ReadBool(ASection, 'CaptionButtonHide', cbHide in CaptionButtons)
    then
      Result := Result + [cbHide];
    if AIniFile.ReadBool(ASection, 'CaptionButtonMaximize',
      cbMaximize in CaptionButtons) then
...
begin
  ...
  try
    ...
    try
      ...
      AllowDock := ReadAllowDockingTypes(AIniFile, ASection, 'AllowDock',
        AllowDock);
      AllowDockClients := ReadAllowDockingTypes(AIniFile, ASection,
        'AllowDockClients', AllowDockClients);
      AllowClosing := AIniFile.ReadBool(ASection, 'AllowClosing', AllowClosing);
      AllowFloating := AIniFile.ReadBool(ASection, 'AllowFloating',
        AllowFloating);
      ...
      if AutoHide and (AutoHideHostSite <> nil) then
      begin
        FAutoHidePosition := TdxAutoHidePosition(AIniFile.ReadInteger(ASection,
          'AutoHidePosition', Integer(ahpUndefined)));
...
procedure TdxCustomDockControl.LoadLayoutProcessChildren
  (AIniFile: TCustomIniFile; AParentForm: TCustomForm; const ASection: string);
var
  I: Integer;
begin
  for I := 0 to AIniFile.ReadInteger(ASection, 'ChildCount', 0) - 1 do
    Controller.LoadControlFromCustomIni(AIniFile, AParentForm, Self,
      AIniFile.ReadString(ASection, 'Children' + IntToStr(I), ''));
end;

procedure TdxCustomDockControl.LoadLayoutProcessSizes(AIniFile: TCustomIniFile;
  AParentForm: TCustomForm; const ASection: string);
var
  APixelsPerInch: Integer;
begin
  APixelsPerInch := ScaleFactor.Apply(dxDefaultDPI);
  SetSize(ReadScaledValue(AIniFile, ASection, 'Width', APixelsPerInch, Width),
    ReadScaledValue(AIniFile, ASection, 'Height', APixelsPerInch, Height));
  FOriginalWidth := ReadScaledValue(AIniFile, ASection, 'OriginalWidth',
    APixelsPerInch, OriginalWidth);
  FOriginalHeight := ReadScaledValue(AIniFile, ASection, 'OriginalHeight',
    APixelsPerInch, OriginalHeight);
end;

procedure TdxCustomDockControl.SaveLayoutProcessChildren
...
begin
  ...
  for I := 0 to ChildCount - 1 do
    AIniFile.WriteString(ASection, 'Children' + IntToStr(I),
      IntToStr(Controller.IndexOfDockControl(Children[I])));
  for I := 0 to ChildCount - 1 do
    Controller.SaveControlToCustomIni(AIniFile, Children[I]);
end;

procedure TdxCustomDockControl.SaveLayoutProcessSizes(AIniFile: TCustomIniFile;
  const ASection: string);
begin
  AIniFile.WriteInteger(ASection, dxDPIValueName,
...
procedure TdxCustomDockControl.SaveLayoutToCustomIni(AIniFile: TCustomIniFile;
  ASection: string);
begin
  ...
  WriteAllowDockingTypes(AIniFile, ASection, 'AllowDockClients',
    AllowDockClients);
  ...
  AIniFile.WriteBool(ASection, 'CaptionButtonMaximize',
    cbMaximize in CaptionButtons);
  ...
  if AutoHide then
    AIniFile.WriteInteger(ASection, 'AutoHidePosition',
      Integer(FAutoHidePosition));
...
begin
  ...
  begin
    ...
    OffsetRect(Result, -FloatDockSite.FloatForm.Left,
      -FloatDockSite.FloatForm.Top);
  end
  else
...
function TdxCustomDockControl.GetValidChild(Index: Integer)
  : TdxCustomDockControl;
var
  I: Integer;
begin
...
procedure TdxCustomDockControl.SetAllowDockClients
  (const Value: TdxDockingTypes);
begin
...
procedure TdxCustomDockControl.SetCustomCaptionButtons
  (AValue: TdxDockControlCustomCaptionButtons);
begin
...
begin
  if (Self is TdxFloatDockSite) and IsDesigning and IsLoading then
    Exit; // Anchors bug
  FDockType := Value;
...
procedure TdxCustomDockControl.SetDockingParams(ADockingTargetZone: TdxZone;
  const ADockingPoint: TPoint);
begin
  if (FDockingTargetZone <> ADockingTargetZone) or (ADockingTargetZone = nil)
    and not cxPointIsEqual(ADockingPoint, FDockingPoint) then
  begin
...
procedure TdxCustomDockControl.SetParentDockControl
  (Value: TdxCustomDockControl);
begin
...
begin
  TcxControlAccess.InvalidateControl(Self, Message.WParam = 0,
    NeedRedrawOnResize);
end;
...
begin
  ...
  with Message do
    if Result = 0 then
      Result := Integer(GetDesignHitTest(Point(XPos, YPos),
...
begin
  if (Message.CharCode = VK_CONTROL) and (Controller.DockingDockControl = Self)
  then
    Docking(ClientToScreen(CursorPoint))
  else
    inherited;
  ...
  try
    ...
    try
      ...
      begin
        ...
        BitBlt(DC, 0, 0, WindowRect.Right, WindowRect.Bottom, TempCanvas.Handle,
          0, 0, SRCCOPY);
      end
      else
      begin
...
begin
  if (Controller.ActiveDockControl <> Self) and CanActive and
    (ParentForm <> nil) and ParentFormActive then
    Activate;
end;
...
begin
  ...
  begin
    ...
    if ButtonsController.HotButton <> nil then
      Message.Result := 1
    else if FCaptionIsDown and CanStartDocking then
    begin
      ReleaseMouse;
...
begin
  ...
  if ButtonsController.PressedButton <> nil then
    Message.Result := 1
  else if not(IsDesigning or AutoHide) and IsCaptionPoint(CursorPoint) and
...
begin
  ...
  begin
    if (Controller.DockingDockControl.DockingTargetZone = nil) and not AllowFloating
    then
...
begin
  ...
  begin
    ...
    try
      ...
      if IsDesigning then
        UpdateDesignSelectors
      else if not(disRedrawLocked in Controller.FInternalState) then
...
procedure dxDockWndProcHook(ACode: Integer; WParam: WParam; lParam: lParam;
  var AHookResult: LRESULT);

  function NeedAdditionalUpdateVisibilityFloatForms(AForm: TCustomForm)
    : Boolean;
  begin
    Result := Application.MainFormOnTaskBar and (AForm = Application.MainForm)
      and not(doFloatingOnTop in dxDockingController.Options(AForm));
  end;
...
begin
  ...
  case AMsg.Message of
      ...
      begin
        ...
        begin
          if (csDesigning in AControl.ComponentState) then
            dxDockingController.UpdateVisibilityFloatForms(nil,
              AMsg.WParam <> 0)
          else
          begin
            if NeedAdditionalUpdateVisibilityFloatForms(TCustomForm(AControl))
              and (AMsg.WParam <> 0) then
              dxDockingController.UpdateVisibilityFloatForms
                (Application.MainForm, AMsg.WParam <> 0);
          end;
        end;
    ...
    WM_ENABLE:
      if AControl is TCustomForm then
        dxDockingController.UpdateEnableStatusFloatForms(TCustomForm(AControl),
          AMsg.WParam <> 0);

    WM_SIZE:
      if (AControl is TCustomForm) and NeedAdditionalUpdateVisibilityFloatForms
        (TCustomForm(AControl)) then
        case AMsg.WParam of
          SIZE_MINIMIZED:
            dxDockingController.UpdateVisibilityFloatForms
          ...
          SIZE_RESTORED:
            dxDockingController.UpdateVisibilityFloatForms
              (Application.MainForm, True);
        end;

{$IFDEF DELPHI17}
    WM_DESTROY:
      if (AControl is TCustomForm) and (csDesigning in AControl.ComponentState)
      then
...
{$ENDIF}
    WM_WINDOWPOSCHANGED:
      ...
      begin
        if PWindowPos(AMsg.lParam).Flags and SWP_SHOWWINDOW <> 0 then
          dxDockingController.UpdateVisibilityFloatForms
            (TCustomForm(AControl), True)
        else if PWindowPos(AMsg.lParam).Flags and SWP_HIDEWINDOW <> 0 then
          dxDockingController.UpdateVisibilityFloatForms
            (TCustomForm(AControl), False);
      end;

    WM_SETFOCUS:
      if (dxDockingController.FActiveDockControlLockCount = 0) and Application.Active
      then
      begin
        AActiveDockControl := dxDockingController.GetDockControlForWindow
          (AMsg.HWND);
        if AActiveDockControl <> nil then
        begin
          if AActiveDockControl.HandleAllocated and
            (AActiveDockControl <> dxDockingController.FActivatingDockControl)
          then
            dxDockingController.ActiveDockControl := AActiveDockControl;
        end
        else if (AControl is TCustomForm) and IsMDIForm(TCustomForm(AControl))
        then
    ...
    WM_KILLFOCUS:
      ...
      then
      begin
        AParentDockControl := dxDockingController.GetDockControlForWindow
          (AMsg.HWND);
        if (AParentDockControl <> nil) and
          (dxDockingController.ActiveDockControl = AParentDockControl) and
          (AParentDockControl <> dxDockingController.FActivatingDockControl)
        then
        begin
          AActiveDockControl := dxDockingController.GetDockControlForWindow
            (AMsg.WParam); // focused
          if (AActiveDockControl = nil) or
            (AActiveDockControl <> AParentDockControl) then
            dxDockingController.ActiveDockControl := nil;
        end;
      end;
  end;
...
function TdxDockingController.GetDockControlAtPos(const P: TPoint)
  : TdxCustomDockControl;
begin
  Result := GetDockControlForWindow(WindowFromPoint(P));
end;

function TdxDockingController.GetDockControlForWindow(AWnd: HWND;
  ADockWindow: HWND = 0): TdxCustomDockControl;
var
  AControl: TControl;
  AFloatForm: TdxFloatForm;
begin
  ...
  begin
    ...
    begin
      ...
      if AFloatForm.DockSite <> nil then
        ...
        Result := nil;
      if (Result <> nil) and (ADockWindow <> 0) and
        (Result.Handle <> ADockWindow) then
        Result := nil;
      Break;
    end;
...
function TdxDockingController.GetFloatDockSiteAtPos(const pt: TPoint)
  : TdxCustomDockControl;
var
  AControl: TWinControl;
  Message: TMessage;
...
function TdxDockingController.GetNearestDockSiteAtPos(const pt: TPoint;
  ADockControl: TdxCustomDockControl = nil): TdxCustomDockControl;

  function DoGetNearestDockSiteAtPos(const pt: TPoint;
    ADockControl: TdxCustomDockControl): TdxCustomDockControl;
  var
    I: Integer;
  ...
  begin
    ...
    for I := 0 to DockControlCount - 1 do
      ...
      begin
        ...
        if (ADockControl <> nil) and
          (ADockControl.ParentForm <> ADockSite.ParentForm) then
          Continue;
        if not ADockSite.AutoSize then
          Continue;
        if not(ADockSite.Align in [alLeft, alTop, alRight, alBottom]) then
          Continue;
        if (ADockSite.Align in [alLeft, alRight]) and
          (ADockSite.Width > ADockSite.ControllerDockZonesWidth) then
          Continue;
        if (ADockSite.Align in [alTop, alBottom]) and
          (ADockSite.Height > ADockSite.ControllerDockZonesWidth) then
          Continue;
...
function TdxDockingController.IsDockControlFocusedEx(ADockControl
  : TdxCustomDockControl): Boolean;
begin
  Result := ADockControl.HandleAllocated and
    (dxDockingController.GetDockControlForWindow(GetFocus, ADockControl.Handle)
    = ADockControl);
end;

function TdxDockingController.FindManager(AForm: TCustomForm)
  : TdxDockingManager;
begin
...
function TdxDockingController.FindManager(AForm: TCustomForm;
  out AManager: TdxDockingManager): Boolean;
begin
  AManager := FindManager(AForm);
  Result := AManager <> nil;
end;

function TdxDockingController.FindFormManager(AForm: TCustomForm)
  : TdxDockingManager;
var
  I: Integer;
  AManager: TdxDockingManager;
...
procedure TdxDockingController.DoActiveDockControlChanged
  (ASender: TdxCustomDockControl; ACallEvent: Boolean);
var
  AManager: TdxDockingManager;
begin
  if ACallEvent and (ASender <> nil) then
  begin
    if FindManager(ASender.ParentForm, AManager) and
      Assigned(AManager.OnActiveDockControlChanged) then
      AManager.OnActiveDockControlChanged(AManager);
  end;
end;

procedure TdxDockingController.DoCreateFloatSite(ASender: TdxCustomDockControl;
  ASite: TdxFloatDockSite);
var
  AManager: TdxDockingManager;
begin
  if FindManager(ASender.ParentForm, AManager) and
    Assigned(AManager.OnCreateFloatSite) then
    AManager.OnCreateFloatSite(ASender, ASite);
end;

procedure TdxDockingController.DoCreateLayoutSite(ASender: TdxCustomDockControl;
  ASite: TdxLayoutDockSite);
var
  AManager: TdxDockingManager;
begin
  if FindManager(ASender.ParentForm, AManager) and
    Assigned(AManager.OnCreateLayoutSite) then
    AManager.OnCreateLayoutSite(ASender, ASite);
end;

procedure TdxDockingController.DoCreateMissingDockControl
  (ASender: TdxCustomDockControl);
var
  AManager: TdxDockingManager;
begin
  if FindManager(ASender.ParentForm, AManager) and
    Assigned(AManager.OnCreateMissingDockControl) then
    AManager.OnCreateMissingDockControl(ASender);
end;

procedure TdxDockingController.DoCreateSideContainerSite
  (ASender: TdxCustomDockControl; ASite: TdxSideContainerDockSite);
var
  AManager: TdxDockingManager;
begin
  if FindManager(ASender.ParentForm, AManager) and
    Assigned(AManager.OnCreateSideContainer) then
    AManager.OnCreateSideContainer(ASender, ASite);
end;

procedure TdxDockingController.DoCreateTabContainerSite
  (ASender: TdxCustomDockControl; ASite: TdxTabContainerDockSite);
var
  AManager: TdxDockingManager;
begin
  if FindManager(ASender.ParentForm, AManager) and
    Assigned(AManager.OnCreateTabContainer) then
    AManager.OnCreateTabContainer(ASender, ASite);
end;

function TdxDockingController.DoCustomDrawResizingSelection
  (ASender: TdxCustomDockControl; DC: HDC; AZone: TdxZone; pt: TPoint;
...
begin
  ...
  if Assigned(ASender.OnCustomDrawResizingSelection) then
    ASender.OnCustomDrawResizingSelection(ASender, DC, AZone,
      AZone.GetResizingSelection(pt), Erasing, Result);
  if not Result then
  begin
    if FindManager(ASender.ParentForm, AManager) and
      Assigned(AManager.OnCustomDrawResizingSelection) then
      AManager.OnCustomDrawResizingSelection(ASender, DC, AZone,
        AZone.GetResizingSelection(pt), Erasing, Result);
  end;
end;

function TdxDockingController.DoCustomDrawDockingSelection
  (ASender: TdxCustomDockControl; DC: HDC; AZone: TdxZone; R: TRect;
  Erasing: Boolean): Boolean;
var
  AManager: TdxDockingManager;
begin
  ...
  if Assigned(ASender.OnCustomDrawDockingSelection) then
    ASender.OnCustomDrawDockingSelection(ASender, DC, AZone, R,
      Erasing, Result);
  if not Result then
  begin
    if FindManager(ASender.ParentForm, AManager) and
      Assigned(AManager.OnCustomDrawDockingSelection) then
      AManager.OnCustomDrawDockingSelection(ASender, DC, AZone, R,
        Erasing, Result);
  end;
end;

procedure TdxDockingController.DoSetFloatFormCaption
  (ASender: TdxCustomDockControl; AFloatForm: TdxFloatForm);
var
  AManager: TdxDockingManager;
begin
  if FindManager(ASender.ParentForm, AManager) and
    Assigned(AManager.OnSetFloatFormCaption) then
...
procedure TdxDockingController.MasterLookAndFeelChanged(Sender: TcxLookAndFeel;
  AChangedValues: TcxLookAndFeelValues);
begin
...
procedure TdxDockingController.MasterLookAndFeelDestroying
  (Sender: TcxLookAndFeel);
begin
  // do nothing
end;

function TdxDockingController.DefaultLayoutSiteProperties(AForm: TCustomForm)
  : TdxLayoutDockSiteProperties;
var
  AManager: TdxDockingManager;
begin
...
function TdxDockingController.DefaultFloatSiteProperties(AForm: TCustomForm)
  : TdxFloatDockSiteProperties;
var
  AManager: TdxDockingManager;
begin
...
function TdxDockingController.DefaultHorizContainerSiteProperties
...
function TdxDockingController.DefaultVertContainerSiteProperties
  (AForm: TCustomForm): TdxSideContainerDockSiteProperties;
var
  AManager: TdxDockingManager;
begin
...
function TdxDockingController.DefaultTabContainerSiteProperties
  (AForm: TCustomForm): TdxTabContainerDockSiteProperties;
var
  AManager: TdxDockingManager;
begin
  if FindManager(AForm, AManager) and AManager.UseDefaultSitesProperties then
...
procedure TdxDockingController.LoadLayoutFromIniFile(AFileName: string;
  AForm: TCustomForm = nil);
var
  AStream: TFileStream;
begin
...
procedure TdxDockingController.LoadLayoutFromRegistry(ARegistryPath: string;
  AForm: TCustomForm = nil);
var
...
procedure TdxDockingController.LoadLayoutFromStream(AStream: TStream;
  AForm: TCustomForm = nil);
var
...
procedure TdxDockingController.SaveLayoutToIniFile(AFileName: string;
  AForm: TCustomForm = nil);
var
  AStream: TFileStream;
begin
...
procedure TdxDockingController.SaveLayoutToRegistry(ARegistryPath: string;
  AForm: TCustomForm = nil);
var
  Storage: TRegistryIniFile;
begin
...
procedure TdxDockingController.SaveLayoutToStream(AStream: TStream;
  AForm: TCustomForm = nil);
var
  AStorage: TdxMemIniFile;
begin
...
function TdxDockingController.AutoHideMovingInterval
  (AForm: TCustomForm): Integer;
var
  AManager: TdxDockingManager;
begin
  if FindManager(AForm, AManager) then
...
function TdxDockingController.ResizeStyle(AForm: TCustomForm)
...
begin
  ...
  try
    for I := 0 to DockControlCount - 1 do
      if ControlNeedUpdate(DockControls[I], AForm) and DockControls[I].ManagerColor
      then
      begin
...
begin
  ...
  try
    ...
    begin
      ...
      if ControlNeedUpdate(ADockControl, AForm) and ADockControl.ManagerFont
      then
      begin
...
begin
  ReleaseTempBitmap;
  if FindManager(ASender.ParentForm, AManager) and
    Assigned(AManager.OnLayoutChanged) then
...
procedure TdxDockingController.DoPainterChanged(AForm: TCustomForm;
  AssignDefaultStyle: Boolean);
var
  I: Integer;
  AManager: TdxDockingManager;
begin
...
begin
  if FindManager(ASender.ParentForm, AManager) and
    Assigned(AManager.OnUpdateDockZones) then
    AManager.OnUpdateDockZones(ASender, ASender.DockZones);
end;

procedure TdxDockingController.DoUpdateResizeZones
  (ASender: TdxCustomDockControl);
var
  AManager: TdxDockingManager;
begin
  if FindManager(ASender.ParentForm, AManager) and
    Assigned(AManager.OnUpdateResizeZones) then
...
begin
  ...
  begin
    ...
    if ((AControl.ParentForm = AForm) or (AForm = nil)) and
      (AControl is TdxDockPanel) and (AControl.ParentDockControl <> nil) then
    begin
      AControl.UnDock;
      AIndex := 0;
    end
  ...
  try
    ...
    with AIniFile do
      try
        ...
        ADockControlCount := ReadInteger('Root', 'DockControlCount',
          ASections.Count);
        ...
        begin
          ...
          begin
            AControlClass := TdxCustomDockControlClass
              (FindClass(ReadString(ASectionName, 'ClassName', '')));
            if AControlClass.InheritsFrom(TdxDockSite) or
              AControlClass.InheritsFrom(TdxFloatDockSite) then
            begin
              AParentForm := FindGlobalComponent(ReadString(ASectionName,
                'ParentForm', '')) as TCustomForm;
              if (AParentForm <> nil) and
                ((AParentForm = AForm) or (AForm = nil)) then
...
procedure TdxDockingController.LoadControlFromCustomIni
  (AIniFile: TCustomIniFile; AParentForm: TCustomForm;
...
begin
  ...
  begin
    if AParentForm = nil then
      AParentForm := FindGlobalComponent(ReadString(ASection, 'ParentForm', ''))
        as TCustomForm;
    if AParentForm <> nil then
    begin
      AControl := AParentForm.FindComponent(ReadString(ASection, 'Name', ''))
        as TdxCustomDockControl;
      if AControl = nil then
      begin
        AControlClass := TdxCustomDockControlClass
          (FindClass(ReadString(ASection, 'ClassName', '')));
      ...
      if AControl <> nil then
        AControl.LoadLayoutFromCustomIni(AIniFile, AParentForm, AParentControl,
          ASection);
    end;
  end;
end;
...
begin
  ...
  for I := 0 to DockControlCount - 1 do
  begin
    if DockControls[I].DockState = dsDestroyed then
      Continue;
    if ((DockControls[I].ParentForm = AForm) or (AForm = nil)) and
      ((DockControls[I] is TdxDockSite) or (DockControls[I] is TdxFloatDockSite))
    then
...
begin
  if FCalculatingControl <> nil then
    Exit;
...
function TdxDockingController.ControlNeedUpdate(AControl: TdxCustomDockControl;
  AForm: TCustomForm): Boolean;
begin
...
begin
  ...
  if AControl2.AutoHide and not AControl1.AutoHide then
    Result := -1
  else if AControl1.AutoHide and not AControl2.AutoHide then
    Result := 1;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if AControl.HandleAllocated and (AControl is TdxDockSite) and
        (AControl.Parent <> nil) then
      begin
        if NeedRedrawDockSitesParent(TdxDockSite(AControl)) then
          cxRedrawWindow(AControl.Parent.Handle, RDW_INVALIDATE or RDW_ERASE or
            RDW_ALLCHILDREN);
      end;
    end
    else if AControl.Visible then
...
function TdxDockingController.CanUpdateNC
  (AControl: TdxCustomDockControl): Boolean;
begin
...
function TdxDockingController.CanCalculateNC
  (AControl: TdxCustomDockControl): Boolean;
begin
...
procedure TdxDockingController.DrawDockingSelection(ADockControl
  : TdxCustomDockControl; AZone: TdxZone; const APoint: TPoint;
  AErasing: Boolean);
var
  R, ARegionRect: TRect;
  AHandled: Boolean;
...
begin
  ...
  begin
    ...
    AHandled := DoCustomDrawDockingSelection(ADockControl,
      cxScreenCanvas.Handle, AZone, R, AErasing);
...
procedure TdxDockingController.DrawResizingSelection(ADockControl
  : TdxCustomDockControl; AZone: TdxZone; const APoint: TPoint;
  AStyle: TdxDockingResizeStyle; AErasing: Boolean);
var
  AClientRect: TRect;
  ADC: HDC;
  AHandled: Boolean;
...
begin
  ...
  begin
    ...
    try
      ...
      try
        AClientRect := dxMapWindowRect(AWindow, 0,
          AParentForm.ClientRect, False);
        SetWindowOrgEx(ADC, AClientRect.Left, AClientRect.Top, nil);
        AHandled := DoCustomDrawResizingSelection(ADockControl, ADC, AZone,
          APoint, AErasing);
        if not AHandled then
        begin
...
function TdxDockingController.PainterClass(AForm: TCustomForm)
  : TdxDockControlPainterClass;
var
  AManager: TdxDockingManager;
begin
  if FindManager(AForm, AManager) then
    ...
    Result := dxDockingPaintersManager.GetAvailablePainterClass
      (LookAndFeel(AForm));
end;
...
procedure TdxDockingController.InvalidateControls(AForm: TCustomForm;
...
begin
  if FTempBitmap = nil then
    FTempBitmap := TcxBitmap.CreateSize(ARect,
      cxDoubleBufferedBitmapPixelFormat);
  if (FTempBitmap.Width < cxRectWidth(ARect)) or
    (FTempBitmap.Height < cxRectHeight(ARect)) then
  begin
    FTempBitmap.SetSize(Max(FTempBitmap.Width, cxRectWidth(ARect) +
      BitmapReserve), Max(FTempBitmap.Height, cxRectHeight(ARect) +
      BitmapReserve));
  end;
end;
...
function TdxDockingController.GetDockControl(Index: Integer)
  : TdxCustomDockControl;
begin
  Result := TdxCustomDockControl(FDockControls.Items[Index]);
end;
...
procedure TdxDockingController.SetActiveDockControl
  (Value: TdxCustomDockControl);
...
procedure TdxDockingController.BringToFrontFloatForms(AParentForm: TCustomForm;
  ATopMost: Boolean);
var
  AControl: TdxCustomDockControl;
  I: Integer;
begin
  ...
  begin
    ...
    begin
      if (AParentForm = nil) or (AParentForm = TdxFloatDockSite(AControl)
        .ParentForm) then
...
procedure TdxDockingController.UpdateVisibilityFloatForms
  (AParentForm: TCustomForm; AShow: Boolean);
  ...
  begin
    ...
    begin
      ...
      begin
        AControl := TdxFloatDockSite(DockControls[I]);
        if AControl.Visible and IsParentForFloatDockSite(AParentForm, AControl)
          and (AControl.FloatForm <> nil) then
...
procedure TdxDockingController.UpdateEnableStatusFloatForms
  (AParentForm: TCustomForm; AEnable: Boolean);
var
  I: Integer;
  AControl: TdxFloatDockSite;
begin
...
procedure TdxDockingController.ValidateFloatFormsDesigners
  (AParentForm: TCustomForm);
var
  AFloatForm: TdxFloatForm;
  I: Integer;
...
procedure TdxDockingController.StartDocking(AControl: TdxCustomDockControl;
  const APoint: TPoint);
begin
  FDockingControllerHelper := CreateDockingControllerHelper
    (DockStyle(AControl.ParentForm));
  FDockingControllerHelper.DockingStart(AControl, APoint);
end;

procedure TdxDockingController.Docking(AControl: TdxCustomDockControl;
  const APoint: TPoint);
begin
...
procedure TdxDockingController.EndDocking(AControl: TdxCustomDockControl;
  const APoint: TPoint);
begin
...
procedure TdxDockingController.DockControlLoaded
  (AControl: TdxCustomDockControl);
begin
...
function TdxDockingController.IndexOfDockControl
  (AControl: TdxCustomDockControl): Integer;
begin
  Result := FDockControls.IndexOf(AControl);
end;

procedure TdxDockingController.PostponedDestroyDockControl
  (AControl: TdxCustomDockControl);
begin
  PostponedDestroyComponent(AControl);
end;

procedure TdxDockingController.PostponedDestroyComponent
...
procedure TdxDockingController.RegisterDockControl
  (AControl: TdxCustomDockControl);
begin
  FDockControls.Add(AControl);
...
procedure TdxDockingController.UnregisterDockControl
  (AControl: TdxCustomDockControl);
begin
...
function TdxDockingControllerHelper.CanDocking(AControl, ATargetControl
  : TdxCustomDockControl; ATargetZone: TdxZone; const APoint: TPoint): Boolean;
begin
...
procedure TdxDockingControllerHelper.CreateSelectionDragImage
  (AControl: TdxCustomDockControl);
begin
  FDragImage := TdxDockingDragImage.Create
    (AControl.ControllerSelectionFrameWidth);
  FDragImage.FillSelection := doFillDockingSelection
    in AControl.ControllerOptions;
...
procedure TdxDockingControllerHelper.DockingStart
...
procedure TdxDockingControllerHelper.DockingMove(AControl: TdxCustomDockControl;
  const APoint: TPoint);
var
...
procedure TdxDockingControllerHelper.DockingFinish
  (AControl: TdxCustomDockControl; const APoint: TPoint);
begin
...
procedure TdxVertContainerDockSite.UpdateControlResizeZones
  (AControl: TdxCustomDockControl);
begin
  inherited;
  if (AControl.SideContainerItem <> nil) and (AControl.SideContainer = Self)
  then
    if GetNextValidChild(AControl.SideContainerIndex) <> nil then
    begin
      AControl.ResizeZones.RegisterZone
        (TdxVertContainerZone.Create(AControl.SideContainerItem,
        ControllerResizeZonesWidth, zkResizing));
    end;
end;

procedure TdxVertContainerDockSite.UpdateControlOriginalSize
  (AControl: TdxCustomDockControl);
begin
...
function TdxVertContainerDockSite.GetDimension(AWidth,
...
procedure TdxVertContainerDockSite.SetDimension(var AWidth, AHeight: Integer;
  AValue: Integer);
begin
  AHeight := AValue;
end;
...
procedure TdxVertContainerDockSite.SetSize(Index: Integer;
  const Value: Integer);
begin
  Children[Index].Height := Value;
end;

procedure TdxVertContainerDockSite.SetPosition(Index: Integer;
  const Value: Integer);
begin
...
constructor TdxCustomDockControlButton.Create(AController
  : TdxDockControlButtonsController);
begin
  inherited Create;
...
begin
  if not Enabled then
    Result := cxbsDisabled
  else if Self = Controller.HotButton then
...
procedure TdxDockingManager.Notification(AComponent: TComponent;
  Operation: TOperation);
var
  I: Integer;
begin
...
begin
  ...
  FDefaultSitesPropertiesList.Add
    (TdxSideContainerDockSiteProperties.Create(Self));
  FDefaultSitesPropertiesList.Add
    (TdxSideContainerDockSiteProperties.Create(Self));
  FDefaultSitesPropertiesList.Add
    (TdxTabContainerDockSiteProperties.Create(Self));
end;
...
procedure TdxDockingManager.DoOnLFChanged(Sender: TcxLookAndFeel;
  AChangedValues: TcxLookAndFeelValues);
begin
  if not IsLoading then
  begin
...
function TdxDockingManager.GetDefaultSiteProperties(Index: Integer)
  : TdxCustomDockControlProperties;
begin
...
function TdxDockingManager.GetDefaultLayoutSiteProperties
  : TdxLayoutDockSiteProperties;
begin
  Result := DefaultSitesProperties[0] as TdxLayoutDockSiteProperties;
end;

function TdxDockingManager.GetDefaultFloatSiteProperties
  : TdxFloatDockSiteProperties;
begin
  Result := DefaultSitesProperties[1] as TdxFloatDockSiteProperties;
end;

function TdxDockingManager.GetDefaultHorizContainerSiteProperties
  : TdxSideContainerDockSiteProperties;
begin
  Result := DefaultSitesProperties[2] as TdxSideContainerDockSiteProperties;
end;

function TdxDockingManager.GetDefaultVertContainerSiteProperties
  : TdxSideContainerDockSiteProperties;
begin
  Result := DefaultSitesProperties[3] as TdxSideContainerDockSiteProperties;
end;

function TdxDockingManager.GetDefaultTabContainerSiteProperties
  : TdxTabContainerDockSiteProperties;
begin
...
procedure TdxDockingManager.SetDefaultLayoutSiteProperties
  (Value: TdxLayoutDockSiteProperties);
begin
  (DefaultSitesProperties[0] as TdxLayoutDockSiteProperties).Assign(Value);
end;

procedure TdxDockingManager.SetDefaultFloatSiteProperties
  (Value: TdxFloatDockSiteProperties);
begin
  (DefaultSitesProperties[1] as TdxFloatDockSiteProperties).Assign(Value);
end;

procedure TdxDockingManager.SetDefaultHorizContainerSiteProperties
  (Value: TdxSideContainerDockSiteProperties);
begin
  (DefaultSitesProperties[2] as TdxSideContainerDockSiteProperties)
    .Assign(Value);
end;

procedure TdxDockingManager.SetDefaultVertContainerSiteProperties
  (Value: TdxSideContainerDockSiteProperties);
begin
  (DefaultSitesProperties[3] as TdxSideContainerDockSiteProperties)
    .Assign(Value);
end;

procedure TdxDockingManager.SetDefaultTabContainerSiteProperties
  (Value: TdxTabContainerDockSiteProperties);
begin
  (DefaultSitesProperties[3] as TdxTabContainerDockSiteProperties)
    .Assign(Value);
end;
...
begin
  if ASections.Count > 0 then
    Buttons.Scroll(0, ASections.First.Bounds.Top - ASections
      [ButtonSectionTopIndex].Bounds.Top);
end;

procedure TdxDockSiteLeftHideBar.CalculateMultiSectionButton(var R: TRect;
  AButton: TdxDockSiteHideBarButton);
var
...
begin
  ...
  begin
    ...
    begin
      AExpanded := (I = ADockSite.ActiveChildIndex) or
        ADockSite.AutoHideBarExpandAllTabs;
...
procedure TdxDockSiteLeftHideBar.CalculateSingleSectionButton(var R: TRect;
  AButton: TdxDockSiteHideBarButton);
begin
...
procedure TdxDockSiteLeftHideBar.CalculateScrollButtons
  (const AButtonsFullRect: TRect);
var
  ASize: TSize;
  R: TRect;
begin
  ScrollUpButton.Visible := cxRectHeight(AButtonsFullRect) >
    cxRectHeight(ContentRect);
...
begin
  ...
  if ScrollDownButton.Visible then
    Result.Bottom := ScrollDownButton.Bounds.Top -
      Painter.GetHideBarHorizInterval;
end;
...
begin
  Result := cxRect(GetHideBarVertInterval, GetHideBarHorzInterval +
    Owner.TopHideBar.GetHideBarSize, GetHideBarVertInterval, 0);
end;
...
procedure TdxDockSiteLeftHideBar.SetFinalPosition
  (AControl: TdxCustomDockControl);
begin
...
procedure TdxDockSiteLeftHideBar.SetInitialPosition
  (AControl: TdxCustomDockControl);
begin
  AControl.AutoHideContainer.SetBounds(Owner.GetClientLeft, Owner.GetClientTop,
...
begin
  if (ADelta > 0) and (Owner.MovingContainer.Width + ADelta >
    Owner.MovingControl.OriginalWidth) then
    ...
    Owner.MovingContainer.Width := Owner.MovingContainer.Width + ADelta;
end;

procedure TdxDockSiteLeftHideBar.UpdateOwnerAutoSizeBounds
  (AControl: TdxCustomDockControl);
var
  AWidth: Integer;
begin
...
class function TdxDockControlPainter.GetTabsPainter(ATabsStyle: TcxPCStyleID)
  : TcxPCPainterClass;
begin
  Result := nil;
end;

class function TdxDockControlPainter.HasLookAndFeelStyle
  (AStyle: TcxLookAndFeelStyle): Boolean;
begin
...
function TdxDockControlPainter.GetDefaultImageSize
  (APosition: TdxAutoHidePosition): Integer;
begin
...
begin
  ...
  Result := Max(Result, GetHideBarVertInterval + AIndent + GetImageHeight +
    AIndent + GetHideBarVertInterval);
end;
...
begin
  ...
  Result := AIndent + GetFontSize + AIndent;
  AIndent := ScaleFactor.Apply(2);
  Result := Max(Result, GetHideBarVertInterval + AIndent + GetImageWidth +
    AIndent + GetHideBarVertInterval);
end;
...
procedure TdxDockControlPainter.DrawHideBar(ACanvas: TcxCanvas; ARect: TRect;
  APosition: TdxAutoHidePosition);
begin
  ACanvas.FillRect(ARect, ColorToRGB(GetHideBarColor));
end;

procedure TdxDockControlPainter.DrawCaption(ACanvas: TcxCanvas; ARect: TRect;
  IsActive: Boolean);
begin
  ACanvas.FillRect(ARect, ColorToRGB(GetCaptionColor(IsActive)));
end;

procedure TdxDockControlPainter.DrawCaptionSeparator(ACanvas: TcxCanvas;
  ARect: TRect);
begin
  ACanvas.FillRect(ARect, ColorToRGB(GetBorderColor));
end;

procedure TdxDockControlPainter.DrawCaptionText(ACanvas: TcxCanvas;
...
begin
  ...
  begin
    ...
    begin
      ...
      R.Left := R.Right - 3;
      DrawColorEdge(ACanvas, R, GetCaptionColor(IsActive), etRaisedOuter,
        [epTopLeft]);
      DrawColorEdge(ACanvas, R, GetCaptionColor(IsActive), etRaisedInner,
        [epBottomRight]);
...
procedure TdxDockControlPainter.DrawCaptionButton(ACanvas: TcxCanvas;
  ARect: TRect; AIsActive: Boolean; AState: TcxButtonState);
begin
  if AState = cxbsPressed then
  begin
    DrawColorEdge(ACanvas, ARect, GetCaptionColor(AIsActive), etSunkenOuter,
      [epRect]);
    InflateRect(ARect, -1, -1);
    DrawColorEdge(ACanvas, ARect, GetCaptionColor(AIsActive), etSunkenInner,
      [epTopLeft]);
  end
  else
  begin
    DrawColorEdge(ACanvas, ARect, GetCaptionColor(AIsActive), etRaisedOuter,
      [epRect]);
    InflateRect(ARect, -1, -1);
    DrawColorEdge(ACanvas, ARect, GetCaptionColor(AIsActive), etRaisedInner,
      [epBottomRight]);
  end;
end;

procedure TdxDockControlPainter.DrawCaptionCloseButton(ACanvas: TcxCanvas;
  ARect: TRect; AIsActive: Boolean; AState: TcxButtonState);
begin
...
begin
  ...
  begin
    ...
    ACanvas.Polyline([Point(ABase, ASide1 - ADelta), Point(ABase, ASide1),
      Point(ARect.Right - ADelta, ASide1), Point(ARect.Right - ADelta, ASide2),
      Point(ABase, ASide2), Point(ABase, ASide2 + ADelta),
      Point(ABase, ASide1)]);
    ACanvas.FillRect(Rect(ABase, ASide2 - ADelta, ARect.Right - ADelta, ASide2),
      ACanvas.Pen.Color);
  ...
  begin
    ...
    ACanvas.Polyline([Point(ASide1 - ADelta, ABase), Point(ASide1, ABase),
      Point(ASide1, ARect.Top), Point(ASide2, ARect.Top), Point(ASide2, ABase),
      Point(ASide2 + ADelta, ABase), Point(ASide1, ABase)]);
    ACanvas.FillRect(Rect(ASide2 - ADelta, ARect.Top, ASide2, ABase),
      ACanvas.Pen.Color);
...
begin
  ...
  pts[2] := Point(ARect.Left + cxRectWidth(ARect) div 2,
    ARect.Top + cxRectWidth(ARect) div 2);
  ACanvas.Polygon(pts);
end;
...
procedure TdxDockControlPainter.DrawDockSiteClient(ACanvas: TcxCanvas;
  ARect: TRect);
begin
  DrawClient(ACanvas, ARect);
end;

procedure TdxDockControlPainter.DrawHideBarButtonBackground(ACanvas: TcxCanvas;
  AButton: TdxDockSiteHideBarButton; APosition: TdxAutoHidePosition);
const
  TopEdges: array [TdxAutoHidePosition] of TdxEdgePositions = ([epTop],
    [epLeft], [epTopLeft], [epTopLeft], []);
  BottomEdges: array [TdxAutoHidePosition] of TdxEdgePositions =
    ([epBottomRight], [epBottomRight], [epBottom], [epRight], []);
begin
  DrawColorEdge(ACanvas, AButton.Bounds, GetHideBarButtonColor, etRaisedOuter,
    TopEdges[APosition]);
  DrawColorEdge(ACanvas, AButton.Bounds, GetHideBarButtonColor, etRaisedInner,
    BottomEdges[APosition]);
end;
...
procedure TdxDockControlPainter.DrawHideBarButtonSection(ACanvas: TcxCanvas;
  ...
  procedure DrawHideBarButtonSectionImage(var R: TRect;
  ...
  begin
    ...
    begin
      AImageSize := GetDefaultImageSize(APosition) + 2 *
...
begin
  ...
  if not cxRectIsEmpty(ARect) then
    DrawHideBarButtonText(ACanvas, AButtonSection.DockControl, ARect,
      APosition);
end;

procedure TdxDockControlPainter.DrawHideBarButtonSections(ACanvas: TcxCanvas;
  AButton: TdxDockSiteHideBarButton; APosition: TdxAutoHidePosition);
var
  I: Integer;
begin
  ...
  begin
    ...
    if I + 1 < AButton.Sections.Count then
      DrawHideBarButtonSectionSeparator(ACanvas, AButton.Sections[I],
        APosition);
  end;
end;

procedure TdxDockControlPainter.DrawHideBarButtonSectionSeparator
  (ACanvas: TcxCanvas; AButtonSection: TdxDockSiteHideBarButtonSection;
  APosition: TdxAutoHidePosition);
const
  SeparatorEdges: array [TdxAutoHidePosition] of TdxEdgePositions = ([epBottom],
    [epRight], [epBottom], [epRight], []);
begin
  DrawColorEdge(ACanvas, AButtonSection.Bounds, GetHideBarButtonColor,
    etRaisedInner, SeparatorEdges[APosition]);
end;
...
procedure TdxDockControlPainter.DrawHideBarButtonImage(ACanvas: TcxCanvas;
  AControl: TdxCustomDockControl; ARect: TRect);
begin
  if IsValidImageIndex(AControl.ImageIndex) then
  begin
    cxDrawImage(ACanvas, cxRectCenter(ARect, GetImageWidth, GetImageHeight),
      nil, AControl.Images, AControl.ImageIndex, ifmNormal, idmNormal, False,
      GetHideBarButtonColorPalette, ScaleFactor);
  end;
end;
...
procedure TdxDockControlPainter.DrawHideBarButtonText(ACanvas: TcxCanvas;
  ...
  begin
    ...
    cxDrawText(ACanvas.Handle, AControl.Caption, R, DT_SINGLELINE or DT_LEFT or
...
begin
  cxLookAndFeelPaintersManager.GetPainter(lfsFlat).DrawScaledArrow(ACanvas,
    ARect, AState, AArrow, ScaleFactor);
end;
...
class procedure TdxDockControlPainter.DrawColorEdge(ACanvas: TcxCanvas;
  ARect: TRect; AColor: TColor; AEdgesType: TdxEdgesType;
  AEdgePositions: TdxEdgePositions);
var
  LTCol, RBCol: TColor;
begin
  ...
  if (epLeft in AEdgePositions) or (epTopLeft in AEdgePositions) or
    (epRect in AEdgePositions) then
    ACanvas.Line(ARect.Left, ARect.Bottom - 1, ARect.Left, ARect.Top - 1);
  if (epTop in AEdgePositions) or (epTopLeft in AEdgePositions) or
    (epRect in AEdgePositions) then
    ACanvas.Line(ARect.Left, ARect.Top, ARect.Right, ARect.Top);
  ACanvas.Pen.Color := RBCol;
  if (epRight in AEdgePositions) or (epBottomRight in AEdgePositions) or
    (epRect in AEdgePositions) then
    ACanvas.Line(ARect.Right - 1, ARect.Top, ARect.Right - 1, ARect.Bottom);
  if (epBottom in AEdgePositions) or (epBottomRight in AEdgePositions) or
    (epRect in AEdgePositions) then
    ACanvas.Line(ARect.Right - 1, ARect.Bottom - 1, ARect.Left - 1,
      ARect.Bottom - 1)
end;
...
function TdxDockControlPainter.GetCaptionContentOffsets
  (AIsVertical: Boolean): TRect;
begin
  if AIsVertical then
...
function TdxDockControlPainter.GetCaptionColorPalette(AState: TcxButtonState)
  : IdxColorPalette;
begin
  Result := nil;
end;
...
begin
  Result := GetCaptionAreaContentHeight +
...
function TdxDockControlPainter.GetCaptionSignColor(IsActive: Boolean;
...
function TdxDockControlPainter.GetLookAndFeelPainter
...
function TdxLayoutDockSite.CanDockHost(AControl: TdxCustomDockControl;
  AType: TdxDockingType): Boolean;
begin
...
procedure TdxLayoutDockSite.UpdateControlDockZones
  (AControl: TdxCustomDockControl; AZoneWidth: Integer);
begin
  if (SiblingDockControl = nil) or (SiblingDockControl.DockType <> dtClient)
  then
  begin
    if not AControl.DockZones.RegisterDockZone(Self, AControl, TdxClientZone,
      AZoneWidth) then
      AControl.DockZones.RegisterDockZone(Self, AControl,
        TdxInvisibleClientZone, AZoneWidth);
    inherited UpdateControlDockZones(AControl, AZoneWidth);
  end;
end;

procedure TdxLayoutDockSite.CreateLayout(AControl: TdxCustomDockControl;
  AType: TdxDockingType; Index: Integer);
begin
  inherited;
...
class function TdxZone.ValidateDockZone(AOwner,
  AControl: TdxCustomDockControl): Boolean;
begin
  Result := (AOwner = AControl);
end;

class function TdxZone.ValidateResizeZone(AOwner,
  AControl: TdxCustomDockControl): Boolean;
begin
  Result := False;
end;
...
begin
  Result := CanConstrainedResize(ANewWidth, ANewHeight) and
    Owner.CanResizing(ANewWidth, ANewHeight);
end;

function TdxZone.CanConstrainedResize(NewWidth, NewHeight: Integer): Boolean;
begin
  Result := ((Owner.Constraints.MinHeight <= 0) or
    (NewHeight > Owner.Constraints.MinHeight)) and
    ((Owner.Constraints.MaxHeight <= 0) or
    (NewHeight < Owner.Constraints.MaxHeight)) and
    ((Owner.Constraints.MinWidth <= 0) or
    (NewWidth > Owner.Constraints.MinWidth)) and
    ((Owner.Constraints.MaxWidth <= 0) or
    (NewWidth < Owner.Constraints.MaxWidth));
end;
...
procedure TdxZone.PrepareSelectionRegion(ARegion: TcxRegion;
  AControl: TdxCustomDockControl; const ARect: TRect);
begin
...
procedure TdxDockSiteRightHideBar.SetFinalPosition
  (AControl: TdxCustomDockControl);
begin
  AControl.AutoHideContainer.SetBounds(Owner.GetClientLeft +
    Owner.GetClientWidth - AControl.OriginalWidth, Owner.GetClientTop,
    AControl.OriginalWidth, Owner.GetClientHeight);
end;

procedure TdxDockSiteRightHideBar.SetInitialPosition
  (AControl: TdxCustomDockControl);
begin
  AControl.AutoHideContainer.SetBounds(Owner.GetClientLeft +
    Owner.GetClientWidth, Owner.GetClientTop, 0, Owner.GetClientHeight);
end;
...
begin
  if (ADelta > 0) and (Owner.MovingContainer.Width + ADelta >
    ...
    Owner.MovingContainer.SetBounds(Owner.MovingContainer.Left - ADelta,
      Owner.MovingContainer.Top, Owner.MovingContainer.Width + ADelta,
      Owner.MovingContainer.Height);
end;
...
procedure TdxDockSiteBottomHideBar.SetFinalPosition
  (AControl: TdxCustomDockControl);
begin
  AControl.AutoHideContainer.SetBounds(Owner.GetClientLeft,
...
procedure TdxDockSiteBottomHideBar.SetInitialPosition
  (AControl: TdxCustomDockControl);
begin
  AControl.AutoHideContainer.SetBounds(Owner.GetClientLeft,
    Owner.GetClientTop + Owner.GetClientHeight, Owner.GetClientWidth, 0);
end;

procedure TdxDockSiteBottomHideBar.UpdatePosition(ADelta: Integer);
begin
  if (ADelta > 0) and (Owner.MovingContainer.Height + ADelta >
    Owner.MovingControl.OriginalHeight) then
    SetFinalPosition(Owner.MovingControl)
  else if (ADelta < 0) and (Owner.MovingContainer.Height + ADelta < 0) then
    SetInitialPosition(Owner.MovingControl)
  else
    Owner.MovingContainer.SetBounds(Owner.MovingContainer.Left,
      Owner.MovingContainer.Top - ADelta, Owner.MovingContainer.Width,
      Owner.MovingContainer.Height + ADelta);
end;
...
begin
  ...
  begin
    TdxTabContainerDockSite(Dest).AutoHideBarExpandAllTabs :=
  ...
  begin
    TdxTabContainerDockSiteProperties(Dest).AutoHideBarExpandAllTabs :=
      AutoHideBarExpandAllTabs;
    TdxTabContainerDockSiteProperties(Dest).TabsProperties.Assign
      (TabsProperties);
  end;
...
begin
  inherited DefineProperties(Filer);
  Filer.DefineProperty('TabsPosition', TabsProperties.ReadOldTabsPosition,
    nil, False);
  Filer.DefineProperty('TabsScroll', TabsProperties.ReadOldTabsScroll,
    nil, False);
end;

procedure TdxTabContainerDockSiteProperties.SetTabsProperties
  (AValue: TdxDockingTabControlProperties);
begin
...
procedure TdxSideContainerDockSite.DoActiveChildChanged(APrevActiveChild
  : TdxCustomDockControl);
begin
  inherited;
  NCChanged;
...
function TdxSideContainerDockSite.CanChildResize(AControl: TdxCustomDockControl;
  ADeltaSize: Integer): Boolean;
var
...
begin
  ...
  Result := (ANextIndex > -1) and
    (MinSizes[AIndex] < Sizes[AIndex] + ADeltaSize) and
    (MinSizes[ANextIndex] < Sizes[ANextIndex] - ADeltaSize);
end;
...
procedure TdxSideContainerDockSite.AdjustChildrenBounds
  (AControl: TdxCustomDockControl);
begin
...
procedure TdxSideContainerDockSite.SetChildBounds
  (AControl: TdxCustomDockControl; var AWidth, AHeight: Integer);
begin
  if (ActiveChild = nil) and not IsAdjustBoundsLocked then
    AdjustChildrenBounds(nil);
end;

function TdxSideContainerDockSite.IsValidActiveChild
  (AControl: TdxCustomDockControl): Boolean;
begin
...
begin
  Result := (doSideContainerHasCaption in ControllerOptions) and ShowCaption and
    (FloatDockSite = nil) and (ValidChildCount > 1);
end;

function TdxSideContainerDockSite.HasCaption: Boolean;
begin
  Result := (doSideContainerHasCaption in ControllerOptions) and ShowCaption and
    (FloatDockSite = nil) and ((ValidChildCount > 1) or AutoHide);
end;
...
function TdxSideContainerDockSite.CanDockHost(AControl: TdxCustomDockControl;
  AType: TdxDockingType): Boolean;
var
...
begin
  ...
  if doSideContainerCanInSideContainer in ControllerOptions then
    ACanDockHost := ACanDockHost or
      (AType in [dtLeft, dtRight, dtTop, dtBottom]);
...
begin
  Result := not AutoHide and (SideContainer <> nil) and
    (SideContainer.ValidChildCount > 1);
end;

procedure TdxSideContainerDockSite.SetBounds(ALeft, ATop, AWidth,
  AHeight: Integer);
begin
  inherited;
  AdjustChildrenBounds(nil);
...
procedure TdxSideContainerDockSite.UpdateControlDockZones
  (AControl: TdxCustomDockControl; AZoneWidth: Integer);
begin
  if doSideContainerCanInSideContainer in ControllerOptions then
    inherited;
...
begin
  ...
  begin
    ...
    case AType of
      ...
      Assert(False, Format(sdxInternalErrorCreateLayout,
        [TdxTabContainerDockSite.ClassName]));
    end;
end;
...
procedure TdxSideContainerDockSite.LoadLayoutFromCustomIni
  (AIniFile: TCustomIniFile; AParentForm: TCustomForm;
  AParentControl: TdxCustomDockControl; ASection: string);
begin
  BeginAdjustBounds;
...
function TdxSideContainerDockSite.CanAcceptSideContainerItems
  (AContainer: TdxSideContainerDockSite): Boolean;
begin
...
function TdxSideContainerDockSite.CanAcceptTabContainerItems
  (AContainer: TdxTabContainerDockSite): Boolean;
begin
...
begin
  ...
  for I := 0 to ChildCount - 1 do
  begin
    if not IsValidChild(Children[I]) then
      Continue;
...
procedure TdxSideContainerDockSite.ChildVisibilityChanged
  (Sender: TdxCustomDockControl);
begin
  inherited;
...
procedure TdxSideContainerDockSite.AdjustChildrenBoundsComplexMode
  (AControl: TdxCustomDockControl);
...
function TdxCustomDockControlProperties.CreateCustomCaptionButtons
  : TdxDockControlCustomCaptionButtons;
begin
  Result := TdxDockControlCustomCaptionButtons.Create(Self);
end;
...
procedure TdxCustomDockControlProperties.SetCustomCaptionButtons
  (const Value: TdxDockControlCustomCaptionButtons);
begin
...
procedure TdxTabContainerDockSite.InvalidateRect(const R: TRect;
...
procedure TdxTabContainerDockSite.SetAutoHideBarExpandAllTabs
  (const Value: Boolean);
begin
...
procedure TdxTabContainerDockSite.DoActiveChildChanged(APrevActiveChild
  : TdxCustomDockControl);
var
  AParentForm: TCustomForm;
  AWasActive: Boolean;
...
begin
  Result := (doTabContainerHasCaption in ControllerOptions) and ShowCaption and
    HasBorder;
end;
...
function TdxTabContainerDockSite.CanDockHost(AControl: TdxCustomDockControl;
  AType: TdxDockingType): Boolean;
var
  ACanDockHost: Boolean;
begin
...
procedure TdxTabContainerDockSite.ActivateNextChild(AGoForward,
  AGoOnCycle: Boolean);
var
...
procedure TdxTabContainerDockSite.ChangeScaleEx(M, D: Integer;
  isDpiChange: Boolean);
begin
  inherited;
  TabsProperties.ChangeScale(M, D);
...
function TdxTabContainerDockSite.GetDesignHitTest(const APoint: TPoint;
  AShift: TShiftState): Boolean;
begin
  Result := inherited GetDesignHitTest(APoint, AShift) or
    PtInRect(TabsRect, ClientToWindow(APoint));
end;

function TdxTabContainerDockSite.CanResizeAtPos(const P: TPoint): Boolean;
begin
  Result := inherited CanResizeAtPos(P) and
    (TabsController.GetTabIndexAtPoint(P) = -1);
end;
...
procedure TdxTabContainerDockSite.LoadLayoutFromCustomIni
  (AIniFile: TCustomIniFile; AParentForm: TCustomForm;
  AParentControl: TdxCustomDockControl; ASection: string);
begin
  inherited LoadLayoutFromCustomIni(AIniFile, AParentForm, AParentControl,
    ASection);
  AutoHideBarExpandAllTabs := AIniFile.ReadBool(ASection,
    'AutoHideBarExpandAllTabs', AutoHideBarExpandAllTabs);
  ShowCaption := AIniFile.ReadBool(ASection, 'ShowCaption', ShowCaption);
  TabsProperties.LoadFromIniFile(AIniFile, ASection);
end;

procedure TdxTabContainerDockSite.SaveLayoutToCustomIni
  (AIniFile: TCustomIniFile; ASection: string);
begin
  inherited SaveLayoutToCustomIni(AIniFile, ASection);
  AIniFile.WriteBool(ASection, 'AutoHideBarExpandAllTabs',
    AutoHideBarExpandAllTabs);
  AIniFile.WriteBool(ASection, 'ShowCaption', ShowCaption);
  TabsProperties.SaveToIniFile(AIniFile, ASection);
end;

function TdxTabContainerDockSite.CanAcceptSideContainerItems
  (AContainer: TdxSideContainerDockSite): Boolean;
begin
  Result := not((doSideContainerCanInTabContainer in ControllerOptions) or
    IsLoading);
end;

function TdxTabContainerDockSite.CanAcceptTabContainerItems
  (AContainer: TdxTabContainerDockSite): Boolean;
begin
  Result := True;
end;
...
procedure TdxTabContainerDockSite.ChildVisibilityChanged
  (Sender: TdxCustomDockControl);
begin
...
procedure TdxTabContainerDockSite.HandlerDrawTab(AProperties
  : TcxCustomTabControlProperties; ATab: TcxTab; var ADefaultDraw: Boolean);
begin
...
procedure TdxTabContainerDockSite.WMLButtonDblClk
...
function TdxDockingTabControlViewInfo.GetProperties
  : TdxDockingTabControlProperties;
begin
...
procedure TdxDockingTabControlController.AddTab(ADockControl
  : TdxCustomDockControl; AVisible: Boolean);
var
  ATabIndex: Integer;
begin
...
procedure TdxDockingTabControlController.DoChanged(Sender: TObject;
  AType: TcxCustomTabControlPropertiesChangedType);
begin
...
procedure TdxDockingTabControlController.DoMouseDblClick
  (var Message: TWMLButtonDblClk);
var
  AControl: TdxCustomDockControl;
  APoint: TPoint;
...
begin
  ...
  try
    if (doDblClickDocking in Owner.ControllerOptions) and
      not(Owner.IsDesigning or Owner.AutoHide) then
    begin
...
procedure TdxDockingTabControlController.DoMouseMove(var Message: TWMMouseMove);
  ...
  begin
    Result := (MouseDownTabVisibleIndex >= 0) and
      (Owner.GetDraggingMouseShift > Mouse.DragThreshold) and
      (Owner.IsDesigning or (MouseDownTabVisibleIndex <>
      GetVisibleTabIndexAtPoint(Owner.CursorPoint)));
  end;
...
procedure TdxDockingTabControlController.DoTabClose(Sender: TObject;
  ATabIndex: Integer);
begin
...
procedure TdxDockingTabControlController.DoUndock(const APoint: TPoint;
  ADockControl: TdxCustomDockControl);
begin
  ADockControl.MakeFloating;
end;

function TdxDockingTabControlController.IsDockable
  (AControl: TdxCustomDockControl): Boolean;
begin
...
procedure TdxDockingTabControlController.RefreshTabInfo(ATab: TcxTab;
  ADockControl: TdxCustomDockControl);
begin
...
procedure TdxDockingTabControlController.TabDown(ATabVisibleIndex: Integer;
  AShift: TShiftState);
begin
...
procedure TdxDockingTabControlController.TabInfoChanged
  (ADockControl: TdxCustomDockControl);
var
  AIndex: Integer;
begin
...
procedure TdxDockingTabControlController.TabUp(ATabVisibleIndex: Integer;
  AShift: TShiftState);
begin
...
function TdxDockingTabControlController.GetClientToScreen
  (const APoint: TPoint): TPoint;
begin
  Result := Owner.WindowToScreen(ViewInfo.ClientToWindow(APoint));
end;

function TdxDockingTabControlController.GetDockControl(Index: Integer)
  : TdxCustomDockControl;
begin
...
function TdxDockingTabControlController.GetProperties
  : TdxDockingTabControlProperties;
begin
  Result := inherited Properties as TdxDockingTabControlProperties;
end;

function TdxDockingTabControlController.GetMappedToTabsPoint
  (const P: TPoint): TPoint;
begin
  Result := ViewInfo.WindowToClient(Owner.ClientToWindow(P));
end;

function TdxDockingTabControlController.GetMappedToTabsSmallPoint
  (const P: TSmallPoint): TPoint;
begin
  Result := GetMappedToTabsPoint(SmallPointToPoint(P));
end;

function TdxDockingTabControlController.GetScreenToClient
  (const APoint: TPoint): TPoint;
begin
  Result := ViewInfo.WindowToClient(Owner.ScreenToWindow(APoint));
end;

function TdxDockingTabControlController.GetTabIndexAtPoint
...
function TdxDockingTabControlController.GetViewInfo
  : TdxDockingTabControlViewInfo;
begin
  Result := inherited ViewInfo as TdxDockingTabControlViewInfo;
end;

function TdxDockingTabControlController.GetVisibleDockControl(Index: Integer)
  : TdxCustomDockControl;
begin
  Result := Tabs.VisibleTabs[Index].Data as TdxCustomDockControl;
end;

function TdxDockingTabControlController.GetVisibleTabIndexAtPoint
  (const P: TPoint): Integer;
begin
...
procedure TdxTabContainerDockSiteTabControlController.DoTabIndexChanged
  (Sender: TObject);
begin
...
function TdxTabContainerDockSiteTabControlController.GetActiveChild
  : TdxCustomDockControl;
begin
  Result := Owner.ActiveChild;
end;

function TdxTabContainerDockSiteTabControlController.GetOwner
  : TdxTabContainerDockSite;
begin
  Result := inherited Owner as TdxTabContainerDockSite;
end;

procedure TdxTabContainerDockSiteTabControlController.SetActiveChild
  (AValue: TdxCustomDockControl);
begin
...
procedure TdxTabContainerDockSiteTabControlProperties.LoadFromIniFile
  (AIniFile: TCustomIniFile; const ASection: string);
begin
  CloseTabWithMiddleClick := AIniFile.ReadBool(ASection,
    'CloseTabWithMiddleClick', False);
  CloseButtonMode := TcxPCButtonMode(AIniFile.ReadInteger(ASection,
    'CloseButtonMode', Ord(cbmNone)));
  ...
  NavigatorPosition := TcxPCNavigatorPosition(AIniFile.ReadInteger(ASection,
    'NavigatorPosition', Ord(npRightTop)));
  RaggedRight := AIniFile.ReadBool(ASection, 'RaggedRight', False);
  Rotate := AIniFile.ReadBool(ASection, 'Rotate', False);
  RotatedTabsMaxWidth := AIniFile.ReadInteger(ASection,
    'RotatedTabsMaxWidth', 0);
  Style := TcxPCStyleID(AIniFile.ReadInteger(ASection, 'Style',
    cxPCDefaultStyle));
  TabCaptionAlignment := TAlignment(AIniFile.ReadInteger(ASection,
    'TabCaptionAlignment', Ord(taCenter)));
  TabPosition := TcxTabPosition(AIniFile.ReadInteger(ASection, 'TabsPosition',
    Ord(tpBottom)));
  TabsScroll := AIniFile.ReadBool(ASection, 'TabsScroll', True);
  TabHeight := ReadScaledValue(AIniFile, ASection, 'TabHeight',
    ScaleFactor.Apply(dxDefaultDPI), 0);
  TabWidth := ReadScaledValue(AIniFile, ASection, 'TabWidth',
    ScaleFactor.Apply(dxDefaultDPI), 0);
...
begin
  AIniFile.WriteInteger(ASection, dxDPIValueName,
    ScaleFactor.Apply(dxDefaultDPI));
  AIniFile.WriteBool(ASection, 'CloseTabWithMiddleClick',
  ...
  AIniFile.WriteInteger(ASection, 'TabCaptionAlignment',
    Ord(TabCaptionAlignment));
...
begin
  ...
  begin
    if AIniFile.ReadBool(ASection, 'Option' + dxPCOptionsNames[AOption],
      AOption in cxPCDefaultOptions) then
...
begin
  ATabSlantPositions := [];
  if AIniFile.ReadBool(ASection, 'TabSlantsLeft',
    spLeft in cxTabSlantDefaultPositions) then
    Include(ATabSlantPositions, spLeft);
  if AIniFile.ReadBool(ASection, 'TabSlantsRight',
    spRight in cxTabSlantDefaultPositions) then
    Include(ATabSlantPositions, spRight);
  TabSlants.Positions := ATabSlantPositions;
  TabSlants.Kind := TcxTabSlantKind(AIniFile.ReadInteger(ASection,
    'TabSlantsKind', Ord(skSlant)));
end;
...
begin
  for AOption := Low(AOption) to High(AOption) do
    AIniFile.WriteBool(ASection, 'Option' + dxPCOptionsNames[AOption],
      AOption in Options);
end;
...
begin
  ...
  AIniFile.WriteBool(ASection, 'TabSlantsRight',
    spRight in TabSlants.Positions);
  AIniFile.WriteInteger(ASection, 'TabSlantsKind', Integer(TabSlants.Kind));
end;

function TdxTabContainerDockSiteTabControlProperties.GetScaleFactor
  : TdxScaleFactor;
begin
...
function TdxContainerDockSite.CanDockHost(AControl: TdxCustomDockControl;
  AType: TdxDockingType): Boolean;
begin
  Result := inherited CanDockHost(AControl, AType);
end;

function TdxContainerDockSite.CanContainerDockHost
  (AType: TdxDockingType): Boolean;
begin
  Result := (AType = GetHeadDockType) or (AType = GetTailDockType);
end;

function TdxContainerDockSite.GetControlAutoHidePosition
  (AControl: TdxCustomDockControl): TdxAutoHidePosition;
begin
  Result := inherited GetControlAutoHidePosition(Self);
end;

procedure TdxContainerDockSite.ChildVisibilityChanged
  (Sender: TdxCustomDockControl);
begin
  if disManagerChanged in Controller.FInternalState then
    Exit;
...
begin
  if CanContainerDockHost(AType) then
    ...
    Assert(False, Format(sdxInternalErrorCreateLayout,
      [TdxContainerDockSite.ClassName]));
end;
...
begin
  ...
  try
    ...
    if ChildCount = 1 then // !!!
      ...
      Assert(ChildCount > 0, Format(sdxInternalErrorDestroyLayout,
        [ClassName]));
  finally
    AParentControl.EndUpdateLayout;
  end;
...
procedure TdxContainerDockSite.DoActiveChildChanged(APrevActiveChild
  : TdxCustomDockControl);
begin
  ValidateActiveChild(-1);
  UpdateCaption;
...
function TdxContainerDockSite.GetNextValidChild(AIndex: Integer)
  : TdxCustomDockControl;
var
  I: Integer;
begin
...
function TdxContainerDockSite.GetPrevValidChild(AIndex: Integer)
  : TdxCustomDockControl;
var
  I: Integer;
begin
...
function TdxContainerDockSite.IsValidActiveChild
  (AControl: TdxCustomDockControl): Boolean;
begin
...
begin
  if (FActiveChild <> Value) and ((Value = nil) or IsValidActiveChild(Value))
  then
  begin
    BeginUpdateNC;
    try
...
function TdxDockSite.GetHideBarByControl(AControl: TdxCustomDockControl)
  : TdxDockSiteHideBar;
var
  I: Integer;
begin
...
function TdxDockSite.GetHideBarByPosition(APosition: TdxAutoHidePosition)
  : TdxDockSiteHideBar;
var
  I: Integer;
begin
...
function TdxDockSite.CanDockHost(AControl: TdxCustomDockControl;
  AType: TdxDockingType): Boolean;
begin
  Result := inherited CanDockHost(AControl, AType);
  Result := Result and ((AType in [dtLeft, dtRight, dtTop, dtBottom]) or
    ((AType in [dtClient]) and (ChildCount = 0)));
  Result := Result and (not AutoSize or ((AutoSizeClientControl = nil) and
    (AType = dtClient)));
end;

function TdxDockSite.GetPositionByControl(AControl: TdxCustomDockControl)
  : TdxAutoHidePosition;
var
  AHideBar: TdxDockSiteHideBar;
begin
...
function TdxDockSite.GetControlAtPos(pt: TPoint;
  var SubControl: TdxCustomDockControl): TdxCustomDockControl;
var
  I: Integer;
begin
  Result := nil;
...
function TdxDockSite.GetControlAutoHidePosition(AControl: TdxCustomDockControl)
  : TdxAutoHidePosition;
begin
  if AutoSize then
  begin
...
procedure TdxDockSite.RegisterAutoHideDockControl
  (AControl: TdxCustomDockControl; APosition: TdxAutoHidePosition);
var
  AHideBar: TdxDockSiteHideBar;
begin
  NCChanged;
...
procedure TdxDockSite.UnregisterAutoHideDockControl
  (AControl: TdxCustomDockControl);
var
  AHideBar: TdxDockSiteHideBar;
begin
...
begin
  if IsDestroying or not AutoSize or (Align = alClient) then
    Exit;
...
begin
  ...
  begin
    ...
    else if Children[1] is TdxContainerDockSite then
...
procedure ShowMovementTimerProc(Wnd: HWND; Msg: UINT; TimerID: UINT_PTR;
...
begin
  AAutoHideMovingSize := IfThen(ControllerAutoHideMovingInterval = 0, MAXWORD,
    ControllerAutoHideMovingSize);
  ...
  if MovingControlHideBar.CheckShowingFinish then
    ...
    FMovingTimerID := dxSetTimer(Handle, 1, ControllerAutoHideMovingInterval,
      ShowMovementTimerProc);
end;

procedure HideMovementTimerProc(Wnd: HWND; Msg: UINT; TimerID: UINT_PTR;
  SysTime: DWORD); stdcall;
var
  AControl: TdxDockSite;
begin
...
procedure AutoHideTimerProc(Wnd: HWND; Msg: UINT; TimerID: UINT_PTR;
  SysTime: DWORD); stdcall;
var
  AControl: TdxDockSite;
begin
...
begin
  ...
  if not IsDestroying and (FHidingTimerID = 0) and (ShowingControl <> nil) then
    FHidingTimerID := dxSetTimer(Handle, 2, ControllerAutoHideInterval,
      AutoHideTimerProc)
end;

procedure AutoShowTimerProc(Wnd: HWND; Msg: UINT; TimerID: UINT_PTR;
  SysTime: DWORD); stdcall;
var
  AControl: TdxDockSite;
begin
...
begin
  if not IsDestroying and (FShowingTimerID = 0) then
    FShowingTimerID := dxSetTimer(Handle, 3, ControllerAutoShowInterval,
      AutoShowTimerProc)
end;
...
var
  ...
  APoint: TPoint;
begin
  if Controller.IsDocking or Controller.IsResizing or (MovingControl <> nil)
  then
    Exit;
  if ShowingControl <> nil then
  begin
    ...
    if not(((AControl = Self) and (GetHideBarAtPos(ScreenToClient(APoint)) <>
      nil)) or ((AControl <> nil) and
      (AControl.AutoHideControl = ShowingControl)) or
      (not(doHideAutoHideIfActive in ControllerOptions) and
      (Controller.ActiveDockControl <> nil) and
...
begin
  ...
  if (FShowingControlCandidate <> nil) and (FShowingControlCandidate = AControl)
    and not(disContextMenu in Controller.FInternalState) then
  begin
...
function TdxDockSite.GetDesignHitTest(const APoint: TPoint;
  AShift: TShiftState): Boolean;
begin
  Result := inherited GetDesignHitTest(APoint, AShift) or
...
begin
  if not((AComponent is TdxCustomDockControl) or
    (AComponent is TdxDockSiteAutoHideContainer)) then
  begin
    if AComponent is TControl then
      (AComponent as TControl).Parent := ParentForm;
    raise EdxException.CreateFmt(sdxInvalidSiteChild, [AComponent.ClassName]);
...
begin
  ...
  begin
    AControl.ResizeZones.RegisterResizeZone(Self, AControl,
      TdxAutoSizeRightZone, ControllerResizeZonesWidth);
    AControl.ResizeZones.RegisterResizeZone(Self, AControl, TdxAutoSizeLeftZone,
      ControllerResizeZonesWidth);
    AControl.ResizeZones.RegisterResizeZone(Self, AControl,
      TdxAutoSizeBottomZone, ControllerResizeZonesWidth);
    AControl.ResizeZones.RegisterResizeZone(Self, AControl, TdxAutoSizeTopZone,
      ControllerResizeZonesWidth);
  end
  else
...
procedure TdxDockSite.UpdateControlDockZones(AControl: TdxCustomDockControl;
  AZoneWidth: Integer);
begin
  if AutoSize then
  begin
    if not AControl.DockZones.RegisterDockZone(Self, AControl,
      TdxAutoSizeClientZone, AZoneWidth) then
      AControl.DockZones.RegisterDockZone(Self, AControl,
        TdxInvisibleAutoSizeClientZone, AZoneWidth);
  end
  else
  begin
    if not AControl.DockZones.RegisterDockZone(Self, AControl, TdxClientZone,
...
procedure TdxDockSite.CreateLayout(AControl: TdxCustomDockControl;
  AType: TdxDockingType; Index: Integer);
var
  AWidth, AHeight: Integer;
begin
...
procedure TdxDockSite.SaveLayoutToCustomIni(AIniFile: TCustomIniFile;
  ASection: string);
begin
  WriteAllowDockingTypes(AIniFile, ASection, 'AllowDockClients',
    AllowDockClients);
...
begin
  ...
  begin
    ...
    else if not Sender.Visible and not HasAutoHideControls then
      UpdateAutoSizeBounds(FOriginalWidth, FOriginalHeight)
    else if HasAutoHideControls then
    begin
...
begin
  if not AutoSize and (AControl <> Self) then
    inherited
  else if (AControl <> Self) and (AControl.UpdateVisibilityLock = 0) and
...
constructor TdxDockControlButtonsController.Create(ADockControl
  : TdxCustomDockControl);
begin
  inherited Create;
  FDockControl := ADockControl;
...
function TdxDockControlButtonsController.HitTest(const P: TPoint)
  : TdxCustomDockControlButton;
var
  I: Integer;
begin
...
procedure TdxDockControlButtonsController.RegisterButton
  (AButton: TdxCustomDockControlButton);
begin
  FButtonsList.Add(AButton);
end;

procedure TdxDockControlButtonsController.UnregisterButton
  (AButton: TdxCustomDockControlButton);
begin
  FButtonsList.Remove(AButton);
end;

function TdxDockControlButtonsController.GetButton(Index: Integer)
  : TdxCustomDockControlButton;
begin
...
procedure TdxDockControlButtonsController.SetHotButton
  (AValue: TdxCustomDockControlButton);
begin
...
procedure TdxDockControlButtonsController.SetPressedButton
  (AValue: TdxCustomDockControlButton);
begin
...
begin
  Painter.DrawCaptionCloseButton(ACanvas, Bounds,
    DockControl.IsCaptionActive, State);
end;
...
begin
  Painter.DrawCaptionHideButton(ACanvas, Bounds, DockControl.IsCaptionActive,
    DockControl.AutoHide, State);
end;
...
begin
  Painter.DrawCaptionMaximizeButton(ACanvas, Bounds,
    DockControl.IsCaptionActive, (DockControl.SideContainer <> nil) and
    (DockControl = DockControl.SideContainer.ActiveChild), State);
end;
...
function TdxDockControlCaptionButtons.GetItem(Index: Integer)
  : TdxDockControlCaptionButton;
begin
  Result := TdxDockControlCaptionButton(inherited Items[Index]);
end;

procedure TdxDockControlCaptionButtons.SetItem(Index: Integer;
  Value: TdxDockControlCaptionButton);
begin
...
function TdxDockControlCustomCaptionButtons.CreateButtons
  : TdxDockControlCaptionButtons;
begin
  Result := TdxDockControlCaptionButtons.Create(Self,
    TdxDockControlCaptionButton);
end;
...
procedure TdxDockControlCustomCaptionButtons.DoFreeNotification
  (Sender: TComponent);
begin
...
procedure TdxDockControlCustomCaptionButtons.SetButtons
  (AValue: TdxDockControlCaptionButtons);
begin
  FButtons.Assign(AValue);
end;

procedure TdxDockControlCustomCaptionButtons.SetImages
...
constructor TdxDockControlCustomButton.Create(AController
  : TdxDockControlButtonsController; AButton: TdxDockControlCaptionButton);
begin
...
begin
  Painter.DrawCaptionButton(ACanvas, Bounds,
    DockControl.IsCaptionActive, State);
  cxDrawImage(ACanvas, Bounds, nil, Images, Button.ImageIndex, ifmNormal,
    ImageStateMap[Enabled], True, GetColorPalette, DockControl.ScaleFactor);
end;
...
begin
  ...
  then
    ...
    begin
      AControl.ResizeZones.RegisterZone
        (TdxHorizContainerZone.Create(AControl.SideContainerItem,
        ControllerResizeZonesWidth, zkResizing));
    end;
end;

procedure TdxHorizContainerDockSite.UpdateControlOriginalSize
  (AControl: TdxCustomDockControl);
begin
...
function TdxHorizContainerDockSite.GetDimension(AWidth,
  AHeight: Integer): Integer;
begin
  Result := AWidth;
end;
...
procedure TdxHorizContainerDockSite.SetDimension(var AWidth, AHeight: Integer;
  AValue: Integer);
begin
  AWidth := AValue;
end;
...
procedure TdxHorizContainerDockSite.SetSize(Index: Integer;
  const Value: Integer);
begin
  Children[Index].Width := Value;
end;

procedure TdxHorizContainerDockSite.SetPosition(Index: Integer;
  const Value: Integer);
begin
...
begin
  FDockSite := ADockSite;
  if not(FDockSite.IsDesigning and FDockSite.IsLoadingFromForm) then
  // Anchors bug - see TdxFloatDockSite.Loaded
...
begin
  ...
  with Params do
    ...
    begin
      if Application.MainFormOnTaskBar and (ParentForm <> Application.MainForm)
      then
...
begin
  if not Visible then
    ...
    SetWindowPos(Handle, ParentForm.Handle, 0, 0, 0, 0, SWP_NOSIZE or
...
begin
  if (Message.HitTest = HTCAPTION) and not IsIconic(Handle) and (DockSite <> nil)
  then
  begin
    SendMessage(DockSite.Handle, WM_MOUSEACTIVATE, 0, 0);
    SetWindowPos(Handle, 0, 0, 0, 0, 0, SWP_NOZORDER or SWP_NOMOVE or
      SWP_NOSIZE);
    SendMessage(Handle, WM_NCLBUTTONUP, TMessage(Message).WParam,
...
begin
  if not IsDesigning and (Message.HitTest = HTCAPTION) and not IsIconic(Handle)
    and (DockSite <> nil) and (doDblClickDocking in DockSite.ControllerOptions)
  then
...
procedure TdxDockSiteAutoHideContainer.AlignControls(AControl: TControl;
  var Rect: TRect);
...
begin
  dxTestCheck(ControlCount <= 1,
    'TdxDockSiteAutoHideContainer.ControlCount > 1');
...
procedure TdxDockSiteAutoHideContainer.CMControlListChange
...
begin
  ...
  begin
    ...
    try
      ...
      FButtonSectionTopIndex := Min(ButtonSectionTopIndex,
        ButtonSectionMaxTopIndex);
      ScrollUpButton.Enabled := ButtonSectionTopIndex <
        ButtonSectionMaxTopIndex;
...
procedure TdxDockSiteHideBar.CalculateButton(var R: TRect;
  AButton: TdxDockSiteHideBarButton);
begin
...
procedure TdxDockSiteHideBar.CreateAutoHideContainer
  (AControl: TdxCustomDockControl);
var
...
function TdxDockSiteHideBar.CreateScrollButton(ADirection: Integer)
  : TdxDockSiteHideBarScrollButton;
begin
...
procedure TdxDockSiteHideBar.DestroyAutoHideContainer
  (AControl: TdxCustomDockControl);
var
  AContainer: TdxDockSiteAutoHideContainer;
begin
...
function TdxDockSiteHideBar.IndexOfDockControl
  (AControl: TdxCustomDockControl): Integer;
begin
  Result := Buttons.IndexOfDockControl(AControl);
end;

procedure TdxDockSiteHideBar.RegisterDockControl
  (AControl: TdxCustomDockControl);
begin
...
procedure TdxDockSiteHideBar.UnregisterDockControl
  (AControl: TdxCustomDockControl);
begin
...
function TdxDockSiteHideBar.GetControlAtPos(const P: TPoint;
  var ASubControl: TdxCustomDockControl): TdxCustomDockControl;
var
  I: Integer;
begin
  Result := nil;
...
function TdxDockSiteHideBar.GetButtonSectionSize(ADockControl
  : TdxCustomDockControl; AExpanded: Boolean = True): Integer;
var
  ADockSite: TdxTabContainerDockSite;
  AIndent: Integer;
  ATabWidth: Integer;
...
function TdxDockSiteHideBar.GetDockControl(Index: Integer)
  : TdxCustomDockControl;
begin
...
function TdxDockSiteHideBarButton.HitTest(const P: TPoint;
  out ADockControl: TdxCustomDockControl): Boolean;
var
  I: Integer;
begin
...
begin
  if Sections.Count > 0 then
    Result := cxRectUnion(Sections[0].Bounds,
      Sections[Sections.Count - 1].Bounds)
  else
    Result := cxNullRect
end;
...
function TdxDockSiteHideBarButtonsList.Add(ADockControl: TdxCustomDockControl)
  : TdxDockSiteHideBarButton;
begin
...
function TdxDockSiteHideBarButtonsList.IndexOfDockControl
...
function TdxDockSiteHideBarButtonsList.GetSections
  : TdxDockSiteHideBarButtonSectionList;

  procedure DoAddSections(AList: TdxDockSiteHideBarButtonSectionList;
    AButton: TdxDockSiteHideBarButton);
  var
    I: Integer;
  begin
...
function TdxDockSiteHideBarButtonsList.GetItem(AIndex: Integer)
  : TdxDockSiteHideBarButton;
begin
...
function TdxDockSiteHideBarButtonSectionList.First
  : TdxDockSiteHideBarButtonSection;
begin
  Result := Items[0];
end;

function TdxDockSiteHideBarButtonSectionList.Last
  : TdxDockSiteHideBarButtonSection;
begin
  Result := Items[Count - 1];
end;

function TdxDockSiteHideBarButtonSectionList.GetItem(Index: Integer)
  : TdxDockSiteHideBarButtonSection;
begin
...
const
  ArrowMap: array [Boolean, Boolean] of TcxArrowDirection = ((adRight, adDown),
    (adLeft, adUp));
begin
...
function TdxZoneList.FindZone(AOwnerControl: TdxCustomDockControl;
  AType: TdxDockingType): TdxZone;
var
  AZone: TdxZone;
  I: Integer;
...
function TdxZoneList.RegisterDockZone(AOwnerControl,
  AControl: TdxCustomDockControl; AZoneClass: TdxZoneClass;
  AZoneWidth: Integer): Boolean;
begin
...
function TdxZoneList.RegisterResizeZone(AOwnerControl,
  AControl: TdxCustomDockControl; AZoneClass: TdxZoneClass;
  AZoneWidth: Integer): Boolean;
begin
...
begin
  if ASections.Count > 0 then
    Buttons.Scroll(ASections.First.Bounds.Left - ASections
      [ButtonSectionTopIndex].Bounds.Left, 0);
end;

procedure TdxDockSiteTopHideBar.CalculateMultiSectionButton(var R: TRect;
  AButton: TdxDockSiteHideBarButton);
var
  ADockSite: TdxTabContainerDockSite;
  AExpanded: Boolean;
...
procedure TdxDockSiteTopHideBar.CalculateSingleSectionButton(var R: TRect;
  AButton: TdxDockSiteHideBarButton);
begin
  AButton.AddSection(cxRectSetWidth(R, GetButtonSectionSize(AButton.DockControl)
    ), AButton.DockControl);
  R.Left := AButton.Bounds.Right + GetHideBarHorzInterval;
end;

procedure TdxDockSiteTopHideBar.CalculateScrollButtons
  (const AButtonsFullRect: TRect);
var
  ASize: TSize;
  R: TRect;
begin
  ScrollUpButton.Visible := cxRectWidth(AButtonsFullRect) >
    cxRectWidth(ContentRect);
  ScrollDownButton.Visible := ScrollUpButton.Visible;
  if ScrollUpButton.Visible then
  begin
    ASize := Painter.GetHideBarScrollButtonSize;
...
begin
  Result := ContentRect;
  if ScrollDownButton.Visible then
    Result.Right := ScrollDownButton.Bounds.Left -
      Painter.GetHideBarHorizInterval;
end;
...
begin
  Result := (Owner.MovingContainer.Height >=
    Owner.MovingControl.OriginalHeight);
end;

procedure TdxDockSiteTopHideBar.SetFinalPosition
  (AControl: TdxCustomDockControl);
begin
  AControl.AutoHideContainer.SetBounds(Owner.GetClientLeft, Owner.GetClientTop,
    Owner.GetClientWidth, AControl.OriginalHeight);
...
procedure TdxDockSiteTopHideBar.SetInitialPosition
  (AControl: TdxCustomDockControl);
begin
  AControl.AutoHideContainer.SetBounds(Owner.GetClientLeft, Owner.GetClientTop,
...
begin
  if (ADelta > 0) and (Owner.MovingContainer.Height + ADelta >
    ...
    Owner.MovingContainer.Height := Owner.MovingContainer.Height + ADelta;
end;

procedure TdxDockSiteTopHideBar.UpdateOwnerAutoSizeBounds
  (AControl: TdxCustomDockControl);
var
  AHeight: Integer;
begin
...
procedure TdxFloatDockSite.SetFloatFormPosition(ALeft, ATop: Integer);
  ...
  begin
    ...
    ALeft := Max(Min(ALeft, ADesktopWorkArea.Right - FloatForm.Width),
      ADesktopWorkArea.Left);
    ATop := Max(Min(ATop, ADesktopWorkArea.Bottom - FloatForm.Height),
      ADesktopWorkArea.Top);
...
begin
  ...
  if IsDesigning and IsLoadingFromForm then
  // Anchors bug - see TdxFloatForm.InsertDockSite
...
procedure TdxFloatDockSite.UpdateControlDockZones
  (AControl: TdxCustomDockControl; AZoneWidth: Integer);
begin
  if doUseCaptionAreaToClientDocking in ControllerOptions then
  begin
...
procedure TdxFloatDockSite.UpdateControlOriginalSize
  (AControl: TdxCustomDockControl);
begin
...
function TdxFloatDockSite.CanDockHost(AControl: TdxCustomDockControl;
  AType: TdxDockingType): Boolean;
begin
  Result := False;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      else if (Result as TdxSideContainerDockSite).ValidChildCount > 0 then
        Result := (Result as TdxSideContainerDockSite).ValidChildren[0]
      else
        Result := nil;
    end
    else if Result is TdxContainerDockSite then
...
begin
  ...
  FOriginalHeight := ReadScaledValue(AIniFile, ASection, 'Height',
    APixelsPerInch, Height);
  FOriginalWidth := ReadScaledValue(AIniFile, ASection, 'Width',
    APixelsPerInch, Width);
...
RegisterClasses([TdxLayoutDockSite, TdxContainerDockSite,
