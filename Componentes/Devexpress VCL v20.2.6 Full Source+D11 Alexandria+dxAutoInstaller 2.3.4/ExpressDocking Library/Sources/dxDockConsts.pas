...
resourcestring
  ...
  sdxInvalidFloatingDeleting =
    'You cannot delete a TdxCustomDockSite in floating mode.';
  sdxInvalidParentAssigning = 'You cannot set the parent for this component.';
  sdxInvalidOwner =
    'The Owner of the TdxCustomDockControl must be TCustomForm.';
  sdxInvalidParent = 'The Parent of the %s must be TdxCustomDockControl.';
  sdxInvalidDockSiteParent =
    'The Parent of the TdxDockSite cannot be TdxCustomDockControl.';
  sdxInvalidFloatSiteParent =
    'The Parent of the TdxFloatDockSite can only be TdxFloatForm.';
  sdxInvalidPanelChild =
    'You cannot insert a TdxCustomDockControl into TdxDockPanel (%s is being inserted).';
  sdxInvalidSiteChild =
    'You can only insert a TdxCustomDockControl into TdxCustomDockSite (%s is being inserted).';
  sdxInvalidZoneOwner =
    'You cannot create a TdxZone without the owning TdxCustomDockControl.';
  sdxInternalErrorAutoHide = 'Internal error while auto-hide controls.';
  sdxInternalErrorPainter =
    'Internal error in the TdxCustomDockControl painter.';
  sdxInternalErrorLayout = 'Internal error in the %s object layout.';
  sdxInternalErrorCreateLayout =
    'Internal error while creating a %s object layout.';
  sdxInternalErrorDestroyLayout =
    'Internal error while destroying a %s object layout.';
  sdxManagerError =
    'You cannot have more than one TdxDockingManager instance on a Form.';
  sdxAncestorError =
    'Docking and auto hiding operations are not available for controls declared in an ancestor form.';

const
  sdxManagerOwnerError =
    'Redundant TdxDockingManager component declaration found.' + dxCRLF +
...
procedure AddExpressDockingResourceStringNames
...
dxResourceStringsRepository.RegisterProduct('ExpressDocking',
  @AddExpressDockingResourceStringNames);
