...
uses
  Classes, cxGridCustomTableView, cxGridWinExplorerView,
...
type
  ...
  published
    property DataBinding: TcxGridItemDBDataBinding read GetDataBinding
  ...
  public
    ...
    property Items[Index: Integer]: TcxGridDBWinExplorerViewItem read GetItem
      write SetItem;
  published
...
procedure TcxGridDBWinExplorerViewItem.SetDataBinding
  (Value: TcxGridItemDBDataBinding);
begin
...
function TcxGridDBWinExplorerView.GetItem(Index: Integer)
  : TcxGridDBWinExplorerViewItem;
begin
  Result := TcxGridDBWinExplorerViewItem(inherited Items[Index]);
end;

procedure TcxGridDBWinExplorerView.SetDataController
  (Value: TcxGridDBDataController);
begin
  FDataController.Assign(Value);
end;

procedure TcxGridDBWinExplorerView.SetItem(Index: Integer;
  Value: TcxGridDBWinExplorerViewItem);
begin
  inherited Items[Index] := Value;
end;

function TcxGridDBWinExplorerView.GetDataControllerClass
...
function TcxGridDBWinExplorerView.GetItemByFieldName(const AFieldName: string)
  : TcxGridDBWinExplorerViewItem;
begin
  Result := TcxGridDBWinExplorerViewItem
