...
type
  ...
  TcxGridWizardChartViewOptionsViewSettingsPageFrame = class
...
begin
  lbDataGroupOptions.Caption := cxGetResourceString
    (@scxGridWizardOptionCaptionDataGroupOptions);
  chbDataGroupHiding.Caption := cxGetResourceString
    (@scxGridWizardOptionCaptionDataGroupHiding);
  chbDataGroupMoving.Caption := cxGetResourceString
    (@scxGridWizardOptionCaptionDataGroupMoving);
  lbCustomizationOptions.Caption :=
    cxGetResourceString(@scxGridWizardOptionCaptionCustomizationOptions);
  chbOptionsCustomization.Caption :=
    cxGetResourceString(@scxGridWizardOptionCaptionOptionsCustomization);
  chbSeriesCustomization.Caption :=
    cxGetResourceString(@scxGridWizardOptionCaptionSeriesCustomization);
  chbCustomizeButton.Caption := cxGetResourceString
    (@scxGridWizardOptionCaptionToolBoxCustomizeButton);
  lbOther.Caption := cxGetResourceString(@scxgwCommonGroupCaptionOthers);
  chbDataDrillDown.Caption := cxGetResourceString
    (@scxGridWizardOptionCaptionDataDrillDown);
  chbAntialiasing.Caption := cxGetResourceString
    (@scxGridWizardOptionCaptionAntialiasing);
  chbTransparentCaptions.Caption :=
    cxGetResourceString(@scxGridWizardOptionCaptionTransparentCaption);
end;
...
begin
  ...
  AView.OptionsCustomize.OptionsCustomization :=
    chbOptionsCustomization.Checked;
...
function TcxGridWizardChartViewOptionsViewSettingsPageFrame.
...
begin
  Result := cxGetResourceString
    (@scxGridWizardChartViewOptionsViewSettingsPageTitle);
end;

{ Events }

procedure TcxGridWizardChartViewOptionsViewSettingsPageFrame.RefreshPreviewGrid
  (Sender: TObject);
begin
