...
type
  ...
  protected
    function GetCardViewFromParameter(const AParameter
      : TcxCustomGridOperationHelperParameters): TcxGridCardView;
    procedure RegisterOperations; override;
    procedure DoLayoutDirection(const AParameter
...
function TcxGridCardViewOperationHelper.GetCardViewFromParameter
  (const AParameter: TcxCustomGridOperationHelperParameters): TcxGridCardView;
begin
...
procedure TcxGridCardViewOperationHelper.DoLayoutDirection(const AParameter
  : TcxCustomGridOperationHelperParameters);
const
  BoolToLayoutDirection: Array [Boolean] of TcxGridCardViewLayoutDirection =
    (ldHorizontal, ldVertical);
  LayoutDirectionToBool: Array [TcxGridCardViewLayoutDirection] of Boolean =
    (False, True);
begin
  If AParameter.IsPerform then
    ...
    SetShowProperty(AParameter, LayoutDirectionToBool
      [GetCardViewFromParameter(AParameter).LayoutDirection]);
end;

procedure TcxGridCardViewOperationHelper.DoShowColumnsCustomizing
  (const AParameter: TcxCustomGridOperationHelperParameters);
begin
  if AParameter.IsPerform then
    GetCardViewFromParameter(AParameter).Controller.Customization :=
      GetShowProperty(AParameter)
  else
    SetShowProperty(AParameter, GetCardViewFromParameter(AParameter)
      .Controller.Customization);
end;

class function TcxGridCardViewOperationHelper.GetViewClass
