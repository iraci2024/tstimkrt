...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Variants, Windows, Messages, Classes, Graphics, Controls, Forms, Menus,
  StdCtrls,
  dxCore, dxCoreClasses, cxClasses, cxGraphics, cxLookAndFeels,
  cxLookAndFeelPainters,
  cxStyles, cxControls, cxStorage, cxEdit, cxCheckBox, cxCheckListBox,
  cxDropDownEdit,
...
type
  ...
  TcxGridChartLineDiagramValueViewInfoClass = class of
  ...
  TcxGridChartPartPosition = (cppDefault, cppNone, cppLeft, cppTop, cppRight,
    cppBottom);
  ...
  TcxGridChartLineDiagramValueCaptionPosition = (ldvcpNone, ldvcpLeft,
    ldvcpAbove, ldvcpRight, ldvcpBelow, ldvcpCenter, ldvcpAboveRight,
    ldvcpBelowRight, ldvcpAboveLeft, ldvcpBelowLeft);
  TcxGridChartLineStyle = (clsNone, clsSolid, clsDash, clsDot, clsDashDot,
    clsDashDotDot);
  TcxGridChartMarkerStyle = (cmsNone, cmsSquare, cmsTriangle, cmsDiamond,
    cmsCircle);
  ...
  public
    ...
    property DataLevelObject: TcxGridChartDataGroup read FDataLevelObject
      write SetDataLevelObject;
  end;
  ...
  TcxGridChartPieSeriesSiteCaptionHitTest = class
  ...
  protected
    ...
    property CustomizationForm: TcxGridChartCustomizationForm
  ...
  TcxGridChartDataGroupMovingObjectClass = class of
  ...
  protected
    ...
    property SourceItem: TcxGridChartDataGroup read GetSourceItem
      write SetSourceItem;
  ...
  protected
    ...
    procedure DrawSeriesImage(ACanvas: TcxCanvas; const R: TRect;
      ASeries: TcxGridChartSeries); virtual;
    function GetInnerCheckListBoxClass
      : TcxCustomInnerCheckListBoxClass; override;
    procedure LookAndFeelChanged(Sender: TcxLookAndFeel;
      AChangedValues: TcxLookAndFeelValues); override;
    procedure RefreshImages;
    procedure RefreshSeriesImages; virtual;

    property DraggingSeries: TcxGridChartSeries read FDraggingSeries
      write FDraggingSeries;
    property GridView: TcxGridChartView read FGridView;
    property LockRefreshItems: Boolean read FLockRefreshItems
      write FLockRefreshItems;
    property Series[AIndex: Integer]: TcxGridChartSeries read GetSeries;
    property SeriesImages: TImageList read FSeriesImages;
  public
    constructor Create(AOwner: TComponent; AGridView: TcxGridChartView);
      reintroduce; virtual;
  ...
  TcxGridChartSortBySeriesComboBoxClass = class of
  ...
  protected
    ...
    function GetDataGroupsListBoxClass
      : TcxGridChartDataGroupsListBoxClass; virtual;
    ...
    function GetSeriesCheckListBoxClass
      : TcxGridChartSeriesCheckListBoxClass; virtual;
    function GetSeriesPageVisible: Boolean; virtual;
    function GetSortBySeriesComboBoxClass
      : TcxGridChartSortBySeriesComboBoxClass; virtual;
  ...
  public
    ...
    property DataGroupsListBox: TcxGridChartDataGroupsListBox
      read FDataGroupsListBox;
    ...
    property SeriesCheckListBox: TcxGridChartSeriesCheckListBox
      read FSeriesCheckListBox;
    property SeriesPage: TcxTabSheet read FSeriesPage;
    property SortBySeriesComboBox: TcxGridChartSortBySeriesComboBox
      read FSortBySeriesComboBox;
    property SortBySeriesLabel: TcxLabel read FSortBySeriesLabel;
  end;

  // popups

  IcxGridChartDataLevelActiveValuePopupOwner = interface
    (IcxCustomGridPopupOwner)
    ['{94AE5C9F-9A81-401D-8B76-E3278CDD0CEB}']
    function GetDataGroup: TcxGridChartDataGroup;
  end;

  TcxGridChartDataLevelActiveValuePopupClass = class of
  ...
  TcxGridChartDiagramSelectorPopupClass = class of
  ...
  private
    ...
    function GetCustomizationForm: TcxGridChartCustomizationForm;
    function GetDataLevelActiveValuePopup
      : TcxGridChartDataLevelActiveValuePopup;
  ...
  protected
    procedure ActiveDataLevelChanged(APrevActiveDataLevel, AActiveDataLevel
      : Integer); virtual;
    ...
    function GetDataLevelActiveValuePopupClass
      : TcxGridChartDataLevelActiveValuePopupClass; virtual;
    function GetDesignHitTest(AHitTest: TcxCustomGridHitTest): Boolean;
      override;
    function GetDiagramSelectorPopupClass
      : TcxGridChartDiagramSelectorPopupClass; virtual;
    ...
    function MayDataDrillDown(ACheckDesignTime: Boolean = True)
      : Boolean; virtual;
    ...
    function CanShowDataLevelActiveValuePopup(ACheckDesignTime: Boolean = True)
      : Boolean; virtual;
    ...
    function GetDataLevelInfoDragAndDropObjectClass
      : TcxGridChartDataGroupMovingObjectClass; virtual;
  ...
  public
    ...
    function GetValueHintText(ASeries: TcxGridChartSeries; AValueIndex: Integer)
      : string; virtual;
    ...
    property FirstVisibleCategoryIndex: Integer
      read GetFirstVisibleCategoryIndex write SetFirstVisibleCategoryIndex;
    property VisibleCategoryCount: Integer read GetVisibleCategoryCountValue;

    property CustomizationForm: TcxGridChartCustomizationForm
      read GetCustomizationForm;
    property DataLevelActiveValuePopup: TcxGridChartDataLevelActiveValuePopup
      read GetDataLevelActiveValuePopup;
    property DiagramSelectorPopup: TcxGridChartDiagramSelectorPopup
      read GetDiagramSelectorPopup;
    property GridView: TcxGridChartView read GetGridView;
...
{$HPPEMIT '__interface IcxGridChartItem;'}
  ...
  IcxGridChartViewItemsProvider = interface
    ...
    function GetItem(AItemClass: TcxGridChartItemClass; AIndex: Integer)
      : TcxGridChartItem;
    procedure GetItemCaptions(AItemClass: TcxGridChartItemClass;
      ACaptions: TStringList);
    procedure InitItem(AItem: TcxGridChartItem; AIndex: Integer);
  end;

  TcxGridChartDataController = class(TcxDataController,
  ...
  published
    property Options;
    property OnAfterSummary: TcxAfterSummaryEvent read GetOnAfterSummary
      write SetOnAfterSummary;
    property OnCompare;
  ...
  public
    ...
    property SmoothingMode: TdxGPSmoothingMode read FSmoothingMode
      write FSmoothingMode;
  end;
  ...
  protected
    ...
    procedure PrepareClipRegionForValueDrawing(AValueViewInfo
  ...
  protected
    ...
    procedure DrawContent; override;
  public
    property ViewInfo: TcxGridChartHistogramTickMarkLabelsViewInfo
      read GetViewInfo;
  end;
  ...
  TcxGridChartLineDiagramLegendItemPainter = class
  ...
  protected
    ...
    property ViewInfo: TcxGridChartLineDiagramLegendItemViewInfo
      read GetViewInfo;
  end;

  TcxGridChartLineDiagramValuePainterClass = class of
  ...
  public
    class procedure DrawLineEx(ACanvas: TcxCanvas;
      const AStart, AFinish: TPoint; AStyle: TcxGridChartLineStyle;
      AWidth: Integer; AColor: TColor; Antialiasing: Boolean); virtual;
    class procedure DrawLines(ACanvas: TcxCanvas; const APoints: TPoints;
      AStyle: TcxGridChartLineStyle; AWidth: Integer; AColor: TColor;
      Antialiasing: Boolean); virtual;
  ...
  TcxGridChartAreaDiagramLegendItemPainter = class
  ...
  TcxGridChartAreaDiagramValuePainter = class
    (TcxGridChartLineDiagramValuePainter)
  private
  ...
  TcxGridChartToolBoxDataLevelActiveValuePainter = class
    (TcxCustomGridCellPainter)
  private
    function GetViewInfo: TcxGridChartToolBoxDataLevelActiveValueViewInfo;
  protected
    procedure PrepareCanvasForDrawText; override;
    property ViewInfo: TcxGridChartToolBoxDataLevelActiveValueViewInfo
      read GetViewInfo;
  end;
  ...
  protected
    procedure Paint; override;
    property ViewInfo: TcxGridChartToolBoxCustomizeButtonViewInfo
      read GetViewInfo;
  end;
  ...
  protected
    ...
    procedure PrepareCanvasForDrawText; override;
    property ViewInfo: TcxGridChartToolBoxDiagramSelectorViewInfo
      read GetViewInfo;
  end;
  ...
  private
    ...
    function GetVisibleGroupValue(AVisibleDataGroupIndex,
      AIndex: Integer): Variant;
    function GetVisibleGroupValueCount(AVisibleDataGroupIndex: Integer)
      : Integer;
    ...
    procedure SetGroupValue(ADataGroupIndex, AIndex: Integer;
      const Value: Variant);
  ...
  protected
    ...
    property ChildDataGroupIndex[Index: Integer]: Integer
      read GetChildDataGroupIndex;
  ...
  public
    constructor Create(AGridView: TcxCustomGridView); override;
    procedure GetVisibleGroupValues(ADataGroup: TcxGridChartDataGroup;
    ...
    property GroupValues[ADataGroupIndex, AIndex: Integer]: Variant
      read GetGroupValue write SetGroupValue;
    property Values[ASeriesIndex, AIndex: Integer]: Variant read GetValue
      write SetValue;

    // visible values
    property IsEmptyValue[ASeriesIndex, AIndex: Integer]: Boolean
      read GetIsEmptyValue;
    property VisibleCategories[AIndex: Integer]: Variant
      read GetVisibleCategory;
    property VisibleCategoryCount: Integer read GetVisibleCategoryCount;
    property VisibleValues[ASeriesIndex, AIndex: Integer]: Variant
      read GetVisibleValue;

    property VisibleGroupValueCount[AVisibleDataGroupIndex: Integer]: Integer
      read GetVisibleGroupValueCount;
    property VisibleGroupValues[AVisibleDataGroupIndex, AIndex: Integer]
      : Variant read GetVisibleGroupValue;
  end;
  ...
  public
    ...
    constructor Create(AContainer: TcxGridChartLegendViewInfo; AIndex: Integer);
      reintroduce; virtual;
  ...
  public
    constructor Create(AGridViewInfo: TcxCustomGridViewInfo;
      ADiagram: TcxGridChartDiagram); reintroduce; virtual;
    destructor Destroy; override;
    ...
    procedure GetItemLegendKeyParams(AIndex: Integer;
  ...
  TcxGridChartDiagramValueCaptionViewInfoClass = class of
  ...
  public
    constructor Create(AValueViewInfo: TcxGridChartDiagramValueViewInfo);
      reintroduce; virtual;
    property ValueViewInfo: TcxGridChartDiagramValueViewInfo
      read FValueViewInfo;
  end;

  TcxGridChartDiagramValueViewInfoClass = class of
    TcxGridChartDiagramValueViewInfo;
  ...
  protected
    ...
    function GetCaptionViewInfoClass
      : TcxGridChartDiagramValueCaptionViewInfoClass; virtual;
  ...
  public
    ...
    function MouseDown(AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
      AShift: TShiftState): Boolean; override;
    property CaptionViewInfo: TcxGridChartDiagramValueCaptionViewInfo
      read FCaptionViewInfo;
  ...
  private
    ...
    function GetValueViewInfoValue(Index: Integer)
      : TcxGridChartDiagramValueViewInfo;
  ...
  protected
    ...
    function CreateValueViewInfo(ASeriesIndex, AVisibleValueIndex: Integer)
      : TcxGridChartDiagramValueViewInfo;
    function GetValue(ASeriesIndex, AIndex: Integer): Variant; virtual;
    function GetValueCaption(ASeriesIndex, AVisibleValueIndex: Integer)
      : string; virtual;
    function GetValueIndex(AVisibleValueIndex: Integer): Integer; virtual;
    class function GetValueViewInfoClass: TcxGridChartDiagramValueViewInfoClass;
      virtual; // abstract; - because of CLR, BCB
    function GetValueViewInfoIndex(ASeriesIndex, AVisibleIndex: Integer)
  ...
  public
    ...
    destructor Destroy; override;
    function GetHitTest(const P: TPoint): TcxCustomGridHitTest; override;
    function GetValueViewInfo(ASeriesIndex, AVisibleIndex: Integer)
      : TcxGridChartDiagramValueViewInfo;
    property Diagram: TcxGridChartDiagram read FDiagram;
    property GridView: TcxGridChartView read GetGridView;
    ...
    property ValueViewInfos[Index: Integer]: TcxGridChartDiagramValueViewInfo
      read GetValueViewInfoValue;
  ...
  public
    ...
    property DiagramViewInfo: TcxGridChartHistogramViewInfo
      read GetDiagramViewInfo;
    property ValueDirection: TcxDirection read GetValueDirection;
  end;

  TcxGridChartHistogramAxisTitleViewInfoClass = class of
    TcxGridChartHistogramAxisTitleViewInfo;

  TcxGridChartHistogramAxisTitleViewInfo = class
  ...
  public
    constructor Create(AContainer: TcxGridChartHistogramTickMarkLabelsViewInfo;
      ATitle: TcxCustomGridChartTitle); reintroduce; virtual;
    property Container: TcxGridChartHistogramTickMarkLabelsViewInfo
      read FContainer;
  ...
  protected
    ...
    function GetTitleViewInfoClass
      : TcxGridChartHistogramAxisTitleViewInfoClass; virtual;
    ...
    function CalculateHeight(AWidth, ALeftReduction, ARightReduction: Integer)
      : Integer; { overload; } reintroduce; virtual;
    function CalculateWidth: Integer; override;
    function CalculateIsTwoRowLayout(AWidth, ALeftReduction, ARightReduction
      : Integer): Boolean; virtual;
    procedure CalculateTitleBounds(out ATitleBounds, AContentBounds
      : TRect); virtual;
    function GetAlignmentHorz: TAlignment; override;
    ...
    procedure GetEdgeCaptionsReductions(var ALeftReduction, ARightReduction
      : Integer); virtual;
  ...
  public
    constructor Create(ADiagramViewInfo: TcxGridChartHistogramViewInfo);
      reintroduce; virtual;
    destructor Destroy; override;
    procedure Calculate(ALeftBound, ATopBound: Integer; AWidth: Integer = -1;
      AHeight: Integer = -1); override;
    procedure FitCaptionsHorz(AWidth: Integer;
      var ALeftReduction, ARightReduction: Integer); virtual;
    procedure FitCaptionsVert(var ATopReduction, ABottomReduction
      : Integer); virtual;
    function GetCaptionSpace(AWidth, ALeftReduction, ARightReduction: Integer)
      : Integer; virtual;
    function GetHitTest(const P: TPoint): TcxCustomGridHitTest; override;

    property CaptionBounds[Index: Integer]: TRect read GetCaptionBounds
      write SetCaptionBounds;
    property Captions[Index: Integer]: string read GetCaption;
    property CaptionsVisible: Boolean read GetCaptionsVisible;
    property Count: Integer read GetCount;
    property DiagramViewInfo: TcxGridChartHistogramViewInfo
      read FDiagramViewInfo;
    property Position: TcxGridChartAxisPosition read GetPosition;
    property TitleViewInfo: TcxGridChartHistogramAxisTitleViewInfo
      read FTitleViewInfo;
    property Values[Index: Integer]: Variant read GetValue;
  end;

  TcxGridChartHistogramCategoryAxisTitleViewInfo = class
    (TcxGridChartHistogramAxisTitleViewInfo)
  protected
    function GetHitTestClass: TcxCustomGridHitTestClass; override;
  end;

  TcxGridChartHistogramCategoryTickMarkLabelsViewInfoClass = class of
    TcxGridChartHistogramCategoryTickMarkLabelsViewInfo;

  TcxGridChartHistogramCategoryTickMarkLabelsViewInfo = class
    (TcxGridChartHistogramTickMarkLabelsViewInfo)
  protected
    function GetTitleViewInfoClass
      : TcxGridChartHistogramAxisTitleViewInfoClass; override;
  ...
  TcxGridChartHistogramValueAxisTitleViewInfo = class
    (TcxGridChartHistogramAxisTitleViewInfo)
  protected
    function GetHitTestClass: TcxCustomGridHitTestClass; override;
  end;

  TcxGridChartHistogramValueTickMarkLabelsViewInfoClass = class of
    TcxGridChartHistogramValueTickMarkLabelsViewInfo;

  TcxGridChartHistogramValueTickMarkLabelsViewInfo = class
    (TcxGridChartHistogramTickMarkLabelsViewInfo)
  private
  ...
  private
    FCategoryTickMarkLabelsViewInfo
      : TcxGridChartHistogramCategoryTickMarkLabelsViewInfo;
  ...
  protected
    function GetCategoryTickMarkLabelsViewInfoClass
      : TcxGridChartHistogramCategoryTickMarkLabelsViewInfoClass; virtual;
    function GetPainterClass: TcxCustomGridCellPainterClass; override;
    function GetValueTickMarkLabelsViewInfoClass
      : TcxGridChartHistogramValueTickMarkLabelsViewInfoClass; virtual;

    procedure DoCalculateParams; override;
    procedure GetPlotBackgroundParams(out AParams: TcxViewParams); virtual;

    function GetCategoryDirection: TcxDirection; virtual;
    function GetCategoryTickMarkLabelOffsetUnits(AIndex: Integer): Integer;
      virtual; abstract;
    function GetCategoryTickMarkOffsetUnits(AIndex: Integer;
      AValueAxisBetweenCategories: Boolean): Integer; virtual; abstract;
    ...
    procedure CalculateMinMaxStackedValues(APercentage: Boolean;
      out AMinValue, AMaxValue: Extended; out AHasValuesOutOfRange: Boolean);
    procedure CalculateMinMaxVisualValues(out AMinVisualValue, AMaxVisualValue
      : Extended); virtual;
    function CalculateSumOfValues(AGroupIndex, AValueIndex: Integer)
      : Variant; virtual;
    ...
    function GetValueDirection(ASeriesIndex, AVisibleValueIndex: Integer)
      : TcxDirection; virtual;
    ...
    function IsValuePositive(ASeriesIndex, AVisibleValueIndex: Integer)
      : Boolean; virtual;
    function NeedsMinMaxValuesOffset: Boolean; virtual;

    procedure AddMark(var AMarks: TcxGridChartHistogramMarks;
    ...
    procedure CalculatePlotOffsets(APlotAreaWidth: Integer;
      var AOffsets: TRect); virtual;
    ...
    function GetTickMarkLabelsBounds(APosition: TcxGridChartAxisPosition)
      : TRect; virtual;
    ...
    property CategoryMarkValues[Index: Integer]: Integer
      read GetCategoryMarkValue;
    property HasValuesOutOfRange: Boolean read FHasValuesOutOfRange;
    property IsCategoriesInReverseOrder: Boolean
      read GetIsCategoriesInReverseOrder;
    ...
    property SumOfValues[AGroupIndex, AValueIndex: Integer]: Variant
      read GetSumOfValues;
  ...
  public
    ...
    constructor Create(AGridViewInfo: TcxCustomGridViewInfo;
      ADiagram: TcxGridChartDiagram); override;
    destructor Destroy; override;
    ...
    property CategoryAxisPosition: TcxGridChartAxisPosition
      read GetCategoryAxisPosition;
    property CategoryGridLineBounds[AIndex: Integer]: TRect
      read GetCategoryGridLineBounds;
    property CategoryGridLineColor: TColor read GetCategoryGridLineColor;
    property CategoryMarkBounds[Index: Integer]: TRect
      read GetCategoryMarkBounds;
    property CategoryTickMarkLabelsViewInfo
      : TcxGridChartHistogramCategoryTickMarkLabelsViewInfo
      read FCategoryTickMarkLabelsViewInfo;
    property CategoryMarkCount: Integer read GetCategoryMarkCount;
    property CategoryMarkPositions[Index: Integer]: Integer
      read GetCategoryMarkPosition write SetCategoryMarkPosition;
    property Diagram: TcxGridChartHistogram read GetDiagram;
    ...
    property ValueAxisPosition: TcxGridChartAxisPosition
      read GetValueAxisPosition;
    property ValueGridLineBounds[AIndex: Integer]: TRect
      read GetValueGridLineBounds;
    ...
    property ValueTickMarkLabelsViewInfo
      : TcxGridChartHistogramValueTickMarkLabelsViewInfo
      read FValueTickMarkLabelsViewInfo;
    property ValueMarkCount: Integer read GetValueMarkCount;
    property ValueMarkPositions[Index: Integer]: Integer
      read GetValueMarkPosition write SetValueMarkPosition;
  end;
  ...
  TcxGridChartColumnDiagramValueViewInfo = class
  ...
  public
    property CaptionPosition: TcxGridChartColumnDiagramValueCaptionPosition
      read GetCaptionPosition;
    property DiagramViewInfo: TcxGridChartColumnDiagramViewInfo
      read GetDiagramViewInfo;
  end;
  ...
  protected
    ...
    class function GetValueViewInfoClass
      : TcxGridChartDiagramValueViewInfoClass; override;
    function GetValueViewInfoIndex(ASeriesIndex, AVisibleIndex: Integer)
      : Integer; override;

    function GetCategoryTickMarkLabelOffsetUnits(AIndex: Integer)
      : Integer; override;
    function GetCategoryTickMarkOffsetUnits(AIndex: Integer;
      AValueAxisBetweenCategories: Boolean): Integer; override;
    function GetUnitCount: Integer; override;
    function GetValueGroupAreaSizeUnits: Integer; virtual;
    function GetValueOffsetUnits(AVisibleValueIndex, ASeriesIndex: Integer)
      : Integer; virtual;
    function IsEdgeCategoryTickMarkLabels: Boolean; override;

    procedure CalculateValues; override;
    function GetValueBounds(AVisibleValueIndex, ASeriesIndex: Integer)
      : TRect; virtual;
    function MakeValueBounds(const ACategoryStart, ACategoryFinish, AValueStart,
      AValueFinish: Integer): TRect;
  public
  ...
  TcxGridChartStackedColumnDiagramViewInfo = class
  ...
  protected
    ...
    procedure DoCalculateParams; override;
    function GetAlignmentVert: TcxAlignmentVert; override;
    function GetDiagramValueViewInfoClass
      : TcxGridChartLineDiagramValueViewInfoClass;
    function GetPainterClass: TcxCustomGridCellPainterClass; override;
  ...
  TcxGridChartLineDiagramLegendViewInfo = class
    (TcxGridChartHistogramLegendViewInfo)
  protected
    function GetItemClass: TcxGridChartLegendItemViewInfoClass; override;
  public
    procedure GetItemLegendKeyMarkerParams(AIndex: Integer;
      out AParams: TcxViewParams); virtual;
  end;
  ...
  protected
    ...
    function GetMarkerBounds: TRect; virtual;
    function GetPainterClass: TcxCustomGridCellPainterClass; override;
    class function GetPainterClassEx
      : TcxGridChartLineDiagramValuePainterClass; virtual;
  ...
  public
    ...
    procedure Calculate(const ABounds: TRect;
      ALineStartY, ALineFinishY: Integer); virtual;
    ...
    property CaptionPosition: TcxGridChartLineDiagramValueCaptionPosition
      read GetCaptionPosition;
    property DiagramViewInfo: TcxGridChartLineDiagramViewInfo
      read GetDiagramViewInfo;
    property LineColor: TColor read GetLineColor;
    property LineStart: TPoint read GetLineStart;
    property LineFinish: TPoint read GetLineFinish;
  ...
  protected
    ...
    function GetValueOffsetUnits(AVisibleValueIndex, ASeriesIndex: Integer)
      : Integer; virtual;
    function GetValueY(AVisibleValueIndex, ASeriesIndex: Integer)
      : Integer; virtual;
  ...
  TcxGridChartAreaDiagramLegendItemViewInfo = class
  ...
  TcxGridChartAreaDiagramLegendViewInfo = class
  ...
  protected
    ...
    class function GetPainterClassEx
      : TcxGridChartLineDiagramValuePainterClass; override;
    procedure GetViewParams(var AParams: TcxViewParams); override;
  ...
  public
    AreaPoints: TPoints;
    procedure Calculate(const ABounds: TRect;
      ALineStartY, ALineFinishY: Integer); override;
  ...
  TcxGridChartStackedAreaDiagramViewInfo = class
  ...
  protected
    function CalculateCaptionBounds: TRect; override;
    function CalculateCaptionCenter(AAngle, ACaptionWidth, ACaptionHeight
      : Integer): TPoint; virtual;
    ...
    function HasBackground: Boolean; override;
    function HasCaption: Boolean; override;
    procedure MakeCaptionVisible(var ACaptionBounds: TRect;
      AAngle: Integer); virtual;
  public
    LeaderLinePoints: TPoints;
    procedure Calculate(const R: TRect;
      AStartAngle, AFinishAngle: Integer); virtual;
    function HasPoint(const P: TPoint): Boolean; override;

    property CaptionPosition: TcxGridChartPieDiagramValueCaptionPosition
      read GetCaptionPosition;
    property Center: TPoint read GetCenter;
    property DiagramViewInfo: TcxGridChartPieDiagramViewInfo
      read GetDiagramViewInfo;
  ...
  TcxGridChartPieSeriesSiteCaptionViewInfoClass = class of
    TcxGridChartPieSeriesSiteCaptionViewInfo;

  TcxGridChartPieSeriesSiteCaptionViewInfo = class
    (TcxCustomGridViewCellViewInfo)
  private
  ...
  protected
    ...
    procedure InitHitTest(AHitTest: TcxCustomGridHitTest); override;
  public
    constructor Create(ASiteViewInfo: TcxGridChartPieSeriesSiteViewInfo);
      reintroduce; virtual;
    function MouseDown(AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
      AShift: TShiftState): Boolean; override;
  ...
  TcxGridChartPieSeriesSiteViewInfoClass = class of
  ...
  protected
    ...
    procedure CalculateCaptionAndPieAreaBounds(var ACaptionBounds,
      APieAreaBounds: TRect); virtual;
    function CalculateContentBounds: TRect; override;
    function CustomDraw(ACanvas: TcxCanvas): Boolean; override;
    function GetBorderColor(AIndex: TcxBorder): TColor; override;
    function GetBorders: TcxBorders; override;
    function GetBorderWidth(AIndex: TcxBorder): Integer; override;
    function GetCaptionViewInfoClass
      : TcxGridChartPieSeriesSiteCaptionViewInfoClass; virtual;
    function GetDesignSelectionBounds: TRect; override;
    function GetHitTestClass: TcxCustomGridHitTestClass; override;
    function GetIsDesignSelected: Boolean; override;
    function GetPainterClass: TcxCustomGridCellPainterClass; override;
    function GetValueViewInfo(AVisibleValueIndex: Integer)
    ...
    property Diagram: TcxGridChartPieDiagram read GetDiagram;
  public
    constructor Create(ADiagramViewInfo: TcxGridChartPieDiagramViewInfo;
      ASeries: TcxGridChartSeries); reintroduce; virtual;
    destructor Destroy; override;
    procedure Calculate(const ABounds: TRect); override;
    procedure DoRightToLeftConversion(const ABounds: TRect); override;
    function GetHitTest(const P: TPoint): TcxCustomGridHitTest; override;
    ...
    property CaptionViewInfo: TcxGridChartPieSeriesSiteCaptionViewInfo
      read FCaptionViewInfo;
    property DiagramViewInfo: TcxGridChartPieDiagramViewInfo
      read FDiagramViewInfo;
  ...
  private
    ...
    function GetCaptionPosition: TcxGridChartPieDiagramValueCaptionPosition;
    function GetDiagram: TcxGridChartPieDiagram;
    function GetSeriesSiteViewInfo(Index: Integer)
      : TcxGridChartPieSeriesSiteViewInfo;
    function GetSeriesSiteViewInfoCount: Integer;
  protected
    function GetPainterClass: TcxCustomGridCellPainterClass; override;
    function GetSeriesSiteViewInfoClass
      : TcxGridChartPieSeriesSiteViewInfoClass; virtual;
    class function GetValueViewInfoClass
      : TcxGridChartDiagramValueViewInfoClass; override;
    function GetValueViewInfoIndex(ASeriesIndex, AVisibleIndex: Integer)
      : Integer; override;
    ...
    property PieAreaValueCaptionCompensation: Integer
      read FPieAreaValueCaptionCompensation;
  public
    constructor Create(AGridViewInfo: TcxCustomGridViewInfo;
      ADiagram: TcxGridChartDiagram); override;
    destructor Destroy; override;
    ...
    property SeriesSiteViewInfos[Index: Integer]
      : TcxGridChartPieSeriesSiteViewInfo read GetSeriesSiteViewInfo;
  end;

  // toolbox

  TcxGridChartToolBoxItemAlignment = TcxGridChartPartPosition;
  // cppLeft, cppRight only

  TcxGridChartToolBoxItemViewInfoClass = class of
  ...
  public
    ...
    property Alignment: TcxGridChartToolBoxItemAlignment read FAlignment
      write FAlignment;
    property Container: TcxGridChartToolBoxViewInfo read FContainer;
    property GridView: TcxGridChartView read GetGridView;
  end;

  TcxGridChartToolBoxItemSeparatorViewInfoClass = class of
    TcxGridChartToolBoxItemSeparatorViewInfo;

  TcxGridChartToolBoxItemSeparatorViewInfo = class
    (TcxGridChartToolBoxItemViewInfo)
  protected
    function CalculateHeight: Integer; override;
    function CalculateWidth: Integer; override;
  ...
  TcxGridChartToolBoxDataLevelActiveValueViewInfoClass = class of
    TcxGridChartToolBoxDataLevelActiveValueViewInfo;

  TcxGridChartToolBoxDataLevelActiveValueViewInfo = class
    (TcxCustomGridViewCellViewInfo, IcxGridChartDataLevelActiveValuePopupOwner)
  private
  ...
  public
    constructor Create(AContainer: TcxGridChartToolBoxDataLevelInfoViewInfo);
      reintroduce; virtual;
    property CanShowDropDownWindow: Boolean read FCanShowDropDownWindow;
    property Container: TcxGridChartToolBoxDataLevelInfoViewInfo
      read FContainer;
    property GridView: TcxGridChartView read GetGridView;
  end;

  TcxGridChartToolBoxDataLevelInfoViewInfoClass = class of
  ...
  protected
    ...
    function CalculateHeight: Integer; override;
    function CalculateWidth: Integer; override;
    function GetActiveValueViewInfoClass
      : TcxGridChartToolBoxDataLevelActiveValueViewInfoClass; virtual;
    function GetAlignmentHorz: TAlignment; override;
    function GetAlignmentVert: TcxAlignmentVert; override;
    function GetBorderColor(AIndex: TcxBorder): TColor; override;
    function GetBorders: TcxBorders; override;
  ...
  TcxGridChartToolBoxDiagramSelectorViewInfoClass = class of
  ...
  protected
    ...
    function GetDropDownWindow: TdxUIElementPopupWindow; override;
    function GetDropDownWindowOwnerBounds: TRect; override;
    property DropDownWindow: TcxGridChartDiagramSelectorPopup
  ...
  private
    ...
    function GetDataLevelInfo(AIndex: Integer)
      : TcxGridChartToolBoxDataLevelInfoViewInfo;
  ...
  protected
    ...
    function AddItem(AItem: TcxGridChartToolBoxItemViewInfo)
      : TcxGridChartToolBoxItemViewInfo;
    procedure AddSeparator(AAlignment: TcxGridChartToolBoxItemAlignment);
    procedure CreateItems; virtual;
    function GetCustomizeButtonClass
      : TcxGridChartToolBoxCustomizeButtonViewInfoClass; virtual;
    function GetDataLevelInfoClass
      : TcxGridChartToolBoxDataLevelInfoViewInfoClass; virtual;
    function GetDiagramSelectorClass
      : TcxGridChartToolBoxDiagramSelectorViewInfoClass; virtual;
    function GetItemSeparatorClass
      : TcxGridChartToolBoxItemSeparatorViewInfoClass; virtual;
  ...
  public
    ...
    property Count: Integer read GetCount;
    property CustomizeButton: TcxGridChartToolBoxCustomizeButtonViewInfo
      read FCustomizeButton;
    property DataLevelInfoConnectorColor: TColor
      read GetDataLevelInfoConnectorColor;
    property DataLevelInfoConnectorCount: Integer
      read GetDataLevelInfoConnectorCount;
    property DataLevelInfoConnectors[AIndex: Integer]: TRect
      read GetDataLevelInfoConnector;
    property DataLevelInfoCount: Integer read GetDataLevelInfoCount;
    property DataLevelInfos[AIndex: Integer]
      : TcxGridChartToolBoxDataLevelInfoViewInfo read GetDataLevelInfo;
    property DiagramSelector: TcxGridChartToolBoxDiagramSelectorViewInfo
      read FDiagramSelector;
    property Items[AIndex: Integer]: TcxGridChartToolBoxItemViewInfo
      read GetItem;
  end;
  ...
  protected
    ...
    procedure CalculatePartsBounds(out ADiagramBounds, ALegendBounds,
      ATitleBounds, AToolBoxBounds: TRect); virtual;
  ...
  protected
    ...
    property Position: TcxGridChartPartPosition read FPosition write SetPosition
      default cppDefault;
  public
  ...
  published
    property Alignment: TcxGridChartPartAlignment read FAlignment
      write SetAlignment default cpaDefault;
  ...
  protected
    ...
    function GetDefaultOrientation(APosition: TcxGridChartPartPosition)
      : TcxGridChartPartOrientation; virtual;
  ...
  public
    ...
    function GetOrientation(APosition: TcxGridChartPartPosition = cppDefault)
      : TcxGridChartPartOrientation;
    function GetPosition: TcxGridChartPartPosition;
  published
    property Alignment: TcxGridChartPartAlignment read FAlignment
      write SetAlignment default cpaDefault;
    property Border: TcxGridChartLegendBorder read FBorder write SetBorder
      default lbDefault;
    property KeyBorder: TcxGridChartLegendBorder read FKeyBorder
      write SetKeyBorder default lbDefault;
  ...
  published
    ...
    property ValueCaptions: TcxStyle index dsValueCaptions read GetValue
      write SetValue;
  ...
  TcxGridChartDiagramLegendCustomDrawEvent = procedure
    (Sender: TcxGridChartDiagram; ACanvas: TcxCanvas;
    AViewInfo: TcxGridChartLegendViewInfo; var ADone: Boolean) of object;
  TcxGridChartDiagramLegendItemCustomDrawEvent = procedure
    (Sender: TcxGridChartDiagram; ACanvas: TcxCanvas;
    AViewInfo: TcxGridChartLegendItemViewInfo; var ADone: Boolean) of object;
  TcxGridChartDiagramValueCustomDrawEvent = procedure
    (Sender: TcxGridChartDiagram; ACanvas: TcxCanvas;
    AViewInfo: TcxGridChartDiagramValueViewInfo; var ADone: Boolean) of object;
  TcxGridChartDiagramValueCaptionCustomDrawEvent = procedure
    (Sender: TcxGridChartDiagram; ACanvas: TcxCanvas;
    AViewInfo: TcxGridChartDiagramValueCaptionViewInfo; var ADone: Boolean)
    of object;
  ...
  strict private
    ...
    procedure SetOnCustomDrawLegend
      (Value: TcxGridChartDiagramLegendCustomDrawEvent);
    procedure SetOnCustomDrawLegendItem
      (Value: TcxGridChartDiagramLegendItemCustomDrawEvent);
    procedure SetOnCustomDrawValue
      (Value: TcxGridChartDiagramValueCustomDrawEvent);
    procedure SetOnCustomDrawValueCaption
  ...
  protected
    ...
    function GetLegendViewInfoClass: TcxGridChartLegendViewInfoClass;
      virtual; abstract;
    ...
    procedure DoCustomDrawLegend(ACanvas: TcxCanvas;
      AViewInfo: TcxGridChartLegendViewInfo; var ADone: Boolean); virtual;
    procedure DoCustomDrawLegendItem(ACanvas: TcxCanvas;
      AViewInfo: TcxGridChartLegendItemViewInfo; var ADone: Boolean); virtual;
    procedure DoCustomDrawValue(ACanvas: TcxCanvas;
      AViewInfo: TcxGridChartDiagramValueViewInfo; var ADone: Boolean); virtual;
  ...
  public
    ...
    function GetStackedValueCaption(ASeries: TcxGridChartSeries;
      AValueIndex: Integer; APercentage: Boolean): string; virtual;
    function GetValueCaption(ASeries: TcxGridChartSeries; AValueIndex: Integer)
      : string; virtual;
  ...
  published
    ...
    property OnCustomDrawLegend: TcxGridChartDiagramLegendCustomDrawEvent
      read FOnCustomDrawLegend write SetOnCustomDrawLegend;
    ...
    property OnCustomDrawValue: TcxGridChartDiagramValueCustomDrawEvent
      read FOnCustomDrawValue write SetOnCustomDrawValue;
    property OnCustomDrawValueCaption
      : TcxGridChartDiagramValueCaptionCustomDrawEvent
      read FOnCustomDrawValueCaption write SetOnCustomDrawValueCaption;
  end;
  ...
  TcxGridChartHistogramTickMarkKind = (tmkNone, tmkCross, tmkInside,
    tmkOutside);
  ...
  published
    ...
    property TickMarkLabels: Boolean read FTickMarkLabels
      write SetTickMarkLabels default True;
    property Title: TcxGridChartHistogramAxisTitle read FTitle write SetTitle;
    property Visible: Boolean read FVisible write SetVisible default True;
  end;

  TcxGridChartHistogramAxisCategoryClass = class of
  ...
  published
    ...
    property ValueAxisBetweenCategories: Boolean
      read FValueAxisBetweenCategories write SetValueAxisBetweenCategories
      default True;
  end;
  ...
  public
    ...
    function GetTickMarkLabelFormat(AConsiderSeriesFormat: Boolean)
      : string; virtual;
  published
    ...
    property TickMarkLabelFormat: string read FTickMarkLabelFormat
      write SetTickMarkLabelFormat;
  end;
  ...
  published
    ...
    property CategoryAxis: TcxStyle index dsCategoryAxis read GetValue
      write SetValue;
    property CategoryAxisTitle: TcxStyle index dsCategoryAxisTitle read GetValue
      write SetValue;
    property CategoryGridLines: TcxStyle index dsCategoryGridLines read GetValue
      write SetValue;
    ...
    property ValueAxisTitle: TcxStyle index dsValueAxisTitle read GetValue
      write SetValue;
    property ValueGridLines: TcxStyle index dsValueGridLines read GetValue
      write SetValue;
  end;
  ...
  protected
    property Stacking: TcxGridChartValuesStacking read FStacking
      write SetStacking default vsNone;
  public
    procedure Assign(Source: TPersistent); override;
    function GetVaryColorsByCategory: Boolean; virtual;
  published
    property VaryColorsByCategory: Boolean read FVaryColorsByCategory
      write SetVaryColorsByCategory default False;
  end;

  { TcxGridChartHistogram }

  TcxGridChartHistogramPlotCustomDrawEvent = procedure
    (Sender: TcxGridChartHistogram; ACanvas: TcxCanvas;
    AViewInfo: TcxGridChartHistogramViewInfo; const ABounds: TRect;
  ...
  strict private
    ...
    procedure SetEmptyPointsDisplayMode
    ...
    procedure SetOnCustomDrawPlot
      (Value: TcxGridChartHistogramPlotCustomDrawEvent);
  protected
    procedure ChangeScale(M, D: Integer); override;
    procedure CreateSubObjects(AGridView: TcxGridChartView); override;
    procedure DestroySubObjects; override;

    function GetAxisCategoryClass
      : TcxGridChartHistogramAxisCategoryClass; virtual;
    ...
    procedure DoCustomDrawPlot(ACanvas: TcxCanvas;
      AViewInfo: TcxGridChartHistogramViewInfo; const ABounds: TRect;
      var ADone: Boolean); virtual;
    function HasCustomDrawPlot: Boolean; virtual;

    property EmptyPointsDisplayMode: TcxGridChartEmptyPointsDisplayMode
      read FEmptyPointsDisplayMode write SetEmptyPointsDisplayMode
      default epdmZero;
  public
    procedure Assign(Source: TPersistent); override;
    function GetCategoryAxisPosition: TcxGridChartAxisPosition; virtual;
    ...
    property AxisCategory: TcxGridChartHistogramAxisCategory read FAxisCategory
      write SetAxisCategory;
    property AxisValue: TcxGridChartHistogramAxisValue read FAxisValue
      write SetAxisValue;
    ...
    property ValuesEvents: TNotifyEvent read FSubClassEvents
      write FSubClassEvents;
  published
    property OnCustomDrawPlot: TcxGridChartHistogramPlotCustomDrawEvent
      read FOnCustomDrawPlot write SetOnCustomDrawPlot;
  end;
  ...
  strict private
    ...
    procedure SetCaptionPosition
      (Value: TcxGridChartColumnDiagramValueCaptionPosition);
  public
    constructor Create(ADiagram: TcxGridChartDiagram); override;
    procedure Assign(Source: TPersistent); override;
  published
    ...
    property CaptionPosition: TcxGridChartColumnDiagramValueCaptionPosition
      read FCaptionPosition write SetCaptionPosition default cdvcpNone;
  end;
  ...
  published
    ...
    property AxisValue;
    property Styles;
    property Values: TcxGridChartColumnDiagramValues read GetValues
      write SetValues;
  end;
  ...
  public
    ...
    procedure GetValueMarkerParams(AVisibleSeriesIndex, AValueIndex: Integer;
      out AParams: TcxViewParams); virtual;
  published
    property ValueMarkers: TcxStyle index dsValueMarkers read GetValue
      write SetValue;
  end;

  { TcxGridChartLineDiagramValues }

  TcxGridChartLineDiagramGetLineStyleEvent = procedure
    (Sender: TcxGridChartLineDiagram; ASeries: TcxGridChartSeries;
    var AStyle: TcxGridChartLineStyle) of object;
  TcxGridChartLineDiagramGetMarkerStyleEvent = procedure
    (Sender: TcxGridChartLineDiagram; ASeries: TcxGridChartSeries;
    var AStyle: TcxGridChartMarkerStyle) of object;
  ...
  strict private
    ...
    procedure SetOnGetLineStyle
      (Value: TcxGridChartLineDiagramGetLineStyleEvent);
    procedure SetOnGetMarkerStyle
      (Value: TcxGridChartLineDiagramGetMarkerStyleEvent);
  protected
    procedure ChangeScale(M, D: Integer); override;
    procedure DoGetLineStyle(ASeries: TcxGridChartSeries;
      var AStyle: TcxGridChartLineStyle); virtual;
    procedure DoGetMarkerStyle(ASeries: TcxGridChartSeries;
      var AStyle: TcxGridChartMarkerStyle); virtual;
  public
    constructor Create(ADiagram: TcxGridChartDiagram); override;
    procedure Assign(Source: TPersistent); override;
    function GetHotSpotSize: Integer; virtual;
    function GetLineStyle(ASeries: TcxGridChartSeries)
      : TcxGridChartLineStyle; virtual;
    function GetMarkerStyle(ASeries: TcxGridChartSeries)
      : TcxGridChartMarkerStyle; virtual;
    property Diagram: TcxGridChartLineDiagram read GetDiagram;
  published
    property CaptionPosition: TcxGridChartLineDiagramValueCaptionPosition
      read FCaptionPosition write SetCaptionPosition default ldvcpNone;
    property HotSpotSize: Integer read FHotSpotSize write SetHotSpotSize
      default cxGridChartLineDiagramDefaultHotSpotSize;
    property LineStyle: TcxGridChartLineStyle read FLineStyle write SetLineStyle
      default clsSolid;
    property LineWidth: Integer read FLineWidth write SetLineWidth
      default cxGridChartLineDiagramDefaultLineWidth;
    property MarkerSize: Integer read FMarkerSize write SetMarkerSize
      default cxGridChartLineDiagramDefaultMarkerSize;
    property MarkerStyle: TcxGridChartMarkerStyle read FMarkerStyle
      write SetMarkerStyle default cmsNone;
    property Stacking;
    property OnGetLineStyle: TcxGridChartLineDiagramGetLineStyleEvent
      read FOnGetLineStyle write SetOnGetLineStyle;
    property OnGetMarkerStyle: TcxGridChartLineDiagramGetMarkerStyleEvent
      read FOnGetMarkerStyle write SetOnGetMarkerStyle;
  end;
  ...
  protected
    function GetAxisCategoryClass
      : TcxGridChartHistogramAxisCategoryClass; override;
    function GetLegendViewInfoClass: TcxGridChartLegendViewInfoClass; override;
    function GetStylesClass: TcxGridChartDiagramStylesClass; override;
    function GetValuesClass: TcxGridChartHistogramValuesClass; override;
    function GetViewInfoClass: TcxGridChartDiagramViewInfoClass; override;
  ...
  published
    property AxisCategory: TcxGridChartLineDiagramAxisCategory
      read GetAxisCategory write SetAxisCategory;
    property AxisValue;
    property EmptyPointsDisplayMode;
    property Styles: TcxGridChartLineDiagramStyles read GetStyles
      write SetStyles;
    property Values: TcxGridChartLineDiagramValues read GetValues
      write SetValues;
  ...
  TcxGridChartAreaDiagramValueAreaCustomDrawEvent = procedure
  ...
  strict private
    ...
    procedure SetOnCustomDrawValueArea
      (Value: TcxGridChartAreaDiagramValueAreaCustomDrawEvent);
  protected
    ...
    procedure DoCustomDrawValueArea(ACanvas: TcxCanvas;
      AViewInfo: TcxGridChartAreaDiagramValueViewInfo;
      var ADone: Boolean); virtual;
  ...
  published
    property Transparency: Byte read FTransparency write SetTransparency
      default 0;
    property Styles: TcxGridChartAreaDiagramStyles read GetStyles
      write SetStyles;
    property OnCustomDrawValueArea
  ...
  TcxGridChartStackedColumnDiagramClass = class of
  ...
  public
    ...
    function GetViewInfoClass: TcxGridChartDiagramViewInfoClass; override;
  published
    property StackedStyle: TcxGridChartStackedAreaDiagramStyle
      read FStackedStyle write SetStackedStyle default sasDefault;
  end;
  ...
  public
    ...
    function GetValueCaption(ASeries: TcxGridChartSeries; AValueIndex: Integer)
      : string; override;
  published
    property StackedStyle: TcxGridChartStackedDiagramStyle read FStackedStyle
      write SetStackedStyle default sdsDefault;
    property SideBySideIndentWidth: Integer read FSideBySideIndentWidth
      write SetSideBySideIndentWidth
      default cxGridChartSideBySideDefaultIndentWidth;
  end;
  ...
  public
    procedure Assign(Source: TPersistent); override;
  published
    property SeriesSiteCaptions: TcxStyle index dsSeriesSiteCaptions
      read GetValue write SetValue;
    property SeriesSites: TcxStyle index dsSeriesSites read GetValue
      write SetValue;
  end;

  { TcxGridChartPieDiagramValues }

  TcxGridChartPieDiagramValueCaptionItem = (pdvciCategory, pdvciValue,
    pdvciPercentage);
  TcxGridChartPieDiagramValueCaptionItems = set of
    TcxGridChartPieDiagramValueCaptionItem;
  ...
  strict private
    ...
    procedure SetCaptionPosition
      (Value: TcxGridChartPieDiagramValueCaptionPosition);
  ...
  public
    ...
    function GetCaptionPosition
      : TcxGridChartPieDiagramValueCaptionPosition; virtual;
    function GetPercentageCaptionFormat: string;
  published
    property AngleOfFirstSlice: Integer read FAngleOfFirstSlice
      write SetAngleOfFirstSlice default 0;
    property CaptionPosition: TcxGridChartPieDiagramValueCaptionPosition
      read FCaptionPosition write SetCaptionPosition default pdvcpNone;
    property CaptionItems: TcxGridChartPieDiagramValueCaptionItems
      read FCaptionItems write SetCaptionItems default [pdvciValue];
    property CaptionItemSeparator: string read FCaptionItemSeparator
      write SetCaptionItemSeparator;
  ...
  TcxGridChartPieDiagramSeriesSiteCaptionCustomDrawEvent = procedure
    (Sender: TcxGridChartPieDiagram; ACanvas: TcxCanvas;
    AViewInfo: TcxGridChartPieSeriesSiteCaptionViewInfo; var ADone: Boolean)
    of object;
  TcxGridChartPieDiagramSeriesSiteCustomDrawEvent = procedure
    (Sender: TcxGridChartPieDiagram; ACanvas: TcxCanvas;
    AViewInfo: TcxGridChartPieSeriesSiteViewInfo; var ADone: Boolean) of object;
  ...
  strict private
    ...
    FOnCustomDrawSeriesSiteCaption
    ...
    procedure SetOnCustomDrawSeriesSite
      (Value: TcxGridChartPieDiagramSeriesSiteCustomDrawEvent);
    procedure SetOnCustomDrawSeriesSiteCaption
      (Value: TcxGridChartPieDiagramSeriesSiteCaptionCustomDrawEvent);
  protected
    procedure ChangeScale(M, D: Integer); override;
    procedure CreateSubObjects(AGridView: TcxGridChartView); override;
    procedure DestroySubObjects; override;
    ...
    procedure DoCustomDrawSeriesSite(ACanvas: TcxCanvas;
      AViewInfo: TcxGridChartPieSeriesSiteViewInfo;
      var ADone: Boolean); virtual;
    procedure DoCustomDrawSeriesSiteCaption(ACanvas: TcxCanvas;
      AViewInfo: TcxGridChartPieSeriesSiteCaptionViewInfo;
      var ADone: Boolean); virtual;
  ...
  public
    ...
    function GetValueCaption(ASeries: TcxGridChartSeries; AValueIndex: Integer)
      : string; override;
  published
    property SeriesCaptions: Boolean read FSeriesCaptions
      write SetSeriesCaptions default True;
    property SeriesColumnCount: Integer read FSeriesColumnCount
      write SetSeriesColumnCount default 0;
    property SeriesSites: Boolean read FSeriesSites write SetSeriesSites
      default False;
    property Styles: TcxGridChartPieDiagramStyles read GetStyles
      write SetStyles;
    property Values: TcxGridChartPieDiagramValues read FValues write SetValues;

    property OnCustomDrawSeriesSite
      : TcxGridChartPieDiagramSeriesSiteCustomDrawEvent
      read FOnCustomDrawSeriesSite write SetOnCustomDrawSeriesSite;
    property OnCustomDrawSeriesSiteCaption
      : TcxGridChartPieDiagramSeriesSiteCaptionCustomDrawEvent
      read FOnCustomDrawSeriesSiteCaption
      write SetOnCustomDrawSeriesSiteCaption;
  end;
  ...
  TcxGridChartItemDataBinding = class(TcxInterfacedPersistent,
  ...
  protected
    ...
    procedure InitDefaultValuesProvider(ADefaultValuesProvider
      : TcxCustomEditDefaultValuesProvider); virtual;
    ...
    property DefaultProperties: TcxCustomEditProperties
      read GetDefaultProperties;
    property DefaultRepositoryItem: TcxEditRepositoryItem
      read FDefaultRepositoryItem;
    property DefaultValuesProvider: TcxCustomEditDefaultValuesProvider
      read GetDefaultValuesProvider;
  ...
  public
    ...
    function IsValueTypeClassValid(AValueTypeClass: TcxValueTypeClass)
      : Boolean; virtual;
  ...
  TcxGridChartItemGetStoredPropertyValueEvent = procedure
    (Sender: TcxGridChartItem; const AName: string; var AValue: Variant)
    of object;
  TcxGridChartItemSetStoredPropertyValueEvent = procedure
    (Sender: TcxGridChartItem; const AName: string; const AValue: Variant)
    of object;
  ...
  private
    ...
    procedure SetOnGetStoredProperties
      (Value: TcxGridChartItemGetStoredPropertiesEvent);
    procedure SetOnGetStoredPropertyValue
      (Value: TcxGridChartItemGetStoredPropertyValueEvent);
    procedure SetOnGetValueDisplayText
      (Value: TcxGridChartGetValueDisplayTextEvent);
  ...
  protected
    ...
    procedure DoGetValueDisplayText(const AValue: Variant;
    ...
    procedure SetValue(AIndex: Integer; const Value: Variant); virtual;
      abstract;
  ...
  public
    ...
    property VisibleDisplayTexts[AIndex: Integer]: string
      read GetVisibleDisplayText;
  ...
  published
    ...
    property OnGetStoredProperties: TcxGridChartItemGetStoredPropertiesEvent
      read FOnGetStoredProperties write SetOnGetStoredProperties;
    property OnGetStoredPropertyValue
      : TcxGridChartItemGetStoredPropertyValueEvent
      read FOnGetStoredPropertyValue write SetOnGetStoredPropertyValue;
    property OnGetValueDisplayText: TcxGridChartGetValueDisplayTextEvent
      read FOnGetValueDisplayText write SetOnGetValueDisplayText;
    property OnSetStoredPropertyValue
      : TcxGridChartItemSetStoredPropertyValueEvent
  ...
  public
    ...
    property Values[Index: Integer]: Variant read GetValue
      write SetValue; default;
    property VisibleDisplayTexts[Index: Integer]: string
      read GetVisibleDisplayText;
    property VisibleValueCount: Integer read GetVisibleValueCount;
  ...
  public
    constructor Create(AOwner: TPersistent); override;
    procedure Assign(Source: TPersistent); override;
    procedure GetValueParams(AValueIndex: Integer;
      AVaryColorsByCategory: Boolean; out AParams: TcxViewParams); virtual;
    property Series: TcxGridChartSeries read GetSeries;
  published
    property Values: TcxStyle index ssValues read GetValue write SetValue;
    property OnGetValueStyle: TcxGridChartSeriesGetValueStyleEvent
      read FOnGetValueStyle write SetOnGetValueStyle;
  end;
  ...
  TcxGridChartSeriesValueCustomDrawEvent = procedure(Sender: TcxGridChartSeries;
    ...
    var ADone: Boolean) of object;
  TcxGridChartValueClickEvent = procedure(Sender: TcxGridChartView;
  ...
  private
    ...
    procedure SetOnCustomDrawValue
      (Value: TcxGridChartSeriesValueCustomDrawEvent);
  ...
  protected
    ...
    procedure DoGetValueDisplayText(const AValue: Variant;
      var ADisplayText: string); override;
    function GetDefaultValueTypeClass: TcxValueTypeClass; override;
  ...
  published
    ...
    property GroupSummaryKind: TcxSummaryKind read GetGroupSummaryKind
      write SetGroupSummaryKind default cxGridChartItemDefaultSummaryKind;
    property Styles: TcxGridChartSeriesStyles read FStyles write SetStyles;
    property ValueCaptionFormat: string read FValueCaptionFormat
      write SetValueCaptionFormat;

    property StylesEvents: TNotifyEvent read FSubObjectEvents
      write FSubObjectEvents;

    property OnCustomDrawValue: TcxGridChartSeriesValueCustomDrawEvent
      read FOnCustomDrawValue write SetOnCustomDrawValue;
    property OnValueClick: TcxGridChartValueClickEvent read FOnValueClick
      write SetOnValueClick;
  end;
  ...
  private
    ...
    procedure SetDataLevelsInfoVisible
      (Value: TcxGridChartDataLevelsInfoVisible);
  ...
  public
    ...
    property GridView: TcxGridChartView read GetGridView;
  published
    property Border: TcxGridChartToolBoxBorder read FBorder write SetBorder
      default tbSingle;
    property CustomizeButton: Boolean read FCustomizeButton
      write SetCustomizeButton default False;
    property DataLevelActiveValueDropDownCount: Integer
      read FDataLevelActiveValueDropDownCount
      write SetDataLevelActiveValueDropDownCount
      default cxGridChartDefaultDataLevelActiveValueDropDownCount;
    property DataLevelActiveValueDropDownWidth: Integer
      read FDataLevelActiveValueDropDownWidth
      write SetDataLevelActiveValueDropDownWidth default 0;
    property DataLevelsInfoVisible: TcxGridChartDataLevelsInfoVisible
      read FDataLevelsInfoVisible write SetDataLevelsInfoVisible
      default dlivNonEmpty;
    property DiagramSelector: Boolean read FDiagramSelector
      write SetDiagramSelector default False;
    property Position: TcxGridChartToolBoxPosition read FPosition
      write SetPosition default tpTop;
    property Visible: TcxGridChartToolBoxVisible read FVisible write SetVisible
      default tvNonEmpty;
  end;
  ...
  published
    ...
    property ValueHints: Boolean read FValueHints write SetValueHints
      default True;
    property ValueHotTrack: TcxGridChartValueHotTrack read FValueHotTrack
      write SetValueHotTrack default vhDefault;
  end;

  TcxGridChartDataDrillUpMethod = (ddumNone, ddumValueMouseRightButtonClick,
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property DataDrillDown: Boolean read FDataDrillDown write SetDataDrillDown
      default True;
    property DataDrillUpMethod: TcxGridChartDataDrillUpMethod
      read FDataDrillUpMethod write SetDataDrillUpMethod
      default ddumMouseRightButtonClick;
    property DataGroupHiding: Boolean read FDataGroupHiding
      write SetDataGroupHiding default False;
    property DataGroupMoving: Boolean read FDataGroupMoving
      write SetDataGroupMoving default True;
    property OptionsCustomization: Boolean read FOptionsCustomization
      write SetOptionsCustomization default True;
    property SeriesCustomization: Boolean read FSeriesCustomization
      write SetSeriesCustomization default True;
  end;
  ...
  published
    property Antialiasing: Boolean read FAntialiasing write SetAntialiasing
      default True;
    property CategoriesPerPage: Integer read FCategoriesPerPage
      write SetCategoriesPerPage default 0;
    property TransparentCaptions: Boolean read FTransparentCaptions
      write SetTransparentCaptions default True;
  end;
  ...
  public
    constructor Create(AOwner: TPersistent); override;
    procedure Assign(Source: TPersistent); override;
    procedure GetDataLevelInfoParams(ADataLevel: Integer;
      out AParams: TcxViewParams); virtual;
    property GridView: TcxGridChartView read GetGridViewValue;
  published
    property ActiveDataLevelInfo: TcxStyle index vsActiveDataLevelInfo
      read GetValue write SetValue;
    property DataLevelActiveValueInfo: TcxStyle index vsDataLevelActiveValueInfo
      read GetValue write SetValue;
    property DataLevelsInfo: TcxStyle index vsDataLevelsInfo read GetValue
      write SetValue;
    property DiagramSelector: TcxStyle index vsDiagramSelector read GetValue
      write SetValue;
  ...
  TcxGridChartDataGroupEvent = procedure(Sender: TcxGridChartView;
    ADataGroup: TcxGridChartDataGroup) of object;
  TcxGridChartDiagramEvent = procedure(Sender: TcxGridChartView;
    ADiagram: TcxGridChartDiagram) of object;
  ...
  TcxGridChartLegendCustomDrawEvent = procedure(Sender: TcxGridChartView;
    ACanvas: TcxCanvas; AViewInfo: TcxGridChartLegendViewInfo;
    var ADone: Boolean) of object;
  TcxGridChartLegendItemCustomDrawEvent = procedure(Sender: TcxGridChartView;
    ...
    var ADone: Boolean) of object;
  TcxGridChartSeriesEvent = procedure(Sender: TcxGridChartView;
  ...
  *)
  ...
  private
    ...
    procedure SetOnCustomDrawLegendItem
      (Value: TcxGridChartLegendItemCustomDrawEvent);
  ...
  protected
    ...
    function GetOptionsCustomizeClass
      : TcxGridChartOptionsCustomizeClass; virtual;
    ...
    function GetStackedAreaDiagramClass
      : TcxGridChartStackedAreaDiagramClass; virtual;
    function GetStackedColumnDiagramClass
      : TcxGridChartStackedColumnDiagramClass; virtual;
    function GetStackedBarDiagramClass
      : TcxGridChartStackedBarDiagramClass; virtual;
    ...
    function CreateDiagram(ADiagramClass: TcxGridChartDiagramClass)
      : TcxGridChartDiagram;
    ...
    procedure UpdateDataController(AItem: TObject;
      ADataBinding: TcxGridChartItemDataBinding; AAdd: Boolean);
    procedure UpdateSummaryItemValues;

    function GetItemList(AItemClass: TcxGridChartItemClass): TList;
      overload; virtual;
    function GetItemList(AItemKind: TcxGridChartItemKind): TList;
      overload; virtual;
    ...
    procedure DataGroupVisibilityChanged(ADataGroup
      : TcxGridChartDataGroup); virtual;
    ...
    procedure ItemVisibilityForCustomizationChanged
      (AItem: TcxGridChartItem); virtual;
    ...
    function FindItemByID(AItemClass: TcxGridChartItemClass; AID: Integer)
      : TcxGridChartItem;
    function FindItemByName(AItemClass: TcxGridChartItemClass;
      const AName: string): TcxGridChartItem;
    function FindItemByTag(AItemClass: TcxGridChartItemClass; ATag: TcxTag)
      : TcxGridChartItem;
    ...
    function GetDataObjectLevel(AObject: TcxGridChartDataGroup)
      : Integer; virtual;
    procedure SetDataObjectLevel(AObject: TcxGridChartDataGroup;
    ...
    function DoValueClick(ASeries: TcxGridChartSeries; AValueIndex: Integer)
      : Boolean; virtual;
    function HasCustomDrawLegend: Boolean; virtual;
    function HasCustomDrawLegendItem: Boolean; virtual;

    property DataGroupActiveValuesUpdateNeeded: Boolean
      read FDataGroupActiveValuesUpdateNeeded;
    property ItemCount: Integer read GetItemCount;
    property Items[Index: Integer]: IcxGridChartItem read GetItem;
    property RestoringDataGroups: TcxGridOpenChartItemList
      read FRestoringDataGroups;
    property RestoringSeries: TcxGridOpenChartItemList read FRestoringSeries;
  public
    // base
    function CreateImage(AGraphicClass: TGraphicClass; AWidth: Integer = 0;
      AHeight: Integer = 0): TGraphic;
    property Controller: TcxGridChartController read GetController;
    property ViewData: TcxGridChartViewData read GetViewData;
    property ViewInfo: TcxGridChartViewInfo read GetViewInfo;

    // diagrams
    function FindDiagramByDisplayText(const ADisplayText: string)
      : TcxGridChartDiagram;
    ...
    property AvailableDiagrams[Index: Integer]: TcxGridChartDiagram
      read GetAvailableDiagram;
    ...
    property Series[Index: Integer]: TcxGridChartSeries read GetSeries
      write SetSeries;
    property SeriesCount: Integer read GetSeriesCount;
    property SortedSeries: TcxGridChartSeries read GetSortedSeries
      write SetSortedSeries;
    property VisibleSeries[Index: Integer]: TcxGridChartSeries
      read GetVisibleSeries;
    ...
    property VisibleSeriesGroupIndex[Index: Integer]: Integer
      read GetVisibleSeriesGroupIndex;
    ...
    property ActiveDataGroup: TcxGridChartDataGroup read GetActiveDataGroup
      write SetActiveDataGroup;
    property ActiveDataLevel: Integer read FActiveDataLevel
      write SetActiveDataLevel;
    property DataLevelCount: Integer read GetDataLevelCount;
    property DataLevelObjects[Index: Integer]: TcxGridChartDataGroup
      read GetDataLevelObject;
    property DataGroupCount: Integer read GetDataGroupCount;
    property DataGroups[Index: Integer]: TcxGridChartDataGroup read GetDataGroup
      write SetDataGroup;
    property IsDataGrouped: Boolean read GetIsDataGrouped;
    property VisibleDataGroupCount: Integer read GetVisibleDataGroupCount;
    property VisibleDataGroups[Index: Integer]: TcxGridChartDataGroup
      read GetVisibleDataGroup;
  published
    property ActiveDiagram: TcxGridChartDiagram read FActiveDiagram
      write SetActiveDiagram stored False;
    property Categories: TcxGridChartCategories read FCategories
      write SetCategories;
    property DataController: TcxGridChartDataController read GetDataController
      write SetDataController;
    property DiagramArea: TcxGridChartAreaDiagram read FDiagramArea
      write SetDiagramArea;
    property DiagramBar: TcxGridChartBarDiagram read FDiagramBar
      write SetDiagramBar;
    property DiagramColumn: TcxGridChartColumnDiagram read FDiagramColumn
      write SetDiagramColumn;
    property DiagramLine: TcxGridChartLineDiagram read FDiagramLine
      write SetDiagramLine;
    property DiagramPie: TcxGridChartPieDiagram read FDiagramPie
      write SetDiagramPie;
    property DiagramStackedArea: TcxGridChartStackedAreaDiagram
      read FDiagramStackedArea write SetDiagramStackedArea;
    property DiagramStackedBar: TcxGridChartStackedBarDiagram
      read FDiagramStackedBar write SetDiagramStackedBar;
    property DiagramStackedColumn: TcxGridChartStackedColumnDiagram
      read FDiagramStackedColumn write SetDiagramStackedColumn;
    property Legend: TcxGridChartLegend read FLegend write SetLegend;
    property OptionsBehavior: TcxGridChartOptionsBehavior
      read GetOptionsBehavior write SetOptionsBehavior;
    property OptionsCustomize: TcxGridChartOptionsCustomize
    ...
    property CategoriesEvents: TNotifyEvent read FSubClassEvents
      write FSubClassEvents;
    property DiagramAreaEvents: TNotifyEvent read FSubClassEvents
      write FSubClassEvents;
    property DiagramBarEvents: TNotifyEvent read FSubClassEvents
      write FSubClassEvents;
    property DiagramColumnEvents: TNotifyEvent read FSubClassEvents
      write FSubClassEvents;
    property DiagramLineEvents: TNotifyEvent read FSubClassEvents
      write FSubClassEvents;
    property DiagramPieEvents: TNotifyEvent read FSubClassEvents
      write FSubClassEvents;
    property DiagramStackedAreaEvents: TNotifyEvent read FSubClassEvents
      write FSubClassEvents;
    property DiagramStackedBarEvents: TNotifyEvent read FSubClassEvents
      write FSubClassEvents;
    property DiagramStackedColumnEvents: TNotifyEvent read FSubClassEvents
      write FSubClassEvents;

    property OnActiveDataLevelChanged: TNotifyEvent
      read FOnActiveDataLevelChanged write SetOnActiveDataLevelChanged;
    property OnActiveDiagramChanged: TcxGridChartDiagramEvent
      read FOnActiveDiagramChanged write SetOnActiveDiagramChanged;
    property OnCustomDrawLegend: TcxGridChartLegendCustomDrawEvent
      read FOnCustomDrawLegend write SetOnCustomDrawLegend;
    property OnCustomDrawLegendItem: TcxGridChartLegendItemCustomDrawEvent
      read FOnCustomDrawLegendItem write SetOnCustomDrawLegendItem;
    property OnCustomization;
    property OnDataGroupPosChanged: TcxGridChartDataGroupEvent
      read FOnDataGroupPosChanged write SetOnDataGroupPosChanged;
    property OnFirstVisibleCategoryIndexChanged: TNotifyEvent
      read FOnFirstVisibleCategoryIndexChanged
      write SetOnFirstVisibleCategoryIndexChanged;
    property OnGetValueHint: TcxGridChartGetValueHintEvent read FOnGetValueHint
      write SetOnGetValueHint;
    property OnInitStoredObject;
    property OnSeriesPosChanged: TcxGridChartSeriesEvent
      read FOnSeriesPosChanged write SetOnSeriesPosChanged;
    property OnValueClick: TcxGridChartValueClickEvent read FOnValueClick
      write SetOnValueClick;
  end;
...
const
  ColorCount = 24;
  Colors: array [0 .. ColorCount - 1] of TColor = ($60C1FF, $B4835C, $7C58A5,
    $657C6C, $6379E6, $9AA05B, $605DCF, $6A8846, $61A3F5, $58999E, $5A8CFF,
    $AD977A, $808E54, $95C9B9, $6763A5, $AC8C4D, $80E4FB, $956349, $4D50C0,
    $67B48B, $D6A584, $73D8DD, $89674D, $9CB5A5);
begin
...
begin
  ...
  Result := RGB(MulDiv(R, Alpha, 100) + MulDiv(255, 100 - Alpha, 100),
    MulDiv(G, Alpha, 100) + MulDiv(255, 100 - Alpha, 100),
    MulDiv(B, Alpha, 100) + MulDiv(255, 100 - Alpha, 100));
end;

procedure PositionRect(out R: TRect; var AClientR: TRect;
  AWidth, AHeight, AOffset: Integer; APosition: TcxGridChartPartPosition);
begin
  R := AClientR;
  case APosition of
    cppLeft:
...
procedure AlignRect(var R: TRect; AWidth, AHeight: Integer;
  AIsHorizontal: Boolean; AAlignment: TcxGridChartPartAlignment);
var
  AOriginalR: TRect;
begin
  AOriginalR := R;
...
procedure GetCenteredRect(const ACenter: TPoint; AWidth, AHeight: Integer;
  out R: TRect);
begin
...
function IsValueTypeValid(AValueType: TVarType;
...
begin
  Result := (AValueType in ValidIntegerValueTypes) or not AOnlyIntegerTypes and
    ((AValueType in ValidFloatValueTypes){$IFNDEF NONDB} or
    (AValueType = VarFMTBcd){$ENDIF});
end;
...
function GetPointOnCircle(const ACenter: TPoint;
  ARadius, AAngle: Integer): TPoint;
var
  ASin, ACos: Extended;
begin
...
function LineHasPoint(const ALineStart, ALineFinish: TPoint;
...
begin
  ...
  begin
    ...
    AHotZoneSizeY := Abs(Round(Max(AHotZoneMinWidth, ALineWidth div 2) *
      Sqrt(1 + Sqr((ALineFinish.Y - ALineStart.Y) / (ALineFinish.X -
      ALineStart.X)))));
    Result := (ALineIntersectionY - AHotZoneSizeY <= P.Y) and
...
begin
  ...
  begin
    ...
    FDataLevelObject := TcxGridChartDataLevelInfoHitTest(Source)
      .FDataLevelObject;
    DataLevelObjectContainerKind := TcxGridChartDataLevelInfoHitTest(Source)
      .DataLevelObjectContainerKind;
  end;
end;
...
procedure TcxGridChartDataLevelInfoHitTest.SetDataLevelObject
  (Value: TcxGridChartDataGroup);
begin
...
function TcxGridChartDataLevelInfoHitTest.DragAndDropObjectClass
  : TcxCustomGridDragAndDropObjectClass;
begin
  if (DataLevelObject <> nil) and DataLevelObject.CanMove then
    Result := TcxGridChartView(GridView)
      .Controller.GetDataLevelInfoDragAndDropObjectClass
  else
    Result := nil;
end;
...
begin
  ...
  if Source is TcxGridChartDataLevelActiveValueInfoHitTest then
    CanDropDown := TcxGridChartDataLevelActiveValueInfoHitTest(Source)
      .CanDropDown;
end;

class function TcxGridChartDataLevelActiveValueInfoHitTest.
  GetHitTestCode: Integer;
begin
...
function TcxGridChartDataLevelActiveValueInfoHitTest.DragAndDropObjectClass
  : TcxCustomGridDragAndDropObjectClass;
begin
  if CanDropDown then
    Result := nil
...
class function TcxGridChartHistogramValueAxisTitleHitTest.
  GetHitTestCode: Integer;
begin
...
function TcxCustomGridChartMovingObject.GetCustomizationForm
...
procedure TcxGridChartDataGroupMovingObject.SetSourceItem
  (Value: TcxGridChartDataGroup);
begin
...
function TcxGridChartDataGroupMovingObject.GetArrowAreaBounds
  (APlace: TcxGridArrowPlace): TRect;
begin
  Result := ViewInfo.ToolBoxViewInfo.GetDataGroupInsertionBounds(DestDataLevel);
end;

function TcxGridChartDataGroupMovingObject.GetCustomizationFormListBox
  : TcxCustomGridItemsListBox;
begin
  Result := CustomizationForm.DataGroupsListBox;
end;

function TcxGridChartDataGroupMovingObject.GetSourceItemViewInfo
...
begin
  Result := (DestDataLevel <> -1) and
    (not SourceItem.Visible or (DestDataLevel < SourceItem.DataLevel) or
    (DestDataLevel > SourceItem.DataLevel + 1));
end;
...
procedure TcxGridChartDataGroupMovingObject.DragAndDrop(const P: TPoint;
...
begin
  ...
  else if IsValidDestination then
  begin
...
procedure TcxGridChartDataGroupMovingObject.Init(const P: TPoint;
...
function TcxGridChartSeriesCheckListBox.GetSeries(AIndex: Integer)
  : TcxGridChartSeries;
begin
  Result := TcxGridChartSeries(Items[AIndex].ItemObject);
end;

procedure TcxGridChartSeriesCheckListBox.CheckClicked(Sender: TObject;
...
procedure TcxGridChartSeriesCheckListBox.DragOver(Source: TObject;
...
function TcxGridChartSeriesCheckListBox.GetInnerCheckListBoxClass
  : TcxCustomInnerCheckListBoxClass;
begin
  Result := TcxGridChartSeriesInnerCheckListBox;
end;

procedure TcxGridChartSeriesCheckListBox.LookAndFeelChanged
...
begin
  ...
  SeriesImages.Width := TcxGridChartSeriesInnerCheckListBox(InnerCheckListBox)
    .GetSeriesImageSize;
  ...
  try
    ...
    begin
      DrawSeriesImage(AImageCanvas, Rect(0, 0, AImage.Width, AImage.Height),
        Series[I]);
...
function TcxGridChartSeriesCheckListBox.StartDrag
  (DragObject: TDragObject): Boolean;
var
  AItemIndex: Integer;
begin
...
procedure TcxGridChartSortBySeriesComboBox.DoButtonClick(AButtonVisibleIndex
  : Integer);
begin
...
procedure TcxGridChartSortBySeriesComboBox.DrawItem(AControl: TcxCustomComboBox;
  ...
  begin
    Result := ARect;
    AKeySize := TdxTextMeasurer.TextLineHeight(ACanvas.Handle) - 2 *
      ScaleFactor.Apply(KeyOffset);
...
begin
  Result := 2 * (LookAndFeelPainter.ChartToolBoxDataLevelInfoBorderSize +
    ScaleFactor.Apply(cxTextOffset)) + TdxTextMeasurer.TextLineHeight(Font);
end;
...
function TcxGridChartDataGroupsListBox.GetDragAndDropParams
...
begin
  ...
  ACanvas.Rectangle(R, AParams, cxBordersAll,
...
constructor TcxGridChartOptionsTreeView.Create(AOwner: TComponent;
  AGridView: TcxGridChartView);
begin
  inherited Create(AOwner);
  FGridView := AGridView;
...
begin
  ...
  LegendPositionID := AddCategory(LegendID, -1,
    cxGetResourceString(@scxGridChartPosition));
  AddRadioButtons(LegendPositionID, TypeInfo(TcxGridChartPartPosition),
    @GetChartPartPositionItemCaption);
  LegendAlignmentID := AddCategory(LegendID, -1,
    cxGetResourceString(@scxGridChartAlignment));
  AddRadioButtons(LegendAlignmentID, TypeInfo(TcxGridChartPartAlignment),
    @GetChartPartAlignmentItemCaption);
  LegendOrientationID := AddCategory(LegendID, -1,
    cxGetResourceString(@scxGridChartOrientation));
  AddRadioButtons(LegendOrientationID, TypeInfo(TcxGridChartPartOrientation),
    @GetChartPartOrientationItemCaption);
  LegendBorderID := AddCheckBox(LegendID, -1,
    cxGetResourceString(@scxGridChartBorder));
  LegendKeyBorderID := AddCheckBox(LegendID, -1,
    cxGetResourceString(@scxGridChartLegendKeyBorder));
  // Title
  TitleID := AddCategory(-1, -1, cxGetResourceString(@scxGridChartTitle));
  TitlePositionID := AddCategory(TitleID, -1,
    cxGetResourceString(@scxGridChartPosition));
  AddRadioButtons(TitlePositionID, TypeInfo(TcxGridChartPartPosition),
    @GetChartPartPositionItemCaption);
  TitleAlignmentID := AddCategory(TitleID, -1,
    cxGetResourceString(@scxGridChartAlignment));
  AddRadioButtons(TitleAlignmentID, TypeInfo(TcxGridChartPartAlignment),
    @GetChartPartAlignmentItemCaption);
  // ToolBox
  ToolBoxID := AddCategory(-1, -1, cxGetResourceString(@scxGridChartToolBox));
  ToolBoxPositionID := AddCategory(ToolBoxID, -1,
    cxGetResourceString(@scxGridChartPosition));
  AddRadioButtons(ToolBoxPositionID, TypeInfo(TcxGridChartToolBoxPosition),
    @GetChartToolBoxPositionItemCaption);
  ToolBoxBorderID := AddCheckBox(ToolBoxID, -1,
    cxGetResourceString(@scxGridChartBorder));
  ToolBoxDiagramSelectorID := AddCheckBox(ToolBoxID, -1,
    cxGetResourceString(@scxGridChartDiagramSelector));
  // Other
  OtherID := AddCategory(-1, -1, cxGetResourceString(@scxGridChartOther));
  OtherValueHintsID := AddCheckBox(OtherID, -1,
    cxGetResourceString(@scxGridChartValueHints));
end;

function TcxGridChartOptionsTreeView.IsItemChecked(AParentID,
  AID: Integer): Boolean;
begin
  Result := False;
  // Legend
  ...
  if AID = LegendKeyBorderID then
    with GridView.ActiveDiagram.Legend do
      if GetKeyBorder = lbNone then
        ...
        KeyBorder := lbNone;
  if AParentID = LegendOrientationID then
    GridView.ActiveDiagram.Legend.Orientation :=
      TcxGridChartPartOrientation(AID);
  if AParentID = LegendPositionID then
...
begin
  Result := (GridView.SortedSeries = nil) or
    GridView.SortedSeries.VisibleForCustomization;
end;
...
function TcxGridChartCustomizationForm.GetDataGroupsListBoxClass
  : TcxGridChartDataGroupsListBoxClass;
begin
...
function TcxGridChartCustomizationForm.GetOptionsTreeViewClass
  : TcxGridChartOptionsTreeViewClass;
begin
  Result := TcxGridChartOptionsTreeView;
end;

function TcxGridChartCustomizationForm.GetSeriesCheckListBoxClass
  : TcxGridChartSeriesCheckListBoxClass;
begin
...
function TcxGridChartCustomizationForm.GetSortBySeriesComboBoxClass
  : TcxGridChartSortBySeriesComboBoxClass;
begin
...
begin
  ...
  FDataGroupsPage :=
    CreatePage(cxGetResourceString
...
constructor TcxGridChartDataLevelActiveValuePopup.Create
...
procedure TcxGridChartDataLevelActiveValuePopup.ListBoxAction
...
begin
  ListBox.VisibleItemCount :=
    GridView.ToolBox.DataLevelActiveValueDropDownCount;
...
procedure TcxGridChartDataLevelActiveValuePopup.PopulateListBox
  (AStrings: TStrings);
var
  I: Integer;
begin
...
constructor TcxGridChartDiagramSelectorPopup.Create
  (AGridView: TcxCustomGridView);
begin
  inherited;
  FListBox := TcxGridPopupListBox.Create(Self);
...
procedure TcxGridChartDiagramSelectorPopup.ListBoxAction
  (Sender: TdxCustomListBox; AItemIndex: Integer);
begin
...
function TcxGridChartController.GetCustomizationForm
  : TcxGridChartCustomizationForm;
begin
  Result := TcxGridChartCustomizationForm(inherited CustomizationForm);
end;

function TcxGridChartController.GetDataLevelActiveValuePopup
  : TcxGridChartDataLevelActiveValuePopup;
begin
  if FDataLevelActiveValuePopup = nil then
    FDataLevelActiveValuePopup := GetDataLevelActiveValuePopupClass.Create
      (GridView);
  Result := FDataLevelActiveValuePopup;
end;

function TcxGridChartController.GetDiagramSelectorPopup
  : TcxGridChartDiagramSelectorPopup;
begin
...
begin
  ...
  begin
    Value := Max(Value, 0);
    Value := Min(Value, GridView.ViewData.VisibleCategoryCount -
...
procedure TcxGridChartController.ActiveDataLevelChanged(APrevActiveDataLevel,
  AActiveDataLevel: Integer);
begin
  if (0 <= APrevActiveDataLevel) and
    (APrevActiveDataLevel < GridView.DataLevelCount) then
    FFirstVisibleCategoryIndexes[APrevActiveDataLevel] :=
      FFirstVisibleCategoryIndex;
  if AActiveDataLevel <> -1 then
    if ActiveDiagramSupportsPaging then
      FirstVisibleCategoryIndex := FFirstVisibleCategoryIndexes
        [AActiveDataLevel]
    else
      FFirstVisibleCategoryIndex := FFirstVisibleCategoryIndexes
        [AActiveDataLevel];
end;

procedure TcxGridChartController.ActiveDiagramChanged
  (ADiagram: TcxGridChartDiagram);
begin
  FirstVisibleCategoryIndexChanged;
end;
...
function TcxGridChartController.GetDataLevelActiveValuePopupClass
  : TcxGridChartDataLevelActiveValuePopupClass;
begin
  Result := TcxGridChartDataLevelActiveValuePopup;
end;

function TcxGridChartController.GetDesignHitTest
  (AHitTest: TcxCustomGridHitTest): Boolean;
begin
  Result := inherited GetDesignHitTest(AHitTest);
  if not Result then
    Result := AHitTest.HitTestCode in [htLegendItem, htDataLevelInfo,
      htDiagramSelector, htChartValue, htChartValueLine, htChartValueArea,
      htSeriesSite, htSeriesSiteCaption];
end;

function TcxGridChartController.GetDiagramSelectorPopupClass
  : TcxGridChartDiagramSelectorPopupClass;
begin
  Result := TcxGridChartDiagramSelectorPopup;
end;

function TcxGridChartController.GetPatternObject(AObject: TPersistent)
  : TPersistent;
begin
  if AObject is GridView.GetCategoriesClass then
    Result := TcxGridChartView(GridView.PatternGridView).Categories
  else if AObject is GridView.GetDataGroupClass then
    Result := TcxGridChartView(GridView.PatternGridView)
      .FindDataGroupByID(TcxGridChartDataGroup(AObject).ID)
  else if AObject is GridView.GetSeriesClass then
    Result := TcxGridChartView(GridView.PatternGridView)
      .FindSeriesByID(TcxGridChartSeries(AObject).ID)
  else
...
function TcxGridChartController.GetVisibleCategoryCount
  (ACheckCount: Boolean): Integer;
begin
  Result := GridView.ViewData.VisibleCategoryCount;
  if ActiveDiagramSupportsPaging and
    (GridView.OptionsView.CategoriesPerPage <> 0) then
  begin
    Result := Min(Result, GridView.OptionsView.CategoriesPerPage);
    if ACheckCount then
      Result := Min(Result, Max(0, GridView.ViewData.VisibleCategoryCount -
...
function TcxGridChartController.MayDataDrillDown(ACheckDesignTime
...
var
  ADelta: Integer;
begin
  if AScrollBarKind <> GetScrollBarKind then
    Exit;
  ADelta := 0;
  case AScrollCode of
    scLineUp:
  ...
  if ADelta <> 0 then
  begin
    if GridView.ActiveDiagram.PagingInOppositeDirection xor UseRightToLeftAlignment
    then
      ADelta := -ADelta;
...
function TcxGridChartController.ScrollPosToCategoryIndex
...
function TcxGridChartController.CanShowDataLevelActiveValuePopup
  (ACheckDesignTime: Boolean = True): Boolean;
begin
  Result := MayDataDrillDown(ACheckDesignTime);
end;

function TcxGridChartController.CreateCustomizationController
  : TcxCustomGridCustomizationController;
begin
  Result := TcxGridChartCustomizationController.Create(GridView);
end;

function TcxGridChartController.GetCustomizationFormClass
  : TcxCustomGridCustomizationFormClass;
begin
  Result := TcxGridChartCustomizationForm;
end;

function TcxGridChartController.GetDataLevelInfoDragAndDropObjectClass
...
procedure TcxGridChartController.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
  if (Button = mbRight) and not(ssDouble in Shift) and
    (GridView.OptionsCustomize.DataDrillUpMethod = ddumMouseRightButtonClick)
  then
    DoDataDrillUp;
end;
...
function TcxGridChartController.GetValueHintText(ASeries: TcxGridChartSeries;
  AValueIndex: Integer): string;
begin
  Result := Format(cxGetResourceString(@scxGridChartValueHintFormat),
    [ASeries.GetDisplayText, GridView.Categories.VisibleDisplayTexts
    [AValueIndex], ASeries.VisibleDisplayTexts[AValueIndex]]);
...
begin
  ...
  GridView.BeginUpdate;
  try
    GridView.ActiveDataGroup.ActiveValue :=
      GridView.ActiveDataGroup.VisibleValues[AValueIndex];
...
function TcxGridChartController.IsDataDrillDownPossible
...
begin
  Result := (GridView.ActiveDiagram <> nil) and
    GridView.ActiveDiagram.SupportsPaging;
end;
...
procedure TcxGridChartDataController.SetOnAfterSummary
  (Value: TcxAfterSummaryEvent);
begin
...
procedure TcxGridChartDataController.AssignData(ADataController
...
procedure TcxGridChartDataController.DoValueTypeClassChanged
  (AItemIndex: Integer);
var
...
function TcxGridChartDataController.GetSortingBySummaryEngineClass
...
procedure TcxGridChartViewPainterHelper.Pie(const R: TRect;
  AStartAngle, ASweepAngle: Integer);
begin
...
const
  ...
  PenStyles: array [psSolid .. psInsideFrame] of Word = (PS_SOLID, PS_DASH,
    PS_DOT, PS_DASHDOT, PS_DASHDOTDOT, PS_NULL, PS_SOLID);
begin
  APenParams.lbStyle := BS_SOLID;
  APenParams.lbColor := RealPenColor;
  APenParams.lbHatch := 0;
  Result := ExtCreatePen(PenTypes[PenWidth <> 1] or PenStyles[PenStyle],
    PenWidth, APenParams, 0, nil);
end;
...
procedure TcxGridChartViewGDIPlusPainterHelper.Pie(const R: TRect;
  AStartAngle, ASweepAngle: Integer);
var
...
begin
  ...
  begin
    ...
    try
      ...
      AGraphics.Pie(R, AStartAngle, ASweepAngle, RealPenColor,
        Canvas.Brush.Color, PenWidth - 0.2, PenStyle, 255, 255);
    finally
...
procedure TcxGridChartViewGDIPlusPainterHelper.Polygon
...
begin
  ...
  try
    ...
    if PenStyle = psClear then
      APenAlphaChannel := 0;
    AGraphics.Polygon(Points, RealPenColor, Canvas.Brush.Color, PenWidth - 0.2,
      PenStyle, APenAlphaChannel, ABrushAlphaChannel);
  finally
    dxGpEndPaint(AGraphics);
  end;
end;

procedure TcxGridChartViewGDIPlusPainterHelper.Polyline
  (const Points: array of TPoint);
var
  AGraphics: TdxGPGraphics;
begin
...
function TcxGridChartLegendItemPainter.GetViewInfo
  : TcxGridChartLegendItemViewInfo;
begin
...
begin
  Canvas.Rectangle(ViewInfo.LegendKeyBounds, ViewInfo.LegendKeyParams,
    ViewInfo.LegendKeyBorders,
    dxGetDarkerColor(ViewInfo.LegendKeyParams.Color, 75));
end;
    ...
    begin
      ...
      begin
        ...
        try
          ...
          if ARegion.IsEmpty or not ViewInfo.GridView.OptionsView.TransparentCaptions
          then
          begin
...
procedure TcxGridChartDiagramPainter.PrepareClipRegionForValueDrawing
  ...
  AOriginalClipRegion: TcxRegion);
begin
end;

{ TcxGridChartHistogramTickMarkLabelsPainter }

function TcxGridChartHistogramTickMarkLabelsPainter.GetViewInfo
  : TcxGridChartHistogramTickMarkLabelsViewInfo;
begin
...
function TcxGridChartHistogramPainter.GetViewInfo
...
begin
  AClipRegion := Canvas.GetClipRegion;
  try
    if ViewInfo.HasCategoryAxis then
      DrawCategoryAxis;
    if ViewInfo.HasValueAxis then
      DrawValueAxis;
    APlotClipRegion := Canvas.GetClipRegion;
    try
      APlotClipRegion.Combine(ViewInfo.PlotBounds, roSubtract);
      if not TransparentValues then
        DrawValues;
      SetValuesClipRegion;
      AValuesClipRegion := Canvas.GetClipRegion;
      if ViewInfo.HasCategoryGridLines then
        DrawCategoryGridLines;
      if ViewInfo.HasValueGridLines then
        DrawValueGridLines;
...
function TcxGridChartLineDiagramLegendItemPainter.GetViewInfo
  : TcxGridChartLineDiagramLegendItemViewInfo;
begin
...
begin
  ViewInfo.GetDiagramValueViewInfoClass.GetPainterClassEx.DrawLineEx(Canvas,
    ViewInfo.LineStart, ViewInfo.LineFinish, ViewInfo.LineStyle,
...
begin
  ViewInfo.GetDiagramValueViewInfoClass.GetPainterClassEx.DrawMarkerEx(Canvas,
    ViewInfo.MarkerBounds, ViewInfo.MarkerPoints, ViewInfo.MarkerStyle,
    ViewInfo.MarkerParams, ViewInfo.GridView.OptionsView.Antialiasing);
end;

{ TcxGridChartLineDiagramValuePainter }

function TcxGridChartLineDiagramValuePainter.GetViewInfo
  : TcxGridChartLineDiagramValueViewInfo;
begin
...
begin
  DrawLineEx(Canvas, ViewInfo.LineStart, ViewInfo.LineFinish,
    ViewInfo.LineStyle, ViewInfo.LineWidth, ViewInfo.LineColor,
    ViewInfo.GridView.OptionsView.Antialiasing);
end;
...
class procedure TcxGridChartLineDiagramValuePainter.DrawLineEx
  (ACanvas: TcxCanvas; const AStart, AFinish: TPoint;
  AStyle: TcxGridChartLineStyle; AWidth: Integer; AColor: TColor;
...
class procedure TcxGridChartLineDiagramValuePainter.DrawLines
  (ACanvas: TcxCanvas; const APoints: TPoints; AStyle: TcxGridChartLineStyle;
  AWidth: Integer; AColor: TColor; Antialiasing: Boolean);
begin
  if AStyle = clsNone then
    Exit;
...
class procedure TcxGridChartLineDiagramValuePainter.DrawMarkerEx
  (ACanvas: TcxCanvas; const ABounds: TRect; const APoints: TPoints;
  AStyle: TcxGridChartMarkerStyle; const AParams: TcxViewParams;
  Antialiasing: Boolean);
var
...
var
  APoints: TPoints;
begin
  if ViewInfo.LineStyle = clsNone then
    Exit;
...
function TcxGridChartAreaDiagramValuePainter.GetViewInfo
...
begin
  with PainterHelperClasses[ViewInfo.GridView.OptionsView.Antialiasing and
    CheckGdiPlus].Create(Canvas) do
    try
...
begin
  ...
  begin
    AValueViewInfo := TcxGridChartAreaDiagramValueViewInfo
      (ViewInfo.ValueViewInfos[I]);
    with TcxGridChartAreaDiagramValuePainter
      (AValueViewInfo.GetPainterClass.Create(Canvas, AValueViewInfo)) do
      try
        DoDrawArea;
      finally
        Free;
    ...
    if TcxGridChartAreaDiagramViewInfo(ViewInfo).ExcludeEachSeriesArea and
      ((I = ViewInfo.ValueViewInfoCount - 1) or
      (ViewInfo.ValueViewInfos[I + 1].SeriesIndex <> AValueViewInfo.SeriesIndex))
    then
    begin
...
function TcxGridChartPieDiagramValuePainter.GetViewInfo
  : TcxGridChartPieDiagramValueViewInfo;
begin
...
begin
  with PainterHelperClasses[ViewInfo.GridView.OptionsView.Antialiasing and
    ...
    try
      ...
      Pie(ViewInfo.Bounds, 90 - ViewInfo.FinishAngle, ViewInfo.FinishAngle -
        ViewInfo.StartAngle);
    finally
      Free;
    end;
...
begin
  inherited;
  if NeedsPainting and
    (ViewInfo.CaptionPosition = pdvcpOutsideEndWithLeaderLines) then
    DrawLeaderLine;
end;
...
function TcxGridChartPieDiagramPainter.GetViewInfo
...
begin
  ...
  begin
    ...
    ASeriesSiteViewInfo.GetPainterClass.DoDrawDesignSelection(Canvas,
      ASeriesSiteViewInfo);
  end;
end;
...
begin
  for I := 0 to ViewInfo.SeriesSiteViewInfoCount - 1 do
    ...
    begin
      ...
      InflateRect(R, -1, -1);
      // to fill the gap between drawn pie and elliptic region
      if not IsRectEmpty(R) then
        Canvas.SetClipRegion(TcxRegion.Create(CreateEllipticRgnIndirect(R)),
          roSubtract);
    end;
end;
...
var
  ARegion: TcxRegion;
begin
  if AValueViewInfo.VisibleValueIndex <> 0 then
    Exit;
  ARegion := TcxRegion.Create(ViewInfo.SeriesSiteViewInfos
    [AValueViewInfo.SeriesIndex].ContentBounds);
...
function TcxGridChartToolBoxDataLevelActiveValuePainter.GetViewInfo
  : TcxGridChartToolBoxDataLevelActiveValueViewInfo;
begin
  Result := TcxGridChartToolBoxDataLevelActiveValueViewInfo(inherited ViewInfo);
end;

procedure TcxGridChartToolBoxDataLevelActiveValuePainter.
...
function TcxGridChartToolBoxCustomizeButtonPainter.GetViewInfo
  : TcxGridChartToolBoxCustomizeButtonViewInfo;
begin
...
function TcxGridChartToolBoxDiagramSelectorPainter.GetViewInfo
  : TcxGridChartToolBoxDiagramSelectorViewInfo;
begin
...
begin
  if ViewInfo.ImageIndex <> -1 then
    cxDrawImage(Canvas, ViewInfo.ImageBounds, nil, cxGridChartDiagramImages,
      ViewInfo.ImageIndex, True, nil, ScaleFactor);
end;
...
function TcxGridChartViewData.GetGroupValue(ADataGroupIndex,
  AIndex: Integer): Variant;
begin
  Result := DataController.Values[AIndex, GridView.DataGroups[ADataGroupIndex]
    .DataBinding.DataIndex];
end;

function TcxGridChartViewData.GetIsEmptyValue(ASeriesIndex,
  ...
  if IsDataGrouped then
    ...
    begin
      AValue := DataController.Summary.GroupSummaryValues
        [ChildDataGroupIndex[AIndex], GridView.Series[ASeriesIndex]
        .DataBinding.SummaryIndex];
    end
    else
      AValue := DataController.Values[ChildRecordIndex[AIndex],
        GridView.Series[ASeriesIndex].DataBinding.DataIndex]
  else
    AValue := DataController.Values[AIndex, GridView.Series[ASeriesIndex]
      .DataBinding.DataIndex];
...
function TcxGridChartViewData.GetVisibleGroupValue(AVisibleDataGroupIndex,
  AIndex: Integer): Variant;
begin
  Result := DataController.Groups.GroupValues
    [DataController.Groups.ChildDataGroupIndex
    [GetDataGroupIndexByLevel(AVisibleDataGroupIndex), AIndex]];
end;

function TcxGridChartViewData.GetVisibleGroupValueCount(AVisibleDataGroupIndex
  : Integer): Integer;
begin
  Result := DataController.Groups.ChildCount
    [GetDataGroupIndexByLevel(AVisibleDataGroupIndex)];
end;

function TcxGridChartViewData.GetVisibleValue(ASeriesIndex,
  AIndex: Integer): Variant;
begin
  if IsDataGrouped then
    if IsSummaryLevel then
...
procedure TcxGridChartViewData.SetCategory(AIndex: Integer;
  const Value: Variant);
begin
...
procedure TcxGridChartViewData.SetGroupValue(ADataGroupIndex, AIndex: Integer;
  const Value: Variant);
begin
  DataController.Values[AIndex, GridView.DataGroups[ADataGroupIndex]
    .DataBinding.DataIndex] := Value;
end;

procedure TcxGridChartViewData.SetValue(ASeriesIndex, AIndex: Integer;
  const Value: Variant);
begin
  DataController.Values[AIndex, GridView.Series[ASeriesIndex]
    .DataBinding.DataIndex] := Value;
end;
...
function TcxGridChartViewData.CalculateSumOfValues(ASeriesIndex
  : Integer): Variant;
var
  I: Integer;
begin
...
procedure TcxGridChartViewData.CheckValueAtLevel(ALevel: Integer;
  var AValue: Variant);
var
...
begin
  ...
  if (ADataGroupIndex = -2) or
    (DataController.Groups.GetDataGroupIndexByGroupValue(ADataGroupIndex,
    AValue) = -1) then
    AValue := Null;
end;

function TcxGridChartViewData.GetDataGroupIndexByLevel(ALevel: Integer)
  : Integer;
var
...
begin
  ...
  begin
    ADataGroupIndex := DataController.Groups.GetDataGroupIndexByGroupValue
      (Result, (DataController.GetItem(DataController.Groups.GroupingItemIndex
      [I]) as TcxGridChartDataGroup).ActiveValue);
...
function TcxGridChartViewData.GetRecordIndexByValueIndex
  (AValueIndex: Integer): Integer;
begin
...
procedure TcxGridChartViewData.GetVisibleGroupValues
  (ADataGroup: TcxGridChartDataGroup; AStrings: TStrings;
...
constructor TcxCustomGridChartTitleViewInfo.Create(AGridViewInfo
  : TcxCustomGridViewInfo; ATitle: TcxCustomGridChartTitle);
begin
...
function TcxCustomGridChartTitleViewInfo.GetAlignment
...
function TcxCustomGridChartTitleViewInfo.GetDrawTextRotationAngle
  : TcxRotationAngle;
const
...
function TcxCustomGridChartTitleViewInfo.GetOrientation
  : TcxGridChartPartOrientation;
begin
  Result := cpoHorizontal;
end;

function TcxCustomGridChartTitleViewInfo.GetPainterClass
...
constructor TcxGridChartLegendItemViewInfo.Create
  (AContainer: TcxGridChartLegendViewInfo; AIndex: Integer);
begin
...
function TcxGridChartLegendItemViewInfo.GetHitTestClass
...
function TcxGridChartLegendItemViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
procedure TcxGridChartLegendItemViewInfo.GetViewParams
...
procedure TcxGridChartLegendItemViewInfo.InitHitTest
...
function TcxGridChartLegendItemViewInfo.MouseDown
  (AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
  AShift: TShiftState): Boolean;
begin
  Result := inherited MouseDown(AHitTest, AButton, AShift);
  if (Container.Kind = lkSeries) and (AButton = mbLeft) and
    not(ssDouble in AShift) and GridView.IsDesigning then
  begin
    GridView.Controller.DesignController.SelectObject(Series,
...
constructor TcxGridChartLegendViewInfo.Create(AGridViewInfo
  : TcxCustomGridViewInfo; ADiagram: TcxGridChartDiagram);
var
  I: Integer;
begin
  inherited Create(AGridViewInfo);
...
function TcxGridChartLegendViewInfo.GetItem(Index: Integer)
  : TcxGridChartLegendItemViewInfo;
begin
...
function TcxGridChartLegendViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  ...
  begin
    Result := GridView.Categories.VisibleDisplayTexts
      [GetItemValueIndex(AIndex)];
    if Result = '' then
      Result := '<' + IntToStr(1 + AIndex) + '>';
  end;
end;

function TcxGridChartLegendViewInfo.GetItemClass
  : TcxGridChartLegendItemViewInfoClass;
begin
...
function TcxGridChartLegendViewInfo.GetItemSeriesIndex(AIndex: Integer)
  : Integer;
begin
  if Kind = lkSeries then
    Result := GetItemObjectIndex(AIndex)
  else if GridView.VisibleSeriesCount = 1 then
    Result := 0
  else
    Result := -1;
end;
...
procedure TcxGridChartLegendViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
...
function TcxGridChartLegendViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  I: Integer;
  AHitTest: TcxCustomGridHitTest;
...
begin
  Diagram.Styles.GetValueParams(GetItemSeriesIndex(AIndex),
...
constructor TcxGridChartDiagramValueCaptionViewInfo.Create(AValueViewInfo
  : TcxGridChartDiagramValueViewInfo);
begin
...
function TcxGridChartDiagramValueCaptionViewInfo.GetAlignmentVert
  : TcxAlignmentVert;
begin
  Result := vaCenter;
end;

function TcxGridChartDiagramValueCaptionViewInfo.GetBorderColor
...
function TcxGridChartDiagramValueCaptionViewInfo.GetBorderWidth
  (AIndex: TcxBorder): Integer;
begin
  Result := 1;
end;

function TcxGridChartDiagramValueCaptionViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
function TcxGridChartDiagramValueCaptionViewInfo.CustomDraw
...
function TcxGridChartDiagramValueCaptionViewInfo.GetTextAttributes
  (AForPainting: Boolean): Integer;
begin
  Result := inherited GetTextAttributes(AForPainting) or cxDontClip;
end;

procedure TcxGridChartDiagramValueCaptionViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
constructor TcxGridChartDiagramValueViewInfo.Create(ADiagramViewInfo
  : TcxGridChartDiagramViewInfo; ASeriesIndex, AVisibleValueIndex: Integer);
begin
...
function TcxGridChartDiagramValueViewInfo.CustomDraw
  (ACanvas: TcxCanvas): Boolean;
begin
  Result := inherited CustomDraw(ACanvas);
  if not Result then
...
function TcxGridChartDiagramValueViewInfo.GetCaptionViewInfoClass
  : TcxGridChartDiagramValueCaptionViewInfoClass;
begin
...
procedure TcxGridChartDiagramValueViewInfo.GetCaptionViewParams
  (var AParams: TcxViewParams);
begin
...
function TcxGridChartDiagramValueViewInfo.GetHintTextRect(const AMousePos
  : TPoint): TRect;
begin
...
function TcxGridChartDiagramValueViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
procedure TcxGridChartDiagramValueViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
function TcxGridChartDiagramValueViewInfo.HasHintPoint(const P: TPoint)
  : Boolean;
begin
  Result := HasPoint(P);
end;

procedure TcxGridChartDiagramValueViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
  inherited;
  TcxGridChartValueHitTest(AHitTest).CanDrillDown :=
    Controller.IsDataDrillDownPossible(ValueIndex);
...
procedure TcxGridChartDiagramValueViewInfo.StateChanged
...
procedure TcxGridChartDiagramValueViewInfo.Calculate(ALeftBound,
...
function TcxGridChartDiagramValueViewInfo.MouseDown
  (AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
  AShift: TShiftState): Boolean;
begin
  Result := inherited MouseDown(AHitTest, AButton, AShift);
  if not(ssDouble in AShift) then
    if GridView.IsDesigning then
      ...
      begin
        Controller.DesignController.SelectObject(Series,
          not(ssShift in AShift));
        Result := True;
      end
      else
    ...
    begin
      ...
      if (AHitTest as TcxGridChartValueHitTest).CanDrillDown then
        case AButton of
          ...
          mbRight:
            if GridView.OptionsCustomize.DataDrillUpMethod = ddumValueMouseRightButtonClick
            then
...
constructor TcxGridChartDiagramViewInfo.Create(AGridViewInfo
  : TcxCustomGridViewInfo; ADiagram: TcxGridChartDiagram);
begin
  inherited Create(AGridViewInfo);
  FDiagram := ADiagram;
...
function TcxGridChartDiagramViewInfo.GetSeries(AIndex: Integer)
  : TcxGridChartSeries;
begin
...
function TcxGridChartDiagramViewInfo.GetValueViewInfoValue(Index: Integer)
  : TcxGridChartDiagramValueViewInfo;
begin
...
procedure TcxGridChartDiagramViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
  inherited;
...
function TcxGridChartDiagramViewInfo.CreateValueViewInfo(ASeriesIndex,
  AVisibleValueIndex: Integer): TcxGridChartDiagramValueViewInfo;
begin
  Result := GetValueViewInfoClass.Create(Self, ASeriesIndex,
    AVisibleValueIndex);
  FValueViewInfos.Add(Result);
end;

function TcxGridChartDiagramViewInfo.GetValue(ASeriesIndex,
  AIndex: Integer): Variant;
begin
  Result := GridView.VisibleSeries[ASeriesIndex].VisibleValues[AIndex];
end;

function TcxGridChartDiagramViewInfo.GetValueCaption(ASeriesIndex,
  AVisibleValueIndex: Integer): string;
begin
  Result := Diagram.GetValueCaption(GridView.VisibleSeries[ASeriesIndex],
    GetValueIndex(AVisibleValueIndex));
end;

function TcxGridChartDiagramViewInfo.GetValueIndex(AVisibleValueIndex
  : Integer): Integer;
begin
  Result := GridView.Controller.FirstVisibleCategoryIndex + AVisibleValueIndex;
end;

class function TcxGridChartDiagramViewInfo.GetValueViewInfoClass
  : TcxGridChartDiagramValueViewInfoClass;
begin
  Result := nil;
end;

function TcxGridChartDiagramViewInfo.GetVisibleCategory
  (AIndex: Integer): string;
begin
  Result := Categories[GetValueIndex(AIndex)];
end;

function TcxGridChartDiagramViewInfo.GetVisibleValue(ASeriesIndex,
  AIndex: Integer): Variant;
begin
...
function TcxGridChartDiagramViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  I: Integer;
begin
...
function TcxGridChartDiagramViewInfo.GetValueViewInfo(ASeriesIndex,
  AVisibleIndex: Integer): TcxGridChartDiagramValueViewInfo;
begin
...
function TcxGridChartHistogramLegendViewInfo.GetItemObjectIndex
...
function TcxGridChartHistogramValueViewInfo.GetDiagramViewInfo
  : TcxGridChartHistogramViewInfo;
begin
...
constructor TcxGridChartHistogramAxisTitleViewInfo.Create
...
function TcxGridChartHistogramAxisTitleViewInfo.GetTitle
  : TcxGridChartHistogramAxisTitle;
begin
  Result := TcxGridChartHistogramAxisTitle(inherited Title);
end;

procedure TcxGridChartHistogramAxisTitleViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
  FContainer.GetTitleViewParams(AParams);
end;

procedure TcxGridChartHistogramAxisTitleViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
...
constructor TcxGridChartHistogramTickMarkLabelsViewInfo.Create(ADiagramViewInfo
  : TcxGridChartHistogramViewInfo);
begin
  inherited Create(ADiagramViewInfo.GridViewInfo);
  FDiagramViewInfo := ADiagramViewInfo;
...
function TcxGridChartHistogramTickMarkLabelsViewInfo.GetCaptionBounds
  (Index: Integer): TRect;
begin
...
function TcxGridChartHistogramTickMarkLabelsViewInfo.GetCaptionWidth
...
function TcxGridChartHistogramTickMarkLabelsViewInfo.GetDiagram
  : TcxGridChartHistogram;
begin
  Result := FDiagramViewInfo.Diagram;
end;
...
procedure TcxGridChartHistogramTickMarkLabelsViewInfo.SetCaptionBounds
  (Index: Integer; const Value: TRect);
begin
  FCaptionBounds[Index] := Value;
end;

function TcxGridChartHistogramTickMarkLabelsViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridChartHistogramTickMarkLabelsPainter;
end;

function TcxGridChartHistogramTickMarkLabelsViewInfo.GetTitleViewInfoClass
  : TcxGridChartHistogramAxisTitleViewInfoClass;
begin
  Result := TcxGridChartHistogramAxisTitleViewInfo;
end;

function TcxGridChartHistogramTickMarkLabelsViewInfo.GetCaption
  (Index: Integer): string;
begin
  Result := Values[Index];
end;

function TcxGridChartHistogramTickMarkLabelsViewInfo.CalculateCaptionBounds
  ...
  begin
    ...
    begin
      if IsReverseOrder then
        ...
        ADirection := 1;
      if AIndex > 0 then
        Result.Left := Max(Result.Left, GetCaptionPosition(AIndex - ADirection)
          + ScaleFactor.Apply(cxTextOffset));
      if AIndex < Count - 1 then
        Result.Right := Min(Result.Right,
          GetCaptionPosition(AIndex + ADirection) -
          ScaleFactor.Apply(cxTextOffset));
      if Odd(AIndex) then
...
function TcxGridChartHistogramTickMarkLabelsViewInfo.CalculateHeight(AWidth,
  ALeftReduction, ARightReduction: Integer): Integer;
begin
  IsTwoRowLayout := CalculateIsTwoRowLayout(AWidth, ALeftReduction,
    ARightReduction);
  if IsVertical then
    Result := 0
  else
...
procedure TcxGridChartHistogramTickMarkLabelsViewInfo.CalculateTitleBounds
  (out ATitleBounds, AContentBounds: TRect);
begin
  ...
  begin
    ...
    AlignRect(ATitleBounds, TitleViewInfo.Width, TitleViewInfo.Height,
      not IsVertical, TitleViewInfo.Alignment);
  end
  else
    SetRectEmpty(ATitleBounds);
end;

function TcxGridChartHistogramTickMarkLabelsViewInfo.GetAlignmentHorz
  : TAlignment;
begin
  if IsVertical then
...
function TcxGridChartHistogramTickMarkLabelsViewInfo.GetCaptionsVisible
  : Boolean;
begin
...
function TcxGridChartHistogramTickMarkLabelsViewInfo.GetTextAttributes
  (AForPainting: Boolean): Integer;
begin
  Result := inherited GetTextAttributes(AForPainting) or cxDontClip or
    cxShowEndEllipsis;
end;
...
procedure TcxGridChartHistogramTickMarkLabelsViewInfo.Calculate(ALeftBound,
  ATopBound: Integer; AWidth: Integer = -1; AHeight: Integer = -1);
var
  ATitleBounds: TRect;
begin
...
procedure TcxGridChartHistogramTickMarkLabelsViewInfo.FitCaptionsHorz
  (AWidth: Integer; var ALeftReduction, ARightReduction: Integer);
var
  ACaptionSpace, ALeftOffset, ARightOffset: Integer;
begin
  if not CaptionsVisible then
    Exit;
  if IsTwoRowLayout and not IsEdgeCaptions then
  begin
    ACaptionSpace := GetCaptionSpace(AWidth, ALeftReduction, ARightReduction);
    ALeftOffset := Max(0, (CaptionWidths[0] - ACaptionSpace) div 2 -
      ALeftReduction);
    ARightOffset := Max(0, (CaptionWidths[Count - 1] - ACaptionSpace) div 2 -
      ARightReduction);

    Inc(ALeftReduction, MulDiv((2 * ARightOffset + (4 * Count - 2) *
      ALeftOffset), 1, 4 * Count - 4));
    Inc(ARightReduction,
      MulDiv((2 * ALeftOffset + (4 * Count - 2) * ARightOffset), 1,
      4 * Count - 4));
  end
  else if IsEdgeCaptions and (Count <> 0) then
...
function TcxGridChartHistogramTickMarkLabelsViewInfo.GetCaptionSpace(AWidth,
  ALeftReduction, ARightReduction: Integer): Integer;
var
  ACount: Integer;
begin
...
function TcxGridChartHistogramTickMarkLabelsViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
...
function TcxGridChartHistogramCategoryAxisTitleViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridChartHistogramCategoryTickMarkLabelsViewInfo.
  GetTitleViewInfoClass: TcxGridChartHistogramAxisTitleViewInfoClass;
begin
...
function TcxGridChartHistogramCategoryTickMarkLabelsViewInfo.
  GetIsReverseOrder: Boolean;
begin
  Result := DiagramViewInfo.IsCategoriesInReverseOrder;
end;

function TcxGridChartHistogramCategoryTickMarkLabelsViewInfo.GetValue
  (Index: Integer): Variant;
begin
  Result := DiagramViewInfo.VisibleCategories[Index];
end;

function TcxGridChartHistogramCategoryTickMarkLabelsViewInfo.GetAxis
  : TcxGridChartHistogramAxis;
begin
  Result := Diagram.AxisCategory;
end;

function TcxGridChartHistogramCategoryTickMarkLabelsViewInfo.GetCaptionPosition
  (AIndex: Integer): Integer;
begin
  Result := DiagramViewInfo.GetUnitOffset
    (DiagramViewInfo.GetCategoryTickMarkLabelOffsetUnits(AIndex));
end;

function TcxGridChartHistogramCategoryTickMarkLabelsViewInfo.
  GetIsEdgeCaptions: Boolean;
begin
  Result := DiagramViewInfo.IsEdgeCategoryTickMarkLabels;
end;

function TcxGridChartHistogramCategoryTickMarkLabelsViewInfo.GetPosition
  : TcxGridChartAxisPosition;
begin
  Result := DiagramViewInfo.CategoryAxisPosition;
end;

procedure TcxGridChartHistogramCategoryTickMarkLabelsViewInfo.GetTitleViewParams
  (var AParams: TcxViewParams);
begin
  Diagram.Styles.GetViewParams(dsCategoryAxisTitle, nil, nil, AParams);
end;

procedure TcxGridChartHistogramCategoryTickMarkLabelsViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
function TcxGridChartHistogramValueAxisTitleViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridChartHistogramValueTickMarkLabelsViewInfo.GetAxisValue
  : TcxGridChartHistogramAxisValue;
begin
  Result := TcxGridChartHistogramAxisValue(inherited Axis);
end;

function TcxGridChartHistogramValueTickMarkLabelsViewInfo.GetTitleViewInfoClass
  : TcxGridChartHistogramAxisTitleViewInfoClass;
begin
  Result := TcxGridChartHistogramValueAxisTitleViewInfo;
end;

function TcxGridChartHistogramValueTickMarkLabelsViewInfo.GetCaption
  (Index: Integer): string;
begin
...
function TcxGridChartHistogramValueTickMarkLabelsViewInfo.
  GetIsReverseOrder: Boolean;
begin
  Result := False;
end;

function TcxGridChartHistogramValueTickMarkLabelsViewInfo.GetValue
  (Index: Integer): Variant;
begin
  Result := DiagramViewInfo.ValueMarkValues[Index];
end;

function TcxGridChartHistogramValueTickMarkLabelsViewInfo.GetAxis
  : TcxGridChartHistogramAxis;
begin
  Result := Diagram.AxisValue;
end;

function TcxGridChartHistogramValueTickMarkLabelsViewInfo.GetCaptionPosition
  (AIndex: Integer): Integer;
begin
...
function TcxGridChartHistogramValueTickMarkLabelsViewInfo.GetPosition
  : TcxGridChartAxisPosition;
begin
  Result := DiagramViewInfo.ValueAxisPosition;
end;

procedure TcxGridChartHistogramValueTickMarkLabelsViewInfo.GetTitleViewParams
  (var AParams: TcxViewParams);
begin
  Diagram.Styles.GetViewParams(dsValueAxisTitle, nil, nil, AParams);
end;

procedure TcxGridChartHistogramValueTickMarkLabelsViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
constructor TcxGridChartHistogramViewInfo.Create(AGridViewInfo
  : TcxCustomGridViewInfo; ADiagram: TcxGridChartDiagram);
begin
  inherited;
  FCategoryTickMarkLabelsViewInfo := GetCategoryTickMarkLabelsViewInfoClass.
    Create(Self);
  FValueTickMarkLabelsViewInfo := GetValueTickMarkLabelsViewInfoClass.
    Create(Self);
end;
...
function TcxGridChartHistogramViewInfo.GetCategoryMarkPosition
  (Index: Integer): Integer;
begin
  Result := FCategoryMarks[Index].Position;
end;

function TcxGridChartHistogramViewInfo.GetCategoryMarkValue
  (Index: Integer): Integer;
begin
...
function TcxGridChartHistogramViewInfo.GetSumOfValues(AGroupIndex,
  AValueIndex: Integer): Variant;
begin
  if FSumOfValues = nil then
  ...
  if VarIsEmpty(FSumOfValues[AGroupIndex, AValueIndex]) then
    FSumOfValues[AGroupIndex, AValueIndex] := CalculateSumOfValues(AGroupIndex,
      AValueIndex);
...
function TcxGridChartHistogramViewInfo.GetValueMarkPosition
  (Index: Integer): Integer;
begin
  Result := FValueMarks[Index].Position;
end;

function TcxGridChartHistogramViewInfo.GetValueMarkValue(Index: Integer)
  : Extended;
begin
...
procedure TcxGridChartHistogramViewInfo.SetCategoryMarkPosition(Index: Integer;
  Value: Integer);
begin
  FCategoryMarks[Index].Position := Value;
end;

procedure TcxGridChartHistogramViewInfo.SetValueMarkPosition(Index: Integer;
  Value: Integer);
begin
  FValueMarks[Index].Position := Value;
end;

function TcxGridChartHistogramViewInfo.GetCategoryTickMarkLabelsViewInfoClass
  : TcxGridChartHistogramCategoryTickMarkLabelsViewInfoClass;
begin
  Result := TcxGridChartHistogramCategoryTickMarkLabelsViewInfo;
end;

function TcxGridChartHistogramViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridChartHistogramPainter;
end;

function TcxGridChartHistogramViewInfo.GetValueTickMarkLabelsViewInfoClass
  : TcxGridChartHistogramValueTickMarkLabelsViewInfoClass;
begin
...
procedure TcxGridChartHistogramViewInfo.GetPlotBackgroundParams
  (out AParams: TcxViewParams);
begin
...
begin
  if IsCategoryAxisHorz then
    if IsCategoriesInReverseOrder then
      ...
      Result := dirRight
  else if IsCategoriesInReverseOrder then
    Result := dirDown
  else
    Result := dirUp;
end;

function TcxGridChartHistogramViewInfo.GetUnitAdjustedOffset
  (AIndex: Integer): Integer;
begin
  Result := GetUnitOffset(AIndex);
  if IsCategoryAxisHorz and (AIndex = UnitCount) or not IsCategoryAxisHorz and
    (AIndex = 0) then
...
procedure TcxGridChartHistogramViewInfo.CalculateMinMaxValues(out AMinValue,
  AMaxValue: Extended; out AHasValuesOutOfRange: Boolean);
var
  I, J: Integer;
  AValue: Extended;
begin
  ...
  for I := 0 to ValueCount - 1 do
    ...
    begin
      ...
      begin
        ...
        if AHasValuesOutOfRange then
          Exit;
      end
      else if (Diagram.AxisValue.MinMaxValues = mmvAuto) and (I = 0) and (J = 0)
      then
      begin
        AMinValue := AValue;
        AMaxValue := AValue;
...
procedure TcxGridChartHistogramViewInfo.CalculateMinMaxStackedValues
  (APercentage: Boolean; out AMinValue, AMaxValue: Extended;
  out AHasValuesOutOfRange: Boolean);
var
  I, J: Integer;
  ASummaryValue, ANegativeSummaryValue, AMinSummaryValue, AMaxSummaryValue
    : Extended;
begin
  AHasValuesOutOfRange := False;
  ...
  begin
    AMaxValue := 100;
    AMinValue := 0;
    AHasValuesOutOfRange := (AMinSummaryValue < AMinValue) or
      (AMaxSummaryValue > AMaxValue);
    Exit;
  end;
  for I := 0 to ValueCount - 1 do
  begin
...
procedure TcxGridChartHistogramViewInfo.CalculateMinMaxVisualValues
  (out AMinVisualValue, AMaxVisualValue: Extended);
begin
  ...
  begin
    ...
    if NeedsMinMaxValuesOffset and (MinValue <> 0) and
      (Fraction(MinValue / ValueStep) = 0) then
      AMinVisualValue := AMinVisualValue - 1;
    AMinVisualValue := AMinVisualValue * ValueStep;

    AMaxVisualValue := Ceiling(MaxValue / ValueStep);
    if NeedsMinMaxValuesOffset and (MaxValue <> 0) and
      (Fraction(MaxValue / ValueStep) = 0) then
...
function TcxGridChartHistogramViewInfo.CalculateSumOfValues(AGroupIndex,
  AValueIndex: Integer): Variant;
var
  I: Integer;
begin
...
function TcxGridChartHistogramViewInfo.GetStackedValue(ASeriesIndex,
  AIndex: Integer): Variant;
var
  ASum: Variant;
begin
...
function TcxGridChartHistogramViewInfo.GetValue(ASeriesIndex,
  AIndex: Integer): Variant;
var
  I: Integer;
  AIsPositive: Boolean;
...
function TcxGridChartHistogramViewInfo.GetValueDirection(ASeriesIndex,
  AVisibleValueIndex: Integer): TcxDirection;
begin
  if IsValueAxisVert then
    if IsValuePositive(ASeriesIndex, AVisibleValueIndex) then
      ...
      Result := dirDown
  else if IsValuePositive(ASeriesIndex, AVisibleValueIndex) then
    Result := dirRight
  else
    Result := dirLeft;
end;

function TcxGridChartHistogramViewInfo.GetValueOffset
...
begin
  ...
  begin
    ...
    try
      AOffset := AAreaSize * (V - MinVisualValue) /
        (MaxVisualValue - MinVisualValue);
    except
...
function TcxGridChartHistogramViewInfo.GetVisibleGroupIndex
...
procedure TcxGridChartHistogramViewInfo.InitializeMinMaxValues(out AMinValue,
  AMaxValue: Extended);
begin
  if Diagram.AxisValue.MinMaxValues = mmvCustom then
  begin
...
function TcxGridChartHistogramViewInfo.IsSeriesBeginOfGroup
  (ASeriesIndex: Integer): Boolean;
begin
  Result := ASeriesIndex = 0;
end;

function TcxGridChartHistogramViewInfo.IsValuePositive(ASeriesIndex,
  AVisibleValueIndex: Integer): Boolean;
begin
  Result := IsPositive(VisibleValues[ASeriesIndex, AVisibleValueIndex] -
    ZeroValue);
end;
...
procedure TcxGridChartHistogramViewInfo.AddMark
  (var AMarks: TcxGridChartHistogramMarks; const AValue: Variant);
begin
...
procedure TcxGridChartHistogramViewInfo.CalculatePlotOffsets(APlotAreaWidth
  : Integer; var AOffsets: TRect);

  procedure ProcessVerticalAxisCaptions(ACaptionsViewInfo
    : TcxGridChartHistogramTickMarkLabelsViewInfo; var AOffsets: TRect);
  var
    AOffset: Integer;
  begin
    ...
    AOffset := ScaleFactor.Apply(TickMarkLabelsOffset) +
      ACaptionsViewInfo.CalculateWidth;
  ...
  procedure ProcessHorizontalAxisCaptions(ACaptionsViewInfo
    : TcxGridChartHistogramTickMarkLabelsViewInfo; var AOffsets: TRect;
    APlotAreaWidth: Integer);
  var
    AOffset: Integer;
  begin
    if not ACaptionsViewInfo.Visible then
    ...
    AOffset := ScaleFactor.Apply(TickMarkLabelsOffset) +
      ACaptionsViewInfo.CalculateHeight(APlotAreaWidth, AOffsets.Left,
      AOffsets.Right);
    ...
    ACaptionsViewInfo.FitCaptionsHorz(APlotAreaWidth, AOffsets.Left,
      AOffsets.Right);
  end;

var
  ACaptionsViewInfoHorz, ACaptionsViewInfoVert
    : TcxGridChartHistogramTickMarkLabelsViewInfo;
begin
  ...
  ProcessHorizontalAxisCaptions(ACaptionsViewInfoHorz, AOffsets,
    APlotAreaWidth);
end;
...
function TcxGridChartHistogramViewInfo.GetCategoryAxisPosition
  : TcxGridChartAxisPosition;
begin
  Result := Diagram.GetCategoryAxisPosition;
end;

function TcxGridChartHistogramViewInfo.GetCategoryGridLineBounds
  (AIndex: Integer): TRect;
begin
  Result := PlotBounds;
  if IsCategoryAxisHorz then
...
function TcxGridChartHistogramViewInfo.GetCategoryMarkBounds
  (Index: Integer): TRect;
var
...
function TcxGridChartHistogramViewInfo.GetTickMarkLabelsBounds
  (APosition: TcxGridChartAxisPosition): TRect;
begin
  Result := Bounds;
  case APosition of
    cppLeft:
...
function TcxGridChartHistogramViewInfo.GetValueAxisPosition
  : TcxGridChartAxisPosition;
begin
...
function TcxGridChartHistogramViewInfo.GetValueGridLineBounds
  (AIndex: Integer): TRect;
begin
  Result := PlotBounds;
  if IsValueAxisVert then
...
function TcxGridChartHistogramViewInfo.GetValueMarkBounds
  (Index: Integer): TRect;
var
  AIsVertical: Boolean;
...
begin
  ...
  if (AMarkKind = tmkCross) or (ValueAxisPosition in [cppRight, cppTop]) and
    (AMarkKind = tmkInside) or (ValueAxisPosition in [cppLeft, cppBottom]) and
    (AMarkKind = tmkOutside) then
    if AIsVertical then
      Dec(Result.Left, ValueMarkHeight)
    else
      Inc(Result.Bottom, ValueMarkHeight);
  if (AMarkKind = tmkCross) or (ValueAxisPosition in [cppRight, cppTop]) and
    (AMarkKind = tmkOutside) or (ValueAxisPosition in [cppLeft, cppBottom]) and
    (AMarkKind = tmkInside) then
    if AIsVertical then
...
function TcxGridChartHistogramViewInfo.CustomDrawPlot
  (ACanvas: TcxCanvas): Boolean;
begin
  Result := False;
...
function TcxGridChartHistogramViewInfo.DoCustomDrawPlot
  (ACanvas: TcxCanvas): Boolean;
begin
...
procedure TcxGridChartHistogramViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited;
  CalculateCategoryMarkPositions;
...
function TcxGridChartHistogramViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
  Result := inherited GetHitTest(P);
  if Result = nil then
...
function TcxGridChartColumnDiagramLegendViewInfo.GetItemsInReverseOrder
  : Boolean;
begin
  Result := (Diagram.GetCategoryAxisPosition in [cppTop, cppBottom]) and
...
function TcxGridChartColumnDiagramValueViewInfo.GetCaptionPosition
  : TcxGridChartColumnDiagramValueCaptionPosition;
begin
  Result := DiagramViewInfo.Diagram.Values.CaptionPosition;
end;

function TcxGridChartColumnDiagramValueViewInfo.GetDiagramViewInfo
  : TcxGridChartColumnDiagramViewInfo;
begin
...
function TcxGridChartColumnDiagramValueViewInfo.CalculateCaptionBounds: TRect;
  ...
  function GetHorizontalValueCaptionBounds(ACaptionWidth, ACaptionHeight
    : Integer; AIsRightDirection: Boolean): TRect;
  begin
    Result := ContentBounds;
    with Result do
    begin
...
var
  AIsPositive: Boolean;
begin
  AIsPositive := DiagramViewInfo.IsValuePositive(SeriesIndex,
    VisibleValueIndex);
...
function TcxGridChartColumnDiagramValueViewInfo.GetBorderColor
  (AIndex: TcxBorder): TColor;
begin
...
function TcxGridChartColumnDiagramValueViewInfo.GetBorderWidth
  (AIndex: TcxBorder): Integer;
begin
  Result := DiagramViewInfo.Diagram.Values.BorderWidth;
end;

function TcxGridChartColumnDiagramValueViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
function TcxGridChartColumnDiagramValueViewInfo.
  HasCaptionVisualCompensation: Boolean;
begin
  Result := True;
end;
...
function TcxGridChartColumnDiagramViewInfo.GetDiagram
  : TcxGridChartColumnDiagram;
begin
  Result := TcxGridChartColumnDiagram(inherited Diagram);
end;

function TcxGridChartColumnDiagramViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridChartColumnDiagramPainter;
end;

class function TcxGridChartColumnDiagramViewInfo.GetValueViewInfoClass
  : TcxGridChartDiagramValueViewInfoClass;
begin
  Result := TcxGridChartColumnDiagramValueViewInfo;
end;

function TcxGridChartColumnDiagramViewInfo.GetValueViewInfoIndex(ASeriesIndex,
  AVisibleIndex: Integer): Integer;
begin
  Result := AVisibleIndex * SeriesCount + ASeriesIndex;
end;

function TcxGridChartColumnDiagramViewInfo.GetCategoryTickMarkLabelOffsetUnits
  (AIndex: Integer): Integer;
begin
  Result := GetCategoryTickMarkOffsetUnits(AIndex, False);
end;

function TcxGridChartColumnDiagramViewInfo.GetCategoryTickMarkOffsetUnits
...
begin
  Result := SeriesCount * ScaleFactor.Apply(ColumnDiagramValueSizeUnits) + 2 *
    ScaleFactor.Apply(ColumnDiagramValueOffsetUnits);
end;

function TcxGridChartColumnDiagramViewInfo.GetValueOffsetUnits
  (AVisibleValueIndex, ASeriesIndex: Integer): Integer;
begin
  Result := AVisibleValueIndex * GetValueGroupAreaSizeUnits +
    ScaleFactor.Apply(ColumnDiagramValueOffsetUnits) + ASeriesIndex *
    ScaleFactor.Apply(ColumnDiagramValueSizeUnits);
end;

function TcxGridChartColumnDiagramViewInfo.IsEdgeCategoryTickMarkLabels
  : Boolean;
begin
  Result := False;
end;
...
begin
  for AValueIndex := 0 to VisibleValueCount - 1 do
    for ASeriesIndex := 0 to SeriesCount - 1 do
      CreateValueViewInfo(ASeriesIndex, AValueIndex)
        .Calculate(GetValueBounds(AValueIndex, ASeriesIndex));
end;

function TcxGridChartColumnDiagramViewInfo.GetValueBounds(AVisibleValueIndex,
  ASeriesIndex: Integer): TRect;
var
  ACategoryOffset, ACategoryOffsetStart, ACategoryOffsetFinish,
    AValueOffsetStart, AValueOffsetFinish: Integer;
begin
  ACategoryOffset := GetValueOffsetUnits(AVisibleValueIndex, ASeriesIndex);
  ACategoryOffsetStart := GetUnitOffset(ACategoryOffset);
  ACategoryOffsetFinish :=
    GetUnitOffset(ACategoryOffset + ScaleFactor.Apply
    (ColumnDiagramValueSizeUnits));
  AValueOffsetStart := ZeroValueOffset;
  AValueOffsetFinish := GetValueOffset(VisibleValues[ASeriesIndex,
    AVisibleValueIndex]);
  Result := MakeValueBounds(ACategoryOffsetStart, ACategoryOffsetFinish,
    AValueOffsetStart, AValueOffsetFinish);
end;

function TcxGridChartColumnDiagramViewInfo.MakeValueBounds(const ACategoryStart,
  ACategoryFinish, AValueStart, AValueFinish: Integer): TRect;
begin
  if IsValueAxisVert then
  begin
...
var
  AValueIndex, ASeriesIndex, ANegativeValueStart, APositiveValueStart,
    AValueSize, AValueStart, AValueFinish, ACategoryOffset, ACategoryStart,
    ACategoryFinish: Integer;
begin
  ...
  for AValueIndex := 0 to VisibleValueCount - 1 do
    ...
    begin
      ...
      ACategoryOffset := GetValueOffsetUnits(AValueIndex,
        GetVisibleGroupIndex(ASeriesIndex));
      ACategoryStart := GetUnitOffset(ACategoryOffset) +
        StackedGroupIndentWidth;
      ACategoryFinish := GetUnitOffset(ACategoryOffset +
        ScaleFactor.Apply(ColumnDiagramValueSizeUnits));
      AValueSize := (GetValueOffset(VisibleValues[ASeriesIndex, AValueIndex]) -
        ZeroValueOffset);
      ...
      CreateValueViewInfo(ASeriesIndex, AValueIndex)
        .Calculate(MakeValueBounds(ACategoryStart, ACategoryFinish, AValueStart,
        AValueFinish));
    end;
end;
...
function TcxGridChartStackedColumnDiagramViewInfo.GetValue(ASeriesIndex,
  AIndex: Integer): Variant;
begin
  Result := GetStackedValue(ASeriesIndex, AIndex);
end;

function TcxGridChartStackedColumnDiagramViewInfo.
  GetValueGroupAreaSizeUnits: Integer;
begin
  Result := SeriesGroupCount * ScaleFactor.Apply(ColumnDiagramValueSizeUnits) +
    2 * ScaleFactor.Apply(ColumnDiagramValueOffsetUnits);
end;
...
function TcxGridChartStackedColumnDiagramViewInfo.
  StackedGroupIndentWidth: Integer;
begin
  Result := 0;
...
function TcxGridChartStackedColumnDiagramViewInfo.GetDiagram
  : TcxGridChartStackedColumnDiagram;
begin
...
function TcxGridChartLineDiagramLegendItemViewInfo.GetDiagram
  : TcxGridChartLineDiagram;
begin
  Result := TcxGridChartLineDiagram(inherited Diagram);
end;

function TcxGridChartLineDiagramLegendItemViewInfo.GetLineStyle
...
function TcxGridChartLineDiagramLegendItemViewInfo.GetMarkerStyle
...
function TcxGridChartLineDiagramLegendItemViewInfo.
  CalculateLegendKeyWidth: Integer;
begin
  Result := 0;
  if LineStyle <> clsNone then
...
begin
  GetDiagramValueViewInfoClass.CalculateMarkerPointsEx(MarkerBounds,
    MarkerStyle, MarkerPoints);
end;

procedure TcxGridChartLineDiagramLegendItemViewInfo.DoCalculateParams;
begin
  inherited;
  TcxGridChartLineDiagramLegendViewInfo(Container).GetItemLegendKeyMarkerParams
    (Index, MarkerParams);
end;

function TcxGridChartLineDiagramLegendItemViewInfo.GetAlignmentVert
  : TcxAlignmentVert;
begin
  Result := vaCenter;
end;

function TcxGridChartLineDiagramLegendItemViewInfo.GetDiagramValueViewInfoClass
  : TcxGridChartLineDiagramValueViewInfoClass;
begin
  Result := TcxGridChartLineDiagramValueViewInfoClass
    (Diagram.GetViewInfoClass.GetValueViewInfoClass);
end;

function TcxGridChartLineDiagramLegendItemViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  R := LegendKeyBounds;
  GetCenteredRect(Point(GetRangeCenter(R.Left, R.Right), GetRangeCenter(R.Top,
    R.Bottom)), MarkerSize, MarkerSize, Result);
end;

procedure TcxGridChartLineDiagramLegendItemViewInfo.Calculate(ALeftBound,
  ATopBound: Integer; AWidth: Integer = -1; AHeight: Integer = -1);
begin
  inherited;
  if not UseRightToLeftAlignment then
...
procedure TcxGridChartLineDiagramLegendItemViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited;
  CalculateMarkerPoints;
...
function TcxGridChartLineDiagramLegendViewInfo.GetItemClass
  : TcxGridChartLegendItemViewInfoClass;
begin
  Result := TcxGridChartLineDiagramLegendItemViewInfo;
end;

procedure TcxGridChartLineDiagramLegendViewInfo.GetItemLegendKeyMarkerParams
  (AIndex: Integer; out AParams: TcxViewParams);
begin
  TcxGridChartLineDiagram(Diagram).Styles.GetValueMarkerParams
    (GetItemSeriesIndex(AIndex), GetItemValueIndex(AIndex), AParams);
end;

{ TcxGridChartLineDiagramValueViewInfo }

function TcxGridChartLineDiagramValueViewInfo.GetCaptionPosition
  : TcxGridChartLineDiagramValueCaptionPosition;
begin
  Result := Diagram.Values.CaptionPosition;
end;

function TcxGridChartLineDiagramValueViewInfo.GetDiagram
  : TcxGridChartLineDiagram;
begin
  Result := TcxGridChartLineDiagram(inherited Diagram);
end;

function TcxGridChartLineDiagramValueViewInfo.GetDiagramViewInfo
  : TcxGridChartLineDiagramViewInfo;
begin
  Result := TcxGridChartLineDiagramViewInfo(inherited DiagramViewInfo);
end;

function TcxGridChartLineDiagramValueViewInfo.GetLineStyle
  : TcxGridChartLineStyle;
begin
  Result := Diagram.Values.GetLineStyle(Series);
end;
...
function TcxGridChartLineDiagramValueViewInfo.GetMarkerStyle
  : TcxGridChartMarkerStyle;
begin
  Result := Diagram.Values.GetMarkerStyle(Series);
end;
...
begin
  Result := cxRectInflate(MarkerBounds,
    ScaleFactor.Apply(LineDiagramCaptionOffset));
  ...
  case CaptionPosition of
    ...
    Result.Left := GetRangeCenter(Result.Left, Result.Right) -
      ACaptionWidth div 2;
    Result.Right := Result.Left + ACaptionWidth;
  end;
  case CaptionPosition of
    ...
    Result.Top := GetRangeCenter(Result.Top, Result.Bottom) -
      ACaptionHeight div 2;
    Result.Bottom := Result.Top + ACaptionHeight;
  end;
end;

procedure TcxGridChartLineDiagramValueViewInfo.CalculateMarkerParams
  (var AParams: TcxViewParams);
begin
...
function TcxGridChartLineDiagramValueViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := GetPainterClassEx;
end;

class function TcxGridChartLineDiagramValueViewInfo.GetPainterClassEx
  : TcxGridChartLineDiagramValuePainterClass;
begin
...
procedure TcxGridChartLineDiagramValueViewInfo.MakeRealBounds
  (var ABounds: TRect);
begin
...
class procedure TcxGridChartLineDiagramValueViewInfo.CalculateMarkerPointsEx
  (const ABounds: TRect; AStyle: TcxGridChartMarkerStyle; var APoints: TPoints);
var
  AOrigin: TPoint;
  ASize: Integer;
begin
  if not(AStyle in [cmsTriangle, cmsDiamond]) then
    Exit;
  with ABounds do
  begin
    AOrigin := TopLeft;
...
function TcxGridChartLineDiagramValueViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
  Result := inherited GetHitTest(P);
...
function TcxGridChartLineDiagramValueViewInfo.HasPoint(const P: TPoint)
  : Boolean;
begin
...
function TcxGridChartLineDiagramViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridChartLineDiagramPainter;
end;

class function TcxGridChartLineDiagramViewInfo.GetValueViewInfoClass
  : TcxGridChartDiagramValueViewInfoClass;
begin
  Result := TcxGridChartLineDiagramValueViewInfo;
end;

function TcxGridChartLineDiagramViewInfo.GetValueViewInfoIndex(ASeriesIndex,
  AVisibleIndex: Integer): Integer;
begin
  Result := ASeriesIndex * VisibleValueCount + AVisibleIndex;
end;

function TcxGridChartLineDiagramViewInfo.GetCategoryTickMarkLabelOffsetUnits
  (AIndex: Integer): Integer;
begin
...
function TcxGridChartLineDiagramViewInfo.GetValueOffsetUnits(AVisibleValueIndex,
  ASeriesIndex: Integer): Integer;
begin
  if Diagram.AxisCategory.ValueAxisBetweenCategories then
    ...
    Result := 0;
  Inc(Result, ScaleFactor.Apply(LineDiagramValueSizeUnits) *
    AVisibleValueIndex);
end;

function TcxGridChartLineDiagramViewInfo.GetValueY(AVisibleValueIndex,
  ASeriesIndex: Integer): Integer;
begin
...
function TcxGridChartLineDiagramViewInfo.IsGapValue(ASeriesIndex,
  AValueIndex: Integer): Boolean;
begin
  Result := Diagram.EmptyPointsDisplayMode = epdmGap;
  if Result then
    Result := GridView.ViewData.IsEmptyValue[ASeriesIndex,
      GetValueIndex(AValueIndex)];
end;

procedure TcxGridChartLineDiagramViewInfo.CalculatePlotOffsets
  (APlotAreaWidth: Integer; var AOffsets: TRect);
var
...
begin
  ...
  begin
    ...
    begin
      ...
      TcxGridChartLineDiagramValueViewInfo(CreateValueViewInfo(ASeriesIndex,
        AValueIndex)).Calculate(R, ALineStartY, ALineFinishY);
...
function TcxGridChartLineDiagramViewInfo.GetValueBounds(AVisibleValueIndex,
  ASeriesIndex: Integer): TRect;
var
  ACategoryOffsetStart, ACategoryOffsetFinish, AValueOffsetStart,
    AValueOffsetFinish: Integer;
begin
  ACategoryOffsetFinish := GetUnitAdjustedOffset
    (GetValueOffsetUnits(AVisibleValueIndex, ASeriesIndex));
  if AVisibleValueIndex = 0 then
    ACategoryOffsetStart := ACategoryOffsetFinish
  else
    ACategoryOffsetStart := GetUnitAdjustedOffset
      (GetValueOffsetUnits(AVisibleValueIndex - 1, ASeriesIndex));
  AValueOffsetStart := ZeroValueOffset;
...
begin
  Result := Max(inherited CalculateHeight,
    2 * ScaleFactor.Apply(AreaDiagramLegendKeyOffset) + LegendKeyHeight);
end;

function TcxGridChartAreaDiagramLegendItemViewInfo.
  CalculateLegendKeyHeight: Integer;
begin
...
function TcxGridChartAreaDiagramLegendItemViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
function TcxGridChartAreaDiagramLegendViewInfo.GetItemClass
  : TcxGridChartLegendItemViewInfoClass;
begin
...
function TcxGridChartAreaDiagramValueViewInfo.GetDiagram
  : TcxGridChartAreaDiagram;
begin
...
begin
  ...
  if not Diagram.CheckGapPoints and (Diagram.Values.Stacking <> vsNone) and
    (SeriesIndex > 0) then
  begin
    APrevSeriesValuePoints := TcxGridChartAreaDiagramValueViewInfo
      (DiagramViewInfo.GetValueViewInfo(SeriesIndex - 1, VisibleValueIndex))
      .AreaPoints;
...
function TcxGridChartAreaDiagramValueViewInfo.CustomDrawBackground
  (ACanvas: TcxCanvas): Boolean;
begin
...
class function TcxGridChartAreaDiagramValueViewInfo.GetPainterClassEx
  : TcxGridChartLineDiagramValuePainterClass;
begin
  Result := TcxGridChartAreaDiagramValuePainter;
end;

procedure TcxGridChartAreaDiagramValueViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
  inherited;
end;
...
begin
  Result := TcxRegion.Create(CreatePolygonRgn(AreaPoints[0], Length(AreaPoints),
    WINDING));
end;

function TcxGridChartAreaDiagramValueViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  ARegion: TcxRegion;
begin
...
function TcxGridChartAreaDiagramViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridChartAreaDiagramPainter;
end;

class function TcxGridChartAreaDiagramViewInfo.GetValueViewInfoClass
  : TcxGridChartDiagramValueViewInfoClass;
begin
...
var
  R: TRect;
  AEmptyPointFound: Boolean;
  AValueIndex, ASeriesIndex, ALineStartY, ALineFinishY,
    AActualLineFinishY: Integer;
begin
  ...
  begin
    ...
    begin
      ...
      if (AValueIndex > 0) and HasGap(AValueIndex - 1) and
        (GetValue(ASeriesIndex, AValueIndex - 1) = 100) then
      ...
      if IsCategoriesInReverseOrder then
        SwapIntegers(ALineStartY, ALineFinishY);
      TcxGridChartLineDiagramValueViewInfo(CreateValueViewInfo(ASeriesIndex,
        AValueIndex)).Calculate(R, ALineStartY, AActualLineFinishY);
      if not IsCategoriesInReverseOrder then
        ALineStartY := ALineFinishY;
      AEmptyPointFound := False;
    end;
...
function TcxGridChartStackedAreaDiagramViewInfo.GetValue(ASeriesIndex,
  AIndex: Integer): Variant;
var
  I: Integer;
begin
  ...
  else if not IsSeriesBeginOfGroup(ASeriesIndex) then
    for I := ASeriesIndex - 1 downto 0 do
    begin
      Result := Result + GetStackedValue(I, AIndex);
      if IsSeriesBeginOfGroup(I) then
        Break;
    end;
end;

function TcxGridChartStackedAreaDiagramViewInfo.GetSeriesCountAt
  (AValueIndex: Integer): Integer;
var
  ASeriesIndex: Integer;
begin
  Result := 0;
  for ASeriesIndex := 0 to SeriesCount - 1 do
    if not IsGapValue(ASeriesIndex, AValueIndex - 1) and
      not IsGapValue(ASeriesIndex, AValueIndex) then
      Inc(Result);
end;

function TcxGridChartStackedAreaDiagramViewInfo.GetDiagram
  : TcxGridChartStackedAreaDiagram;
begin
...
function TcxGridChartPieDiagramLegendViewInfo.GetDiagram
  : TcxGridChartPieDiagram;
begin
  Result := TcxGridChartPieDiagram(inherited Diagram);
end;

function TcxGridChartPieDiagramLegendViewInfo.GetItemObjectIndex
  (AIndex: Integer): Integer;
begin
  Result := AIndex;
end;
...
function TcxGridChartPieDiagramValueViewInfo.GetCaptionPosition
...
function TcxGridChartPieDiagramValueViewInfo.GetDiagramViewInfo
  : TcxGridChartPieDiagramViewInfo;
begin
...
function TcxGridChartPieDiagramValueViewInfo.CalculateCaptionCenter(AAngle,
  ACaptionWidth, ACaptionHeight: Integer): TPoint;
const
...
begin
  ...
  begin
    ...
    case CaptionPosition of
      ...
      pdvcpInsideEnd:
        Dec(ARadius, ScaleFactor.Apply(PieValueCaptionOffset) +
          Max(ACaptionWidth div 2, ACaptionHeight div 2));
      pdvcpOutsideEnd:
        begin
          Inc(ARadius, ScaleFactor.Apply(PieValueCaptionOffset) +
            ACaptionHeight div 2);
          AIsSpecialCase :=
            not(AAngle mod 180 in [SpecialCaseAngleDelta .. 180 -
            SpecialCaseAngleDelta]);
          ...
          begin
            ...
            if ACaptionWidth div 2 >= Abs(ASin / ACos * ARadius) then
              ...
              ARadius := Round(ACaptionWidth div 2 * ASin +
                Sqrt(Sqr(ARadius) - Sqr(ACaptionWidth div 2 * ACos)));
          end;
        end;
    end;
    ...
    if CaptionPosition = pdvcpOutsideEnd then
      if AIsSpecialCase then
        if AAngle in [180 - SpecialCaseAngleDelta .. 180 + SpecialCaseAngleDelta]
        then
...
procedure TcxGridChartPieDiagramValueViewInfo.CalculateLeaderLinePoints
  (AAngle: Integer);
begin
  SetLength(LeaderLinePoints, 3);
  LeaderLinePoints[0] := GetPointOnCircle(Center, Radius, AAngle);
  LeaderLinePoints[1] := GetPointOnCircle(Center,
    Radius + ScaleFactor.Apply(PieLeaderLineSegment1), AAngle);
...
function TcxGridChartPieDiagramValueViewInfo.DoCustomDraw
  (ACanvas: TcxCanvas): Boolean;
begin
...
function TcxGridChartPieDiagramValueViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
procedure TcxGridChartPieDiagramValueViewInfo.MakeCaptionVisible
  (var ACaptionBounds: TRect; AAngle: Integer);
var
  APrevValueIndex, ACaptionOffset: Integer;
  APrevCaptionBounds, AIntersection: TRect;
begin
  if VisibleValueIndex = 0 then
    Exit;
  APrevValueIndex := VisibleValueIndex;
  repeat
    Dec(APrevValueIndex);
    APrevCaptionBounds := DiagramViewInfo.GetValueViewInfo(SeriesIndex,
      APrevValueIndex).CaptionViewInfo.Bounds;
...
begin
  ...
  begin
    ...
    begin
      APointAngle := 90 +
        Round(RadToDeg(ArcTan2(P.Y - Center.Y, P.X - Center.X)));
      if APointAngle < 0 then
        Inc(APointAngle, 360);
...
constructor TcxGridChartPieSeriesSiteCaptionViewInfo.Create
  (ASiteViewInfo: TcxGridChartPieSeriesSiteViewInfo);
begin
...
function TcxGridChartPieSeriesSiteCaptionViewInfo.CustomDraw
  (ACanvas: TcxCanvas): Boolean;
begin
  Result := inherited CustomDraw(ACanvas);
  if not Result then
...
function TcxGridChartPieSeriesSiteCaptionViewInfo.GetBorderColor
  (AIndex: TcxBorder): TColor;
begin
...
function TcxGridChartPieSeriesSiteCaptionViewInfo.GetBorderWidth
  (AIndex: TcxBorder): Integer;
begin
  Result := FSiteViewInfo.BorderWidth[AIndex];
end;

function TcxGridChartPieSeriesSiteCaptionViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridChartPieSeriesSiteCaptionViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridChartPieSeriesSiteCaptionPainter;
end;

procedure TcxGridChartPieSeriesSiteCaptionViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
  FSiteViewInfo.Diagram.Styles.GetViewParams(dsSeriesSiteCaptions, nil,
    nil, AParams);
end;
...
procedure TcxGridChartPieSeriesSiteCaptionViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
...
function TcxGridChartPieSeriesSiteCaptionViewInfo.MouseDown
  (AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
  AShift: TShiftState): Boolean;
begin
  Result := inherited MouseDown(AHitTest, AButton, AShift);
  if (AButton = mbLeft) and not(ssDouble in AShift) and GridView.IsDesigning
  then
  begin
    GridView.Controller.DesignController.SelectObject(FSiteViewInfo.Series,
      not(ssShift in AShift));
    Result := True;
  end;
end;
...
constructor TcxGridChartPieSeriesSiteViewInfo.Create(ADiagramViewInfo
  : TcxGridChartPieDiagramViewInfo; ASeries: TcxGridChartSeries);
begin
  inherited Create(ADiagramViewInfo.GridViewInfo);
  FDiagramViewInfo := ADiagramViewInfo;
  FSeries := ASeries;
...
procedure TcxGridChartPieSeriesSiteViewInfo.CalculateCaptionAndPieAreaBounds
  (var ACaptionBounds, APieAreaBounds: TRect);
var
  ASize: Integer;
begin
  ...
  APieAreaBounds := cxRectInflate(ContentBounds,
    -ScaleFactor.Apply(PieAreaOffset));
  with APieAreaBounds do
  begin
    ASize := Max(ScaleFactor.Apply(PieMinSize), Min(Right - Left, Bottom - Top)
...
begin
  ...
  if IsRectEmpty(Result) then
    SetRectEmpty(Result); // for negative values
end;

function TcxGridChartPieSeriesSiteViewInfo.CustomDraw
  (ACanvas: TcxCanvas): Boolean;
begin
  Result := inherited CustomDraw(ACanvas);
  if not Result then
...
function TcxGridChartPieSeriesSiteViewInfo.GetBorderColor
  (AIndex: TcxBorder): TColor;
begin
  Result := Params.TextColor;
end;
...
function TcxGridChartPieSeriesSiteViewInfo.GetBorderWidth
  (AIndex: TcxBorder): Integer;
begin
  Result := 1;
end;

function TcxGridChartPieSeriesSiteViewInfo.GetCaptionViewInfoClass
  : TcxGridChartPieSeriesSiteCaptionViewInfoClass;
begin
...
function TcxGridChartPieSeriesSiteViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
begin
  Result := GridView.IsDesigning and GridView.Controller.DesignController.
    IsObjectSelected(Series);
end;

function TcxGridChartPieSeriesSiteViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridChartPieSeriesSitePainter;
end;

function TcxGridChartPieSeriesSiteViewInfo.GetValueViewInfo(AVisibleValueIndex
  : Integer): TcxGridChartPieDiagramValueViewInfo;
begin
  Result := FDiagramViewInfo.GetValueViewInfo(FSeries.VisibleIndex,
    AVisibleValueIndex) as TcxGridChartPieDiagramValueViewInfo;
end;

procedure TcxGridChartPieSeriesSiteViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
procedure TcxGridChartPieSeriesSiteViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
...
procedure TcxGridChartPieSeriesSiteViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
  APrevBounds: TRect;
...
begin
  ...
  FPieAreaBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (FPieAreaBounds, ABounds);
  FCaptionBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (FCaptionBounds, ABounds);
  if FCaptionViewInfo.Visible then
...
function TcxGridChartPieSeriesSiteViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
...
function TcxGridChartPieSeriesSiteViewInfo.MouseDown
  (AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
  AShift: TShiftState): Boolean;
begin
  Result := inherited MouseDown(AHitTest, AButton, AShift);
...
constructor TcxGridChartPieDiagramViewInfo.Create(AGridViewInfo
  : TcxCustomGridViewInfo; ADiagram: TcxGridChartDiagram);
var
  I: Integer;
begin
  ...
  for I := 0 to SeriesCount - 1 do
    FSeriesSiteViewInfos.Add(GetSeriesSiteViewInfoClass.Create(Self,
      Series[I]));
end;
...
function TcxGridChartPieDiagramViewInfo.GetCaptionPosition
  : TcxGridChartPieDiagramValueCaptionPosition;
begin
...
function TcxGridChartPieDiagramViewInfo.GetSeriesSiteViewInfo(Index: Integer)
  : TcxGridChartPieSeriesSiteViewInfo;
begin
...
function TcxGridChartPieDiagramViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridChartPieDiagramPainter;
end;

function TcxGridChartPieDiagramViewInfo.GetSeriesSiteViewInfoClass
  : TcxGridChartPieSeriesSiteViewInfoClass;
begin
  Result := TcxGridChartPieSeriesSiteViewInfo;
end;

class function TcxGridChartPieDiagramViewInfo.GetValueViewInfoClass
  : TcxGridChartDiagramValueViewInfoClass;
begin
  Result := TcxGridChartPieDiagramValueViewInfo;
end;

function TcxGridChartPieDiagramViewInfo.GetValueViewInfoIndex(ASeriesIndex,
  AVisibleIndex: Integer): Integer;
begin
  Result := ASeriesIndex * VisibleValueCount + AVisibleIndex;
end;

function TcxGridChartPieDiagramViewInfo.
  CalculatePieAreaValueCaptionCompensation: Integer;
begin
  case CaptionPosition of
    pdvcpOutsideEnd:
      Result := ScaleFactor.Apply(PieValueCaptionOffset) +
        CalculateValueCaptionMaxHeight div 2 + CalculateValueCaptionMaxWidth;
    pdvcpOutsideEndWithLeaderLines:
      Result := ScaleFactor.Apply(PieLeaderLineSegment1) +
        ScaleFactor.Apply(PieLeaderLineSegment2) +
...
function TcxGridChartPieDiagramViewInfo.CalculateSeriesSiteViewInfoBounds
  (AIndex: Integer): TRect;
var
...
begin
  ...
  ASiteWidth := (Bounds.Right - Bounds.Left - (AColumnCount - 1) *
    ScaleFactor.Apply(PieSeriesSiteOffset)) div AColumnCount;
  ASiteHeight := (Bounds.Bottom - Bounds.Top - (ARowCount - 1) *
    ScaleFactor.Apply(PieSeriesSiteOffset)) div ARowCount;

  Result := Bounds;
  Inc(Result.Left, AIndex mod AColumnCount *
    (ASiteWidth + ScaleFactor.Apply(PieSeriesSiteOffset)));
  Result.Right := Result.Left + ASiteWidth;
  Inc(Result.Top, AIndex div AColumnCount *
    (ASiteHeight + ScaleFactor.Apply(PieSeriesSiteOffset)));
...
procedure TcxGridChartPieDiagramViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
...
function TcxGridChartPieDiagramViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  I: Integer;
begin
...
constructor TcxGridChartToolBoxItemViewInfo.Create
...
procedure TcxGridChartToolBoxItemViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
  FContainer.GetViewParams(AParams);
end;
...
function TcxGridChartToolBoxItemSeparatorViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
  Result := nil;
end;

function TcxGridChartToolBoxItemSeparatorViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridChartToolBoxItemSeparatorPainter;
end;

procedure TcxGridChartToolBoxItemSeparatorViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
constructor TcxGridChartToolBoxDataLevelActiveValueViewInfo.Create
  (AContainer: TcxGridChartToolBoxDataLevelInfoViewInfo);
begin
  inherited Create(AContainer.GridViewInfo);
  FContainer := AContainer;
  FCanShowDropDownWindow :=
    GridView.Controller.CanShowDataLevelActiveValuePopup;
end;

function TcxGridChartToolBoxDataLevelActiveValueViewInfo.GetGridView
  : TcxGridChartView;
begin
  Result := TcxGridChartView(inherited GridView);
end;

function TcxGridChartToolBoxDataLevelActiveValueViewInfo.GetDataGroup
  : TcxGridChartDataGroup;
begin
  Result := FContainer.DataLevelObject;
end;

function TcxGridChartToolBoxDataLevelActiveValueViewInfo.
  CalculateContentBounds: TRect;
begin
  Result := inherited CalculateContentBounds;
...
function TcxGridChartToolBoxDataLevelActiveValueViewInfo.CalculateWidth
  : Integer;
begin
  Result := BorderSize[bLeft] + 2 * ScaleFactor.Apply(cxTextOffset) +
    TextWidthWithOffset;
end;

function TcxGridChartToolBoxDataLevelActiveValueViewInfo.GetAlignmentVert
  : TcxAlignmentVert;
begin
  Result := vaCenter;
end;

function TcxGridChartToolBoxDataLevelActiveValueViewInfo.GetBorderColor
  (AIndex: TcxBorder): TColor;
begin
...
function TcxGridChartToolBoxDataLevelActiveValueViewInfo.GetBorderWidth
  (AIndex: TcxBorder): Integer;
begin
  Result := FContainer.BorderWidth[AIndex];
end;

function TcxGridChartToolBoxDataLevelActiveValueViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
  Result := TcxGridChartDataLevelActiveValueInfoHitTest;
end;

function TcxGridChartToolBoxDataLevelActiveValueViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
procedure TcxGridChartToolBoxDataLevelActiveValueViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
  GridView.Styles.GetViewParams(vsDataLevelActiveValueInfo, nil, nil, AParams);
end;

procedure TcxGridChartToolBoxDataLevelActiveValueViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
  FContainer.InitHitTest(AHitTest);
  inherited;
  TcxGridChartDataLevelActiveValueInfoHitTest(AHitTest).CanDropDown :=
    CanShowDropDownWindow;
end;

function TcxGridChartToolBoxDataLevelActiveValueViewInfo.
  DropDownWindowExists: Boolean;
begin
  Result := CanShowDropDownWindow and
    GridView.Controller.HasDataLevelActiveValuePopup;
end;

function TcxGridChartToolBoxDataLevelActiveValueViewInfo.GetDropDownWindow
...
constructor TcxGridChartToolBoxDataLevelInfoViewInfo.Create
  (AContainer: TcxGridChartToolBoxViewInfo;
  AAlignment: TcxGridChartToolBoxItemAlignment; ADataLevel: Integer);
begin
...
function TcxGridChartToolBoxDataLevelInfoViewInfo.GetDataLevelObject
  : TcxGridChartDataGroup;
begin
  Result := GridView.DataLevelObjects[FDataLevel];
end;

function TcxGridChartToolBoxDataLevelInfoViewInfo.
  CalculateActiveValueViewInfoBounds: TRect;
begin
  Result := ClientBounds;
...
begin
  Result := BorderSize[bLeft] + 2 * ScaleFactor.Apply(cxTextOffset) +
    TextWidthWithOffset + BorderSize[bRight];
  if FActiveValueViewInfo <> nil then
    Inc(Result, FActiveValueViewInfo.CalculateWidth);
end;

function TcxGridChartToolBoxDataLevelInfoViewInfo.GetActiveValueViewInfoClass
  : TcxGridChartToolBoxDataLevelActiveValueViewInfoClass;
begin
...
function TcxGridChartToolBoxDataLevelInfoViewInfo.GetAlignmentVert
  : TcxAlignmentVert;
begin
  Result := vaCenter;
end;

function TcxGridChartToolBoxDataLevelInfoViewInfo.GetBorderColor
  (AIndex: TcxBorder): TColor;
begin
...
function TcxGridChartToolBoxDataLevelInfoViewInfo.GetBorderWidth
  (AIndex: TcxBorder): Integer;
begin
...
function TcxGridChartToolBoxDataLevelInfoViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
begin
  Result := GridView.IsDesigning and GridView.Controller.DesignController.
    IsObjectSelected(GetDesignObject);
end;

function TcxGridChartToolBoxDataLevelInfoViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
procedure TcxGridChartToolBoxDataLevelInfoViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
procedure TcxGridChartToolBoxDataLevelInfoViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
  inherited;
...
procedure TcxGridChartToolBoxDataLevelInfoViewInfo.Calculate(ALeftBound,
  ATopBound: Integer; AWidth: Integer = -1; AHeight: Integer = -1);
begin
  inherited;
  if FActiveValueViewInfo <> nil then
...
procedure TcxGridChartToolBoxDataLevelInfoViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited;
  if FActiveValueViewInfo <> nil then
...
function TcxGridChartToolBoxDataLevelInfoViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  AHitTest: TcxCustomGridHitTest;
begin
  Result := inherited GetHitTest(P);
  if (Result <> nil) and not GridView.IsDesigning and
    (FActiveValueViewInfo <> nil) then
  begin
...
function TcxGridChartToolBoxDataLevelInfoViewInfo.MouseDown
  (AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
  AShift: TShiftState): Boolean;
begin
  Result := inherited MouseDown(AHitTest, AButton, AShift);
  if (AButton = mbLeft) and not(ssDouble in AShift) then
    if GridView.IsDesigning then
    begin
      GridView.Controller.DesignController.SelectObject(GetDesignObject,
        not(ssShift in AShift));
      Result := True;
    end
    else if GridView.Controller.MayDataDrillDown then
...
begin
  Result := BorderWidth[bTop] + 2 * LookAndFeelPainter.ScaledButtonTextOffset
    (ScaleFactor) + TextHeightWithOffset + BorderWidth[bBottom];
end;

function TcxGridChartToolBoxCustomizeButtonViewInfo.CalculateWidth: Integer;
begin
  Result := BorderWidth[bLeft] + 2 * LookAndFeelPainter.ScaledButtonTextOffset
    (ScaleFactor) + TextWidthWithOffset + BorderWidth[bRight];
end;

function TcxGridChartToolBoxCustomizeButtonViewInfo.CaptureMouseOnPress
  : Boolean;
begin
  Result := True;
end;
...
function TcxGridChartToolBoxCustomizeButtonViewInfo.GetActualState
  : TcxGridCellState;
begin
  if Checked then
    Result := gcsPressed
...
function TcxGridChartToolBoxCustomizeButtonViewInfo.GetBorderWidth
  (AIndex: TcxBorder): Integer;
begin
  Result := LookAndFeelPainter.ButtonBorderSize;
end;

function TcxGridChartToolBoxCustomizeButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridChartToolBoxCustomizeButtonViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
constructor TcxGridChartToolBoxDiagramSelectorViewInfo.Create
  (AContainer: TcxGridChartToolBoxViewInfo;
  AAlignment: TcxGridChartToolBoxItemAlignment);
begin
  inherited;
...
function TcxGridChartToolBoxDiagramSelectorViewInfo.GetDropDownWindowValue
  : TcxGridChartDiagramSelectorPopup;
begin
...
begin
  Result := ImageWidth + ScaleFactor.Apply(ToolBoxDiagramImageOffset) +
    TextWidthWithOffset;
end;

function TcxGridChartToolBoxDiagramSelectorViewInfo.GetAlignmentVert
  : TcxAlignmentVert;
begin
  Result := vaCenter;
end;

function TcxGridChartToolBoxDiagramSelectorViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridChartToolBoxDiagramSelectorViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
procedure TcxGridChartToolBoxDiagramSelectorViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
procedure TcxGridChartToolBoxDiagramSelectorViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
  inherited;
  TcxGridChartDiagramSelectorHitTest(AHitTest).CanDropDown :=
    CanShowDropDownWindow;
end;

function TcxGridChartToolBoxDiagramSelectorViewInfo.
  CalculateCanShowDropDownWindow: Boolean;
begin
...
begin
  Result := CanShowDropDownWindow and
    GridView.Controller.HasDiagramSelectorPopup;
end;

function TcxGridChartToolBoxDiagramSelectorViewInfo.GetDropDownWindow
  : TdxUIElementPopupWindow;
begin
  if CanShowDropDownWindow then
...
begin
  Result := Bounds;
  Dec(Result.Left, DropDownWindow.BorderWidths[bLeft] +
    DropDownWindow.ImageOffset);
end;

{ TcxGridChartToolBoxViewInfo }

constructor TcxGridChartToolBoxViewInfo.Create(AGridViewInfo
...
function TcxGridChartToolBoxViewInfo.GetDataLevelInfo(AIndex: Integer)
  : TcxGridChartToolBoxDataLevelInfoViewInfo;
begin
...
function TcxGridChartToolBoxViewInfo.GetItem(AIndex: Integer)
  : TcxGridChartToolBoxItemViewInfo;
begin
...
begin
  ...
  for I := 0 to Count - 1 do
    Result := Max(Result, Items[I].CalculateHeight);
  Inc(Result, BorderSize[bTop] + 2 * ScaleFactor.Apply(ToolBoxItemOffset) +
    BorderSize[bBottom]);
end;
...
begin
  Result := cxRectInflate(inherited CalculateContentBounds,
    -ScaleFactor.Apply(ToolBoxItemOffset));
end;

procedure TcxGridChartToolBoxViewInfo.CalculateItems;

  function GetItemBounds(AItem: TcxGridChartToolBoxItemViewInfo;
    var ARestSpace: TRect): TRect;
  begin
    PositionRect(Result, ARestSpace, AItem.CalculateWidth, 0,
      ScaleFactor.Apply(ToolBoxItemOffset), AItem.Alignment);
...
begin
  ...
  begin
    ...
    begin
      ...
      ARestWidth := ARestSpace.Right - ARestSpace.Left +
        ScaleFactor.Apply(ToolBoxItemOffset);
...
function TcxGridChartToolBoxViewInfo.GetDataLevelInfoConnector
  (AIndex: Integer): TRect;
begin
  ...
  Result.Top := (Result.Top + Result.Bottom -
    ToolBoxDataLevelInfoConnectorWidth) div 2;
...
function TcxGridChartToolBoxViewInfo.GetFirstSeparator
  : TcxGridChartToolBoxItemViewInfo;
var
  I: Integer;
begin
...
begin
  Result := ContentBounds;
  if Text <> '' then
    Inc(Result.Left, TextWidthWithOffset + ScaleFactor.Apply
      (ToolBoxItemOffset));
end;

function TcxGridChartToolBoxViewInfo.GetOrientation
  : TcxGridChartPartOrientation;
begin
  Result := cpoHorizontal;
end;

function TcxGridChartToolBoxViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
function TcxGridChartToolBoxViewInfo.AddItem
  (AItem: TcxGridChartToolBoxItemViewInfo): TcxGridChartToolBoxItemViewInfo;
begin
  Result := AItem;
  FItems.Add(AItem);
end;

procedure TcxGridChartToolBoxViewInfo.AddSeparator
  (AAlignment: TcxGridChartToolBoxItemAlignment);
begin
  if Count <> 0 then
...
begin
  if IsDataLevelsInfoVisible then
    for I := 0 to GridView.DataLevelCount - 1 do
      FDataLevelInfos.Add(AddItem(GetDataLevelInfoClass.Create(Self,
        cppLeft, I)));
...
function TcxGridChartToolBoxViewInfo.GetCustomizeButtonClass
  : TcxGridChartToolBoxCustomizeButtonViewInfoClass;
begin
  Result := TcxGridChartToolBoxCustomizeButtonViewInfo;
end;

function TcxGridChartToolBoxViewInfo.GetDataLevelInfoClass
  : TcxGridChartToolBoxDataLevelInfoViewInfoClass;
begin
  Result := TcxGridChartToolBoxDataLevelInfoViewInfo;
end;

function TcxGridChartToolBoxViewInfo.GetDiagramSelectorClass
  : TcxGridChartToolBoxDiagramSelectorViewInfoClass;
begin
  Result := TcxGridChartToolBoxDiagramSelectorViewInfo;
end;

function TcxGridChartToolBoxViewInfo.GetItemSeparatorClass
  : TcxGridChartToolBoxItemSeparatorViewInfoClass;
begin
...
function TcxGridChartToolBoxViewInfo.IsSeparator
  (AItem: TcxGridChartToolBoxItemViewInfo): Boolean;
begin
...
procedure TcxGridChartToolBoxViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
...
function TcxGridChartToolBoxViewInfo.GetDataGroupInsertionBounds
  (AIndex: Integer): TRect;
begin
...
function TcxGridChartToolBoxViewInfo.GetDataGroupInsertionIndex
  (const P: TPoint): Integer;
var
  R: TRect;
begin
  Result := -1;
  if not PtInRect(GetDataGroupInsertionAreaBounds, P) then
    Exit;
  for Result := 0 to DataLevelInfoCount - 1 do
    if DataLevelInfos[Result].DataLevelObject <> nil then
    begin
      R := DataLevelInfos[Result].Bounds;
      if P.X < GetRangeCenter(R.Left, R.Right) then
        Exit;
    end;
  Result := GridView.VisibleDataGroupCount;
end;

function TcxGridChartToolBoxViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  I: Integer;
  AHitTest: TcxCustomGridHitTest;
...
function TcxGridChartViewInfo.GetTitleViewInfoClass
  : TcxGridChartTitleViewInfoClass;
begin
  Result := TcxGridChartTitleViewInfo;
end;

function TcxGridChartViewInfo.GetToolBoxViewInfoClass
  : TcxGridChartToolBoxViewInfoClass;
begin
...
begin
  Result := cxRectInflate(inherited CalculateClientBounds,
    ScaleFactor.Apply(-ChartPartOffset));
end;
...
begin
  ...
  begin
    PositionRect(APartBounds, ABounds, APart.Width, APart.Height,
      ScaleFactor.Apply(ChartPartOffset), APart.Position);
    AlignRect(APartBounds, APart.Width, APart.Height, APart.Position
      in [cppTop, cppBottom], APart.Alignment);
  end
  else
    SetRectEmpty(APartBounds);
end;

procedure TcxGridChartViewInfo.CalculatePartsBounds(out ADiagramBounds,
  ALegendBounds, ATitleBounds, AToolBoxBounds: TRect);
begin
...
function TcxGridChartViewInfo.DoGetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
  if FDiagramViewInfo <> nil then
...
procedure TcxCustomGridChartTitle.SetAlignment
  (Value: TcxGridChartPartAlignment);
begin
...
begin
  ...
  else if AName = 'Title.Position' then
...
function TcxCustomGridChartTitle.GetDefaultOrientation
  : TcxGridChartPartOrientation;
begin
...
begin
  if AName = 'Legend.Alignment' then
    AValue := Variant(Alignment)
  else if AName = 'Legend.Border' then
    AValue := Variant(Border)
  else if AName = 'Legend.KeyBorder' then
    AValue := Variant(KeyBorder)
  else if AName = 'Legend.Orientation' then
    AValue := Variant(Orientation)
  else if AName = 'Legend.Position' then
    AValue := Variant(Position);
  inherited;
end;
...
function TcxGridChartLegend.GetDefaultOrientation
  (APosition: TcxGridChartPartPosition): TcxGridChartPartOrientation;
begin
...
function TcxGridChartLegend.GetOrientation
  (APosition: TcxGridChartPartPosition = cppDefault)
  : TcxGridChartPartOrientation;
begin
  Result := FOrientation;
...
constructor TcxCustomGridChartDiagramOptions.Create
  (ADiagram: TcxGridChartDiagram);
begin
  inherited Create;
  FDiagram := ADiagram;
...
function TcxCustomGridChartDiagramOptions.GetLookAndFeelPainter
  : TcxCustomLookAndFeelPainter;
begin
  Result := FDiagram.GridView.LookAndFeelPainter;
end;

procedure TcxCustomGridChartDiagramOptions.Changed
  (AChange: TcxGridDiagramChange = dcLayout);
begin
...
procedure TcxGridChartDiagramStyles.GetDefaultViewParams(Index: Integer;
      ...
      dsValues:
        ...
        begin
          if VisibleSeriesIndex <> -1 then
            GridView.VisibleSeries[VisibleSeriesIndex].Styles.GetValueParams
              (ValueIndex, GetVaryColorsByCategory, AParams)
          else
...
procedure TcxGridChartDiagramStyles.GetBackgroundParams
  (out AParams: TcxViewParams);
begin
  GridView.Styles.GetViewParams(vsBackground, nil, nil, AParams);
end;

procedure TcxGridChartDiagramStyles.GetValueParams(AVisibleSeriesIndex,
  AValueIndex: Integer; out AParams: TcxViewParams);
var
...
procedure TcxGridChartDiagram.SetOnCustomDrawLegend
  (Value: TcxGridChartDiagramLegendCustomDrawEvent);
begin
...
procedure TcxGridChartDiagram.SetOnCustomDrawLegendItem
  (Value: TcxGridChartDiagramLegendItemCustomDrawEvent);
begin
...
procedure TcxGridChartDiagram.SetOnCustomDrawValue
  (Value: TcxGridChartDiagramValueCustomDrawEvent);
begin
...
function TcxGridChartDiagram.GetStackedValueCaption(ASeries: TcxGridChartSeries;
  AValueIndex: Integer; APercentage: Boolean): string;
var
  AValue: Variant;
  AFormat: string;
begin
  ...
  begin
    ...
    AValue := TcxGridChartHistogramViewInfo(GridView.ViewInfo.DiagramViewInfo)
      .GetStackedValue(ASeries.VisibleIndex, AValueIndex);
...
constructor TcxGridChartHistogramAxisTitle.Create
  (AAxis: TcxGridChartHistogramAxis);
begin
  FAxis := AAxis;
  inherited Create(nil);
end;

function TcxGridChartHistogramAxisTitle.GetDefaultPosition
...
procedure TcxGridChartHistogramAxis.SetTickMarkKind
  (Value: TcxGridChartHistogramTickMarkKind);
begin
...
procedure TcxGridChartHistogramAxis.SetTitle
  (Value: TcxGridChartHistogramAxisTitle);
begin
  FTitle.Assign(Value);
end;
...
function TcxGridChartHistogramAxis.GetTitleClass
  : TcxGridChartHistogramAxisTitleClass;
begin
...
constructor TcxGridChartHistogramAxisCategory.Create
  (ADiagram: TcxGridChartDiagram);
begin
  inherited;
...
procedure TcxGridChartHistogramAxisCategory.SetCategoriesInReverseOrder
  (Value: Boolean);
begin
...
procedure TcxGridChartHistogramAxisCategory.SetValueAxisAtMaxCategory
  (Value: Boolean);
begin
...
procedure TcxGridChartHistogramAxisCategory.SetValueAxisBetweenCategories
  (Value: Boolean);
begin
...
function TcxGridChartHistogramAxisCategory.
  GetDefaultValueAxisBetweenCategories: Boolean;
begin
  Result := True;
end;
...
function TcxGridChartHistogramAxisCategory.GetPosition
  : TcxGridChartAxisPosition;
begin
  Result := Diagram.GetCategoryAxisPosition;
end;
...
procedure TcxGridChartHistogramAxisValue.SetMinMaxValues
  (Value: TcxGridChartHistogramMinMaxValues);
begin
...
procedure TcxGridChartHistogramAxisValue.SetTickMarkLabelFormat
  (const Value: string);
begin
...
function TcxGridChartHistogramAxisValue.GetTickMarkLabel(const ATickMarkValue
  : Variant): string;
var
...
begin
  ...
  if ATickMarkLabelFormat = '' then
    case GridView.VisibleSeriesCount of
      ...
      1:
        Result := GridView.VisibleSeries[0].GetValueDisplayText(ATickMarkValue);
    else
      ATickMarkLabelFormat := GetTickMarkLabelFormat(True);
      if ATickMarkLabelFormat = '' then
        Result := GridView.VisibleSeries[0].DataBinding.GetValueDisplayText
          (ATickMarkValue)
      else
...
function TcxGridChartHistogramAxisValue.GetTickMarkLabelFormat
  (AConsiderSeriesFormat: Boolean): string;
var
  I: Integer;
...
procedure TcxGridChartHistogramValues.SetStacking
  (Value: TcxGridChartValuesStacking);
begin
...
procedure TcxGridChartHistogram.SetAxisCategory
  (Value: TcxGridChartHistogramAxisCategory);
begin
  FAxisCategory.Assign(Value);
end;

procedure TcxGridChartHistogram.SetAxisValue
  (Value: TcxGridChartHistogramAxisValue);
begin
...
procedure TcxGridChartHistogram.SetOnCustomDrawPlot
  (Value: TcxGridChartHistogramPlotCustomDrawEvent);
begin
...
function TcxGridChartHistogram.GetAxisCategoryClass
  : TcxGridChartHistogramAxisCategoryClass;
begin
  Result := TcxGridChartHistogramAxisCategory;
end;

function TcxGridChartHistogram.GetAxisValueClass
  : TcxGridChartHistogramAxisValueClass;
begin
...
function TcxGridChartHistogram.GetLegendViewInfoClass
  : TcxGridChartLegendViewInfoClass;
begin
...
function TcxGridChartHistogram.GetCategoryAxisPosition
  : TcxGridChartAxisPosition;
begin
  Result := cppBottom;
end;
...
begin
  if AxisCategory.ValueAxisAtMaxCategory xor AxisCategory.CategoriesInReverseOrder
  then
    Result := cppRight
  else
    Result := cppLeft;
...
constructor TcxGridChartColumnDiagramValues.Create
  (ADiagram: TcxGridChartDiagram);
begin
  inherited;
...
procedure TcxGridChartColumnDiagramValues.SetCaptionPosition
  (Value: TcxGridChartColumnDiagramValueCaptionPosition);
begin
...
procedure TcxGridChartColumnDiagram.SetValues
  (Value: TcxGridChartColumnDiagramValues);
begin
  inherited Values := Value;
end;

function TcxGridChartColumnDiagram.GetLegendViewInfoClass
  : TcxGridChartLegendViewInfoClass;
begin
  Result := TcxGridChartColumnDiagramLegendViewInfo;
end;

function TcxGridChartColumnDiagram.GetValuesClass
  : TcxGridChartHistogramValuesClass;
begin
  Result := TcxGridChartColumnDiagramValues;
end;

function TcxGridChartColumnDiagram.GetViewInfoClass
  : TcxGridChartDiagramViewInfoClass;
begin
...
function TcxGridChartBarDiagram.GetCategoryAxisPosition
  : TcxGridChartAxisPosition;
begin
  Result := cppLeft;
end;
...
begin
  Result := (StackedStyle = sas100Percent) and
    (EmptyPointsDisplayMode = epdmGap);
end;
...
begin
  Result := GetStackedValueCaption(ASeries, AValueIndex,
    StackedStyle = sas100Percent);
end;

function TcxGridChartStackedAreaDiagram.GetViewInfoClass
  : TcxGridChartDiagramViewInfoClass;
begin
...
constructor TcxGridChartStackedColumnDiagram.Create
  (AGridView: TcxGridChartView);
begin
...
begin
  ...
  begin
    ...
    SideBySideIndentWidth := TcxGridChartStackedColumnDiagram(Source)
...
begin
  Result := GetStackedValueCaption(ASeries, AValueIndex,
    StackedStyle in [sds100Percent, sdsSideBySide100Percent]);
end;
...
function TcxGridChartStackedColumnDiagram.GetViewInfoClass
  : TcxGridChartDiagramViewInfoClass;
begin
  Result := TcxGridChartStackedColumnDiagramViewInfo
end;

procedure TcxGridChartStackedColumnDiagram.SetSideBySideIndentWidth
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
const
  StackingStyleToValuesStacking: array [TcxGridChartStackedDiagramStyle]
    of TcxGridChartValuesStacking = (vsNone, vs100Percent, vsNone,
    vs100Percent);
begin
  if FStackedStyle <> Value then
  begin
...
function TcxGridChartStackedBarDiagram.GetCategoryAxisPosition
  : TcxGridChartAxisPosition;
begin
  Result := cppLeft;
end;
...
function TcxGridChartStackedBarDiagram.GetValueAxisPosition
  : TcxGridChartAxisPosition;
begin
  if AxisCategory.ValueAxisAtMaxCategory xor AxisCategory.CategoriesInReverseOrder
  then
...
function TcxGridChartLineDiagramAxisCategory.
  GetDefaultValueAxisBetweenCategories: Boolean;
begin
  Result := False;
end;
...
procedure TcxGridChartLineDiagramStyles.GetValueMarkerParams
  (AVisibleSeriesIndex, AValueIndex: Integer; out AParams: TcxViewParams);
var
  AData: TcxGridChartDiagramValueData;
begin
  AData := TcxGridChartDiagramValueData.Create;
...
procedure TcxGridChartLineDiagramValues.SetLineStyle
  (Value: TcxGridChartLineStyle);
begin
...
procedure TcxGridChartLineDiagramValues.SetMarkerStyle
  (Value: TcxGridChartMarkerStyle);
begin
...
procedure TcxGridChartLineDiagramValues.SetOnGetLineStyle
  (Value: TcxGridChartLineDiagramGetLineStyleEvent);
begin
...
procedure TcxGridChartLineDiagramValues.SetOnGetMarkerStyle
  (Value: TcxGridChartLineDiagramGetMarkerStyleEvent);
begin
...
procedure TcxGridChartLineDiagramValues.DoGetLineStyle
  (ASeries: TcxGridChartSeries; var AStyle: TcxGridChartLineStyle);
begin
  if Assigned(FOnGetLineStyle) then
    FOnGetLineStyle(Diagram, ASeries, AStyle);
end;

procedure TcxGridChartLineDiagramValues.DoGetMarkerStyle
  (ASeries: TcxGridChartSeries; var AStyle: TcxGridChartMarkerStyle);
begin
  if Assigned(FOnGetMarkerStyle) then
    FOnGetMarkerStyle(Diagram, ASeries, AStyle);
end;
...
function TcxGridChartLineDiagramValues.GetLineStyle(ASeries: TcxGridChartSeries)
  : TcxGridChartLineStyle;
begin
  Result := FLineStyle;
...
function TcxGridChartLineDiagramValues.GetMarkerStyle
  (ASeries: TcxGridChartSeries): TcxGridChartMarkerStyle;
begin
  Result := FMarkerStyle;
...
function TcxGridChartLineDiagram.GetAxisCategory
  : TcxGridChartLineDiagramAxisCategory;
begin
...
procedure TcxGridChartLineDiagram.SetAxisCategory
  (Value: TcxGridChartLineDiagramAxisCategory);
begin
  inherited AxisCategory := Value;
end;

procedure TcxGridChartLineDiagram.SetStyles
  (Value: TcxGridChartLineDiagramStyles);
begin
  inherited Styles := Value;
end;

procedure TcxGridChartLineDiagram.SetValues
  (Value: TcxGridChartLineDiagramValues);
begin
  inherited Values := Value;
end;

function TcxGridChartLineDiagram.GetAxisCategoryClass
  : TcxGridChartHistogramAxisCategoryClass;
begin
  Result := TcxGridChartLineDiagramAxisCategory;
end;

function TcxGridChartLineDiagram.GetLegendViewInfoClass
  : TcxGridChartLegendViewInfoClass;
begin
...
function TcxGridChartLineDiagram.GetValuesClass
  : TcxGridChartHistogramValuesClass;
begin
  Result := TcxGridChartLineDiagramValues;
end;

function TcxGridChartLineDiagram.GetViewInfoClass
  : TcxGridChartDiagramViewInfoClass;
begin
...
procedure TcxGridChartAreaDiagram.SetStyles
  (Value: TcxGridChartAreaDiagramStyles);
begin
  inherited Styles := Value;
end;
...
procedure TcxGridChartAreaDiagram.SetOnCustomDrawValueArea
  (Value: TcxGridChartAreaDiagramValueAreaCustomDrawEvent);
begin
...
function TcxGridChartAreaDiagram.GetLegendViewInfoClass
  : TcxGridChartLegendViewInfoClass;
begin
...
function TcxGridChartAreaDiagram.GetViewInfoClass
  : TcxGridChartDiagramViewInfoClass;
begin
...
begin
  ...
  begin
    OnCustomDrawValueArea := TcxGridChartAreaDiagram(Source)
...
procedure TcxGridChartPieDiagramValues.SetCaptionItems
  (Value: TcxGridChartPieDiagramValueCaptionItems);
begin
...
procedure TcxGridChartPieDiagramValues.SetCaptionItemSeparator
  (const Value: string);
begin
...
procedure TcxGridChartPieDiagramValues.SetCaptionPosition
  (Value: TcxGridChartPieDiagramValueCaptionPosition);
begin
  if FCaptionPosition <> Value then
  begin
...
procedure TcxGridChartPieDiagramValues.SetPercentageCaptionFormat
  (const Value: string);
begin
...
function TcxGridChartPieDiagramValues.GetCaptionPosition
  : TcxGridChartPieDiagramValueCaptionPosition;
begin
...
procedure TcxGridChartPieDiagram.SetOnCustomDrawSeriesSite
  (Value: TcxGridChartPieDiagramSeriesSiteCustomDrawEvent);
begin
...
procedure TcxGridChartPieDiagram.SetOnCustomDrawSeriesSiteCaption
  (Value: TcxGridChartPieDiagramSeriesSiteCaptionCustomDrawEvent);
begin
...
function TcxGridChartPieDiagram.GetValuesClass
  : TcxGridChartPieDiagramValuesClass;
begin
  Result := TcxGridChartPieDiagramValues;
end;

function TcxGridChartPieDiagram.GetLegendViewInfoClass
  : TcxGridChartLegendViewInfoClass;
begin
  Result := TcxGridChartPieDiagramLegendViewInfo;
end;

function TcxGridChartPieDiagram.GetViewInfoClass
  : TcxGridChartDiagramViewInfoClass;
begin
...
procedure TcxGridChartPieDiagram.DoCustomDrawSeriesSiteCaption
  (ACanvas: TcxCanvas; AViewInfo: TcxGridChartPieSeriesSiteCaptionViewInfo;
  var ADone: Boolean);
begin
      ...
      pdvciPercentage:
        begin
          if ASeries.SumOfValues = 0 then
            ...
            AValue := Abs(100 * ASeries.VisibleValues[AValueIndex] /
              ASeries.SumOfValues);
  ...
  for ACaptionItem := Low(ACaptionItem) to High(ACaptionItem) do
    if ACaptionItem in Values.CaptionItems then
      if Result = '' then
        ...
        Result := Result + Values.GetCaptionItemSeparator +
          GetItemText(ACaptionItem);
end;
...
function TcxGridChartItemDataBinding.GetDefaultProperties
...
function TcxGridChartItemDataBinding.GetDefaultValuesProvider
...
procedure TcxGridChartItemDataBinding.SetValueTypeClass
  (Value: TcxValueTypeClass);
begin
  DataController.ChangeValueTypeClass(DataIndex, Value);
end;

procedure TcxGridChartItemDataBinding.ItemRemoved
  (Sender: TcxEditRepositoryItem);
begin
  UpdateDefaultRepositoryItemValue;
end;

procedure TcxGridChartItemDataBinding.PropertiesChanged
  (Sender: TcxEditRepositoryItem);
begin
  if not GridView.IsPattern then
    GridView.Changed(vcLayout);
end;

procedure TcxGridChartItemDataBinding.CreateSummaryItem(var ASummaryItem
  : TcxDataSummaryItem);
begin
...
function TcxGridChartItemDataBinding.GetDefaultValuesProviderClass
  : TcxCustomEditDefaultValuesProviderClass;
begin
  Result := TcxCustomEditDefaultValuesProvider;
end;

function TcxGridChartItemDataBinding.GetDefaultValueTypeClass
  : TcxValueTypeClass;
begin
...
begin
  Result := DataController.Summary.DefaultGroupSummaryItems.ItemOfItemLink
    (DataItem);
end;

procedure TcxGridChartItemDataBinding.InitDefaultValuesProvider
...
begin
  Result := (ValueTypeClass = nil) or
    IsValueTypeValid(ValueTypeClass.GetVarType, True);
end;
...
function TcxGridChartItemDataBinding.GetDefaultRepositoryItem
...
function TcxGridChartItemDataBinding.GetValueDisplayText
  (const AValue: Variant): string;
begin
  Result := DefaultProperties.GetDisplayText(AValue);
end;

function TcxGridChartItemDataBinding.IsValueTypeClassValid(AValueTypeClass
...
procedure TcxGridChartItem.SetOnGetStoredProperties
  (Value: TcxGridChartItemGetStoredPropertiesEvent);
begin
...
procedure TcxGridChartItem.SetOnGetStoredPropertyValue
  (Value: TcxGridChartItemGetStoredPropertyValueEvent);
begin
...
procedure TcxGridChartItem.SetOnGetValueDisplayText
  (Value: TcxGridChartGetValueDisplayTextEvent);
begin
...
procedure TcxGridChartItem.SetOnSetStoredPropertyValue
  (Value: TcxGridChartItemSetStoredPropertyValueEvent);
begin
...
procedure TcxGridChartItem.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
  if AName = 'Index' then
    AValue := Index
...
procedure TcxGridChartItem.SetPropertyValue(const AName: string;
  const AValue: Variant);
begin
  if AName = 'Index' then
...
begin
  if DataBinding.GetDefaultDisplayText <> FLastDataBindingDefaultDisplayText
  then
  begin
...
procedure TcxGridChartCategories.SetDataBinding
  (Value: TcxGridChartItemDataBinding);
begin
  FDataBinding.Assign(Value);
end;
...
procedure TcxGridChartCategories.SetOnGetValueDisplayText
  (Value: TcxGridChartGetValueDisplayTextEvent);
begin
  if not dxSameMethods(FOnGetValueDisplayText, Value) then
  begin
...
function TcxGridChartCategories.GetValueDisplayText(const AValue
  : Variant): string;
begin
...
function TcxGridChartDataGroup.GetStoredProperties
...
procedure TcxGridChartDataGroup.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
...
procedure TcxGridChartDataGroup.SetPropertyValue(const AName: string;
  const AValue: Variant);
begin
  if AName = 'ActiveValue' then
    ActiveValue := AValue
...
begin
  Result := not VarIsEmpty(FActiveValue) and
    (not VarIsNull(FActiveValue) or HasNullGroupValue);
end;
...
procedure TcxGridChartSeriesStyles.SetOnGetValueStyle
  (Value: TcxGridChartSeriesGetValueStyleEvent);
begin
...
begin
  ...
  if not AVaryColorsByCategory then
    AValueIndex := -1;
...
procedure TcxGridChartSeries.SetOnCustomDrawValue
  (Value: TcxGridChartSeriesValueCustomDrawEvent);
begin
  if not dxSameMethods(FOnCustomDrawValue, Value) then
  begin
...
procedure TcxGridChartSeries.SetOnValueClick
  (Value: TcxGridChartValueClickEvent);
begin
...
procedure TcxGridChartSeries.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
...
procedure TcxGridChartSeries.SetPropertyValue(const AName: string;
  const AValue: Variant);
begin
  if AName = 'SortOrder' then
...
function TcxGridChartSeries.IsGroupSummaryKindValid
  (AValue: TcxSummaryKind): Boolean;
begin
...
begin
  inherited;
  FBorder := tbSingle;
  FDataLevelActiveValueDropDownCount :=
...
procedure TcxGridChartToolBox.SetDataLevelActiveValueDropDownCount
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
procedure TcxGridChartToolBox.SetDataLevelActiveValueDropDownWidth
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
procedure TcxGridChartToolBox.SetDataLevelsInfoVisible
  (Value: TcxGridChartDataLevelsInfoVisible);
begin
...
begin
  if AName = 'ToolBox.Border' then
    AValue := Variant(Border)
  else if AName = 'ToolBox.DiagramSelector' then
    AValue := DiagramSelector
  else if AName = 'ToolBox.Position' then
    AValue := Variant(Position);
  inherited;
end;
...
begin
  ...
  if Source is TcxGridChartToolBox then
    ...
    begin
      ...
      Self.DataLevelActiveValueDropDownCount :=
        DataLevelActiveValueDropDownCount;
      Self.DataLevelActiveValueDropDownWidth :=
...
procedure TcxGridChartOptionsBehavior.SetValueHotTrack
  (Value: TcxGridChartValueHotTrack);
begin
...
procedure TcxGridChartOptionsBehavior.GetStoredProperties
...
procedure TcxGridChartOptionsBehavior.GetStoredPropertyValue
...
procedure TcxGridChartOptionsBehavior.SetStoredPropertyValue
...
function TcxGridChartOptionsBehavior.GetDefaultValueHotTrack
  (AValueIndex: Integer): Boolean;
begin
...
function TcxGridChartOptionsBehavior.GetValueHotTrack
  (AValueIndex: Integer): Boolean;
begin
  Result := GridView.ActiveDiagram.SupportsValueHotTrack and
    ((FValueHotTrack = vhAlways) or (FValueHotTrack = vhDefault) and
    GetDefaultValueHotTrack(AValueIndex));
end;
...
procedure TcxGridChartOptionsCustomize.SetDataDrillUpMethod
  (Value: TcxGridChartDataDrillUpMethod);
begin
...
procedure TcxGridChartViewStyles.GetDefaultViewParams(Index: Integer;
  AData: TObject; out AParams: TcxViewParams);
begin
  inherited;
  with AParams, LookAndFeelPainter do
...
procedure TcxGridOpenChartItemList.SetItem(Index: Integer;
  Value: TcxGridChartItem);
begin
...
function TcxGridChartView.GetAvailableDiagram(Index: Integer)
  : TcxGridChartDiagram;
begin
...
begin
  ...
  begin
    Result := Series[I];
    if Result.SortOrder <> soNone then
      Exit;
  end;
  Result := nil;
end;
...
function TcxGridChartView.GetVisibleDataGroup(Index: Integer)
  : TcxGridChartDataGroup;
begin
...
begin
  if Value < 0 then
    Value := 0;
  if Value > DataLevelCount - 1 then
    Value := DataLevelCount - 1;
...
procedure TcxGridChartView.SetDataGroup(Index: Integer;
  Value: TcxGridChartDataGroup);
begin
...
procedure TcxGridChartView.SetDiagramStackedArea
  (Value: TcxGridChartStackedAreaDiagram);
begin
  FDiagramStackedArea.Assign(Value);
end;

procedure TcxGridChartView.SetDiagramStackedBar
  (Value: TcxGridChartStackedBarDiagram);
begin
  FDiagramStackedBar.Assign(Value);
end;

procedure TcxGridChartView.SetDiagramStackedColumn
  (Value: TcxGridChartStackedColumnDiagram);
begin
...
procedure TcxGridChartView.SetOptionsBehavior
  (Value: TcxGridChartOptionsBehavior);
begin
  inherited OptionsBehavior := Value;
end;

procedure TcxGridChartView.SetOptionsCustomize
  (Value: TcxGridChartOptionsCustomize);
begin
...
procedure TcxGridChartView.SetOnActiveDiagramChanged
  (Value: TcxGridChartDiagramEvent);
begin
...
procedure TcxGridChartView.SetOnCustomDrawLegend
  (Value: TcxGridChartLegendCustomDrawEvent);
begin
  if not dxSameMethods(FOnCustomDrawLegend, Value) then
  begin
    FOnCustomDrawLegend := Value;
...
procedure TcxGridChartView.SetOnCustomDrawLegendItem
  (Value: TcxGridChartLegendItemCustomDrawEvent);
begin
  if not dxSameMethods(FOnCustomDrawLegendItem, Value) then
  begin
...
procedure TcxGridChartView.SetOnDataGroupPosChanged
  (Value: TcxGridChartDataGroupEvent);
begin
...
procedure TcxGridChartView.SetOnFirstVisibleCategoryIndexChanged
  (Value: TNotifyEvent);
begin
...
procedure TcxGridChartView.SetOnGetValueHint
  (Value: TcxGridChartGetValueHintEvent);
begin
...
procedure TcxGridChartView.SetOnSeriesPosChanged
  (Value: TcxGridChartSeriesEvent);
begin
...
procedure TcxGridChartView.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
  if AName = 'ActiveDataLevel' then
    AValue := ActiveDataLevel
  else if AName = 'ActiveDiagram' then
...
procedure TcxGridChartView.SetPropertyValue(const AName: string;
  const AValue: Variant);
var
  ADiagram: TcxGridChartDiagram;
begin
...
function TcxGridChartView.CreateStoredObject(const AObjectName,
  AClassName: string): TObject;
begin
  if AClassName = GetDataGroupClass.ClassName then
    Result := CreateDataGroup
  else if AClassName = GetSeriesClass.ClassName then
    Result := CreateSeries
  else
...
procedure TcxGridChartView.ActiveDataLevelChanged(APrevActiveDataLevel
  : Integer);
begin
...
procedure TcxGridChartView.DoAssign(ASource: TcxCustomGridView);
  ...
  procedure AssignItems(ASource: TcxGridChartView;
    AItemClass: TcxGridChartItemClass; AItemKind: TcxGridChartItemKind);
  var
...
begin
  ...
  begin
    ...
    begin
      ...
      Self.OnFirstVisibleCategoryIndexChanged :=
...
begin
  inherited;
  for I := 0 to DataGroupCount - 1 do
    if DataGroups[I].Owner = Root then
      Proc(DataGroups[I]);
  for I := 0 to SeriesCount - 1 do
    if Series[I].Owner = Root then
      Proc(Series[I]);
end;
...
begin
  ...
  begin
    RenameComponents(Self, Owner, Name, AOldName, DataGroupCount,
      @ChartViewGetDataGroup);
    RenameComponents(Self, Owner, Name, AOldName, SeriesCount,
      @ChartViewGetSeries);
  end;
end;
...
begin
  ...
  if not(IsLoading or IsDestroying) and
    not(AInfo is TcxFocusedRecordChangedInfo) and
    not(AInfo is TcxFocusedRowChangedInfo) then
  begin
    LayoutChanged;
    if (AInfo is TcxDataChangedInfo) or (AInfo is TcxLayoutChangedInfo) then
    begin
...
function TcxGridChartView.GetItemDataBindingClass
  : TcxGridChartItemDataBindingClass;
begin
...
function TcxGridChartView.GetOptionsBehaviorClass
  : TcxCustomGridOptionsBehaviorClass;
begin
  Result := TcxGridChartOptionsBehavior;
end;

function TcxGridChartView.GetOptionsCustomizeClass
  : TcxGridChartOptionsCustomizeClass;
begin
...
function TcxGridChartView.GetStackedAreaDiagramClass
  : TcxGridChartStackedAreaDiagramClass;
begin
  Result := TcxGridChartStackedAreaDiagram;
end;

function TcxGridChartView.GetStackedColumnDiagramClass
  : TcxGridChartStackedColumnDiagramClass;
begin
  Result := TcxGridChartStackedColumnDiagram;
end;

function TcxGridChartView.GetStackedBarDiagramClass
  : TcxGridChartStackedBarDiagramClass;
begin
...
function TcxGridChartView.CreateDiagram(ADiagramClass: TcxGridChartDiagramClass)
  : TcxGridChartDiagram;
begin
...
begin
  FDiagramColumn := TcxGridChartColumnDiagram
    (CreateDiagram(GetColumnDiagramClass)); // should first to be default
  FDiagramBar := TcxGridChartBarDiagram(CreateDiagram(GetBarDiagramClass));
  FDiagramStackedArea := TcxGridChartStackedAreaDiagram
    (CreateDiagram(GetStackedAreaDiagramClass));
  FDiagramStackedBar := TcxGridChartStackedBarDiagram
    (CreateDiagram(GetStackedBarDiagramClass));
  FDiagramStackedColumn := TcxGridChartStackedColumnDiagram
    (CreateDiagram(GetStackedColumnDiagramClass));
...
function TcxGridChartView.GetDiagramNamePath
  (ADiagram: TcxGridChartDiagram): string;
begin
  Result := Name;
  if Result <> '' then
    Result := Result + '.';
...
procedure TcxGridChartView.DataSortingChanging(AItem: TObject);
  ...
  begin
    ...
    begin
      ASortedItem := FDataController.GetItem
        (FDataController.GetSortingItemIndex(I));
...
begin
  if (AItem is GetSeriesClass) and (TcxGridChartSeries(AItem).SortOrder = soNone)
  then
    ClearSeriesSorting;
end;
...
begin
  if AItemClass = GetSeriesClass then
    Result := FSeries
  else if AItemClass = GetDataGroupClass then
    Result := FDataGroups
  else
    Result := nil;
end;
...
begin
  if AItemKind = cikSeries then
    Result := FSeries
  else if AItemKind = cikDataGroup then
    Result := FDataGroups
  else
    Result := nil;
end;
...
begin
  ...
  else if AItem is GetDataGroupClass then
...
procedure TcxGridChartView.SetItemIndex(AItem: TcxGridChartItem;
  AIndex: Integer);
begin
...
procedure TcxGridChartView.DataGroupVisibilityChanged
...
function CompareSeriesByGroupIndex(ASeries1,
  ASeries2: TcxGridChartSeries): Integer;
begin
...
procedure TcxGridChartView.ItemVisibilityForCustomizationChanged
...
procedure TcxGridChartView.RefreshVisibleItemsList(AItems,
  AVisibleItems: TList);
var
  I: Integer;
  AItem: TcxGridChartItem;
    ...
    begin
      ...
      begin
        if (ActiveDiagram is TcxGridChartStackedColumnDiagram) and
          (TcxGridChartStackedColumnDiagram(ActiveDiagram).StackedStyle
          in [sdsSideBySide, sdsSideBySide100Percent]) then
          AIndex := GroupIndex
        else
          AIndex := 0;
...
function TcxGridChartView.CreateItem(AItemClass: TcxGridChartItemClass)
  : TcxGridChartItem;
begin
...
begin
  for Result := 0 to ALevel - 1 do
    if not DataLevelObjects[Result].HasActiveValue then
      Exit;
  Result := ALevel;
end;
...
function TcxGridChartView.GetDataLevelObject(Index: Integer)
  : TcxGridChartDataGroup;
begin
...
function TcxGridChartView.GetDataObjectLevel
  (AObject: TcxGridChartDataGroup): Integer;
begin
  Result := AObject.VisibleIndex;
end;

procedure TcxGridChartView.SetDataObjectLevel(AObject: TcxGridChartDataGroup;
  ALevel: Integer);
begin
  if ALevel = -1 then
    AObject.Visible := False
  else if (0 <= ALevel) and
    (ALevel < VisibleDataGroupCount + Ord(not AObject.Visible)) then
  begin
    BeginUpdate;
    try
...
begin
  ...
  if ASeries = nil then
    ...
    FDataController.SortingBySummaryDataItemIndex :=
      ASeries.DataBinding.DataIndex;
end;
...
begin
  if Assigned(FOnActiveDataLevelChanged) then
    FOnActiveDataLevelChanged(Self);
end;

procedure TcxGridChartView.DoActiveDiagramChanged
  (ADiagram: TcxGridChartDiagram);
begin
  if Assigned(FOnActiveDiagramChanged) then
...
procedure TcxGridChartView.DoDataGroupPosChanged
  (ADataGroup: TcxGridChartDataGroup);
begin
  if Assigned(FOnDataGroupPosChanged) then
    FOnDataGroupPosChanged(Self, ADataGroup);
end;
...
procedure TcxGridChartView.DoGetValueHint(ASeries: TcxGridChartSeries;
  AValueIndex: Integer; var AHint: string);
begin
...
begin
  if Assigned(FOnSeriesPosChanged) then
    FOnSeriesPosChanged(Self, ASeries);
end;

function TcxGridChartView.DoValueClick(ASeries: TcxGridChartSeries;
  AValueIndex: Integer): Boolean;
begin
  Result := False;
  if Assigned(FOnValueClick) then
...
begin
  if IsPattern or not(AGraphicClass.InheritsFrom(TMetafile) or
    AGraphicClass.InheritsFrom(TBitmap)) then
  begin
    Result := nil;
    Exit;
  end;
...
function TcxGridChartView.FindDiagramByDisplayText(const ADisplayText: string)
  : TcxGridChartDiagram;
var
  I: Integer;
begin
  ...
  begin
    Result := Diagrams[I];
    if Result.DisplayText = ADisplayText then
      Exit;
  end;
  Result := nil;
end;

function TcxGridChartView.FindDiagramByID(const AID: string)
  : TcxGridChartDiagram;
var
  I: Integer;
begin
...
function TcxGridChartView.FindSeriesByName(const AName: string)
  : TcxGridChartSeries;
begin
...
function TcxGridChartView.FindDataGroupByID(AID: Integer)
  : TcxGridChartDataGroup;
begin
  Result := TcxGridChartDataGroup(FindItemByID(GetDataGroupClass, AID));
end;

function TcxGridChartView.FindDataGroupByName(const AName: string)
  : TcxGridChartDataGroup;
begin
  Result := TcxGridChartDataGroup(FindItemByName(GetDataGroupClass, AName));
end;

function TcxGridChartView.FindDataGroupByTag(ATag: TcxTag)
  : TcxGridChartDataGroup;
begin
