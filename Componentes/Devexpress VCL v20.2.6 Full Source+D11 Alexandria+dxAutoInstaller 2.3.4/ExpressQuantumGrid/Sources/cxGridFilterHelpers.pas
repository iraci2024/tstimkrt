...
class function TcxFilterExtLookupComboBoxHelper.GetFilterEditClass
  : TcxCustomEditClass;
begin
...
class procedure TcxFilterExtLookupComboBoxHelper.InitializeProperties
...
begin
  ...
  begin
    ...
    if (AView <> nil) and (TcxExtLookupComboBoxProperties(AEditProperties)
      .ListFieldItem <> nil) then
    begin
      ListSource := TcxDBDataController(AView.DataController).DataSource;
      KeyFieldNames := TcxExtLookupComboBoxProperties(AEditProperties)
        .KeyFieldNames;
      ListFieldNames := TcxGridItemDBDataBinding
        (TcxExtLookupComboBoxProperties(AEditProperties)
        .ListFieldItem.DataBinding).FieldName;
...
class function TcxFilterExtLookupComboBoxHelper.IsValueValid(AValueTypeClass
