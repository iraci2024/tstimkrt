...
uses
  ...
  cxViewEditor, cxCustomTableViewEditor, cxGridCustomView,
  cxGridWinExplorerView,
...
function TcxGridWinExplorerViewStorage.GetOptionsBehavior
  : TcxGridWinExplorerViewOptionsBehavior;
begin
  Result := WinExplorerView.OptionsBehavior;
end;

function TcxGridWinExplorerViewStorage.GetOptionsData
  : TcxGridWinExplorerViewOptionsData;
begin
  Result := WinExplorerView.OptionsData;
end;

function TcxGridWinExplorerViewStorage.GetOptionsSelection
  : TcxGridWinExplorerViewOptionsSelection;
begin
  Result := WinExplorerView.OptionsSelection;
end;

function TcxGridWinExplorerViewStorage.GetOptionsView
...
class function TcxGridWinExplorerViewStorage.GetViewClass
