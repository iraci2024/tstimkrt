...
uses
  ...
  cxGridWizardCustomHelper, cxGridCustomView, cxGridTableView,
  cxGridDBTableView, cxGridBandedTableView,
...
type
  ...
  TcxGridWizardBandedTableViewHelper = class(TcxGridWizardTableViewHelper,
    IcxGridWizardBandedTableView)
  private
  ...
  TcxGridWizardDBBandedTableViewHelper = class(TcxGridWizardDBTableViewHelper,
    IcxGridWizardBandedTableView)
  private
...
uses
  cxGridWizardCustomPage, cxGridWizardDBViewsDataSourcePage,
  cxGridWizardDBViewsSelectItemsForDisplayPage,
  cxGridWizardBandedTableViewOptionsBandsPage,
  cxGridWizardCommonCustomizeItemsPage,
  cxGridWizardDBViewsDataLoadingSettingsPage,
  cxGridWizardTableViewOptionsInterfaceElementsPage,
  cxGridWizardTableViewOptionsInplaceEditFormPage,
  cxGridWizardTableViewOptionsInplaceEditFormLayoutPage,
...
const
  cxGridWizardBandedTableViewPages: array [0 .. 9]
  ...
  cxGridWizardDBBandedTableViewPages: array [0 .. 11]
    of TcxGridWizardCustomPageFrameClass =
...
procedure TcxGridWizardBandedTableViewHelper.CorrectCustomizationFormContent
...
class function TcxGridWizardBandedTableViewHelper.GetGridViewClass
...
procedure TcxGridWizardBandedTableViewHelper.SetBandsQuickCustomization
...
function TcxGridWizardBandedTableViewHelper.GetPageClasses
...
procedure TcxGridWizardDBBandedTableViewHelper.CorrectCustomizationFormContent
  (ACustomizationForm: TForm);
var
  AForm: TcxGridBandedTableCustomizationForm;
begin
...
class function TcxGridWizardDBBandedTableViewHelper.GetGridViewClass
  : TcxCustomGridViewClass;
begin
...
function TcxGridWizardDBBandedTableViewHelper.
  GetBandsQuickCustomization: Boolean;
begin
  Result := GridView.OptionsCustomize.BandsQuickCustomization;
end;

procedure TcxGridWizardDBBandedTableViewHelper.SetBandsQuickCustomization
  (const AValue: Boolean);
begin
  GridView.OptionsCustomize.BandsQuickCustomization := AValue;
end;

function TcxGridWizardDBBandedTableViewHelper.GetGridView
  : TcxGridDBBandedTableView;
begin
  Result := TcxGridDBBandedTableView(inherited GetGridView);
end;

procedure TcxGridWizardDBBandedTableViewHelper.CheckComponentNames
...
begin
  ...
  for I := 0 to ATableView.ColumnCount - 1 do
    ATableView.Columns[I].Name :=
      CreateUniqueName(GetParentForm(ATableView.Control), ATableView,
      ATableView.Columns[I], ScxGridPrefixName,
      ATableView.Columns[I].DataBinding.FieldName);
end;
...
function TcxGridWizardDBBandedTableViewHelper.GetPageClasses
  (Index: Integer): TClass;
begin
