...
uses
  ...
  cxButtons, cxMaskEdit, cxDropDownEdit, dxLayoutContainer, cxTextEdit,
  dxLayoutControl, cxClasses, cxGridWizardStrs,
...
type
  ...
  public
    ...
    property ItemProperties: TStringList read GetItemProperties
      write SetItemProperties;
    property ItemPropertyIndex: Integer read GetItemPropertyIndex
      write SetItemPropertyIndex;
  end;

function cxgwExecuteEditItemDialog(AOwner: TComponent; const ATitle: string;
  var AItemCaption: string): Boolean; overload;
function cxgwExecuteEditItemDialog(AOwner: TComponent; const ATitle: string;
  AItemProperties: TStringList; var AItemCaption: string;
  var AItemPropertyIndex: Integer; const AItemPropertiesCaption: string = '')
  : Boolean; overload;
...
function DoExecuteEditItemDialog(AOwner: TComponent; const ATitle: string;
  AAllowSelectItemProperties: Boolean; AItemProperties: TStringList;
  var AItemCaption: string; var AItemPropertyIndex: Integer;
...
function cxgwExecuteEditItemDialog(AOwner: TComponent; const ATitle: string;
  var AItemCaption: string): Boolean;
var
...
begin
  ...
  try
    Result := DoExecuteEditItemDialog(AOwner, ATitle, False, AList,
      AItemCaption, AItemPropertyIndex, '');
  finally
    AList.Free;
  end;
end;
...
function cxgwExecuteEditItemDialog(AOwner: TComponent; const ATitle: string;
  AItemProperties: TStringList; var AItemCaption: string;
  var AItemPropertyIndex: Integer;
  const AItemPropertiesCaption: string = ''): Boolean;
begin
  Result := DoExecuteEditItemDialog(AOwner, ATitle, True, AItemProperties,
    AItemCaption, AItemPropertyIndex, AItemPropertiesCaption);
end;
...
function TcxGridWizardUnboundViewsEditItemDialogForm.GetItemProperties
  : TStringList;
begin
  Result := cbItemProperties.Properties.Items as TStringList;
end;

function TcxGridWizardUnboundViewsEditItemDialogForm.
  GetItemPropertyIndex: Integer;
begin
  Result := cbItemProperties.ItemIndex;
end;

procedure TcxGridWizardUnboundViewsEditItemDialogForm.SetItemCaption
  (const AValue: string);
begin
  edItemCaption.Text := AValue;
end;

procedure TcxGridWizardUnboundViewsEditItemDialogForm.SetItemProperties
  (AValue: TStringList);
begin
...
procedure TcxGridWizardUnboundViewsEditItemDialogForm.SetItemPropertyIndex
  (AValue: Integer);
begin
...
procedure TcxGridWizardUnboundViewsEditItemDialogForm.FormCreate
  (Sender: TObject);
begin
