...
type
  ...
  TcxGridWizardCardViewOptionsSizingPageFrame = class
...
begin
  ...
  chbCardAutoWidth.Caption := cxGetResourceString
    (@scxgwSizingPageCardAutoWidth);
  chbCardAutoWidth.Hint := cxGetResourceString
  ...
  chbRowCaptionAutoHeight.Caption :=
    cxGetResourceString(@scxgwSizingPageRowCaptionAutoHeight);
  chbRowCaptionAutoHeight.Hint := cxGetResourceString
    (@scxgwSizingPageRowCaptionAutoHeightHint);

  chbRowCaptionEndEllipsis.Caption :=
    cxGetResourceString(@scxgwSizingPageRowCaptionEndEllipsis);
  chbRowCaptionEndEllipsis.Hint :=
    cxGetResourceString(@scxgwSizingPageRowCaptionEndEllipsisHint);
end;
...
procedure TcxGridWizardCardViewOptionsSizingPageFrame.RefreshPreviewGrid
  (Sender: TObject);
begin
