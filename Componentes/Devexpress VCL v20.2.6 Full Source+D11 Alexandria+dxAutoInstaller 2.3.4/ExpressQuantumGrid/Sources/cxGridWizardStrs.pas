...
const
  scxGridWizardDefaultBooleanCaptions: array [0 .. 2] of string = ('Disabled',
    'Enabled', 'Default');
  scxGridWizardNavigatorButtonsNames: array [0 .. NavigatorButtonCount - 1]
    of string = ('First', 'PriorPage', 'Prior', 'Next', 'NextPage', 'Last',
    'Insert', 'Append', 'Delete', 'Edit', 'Post', 'Cancel', 'Refresh',
    'SaveBookmark', 'GotoBookmark', 'Filter');
...
resourcestring
  ...
  scxgwCommonCloseQuery =
    'You are about to terminate the DevExpress Grid Configuration Wizard. ' +
    'If you close the wizard, you will lose all grid configurations. Do you wish to continue?';
  scxgwCommonCreateDetailLevelQuery =
    'Do you want to create a new detail view?';
  ...
  // Wizard Mode Page
  scxgwWizardModePageDescription =
    'Choose the most appropriate data presentation for your task.';
  scxgwWizardModePageTitle = 'Data Presentation';
  scxgwWizardModePageDeletePresentStructure =
    'Delete the Present Level Structure';
  scxgwWizardModePageMultiLevelStructure = 'Master-Detail';
  scxgwWizardModePageSingleLevelStructure = 'Simple Table';

  // Select View Page
  scxgwSelectViewPageDescription =
    'Choose the most appropriate Grid View for your data source.';
  ...
  // Finish Page
  scxgwFinishPageDescription =
    'This is your customized Grid View. If you need to make some corrections, '
    + 'use the Back button, otherwise click Finish to save the changes.';
  scxgwFinishPageTitle = 'Finish';

  // Customize Items Page
  scxgwCustomizeItemsPageDescriptionDB =
    'Provide the most convenient layout for your interface elements.';
  ...
  scxgwCardViewTreeViewFrameInputQueryCaptionAddCategoryRow =
    'Add Category Row';
  scxgwCardViewTreeViewFrameInputQueryCaptionEditRow = 'Edit Row';

  // Customize Bands Page
  scxgwBandsPageDescription =
    'Create bands, name them, and specify their order.';
  ...
  scxgwUnboundsSelectColumnsForDisplayPageDescription =
    'Create columns, name them, and specify their order.';
  ...
  scxgwUnboundsSelectItemsForDisplayPageDescription =
    'Create items, name them, and specify their order.';
  ...
  scxgwUnboundsSelectRowsForDisplayPageDescription =
    'Create rows, name them, and specify their order.';
  ...
  scxgwDataSourcePageDescription =
    'Specify a data source and configure its settings. ' +
  ...
  scxgwEMFDataSourcePageDescription =
    'Specify an EMF data source. Make sure that your data source has the EntityName and Session properties assigned.';
  scxgwEMFDataSourcePageMasterViewKeyFieldNamesHint =
    'Master Key Fields specify a list of fields in a master data source' +
    #13#10 + 'that establish a master-detail relationship between two data sources.';
  ...
  scxgwEMFSelectItemsForDisplayDataSourceFields =
    'Remaining Fields in the Data Source';
  ...
  scxgwSelectItemsForDisplayPageDescription =
    'Select fields to display in the Grid View and specify their order.';
  ...
  scxgwDataSettingsPageDescription =
    'Choose the most appropriate settings for your data processing.';
  ...
  scxgwDataSettingsPageMultiThreadedOptionsFiltering =
  ...
  scxgwUIElementsPageDescription =
    'Specify interface elements that will be accessible for end-users.';
  ...
  scxgwUIElementsPageHeaderHint =
    'This option determines whether column headers are displayed by the Grid View'
    + #13#10 +
  ...
  scxgwUIElementsPageColumnsQuickCustomization =
    'Quick Customization of Columns';
  ...
  scxgwUIElementsPageGroupFooterModeVisibleWhenExpanded =
    'Visible When Expanded';
  scxgwUIElementsPagePreview = 'Preview';
  scxgwUIElementsPagePreviewHint =
    'MS-Outlook style preview sections allow you to display a memo field’s content'
    + #13#10 +
    'or custom memo information for records in an elegant manner. Such sections are'
    + #13#10 +
  ...
  scxgwUIElementsPageNavigatorHint =
    'The navigator provides record navigation and management';
  ...
  scxgwUIElementsPageNewItemRowHint =
    'A new item row is labeled with the ‘Click here to add a new row’ description'
    + #13#10 +
    'and provides the capability to enter a new record into the dataset';
  scxgwUIElementsPageRecordCaption = 'Record Caption';
  scxgwUIElementsPageRecordCaptionHint =
    'Specifies the visibility of the card caption';
  scxgwUIElementsPageFilterButton = 'Filter Button Visibility';
  scxgwUIElementsPageFilterButtonHint =
    'Specifies whether to display filter dropdown buttons';
  ...
  scxgwUIElementsPageInplaceEditFormHint =
    'Enables record editing using an in-place Edit Form';
  scxgwUIElementsPageHideCurrentRow = 'Hide Current Row';
  scxgwUIElementsPageHideCurrentRowHint =
    'Hide the row being edited when the in-place Edit Form is active';
  ...
  scxgwInplaceEditFormPageMasterRowDblClickAction =
    'Master Row Double Click Action';
  ...
  scxgwInplaceEditFormPageUseDefaultLayoutHint =
    'Use auto-generated layout within the Edit Form or customize it';
  scxgwInplaceEditFormPageDefaultColumnCount = 'Column Count';
  scxgwInplaceEditFormPageDefaultColumnCountHint =
    'Form editors are arranged across the specified number of columns';

  // Table View Options Inplace Edit Form Layout Page
  scxgwInplaceEditFormLayoutPageDescription =
    'Customize the Edit Form’s layout.';
  scxgwInplaceEditFormLayoutPageTitle = 'In-place Edit Form Layout';

  // Table View Options Filtering Sorting Page
  scxgwFilteringSortingPageDescription =
    'Specify capabilities and elements for filtering and sorting.';
  ...
  scxgwFilteringSortingPageHeaderFilterButtonShowMode =
    'Filter Button Show Mode';
  ...
  scxgwFilteringSortingPageHeaderFilterButtonShowModeSmartTagHint =
    'The filter dropdown button is replaced with a small specially-designed' +
    #13#10 + 'image imitating a smart tag. The image is highlighted when the grid is'
    + #13#10 +
    'filtered by a column`s values to help end-users easily discern which' +
    #13#10 + 'columns have a filter applied.';
  ...
  scxgwFilteringSortingPageIncSearchHint =
    'Incremental search allows a user to locate records in a grid control' +
    #13#10 + 'by matching the initial characters of a record field';
  ...
  scxgwSummaryPageDescription =
    'Click the right mouse button on Footer or Group Footer to specify a summary for the required column.';
  scxgwSummaryPageTitle = 'Summary';
  scxgwSummaryPageNullIgnore = 'Ignore Null Values';
  scxgwSummaryPageNullIgnoreHint =
    'Determines whether NULL values are ignored when calculating summaries';
  ...
  scxgwLayoutViewCustomizeItemsPageDescription =
    'Specify the most appropriate layout for your items.';
  scxgwLayoutViewCustomizeItemsPageTitle = 'Customize Items';

  // Layout View Options View Page
  scxgwLayoutViewOptionsViewPageDescription =
    'Specify how cards are arranged and stretched in the View.';
  ...
  scxgwUIElementsCardViewRowLayoutHint = 'Specifies the card row layout';
  ...
  scxGridWizardChartViewOptionsViewSettingsPageDescription =
    'ChartViewOptionsViewSettingsPage description.';
