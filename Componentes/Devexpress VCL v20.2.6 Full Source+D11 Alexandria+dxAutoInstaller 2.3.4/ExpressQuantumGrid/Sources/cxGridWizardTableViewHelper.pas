...
uses
  SysUtils, Forms,
  dxCore, cxGraphics, dxCustomWizardControl, dxWizardControl, cxClasses,
...
type
  ...
  TcxGridWizardCustomTableViewHelper = class
  ...
  TcxGridWizardDBTableViewHelper = class(TcxGridWizardCustomTableViewHelper,
...
const
  cxGridWizardTableViewPages: array [0 .. 8]
  ...
  cxGridWizardDBTableViewPages: array [0 .. 10]
    of TcxGridWizardCustomPageFrameClass =
...
procedure TcxGridWizardCustomTableViewHelper.CorrectCustomizationFormContent
  (ACustomizationForm: TForm);
begin
  (ACustomizationForm as TcxGridTableCustomizationForm).ColumnsPage.Caption :=
    cxGetResourceString(@scxgwCustomizationFormColumnsTab);
end;
...
procedure TcxGridWizardCustomTableViewHelper.CheckComponentNames
...
function TcxGridWizardCustomTableViewHelper.GetItem(Index: Integer)
  : TcxGridColumn;
begin
...
class function TcxGridWizardTableViewHelper.GetGridViewClass
...
class function TcxGridWizardDBTableViewHelper.GetGridViewClass
  : TcxCustomGridViewClass;
begin
  Result := TcxGridDBTableView;
end;

function TcxGridWizardDBTableViewHelper.GetItemIndexByFieldName(const AFieldName
  : string): Integer;
var
...
procedure TcxGridWizardDBTableViewHelper.CheckComponentNames
  (AView: TcxCustomGridView);
var
...
function TcxGridWizardDBTableViewHelper.GetItemFieldName
...
procedure TcxGridWizardDBTableViewHelper.SetItemFieldName(Index: Integer;
  const AValue: string);
begin
...
function TcxGridWizardDBTableViewHelper.GetItem(Index: Integer)
  : TcxGridDBColumn;
begin
  Result := GridView.Columns[Index];
end;
