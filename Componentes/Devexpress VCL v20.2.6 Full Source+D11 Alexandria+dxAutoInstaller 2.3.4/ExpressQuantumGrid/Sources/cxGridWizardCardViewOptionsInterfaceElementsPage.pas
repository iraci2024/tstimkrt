...
uses
  ...
  dxLayoutControlAdapters, dxLayoutContainer, cxCheckBox, StdCtrls,
  cxRadioGroup, cxLabel, ExtCtrls, dxLayoutControl,
  cxGridWizardCustomPage, cxGridWizardStrs, cxGridCustomTableView,
  cxGridCardView, dxLayoutLookAndFeels,
  cxTextEdit, cxMaskEdit, cxDropDownEdit, cxCheckComboBox, cxNavigator;

type
  { TcxGridWizardCardViewOptionsInterfaceElementsPageFrame }

  TcxGridWizardCardViewOptionsInterfaceElementsPageFrame = class
...
procedure TcxGridWizardCardViewOptionsInterfaceElementsPageFrame.
  ApplyLocalization;
begin
  lbCardExpandButtonAlignment.Caption :=
    cxGetResourceString(@scxgwUIElementsCardViewExpandButtonAlignment);
  lbCardExpandButtonAlignment.Hint :=
    cxGetResourceString(@scxgwUIElementsCardViewExpandButtonAlignmentHint);

  rbAlignmentLeft.Caption := cxGetResourceString
    (@scxgwUIElementsCardViewExpandButtonAlignmentLeft);
  rbAlignmentLeft.Hint := cxGetResourceString
    (@scxgwUIElementsCardViewExpandButtonAlignmentLeftHint);

  rbAlignmentRight.Caption := cxGetResourceString
    (@scxgwUIElementsCardViewExpandButtonAlignmentRight);
  rbAlignmentRight.Hint := cxGetResourceString
    (@scxgwUIElementsCardViewExpandButtonAlignmentRightHint);

  lbOther.Caption := cxGetResourceString(@scxgwCommonGroupCaptionOthers);

  chbEmptyRows.Caption := cxGetResourceString
    (@scxgwUIElementsCardViewEmptyRows);
  chbEmptyRows.Hint := cxGetResourceString
  ...
  lbRowLayout.Hint := cxGetResourceString
    (@scxgwUIElementsCardViewRowLayoutHint);

  rbLayoutHorizontal.Caption := cxGetResourceString
    (@scxgwUIElementsCardViewRowLayoutHorizontal);
  rbLayoutHorizontal.Hint := cxGetResourceString
    (@scxgwUIElementsCardViewRowLayoutHorizontalHint);

  rbLayoutVertical.Caption := cxGetResourceString
    (@scxgwUIElementsCardViewRowLayoutVertical);
  rbLayoutVertical.Hint := cxGetResourceString
...
begin
  ...
  AView := TcxGridCardView(Helper.GridView);
  rbAlignmentLeft.Checked :=
    AView.OptionsView.CardExpandButtonAlignment = cebaLeft;
  rbAlignmentRight.Checked := AView.OptionsView.CardExpandButtonAlignment =
    cebaRight;
...
function TcxGridWizardCardViewOptionsInterfaceElementsPageFrame.
...
procedure TcxGridWizardCardViewOptionsInterfaceElementsPageFrame.
  chbNavigatorClick(Sender: TObject);
begin
  chcbNavigatorButtons.Enabled := chbNavigator.Checked;
end;
