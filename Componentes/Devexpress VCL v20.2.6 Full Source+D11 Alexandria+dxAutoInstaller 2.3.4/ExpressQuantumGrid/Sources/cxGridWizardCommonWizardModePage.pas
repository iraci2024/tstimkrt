...
uses
  ...
  cxGridCustomView, dxWizardControl,
  cxGridWizardCustomPage, cxGridWizardStrs, dxLayoutcxEditAdapters, cxLabel,
  cxImage,
...
begin
  rbSingleLevelStructure.Caption :=
    cxGetResourceString(@scxgwWizardModePageSingleLevelStructure);
  rbMultiLevelStructure.Caption :=
    cxGetResourceString(@scxgwWizardModePageMultiLevelStructure);
  chbDeletePresentStructure.Caption :=
    cxGetResourceString(@scxgwWizardModePageDeletePresentStructure);
end;
...
procedure TcxGridWizardCommonWizardModePageFrame.imMultiLevelStructureClick
  (Sender: TObject);
begin
  rbMultiLevelStructure.Checked := True;
end;

procedure TcxGridWizardCommonWizardModePageFrame.imSingleLevelStructureClick
  (Sender: TObject);
begin
