...
const
  SummaryNames: array [TcxSummaryKind] of TcxResourceStringID =
    (@cxSGridNoneMenuItem, @cxSGridSumMenuItem, @cxSGridMinMenuItem,
    @cxSGridMaxMenuItem, @cxSGridCountMenuItem, @cxSGridAvgMenuItem);
begin
  Result := SummaryNames[ASummaryKind];
end;

procedure AddcxGridPopupMenuResourceStringNames
...
dxResourceStringsRepository.RegisterProduct('cxGridPopupMenu',
  @AddcxGridPopupMenuResourceStringNames);
