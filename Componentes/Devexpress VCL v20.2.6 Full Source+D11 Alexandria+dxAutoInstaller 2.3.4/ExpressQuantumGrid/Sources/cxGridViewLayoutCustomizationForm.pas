...
uses
  ...
  ComCtrls, Forms, ImgList,
  ActnList, Dialogs, Menus,
  dxCore, cxGraphics, cxControls, cxLookAndFeels, cxCheckBox, cxButtons,
  cxTreeView,
  cxLookAndFeelPainters, cxContainer, cxEdit, dxLayoutPainters, dxLayoutCommon,
  dxLayoutCustomizeForm, dxLayoutControlAdapters, dxLayoutContainer,
...
type
  ...
  private
    function GetGridLayoutViewLayoutLookAndFeel
  ...
  protected
    ...
    property LayoutLookAndFeel
      : TcxGridViewLayoutCustomizationFormLayoutLookAndFeel
      read GetGridLayoutViewLayoutLookAndFeel;
  end;

  { TcxGridLayoutViewCustomizationFormGroupPainter }

  TcxGridViewLayoutCustomizationFormGroupPainter = class
  ...
  TcxGridViewLayoutCustomizationFormLayoutLookAndFeelClass = class of
    TcxGridViewLayoutCustomizationFormLayoutLookAndFeel;

  TcxGridViewLayoutCustomizationFormContainerViewInfo = class
  ...
  public
    function CloneItem(AItem: TdxCustomLayoutItem;
      AParent: TdxCustomLayoutGroup = nil): TdxCustomLayoutItem; override;
  ...
  public
    ...
    property Container: TcxGridViewLayoutCustomizationFormContainer
      read GetContainer;
  end;

  TcxGridViewLayoutCustomizationFormLayoutControlClass = class of
    TcxGridViewLayoutCustomizationFormLayoutControl;

  { TcxGridLayoutViewCustomizationForm }

  TcxGridViewLayoutCustomizationForm = class(TdxLayoutControlCustomizeForm,
    IcxGridCustomizationForm, IcxDialogMetricsInfoData)
  ...
  private
    ...
    procedure SetContainer(const Value
      : TcxGridViewLayoutCustomizationFormContainer);
  protected
    ...
    function GetGridViewContainerInstance: TdxLayoutContainer; virtual;
      abstract;
    function GetGridViewLayoutControlClass
      : TcxGridViewLayoutCustomizationFormLayoutControlClass; virtual;
    function GetGridViewLayoutLookAndFeel: TdxLayoutCxLookAndFeel;
      virtual; abstract;
    function GetLayoutLookAndFeelClass
      : TcxGridViewLayoutCustomizationFormLayoutLookAndFeelClass; virtual;
  ...
  public
    ...
    property GridViewLayoutControl
      : TcxGridViewLayoutCustomizationFormLayoutControl
      read FGridViewLayoutControl;
...
function TcxGridViewLayoutCustomizationFormRootViewInfo.CalculateOffset
...
function TcxGridViewLayoutCustomizationFormRootViewInfo.
  GetGridLayoutViewLayoutLookAndFeel
  : TcxGridViewLayoutCustomizationFormLayoutLookAndFeel;
begin
  Result := TcxGridViewLayoutCustomizationFormLayoutLookAndFeel
    (inherited LayoutLookAndFeel);
end;

function TcxGridViewLayoutCustomizationFormRootViewInfo.GetRootOffset: Integer;
begin
  Result := LayoutLookAndFeel.DLUToPixels
    (LayoutLookAndFeel.GetGroupCaptionFont(Group.Container), 7);
end;

function TcxGridViewLayoutCustomizationFormRootViewInfo.
  GetSelectionBoundsOffset: Integer;
begin
...
begin
  Result := inherited CanDrawBorders or TdxCustomLayoutItemViewInfoAccess
    (ViewInfo).Item.IsRoot;
end;

function TcxGridViewLayoutCustomizationFormGroupPainter.CanDrawCaption: Boolean;
begin
  Result := inherited CanDrawCaption or TdxCustomLayoutItemViewInfoAccess
    (ViewInfo).Item.IsRoot;
end;

function TcxGridViewLayoutCustomizationFormContainerViewInfo.
  GetRootViewInfoClass: TdxLayoutRootViewInfoClass;
begin
...
function TcxGridViewLayoutCustomizationFormLayoutLookAndFeel.
  GetGroupPainterClass: TClass;
begin
...
function TcxGridViewLayoutCustomizationFormContainer.CloneItem
  (AItem: TdxCustomLayoutItem; AParent: TdxCustomLayoutGroup = nil)
  : TdxCustomLayoutItem;
begin
...
function TcxGridViewLayoutCustomizationFormContainer.
  CalculateCustomizeFormBounds(const AFormBounds: TRect): TRect;
begin
  Result := AFormBounds;
end;
...
function TcxGridViewLayoutCustomizationFormContainer.GetViewInfoClass
  : TdxLayoutContainerViewInfoClass;
begin
  Result := TcxGridViewLayoutCustomizationFormContainerViewInfo;
end;

function TcxGridViewLayoutCustomizationFormContainer.GetCloneItemClass
  : TcxGridCustomLayoutItemClass;
begin
  Result := TcxGridCustomLayoutItem;
end;

function TcxGridViewLayoutCustomizationFormContainer.GetCustomizeForm
...
function TcxGridViewLayoutCustomizationFormContainer.GetCustomizationHelperClass
  : TdxLayoutContainerCustomizationHelperClass;
begin
  Result := TcxGridLayoutContainerCustomizationHelper;
end;

function TcxGridViewLayoutCustomizationFormContainer.GetCustomizationHelper
...
constructor TcxGridViewLayoutCustomizationFormLayoutControl.Create
  (AOwner: TComponent);
begin
...
function TcxGridViewLayoutCustomizationFormLayoutControl.GetContainerClass
  : TdxLayoutControlContainerClass;
begin
  Result := TcxGridViewLayoutCustomizationFormContainer;
end;

function TcxGridViewLayoutCustomizationFormLayoutControl.GetContainer
  : TcxGridViewLayoutCustomizationFormContainer;
begin
...
function TcxGridViewLayoutCustomizationForm.GetHitTest(const P: TPoint)
...
procedure TcxGridViewLayoutCustomizationForm.Initialize
...
procedure TcxGridViewLayoutCustomizationForm.SetContainer
  (const Value: TcxGridViewLayoutCustomizationFormContainer);
begin
...
function TcxGridViewLayoutCustomizationForm.GetController
...
procedure TcxGridViewLayoutCustomizationForm.
...
begin
  ...
  if Container <> nil then
    Container.Root.Caption := cxGetResourceString
      (@scxGridLayoutViewCustomizeFormTemplateCard);
end;

function TcxGridViewLayoutCustomizationForm.GetGridViewContainer
  : TdxLayoutContainer;
begin
  Result := GetGridViewContainerInstance;
end;

function TcxGridViewLayoutCustomizationForm.GetGridViewLayoutControlClass
  : TcxGridViewLayoutCustomizationFormLayoutControlClass;
begin
  Result := TcxGridViewLayoutCustomizationFormLayoutControl;
end;

function TcxGridViewLayoutCustomizationForm.GetLayoutLookAndFeelClass
  : TcxGridViewLayoutCustomizationFormLayoutLookAndFeelClass;
begin
  Result := TcxGridViewLayoutCustomizationFormLayoutLookAndFeel;
end;
...
begin
  ...
  else if (GridView <> nil) and (GridView.Control <> nil) then
...
begin
  ...
  FGridViewLayoutControl.MenuItems := TdxLayoutContainerAccess
    (GridViewContainer).MenuItems;

  FGridViewLayoutControl.OptionsItem.SizableHorz :=
    TdxLayoutContainerAccess(GridViewContainer).IsSizableHorz;
  FGridViewLayoutControl.OptionsItem.SizableVert :=
    TdxLayoutContainerAccess(GridViewContainer).IsSizableVert;
...
begin
  inherited Localize;
  acCancel.Caption := cxGetResourceString
    (@scxGridLayoutViewCustomizeFormCancel);
  acCancel.Hint := StripHotKey(acCancel.Caption);
...
function TcxGridViewLayoutCustomizationForm.GetContainer
  : TcxGridViewLayoutCustomizationFormContainer;
begin
  Result := TcxGridViewLayoutCustomizationFormContainer(inherited Container);
end;

function TcxGridViewLayoutCustomizationForm.GetViewSupport
...
procedure TcxGridViewLayoutCustomizationForm.acCancelExecute(Sender: TObject);
begin
  Close;
end;
...
var
  AChoice: Integer;
begin
  if (ModalResult = mrCancel) and FGridViewLayoutControl.UndoRedoManager.CanUndo
  then
  begin
    AChoice := MessageBox(Handle,
      PChar(cxGetResourceString(@scxGridLayoutViewCustomizeWarningDialogMessage)
      ), PChar(cxGetResourceString
      (@scxGridLayoutViewCustomizeWarningDialogCaption)), MB_ICONWARNING or
      MB_YESNOCANCEL);
