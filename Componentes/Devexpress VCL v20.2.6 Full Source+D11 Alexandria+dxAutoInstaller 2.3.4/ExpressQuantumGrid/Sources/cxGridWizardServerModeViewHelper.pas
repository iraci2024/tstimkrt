...
uses
  ...
  dxCore, cxClasses, cxGraphics, dxCustomWizardControl, dxWizardControl,
  cxGridWizardStrs, cxGridCustomView,
  cxGridServerModeTableView, cxGridServerModeBandedTableView, cxGridLevel,
  cxGridWizardCustomHelper, dxServerModeData,
  cxGridServerModeDataDefinitions, cxGridWizardTableViewHelper,
...
type
  ...
  TcxGridWizardServerModeTableViewHelper = class
    (TcxGridWizardCustomTableViewHelper, IcxGridWizardServerModeViewHelper,
  ...
  TcxGridWizardServerModeBandedTableViewHelper = class
    (TcxGridWizardServerModeTableViewHelper, IcxGridWizardBandedTableView)
  private
...
uses
  cxGridWizardCustomPage, cxGridWizardCommonCustomizeItemsPage,
  cxGridWizardTableViewOptionsInterfaceElementsPage,
  cxGridWizardTableViewOptionsSummaryPage,
  cxGridWizardTableViewOptionsFilteringSortingPage,
  cxGridWizardTableViewOptionsBehaviorPage,
  cxGridWizardTableViewOptionsSizingPage,
  cxGridWizardBandedTableViewOptionsBandsPage,
  cxGridWizardServerModeViewsDataSourcePage,
  cxGridWizardDBViewsSelectItemsForDisplayPage;

const
  cxGridWizardServerModeTableViewPages: array [0 .. 7]
    of TcxGridWizardCustomPageFrameClass =
  ...
  cxGridWizardServerModeBandedTableViewPages: array [0 .. 8]
    of TcxGridWizardCustomPageFrameClass =
    (TcxGridWizardServerModeViewsDataSourcePageFrame,
...
procedure TcxGridWizardServerModeTableViewHelper.DeleteItem
  (const AFieldName: string);
begin
  GridView.GetColumnByFieldName(AFieldName).Free;
end;

class function TcxGridWizardServerModeTableViewHelper.GetGridViewClass
  : TcxCustomGridViewClass;
begin
  Result := TcxGridServerModeTableView;
end;

function TcxGridWizardServerModeTableViewHelper.GetItemIndexByFieldName
...
procedure TcxGridWizardServerModeTableViewHelper.PreparePreview
...
procedure TcxGridWizardServerModeTableViewHelper.AssignDataSource
  (AGridView: TcxCustomGridView);
begin
  TcxGridServerModeTableView(AGridView).DataController.DataSource :=
    FDataSource;
end;
...
function TcxGridWizardServerModeTableViewHelper.GetItemCaption
...
function TcxGridWizardServerModeTableViewHelper.GetItemFieldName
  (Index: Integer): string;
begin
...
function TcxGridWizardServerModeTableViewHelper.GetPageClasses
  (Index: Integer): TClass;
begin
  Result := cxGridWizardServerModeTableViewPages[Index];
end;

procedure TcxGridWizardServerModeTableViewHelper.SetItemFieldName
  (Index: Integer; const AValue: string);
begin
  Items[Index].DataBinding.FieldName := AValue;
end;

function TcxGridWizardServerModeTableViewHelper.GetDataController
  : TcxGridServerModeDataController;
begin
  Result := GridView.DataController;
end;

function TcxGridWizardServerModeTableViewHelper.GetSelectedDataSource
  : TdxServerModeCustomDataSource;
begin
  Result := FDataSource;
end;

procedure TcxGridWizardServerModeTableViewHelper.SelectDataSource
...
procedure TcxGridWizardServerModeTableViewHelper.SaveGridViewData
...
function TcxGridWizardServerModeTableViewHelper.GetGridView
  : TcxGridServerModeTableView;
begin
  Result := TcxGridServerModeTableView(inherited GridView);
end;

function TcxGridWizardServerModeTableViewHelper.GetItem(Index: Integer)
...
procedure TcxGridWizardServerModeBandedTableViewHelper.
  CorrectCustomizationFormContent(ACustomizationForm: TForm);
var
  AForm: TcxGridBandedTableCustomizationForm;
begin
  AForm := ACustomizationForm as TcxGridBandedTableCustomizationForm;
  AForm.BandsPage.Caption := cxGetResourceString
    (@scxgwCustomizationFormBandsTab);
  AForm.ColumnsPage.Caption := cxGetResourceString
    (@scxgwCustomizationFormColumnsTab);
end;

class function TcxGridWizardServerModeBandedTableViewHelper.GetGridViewClass
  : TcxCustomGridViewClass;
begin
  Result := TcxGridServerModeBandedTableView;
end;

function TcxGridWizardServerModeBandedTableViewHelper.GetPageClassCount
  : Integer;
begin
  Result := Length(cxGridWizardServerModeBandedTableViewPages);
end;

function TcxGridWizardServerModeBandedTableViewHelper.GetPageClasses
  (Index: Integer): TClass;
begin
...
function TcxGridWizardServerModeBandedTableViewHelper.
  GetBandsQuickCustomization: Boolean;
begin
  Result := GridView.OptionsCustomize.BandsQuickCustomization;
end;

procedure TcxGridWizardServerModeBandedTableViewHelper.AssignDataSource
  (AGridView: TcxCustomGridView);
begin
  TcxGridServerModeBandedTableView(AGridView).DataController.DataSource :=
    FDataSource;
end;

function TcxGridWizardServerModeBandedTableViewHelper.GetDataController
  : TcxGridServerModeDataController;
begin
  Result := GridView.DataController;
end;
...
function TcxGridWizardServerModeBandedTableViewHelper.
  GetDefaultBandCaption: string;
begin
  Result := GridView.Bands.ItemClass.ClassName;
end;

procedure TcxGridWizardServerModeBandedTableViewHelper.
  SetBandsQuickCustomization(const AValue: Boolean);
begin
  GridView.OptionsCustomize.BandsQuickCustomization := AValue;
end;

function TcxGridWizardServerModeBandedTableViewHelper.GetGridView
...
cxGridWizardHelperInfoList.Add(TcxGridWizardServerModeBandedTableViewHelper,
  HInstance);
cxGridWizardHelperInfoList.Add(TcxGridWizardServerModeTableViewHelper,
  HInstance);
