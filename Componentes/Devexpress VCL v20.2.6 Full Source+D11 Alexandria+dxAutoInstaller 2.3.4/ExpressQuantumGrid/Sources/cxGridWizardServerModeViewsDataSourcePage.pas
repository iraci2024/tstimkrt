...
uses
  ...
  cxGridCustomView, dxBevel, cxGroupBox, dxLayoutLookAndFeels, cxLabel,
  dxLayoutControlAdapters,
  cxButtons, dxServerModeData, cxGridServerModeDataDefinitions, cxRadioGroup,
  cxCheckComboBox,
...
type
  ...
  TcxGridWizardServerModeViewsDataSourcePageFrame = class
  ...
  protected
    ...
    property ServerModeHelper: IcxGridWizardServerModeViewHelper
      read GetServerModeHelper;
  public
...
function CheckDataSourceConnection(ADataSource
  : TdxServerModeCustomDataSource): Boolean;
begin
...
begin
  ...
  btnTestConnection.Caption := cxGetResourceString
...
begin
  ...
  cbDataSource.ItemIndex :=
    Max(0, cbDataSource.Properties.Items.IndexOfObject(DataSource));
  UpdateControlStates;
end;

function TcxGridWizardServerModeViewsDataSourcePageFrame.
...
begin
  Helper.PopulateComponents(TdxServerModeCustomDataSource,
    @CheckDataSourceConnection, cbDataSource.Properties.Items);
...
function TcxGridWizardServerModeViewsDataSourcePageFrame.GetDataSource
  : TdxServerModeCustomDataSource;
begin
  Result := ServerModeHelper.GetSelectedDataSource;
end;

function TcxGridWizardServerModeViewsDataSourcePageFrame.GetServerModeHelper
...
procedure TcxGridWizardServerModeViewsDataSourcePageFrame.btnTestConnectionClick
  (Sender: TObject);
begin
...
procedure TcxGridWizardServerModeViewsDataSourcePageFrame.
  cbDataSourcePropertiesChange(Sender: TObject);
begin
  ServerModeHelper.SelectDataSource
    (TdxServerModeCustomDataSource(cbDataSource.ItemObject));
  UpdateControlStates;
end;
