...
uses
  ...
  dxLayoutControlAdapters, dxLayoutContainer, cxCheckBox, ExtCtrls,
  dxLayoutControl, cxGridWizardCustomPage,
  cxGridWizardStrs, cxGridLayoutView, dxLayoutLookAndFeels, cxLabel,
  cxGridCustomLayoutView;

type
  { TcxGridWizardLayoutViewOptionsBehaviorPageFrame }

  TcxGridWizardLayoutViewOptionsBehaviorPageFrame = class
...
begin
  lbExpandingOptions.Caption := cxGetResourceString
    (@scxgwBehaviorPageExpandingOptions);
  lbFocusingOptions.Caption := cxGetResourceString
    (@scxgwBehaviorPageFocusingOptions);
  lbOther.Caption := cxGetResourceString(@scxgwCommonGroupCaptionOthers);
  lbSelectionOptions.Caption := cxGetResourceString
    (@scxgwBehaviorPageSelectionOptions);

  chbFocusCellOnTab.Caption := cxGetResourceString
    (@scxgwBehaviorPageFocusCellOnTab);
  chbFocusCellOnTab.Hint := cxGetResourceString
    (@scxgwBehaviorPageFocusCellOnTabHint);

  chbGoToNextCellOnEnter.Caption :=
    cxGetResourceString(@scxgwBehaviorPageGoToNextCellOnEnter);
  chbGoToNextCellOnEnter.Hint := cxGetResourceString
  ...
  chbRecordExpanding.Caption := cxGetResourceString
    (@scxgwBehaviorPageRecordExpanding);
  chbRecordExpanding.Hint := cxGetResourceString
    (@scxgwBehaviorPageRecordExpandingHint);

  chbGroupExpanding.Caption := cxGetResourceString
    (@scxgwBehaviorPageGroupExpanding);
  chbGroupExpanding.Hint := cxGetResourceString
    (@scxgwBehaviorPageGroupExpandingHint);

  chbExpandRecordOnDblClick.Caption :=
    cxGetResourceString(@scxgwBehaviorPageExpandRecordOnDblClick);
  chbExpandRecordOnDblClick.Hint :=
    cxGetResourceString(@scxgwBehaviorPageExpandRecordOnDblClickHint);

  chbFocusFirstCellOnNewRecord.Caption :=
    cxGetResourceString(@scxgwBehaviorPageFocusFirstCellOnNewRecord);
  chbFocusFirstCellOnNewRecord.Hint :=
    cxGetResourceString(@scxgwBehaviorPageFocusFirstCellOnNewRecordHint);

  chbItemHotTrack.Caption := cxGetResourceString
    (@scxgwBehaviorPageItemHotTrack);
  chbItemHotTrack.Hint := cxGetResourceString
    (@scxgwBehaviorPageItemHotTrackHint);

  chbMultiSelect.Caption := cxGetResourceString
    (@scxgwBehaviorPageRecordMultiSelect);
  chbMultiSelect.Hint := cxGetResourceString
    (@scxgwBehaviorPageRecordMultiSelectHint);

  chbIncSearch.Caption := cxGetResourceString
    (@scxgwFilteringSortingPageIncSearch);
  chbIncSearch.Hint := cxGetResourceString
  ...
  chbHideSelection.Caption := cxGetResourceString
    (@scxgwBehaviorPageHideSelection);
  chbHideSelection.Hint := cxGetResourceString
...
begin
  ...
  AView.OptionsBehavior.ExpandRecordOnDblClick :=
    chbExpandRecordOnDblClick.Checked;
  AView.OptionsBehavior.FocusCellOnTab := chbFocusCellOnTab.Checked;
  AView.OptionsBehavior.FocusFirstCellOnNewRecord :=
    chbFocusFirstCellOnNewRecord.Checked;
...
function TcxGridWizardLayoutViewOptionsBehaviorPageFrame.
...
procedure TcxGridWizardLayoutViewOptionsBehaviorPageFrame.RefreshPreviewGrid
  (Sender: TObject);
begin
