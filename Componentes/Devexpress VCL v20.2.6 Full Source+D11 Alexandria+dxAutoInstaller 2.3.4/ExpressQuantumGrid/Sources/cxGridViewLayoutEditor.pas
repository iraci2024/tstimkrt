...
uses
  ...
  ExtCtrls, StdCtrls, cxStyles, cxGridLevel,
  cxControls, cxGrid, cxGridCustomView, cxGridCustomPopupMenu, cxGridPopupMenu,
  Menus, cxLookAndFeelPainters,
  cxContainer, cxEdit, cxCheckBox, cxButtons, cxGraphics, cxLookAndFeels,
  dxLayoutControlAdapters,
  dxLayoutcxEditAdapters, dxLayoutContainer, dxLayoutLookAndFeels,
  dxLayoutControl, cxClasses, dxForms;
...
function TcxGridViewLayoutEditor.GetDataControllerSupport
...
begin
  ...
  (FView.DataController as IcxCustomGridDataController)
    .AssignData(FOriginalView.DataController);
...
begin
  ...
  btnLayoutCustomization.Caption :=
    ViewSupport.GetLayoutCustomizationFormButtonCaption;
  liSaveLayout.Visible := ViewSupport.IsLayoutChangeable;
  liSaveData.Visible := DataControllerSupport.IsDataChangeable;
  liOK.Visible := ViewSupport.IsLayoutChangeable or
    DataControllerSupport.IsDataChangeable;
  liConditionalFormatting.Visible :=
    Supports(FView, IcxDataControllerConditionalFormattingProviderOwner, AIntf)
    and (AIntf.GetConditionalFormattingProvider <> nil) and
    AIntf.GetConditionalFormattingProvider.ConditionalFormatting.
