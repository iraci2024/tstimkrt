...
type
  ...
  protected
    ...
    procedure DoShowBands(const AParameter
...
procedure TcxGridBandedTableViewOperationHelper.DoShowBands(const AParameter
  : TcxCustomGridOperationHelperParameters);
begin
  If AParameter.IsPerform then
    (AParameter.View as TcxGridBandedTableView).OptionsView.BandHeaders :=
      GetShowProperty(AParameter)
  else
    SetShowProperty(AParameter, (AParameter.View as TcxGridBandedTableView)
      .OptionsView.BandHeaders);
end;

class function TcxGridBandedTableViewOperationHelper.GetViewClass
