...
type
  ...
  TcxCustomTableViewStyleSheetEditorPreview = class
    (TcxCustomViewStyleSheetEditorPreview)
  protected
  ...
  TcxTableViewStyleSheetEditorPreview = class
    (TcxCustomTableViewStyleSheetEditorPreview)
  private
  ...
  TcxBandedTableViewStyleSheetEditorPreview = class
    (TcxCustomTableViewStyleSheetEditorPreview)
  private
  ...
  TcxCardViewStyleSheetEditorPreview = class
    (TcxCustomViewStyleSheetEditorPreview)
  protected
  ...
  TcxLayoutViewStyleSheetEditorPreview = class
    (TcxCustomViewStyleSheetEditorPreview)
  protected
...
begin
  ...
  TableView.DataController.Summary.FooterSummaryItems.Items[0].ItemLink :=
    TableView.Columns[1];
end;
...
class function TcxTableViewStyleSheetEditorPreview.GetStyleSheetClass
  : TcxCustomStyleSheetClass;
begin
  Result := TcxGridTableViewStyleSheet;
end;

procedure TcxTableViewStyleSheetEditorPreview.SetStyleSheet
...
constructor TcxBandedTableViewStyleSheetEditorPreview.Create
  (AOwner: TComponent);
var
  I: Integer;
begin
  inherited Create(AOwner);
  FBandedTableView := TcxGridBandedTableView
    (FGrid.CreateView(TcxGridBandedTableView));
...
class function TcxBandedTableViewStyleSheetEditorPreview.GetStyleSheetClass
  : TcxCustomStyleSheetClass;
begin
  Result := TcxGridBandedTableViewStyleSheet;
end;

procedure TcxBandedTableViewStyleSheetEditorPreview.SetStyleSheet
  (AStyleSheet: TcxCustomStyleSheet);
begin
...
class function TcxCardViewStyleSheetEditorPreview.GetStyleSheetClass
  : TcxCustomStyleSheetClass;
begin
...
procedure TcxCardViewStyleSheetEditorPreview.SetStyleSheet
  (AStyleSheet: TcxCustomStyleSheet);
begin
...
class function TcxLayoutViewStyleSheetEditorPreview.GetStyleSheetClass
  : TcxCustomStyleSheetClass;
begin
