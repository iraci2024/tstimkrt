...
type
  ...
  published
    property LayoutDirection: TcxGridCardViewLayoutDirection
      read GetLayoutDirection write SetLayoutDirection;
...
function TcxGridCardViewStorage.GetLayoutDirection
  : TcxGridCardViewLayoutDirection;
begin
  Result := CardView.LayoutDirection;
end;

function TcxGridCardViewStorage.GetOptionsBehavior
...
function TcxGridCardViewStorage.GetOptionsSelection
...
procedure TcxGridCardViewStorage.SetLayoutDirection
