...
uses
  cxGridWizardCustomHelper, cxGridCustomView, cxGridCardView, cxGridDBCardView,
  cxGridLevel, SysUtils, cxGraphics,
  dxCustomWizardControl, dxWizardControl, cxGridDBDataDefinitions, cxDBData,
  Forms, cxEdit, ExtCtrls, cxPC, Controls,
...
type
  ...
  TcxGridWizardCustomCardViewHelper = class
  ...
  protected
    ...
    property TreeViewFrame: TcxGridWizardCardStructureEditorFrame
      read FTreeViewFrame;
  ...
  TcxGridWizardDBCardViewHelper = class(TcxGridWizardCustomCardViewHelper,
  ...
  TcxGridCardViewCustomizationFormAccess = class
    (TcxGridCardViewCustomizationForm);

implementation

uses
  cxClasses, cxGridWizardCustomPage, cxGridWizardDBViewsDataSourcePage,
  ...
  cxGridWizardCardViewOptionsInterfaceElementsPage,
  cxGridWizardCommonOptionsFilteringSortingPage,
  cxGridWizardCardViewOptionsBehaviorPage,
  cxGridWizardCardViewOptionsSizingPage,
  cxGridWizardUnboundViewsSelectItemsForDisplayPage, cxGridCommon, dxCore,
  cxGridWizardStrs, cxGrid;

const
  cxGridWizardCardViewPages: array [0 .. 5]
  ...
  cxGridWizardDBCardViewPages: array [0 .. 7]
    of TcxGridWizardCustomPageFrameClass =
...
procedure TcxGridWizardCustomCardViewHelper.CorrectCustomizationFormContent
...
begin
  ...
  ACustomizationFormAccess.ItemsPage.Caption :=
    cxGetResourceString(@scxgwCustomizationFormRowsTab);

  ATreeViewPage := ACustomizationFormAccess.CreatePage
    (cxGetResourceString(@scxgwCustomizationFormCardTreeViewTab), True);
  ...
  TreeViewFrame.LoadSettings
    (TcxCustomGrid(ACustomizationFormAccess.Controller.GridView.Control));
end;
...
procedure TcxGridWizardCustomCardViewHelper.CheckComponentNames
...
function TcxGridWizardCustomCardViewHelper.GetItem(Index: Integer)
  : TcxGridCardViewRow;
begin
...
class function TcxGridWizardCardViewHelper.GetGridViewClass
...
function TcxGridWizardDBCardViewHelper.GetItemIndexByFieldName(const AFieldName
  : string): Integer;
var
...
class function TcxGridWizardDBCardViewHelper.GetGridViewClass
  : TcxCustomGridViewClass;
begin
  Result := TcxGridDBCardView;
end;

function TcxGridWizardDBCardViewHelper.GetItem(Index: Integer)
...
procedure TcxGridWizardDBCardViewHelper.SetItemFieldName(Index: Integer;
  const AValue: string);
begin
