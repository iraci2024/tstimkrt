...
type
  ...
  TcxLayoutLayoutViewLookAndFeelItemOptions = class
  ...
  TcxGridCustomLayoutItemCaptionPainter = class
  ...
  TcxGridCustomLayoutItemCaptionViewInfo = class
  ...
  public
    property ControlViewInfo: TcxGridCustomLayoutItemEditViewInfo
      read GetControlViewInfo;
    property GridItemViewInfo: TcxGridTableDataCellViewInfo
  ...
  protected
    ...
    property GridItemCaption: string read FGridItemCaption
      write FGridItemCaption;
  public
    property Item: TcxGridCustomLayoutItem read GetItem;
  end;
  ...
  private
    ...
    procedure SetCaptionOptions
      (Value: TcxGridCustomLayoutItemCaptionOptions); inline;
  ...
  public
    ...
    property CaptionOptions: TcxGridCustomLayoutItemCaptionOptions
  ...
  protected
    ...
    function GetLayoutItemViewInfoInstance: TcxGridCustomLayoutItemViewInfo;
      virtual; abstract;
    ...
    property LayoutItemViewInfo: TcxGridCustomLayoutItemViewInfo
  ...
  TcxGridLayoutCustomizationController = class
  ...
  protected
    ...
    function GetFormBounds: TRect; override;
  ...
  private
    ...
    procedure PopulateItem(AItem: TdxCustomLayoutItemViewInfo; AList: TList);
  protected
    function CanDrawRoot: Boolean; virtual;
    function CanPopulateItem(AValue: TdxCustomLayoutItemViewInfo)
      : Boolean; virtual;
    ...
    procedure DoPopulateTabOrderList(AItem: TdxCustomLayoutItemViewInfo;
      AList: TList); virtual;
    function IsItemGroup(AValue: TdxCustomLayoutItemViewInfo): Boolean; virtual;
  public
    function GetGridItemViewInfo(AViewInfo: TcxGridCustomLayoutItemViewInfo)
  ...
  protected
    ...
    function FindGridItemViewInfo(AViewInfo: TcxGridCustomLayoutItemViewInfo)
      : TcxGridTableDataCellViewInfo; virtual; abstract;
    function GetLayoutItem(AViewInfo: TcxGridCustomLayoutItemViewInfo)
      : TdxLayoutControlItem; virtual;
    function GetItemOptions(AViewInfo: TdxCustomLayoutItemViewInfo)
      : TdxCustomLayoutLookAndFeelOptions; override;
    function GetItemLayoutLookAndFeel(AViewInfo: TdxCustomLayoutItemViewInfo)
      : TdxCustomLayoutLookAndFeel; override;
  ...
  public
    constructor Create(AContainer: TdxLayoutContainer;
      ARecordViewInfo: TcxCustomGridRecordViewInfo); reintroduce; virtual;
  ...
  TcxGridLayoutContainerAssignLayoutMode = (almNone, almToParent,
    almFromParent);

  TcxGridLayoutContainerCustomizationHelper = class
  ...
  protected
    property AssignLayoutMode: TcxGridLayoutContainerAssignLayoutMode
      read FAssignLayoutMode;
  ...
  protected
    ...
    function GetCustomizationHelperClass
      : TdxLayoutContainerCustomizationHelperClass; override;
    ...
    property CustomizationHelper: TcxGridLayoutContainerCustomizationHelper
      read GetCustomizationHelper;
    property GridView: TcxCustomGridTableView read GetGridView;
  end;
...
function TcxLayoutLayoutViewLookAndFeelItemOptions.GetPaddingClass
...
function TcxGridCustomLayoutLookAndFeel.GetItemOptionsClass
...
begin
  ...
  try
    ...
    try
      AEditViewInfo := AProperties.GetViewInfoClass.Create as
      ...
      try
        ...
        try
          AEditViewData.Calculate(ACanvas, AEditDrawBounds, cxNullPoint,
            cxmbNone, [], AEditViewInfo, False);
          ...
          cxAlphaBlend(AOpaqueBitmap.Canvas.Handle, AAlphaBitmap,
            AOpaqueBitmap.ClientRect, AAlphaBitmap.ClientRect);
          cxBitBlt(ACanvas.Handle, AOpaqueBitmap.Canvas.Handle, ViewInfo.Bounds,
            cxSimplePoint, SRCCOPY);
        finally
          AAlphaBitmap.Free;
          AOpaqueBitmap.Free;
        end;
...
function TcxGridCustomLayoutItemEditPainter.GetGridViewItem
...
begin
  Result := TcxCustomGridTableItemAccess(GetGridViewItem)
    .GetCellStyle.LookAndFeel;
end;

function TcxGridCustomLayoutItemEditPainter.GetViewInfo
  : TcxGridCustomLayoutItemEditViewInfo;
begin
...
function TcxGridCustomLayoutItemPainter.GetCaptionPainterClass
  : TdxCustomLayoutItemCaptionPainterClass;
begin
  Result := TcxGridCustomLayoutItemCaptionPainter;
end;

function TcxGridCustomLayoutItemPainter.GetControlPainterClass
  : TdxLayoutControlItemControlPainterClass;
begin
  Result := TcxGridCustomLayoutItemEditPainter;
end;

function TcxGridCustomLayoutItemPainter.GetViewInfo
  : TcxGridCustomLayoutItemViewInfo;
begin
...
function TcxGridCustomLayoutItemCaptionViewInfo.GetItemViewInfo
  : TcxGridCustomLayoutItemViewInfo;
begin
...
procedure TcxGridCustomLayoutItemEditViewInfo.CalculateInternalTabOrder
...
function TcxGridCustomLayoutItemEditViewInfo.GetDataViewInfo
...
function TcxGridCustomLayoutItemEditViewInfo.GetItemViewInfo
  : TcxGridCustomLayoutItemViewInfo;
begin
  Result := TcxGridCustomLayoutItemViewInfo(inherited ItemViewInfo);
end;

function TcxGridCustomLayoutItemEditViewInfo.GetGridView
...
function TcxGridCustomLayoutItemViewInfo.GetCaptionViewInfoClass
  : TdxCustomLayoutItemCaptionViewInfoClass;
begin
  Result := TcxGridCustomLayoutItemCaptionViewInfo;
end;

function TcxGridCustomLayoutItemViewInfo.GetControlViewInfoClass
  : TdxLayoutControlItemControlViewInfoClass;
begin
  Result := TcxGridCustomLayoutItemEditViewInfo;
end;

function TcxGridCustomLayoutItemViewInfo.GetCurrentGridItemViewInfo
  : TcxGridTableDataCellViewInfo;
begin
  Result := nil;
end;

function TcxGridCustomLayoutItemViewInfo.GetPainterClass
  : TdxCustomLayoutItemPainterClass;
begin
  Result := TcxGridCustomLayoutItemPainter;
end;

function TcxGridCustomLayoutItemViewInfo.GetControlViewInfo
  : TcxGridCustomLayoutItemEditViewInfo;
begin
  Result := TcxGridCustomLayoutItemEditViewInfo(inherited ControlViewInfo);
end;

function TcxGridCustomLayoutItemViewInfo.GetGridItemViewInfo
  : TcxGridTableDataCellViewInfo;
begin
...
begin
  ...
  begin
    ...
    case (TdxLayoutContainerAccess(Container)
      .CustomizationHelper as TcxGridLayoutContainerCustomizationHelper)
      .AssignLayoutMode of
      almFromParent:
...
function TcxGridCustomLayoutItem.GetStoredProperties
...
procedure TcxGridCustomLayoutItem.GetStoredPropertyValue(const AName: string;
  var AValue: Variant);
begin
...
procedure TcxGridCustomLayoutItem.SetStoredPropertyValue(const AName: string;
...
class function TcxGridCustomLayoutItem.GetCaptionOptionsClass
...
function TcxGridCustomLayoutItem.GetViewInfoClass
...
procedure TcxGridCustomLayoutItem.SetInplaceRenameCaption
...
function TcxGridCustomLayoutItem.CaptionToDisplayCaption
  (AValue: string): string;
begin
  Result := AValue;
end;

function TcxGridCustomLayoutItem.DisplayCaptionToCaption
  (AValue: string): string;
begin
  Result := AValue;
end;

function TcxGridCustomLayoutItem.GetCaptionOptions
  : TcxGridCustomLayoutItemCaptionOptions;
begin
...
procedure TcxGridCustomLayoutItem.SetCaptionOptions
  (Value: TcxGridCustomLayoutItemCaptionOptions);
begin
  inherited CaptionOptions := Value;
end;

procedure TcxGridCustomLayoutItem.SetGridViewItem(const AValue
  : TcxCustomGridTableItem);
begin
...
begin
  ...
  begin
    ...
    if AState <> cxbsNormal then
      ViewInfo.LookAndFeelPainter.LayoutViewDrawItem(Canvas,
        ViewInfo.Bounds, AState);
  end;
end;
...
begin
  ...
  begin
    ABounds := cxRectInflate(ViewInfo.EditViewInfo.Bounds,
      cxGridLayoutItemCellBorderWidth);
...
begin
  with TdxCustomLayoutItemCaptionPainter.Create
    (ViewInfo.LayoutItemViewInfo.CaptionViewInfo) do
    try
      Paint(Canvas);
    finally
      Free;
...
function TcxGridViewLayoutItemDataCellPainter.GetViewInfo
  : TcxGridViewLayoutItemDataCellViewInfo;
begin
...
function TcxGridViewLayoutItemDataCellViewInfo.GetPainterClass
...
begin
  ...
  begin
    if State = gcsPressed then
      Result := cxbsPressed
    else if (State = gcsSelected) and AIsHotTrack then
      Result := cxbsHot
...
begin
  Result := not InvalidateOnStateChange;
end;
...
procedure TcxGridViewLayoutItemDataCellViewInfo.StateChanged
...
function TcxGridViewLayoutItemDataCellViewInfo.GetLayoutItemViewInfo
  : TcxGridCustomLayoutItemViewInfo;
begin
...
function TcxGridLayoutCustomizationController.GetFormBounds: TRect;
begin
  if IsRectEmpty(FormBounds) then
  begin
    Result := ScaleFactor.Apply(Rect(0, 0, GetFormDefaultWidth,
      GetFormDefaultHeight));
...
function TcxGridLayoutCustomizationController.GetScaleFactor: TdxScaleFactor;
begin
  Result := TcxControlAccess(Site).ScaleFactor;
end;
...
begin
  Result := inherited CanDrawBackground and TcxGridLayoutContainerViewInfo
    (ContainerViewInfo).CanDrawRoot;
end;
...
function TcxGridLayoutContainerViewInfo.IsValid: Boolean;
begin
...
function TcxGridLayoutContainerViewInfo.CanPopulateItem
...
function TcxGridLayoutContainerViewInfo.GetRootViewInfoClass
...
procedure TcxGridLayoutContainerViewInfo.DoPopulateTabOrderList
  (AItem: TdxCustomLayoutItemViewInfo; AList: TList);
begin
  if IsItemGroup(AItem) then
    PopulateGroup(AItem, AList)
  else if CanPopulateItem(AItem) then
...
procedure TcxGridLayoutContainerViewInfo.PopulateGroup
  (AValue: TdxCustomLayoutItemViewInfo; AList: TList);
var
...
procedure TcxGridLayoutContainerViewInfo.PopulateItem
  (AItem: TdxCustomLayoutItemViewInfo; AList: TList);
var
  AViewInfo: TcxGridCustomLayoutItemViewInfo absolute AItem;
begin
  AList.Add(AViewInfo.Item.GridViewItem);
end;

{ TdxLayoutCloneGroupViewData }

procedure TdxLayoutCloneGroupViewData.Assign
...
function TcxGridRecordLayoutContainerViewInfo.GetGridItemViewInfo
  (AViewInfo: TcxGridCustomLayoutItemViewInfo): TcxGridTableDataCellViewInfo;
begin
...
function TcxGridRecordLayoutContainerViewInfo.GetRecordViewInfoInstance
...
function TcxGridRecordLayoutContainerViewInfo.GetRecordViewInfo
  : TcxCustomGridRecordViewInfo;
begin
  Result := GetRecordViewInfoInstance;
end;

function TcxGridRecordLayoutContainerViewInfo.GetItemOptions
  (AViewInfo: TdxCustomLayoutItemViewInfo): TdxCustomLayoutLookAndFeelOptions;
begin
  if TdxCustomLayoutItemAccess(TdxCustomLayoutItemViewInfoAccess(AViewInfo)
    .Item).IsGroup then
...
function TcxGridRecordLayoutContainerViewInfo.GetViewDataClass
...
function FindItemByData(AContainer: TdxLayoutContainer; AData: Pointer)
  : TdxCustomLayoutItem;
var
  I: Integer;
    ...
    begin
      ...
      if AParent <> nil then
        if AParent.IsRoot then
          ...
          AItem.Parent := FindItemByData(Container, AParent)
            as TdxCustomLayoutGroup;
    end;
    for I := 0 to Container.AbsoluteItemCount - 1 do
      TdxCustomLayoutItemAccess(Container.AbsoluteItems[I]).LoadedIndex :=
        FPattern.AbsoluteItems[I].Index;
...
procedure TcxGridLayoutContainerCustomizationHelper.AssignStructureToPattern;
  ...
  begin
    Result := nil;
    if TdxLayoutContainerAccess(FPattern).AbsoluteItemList.IndexOf
      (AItem.Data) > -1 then
    ...
    begin
      ...
      begin
        if Container.AbsoluteItems[I].Parent.IsRoot then
          ...
          AItem.Parent := TdxCustomLayoutItemAccess
            (FindDestinationItem(Container.AbsoluteItems[I].Parent)).AsGroup;
      end;
    end;
    for I := 0 to Container.AbsoluteItemCount - 1 do
    begin
      ...
      TdxCustomLayoutItemAccess(AItem).LoadedIndex :=
        Container.AbsoluteItems[I].Index;
    end;
...
procedure TcxGridLayoutContainerCustomizationHelper.CopyStructure
  (AContainer: TdxLayoutContainer);
var
  AGridHelper: TcxGridLayoutContainerCustomizationHelper;
begin
  AGridHelper := TdxLayoutContainerAccess(AContainer)
    .CustomizationHelper as TcxGridLayoutContainerCustomizationHelper;
  try
...
function TcxGridCustomLayoutContainer.GetCustomizationHelperClass
  : TdxLayoutContainerCustomizationHelperClass;
begin
  Result := TcxGridLayoutContainerCustomizationHelper;
end;

function TcxGridCustomLayoutContainer.GetCustomizationHelper
  : TcxGridLayoutContainerCustomizationHelper;
begin
  Result := inherited CustomizationHelper as
    TcxGridLayoutContainerCustomizationHelper;
end;
