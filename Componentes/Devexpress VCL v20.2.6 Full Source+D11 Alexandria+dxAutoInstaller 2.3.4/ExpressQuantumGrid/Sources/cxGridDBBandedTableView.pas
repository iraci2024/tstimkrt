...
type
  ...
  public
    ...
    property Columns[Index: Integer]: TcxGridDBBandedColumn read GetColumn
      write SetColumn;
  published
...
function TcxGridDBBandedTableView.GetColumn(Index: Integer)
  : TcxGridDBBandedColumn;
begin
...
procedure TcxGridDBBandedTableView.SetColumn(Index: Integer;
  Value: TcxGridDBBandedColumn);
begin
  inherited Columns[Index] := Value;
end;

procedure TcxGridDBBandedTableView.SetDataController
  (Value: TcxGridDBDataController);
begin
  FDataController.Assign(Value);
end;

function TcxGridDBBandedTableView.GetDataControllerClass
...
function TcxGridDBBandedTableView.GetColumnByFieldName(const AFieldName: string)
  : TcxGridDBBandedColumn;
begin
  Result := TcxGridDBBandedColumn(DataController.GetItemByFieldName
    (AFieldName));
end;
