...
uses
  ...
  dxLayoutControlAdapters, dxLayoutContainer, cxCheckBox, dxLayoutLookAndFeels,
  ExtCtrls, dxLayoutControl,
  cxGridWizardCustomPage, cxGridWizardStrs, cxGridLayoutView, cxLabel, StdCtrls,
  cxRadioGroup, cxGridCustomLayoutView,
  cxGridCustomTableView;

type
  { TcxGridWizardLayoutViewOptionsViewSettingsPageFrame }

  TcxGridWizardLayoutViewOptionsViewSettingsPageFrame = class
...
begin
  lbSingleRecordStretch.Caption :=
    cxGetResourceString(@scxgwLayoutViewOptionsViewPageSingleRecordStretch);
  lbSingleRecordStretch.Hint := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageSingleRecordStretchHint);

  rbClient.Caption := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageSingleRecordStretchClient);
  rbClient.Hint := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageSingleRecordStretchClientHint);

  rbHorizontal.Caption := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageSingleRecordStretchHorizontal);
  rbHorizontal.Hint := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageSingleRecordStretchHorizontalHint);

  rbNone.Caption := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageSingleRecordStretchNone);
  rbNone.Hint := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageSingleRecordStretchNoneHint);

  rbVertical.Caption := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageSingleRecordStretchVertical);
  rbVertical.Hint := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageSingleRecordStretchVerticalHint);

  chbCenterRecords.Caption := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageCenterRecords);
  chbCenterRecords.Hint := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageCenterRecordsHint);

  lbViewMode.Caption := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageViewMode);
  lbViewMode.Hint := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageViewModeHint);

  rbCarousel.Caption := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageViewModeCarousel);
  rbCarousel.Hint := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageViewModeCarouselHint);

  rbMultiColumn.Caption := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageViewModeMultiColumn);
  rbMultiColumn.Hint := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageViewModeMultiColumnHint);

  rbMultiRow.Caption := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageViewModeMultiRow);
  rbMultiRow.Hint := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageViewModeMultiRowHint);

  rbSingleColumn.Caption := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageViewModeSingleColumn);
  rbSingleColumn.Hint := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageViewModeSingleColumnHint);

  rbSingleRecord.Caption := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageViewModeSingleRecord);
  rbSingleRecord.Hint := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageViewModeSingleRecordHint);

  rbSingleRow.Caption := cxGetResourceString
    (@scxgwLayoutViewOptionsViewPageViewModeSingleRow);
  rbSingleRow.Hint := cxGetResourceString
...
function TcxGridWizardLayoutViewOptionsViewSettingsPageFrame.
...
function TcxGridWizardLayoutViewOptionsViewSettingsPageFrame.
  GetSingleRecordStretch: TcxGridLayoutViewSingleRecordStretch;
begin
  Result := srsNone;
...
function TcxGridWizardLayoutViewOptionsViewSettingsPageFrame.GetViewMode
...
procedure TcxGridWizardLayoutViewOptionsViewSettingsPageFrame.
  UpdateControlsState;
begin
  lcViewSettingsPageGroup2.Visible := TcxGridLayoutView(Helper.GridView)
    .OptionsView.ViewMode = lvvmSingleRecord;
  lcViewSettingsPageGroup4.Visible := TcxGridLayoutView(Helper.GridView)
    .OptionsView.ViewMode = lvvmSingleRecord;
end;

{ Events }

procedure TcxGridWizardLayoutViewOptionsViewSettingsPageFrame.RefreshPreviewGrid
  (Sender: TObject);
begin
