...
uses
  ...
  cxGridCustomView, cxGridLayoutViewCustomizationForm, cxGridWizardCustomPage,
  cxGridWizardStrs, dxCustomWizardControl,
...
type
  ...
  TcxCustomGridCustomizationControllerAccess = class
    (TcxCustomGridCustomizationController);

  { TcxGridWizardLayoutViewOptionsCustomizeItemsPageFrame }

  TcxGridWizardLayoutViewOptionsCustomizeItemsPageFrame = class
  ...
  private
    ...
    function GetGridViewCustomizationController
      : TcxCustomGridCustomizationControllerAccess;
  protected
  ...
  public
    ...
    property CustomizationForm: TcxGridLayoutViewCustomizationForm
      read GetCustomizationForm;
    property GridViewController: TcxCustomGridControllerAccess
      read GetGridViewController;
    property GridViewCustomizationController
      : TcxCustomGridCustomizationControllerAccess
      read GetGridViewCustomizationController;
  end;
...
procedure TcxGridWizardLayoutViewOptionsCustomizeItemsPageFrame.
  BeforeDestruction;
begin
...
function TcxGridWizardLayoutViewOptionsCustomizeItemsPageFrame.
...
function TcxGridWizardLayoutViewOptionsCustomizeItemsPageFrame.
  GetCustomizationForm: TcxGridLayoutViewCustomizationForm;
begin
  if (PreviewGrid <> nil) and (PreviewGrid.ActiveLevel <> nil) and
    (PreviewGrid.ActiveView <> nil) then
    Result := TcxGridLayoutViewCustomizationForm
      (GridViewController.CustomizationForm)
  else
    Result := nil;
end;

function TcxGridWizardLayoutViewOptionsCustomizeItemsPageFrame.
  GetGridViewController: TcxCustomGridControllerAccess;
begin
  Result := TcxCustomGridControllerAccess(PreviewGrid.ActiveView.Controller);
end;

function TcxGridWizardLayoutViewOptionsCustomizeItemsPageFrame.
  GetGridViewCustomizationController
  : TcxCustomGridCustomizationControllerAccess;
begin
  Result := TcxCustomGridCustomizationControllerAccess
    (GridViewController.CustomizationController);
end;
