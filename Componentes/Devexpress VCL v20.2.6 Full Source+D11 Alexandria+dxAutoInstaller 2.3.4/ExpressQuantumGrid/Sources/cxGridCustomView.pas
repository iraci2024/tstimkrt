...
type
  ...
  TcxGridShowLockedStateImageMode = type TcxLockedStateImageShowingMode;
  // (lsimNever, lsimPending, lsimImmediate);

  IcxGridViewLayoutEditorSupport = interface
  // it is here because of problem in CBuilder
  ...
  public
    ...
    function DragAndDropObjectClass
      : TcxCustomGridDragAndDropObjectClass; virtual;
  ...
  protected
    ...
    function GetArrowAreaBounds(APlace: TcxGridArrowPlace): TRect;
      virtual; abstract;
    function GetArrowClass: TcxDragAndDropArrowClass; virtual;
    function GetArrowsClientRect: TRect; virtual;
    function GetCustomizationFormListBox: TcxCustomGridItemsListBox;
      virtual; abstract;
    ...
    property ArrowPlaces[AArrowNumber: TcxGridArrowNumber]: TcxGridArrowPlace
      read GetArrowPlace;
    property ArrowsClientRect: TRect read GetArrowsClientRect;
    property CustomizationForm: TcxCustomGridCustomizationForm
      read GetCustomizationForm;
    property CustomizationFormListBox: TcxCustomGridItemsListBox
      read GetCustomizationFormListBox;
    ...
    property SourceItemViewInfo: TcxCustomGridCellViewInfo
      read GetSourceItemViewInfo;
  public
  ...
  public
    ...
    procedure PaintDragAndDropItem(ACanvas: TcxCanvas; const R: TRect;
      AItem: TObject);
    procedure PaintItem(ACanvas: TcxCanvas; R: TRect; AIndex: Integer;
      AFocused: Boolean); virtual; abstract;
  ...
  protected
    ...
    property ViewInfo: TcxCustomGridViewInfo read GetViewInfo;
  public
    constructor Create(AController: TcxCustomGridController);
      reintroduce; virtual;
    destructor Destroy; override;
  ...
  protected
    ...
    property OptionsBehavior: TcxCustomGridOptionsBehavior
  ...
  protected
    ...
    function GetFormBounds: TRect; virtual;
  ...
  protected
    ...
    function CreateFieldControls(X, Y: Integer; ADataSource: TObject;
      AFieldList: TList): Boolean; virtual;
    ...
    function GetActiveCellViewInfo(AHitTest: TcxCustomGridHitTest)
      : TcxCustomGridCellViewInfo;
    function GetDesignControllerClass
      : TcxGridViewDesignControllerClass; virtual;
    ...
    function ProcessDesignPopupMenu(AViewInfo: TcxCustomGridCellViewInfo)
      : Boolean; virtual;
    ...
    function CreateCustomizationController
      : TcxCustomGridCustomizationController; virtual;
    function GetCustomizationFormClass
      : TcxCustomGridCustomizationFormClass; virtual;
    // hints
    ...
    property CustomizationController: TcxCustomGridCustomizationController
      read FCustomizationController;
    property HintHelper: TcxGridHintHelper read FHintHelper;
    property DesignPopupMenuInvoker: TcxCustomGridCellViewInfo
      read FDesignPopupMenuInvoker;
    property DragAndDropObject: TcxCustomGridDragAndDropObject
  ...
  public
    ...
    procedure ShowHint(const AHintAreaBounds, ATextRect: TRect;
      const AText: string; AIsHintMultiLine: Boolean; AFont: TFont;
      AHintCellViewInfo: TcxCustomGridViewCellViewInfo);
    property HintCellViewInfo: TcxCustomGridViewCellViewInfo
      read GetHintCellViewInfo;
    ...
    function ProcessDetailDialogChar(ADetail: TcxCustomGridView;
      ACharCode: Word): Boolean; virtual;
    ...
    property CustomizationFormBounds: TRect read GetCustomizationFormBounds
      write SetCustomizationFormBounds;
    property DesignController: TcxGridViewDesignController
      read GetDesignController;
    property DragAndDropObjectClass: TcxDragAndDropObjectClass
      read GetDragAndDropObjectClass write SetDragAndDropObjectClass;
    property IsDblClick: Boolean read FIsDblClick;
    property MouseCaptureViewInfo: TcxCustomGridCellViewInfo
      read GetMouseCaptureViewInfo write SetMouseCaptureViewInfo;
  end;
  ...
  public
    constructor Create(AParent: TcxDataGroupNode;
  ...
  protected
    ...
    procedure BuildNodes(AParentNode: TcxDataGroupNode; ALevel: Integer;
      var ACurIndex: Integer);
    procedure ClearInfos;
    function CompareGroupsBySummary(AInfo1, AInfo2: Pointer): Integer;
    procedure RebuildDataGroupRecursive(AParentNode: TcxDataGroupNode;
  ...
  protected
    ...
    class function GetIsMainCanvasInUse(ACanvas: TcxCanvas;
  ...
  public
    ...
    procedure Paint(ACanvas: TcxCanvas = nil;
  ...
  TcxGridSite = class(TcxControl, IcxLockedStatePaint, IcxEditorFieldLink)
  private
  ...
  protected
    ...
    property Controller: TcxCustomGridController read GetController;
    property IgnoreUpdateLock: Boolean read FIgnoreUpdateLock
      write FIgnoreUpdateLock;
    property Painter: TcxCustomGridPainter read GetPainter;
  public
...
{$ENDIF}
  ...
  TcxCustomGridCellViewInfo = class(TcxOwnedInterfacedPersistent,
    ...
    IcxCustomGridPopupOwner, IdxScaleFactor, IdxAdornerTargetElement,
  ...
  protected
    ...
    function IcxCustomGridPopupOwner.ClosePopupWhenSetNil =
    ...
    property LinkedHitTest: TcxCustomGridHitTest read FLinkedHitTest
      write SetLinkedHitTest;
  ...
  public
    ...
    property AlignmentVert: TcxAlignmentVert read FAlignmentVert
      write FAlignmentVert;
  ...
  TcxCustomGridViewInfo = class(TcxGridViewHandler, IdxScaleFactor)
  private
  ...
  protected
    ...
    function GetDesignSelectorViewInfoClass
      : TcxGridDesignSelectorViewInfoClass; virtual;
    ...
    function CanHandleDesignHitTest(X, Y: Integer; Shift: TShiftState)
      : Boolean; virtual;
    procedure ControlFocusChanged; virtual;
    ...
    property AllowBoundsChangedNotification: Boolean
      read GetAllowBoundsChangedNotification;
    property AllowCheckCoordinates: Boolean read FAllowCheckCoordinates
      write FAllowCheckCoordinates;
    property ClientBoundsAssigned: Boolean read FClientBoundsAssigned
      write FClientBoundsAssigned;
  ...
  public
    ...
    function GetHitTest(const P: TPoint): TcxCustomGridHitTest;
      overload; virtual;
    ...
    property DesignSelectorViewInfo: TcxGridDesignSelectorViewInfo
      read FDesignSelectorViewInfo;
    property IsCalculating: Boolean read FIsCalculating;
    property IsInternalUse: Boolean read GetIsInternalUseValue
      write FIsInternalUse;
    property IsRightToLeftConverted: Boolean read FIsRightToLeftConverted
      write FIsRightToLeftConverted;
  ...
  public
    constructor Create(AOwner: TcxCustomGridViewInfoCache;
  ...
  private
    ...
    function GetInternalItem(Index: Integer)
      : TcxCustomGridViewInfoCacheItem; inline;
    function GetItem(Index: Integer): TcxCustomGridViewInfoCacheItem;
    procedure SetCount(Value: Integer);
  protected
    function GetItemClass(Index: Integer): TcxCustomGridViewInfoCacheItemClass;
      virtual; abstract;
    property InternalItems[Index: Integer]: TcxCustomGridViewInfoCacheItem
  ...
  public
    ...
    property Items[Index: Integer]: TcxCustomGridViewInfoCacheItem
  ...
  public
    ...
    property Values[Index: Integer]: TBitmap read GetValue
      write SetValue; default;
  published
    property Background: TBitmap index bbBackground read GetValue
      write SetValue;
  end;

  { TcxGridLockedImageOptions }

  TcxCustomGridShowLockedStateImageOptionsClass = class of
  ...
  protected
    function GetShowLockedStateImageOptionsClass
      : TcxCustomGridShowLockedStateImageOptionsClass; virtual;

    property HintHidePause: Integer read FHintHidePause write FHintHidePause
      default 0;
    property ShowHourglassCursor: Boolean read FShowHourglassCursor
      write FShowHourglassCursor default True;
    property ShowLockedStateImageOptions
      : TcxCustomGridShowLockedStateImageOptions
      read FShowLockedStateImageOptions write SetShowLockedStateImageOptions;
    property SuppressHintOnMouseDown: Boolean read FSuppressHintOnMouseDown
      write FSuppressHintOnMouseDown default True;
  public
    constructor Create(AGridView: TcxCustomGridView); override;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
  published
    property PostponedSynchronization: Boolean read GetPostponedSynchronization
      write FPostponedSynchronization default True;
    // should be published in all descendants
  end;
  ...
  public
    procedure Assign(Source: TPersistent); override;
  published
    property Background: TcxStyle index vsBackground read GetValue
      write SetValue;
  end;
  ...
  TcxGridInitStoredObjectEvent = procedure(Sender: TcxCustomGridView;
  ...
  TcxCustomGridView = class(TcxControlChildComponent, IcxStoredObject,
    IcxStoredParent, IcxGridViewLayoutEditorSupport, IdxAdornerTargetElement)
  private
    ...
    procedure SetOnGetStoredPropertyValue
      (Value: TcxGridViewGetStoredPropertyValueEvent);
  ...
  protected
    ...
    procedure InitChildComponent(AObject: TObject;
      const AObjectName: string); virtual;
    ...
    procedure GridBeginUpdate(AShowLockedStateImage
      : TcxGridShowLockedStateImageMode = lsimNever);
    ...
    procedure GridBeginLockedStatePaint
      (AMode: TcxGridShowLockedStateImageMode); virtual;
    ...
    property SynchronizationAssignNeeded: Boolean
      read FSynchronizationAssignNeeded;
    ...
    function HandleSetStoredPropertyValueError(Sender: TcxStorage;
      const AName: string; const AValue: Variant): Boolean; virtual;
    ...
    function GetControllerClass: TcxCustomGridControllerClass; virtual;
      abstract;
    function GetDataControllerClass: TcxCustomDataControllerClass;
      virtual; abstract;
    ...
    property BackgroundBitmaps: TcxCustomGridBackgroundBitmaps
      read FBackgroundBitmaps write SetBackgroundBitmaps; { 4 }
    ...
    property OptionsData: TcxCustomGridOptionsData read FOptionsData
      write SetOptionsData;
    property OptionsSelection: TcxCustomGridOptionsSelection
      read FOptionsSelection write SetOptionsSelection;
    property OptionsView: TcxCustomGridOptionsView read FOptionsView
    ...
    property OnCustomization: TNotifyEvent read FOnCustomization
      write SetOnCustomization;
    property OnInitStoredObject: TcxGridInitStoredObjectEvent
      read FOnInitStoredObject write SetOnInitStoredObject;
  public
    ...
    function Changed(AGridChange: TObject): Boolean; overload;
    ...
    procedure BoundsChanged(AUpdateSelfOnly: Boolean = False;
      AKeepMaster: Boolean = False); virtual;
    procedure Changed(AChangeKind: TcxGridViewChangeKind); overload;
    {$IFDEF BCBCOMPATIBLE}virtual; {$ENDIF}
    procedure LayoutChanged(AUpdateSelfOnly: Boolean = True);
    function SizeChanged(AUpdateSelfOnly: Boolean = False;
      AKeepMaster: Boolean = False): Boolean; virtual;
    procedure ViewChanged; overload; {$IFDEF BCBCOMPATIBLE}virtual; {$ENDIF}
    procedure ViewChanged(const AUpdateRect: TRect); overload;
    {$IFDEF BCBCOMPATIBLE}virtual; {$ENDIF}
    procedure ViewChanged(ARegion: TcxRegion); overload;
    {$IFDEF BCBCOMPATIBLE}virtual; {$ENDIF}
    ...
    procedure RestoreFromStorage(const AStorageName: string;
      AReaderClass: TcxCustomReaderClass; AChildrenCreating: Boolean = True;
    ...
    property StorageOptions: TcxGridStorageOptions read FStorageOptions
      write FStorageOptions;
    ...
    property MasterDataController: TcxCustomDataController
    ...
    property Visible: Boolean read GetVisible;
  published
    property DataControllerEvents: TNotifyEvent read FSubClassEvents
    ...
    property StylesEvents: TNotifyEvent read FSubClassEvents
      write FSubClassEvents;
    property Synchronization: Boolean read GetSynchronization
      write SetSynchronization default True { False };
    ...
    property OnMouseEnter: TNotifyEvent read GetOnMouseEnter
      write SetOnMouseEnter;
    property OnMouseLeave: TNotifyEvent read GetOnMouseLeave
    ...
    property OnMouseWheel: TMouseWheelEvent read GetOnMouseWheel
      write SetOnMouseWheel;
    property OnMouseWheelDown: TMouseWheelUpDownEvent read GetOnMouseWheelDown
      write SetOnMouseWheelDown;
    property OnMouseWheelUp: TMouseWheelUpDownEvent read GetOnMouseWheelUp
  ...
  public
    class procedure AddClone(AInstance: TcxCustomGridView;
      AClone: TcxCustomGridView); static;
    class procedure AssignPattern(AInstance: TcxCustomGridView;
      APattern: TcxCustomGridView); static;
    class function CanBeUsedAsDetail(AInstance: TcxCustomGridView)
      : Boolean; static;
    class function CanBeUsedAsMaster(AInstance: TcxCustomGridView)
      : Boolean; static;
    ...
    class procedure DetailVisibleChanged(AInstance: TcxCustomGridView;
      ADetailLevel: TComponent; APrevVisibleDetailCount, AVisibleDetailCount
      : Integer); static;
    class procedure FocusChanged(AInstance: TcxCustomGridView;
      AFocused: Boolean); static;
    class procedure LookAndFeelChanged(AInstance: TcxCustomGridView); static;
    class procedure SetLevel(AInstance: TcxCustomGridView;
      Value: TComponent); static;

    class function GetChangeable(AInstance: TcxCustomGridView): Boolean; static;
    class function GetStyles(AInstance: TcxCustomGridView)
      : TcxCustomGridStyles; static;

    class procedure AfterDestroyingLockedStateImage
      (AInstance: TcxCustomGridView); static;
    class procedure BeforeCreatingLockedStateImage
      (AInstance: TcxCustomGridView); static;
  end;

function GetViewItemUniqueName(AView: TcxCustomGridView; AItem: TComponent;
  const AItemName: string): string;
function GetGridViewDataController(AView: TcxCustomGridView)
...
{$ENDIF}
  ...
  cxGrid, cxGridLevel, cxGridStrs, cxDrawTextUtils, cxEditUtils,
...
type
  ...
  private
    FItems: TList;
    function GetCount: Integer; inline;
    function GetInstance(AClass: TcxCustomGridHitTestClass)
      : TcxCustomGridHitTest;
    function GetItem(Index: Integer): TcxCustomGridHitTest; inline;
  protected
    function GetObjectByClass(AClass: TcxCustomGridHitTestClass)
      : TcxCustomGridHitTest;
    property Count: Integer read GetCount;
  ...
  public
    constructor Create;
    destructor Destroy; override;
    property Instances[AClass: TcxCustomGridHitTestClass]: TcxCustomGridHitTest
...
function TGridHitTests.GetInstance(AClass: TcxCustomGridHitTestClass)
  : TcxCustomGridHitTest;
begin
...
function TGridHitTests.GetObjectByClass(AClass: TcxCustomGridHitTestClass)
  : TcxCustomGridHitTest;
var
  I: Integer;
begin
...
function TcxCustomGridViewChange.IsEqualCore
...
function TcxCustomGridHitTest.DragAndDropObjectClass
...
class function TcxCustomGridHitTest.Instance(const APos: TPoint)
  : TcxCustomGridHitTest;
begin
...
procedure TcxGridViewHandler.BeginUpdate(AShowLockedStateImage
  : TcxGridShowLockedStateImageMode = lsimNever);
begin
...
procedure TcxCustomGridDragAndDropObject.Init(const P: TPoint;
...
function TcxCustomGridMovingObject.GetArrowPlace(AArrowNumber
  : TcxGridArrowNumber): TcxGridArrowPlace;
begin
  if AreArrowsVertical then
    if AArrowNumber = anFirst then
      ...
      Result := apBottom
  else if AArrowNumber = anFirst then
    Result := apLeft
  else
    Result := apRight;
end;

function TcxCustomGridMovingObject.GetCustomizationForm
...
function TcxCustomGridMovingObject.GetDragAndDropCursor
...
procedure TcxCustomGridMovingObject.ChangeArrowsPosition
...
begin
  ...
  begin
    if AVisible then
      Arrows[AArrowNumber].Init(GridView.Site,
        GetArrowAreaBounds(ArrowPlaces[AArrowNumber]), ArrowsClientRect,
        ArrowPlaces[AArrowNumber]);
    Arrows[AArrowNumber].Visible := AVisible;
  end;
end;

procedure TcxCustomGridMovingObject.ChangeDragImagePosition
  (AVisible: Boolean = True);
begin
  if AVisible then
...
begin
  ...
  else if IsSourceCustomizationForm and (CustomizationFormListBox <> nil) then
  begin
    with CustomizationFormListBox do
      Result := dxMapWindowRect(Handle, Control.Handle,
        ItemRect(IndexOfItem(SourceItem)));
  end
  else
    Result := cxNullRect;
end;

function TcxCustomGridMovingObject.GetSourceItemViewInfo
  : TcxCustomGridCellViewInfo;
begin
  Result := nil;
end;
...
begin
  ...
  else if IsSourceCustomizationForm then
    InitFromCustomizationForm;
end;

procedure TcxCustomGridMovingObject.InitDragImageUsingCustomizationForm
  (ACanvas: TcxCanvas; const R: TRect; AItem: TObject);
begin
...
procedure TcxCustomGridMovingObject.DragAndDrop(const P: TPoint;
...
function TcxCustomGridItemsInnerListBox.GetLookAndFeelPainter
  : TcxCustomLookAndFeelPainter;
begin
  Result := LookAndFeel.Painter;
end;

procedure TcxCustomGridItemsInnerListBox.WMCancelMode
...
procedure TcxCustomGridItemsInnerListBox.WMNCCalcSize
...
procedure TcxCustomGridItemsInnerListBox.CreateParams
...
procedure TcxCustomGridItemsInnerListBox.KeyDown(var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TcxCustomGridItemsInnerListBox.LookAndFeelChanged
...
procedure TcxCustomGridItemsInnerListBox.MouseMove(Shift: TShiftState;
  X, Y: Integer);
var
  AParams: TcxCustomGridHitTest;
  P: TPoint;
...
procedure TcxCustomGridItemsInnerListBox.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
  FDragAndDropItemIndex := -1;
...
function TcxCustomGridItemsListBox.GetInnerListBox
  : TcxCustomGridItemsInnerListBox;
begin
...
constructor TcxCustomGridCustomizationForm.Create
...
begin
  ...
  if IsIconic(Application.Handle) then
    Visible := False
  else if not IsControlVisible(Controller.Site) then
    FController.Customization := False
...
procedure TcxCustomGridCustomizationForm.CreateParams
  (var Params: TCreateParams);
begin
...
procedure TcxCustomGridCustomizationForm.Initialize
  (AController: TcxCustomGridController);
begin
  // do nothing
end;
...
function TcxCustomGridDesignController.GetDesignObject(AObject: TPersistent)
  : TPersistent;
begin
  Result := AObject;
end;
...
function TcxCustomGridDesignController.CanDeleteComponent
...
function TcxCustomGridDesignController.IsObjectSelected
  (AObject: TPersistent): Boolean;
begin
  if TcxCustomGrid(Control).StructureNavigator = nil then
    Result := False
  else
    Result := TcxCustomGrid(Control).StructureNavigator.IsObjectSelected
      (GetDesignObject(AObject));
end;
...
procedure TcxCustomGridDesignController.SelectObject(AObject: TPersistent;
  AClearSelection: Boolean);
begin
  TcxCustomGrid(Control).StructureNavigator.SelectObject
    (GetDesignObject(AObject), AClearSelection);
end;
...
begin
  if Control <> nil then
    TcxCustomGrid(Control).StructureNavigator.UnselectObject
      (GetDesignObject(AObject));
end;

{ TcxGridViewDesignController }

constructor TcxGridViewDesignController.Create(AController
...
function TcxGridViewDesignController.GetDesignObject(AObject: TPersistent)
  : TPersistent;
begin
...
function TcxCustomGridCustomizationController.GetFormBounds: TRect;
begin
  if IsRectEmpty(FFormBounds) then
  begin
    Result.BottomRight := Site.ClientToScreen(Site.ClientRect.BottomRight);
    Result.Left := Result.Right - Site.ScaleFactor.Apply(GetFormDefaultWidth);
    Result.Top := Result.Bottom - Site.ScaleFactor.Apply(GetFormDefaultHeight);
...
begin
  ...
  AForm.BoundsRect := GetFormBounds;
  if Control <> nil then
  begin
...
function TcxCustomGridCustomizationController.GetFormIntf
  : IcxGridCustomizationForm;
begin
  if Form = nil then
    Result := nil
...
function TcxCustomGridController.GetDesignController
  : TcxGridViewDesignController;
begin
...
function TcxCustomGridController.GetDragAndDropObject
  : TcxCustomGridDragAndDropObject;
begin
  Result := Site.DragAndDropObject as TcxCustomGridDragAndDropObject;
end;

function TcxCustomGridController.GetDragAndDropObjectClass
...
function TcxCustomGridController.GetHintCellViewInfo
...
function TcxCustomGridController.GetMouseCaptureViewInfo
  : TcxCustomGridCellViewInfo;
begin
...
procedure TcxCustomGridController.SetCustomizationFormBounds
  (const AValue: TRect);
begin
  CustomizationController.FormBounds := AValue;
end;

procedure TcxCustomGridController.SetDragAndDropObjectClass
  (Value: TcxDragAndDropObjectClass);
begin
  Site.DragAndDropObjectClass := Value;
end;

procedure TcxCustomGridController.SetMouseCaptureViewInfo
  (Value: TcxCustomGridCellViewInfo);
begin
  Site.MouseCaptureObject := Value;
end;

procedure TcxCustomGridController.CheckKeyAutoRepeat(ACharCode: Word;
...
function TcxCustomGridController.CanCancelDragStartOnCaptureObjectClear
  : Boolean;
begin
  Result := True;
end;
...
function TcxCustomGridController.CanHandleHitTest
...
begin
  ...
  else if AHitTest.ViewInfo <> nil then
    Result := AHitTest.ViewInfo
  else
    Result := nil;
end;

function TcxCustomGridController.GetDesignControllerClass
  : TcxGridViewDesignControllerClass;
begin
  Result := TcxGridViewDesignController;
end;

function TcxCustomGridController.GetDesignHitTest
  (AHitTest: TcxCustomGridHitTest): Boolean;
begin
...
function TcxCustomGridController.GetMouseWheelMajorScrollBarKind
  : TScrollBarKind;
begin
  Result := sbVertical;
end;

function TcxCustomGridController.GetPatternObject(AObject: TPersistent)
  : TPersistent;
begin
  if AObject is TcxCustomGridView then
    Result := TcxCustomGridView(AObject).PatternGridView
  else if AObject is TcxDataSummaryItem then
    Result := DataController.Summary.GetPatternSummaryItems
      (GridView.PatternGridView.DataController.Summary,
      TcxDataSummaryItem(AObject).SummaryItems)
      [TcxDataSummaryItem(AObject).Index]
  else
    Result := AObject;
end;
...
function TcxCustomGridController.IsPixelScrollBar
...
function TcxCustomGridController.ProcessDesignPopupMenu
  (AViewInfo: TcxCustomGridCellViewInfo): Boolean;
var
  AMenu: TPopupMenu;
begin
...
procedure TcxCustomGridController.SetFocusOnMouseClick(AButton: TMouseButton;
  X, Y: Integer);
begin
end;
...
function TcxCustomGridController.CreateCustomizationController
  : TcxCustomGridCustomizationController;
begin
  Result := TcxGridCustomizationController.Create(GridView);
end;

function TcxCustomGridController.GetCustomizationFormClass
...
procedure TcxCustomGridController.DoScroll(AScrollBarKind: TScrollBarKind;
...
procedure TcxCustomGridController.ScrollContentByGesture
...
function TcxCustomGridController.IsDataFullyVisible(AIsCallFromMaster
...
procedure TcxCustomGridController.SetScrollBarInfo(AScrollBarKind
  : TScrollBarKind; AMin, AMax, AStep, APage, APos: Integer;
  AAllowShow, AAllowHide: Boolean);
begin
  Site.SetScrollBarInfo(AScrollBarKind, AMin, AMax, AStep, APage, APos,
    AAllowShow, AAllowHide);
end;

procedure TcxCustomGridController.UpdateScrollBars(AIgnoreUpdateLock
  : Boolean = False);
var
...
procedure TcxCustomGridController.DragAndDrop(const P: TPoint;
  var Accepted: Boolean);
begin
end;
...
procedure TcxCustomGridController.ShowHint(const AHintAreaBounds,
  ATextRect: TRect; const AText: string; AIsHintMultiLine: Boolean;
  AFont: TFont; AHintCellViewInfo: TcxCustomGridViewCellViewInfo);
begin
  HintHelper.ShowHint(AHintAreaBounds, ATextRect, AText, AIsHintMultiLine,
    AHintCellViewInfo, AFont);
end;
...
function TcxCustomGridController.IMEComposition(var AMessage: TMessage)
  : Boolean;
begin
  Result := False;
end;
...
procedure TcxCustomGridController.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  AHitTest: TcxCustomGridHitTest;
begin
...
procedure TcxCustomGridController.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  AHitTest: TcxCustomGridHitTest;
  ACellViewInfo: TcxCustomGridCellViewInfo;
...
function TcxCustomGridController.ProcessDetailDialogChar
...
begin
  Result := (GridView.MasterGridView <> nil) and
    GridView.MasterGridView.Controller.ProcessDetailDialogChar(GridView,
    ACharCode);
end;
...
constructor TcxDataGroupNode.Create(AParent: TcxDataGroupNode;
  ADataGroupInfo: TcxDataGroupInfo);
begin
  inherited Create;
...
function TcxDataGroupNode.AddChild(ADataGroupInfo: TcxDataGroupInfo)
  : TcxDataGroupNode;
begin
...
constructor TcxGridSortingBySummaryEngine.Create(ADataControllerInfo
...
function TcxGridSortingBySummaryEngine.GetInfo(Index: Integer)
  : TcxSortingBySummaryInfo;
begin
...
procedure TcxGridSortingBySummaryEngine.BuildNodes
  (AParentNode: TcxDataGroupNode; ALevel: Integer; var ACurIndex: Integer);
var
...
function TcxGridSortingBySummaryEngine.CompareGroupsBySummary(AInfo1,
  AInfo2: Pointer): Integer;
var
  AInfo: TcxSortingBySummaryInfo;
begin
  AInfo := Infos[TcxDataGroupNode(AInfo1).DataGroupInfo.Level];
  Result := VarCompare(TcxDataGroupNode(AInfo1).DataGroupInfo.SummaryValues
    [AInfo.SummaryItemIndex], TcxDataGroupNode(AInfo2)
    .DataGroupInfo.SummaryValues[AInfo.SummaryItemIndex]);
  if Result = 0 then
  begin
  ...
  else if AInfo.SortOrder = soDescending then
    Result := -Result;
end;

procedure TcxGridSortingBySummaryEngine.RebuildDataGroupRecursive
  (AParentNode: TcxDataGroupNode; var AFirstRecordListIndex: Integer);
var
  I: Integer;
begin
...
procedure TcxGridSortingBySummaryEngine.SortNodeRecursive
  (ANode: TcxDataGroupNode; ALevel: Integer);
var
  I: Integer;
begin
...
begin
  ...
  begin
    ...
    ASortedSummaryItem := DataController.Summary.GroupSummaryItems[ALevel]
      .SortedSummaryItem;
    ...
    begin
      ...
      if DataController.SortingBySummaryDataItemIndex <> -1 then
        AInfo.SortOrder := DataController.GetItemSortOrder
      ...
      begin
        AItemGroupIndex :=
          ...
          (ALevel, 0);
        AInfo.SortOrder := DataControllerInfo.GroupingFieldList[AItemGroupIndex]
          .SortOrder;
      end;
    end
    else
...
begin
  ...
  else if ViewInfo.BackgroundBitmap <> nil then
...
class procedure TcxCustomGridCellPainter.DrawDesignSelection(ACanvas: TcxCanvas;
  AViewInfo: TcxCustomGridCellViewInfo);
begin
  ACanvas.DrawDesignSelection(AViewInfo.DesignSelectionBounds,
    AViewInfo.DesignSelectionWidth);
end;
...
begin
  ...
  begin
    ...
    cxTextOut(Canvas.Canvas, ViewInfo.TextForPainting, ARect, ATextOutFlags,
      ViewInfo.TextSelStart, ViewInfo.TextSelLength, nil,
      ViewInfo.TextSelBkColor, ViewInfo.TextSelColor)
  end
  else
    Canvas.DrawText(ViewInfo.TextForPainting, ARect, ADrawTextFlags, True,
      ViewInfo.GetDrawTextRotationAngle);
...
begin
  Result := ViewInfo.Calculated and
    Canvas.RectVisible(ViewInfo.GetAreaBoundsForPainting);
end;
...
class procedure TcxCustomGridCellPainter.DoDrawDesignSelection
  (ACanvas: TcxCanvas; AViewInfo: TcxCustomGridCellViewInfo);
begin
  if AViewInfo.IsDesignSelected and GetIsMainCanvasInUse(ACanvas, AViewInfo)
  then
...
function TcxGridDesignSelectorPainter.GetViewInfo
...
procedure TcxCustomGridPainter.DrawBackground;
  ...
  begin
    FillRgn(Canvas.Handle, FBackgroundRegion.Handle,
      TdxSolidBrushCache.Get(ViewInfo.BackgroundColor));
  end;
...
procedure TcxCustomGridPainter.DrawFocusRect(const R: TRect;
  AHideFocusRect: Boolean);
begin
  if GridView.IsControlFocused then
    Canvas.DrawFocusRect(R)
  else if not AHideFocusRect then
    with Canvas, R do
    begin
...
function TcxCustomGridViewData.GetSortingBySummaryEngineClass
...
function TcxCustomGridViewData.MakeDetailVisible(ADetailLevel
...
function TcxGridSite.GetActiveCanvas: TcxCanvas;
begin
  if HandleAllocated then
  begin
    FreeAndNil(FActiveCanvas);
...
function TcxGridSite.CreateFieldControls(X, Y: Integer; ADataSource: TObject;
  AFieldList: TList): Boolean;
begin
  if GridView.IsPattern then
    Result := GridView.Controller.CreateFieldControls(X, Y, ADataSource,
      AFieldList)
  else
    Result := GridView.PatternGridView.Controller.CreateFieldControls(X, Y,
      ADataSource, AFieldList);
end;

function TcxGridSite.AllowPan(AScrollKind: TScrollBarKind): Boolean;
begin
  Result := inherited AllowPan(AScrollKind) and
    ((Controller = nil) or Controller.AllowPan(AScrollKind));
end;
...
begin
  TcxControlAccess(Container).CheckOverpan(AScrollKind, ANewDataPos,
    AMinDataPos, AMaxDataPos, ADeltaX, ADeltaY);
end;
...
var
  APrevSize: TSize;
begin
  if CreatingWindow then
    Exit;
  APrevSize := FSize;
  UpdateSize;
  if ViewInfo.VisibilityChanging then
    Exit;
  if ((APrevSize.cx <> 0) or (APrevSize.cy <> 0)) and
    ...
    else if UpdatingScrollBars then
      PostBoundsChanged;
  inherited;
end;
...
begin
  Result := inherited CanFocusOnClick(X, Y) and Controller.CanFocusOnClick(X, Y)
    and (not IsScrollBarsArea(Point(X, Y)) or not Container.IsFocused);
end;

function TcxGridSite.CanProcessScrollEvents(var Message: TMessage): Boolean;
begin
  Result := not Locked or (ScrollBarsManager <> nil) and
    ScrollBarsManager.IsCapture and (Message.Msg = WM_CAPTURECHANGED);
end;
...
procedure TcxGridSite.SetFocusOnMouseClick(AButton: TMouseButton;
  X, Y: Integer);
var
  ALink: TcxObjectLink;
begin
...
procedure TcxGridSite.DoGestureScroll(AScrollKind: TScrollBarKind;
...
function TcxGridSite.IsScrollBarBasedGestureScroll
  (AScrollKind: TScrollBarKind): Boolean;

  function IsDataScrollDirection(AScrollKind: TScrollBarKind): Boolean;
  begin
    Result := (AScrollKind = sbVertical) and
      (MouseWheelScrollingKind = mwskVertical) or (AScrollKind = sbHorizontal)
      and (MouseWheelScrollingKind = mwskHorizontal);
  end;

begin
  Result := not GridView.IsRecordPixelScrolling or
    not IsDataScrollDirection(AScrollKind);
end;
...
function TcxGridSite.GetTouchScrollUIOwner(const APoint: TPoint)
...
procedure TcxGridSite.ScrollContentByGesture(AScrollKind: TScrollBarKind;
  ADelta: Integer);
begin
...
begin
  Result := inherited FocusWhenChildIsClicked(AChild) and
    not Container.IsFocused;
end;
...
function TcxGridSite.GetDesignHitTest(X, Y: Integer;
  Shift: TShiftState): Boolean;
var
  AHitTest: TcxCustomGridHitTest;
begin
  ...
  begin
    Result := Assigned(AHitTest.ViewInfo) and
      AHitTest.ViewInfo.HasDesignPopupMenu;
    if Result and MouseRightButtonReleased then
      FDesignPopupMenuInvoker := AHitTest.ViewInfo;
    if Result then
      Exit;
  end;
  if not((ssRight in Shift) or cxShiftStateMoveOnly(Shift) and
    MouseRightButtonReleased) then
...
begin
  Result := (GridView.Control <> nil) and TcxCustomGridAccess(GridView.Control)
    .IsPopupControl or { 8 }
...
const
  MinorScrollBar: array [TScrollBarKind] of TScrollBarKind = (sbVertical,
    sbHorizontal);
  ScrollingKind: array [TScrollBarKind] of TcxMouseWheelScrollingKind =
    (mwskHorizontal, mwskVertical);
var
...
begin
  Result := PtInRect(ViewInfo.ClientBounds, dxMapWindowPoint(Container.Handle,
    Handle, APoint));
end;
...
procedure TcxGridSite.MouseDown(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
  SaveOrigin;
...
begin
  if cxRectIsEqual(BoundsRect, ANewBounds) then
    Exit;
...
begin
  if Left = cxInvisibleCoordinate then
    Exit;
  inherited Paint;
end;
...
procedure TcxGridSite.DragOver(Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  inherited;
...
begin
  if not CreatingWindow and not FViewInfo.IsCalculating and GridView.Visible and
    (IgnoreUpdateLock or not Locked) then
    inherited UpdateScrollBars;
end;

function TcxGridSite.CanCancelDragStartOnCaptureObjectClear: Boolean;
begin
  Result := (Controller = nil) or
    Controller.CanCancelDragStartOnCaptureObjectClear;
end;
...
begin
  ATopSiteOriginDelta := Top - GridView.MasterGridView.ViewInfo.
    GetContentBounds.Top;
  ABottomSiteOriginDelta := GridView.MasterGridView.ViewInfo.GetContentBounds.
...
function TcxGridSite.IsLockedStatePaint(out ALockedStateImage
  : TcxBitmap32): Boolean;
var
  AGrid: TcxCustomGridAccess;
begin
...
begin
  Result := inherited ExecuteAction(Action) or GridView.Focused and
    GridView.DataController.ExecuteAction(Action);
end;
...
begin
  Result := inherited UpdateAction(Action) or GridView.Focused and
    GridView.DataController.UpdateAction(Action);
end;
...
begin
  ...
  else if AllowBoundsChangedNotification then
...
procedure TcxCustomGridCellViewInfo.SetLinkedHitTest
  (Value: TcxCustomGridHitTest);
var
...
begin
  if not MouseCapture and ((FState = gcsSelected) or not IsCheck and
    (FState = gcsPressed)) then
    DoMouseLeave;
end;
...
function TcxCustomGridCellViewInfo.
...
begin
  ...
  begin
    ...
    ADrawTextFlags := GetTextAttributes(False) and
      not(cxAlignRight or cxAlignCenter) or cxAlignLeft;
    ATextOutFlags := DrawTextFlagsTocxTextOutFlags(ADrawTextFlags) or
      CXTO_CALCRECT;
...
function TcxCustomGridCellViewInfo.CalculateTextHeight
...
begin
  ...
  begin
    ...
    ADrawTextFlags := GetTextAttributes(AForPainting) and
      not(cxAlignBottom or cxAlignVCenter) or cxAlignTop;
    ATextOutFlags := DrawTextFlagsTocxTextOutFlags(ADrawTextFlags) or
      CXTO_CALCRECT;
    cxTextOut(Canvas.Handle, Text, R, ATextOutFlags);
...
begin
  if FParamsCalculated or FCalculatingParams then
    Exit;
...
function TcxCustomGridCellViewInfo.CustomDrawBackground
...
function TcxCustomGridCellViewInfo.DoCustomDrawBackground
  (ACanvas: TcxCanvas): Boolean;
begin
...
function TcxCustomGridCellViewInfo.GetPainterClass
...
function TcxCustomGridCellViewInfo.GetTextAttributes(AForPainting
  : Boolean): Integer;
const
...
begin
  Result := cxAlignmentsHorz[AlignmentHorz] or cxAlignmentsVert[AlignmentVert]
    or AMultiLines[AForPainting and MultiLinePainting or not AForPainting and
    MultiLine] or AShowEndEllipsis[ShowEndEllipsis];
  if Control.UseRightToLeftReading then
    Result := Result or cxRtlReading;
end;

function TcxCustomGridCellViewInfo.GetTextBounds(AHorizontal,
...
begin
  ...
  begin
    ...
    with Result do
    begin
      if MultiLinePainting and (ATextWidth > Right - Left) then
        Exit;
...
function TcxCustomGridCellViewInfo.GetTextCellHeight(AGridViewInfo
...
function TcxCustomGridCellViewInfo.HasMouse
  (AHitTest: TcxCustomGridHitTest): Boolean;
begin
...
procedure TcxCustomGridCellViewInfo.InitDropDownWindow
...
function TcxCustomGridCellViewInfo.IsHotTracked(ACheckChildren
  : Boolean = True): Boolean;
begin
  Result := ButtonState = cxbsHot;
end;

function TcxCustomGridCellViewInfo.IsHotTrackChanged
  (APrevState: TcxGridCellState): Boolean;
begin
...
procedure TcxCustomGridCellViewInfo.PopulateDesignPopupMenu
...
function TcxCustomGridCellViewInfo.GetDropDownWindowAlignHorz
  : TcxPopupAlignHorz;
var
...
function TcxCustomGridCellViewInfo.GetDropDownWindowDefaultAlignHorz
  : TcxPopupAlignHorz;
begin
  Result := pahRight;
end;
...
function TcxCustomGridCellViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
...
begin
  Result := False;
  if (AButton = mbLeft) and HotTrack and AllowChangeStateOnMouseDown and
    HasMouse(AHitTest) then
  begin
    if IsCheck then
      case FState of
        gcsSelected:
...
procedure TcxCustomGridCellViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  AAlignmentHorz: TAlignment;
begin
  Bounds := TdxRightToLeftLayoutConverter.ConvertRect(Bounds, ABounds);
  FClientBounds := TdxRightToLeftLayoutConverter.ConvertRect
...
constructor TcxCustomGridViewCellViewInfo.Create(AGridViewInfo
  : TcxCustomGridViewInfo);
begin
...
function TcxCustomGridViewCellViewInfo.GetLookAndFeelPainter
  : TcxCustomLookAndFeelPainter;
begin
...
function TcxCustomGridViewCellViewInfo.GetAdornerTargetElementControl
  : TWinControl;
begin
...
procedure TcxCustomGridViewCellViewInfo.AfterCalculateBounds
  (var ABounds: TRect);
var
  AHitTest: TcxCustomGridHitTest;
begin
  inherited;
  if EmulateMouseMoveAfterCalculate and HotTrack and Control.HandleAllocated and
    GridViewInfo.Visible then
  begin
...
function TcxCustomGridViewCellViewInfo.
  AllowRightToLeftConversionOnRecalculate: Boolean;
begin
  Result := inherited AllowRightToLeftConversionOnRecalculate and
    not GridViewInfo.IsCalculating;
end;
...
function TcxCustomGridViewCellViewInfo.HasMouse
  (AHitTest: TcxCustomGridHitTest): Boolean;
begin
...
procedure TcxCustomGridViewCellViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
  inherited;
...
procedure TcxCustomGridViewCellViewInfo.InitDropDownWindow
  (APopup: TdxUIElementPopupWindow);
begin
...
procedure TcxCustomGridViewCellViewInfo.CheckHint
  (AHitTest: TcxCustomGridHitTest);
var
  AHintText: TCaption;
...
begin
  ...
  begin
    ...
    Controller.ShowHint(GetBoundsForHint, ATextRect, AHintText,
      AIsHintMultiLine, Params.Font, Self);
  end
  else
    Controller.CancelHint;
end;
...
function TcxCustomGridViewCellViewInfo.GetHintTextRect(const AMousePos
  : TPoint): TRect;
begin
  Result := TextAreaBounds;
end;
...
var
  ATextBounds, R: TRect;
begin
  Result := (HintText <> '') and HasHintPoint(AMousePos) and
    (State <> gcsPressed);
  if Result then
  begin
...
function TcxGridDesignSelectorViewInfo.GetHitTestClass
...
function TcxGridDesignSelectorViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridDesignSelectorPainter;
end;

procedure TcxGridDesignSelectorViewInfo.GetViewParams
  (var AParams: TcxViewParams);
const
  Colors: array [Boolean, Boolean] of TColor = ((cxGridDesignViewColor,
    cxGridDesignViewHotColor), (cxGridDesignSelectedColor,
    cxGridDesignSelectedHotColor));
...
begin
  AObjectSelected := GridView.Controller.DesignController.IsObjectSelected
    (GridView);
  AParams.Color := dxGetNearestColor(Colors[AObjectSelected,
    State = gcsSelected]);
  AParams.TextColor := dxGetNearestColor(BorderColors[AObjectSelected,
    State = gcsSelected]);
end;
...
begin
  ...
  FRegion := TcxRegion.Create(CreatePolygonRgn(Points, Length(Points),
    WINDING));
...
procedure TcxGridDesignSelectorViewInfo.Calculate(ALeftBound,
...
begin
  ...
  begin
    GridView.Controller.DesignController.SelectObject(GridView,
...
begin
  Result := GetIsInternalUse or GridView.IsDetail and
...
function TcxCustomGridViewInfo.GetDesignSelectorViewInfoClass
  : TcxGridDesignSelectorViewInfoClass;
begin
...
begin
  ...
  Result := (Control = nil) or GridView.IsDestroying or FAllowHideSite and
    not FSite.IsFocused and ((AGrid.FocusedView = nil) or
    not FSite.ContainsControl(AGrid.FocusedView.Site));
end;
...
begin
  if not IsInternalUse then
    Controller.UpdateScrollBars(True);
  if CanCheckCoordinates then
    Controller.DoCheckCoordinates;
end;
...
procedure TcxCustomGridViewInfo.CalculateWidth(const AMaxSize: TPoint;
  var AWidth: Integer);
begin
  if Site.IsScrollBarActive(sbVertical) then
    Inc(AWidth, Site.GetVScrollBarAreaWidth);
  if AWidth > AMaxSize.X then
    AWidth := AMaxSize.X;
end;
...
function TcxCustomGridViewInfo.CanHandleDesignHitTest(X, Y: Integer;
  Shift: TShiftState): Boolean;
begin
...
function TcxCustomGridViewInfo.DoGetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
...
begin
  if FSite.Left = cxInvisibleCoordinate then
    Exit;
...
procedure TcxCustomGridViewInfo.GetFontMetrics(AFont: TFont;
  out AMetrics: TTextMetric);
begin
  TdxTextMeasurer.TextMetrics(AFont, AMetrics);
end;

procedure TcxCustomGridViewInfo.GetHeight(const AMaxSize: TPoint;
  var AHeight: Integer; var AFullyVisible: Boolean);
begin
...
function TcxCustomGridViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
  Result := nil;
  if (Controller.CustomizationForm <> nil) and Site.HandleAllocated and
    PtInRect(cxGetWindowRect(Controller.CustomizationForm),
    Site.ClientToScreen(P)) then
  begin
    Result := TcxGridCustomizationFormHitTest.Instance(P);
    InitHitTest(Result);
  end
  else if DesignSelectorViewInfo <> nil then
...
procedure TcxCustomGridViewInfo.GetWidth(const AMaxSize: TPoint;
  var AWidth: Integer);
begin
  FSizeCalculating := True;
...
begin
  if FIsCalculating { or GridView.IsPattern } then
    Exit;
  IsRightToLeftConverted := False;
  BeforeCalculating;
  FIsCalculating := True;
  try
    if (Control <> nil) and (FSite.Parent = nil) then
      FSite.LookAndFeel.MasterLookAndFeel := TcxControlAccess(Control)
        .LookAndFeel;
...
constructor TcxCustomGridViewInfoCacheItem.Create
  (AOwner: TcxCustomGridViewInfoCache; AIndex: Integer);
begin
  inherited Create;
  FIndex := AIndex;
  FOwner := AOwner;
...
function TcxCustomGridViewInfoCache.GetInternalItem(Index: Integer)
  : TcxCustomGridViewInfoCacheItem;
begin
  Result := TcxCustomGridViewInfoCacheItem(FItems[Index]);
end;

function TcxCustomGridViewInfoCache.GetItem(Index: Integer)
  : TcxCustomGridViewInfoCacheItem;
begin
...
procedure TcxCustomGridViewInfoCache.UnassignValues
  ...
  begin
    ...
    begin
      ...
      if AItem <> nil then
        AItem.UnassignValues(AKeepMaster);
    end;
  end;
...
function TcxCustomGridOptions.GetLookAndFeelPainter
  : TcxCustomLookAndFeelPainter;
begin
...
function TcxCustomGridBackgroundBitmaps.GetBitmapStyleIndex
...
function TcxCustomGridBackgroundBitmaps.GetDefaultBitmap
...
procedure TcxCustomGridBackgroundBitmaps.SetValue(Index: Integer;
  Value: TBitmap);
begin
...
begin
  ...
  begin
    ...
    PostponedSynchronization := TcxCustomGridOptionsBehavior(Source)
      .PostponedSynchronization;
    ShowHourglassCursor := TcxCustomGridOptionsBehavior(Source)
      .ShowHourglassCursor;
    ShowLockedStateImageOptions := TcxCustomGridOptionsBehavior(Source)
      .ShowLockedStateImageOptions;
    SuppressHintOnMouseDown := TcxCustomGridOptionsBehavior(Source)
      .SuppressHintOnMouseDown;
  end;
  inherited Assign(Source);
end;

function TcxCustomGridOptionsBehavior.GetShowLockedStateImageOptionsClass
...
procedure TcxCustomGridStyles.GetDefaultViewParams(Index: Integer;
...
procedure TcxCustomGridViewStyles.GetDefaultViewParams(Index: Integer;
  AData: TObject; out AParams: TcxViewParams);
begin
  ...
  case Index of
    vsBackground:
      begin
        ...
        if (AParams.TextColor = clWindowText) and (AParams.Color = clWindow)
        then
...
function TcxGridViewNotificationList.GetItem(Index: Integer)
...
begin
  Result := (Control <> nil) { 5 } and
    (TcxCustomGrid(Control).FocusedView = Self);
end;
...
begin
  if MasterRecordIndex <> -1 then
    Result := MasterDataController.GetRowIndexByRecordIndex
      (MasterRecordIndex, False)
  else
    Result := -1;
end;
...
procedure TcxCustomGridView.SetBackgroundBitmaps
  (Value: TcxCustomGridBackgroundBitmaps);
begin
...
procedure TcxCustomGridView.SetOnGetStoredProperties
  (Value: TcxGridViewGetStoredPropertiesEvent);
begin
...
procedure TcxCustomGridView.SetOnGetStoredPropertyValue
  (Value: TcxGridViewGetStoredPropertyValueEvent);
begin
...
procedure TcxCustomGridView.SetOnInitStoredObject
  (Value: TcxGridInitStoredObjectEvent);
begin
...
procedure TcxCustomGridView.SetOnSetStoredPropertyValue
  (Value: TcxGridViewSetStoredPropertyValueEvent);
begin
...
procedure TcxCustomGridView.SetOptionsBehavior
  (Value: TcxCustomGridOptionsBehavior);
begin
...
procedure TcxCustomGridView.SetOptionsSelection
  (Value: TcxCustomGridOptionsSelection);
begin
...
procedure TcxCustomGridView.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
...
procedure TcxCustomGridView.SetPropertyValue(const AName: string;
  const AValue: Variant);
begin
  if AName = 'Version' then
...
function TcxCustomGridView.CreateChild(const AObjectName,
...
function TcxCustomGridView.CreateStoredObject(const AObjectName,
  AClassName: string): TObject;
begin
  Result := nil;
end;

procedure TcxCustomGridView.DeleteChild(const AObjectName: string;
  AObject: TObject);
begin
  AObject.Free;
end;
...
begin
  Result := inherited GetIsDestroying or IsDetail and
    MasterGridView.IsDestroying;
end;
...
procedure TcxCustomGridView.GridBeginUpdate(AShowLockedStateImage
  : TcxGridShowLockedStateImageMode = lsimNever);
begin
  if Control <> nil then
...
procedure TcxCustomGridView.GridBeginLockedStatePaint
...
var
  I: Integer;
begin
  if IsLoading or IsDestroying or (Control = nil) or not IsSynchronization or
    FAssigningPattern or FSynchronizationAssignNeeded then
    Exit;
...
begin
  if not IsSynchronization or FIsSynchronizing or FAssigningPattern then
    Exit;
  if OptionsBehavior.PostponedSynchronization and not IsPattern and not Visible
  then
  begin
...
begin
  ...
  try
    ...
    try
      TcxDataControllerAccess(DataController).SetPatternDataController
        (APattern.DataController);
      Assign(APattern);
    finally
...
function TcxCustomGridView.HandleSetStoredPropertyValueError(Sender: TcxStorage;
  const AName: string; const AValue: Variant): Boolean;
begin
  Result := False;
end;

procedure TcxCustomGridView.RestoreFrom(const AStorageName: string;
...
procedure TcxCustomGridView.StoreTo(const AStorageName: string;
...
function TcxCustomGridView.GetTouchScrollUIOwner(const APoint: TPoint)
  : IdxTouchScrollUIOwner;
begin
  Result := nil;
end;
...
begin
  if (Site.GetScrollbarMode = sbmHybrid) and Site.IsScrollBarActive(sbVertical)
  then
    Result := Site.GetVScrollBarAreaWidth
  else
    Result := 0;
...
function TcxCustomGridView.IsDetailVisible
...
procedure TcxCustomGridView.NotifyControl(AChangeKind
  : TcxGridViewChangeNotificationKind);
begin
  if Control <> nil then
...
procedure TcxCustomGridView.ScrollContentByGesture(AScrollKind: TScrollBarKind;
  ADelta: Integer);
begin
...
begin
  Result := (Site.GetScrollbarMode = sbmHybrid) and
    Site.IsScrollBarActive(sbHorizontal);
end;
...
begin
  if not(IsLoading or IsDestroying or IsPattern) and
    (AInfo is TcxDataChangedInfo) then
  begin
    if IsDetail then
    begin
      AMasterGridView := MasterGridView;
    ...
    else if Control <> nil then // ext lookup editor
...
function TcxCustomGridView.GetViewInfoCacheClass
  : TcxCustomGridViewInfoCacheClass;
begin
  Result := nil;
end;

function TcxCustomGridView.GetBackgroundBitmapsClass
  : TcxCustomGridBackgroundBitmapsClass;
begin
  Result := TcxCustomGridBackgroundBitmaps;
end;

function TcxCustomGridView.GetOptionsBehaviorClass
...
function TcxCustomGridView.GetOptionsSelectionClass
...
begin
  MessageBox(0, PChar(Format('%s does not support master-detail relationships!',
    [ClassName])), 'Error', MB_OK or MB_ICONSTOP or MB_TASKMODAL);
  Abort;
end;

procedure TcxCustomGridView.ValidateMasterDetailRelationship
  (AIsMaster: Boolean);
begin
  if AIsMaster then
  begin
  ...
  else if not CanBeUsedAsDetail then
    UnsupportedMasterDetailError;
end;
...
begin
  AMasterGridView := MasterGridView;
  Result := (AMasterGridView = AGridView) or (AMasterGridView <> nil) and
    AMasterGridView.HasAsMaster(AGridView);
end;
...
procedure TcxCustomGridView.BeginUpdate(AShowLockedStateImage
  : TcxGridShowLockedStateImageMode = lsimNever);
begin
...
begin
  Result := True;
  if IsLoading or IsDestroying { or IsPattern } or (FViewInfo = nil) or
    FViewInfo.IsCalculating then
  begin
    AGridChange.Free;
    Result := False;
  end
  else if Control = nil { 5 } then
    try
...
begin
  if (DataController <> nil) and DataController.IsDataLoading then
    Exit;
  BeginUpdate;
  try
    case AChangeKind of
...
begin
  Result := Changed(TcxGridSizeChange.Create(Self, AUpdateSelfOnly or
    (Control = nil) { 7 } , AKeepMaster));
end;
...
procedure TcxCustomGridView.StoreToIniFile(const AStorageName: string;
  ...
  const ASaveViewName: string = ''; const AOwnerName: string = '');
begin
  StoreTo(AStorageName, nil, TcxIniFileWriter, AReCreate, AOptions,
    ASaveViewName, AOwnerName);
end;
...
procedure TcxCustomGridView.StoreToRegistry(const AStorageName: string;
  ...
  const ASaveViewName: string = ''; const AOwnerName: string = '');
begin
  StoreTo(AStorageName, nil, TcxRegistryWriter, AReCreate, AOptions,
    ASaveViewName, AOwnerName);
end;
...
function TcxCustomGridView.GetScrollbarAnnotationHelper
...
class procedure TcxCustomGridViewAccess.AssignPattern
  (AInstance: TcxCustomGridView; APattern: TcxCustomGridView);
begin
  AInstance.AssignPattern(APattern);
end;

class function TcxCustomGridViewAccess.CanBeUsedAsDetail
  (AInstance: TcxCustomGridView): Boolean;
begin
  Result := AInstance.CanBeUsedAsDetail;
end;

class function TcxCustomGridViewAccess.CanBeUsedAsMaster
  (AInstance: TcxCustomGridView): Boolean;
begin
  Result := AInstance.CanBeUsedAsMaster;
end;

class function TcxCustomGridViewAccess.CanFocus
  (AInstance: TcxCustomGridView): Boolean;
begin
  Result := AInstance.CanFocus;
end;

class procedure TcxCustomGridViewAccess.Deactivate
  (AInstance: TcxCustomGridView);
begin
  if AInstance <> nil then
    AInstance.Deactivate;
end;

class procedure TcxCustomGridViewAccess.DetailVisibleChanged
  (AInstance: TcxCustomGridView; ADetailLevel: TComponent;
  APrevVisibleDetailCount, AVisibleDetailCount: Integer);
begin
  AInstance.DetailVisibleChanged(ADetailLevel, APrevVisibleDetailCount,
    AVisibleDetailCount);
end;

class procedure TcxCustomGridViewAccess.FocusChanged
  (AInstance: TcxCustomGridView; AFocused: Boolean);
begin
  AInstance.FocusChanged(AFocused);
end;

class procedure TcxCustomGridViewAccess.LookAndFeelChanged
  (AInstance: TcxCustomGridView);
begin
...
class function TcxCustomGridViewAccess.GetChangeable
  (AInstance: TcxCustomGridView): Boolean;
begin
  Result := AInstance.Changeable;
end;

class function TcxCustomGridViewAccess.GetStyles(AInstance: TcxCustomGridView)
  : TcxCustomGridStyles;
begin
  Result := AInstance.Styles;
end;

class procedure TcxCustomGridViewAccess.AfterDestroyingLockedStateImage
  (AInstance: TcxCustomGridView);
begin
  AInstance.AfterDestroyingLockedStateImage;
end;

class procedure TcxCustomGridViewAccess.BeforeCreatingLockedStateImage
  (AInstance: TcxCustomGridView);
begin
...
function TcxGridRegisteredViews.CompareItems(AIndex1, AIndex2: Integer)
  : Integer;
var
...
begin
  ...
  if not AIsDBView1 and AIsDBView2 then
    Result := -1
  else if AIsDBView1 and not AIsDBView2 then
    Result := 1
  else
