...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Windows, Classes, Graphics, Controls, Forms, StdCtrls, Contnrs,
  ImgList,
  dxCore, cxClasses, cxControls, cxGraphics, cxLookAndFeels,
  cxLookAndFeelPainters,
  dxCoreClasses, cxCustomData, cxPC, cxGridCommon, cxGridLevel,
  cxGridCustomView,
  cxGridCustomTableView, cxGridTableView, cxGridDetailsSite, cxScrollBar,
  cxImageComboBox,
  cxGridInplaceEditForm, cxFilterControlUtils, cxListBox, cxGeometry,
  dxTypeHelpers, cxGridRowLayout;
...
type
  ...
  protected
    ...
    property ViewInfo: TcxGridInplaceEditFormButtonsPanelViewInfo
      read GetViewInfo;
  end;
  ...
  TcxGridMasterDataRowDetailsSiteTabsPainter = class
  ...
  protected
    ...
    property ViewInfo: TcxGridMasterDataRowDetailsSiteLeftTabsViewInfo
      read GetViewInfo;
  end;
  ...
  protected
    ...
    property ViewInfo: TcxGridGroupRowGroupedColumnAreaViewInfo
      read GetViewInfo;
  end;
  ...
  public
    constructor Create(ACellViewInfo: TcxGridDataCellViewInfo);
      reintroduce; virtual;
  ...
  protected
    ...
    property MergedCellOfFocusedRow: TcxGridDataCellViewInfo
      read GetMergedCellOfFocusedRow;
    property GridView: TcxGridTableView read GetGridView;
    property GridViewInfo: TcxGridTableViewInfo read GetGridViewInfo;
  ...
  public
    ...
    property CheckBoxArea: TcxGridDataCellCheckBoxAreaViewInfo
      read FCheckBoxArea;
    ...
    property MergedCells[Index: Integer]: TcxGridDataCellViewInfo
      read GetMergedCell;
  ...
  public
    constructor Create(ACellViewInfo: TcxGridFilterRowCellViewInfo);
      reintroduce; virtual;
  ...
  TcxGridFilterRowOperatorViewInfoClass = class of
  ...
  private
    ...
    procedure OperatorMenuSelectHandler(Sender: TObject;
      AItem: TdxCustomListBoxItem; ASelectedViaKeyboard: Boolean);
  protected
    function GetOperatorViewInfoClass
      : TcxGridFilterRowOperatorViewInfoClass; virtual;
    ...
    property FilterOperator: TcxFilterControlOperator read GetOperator
      write SetOperator;
    property OperatorViewInfo: TcxGridFilterRowOperatorViewInfo
      read FOperatorViewInfo;
    property SupportedOperators: TcxFilterControlOperators
      read GetSupportedOperators;
  public
    constructor Create(ARecordViewInfo: TcxCustomGridRecordViewInfo;
      AItem: TcxCustomGridTableItem); override;
    destructor Destroy; override;
  ...
  TcxGridDataRowCellsAreaViewInfoClass = class of
    TcxGridDataRowCellsAreaViewInfo;
  ...
  strict private
    FContainerViewInfo: TcxGridRowLayoutContainerViewInfo;
    FItemViewInfos: TcxGridRowLayoutGridItemViewInfos;
    FRecordViewInfo: TcxGridDataRowViewInfo;

    function GetGridView: TcxGridTableView;
    function GetGridViewInfo: TcxGridTableViewInfo;
    function GetRowLayoutController: TcxGridRowLayoutController;
  protected
    function CalculateHeight: Integer; override;
    function CalculateWidth: Integer; override;
    function CreateContainerViewInfo
      : TcxGridTableRowLayoutContainerViewInfo; virtual;
    ...
    function GetHeight: Integer; override;
    function GetHitTestClass: TcxCustomGridHitTestClass; override;
    function GetItemViewInfoClass: TcxGridTableDataCellViewInfoClass; virtual;
    function GetPainterClass: TcxCustomGridCellPainterClass; override;
    procedure GetViewParams(var AParams: TcxViewParams); override;
    function GetWidth: Integer; override;
    ...
    property ItemViewInfos: TcxGridRowLayoutGridItemViewInfos
      read FItemViewInfos;
    property RecordViewInfo: TcxGridDataRowViewInfo read FRecordViewInfo;
    property RowLayoutController: TcxGridRowLayoutController
      read GetRowLayoutController;
  public
    constructor Create(ARecordViewInfo: TcxGridDataRowViewInfo);
      reintroduce; virtual;
    destructor Destroy; override;
    ...
    procedure Calculate(ALeftBound, ATopBound: Integer; AWidth: Integer = -1;
      AHeight: Integer = -1); override;
    function FindCellViewInfo(AItem: TcxCustomGridColumn)
      : TcxGridTableDataCellViewInfo;
    function FindLayoutItemViewInfo(AItem: TcxCustomGridColumn)
  ...
  TcxGridInplaceEditFormAreaScrollBarViewInfo = class
    (TcxCustomGridViewCellViewInfo, IcxScrollBarOwner)
  private
  ...
  public
    constructor Create(AViewInfo: TcxGridInplaceEditFormAreaViewInfo);
      reintroduce; virtual;
    destructor Destroy; override;
    ...
    property InplaceEditFormAreaViewInfo: TcxGridInplaceEditFormAreaViewInfo
      read FViewInfo;
  ...
  TcxGridInplaceEditFormAreaScrollBarViewInfoClass = class of
    TcxGridInplaceEditFormAreaScrollBarViewInfo;
  ...
  protected
    ...
    procedure CalculateScrollBarViewInfo(AScrollBarViewInfo
      : TcxGridInplaceEditFormAreaScrollBarViewInfo;
    ...
    function GetContainerOffsetFromScrollPosition(AScrollBarViewInfo
      : TcxGridInplaceEditFormAreaScrollBarViewInfo;
    ...
    function GetScrollBarClass
      : TcxGridInplaceEditFormAreaScrollBarViewInfoClass; virtual;
    function NeedRecheckHorizontalScrollVisibility: Boolean; virtual;
  public
    constructor Create(AInplaceEditFormAreaViewInfo
      : TcxGridInplaceEditFormAreaViewInfo); virtual;
    destructor Destroy; override;
    ...
    property HorizontalScrollBar: TcxGridInplaceEditFormAreaScrollBarViewInfo
      read FHorizontalScrollBar;
    property VerticalScrollBar: TcxGridInplaceEditFormAreaScrollBarViewInfo
      read FVerticalScrollBar;

    property ContainerViewInfo: TcxGridInplaceEditFormContainerViewInfo
      read GetContainerViewInfo;
    property ViewInfo: TcxGridInplaceEditFormAreaViewInfo read FViewInfo;
  end;

  TcxGridInplaceEditFormAreaScrollBarsClass = class of
    TcxGridInplaceEditFormAreaScrollBars;
  ...
  protected
    ...
    procedure GetViewParams(var AParams: TcxViewParams); override;
  public
    constructor Create(AButtonsPanelViewInfo
      : TcxGridInplaceEditFormButtonsPanelViewInfo); reintroduce; virtual;

    property ButtonsPanelViewInfo: TcxGridInplaceEditFormButtonsPanelViewInfo
      read FViewInfo;
    property GridView: TcxGridTableView read GetGridView;
    property ViewInfo: TcxGridInplaceEditFormAreaViewInfo
      read GetInplaceEditFormAreaViewInfo;
  end;

  TcxGridInplaceEditFormButtonViewInfoClass = class of
    TcxGridInplaceEditFormButtonViewInfo;

  { TcxGridInplaceEditFormCancelButtonViewInfo }

  TcxGridInplaceEditFormCancelButtonViewInfo = class
    (TcxGridInplaceEditFormButtonViewInfo)
  protected
  ...
  TcxGridInplaceEditFormUpdateButtonViewInfo = class
    (TcxGridInplaceEditFormButtonViewInfo)
  protected
    procedure Click; override;
  ...
  protected
    ...
    function AddItem(AItemClass: TcxGridInplaceEditFormButtonViewInfoClass)
      : TcxGridInplaceEditFormButtonViewInfo;
    ...
    property Items[Index: Integer]: TcxGridInplaceEditFormButtonViewInfo
      read GetItem; default;
  public
    constructor Create(AInplaceEditFormAreaViewInfo
      : TcxGridInplaceEditFormAreaViewInfo); reintroduce; virtual;
    destructor Destroy; override;
  ...
  TcxGridInplaceEditFormButtonsPanelViewInfoClass = class of
    TcxGridInplaceEditFormButtonsPanelViewInfo;
  ...
  public
    ...
    property IsRestHeightAssigned: Boolean read FIsRestHeightAssigned
      write FIsRestHeightAssigned;
  ...
  protected
    ...
    function GetBoundsForGridItem(AGridItem: TcxCustomGridTableItem)
      : TRect; virtual;
    ...
    function GetGridItemViewInfoClass
      : TcxGridTableDataCellViewInfoClass; virtual;
    function GetHitTestClass: TcxCustomGridHitTestClass; override;
    function GetButtonsPanelViewInfoClass
      : TcxGridInplaceEditFormButtonsPanelViewInfoClass; virtual;
    function GetScrollBarsClass
      : TcxGridInplaceEditFormAreaScrollBarsClass; virtual;
    function GetPainterClass: TcxCustomGridCellPainterClass; override;

    property AvailableHeight: Integer read GetAvailableHeight;
    property CacheInfo: TcxGridInplaceEditFormAreaViewInfoCacheInfo
      read FCacheInfo;
    property DataHeight: Integer read GetDataHeight;
    property DataWidth: Integer read GetDataWidth;
    property GridItemViewInfos: TcxGridRowLayoutGridItemViewInfos
      read FGridItemViewInfos;
  ...
  public
    constructor Create(AGridViewInfo: TcxCustomGridViewInfo;
      ARecordViewInfo: TcxGridDataRowViewInfo); reintroduce; virtual;
    destructor Destroy; override;
    ...
    procedure Calculate(ALeftBound, ATopBound: Integer; AWidth: Integer = -1;
      AHeight: Integer = -1); override;
    procedure DoRightToLeftConversion(const ABounds: TRect); override;
    function FindCellViewInfo(AGridItem: TcxCustomGridTableItem)
      : TcxGridTableDataCellViewInfo;
    function GetBoundsForEdit(const ADataCellBounds: TRect): TRect; virtual;
    function GetHitTest(const P: TPoint): TcxCustomGridHitTest; override;
    procedure InvalidateUpdateButtonInfo;
    procedure MakeDataCellVisible(ACellViewInfo
      : TcxGridTableViewInplaceEditFormDataCellViewInfo); virtual;
  ...
  TcxGridInplaceEditFormAreaViewInfoClass = class of
    TcxGridInplaceEditFormAreaViewInfo;
  ...
  private
    ...
    function FindCellViewInfoInTableRow(AItem: TcxCustomGridColumn)
      : TcxGridTableDataCellViewInfo;
  ...
  protected
    procedure AddAdornerTargetElementsForColumn(AList: TStrings;
      AColumn: TcxCustomGridColumn; AName: string); override;
    function AdjustToIntegralBottomBound(var ABound: Integer): Boolean;
      override;
    procedure AfterRowsViewInfoCalculate; override;
    procedure AfterRowsViewInfoOffset; override;
    procedure ApplyMergedCellsBounds(var R: TRect;
    ...
    function CalculateDataAutoHeight(ACheckEditingCell: Boolean = True)
      : Integer;
    function CalculateHeight: Integer; override;
    ...
    function GetCellsAreaViewInfoClass
      : TcxGridDataRowCellsAreaViewInfoClass; virtual;
    function GetCellViewInfoClass(AIndex: Integer)
      : TcxGridDataCellViewInfoClass; virtual;
    function GetCellWidth(AIndex: Integer): Integer; virtual;
    function GetDataWidth: Integer; override;
    function GetInplaceEditFormAreaViewInfoClass
      : TcxGridInplaceEditFormAreaViewInfoClass; virtual;
  ...
  public
    ...
    function GetHitTest(const P: TPoint): TcxCustomGridHitTest; override;
    function GetInplaceEditFormClientBounds: TRect; virtual;
    function GetLayoutBounds: TRect; virtual;
    function IsHotTracked(ACheckChildren: Boolean = True): Boolean; override;
    function IsInplaceEditFormCellPartVisible(ACellViewInfo
      : TcxGridTableDataCellViewInfo): Boolean; virtual;

    property CellsAreaBounds: TRect read GetCellsAreaBounds;
    property CellsAreaViewInfo: TcxGridDataRowCellsAreaViewInfo
      read FCellsAreaViewInfo;
    property CellViewInfoCount: Integer read GetCellViewInfoCount;
    property CellViewInfos[Index: Integer]: TcxGridDataCellViewInfo
      read GetCellViewInfo;
    property GridRecord: TcxGridDataRow read GetGridRecord;
    property HasPreview: Boolean read GetHasPreview;
    property InternalCellViewInfos[Index: Integer]: TcxGridDataCellViewInfo
      read GetInternalCellViewInfo;
    property InplaceEditFormAreaViewInfo: TcxGridInplaceEditFormAreaViewInfo
      read FInplaceEditFormAreaViewInfo;
  ...
  protected
    function GetCellViewInfoClass(AIndex: Integer)
      : TcxGridDataCellViewInfoClass; override;
  ...
  protected
    ...
    function GetTabsViewInfoClass
      : TcxCustomGridDetailsSiteTabsViewInfoClass; override;
    function GetVisible: Boolean; override;
    function GetWidth: Integer; override;
    ...
    property MasterGridViewInfo: TcxGridTableViewInfo
      read GetMasterGridViewInfo;
    property MasterDataRowViewInfo: TcxGridMasterDataRowViewInfo
      read FMasterDataRowViewInfo;
  public
    constructor Create(AMasterDataRowViewInfo: TcxGridMasterDataRowViewInfo);
      reintroduce; virtual;
    destructor Destroy; override;
    procedure ChangeActiveTab(ALevel: TcxGridLevel;
      AFocusView: Boolean = False); override;
  ...
  TcxGridExpandButtonCellViewInfoClass = class of
    TcxGridExpandButtonCellViewInfo;
  ...
  protected
    ...
    property RightBorderRestSpaceBounds: TRect
      read GetRightBorderRestSpaceBounds;
  public
    property RecordViewInfo: TcxGridMasterDataRowViewInfo
  ...
  protected
    ...
    function GetDetailsAreaViewInfoClass
      : TcxGridDetailsAreaViewInfoClass; virtual;
    function GetDetailsSiteViewInfoClass
      : TcxGridDetailsSiteViewInfoClass; virtual;
    function GetExpandButtonCellViewInfoClass
      : TcxGridExpandButtonCellViewInfoClass; virtual;

    property CacheItem: TcxGridMasterTableViewInfoCacheItem read GetCacheItem;
    property DetailsAreaViewInfo: TcxGridDetailsAreaViewInfo
      read FDetailsAreaViewInfo;
    property DetailsSiteIndentBounds: TRect read GetDetailsSiteIndentBounds;
    property ExpandButtonCellViewInfo: TcxGridExpandButtonCellViewInfo
      read FExpandButtonCellViewInfo;
  ...
  public
    ...
    property DetailsSiteViewInfo: TcxGridDetailsSiteViewInfo
      read FDetailsSiteViewInfo;
  ...
  protected
    ...
    property ImageProperties: TcxImageComboBoxProperties
      read GetImageProperties;
    property Images: TCustomImageList read GetImages;
  public
    constructor Create(AGroupCell: TcxGridGroupCellViewInfo);
      reintroduce; virtual;
  end;
  ...
  protected
    ...
    procedure GetFindTextSelectionInfo(out ASelStart: Integer;
      out AHighlightedText: string); override;
    function GetHitTestClass: TcxCustomGridHitTestClass; override;
    function GetImageBounds: TRect; virtual;
    ...
    property GroupedColumn: TcxGridColumn read GetGroupedColumn;
    property GroupedColumnAreaViewInfo: TcxGridGroupRowGroupedColumnAreaViewInfo
      read FGroupedColumnAreaViewInfo;
  ...
  public
    constructor Create(AGroupedColumnAreaViewInfo
      : TcxGridGroupRowGroupedColumnAreaViewInfo); reintroduce; virtual;
    destructor Destroy; override;
  ...
  public
    constructor Create(ARowViewInfo: TcxGridGroupRowViewInfo;
      const AText: string); reintroduce; virtual;
    property GridView: TcxGridTableView read GetGridView;
  ...
  TcxGridGroupSummaryCellViewInfoClass = class of
    TcxGridGroupSummaryCellViewInfo;
  ...
  public
    ...
    property SeparatorViewInfo: TcxGridGroupRowSpacerViewInfo
      read FSeparatorViewInfo;
  ...
  private
    ...
    function GetRecordViewInfo: TcxGridGroupRowViewInfo;
    function GetSummaryCellViewInfo(Index: Integer)
      : TcxGridGroupSummaryCellViewInfo;
  ...
  protected
    ...
    // summary
    procedure AddSummaryCellViewInfo(ASummaryItem: TcxDataSummaryItem;
    ...
    procedure CalculateSummaryCells(ACellViewInfos: TList;
      ...
      overload; virtual;
    function CalculateSummaryCellWidths(ACellViewInfos: TList;
      AAvailableWidth: Integer; AAutoWidth: Boolean)
      : TcxAutoWidthObject; virtual;
    function CreateSummaryCellViewInfo(ASummaryItem: TcxDataSummaryItem;
    ...
    function GetColumnSummaryCellsAreaBounds(AColumnHeaderViewInfo
      : TcxGridColumnHeaderViewInfo): TRect; virtual;
    procedure PopulateColumnSummaryCellViewInfos(AList: TList;
      AColumn: TcxGridColumn); virtual;
    function GetSummaryCellAutoWidth: Boolean; virtual;
    function GetSummaryCellsAreaBounds(AForAlignableCells: Boolean)
      : TRect; virtual;
    function GetSummaryCellsBounds(const AAreaBounds: TRect;
      AWidths: TcxAutoWidthObject; AAlignment: TAlignment; AAutoWidth: Boolean)
      : TRect; virtual;
    function GetSummaryCellViewInfoClass
      : TcxGridGroupSummaryCellViewInfoClass; virtual;
    ...
    function CreateSpacerViewInfo(const AText: string)
      : TcxGridGroupRowSpacerViewInfo;
    ...
    function GetSeparatorBounds: TRect; virtual;
    function GetSeparatorText: string; virtual;
    function GetSpacerViewInfoClass
      : TcxGridGroupRowSpacerViewInfoClass; virtual;
    ...
    property SeparatorViewInfo: TcxGridGroupRowSpacerViewInfo
      read FSeparatorViewInfo;
    property SummaryBeginningSpacerViewInfo: TcxGridGroupRowSpacerViewInfo
      read FSummaryBeginningSpacerViewInfo;
    ...
    property SummaryEndingSpacerViewInfo: TcxGridGroupRowSpacerViewInfo
      read FSummaryEndingSpacerViewInfo;
  ...
  public
    ...
    property SummaryCellViewInfos[Index: Integer]
      : TcxGridGroupSummaryCellViewInfo read GetSummaryCellViewInfo;
  end;
  ...
  private
    ...
    function GetGroupedColumnAreaViewInfo(AIndex: Integer)
      : TcxGridGroupRowGroupedColumnAreaViewInfo;
    function GetMainGroupedColumnAreaViewInfo
      : TcxGridGroupRowGroupedColumnAreaViewInfo;
    function GetRowStyle: TcxGridGroupRowStyle;
    function GetSummaryCellLayout: TcxGridGroupSummaryLayout;
  protected
    procedure AddGroupedColumnAreaViewInfo(AGroupedColumnIndex
      : Integer); virtual;
    procedure CalculateBottomBorderLeftPosition; virtual;
    procedure CalculateExpandButtonBounds(var ABounds: TRect); override;
    procedure CalculateGroupedColumnAreaViewInfo(ALeftBound,
      ATopBound: Integer); virtual;
    function CalculateHeight: Integer; override;
    function CanSize: Boolean; override;
    procedure CheckRowHeight(var AValue: Integer); override;
    function CreateGroupedColumnAreaViewInfo(AGroupedColumnIndex: Integer)
      : TcxGridGroupRowGroupedColumnAreaViewInfo; virtual;
    ...
    property FixedGroupIndicatorBounds: TRect
      read GetRealFixedGroupIndicatorBounds;
    property GroupedColumnAreaViewInfoCount: Integer
      read GetGroupedColumnAreaViewInfoCount;
    property GroupedColumnAreaViewInfos[AIndex: Integer]
      : TcxGridGroupRowGroupedColumnAreaViewInfo
      read GetGroupedColumnAreaViewInfo;
    property MainGroupedColumnAreaViewInfo
      : TcxGridGroupRowGroupedColumnAreaViewInfo
      read GetMainGroupedColumnAreaViewInfo;
    property RowStyle: TcxGridGroupRowStyle read GetRowStyle;
    property SummaryCellLayout: TcxGridGroupSummaryLayout
      read GetSummaryCellLayout;
  public
    constructor Create(ARecordsViewInfo: TcxCustomGridRecordsViewInfo;
      ARecord: TcxCustomGridRecord); override;
    destructor Destroy; override;
...
uses
  ...
  dxLayoutContainer, dxLayoutLookAndFeels, cxFilter, cxFilterControl,
...
class function TcxGridInplaceEditFormCancelButtonHitTest.GetHitTestCode
  : Integer;
begin
...
class function TcxGridInplaceEditFormUpdateButtonHitTest.GetHitTestCode
  : Integer;
begin
...
class function TcxGridInplaceEditFormButtonsPanelHitTest.GetHitTestCode
  : Integer;
begin
...
function TcxGridDataCellCheckBoxAreaPainter.GetViewInfo
  : TcxGridDataCellCheckBoxAreaViewInfo;
begin
...
begin
  Result := not ExcludeFromClipRect and
    ViewInfo.RecordViewInfo.CanDelayedDrawDataCellBorders;
end;

procedure TcxGridDataCellPainter.DrawBorder(ABorder: TcxBorder);
begin
  if CanDelayedDrawBorder then
    TcxGridTablePainter(ViewInfo.GridViewInfo.Painter)
      .AddGridLine(ViewInfo.BorderBounds[ABorder])
  else
...
begin
  Result := (ViewInfo.RecordViewInfo.CellsAreaViewInfo <> nil) and
...
begin
  ...
  if NeedDrawButton then
    ViewInfo.LookAndFeelPainter.DrawScaledButton(Canvas, ViewInfo.ButtonBounds,
      ViewInfo.Text, ViewInfo.ButtonState, ScaleFactor);
  TcxFilterControlImagesHelper.DrawOperatorImage(Canvas.Canvas,
    ViewInfo.FilterOperator, ViewInfo.ImageBounds, ViewInfo.LookAndFeelPainter,
    TdxAlphaColors.FromColor(ViewInfo.LookAndFeelPainter.
...
function TcxGridFilterRowOperatorPainter.GetViewInfo
  : TcxGridFilterRowOperatorViewInfo;
begin
...
procedure TcxGridRowLayoutPainter.DrawBackground(const R: TRect);
const
  ABorderWidth = 1;
begin
  if ViewInfo.NeedDrawSelection then
  ...
  begin
    ...
    try
      ...
      ViewInfo.LookAndFeelPainter.LayoutViewDrawRecordContent(Canvas,
        cxRectInflate(R, ABorderWidth), cxgpCenter, cxbsNormal);
    finally
...
function TcxGridInplaceEditFormButtonPainter.GetGridViewInfo
...
function TcxGridInplaceEditFormButtonPainter.GetViewInfo
  : TcxGridInplaceEditFormButtonViewInfo;
begin
...
begin
  ViewInfo.LookAndFeelPainter.DrawSeparator(Canvas,
    ViewInfo.GetSeparatorBound, False);
end;

function TcxGridInplaceEditFormButtonsPanelPainter.GetViewInfo
  : TcxGridInplaceEditFormButtonsPanelViewInfo;
begin
...
function TcxGridInplaceEditFormAreaPainter.GetViewInfo
  : TcxGridInplaceEditFormAreaViewInfo;
begin
...
begin
  ViewInfo.LookAndFeelPainter.DrawFilterRowSeparator(Canvas,
    ViewInfo.GetFixedRowsSeparatorBounds,
...
begin
  ViewInfo.LookAndFeelPainter.DrawFilterRowSeparator(Canvas,
    ViewInfo.SeparatorBounds, ViewInfo.SeparatorColor);
end;
...
function TcxGridMasterDataRowDetailsSiteTabsPainter.GetViewInfo
  : TcxGridMasterDataRowDetailsSiteLeftTabsViewInfo;
begin
...
function TcxGridExpandButtonCellPainter.GetViewInfo
  : TcxGridExpandButtonCellViewInfo;
begin
...
begin
  ...
  ViewInfo.GridViewInfo.Painter.ExcludeFromBackground
    (ViewInfo.DetailsSiteViewInfo.Bounds);
end;
...
begin
  Result := inherited NeedsPainting or ViewInfo.DetailsSiteVisible and
    Canvas.RectVisible(ViewInfo.DetailsAreaViewInfo.GetAreaBoundsForPainting);
end;
...
begin
  cxDrawImage(Canvas, ViewInfo.GetImageBounds, nil, ViewInfo.Images,
    ViewInfo.ImageIndex, ifmNormal);
end;

function TcxGridGroupCellImagePainter.GetViewInfo
...
function TcxGridGroupSummaryCellPainter.GetViewInfo
  : TcxGridGroupSummaryCellViewInfo;
begin
...
function TcxGridGroupRowGroupedColumnAreaPainter.GetViewInfo
  : TcxGridGroupRowGroupedColumnAreaViewInfo;
begin
...
begin
  ViewInfo.LookAndFeelPainter.DrawScaledFixedGroupIndicator(Canvas,
    ViewInfo.FixedGroupIndicatorBounds, ScaleFactor);
end;
...
constructor TcxGridDataCellPinViewInfo.Create(ACellViewInfo
  : TcxGridDataCellViewInfo);
begin
...
function TcxGridDataCellPinViewInfo.MouseDown(AHitTest: TcxCustomGridHitTest;
  AButton: TMouseButton; AShift: TShiftState): Boolean;

  function FindSelf(AGridView: TcxGridTableView; ARowIndex: Integer;
    AColumn: TcxGridColumn): TcxGridDataCellPinViewInfo;
  var
...
begin
  Result := Pinned or GridView.OptionsCustomize.DataRowFixing and
    (Options.PinClickAction <> rpcaNone) and
    ((ButtonState in [cxbsPressed, cxbsHot]) or
    (Options.PinVisibility = rpvAlways) or
    (Options.PinVisibility = rpvRowHotTrack) and RowViewInfo.IsHotTracked);
end;

function TcxGridDataCellPinViewInfo.CanToggle: Boolean;
begin
  Result := GridView.OptionsCustomize.DataRowFixing and
    (Options.PinClickAction <> rpcaNone);
end;
...
constructor TcxGridDataCellCheckBoxAreaViewInfo.Create(ACellViewInfo
  : TcxGridDataCellViewInfo);
begin
...
procedure TcxGridDataCellCheckBoxAreaViewInfo.Calculate(ALeftBound, ATopBound,
...
function TcxGridDataCellCheckBoxAreaViewInfo.GetHitTest(const P: TPoint)
...
function TcxGridDataCellCheckBoxAreaViewInfo.CreateCheckBox
  : TcxGridRowCheckBoxViewInfo;
begin
  Result := TcxGridRowCheckBoxViewInfo.Create(DataCell.RecordViewInfo);
end;

procedure TcxGridDataCellCheckBoxAreaViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
...
begin
  ...
  Result := cxRectSetLeft(Result, Result.Left + GetMargins.Left,
    CheckBox.Width);
...
function TcxGridDataCellCheckBoxAreaViewInfo.GetHitTestClass
...
begin
  Result := ScaleFactor.Apply(Rect(cxGridDataCellCheckBoxLeftMargin, 0,
    cxGridDataCellCheckBoxRightMargin, 0));
end;

function TcxGridDataCellCheckBoxAreaViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridDataCellCheckBoxAreaPainter;
end;

procedure TcxGridDataCellCheckBoxAreaViewInfo.GetViewParams
...
function TcxGridDataCellCheckBoxAreaViewInfo.IsHotTracked(ACheckChildren
...
constructor TcxGridDataCellViewInfo.Create(ARecordViewInfo
...
begin
  ...
  else if FIsMerged and (FMergingCell <> nil) then
...
function TcxGridDataCellViewInfo.GetMergedCell(Index: Integer)
  : TcxGridDataCellViewInfo;
begin
...
function TcxGridDataCellViewInfo.GetMergedCellOfFocusedRow
  : TcxGridDataCellViewInfo;
var
  I: Integer;
begin
  ...
  begin
    ...
    if Result.RecordViewInfo.Focused then
      Exit;
  end;
  Result := nil;
end;
...
var
  ...
  begin
    ...
    else if Height <> FOriginalHeight then
    begin
...
begin
  ...
  if not CanCellMerging or GridViewInfo.IsInternalUse then
    Exit;
  AProperties := Properties;
  AValue := DisplayValue;
  for I := RecordViewInfo.Index + 1 to RecordViewInfo.RecordsViewInfo.
    Count - 1 do
  begin
    ARowViewInfo := RecordViewInfo.RecordsViewInfo[I];
    if ARowViewInfo is TcxGridDataRowViewInfo then
    begin
      ACellViewInfo := TcxGridDataRowViewInfo(ARowViewInfo)
        .InternalCellViewInfos[Item.VisibleIndex];
      if Item.DoCompareValuesForCellMerging(RecordViewInfo.GridRecord,
        AProperties, AValue, TcxGridDataRowViewInfo(ARowViewInfo).GridRecord,
        ACellViewInfo.Properties, ACellViewInfo.DisplayValue) then
      begin
        ...
        if not ACellViewInfo.CanBeMergingCell then
          Break;
      end
      else
        Break;
...
begin
  Result := inherited CanDrawSelected and
    ((RecordViewInfo.InplaceEditFormAreaViewInfo = nil) or
    GridView.OptionsSelection.InvertSelect) and
    ((RecordViewInfo.LayoutViewInfo = nil) or
    GridView.OptionsSelection.InvertSelect and
    not GridView.RowLayout.ItemHotTrack);
end;

function TcxGridDataCellViewInfo.GetAlwaysSelected: Boolean;
begin
  if (RecordViewInfo.InplaceEditFormAreaViewInfo <> nil) and
    GridView.OptionsSelection.InvertSelect then
    Result := True
  else
...
begin
  Result := inherited HasFocusRect or
    (TcxGridTableViewAccess.IsMultiSelectPersistent(GridView) and
...
procedure TcxGridDataCellViewInfo.RemoveMergedCell(ACellViewInfo
  : TcxGridDataCellViewInfo);
begin
...
begin
  Result := (GridView.OptionsBehavior.EditMode = emInplace) or
    GridRecord.IsNewItemRecord;
end;
...
begin
  inherited DoRightToLeftConversion(ABounds);
  OriginalBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (OriginalBounds, ABounds);
  if HasCheckBox then
...
function TcxGridDataCellViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  AHitTest: TcxCustomGridHitTest;
begin
...
function TcxGridDataCellViewInfo.IsHotTracked(ACheckChildren
  : Boolean = True): Boolean;
begin
  Result := inherited IsHotTracked or ACheckChildren and
    (HasCheckBox and CheckBoxArea.IsHotTracked or HasPin and Pin.IsHotTracked);
end;
...
constructor TcxGridFilterRowOperatorViewInfo.Create(ACellViewInfo
  : TcxGridFilterRowCellViewInfo);
begin
...
function TcxGridFilterRowOperatorViewInfo.MouseDown
...
begin
  Result := Min(ImageSize.cx + 2 * ScaleFactor.Apply
    (cxFilterRowOperatorButtonImageIndent), CellViewInfo.Width);
end;
...
function TcxGridFilterRowOperatorViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridFilterRowOperatorViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridFilterRowOperatorPainter;
end;

procedure TcxGridFilterRowOperatorViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
  CellViewInfo.GetViewParams(AParams);
end;
...
constructor TcxGridFilterRowCellViewInfo.Create(ARecordViewInfo
  : TcxCustomGridRecordViewInfo; AItem: TcxCustomGridTableItem);
begin
  inherited Create(ARecordViewInfo, AItem);
...
procedure TcxGridFilterRowCellViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
  if HasOperatorViewInfo then
...
function TcxGridFilterRowCellViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  AHitTest: TcxCustomGridHitTest;
begin
...
function TcxGridFilterRowCellViewInfo.GetOperatorViewInfoClass
  : TcxGridFilterRowOperatorViewInfoClass;
begin
...
function TcxGridFilterRowCellViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  Result := RecordViewInfo.OperatorCustomization and
    TcxCustomGridTableItemAccess.CanFilter(Item, False);
end;
...
function TcxGridFilterRowCellViewInfo.GetRecordViewInfo
  : TcxGridFilterRowViewInfo;
begin
  Result := TcxGridFilterRowViewInfo(inherited RecordViewInfo);
end;

function TcxGridFilterRowCellViewInfo.GetSupportedOperators
...
procedure TcxGridFilterRowCellViewInfo.SetOperator
  (AValue: TcxFilterControlOperator);
begin
...
procedure TcxGridFilterRowCellViewInfo.OperatorMenuSelectHandler
  (Sender: TObject; AItem: TdxCustomListBoxItem; ASelectedViaKeyboard: Boolean);
begin
...
constructor TcxGridDataRowCellsAreaViewInfo.Create(ARecordViewInfo
...
function TcxGridDataRowCellsAreaViewInfo.GetRecordViewInfo
  : TcxGridDataRowViewInfo;
begin
  Result := TcxGridDataRowViewInfo(inherited RecordViewInfo);
end;
...
begin
  Result := not RecordViewInfo.HasPreview or (GridView.Preview.Place = ppTop) or
...
begin
  Result := GridViewInfo.GetCellBorders(True, (Preview.Place = ppBottom) or
    (RecordViewInfo.CellViewInfoCount = 0));
end;

procedure TcxGridPreviewCellViewInfo.GetEditViewDataContentOffsets
  (var R: TRect);
begin
  inherited;
  R.Left := Preview.LeftIndent - (ScaleFactor.Apply(cxGridCellTextOffset) -
    cxGridEditOffset);
  R.Right := Preview.RightIndent - (ScaleFactor.Apply(cxGridCellTextOffset) -
    cxGridEditOffset);
end;
...
constructor TcxGridRowLayoutViewInfo.Create(ARecordViewInfo
  : TcxGridDataRowViewInfo);
begin
...
procedure TcxGridRowLayoutViewInfo.Calculate(ALeftBound, ATopBound: Integer;
  AWidth: Integer = -1; AHeight: Integer = -1);
var
...
function TcxGridRowLayoutViewInfo.FindCellViewInfo(AItem: TcxCustomGridColumn)
  : TcxGridTableDataCellViewInfo;
begin
  Result := ItemViewInfos.FindCellViewInfo(AItem);
end;

function TcxGridRowLayoutViewInfo.FindLayoutItemViewInfo
  (AItem: TcxCustomGridColumn): TcxGridRowLayoutItemViewInfo;
begin
  Result := TcxGridRowLayoutItemViewInfo
    (ContainerViewInfo.ItemsViewInfo.FindItemViewInfo(AItem.RowLayoutItem));
end;

function TcxGridRowLayoutViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
  if PtInItems(P) then
...
begin
  Result := RecordViewInfo.Width - GridViewInfo.VisualLevelCount *
    GridViewInfo.LevelIndent;
end;

function TcxGridRowLayoutViewInfo.CreateContainerViewInfo
  : TcxGridTableRowLayoutContainerViewInfo;
begin
  Result := TcxGridTableRowLayoutContainerViewInfo.Create
    (RowLayoutController.Container, RecordViewInfo);
end;

function TcxGridRowLayoutViewInfo.CreateItemViewInfos
...
function TcxGridRowLayoutViewInfo.GetItemViewInfoClass
  : TcxGridTableDataCellViewInfoClass;
begin
  Result := TcxGridTableRowLayoutDataCellViewInfo;
end;

function TcxGridRowLayoutViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridRowLayoutPainter;
end;

procedure TcxGridRowLayoutViewInfo.GetViewParams(var AParams: TcxViewParams);
begin
  GridView.Styles.GetDataCellParams(RecordViewInfo.GridRecord, nil, AParams);
end;
...
function TcxGridRowLayoutViewInfo.NeedDrawSelection: Boolean;
begin
  Result := RecordViewInfo.GridRecord.Selected and
    GridView.OptionsSelection.InvertSelect and
    not GridView.RowLayout.ItemHotTrack;
end;
...
begin
  inherited Offset(DX, DY);
  ContainerViewInfo.Offset := cxPointOffset(ContainerViewInfo.Offset,
    IfThen(UseRightToLeftAlignment, -DX, DX), DY);
end;
...
begin
  ...
  begin
    if not(RowLayoutController.Container.AbsoluteItems[I]
      is TcxGridTableRowLayoutItem) or
      (RowLayoutController.Container.AbsoluteItems[I].Parent = nil) then
      Continue;
    AGridViewItem := TcxGridTableRowLayoutItem
      (RowLayoutController.Container.AbsoluteItems[I]).GridViewItem;
    AGridItemViewInfo := GetItemViewInfoClass.Create(RecordViewInfo,
      AGridViewItem);
    FItemViewInfos.Add(AGridItemViewInfo);
  end;
end;

function TcxGridRowLayoutViewInfo.PtInItems(const APoint: TPoint): Boolean;
begin
  Result := PtInRect(Bounds, APoint) and
    PtInRect(ContainerViewInfo.ContentBounds, APoint);
end;
...
function TcxGridRowLayoutViewInfo.GetRowLayoutController
...
procedure TcxGridInplaceEditFormAreaScrollBarViewInfo.Calculate(ALeftBound,
...
procedure TcxGridInplaceEditFormAreaScrollBarViewInfo.SetScrollParams(AMin,
  AMax, APosition, APageSize: Integer; ARedraw: Boolean = True);
begin
...
function TcxGridInplaceEditFormAreaScrollBarViewInfo.
  CaptureMouseOnPress: Boolean;
begin
  Result := True;
end;
...
procedure TcxGridInplaceEditFormAreaScrollBarViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
  FScrollBar.BoundsRect := Bounds;
...
procedure TcxGridInplaceEditFormAreaScrollBarViewInfo.DoScroll(Sender: TObject;
...
procedure TcxGridInplaceEditFormAreaScrollBarViewInfo.SetKind
  (Value: TScrollBarKind);
var
  ASize: TSize;
begin
...
procedure TcxGridInplaceEditFormAreaScrollBarViewInfo.SetPageSize
  (Value: Integer);
begin
  ScrollBar.PageSize := Value;
end;

procedure TcxGridInplaceEditFormAreaScrollBarViewInfo.SetPosition
  (Value: Integer);
begin
  ScrollBar.Position := Value;
end;

function TcxGridInplaceEditFormAreaScrollBarViewInfo.GetScrollBarOwner
  : TWinControl;
begin
  Result := Control;
end;

function TcxGridInplaceEditFormAreaScrollBarViewInfo.GetLookAndFeel
  : TcxLookAndFeel;
begin
...
constructor TcxGridInplaceEditFormAreaScrollBars.Create
...
begin
  Result := Point(0, 0);
  Result.X := GetContainerOffsetFromScrollPosition(HorizontalScrollBar,
    sbHorizontal);
  Result.Y := GetContainerOffsetFromScrollPosition(VerticalScrollBar,
    sbVertical);
end;

function TcxGridInplaceEditFormAreaScrollBars.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
  Result := nil;
end;
...
begin
  ...
  begin
    ...
    CalculateScrollBarViewInfo(HorizontalScrollBar, ViewInfo.Width,
      ABounds.Left, ATop);
  end;
...
procedure TcxGridInplaceEditFormAreaScrollBars.CalculateScrollBarViewInfo
  (AScrollBarViewInfo: TcxGridInplaceEditFormAreaScrollBarViewInfo;
  ASize, ALeft, ATop: Integer);
var
...
begin
  ...
  begin
    ...
    APageSize := Round(ASize * ViewInfo.DataWidth /
      ContainerViewInfo.ContentWidth);
  end
  else
  begin
    AScrollBarViewInfo.Height := ASize;
    APageSize := Round(ASize * ViewInfo.DataHeight /
      ContainerViewInfo.ContentHeight);
  end;
...
begin
  ...
  begin
    ABounds := ViewInfo.Bounds;
    if ViewInfo.Control.UseRightToLeftScrollBar and not ViewInfo.Control.UseRightToLeftAlignment
    then
      ALeft := ABounds.Left
    else
      ALeft := ABounds.Right - VerticalScrollBar.Width;
    ATop := ABounds.Top;
    CalculateScrollBarViewInfo(VerticalScrollBar, ViewInfo.DataHeight,
      ALeft, ATop);
  end;
...
begin
  if HorizontalScrollBar.Visible then
    HorizontalScrollBar.Position :=
      Round((ViewInfo.Bounds.Left - ContainerViewInfo.Offset.X) *
      (HorizontalScrollBar.Max - HorizontalScrollBar.Min -
      HorizontalScrollBar.PageSize) / (ContainerViewInfo.ContentWidth -
      ViewInfo.DataWidth))
end;

procedure TcxGridInplaceEditFormAreaScrollBars.CheckHorizontalScrollVisibility;
begin
  HorizontalScrollBar.Visible := ContainerViewInfo.ContentWidth >
    ViewInfo.DataWidth;
end;
...
begin
  if VerticalScrollBar.Visible then
    VerticalScrollBar.Position :=
      Round((ViewInfo.Bounds.Top - ContainerViewInfo.Offset.Y) *
      (VerticalScrollBar.Max - VerticalScrollBar.Min -
      VerticalScrollBar.PageSize) / (ContainerViewInfo.ContentHeight -
      ViewInfo.DataHeight))
end;

procedure TcxGridInplaceEditFormAreaScrollBars.CheckVertiacalScrollVisibility;
begin
  VerticalScrollBar.Visible := ContainerViewInfo.ContentHeight >
    ViewInfo.DataHeight;
end;
...
function TcxGridInplaceEditFormAreaScrollBars.
  GetContainerOffsetFromScrollPosition(AScrollBarViewInfo
  : TcxGridInplaceEditFormAreaScrollBarViewInfo; AKind: TScrollBarKind)
  : Integer;
var
...
begin
  ...
  begin
    if (AScrollBarViewInfo.Max - AScrollBarViewInfo.Min -
      AScrollBarViewInfo.PageSize) <= 0 then
      Result := 0
    else
    begin
      if AKind = sbHorizontal then
      ...
      Result := AStartPosition - Round(AScrollBarViewInfo.Position * ADelta /
        (AScrollBarViewInfo.Max - AScrollBarViewInfo.Min -
        AScrollBarViewInfo.PageSize))
    end;
  end;
end;

function TcxGridInplaceEditFormAreaScrollBars.
  GetHorizontalScrollBarHeight: Integer;
begin
  if HorizontalScrollBar.Visible then
...
function TcxGridInplaceEditFormAreaScrollBars.GetVerticalScrollBarWidth
  : Integer;
begin
  if VerticalScrollBar.Visible then
...
function TcxGridInplaceEditFormAreaScrollBars.GetScrollBarClass
  : TcxGridInplaceEditFormAreaScrollBarViewInfoClass;
begin
  Result := TcxGridInplaceEditFormAreaScrollBarViewInfo;
end;

function TcxGridInplaceEditFormAreaScrollBars.
  NeedRecheckHorizontalScrollVisibility: Boolean;
begin
...
procedure TcxGridInplaceEditFormAreaScrollBars.RightToLeftConversion
  (const ABounds: TRect);
begin
  if HorizontalScrollBar.Visible then
...
function TcxGridInplaceEditFormAreaScrollBars.GetContainerViewInfo
...
constructor TcxGridInplaceEditFormButtonViewInfo.Create(AButtonsPanelViewInfo
  : TcxGridInplaceEditFormButtonsPanelViewInfo);
begin
...
begin
  Result := TextHeightWithOffset + 2 * LookAndFeelPainter.ScaledButtonTextOffset
    (ScaleFactor);
  Result := Max(Result,
    ScaleFactor.Apply(cxGridInplaceEditFormButtonMinHeight));
end;

function TcxGridInplaceEditFormButtonViewInfo.DoCalculateWidth: Integer;
begin
  Result := TextWidthWithOffset + 2 * LookAndFeelPainter.ScaledButtonTextOffset
    (ScaleFactor);
  Result := Max(Result, ScaleFactor.Apply(cxGridInplaceEditFormButtonMinWidth));
end;

function TcxGridInplaceEditFormButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
  Result := TcxGridInplaceEditFormButtonHitTest;
end;

function TcxGridInplaceEditFormButtonViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridInplaceEditFormButtonPainter;
end;

procedure TcxGridInplaceEditFormButtonViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
function TcxGridInplaceEditFormButtonViewInfo.GetInplaceEditFormAreaViewInfo
  : TcxGridInplaceEditFormAreaViewInfo;
begin
...
function TcxGridInplaceEditFormCancelButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
begin
  Result := (ViewInfo.FocusedItemKind = fikCancelButton) and
...
begin
  Result := (ViewInfo.FocusedItemKind = fikUpdateButton) and
    GridView.IsControlFocused;
end;

function TcxGridInplaceEditFormUpdateButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
constructor TcxGridInplaceEditFormButtonsPanelViewInfo.Create
  (AInplaceEditFormAreaViewInfo: TcxGridInplaceEditFormAreaViewInfo);
begin
...
procedure TcxGridInplaceEditFormButtonsPanelViewInfo.Calculate(ALeftBound,
  ATopBound: Integer; AWidth: Integer = -1; AHeight: Integer = -1);
begin
  inherited Calculate(ALeftBound, ATopBound, AWidth, AHeight);
  CalculateButtons;
...
function TcxGridInplaceEditFormButtonsPanelViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  AHitTest: TcxCustomGridHitTest;
  I: Integer;
...
function TcxGridInplaceEditFormButtonsPanelViewInfo.AddItem
  (AItemClass: TcxGridInplaceEditFormButtonViewInfoClass)
  : TcxGridInplaceEditFormButtonViewInfo;
begin
...
function TcxGridInplaceEditFormButtonsPanelViewInfo.
  GetButtonRightIndent: Integer;
var
...
begin
  ...
  Result := AContainerRootOffset.RootItemsAreaOffsetHorz +
    AContainerRootOffset.ItemOffset;
end;
...
begin
  ...
  begin
    ...
    ATop := Bounds.Top + cxGridInplaceEditFormButtonsTopOffset +
      GetSeparatorHeight;
...
function TcxGridInplaceEditFormButtonsPanelViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
  Result := TcxGridInplaceEditFormButtonsPanelHitTest;
end;

function TcxGridInplaceEditFormButtonsPanelViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
procedure TcxGridInplaceEditFormButtonsPanelViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
  GridView.Styles.GetViewParams(0, nil, nil, AParams);
end;
...
procedure TcxGridInplaceEditFormButtonsPanelViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
...
function TcxGridInplaceEditFormButtonsPanelViewInfo.GetGridView
  : TcxGridTableView;
begin
  Result := TcxGridTableView(inherited GridView);
end;

function TcxGridInplaceEditFormButtonsPanelViewInfo.GetForm
  : TcxGridTableViewInplaceEditForm;
begin
  Result := ViewInfo.InplaceEditForm;
end;

function TcxGridInplaceEditFormButtonsPanelViewInfo.GetItem(Index: Integer)
  : TcxGridInplaceEditFormButtonViewInfo;
begin
...
procedure TcxGridInplaceEditFormButtonsPanelViewInfo.SetButtonsWidth
  (AValue: Integer);
var
  I: Integer;
begin
...
constructor TcxGridInplaceEditFormAreaViewInfo.Create(AGridViewInfo
  : TcxCustomGridViewInfo; ARecordViewInfo: TcxGridDataRowViewInfo);
begin
...
procedure TcxGridInplaceEditFormAreaViewInfo.Calculate(ALeftBound,
  ATopBound: Integer; AWidth: Integer = -1; AHeight: Integer = -1);
var
...
begin
  ...
  if GridViewInfo.IsRightToLeftConverted then
  begin
    ADelta := RecordViewInfo.RecordsViewInfo.ContentBounds.Left -
      GridViewInfo.Bounds.Left;
    if ADelta > 0 then
      Dec(AOffsetX, Min(TcxGridViewAccess(GridView)
        .GetVerticalScrollBarAreaWidth, ADelta));
...
procedure TcxGridInplaceEditFormAreaViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
...
function TcxGridInplaceEditFormAreaViewInfo.GetBoundsForEdit
  (const ADataCellBounds: TRect): TRect;
begin
...
function TcxGridInplaceEditFormAreaViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  AHitTest: TcxCustomGridHitTest;
begin
...
procedure TcxGridInplaceEditFormAreaViewInfo.MakeDataCellVisible
  ...
  begin
    ...
    else if ALayoutItemBounds.Right > (Bounds.Left + DataWidth) then
  ...
  begin
    ...
    else if ALayoutItemBounds.Bottom > (Bounds.Top + DataHeight) then
...
procedure TcxGridInplaceEditFormAreaViewInfo.MakeItemVisible
  (AItem: TcxCustomGridTableItem);
var
...
begin
  ...
  if ADataCell <> nil then
    MakeDataCellVisible(TcxGridTableViewInplaceEditFormDataCellViewInfo
      (ADataCell));
end;

function TcxGridInplaceEditFormAreaViewInfo.MouseDown
  (AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
  AShift: TShiftState): Boolean;
begin
  Result := inherited MouseDown(AHitTest, AButton, AShift);
  if IsPointInLayoutContainer(AHitTest.Pos) then
    ContainerViewInfo.MouseDown(AButton, AShift, AHitTest.Pos.X,
      AHitTest.Pos.Y);
end;

function TcxGridInplaceEditFormAreaViewInfo.MouseMove
...
function TcxGridInplaceEditFormAreaViewInfo.MouseUp
  (AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
  AShift: TShiftState): Boolean;
begin
...
function TcxGridInplaceEditFormAreaViewInfo.CalculateWidth: Integer;
  ...
  begin
    if GridViewInfo.IsRightToLeftConverted then
      Result := RecordViewInfo.RecordsViewInfo.ContentBounds.Left -
        GridViewInfo.Bounds.Left
    else
      Result := GridViewInfo.Bounds.Right -
        RecordViewInfo.RecordsViewInfo.ContentBounds.Right;
    Result := Max(Result, 0);
  end;

begin
  if GridViewInfo.IsRightToLeftConverted then
    Result := Min(RecordViewInfo.RecordsViewInfo.ContentBounds.Right -
      RecordViewInfo.DataRelativeIndent, GridViewInfo.Bounds.Right -
      GridViewInfo.IndicatorViewInfo.Width) - GridViewInfo.ClientBounds.Left
  else
    Result := GridViewInfo.ClientBounds.Right -
      RecordViewInfo.GetInplaceEditFormLeftPosition;
  Dec(Result, Min(TcxGridViewAccess(GridView).GetVerticalScrollBarAreaWidth,
    GetEmptySpaceWidth));
  Result := Max(Result, 0);
end;
...
function TcxGridInplaceEditFormAreaViewInfo.FocusedItemKind
  : TcxGridFocusedItemKind;
begin
...
function TcxGridInplaceEditFormAreaViewInfo.GetBoundsForGridItem
  (AGridItem: TcxCustomGridTableItem): TRect;
var
...
begin
  ...
  if ScrollBars.HorizontalScrollBar.Visible and not TcxControlAccess(Control).IsPopupScrollBars
  then
    AHScrollBarHeight := GetHorizontalScrollBarHeight
  else
    AHScrollBarHeight := 0;
  ARequiredHeight := AContentHeight + ButtonsPanelViewInfo.Height +
    AHScrollBarHeight;
...
begin
  Result := Width;
  AVScrollBarWidth := 0;
  if ScrollBars.VerticalScrollBar.Visible and not TcxControlAccess(Control).IsPopupScrollBars
  then
...
function TcxGridInplaceEditFormAreaViewInfo.GetGridItemHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
...
function TcxGridInplaceEditFormAreaViewInfo.
  GetInplaceEditFormClientBounds: TRect;
begin
  Result := Rect(Bounds.Left, Bounds.Top, Bounds.Left + DataWidth,
    Bounds.Top + DataHeight);
end;

procedure TcxGridInplaceEditFormAreaViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
function TcxGridInplaceEditFormAreaViewInfo.IsPointInLayoutContainer
...
begin
  ...
  ABottom := Min(Bounds.Top + DataHeight,
    ContainerViewInfo.ContentBounds.Bottom);
...
function TcxGridInplaceEditFormAreaViewInfo.GetGridItemViewInfoClass
  : TcxGridTableDataCellViewInfoClass;
begin
  Result := TcxGridTableViewInplaceEditFormDataCellViewInfo;
end;

function TcxGridInplaceEditFormAreaViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
  Result := TcxGridInplaceEditFormAreaHitTest;
end;

function TcxGridInplaceEditFormAreaViewInfo.GetButtonsPanelViewInfoClass
  : TcxGridInplaceEditFormButtonsPanelViewInfoClass;
begin
  Result := TcxGridInplaceEditFormButtonsPanelViewInfo;
end;

function TcxGridInplaceEditFormAreaViewInfo.GetScrollBarsClass
  : TcxGridInplaceEditFormAreaScrollBarsClass;
begin
  Result := TcxGridInplaceEditFormAreaScrollBars;
end;

function TcxGridInplaceEditFormAreaViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  ...
  begin
    if not(InplaceEditForm.Container.AbsoluteItems[I]
      is TcxGridInplaceEditFormLayoutItem) or
      (InplaceEditForm.Container.AbsoluteItems[I].Parent = nil) then
      Continue;
    AGridViewItem := TcxGridInplaceEditFormLayoutItem
      (InplaceEditForm.Container.AbsoluteItems[I]).GridViewItem;
    AGridItemViewInfo := GetGridItemViewInfoClass.Create(RecordViewInfo,
      AGridViewItem);
...
function TcxGridInplaceEditFormAreaViewInfo.GetContainerViewInfo
  : TcxGridInplaceEditFormContainerViewInfo;
begin
...
function TcxGridInplaceEditFormAreaViewInfo.GetGridViewInfo
  : TcxGridTableViewInfo;
begin
  Result := TcxGridTableViewInfo(inherited GridViewInfo);
end;

function TcxGridInplaceEditFormAreaViewInfo.GetInplaceEditForm
  : TcxGridTableViewInplaceEditForm;
begin
...
begin
  Result := (ScrollBars <> nil) and
    (ScrollBars.HorizontalScrollBar.ScrollBar.Visible or
...
function TcxGridInplaceEditFormAreaViewInfo.GetManager
...
constructor TcxGridDataRowViewInfo.Create(ARecordsViewInfo
...
function TcxGridDataRowViewInfo.FindCellViewInfoInTableRow
  (AItem: TcxCustomGridColumn): TcxGridTableDataCellViewInfo;
begin
  if AItem.VisibleIndex = -1 then
    Result := nil
  else if GridView.IsControlLocked and
    not(GridViewInfo.IsCalculating or GridView.InDataControlFocusing) then
    Result := nil
  else
    Result := InternalCellViewInfos[AItem.VisibleIndex];
end;

function TcxGridDataRowViewInfo.GetCellViewInfo(Index: Integer)
  : TcxGridDataCellViewInfo;
begin
  Result := InternalCellViewInfos[Index];
  if Result = nil then
  begin
    Result := GetCellViewInfoClass(Index)
      .Create(Self, GridView.VisibleColumns[Index]);
...
function TcxGridDataRowViewInfo.GetInplaceEditForm
  : TcxGridTableViewInplaceEditForm;
begin
  Result := TcxGridTableViewAccess.GetInplaceEditForm(GridView);
end;

function TcxGridDataRowViewInfo.GetInternalCellViewInfo(Index: Integer)
  : TcxGridDataCellViewInfo;
begin
...
function TcxGridDataRowViewInfo.GetRowLayoutController
  : TcxGridRowLayoutController;
begin
  Result := TcxGridTableViewAccess.GetRowLayoutController(GridView);
end;
...
begin
  ...
  begin
    ...
    if ShowPreview then
      FPreviewViewInfo := GetPreviewViewInfoClass.Create(Self,
        GridView.Preview.Column);
  end;
  if ShowInplaceEditForm then
  begin
    FInplaceEditFormAreaViewInfo := GetInplaceEditFormAreaViewInfoClass.Create
      (GridViewInfo, Self);
...
procedure TcxGridDataRowViewInfo.AddAdornerTargetElementsForColumn
...
function TcxGridDataRowViewInfo.AdjustToIntegralBottomBound
...
begin
  ...
  begin
    ACellViewInfo := InternalCellViewInfos[I];
    if (ACellViewInfo <> nil) and ACellViewInfo.IsMerging and
      (ACellViewInfo.Bounds.Bottom > R.Bottom) then
...
begin
  CellViewInfos[AIndex].Calculate(GetCellLeftBound(AIndex),
    GetCellTopBound(AIndex), -1, GetCellHeight(AIndex));
  if GridViewInfo.IsRightToLeftConverted then
...
begin
  ...
  FEmptyAreaBounds := Rect(ACellsAreaBounds.Right, ACellsAreaBounds.Top,
    InplaceEditFormAreaViewInfo.Bounds.Right,
    InplaceEditFormAreaViewInfo.Bounds.Top);
end;

function TcxGridDataRowViewInfo.CalculateDataAutoHeight(ACheckEditingCell
...
begin
  ...
  begin
    ...
    if not ACheckEditingCell and
      (ADataCellViewInfo.Item = GridView.Controller.EditingItem) then
      Continue;
...
begin
  ...
  else if CellsAreaViewInfo <> nil then
    if AutoHeight then
...
function TcxGridDataRowViewInfo.FindCellViewInfo(AItem: TcxCustomGridColumn)
  : TcxGridTableDataCellViewInfo;
begin
  if InplaceEditFormAreaViewInfo <> nil then
    Result := InplaceEditFormAreaViewInfo.FindCellViewInfo(AItem)
  else if LayoutViewInfo <> nil then
...
begin
  Result := RecordsViewInfo.AutoDataRecordHeight and not ShowInplaceEditForm and
    (LayoutViewInfo = nil);
end;
...
begin
  if GridViewInfo.IsRightToLeftConverted then
    if (GridViewInfo.Bounds.Right - GridViewInfo.IndicatorViewInfo.Width) <
      (RecordsViewInfo.ContentBounds.Right - DataRelativeIndent) then
      Result := Bounds.Left + Bounds.Right - GridViewInfo.Bounds.Right +
        GridViewInfo.IndicatorViewInfo.Width
    else
  ...
  begin
    ...
    Result := Max(Result, GridViewInfo.Bounds.Left +
      GridViewInfo.IndicatorViewInfo.Width);
  end;
end;
...
function TcxGridDataRowViewInfo.NeedToggleExpandRecord
  (AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
  AShift: TShiftState): Boolean;
begin
  Result := inherited NeedToggleExpandRecord(AHitTest, AButton, AShift);
  if Result and (InplaceEditFormAreaViewInfo <> nil) then
    Result := not
      (AHitTest.ViewInfo is TcxGridTableViewInplaceEditFormDataCellViewInfo);
end;
...
procedure TcxGridDataRowViewInfo.Offset(DX, DY: Integer);
  ...
  begin
    ...
    begin
      ...
      else if (DX <> 0) and (ACellViewInfo <> nil) then
      begin
        ACellViewInfo.Free;
...
begin
  ...
  else if FCellsAreaViewInfo <> nil then
  begin
    OffsetCells;
  ...
  begin
    ...
    begin
      ...
      FEmptyAreaBounds := TdxRightToLeftLayoutConverter.ConvertRect
        (FEmptyAreaBounds, Bounds);
    end;
  end;
end;
...
begin
  Result := (FixedState = rfsFixedToTop) and
    (GridRecord.Index = GridView.ViewData.FixedTopRowCount - 1);
end;

function TcxGridDataRowViewInfo.ShowDataCells: Boolean;
begin
  Result := not GridRecord.EditFormVisible or
    (GridView.OptionsBehavior.EditMode <> emInplaceEditFormHideCurrentRow);
end;

function TcxGridDataRowViewInfo.ShowFixedOnBottomRowsSeparator: Boolean;
begin
  Result := (FixedState = rfsFixedToBottom) and
    (GridRecord.Index = GridView.ViewData.RecordCount -
    GridView.ViewData.FixedBottomRowCount);
end;
...
begin
  Result := GridRecord.EditFormVisible and
    (GridView.OptionsBehavior.EditMode <> emModalEditForm);
end;

function TcxGridDataRowViewInfo.ShowLayout: Boolean;
begin
  Result := RowLayoutController.Active;
end;
...
begin
  Result := FCellsAreaBounds.Top + GridViewInfo.GetCellTopOffset(AIndex,
    FCellHeight);
end;
...
function TcxGridDataRowViewInfo.GetCellsAreaViewInfoClass
  : TcxGridDataRowCellsAreaViewInfoClass;
begin
  Result := TcxGridDataRowCellsAreaViewInfoClass
    (RecordsViewInfo.GetDataRowCellsAreaViewInfoClass);
end;

function TcxGridDataRowViewInfo.GetCellViewInfoClass(AIndex: Integer)
  : TcxGridDataCellViewInfoClass;
begin
...
function TcxGridDataRowViewInfo.GetInplaceEditFormAreaViewInfoClass
  : TcxGridInplaceEditFormAreaViewInfoClass;
begin
  Result := TcxGridInplaceEditFormAreaViewInfo;
end;

function TcxGridDataRowViewInfo.GetPreviewViewInfoClass
  : TcxGridPreviewCellViewInfoClass;
begin
...
function TcxGridDataRowViewInfo.GetWidth: Integer;
  ...
  begin
    ...
    else if cxRectIsEmpty(Bounds) then
    begin
    ...
    if ADelta > 0 then
      Dec(Result, Min(TcxGridViewAccess(GridView)
        .GetVerticalScrollBarAreaWidth, ADelta));
  end;
...
begin
  Result := inherited HasFocusRect and (InplaceEditFormAreaViewInfo = nil) and
    (LayoutViewInfo = nil) and
    not(TcxGridTableViewAccess.IsMultiSelectPersistent(GridView) and
    GridRecord.CanFocusCells and not IsSpecial);
end;
...
begin
  Result := inherited InvalidateOnChildHotTrackChanged or
    (GridView.FixedDataRows.PinVisibility = rpvRowHotTrack);
end;

procedure TcxGridDataRowViewInfo.BeforeCellRecalculation
  (ACell: TcxGridTableCellViewInfo);
begin
  // do nothing
end;
...
var
  ...
  X, ADelta: Integer;
begin
  if GridViewInfo.IsRightToLeftConverted and (InplaceEditFormAreaViewInfo <> nil)
  then
  begin
    ADelta := RecordsViewInfo.ContentBounds.Left - GridViewInfo.Bounds.Left;
    if ADelta > TcxGridViewAccess(GridView).GetVerticalScrollBarAreaWidth then
    begin
      AIndicatorWidth := 0;
      if GridViewInfo.IndicatorViewInfo.Visible then
        AIndicatorWidth := GridView.OptionsView.IndicatorWidth;

      X := GridViewInfo.Bounds.Right - RecordsViewInfo.ContentBounds.Right -
        AIndicatorWidth + GridViewInfo.Bounds.Left;

      Inc(X, Min(TcxGridViewAccess(GridView)
        .GetVerticalScrollBarAreaWidth, ADelta));
...
begin
  ...
  if CellsAreaViewInfo <> nil then
    FCellsAreaBounds := TdxRightToLeftLayoutConverter.ConvertRect
      (FCellsAreaBounds, ABounds);
  if HasPreview then
...
function TcxGridDataRowViewInfo.GetBoundsForInvalidate
...
function TcxGridDataRowViewInfo.GetBoundsForItem
  (AItem: TcxCustomGridTableItem): TRect;
var
  ACell: TcxGridTableDataCellViewInfo;
begin
  if InplaceEditFormAreaViewInfo <> nil then
    ACell := InplaceEditFormAreaViewInfo.GridItemViewInfos.
      FindCellViewInfo(AItem)
  else if LayoutViewInfo <> nil then
...
function TcxGridDataRowViewInfo.GetCellBorders(AIsRight, AIsBottom: Boolean)
  : TcxBorders;
begin
  Result := GridViewInfo.GetCellBorders(AIsRight, AIsBottom);
end;

function TcxGridDataRowViewInfo.GetCellViewInfoByItem
...
function TcxGridDataRowViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  I: Integer;
  ACellViewInfo: TcxGridDataCellViewInfo;
...
function TcxGridDataRowViewInfo.GetLayoutBounds: TRect;
begin
  if LayoutViewInfo <> nil then
    Result := LayoutViewInfo.Bounds
  else
    Result := cxEmptyRect
end;

function TcxGridDataRowViewInfo.IsHotTracked(ACheckChildren
  : Boolean = True): Boolean;
var
  I: Integer;
begin
  Result := inherited IsHotTracked or ACheckChildren and HasPreview and
    PreviewViewInfo.IsHotTracked;
...
function TcxGridDataRowViewInfo.IsInplaceEditFormCellPartVisible
  (ACellViewInfo: TcxGridTableDataCellViewInfo): Boolean;
var
  AEditFormAreaBounds, AEditBounds: TRect;
begin
  if (ACellViewInfo = nil) or (InplaceEditFormAreaViewInfo = nil) then
    Exit(False);
  AEditFormAreaBounds :=
    cxRectInflate(InplaceEditFormAreaViewInfo.Bounds, 0, -1);
...
function TcxGridNewItemRowViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
function TcxGridFilterRowViewInfo.GetCellViewInfoClass(AIndex: Integer)
  : TcxGridDataCellViewInfoClass;
begin
...
begin
  Result := inherited GetShowInfoText and GridRecord.IsEmpty and
    not OperatorCustomization;
end;
...
function TcxGridMasterDataRowDetailsSiteLeftTabsViewInfo.
  GetBottomGridLineColor: TColor;
begin
  Result := SiteViewInfo.MasterGridViewInfo.GridLineColor;
end;

function TcxGridMasterDataRowDetailsSiteLeftTabsViewInfo.
  GetBottomGridLineWidth: Integer;
begin
  Result := SiteViewInfo.MasterGridViewInfo.GridLineWidth;
end;

function TcxGridMasterDataRowDetailsSiteLeftTabsViewInfo.GetSiteViewInfo
  : TcxGridDetailsSiteViewInfo;
begin
...
function TcxGridMasterDataRowDetailsSiteLeftTabsViewInfo.
  GetBottomGridLineBounds: TRect;
begin
  Result := Bounds;
  Result.Top := Result.Bottom - BottomGridLineWidth;
end;

function TcxGridMasterDataRowDetailsSiteLeftTabsViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
function TcxGridMasterDataRowDetailsSiteLeftTabsViewInfo.
  HasBottomGridLine: Boolean;
begin
  Result := bBottom in SiteViewInfo.MasterGridViewInfo.GetCellBorders
    (False, True);
end;

{ TcxGridDetailsSiteViewInfo }

constructor TcxGridDetailsSiteViewInfo.Create(AMasterDataRowViewInfo
  : TcxGridMasterDataRowViewInfo);
begin
...
function TcxGridDetailsSiteViewInfo.GetCacheItem
...
begin
  ...
  if not Result and not IsActiveGridViewDestroying and
    not(csDestroying in ComponentState) then
  begin
    AMasterGridRecord := FMasterDataRowViewInfo.GridRecord;
    Result := (AMasterGridRecord <> nil) and
      AMasterGridRecord.ActiveDetailGridViewExists and
...
function TcxGridDetailsSiteViewInfo.GetDesignController
...
begin
  Result := MasterGridViewInfo.ClientWidth - FMasterDataRowViewInfo.LevelIndent;
...
function TcxGridDetailsSiteViewInfo.GetTabsViewInfoClass
  : TcxCustomGridDetailsSiteTabsViewInfoClass;
begin
...
procedure TcxGridDetailsSiteViewInfo.InitTabHitTest
  (AHitTest: TcxGridDetailsSiteTabHitTest);
begin
...
function TcxGridDetailsSiteViewInfo.DetailHasData(ALevel: TcxGridLevel)
  : Boolean;
begin
  Result := TcxGridMasterDataRow(MasterRecord).DetailGridViewHasData
    [ALevel.Index];
end;
...
function TcxGridExpandButtonCellViewInfo.GetRecordViewInfo
  : TcxGridMasterDataRowViewInfo;
begin
...
function TcxGridExpandButtonCellViewInfo.GetBorderBounds
  (AIndex: TcxBorder): TRect;
begin
...
function TcxGridExpandButtonCellViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
function TcxGridDetailsAreaViewInfo.GetRecordViewInfo
  : TcxGridMasterDataRowViewInfo;
begin
  Result := TcxGridMasterDataRowViewInfo(inherited RecordViewInfo);
end;
...
constructor TcxGridMasterDataRowViewInfo.Create(ARecordsViewInfo
  : TcxCustomGridRecordsViewInfo; ARecord: TcxCustomGridRecord);
begin
  inherited;
...
function TcxGridMasterDataRowViewInfo.GetCacheItem
  : TcxGridMasterTableViewInfoCacheItem;
begin
...
procedure TcxGridMasterDataRowViewInfo.CalculateExpandButtonBounds
  (var ABounds: TRect);
begin
...
function TcxGridMasterDataRowViewInfo.CalculateRestHeight
...
begin
  ...
  if InplaceEditFormAreaViewInfo <> nil then
    AButtonHeight := AButtonHeight -
      cxRectHeight(InplaceEditFormAreaViewInfo.Bounds);
  Result := Rect(ContentIndent, Bounds.Top, DataIndent,
    Bounds.Top + AButtonHeight);
end;
...
begin
  ...
  if DetailsSiteVisible then
    if not DetailsSiteViewInfo.FullyVisible and
      not GridViewInfo.CalculateDown and (Index > 0) and
      not DetailsSiteViewInfo.HasMaxHeight then
      Result := cxMaxRectSize
    else
      Result := Result - DetailsSiteViewInfo.Height +
        DetailsSiteViewInfo.NormalHeight;
end;
...
function TcxGridMasterDataRowViewInfo.IsDetailVisible
...
begin
  Result := inherited IsFullyVisible and
    (not DetailsSiteVisible or DetailsSiteViewInfo.HasMaxHeight or
    DetailsSiteViewInfo.FullyVisible);
end;
...
function TcxGridMasterDataRowViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridMasterDataRowPainter;
end;

function TcxGridMasterDataRowViewInfo.GetDetailsAreaViewInfoClass
  : TcxGridDetailsAreaViewInfoClass;
begin
  Result := TcxGridDetailsAreaViewInfo;
end;

function TcxGridMasterDataRowViewInfo.GetDetailsSiteViewInfoClass
  : TcxGridDetailsSiteViewInfoClass;
begin
  Result := TcxGridDetailsSiteViewInfo;
end;

function TcxGridMasterDataRowViewInfo.GetExpandButtonCellViewInfoClass
  : TcxGridExpandButtonCellViewInfoClass;
begin
...
var
  ...
  begin
    Result := DetailsSiteVisible and
      (GridViewInfo.IsCalculating or DetailsSiteViewInfo.ActiveGridViewExists
      and (DetailsSiteViewInfo.ActiveGridView.Site.Left =
      cxInvisibleCoordinate));
  end;
...
procedure TcxGridMasterDataRowViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
  if HasExpandButtonCell then
...
function TcxGridMasterDataRowViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
...
function TcxGridMasterDataRowViewInfo.ProcessDialogChar
...
constructor TcxGridGroupCellImageViewInfo.Create
  (AGroupCell: TcxGridGroupCellViewInfo);
begin
...
function TcxGridGroupCellImageViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
  Result := nil;
end;
...
function TcxGridGroupCellImageViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridGroupCellImagePainter;
end;

procedure TcxGridGroupCellImageViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
function TcxGridGroupCellImageViewInfo.GetImageProperties
...
constructor TcxGridGroupCellViewInfo.Create(AGroupedColumnAreaViewInfo
  : TcxGridGroupRowGroupedColumnAreaViewInfo);
begin
...
begin
  Result := TcxGridColumnAccess.CanSearchInGroupRows(GroupedColumn);
end;
...
begin
  ...
  if not Result then
    TcxGridTableViewAccess.DoCustomDrawGroupCell(GridView, ACanvas,
      Self, Result);
end;
...
begin
  Result := inherited GetBorderBounds(AIndex);
  if (AIndex = bBottom) and (RowStyle = grsStandard) and GridRecord.Expanded
  then
    if UseRightToLeftAlignment then
      Result.Right := RecordViewInfo.LevelIndentVertLineBounds
        [GridRecord.Level].Right
    else
      Result.Left := RecordViewInfo.LevelIndentVertLineBounds
        [GridRecord.Level].Left;
end;
...
begin
  Result := cxRectSetLeft(Bounds, Bounds.Left + GetCheckBoxMargins.Left,
    CheckBox.Width);
...
procedure TcxGridGroupCellViewInfo.GetFindTextSelectionInfo
  (out ASelStart: Integer; out AHighlightedText: string);
var
  APrefix: string;
begin
  ASelStart := GridView.DataController.FindCriteria.
    GetTextStartPositionByRowIndex(GridRecord.Index, GroupedColumn.Index,
    AHighlightedText);
  APrefix := TcxGridGroupRowAccess(GridRecord).CaptionPrefix
    [GroupedColumnIndex];
...
begin
  ...
  else if HasCheckBox then
    ALeft := GetCheckBoxBounds.Right + GetCheckBoxMargins.Right +
      GetImageMargins.Left
  else
  begin
...
function TcxGridGroupCellViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  ...
  TcxCustomGridTableItemAccess.DoGetDisplayText(GroupedColumn,
    GridRecord, Result);
end;
...
procedure TcxGridGroupCellViewInfo.Calculate(ALeftBound: Integer;
  ATopBound: Integer; AWidth: Integer = -1; AHeight: Integer = -1);
begin
  inherited Calculate(ALeftBound, ATopBound, AWidth, AHeight);
  if HasCheckBox then
...
procedure TcxGridGroupCellViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
  if HasCheckBox then
...
function TcxGridGroupCellViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  AHitTest: TcxCustomGridHitTest;
begin
...
function TcxGridGroupCellViewInfo.IsHotTracked(ACheckChildren
  : Boolean = True): Boolean;
begin
  Result := inherited IsHotTracked or ACheckChildren and HasCheckBox and
    CheckBox.IsHotTracked;
end;

{ TcxGridGroupRowSpacerViewInfo }

constructor TcxGridGroupRowSpacerViewInfo.Create(ARowViewInfo
  : TcxGridGroupRowViewInfo; const AText: string);
begin
...
procedure TcxGridGroupRowSpacerViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
  GridView.Styles.GetGroupSummaryCellParams(RowViewInfo.GridRecord,
    nil, AParams);
end;
...
constructor TcxGridGroupSummaryCellViewInfo.Create(AGroupedColumnAreaViewInfo
  : TcxGridGroupRowGroupedColumnAreaViewInfo; ASummaryItem: TcxDataSummaryItem;
  const AValue: Variant);
begin
  ...
  FValue := AValue;
  FSeparatorViewInfo := GroupedColumnAreaViewInfo.CreateSpacerViewInfo
    (GetSeparatorText);
end;
...
function TcxGridGroupSummaryCellViewInfo.GetRowViewInfo
  : TcxGridGroupRowViewInfo;
begin
...
function TcxGridGroupSummaryCellViewInfo.CustomDraw(ACanvas: TcxCanvas)
  : Boolean;
begin
  Result := inherited CustomDraw(ACanvas);
  if not Result then
  begin
    if Column <> nil then
      TcxGridColumnAccess.DoCustomDrawGroupSummaryCell(Column, ACanvas,
        Self, Result);
    if not Result then
      TcxGridTableViewAccess.DoCustomDrawGroupSummaryCell(GridView, ACanvas,
        Self, Result);
  end;
end;
...
function TcxGridGroupSummaryCellViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridGroupSummaryCellViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  if IsLast then
    ...
    Result := (SummaryItem.SummaryItems as TcxDataGroupSummaryItems)
      .Separator + ' ';
end;
...
procedure TcxGridGroupSummaryCellViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
  GridView.Styles.GetGroupSummaryCellParams(RowViewInfo.GridRecord,
    SummaryItem, AParams);
...
begin
  Result := inherited HasCustomDraw or (Column <> nil) and
    TcxGridColumnAccess.HasCustomDrawGroupSummaryCell(Column) or
    TcxGridTableViewAccess.HasCustomDrawGroupSummaryCell(GridView);
end;

procedure TcxGridGroupSummaryCellViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
  inherited;
...
procedure TcxGridGroupSummaryCellViewInfo.Calculate(ALeftBound,
  ATopBound: Integer; AWidth: Integer = -1; AHeight: Integer = -1);
begin
  inherited;
...
procedure TcxGridGroupSummaryCellViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
...
function TcxGridGroupSummaryCellViewInfo.MouseDown
  (AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
  AShift: TShiftState): Boolean;
begin
  Result := inherited MouseDown(AHitTest, AButton, AShift);
...
constructor TcxGridGroupRowGroupedColumnAreaViewInfo.Create(ARecordViewInfo
  : TcxCustomGridRecordViewInfo; AGroupedColumnIndex: Integer);
begin
...
procedure TcxGridGroupRowGroupedColumnAreaViewInfo.Calculate
  (ALeftBound: Integer; ATopBound: Integer; AWidth: Integer = -1;
  AHeight: Integer = -1);
begin
  inherited Calculate(ALeftBound, ATopBound, AWidth, AHeight);
...
function TcxGridGroupRowGroupedColumnAreaViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  I: Integer;
  AHitTest: TcxCustomGridHitTest;
...
function TcxGridGroupRowGroupedColumnAreaViewInfo.IsHotTracked
  (ACheckChildren: Boolean = True): Boolean;
var
  I: Integer;
begin
  Result := inherited IsHotTracked or ACheckChildren and
    CellViewInfo.IsHotTracked;
  if not Result and ACheckChildren then
    for I := 0 to SummaryCellViewInfoCount - 1 do
    begin
...
function TcxGridGroupRowGroupedColumnAreaViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridGroupRowGroupedColumnAreaPainter;
end;

procedure TcxGridGroupRowGroupedColumnAreaViewInfo.Offset(DX: Integer;
  DY: Integer);
var
  I: Integer;
begin
...
procedure TcxGridGroupRowGroupedColumnAreaViewInfo.AddSummaryCellViewInfo
  (ASummaryItem: TcxDataSummaryItem; const AValue: Variant);
begin
...
begin
  ...
  begin
    ...
    TcxGridGroupSummaryCellViewInfo(UnalignableSummaryCells.Last)
      .IsLast := True;
    CalculateSummaryCells(UnalignableSummaryCells,
      GetSummaryCellsAreaBounds(False), taLeftJustify, False);
  ...
  begin
    ...
    try
      ...
      begin
        ...
        PopulateColumnSummaryCellViewInfos(ACellViewInfos,
          AColumnHeaderViewInfo.Column);
        ...
        begin
          ...
          CalculateSummaryCells(ACellViewInfos,
            ...
            AColumnHeaderViewInfo.Column.GroupSummaryAlignment,
            SummaryCellAutoWidth);
        end;
      end;
    finally
      ACellViewInfos.Free;
...
procedure TcxGridGroupRowGroupedColumnAreaViewInfo.CalculateSummaryCells
  (ACellViewInfos: TList; const AAreaBounds: TRect; AAlignment: TAlignment;
  AAutoWidth: Boolean);
var
  ...
  I: Integer;
begin
  AWidths := CalculateSummaryCellWidths(ACellViewInfos,
    AAreaBounds.Right - AAreaBounds.Left, AAutoWidth);
  try
    ABounds := GetSummaryCellsBounds(AAreaBounds, AWidths, AAlignment,
      AAutoWidth);
    for I := 0 to ACellViewInfos.Count - 1 do
    begin
      ABounds.Right := Min(ABounds.Left + AWidths[I].AutoWidth,
        AAreaBounds.Right);
...
function TcxGridGroupRowGroupedColumnAreaViewInfo.CalculateSummaryCellWidths
  (ACellViewInfos: TList; AAvailableWidth: Integer; AAutoWidth: Boolean)
  : TcxAutoWidthObject;
var
  I: Integer;
begin
  ...
  for I := 0 to ACellViewInfos.Count - 1 do
    ...
    begin
      Width := TcxGridGroupSummaryCellViewInfo(ACellViewInfos[I])
        .CalculateWidth;
      MinWidth := Width;
      Fixed := False;
...
function TcxGridGroupRowGroupedColumnAreaViewInfo.CreateSummaryCellViewInfo
  (ASummaryItem: TcxDataSummaryItem; const AValue: Variant)
  : TcxGridGroupSummaryCellViewInfo;
begin
...
begin
  ...
  if not GridRecord.GetGroupSummaryInfo(ASummaryItems, ASummaryValues,
    GroupedColumnIndex) then
    Exit;
...
procedure TcxGridGroupRowGroupedColumnAreaViewInfo.
  CreateSummaryCellsWithoutColumns;
begin
...
function TcxGridGroupRowGroupedColumnAreaViewInfo.
  GetColumnSummaryCellsAreaBounds(AColumnHeaderViewInfo
  : TcxGridColumnHeaderViewInfo): TRect;
var
  R: TRect;
begin
  ...
  if GridViewInfo.IsRightToLeftConverted then
    R := TdxRightToLeftLayoutConverter.ConvertRect(R,
      CellViewInfo.RecordViewInfo.Bounds)
  else
    R.Left := AColumnHeaderViewInfo.DataOffset;
  Result.Left := Max(Result.Left,
    R.Left + ScaleFactor.Apply(cxGridCellTextOffset));
  Result.Right := Min(Result.Right,
    R.Right - ScaleFactor.Apply(cxGridCellTextOffset));
end;

procedure TcxGridGroupRowGroupedColumnAreaViewInfo.
  PopulateColumnSummaryCellViewInfos(AList: TList; AColumn: TcxGridColumn);
var
  I: Integer;
begin
  AList.Clear;
...
function TcxGridGroupRowGroupedColumnAreaViewInfo.
  GetSummaryCellAutoWidth: Boolean;
begin
  Result := RecordViewInfo.SummaryCellLayout = gslAlignWithColumnsAndDistribute;
end;

function TcxGridGroupRowGroupedColumnAreaViewInfo.GetSummaryCellsAreaBounds
  (AForAlignableCells: Boolean): TRect;
begin
...
function TcxGridGroupRowGroupedColumnAreaViewInfo.
  GetUnalignableSummaryCells: TList;
begin
  if RecordViewInfo.SummaryCellLayout = gslStandard then
    Result := SummaryCells
  else
...
function TcxGridGroupRowGroupedColumnAreaViewInfo.
  HasUnalignableSummaryCells: Boolean;
begin
  Result := (RecordViewInfo.SummaryCellLayout = gslStandard) or
    (SummaryCellsWithoutColumns.Count <> 0);
end;
...
function TcxGridGroupRowGroupedColumnAreaViewInfo.CreateSpacerViewInfo
  (const AText: string): TcxGridGroupRowSpacerViewInfo;
begin
...
begin
  FSummaryBeginningSpacerViewInfo :=
    CreateSpacerViewInfo(GetSummaryBeginningSpacerText);
end;
...
procedure TcxGridGroupRowGroupedColumnAreaViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
  ...
  for I := 0 to SummaryCellsWithoutColumns.Count - 1 do
    TcxGridGroupSummaryCellViewInfo(SummaryCellsWithoutColumns[I])
...
function TcxGridGroupRowGroupedColumnAreaViewInfo.GetSpacerViewInfoClass
  : TcxGridGroupRowSpacerViewInfoClass;
begin
  Result := TcxGridGroupRowSpacerViewInfo;
end;

function TcxGridGroupRowGroupedColumnAreaViewInfo.
  GetSummaryBeginningSpacerBounds: TRect;
begin
...
function TcxGridGroupRowGroupedColumnAreaViewInfo.
  GetSummaryBeginningSpacerText: string;
begin
  Result := ' ' + GridRecord.GroupSummaryItems.BeginText;
end;

function TcxGridGroupRowGroupedColumnAreaViewInfo.
  GetSummaryEndingSpacerBounds: TRect;
begin
  Result := GetSummaryCellsAreaBounds(False);
  Result.Left := TcxGridGroupSummaryCellViewInfo(UnalignableSummaryCells.Last)
    .Bounds.Right;
...
function TcxGridGroupRowGroupedColumnAreaViewInfo.
  GetSummaryEndingSpacerText: string;
begin
...
function TcxGridGroupRowGroupedColumnAreaViewInfo.
  HasSummaryBeginningSpacer: Boolean;
begin
  Result := SummaryBeginningSpacerViewInfo <> nil;
end;

function TcxGridGroupRowGroupedColumnAreaViewInfo.
  HasSummaryEndingSpacer: Boolean;
begin
...
function TcxGridGroupRowGroupedColumnAreaViewInfo.GetSummaryCellsBounds
  (const AAreaBounds: TRect; AWidths: TcxAutoWidthObject;
...
function TcxGridGroupRowGroupedColumnAreaViewInfo.GetSummaryCellViewInfoClass
  : TcxGridGroupSummaryCellViewInfoClass;
begin
  Result := TcxGridGroupSummaryCellViewInfo;
end;

function TcxGridGroupRowGroupedColumnAreaViewInfo.GetGridRecord
  : TcxGridGroupRow;
begin
  Result := TcxGridGroupRow(inherited GridRecord);
end;
...
begin
  Result := GroupedColumnIndex = RecordViewInfo.GridRecord.
    GroupedColumnCount - 1;
end;

function TcxGridGroupRowGroupedColumnAreaViewInfo.GetRecordViewInfo
  : TcxGridGroupRowViewInfo;
begin
  Result := TcxGridGroupRowViewInfo(inherited RecordViewInfo);
end;

function TcxGridGroupRowGroupedColumnAreaViewInfo.GetSummaryCellViewInfo
  (Index: Integer): TcxGridGroupSummaryCellViewInfo;
begin
  Result := TcxGridGroupSummaryCellViewInfo(SummaryCells[Index]);
end;

function TcxGridGroupRowGroupedColumnAreaViewInfo.
  GetSummaryCellViewInfoCount: Integer;
begin
...
constructor TcxGridGroupRowViewInfo.Create(ARecordsViewInfo
  : TcxCustomGridRecordsViewInfo; ARecord: TcxCustomGridRecord);
begin
...
function TcxGridGroupRowViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  I: Integer;
  AHitTest: TcxCustomGridHitTest;
...
function TcxGridGroupRowViewInfo.IsHotTracked(ACheckChildren
  : Boolean = True): Boolean;
var
  I: Integer;
begin
...
procedure TcxGridGroupRowViewInfo.AddGroupedColumnAreaViewInfo
  (AGroupedColumnIndex: Integer);
begin
  FGroupedColumnAreaViewInfos.Add
    (CreateGroupedColumnAreaViewInfo(AGroupedColumnIndex));
end;
...
begin
  ...
  if FixedState = rfsNotFixed then
    Exit;
  ANextIndex := TcxGridRowsViewInfoAccess(RecordsViewInfo)
    .GetNextNonOverlappedIndex(Index);
  ...
  if GridRecord.Level >= ALevel then
    FBottomBorderLeftPosition := ARowViewInfo.LevelIndentSpaceBounds
      [ALevel].Left;
end;

procedure TcxGridGroupRowViewInfo.CalculateExpandButtonBounds
  (var ABounds: TRect);
begin
  ABounds := MainGroupedColumnAreaViewInfo.CellViewInfo.ContentBounds;
  if RowStyle = grsOffice11 then
    ABounds.Top := ABounds.Bottom - MainGroupedColumnAreaViewInfo.CellViewInfo.
      TextHeightWithOffset;
  inherited CalculateExpandButtonBounds(ABounds);
end;

procedure TcxGridGroupRowViewInfo.CalculateGroupedColumnAreaViewInfo(ALeftBound,
  ATopBound: Integer);
var
  I, AWidth: Integer;
...
begin
  Result := TcxGridGroupRowGroupedColumnAreaViewInfo.Create(Self,
    AGroupedColumnIndex);
end;
...
begin
  ...
  if HasElongateBottomBorder then
    FBottomBorderLeftPosition :=
      TdxRightToLeftLayoutConverter.ConvertXCoordinate
      (FBottomBorderLeftPosition, ABounds);
  for I := 0 to GroupedColumnAreaViewInfoCount - 1 do
...
begin
  Result := inherited GetAutoHeight and
    (GridView.OptionsView.GroupRowHeight = 0);
end;
...
begin
  AIndicatorSize := LookAndFeelPainter.GetScaledFixedGroupIndicatorSize
    (ScaleFactor);
...
begin
  ...
  Result.Bottom := MainGroupedColumnAreaViewInfo.CellViewInfo.
...
begin
  Result := inherited HasFooter(ALevel) or
    (GridView.OptionsView.GroupFooters = gfAlwaysVisible) and (ALevel = 0) and
    not GridRecord.Expanded and Controller.CanShowGroupFooter(GridRecord.Level);
end;
...
procedure TcxGridGroupRowViewInfo.SetFixedState
...
function TcxGridGroupRowViewInfo.GetGroupedColumnAreaViewInfo(AIndex: Integer)
  : TcxGridGroupRowGroupedColumnAreaViewInfo;
begin
  Result := TcxGridGroupRowGroupedColumnAreaViewInfo
    (FGroupedColumnAreaViewInfos[AIndex]);
end;

function TcxGridGroupRowViewInfo.GetMainGroupedColumnAreaViewInfo
  : TcxGridGroupRowGroupedColumnAreaViewInfo;
begin
...
function TcxGridGroupRowViewInfo.GetSummaryCellLayout
