...
uses
  Classes, cxGrid, cxGridCustomView, cxGridWizard, cxGridReg, cxViewEditor,
  DesignIntf, cxGridWizardCustomHelper;
...
procedure TcxGridWizardHelper.Execute(AGrid: TcxCustomGrid;
  AGridView: TcxCustomGridView);
begin
  ExecuteGridWizard(AGrid, AGridView);
end;

function TcxGridWizardHelper.IsGridViewSupported(AGridViewClass
  : TClass): Boolean;
begin
