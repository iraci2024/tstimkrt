...
{$ENDIF}
  ...
  Math, ImgList, Dialogs, Types, Menus, MultiMon,
  ...
  cxLibraryConsts, dxHooks, dxAnimation, cxButtonEdit, cxEdit, cxEditConsts,
  dxMessages, cxContainer, cxCustomCanvas,
  dxCustomTileControl, dxDirectX.D2D.Classes;
...
type
  ...
  TdxTileBarDetailSiteTitleViewInfo = class
  ...
  protected
    ...
    function GetTitleViewInfoClass
      : TdxTileControlDetailSiteTitleViewInfoClass; override;
  ...
  protected
    ...
    procedure DrawContent(ACanvas: TcxCustomCanvas;
      const ADrawRect: TRect); override;
  ...
  public
    ...
    property DropDownButton: TdxTileBarItemDropDownButtonViewInfo
  ...
  public
    ...
    property TileBar: TdxCustomTileBar read GetTileBar;
  published
    property DetailOptions: TdxTileBarItemDetailOptions read GetDetailOptions
      write SetDetailOptions stored IsDetailOptionsStored;
    property PopupOptions: TdxTileBarItemPopupOptions read FPopupOptions
      write SetPopupOptions stored IsPopupOptionsStored;
  ...
  protected
    procedure DoCalculateTopLeft(const ASizeX, ASizeY: Integer;
      var ATop, ALeft: Integer); override;
  ...
  protected
    ...
    function GetScrollButtonViewInfoClass
      : TdxTileControlScrollButtonViewInfoClass; override;
  ...
  protected
    procedure DrawDefaultDropDownButtonArrow(ACanvas: TcxCustomCanvas;
      const ARect: TRect; ADirection: TcxArrowDirection; ABorderColor: TColor);
      overload; virtual;
    procedure DrawDropDownButton(ACanvas: TcxCustomCanvas; const ARect: TRect;
      ADirection: TcxArrowDirection; AState: TcxButtonState;
      AHighlightColor: TdxAlphaColor; AItem: TdxTileControlCustomItem); virtual;
  public
    property TileBar: TdxCustomTileBar read GetTileBar;
  end;
  ...
  protected
    ...
    function GetDefaultItemHotTrackMode
      : TdxTileControlItemHotTrackMode; override;
  ...
  protected
    ...
    class function CheckGroupLayout(const APosition: TdxTileBarPosition)
      : TdxTileControlGroupLayout;
    procedure DoItemChanged(AItem: TdxTileControlItem; const AData: Pointer);
    class function GetGroupMaxRowCount(const ALayout: TdxTileControlGroupLayout)
      : Integer; overload;
    class function GetGroupMaxRowCount(const APosition: TdxTileBarPosition)
      : Integer; overload;
  ...
  public
    ...
    procedure Assign(ASource: TPersistent); override;
  published
    property Position: TdxTileBarPosition read FPosition write SetPosition
      default tbpTop;
  end;
  ...
  protected
    ...
    property ActualControl: TWinControl read GetActualControl;
    property ActualBarItem: TdxTileBarItem read FActualBarItem
      write SetActualBarItem;
  ...
  public
    constructor Create(ATileBar: TdxCustomTileBar; AIsShowing: Boolean);
      reintroduce; virtual;
  ...
  public
    property DropDownButton: TdxTileBarItemDropDownButtonViewInfo
      read GetDropDownButton;
    property HitAtDropDownButton: Boolean index tbhtDropDownButton
      read GetBitState;
    property TileBar: TdxCustomTileBar read GetTileBar;
  end;
  ...
  protected
    ...
    procedure InternalMouseLeftDown(Shift: TShiftState; X, Y: Integer);
      override;
    ...
    function CreateRegularItem(AGroup: TdxTileControlGroup)
      : TdxTileControlItem; override;
    function IsDesignerMenuItemChecked(const AItemSizeIndex: Integer;
      AItem: TdxTileControlItem): Boolean; override;
  ...
  protected
    ...
    procedure ExecuteDetailDeactivating
      (ADetail: TdxTileControlDetailSite); override;
    ...
    function GetOptionsBehaviorClass
      : TdxTileControlOptionsBehaviorClass; override;
    ...
    function NeedStopAnimationsBeforeActiveDetailChanging
      (AActiveDetail: TdxTileControlDetailSite): Boolean; override;

    procedure SetOptionsBehavior(AValue: TdxTileBarOptionsBehavior);
      reintroduce; virtual;
    procedure SetOptionsView(AValue: TdxTileBarOptionsView);
      reintroduce; virtual;
    ...
    property OnPopupActivating: TdxTileControlItemAllowOperationEvent
      read FOnPopupActivating write FOnPopupActivating;
    property OnPopupActivate: TdxTileControlItemOperationEvent
      read FOnPopupActivate write FOnPopupActivate;
    property OnPopupDeactivating: TdxTileControlItemAllowOperationEvent
      read FOnPopupDeactivating write FOnPopupDeactivating;
    property OnPopupDeactivate: TdxTileControlItemOperationEvent
      read FOnPopupDeactivate write FOnPopupDeactivate;
  public
    function CreateItem(ASize: TdxTileBarItemSize;
      AGroup: TdxTileControlGroup = nil): TdxTileBarItem; reintroduce;
    ...
    property FocusedItem: TdxTileBarItem read GetFocusedItem
      write SetFocusedItem;
    property OptionsBehavior: TdxTileBarOptionsBehavior read GetOptionsBehavior
  ...
  TdxTileBar = class(TdxCustomTileBar, IdxDirect2DSupport)
  published
    property Anchors;
    property AutoSize;
    property BiDiMode;
...
function TdxTileBarDetailSiteHitTest.GetActiveViewInfo
...
function TdxTileBarDetailSiteTitleViewInfo.GetOptions
  : TdxTileBarItemDetailOptions;
begin
...
function TdxTileBarDetailSite.GetTitleViewInfoClass
...
begin
  ...
  if (TileBar.OptionsView.Position = tbpRight) xor TileBar.ViewInfo.UseRightToLeftAlignment
  then
    ABounds.Right := ABounds.Left + TileBar.OptionsView.DropDownButtonWidth -
      AInflateDelta
  else
    ABounds.Left := ABounds.Right - TileBar.OptionsView.DropDownButtonWidth +
      AInflateDelta;
...
const
  DirectionMap: array [TdxTileBarPosition] of TcxArrowDirection = (adDown, adUp,
    adRight, adLeft);
begin
...
function TdxTileBarItemDropDownButtonViewInfo.GetHitTest
...
begin
  if TileBar.PopupWindow.Visible and (TileBar.PopupWindow.ActualBarItem = Item)
  then
    AValue := cxbsHot;
...
function TdxTileBarItemDropDownButtonViewInfo.PtInCaller
...
procedure TdxTileBarItemViewInfo.DrawContent(ACanvas: TcxCustomCanvas;
  const ADrawRect: TRect);
begin
...
begin
  Result := ABounds;
  if Item.IsPopupControlAssigned then
    if (Item.TileBar.OptionsView.Position = tbpRight) xor Item.TileBar.ViewInfo.UseRightToLeftAlignment
    then
...
function TdxTileBarItemViewInfo.GetHitTest
  (AHitTest: TdxTileControlHitTest): Boolean;
begin
  Result := Visible and PtInRect(ClipRect, AHitTest.HitPoint);
  if Result and (Item.TileBar.IsDesigning or not DropDownButton.GetHitTest
    (AHitTest)) then
  begin
    AHitTest.HitObject := Self;
...
procedure TdxTileBarItemViewInfo.DoRightToLeftConversion
...
begin
  ...
  begin
    if (AValue <> nil) and
      (TdxTileBarItem(TileItem).PopupOptions.PopupControl = AValue) then
...
begin
  ...
  FPopupControlNotifyComponent.OnFreeNotification :=
    PopupControlFreeNotification;
end;
...
procedure TdxTileBarItemPopupOptions.PopupControlFreeNotification
...
begin
  Result := (FPopupControl <> nil) or (FBorderColor <> clNone) or
    (FBorderWidth <> 1) or (FBorderHeight <> 1) or (FColor <> clDefault);
end;
...
begin
  ...
  else if ControlHasTileBarAsParent then
...
function TdxTileBarItem.GetDetailOptionsClass
...
begin
  Result := IsPopupControlAssigned and
    not(IsDragged or TdxTileControlGroupAccess(Group).IsDragged);
end;
...
procedure TdxTileBarScrollButtonViewInfo.DoCalculateTopLeft(const ASizeX,
  ...
  case Direction of
    ...
    adDown:
      begin
        ALeft := (R.Left + R.Right) div 2 - DX;
        if OptionsView.FixedIndentVert then
          ATop := Min(R.Bottom - ASizeY - ADPI_MinOffset,
            R.Bottom - OptionsView.IndentVert div 2 - DY)
        else
    ...
    adLeft:
      begin
        ...
        if OptionsView.FixedIndentHorz then
          ALeft := Max(ADPI_MinOffset,
            R.Left + OptionsView.IndentHorz div 2 - DX)
        else
          ALeft := R.Left + DX;
      end;
  else
    begin
      ATop := (R.Top + R.Bottom) div 2 - DY;
      if OptionsView.FixedIndentHorz then
        ALeft := Min(R.Right - ASizeX - ADPI_MinOffset,
          R.Right - OptionsView.IndentHorz div 2 - DX)
      else
...
begin
  ...
  begin
    ...
    Result.Bottom := R.Top + GetGroupsCaptionsMaxHeight + 2 *
      OptionsView.IndentVert + Max(GetItemsMaxHeight, OptionsView.ItemHeight);
...
begin
  Result := cxRectInflate(inherited GetDetailSiteArea, -TileBar.BorderSize,
    -TileBar.BorderSize);
...
begin
  ...
  for I := 0 to TileControl.Items.Count - 1 do
    Result := Max(Result,
      (TileControl.Items[I].ViewInfo as TdxTileBarItemViewInfo).GetHeight);
end;
...
function TdxTileBarViewInfo.GetScrollButtonViewInfoClass
...
begin
  ...
  begin
    ...
    FCallOutPoints1[2].X := FCallOutPoints1[1].X - FCallOutElementSize.cx div 2
      + Integer(APosition = tbpBottom);
    FCallOutPoints1[2].Y := FCallOutPoints1[1].Y + dxSignature
      [APosition = tbpTop] * FCallOutElementSize.cy;
    FCallOutPoints1[3].X := FCallOutPoints1[0].X;
    FCallOutPoints1[3].Y := FCallOutPoints1[2].Y;

    FCallOutPoints2[0].X := FCallOutPoints1[1].X + 1 -
      Integer(APosition = tbpBottom);
    ...
    FCallOutPoints2[2].Y := FCallOutPoints2[1].Y + dxSignature
      [APosition = tbpTop] * FCallOutElementSize.cy;
  ...
  begin
    ...
    FCallOutPoints1[2].X := FCallOutPoints1[1].X + dxSignature
      [APosition = tbpLeft] * FCallOutElementSize.cx;
    ...
    FCallOutPoints2[2].X := FCallOutPoints2[1].X + dxSignature
      [APosition = tbpLeft] * FCallOutElementSize.cx;
...
begin
  ...
  case TileBar.OptionsView.ActualPosition of
    ...
    tbpBottom:
      Result := cxPoint(0, ADetailArea.Bottom - FRequiredSize.cy +
        FCallOutElementSize.cy);

    tbpLeft:
      Result := cxPoint(ADetailArea.Left - FCallOutElementSize.cx, 0);

  else
    Result := cxPoint(ADetailArea.Right - FRequiredSize.cx +
      FCallOutElementSize.cx, 0);
  end;
...
begin
  ...
  ARegion := CreatePolygonRgn(FCallOutPoints1[0],
    Length(FCallOutPoints1), WINDING);
  if ARegion <> 0 then
  begin
    CombineRgn(Result, Result, ARegion, RGN_DIFF);
    DeleteObject(ARegion);
  end;
  ARegion := CreatePolygonRgn(FCallOutPoints2[0],
    Length(FCallOutPoints2), WINDING);
  if ARegion <> 0 then
  begin
    CombineRgn(Result, Result, ARegion, RGN_DIFF);
    DeleteObject(ARegion);
  ...
  ARegion := CreateRectRgn(FOutTilesArea1.Left, FOutTilesArea1.Top,
    FOutTilesArea1.Right, FOutTilesArea1.Bottom);
  if ARegion <> 0 then
  begin
    CombineRgn(Result, Result, ARegion, RGN_DIFF);
    DeleteObject(ARegion);
  end;
  ARegion := CreateRectRgn(FOutTilesArea2.Left, FOutTilesArea2.Top,
    FOutTilesArea2.Right, FOutTilesArea2.Bottom);
  if ARegion <> 0 then
  begin
    CombineRgn(Result, Result, ARegion, RGN_DIFF);
    DeleteObject(ARegion);
...
begin
  ...
  begin
    ...
    if FOwner.HasBorder then
      ACanvas.FrameRegion(ARegion, FOwner.BorderColor, FOwner.BorderWidth,
        FOwner.BorderHeight);
    DeleteObject(ARegion);
  end;
end;
...
begin
  ...
  OwnerBounds := cxRectSetOrigin(ActualBarItem.ViewInfo.DropDownButton.Bounds,
    TileBar.ClientToParent(ActualBarItem.ViewInfo.DropDownButton.
    Bounds.TopLeft));
...
begin
  ...
  else if FActualBarItem <> nil then
    SetActualControlVisibility(True);
end;
...
constructor TdxTileBarPopupWindowAnimation.Create(ATileBar: TdxCustomTileBar;
  AIsShowing: Boolean);
const
  AAnimationTime: array [Boolean] of Cardinal = (dxTileBarPopupWindowHideTime,
    dxTileBarPopupWindowShowTime);
begin
  FTileBar := ATileBar;
...
procedure TdxTileBarPainter.DrawDropDownButton(ACanvas: TcxCustomCanvas;
  const ARect: TRect; ADirection: TcxArrowDirection; AState: TcxButtonState;
  AHighlightColor: TdxAlphaColor; AItem: TdxTileControlCustomItem);
var
...
begin
  ...
  if not TileBar.IsDesigning and (AState in [cxbsHot, cxbsPressed]) then
    DrawHighlightRect(ACanvas, ARect, AHighlightColor,
      AItem.Style.GradientBeginColor);
  ...
  ACanvas.FillRect(cxRectInflate(R, 0, -TileBar.ScaleFactor.Apply(7)),
    ASplitLineColor, MaxByte);
end;
...
function TdxTileBarOptionsBehavior.GetDefaultItemCheckMode
  : TdxTileControlItemCheckMode;
begin
  Result := tcicmNone;
end;

function TdxTileBarOptionsBehavior.GetDefaultItemFocusMode
  : TdxTileControlItemFocusMode;
begin
  Result := tcifmOuterFrame;
end;

function TdxTileBarOptionsBehavior.GetDefaultItemHotTrackMode
  : TdxTileControlItemHotTrackMode;
begin
  Result := tcihtmHighlight;
end;

function TdxTileBarOptionsBehavior.GetDefaultItemHotTrackHighlightColor
  : TdxAlphaColor;
begin
...
function TdxTileBarOptionsBehavior.GetDefaultScrollMode
...
class function TdxTileBarOptionsView.CheckGroupLayout(const APosition
  : TdxTileBarPosition): TdxTileControlGroupLayout;
begin
...
procedure TdxTileBarOptionsView.DoItemChanged(AItem: TdxTileControlItem;
  const AData: Pointer);
begin
...
begin
  Result := FPosition;
  if TileBar.ViewInfo.UseRightToLeftAlignment and (Result in [tbpLeft, tbpRight])
  then
...
class function TdxTileBarOptionsView.GetGroupMaxRowCount(const ALayout
  : TdxTileControlGroupLayout): Integer;
begin
...
class function TdxTileBarOptionsView.GetGroupMaxRowCount(const APosition
  : TdxTileBarPosition): Integer;
begin
...
begin
  ...
  try
    ...
    TdxTileControlItemCollectionAccess(TileBar.Items).ForEach(DoItemChanged,
      nil, False);
  finally
    TileBar.EndUpdate;
...
procedure TdxTileBarOptionsView.SetGroupLayout
...
procedure TdxTileBarController.InternalMouseLeftDown(Shift: TShiftState;
  X, Y: Integer);
begin
  HitTest.Calculate(X, Y);
  FPressedDropDownButton := HitTest.DropDownButton;
  if (FPressedDropDownButton <> nil) and not FPressedDropDownButton.Item.Enabled
  then
...
procedure TdxTileBarController.InternalMouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  AButton: TdxTileBarItemDropDownButtonViewInfo;
begin
  HitTest.Calculate(X, Y);
  if HitAtDropDownButton and (HitTest.DropDownButton = FPressedDropDownButton)
...
begin
  ...
  if (AFocusedItem <> nil) and AFocusedItem.Enabled and
    AFocusedItem.IsPopupControlAssigned and CanPopupByKey(Key) then
  begin
...
// design selection
function TdxTileBarController.CreateDesignHelper
...
function TdxTileBarController.CreateRegularItem(AGroup: TdxTileControlGroup)
  : TdxTileControlItem;
begin
  Result := TileBar.CreateItem(tbisRegular, AGroup);
end;

function TdxTileBarController.IsDesignerMenuItemChecked(const AItemSizeIndex
...
function TdxTileBarController.GetIsLargeItem(AItem: TdxTileControlItem)
  : Boolean;
begin
  Result := ((AItem as TdxTileBarItem).Size = tbisLarge) and
    (AItem.RowCount = 1);
end;

function TdxTileBarController.GetIsRegularItem
  (AItem: TdxTileControlItem): Boolean;
begin
  Result := ((AItem as TdxTileBarItem).Size = tbisRegular) and
    (AItem.RowCount = 1);
end;

procedure TdxTileBarController.PopulateOneGroupDesignPopupMenu;
const
  AMenuItemCaption: array [Low(TdxTileBarItemSize) .. High(TdxTileBarItemSize)
    ] of string = ('Add Regular Item', 'Add Large Item');
var
...
procedure TdxTileBarController.SetDesignItemSize(AItem: TdxTileControlItem;
...
function TdxTileBarHitTest.GetDropDownButton
  : TdxTileBarItemDropDownButtonViewInfo;
begin
...
const
  DesignTimeAlign: array [TdxTileBarPosition] of TAlign = (alTop, alBottom,
    alLeft, alRight);
begin
  if IsDesigning then
...
function TdxCustomTileBar.CreateItem(ASize: TdxTileBarItemSize;
  AGroup: TdxTileControlGroup = nil): TdxTileBarItem;
begin
  BeginUpdate;
  try
...
begin
  ...
  ViewInfo.Calculate;
  if not IsDesigning and (FocusedItem <> nil) and FocusedItem.Visible and
    FocusedItem.Enabled and FocusedItem.DetailOptions.HasDetail then
    FocusedItem.ActivateDetail;
end;

procedure TdxCustomTileBar.ExecuteDetailDeactivating
...
begin
  ...
  try
    ...
    begin
      APrevDetail := QueuePrevDetails[QueuePrevDetails.Count - 1]
        as TdxTileBarDetailSite;
...
begin
  ...
  begin
    ActiveDetail.HitTest.HitPoint := ActiveDetail.ScreenToClient
      (ActiveHitTestPos);
...
function TdxCustomTileBar.GetAnimationScrollFadeMode(AIndex1, AIndex2: Integer)
...
function TdxCustomTileBar.GetAnimationScrollMode(AIndex1, AIndex2: Integer)
  : TdxDrawAnimationMode;
begin
...
function TdxCustomTileBar.GetOptionsBehaviorClass
...
function TdxCustomTileBar.NeedStopAnimationsBeforeActiveDetailChanging
...
procedure TdxCustomTileBar.SetOptionsBehavior
  (AValue: TdxTileBarOptionsBehavior);
begin
...
var
  AAllow: Boolean;
begin
  if (AItem <> nil) and AItem.ViewInfo.Visible and
    (PopupWindow.FLastActualBarItem <> AItem) then
  begin
    AItem.MakeVisible;
...
function TdxTileBarTopActionBar.CreateViewInfo
...
function TdxTileBarActionBarViewInfo.GetCanDisplayItem
