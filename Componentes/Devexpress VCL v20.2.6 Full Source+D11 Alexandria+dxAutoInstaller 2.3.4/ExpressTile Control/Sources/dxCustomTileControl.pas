...
{ ExpressTileControl }
{ }
{ Copyright (c) 2011-2021 Developer Express Inc. }
{ ALL RIGHTS RESERVED }
{ }
...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Windows, Messages, Forms, SysUtils, Classes, Controls, StdCtrls, Graphics,
  Math, ImgList, Dialogs, Types, Menus,
  dxCoreClasses, dxCore, dxCoreGraphics, cxGeometry, cxClasses, cxGraphics,
  cxControls, cxLookAndFeels, dxSkinInfo,
  cxLookAndFeelPainters, dxGDIPlusClasses, dxGDIPlusAPI, cxInplaceContainer,
  cxStorage, dxSkinsCore, cxDrawTextUtils,
  cxLibraryConsts, dxHooks, dxAnimation, cxButtonEdit, cxEdit, dxMessages,
  cxCustomCanvas, Generics.Collections;
...
type
  ...
  TdxTileControlScrollButtonViewInfoClass = class of
    TdxTileControlScrollButtonViewInfo;
  TdxTileControlItemDetailOptionsClass = class of
    TdxTileControlItemDetailOptions;
  TdxTileControlDetailSiteTitleViewInfoClass = class of
  ...
  TdxTileControlDetailAnimationMode = (damScroll, damFade, damSegmentedFade,
    damRandomSegmentedFade, damScrollFade);

  TdxTileControlRectIntersectedBounds = (rcNone, rcFull, rcFullLeft, rcFullTop,
    rcFullRight, rcFullBottom, rcLeft, rcRight);

  TdxTileControlActionBarVisibilityChangeReason = (abvcrManualSwitch,
    abvcrActionButtonClick, abvcrActiveDetailChange, abvcrMouseLeftClick,
    abvcrMouseMiddleClick, abvcrMouseRightClick, abvcrTileElementInteraction,
  ...
  TdxTileControlItemHotTrackMode = (tcihtmNone, tcihtmFrame, tcihtmHighlight,
    tcihtmOuterFrame);
  ...
  TdxTileControlDesignTimeWhatSelected = (tcdtwsNone, tcdtwsItem, tcdtwsItems,
    tcdtwsGroup, tcdtwsGroups, tcdtwsMixed);
  ...
  strict private
    function GetItem(AIndex: Integer): TdxTileControlCustomCellViewInfo; inline;
  public
    function CalculateHitTest(AHitTest: TdxTileControlHitTest)
      : Boolean; virtual;
    ...
    property Items[AIndex: Integer]: TdxTileControlCustomCellViewInfo
      read GetItem; default; // for internal use
  end;
  ...
  private
    FBounds: TRect;
  protected
    function GetHitTest(AHitTest: TdxTileControlHitTest): Boolean;
      virtual; abstract;
  ...
  TdxTileControlAnimatedDragAndDropCustomCellViewInfo = class
    (TdxTileControlCustomCellViewInfo)
  protected
  ...
  TdxTileControlItemViewInfo = class
    (TdxTileControlAnimatedDragAndDropCustomCellViewInfo)
  private
  ...
  protected
    ...
    procedure DrawFrameRect(ACanvas: TcxCustomCanvas; AColor: TColor;
      AIsOuter: Boolean; AColorAlpha: Byte = 255); virtual;
    ...
    procedure DrawHighlightRect(ACanvas: TcxCustomCanvas; const R: TRect;
      const AHighlightColor: TdxAlphaColor); overload; virtual;
    ...
    property GalleryCellController: TdxTileControlGalleryCellController
      read GetGalleryCellController;
    ...
    property ItemHotTrackMode: TdxTileControlItemHotTrackMode
      read GetItemHotTrackMode;
  ...
  public
    ...
    property ViewData: TdxTileControlCustomItemViewData read GetViewData
      write SetViewData; // for internal use
  end;
  ...
  strict private
    ...
    procedure CalculateSizeAtHorizontalGroupLayout(var AWidth,
      AHeight: Integer);
    procedure CalculateSizeAtVerticalGroupLayout(var AWidth, AHeight: Integer);
    procedure GetDrawingBoundsParamsAtHorizontalGroupLayout(var ALeft, ATop,
      AWidth, AHeight: Integer);
    procedure GetDrawingBoundsParamsAtVerticalGroupLayout(var ALeft, ATop,
      AWidth, AHeight: Integer);
  ...
  public
    ...
    property SizeMustFromDragItem: Boolean read FSizeMustFromDragItem
      write FSizeMustFromDragItem;
  end;
  ...
  private
    ...
    function IsItemOccupyPosition(AItem: TdxTileControlItem;
      APosition: TdxLayoutItemPosition): Boolean;
    function IsOccupiedByPriorItems(ACurrentItem: TdxTileControlItem;
  ...
  protected
    ...
    function GetHitTest(AHitTest: TdxTileControlHitTest): Boolean; override;
    function GetLeftPos: Integer; override;
    function GetOccupiedItem(APosition: TdxLayoutItemPosition)
      : TdxTileControlItem;
    class function GetStartOfCurrentLogicalColumn(const ASmallColumn,
      ASmallColumnCountInLogicalRow: Integer): Integer;
    class function GetStartOfCurrentRegularColumn(const ASmallColumn
      : Integer): Integer;
    class function GetStartOfCurrentRegularRow(const ASmallRow
      : Integer): Integer;
    function GetTopPos: Integer; override;
    function GetZIndex(AColumn, ARow, ADragItemRow: Integer): Integer; overload;
    function GetZIndex(APosition, ADragItemPosition: TdxLayoutItemPosition)
      : Integer; overload;
    procedure Offset(const dX, dY: Integer); override;
    ...
    property SmallColumnCountInLogicalRow: Integer
      read GetSmallColumnCountInLogicalRow;
  ...
  public
    ...
    procedure CreateItemClickHandler(AItem: TdxTileControlItem);
      virtual; abstract;
  ...
  TdxTileControlCustomDesignHelperClass = class of
    TdxTileControlCustomDesignHelper;
  ...
  protected
    ...
    property SourceViewData: TdxTileControlCustomItemViewData
      read FSourceViewData;
  public
  ...
  TdxTileControlGalleryImage = class(TInterfacedObject,
    IdxTileControlGalleryImage)
  strict private
  ...
  strict private
    ...
    FSourceRect: TRect;
  public
    constructor Create(AImage: IdxTileControlGalleryImage;
  ...
  public
    constructor Create(AItem: TdxTileControlItem;
      ACell: TdxTileControlItemGalleryCell); reintroduce; virtual;
    destructor Destroy; override;
    procedure Draw(ACanvas: TcxCustomCanvas; const R: TRect);
    procedure RefreshAnimatedObject; override;
  ...
  protected
    procedure DoAnimate; override;
    function IsCompatible(AAnimation: TdxAnimationTransition): Boolean;
      override;
  public
    constructor Create(AItem: TdxTileControlItem; AShowFrame: Boolean = True);
      reintroduce;
    destructor Destroy; override;
  ...
  public
    constructor Create(ATileControl: TdxCustomTileControl;
      AMode: TdxTileControlActionBarsAnimationMode); reintroduce; virtual;
    //
    property ActionBarBottom: TdxTileControlCustomActionBar
      read GetActionBarBottom;
  ...
  public
    constructor Create(ATileControl: TdxCustomTileControl; ATime: Cardinal;
      const ALengthX, ALengthY: Integer); reintroduce; virtual;
  ...
  protected
    ...
    procedure CalculateComplexDrawingAreaBounds(var ADest, ASource: TRect;
      const AOffsetX, AOffsetY: Integer);
    procedure CalculateSimpleDrawingAreaBounds(var ADest: TRect;
      const AOffsetX, AOffsetY: Integer);
    function CompareTileControlGroupCaptions
      (AInfo: TdxTileControlDragAndDropChangesCellInfo): Integer;
    function CompareTileControlItems
      (AInfo: TdxTileControlDragAndDropChangesCellInfo): Integer;
    function IsEqualGroupCaptions
  ...
  public
    ...
    function IndexOf(ACell
      : TdxTileControlAnimatedDragAndDropCustomCellViewInfo): Integer;

    property Count: Integer read GetCount;
    property DragAndDropObject: TdxTileControlDragDropCustomObject
      read GetDragAndDropObject;
    ...
    property Items[Index: Integer]: TdxTileControlDragAndDropChangesCellInfo
      read GetItem;
    property TileControl: TdxCustomTileControl read GetTileControl;
  ...
  protected
    ...
    procedure Scroll(AKind: TScrollBarKind; ACode: TScrollCode;
      var APosition: Integer); override;
  ...
  private
    ...
    function GetSlowdownScrollFactor(APos, AScrollPageSize, AContentSize,
      ANewDelta: Integer): Integer;
    function GetTileControl: TdxCustomTileControl;
    function GetViewInfo: TdxTileControlViewInfo;
  protected
  ...
  protected
    ...
    ScrollControllers: array [TdxTileControlAutoScrollSide]
      of TdxTileControlAutoScrollingObject;
    ...
    procedure EndDragAndDropItem(Accepted: Boolean;
      var ANewGroup: TdxTileControlGroup); virtual;
    ...
    property DragDropChanges: TdxTileControlDragAndDropChanges
      read GetDragDropChanges;
  ...
  public
    ...
    property ImmediateFinish: Boolean read FImmediateFinish
      write FImmediateFinish;
  end;
  ...
  public
    ...
    property Position: TdxLayoutItemPosition read FPosition write FPosition;
    property VirtualGroup: TdxTileControlVirtualGroupViewInfo read FVirtualGroup
      write FVirtualGroup;
  end;
  ...
  private
    ...
    function CreateNewGroupAndMoveDragItemTo(AVirtualGroup
      : TdxTileControlVirtualGroupViewInfo): TdxTileControlGroup;
    ...
    function IsDragBoundsCrossesOnTheRight(AGroup: TdxTileControlGroup)
      : Boolean;
    ...
    function IsPossibleIncreaseGroup(AGroup: TdxTileControlGroup;
      var AAccepted: Boolean): Boolean;
    procedure MoveDragItemFromControl;
    procedure MoveDragItemToGroup(AGroup: TdxTileControlGroup;
      AIndexInGroup: Integer);
  ...
  protected
    ...
    procedure EndDragAndDropItem(Accepted: Boolean;
      var ANewGroup: TdxTileControlGroup); override;
    procedure InitializeDragImage; override;
  ...
  protected
    ...
    procedure ChangeScaleEx(M: Integer; D: Integer;
      IsDPIChanged: Boolean); override;
  ...
  public
    constructor Create(AImageItem: TcxImageCollectionItem; AOutputSize: TSize;
  ...
  public
    constructor Create;
    destructor Destroy; override;
    procedure AddTask(AImageItem: TcxImageCollectionItem; AOutputSize: TSize;
      ACallBackProc: TNotifyEvent);
  ...
  TdxTileControlDesignTimeMenuItemCheckedCondition = function
    (AItem: TdxTileControlItem): Boolean of object;

  TdxTileControlController = class(TcxIUnknownObject, IdxAnimationListener,
  ...
  private
    ...
    function GetViewInfo: TdxTileControlViewInfo;
    procedure RestoreItemBounds(AItem: TdxTileControlItem;
      const AData: Pointer);
    procedure SetHottrackedItem(AValue: TdxTileControlItem);
    procedure SetPressedScrollButton
      (AValue: TdxTileControlScrollButtonViewInfo);
    // design PopupMenu
    function CheckCallerGroup: TdxTileControlGroup;
    function CreatePopupMenuItem(const ACaption: string; const ATag: Integer;
      const AGroupIndex: Byte; const AChecked, ARadioItem: Boolean;
    ...
    procedure DeleteTileControlGroups(const ASelectNextObjectAfterDelete
      : Boolean);
    procedure DeleteTileControlItems(const ASelectNextObjectAfterDelete
      : Boolean);
    ...
    function GetNextObject(ADeletedItemIndex: Integer;
      ADeletedItemGroup: TdxTileControlGroup): TPersistent; overload;
  protected
    ...
    // design popup menu
    procedure AddDesignPopupMenuItem(const ACaption: string;
      const ATag: Integer; const AGroupIndex: Byte;
      const AChecked, ARadioItem: Boolean; AOnClick: TNotifyEvent);
    function CreateRegularItem(AGroup: TdxTileControlGroup)
      : TdxTileControlItem; virtual;
    ...
    function IsDesignerMenuItemChecked(const AItemSizeIndex: Integer;
      AItem: TdxTileControlItem): Boolean; overload; virtual;
    function IsDesignerMenuItemChecked(AItem: TdxTileControlItem;
      AFunc: TdxTileControlDesignTimeMenuItemCheckedCondition)
      : Boolean; overload;
    ...
    procedure SetDesignItemSize(AItem: TdxTileControlItem;
      AMenuItemTag: Longint); virtual;
    ...
    // action bars
    procedure HideActionBars(AReason
      : TdxTileControlActionBarVisibilityChangeReason);
    procedure ShowActionBars(AReason
      : TdxTileControlActionBarVisibilityChangeReason);
    procedure ToggleActionBars(AReason
      : TdxTileControlActionBarVisibilityChangeReason);
    //
    ...
    property DesignPopupMenuCaller: TcxComponentCollectionItem
      read FDesignPopupMenuCaller;
    ...
    property ItemsContentAnimationLockCount: Integer
      read FItemsContentAnimationLockCount;
    property MouseDownWasHandled: Boolean read FMouseDownWasHandled
      write FMouseDownWasHandled;
    property Navigator: TdxTileControlItemNavigator read FNavigator;
    property RestoreItemsBoundsOnMouseUp: Boolean
      read FRestoreItemsBoundsOnMouseUp;
  ...
  public
    ...
    property FocusedItem: TdxTileControlItem read FFocusedItem
      write SetFocusedItem;
    property HottrackedItem: TdxTileControlItem read FHottrackedItem
      write SetHottrackedItem;
    property PressedScrollButton: TdxTileControlScrollButtonViewInfo
      read FPressedScrollButton write SetPressedScrollButton;
    // for internal use
  end;
  ...
  protected
    ...
    property ActiveViewInfo: TdxTileControlCustomViewInfo
      read GetActiveViewInfo;
    property BitState[AIndex: Integer]: Boolean read GetBitState
      write SetBitState;
    property Controller: TdxTileControlController read GetController;
    property ScrollButton: TdxTileControlScrollButtonViewInfo
      read GetScrollButton;
  public
    ...
    property Group: TdxTileControlGroup read GetGroup;
    property HitAtActionBarBottom: Boolean index tchtActionBarBottom
      read GetBitState;
    ...
    property HitAtScrollButtonArea: Boolean index tchtScrollButtonArea
      read GetBitState;
    property HitAtTabScrollButton: Boolean index tchtTabScrollButton
      read GetBitState;
  ...
  private
    ...
    function GetGroupLayout: TdxTileControlGroupLayout;
    function GetGroups: TdxTileControlGroupCollection;
    function CheckGroupOnExistenceOfItemsStartingFromRow
      (AGroup: TdxTileControlGroup; const ARow: Integer): Boolean;
    ...
    function GetItemByBackSearchOnColumns(AGroup: TdxTileControlGroup;
      const AStartColumn, AEndColumn: Integer): TdxTileControlItem;
    function GetItemByBackSearchOnRows(AGroup: TdxTileControlGroup;
      const AStartRow, AEndRow: Integer): TdxTileControlItem;
    function GetItemByForwardSearchOnColumns(AGroup: TdxTileControlGroup;
      const AStartColumn, AEndColumn: Integer): TdxTileControlItem;
    function GetItemByForwardSearchOnRows(AGroup: TdxTileControlGroup;
      const AStartRow, AEndRow: Integer): TdxTileControlItem;
    function GetNextItemInColumnAboveTheCurrentWhenHorizontalLayout
      (const ACurrentGroupIndex: Integer): TdxTileControlItem;
    function GetNextItemInColumnAboveTheCurrentWhenVerticalLayout
      (const ACurrentGroupIndex: Integer): TdxTileControlItem;
    function GetNextItemInColumnBelowTheCurrent(const ACurrentGroupIndex
      : Integer): TdxTileControlItem;
    function GetNextItemInNextRowWhenHorizontalLayout(const ACurrentGroupIndex
      : Integer): TdxTileControlItem;
    function GetNextItemInNextRowWhenVerticalLayout(const AStartRow,
      ACurrentGroupIndex: Integer): TdxTileControlItem;
    function GetNextItemInRowToRightHand(AStartColumn, ACurrentGroupIndex
      : Integer): TdxTileControlItem;
    function GetPrevItemInColumnBelowTheCurrentWhenHorizontalLayout
      (const AStartRow, ACurrentGroupIndex: Integer): TdxTileControlItem;
    function GetPrevItemInColumnBelowTheCurrentWhenVerticalLayout
      (const ACurrentGroupIndex: Integer): TdxTileControlItem;
    function GetPrevItemInColumnAboveTheCurrent(const ACurrentGroupIndex
      : Integer): TdxTileControlItem;
    function GetPrevItemInPrevRowWhenHorizontalLayout(const ACurrentGroupIndex
      : Integer): TdxTileControlItem;
    function GetPrevItemInPrevRowWhenVerticalLayout(const AStartRow,
      ACurrentGroupIndex: Integer): TdxTileControlItem;
    function GetPrevItemInRowToLeftHand(AStartColumn, ACurrentGroupIndex
      : Integer): TdxTileControlItem;
    function GetNextRow(const AIncrement: Integer;
      var AGroupIndex: Integer): Integer;
    function GetNextRowWhenHorizontalLayout(const AIncrement: Integer): Integer;
    function GetNextRowWhenVerticalLayout(const AIncrement: Integer;
      var AGroupIndex: Integer): Integer;
  ...
  protected
    ...
    property CurrentItem: TdxTileControlItem read GetCurrentItem
  ...
  TdxTileItemInnerObjectAlignment = (oaDefault, oaTopLeft, oaTopCenter,
    oaTopRight, oaMiddleLeft, oaMiddleCenter, oaMiddleRight, oaBottomLeft,
    oaBottomCenter, oaBottomRight);
  TdxTileControlImageWithTextAlignment = (itaNone, itaLeft, itaTop, itaRight,
    itaBottom);
  ...
  published
    property Align: TdxTileItemInnerObjectAlignment read FAlign write SetAlign
      default oaDefault;
    property Alignment: TAlignment read FAlignment write SetAlignment
      default taLeftJustify;
    property AssignedValues: TdxTileItemTextAssignedValues read FAssignedValues
      write SetAssignedValues;
    property Color: TColor read FColor write SetColor default clDefault;
    property Font: TFont read FFont write SetFont stored IsFontStored;
    property IndentHorz: Integer read FIndentHorz write SetIndentHorz
      default dxTileItemObjectDefaultIndent;
    property IndentVert: Integer read FIndentVert write SetIndentVert
      default dxTileItemObjectDefaultIndent;
  ...
  published
    property Align: TdxTileItemInnerObjectAlignment read FAlign write SetAlign
      default oaDefault;
    property AlignWithText: TdxTileControlImageWithTextAlignment
      read FAlignWithText write SetAlignWithText default itaNone;
  ...
  published
    property BorderColor: TColor read FBorderColor write SetBorderColor
      default clDefault;
    property Font: TFont read FFont write SetFont stored IsFontStored;
    property Gradient: TdxSkinGradientMode read FGradient write SetGradientMode
      default gmHorizontal;
    property GradientBeginColor: TColor read FGradientBeginColor
      write SetGradientBeginColor default clDefault;
    property GradientEndColor: TColor read FGradientEndColor
      write SetGradientEndColor default clDefault;
    property Stretch: TdxSkinStretchMode read FStretch write SetStretch
      default smStretch;
  ...
  public
    ...
    procedure Assign(ASource: TPersistent); override;
  published
    property AnimationInterval: Integer read FAnimationInterval
      write FAnimationInterval default dxTileControlActivateDetailAnimationTime;
    property AnimationMode: TdxTileControlDetailAnimationMode
      read FAnimationMode write FAnimationMode default damScroll;
  end;

  { TdxTileControlCustomItemOptionsAnimate }

  TdxTileControlItemOptionsAnimateAssignedValue = (ioaavAnimateText);
  TdxTileControlItemOptionsAnimateAssignedValues = set of
  ...
  protected
    ...
    function GetParentOptionsAnimate
      : TdxTileControlCustomItemOptionsAnimate; virtual;
    //
    property AssignedValues: TdxTileControlItemOptionsAnimateAssignedValues
      read FAssignedValues write FAssignedValues stored False;
    property ParentOptionsAnimate: TdxTileControlCustomItemOptionsAnimate
      read GetParentOptionsAnimate;
  public
    constructor Create(AOwner: TPersistent); override;
  published
    property AnimateText: Boolean read GetAnimateText write SetAnimateText
      stored IsAnimateTextStored;
  end;
  ...
  protected
    procedure AdjustObjectBounds(const ABounds: TRect; var AObjectBounds: TRect;
      AAlign: TdxTileItemInnerObjectAlignment;
      AIndentHorz, AIndentVert: Integer);
    procedure AdjustImageBoundsWithText(const ABounds: TRect;
    ...
    procedure DrawItemText(ACanvas: TcxCustomCanvas;
      const ATextBounds, AClientRect: TRect;
      AText: TdxTileControlItemText); virtual;
    procedure DrawItemTexts(ACanvas: TcxCustomCanvas; const AOrigin: TPoint;
  ...
  protected
    function GetParentOptionsAnimate
      : TdxTileControlCustomItemOptionsAnimate; override;
  published
  ...
  protected
    ...
    function CreateOptionsAnimate: TdxTileControlItemOptionsAnimate;
      virtual; abstract;
    function CreateText(const AAlign: TdxTileItemInnerObjectAlignment)
      : TdxTileControlItemText; virtual;
    ...
    property OptionsAnimate: TdxTileControlItemOptionsAnimate
      read FOptionsAnimate write SetOptionsAnimate;
  ...
  public
    ...
    property Margins: TcxMargin read FMargins write SetMargins
      stored IsMarginsStored;
    property Style: TdxTileControlCustomStyle read FStyle write SetStyle
      stored IsStyleStored;
  ...
  TdxTileControlItemFrameOptionsAnimate = class
    (TdxTileControlItemOptionsAnimate)
  protected
    function GetParentOptionsAnimate
      : TdxTileControlCustomItemOptionsAnimate; override;
  ...
  published
    property Glyph: TdxTileControlItemFrameGlyph read GetGlyph write SetGlyph
  ...
  TdxTileControlForEachItemFrameProc = procedure(AItem: TdxTileControlItemFrame;
  ...
  protected
    procedure ChangeScale(M, D: Integer); virtual;
    procedure ForEach(AProc: TdxTileControlForEachItemFrameProc;
      const AData: Pointer);
  public
    function Add: TdxTileControlItemFrame;
    //
    property Owner: TdxTileControlItem read GetOwnerItem;
    property Items[Index: Integer]: TdxTileControlItemFrame read GetItem
  ...
  published
    ...
    property DetailControl: TWinControl read GetDetailControl
      write SetDetailControl;
  ...
  public
    ...
    property NextImage: TdxTileControlGalleryCellImage read FNextImage
      write SetNextImage;
  ...
  strict private
    ...
    function GetItem(AIndex: Integer): TdxTileControlItemGalleryCell; inline;
  public
    function CalculateHitTest(AHitTest: TdxTileControlHitTest)
      : Boolean; override;

    property Items[Index: Integer]: TdxTileControlItemGalleryCell
      read GetItem; default;
    property Cells[ARow, AColumn: Integer]: TdxTileControlItemGalleryCell
      read GetCell;
  end;
  ...
  protected
    ...
    property TileControl: TdxCustomTileControl read GetTileControl;
    property UntouchableCells: TdxTileControlGalleryCells
      read FUntouchableCells;
  public
  ...
  TdxTileControlItemAllowOperationEvent = procedure
    (Sender: TdxCustomTileControl; AItem: TdxTileControlItem;
    var AAllow: Boolean) of object;
  TdxTileControlItemFrameEvent = procedure(Sender: TdxTileControlItemFrame)
    of object;
  TdxTileControlItemEvent = procedure(Sender: TdxTileControlItem) of object;
  TdxTileControlItemOperationEvent = procedure(Sender: TdxCustomTileControl;
    AItem: TdxTileControlItem) of object;
  ...
  private
    ...
    procedure RefreshFrame(AItem: TdxTileControlItemFrame;
      const AData: Pointer);
  ...
  protected
    ...
    function CheckViewDataInitialized(AViewData
      : TdxTileControlCustomItemViewData): TdxTileControlCustomItemViewData;
    ...
    function GetCollectionFromParent(AParent: TComponent)
      : TcxComponentCollection; override;
    function GetDetailOptionsClass
      : TdxTileControlItemDetailOptionsClass; virtual;
    function GetTileItem: TdxTileControlItem; override;
    ...
    procedure OnEndGalleryCellAnimation(AAnimation
      : TdxTileControlGalleryCellAnimation);
    ...
    procedure SetDetailOptions
      (AValue: TdxTileControlItemDetailOptions); virtual;
  ...
  public
    ...
    property ActiveFrame: TdxTileControlItemFrame read GetActiveFrame
  ...
  published
    property AnimationInterval: Integer read FAnimationInterval
      write SetAnimationInterval default dxTileControlDefaultAnimationInterval;
    property AnimationMode: TdxDrawAnimationMode read FAnimationMode
      write FAnimationMode default dxTileControlDefaultAnimationMode;
    property DetailOptions: TdxTileControlItemDetailOptions read FDetailOptions
      write SetDetailOptions stored IsDetailOptionsStored;
    property Enabled: Boolean read FEnabled write SetEnabled default True;
    property Frames: TdxTileControlItemFrames read FFrames write SetFrames;
    property GalleryImages: TcxImageCollection read FGalleryImages
      write SetGalleryImages;
    property Glyph: TdxTileControlItemGlyph read GetGlyph write SetGlyph
      stored IsGlyphStored;
    ...
    property RowCount: Integer read FRowCount write SetRowCount
      default dxTileControlDefaultItemRowCount;
    property Size: TdxTileControlItemSize read FSize write SetSize
      default tcisRegular;
    ...
    property Visible;
    // Events
    property OnActivateDetail: TdxTileControlItemEvent read FOnActivateDetail
      write SetOnActivateDetail;
    property OnActiveFrameChanged: TdxTileControlItemEvent
      read FOnActiveFrameChanged write FOnActiveFrameChanged;
    property OnClick: TdxTileControlItemEvent read FOnClick write FOnClick;
    property OnDeactivateDetail: TdxTileControlItemEvent
      read FOnDeactivateDetail write FOnDeactivateDetail;
    property OnDeactivatingDetail: TdxTileControlItemAllowOperationEvent
      read FOnDeactivatingDetail write FOnDeactivatingDetail;
    property OnFrameDestroy: TdxTileControlItemFrameEvent read FOnFrameDestroy
      write FOnFrameDestroy;
    property OnFrameInitialize: TdxTileControlItemFrameEvent
      read FOnFrameInitialize write FOnFrameInitialize;
    // IcxStoredObject events
  ...
  TdxTileControlForEachItemProc = procedure(AItem: TdxTileControlItem;
    const AData: Pointer) of object;
  ...
  protected
    procedure ChangeScale(M, D: Integer); override;
    procedure ForEach(AProc: TdxTileControlForEachItemProc;
  ...
  TdxTileControlGroup = class(TcxComponentCollectionItem, IcxStoredObject,
    IcxStoredParent)
  private
    ...
    procedure IcxStoredParent.GetChildren = StoredChildren;
  protected
    procedure AssignFrom(AGroup: TdxTileControlGroup;
      AExcludeItem: TdxTileControlItem = nil);
    procedure ChangeScale(M, D: Integer); virtual;
    procedure CreateCaptionEditor;
    procedure GroupChanged; virtual;
    function GetCollectionFromParent(AParent: TComponent)
      : TcxComponentCollection; override;
    function GetCustomIndent(AVirtualGroup
      : TdxTileControlVirtualGroupViewInfo): Integer;
    ...
    property Bounds: TRect read GetBounds;
    property CaptionEditor: TdxTileControlGroupCaptionInplaceEdit
      read FCaptionEditor;
    ...
    property VirtualGroupBefore: TdxTileControlVirtualGroupViewInfo
      read FVirtualGroupBefore;
    property VirtualGroupAfter: TdxTileControlVirtualGroupViewInfo
      read FVirtualGroupAfter;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
  ...
  published
    ...
    property Caption: TdxTileControlGroupCaption read FCaption write SetCaption
  ...
  TdxTileControlGroupCaptionViewInfo = class
    (TdxTileControlAnimatedDragAndDropCustomCellViewInfo)
  private
    FCaption: TdxTileControlGroupCaption;
    FFont: TFont;
  ...
  strict private
    ...
    procedure SetItem(AIndex: Integer;
      const AValue: TdxTileControlGroup); inline;
  protected
    procedure ChangeScale(M, D: Integer); override;
    function GetNextVisibleGroup(AGroup: TdxTileControlGroup)
      : TdxTileControlGroup;
    function GetPrevVisibleGroup(AGroup: TdxTileControlGroup)
      : TdxTileControlGroup;
    procedure Loaded; virtual;
  ...
  public
    ...
    property Items[Index: Integer]: TdxTileControlGroup read GetItem
      write SetItem; default;
  end;
  ...
  public
    ...
    procedure Assign(ASource: TPersistent); override;
  published
    property CheckedItemCheckMarkColor: TColor read FCheckedItemCheckMarkColor
      write SetCheckedItemCheckMarkColor default clDefault;
    property CheckedItemFrameColor: TColor read FCheckedItemFrameColor
      write SetCheckedItemFrameColor default clDefault;
  ...
  protected
    ...
    function GetDefaultItemHotTrackMode
      : TdxTileControlItemHotTrackMode; virtual;
  ...
  public
    ...
    procedure Assign(ASource: TPersistent); override;
  published
    property BackgroundScrollSync: Byte read FBackgroundScrollSync
      write SetBackgroundScrollSync default dxTileControlDefaultScrollSync;
    property FocusItemOnCycle: Boolean read FFocusItemOnCycle
      write FFocusItemOnCycle default True;
    property GroupCaptionHint: string read FGroupCaptionHint
      write FGroupCaptionHint stored IsGroupCaptionHintStored;
    property GroupMoving: Boolean read FGroupMoving write FGroupMoving
      default False;
    property GroupRenaming: Boolean read FGroupRenaming write SetGroupRenaming
      default False;
    property HideFocusOnItemHotTrack: Boolean read FHideFocusOnItemHotTrack
      write FHideFocusOnItemHotTrack default False;
    property ItemCheckMode: TdxTileControlItemCheckMode read FItemCheckMode
      write SetItemCheckMode stored IsItemCheckModeStored;
    property ItemFocusMode: TdxTileControlItemFocusMode read FItemFocusMode
      write SetItemFocusMode stored IsItemFocusModeStored;
    property ItemHotTrackHighlightColor: TdxAlphaColor
      read FItemHotTrackHighlightColor write SetItemHotTrackHighlightColor
      stored IsItemHotTrackHighlightColorStored;
    property ItemHotTrackMode: TdxTileControlItemHotTrackMode
      read FItemHotTrackMode write SetItemHotTrackMode
      stored IsItemHotTrackModeStored;
    property ItemMoving: Boolean read FItemMoving write SetItemMoving
      stored IsItemMovingStored;
    property ItemOuterFrameColor: TColor read FItemOuterFrameColor
      write SetItemOuterFrameColor default clDefault;
    property ItemPressAnimation: Boolean read FItemPressAnimation
      write SetItemPressAnimation stored IsItemPressAnimationStored;
    property ScrollMode: TdxTileControlScrollMode read FScrollMode
      write SetScrollMode stored IsScrollModeStored;
  end;
  ...
  public
    ...
    procedure Assign(ASource: TPersistent); override;
  published
    property CenterContentHorz: Boolean read FCenterContentHorz
      write SetCenterContentHorz default False;
    property CenterContentVert: Boolean read FCenterContentVert
      write SetCenterContentVert default False;
    property FixedIndentHorz: Boolean read FFixedIndentHorz
      write SetFixedIndentHorz stored IsFixedIndentHorzStored;
    property FixedIndentVert: Boolean read FFixedIndentVert
      write SetFixedIndentVert stored IsFixedIndentVertStored;
    property GroupBlockMaxColumnCount: Integer read FGroupBlockMaxColumnCount
      write SetGroupBlockMaxColumnCount stored IsGroupBlockMaxColumnCountStored;
    property GroupIndent: Integer read FGroupIndent write SetGroupIndent
      stored IsGroupIndentStored;
    property GroupLayout: TdxTileControlGroupLayout read FGroupLayout
      write SetGroupLayout default glHorizontal;
    property GroupMaxRowCount: Integer read FGroupMaxRowCount
      write SetGroupMaxRowCount stored IsGroupMaxRowCountStored;
    property IndentHorz: Integer read FIndentHorz write SetIndentHorz
      stored IsIndentHorzStored;
    property IndentVert: Integer read FIndentVert write SetIndentVert
      stored IsIndentVertStored;
    property ItemHeight: Integer read FItemHeight write SetItemHeight
      stored IsItemHeightStored;
    property ItemIndent: Integer read FItemIndent write SetItemIndent
      stored IsItemIndentStored;
    property ItemWidth: Integer read FItemWidth write SetItemWidth
      stored IsItemWidthStored;
  end;
  ...
  private
    ...
    FRowCount: Integer;
    FScrollButtonViewInfo: array [TcxArrowDirection]
      of TdxTileControlScrollButtonViewInfo;
    FTileControl: TdxCustomTileControl;
    FTilesArea: TRect;
    FTilesZone: TRect;
    ...
    procedure DoCenterContentHorzAtHorizontalGroupLayout(const AShift,
      AAreaRight: Integer);
    ...
    procedure DoCenterContentVertAtVerticalGroupLayout(const AShift,
      AAreaBottom: Integer);
  ...
  protected
    ...
    function CalculateFrameSelectionClipRect(const R: TRect;
      AFrameSize: Integer): TRect;
    procedure DoCalculate; virtual;
    ...
    function GetScaleFactor: TdxScaleFactor; override;
    function GetScrollButtonViewInfoClass
      : TdxTileControlScrollButtonViewInfoClass; virtual;
    ...
    function IsScrollAvailable(ADirection: TcxArrowDirection): Boolean;
      overload;
    procedure ItemDestroyed(AItem: TdxTileControlItem);
    procedure MakeVisible(const ABounds: TRect;
      AIsMostLeft, AIsMostTop, AIsMostRight, AIsMostBottom: Boolean);
  ...
  public
    ...
    property TitleViewInfo: TdxTileControlTitleViewInfo read GetTitleViewInfo;
    // for internal use
  ...
  strict private
    ...
    function GetTextOutFlags(AAlignment: TAlignment;
      AVertAlignment: TcxAlignmentVert; AWordWrap: Boolean): Integer;
    function GetUserSkins: Boolean;
  protected
    procedure DrawDefaultItemBackground(ACanvas: TcxCustomCanvas;
      const R: TRect); virtual;
    procedure DrawDefaultItemCheck(ACanvas: TcxCustomCanvas; const R: TRect);
      overload; virtual;
    procedure DrawDefaultItemCheck(ACanvas: TcxCustomCanvas; const R: TRect;
      ABackgroundColor, ACheckMarkColor: TColor; AAlpha: Byte = MaxByte);
      overload; virtual;
    procedure DrawDefaultItemCheck(ACanvas: TdxGPCanvas; const R: TRect;
      ABackgroundColor, ACheckMarkColor: TdxAlphaColor;
      AScaleFactor: TdxScaleFactor); overload; virtual;
    procedure DrawHighlightRect(ACanvas: TcxCustomCanvas; const R: TRect;
      AHighlightColor: TdxAlphaColor;
      ABackgroundColor: TColor = clNone); virtual;
    procedure DrawItemCheck(ACanvas: TcxCustomCanvas; const R: TRect); virtual;
    procedure DrawStyleRect(ACanvas: TcxCustomCanvas; const R: TRect;
      AStyle: TdxTileControlCustomStyle;
      ATextureOffsetX, ATextureOffsetY: Integer;
      ATextureCache: PcxCanvasBasedImage = nil);
    procedure DrawStyleRectFrame(ACanvas: TcxCustomCanvas; const R: TRect;
      AStyle: TdxTileControlCustomStyle);
    procedure DrawStyleTexture(ACanvas: TcxCustomCanvas; R: TRect;
      AStyle: TdxTileControlCustomStyle;
      ATextureOffsetX, ATextureOffsetY: Integer;
      ATextureCache: PcxCanvasBasedImage = nil);
    ...
    function GetItemOuterFrameColor(AItem: TdxTileControlCustomItem)
      : TColor; virtual;
  ...
  public
    ...
    procedure DrawDesignTimeBorder(ACanvas: TcxCustomCanvas; const R: TRect;
      ASelected: Boolean); virtual;
    procedure DrawGlyph(ACanvas: TcxCustomCanvas; const R: TRect;
      AGlyph: TdxSmartImage); overload; virtual;
    procedure DrawGlyph(ACanvas: TcxCustomCanvas; const R: TRect;
      AGlyph: TdxSmartImage; AImages: TCustomImageList;
      AImageIndex: TcxImageIndex; ADrawMode: TcxImageDrawMode = idmNormal);
      overload; virtual;
    procedure DrawGlyph(ACanvas: TcxCustomCanvas; const R: TRect;
      AState: TcxButtonState; AGlyph: TdxSkinImage; AGlyphType: TImageType;
      AColor: TColor; AIsRTL: Boolean = False); overload; virtual;
    procedure DrawItemBackground(ACanvas: TcxCustomCanvas; const R: TRect;
      AStyle: TdxTileControlCustomStyle); virtual;
    procedure DrawItemPlace(ACanvas: TcxCustomCanvas; const R: TRect); virtual;
    procedure DrawPageTab(ACanvas: TcxCustomCanvas; const R: TRect;
      AState: TcxButtonState); virtual;
    procedure DrawText(ACanvas: TcxCustomCanvas; const R: TRect;
      const AText: string; AFont: TFont; AColor: TColor;
      AAlignment: TAlignment = taLeftJustify;
      AVertAlignment: TcxAlignmentVert = vaCenter; AWordWrap: Boolean = False;
      APaintOnGlass: Boolean = False); virtual;
    procedure DrawVirtualGroup(ACanvas: TcxCustomCanvas;
      const R: TRect); virtual;
    //
    function MeasureTextSize(ACanvas: TcxCustomCanvas; const AText: string;
      AFont: TFont; AAlignment: TAlignment; AWordWrap: Boolean;
      AMaxWidth, AMaxHeight: Integer): TSize; virtual;
    //
    class function GetColorAsItemBackground
      (AItem: TdxTileControlCustomItem): TColor;
    function GetSelectionFocusedColor(AItem: TdxTileControlCustomItem = nil)
      : TColor; virtual;
    function GetSelectionHottrackedColor(AItem: TdxTileControlCustomItem = nil)
      : TColor; virtual;
    procedure ValidatePainterData; virtual;
    //
    property ActionBarDefaultBackgroundColor: TColor
      read GetActionBarDefaultBackgroundColor;
    property ActionBarDefaultTextColor: TColor
      read GetActionBarDefaultTextColor;
    property CheckedItemCheckMarkColor: TColor
      read GetCheckedItemCheckMarkColor;
    property CheckedItemFrameColor: TColor read GetCheckedItemFrameColor;
    property DefaultItemTextBackgroundColor: TColor
      read GetDefaultItemTextBackgroundColor;
    property DefaultItemTextColor: TColor read GetDefaultItemTextColor;
    property GroupCaptionDefaultFontSize: Integer
      read GetGroupCaptionDefaultFontSize;
    property GroupCaptionDefaultTextColor: TColor
      read GetGroupCaptionDefaultTextColor;
    ...
    property PageTabTextColor[AState: TcxButtonState]: TColor
      read GetPageTabTextColor;
    property ScaleFactor: TdxScaleFactor read GetScaleFactor;
  ...
  protected
    ...
    property GlyphAlignHorz: TAlignment read FGlyphAlignHorz
      write SetGlyphAlignHorz default taRightJustify;
    property GlyphAlignVert: TcxAlignmentVert read FGlyphAlignVert
      write SetGlyphAlignVert default vaBottom;
    property TextAlignHorz: TAlignment read FTextAlignHorz
      write SetTextAlignHorz default taLeftJustify;
    property TextAlignVert: TcxAlignmentVert read FTextAlignVert
      write SetTextAlignVert default vaBottom;
    property TileControl: TdxCustomTileControl read GetTileControl;
  ...
  published
    ...
    property IndentVert: Integer read FIndentVert write SetIndentVert
      default dxTileItemObjectDefaultIndent;
    property TabsActiveTextColor: TColor read FTabsActiveTextColor
      write SetTabsActiveTextColor default clDefault;
    property TabsDisabledTextColor: TColor read FTabsDisabledTextColor
      write SetTabsDisabledTextColor default clDefault;
    property TabsFontSize: Integer read FTabsFontSize write SetTabsFontSize
      default dxTileControlDefaultTabFontSize;
    property TabsHotTextColor: TColor read FTabsHotTextColor
      write SetTabsHotTextColor default clDefault;
    property TabsTextColor: TColor read FTabsTextColor write SetTabsTextColor
      default clDefault;
    property Text: string read FText write SetText;
  end;
  ...
  public
    constructor Create(AOwner: TdxTileControlDetailSiteTitleViewInfo;
  ...
  TdxTileControlDetailSiteBackButtonViewInfo = class
    (TdxTileControlCustomButtonViewInfo)
  private
  ...
  protected
    procedure DoCalculate; override;
    procedure DoCalculateTopLeft(const ASizeX, ASizeY: Integer;
      var ATop, ALeft: Integer); virtual;
    procedure DoDraw(ACanvas: TcxCustomCanvas); override;
  ...
  public
    constructor Create(AOwner: TdxCustomTileControl;
      ADirection: TcxArrowDirection); virtual;
    destructor Destroy; override;
    procedure Invalidate; override;
    procedure RefreshState; override;
  ...
  TdxTileControlDetailSiteTabsScrollButtonViewInfo = class
    (TdxTileControlCustomCellViewInfo, IcxMouseTrackingCaller,
    IcxMouseTrackingCaller2)
  strict private
    FDirection: TcxArrowDirection;
    FOwner: TdxTileControlDetailSiteTitleViewInfo;
  ...
  public
    constructor Create(AOwner: TdxTileControlDetailSiteTitleViewInfo;
      ATime: Cardinal; const ALength: Integer); reintroduce; virtual;
  end;
  ...
  protected
    ...
    procedure CheckBiDiModeAlignment; virtual;
    function CreateBackButtonViewInfo
      : TdxTileControlDetailSiteBackButtonViewInfo; virtual;
    procedure CreateScrollTabsButtons; virtual;
    function CreateTabCellViewInfo(AItem: TdxTileControlItem)
      : TdxTileControlPageTabCellViewInfo; virtual;
    ...
    function GetHeight: Integer; override;
    function GetHitTest(AHitTest: TdxTileControlHitTest): Boolean; override;
    function GetTabsScrollButtonsHitTest(AHitTest: TdxTileControlHitTest)
      : Boolean; virtual;
    function GetVisibleBounds: TRect; override;
    ...
    property TabsLeftScrollPos: Integer read FTabsLeftScrollPos
      write SetTabsLeftScrollPos;
  public
    constructor Create(AOwner: TdxTileControlDetailSite); virtual;
    destructor Destroy; override;
    procedure RefreshState; override;

    property BackButtonViewInfo: TdxTileControlDetailSiteBackButtonViewInfo
      read FBackButtonViewInfo;
    property Item: TdxTileControlItem read GetItem;
    property Owner: TdxTileControlDetailSite read FOwner;
    property ScrollTabsLeftButton
      : TdxTileControlDetailSiteTabsScrollButtonViewInfo
      read FScrollTabsLeftButton;
    property ScrollTabsRightButton
      : TdxTileControlDetailSiteTabsScrollButtonViewInfo
      read FScrollTabsRightButton;
  ...
  TdxTileControlCustomPopupControl = class(TcxControl, IcxMouseTrackingCaller,
    IcxMouseTrackingCaller2)
  private
  ...
  protected
    ...
    function GetTileControl: TdxCustomTileControl; override;
    function GetTitleViewInfoClass
      : TdxTileControlDetailSiteTitleViewInfoClass; virtual;
    ...
    //
    property PressedCell: TdxTileControlCustomCellViewInfo read FPressedCell
      write SetPressedCell;
    property TitleViewInfo: TdxTileControlDetailSiteTitleViewInfo
      read FTitleViewInfo;
  public
  ...
  TdxTileControlActionBarItemEvent = procedure
    (Sender: TdxTileControlActionBarItem) of object;
  TdxTileControlActionBarVisibilityChangeEvent = procedure
    (Sender: TdxCustomTileControl;
    AReason: TdxTileControlActionBarVisibilityChangeReason;
  ...
  public
    ...
    procedure Click;
  published
    property Align: TdxTileControlActionBarItemAlignment read FAlign
      write SetAlign default abiaLeft;
    property Caption: string read FCaption write SetCaption;
    property Glyph: TdxSmartImage read GetGlyph write SetGlyph;
    property GlyphFrameCount: Integer read GetGlyphFrameCount
      write SetGlyphFrameCount default 1;
    property GlyphType: TImageType read FGlyphType write SetGlyphType
      default itMask;
    property ImageIndex: TcxImageIndex read FImageIndex write SetImageIndex
      default -1;
    property Position: TdxTileControlActionBarItemPosition read FPosition
      write SetPosition default abipBottomBar;
    property Visible: Boolean read FVisible write SetVisible default True;
    //
    property OnClick: TdxTileControlActionBarItemEvent read FOnClick
      write FOnClick;
  end;
  ...
  public
    ...
    //
    property Items[Index: Integer]: TdxTileControlActionBarItem read GetItem
      write SetItem; default;
  end;

  { TdxTileControlActionBarCustomItemViewInfo }

  TdxTileControlActionBarCustomItemViewInfo = class
    (TdxTileControlCustomButtonViewInfo)
  private
  ...
  protected
    ...
    procedure CheckBiDiModeAlignment; virtual;
    function CreateItemViewInfo(AItem: TdxTileControlActionBarItem)
      : TdxTileControlActionBarCustomItemViewInfo; virtual;
    function GetCanDisplayItem(AItem: TdxTileControlActionBarItem)
      : Boolean; virtual;
    function GetHitTest(AHitTest: TdxTileControlHitTest): Boolean; override;
    function GetScaleFactor: TdxScaleFactor; override;
  public
  ...
  TdxTileControlActionBarItemViewInfo = class
    (TdxTileControlActionBarCustomItemViewInfo)
  private
  ...
  TdxTileControlActionBarController = class(TcxIUnknownObject,
    IcxMouseTrackingCaller, IcxMouseTrackingCaller2)
  private
    FHotCell: TObject;
    FOwner: TdxTileControlCustomActionBar;
  ...
  protected
    ...
    function CreateViewInfo: TdxTileControlCustomActionBarViewInfo;
      virtual; abstract;
    procedure DoPaint; override;
    procedure Recalculate;
    // Mouse
  ...
  TdxTileControlBottomActionBarViewInfo = class
    (TdxTileControlCustomActionBarViewInfo)
  protected
    function GetCanDisplayItem(AItem: TdxTileControlActionBarItem)
      : Boolean; override;
  ...
  TdxTileControlTopActionBarViewInfo = class
    (TdxTileControlCustomActionBarViewInfo)
  protected
    function CreateBackButtonViewInfo
      : TdxTileControlActionBarCustomItemViewInfo; virtual;
  ...
  TdxTileControlTopActionBarBackButtonViewInfo = class
    (TdxTileControlActionBarCustomItemViewInfo)
  protected
    function GetHitTest(AHitTest: TdxTileControlHitTest): Boolean; override;
    function GetTexture: TdxSkinImage; override;
  ...
  published
    ...
    property Images: TCustomImageList read FImages write SetImages;
    property IndentHorz: Integer read FIndentHorz write SetIndentHorz
      default dxTileControlDefaultActionBarsIndentHorz;
    property IndentVert: Integer read FIndentVert write SetIndentVert
      default dxTileControlDefaultActionBarsIndentVert;
    property ItemIndent: Integer read FItemIndent write SetItemIndent
      default dxTileControlDefaultActionBarsItemIndent;
    property Items: TdxTileControlActionBarItems read FItems write SetItems;
  end;

  { TdxCustomTileControl }

  TdxTileControlChange = (tccLayout, tccSelection, tccItems, tccTitle,
    tccStyle);
  TdxTileControlChanges = set of TdxTileControlChange;

  TdxTileControlGroupDragBeginEvent = procedure(Sender: TdxCustomTileControl;
    AInfo: TdxTileControlDragGroupInfo; var AAllow: Boolean) of object;
  TdxTileControlGroupDragEndEvent = procedure(Sender: TdxCustomTileControl;
    AInfo: TdxTileControlDragGroupInfo) of object;
  TdxTileControlGroupDragOverEvent = procedure(Sender: TdxCustomTileControl;
    AInfo: TdxTileControlDragGroupInfo; var AAccept: Boolean) of object;
  TdxTileControlGroupRemoveWithLastItemEvent = procedure
    (Sender: TdxCustomTileControl; AGroup: TdxTileControlGroup;
    var AAllow: Boolean) of object;

  TdxTileControlItemDragBeginEvent = procedure(Sender: TdxCustomTileControl;
    AInfo: TdxTileControlDragItemInfo; var AAllow: Boolean) of object;
  TdxTileControlItemDragEndEvent = procedure(Sender: TdxCustomTileControl;
    AInfo: TdxTileControlDragItemInfo) of object;
  TdxTileControlItemDragOverEvent = procedure(Sender: TdxCustomTileControl;
    AInfo: TdxTileControlDragItemInfo; var AAccept: Boolean) of object;

  TdxTileControlItemFocusChange = procedure(Sender: TdxCustomTileControl;
    AFocusedItem, ANewFocusedItem: TdxTileControlItem) of object;

  TdxCustomTileControl = class(TcxControl, IcxStoredParent, IcxStoredObject,
    IdxSkinSupport)
  private
    ...
    procedure AnimationHandler(Sender: TdxAnimationTransition;
    ...
    procedure SetImages(AValue: TCustomImageList);
    procedure SetOptionsDetailAnimate
      (AValue: TdxTileControlDetailOptionsAnimate);
    procedure SetOptionsItemAnimate
      (AValue: TdxTileControlCustomItemOptionsAnimate);
    procedure SetStyle(AValue: TdxTileControlStyle);
    procedure SetTitle(AValue: TdxTileControlTitle);
    // scroll
    procedure ScrollHorz(AScrollBarKind: TScrollBarKind;
      AScrollCode: TScrollCode; var AScrollPos: Integer);
    procedure ScrollVert(AScrollBarKind: TScrollBarKind;
      AScrollCode: TScrollCode; var AScrollPos: Integer);
    // IcxStoredObject
    function GetObjectName: string;
    ...
    procedure WMHideGroupCaptionEditors(var Message: TMessage);
      message DXM_TILECONTROL_HIDEGROUPCAPTIONEDITORS;
  protected
    FCheckedItems: TdxTileControlCheckedItems;

    procedure AfterActiveDetailChanging(AActiveDetail,
      ANewDetail: TdxTileControlDetailSite); virtual;
    procedure BeforeActiveDetailChanging(AActiveDetail,
      ANewDetail: TdxTileControlDetailSite); virtual;
    ...
    function CanRemoveGroupIfEmpty(AGroup: TdxTileControlGroup)
      : Boolean; virtual;
    ...
    function CreateImagesFreeNotificator(AOnFree: TcxFreeNotificationEvent)
      : TcxFreeNotificator;
    ...
    function GetAnimationScrollFadeMode(AIndex1, AIndex2: Integer)
      : TdxDrawAnimationMode; virtual;
    function GetAnimationScrollMode(AIndex1, AIndex2: Integer)
      : TdxDrawAnimationMode; virtual;

    function CanDeactivateDetail(ADetail: TdxTileControlDetailSite)
      : Boolean; virtual;
    function DoActionBarsHide(AReason
      : TdxTileControlActionBarVisibilityChangeReason): Boolean; virtual;
    function DoActionBarsShow(AReason
      : TdxTileControlActionBarVisibilityChangeReason): Boolean; virtual;
    procedure DoActivateDetail(ADetail: TdxTileControlDetailSite); virtual;
    ...
    procedure ExecuteDetailDeactivating
      (ADetail: TdxTileControlDetailSite); virtual;

    procedure DoCustomPaint(ACanvas: TcxCustomCanvas); virtual;
    procedure DoPaint; override;

    procedure SetOptionsBehavior
      (AValue: TdxTileControlOptionsBehavior); virtual;
    ...
    procedure DoHideActionBars(AReason
      : TdxTileControlActionBarVisibilityChangeReason); virtual;
    procedure DoShowActionBars(AReason
      : TdxTileControlActionBarVisibilityChangeReason); virtual;
    ...
    function GetOptionsBehaviorClass
      : TdxTileControlOptionsBehaviorClass; virtual;
    ...
    function NeedStopAnimationsBeforeActiveDetailChanging
      (AActiveDetail: TdxTileControlDetailSite): Boolean; virtual;
    procedure Notification(AComponent: TComponent;
      Operation: TOperation); override;
    ...
    property OnActionBarsHide: TdxTileControlActionBarVisibilityChangeEvent
      read FOnActionBarsHide write FOnActionBarsHide;
    property OnActionBarsShow: TdxTileControlActionBarVisibilityChangeEvent
      read FOnActionBarsShow write FOnActionBarsShow;
    property OnGroupDragBegin: TdxTileControlGroupDragBeginEvent
      read FOnGroupDragBegin write FOnGroupDragBegin;
    property OnGroupDragEnd: TdxTileControlGroupDragEndEvent
      read FOnGroupDragEnd write FOnGroupDragEnd;
    property OnGroupDragOver: TdxTileControlGroupDragOverEvent
      read FOnGroupDragOver write FOnGroupDragOver;
    property OnGroupRemoveWithLastItem
      : TdxTileControlGroupRemoveWithLastItemEvent
      read FOnGroupRemoveWithLastItem write FOnGroupRemoveWithLastItem;
    property OnItemActivateDetail: TdxTileControlItemOperationEvent
      read FOnItemActivateDetail write FOnItemActivateDetail;
    property OnItemBeforeCheck: TdxTileControlItemAllowOperationEvent
      read FOnItemBeforeCheck write FOnItemBeforeCheck;
    property OnItemCheck: TdxTileControlItemOperationEvent read FOnItemCheck
      write FOnItemCheck;
    property OnItemDeactivateDetail: TdxTileControlItemOperationEvent
      read FOnItemDeactivateDetail write FOnItemDeactivateDetail;
    property OnItemDeactivatingDetail: TdxTileControlItemAllowOperationEvent
      read FOnItemDeactivatingDetail write FOnItemDeactivatingDetail;
    property OnItemDragBegin: TdxTileControlItemDragBeginEvent
      read FOnItemDragBegin write FOnItemDragBegin;
    property OnItemDragEnd: TdxTileControlItemDragEndEvent read FOnItemDragEnd
      write FOnItemDragEnd;
    property OnItemDragOver: TdxTileControlItemDragOverEvent
      read FOnItemDragOver write FOnItemDragOver;
    property OnItemFocusChange: TdxTileControlItemFocusChange
      read FOnItemFocusChange write FOnItemFocusChange;
    property OnItemFocusChanging: TdxTileControlItemAllowOperationEvent
      read FOnItemFocusChanging write FOnItemFocusChanging;
  ...
  public
    ...
    function CreateItem(AIsLarge: Boolean = False;
      AGroup: TdxTileControlGroup = nil): TdxTileControlItem; overload;
    function CreateItem(ASize: TdxTileControlItemSize;
      AGroup: TdxTileControlGroup = nil): TdxTileControlItem; overload;
    procedure DeleteItem(AItem: TdxTileControlItem);
    procedure EndUpdate;
    procedure GetChildren(Proc: TGetChildProc; Root: TComponent); override;
    ...
    property ActionBars: TdxTileControlActionBars read FActionBars
      write SetActionBars;
    property ActiveDetail: TdxTileControlDetailSite read FActiveDetail
      write SetActiveDetail;
    property ActiveHitTest: TdxTileControlHitTest read GetActiveHitTest;
    property CheckedItems[Index: Integer]: TdxTileControlItem
      read GetCheckedItem;
    ...
    property Images: TCustomImageList read FImages write SetImages;
    property OptionsBehavior: TdxTileControlOptionsBehavior
      read FOptionsBehavior write SetOptionsBehavior;
    property OptionsDetailAnimate: TdxTileControlDetailOptionsAnimate
      read FOptionsDetailAnimate write SetOptionsDetailAnimate;
    property OptionsItemAnimate: TdxTileControlCustomItemOptionsAnimate
      read FOptionsItemAnimate write SetOptionsItemAnimate;
    property OptionsView: TdxTileControlOptionsView read FOptionsView
      write SetOptionsView;
    property Style: TdxTileControlStyle read FStyle write SetStyle
      stored IsStyleStored;
    property Title: TdxTileControlTitle read FTitle write SetTitle
...
const
  ...
  dxTileControlStoredItemPropertiesNames: array [0 .. 5] of string = ('Visible',
    'Size', 'GroupIndex', 'IndexInGroup', 'RowCount', 'Enabled');

  dxTileControlStoredGroupPropertiesNames: array [0 .. 3] of string =
    ('Visible', 'Index', 'Enabled', 'Caption');

  dxMouseButtonToActionBarVisibilityChangeReason: array [TMouseButton]
    of TdxTileControlActionBarVisibilityChangeReason = (abvcrMouseLeftClick,
    abvcrMouseRightClick, abvcrMouseMiddleClick);

function dxGetBiDiModeTileItemInnerObjectAlignment
  (AAlign: TdxTileItemInnerObjectAlignment; AUseRightToLeftAlignment: Boolean)
  ...
  if AUseRightToLeftAlignment then
    case AAlign of
      ...
      oaTopRight:
        Result := oaTopLeft;
      oaMiddleLeft:
        Result := oaMiddleRight;
      oaMiddleRight:
        Result := oaMiddleLeft;
      oaBottomLeft:
        Result := oaBottomRight;
      oaBottomRight:
        Result := oaBottomLeft;
    end;
end;
...
type
  ...
  public
    ...
    procedure ProcessKeyDownOnControl(ATileControl: TdxCustomTileControl;
      AKey: Word);
    class procedure Register(ATileControl: TdxCustomTileControl);
    class procedure Unregister(ATileControl: TdxCustomTileControl);
  ...
  public
    constructor Create(ATileControl: TdxCustomTileControl;
      const ADragBounds, AGroupExpandedBounds: TRect); virtual;
...
procedure AddTileControlResourceStringNames
  (AProduct: TdxProductResourceStrings);
begin
  AProduct.Add('dxTileControlDefaultGroupCaptionHint',
    @dxTileControlDefaultGroupCaptionHint);
end;
...
procedure dxTileControlKeyboardHook(ACode: Integer; wParam: wParam;
  lParam: lParam; var AHookResult: LRESULT);
var
  I: Integer;
begin
  if (lParam > 0) and (DesignKeyDownHookHelper <> nil) and
    (DesignKeyDownHookHelper.CanProcessKeyboardHook) then
    for I := 0 to DesignKeyDownHookHelper.TileControls.Count - 1 do
      DesignKeyDownHookHelper.ProcessKeyDownOnControl
        (TdxCustomTileControl(DesignKeyDownHookHelper.TileControls[I]), wParam);
end;

procedure dxTileControlMouseHook(ACode: Integer; wParam: wParam; lParam: lParam;
  var AHookResult: LRESULT);

  procedure DoProcessClick(AButton: TMouseButton);
  begin
    if ActionsBarHelper <> nil then
      ActionsBarHelper.ProcessClickOnControl
        (FindControl(PMouseHookStruct(lParam).hwnd), AButton);
  end;
...
procedure AdjustFontHeight(AFont: TFont; AScaleFactor: TdxScaleFactor;
  AStoredFontSize, ADefaultFontSize: Integer);
begin
  if AFont.Height = AScaleFactor.Apply
    (dxGetFontHeightForDefaultDPI(AStoredFontSize)) then
    AFont.Height := AScaleFactor.Apply
      (dxGetFontHeightForDefaultDPI(ADefaultFontSize));
end;
...
procedure TdxTileControlActionsBarHelper.ProcessClickOnControl
  (AControl: TWinControl; AButton: TMouseButton);
  ...
  procedure HideActionBarsForAnotherTileControls(ACurrentTileControl
    : TdxCustomTileControl);
  var
    I: Integer;
  begin
    ...
    begin
      if FTileControls[I] <> ACurrentTileControl then
        TdxCustomTileControl(FTileControls[I])
          .DoHideActionBars(dxMouseButtonToActionBarVisibilityChangeReason
          [AButton]);
    end;
  end;
...
class procedure TdxTileControlActionsBarHelper.Register
...
class procedure TdxTileControlActionsBarHelper.Unregister
  (ATileControl: TdxCustomTileControl);
begin
  if ActionsBarHelper <> nil then
  begin
...
function TdxTileControlDesignKeyDownHookHelper.CanCustomize
  (ATileControl: TdxCustomTileControl): Boolean;
var
  AOwner: TWinControl;
begin
...
begin
  ...
  begin
    ATileControl := TdxCustomTileControl
      (DesignKeyDownHookHelper.TileControls[I]);
...
procedure TdxTileControlDesignKeyDownHookHelper.ProcessKeyDownOnControl
  (ATileControl: TdxCustomTileControl; AKey: Word);
begin
  if AKey = VK_DELETE then
    ATileControl.Controller.DeleteSelectedObjects(nil);
end;

class procedure TdxTileControlDesignKeyDownHookHelper.Register
  (ATileControl: TdxCustomTileControl);
begin
...
class procedure TdxTileControlDesignKeyDownHookHelper.Unregister
  (ATileControl: TdxCustomTileControl);
begin
  if DesignKeyDownHookHelper <> nil then
  begin
...
procedure TdxDetailControlsInfo.AddInfo(AControl: TWinControl;
  ATileItem: TdxTileControlItem);
var
...
function TdxDetailControlsInfo.FindByControl(AControl: TWinControl)
  : TdxDetailControlInfo;
var
  I: Integer;
begin
...
procedure TdxDetailControlsInfo.RemoveInfo(AControl: TWinControl;
  ATileItem: TdxTileControlItem);
var
  AInfo: TdxDetailControlInfo;
begin
...
constructor TdxTileControlDragAndDropSecondaryDragPointHelper.Create
  (ATileControl: TdxCustomTileControl;
...
procedure TdxTileControlDragAndDropSecondaryDragPointHelper.
...
begin
  ...
  for I := 0 to FCount - 1 do
    if FTileControl.OptionsView.GroupLayout = glHorizontal then
    begin
      FSegments[I].TopLeft := cxPointOffset(FGroupExpandedBounds.TopLeft,
        FIncludedSideLength * I, 0);
      FSegments[I].BottomRight :=
        cxPointOffset(FGroupExpandedBounds.BottomRight,
        -FIncludedSideLength * (FCount - I - 1), 0);
    end
    else
    begin
      FSegments[I].TopLeft := cxPointOffset(FGroupExpandedBounds.TopLeft, 0,
        FIncludedSideLength * I);
      FSegments[I].BottomRight :=
        cxPointOffset(FGroupExpandedBounds.BottomRight, 0,
        -FIncludedSideLength * (FCount - I - 1));
    end;
end;

function TdxTileControlDragAndDropSecondaryDragPointHelper.
  GetMaxIntersection: TRect;
var
  I: Integer;
  ASquare: Integer;
begin
  ...
  for I := 1 to FCount - 1 do
    if not cxRectIsEqual(FIntersections[I], cxNullRect) and
      (cxRectSquare(FIntersections[I]) > ASquare) then
    begin
...
begin
  ...
  inherited Create(SourceViewData.ContentLayer, DestViewData.ContentLayer,
...
constructor TdxTileControlGalleryCellAnimation.Create(AItem: TdxTileControlItem;
...
begin
  ...
  inherited Create(dxTileControlGalleryAnimationTime,
    ateAccelerateDecelerate, 180);
  Item.ViewInfo.FContentAnimation := Self;
  Item.AddTransition(Self);
end;
...
procedure TdxTileControlGalleryCellAnimation.Draw(ACanvas: TcxCustomCanvas;
  const R: TRect);
var
...
begin
  ...
  ARect := cxRectSetHeight(cxRectOffsetVert(R, (AHeight - AActualHeight) div 2),
    AActualHeight);
...
function TdxTileControlDragAndDropAnimation.GetTileControl
  : TdxCustomTileControl;
begin
...
begin
  ...
  begin
    ...
    if not Changes.DragObjectFinished and not cxPointIsEqual(GetMouseCursorPos,
      Changes.DragAndDropObject.PrevMousePos) then
...
function TdxTileControlHottrackItemAnimation.IsCompatible
  (AAnimation: TdxAnimationTransition): Boolean;
begin
...
procedure TdxTileControlAutoScrollingObject.GetScrollBarParams(var AMin, AMax,
  APos: Integer);
var
...
const
  ALayouts: array [TScrollBarKind] of TdxTileControlGroupLayout = (glHorizontal,
    glVertical);
var
  P: TPoint;
  AAccepted: Boolean;
begin
  ...
  else if TileControl.OptionsView.GroupLayout = ALayouts[AKind] then
  begin
    ...
    TdxTileControlDragDropCustomObject(TileControl.DragAndDropObject)
      .DragAndDrop(P, AAccepted);
  end;
end;
...
procedure TdxTileControlGroupCaptionInplaceEdit.ClearEditor(Sender: TObject;
  AButtonIndex: Integer);
begin
  Clear;
end;

procedure TdxTileControlGroupCaptionInplaceEdit.ChangeScaleEx(M: Integer;
  D: Integer; IsDPIChanged: Boolean);
begin
  inherited ChangeScaleEx(M, D, IsDPIChanged);
  SetupClearButton;
end;

procedure TdxTileControlGroupCaptionInplaceEdit.CheckEmptyOnExit
  (Sender: TObject);
var
  AText: string;
begin
...
procedure TdxTileControlGroupCaptionInplaceEdit.CreateParams
  ...
  try
    ...
    try
      ...
      try
        ...
        AImageCanvas.Line(ACenter.X - AHorn, ACenter.Y - AHorn,
          ACenter.X + AHorn, ACenter.Y + AHorn, $FF000000,
          ScaleFactor.Apply(2));
        AImageCanvas.Line(ACenter.X - AHorn, ACenter.Y + AHorn,
          ACenter.X + AHorn, ACenter.Y - AHorn, $FF000000,
          ScaleFactor.Apply(2));
...
function TdxTileControlGroupCaptionInplaceEdit.GetCaption
  : TdxTileControlGroupCaption;
begin
...
function TdxTileControlGroupCaptionInplaceEdit.GetTileControl
  : TdxCustomTileControl;
begin
...
procedure TdxTileControlGroupCaptionInplaceEdit.KeyDown(var Key: Word;
  Shift: TShiftState);
  ...
  begin
    ...
    Key := 0;
    PostMessage(TileControl.Handle,
      DXM_TILECONTROL_HIDEGROUPCAPTIONEDITORS, 0, 0);
  end;
...
procedure TdxTileControlGroupCaptionInplaceEdit.UpdatePosition
  (AWinPosInfo: THandle);
var
  AActualCaptionPos: TPoint;
begin
  AActualCaptionPos := GetCaptionTextBounds.TopLeft;
  DeferWindowPos(AWinPosInfo, Handle, 0, IniBoundsPos.X + AActualCaptionPos.X -
    IniCaptionPos.X, IniBoundsPos.Y + AActualCaptionPos.Y - IniCaptionPos.Y,
...
begin
  ...
  ABoundsRect := cxRectInflate(ACaptionTextBounds,
    TileControl.ScaleFactor.Apply(cxTextSpace));
  FIniBoundsPos := ABoundsRect.TopLeft;
  SetBounds(ABoundsRect.Left, ABoundsRect.Top, cxRectWidth(ABoundsRect),
    cxRectHeight(ABoundsRect));
end;
...
begin
  ...
  Style.Color := dxGetLighterColor
    (cxGetActualColor(TileControl.Style.GradientBeginColor,
    LookAndFeelPainter.DefaultContentColor), 90);
  ...
  StyleHot.Color := dxGetLighterColor(cxGetActualColor(Style.Color,
    LookAndFeelPainter.DefaultContentColor), 90);
end;

procedure TdxTileControlGroupCaptionInplaceEdit.WMGetDlgCode
...
procedure TdxTileControlGroup.AssignFrom(AGroup: TdxTileControlGroup;
  AExcludeItem: TdxTileControlItem = nil);
var
  I: Integer;
begin
...
function TdxTileControlGroup.GetCollectionFromParent(AParent: TComponent)
...
function TdxTileControlGroup.GetCustomIndent(AVirtualGroup
  : TdxTileControlVirtualGroupViewInfo): Integer;
begin
  if (AVirtualGroup = VirtualGroupAfter) and
    not(((GroupLayout = glHorizontal) and IsRealMostRight) or
    ((GroupLayout = glVertical) and IsRealMostBottom)) then
    Result := Indent
  else
    Result := 0;
end;
...
begin
  if TileControl.IsGroupDragged then
    Result := ViewInfo =
      (TileControl.DragAndDropObject as
      TdxTileControlDragDropCustomObject).DragCell
  else
    Result := False;
end;
...
begin
  if not Visible or TileControl.IsLocked then
    Exit;
  TileControl.ViewInfo.MakeVisible(ViewInfo.Bounds, IsRealMostLeft,
    IsRealMostTop, IsRealMostRight, IsRealMostBottom);
  Invalidate;
end;

procedure TdxTileControlGroup.MoveItem(AItem: TdxTileControlItem;
  AIndexDest: Integer);
var
  ANowIndex: Integer;
begin
...
begin
  ...
  try
    ...
    begin
      AItem.FGroup := nil;
      if not((csDestroying in ComponentState) or ATileControl.IsDesigning or
        ATileControl.IsDestroying or ATileControl.IsRestoring) and
        not TileControl.IsItemDragged and ATileControl.CanRemoveGroupIfEmpty
        (Self) then
...
begin
  ...
  if ((Index = 0) or (AValue = 0)) and (Collection.Items[0] <> nil) then
    ALeftOfFirstGroup := TdxTileControlGroup(Collection.Items[0])
      .ViewInfo.Bounds.Left;
  TileControl.BeginUpdate;
  try
...
begin
  ATopOfFirstGroup := 0;
  if ((Index = 0) or (AValue = 0)) and (Collection.Items[0] <> nil) then
    ATopOfFirstGroup := TdxTileControlGroup(Collection.Items[0])
      .ViewInfo.Bounds.Top;
  TileControl.BeginUpdate;
  try
    inherited SetIndex(AValue);
...
var
  I: Integer;
begin
  for I := Low(dxTileControlStoredGroupPropertiesNames)
    to High(dxTileControlStoredGroupPropertiesNames) do
...
procedure TdxTileControlGroup.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
  if AName = dxTileControlStoredGroupPropertiesNames[3] then
    AValue := Caption.Text
  else if Assigned(OnGetStoredPropertyValue) then
    OnGetStoredPropertyValue(Self, AName, AValue);
end;

procedure TdxTileControlGroup.SetPropertyValue(const AName: string;
  const AValue: Variant);
begin
  if AName = dxTileControlStoredGroupPropertiesNames[3] then
    Caption.Text := AValue
  else if Assigned(OnSetStoredPropertyValue) then
    OnSetStoredPropertyValue(Self, AName, AValue);
end;

// IcxStoredParent
function TdxTileControlGroup.StoredCreateChild(const AObjectName,
...
procedure TdxTileControlGroup.StoredDeleteChild(const AObjectName: string;
  AObject: TObject);
begin
...
begin
  if ((TileControl.ActiveDetail = nil) or
    (TileControl.ActiveDetail.ActiveControl <> DetailOptions.DetailControl)) and
...
begin
  if IsAnimationActive and HasAnimatedContent then
    ...
    begin
      FActiveFrameIndex :=
        Max(-1, Min(VisibleFramesCount - 1, FActiveFrameIndex));
...
begin
  Result := not(csDestroying in ComponentState) and
    not(csDestroying in TileControl.ComponentState) and (ItemType = tcitGallery)
    and (GalleryCellController <> nil);
end;
...
begin
  AnimationTimer.Enabled := IsVisible and (AnimationInterval > 0) and
    (TileControl <> nil) and not TileControl.IsDesigning and
    not TileControl.IsLocked and not(csDestroying in TileControl.ComponentState)
    and (Controller.AnimationItems.IndexOf(Self) < 0);
end;

function TdxTileControlItem.CheckViewDataInitialized
  (AViewData: TdxTileControlCustomItemViewData)
  : TdxTileControlCustomItemViewData;
begin
...
function TdxTileControlItem.ConvertToSize(AIsLarge: Boolean)
...
function TdxTileControlItem.CreateDetailOptions
  : TdxTileControlItemDetailOptions;
begin
...
function TdxTileControlItem.CreateOptionsAnimate
  : TdxTileControlItemOptionsAnimate;
begin
...
begin
  ...
  begin
    if (AActiveControl.Parent <> ADetail) or
      (DetailOptions.FDetailControlPrevParent = nil) then
...
begin
  Result := ViewData;
  if TileControl.IsDesigning or (ActiveFrame = nil) or (ItemType = tcitGallery)
  then
    Exit;
...
function TdxTileControlItem.GetCollectionFromParent(AParent: TComponent)
  : TcxComponentCollection;
begin
  Result := TdxCustomTileControl(AParent).Items;
end;

function TdxTileControlItem.GetDetailOptionsClass
  : TdxTileControlItemDetailOptionsClass;
begin
...
begin
  if ViewInfo.Visible then
    TileControl.InvalidateRect(cxRectInflate(ViewInfo.GetActualVisualBounds, 1,
      1), False);
end;
...
begin
  if (TileControl.DragAndDropState = ddsInProcess) and
    (TileControl.IsItemDragged or (TileControl.ViewInfo.DragDropChanges <> nil))
  then
    Result := ViewInfo =
      (TileControl.DragAndDropObject as
      TdxTileControlDragDropCustomObject).DragCell
...
procedure TdxTileControlItem.OnEndGalleryCellAnimation
  (AAnimation: TdxTileControlGalleryCellAnimation);
begin
...
procedure TdxTileControlItem.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
  if (DetailOptions <> nil) and (Operation = opRemove) and
    (DetailOptions.DetailControl = AComponent) then
    DetailOptions.DetailControl := nil;
  if (AComponent is TcxImageCollectionItem) and (Operation = opRemove) and
    Assigned(ThreadScaler) then
...
procedure TdxTileControlItem.RemoveTransition(ATransition
...
procedure TdxTileControlItem.Move(AGroupDest: TdxTileControlGroup;
  AIndexDest: Integer);
begin
  TileControl.BeginUpdate;
  try
...
begin
  ...
  if Result then
    if GroupLayout = glHorizontal then
      Result := ViewInfo.GetLastOccupiedColumn(ViewInfo.Position.Column)
        = Group.RealColumnCount - 1
    else
      Result := ViewInfo.GetLastOccupiedRow(ViewInfo.Position.Row)
        = Group.RealRowCount - 1;
end;
...
begin
  Result := (Group <> nil) and Group.IsRealMostLeft and
    (ViewInfo.Position.Column = 0);
end;
...
begin
  Result := (Group <> nil) and Group.IsRealMostTop and
    (ViewInfo.Position.Row = 0);
end;
...
procedure TdxTileControlItem.RefreshFrame(AItem: TdxTileControlItemFrame;
  const AData: Pointer);
begin
  AItem.Changed;
end;
...
procedure TdxTileControlItem.SetOnActivateDetail
  (AValue: TdxTileControlItemEvent);
begin
...
procedure TdxTileControlItem.SetDetailOptions
  (AValue: TdxTileControlItemDetailOptions);
begin
...
var
  I: Integer;
begin
  for I := Low(dxTileControlStoredItemPropertiesNames)
    to High(dxTileControlStoredItemPropertiesNames) do
...
begin
  ...
  for I := Low(dxTileControlStoredItemPropertiesNames)
    to High(dxTileControlStoredItemPropertiesNames) do
  begin
    if AnsiCompareText(dxTileControlStoredItemPropertiesNames[I], AName) = 0
    then
    begin
      Result := I;
      Break;
...
procedure TdxTileControlItem.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
...
procedure TdxTileControlItem.SetPropertyValue(const AName: string;
  const AValue: Variant);
var
...
begin
  ...
  if ItemType <> tcitGallery then
    FreeAndNil(FGalleryCellController)
  else if FGalleryCellController = nil then
...
begin
  ...
  dX := dX div GetSlowdownScrollFactor(ViewInfo.LeftScrollPos,
    ViewInfo.HorzScrollPage, ViewInfo.ContentWidth, dX);
  if dX <> 0 then
...
begin
  ...
  dY := dY div GetSlowdownScrollFactor(ViewInfo.TopScrollPos,
    ViewInfo.VertScrollPage, ViewInfo.ContentHeight, dY);
  if dY <> 0 then
    ViewInfo.TopScrollPos := ViewInfo.TopScrollPos + dY;
end;

procedure TdxTileControlHandScroll.DragAndDrop(const P: TPoint;
...
begin
  ...
  DoScrollVertically;
  if (ALeftPos <> ViewInfo.LeftScrollPos) or (ATopPos <> ViewInfo.TopScrollPos)
  then
    TileControl.Update;
...
begin
  ...
  FFinishAnimationPosX :=
    Max(0, Min(StartAnimationPosX, ViewInfo.ContentWidth -
    ViewInfo.HorzScrollPage));
  FStartAnimationPosY := ViewInfo.TopScrollPos;
  FFinishAnimationPosY :=
    Max(0, Min(FStartAnimationPosY, ViewInfo.ContentHeight -
    ViewInfo.VertScrollPage));
  if (StartAnimationPosX <> FinishAnimationPosX) or
    (StartAnimationPosY <> FinishAnimationPosY) then
    TileControl.Controller.ImmediateAnimation
      (TdxTileControlRubberAnimation.Create(TileControl, Self));
  inherited EndDragAndDrop(Accepted);
end;

function TdxTileControlHandScroll.GetDragAndDropCursor
...
function TdxTileControlHandScroll.GetSlowdownScrollFactor(APos, AScrollPageSize,
  AContentSize, ANewDelta: Integer): Integer;

  function IsNeedToSlowdown: Boolean;
  begin
    Result := ((APos * ANewDelta) > 0) and
      ((APos < 0) or (APos > (AContentSize - AScrollPageSize)));
  end;
...
constructor TdxTileControlHintController.Create
  (AOwner: TdxTileControlController);
begin
  inherited Create;
  FOwner := AOwner;
end;
...
constructor TdxTileControlInflateItemAnimation.Create
  (ATileControl: TdxCustomTileControl; AItem: TdxTileControlItem;
...
procedure TdxTileControlInflateItemAnimation.InflateItem
...
constructor TdxTileControlGroupCaptionViewInfo.Create
  (AOwner: TdxTileControlGroupCaption);
begin
  inherited Create;
  FCaption := AOwner;
  FFont := TFont.Create;
...
begin
  ...
  if TileControl.OptionsBehavior.GroupRenaming and (AText = '') then
    AText := 'I';
  ATextHeight := Painter.MeasureTextSize(TileControl.ActualCanvas, AText, Font,
    Caption.Alignment, False, 0, 0).cy;
...
begin
  ...
  AdjustFontHeight(Font, ScaleFactor, dxTileControlDefaultGroupCaptionFontSize,
    Painter.GroupCaptionDefaultFontSize);
end;

procedure TdxTileControlGroupCaptionViewInfo.DoDraw(ACanvas: TcxCustomCanvas);
begin
  if Group.Visible and (Group <> TileControl.DraggedGroup) and not IsAnimatedOnDragDrop
  then
    DrawContent(ACanvas, TextBounds);
end;

procedure TdxTileControlGroupCaptionViewInfo.DrawContent
...
begin
  ...
  if ACanvas.RectVisible(R) and (Caption.Text <> '') then
    Painter.DrawText(ACanvas, R, Caption.Text, Font, TextColor,
      Caption.Alignment, vaBottom);
end;
...
function TdxTileControlGroupCaptionViewInfo.GetHitTest
...
function TdxTileControlGroupCaptionViewInfo.GetTextBounds
  (ABounds: TRect): TRect;
begin
  Result := ABounds;
...
function TdxTileControlGroupCaptionViewInfo.GetTileControl
  : TdxCustomTileControl;
begin
...
procedure TdxTileControlGroupCaptionViewInfo.DoRightToLeftConversion
...
begin
  ...
  FFont.Height := dxGetFontHeightForDefaultDPI
    (dxTileControlDefaultGroupCaptionFontSize);
...
begin
  Result := IsFontStored or (Alignment <> taLeftJustify) or (Text <> '') or
    (Color <> clDefault);
end;
...
function TdxTileControlCustomStoredCollection.GetTileControl
  : TdxCustomTileControl;
begin
...
// IInterface
function TdxTileControlCustomStoredCollection.QueryInterface(const IID: TGUID;
  out Obj): HResult;
begin
...
procedure TdxTileControlCustomStoredCollection.StoredChildren
...
procedure TdxTileControlItemCollection.ForEach
  (AProc: TdxTileControlForEachItemProc; const AData: Pointer;
...
function TdxTileControlItemCollection.GetItem(AIndex: Integer)
  : TdxTileControlItem;
begin
  Result := TdxTileControlItem(inherited GetItem(AIndex));
end;

procedure TdxTileControlItemCollection.SetItem(AIndex: Integer;
  const AValue: TdxTileControlItem);
begin
...
procedure TdxTileControlDragDropCustomObject.AfterDragAndDrop
  (Accepted: Boolean);
begin
...
begin
  ...
  if IsTouching and (Controller.ItemCheckMode <> tcicmNone) and DragCellIsItem
  then
  begin
    FState := tcddsPulling;
    InitializeDragImage;
...
function TdxTileControlDragDropCustomObject.CreateAutoScrollObject
  (Kind: TScrollBarKind; const ARect: TRect; ACode: TScrollCode)
  : TdxTileControlAutoScrollingObject;
begin
...
begin
  ...
  AAutoScrollWidth := TileControl.ScaleFactor.Apply
    (dxTileControlAutoScrollWidth);
  AScrollRect := cxRectSetWidth(R, AAutoScrollWidth);
  AScrollRect.Left := AScrollRect.Left - Screen.Width;
  ScrollControllers[sLeft] := CreateAutoScrollObject(sbHorizontal, AScrollRect,
    ALineUpScrollCodes[not UseRightToLeftAlignment]);

  AScrollRect := R;
  AScrollRect.Left := AScrollRect.Right - AAutoScrollWidth;
  AScrollRect := cxRectSetWidth(AScrollRect, Screen.Width);
  ScrollControllers[sRight] := CreateAutoScrollObject(sbHorizontal, AScrollRect,
    ALineDownScrollCodes[not UseRightToLeftAlignment]);

  AScrollRect := R;
  AScrollRect.Bottom := AScrollRect.Top + AAutoScrollWidth;
  AScrollRect.Top := AScrollRect.Top - Screen.Height;
  ScrollControllers[sTop] := CreateAutoScrollObject(sbVertical, AScrollRect,
    ALineUpScrollCodes[not UseRightToLeftAlignment]);

  AScrollRect := R;
  AScrollRect.Top := AScrollRect.Bottom - AAutoScrollWidth;
  AScrollRect := cxRectSetHeight(AScrollRect, Screen.Height);
  ScrollControllers[sBottom] := CreateAutoScrollObject(sbVertical, AScrollRect,
    ALineDownScrollCodes[not UseRightToLeftAlignment]);
end;
...
begin
  for ASide := Low(TdxTileControlAutoScrollSide)
    to High(TdxTileControlAutoScrollSide) do
...
function TdxTileControlDragDropCustomObject.GetController
  : TdxTileControlController;
begin
  Result := TileControl.Controller;
end;
...
function TdxTileControlDragDropCustomObject.GetDragCellAsGroup
  : TdxTileControlGroup;
begin
  Result := TdxTileControlGroupViewInfo(DragCell).Group;
end;

function TdxTileControlDragDropCustomObject.GetDragCellAsItem
  : TdxTileControlItem;
begin
...
procedure TdxTileControlDragDropCustomObject.DoAnimateContent(const AStart,
  AFinish: TPoint);
var
  I: Integer;
begin
  if TileControl.IsDesigning or cxPointIsEqual(AStart, AFinish) then
    Exit;
  for I := 0 to ViewInfo.Cells.Count - 1 do
    ViewInfo.Cells[I].Scroll(AStart.X - AFinish.X, AStart.Y - AFinish.Y);
  TileControl.Controller.ImmediateAnimation
    (TdxTileControlContentAnimation.Create(TileControl,
    dxTileControlCenterContentAnimationTime, AFinish.X - AStart.X,
    AFinish.Y - AStart.Y));
end;
...
procedure TdxTileControlDragDropCustomObject.DragAndDrop(const P: TPoint;
  var Accepted: Boolean);
begin
...
procedure TdxTileControlDragDropCustomObject.DragAndDropGroup
  (var Accepted: Boolean);
begin
end;

procedure TdxTileControlDragDropCustomObject.DragAndDropItem
  (var Accepted: Boolean);
begin
end;

procedure TdxTileControlDragDropCustomObject.DragMoving(const P: TPoint;
  var Accepted: Boolean);
begin
...
procedure TdxTileControlDragDropCustomObject.EndDragAndDropGroup
  (Accepted: Boolean);
begin
end;

procedure TdxTileControlDragDropCustomObject.EndDragAndDropItem
  (Accepted: Boolean; var ANewGroup: TdxTileControlGroup);
begin
end;
...
begin
  ...
  ADragImagePos.Y := ADragImagePos.Y +
    Min(MulDiv(Max(P.Y - ADragImagePos.Y, 0), 2, 5), MaxPullSize);
  PullProgress := MulDiv(100, ADragImagePos.Y - Controller.StartDragPos.Y,
    MaxPullSize);
  ShowDragImage(TileControl.ClientToScreen(ADragImagePos));
  if not PtInRect(cxRectInflate(DragBounds, MaxPullSize div 2,
    MaxPullSize div 2), P) then
    BeginDragMoving;
end;
...
begin
  ...
  if UseRightToLeftAlignment then
    Result := TdxRightToLeftLayoutConverter.ConvertRect(Result,
      TileControl.ViewInfo.ClientBounds);
end;

function TdxTileControlDragDropCustomObject.GetDragAndDropCursor
  (Accepted: Boolean): TCursor;
const
...
function TdxTileControlDragDropCustomObject.GetDragDropChanges
  : TdxTileControlDragAndDropChanges;
begin
...
function TdxTileControlDragDropCustomObject.GetTileControl
  : TdxCustomTileControl;
begin
  Result := TdxCustomTileControl(Control);
end;
...
begin
  if FDragCellIsHided then
    Exit;
  FDragCellIsHided := True;
  TileControl.ForceUpdate(True);
end;

function TdxTileControlDragDropCustomObject.IsRectInControl
  (const ARect: TRect): Boolean;
begin
  Result := cxRectIntersect(TileControl.Bounds, ARect);
end;

function TdxTileControlDragDropCustomObject.MouseClientToScreen
...
function TdxLayoutItemPosition.IsEqual(APosition
  : TdxLayoutItemPosition): Boolean;
begin
  Result := (APosition <> nil) and (Row = APosition.Row) and
    (Column = APosition.Column);
end;

{ TdxTileControlCells }

function TdxTileControlCells.CalculateHitTest
  (AHitTest: TdxTileControlHitTest): Boolean;
var
  I: Integer;
begin
...
function TdxTileControlCells.GetItem(AIndex: Integer)
  : TdxTileControlCustomCellViewInfo;
begin
...
function TdxTileControlGroupCollection.Insert(AIndex: Integer)
  : TdxTileControlGroup;
begin
...
function TdxTileControlGroupCollection.GetNextVisibleGroup
  (AGroup: TdxTileControlGroup): TdxTileControlGroup;
var
...
function TdxTileControlGroupCollection.GetPrevVisibleGroup
  (AGroup: TdxTileControlGroup): TdxTileControlGroup;
var
  AItem: TdxTileControlGroup;
  I: Integer;
...
function TdxTileControlGroupCollection.GetItem(AIndex: Integer)
  : TdxTileControlGroup;
begin
  Result := TdxTileControlGroup(inherited GetItem(AIndex));
end;

function dxCompareItemsByIndexInGroup(AItem1,
  AItem2: TdxTileControlItem): Integer;
begin
...
procedure TdxTileControlGroupCollection.StoredDeleteChild(const AObjectName
...
function dxCompareAnimationInfoCells(AInfo1,
  AInfo2: TdxTileControlDragAndDropChangesCellInfo): Integer;
begin
...
begin
  ...
  begin
    ...
    else if (AInfo = nil) or (Items[I].Item <> AInfo.Item) or
  ...
  begin
    if DragObjectFinished then
      FDragImageBounds := dxMapWindowRect(DragAndDropObject.DragImage.Handle,
        TileControl.Handle, DragAndDropObject.DragImage.ClientRect);
    if not TileControl.IsDesigning then
    begin
      if not DragAndDropObject.ImmediateFinish and
        ((ItemsInfo.Count > 0) or DragObjectFinished or DragFinished) then
        TileControl.Controller.ImmediateAnimation
          (TdxTileControlDragAndDropAnimation.Create(Self));
...
function TdxTileControlDragAndDropChanges.IndexOf
  (ACell: TdxTileControlAnimatedDragAndDropCustomCellViewInfo): Integer;
begin
  for Result := 0 to Count - 1 do
    if Items[Result].Cell = ACell then
      Exit;
  Result := -1;
end;

procedure TdxTileControlDragAndDropChanges.AnimateDragFinished(const AProgress
  : Integer);
var
  APos: TPoint;
  R: TRect;
begin
  ...
  APos.X := FDragImageBounds.Left + MulDiv(APos.X - FDragImageBounds.Left,
    AProgress, dxTileDropAnimationStepCount);
  APos.Y := FDragImageBounds.Top + MulDiv(APos.Y - FDragImageBounds.Top,
    AProgress, dxTileDropAnimationStepCount);
  if not cxPointIsEqual(APos, DragAndDropObject.DragImage.BoundsRect.TopLeft)
  then
  begin
...
begin
  ...
  if FDragFinished and (DragAndDropObject is TdxTileControlDragDropItem) then
    DragAndDropObject.DragCellAsItem.ViewInfo.DrawContent(ACanvas,
      cxRectSetOrigin(FDragImageBounds, FDragImagePosition));
end;
...
begin
  ...
  begin
    ...
    ACellIsGroupCaption := ViewInfo.Cells[I]
      is TdxTileControlGroupCaptionViewInfo;
    if (ViewInfo.Cells[I] is TdxTileControlItemViewInfo) or ACellIsGroupCaption
    then
    begin
      ACell := TdxTileControlAnimatedDragAndDropCustomCellViewInfo
        (ViewInfo.Cells[I]);
      ...
      begin
        ...
        if not((AGroupCaption.Group = nil) or AGroupCaption.Group.IsDragged or
          (Trim(AGroupCaption.Text) = '')) then
          ItemsInfo.Add(TdxTileControlDragAndDropChangesCellInfo.Create(ACell,
            ABeforeUpdate));
      end
      else
      begin
        ...
        if not(AItem.IsDragged or (AItem.Group = nil) or AItem.Group.IsDragged)
        then
          ItemsInfo.Add(TdxTileControlDragAndDropChangesCellInfo.Create(ACell,
            ABeforeUpdate));
      end;
...
procedure TdxTileControlDragAndDropChanges.SetAnimationProgress(const AProgress
  : Integer);
var
  I: Integer;
begin
...
function TdxTileControlDragAndDropChanges.GetDragAndDropObject
  : TdxTileControlDragDropCustomObject;
begin
...
begin
  Result := (TileControl.DragAndDropState = ddsNone) and (DragObject <> nil) or
    DragFinished;
end;

function TdxTileControlDragAndDropChanges.GetItem(AIndex: Integer)
...
begin
  ...
  try
    ...
    else if DragGroup.Collection <> nil then
    begin
...
function TdxTileControlDragDropGroup.GetDragGroupInfo
  : TdxTileControlDragGroupInfo;
begin
...
function TdxTileControlDragDropGroup.
  GetPotentialIndexForNewlyInsertedGroup: Integer;
var
...
function TdxTileControlDragDropGroup.GetPotentialIndexForMovedGroup: Integer;
  ...
  function GetIndex(const ACurrentGroupIndex, ACurrentGroupCenter, ADragLeft,
    ADragRight: Integer): Integer;
  begin
    Result := -1;
    if ADragRight < ACurrentGroupCenter then
      Result := Max(0, ACurrentGroupIndex - 1 +
        Ord(ACurrentGroupIndex = FPrevIndex))
    else if (ADragLeft < ACurrentGroupCenter) and
      (ACurrentGroupCenter <= ADragRight) then
...
begin
  ...
  begin
    ...
    if GroupLayout = glHorizontal then
      ...
      AIndex := GetIndex(I, AGroupCenter.Y, ADragBounds.Top,
        ADragBounds.Bottom);
    if AIndex >= 0 then
    begin
      Result := AIndex;
...
begin
  ...
  ViewInfo.Painter.DrawBackground(DragImage.Canvas,
    cxRectUnion(TileControl.ClientRect, DragCell.Bounds));
...
procedure TdxTileControlDragItemPlace.Assign
  (ASource: TdxTileControlDragItemPlace);
begin
...
function TdxTileControlDragItemPlace.IsEqual
  (APlace: TdxTileControlDragItemPlace): Boolean;
begin
  Result := (FGroup = APlace.Group) and (FVirtualGroup = APlace.FVirtualGroup)
    and FPosition.IsEqual(APlace.Position);
end;

{ TdxTileControlCustomGroupViewInfo }

constructor TdxTileControlCustomGroupViewInfo.Create
  (AOwner: TdxTileControlGroup);
begin
  inherited Create;
  FGroup := AOwner;
end;
...
procedure TdxTileControlCustomGroupViewInfo.CalculateSize(var AWidth,
  AHeight: Integer);
begin
  AWidth := 0;
  AHeight := 0;
...
constructor TdxThreadScalerTaskItem.Create(AImageItem: TcxImageCollectionItem;
  AOutputSize: TSize; ACallBackProc: TNotifyEvent);
begin
  inherited Create;
...
procedure TdxThreadScalerTaskItem.LoadGraphicToImage(AGraphic: TGraphic;
  AImage: TdxSmartImage);
var
...
procedure TdxThreadScalerTaskItem.Scale;
  ...
  begin
    Result := cxGetImageRect(cxRect(FOutputSize),
      Size(AGraphic.Width, AGraphic.Height),
      ModeMap[(FOutputSize.cx < AGraphic.Width) and
      (FOutputSize.cy < AGraphic.Height)]);
...
begin
  ...
  try
    ...
    try
      AImage.StretchDraw(AImageCanvas, GetImageRect(AImage),
        AImage.ClientRect, nil);
    finally
      AImageCanvas.Free;
    end;
  finally
...
procedure TdxTileControlDragAndDropChangesCellInfo.
  CalculateComplexDrawingAreaBounds(var ADest, ASource: TRect;
  const AOffsetX, AOffsetY: Integer);

  function IsMovingToForward: Boolean;
  begin
    Result := Group.ViewInfo.GetZIndex(ColumnBefore, RowBefore, RowBefore) <
  ...
  begin
    Result := (((RowBefore div 2 = TileControl.ViewInfo.RowCount - 1) and
      (RowAfter div 2 = 0)) or ((RowBefore div 2 = 0) and
      (RowAfter div 2 = TileControl.ViewInfo.RowCount - 1)));
  end;

  function IsDraggedItemNotPlaceSameBeforePosition(ADraggedItem
    : TdxTileControlItem): Boolean;
  begin
    Result := (ADraggedItem <> nil) and
      ((ADraggedItem.Group = nil) or ((ADraggedItem.Group <> nil) and
      (ADraggedItem.ViewInfo.Position.Row div 2 <> RowBefore div 2) and
...
procedure TdxTileControlDragAndDropChangesCellInfo.
  CalculateSimpleDrawingAreaBounds(var ADest: TRect;
  const AOffsetX, AOffsetY: Integer);
begin
...
begin
  ...
  else if (GroupCaption <> nil) and (AInfo.GroupCaption <> nil) then
...
function TdxTileControlDragAndDropChangesCellInfo.
  CompareTileControlGroupCaptions
  (AInfo: TdxTileControlDragAndDropChangesCellInfo): Integer;
begin
...
procedure TdxTileControlDragAndDropChangesCellInfo.Draw
  (ACanvas: TcxCustomCanvas; const AProgress: Integer);
...
function TdxTileControlDragAndDropChangesCellInfo.GetTileControl
  : TdxCustomTileControl;
begin
  Result := Cell.TileControl;
end;

function TdxTileControlDragAndDropChangesCellInfo.GetViewInfo
  : TdxTileControlViewInfo;
begin
  Result := TileControl.ViewInfo;
end;
...
function TdxTileControlDragAndDropChangesCellInfo.Merge
  (AInfo: TdxTileControlDragAndDropChangesCellInfo): Boolean;
begin
  BoundsBefore := cxRectOffset(BoundsBefore, ViewInfo.LeftScrollPos,
    ViewInfo.TopScrollPos);
  ...
  IsSimpleMoving := (GroupCaption <> nil) or (Item <> nil) and
    (RowBefore = AInfo.RowAfter) or (ColumnBefore = AInfo.ColumnAfter);
  if IsSimpleMoving then
  begin
...
begin
  ...
  AdjustFontHeight(Font, ScaleFactor, dxTileControlDefaultTitleFontSize,
    Painter.TitleDefaultFontSize);
end;
...
begin
  ...
  begin
    FGlyphBounds := Rect(Bounds.Right - Title.Glyph.Width,
      Bounds.Bottom - Title.Glyph.Height, Bounds.Right, Bounds.Bottom);
...
begin
  ...
  begin
    ...
    FTextBounds := cxRectSetTop(FTextBounds,
      Bounds.Top + (cxRectHeight(Bounds) - cxRectHeight(FTextBounds)) div 2);
  end;
end;
...
begin
  ...
  if Title.Text <> '' then
    Painter.DrawText(ACanvas, FTextBounds, Title.Text, Font, TextColor,
      Title.TextAlignHorz, Title.TextAlignVert, Title.WordWrap);
  if not Title.Glyph.Empty then
...
begin
  ...
  if Title.Text <> '' then
    Result := Max(Result, cxRectHeight(MeasureTextBounds(cxNullRect)) + 2 *
      Title.IndentVert);
end;

function TdxTileControlTitleViewInfo.GetHitTest
  (AHitTest: TdxTileControlHitTest): Boolean;
begin
  Result := inherited GetHitTest(AHitTest);
  if Result then
...
function TdxTileControlTitleViewInfo.MeasureTextBounds(const AVisibleBounds
  : TRect): TRect;
begin
  if Title.Text <> '' then
  begin
    Result := cxRectSetSize(AVisibleBounds,
      Painter.MeasureTextSize(ActualCanvas, Title.Text, Font,
      Title.TextAlignHorz, Title.WordWrap, IfThen(Title.WordWrap,
      cxRectWidth(AVisibleBounds)), 0));
  end
  else
...
procedure TdxTileControlTitleViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
...
function TdxTileControlGalleryCells.CalculateHitTest
  (AHitTest: TdxTileControlHitTest): Boolean;
begin
  Result := False;
end;

function TdxTileControlGalleryCells.GetCell(ARow, AColumn: Integer)
  : TdxTileControlItemGalleryCell;
var
  ACell: TdxTileControlItemGalleryCell;
  I: Integer;
...
function TdxTileControlGalleryCells.GetItem(AIndex: Integer)
  : TdxTileControlItemGalleryCell;
begin
...
constructor TdxTileControlGalleryCellController.Create
  (ATileItem: TdxTileControlItem);
begin
  inherited Create;
  FTileItem := ATileItem;
...
begin
  TileItem.Controller.AddAnimation(TdxTileControlGalleryCellAnimation.Create
    (TileItem, PreparedCell));
...
begin
  R := CellsBounds;
  Result := (ActualCellsHeight <> cxRectHeight(R)) or
    (ActualCellsWidth <> cxRectWidth(R));
end;
...
var
  ...
  R: TRect;
begin
  AColumnWidth := TileControl.OptionsView.ItemWidth div
    AColumnCountPerRegularItem;
...
function TdxTileControlGalleryCellController.CanPopulatePreparedCellsAt
  (const ARow, AColumn: Byte): Boolean;
var
  I: Integer;
  ACell: TdxTileControlItemGalleryCell;
  ACellRow, ACellColumn: Byte;
begin
  Result := (ARow + ImageRowCount <= RowCount) and
    (AColumn + ImageColumnCount <= ColumnCount) and IsThereEmptyCells;
  if Result then
...
procedure TdxTileControlGalleryCellController.Draw(ACanvas: TcxCustomCanvas;
...
function TdxTileControlGalleryCellController.GetGalleryImages
  : TcxImageCollection;
begin
...
function TdxTileControlGalleryCellController.
  GetPreparedCellsCombinedBounds: TRect;
var
  I: Integer;
  ACell: TdxTileControlItemGalleryCell;
begin
...
function TdxTileControlGalleryCellController.GetTileControl
  : TdxCustomTileControl;
begin
...
begin
  ...
  for ARow := 0 to RowCount - 1 do
    ...
    begin
      ...
      ACell := TdxTileControlItemGalleryCell.Create(TileItem, Self, ARow,
        AColumn, cxRect(ALeft, ATop, ARight, ABottom));
...
function TdxTileControlGalleryCellController.IsEmptyImage
  (AImageIndex: Integer): Boolean;
begin
  Result := (AImageIndex = -1) or
    not Assigned(GalleryImages.Items[FImageIndex].Picture.Graphic);
end;
...
procedure TdxTileControlGalleryCellController.OnEndBitmapRescale
  (Sender: TObject);
var
  ACell: TdxTileControlItemGalleryCell;
...
begin
  ...
  begin
    ...
    ACell.NextImage := TdxTileControlGalleryCellImage.Create(AImage,
      cxRectOffset(ACell.Bounds, AOrigin, False));
  end;
...
begin
  ...
  begin
    ...
    GetThreadScaler.AddTask(AImageItem,
      cxRectSize(GetPreparedCellsCombinedBounds), OnEndBitmapRescale);
  end;
end;
...
function TdxTileControlItemCustomGlyph.GetClientRect(const ABounds
  : TRect): TRect;
var
  AAspectRatio: Double;
  AImageSize: TSize;
  ARectSize: TSize;
begin
  AImageSize := dxGetImageSize(Image, GetImages, ImageIndex,
    Owner.TileItem.TileControl.ScaleFactor);
  if (AImageSize.cx > 0) and (AImageSize.cy > 0) then
  begin
    ARectSize := cxSize(ABounds);
    if Mode = ifmStretch then
      AImageSize := ARectSize
    else if Mode in [ifmProportionalStretch, ifmFit] then
    begin
      AAspectRatio := Min(ARectSize.cx / AImageSize.cx,
        ARectSize.cy / AImageSize.cy);
      if (Mode = ifmProportionalStretch) or (AAspectRatio < 1) then
        AImageSize := cxSize(Trunc(AImageSize.cx * AAspectRatio),
          Trunc(AImageSize.cy * AAspectRatio));
    end;
  end;
...
function TdxTileControlItemCustomGlyph.GetActualAlign
  : TdxTileItemInnerObjectAlignment;
begin
  Result := Align;
  if Result = oaDefault then
    Result := oaMiddleCenter;
  Result := dxGetBiDiModeTileItemInnerObjectAlignment(Result,
    Owner.TileItem.UseRightToLeftAlignment);
end;
...
procedure TdxTileControlItemCustomGlyph.ImagesFreeNotification
...
begin
  Result := (Align <> oaDefault) or not Image.Empty or IsImageListUsed or
...
begin
  AImages := GetImages;
  Result := (AImages <> nil) and (ImageIndex > -1) and
    (ImageIndex < AImages.Count);
end;
...
procedure TdxTileControlItemCustomGlyph.SetAlign
  (AValue: TdxTileItemInnerObjectAlignment);
begin
...
procedure TdxTileControlItemCustomGlyph.SetAlignWithText
  (AValue: TdxTileControlImageWithTextAlignment);
begin
...
procedure TdxTileControlGalleryImage.Draw(ACanvas: TcxCustomCanvas;
  const ATargetRect, ASourceRect: TRect);
begin
  ACanvas.DrawBitmap(FImage, ATargetRect, ASourceRect, afPremultiplied,
    @FCache);
end;

{ TdxTileControlGalleryCellImage }

constructor TdxTileControlGalleryCellImage.Create
  (AImage: IdxTileControlGalleryImage; const ASourceRect: TRect);
begin
  FImage := AImage;
  FSourceRect := ASourceRect;
end;

procedure TdxTileControlGalleryCellImage.Draw(ACanvas: TcxCustomCanvas;
  const R: TRect);
begin
...
function TdxTileControlItemGalleryCell.GetAnimation
  : TdxTileControlGalleryCellAnimation;
begin
  Result := TileItem.ViewInfo.ContentAnimation as
    TdxTileControlGalleryCellAnimation;
end;

function TdxTileControlItemGalleryCell.GetEmptyCellBasicColor: TColor;
begin
  Result := cxGetActualColor(TileItem.Style.GradientBeginColor,
    dxTileItemShadowColor);
...
function TdxTileControlItemGalleryCell.GetHitTest
  (AHitTest: TdxTileControlHitTest): Boolean;
begin
  Result := False;
end;
...
begin
  Result := cxRectOffset(TileItem.ViewInfo.VisibleBounds,
    TileItem.ViewInfo.Bounds.TopLeft, False);
end;
...
function TdxTileControlItemGalleryCell.JumpToNextFrame
  : TdxTileControlGalleryCellImage;
begin
...
procedure TdxTileControlItemGalleryCell.SetNextImage
  (AValue: TdxTileControlGalleryCellImage);
begin
...
function TdxTileControlAnimatedDragAndDropCustomCellViewInfo.
  GetBaseDrawBounds: TRect;
begin
  Result := Bounds;
end;
...
begin
  ...
  if AAbsolutePosition then
    OffsetRect(Result, -TileControl.ViewInfo.LeftScrollPos,
      -TileControl.ViewInfo.TopScrollPos);
end;

function TdxTileControlAnimatedDragAndDropCustomCellViewInfo.
  GetIsAnimatedOnDragDrop: Boolean;
begin
  with TileControl.ViewInfo do
    Result := (DragDropChanges <> nil) and (DragDropChanges.IndexOf(Self) >= 0);
end;

function TdxTileControlAnimatedDragAndDropCustomCellViewInfo.GetScaleFactor
  : TdxScaleFactor;
begin
  Result := TileControl.ScaleFactor;
end;

function TdxTileControlAnimatedDragAndDropCustomCellViewInfo.GetTileControl
  : TdxCustomTileControl;
begin
  Result := nil;
end;
...
constructor TdxTileControlCustomActionBarViewInfo.Create
  (AOwner: TdxTileControlCustomActionBar);
begin
  inherited Create;
  FOwner := AOwner;
...
procedure TdxTileControlCustomActionBarViewInfo.CalculateItems(ABounds: TRect);
  ...
  procedure CheckBoundaryValues(const AGlyphBounds: TRect;
...
begin
  ABounds := cxRectInflate(ABounds, -ActionBars.IndentHorz,
    -ActionBars.IndentVert);

  ATop := MaxInt;
  ABottom := MinInt;
  for I := 0 to Cells.Count - 1 do
    CheckBoundaryValues(TdxTileControlActionBarCustomItemViewInfo(Cells.Items[I]
      ).FGlyphBounds, ATop, ABottom);
  ...
  begin
    ...
    begin
      ...
      Cells.Add(AItemViewInfo);
      AItemViewInfo.SetBounds(cxRectSetRight(ABounds, ABounds.Right,
        AItemWidth), Bounds);
      CheckBoundaryValues(AItemViewInfo.FGlyphBounds, ATop, ABottom);
  ...
  begin
    ...
    if (AItemViewInfo.FGlyphBounds.Top <> ATop) or
      (AItemViewInfo.FGlyphBounds.Bottom <> ABottom) then
    begin
      ...
      AItemViewInfo.FGlyphRect.Top := cxRectCenter(AItemViewInfo.FGlyphBounds).Y
        - AHeight div 2;
...
procedure TdxTileControlCustomActionBarViewInfo.DrawBackground
  (ACanvas: TcxCustomCanvas);
begin
  ACanvas.FillRect(Bounds, cxGetActualColor(ActionBars.Color,
    Painter.ActionBarDefaultBackgroundColor));
end;
...
begin
  Result := 0;
  for I := 0 to Cells.Count - 1 do
    Result := Max(Result, TdxTileControlCustomButtonViewInfo(Cells[I])
      .MeasureSize.cy);
  if Result > 0 then
...
function TdxTileControlCustomActionBarViewInfo.GetActionBars
  : TdxTileControlActionBars;
begin
  Result := Owner.TileControl.ActionBars;
end;

function TdxTileControlCustomActionBarViewInfo.GetCanDisplayItem
  (AItem: TdxTileControlActionBarItem): Boolean;
begin
  Result := AItem.Visible;
end;

function TdxTileControlCustomActionBarViewInfo.GetHitTest
  (AHitTest: TdxTileControlHitTest): Boolean;
begin
...
function TdxTileControlCustomActionBarViewInfo.GetItems
  : TdxTileControlActionBarItems;
begin
  Result := ActionBars.Items;
end;

function TdxTileControlCustomActionBarViewInfo.GetPainter
  : TdxTileControlPainter;
begin
...
function TdxTileControlActionBarItem.GetCollectionFromParent
...
procedure TdxTileControlActionBarItem.SetAlign
  (AValue: TdxTileControlActionBarItemAlignment);
begin
...
procedure TdxTileControlActionBarItem.SetPosition
  (AValue: TdxTileControlActionBarItemPosition);
begin
...
function TdxTileControlActionBarItems.GetItem(AIndex: Integer)
  : TdxTileControlActionBarItem;
begin
...
procedure TdxTileControlActionBarItems.SetItem(AIndex: Integer;
  AValue: TdxTileControlActionBarItem);
begin
...
function TdxTileControlItemFrame.CreateOptionsAnimate
  : TdxTileControlItemOptionsAnimate;
begin
  Result := TdxTileControlItemFrameOptionsAnimate.Create(Self);
end;

function TdxTileControlItemFrame.GetCollectionFromParent(AParent: TComponent)
  : TcxComponentCollection;
begin
...
procedure TdxTileControlItemFrame.SetGlyph
  (AValue: TdxTileControlItemFrameGlyph);
begin
  inherited Glyph.Assign(AValue);
  Changed;
end;
...
constructor TdxTileControlCustomActionBar.Create(ATileControl
  : TdxCustomTileControl);
begin
  inherited Create(nil);
  FTileControl := ATileControl;
...
function TdxTileControlCustomActionBar.CreateController
  : TdxTileControlActionBarController;
begin
  Result := TdxTileControlActionBarController.Create(Self);
end;

function TdxTileControlCustomActionBar.CreateHitTest
  : TdxTileControlActionBarHitTest;
begin
...
procedure TdxTileControlCustomActionBar.MouseDown(Button: TMouseButton;
...
procedure TdxTileControlCustomActionBar.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
...
procedure TdxTileControlCustomActionBar.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
constructor TdxTileControlActionBarsAnimation.Create(ATileControl
  : TdxCustomTileControl; AMode: TdxTileControlActionBarsAnimationMode);
begin
  FPrevPosition := -1;
  FTileControl := ATileControl;
  FTileControl.RefreshActionBars;
  inherited Create(dxTileControlActionBarsAnimationTime,
    ateAccelerateDecelerate, Max(ActionBarBottom.ViewInfo.MeasureHeight,
    ActionBarTop.ViewInfo.MeasureHeight));
  FMode := AMode;
end;

function TdxTileControlActionBarsAnimation.
  CalculateActionBarBottomBounds: TRect;
var
  ADelta: Integer;
begin
...
procedure TdxTileControlActionBarsAnimation.DoAnimate;
  ...
  procedure DeferWindowPosition(AInfoHandle: HDWP; AWindow: TWinControl;
    const R: TRect);
  begin
    DeferWindowPos(AInfoHandle, AWindow.Handle, 0, R.Left, R.Top,
      cxRectWidth(R), cxRectHeight(R), SWP_NOZORDER)
  end;
...
begin
  ...
  begin
    ...
    try
      DeferWindowPosition(ADeferHandle, ActionBarTop,
        CalculateActionBarTopBounds);
      DeferWindowPosition(ADeferHandle, ActionBarBottom,
        CalculateActionBarBottomBounds);
    finally
...
function TdxTileControlActionBarsAnimation.GetActionBarBottom
  : TdxTileControlCustomActionBar;
begin
  Result := TileControl.ActionBarBottom;
end;

function TdxTileControlActionBarsAnimation.GetActionBarTop
  : TdxTileControlCustomActionBar;
begin
  Result := TileControl.ActionBarTop;
end;

function TdxTileControlActionBarsAnimation.IsCompatible
  (Animation: TdxAnimationTransition): Boolean;
begin
...
constructor TdxTileControlContentAnimation.Create(ATileControl
  : TdxCustomTileControl; ATime: Cardinal; const ALengthX, ALengthY: Integer);
begin
  FTileControl := ATileControl;
  FLengthX := ALengthX;
  FLengthY := ALengthY;
  inherited Create(ATime, ateAccelerateDecelerate,
    Max(Abs(LengthX), Abs(LengthY)));
end;
...
constructor TdxTileControlRubberAnimation.Create(ATileControl
  : TdxCustomTileControl; AHandScrollObject: TdxTileControlHandScroll);
begin
...
constructor TdxTileControlActionBarController.Create
  (AOwner: TdxTileControlCustomActionBar);
begin
  inherited Create;
  FOwner := AOwner;
...
procedure TdxTileControlActionBarController.MouseDown(AButton: TMouseButton;
...
procedure TdxTileControlActionBarController.MouseMove(AShift: TShiftState;
  X, Y: Integer);
begin
  HitTest.Calculate(X, Y);
...
procedure TdxTileControlActionBarController.MouseUp(AButton: TMouseButton;
  AShift: TShiftState; X, Y: Integer);
begin
  HitTest.Calculate(X, Y);
  case AButton of
...
function TdxTileControlActionBarController.GetHitTest
  : TdxTileControlActionBarHitTest;
begin
...
constructor TdxTileControlActionBarHitTest.Create
  (AOwner: TdxTileControlCustomActionBar);
begin
...
function TdxTileControlActionBarHitTest.GetActiveViewInfo
  : TdxTileControlCustomViewInfo;
begin
...
function TdxCustomTileControl.CreateItem(ASize: TdxTileControlItemSize;
  AGroup: TdxTileControlGroup = nil): TdxTileControlItem;
begin
  BeginUpdate;
  try
...
begin
  Result := cxRectSetBottom(ClientRect, ClientRect.Bottom,
    ActionBarBottom.ViewInfo.MeasureHeight);
end;
...
function TdxCustomTileControl.GetCheckedItem(Index: Integer)
  : TdxTileControlItem;
begin
...
procedure TdxCustomTileControl.GetChildren(Proc: TGetChildProc;
  Root: TComponent);
...
procedure TdxCustomTileControl.AfterActiveDetailChanging(AActiveDetail,
  ANewDetail: TdxTileControlDetailSite);
begin
  ...
  begin
    ...
    if dxCopyDirectCanvasContentToGdiCanvas(ActualCanvas, Canvas) then
    ...
    begin
      ...
      else if ANewDetail.CanFocus then
        ANewDetail.SetFocus;
    end;
  end
  else
...
procedure TdxCustomTileControl.BeforeActiveDetailChanging(AActiveDetail,
  ANewDetail: TdxTileControlDetailSite);
  ...
  begin
    case OptionsDetailAnimate.AnimationMode of
      ...
      damScrollFade:
        Result := GetAnimationScrollFadeMode(GetIndex(AActiveDetail),
          GetIndex(ANewDetail));
    else
      Result := GetAnimationScrollMode(GetIndex(AActiveDetail),
        GetIndex(ANewDetail));
    end;
  end;
  ...
  begin
    ...
    try
      if AValue <> nil then
        cxPaintTo(AValue, cxPaintCanvas, cxNullPoint,
          Rect(0, 0, AValue.Width, AValue.Height))
      else
      begin
...
begin
  ...
  FAnimation := TdxImageAnimationTransition.Create(AStartImage, AFinishImage,
    AActualInterval, GetAnimationMode, ateLinear, -1, True, False);
...
function TdxCustomTileControl.GetActiveHitTest: TdxTileControlHitTest;
  ...
  function CheckActionBarHitTest(AActionBar: TdxTileControlCustomActionBar)
    : TdxTileControlHitTest;
  const
    IndexMap: array [Boolean] of Integer = (tchtActionBarBottom,
      tchtActionBarTop);
  begin
    Result := HitTest;
...
begin
  ...
  if (Result = HitTest) and (ActiveDetail <> nil) and ActiveDetailOccupiesAllTileControl
  then
    Result := ActiveDetail.HitTest;
end;

function TdxCustomTileControl.GetAnimationScrollFadeMode(AIndex1,
  AIndex2: Integer): TdxDrawAnimationMode;
const
  AMode: array [Boolean] of TdxDrawAnimationMode = (amScrollLeftFade,
    amScrollRightFade);
begin
  Result := AMode[GetAnimationScrollMode(AIndex1, AIndex2) in [amScrollDown,
    amScrollRight]];
end;

function TdxCustomTileControl.GetAnimationScrollMode(AIndex1, AIndex2: Integer)
  : TdxDrawAnimationMode;
var
  ASign: TValueSign;
begin
...
procedure TdxCustomTileControl.InitScrollBarsParameters;
  ...
  procedure InitScrollBarParameters(AKind: TScrollBarKind;
    ASize, APage, APosition: Integer);
  var
    AMin: Integer;
  begin
    ...
    SetScrollBarInfo(AKind, AMin, ASize + AMin, GetScrollStep, APage, APosition,
      OptionsBehavior.ScrollMode = smScrollbars, True);
  end;

begin
  if ([csLoading, csDestroying, csUpdating, csReading] * ComponentState = [])
    and (ViewInfo <> nil) then
  begin
    InitScrollBarParameters(sbHorizontal, ViewInfo.ContentWidth - 1,
      ViewInfo.HorzScrollPage, ViewInfo.LeftScrollPos);
    InitScrollBarParameters(sbVertical, ViewInfo.ContentHeight - 1,
      ViewInfo.VertScrollPage, ViewInfo.TopScrollPos);
  end;
end;
...
function TdxCustomTileControl.CanDeactivateDetail
  (ADetail: TdxTileControlDetailSite): Boolean;
var
  AItem: TdxTileControlItem;
begin
  Result := True;
...
function TdxCustomTileControl.DoActionBarsHide
  (AReason: TdxTileControlActionBarVisibilityChangeReason): Boolean;
begin
  Result := False;
...
function TdxCustomTileControl.DoActionBarsShow
  (AReason: TdxTileControlActionBarVisibilityChangeReason): Boolean;
begin
  Result := False;
...
function TdxCustomTileControl.DoItemBeforeCheck
  (AItem: TdxTileControlItem): Boolean;
begin
  Result := True;
...
procedure TdxCustomTileControl.ExecuteDetailDeactivating
  (ADetail: TdxTileControlDetailSite);
begin
  ActiveDetail := nil;
end;
...
procedure TdxCustomTileControl.DoHideActionBars
  (AReason: TdxTileControlActionBarVisibilityChangeReason);
begin
  if IsAnyActionBarVisible and not DoActionBarsHide(AReason) then
  begin
    TdxTileControlActionsBarHelper.Unregister(Self);
    TdxTileControlActionBarsAnimation.Create(Self, tcabamHide)
      .ImmediateAnimation;
  end;
end;

procedure TdxCustomTileControl.DoShowActionBars
  (AReason: TdxTileControlActionBarVisibilityChangeReason);
begin
  ...
  begin
    ...
    TdxTileControlActionBarsAnimation.Create(Self, tcabamShow)
      .ImmediateAnimation;
    TdxTileControlActionsBarHelper.Register(Self);
  end;
end;

procedure TdxCustomTileControl.CheckDetailLayout
  (ADetail: TdxTileControlDetailSite);
begin
...
function TdxCustomTileControl.FindGroup(const AName: string)
  : TdxTileControlGroup;
var
  I: Integer;
begin
...
function TdxCustomTileControl.GetDesignHitTest(X, Y: Integer;
...
begin
  ...
  if not Result and (ssLeft in Shift) then
    Result := not FRightButtonPressed and
      (Controller.HitAtItemOrGroup or HitTest.HitAtScrollButton or
      (DragAndDropState <> ddsNone));
end;

function TdxCustomTileControl.GetDragAndDropObjectClass
  : TcxDragAndDropObjectClass;
begin
  if Controller.IsDetectedDragItem then
    Result := TdxTileControlDragDropItem
  else if Controller.IsDetectedDragGroup then
...
function TdxCustomTileControl.GetOptionsBehaviorClass
  : TdxTileControlOptionsBehaviorClass;
begin
  Result := TdxTileControlOptionsBehavior;
end;

function TdxCustomTileControl.GetOptionsViewClass
  : TdxTileControlOptionsViewClass;
begin
  Result := TdxTileControlOptionsView;
end;

function TdxCustomTileControl.GetMouseWheelScrollingKind
  : TcxMouseWheelScrollingKind;
begin
  Result := inherited GetMouseWheelScrollingKind;
  if OptionsView.GroupLayout = glHorizontal then
  begin
    if (Result = mwskNone) and (IsScrollBarActive(sbHorizontal) or
      (OptionsBehavior.ScrollMode = smScrollButtons)) then
      Result := mwskHorizontal
  end
  else if (Result = mwskNone) and (IsScrollBarActive(sbVertical) or
    (OptionsBehavior.ScrollMode = smScrollButtons)) then
    Result := mwskVertical
end;
...
function TdxCustomTileControl.CanAutoSize(var NewWidth,
  NewHeight: Integer): Boolean;

  function GetMinHeight: Integer;
  begin
    Result := ViewInfo.TitleHeight + ViewInfo.FRealContentHeight +
      BorderSize * 2;
  end;
...
begin
  ...
  else if not FScalingInProcess then
  begin
    ...
    if Align in [alLeft, alRight] then
      ANewHeight := Height
    else if ViewInfo.FRealContentHeight = 0 then
    ...
    if Align in [alTop, alBottom] then
      ANewWidth := Width
    else if ViewInfo.FRealContentWidth = 0 then
      ANewWidth := NewWidth
    else
...
function TdxCustomTileControl.CanRemoveGroupIfEmpty
  (AGroup: TdxTileControlGroup): Boolean;
begin
...
procedure TdxCustomTileControl.ChangeScaleEx(M, D: Integer;
  isDpiChange: Boolean);
begin
...
function TdxCustomTileControl.CreateGroupsCollection
  : TdxTileControlGroupCollection;
begin
  Result := TdxTileControlGroupCollection.Create(Self, TdxTileControlGroup);
end;

function TdxCustomTileControl.CreateImagesChangeLink(AOnChange: TNotifyEvent)
  : TChangeLink;
begin
...
function TdxCustomTileControl.CreateImagesFreeNotificator
  (AOnFree: TcxFreeNotificationEvent): TcxFreeNotificator;
begin
  Result := TcxFreeNotificator.Create(nil);
  Result.OnFreeNotification := AOnFree;
end;

function TdxCustomTileControl.CreateItemsCollection
  : TdxTileControlItemCollection;
begin
...
function TdxCustomTileControl.CreateActionBarBottom
  : TdxTileControlCustomActionBar;
begin
...
procedure TdxCustomTileControl.CreateActualCanvas;
begin
  inherited CreateActualCanvas;
  FController.StartAnimations;
end;

procedure TdxCustomTileControl.FreeActualCanvas;
begin
  FController.StopAnimations;
  FlushCache;
...
function TdxCustomTileControl.IsMouseWheelHandleNeeded(Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
  Result := True;
end;

procedure TdxCustomTileControl.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  Controller.MouseDown(Button, Shift, X, Y);
  inherited MouseDown(Button, Shift, X, Y);
...
procedure TdxCustomTileControl.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
  inherited MouseUp(Button, Shift, X, Y);
  Controller.MouseUp(Button, Shift, X, Y);
...
function TdxCustomTileControl.NeedStopAnimationsBeforeActiveDetailChanging
  (AActiveDetail: TdxTileControlDetailSite): Boolean;
begin
  Result := AActiveDetail = nil;
end;

procedure TdxCustomTileControl.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
...
begin
  if (AGroup = nil) or (AGroup.ItemCount > 0) then
    Exit;
  BeginUpdate;
  try
    RemoveGroup(AGroup);
...
procedure TdxCustomTileControl.RefreshItem(AItem: TdxTileControlItem;
  const AData: Pointer);
begin
  AItem.Changed;
end;
...
procedure TdxCustomTileControl.SetActiveDetail
  (AValue: TdxTileControlDetailSite);
var
...
procedure TdxCustomTileControl.SetOptionsDetailAnimate
  (AValue: TdxTileControlDetailOptionsAnimate);
begin
  FOptionsDetailAnimate.Assign(AValue);
end;

procedure TdxCustomTileControl.SetOptionsItemAnimate
  (AValue: TdxTileControlCustomItemOptionsAnimate);
begin
  FOptionsItemAnimate.Assign(AValue);
end;

procedure TdxCustomTileControl.SetOptionsBehavior
  (AValue: TdxTileControlOptionsBehavior);
begin
  FOptionsBehavior.Assign(AValue);
end;

procedure TdxCustomTileControl.SetOptionsView
  (AValue: TdxTileControlOptionsView);
begin
...
begin
  ...
  Result := not FRightButtonPressed and not HitTest.HitAtScrollButton and
    not HitTest.HitAtTitle and ((AHitAtItem and Controller.CanItemMoving) or
    (AHitAtGroup and Controller.CanGroupMoving) or
    (ViewInfo.IsScrollAvailable and not IsDesigning and
    (ADragAndDropObjectClass = TdxTileControlHandScroll)));
...
procedure TdxCustomTileControl.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
  GetStoredPropertyValue(AName, AValue);
end;

procedure TdxCustomTileControl.SetPropertyValue(const AName: string;
  const AValue: Variant);
begin
...
function TdxCustomTileControl.GetGroupsClass
  : TdxTileControlGroupCollectionClass;
begin
...
procedure TdxCustomTileControl.StoreTo(AStorageType: TcxStorageType;
...
function TdxCustomTileControl.GetStoredObjectProperties
  (AProperties: TStrings): Boolean;
begin
...
procedure TdxCustomTileControl.GetStoredPropertyValue(const AName: string;
  var AValue: Variant);
begin
...
procedure TdxCustomTileControl.SetStoredPropertyValue(const AName: string;
  const AValue: Variant);
begin
  if AName = 'Version' then
    FStoredVersion := AValue;
...
function TdxCustomTileControl.StoredCreateChild(const AObjectName,
  AClassName: string): TObject;
begin
  if (AClassName = GetGroupsClass.ClassName) or
    (AClassName = GetItemsClass.ClassName) then
  begin
...
procedure TdxCustomTileControl.StoredDeleteChild(const AObjectName: string;
  AObject: TObject);
begin
  AObject.Free;
end;
...
begin
  RestoreFrom(stIniFile, AStorageName, nil, AChildrenCreating,
    AChildrenDeleting, ARestoreName);
end;
...
procedure TdxCustomTileControl.StoreToStream(AStream: TStream;
  const ASaveName: string = '');
begin
...
begin
  ...
  FCustomButton.LoadFromResource(HInstance, 'dxTileControlCustomButton',
    RT_RCDATA);
...
function TdxTileControlTopActionBarBackButtonViewInfo.GetHitTest
  (AHitTest: TdxTileControlHitTest): Boolean;
begin
  Result := inherited GetHitTest(AHitTest);
  if Result then
...
function TdxTileControlBottomActionBar.CreateViewInfo
  : TdxTileControlCustomActionBarViewInfo;
begin
...
function TdxTileControlBottomActionBarViewInfo.GetCanDisplayItem
  (AItem: TdxTileControlActionBarItem): Boolean;
begin
  Result := inherited GetCanDisplayItem(AItem) and
    (AItem.Position = abipBottomBar);
end;

{ TdxTileControlTopActionBar }

function TdxTileControlTopActionBar.CreateViewInfo
  : TdxTileControlCustomActionBarViewInfo;
begin
...
begin
  ...
  begin
    ...
    ABackButtonBounds := cxRectInflate(ABounds, -ActionBars.IndentHorz,
      -ActionBars.IndentVert);
    ABackButtonBounds := cxRectSetWidth(ABackButtonBounds,
      ABackButtonViewInfo.MeasureSize.cx);
...
function TdxTileControlTopActionBarViewInfo.CreateBackButtonViewInfo
  : TdxTileControlActionBarCustomItemViewInfo;
begin
...
begin
  if PressedScrollButton = nil then
    Exit;
  PressedScrollButton.State := AState[(PressedScrollButton.State = cxbsPressed)
    and ViewInfo.IsScrollAvailable(PressedScrollButton.Direction)];
...
procedure TdxTileControlController.ProcessContextMenuMessage
...
procedure TdxTileControlController.RestoreItemBounds(AItem: TdxTileControlItem;
  const AData: Pointer);
begin
...
procedure TdxTileControlController.SetFocusedItem(AValue: TdxTileControlItem);
  ...
  begin
    Result := True;
    if not(csDestroying in TileControl.ComponentState) and
      Assigned(TileControl.OnItemFocusChanging) then
...
begin
  ...
  begin
    ...
    if not(csDestroying in TileControl.ComponentState) and
      Assigned(TileControl.OnItemFocusChange) then
      TileControl.OnItemFocusChange(TileControl, AOldItem, FFocusedItem);
  end;
end;

procedure TdxTileControlController.SetHottrackedItem
  (AValue: TdxTileControlItem);

  function IsItemHottrackVisible(AMode: TdxTileControlItemHotTrackMode)
    : Boolean;
  begin
...
begin
  ...
  if IsItemHottrackVisible(AMode) then
    if AMode = tcihtmHighlight then
      ...
      AddAnimation(TdxTileControlHottrackItemAnimation.Create
        (FHottrackedItem, False));
  ...
  if IsItemHottrackVisible(AMode) then
    if AMode = tcihtmHighlight then
      ...
      AddAnimation(TdxTileControlHottrackItemAnimation.Create
        (FHottrackedItem, True));
  if AOldItem <> nil then
    AOldItem.Invalidate;
  if (FocusedItem <> nil) and TileControl.OptionsBehavior.HideFocusOnItemHotTrack
  then
    FocusedItem.Invalidate;
end;

procedure TdxTileControlController.SetPressedScrollButton
  (AValue: TdxTileControlScrollButtonViewInfo);
begin
...
// design PopupMenu
function TdxTileControlController.CreatePopupMenuItem(const ACaption: string;
  const ATag: Integer; const AGroupIndex: Byte;
...
function TdxTileControlController.CheckDesignPopupMenu
...
function TdxTileControlController.CreateRegularItem(AGroup: TdxTileControlGroup)
  : TdxTileControlItem;
begin
...
procedure TdxTileControlController.DeleteTileControlGroups
  (const ASelectNextObjectAfterDelete: Boolean);
var
  AIndex: Integer;
  AGroup: TdxTileControlGroup;
begin
...
procedure TdxTileControlController.DeleteTileControlItems
  (const ASelectNextObjectAfterDelete: Boolean);
var
  AItemIndex: Integer;
...
function TdxTileControlController.GetIsExtraLargeItem
  (AItem: TdxTileControlItem): Boolean;
begin
  Result := (AItem.Size = tcisExtraLarge) and (AItem.RowCount = 2);
end;

function TdxTileControlController.GetIsLargeItem
  (AItem: TdxTileControlItem): Boolean;
begin
  Result := (AItem.Size = tcisLarge) and (AItem.RowCount = 1);
end;

function TdxTileControlController.GetIsRegularItem
  (AItem: TdxTileControlItem): Boolean;
begin
  Result := (AItem.Size = tcisRegular) and (AItem.RowCount = 1);
end;

function TdxTileControlController.GetIsSmallItem
  (AItem: TdxTileControlItem): Boolean;
begin
  Result := (AItem.Size = tcisSmall) and (AItem.RowCount = 1);
end;

function TdxTileControlController.GetDesignTimeWhatSelected
  : TdxTileControlDesignTimeWhatSelected;
var
  I: Integer;
begin
  Result := tcdtwsNone;
  ...
  for I := 0 to TileControl.Groups.Count - 1 do
    if IsObjectSelected(TileControl.Groups[I]) then
      ...
      else if Result = tcdtwsGroup then
      begin
        Result := tcdtwsGroups;
        Break;
      end
...
function TdxTileControlController.GetNextObject(ADeletedGroupIndex: Integer)
  : TPersistent;
var
  I: Integer;
begin
...
function TdxTileControlController.GetNextObject(ADeletedItemIndex: Integer;
  ADeletedItemGroup: TdxTileControlGroup): TPersistent;
var
  I: Integer;
begin
  Result := TileControl;
  if ADeletedItemGroup = nil then
    Exit;
...
function TdxTileControlController.IsDesignerMenuItemChecked(const AItemSizeIndex
  : Integer; AItem: TdxTileControlItem): Boolean;
begin
...
function TdxTileControlController.IsDesignerMenuItemChecked
  (AItem: TdxTileControlItem;
...
procedure TdxTileControlController.AddDesignPopupMenuItem(const ACaption
  : string; const ATag: Integer; const AGroupIndex: Byte;
  const AChecked, ARadioItem: Boolean; AOnClick: TNotifyEvent);
begin
  FDesignPopupMenu.Items.Add(CreatePopupMenuItem(ACaption, ATag, AGroupIndex,
    AChecked, ARadioItem, AOnClick));
end;
...
begin
  Result := HitAtItem and (TileControl.IsDesigning or HitTest.Item.CanFocused)
    and EnabledItemMoving;
end;
...
begin
  ...
  AItem := CreatePopupMenuItem('Delete', 0, 0, False, False,
...
const
  AMenuItemCaption: array [Low(TdxTileControlItemSize)
    .. High(TdxTileControlItemSize)] of string = ('Add Small Item',
...
begin
  for I := Low(TdxTileControlItemSize) to High(TdxTileControlItemSize) do
    AddDesignPopupMenuItem(AMenuItemCaption[I], Integer(I), 0, False, False,
...
const
  AMenuItemCaption: array [Low(TdxTileControlItemSize)
    .. High(TdxTileControlItemSize)] of string = ('Small', 'Regular', 'Large',
    'Extra-Large');
var
  I: TdxTileControlItemSize;
  AItem: TdxTileControlItem;
begin
  AItem := FDesignPopupMenuCaller as TdxTileControlItem;
  for I := Low(TdxTileControlItemSize) to High(TdxTileControlItemSize) do
    AddDesignPopupMenuItem(AMenuItemCaption[I], Integer(I), 1,
      IsDesignerMenuItemChecked(Integer(I), AItem), True, SwitchItemsProperty);
end;

procedure TdxTileControlController.ProcessDesignPopupMenu
  (ACaller: TcxComponentCollectionItem; AShift: TShiftState;
  APopupPoint: TPoint);
begin
...
procedure TdxTileControlController.SetDesignItemSize(AItem: TdxTileControlItem;
  AMenuItemTag: Longint);
begin
  ...
  try
    ...
    begin
      ...
      begin
        ...
        SetDesignItemSize(AItem, (Sender as TMenuItem).Tag);
        AHasChanges := AHasChanges or (AOldSize <> AItem.Size) or
          (AOldRowCount <> AItem.RowCount);
      end;
    end;
  finally
...
//
procedure TdxTileControlController.AddAnimation
  (Animation: TdxAnimationTransition);
begin
  FAnimations.Add(Animation);
  Animation.Resume;
end;

procedure TdxTileControlController.AfterAnimation
  (Sender: TdxAnimationController);

  procedure InvalidateItem(AItem: TdxTileControlItem);
  begin
    if AItem.ViewInfo.Visible and AItem.ViewInfo.ContentAnimation.PositionChanged
    then
      AItem.Refresh;
  end;
...
procedure TdxTileControlController.AnimateItemContent
  (AItem: TdxTileControlItem);
begin
  if (AnimationItems.IndexOf(AItem) < 0) and
    (AItem.CanGalleryAnimation or (AItem.ViewInfo.ViewData <>
    AItem.ActiveFrame.ViewData)) then
  begin
...
procedure TdxTileControlController.BeforeAnimation
  (Sender: TdxAnimationController);
begin
end;

procedure TdxTileControlController.DestroyAnimation
  (Animation: TdxAnimationTransition);
begin
...
begin
  Result := (TileControl.OptionsBehavior.GroupMoving or TileControl.IsDesigning)
    and (TileControl.Groups.Count > 1);
end;

function TdxTileControlController.EnabledItemMoving: Boolean;
begin
  Result := (TileControl.OptionsBehavior.ItemMoving or TileControl.IsDesigning)
    and (TileControl.Items.Count > 1);
end;

procedure TdxTileControlController.FrameDestroyed
  (AFrame: TdxTileControlItemFrame);
var
  AItem: TdxTileControlItem;
begin
  AItem := AFrame.TileItem;
  if AnimationItems.IndexOf(AItem) < 0 then
    Exit;
  StopItemContentAnimation;
...
procedure TdxTileControlController.ImmediateAnimation
  (Animation: TdxAnimationTransition);
begin
...
begin
  Result := ((TileControl.DraggedItem <> nil) or
    (ViewInfo.DragDropChanges <> nil)) and
    (((TileControl.DragAndDropObject as TdxTileControlDragDropItem).Place.Group
    <> nil) or not(TileControl.DragAndDropObject as TdxTileControlDragDropItem)
    .FDragOverIsAccepted);
end;

function TdxTileControlController.IsHandScrolling(ACheckedKind
...
begin
  ViewInfo.Calculate;
  dxCopyDirectCanvasContentToGdiCanvas(TileControl.ActualCanvas,
    TileControl.Canvas);
  for I := 0 to TileControl.Groups.Count - 1 do
  begin
    AGroup := TileControl.Groups[I];
  ...
  ImmediateAnimation(TdxTileControlInflateItemAnimation.Create(TileControl,
    nil, -1, 3));
end;

procedure TdxTileControlController.TerminateAnimations
  (ATerminateContentAnimations: Boolean);
var
  I: Integer;
...
begin
  ...
  begin
    ...
    if ((AAnimation is TdxTileControlFramesAnimation) or
      (AAnimation is TdxTileControlGalleryCellAnimation)) <> ATerminateContentAnimations
    then
      Continue;
...
begin
  Result := TileControl.IsDesigning and not TileControl.IsDestroying and
    not TileControl.IsLoading and IsDesignHelperClassInitialized and
    TileControl.HandleAllocated;
end;

function TdxTileControlController.CanShowActionBarsOnRightClick: Boolean;
begin
  Result := not ContextMenuHandled and
    (not HitAtItem or (ItemCheckMode = tcicmNone));
end;
...
procedure TdxTileControlController.CheckActionBarsState(ACheckingItem
  : TdxTileControlItem);
begin
  ...
  begin
    ...
    else if CheckedItems.Count = 0 then
...
function TdxTileControlController.CreateDesignHelper
  : TdxTileControlCustomDesignHelper;
begin
...
function TdxTileControlController.IsObjectSelected
  (AObject: TPersistent): Boolean;
begin
  Result := (DesignHelper <> nil) and DesignHelper.IsObjectSelected(AObject);
end;

procedure TdxTileControlController.SelectObject(AObject: TPersistent;
  AShift: TShiftState);
begin
...
procedure TdxTileControlController.InternalMouseLeftDown(Shift: TShiftState;
  X, Y: Integer);
begin
  //
end;

procedure TdxTileControlController.InternalMouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  //
end;

procedure TdxTileControlController.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  ...
  if not TileControl.IsDesigning and (FMouseDownItem <> nil) and
    not FMouseDownItem.CanFocused then
    FMouseDownItem := nil;
  ...
  begin
    ...
    else if HitAtItem then
    begin
      if not(TileControl.IsDesigning or IsTouchEvent or
        not TileControl.OptionsBehavior.ItemPressAnimation) and
        (FMouseDownItem <> nil) then
        TdxTileControlInflateItemAnimation.Create(TileControl, HitTest.Item, -1,
          3).ImmediateAnimation;
...
procedure TdxTileControlController.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  if not MouseDownWasHandled then
    Exit;
  HitTest.Calculate(X, Y);
  if FRestoreItemsBoundsOnMouseUp or not TileControl.OptionsBehavior.GroupRenaming
  then
    RestoreItemsBounds;
  FRestoreItemsBoundsOnMouseUp := True;
...
begin
  ...
  FGlyphBounds := cxRectSetHeight(cxRectCenterHorizontally(Bounds, ASize.cx),
    ASize.cy);
  FGlyphRect := FGlyphBounds;
end;

procedure TdxTileControlActionBarCustomItemViewInfo.DrawGlyph
  (ACanvas: TcxCustomCanvas);
begin
  Painter.DrawGlyph(ACanvas, FGlyphRect, State, Texture, TextureType,
    TextColor);
end;

procedure TdxTileControlActionBarCustomItemViewInfo.Draw
  (ACanvas: TcxCustomCanvas);
begin
  DrawGlyph(ACanvas);
  if Text <> '' then
    Painter.DrawText(ACanvas, TextBounds, Text, Font, TextColor, taCenter,
      vaCenter);
end;
...
begin
  ...
  if Text <> '' then
  begin
    ATextSize := Painter.MeasureTextSize(cxMeasureCanvas, Text, Font, taCenter,
      False, 0, 0);
...
begin
  if (Controller.PressedCell = Self) and (Controller.HotCell = Self) then
    State := cxbsPressed
  else if (Controller.HotCell = Self) and (Controller.PressedCell = nil) then
    State := cxbsHot
  else
    State := cxbsNormal;
end;

procedure TdxTileControlActionBarCustomItemViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  FGlyphBounds := TdxRightToLeftLayoutConverter.ConvertRect(FGlyphBounds,
    AClientBounds);
...
function TdxTileControlActionBarCustomItemViewInfo.GetController
  : TdxTileControlActionBarController;
begin
...
function TdxTileControlActionBarCustomItemViewInfo.GetPainter
  : TdxTileControlPainter;
begin
  Result := Owner.Owner.TileControl.Painter;
end;

function TdxTileControlActionBarCustomItemViewInfo.GetScaleFactor
  : TdxScaleFactor;
begin
...
function TdxTileControlActionBarItemViewInfo.GetHitTest
  (AHitTest: TdxTileControlHitTest): Boolean;
begin
  Result := inherited GetHitTest(AHitTest);
  if Result then
...
procedure TdxTileControlActionBarItemViewInfo.DrawGlyph
  (ACanvas: TcxCustomCanvas);
const
...
begin
  ...
  begin
    ...
    Painter.DrawGlyph(ACanvas, R, Item.Glyph, Item.GetImages, Item.ImageIndex,
      DrawModeMap[State <> cxbsNormal]);
  end
  else
...
constructor TdxTileControlTabsScrollingAnimation.Create
  (AOwner: TdxTileControlDetailSiteTitleViewInfo; ATime: Cardinal;
...
function TdxTileControlTabsScrollingAnimation.GetDetailSite
  : TdxTileControlDetailSite;
begin
...
constructor TdxTileControlDetailSiteTitleViewInfo.Create
...
begin
  ...
  ABounds := cxRectSetRight(ABounds,
    Max(Bounds.Left + ABounds.Right + TextOffset, GetLeftOffset - TextOffset));
  ABounds := cxRectSetTop(ABounds, (VisibleBounds.Top + VisibleBounds.Bottom -
    cxRectHeight(ABounds)) div 2);
...
procedure TdxTileControlDetailSiteTitleViewInfo.CalculateTabs;
  ...
  begin
    ...
    begin
      ...
      ABounds := cxRectSetBottom(R, R.Bottom,
        Min(cxRectHeight(R), ACellSize.cy));
...
begin
  ...
  begin
    ...
    begin
      ...
      FTabsBounds := cxRectInflate(FTabsBounds,
        -(AScrollButtonWidth + ScaleFactor.Apply(cxTextOffset)), 0);
      RestorePriorTabsLeftScrollPos;
      if cxRectWidth(FTabsBounds) <= 2 * ScaleFactor.Apply(cxTextOffset) then
        DestroyScrollTabsButtons;
    end
    else
      Inc(FTabsBounds.Left, TabsBounds.Right - Tabs[Tabs.Count - 1]
        .Bounds.Right);
...
begin
  ...
  Result := AActualTab.Bounds.Left < TabsBounds.Left -
...
begin
  ...
  if UseRightToLeftAlignment then
    AActualTab := Tabs[0];
  Result := AActualTab.Bounds.Right > TabsBounds.Right +
    ScaleFactor.Apply(cxTextOffset);
end;
...
function TdxTileControlDetailSiteTitleViewInfo.CreateBackButtonViewInfo
  : TdxTileControlDetailSiteBackButtonViewInfo;
begin
...
procedure TdxTileControlDetailSiteTitleViewInfo.CreateScrollTabsButtons;
  ...
  function CreateButton(ADirection: TcxArrowDirection)
    : TdxTileControlDetailSiteTabsScrollButtonViewInfo;
  begin
    Result := TdxTileControlDetailSiteTabsScrollButtonViewInfo.Create(Self,
      ADirection);
    Result.Recalculate;
  end;
...
begin
  inherited DoCalculate;
  CalculateBackButton;
  SetTextBounds(cxRectOffsetHorz(TextBounds, BackButtonViewInfo.Bounds.Right +
    TextOffset - TextBounds.Left));
  TabsFont.Assign(Title.Font);
  TabsFont.Height := dxGetFontHeightForDefaultDPI(Title.TabsFontSize);
  AdjustFontHeight(TabsFont, ScaleFactor, dxTileControlDefaultTabFontSize,
    Painter.PageTabDefaultFontSize);
  CalculateTabs;
  CheckBiDiModeAlignment;
end;

procedure TdxTileControlDetailSiteTitleViewInfo.DoDraw
  (ACanvas: TcxCustomCanvas);
begin
  ACanvas.SaveClipRegion;
...
procedure TdxTileControlDetailSiteTitleViewInfo.DoDrawScrollTabsButtons
  (ACanvas: TcxCustomCanvas);
begin
...
begin
  Result := Max(inherited GetHeight, BackButtonViewInfo.MeasureSize.cy + 2 *
    Title.IndentVert);
end;

function TdxTileControlDetailSiteTitleViewInfo.GetHitTest
  (AHitTest: TdxTileControlHitTest): Boolean;
begin
  Result := inherited GetHitTest(AHitTest);
  if Result then
  begin
    if not BackButtonViewInfo.GetHitTest(AHitTest) and
      not GetTabsScrollButtonsHitTest(AHitTest) and
...
function TdxTileControlDetailSiteTitleViewInfo.GetTabsScrollButtonsHitTest
  (AHitTest: TdxTileControlHitTest): Boolean;
begin
  Result := False;
  if ScrollTabsLeftButton <> nil then
...
function TdxTileControlDetailSiteTitleViewInfo.GetTileControl
  : TdxCustomTileControl;
begin
  Result := Item.TileControl;
end;
...
begin
  ...
  Result.Bottom := Max(Result.Bottom,
    Result.Top + BackButtonViewInfo.MeasureSize.cy + Title.IndentVert * 2);
end;
...
procedure TdxTileControlDetailSiteTitleViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
var
  I: Integer;
begin
  ...
  FTabsBounds := TdxRightToLeftLayoutConverter.ConvertRect(FTabsBounds,
    AClientBounds);
...
procedure TdxTileControlDetailSiteTitleViewInfo.SetTabsLeftScrollPos
  (AValue: Integer);
begin
  if FTabsLeftScrollPos <> AValue then
  begin
    TileControl.Controller.ImmediateAnimation
      (TdxTileControlTabsScrollingAnimation.Create(Self,
...
function TdxTileControlOptionsView.IsAllowableWidth(const AWidth
  : Integer): Boolean;
begin
  Result := AWidth > 0;
end;
...
procedure TdxTileControlOptionsView.SetGroupBlockMaxColumnCount
  (AValue: Integer);
begin
  AValue := Max(1, AValue);
...
procedure TdxTileControlOptionsView.SetGroupLayout
  (AValue: TdxTileControlGroupLayout);
begin
...
procedure TdxTileControlCustomButtonViewInfo.SetBounds(const ABounds,
...
procedure TdxTileControlCustomButtonViewInfo.SetState
  (const Value: TcxButtonState);
begin
...
begin
  if (Owner.PressedCell = Self) and (Owner.HitTest.HitObject = Self) then
    State := cxbsPressed
  else if (Owner.HitTest.HitObject = Self) and (Owner.PressedCell = nil) then
    State := cxbsHot
  else
    State := cxbsNormal;
end;

procedure TdxTileControlDetailSiteBackButtonViewInfo.Draw
  (ACanvas: TcxCustomCanvas);
begin
  Owner.TileControl.Painter.DrawGlyph(ACanvas, Bounds, State, Texture,
    TextureType, Owner.TitleViewInfo.TextColor,
...
function TdxTileControlDetailSiteBackButtonViewInfo.GetScaleFactor
  : TdxScaleFactor;
begin
  Result := Owner.TileControl.ScaleFactor;
end;
...
begin
  ASizeX := Owner.LookAndFeelPainter.ScaledSliderButtonSize(FDirection,
    ScaleFactor).cx;
  ASizeY := Owner.LookAndFeelPainter.ScaledSliderButtonSize(FDirection,
    ScaleFactor).cy;
...
procedure TdxTileControlScrollButtonViewInfo.DoCalculateTopLeft(const ASizeX,
  ASizeY: Integer; var ATop, ALeft: Integer);
  ...
  begin
    ...
    AIsNeedUseFixedIndentHorz := Owner.OptionsView.FixedIndentHorz and
      (AOwnerIndentHorz > ASizeX + 2 * AFrameSize);
    ...
    AIsNeedUseFixedIndentVert := Owner.OptionsView.FixedIndentVert and
      (AOwnerIndentVert > ASizeY + 2 * AFrameSize);
...
begin
  ...
  AHeight := cxRectHeight(R);
  CalculateOffsetsAndPlacements(AOffsetX, AOffsetY, AIsNeedUseFixedIndentHorz,
    AIsNeedUseFixedIndentVert);
  case Direction of
    adUp:
      begin
...
begin
  if State <> cxbsDisabled then
    Owner.LookAndFeelPainter.DrawScaledSliderButton(ACanvas, Bounds, FDirection,
      State, ScaleFactor);
end;

procedure TdxTileControlScrollButtonViewInfo.DoScrollContent;
const
  AScrollBarKind: array [TcxArrowDirection] of TScrollBarKind = (sbVertical,
    sbVertical, sbHorizontal, sbHorizontal);
  AScrollCode: array [TcxArrowDirection] of TScrollCode = (scLineUp, scLineDown,
    scLineUp, scLineDown);
var
  AScrollPos: Integer;
begin
...
function TdxTileControlScrollButtonViewInfo.GetController
  : TdxTileControlController;
begin
...
function TdxTileControlScrollButtonViewInfo.GetHitTest
  (AHitTest: TdxTileControlHitTest): Boolean;
begin
  Result := False;
  if (Owner.DragAndDropState <> ddsNone) or not ViewInfo.IsScrollAvailable
    (FDirection) then
  begin
  ...
  else if PtInCaller(AHitTest.HitPoint) then
  begin
    AHitTest.HitObject := Self;
...
procedure TdxTileControlScrollButtonViewInfo.SetState
  (const AValue: TcxButtonState);
begin
...
function TdxTileControlScrollButtonViewInfo.PtInCaller(const P: TPoint)
  : Boolean;
begin
...
constructor TdxTileControlDetailSiteTabsScrollButtonViewInfo.Create
  (AOwner: TdxTileControlDetailSiteTitleViewInfo;
...
procedure TdxTileControlDetailSiteTabsScrollButtonViewInfo.DoDraw
  (ACanvas: TcxCustomCanvas);
begin
  Owner.TileControl.LookAndFeelPainter.DrawArrow(ACanvas, Bounds, FDirection,
    Owner.Painter.PageTabTextColor[State]);
end;
...
function TdxTileControlDetailSiteTabsScrollButtonViewInfo.GetDetailSite
  : TdxTileControlDetailSite;
begin
  Result := Owner.Owner as TdxTileControlDetailSite;
end;

function TdxTileControlDetailSiteTabsScrollButtonViewInfo.GetHitTest
  (AHitTest: TdxTileControlHitTest): Boolean;
begin
  Result := inherited GetHitTest(AHitTest);
...
function TdxTileControlDetailSiteTabsScrollButtonViewInfo.
  GetNearestTabBounds: TRect;

  function GetNearestTabBoundsToLeftScrollButton
    (ATabs: TdxTileControlCells): TRect;
  var
    I: Integer;
  ...
  function GetNearestTabBoundsToRightScrollButton
    (ATabs: TdxTileControlCells): TRect;
  var
    I: Integer;
    ATab: TdxTileControlPageTabCellViewInfo;
...
function TdxTileControlDetailSiteTabsScrollButtonViewInfo.GetScaleFactor
  : TdxScaleFactor;
begin
  Result := Owner.ScaleFactor;
end;
...
begin
  ...
  if (FDirection = adLeft) and not Owner.CanScrollTabToLeft then
    State := cxbsDisabled
  else if (FDirection = adRight) and not Owner.CanScrollTabToRight then
    State := cxbsDisabled
  else if (DetailSite.PressedCell = Self) and
    (DetailSite.HitTest.HitObject = Self) then
    State := cxbsPressed
  else if (DetailSite.HitTest.HitObject = Self) and
    (DetailSite.PressedCell = nil) then
    State := cxbsHot
  else
    State := cxbsNormal;
...
procedure TdxTileControlDetailSiteTabsScrollButtonViewInfo.Scroll(const dX,
  dY: Integer);
begin
end;

procedure TdxTileControlDetailSiteTabsScrollButtonViewInfo.
  DoRightToLeftConversion(const AClientBounds: TRect);
begin
  inherited DoRightToLeftConversion(AClientBounds);
  if FDirection = adLeft then
    FDirection := adRight
...
procedure TdxTileControlDetailSiteTabsScrollButtonViewInfo.SetState
  (const AValue: TcxButtonState);
begin
  if FState <> AValue then
  begin
...
procedure TdxTileControlDetailSiteTabsScrollButtonViewInfo.TimerHandler
  (Sender: TObject);
begin
  if DetailSite.PressedCell = Self then
  begin
...
function TdxTileControlDetailSiteTabsScrollButtonViewInfo.PtInCaller
...
function TdxTileControlItemFrames.GetItem(AIndex: Integer)
  : TdxTileControlItemFrame;
begin
...
procedure TdxTileControlItemFrames.SetItem(AIndex: Integer;
  const AValue: TdxTileControlItemFrame);
begin
...
procedure TdxTileControlPainter.DrawBackground(ACanvas: TcxCustomCanvas;
  const R: TRect);
var
...
begin
  ...
  ATextureOffsetX := MulDiv(TileControl.ViewInfo.LeftScrollPos,
    TileControl.OptionsBehavior.BackgroundScrollSync, 100);
  ATextureOffsetY := MulDiv(TileControl.ViewInfo.TopScrollPos,
    TileControl.OptionsBehavior.BackgroundScrollSync, 100);
  if UseSkins then
  begin
    SkinInfo.TileControlBackground.UseCache := True;
    SkinInfo.TileControlBackground.Draw(ACanvas, R, ScaleFactor);
    DrawStyleTexture(ACanvas, R, TileControl.Style, ATextureOffsetX,
      ATextureOffsetY, @FBackgroundCache);
  end
  else
  begin
    if TileControl.Style.IsEmpty then
      LookAndFeelPainter.DrawPanelContent(ACanvas, R);
    DrawStyleRect(ACanvas, R, TileControl.Style, ATextureOffsetX,
      ATextureOffsetY, @FBackgroundCache);
  end;
end;

procedure TdxTileControlPainter.DrawDesignTimeBorder(ACanvas: TcxCustomCanvas;
  const R: TRect; ASelected: Boolean);
const
  ColorMap: array [Boolean] of TColor =
    (dxTileVirtualGroupBackgroundColor, clBlue);
  StyleMap: array [Boolean] of TPenStyle = (psDash, psDashDot);
begin
  ACanvas.Rectangle(R, clNone, ColorMap[ASelected], StyleMap[ASelected]);
end;

procedure TdxTileControlPainter.DrawGlyph(ACanvas: TcxCustomCanvas;
  const R: TRect; AGlyph: TdxSmartImage);
begin
  ACanvas.DrawNativeObject(R, TcxCanvasBasedResourceCacheKey.Create(AGlyph,
    cxSize(R), 0, 0, ScaleFactor.TargetDPI),
    procedure(ACanvas: TcxGdiBasedCanvas; const R: TRect)
    begin
      cxDrawImage(TcxCanvas(ACanvas), R, AGlyph, ifmNormal, nil, ScaleFactor);
    end);
end;

procedure TdxTileControlPainter.DrawGlyph(ACanvas: TcxCustomCanvas;
const R: TRect; AGlyph: TdxSmartImage; AImages: TCustomImageList;
AImageIndex: TcxImageIndex; ADrawMode: TcxImageDrawMode = idmNormal);
var
  ACacheKey: TcxCanvasBasedResourceCacheKey;
begin
  ACacheKey := TcxCanvasBasedResourceCacheKey.Create(AGlyph, cxSize(R),
    Ord(ADrawMode), -1, ScaleFactor.TargetDPI);
  ...
  ACanvas.DrawNativeObject(R, ACacheKey,
    procedure(ACanvas: TcxGdiBasedCanvas; const R: TRect)
    begin
      cxDrawImage(TcxCanvas(ACanvas), R, AGlyph, AImages, AImageIndex,
        ifmStretch, ADrawMode, False, nil, ScaleFactor, True);
    end);
end;

procedure TdxTileControlPainter.DrawGlyph(ACanvas: TcxCustomCanvas;
const R: TRect; AState: TcxButtonState; AGlyph: TdxSkinImage;
AGlyphType: TImageType; AColor: TColor; AIsRTL: Boolean = False);
const
...
begin
  ...
  begin
    ...
    try
      ...
      ASkinImage.RightToLeftDependentDraw(ACanvas, R, ScaleFactor, AIsRTL,
        StateMap[AState]);
    finally
      ASkinImage.Free;
    end;
...
procedure TdxTileControlPainter.DrawDefaultItemBackground
  (ACanvas: TcxCustomCanvas; const R: TRect);
begin
  if UseSkins then
    SkinInfo.TileControlItem.Draw(ACanvas, R, ScaleFactor)
  else
    ACanvas.FillRectByGradient(R, dxColorToAlphaColor(dxTileItemShadowColor),
...
const R: TRect);
begin
  DrawDefaultItemCheck(ACanvas, R, CheckedItemFrameColor,
    CheckedItemCheckMarkColor);
end;

procedure TdxTileControlPainter.DrawDefaultItemCheck(ACanvas: TcxCustomCanvas;
const R: TRect; ABackgroundColor, ACheckMarkColor: TColor;
AAlpha: Byte = MaxByte);
begin
  ACanvas.DrawNativeObject(R, TcxCanvasBasedResourceCacheKey.Create(Self,
    cxSize(R), ABackgroundColor, ACheckMarkColor, ScaleFactor.TargetDPI),
    procedure(ACanvas: TdxGPCanvas; const R: TRect)
    begin
      DrawDefaultItemCheck(ACanvas, R, dxColorToAlphaColor(ABackgroundColor,
        AAlpha), dxColorToAlphaColor(ACheckMarkColor, AAlpha), ScaleFactor);
    end);
end;

procedure TdxTileControlPainter.DrawDefaultItemCheck(ACanvas: TdxGPCanvas;
const R: TRect; ABackgroundColor, ACheckMarkColor: TdxAlphaColor;
AScaleFactor: TdxScaleFactor);
  ...
  begin
    APoints[0] :=
      cxPoint(R.Right - AScaleFactor.Apply
      (dxTileCheckedItemCheckMarkAreaSize), R.Top);
    APoints[1] := cxPoint(R.Right, R.Top);
    APoints[2] := cxPoint(R.Right,
      R.Top + AScaleFactor.Apply(dxTileCheckedItemCheckMarkAreaSize));

    Result := TdxGPRegion.Create(R);
    Result.CombineRegionRect(cxRectInflate(R,
      -AScaleFactor.Apply(dxTileCheckedItemFrameBorderSize)), gmExclude);
    Result.CombineRegionRegion(CreatePolygonRgn(APoints[0], Length(APoints),
      ALTERNATE), gmUnion, True);
  end;
  ...
  begin
    ACheckMarkAreaHalfSize := AScaleFactor.Apply
      (dxTileCheckedItemCheckMarkAreaSize) div 2;
    Result := cxRectSetHeight(R, MulDiv(ACheckMarkAreaHalfSize,
      AScaleFactor.Apply(8), AScaleFactor.Apply(9)));
    Result := cxRectSetRight(Result, Result.Right, ACheckMarkAreaHalfSize);
    Result := cxRectInflate(Result, 0,
      -2 * AScaleFactor.Apply(dxTileCheckedItemFrameBorderSize),
  ...
  begin
    ...
    APoints[1] := cxPoint((ACheckMarkArea.Left + ACheckMarkArea.Right) div 2,
      ACheckMarkArea.Bottom);
    APoints[2] := cxPoint(ACheckMarkArea.Left,
      (ACheckMarkArea.Bottom + ACheckMarkArea.Top) div 2);

    APrevSmoothingMode := ACanvas.SmoothingMode;
    try
      ACanvas.SmoothingMode := smAntiAlias;
      ACanvas.Polyline(APoints, AColor,
        AScaleFactor.Apply(dxTileCheckedItemCheckMarkPenSize));
    finally
...
const R: TRect; AHighlightColor: TdxAlphaColor;
...
procedure TdxTileControlPainter.DrawItemCheck(ACanvas: TcxCustomCanvas;
const R: TRect);
begin
  if UseSkins then
...
procedure TdxTileControlPainter.DrawStyleRect(ACanvas: TcxCustomCanvas;
const R: TRect; AStyle: TdxTileControlCustomStyle;
ATextureOffsetX, ATextureOffsetY: Integer;
ATextureCache: PcxCanvasBasedImage = nil);
begin
  ACanvas.FillRectByGradient(R,
    dxColorToAlphaColor(cxGetActualColor(AStyle.GradientBeginColor,
    LookAndFeelPainter.DefaultContentColor)),
    dxColorToAlphaColor(AStyle.GradientEndColor),
    dxSkinsGradientModeMap[AStyle.Gradient]);
  DrawStyleTexture(ACanvas, R, AStyle, ATextureOffsetX, ATextureOffsetY,
    ATextureCache);
end;

procedure TdxTileControlPainter.DrawStyleRectFrame(ACanvas: TcxCustomCanvas;
const R: TRect; AStyle: TdxTileControlCustomStyle);
begin
  if AStyle.BorderColor <> clNone then
    ACanvas.FrameRect(R,
      dxColorToAlphaColor(cxGetActualColor(AStyle.BorderColor, clBtnShadow)), 1,
      cxBordersAll);
end;

procedure TdxTileControlPainter.DrawStyleTexture(ACanvas: TcxCustomCanvas;
R: TRect; AStyle: TdxTileControlCustomStyle;
ATextureOffsetX, ATextureOffsetY: Integer; ATextureCache: PcxCanvasBasedImage);
var
...
procedure TdxTileControlPainter.DrawItemBackground(ACanvas: TcxCustomCanvas;
const R: TRect; AStyle: TdxTileControlCustomStyle);
begin
...
procedure TdxTileControlPainter.DrawItemPlace(ACanvas: TcxCustomCanvas;
const R: TRect);
begin
  if UseSkins then
...
procedure TdxTileControlPainter.DrawPageTab(ACanvas: TcxCustomCanvas;
...
begin
  if UseSkins then
    SkinInfo.TileControlTabHeader.Draw(ACanvas, R, ScaleFactor, 0,
      ButtonStateToSkinState[AState]);
end;

procedure TdxTileControlPainter.DrawText(ACanvas: TcxCustomCanvas;
const R: TRect; const AText: string; AFont: TFont; AColor: TColor;
AAlignment: TAlignment = taLeftJustify;
AVertAlignment: TcxAlignmentVert = vaCenter; AWordWrap: Boolean = False;
APaintOnGlass: Boolean = False);
var
...
begin
  ...
  begin
    ...
    try
      ...
      ALayout.SetLayoutConstraints(cxRectWidth(R), cxRectHeight(R), 0);
...
procedure TdxTileControlPainter.DrawTransparentBackground(ACanvas: TcxCanvas;
const R: TRect);
begin
  ACanvas.SaveClipRegion;
  try
...
procedure TdxTileControlPainter.DrawVirtualGroup(ACanvas: TcxCustomCanvas;
const R: TRect);
begin
  if UseSkins then
    SkinInfo.TileControlVirtualGroup.Draw(ACanvas, R, ScaleFactor)
...
function TdxTileControlPainter.MeasureTextSize(ACanvas: TcxCustomCanvas;
const AText: string; AFont: TFont; AAlignment: TAlignment; AWordWrap: Boolean;
AMaxWidth, AMaxHeight: Integer): TSize;
var
  ALayout: TcxCanvasBasedTextLayout;
begin
  ALayout := ACanvas.CreateTextLayout;
...
begin
  Result := cxGetActualColor(TileControl.Style.CheckedItemCheckMarkColor,
    clHighlightText);
end;

function TdxTileControlPainter.GetCheckedItemFrameColor: TColor;
begin
  Result := cxGetActualColor(TileControl.Style.CheckedItemFrameColor,
    clHighlight);
end;
...
function TdxTileControlPainter.GetItemOuterFrameColor
  (AItem: TdxTileControlCustomItem): TColor;
begin
  if (AItem <> nil) and
    (TileControl.OptionsBehavior.ItemOuterFrameColor = clDefault) then
    Result := GetColorAsItemBackground(AItem)
  else
    Result := TileControl.OptionsBehavior.ItemOuterFrameColor;
end;

function TdxTileControlPainter.GetLookAndFeelPainter
...
function TdxTileControlPainter.GetPageTabTextColor
...
class function TdxTileControlPainter.GetColorAsItemBackground
  (AItem: TdxTileControlCustomItem): TColor;
begin
...
function TdxTileControlPainter.GetTextOutFlags(AAlignment: TAlignment;
AVertAlignment: TcxAlignmentVert; AWordWrap: Boolean): Integer;
const
  ...
  VertAlign: array [TcxAlignmentVert] of Integer = (CXTO_TOP, CXTO_BOTTOM,
    CXTO_CENTER_VERTICALLY);
begin
  Result := CXTO_EXPANDTABS or CXTO_EDITCONTROL or CXTO_END_ELLIPSIS;
  Result := Result or HorzAlign[TileControl.UseRightToLeftAlignment, AAlignment]
    or VertAlign[AVertAlignment];
...
function TdxTileControlPainter.GetSelectionFocusedColor
  (AItem: TdxTileControlCustomItem = nil): TColor;
begin
...
function TdxTileControlPainter.GetSelectionHottrackedColor
  (AItem: TdxTileControlCustomItem = nil): TColor;
begin
...
begin
  ...
  Painter.DrawText(ACanvas, cxRectContent(Bounds, GetContentOffsets), Caption,
    Font, Painter.PageTabTextColor[State], taCenter, vaCenter);
end;
...
begin
  AContentOffsets := GetContentOffsets;
  Result := Painter.MeasureTextSize(Owner.ActualCanvas, Caption, Font, taCenter,
    False, 0, 0);
  Inc(Result.cx, cxMarginsWidth(AContentOffsets));
  Inc(Result.cy, cxMarginsHeight(AContentOffsets));
...
begin
  if not Item.IsEnabled then
    ...
    State := cxbsPressed
  else if Owner.TileControl.HitTest.HitObject = Self then
    State := cxbsHot
  else
    State := cxbsNormal;
end;

procedure TdxTileControlPageTabCellViewInfo.SetBounds(const ABounds,
  AVisibleBounds: TRect);
begin
  FBounds := ABounds;
...
procedure TdxTileControlPageTabCellViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  VisibleBounds := TdxRightToLeftLayoutConverter.ConvertRect(VisibleBounds,
    AClientBounds);
  inherited DoRightToLeftConversion(AClientBounds);
end;
...
constructor TdxTileControlCustomItemViewData.Create
...
procedure TdxTileControlCustomItemViewData.AdjustObjectBounds
  (const ABounds: TRect; var AObjectBounds: TRect;
...
begin
  ...
  begin
    AObjectBounds := cxRectSetLeft(AObjectBounds,
      (ABounds.Left + ABounds.Right - cxRectWidth(AObjectBounds)) div 2);
    AIndentHorz := 0;
  end
  else if AAlign in [oaTopRight, oaMiddleRight, oaBottomRight] then
  begin
  ...
  else if AAlign in [oaMiddleLeft .. oaMiddleRight] then
  begin
...
procedure TdxTileControlCustomItemViewData.AdjustImageBoundsWithText
  (const ABounds: TRect; AText: TdxTileControlItemText;
...
begin
  ...
  AdjustObjectBounds(ABounds, R, AImageAlign, AGlyph.IndentHorz,
    AGlyph.IndentVert);
  ...
  case AAlign of
    itaLeft:
      begin
        ...
        ATextBounds := cxRectSetLeft(ATextBounds, AImageBounds.Right +
          AText.IndentHorz);
      end;
    ...
    itaTop:
      begin
        ...
        ATextBounds := cxRectSetTop(ATextBounds, AImageBounds.Bottom +
          AText.IndentVert);
      end;
    ...
    itaRight:
      begin
        ...
        ATextBounds := cxRectSetRight(ATextBounds,
          AImageBounds.Left - AText.IndentHorz);
      end;

    itaBottom:
      begin
        AImageBounds := cxRectSetBottom(AImageBounds, R.Bottom);
        ATextBounds := cxRectSetBottom(ATextBounds,
          AImageBounds.Top - AText.IndentVert);
      end;
  end;
  ...
  begin
    ...
    if (AAlign in [itaTop, itaBottom]) and (DW > 0) then
      OffsetRect(AImageBounds,
        DW * (Ord(AImageAlign in [oaTopLeft, oaMiddleLeft, oaBottomLeft]) *
        2 - 1), 0)
    else if (AAlign in [itaLeft, itaRight]) and (DH > 0) then
      OffsetRect(AImageBounds, 0,
        DH * (Ord(AImageAlign in [oaTopLeft, oaTopCenter, oaTopRight])
        * 2 - 1));
  end;
  ...
  begin
    if cxRectWidth(ATextBounds) <= cxRectWidth(AImageBounds) then
      ATextBounds := cxRectSetLeft(ATextBounds,
        (AImageBounds.Left + AImageBounds.Right -
        cxRectWidth(ATextBounds)) div 2)
  end
  else if cxRectHeight(ATextBounds) <= cxRectHeight(AImageBounds) then
    ATextBounds := cxRectSetTop(ATextBounds,
      (AImageBounds.Top + AImageBounds.Bottom -
      cxRectHeight(ATextBounds)) div 2);
...
procedure TdxTileControlCustomItemViewData.CalculateImageAndTextLayout
  (const ABounds: TRect);

  function GetTextBounds(AText: TdxTileControlItemText; ANum: Integer;
  AGlyph: TdxTileControlItemCustomGlyph): TRect;
  var
    AImageSize: TSize;
    AImageAlign: TdxTileControlImageWithTextAlignment;
  begin
    Result := ABounds;
    Result.BottomRight := cxPointOffset(Result.BottomRight, -AText.IndentHorz,
      -AText.IndentVert);
    AImageAlign := AGlyph.AlignWithText;
    if (ANum = 0) and (not AGlyph.Image.Empty or Item.Glyph.IsImageListUsed) and
      (AImageAlign <> itaNone) then
    begin
...
begin
  ...
  FImageBounds := cxRectScaleSize(AGlyph.GetClientRect(ABounds), dxDefaultDPI,
    AGlyph.Image.SourceDPI);
  for I := 0 to 3 do
  begin
    ...
    begin
      ATextBounds := cxRectInflate(GetTextBounds(AText, I, AGlyph),
        -APainter.ScaleFactor.Apply(cxTextSpace));
      ATextBounds := cxRectSetSize(ATextBounds,
        APainter.MeasureTextSize(ACanvas, AText.GetActualValue,
        AText.GetActualFont, AText.Alignment, AText.WordWrap,
        cxRectWidth(ATextBounds), cxRectHeight(ATextBounds)));
      AdjustObjectBounds(ABounds, ATextBounds, AText.GetActualAlign,
        AText.IndentHorz, AText.IndentVert);
      FTextBounds[I] := ATextBounds;
    end;
  end;
  if not cxRectIsEmpty(FImageBounds) then
  begin
    AdjustObjectBounds(ABounds, FImageBounds, AGlyph.GetActualAlign,
      AGlyph.IndentHorz, AGlyph.IndentVert);
    if (AGlyph.AlignWithText <> itaNone) and Item.GetText(0).HasValue then
      AdjustImageBoundsWithText(ABounds, Item.GetText(0), FImageBounds,
        FTextBounds[0]);
  end;
end;

procedure TdxTileControlCustomItemViewData.DrawItemBackground
  (ACanvas: TcxCustomCanvas);
var
  AStyle: TdxTileControlCustomStyle;
begin
...
procedure TdxTileControlCustomItemViewData.DrawItemGlyph
  (ACanvas: TcxCustomCanvas);
var
  AGlyph: TdxTileControlItemCustomGlyph;
begin
  AGlyph := Item.Glyph;
  Painter.DrawGlyph(ACanvas, ImageBounds, AGlyph.Image, AGlyph.GetImages,
    AGlyph.ImageIndex);
end;

procedure TdxTileControlCustomItemViewData.DrawItemText
  (ACanvas: TcxCustomCanvas; const ATextBounds, AClientRect: TRect;
AText: TdxTileControlItemText);
var
  AActualText: string;
  AClipNeeded: Boolean;
...
begin
  ...
  begin
    ...
    begin
      ACanvas.FillRect(ATextBounds, cxGetActualColor(AText.GetActualColor,
        Painter.DefaultItemTextBackgroundColor), MaxByte);
    end;
...
begin
  for I := 0 to 3 do
    DrawItemText(ACanvas, cxRectOffset(FTextBounds[I], AOrigin), AClipRect,
      Item.GetText(I));
end;
...
begin
  FClientRect := cxRectContent(TileItem.ViewInfo.GetHighlightBounds(Bounds),
    Item.Margins.Margin);
...
function TdxTileControlCustomItemViewData.GetGalleryCellController
  : TdxTileControlGalleryCellController;
begin
...
begin
  ...
  begin
    FAnimationInterval := TdxTileControlDetailOptionsAnimate(ASource)
      .AnimationInterval;
...
begin
  ...
  begin
    ...
    AssignedValues := TdxTileControlCustomItemOptionsAnimate(Source)
      .AssignedValues;
  end;
end;
...
function TdxTileControlCustomItemOptionsAnimate.GetParentOptionsAnimate
  : TdxTileControlCustomItemOptionsAnimate;
begin
  Result := nil;
end;

procedure TdxTileControlCustomItemOptionsAnimate.SetAnimateText
  (AValue: Boolean);
begin
...
begin
  ...
  FCountInfoFont.Height := dxGetFontHeightForDefaultDPI
    (dxTileControlDefaultGroupCaptionFontSize);
...
procedure TdxTileControlDragDropItem.EndDragAndDropItem(Accepted: Boolean;
var ANewGroup: TdxTileControlGroup);
var
  I: Integer;
begin
  if not Accepted or ((FPrevPlace.Group = nil) and
    (FPrevPlace.VirtualGroup = nil)) then
...
procedure TdxTileControlDragDropItem.CalculateDragAndDropItemInVirtualGroup
  (var AAccepted: Boolean);
var
  AGroup, ATemporaryGroup: TdxTileControlGroup;
begin
  if GetStayInPlaceVirtualGroup then
    Exit;
...
begin
  ...
  if not Result then
    Exit;
  if GroupLayout = glVertical then
    Result := DragItem.ViewInfo.GetLastOccupiedRow
      (DragItem.ViewInfo.Position.Row) = BeginGroup.RealRowCount - 1
  else
    Result := DragItem.ViewInfo.GetLastOccupiedColumn
      (DragItem.ViewInfo.Position.Column) = BeginGroup.RealColumnCount - 1;
  if Result then
  begin
    ...
    try
      ...
      if (AChanging.cx <> 0) or (AChanging.cy <> 0) then
      begin
        ANextGroupExpandedBounds := BeginGroup.Groups.GetNextVisibleGroup
          (BeginGroup).ExpandedBounds;
        ANextGroupExpandedBounds := cxRectOffset(ANextGroupExpandedBounds,
          Point(AChanging.cx, AChanging.cy));
...
begin
  ...
  ASizeX := TileControl.ViewInfo.ItemSmallWidth +
    TileControl.OptionsView.ItemIndent;
  ASizeY := TileControl.ViewInfo.ItemSmallHeight +
    TileControl.OptionsView.ItemIndent;
  ...
  case DragItem.Size of
    tcisRegular:
      begin
        ...
        AColumn := TdxTileControlGroupViewInfo.
          GetStartOfCurrentRegularColumn(AColumn);
      end;
    tcisLarge, tcisExtraLarge:
      begin
        ARow := TdxTileControlGroupViewInfo.GetStartOfCurrentRegularRow(ARow);
        AColumn := TdxTileControlGroupViewInfo.GetStartOfCurrentLogicalColumn
          (AColumn, 2 * TileControl.OptionsView.GroupBlockMaxColumnCount);
      end;
  end;
...
var
  AIndex: Integer;
begin
  AIndex := AVirtualGroup.Group.Index +
    Ord(AVirtualGroup = AVirtualGroup.Group.VirtualGroupAfter);
...
begin
  ...
  if AGroup = nil then
    Exit;
  Result := True;
  if not IsDragBoundsCrossesOnTheRight(AGroup) then
    Exit;
  ...
  try
    ...
    if GroupLayout = glHorizontal then
      Result := cxRectWidth(AGroup.ExpandedBounds)
        = cxRectWidth(FTemporaryGroup.ExpandedBounds)
    else
      Result := cxRectHeight(AGroup.ExpandedBounds)
        = cxRectHeight(FTemporaryGroup.ExpandedBounds);
  finally
...
begin
  AGroup := DragItem.Group;
  Result := (AGroup <> nil) and
    (AGroup.Bounds.Left > FPlace.VirtualGroup.Bounds.Left);
end;
...
begin
  ...
  begin
    AGroup := TileControl.Groups[I].ViewInfo;
    if AGroup.Group.Visible and cxRectIntersect(R, ADragBounds,
      AGroup.ExpandedBounds) then
    begin
  ...
  else if AResult is TdxTileControlVirtualGroupViewInfo then
...
function TdxTileControlDragDropItem.GetGroupCrossedOnTheRight
  : TdxTileControlGroup;
var
  I: Integer;
  AGroup: TdxTileControlGroup;
...
begin
  ...
  if UseRightToLeftAlignment then
    Result := TdxRightToLeftLayoutConverter.ConvertPoint(Result,
      ViewInfo.ClientBounds);
end;

function TdxTileControlDragDropItem.GetMaximizedAreaBoundsChanging
  (AGroup: TdxTileControlGroup): TSize;
var
  AMaximizedAreaBounds: TRect;
begin
  AMaximizedAreaBounds := AGroup.MaximizedAreaBounds;
  RecalculateGroup(AGroup);
  Result.cx := cxRectWidth(AGroup.MaximizedAreaBounds) -
    cxRectWidth(AMaximizedAreaBounds);
  Result.cy := cxRectHeight(AGroup.MaximizedAreaBounds) -
    cxRectHeight(AMaximizedAreaBounds);
end;

function TdxTileControlDragDropItem.GetNewIndexOfDragItem
  (AGroup: TdxTileControlGroup): Integer;

  function GetPositionCountOccupiedWithHeadOfItem
    (AItem: TdxTileControlItem): Integer;
  var
    AColumn: Integer;
...
begin
  ...
  begin
    ...
    AIndex := AGroup.ViewInfo.GetZIndex(AItem.ViewInfo.Position,
      Place.Position);
    if AIndex + GetPositionCountOccupiedWithHeadOfItem(AItem) - 1 < ADragItemIndex
    then
    begin
      Result := I + 1;
      Break;
...
function TdxTileControlDragDropItem.GetSecondaryDragPoint
  (ABounds: TRect): TPoint;
var
  AHelper: TdxTileControlDragAndDropSecondaryDragPointHelper;
begin
  AHelper := TdxTileControlDragAndDropSecondaryDragPointHelper.Create
    (TileControl, DragBounds, ABounds);
  try
...
begin
  Result := cxRectCenter(GetActualDragBounds).X -
    TileControl.OptionsView.ItemWidth div 4;
end;
...
begin
  Result := False;
  if not FPrevAccepted or IsDragItemsGroupStayMoreRight or IsDragItemsGroupHasMaxExpanded
  then
  begin
...
procedure TdxTileControlDragDropItem.InitializeDragImage;
  ...
  begin
    ...
    ABounds.Left := ABounds.Right - 3 *
      TileControl.ViewInfo.ItemSmallWidth div 4;
    ABounds.Bottom := ABounds.Top + 3 *
      TileControl.ViewInfo.ItemSmallHeight div 4;
    DragImage.Canvas.FillRect(ABounds,
      dxGetColorTint(FCountInfoFont.Color, -70));
    cxTextOut(DragImage.Canvas.Handle, IntToStr(CheckedItems.Count + 1),
      ABounds, cxMakeFormat(taCenterX, taCenterY), 0, 0, FCountInfoFont, clNone,
      clNone, 0, 0, 0, FCountInfoFont.Color);
  end;
...
begin
  ...
  else if CheckedItems <> nil then
    DrawCheckedCountInfo;
end;

function TdxTileControlDragDropItem.IsDragBoundsCrossesOnTheRight
  (AGroup: TdxTileControlGroup): Boolean;
var
...
begin
  ...
  ADragBounds := GetActualDragBounds;
  if GroupLayout = glHorizontal then
    Result := (PtInRect(ABounds, ADragBounds.TopLeft) or PtInRect(ABounds,
      cxRectLeftBottom(ADragBounds))) and (GetSpecialPointX <= ABounds.Right)
  else
    Result := (PtInRect(ABounds, ADragBounds.TopLeft) or PtInRect(ABounds,
      cxRectRightTop(ADragBounds))) and (GetSpecialPointY <= ABounds.Bottom);
end;
...
function TdxTileControlDragDropItem.IsPossibleIncreaseGroup
  (AGroup: TdxTileControlGroup; var AAccepted: Boolean): Boolean;
var
  ARowCountBefore, AColumnCountBefore: Integer;
begin
  DoItemDragOver(AAccepted);
  Result := (AGroup <> nil) and AAccepted and
    (TileControl.IsDesigning or AGroup.Enabled) and (AGroup.ItemCount > 0) and
    (FPlace.VirtualGroup.IsEqual(FPrevPlace.VirtualGroup) or
    (AGroup.ViewInfo = FPrevPlace.Group));
  if not Result then
    Exit;
  FTemporaryGroup.AssignFrom(AGroup, DragItem);
  StoreGroupItemsPositions(AGroup);
...
begin
  ...
  else if FPrevPlace.VirtualGroup <> nil then
  begin
    SwitchOff(FPrevPlace.VirtualGroup);
    ViewInfo.Calculate;
    FPrevPlace.VirtualGroup := nil;
...
procedure TdxTileControlDragDropItem.MoveDragItemToGroup
  (AGroup: TdxTileControlGroup; AIndexInGroup: Integer);
begin
  if AIndexInGroup < 0 then
    Exit;
  DragItem.Move(AGroup, AIndexInGroup);
  if (BeginGroup <> AGroup) and (BeginGroup.ItemCount = 0) and BeginGroup.Visible
  then
...
procedure TdxTileControlDragDropItem.RestoreGroupItemsPositions
  (AGroup: TdxTileControlGroup);
var
  I: Integer;
begin
  for I := 0 to FGroupItemsPositions.Count - 1 do
    AGroup.Items[I].ViewInfo.Position.Assign
      (TdxLayoutItemPosition(FGroupItemsPositions[I]));
end;

procedure TdxTileControlDragDropItem.RecalculateGroup
  (AGroup: TdxTileControlGroup);
begin
...
procedure TdxTileControlDragDropItem.RestoreSourcePositions;
  ...
  begin
    Result := (DragItem.Group = nil) or (DragItem.Group <> BeginGroup) or
      (DragItem.IndexInGroup <> BeginIndex) or (CheckedItems <> nil);
  end;
...
procedure TdxTileControlDragDropItem.SwitchOff(AVirtualGroup
  : TdxTileControlVirtualGroupViewInfo);
begin
...
procedure TdxTileControlDragDropItem.StoreGroupItemsPositions
  (AGroup: TdxTileControlGroup);
var
...
begin
  ...
  if BeginGroup.ItemCount = 1 then
    DoCollapseBeginGroupWhenItemIsLast
  else if CanDecreaseBeginGroup then
  begin
    DragItem.RemoveFromGroup;
...
procedure TdxTileControlCustomPopupControl.CreateParams
  (var Params: TCreateParams);
begin
  inherited CreateParams(Params);
  with Params do
...
procedure TdxTileControlCustomPopupControl.MouseDown(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
begin
  inherited MouseDown(Button, Shift, X, Y);
  HitTest.Calculate(X, Y);
...
procedure TdxTileControlCustomPopupControl.MouseMove(Shift: TShiftState;
X, Y: Integer);
begin
  inherited MouseMove(Shift, X, Y);
...
procedure TdxTileControlCustomPopupControl.MouseUp(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
begin
  inherited MouseUp(Button, Shift, X, Y);
  HitTest.Calculate(X, Y);
...
begin
  if (TileControl.ActiveDetail = nil) or
    (TileControl.ActiveDetail.ActiveControl <> Self.ActiveControl) then
  begin
...
function TdxTileControlDetailSite.GetTitleViewInfoClass
  : TdxTileControlDetailSiteTitleViewInfoClass;
begin
...
begin
  ...
  R := cxRectInflate(TileControl.ViewInfo.ClientBounds, -AIndentHorz,
    -TitleViewInfo.Bounds.Bottom - AIndentVert, -AIndentHorz, -AIndentVert);
  if ActiveControl <> nil then
  begin
...
procedure TdxTileControlDetailSite.MouseDown(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
begin
  inherited MouseDown(Button, Shift, X, Y);
...
procedure TdxTileControlDetailSite.MouseUp(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
begin
  inherited MouseUp(Button, Shift, X, Y);
  if Button = mbRight then
    ...
    TileControl.Controller.HideActionBars
      (dxMouseButtonToActionBarVisibilityChangeReason[Button]);
  ...
  begin
    ...
    else if HitTest.HitAtBackButton then
      TileControl.DoDeactivateDetail(Self)
    else if PressedCell is TdxTileControlDetailSiteTabsScrollButtonViewInfo then
...
procedure TdxTileControlDetailSite.SetPressedCell
  (AValue: TdxTileControlCustomCellViewInfo);
begin
...
function TdxTileControlDetailSite.AllowPan(AScrollKind: TScrollBarKind)
  : Boolean;
begin
...
function TdxTileControlDetailSite.GetCheckedDeltaX(const ADelta
  : Integer): Integer;
begin
  if ADelta > 0 then
    Result := Min(ADelta, TitleViewInfo.TabsBounds.Left - TitleViewInfo.Tabs[0]
      .Bounds.Left)
  else
    Result := Max(ADelta, TitleViewInfo.TabsBounds.Right - TitleViewInfo.Tabs
      [TitleViewInfo.Tabs.Count - 1].Bounds.Right);
end;
...
begin
  for P := 1 to Count - 1 do
    for I := 0 to Count - 1 - P do
      if Items[I].IndexInGroupBeforeDrag > Items[I + 1].IndexInGroupBeforeDrag
      then
        Exchange(I, I + 1);
end;
...
begin
  if not SizeMustFromDragItem then
    Exit;
  if GroupLayout = glHorizontal then
...
procedure TdxTileControlVirtualGroupViewInfo.CalculateSize(var AWidth,
  AHeight: Integer);
begin
...
procedure TdxTileControlVirtualGroupViewInfo.
  CalculateSizeAtHorizontalGroupLayout(var AWidth, AHeight: Integer);
  ...
  begin
    if not TileControl.IsItemDragged then
      ...
      Result := Max(TileControl.ViewInfo.ItemHalfIndent + ScaleFactor.Apply(1),
        AAdvanceWidth);
  end;
...
begin
  ...
  if SizeMustFromDragItem then
    AWidth := AWidth + AGroupIndent + ABorderWidth * 2 +
      cxRectWidth((TileControl.DragAndDropObject as TdxTileControlDragDropItem)
      .DragItem.ViewInfo.Bounds);
  FBasisWidth := AWidth;
  if TileControl.ViewInfo.IsFixedContentLeftSide and
    (Self = Group.VirtualGroupBefore) and Group.IsRealMostLeft then
    AWidth := Max(AWidth, TileControl.ViewInfo.VisibleGroupsOrigin.X -
      TileControl.ViewInfo.TilesArea.Left);
  if (not TileControl.OptionsView.CenterContentHorz or
    TileControl.ViewInfo.IsFixedContentLeftSide) and
    (Self = Group.VirtualGroupAfter) and Group.IsRealMostRight then
    AWidth := Max(AWidth, TileControl.ViewInfo.ClientBounds.Right -
      Group.Bounds.Right);
  AHeight := Max(TileControl.ViewInfo.ContentHeight,
    TileControl.ClientBounds.Bottom);
end;
...
begin
  AGroupIndent := TileControl.OptionsView.GroupIndent;
  ABorderWidth := GetBorderWidth;
  AWidth := Max(TileControl.ViewInfo.ContentWidth,
    TileControl.ClientBounds.Right);
  ...
  if SizeMustFromDragItem then
    AHeight := AHeight + AGroupIndent + ABorderWidth * 2 +
      cxRectHeight((TileControl.DragAndDropObject as TdxTileControlDragDropItem)
      .DragItem.ViewInfo.Bounds);
  if TileControl.ViewInfo.IsFixedContentTopSide and
    (Self = Group.VirtualGroupBefore) and Group.IsRealMostTop then
    AHeight := Max(AHeight, TileControl.ViewInfo.VisibleGroupsOrigin.Y -
      TileControl.ViewInfo.TilesArea.Top);
  if (not TileControl.OptionsView.CenterContentVert or
    TileControl.ViewInfo.IsFixedContentTopSide) and
    (Self = Group.VirtualGroupAfter) and Group.IsRealMostBottom then
    AHeight := Max(AHeight, TileControl.ViewInfo.ClientBounds.Bottom -
      Group.Bounds.Bottom);
end;
...
procedure TdxTileControlVirtualGroupViewInfo.ExpandBounds(const DW,
  DH: Integer);
begin
...
procedure TdxTileControlVirtualGroupViewInfo.
  GetDrawingBoundsParamsAtHorizontalGroupLayout(var ALeft, ATop, AWidth,
  AHeight: Integer);
var
...
begin
  ...
  else if Group.IsRealMostRight then
...
procedure TdxTileControlVirtualGroupViewInfo.
  GetDrawingBoundsParamsAtVerticalGroupLayout(var ALeft, ATop, AWidth,
  AHeight: Integer);
var
  ABounds, ATilesArea: TRect;
  AItemIndent, AGroupIndent: Integer;
begin
  ...
  else if Group.IsRealMostBottom then
    ATop := Bounds.Top + AItemIndent + AGroupIndent
  else
    ATop := cxRectCenter(Bounds).Y - AHeight div 2;
end;

function TdxTileControlVirtualGroupViewInfo.GetGroupLayout
...
begin
  ...
  if Group.Visible then
    ...
    begin
      Result := TileControl.ViewInfo.TilesArea.Left -
        TileControl.ViewInfo.LeftScrollPos;
      if TileControl.OptionsView.FixedIndentHorz then
...
begin
  ...
  if Group.Visible and (GroupLayout = glVertical) then
    if Self = Group.VirtualGroupBefore then
    begin
      Result := TileControl.ViewInfo.TilesArea.Top -
        TileControl.ViewInfo.TopScrollPos;
      if TileControl.OptionsView.FixedIndentVert then
...
begin
  if Visible then
    if not Group.UseRightToLeftAlignment then
      ...
      TileControl.InvalidateRect(TdxRightToLeftLayoutConverter.ConvertRect
        (Bounds, TileControl.ViewInfo.ClientBounds), False);
end;
...
procedure TdxTileControlVirtualGroupViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  FDrawingBounds := TdxRightToLeftLayoutConverter.ConvertRect(FDrawingBounds,
    AClientBounds);
  FClipRect := TdxRightToLeftLayoutConverter.ConvertRect(FClipRect,
    AClientBounds);
end;

procedure TdxTileControlVirtualGroupViewInfo.SetState
  (const AValue: TdxTileControlVirtualGroupState);
begin
  if FState <> AValue then
  begin
    FState := AValue;
...
begin
  Result := (Gradient <> gmHorizontal) or (GradientBeginColor <> clNone) or
    (GradientEndColor <> clNone) or (Stretch <> smStretch) or
    not Texture.Empty or (BorderColor <> clDefault) or FFontChanged;
end;
...
procedure TdxTileControlCustomStyle.SetGradientMode
  (AValue: TdxSkinGradientMode);
begin
...
function TdxTileControlCustomViewInfo.IsEqual
  (ACompare: TdxTileControlCustomViewInfo): Boolean;
begin
...
function TdxTileControlCustomCellViewInfo.GetHitTest
  (AHitTest: TdxTileControlHitTest): Boolean;
begin
...
procedure TdxTileControlCustomCellViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
...
var
  AAlpha: Byte;
begin
  if (Group = nil) or Group.IsDragged or not ACanvas.RectVisible
    (GetActualVisualBounds) then
    Exit;
  ...
  try
    ...
    if Item.IsDragged or not Controller.CanItemDrawing and
      (Controller.DragCell = Self) then
    begin
      ...
      if CanDrawItemCheckOnPullGesture(AAlpha) then
        Painter.DrawDefaultItemCheck(ACanvas, Bounds, clNone,
          Painter.GroupCaptionDefaultTextColor, AAlpha);
      Exit;
    end;
    ...
    if Item.CanFocused and Hottracked and (ItemHotTrackMode = tcihtmHighlight)
    then
...
procedure TdxTileControlItemViewInfo.DrawContent(ACanvas: TcxCustomCanvas;
const R: TRect);
var
  AMatrix: TXForm;
  APrevImageStretchQuality: TcxCanvasImageStretchQuality;
begin
  ...
  begin
    ...
    try
      ...
      try
        ACanvas.ImageStretchQuality := isqHigh;
        AMatrix := TXForm.CreateScaleMatrix
          (cxRectWidth(R) / cxRectWidth(Bounds),
          cxRectHeight(R) / cxRectHeight(Bounds));
...
begin
  DrawFrameRect(ACanvas, Painter.GetSelectionFocusedColor(Item),
    TileControl.OptionsBehavior.ItemFocusMode = tcifmOuterFrame);
end;

procedure TdxTileControlItemViewInfo.DrawFrameRect(ACanvas: TcxCustomCanvas;
AColor: TColor; AIsOuter: Boolean; AColorAlpha: Byte = 255);
var
  ABounds: TRect;
  AFrameSize: Integer;
begin
  ...
  try
    ...
    ACanvas.IntersectClipRect
      (TileControl.ViewInfo.CalculateFrameSelectionClipRect(ABounds,
      AFrameSize));
    if AIsOuter then
      AFrameSize := ScaleFactor.Apply(2);
    ACanvas.FrameRect(ABounds, dxColorToAlphaColor(AColor, AColorAlpha),
      AFrameSize);
  finally
    ACanvas.RestoreClipRegion;
  end;
...
procedure TdxTileControlItemViewInfo.DrawHighlightRect
  (ACanvas: TcxCustomCanvas);
begin
  DrawHighlightRect(ACanvas, GetHighlightBounds(Bounds),
    TileControl.OptionsBehavior.ItemHotTrackHighlightColor);
end;

procedure TdxTileControlItemViewInfo.DrawHighlightRect(ACanvas: TcxCustomCanvas;
const R: TRect; const AHighlightColor: TdxAlphaColor);
begin
  TileControl.Painter.DrawHighlightRect(ACanvas, R, AHighlightColor,
...
begin
  DrawFrameRect(ACanvas, Painter.GetSelectionHottrackedColor(Item),
    TileControl.OptionsBehavior.ItemHotTrackMode = tcihtmOuterFrame,
    HottrackValue);
end;
...
begin
  Var1 :=
    cxRectInflate(Bounds, InflateDelta);
  ACanvas.FillRect(Var1,
    Painter.SelectionSelectedColor, 127);
  ACanvas.Rectangle(Var1, clNone,
    clRed, psDashDot);
end;
...
begin
  ...
  if Focused and (TileControl.OptionsBehavior.ItemFocusMode = tcifmOuterFrame)
  then
...
begin
  ...
  Result := Item.Group.Bounds.Left + (Position.Column div 2) *
    (ARegularItemWidth + ItemIndent);
...
begin
  ...
  Result := Item.Group.Bounds.Top + Item.Group.Caption.Height +
    (Position.Row div 2) * (ARegularItemHeight + ItemIndent);
  if Odd(Position.Row) then
    Result := Result + ARegularItemHeight -
      TileControl.ViewInfo.ItemSmallHeight;
end;
...
begin
  ...
  Result := not(Focused and (((AHotTrackMode = tcihtmFrame) and
    (AFocusedMode = tcifmDefault)) or ((AHotTrackMode = tcihtmOuterFrame) and
    (AFocusedMode = tcifmOuterFrame))));
end;
...
begin
  Result := (CanFocusInDesigning or not TileControl.IsDesigning) and
    (InflateDelta = 0) and (Controller.FocusedItem = Item) and
    ((Controller.HottrackedItem = nil) or
    not TileControl.OptionsBehavior.HideFocusOnItemHotTrack);
end;

function TdxTileControlItemViewInfo.GetGalleryCellController
  : TdxTileControlGalleryCellController;
begin
...
begin
  Result := not TileControl.IsDesigning and
    (TileControl.OptionsBehavior.ItemHotTrackMode <> tcihtmNone) and
    (InflateDelta = 0) and
    ((HottrackValue <> 0) or (Controller.HottrackedItem = Item)) and
    CanHottracked;
end;

function TdxTileControlItemViewInfo.GetItemHotTrackMode
...
function TdxTileControlItemViewInfo.GetHighlightBounds(const ABounds
  : TRect): TRect;
begin
  Result := ABounds;
end;

function TdxTileControlItemViewInfo.GetHitTest
  (AHitTest: TdxTileControlHitTest): Boolean;
begin
  Result := inherited GetHitTest(AHitTest);
  if Result then
...
function TdxTileControlItemViewInfo.GetLastOccupiedColumn
  (AStartColumn: Integer): Integer;
begin
  case Item.Size of
    tcisSmall:
      Result := AStartColumn;
...
function TdxTileControlItemViewInfo.GetLastOccupiedRow
  (AStartRow: Integer): Integer;
begin
  Result := AStartRow;
  if Item.Size = tcisSmall then
...
function TdxTileControlItemViewInfo.GetViewData
  : TdxTileControlCustomItemViewData;
begin
...
procedure TdxTileControlItemViewInfo.SetViewData
  (AValue: TdxTileControlCustomItemViewData);
begin
...
function TdxTileControlCustomItem.CreateText(const AAlign
  : TdxTileItemInnerObjectAlignment): TdxTileControlItemText;
begin
  Result := TdxTileControlItemText.Create(Self);
  Result.FDefaultAlign := AAlign;
end;

function TdxTileControlCustomItem.CreateViewData
  : TdxTileControlCustomItemViewData;
begin
...
function TdxTileControlCustomItem.GetText(AIndex: Integer)
  : TdxTileControlItemText;
begin
...
procedure TdxTileControlCustomItem.SetOptionsAnimate
  (AValue: TdxTileControlItemOptionsAnimate);
begin
...
procedure TdxTileControlCustomItem.SetText(AIndex: Integer;
AValue: TdxTileControlItemText);
begin
...
begin
  Result := Value;
  if (Result = '') and TileControl.IsDesigning and (FDefaultAlign = oaTopLeft)
  then
...
procedure TdxTileControlItemText.SetAlign
  (AValue: TdxTileItemInnerObjectAlignment);
begin
  if FAlign <> AValue then
  begin
...
procedure TdxTileControlItemText.SetAssignedValues
  (AValue: TdxTileItemTextAssignedValues);
begin
...
procedure TdxThreadScaler.AddTask(AImageItem: TcxImageCollectionItem;
AOutputSize: TSize; ACallBackProc: TNotifyEvent);
begin
  FTasks.Add(TdxThreadScalerTaskItem.Create(AImageItem, AOutputSize,
    ACallBackProc));
  Unpause;
end;
...
begin
  L := FTasks.LockList;
  try
    if Assigned(FCurrentTask) and dxSameMethods(FCurrentTask.CallBackProc,
      ACallBackProc) then
      CancelCurrentTask;
    for I := L.Count - 1 downto 0 do
      if dxSameMethods((TObject(L[I]) as TdxThreadScalerTaskItem).CallBackProc,
        ACallBackProc) then
      begin
...
begin
  L := FTasks.LockList;
  try
    Result := Assigned(FCurrentTask) and
      dxSameMethods(FCurrentTask.CallBackProc, ACallBackProc);
    if not Result then
      for I := 0 to L.Count - 1 do
      begin
        Result := dxSameMethods((TObject(L[I]) as TdxThreadScalerTaskItem)
...
begin
  ...
  begin
    ...
    FMaximizedAreaBounds := cxRectOffset(Bounds, -AItemHalfIndent,
      -AItemHalfIndent + Group.Caption.Height);
    FMaximizedAreaBounds.Bottom := FMaximizedAreaBounds.Top +
      GetTilesMaximizedAreaHeight;
    FMaximizedAreaBounds.Right := FMaximizedAreaBounds.Left +
      GetTilesMaximizedAreaWidth;
  end;
end;
  ...
  begin
    ...
    begin
      FRowCount := Max(FRowCount,
        2 * (GetStartOfCurrentRegularRow(AItem.ViewInfo.GetLastOccupiedRow
        (AItem.ViewInfo.Position.Row)) div 2 + 1));
      FColumnCount := Max(FColumnCount,
        AItem.ViewInfo.GetLastOccupiedColumn
        (AItem.ViewInfo.Position.Column) + 1);
    end
    else
    begin
      FRowCount := Max(FRowCount, AItem.ViewInfo.GetLastOccupiedRow
        (AItem.ViewInfo.Position.Row) + 1);
      FColumnCount := Max(FColumnCount,
        2 * (GetStartOfCurrentRegularColumn(AItem.ViewInfo.GetLastOccupiedColumn
        (AItem.ViewInfo.Position.Column)) div 2 + 1));
    end;
...
procedure TdxTileControlGroupViewInfo.CalculateItemPosition(AItem,
  APrevItem: TdxTileControlItem);

  procedure MoveToNextRegularPosition(var ANewRow, ANewColumn: Integer;
  const AIsLarge: Boolean);
  var
    ASmallColumnCountInLogicalRow: Integer;
  begin
    ASmallColumnCountInLogicalRow := SmallColumnCountInLogicalRow;
    if ANewColumn mod ASmallColumnCountInLogicalRow <
      ASmallColumnCountInLogicalRow - 2 * (1 + Integer(AIsLarge)) then
    begin
    ...
    begin
      ANewColumn := GetStartOfCurrentLogicalColumn(ANewColumn,
        ASmallColumnCountInLogicalRow);
...
begin
  ...
  begin
    ...
    repeat
      ...
      if (ARow > 0) and (AItem.ViewInfo.GetLastOccupiedRow(ARow) >= 2 *
        TileViewInfo.RowCount) then
      begin
        ARow := 0;
        ASmallColumnCountInLogicalRow := SmallColumnCountInLogicalRow;
        AColumn := GetStartOfCurrentLogicalColumn(AColumn,
          ASmallColumnCountInLogicalRow) + ASmallColumnCountInLogicalRow;
      end;
    until not IsOccupiedByPriorItems(AItem, ARow, AColumn);
  end;
...
procedure TdxTileControlGroupViewInfo.CalculateSize(var AWidth,
  AHeight: Integer);
var
...
begin
  ...
  else if Group.IsDragged then
  begin
    if (Group.Collection <> nil) and ((TileViewInfo.DragDropChanges = nil) or
      not TileViewInfo.DragDropChanges.DragObjectFinished) then
      Painter.DrawItemPlace(ACanvas, Bounds);
  end;
end;

procedure TdxTileControlGroupViewInfo.ExpandBoundsToBottomControl
  (var ABounds: TRect);
begin
  ABounds.Bottom := Max(ABounds.Bottom, TileViewInfo.ClientBounds.Bottom);
end;

procedure TdxTileControlGroupViewInfo.ExpandBoundsToLeftControl
  (var ABounds: TRect);
begin
  ABounds.Left := Min(ABounds.Left, TileViewInfo.ClientBounds.Left);
end;

procedure TdxTileControlGroupViewInfo.ExpandBoundsToRightControl
  (var ABounds: TRect);
begin
  ABounds.Right := Max(ABounds.Right, TileViewInfo.ClientBounds.Right);
end;

procedure TdxTileControlGroupViewInfo.ExpandBoundsToTopControl
  (var ABounds: TRect);
begin
...
begin
  ...
  if TileControl.IsDesigning and not Group.IsDragged and
    cxRectIsNull(FNewGroupDrawingBounds) then
  begin
    ACanvas.SaveClipRegion;
    try
      ACanvas.IntersectClipRect(TileViewInfo.CalculateFrameSelectionClipRect
        (Bounds, GetBorderWidth));
...
function TdxTileControlGroupViewInfo.GetHitTest
  (AHitTest: TdxTileControlHitTest): Boolean;
begin
  Result := inherited GetHitTest(AHitTest);
  if Result then
...
begin
  ...
  begin
    ...
    begin
      Result := TileViewInfo.TilesArea.Left - TileViewInfo.LeftScrollPos -
        GetBorderWidth;
...
function TdxTileControlGroupViewInfo.GetOccupiedItem
  (APosition: TdxLayoutItemPosition): TdxTileControlItem;
var
  I: Integer;
begin
  Result := nil;
...
begin
  Result := ASmallColumn div ASmallColumnCountInLogicalRow *
    ASmallColumnCountInLogicalRow;
end;

class function TdxTileControlGroupViewInfo.GetStartOfCurrentRegularColumn
  (const ASmallColumn: Integer): Integer;
begin
  Result := ASmallColumn div 2 * 2;
end;

class function TdxTileControlGroupViewInfo.GetStartOfCurrentRegularRow
  (const ASmallRow: Integer): Integer;
begin
...
begin
  Result := Bounds.Top;
  if not Group.Visible or (Group.Groups = nil) then
    Exit;
  if GroupLayout = glHorizontal then
  begin
    Result := TileViewInfo.TilesArea.Top - TileViewInfo.TopScrollPos -
      GetBorderWidth;
...
function TdxTileControlGroupViewInfo.GetZIndex(AColumn, ARow,
  ADragItemRow: Integer): Integer;
var
  ASmallColumnCountInLogicalRow, AStartLogicalColumn: Integer;
begin
  ASmallColumnCountInLogicalRow := SmallColumnCountInLogicalRow;
  AStartLogicalColumn := GetStartOfCurrentLogicalColumn(AColumn,
    ASmallColumnCountInLogicalRow);
  Result := AStartLogicalColumn * Max(RowCount, (ADragItemRow div 2 + 1) * 2) +
    ARow div 2 * (2 * ASmallColumnCountInLogicalRow) +
    (AColumn - AStartLogicalColumn) div 2 * 4 + ARow mod 2 * 2 + AColumn mod 2;
end;

function TdxTileControlGroupViewInfo.GetZIndex(APosition, ADragItemPosition
  : TdxLayoutItemPosition): Integer;
begin
...
function TdxTileControlGroupViewInfo.IsItemOccupyPosition
  (AItem: TdxTileControlItem; APosition: TdxLayoutItemPosition): Boolean;
var
...
begin
  ...
  Result := (APosition.Row >= AItemPosition.Row) and
    (APosition.Row <= AItemLastRow) and
    (APosition.Column >= AItemPosition.Column) and
    (APosition.Column <= AItemLastColumn);
end;

function TdxTileControlGroupViewInfo.IsAreasIntersect(const AArea1,
  AArea2: TRect): Boolean;
var
  AArea: TRect;
begin
...
function TdxTileControlGroupViewInfo.IsOccupiedByPriorItems
  (ACurrentItem: TdxTileControlItem;
ACurrentRow, ACurrentColumn: Integer): Boolean;
var
...
begin
  Result := False;
  ACurrentLastColumn := ACurrentItem.ViewInfo.GetLastOccupiedColumn
    (ACurrentColumn);
  ...
  begin
    ...
    if AItem.Visible then
      Result := IsAreasIntersect(Rect(ACurrentColumn, ACurrentRow,
        ACurrentLastColumn, ACurrentLastRow),
        Rect(APosition.Column, APosition.Row,
        AItem.ViewInfo.GetLastOccupiedColumn(APosition.Column),
        AItem.ViewInfo.GetLastOccupiedRow(APosition.Row)));
    if Result then
      Break;
  end;
end;
...
begin
  Result := TileControl.ViewInfo;
  if (TileControl.ActiveDetail <> nil) and
    (TileControl.ActiveDetail is TdxTileControlDetailSite) then
...
begin
  if (HitObject is TdxTileControlGroupViewInfo) or
    (HitObject is TdxTileControlGroupCaptionViewInfo) then
...
function TdxTileControlHitTest.GetScrollButton
  : TdxTileControlScrollButtonViewInfo;
begin
...
constructor TdxTileControlItemNavigator.Create(AController
  : TdxTileControlController);
begin
  FController := AController;
...
function TdxTileControlItemNavigator.CheckGroupOnExistenceOfItemsStartingFromRow
  (AGroup: TdxTileControlGroup; const ARow: Integer): Boolean;
var
  I: Integer;
begin
...
begin
  Result := CurrentItem.ViewInfo.GetLastOccupiedColumn
    (CurrentItem.ViewInfo.Position.Column);
end;

function TdxTileControlItemNavigator.GetCurrentItemLastRow: Integer;
begin
  Result := CurrentItem.ViewInfo.GetLastOccupiedRow
    (CurrentItem.ViewInfo.Position.Row);
end;
...
begin
  ...
  if GroupLayout = glVertical then
  begin
    AItem := GetItemByForwardSearchOnColumns(ACurrentGroup, 0,
      CurrentColumn - 1);
    if AItem <> nil then
      Result := AItem;
  end
...
function TdxTileControlItemNavigator.GetItemByBackSearchOnColumns
  (AGroup: TdxTileControlGroup; const AStartColumn, AEndColumn: Integer)
  : TdxTileControlItem;
var
  AItem: TdxTileControlItem;
  AColumn: Integer;
...
function TdxTileControlItemNavigator.GetItemByBackSearchOnRows
  (AGroup: TdxTileControlGroup; const AStartRow, AEndRow: Integer)
  : TdxTileControlItem;
var
  AItem: TdxTileControlItem;
  ARow: Integer;
...
begin
  ...
  if GroupLayout = glVertical then
  begin
    AItem := GetItemByBackSearchOnColumns(ACurrentGroup, CurrentItemLastColumn +
      1, ACurrentGroup.ViewInfo.ColumnCount - 1);
    if AItem <> nil then
      Result := AItem;
  end
  else
    ...
    begin
      ...
      begin
        if I = ACurrentGroup.Index then
          ...
          AEndColumn := 0;
        AItem := GetItemByBackSearchOnColumns(AGroup, AGroup.RealColumnCount -
          1, AEndColumn);
        if AItem <> nil then
        begin
          Result := AItem;
...
function TdxTileControlItemNavigator.
  GetNextItemInColumnAboveTheCurrentWhenHorizontalLayout
  (const ACurrentGroupIndex: Integer): TdxTileControlItem;
var
  AItem: TdxTileControlItem;
begin
  Result := nil;
  AItem := GetItemByForwardSearchOnRows(Groups[ACurrentGroupIndex], 0,
    CurrentRow - 1);
  if AItem <> nil then
    Result := AItem;
end;
...
function TdxTileControlItemNavigator.
  GetNextItemInColumnAboveTheCurrentWhenVerticalLayout(const ACurrentGroupIndex
  : Integer): TdxTileControlItem;
var
  I, AEndRow: Integer;
  AGroup: TdxTileControlGroup;
...
begin
  ...
  begin
    AGroup := Groups[I];
    if not AGroup.IsAvailableForNavigation then
      Continue;
...
begin
  ...
  begin
    if (GroupLayout = glHorizontal) and (I <> ACurrentGroupIndex) then
      Break;
    AGroup := Groups[I];
    if not AGroup.IsAvailableForNavigation then
      Continue;
    if I = ACurrentGroupIndex then
      ...
      AStartRow := 0;
    AItem := GetItemByForwardSearchOnRows(AGroup, AStartRow,
      AGroup.RealRowCount - 1);
    if AItem <> nil then
    begin
      Result := AItem;
      Break;
...
begin
  ...
  begin
    if GroupLayout = glHorizontal then
      AItem := GetNextItemInColumnAboveTheCurrentWhenHorizontalLayout
        (ACurrentGroupIndex)
    else
      AItem := GetNextItemInColumnAboveTheCurrentWhenVerticalLayout
        (ACurrentGroupIndex);
    if AItem <> nil then
      Result := AItem;
  end;
...
begin
  ...
  begin
    ...
    begin
      if (ARow < AStartRow) and (I = ACurrentGroupIndex) then
        Continue;
      AItem := GetItemByForwardSearchOnColumns(AGroup, 0,
        AGroup.RealColumnCount - 1);
      if AItem <> nil then
      begin
        Result := AItem;
        Break;
...
begin
  Result := CurrentItem;
  ACurrentGroupIndex := CurrentItem.Group.Index;
  AItem := GetNextItemInRowToRightHand(CurrentItemLastColumn + 1,
    ACurrentGroupIndex);
  if AItem <> nil then
    Result := AItem;
  if (Result = CurrentItem) and FFocusItemOnCycle then
  begin
    ...
    begin
      ...
      if GroupLayout = glHorizontal then
        ...
        AItem := GetNextItemInNextRowWhenVerticalLayout(CurrentRow,
          ACurrentGroupIndex);
      if AItem <> nil then
        Result := AItem;
    end;
...
function TdxTileControlItemNavigator.GetNextItemInRowToRightHand(AStartColumn,
  ACurrentGroupIndex: Integer): TdxTileControlItem;
var
  I: Integer;
  AEndColumn: Integer;
...
begin
  ...
  for I := ACurrentGroupIndex to Groups.Count - 1 do
  begin
    if (GroupLayout = glVertical) and (I <> ACurrentGroupIndex) then
      Break;
    AGroup := Groups[I];
    if not AGroup.IsAvailableForNavigation then
      Continue;
...
begin
  ...
  begin
    if GroupLayout = glHorizontal then
      AItem := GetPrevItemInColumnBelowTheCurrentWhenHorizontalLayout
        (CurrentItem.Group.RealRowCount - 1, ACurrentGroupIndex)
    else
      AItem := GetPrevItemInColumnBelowTheCurrentWhenVerticalLayout
        (ACurrentGroupIndex);
    if AItem <> nil then
      Result := AItem;
  end;
...
function TdxTileControlItemNavigator.
  GetPrevItemInColumnBelowTheCurrentWhenHorizontalLayout(const AStartRow,
  ACurrentGroupIndex: Integer): TdxTileControlItem;
var
  AItem: TdxTileControlItem;
  AGroup: TdxTileControlGroup;
...
function TdxTileControlItemNavigator.
  GetPrevItemInColumnBelowTheCurrentWhenVerticalLayout(const ACurrentGroupIndex
  : Integer): TdxTileControlItem;
var
  I, AEndRow: Integer;
  AGroup: TdxTileControlGroup;
...
begin
  ...
  begin
    ...
    if I = ACurrentGroupIndex then
      ...
      AEndRow := 0;
    AItem := GetItemByBackSearchOnRows(AGroup, AGroup.RealRowCount - 1,
      AEndRow);
    if AItem <> nil then
    begin
      Result := AItem;
...
begin
  ...
  begin
    ...
    begin
      if (ARow > AStartRow) and (I = ACurrentGroupIndex) then
        Continue;
      AItem := GetItemByBackSearchOnColumns(AGroup,
        AGroup.RealColumnCount - 1, 0);
      if AItem <> nil then
      begin
        Result := AItem;
        Break;
...
begin
  Result := CurrentItem;
  ACurrentGroupIndex := CurrentItem.Group.Index;
  AItem := GetPrevItemInRowToLeftHand(CurrentItem.ViewInfo.Position.Column - 1,
    ACurrentGroupIndex);
  if AItem <> nil then
    Result := AItem;
  if (Result = CurrentItem) and FFocusItemOnCycle then
  begin
    ...
    begin
      ...
      if GroupLayout = glHorizontal then
        ...
        AItem := GetPrevItemInPrevRowWhenVerticalLayout(CurrentRow,
          ACurrentGroupIndex);
      if AItem <> nil then
        Result := AItem;
    end;
...
function TdxTileControlItemNavigator.GetPrevItemInRowToLeftHand(AStartColumn,
  ACurrentGroupIndex: Integer): TdxTileControlItem;
var
  I: Integer;
  AGroup: TdxTileControlGroup;
...
function TdxTileControlItemNavigator.GetNextRow(const AIncrement: Integer;
var AGroupIndex: Integer): Integer;
begin
  if GroupLayout = glHorizontal then
...
function TdxTileControlItemNavigator.GetNextRowWhenHorizontalLayout
  (const AIncrement: Integer): Integer;
var
  ASkipRow: Boolean;
  I: Integer;
begin
  ...
  begin
    ...
    begin
      if Groups[I].IsAvailableForNavigation then
        ASkipRow := not CheckGroupOnExistenceOfItemsStartingFromRow
          (Groups[I], Result);
...
begin
  if FIsInitializingCurrentPositionDisabled then
    Exit;
...
procedure TdxTileControlItemNavigator.KeyDown(var Key: Word;
Shift: TShiftState);
begin
...
var
  ...
  AGroup: TdxTileControlGroup;
begin
  if Controller.TileControl.IsDesigning then
    Exit;
  if CurrentItem = nil then
    for I := 0 to Groups.Count - 1 do
    begin
...
procedure TdxTileControlItemNavigator.SetCurrentItem
  (AValue: TdxTileControlItem);
begin
...
function TdxTileControlOptionsBehavior.GetDefaultItemCheckMode
  : TdxTileControlItemCheckMode;
begin
  Result := tcicmMultiple;
end;

function TdxTileControlOptionsBehavior.GetDefaultItemFocusMode
  : TdxTileControlItemFocusMode;
begin
  Result := tcifmDefault;
end;

function TdxTileControlOptionsBehavior.GetDefaultItemHotTrackHighlightColor
  : TdxAlphaColor;
begin
  Result := dxTileControlItemHotTrackHighlightDefaultColor;
end;

function TdxTileControlOptionsBehavior.GetDefaultItemHotTrackMode
  : TdxTileControlItemHotTrackMode;
begin
  Result := tcihtmFrame;
end;
...
function TdxTileControlOptionsBehavior.GetDefaultScrollMode
...
function TdxTileControlOptionsBehavior.
  IsItemHotTrackHighlightColorStored: Boolean;
begin
...
const
  AMode: array [Boolean] of TdxTileControlItemHotTrackMode = (tcihtmNone,
    tcihtmFrame);
begin
...
procedure TdxTileControlOptionsBehavior.SetItemCheckMode
  (AValue: TdxTileControlItemCheckMode);
begin
...
procedure TdxTileControlOptionsBehavior.SetItemFocusMode
  (AValue: TdxTileControlItemFocusMode);
begin
...
procedure TdxTileControlOptionsBehavior.SetItemHotTrackHighlightColor
...
procedure TdxTileControlOptionsBehavior.SetItemHotTrackMode
  (AValue: TdxTileControlItemHotTrackMode);
begin
...
procedure TdxTileControlOptionsBehavior.SetScrollMode
  (AValue: TdxTileControlScrollMode);
begin
...
function TdxTileControlItemOptionsAnimate.GetParentOptionsAnimate
  : TdxTileControlCustomItemOptionsAnimate;
begin
  if Owner is TdxTileControlItem then
...
function TdxTileControlItemFrameOptionsAnimate.GetParentOptionsAnimate
  : TdxTileControlCustomItemOptionsAnimate;
begin
...
begin
  ...
  FFont.Name := DefaultFontName;
  FFont.Height := dxGetFontHeightForDefaultDPI
    (dxTileControlDefaultTitleFontSize);
  FFont.OnChange := FontChanged;
...
begin
  Result := IsFontStored or (TextAlignHorz <> taLeftJustify) or
    (TextAlignVert <> vaBottom) or (Color <> clDefault) or
    (IndentHorz <> dxTileItemObjectDefaultIndent) or
    (IndentVert <> dxTileItemObjectDefaultIndent) or (Text <> '') or WordWrap or
    not Glyph.Empty or (GlyphAlignHorz <> taRightJustify) or
    (GlyphAlignVert <> vaBottom) or
    (TabsFontSize <> dxTileControlDefaultTabFontSize) or
    (TabsActiveTextColor <> clDefault) or (TabsDisabledTextColor <> clDefault)
    or (TabsHotTextColor <> clDefault) or (TabsTextColor <> clDefault);
end;
...
begin
  Result := TdxTileControlActionBarItems.Create(TileControl,
    TdxTileControlActionBarItem);
end;
...
procedure TdxTileControlActionBars.ImagesFreeNotification
  (AComponent: TComponent);
begin
  Images := nil;
end;
...
procedure TdxTileControlActionBars.SetItems
  (AValue: TdxTileControlActionBarItems);
begin
...
function TdxTileControlViewInfo.GetHitTest
  (AHitTest: TdxTileControlHitTest): Boolean;
begin
  Result := TitleViewInfo.GetHitTest(AHitTest) or
    Cells.CalculateHitTest(AHitTest);
end;
...
var
  I: TcxArrowDirection;
begin
  if TileControl.OptionsBehavior.ScrollMode <> smScrollButtons then
    Exit;
...
procedure TdxTileControlViewInfo.AddVirtualGroupAfter
  (AGroup: TdxTileControlGroup);
begin
  if AGroup.Visible then
  begin
...
procedure TdxTileControlViewInfo.AddVirtualGroupBefore
  (AGroup: TdxTileControlGroup);
begin
  if AGroup.Visible and
    (((GroupLayout = glHorizontal) and AGroup.IsRealMostLeft) or
    ((GroupLayout = glVertical) and AGroup.IsRealMostTop)) then
  begin
...
begin
  ...
  FItemSmallHeight := (TileControl.OptionsView.ItemHeight -
    TileControl.OptionsView.ItemIndent) div 2;
  FItemSmallWidth := (TileControl.OptionsView.ItemWidth -
    TileControl.OptionsView.ItemIndent) div 2;
  FItemLargeWidth := 2 * TileControl.OptionsView.ItemWidth +
    TileControl.OptionsView.ItemIndent;
end;
...
begin
  ...
  begin
    ...
    Inc(FRowCount, Ord(AUsefulHeight > (FRowCount + 1) * ARegularItemHeight -
      AItemIndent));
...
begin
  ...
  if UseRightToLeftAlignment then
  begin
    FTilesZone := TdxRightToLeftLayoutConverter.ConvertRect(FTilesZone,
      ClientBounds);
    FTilesArea := TdxRightToLeftLayoutConverter.ConvertRect(FTilesArea,
      ClientBounds);
...
begin
  for I := Low(TcxArrowDirection) to High(TcxArrowDirection) do
    FScrollButtonViewInfo[I] := GetScrollButtonViewInfoClass.Create
      (TileControl, I);
end;

function TdxTileControlViewInfo.GetScrollButtonViewInfoClass
  : TdxTileControlScrollButtonViewInfoClass;
begin
...
function TdxTileControlViewInfo.CalculateFrameSelectionClipRect(const R: TRect;
AFrameSize: Integer): TRect;
begin
  Result := R;
  if R.Left + AFrameSize < TilesArea.Left then
    Result.Left := TilesArea.Left;
  if (R.Right - AFrameSize - 1 >= TilesArea.Right) or
    TileControl.IsScrollBarActive(sbVertical) and
    (R.Right >= TileControl.GetVScrollBarBounds.Left - 1) then
    Result.Right := TilesArea.Right;
  if R.Top + AFrameSize < TilesArea.Top then
    Result.Top := TilesArea.Top;
  if (R.Bottom - AFrameSize - 1 >= TilesArea.Bottom) or
    TileControl.IsScrollBarActive(sbHorizontal) and
    (R.Bottom >= TileControl.GetHScrollBarBounds.Top - 1) then
...
begin
  ...
  if (TileControl.ActiveDetail <> nil) and not TileControl.ForceCalculate then
    Exit;
  CalculateRowCount;
  AddGroups;
...
begin
  ...
  if IsContentNotCenteredHorz or (VirtualGroups.Count = 0) or
    (FContentRight > AAreaRight) then
    Exit;
...
begin
  ...
  AVirtualGroup := TdxTileControlVirtualGroupViewInfo
    (VirtualGroups[VirtualGroups.Count - 1]);
...
begin
  ...
  if IsContentNotCenteredVert or (VirtualGroups.Count = 0) or
    (FContentBottom > AControlBottom) then
    Exit;
...
procedure TdxTileControlViewInfo.DoCenterContentVertAtHorizontalGroupLayout
  ...
  function IsCellIsVirtualGroupViewInfo
    (ACell: TdxTileControlCustomCellViewInfo): Boolean;
  begin
...
begin
  ...
  begin
    ...
    ARealContentRight := Max(Result.Right, AGroup.ViewInfo.ItemsRight +
      TileControl.OptionsView.IndentHorz);
    Result.Left := Min(Result.Left, ABounds.Left);
    Result.Bottom := Max(Result.Bottom, AGroup.ViewInfo.ItemsBottom +
      TileControl.OptionsView.IndentVert);
    if GroupLayout = glHorizontal then
    begin
      Result.Top := Min(Result.Top, AGroup.Caption.Bounds.Top -
        TileControl.OptionsView.IndentVert);
      if TileControl.IsItemDragged and (AVirtualGroup = AGroup.VirtualGroupAfter)
      then
        ARealContentRight := Max(ARealContentRight, AGroup.Bounds.Right +
          AVirtualGroup.BasisWidth);
    end
    else
    begin
  ...
  if TileControl.OptionsView.FixedIndentHorz and (AWidth > 0) and
    (AWidth > TileControl.OptionsView.IndentHorz) then
    Result := cxRectInflate(Result, -TileControl.OptionsView.IndentHorz, 0);
  AHeight := Result.Bottom - Result.Top;
  if TileControl.OptionsView.FixedIndentVert and (AHeight > 0) and
    (AHeight > TileControl.OptionsView.IndentVert) then
    Result := cxRectInflate(Result, 0, -TileControl.OptionsView.IndentVert);
...
procedure TdxTileControlViewInfo.MakeVisible(const ABounds: TRect;
AIsMostLeft, AIsMostTop, AIsMostRight, AIsMostBottom: Boolean);
var
...
begin
  ...
  if AIsMostLeft then
    ALeftPos := 0
  else if AIsMostRight then
    ALeftPos := FContentWidth - HorzScrollPage
  else if not TileControl.UseRightToLeftAlignment then
  begin
    if ABounds.Left < TilesArea.Left then
      Dec(ALeftPos, TilesArea.Left - ABounds.Left + AGap)
    else if ABounds.Right > TilesArea.Right then
  ...
  if AIsMostTop then
    ATopPos := 0
  else if AIsMostBottom then
    ATopPos := FContentHeight - VertScrollPage
  else if ABounds.Top < TilesArea.Top then
    Dec(ATopPos, TilesArea.Top - ABounds.Top + AGap)
  else if ABounds.Bottom > TilesArea.Bottom then
...
begin
  Painter.DrawDesignTimeBorder(ACanvas, Bounds,
    TileControl.Controller.IsObjectSelected(TileControl));
end;
...
function TdxTileControlViewInfo.IsScrollAvailable
  (ADirection: TcxArrowDirection): Boolean;
begin
  case ADirection of
    adUp:
...
begin
  Result := (DetailControl <> nil) or Assigned(TileItem.OnActivateDetail)
    or ShowTab;
end;
...
function TdxTileControlItemDetailOptions.GetDetailSite
  : TdxTileControlDetailSite;
begin
  ...
  begin
    FDetailSite.SetBounds(dxTileControlInvisiblePosition, 0, GetDetailSiteWidth,
      GetDetailSiteHeight);
...
procedure TdxTileControlItemDetailOptions.StoreDetailControlPrevParent
  (AParent: TWinControl);
begin
...
dxResourceStringsRepository.RegisterProduct('ExpressTileControl',
  @AddTileControlResourceStringNames);
