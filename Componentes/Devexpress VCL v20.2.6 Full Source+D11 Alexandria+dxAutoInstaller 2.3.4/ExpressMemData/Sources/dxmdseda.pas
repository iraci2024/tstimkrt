...
uses
  DesignIntf, Windows, Classes, Controls, Forms, StdCtrls, DB, dxmdaset,
  ExtCtrls, Graphics;
...
function GetMemDataNewFieldType(Data: TdxMemData; X, Y: Integer;
  FormDesigner: IFormDesigner): TField;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        FormDesigner.GetComponentNames(GetTypeData(TDataSet.ClassInfo),
          GetDataSets);
...
begin
  edSize.Enabled := (cbFieldType.Text = 'ftString') or
    (cbFieldType.Text = 'ftWideString');
...
procedure TfrmdxMemDataAddField.edSizeKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TfrmdxMemDataAddField.CreateControls;
  ...
  procedure CreateLabel(AParent: TWinControl; ALeft, ATop: Integer;
    ACaption: String);
  var
    ALabel: TLabel;
  begin
