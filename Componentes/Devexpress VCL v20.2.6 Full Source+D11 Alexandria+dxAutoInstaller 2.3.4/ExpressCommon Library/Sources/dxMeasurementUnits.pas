...
type
  ...
  public
    ...
    class function FromLoMetric(const Value: Integer): Single;
      overload; virtual;
...
function dxGetActualMeasurementUnits(AValue: TdxMeasurementUnits)
  : TdxMeasurementUnits;
...
function DocumentsToPixels(const AValue: Integer; const ADpi: Single): Integer;
  overload; inline;
function DocumentsToPixels(const AValue: TdxRectF; const ADpiX, ADpiY: Single)
  : TdxRectF; overload; inline;
function DocumentsToPixels(const AValue: TPoint; const ADpiX, ADpiY: Single)
  : TPoint; overload; inline;
function DocumentsToPixels(const AValue: TRect; const ADpiX, ADpiY: Single)
  : TRect; overload; inline;
function DocumentsToPixels(const AValue: TSize; const ADpiX, ADpiY: Single)
  : TSize; overload; inline;
function DocumentsToPixelsF(const AValue: Single; const ADpi: Single)
  : Single; inline;
...
function TwipsToPixels(const AValue: Integer; const ADpi: Single): Integer;
  overload; inline;
function TwipsToPixels(const AValue: TPoint; const ADpiX, ADpiY: Single)
  : TPoint; overload; inline;
...
function TwipsToPixels(const AValue: TSize; const ADpiX, ADpiY: Single): TSize;
  overload; inline;
function TwipsToPixelsF(const AValue: Single; const ADpi: Single)
  : Single; inline;
...
function PixelsToDocuments(const APoint: TPoint; ADpiX, ADpiY: Single): TPoint;
  overload; inline;
function PixelsToDocuments(const ARect: TdxRectF; ADpiX, ADpiY: Single)
  : TdxRectF; overload; inline;
...
function PixelsToDocuments(const AValue: Integer; const ADpi: Single): Integer;
  overload; inline;
function PixelsToDocumentsF(const AValue: Single; const ADpi: Single)
  : Single; inline;
function PixelsToDocumentsRound(const ASize: TSize; ADpiX, ADpiY: Single)
  : TSize; overload; inline;
function PixelsToDocumentsRound(const AValue: Integer; ADpi: Single): Integer;
  overload; inline;
function PixelsToHundredthsOfInch(const AValue: Integer; const ADpi: Single)
  : Integer; overload; inline;
function PixelsToHundredthsOfInch(const AValue: TSize; const ADpi: Single)
  : TSize; overload; inline;
function PixelsToHundredthsOfMillimeter(const AValue: Integer;
  const ADpi: Single): Integer; overload; inline;
function PixelsToHundredthsOfMillimeter(const AValue: TSize;
  const ADpiX, ADpiY: Single): TSize; overload; inline;
function PixelsToLoMetric(Value: Integer; DPI: Integer = dxDefaultDPI): Integer;
function PixelsToPoints(const AValue: Integer; const ADpi: Single)
  : Integer; inline;
function PixelsToPointsF(const AValue: Single; const ADpi: Single)
  : Single; inline;
...
function PixelsToTwips(const AValue: Integer; const ADpi: Single): Integer;
  overload; inline;
function PixelsToTwipsF(const AValue: Single; const ADpi: Single)
  : Single; inline;
function PixelsToTwipsL(const AValue: Int64; const ADpi: Single): Int64; inline;
function PixelsToTwipsRound(const ASize: TSize; ADpiX, ADpiY: Single)
  : TSize; inline;
...
function HundredthsOfMillimeterToDocuments(const AValue: TSize): TSize;
  overload; inline;
function HundredthsOfMillimeterToDocumentsRound(const AValue: TSize): TSize;
  overload; inline;
function HundredthsOfMillimeterToPixels(const AValue: Integer;
  const ADpi: Single): Integer; overload; inline;
function HundredthsOfMillimeterToPixels(const AValue: TSize;
  const ADpiX, ADpiY: Single): TSize; overload; inline;
...
function HundredthsOfMillimeterToTwips(const AValue: TSize): TSize;
  overload; inline;
function HundredthsOfMillimeterToTwipsRound(const AValue: TSize): TSize;
  overload; inline;
...
function PointsToPixels(const AValue: Integer; const ADpi: Single)
  : Integer; inline;
function PointsToPixelsF(const AValue: Single; const ADpi: Single)
  : Single; inline;
...
function LoMetricToPixels(Value: Integer; DPI: Integer = dxDefaultDPI)
  : Integer; overload;
function LoMetricToPixels(const Pt: TPoint; DPI: Integer = dxDefaultDPI)
  : TPoint; overload;
...
function dxGetDefaultMeasurementUnits: TdxMeasurementUnits;
const
  MeasurementUnitsMap: array [Boolean] of TdxMeasurementUnits = (muInches,
    muMillimeters);
begin
  Result := MeasurementUnitsMap[GetLocaleChar(LOCALE_USER_DEFAULT,
    LOCALE_IMEASURE, '0') = '0'];
end;
...
function PixelsToPointsCore(const AValue: Integer; const ADpi: Single): Integer;
  overload; inline;
begin
  Result := MulDiv(AValue, 72, ADpi);
end;

function PixelsToPointsCore(const AValue: Single; const ADpi: Single): Single;
  overload; inline;
begin
  Result := MulDivF(AValue, 72, ADpi);
end;

function PixelsToDocumentsCore(const AValue: Integer; const ADpi: Single)
  : Integer; overload; inline;
begin
  Result := MulDiv(AValue, 300, ADpi);
end;

function PixelsToDocumentsCoreRound(const AValue: Integer; const ADpi: Single)
  : Integer; inline;
begin
  Result := Round(MulDivF(AValue, 300, ADpi));
end;

function PixelsToTwipsCore(const AValue: Integer; const ADpi: Single): Integer;
  overload; inline;
begin
  Result := MulDiv(AValue, 1440, ADpi);
end;

function PixelsToTwipsCoreRound(const AValue: Integer; const ADpi: Single)
  : Integer; inline;
begin
  Result := Round(MulDivF(AValue, 1440, ADpi));
end;

function PixelsToTwipsCore(const AValue: Int64; const ADpi: Single): Int64;
  overload; inline;
begin
  Result := MulDivL(AValue, 1440, ADpi);
end;

function PixelsToTwipsCore(const AValue: Single; const ADpi: Single): Single;
  overload; inline;
begin
  Result := MulDivF(AValue, 1440, ADpi);
end;

function PixelsToDocumentsCore(const AValue: Double; const ADpi: Single)
  : Integer; overload; inline;
begin
  Result := Round(300 * AValue / ADpi);
end;

function PixelsToDocumentsCoreF(const AValue: Single; const ADpi: Single)
  : Single; inline;
begin
...
function DocumentsToPixels(const AValue: TPoint;
  const ADpiX, ADpiY: Single): TPoint;
begin
  Result.Init(DocumentsToPixels(AValue.X, ADpiX),
    DocumentsToPixels(AValue.Y, ADpiY));
end;

function DocumentsToPixels(const AValue: TSize;
  const ADpiX, ADpiY: Single): TSize;
begin
  Result.Init(DocumentsToPixels(AValue.cx, ADpiX),
    DocumentsToPixels(AValue.cy, ADpiY));
end;

function DocumentsToPixels(const AValue: TRect;
  const ADpiX, ADpiY: Single): TRect;
begin
  Result.Init(DocumentsToPixels(AValue.Left, ADpiX),
    DocumentsToPixels(AValue.Top, ADpiY), DocumentsToPixels(AValue.Right,
    ADpiX), DocumentsToPixels(AValue.Bottom, ADpiY));
end;

function DocumentsToPixels(const AValue: TdxRectF; const ADpiX, ADpiY: Single)
  : TdxRectF;
begin
  Result.Init(DocumentsToPixelsF(AValue.Left, ADpiX),
    DocumentsToPixelsF(AValue.Top, ADpiY), DocumentsToPixelsF(AValue.Right,
    ADpiX), DocumentsToPixelsF(AValue.Bottom, ADpiY));
end;
...
function DocumentsToHundredthsOfInch(const AValue: TSize): TSize;
begin
  Result.Init(DocumentsToHundredthsOfInch(AValue.cx),
    DocumentsToHundredthsOfInch(AValue.cy));
end;
...
function TwipsToPixels(const AValue: TPoint;
  const ADpiX, ADpiY: Single): TPoint;
begin
...
function TwipsToPixels(const AValue: TRect; const ADpiX, ADpiY: Single): TRect;
begin
  Result.Init(TwipsToPixels(AValue.Left, ADpiX), TwipsToPixels(AValue.Top,
    ADpiY), TwipsToPixels(AValue.Right, ADpiX),
    TwipsToPixels(AValue.Bottom, ADpiY));
end;
...
begin
  Result.Init(TwipsToHundredthsOfInch(AValue.cx),
    TwipsToHundredthsOfInch(AValue.cy));
end;
...
begin
  ...
  if ADpiY = 0 then
    ADpiY := 300;
  Result.Init(PixelsToDocumentsCore(ARect.Left, ADpiX),
    PixelsToDocumentsCore(ARect.Top, ADpiY), PixelsToDocumentsCore(ARect.Right,
    ADpiX), PixelsToDocumentsCore(ARect.Bottom, ADpiY));
end;
...
begin
  ...
  if ADpiY = 0 then
    ADpiY := 300;
  Result.Init(PixelsToDocumentsCoreF(ARect.Left, ADpiX),
    PixelsToDocumentsCoreF(ARect.Top, ADpiY),
    PixelsToDocumentsCoreF(ARect.Right, ADpiX),
    PixelsToDocumentsCoreF(ARect.Bottom, ADpiY));
end;
...
begin
  ...
  if ADpiY = 0 then
    ADpiY := 300;
  Result.Init(PixelsToDocumentsCore(ASize.cx, ADpiX),
    PixelsToDocumentsCore(ASize.cy, ADpiY));
end;
...
function PixelsToDocumentsRound(const ASize: TSize;
  ADpiX, ADpiY: Single): TSize;
begin
  if ADpiX = 0 then
    ADpiX := 300;
  if ADpiY = 0 then
    ADpiY := 300;
  Result.Init(PixelsToDocumentsCoreRound(ASize.cx, ADpiX),
    PixelsToDocumentsCoreRound(ASize.cy, ADpiY));
end;
...
begin
  ...
  if ADpiY = 0 then
    ADpiY := 1440;
  Result.Init(PixelsToTwipsCore(ASize.cx, ADpiX),
    PixelsToTwipsCore(ASize.cy, ADpiY));
end;
...
begin
  ...
  if ADpiY = 0 then
    ADpiY := 1440;
  Result.Init(PixelsToTwipsCoreRound(ASize.cx, ADpiX),
    PixelsToTwipsCoreRound(ASize.cy, ADpiY));
end;
...
begin
  ...
  if ADpiY = 0 then
    ADpiY := 1440;
  Result.Init(PixelsToTwipsCore(ARect.Left, ADpiX), PixelsToTwipsCore(ARect.Top,
    ADpiY), PixelsToTwipsCore(ARect.Right, ADpiX),
    PixelsToTwipsCore(ARect.Bottom, ADpiY));
end;
...
begin
  ...
  if ADpiY = 0 then
    ADpiY := 300;
  Result.Init(PixelsToDocumentsCore(APoint.X, ADpiX),
    PixelsToDocumentsCore(APoint.Y, ADpiY));
end;
...
function PixelsToHundredthsOfInch(const AValue: Integer;
  const ADpi: Single): Integer;
begin
  Result := MulDiv(AValue, 100, ADpi);
end;

function PixelsToHundredthsOfInch(const AValue: TSize;
  const ADpi: Single): TSize;
begin
...
function HundredthsOfMillimeterToDocumentsRound(const AValue: Integer): Integer;
  overload; inline;
begin
  Result := Round(MulDivF(AValue, 15, 127));
end;

function HundredthsOfMillimeterToDocumentsRound(const AValue: TSize)
  : TSize; overload;
begin
...
function HundredthsOfMillimeterToTwipsRound(const AValue: Integer): Integer;
  overload; inline;
begin
  Result := Round(MulDivF(AValue, 72, 127));
end;

function HundredthsOfMillimeterToTwipsRound(const AValue: TSize)
  : TSize; overload;
begin
...
function HundredthsOfMillimeterToPixels(const AValue: Integer;
  const ADpi: Single): Integer; overload;
begin
  Result := Round(MulDivF(AValue, ADpi, 2540));
end;

function HundredthsOfMillimeterToPixels(const AValue: TSize;
  const ADpiX, ADpiY: Single): TSize; overload;
begin
...
function HundredthsOfInchToDocuments(const AValue: TSize): TSize;
begin
  Result.Init(HundredthsOfInchToDocuments(AValue.cx),
    HundredthsOfInchToDocuments(AValue.cy));
end;
...
begin
  Result.Init(HundredthsOfInchToTwips(AValue.cx),
    HundredthsOfInchToTwips(AValue.cy));
end;
...
function LoMetricToPixels(const Pt: TPoint;
  DPI: Integer = dxDefaultDPI): TPoint;
begin
