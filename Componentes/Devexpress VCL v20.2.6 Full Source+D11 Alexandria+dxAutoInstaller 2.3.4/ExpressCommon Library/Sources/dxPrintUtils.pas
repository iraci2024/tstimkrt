...
type
  ...
  public
    ...
    class procedure GetDefaultPageInfo(out AMargins: TRect;
      out AHeader, AFooter: Integer; out APageSize: TPoint;
      out ADMPaper: Integer; out AOrientation: TdxPrinterOrientation;
...
type
  TGetDefaultPrinter = function(pszBuffer: PChar; var cchBuffer: DWORD)
    : BOOL; stdcall;
...
begin
  case GetLocaleChar(LOCALE_USER_DEFAULT, LOCALE_IPAPERSIZE, '0') of
    '1':
      Result := Windows.DMPAPER_LETTER;
    '5':
      Result := Windows.DMPAPER_LEGAL;
    '8':
      Result := Windows.DMPAPER_A3;
    '9':
...
begin
  ...
  begin
    if (Abs(Papers[Result].Width - AWidth) <= S) and
      (Abs(Papers[Result].Height - AHeight) <= S) then
      Exit;
  end;
  Result := -1;
end;
...
procedure TdxPapers.AddPapers;
  ...
  procedure Add(const AName, AShortName: string; AWidth, AHeight: Integer;
    DMPaper: Integer);
  begin
...
begin
  Add('Letter 8 1/2 x 11 in', 'Letter', InchesToLoMetric(8.5),
    InchesToLoMetric(11), DMPAPER_LETTER);
  Add('Letter Small 8 1/2 x 11 in ', 'Letter Small', InchesToLoMetric(8.5),
    InchesToLoMetric(11), DMPAPER_LETTERSMALL);
  Add('Tabloid 11 x 17 in', 'Tabloid', InchesToLoMetric(11),
    InchesToLoMetric(17), DMPAPER_TABLOID);
  Add('Ledger 17 x 11 in', 'Ledger', InchesToLoMetric(17), InchesToLoMetric(11),
    DMPAPER_LEDGER);
  Add('Legal 8 1/2 x 14 in', 'Legal', InchesToLoMetric(8.5),
    InchesToLoMetric(14), DMPAPER_LEGAL);
  Add('Statement 5 1/2 x 8 1/2 in', 'Statement', InchesToLoMetric(5.5),
    InchesToLoMetric(8.5), DMPAPER_STATEMENT);
  Add('Executive 7 1/4 x 10 1/2 in', 'Executive', InchesToLoMetric(7.25),
    InchesToLoMetric(10.5), DMPAPER_EXECUTIVE);
  ...
  Add('Folio 8 1/2 x 13 in', 'Folio', InchesToLoMetric(8.5),
    InchesToLoMetric(13), DMPAPER_FOLIO);
  Add('Quarto 215 x 275 mm', 'Quarto', 2150, 2750, DMPAPER_QUARTO);
  Add('10x14 in', '10x14 in', InchesToLoMetric(10), InchesToLoMetric(14),
    DMPAPER_10X14);
  Add('11x17 in', '11x17 in', InchesToLoMetric(11), InchesToLoMetric(17),
    DMPAPER_11X17);
  Add('Note 8 1/2 x 11 in', 'Note', InchesToLoMetric(8.5), InchesToLoMetric(11),
    DMPAPER_NOTE);
  Add('Envelope #9 3 7/8 x 8 7/8', 'Envelope #9', InchesToLoMetric(3 + 7 / 8),
    InchesToLoMetric(8 + 7 / 8), DMPAPER_ENV_9);
  Add('Envelope #10 4 1/8 x 9 1/2', 'Envelope #10', InchesToLoMetric(4 + 1 / 8),
    InchesToLoMetric(9.5), DMPAPER_ENV_10);
  Add('Envelope #11 4 1/2 x 10 3/8', 'Envelope #11', InchesToLoMetric(4.5),
    InchesToLoMetric(10 + 3 / 8), DMPAPER_ENV_11);
  Add('Envelope #12 4 3/4 x 11', 'Envelope #12', InchesToLoMetric(4 + 3 / 4),
    InchesToLoMetric(11), DMPAPER_ENV_12);
  Add('Envelope #14 5 x 11 1/2', 'Envelope #14', InchesToLoMetric(5),
    InchesToLoMetric(11.5), DMPAPER_ENV_14);
  Add('C sheet 17 x 22 in', 'C sheet', InchesToLoMetric(17),
    InchesToLoMetric(22), DMPAPER_CSHEET);
  Add('D sheet 22 x 34 in', 'D sheet', InchesToLoMetric(22),
    InchesToLoMetric(34), DMPAPER_DSHEET);
  Add('E sheet 34 x 44 in', 'E sheet', InchesToLoMetric(34),
    InchesToLoMetric(44), DMPAPER_ESHEET);
  ...
  Add('Envelope Monarch 3 7/8 x 7 1/2 in', 'Envelope Monarch',
    InchesToLoMetric(3 + 7 / 8), InchesToLoMetric(7.5), DMPAPER_ENV_MONARCH);
  Add('6 3/4 Envelope 3 5/8 x 6 1/2 in', '6 3/4 Envelope',
    InchesToLoMetric(3 + 5 / 8), InchesToLoMetric(6.5), DMPAPER_ENV_PERSONAL);
  Add('US Std Fanfold 14 7/8 x 11 in', 'US Std Fanfold',
    InchesToLoMetric(14 + 7 / 8), InchesToLoMetric(11), DMPAPER_FANFOLD_US);
  Add('German Std Fanfold 8 1/2 x 12 in', 'German Std Fanfold',
    InchesToLoMetric(8.5), InchesToLoMetric(12), DMPAPER_FANFOLD_STD_GERMAN);
  Add('German Legal Fanfold 8 1/2 x 13 in', 'German Legal Fanfold',
    InchesToLoMetric(8.5), InchesToLoMetric(13), DMPAPER_FANFOLD_LGL_GERMAN);
  Add('B4 (ISO) 250 x 353 mm', 'B4 (ISO)', 2500, 3530, DMPAPER_ISO_B4);
  Add('Japanese Postcard 100 x 148 mm', 'Japanese Postcard', 1000, 1480,
    DMPAPER_JAPANESE_POSTCARD);
  Add('9 x 11 in', '9 x 11 in', InchesToLoMetric(90), InchesToLoMetric(110),
    DMPAPER_9X11);
  Add('10 x 11 in', '10 x 11 in', InchesToLoMetric(10), InchesToLoMetric(11),
    DMPAPER_10X11);
  Add('15 x 11 in', '15 x 11 in', InchesToLoMetric(15), InchesToLoMetric(11),
    DMPAPER_15X11);
  Add('Envelope Invite 220 x 220 mm', 'Envelope Invite', 2200, 2200,
    DMPAPER_ENV_INVITE);
  // DMPAPER_RESERVED_48        = 48;  { RESERVED--DO NOT USE                }
  // DMPAPER_RESERVED_49        = 49;  { RESERVED--DO NOT USE                }
  Add('Letter Extra 9 \275 x 12 in', 'Legal Extra',
    InchesToLoMetric(9 + 1 / 275), InchesToLoMetric(12), DMPAPER_LETTER_EXTRA);
  Add('Legal Extra 9 \275 x 15 in', 'Legal Extra',
    InchesToLoMetric(9 + 1 / 275), InchesToLoMetric(15), DMPAPER_LEGAL_EXTRA);
  Add('Tabloid Extra 11.69 x 18 in', 'Tabloid Extra', InchesToLoMetric(11.69),
    InchesToLoMetric(18), DMPAPER_TABLOID_EXTRA);
  Add('A4 Extra 9.27 x 12.69 in', 'A4 Extra', InchesToLoMetric(9.27),
    InchesToLoMetric(12.69), DMPAPER_A4_EXTRA);
  Add('Letter Transverse 8 \275 x 11 in', 'Letter Transverse',
    InchesToLoMetric(8 + 1 / 275), InchesToLoMetric(11),
    DMPAPER_LETTER_TRANSVERSE);
  Add('A4 Transverse 210 x 297 mm', 'A4 Transverse', 2100, 2970,
    DMPAPER_LETTER_EXTRA_TRANSVERSE);
  Add('Letter Extra Transverse 9\275 x 12 in', 'Letter Extra Transverse',
    InchesToLoMetric(9 + 1 / 275), InchesToLoMetric(12),
    DMPAPER_LETTER_EXTRA_TRANSVERSE);
  Add('SuperASuperAA4 227 x 356 mm', 'SuperASuperAA4', 2270, 3560,
    DMPAPER_A_PLUS);
  Add('SuperBSuperBA3 305 x 487 mm', 'SuperBSuperBA3', 3050, 4870,
    DMPAPER_B_PLUS);
  Add('Letter Plus 8.5 x 12.69 in', 'Letter Plus', InchesToLoMetric(8.5),
    InchesToLoMetric(12.69), DMPAPER_LETTER_PLUS);
  Add('A4 Plus 210 x 330 mm', 'A4 Plus', 2100, 3300, DMPAPER_A4_PLUS);
  Add('A5 Transverse 148 x 210 mm', 'A5 Transverse', 1480, 2100,
    DMPAPER_A5_TRANSVERSE);
  Add('B5 (JIS) Transverse 182 x 257 mm', 'B5 (JIS) Transverse', 1820, 2570,
  ...
  Add('B5 (ISO) Extra 201 x 276 mm', 'B5 (ISO) Extra', 2010, 2760,
    DMPAPER_B5_EXTRA);
  Add('A2 420 x 594 mm', 'A2', 4200, 5940, DMPAPER_A2);
  Add('A3 Transverse 297 x 420 mm', 'A3 Transverse', 2970, 4200,
    DMPAPER_A3_TRANSVERSE);
  Add('A3 Extra Transverse 322 x 445 mm', 'A3 Extra Transverse', 3220, 4450,
    DMPAPER_A3_EXTRA_TRANSVERSE);

  if Win32MajorVersion >= 5 then
  begin
    Add('Japanese Double Postcard 200 x 148 mm', 'Japanese Double Postcard',
      2000, 148, DMPAPER_DBL_JAPANESE_POSTCARD);
    ...
    Add('Letter Rotated 11 x 8 1/2 11 in', 'Letter Rotated',
      InchesToLoMetric(11), InchesToLoMetric(8.5), DMPAPER_LETTER_ROTATED);
    Add('A3 Rotated 420 x 297 mm', 'A3 Rotated', 4200, 2970,
      DMPAPER_A3_ROTATED);
    Add('A4 Rotated 297 x 210 mm', 'A4 Rotated', 2970, 2100,
      DMPAPER_A4_ROTATED);
    Add('A5 Rotated 210 x 148 mm', 'A5 Rotated', 2100, 1480,
      DMPAPER_A5_ROTATED);
    Add('B4 (JIS) Rotated 364 x 257 mm', 'B4 (JIS) Rotated', 3640, 2570,
      DMPAPER_B4_JIS_ROTATED);
    Add('B5 (JIS) Rotated 257 x 182 mm', 'B5 (JIS) Rotated', 2570, 1820,
      DMPAPER_B5_JIS_ROTATED);
    Add('Japanese Postcard Rotated 148 x 100 mm', 'Japanese Postcard Rotated',
      1480, 1000, DMPAPER_JAPANESE_POSTCARD_ROTATED);
    Add('A6 Rotated 148 x 105 mm', 'A6 Rotated', 1480, 1050,
      DMPAPER_A6_ROTATED);
    ...
    Add('B6 (JIS) Rotated 182 x 128 mm', 'B6 (JIS) Rotated', 1820, 1280,
      DMPAPER_B6_JIS_ROTATED);
    Add('12X11 12 x 11 in', '12X11', InchesToLoMetric(12), InchesToLoMetric(11),
      DMPAPER_12X11);
    ...
    Add('PRC Envelope #1 102 x 165 mm', 'PRC Envelope #1', 1020, 1650,
      DMPAPER_PENV_1);
    Add('PRC Envelope #2 102 x 176 mm', 'PRC Envelope #2', 1020, 1760,
      DMPAPER_PENV_2);
    Add('PRC Envelope #3 125 x 176 mm', 'PRC Envelope #3', 1250, 1760,
      DMPAPER_PENV_3);
    Add('PRC Envelope #4 110 x 208 mm', 'PRC Envelope #4', 1100, 2080,
      DMPAPER_PENV_4);
    Add('PRC Envelope #5 110 x 220 mm', 'PRC Envelope #5', 2190, 2200,
      DMPAPER_PENV_5);
    Add('PRC Envelope #6 120 x 230 mm', 'PRC Envelope #6', 1200, 2300,
      DMPAPER_PENV_6);
    Add('PRC Envelope #7 160 x 230 mm', 'PRC Envelope #7', 1600, 2300,
      DMPAPER_PENV_7);
    Add('PRC Envelope #8 120 x 309 mm', 'PRC Envelope #8', 1200, 3090,
      DMPAPER_PENV_8);
    Add('PRC Envelope #9 229 x 324 mm', 'PRC Envelope #9', 2290, 3240,
      DMPAPER_PENV_9);
    Add('PRC Envelope #10 324 x 458 mm', 'PRC Envelope #10', 3240, 4580,
      DMPAPER_PENV_10);
    Add('PRC 16K Rotated 146 x 215 mm', 'PRC 16K Rotated', 1460, 2150,
      DMPAPER_P16K_ROTATED);
    Add('PRC 32K Rotated 97 x 151 mm', 'PRC 32K Rotated', 970, 1510,
      DMPAPER_P32K_ROTATED);
    Add('PRC 32K(Big) Rotated 97 x 151 mm', 'PRC 32K(Big) Rotated', 970, 1510,
      DMPAPER_P32KBIG_ROTATED);
    Add('PRC Envelope #1 Rotated 165 x 102 mm', 'PRC Envelope #1 Rotated', 1650,
      1020, DMPAPER_PENV_1_ROTATED);
    Add('PRC Envelope #2 Rotated 176 x 102 mm', 'PRC Envelope #2 Rotated', 1760,
      1020, DMPAPER_PENV_2_ROTATED);
    Add('PRC Envelope #3 Rotated 176 x 125 mm', 'PRC Envelope #3 Rotated', 1760,
      1250, DMPAPER_PENV_3_ROTATED);
    Add('PRC Envelope #4 Rotated 208 x 110 mm', 'PRC Envelope #4 Rotated', 2080,
      1100, DMPAPER_PENV_4_ROTATED);
    Add('PRC Envelope #5 Rotated 220 x 110 mm', 'PRC Envelope #5 Rotated', 2200,
      2190, DMPAPER_PENV_5_ROTATED);
    Add('PRC Envelope #6 Rotated 230 x 120 mm', 'PRC Envelope #6 Rotated', 2300,
      1200, DMPAPER_PENV_6_ROTATED);
    Add('PRC Envelope #7 Rotated 230 x 160 mm', 'PRC Envelope #7 Rotated', 2300,
      1600, DMPAPER_PENV_7_ROTATED);
    Add('PRC Envelope #8 Rotated 309 x 120 mm', 'PRC Envelope #8 Rotated', 3090,
      1200, DMPAPER_PENV_8_ROTATED);
    Add('PRC Envelope #9 Rotated 324 x 229 mm', 'PRC Envelope #9 Rotated', 3240,
      2290, DMPAPER_PENV_9_ROTATED);
    Add('PRC Envelope #10 Rotated 458 x 324 mm', 'PRC Envelope #10 Rotated',
      4580, 3240, DMPAPER_PENV_10_ROTATED);
  end;
...
class procedure TdxPrintingDefaults.GetDefaultPageInfo(out AMargins: TRect;
  out AHeader, AFooter: Integer; out APageSize: TPoint; out ADMPaper: Integer;
  out AOrientation: TdxPrinterOrientation;
  AUnits: TdxMeasurementUnits = muDefault);
var
  AIndex: Integer;
begin
...
begin
  ...
  begin
    ...
    if (ADevice <> '') and OpenPrinter(PChar(ADevice), APrinterHandle, nil) and
      (APrinterHandle <> 0) then
      try
        ANeeded := 0;
        if GetPrinter(APrinterHandle, 9, nil, 0, @ANeeded) or (ANeeded <> 0)
        then
        begin
          APrinterInfo := GlobalAllocPtr(GPTR, ANeeded);
          if APrinterInfo <> nil then
            try
              if GetPrinter(APrinterHandle, 9, APrinterInfo, ANeeded, @ANeeded)
              then
              begin
...
begin
  ...
  if Assigned(FGetDefaultPrinter) and FGetDefaultPrinter(@ABuffer,
    ABufferLength) and (GetLastError = ERROR_SUCCESS) then
    Result := ABuffer
  else if GetProfileString('WINDOWS', 'DEVICE', '', ABuffer, ABufferLength) > 0
  then
  begin
    AScan := @ABuffer[0];
...
class procedure TdxPrintingDefaults.SetPrinterName(const Value: string);
  ...
  begin
    SendMessageTimeout(HWND_BROADCAST, WM_SETTINGCHANGE, 0, ALParam,
      SMTO_NORMAL, 1000, {$IFDEF DELPHI16}@{$ENDIF}ANeeded);
  end;
...
begin
  ...
  else if OpenPrinter(PChar(Value), APrinterHandle, nil) and
    (APrinterHandle <> 0) then
    try
      ANeeded := 0; { 3.03 }
      ...
      begin
        ...
        if APrinterInfo <> nil then
          try
            if GetPrinter(APrinterHandle, 2, APrinterInfo, ANeeded, @ANeeded)
            then
              if IsWin95 then // Win9x
              begin
                APrinterInfo^.Attributes := APrinterInfo^.Attributes or
                ...
                if (APrinterInfo^.pDriverName <> nil) and
                  (APrinterInfo^.pPortName <> nil) then
                begin
                  AData := dxConcatenateStrings([APrinterInfo^.pPrinterName,
                    ',', APrinterInfo^.pDriverName, ',',
                    APrinterInfo^.pDriverName]);
