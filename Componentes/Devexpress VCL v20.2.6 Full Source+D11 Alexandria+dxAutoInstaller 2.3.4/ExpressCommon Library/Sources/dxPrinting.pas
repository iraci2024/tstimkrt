...
type
  ...
  public
    ...
    procedure PrintReport(AComponent: TComponent;
      const APageIndexes: array of Integer); overload;
...
procedure TdxPrintingRepository.PrintReport(AComponent: TComponent;
  const APageIndexes: array of Integer);
var
  APrinting: IdxPrinting;
begin
  if Find(AComponent, APrinting) then
...
function TdxPrintingRepository.Find(AComponent: TComponent;
  out APrinting: IdxPrinting): Boolean;
var
  AIntf: IdxPrinting;
begin
  Result := False;
