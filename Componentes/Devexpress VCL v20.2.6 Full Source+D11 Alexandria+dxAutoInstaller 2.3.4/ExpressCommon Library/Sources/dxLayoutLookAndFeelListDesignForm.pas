...
{$ENDIF}
  ...
  cxTextEdit,
  cxLookAndFeelPainters, cxButtons, cxRichEdit, dxLayoutcxEditAdapters,
  cxLookAndFeels,
  dxLayoutContainer, cxClasses, cxImageList;

type
{$IFNDEF DXLAYOUTTEST}
  TdxLayoutLookAndFeelListDesignForm = class(TcxDesignFormEditor,
    IdxLayoutLookAndFeelsDesigner)
{$ELSE}
  TdxLayoutLookAndFeelListDesignForm = class(TForm,
    IdxLayoutLookAndFeelsDesigner)
{$ENDIF}
...
{$ENDIF}
  ...
  protected
    ...
    procedure SetComponent(AValue: TComponent); {$IFNDEF DXLAYOUTTEST}override;
    {$ENDIF}
...
procedure TdxLayoutLookAndFeelListDesignForm.SelectionsChanged(const ASelection
...
procedure TdxLayoutLookAndFeelListDesignForm.SelectComponent
...
procedure TdxLayoutLookAndFeelListDesignForm.Refresh(ARefreshSelection
  : Boolean = False);
begin
...
procedure TdxLayoutLookAndFeelListDesignForm.SetAddItemsActionEnabled
  (AEnabled: Boolean);
begin
  acAdd.Enabled := AEnabled;
end;

procedure TdxLayoutLookAndFeelListDesignForm.SetDeleteItemsActionEnabled
  (AEnabled: Boolean);
begin
  acDelete.Enabled := AEnabled;
end;

procedure TdxLayoutLookAndFeelListDesignForm.SynchronizeControlsSelection
  (AList: TList);
begin
...
begin
  ...
  RefreshEnabled;
  lcPreview_Root.Visible := (AList.Count = 1) and
    (TPersistent(AList[0]) is TdxCustomLayoutLookAndFeel) and
...
procedure TdxLayoutLookAndFeelListDesignForm.ComponentNameChanged
...
procedure TdxLayoutLookAndFeelListDesignForm.ItemsChanged(ALookAndFeelList
...
procedure TdxLayoutLookAndFeelListDesignForm.Edit(ALookAndFeelList
  : TdxLayoutLookAndFeelList);
begin
...
begin
  ALookAndFeel := List.CreateItem(dxLayoutLookAndFeelDefs.Items
...
procedure TdxLayoutLookAndFeelListDesignForm.lbItemsKeyDown(Sender: TObject;
...
begin
  liPreview.ControlOptions.OriginalWidth := lcPreview.OccupiedClientWidth +
    (lcPreview.Width - lcPreview.ClientWidth) + 5 { for skins };
  liPreview.ControlOptions.OriginalHeight := lcPreview.OccupiedClientHeight +
    (lcPreview.Height - lcPreview.ClientHeight) + 5 { for skins };
