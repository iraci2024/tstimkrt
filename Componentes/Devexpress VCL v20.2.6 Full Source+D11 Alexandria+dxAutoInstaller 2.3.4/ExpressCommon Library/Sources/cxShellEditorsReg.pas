...
uses
  DesignEditors, DesignIntf, Windows, Classes, Forms, cxDBShellComboBox,
  cxEditPropEditors,
  cxEditRepositoryEditor, cxExtEditConsts, cxShellBrowserDialog,
  cxShellComboBox,
...
begin
  ...
  with TcxShellBrowserDialog.Create(Application) do
    try
      ...
      Options.ShowZipFilesWithFolders :=
        ADialog.Options.ShowZipFilesWithFolders;
...
begin
  ...
  RegisterSelectionEditor(TdxCustomShellBreadcrumbEdit,
    TcxShellEditorSelectionEditor);
  RegisterSelectionEditor(TcxCustomShellComboBox,
    TcxShellEditorSelectionEditor);
  RegisterSelectionEditor(TcxCustomShellListView,
    TcxShellEditorSelectionEditor);
  RegisterSelectionEditor(TcxCustomShellTreeView,
    TcxShellEditorSelectionEditor);
  ...
  RegisterPropertyEditor(TypeInfo(Boolean), TcxCustomShellTreeView,
    'RightClickSelect', nil);
end;
