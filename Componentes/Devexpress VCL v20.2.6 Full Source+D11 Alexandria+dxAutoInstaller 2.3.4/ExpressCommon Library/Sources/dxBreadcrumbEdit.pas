...
{$ENDIF}
  ...
  ImgList, Menus,
  dxCore, dxCoreClasses, dxMessages, cxClasses, dxCustomTree, dxFading,
  cxGraphics,
  cxLookAndFeels, cxLookAndFeelPainters, cxControls, cxEdit, cxContainer,
  cxListBox,
...
type
  ...
  TdxBreadcrumbEditChange = (bcecAnimation, bcecButtons, bcecLayout, bcecNodes,
    bcecPathEditor, bcecProgress, bcecSelection);
  TdxBreadcrumbEditChanges = set of TdxBreadcrumbEditChange;
  TdxBreadcrumbEditChangeEvent = procedure(Sender: TObject;
    AChanges: TdxBreadcrumbEditChanges) of object;
...
{$ENDIF}
  ...
  IdxBreadcrumbEditEvents = interface
    ...
    procedure PathValidate(const APath: string;
      var ANode: TdxBreadcrumbEditNode; var AErrorText: string;
      var AError: Boolean);
    procedure PopulateAutoCompleteSuggestions(const APath: string;
  ...
  public
    ...
    function AddChild(const AName: string; AImageIndex: TcxImageIndex = -1;
      AData: Pointer = nil): TdxBreadcrumbEditNode; overload;
    function AddChild(const AName, ADisplayName: string;
      AImageIndex: TcxImageIndex = -1; AData: Pointer = nil)
      : TdxBreadcrumbEditNode; overload;
    function AddChildFirst: TdxBreadcrumbEditNode;
    function AddNode(ANode, ARelative: TdxBreadcrumbEditNode; AData: Pointer;
      AAttachMode: TdxTreeNodeAttachMode): TdxBreadcrumbEditNode;
    function Compare(const AName: string): Boolean; virtual;
    function FindNode(const AName: string;
  ...
  protected
    ...
    function CreateFadeImage(AHotPartIndex: Integer;
      AIsHot, AIsPressed: Boolean): TcxBitmap32; virtual;
  ...
  public
    ...
    procedure CalculateHitTest(AHitTestInfo
      : TdxBreadcrumbEditHitTestInfo); virtual;
  ...
  public
    constructor Create(AOwner: TdxBreadcrumbEditPartCustomViewInfo;
      AButton: TdxBreadcrumbEditButton); virtual;
  ...
  public
    ...
    property DelimiterState: TdxBreadcrumbEditButtonState
      read GetDelimiterState;
  ...
  public
    constructor Create(AOwner: TdxBreadcrumbEditPartCustomViewInfo;
      ANode: TdxBreadcrumbEditNode); override;
  ...
  public
    ...
    //
    property Items[Index: Integer]: TdxBreadcrumbEditButton read GetItem
  ...
  public
    ...
    function Add(const APath: string; AImageIndex: TcxImageIndex = -1)
      : TdxBreadcrumbEditRecentPath; overload;
    function IndexOfPath(const APath: string): Integer;
    function Insert(AIndex: Integer): TdxBreadcrumbEditRecentPath; overload;
    function Insert(AIndex: Integer; const APath: string;
      AImageIndex: TcxImageIndex = -1): TdxBreadcrumbEditRecentPath; overload;
    //
    property Items[Index: Integer]: TdxBreadcrumbEditRecentPath read GetItem
      write SetItem; default;
  end;
  ...
  public
    property OnChange: TdxBreadcrumbEditChangeEvent read FOnChange
      write FOnChange;
  end;
  ...
  published
    ...
    property AutoCompleteDropDownRows: Integer read FAutoCompleteDropDownRows
      write SetAutoCompleteDropDownRows
      default dxBreadcrumbEditDefaultAutoCompleteDropDownRows;
    property Enabled: Boolean read FEnabled write SetEnabled default True;
    property PathDelimiter: Char read FPathDelimiter write SetPathDelimiter
      default PathDelim;
    property ReadOnly: Boolean read FReadOnly write SetReadOnly default False;
    property RecentPaths: TdxBreadcrumbEditRecentPaths read FRecentPaths
      write SetRecentPaths;
    property RecentPathsAutoPopulate: Boolean read FRecentPathsAutoPopulate
      write SetRecentPathsAutoPopulate default True;
    property RecentPathsDropDownRows: Integer read FRecentPathsDropDownRows
      write SetRecentPathsDropDownRows
      default dxBreadcrumbEditDefaultRecentPathsDropDownRows;
    property RecentPathsEnabled: Boolean read FRecentPathsEnabled
      write SetRecentPathsEnabled default True;
    property RecentPathsMaxCount: Integer read FRecentPathsMaxCount
      write SetRecentPathsMaxCount
      default dxBreadcrumbEditDefaultRecentPathsMaxCount;
  end;

  { TdxBreadcrumbEditProgressBarProperties }

  TdxBreadcrumbEditProgressBarCancelEffect = (bpceNone, bpceFillAreaForward,
  ...
  published
    ...
    property AnimationRestartDelay: Cardinal read FAnimationRestartDelay
      ...
      default dxBreadcrumbEditDefaultAnimationRestartDelay;
    ...
    property CancelEffect: TdxBreadcrumbEditProgressBarCancelEffect
      read FCancelEffect write SetCancelEffect default bpceFillAreaForward;
  ...
  protected
    ...
    function CreatePathEditorProperties
      : TdxBreadcrumbEditPathEditorProperties; virtual;
    function CreateProgressBarProperties
      : TdxBreadcrumbEditProgressBarProperties; virtual;
    procedure InitiateActions; virtual;
    procedure Notification(AComponent: TComponent;
      Operation: TOperation); virtual;
    //
    property Borders: TcxBorders read FBorders write SetBorders
      default cxBordersAll;
    ...
    property DropDownIndent: TdxBreadcrumbEditDropDownIndent
      read FDropDownIndent write SetDropDownIndent default ddiNone;
    property DropDownRows: Integer read FDropDownRows write SetDropDownRows
      default dxBreadcrumbEditDefaultDropDownRows;
    property Images: TCustomImageList read FImages write SetImages;
    property PathEditor: TdxBreadcrumbEditPathEditorProperties read FPathEditor
      write SetPathEditor;
    property ProgressBar: TdxBreadcrumbEditProgressBarProperties
      read FProgressBar write SetProgressBar;
  public
    constructor Create(AOwner: TPersistent); override;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
  ...
  protected
    ...
    function IsViewItemValid(AItem: TdxBreadcrumbEditViewItem)
      : Boolean; virtual;
    procedure InternalDraw(ACanvas: TcxCanvas); virtual;
    function PlaceAt(var R: TRect; AWidth: Integer;
      AAtRightSide: Boolean): TRect;
  public
    ...
    procedure UpdateViewItemsState
      (AInfo: TdxBreadcrumbEditHitTestInfo); virtual;
    //
    property Bounds: TRect read FBounds;
    ...
    property ScaleFactor: TdxScaleFactor read GetScaleFactor;
    property UseRightToLeftAlignment: Boolean read GetUseRightToLeftAlignment;
    property ViewItems[Index: Integer]: TdxBreadcrumbEditViewItem
      read GetViewItem; // for internal use
    property ViewItemCount: Integer read GetViewItemCount;
  end;

  { TdxBreadcrumbEditButtonsPartViewInfo }

  TdxBreadcrumbEditButtonsPartViewInfo = class
    (TdxBreadcrumbEditPartCustomViewInfo)
  protected
    FSeparatorRect: TRect;
    function CreateViewItem(AButton: TdxBreadcrumbEditButton)
      : TdxBreadcrumbEditButtonViewItem; virtual;
  ...
  protected
    ...
    function CreateViewItem(ANode: TdxBreadcrumbEditNode)
      : TdxBreadcrumbEditNodeViewItem; virtual;
    ...
    procedure DrawImage(ACanvas: TcxCanvas; const ARect: TRect;
      AImageIndex: TcxImageIndex); virtual;
    procedure InternalDraw(ACanvas: TcxCanvas); override;
  public
    ...
    function FindViewItem(ANode: TdxBreadcrumbEditNode;
      out AViewItem: TdxBreadcrumbEditNodeViewItem): Boolean;
    procedure RecreateViewItems; override;
    procedure UpdateViewItemsState
      (AInfo: TdxBreadcrumbEditHitTestInfo); override;
    //
    ...
    property SelectedNodeViewItem: TdxBreadcrumbEditNodeViewItem
      read GetSelectedNodeViewItem; // for internal use
    property ViewItems[Index: Integer]: TdxBreadcrumbEditNodeViewItem
      read GetViewItem; // for internal use
  end;

  { TdxBreadcrumbEditProgressBarPartViewInfo }

  TdxBreadcrumbEditProgressBarPartViewInfo = class
    (TdxBreadcrumbEditPartCustomViewInfo)
  private
    FOpacity: Byte;
  ...
  public
    ...
    property OverlayPosition: Integer read FOverlayPosition
      write FOverlayPosition;
  ...
  TdxBreadcrumbEditProgressBarFadingState = (bcpfsNone, bcpfsFadeIn,
    bcpfsFadeOut);
  ...
  protected
    ...
    //
    property CancelEffectAnimationActive: Boolean
      read GetCancelEffectAnimationActive;
    property CancelEffectAnimationTimer: TcxTimer
      read FCancelEffectAnimationTimer;
    property FadingStageAlpha: Byte read GetFadingStageAlpha;
    property FadingState: TdxBreadcrumbEditProgressBarFadingState
      read FFadingState;
    ...
    property OverlayAnimationTimerInterval: Cardinal
      read GetOverlayAnimationTimerInterval;
    property Progress: Single read FProgress write SetProgress;
  public
    ...
    property Properties: TdxBreadcrumbEditProgressBarProperties
      read GetProperties;
    property ViewInfo: TdxBreadcrumbEditProgressBarPartViewInfo
      read GetViewInfo;
  end;
  ...
  protected
    ...
    function CreateButtonsViewInfo
      : TdxBreadcrumbEditButtonsPartViewInfo; virtual;
    function CreateHitTestInfo: TdxBreadcrumbEditHitTestInfo; virtual;
    function CreateNodesAreaViewInfo
      : TdxBreadcrumbEditNodesAreaPartViewInfo; virtual;
    function CreateProgressBarViewInfo
      : TdxBreadcrumbEditProgressBarPartViewInfo; virtual;
    function IsViewItemValid(AItem: TdxBreadcrumbEditViewItem)
      : Boolean; virtual;
  ...
  public
    ...
    property Bounds: TRect read FBounds;
    property ButtonsViewInfo: TdxBreadcrumbEditButtonsPartViewInfo
    ...
    // for internal use
    property NodesAreaViewInfo: TdxBreadcrumbEditNodesAreaPartViewInfo
      read FNodesAreaViewInfo; // for internal use
    property Painter: TcxCustomLookAndFeelPainter read GetPainter;
    property ProgressBarViewInfo: TdxBreadcrumbEditProgressBarPartViewInfo
      read FProgressBarViewInfo; // for internal use
    property Properties: TdxCustomBreadcrumbEditProperties read GetProperties;
  ...
  protected
    ...
    procedure InternalCalculateVerticalDirectionPosition(var APosition: TPoint;
      var AOrigin: TPoint; const ASize: TSize); override;
    //
    property Controller: TdxBreadcrumbEditController read FController;
    property RootAlwaysVisible: Boolean read GetRootAlwaysVisible;
  public
    constructor Create(AController: TdxBreadcrumbEditController);
      reintroduce; virtual;
    procedure Popup; override;
    //
    property InnerListBox: TdxBreadcrumbEditDropDownInnerListBox
      read GetInnerListBox;
  end;
  ...
  protected
    ...
    function ProcessNavigationKey(var Key: Word; Shift: TShiftState)
      : Boolean; override;
    ...
    property RootItemState: TcxButtonState read FRootItemState
      write SetRootItemState default cxbsNormal;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    function CalculateContentSize(AMaxVisibleItemsCount: Integer)
      : TSize; override;
    function CalculateItemHeight: Integer; override;
    function ItemAtPos(const APoint: TPoint; AExistOnly: Boolean = False)
      : Integer; override;
  ...
  TdxBreadcrumbEditPathInplaceEditorProperties = class
  ...
  public
    ...
    property AutoCompleteDropDownRows: Integer read FAutoCompleteDropDownRows
      write SetAutoCompleteDropDownRows;
    property CanShowDropDown: Boolean read FCanShowDropDown
      write SetCanShowDropDown;
  ...
  protected
    ...
    property Properties: TdxBreadcrumbEditPathInplaceEditorProperties
      read GetProperties;
  public
  ...
  protected
    procedure CalculateButtonNativeInfo(AButtonViewInfo
      : TcxEditButtonViewInfo); override;
  ...
  strict private
    ...
    FOnPopulateAutoCompleteSuggestions
      : TdxBreadcrumbEditPopulateAutoCompleteSuggestionsEvent;
  ...
  protected
    ...
    function CreateAutoCompleteWindow
      : TdxBreadcrumbEditAutoCompleteWindow; virtual;
    function CreateViewData: TcxCustomEditViewData; override;
    class function GetDataBindingClass: TcxEditDataBindingClass; override;
    function GetScrollLookupDataList(AScrollCause: TcxEditScrollCause)
      : Boolean; override;
    ...
    //
    property AutoCompleteWindow: TdxBreadcrumbEditAutoCompleteWindow
      read FAutoCompleteWindow;
    property AutoCompleteWindowCustomizedSize: TSize
      read FAutoCompleteWindowCustomizedSize;
    property AutoCompleteWindowCustomizedSizeAssigned: Boolean
      read GetIsAutoCompleteWindowCustomizedSizeAssigned;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    ...
    //
    property ActiveProperties: TdxBreadcrumbEditPathInplaceEditorProperties
      read GetActiveProperties; // for internal use
    property AutoCompleteSuggestions: TStringList read FAutoCompleteSuggestions
      write SetAutoCompleteSuggestions;
    property LookupData: TdxBreadcrumbEditPathEditorLookupData
      read GetLookupData; // for internal use
    property Properties: TdxBreadcrumbEditPathInplaceEditorProperties
      read GetProperties; // for internal use
    //
    property OnPopulateAutoCompleteSuggestions
      : TdxBreadcrumbEditPopulateAutoCompleteSuggestionsEvent
      read FOnPopulateAutoCompleteSuggestions
      write FOnPopulateAutoCompleteSuggestions;
  end;
  ...
  strict private
    ...
    procedure PathEditorPopulateAutoCompleteSuggestions(Sender: TObject;
  ...
  protected
    ...
    function CanAddToRecentPaths(ANode: TdxBreadcrumbEditNode)
      : Boolean; virtual;
    ...
    // Suggestions
    procedure AddSuggestion(const ACurrentPath, ASuggestedPath: string;
      ASuggestions: TStringList);
    function CanAddNodeToSuggestions(const ACurrentPath: string;
      ANode: TdxBreadcrumbEditNode): Boolean; virtual;
    function IsSubPath(const ABasePath, APathForCheck: string)
      : Boolean; virtual;
    procedure PopulateCustomSuggestions(const APath: string;
      ASuggestions: TStringList); virtual;
  ...
  public
    ...
    // for internal use
    property Properties: TdxBreadcrumbEditPathEditorProperties
      read GetProperties;
  ...
  protected
    ...
    function CreateDropDownMenuWindow
      : TdxBreadcrumbEditNodeDropDownMenu; virtual;
    function CreatePathEditingController
      : TdxBreadcrumbEditPathEditingController; virtual;
    function CreateProgressBarController
      : TdxBreadcrumbEditProgressBarController; virtual;
    function FindNextSelectableViewItem(AItem: TdxBreadcrumbEditViewItem)
      : TdxBreadcrumbEditViewItem; virtual;
    function FindPrevSelectableViewItem(AItem: TdxBreadcrumbEditViewItem)
      : TdxBreadcrumbEditViewItem; virtual;
    function FindRootNodeForPath(var APath: string;
      out ANode: TdxBreadcrumbEditNode): Boolean; virtual;
    function FindSelectableViewItem(AItem: TdxBreadcrumbEditViewItem;
      AGoForward: Boolean): TdxBreadcrumbEditViewItem; virtual;
    ...
    procedure ValidatePath(const APath: string;
      var ANode: TdxBreadcrumbEditNode); virtual;
    procedure WndProc(var Message: TMessage); override;
    //
    ...
    function DoSelectPath(const APath: string; ANode: TdxBreadcrumbEditNode)
      : Boolean; virtual;
    ...
    property DropDownMenuOwner: TdxBreadcrumbEditNodeViewItem
      read FDropDownMenuOwner write SetDropDownMenuOwner;
    property DropDownMenuWindow: TdxBreadcrumbEditNodeDropDownMenu
      read FDropDownMenuWindow;
    property FocusedViewItem: TdxBreadcrumbEditViewItem read FFocusedViewItem
      write SetFocusedViewItem;
    property IsUpdateLocked: Boolean read GetIsUpdateLocked;
    property MouseInControl: Boolean read FMouseInControl
      write SetMouseInControl;
    property PressedViewItem: TdxBreadcrumbEditViewItem read FPressedViewItem
      write SetPressedViewItem;
    property ProgressBarController: TdxBreadcrumbEditProgressBarController
      read FProgressBarController;
    property Root: TdxBreadcrumbEditNode read GetRoot;
    property SelectedNodeViewItem: TdxBreadcrumbEditNodeViewItem
      read GetSelectedNodeViewItem;
  public
    constructor Create(AViewInfo: TdxBreadcrumbEditViewInfo);
      reintroduce; virtual;
    destructor Destroy; override;
    ...
    procedure MouseDown(AButton: TMouseButton; const P: TPoint;
      AShift: TShiftState); virtual;
    procedure MouseLeave; virtual;
    procedure MouseMove(const P: TPoint; AShift: TShiftState); virtual;
    procedure MouseUp(AButton: TMouseButton; const P: TPoint;
      AShift: TShiftState); virtual;
    ...
    procedure ShowNodeDropDownMenu(ANodeViewItem
      : TdxBreadcrumbEditNodeViewItem); virtual;
    //
    property Control: IdxBreadcrumbEdit read GetControl; // for internal use
    ...
    // for internal use
    property IsFocused: Boolean read GetIsFocused;
    property PathEditingController: TdxBreadcrumbEditPathEditingController
      read FPathEditingController; // for internal use
  ...
  TdxBreadcrumbEditButtonClickEvent = procedure(Sender: TObject;
    AButton: TdxBreadcrumbEditButton) of object;
  TdxBreadcrumbEditNodeEvent = procedure(Sender: TObject;
    ANode: TdxBreadcrumbEditNode) of object;
  TdxBreadcrumbEditPathEnteredEvent = procedure(Sender: TObject;
    var ANewPath: string; var AHandled: Boolean) of object;
  TdxBreadcrumbEditPathValidateEvent = procedure(Sender: TObject;
    const APath: string; var ANode: TdxBreadcrumbEditNode;
    var AErrorText: string; var AError: Boolean) of object;

  TdxCustomBreadcrumbEdit = class(TcxControl, IdxSkinSupport, IdxTreeOwner,
    IdxBreadcrumbEdit, IdxBreadcrumbEditEvents)
  private
    FController: TdxBreadcrumbEditController;
{$IFNDEF VCLGLASSPAINT}
    FOnGlass: Boolean;
...
{$ENDIF}
    ...
    property ViewInfo: TdxBreadcrumbEditViewInfo read FViewInfo;
    //
    property OnButtonClick: TdxBreadcrumbEditButtonClickEvent
      read FOnButtonClick write FOnButtonClick;
    property OnDeleteNode: TdxBreadcrumbEditNodeEvent read FOnDeleteNode
      write FOnDeleteNode;
    property OnNodeDropDownPopup: TdxBreadcrumbEditNodeEvent
      read FOnNodeDropDownPopup write FOnNodeDropDownPopup;
    property OnPathEntered: TdxBreadcrumbEditPathEnteredEvent
      read FOnPathEntered write FOnPathEntered;
    property OnPathSelected: TNotifyEvent read FOnPathSelected
      write FOnPathSelected;
    property OnPathValidate: TdxBreadcrumbEditPathValidateEvent
      read FOnPathValidate write FOnPathValidate;
    property OnPopulateAutoCompleteSuggestions
      : TdxBreadcrumbEditPopulateAutoCompleteSuggestionsEvent
      read FOnPopulateAutoCompleteSuggestions
      write FOnPopulateAutoCompleteSuggestions;
    property OnPopulateChildren: TdxBreadcrumbEditNodeEvent
      read FOnPopulateChildren write FOnPopulateChildren;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
...
{$ENDIF}
  ...
  published
    ...
    property Properties: TdxBreadcrumbEditProperties read GetProperties
      write SetProperties;
...
uses
  Math, StdCtrls, cxEditConsts, Variants, StrUtils, dxCoreGraphics;
...
begin
  Result := TdxBreadcrumbEditNode(inherited AddNode(ANode, ARelative, AData,
    AAttachMode));
end;
...
function TdxBreadcrumbEditNode.FindNode(const AName: string;
  out ANode: TdxBreadcrumbEditNode): Boolean;
var
  I: Integer;
begin
...
constructor TdxBreadcrumbEditViewItem.Create
  (AOwner: TdxBreadcrumbEditPartCustomViewInfo);
begin
  inherited Create;
  FOwner := AOwner;
end;
...
procedure TdxBreadcrumbEditViewItem.CalculateHitTest(AHitTestInfo
  : TdxBreadcrumbEditHitTestInfo);
begin
...
function TdxBreadcrumbEditViewItem.CreateFadeImage(AHotPartIndex: Integer;
  AIsHot, AIsPressed: Boolean): TcxBitmap32;
var
  APrevHot: Boolean;
...
procedure TdxBreadcrumbEditViewItem.UpdateStates(AHitTestInfo
  : TdxBreadcrumbEditHitTestInfo);
  ...
  function DoUpdateState(AHotPartIndex: Integer;
    AIsHot, AIsPressed: Boolean): Boolean;
  var
    APrevHotPartIndex: Integer;
  ...
  begin
    ...
    FIsPressed := AIsPressed;
    FIsHot := AIsHot;
    Result := (State <> APrevState) or (State = dxbcbsHot) and
      (APrevHotPartIndex <> FHotPartIndex);
  end;
...
begin
  ...
  begin
    if CanFade then
    begin
      dxFader.Fade(Self, CreateFadeImage(APrevHotPartIndex, APrevHot,
        APrevPressed), CreateFadeImage(GetHotPartIndex, GetIsHot, GetIsPressed),
        dxBreadcrumbEditButtonsFadeFramesCount,
...
procedure TdxBreadcrumbEditViewItem.GetFadingImages(out AFadeOutImage,
...
begin
  Result := (Controller.FocusedViewItem = Self) and
...
begin
  Result := (Controller.FocusedViewItem = Self) and
    (Controller.PressedViewItem = Self);
end;

function TdxBreadcrumbEditViewItem.GetState: TdxBreadcrumbEditButtonState;
const
  HotStateMap: array [Boolean] of TdxBreadcrumbEditButtonState = (dxbcbsHot,
    dxbcbsFocused);
begin
...
constructor TdxBreadcrumbEditButtonViewItem.Create
  (AOwner: TdxBreadcrumbEditPartCustomViewInfo;
  AButton: TdxBreadcrumbEditButton);
begin
...
begin
  Painter.DrawBreadcrumbEditScaledButton(ACanvas, Bounds, State, IsFirst,
    IsLast, ScaleFactor);
end;

procedure TdxBreadcrumbEditButtonViewItem.DrawContent(ACanvas: TcxCanvas);
begin
  cxDrawImage(ACanvas.Handle, cxRectCenter(cxRectContent(Bounds,
    ContentOffsets), ImageSize), Bounds, Button.Glyph,
    Owner.Properties.ButtonImages, Button.ImageIndex,
    EnabledImageDrawModeMap[GetIsEnabled], False, 0, clDefault, False,
    Painter.BreadcrumbEditButtonColorPalette(State));
end;

function TdxBreadcrumbEditButtonViewItem.GetContentOffsets: TRect;
begin
  Result := Painter.BreadcrumbEditScaledButtonContentOffsets(IsFirst, IsLast,
    ScaleFactor);
end;
...
begin
  if IsImageAssigned(Button.Glyph, Owner.Properties.ButtonImages,
    Button.ImageIndex) then
    Result := dxGetImageSize(Button.Glyph, Owner.Properties.ButtonImages,
      Button.ImageIndex, ScaleFactor)
  else
...
procedure TdxBreadcrumbEditNodeViewItem.BuildDropDownMenu
  (AItems: TdxCustomListBoxItems);
var
...
begin
  Result := FTextSize.cy + cxMarginsHeight
    (Painter.BreadcrumbEditScaledNodeTextOffsets(ScaleFactor));
end;

procedure TdxBreadcrumbEditNodeViewItem.CalculateHitTest
  (AHitTestInfo: TdxBreadcrumbEditHitTestInfo);
begin
...
begin
  ...
  FMaxWidth := DelimiterSize +
    Max(Painter.BreadcrumbEditScaledNodeDelimiterSize(ScaleFactor),
    FTextSize.cx + cxMarginsWidth(Painter.BreadcrumbEditScaledNodeTextOffsets
    (ScaleFactor)));
  FMinWidth := Min(ScaleFactor.Apply(dxBreadcrumbEditMinReducedNodeWidth),
    MaxWidth);
  FWidth := MaxWidth;
end;
...
begin
  if cxRectIsEmpty(ButtonRect) then
    Painter.DrawBreadcrumbEditScaledNode(ACanvas, DelimiterRect, DelimiterState,
      False, ScaleFactor)
  else if cxRectIsEmpty(DelimiterRect) then
    Painter.DrawBreadcrumbEditScaledNode(ACanvas, ButtonRect, State, False,
      ScaleFactor)
  else
  begin
    Painter.DrawBreadcrumbEditScaledNode(ACanvas, ButtonRect, State, True,
      ScaleFactor);
    Painter.DrawBreadcrumbEditScaledNodeDelimiter(ACanvas, DelimiterRect,
      DelimiterState, ScaleFactor);
  end;
end;
...
begin
  ...
  R := cxRectContent(ButtonRect, Painter.BreadcrumbEditScaledNodeTextOffsets
    (ScaleFactor));
  if not cxRectIsEmpty(R) then
  begin
    ACanvas.Font := Font;
    ACanvas.Font.Color := GetTextColor;
    ACanvas.DrawTexT(Node.ActualDisplayName, R,
      AlignMap[cxRectWidth(R) > FTextSize.cx], vaCenter, False, True);
  end;
end;

procedure TdxBreadcrumbEditNodeViewItem.DrawDelimiterGlyph(ACanvas: TcxCanvas);
begin
  Painter.DrawBreadcrumbEditScaledNodeDelimiterGlyph(ACanvas, DelimiterRect,
    DelimiterState, ScaleFactor);
end;
...
function TdxBreadcrumbEditNodeViewItem.GetDelimiterState
  : TdxBreadcrumbEditButtonState;
const
  HotStateMap: array [Boolean] of TdxBreadcrumbEditButtonState = (dxbcbsHot,
    dxbcbsFocused);
begin
...
procedure TdxBreadcrumbEditRootNodeViewItem.BuildDropDownMenu
  (AItems: TdxCustomListBoxItems);
...
procedure TdxBreadcrumbEditRootNodeViewItem.DrawDelimiterGlyph
  (ACanvas: TcxCanvas);
begin
  if IsNextNodeHidden then
    Painter.DrawBreadcrumbEditScaledNodeMoreButtonGlyph(ACanvas, DelimiterRect,
      DelimiterState, ScaleFactor)
  else
...
function TdxBreadcrumbEditButtons.GetItem(Index: Integer)
  : TdxBreadcrumbEditButton;
begin
  Result := TdxBreadcrumbEditButton(inherited GetItem(Index));
end;

procedure TdxBreadcrumbEditButtons.SetItem(Index: Integer;
  Value: TdxBreadcrumbEditButton);
begin
...
procedure TdxBreadcrumbEditCustomPropertiesPersistent.Changed
  (AChanges: TdxBreadcrumbEditChanges);
begin
...
procedure TdxBreadcrumbEditCustomPropertiesPersistent.ChangeScale(M,
  D: Integer);
begin
  // do nothing
end;
...
begin
  ...
  begin
    ...
    AnimationRestartDelay := TdxBreadcrumbEditProgressBarProperties(Source)
      .AnimationRestartDelay;
    AnimationSpeed := TdxBreadcrumbEditProgressBarProperties(Source)
      .AnimationSpeed;
...
procedure TdxBreadcrumbEditProgressBarProperties.SetAnimationRestartDelay
  (AValue: Cardinal);
begin
...
procedure TdxBreadcrumbEditProgressBarProperties.SetAnimationSpeed
  (AValue: Cardinal);
begin
...
begin
  if Collection.Owner is TdxBreadcrumbEditPathEditorProperties then
    Result := TdxBreadcrumbEditPathEditorProperties(Collection.Owner)
      .PathDelimiter
  else
    Result := PathDelim;
end;
...
function TdxBreadcrumbEditRecentPaths.Add(const APath: string;
  AImageIndex: TcxImageIndex = -1): TdxBreadcrumbEditRecentPath;
begin
  BeginUpdate;
  try
    Result := Add;
...
function TdxBreadcrumbEditRecentPaths.Insert(AIndex: Integer;
  const APath: string; AImageIndex: TcxImageIndex = -1)
  : TdxBreadcrumbEditRecentPath;
begin
  BeginUpdate;
  try
...
function TdxBreadcrumbEditRecentPaths.GetItem(AIndex: Integer)
  : TdxBreadcrumbEditRecentPath;
begin
  Result := TdxBreadcrumbEditRecentPath(inherited Items[AIndex]);
end;

procedure TdxBreadcrumbEditRecentPaths.SetItem(AIndex: Integer;
  AValue: TdxBreadcrumbEditRecentPath);
begin
...
begin
  ...
  begin
    ...
    AutoCompleteDropDownRows := TdxBreadcrumbEditPathEditorProperties(Source)
      .AutoCompleteDropDownRows;
    Enabled := TdxBreadcrumbEditPathEditorProperties(Source).Enabled;
    PathDelimiter := TdxBreadcrumbEditPathEditorProperties(Source)
      .PathDelimiter;
    ...
    RecentPathsAutoPopulate := TdxBreadcrumbEditPathEditorProperties(Source)
      .RecentPathsAutoPopulate;
    RecentPathsDropDownRows := TdxBreadcrumbEditPathEditorProperties(Source)
      .RecentPathsDropDownRows;
    RecentPathsMaxCount := TdxBreadcrumbEditPathEditorProperties(Source)
      .RecentPathsMaxCount;
    RecentPathsEnabled := TdxBreadcrumbEditPathEditorProperties(Source)
      .RecentPathsEnabled;
  end;
end;

procedure TdxBreadcrumbEditPathEditorProperties.SetAutoComplete
  (AValue: Boolean);
begin
...
procedure TdxBreadcrumbEditPathEditorProperties.SetAutoCompleteDropDownRows
  (AValue: Integer);
begin
  AValue := Max(AValue, 1);
...
procedure TdxBreadcrumbEditPathEditorProperties.SetRecentPaths
  (AValue: TdxBreadcrumbEditRecentPaths);
begin
  FRecentPaths.Assign(AValue);
end;

procedure TdxBreadcrumbEditPathEditorProperties.SetRecentPathsAutoPopulate
  (AValue: Boolean);
begin
...
procedure TdxBreadcrumbEditPathEditorProperties.SetRecentPathsDropDownRows
  (AValue: Integer);
begin
  AValue := Max(AValue, 1);
...
procedure TdxBreadcrumbEditPathEditorProperties.SetRecentPathsEnabled
  (AValue: Boolean);
begin
...
procedure TdxBreadcrumbEditPathEditorProperties.SetRecentPathsMaxCount
  (AValue: Integer);
begin
  AValue := Max(0, AValue);
...
function TdxCustomBreadcrumbEditProperties.CreateButtons
  : TdxBreadcrumbEditButtons;
begin
  Result := TdxBreadcrumbEditButtons.Create(Self,
    TdxBreadcrumbEditButtons.GetButtonClass);
end;

function TdxCustomBreadcrumbEditProperties.CreatePathEditorProperties
  : TdxBreadcrumbEditPathEditorProperties;
begin
  Result := TdxBreadcrumbEditPathEditorProperties.Create(Self);
end;

function TdxCustomBreadcrumbEditProperties.CreateProgressBarProperties
  : TdxBreadcrumbEditProgressBarProperties;
begin
...
procedure TdxCustomBreadcrumbEditProperties.Notification(AComponent: TComponent;
...
procedure TdxCustomBreadcrumbEditProperties.PropertiesChanged(Sender: TObject;
  AChanges: TdxBreadcrumbEditChanges);
begin
  Changed(AChanges);
end;
...
procedure TdxCustomBreadcrumbEditProperties.SetButtons
  (AValue: TdxBreadcrumbEditButtons);
begin
  FButtons.Assign(AValue);
end;

procedure TdxCustomBreadcrumbEditProperties.SetButtonImages
  (AValue: TCustomImageList);
begin
  cxSetImageList(AValue, FButtonImages, FButtonImagesChangeLink,
    Owner as TComponent);
end;

procedure TdxCustomBreadcrumbEditProperties.SetDropDownIndent
  (AValue: TdxBreadcrumbEditDropDownIndent);
begin
...
constructor TdxBreadcrumbEditPartCustomViewInfo.Create
  (AOwner: TdxBreadcrumbEditViewInfo);
begin
  inherited Create;
  FOwner := AOwner;
...
procedure TdxBreadcrumbEditPartCustomViewInfo.CalculateHitTest
...
function TdxBreadcrumbEditPartCustomViewInfo.PlaceAt(var R: TRect;
  AWidth: Integer; AAtRightSide: Boolean): TRect;
begin
...
function TdxBreadcrumbEditPartCustomViewInfo.IsViewItemValid
...
procedure TdxBreadcrumbEditPartCustomViewInfo.UpdateViewItemsState
  (AInfo: TdxBreadcrumbEditHitTestInfo);
var
  I: Integer;
begin
...
function TdxBreadcrumbEditPartCustomViewInfo.GetPainter
  : TcxCustomLookAndFeelPainter;
begin
  Result := Owner.GetPainter;
end;

function TdxBreadcrumbEditPartCustomViewInfo.GetProperties
  : TdxCustomBreadcrumbEditProperties;
begin
...
function TdxBreadcrumbEditPartCustomViewInfo.GetUseRightToLeftAlignment
  : Boolean;
begin
  Result := Control.UseRightToLeftAlignment;
end;

function TdxBreadcrumbEditPartCustomViewInfo.GetViewItem(Index: Integer)
  : TdxBreadcrumbEditViewItem;
begin
...
procedure TdxBreadcrumbEditButtonsPartViewInfo.Calculate(R: TRect);
  ...
  function GetButtonWidth(AButtonViewItem
    : TdxBreadcrumbEditButtonViewItem): Integer;
  begin
...
begin
  ...
  begin
    ...
    AButtonViewItem.Calculate(PlaceAt(R, GetButtonWidth(AButtonViewItem),
      AUseRTLAlignment));
  end;

  if ViewItemCount > 0 then
    FSeparatorRect :=
      PlaceAt(R, Painter.BreadcrumbEditScaledButtonAreaSeparatorSize
      (ScaleFactor), AUseRTLAlignment)
  else
...
begin
  ...
  Painter.DrawBreadcrumbEditScaledButtonAreaSeparator(ACanvas, SeparatorRect,
    Owner.State, ScaleFactor);
end;
...
begin
  Result := ScaleFactor.Apply(dxBreadcrumbEditDefaultImageSize) +
    cxMarginsHeight(Painter.BreadcrumbEditScaledButtonContentOffsets(True, True,
    ScaleFactor));
end;

procedure TdxBreadcrumbEditDropDownButtonViewItem.Click
  (APart: Integer = nvipControl);
begin
  if APart = nvipControl then
    Controller.PathEditingController.DropDown;
end;

procedure TdxBreadcrumbEditDropDownButtonViewItem.DrawBackground
  (ACanvas: TcxCanvas);
begin
  Painter.DrawBreadcrumbEditScaledDropDownButton(ACanvas, Bounds, State, False,
    ScaleFactor);
end;

procedure TdxBreadcrumbEditDropDownButtonViewItem.DrawContent
  (ACanvas: TcxCanvas);
begin
  Painter.DrawBreadcrumbEditScaledDropDownButtonGlyph(ACanvas, Bounds, State,
    False, ScaleFactor);
end;

{ TdxBreadcrumbEditNodesAreaPartViewInfo }

constructor TdxBreadcrumbEditNodesAreaPartViewInfo.Create
  (AOwner: TdxBreadcrumbEditViewInfo);
begin
  inherited Create(AOwner);
...
begin
  Result := Max(inherited CalculateAutoHeight,
    DropDownButton.CalculateAutoHeight);
  Result := Max(Result, GetDefaultImageHeight + 2 *
    dxBreadcrumbEditImageBorder);
end;

procedure TdxBreadcrumbEditNodesAreaPartViewInfo.CalculateDropDownButton
  (var R: TRect);
var
  AWidth: Integer;
begin
  if Properties.PathEditor.Enabled and Properties.PathEditor.RecentPathsEnabled
  then
...
procedure TdxBreadcrumbEditNodesAreaPartViewInfo.CalculateHitTest
  (AInfo: TdxBreadcrumbEditHitTestInfo);
begin
...
procedure TdxBreadcrumbEditNodesAreaPartViewInfo.CalculateImageRect
  (var R: TRect);
var
  AImageSize: TSize;
begin
  ...
  begin
    ...
    FImageRect := cxRectCenter
      (PlaceAt(R, AImageSize.cx + 2 * dxBreadcrumbEditImageBorder,
      not UseRightToLeftAlignment), AImageSize);
  end
  else
...
begin
  ...
  begin
    ...
    ANodeViewItem.Calculate(PlaceAt(R, ANodeViewItem.Width,
      not AUseRightToLeftAlignment));
  end;
end;

procedure TdxBreadcrumbEditNodesAreaPartViewInfo.CalculateNodesWidths
  ...
  function ReduceNodeViewItemWidth(ANodeViewItem
    : TdxBreadcrumbEditNodeViewItem): Boolean;
  begin
...
begin
  ...
  AIndex := 0;
  while (GetContentWidth > AContentWidth) and
    (AIndex + dxBreadcrumbEditMinVisibleNodesCount < ViewItemCount) do
  begin
...
function TdxBreadcrumbEditNodesAreaPartViewInfo.CreateDropDownButton
  : TdxBreadcrumbEditViewItem;
begin
...
procedure TdxBreadcrumbEditNodesAreaPartViewInfo.DrawImage(ACanvas: TcxCanvas;
  const ARect: TRect; AImageIndex: TcxImageIndex);
begin
...
procedure TdxBreadcrumbEditNodesAreaPartViewInfo.InternalDraw
  (ACanvas: TcxCanvas);
begin
...
function TdxBreadcrumbEditNodesAreaPartViewInfo.GetFirstViewItem
  : TdxBreadcrumbEditNodeViewItem;
begin
  if ViewItemCount > 0 then
    Result := ViewItems[0]
...
function TdxBreadcrumbEditNodesAreaPartViewInfo.GetSelectedNodeViewItem
  : TdxBreadcrumbEditNodeViewItem;
begin
  if ViewItemCount > 0 then
...
function TdxBreadcrumbEditNodesAreaPartViewInfo.GetViewItem(Index: Integer)
  : TdxBreadcrumbEditNodeViewItem;
begin
...
begin
  FBounds := cxRectContent(R, Painter.BreadcrumbEditScaledProgressChunkPadding
    (ScaleFactor));
  FOverlaySize := Painter.BreadcrumbEditScaledProgressChunkOverlaySize
    (ScaleFactor);
  ResetOverlayPosition;
end;

procedure TdxBreadcrumbEditProgressBarPartViewInfo.DrawContent
  (ACanvas: TcxCanvas);
var
  AChunkRect: TRect;
begin
  ...
  begin
    ...
    try
      ...
      Painter.DrawBreadcrumbEditScaledProgressChunk(ACanvas, AChunkRect,
        ScaleFactor);
      Painter.DrawBreadcrumbEditScaledProgressChunkOverlay(ACanvas, OverlayRect,
        ScaleFactor);
    finally
      ACanvas.RestoreClipRegion;
    end;
...
procedure TdxBreadcrumbEditProgressBarPartViewInfo.InternalDraw
  (ACanvas: TcxCanvas);
var
  ABitmap: TcxBitmap32;
begin
  ...
  begin
    ...
    try
      ...
      ABitmap.MakeOpaque;
      cxAlphaBlend(ACanvas.Handle, ABitmap, Bounds, ABitmap.ClientRect,
        False, Opacity);
    finally
      ABitmap.Free;
    end;
...
function TdxBreadcrumbEditViewInfo.CreateButtonsViewInfo
  : TdxBreadcrumbEditButtonsPartViewInfo;
begin
  Result := TdxBreadcrumbEditButtonsPartViewInfo.Create(Self);
end;

function TdxBreadcrumbEditViewInfo.CreateHitTestInfo
  : TdxBreadcrumbEditHitTestInfo;
begin
  Result := TdxBreadcrumbEditHitTestInfo.Create;
end;

function TdxBreadcrumbEditViewInfo.CreateNodesAreaViewInfo
  : TdxBreadcrumbEditNodesAreaPartViewInfo;
begin
  Result := TdxBreadcrumbEditNodesAreaPartViewInfo.Create(Self);
end;

function TdxBreadcrumbEditViewInfo.CreateProgressBarViewInfo
  : TdxBreadcrumbEditProgressBarPartViewInfo;
begin
  Result := TdxBreadcrumbEditProgressBarPartViewInfo.Create(Self);
end;

procedure TdxBreadcrumbEditViewInfo.DoCalculateHitTest
  (AInfo: TdxBreadcrumbEditHitTestInfo);
begin
...
begin
  ACanvas.SaveClipRegion;
  try
    Painter.DrawBreadcrumbEditBorders(ACanvas, Bounds,
      Properties.Borders, State);
...
function TdxBreadcrumbEditViewInfo.IsViewItemValid
  (AItem: TdxBreadcrumbEditViewItem): Boolean;
begin
  Result := ButtonsViewInfo.IsViewItemValid(AItem) or
    NodesAreaViewInfo.IsViewItemValid(AItem);
end;
...
function TdxBreadcrumbEditViewInfo.GetProperties
  : TdxCustomBreadcrumbEditProperties;
begin
...
constructor TdxBreadcrumbEditProgressBarController.Create
  (AController: TdxBreadcrumbEditController);
begin
  inherited Create;
...
procedure TdxBreadcrumbEditProgressBarController.Fade(AFramesCount: Integer;
  AFadeOut: Boolean);
const
  StatesMap: array [Boolean] of TdxBreadcrumbEditProgressBarFadingState =
    (bcpfsFadeIn, bcpfsFadeOut);
begin
  if FadingState = bcpfsNone then
  begin
    FFadingState := StatesMap[AFadeOut];
    if dxFader.IsReady and ViewInfo.Painter.BreadcrumbEditIsFadingSupports and
      (AFramesCount > 0) then
    begin
      FFadingFrameIndex := 0;
...
procedure TdxBreadcrumbEditProgressBarController.
  ProcessCancelEffectAnimationStep(Sender: TObject);
...
const
  Direction: array [TdxBreadcrumbEditProgressBarCancelEffect]
    of Single = (0, 1, -1);
begin
  ...
  begin
    ViewInfo.Progress := ViewInfo.Progress + Direction[Properties.CancelEffect]
      * dxBreadcrumbEditProgressFillingDelta;
    ViewInfo.Invalidate;
  end;
end;

procedure TdxBreadcrumbEditProgressBarController.ProcessFadeStep
  (Sender: TObject);
begin
...
procedure TdxBreadcrumbEditProgressBarController.ProcessOverlayAnimationStep
  (Sender: TObject);
begin
  if FOverlayAnimationRestartDelayCount = 0 then
  begin
    ViewInfo.OverlayPosition := ViewInfo.OverlayPosition +
      OverlayAnimationOffset;
    if not cxRectIntersect(ViewInfo.OverlayRect, ViewInfo.ChunkRect) then
    begin
      FOverlayAnimationRestartDelayCount :=
        Round(Properties.AnimationRestartDelay /
        OverlayAnimationTimer.Interval);
...
begin
  if Properties.MaxValue > Properties.MinValue then
    Progress := 100 * (Properties.Position - Properties.MinValue) /
      (Properties.MaxValue - Properties.MinValue)
  else
    Progress := 0;
end;

function TdxBreadcrumbEditProgressBarController.
  GetCancelEffectAnimationActive: Boolean;
begin
...
function TdxBreadcrumbEditProgressBarController.
  GetIsOverlayAnimationEnabled: Boolean;
begin
...
function TdxBreadcrumbEditProgressBarController.
  GetOverlayAnimationOffset: Integer;
var
...
function TdxBreadcrumbEditProgressBarController.GetOverlayAnimationTimerInterval
  : Cardinal;
var
  AAnimationSpeed: Cardinal;
begin
...
function TdxBreadcrumbEditProgressBarController.GetProperties
  : TdxBreadcrumbEditProgressBarProperties;
begin
  Result := Controller.ViewInfo.Properties.ProgressBar;
end;

function TdxBreadcrumbEditProgressBarController.GetViewInfo
  : TdxBreadcrumbEditProgressBarPartViewInfo;
begin
...
procedure TdxBreadcrumbEditProgressBarController.SetProgress(AValue: Single);
  ...
  begin
    Result := (FadingState = bcpfsNone) and not CancelEffectAnimationActive and
      (ViewInfo.Opacity = 0);
  end;
  ...
  begin
    ...
    else if not IsAnimationOnResetValueActive then
    begin
...
constructor TdxBreadcrumbEditNodeDropDownMenu.Create
  (AController: TdxBreadcrumbEditController);
begin
...
function TdxBreadcrumbEditNodeDropDownMenu.CreateInnerListBox
  : TdxCustomDropDownInnerListBox;
begin
  Result := TdxBreadcrumbEditDropDownInnerListBox.Create(nil);
end;

procedure TdxBreadcrumbEditNodeDropDownMenu.DoCloseUp(AClosedViaKeyboard
  : Boolean);
begin
  PostMessage(Controller.Handle, DXM_BREADCRUMBEDIT_CLOSEPOPUPWINDOW,
    Ord(AClosedViaKeyboard), 0);
end;
...
begin
  ...
  InnerListBox.LookAndFeel.MasterLookAndFeel :=
    Controller.Control.GetLookAndFeel;
...
procedure TdxBreadcrumbEditNodeDropDownMenu.
  InternalCalculateVerticalDirectionPosition(var APosition: TPoint;
...
begin
  ...
  begin
    AOffset := Controller.DropDownMenuOwner.GetDelimiterSize +
      ScaleFactor.Apply(dxBreadcrumbEditDefaultDropDownIndentValue);
    if UseRightToLeftAlignment then
    begin
    ...
    inherited InternalCalculateVerticalDirectionPosition(APosition,
      AOrigin, ASize);
end;

function TdxBreadcrumbEditNodeDropDownMenu.GetInnerListBox
  : TdxBreadcrumbEditDropDownInnerListBox;
begin
...
function TdxBreadcrumbEditDropDownInnerListBox.CalculateContentSize
  (AMaxVisibleItemsCount: Integer): TSize;
begin
...
function TdxBreadcrumbEditDropDownInnerListBox.ItemAtPos(const APoint: TPoint;
  AExistOnly: Boolean = False): Integer;
var
...
procedure TdxBreadcrumbEditDropDownInnerListBox.DoSelectItem
  (ASelectedViaKeyboard: Boolean);
begin
  if Items.IsValidIndex(ItemIndex) then
    inherited DoSelectItem(ASelectedViaKeyboard)
  else if IsRootAlwaysVisible and (RootItemState = cxbsPressed) then
  begin
...
function TdxBreadcrumbEditDropDownInnerListBox.GetHasSeparator
  (AItem: TdxCustomListBoxItem): Boolean;
begin
...
function TdxBreadcrumbEditDropDownInnerListBox.IsDefaultItem
  (AItem: TdxCustomListBoxItem): Boolean;
begin
  if AItem <> RootItem then
...
function TdxBreadcrumbEditDropDownInnerListBox.ProcessNavigationKey
  (var Key: Word; Shift: TShiftState): Boolean;
var
  AIsMoveToRoot, AIsMoveFromRoot: Boolean;
begin
  AIsMoveToRoot := ((ItemIndex = 0) and (Key = VK_UP)) or
    ((ItemIndex = (Items.Count - 1)) and (Key = VK_DOWN));
...
procedure TdxBreadcrumbEditDropDownInnerListBox.SetRootItemState
...
function TdxBreadcrumbEditPathEditor.
  CanShowValidationErrorOnPostEditValue: Boolean;
begin
  Result := True;
end;

function TdxBreadcrumbEditPathEditor.CreateAutoCompleteWindow
  : TdxBreadcrumbEditAutoCompleteWindow;
begin
...
procedure TdxBreadcrumbEditPathEditor.DoAutoCompleteSuggestionsChanged
  (Sender: TObject);
begin
...
procedure TdxBreadcrumbEditPathEditor.DoEditKeyDown(var Key: Word;
  Shift: TShiftState);
begin
  case Key of
    VK_RETURN:
...
begin
  ADefaultWidth := Style.LookAndFeel.Painter.
    BreadcrumbEditScaledDropDownButtonWidth(ScaleFactor);
...
begin
  if Assigned(OnPopulateAutoCompleteSuggestions) then
    OnPopulateAutoCompleteSuggestions(Self, EditingValue,
...
procedure TdxBreadcrumbEditPathEditor.PreviewEditValue(const AEditValue: string;
  ASelectAll: Boolean);
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      FAutoCompleteWindow.DisplayRowsCount :=
        Properties.AutoCompleteDropDownRows;
      FAutoCompleteWindow.BiDiMode := BiDiMode;
    end;
    AutoCompleteWindow.Adjustable :=
      not AutoCompleteWindowCustomizedSizeAssigned;
...
function TdxBreadcrumbEditPathEditor.GetActiveProperties
  : TdxBreadcrumbEditPathInplaceEditorProperties;
begin
  Result := TdxBreadcrumbEditPathInplaceEditorProperties
    (inherited ActiveProperties);
end;

class function TdxBreadcrumbEditPathEditor.GetDataBindingClass
  : TcxEditDataBindingClass;
begin
  Result := TdxBreadcrumbEditPathEditorDataBinding;
end;

function TdxBreadcrumbEditPathEditor.
  GetIsAutoCompleteWindowCustomizedSizeAssigned: Boolean;
begin
  Result := (AutoCompleteWindowCustomizedSize.cx > 0) and
    (AutoCompleteWindowCustomizedSize.cy > 0);
end;

function TdxBreadcrumbEditPathEditor.GetLookupData
  : TdxBreadcrumbEditPathEditorLookupData;
begin
  Result := TdxBreadcrumbEditPathEditorLookupData(inherited LookupData);
end;

function TdxBreadcrumbEditPathEditor.GetProperties
  : TdxBreadcrumbEditPathInplaceEditorProperties;
begin
  Result := TdxBreadcrumbEditPathInplaceEditorProperties(inherited Properties);
end;

class function TdxBreadcrumbEditPathEditor.GetPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TdxBreadcrumbEditPathInplaceEditorProperties;
end;

function TdxBreadcrumbEditPathEditor.GetScrollLookupDataList
  (AScrollCause: TcxEditScrollCause): Boolean;
begin
...
procedure TdxBreadcrumbEditPathEditor.SelectAutoCompleteWindowItemHandler
  (Sender: TObject);
begin
...
procedure TdxBreadcrumbEditPathEditor.SetAutoCompleteSuggestions
  (AValue: TStringList);
begin
  FAutoCompleteSuggestions.Assign(AValue);
end;

procedure TdxBreadcrumbEditPathEditor.StoreAutoCompleteWindowSize
  (Sender: TObject);
begin
...
procedure TdxBreadcrumbEditPathEditorViewInfo.DrawEditButton(ACanvas: TcxCanvas;
...
begin
  ...
  Painter.DrawBreadcrumbEditScaledDropDownButton(ACanvas, AButtonInfo.Bounds,
    StatesMap[AButtonInfo.Data.State], True, ScaleFactor);
...
begin
  ...
  if Images <> nil then
    cxDrawImage(ACanvas.Handle, ImageRect, ImageRect, nil, Images, ImageIndex,
      idmNormal);
end;
...
procedure TdxBreadcrumbEditPathEditorViewInfo.UpdateStyle
...
begin
  inherited Calculate(ACanvas, ABounds, P, Button, Shift, ViewInfo,
    AIsMouseEvent);
  ...
  begin
    AImageAreaSize := dxGetImageSize(AViewInfo.Images, ScaleFactor).cx + 2 *
      dxBreadcrumbEditImageBorder;
    AViewInfo.ImageRect := cxRectSetWidth(AViewInfo.ClientRect, AImageAreaSize);
    AViewInfo.ImageRect := cxRectCenter(AViewInfo.ImageRect,
      dxGetImageSize(AViewInfo.Images, ScaleFactor));
    if UseRightToLeftAlignment then
    begin
      AViewInfo.ImageRect := TdxRightToLeftLayoutConverter.ConvertRect
...
function TdxBreadcrumbEditPathEditorViewData.GetProperties
  : TdxBreadcrumbEditPathInplaceEditorProperties;
begin
  Result := TdxBreadcrumbEditPathInplaceEditorProperties(inherited Properties);
end;
...
procedure TdxBreadcrumbEditPathEditorListBox.DrawItem(Index: Integer;
...
begin
  ...
  begin
    ...
    begin
      ...
      if Images <> nil then
        cxDrawImage(Canvas.Handle, AImageRect, AImageRect, nil, Images,
          ImageIndex[Index], idmNormal);
      if UseRightToLeftAlignment then
...
function TdxBreadcrumbEditPathEditorListBox.GetImageIndex(AItemIndex: Integer)
  : TcxImageIndex;
begin
...
begin
  ...
  begin
    ...
    Result := cxRectSetWidth(R, 2 * dxBreadcrumbEditImageBorder +
      AImageSize.cx);
...
function TdxBreadcrumbEditPathEditorListBox.GetItemHeight
  (AIndex: Integer = -1): Integer;
begin
  Result := inherited GetItemHeight(AIndex);
  if Images <> nil then
    Result := Max(Result, 2 * dxBreadcrumbEditImageBorder +
      dxGetImageSize(Images, ScaleFactor).cy);
end;
...
function TdxBreadcrumbEditPathEditorListBox.GetProperties
  : TdxBreadcrumbEditPathInplaceEditorProperties;
begin
...
function TdxBreadcrumbEditPathEditorLookupData.GetListBoxClass
  : TcxCustomEditListBoxClass;
begin
...
constructor TdxBreadcrumbEditPathInplaceEditorProperties.Create
  (AOwner: TPersistent);
begin
  inherited Create(AOwner);
  FAutoCompleteDropDownRows := dxBreadcrumbEditDefaultAutoCompleteDropDownRows;
...
class function TdxBreadcrumbEditPathInplaceEditorProperties.GetLookupDataClass
  : TcxInterfacedPersistentClass;
begin
  Result := TdxBreadcrumbEditPathEditorLookupData;
end;

class function TdxBreadcrumbEditPathInplaceEditorProperties.GetViewDataClass
  : TcxCustomEditViewDataClass;
begin
  Result := TdxBreadcrumbEditPathEditorViewData;
end;

class function TdxBreadcrumbEditPathInplaceEditorProperties.GetViewInfoClass
  : TcxContainerViewInfoClass;
begin
  Result := TdxBreadcrumbEditPathEditorViewInfo;
end;

procedure TdxBreadcrumbEditPathInplaceEditorProperties.SetAutoComplete
  (AValue: Boolean);
begin
  if AValue <> FAutoComplete then
  begin
...
procedure TdxBreadcrumbEditPathInplaceEditorProperties.
  SetAutoCompleteDropDownRows(AValue: Integer);
begin
  AValue := Max(AValue, 1);
  if AValue <> FAutoCompleteDropDownRows then
  begin
...
procedure TdxBreadcrumbEditPathInplaceEditorProperties.SetCanShowDropDown
  (AValue: Boolean);
begin
...
procedure TdxBreadcrumbEditPathInplaceEditorProperties.SetImageIndex
...
constructor TdxBreadcrumbEditPathEditingController.Create
  (AController: TdxBreadcrumbEditController);
begin
  inherited Create;
  FController := AController;
...
procedure TdxBreadcrumbEditPathEditingController.AddToRecentPaths
  (ANode: TdxBreadcrumbEditNode);
var
  AIndex: Integer;
begin
...
function TdxBreadcrumbEditPathEditingController.CanAddToRecentPaths
  (ANode: TdxBreadcrumbEditNode): Boolean;
begin
  Result := Properties.RecentPathsEnabled and
    Properties.RecentPathsAutoPopulate;
end;
...
function TdxBreadcrumbEditPathEditingController.DoPathEntered
...
{$ENDIF}
      ...
      PathEditor.OnPopulateAutoCompleteSuggestions :=
        PathEditorPopulateAutoCompleteSuggestions;
...
procedure TdxBreadcrumbEditPathEditingController.PathEditorEnterHandler
  (Sender: TObject);
begin
  Controller.UpdateState;
end;

procedure TdxBreadcrumbEditPathEditingController.PathEditorExitHandler
  (Sender: TObject);
begin
  ReleasePathEditor;
end;

procedure TdxBreadcrumbEditPathEditingController.
  PathEditorPopulateAutoCompleteSuggestions(Sender: TObject;
  const APath: string; ASuggestions: TStringList);
begin
  PopulateSuggestions(APath, ASuggestions);
end;

procedure TdxBreadcrumbEditPathEditingController.PathEditorPostEditValueHandler
  (Sender: TObject);
var
  ANewPath: string;
begin
...
function TdxBreadcrumbEditPathEditingController.IsSubPath(const ABasePath,
  APathForCheck: string): Boolean;
begin
  Result := (Length(APathForCheck) > Length(ABasePath)) and
    SameText(ABasePath, Copy(APathForCheck, 1, Length(ABasePath)));
end;
...
procedure TdxBreadcrumbEditPathEditingController.PopulateSuggestions
  (const APath: string; ASuggestions: TStringList);
  ...
  procedure PopulateSuggestionsFromNodeChildren(const ACompletePath: string;
    ANode: TdxBreadcrumbEditNode);
  var
        ...
        begin
          ...
          begin
            ...
            if AChildNode.DisplayName <> '' then
              AddSuggestion(APath, ACompletePath + AChildNode.DisplayName,
                ASuggestions);
          end;
        end;
      end;
...
begin
  ...
  begin
    ...
    ACompletePath := Copy(APath, 1,
      LastDelimiter(Properties.PathDelimiter, APath));
    PopulateSuggestionsFromNodeChildren(ACompletePath,
      GetCurrentNode(ACompletePath));
    ASuggestions.Sort;
  end;
...
procedure TdxBreadcrumbEditPathEditingController.PopulateRecentPaths
  (AItems: TStrings);
var
...
begin
  ...
  PathEditor.Properties.AutoCompleteDropDownRows :=
    Properties.AutoCompleteDropDownRows;
...
function TdxBreadcrumbEditPathEditingController.GetProperties
  : TdxBreadcrumbEditPathEditorProperties;
begin
  Result := ViewInfo.Properties.PathEditor;
end;

function TdxBreadcrumbEditPathEditingController.GetRecentPaths
  : TdxBreadcrumbEditRecentPaths;
begin
  Result := Properties.RecentPaths;
end;

function TdxBreadcrumbEditPathEditingController.GetSelected
  : TdxBreadcrumbEditNode;
begin
  Result := Controller.Selected;
end;

function TdxBreadcrumbEditPathEditingController.GetViewInfo
  : TdxBreadcrumbEditViewInfo;
begin
...
constructor TdxBreadcrumbEditController.Create
  (AViewInfo: TdxBreadcrumbEditViewInfo);
begin
  inherited Create;
  FViewInfo := AViewInfo;
...
function TdxBreadcrumbEditController.CanClickAt
  (AViewItem: TdxBreadcrumbEditViewItem): Boolean;
begin
  Result := (AViewItem <> nil) and AViewItem.GetIsEnabled;
end;

procedure TdxBreadcrumbEditController.Changed(const AChanges
  : TdxBreadcrumbEditChanges);
var
...
begin
  Result := (FocusedViewItem = nil) or
    (FocusedViewItem is TdxBreadcrumbEditNodeViewItem) and
    (TdxBreadcrumbEditNodeViewItem(FocusedViewItem).Node = Root);
end;

function TdxBreadcrumbEditController.CanSelectNode
  (ANode: TdxBreadcrumbEditNode): Boolean;
begin
  Result := (ANode <> nil) and (ANode.HasAsParent(Root) or (ANode = Root));
end;

function TdxBreadcrumbEditController.CreateDropDownMenuWindow
  : TdxBreadcrumbEditNodeDropDownMenu;
begin
  Result := TdxBreadcrumbEditNodeDropDownMenu.Create(Self);
end;

function TdxBreadcrumbEditController.CreatePathEditingController
  : TdxBreadcrumbEditPathEditingController;
begin
  Result := TdxBreadcrumbEditPathEditingController.Create(Self);
end;

function TdxBreadcrumbEditController.CreateProgressBarController
  : TdxBreadcrumbEditProgressBarController;
begin
...
procedure TdxBreadcrumbEditController.DoDeleteNode
  (ANode: TdxBreadcrumbEditNode);

  function GetNextSelectableNode(ANode: TdxBreadcrumbEditNode)
    : TdxBreadcrumbEditNode;
  begin
    Result := ANode;
...
procedure TdxBreadcrumbEditController.DoNodeDropDownPopup
  (ANode: TdxBreadcrumbEditNode);
var
  AEvents: IdxBreadcrumbEditEvents;
begin
...
function TdxBreadcrumbEditController.DoSelectPath(const APath: string;
  ANode: TdxBreadcrumbEditNode): Boolean;
begin
...
function TdxBreadcrumbEditController.FindSelectableViewItem
  (AItem: TdxBreadcrumbEditViewItem; AGoForward: Boolean)
  : TdxBreadcrumbEditViewItem;
var
  AIndex: Integer;
  AList: TList;
...
begin
  ...
  else if not IsNodeDropDownMenuWindowActive then
    FocusedViewItem := nil;

  UpdateState;
end;

function TdxBreadcrumbEditController.FindNodeByPath(APath: string)
  : TdxBreadcrumbEditNode;
var
  ANodeName: string;
begin
...
function TdxBreadcrumbEditController.FindRootNodeForPath(var APath: string;
  out ANode: TdxBreadcrumbEditNode): Boolean;
var
  ANodeName: string;
begin
  ...
  begin
    if Root.Compare(ANodeName) then
      ANode := Root
    else if (Selected = nil) or not Selected.FindNode(ANodeName, ANode) then
...
procedure TdxBreadcrumbEditController.KeyDown(var Key: Word;
  Shift: TShiftState);
begin
  case Key of
    VK_F4:
    ...
    VK_RETURN:
      ...
      else if CanClickAt(FocusedViewItem) then
        FocusedViewItem.Click;
  end;
end;

procedure TdxBreadcrumbEditController.MouseDown(AButton: TMouseButton;
  const P: TPoint; AShift: TShiftState);
begin
  ...
  begin
    ...
    if HitTestInfo.ViewItem = nil then
      PathEditingController.OpenPathEditor;
    if (HitTestInfo.ViewItemPart = nvipDelimiter) and
      not IsNodeDropDownMenuWindowActive and
      (HitTestInfo.ViewItem is TdxBreadcrumbEditNodeViewItem) then
      ShowNodeDropDownMenu(TdxBreadcrumbEditNodeViewItem(HitTestInfo.ViewItem));
    PressedViewItem := HitTestInfo.ViewItem;
  end;
end;

procedure TdxBreadcrumbEditController.MouseMove(const P: TPoint;
  AShift: TShiftState);
begin
...
procedure TdxBreadcrumbEditController.MouseUp(AButton: TMouseButton;
  const P: TPoint; AShift: TShiftState);
begin
...
function TdxBreadcrumbEditController.ParsePath(var ANodeName,
  ASubPath: string): Boolean;
var
  APathDelimPosition: Integer;
begin
  Result := ASubPath <> '';
  APathDelimPosition := Pos(PathEditingController.Properties.PathDelimiter,
    ASubPath);
...
procedure TdxBreadcrumbEditController.ProcessButtonClick
  (AButton: TdxBreadcrumbEditButton);
var
  AEvents: IdxBreadcrumbEditEvents;
begin
  ...
  else if Supports(Control, IdxBreadcrumbEditEvents, AEvents) then
    AEvents.ProcessButtonClick(AButton);

  UpdateHitTest;
end;

procedure TdxBreadcrumbEditController.ProcessChanges(const AChanges
  : TdxBreadcrumbEditChanges);
begin
...
function TdxBreadcrumbEditController.SelectPath
  (ANode: TdxBreadcrumbEditNode): Boolean;
begin
...
procedure TdxBreadcrumbEditController.SelectPathViaDropDownMenu
  (AItem: TdxBreadcrumbEditNode);
begin
...
begin
  ...
  begin
    dxMessagesController.KillMessages(Handle,
...
procedure TdxBreadcrumbEditController.ValidateItem
  (var AItem: TdxBreadcrumbEditViewItem);
begin
...
procedure TdxBreadcrumbEditController.ValidatePath(const APath: string;
  var ANode: TdxBreadcrumbEditNode);
var
  AError: Boolean;
  AErrorText: string;
begin
  ...
  if AError then
    AErrorText :=
      Format(cxGetResourceString(@sdxBreadcrumbEditInvalidPath), [APath]);
...
begin
  ...
  begin
    ViewInfo.CalculateHitTest(ControlContainer.ScreenToClient
      (GetMouseCursorPos));
...
function TdxBreadcrumbEditController.GetHitTestInfo
  : TdxBreadcrumbEditHitTestInfo;
begin
...
function TdxBreadcrumbEditController.GetSelectedNodeViewItem
  : TdxBreadcrumbEditNodeViewItem;
begin
  Result := ViewInfo.NodesAreaViewInfo.SelectedNodeViewItem;
end;

procedure TdxBreadcrumbEditController.SetDropDownMenuOwner
  (AValue: TdxBreadcrumbEditNodeViewItem);
begin
  FDropDownMenuOwner := AValue;
  ViewInfo.UpdateViewItemStates;
end;

procedure TdxBreadcrumbEditController.SetFocusedViewItem
  (AValue: TdxBreadcrumbEditViewItem);
begin
...
procedure TdxBreadcrumbEditController.SetPressedViewItem
  (AValue: TdxBreadcrumbEditViewItem);
begin
...
procedure TdxBreadcrumbEditController.SetSelected
  (AValue: TdxBreadcrumbEditNode);
begin
...
function TdxCustomBreadcrumbEdit.CanAutoSize(var NewWidth,
...
function TdxCustomBreadcrumbEdit.CanCollapse
...
procedure TdxCustomBreadcrumbEdit.ChangeScaleEx(M: Integer; D: Integer;
  isDpiChange: Boolean);
begin
  inherited;
...
function TdxCustomBreadcrumbEdit.CreateProperties
  : TdxCustomBreadcrumbEditProperties;
begin
...
procedure TdxCustomBreadcrumbEdit.DrawBackground(ACanvas: TcxCanvas;
  const R: TRect);
begin
  if Transparent then
...
function TdxCustomBreadcrumbEdit.GetNodeClass(ARelativeNode: TdxTreeCustomNode)
  : TdxTreeCustomNodeClass;
begin
...
procedure TdxCustomBreadcrumbEdit.TreeNotification(ASender: TdxTreeCustomNode;
  ANotification: TdxTreeNodeNotifications);
const
  NotificationsMap: array [TdxTreeNodeNotification]
    of TdxBreadcrumbEditChanges = ([bcecNodes, bcecLayout], [bcecLayout]);
var
  AChanges: TdxBreadcrumbEditChanges;
...
procedure TdxCustomBreadcrumbEdit.LookAndFeelChanged(Sender: TcxLookAndFeel;
...
procedure TdxCustomBreadcrumbEdit.MouseDown(Button: TMouseButton;
...
procedure TdxCustomBreadcrumbEdit.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TdxCustomBreadcrumbEdit.NodeDropDownPopup
  (ANode: TdxBreadcrumbEditNode);
begin
...
procedure TdxCustomBreadcrumbEdit.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
...
procedure TdxCustomBreadcrumbEdit.PropertiesChanged(Sender: TObject;
  AChanges: TdxBreadcrumbEditChanges);
begin
  Changed(AChanges);
end;

procedure TdxCustomBreadcrumbEdit.PathEntered(var ANewPath: string;
...
procedure TdxCustomBreadcrumbEdit.ProcessButtonClick
  (AButton: TdxBreadcrumbEditButton);
begin
...
begin
  if Assigned(OnPathSelected) then
    OnPathSelected(Self);
end;
...
begin
  ...
  begin
    Message.HintInfo^.HintStr :=
      GetShortHint(ViewInfo.HitTestInfo.ViewItem.HintText);
...
function TdxCustomBreadcrumbEdit.GetProperties
  : TdxCustomBreadcrumbEditProperties;
begin
  Result := FProperties;
end;
...
procedure TdxCustomBreadcrumbEdit.SetProperties
  (AValue: TdxCustomBreadcrumbEditProperties);
begin
...
begin
  ...
  try
    ...
    if AVersion <> dxBreadcrumbEditStreamVersion then
      raise EdxBreadcrumbEditValidationError.CreateFmt
        (cxGetResourceString(@sdxBreadcrumbEditInvalidStreamVersion),
        [AVersion]);
