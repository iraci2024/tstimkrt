...
uses
  ...
  dxCore, cxClasses, cxGraphics, dxForms, cxControls, cxLookAndFeels,
  cxLookAndFeelPainters, cxContainer, cxEdit, dxCameraControl;
...
begin
  btnSnapshot.Enabled := TdxCameraControlAccess(ccCamera).State
    in [ccsRunning, ccsPaused];
end;
