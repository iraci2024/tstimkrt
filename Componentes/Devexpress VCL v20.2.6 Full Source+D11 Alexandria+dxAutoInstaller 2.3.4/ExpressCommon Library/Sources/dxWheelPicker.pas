...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Windows, Classes, StdCtrls, Graphics, Controls, Messages, Forms,
  Buttons,
  dxCore, dxCoreClasses, cxClasses, cxGraphics, dxTouch, dxGDIPlusClasses,
...
type
  ...
  TdxCustomWheelPickerItemViewInfoClass = class of
    TdxCustomWheelPickerItemViewInfo;
  TdxCustomWheelPickerWheelViewInfoClass = class of
  ...
  protected
    procedure DrawItem(ACanvas: TcxCanvas; const R: TRect;
  ...
  public
    constructor Create(AWheelViewInfo
      : TdxCustomWheelPickerWheelViewInfo); virtual;
    procedure Invalidate; override;

    property Bounds: TRect read GetBounds;
    property WheelViewInfo: TdxCustomWheelPickerWheelViewInfo
      read FWheelViewInfo;
  end;
  ...
  protected
    ...
    function GetHitTest(const APoint: TPoint)
      : TdxCustomWheelPickerPartViewInfo; virtual;
  ...
  public
    constructor Create(AWheelPickerViewInfo
      : TdxCustomWheelPickerViewInfo); virtual;
    ...
    property WheelPickerViewInfo: TdxCustomWheelPickerViewInfo
      read FWheelPickerViewInfo;
  end;
  ...
  protected
    ...
    procedure DoDraw(ACanvas: TcxCanvas; const ABounds: TRect;
      AState: TcxButtonState); virtual;
  ...
  public
    constructor Create(AWheelPickerViewInfo
      : TdxCustomWheelPickerViewInfo); override;
  ...
  private
    ...
    FWheelViewInfo: TdxCustomWheelPickerWheelViewInfo;
  protected
    procedure DoAnimation(Sender: TdxAnimationTransition;
      var APosition: Integer; var AFinished: Boolean); virtual;
  ...
  protected
    ...
    function GetHitTest(const APoint: TPoint)
      : TdxCustomWheelPickerPartViewInfo; override;
    function GetCentralRowRect: TRect; virtual;
    function GetState: TcxButtonState; virtual;
    class function GetWheelPickerItemViewInfoClass
      : TdxCustomWheelPickerItemViewInfoClass; virtual;
    procedure InitializeItem(AItem: TdxCustomWheelPickerItemViewInfo;
    ...
    property Items[Index: Integer]: TdxCustomWheelPickerItemViewInfo
      read GetItem;
  public
    constructor Create(AWheelPickerViewInfo
      : TdxCustomWheelPickerViewInfo); override;
  ...
  protected
    ...
    function GetHitTest(const APoint: TPoint)
      : TdxCustomWheelPickerPartViewInfo; virtual;
    class function GetWheelPickerWheelViewInfoClass
      : TdxCustomWheelPickerWheelViewInfoClass; virtual;
  ...
  public
    ...
    property DraggedWheel: TdxCustomWheelPickerWheelViewInfo read FDraggedWheel
      write SetDraggedWheel;
    property PressedWheel: TdxCustomWheelPickerWheelViewInfo read FPressedWheel
      write SetPressedWheel;
    property SelectedWheel: TdxCustomWheelPickerWheelViewInfo
      read FSelectedWheel write SetSelectedWheel;
  ...
  protected
    procedure CalculateRowHeight(AViewInfo
      : TdxCustomWheelPickerViewInfo); virtual;
    procedure CalculateTextSize(AViewInfo
      : TdxCustomWheelPickerViewInfo); virtual;
    ...
    function GetWheelsHeight(AViewInfo: TdxCustomWheelPickerViewInfo)
      : Integer; virtual;
    function GetWheelIndent: Integer; virtual;
    procedure InitializeWheel(AWheelViewInfo: TdxCustomWheelPickerWheelViewInfo;
      AIndex: Integer); virtual;
  ...
  protected
    ...
    property ActiveProperties: TdxCustomWheelPickerProperties
  ...
  strict private
    ...
    procedure CalculateCenterHorizontallyAlignment(var ATextRect,
      AImageRect: TRect);
    procedure CalculateCenterVerticallyAlignment(var ATextRect,
      AImageRect: TRect);
  ...
  public
    property WheelPickerViewInfo: TdxWheelPickerViewInfo
      read GetWheelPickerViewInfo;
  end;
  ...
  protected
    ...
    class function GetWheelPickerItemViewInfoClass
      : TdxCustomWheelPickerItemViewInfoClass; override;
    procedure InitializeItem(AItem: TdxCustomWheelPickerItemViewInfo;
  ...
  protected
    ...
    class function GetWheelPickerWheelViewInfoClass
      : TdxCustomWheelPickerWheelViewInfoClass; override;
  ...
  public
    ...
    property Items[Index: Integer]: TdxWheelPickerItem read GetItem
  ...
  public
    ...
    property Items[Index: Integer]: TdxWheelPickerWheel read GetItem
      write SetItem; default;
  end;
  ...
  protected
    function CalculateEditValueByItemIndexes(const AItemIndexes
      : TdxWheelPickerItemIndexes): TcxEditValue; virtual;
  ...
  published
    ...
    property LineAutoHeight: Boolean read FLineAutoHeight
      write SetLineAutoHeight default False;
    property LineCount;
    property LineHeight: Integer read FLineHeight write SetLineHeight
      default 20;
    property WheelAutoWidth: Boolean read FWheelAutoWidth
      write SetWheelAutoWidth default False;
  ...
  public
    ...
    property ActiveProperties: TdxWheelPickerProperties
      read GetActiveProperties;
    property ItemIndexes[AIndex: Integer]: Integer read GetItemIndex
      write SetItemIndex;
  published
    property Anchors;
    property AutoSize;
...
function dxIncIndex(ACurrentIndex, AIncrement, AFirstIndex, ALastIndex: Integer;
  ACyclic: Boolean = False): Integer;
...
begin
  ...
  else if (Result < AFirstIndex) and (GetCount > -1) then
    Result := Min(ALastIndex, ALastIndex + GetOffset mod GetCount + 1);
end;

{ TdxWheelPickerWheelFadingHelper }

constructor TdxWheelPickerWheelFadingHelper.Create(AWheelViewInfo
  : TdxCustomWheelPickerWheelViewInfo);
begin
  inherited Create;
...
procedure TdxWheelPickerWheelFadingHelper.DrawItem(ACanvas: TcxCanvas;
...
procedure TdxWheelPickerWheelFadingHelper.GetFadingImages(out AFadeOutImage,
...
constructor TdxCustomWheelPickerPartViewInfo.Create(AWheelPickerViewInfo
  : TdxCustomWheelPickerViewInfo);
begin
  inherited Create;
...
function TdxCustomWheelPickerPartViewInfo.GetHitTest(const APoint: TPoint)
  : TdxCustomWheelPickerPartViewInfo;
begin
...
function TdxCustomWheelPickerPartViewInfo.GetPainter
...
constructor TdxCustomWheelPickerItemViewInfo.Create(AWheelPickerViewInfo
  : TdxCustomWheelPickerViewInfo);
begin
  inherited;
...
begin
  ...
  FContentRect := cxRectContent(Bounds, Rect(AMargin, AMargin, AMargin,
    AMargin));
  FContentBounds := cxRectSetNullOrigin(ContentRect);
  Bitmap.SetSize(ContentRect);
end;

procedure TdxCustomWheelPickerItemViewInfo.DoDraw(ACanvas: TcxCanvas;
  const ABounds: TRect; AState: TcxButtonState);
begin
  if IsItemSelected or not WheelViewInfo.FadingHelper.DrawImage(ACanvas.Handle,
    ABounds) then
    WheelViewInfo.DrawItemBackground(ACanvas, ABounds, AState);

  cxBitBlt(Bitmap.Canvas.Handle, ACanvas.Handle, ContentBounds,
    ContentRect.TopLeft, SRCCOPY);
  DrawContent(Bitmap.cxCanvas, FContentBounds, AState);
  cxBitBlt(ACanvas.Handle, Bitmap.Canvas.Handle, ContentRect,
    cxNullPoint, SRCCOPY);
end;
...
procedure TdxCustomWheelPickerItemViewInfo.DrawContent(ACanvas: TcxCanvas;
  const ABounds: TRect; AState: TcxButtonState);
begin
  // do nothing
end;
...
begin
  ...
  else if WheelViewInfo.IsSelected then
    Result := cxbsHot
  else
    Result := cxbsNormal;
...
begin
  Result := (Bounds.Top = WheelViewInfo.FCentralRowRect.Top) and
    not WheelViewInfo.IsDragged and not WheelViewInfo.IsAnimating;
end;
...
constructor TdxCustomWheelPickerWheelViewInfoAnimationHelper.Create
...
procedure TdxCustomWheelPickerWheelViewInfoAnimationHelper.DoAnimation
...
procedure TdxCustomWheelPickerWheelViewInfoAnimationHelper.DoAnimationTerminate
  (Sender: TObject);
begin
  FAnimation := nil;
...
procedure TdxCustomWheelPickerWheelViewInfoAnimationHelper.StartAnimation
  (ADelta: Integer);
begin
...
constructor TdxCustomWheelPickerWheelViewInfo.Create(AWheelPickerViewInfo
  : TdxCustomWheelPickerViewInfo);
begin
  inherited;
...
procedure TdxCustomWheelPickerWheelViewInfo.AddItem(const ABounds: TRect;
  AWheelItemIndex: Integer);
var
...
begin
  ...
  ATopItemRect := cxRectOffset(ASelectedItemRect, 0,
    -(ItemIndex - ATopItemIndex) * RowHeight);
...
procedure TdxCustomWheelPickerWheelViewInfo.DrawItemBackground
  (ACanvas: TcxCanvas; const ABounds: TRect; AState: TcxButtonState);
const
  ButtonStateToEditBtnState: array [TcxButtonState] of TcxEditButtonState =
    (ebsDisabled, ebsNormal, ebsSelected, ebsPressed, ebsDisabled);
var
  ...
  begin
    ...
    begin
      ...
      if Assigned(WheelPickerViewInfo.OnDrawButtonBackground) then
        WheelPickerViewInfo.OnDrawButtonBackground(FEditButtonViewInfo, ACanvas,
          ABackgroundRect, AHandled);
      if not AHandled then
        Painter.DrawWheelPickerItemBackground(ACanvas, ABounds, AState);
      AHandled := False;
      if Assigned(WheelPickerViewInfo.OnDrawButtonBorder) then
        WheelPickerViewInfo.OnDrawButtonBorder(FEditButtonViewInfo, ACanvas,
          ABackgroundRect, AContentRect, AHandled);
      if not AHandled then
...
function TdxCustomWheelPickerWheelViewInfo.GetItem(AIndex: Integer)
  : TdxCustomWheelPickerItemViewInfo;
begin
...
function TdxCustomWheelPickerWheelViewInfo.GetHitTest(const APoint: TPoint)
  : TdxCustomWheelPickerPartViewInfo;
var
  I: Integer;
...
class function TdxCustomWheelPickerWheelViewInfo.GetWheelPickerItemViewInfoClass
  : TdxCustomWheelPickerItemViewInfoClass;
begin
  Result := TdxCustomWheelPickerItemViewInfo;
end;

procedure TdxCustomWheelPickerWheelViewInfo.InitializeItem
  (AItem: TdxCustomWheelPickerItemViewInfo; AIndex: Integer);
begin
  AItem.FIndex := AIndex;
...
begin
  if (WheelPickerViewInfo.Edit <> nil) and WheelPickerViewInfo.Edit.HandleAllocated
  then
...
procedure TdxCustomWheelPickerWheelViewInfo.KeyDown(AKey: Word);
  ...
  begin
    ANewItemIndex := dxIncIndex(ItemIndex, AIncrement, 0,
      FWheelItemCount - 1, FCyclic);
...
var
  ANewItemIndex: Integer;
begin
  ANewItemIndex := dxIncIndex(ItemIndex, -ADelta, 0,
    FWheelItemCount - 1, FCyclic);
...
begin
  ...
  if not FCyclic then
    FMovingOffset := Min(Max(FMovingOffset, -ItemIndex * RowHeight),
      (FWheelItemCount - ItemIndex - 1) * RowHeight);
...
begin
  ...
  begin
    ...
    I := dxIncIndex(ASelectedWheelIndex, AIncrement, 0,
      FWheels.Count - 1, True);
...
function TdxCustomWheelPickerViewInfo.GetHitTest(const APoint: TPoint)
  : TdxCustomWheelPickerPartViewInfo;
var
  I: Integer;
begin
...
class function TdxCustomWheelPickerViewInfo.GetWheelPickerWheelViewInfoClass
  : TdxCustomWheelPickerWheelViewInfoClass;
begin
...
begin
  ...
  else if (SelectedWheel = nil) and (DraggedWheel = nil) and
    (PressedWheel = nil) and (GetMouseKeys = 0) then
    SelectNextWheel(1);
end;

procedure TdxCustomWheelPickerViewInfo.KeyDown(var AKey: Word;
  AShift: TShiftState);
begin
...
begin
  if (FPressedItemViewInfo <> nil) and
    (GetHitTest(APoint) = FPressedItemViewInfo) then
  begin
    if (SelectedWheel = PressedWheel) and FPressedItemViewInfo.IsItemSelected
    then
      SelectedWheel := nil
    else
      SelectedWheel := PressedWheel;
    AAnimationDelta := PressedWheel.FCentralRowRect.Top -
      FPressedItemViewInfo.Bounds.Top;
...
procedure TdxCustomWheelPickerViewInfo.MouseWheel(Shift: TShiftState;
...
begin
  ...
  else if APartViewInfo is TdxCustomWheelPickerItemViewInfo then
    SelectedWheel := TdxCustomWheelPickerItemViewInfo(APartViewInfo)
      .WheelViewInfo;
...
begin
  ...
  begin
    ...
    for I := 0 to FWheels.Count - 1 do
      ADisplayValue[I] := TdxCustomWheelPickerWheelViewInfo(FWheels[I])
        .ItemIndex;
...
function TdxCustomWheelPickerViewInfo.AddWheel
  : TdxCustomWheelPickerWheelViewInfo;
begin
...
function TdxCustomWheelPickerViewInfo.GetWheel(AIndex: Integer)
  : TdxCustomWheelPickerWheelViewInfo;
begin
  Result := TdxCustomWheelPickerWheelViewInfo(FWheels[AIndex]);
end;

procedure TdxCustomWheelPickerViewInfo.SetDraggedWheel
  (AValue: TdxCustomWheelPickerWheelViewInfo);
begin
  if DraggedWheel <> AValue then
  begin
    if (AValue <> nil) and (AValue <> SelectedWheel) and (AValue <> PressedWheel)
    then
      AValue.ChangeSelectedState;
    if (DraggedWheel <> nil) and (DraggedWheel <> SelectedWheel) and
      ((DraggedWheel <> PressedWheel)) then
...
procedure TdxCustomWheelPickerViewInfo.SetPressedWheel
  (AValue: TdxCustomWheelPickerWheelViewInfo);
begin
  if PressedWheel <> AValue then
  begin
    if (AValue <> nil) and (AValue <> SelectedWheel) and (AValue <> DraggedWheel)
    then
      AValue.ChangeSelectedState;
    if (PressedWheel <> nil) and (PressedWheel <> SelectedWheel) and
      ((PressedWheel <> DraggedWheel)) then
...
procedure TdxCustomWheelPickerViewInfo.SetSelectedWheel
  (AValue: TdxCustomWheelPickerWheelViewInfo);
begin
  if SelectedWheel <> AValue then
  begin
    if (AValue <> nil) and (AValue <> FPressedWheel) and (AValue <> DraggedWheel)
    then
      AValue.ChangeSelectedState;
    if (SelectedWheel <> nil) and (SelectedWheel <> FPressedWheel) and
      ((SelectedWheel <> DraggedWheel)) then
...
procedure TdxCustomWheelPickerViewData.Calculate(ACanvas: TcxCanvas;
...
begin
  ...
  inherited Calculate(ACanvas, ABounds, P, Button, Shift, AViewInfo,
    AIsMouseEvent);
  if AWheelPickerViewInfo.FIsDirty or not cxRectIsEqual(APrevClientRect,
    AViewInfo.ClientRect) then
  begin
    CalculateTextSize(AWheelPickerViewInfo);
    CalculateRowHeight(AWheelPickerViewInfo);
    if not(((ABounds.Bottom >= cxMaxRectSize) or
      (ABounds.Right >= cxMaxRectSize)) and IsInplace) then
...
begin
  ...
  begin
    ...
    begin
      ...
      AMaxImageHeight := Max(AMaxImageHeight, dxGetImageSize(AWheelItem.Glyph,
        Properties.Images, AWheelItem.ImageIndex, ScaleFactor).cy);
      if AWheelItem.Text <> '' then
        AMaxTextHeight := Max(AMaxTextHeight,
          TdxTextMeasurer.TextLineHeight(Style.Font));
    end;
    if AWheel.Items.Layout in [blGlyphLeft, blGlyphRight] then
      Result := Max(Result, Max(AMaxImageHeight, AMaxTextHeight))
    else
      Result := Max(Result, AMaxImageHeight + AMaxTextHeight +
        ScaleFactor.Apply(dxWheelPickerItemContentMargin));
  end;
  Result := Max(ScaleFactor.Apply(10),
    Result + 2 * ScaleFactor.Apply(dxWheelPickerItemContentMargin));
end;

procedure TdxCustomWheelPickerViewData.CalculateRowHeight
  (AViewInfo: TdxCustomWheelPickerViewInfo);
begin
  if Properties.LineCount <= 0 then
    AViewInfo.FRowHeight := Min(GetOptimalRowHeight,
      cxRectHeight(AViewInfo.ClientRect) - 2)
  else
    AViewInfo.FRowHeight := (cxRectHeight(AViewInfo.ClientRect) - 2 *
      GetWheelIndent) div Properties.LineCount;
end;

procedure TdxCustomWheelPickerViewData.CalculateTextSize
  (AViewInfo: TdxCustomWheelPickerViewInfo);
begin
  // do nothing
end;

procedure TdxCustomWheelPickerViewData.CalculateWheels
  (AViewInfo: TdxCustomWheelPickerViewInfo);
  ...
  begin
    ...
    Result := (cxRectWidth(AViewInfo.ClientRect) - Result - GetWheelIndent *
      (GetWheelCount - 1)) div 2;
...
begin
  ...
  try
    ADisplayWheelsWidth.AvailableWidth := cxRectWidth(AViewInfo.ClientRect) -
      GetWheelIndent * (AWheelCount + 1);
    ...
    AWheelBounds := cxRectCenterVertically(AViewInfo.ClientRect,
      GetWheelsHeight(AViewInfo) - GetWheelIndent * 2);
    ...
    begin
      ...
      AWheelBounds := cxRectSetLeft(cxRectSetWidth(AWheelBounds, AWheelWidth),
        AWheelLeftPos);
...
procedure TdxCustomWheelPickerViewData.EditValueToDrawValue(const AEditValue
  : Variant; AViewInfo: TcxCustomEditViewInfo);
var
...
function TdxCustomWheelPickerViewData.GetWheelsHeight
  (AViewInfo: TdxCustomWheelPickerViewInfo): Integer;
begin
  Result := cxRectHeight(AViewInfo.ClientRect);
  if Properties.LineCount > 0 then
    Result := Min(Result, Properties.LineCount * AViewInfo.FRowHeight + 2 *
      GetWheelIndent);
end;
...
procedure TdxCustomWheelPickerViewData.InitializeWheel(AWheelViewInfo
  : TdxCustomWheelPickerWheelViewInfo; AIndex: Integer);
begin
  AWheelViewInfo.FIndex := AIndex;
end;

function TdxCustomWheelPickerViewData.InternalGetEditConstantPartSize
...
begin
  ...
  begin
    ...
    if Properties.LineCount <= 0 then
      ARowCount := 3;
    Result.cy := Result.cy + GetOptimalRowHeight * ARowCount + 2 *
      GetWheelIndent;
  ...
  begin
    ...
    MinContentSize.cy := MinContentSize.cy +
      (TdxTextMeasurer.TextLineHeight(Style.Font) + 2 *
      ScaleFactor.Apply(dxWheelPickerItemContentMargin)) * ARowCount + 2 *
      GetWheelIndent;
  end;
end;
...
function TdxCustomWheelPickerViewData.GetProperties
  : TdxCustomWheelPickerProperties;
begin
...
class function TdxCustomWheelPickerProperties.GetContainerClass
  : TcxContainerClass;
begin
  Result := TdxCustomWheelPicker;
end;

function TdxCustomWheelPickerProperties.GetSpecialFeatures
  : TcxEditSpecialFeatures;
begin
  Result := inherited GetSpecialFeatures + [esfMultiRow];
end;

class function TdxCustomWheelPickerProperties.GetViewInfoClass
...
procedure TdxCustomWheelPickerProperties.DoAssign
...
class function TdxCustomWheelPickerProperties.GetViewDataClass
...
procedure TdxCustomWheelPickerProperties.InternalPrepareValue
  (var AEditValue: TcxEditValue);
begin
  // do nothing
end;
...
function TdxWheelPickerDragAndDropObject.GetDragAndDropCursor
...
class function TdxCustomWheelPicker.GetPropertiesClass
...
function TdxCustomWheelPicker.NeedPanningFeedback
...
procedure TdxCustomWheelPicker.DragAndDrop(const P: TPoint;
...
function TdxCustomWheelPicker.GetDragAndDropObjectClass
...
function TdxCustomWheelPicker.InternalMouseWheel(Shift: TShiftState;
...
procedure TdxCustomWheelPicker.InternalSetSelectedValue(ASelectedValue
  : TcxEditValue);
begin
...
function TdxCustomWheelPicker.IsMouseWheelHandleNeeded(Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
...
procedure TdxCustomWheelPicker.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  if Button = mbLeft then
    ViewInfo.SetPressedElements(Point(X, Y));
  inherited;
  if (Button = mbLeft) and (DragAndDropState = ddsStarting) and
    (ViewInfo.PressedWheel.AnimationOffset <> 0) then
    BeginDragAndDrop;
end;
...
procedure TdxCustomWheelPicker.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
...
begin
  ActiveProperties.PrepareDisplayValue(EditingValue, ADisplayValue,
    InternalFocused);
...
function TdxCustomWheelPicker.GetActiveProperties
  : TdxCustomWheelPickerProperties;
begin
...
procedure TdxCustomWheelPicker.SetProperties
  (AValue: TdxCustomWheelPickerProperties);
begin
...
procedure TdxWheelPickerItemViewInfo.CalculateContentLayout(out ATextRect,
  AImageRect: TRect);
begin
...
procedure TdxWheelPickerItemViewInfo.DrawContent(ACanvas: TcxCanvas;
  const ABounds: TRect; AState: TcxButtonState);
begin
  inherited;
  DrawText(ACanvas);
...
procedure TdxWheelPickerItemViewInfo.DrawGlyph(ACanvas: TcxCanvas;
  AState: TcxButtonState);
begin
  cxDrawImage(ACanvas, FImageRect, FGlyph, WheelPickerViewInfo.FImages,
    FImageIndex, ifmNormal, idmNormal, True,
    Painter.GetWheelPickerColorPalette(AState), ScaleFactor);
end;
...
begin
  Result := dxGetImageSize(FGlyph, WheelPickerViewInfo.FImages, FImageIndex,
    ScaleFactor);
end;

function TdxWheelPickerItemViewInfo.GetTextFlags: Integer;
const
  AAlignHorz: array [TAlignment] of Integer = (CXTO_LEFT, CXTO_RIGHT,
    CXTO_CENTER_HORIZONTALLY);
  AAlignVert: array [TcxAlignmentVert] of Integer = (CXTO_TOP, CXTO_BOTTOM,
    CXTO_CENTER_VERTICALLY);
begin
  Result := CXTO_SINGLELINE or AAlignHorz[FItemContentAlignHorz] or
    AAlignVert[FItemContentAlignVert];
...
begin
  if HasText then
  begin
    Result.cx := cxRectWidth(Bounds) - 2 * ScaleFactor.Apply
      (dxWheelPickerItemContentMargin);
    Result.cy := cxRectHeight(Bounds) - 2 * ScaleFactor.Apply
      (dxWheelPickerItemContentMargin);
    if HasGlyph then
    begin
      case ActualLayout of
        blGlyphLeft, blGlyphRight:
          Result.cx := Result.cx - FImageSize.cx -
            ScaleFactor.Apply(dxWheelPickerItemContentMargin);
      else
        Result.cx := Result.cy - FImageSize.cy -
          ScaleFactor.Apply(dxWheelPickerItemContentMargin);
      end;
    end;
    ARect := cxRect(Result);
    TdxTextMeasurer.TextRectDT(ARect, FText, WheelPickerViewInfo.Font,
      DT_SINGLELINE);
...
procedure TdxWheelPickerItemViewInfo.InitializeByItem
  (AItem: TdxWheelPickerItem);
begin
  FText := AItem.Text;
  FGlyph := AItem.Glyph;
...
procedure TdxWheelPickerItemViewInfo.CalculateBottomAlignment(var ATextRect,
  AImageRect: TRect);
begin
  if HasGlyph and HasText then
    case ActualLayout of
      blGlyphTop:
        begin
          ...
          AImageRect := cxRectSetBottom(AImageRect,
            ATextRect.Top - ScaleFactor.Apply(dxWheelPickerItemContentMargin));
        end;
      blGlyphBottom:
        begin
          AImageRect := cxRectSetBottom(AImageRect, ContentBounds.Bottom);
          ATextRect := cxRectSetBottom(ATextRect,
            AImageRect.Top - ScaleFactor.Apply(dxWheelPickerItemContentMargin));
        end;
    else
      begin
        ATextRect := cxRectSetBottom(ATextRect, ContentBounds.Bottom);
    ...
    ATextRect := cxRectSetBottom(ATextRect, ContentBounds.Bottom)
  else if HasGlyph then
    AImageRect := cxRectSetBottom(AImageRect, ContentBounds.Bottom)
end;

procedure TdxWheelPickerItemViewInfo.CalculateCenterHorizontallyAlignment
  (var ATextRect, AImageRect: TRect);
var
  ARect: TRect;
begin
  if HasGlyph and HasText then
    case ActualLayout of
      blGlyphLeft:
        begin
          ARect := cxRectCenterHorizontally(ContentBounds,
            FImageSize.cx + FTextSize.cx + ScaleFactor.Apply
            (dxWheelPickerItemContentMargin));
      ...
      begin
        ATextRect := Rect(ContentBounds.Left, ATextRect.Top,
          ContentBounds.Right, ATextRect.Bottom);
        AImageRect := Rect(ContentBounds.Left, AImageRect.Top,
          ContentBounds.Right, AImageRect.Bottom);
  ...
  begin
    ATextRect := Rect(ContentBounds.Left, ATextRect.Top, ContentBounds.Right,
      ATextRect.Bottom);
    ATextRect := cxRectCenterHorizontally(cxRectSetWidth(ATextRect,
      cxRectWidth(ContentBounds)), FTextSize.cx);
  end
  else if HasGlyph then
  begin
    AImageRect := Rect(ContentBounds.Left, AImageRect.Top, ContentBounds.Right,
      AImageRect.Bottom);
    AImageRect := cxRectCenterHorizontally(cxRectSetWidth(AImageRect,
      cxRectWidth(ContentBounds)), FImageSize.cx);
  end;
end;

procedure TdxWheelPickerItemViewInfo.CalculateCenterVerticallyAlignment
  (var ATextRect, AImageRect: TRect);
var
  ARect: TRect;
begin
  if HasGlyph and HasText then
    case ActualLayout of
      blGlyphTop:
        begin
          ARect := cxRectCenterVertically(ContentBounds,
            FImageSize.cy + FTextSize.cy + ScaleFactor.Apply
            (dxWheelPickerItemContentMargin));
...
procedure TdxWheelPickerItemViewInfo.CalculateLeftAlignment(var ATextRect,
  AImageRect: TRect);
begin
  if HasGlyph and HasText then
    case ActualLayout of
      blGlyphLeft:
        begin
          ...
          ATextRect := cxRectSetLeft(ATextRect,
            AImageRect.Right + ScaleFactor.Apply
            (dxWheelPickerItemContentMargin));
        end;
      blGlyphRight:
        begin
          ATextRect := cxRectSetLeft(ATextRect, ContentBounds.Left);
          AImageRect := cxRectSetLeft(AImageRect,
            ATextRect.Right + ScaleFactor.Apply
            (dxWheelPickerItemContentMargin));
        end;
    else
      begin
...
procedure TdxWheelPickerItemViewInfo.CalculateRightAlignment(var ATextRect,
  AImageRect: TRect);
begin
  if HasGlyph and HasText then
    case ActualLayout of
      blGlyphLeft:
        begin
          ...
          AImageRect := cxRectSetRight(AImageRect,
            ATextRect.Left - ScaleFactor.Apply(dxWheelPickerItemContentMargin));
        end;
      blGlyphRight:
        begin
          AImageRect := cxRectSetRight(AImageRect, ContentBounds.Right);
          ATextRect := cxRectSetRight(ATextRect,
            AImageRect.Left - ScaleFactor.Apply
            (dxWheelPickerItemContentMargin));
        end;
    else
      begin
...
procedure TdxWheelPickerItemViewInfo.CalculateTopAlignment(var ATextRect,
  AImageRect: TRect);
begin
  if HasGlyph and HasText then
    case ActualLayout of
      blGlyphTop:
        begin
          ...
          ATextRect := cxRectSetTop(ATextRect, AImageRect.Bottom +
            ScaleFactor.Apply(dxWheelPickerItemContentMargin));
        end;
      blGlyphBottom:
        begin
          ATextRect := cxRectSetTop(ATextRect, ContentBounds.Top);
          AImageRect := cxRectSetTop(AImageRect,
            ATextRect.Bottom + ScaleFactor.Apply
            (dxWheelPickerItemContentMargin));
        end;
    else
      begin
...
function TdxWheelPickerItemViewInfo.GetWheelPickerViewInfo
  : TdxWheelPickerViewInfo;
begin
...
class function TdxWheelPickerWheelViewInfo.GetWheelPickerItemViewInfoClass
  : TdxCustomWheelPickerItemViewInfoClass;
begin
  Result := TdxWheelPickerItemViewInfo;
end;

procedure TdxWheelPickerWheelViewInfo.InitializeItem
  (AItem: TdxCustomWheelPickerItemViewInfo; AIndex: Integer);
var
...
class function TdxWheelPickerViewInfo.GetWheelPickerWheelViewInfoClass
  : TdxCustomWheelPickerWheelViewInfoClass;
begin
...
procedure TdxWheelPickerViewData.Calculate(ACanvas: TcxCanvas;
  const ABounds: TRect; const P: TPoint; Button: TcxMouseButton;
  Shift: TShiftState; AViewInfo: TcxCustomEditViewInfo; AIsMouseEvent: Boolean);
var
...
procedure TdxWheelPickerViewData.CalculateRowHeight
  (AViewInfo: TdxCustomWheelPickerViewInfo);
begin
  AViewInfo.FRowHeight := GetOptimalRowHeight;
end;

procedure TdxWheelPickerViewData.InitializeWheel(AWheelViewInfo
  : TdxCustomWheelPickerWheelViewInfo; AIndex: Integer);
var
  AWheel: TdxWheelPickerWheel;
begin
...
begin
  Result := ScaleFactor.Apply(Properties.Wheels[AIndex].Width,
...
constructor TdxWheelPickerItems.Create(AOwner: TPersistent;
...
procedure TdxWheelPickerItems.SetItem(Index: Integer;
  AValue: TdxWheelPickerItem);
begin
...
procedure TdxWheelPickerWheels.SetItem(Index: Integer;
  AValue: TdxWheelPickerWheel);
begin
  inherited SetItem(Index, AValue);
end;
...
function TdxWheelPickerWheels.InsertGalleryGroup(AIndex: Integer)
  : IdxGalleryGroup;
begin
...
begin
  ...
  cxCopyData(Pointer(AItemIndexes), Pointer(AData), Length(AItemIndexes) *
    SizeOf(Integer));
  Result := AData;
end;
...
procedure TdxWheelPickerProperties.DoAssign(AProperties
...
begin
  ...
  begin
    ...
    FLineHeight := Self.ScaleFactor.Apply(AWheelPickerProperties.LineHeight,
      ScaleFactor);
...
class function TdxWheelPickerProperties.GetViewDataClass
  : TcxCustomEditViewDataClass;
begin
  Result := TdxWheelPickerViewData;
end;

class function TdxWheelPickerProperties.GetViewInfoClass
  : TcxContainerViewInfoClass;
begin
  Result := TdxWheelPickerViewInfo;
end;

procedure TdxWheelPickerProperties.InternalPrepareValue(var AEditValue
  : TcxEditValue);
var
...
procedure TdxWheelPickerProperties.PrepareDisplayValue(const AEditValue
  : Variant; var DisplayValue: Variant; AEditFocused: Boolean);
var
...
begin
  ...
  begin
    ...
    cxCopyData(Pointer(AValueString), Pointer(AItemIndexes),
      Wheels.Count * SizeOf(Integer));
    DisplayValue := AItemIndexes;
  end
  else if Wheels.Count > 0 then
    DisplayValue := AItemIndexes
  else
    DisplayValue := Null;
end;
...
begin
  ...
  if AValue = Null then
    ...
    Result := Min(AValue[AIndex], ActiveProperties.Wheels[AIndex]
      .ItemCount - 1);
end;
...
function TdxWheelPicker.GetAllowedCustomizationActions
