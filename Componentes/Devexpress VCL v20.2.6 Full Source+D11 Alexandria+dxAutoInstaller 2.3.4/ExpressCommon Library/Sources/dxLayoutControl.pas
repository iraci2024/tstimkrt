...
{$ENDIF}
  ...
  dxCore, dxCoreClasses, dxMessages, cxClasses, cxGeometry, cxGraphics,
  cxControls,
...
type
  ...
  protected
    ...
    function DoGetCustomizationMenuItems(const ASelectedItems: TList)
      : TdxLayoutCustomizeFormMenuItems; override;
    ...
    function GetSelectionHelperClass
      : TdxLayoutRunTimeSelectionHelperClass; override;
  ...
  published
    ...
    property StoreToIniFile: Boolean read FStoreToIniFile write FStoreToIniFile
      default False;
    property StoreToRegistry: Boolean read FStoreToRegistry
      write FStoreToRegistry default False;
  end;
  ...
  protected
    ...
    property AllowFloatingDragImage: Boolean read FAllowFloatingDragImage
      write FAllowFloatingDragImage default True;
  public
    constructor Create(AControl: TdxCustomLayoutControl); override;
    procedure Assign(Source: TPersistent); override;
  published
    property AllowFloatingGroups: Boolean read FAllowFloatingGroups
      write FAllowFloatingGroups default False;
    property AllowQuickCustomize: Boolean read GetAllowQuickCustomize
      write SetAllowQuickCustomize stored False default False;
    property AllowGroupWrapItems: Boolean read GetAllowGroupWrapItems
      write SetAllowGroupWrapItems default False;
    property AllowRename: Boolean read GetAllowRename write SetAllowRename
      default True;
    ...
    property FocusControlOnItemCaptionClick: Boolean
      read FFocusControlOnItemCaptionClick write FFocusControlOnItemCaptionClick
      default False;
    property ShowLockedGroupChildren: Boolean read FShowLockedGroupChildren
      write SetShowLockedGroupChildren default True;
    property ShowQuickCustomizationToolbar: Boolean
      read GetShowQuickCustomizationToolbar
      write SetShowQuickCustomizationToolbar default True;
    property SizableHorz: Boolean read FSizableHorz write FSizableHorz
      default False;
    property SizableVert: Boolean read FSizableVert write FSizableVert
      default False;
  end;
  ...
  TdxLayoutControlGetItemStoredPropertiesEvent = procedure
    (Sender: TdxCustomLayoutControl; AItem: TdxCustomLayoutItem;
    AProperties: TStrings) of object;
  TdxLayoutControlGetItemStoredPropertyValueEvent = procedure
    (Sender: TdxCustomLayoutControl; AItem: TdxCustomLayoutItem;
    const AName: string; var AValue: Variant) of object;
  TdxLayoutControlSetItemStoredPropertyValueEvent = procedure
    (Sender: TdxCustomLayoutControl; AItem: TdxCustomLayoutItem;
    const AName: string; const AValue: Variant) of object;
  TdxLayoutControlGetStoredPropertiesEvent = procedure
    (Sender: TdxCustomLayoutControl; AProperties: TStrings) of object;
  TdxLayoutControlGetStoredPropertyValueEvent = procedure
    (Sender: TdxCustomLayoutControl; const AName: string; var AValue: Variant)
    of object;
  TdxLayoutControlSetStoredPropertyValueEvent = procedure
    (Sender: TdxCustomLayoutControl; const AName: string; const AValue: Variant)
    of object;
  TdxLayoutGetCustomizationMenuItemsEvent = procedure(Sender: TObject;
    const ASelectedItems: TList;
    var AMenuItems: TdxLayoutCustomizeFormMenuItems) of object;

  TdxCustomLayoutControl = class(TcxScrollingControl, IdxLayoutComponent,
    IdxSkinSupport, IdxCustomizeControlsHelper, IcxEditorFieldLink2,
    IdxLayoutContainerOwner, IdxAcrylicHostControlListener)
  private
    // Internal Objects
    FBoldFont: TFont;
    ...
    FOnGetItemStoredPropertyValue
      : TdxLayoutControlGetItemStoredPropertyValueEvent;
    FOnSetItemStoredPropertyValue
      : TdxLayoutControlSetItemStoredPropertyValueEvent;
    ...
    function GetCustomizeAvailableItemsViewKind
    ...
    procedure SetCustomizeFormClass
    ...
    procedure DXMPlaceControls(var Message: TMessage);
      message DXM_LAYOUT_PLACECONTROLS;
    procedure DXMLayoutChanged(var Message: TMessage);
      message DXM_LAYOUT_LAYOUTCHANGED;
    procedure DXMBuildSelectionLayer(var Message: TMessage);
      message DXM_LAYOUT_BUILDSELECTIONLAYER;
    procedure DXMInvalidateSelectionLayer(var Message: TMessage);
      message DXM_LAYOUT_INVALIDATESELECTIONLAYER;
    procedure DXMCustomizeFormUpdate(var Message: TMessage);
      message DXM_REFRESHCUSTOMIZATION;
    procedure DXMUpdateScrollPos(var Message: TMessage);
      message DXM_LAYOUT_UPDATESCROLLPOS;
  protected
    // inherited methods
    ...
    procedure DoGetCustomizationMenuItems(const ASelectedItems: TList;
      var AMenuItems: TdxLayoutCustomizeFormMenuItems); virtual;
    ...
    // storing
    procedure DoGetItemStoredProperties(AItem: TdxCustomLayoutItem;
    ...
    property MenuItems: TdxLayoutCustomizeFormMenuItems read GetMenuItems
      write SetMenuItems;
  public
...
{$ENDIF}
    ...
    function CreateGroup(AGroupClass: TdxLayoutGroupClass;
    ...
    property AutoContentSizes: TdxLayoutAutoContentSizes
      read GetAutoContentSizes write SetAutoContentSizes;
    ...
    property LookAndFeel: TdxCustomLayoutLookAndFeel read GetLayoutLookAndFeel
      write SetLayoutLookAndFeel;
    property LayoutLookAndFeel: TdxCustomLayoutLookAndFeel
      read GetLayoutLookAndFeel write SetLayoutLookAndFeel;
    ...
    property CustomizeAvailableItemsViewKind: TdxLayoutAvailableItemsViewKind
      read GetCustomizeAvailableItemsViewKind
      write SetCustomizeAvailableItemsViewKind;
    property CustomizeForm: TdxLayoutControlCustomCustomizeForm
      read GetCustomizeForm;
    property CustomizeFormBounds: TRect read GetCustomizeFormBounds
      write SetCustomizeFormBounds;
    property CustomizeFormClass: TdxLayoutControlCustomCustomizeFormClass
      read GetCustomizeFormClass write SetCustomizeFormClass;
    property CustomizeFormTabbedView: Boolean read GetCustomizeFormTabbedView
      write SetCustomizeFormTabbedView;
    property ShowDesignSelectors: Boolean read GetShowDesignSelectors
      write SetShowDesignSelectors;
    property HighlightRoot: Boolean read GetHighlightRoot
      write SetHighlightRoot;
    ...
    // Options
    property OptionsImage: TdxLayoutImageOptions read GetOptionsImage
      write SetOptionsImage;

    // Item properties
    property OptionsItem: TdxLayoutItemOptions read FOptionsItem
      write SetOptionsItem;
    property AutoControlAlignment: Boolean read GetAutoControlAlignment
      write SetAutoControlAlignment default True;
    property AutoControlTabOrders: Boolean read GetAutoControlTabOrders
      write SetAutoControlTabOrders default True;
    ...
    // Storing properties
    property OptionsStoring: TdxStoringOptions read FOptionsStoring
      write SetOptionsStoring;
    ...
    property StoreInIniFile: Boolean read GetStoreInIniFile
      write SetStoreInIniFile;
    property StoreInRegistry: Boolean read GetStoreInRegistry
      write SetStoreInRegistry;
  ...
  protected
    ...
    property ContainerViewInfo: TdxLayoutControlContainerViewInfo
  ...
  protected
    function FindActiveDesigner(out ADesigner: IdxLayoutDesignerHelper)
      : Boolean;
  public
    constructor Create;
    destructor Destroy; override;
...
uses
  ...
  UxTheme, Themes,
  dxGDIPlusClasses, dxHooks, dxCoreGraphics, cxContainer, dxOffice11,
  dxShadowWindow, dxThreading,
  dxLayoutControlAdapters, dxLayoutCustomizeForm, dxLayoutStrs,
  dxLayoutDragAndDrop, dxDPIAwareUtils, dxCustomFluentDesignForm;
...
type
  ...
  TdxLayoutFloatForm = class(TdxLayoutCustomFloatForm, IdxLayoutLookAndFeelUser)
  strict private
    ...
    procedure DXMUpdateFloat(var Message: TMessage);
      message DXM_LAYOUT_UPDATEFLOAT;
    ...
    function GetLayoutLookAndFeel(AItem: TdxCustomLayoutItemAccess)
  ...
  protected
    ...
    property MasterLayoutLookAndFeel: TdxCustomLayoutLookAndFeel
      read FMasterLayoutLookAndFeel write SetMasterLayoutLookAndFeel;
...
procedure TdxLayoutShadowPart.UpdatePosition;
  ...
  begin
    Result := (OwnerWindow.Left <> 10000) and
      IsWindowVisible(OwnerWindow.Handle);
  end;
...
begin
  ...
  if AVisible then
  begin
    BoundsRect := cxRectInflate(OwnerWindow.BoundsRect, AShadowSize,
      AShadowSize);
    FOwnerRect := cxRectInflate(cxGetWindowBounds(Handle), -AShadowSize,
      -AShadowSize);
...
begin
  ...
  dxGPPaintCanvas.Rectangle(cxRectInflate(FOwnerRect, 1, 1), $BEBEBE, clNone, 1,
    psSolid, 60, 255);
...
begin
  ...
  (FLayoutControl.Container as TdxLayoutControlContainer).MasterContainer :=
    AMasterContainer;
  FLayoutControl.OptionsItem.AllowFloatingGroups :=
    AMasterContainer.AllowFloatingGroups;
  ...
  FOwnerWindowWndProcObject := cxWindowProcController.Add(OwnerWindow,
    OwnerWindowWndProc);
...
begin
  ...
  try
    ...
    dxAssignFont(LayoutControl.Font, ARealContainer.Control.Font,
      LayoutControl.ScaleFactor, ARealContainer.Control.ScaleFactor);
...
begin
  Result := Forms.GetParentForm
    ((FLayoutControl.Container as TdxLayoutControlContainer)
    .MasterContainer.ItemsParent);
end;
...
procedure TdxLayoutFloatForm.WMWindowPosChanged(var Message
  : TWMWindowPosChanged);
begin
  inherited;
  if FShadow <> nil then
...
begin
  if Message.Active and (GetParentForm <> nil) and GetParentForm.HandleAllocated
  then
...
function TdxLayoutFloatForm.GetLayoutLookAndFeel
  (AItem: TdxCustomLayoutItemAccess): TdxCustomLayoutLookAndFeel;
begin
  Result := AItem.LayoutLookAndFeel;
  if Result = nil then
    Result := TdxLayoutContainerAccess(AItem.RealContainer)
...
procedure TdxLayoutFloatForm.SetMasterLayoutLookAndFeel
  (AValue: TdxCustomLayoutLookAndFeel);
begin
...
begin
  Visible := FIsFloat and IsWindowVisible(OwnerWindow) and
    not IsIconic(OwnerWindow);
  if FShadow <> nil then
    FShadow.UpdatePosition;
end;
...
type
  ...
  public
    procedure Assign(Source: TPersistent); override;
    property LayoutControl: TdxCustomLayoutControl read FLayoutControl
      write SetLayoutControl;
...
function TdxLayoutItemSelectorHelper.DoControlWndProc
  (var Message: TMessage): Boolean;
begin
  case Message.Msg of
    WM_PAINT, WM_ERASEBKGND, WM_NCPAINT, CM_TEXTCHANGED:
      if IsValid and ((Control = nil) or
        not(csPaintCopy in Control.ControlState)) then
        LayoutControl.PostInvalidateSelectionLayer
          (LayoutItem.ViewInfo.ControlViewInfo.Bounds);
  end;
  Result := inherited DoControlWndProc(Message);
end;

function TdxLayoutItemSelectorHelper.GetChildClass
...
begin
  Result := inherited IsActiveDesignSelector and TdxLayoutItemAccess(LayoutItem)
    .IsDesignSelectorVisible;
end;

function TdxLayoutItemSelectorHelper.IsHitTestTransparent
...
begin
  Result := (not LayoutControl.Customization and LayoutItem.ViewInfo.Selected)
    or (LayoutControl.Customization and
    LayoutControl.Container.IsComponentSelected(LayoutItem.Control));
end;
...
begin
  Result := inherited IsValid and (LayoutControl <> nil) and (LayoutItem <> nil)
    and TdxLayoutItemAccess(LayoutItem).IsViewInfoValid;
end;
...
procedure TdxLayoutItemSelectorHelper.SetLayoutControl
  (AValue: TdxCustomLayoutControl);
begin
...
begin
  ...
  begin
    ...
    try
      if dxDesignCustomizationHelper.FindActiveDesigner(ADesigner) and
        ADesigner.CanProcessKeyboard then
...
procedure dxLayoutKeyboardHook(ACode: Integer; WPARAM: WPARAM; LPARAM: LPARAM;
...
procedure TdxDesignCustomizationHelper.AddLayout
...
procedure TdxDesignCustomizationHelper.RemoveLayout
  (ALayout: TdxCustomLayoutControl);
begin
  FLayoutControls.Extract(ALayout);
end;

function TdxDesignCustomizationHelper.FindActiveDesigner(out ADesigner
  : IdxLayoutDesignerHelper): Boolean;
var
  I: Integer;
  ALayout: TdxCustomLayoutControl;
begin
  ...
  begin
    ...
    Result := Supports(ALayout.Container, IdxLayoutDesignerHelper, ADesigner)
      and ADesigner.IsActive and ALayout.HandleAllocated and
      ((ALayout.Handle = GetFocus) or ((ALayout.Parent <> nil) and
      ALayout.Parent.HandleAllocated and
      cxIsParentFocused(ALayout.Parent.Handle)));
    if Result then
      Break;
  end;
end;
...
function TdxDesignCustomizationHelper.GetItem(AIndex: Integer)
  : TdxCustomLayoutControl;
begin
...
procedure TdxLayoutControlContainer.SetDefaultItemName
  (AItem: TdxCustomLayoutItem);
var
  ADesignerHook: IDesignerHook;
begin
  if IsDesigning and Supports(FindRootDesigner(AItem), IDesignerHook,
    ADesignerHook) then
...
function TdxLayoutControlContainer.GetPainterClass
  : TdxLayoutContainerPainterClass;
begin
...
function TdxLayoutControlContainer.GetViewInfoClass
  : TdxLayoutContainerViewInfoClass;
begin
  Result := TdxLayoutControlContainerViewInfo;
end;

procedure TdxLayoutControlContainer.DoSetStoredPropertyValue
  (const AName: string; const AValue: Variant);
begin
  Control.DoSetStoredPropertyValue(AName, AValue);
end;

procedure TdxLayoutControlContainer.DoGetStoredPropertyValue
...
procedure TdxLayoutControlContainer.InitializeFloatForm
  (AItem: TdxCustomLayoutItem);
begin
  (TdxCustomLayoutItemAccess(AItem).FFloatForm as TdxLayoutFloatForm)
    .Initialize(TdxCustomLayoutItemAccess(AItem));
end;

function TdxLayoutControlContainer.GetFloatDock(AItem: TdxCustomLayoutItem)
  : TdxLayoutGroup;
begin
  Result := (TdxCustomLayoutItemAccess(AItem).FFloatForm as TdxLayoutFloatForm)
    .LayoutControl.Items;
end;
...
function TdxLayoutControlContainer.CreateItemSelectorHelper
...
procedure TdxLayoutControlContainer.CustomizeFormPostUpdate
...
procedure TdxLayoutControlContainer.PostInvalidateSelectionLayer
  (const R: TRect);
begin
  inherited;
...
procedure TdxLayoutControlContainer.PostLayoutChanged
  (AType: TdxChangeType = ctHard);
begin
  inherited;
...
function TdxLayoutControlContainer.GetSelectionHelperClass
...
procedure TdxLayoutControlContainer.MakeVisible(const ARect: TRect;
  AFully: Boolean);
const
  VisibilityChangeMap: array [Boolean] of TdxVisibilityType =
    (vtPartialy, vtFully);
begin
  inherited;
...
function TdxLayoutControlContainer.GetViewInfo
  : TdxLayoutControlContainerViewInfo;
begin
...
begin
  ...
  begin
    ...
    try
      AutoControlAreaAlignment := TdxLayoutItemOptions(Source)
        .AutoControlAreaAlignment;
      AutoControlTabOrders := TdxLayoutItemOptions(Source).AutoControlTabOrders;
      FocusControlOnItemCaptionClick := TdxLayoutItemOptions(Source)
        .FocusControlOnItemCaptionClick;
      SizableHorz := TdxLayoutItemOptions(Source).SizableHorz;
      SizableVert := TdxLayoutItemOptions(Source).SizableVert;
      ShowLockedGroupChildren := TdxLayoutItemOptions(Source)
        .ShowLockedGroupChildren;
    finally
...
begin
  Result := TdxLayoutContainerAccess(Control.Container)
    .ShowQuickCustomizationToolbar;
end;

procedure TdxLayoutItemOptions.SetShowQuickCustomizationToolbar(Value: Boolean);
begin
  TdxLayoutContainerAccess(Control.Container)
    .ShowQuickCustomizationToolbar := Value;
end;
...
function TdxCustomLayoutControl.GetAbsoluteItem(Index: Integer)
  : TdxCustomLayoutItem;
begin
...
function TdxCustomLayoutControl.GetAlignmentConstraint(Index: Integer)
  : TdxLayoutAlignmentConstraint;
begin
...
function TdxCustomLayoutControl.GetAvailableItem(Index: Integer)
  : TdxCustomLayoutItem;
begin
...
function TdxCustomLayoutControl.GetCustomizeAvailableItemsViewKind
  : TdxLayoutAvailableItemsViewKind;
begin
  Result := Container.CustomizeAvailableItemsViewKind;
end;

function TdxCustomLayoutControl.GetCustomizeForm
...
function TdxCustomLayoutControl.GetCustomizeFormClass
...
function TdxCustomLayoutControl.GetLayoutLookAndFeel
  : TdxCustomLayoutLookAndFeel;
begin
...
procedure TdxCustomLayoutControl.SetAutoContentSizes
  (Value: TdxLayoutAutoContentSizes);
begin
  if IsLoading then
...
procedure TdxCustomLayoutControl.SetCustomizeAvailableItemsViewKind
  (Value: TdxLayoutAvailableItemsViewKind);
begin
...
procedure TdxCustomLayoutControl.SetMenuItems
  (Value: TdxLayoutCustomizeFormMenuItems);
begin
  Container.MenuItems := Value;
end;

procedure TdxCustomLayoutControl.SetLayoutLookAndFeel
...
procedure TdxCustomLayoutControl.ContainerSelectionChangedHandler
  (Sender: TObject);
begin
  if IsDesigning then
...
begin
  Container.GetLayoutLookAndFeel.InitializeSubControlCxLookAndFeel
    (HScrollBar.Control.LookAndFeel);
  Container.GetLayoutLookAndFeel.InitializeSubControlCxLookAndFeel
    (VScrollBar.Control.LookAndFeel);
  Container.GetLayoutLookAndFeel.InitializeSubControlCxLookAndFeel
    (SizeGrip.LookAndFeel);
end;

procedure TdxCustomLayoutControl.MasterLookAndFeelEndChangeHandler
  (Sender: TObject);
begin
  EndUpdate;
end;

procedure TdxCustomLayoutControl.MasterLookAndFeelBeginChangeHandler
  (Sender: TObject);
begin
  BeginUpdate;
end;
...
begin
  ...
  begin
    ...
    if (AForm <> nil) and AForm.Active and (Message.FocusedWnd <> AForm.Handle)
      and (Message.FocusedWnd <> 0) and (Message.FocusedWnd <> Handle) then
      Container.KillFocus
    else
      Invalidate;
  end;
...
begin
  ...
  if not(IsLoading or IsDestroying) and Message.Inserting and
    not IsInternalControl(AControl) and
    not(csAncestor in AControl.ComponentState) and (FindItem(AControl) = nil)
    and (not IsDesigning or not Container.IsUpdateLocked) then
  begin
...
procedure TdxCustomLayoutControl.CMControlListChange
...
begin
  ...
  if not Container.IsCustomization and Container.ShowHint(Message.HintInfo^,
    P.X, P.Y) then
    Message.Result := 0
  else
    inherited;
...
procedure TdxCustomLayoutControl.DXMInvalidateSelectionLayer
...
begin
  ...
  while PeekMessage(AMSG, Handle, DXM_REFRESHCUSTOMIZATION,
    DXM_REFRESHCUSTOMIZATION, PM_REMOVE) do
    AUpdateTypes := AUpdateTypes + TdxLayoutCustomizeFormUpdateTypes
      (Byte(AMSG.WPARAM));
...
begin
  ...
  if TdxLayoutGroupViewDataAccess(AGroupViewData).ViewInfo <> nil then
    TdxLayoutGroupViewInfoAccess(TdxLayoutGroupViewDataAccess(AGroupViewData)
      .ViewInfo).UpdateScrollPos(Message.LPARAM = 0);
end;

function TdxCustomLayoutControl.CanAutoHeight: Boolean;
begin
  Result := ViewInfo.IsValid and (ViewInfo.ItemsViewInfo.AlignVert <> avClient)
    and (Anchors * [akTop, akBottom] <> [akTop, akBottom]);
end;

function TdxCustomLayoutControl.CanAutoWidth: Boolean;
begin
  Result := ViewInfo.IsValid and (ViewInfo.ItemsViewInfo.AlignHorz <> ahClient)
    and (Anchors * [akLeft, akRight] <> [akLeft, akRight]);
end;

function TdxCustomLayoutControl.CanAutoSize(var NewWidth,
...
procedure TdxCustomLayoutControl.ActionChange(Sender: TObject;
...
procedure TdxCustomLayoutControl.AlignControls(AControl: TControl;
  var Rect: TRect);
begin
end;
...
begin
  Result := not IsDesigning and (FocusOnClick or Customization) and MayFocus and
    CanFocus and IsWindowVisible(Handle) and Container.CanFocusOnClick(X, Y);
end;

procedure TdxCustomLayoutControl.ChangeScaleEx(M, D: Integer;
  IsDpiChange: Boolean);
begin
...
begin
  ...
  begin
    AControl := Controls[I];
    TControlAccess(AControl).ScalingFlags := TControlAccess(AControl)
      .ScalingFlags - [sfLeft, sfTop];
  end;
...
procedure TdxCustomLayoutControl.CreateWindowHandle(const Params
  : TCreateParams);
begin
  inherited;
...
function TdxCustomLayoutControl.FluentDesignContainerControlCanBeOpaque
  : Boolean;
begin
...
begin
  Result := TComponent(AItem1).ComponentIndex - TComponent(AItem2)
    .ComponentIndex;
end;

procedure TdxCustomLayoutControl.GetChildren(Proc: TGetChildProc;
Root: TComponent);
var
  I: Integer;
  AChilds: TList;
...
procedure TdxCustomLayoutControl.DoGetCustomizationMenuItems
  (const ASelectedItems: TList;
var AMenuItems: TdxLayoutCustomizeFormMenuItems);
begin
  if Assigned(FOnGetCustomizationMenuItems) then
    FOnGetCustomizationMenuItems(Self, ASelectedItems, AMenuItems);
end;

function TdxCustomLayoutControl.DoShowPopupMenu(AMenu: TComponent;
X, Y: Integer): Boolean;
var
...
function TdxCustomLayoutControl.GetDesignHitTest(X, Y: Integer;
Shift: TShiftState): Boolean;
var
  AHitTest: TdxCustomLayoutHitTest;
...
begin
  Result := inherited IsInternalControl(AControl) or
...
begin
  Result := RedrawOnResize and (ViewInfo.LayoutLookAndFeel <> nil) and
    ViewInfo.LayoutLookAndFeel.NeedRedrawOnResize;
end;
...
procedure TdxCustomLayoutControl.MouseDown(Button: TMouseButton;
...
begin
  if not IsLoading and not IsDestroying then
    ...
    else if TcxBitmapAccess(FLockedStateImage).IsDormant then
...
procedure TdxCustomLayoutControl.WndProc(var Message: TMessage);
  ...
  begin
    ...
    begin
      ...
      Result := (AHitTest <> nil) and (AHitTest is TdxLayoutItemHitTest) and
        TdxLayoutItemViewInfoAccess((AHitTest as TdxLayoutItemHitTest)
        .Item.ViewInfo).PtInDesignSelectorRect(P);
    end;
  end;

begin
  if FJustLoaded and FIsSizeSet and
    ((GetParentForm(Self) = nil) or not(fsCreating in GetParentForm(Self)
    .FormState)) then
  begin
    FJustLoaded := False;
    Container.EndUpdate(False);
  ...
  case Message.Msg of
    WM_SIZE:
      FIsSizeSet := True;
    WM_LBUTTONDOWN:
      if (IsDesigning or Customization) and HandleAllocated and
        (GetCapture <> Handle) and
        (Customization or PtInDesignSelectorRect
        (SmallPointToPoint(TWMMouse(Message).Pos))) then
...
function TdxCustomLayoutControl.InternalMouseWheel(Shift: TShiftState;
...
function TdxCustomLayoutControl.IsMouseWheelHandleNeeded(Shift: TShiftState;
WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
  Result := inherited IsMouseWheelHandleNeeded(Shift, WheelDelta, MousePos) or
    Container.IsMouseWheelHandleNeeded(Shift, WheelDelta,
...
begin
  if Container <> nil then { IsDestroying }
    Result := TdxCustomLayoutLookAndFeelAccess(Container.GetLayoutLookAndFeel)
      .LookAndFeel
  else
    Result := TdxCustomLayoutLookAndFeelAccess(dxLayoutDefaultLookAndFeel)
      .LookAndFeel;
end;

function TdxCustomLayoutControl.GetTouchScrollUIOwner(const APoint: TPoint)
...
procedure TdxCustomLayoutControl.ScrollBarVisibilityChanged
  (AScrollBars: TScrollBarKinds);
begin
  if not IsDestroying then
  begin
    if (FScrollChangeCount > 0) and
      (not HScrollBar.Visible and not VScrollBar.Visible) and
      TdxCustomLayoutGroupAccess(Container.Root).IsWrapItemsAllowed then
      UpdateScrollBarBounds
    else if ((Container.Root.AlignHorz in [ahClient, ahParentManaged]) and
      (sbVertical in AScrollBars) or (Container.Root.AlignVert in [avClient,
      avParentManaged]) and (sbHorizontal in AScrollBars) or
      TdxCustomLayoutGroupAccess(Container.Root).IsWrapItemsAllowed) then
    begin
...
function TdxCustomLayoutControl.GetDragAndDropObjectClass
...
begin
  if HandleAllocated then
    with R do
      PostMessage(Handle, DXM_LAYOUT_INVALIDATESELECTIONLAYER,
        MakeWParam(Left, Top), MakeLParam(Right, Bottom));
end;

procedure TdxCustomLayoutControl.CustomizeFormPostUpdate
  (AUpdateTypes: TdxLayoutCustomizeFormUpdateTypes);
begin
  if HandleAllocated and (Container <> nil) and (Container.MasterContainer = nil)
  then
...
procedure TdxCustomLayoutControl.DoGetStoredPropertyValue(const AName: string;
var AValue: Variant);
begin
...
procedure TdxCustomLayoutControl.DoSetStoredPropertyValue(const AName: string;
...
function TdxCustomLayoutControl.GetAlignmentConstraintClass
  : TdxLayoutAlignmentConstraintClass;
begin
  Result := TdxLayoutAlignmentConstraint;
end;

function TdxCustomLayoutControl.GetContainerClass
  : TdxLayoutControlContainerClass;
begin
...
begin
  Result := TdxControlsDesignSelectorHelper.CalculateBounds(ClientBounds, 3, 16,
    ScaleFactor);
end;
...
procedure TdxCustomLayoutControl.PostLayoutChanged
  (AType: TdxChangeType = ctHard);
begin
  PostMessage(Handle, DXM_LAYOUT_LAYOUTCHANGED, Integer(AType), 0)
end;

function TdxCustomLayoutControl.OldLoadFromIniFile(const AFileName
  : string): Boolean;
var
...
function TdxCustomLayoutControl.OldLoadFromRegistry(const ARegistryPath
  : string): Boolean;
var
...
function TdxCustomLayoutControl.CreateFieldControls(X, Y: Integer;
ADataSource: TObject { TDataSource }; AFieldList: TList): Boolean;
begin
  Result := False;
end;

procedure TdxCustomLayoutControl.DoCreateFieldControl(AControl: TControl;
AField: TObject { TField } );
var
  AItem: TdxLayoutItem;
begin
...
begin
  Result := IsWindowVisible(Handle) and PtInRect(ClientBounds, P) and
    not(Container.IsDesignSelectorsVisible and
    PtInRect(GetDesignSelectorRect, P));
end;

function TdxCustomLayoutControl.CanProcessKeyboard: Boolean;
begin
  Result := (dxLayoutDragAndDropObject = nil) and
    (dxLayoutSizingDragAndDropObject = nil) and not FIsPopupShown;
end;
...
function TdxCustomLayoutControl.CreateAlignmentConstraint
  : TdxLayoutAlignmentConstraint;
begin
...
function TdxCustomLayoutControl.FindItem(AControlHandle: THandle)
  : TdxLayoutItem;
begin
  Result := Container.FindItem(AControlHandle);
end;

function TdxCustomLayoutControl.FindItem(const AName: string)
  : TdxCustomLayoutItem;
begin
  Result := Container.FindItem(AName);
end;

function TdxCustomLayoutControl.GetHitTest(const P: TPoint)
  : TdxCustomLayoutHitTest;
begin
  Result := Container.GetHitTest(P);
end;

function TdxCustomLayoutControl.GetHitTest(X, Y: Integer)
  : TdxCustomLayoutHitTest;
begin
...
begin
  ...
  begin
    ...
    cxPaintControlTo(Self, FLockedStateImage.cxCanvas, cxNullPoint, Bounds,
      False, False);
  end;
  Container.BeginUpdate;
end;
...
function TdxCustomLayoutControl.CreateItem(AItemClass
...
begin
  Result := OptionsStoring.CanRestoreFromIniFile or
    OptionsStoring.CanRestoreFromRegistry or (FStoredStream.Size > 0);
end;
...
begin
  ...
  else if OptionsStoring.CanRestoreFromIniFile then
...
constructor TdxCustomLayoutControlHandler.Create
...
begin
  if not ViewInfo.IsTransparent then
    ViewInfo.LayoutLookAndFeel.DrawLayoutControlBackground(ACanvas,
...
procedure TdxLayoutControlPainter.DrawContent(ACanvas: TcxCanvas);
  ...
  begin
    if Control.Container.IsDesignSelectorsVisible then
      cxDrawDesignRect(ACanvas, Control.GetDesignSelectorRect,
        Control.Container.IsComponentSelected(Control));
  end;
...
function TdxLayoutControlViewInfo.GetContainerViewInfo
  : TdxLayoutControlContainerViewInfo;
begin
...
function TdxLayoutControlViewInfo.GetLayoutLookAndFeel
  : TdxCustomLayoutLookAndFeel;
begin
  if ContainerViewInfo <> nil then
...
begin
  Result := (ItemsViewInfo <> nil) and TdxCustomLayoutItemViewInfoAccess
    (ItemsViewInfo).IsValid;
end;
...
var
  ...
  var
    ...
    var
      ...
      begin
        with TdxCustomLayoutItemViewInfoAccess
          (AItemViewInfos[AItemViewInfoIndex]) do
  ...
  begin
    ...
    try
      ...
      while not AlignItemViewInfos do
      // !!! to think about invisible items if items will be deleted
      begin
        ResetOffsets;
...
procedure TdxLayoutControlViewInfo.InvalidateRect(const R: TRect;
...
function TdxLayoutControlViewInfo.GetItemWithMouse(const P: TPoint)
  : TdxCustomLayoutItem;
begin
