...
uses
  ...
  cxGraphics, dxGDIPlusClasses, cxGeometry, cxControls, cxLookAndFeels,
  cxLookAndFeelPainters, cxClasses, cxContainer,
...
type
  ...
  published
    ...
    property Position: TdxToggleSwitchStateIndicatorPosition read FPosition
      write SetPosition default sipOutside;
  end;
  ...
  protected
    ...
    property SmoothToggle: Boolean read FSmoothToggle write SetSmoothToggle
      default True;
    property StateIndicator: TdxToggleSwitchStateIndicator read FStateText
      write SetStateText;
  public
  ...
  protected
    ...
    function CalculateOffIndicatorRect(AViewInfo: TdxCustomToggleSwitchViewInfo)
      : TRect; virtual;
    function CalculateOnIndicatorRect(AViewInfo: TdxCustomToggleSwitchViewInfo)
      : TRect; virtual;
    procedure CalculateStateTextFont(AViewInfo
      : TdxCustomToggleSwitchViewInfo); virtual;
    procedure CalculateStateIndicatorRectSizes
      (AViewInfo: TdxCustomToggleSwitchViewInfo); virtual;
    procedure CalculateStateIndicatorSizes
      (AViewInfo: TdxCustomToggleSwitchViewInfo); virtual;
    function CalculateThumbBounds(AViewInfo: TdxCustomToggleSwitchViewInfo)
      : TRect; virtual;
    function CalculateToggleSwitchSize(AViewInfo: TdxCustomToggleSwitchViewInfo)
      : TSize; virtual;
    function GetStateIndicatorGap(AViewInfo: TdxCustomToggleSwitchViewInfo)
      : Integer; virtual;
  public
  ...
  protected
    ...
    class function GetContentOffset(AIsInplace, AIsCaptionVisible: Boolean;
      AItemAlignment: TLeftRight; AScaleFactor: TdxScaleFactor): TRect;
      override;
    ...
    property OffIndicatorRect: TRect read FOffIndicatorRect
      write FOffIndicatorRect;
    property OnText: string read FOnText write FOnText;
    property OnIndicatorRect: TRect read FOnIndicatorRect
      write FOnIndicatorRect;
    property StateIndicatorPosition: TdxToggleSwitchStateIndicatorPosition
      read FStateIndicatorPosition write FStateIndicatorPosition;
    property StateIndicatorKind: TdxToggleSwitchStateIndicatorKind
      read FStateIndicatorKind write FStateIndicatorKind;
  ...
  public
    ...
    property ToggleSwitchBounds: TRect read FToggleSwitchBounds
      write FToggleSwitchBounds;
  end;
  ...
  protected
    ...
    property ActiveProperties: TdxCustomToggleSwitchProperties
  ...
  public
    class function GetPropertiesClass: TcxCustomEditPropertiesClass; override;
    property ActiveProperties: TdxToggleSwitchProperties
      read GetActiveProperties;
  published
    property Action;
    property Anchors;
    ...
    property PopupMenu;
    property Properties: TdxToggleSwitchProperties read GetProperties
      write SetProperties;
    property ShowHint;
    property Style;
...
procedure TdxToggleSwitchThumbFadingHelper.GetFadingImages(out AFadeOutImage,
  ...
  begin
    ...
    GetToggleSwitchViewInfo.DrawThumb(Result.cxCanvas,
...
function TdxToggleSwitchThumbFadingHelper.GetToggleSwitchViewInfo
...
procedure TdxCustomToggleSwitch.DoProcessEventsOnViewInfoChanging;
  ...
  begin
    Result := (FThumbDragged and
      (ViewInfo.ThumbDelta > Round(ViewInfo.ThumbMaxDelta / 2))) or
      (not FThumbDragged and (ViewInfo.CheckBoxState = ecsHot));
  end;

begin
  if (IsInplace or Focused) and (ViewInfo.CheckBoxLastState = ecsPressed) and
    (ViewInfo.CheckBoxState <> ecsPressed) and not ActiveProperties.ReadOnly
  then
  begin
    ...
    else if ViewInfo.CheckBoxState = ecsHot then
      Toggle;
  end;
end;

procedure TdxCustomToggleSwitch.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  if not IsInplace and (Button = mbLeft) then
    StopAnimation;
  inherited MouseDown(Button, Shift, X, Y);
  ViewInfo.ThumbCapture := Focused and not ActiveProperties.ReadOnly and
    (Button = mbLeft) and cxRectPtIn(ViewInfo.ThumbBounds, X, Y);
...
begin
  if not IsInplace and ActiveProperties.SmoothToggle and
    ViewInfo.ThumbCapture and (Abs(X - FPrevMousePos) > 0) then
  begin
...
procedure TdxCustomToggleSwitch.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
function TdxCustomToggleSwitch.GetActiveProperties
...
class function TdxCustomToggleSwitch.GetPropertiesClass
...
procedure TdxCustomToggleSwitch.SetProperties
  (Value: TdxCustomToggleSwitchProperties);
begin
...
procedure TdxToggleSwitchStateIndicator.SetKind
  (AValue: TdxToggleSwitchStateIndicatorKind);
begin
...
procedure TdxToggleSwitchStateIndicator.SetPosition
  (AValue: TdxToggleSwitchStateIndicatorPosition);
begin
...
procedure TdxCustomToggleSwitchProperties.DoAssign
...
class function TdxCustomToggleSwitchProperties.GetContainerClass
  : TcxContainerClass;
begin
  Result := TdxToggleSwitch;
end;

class function TdxCustomToggleSwitchProperties.GetViewInfoClass
  : TcxContainerViewInfoClass;
begin
  Result := TdxCustomToggleSwitchViewInfo;
end;

class function TdxCustomToggleSwitchProperties.GetViewDataClass
...
procedure TdxCustomToggleSwitchProperties.SetStateText
  (AValue: TdxToggleSwitchStateIndicator);
begin
  FStateText.Assign(AValue);
  Changed;
end;

procedure TdxCustomToggleSwitchProperties.StateTextChangedHandler
  (Sender: TObject);
begin
  Changed;
end;
...
begin
  ...
  AToggleSwitchViewInfo.StateIndicatorPosition :=
    AProperties.StateIndicator.Position;
  AToggleSwitchViewInfo.StateIndicatorKind := AProperties.StateIndicator.Kind;
  AToggleSwitchViewInfo.CheckBoxSize := CalculateToggleSwitchSize
    (AToggleSwitchViewInfo);
  ...
  AToggleSwitchViewInfo.CheckBoxRect :=
    CalculateCheckBoxRect(AToggleSwitchViewInfo);
  AToggleSwitchViewInfo.TextRect := CalculateTextRect(AToggleSwitchViewInfo);
  AToggleSwitchViewInfo.ToggleSwitchBounds :=
    AToggleSwitchViewInfo.CheckBoxRect;
  AToggleSwitchViewInfo.ThumbBounds :=
    CalculateThumbBounds(AToggleSwitchViewInfo);
  ...
  if UseRightToLeftAlignment then
  begin
    AToggleSwitchViewInfo.OffIndicatorRect :=
      CalculateIndicatorRect(AToggleSwitchViewInfo,
      AToggleSwitchViewInfo.OffIndicatorRectSize, taRightJustify);
    AToggleSwitchViewInfo.OnIndicatorRect :=
      CalculateIndicatorRect(AToggleSwitchViewInfo,
...
function TdxCustomToggleSwitchViewData.GetTextGap(AIsInplace,
  ANativeStyle: Boolean; AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := TdxCustomToggleSwitchViewInfo.GetTextGap(AIsInplace, ANativeStyle,
    AScaleFactor);
end;

function TdxCustomToggleSwitchViewData.GetContentOffset(AIsCaptionVisible
  : Boolean): TRect;
begin
  Result := TdxCustomToggleSwitchViewInfo.GetContentOffset(IsInplace,
    AIsCaptionVisible, Alignment, ScaleFactor);
end;

function TdxCustomToggleSwitchViewData.CalculateCheckBoxRect
...
begin
  ...
  AToggleSwitchViewInfo := TdxCustomToggleSwitchViewInfo(AViewInfo);
  if (AToggleSwitchViewInfo.StateIndicatorKind <> sikNone) and
      ...
      taLeftJustify:
        if AToggleSwitchViewInfo.GetLeftIndicatorWidth > 0 then
          Result := cxRectSetLeft(Result,
            Result.Left + AToggleSwitchViewInfo.GetLeftIndicatorWidth +
            GetStateIndicatorGap(AToggleSwitchViewInfo));
      taRightJustify:
        if AToggleSwitchViewInfo.GetRightIndicatorWidth > 0 then
          Result := cxRectSetRight(Result,
            Result.Right - AToggleSwitchViewInfo.GetRightIndicatorWidth -
            GetStateIndicatorGap(AToggleSwitchViewInfo));
    end;
  end;
end;

function TdxCustomToggleSwitchViewData.CalculateCheckBoxState
...
function TdxCustomToggleSwitchViewData.CalculateTextRect
  (AViewInfo: TcxCustomCheckBoxViewInfo): TRect;
var
  AToggleSwitchViewInfo: TdxCustomToggleSwitchViewInfo;
begin
  ...
  AToggleSwitchViewInfo := TdxCustomToggleSwitchViewInfo(AViewInfo);
  if (cxRectWidth(Result) > 0) and (AToggleSwitchViewInfo.StateIndicatorKind <>
    sikNone) and (AToggleSwitchViewInfo.StateIndicatorPosition = sipOutside)
  then
    case AViewInfo.Alignment of
      taLeftJustify:
        if AToggleSwitchViewInfo.GetRightIndicatorWidth > 0 then
          Result.Left := Result.Left +
            AToggleSwitchViewInfo.GetRightIndicatorWidth +
            GetStateIndicatorGap(AToggleSwitchViewInfo);
      taRightJustify:
        if AToggleSwitchViewInfo.GetLeftIndicatorWidth > 0 then
          Result.Right := Result.Right -
            AToggleSwitchViewInfo.GetLeftIndicatorWidth -
            GetStateIndicatorGap(AToggleSwitchViewInfo);
    end;
end;

function TdxCustomToggleSwitchViewData.InternalGetEditConstantPartSize
...
begin
  ...
  AToggleSwitchViewInfo := TdxCustomToggleSwitchViewInfo(AViewInfo);
  if AIsInplace then
    ASize1 := ScaleFactor.Apply(cxSize(dxToggleSwitchDefaultWidth,
      dxToggleSwitchInplaceHeight))
  else
  ...
  begin
    ...
    Result := cxSize(AExtend.Left + AExtend.Right,
      AExtend.Top + AExtend.Bottom);
  end
  else
  begin
  ...
  begin
    if AToggleSwitchViewInfo.OffIndicatorSize.cx > 0 then
      Inc(Result.cx, AToggleSwitchViewInfo.OffIndicatorSize.cx +
        GetStateIndicatorGap(AToggleSwitchViewInfo));
    if AToggleSwitchViewInfo.OnIndicatorSize.cx > 0 then
      Inc(Result.cx, AToggleSwitchViewInfo.OnIndicatorSize.cx +
        GetStateIndicatorGap(AToggleSwitchViewInfo));

    MinContentSize.cy := Max(MinContentSize.cy,
      Max(AToggleSwitchViewInfo.OnIndicatorSize.cy,
      AToggleSwitchViewInfo.OffIndicatorSize.cy));
  end;
  AOffset := GetContentOffset(True);
  Inc(Result.cx, ASize1.cx + AOffset.Left + AOffset.Right);
end;

function TdxCustomToggleSwitchViewData.CalculateIndicatorRect
  (AViewInfo: TdxCustomToggleSwitchViewInfo; AIndicatorSize: TSize;
  AAlign: TLeftRight): TRect;
begin
  ...
  begin
    case AViewInfo.StateIndicatorPosition of
      sipInside:
        begin
          Result := cxRectCenterVertically(AViewInfo.CheckBoxRect,
            AIndicatorSize.cy);
          Result := cxRectSetWidth(Result, AIndicatorSize.cx);
          if AAlign = taLeftJustify then
            Result := cxRectSetRight(Result, AViewInfo.CheckBoxRect.Right -
              GetStateIndicatorGap(AViewInfo))
          else
            Result := cxRectSetLeft(Result, AViewInfo.CheckBoxRect.Left +
              GetStateIndicatorGap(AViewInfo));
        end;
      sipOutside:
        begin
          Result := cxRectCenterVertically(AViewInfo.ClientRect,
            AIndicatorSize.cy);
          Result := cxRectSetWidth(Result, AIndicatorSize.cx);
          if AAlign = taLeftJustify then
            Result := cxRectSetRight(Result, AViewInfo.CheckBoxRect.Left -
              GetStateIndicatorGap(AViewInfo))
          else
            Result := cxRectSetLeft(Result, AViewInfo.CheckBoxRect.Right +
              GetStateIndicatorGap(AViewInfo));
        end;
    end;
...
function TdxCustomToggleSwitchViewData.CalculateOffIndicatorRect
  (AViewInfo: TdxCustomToggleSwitchViewInfo): TRect;
begin
  Result := CalculateIndicatorRect(AViewInfo, AViewInfo.OffIndicatorRectSize,
    taLeftJustify);
end;

function TdxCustomToggleSwitchViewData.CalculateOnIndicatorRect
  (AViewInfo: TdxCustomToggleSwitchViewInfo): TRect;
begin
  Result := CalculateIndicatorRect(AViewInfo, AViewInfo.OnIndicatorRectSize,
    taRightJustify);
end;

procedure TdxCustomToggleSwitchViewData.CalculateStateTextFont
  (AViewInfo: TdxCustomToggleSwitchViewInfo);
begin
  AViewInfo.NormalStateTextFont.Assign(AViewInfo.Font);
  AViewInfo.ActiveStateTextFont.Assign(AViewInfo.Font);
end;

procedure TdxCustomToggleSwitchViewData.CalculateStateIndicatorRectSizes
  (AViewInfo: TdxCustomToggleSwitchViewInfo);
var
  ATextGap: Integer;
  AFactorX: Single;
...
begin
  if (AViewInfo.OffIndicatorSize.cx = 0) and (AViewInfo.OnIndicatorSize.cx = 0)
  then
  begin
  ...
  begin
    ...
    AStateIndicatorWidth := AViewInfo.OffIndicatorSize.cx +
      AViewInfo.OnIndicatorSize.cx;
    case AViewInfo.StateIndicatorPosition of
      sipInside:
        begin
          AFactorX :=
            Min(1, (AViewInfo.CheckBoxSize.cx - 3 * GetStateIndicatorGap
            (AViewInfo)) / AStateIndicatorWidth);
          AStateIndicatorMaxSizeY := AViewInfo.CheckBoxSize.cy;
        end;
      sipOutside:
        begin
          AStateIndicatorPlaceWidth :=
            (cxRectWidth(AViewInfo.ClientRect) - AViewInfo.CheckBoxSize.cx -
            ATextGap);
          if AViewInfo.OffIndicatorSize.cx > 0 then
            AStateIndicatorPlaceWidth := AStateIndicatorPlaceWidth -
              GetStateIndicatorGap(AViewInfo);
    ...
    AViewInfo.OffIndicatorRectSize.cx :=
      Trunc(AViewInfo.OffIndicatorSize.cx * AFactorX);
    AViewInfo.OnIndicatorRectSize.cx :=
      Trunc(AViewInfo.OnIndicatorSize.cx * AFactorX);
    AViewInfo.OffIndicatorRectSize.cy := Min(AViewInfo.OffIndicatorSize.cy,
      AStateIndicatorMaxSizeY);
    AViewInfo.OnIndicatorRectSize.cy := Min(AViewInfo.OnIndicatorSize.cy,
      AStateIndicatorMaxSizeY);
  end;
end;

procedure TdxCustomToggleSwitchViewData.CalculateStateIndicatorSizes
  (AViewInfo: TdxCustomToggleSwitchViewInfo);
begin
  case AViewInfo.StateIndicatorKind of
    sikText:
      begin
        AViewInfo.OffIndicatorSize.cx :=
          Max(cxTextWidth(AViewInfo.NormalStateTextFont, AViewInfo.OffText),
          cxTextWidth(AViewInfo.ActiveStateTextFont, AViewInfo.OffText));
        AViewInfo.OnIndicatorSize.cx :=
          Max(cxTextWidth(AViewInfo.NormalStateTextFont, AViewInfo.OnText),
          cxTextWidth(AViewInfo.ActiveStateTextFont, AViewInfo.OnText));
        AViewInfo.OffIndicatorSize.cy :=
          Max(TdxTextMeasurer.TextLineHeight(AViewInfo.NormalStateTextFont),
          TdxTextMeasurer.TextLineHeight(AViewInfo.ActiveStateTextFont));
        AViewInfo.OnIndicatorSize.cy :=
          Max(TdxTextMeasurer.TextLineHeight(AViewInfo.NormalStateTextFont),
          TdxTextMeasurer.TextLineHeight(AViewInfo.ActiveStateTextFont));
      end;
    sikGlyph:
      begin
        AViewInfo.OffIndicatorSize := dxGetImageSize(AViewInfo.FOffGlyph,
          ScaleFactor);
        AViewInfo.OnIndicatorSize := dxGetImageSize(AViewInfo.FOnGlyph,
          ScaleFactor);
      end;
    sikNone:
      begin
...
function TdxCustomToggleSwitchViewData.CalculateThumbBounds
  (AViewInfo: TdxCustomToggleSwitchViewInfo): TRect;
var
  ASize: TSize;
  ABounds: TRect;
begin
  ...
  ASize.cx := Round(AViewInfo.CheckBoxSize.cx *
    AViewInfo.Painter.GetToggleSwitchThumbPercentsWidth / 100);
  ...
  case AViewInfo.State of
    ...
    cbsChecked:
      Result := cxRectSetLeft(Result, ABounds.Right - ASize.cx -
        AViewInfo.ThumbDelta);
  else
    Result := cxRectSetLeft(Result, ABounds.Left +
      (cxRectWidth(ABounds) - ASize.cx) div 2);
  end;
end;

function TdxCustomToggleSwitchViewData.CalculateToggleSwitchSize
  (AViewInfo: TdxCustomToggleSwitchViewInfo): TSize;
var
...
function TdxCustomToggleSwitchViewData.GetStateIndicatorGap
  (AViewInfo: TdxCustomToggleSwitchViewInfo): Integer;
begin
  case AViewInfo.StateIndicatorPosition of
    sipOutside:
    ...
    sipInside:
      Result := ScaleFactor.Apply
        (dxDefaultToggleSwitchInsideStateIndicatorOffset);
  else
    Result := 0;
  end;
end;
...
function TdxCustomToggleSwitchViewData.GetProperties
  : TdxCustomToggleSwitchProperties;
begin
...
class function TdxCustomToggleSwitchViewInfo.GetContentOffset(AIsInplace,
...
class function TdxCustomToggleSwitchViewInfo.GetTextGap(AIsInplace,
  ANativeStyle: Boolean; AScaleFactor: TdxScaleFactor): Integer;
begin
...
begin
  ...
  if Alignment <> taCenter then
    DrawCheckBoxText(ACanvas, Text, Font, TextColor, TextRect, DrawTextFlags,
      IsTextEnabled);
  Painter.DrawScaledToggleSwitch(ACanvas, ToggleSwitchBounds, ThumbState,
    ThumbBounds, ScaleFactor);
...
begin
  Result := (ThumbDelta <> 0) or (State <> cbsChecked) or
    (StateIndicatorPosition <> sipInside);
end;

function TdxCustomToggleSwitchViewInfo.NeedShowOnIndicator: Boolean;
begin
  Result := (ThumbDelta <> 0) or (State <> cbsUnchecked) or
    (StateIndicatorPosition <> sipInside);
end;

function TdxCustomToggleSwitchViewInfo.GetCheckControlFadingHelperClass
...
procedure TdxCustomToggleSwitchViewInfo.DrawStateGlyph(ACanvas: TcxCanvas);
  ...
  begin
    Result := ARect;
    Result := cxRectSetLeft(Result,
      Result.Left + (cxRectWidth(Result) - ASize.cx) div 2);
    Result := cxRectSetTop(Result,
      Result.Top + (cxRectHeight(Result) - ASize.cy) div 2);
    Result := cxRectSetSize(Result, ASize);
  end;

  procedure InternalDrawGlyph(AGlyph: TdxSmartGlyph;
    const AIndicatorRect: TRect; const AIndicatorSize: TSize);
  begin
    ...
    begin
      ...
      try
        ...
        AGlyph.StretchDraw(ACanvas.Handle, GetDrawingRect(AIndicatorRect,
          AIndicatorSize), MaxByte, Painter.GetToggleSwitchColorPalette);
      finally
...
begin
  if not cxRectIsNull(OffIndicatorRect) and NeedShowOffIndicator then
    if State = cbsUnchecked then
      Painter.DrawToggleSwitchStateIndicator(ACanvas, OffIndicatorRect, OffText,
        ActiveStateTextFont)
    else
      Painter.DrawToggleSwitchStateIndicator(ACanvas, OffIndicatorRect, OffText,
        NormalStateTextFont);
  ...
  if not cxRectIsNull(OnIndicatorRect) and NeedShowOnIndicator then
    if State = cbsChecked then
      Painter.DrawToggleSwitchStateIndicator(ACanvas, OnIndicatorRect, OnText,
        ActiveStateTextFont)
    else
      Painter.DrawToggleSwitchStateIndicator(ACanvas, OnIndicatorRect, OnText,
        NormalStateTextFont);
...
procedure TdxCustomToggleSwitchViewInfo.DrawThumb(ACanvas: TcxCanvas;
  AClientRect: TRect; AState: TcxButtonState);
begin
  Painter.DrawScaledToggleSwitchThumb(ACanvas, AClientRect, AState,
    ScaleFactor);
end;
...
GetRegisteredEditProperties.Register(TdxToggleSwitchProperties,
  scxSEditRepositoryToggleSwitchItem);
FilterEditsController.Register(TdxToggleSwitchProperties,
  TcxFilterCheckBoxHelper);

finalization

FilterEditsController.Unregister(TdxToggleSwitchProperties,
  TcxFilterCheckBoxHelper);
