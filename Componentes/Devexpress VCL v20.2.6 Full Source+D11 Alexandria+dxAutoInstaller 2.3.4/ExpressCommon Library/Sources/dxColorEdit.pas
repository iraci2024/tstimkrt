...
type
  ...
  public
    ...
    property ActiveProperties: TdxCustomColorEditProperties
...
begin
  ...
  TcxColorComboBoxHelper.DrawColorBox(ACanvas, ClientRect, clBtnShadow, FColor,
    BackgroundColor, cxdcColor, ScaleFactor);
...
procedure TdxCustomColorEditViewData.DisplayValueToDrawValue(const ADisplayValue
...
procedure TdxCustomColorEditViewData.EditValueToDrawValue(const AEditValue
  : TcxEditValue; AViewInfo: TcxCustomEditViewInfo);
begin
  (AViewInfo as TdxCustomColorEditViewInfo).FColor :=
    Properties.EditValueToColorValue(AEditValue);
end;
...
class function TdxCustomColorEditProperties.GetContainerClass
  : TcxContainerClass;
begin
  Result := TdxColorEdit;
end;

class function TdxCustomColorEditProperties.GetViewInfoClass
  : TcxContainerViewInfoClass;
begin
  Result := TdxCustomColorEditViewInfo;
end;

procedure TdxCustomColorEditProperties.DoAssign(AProperties
...
class function TdxCustomColorEditProperties.GetLookupDataClass
...
class function TdxCustomColorEditProperties.GetViewDataClass
...
function TdxCustomColorEditProperties.EditValueToColorValue
  (AEditValue: TcxEditValue): TColor;
begin
...
procedure TdxPopupColorGallery.HidePopup(Sender: TcxControl;
...
class function TdxCustomColorEdit.GetPropertiesClass
...
begin
  ...
  TdxCustomColorGalleryAccess(FColorGallery)
    .SetColorParams(ActiveProperties.ColorPalette, ActiveProperties.ColorSet,
...
procedure TdxCustomColorEdit.ItemClickHandler(Sender: TObject;
