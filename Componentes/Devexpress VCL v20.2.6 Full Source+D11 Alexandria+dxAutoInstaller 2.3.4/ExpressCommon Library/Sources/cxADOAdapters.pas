...
cxDetailFilterControllers.RegisterAdapter(TCustomADODataSet,
  TcxADOProviderDetailFilterAdapter);
cxFilterOperatorAdapters.RegisterAdapter(TCustomADODataSet,
  TcxADOFilterOperatorAdapter);

finalization

cxDetailFilterControllers.UnregisterAdapter(TCustomADODataSet,
  TcxADOProviderDetailFilterAdapter);
cxFilterOperatorAdapters.UnregisterAdapter(TCustomADODataSet,
  TcxADOFilterOperatorAdapter);
