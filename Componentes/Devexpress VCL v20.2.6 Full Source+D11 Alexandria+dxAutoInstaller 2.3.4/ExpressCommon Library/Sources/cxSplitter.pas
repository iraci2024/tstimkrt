...
{$ENDIF}
  ...
  ExtCtrls,
  cxGeometry, dxMessages, cxClasses, cxControls, cxExtEditConsts,
  cxExtEditUtils, cxGraphics,
...
type
  ...
  TcxSplitterDirection = (cxsdLeftToRight, cxsdRightToLeft, cxsdTopToBottom,
    cxsdBottomToTop);

  TBeforeCloseHotZoneEvent = procedure(Sender: TObject; var AllowClose: Boolean)
    of object;
  TBeforeOpenHotZoneEvent = procedure(Sender: TObject; var NewSize: Integer;
    var AllowOpen: Boolean) of object;
...
type
  ...
  public
    ...
    //
    property SizePercent: TcxNaturalNumber read FSizePercent
      write SetSizePercent default 30;
  ...
  published
    ...
    property ArrowHighlightColor: TColor read FArrowHighlightColor
      write SetArrowHighlightColor default clBlue;
    property LightColor: TColor read FLightColor write SetLightColor
      default clWindow;
    property BorderColor: TColor read FBorderColor write SetBorderColor
      default clBtnShadow;
    property ShadowStartColor: TColor read FShadowStartColor
      write SetShadowStartColor default $00F5E6CD;
  ...
  published
    ...
    property ArrowColor: TColor read FArrowColor write SetArrowColor
      default clWindowText;
    property ArrowHighlightColor: TColor read FArrowHighlightColor
      write SetArrowHighlightColor default clWindow;
    property LightColor: TColor read FLightColor write SetLightColor
      default clWindow;
  ...
  published
    ...
    property ShadowColor: TColor read FShadowColor write SetShadowColor
      default clBtnShadow;
    property DotsColor: TColor read FDotsColor write SetDotsColor
      default clHighlight;
    property DotsShadowColor: TColor read FDotsShadowColor
      write SetDotsShadowColor default clWindow;
  end;
  ...
  private
    ...
    procedure DXMAdjustPosition(var Message: TMessage);
      message DXM_ADJUSTPOSITION;
  ...
  protected
    ...
    property AllowHotZoneDrag: Boolean read FAllowHotZoneDrag
      write SetAllowHotZoneDrag default True;
    property Control: TControl read FControl write SetControl;
    property DragThreshold: TcxNaturalNumber read FDragThreshold
      write SetDragThreshold default 3;
    property InvertDirection: Boolean read FInvertDirection
      write SetInvertDirection default False;
    property MinSize: TcxNaturalNumber read FMinSize write SetMinSize
      default 30;
    property NativeBackground: Boolean read FNativeBackground
      write SetNativeBackground default True;
    property PositionAfterOpen: TcxPositionAfterOpen read FPositionAfterOpen
      write SetPositionAfterOpen default 30;
    property ResizeUpdate: Boolean read FResizeUpdate write FResizeUpdate
      default False;
    ...
    property OnBeforeOpen: TBeforeOpenHotZoneEvent read FOnBeforeOpen
      write FOnBeforeOpen;
    property OnAfterOpen: TNotifyEvent read FOnAfterOpen write FOnAfterOpen;
    property OnBeforeClose: TBeforeCloseHotZoneEvent read FOnBeforeClose
  ...
  published
    property HotZoneClassName: string read GetHotZoneClassName
      write SetHotZoneClassName;
    property HotZone: TcxHotZoneStyle read FHotZone write SetHotZone;
    property HotZoneEvents: TNotifyEvent read FHotZoneEvents
      write FHotZoneEvents;
  end;
...
procedure DrawSplitterDots(ACanvas: TcxCanvas; const ARect: TRect;
  AClicked, AFromLeftTop: Boolean; ALightColor, AShadowColor: TColor;
  ASplitterDirection: TcxSplitterDirection; ABetweenPoints, AIndent: Integer;
...
begin
  ...
  begin
    if (ASplitterDirection = cxsdLeftToRight) or
      (ASplitterDirection = cxsdRightToLeft) then
    begin
...
procedure DrawHotZoneArrow(ACanvas: TcxCanvas; const ARect: TRect;
  const AHighlighted, AClicked: Boolean;
  const ArrowColor, ArrowHighlightColor: TColor;
  ...
  case ASplitterDirection of
    cxsdLeftToRight:
      ...
      begin
        ...
        DrawCanvasLine(ACanvas.Canvas, ALocalArrowColor,
          Point(ARect.Left + AScaleFactor.Apply(4) - I + ADelta,
          ARect.Top + ACenter - I), Point(ARect.Left + AScaleFactor.Apply(6) -
          I, ARect.Top + ACenter - I));
        DrawCanvasLine(ACanvas.Canvas, ALocalArrowColor,
          Point(ARect.Left + AScaleFactor.Apply(4) - I + ADelta,
          ARect.Top + ACenter + I), Point(ARect.Left + AScaleFactor.Apply(6) -
          I, ARect.Top + ACenter + I));
    ...
    cxsdRightToLeft:
      ...
      begin
        ...
        DrawCanvasLine(ACanvas.Canvas, ALocalArrowColor,
          Point(ARect.Left + AScaleFactor.Apply(2) + I,
          ARect.Top + ACenter - I), Point(ARect.Left + AScaleFactor.Apply(4) + I
          + ADelta, ARect.Top + ACenter - I));
        DrawCanvasLine(ACanvas.Canvas, ALocalArrowColor,
          Point(ARect.Left + AScaleFactor.Apply(2) + I,
          ARect.Top + ACenter + I), Point(ARect.Left + AScaleFactor.Apply(4) + I
          + ADelta, ARect.Top + ACenter + I));
    ...
    cxsdTopToBottom:
      ...
      begin
        ...
        DrawCanvasLine(ACanvas.Canvas, ALocalArrowColor,
          Point(ARect.Left + ACenter - I, ARect.Top + AScaleFactor.Apply(4) - I
          + ADelta), Point(ARect.Left + ACenter - I,
          ARect.Top + AScaleFactor.Apply(6) - I));
        DrawCanvasLine(ACanvas.Canvas, ALocalArrowColor,
          Point(ARect.Left + ACenter + I, ARect.Top + AScaleFactor.Apply(4) - I
          + ADelta), Point(ARect.Left + ACenter + I,
          ARect.Top + AScaleFactor.Apply(6) - I));
    ...
    cxsdBottomToTop:
      ...
      begin
        ...
        DrawCanvasLine(ACanvas.Canvas, ALocalArrowColor,
          Point(ARect.Left + ACenter - I, ARect.Top + AScaleFactor.Apply(2) +
          I), Point(ARect.Left + ACenter - I, ARect.Top + AScaleFactor.Apply(4)
          + I + ADelta));
        DrawCanvasLine(ACanvas.Canvas, ALocalArrowColor,
          Point(ARect.Left + ACenter + I, ARect.Top + AScaleFactor.Apply(2) +
          I), Point(ARect.Left + ACenter + I, ARect.Top + AScaleFactor.Apply(4)
...
begin
  ARect := ABounds;
  if (SplitterDirection = cxsdLeftToRight) or
    (SplitterDirection = cxsdRightToLeft) then
  begin
...
function TcxMediaPlayer9Style.DrawHotZone(ACanvas: TcxCanvas;
  const ARect: TRect; const AHighlighted, AClicked: Boolean): TRect;
begin
...
begin
  ...
  if (SplitterDirection = cxsdLeftToRight) or
    (SplitterDirection = cxsdRightToLeft) then
  begin
    FArrowRect := Rect(Result.Left, Result.Top + (cxRectHeight(Result) div 2) -
      ScaleFactor.Apply(7), Result.Left + ScaleFactor.Apply(SplitterDefaultSize)
      - 1, Result.Top + (cxRectHeight(Result) div 2) + ScaleFactor.Apply(7))
  end
  else
  begin
    FArrowRect := Rect(Result.Left + (cxRectWidth(Result) div 2) -
      ScaleFactor.Apply(7), Result.Top,
...
procedure TcxMediaPlayer9Style.DrawBackground(ACanvas: TcxCanvas;
  const ARect: TRect; const AHighlighted, AClicked: Boolean);
var
...
begin
  ...
  case SplitterDirection of
    cxsdLeftToRight, cxsdRightToLeft:
      begin
        DrawCanvasLine(ACanvas.Canvas, LightColor,
          Point(ARect.Left + 2, ARect.Top + 1),
          Point(ARect.Right - 1, ARect.Top + 1));
        DrawCanvasLine(ACanvas.Canvas, LightColor,
          Point(ARect.Left + 2, ARect.Bottom - 1),
          Point(ARect.Right - 1, ARect.Bottom - 1));

        if AClicked then
          FillGradientRect(ACanvas.Handle, cxRect(ARect.Left + 1, ARect.Top,
            cxRectCenter(ARect).X, ARect.Bottom), ALocalShadowColor2,
            ALocalShadowColor, True)
        else
          FillGradientRect(ACanvas.Handle, cxRect(cxRectCenter(ARect).X + 1,
            ARect.Top + 2, ARect.Right, ARect.Bottom), ALocalShadowColor,
            ALocalShadowColor2, True);

        DrawCanvasLine(ACanvas.Canvas, BorderColor,
          Point(ARect.Left + 1, ARect.Top), Point(ARect.Right, ARect.Top));
        DrawCanvasLine(ACanvas.Canvas, BorderColor,
    ...
    cxsdTopToBottom, cxsdBottomToTop:
      begin
        DrawCanvasLine(ACanvas.Canvas, LightColor,
          Point(ARect.Left + 1, ARect.Top + 2),
        ...
        if AClicked then
          FillGradientRect(ACanvas.Handle, cxRect(ARect.Left + 1,
            cxRectCenter(ARect).Y, ARect.Right, ARect.Bottom),
            ALocalShadowColor2, ALocalShadowColor, True)
        else
          FillGradientRect(ACanvas.Handle, cxRect(ARect.Left + 2,
            cxRectCenter(ARect).Y + 1, ARect.Right, ARect.Bottom),
            ALocalShadowColor, ALocalShadowColor2, True);

        DrawCanvasLine(ACanvas.Canvas, BorderColor,
          Point(ARect.Left, ARect.Top + 1), Point(ARect.Left, ARect.Bottom));
        DrawCanvasLine(ACanvas.Canvas, BorderColor,
          Point(ARect.Right, ARect.Top + 1), Point(ARect.Right, ARect.Bottom));
      end;
  end;
...
function TcxMediaPlayer8Style.DrawHotZone(ACanvas: TcxCanvas;
  const ARect: TRect; const AHighlighted, AClicked: Boolean): TRect;
begin
  Result := CalculateHotZoneRect(ARect);
  ACanvas.Lock;
  try
    ...
    DrawSplitterDots(ACanvas, FLTPointsRect, AClicked, False, FLightColor,
      FShadowColor, SplitterDirection, 3, 3, ScaleFactor);
...
begin
  ...
  FHotZonePointsRectHeight := (FHotZoneRectSize - (FHotZoneRoundRectHeight * 2)
    - ScaleFactor.Apply(19)) div 2;
  if (SplitterDirection = cxsdLeftToRight) or
    (SplitterDirection = cxsdRightToLeft) then
  begin
    FLTPointsRect := Rect(HotZoneRect.Left,
      HotZoneRect.Top + FHotZoneRoundRectHeight,
      HotZoneRect.Left + HotZoneRect.Right - HotZoneRect.Left,
      HotZoneRect.Top + FHotZoneRoundRectHeight + FHotZonePointsRectHeight);
    FRBPointsRect := Rect(HotZoneRect.Left, HotZoneRect.Bottom -
      FHotZoneRoundRectHeight - FHotZonePointsRectHeight,
      HotZoneRect.Left + HotZoneRect.Right - HotZoneRect.Left,
      HotZoneRect.Bottom - FHotZoneRoundRectHeight - FHotZonePointsRectHeight +
      FHotZonePointsRectHeight);
    FArrowRect := Rect(HotZoneRect.Left, HotZoneRect.Top +
      FHotZonePointsRectHeight + FHotZoneRoundRectHeight,
      HotZoneRect.Left + ScaleFactor.Apply(SplitterDefaultSize) - 1,
      HotZoneRect.Top + FHotZonePointsRectHeight + FHotZoneRoundRectHeight +
      ScaleFactor.Apply(19));
  end
  else
  begin
    FLTPointsRect := Rect(HotZoneRect.Left + FHotZoneRoundRectHeight,
      HotZoneRect.Top, HotZoneRect.Left + FHotZoneRoundRectHeight +
      FHotZonePointsRectHeight, HotZoneRect.Bottom);
    FRBPointsRect := Rect(HotZoneRect.Right - FHotZoneRoundRectHeight -
      FHotZonePointsRectHeight, HotZoneRect.Top,
      HotZoneRect.Right - FHotZoneRoundRectHeight - FHotZonePointsRectHeight +
      FHotZonePointsRectHeight, HotZoneRect.Bottom);
    FArrowRect := Rect(HotZoneRect.Left + FHotZonePointsRectHeight +
      FHotZoneRoundRectHeight, HotZoneRect.Top,
      HotZoneRect.Left + FHotZonePointsRectHeight + FHotZoneRoundRectHeight +
      ScaleFactor.Apply(19), HotZoneRect.Top +
      ScaleFactor.Apply(SplitterDefaultSize) - 1);
  end;
  Result := HotZoneRect;
end;

procedure TcxMediaPlayer8Style.DrawBackground(ACanvas: TcxCanvas;
  const ARect: TRect; const AHighlighted, AClicked: Boolean);
begin
  ACanvas.Pen.Color := Owner.Color;
  ACanvas.Brush.Color := Owner.Color;
  ...
  case SplitterDirection of
    cxsdLeftToRight:
      begin
        { Shadow border }
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
          Point(ARect.Left, ARect.Bottom - 4),
          Point(ARect.Left, ARect.Top + 3));
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
          Point(ARect.Right, ARect.Bottom), Point(ARect.Right, ARect.Top));
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
        ...
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
          Point(ARect.Left + 4, ARect.Bottom),
          Point(ARect.Right, ARect.Bottom));
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
          Point(ARect.Left + 4, ARect.Top), Point(ARect.Right + 1, ARect.Top));
        { Light border }
        ...
        begin
          ...
          DrawCanvasLine(ACanvas.Canvas, LightColor,
            Point(ARect.Left + 2, ARect.Bottom - 2),
    ...
    cxsdRightToLeft:
      begin
        { Shadow border }
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
          Point(ARect.Right, ARect.Bottom - 4),
          Point(ARect.Right, ARect.Top + 3));
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
          Point(ARect.Left, ARect.Bottom), Point(ARect.Left, ARect.Top));
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
        ...
        begin
          DrawCanvasLine(ACanvas.Canvas, LightColor,
            Point(ARect.Left + 3, ARect.Top + 1),
            Point(ARect.Left + 4, ARect.Top + 1));
          DrawCanvasLine(ACanvas.Canvas, LightColor,
            Point(ARect.Left + 4, ARect.Top + 2),
            Point(ARect.Left + 6, ARect.Top + 2));
          DrawCanvasLine(ACanvas.Canvas, LightColor,
            Point(ARect.Left + 5, ARect.Top + 2),
            Point(ARect.Left + 5, ARect.Top + 4));
          DrawCanvasLine(ACanvas.Canvas, LightColor,
            Point(ARect.Left + 6, ARect.Top + 4),
          ...
          DrawCanvasLine(ACanvas.Canvas, LightColor,
            Point(ARect.Left + 5, ARect.Bottom - 2),
    ...
    cxsdTopToBottom:
      begin
        { Shadow border }
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
          Point(ARect.Left + 4, ARect.Top), Point(ARect.Right - 3, ARect.Top));
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
          Point(ARect.Left, ARect.Bottom), Point(ARect.Right, ARect.Bottom));
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
          Point(ARect.Left + 2, ARect.Top + 1),
          Point(ARect.Left + 4, ARect.Top + 1));
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
        ...
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
          ...
          Point(ARect.Right - 1, ARect.Top + 4));
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
          Point(ARect.Left, ARect.Top + 4), Point(ARect.Left, ARect.Bottom));
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
          Point(ARect.Right, ARect.Top + 4),
        ...
        begin
          ...
          DrawCanvasLine(ACanvas.Canvas, LightColor,
            Point(ARect.Right - 2, ARect.Top + 2),
    ...
    cxsdBottomToTop:
      begin
        ...
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
          ...
          Point(ARect.Right - 1, ARect.Bottom - 4));
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
          Point(ARect.Left, ARect.Bottom - 4), Point(ARect.Left, ARect.Top));
        DrawCanvasLine(ACanvas.Canvas, ShadowColor,
          Point(ARect.Right, ARect.Bottom - 3),
          Point(ARect.Right, ARect.Top - 1));
        { Light border }
        if not AClicked then
        begin
        ...
        begin
          ...
          DrawCanvasLine(ACanvas.Canvas, LightColor,
            Point(ARect.Right - 2, ARect.Bottom - 2),
...
procedure TcxMediaPlayer8Style.DrawArrowRect(ACanvas: TcxCanvas;
  const ARect: TRect; const AHighlighted, AClicked: Boolean);
begin
  ACanvas.Brush.Color := Owner.Color;
  ACanvas.FillRect(ARect);
...
begin
  ...
  try
    ...
    DrawSplitterDots(ACanvas, FLTPointsRect, not AClicked, True, FLightColor,
      FShadowColor, SplitterDirection, 4, 0, ScaleFactor);
  ...
  case SplitterDirection of
    cxsdLeftToRight, cxsdRightToLeft:
      begin
        ...
        FLTPointsRect := Rect(Result.Left + 1, Result.Top, (Result.Right div 2),
          Result.Bottom);
    ...
    begin
      ...
      FLTPointsRect := Rect(Result.Left, Result.Top + 1, Result.Right,
        Result.Bottom div 2);
...
procedure TcxXPTaskBarStyle.DrawBackground(ACanvas: TcxCanvas;
  const ARect: TRect; const AHighlighted, AClicked: Boolean);
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      for I_count := 0 to (Right - Left - ScaleFactor.Apply(32))
        div (ADotSize + 1) do
      begin
        ADotRect := cxRectBounds(Left + ScaleFactor.Apply(16) + I_count *
          (ADotSize + 1) - 1, MiddlePos, ADotSize - 1, ADotSize - 1);
    ...
    begin
      ...
      for I_count := 0 to (Bottom - Top - ScaleFactor.Apply(32))
        div (ADotSize + 1) do
      begin
        ADotRect := cxRectBounds(MiddlePos, Top + ScaleFactor.Apply(16) +
          I_count * (ADotSize + 1) - 1, ADotSize - 1, ADotSize - 1);
        FillRect(ADotRect, AColor1);
        ADotRect := cxRectOffset(ADotRect, 1, 1);
        FillRect(ADotRect, AColor2);
      end;
...
begin
  ...
  SetBounds(0, 0, SplitterDefaultSize,
    100 { //#Must be >=10, otherwise the IDE sets the default size (100x48) } );
  TabStop := False;
end;
...
procedure TcxCustomSplitter.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
  inherited;
  if (Operation = opRemove) and (FControl <> nil) and (AComponent = FControl)
  then
    FControl := nil;
end;
...
begin
  HotZoneStyleClass := TcxHotZoneStyleClass
    (GetRegisteredHotZoneStyles.FindByClassName(Value));
end;
...
begin
  FDragThreshold := Max(Min(Value, High(TcxNaturalNumber)),
    Low(TcxNaturalNumber));
end;
...
procedure TcxCustomSplitter.SetPositionAfterOpen(const Value
  : TcxPositionAfterOpen);
begin
  FPositionAfterOpen := Max(Min(Value, High(TcxPositionAfterOpen)),
    Low(TcxPositionAfterOpen));
end;
...
function TcxCustomSplitter.IsControlActualForSplitter
  (AControl: TControl): Boolean;
begin
  Result := (AControl <> nil) and (IsDesigning or AControl.Visible) and
    (AControl.Align in [alTop, alBottom, alLeft, alRight]);
end;
...
begin
  ...
  begin
    ...
    if AHorizontal then
      Result := LookAndFeel.SkinPainter.GetScaledSplitterSize(AHorizontal,
        ScaleFactor).cy
    else
      Result := LookAndFeel.SkinPainter.GetScaledSplitterSize(AHorizontal,
        ScaleFactor).cx;
  end
  else if Assigned(FHotZone) then
...
begin
  Result := Low(TcxSplitterDirection);
  AInvertDirection := InvertDirection xor dxWindowHasRightToLeftLayout
    (Parent.Handle);
  case Align of
    alTop:
    ...
    alLeft:
      if ((State = ssOpened) and (not AInvertDirection)) or
        ((State = ssClosed) and (AInvertDirection)) then
        ...
        begin
          ...
          if not Result then
            raise EdxException.Create
              ('The specified control is already bound to another TcxSplitter control.');
        end
    end
    else
      raise EdxException.Create
        ('The splitter cannot be bound to another splitter.');
  end;
...
function TcxCustomSplitter.FindControl(AAlign: TAlign): TControl;
  ...
  begin
    ...
    if AControl.AlignWithMargins then
      Result := cxRectTransform(Result, AControl.Margins.Left,
        AControl.Margins.Top, AControl.Margins.Right, AControl.Margins.Bottom);
  end;
...
begin
  ...
  begin
    ...
    if (ANextControl <> Self) and ANextControl.Visible and ANextControl.Enabled
    then
    begin
      R := cxRectInflate(ANextControl.BoundsRect,
        GetControlOffsets(ANextControl));
      ...
      begin
        ...
        begin
          ...
          case AAlign of
            alLeft:
              if (R.Right = R.Left) and (R.Left = Left + Width) then
                Result := GetNearestControl(Result, ANextControl);
            alRight:
              if (R.Right = R.Left) and (R.Right = Left) then
                Result := GetNearestControl(Result, ANextControl);
            alTop:
              if (R.Bottom = R.Top) and (R.Top = Top + Height) then
                Result := GetNearestControl(Result, ANextControl);
            alBottom:
              if (R.Bottom = R.Top) and (R.Bottom = Top) then
                Result := GetNearestControl(Result, ANextControl);
          end;
        end;
      end;
...
begin
  ...
  begin
    ...
    begin
      ...
      cxBitBlt(FDrawBitmap.Canvas.Handle, Canvas.Handle, FDrawBitmap.ClientRect,
        cxNullPoint, SRCCOPY);
    end
    else
  ...
  begin
    ...
    LookAndFeel.SkinPainter.DrawScaledSplitter(FDrawBitmap.cxCanvas, R,
      smsInHotZone in FMouseStates, (smsClicked in FMouseStates) and
      (smsInHotZone in FMouseStates), Align in [alBottom, alTop], ScaleFactor);
  end;
...
begin
  if HotZone <> nil then
    HotZone.DrawHotZone(FDrawBitmap.cxCanvas,
      FDrawBitmap.cxCanvas.Canvas.ClipRect, (smsInHotZone in FMouseStates),
...
begin
  ...
  try
    case Align of
      alLeft:
        FCurrentControl.SetBounds(FCurrentControl.Left, FCurrentControl.Top,
          FNewSize, FCurrentControl.Height);
      alTop:
        FCurrentControl.SetBounds(FCurrentControl.Left, FCurrentControl.Top,
          FCurrentControl.Width, FNewSize);
      alRight:
        FCurrentControl.SetBounds(FCurrentControl.Left + FCurrentControl.Width -
          FNewSize, FCurrentControl.Top, FNewSize, FCurrentControl.Height);
      alBottom:
        FCurrentControl.SetBounds(FCurrentControl.Left,
          FCurrentControl.Top + FCurrentControl.Height - FNewSize,
          FCurrentControl.Width, FNewSize);
    end;
  finally
    Parent.EnableAlign;
...
procedure TcxCustomSplitter.AdjustAlignSettings(APostponedCorrection: Boolean);
  ...
  function LeavePrevControl(ANewCurrentControl: TControl;
    ANewAlign: TAlign): Boolean;
  begin
    Result := (FSplitterState <> sstNormal) or (ANewCurrentControl = nil) and
      IsControlActualForSplitter(FCurrentControl) and
      (((ANewAlign in [alLeft, alRight]) and (FCurrentControl.Width = 0)) or
      ((ANewAlign in [alTop, alBottom]) and (FCurrentControl.Height = 0)));
  end;
...
begin
  ...
  try
    ...
    begin
      if (Control <> nil) and (Control.Align in [alTop, alBottom, alLeft,
        alRight]) then
        ANewAlign := Control.Align
      else
      begin
...
begin
  ...
  begin
    ...
    else if (S > FMaxSize) and (FMaxSize > 0) then
      ANewSize := FMaxSize;
...
procedure TcxCustomSplitter.CorrectSelfPosition;
  ...
  begin
    Result := IsControlActualForSplitter(FCurrentControl) and
      not(csLoading in ComponentState) and not FIsAdjustingPosition and
      (FCurrentControl.Parent = Parent);
  end;
...
begin
  ...
  try
    case Align of
      alLeft:
        begin
          ANewPosition := FCurrentControl.Left + FCurrentControl.Width +
            GetMargin;
      ...
      alTop:
        begin
          ANewPosition := FCurrentControl.Top + FCurrentControl.Height +
            GetMargin;
...
procedure TcxCustomSplitter.InitResize(X, Y: Integer);
  ...
  begin
    ...
    for I := 0 to Parent.ControlCount - 1 do
      if (Parent.Controls[I] <> FCurrentControl) and Parent.Controls[I].Visible
      then
      begin
        if (Align in [alLeft, alRight]) and
          (Parent.Controls[I].Align in [alLeft, alRight]) then
          Dec(Result, Parent.Controls[I].Width)
        else if (Align in [alTop, alBottom]) and
          (Parent.Controls[I].Align in [alTop, alBottom]) then
  ...
  begin
    ...
    case FSplitterState of
      ...
      sstHotZoneClick:
        ...
        begin
          if (Max(Abs(FHotZoneClickPoint.Y - Y), Abs(FHotZoneClickPoint.X - X))
            >= DragThreshold) and DoCanResize(ANewSize) then
          begin
            FSplitterState := sstResizing;
            InitResize(X, Y);
          end;
        end
        else if FMouseStates <> ASavedMouseStates then
          Invalidate;
    end;
  end;
...
begin
  ...
  if (Button = mbLeft) and (FCurrentControl <> nil) and
    (smsClicked in FMouseStates) then
    ControlResizing(X, Y);
end;

procedure TcxCustomSplitter.FocusKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  ...
  else if Assigned(FPrevKeyDown) then
    FPrevKeyDown(Sender, Key, Shift);
end;
...
GetRegisteredHotZoneStyles.Register(TcxMediaPlayer8Style,
  scxHotZoneStyleMediaPlayer8);
GetRegisteredHotZoneStyles.Register(TcxMediaPlayer9Style,
  scxHotZoneStyleMediaPlayer9);
GetRegisteredHotZoneStyles.Register(TcxXPTaskBarStyle,
  scxHotZoneStyleXPTaskBar);
