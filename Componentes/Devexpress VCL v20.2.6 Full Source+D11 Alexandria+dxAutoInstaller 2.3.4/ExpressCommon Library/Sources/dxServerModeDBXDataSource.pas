...
type
  ...
  published
    ...
    property Options: TdxServerModeDBXDataSourceOptions read GetOptions
      write SetOptions;
  end;
...
function TdxServerModeDBXDataSource.GetHelperClass
  : TdxServerModeDataSourceCustomHelperClass;
begin
  Result := TdxServerModeDBXDataSourceHelper;
end;

function TdxServerModeDBXDataSource.GetOptions
  : TdxServerModeDBXDataSourceOptions;
begin
...
procedure TdxServerModeDBXDataSource.SetOptions(const Value
  : TdxServerModeDBXDataSourceOptions);
begin
...
function TdxServerModeDBXDataSourceHelper.GetOptionsClass
  : TdxServerModeDataSourceOptionsClass;
begin
  Result := TdxServerModeDBXDataSourceOptions;
end;

function TdxServerModeDBXDataSourceHelper.GetQueryBuilderClass
  : TdxServerModeCustomSQLQueryBuilderClass;
begin
  Result := TdxServerModeDBXSQLQueryBuilder;
end;

procedure TdxServerModeDBXDataSourceHelper.CheckParamValue
...
procedure TdxServerModeDBXDataSourceHelper.DoInitializeDataSet
  (ADataSet: TDataSet);
begin
  TSQLDataSet(ADataSet).SchemaName := TdxServerModeDBXDataSourceOptions
    (DataSource.Options).SchemaName;
  TSQLDataSet(ADataSet).CommandText := GetFieldsRetrieveQuery;
end;

procedure TdxServerModeDBXDataSourceHelper.DoSynchronizeDataSetConnection
  (ADataSet: TDataSet);
begin
  TSQLDataSet(ADataSet).SQLConnection := TSQLConnection(Connection);
end;

procedure TdxServerModeDBXDataSourceHelper.PrepareDatasetForIterate
  (ADataSet: TDataSet);
begin
...
function TdxServerModeDBXQueryDataSource.GetHelperClass
  : TdxServerModeDataSourceCustomHelperClass;
begin
  Result := TdxServerModeDBXDataSourceHelper;
end;

function TdxServerModeDBXQueryDataSource.GetOptions
  : TdxServerModeDBXDataSourceOptions;
begin
  Result := inherited Options as TdxServerModeDBXDataSourceOptions;
end;

function TdxServerModeDBXQueryDataSource.GetHelper
  : TdxServerModeDBXDataSourceHelper;
begin
  Result := TdxServerModeDBXDataSourceHelper(inherited Helper);
end;
...
procedure TdxServerModeDBXQueryDataSource.SetOptions
  (const Value: TdxServerModeDBXDataSourceOptions);
begin
  inherited Options := Value;
end;
