...
{$ENDIF}
  ...
  dxTypeHelpers,
  cxScrollBar, cxLookAndFeelPainters, dxCustomHint, cxEdit, cxCustomListBox,
  dxCoreClasses;
...
type
  ...
  TdxCustomListBoxActionEvent = procedure(Sender: TdxCustomListBox;
  ...
  published
    ...
    property OnDataFind: TLBFindDataEvent read GetOnDataFind
      write SetOnDataFind;
  ...
  protected
    ...
    property SortOptions: TdxCustomListBoxSortOptions read FSortOptions
  ...
  public
    ...
    function Add(const ACaption: string; AImageIndex: Integer = -1;
      AData: TObject = nil; AHasSeparator: Boolean = False)
      : TdxCustomListBoxItem;
    function AddObject(const ACaption: string; AData: TObject)
      : TdxCustomListBoxItem;
    function AddSeparator: TdxCustomListBoxItem;
    procedure BeginUpdate;
    procedure CancelUpdate;
    procedure EndUpdate;
    function IndexOfCaption(const ACaption: string;
  ...
  public
    ...
    property Items[Index: Integer]: TdxCustomCheckListBoxItem read GetItem;
  ...
  TdxCustomListBox = class(TcxControl, IcxMouseTrackingCaller,
  ...
  protected
    ...
    procedure AdjustItemFont(AFont: TFont; AItem: TdxCustomListBoxItem;
    ...
    function CanShowHint(AItemIndex: Integer;
      out AItemRect, AItemTextRect: TRect): Boolean; virtual;
    ...
    function FindNextItemIndex(AStartItemIndex: Integer;
      AGoForward: Boolean = True; AGoOnCycle: Boolean = False)
      : Integer; virtual;
    procedure FocusNextItemIndex(AStartItemIndex: Integer;
      AGoForward: Boolean = True; AGoOnCycle: Boolean = False); virtual;
    procedure FontChanged; override;
    procedure EraseBackground(DC: HDC); override;
    function GetHasSeparator(AItem: TdxCustomListBoxItem): Boolean; virtual;
    function GetImagesAreaRect: TRect; virtual;
    function GetItemFontStyle(AItem: TdxCustomListBoxItem)
      : TFontStyles; virtual;
    ...
    procedure InternalMouseDown(Button: TMouseButton; Shift: TShiftState;
      X, Y: Integer); virtual;
    ...
    function NeedPanningFeedback(AScrollKind: TScrollBarKind): Boolean;
      override;
    function NeedUseHotColor(AItem: TdxCustomListBoxItem;
      AState: TcxButtonState): Boolean; virtual;
    ...
    function GetItemBackgroundColor(AItem: TdxCustomListBoxItem;
      AState: TcxButtonState): TColor; virtual;
    function GetItemBackgroundRect(const AItemRect: TRect): TRect;
    function GetItemImageRect(const AItemRect: TRect): TRect; virtual;
    procedure GetItemPartsRects(AItem: TdxCustomListBoxItem; const R: TRect;
      out AItemRect, ASeparatorRect: TRect); virtual;
    function GetItemRect(AItemIndex: Integer;
      const APrevItemRect: TRect): TRect;
    ...
    function GetTextColor(AItem: TdxCustomListBoxItem; AState: TcxButtonState)
      : TColor; virtual;
    ...
    procedure DrawItem(const R: TRect; AItem: TdxCustomListBoxItem;
      AState: TcxButtonState); virtual;
    procedure DrawItemBackground(const R: TRect; AItem: TdxCustomListBoxItem;
      AState: TcxButtonState); virtual;
    ...
    function FocusItemWithText(const AText: string;
      AStartIndex, AFinishIndex: Integer): Boolean;
    ...
    property SortOptions: TdxCustomListBoxSortOptions read GetSortOptions
      write SetSortOptions;
  ...
  public
    ...
    function AddItem(const ACaption: string; AObject: TObject;
      AImageIndex: Integer = -1): Integer;
    function CalculateContentSize(AMaxVisibleItemsCount: Integer): TSize;
      overload; virtual;
    ...
    // for internal use
    property LoopedNavigation: Boolean read FLoopedNavigation
      write FLoopedNavigation;
  ...
  TdxCustomCheckListBoxItemDragOverEvent = procedure(AItem: Pointer;
  ...
  strict private
    ...
    function GetAutoSizeItemWidth(const AUseCachedTextMaxWidth
  ...
  protected
    ...
    function CalculateAutoWidth(AUseCachedTextMaxWidth: Boolean = False)
      : Integer; virtual;
    ...
    procedure DrawItemCheckBox(const R: TRect; AItem: TdxCustomListBoxItem;
      AState: TcxButtonState); virtual;
    ...
    function GetItemFocusRect(const AItemRect: TRect;
      AItem: TdxCustomListBoxItem): TRect; virtual;
    function GetItemsClass: TdxCustomListBoxItemsClass; override;
    function GetItemMaxWidth(const AUseCachedTextMaxWidth
      : Boolean = False): Integer;
    ...
    procedure ItemAction(AItemIndex: Integer;
      AValue: TdxDefaultBoolean = bDefault); virtual;
    function NeedBeginDrag(AButton: TMouseButton;
    ...
    property CheckBoxState[AItemIndex: Integer]: TcxButtonState
  ...
  public
    ...
    property CheckedIndexes: TdxIntegerIndexes read GetCheckedIndexes
      write SetCheckedIndexes;
    property ItemMoving: Boolean read FItemMoving write FItemMoving
      default True;
    ...
    property OnAction: TdxCustomListBoxActionEvent read FOnAction
      write FOnAction;
    property OnDragDrop;
    property OnItemDragOver: TdxCustomCheckListBoxItemDragOverEvent
  ...
  TdxCustomDropDownListBoxCloseUpEvent = procedure(Sender: TObject;
    AClosedViaKeyboard: Boolean) of object;
  ...
  public
    constructor Create(AOwner: TComponent); override;
    //
    property DefaultItemIndex: Integer read FDefaultItemIndex
      write SetDefaultItemIndex default -1;
    property OnSelectItem: TdxCustomDropDownListBoxSelectedEvent
  ...
  protected
    ...
    procedure DoSelectItem(AItem: TdxCustomListBoxItem;
      ASelectedViaKeyboard: Boolean); virtual;
    procedure InitInnerListBox; virtual;
    procedure InitPopup; override;
    procedure ItemSelected(Sender: TObject; AItem: TdxCustomListBoxItem;
  ...
  public
    ...
    //
    property Count: Integer read GetCount;
    property DisplayRowsCount: Cardinal read FDisplayRowsCount
      write FDisplayRowsCount;
    ...
    property OnCloseUp: TdxCustomDropDownListBoxCloseUpEvent read FOnCloseUp
      write FOnCloseUp;
    property OnSelect: TdxCustomDropDownListBoxSelectedEvent read FOnSelect
      write FOnSelect;
  end;
  ...
  public
    ...
    property QuickCustomizationControl: TdxQuickCustomizationCustomControl
      read GetQuickCustomizationControl; // for internal use
    property OnSelectionChanged;
  end;

  TdxQuickCustomizationCustomCheckListBoxClass = class of
    TdxQuickCustomizationCustomCheckListBox;

  { TdxComboCommandBoxCommandListBox }

  TdxQuickCustomizationCommandListBox = class
    (TdxQuickCustomizationCustomCheckListBox)
  private
    function GetCommand(AItemIndex: Integer)
      : TdxQuickCustomizationCustomCommand;
  protected
    ...
    property Command[AItemIndex: Integer]: TdxQuickCustomizationCustomCommand
      read GetCommand;
  end;

  { TdxQuickCustomizationCheckListBox }

  TdxQuickCustomizationCheckListBox = class
    (TdxQuickCustomizationCustomCheckListBox)
  private
  ...
  public
    ...
    property OnSelectedItemCheckedStateChanged: TNotifyEvent
      read FOnSelectedItemCheckedStateChanged
      write FOnSelectedItemCheckedStateChanged;
    property OnSelectedItemCheckedStateChanging: TNotifyEvent
      read FOnSelectedItemCheckedStateChanging
      write FOnSelectedItemCheckedStateChanging;
  end;
  ...
  protected
    function DoIncrementalSearchOnOtherListBox(Sender: TdxCustomCheckListBox;
      const ASearchText: string): Boolean;
    procedure DoKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure HandleCommandListBoxMouseWheel(Sender: TObject;
      Shift: TShiftState; WheelDelta: Integer; MousePos: TPoint;
      var Handled: Boolean);
    procedure HandleItemIndexChanging(Sender: TdxCustomListBox;
      AItemIndex: Integer);
    function ProcessCheckListBoxNavigationKey(var Key: Word;
      Shift: TShiftState): Boolean;
    function ProcessCommandListBoxNavigationKey(var Key: Word;
      Shift: TShiftState): Boolean;
    function ProcessNavigationKey(Sender: TdxCustomListBox; var Key: Word;
      Shift: TShiftState): Boolean;
  public
  ...
  protected
    function AddCommand(const ACaption: string; AHasCheckBox: Boolean;
      AOnAction: TNotifyEvent): TdxQuickCustomizationCustomCommand;
    procedure AdjustBounds(const AUseCachedTextMaxWidth
      : Boolean = False); virtual;
    procedure ChangeScaleEx(M, D: Integer; isDpiChange: Boolean); override;
    procedure DrawSeparator; virtual;
    function GetCommandListBoxClass
      : TdxQuickCustomizationCustomCheckListBoxClass; virtual;
    ...
    property CheckListBoxVisibleRowCount: Integer
      read FCheckListBoxVisibleRowCount write FCheckListBoxVisibleRowCount;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    ...
    // for internal use
    property CommandListBox: TdxQuickCustomizationCustomCheckListBox
      read FCommandListBox; // for internal use
...
uses
  Variants, cxGeometry, dxCoreGraphics, StrUtils, dxDPIAwareUtils;
...
function dxCustomListBoxItemsAnsiCompare(Item1,
  Item2: TdxCustomListBoxItem): Integer;
begin
  Result := AnsiCompareStr(Item1.Caption, Item2.Caption);
end;

function dxCustomListBoxItemsAnsiInsensitiveCompare(Item1,
  Item2: TdxCustomListBoxItem): Integer;
begin
  Result := AnsiCompareText(Item1.Caption, Item2.Caption);
end;

function dxCustomListBoxItemsCompare(Item1,
  Item2: TdxCustomListBoxItem): Integer;
begin
  Result := CompareStr(Item1.Caption, Item2.Caption);
end;

function dxCustomListBoxItemsInsensitiveCompare(Item1,
  Item2: TdxCustomListBoxItem): Integer;
begin
...
begin
  ...
  begin
    SetFocus;
    MouseDown(mbLeft, KeysToShiftState(Message.Keys), Message.XPos,
      Message.YPos);
  end;
end;
...
begin
  Result := InnerListBox.ItemAtPos(Point(APos.X - InnerListBox.Left,
    APos.Y - InnerListBox.Top), AExisting);
end;
...
begin
  ...
  try
    ...
    if not EqualRect(APrevBoundsRect, InnerListBox.BoundsRect) and InnerListBox.HandleAllocated
    then
...
begin
  ...
  if (InnerListBox <> nil) and (Message.Msg = WM_COMMAND) and
    (Message.WParamHi = LBN_SELCHANGE) then
...
function TcxListBox.IsMouseWheelHandleNeeded(Shift: TShiftState;
...
function TdxCustomListBoxItems.AddObject(const ACaption: string; AData: TObject)
  : TdxCustomListBoxItem;
begin
...
function TdxCustomListBoxItems.FindInSortedList(const ACaption: string)
  : Integer;
var
...
function TdxCustomListBoxItems.IndexOfCaption(const ACaption: string;
  ACaseSensitive: Boolean = True): Integer;
...
procedure TdxCustomListBoxItems.SetSortOptions
  (AValue: TdxCustomListBoxSortOptions);
begin
...
function TdxCustomCheckListBoxItems.AddObject(const ACaption: string;
  AData: TObject): TdxCustomCheckListBoxItem;
begin
  Result := inherited AddObject(ACaption, AData) as TdxCustomCheckListBoxItem;
end;

function TdxCustomCheckListBoxItems.GetItem(Index: Integer)
  : TdxCustomCheckListBoxItem;
begin
...
function TdxCustomListBox.Add(const ACaption: string;
  AImageIndex: Integer = -1): Integer;
begin
  Result := AddItem(ACaption, nil, AImageIndex);
end;

function TdxCustomListBox.AddItem(const ACaption: string; AObject: TObject;
  AImageIndex: Integer = -1): Integer;
begin
  Result := FItems.Add(ACaption, AImageIndex, AObject).Index;
end;

procedure TdxCustomListBox.AdjustItemFont(AFont: TFont;
...
function TdxCustomListBox.CanShowHint(AItemIndex: Integer;
  out AItemRect, AItemTextRect: TRect): Boolean;
begin
  Result := False;
  ...
  begin
    ...
    Result := cxScreenCanvas.TextWidth(Items[AItemIndex].Caption) >
      cxRectWidth(AItemTextRect);
...
function TdxCustomListBox.CalculateContentSize(AMaxVisibleItemsCount
  : Integer): TSize;
var
  I: Integer;
...
begin
  ...
  begin
    AItem := Items[I];
    Result.cx := Max(Result.cx, TdxTextMeasurer.TextWidthTO(Font, AItem.Caption,
      GetItemFontStyle(AItem)));
  end;
  for I := 0 to Min(Items.Count, AMaxVisibleItemsCount) - 1 do
    Inc(Result.cy, ItemsHeight[I]);
  Inc(Result.cx, dxGetSystemMetrics(SM_CXVSCROLL, ScaleFactor) +
    cxMarginsWidth(TextOffsets) + ImagesAreaSize);
...
function TdxCustomListBox.GetMouseWheelScrollingKind
...
function TdxCustomListBox.FindNextItemIndex(AStartItemIndex: Integer;
  AGoForward: Boolean = True; AGoOnCycle: Boolean = False): Integer;
begin
  ...
  else if AStartItemIndex >= Items.Count then
...
procedure TdxCustomListBox.FocusNextItemIndex(AStartItemIndex: Integer;
  AGoForward: Boolean = True; AGoOnCycle: Boolean = False);
begin
...
procedure TdxCustomListBox.DrawItem(const R: TRect; AItem: TdxCustomListBoxItem;
...
begin
  ...
  begin
    ABackgroundRect := TdxRightToLeftLayoutConverter.ConvertRect
      (ABackgroundRect, R);
    ...
    ASeparatorRect := TdxRightToLeftLayoutConverter.ConvertRect
      (ASeparatorRect, R);
  end;
...
procedure TdxCustomListBox.DrawItemBackground(const R: TRect;
  AItem: TdxCustomListBoxItem; AState: TcxButtonState);
var
  AColor: TColor;
begin
...
procedure TdxCustomListBox.DrawItemImage(const R: TRect;
  AItem: TdxCustomListBoxItem; AState: TcxButtonState);
var
  AImageRect: TRect;
begin
  ...
  begin
    ...
    cxDrawImage(Canvas.Handle, AImageRect, AImageRect, nil, Images,
      AItem.ImageIndex, idmNormal);
  end;
end;

procedure TdxCustomListBox.DrawItemText(const R: TRect;
  AItem: TdxCustomListBoxItem; AState: TcxButtonState);
begin
  Canvas.Font := Font;
...
begin
  if not cxRectIsEmpty(R) then
    LookAndFeelPainter.DrawDropDownListBoxScaledSeparator(Canvas, R,
      ImagesAreaRect, ScaleFactor);
end;
...
function TdxCustomListBox.ItemAtPos(const APoint: TPoint;
...
begin
  ...
  else if AIndex < TopIndex then
    TopIndex := AIndex
  else if AIndex >= TopIndex + APageSize then
...
begin
  if Columns = 0 then
    SetScrollBarInfo(sbVertical, 0, Items.Count - 1, GetScrollStep, PageSize,
      TopIndex, True, True)
  else
    SetScrollBarInfo(sbHorizontal, 0, Items.Count - 1, GetScrollStep, PageSize,
      TopIndex, True, True);
end;
...
procedure TdxCustomListBox.MeasureItemHeight(AIndex: Integer;
  var AHeight: Integer);
begin
  if GetHasSeparator(Items[AIndex]) then
    Inc(AHeight, LookAndFeelPainter.DropDownListBoxScaledSeparatorSize
      (ScaleFactor));
...
procedure TdxCustomListBox.InternalMouseDown(Button: TMouseButton;
...
procedure TdxCustomListBox.MouseDown(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
...
function TdxCustomListBox.NeedPanningFeedback(AScrollKind
  : TScrollBarKind): Boolean;
begin
  Result := False;
end;

function TdxCustomListBox.NeedUseHotColor(AItem: TdxCustomListBoxItem;
  AState: TcxButtonState): Boolean;
begin
  Result := NeedHotTrack and (AState = cxbsHot);
end;

function TdxCustomListBox.NeedUseSelectionColor(AItem: TdxCustomListBoxItem;
  AState: TcxButtonState): Boolean;
begin
...
procedure TdxCustomListBox.Notification(AComponent: TComponent;
...
begin
  ...
  begin
    ...
    Result := ((AStartIndex < Count) and FocusItemWithText(AText, AStartIndex,
      Count - 1)) or FocusItemWithText(AText, 0, AStartIndex - 1);
  end;
end;

function TdxCustomListBox.FocusItemWithText(const AText: string;
  AStartIndex, AFinishIndex: Integer): Boolean;
var
  I: Integer;
begin
...
function TdxCustomListBox.IsItemWithText(AItem: TdxCustomListBoxItem;
  const AText: string): Boolean;
begin
  Result := AnsiStartsText(AText, AItem.Caption);
end;

function TdxCustomListBox.ProcessNavigationKey(var Key: Word;
  Shift: TShiftState): Boolean;
  ...
  begin
    ...
    if ((AStep < 0) and (AIndex < FTopIndex)) or
      ((AStep > 0) and (AIndex >= FTopIndex + PageSize) and
      (AIndex <= Count - 1)) then
  ...
  case Key of
    ...
    VK_NEXT:
      if ssCtrl in Shift then
        ...
        FocusNextColumnItem(PageSize - Integer((FTopIndex = 0) and
          (ItemIndex = 0)))
      else
    ...
    VK_LEFT:
      if Columns > 0 then
        FocusNextColumnItem(-GetScrollStep *
          IfThen(UseRightToLeftAlignment, -1, 1));
    VK_UP:
      if Columns > 0 then
  ...
  case AScrollCode of
    ...
    scTrack:
      ...
      begin
        ...
        else if AScrollPos > MaxTopIndex - AScrollStep then
...
begin
  if ShowHint and CanShowHint(HotIndex, AItemRect, AItemTextRect) then
    HintHelper.ShowHint(AItemRect, AItemTextRect, Items[HotIndex].Caption,
      False, Items[HotIndex])
  else
...
begin
  ...
  else if Count * ItemHeight > ClientBounds.Bottom - ClientBounds.Top then
...
function TdxCustomListBox.GetItemFontStyle(AItem: TdxCustomListBoxItem)
  : TFontStyles;
begin
  Result := Font.Style;
end;
...
function TdxCustomListBox.GetItemBackgroundColor(AItem: TdxCustomListBoxItem;
...
begin
  Result := Rect(AItemRect.Left + ImagesAreaRect.Left - ClientBounds.Left,
    AItemRect.Top, AItemRect.Left + ImagesAreaRect.Right - ClientBounds.Left,
    AItemRect.Bottom);
  Result := cxRectContent(Result, ImageOffsets);
end;

procedure TdxCustomListBox.GetItemPartsRects(AItem: TdxCustomListBoxItem;
  const R: TRect; out AItemRect, ASeparatorRect: TRect);
var
  ASeparatorSize: Integer;
begin
  if GetHasSeparator(AItem) then
  begin
    ASeparatorSize := LookAndFeelPainter.DropDownListBoxScaledSeparatorSize
      (ScaleFactor);
...
function TdxCustomListBox.GetItemRect(AItemIndex: Integer;
  const APrevItemRect: TRect): TRect;
begin
  Result := cxRectSetTop(APrevItemRect, APrevItemRect.Bottom,
    ItemsHeight[AItemIndex]);
  if Columns > 0 then
  begin
    if UseRightToLeftAlignment then
    ...
    if Result.Bottom > ClientBounds.Height then
      if UseRightToLeftAlignment then
        Result := cxRectSetOrigin(Result, cxPoint(Result.Left - ColumnWidth,
          ItemsAreaRect.Top))
      else
        Result := cxRectSetOrigin(Result, cxPoint(Result.Left + ColumnWidth,
          ItemsAreaRect.Top));
...
function TdxCustomListBox.GetTextColor(AItem: TdxCustomListBoxItem;
  AState: TcxButtonState): TColor;
begin
  if Font.Color <> clWindowText then
    Result := Font.Color
  else if NeedUseSelectionColor(AItem, AState) or NeedUseHotColor(AItem, AState)
  then
...
function TdxCustomCheckListBox.CalculateAutoWidth(AUseCachedTextMaxWidth
  : Boolean = False): Integer;
begin
...
function TdxCustomCheckListBox.CanAutoSize(var NewWidth: Integer;
...
procedure TdxCustomCheckListBox.DragOver(Source: TObject; X, Y: Integer;
  ...
  begin
    ...
    Result := TcxDragAndDropArrow.CalculateBounds(Result, cxEmptyRect, APlace,
      ScaleFactor);
  ...
  begin
    if FDragItemIndex = -1 then
      ScrollDirection := dirNone
    else if VScrollBarVisible then
      if Y <= dxListBoxScrollZoneWidth then
        ScrollDirection := dirUp
      else if Y >= ClientHeight - dxListBoxScrollZoneWidth then
        ScrollDirection := dirDown
      else
        ScrollDirection := dirNone
    else if HScrollBarVisible then
      if X <= dxListBoxScrollZoneWidth then
        ScrollDirection := dirLeft
      else if X >= ClientWidth - dxListBoxScrollZoneWidth then
...
begin
  if not cxRectIsInvalid(FDragAndDropLeftArrowRect) then
    TcxDragAndDropArrow.Draw(Canvas, FDragAndDropLeftArrowRect, apLeft,
      ScaleFactor);
  if not cxRectIsInvalid(FDragAndDropRightArrowRect) then
    TcxDragAndDropArrow.Draw(Canvas, FDragAndDropRightArrowRect, apRight,
      ScaleFactor);
end;

procedure TdxCustomCheckListBox.DrawItem(const R: TRect;
  AItem: TdxCustomListBoxItem; AState: TcxButtonState);
var
  AItemRect, ASeparatorRect: TRect;
  ABackgroundRect, AImageRect, ATextRect: TRect;
...
begin
  ...
  begin
    ...
    ACheckBoxRect := TdxRightToLeftLayoutConverter.ConvertRect
      (ACheckBoxRect, R);
  end;
  DrawItemBackground(ABackgroundRect, AItem, AState);
...
procedure TdxCustomCheckListBox.DrawItemCheckBox(const R: TRect;
  AItem: TdxCustomListBoxItem; AState: TcxButtonState);
var
  ACheckItem: TdxCustomCheckListBoxItem absolute AItem;
begin
  LookAndFeelPainter.DrawScaledCheckButton(Canvas, R,
    GetCheckBoxState(AItem.Index), ACheckItem.State, ScaleFactor);
end;
...
function TdxCustomCheckListBox.GetCheckBoxState(AItemIndex: Integer)
  : TcxButtonState;
begin
  if HasCheckBox(AItemIndex) then
    if MouseCapture and HitAtItemCheckBox(AItemIndex) then
      Result := cxbsPressed
    else if (HotIndex = AItemIndex) and
      (NeedHotTrack or HitAtItemCheckBox(AItemIndex)) then
      Result := cxbsHot
    else
      Result := cxbsNormal
  else
...
function TdxCustomCheckListBox.GetDragItemInsertionIndex(X, Y: Integer)
  : Integer;
var
  R: TRect;
begin
...
function TdxCustomCheckListBox.GetItemCheckBoxRect(const AItemRect
  : TRect): TRect;
begin
  Result := AItemRect;
...
function TdxCustomCheckListBox.GetItemFocusRect(const AItemRect: TRect;
  AItem: TdxCustomListBoxItem): TRect;
begin
  Result := AItemRect;
  if HasCheckBox(AItem.Index) then
...
function TdxCustomCheckListBox.GetItemMaxWidth(const AUseCachedTextMaxWidth
  : Boolean = False): Integer;
begin
...
procedure TdxCustomCheckListBox.InternalDragDrop(Source: TObject;
  X, Y: Integer);
var
...
procedure TdxCustomCheckListBox.ItemAction(AItemIndex: Integer;
  AValue: TdxDefaultBoolean = bDefault);
begin
  if not Items.IsValidIndex(AItemIndex) then
    Exit;
  if HasCheckBox(AItemIndex) then
    Checked[AItemIndex] := dxDefaultBooleanToBoolean(AValue,
      not Checked[AItemIndex]);
  DoItemAction(AItemIndex);
end;

function TdxCustomCheckListBox.NeedBeginDrag(AButton: TMouseButton;
  AShiftState: TShiftState): Boolean;
begin
  Result := (AButton = mbLeft) and (DragMode = dmAutomatic) and ItemMoving and
    not Sorted;
  if Result then
...
function TdxCustomCheckListBox.NeedUseSelectionColor
  (AItem: TdxCustomListBoxItem; AState: TcxButtonState): Boolean;
begin
  Result := Selected[AItem.Index] or not MultiSelect and
    inherited NeedUseSelectionColor(AItem, AState);
end;
...
procedure TdxCustomCheckListBox.InternalMouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  APrevIndex: Integer;
begin
  ...
  if HitAtItemCheckBox(ItemIndex) then
    SelectFocusedItem
  else if NeedBeginDrag(Button, Shift) then
  begin
...
procedure TdxCustomCheckListBox.InternalMouseMove(Shift: TShiftState;
  X, Y: Integer);
var
...
begin
  ...
  if Items.IsValidIndex(AItemIndex) and
    (AItemIndex <> FSelectedViaMouseMovePriorIndex) then
    if ssCtrl in Shift then
    begin
      if ((FAnchorIndex <= AItemIndex) and
        (AItemIndex < FSelectedViaMouseMovePriorIndex)) or
        ((FSelectedViaMouseMovePriorIndex < AItemIndex) and
        (AItemIndex <= FAnchorIndex)) then
        Selected[FSelectedViaMouseMovePriorIndex] :=
          not Selected[FSelectedViaMouseMovePriorIndex];
      if ((AItemIndex > FAnchorIndex) and
        (AItemIndex > FSelectedViaMouseMovePriorIndex)) or
        ((AItemIndex < FAnchorIndex) and
        (AItemIndex < FSelectedViaMouseMovePriorIndex)) then
...
procedure TdxCustomCheckListBox.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  ...
  else if DragAndDropState <> ddsStarting then
    if not FInMouseSelectionProcess and (FAnchorIndex = ItemIndex) and
      not(ssCtrl in Shift) then
      SelectFocusedItem;
  FInMouseSelectionProcess := False;
end;

function TdxCustomCheckListBox.ProcessNavigationKey(var Key: Word;
  Shift: TShiftState): Boolean;
var
  APrevItem: Integer;
begin
  ...
  case Key of
    ...
    begin
      ...
      if Result and MultiSelect and not(ssCtrl in Shift) and
        (APrevItem <> ItemIndex) then
...
procedure TdxCustomCheckListBox.SelectItems(AStartIndex, AFinishIndex: Integer;
  AValue: Boolean);
var
  AChanged: Boolean;
  I: Integer;
...
procedure TdxCustomCheckListBox.SelectItemsViaMouseDown(APrevIndex: Integer;
  AShift: TShiftState);
...
begin
  ...
  begin
    ...
    else if APrevIndex = ItemIndex then
      SelectFocusedItem
    else
    begin
...
procedure TdxCustomCheckListBox.DoSelect(AIndex: Integer; AValue: Boolean;
...
function TdxCustomCheckListBox.GetAutoSizeItemWidth(const AUseCachedTextMaxWidth
  : Boolean = False): Integer;
begin
  Result := 0;
  if ShowCheckBoxes then
...
begin
  Result.cx := CheckBoxMargins.Left + LookAndFeelPainter.ScaledCheckButtonSize
    (ScaleFactor).cx + CheckBoxMargins.Right;
  Result.cy := CheckBoxMargins.Top + LookAndFeelPainter.ScaledCheckButtonSize
    (ScaleFactor).cy + CheckBoxMargins.Bottom;
  dxAdjustToTouchableSize(Result, ScaleFactor);
end;

function TdxCustomCheckListBox.GetCheckBoxMargins: TRect;
begin
  Result := cxRect(dxCheckBoxOffset, dxCheckBoxOffset, dxCheckBoxOffset,
    dxCheckBoxOffset);
...
procedure TdxCustomCheckListBox.SetCheckedIndexes
  (const Value: TdxIntegerIndexes);
var
  I: Integer;
begin
  BeginUpdate;
...
procedure TdxCustomCheckListBox.SetState(AIndex: Integer;
...
procedure TdxCustomDropDownInnerListBox.AdjustItemFont(AFont: TFont;
  AItem: TdxCustomListBoxItem; AState: TcxButtonState);
begin
  AFont.Style := GetItemFontStyle(AItem);
end;

procedure TdxCustomDropDownInnerListBox.DoSelectItem(ASelectedViaKeyboard
  : Boolean);
begin
...
begin
  LookAndFeelPainter.DrawDropDownListBoxBackground(Canvas, ClientRect,
    BorderSize > 0);
  AImagesAreaRect := ImagesAreaRect;
  if UseRightToLeftAlignment then
    AImagesAreaRect := TdxRightToLeftLayoutConverter.ConvertRect
      (AImagesAreaRect, ClientBounds);
  LookAndFeelPainter.DrawDropDownListBoxScaledGutterBackground(Canvas,
    AImagesAreaRect, ScaleFactor);
end;

procedure TdxCustomDropDownInnerListBox.DrawItemBackground(const R: TRect;
  AItem: TdxCustomListBoxItem; AState: TcxButtonState);
var
  AImagesAreaRect: TRect;
begin
  ...
  begin
    ...
    if UseRightToLeftAlignment then
      AImagesAreaRect := TdxRightToLeftLayoutConverter.ConvertRect
        (AImagesAreaRect, Bounds);
    LookAndFeelPainter.DrawDropDownListBoxScaledSelection(Canvas, R,
      AImagesAreaRect, ScaleFactor);
  end;
end;

function TdxCustomDropDownInnerListBox.ProcessNavigationKey(var Key: Word;
  Shift: TShiftState): Boolean;
begin
  Result := True;
  case Key of
...
procedure TdxCustomDropDownInnerListBox.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
  inherited MouseMove(Shift, X, Y);
...
procedure TdxCustomDropDownInnerListBox.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
begin
  Result := LookAndFeelPainter.DropDownListBoxScaledItemImageOffsets
    (ScaleFactor);
end;
...
function TdxCustomDropDownInnerListBox.GetItemFontStyle
  (AItem: TdxCustomListBoxItem): TFontStyles;
begin
  Result := Font.Style;
...
function TdxCustomDropDownInnerListBox.GetTextColor(AItem: TdxCustomListBoxItem;
  AState: TcxButtonState): TColor;
begin
  Result := Font.Color;
  if Result = clWindowText then
    Result := LookAndFeelPainter.DropDownListBoxItemTextColor
      (AState = cxbsPressed);
  if Result = clDefault then
    Result := clWindowText;
end;
...
begin
  Result := LookAndFeelPainter.DropDownListBoxScaledItemTextOffsets
    (ScaleFactor);
end;

function TdxCustomDropDownInnerListBox.IsDefaultItem
...
function TdxCustomDropDownListBox.CreateInnerListBox
  : TdxCustomDropDownInnerListBox;
begin
...
procedure TdxCustomDropDownListBox.DoSelectItem(AItem: TdxCustomListBoxItem;
  ASelectedViaKeyboard: Boolean);
begin
  if Assigned(OnSelect) then
    OnSelect(Self, AItem, ASelectedViaKeyboard);
end;
...
procedure TdxCustomDropDownListBox.PopupForBounds(const ABounds: TRect;
  AActivateKey: Char = #0);
begin
...
constructor TdxQuickCustomizationCustomCommand.Create(const ACaption: string;
  AHasCheckBox: Boolean);
begin
  FCaption := ACaption;
...
function TdxQuickCustomizationCustomCheckListBox.DoIncrementalSearch
  (var Key: Char): Boolean;
begin
  Result := inherited DoIncrementalSearch(Key);
  if not Result and (SearchText <> '') then
    QuickCustomizationControl.Controller.DoIncrementalSearchOnOtherListBox(Self,
      SearchText);
end;

function TdxQuickCustomizationCustomCheckListBox.GetQuickCustomizationControl
  : TdxQuickCustomizationCustomControl;
begin
...
begin
  Result := inherited NeedHandleClick and
    (not HasCheckBox(ItemIndex) or HitAtItemCheckBox(ItemIndex));
end;

function TdxQuickCustomizationCustomCheckListBox.ProcessNavigationKey
  (var Key: Word; Shift: TShiftState): Boolean;
begin
  Result := GetQuickCustomizationControl.Controller.ProcessNavigationKey(Self,
    Key, Shift) or inherited ProcessNavigationKey(Key, Shift);
end;
...
procedure TdxQuickCustomizationCommandListBox.CheckedChanged
  (AItemIndex: Integer);
begin
...
function TdxQuickCustomizationCommandListBox.HasCheckBox
  (AItemIndex: Integer): Boolean;
begin
  Result := Command[AItemIndex].HasCheckBox;
end;

function TdxQuickCustomizationCommandListBox.GetCommand(AItemIndex: Integer)
  : TdxQuickCustomizationCustomCommand;
begin
...
procedure TdxQuickCustomizationCheckListBox.WMLButtonDblClk
...
procedure TdxQuickCustomizationCheckListBox.InternalMouseDown
...
begin
  ...
  else if MultiSelect and (APrevCount = Count) then
  begin
    SelectItemsViaMouseDown(APrevIndex, Shift);
    FSelectedViaMouseMovePriorIndex := FAnchorIndex;
    FInMouseSelectionProcess := True;
...
constructor TdxQuickCustomizationController.Create
  (AOwner: TdxQuickCustomizationCustomControl);
begin
  FOwner := AOwner;
end;

function TdxQuickCustomizationController.DoIncrementalSearchOnOtherListBox
  (Sender: TdxCustomCheckListBox; const ASearchText: string): Boolean;
var
...
procedure TdxQuickCustomizationController.DoKeyUp(Sender: TObject;
...
begin
  ...
  else if CheckListBox.ItemIndex >= 0 then
...
function TdxQuickCustomizationController.GetCommandListBox
  : TdxCustomCheckListBox;
begin
  Result := Owner.CommandListBox;
end;

procedure TdxQuickCustomizationController.HandleCommandListBoxMouseWheel
...
procedure TdxQuickCustomizationController.HandleItemIndexChanging
...
begin
  ...
  else if Sender = CheckListBox then
    CheckListBox.ClearSelection;
end;

function TdxQuickCustomizationController.ProcessCheckListBoxNavigationKey
  (var Key: Word; Shift: TShiftState): Boolean;
begin
  ...
  else if (CheckListBox.ItemIndex = 0) and (Key in [VK_PRIOR, VK_UP]) then
  begin
    CommandListBox.SetFocus;
    if Key = VK_UP then
...
function TdxQuickCustomizationController.ProcessCommandListBoxNavigationKey
  (var Key: Word; Shift: TShiftState): Boolean;
begin
  Result := True;
  case Key of
...
function TdxQuickCustomizationController.ProcessNavigationKey
  (Sender: TdxCustomListBox; var Key: Word; Shift: TShiftState): Boolean;
begin
  ...
  Result := ((Sender = CheckListBox) and ProcessCheckListBoxNavigationKey(Key,
    Shift)) or ((Sender = CommandListBox) and ProcessCommandListBoxNavigationKey
    (Key, Shift));
  if Result then
  begin
...
function TdxQuickCustomizationCustomControl.AddCommand(const ACaption: string;
  AHasCheckBox: Boolean; AOnAction: TNotifyEvent)
  : TdxQuickCustomizationCustomCommand;
begin
...
procedure TdxQuickCustomizationCustomControl.AdjustBounds
  (const AUseCachedTextMaxWidth: Boolean = False);
var
...
procedure TdxQuickCustomizationCustomControl.ChangeScaleEx(M, D: Integer;
  isDpiChange: Boolean);
begin
  inherited;
  AdjustBounds;
...
function TdxQuickCustomizationCustomControl.GetCommandListBoxClass
  : TdxQuickCustomizationCustomCheckListBoxClass;
begin
...
begin
  ...
  if HasCommands and (CheckListBox.GetSelectionCount = 0) then
    CommandListBox.ItemIndex := 0
  else if CheckListBox.GetSelectionCount > 0 then
    CheckListBox.ItemIndex := TdxNativeUInt(CheckListBox.Selection[0])
  else if CheckListBox.Count > 0 then
  begin
    CheckListBox.ItemIndex := 0;
    CheckListBox.SelectFocusedItem;
  end;
...
procedure TdxQuickCustomizationCustomControl.SetBounds(ALeft, ATop, AWidth,
  AHeight: Integer);
begin
