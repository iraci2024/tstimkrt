...
class function TcxCustomButtonEditProperties.GetContainerClass
  : TcxContainerClass;
begin
...
class function TcxCustomButtonEdit.GetPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TcxCustomButtonEditProperties;
end;

function TcxCustomButtonEdit.InternalGetNotPublishedStyleValues
  : TcxEditStyleValues;
begin
...
procedure TcxCustomButtonEdit.SetProperties
  (Value: TcxCustomButtonEditProperties);
begin
...
GetRegisteredEditProperties.Register(TcxButtonEditProperties,
