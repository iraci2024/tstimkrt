...
type
  ...
  TcxInplaceEditContainerVisibleForExpressionEditorPropertyEditor = class
  ...
  TcxInplaceEditContainerPropertiesEventsProperty = class
  ...
  TcxInplaceEditContainerCustomItemDataBindingExpressionProperty = class
    (TStringProperty)
  private
  ...
  TcxDesignSelectionHelper = class(TcxCustomDesignSelectionHelper, IUnknown,
    IDesignNotification)
  private
...
function TcxInplaceEditContainerVisibleForExpressionEditorPropertyEditor.
  GetDefaultValue: Boolean;
begin
  Result := TcxCustomInplaceEditContainerAccess(GetComponent(0))
    .IsDefaultVisibleForExpressionEditor;
end;

{ TcxInplaceEditContainerPropertiesEventsProperty }

function TcxInplaceEditContainerPropertiesEventsProperty.GetInstance
  : TPersistent;
var
...
function TcxInplaceEditContainerPropertiesProperty.GetAttributes
  : TPropertyAttributes;
begin
...
procedure TcxInplaceEditContainerPropertiesProperty.GetValues
  (Proc: TGetStrProc);
var
  I: Integer;
  ADesc: string;
...
procedure TcxInplaceEditContainerPropertiesProperty.SetValue
  (const Value: string);
var
...
function TcxInplaceEditContainerCustomItemDataBindingExpressionProperty.
...
function TcxDesignSelectionHelper.QueryInterface(const IID: TGUID; out Obj)
  : HResult; stdcall;
begin
...
begin
  ...
  RegisterPropertyEditor(TypeInfo(TNotifyEvent), TcxCustomInplaceEditContainer,
    'PropertiesEvents', TcxInplaceEditContainerPropertiesEventsProperty);
  ...
  RegisterPropertyEditor(TypeInfo(TdxDefaultBoolean),
    TcxCustomInplaceEditContainer, 'VisibleForExpressionEditor',
    TcxInplaceEditContainerVisibleForExpressionEditorPropertyEditor);
end;
