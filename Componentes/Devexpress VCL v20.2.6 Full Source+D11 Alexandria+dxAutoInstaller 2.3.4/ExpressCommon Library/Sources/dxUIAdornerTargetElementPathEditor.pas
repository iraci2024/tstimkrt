...
function ShowAdornerTargetElementPathEditor
  (APath: TdxAdornerTargetElementPath): Boolean;
...
procedure TdxUIAdornerTargetElementPathEditor.Initialize
  (APath: TdxAdornerTargetElementPath);
begin
  FPath := APath;
...
procedure TdxUIAdornerTargetElementPathEditor.tvTargetElementsChange
...
function TdxUIAdornerTargetElementPathEditor.FindNodeByPath(APath: string)
  : TTreeNode;
var
  I: Integer;
begin
...
function TdxUIAdornerTargetElementPathEditor.GetNodePath
...
begin
  btnSelect.Enabled := (tvTargetElements.Selected <> nil) and
    Boolean(tvTargetElements.Selected.Data);
end;

procedure TdxUIAdornerTargetElementPathEditor.UpdateImageIndex
  (ANode: TTreeNode);
var
  AIndex: Integer;
begin
