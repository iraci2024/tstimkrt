...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Windows, Messages, Variants, Forms, ComCtrls, Classes, Controls,
  Graphics,
  Menus, StdCtrls, SysUtils, ActnList, ImgList,
  dxCore, dxCoreClasses, dxMessages, dxGDIPlusClasses, cxGeometry,
  dxDPIAwareUtils,
  cxClasses, cxContainer, cxControls, cxCustomData, dxSpellCheckerCore,
  cxDataStorage, cxDataUtils, cxGraphics, cxLookAndFeels, cxVariants,
  dxCustomHint,
...
const
  ...
  cxEditStyleValueNameA: array [0 .. cxEditStyleValueCount -
    cxContainerStyleValueCount - 1] of string = ('ButtonStyle',
    'ButtonTransparency', 'PopupBorderStyle', 'GradientButtons', 'Gradient',
    'GradientDirection');

  EditContentDefaultOffsets: array [Boolean] of TRect = ((Left: 1; Top: 1;
    Right: 1; Bottom: 3), (Left: 1; Top: 1; Right: 1; Bottom: 1));
  ...
  EditBtnPositionMap: array [Boolean] of TcxEditBtnPosition = (cxbpRight,
    cxbpLeft);
...
type
  ...
  TcxEditValidateEvent = procedure(Sender: TObject;
    var DisplayValue: TcxEditValue; var ErrorText: TCaption; var Error: Boolean)
    of object;
  TcxEditErrorKind = Integer;
  TcxEditValidationOptions = set of (evoRaiseException, evoShowErrorIcon,
    evoAllowLoseFocus);
  ...
  IcxEditorFieldLink = interface
    ...
    function CreateFieldControls(X, Y: Integer;
      ADataSource: TObject { TDataSource }; AFieldList: TList): Boolean;
  end;

  IcxEditorFieldLink2 = interface(IcxEditorFieldLink)
    ['{4A1B4837-FF36-4408-AF91-D195D16F2BA0}']
    procedure DoCreateFieldControl(AControl: TControl;
      AField: TObject { TField } );
  ...
  public
    ...
    class function GetEditPropertiesClass
      : TcxCustomEditPropertiesClass; virtual;
  ...
  public
    ...
    destructor Destroy; override;
    procedure Clear;
    function CreateItem(ARepositoryItemClass: TcxEditRepositoryItemClass)
      : TcxEditRepositoryItem; virtual;
    function CreateItemEx(ARepositoryItemClass: TcxEditRepositoryItemClass;
      AOwner: TComponent): TcxEditRepositoryItem; virtual;
    function ItemByName(const ARepositoryItemName: string)
      : TcxEditRepositoryItem;
  ...
  protected
    ...
    procedure GetFadingImages(out AFadeOutImage, AFadeInImage
      : TcxBitmap); override;
    function PrepareFadingImage(AState: TcxEditButtonState)
      : TcxBitmap32; virtual;
  public
  ...
  public
    ...
    function GetUpdateRegion(AViewInfo: TcxEditButtonViewInfo)
      : TcxRegion; virtual;
  ...
  protected
    ...
    property LeftAlignment: Boolean read FLeftAlignment write SetLeftAlignment
      default False;
    property Stretchable: Boolean read FStretchable write SetStretchable
      default True;
    property Tag: TcxTag read FTag write FTag stored IsTagStored;
    property TextColor: TColor read FTextColor write SetTextColor
      default clBtnText; // TODO published
  ...
  public
    constructor Create(AOwner: TPersistent;
      AButtonClass: TcxEditButtonClass); virtual;
    destructor Destroy; override;
    //
    property Items[Index: Integer]: TcxCustomEditButton read GetItem
  ...
  public
    ...
    //
    property Items[Index: Integer]: TcxEditButton read GetItem
      write SetItem; default;
  end;
  ...
  TcxEditCanStartButtonFadingEvent = procedure(Sender: TcxCustomEditViewInfo;
    var ACanStart: Boolean) of object;
  ...
  TcxEditDrawButtonBorderEvent = procedure(Sender: TcxEditButtonViewInfo;
    ACanvas: TcxCanvas; var ABackgroundRect, AContentRect: TRect;
    var AHandled: Boolean) of object;
  TcxEditGetButtonContentColorEvent = procedure(Sender: TcxEditButtonViewInfo;
    var AColor: TColor) of object;
  TcxEditGetButtonStateEvent = procedure(Sender: TcxEditButtonViewInfo;
    var AState: TcxEditButtonState) of object;
  TcxEditPaintEvent = procedure(Sender: TcxCustomEditViewInfo;
    ACanvas: TcxCanvas) of object;
  TcxEditPrepareButtonFadingImageEvent = procedure
    (ASender: TcxEditButtonViewInfo; AState: TcxEditButtonState;
    out AImage: TcxBitmap32; var AHandled: Boolean) of object;

  TcxDrawBackgroundStyle = (dbsCustom, dbsCustomEdit, dbsNone, dbsSimpleFill,
    dbsSimpleParent, dbsThemeParent);
...
{$REGION 'strict private type'}
    TAfterDrawEvent = procedure(Sender: TcxCustomEditViewInfo;
      ACanvas: TcxCanvas) of object;
    TCanDrawEditValueEvent = procedure(Sender: TcxCustomEditViewInfo;
      var Allow: Boolean) of object;
    TCalculateEditorBoundsEvent = procedure(AViewInfo: TcxCustomEditViewInfo;
...
{$ENDREGION}
  private
    ...
    function DoDrawButton(ACanvas: TcxCanvas;
      AViewInfo: TcxEditButtonViewInfo): Boolean;
    function DoDrawButtonBackground(ACanvas: TcxCanvas; const ARect: TRect;
      AViewInfo: TcxEditButtonViewInfo): Boolean;
    function DoDrawButtonBorder(ACanvas: TcxCanvas;
      AViewInfo: TcxEditButtonViewInfo;
      var ABackgroundRect, AContentRect: TRect): Boolean;
  ...
  protected
    ...
    function CalculateBackgroundColor(AStyle: TcxContainerStyle;
      AEnabled: Boolean; AContainer: TcxContainer = nil): TColor; override;

    function GetCurrentCursor(const AMousePos: TPoint): TCursor; virtual;
    procedure InplaceMouseDown(AButton: TMouseButton; const AShift: TShiftState;
      X, Y: Integer); virtual;

    function GetBackgroundPaintingStyle
      : TcxEditBackgroundPaintingStyle; virtual;
    ...
    procedure InternalPrepareEditButtonBackground(ACanvas: TcxCanvas;
      AViewInfo: TcxEditButtonViewInfo;
      out AContentRect, ABackgroundRect: TRect;
      out APenColor, ABrushColor: TColor; ACalculateOnly: Boolean);
    function IsRepaintOnStateChangingNeeded: Boolean; virtual;
    procedure DrawEditButton(ACanvas: TcxCanvas;
      AButtonVisibleIndex: Integer); virtual;
    ...
    procedure Draw3DButtonBorder(ACanvas: TcxCanvas;
      AButtonViewInfo: TcxEditButtonViewInfo; var ARect: TRect;
      out AContentRect: TRect; var APenColor, ABrushColor: TColor); virtual;
    procedure DrawFlatButtonBorder(ACanvas: TcxCanvas;
      AButtonViewInfo: TcxEditButtonViewInfo; var ARect: TRect;
      out AContentRect: TRect; var APenColor, ABrushColor: TColor); virtual;
    procedure DrawHotFlatButtonBorder(ACanvas: TcxCanvas;
      AButtonViewInfo: TcxEditButtonViewInfo; var ARect: TRect;
      out AContentRect: TRect; var APenColor, ABrushColor: TColor); virtual;
    procedure DrawNativeButtonBorder(ACanvas: TcxCanvas;
      AButtonViewInfo: TcxEditButtonViewInfo; var ARect: TRect;
      out AContentRect: TRect; var APenColor, ABrushColor: TColor); virtual;
    procedure DrawSimpleButtonBorder(ACanvas: TcxCanvas;
      AButtonViewInfo: TcxEditButtonViewInfo; var ARect: TRect;
      out AContentRect: TRect; var APenColor, ABrushColor: TColor); virtual;
    procedure DrawUltraFlatButtonBorder(ACanvas: TcxCanvas;
      AButtonViewInfo: TcxEditButtonViewInfo; AIsOffice11Style: Boolean;
      var ARect: TRect; var AContentRect: TRect;
      out APenColor, ABrushColor: TColor); virtual;
    ...
    procedure DrawButtonBorderByPainter(AButtonViewInfo: TcxEditButtonViewInfo;
      var ARect: TRect; out AContentRect: TRect;
  ...
  public
    ...
    function DrawBackground(ACanvas: TcxCanvas; const APos: TPoint)
      : Boolean; overload;
    procedure DrawCustomEdit(ACanvas: TcxCanvas;
      ACanDrawBackground, ACanDrawValidationMark: Boolean);
    procedure DrawCustomEditValidationMark(ACanvas: TcxCanvas);
    procedure DrawEditBackground(ACanvas: TcxCanvas; ARect, AGlyphRect: TRect;
      AGlyphTransparent: Boolean);
    ...
    procedure DrawButtonBackground(ACanvas: TcxCanvas;
      AViewInfo: TcxEditButtonViewInfo; const ARect, AContentRect: TRect;
      ABrushColor: TColor);
    procedure DrawButtonBorder(ACanvas: TcxCanvas;
      AViewInfo: TcxEditButtonViewInfo; var ARect, AContentRect: TRect;
      var APenColor, ABrushColor: TColor); virtual;
    procedure DrawButtonContent(ACanvas: TcxCanvas;
      AViewInfo: TcxEditButtonViewInfo; const AContentRect: TRect;
      APenColor, ABrushColor: TColor; ANeedOffsetContent: Boolean); virtual;
    ...
    function IsCustomButtonBackground(AButtonVisibleIndex: Integer = 0)
      : Boolean;
    ...
    function NeedShowHint(ACanvas: TcxCanvas; const P: TPoint;
      ...
      AMaxLineCount: Integer = 0): Boolean; virtual;
    ...
    function GetUpdateRegion(AViewInfo: TcxContainerViewInfo)
      : TcxRegion; override;
    ...
    //
    property BackgroundPaintingStyle: TcxEditBackgroundPaintingStyle
      read GetBackgroundPaintingStyle;
    ...
    //
    property OnAfterDrawBackground: TAfterDrawEvent read FOnAfterDrawBackground
      write FOnAfterDrawBackground;
    property OnAfterDrawValue: TAfterDrawEvent read FOnAfterDrawValue
      write FOnAfterDrawValue;
    property OnCalculateEditorBounds: TCalculateEditorBoundsEvent
      read FOnCalculateEditorBounds write FOnCalculateEditorBounds;
    property OnCanDrawEditValue: TCanDrawEditValueEvent read FOnCanDrawEditValue
      write FOnCanDrawEditValue;
    //
    property OnCanStartButtonFading: TcxEditCanStartButtonFadingEvent
      read FOnCanStartButtonFading write FOnCanStartButtonFading;
    ...
    property OnGetButtonContentColor: TcxEditGetButtonContentColorEvent
      read FOnGetButtonContentColor write FOnGetButtonContentColor;
    property OnGetButtonState: TcxEditGetButtonStateEvent read FOnGetButtonState
      write FOnGetButtonState;
    property OnPaint: TcxEditPaintEvent read FOnPaint write FOnPaint;
    property OnPrepareButtonFadingImage: TcxEditPrepareButtonFadingImageEvent
      read FOnPrepareButtonFadingImage write FOnPrepareButtonFadingImage;
  end;
  ...
  private
    ...
    procedure DoGetButtonState(AViewInfo: TcxEditButtonViewInfo;
      var AState: TcxEditButtonState);
  ...
  protected
    ...
    // ButtonNativeInfo
    procedure CalculateButtonNativeInfo(AButtonViewInfo
      : TcxEditButtonViewInfo); virtual;
    procedure CalculateButtonNativePartInfo(ATheme: TdxTheme;
      AButtonViewInfo: TcxEditButtonViewInfo); virtual;
    function GetButtonNativeTheme(AButtonViewInfo: TcxEditButtonViewInfo)
      : TdxTheme; virtual;
    //
    function CalculatePaintOptions: TcxEditPaintOptions; virtual;
    procedure CalculateViewInfo(AViewInfo: TcxCustomEditViewInfo;
      AIsMouseEvent: Boolean);
    function CanPressButton(AViewInfo: TcxCustomEditViewInfo;
    ...
    function GetContainerState(const ABounds: TRect; const P: TPoint;
      ...
      : TcxContainerState; virtual;
    function GetEditContentDefaultOffsets: TRect; virtual;
    function GetEditNativeState(AViewInfo: TcxCustomEditViewInfo)
      : Integer; virtual;
    ...
    function InternalEditValueToDisplayText(AEditValue: TcxEditValue)
      : string; virtual;
    ...
    function InternalGetEditConstantPartSize(ACanvas: TcxCanvas;
      ...
      var MinContentSize: TSize; AViewInfo: TcxCustomEditViewInfo)
      : TSize; virtual;
    ...
    function InternalGetEditSize(ACanvas: TcxCanvas;
      const AEditValue: TcxEditValue;
      AEditSizeProperties: TcxEditSizeProperties;
      AViewInfo: TcxCustomEditViewInfo = nil;
      AIsEditing: Boolean = False): TSize;
  ...
  public
    ...
    constructor Create(AProperties: TcxCustomEditProperties;
      AStyle: TcxCustomEditStyle; AIsInplace: Boolean); reintroduce; virtual;
    destructor Destroy; override;

    procedure Calculate(ACanvas: TcxCanvas; const ABounds: TRect;
      const P: TPoint; Button: TcxMouseButton; Shift: TShiftState;
      AViewInfo: TcxCustomEditViewInfo; AIsMouseEvent: Boolean); virtual;
    procedure CalculateButtonBounds(ACanvas: TcxCanvas;
    ...
    procedure CheckStartButtonsFading(AViewInfo
      : TcxCustomEditViewInfo); virtual;
    procedure DoRightToLeftConversion(AViewInfo: TcxCustomEditViewInfo;
    ...
    procedure InitializeButtonInfo(AViewInfo: TcxCustomEditViewInfo;
      AButtonVisibleIndex: Integer); virtual;
    ...
    function GetEditConstantPartSize(ACanvas: TcxCanvas;
      ...
      var MinContentSize: TSize; AViewInfo: TcxCustomEditViewInfo = nil)
      : TSize; virtual;
    function GetEditContentSize(ACanvas: TcxCanvas;
      const AEditValue: TcxEditValue;
      const AEditSizeProperties: TcxEditSizeProperties;
      AErrorData: TcxEditValidateInfo = nil): TSize; virtual;
    function GetEditingContentSize(ACanvas: TcxCanvas;
      const AEditValue: TcxEditValue;
      const AEditSizeProperties: TcxEditSizeProperties): TSize; virtual;
    ...
    function IgnoreButtonWhileStretching(AButtonVisibleIndex: Integer)
      : Boolean; virtual;
    function IsButtonLeftAligned(AViewInfo: TcxCustomEditViewInfo;
      AButtonVisibleIndex: Integer): Boolean; virtual;
    class function IsNativeStyle(ALookAndFeel: TcxLookAndFeel)
      : Boolean; virtual;
  ...
  strict private
    function GetInternalStyle(AState: TcxContainerStateItem)
      : TcxCustomEditStyle;
  ...
  private
    ...
    function InternalGetButtonStyle(var ButtonStyle
      : TcxEditButtonStyle): Boolean;
    function InternalGetButtonTransparency(var ButtonTransparency
      : TcxEditButtonTransparency): Boolean;
    ...
    function InternalGetGradientDirection(var GradientDirection
      : TcxEditGradientDirection): Boolean;
    function InternalGetPopupBorderStyle(var PopupBorderStyle
  ...
  protected
    ...
    function InternalGetNotPublishedExtendedStyleValues
      : TcxEditStyleValues; override;
  ...
  public
    ...
    property ButtonTransparency: TcxEditButtonTransparency
      read GetButtonTransparency write SetButtonTransparency
      stored IsButtonTransparencyStored;
    ...
    property GradientDirection: TcxEditGradientDirection
      read GetGradientDirection write SetGradientDirection
      stored IsGradientDirectionStored;
  ...
  TcxCustomEditDefaultValuesProvider = class(TcxInterfacedPersistent, IUnknown,
    IcxEditDefaultValuesProvider)
  public
    destructor Destroy; override;
  ...
  TcxCustomEditDefaultValuesProviderClass = class of
    TcxCustomEditDefaultValuesProvider;

  { TcxCustomEditProperties }

  TcxEditButtonClickEvent = procedure(Sender: TObject; AButtonIndex: Integer)
    of object;
  TcxEditEditingEvent = procedure(Sender: TObject; var CanEdit: Boolean)
    of object;
  TcxEditCloseUpReason = (crUnknown, crTab, crClose, crCancel, crEnter);
  TcxEditClosePopupEvent = procedure(Sender: TcxControl;
    AReason: TcxEditCloseUpReason) of object;
  ...
  protected
    ...
    procedure FreeNotification(Sender: TComponent); virtual;
    class function GetAssignedValuesClass
      : TcxCustomEditPropertiesValuesClass; virtual;
    ...
    function GetValidateErrorText(AErrorKind: TcxEditErrorKind)
      : string; virtual;
    function GetValueEditorEditValueSource(AEditFocused: Boolean)
    ...
    function IsMinValueStored: Boolean;
    procedure InitiateActions; virtual;
    function SupportsMultiThreading(AUseDisplayValue: Boolean)
      : Boolean; virtual;
    ...
    property DisplayFormatOptions: TcxEditDisplayFormatOptions
      read GetDisplayFormatOptions;
    property FreeNotificator: TcxFreeNotificator read GetFreeNotificator;
  ...
  public
    ...
    function CompareDisplayValues(const AEditValue1, AEditValue2: TcxEditValue)
      : Boolean; virtual;
    function CreatePreviewProperties: TcxCustomEditProperties; virtual;
    function CreateViewData(AStyle: TcxCustomEditStyle; AIsInplace: Boolean;
      APreviewMode: Boolean = False): TcxCustomEditViewData; virtual;
    procedure DataChanged; virtual;
    function GetDisplayText(const AEditValue: TcxEditValue;
      AFullText: Boolean = False; AIsInplace: Boolean = True): string; virtual;
    function GetEditConstantPartSize(ACanvas: TcxCanvas;
    ...
    function GetEditSize(ACanvas: TcxCanvas; AEditStyle: TcxCustomEditStyle;
      AIsInplace: Boolean; const AEditValue: TcxEditValue;
    ...
    function IsEditValueValid(var EditValue: TcxEditValue;
      AEditFocused: Boolean): Boolean; virtual;
    ...
    property OnPropertiesChanged: TNotifyEvent read FOnPropertiesChanged
      write FOnPropertiesChanged;
    property ReadOnly: Boolean read GetReadOnly write SetReadOnly
      stored IsReadOnlyStored;
    property UseLeftAlignmentOnEditing: Boolean read FUseLeftAlignmentOnEditing
      write SetUseLeftAlignmentOnEditing
      stored IsUseLeftAlignmentOnEditingStored;
    ...
    property ImmediatePost: Boolean read FImmediatePost write FImmediatePost
      default False;
    property ValidateOnEnter: Boolean read FValidateOnEnter
      write FValidateOnEnter default False;
    property ValidationErrorIconAlignment: TLeftRight
      read FValidationErrorIconAlignment write SetValidationErrorIconAlignment
      default taLeftJustify;
    property ValidationOptions: TcxEditValidationOptions read FValidationOptions
      write SetValidationOptions default [evoRaiseException];

    property ErrorIcon: TdxSmartImage read FErrorIcon write SetErrorIcon;

    property OnButtonClick: TcxEditButtonClickEvent read FOnButtonClick
      write FOnButtonClick;
    property OnChange: TNotifyEvent read FOnChange write FOnChange;
    property OnClosePopup: TcxEditClosePopupEvent read FOnClosePopup
      write FOnClosePopup;
    property OnEditValueChanged: TNotifyEvent read FOnEditValueChanged
      write FOnEditValueChanged;
    property OnValidate: TcxEditValidateEvent read FOnValidate
      write FOnValidate;
  end;
  ...
  public
    ...
    class function GetDefaultValuesProviderClass
    ...
    property IDefaultValuesProvider: IcxEditDefaultValuesProvider
      read GetIDefaultValuesProvider; // for internal use
  ...
  private
    procedure CMGestureManagerChanged(var Message: TMessage);
      message CM_GESTUREMANAGERCHANGED;
  ...
  protected
    ...
    procedure IcxMouseTrackingCaller3.MouseLeave =
      MouseTrackingCallerMouseLeave;
  ...
  TcxCustomEdit = class(TcxCustomEditContainer, IcxEditRepositoryItemListener,
    IcxInplaceEditIMEHelper, IdxSkinSupport, IdxSpellCheckerControl,
    IdxFadingObject, IcxEditOwner, IdxTouchModeSupport)
  private
    FAnchorX: Integer;
    FAnchorY: Integer;
    ...
    procedure DXMUpdateEditValue(var Message: TMessage);
      message DXM_UPDATEEDITVALUE;
  protected
    ...
    function DoInnerControlDefaultHandler(var Message: TMessage)
      : Boolean; override;
    ...
    procedure CalculateViewInfo(P: TPoint; Button: TcxMouseButton;
      Shift: TShiftState; AIsMouseEvent: Boolean); reintroduce;
      overload; virtual;
    ...
    class function GetDataBindingClass: TcxEditDataBindingClass;
      reintroduce; virtual;
    ...
    procedure PopulateSizeProperties(var AEditSizeProperties
      : TcxEditSizeProperties); virtual;
    ...
    function CanKeyDownModifyEdit(Key: Word; Shift: TShiftState)
      : Boolean; virtual;
    ...
    function IsValidChar(AChar: Char): Boolean; virtual;
    function NeedsInvokeAfterKeyDown(AKey: Word; AShift: TShiftState)
      : Boolean; virtual;
    ...
    procedure DoValidateDisplayValue(var ADisplayValue: TcxEditValue;
      var AErrorText: TCaption; var AError: Boolean); virtual;
    ...
    function InternalValidateEdit(AValidationOptions: TcxEditValidationOptions;
      AForceValidation: Boolean = False): Boolean; overload;
    function InternalValidateEdit(AForceValidation: Boolean = False)
      : Boolean; overload;
    ...
    function ValidateKeyDown(var Key: Word; Shift: TShiftState)
      : Boolean; virtual;
    ...
    // IcxEditRepositoryItemListener
    procedure IcxEditRepositoryItemListener.ItemRemoved =
      RepositoryItemListenerItemRemoved;
    ...
    procedure RepositoryItemListenerPropertiesChanged
      (Sender: TcxEditRepositoryItem);

    // IdxSpellCheckerSupport
    procedure IdxSpellCheckerControl.SetValue = SpellCheckerSetValue;
    procedure IdxSpellCheckerControl.SetIsBarControl =
      SpellCheckerSetIsBarControl;
    ...
    procedure SpellCheckerSetSelText(const AValue: string;
      APost: Boolean = False); virtual;
    ...
    procedure FadingGetBackgroundImages(out AFadeOutImage,
      AFadeInImage: TcxBitmap); virtual;
    ...
    property AutoSize: Boolean read GetAutoSize write SetEditAutoSize
      default True;
    property AutoWidth: Boolean read FAutoWidth write SetAutoWidth;
    property CaptureButtonVisibleIndex: Integer read FCaptureButtonVisibleIndex
      write FCaptureButtonVisibleIndex;
    property ChangeEventsCatcher: TcxEditChangeEventsCatcher
      read FChangeEventsCatcher;
    property DataBinding: TcxEditDataBinding read FDataBinding
    ...
    property IsEditValidated: Boolean read FIsEditValidated
      write FIsEditValidated;

    property IsInplaceInitializing: Boolean read FIsInplaceInitializing;
    property IsKeyPressHandled: Boolean read FIsKeyPressHandled
      write FIsKeyPressHandled;
    property NeedFocusOnClick: Boolean read FNeedFocusOnClick
      write FNeedFocusOnClick;
    property PrevEditValue: TcxEditValue read FPrevEditValue
      write SetPrevEditValue;
    property Properties: TcxCustomEditProperties read FProperties
      write SetProperties;
    property SupportsTouchMode: Boolean read FSupportsTouchMode
      write FSupportsTouchMode;
  ...
  public
    ...
    constructor Create(AOwner: TComponent; AIsInplace: Boolean); reintroduce;
      overload; virtual;
    destructor Destroy; override;
    ...
    procedure Activate(var AEditData: TcxCustomEditData;
      ANeedSetFocus: Boolean = True); virtual;
    procedure ActivateByKey(Key: Char;
    ...
    function IsRepositoryItemAcceptable(ARepositoryItem: TcxEditRepositoryItem)
      : Boolean; virtual;
    ...
    property ModifiedAfterEnter: Boolean read FModifiedAfterEnter
      write SetModifiedAfterEnter;
    property Style: TcxEditStyle read GetStyle write SetStyle;
    property StyleDisabled: TcxEditStyle read GetStyleDisabled
      write SetStyleDisabled;
    property StyleFocused: TcxEditStyle read GetStyleFocused
    ...
    property OnAfterKeyDown: TKeyEvent read FOnAfterKeyDown
      write FOnAfterKeyDown;
    property OnEditing: TcxEditEditingEvent read FOnEditing write FOnEditing;
    property OnPostEditValue: TNotifyEvent read FOnPostEditValue
      write FOnPostEditValue;
  published
  ...
  public
    ...
    constructor Create(AOwner: TPersistent;
      ADefaultHorzAlignment: TcxEditHorzAlignment;
      ADefaultVertAlignment: TcxEditVertAlignment); overload; virtual;
    procedure Assign(Source: TPersistent); override;
    ...
    procedure Reset;
  published
    property Horz: TcxEditHorzAlignment read FHorz write SetHorz
      stored IsHorzStored;
    property Vert: TcxEditVertAlignment read FVert write SetVert
      stored IsVertStored;
  end;
  ...
  private
    ...
    function CreateEdit(APropertiesClass: TcxCustomEditPropertiesClass)
      : TcxCustomEdit;
    procedure DestroyItems;
    function FindItem(AProperties: TcxCustomEditProperties;
      ACanUseFreeEditors: Boolean): Integer; overload;
    function FindItem(APropertiesClass: TcxCustomEditPropertiesClass)
      : Integer; overload;
    function GetCount: Integer; inline;
    function GetEdit(AItemIndex: Integer): TcxCustomEdit; overload;
    procedure InitEdit(AEdit: TcxCustomEdit;
  ...
  public
    ...
    function FindEdit(AProperties: TcxCustomEditProperties)
      : TcxCustomEdit; overload;
    function FindEdit(APropertiesClass: TcxCustomEditPropertiesClass)
      : TcxCustomEdit; overload;
    function GetEdit(AProperties: TcxCustomEditProperties)
      : TcxCustomEdit; overload;
    function GetEdit(APropertiesClass: TcxCustomEditPropertiesClass)
      : TcxCustomEdit; overload;
    procedure RemoveItem(AProperties: TcxCustomEditProperties); overload;
    procedure RemoveItem(APropertiesClass
      : TcxCustomEditPropertiesClass); overload;
  end;
  ...
  protected
    ...
    property ChangeEventsCatcher: TcxEditChangeEventsCatcher
      read GetChangeEventsCatcher;
    property EditHiding: Boolean read FEditHiding;
    property EditingItemSetting: Boolean read FEditingItemSetting
      write FEditingItemSetting;
    ...
    property HideEditOnFocusedRecordChange: Boolean
      read GetHideEditOnFocusedRecordChange;
...
const
  cxDefaultEditSizeProperties: TcxEditSizeProperties = (Height: - 1;
    MaxLineCount: 0; Width: - 1);

function ButtonToShift(Button: TMouseButton): TShiftState;
function cxButtonToShift(Button: TcxMouseButton): TShiftState;
function cxGetScaledEditProperties(var AInternalProperties
  : TcxCustomEditProperties; AProperties: TcxCustomEditProperties;
  AScaleFactor: TdxScaleFactor; AOwner: TPersistent = nil)
  : TcxCustomEditProperties;
...
function NeedAssignRepositoryItem(AItemProperties: TcxCustomEditProperties;
  ...
  var AEditingProperties: TcxCustomEditProperties): Boolean;
...
function ButtonToShift(Button: TMouseButton): TShiftState;
const
  AButtonMap: array [TMouseButton] of TShiftState = ([ssLeft], [ssRight],
    [ssMiddle]);
begin
  Result := AButtonMap[Button];
end;

procedure ClearPropertiesDestroyingListeners(AProperties
  : TcxCustomEditProperties);
var
  I: Integer;
begin
  if FInplaceEditLists <> nil then
    for I := 0 to FInplaceEditLists.Count - 1 do
      TcxInplaceEditList(FInplaceEditLists.List[I]).DisconnectProperties
        (AProperties);
end;

function cxButtonToShift(Button: TcxMouseButton): TShiftState;
const
  AButtonMap: array [TcxMouseButton] of TShiftState = ([], [ssLeft], [ssRight],
    [ssMiddle]);
begin
  Result := AButtonMap[Button];
end;
...
begin
  ...
  begin
    if (AInternalProperties = nil) or
      (AInternalProperties.ClassType <> Result.ClassType) then
    begin
...
function cxEditVarEquals(const V1, V2: Variant): Boolean;
  ...
  begin
    Result := VarIsNumericEx(V1) and VarIsNumericEx(V2) or
...
procedure DrawComplexFrameEx(ACanvas: TcxCanvas; var ARect: TRect;
...
procedure SendMouseEvent(AReceiver: TWinControl; AMessage: DWORD;
  AShift: TShiftState; const APoint: TPoint);
begin
  SendMessage(AReceiver.Handle, AMessage, ShiftStateToKeys(AShift),
    MakeLParam(APoint.X, APoint.Y));
end;

procedure SendKeyEvent(AReceiver: TWinControl; AMessage: DWORD; AKey: Word;
  AShift: TShiftState);
begin
...
class function TcxEditDataBinding.GetDefaultValuesProviderClass
...
function TcxEditDataBinding.GetIDefaultValuesProvider
  : IcxEditDefaultValuesProvider;
begin
...
var
  AProviderIntf: IcxEditDefaultValuesProvider;
  I: Integer;
begin
  if FCreatedEditPropertiesList <> nil then
  begin
    ...
    for I := 0 to FCreatedEditPropertiesList.Count - 1 do
      ...
      begin
        if IDefaultValuesProvider = AProviderIntf then
...
procedure TcxEditRepositoryItem.AddListener
  (AListener: IcxEditRepositoryItemListener);
begin
...
class function TcxEditRepositoryItem.GetEditPropertiesClass
...
procedure TcxEditRepositoryItem.RemoveListener
  (AListener: IcxEditRepositoryItemListener);
begin
...
function TcxEditRepositoryItem.ArePropertiesCompatible(APropertiesClass
  : TClass): Boolean;
begin
...
function TcxEditRepository.CreateItem(ARepositoryItemClass
  : TcxEditRepositoryItemClass): TcxEditRepositoryItem;
begin
  Result := CreateItemEx(ARepositoryItemClass, Self);
end;

function TcxEditRepository.CreateItemEx(ARepositoryItemClass
  : TcxEditRepositoryItemClass; AOwner: TComponent): TcxEditRepositoryItem;
begin
  Result := ARepositoryItemClass.Create(AOwner);
  Result.Repository := Self;
end;

function TcxEditRepository.ItemByName(const ARepositoryItemName: string)
  : TcxEditRepositoryItem;
var
  I: Integer;
begin
...
function TcxEditButtonViewInfo.GetUpdateRegion(AViewInfo: TcxEditButtonViewInfo)
  : TcxRegion;
var
  AEquals: Boolean;
begin
...
begin
  ...
  if Result then
    cxRedrawWindow(AControl.Handle, cxRectOffset(Bounds, AEditPosition),
      HasBackground);
end;
...
begin
  ...
  else if not Supports(EditViewInfo.Owner, IcxEditOwner, Result) then
    Result := nil;
end;

procedure TcxCustomEditFadingHelper.Invalidate(const R: TRect;
...
begin
  ...
  begin
    CheckStartFading(EditButtonStateToButtonState[State],
...
begin
  EditViewInfo.InternalPrepareEditButtonBackground(ACanvas, ViewInfo,
    AContentRect, ABackgroundRect, APenColor, ABrushColor, False);
end;
...
procedure TcxEditButtonFadingHelper.GetFadingImages(out AFadeOutImage,
...
function TcxEditButtonFadingHelper.PrepareFadingImage
  (AState: TcxEditButtonState): TcxBitmap32;
var
...
begin
  ...
  begin
    ...
    begin
      if HintStr <> '' then
        HintStr := Format('%s (%s)',
          [HintStr, ShortCutToText(TCustomAction(Action).ShortCut)]);
    end;
  end;
end;
...
procedure TcxCustomEditButton.ActionChange(Sender: TObject;
...
constructor TcxCustomEditButtons.Create(AOwner: TPersistent;
...
procedure TcxCustomEditButtons.SetItem(Index: Integer;
  Value: TcxCustomEditButton);
begin
...
begin
  Result := (ErrorType <> eetNone) and (FErrorIcon <> nil) and
    not FErrorIcon.Empty;
end;
...
procedure TcxCustomEditViewInfo.CalculateNativeInfo(out AThemedObjectType
  : TdxThemedObjectType; out ANativePart: Integer);
begin
  AThemedObjectType := totEdit;
  if not IsWinVistaOrLater then
    ANativePart := EP_EDITTEXT
  else if BackgroundPaintingStyle = bpsComboListEdit then
  begin
...
function TcxCustomEditViewInfo.GetUpdateRegion(AViewInfo: TcxContainerViewInfo)
  : TcxRegion;
var
  I: Integer;
  AEquals: Boolean;
...
begin
  ...
  AEquals := (BorderColor = AEditViewInfo.BorderColor) or
    (BorderStyle = ebsNone);
  AEquals := AEquals and (BorderStyle = AEditViewInfo.BorderStyle);
  AEquals := AEquals and
    (Length(ButtonsInfo) = Length(AEditViewInfo.ButtonsInfo));
  ...
  for I := 0 to Length(Self.ButtonsInfo) - 1 do
    Result.Combine(ButtonsInfo[I].GetUpdateRegion(AEditViewInfo.ButtonsInfo
      [I]), roAdd);
end;

function TcxCustomEditViewInfo.CalculateBackgroundColor
  (AStyle: TcxContainerStyle; AEnabled: Boolean;
  AContainer: TcxContainer = nil): TColor;
const
...
begin
  ...
  if UseSkinnedColors and (AEdit <> nil) and not IsStyleValueAssigned(AStyle,
    csvColor) then
    Result := Painter.DefaultEditorBackgroundColorEx
      (AEdit.GetEditStateColorKind)
  else
    Result := clDefault;
  ...
  begin
    if NativeStyle and not(AEnabled or AStyle.IsValueAssigned(csvColor)) then
      Result := cxGetThemeColor(totEdit, NativePartMap[IsWinVistaOrLater],
        NativeState, TMT_FILLCOLOR);
  end;
...
function TcxCustomEditViewInfo.GetCurrentCursor(const AMousePos
  : TPoint): TCursor;
begin
  Result := crDefault;
end;

procedure TcxCustomEditViewInfo.InplaceMouseDown(AButton: TMouseButton;
  const AShift: TShiftState; X, Y: Integer);
begin
end;
...
begin
  ...
  ACanvas.WindowOrg := Point(APrevWindowOrg.X + APos.X,
    APrevWindowOrg.Y + APos.Y);
  try
...
procedure TcxCustomEditViewInfo.DrawCustomEdit(ACanvas: TcxCanvas;
  ACanDrawBackground, ACanDrawValidationMark: Boolean);
begin
...
procedure TcxCustomEditViewInfo.DrawCustomEditValidationMark
  (ACanvas: TcxCanvas);
var
  ASize: TSize;
begin
  ...
  begin
    ...
    cxDrawImage(ACanvas.Handle, cxRectCenter(FErrorBounds, ASize), FErrorBounds,
      ErrorData.ErrorIcon, nil, -1, idmNormal, True);
  end;
end;

procedure TcxCustomEditViewInfo.DrawButton(ACanvas: TcxCanvas;
...
var
  I: Integer;
begin
  if (evsPaintButtons in FState) or
    ((Edit <> nil) and (Edit.IsButtonDC(ACanvas.Handle))) then
    Exit;
...
procedure TcxCustomEditViewInfo.DrawEditBackground(ACanvas: TcxCanvas;
  ARect, AGlyphRect: TRect; AGlyphTransparent: Boolean);
begin
  ACanvas.SaveDC;
  try
...
procedure TcxCustomEditViewInfo.DrawButtonBorderByPainter(AButtonViewInfo
  : TcxEditButtonViewInfo; var ARect: TRect; out AContentRect: TRect;
  var APenColor, ABrushColor: TColor);
const
...
begin
  ...
  if AViewInfo.Data.NativeState <> TC_NONE then
    DrawNativeButtonBorder(ACanvas, AViewInfo, ARect, AContentRect, APenColor,
      ABrushColor)
  else if UseSkins then
    DrawButtonBorderByPainter(AViewInfo, ARect, AContentRect, APenColor,
      ABrushColor)
  else
  begin
    AButtonStyle := AViewInfo.Data.Style;
    if (AViewInfo.Data.State in [ebsPressed, ebsSelected]) and
      (AButtonStyle = btsSimple) then
      AButtonStyle := btsFlat;
    case AButtonStyle of
      bts3D:
        Draw3DButtonBorder(ACanvas, AViewInfo, ARect, AContentRect, APenColor,
          ABrushColor);
      btsFlat:
        DrawFlatButtonBorder(ACanvas, AViewInfo, ARect, AContentRect, APenColor,
          ABrushColor);
      btsSimple:
        DrawSimpleButtonBorder(ACanvas, AViewInfo, ARect, AContentRect,
          APenColor, ABrushColor);
      btsHotFlat:
        DrawHotFlatButtonBorder(ACanvas, AViewInfo, ARect, AContentRect,
          APenColor, ABrushColor);
      btsUltraFlat, btsOffice11:
        DrawUltraFlatButtonBorder(ACanvas, AViewInfo,
          AButtonStyle = btsOffice11, ARect, AContentRect, APenColor,
          ABrushColor);
    end;
  end;
end;
...
procedure TcxCustomEditViewInfo.DrawButtonContent(ACanvas: TcxCanvas;
  ...
  function GetContentPosition(const AContentSize: TSize;
    AOffsetContent: Boolean): TPoint;
  var
  ...
  begin
    ...
    else if not ANeedOffsetContent then
    begin
      Inc(R.Right, AButtonWidth div 2);
  ...
  procedure DrawEllipsisButtonContent;
    ...
    begin
      ...
      ACanvas.FillRect(Rect(X + ASize + 2, Y, X + ASize * 2 + 2,
        Y + ASize), AColor);
      ACanvas.FillRect(Rect(X + ASize * 2 + 4, Y, X + ASize * 3 + 4,
        Y + ASize), AColor);
    end;
  ...
  var
    ...
    ASize: TSize;
  begin
    if IsImageAssigned(AViewInfo.Glyph, AViewInfo.Images, AViewInfo.ImageIndex)
    then
    begin
      ...
      cxDrawImage(ACanvas.Handle, AImageRect, AContentRect, AViewInfo.Glyph,
        AViewInfo.Images, AViewInfo.ImageIndex,
        EnabledImageDrawModeMap[not(AViewInfo.Data.State = ebsDisabled)], False,
        0, clDefault, True, GetButtonColorPalette(AViewInfo.Data.State));
    end;
  end;
  ...
  procedure DrawTextButtonContent;
    ...
    begin
      ...
      ACanvas.DrawText(AViewInfo.Data.Caption, R,
        cxAlignmentsHorz[AViewInfo.Data.ContentAlignment] or cxAlignVCenter or
        cxSingleLine or cxShowPrefix or cxShowEndEllipsis);
    end;
  ...
  begin
    ...
    begin
      if (AViewInfo.Data.Style = btsHotFlat) and
        (AViewInfo.Data.State in [ebsPressed, ebsSelected]) then
        AColor := APenColor
      else if AViewInfo.Data.TextColor = clDefault then
        AColor := TextColor
      else
...
procedure TcxCustomEditViewInfo.DrawNativeStyleEditBackground
  (ACanvas: TcxCanvas; ADrawBackground: Boolean;
      ...
      bpsSolid:
        if IsWinVistaOrLater then
          ...
          GetThemeBackgroundContentRect(ATheme, ACanvas.Handle, ANativePart,
            NativeState, FEditorBounds, Result);
  ...
  procedure DrawBorder(ATheme: TdxTheme; ANativePart: Integer;
    const AContentRect: TRect);
  var
    R: TRect;
  begin
...
begin
  ...
  begin
    CalculateNativeInfo(AThemedObjectType, ANativePart);
    Result := IsThemeBackgroundPartiallyTransparent
      (OpenTheme(AThemedObjectType), ANativePart, NativeState);
  end;
end;
...
function TcxCustomEditViewInfo.IsCustomButton(AButtonVisibleIndex
  : Integer = 0): Boolean;
begin
  Result := DoDrawButton(nil, ButtonsInfo[AButtonVisibleIndex]);
end;

function TcxCustomEditViewInfo.IsCustomButtonBackground(AButtonVisibleIndex
  : Integer = 0): Boolean;
begin
  Result := DoDrawButtonBackground(nil, cxEmptyRect,
    ButtonsInfo[AButtonVisibleIndex]);
end;

function TcxCustomEditViewInfo.IsCustomButtonBorder(AButtonVisibleIndex
  : Integer = 0): Boolean;
var
  ARect: TRect;
begin
  Result := DoDrawButtonBorder(nil, ButtonsInfo[AButtonVisibleIndex],
    ARect, ARect);
end;

function TcxCustomEditViewInfo.IsCustomDrawButton(AButtonVisibleIndex
  : Integer = 0): Boolean;
begin
  Result := IsCustomButtonBorder(AButtonVisibleIndex) or
    IsCustomButtonBackground(AButtonVisibleIndex) or
    IsCustomButton(AButtonVisibleIndex);
end;
...
function TcxCustomEditViewInfo.NeedShowHint(ACanvas: TcxCanvas; const P: TPoint;
  const AVisibleBounds: TRect; out AText: TCaption; out AIsMultiLine: Boolean;
  out ATextRect: TRect; AMaxLineCount: Integer = 0): Boolean;
var
  APart: Integer;
begin
...
function TcxCustomEditViewInfo.Repaint(AControl: TWinControl;
  ...
  begin
    ...
    for I := 0 to Length(ButtonsInfo) - 1 do
      if ButtonsInfo[I].Repaint(AControl, TcxCustomEditViewInfo(AViewInfo)
        .ButtonsInfo[I], AEditPosition) then
        Result := True;
  end;
...
begin
  ...
  begin
    if ((Self.NativeState <> NativeState) or
      ...
      (Self.ContainerState <> ContainerState) and
      Self.IsRepaintOnStateChangingNeeded) or
      (Length(Self.ButtonsInfo) <> Length(ButtonsInfo)) then
      R1 := GetInnerEditRect
    else if (Self.BorderColor <> BorderColor) and (Self.BorderStyle <> ebsNone)
      or (Self.BorderStyle <> BorderStyle) then
    begin
      R1 := Self.BorderRect;
...
function TcxCustomEditViewInfo.GetBackgroundPaintingStyle
  : TcxEditBackgroundPaintingStyle;
begin
  Result := bpsSolid;
end;

function TcxCustomEditViewInfo.GetButtonViewInfoClass
...
begin
  Result := (LastPressedButton <> PressedButton) or
...
begin
  ...
  else if APart = ecpErrorIcon then
...
begin
  if ErrorData.IsError and PtInRect(FErrorBounds, P) then
    Result := ecpErrorIcon
  else if PtInRect(BorderRect, P) then
    Result := ecpControl
  else
    Result := ecpNone;
...
begin
  ...
  if APart = ecpErrorIcon then
    Result := FErrorBounds
  else if APart = ecpControl then
  begin
    Result := BorderRect;
    for I := Low(ButtonsInfo) to High(ButtonsInfo) do
      if (ButtonsInfo[I].Data.LeftAlignment) and (ButtonsInfo[I].Data.Rightmost)
      then
        Result.Left := ButtonsInfo[I].Bounds.Right
      else if not(ButtonsInfo[I].Data.LeftAlignment) and
        (ButtonsInfo[I].Data.Leftmost) then
        Result.Right := ButtonsInfo[I].Bounds.Left;
  end
  else if (APart >= ecpButton) and (APart < Length(ButtonsInfo)) then
...
procedure TcxCustomEditViewInfo.InternalPrepareEditButtonBackground
  (ACanvas: TcxCanvas; AViewInfo: TcxEditButtonViewInfo;
  out AContentRect, ABackgroundRect: TRect; out APenColor, ABrushColor: TColor;
  ACalculateOnly: Boolean);
begin
  ABrushColor := 0;
  APenColor := clBtnText;
  ...
  try
    ...
    DrawButtonBorder(ACanvas, AViewInfo, ABackgroundRect, AContentRect,
      APenColor, ABrushColor);
    if not IsRectEmpty(ABackgroundRect) then
      DrawButtonBackground(ACanvas, AViewInfo, ABackgroundRect, AContentRect,
        ABrushColor);
  finally
    ACanvas.RestoreClipRegion;
  end;
...
procedure TcxCustomEditViewInfo.DrawEditButton(ACanvas: TcxCanvas;
  ...
  begin
    Result := (AViewInfo.Data.State = ebsPressed) and
      ((Edit = nil) or (ecoOffsetButtonContent in Edit.ContentParams.Options));
    // to support the solution in B782
  end;
...
begin
  ...
  if AFadingActive then
    AButtonViewInfo.FadingHelper.DrawImage(ACanvas.Handle,
      AButtonViewInfo.Bounds);
  InternalPrepareEditButtonBackground(ACanvas, AButtonViewInfo, AContentRect,
    ABackgroundRect, APenColor, ABrushColor, AFadingActive);
  if not IsRectEmpty(AContentRect) then
    DrawButtonContent(ACanvas, AButtonViewInfo, AContentRect, APenColor,
      ABrushColor, NeedOffsetContent(AButtonViewInfo));
end;

procedure TcxCustomEditViewInfo.SetOnDrawBackground
  (AValue: TcxEditDrawBackgroundEvent);
begin
...
procedure TcxCustomEditViewInfo.Draw3DButtonBorder(ACanvas: TcxCanvas;
  AButtonViewInfo: TcxEditButtonViewInfo; var ARect: TRect;
  out AContentRect: TRect; var APenColor, ABrushColor: TColor);
begin
  APenColor := clBtnText;
...
procedure TcxCustomEditViewInfo.DrawFlatButtonBorder(ACanvas: TcxCanvas;
  AButtonViewInfo: TcxEditButtonViewInfo; var ARect: TRect;
  out AContentRect: TRect; var APenColor, ABrushColor: TColor);
begin
...
procedure TcxCustomEditViewInfo.DrawHotFlatButtonBorder(ACanvas: TcxCanvas;
  AButtonViewInfo: TcxEditButtonViewInfo; var ARect: TRect;
  out AContentRect: TRect; var APenColor, ABrushColor: TColor);
const
  ABrushColorA: array [TcxEditButtonState] of TColor = (clBtnFace, clBtnFace,
    clBtnText, clBtnShadow);
begin
  ...
  begin
    ...
    if (Data.LeftAlignment and Data.Rightmost) or
      (not Data.LeftAlignment and Data.Leftmost) then
      FrameRectEx(ACanvas, ARect, APenColor)
    else if Data.LeftAlignment then
    begin
      cxEditUtils.DrawButtonBorder(ACanvas, ARect, [bBottom, bLeft, bTop],
        APenColor);
      cxEditUtils.DrawButtonBorder(ACanvas, ARect, [bRight], ABrushColor);
    end
    else
    begin
      cxEditUtils.DrawButtonBorder(ACanvas, ARect, [bTop, bRight, bBottom],
        APenColor);
      cxEditUtils.DrawButtonBorder(ACanvas, ARect, [bLeft], ABrushColor);
    end;
...
procedure TcxCustomEditViewInfo.DrawNativeButtonBorder(ACanvas: TcxCanvas;
  AButtonViewInfo: TcxEditButtonViewInfo; var ARect: TRect;
  out AContentRect: TRect; var APenColor, ABrushColor: TColor);

  function GetThemeContentRect(AThemeObject: TdxThemedObjectType;
    APart: Integer): TRect;
  var
    ATheme: TdxTheme;
  begin
  ...
  begin
    if IsCustomDrawButton then
      Result := ARect
    else if AButtonViewInfo.Data.ComboBoxStyle then
      Result := cxEmptyRect
    else
...
procedure TcxCustomEditViewInfo.DrawSimpleButtonBorder(ACanvas: TcxCanvas;
  AButtonViewInfo: TcxEditButtonViewInfo; var ARect: TRect;
  out AContentRect: TRect; var APenColor, ABrushColor: TColor);
begin
  if not Transparent then
...
procedure TcxCustomEditViewInfo.DrawUltraFlatButtonBorder(ACanvas: TcxCanvas;
  AButtonViewInfo: TcxEditButtonViewInfo; AIsOffice11Style: Boolean;
  var ARect: TRect; var AContentRect: TRect;
  out APenColor, ABrushColor: TColor);
var
...
begin
  if AButtonViewInfo.Data.Transparent then
    ABrushColor := AButtonViewInfo.Data.BackgroundColor
  else if AButtonViewInfo.Data.State = ebsDisabled then
    ABrushColor := clBtnFace
  else if AButtonViewInfo.Data.State = ebsNormal then
  ...
  if (AButtonViewInfo.Data.State in [ebsDisabled, ebsNormal]) or
    ...
    AButtonViewInfo.Data.IsInplace and not(epoHasExternalBorder in PaintOptions)
  then
  begin
...
procedure TcxCustomEditViewInfo.DrawLookAndFeelButtonBackground
  (ACanvas: TcxCanvas; AButtonViewInfo: TcxEditButtonViewInfo;
  const ARect: TRect);
begin
  Painter.DrawScaledEditorButton(ACanvas, ARect, EditBtnKindToEditBtnPainterKind
    [AButtonViewInfo.Data.Kind], EditBtnStateToButtonState
    [AButtonViewInfo.Data.State], AButtonViewInfo.ScaleFactor,
    EditBtnPositionMap[AButtonViewInfo.Data.LeftAlignment]);
end;

procedure TcxCustomEditViewInfo.DrawNativeButtonBackground(ACanvas: TcxCanvas;
  AButtonViewInfo: TcxEditButtonViewInfo; const ARect: TRect);
var
  APart: Integer;
...
begin
  ...
  dxDrawThemeBackground(ACanvas.Handle, AThemeObject, ScaleFactor, ARect, APart,
    AButtonViewInfo.Data.NativeState);
end;

procedure TcxCustomEditViewInfo.DrawUsualButtonBackground(ACanvas: TcxCanvas;
  AButtonViewInfo: TcxEditButtonViewInfo; const ARect: TRect;
  ABrushColor: TColor);
...
function TcxCustomEditViewInfo.DoDrawButtonBorder(ACanvas: TcxCanvas;
  AViewInfo: TcxEditButtonViewInfo; var ABackgroundRect,
  AContentRect: TRect): Boolean;
begin
  Result := False;
  if Assigned(FOnDrawButtonBorder) then
    FOnDrawButtonBorder(AViewInfo, ACanvas, ABackgroundRect,
      AContentRect, Result);
end;

function TcxCustomEditViewInfo.DoPrepareButtonFadingImage
  (ASender: TcxEditButtonViewInfo; AState: TcxEditButtonState;
  out AImage: TcxBitmap32): Boolean;
begin
  Result := False;
...
begin
  ...
  begin
    ...
    else if IsNativeBackground then
...
function TcxCustomEditViewInfo.GetButtonColorPalette(AState: TcxEditButtonState)
  : IdxColorPalette;
begin
  if Painter <> nil then
...
procedure TcxCustomEditViewData.Calculate(ACanvas: TcxCanvas;
  ...
  begin
    AViewInfo.ContainerState := GetContainerState(ABounds, P, Button, Shift,
      AIsMouseEvent);
  ...
  const
    ADefaultPopupBorderStyleMap: array [TcxEditBorderStyle]
      of TcxEditPopupBorderStyle = (epbsFlat, epbsSingle, epbsSingle, epbsFlat,
      epbsSingle, epbsSingle, epbsSingle);
    AInplaceDefaultPopupBorderStyleMap: array [TcxLookAndFeelKind]
      of TcxEditPopupBorderStyle = (epbsFlat, epbsFrame3D, epbsSingle,
      epbsSingle);
  begin
    AViewInfo.PopupBorderStyle := Style.PopupBorderStyle;
    if (AViewInfo.PopupBorderStyle = epbsDefault) and (Edit <> nil) then
      if IsInplace then
        AViewInfo.PopupBorderStyle := AInplaceDefaultPopupBorderStyleMap
          [Style.LookAndFeel.Kind]
      else if (AViewInfo.BorderStyle = ebsNone) and
        (Length(AViewInfo.ButtonsInfo) > 0) then
        AViewInfo.PopupBorderStyle := AInplaceDefaultPopupBorderStyleMap
          [Edit.Style.LookAndFeel.Kind]
      else
        AViewInfo.PopupBorderStyle := ADefaultPopupBorderStyleMap
          [AViewInfo.BorderStyle];
  end;
...
begin
  ...
  APrevBorderWidth := GetContainerBorderWidth
    (TcxContainerBorderStyle(AViewInfo.BorderStyle));
  CalculateContainerState;
  if not IsInplace and not NativeStyle and
    (GetContainerBorderWidth(TcxContainerBorderStyle(AViewInfo.BorderStyle)) <
    APrevBorderWidth) then
    CalculateContainerState;
  TcxContainerViewInfo(AViewInfo).BorderStyle :=
    TcxContainerBorderStyle(AViewInfo.BorderStyle);
  ...
  if IsInplace then
    ButtonsOnlyStyle := (ABounds.Right <> cxMaxRectSize) and
      (Properties.ButtonsViewStyle <> bvsNormal)
  else
  ...
  AViewInfo.IsDBEditPaintCopyDrawing := (Edit <> nil) and
    Edit.IsDBEditPaintCopyDrawing;
  AViewInfo.IsContainerInnerControl := (Edit <> nil) and
    Supports(TObject(Edit), IcxContainerInnerControl);
  ...
  CalculateButtonsViewInfo(ACanvas, AViewInfo.FEditorBounds, P, Button, Shift,
...
begin
  ...
  begin
    ...
    begin
      ...
      AButtonWidth := CalculateEditDefaultButtonWidth(ACanvas,
        AViewInfo.ButtonsInfo[AButtonVisibleIndex]);
...
procedure TcxCustomEditViewData.CalculateButtonsViewInfo(ACanvas: TcxCanvas;
  ...
  begin
    ...
    begin
      ...
      if not Enabled or not Properties.Buttons[AButtonViewInfo.ButtonIndex].Enabled
      then
        AButtonViewInfo.Data.State := ebsDisabled
      else if AIsButtonPressed or
        (not IsDesigning and PtInRect(AButtonViewInfo.VisibleBounds, P)) then
      begin
        ACapturePressing := (Button = cxmbNone) and (ssLeft in Shift) and
          (AButtonViewInfo.Data.State = ebsNormal) and
          (GetCaptureButtonVisibleIndex = AButtonVisibleIndex);
        AMouseButtonPressing := (Button = cxmbLeft) and
          cxShiftStateLeftOnly(Shift, True);
        AHoldPressing := (AButtonViewInfo.Data.State = ebsPressed) and
          (ssLeft in Shift);
        if AIsButtonPressed or AMouseButtonPressing or AHoldPressing or ACapturePressing
        then
          AViewInfo.IsButtonReallyPressed := True;
        if not AIsButtonPressed and cxShiftStateMoveOnly(Shift) and not ACapturePressing
        then
        begin
          AButtonViewInfo.Data.State := ebsSelected;
          AViewInfo.SelectedButton := AButtonVisibleIndex;
        end
        else if (AIsButtonPressed or ACapturePressing and
          CanPressButton(AViewInfo, AButtonVisibleIndex) or
          cxShiftStateLeftOnly(Shift, True) and ((Button = cxmbLeft) and
          CanPressButton(AViewInfo, AButtonVisibleIndex) or
  ...
  begin
    ...
    if (FLeftSideRightmostButtonIndex <> -1) and
      (not ButtonsOnlyStyle or (FRightSideLeftmostButtonIndex = -1)) then
      AViewInfo.ButtonsInfo[FLeftSideRightmostButtonIndex]
        .Data.Rightmost := True;
    if (FRightSideLeftmostButtonIndex <> -1) and
      (not ButtonsOnlyStyle or (FLeftSideRightmostButtonIndex = -1)) then
      AViewInfo.ButtonsInfo[FRightSideLeftmostButtonIndex]
        .Data.Leftmost := True;
    if FRightSideRightmostButtonIndex <> -1 then
      AViewInfo.ButtonsInfo[FRightSideRightmostButtonIndex]
        .Data.Rightmost := True;
...
begin
  ...
  if not(csActive in ContainerState) then
    if (Style.ButtonTransparency = ebtHideInactive) or
      (not(csHotTrack in ContainerState) and
      (Style.ButtonTransparency = ebtHideUnselected)) then
    begin
  ...
  if IsInplace or not(AViewInfo.NativeStyle and AViewInfo.ButtonsInfo[0]
    .Data.ComboBoxStyle and IsWinVistaOrLater) then
    AButtonsRect := cxRectContent(ABounds, GetButtonsExtent(ACanvas))
  else
...
begin
  ...
  begin
    ...
    begin
      ...
      CalculateButtonViewInfo(ACanvas, AViewInfo, AButtonVisibleIndex,
        AButtonsRect);
...
procedure TcxCustomEditViewData.CalculateEx(ACanvas: TcxCanvas;
  const ABounds: TRect; const P: TPoint; Button: TcxMouseButton;
  Shift: TShiftState; AViewInfo: TcxCustomEditViewInfo; AIsMouseEvent: Boolean);
var
  ANewBounds: TRect;
...
begin
  ...
  Calculate(ACanvas, ANewBounds, ANewP, Button, Shift, AViewInfo,
    AIsMouseEvent);
end;
...
var
  ...
  procedure FindStretchableButtons(out AStretchableButtonCount,
    AStretchableButtonsTotalWidth: Integer;
    out AAllButtonsAreStretchable: Boolean);
  var
    I: Integer;
  begin
  ...
  begin
    ...
    begin
      for J := 0 to High(AViewInfo.ButtonsInfo) do
        with AViewInfo.ButtonsInfo[J] do
          if Data.LeftAlignment and (Bounds.Left >= AButtonViewInfo.Bounds.Right)
          then
          begin
    ...
    begin
      for J := 0 to High(AViewInfo.ButtonsInfo) do
        with AViewInfo.ButtonsInfo[J] do
          if not Data.LeftAlignment and
            (Bounds.Right <= AButtonViewInfo.Bounds.Left) then
          begin
...
begin
  ...
  begin
    ...
    if not AAllButtonsAreStretchable and
      (not AButtonViewInfo.Stretchable or IgnoreButtonWhileStretching(I)) then
      Continue;
    ...
    begin
      if AStretchableButtonsTotalWidth < 1 then
        ...
        with AButtonViewInfo.Bounds do
          AButtonWidthCorrection := AButtonsWidth * (Right - Left)
            div AStretchableButtonsTotalWidth;
...
procedure TcxCustomEditViewData.EditValueToDrawValue(const AEditValue
  : TcxEditValue; AViewInfo: TcxCustomEditViewInfo);
begin
end;

procedure TcxCustomEditViewData.InitializeButtonInfo
  (AViewInfo: TcxCustomEditViewInfo; AButtonVisibleIndex: Integer);
...
begin
  ...
  begin
    ...
    else if AStyle.TransparentBorder then
      Result := cxContainerDefaultBorderExtent
    else if not AStyle.HasBorder or ANativeStyle and
      (AStyle.BaseStyle.BorderStyle = ebsNone) or (Edit <> nil) and Edit.Transparent
    then
      Result := cxEmptyRect
    else if ANativeStyle then
      Result := cxContainerDefaultBorderExtent
    else
      Result := GetBorderExtentByEdges
        (GetContainerBorderWidth(TcxContainerBorderStyle(GetBorderStyle)));
...
function TcxCustomEditViewData.GetBorderExtentByEdges
  (ABorderWidth: Integer): TRect;
begin
  Result := cxEmptyRect;
...
function TcxCustomEditViewData.GetButtonNativeTheme(AButtonViewInfo
  : TcxEditButtonViewInfo): TdxTheme;
begin
  if AButtonViewInfo.Data.ComboBoxStyle then
...
begin
  if IsInplace then
    Result := ContentOffset
  else if NativeStyle then
  begin
    if not Style.TransparentBorder and (Style.BaseStyle.BorderStyle = ebsNone)
    then
      Result := cxEmptyRect
    else if Style.BaseStyle.BorderStyle = ebsNone then
      Result := cxContainerDefaultBorderExtent
    else
    begin
      R := Rect(0, 0, 100, 100);
      GetThemeBackgroundContentRect(OpenTheme(totEdit, ScaleFactor),
        ACanvas.Handle, EP_EDITTEXT, ETS_NORMAL, R, CR);
      Result := CR;
...
begin
  Result := GetBorderExtent;
  if (Properties.ButtonsViewStyle <> bvsNormal) and
    (Length(AViewInfo.ButtonsInfo) > 0) then
  ...
  begin
    AButtonViewInfo := AViewInfo.ButtonsInfo[I];
    if AButtonViewInfo.Data.LeftAlignment then
      Result.Left := Max(Result.Left, AButtonViewInfo.Bounds.Right -
        AViewInfo.FEditorBounds.Left)
    else
      Result.Right := Max(Result.Right, AViewInfo.FEditorBounds.Right -
        AButtonViewInfo.Bounds.Left);
  end;
end;
...
begin
  ...
  try
    if AViewInfo = nil then
      Calculate(ACanvas, Rect(0, 0, cxMaxRectSize, cxMaxRectSize),
        cxInvalidPoint, cxmbNone, [], ATempViewInfo, False);
...
function TcxCustomEditViewData.GetEditContentSize(ACanvas: TcxCanvas;
  const AEditValue: TcxEditValue;
  const AEditSizeProperties: TcxEditSizeProperties;
...
begin
  ...
  begin
    Result.cx := 0;
    Result.cy := TdxTextMeasurer.TextLineHeight(Style.GetVisibleFont) +
      Self.GetEditContentSizeCorrection.cy;
  end
  else
    Result := InternalGetEditContentSize(ACanvas, AEditValue,
      AEditSizeProperties);
...
function TcxCustomEditViewData.GetEditSize(ACanvas: TcxCanvas;
  ...
  AViewInfo: TcxCustomEditViewInfo = nil): TSize;
begin
  Result := InternalGetEditSize(ACanvas, AEditValue, AEditSizeProperties,
    AViewInfo, False);
end;
...
begin
  Result := Style.HasBorder and ((Style.BorderStyle <> ebsNone) or
...
function TcxCustomEditViewData.IgnoreButtonWhileStretching(AButtonVisibleIndex
  : Integer): Boolean;
begin
  Result := False;
end;

function TcxCustomEditViewData.IsButtonLeftAligned
  (AViewInfo: TcxCustomEditViewInfo; AButtonVisibleIndex: Integer): Boolean;
begin
  Result := Properties.Buttons[AViewInfo.ButtonsInfo[AButtonVisibleIndex]
    .ButtonIndex].LeftAlignment xor UseRightToLeftAlignment;
end;

class function TcxCustomEditViewData.IsNativeStyle(ALookAndFeel
  : TcxLookAndFeel): Boolean;
begin
  Result := AreVisualStylesMustBeUsed(ALookAndFeel.NativeStyle, totEdit);
end;

procedure TcxCustomEditViewData.CalculateButtonNativeInfo(AButtonViewInfo
  : TcxEditButtonViewInfo);
var
  ATheme: TdxTheme;
begin
  ...
  AButtonViewInfo.Data.BackgroundPartiallyTransparent :=
    AButtonViewInfo.Data.UseSkins or
    (AButtonViewInfo.Data.NativePart <> TC_NONE) and
    IsThemeBackgroundPartiallyTransparent(ATheme,
    AButtonViewInfo.Data.NativePart, AButtonViewInfo.Data.NativeState);
end;

procedure TcxCustomEditViewData.CalculateButtonNativePartInfo(ATheme: TdxTheme;
  AButtonViewInfo: TcxEditButtonViewInfo);
const
  AlignmentMap: array [Boolean] of Integer = (CP_DROPDOWNBUTTONRIGHT,
...
begin
  ...
  else if not AButtonViewInfo.Data.ComboBoxStyle then
    AButtonViewInfo.Data.NativePart := BP_PUSHBUTTON
  else if IsWinVistaOrLater and not IsInplace then
    AButtonViewInfo.Data.NativePart := AlignmentMap
      [AButtonViewInfo.Data.LeftAlignment]
  else
...
procedure TcxCustomEditViewData.CalculateViewInfo
  (AViewInfo: TcxCustomEditViewInfo; AIsMouseEvent: Boolean);
begin
  ...
  begin
    ...
    case FValidationErrorIconAlignment of
      taLeftJustify:
        begin
          AViewInfo.FErrorBounds.Right := AViewInfo.FErrorBounds.Left +
            GetErrorIconWidth(AViewInfo.ErrorData);
          AViewInfo.FEditorBounds.Left := AViewInfo.FErrorBounds.Right;
        end;
      taRightJustify:
        begin
          AViewInfo.FErrorBounds.Left := AViewInfo.FErrorBounds.Right -
            GetErrorIconWidth(AViewInfo.ErrorData);
  ...
  AViewInfo.BorderRect := cxRectContent(AViewInfo.FEditorBounds,
    AViewInfo.BorderExtent);
  AViewInfo.ShadowRect := AViewInfo.BorderRect;
  AViewInfo.HasContentOffsets := not cxRectIsEqual(ContentOffset, cxNullRect);

  if not IsInplace then
    AViewInfo.BorderColor := AViewInfo.CalculateBorderColor(Style, Enabled,
      IsDesigning, Edit);
  AViewInfo.BackgroundColor := AViewInfo.CalculateBackgroundColor(Style,
    Enabled, Edit);
...
procedure TcxCustomEditViewData.CheckStartButtonsFading
...
procedure TcxCustomEditViewData.DoRightToLeftConversion
  (AViewInfo: TcxCustomEditViewInfo; const ABounds: TRect);
begin
end;
...
procedure TcxCustomEditViewData.CorrectBorderStyle(var ABorderStyle
  : TcxEditBorderStyle);
begin
...
function TcxCustomEditViewData.GetErrorIconWidth
  (AErrorData: TcxEditValidateInfo): Integer;
begin
  if NeedShowErrorIcon(AErrorData) then
    Result := dxGetImageSize(AErrorData.ErrorIcon, ScaleFactor).cx +
      ScaleFactor.Apply(3)
  else
    Result := 0;
end;
  ...
  if Enabled then
    ...
    begin
      ...
      if PtInRect(GetEditVisibleBounds, P) and
        (cxShiftStateMoveOnly(Shift) or (Edit <> nil) and
        (GetCaptureControl = Edit)) then
...
begin
  ...
  AParams.SizeCorrection.cx := Max(EditContentDefaultOffsets[False].Left,
    EditContentMaxTotalDefaultHorzOffset - (AParams.Offsets.Left +
    AParams.Offsets.Right));
  if not NativeStyle then
    AParams.SizeCorrection.cy := 0
  else
    AParams.SizeCorrection.cy := GetNativeInnerTextEditContentHeightCorrection
      (Properties, IsInplace);
  AParams.ExternalBorderBounds := cxEmptyRect;
  AParams.Options := [ecoOffsetButtonContent];
end;

function TcxCustomEditViewData.GetEditNativeState
...
function TcxCustomEditViewData.InternalGetEditConstantPartSize
...
begin
  ...
  begin
    Result.cx := cxRectWidth(AViewInfo.Bounds) -
      cxRectWidth(AViewInfo.ClientRect);
    Result.cy := cxRectHeight(AViewInfo.Bounds) -
      cxRectHeight(AViewInfo.ClientRect);
  end;
  ...
  begin
    ...
    if not AButton.Visible then
      Continue;
    if (AButton.Kind = bkGlyph) and IsImageAssigned(AButton.Glyph,
      Properties.Images, AButton.ImageIndex) then
    begin
      AMaxButtonContentHeight := Max(AMaxButtonContentHeight,
        dxGetImageSize(AButton.Glyph, Properties.Images, AButton.ImageIndex,
        ScaleFactor).cy);
    end;
    if IsInplace and (AButton.Kind = bkText) and
      (Length(AButton.VisibleCaption) > 0) then
      AMaxButtonContentHeight := Max(AMaxButtonContentHeight,
  ...
  if IsInplace then
  begin
    Inc(Result.cx, TdxVisualRefinements.Padding.ScaledWidth(ScaleFactor));
    Inc(Result.cy, TdxVisualRefinements.Padding.ScaledHeight(ScaleFactor));
  end;
end;
...
begin
  ...
  if AIsEditing and (esoEditingAutoHeight in Properties.GetSupportedOperations)
  then
    AContentSize := GetEditingContentSize(ACanvas, AEditValue,
      AEditSizeProperties)
  else
    AContentSize := GetEditContentSize(ACanvas, AEditValue,
      AEditSizeProperties);
...
function TcxCustomEditViewData.NeedShowErrorIcon
  (AErrorData: TcxEditValidateInfo): Boolean;
begin
  Result := AErrorData.HasErrorIcon and
    (evoShowErrorIcon in Properties.ValidationOptions);
end;
...
function TcxCustomEditViewData.DoGetDefaultButtonWidth(AIndex: Integer)
  : Integer;
begin
  Result := 0;
...
begin
  Result := MaxValue and
    (Properties.MaxValue =
    0 { TcxCustomEditProperties(Properties).GetDefaultMaxValue } ) and
...
begin
  Result := MinValue and
    (Properties.MinValue =
    0 { TcxCustomEditProperties(Properties).GetDefaultMinValue } ) and
...
function TcxDefaultEditStyleController.GetEmulateStandardControlDrawing
  : Boolean;
begin
...
begin
  Result := IsEditing and not(FEditHiding or FInitiatingEditing or
    FEdit.IsPosting or FEdit.IsEditValidating);
end;
...
procedure TcxCustomEditingController.StartEditAutoHeight(AHeightChanged
  : Boolean);
begin
end;
...
function TcxCustomEditingController.GetChangeEventsCatcher
  : TcxEditChangeEventsCatcher;
begin
...
procedure TcxCustomEditingController.ImmediateEventHandler(ADataController
...
begin
  Result := IsEditing and Edit.HandleAllocated and
    (Edit.Left = cxInvisibleCoordinate);
end;
...
function TcxCustomEditingController.
...
begin
  if Assigned(Edit) and Edit.IsPosting and
    (ChangeEventsCatcher.IsLocked and IsNeedInvokeEditChangedEventsBeforePost)
  then
...
begin
  Result := IsEditing and FEdit.Visible and
    (FEdit.Left <> cxInvisibleCoordinate) and not IsHiddenOnScrolling;
end;
...
procedure TcxCustomEditingController.SetImmediatePostEventHandler
  (ASet: Boolean);
var
...
procedure TcxCustomEditingController.EditAfterKeyDown(Sender: TObject;
...
procedure TcxCustomEditingController.EditEditing(Sender: TObject;
  var CanEdit: Boolean);
begin
...
procedure TcxCustomEditingController.EditKeyPress(Sender: TObject;
  var Key: Char);
begin
end;
...
function TcxCustomEditingController.IMEComposition(var AMessage
  : TMessage): Boolean;
var
...
procedure TcxCustomEditingController.RemoveEdit(AProperties
  : TcxCustomEditProperties);
begin
...
function TcxEditStyleController.GetInternalStyle(AState: TcxContainerStateItem)
  : TcxCustomEditStyle;
begin
...
begin
  ...
  begin
    ...
    if Result then
      StyleValueName := cxEditStyleValueNameA
        [AStyleValue - cxContainerStyleValueCount];
  end;
end;
...
function TcxCustomEditStyle.InternalGetNotPublishedExtendedStyleValues
  : TcxEditStyleValues;
begin
...
function TcxCustomEditStyle.DefaultButtonTransparency
...
begin
  Result := (ParentStyle <> nil) and TcxCustomEditStyle(ParentStyle)
    .GradientButtons;
end;
...
begin
  ...
  else if not InternalGetButtonStyle(Result) then
    Result := DefaultButtonStyle;
end;
...
begin
  ...
  else if not InternalGetButtonTransparency(Result) then
    Result := DefaultButtonTransparency;
end;
...
begin
  ...
  else if not InternalGetGradient(Result) then
    Result := DefaultGradient;
end;
...
begin
  ...
  else if not InternalGetGradientButtons(Result) then
    Result := DefaultGradientButtons;
end;
...
begin
  ...
  else if not InternalGetGradientDirection(Result) then
    Result := DefaultGradientDirection;
end;
...
begin
  ...
  else if not InternalGetPopupBorderStyle(Result) then
    Result := DefaultPopupBorderStyle;
end;
...
function TcxCustomEditStyle.InternalGetButtonStyle(var ButtonStyle
  : TcxEditButtonStyle): Boolean;
begin
  Result := svButtonStyle in FAssignedValues;
  if Result then
    ButtonStyle := FButtonStyle
  else if ActiveStyleController <> nil then
    Result := ActiveStyleController.Styles[TcxContainerStateItem(State)
      ].InternalGetButtonStyle(ButtonStyle);
end;

function TcxCustomEditStyle.InternalGetButtonTransparency(var ButtonTransparency
  : TcxEditButtonTransparency): Boolean;
begin
  ...
  if Result then
    ...
    Result := ActiveStyleController.Styles[TcxContainerStateItem(State)
      ].InternalGetButtonTransparency(ButtonTransparency);
end;
...
begin
  ...
  if Result then
    ...
    Result := ActiveStyleController.Styles[TcxContainerStateItem(State)
      ].InternalGetGradient(Gradient);
end;

function TcxCustomEditStyle.InternalGetGradientButtons(var GradientButtons
  : Boolean): Boolean;
begin
  ...
  if Result then
    ...
    Result := ActiveStyleController.Styles[TcxContainerStateItem(State)
      ].InternalGetGradientButtons(GradientButtons);
end;

function TcxCustomEditStyle.InternalGetGradientDirection(var GradientDirection
  : TcxEditGradientDirection): Boolean;
begin
  ...
  if Result then
    ...
    Result := ActiveStyleController.Styles[TcxContainerStateItem(State)
      ].InternalGetGradientDirection(GradientDirection);
end;
...
begin
  ...
  if Result then
    ...
    Result := ActiveStyleController.Styles[TcxContainerStateItem(State)
      ].InternalGetPopupBorderStyle(PopupBorderStyle);
end;

function TcxCustomEditStyle.IsBorderStyleStored: Boolean;
begin
  Result := (svBorderStyle in FAssignedValues) and
    ((Edit = nil) or Edit.IsStylePropertyPublished('BorderStyle',
    State <> csNormal));
end;

function TcxCustomEditStyle.IsButtonStyleStored: Boolean;
begin
  Result := (svButtonStyle in FAssignedValues) and
    ((Edit = nil) or Edit.IsStylePropertyPublished('ButtonStyle',
    State <> csNormal));
end;

function TcxCustomEditStyle.IsButtonTransparencyStored: Boolean;
begin
  Result := (svButtonTransparency in FAssignedValues) and
    ((Edit = nil) or Edit.IsStylePropertyPublished('ButtonTransparency',
    State <> csNormal));
end;

function TcxCustomEditStyle.IsGradientStored: Boolean;
begin
  Result := (svGradient in FAssignedValues) and
    ((Edit = nil) or Edit.IsStylePropertyPublished('Gradient',
    State <> csNormal));
end;

function TcxCustomEditStyle.IsGradientButtonsStored: Boolean;
begin
  Result := (svGradientButtons in FAssignedValues) and
    ((Edit = nil) or Edit.IsStylePropertyPublished('GradientButtons',
    State <> csNormal));
end;

function TcxCustomEditStyle.IsGradientDirectionStored: Boolean;
begin
  Result := (svGradientDirection in FAssignedValues) and
    ((Edit = nil) or Edit.IsStylePropertyPublished('GradientDirection',
    State <> csNormal));
end;

function TcxCustomEditStyle.IsPopupBorderStyleStored: Boolean;
begin
  Result := (svPopupBorderStyle in FAssignedValues) and
    ((Edit = nil) or Edit.IsStylePropertyPublished('PopupBorderStyle',
    State <> csNormal));
end;
...
procedure TcxCustomEditStyle.SetButtonTransparency
  (Value: TcxEditButtonTransparency);
begin
  if ParentStyle = nil then
  begin
    if (svButtonTransparency in FAssignedValues) and
      (Value = FButtonTransparency) then
      Exit;
...
begin
  if ParentStyle = nil then
  begin
    if (svGradientButtons in FAssignedValues) and (Value = FGradientButtons)
    then
      Exit;
...
procedure TcxCustomEditStyle.SetGradientDirection
  (Value: TcxEditGradientDirection);
begin
  if ParentStyle = nil then
  begin
    if (svGradientDirection in FAssignedValues) and (Value = FGradientDirection)
    then
      Exit;
...
procedure TcxCustomEditStyle.SetPopupBorderStyle
  (Value: TcxEditPopupBorderStyle);
begin
  if ParentStyle = nil then
  begin
    if (svPopupBorderStyle in FAssignedValues) and (Value = FPopupBorderStyle)
    then
      Exit;
...
function TcxInplaceEditList.FindEdit(AProperties: TcxCustomEditProperties)
  : TcxCustomEdit;
begin
  Result := GetEdit(FindItem(AProperties, True));
end;

function TcxInplaceEditList.FindEdit(APropertiesClass
  : TcxCustomEditPropertiesClass): TcxCustomEdit;
begin
  Result := GetEdit(FindItem(APropertiesClass));
end;

function TcxInplaceEditList.GetEdit(AProperties: TcxCustomEditProperties)
  : TcxCustomEdit;
begin
...
function TcxInplaceEditList.GetEdit(APropertiesClass
  : TcxCustomEditPropertiesClass): TcxCustomEdit;
begin
...
procedure TcxInplaceEditList.RemoveItem(APropertiesClass
  : TcxCustomEditPropertiesClass);
var
  AItemIndex: Integer;
begin
...
function TcxInplaceEditList.CreateEdit(APropertiesClass
  : TcxCustomEditPropertiesClass): TcxCustomEdit;
begin
  Result := TcxCustomEditClass(APropertiesClass.GetContainerClass)
    .Create(EditorOwner, True);
...
function TcxInplaceEditList.FindItem(APropertiesClass
  : TcxCustomEditPropertiesClass): Integer;
var
...
begin
  ...
  begin
    AItem := FItems[I];
    if (AItem.Properties = nil) and
      (AItem.Edit.ClassType = APropertiesClass.GetContainerClass) then
      Exit(I);
  end;
  Result := -1;
end;
...
begin
  ...
  begin
    ...
    if AIndex < Count - 1 then
      Move(FItems[AIndex + 1], FItems[AIndex], SizeOf(TcxEditListItem) *
        (Count - AIndex - 1));
...
procedure TcxCustomEdit.ActivateByKey(Key: Char;
...
begin
  ...
  begin
    ...
    if (GetCaptureControl = Self) and not(ssLeft in KeyboardStateToShiftState)
    then
...
function TcxCustomEdit.InternalValidateEdit(AValidationOptions
  : TcxEditValidationOptions; AForceValidation: Boolean): Boolean;
  ...
  begin
    Result := (VarType(AValue1) = VarType(AValue2)) and
      VarEquals(AValue1, AValue2);
  end;
...
begin
  DisableUserAction;
  try
    if not(FModifiedAfterEnter and not FIsEditValidated and (FLockValidate = 0))
      and not AForceValidation then
    begin
    ...
    try
      ...
      DoValidateDisplayValue(ADisplayValue, FValidationErrorText,
        FValidationError);
      ...
      if FValidationError then
        try
          HandleValidationError(FValidationErrorText, AValidationOptions,
            not AForceValidation);
        finally
      ...
      begin
        if (FModifiedAfterEnter or not ValueEquals(ADisplayValue,
          GetValueToValidate)) and not(IsUserAction and not DoEditing) then
        begin
...
begin
  Result := InternalValidateEdit(ActiveProperties.ValidationOptions,
    AForceValidation);
end;
...
procedure TcxCustomEdit.FadingGetBackgroundImages(out AFadeOutImage,
  AFadeInImage: TcxBitmap);
  ...
  begin
    ...
    try
      ...
      CalculateViewInfo(AViewInfo, GetHitPoint(AHotTracked), cxmbNone,
        [], True);
      AViewInfo.BackgroundColor := TdxFadingHelper.CheckColor
        (AViewInfo.BackgroundColor);
      AViewInfo.BorderColor := TdxFadingHelper.CheckColor
        (AViewInfo.BorderColor);
...
begin
  if (M <> D) and (not(csLoading in ComponentState) or
    (FAnchorScalingFlags <> [])) then
  begin
...
procedure TcxCustomEdit.DefineProperties(Filer: TFiler);
  ...
  begin
    Result := (Filer.Ancestor = nil) or
      (TcxCustomEdit(Filer.Ancestor).Height <> Height);
  end;

  function HasWidth: Boolean;
  begin
    Result := (Filer.Ancestor = nil) or
      (TcxCustomEdit(Filer.Ancestor).Width <> Width);
  end;

begin
  inherited DefineProperties(Filer);
  Filer.DefineProperty('Height', ReadHeight, WriteHeight, NeedStoreHeight and
    HasHeight);
  Filer.DefineProperty('Width', ReadWidth, WriteWidth, NeedStoreWidth and
    HasWidth);
...
function TcxCustomEdit.DoMouseWheel(Shift: TShiftState; WheelDelta: Integer;
...
function TcxCustomEdit.DoInnerControlDefaultHandler
...
function TcxCustomEdit.InternalGetNotPublishedStyleValues: TcxEditStyleValues;
begin
...
procedure TcxCustomEdit.MouseDown(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
const
  AMouseMessages: array [TMouseButton] of UINT = (WM_LBUTTONDOWN,
...
procedure TcxCustomEdit.DoSetSize;
  ...
  procedure CalculateLeftTop(var ALeft, ATop: Integer;
    ANewWidth, ANewHeight: Integer);
  begin
    ALeft := Left;
    ATop := Top;
    if not IsScaleChanging and UseAnchors and IsAutoWidth and not IsHeightDependOnWidth
    then
    begin
      ...
      begin
        if ActiveProperties.Alignment.Horz = taCenter then
          ALeft := AnchorX - ANewWidth div 2 -
            Integer((ANewWidth div 2) <> (ANewWidth / 2))
        else
      ...
      begin
        if ActiveProperties.Alignment.Vert = taVCenter then
          ATop := AnchorY - ANewHeight div 2 -
            Integer((ANewHeight div 2) <> (ANewHeight / 2))
        else
...
begin
  CalculateViewInfo(GetMouseCursorClientPos, cxmbNone,
    KeyboardStateToShiftState, False);
end;
...
begin
  ...
  if (csHotTrack in ViewInfo.ContainerState) <>
    (csHotTrack in APrevContainerState) then
  begin
...
procedure TcxCustomEdit.CalculateViewInfo(AViewInfo: TcxCustomEditViewInfo;
  P: TPoint; Button: TcxMouseButton; Shift: TShiftState;
  AIsMouseEvent: Boolean);
var
  AViewData: TcxCustomEditViewData;
  R: TRect;
...
function TcxCustomEdit.CanKeyDownModifyEdit(Key: Word;
  ...
  if IsInplace then
    ...
    begin
      ...
      begin
        ...
        Result := Result and DataBinding.IDefaultValuesProvider.DefaultCanModify
          and DataBinding.IDefaultValuesProvider.CanSetEditMode;
      end;
    end;
end;
...
begin
  ...
  else if not ActiveProperties.IsChanging then
    DataBinding.SetModified;
  DoChange;
end;
...
begin
  if not(FHandleAllocating or HandleAllocated or IsDestroying) and
    CanAllocateHandle(Self) then
  begin
...
begin
  ...
  try
    ...
    if (RepositoryItem <> nil) and Assigned(ActiveProperties.FOnButtonClick)
    then
...
begin
  ...
  if not ActiveProperties.HasDisplayValue and not ActiveProperties.CanCompareEditValue
  then
    DoEditValueChanged;
end;
...
begin
  ...
  try
    case Key of
      ...
      VK_TAB:
        if Focused and (Shift * [ssAlt, ssCtrl] = []) and not ActiveProperties.InnerEditNeedsTabs
        then
        begin
          EnableUserAction;
          try
          ...
          if GetParentForm(Self) <> nil then
            TWinControlAccess(GetParentForm(Self))
              .SelectNext(GetParentForm(Self).ActiveControl,
...
procedure TcxCustomEdit.DoFocusChanged;
  ...
  begin
    ...
    Result := (AParentForm <> nil) and not AParentForm.Visible and
      (fsModal in AParentForm.FormState) and
      not(AParentForm.ModalResult in [mrNone, mrCancel]);
  end;
...
procedure TcxCustomEdit.DoValidateDisplayValue(var ADisplayValue: TcxEditValue;
  var AErrorText: TCaption; var AError: Boolean);
begin
  if ActiveProperties.CanValidate then
    ActiveProperties.ValidateDisplayValue(ADisplayValue, AErrorText,
      AError, Self);
end;
...
procedure TcxCustomEdit.PopulateSizeProperties(var AEditSizeProperties
...
begin
  Result := not IsDesigning and
    (not IsInplace or ActiveProperties.UseMouseWheel or (ssCtrl in Shift))
    and Focused;
end;
...
procedure TcxCustomEdit.HandleValidationError(const AErrorText: string;
  ...
  begin
    Result := (evoAllowLoseFocus in ActiveProperties.ValidationOptions) and
      ( { not IsInplace or } (AErrorText = '') or
      not(evoRaiseException in AValidationOptions));
  end;
...
begin
  ...
  else if ACanAbortExecution and not(evoAllowLoseFocus in AValidationOptions)
  then
    Abort;
end;
...
procedure TcxCustomEdit.Initialize;
  ...
  begin
    FDblClickTimer := cxCreateTimer(DblClickTimerHandler,
      GetDblClickInterval, False);
  end;
...
begin
  Result := not ActiveProperties.IsEditValueConversionDependOnFocused
    or Focused;
end;
...
function TcxCustomEdit.IsRepositoryItemAcceptable(ARepositoryItem
  : TcxEditRepositoryItem): Boolean;
begin
  Result := (ARepositoryItem = nil) or ARepositoryItem.ArePropertiesCompatible
    (GetPropertiesClass);
end;

procedure TcxCustomEdit.LockChangeEvents(ALock: Boolean;
  AInvokeChangedOnUnlock: Boolean = True);
begin
...
begin
  if ALock then
    Inc(FClickLockCount)
  else if FClickLockCount > 0 then
    Dec(FClickLockCount);
end;
...
begin
  ...
  else if FEditValueChangingLockCount > 0 then
...
begin
  ...
  try
    ...
    try
      ...
      else if DataBinding.Modified then
      begin
        SaveModified;
        try
...
procedure TcxCustomEdit.InternalValidateDisplayValue(const ADisplayValue
  : TcxEditValue);
begin
  SaveModified;
...
begin
  ...
  begin
    ...
    Result := Result or HasInnerEdit and
      (AParentForm.ActiveControl = InnerEdit.Control);
  end;
end;
...
begin
  Result := not ModifiedAfterEnter and (csPaintCopy in ControlState) and
    IsDBEdit and IsParentDBCtrlGrid and
    not cxIsTransparentBackgroundDrawing(Self);
end;
...
begin
  AIndex := GetDefaultButtonVisibleIndex;
  Result := (AShortCut = ActiveProperties.ClickKey) and (AIndex <> -1) and
    (ViewInfo.ButtonsInfo[AIndex].Data.State <> ebsDisabled);
end;
...
begin
  AShortCut := ShortCut(Key, Shift);
  Result := (AShortCut = ActiveProperties.ClearKey) or
    IsDefaultButtonKey(AShortCut);
end;
...
begin
  dxTestCheck(FUserActionDisabledCount > 0,
    'TcxCustomEdit.EnableUserAction fails');
...
begin
  ...
  try
    ...
    try
      ...
      AViewData.Calculate(Canvas, GetControlRect(Self), cxInvalidPoint,
        cxmbNone, [], AViewInfo, False);
...
begin
  Result := ActiveProperties.ReadOnly or
    DataBinding.IsInnerControlHaveToBeReadOnly;
end;
...
function TcxCustomEdit.ValidateKeyDown(var Key: Word;
  Shift: TShiftState): Boolean;
begin
  Result := not(not DataBinding.Modified and CanKeyDownModifyEdit(Key, Shift)
    and not DoEditing);
end;
...
begin
  ...
  else if CanKeyPressModifyEdit(Key) and not DoEditing then
    Key := #0;
  Result := Key <> #0;
end;
...
begin
  if HasInnerEdit then
    FWindowProcObject := cxWindowProcController.Add(InnerEdit.Control.Handle,
      LockedInnerEditWindowProc);
end;
...
// IcxEditRepositoryItemListener
procedure TcxCustomEdit.RepositoryItemListenerItemRemoved
  (Sender: TcxEditRepositoryItem);
begin
  RepositoryItem := nil;
end;

procedure TcxCustomEdit.RepositoryItemListenerPropertiesChanged
  (Sender: TcxEditRepositoryItem);
begin
...
procedure TcxCustomEdit.SpellCheckerSetSelText(const AValue: string;
  APost: Boolean = False);
begin
end;
...
begin
  ...
  begin
    ...
    if (AButtonViewInfo.Data.State <> ebsDisabled) and
      IsAccel(AKey, AButtonViewInfo.Data.Caption) then
    begin
      Result := True;
      DoButtonClick(I);
      Break;
...
function TcxCustomEdit.GetInternalStyle(AState: TcxContainerStateItem)
  : TcxCustomEditStyle;
begin
  Result := TcxCustomEditStyle(FStyles[AState]);
end;
...
begin
  if HasInnerControl then
    AMessage.Result := SendMessage(InnerControl.Handle, AMessage.Msg,
...
function TcxCustomEdit.GetViewData(out AIsViewDataCreated: Boolean)
  : TcxCustomEditViewData;
begin
...
begin
  ...
  begin
    ...
    AViewData := TcxCustomEditViewData(CreateViewData);
    try
      ASize := AViewData.GetEditSize(cxScreenCanvas, EditValue,
        AEditSizeProperties, ViewInfo);
...
begin
  ...
  if not IsRepositoryItemAcceptable(Value) then
    raise EcxEditError.Create
      (cxGetResourceString(@cxSEditInvalidRepositoryItem));
...
function TcxCustomEditProperties.Clone(AOwner: TPersistent)
  : TcxCustomEditProperties;
begin
...
class function TcxCustomEditProperties.GetViewInfoClass
...
procedure TcxCustomEditProperties.Changed;
  ...
  begin
    Result := not ChangedLocked and
      not((GetOwner is TComponent) and (csDestroying in TComponent(GetOwner)
      .ComponentState));
  end;
...
procedure TcxCustomEditProperties.DoUpdate(AProperties
  : TcxCustomEditProperties);
begin
  // do nothing
end;

function TcxCustomEditProperties.CompareDisplayValues(const AEditValue1,
  AEditValue2: TcxEditValue): Boolean;
var
...
function TcxCustomEditProperties.CreatePreviewProperties
  : TcxCustomEditProperties;
begin
...
begin
  AViewData := TcxCustomEditViewData(CreateViewData(AEditStyle, AIsInplace));
  try
    Result := AViewData.GetEditContentSize(ACanvas, AEditValue,
      AEditSizeProperties);
  finally
    FreeAndNil(AViewData);
  end;
...
function TcxCustomEditProperties.GetSupportedOperations
...
function TcxCustomEditProperties.IsEditValueValid(var EditValue: TcxEditValue;
...
procedure TcxCustomEditProperties.ValidateDisplayValue(var ADisplayValue
  : TcxEditValue; var AErrorText: TCaption; var AError: Boolean;
  AEdit: TcxCustomEdit);
var
...
procedure TcxCustomEditProperties.FillMinMaxValues(AMinValue,
  AMaxValue: Double);
begin
...
class function TcxCustomEditProperties.GetAssignedValuesClass
  : TcxCustomEditPropertiesValuesClass;
begin
...
function TcxCustomEditProperties.GetDisplayFormatOptions
...
begin
  if AssignedValues.MaxValue then
    Result := FMaxValue
  else if IDefaultValuesProvider = nil then
    Result := 0
  else
...
function TcxCustomEditProperties.GetEditValueSource(AEditFocused: Boolean)
  : TcxDataEditValueSource;
begin
  Result := evsValue;
end;

function TcxCustomEditProperties.GetValidateErrorText
  (AErrorKind: TcxEditErrorKind): string;
begin
  Result := cxGetResourceString(@cxSEditValidateErrorText);
end;

function TcxCustomEditProperties.GetValueEditorEditValueSource
  (AEditFocused: Boolean): TcxDataEditValueSource;
begin
  Result := evsValue;
  if not AEditFocused and (dfoSupports in DisplayFormatOptions) and
    (IDefaultValuesProvider <> nil) and
    IDefaultValuesProvider.IsDisplayFormatDefined
    (not(dfoNoCurrencyValue in DisplayFormatOptions)) then
    Result := evsText;
end;

class function TcxCustomEditProperties.GetViewDataClass
...
begin
  Result := (Owner is TComponent) and
    (csDesigning in TComponent(Owner).ComponentState);
end;
...
begin
  Result := not IsValueFormattedByProperties and
    (dfoSupports in DisplayFormatOptions) and
    (GetEditValueSource(True) = evsValue) and
    (GetEditValueSource(False) = evsText) and (IDefaultValuesProvider <> nil)
    and IDefaultValuesProvider.IsDisplayFormatDefined
    (not(dfoNoCurrencyValue in DisplayFormatOptions));
end;
...
procedure TcxCustomEditProperties.PrepareDisplayValue(const AEditValue
...
procedure TcxCustomEditProperties.DoAssign(AProperties
  : TcxCustomEditProperties);
begin
...
begin
  ...
  begin
    ...
    if AError then
    begin
      AIsUserErrorDisplayValue := not VarEquals(APrevDisplayValue,
        ADisplayValue);
...
begin
  ...
  begin
    ...
    if (AOwnerComponent <> nil) and (csWriting in AOwnerComponent.ComponentState)
    then
      Exit;
  end;
...
function TcxCustomEditProperties.SupportsMultiThreading(AUseDisplayValue
  : Boolean): Boolean;
begin
...
procedure TcxCustomEditProperties.SetButtonsViewStyle
  (Value: TcxEditButtonsViewStyle);
begin
...
procedure TcxCustomEditProperties.SetIDefaultValuesProvider
  (Value: IcxEditDefaultValuesProvider);
begin
...
procedure TcxCustomEditProperties.SetValidationErrorIconAlignment
  (AValue: TLeftRight);
begin
...
procedure TcxCustomEditProperties.SetValidationOptions
  (Value: TcxEditValidationOptions);
begin
...
procedure TcxCustomEditProperties.ScaleFactorChangeHandler(Sender: TObject;
