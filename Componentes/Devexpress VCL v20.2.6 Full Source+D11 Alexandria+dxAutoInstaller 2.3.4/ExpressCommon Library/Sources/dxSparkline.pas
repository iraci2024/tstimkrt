...
uses
  Types, Variants, Windows, Classes, SysUtils, Graphics, Contnrs, Controls,
  Messages,
  dxCore, dxCoreGraphics, dxCoreClasses, cxGraphics, cxGeometry, dxGDIPlusApi,
  dxGDIPlusClasses,
...
type
  ...
  protected
    ...
    property DefaultValueTypeClass: TcxValueTypeClass
      read FDefaultValueTypeClass write FDefaultValueTypeClass;
  ...
  published
    ...
    property MinMaxRangeType: TdxSparklineMinMaxRangeType read FMinMaxRangeType
      write SetMinMaxRangeType default mmrtAuto;
  ...
  published
    property DataBinding: TdxSparklineItemDataBinding read FDataBinding
      write SetDataBinding;
    property AreaOpacity: Byte read FAreaOpacity write SetAreaOpacity
      default 127;
    property Color: TColor read FColor write SetColor default clDefault;
    property EndPointColor: TColor read FEndPointColor write SetEndPointColor
      default clNone;
    ...
    property MaxPointColor: TColor read FMaxPointColor write SetMaxPointColor
      default clNone;
    property MinPointColor: TColor read FMinPointColor write SetMinPointColor
      default clNone;
    property NegativePointColor: TColor read FNegativePointColor
      write SetNegativePointColor default clNone;
    property SeriesType: TdxSparklineSeriesType read FSeriesType
      write SetSeriesType default stLine;
    property StartPointColor: TColor read FStartPointColor
      write SetStartPointColor default clNone;
  ...
  public
    ...
    property Properties: TdxSparklineProperties read FProperties;
    property Items[Index: Integer]: TdxSparklineSeries read GetItem
  ...
  protected
    procedure AddDataBinding(ADataBinding
      : TdxSparklineItemDataBinding); virtual;
    procedure RemoveDataBinding(ADataBinding
      : TdxSparklineItemDataBinding); virtual;
    //
    ...
    function GetItemsDataBindingClass
      : TdxSparklineItemDataBindingClass; virtual;
    function GetSeriesClass: TdxSparklineSeriesClass; virtual;
    class function GetViewDataClass: TcxCustomEditViewDataClass; override;
    function IsActive: Boolean; virtual;
    procedure LoadRecords(const AEditValue: TcxEditValue;
      AList: TList); virtual;
  ...
  published
    property Antialiasing: Boolean read FAntialiasing write SetAntialiasing
      default True;
    property Categories: TdxSparklineCategories read FCategories
      write SetCategories;
  ...
  public
    ...
    procedure Calculate(const ACategories, AValues: array of Variant;
      const ADataRange: TdxSeriesRange; AValueRange: TdxValueRange;
      const AStep: TdxChartPoint; const ABounds: TRect); virtual;
  ...
  public
    procedure Calculate(const ACategories, AValues: array of Variant;
      const ADataRange: TdxSeriesRange; AValueRange: TdxValueRange;
      const AStep: TdxChartPoint; const ABounds: TRect); override;
  ...
  strict private
    ...
    procedure CalculateBarSeriesInfo(const AChartRange: TdxSeriesRange;
      const AStep: TdxChartPoint);

    function GetBarSeriesCount: Integer;
    function GetSeriesCount: Integer;
  protected
    procedure AddSeries(ASeries: TdxSparklineSeries);
    procedure CalculateSeriesViewInfo(const ACategories: TdxSparklineValues;
      const AValues: array of TdxSparklineValues;
  ...
  protected
    procedure Clear;
    procedure PopulateValues(AViewInfo: TdxSparklineViewInfo;
      ARecords: TList); virtual;
...
const
  dxcMinBarWidth = 2;
  dxcMinBarHeight = 1;
  SeriesViewInfoTypes: array [TdxSparklineSeriesType]
    of TdxSparklineSeriesViewInfoClass = (TdxSparklineLineSeriesViewInfo,
    TdxSparklinePointSeriesViewInfo, TdxSparklineAreaSeriesViewInfo,
...
constructor TdxSparklineItemDataBinding.Create(AOwner: TPersistent;
...
begin
  Result := Owner.GetItemsDataBindingClass.Create(Self, Owner,
    TcxStringValueType);
end;
...
procedure TdxSparklineCategories.SetDataBinding
  (AValue: TdxSparklineItemDataBinding);
begin
...
procedure TdxSparklineCategories.SetMinMaxRangeType
  (AValue: TdxSparklineMinMaxRangeType);
begin
...
begin
  ...
  begin
    ...
    LineWidth := ScaleFactor.Apply(TdxSparklineSeries(Source).LineWidth,
      TdxSparklineSeries(Source).ScaleFactor);
    MarkerColor := TdxSparklineSeries(Source).MarkerColor;
    MarkerColor := TdxSparklineSeries(Source).MarkerColor;
    MarkerSize := ScaleFactor.Apply(TdxSparklineSeries(Source).MarkerSize,
      TdxSparklineSeries(Source).ScaleFactor);
...
procedure TdxSparklineSeries.SetDataBinding
  (AValue: TdxSparklineItemDataBinding);
begin
  DataBinding.Assign(AValue);
end;
...
constructor TdxSparklineSeriesCollection.Create(AProperties
  : TdxSparklineProperties);
begin
...
function TdxSparklineSeriesCollection.GetItem(AIndex: Integer)
  : TdxSparklineSeries;
begin
...
procedure TdxSparklineSeriesCollection.SetItem(AIndex: Integer;
  AValue: TdxSparklineSeries);
begin
...
procedure TdxSparklineSeriesCollection.SetMinMaxRangeType
  (AValue: TdxSparklineMinMaxRangeType);
begin
  if FMinMaxRangeType <> AValue then
  begin
...
class function TdxSparklineProperties.GetViewInfoClass
...
procedure TdxSparklineProperties.SetSeries
  (AValue: TdxSparklineSeriesCollection);
begin
  Series.Assign(AValue);
end;

procedure TdxSparklineProperties.AddDataBinding(ADataBinding
  : TdxSparklineItemDataBinding);
begin
...
procedure TdxSparklineProperties.RemoveDataBinding(ADataBinding
  : TdxSparklineItemDataBinding);
begin
...
function TdxSparklineProperties.CreateSeriesCollection
  : TdxSparklineSeriesCollection;
begin
...
begin
  ...
  begin
    ...
    Padding.ChangeScale(ScaleFactor.Numerator,
      TdxSparklineProperties(AProperties).ScaleFactor.Numerator);
  end;
end;

function TdxSparklineProperties.GetItemsDataBindingClass
  : TdxSparklineItemDataBindingClass;
begin
...
class function TdxSparklineProperties.GetViewDataClass
...
procedure TdxSparklineProperties.LoadRecords(const AEditValue: TcxEditValue;
  AList: TList);
var
  AData: AnsiString;
...
function dxSparkLineDiagramScale(const ADiagramRange: TdxSeriesRange;
  const ACanvasRect: TRect): TdxPointF;
var
...
function dxSparkLineDiagramPointToCanvasPoint(const ADiagramRange
  : TdxSeriesRange; const ACanvasRect: TRect; const ADiagramPoint: TdxPointF)
  : TdxPointF;
var
  AScale: TdxPointF;
begin
  ...
  if AScale.X <> 0 then
    Result.X := ACanvasRect.Left + (ADiagramPoint.X - ADiagramRange.X.Min)
      / AScale.X
  else
    Result.X := -1;
  if AScale.Y <> 0 then
    Result.Y := ACanvasRect.Bottom - (ADiagramPoint.Y - ADiagramRange.Y.Min)
      / AScale.Y
  else
    Result.Y := -1;
end;

function dxSparkLineValueToFloat(AValues: array of Variant;
...
function GetValueRange(const AValues: array of Variant;
  const AMin, AMax: Double; ARangeType: TdxSparklineMinMaxRangeType)
  : TdxValueRange; overload;
var
  I: Integer;
  AValue: Single;
begin
...
function GetValueRange(const AValues: array of Variant): TdxValueRange;
  overload;
begin
...
begin
  if (ADiagramRange.Value.Min < 0) and (ADiagramRange.Value.Max > 0) then
    Result := 0
  else if ADiagramRange.Value.Min < 0 then
...
const
  ColorCount = 24;
  Colors: array [0 .. ColorCount - 1] of TColor = ($0204FF, $B4835C, $7C58A5,
...
procedure TdxSparklineSeriesViewInfo.Calculate(const ACategories,
  AValues: array of Variant; const ADataRange: TdxSeriesRange;
  AValueRange: TdxValueRange; const AStep: TdxChartPoint; const ABounds: TRect);

  function GetValueColor(AIndex: Integer): TColor;
  begin
    if (FStartPointColor <> clNone) and (AIndex = 0) then
      Result := FStartPointColor
    else if (FEndPointColor <> clNone) and (AIndex = Length(AValues) - 1) then
      Result := FEndPointColor
    else if (FMinPointColor <> clNone) and (AValues[AIndex] = AValueRange.Min)
    then
      Result := FMinPointColor
    else if (FMaxPointColor <> clNone) and (AValues[AIndex] = AValueRange.Max)
    then
      Result := FMaxPointColor
    else if (FNegativePointColor <> clNone) and (AValues[AIndex] < 0) then
...
var
  I: Integer;
begin
  dxTestCheck(Length(AValues) = Length(ACategories),
    'TdxSparklineSeriesViewInfo.Calculate fails');
...
function TdxSparklineSeriesViewInfo.GetColorForDrawing(AColor: TColor;
  ATint: Integer): TColor;
begin
...
procedure TdxSparklinePointSeriesViewInfo.Calculate(const ACategories,
  AValues: array of Variant; const ADataRange: TdxSeriesRange;
  AValueRange: TdxValueRange; const AStep: TdxChartPoint; const ABounds: TRect);
var
  I: Integer;
begin
  ...
  for I := 0 to Length(FPointArray) - 1 do
    FPointArray[I] := dxSparkLineDiagramPointToCanvasPoint(ADataRange, ABounds,
      dxPointF(dxSparkLineValueToFloat(ACategories, I),
      dxSparkLineValueToFloat(AValues, I)));
end;

procedure TdxSparklinePointSeriesViewInfo.Initialize
  (ASeries: TdxSparklineSeries);
begin
  inherited;
  FMarkerColor := GetColorForDrawing(ASeries.MarkerColor);
  FMarkerWidth := Owner.ScaleFactor.Apply(ASeries.MarkerSize,
    ASeries.Owner.ScaleFactor) / 2;
end;
...
begin
  for I := 0 to Length(FPointArray) - 1 do
    ...
    begin
      AMarkerRect := dxRectF(FPointArray[I].X - FMarkerWidth,
        FPointArray[I].Y - FMarkerWidth, FPointArray[I].X + FMarkerWidth,
        FPointArray[I].Y + FMarkerWidth);
      AGPCanvas.Ellipse(AMarkerRect, dxColorToAlphaColor(PointColors[I]),
        dxColorToAlphaColor(PointColors[I]));
    end;
end;
...
procedure TdxSparklineLineSeriesViewInfo.Initialize
  (ASeries: TdxSparklineSeries);
begin
  inherited;
  LineWidth := Owner.ScaleFactor.Apply(ASeries.LineWidth,
    ASeries.Owner.ScaleFactor);
end;
...
procedure TdxSparklineAreaSeriesViewInfo.Calculate(const ACategories,
  AValues: array of Variant; const ADataRange: TdxSeriesRange;
  AValueRange: TdxValueRange; const AStep: TdxChartPoint; const ABounds: TRect);
var
  I: Integer;
...
begin
  ...
  begin
    ...
    FPolygonPoints[Length(FPolygonPoints) - 1 - I].Y :=
      dxSparkLineDiagramPointToCanvasPoint(ADataRange, ABounds,
      dxPointF(0, AAxisPoint)).Y;
  end;
end;

procedure TdxSparklineAreaSeriesViewInfo.Initialize
  (ASeries: TdxSparklineSeries);
begin
  inherited;
...
procedure TdxSparklineBarSeriesViewInfo.Calculate(const ACategories,
  AValues: array of Variant; const ADataRange: TdxSeriesRange;
  AValueRange: TdxValueRange; const AStep: TdxChartPoint; const ABounds: TRect);
  ...
  begin
    ...
    Result.Left := P1.X - Round(AWidth * Owner.BarSeriesCount / 2) + AWidth
      * BarIndex;
...
begin
  ...
  begin
    ...
    begin
      if (I > 0) and (FBarRectArray[I].Left <= APrevBarRect.Left +
        Owner.BarWidth * Owner.BarSeriesCount + 1) then
...
begin
  ...
  try
    for I := 0 to Length(FBarRectArray) - 1 do
      dxGPPaintCanvas.FillRectangle(FBarRectArray[I],
        dxColorToAlphaColor(PointColors[I]));
  finally
    dxGPPaintCanvas.EndPaint;
  end;
...
procedure TdxSparklineViewInfo.CalculateSeriesViewInfo(const ACategories
  : TdxSparklineValues; const AValues: array of TdxSparklineValues;
  const ADataRange: TdxSeriesRange; const AStep: TdxChartPoint);
...
begin
  ...
  begin
    ...
    TdxSparklineSeriesViewInfo(FSeries[I]).Calculate(ACategories, AValues[I],
      ADataRange, AValueRange, AStep,
      GetChartRect(TdxSparklineSeriesViewInfo(FSeries[I])));
  end;
end;
...
begin
  ...
  begin
    ACanvas.Font := Font;
    cxDrawText(ACanvas, cxGetResourceString(@sdxSparklineNoData), ClientRect,
      DT_SINGLELINE or DT_CENTER or DT_VCENTER);
  end;
end;

procedure TdxSparklineViewInfo.CalculateBarSeriesInfo(const AChartRange
  : TdxSeriesRange; const AStep: TdxChartPoint);
var
  AChartWidth: Integer;
  ABarCount: Integer;
begin
  ...
  ABarCount := Round((AChartRange.Category.Max - AChartRange.Category.Min) /
    AStep.Category) + 1;
  FBarWidth := Trunc(3 * AChartWidth / (3 * BarSeriesCount * ABarCount + 2 *
    ABarCount - 2));
...
procedure TdxSparklineViewData.Calculate(ACanvas: TcxCanvas;
...
const
  SmoothingModeMap: array [Boolean] of TdxGPSmoothingMode = (smDefault,
    smAntiAlias);
begin
  inherited;
  CalculateRange;
  ...
  (AViewInfo as TdxSparklineViewInfo).CalculateSeriesViewInfo(Categories,
    Values, DataRange, Step);
  (AViewInfo as TdxSparklineViewInfo).SmoothingMode :=
    SmoothingModeMap[Properties.Antialiasing];
end;

procedure TdxSparklineViewData.EditValueToDrawValue(const AEditValue
...
function TdxSparklineViewData.GetClientExtent(ACanvas: TcxCanvas;
  AViewInfo: TcxCustomEditViewInfo): TRect;
var
  AMargin: TRect;
begin
  Result := inherited GetClientExtent(ACanvas, AViewInfo);
  AMargin := ScaleFactor.Apply(Properties.Padding.Margin,
...
function TdxSparklineViewData.GetEditContentSize(ACanvas: TcxCanvas;
  const AEditValue: TcxEditValue;
  const AEditSizeProperties: TcxEditSizeProperties;
  AErrorData: TcxEditValidateInfo): TSize;
begin
  Result := inherited GetEditContentSize(ACanvas, AEditValue,
    AEditSizeProperties, AErrorData);
  Result.cx := 100;
...
procedure TdxSparklineViewData.PopulateValues(AViewInfo: TdxSparklineViewInfo;
  ARecords: TList);
var
...
begin
  ...
  try
    ...
    begin
      Categories[ARecordIndex] := Properties.Categories.Values
        [Integer(ARecords[ARecordIndex])];
      for AIndex := 0 to AVisibleSeries.Count - 1 do
        Values[AIndex, ARecordIndex] :=
          TdxSparklineSeries(AVisibleSeries[AIndex])
          .Values[Integer(ARecords[ARecordIndex])];
    end;
  finally
    AVisibleSeries.Free;
  end;
...
begin
  ...
  begin
    DataRange.Category := GetValueRange(Categories,
      Properties.Categories.MinValue, Properties.Categories.MaxValue,
      Properties.Categories.MinMaxRangeType);
...
begin
  ...
  begin
    ...
    for I := 0 to Length(Categories) - 1 do
      Step.X := Min(Step.X, Abs(dxSparkLineValueToFloat(Categories,
        I) - dxSparkLineValueToFloat(Categories, I - 1)));
    if Step.X = 0 then
      Step.X := 1;
...
class function TdxCustomSparklineEdit.GetPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TdxSparklineProperties;
end;

procedure TdxCustomSparklineEdit.InitializeViewData
...
procedure TdxCustomSparklineEdit.InternalSetEditValue(const Value: TcxEditValue;
...
RegisterClasses([TdxSparklineItemDataBinding, TdxSparklineSeries,
  TdxSparklineCategories, TdxSparklineProperties]);
GetRegisteredEditProperties.Register(TdxSparklineProperties,
