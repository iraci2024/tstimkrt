...
uses
  Classes, Windows, Controls, Messages, cxControls, cxGraphics, cxListBox,
  cxLookAndFeelPainters,
  dxCore, dxCoreClasses, cxContainer, dxIncrementalFiltering, cxFilter,
  cxButtons, cxClasses, cxTextEdit,
  dxUIElementPopupWindow, dxFilterValueContainer, Generics.Collections,
  cxGeometry;
...
type
  ...
  TdxFilterPopupWindowSysPanelType = (sptNone, sptClearClose, sptClearOkCancel);
  // for internal use
  ...
  IdxFilterPopupWindowOptions = interface
    ...
    function GetIncrementalFilteringOptions
  ...
  TdxFilterPopupWindowFilterValueContainerListBox = class
  ...
  public
    property FilterValueContainer: TdxFilterPopupWindowFilterValueContainer
      read GetFilterValueContainer;
  end;

  { TdxFilterPopupWindowExcelFilterValueContainerListBox }

  TdxFilterPopupWindowExcelFilterValueContainerListBox = class
    (TdxExcelFilterValueContainerListBox)
  strict private
    function GetFilterValueContainer
      : TdxFilterPopupWindowExcelFilterValueContainer;
  protected
    procedure ApplyCheckAction(AItemIndex: Integer); override;
  public
    property FilterValueContainer: TdxFilterPopupWindowExcelFilterValueContainer
      read GetFilterValueContainer;
  end;
  ...
  protected
    ...
    property ListBox: TdxFilterPopupWindowFilterValueContainerListBox
      read GetListBox;
  ...
  TdxFilterPopupWindowExcelFilterValueContainer = class
    (TdxExcelFilterValueContainer, IdxFilterPopupWindowFilterValueContainer)
  strict private
    function GetPopup: TdxFilterPopupWindow;
  protected
    // IdxFilterPopupWindowFilterValueContainer
    ...
    function GetListBoxClass: TdxExcelFilterValueContainerListBoxClass;
      override;
  ...
  TdxFilterPopupWindowSysPanelButtonViewInfo = class
    (TdxFilterPopupWindowCustomItemViewInfo)
  protected
  ...
  TdxFilterPopupWindowSysPanelButtonViewInfoClass = class of
    TdxFilterPopupWindowSysPanelButtonViewInfo;

  { TdxFilterPopupWindowSysPanelClearButtonViewInfo }

  TdxFilterPopupWindowSysPanelClearButtonViewInfo = class
    (TdxFilterPopupWindowSysPanelButtonViewInfo)
  protected
  ...
  TdxFilterPopupWindowSysPanelCloseButtonViewInfo = class
    (TdxFilterPopupWindowSysPanelButtonViewInfo)
  protected
    function GetHitCode: Integer; override;
    function GetText: string; override;
  ...
  TdxFilterPopupWindowSysPanelCancelButtonViewInfo = class
    (TdxFilterPopupWindowSysPanelCloseButtonViewInfo)
  protected
    function GetHitCode: Integer; override;
    function GetText: string; override;
  ...
  TdxFilterPopupWindowSysPanelOkButtonViewInfo = class
    (TdxFilterPopupWindowSysPanelButtonViewInfo)
  protected
    function GetHitCode: Integer; override;
    function GetText: string; override;
  ...
  TdxFilterPopupWindowSysPanelViewInfo = class
    (TdxFilterPopupWindowCustomItemViewInfo)
  strict private
  ...
  protected
    procedure AddButton(AClass
      : TdxFilterPopupWindowSysPanelButtonViewInfoClass);
    ...
    function GetHeight: Integer; override;
    function GetHitButton(const APoint: TPoint)
      : TdxFilterPopupWindowSysPanelButtonViewInfo; virtual;
    function GetHitCode: Integer; override;
    ...
    property Buttons: TObjectList<TdxFilterPopupWindowSysPanelButtonViewInfo>
      read FButtons;
  ...
  strict private
    ...
    function GetFilterValueContainerIntf
      : IdxFilterPopupWindowFilterValueContainer;
    function GetLinkComponent: TComponent;
  ...
  protected
    ...
    function CreateSysPanelViewInfo
      : TdxFilterPopupWindowSysPanelViewInfo; virtual;
    procedure Deactivate; override;
    procedure DoShowed; override;
    procedure DrawSysPanel; virtual;
    function GetDefaultBounds: TRect; virtual;
    function GetFilterValueContainerClass
      : TdxCustomFilterValueContainerClass; virtual;
    function GetHitTest(const APoint: TPoint): Integer; virtual;
    ...
    property ActualMode: TdxFilterPopupWindowActualMode read FActualMode
      write SetActualMode;
    ...
    property FilterValueContainerIntf: IdxFilterPopupWindowFilterValueContainer
      read GetFilterValueContainerIntf;
    property NeedFilteringAppliedOnClose: Boolean
      read FNeedFilteringAppliedOnClose write FNeedFilteringAppliedOnClose;
    property SysPanelViewInfo: TdxFilterPopupWindowSysPanelViewInfo
      read FSysPanelViewInfo;
  public
...
function dxGetFilterPopupActualMode(AMode: TdxFilterPopupWindowMode)
  : TdxFilterPopupWindowActualMode; // for internal use
...
function dxGetFilterPopupActualMode(AMode: TdxFilterPopupWindowMode)
  : TdxFilterPopupWindowActualMode;
begin
  if (AMode = fpmExcel) or (AMode = fpmDefault) and
    (dxDefaultFilterPopupWindowMode = fpmExcel) then
    Result := fpmExcel
  else
    Result := fpmClassic;
end;
...
procedure TdxFilterPopupWindowFilterValueContainerListBox.ApplyCheckAction
  (AItemIndex: Integer);
begin
...
procedure TdxFilterPopupWindowFilterValueContainerListBox.ApplyClickAction
  (AItemIndex: Integer);
begin
...
procedure TdxFilterPopupWindowFilterValueContainerListBox.KeyDown(var Key: Word;
  Shift: TShiftState);
begin
...
function TdxFilterPopupWindowFilterValueContainerListBox.GetFilterValueContainer
  : TdxFilterPopupWindowFilterValueContainer;
begin
  Result := TdxFilterPopupWindowFilterValueContainer
    (inherited FilterValueContainer);
end;

{ TdxFilterPopupWindowExcelFilterValueContainerListBox }

procedure TdxFilterPopupWindowExcelFilterValueContainerListBox.ApplyCheckAction
  (AItemIndex: Integer);
begin
  inherited ApplyCheckAction(AItemIndex);
  if FilterValueContainer.NeedImmediateApply then
...
function TdxFilterPopupWindowExcelFilterValueContainerListBox.
  GetFilterValueContainer: TdxFilterPopupWindowExcelFilterValueContainer;
begin
...
begin
  ...
  if HasIncrementalFiltering then
    Inc(AHeight, SearchEditOffsets.Top + SearchEditOffsets.Bottom +
      SearchEdit.Height);
  ...
  Height := AHeight;
  AWidth := ListBox.CalculateAutoWidth + GetBorderExtent.Left +
    GetBorderExtent.Right;
...
function TdxFilterPopupWindowFilterValueContainer.CreateListBox
  : TdxFilterValueContainerListBox;
begin
...
procedure TdxFilterPopupWindowFilterValueContainer.AssignOptions
  (AOptions: TObject);
var
...
procedure TdxFilterPopupWindowFilterValueContainer.SysPanelButtonAction
  (AHitCode: Integer);
begin
  // do nothing
end;

function TdxFilterPopupWindowFilterValueContainer.SysPanelButtonEnabled
  (AHitCode: Integer): Boolean;
begin
  Result := False;
end;

function TdxFilterPopupWindowFilterValueContainer.SysPanelType
  : TdxFilterPopupWindowSysPanelType;
begin
  Result := sptNone;
end;

function TdxFilterPopupWindowFilterValueContainer.GetListBox
  : TdxFilterPopupWindowFilterValueContainerListBox;
begin
  Result := TdxFilterPopupWindowFilterValueContainerListBox(inherited ListBox);
end;

function TdxFilterPopupWindowFilterValueContainer.GetPopup
  : TdxFilterPopupWindow;
begin
...
procedure TdxFilterPopupWindowFilterValueContainer.SetVisibleItemCount
  (AValue: Integer);
begin
...
procedure TdxFilterPopupWindowFilterValueContainer.SetVisibleWidth
  (AValue: Integer);
begin
...
procedure TdxFilterPopupWindowExcelFilterValueContainer.AssignOptions
  (AOptions: TObject);
var
...
procedure TdxFilterPopupWindowExcelFilterValueContainer.SysPanelButtonAction
  (AHitCode: Integer);
begin
  case AHitCode of
    htClearButton:
...
function TdxFilterPopupWindowExcelFilterValueContainer.SysPanelButtonEnabled
  (AHitCode: Integer): Boolean;
begin
  Result := True;
  case AHitCode of
...
function TdxFilterPopupWindowExcelFilterValueContainer.SysPanelType
  : TdxFilterPopupWindowSysPanelType;
begin
...
function TdxFilterPopupWindowExcelFilterValueContainer.GetListBoxClass
...
procedure TdxFilterPopupWindowExcelFilterValueContainer.LayoutKeyDown
  (ASender: TObject; var Key: Word; Shift: TShiftState);
var
  AEdit: TcxCustomEdit;
begin
  inherited LayoutKeyDown(ASender, Key, Shift);
  AEdit := Safe<TcxCustomEdit>.Cast(ASender);
  if (Key = VK_ESCAPE) and ((AEdit = nil) or not AEdit.ModifiedAfterEnter and
    not AEdit.HasPopupWindow) then
  begin
    Key := 0;
    Popup.ClosePopup;
  end;
...
function TdxFilterPopupWindowExcelFilterValueContainer.GetPopup
  : TdxFilterPopupWindow;
begin
  Result := TdxFilterPopupWindow(Owner);
end;
...
constructor TdxFilterPopupWindowCustomItemViewInfo.Create
  (AFilterPopup: TdxFilterPopupWindow);
begin
  inherited Create;
...
procedure TdxFilterPopupWindowCustomItemViewInfo.Calculate(ALeftBound,
  ATopBound: Integer);
begin
...
procedure TdxFilterPopupWindowCustomItemViewInfo.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  State := cxbsPressed;
end;

procedure TdxFilterPopupWindowCustomItemViewInfo.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
...
procedure TdxFilterPopupWindowCustomItemViewInfo.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  AIsClick: Boolean;
begin
...
function TdxFilterPopupWindowCustomItemViewInfo.PtInCaller
...
function TdxFilterPopupWindowCustomItemViewInfo.GetHitTest
...
function TdxFilterPopupWindowCustomItemViewInfo.HasPoint
...
procedure TdxFilterPopupWindowCustomItemViewInfo.RightToLeftConversion
  (ABounds: TRect);
begin
...
function TdxFilterPopupWindowCustomItemViewInfo.GetPainter
...
procedure TdxFilterPopupWindowCustomItemViewInfo.SetState
...
begin
  Result := TdxTextMeasurer.TextLineHeight(FilterPopup.Font) + 2 *
    Painter.ScaledButtonTextOffset(ScaleFactor) + 2 * Painter.ButtonBorderSize;
...
begin
  Result := cxTextWidth(FilterPopup.Font, Text) + 2 * Painter.ButtonBorderSize +
...
function TdxFilterPopupWindowSysPanelClearButtonViewInfo.GetHorzAlign
  : TLeftRight;
begin
...
constructor TdxFilterPopupWindowSysPanelViewInfo.Create
  (AFilterPopup: TdxFilterPopupWindow);
begin
...
procedure TdxFilterPopupWindowSysPanelViewInfo.Calculate(ALeftBound,
  ATopBound: Integer);
begin
...
procedure TdxFilterPopupWindowSysPanelViewInfo.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
...
procedure TdxFilterPopupWindowSysPanelViewInfo.MouseMove(Shift: TShiftState;
  X, Y: Integer);
var
  AHitButton: TdxFilterPopupWindowSysPanelButtonViewInfo;
begin
...
procedure TdxFilterPopupWindowSysPanelViewInfo.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  AHitButton: TdxFilterPopupWindowSysPanelButtonViewInfo;
begin
...
procedure TdxFilterPopupWindowSysPanelViewInfo.AddButton
  (AClass: TdxFilterPopupWindowSysPanelButtonViewInfoClass);
begin
...
begin
  ...
  AButtonsPlaceBounds := cxRectCenterVertically(AButtonsPlaceBounds,
    Buttons.First.Height);
  ...
  begin
    ...
    begin
      AButton.Calculate(AButtonsPlaceBounds.Right - AButton.Width,
        AButtonsPlaceBounds.Top);
...
procedure TdxFilterPopupWindowSysPanelViewInfo.DrawBackground
  (ACanvas: TcxCanvas);
begin
...
procedure TdxFilterPopupWindowSysPanelViewInfo.DrawSeparator
  (ACanvas: TcxCanvas);
begin
...
begin
  Painter.DrawScaledSizeGrip(ACanvas, SizeGripBounds, ScaleFactor, clDefault,
    GetSizeGripCorner);
end;
...
function TdxFilterPopupWindowSysPanelViewInfo.GetHitButton(const APoint: TPoint)
  : TdxFilterPopupWindowSysPanelButtonViewInfo;
var
  I: Integer;
begin
...
procedure TdxFilterPopupWindowSysPanelViewInfo.RightToLeftConversion
  (ABounds: TRect);
var
  I: Integer;
begin
  ...
  FSeparatorBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (SeparatorBounds, ABounds);
  for I := 0 to Buttons.Count - 1 do
    Buttons[I].RightToLeftConversion(ABounds);
  FSizeGripBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (SizeGripBounds, ABounds);
end;

function TdxFilterPopupWindowSysPanelViewInfo.GetHitTest
  (const APoint: TPoint): Integer;
var
  I, AHitCode: Integer;
begin
...
procedure TdxFilterPopupWindow.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  AHitCode: Integer;
begin
  ...
  if AHitCode = htNone then
    Exit;
  if (AHitCode = htSizeGrip) and (Button = mbLeft) and (GetCaptureControl = Self)
  then
...
begin
  ...
  else if GetHitTest(cxPoint(X, Y)) <> htNone then
    SysPanelViewInfo.MouseMove(Shift, X, Y);
end;

procedure TdxFilterPopupWindow.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
  if CaptureSizeGrip then
...
function TdxFilterPopupWindow.CreateSysPanelViewInfo
  : TdxFilterPopupWindowSysPanelViewInfo;
begin
...
begin
  ...
  try
    ...
    cxBitBlt(Canvas.Handle, ACanvas.Handle, SysPanelViewInfo.Bounds,
      cxNullPoint, SRCCOPY);
  finally
    ABuffer.Free;
  end;
...
begin
  ...
  if ActualMode = fpmExcel then
    Result := ScaleFactor.Apply(Rect(0, 0, dxExcelFilterPopupDefaultWidth,
      dxExcelFilterPopupDefaultHeight));
end;

function TdxFilterPopupWindow.GetFilterValueContainerClass
  : TdxCustomFilterValueContainerClass;
begin
  if ActualMode = fpmExcel then
    Result := TdxFilterPopupWindowExcelFilterValueContainer
  else
...
function TdxFilterPopupWindow.GetFilterValueContainerIntf
  : IdxFilterPopupWindowFilterValueContainer;
begin
  Supports(FilterValueContainer,
    IdxFilterPopupWindowFilterValueContainer, Result);
end;
...
procedure TdxFilterPopupWindow.SetActualMode
  (AValue: TdxFilterPopupWindowActualMode);
begin
