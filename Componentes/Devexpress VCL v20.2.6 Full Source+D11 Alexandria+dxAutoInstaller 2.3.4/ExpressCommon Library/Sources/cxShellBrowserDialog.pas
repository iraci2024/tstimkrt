...
uses
  ...
  cxClasses, cxShellCommon, cxShellControls, cxShellDlgs, cxShellBrowser,
  cxLookAndFeels;
...
type
  ...
  protected
    ...
    property FolderLabelCaption: string read FFolderCaption
      write FFolderCaption;
...
begin
  ...
  try
    ...
    try
      ...
      ADlg.DlgOptions.ShowZipFilesWithFolders :=
        FShellOptions.ShowZipFilesWithFolders;
