...
function dxVarArrayToDelimitedText(const AValue: Variant;
  const ADelimiter, AQuote: string): string;
function dxVarArrayToDelimetedText(const AValue: Variant;
  const ADelimiter, AQuote: string): string;
  deprecated 'use the dxVarArrayToDelimitedText global function instead'
...
begin
  ...
  begin
    ...
    begin
      ...
      Result := Result + dxVarArrayToDelimitedText(AValue[I],
        ADelimiter, AQuote);
    end;
  end
  else
