...
class function TcxEditRepositoryLookupComboBoxItem.GetEditPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TcxLookupComboBoxProperties;
end;

function TcxEditRepositoryLookupComboBoxItem.GetProperties
  : TcxLookupComboBoxProperties;
begin
  Result := inherited Properties as TcxLookupComboBoxProperties;
end;

procedure TcxEditRepositoryLookupComboBoxItem.SetProperties
