...
uses
  Types, Variants, Windows, DB, Classes, SysUtils, Graphics, Contnrs, Controls,
  Messages,
  dxCore, dxCoreGraphics, dxCoreClasses, cxGraphics, cxGeometry, dxGDIPlusApi,
  dxGDIPlusClasses, cxDBEdit,
  cxContainer, cxCustomData, cxDBData, cxDataStorage, cxDataUtils, cxEdit,
  cxEditConsts, dxSparkline;
...
type
  ...
  published
    property DataBinding: TdxLookupSparklineItemDataBinding read GetDataBinding
  ...
  public
    ...
    property Items[Index: Integer]: TdxLookupSparklineSeries read GetItem
  ...
  protected
    ...
    function GetItemsDataBindingClass
      : TdxSparklineItemDataBindingClass; override;
    function GetSeriesClass: TdxSparklineSeriesClass; override;
    function IsActive: Boolean; override;
    procedure LoadRecords(const AEditValue: TcxEditValue;
      AList: TList); override;
    procedure MakeGroups;

    property DetailBinding: TdxLookupSparklineItemDataBinding
      read FDetailBinding write FDetailBinding;
  public
  ...
  published
    ...
    property LookupKeyFieldName: string read GetLookupKeyFieldName
      write SetLookupKeyFieldName;
    property Categories: TdxLookupSparklineCategories read GetCategories
      write SetCategories;
    property Series: TdxLookupSparklineSeriesCollection read GetSeries
      write SetSeries;
  end;
  ...
  public
    ...
    property ActiveProperties: TdxLookupSparklineProperties
      read GetActiveProperties;
  published
    property Properties: TdxLookupSparklineProperties read GetProperties
      write SetProperties;
  end;
...
type
  ...
  public
    constructor Create(AOwner: TdxLookupSparklineProperties);
...
constructor TdxLookSparklineDataController.Create
  (AOwner: TdxLookupSparklineProperties);
begin
  FSparkline := AOwner;
...
procedure TdxLookSparklineDataController.UpdateControl
...
begin
  if Properties.Owner <> nil then
    Result := TcxDBDataController(DataController)
      .GetItemByFieldName(FieldName) <> nil
  else
    Result := False;
end;
...
function TdxLookupSparklineCategories.GetDataBinding
  : TdxLookupSparklineItemDataBinding;
begin
  Result := TdxLookupSparklineItemDataBinding(inherited DataBinding);
end;

procedure TdxLookupSparklineCategories.SetDataBinding
  (AValue: TdxLookupSparklineItemDataBinding);
begin
...
function TdxLookupSparklineSeries.GetDataBinding
  : TdxLookupSparklineItemDataBinding;
begin
  Result := TdxLookupSparklineItemDataBinding(inherited DataBinding);
end;

procedure TdxLookupSparklineSeries.SetDataBinding
  (AValue: TdxLookupSparklineItemDataBinding);
begin
  DataBinding.Assign(AValue)
end;
...
function TdxLookupSparklineSeriesCollection.GetItem(AIndex: Integer)
  : TdxLookupSparklineSeries;
begin
  Result := TdxLookupSparklineSeries(inherited Items[AIndex]);
end;

procedure TdxLookupSparklineSeriesCollection.SetItem(AIndex: Integer;
  AValue: TdxLookupSparklineSeries);
begin
...
begin
  ...
  DetailBinding := GetItemsDataBindingClass.Create(Self, Self,
    TcxIntegerValueType) as TdxLookupSparklineItemDataBinding;
end;

procedure TdxLookupSparklineProperties.DoAssign(AProperties
  : TcxCustomEditProperties);
begin
  inherited DoAssign(AProperties);
  if AProperties is TdxLookupSparklineProperties then
  begin
    LookupDataSource := TdxLookupSparklineProperties(AProperties)
      .LookupDataSource;
    LookupKeyFieldName := TdxLookupSparklineProperties(AProperties)
      .LookupKeyFieldName;
  end;
end;

class function TdxLookupSparklineProperties.GetContainerClass
  : TcxContainerClass;
begin
...
function TdxLookupSparklineProperties.CreateDataController
  : TcxCustomDataController;
begin
  Result := TdxLookSparklineDataController.Create(Self);
end;

function TdxLookupSparklineProperties.CreateSeriesCollection
  : TdxSparklineSeriesCollection;
begin
  Result := TdxLookupSparklineSeriesCollection.Create(Self);
end;

function TdxLookupSparklineProperties.GetItemsDataBindingClass
...
procedure TdxLookupSparklineProperties.LoadRecords(const AEditValue
  : TcxEditValue; AList: TList);
var
  ADataGroupIndex: TcxDataGroupIndex;
begin
  AList.Clear;
  ADataGroupIndex := DataController.Groups.GetDataGroupIndexByGroupValue(-1,
    AEditValue);
...
function TdxLookupSparklineProperties.GetCategories
  : TdxLookupSparklineCategories;
begin
...
function TdxLookupSparklineProperties.GetSeries
  : TdxLookupSparklineSeriesCollection;
begin
  Result := inherited Series as TdxLookupSparklineSeriesCollection;
end;

procedure TdxLookupSparklineProperties.SetCategories
  (AValue: TdxLookupSparklineCategories);
begin
...
procedure TdxLookupSparklineProperties.SetLookupKeyFieldName
  (const AValue: string);
begin
  DetailBinding.FieldName := AValue;
end;

procedure TdxLookupSparklineProperties.SetSeries
  (AValue: TdxLookupSparklineSeriesCollection);
begin
...
class function TdxCustomLookupSparklineEdit.GetPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TdxLookupSparklineProperties;
end;

function TdxCustomLookupSparklineEdit.GetActiveProperties
  : TdxLookupSparklineProperties;
begin
  Result := inherited ActiveProperties as TdxLookupSparklineProperties;
end;

function TdxCustomLookupSparklineEdit.GetProperties
  : TdxLookupSparklineProperties;
begin
  Result := inherited Properties as TdxLookupSparklineProperties;
end;

procedure TdxCustomLookupSparklineEdit.SetProperties
  (AValue: TdxLookupSparklineProperties);
begin
...
class function TdxDBLookupSparklineEdit.GetDataBindingClass
...
class function TcxEditRepositoryLookupSparklineItem.GetEditPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TdxLookupSparklineProperties;
end;

function TcxEditRepositoryLookupSparklineItem.GetProperties
  : TdxLookupSparklineProperties;
begin
  Result := inherited Properties as TdxLookupSparklineProperties
end;

procedure TcxEditRepositoryLookupSparklineItem.SetProperties
  (Value: TdxLookupSparklineProperties);
begin
...
RegisterClasses([TdxLookupSparklineItemDataBinding, TdxLookupSparklineSeries,
  TdxLookupSparklineCategories, TdxLookupSparklineProperties,
  TcxEditRepositoryLookupSparklineItem]);
GetRegisteredEditProperties.Register(TdxLookupSparklineProperties,
