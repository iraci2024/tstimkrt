...
function FormatText(const AText, AMask: string;
...
constructor TcxStandardMaskManyItem.Create(AOptional: Boolean;
...
constructor TcxStandardMaskNumericSymbolItem.Create(AOptional: Boolean;
  ACaseControl: TcxCaseControl);
begin
...
procedure TcxStandardMask.Format(var AText: string;
  AChangeCharCase: Boolean = True; AMatchForBlanksAndLiterals: Boolean = True);

  procedure InitializeVariables(out S: string;
    out ANotTestedPos, APos, AStep: Integer);
  begin
    S := FullEmptyString;
...
begin
  ...
  ACheckLiteralItem := not SaveLiteralCharacters and
    not AMatchForBlanksAndLiterals and (Length(AResult) <> Length(AText));
...
begin
  ...
  begin
    case AMask[I] of
      ...
      'A':
        begin
          FItems.Add(TcxStandardMaskAlphaNumericItem.Create(False,
            ACaseControl));
          Inc(I);
        end;
      'a':
        begin
          FItems.Add(TcxStandardMaskAlphaNumericItem.Create(True,
            ACaseControl));
          Inc(I);
        end;
      'C':
      ...
      '#':
        begin
          FItems.Add(TcxStandardMaskNumericSymbolItem.Create(True,
            ACaseControl));
          Inc(I);
        end;
      ':':
        begin
          FItems.Add(TcxStandardMaskLiteralItem.Create
            (dxFormatSettings.TimeSeparator));
          Inc(I);
        end;
      '/':
        begin
