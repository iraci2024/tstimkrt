...
uses
  Types, Windows, SysUtils, Classes, Controls, Graphics, Generics.Defaults,
...
type
  ...
  IdxSpellCheckerAdapter = interface
    ...
    procedure Replace(var AStart, AFinish: IdxSpellCheckerPosition;
      const AWord: string; var ASpellingStart, ASpellingFinish
      : IdxSpellCheckerPosition);
  ...
  TdxSpellCheckerAutoCorrectWordRange = record
    ...
    class operator Equal(const R1,
      R2: TdxSpellCheckerAutoCorrectWordRange): Boolean;
    class operator NotEqual(const R1,
      R2: TdxSpellCheckerAutoCorrectWordRange): Boolean;
  end;
  ...
  TdxSpellCheckerAutoCorrectWordInfo = record
    ...
    class function Create(const AWordRange: TdxSpellCheckerAutoCorrectWordRange;
      const ATextController: IdxSpellCheckTextController)
      : TdxSpellCheckerAutoCorrectWordInfo; overload; static;
    procedure Reset;
  ...
  TdxSpellCheckerPosition<T> = class abstract(TInterfacedObject,
    IdxSpellCheckerPosition)
  strict private
  ...
  protected
    ...
    function Compare(APosition: IdxSpellCheckerPosition): Integer; overload;
      virtual; abstract;
  ...
  public
    ...
    function Subtract(APosition: IdxSpellCheckerPosition)
      : IdxSpellCheckerPosition; virtual; abstract;

    function ToInteger: Integer; virtual; abstract;
    function Equals(AObj: TObject): Boolean; overload; override;
    function GetHashCode: Integer; override;

    class function Compare(const APosition1, APosition2
      : IdxSpellCheckerPosition): Integer; overload; static;
    class function IsGreater(const APosition1,
      APosition2: IdxSpellCheckerPosition): Boolean; static;
    class function IsGreaterOrEqual(const APosition1,
      APosition2: IdxSpellCheckerPosition): Boolean; static;
    class function IsLess(const APosition1, APosition2: IdxSpellCheckerPosition)
      : Boolean; static;
    class function IsLessOrEqual(const APosition1,
      APosition2: IdxSpellCheckerPosition): Boolean; static;
  ...
  TdxSpellCheckCustomSimpleTextController = class(TInterfacedObject,
    IdxSpellCheckTextController)
  protected
    ...
    function DecodePosition(const AValue: IdxSpellCheckerPosition)
      : Integer; inline;
    function DecodePositions(const AStart, AFinish: IdxSpellCheckerPosition;
      var AIndex, ACount: Integer): Boolean;
    function EncodePosition(const AValue: Integer)
      : IdxSpellCheckerPosition; inline;
  public
    ...
    function GetWord(const AStart, AFinish: IdxSpellCheckerPosition)
      : string; virtual;
    function IsRangeEditable(const AStart, AFinish: IdxSpellCheckerPosition)
      : Boolean; virtual;
    procedure SetSpellingArea(const AStart,
      AFinish: IdxSpellCheckerPosition); virtual;
    //
  ...
  public
    ...
    property Items[Index: Integer]: TdxSpellCheckerReplacement
  ...
  TdxSpellCheckerPopupMenuItem = (scmiAddToDictionary, scmiAutoCorrect,
    scmiDelete, scmiIgnoreAll, scmiSpelling, scmiSuggestions, scmiIgnore);
  ...
  published
    ...
    property PopupMenuItems: TdxSpellCheckerPopupMenuItems read FPopupMenuItems
      write SetPopupMenuItems default DefaultPopupMenuItems;
    property SuggestionCount: Integer read FSuggestionCount
      write SetSuggestionCount default 5;
  ...
  TdxSpellCheckerAutoCorrectExceptionAddEvent = procedure
    (Sender: TdxSpellCheckerAutoCorrectExceptions; var AException: WideString;
    var AAllow: Boolean) of object;
  TdxSpellCheckerAutoCorrectExceptionDeleteEvent = procedure
    (Sender: TdxSpellCheckerAutoCorrectExceptions; const AException: WideString;
    var AAllow: Boolean) of object;
  ...
  protected
    ...
    property OnAdd: TdxSpellCheckerAutoCorrectExceptionAddEvent read FOnAdd
      write FOnAdd;
    property OnDelete: TdxSpellCheckerAutoCorrectExceptionDeleteEvent
      read FOnDelete write FOnDelete;
  public
    constructor Create(AOptions
      : TdxSpellCheckerCustomAutoCorrectOptions); virtual;
    destructor Destroy; override;
  ...
  strict private
    ...
    procedure FirstLetterExceptionAddHandler
      (Sender: TdxSpellCheckerAutoCorrectExceptions; var AException: WideString;
      var AAllow: Boolean);
    procedure InitialCapsExceptionAddHandler
      (Sender: TdxSpellCheckerAutoCorrectExceptions; var AException: WideString;
      var AAllow: Boolean);
  ...
  public
    ...
    property FirstLetterExceptions: TdxSpellCheckerAutoCorrectExceptions
      read FFirstLetterExceptions;
    property InitialCapsExceptions: TdxSpellCheckerAutoCorrectExceptions
      read FInitialCapsExceptions;
    property Replacements: TdxSpellCheckerAutoCorrectReplacementList
      read FReplacements;
  published
    property Active: Boolean read FActive write SetActive default False;
    property AutomaticallyUseSuggestions: Boolean
      read FAutomaticallyUseSuggestions write SetAutomaticallyUseSuggestions
      default True;
    property CorrectCapsLock: Boolean read FCorrectCapsLock
      write SetCorrectCapsLock default True;
    property CorrectInitialCaps: Boolean read FCorrectInitialCaps
      write SetCorrectInitialCaps default True;
    property CorrectSentenceCaps: Boolean read FCorrectSentenceCaps
      write SetCorrectSentenceCaps default True;
    property DisableCapsLock: Boolean read FDisableCapsLock
      write SetDisableCapsLock default False;
    property ReplaceTextAsYouType: Boolean read FReplaceTextAsYouType
      write SetReplaceTextAsYouType default True;
  end;
  ...
  IdxSpellingErrorInfo = interface
    ...
    property WordStartPosition: IdxSpellCheckerPosition
      read GetWordStartPosition;
  end;

  { IdxSpellChecker3 }

  IdxSpellChecker3CheckCallbackProc = reference to function
    (AErrorInfo: IdxSpellingErrorInfo): Boolean;
  ...
  IdxSpellChecker3 = interface
    ...
    procedure Ignore(AControl: TControl; const AWord: string;
      const AStart, AEnd: IdxSpellCheckerPosition);
    ...
    property AutoCorrectOptions: TdxSpellCheckerCustomAutoCorrectOptions
      read GetAutoCorrectOptions;
    property CheckAsYouTypeOptions: TdxSpellCheckerCustomCheckAsYouTypeOptions
      read GetCheckAsYouTypeOptions;
  end;
  ...
  TdxSpellCheckerCreateAdapterProc = function(AObject: TObject)
    : IdxSpellCheckerAdapter of object;

  TdxSpellCheckerAdapters = class
  strict private
    class var FAdapters: TDictionary<TClass, TdxSpellCheckerCreateAdapterProc>;

    class function FindAdapter(AObject: TObject;
      out AProc: TdxSpellCheckerCreateAdapterProc): Boolean;
  public
    class function CreateAdapter(AObject: TObject;
...
function dxSpellCheckerContextPopupHook(ASender: TObject; APopup: TComponent;
  const P: TPoint): Boolean;
begin
  Result := Assigned(TdxSpellCheckerInstance.ISpellChecker) and
    TdxSpellCheckerInstance.ISpellChecker.QueryPopup(APopup, P);
end;

{ TdxSpellCheckerAutoCorrectWordRange }

class operator TdxSpellCheckerAutoCorrectWordRange.Equal(const R1,
  R2: TdxSpellCheckerAutoCorrectWordRange): Boolean;
begin
  Result := (R1.Replacement = R2.Replacement) and (R1.SelStart = R2.SelStart)
    and (R1.SelLength = R2.SelLength) and (R1.NewSelStart = R2.NewSelStart);
end;

class operator TdxSpellCheckerAutoCorrectWordRange.NotEqual(const R1,
  R2: TdxSpellCheckerAutoCorrectWordRange): Boolean;
begin
  Result := not(R1 = R2);
end;
...
class function TdxSpellCheckerAutoCorrectWordInfo.Create(const AWordRange
  : TdxSpellCheckerAutoCorrectWordRange;
  const ATextController: IdxSpellCheckTextController)
  : TdxSpellCheckerAutoCorrectWordInfo;
begin
  ...
  Result.WordPositionFinish := ATextController.CreatePosition
    (AWordRange.SelStart + AWordRange.SelLength);
  Result.WordPositionStart := ATextController.CreatePosition
    (AWordRange.SelStart);
...
class function TdxSpellCheckerPosition<T>.Compare(const APosition1,
  APosition2: IdxSpellCheckerPosition): Integer;
begin
  if APosition1 <> nil then
    Exit(APosition1.Compare(APosition2))
  else if APosition2 <> nil then
    Exit(-APosition2.Compare(APosition1))
  else
    Exit(0);
end;

class function TdxSpellCheckerPosition<T>.IsGreater(const APosition1,
  APosition2: IdxSpellCheckerPosition): Boolean;
begin
  Result := Compare(APosition1, APosition2) > 0;
end;

class function TdxSpellCheckerPosition<T>.IsGreaterOrEqual(const APosition1,
  APosition2: IdxSpellCheckerPosition): Boolean;
begin
  Result := IsGreater(APosition1, APosition2) or
    (Compare(APosition1, APosition2) = 0);
end;

class function TdxSpellCheckerPosition<T>.IsLess(const APosition1,
  APosition2: IdxSpellCheckerPosition): Boolean;
begin
  Result := Compare(APosition1, APosition2) < 0;
end;

class function TdxSpellCheckerPosition<T>.IsLessOrEqual(const APosition1,
  APosition2: IdxSpellCheckerPosition): Boolean;
begin
  Result := IsLess(APosition1, APosition2) or
    (Compare(APosition1, APosition2) = 0);
end;
...
begin
  if Self = AObj then
    Exit(True);
  Result := Supports(AObj, IdxSpellCheckerPosition, APosition) and
    (Compare(Self, APosition) = 0);
end;
...
function TdxSpellCheckerAutoCorrectWordInfo.ToWordRange
  : TdxSpellCheckerAutoCorrectWordRange;
begin
...
function TdxSpellCheckerIntegerPosition.Add(APosition: IdxSpellCheckerPosition)
  : IdxSpellCheckerPosition;
begin
...
function TdxSpellCheckerIntegerPosition.Subtract
  (APosition: IdxSpellCheckerPosition): IdxSpellCheckerPosition;
begin
  Result := TdxSpellCheckerIntegerPosition.Create
    (ActualPosition - APosition.ToInteger);
end;
...
procedure TdxSpellCheckerIntegerPosition.SetActualPosition
  (const Value: Integer);
begin
  FValue := Value;
end;

function TdxSpellCheckerIntegerPosition.Compare
  (APosition: IdxSpellCheckerPosition): Integer;
begin
...
function TdxSpellCheckCustomSimpleTextController.GetWord(const AStart,
...
function TdxSpellCheckCustomSimpleTextController.IsRangeEditable(const AStart,
  AFinish: IdxSpellCheckerPosition): Boolean;
begin
  Result := True;
end;

procedure TdxSpellCheckCustomSimpleTextController.SetSpellingArea(const AStart,
  AFinish: IdxSpellCheckerPosition);
begin
  FSpellingAreaStart := Max(0, DecodePosition(AStart));
  FSpellingAreaFinish := Min(Max(FSpellingAreaStart, DecodePosition(AFinish)),
    Length(FText));
end;

function TdxSpellCheckCustomSimpleTextController.CreatePosition(AValue: Integer)
  : IdxSpellCheckerPosition;
begin
  Result := TdxSpellCheckerIntegerPosition.Create(AValue);
end;

function TdxSpellCheckCustomSimpleTextController.DecodePosition
  (const AValue: IdxSpellCheckerPosition): Integer;
begin
  if AValue <> nil then
...
function TdxSpellCheckCustomSimpleTextController.DecodePositions(const AStart,
  AFinish: IdxSpellCheckerPosition; var AIndex, ACount: Integer): Boolean;
var
  S, F: Integer;
begin
...
function TdxSpellCheckCustomSimpleTextController.EncodePosition
  (const AValue: Integer): IdxSpellCheckerPosition;
begin
...
constructor TdxSpellCheckerReplacement.Create(const AText,
  AReplacement: string);
begin
  inherited Create;
  FText := AText;
...
constructor TdxSpellCheckerReplacementList.Create(AllowDuplicates
  : Boolean = False);
begin
  inherited Create;
  Capacity := 256;
...
function TdxSpellCheckerReplacementList.FindReplacement(const AText: string)
  : TdxSpellCheckerReplacement;
var
  L, H, I, C: Integer;
begin
...
function TdxSpellCheckerReplacementList.GetItem(Index: Integer)
  : TdxSpellCheckerReplacement;
begin
...
procedure TdxSpellCheckerCustomOptions.AddChangedHandler
  (AHandler: TNotifyEvent);
begin
  FOnChanged.Add(AHandler);
end;

procedure TdxSpellCheckerCustomOptions.RemoveChangedHandler
  (AHandler: TNotifyEvent);
begin
...
procedure TdxSpellCheckerCustomCheckAsYouTypeOptions.DoAssign
  (Source: TPersistent);
begin
  if Source is TdxSpellCheckerCustomCheckAsYouTypeOptions then
  begin
    FSuggestionCount := TdxSpellCheckerCustomCheckAsYouTypeOptions(Source)
      .FSuggestionCount;
    FUnderlineColor := TdxSpellCheckerCustomCheckAsYouTypeOptions(Source)
      .FUnderlineColor;
    FUnderlineStyle := TdxSpellCheckerCustomCheckAsYouTypeOptions(Source)
      .FUnderlineStyle;
    FPopupMenuItems := TdxSpellCheckerCustomCheckAsYouTypeOptions(Source)
      .PopupMenuItems;
    Changed;
  end;
end;
...
procedure TdxSpellCheckerCustomCheckAsYouTypeOptions.SetPopupMenuItems
  (AValue: TdxSpellCheckerPopupMenuItems);
begin
...
procedure TdxSpellCheckerCustomCheckAsYouTypeOptions.SetSuggestionCount
  (AValue: Integer);
begin
...
procedure TdxSpellCheckerCustomCheckAsYouTypeOptions.SetUnderlineColor
  (AValue: TColor);
begin
...
procedure TdxSpellCheckerCustomCheckAsYouTypeOptions.SetUnderlineStyle
...
procedure TdxSpellCheckerAutoCorrectReplacementList.LoadFromFile
...
procedure TdxSpellCheckerAutoCorrectReplacementList.LoadFromStream
  (AStream: TStream);
var
  ...
  try
    ...
    if ADocument.FindChild('block-list:block-list', ARootNode) then
      ...
      begin
        ...
        Add(ANode.Attributes.GetValueAsString('block-list:abbreviated-name'),
...
procedure TdxSpellCheckerAutoCorrectReplacementList.SaveToFile
  (const AFileName: string);
var
  AStream: TStream;
begin
...
procedure TdxSpellCheckerAutoCorrectReplacementList.SaveToStream
  (AStream: TStream);
var
  ADocument: TdxXMLDocument;
  ANode, ARootNode: TdxXMLNode;
...
begin
  ...
  try
    ...
    ARootNode.Attributes.SetValue('xmlns:block-list',
      'http://www.devexpress.com');
    for I := 0 to Count - 1 do
    begin
      ANode := ARootNode.AddChild('block-list:block');
      ANode.Attributes.SetValueAsString('block-list:abbreviated-name',
        Items[I].Text);
      ANode.Attributes.SetValueAsString('block-list:name',
        Items[I].Replacement);
    end;
...
constructor TdxSpellCheckerAutoCorrectExceptions.Create
...
function TdxSpellCheckerAutoCorrectExceptions.Add(const AException
  : string): Integer;
var
  ALen: Integer;
  S: string;
...
var
  I: Integer;
begin
  if (AIndex < 0) or (AIndex >= Count) or (FList[AIndex] = nil) or
    not DoDelete(FList[AIndex]) then
    Exit;
...
function TdxSpellCheckerAutoCorrectExceptions.Find(const AException
  : string): Integer;
var
  I: Integer;
begin
...
procedure TdxSpellCheckerAutoCorrectExceptions.LoadFromFile
  (const AFileName: string);
var
  AStream: TStream;
begin
...
begin
  ...
  try
    ...
    begin
      for I := 0 to ARootNode.Count - 1 do
        Add(ARootNode.Items[I].Attributes.GetValueAsString
...
procedure TdxSpellCheckerAutoCorrectExceptions.PopulateExceptions
  (AList: TStrings);
var
  I: Integer;
begin
...
procedure TdxSpellCheckerAutoCorrectExceptions.SaveToFile
  (const AFileName: string);
var
  AStream: TStream;
begin
...
begin
  ...
  try
    ...
    ARootNode.Attributes.SetValue('xmlns:block-list',
      'http://www.devexpress.com');
    for I := 0 to Count - 1 do
      ARootNode.AddChild('block-list:block').Attributes.SetValueAsString
        ('block-list:abbreviated-name', Exceptions[I]);
    ADocument.SaveToStream(AStream);
  finally
    ADocument.Free;
  end;
...
procedure TdxSpellCheckerAutoCorrectExceptions.DisposeException
  (AException: PWideChar);
begin
  if AException <> nil then
    FreeMem(AException, PCardinal(AException)^);
end;

function TdxSpellCheckerAutoCorrectExceptions.DoAdd(var AException
  : string): Boolean;
var
  S: WideString;
begin
...
function TdxSpellCheckerAutoCorrectExceptions.DoDelete(const AException
  : string): Boolean;
begin
  Result := True;
...
procedure TdxSpellCheckerCustomAutoCorrectOptions.SetActive
...
procedure TdxSpellCheckerCustomAutoCorrectOptions.SetAutomaticallyUseSuggestions
  (const AValue: Boolean);
begin
...
procedure TdxSpellCheckerCustomAutoCorrectOptions.SetCorrectCapsLock
  (const AValue: Boolean);
begin
...
procedure TdxSpellCheckerCustomAutoCorrectOptions.SetCorrectInitialCaps
  (const AValue: Boolean);
begin
...
procedure TdxSpellCheckerCustomAutoCorrectOptions.SetCorrectSentenceCaps
  (const AValue: Boolean);
begin
...
procedure TdxSpellCheckerCustomAutoCorrectOptions.SetDisableCapsLock
  (const AValue: Boolean);
begin
...
procedure TdxSpellCheckerCustomAutoCorrectOptions.SetReplaceTextAsYouType
  (const AValue: Boolean);
begin
...
class procedure TdxSpellCheckerInstance.RegisterListener
...
class procedure TdxSpellCheckerInstance.UnregisterListener
  (AListener: TNotifyEvent);
begin
  if FListeners <> nil then
  begin
...
class function TdxSpellCheckerAdapters.CreateAdapter(AObject: TObject;
  out AAdapter: IdxSpellCheckerAdapter): Boolean;
var
  AProc: TdxSpellCheckerCreateAdapterProc;
begin
...
class function TdxSpellCheckerAdapters.IsSupported
...
begin
  Result := Assigned(AControl) and AControl.HandleAllocated and
    FindAdapter(AControl, AProc);
  if Result then
  begin
    if Supports(GetInnerControlContainer(AControl), IdxSpellCheckerControl,
      AIntf) then
      Result := AIntf.SupportsSpelling;
  end;
end;

class procedure TdxSpellCheckerAdapters.Register(AClass: TClass;
  AProc: TdxSpellCheckerCreateAdapterProc);
begin
...
class function TdxSpellCheckerAdapters.FindAdapter(AObject: TObject;
  out AProc: TdxSpellCheckerCreateAdapterProc): Boolean;
var
  AClassType: TClass;
begin
