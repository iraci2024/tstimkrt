...
type
  ...
  TcxValueDefDataType = (dtEmpty, dtNull, dtValue, dtError);
  ...
  protected
    ...
    class procedure ReadDataValue(ABuffer: PAnsiChar;
      AStream: TdxStream); virtual;
    class procedure ReadDisplayText(ABuffer: PAnsiChar;
      AStream: TdxStream); virtual;
    class procedure SetDataValue(ABuffer: PAnsiChar;
      const Value: Variant); virtual;
    class procedure SetDisplayText(ABuffer: PAnsiChar;
      const DisplayText: string); virtual;
    class procedure WriteDataValue(ABuffer: PAnsiChar;
      AStream: TdxStream); virtual;
    class procedure WriteDisplayText(ABuffer: PAnsiChar;
      AStream: TdxStream); virtual;
  public
...
{$ENDIF}
  ...
  public
    constructor Create(AValueDefs: TcxValueDefs;
      AValueTypeClass: TcxValueTypeClass); virtual;
    destructor Destroy; override;
    procedure Assign(ASource: TcxValueDef); virtual;
    function CompareValues(AIsNull1, AIsNull2: Boolean;
      P1, P2: PAnsiChar): Integer;
    ...
    property StreamStored: Boolean read FStreamStored write FStreamStored
      default True;
  ...
  public
    ...
    destructor Destroy; override;
    function Add(AValueTypeClass: TcxValueTypeClass;
      AStored, ATextStored: Boolean; ALinkObject: TObject): TcxValueDef;
    procedure Clear;
  ...
  TcxValueDefSetProc = procedure(AValueDef: TcxValueDef;
  ...
  protected
    ...
    procedure ChangeRecordFlag(ABuffer: PAnsiChar; AFlag: Byte;
      ATurnOn: Boolean);
    ...
    function CheckValueDef(ARecordIndex: Integer;
      var AValueDef: TcxValueDef): Boolean;
    ...
    procedure ValueDefsChanged(AValueDef: TcxValueDef;
      AResyncNeeded: Boolean); virtual;
  ...
  public
    ...
    procedure EndLoad;
    function GetDisplayText(ARecordIndex: Integer;
      AValueDef: TcxValueDef): string;
    function GetCompareInfo(ARecordIndex: Integer; AValueDef: TcxValueDef;
      var P: PAnsiChar): Boolean;
    function GetErrorCode(ARecordIndex: Integer;
      AValueDef: TcxValueDef): Integer;
    ...
    function IsValueEmpty(ARecordIndex: Integer;
      AValueDef: TcxValueDef): Boolean;
    procedure ReadData(ARecordIndex: Integer; AStream: TStream);
    procedure ReadDataByFields(ARecordIndex: Integer;
      AValueDefReader: TcxValueDefReader; AFields: TList);
    procedure ReadRecord(ARecordIndex: Integer;
      AValueDefReader: TcxValueDefReader);
    procedure ReadRecordFrom(AFromRecordIndex, AToRecordIndex: Integer;
      AValueDefReader: TcxValueDefReader; ASetProc: TcxValueDefSetProc);
    procedure SetDisplayText(ARecordIndex: Integer; AValueDef: TcxValueDef;
      const Value: string);
    procedure SetErrorCode(ARecordIndex: Integer; AValueDef: TcxValueDef;
      ACode: Integer);
    procedure SetRecordID(ARecordIndex, AID: Integer);
    procedure SetValue(ARecordIndex: Integer; AValueDef: TcxValueDef;
      const Value: Variant);
    ...
    property StoredValuesOnly: Boolean read FStoredValuesOnly
      write SetStoredValuesOnly;
    property UseRecordID: Boolean read FUseRecordID write SetUseRecordID;
    property RecordBuffers[Index: Integer]: PAnsiChar read GetRecordBuffer
      write SetRecordBuffer;
    property RecordCount: Integer read GetRecordCount write SetRecordCount;
    property ValueDefs: TcxValueDefs read FValueDefs;
    property OnClearInternalRecords: TNotifyEvent read FOnClearInternalRecords
      write FOnClearInternalRecords;
  end;

  TcxDataStorageHelper = class
  public
    class function AllocateRecord(ADataStorage: TcxDataStorage): Pointer;
    class function AppendRecord(ADataStorage: TcxDataStorage;
      ARecord: Pointer): Integer;
    class procedure ClearValue(ARecord: Pointer; AValueDef: TcxValueDef);
    class function Compare(AValueDef: TcxValueDef;
      ARecord1, ARecord2: Pointer): Integer;
    class procedure FreeBuffer(AValueDef: TcxValueDef; ARecord: Pointer);
    class function GetDisplayText(AValueDef: TcxValueDef;
      ARecord: Pointer): string;
    class function GetErrorCode(AValueDef: TcxValueDef;
      ARecord: Pointer): Variant;
    ...
    class function IsValueEmpty(AValueDef: TcxValueDef;
      ARecord: Pointer): Boolean;
    class function RemoveRecord(ADataStorage: TcxDataStorage;
      ARecordIndex: Integer): Pointer;
    class procedure SetDisplayText(ARecord: Pointer; AValueDef: TcxValueDef;
      const AValue: string);
    class procedure SetErrorCode(ARecord: Pointer; AValueDef: TcxValueDef;
      ACode: Variant);
    class procedure SetRecordsCapacity(ADataStorage: TcxDataStorage;
      ACapacity: Integer);
    class procedure SetTextStored(AValueDef: TcxValueDef; ATextStored: Boolean);
    class procedure SetValue(ARecord: Pointer; AValueDef: TcxValueDef;
      const AValue: Variant);
    class procedure FreeRecord(ADataStorage: TcxDataStorage;
      var ARecord: Pointer);
  end;
  ...
  public
    ...
    procedure Insert(AIndex: Integer; const AKeyValue: Variant;
...
class procedure TcxValueType.ReadDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
  SetDataValue(ABuffer, ReadVariantFunc(AStream));
end;

class procedure TcxValueType.ReadDisplayText(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
...
class procedure TcxValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
begin
end;

class procedure TcxValueType.SetDisplayText(ABuffer: PAnsiChar;
...
class procedure TcxValueType.WriteDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
  WriteVariantProc(AStream, GetDataValue(ABuffer));
end;

class procedure TcxValueType.WriteDisplayText(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
  if AStream.IsUnicode then
...
class procedure TcxStringValueType.ReadDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
  if AStream.IsUnicode then
...
class procedure TcxStringValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
begin
...
class procedure TcxStringValueType.WriteDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
  if AStream.IsUnicode then
    WriteWideStringProc(AStream, GetDisplayText(ABuffer))
...
class procedure TcxWideStringValueType.PrepareValueBuffer
  (var ABuffer: PAnsiChar);
begin
  ABuffer := PPointer(ABuffer)^;
end;
...
class procedure TcxWideStringValueType.ReadDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
  SetDataValue(ABuffer, ReadWideStringFunc(AStream));
end;

class procedure TcxWideStringValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
var
  P: PcxWideStringValue;
  W: WideString;
...
class procedure TcxWideStringValueType.WriteDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
...
class procedure TcxSmallintValueType.ReadDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
  SetDataValue(ABuffer, ReadSmallIntFunc(AStream));
end;

class procedure TcxSmallintValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
begin
  PSmallInt(ABuffer)^ := Value;
end;

class procedure TcxSmallintValueType.WriteDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
...
class procedure TcxIntegerValueType.ReadDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
  SetDataValue(ABuffer, ReadIntegerFunc(AStream));
end;

class procedure TcxIntegerValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
begin
  PInteger(ABuffer)^ := Value;
end;

class procedure TcxIntegerValueType.WriteDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
...
class procedure TcxWordValueType.ReadDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
  SetDataValue(ABuffer, ReadWordFunc(AStream));
end;

class procedure TcxWordValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
begin
  PWord(ABuffer)^ := Value;
end;

class procedure TcxWordValueType.WriteDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
...
class function TcxBooleanValueType.GetDefaultDisplayText
  (ABuffer: PAnsiChar): string;
begin
  try
...
class procedure TcxBooleanValueType.ReadDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
  SetDataValue(ABuffer, ReadBooleanFunc(AStream));
end;

class procedure TcxBooleanValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
begin
  PBoolean(ABuffer)^ := Value;
end;

class procedure TcxBooleanValueType.WriteDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
...
class procedure TcxSingleValueType.ReadDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
var
  E: Single;
begin
...
class procedure TcxSingleValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
begin
  PSingle(ABuffer)^ := Value;
end;

class procedure TcxSingleValueType.WriteDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
...
class procedure TcxFloatValueType.ReadDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
var
  E: Extended;
begin
...
class procedure TcxFloatValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
begin
  PDouble(ABuffer)^ := Value;
end;

class procedure TcxFloatValueType.WriteDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
...
class procedure TcxCurrencyValueType.ReadDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
  SetDataValue(ABuffer, ReadCurrencyFunc(AStream));
end;

class procedure TcxCurrencyValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
begin
  PCurrency(ABuffer)^ := Value;
end;

class procedure TcxCurrencyValueType.WriteDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
...
class function TcxDateTimeValueType.GetDefaultDisplayText
  (ABuffer: PAnsiChar): string;
var
  DT: TDateTime;
begin
...
class procedure TcxDateTimeValueType.ReadDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
  SetDataValue(ABuffer, ReadDateTimeFunc(AStream));
end;

class procedure TcxDateTimeValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
begin
  PDateTime(ABuffer)^ := VarToDateTime(Value);
end;

class procedure TcxDateTimeValueType.WriteDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
...
class procedure TcxLargeIntValueType.ReadDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
  SetDataValue(ABuffer, ReadLargeIntFunc(AStream));
end;

class procedure TcxLargeIntValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
begin
  PLargeInt(ABuffer)^ := Value;
end;

class procedure TcxLargeIntValueType.WriteDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
...
class function TcxFMTBcdValueType.GetDefaultDisplayText
  (ABuffer: PAnsiChar): string;
var
  Bcd: TBcd;
begin
  Bcd := PBcd(ABuffer)^;
{$IFDEF DELPHI16}
  Result := BcdToStrF(Bcd, ffGeneral, Bcd.Precision, Bcd.SignSpecialPlaces);
  // P, D - must be used in XE2
{$ELSE}
  Result := BcdToStrF(Bcd, ffGeneral, 0, 0); // P, D - ignored in BcdToStrF
{$ENDIF}
end;

class procedure TcxFMTBcdValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
begin
...
class function TcxSQLTimeStampValueType.GetDataValue
  (ABuffer: PAnsiChar): Variant;
begin
  Result := SQLTimeStampToDateTime(PSQLTimeStamp(ABuffer)^);
end;

class procedure TcxSQLTimeStampValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
begin
...
class procedure TcxVariantValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
var
  P: PVariant;
begin
...
class procedure TcxBLOBValueType.ReadDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
  SetDataValue(ABuffer, ReadAnsiStringFunc(AStream));
end;

class procedure TcxBLOBValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
var
  P: PAnsiString;
begin
...
class procedure TcxBLOBValueType.WriteDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
...
class procedure TcxObjectValueType.ReadDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
  // not supported
end;

class procedure TcxObjectValueType.SetDataValue(ABuffer: PAnsiChar;
  const Value: Variant);
begin
...
class procedure TcxObjectValueType.WriteDataValue(ABuffer: PAnsiChar;
  AStream: TdxStream);
begin
  // not supported
end;
...
constructor TcxValueDef.Create(AValueDefs: TcxValueDefs;
...
function TcxValueDef.CompareValues(AIsNull1, AIsNull2: Boolean;
  P1, P2: PAnsiChar): Integer;
begin
  if AIsNull1 then
  begin
...
begin
  ...
  else if IsNullValueEx(P2) then
    Result := 1
  else
    Result := ValueTypeClass.Compare(GetDataFromBuffer(P1),
      GetDataFromBuffer(P2));
end;
...
begin
  ...
  else if GetDataType(ABuffer) = dtValue then
...
begin
  Result := (ABuffer = nil) or (GetDataType(ABuffer) in [dtEmpty, dtNull,
    dtError]);
end;
...
procedure TcxValueDef.SetDisplayText(ABuffer: PAnsiChar;
  const DisplayText: string);
begin
  if TextStored then
    ValueTypeClass.SetDisplayText(GetDisplayTextFromBuffer(ABuffer),
      DisplayText);
end;
...
function TcxValueDefs.Add(AValueTypeClass: TcxValueTypeClass;
  AStored, ATextStored: Boolean; ALinkObject: TObject): TcxValueDef;
var
  I: Integer;
begin
...
function TcxInternalValueDefs.FindByLinkObject(ALinkObject: TObject)
  : TcxValueDef;
var
  I: Integer;
begin
...
procedure TcxValueDefReader.ClearValue(ABuffer: PAnsiChar;
...
procedure TcxDataStorage.ClearValue(ARecordIndex: Integer;
  AValueDef: TcxValueDef);
var
  ABuffer: PAnsiChar;
begin
...
function TcxDataStorage.GetDisplayText(ARecordIndex: Integer;
  AValueDef: TcxValueDef): string;
var
  P: PAnsiChar;
begin
...
function TcxDataStorage.GetCompareInfo(ARecordIndex: Integer;
  AValueDef: TcxValueDef; var P: PAnsiChar): Boolean;
begin
  P := RecordBuffers[ARecordIndex];
...
function TcxDataStorage.GetErrorCode(ARecordIndex: Integer;
  AValueDef: TcxValueDef): Integer;
var
  P: PAnsiChar;
begin
...
function TcxDataStorage.GetValue(ARecordIndex: Integer;
...
function TcxDataStorage.IsValueEmpty(ARecordIndex: Integer;
  AValueDef: TcxValueDef): Boolean;
var
  ABuffer: PAnsiChar;
begin
  ABuffer := RecordBuffers[ARecordIndex];
  Result := (ABuffer = nil) or not CheckValueDef(ARecordIndex, AValueDef) or
    (AValueDef.GetDataType(ABuffer) = dtEmpty);
end;
...
procedure TcxDataStorage.ReadDataByFields(ARecordIndex: Integer;
  AValueDefReader: TcxValueDefReader; AFields: TList);
var
  P: PAnsiChar;
  I: Integer;
...
procedure TcxDataStorage.ReadRecord(ARecordIndex: Integer;
  AValueDefReader: TcxValueDefReader);
var
  P: PAnsiChar;
  I: Integer;
...
procedure TcxDataStorage.ReadRecordFrom(AFromRecordIndex, AToRecordIndex
  : Integer; AValueDefReader: TcxValueDefReader; ASetProc: TcxValueDefSetProc);
var
  I: Integer;
  AValueDefs: TcxValueDefs;
begin
  ...
  for I := 0 to AValueDefs.Count - 1 do
    if not AValueDefReader.IsInternal(ValueDefs[I]) then
      ASetProc(AValueDefs[I], AFromRecordIndex, AToRecordIndex,
        AValueDefReader);
end;

procedure TcxDataStorage.SetDisplayText(ARecordIndex: Integer;
  AValueDef: TcxValueDef; const Value: string);
var
  P: PAnsiChar;
begin
  P := AllocRecordBuffer(ARecordIndex);
...
procedure TcxDataStorage.SetErrorCode(ARecordIndex: Integer;
  AValueDef: TcxValueDef; ACode: Integer);
var
  P: PAnsiChar;
begin
  P := AllocRecordBuffer(ARecordIndex);
...
procedure TcxDataStorage.ChangeRecordFlag(ABuffer: PAnsiChar; AFlag: Byte;
  ATurnOn: Boolean);
begin
  if ABuffer <> nil then
    if ATurnOn then
...
begin
  if FRecordBuffers.Count = 0 then
    FRecordIDCounter := 1; // TODO: reset
end;
...
function TcxDataStorage.CheckValueDef(ARecordIndex: Integer;
  var AValueDef: TcxValueDef): Boolean;
begin
...
procedure TcxDataStorage.InsertValueDef(AIndex: Integer;
  AValueDef: TcxValueDef);
var
...
begin
  ...
  begin
    InternalValueDefs.Add(AValueDef.ValueTypeClass, True, AValueDef.FTextStored,
      AValueDef);
    AStartIndex := 0;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        System.Move(PSource^, PDest^, AValueDefs.RecordSize -
          (PSource - ABuffer));
      end
      else
      begin
        ...
        if AValueDefs.Count > 0 then
          Inc(PSource, AValueDefs[AValueDefs.Count - 1].Offset + AValueDefs
            [AValueDefs.Count - 1].BufferSize)
        else
    ...
    if ABuffer <> nil then
      ...
      begin
        ...
        System.Move(PSource^, PDest^, AValueDefs.RecordSize -
          (PSource - ABuffer));
        ReallocMem(ABuffer, AValueDefs.RecordSize - AValueDef.BufferSize);
        // existing data in the block is not affected!
        RecordBuffers[I] := ABuffer;
      end;
  end;
end;

procedure TcxDataStorage.ValueDefsChanged(AValueDef: TcxValueDef;
  AResyncNeeded: Boolean);
// var
...
class function TcxDataStorageHelper.AllocateRecord(ADataStorage
  : TcxDataStorage): Pointer;
begin
  Result := AllocMem(ADataStorage.FValueDefs.RecordSize);
end;

class function TcxDataStorageHelper.AppendRecord(ADataStorage: TcxDataStorage;
  ARecord: Pointer): Integer;
begin
  Result := ADataStorage.FRecordBuffers.Add(ARecord);
end;

class procedure TcxDataStorageHelper.ClearValue(ARecord: Pointer;
  AValueDef: TcxValueDef);
begin
...
class function TcxDataStorageHelper.Compare(AValueDef: TcxValueDef;
  ARecord1, ARecord2: Pointer): Integer;
begin
  if AValueDef <> nil then
...
class procedure TcxDataStorageHelper.FreeBuffer(AValueDef: TcxValueDef;
  ARecord: Pointer);
begin
  if AValueDef <> nil then
...
class function TcxDataStorageHelper.GetDisplayText(AValueDef: TcxValueDef;
  ARecord: Pointer): string;
begin
  if AValueDef <> nil then
...
class function TcxDataStorageHelper.GetErrorCode(AValueDef: TcxValueDef;
  ARecord: Pointer): Variant;
begin
  if AValueDef <> nil then
...
class function TcxDataStorageHelper.GetRecordSize(ADataStorage
  : TcxDataStorage): Integer;
begin
  Result := ADataStorage.ValueDefs.RecordSize;
end;

class function TcxDataStorageHelper.GetStoredCount(ADataStorage
  : TcxDataStorage): Integer;
begin
  Result := ADataStorage.ValueDefs.StoredCount;
end;

class function TcxDataStorageHelper.GetValue(AValueDef: TcxValueDef;
  ARecord: Pointer): Variant;
begin
...
class function TcxDataStorageHelper.IsValueEmpty(AValueDef: TcxValueDef;
  ARecord: Pointer): Boolean;
begin
  if AValueDef <> nil then
...
class function TcxDataStorageHelper.RemoveRecord(ADataStorage: TcxDataStorage;
  ARecordIndex: Integer): Pointer;
begin
...
class procedure TcxDataStorageHelper.SetDisplayText(ARecord: Pointer;
  AValueDef: TcxValueDef; const AValue: string);
begin
  if AValueDef <> nil then
    AValueDef.SetDisplayText(ARecord, AValue);
end;

class procedure TcxDataStorageHelper.SetErrorCode(ARecord: Pointer;
  AValueDef: TcxValueDef; ACode: Variant);
begin
  if AValueDef <> nil then
...
class procedure TcxDataStorageHelper.SetTextStored(AValueDef: TcxValueDef;
  ATextStored: Boolean);
begin
...
class procedure TcxDataStorageHelper.FreeRecord(ADataStorage: TcxDataStorage;
  var ARecord: Pointer);
var
  I: Integer;
  P: Pointer;
...
function TcxLookupList.Find(const AKeyValue: Variant;
...
function TcxValueTypeClassList.ItemByCaption(const ACaption: string)
  : TcxValueTypeClass;
var
  I: Integer;
begin
...
procedure TcxValueTypeClassList.RegisterItem(AValueTypeClass
  : TcxValueTypeClass);
begin
...
procedure TcxValueTypeClassList.UnregisterItem(AValueTypeClass
  : TcxValueTypeClass);
begin
