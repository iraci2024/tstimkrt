...
{$IFNDEF NONDB}
  RegisterComponents(dxCoreLibraryProductPage, [TdxServerModeDBXDataSource,
    TdxServerModeDBXQueryDataSource]);
  RegisterPropertyEditor(TypeInfo(string), TdxServerModeDBXDataSourceOptions,
    'SchemaName', TdxServerModeSchemaNameProperty);
{$ENDIF}
end;
