...
type
  ...
  public
    ...
    property DlgFolderLabelCaption: string read GetFolderCaption
      write SetFolderCaption;
...
begin
  ...
  liCurrentFolder.CaptionOptions.Text :=
    cxGetResourceString(@scxShellBrowserDlgCurrentFolderCaption);
  DoubleBuffered := True;
  FWindowProcObject := cxWindowProcController.Add(dxLayoutControl1,
    LayoutWndProc);
end;
