...
{$ENDIF}
  ...
  dxCore, dxCoreGraphics, cxVariants, cxClasses, cxControls, cxGraphics,
  dxGalleryControl,
...
type
  ...
  TdxColorSet = (csDefault, csTheme1, csTheme2, csTheme3, csTheme4, csTheme5,
    csCustom);
  TdxColorAccent = (caLight80, caLight60, caLight50, caLight40, caLight35,
    caLight25, caLight15, caLight5, caDark5, caDark10, caDark15, caDark25,
    caDark35, caDark50, caDark75, caDark90);
  TdxColorAccentArray = array [0 .. dxcColorAccentCount - 1] of TdxColorAccent;
  TdxColorGetCustomColorSetEvent = procedure(Sender: TObject; var ASet: TColors)
    of object;
  ...
  private
    ...
    procedure InternalSetEditValue(AValue: Variant;
      ANeedSynchronizeSelectedItems: Boolean);
    ...
    procedure AddColorItem(AGroup: TdxGalleryGroup; AColor: TColor;
      ASize: Integer; ABorders: TcxBorders = cxBordersAll);
  ...
  protected
    ...
    procedure SetColorParams(AColorPalette: TdxColorPalette;
      AColorSet: TdxColorSet; AItemSize: Integer);

    property ColorPalette: TdxColorPalette read FColorPalette
    ...
    property ShowItemBorders: Boolean read FShowItemBorders
      write SetShowItemBorders;

    property OnChange: TNotifyEvent read FOnChange write FOnChange;
    property OnGetCustomColorSet: TdxColorGetCustomColorSetEvent
      read FOnGetCustomColorSet write FOnGetCustomColorSet;
  public
...
uses
  Controls, dxOffice11, Variants, cxEditConsts, Math, cxGeometry,
  dxDPIAwareUtils;
...
procedure TdxColorGalleryPainter.DrawItemSelection(ACanvas: TcxCustomCanvas;
  AViewInfo: TdxGalleryItemViewInfo);
begin
  LookAndFeelPainter.DrawColorGalleryItemSelection(ACanvas, AViewInfo.GlyphRect,
    AViewInfo.State);
end;
...
procedure TdxCustomColorGallery.ChangeScaleEx(M, D: Integer;
  isDpiChange: Boolean);
begin
  inherited;
...
procedure TdxCustomColorGallery.LookAndFeelChanged(Sender: TcxLookAndFeel;
...
procedure TdxCustomColorGallery.SetColorParams(AColorPalette: TdxColorPalette;
  AColorSet: TdxColorSet; AItemSize: Integer);
begin
  if (FColorPalette <> AColorPalette) or (FColorSet <> AColorSet) or
    (FItemSize <> AItemSize) then
  begin
...
procedure TdxCustomColorGallery.InternalSetEditValue(AValue: Variant;
  ANeedSynchronizeSelectedItems: Boolean);
begin
...
function TdxCustomColorGallery.AddColorGroup(const ACaption: string)
  : TdxGalleryGroup;
begin
  Result := TdxGalleryGroup(TcxComponentCollectionAccess(Gallery.Groups)
    .AddInternalItem);
  Result.Caption := ACaption;
end;

procedure TdxCustomColorGallery.AddColorItem(AGroup: TdxGalleryGroup;
  AColor: TColor; ASize: Integer; ABorders: TcxBorders);
var
  AItem: TdxGalleryItem;
  ABitmap: TcxBitmap32;
begin
  AItem := TdxGalleryItem(TcxComponentCollectionAccess(AGroup.Items)
    .AddInternalItem);
...
const
  ExtendedColorMap: array [0 .. 39] of TColor = ($000000, $003399, $003333,
    $003300, $336600, $800000, $993333, $333333, $000080, $0066FF, $008080,
    $008000, $808000, $FF0000, $996666, $808080, $0000FF, $0099FF, $00CC99,
    $669933, $CCCC33, $FF6633, $800080, $999999, $FF00FF, $00CCFF, $00FFFF,
    $00FF00, $FFFF00, $FFCC00, $663399, $CCCCCC, $CC99FF, $99CCFF, $99FFFF,
    $CCFFCC, $FFFFCC, $FFCCCC, $FF99CC, $FFFFFF);
var
  I: Integer;
...
begin
  ...
  AItemSize := IfThen(ItemSize > 0, ItemSize,
    ScaleFactor.Apply(dxcExtendedSchemeItemSize));
...
const
  StandardColorMap: array [0 .. 14] of TColor = ($0000FF, $00FF00, $FF0000,
    $FFFF00, $FF00FF, $00FFFF, $000080, $008000, $800000, $808000, $800080,
    $008080, $FFFFFF, $808080, $000000);
var
  I: Integer;
  AGroup: TdxGalleryGroup;
  AColors: TColors;
...
begin
  ...
  AGroup := AddColorGroup('');
  AItemSize := IfThen(ItemSize > 0, ItemSize,
    ScaleFactor.Apply(dxcStandardSchemeItemSize));
...
const
  AnAccentMap: array [TdxColorAccent] of Integer = (80, 60, 50, 40, 35, 25, 15,
    5, -5, -10, -15, -25, -35, -50, -75, -90);
  ...
  procedure PopulateWithAccents(ABaseColors: TColors; AItemSize: Integer);
    ...
    procedure InternalPopulateWithAccents(AIndex: Integer;
      var AColorMatrix: array of TdxOfficeColorSet);
    const
      ColorAccentMap1: TdxColorAccentArray = (caLight50, caLight35, caLight25,
        caLight15, caLight5);
      ColorAccentMap2: TdxColorAccentArray = (caLight80, caLight60, caLight40,
        caDark25, caDark50);
      ColorAccentMap3: TdxColorAccentArray = (caDark10, caDark25, caDark50,
        caDark75, caDark90);
      ColorAccentMap4: TdxColorAccentArray = (caDark5, caDark15, caDark25,
        caDark35, caDark50);
    var
      I: Integer;
    ...
    begin
      ...
      else if (AHSV.V > 0.8) and (AHSV.S < 0.15) then
      begin
        if AHSV.S > 0.05 then
  ...
  begin
    ...
    begin
      for I := 0 to dxcOfficeSchemeColorCount - 1 do
        AddColorItem(AGroup, AColorMatrix[J][I], AItemSize,
          GetItemBorders(J = 0, J = RowsCount - 1));
    end;
  end;

const
  OfficeStandardColorMap: TdxOfficeColorSet = ($0000C0, $0000FF, $00C0FF,
    $00FFFF, $50D092, $50B000, $F0B000, $C07000, $602000, $A03070);
  OfficeColorMaps: array [TdxColorSet] of TdxOfficeColorSet =
    (($FFFFFF, $000000, $D2B48C, $00008B, $0000FF, $FF0000, $556B2F, $800080,
    $FFFF00, $FFA500), ($FFFFFF, $000000, $E1ECEE, $7D491F, $BD814F, $4D50C0,
    $59BB9B, $A26480, $C6AC4B, $4696F7), ($FFFFFF, $000000, $6D6769, $D1C2C9,
    $66B9CE, $84B09C, $C9B16B, $CF8565, $C96B7E, $BB79A3),
    ($FFFFFF, $000000, $323232, $D1DEE3, $097FF0, $36299F, $7C581B, $42854E,
    $784860, $5998C1), ($FFFFFF, $000000, $866B64, $D7D1C5, $4963D1, $00B4CC,
    $AEAD8C, $707B8C, $8CB08F, $4990D1), ($FFFFFF, $000000, $464646, $FAF5DE,
    $BFA22D, $281FDA, $1B64EB, $9D6339, $784B47, $4A3C7D),
    ($FFFFFF, $000000, $D2B48C, $00008B, $0000FF, $FF0000, $556B2F, $800080,
    $FFFF00, $FFA500));
var
  AColors: TColors;
...
begin
  ...
  AItemSize := IfThen(ItemSize > 0, ItemSize,
    ScaleFactor.Apply(dxcOfficeSchemeItemSize));
