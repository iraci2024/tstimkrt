...
type
  ...
  TdxBorderCollapse = (Separate, Collapse);

  { TdxHtmlCssFloat }

  TdxHtmlCssFloat = (NotSet, Left, Right, None);

  { TdxHtmlImageAlignment }

  TdxHtmlImageAlignment = (None, Left, Right, Middle, Top, Bottom);
  ...
  public
    ...
    function MergeWith(AProperties: TdxHtmlListLevelProperties)
      : TdxHtmlListLevelProperties;

    property BulletFontName: string read FBulletFontName
      write SetBulletFontName;
    property Format: TdxNumberingFormat read FFormat write SetFormat;
    property Start: Integer read FStart write SetStart;
    property LevelPositionIsOutside: Boolean read FLevelPositionIsOutside
      write SetLevelPositionIsOutside;
    property UseBulletFontName: Boolean read FUseBulletFontName
      write FUseBulletFontName;
  ...
  protected
    constructor Create(ATopBorder, ALeftBorder, ABottomBorder,
      ARightBorder: TdxHtmlBorderProperty); overload;
  public
    constructor Create; overload;
    destructor Destroy; override;
    procedure CopyFrom(ASource: TdxHtmlBordersProperties);
    function IsDefaultProperties: Boolean;
    function MergeWith(AOther: TdxHtmlBordersProperties)
      : TdxHtmlBordersProperties;

    property TopBorder: TdxHtmlBorderProperty read FTopBorder write FTopBorder;
    property LeftBorder: TdxHtmlBorderProperty read FLeftBorder
      write FLeftBorder;
    property BottomBorder: TdxHtmlBorderProperty read FBottomBorder
      write FBottomBorder;
    property RightBorder: TdxHtmlBorderProperty read FRightBorder
      write FRightBorder;
  end;
  ...
  public
    ...
    procedure ApplyPropertiesToCharacter(AProperties
    ...
    function MergeWith(AProperties: TdxHtmlTableProperties)
      : TdxHtmlTableProperties;
    ...
    property BorderCollapse: TdxBorderCollapse read FBorderCollapse
      write SetBorderCollapse;
    property SetInnerBorders: Boolean read FSetInnerBorders
      write FSetInnerBorders;
  end;
  ...
  public
    ...
    destructor Destroy; override;
    procedure ApplyBackgroundColorToCell(AProperties: TdxTableCellProperties);
    procedure ApplyPropertiesToCharacter(ACharacterFormattingBase
      : TdxCharacterFormattingBase);
    ...
    function MergeWith(AProperties: TdxHtmlTableRowProperties)
      : TdxHtmlTableRowProperties;
  ...
  public
    ...
    function MergeWith(AProperties: TdxHtmlImageProperties)
      : TdxHtmlImageProperties;
  ...
  public
    ...
    property UnitRelativeFontSize: string read FUnitRelativeFontSize
      write SetUnitRelativeFontSize;
    property UnitRelativeFirstLineIndent: string
      read FUnitRelativeFirstLineIndent write SetUnitRelativeFirstLineIndent;
    property UnitRelativeLeftIndent: string read FUnitRelativeLeftIndent
      write SetUnitRelativeLeftIndent;
    property UnitRelativeRightIndent: string read FUnitRelativeRightIndent
      write SetUnitRelativeRightIndent;
    property UnitRelativeLineSpacing: string read FUnitRelativeLineSpacing
      write SetUnitRelativeLineSpacing;
    property UnitRelativeSpacingAfter: string read FUnitRelativeSpacingAfter
      write SetUnitRelativeSpacingAfter;
    property UnitRelativeSpacingBefore: string read FUnitRelativeSpacingBefore
      write SetUnitRelativeSpacingBefore;
    property UnitRelativeWidth: string read FUnitRelativeWidth
      write SetUnitRelativeWidth;
    property UnitRelativeHeight: string read FUnitRelativeHeight
      write SetUnitRelativeHeight;
  ...
  strict private
    ...
    FEx: Single;
    FDpi: Single;
    class function CreateEmptyUnitConversionParameters
      : TdxUnitConversionParameters; static;
  public
    ...
    class property Empty: TdxUnitConversionParameters
      read CreateEmptyUnitConversionParameters;
  end;
  ...
  public
    ...
    property CssParagraphProperties: TdxParagraphFormattingBase
      read FParagraphProperties;
    property CssCharacterProperties: TdxCharacterFormattingBase
    ...
    property BordersProperties: TdxHtmlBordersProperties
      read FBordersProperties;
    ...
    property RelativeProperties: PdxRelativeProperties
      read GetRelativeProperties;
  ...
  TdxCssPropertiesTranslateHandler = reference to procedure(ACssProperties
    : TdxCssProperties; const APropertiesValues: TArray<string>);
  TdxCssKeywordTranslatorTable = class
    (TdxNamedDelegateDictionary<TdxCssPropertiesTranslateHandler>);
  ...
  TdxCssParserState = (ReadSelector, ReadPropertiesName, WaitColonSymbol,
    SkipProperties, WaitPropertiesValue, ReadPropertiesValueInQuotes,
    ReadPropertiesValueInApostrophe, ReadPropertiesValueInParentheses,
    ReadPropertiesValue, WaitPropertiesKeyword, ReadPropertiesKeyword,
    WaitStartComment, ReadComment, WaitEndComment, SkipNestedProperties);

  { TdxFontProperties }

  TdxFontProperties = (Style = 0, Variant, Weight, Size, Family);
  ...
  public type
    ...
    public
      ...
      function ToModelUnits(AValue: TdxUnit;
        AParameters: TdxUnitConversionParameters): Integer; overload;
      function ToPoints(AValue: TdxUnit;
        AParameters: TdxUnitConversionParameters): Single;
    end;
  strict private
  ...
  protected
    class function ConvertKeyToUpper(const AKey: string): string;
      static; inline;
    class function CompareNoCase(const AStr1: string; const AStr2: string)
      : Boolean; static; inline;

    function GetCssKeywordTable: TdxCssKeywordTranslatorTable; virtual;
      abstract;
    ...
    property CssKeywordTable: TdxCssKeywordTranslatorTable
      read GetCssKeywordTable;
    property IsUpdateLocked: Boolean read GetIsUpdateLocked;
  public
    constructor Create(ADocumentModel: TdxDocumentModel);
    destructor Destroy; override;

    function ParseAttribute(AReader: TTextReader)
      : TdxCssElementCollection; virtual;
...
procedure TdxHtmlListLevelProperties.SetFormat(const AValue
  : TdxNumberingFormat);
begin
  FFormat := AValue;
  FUseFormat := True;
...
procedure TdxHtmlListLevelProperties.SetLevelPositionIsOutside
...
procedure TdxHtmlListLevelProperties.CopyFrom
  (AValue: TdxHtmlListLevelProperties);
begin
  FStart := AValue.Start;
...
function TdxHtmlListLevelProperties.MergeWith(AProperties
  : TdxHtmlListLevelProperties): TdxHtmlListLevelProperties;
begin
  Result := TdxHtmlListLevelProperties.Create;
  if FUseFormat then
    Result.Format := Format
  else if AProperties.FUseFormat then
    Result.Format := AProperties.Format;

  if FUseLevelPositionIsOutside then
    Result.LevelPositionIsOutside := LevelPositionIsOutside
  else if AProperties.FUseLevelPositionIsOutside then
    Result.LevelPositionIsOutside := AProperties.LevelPositionIsOutside;

  if FUseStart then
    Result.Start := Start
  else if AProperties.FUseStart then
    Result.Start := AProperties.Start;

  if FUseBulletFontName then
    Result.BulletFontName := BulletFontName
  else if AProperties.FUseBulletFontName then
    Result.BulletFontName := AProperties.BulletFontName;
end;

function TdxHtmlListLevelProperties.ApplyPropertiesToListLevel
  (ALevel: TdxListLevel): TdxListLevel;
begin
  if FUseBulletFontName then
...
function TdxHtmlBorderProperty.MergeWith(AOther: TdxHtmlBorderProperty)
  : TdxHtmlBorderProperty;
begin
  Result := TdxHtmlBorderProperty.Create;
  if UseLineStyle then
    Result.LineStyle := LineStyle
  else if AOther.UseLineStyle then
    Result.LineStyle := AOther.LineStyle;

  if UseColor then
    Result.Color := Color
  else if AOther.UseColor then
    Result.Color := AOther.Color;

  if UseWidth then
    Result.Width := Width
  else if AOther.UseWidth then
...
constructor TdxHtmlBordersProperties.Create(ATopBorder, ALeftBorder,
  ABottomBorder, ARightBorder: TdxHtmlBorderProperty);
begin
  inherited Create;
...
begin
  Result := ((TopBorder.IsDefaultProperties and LeftBorder.IsDefaultProperties)
    and RightBorder.IsDefaultProperties) and BottomBorder.IsDefaultProperties;
end;

function TdxHtmlBordersProperties.MergeWith(AOther: TdxHtmlBordersProperties)
  : TdxHtmlBordersProperties;
begin
...
procedure TdxHtmlTableProperties.SetBackgroundColor(const AValue
  : TdxAlphaColor);
begin
...
procedure TdxHtmlTableProperties.SetTableAlignment(const AValue
...
procedure TdxHtmlTableProperties.SetBorderCollapse(const AValue
  : TdxBorderCollapse);
begin
...
procedure TdxHtmlTableProperties.SetBordersProperties
  (const Value: TdxHtmlBordersProperties);
begin
...
begin
  ...
  FUseCellSpacing := AValue.FUseCellSpacing and
    ((AValue.CellSpacing.Value > 0) or
...
function TdxHtmlTableProperties.MergeWith(AProperties: TdxHtmlTableProperties)
  : TdxHtmlTableProperties;
var
...
begin
  ...
  ABordersProperties := BordersProperties.MergeWith
    (AProperties.BordersProperties);
  try
  ...
  else if AProperties.UseBackgroundColor then
  ...
  else if AProperties.FUseTableAlignment then
    Result.TableAlignment := AProperties.TableAlignment;

  if FUseIndent then
    Result.Indent := Indent
  else if AProperties.FUseIndent then
    Result.Indent := AProperties.Indent;
end;

procedure TdxHtmlTableProperties.ApplyPropertiesToTable
...
begin
  ...
  ASpacingBetweenCellsIsForbidden := FUseBorderCollapse and
    (BorderCollapse = TdxBorderCollapse.Collapse);
...
procedure TdxHtmlTableProperties.ApplyBackgroundColorToCell
...
procedure TdxHtmlTableProperties.ApplyPropertiesToCharacter
  (AProperties: TdxCharacterFormattingBase);
begin
  if FUseBackgroundColor then
...
begin
  Result := (((((not FUseWidth and not FUseCellMargins) and not FUseCellSpacing)
    and FBordersProperties.IsDefaultProperties) and not FUseTableAlignment) and
    not FUseIndent) and not FUseBorderCollapse;
end;
...
procedure TdxHtmlTableRowProperties.SetBackgroundColor
...
procedure TdxHtmlTableRowProperties.SetVerticalAlignment
...
function TdxHtmlTableRowProperties.MergeWith(AProperties
  : TdxHtmlTableRowProperties): TdxHtmlTableRowProperties;
begin
  Result := TdxHtmlTableRowProperties.Create;
  if FUseHeight then
    Result.Height := Height
  else if AProperties.UseHeight then
    Result.Height := AProperties.Height;

  if FUseBackgroundColor then
    Result.BackgroundColor := BackgroundColor
  else if AProperties.FUseBackgroundColor then
    Result.BackgroundColor := AProperties.BackgroundColor;

  if FUseVerticalAlignment then
    Result.VerticalAlignment := VerticalAlignment
  else if AProperties.FUseVerticalAlignment then
    Result.VerticalAlignment := AProperties.VerticalAlignment;
end;

procedure TdxHtmlTableRowProperties.ApplyPropertiesToRow
...
procedure TdxHtmlTableRowProperties.ApplyBackgroundColorToCell
  (AProperties: TdxTableCellProperties);
begin
  if FUseBackgroundColor then
    AProperties.BackgroundColor := BackgroundColor;
...
procedure TdxHtmlTableRowProperties.ApplyVerticalAlignmentToCell
  (AProperties: TdxTableCellProperties);
begin
  if FUseVerticalAlignment then
...
begin
  Result := (not FUseHeight and not FUseBackgroundColor) and
    not FUseVerticalAlignment;
end;

procedure TdxHtmlTableRowProperties.ApplyPropertiesToCharacter
  (ACharacterFormattingBase: TdxCharacterFormattingBase);
begin
  if FUseBackgroundColor then
...
function TdxHtmlImageProperties.MergeWith(AProperties: TdxHtmlImageProperties)
  : TdxHtmlImageProperties;
begin
  Result := TdxHtmlImageProperties.Create;
  if FUseHeight then
    Result.Height := Height
  else if AProperties.FUseHeight then
    Result.Height := AProperties.Height;
  ...
  else if AProperties.FUseCssFloat then
    Result.CssFloat := AProperties.CssFloat;
end;

function TdxHtmlImageProperties.IsDefaultProperties: Boolean;
begin
  Result := ((not FUseHeight and not FUseWidth) and
    (Alignment = TdxHtmlImageAlignment.None)) and not FUseCssFloat;
end;
...
procedure TdxRelativeProperties.SetUnitRelativeFirstLineIndent
  (const AValue: string);
begin
...
procedure TdxRelativeProperties.SetUnitRelativeRightIndent
  (const AValue: string);
begin
...
procedure TdxRelativeProperties.SetUnitRelativeLineSpacing
  (const AValue: string);
begin
...
procedure TdxRelativeProperties.SetUnitRelativeSpacingAfter
  (const AValue: string);
begin
...
procedure TdxRelativeProperties.SetUnitRelativeSpacingBefore
  (const AValue: string);
begin
...
class function TdxRelativeProperties.IsRelative(const ARelativeUnit
  : string): Boolean;
begin
  if ARelativeUnit = '' then
    Result := False
  else
    Result := (ARelativeUnit = 'em') or (ARelativeUnit = 'rem') or
      (ARelativeUnit = 'ex') or (ARelativeUnit = '%');
end;

function TdxRelativeProperties.IsDefaultProperties: Boolean;
begin
  Result := ((((((((FUnitRelativeFirstLineIndent = '') and
    (FUnitRelativeFontSize = '')) and (FUnitRelativeLeftIndent = '')) and
    (FUnitRelativeRightIndent = '')) and (FUnitRelativeLineSpacing = '')) and
    (FUnitRelativeSpacingAfter = '')) and (FUnitRelativeSpacingBefore = '')) and
    (FUnitRelativeWidth = '')) and (FUnitRelativeHeight = '');
end;

{ TdxUnitConversionParameters }

class function TdxUnitConversionParameters.CreateEmptyUnitConversionParameters
  : TdxUnitConversionParameters;
var
...
begin
  ...
  FParagraphProperties := APieceTable.DocumentModel.
    CreateEmptyParagraphFormatting;
  FCharacterProperties := APieceTable.DocumentModel.
...
begin
  Result := (Self <> nil) and (FRawProperties <> nil) and
    (FRawProperties.Count > 0);
end;
...
begin
  Result := (CssCharacterProperties.Options.Value =
    TdxCharacterFormattingOptions.MaskUseNone) and
    (CssParagraphProperties.Options.Value = TdxParagraphFormattingOptions.
    MaskUseNone) and ListLevelProperties.IsDefaultProperties and
    ...
    RelativeProperties.IsDefaultProperties and (FRawProperties = nil) and
    (FCssFloat = TdxHtmlCssFloat.NotSet) and
    (TdxDocumentModel(CellProperties.DocumentModel)
    .Cache.TableCellPropertiesOptionsCache.DefaultItem.Equals
    (CellProperties.Info));
end;
...
function TdxCssProperties.CreateCellPropertiesChangedHistoryItem
  (AProperties: TdxTableCellProperties): TdxIndexChangedHistoryItemCore;
begin
...
constructor TdxCustomCssParser.TUnitConverter.Create(AUnitConverter
...
function TdxCustomCssParser.TUnitConverter.ToModelUnits
  (AValue: TdxUnit): Integer;
begin
  Result := ToModelUnits(AValue, TdxUnitConversionParameters.Empty);
end;

function TdxCustomCssParser.TUnitConverter.DegreeToModelUnits
  (AValue: TdxRotationUnit): Integer;
begin
  Result := FUnitConverter.DegreeToModelUnits(Trunc(AValue.Value));
end;

function TdxCustomCssParser.TUnitConverter.FDToModelUnits
  (AValue: TdxRotationUnit): Integer;
begin
  Result := FUnitConverter.FDToModelUnits(Trunc(AValue.Value));
end;

function TdxCustomCssParser.TUnitConverter.ToModelUnits(AValue: TdxUnit;
  AParameters: TdxUnitConversionParameters): Integer;
begin
  Result := Trunc(FUnitConverter.PointsToModelUnitsF(ToPoints(AValue,
    AParameters)));
end;

function TdxCustomCssParser.TUnitConverter.ToPoints(AValue: TdxUnit;
  AParameters: TdxUnitConversionParameters): Single;
begin
  case AValue.&Type of
    TdxUnitType.Em:
...
class function TdxCustomCssParser.CompareNoCase(const AStr1: string;
...
function TdxCustomCssParser.Parse(AReader: TTextReader)
  : TdxCssElementCollection;
var
  AIntChar: Integer;
begin
...
function TdxCustomCssParser.ParseAttribute(AReader: TTextReader)
  : TdxCssElementCollection;
var
  AIntChar: Integer;
begin
...
function TdxCustomCssParser.ParseCssElements(AReader: TTextReader)
  : TdxCssElementCollection;
var
  AIntChar: Integer;
  ACh: Char;
...
begin
  ...
  ACssElement := TdxCssElement.Create(FDocumentModel.MainPieceTable,
    FCssElementCollection.Count);
