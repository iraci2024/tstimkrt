...
type
  ...
  public type
    TUnit = (None, EM, EX, PT, PC, PX, &IN, CM, MM);
  strict private
    FPointsValue: Single;
    ...
    function GetLengthValueInPoints(const AValueInfo: TdxValueInfo)
      : Single; overload;
    function GetLengthValueInPoints(const AValueInfo: TdxValueInfo;
      const V: TdxUnitConversionParameters): Single; overload;
  public
  ...
  strict private
    ...
    class function SetLineIndentType(ACssProperties: TdxCssProperties;
      AIndent: Single): Single; static;
    class procedure CssTextTransformKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssTopKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssUnicodeBidiKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssVerticalAlignKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssVisibilityKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssVisitedKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssWhiteSpaceKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssWidthKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssWordSpacingKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
  protected
    class procedure CssBackgroundKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBackgroundAttachmentKeyword(ACssProperties
      : TdxCssProperties; const APropertiesValue: TArray<string>); static;
    class procedure CssBackgroundColorKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBackgroundImageKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBackgroundPositionKeyword(ACssProperties
      : TdxCssProperties; const APropertiesValue: TArray<string>); static;
    class procedure CssBackgroundRepeatKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBeforeKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderBottomKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderKeywordCore(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>;
      ABorder: TdxHtmlBorderProperty); static;
    class procedure CssBorderBottomColorKeyword(ACssProperties
      : TdxCssProperties; const APropertiesValue: TArray<string>); static;
    class procedure CssBorderBottomStyleKeyword(ACssProperties
      : TdxCssProperties; const APropertiesValue: TArray<string>); static;
    class procedure CssBorderBottomWidthKeyword(ACssProperties
      : TdxCssProperties; const APropertiesValue: TArray<string>); static;
    class procedure CssBorderCollapseKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderLeftKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderLeftColorKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderLeftStyleKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderLeftWidthKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderRightKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderRightColorKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderRightStyleKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderRightWidthKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderSpacingKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderStyleKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderColorKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderWidthKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderTopKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderTopColorKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderTopStyleKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBorderTopWidthKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBottomKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssCaptionSideKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssClearKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssClipKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssColorKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class function GetColor(const AValue: string): TdxAlphaColor; static;
    class procedure CssContentKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssCounterIncrementKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssCounterResetKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssCursorKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssDirectionKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssDisplayKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssEmptyCellsKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssFirstChildKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssFloatKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssFocusKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssFontKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class function TrySetFontProperty(ACssProperties: TdxCssProperties;
      AProperty: TdxFontProperties; const AValue: string): Boolean; static;
    class function ShouldSplitFontSizeLineHeight(const AFontSizeProperties
      : string): Boolean; static;
    class function GetPropertiesList(const AProperty: string)
      : TArray<string>; static;
    class procedure CssFontFamilyKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class function SetFontFamily(ACssProperties: TdxCssProperties;
      const AValue: string): Boolean; static;
    class procedure CssFontSizeKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class function SetFontSize(ACssProperties: TdxCssProperties;
      const AValue: string): Boolean; static;
    class procedure CssFontStyleKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class function SetFontStyle(ACssProperties: TdxCssProperties;
      const AValue: string): Boolean; static;
    class procedure CssFontVariantKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class function SetFontVariant(ACssProperties: TdxCssProperties;
      const AValue: string): Boolean; static;
    class procedure CssFontWeightKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class function SetFontWeight(ACssProperties: TdxCssProperties;
      const AValue: string): Boolean; static;
    class procedure CssHeightKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssHoverKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssLeftKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssLetterSpacingKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssLineHeightKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssLinkKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssListStyleKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssListStyleImageKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssListStylePositionKeyword(ACssProperties
      : TdxCssProperties; const APropertiesValue: TArray<string>); static;
    class procedure CssListStyleTypeKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssMarginKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssMarginKeywordCore(ACssProperties: TdxCssProperties;
      const ABottom: string; const ATop: string; const ALeft: string;
      const ARight: string); static;
    class function CreateStringList(const AItem: string)
      : TArray<string>; static;
    class procedure CssMarginTopKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssMarginBottomKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssMarginLeftKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssMarginRightKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssMaxHeightKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssMaxWidthKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssMinHeightKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssMinWidthKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssBeforeAutoSpacing(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssAfterAutoSpacing(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssMsoPagination(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssOpacityKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssOutlineKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssOutlineColorKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssOutlineStyleKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssOutlineWidthKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssOverflowKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssPaddingKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssPaddingKeywordCore(ACssProperties: TdxCssProperties;
      const ABottom: string; const ATop: string; const ALeft: string;
      const ARight: string); static;
    class procedure CssPaddingBottomKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssPaddingLeftKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssPaddingRightKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssPaddingTopKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssPageBreakAfterKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssPageBreakBeforeKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssPageBreakInsideKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssPositionKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssQuotesKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssRightKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssTableLayoutKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssTextAlignKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssTextDecorationKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssTextIndentKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;
    class procedure CssMsoSpacerunKeyword(ACssProperties: TdxCssProperties;
      const APropertiesValue: TArray<string>); static;

    class function SetMarginProperties(const APropertiesValue: TArray<string>;
      var AMarginValue: Single; AUnitConverter: TdxDocumentModelUnitConverter)
      : string; static;
...
begin
  ...
  begin
    ...
    if (FRelativeUnit = 'em') or (FRelativeUnit = 'rem') or
      (FRelativeUnit = 'ex') or (FRelativeUnit = '%') then
      FIsRelativeUnit := True;
  end;
  Result := True;
end;

function TdxLengthValueParser.GetLengthValueInPoints(const AValueInfo
  : TdxValueInfo): Single;
begin
  Result := GetLengthValueInPoints(AValueInfo,
    TdxUnitConversionParameters.Empty);
end;

function TdxLengthValueParser.GetLengthValueInPoints(const AValueInfo
  : TdxValueInfo; const V: TdxUnitConversionParameters): Single;
var
  AUnit: string;
begin
...
begin
  ...
  Result.Add(ConvertKeyToUpper('background-attachment'),
    CssBackgroundAttachmentKeyword);
  ...
  Result.Add(ConvertKeyToUpper('background-position'),
    CssBackgroundPositionKeyword);
  Result.Add(ConvertKeyToUpper('background-repeat'),
    CssBackgroundRepeatKeyword);
  ...
  Result.Add(ConvertKeyToUpper('border-bottom-color'),
    CssBorderBottomColorKeyword);
  Result.Add(ConvertKeyToUpper('border-bottom-style'),
    CssBorderBottomStyleKeyword);
  Result.Add(ConvertKeyToUpper('border-bottom-width'),
    CssBorderBottomWidthKeyword);
  ...
  Result.Add(ConvertKeyToUpper('border-right-color'),
    CssBorderRightColorKeyword);
  Result.Add(ConvertKeyToUpper('border-right-style'),
    CssBorderRightStyleKeyword);
  Result.Add(ConvertKeyToUpper('border-right-width'),
    CssBorderRightWidthKeyword);
  ...
  Result.Add(ConvertKeyToUpper('counter-increment'),
    CssCounterIncrementKeyword);
  ...
  Result.Add(ConvertKeyToUpper('list-style-position'),
    CssListStylePositionKeyword);
...
class procedure TdxCssParser.CssBackgroundKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  AProperties: TArray<string>;
  ACount, I: Integer;
  AColor: TdxAlphaColor;
begin
  AProperties := TdxStringHelper.Split(APropertiesValue[0], [' '],
    [RemoveEmptyEntries]);
...
class procedure TdxCssParser.CssBackgroundAttachmentKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssBackgroundColorKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  AColor: TdxAlphaColor;
begin
...
class procedure TdxCssParser.CssBackgroundImageKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssBackgroundPositionKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssBackgroundRepeatKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssBeforeKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssBorderKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
var
...
class procedure TdxCssParser.CssBorderBottomKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
...
class procedure TdxCssParser.CssBorderKeywordCore(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>;
  ABorder: TdxHtmlBorderProperty);
var
  ANormalizedSpaces, APropertyValueWithoutRgbColorRepresentation,
    AColorRgbValue, AValue: string;
...
begin
  ...
  begin
    ...
    AColorRgbValue := TdxStringHelper.Substring(ANormalizedSpaces, AStartIndex,
      AColorRgbValueLength);
    TdxTdTag.ImportBorderColor(ACssProperties.UnitConverter,
      AColorRgbValue, ABorder);
    APropertyValueWithoutRgbColorRepresentation :=
      TdxStringHelper.Remove(ANormalizedSpaces, AStartIndex,
      AColorRgbValueLength);
    if APropertyValueWithoutRgbColorRepresentation = '' then
      Exit;
  end;
  ABordersContent := TdxStringHelper.Split
    (APropertyValueWithoutRgbColorRepresentation, [' ']);
  ...
  begin
    ...
    TdxTagBase.ImportBorderLineStyle(ACssProperties.UnitConverter,
      AValue, ABorder);
    TdxTdTag.ImportBorderColor(ACssProperties.UnitConverter, AValue, ABorder);
  end;
end;

class procedure TdxCssParser.CssBorderBottomColorKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ABorder: TdxHtmlBorderProperty;
begin
...
class procedure TdxCssParser.CssBorderBottomStyleKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ABorder: TdxHtmlBorderProperty;
begin
...
class procedure TdxCssParser.CssBorderBottomWidthKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ABottomBorder: TdxHtmlBorderProperty;
begin
...
class procedure TdxCssParser.CssBorderCollapseKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  AValue: string;
begin
  ...
  else if AValue = 'separate' then
    ACssProperties.TableProperties.BorderCollapse := TdxBorderCollapse.Separate;
end;

class procedure TdxCssParser.CssBorderLeftKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ABorder: TdxHtmlBorderProperty;
begin
...
class procedure TdxCssParser.CssBorderLeftColorKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ABorder: TdxHtmlBorderProperty;
begin
...
class procedure TdxCssParser.CssBorderLeftStyleKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ABorder: TdxHtmlBorderProperty;
begin
...
class procedure TdxCssParser.CssBorderLeftWidthKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ABorder: TdxHtmlBorderProperty;
begin
...
class procedure TdxCssParser.CssBorderRightKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ABorder: TdxHtmlBorderProperty;
begin
...
class procedure TdxCssParser.CssBorderRightColorKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ABorder: TdxHtmlBorderProperty;
begin
...
class procedure TdxCssParser.CssBorderRightStyleKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ABorder: TdxHtmlBorderProperty;
begin
...
class procedure TdxCssParser.CssBorderRightWidthKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ABorder: TdxHtmlBorderProperty;
begin
...
class procedure TdxCssParser.CssBorderSpacingKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssBorderStyleKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  if Length(APropertiesValue) = 0 then
    Exit;
  TdxTagBase.ImportBordersLineStyles(ACssProperties.UnitConverter,
    APropertiesValue[0], ACssProperties.BordersProperties);
end;

class procedure TdxCssParser.CssBorderColorKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  if Length(APropertiesValue) = 0 then
    Exit;
  TdxTagBase.ImportBordersColors(ACssProperties.UnitConverter,
    APropertiesValue[0], ACssProperties.BordersProperties);
end;

class procedure TdxCssParser.CssBorderWidthKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  if Length(APropertiesValue) = 0 then
    Exit;
  TdxTagBase.ImportBordersWidths(ACssProperties.UnitConverter,
    APropertiesValue[0], ACssProperties.BordersProperties);
end;

class procedure TdxCssParser.CssBorderTopKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ABorder: TdxHtmlBorderProperty;
begin
...
class procedure TdxCssParser.CssBorderTopColorKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ABorder: TdxHtmlBorderProperty;
begin
...
class procedure TdxCssParser.CssBorderTopStyleKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ABorder: TdxHtmlBorderProperty;
begin
...
class procedure TdxCssParser.CssBorderTopWidthKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ABorder: TdxHtmlBorderProperty;
begin
...
class procedure TdxCssParser.CssBottomKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssCaptionSideKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssClearKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssClipKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssColorKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin

  ACssProperties.CssCharacterProperties.ForeColor :=
    GetColor(APropertiesValue[0]);
end;
...
class procedure TdxCssParser.CssContentKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssCounterIncrementKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssCounterResetKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssCursorKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssDirectionKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssDisplayKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
var
  AValue: string;
begin
...
class procedure TdxCssParser.CssEmptyCellsKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssFirstChildKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssFloatKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
var
  AValue: string;
...
begin
  ...
  else if AValue = 'none' then
    ACssProperties.ImageProperties.CssFloat := TdxHtmlCssFloat.None;
end;

class procedure TdxCssParser.CssFocusKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssFontKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
var
...
begin
  ...
  while (ATokenStartIndex < Length(APropertyValue)) and
    (ANextFontProperty <= TdxFontProperties.Family) do
  begin
    if ANextFontProperty < TdxFontProperties.Family then
    begin
      ASeparatorIndex := TdxStringHelper.IndexOf(APropertyValue, ' ',
        ATokenStartIndex);
      ...
      ASeparatorIndex := Length(APropertyValue);
    AToken := TdxStringHelper.Substring(APropertyValue, ATokenStartIndex,
      ASeparatorIndex - ATokenStartIndex);
    if AToken <> '' then
    begin
      ...
      begin
        ...
        else if (AProperty = TdxFontProperties.Size) or
          (AProperty = TdxFontProperties.Family) then
          Exit;
      end;
    end;
...
class function TdxCssParser.TrySetFontProperty(ACssProperties: TdxCssProperties;
  AProperty: TdxFontProperties; const AValue: string): Boolean;
var
...
begin
  case AProperty of
    ...
    TdxFontProperties.Size:
      begin
        ASizeParts := TdxStringHelper.Split(AValue, ['/'],
          [RemoveEmptyEntries]);
...
class function TdxCssParser.ShouldSplitFontSizeLineHeight
  (const AFontSizeProperties: string): Boolean;
var
...
class function TdxCssParser.GetPropertiesList(const AProperty: string)
  : TArray<string>;
begin
  Result := TArray<string>.Create(AProperty);
end;

class procedure TdxCssParser.CssFontFamilyKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  AFontFamily: string;
begin
...
class function TdxCssParser.SetFontFamily(ACssProperties: TdxCssProperties;
...
begin
  ...
  else if AName = 'sans-serif' then
    AFontName := 'Arial'
  else if AName = 'cursive' then
    AFontName := 'Comic Sans MS'
  else if AName = 'fantasy' then
    AFontName := 'Algerian'
...
class procedure TdxCssParser.CssFontSizeKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
...
class function TdxCssParser.SetFontSize(ACssProperties: TdxCssProperties;
  const AValue: string): Boolean;
var
...
begin
  ...
  else if AFontSize = 'x-small' then
    ACharacterFormatting.DoubleFontSize := AHtmlFontSize.GetDoubleFontSize(2)
  else if AFontSize = 'small' then
    ACharacterFormatting.DoubleFontSize := AHtmlFontSize.GetDoubleFontSize(3)
  else if AFontSize = 'medium' then
    ACharacterFormatting.DoubleFontSize := AHtmlFontSize.GetDoubleFontSize(4)
  else if AFontSize = 'large' then
    ACharacterFormatting.DoubleFontSize := AHtmlFontSize.GetDoubleFontSize(5)
  else if AFontSize = 'x-large' then
    ACharacterFormatting.DoubleFontSize := AHtmlFontSize.GetDoubleFontSize(6)
  else if AFontSize = 'xx-large' then
    ACharacterFormatting.DoubleFontSize := AHtmlFontSize.GetDoubleFontSize(7)
  else if AFontSize = 'larger' then
    ACharacterFormatting.DoubleFontSize := AHtmlFontSize.GetLargerDoubleFontSize
  else if AFontSize = 'smaller' then
    ACharacterFormatting.DoubleFontSize :=
      AHtmlFontSize.GetSmallerDoubleFontSize
  else if not((AFontSize = 'inherit') or (AFontSize = 'initial')) then
  begin
    APar := TdxLengthValueParser.Create(AValue,
      ACssProperties.UnitConverter.ScreenDpi);
    if (not APar.Success) or (not APar.IsDigit) then
      Exit(False);
    if APar.PointsValue > 0 then
    begin
      ACssProperties.RelativeProperties.UnitRelativeFontSize :=
        APar.RelativeUnit;
      ACharacterFormatting.DoubleFontSize :=
        Max(1, Round(APar.PointsValue * 2));
    end;
  end;
  Result := True;
end;

class procedure TdxCssParser.CssFontStyleKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  SetFontStyle(ACssProperties, APropertiesValue[0]);
end;

class function TdxCssParser.SetFontStyle(ACssProperties: TdxCssProperties;
  const AValue: string): Boolean;
var
  AFontStyle: string;
begin
  AFontStyle := LowerCase(AValue);
  if (AFontStyle = 'inherit') or (AFontStyle = 'initial') or
    (AFontStyle = 'normal') then
    ACssProperties.CssCharacterProperties.FontItalic := False
  else if (AFontStyle = 'italic') or (AFontStyle = 'oblique') then
...
class procedure TdxCssParser.CssFontVariantKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  SetFontVariant(ACssProperties, APropertiesValue[0]);
end;

class function TdxCssParser.SetFontVariant(ACssProperties: TdxCssProperties;
  const AValue: string): Boolean;
var
  AFontVariant: string;
begin
  AFontVariant := LowerCase(AValue);
  Result := (AFontVariant = 'normal') or (AFontVariant = 'small-caps') or
    (AFontVariant = 'initial') or (AFontVariant = 'inherit');
end;

class procedure TdxCssParser.CssFontWeightKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  SetFontWeight(ACssProperties, APropertiesValue[0]);
end;

class function TdxCssParser.SetFontWeight(ACssProperties: TdxCssProperties;
  const AValue: string): Boolean;
var
  AFontWeight: Integer;
...
begin
  ...
  begin
    ...
    if (AFontWeightName = 'initial') or (AFontWeightName = 'inherit') or
      (AFontWeightName = 'lighter') or (AFontWeightName = 'normal') then
      ACssProperties.CssCharacterProperties.FontBold := False
    else if (AFontWeightName = 'bold') or (AFontWeightName = 'bolder') then
      ACssProperties.CssCharacterProperties.FontBold := True
    else
      Exit(False);
  end;
...
class procedure TdxCssParser.CssHeightKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
var
  APar: TdxLengthValueParser;
  AValue: Integer;
...
begin
  if APropertiesValue[0] = '' then
    Exit;
  APar := TdxLengthValueParser.Create(APropertiesValue[0],
    ACssProperties.UnitConverter.ScreenDpi);
  ...
  begin
    AValue := Round(ACssProperties.UnitConverter.PointsToModelUnitsF
      (APar.PointsValue));
...
class procedure TdxCssParser.CssHoverKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssLeftKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssLetterSpacingKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssLineHeightKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  APar: TdxLengthValueParser;
  AMultiple: Single;
begin
  ...
  if APar.&Unit = '' then
  begin
    ACssProperties.CssParagraphProperties.SetMultipleLineSpacing
      (APar.PointsValue);
  end
  else if APar.&Unit = '%' then
  begin
  ...
  begin
    ACssProperties.CssParagraphProperties.LineSpacingType :=
      TdxParagraphLineSpacing.AtLeast;
    if APar.IsRelativeUnit then
    begin
      ACssProperties.RelativeProperties.UnitRelativeLineSpacing :=
        APar.RelativeUnit;
      ACssProperties.CssParagraphProperties.LineSpacing := APar.PointsValue;
    end
    else
      ACssProperties.CssParagraphProperties.LineSpacing :=
        ACssProperties.UnitConverter.PointsToModelUnitsF(APar.PointsValue);
  end;
end;

class procedure TdxCssParser.CssLinkKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssListStyleKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssListStyleImageKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssListStylePositionKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssListStyleTypeKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  AStyleType: string;
begin
...
begin
  ...
  case Length(AProperties) of
    1:
      CssMarginKeywordCore(ACssProperties, AProperties[0], AProperties[0],
        AProperties[0], AProperties[0]);
    2:
      CssMarginKeywordCore(ACssProperties, AProperties[0], AProperties[0],
        AProperties[1], AProperties[1]);
    3:
      CssMarginKeywordCore(ACssProperties, AProperties[2], AProperties[0],
        AProperties[1], AProperties[1]);
    4:
      CssMarginKeywordCore(ACssProperties, AProperties[2], AProperties[0],
        AProperties[3], AProperties[1]);
  end;
end;

class procedure TdxCssParser.CssMarginKeywordCore(ACssProperties
  : TdxCssProperties; const ABottom: string; const ATop: string;
  const ALeft: string; const ARight: string);
begin
...
class function TdxCssParser.CreateStringList(const AItem: string)
  : TArray<string>;
begin
  Result := TArray<string>.Create(AItem);
end;

class procedure TdxCssParser.CssMarginTopKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
...
begin
  ...
  ACssProperties.RelativeProperties.UnitRelativeSpacingBefore :=
    SetMarginProperties(APropertiesValue, ASpacingBefore,
...
class procedure TdxCssParser.CssMarginBottomKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
...
begin
  ...
  ACssProperties.RelativeProperties.UnitRelativeSpacingAfter :=
    SetMarginProperties(APropertiesValue, ASpacingAfter,
    ACssProperties.UnitConverter);
...
class procedure TdxCssParser.CssMarginLeftKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ALeftIndent: Single;
...
begin
  ...
  ACssProperties.RelativeProperties.UnitRelativeLeftIndent :=
    SetMarginProperties(APropertiesValue, ALeftIndent,
    ACssProperties.UnitConverter);
...
class procedure TdxCssParser.CssMarginRightKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ARightIndent: Single;
begin
  ARightIndent := ACssProperties.CssParagraphProperties.RightIndent;
  ACssProperties.RelativeProperties.UnitRelativeRightIndent :=
    SetMarginProperties(APropertiesValue, ARightIndent,
    ACssProperties.UnitConverter);
  ACssProperties.CssParagraphProperties.RightIndent := Round(ARightIndent);
end;

class procedure TdxCssParser.CssMaxHeightKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssMaxWidthKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssMinHeightKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssMinWidthKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssBeforeAutoSpacing(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  if (Length(APropertiesValue) > 0) and CompareNoCase(APropertiesValue[0],
    'auto') then
    ACssProperties.CssParagraphProperties.BeforeAutoSpacing := True;
end;

class procedure TdxCssParser.CssAfterAutoSpacing(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  if (Length(APropertiesValue) > 0) and CompareNoCase(APropertiesValue[0],
    'auto') then
...
class procedure TdxCssParser.CssMsoPagination(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
var
  ACount, I: Integer;
begin
...
class procedure TdxCssParser.CssMsoSpacerunKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  AStyleValue: string;
begin
...
class procedure TdxCssParser.CssOpacityKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssOutlineKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssOutlineColorKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssOutlineStyleKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssOutlineWidthKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssOverflowKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssPaddingKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
var
  AProperties: TArray<string>;
begin
  ...
  case Length(AProperties) of
    1:
      CssPaddingKeywordCore(ACssProperties, AProperties[0], AProperties[0],
        AProperties[0], AProperties[0]);
    2:
      CssPaddingKeywordCore(ACssProperties, AProperties[0], AProperties[0],
        AProperties[1], AProperties[1]);
    3:
      CssPaddingKeywordCore(ACssProperties, AProperties[0], AProperties[2],
        AProperties[1], AProperties[1]);
    4:
      CssPaddingKeywordCore(ACssProperties, AProperties[2], AProperties[0],
        AProperties[3], AProperties[1]);
  end;
end;

class procedure TdxCssParser.CssPaddingKeywordCore(ACssProperties
  : TdxCssProperties; const ABottom: string; const ATop: string;
  const ALeft: string; const ARight: string);
begin
...
class procedure TdxCssParser.CssPaddingBottomKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
...
begin
  ...
  AParser := TdxLengthValueParser.Create(APropertiesValue[0],
    ACssProperties.UnitConverter.ScreenDpi);
  ...
  begin
    ...
    begin
      ...
      ACssProperties.CellProperties.CellMargins.Bottom.&Type :=
        TdxWidthUnitType.ModelUnits;
    end;
  end;
end;

class procedure TdxCssParser.CssPaddingLeftKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  AParser: TdxLengthValueParser;
  AValue: Integer;
begin
  ...
  begin
    ...
    begin
      ...
      ACssProperties.CellProperties.CellMargins.Left.&Type :=
        TdxWidthUnitType.ModelUnits;
    end;
  end;
end;

class procedure TdxCssParser.CssPaddingRightKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  AParser: TdxLengthValueParser;
  AValue: Integer;
begin
  ...
  begin
    ...
    begin
      ...
      ACssProperties.CellProperties.CellMargins.Right.&Type :=
        TdxWidthUnitType.ModelUnits;
    end;
  end;
end;

class procedure TdxCssParser.CssPaddingTopKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  AParser: TdxLengthValueParser;
  AValue: Integer;
begin
  ...
  begin
    ...
    begin
      ...
      ACssProperties.CellProperties.CellMargins.Top.&Type :=
        TdxWidthUnitType.ModelUnits;
    end;
  end;
end;

class procedure TdxCssParser.CssPageBreakAfterKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  if Length(APropertiesValue) = 0 then
    Exit;
...
class procedure TdxCssParser.CssPageBreakBeforeKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  if Length(APropertiesValue) = 0 then
    Exit;
...
class procedure TdxCssParser.CssPageBreakInsideKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  if Length(APropertiesValue) = 0 then
    Exit;
...
class procedure TdxCssParser.CssPositionKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssQuotesKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssRightKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssTableLayoutKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssTextAlignKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  ATextAlign: string;
begin
  ...
  if ATextAlign = 'LEFT' then
    ACssProperties.CssParagraphProperties.Alignment :=
      TdxParagraphAlignment.Left
  else if ATextAlign = 'RIGHT' then
    ACssProperties.CssParagraphProperties.Alignment :=
      TdxParagraphAlignment.Right
  else if ATextAlign = 'CENTER' then
    ACssProperties.CssParagraphProperties.Alignment :=
      TdxParagraphAlignment.Center
  else if ATextAlign = 'JUSTIFY' then
    ACssProperties.CssParagraphProperties.Alignment :=
      TdxParagraphAlignment.Justify;
end;

class procedure TdxCssParser.CssTextDecorationKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  AProperties: TArray<string>;
  ACount, I: Integer;
...
begin
  ...
  begin
    ...
    if AValue = 'LINE-THROUGH' then
      ACssProperties.CssCharacterProperties.FontStrikeoutType :=
        TdxStrikeoutType.Single
    else if AValue = 'UNDERLINE' then
      ACssProperties.CssCharacterProperties.FontUnderlineType :=
...
class procedure TdxCssParser.CssTextIndentKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  APar: TdxLengthValueParser;
  AIndent: Single;
begin
  ...
  if APar.IsRelativeUnit then
  begin
    ACssProperties.RelativeProperties.UnitRelativeFirstLineIndent :=
      APar.RelativeUnit;
    ACssProperties.CssParagraphProperties.FirstLineIndent := Round(AIndent);
  end
  else
    ACssProperties.CssParagraphProperties.FirstLineIndent :=
      Round(ACssProperties.UnitConverter.PointsToModelUnitsF(AIndent));
end;

class function TdxCssParser.SetMarginProperties(const APropertiesValue
  : TArray<string>; var AMarginValue: Single;
...
class function TdxCssParser.SetLineIndentType(ACssProperties: TdxCssProperties;
  AIndent: Single): Single;
begin
  if AIndent < 0 then
  begin
    ACssProperties.CssParagraphProperties.FirstLineIndentType :=
...
class procedure TdxCssParser.CssTextTransformKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
  if (Length(APropertiesValue) = 1) and
    (CompareText(APropertiesValue[0], 'uppercase') = 0) then
    ACssProperties.CssCharacterProperties.AllCaps := True;
end;

class procedure TdxCssParser.CssTopKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssUnicodeBidiKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssVerticalAlignKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
...
class procedure TdxCssParser.CssVisibilityKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssVisitedKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
begin
end;

class procedure TdxCssParser.CssWhiteSpaceKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
var
  AReadedValue: string;
begin
  ...
  else if AReadedValue = 'normal' then
    ACssProperties.CellProperties.NoWrap := False;
end;

class procedure TdxCssParser.CssWidthKeyword(ACssProperties: TdxCssProperties;
  const APropertiesValue: TArray<string>);
var
...
begin
  ...
  if ASeparatorPos > 1 then
    APropertyValue := TdxStringHelper.Substring(APropertyValue, 1,
      ASeparatorPos - 1);
  AParser := TdxLengthValueParser.Create(APropertyValue,
    ACssProperties.UnitConverter.ScreenDpi);
  if AParser.IsDigit and (AParser.PointsValue > 0) then
  begin
    if not AParser.IsRelativeUnit then
    begin
      ...
      ACssProperties.CellProperties.PreferredWidth.&Type :=
        TdxWidthUnitType.ModelUnits;
      ACssProperties.TableProperties.Width :=
        ACssProperties.CellProperties.PreferredWidth.Info;
...
class procedure TdxCssParser.CssWordSpacingKeyword(ACssProperties
  : TdxCssProperties; const APropertiesValue: TArray<string>);
begin
end;
