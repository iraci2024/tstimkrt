...
type
  ...
  public
    ...
    property Items[Index: Integer]: TdxReportCellShapeClass
  ...
  public
    ...
    property ShapeBorderColor: TColor read FShapeBorderColor
      write FShapeBorderColor;
    property ShapeBorderThickness: Integer read FShapeBorderThickness
    ...
    property ShapeTransparent: Boolean read GetShapeTransparent
      write SetShapeTransparent;
...
procedure TCustomdxReportCellShape.SetContentPattern
...
procedure TdxReportCellRoundRect.ConvertCoords(APixelsNumerator,
  APixelsDenominator: Integer);
begin
  inherited;
  FEllipseHeight := MulDiv(FEllipseHeight, APixelsNumerator,
    APixelsDenominator);
