...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Graphics, Classes, cxGeometry, cxGraphics, dxGDIPlusClasses,
  dxSpreadSheetTypes, dxSpreadSheetClasses, dxCore,
  dxSpreadSheetCore, dxSpreadSheetGraphics, dxSpreadSheetPrinting,
  dxSpreadSheetConditionalFormattingRules,
  dxSpreadSheetContainers, dxProtectionUtils, dxSpreadSheetCoreStyles;

type
  TdxSpreadSheetXLSXCellType = (sxctUnknown, sxctBoolean, sxctError, sxctFloat,
    sxctFormula, sxctSharedString, sxctString, sxctRichText);

const
  sdxXLSXCommonContentType = AnsiString
    ('application/vnd.openxmlformats-officedocument.spreadsheetml');
  sdxXLSXCommonRelationshipPath = AnsiString
    ('http://schemas.openxmlformats.org/officeDocument/2006/relationships');

  sdxXLSXChartsheetRelationship = sdxXLSXCommonRelationshipPath +
    AnsiString('/chartsheet');
  sdxXLSXCommentsRelationship = sdxXLSXCommonRelationshipPath +
    AnsiString('/comments');
  sdxXLSXCorePropertiesRelationship =
    'http://schemas.openxmlformats.org/package/2006/relationships/metadata/core-properties';
  sdxXLSXDrawingRelationship = sdxXLSXCommonRelationshipPath +
    AnsiString('/drawing');
  sdxXLSXExternalLinkPathRelationship = sdxXLSXCommonRelationshipPath +
    AnsiString('/externalLinkPath');
  sdxXLSXExternalLinkRelationship = sdxXLSXCommonRelationshipPath +
    AnsiString('/externalLink');
  sdxXLSXHyperlinkRelationship = sdxXLSXCommonRelationshipPath +
    AnsiString('/hyperlink');
  sdxXLSXImageRelationship = sdxXLSXCommonRelationshipPath +
    AnsiString('/image');
  sdxXLSXSharedStringRelationship = sdxXLSXCommonRelationshipPath +
    AnsiString('/sharedStrings');
  sdxXLSXStyleRelationship = sdxXLSXCommonRelationshipPath +
    AnsiString('/styles');
  sdxXLSXThemeRelationship = sdxXLSXCommonRelationshipPath +
    AnsiString('/theme');
  sdxXLSXVMLDrawingRelationship = sdxXLSXCommonRelationshipPath +
    AnsiString('/vmlDrawing');
  sdxXLSXWorkbookRelationship = sdxXLSXCommonRelationshipPath +
    AnsiString('/officeDocument');
  sdxXLSXWorksheetRelationship = sdxXLSXCommonRelationshipPath +
    AnsiString('/worksheet');

  sdxXLSXCommentsContentType = sdxXLSXCommonContentType +
    AnsiString('.comments+xml');
  sdxXLSXCorePropertiesContentType = AnsiString
    ('application/vnd.openxmlformats-package.core-properties+xml');
  sdxXLSXDrawingContentType = AnsiString
    ('application/vnd.openxmlformats-officedocument.drawing+xml');
  sdxXLSXExternalLinkContentType = sdxXLSXCommonContentType +
    AnsiString('.externalLink+xml');
  sdxXLSXRelsContentType = AnsiString
    ('application/vnd.openxmlformats-package.relationships+xml');
  sdxXLSXSharedStringsContentType = sdxXLSXCommonContentType +
    AnsiString('.sharedStrings+xml');
  sdxXLSXStylesContentType = sdxXLSXCommonContentType +
    AnsiString('.styles+xml');
  sdxXLSXWorkbookContentType = sdxXLSXCommonContentType +
    AnsiString('.sheet.main+xml');
  sdxXLSXWorkbookTemplateContentType = sdxXLSXCommonContentType +
    AnsiString('.template.main+xml');
  sdxXLSXWorksheetContentType = sdxXLSXCommonContentType +
    AnsiString('.worksheet+xml');

  sdxXLSXContentTypeNamespace = AnsiString
    ('http://schemas.openxmlformats.org/package/2006/content-types');
  sdxXLSXDrawingNamespace = AnsiString
    ('http://schemas.openxmlformats.org/drawingml/2006/main');
  sdxXLSXDrawingNamespaceXDR = AnsiString
    ('http://schemas.openxmlformats.org/drawingml/2006/spreadsheetDrawing');

  sdxXLSXRelsNamespace = AnsiString
    ('http://schemas.openxmlformats.org/package/2006/relationships');
  sdxXLSXWorkbookNamespace = AnsiString
  ...
  sdxXLSXFileTemplateExternalLink = AnsiString
...
const
  ...
  sdxXLSXAttrNegativeBarBorderColorSameAsPositive = AnsiString
    ('negativeBarBorderColorSameAsPositive');
  sdxXLSXAttrNegativeBarColorSameAsPositive = AnsiString
...
const
  ...
  dxXLSXBorderNames: array [TcxBorder] of AnsiString = ('left', 'top', 'right',
    'bottom');

  dxXLSXCellBorderStyleNames: array [TdxSpreadSheetCellBorderStyle]
    of AnsiString = ('', 'hair', 'dotted', 'dashDotDot', 'dashDot', 'dashed',
    'thin', 'mediumDashDotDot', 'slantDashDot', 'mediumDashDot', 'mediumDashed',
    'medium', 'thick', 'double', 'none');
  ...
  dxXLSXCellFillStyleNames: array [TdxSpreadSheetCellFillStyle] of AnsiString =
    ...
    'lightTrellis', 'lightGrid');
  dxXLSXFontStyles: array [TFontStyle] of AnsiString = ('b', 'i', 'u',
    'strike');

  dxXLSXRestrictionNames: array [TdxSpreadSheetContainerRestriction]
    of AnsiString = ('noCrop', 'noMove', 'noResize', 'noRot', 'noChangeAspect');

  dxXLSXShapeTypeMap: array [TdxSpreadSheetShapeType] of AnsiString = ('rect',
    'roundRect', 'ellipse');

  dxXLSXPenStyleMap: array [TdxGPPenStyle] of AnsiString = ('solid', 'dash',
    'dot', 'dashDot', 'lgDashDotDot');

  dxXLSXPrintCellComments
    : array [TdxSpreadSheetTableViewOptionsPrintSourceCellComments]
    of AnsiString = ('asDisplayed', 'atEnd', 'none');

  dxXLSXPrintErrorIndication
    : array [TdxSpreadSheetTableViewOptionsPrintSourceErrorIndication]
    of AnsiString = ('', 'blank', 'dash', 'displayed', 'NA');

  dxXLSXPrintPageOrientation
    : array [TdxSpreadSheetTableViewOptionsPrintPageOrientation] of AnsiString =
    ('default', 'landscape', 'portrait');

  dxXLSXPrintPageOrder
    : array [TdxSpreadSheetTableViewOptionsPrintPrintingPageOrder]
    of AnsiString = ('', 'downThenOver', 'overThenDown');

  dxXLSXCfCellIsRuleOperator
    : array [TdxSpreadSheetConditionalFormattingRuleCellIsComparisonOperator]
    of AnsiString = ('between', 'equal', 'greaterThan', 'greaterThanOrEqual',
    'lessThan', 'lessThanOrEqual', 'notBetween', 'notEqual');

  dxXLSXScaleStopValueTypeMap
    : array [TdxSpreadSheetConditionalFormattingRuleCustomScaleStopValueType]
    of AnsiString = ('', sdxXLSXValueTypeNum, sdxXLSXValueTypePercent,
    sdxXLSXValueTypeFormula, sdxXLSXValueTypePercentile);

  dxXLSXAxisPosition: array
    [TdxSpreadSheetConditionalFormattingRuleDataBarAxisPosition] of AnsiString =
    (sdxXLSXValueAxisAuto, sdxXLSXValueAxisMiddle, sdxXLSXValueAxisNone);

  dxXLSXDataBarDirectionMap
    : array [TdxSpreadSheetConditionalFormattingRuleDataBarDirection]
    of AnsiString = ('context', 'leftToRight', 'rightToLeft');

  dxXLSXAlignmentMap: array [TAlignment] of AnsiString = ('l', 'r', 'ctr');

  dxXLSXVerticalAlignmentMap: array [TVerticalAlignment] of AnsiString = ('t',
    'b', 'ctr');

  dxXLSXVMLDashStyle: array [TdxGPPenStyle] of string = ('solid', 'dash', 'dot',
    'dashdot', 'dashdotdot');

  dxXLSXVMLTextAlignHorzMap: array [TAlignment] of string = ('Left', 'Right',
    'Center');

  dxXLSXVMLTextAlignVertMap: array [TVerticalAlignment] of string = ('Top',
    'Bottom', 'Center');

  dxXLSXHashAlgorithmTypeNames: array [TdxHashAlgorithmType] of string = ('',
    'MD2', 'MD4', 'MD5', ' SHA-1', '', 'RIPEMD-128', 'RIPEMD-160', '', '', '',
...
type
  ...
  public
    class function AlignHorzToString(const S: TdxSpreadSheetDataAlignHorz)
      : AnsiString;
    class function AlignVertToString(const S: TdxSpreadSheetDataAlignVert)
      : AnsiString;
    class function BorderStyleToString(const S: TdxSpreadSheetCellBorderStyle)
      : AnsiString;
    class function FillStyleToString(const S: TdxSpreadSheetBrushHandle)
      : AnsiString;
    class function PenStyleToString(const S: TdxGPPenStyle): AnsiString;
    class function ShapeTypeToString(const S: TdxSpreadSheetShapeType)
      : AnsiString;

    class function StringToAlignHorz(const S: AnsiString)
      : TdxSpreadSheetDataAlignHorz;
    class function StringToAlignment(const S: AnsiString): TAlignment;
    class function StringToAlignVert(const S: AnsiString)
      : TdxSpreadSheetDataAlignVert;
    class function StringToAxisPosition(const S: AnsiString)
      : TdxSpreadSheetConditionalFormattingRuleDataBarAxisPosition;
    class function StringToBorderStyle(const S: AnsiString)
      : TdxSpreadSheetCellBorderStyle;
    class function StringToCellType(const S: AnsiString)
      : TdxSpreadSheetXLSXCellType;
    class function StringToCfCellIsRuleOperator(const S: AnsiString)
      : TdxSpreadSheetConditionalFormattingRuleCellIsComparisonOperator;
    class function StringToColorScaleStopValueType(const S: AnsiString)
      : TdxSpreadSheetConditionalFormattingRuleCustomScaleStopValueType;
    class function StringToDataBarDirection(const S: AnsiString)
      : TdxSpreadSheetConditionalFormattingRuleDataBarDirection;
    class function StringToFillStyle(const S: AnsiString)
    ...
    class function StringToPrintCellComments(const S: AnsiString)
      : TdxSpreadSheetTableViewOptionsPrintSourceCellComments;
    class function StringToPrintErrorIndication(const S: AnsiString)
      : TdxSpreadSheetTableViewOptionsPrintSourceErrorIndication;
    class function StringToPrintPageOrder(const S: AnsiString)
      : TdxSpreadSheetTableViewOptionsPrintPrintingPageOrder;
    class function StringToPrintPageOrientation(const S: AnsiString)
      : TdxSpreadSheetTableViewOptionsPrintPageOrientation;
    class function StringToShapeType(const S: AnsiString)
      : TdxSpreadSheetShapeType;
    class function StringToVerticalAlignment(const S: AnsiString)
      : TVerticalAlignment;
    ...
    class function StringToVMLTextAlignVert(const S: string)
      : TVerticalAlignment;
  end;
...
class function TdxSpreadSheetXLSXHelper.AlignHorzToString
  (const S: TdxSpreadSheetDataAlignHorz): AnsiString;
begin
  Result := dxXLSXAlignHorzNames[S];
end;

class function TdxSpreadSheetXLSXHelper.AlignVertToString
  (const S: TdxSpreadSheetDataAlignVert): AnsiString;
begin
  Result := dxXLSXAlignVertNames[S];
end;

class function TdxSpreadSheetXLSXHelper.BorderStyleToString
  (const S: TdxSpreadSheetCellBorderStyle): AnsiString;
begin
  Result := dxXLSXCellBorderStyleNames[S];
end;

class function TdxSpreadSheetXLSXHelper.FillStyleToString
  (const S: TdxSpreadSheetBrushHandle): AnsiString;
begin
...
class function TdxSpreadSheetXLSXHelper.PenStyleToString(const S: TdxGPPenStyle)
  : AnsiString;
begin
  Result := dxXLSXPenStyleMap[S];
end;

class function TdxSpreadSheetXLSXHelper.ShapeTypeToString
  (const S: TdxSpreadSheetShapeType): AnsiString;
begin
  Result := dxXLSXShapeTypeMap[S];
end;

class function TdxSpreadSheetXLSXHelper.StringToAlignHorz(const S: AnsiString)
  : TdxSpreadSheetDataAlignHorz;
var
...
class function TdxSpreadSheetXLSXHelper.StringToAlignment(const S: AnsiString)
  : TAlignment;
var
  I: TAlignment;
begin
...
class function TdxSpreadSheetXLSXHelper.StringToAlignVert(const S: AnsiString)
  : TdxSpreadSheetDataAlignVert;
var
...
class function TdxSpreadSheetXLSXHelper.StringToBorderStyle(const S: AnsiString)
  : TdxSpreadSheetCellBorderStyle;
var
  I: TdxSpreadSheetCellBorderStyle;
begin
  for I := Low(TdxSpreadSheetCellBorderStyle)
...
class function TdxSpreadSheetXLSXHelper.StringToCellType(const S: AnsiString)
  : TdxSpreadSheetXLSXCellType;
var
  I: TdxSpreadSheetXLSXCellType;
begin
  for I := Low(TdxSpreadSheetXLSXCellType)
    to High(TdxSpreadSheetXLSXCellType) do
  begin
...
begin
  for I := Low(TdxSpreadSheetConditionalFormattingRuleCellIsComparisonOperator)
    to High(TdxSpreadSheetConditionalFormattingRuleCellIsComparisonOperator) do
  begin
...
class function TdxSpreadSheetXLSXHelper.StringToFillStyle(const S: AnsiString)
  : TdxSpreadSheetCellFillStyle;
var
...
class function TdxSpreadSheetXLSXHelper.StringToHashAlgorithm(const S: string)
...
class function TdxSpreadSheetXLSXHelper.StringToPenStyle(const S: AnsiString)
  : TdxGPPenStyle;
const
...
begin
  for I := Low(TdxSpreadSheetTableViewOptionsPrintSourceCellComments)
    to High(TdxSpreadSheetTableViewOptionsPrintSourceCellComments) do
  begin
...
begin
  for I := Low(TdxSpreadSheetTableViewOptionsPrintSourceErrorIndication)
    to High(TdxSpreadSheetTableViewOptionsPrintSourceErrorIndication) do
  begin
...
class function TdxSpreadSheetXLSXHelper.StringToPrintPageOrder
  (const S: AnsiString): TdxSpreadSheetTableViewOptionsPrintPrintingPageOrder;
var
  I: TdxSpreadSheetTableViewOptionsPrintPrintingPageOrder;
begin
  for I := Low(TdxSpreadSheetTableViewOptionsPrintPrintingPageOrder)
    to High(TdxSpreadSheetTableViewOptionsPrintPrintingPageOrder) do
  begin
...
begin
  for I := Low(TdxSpreadSheetTableViewOptionsPrintPageOrientation)
    to High(TdxSpreadSheetTableViewOptionsPrintPageOrientation) do
  begin
...
class function TdxSpreadSheetXLSXHelper.StringToShapeType(const S: AnsiString)
  : TdxSpreadSheetShapeType;
var
...
class function TdxSpreadSheetXLSXHelper.StringToVerticalAlignment
  (const S: AnsiString): TVerticalAlignment;
var
...
class function TdxSpreadSheetXLSXHelper.StringToVMLDashStyle(S: AnsiString)
  : TdxGPPenStyle;
begin
  S := UpperCase(S);
...
class function TdxSpreadSheetXLSXHelper.StringToVMLTextAlignHorz
  (const S: string): TAlignment;
var
  I: TAlignment;
begin
  for I := Low(TAlignment) to High(TAlignment) do
...
class function TdxSpreadSheetXLSXHelper.StringToVMLTextAlignVert
  (const S: string): TVerticalAlignment;
var
  I: TVerticalAlignment;
begin
  for I := Low(TVerticalAlignment) to High(TVerticalAlignment) do
