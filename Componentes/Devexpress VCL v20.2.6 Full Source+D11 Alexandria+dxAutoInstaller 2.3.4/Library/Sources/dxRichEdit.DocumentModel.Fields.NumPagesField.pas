...
type
  ...
  public
    ...
    function ShouldInsertLayoutDependentRun(ASourcePieceTable
      : TdxCustomPieceTable): Boolean;
    function GetTopLevelPieceTable(ASourcePieceTable: TdxCustomPieceTable)
      : TdxCustomPieceTable;
...
function TdxNumPagesFieldResultFormatting.
  GetRecalculateOnSecondaryFormatting: Boolean;
begin
  Result := True;
end;

function TdxNumPagesFieldResultFormatting.GetValueCore(AFormatter: TObject;
...
function TdxNumPagesField.GetCalculatedValueCore(ASourcePieceTable
  ...
  begin
    ...
    try
      ATargetModel.MainPieceTable.InsertLayoutDependentTextRun(0, 0,
        TdxNumPagesFieldResultFormatting.Create(NumericFormatting,
        GeneralFormatting));
    finally
    ...
    Result := TdxCalculatedFieldValue.Create(TdxPieceTable(ASourcePieceTable)
      .DocumentModel.ExtendedDocumentProperties.Pages);
end;

function TdxNumPagesField.ShouldInsertLayoutDependentRun(ASourcePieceTable
  : TdxCustomPieceTable): Boolean;
var
...
function TdxNumPagesField.GetTopLevelPieceTable(ASourcePieceTable
  : TdxCustomPieceTable): TdxCustomPieceTable;
var
...
procedure TdxNumPagesField.ApplyFieldFormatting(AValue: TdxCalculatedFieldValue;
...
function TdxNumPagesField.GetAllowedUpdateFieldTypes(const AOptions
