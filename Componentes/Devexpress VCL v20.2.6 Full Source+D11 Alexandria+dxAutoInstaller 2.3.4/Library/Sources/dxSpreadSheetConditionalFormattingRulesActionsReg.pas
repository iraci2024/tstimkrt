...
{$ENDIF}
  ...
  dxSpreadSheetUIGeneratorScheme, dxUIGenerator;
...
begin
  ...
  begin
    ACategory := AComponent.Add(sdxSpreadSheetTabHome,
      sdxSpreadSheetBarHomeConditionalFormatting,
      'Conditional Formatting\ConditionalFormatting_16x16.png', 2);

    ACommand := ACategory.Add
      ('Conditional Formatting\ConditionalFormatting.png',
      sdxSpreadSheetSubItemHomeConditionalFormattingConditionalFormatting);

    AGallery := ACommand.Add
      (TdxSpreadSheetConditionalFormattingTopBottomRulesGallery, True, False,
      True, False, 1, 2, False);
    AGallery.Add(TdxSpreadSheetConditionalFormattingMoreRules);

    AGallery := ACommand.Add(TdxSpreadSheetConditionalFormattingDataBarsGallery,
      False, False, True, False, 3);
    AGallery.Add(TdxSpreadSheetConditionalFormattingMoreRules);

    AGallery := ACommand.Add
      (TdxSpreadSheetConditionalFormattingColorScalesGallery, False, False,
      True, False, 4);
    AGallery.Add(TdxSpreadSheetConditionalFormattingMoreRules);

    AGallery := ACommand.Add(TdxSpreadSheetConditionalFormattingIconSetsGallery,
      False, False, True, False, 2);
    AGallery.Add(TdxSpreadSheetConditionalFormattingMoreRules);

    ACommand.Add(TdxSpreadSheetConditionalFormattingNewRule,
