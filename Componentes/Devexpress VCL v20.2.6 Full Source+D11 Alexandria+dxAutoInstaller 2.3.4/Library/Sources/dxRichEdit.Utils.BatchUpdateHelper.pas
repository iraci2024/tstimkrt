...
type
  ...
  strict private
    ...
    function GetIsUpdateLocked: Boolean;
  public
    constructor Create(const ABatchUpdateHandler: IdxBatchUpdateHandler;
      ALifetimeStrategy: TLifetimeStrategy = TLifetimeStrategy.Persistent);
    ...
    property BatchUpdateHandler: IdxBatchUpdateHandler read FBatchUpdateHandler
      write FBatchUpdateHandler;
  ...
  public
    ...
    property DeferredNotifications: T read FDeferredNotifications
      write FDeferredNotifications;
    property FakeAssignDetected: Boolean read FFakeAssignDetected
      write FFakeAssignDetected;
    property IsDirectNotificationsEnabled: Boolean
      read GetIsDirectNotificationsEnabled;
    property IsIndexRecalculationOnEndInitEnabled: Boolean
      read GetIsIndexRecalculationOnEndInitEnabled;
  end;
  ...
  public
    destructor Destroy; override;
    property DeferredInfoNotifications: TInfo read FDeferredInfoNotifications
      write FDeferredInfoNotifications;
    property DeferredOptionsNotifications: TOptions
      read FDeferredOptionsNotifications write FDeferredOptionsNotifications;
  end;
...
constructor TdxBatchUpdateHelper.Create(const ABatchUpdateHandler
...
function TdxBatchUpdateHelper<T>.
  GetIsIndexRecalculationOnEndInitEnabled: Boolean;
begin
