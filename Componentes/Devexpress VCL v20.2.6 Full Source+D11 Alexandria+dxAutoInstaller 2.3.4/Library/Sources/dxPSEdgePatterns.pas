...
type
  ...
  protected
    procedure Initialize(APattern: TdxPSEdgePatternClass;
      AIsPrinting: Boolean); virtual;
  public
    constructor Create(APattern: TdxPSEdgePatternClass; AIsPrinting: Boolean);
    destructor Destroy; override;
    property Bitmaps[Orientation: TdxPSCellEdgePatternOrientation]: TBitmap
      read GetBitmap;
    property Brushes[Orientation: TdxPSCellEdgePatternOrientation]: TBrush
      read GetBrush;
  end;
  ...
  private
    ...
    function GetInternalItem(Index: Integer; IsPrinting: Boolean)
      : TdxPSEdgePatternItem;
    function GetItem(Pattern: TdxPSEdgePatternClass; IsPrinting: Boolean)
      : TdxPSEdgePatternItem;
    function GetPattern(Index: Integer): TdxPSEdgePatternClass;
    procedure SetInternalItem(Index: Integer; IsPrinting: Boolean;
  ...
  protected
    ...
    property InternalItems[Index: Integer; IsPrinting: Boolean]
      : TdxPSEdgePatternItem read GetInternalItem write SetInternalItem;
  public
    ...
    property Items[Pattern: TdxPSEdgePatternClass; IsPrinting: Boolean]
      : TdxPSEdgePatternItem read GetItem; default;
...
constructor TdxPSEdgePatternItem.Create(APattern: TdxPSEdgePatternClass;
  AIsPrinting: Boolean);
begin
  inherited Create;
...
procedure TdxPSEdgePatternItem.Initialize(APattern: TdxPSEdgePatternClass;
  AIsPrinting: Boolean);

  procedure InitializeOrientation(AOrientation
    : TdxPSCellEdgePatternOrientation);
  const
...
function TdxPSEdgePatternItem.GetBitmap(Orientation
  : TdxPSCellEdgePatternOrientation): TBitmap;
begin
  Result := FBitmaps[Orientation];
end;

function TdxPSEdgePatternItem.GetBrush(Orientation
  : TdxPSCellEdgePatternOrientation): TBrush;
begin
...
function TdxPSEdgePatternFactory.IndexOf
  (APattern: TdxPSEdgePatternClass): Integer;
begin
  ...
  begin
    ...
    if Index = -1 then
      raise EdxException.CreateFmt
        (cxGetResourceString(@sdxPatternIsNotRegistered), [Pattern.ClassName]);
    if InternalItems[Index, IsPrinting] = nil then
      InternalItems[Index, IsPrinting] := TdxPSEdgePatternItem.Create(Pattern,
        IsPrinting);
...
function TdxPSEdgePatternFactory.GetPattern(Index: Integer)
  : TdxPSEdgePatternClass;
begin
  Result := TdxPSEdgePatternClass(FPatterns[Index]);
end;

procedure TdxPSEdgePatternFactory.SetInternalItem(Index: Integer;
  IsPrinting: Boolean; Value: TdxPSEdgePatternItem);
begin
  if IsPrinting then
...
procedure TdxPSEdgePatternFactory.RemovePattern
  (APattern: TdxPSEdgePatternClass);
begin
  if HasItem(APattern) then
    RemovePatternItem(APattern);
  if HasPrintItem(APattern) then
    RemovePatternPrintItem(APattern);
  FPatterns.Remove(APattern)
end;

function TdxPSEdgePatternFactory.HasItem
  (APattern: TdxPSEdgePatternClass): Boolean;
begin
  Result := InternalItems[IndexOf(APattern), False] <> nil;
end;

function TdxPSEdgePatternFactory.HasPrintItem
  (APattern: TdxPSEdgePatternClass): Boolean;
begin
  Result := InternalItems[IndexOf(APattern), True] <> nil;
end;

procedure TdxPSEdgePatternFactory.RemovePatternItem
  (APattern: TdxPSEdgePatternClass);
var
...
procedure TdxPSEdgePatternFactory.RemovePatternPrintItem
  (APattern: TdxPSEdgePatternClass);
var
  Item: TdxPSEdgePatternItem;
begin
