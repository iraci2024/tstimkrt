...
type
  ...
  public
    function CreateAndParseElement(ANode: TdxXMLNode;
      const AElementName: TdxXMLString): TdxKmlElement; overload;
    function CreateAndParseElement(ANode: TdxXMLNode;
      const AElementNames: array of TdxXMLString): TdxKmlElement; overload;
    function CreateAndParseElements(ANode: TdxXMLNode;
      const AElementName: TdxXMLString): TdxFastObjectList; overload;
    function CreateAndParseElements(ANode: TdxXMLNode;
      const AElementNames: array of TdxXMLString): TdxFastObjectList; overload;
    class function GetParseName: string; virtual;
    function ParseBooleanElement(ANode: TdxXMLNode;
      const AElementName: TdxXMLString; ADefaultValue: Boolean): Boolean;
    function ParseDoubleAttribute(ANode: TdxXMLNode;
      const AElementName: TdxXMLString; ADefaultValue: Double): Double;
    function ParseDoubleElement(ANode: TdxXMLNode;
      const AElementName: TdxXMLString; ADefaultValue: Double): Double;
  ...
  protected
    function ParseColorElement(ANode: TdxXMLNode;
      const AElementName: TdxXMLString; ADefaultValue: TdxAlphaColor)
      : TdxAlphaColor;
  end;
  ...
  private
    ...
    FText: string;
    function ParseDisplayMode(ANode: TdxXMLNode;
      const AElementName: TdxXMLString; ADefaultValue: TdxKmlDisplayMode)
      : TdxKmlDisplayMode;
  protected
    procedure Parse(ANode: TdxXMLNode); override;
  public
  ...
  TdxKmlListItemType = (kliCheck, kliCheckOffOnly, kliCheckHideChildren,
    kliRadioFolder);
  TdxKmlItemIconMode = (kiimOpen, kiimClosed, kiimError, kiimFetching0,
    kiimFetching1, kiimFetching2);
  ...
  protected
    procedure Parse(ANode: TdxXMLNode); override;
    function ParseIconItemMode(ANode: TdxXMLNode;
      const AElementName: TdxXMLString; ADefaultValue: TdxKmlItemIconMode)
      : TdxKmlItemIconMode;
  public
    class function GetParseName: string; override;
  ...
  private
    ...
    function ParseListItemType(ANode: TdxXMLNode;
      const AElementName: TdxXMLString; ADefaultValue: TdxKmlListItemType)
      : TdxKmlListItemType;
...
function TdxKmlElementsFactory.GetElementClassByName(const AName: string)
  : TdxKmlElementClass;
var
  I: Integer;
...
function TdxKmlElementsFactory.CreateElementByName(const AName: TdxXMLString)
  : TdxKmlElement;
begin
...
procedure TdxKmlElementsFactory.RegisterElements(AElementClasses
  : array of TdxKmlElementClass);
var
  I: Integer;
begin
...
function TdxKmlElement.DoCreateAndParseElement(ANode: TdxXMLNode)
  : TdxKmlElement;
begin
...
function TdxKmlElement.CreateAndParseElements(ANode: TdxXMLNode;
  const AElementName: TdxXMLString): TdxFastObjectList;
var
...
function TdxKmlElement.CreateAndParseElements(ANode: TdxXMLNode;
const AElementNames: array of TdxXMLString): TdxFastObjectList;
var
  I: Integer;
begin
...
function TdxKmlElement.ParseBooleanElement(ANode: TdxXMLNode;
const AElementName: TdxXMLString; ADefaultValue: Boolean): Boolean;
var
  AText: string;
begin
...
function TdxKmlElement.ParseDoubleAttribute(ANode: TdxXMLNode;
const AElementName: TdxXMLString; ADefaultValue: Double): Double;
var
  AText: string;
begin
...
function TdxKmlElement.ParseDoubleElement(ANode: TdxXMLNode;
const AElementName: TdxXMLString; ADefaultValue: Double): Double;
var
  AText: string;
begin
...
begin
  ...
  if StyleSelector = nil then
    FStyleSelector := CreateAndParseElement(ANode, SdxKmlStyleMap)
      as TdxKmlStyleMap;
end;
...
procedure TdxKmlCoordinatesGeometry.Parse(ANode: TdxXMLNode);
  ...
  function IsEndOfTuples(const ARestOfTuples: string;
  out AEndOfTuple: Integer): Boolean;
  begin
  ...
  begin
    ...
    if ACommaPos1 <> 0 then
      FCoordinates[CoordinatesCount - 1].Longitude :=
        dxStrToFloat(Copy(ACurrentTuple, 1, ACommaPos1 - 1));
    ACommaPos2 := PosEx(',', ACurrentTuple, ACommaPos1 + 1);
    if ACommaPos2 = 0 then
      ACommaPos2 := Length(ACurrentTuple) + 1;
    FCoordinates[CoordinatesCount - 1].Latitude :=
      dxStrToFloat(Copy(ACurrentTuple, ACommaPos1 + 1,
      ACommaPos2 - ACommaPos1 - 1));
  end;
...
function TdxKmlCoordinatesGeometry.GetCoordinates(Index: Integer)
  : TdxKmlCoordinate;
begin
...
begin
  inherited;
  FLinearRing := CreateAndParseElement(ANode, SdxKmlLinearRing)
    as TdxKmlLinearRing;
end;
...
begin
  inherited;
  FInnerBoundaryIs := CreateAndParseElement(ANode, SdxKmlInnerBoundaryIs)
    as TdxKmlInnerBoundaryIs;
  FOuterBoundaryIs := CreateAndParseElement(ANode, SdxKmlOuterBoundaryIs)
    as TdxKmlOuterBoundaryIs;
end;
...
begin
  inherited;
  FGeometries := CreateAndParseElements(ANode, [SdxKmlPoint, SdxKmlLineString,
    SdxKmlPolygon, SdxKmlMultiGeometry]);
end;
...
begin
  inherited;
  FGeometry := CreateAndParseElement(ANode, [SdxKmlLineString, SdxKmlPoint,
    SdxKmlPolygon, SdxKmlMultiGeometry]) as TdxKmlGeometry;
end;
...
function TdxKmlHotSpot.ParseUnit(ANode: TdxXMLNode;
const AElementName: TdxXMLString; ADefaultValue: TdxKmlUnits): TdxKmlUnits;
var
  AText: string;
begin
  AText := ParseStringAttribute(ANode, AElementName, '');
  if AText = SdxKmlPixels then
    Result := kmluPixels
  else if AText = SdxKmlInsetPixels then
    Result := kmluInsetPixels
  else if AText = SdxKmlFraction then
    Result := kmluFraction
  else
    Result := ADefaultValue;
end;
...
const AElementName: TdxXMLString; ADefaultValue: TdxKmlColorMode)
  : TdxKmlColorMode;
var
  AText: string;
begin
  ...
  if AText = SdxKmlRandom then
    Result := kcmRandom
  else if AText = SdxKmlNormal then
    Result := kcmNormal
  else
    Result := ADefaultValue;
end;
...
begin
  inherited;
  FItemIconMode := ParseIconItemMode(ANode, SdxKmlIconItemMode,
    DefaultIconItemMode);
  FHRef := ParseStringElement(ANode, SdxKmlHRef, '');
end;
...
begin
  ...
  if AText = SdxKmlOpen then
    Result := kiimOpen
  else if AText = SdxKmlClosed then
    Result := kiimClosed
  else if AText = SdxKmlError then
    Result := kiimError
  else if AText = SdxKmlFetching0 then
    Result := kiimFetching0
  else if AText = SdxKmlFetching1 then
    Result := kiimFetching1
  else if AText = SdxKmlFetching2 then
...
begin
  inherited;
  FBgColor := ParseColorElement(ANode, SdxKmlBgColor, $FFFFFFFF);
  FListItemType := ParseListItemType(ANode, SdxKmlListItemType,
    DefaultListItemType);
  CreateAndParseItemIcons(ANode);
end;

function TdxKmlListStyle.ParseListItemType(ANode: TdxXMLNode;
const AElementName: TdxXMLString; ADefaultValue: TdxKmlListItemType)
  : TdxKmlListItemType;
var
  AText: string;
begin
  ...
  else if AText = SdxKmlCheckHideChildren then
    Result := kliCheckHideChildren
  else if AText = SdxKmlRadioFolder then
    Result := kliRadioFolder
  else if AText = SdxKmlCheck then
    Result := kliCheck
  else
    Result := ADefaultValue;
end;
...
begin
  ...
  FIconStyle := CreateAndParseElement(ANode, SdxKmlIconStyle)
    as TdxKmlIconStyle;
  FLabelStyle := CreateAndParseElement(ANode, SdxKmlLabelStyle)
    as TdxKmlLabelStyle;
  FLineStyle := CreateAndParseElement(ANode, SdxKmlLineStyle)
    as TdxKmlLineStyle;
  FPolyStyle := CreateAndParseElement(ANode, SdxKmlPolyStyle)
    as TdxKmlPolyStyle;
  FBalloonStyle := CreateAndParseElement(ANode, SdxKmlBalloonStyle)
    as TdxKmlBalloonStyle;
  FListStyle := CreateAndParseElement(ANode, SdxKmlListStyle)
    as TdxKmlListStyle;
end;
...
function TdxKmlPair.ParseKey(ANode: TdxXMLNode;
const AElementName: TdxXMLString; ADefaultValue: TdxKmlStyleState)
  : TdxKmlStyleState;
var
  AText: string;
begin
  ...
  if AText = SdxKmlNormalStyleState then
    Result := kssNormal
  else if AText = SdxKmlHighlightStyleState then
    Result := kssHighlight
  else
    Result := ADefaultValue;
end;
...
begin
  ...
  begin
    if APlacemark.StyleSelector is TdxKmlStyle then
      ...
      ResolveStyleMapStyles(TdxKmlStyleMap(APlacemark.StyleSelector),
        ANormalStyle, AHighlightedStyle);
  end
  else if APlacemark.StyleUrl <> '' then
...
dxKmlElementsFactory.RegisterElements([TdxKmlPlacemark, TdxKmlStyle,
  TdxKmlStyleMap, TdxKmlPoint, TdxKmlLineString, TdxKmlLinearRing,
  TdxKmlOuterBoundaryIs, TdxKmlInnerBoundaryIs, TdxKmlPolygon,
  TdxKmlMultiGeometry, TdxKmlIcon, TdxKmlHotSpot, TdxKmlIconStyle,
