...
{$ENDIF}
  ...
  StdCtrls, SysUtils,
  dxCore, dxCoreClasses, cxClasses, cxContainer, cxControls, cxFilter,
...
type
  ...
  strict private
    ...
    procedure ScaleFactorChangeHandler(Sender: TObject; M, D: Integer;
      IsLoading: Boolean);
  protected
    procedure Changed(AChangeType: TcxNavigatorChangeType;
  ...
  public
    ...
    property Items[Index: Integer]: TcxNavigatorCustomButton read GetItem
      write SetItem; default;
  end;

  { TcxCustomNavigatorButtons }

  TcxNavigatorButtonClickEvent = procedure(Sender: TObject;
    AButtonIndex: Integer; var ADone: Boolean) of object;
  ...
  protected
    ...
    function GetAdornerTargetElementName(ADefaultIndex: Integer)
      : string; virtual;
    ...
    property First: TcxNavigatorButton index NBDI_FIRST read GetButton
      write SetButton;
    property PriorPage: TcxNavigatorButton index NBDI_PRIORPAGE read GetButton
      write SetButton;
    property Prior: TcxNavigatorButton index NBDI_PRIOR read GetButton
      write SetButton;
    property Next: TcxNavigatorButton index NBDI_NEXT read GetButton
      write SetButton;
    property NextPage: TcxNavigatorButton index NBDI_NEXTPAGE read GetButton
      write SetButton;
    property Last: TcxNavigatorButton index NBDI_LAST read GetButton
      write SetButton;
    property Insert: TcxNavigatorButton index NBDI_INSERT read GetButton
      write SetButton;
    property Append: TcxNavigatorButton index NBDI_APPEND read GetButton
      write SetButton;
    property Delete: TcxNavigatorButton index NBDI_DELETE read GetButton
      write SetButton;
    property Edit: TcxNavigatorButton index NBDI_EDIT read GetButton
      write SetButton;
    property Post: TcxNavigatorButton index NBDI_POST read GetButton
      write SetButton;
    property Cancel: TcxNavigatorButton index NBDI_CANCEL read GetButton
      write SetButton;
    property CustomButtons: TcxNavigatorCustomButtons read FCustomButtons
      write SetCustomButtons;
    property Refresh: TcxNavigatorButton index NBDI_REFRESH read GetButton
      write SetButton;
    property SaveBookmark: TcxNavigatorButton index NBDI_SAVEBOOKMARK
      read GetButton write SetButton;
    property GotoBookmark: TcxNavigatorButton index NBDI_GOTOBOOKMARK
      read GetButton write SetButton;
    property Filter: TcxNavigatorButton index NBDI_FILTER read GetButton
      write SetButton;
  public
    ...
    property Buttons[Index: Integer]: TcxNavigatorButton
  ...
  TcxInfoPanelGetIRecordPosition = function
    : IcxNavigatorRecordPosition of object;
  TcxNavigatorInfoPanelClickEvent = procedure
    (Sender: TcxCustomNavigatorInfoPanel; Button: TMouseButton) of object;
  ...
  protected
    ...
    property IRecordPosition: IcxNavigatorRecordPosition
      read GetIRecordPosition;
  ...
  published
    property OnClick: TcxNavigatorInfoPanelClickEvent read FOnClick
      write FOnClick;
  end;

  { TcxNavigatorButtonViewInfo }

  TcxNavigatorButtonViewInfo = class(TcxIUnknownObject, IcxHintableObject,
    IdxFadingObject, IdxAdornerTargetElement)
  private
  ...
  protected
    ...
    procedure DrawGlyph(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState); virtual;
    // IdxFadingObject
  ...
  public
    ...
    property Items[Index: Integer]: TcxNavigatorButtonViewInfo read GetItem;
  ...
  protected
    ...
    procedure CalculateSize(var AWidth, AHeight: Integer;
      const AInfoPanelText: string; out AButtonIndent, AInfoPanelWidth
      : Integer);
    function CanButtonOverlapBorder: Boolean; virtual;
    procedure CheckCalculate;
    procedure ClearButtons;
    procedure DoRightToLeftConversion; virtual;
    function FindInfoPanelPositionIndex(const AInfoPanelText: string)
      : Integer; virtual;
    ...
    procedure PaintButtonsInplaceBackground(const ABounds: TRect;
      ACanvas: TcxCanvas); virtual;
    procedure PaintButtonsControlBackground(const ABounds: TRect;
      ACanvas: TcxCanvas); virtual;
    procedure PrepareButtonsBackground;
    procedure RightToLeftConversion;
    procedure UnprepareButtonsBackground;
    procedure ValidateButtonsViewInfos;

    property ButtonsBackground: TcxBitmap read FButtonsBackground;
    ...
    property InfoPanelViewInfo: TcxCustomNavigatorInfoPanelViewInfo
  ...
  public
    ...
    function GetButtonViewInfoByButton(AButton: TcxNavigatorButton)
      : TcxNavigatorButtonViewInfo;
    procedure MakeDirty;
  ...
  TcxCustomNavigator = class(TcxControl, IcxNavigatorOwner, IcxNavigatorOwner2,
  ...
  public
    ...
    property BorderStyle: TcxNavigatorBorderStyle read FBorderStyle
      write SetBorderStyle default nbsDefault;
  ...
  protected
    ...
    property Buttons: TcxNavigatorControlButtons read GetButtons
      write SetButtons;
    property Control: TComponent read FControl write SetControl;
    property InfoPanel: TcxNavigatorControlInfoPanel read GetInfoPanel
      write SetInfoPanel;
  public
    destructor Destroy; override;
  end;
...
begin
  ...
  if AIsNeedRecordIndex then
    Result := StringReplace(Result, '[RecordIndex]', '%0:s',
      [rfReplaceAll, rfIgnoreCase]);
  AIsNeedRecordCount := AnsiPos('[RecordCount]', ADisplayMask) > 0;
  if AIsNeedRecordCount then
    Result := StringReplace(Result, '[RecordCount]', '%1:s',
      [rfReplaceAll, rfIgnoreCase]);
end;
...
procedure TcxNavigatorChildComponent.Changed(AChangeType
  : TcxNavigatorChangeType; ANeedRefresh: Boolean = False);
begin
...
procedure TcxNavigatorChildComponent.ScaleFactorChangeHandler(Sender: TObject;
...
begin
  inherited;
  FButton := TcxNavigatorButton.Create
    (Collection.Owner as TcxCustomNavigatorButtons, True);
end;
...
function TcxNavigatorCustomButtons.GetItem(Index: Integer)
  : TcxNavigatorCustomButton;
begin
...
begin
  ...
  CreateButtons;
  FCustomButtons := TcxNavigatorCustomButtons.Create(Self,
    TcxNavigatorCustomButton);
  FConfirmDelete := True;
end;
...
function TcxCustomNavigatorButtons.GetAdornerTargetElementName
  (ADefaultIndex: Integer): string;
begin
...
function TcxCustomNavigatorButtons.GetButtonEnabled(ADefaultIndex
  : Integer): Boolean;
begin
  Result := IsNavigatorEnabled;
end;

function TcxCustomNavigatorButtons.GetButtonHint(ADefaultIndex
  : Integer): string;
begin
  case ADefaultIndex of
    NBDI_FIRST:
      Result := cxGetResourceString(@cxNavigatorHint_First);
    NBDI_PRIORPAGE:
      Result := cxGetResourceString(@cxNavigatorHint_PriorPage);
    NBDI_PRIOR:
      Result := cxGetResourceString(@cxNavigatorHint_Prior);
    NBDI_LAST:
      Result := cxGetResourceString(@cxNavigatorHint_Last);
    NBDI_NEXT:
      Result := cxGetResourceString(@cxNavigatorHint_Next);
    NBDI_NEXTPAGE:
      Result := cxGetResourceString(@cxNavigatorHint_NextPage);
    NBDI_INSERT:
      Result := cxGetResourceString(@cxNavigatorHint_Insert);
    NBDI_APPEND:
      Result := cxGetResourceString(@cxNavigatorHint_Append);
    NBDI_DELETE:
      Result := cxGetResourceString(@cxNavigatorHint_Delete);
    NBDI_EDIT:
      Result := cxGetResourceString(@cxNavigatorHint_Edit);
    NBDI_POST:
      Result := cxGetResourceString(@cxNavigatorHint_Post);
    NBDI_CANCEL:
      Result := cxGetResourceString(@cxNavigatorHint_Cancel);
    NBDI_REFRESH:
      Result := cxGetResourceString(@cxNavigatorHint_Refresh);
    NBDI_SAVEBOOKMARK:
      Result := cxGetResourceString(@cxNavigatorHint_SaveBookmark);
    NBDI_GOTOBOOKMARK:
      Result := cxGetResourceString(@cxNavigatorHint_GotoBookmark);
    NBDI_FILTER:
      Result := cxGetResourceString(@cxNavigatorHint_Filter);
  else
    Result := '';
  end;
end;
...
function TcxCustomNavigatorButtons.IsButtonVisibleByDefault
  (AIndex: Integer): Boolean;
begin
  Result := AIndex <> NBDI_APPEND;
end;

function TcxCustomNavigatorButtons.GetButton(Index: Integer)
  : TcxNavigatorButton;
begin
...
procedure TcxCustomNavigatorButtons.SetButton(Index: Integer;
  const Value: TcxNavigatorButton);
begin
...
begin
  FFormatString := cxGetNavigatorFormatString(GetDisplayMask,
    FIsNeedRecordIndex, FIsNeedRecordCount);
end;
...
function TcxCustomNavigatorInfoPanel.GetIRecordPosition
...
begin
  if not Enabled then
    Result := cxbsDisabled
  else if (Self = Owner.PressedButtonViewInfo) and
    (Self = Owner.HotTrackButtonViewInfo) then
    Result := cxbsPressed
  else if Self = Owner.HotTrackButtonViewInfo then
    Result := cxbsHot
  else
    Result := cxbsNormal;
end;
...
var
  ABitmap: TcxBitmap;
  ABounds, AContentRect, AImageRect, ABackgroundRect: TRect;
  AImageSize: TSize;
  APainter: TcxCustomLookAndFeelPainter;
...
begin
  ...
  AContentRect := cxRectContent(ABounds,
    APainter.NavigatorScaledButtonGlyphPadding(Button.ScaleFactor));
  CorrectButtonBounds(ABounds);

  ABitmap := TcxBitmap.CreateSize(ABounds, pf32bit);
  try
    ABackgroundRect := Owner.NavigatorOwner.GetNavigatorBounds;
    cxBitBlt(ABitmap.cxCanvas.Handle, Owner.ButtonsBackground.cxCanvas.Handle,
      ABitmap.ClientRect, Point(ABounds.Left - ABackgroundRect.Left,
      ABounds.Top - ABackgroundRect.Top), SRCCOPY);

    if not dxFader.DrawFadeImage(Self, ABitmap.Canvas.Handle, ABitmap.ClientRect)
    then
    ...
    begin
      ...
      if AState = cxbsPressed then
        AImageRect := cxRectOffset(AImageRect,
    ...
    cxBitBlt(ACanvas.Handle, ABitmap.Canvas.Handle, ABounds,
      cxNullPoint, SRCCOPY);
  finally
    ABitmap.Free;
  end;
...
procedure TcxNavigatorButtonViewInfo.DrawContent(ACanvas: TcxCanvas;
  const R: TRect; AState: TcxButtonState);
begin
  Painter.DrawNavigatorScaledButton(ACanvas, R, AState, clWindow,
    Button.ScaleFactor);
end;

procedure TcxNavigatorButtonViewInfo.DrawGlyph(ACanvas: TcxCanvas;
  const R: TRect; AState: TcxButtonState);
begin
...
procedure TcxNavigatorButtonViewInfo.GetFadingImages(out AFadeOutImage,
...
begin
  ...
  begin
    if (ANewState = cxbsHot) and (State = cxbsNormal) then
      dxFader.FadeIn(Self)
    else if (ANewState = cxbsNormal) and (State = cxbsHot) then
...
begin
  Result := Owner.NavigatorOwner.GetNavigatorLookAndFeel.GetAvailablePainter
    (totButton);
end;
...
function TcxNavigatorButtonsViewInfo.GetItem(Index: Integer)
  : TcxNavigatorButtonViewInfo;
begin
...
constructor TcxCustomNavigatorInfoPanelViewInfo.Create(ANavigatorViewInfo
  : TcxNavigatorViewInfo);
begin
  inherited Create;
...
begin
  Result := dxIsPaintOnGlass
    (FNavigatorViewInfo.NavigatorOwner.GetNavigatorControl);
end;

function TcxCustomNavigatorInfoPanelViewInfo.GetNavigatorOwner
  : IcxNavigatorOwner2;
begin
  Result := FNavigatorViewInfo.NavigatorOwner2;
end;

procedure TcxCustomNavigatorInfoPanelViewInfo.Calculate(const ABounds: TRect;
  const AText: string);
begin
  FBounds := ABounds;
  FText := AText;
...
begin
  ...
  begin
    ...
    try
      ...
      ABitmap.MakeOpaque;
      cxBitBlt(NavigatorViewInfo.Canvas.Handle, ABitmap.Canvas.Handle, Bounds,
        cxNullPoint, SRCCOPY);
    finally
      ABitmap.Free;
    end;
...
function TcxCustomNavigatorInfoPanelViewInfo.GetAdornerTargetElementControl
  : TWinControl;
begin
  Result := NavigatorOwner.GetNavigatorControl;
end;

function TcxCustomNavigatorInfoPanelViewInfo.
  GetAdornerTargetElementBounds: TRect;
begin
  Result := Bounds;
end;
...
procedure TcxCustomNavigatorInfoPanelViewInfo.DoRightToLeftConversion
...
constructor TcxNavigatorHintHelper.Create(ANavigatorViewInfo
  : TcxNavigatorViewInfo);
begin
  inherited Create;
  FNavigatorViewInfo := ANavigatorViewInfo;
...
begin
  ...
  CalculateSize(AWidth, AHeight, AInfoPanelText, AButtonIndent,
    AInfoPanelWidth);
...
function TcxNavigatorViewInfo.GetButtonViewInfoAt(const pt: TPoint)
  : TcxNavigatorButtonViewInfo;
var
  I: Integer;
begin
...
begin
  ...
  UpdateSelected;
  if (AButtonViewInfo <> nil) and PtInRect(AButtonViewInfo.Bounds, Point(X, Y))
    and AButtonViewInfo.Enabled then
...
begin
  ...
  ASelected := FIsSelected or (csDesigning in ANavigatorControl.ComponentState)
    and ANavigatorControl.Enabled;
  APainter := NavigatorOwner.GetNavigatorLookAndFeel.GetAvailablePainter
    (totButton);
  APainter.DrawNavigatorBorder(Canvas, ABounds, ASelected);
  if APainter.LookAndFeelStyle in [lfsUltraFlat, lfsOffice11] then
...
begin
  ...
  begin
    ...
    AInvalidateBounds := InfoPanelViewInfo.FBounds;
...
function TcxNavigatorViewInfo.FindInfoPanelPositionIndex(const AInfoPanelText
  : string): Integer;
var
  I: Integer;
begin
...
procedure TcxNavigatorViewInfo.CalculateBounds(const AInfoPanelText: string;
  AInfoPanelWidth, AHeight, AButtonIndent: Integer);
var
...
begin
  ...
  ANavigatorBounds := NavigatorOwner.GetNavigatorBounds;
  AButtonBounds.InitSize(ANavigatorBounds.Left, ANavigatorBounds.Top,
    0, AHeight);
...
begin
  ...
  ValidateButtonsViewInfos;
  Result := cxNullSize;
  CalculateSize(Result.cx, Result.cy, GetInfoPanelText, AButtonIndent,
    AInfoPanelWidth);
end;
...
procedure TcxNavigatorViewInfo.InvalidateButton
...
var
  I: Integer;
begin
  if FButtonsBackground <> nil then
    Exit;
  PrepareButtonsBackground;
  try
    for I := 0 to ButtonCount - 1 do
      PaintButton(I);
  finally
...
procedure TcxNavigatorViewInfo.PaintButtonsControlBackground
  (const ABounds: TRect; ACanvas: TcxCanvas);
begin
  cxDrawTransparentControlBackground(NavigatorOwner.GetNavigatorControl,
    ACanvas, ABounds, cxNullPoint)
end;

procedure TcxNavigatorViewInfo.PaintButtonsInplaceBackground
  (const ABounds: TRect; ACanvas: TcxCanvas);
var
  APainter: TcxCustomLookAndFeelPainter;
begin
  APainter := NavigatorOwner.GetNavigatorLookAndFeel.Painter;
  ACanvas.FillRect(ABounds, APainter.DefaultControlColor);
end;

procedure TcxNavigatorViewInfo.PrepareButtonsBackground;
var
  ANavigatorBounds: TRect;
begin
  ANavigatorBounds := NavigatorOwner.GetNavigatorBounds;
  FButtonsBackground := TcxBitmap.CreateSize(ANavigatorBounds, pf32bit);
  if FIsInplace then
    PaintButtonsInplaceBackground(FButtonsBackground.ClientRect,
      FButtonsBackground.cxCanvas)
  else
    PaintButtonsControlBackground(ANavigatorBounds,
      FButtonsBackground.cxCanvas);
end;
...
procedure TcxNavigatorViewInfo.UnprepareButtonsBackground;
begin
  FreeAndNil(FButtonsBackground);
end;
...
procedure TcxNavigatorViewInfo.SetFocusedButton
  (Value: TcxNavigatorButtonViewInfo);
var
...
begin
  ...
  begin
    AButtonViewInfo := Buttons[I];
    if AButtonViewInfo.Button.Visible and
      InRange(AButtonViewInfo.Button.DefaultIndex, NBDI_FIRST, NBDI_LAST) then
  ...
  begin
    ...
    if AButtonViewInfo.Button.Visible and
      ...
      AButtonViewInfo.Bounds := TdxRightToLeftLayoutConverter.ConvertRect
        (AButtonViewInfo.Bounds, ABounds);
...
begin
  ...
  begin
    ...
    if AInfoPanel.Width > 0 then
      Result.Init(AInfoPanel.Width, TdxTextMeasurer.TextLineHeight(AFont))
    else
    begin
      for I := 1 to Length(AText) do
        if (AText[I] >= '0') and (AText[I] <= '9') then
          AText[I] := '0';
      Result := TdxTextMeasurer.TextSizeTO(AFont, AText);
...
var
  ...
  APainter: TcxCustomLookAndFeelPainter;
begin
  Result := TcxNavigatorButtonViewInfo(FButtons[AButtonIndex])
    .Button.GetImageSize;
  APainter := NavigatorOwner.GetNavigatorLookAndFeel.GetAvailablePainter
    (totButton);
...
begin
  ...
  if (HotTrackButtonViewInfo <> nil) and
    (HotTrackButtonViewInfo = PressedButtonViewInfo) and
    PressedButtonViewInfo.Enabled and (PressedButtonViewInfo.Button.DefaultIndex
    in [NBDI_PRIOR, NBDI_NEXT]) then
    try
...
begin
  if not NavigatorOwner.GetNavigatorLookAndFeel.Painter.IsButtonHotTrack then
    Exit;
  ANavigatorControl := NavigatorOwner.GetNavigatorControl;
  AIsSelected := (HotTrackButtonViewInfo <> nil) or
    (PressedButtonViewInfo <> nil) or NavigatorOwner.GetNavigatorFocused or
    (not FIsInplace and HasInfoPanel and ANavigatorControl.HandleAllocated and
    PtInRect(InfoPanelViewInfo.Bounds,
    ANavigatorControl.ScreenToClient(GetMouseCursorPos)));
...
begin
  ...
  CalculateSize(FNavigatorSize.cx, FNavigatorSize.cy, AInfoPanelText,
    AButtonIndent, AInfoPanelWidth);
  UpdateNavigatorSiteBounds(GetNavigatorSiteBounds);
  CalculateBounds(AInfoPanelText, AInfoPanelWidth, FNavigatorSize.cy,
    AButtonIndent);
  CalculateButtons;
  FIsDirty := False;
end;
...
function TcxInplaceNavigatorViewInfo.GetLookAndFeelPainter
  : TcxCustomLookAndFeelPainter;
begin
  Result := NavigatorOwner.GetNavigatorLookAndFeel.Painter;
end;

function TcxInplaceNavigatorViewInfo.GetMinButtonSize
  (AButtonIndex: Integer): TSize;
begin
...
begin
  ...
  if not AOwnerControl.IsPopupScrollBars and AOwnerControl.HScrollBarVisible
  then
  begin
  ...
  begin
    ...
    if not AOwnerControl.IsPopupScrollBars and
      AOwnerControl.VScrollBarVisible and not AOwnerControl.HScrollBarVisible
    then
...
procedure TcxInplaceNavigatorViewInfo.UpdateNavigatorSiteBounds
  (const ABounds: TRect);
begin
  dxAbstractError;
end;
...
procedure TcxCustomNavigator.SetBorderStyle(const Value
  : TcxNavigatorBorderStyle);
begin
...
function TcxCustomNavigator.CanResize(var NewWidth, NewHeight: Integer)
  : Boolean;
begin
  Result := inherited CanResize(NewWidth, NewHeight);
  if Result and (FViewInfo <> nil) and HandleAllocated and not IsScaleChanging
  then
...
begin
  ...
  if (Key = VK_SPACE) and (FViewInfo.FocusedButton <> nil) and
    FViewInfo.FocusedButton.Enabled then
    FViewInfo.FocusedButton.Button.DoClick;
end;

procedure TcxCustomNavigator.MouseDown(Button: TMouseButton; Shift: TShiftState;
X, Y: Integer);
begin
...
procedure TcxCustomNavigator.MouseUp(Button: TMouseButton; Shift: TShiftState;
X, Y: Integer);
begin
...
procedure TcxCustomNavigator.Notification(AComponent: TComponent;
Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
  if not IsDestroying and (Operation = opRemove) and
    (AComponent = CustomButtons.Images) then
...
procedure TcxCustomNavigator.NavigatorChanged(AChangeType
  ...
  if FViewInfo <> nil then
    with Message do
      if ((Msg >= WM_KEYFIRST) and (Msg <= WM_KEYLAST)) or
        ((Msg = CM_ACTIVATE) or (Msg = CM_DEACTIVATE)) or (Msg = CM_APPKEYDOWN)
        or (Msg = CM_APPSYSCOMMAND) or (Msg = WM_COMMAND) or
        ((Msg > WM_MOUSEMOVE) and (Msg <= WM_MOUSELAST)) or
        (Msg = WM_NCMOUSEMOVE) then
...
procedure TcxNavigatorControlNotifier.AddNavigator
...
procedure TcxNavigatorControlNotifier.RemoveNavigator
  (ANavigator: IcxNavigatorOwner);
begin
...
begin
  ANavigatorControl := Control;
  if (ANavigatorControl <> nil) and ((ADefaultIndex <> NBDI_DELETE) or
    not ConfirmDelete or
...
function TcxNavigatorControlButtons.GetButtonEnabled(ADefaultIndex
  : Integer): Boolean;
var
  ANavigatorControl: IcxNavigator;
begin
...
begin
  Result.Font := Font;
  if ParentFont then
    Result.TextColor := Navigator.GetNavigatorLookAndFeel.Painter.
      NavigatorInfoPanelTextColor
  else
    Result.TextColor := Result.Font.Color;

  Result.Bitmap := nil;
  Result.Color := Navigator.GetNavigatorLookAndFeel.Painter.
    NavigatorInfoPanelColor;
end;
...
function TcxCustomNavigatorControl.GetButtonsClass
  : TcxNavigatorControlButtonsClass;
begin
  Result := TcxNavigatorControlButtons;
end;

function TcxCustomNavigatorControl.GetInfoPanelClass
  : TcxNavigatorControlInfoPanelClass;
begin
  Result := TcxNavigatorControlInfoPanel;
end;

procedure TcxCustomNavigatorControl.Notification(AComponent: TComponent;
Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
...
begin
  ...
  begin
    ...
    for I := 0 to NavigatorButtonCount - 1 do
      FButtons[I].RestoreDefaultVisible
        (ANavigator.IsActionSupported(FButtons[I].DefaultIndex));
  end;
end;
...
function TcxCustomNavigatorControl.GetIRecordPosition
  : IcxNavigatorRecordPosition;
begin
  if Control <> nil then
...
procedure TcxCustomNavigatorControl.SetButtons
...
procedure TcxCustomNavigatorControl.SetInfoPanel
  (Value: TcxNavigatorControlInfoPanel);
begin
