...
type
  ...
  TdxDocTableCellHorizontalMergingList = class
    (TdxObjectList<TdxDocTableCellHorizontalMerging>);

  { TdxDocImporter }

  TdxInsertDocObjectDelegate = reference to procedure(const ADocObject
    : IdxDocObject; APieceTable: TdxPieceTable;
  ...
  strict private
    ...
    FDocObjectDispatcher: array [TdxDocObjectType]
      of TdxInsertDocObjectDelegate;
    FCellsHorizontalMerging
      : TObjectDictionary<TdxTableRow, TdxDocTableCellHorizontalMergingList>;
  ...
  protected
    ...
    procedure ProcessDocObject(const ADocObject: IdxDocObject;
    ...
    procedure InsertText(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure InsertExpectedObjectAsText(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure InsertTextCore(const APlainText: string; AInfo: TdxCharacterInfo;
      APieceTable: TdxPieceTable; APos: TdxInputPosition);
    procedure InsertPictureFloatingObject(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure InsertPictureFloatingObjectCore(AFloatingObject
      : TdxDocPictureFloatingObject; AInputPosition: TdxInputPosition);
    procedure InsertTextBoxFloatingObject(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure InsertTextBoxFloatingObjectCore
      (ATextBox: TdxDocTextBoxFloatingObject; AInputPosition: TdxInputPosition);
    procedure InsertImage(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure InsertImageCore(AImage: TdxDocImage; APieceTable: TdxPieceTable;
      APosition: TdxInputPosition);
    procedure InsertFieldBegin(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure InsertFieldSeparator(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure InsertFieldEnd(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure InsertHyperlinkFieldData(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure InsertFootNoteReference(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure InsertFootNoteContent(ANote: TdxFootNote;
      ACharacterPosition: Integer);
    procedure InsertEndnoteReference(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure InsertEndNoteContent(ANote: TdxEndNote;
      ACharacterPosition: Integer);
    procedure InsertEmbeddedContent(APieceTable: TdxPieceTable;
      AContent: TdxDocObjectCollection);
    procedure InsertNoteNumber(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure TryInsertFootNoteNumber(APosition: TdxInputPosition;
      APieceTable: TdxPieceTable);
    procedure TryInsertEndNoteNumber(APosition: TdxInputPosition;
      APieceTable: TdxPieceTable);
    procedure InsertAnnotationReference(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure InsertCommentContent(ACommentContent: TdxCommentContentType;
      ACharacterPosition: Integer);
    procedure InsertTableCell(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure InsertTableRow(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure ProcessParagraphListInfoIndex(APieceTable: TdxPieceTable;
      AIndex: TdxParagraphIndex; AInfo: TdxParagraphInfo);
    procedure SpecifyCharacterFormattingForInputPosition
      (AInfo: TdxCharacterInfo; APosition: TdxInputPosition);
    procedure AddDelayedTextFormatting(AInfo: TdxCharacterInfo;
      APieceTable: TdxPieceTable);
    procedure AddDelayedImageFormatting(AInfo: TdxCharacterInfo;
      APieceTable: TdxPieceTable);
    procedure AddDelayedFormattingCore(AInfo: TdxCharacterInfo;
      APieceTable: TdxPieceTable; ARun: TdxTextRunBase);
    procedure ProcessDelayedFormatting;
    procedure InsertParagraph(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure SetDefaultDocumentProperties; virtual;
    procedure SetCharacterProperties(AInputPosition: TdxInputPosition;
      APropertyContainer: TdxDocPropertyContainer);
    procedure SetParagraphProperties(APieceTable: TdxPieceTable;
      AParagraphIndex: TdxParagraphIndex;
      APropertyContainer: TdxDocPropertyContainer; ASectionMark: Boolean);
    procedure InsertSection(const ADocObject: IdxDocObject;
      APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
    procedure ApplySectionProperties(APropertyContainer
    ...
    property ImportInfoStack: TObjectStack<TdxDocImportPieceTableInfo>
      read FImportInfoStack;
    property ActiveImportInfo: TdxDocImportPieceTableInfo
      read GetActiveImportInfo;
    property StylesImportHelper: TdxDocStylesImportHelper
      read FStylesImportHelper;
  ...
  public
    ...
    procedure MergeCellsHorizontally(ARow: TdxTableRow;
    ...
    procedure AddCellsHorizontalMerging(ARow: TdxTableRow;
      AFirstCellIndex: Integer; ASpan: Integer);

    property CellsHorizontalMerging
      : TObjectDictionary<TdxTableRow, TdxDocTableCellHorizontalMergingList>
      read FCellsHorizontalMerging;
...
type
  ...
  TdxDocTableCellHorizontalMergingComparer = class(TInterfacedObject,
    IComparer<TdxDocTableCellHorizontalMerging>)
  protected
    function Compare(const Left,
      Right: TdxDocTableCellHorizontalMerging): Integer;
  end;

  { TdxDocTableCellHorizontalMergingComparer }

function TdxDocTableCellHorizontalMergingComparer.Compare(const Left,
  Right: TdxDocTableCellHorizontalMerging): Integer;
begin
...
constructor TdxDocImportPieceTableInfo.Create(AImporter: TdxDocImporter;
  APieceTable: TdxPieceTable);
begin
  inherited Create;
  ...
  FFieldsImporter := TdxDocFieldsImporter.Create(APieceTable,
    FPieceTableInfo.FieldInfoStack);
end;
...
constructor TdxDocTableCellHorizontalMerging.Create(AFirstCellIndex: Integer;
  ACount: Integer);
begin
  inherited Create;
...
constructor TdxDocImporter.Create(ADocumentModel: TdxCustomDocumentModel;
...
begin
  ...
  FDocObjectDispatcher[TdxDocObjectType.PictureFloatingObject] :=
    InsertPictureFloatingObject;
  FDocObjectDispatcher[TdxDocObjectType.TextBoxFloatingObject] :=
    InsertTextBoxFloatingObject;
  ...
  FDocObjectDispatcher[TdxDocObjectType.HyperlinkFieldData] :=
    InsertHyperlinkFieldData;
  FDocObjectDispatcher[TdxDocObjectType.AutoNumberedFootnoteReference] :=
    InsertFootNoteReference;
  FDocObjectDispatcher[TdxDocObjectType.AnnotationReference] :=
    InsertAnnotationReference;
  FDocObjectDispatcher[TdxDocObjectType.EndnoteReference] :=
    InsertEndnoteReference;
  ...
  FDocObjectDispatcher[TdxDocObjectType.ExpectedFieldBegin] :=
    InsertExpectedObjectAsText;
  FDocObjectDispatcher[TdxDocObjectType.ExpectedFieldSeparator] :=
    InsertExpectedObjectAsText;
  FDocObjectDispatcher[TdxDocObjectType.ExpectedFieldEnd] :=
    InsertExpectedObjectAsText;
end;
...
begin
  ...
  try
    ...
    FCellsHorizontalMerging :=
      TObjectDictionary<TdxTableRow, TdxDocTableCellHorizontalMergingList>.
      Create([doOwnsValues]);
    FContentBuilder := TdxDocContentBuilder.Create(DocumentModel,
      TdxDocDocumentImporterOptions(Options));
    try
      try
...
procedure TdxDocImporter.MergeCellsHorizontally(ARow: TdxTableRow;
  AMerging: TdxDocTableCellHorizontalMerging);
var
  APieceTable: TdxPieceTable;
...
begin
  ...
  begin
    ...
    APieceTable.DeleteContent(APieceTable.Paragraphs[ACell.StartParagraphIndex]
      .LogPosition, 1, False);
    ARow.Cells.DeleteInternal(ACell);
  end;
  AFirstCell := ARow.Cells[AFirstCellIndex];
  AFirstCell.ColumnSpan := AFirstCell.ColumnSpan + ASpan - 1;
  if AFirstCell.Properties.PreferredWidth.&Type = TdxWidthUnitType.ModelUnits
  then
    AFirstCell.Properties.PreferredWidth.Value :=
      AFirstCell.Properties.PreferredWidth.Value + ASummaryWidth;
end;

procedure TdxDocImporter.ImportDocument;
begin
  FDelayedFormatting := TDictionary<TdxTextRunBase, TdxCharacterInfo>.Create;
  FStylesImportHelper := TdxDocStylesImportHelper.Create(ContentBuilder,
    DocumentModel);
  FListsImportHelper := TdxDocListsImportHelper.Create(ContentBuilder,
    DocumentModel);
  try
    ImportContent;
...
begin
  DocumentModel.DocumentProperties.DisplayBackgroundShape :=
    ContentBuilder.DocumentProperties.DisplayBackgroundShape;
end;
...
var
  I: Integer;
begin
  DocumentModel.DocumentProperties.DifferentOddAndEvenPages :=
    ContentBuilder.DocumentProperties.DifferentOddAndEvenPages;
...
begin
  ADocObjects := ContentBuilder.Iterator.HeadersFooters.GetEvenPageHeaderObjects
    (ASectionIndex);
...
begin
  ADocObjects := ContentBuilder.Iterator.HeadersFooters.GetEvenPageFooterObjects
    (ASectionIndex);
  ACurrentSection := DocumentModel.Sections[ASectionIndex];
  if (ADocObjects = nil) or (ADocObjects.Count = 0) then
  begin
...
begin
  ADocObjects := ContentBuilder.Iterator.HeadersFooters.GetOddPageHeaderObjects
    (ASectionIndex);
  ACurrentSection := DocumentModel.Sections[ASectionIndex];
  if (ADocObjects = nil) or (ADocObjects.Count = 0) then
  begin
...
begin
  ADocObjects := ContentBuilder.Iterator.HeadersFooters.GetOddPageFooterObjects
    (ASectionIndex);
  ACurrentSection := DocumentModel.Sections[ASectionIndex];
  if (ADocObjects = nil) or (ADocObjects.Count = 0) then
  begin
...
begin
  ADocObjects := ContentBuilder.Iterator.HeadersFooters.
    GetFirstPageHeaderObjects(ASectionIndex);
  ACurrentSection := DocumentModel.Sections[ASectionIndex];
  if (ADocObjects = nil) or (ADocObjects.Count = 0) then
  begin
...
begin
  ADocObjects := ContentBuilder.Iterator.HeadersFooters.
    GetFirstPageFooterObjects(ASectionIndex);
  ACurrentSection := DocumentModel.Sections[ASectionIndex];
  if (ADocObjects = nil) or (ADocObjects.Count = 0) then
  begin
...
begin
  ContentBuilder.DocumentVariables.SetVariables(DocumentModel.Variables,
    DocumentModel.DocumentProperties);
end;

procedure TdxDocImporter.ProcessDocObject(const ADocObject: IdxDocObject;
  APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
var
...
begin
  ...
  begin
    ContentBuilder.Iterator.AdvancePosition(AInputPosition.LogPosition,
      ADocObject.Position, ADocObject.Length);
...
begin
  ...
  if (IsContainsParagraphFrame) or (FStylesImportHelper.IsContainsParagraphFrame)
  then
    ATargetPieceTable.FixParagraphFramesInTables;
  ImportInfoStack.Pop;
end;

procedure TdxDocImporter.FixAbsentLastParagraph(ATargetPieceTable
  : TdxPieceTable);
var
...
procedure TdxDocImporter.InsertText(const ADocObject: IdxDocObject;
  APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
begin
  InsertTextCore((TdxDocTextRun(ADocObject)).Text,
    ADocObject.PropertyContainer.CharacterInfo, APieceTable, AInputPosition);
end;

procedure TdxDocImporter.InsertExpectedObjectAsText(const ADocObject
  : IdxDocObject; APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
begin
  InsertTextCore((TdxExpectedDocObject(ADocObject)).Text,
    ADocObject.PropertyContainer.CharacterInfo, APieceTable, AInputPosition);
end;
...
procedure TdxDocImporter.InsertPictureFloatingObject(const ADocObject
  : IdxDocObject; APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
begin
  InsertPictureFloatingObjectCore(TdxDocPictureFloatingObject(ADocObject),
    AInputPosition);
end;

procedure TdxDocImporter.InsertPictureFloatingObjectCore(AFloatingObject
  : TdxDocPictureFloatingObject; AInputPosition: TdxInputPosition);
var
  ARun: TdxFloatingObjectAnchorRun;
  AImage: TdxOfficeImageReference;
begin
  SpecifyCharacterFormattingForInputPosition
    (AFloatingObject.PropertyContainer.CharacterInfo, AInputPosition);
  ARun := ActiveImportInfo.PieceTable.InsertFloatingObjectAnchorCore
    (AInputPosition);
...
procedure TdxDocImporter.InsertTextBoxFloatingObject(const ADocObject
  : IdxDocObject; APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
begin
  InsertTextBoxFloatingObjectCore(TdxDocTextBoxFloatingObject(ADocObject),
    AInputPosition);
end;

procedure TdxDocImporter.InsertTextBoxFloatingObjectCore
  (ATextBox: TdxDocTextBoxFloatingObject; AInputPosition: TdxInputPosition);
var
  APieceTable: TdxPieceTable;
  ARun: TdxFloatingObjectAnchorRun;
...
begin
  SpecifyCharacterFormattingForInputPosition
    (ATextBox.PropertyContainer.CharacterInfo, AInputPosition);
  ...
  AddDelayedTextFormatting(ATextBox.PropertyContainer.CharacterInfo,
    APieceTable);
  ...
  InsertEmbeddedContent(TdxPieceTable(ATextBoxContentType.PieceTable),
    ATextBoxContent);
end;

procedure TdxDocImporter.InsertImage(const ADocObject: IdxDocObject;
  APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
var
  AImage: TdxDocImage;
begin
...
procedure TdxDocImporter.InsertImageCore(AImage: TdxDocImage;
  APieceTable: TdxPieceTable; APosition: TdxInputPosition);
var
...
begin
  if not DocumentModel.DocumentCapabilities.InlinePicturesAllowed then
    Exit;
  SpecifyCharacterFormattingForInputPosition
    (AImage.PropertyContainer.CharacterInfo, APosition);
  ...
  AddDelayedImageFormatting(AImage.PropertyContainer.CharacterInfo,
    APieceTable);
end;

procedure TdxDocImporter.InsertFieldBegin(const ADocObject: IdxDocObject;
  APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
begin
  ActiveImportInfo.FieldsImporter.ProcessFieldBegin(AInputPosition);
end;

procedure TdxDocImporter.InsertFieldSeparator(const ADocObject: IdxDocObject;
  APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
begin
  ActiveImportInfo.FieldsImporter.ProcessFieldSeparator(AInputPosition);
end;

procedure TdxDocImporter.InsertFieldEnd(const ADocObject: IdxDocObject;
  APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
begin
  ActiveImportInfo.FieldsImporter.ProcessFieldEnd(AInputPosition,
    ADocObject.PropertyContainer);
end;

procedure TdxDocImporter.InsertHyperlinkFieldData(const ADocObject
  : IdxDocObject; APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
var
...
procedure TdxDocImporter.InsertFootNoteReference(const ADocObject: IdxDocObject;
  APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
var
...
procedure TdxDocImporter.InsertFootNoteContent(ANote: TdxFootNote;
  ACharacterPosition: Integer);
var
  ANoteContent: TdxDocObjectCollection;
begin
  ANoteContent := ContentBuilder.Iterator.NotesIterator.GetFootNoteObjects
    (ACharacterPosition);
  InsertEmbeddedContent(TdxPieceTable(ANote.PieceTable), ANoteContent);
end;

procedure TdxDocImporter.InsertEndnoteReference(const ADocObject: IdxDocObject;
  APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
var
  AEndNote: TdxEndNote;
...
procedure TdxDocImporter.InsertEndNoteContent(ANote: TdxEndNote;
  ACharacterPosition: Integer);
var
  ANoteContent: TdxDocObjectCollection;
begin
  ANoteContent := ContentBuilder.Iterator.NotesIterator.GetEndNoteObjects
    (ACharacterPosition);
  InsertEmbeddedContent(TdxPieceTable(ANote.PieceTable), ANoteContent);
end;

procedure TdxDocImporter.InsertEmbeddedContent(APieceTable: TdxPieceTable;
  AContent: TdxDocObjectCollection);
var
  APosition: TdxInputPosition;
...
procedure TdxDocImporter.InsertNoteNumber(const ADocObject: IdxDocObject;
  APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
var
  AInfo: TdxCharacterInfo;
begin
  ...
  else if APieceTable.ContentType is TdxEndNote then
    TryInsertEndNoteNumber(AInputPosition, APieceTable);
  AddDelayedTextFormatting(AInfo, APieceTable);
end;

procedure TdxDocImporter.TryInsertFootNoteNumber(APosition: TdxInputPosition;
  APieceTable: TdxPieceTable);
var
  AIndex: Integer;
begin
...
procedure TdxDocImporter.TryInsertEndNoteNumber(APosition: TdxInputPosition;
  APieceTable: TdxPieceTable);
var
  AIndex: Integer;
begin
...
procedure TdxDocImporter.InsertAnnotationReference(const ADocObject
  : IdxDocObject; APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
begin
end;

procedure TdxDocImporter.InsertCommentContent(ACommentContent
  : TdxCommentContentType; ACharacterPosition: Integer);
begin
end;

procedure TdxDocImporter.InsertTableCell(const ADocObject: IdxDocObject;
  APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
begin
...
procedure TdxDocImporter.InsertTableRow(const ADocObject: IdxDocObject;
  APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
var
  APropertyContainer: TdxDocPropertyContainer;
...
begin
  ...
  if ATableStyleIndex >= 0 then
    AStyleIndex := StylesImportHelper.GetStyleIndex
      (APropertyContainer.TableInfo.TableStyleIndex, TdxStyleType.TableStyle)
  else
    AStyleIndex := -1;
...
procedure TdxDocImporter.ProcessParagraphListInfoIndex
  (APieceTable: TdxPieceTable; AIndex: TdxParagraphIndex;
...
begin
  ...
  begin
    ...
    if AActualListIndex < NumberingListIndexMinValue then
      Exit;
    if AListLevel >= DocumentModel.NumberingLists[AActualListIndex].Levels.Count
    then
      AListLevel := 0;
    APieceTable.AddNumberingListToParagraph(AParagraph,
      NumberingListIndexNoNumberingList, AListLevel);
  end;
  if (AListInfoIndex > 0) and
    (AListInfoIndex - 1 < DocumentModel.NumberingLists.Count) then
  begin
    APieceTable.AddNumberingListToParagraph(AParagraph, AListInfoIndex - 1,
      AListLevel);
  end;
end;

procedure TdxDocImporter.SpecifyCharacterFormattingForInputPosition
  (AInfo: TdxCharacterInfo; APosition: TdxInputPosition);
var
  AIsInverted: Boolean;
...
begin
  if AInfo = nil then
  begin
    APosition.CharacterFormatting.ResetUse
      (TdxCharacterFormattingOptions.MaskUseAll);
    APosition.CharacterStyleIndex :=
      DocumentModel.CharacterStyles.DefaultItemIndex;
    Exit;
  end;
  APosition.CharacterStyleIndex := StylesImportHelper.GetStyleIndex
    (AInfo.FormattingInfo.StyleIndex, TdxStyleType.CharacterStyle);
  AIsInverted := AInfo.FormattingInfo.ContainsInvertedProperties;

  if not AIsInverted then
  begin
    AFormattingInfo := StylesImportHelper.GetCharacterFormattingInfo
      (AInfo.FormattingInfo);
    try
      APosition.CharacterFormatting.CopyFrom(AFormattingInfo,
        AInfo.FormattingOptions);
    finally
...
procedure TdxDocImporter.AddDelayedTextFormatting(AInfo: TdxCharacterInfo;
  APieceTable: TdxPieceTable);
begin
  AddDelayedFormattingCore(AInfo, APieceTable,
    APieceTable.LastInsertedRunInfo.Run);
end;

procedure TdxDocImporter.AddDelayedImageFormatting(AInfo: TdxCharacterInfo;
  APieceTable: TdxPieceTable);
begin
  AddDelayedFormattingCore(AInfo, APieceTable,
    APieceTable.LastInsertedInlinePictureRunInfo.Run);
end;

procedure TdxDocImporter.AddDelayedFormattingCore(AInfo: TdxCharacterInfo;
  APieceTable: TdxPieceTable; ARun: TdxTextRunBase);
begin
  if (ARun = nil) or (AInfo = nil) or
    (not AInfo.FormattingInfo.ContainsInvertedProperties) then
    Exit;
...
begin
  ...
  begin
    ...
    try
      ...
      AInfo := TdxDocCharacterFormattingHelper.GetMergedCharacterFormattingInfo
        (ACharacterInfo.FormattingInfo, AProperties.Info, DocumentModel);
      try
        AMergedCharacterProperties := TdxMergedCharacterProperties.Create(AInfo,
          ACharacterInfo.FormattingOptions);
        try
...
procedure TdxDocImporter.InsertParagraph(const ADocObject: IdxDocObject;
  APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
var
  AParagraphIndex: TdxParagraphIndex;
  APropertyContainer: TdxDocPropertyContainer;
begin
  ...
  SetParagraphProperties(APieceTable, AParagraphIndex,
    APropertyContainer, False);
end;
...
begin
  ...
  DocumentModel.DefaultParagraphProperties.LineSpacingType :=
    TdxRichEditParagraphLineSpacing.Single;
  DocumentModel.DefaultParagraphProperties.SpacingBefore := 0;
  DocumentModel.DefaultParagraphProperties.SpacingAfter := 0;
end;

procedure TdxDocImporter.SetCharacterProperties(AInputPosition
  : TdxInputPosition; APropertyContainer: TdxDocPropertyContainer);
var
...
begin
  ...
  begin
    AInputPosition.CharacterFormatting.ResetUse
      (TdxCharacterFormattingOptions.MaskUseAll);
    Exit;
  end;
  ...
  try
    AInputPosition.CharacterFormatting.CopyFrom(AFormattingInfo,
      AFormattingOptions);
  finally
    AFormattingInfo.Free;
  end;
  AInputPosition.CharacterStyleIndex := StylesImportHelper.GetStyleIndex
    (AInfo.StyleIndex, TdxStyleType.CharacterStyle);
end;

procedure TdxDocImporter.SetParagraphProperties(APieceTable: TdxPieceTable;
  AParagraphIndex: TdxParagraphIndex;
  APropertyContainer: TdxDocPropertyContainer; ASectionMark: Boolean);
var
  AParagraph: TdxParagraph;
...
begin
  ...
  begin
    AMergedParagraphProperties := TdxMergedParagraphProperties.Create
      (AParagraphInfo.FormattingInfo, AParagraphInfo.FormattingOptions);
    try
    ...
    AParagraph.ParagraphStyleIndex := StylesImportHelper.GetStyleIndex
      (AParagraphInfo.ParagraphStyleIndex, TdxStyleType.ParagraphStyle);
    ProcessParagraphListInfoIndex(APieceTable, AParagraphIndex, AParagraphInfo);
    AFrameInfo := APropertyContainer.FrameInfo;
    if (AFrameInfo <> nil) and DocumentModel.DocumentCapabilities.ParagraphFramesAllowed
    then
    begin
      if not IsContainsParagraphFrame then
        IsContainsParagraphFrame := True;
      AParagraph.CreateFrameProperties;
      AMergedFrameProperties := TdxMergedFrameProperties.Create
        (AFrameInfo.FormattingInfo, AFrameInfo.FormattingOptions);
      try
  ...
  if not ASectionMark then
    ActiveImportInfo.TablesImporter.ParagraphAdded(AParagraph,
      APropertyContainer);
  if FDelayedFormatting.Count > 0 then
    ProcessDelayedFormatting;
end;

procedure TdxDocImporter.InsertSection(const ADocObject: IdxDocObject;
  APieceTable: TdxPieceTable; AInputPosition: TdxInputPosition);
var
  AParagraphIndex: TdxParagraphIndex;
...
procedure TdxDocImporter.ApplySectionProperties(APropertyContainer
  : TdxDocPropertyContainer);
var
  ACurrentSection: TdxSection;
begin
  if (APropertyContainer.SectionInfo = nil) or
    (FCurrentSectionIndex >= DocumentModel.Sections.Count) then
    Exit;
  ACurrentSection := DocumentModel.Sections[FCurrentSectionIndex];
  ACurrentSection.Columns.CopyFrom
    (APropertyContainer.SectionInfo.SectionColumns);
  ACurrentSection.Margins.CopyFrom
    (APropertyContainer.SectionInfo.SectionMargins);
  if ContentBuilder.DocumentProperties.GutterPosition = TdxGutterPosition.Top
  then
    ACurrentSection.Margins.GutterAlignment := TdxSectionGutterAlignment.Top;
  APropertyContainer.SectionInfo.SectionPage.ValidatePaperKind
    (DocumentModel.UnitConverter);
  ACurrentSection.Page.CopyFrom(APropertyContainer.SectionInfo.SectionPage);
  ACurrentSection.GeneralSettings.CopyFrom
    (APropertyContainer.SectionInfo.SectionGeneralSettings);
  ACurrentSection.PageNumbering.CopyFrom
    (APropertyContainer.SectionInfo.SectionPageNumbering);
  ACurrentSection.LineNumbering.CopyFrom
    (APropertyContainer.SectionInfo.SectionLineNumbering);
...
procedure TdxDocImporter.AddCellsHorizontalMerging(ARow: TdxTableRow;
  AFirstCellIndex: Integer; ASpan: Integer);
var
