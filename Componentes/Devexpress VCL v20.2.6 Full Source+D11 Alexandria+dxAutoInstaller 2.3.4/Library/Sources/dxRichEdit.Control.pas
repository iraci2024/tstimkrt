...
type
  ...
  TdxRichEditControlKeyboardDefaultHandler = class
  ...
  protected
    function CreateInnerServer(ADocumentModel: TdxDocumentModel)
      : TdxInnerRichEditDocumentServer; override;
  end;
  ...
  published
    ...
    property PrintLayoutView: TdxPrintLayoutView read GetPrintLayoutView
      write SetPrintLayoutView;
  ...
  TdxRichEditControlBeforeExportEvent = procedure
    (Sender: TdxCustomRichEditControl;
    ADocumentFormat: TdxRichEditDocumentFormat; var AUriTarget: string)
    of object;
  TdxRichEditControlQueryEncryptionPasswordEvent = procedure
    (Sender: TdxCustomRichEditControl; var APassword: string;
  ...
  strict private
    ...
    FOnFloatingInlineObjectLayoutOptionsFormShowing
      : TdxFloatingInlineObjectLayoutOptionsFormShowingEvent;
    ...
    FOnDocumentProtectionQuerySetPasswordFormShowing
      : TdxDocumentProtectionSetPasswordFormShowingEvent;
    FOnDocumentProtectionQueryGetPasswordFormShowing
      : TdxDocumentProtectionGetPasswordFormShowingEvent;
    FOnDocumentEncryptionQueryPassword
      : TdxRichEditControlQueryEncryptionPasswordEvent;
    FOnRangeEditingPermissionsFormShowing
      : TdxRangeEditingPermissionsFormShowingEvent;
    FOnDocumentEncryptQueryNewPasswordFormShowing
      : TdxDocumentEncryptSetPasswordFormShowingEvent;
  ...
  protected
    function CreateDocumentServer(ADocumentModel: TdxDocumentModel)
      : IdxRichEditDocumentContainer; overload; override;
    function CreateOptions(const ADocumentServer
      : TObject { TdxInnerRichEditDocumentServer } )
      : TObject { TdxRichEditControlOptionsBase }; override;
    ...
    function CreateSearchForm(AControllerParameters
      : TdxFormControllerParameters): TForm; virtual;
    procedure SearchFormClosed(Sender: TObject; var Action: TCloseAction);
    procedure InsertMergeFieldFormClosed(Sender: TObject;
    ...
    procedure ShowFindReplaceForm(AControllerParameters
    ...
    procedure ShowDocumentEncryptQueryNewPasswordForm(const APassword: string;
      const ACallback: TdxPasswordFormCallback); override;
    procedure ShowDocumentProtectionQueryNewPasswordForm(const APassword
      : string; const ACallback: TdxPasswordFormCallback); override;
    ...
    procedure ShowHyperlinkForm(AHyperlinkInfo: TdxHyperlinkInfo;
      ...
      const ACallback: TdxShowHyperlinkFormCallback); override;
    ...
    procedure ShowTablePropertiesForm(ASelectedCells
      : TdxSelectedCellsCollection); override;
    ...
    procedure ShowPageSetupForm(AProperties: TdxPageSetupInfo;
      ...
      AInitialTabPage: TdxPageSetupFormInitialTabPage); override;
    ...
    procedure RedrawEnsureSecondaryFormattingComplete
      (Action: TdxRefreshAction); override;

    function CreateInnerControl: TdxInnerRichEditControl; override;
    procedure DoBeforeExport(Sender: TObject;
      Args: TdxBeforeExportEventArgs); override;

    procedure DoParagraphFormShowing(const AArgs
      : TdxParagraphFormShowingEventArgs);
    procedure DoNumberingListFormShowing(const AArgs
    ...
    procedure DoTablePropertiesFormShowing(const AArgs
      : TdxTablePropertiesFormShowingEventArgs);
    procedure DoTableOptionsFormShowing(const AArgs
      : TdxTableOptionsFormShowingEventArgs);
    procedure DoTableStyleFormShowing(const AArgs
      : TdxTableStyleFormShowingEventArgs);
    procedure DoTabsFormShowing(const AArgs: TdxTabsFormShowingEventArgs);
    procedure DoInsertTableFormShowing(const AArgs
      : TdxInsertTableFormShowingEventArgs);
    procedure DoSplitTableCellsFormShowing(const AArgs
      : TdxSplitTableCellsFormShowingEventArgs);
    procedure DoHyperlinkFormShowing(const AArgs
      : TdxHyperlinkFormShowingEventArgs);
    procedure DoDeleteTableCellsFormShowing(const AArgs
      : TdxDeleteTableCellsFormShowingEventArgs);
    procedure DoInsertTableCellsFormShowing(const AArgs
      : TdxInsertTableCellsFormShowingEventArgs);
    procedure DoColumnsSetupFormShowing(const AArgs
      : TdxColumnsSetupFormShowingEventArgs);
    procedure DoEditStyleFormShowing(const AArgs
      : TdxEditStyleFormShowingEventArgs);
    procedure DoFloatingInlineObjectLayoutOptionsFormShowing
      (const AArgs: TdxFloatingInlineObjectLayoutOptionsFormShowingEventArgs);
    procedure DoSearchFormShowing(const AArgs: TdxSearchFormShowingEventArgs);
    procedure DoLineNumberingFormShowing(const AArgs
      : TdxLineNumberingFormShowingEventArgs);
    procedure DoPageSetupFormShowing(const AArgs
      : TdxPageSetupFormShowingEventArgs);
    procedure DoInsertMergeFieldFormShowing(const AArgs
      : TdxInsertMergeFieldFormShowingEventArgs);
    procedure DoBookmarkFormShowing(const AArgs
      : TdxBookmarkFormShowingEventArgs);
    procedure DoMergeDatabaseRecordsFormShowing(const AArgs
      : TdxMergeDatabaseRecordsFormShowingEventArgs);
    procedure DoDocumentProtectionQueryNewPasswordFormShowing
      (const AArgs: TdxDocumentProtectionSetPasswordFormShowingEventArgs);
    procedure DoDocumentProtectionQueryPasswordFormShowing
      (const AArgs: TdxDocumentProtectionGetPasswordFormShowingEventArgs);
    procedure DoRangeEditingPermissionsFormShowing
      (const AArgs: TdxRangeEditingPermissionsFormShowingEventArgs);
    function GetDocumentEncryptionPassword(var APassword: string)
      : Boolean; virtual;
    procedure DoDocumentEncryptQueryNewPasswordFormShowing
    ...
    property HorizontalRuler: TdxCustomRichEditRulerControl
      read FHorizontalRuler;
  ...
  public
    ...
    property Options: TdxRichEditControlOptions read GetOptions
      write SetOptions;
    property OnBeforeExport: TdxRichEditControlBeforeExportEvent
      read FOnBeforeExport write FOnBeforeExport;

    property OnParagraphFormShowing: TdxParagraphFormShowingEvent
      read FOnParagraphFormShowing write FOnParagraphFormShowing;
    property OnNumberingListFormShowing: TdxNumberingListFormShowingEvent
      read FOnNumberingListFormShowing write FOnNumberingListFormShowing;
    property OnSymbolFormShowing: TdxSymbolFormShowingEvent
      read FOnSymbolFormShowing write FOnSymbolFormShowing;
    property OnFontFormShowing: TdxFontFormShowingEvent read FOnFontFormShowing
      write FOnFontFormShowing;
    property OnTablePropertiesFormShowing: TdxTablePropertiesFormShowingEvent
      read FOnTablePropertiesFormShowing write FOnTablePropertiesFormShowing;
    property OnTableOptionsFormShowing: TdxTableOptionsFormShowingEvent
      read FOnTableOptionsFormShowing write FOnTableOptionsFormShowing;
    property OnTabsFormShowing: TdxTabsFormShowingEvent read FOnTabsFormShowing
      write FOnTabsFormShowing;
    property OnInsertTableFormShowing: TdxInsertTableFormShowingEvent
      read FOnInsertTableFormShowing write FOnInsertTableFormShowing;
    property OnSplitTableCellsFormShowing: TdxSplitTableCellsFormShowingEvent
      read FOnSplitTableCellsFormShowing write FOnSplitTableCellsFormShowing;
    property OnHyperlinkFormShowing: TdxHyperlinkFormShowingEvent
      read FOnHyperlinkFormShowing write FOnHyperlinkFormShowing;
    property OnDeleteTableCellsFormShowing: TdxDeleteTableCellsFormShowingEvent
      read FOnDeleteTableCellsFormShowing write FOnDeleteTableCellsFormShowing;
    property OnInsertTableCellsFormShowing: TdxInsertTableCellsFormShowingEvent
      read FOnInsertTableCellsFormShowing write FOnInsertTableCellsFormShowing;
    property OnColumnsSetupFormShowing: TdxColumnsSetupFormShowingEvent
      read FOnColumnsSetupFormShowing write FOnColumnsSetupFormShowing;
    property OnEditStyleFormShowing: TdxEditStyleFormShowingEvent
      read FOnEditStyleFormShowing write FOnEditStyleFormShowing;
    property OnFloatingInlineObjectLayoutOptionsFormShowing
      : TdxFloatingInlineObjectLayoutOptionsFormShowingEvent
      read FOnFloatingInlineObjectLayoutOptionsFormShowing
      write FOnFloatingInlineObjectLayoutOptionsFormShowing;
    property OnSearchFormShowing: TdxSearchFormShowingEvent
      read FOnSearchFormShowing write FOnSearchFormShowing;
    property OnLineNumberingFormShowing: TdxLineNumberingFormShowingEvent
      read FOnLineNumberingFormShowing write FOnLineNumberingFormShowing;
    property OnPageSetupFormShowing: TdxPageSetupFormShowingEvent
      read FOnPageSetupFormShowing write FOnPageSetupFormShowing;
    property OnInsertMergeFieldFormShowing: TdxInsertMergeFieldFormShowingEvent
      read FOnInsertMergeFieldFormShowing write FOnInsertMergeFieldFormShowing;
    property OnBookmarkFormShowing: TdxBookmarkFormShowingEvent
      read FOnBookmarkFormShowing write FOnBookmarkFormShowing;
    property OnMergeDatabaseRecordsFormShowing
      : TdxMergeDatabaseRecordsFormShowingEvent
      read FOnMergeDatabaseRecordsFormShowing
      write FOnMergeDatabaseRecordsFormShowing;
    property OnTableStyleFormShowing: TdxTableStyleFormShowingEvent
      read FOnTableStyleFormShowing write FOnTableStyleFormShowing;
    property OnDocumentProtectionQuerySetPasswordFormShowing
      : TdxDocumentProtectionSetPasswordFormShowingEvent
      read FOnDocumentProtectionQuerySetPasswordFormShowing
      write FOnDocumentProtectionQuerySetPasswordFormShowing;
    property OnDocumentProtectionQueryGetPasswordFormShowing
      : TdxDocumentProtectionGetPasswordFormShowingEvent
      read FOnDocumentProtectionQueryGetPasswordFormShowing
      write FOnDocumentProtectionQueryGetPasswordFormShowing;
    property OnDocumentEncryptionQueryPassword
      : TdxRichEditControlQueryEncryptionPasswordEvent
      read FOnDocumentEncryptionQueryPassword
      write FOnDocumentEncryptionQueryPassword;
    property OnRangeEditingPermissionsFormShowing
      : TdxRangeEditingPermissionsFormShowingEvent
      read FOnRangeEditingPermissionsFormShowing
      write FOnRangeEditingPermissionsFormShowing;
    property OnDocumentEncryptQueryNewPasswordFormShowing
      : TdxDocumentEncryptSetPasswordFormShowingEvent
      read FOnDocumentEncryptQueryNewPasswordFormShowing
      write FOnDocumentEncryptQueryNewPasswordFormShowing;
  end;
...
uses
  Contnrs, Math, Dialogs, ShellAPI, ComObj, ShlObj, UxTheme, DwmApi,
...
function TdxRichEditControlKeyboardController.CreateDefaultHandler
...
function TdxRichEditInnerControl.CreateKeyboardController
  : TdxCustomKeyboardController;
begin
  Result := TdxRichEditControlKeyboardController.Create(Self);
end;

function TdxRichEditInnerControl.GetEncryptionPassword(Sender: TObject;
  var APassword: string): Boolean;
begin
  Result := TdxCustomRichEditControl(Control).GetDocumentEncryptionPassword
    (APassword);
  if not Result then
    Result := ShowQueryPasswordDialog(TdxQueryPasswordKind.Query, APassword);
end;

procedure TdxRichEditInnerControl.DoShortCut
...
function TdxRichEditInnerDocumentServer.CreateNativeDocument
  : IdxRichEditDocument;
begin
  Result := TdxNativeDocument.Create(DocumentModel.MainPieceTable, Self);
end;

function TdxRichEditInnerDocumentServer.CreateNativeSubDocument
  (APieceTable: TdxPieceTable): IdxRichEditSubDocument;
begin
  Result := TdxNativeSubDocument.Create(APieceTable, Self);
end;

function TdxRichEditInnerDocumentServer.GetEncryptionPassword(Sender: TObject;
  var APassword: string): Boolean;
begin
  Result := ShowQueryPasswordDialog(TdxQueryPasswordKind.Query, APassword);
end;

function TdxRichEditInnerDocumentServer.GetMailMergeOptions(const AOptions
  : IdxRichEditMailMergeOptions): TdxMailMergeOptions;
begin
  Result := TdxNativeMailMergeOptions(AOptions).GetInternalMailMergeOptions;
end;

function TdxRichEditInnerDocumentServer.CreateMailMergeOptions
...
function TdxRichEditInternalDocumentServer.CreateInnerServer(ADocumentModel
  : TdxDocumentModel): TdxInnerRichEditDocumentServer;
begin
...
procedure TdxRichEditViewRepository.SetPrintLayoutView
  (const Value: TdxPrintLayoutView);
begin
...
begin
  AControllerParameters := TdxSearchFormControllerParameters.Create(Self,
...
procedure TdxCustomRichEditControl.ShowSplitTableCellsForm(const AParameters
  : TdxSplitTableCellsParameters;
...
begin
  AControllerParameters := TdxSplitTableCellsFormControllerParameters.Create
    (Self, AParameters);
...
begin
  AControllerParameters := TdxRangeEditingPermissionsFormControllerParameters.
    Create(Self);
  try
    AArgs := TdxRangeEditingPermissionsFormShowingEventArgs.Create
      (AControllerParameters);
    try
...
procedure TdxCustomRichEditControl.ShowNumberingListForm
...
begin
  AControllerParameters := TdxNumberingListFormControllerParameters.Create(Self,
    AParagraphs);
  try
...
procedure TdxCustomRichEditControl.ShowPageSetupForm
...
begin
  AControllerParameters := TdxPageSetupFormControllerParameters.Create(Self,
    AProperties);
  try
...
procedure TdxCustomRichEditControl.ShowParagraphForm(AParagraphProperties
...
begin
  AControllerParameters := TdxParagraphFormControllerParameters.Create(Self,
    AParagraphProperties, DocumentModel.UnitConverter);
  try
...
procedure TdxCustomRichEditControl.ShowFindReplaceForm(AControllerParameters
  : TdxFormControllerParameters);
var
...
begin
  ...
  TdxRichEditSearchTextDialogForm(FSearchForm).ActivePage :=
    TdxSearchFormControllerParameters(AControllerParameters).ActivePage;
  FSearchForm.Show;
end;
...
begin
  AControllerParameters :=
    TdxFloatingInlineObjectLayoutOptionsFormControllerParameters.Create(Self,
    AFloatingObjectParameters);
  try
    AArgs := TdxFloatingInlineObjectLayoutOptionsFormShowingEventArgs.Create
      (AControllerParameters);
    try
      ...
      if (AResult = mrOk) and Assigned(ACallback) then
        ACallback(AControllerParameters.FloatingInlineObjectParameters,
          ACallbackData);
    finally
      AArgs.Free
    end;
...
procedure TdxCustomRichEditControl.ShowFontForm(ACharacterProperties
...
begin
  AControllerParameters := TdxFontFormControllerParameters.Create(Self,
      ...
      begin
        ...
        try
          ...
          if (AForm.ShowModal = mrOk) and Assigned(ACallback) then
            ACallback(AForm.Controller.SourceCharacterProperties,
              ACallbackData);
        finally
          AForm.Free;
        end;
      end
      else if (AArgs.DialogResult = mrOk) and Assigned(ACallback) then
        ACallback(AControllerParameters.SourceCharacterProperties,
          ACallbackData);
    finally
      AArgs.Free;
    end;
...
procedure TdxCustomRichEditControl.ShowHyperlinkForm(AHyperlinkInfo
...
begin
  AControllerParameters := TdxHyperlinkFormControllerParameters.Create(Self,
    AHyperlinkInfo, ARunInfo);
  ...
  try
    ...
    begin
      ...
      try
        ...
        if AForm.ShowModal = mrOk then
          ACallback(AForm.Controller.HyperlinkInfo.Clone,
            AForm.Controller.TextSource, ARunInfo,
            AForm.Controller.TextToDisplay);
      finally
        AForm.Free;
      end;
    end
    ...
    begin
      if AArgs.DialogResult = mrOk then
        ACallback(AControllerParameters.HyperlinkInfo.Clone,
          AControllerParameters.TextSource, ARunInfo,
          AControllerParameters.TextToDisplay);
    end;
  finally
    AControllerParameters.Free;
    AArgs.Free;
...
begin
  ...
  AControllerParameters := TdxInsertMergeFieldFormControllerParameters.
    Create(Self);
  try
    AArgs := TdxInsertMergeFieldFormShowingEventArgs.Create
      (AControllerParameters);
    try
    ...
    TdxRichEditInsertMergeFieldForm(FInsertMergeFieldForm)
      .Initialize(AControllerParameters);
...
procedure TdxCustomRichEditControl.ShowInsertTableCellsForm(const AParameters
  : TdxTableCellsParameters;
  const ACallback: TdxShowInsertDeleteTableCellsFormCallback;
  ACallbackData: TObject);
var
...
begin
  AControllerParameters := TdxInsertTableCellsFormControllerParameters.Create
    (Self, AParameters);
  AArgs := TdxInsertTableCellsFormShowingEventArgs.Create
    (AControllerParameters);
  try
    ...
    else if AArgs.DialogResult = mrOk then
...
procedure TdxCustomRichEditControl.ShowInsertTableForm(const AParameters
...
begin
  AControllerParameters := TdxInsertTableFormControllerParameters.Create(Self,
    AParameters);
...
procedure TdxCustomRichEditControl.ShowLineNumberingForm
...
begin
  AControllerParameters := TdxLineNumberingFormControllerParameters.Create(Self,
    AProperties);
  try
...
procedure TdxCustomRichEditControl.ShowMergeDatabaseRecordsForm
...
begin
  AControllerParameters := TdxMergeOptionsFormControllerParameters.Create(Self,
    AMergeRecordsParameters);
  try
    AArgs := TdxMergeDatabaseRecordsFormShowingEventArgs.Create
      (AControllerParameters);
    try
...
procedure TdxCustomRichEditControl.ShowSymbolForm(const ASymbolProperties
...
begin
  AControllerParameters := TdxRichEditInsertSymbolControllerParameters.Create
    (Self, ASymbolProperties, ACallback, ACallbackData);
  try
...
procedure TdxCustomRichEditControl.ShowTableOptionsForm(ATable: TdxTable;
  AOwner: TObject);
var
...
begin
  AControllerParameters := TdxTableOptionsFormControllerParameters.Create
    (Self, ATable);
  try
...
procedure TdxCustomRichEditControl.ShowTablePropertiesForm(ASelectedCells
...
begin
  AControllerParameters := TdxTablePropertiesFormControllerParameters.Create
    (Self, ASelectedCells);
  try
    AArgs := TdxTablePropertiesFormShowingEventArgs.Create
      (AControllerParameters);
    try
...
begin
  AControllerParameters := TdxTableStyleFormControllerParameters.Create
    (Self, AStyle);
  try
...
procedure TdxCustomRichEditControl.ShowTabsForm(ATabInfo: TdxTabFormattingInfo;
  ADefaultTabWidth: Integer; const ACallback: TdxShowTabsFormCallback;
  ACallbackData: TObject);
var
...
begin
  ...
  if Assigned(ACommandState) then
    ...
    ATabFormOwner := nil;
  AControllerParameters := TdxTabsFormControllerParameters.Create(Self,
    ATabInfo, ADefaultTabWidth, DocumentModel.UnitConverter, ATabFormOwner);
  ...
  try
    ...
    begin
      ...
      try
        AForm.Initialize(AControllerParameters);
        if AForm.ShowModal = mrOk then
          ACallback(AForm.Controller.SourceTabInfo,
            AForm.Controller.SourceDefaultTabWidth, ACallbackData);
      finally
        AForm.Free;
      end;
    end
    else if AArgs.DialogResult = mrOk then
      ACallback(AControllerParameters.TabInfo,
        AControllerParameters.DefaultTabWidth, ACallbackData);
  finally
    AControllerParameters.Free;
    AArgs.Free;
  end;
...
procedure TdxCustomRichEditControl.ActivateViewPlatformSpecific
...
function TdxCustomRichEditControl.CreateViewRepository
  : TdxRichEditCustomViewRepository;
begin
  Result := TdxRichEditViewRepository.Create(Self);
end;

procedure TdxCustomRichEditControl.ApplyShowTableStyleFormResults
  (AStyle: TdxTableStyle);
var
  AModelStyle: TdxTableStyle;
begin
  DocumentModel.BeginUpdate;
  AModelStyle := DocumentModel.TableStyles.GetStyleByName(AStyle.StyleName)
    as TdxTableStyle;
...
function TdxCustomRichEditControl.CreateDocumentServer(ADocumentModel
  : TdxDocumentModel): IdxRichEditDocumentContainer;
begin
...
procedure TdxCustomRichEditControl.DoBeforeExport(Sender: TObject;
...
function TdxCustomRichEditControl.GetDocumentEncryptionPassword
  (var APassword: string): Boolean;
begin
  Result := False;
...
procedure TdxCustomRichEditControl.DoBookmarkFormShowing
  (const AArgs: TdxBookmarkFormShowingEventArgs);
begin
  if Assigned(FOnBookmarkFormShowing) then
    FOnBookmarkFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoPageSetupFormShowing
  (const AArgs: TdxPageSetupFormShowingEventArgs);
begin
  if Assigned(FOnPageSetupFormShowing) then
    FOnPageSetupFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.
  DoDocumentProtectionQueryNewPasswordFormShowing
  (const AArgs: TdxDocumentProtectionSetPasswordFormShowingEventArgs);
begin
...
procedure TdxCustomRichEditControl.DoParagraphFormShowing
  (const AArgs: TdxParagraphFormShowingEventArgs);
begin
  if Assigned(FOnParagraphFormShowing) then
    FOnParagraphFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoNumberingListFormShowing
  (const AArgs: TdxNumberingListFormShowingEventArgs);
begin
  if Assigned(FOnNumberingListFormShowing) then
    FOnNumberingListFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoSymbolFormShowing
  (const AArgs: TdxSymbolFormShowingEventArgs);
begin
  if Assigned(FOnSymbolFormShowing) then
    FOnSymbolFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoFontFormShowing
  (const AArgs: TdxFontFormShowingEventArgs);
begin
  if Assigned(FOnFontFormShowing) then
    FOnFontFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoTablePropertiesFormShowing
  (const AArgs: TdxTablePropertiesFormShowingEventArgs);
begin
  if Assigned(FOnTablePropertiesFormShowing) then
    FOnTablePropertiesFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoTableStyleFormShowing
  (const AArgs: TdxTableStyleFormShowingEventArgs);
begin
  if Assigned(FOnTableStyleFormShowing) then
    FOnTableStyleFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoTableOptionsFormShowing
  (const AArgs: TdxTableOptionsFormShowingEventArgs);
begin
  if Assigned(FOnTableOptionsFormShowing) then
    FOnTableOptionsFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoTabsFormShowing
  (const AArgs: TdxTabsFormShowingEventArgs);
begin
  if Assigned(FOnTabsFormShowing) then
    FOnTabsFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoInsertTableFormShowing
  (const AArgs: TdxInsertTableFormShowingEventArgs);
begin
  if Assigned(FOnInsertTableFormShowing) then
    FOnInsertTableFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoLineNumberingFormShowing
  (const AArgs: TdxLineNumberingFormShowingEventArgs);
begin
  if Assigned(FOnLineNumberingFormShowing) then
    FOnLineNumberingFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoSplitTableCellsFormShowing
  (const AArgs: TdxSplitTableCellsFormShowingEventArgs);
begin
  if Assigned(FOnSplitTableCellsFormShowing) then
    FOnSplitTableCellsFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoHyperlinkFormShowing
  (const AArgs: TdxHyperlinkFormShowingEventArgs);
begin
  if Assigned(FOnHyperlinkFormShowing) then
    FOnHyperlinkFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoDeleteTableCellsFormShowing
  (const AArgs: TdxDeleteTableCellsFormShowingEventArgs);
begin
  if Assigned(FOnDeleteTableCellsFormShowing) then
    FOnDeleteTableCellsFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoInsertMergeFieldFormShowing
  (const AArgs: TdxInsertMergeFieldFormShowingEventArgs);
begin
  if Assigned(FOnInsertMergeFieldFormShowing) then
    FOnInsertMergeFieldFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoInsertTableCellsFormShowing
  (const AArgs: TdxInsertTableCellsFormShowingEventArgs);
begin
  if Assigned(FOnInsertTableCellsFormShowing) then
    FOnInsertTableCellsFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoColumnsSetupFormShowing
  (const AArgs: TdxColumnsSetupFormShowingEventArgs);
begin
  if Assigned(FOnColumnsSetupFormShowing) then
    FOnColumnsSetupFormShowing(Self, AArgs);
end;

procedure TdxCustomRichEditControl.DoEditStyleFormShowing
  (const AArgs: TdxEditStyleFormShowingEventArgs);
begin
...
procedure TdxCustomRichEditControl.
  DoFloatingInlineObjectLayoutOptionsFormShowing(const AArgs
  : TdxFloatingInlineObjectLayoutOptionsFormShowingEventArgs);
begin
...
procedure TdxCustomRichEditControl.DoSearchFormShowing
  (const AArgs: TdxSearchFormShowingEventArgs);
begin
...
function TdxCustomRichEditControl.CreateOptions(const ADocumentServer
  : TObject { TdxInnerRichEditDocumentServer } )
  : TObject { TdxRichEditControlOptionsBase };
begin
  Result := TdxRichEditControlOptions.Create
    (TdxInnerRichEditDocumentServer(ADocumentServer));
end;
...
procedure TdxCustomRichEditControl.InsertMergeFieldFormClosed(Sender: TObject;
  var Action: TCloseAction);
begin
...
begin
  ...
  FHorizontalRuler.SetBounds(FClientBounds.Left, FClientBounds.Top,
    FClientBounds.Width, AHorizontalRulerHeight);
  FVerticalRuler.SetBounds(FClientBounds.Left, FClientBounds.Top,
    AVerticalRulerWidth, FClientBounds.Height);
  Inc(FClientBounds.Top, AHorizontalRulerHeight);
  Inc(FClientBounds.Left, AVerticalRulerWidth);
end;

procedure TdxCustomRichEditControl.SearchFormClosed(Sender: TObject;
  var Action: TCloseAction);
begin
...
procedure TdxCustomRichEditControl.SetViews(const Value
  : TdxRichEditViewRepository);
begin
  inherited Views := Value;
end;

procedure TdxCustomRichEditControl.SetOptions(const Value
  : TdxRichEditControlOptions);
begin
...
procedure TdxCustomRichEditControl.ShowColumnsSetupForm(const AProperties
...
begin
  AControllerParameters := TdxColumnsSetupFormControllerParameters.Create(Self,
    AProperties);
...
procedure TdxCustomRichEditControl.ShowDeleteTableCellsForm(const AParameters
  : TdxTableCellsParameters;
  const ACallback: TdxShowInsertDeleteTableCellsFormCallback;
  ACallbackData: TObject);
var
...
begin
  AControllerParameters := TdxDeleteTableCellsFormControllerParameters.Create
    (Self, AParameters);
  AArgs := TdxDeleteTableCellsFormShowingEventArgs.Create
    (AControllerParameters);
  try
...
procedure TdxCustomRichEditControl.ShowDocumentEncryptQueryNewPasswordForm
...
begin
  AControllerParameters :=
    TdxDocumentEncryptQueryPasswordFormControllerParameters.Create(Self,
    APassword);
  try
    AArgs := TdxDocumentEncryptSetPasswordFormShowingEventArgs.Create
      (AControllerParameters);
    try
      ...
      begin
        ...
        if ShowQueryPasswordDialog
          (TdxQueryPasswordKind.SetNewWithOptionalConfirmation, ANewPassword,
          cxGetResourceString(@sdxDocumentEncryptionQueryNewPasswordForm), Self)
        then
...
procedure TdxCustomRichEditControl.ShowDocumentProtectionQueryNewPasswordForm
  (const APassword: string; const ACallback: TdxPasswordFormCallback);
var
  AControllerParameters
...
begin
  AControllerParameters :=
    TdxDocumentProtectionSetPasswordFormControllerParameters.Create(Self,
    APassword);
  try
    AArgs := TdxDocumentProtectionSetPasswordFormShowingEventArgs.Create
      (AControllerParameters);
    try
      DoDocumentProtectionQueryNewPasswordFormShowing(AArgs);
      if not AArgs.Handled then
      begin
        if ShowQueryPasswordDialog(TdxQueryPasswordKind.SetNewWithConfirmation,
          ANewPassword,
          cxGetResourceString(@sdxDocumentProtectionQueryNewPasswordForm), Self)
        then
          ACallback(ANewPassword);
      end
      else if AArgs.DialogResult = mrOk then
...
procedure TdxCustomRichEditControl.ShowDocumentProtectionQueryPasswordForm
  (const APassword: string; const ACallback: TdxPasswordFormCallback);
var
  AControllerParameters
    : TdxDocumentProtectionGetPasswordFormControllerParameters;
  AArgs: TdxDocumentProtectionGetPasswordFormShowingEventArgs;
  ANewPassword: string;
begin
  AControllerParameters :=
    TdxDocumentProtectionGetPasswordFormControllerParameters.Create(Self,
    APassword);
  try
    AArgs := TdxDocumentProtectionGetPasswordFormShowingEventArgs.Create
      (AControllerParameters);
    try
      ...
      begin
        if ShowQueryPasswordDialog(TdxQueryPasswordKind.Query, ANewPassword,
          cxGetResourceString(@sdxDocumentProtectionQueryPasswordForm), Self)
        then
          ACallback(ANewPassword);
      end
      else if AArgs.DialogResult = mrOk then
...
procedure TdxCustomRichEditControl.ShowEditStyleForm(AParagraphSourceStyle
...
procedure TdxCustomRichEditControl.ShowEditStyleForm(ACharacterSourceStyle
...
procedure TdxCustomRichEditControl.ShowEditStyleForm(AParagraphSourceStyle
  : TdxParagraphStyle; ACharacterSourceStyle: TdxCharacterStyle;
  AIndex: TdxParagraphIndex; const ACallback: TdxShowEditStyleFormCallback);
var
...
begin
  if ACharacterSourceStyle = nil then
    AControllerParameters := TdxEditStyleFormControllerParameters.Create(Self,
      AParagraphSourceStyle, AIndex)
  else
    AControllerParameters := TdxEditStyleFormControllerParameters.Create(Self,
      ACharacterSourceStyle, AIndex);
  try
...
function TdxCustomRichEditControl.CreateSearchForm(AControllerParameters
  : TdxFormControllerParameters): TForm;
var
