...
type
  ...
  public
    class function Instance: TdxPSPageSetupMenuBuilderFactory;
    ...
    property ActiveBuilder: TdxPSPageSetupMenuBuilderClass
      read GetActiveBuilder;
    property Builders[Index: Integer]: TdxPSPageSetupMenuBuilderClass
      read GetBuilder;
...
class function TdxPSPageSetupMenuBuilderFactory.Instance
  : TdxPSPageSetupMenuBuilderFactory;
begin
  Result := inherited Instance as TdxPSPageSetupMenuBuilderFactory;
end;

procedure TdxPSPageSetupMenuBuilderFactory.RegisterBuilder
  (ABuilder: TdxPSPageSetupMenuBuilderClass);
begin
  if ABuilder <> nil then
    FBuilders.Add(ABuilder);
end;

procedure TdxPSPageSetupMenuBuilderFactory.UnregisterBuilder
  (ABuilder: TdxPSPageSetupMenuBuilderClass);
begin
...
function TdxPSPageSetupMenuBuilderFactory.GetActiveBuilder
  : TdxPSPageSetupMenuBuilderClass;
begin
  if Count <> 0 then
...
function TdxPSPageSetupMenuBuilderFactory.GetBuilder(Index: Integer)
  : TdxPSPageSetupMenuBuilderClass;
begin
...
class function TAbstractdxPSPageSetupMenuBuilder.ExtractPrintStyleFromObj
...
class function TdxStandardPSPageSetupMenuBuilder.ExtractPrintStyleFromObj
  (Obj: TObject): TBasedxPrintStyle;
begin
...
procedure TdxStandardPSPageSetupMenuBuilder.BuildPageSetupMenu
  (ARootItem: TObject; AData: Pointer; AIncludeDefineItem: Boolean;
...
var
  ...
  MI: TMenuItem;
begin
  if not(ARootItem is TMenuItem) then
    Exit;
...
dxPSPageSetupMenuBuilderFactory.RegisterBuilder
  (TdxStandardPSPageSetupMenuBuilder);
