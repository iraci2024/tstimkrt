...
type
  ...
  TdxSplitTableCellsFormControllerParameters = class
  ...
  public
    ...
    property SourceParameters: TdxSplitTableCellsParameters
      read FSourceParameters;
...
constructor TdxSplitTableCellsFormControllerParameters.Create
...
constructor TdxSplitTableCellsFormController.Create(AControllerParameters
  : TdxSplitTableCellsFormControllerParameters);
begin
  inherited Create;
  FMaxRowsCount := 15;
...
function TdxSplitTableCellsFormController.CalculateAllowedRowsCount
  : TdxIntegerList;
var
  I: Integer;
begin
