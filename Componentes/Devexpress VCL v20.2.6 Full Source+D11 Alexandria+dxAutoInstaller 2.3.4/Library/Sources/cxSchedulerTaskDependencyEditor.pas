...
uses
  ...
  cxLookAndFeelPainters, cxButtons, cxGroupBox, cxLookAndFeels,
...
type
  ...
  public
    ...
    property LinkRelation: TcxSchedulerEventRelation read FLinkRelation
      write SetLinkRelation;
  end;

  TcxSchedulerTaskDependencyEditor = TfmSchedulerTaskDependencyEditor;
  TcxSchedulerTaskDependencyEditorClass = class of
...
function TfmSchedulerTaskDependencyEditor.GetEventStr
  (const AEvent: TcxSchedulerEvent): string;
begin
...
begin
  ...
  lbFromName.Caption := cxGetStringAdjustedToWidth(lbFromName.Style.Font,
    GetEventStr(FEventFrom), lbFromName.ClientWidth);
  lbToName.Caption := cxGetStringAdjustedToWidth(lbToName.Style.Font,
    GetEventStr(FEventTo), lbToName.ClientWidth);
end;
...
procedure TfmSchedulerTaskDependencyEditor.SetLinkRelation
...
procedure TfmSchedulerTaskDependencyEditor.cbTypeRelationPropertiesChange
  (Sender: TObject);
begin
