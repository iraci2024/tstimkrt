...
uses
  Types, Variants, Windows, Messages, Classes, Graphics, Controls, ImgList,
  Forms, Generics.Collections, Generics.Defaults,
...
const
  ...
  vsRowLayoutItem = vsTableFirst + 15; // for internal use only
  vsRowLayoutItemHotTrack = vsTableFirst + 16; // for internal use only

  vsTableLast = vsRowLayoutItemHotTrack;
...
type
  ...
  TcxGridColumnHeaderAreaViewInfoClass = class of
  ...
  public
    function DragAndDropObjectClass
      : TcxCustomGridDragAndDropObjectClass; override;
  end;
  ...
  protected
    ...
    procedure DoSelectItem(AItem: TdxCustomListBoxItem;
      ASelectedViaKeyboard: Boolean); override;
    function GetOperationImageIndex(AFixedState
      : TcxDataControllerRowFixedState): Integer;
    function GetOperationText(AFixedState
      : TcxDataControllerRowFixedState): string;
    procedure RecreateOperations;

    property DataRow: TcxGridDataRow read FDataRow;
  public
    procedure Popup(ADataRow: TcxGridDataRow; AForBounds: TRect);
      reintroduce; virtual;
  end;

  { row layout }

  TcxGridRowLayoutOptions = class(TcxCustomGridOptions)
  strict private
    FIsAssigning: Boolean;

    function GetActive: Boolean;
    function GetDefaultColumnCount: Integer;
    function GetDefaultStretch: TcxGridRowLayoutStretch;
    function GetGridView: TcxGridTableView;
  ...
  published
    ...
    property DefaultColumnCount: Integer read GetDefaultColumnCount
      write SetDefaultColumnCount default 2;
    property DefaultStretch: TcxGridRowLayoutStretch read GetDefaultStretch
      write SetDefaultStretch default fsNone;
    property ItemHotTrack: Boolean read GetItemHotTrack write SetItemHotTrack
      default False;
    property UseDefaultLayout: Boolean read GetUseDefaultLayout
      write SetUseDefaultLayout default True;
  end;

  TcxGridRowLayoutOptionsClass = class of TcxGridRowLayoutOptions;

  TcxGridTableRowLayoutDataCellViewInfo = class
  ...
  protected
    ...
    function GetLayoutItemViewInfoInstance
      : TcxGridCustomLayoutItemViewInfo; override;
  ...
  TcxGridTableRowLayoutContainerViewInfo = class
    (TcxGridRowLayoutContainerViewInfo)
  protected
    function CanDrawRoot: Boolean; override;
    function FindGridItemViewInfo(AViewInfo: TcxGridCustomLayoutItemViewInfo)
      : TcxGridTableDataCellViewInfo; override;
  end;
  ...
  protected
    ...
    function GetActualViewInfo: TcxGridRowLayoutContainerViewInfo; virtual;
    ...
    procedure SetItemForGridItem(AGridItem: TcxCustomGridTableItem;
      AItem: TcxGridRowLayoutItem); override;
  ...
  TcxGridTableRowLayoutCustomizationController = class
  ...
  protected
    ...
    function CreateCustomizationController
      : TcxGridRowLayoutCustomizationController; override;
    function CreateContainerOwner
      : TcxGridTableRowLayoutSerializationOwner; virtual;
    function GetContainerClass: TcxGridRowLayoutContainerClass; override;
    function GetLayoutLookAndFeel: TcxGridRowLayoutLookAndFeel; override;
    function GetResetDefaultLayoutQuery: string; override;
    function IsAssigningOptions: Boolean; override;
    procedure SetSerializationOwner
      (AValue: TcxGridTableRowLayoutSerializationOwner); virtual;
    procedure Store(Proc: TGetChildProc); override;
    procedure UseDefaultLayoutChanged; override;
  public
    procedure CopyCustomizationSetting(AContainer: TdxLayoutContainer);
      override;
  ...
  TcxGridTableRowLayoutControllerClass = class of
    TcxGridTableRowLayoutController;

  { inplace edit form }

  TcxGridTableViewInplaceEditFormDataCellViewInfo = class
    (TcxGridRowLayoutDataCellViewInfo)
  private
    function GetGridView: TcxGridTableView; inline;
  ...
  TcxGridTableViewInplaceEditFormContainerViewInfo = class
  ...
  TcxGridTableViewInplaceEditFormContainer = class
  ...
  protected
    ...
    procedure SetItemForGridItem(AGridItem: TcxCustomGridTableItem;
      AItem: TcxGridRowLayoutItem); override;
  public
    property InplaceEditForm: TcxGridTableViewInplaceEditForm
      read GetInplaceEditForm;
    property GridView: TcxGridTableView read GetGridView;
    property ViewInfo: TcxGridTableViewInplaceEditFormContainerViewInfo
      read GetViewInfo;
  end;

  TcxGridTableViewDetachedEditFormEvent = procedure(Sender: TcxGridTableView;
    AForm: TForm) of object;

  TcxGridTableViewInplaceEditFormCustomizationController = class
    (TcxGridRowLayoutCustomizationController)
  protected
    function CreateForm: TForm; override;
  end;
  ...
  public
    procedure CheckFocusedItem(AItemViewInfo
      : TcxGridTableViewInplaceEditFormDataCellViewInfo);
    procedure ValidateEditVisibility;

    property Container: TcxGridTableViewInplaceEditFormContainer
      read GetContainer;
    property GridView: TcxGridTableView read GetGridView;
  end;

  TcxGridTableViewInplaceEditFormClass = class of
  ...
  strict private
    ...
    function GetCaptionMask: string;
    function GetDefaultColumnCount: Integer;
    ...
    procedure SetItemHotTrack(AValue: Boolean);
    procedure SetMasterRowDblClickAction
  ...
  public
    ...
    property GridView: TcxGridTableView read GetGridView;
  published
    property CaptionMask: string read GetCaptionMask write SetCaptionMask;
    property DefaultColumnCount: Integer read GetDefaultColumnCount
      write SetDefaultColumnCount default 2;
    property DefaultStretch: TcxGridInplaceEditFormStretch
      read GetDefaultStretch write SetDefaultStretch default fsNone;
    property ItemHotTrack: Boolean read GetItemHotTrack write SetItemHotTrack
      default False;
    property MasterRowDblClickAction: TcxGridMasterRowDblClickAction
      read FMasterRowDblClickAction write SetMasterRowDblClickAction
      default dcaSwitchExpandedState;
    property UseDefaultLayout: Boolean read GetUseDefaultLayout
      write SetUseDefaultLayout default True;
  end;
  ...
  protected
    ...
    property FixedState: TcxDataControllerRowFixedState read GetFixedState
      write SetFixedState;
  ...
  protected
    ...
    function GetViewInfoCacheItemClass
  ...
  public
    ...
    property EditFormVisible: Boolean read GetEditFormVisible
      write SetEditFormVisible;
    property FixedState;
  end;
  ...
  private
    ...
    function GetOperator(Index: Integer; AValue: Variant)
      : TcxFilterOperatorKind; overload;
  ...
  protected
    ...
    function GetDisplayTextForValue(AIndex: Integer; const AValue: Variant)
      : string; virtual;
    function GetDefaultFilterOperatorKind(const AValue: Variant;
      ACheckMask: Boolean): TcxFilterOperatorKind; virtual;
    function IsCriteriaItemSupported(AIndex: Integer;
      ACriteriaItem: TcxFilterCriteriaItem): Boolean; virtual;
    procedure ResetOperators; virtual;

    procedure KeyDown(var Key: Word; Shift: TShiftState); override;

    property FilterCriteriaItems[Index: Integer]: TcxFilterCriteriaItem
  ...
  public
    ...
    property Operators[Index: Integer]: TcxFilterOperatorKind read GetOperator
      write SetOperator;
  end;
  ...
  protected
    ...
    function GetInternalActiveDetailGridView
      (out AView: TcxCustomGridView): Boolean;
    function GetViewInfoCacheItemClass
      : TcxCustomGridViewInfoCacheItemClass; override;
    function GetViewInfoClass: TcxCustomGridRecordViewInfoClass; override;
    procedure KeyDown(var Key: Word; Shift: TShiftState); override;
    ...
    property InternalActiveDetailIndex: Integer
      read GetInternalActiveDetailIndex;
  public
    function ExpandOnDblClick: Boolean; override;
    function GetFirstFocusableChild: TcxCustomGridRecord; override;
    function GetLastFocusableChild(ARecursive: Boolean)
      : TcxCustomGridRecord; override;

    property ActiveDetailGridView: TcxCustomGridView
      read GetActiveDetailGridView;
    property ActiveDetailGridViewExists: Boolean
      read GetActiveDetailGridViewExists;
    property ActiveDetailIndex: Integer read GetActiveDetailIndex
      write SetActiveDetailIndex;
    property ActiveDetailLevel: TcxGridLevel read GetActiveDetailLevel
      write SetActiveDetailLevel;
    property DetailGridViewCount: Integer read GetDetailGridViewCount;
    property DetailGridViewExists[Index: Integer]: Boolean
      read GetDetailGridViewExists;
    property DetailGridViewHasData[Index: Integer]: Boolean
      read GetDetailGridViewHasData;
    property DetailGridViews[Index: Integer]: TcxCustomGridView
      read GetDetailGridView;
  ...
  protected
    ...
    function GetDisplayText(Index: Integer): string; override;
    function GetDisplayTextByGroupedColumn(AGroupedColumnIndex: Integer)
      : string; virtual;
    ...
    property CaptionPrefix[AGroupedColumnIndex: Integer]: string
      read GetCaptionPrefix;
    property CaptionSeparator: string read GetCaptionSeparator;
    property DisplayTextByGroupedColumn[AGroupedColumnIndex: Integer]: string
      read GetDisplayTextByGroupedColumn;
  public
    function ExpandOnDblClick: Boolean; override;
    ...
    property DisplayCaptions[AGroupedColumnIndex: Integer]: string
      read GetDisplayCaptionByGroupedColumn;
    property DisplayText: string read GetDisplayTextValue;
    property GroupedColumn: TcxGridColumn read GetMainGroupedColumn;
    property GroupedColumns[AGroupedColumnIndex: Integer]: TcxGridColumn
      read GetGroupedColumn;
    property GroupedColumnCount: Integer read GetGroupedColumnCount;
    property GroupedColumnValue[AGroupedColumnIndex: Integer]: Variant
      read GetGroupedColumnValue;
    property GroupSummaryItems: TcxDataGroupSummaryItems
      read GetGroupSummaryItems;
  ...
  protected
    ...
    function GetDataRecordClass(const ARecordInfo: TcxRowInfo)
      : TcxCustomGridRecordClass; virtual;
    function GetGroupRecordClass(const ARecordInfo: TcxRowInfo)
      : TcxCustomGridRecordClass; virtual;
    function GetMasterRecordClass(const ARecordInfo: TcxRowInfo)
      : TcxCustomGridRecordClass; virtual;
    function GetRecordClass(const ARecordInfo: TcxRowInfo)
      : TcxCustomGridRecordClass; override;
    function GetTopGroup(ARowIndex: Integer; ALevel: Integer = 0)
      : TcxCustomGridRow; virtual;
    function GetTopGroupIndex(ARowIndex: Integer; ALevel: Integer = 0)
      : Integer; virtual;
  ...
  public
    ...
    function MakeDetailVisible(ADetailLevel: TComponent { TcxGridLevel } )
      : TcxCustomGridView; override;
  ...
  TcxGridColumnHeaderMergeIndicatorClass = class of
    TcxGridColumnHeaderMergeIndicator;
  ...
  TcxGridColumnHeaderMovingObjectClass = class of
  ...
  protected
    procedure CalculateDestParams(AHitTest: TcxCustomGridHitTest;
      ...
      out AZone: TcxGridItemContainerZone); override;
    ...
    procedure CheckDestItemContainerKind(var AValue
      : TcxGridItemContainerKind); override;
    ...
    function GetArrowAreaBoundsForHeader(APlace: TcxGridArrowPlace)
      : TRect; virtual;
    function GetArrowsClientRect: TRect; override;
    function GetMergeIndicatorClass
      : TcxGridColumnHeaderMergeIndicatorClass; virtual;
    ...
    property GridView: TcxGridTableView read GetGridView;
    property MergeIndicator: TcxGridColumnHeaderMergeIndicator
      read FMergeIndicator;
    property OriginalDestColumnContainerKind: TcxGridColumnContainerKind
      read FOriginalDestColumnContainerKind
      write FOriginalDestColumnContainerKind;
  ...
  protected
    ...
    property ColumnHeaderViewInfo: TcxGridColumnHeaderViewInfo
      read GetColumnHeaderViewInfo;
  public
    procedure Init(const P: TPoint; AParams: TcxCustomGridHitTest); override;
  end;
  ...
  protected
    ...
    function DrawItemDrawBackgroundHandler(ACanvas: TcxCanvas;
      const ABounds: TRect): Boolean; virtual; abstract;
  ...
  public
    ...
    procedure PaintItem(ACanvas: TcxCanvas; R: TRect; AIndex: Integer;
      AFocused: Boolean); override;
  end;
  ...
  protected
    ...
    function DrawItemDrawBackgroundHandler(ACanvas: TcxCanvas;
      const ABounds: TRect): Boolean; override;
  ...
  private
    ...
    function GetViewInfo: TcxGridTableViewInfo;
  protected
    function GetItemsListBoxClass: TcxCustomGridTableItemsListBoxClass;
      override;
  ...
  public
    ...
    constructor Create(ALevel: TcxGridLevel; AGridRow: TcxGridMasterDataRow);
      reintroduce; virtual;
  ...
  protected
    ...
    property ApplyingImmediateFiltering: Boolean
      read FApplyingImmediateFiltering write FApplyingImmediateFiltering;
  public
    destructor Destroy; override;
  ...
  TcxGridFocusedItemKind = (fikNone, fikGridItem, fikUpdateButton,
    fikCancelButton); // for internal use only
  TcxGridGetNextItemFunc = function(AItems: TList; AFocusedIndex: Integer;
    AGoForward, AGoOnCycle: Boolean; out ACycleChanged: Boolean)
    : Integer of object; // for internal use only
  ...
  protected
    ...
    procedure FocusedItemChanged(APrevFocusedItem
      : TcxCustomGridTableItem); override;
    ...
    function GetDesignHitTest(AHitTest: TcxCustomGridHitTest): Boolean;
      override;
    ...
    function GetItemsCustomizationPopupClass
      : TcxCustomGridItemsCustomizationPopupClass; override;
    ...
    function IsColumnFixedDuringHorzSizing(AColumn: TcxGridColumn)
      : Boolean; virtual;
    ...
    function NeedsAdditionalRowsScrolling(AIsCallFromMaster: Boolean = False)
      : Boolean; virtual;
    ...
    procedure ShowDataRowFixingMenu(ADataRow: TcxGridDataRow;
      AForBounds: TRect); virtual;
    ...
    function FocusNextEditFormItem(AFocusedItemIndex: Integer;
      AGoForward: Boolean): Boolean; overload;
    function FocusNextRowLayoutItem(AFocusedItemIndex: Integer;
      AGoForward, AGoOnCycle: Boolean; out ACycleChanged: Boolean): Boolean;
    function GetNextEditFormItemIndexFunc(AItems: TList; AFocusedIndex: Integer;
      AGoForward, AGoOnCycle: Boolean; out ACycleChanged: Boolean): Integer;
    function GetNextInplaceButton: TcxGridFocusedItemKind;
    function GetNextRowLayoutItemIndexFunc(AItems: TList;
      AFocusedIndex: Integer; AGoForward, AGoOnCycle: Boolean;
      out ACycleChanged: Boolean): Integer;
    function GetNextLayoutItemIndex(AContainerViewInfo
      : TcxGridRowLayoutContainerViewInfo; AFocusedIndex: Integer;
      AGoForward, AGoOnCycle: Boolean; AFunc: TcxGridGetNextItemFunc;
      out ACycleChanged: Boolean): Integer;
    ...
    function GetPullFocusingScrollingDirection(X, Y: Integer;
      out ADirection: TcxDirection): Boolean; override;
    function SupportsPullFocusing: Boolean; override;

    // delphi drag and drop
    function GetDragOpenInfo(AHitTest: TcxCustomGridHitTest)
      : TcxCustomGridDragOpenInfo; override;
    function GetDragScrollDirection(X, Y: Integer): TcxDirection; override;

    // customization
    function CreateCustomizationController
      : TcxCustomGridCustomizationController; override;
    function GetColumnHeaderDragAndDropObjectClass
      : TcxGridColumnHeaderMovingObjectClass; virtual;
    function GetCustomizationFormClass
      : TcxCustomGridCustomizationFormClass; override;

    // cells selection
    function CanNormalSelectionOnMouse: Boolean; override;
    function CanProcessCellMultiSelect(APrevFocusedColumn: TcxGridColumn)
      : Boolean; virtual;
    procedure CellMultiSelectKeyDown(var Key: Word;
    ...
    property DataRowFixingMenu: TcxGridDataRowFixingMenu
      read GetDataRowFixingMenu;
    property FilterRowOperatorMenu: TcxFilterDropDownMenu
      read GetFilterRowOperatorMenu;
    property FindPanel: TcxGridTableFindPanel read GetFindPanel;
    property FocusedItemKind: TcxGridFocusedItemKind read FFocusedItemKind
      write SetFocusedItemKind;
    property InplaceEditForm: TcxGridTableViewInplaceEditForm
      read GetInplaceEditForm;
    property IsFilterPopupOpenedFromHeader: Boolean
      read FIsFilterPopupOpenedFromHeader write FIsFilterPopupOpenedFromHeader;
    property KeepFilterRowFocusing: Boolean read FKeepFilterRowFocusing
      write FKeepFilterRowFocusing;
    property RowLayoutController: TcxGridTableRowLayoutController
      read GetRowLayoutController;
    property ViewData: TcxGridViewData read GetViewData;
    property ViewInfo: TcxGridTableViewInfo read GetViewInfo;
  public
    ...
    function FocusNextCell(AGoForward: Boolean;
      ...
      ANeedNormalizeSelection: Boolean = False): Boolean; override;
    function FocusNextItem(AFocusedItemIndex: Integer;
      AGoForward, AGoOnCycle, AGoToNextRecordOnCycle, AFollowVisualOrder
      : Boolean; ANeedNormalizeSelection: Boolean = False): Boolean; override;
    function IsFilterRowFocused: Boolean;
    function IsFilterRowOperatorSupported(AItemIndex: Integer;
      AOperator: TcxFilterOperatorKind): Boolean; virtual;
    ...
    property CellSelectionAnchor: TcxGridColumn read FCellSelectionAnchor
      write FCellSelectionAnchor;
    property ColumnsCustomizationPopup: TcxGridColumnsCustomizationPopup
      read GetColumnsCustomizationPopup;
    property CustomizationForm: TcxGridTableCustomizationForm
      read GetCustomizationForm;
    property EditingController: TcxGridTableEditingController
      read GetEditingController;
    property FocusedColumn: TcxGridColumn read GetFocusedColumn
      write SetFocusedColumn;
    property FocusedColumnIndex: Integer read GetFocusedColumnIndex
      write SetFocusedColumnIndex;
    property FocusedRow: TcxCustomGridRow read GetFocusedRow
      write SetFocusedRow;
    ...
    property PressedColumn: TcxGridColumn read FPressedColumn
      write SetPressedColumn;
    property SelectedColumnCount: Integer read GetSelectedColumnCount;
    property SelectedColumns[Index: Integer]: TcxGridColumn
  ...
  protected
    function DrawBackgroundHandler(ACanvas: TcxCanvas; const ABounds: TRect)
      : Boolean; override;
    procedure DrawContent; override;
  ...
  public
    constructor Create(ACanvas: TcxCanvas;
      AViewInfo: TcxGridFixedDataRowsViewInfo); virtual;
  ...
  public
    class procedure DrawDataRowCells(ARowViewInfo
      : TcxCustomGridRowViewInfo); virtual;
  end;
  ...
  public
    constructor Create(ARowViewInfo: TcxCustomGridRowViewInfo);
      reintroduce; virtual;
  ...
  private
    ...
    function GetGridView: TcxGridTableView;
    function GetGridViewInfo: TcxGridTableViewInfo;
    function GetInternalItem(Index: Integer)
      : TcxGridColumnHeaderViewInfo; inline;
  ...
  protected
    ...
    function FindItem(AColumn: TcxCustomGridColumn)
      : TcxGridColumnHeaderViewInfo; virtual;
    ...
    function GetItemAdditionWidth(AItem: TcxGridColumnHeaderViewInfo)
      : Integer; virtual;
    function GetItemAreaBounds(AItem: TcxGridColumnHeaderViewInfo)
      : TRect; virtual;
    function GetItemMultiLinePainting(AItem: TcxGridColumnHeaderViewInfo)
      : Boolean; virtual;
  ...
  public
    ...
    property GridView: TcxGridTableView read GetGridView;
    property GridViewInfo: TcxGridTableViewInfo read GetGridViewInfo;
    property InternalItems[Index: Integer]: TcxGridColumnHeaderViewInfo
      read GetInternalItem;
    property ItemHeight: Integer read GetItemHeight;
    property Items[Index: Integer]: TcxGridColumnHeaderViewInfo
  ...
  protected
    ...
    property GridViewInfo: TcxGridTableViewInfo read GetGridViewInfo;
  public
    constructor Create(AColumnHeaderViewInfo: TcxGridColumnHeaderViewInfo);
      reintroduce; virtual;
    procedure Calculate(const ABounds: TRect; var ATextAreaBounds: TRect);
      reintroduce; virtual;
    property AlignmentHorz: TAlignment read GetAlignmentHorz;
    property AlignmentVert: TcxAlignmentVert read GetAlignmentVert;
    property ColumnHeaderViewInfo: TcxGridColumnHeaderViewInfo
      read FColumnHeaderViewInfo;
    property Height: Integer read GetHeight;
    property Width: Integer read GetWidth;
  end;

  TcxGridColumnHeaderSortingMarkViewInfo = class
    (TcxGridColumnHeaderAreaViewInfo)
  private
  ...
  TcxGridColumnHeaderHorzSizingEdgeViewInfo = class
    (TcxGridColumnHeaderAreaViewInfo)
  protected
    function CalculateHeight: Integer; override;
    function CalculateWidth: Integer; override;
  ...
  public
    procedure Calculate(const ABounds: TRect;
      var ATextAreaBounds: TRect); override;
    function MouseDown(AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
      AShift: TShiftState): Boolean; override;
  end;

  TcxGridColumnHeaderFilterButtonViewInfo = class
    (TcxGridColumnHeaderAreaViewInfo, IdxFilterPopupWindowOwner)
  private
    function GetActive: Boolean;
  ...
  protected
    ...
    function IdxFilterPopupWindowOwner.GetLinkComponent =
      GetFilterDropDownWindowLinkComponent;
    function IdxFilterPopupWindowOwner.GetMode = GetFilterPopupMode;
    function IdxFilterPopupWindowOwner.GetOptions =
      GetFilterDropDownWindowOptions;
  ...
  protected
    ...
    function GetPainterClass: TcxCustomGridCellPainterClass; override;
  public
    constructor Create(AColumnHeaderViewInfo
      : TcxGridColumnHeaderViewInfo); override;
  ...
  protected
    ...
    function FindArea(AAreaClass: TcxGridColumnHeaderAreaViewInfoClass)
      : TcxGridColumnHeaderAreaViewInfo; virtual;
    ...
    procedure GetAreaViewInfoClasses
      (AProc: TcxGridClassEnumeratorProc); virtual;
    ...
    class function GetCellBorderWidth(ALookAndFeelPainter
      : TcxCustomLookAndFeelPainter): Integer; virtual;
  ...
  public
    ...
    property AreaViewInfos[Index: Integer]: TcxGridColumnHeaderAreaViewInfo
      read GetAreaViewInfo;
  ...
  protected
    ...
    procedure AddIndicatorItems(AIndicatorViewInfo: TcxGridIndicatorViewInfo;
      ATopBound: Integer); virtual;
    ...
    function DrawColumnBackgroundHandler(ACanvas: TcxCanvas;
      const ABounds: TRect): Boolean; virtual;
  ...
  protected
    ...
    property GroupByBoxViewInfo: TcxGridGroupByBoxViewInfo
      read FGroupByBoxViewInfo;
  public
    constructor Create(AGroupByBoxViewInfo: TcxGridGroupByBoxViewInfo);
      reintroduce; virtual;
  ...
  protected
    ...
    function CalculateFitElementBounds(AElementHeight, AElementWidth: Integer)
      : TRect; virtual;
    ...
    function CreateSearchButtonViewInfo
      : TcxGridGroupByBoxSearchButtonViewInfo; virtual;
    function GetAlignment: TcxGridPartAlignment; override;
    function GetAlignmentVert: TcxAlignmentVert; override;
    function GetBackgroundBitmap: TBitmap; override;
    ...
    property SearchButtonViewInfo: TcxGridGroupByBoxSearchButtonViewInfo
      read FSearchButtonViewInfo;
  public
    constructor Create(AGridViewInfo: TcxCustomGridTableViewInfo); override;
    destructor Destroy; override;
    ...
    property LinkLineBounds[Index: Integer; Horizontal: Boolean]: TRect
      read GetLinkLineBounds;
  end;
  ...
  protected
    ...
    function GetBackgroundBitmap: TBitmap; override;
    procedure GetAreaViewInfoClasses
      (AProc: TcxGridClassEnumeratorProc); override;
    function GetBorders: TcxBorders; override;
    class function GetCellBorderWidth(ALookAndFeelPainter
      : TcxCustomLookAndFeelPainter): Integer; override;
    class function GetCellHeight(ATextHeight: Integer;
      ALookAndFeelPainter: TcxCustomLookAndFeelPainter;
      AScaleFactor: TdxScaleFactor): Integer; override;
  ...
  public
    constructor Create(AContainer: TcxGridColumnContainerViewInfo;
      AData: TcxGridFooterCellData); reintroduce; virtual;
    function GetBestFitWidth: Integer; override;
    function MouseDown(AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
      AShift: TShiftState): Boolean; override;
  ...
  protected
    procedure AddAdornerTargetElementForColumn(AList: TStrings;
      AColumn: TcxCustomGridColumn; AName: string); virtual;
    ...
    function CreateCellData(ASummaryItem: TcxDataSummaryItem)
      : TcxGridFooterCellData; virtual;
    procedure DestroyItems; override;
    function GetColumn(Index: Integer): TcxGridColumn; override;
    function GetColumnCount: Integer; override;
    function GetItemClass: TcxGridColumnHeaderViewInfoClass; override;
    procedure PopulateCellDataList(var AColumnHasSummaries: array of Boolean);
      overload; virtual;
    procedure PopulateCellDataList(ASummaryItems: TcxDataSummaryItems;
      var AColumnHasSummaries: array of Boolean); overload; virtual;
    ...
    function GetItemLeftBound(AColumn: TcxGridColumn): Integer;
      overload; virtual;
    ...
    function GetItemTopBound(AColumn: TcxGridColumn): Integer;
      overload; virtual;
    ...
    property CellDataList[AIndex: Integer]: TcxGridFooterCellData
      read GetCellData;
  public
  ...
  TcxCustomGridIndicatorItemViewInfoClass = class of
  ...
  public
    constructor Create(AContainer: TcxGridIndicatorViewInfo);
      reintroduce; virtual;
    destructor Destroy; override;
  ...
  protected
    ...
    function DropDownWindowExists: Boolean; override;
    function GetDropDownWindow: TdxUIElementPopupWindow; override;
    property DropDownWindow: TcxCustomGridCustomizationPopup
      read GetDropDownWindowValue;
  end;

  TcxGridIndicatorRowItemViewInfoClass = class of
  ...
  public
    constructor Create(AContainer: TcxGridIndicatorViewInfo;
      ARowViewInfo: TcxCustomGridRowViewInfo); reintroduce; virtual;
    destructor Destroy; override;
  ...
  protected
    ...
    function GetHitTestClass: TcxCustomGridHitTestClass; override;
    function GetPainterClass: TcxCustomGridCellPainterClass; override;
    function GetRowItemClass(ARowViewInfo: TcxCustomGridRowViewInfo)
      : TcxGridIndicatorRowItemViewInfoClass; virtual;
    procedure GetViewParams(var AParams: TcxViewParams); override;
    function GetVisible: Boolean; override;
    function GetWidth: Integer; override;
  ...
  public
    constructor Create(AGridViewInfo: TcxGridTableViewInfo);
      reintroduce; virtual;
    destructor Destroy; override;
    function AddItem(AItemClass: TcxCustomGridIndicatorItemViewInfoClass)
      : TcxCustomGridIndicatorItemViewInfo; overload;
    function AddItem(ATopBound, AHeight: Integer;
      AItemClass: TcxCustomGridIndicatorItemViewInfoClass)
      : TcxCustomGridIndicatorItemViewInfo; overload;
    function AddRowItem(ARowViewInfo: TcxCustomGridRowViewInfo)
      : TcxCustomGridIndicatorItemViewInfo;
    procedure Calculate(ALeftBound, ATopBound: Integer; AWidth: Integer = -1;
      AHeight: Integer = -1); override;
    ...
    property GridView: TcxGridTableView read GetGridView;
    property GridViewInfo: TcxGridTableViewInfo read GetGridViewInfo;
    property Items[Index: Integer]: TcxCustomGridIndicatorItemViewInfo
      read GetItem;
  end;
  ...
  public
    constructor Create(ASummaryItem: TcxDataSummaryItem;
      AGroupedColumnIndex: Integer); reintroduce; virtual;
  ...
  protected
    ...
    function CalculateWidth: Integer; override;
    function CreateCellData(ASummaryItem: TcxDataSummaryItem)
      : TcxGridFooterCellData; override;
    function GetBorders: TcxBorders; override;
    function GetColumnWidth(AColumn: TcxGridColumn): Integer; override;
    function GetHitTestClass: TcxCustomGridHitTestClass; override;
    function GetIsPart: Boolean; override;
    ...
    procedure PopulateCellDataList(var AColumnHasSummaries
      : array of Boolean); override;
    procedure Prepare(ACellDataList: TdxFastObjectList); override;
    property Indent: Integer read GetIndent;
  public
    constructor Create(AContainer: TcxGridRowFootersViewInfo; ALevel: Integer);
      reintroduce; virtual;
  ...
  public
    ...
    property Count: Integer read GetCount;
    property GridViewInfo: TcxGridTableViewInfo read GetGridViewInfo;
    property Items[Index: Integer]: TcxGridRowFooterViewInfo
      read GetItem; default;
    property Height: Integer read GetHeight;
    property IsRightToLeftConverted: Boolean read FIsRightToLeftConverted
      write FIsRightToLeftConverted;
    property RowViewInfo: TcxCustomGridRowViewInfo read FRowViewInfo;
    property VisibleItems[ALevel: Integer]: TcxGridRowFooterViewInfo
      read GetVisibleItem;
  end;
  ...
  protected
    procedure AddAdornerTargetElementsForColumn(AList: TStrings;
      AColumn: TcxCustomGridColumn; AName: string); virtual;
    ...
    function CalculateHeight: Integer; override;
    function CalculateLevelIndentHorzLineBounds(ALevel: Integer;
      const ABounds: TRect): TRect;
    function CalculateLevelIndentSpaceBounds(ALevel: Integer;
      const ABounds: TRect): TRect;
    function CalculateLevelIndentVertLineBounds(ALevel: Integer;
      const ABounds: TRect): TRect;
    function CalculateWidth: Integer; override;
    ...
    function NeedToggleExpandRecord(AHitTest: TcxCustomGridHitTest;
      AButton: TMouseButton; AShift: TShiftState): Boolean; virtual;
    procedure Offset(DX, DY: Integer); override;
    procedure SetFixedState(AValue: TcxDataControllerRowFixedState); virtual;
    ...
    property IndicatorItem: TcxCustomGridIndicatorItemViewInfo
      read FIndicatorItem;
    property FixedState: TcxDataControllerRowFixedState read GetFixedState
      write SetFixedState;
  ...
  public
    ...
    property LevelIndentHorzLineBounds[Index: Integer]: TRect
      read GetLevelIndentHorzLineBounds;
    property LevelIndentSpaceBounds[Index: Integer]: TRect
      read GetLevelIndentSpaceBounds;
    property LevelIndentVertLineBounds[Index: Integer]: TRect
      read GetLevelIndentVertLineBounds;
  ...
  protected
    ...
    function CreateRowViewInfo(ARow: TcxCustomGridRow)
      : TcxCustomGridRowViewInfo; virtual;
    ...
    property BottomItems[Index: Integer]: TcxCustomGridRowViewInfo
      read GetBottomItem;
  ...
  private
    ...
    procedure CreateMissingItems(ABottomViewInfo: TcxCustomGridRowViewInfo;
      ATopBound: Integer);
  protected
    ...
    function CalculateDataRowHeight(AConsideLayout: Boolean = True)
      : Integer; virtual;
    ...
    function CalculateGroupRowDefaultHeight(AMinHeight: Boolean)
      : Integer; virtual;
    ...
    function CalculateRowDefaultHeight(AConsideLayout: Boolean = True)
      : Integer; virtual;
    function CalculateRowHeight(AConsideLayout: Boolean = True)
      : Integer; virtual;
    procedure CalculateVisibleCount; override;
    procedure ControlFocusChanged; override;
    function CreateFixedGroupRowViewInfo(ARow: TcxCustomGridRow)
      : TcxCustomGridRowViewInfo; virtual;
    function CreateRowViewInfo(ARow: TcxCustomGridRow)
      : TcxCustomGridRowViewInfo; virtual;
    function GetAdjustedScrollPositionForFixedGroupMode(ARow: TcxCustomGridRow;
      APosition: Integer): Integer;
    function GetAdjustedPixelScrollPositionForFixedGroupsMode
      (ARow: TcxCustomGridRow; APosition: Integer): Integer;
    function GetAdjustedIndexScrollPositionForFixedGroupsMode
      (ARow: TcxCustomGridRow; APosition: Integer): Integer;
    ...
    function HasLastHorzGridLine(ARowViewInfo: TcxCustomGridRowViewInfo)
      : Boolean; virtual;
    function HasNewItemRow: Boolean;
    function IsCellPartVisibleForFixedGroupsMode(ACellViewInfo
      : TcxGridTableDataCellViewInfo): Boolean;
    ...
    function IsRowLocatedInGroup(ARowIndex, AGroupIndex, ALevel: Integer)
      : Boolean; virtual;
    ...
    property Controller: TcxGridTableController read GetController;
    property FixedDataRowsViewInfo: TcxGridFixedDataRowsViewInfo
      read FFixedDataRowsViewInfo;
    property GridView: TcxGridTableView read GetGridView;
    property GridViewInfo: TcxGridTableViewInfo read GetGridViewInfo;
  ...
  public
    ...
    function CalculateCustomGroupRowHeight(AMinHeight: Boolean;
      AParams: TcxViewParams): Integer; virtual;
    ...
    function GetRealItem(ARecord: TcxCustomGridRecord)
      : TcxCustomGridRecordViewInfo; override;
    ...
    property FilterRowViewInfo: TcxCustomGridRowViewInfo
      read GetFilterRowViewInfo;
    property GridLines: TcxGridLines read GetGridLines;
    ...
    property Items[Index: Integer]: TcxCustomGridRowViewInfo
      read GetItem; default;
    property NewItemRowViewInfo: TcxCustomGridRowViewInfo
      read GetNewItemRowViewInfo;
    ...
    property SeparatorWidth: Integer read GetSeparatorWidth;
    property SpecialDataRowHeight: Integer read FSpecialDataRowHeight;
    // for internal use only
    property SpecialRowHeight: Integer read FSpecialRowHeight;
    // for internal use only
  end;
  ...
  protected
    ...
    procedure CalculateWidth(const AMaxSize: TPoint;
    ...
    function GetColumnFooterWidth(AFooterViewInfo: TcxGridFooterViewInfo;
      AColumn: TcxGridColumn): Integer; virtual;
    ...
    function GetGroupByBoxViewInfoClass
      : TcxGridGroupByBoxViewInfoClass; virtual;
    ...
    function GetHeaderViewInfoSpecificClass
      : TcxGridHeaderViewInfoSpecificClass; virtual;
    function GetRecordsViewInfoClass
      : TcxCustomGridRecordsViewInfoClass; override;
  ...
  public
    ...
    function GetOffsetBounds(AItemsOffset: Integer; out AUpdateBounds: TRect)
      : TRect; overload; virtual;
    function GetOffsetBounds(DX, DY: Integer; out AUpdateBounds: TRect): TRect;
      overload; virtual;
    ...
    function GetNearestPopupHeight(AHeight: Integer;
      AAdditionalRecord: Boolean = False): Integer; override;
    function GetPopupHeight(ADropDownRowCount: Integer): Integer; override;

    property DataWidth: Integer read GetDataWidth;
    property ExpandButtonIndent: Integer read FExpandButtonIndent
      write FExpandButtonIndent;
    property FindPanelViewInfo: TcxGridTableFindPanelViewInfo
    ...
    property IndicatorViewInfo: TcxGridIndicatorViewInfo
      read FIndicatorViewInfo;
    property LeftPos: Integer read GetLeftPos;
    property LevelIndent: Integer read FLevelIndent write FLevelIndent;
    property LevelIndentBackgroundBitmap: TBitmap
      read GetLevelIndentBackgroundBitmap;
  ...
  public
    ...
    destructor Destroy; override;
    procedure UnassignValues(AKeepMaster: Boolean); override;
    property IsDetailsSiteCachedInfoAssigned: Boolean
      read GetIsDetailsSiteCachedInfoAssigned;
    property IsDetailsSiteFullyVisibleAssigned: Boolean
      read FIsDetailsSiteFullyVisibleAssigned
      write FIsDetailsSiteFullyVisibleAssigned;
    property IsDetailsSiteHeightAssigned: Boolean
      read FIsDetailsSiteHeightAssigned write FIsDetailsSiteHeightAssigned;
    property IsDetailsSiteNormalHeightAssigned: Boolean
      read FIsDetailsSiteNormalHeightAssigned
      write FIsDetailsSiteNormalHeightAssigned;
    property IsDetailsSiteWidthAssigned: Boolean
      read FIsDetailsSiteWidthAssigned write FIsDetailsSiteWidthAssigned;
    property DetailsSiteFullyVisible: Boolean read FDetailsSiteFullyVisible
      write SetDetailsSiteFullyVisible;
    property DetailsSiteHeight: Integer read FDetailsSiteHeight
      write SetDetailsSiteHeight;
    property DetailsSiteNormalHeight: Integer read FDetailsSiteNormalHeight
      write SetDetailsSiteNormalHeight;
    property DetailsSiteWidth: Integer read FDetailsSiteWidth
  ...
  public
    ...
    property AutoWidthSizable: Boolean read FAutoWidthSizable
      write SetAutoWidthSizable default True;
    property CellMerging: Boolean read FCellMerging write SetCellMerging
      default False;
    property GroupFooters: Boolean read FGroupFooters write SetGroupFooters
      default True;
    property HorzSizing: Boolean read FHorzSizing write SetHorzSizing
      default True;
  ...
  published
    ...
    property FilterRowOperator: TcxFilterOperatorKind read GetFilterRowOperator
      write SetFilterRowOperator default foEqual;
    property ShowEditButtons;
    property ShowGroupValuesWithImages: Boolean read FShowGroupValuesWithImages
      write SetShowGroupValuesWithImages default False;
  end;
  ...
  TcxGridGetFooterStyleExEvent = procedure(Sender: TcxGridTableView;
    ARow: TcxCustomGridRow; AColumn: TcxGridColumn; AFooterGroupLevel: Integer;
    var AStyle: TcxStyle) of object;
  TcxGridGetFooterSummaryStyleEvent = procedure(AView: TcxGridTableView;
    ARow: TcxCustomGridRow; AColumn: TcxGridColumn; AFooterGroupLevel: Integer;
    ASummaryItem: TcxDataSummaryItem; var AStyle: TcxStyle) of object;
  TcxGridGetGroupSummaryStyleEvent = procedure(Sender: TcxGridTableView;
    ARow: TcxGridGroupRow; AColumn: TcxGridColumn;
    ASummaryItem: TcxDataSummaryItem; var AStyle: TcxStyle) of object;
  TcxGridGetHeaderStyleEvent = procedure(Sender: TcxGridTableView;
    AColumn: TcxGridColumn; {$IFDEF BCBCOMPATIBLE}var {$ELSE}out
    {$ENDIF} AStyle: TcxStyle) of object;
  ...
  private
    ...
    procedure SetOnGetFooterSummaryStyle
      (Value: TcxGridGetFooterSummaryStyleEvent);
    procedure SetOnGetGroupSummaryStyle
      (Value: TcxGridGetGroupSummaryStyleEvent);
  ...
  public
    procedure Assign(Source: TPersistent); override;
    procedure GetFooterParams(ARow: TcxCustomGridRow;
      AFooterGroupLevel: Integer; ASummaryItem: TcxDataSummaryItem;
      out AParams: TcxViewParams); virtual;
    procedure GetGroupSummaryParams(ARow: TcxGridGroupRow;
  ...
  published
    ...
    property GroupSummary: TcxStyle index isGroupSummary read GetValue
      write SetValue;
    property Header: TcxStyle index isHeader read GetValue write SetValue;
    property OnGetFooterStyle: TcxGridGetCellStyleEvent read FOnGetFooterStyle
      write SetOnGetFooterStyle;
    property OnGetFooterStyleEx: TcxGridGetFooterStyleExEvent
      read FOnGetFooterStyleEx write SetOnGetFooterStyleEx;
    property OnGetFooterSummaryStyle: TcxGridGetFooterSummaryStyleEvent
      read FOnGetFooterSummaryStyle write SetOnGetFooterSummaryStyle;
    property OnGetGroupSummaryStyle: TcxGridGetGroupSummaryStyleEvent
      read FOnGetGroupSummaryStyle write SetOnGetGroupSummaryStyle;
    property OnGetHeaderStyle: TcxGridGetHeaderStyleEvent read FOnGetHeaderStyle
  ...
  protected
    function GetSummaryItems(AIndex: TcxGridSummariesIndex)
      : TcxDataSummaryItems;
    function GetSummaryItemsPosition(AIndex: TcxGridSummariesIndex)
      : TcxSummaryPosition;
    property DataController: TcxCustomDataController read GetDataController;
  public
    procedure Assign(Source: TPersistent); override;
  published
    property FooterKind: TcxSummaryKind index 0 read GetKind write SetKind
      stored False;
    property FooterFormat: string index 0 read GetFormat write SetFormat
      stored False;
    property GroupFooterKind: TcxSummaryKind index 1 read GetKind write SetKind
      stored False;
    property GroupFooterFormat: string index 1 read GetFormat write SetFormat
      stored False;
    property GroupKind: TcxSummaryKind index 2 read GetKind write SetKind
      stored False;
    property GroupFormat: string index 2 read GetFormat write SetFormat
      stored False;
    property SortByGroupFooterSummary: Boolean read GetSortByGroupFooterSummary
      write SetSortByGroupFooterSummary stored False;
    property SortByGroupSummary: Boolean read GetSortByGroupSummary
      write SetSortByGroupSummary stored False;
  end;
  ...
  TcxGridColumnCompareRowValuesEvent = procedure(Sender: TcxGridColumn;
    ...
    const AValue1: TcxEditValue; ARow2: TcxGridDataRow;
    AProperties2: TcxCustomEditProperties; const AValue2: TcxEditValue;
  ...
  TcxGridColumnCompareValuesEvent = procedure(Sender: TcxGridColumn;
    ...
    AProperties2: TcxCustomEditProperties; const AValue2: TcxEditValue;
    var AAreEqual: Boolean) of object;
  TcxGridColumnCustomDrawHeaderEvent = procedure(Sender: TcxGridTableView;
    ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo;
    var ADone: Boolean) of object;
  TcxGridGroupSummaryCellCustomDrawEvent = procedure(Sender: TObject;
  ...
  protected
    ...
    function IsFilterOperatorSupported(AOperator: TcxFilterOperatorKind)
      : Boolean; virtual;
    ...
    property Controller: TcxGridTableController read GetController;
    property FilterRowOperator: TcxFilterOperatorKind read GetFilterRowOperator
      write SetFilterRowOperator;
    property ViewData: TcxGridViewData read GetViewData;
  public
    constructor Create(AOwner: TComponent); override;
    function GroupBy(AGroupIndex: Integer; ACanShow: Boolean = True;
  ...
  published
    ...
    property FooterAlignmentHorz: TAlignment read GetFooterAlignmentHorz
      write SetFooterAlignmentHorz stored IsFooterAlignmentHorzStored;
    property GroupIndex;
    property GroupSummaryAlignment: TAlignment read GetGroupSummaryAlignment
      write SetGroupSummaryAlignment stored IsGroupSummaryAlignmentStored;
    ...
    property HeaderGlyphAlignmentVert: TcxAlignmentVert
      read FHeaderGlyphAlignmentVert write SetHeaderGlyphAlignmentVert
      default vaCenter;
    property HeaderHint;
    property HeaderImageIndex: TcxImageIndex read FHeaderImageIndex
      write SetHeaderImageIndex default -1;
    property IsChildInMergedGroup: Boolean read GetIsChildInMergedGroup
      write SetIsChildInMergedGroup default False;
    property LayoutItem: TcxGridInplaceEditFormLayoutItem read FLayoutItem
      write SetLayoutItem stored IsLayoutItemStored;
    property MinWidth;
    property Options: TcxCustomGridColumnOptions read GetOptions
      write SetOptions;
    property RowLayoutItem: TcxGridTableRowLayoutItem read FRowLayoutItem
      write SetRowLayoutItem stored IsRowLayoutItemStored;
    property SortIndex;
    property SortOrder;
    ...
    property VisibleForEditForm: TdxDefaultBoolean read FVisibleForEditForm
      write SetVisibleForEditForm default bDefault;
    property VisibleForRowLayout: TdxDefaultBoolean read FVisibleForRowLayout
      write SetVisibleForRowLayout default bDefault;
    property Width;
  end;
  ...
  private
    ...
    procedure SetOnCompareRowValuesForCellMerging
      (Value: TcxGridColumnCompareRowValuesEvent);
    procedure SetOnCompareValuesForCellMerging
      (Value: TcxGridColumnCompareValuesEvent);
    procedure SetOnCustomDrawFooterCell
      (Value: TcxGridColumnCustomDrawHeaderEvent);
    procedure SetOnCustomDrawGroupSummaryCell
  ...
  protected
    ...
    function GetOptionsClass: TcxCustomGridTableItemOptionsClass; override;
    procedure DoCustomDrawFooterCell(ACanvas: TcxCanvas;
      AViewInfo: TcxGridColumnHeaderViewInfo; var ADone: Boolean); virtual;
    procedure DoCustomDrawGroupSummaryCell(ACanvas: TcxCanvas;
      AViewInfo: TcxCustomGridViewCellViewInfo; var ADone: Boolean); virtual;
    procedure DoCustomDrawHeader(ACanvas: TcxCanvas;
      AViewInfo: TcxGridColumnHeaderViewInfo; var ADone: Boolean); virtual;
  ...
  public
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    function DoCompareValuesForCellMerging(ARow1: TcxGridDataRow;
      AProperties1: TcxCustomEditProperties; const AValue1: TcxEditValue;
  ...
  published
    ...
    property OnCompareRowValuesForCellMerging
      : TcxGridColumnCompareRowValuesEvent
      read FOnCompareRowValuesForCellMerging
      write SetOnCompareRowValuesForCellMerging;
    property OnCompareValuesForCellMerging: TcxGridColumnCompareValuesEvent
      read FOnCompareValuesForCellMerging
      write SetOnCompareValuesForCellMerging;
    ...
    property OnCustomDrawGroupSummaryCell
      : TcxGridGroupSummaryCellCustomDrawEvent
      read FOnCustomDrawGroupSummaryCell write SetOnCustomDrawGroupSummaryCell;
    property OnCustomDrawHeader: TcxGridColumnCustomDrawHeaderEvent
      read FOnCustomDrawHeader write SetOnCustomDrawHeader;
    property OnHeaderClick: TNotifyEvent read FOnHeaderClick
      write SetOnHeaderClick;
  ...
  published
    ...
    property GroupByBox: TBitmap index bbGroupByBox read GetValue
      write SetValue;
  ...
  protected
    function GetNavigatorButtonsClass
      : TcxGridViewNavigatorButtonsClass; override;
  end;
  ...
  published
    property Location: TcxGridTableFindPanelLocation read FLocation
      write SetLocation default fplSeparatePanel;
    property SearchInGroupRows: Boolean read FSearchInGroupRows
      write SetSearchInGroupRows default False;
    property SearchInPreview: Boolean read FSearchInPreview
      write SetSearchInPreview default False;
  end;
  ...
  TcxGridEditMode = (emInplace, emInplaceEditForm,
    emInplaceEditFormHideCurrentRow, emModalEditForm);
  ...
  published
    ...
    property ColumnHeaderHints: Boolean read FColumnHeaderHints
      write SetColumnHeaderHints default True;
    property ColumnMergedGrouping: Boolean read FColumnMergedGrouping
      write SetColumnMergedGrouping default False;
    property CopyPreviewToClipboard: Boolean read FCopyPreviewToClipboard
      write SetCopyPreviewToClipboard default True;
    property EditAutoHeight;
    property EditMode: TcxGridEditMode read FEditMode write SetEditMode
      default emInplace;
    property ExpandMasterRowOnDblClick: Boolean read FExpandMasterRowOnDblClick
      write SetExpandMasterRowOnDblClick default True;
    property FixedGroups: Boolean read FFixedGroups write SetFixedGroups
      default False;
  ...
  public
    ...
    property ColumnPopupDropDownWidth: Integer read GetItemPopupDropDownWidth
      write SetItemPopupDropDownWidth;
    property DropDownWidth;
    // obsolete - use ColumnPopup.MaxDropDownItemCount
    property ColumnPopupMaxDropDownItemCount: Integer
      read GetItemPopupMaxDropDownItemCount
      write SetItemPopupMaxDropDownItemCount;
    property MaxDropDownCount;
  published
    property ColumnAddValueItems: Boolean read GetColumnAddValueItems
      write SetColumnAddValueItems default True;
    property ColumnExcelPopup: TcxGridItemExcelFilterPopupOptions
    ...
    property ColumnFilteredItemsListShowFilteredItemsOnly: Boolean
      read GetColumnFilteredItemsListShowFilteredItemsOnly
      write SetColumnFilteredItemsListShowFilteredItemsOnly default True;
    property ColumnMRUItemsList: Boolean read GetColumnMRUItemsList
      write SetColumnMRUItemsList default True;
    property ColumnMRUItemsListCount: Integer read GetColumnMRUItemsListCount
      write SetColumnMRUItemsListCount
      default cxGridFilterDefaultItemMRUItemsListCount;
    property ColumnPopup: TcxGridItemFilterPopupOptions read GetColumnPopup
      write SetColumnPopup;
  ...
  private
    ...
    function GetColumnsQuickCustomizationReordering
    ...
    procedure SetColumnsQuickCustomizationReordering
  ...
  protected
    property ColumnsQuickCustomizationMultiColumnMode: Boolean
      read GetColumnsQuickCustomizationMultiColumnMode
  ...
  public
    ...
    property GridView: TcxGridTableView read GetGridView;
  published
    property ColumnExpressionEditing: Boolean read GetColumnExpressionEditing
      write SetColumnExpressionEditing default False;
    property ColumnFiltering: Boolean read GetColumnFiltering
      write SetColumnFiltering default True;
    property ColumnGrouping: Boolean read GetColumnGrouping
      write SetColumnGrouping default True;
    property ColumnHiding: Boolean read GetColumnHiding write SetColumnHiding
      default False;
    property ColumnHidingOnGrouping: Boolean read FColumnHidingOnGrouping
      write SetColumnHidingOnGrouping default True;
    property ColumnHorzSizing: Boolean read FColumnHorzSizing
      write SetColumnHorzSizing default True;
    property ColumnMoving: Boolean read GetColumnMoving write SetColumnMoving
      default True;
    property ColumnSorting: Boolean read GetColumnSorting write SetColumnSorting
      default True;
    property ColumnsQuickCustomization: Boolean
      read GetColumnsQuickCustomization write SetColumnsQuickCustomization
      default False;
    property ColumnsQuickCustomizationMaxDropDownCount: Integer
      read GetColumnsQuickCustomizationMaxDropDownCount
      write SetColumnsQuickCustomizationMaxDropDownCount default 0;
    property ColumnsQuickCustomizationReordering
      : TcxGridQuickCustomizationReordering
      read GetColumnsQuickCustomizationReordering
      write SetColumnsQuickCustomizationReordering default qcrDefault;
    property ColumnsQuickCustomizationShowCommands: Boolean
      read GetColumnsQuickCustomizationShowCommands
      write SetColumnsQuickCustomizationShowCommands default True;
    property ColumnsQuickCustomizationSorted: Boolean
      read GetColumnsQuickCustomizationSorted
      write SetColumnsQuickCustomizationSorted default False;
    property DataRowFixing: Boolean read FDataRowFixing write SetDataRowFixing
      default False;
    property DataRowSizing: Boolean read FDataRowSizing write SetDataRowSizing
      default False;
    property GroupBySorting: Boolean read FGroupBySorting
      write SetGroupBySorting default False;
    property GroupRowSizing: Boolean read FGroupRowSizing
      write SetGroupRowSizing default False;
  end;
  ...
  public
    procedure Assign(Source: TPersistent); override;
  published
    property CellMultiSelect: Boolean read FCellMultiSelect
      write SetCellMultiSelect default False;
    property CheckBoxPosition: TcxGridCheckBoxPosition read FCheckBoxPosition
      write SetCheckBoxPosition default cbpFirstColumn;
    property CheckBoxVisibility: TcxGridCheckBoxVisibility
      read FCheckBoxVisibility write SetCheckBoxVisibility default [];
    property ClearPersistentSelectionOnOutsideClick: Boolean
      read FClearPersistentSelectionOnOutsideClick
    ...
    property MultiSelectMode: TcxGridMultiSelectMode read FMultiSelectMode
      write SetMultiSelectMode default msmStandard;
    property ShowCheckBoxesDynamically: Boolean read FShowCheckBoxesDynamically
      write SetShowCheckBoxesDynamically default False;
    property UnselectFocusedRecordOnExit;
  end;

  // view

  TcxGridDataRowPinClickAction = (rpcaNone, rpcaFixToTop, rpcaFixToBottom,
    rpcaShowPopup);
  TcxGridDataRowPinVisibility = (rpvNever, rpvAlways, rpvHotTrack,
    rpvRowHotTrack);
  ...
  public
    ...
    property GridView: TcxGridTableView read GetGridView;
  published
    property PinClickAction: TcxGridDataRowPinClickAction read FPinClickAction
      write SetPinClickAction default rpcaShowPopup;
    property PinSize: TcxSize read FPinSize write SetPinSize;
    property PinVisibility: TcxGridDataRowPinVisibility read FPinVisibility
      write SetPinVisibility default rpvNever;
  ...
  published
    ...
    property OperatorCustomization: Boolean read FOperatorCustomization
      write SetOperatorCustomization default False;
  end;
  ...
  TcxGridGroupFootersMode = (gfInvisible, gfVisibleWhenExpanded,
    gfAlwaysVisible);
  ...
  private
    ...
    procedure SetHeaderFilterButtonShowMode
  ...
  public
    ...
    property NewItemRowInfoText: string read GetNewItemRowInfoText
      write SetNewItemRowInfoText;
    property NewItemRowSeparatorColor: TColor read GetNewItemRowSeparatorColor
      write SetNewItemRowSeparatorColor;
  ...
  published
    ...
    property DataRowHeight: Integer read FDataRowHeight write SetDataRowHeight
      default 0;
    property EditAutoHeightBorderColor;
    property ExpandButtonsForEmptyDetails: Boolean
      read GetExpandButtonsForEmptyDetails write SetExpandButtonsForEmptyDetails
      default True;
    property Footer: Boolean read FFooter write SetFooter default False;
    property FooterAutoHeight: Boolean read FFooterAutoHeight
      write SetFooterAutoHeight default False;
    property FooterMultiSummaries: Boolean read FFooterMultiSummaries
      write SetFooterMultiSummaries default False;
    property GridLineColor: TColor read FGridLineColor write SetGridLineColor
      default clDefault;
    property GridLines: TcxGridLines read FGridLines write SetGridLines
      default glBoth;
    property GroupByBox: Boolean read FGroupByBox write SetGroupByBox
      default True;
    property GroupByHeaderLayout: TcxGridGroupByHeaderLayout
      read FGroupByHeaderLayout write SetGroupByHeaderLayout
      default ghlVerticallyShifted;
    property GroupFooterMultiSummaries: Boolean read FGroupFooterMultiSummaries
      write SetGroupFooterMultiSummaries default False;
    property GroupFooters: TcxGridGroupFootersMode read FGroupFooters
      write SetGroupFooters default gfInvisible;
    property GroupRowHeight: Integer read FGroupRowHeight
      write SetGroupRowHeight default 0;
    property GroupRowStyle: TcxGridGroupRowStyle read FGroupRowStyle
      write SetGroupRowStyle default grsStandard;
    property GroupSummaryLayout: TcxGridGroupSummaryLayout
      read FGroupSummaryLayout write SetGroupSummaryLayout default gslStandard;
    ...
    property HeaderEndEllipsis: Boolean read GetHeaderEndEllipsis
      write SetHeaderEndEllipsis default False;
    property HeaderFilterButtonShowMode: TcxGridItemFilterButtonShowMode
    ...
    property IndicatorWidth: Integer read FIndicatorWidth
      write SetIndicatorWidth default cxGridDefaultIndicatorWidth;
    property MergedGroupSeparator: string read FMergedGroupSeparator
      write SetMergedGroupSeparator stored IsMergedGroupSeparatorStored;
    property RowSeparatorColor: TColor read FRowSeparatorColor
      write SetRowSeparatorColor default clDefault;
    property RowSeparatorWidth: Integer read FRowSeparatorWidth
      write SetRowSeparatorWidth default 0;
    property ShowColumnFilterButtons: TcxGridShowItemFilterButtons
  ...
  published
    ...
    property Place: TcxGridPreviewPlace read FPlace write SetPlace
      default ppBottom;
  ...
  TcxGridGetGroupStyleEvent = procedure(Sender: TcxGridTableView;
    ARecord: TcxCustomGridRecord; ALevel: Integer; {$IFDEF BCBCOMPATIBLE}var
    {$ELSE}out {$ENDIF} AStyle: TcxStyle) of object;
  ...
  protected
    ...
    procedure GetRowLayoutItemHottrackParams(AItem: TcxCustomGridTableItem;
      out AParams: TcxViewParams); virtual;
    procedure GetRowLayoutItemParams(ARecord: TcxCustomGridRecord;
  ...
  public
    ...
    procedure GetContentParams(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem; out AParams: TcxViewParams); override;
    procedure GetFooterCellParams(ARow: TcxCustomGridRow;
      AColumn: TcxGridColumn; AFooterGroupLevel: Integer;
      ASummaryItem: TcxDataSummaryItem; out AParams: TcxViewParams); virtual;
    ...
    procedure GetGroupSummaryParams(ARow: TcxGridGroupRow;
      ASummaryItem: TcxDataSummaryItem; out AParams: TcxViewParams); virtual;
    procedure GetHeaderParams(AItem: TcxGridColumn;
      out AParams: TcxViewParams); virtual;
    procedure GetInplaceEditFormGroupParams(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem; out AParams: TcxViewParams); virtual;
    procedure GetInplaceEditFormItemHottrackParams
      (AItem: TcxCustomGridTableItem; out AParams: TcxViewParams); virtual;
    procedure GetInplaceEditFormItemParams(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem; out AParams: TcxViewParams); virtual;
    procedure GetPreviewParams(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem; out AParams: TcxViewParams); virtual;
    ...
    property GridView: TcxGridTableView read GetGridViewValue;
  published
    property FilterRowInfoText: TcxStyle index vsFilterRowInfoText read GetValue
      write SetValue;
    ...
    property GroupByBox: TcxStyle index vsGroupByBox read GetValue
      write SetValue;
    property GroupFooterSortedSummary: TcxStyle index vsGroupFooterSortedSummary
      read GetValue write SetValue;
    property GroupSortedSummary: TcxStyle index vsGroupSortedSummary
      read GetValue write SetValue;
    property GroupSummary: TcxStyle index vsGroupSummary read GetValue
      write SetValue;
    ...
    property InplaceEditFormGroup: TcxStyle index vsInplaceEditFormGroup
      read GetValue write SetValue;
    property InplaceEditFormItem: TcxStyle index vsInplaceEditFormItem
      read GetValue write SetValue;
    property InplaceEditFormItemHotTrack: TcxStyle
      index vsInplaceEditFormItemHotTrack read GetValue write SetValue;
    property NewItemRowInfoText: TcxStyle index vsNewItemRowInfoText
      read GetValue write SetValue;
    ...
    property OnGetFooterSummaryStyle: TcxGridGetFooterSummaryStyleEvent
      read FOnGetFooterSummaryStyle write SetOnGetFooterSummaryStyle;
    property OnGetGroupStyle: TcxGridGetGroupStyleEvent read FOnGetGroupStyle
      write SetOnGetGroupStyle;
    property OnGetGroupSummaryStyle: TcxGridGetGroupSummaryStyleEvent
      read FOnGetGroupSummaryStyle write SetOnGetGroupSummaryStyle;
    property OnGetHeaderStyle: TcxGridGetHeaderStyleEvent read FOnGetHeaderStyle
      write SetOnGetHeaderStyle;
    property OnGetInplaceEditFormGroupStyle: TcxGridGetCellStyleEvent
      read FOnGetInplaceEditFormGroupStyle
      write FOnGetInplaceEditFormGroupStyle;
    property OnGetInplaceEditFormItemStyle: TcxGridGetCellStyleEvent
      read FOnGetInplaceEditFormItemStyle
      write SetOnGetInplaceEditFormItemStyle;
    property OnGetPreviewStyle: TcxGridGetCellStyleEvent read FOnGetPreviewStyle
      write SetOnGetPreviewStyle;
  end;
  ...
  published
    property Styles: TcxGridTableViewStyles read GetStylesValue
      write SetStylesValue;
  end;
  ...
  TcxGridColumnEvent = procedure(Sender: TcxGridTableView;
    AColumn: TcxGridColumn) of object;
  TcxGridIndicatorCellCustomDrawEvent = procedure(Sender: TcxGridTableView;
    ACanvas: TcxCanvas; AViewInfo: TcxCustomGridIndicatorItemViewInfo;
    var ADone: Boolean) of object;
  TcxGridGroupRowChangingEvent = procedure(Sender: TcxGridTableView;
    AGroup: TcxGridGroupRow; var AAllow: Boolean) of object;
  TcxGridGroupRowEvent = procedure(Sender: TcxGridTableView;
    AGroup: TcxGridGroupRow) of object;
  TcxGridGetUnmergeableColumnsEvent = procedure(Sender: TcxGridTableView;
    AColumn: TcxGridColumn; AUnmergeableColumns: TList) of object;

  TcxGridTableView = class(TcxCustomGridTableView, IdxLayoutContainerOwner)
  private
    ...
    FInplaceEditFormLayoutLookAndFeel: TcxGridRowLayoutLookAndFeel;
    ...
    FRowLayoutLookAndFeel: TcxGridRowLayoutLookAndFeel;
    ...
    procedure SetOnCustomDrawColumnHeader
      (Value: TcxGridColumnCustomDrawHeaderEvent);
    procedure SetOnCustomDrawFooterCell
      (Value: TcxGridColumnCustomDrawHeaderEvent);
    ...
    procedure SetOnCustomDrawIndicatorCell
      (Value: TcxGridIndicatorCellCustomDrawEvent);
    procedure SetOnDetachedEditFormInitialize
      (Value: TcxGridTableViewDetachedEditFormEvent);
    procedure SetOnGetUnmergeableColumns
      (Value: TcxGridGetUnmergeableColumnsEvent);
  ...
  protected
    ...
    function CreateInplaceEditFormLayoutLookAndFeel
      : TcxGridRowLayoutLookAndFeel; virtual;
    function CreateRowLayoutLookAndFeel: TcxGridRowLayoutLookAndFeel; virtual;
    procedure Notification(AComponent: TComponent;
      AOperation: TOperation); override;
    procedure LookAndFeelChanged; override;
    procedure UpdateInplaceEditFormStyles(ALayoutLookAndFeel
      : TcxGridRowLayoutLookAndFeel);
    procedure UpdateRowLayoutLookAndFeel(ALayoutLookAndFeel
      : TcxGridRowLayoutLookAndFeel);
    ...
    function UpdateOnDetailDataChange(ADetail: TcxCustomGridView)
      : Boolean; virtual;
    ...
    function GetDateTimeHandlingClass
      : TcxCustomGridTableDateTimeHandlingClass; override;
    ...
    function GetFixedDataRowsOptionsClass
      : TcxGridFixedDataRowsOptionsClass; virtual;
    function GetInplaceEditFormClass
      : TcxGridTableViewInplaceEditFormClass; virtual;
    ...
    function GetOptionsCustomizeClass
      : TcxCustomGridTableOptionsCustomizeClass; override;
    ...
    function GetRowLayoutControllerClass
      : TcxGridTableRowLayoutControllerClass; virtual;
    ...
    procedure DoCustomDrawFooterCell(ACanvas: TcxCanvas;
      AViewInfo: TcxGridColumnHeaderViewInfo; var ADone: Boolean); virtual;
    procedure DoCustomDrawGroupCell(ACanvas: TcxCanvas;
      AViewInfo: TcxGridTableCellViewInfo; var ADone: Boolean); virtual;
    procedure DoCustomDrawGroupSummaryCell(ACanvas: TcxCanvas;
      AViewInfo: TcxCustomGridViewCellViewInfo; var ADone: Boolean); virtual;
    procedure DoCustomDrawIndicatorCell(ACanvas: TcxCanvas;
    ...
    procedure DoGetUnmergeableColumns(AColumn: TcxGridColumn;
      AUnmergeableColumns: TList); virtual;
    ...
    property AllowCellMerging: Boolean read FAllowCellMerging
      write FAllowCellMerging;
    property InplaceEditForm: TcxGridTableViewInplaceEditForm
      read FInplaceEditForm;
    property InplaceEditFormLayoutLookAndFeel: TcxGridRowLayoutLookAndFeel
      read FInplaceEditFormLayoutLookAndFeel;
    property RowLayoutController: TcxGridTableRowLayoutController
      read FRowLayoutController;
    property RowLayoutLookAndFeel: TcxGridRowLayoutLookAndFeel
      read FRowLayoutLookAndFeel;
  public
    constructor Create(AOwner: TComponent); override;
    procedure GetChildren(Proc: TGetChildProc; Root: TComponent); override;
    ...
    property AssigningIsChildInMergedGroupItems: TcxGridOpenTableItemList
      read FAssigningIsChildInMergedGroupItems;
    property ColumnCount: Integer read GetColumnCount;
    property Columns[Index: Integer]: TcxGridColumn read GetColumn
      write SetColumn;
    property Controller: TcxGridTableController read GetController;
    property GroupedColumnCount: Integer read GetGroupedColumnCount;
    property GroupedColumns[Index: Integer]: TcxGridColumn
      read GetGroupedColumn;
    ...
    property VisibleColumns[Index: Integer]: TcxGridColumn
      read GetVisibleColumn;
  published
    property BackgroundBitmaps: TcxGridTableBackgroundBitmaps
    ...
    property Filtering: TcxGridTableFiltering read GetFiltering
      write SetFiltering;
    property FilterRow: TcxGridFilterRowOptions read FFilterRow
      write SetFilterRow;
    property FindPanel: TcxGridTableFindPanelOptions read GetFindPanel
      write SetFindPanel;
    property FixedDataRows: TcxGridFixedDataRowsOptions read FFixedDataRows
      write SetFixedDataRows;
    property Images;
    property NewItemRow: TcxGridNewItemRowOptions read FNewItemRow
      write SetNewItemRow;
    property OptionsBehavior: TcxGridTableOptionsBehavior
      read GetOptionsBehavior write SetOptionsBehavior;
    property OptionsCustomize: TcxGridTableOptionsCustomize
      read GetOptionsCustomize write SetOptionsCustomize;
    property OptionsData: TcxGridTableOptionsData read GetOptionsData
      write SetOptionsData;
    property OptionsSelection: TcxGridTableOptionsSelection
    ...
    property RowLayout: TcxGridRowLayoutOptions read FRowLayout
      write SetRowLayout;
    property Styles: TcxGridTableViewStyles read GetStyles write SetStyles;

    property OnColumnHeaderClick: TcxGridColumnEvent read FOnColumnHeaderClick
      write SetOnColumnHeaderClick;
    property OnColumnPosChanged: TcxGridColumnEvent read FOnColumnPosChanged
      write SetOnColumnPosChanged;
    property OnColumnSizeChanged: TcxGridColumnEvent read FOnColumnSizeChanged
      write SetOnColumnSizeChanged;
    property OnCustomDrawColumnHeader: TcxGridColumnCustomDrawHeaderEvent
      read FOnCustomDrawColumnHeader write SetOnCustomDrawColumnHeader;
    property OnCustomDrawFooterCell: TcxGridColumnCustomDrawHeaderEvent
      read FOnCustomDrawFooterCell write SetOnCustomDrawFooterCell;
    property OnCustomDrawGroupCell: TcxGridTableCellCustomDrawEvent
      read FOnCustomDrawGroupCell write SetOnCustomDrawGroupCell;
    property OnCustomDrawGroupSummaryCell
      : TcxGridGroupSummaryCellCustomDrawEvent
      read FOnCustomDrawGroupSummaryCell write SetOnCustomDrawGroupSummaryCell;
    property OnCustomDrawIndicatorCell: TcxGridIndicatorCellCustomDrawEvent
      read FOnCustomDrawIndicatorCell write SetOnCustomDrawIndicatorCell;
    property OnCustomization;

    property OnGroupRowCollapsed: TcxGridGroupRowEvent read FOnGroupRowCollapsed
      write FOnGroupRowCollapsed;
    property OnGroupRowCollapsing: TcxGridGroupRowChangingEvent
      read FOnGroupRowCollapsing write FOnGroupRowCollapsing;
    property OnGroupRowExpanded: TcxGridGroupRowEvent read FOnGroupRowExpanded
      write FOnGroupRowExpanded;
    property OnGroupRowExpanding: TcxGridGroupRowChangingEvent
      read FOnGroupRowExpanding write FOnGroupRowExpanding;

    property OnDetachedEditFormInitialize: TcxGridTableViewDetachedEditFormEvent
      read FOnDetachedEditFormInitialize write SetOnDetachedEditFormInitialize;

    property OnGetUnmergeableColumns: TcxGridGetUnmergeableColumnsEvent
      read FOnGetUnmergeableColumns write SetOnGetUnmergeableColumns;
    property OnInitGroupingDateRanges;
  ...
  public
    ...
    class function CanSearchInGroupRows(AInstance: TcxGridColumn): Boolean;
    class procedure DoCustomDrawGroupSummaryCell(AInstance: TcxGridColumn;
      ACanvas: TcxCanvas; AViewInfo: TcxCustomGridViewCellViewInfo;
      var ADone: Boolean); virtual;
    class function HasCustomDrawGroupSummaryCell
      (AInstance: TcxGridColumn): Boolean;
    class function GetImageComboBoxProperties(AInstance: TcxGridColumn)
  ...
  public
    ...
    class procedure DoCustomDrawGroupSummaryCell(AInstance: TcxGridTableView;
      ACanvas: TcxCanvas; AViewInfo: TcxCustomGridViewCellViewInfo;
      var ADone: Boolean); virtual;
    class function GetFilterRowOperatorMenu(AInstance: TcxGridTableView)
      : TcxFilterDropDownMenu;
    class function GetInplaceEditForm(AInstance: TcxGridTableView)
      : TcxGridTableViewInplaceEditForm;
    class function GetRowLayoutController(AInstance: TcxGridTableView)
      : TcxGridRowLayoutController;
    class function HasCustomDrawGroupCell(AInstance: TcxGridTableView): Boolean;
    class function HasCustomDrawGroupSummaryCell
      (AInstance: TcxGridTableView): Boolean;
    class function IsMultiSelectPersistent(AInstance: TcxGridTableView)
      : Boolean; static;
  end;
...
uses
  RTLConsts, SysUtils, Math, Contnrs, Dialogs, dxOffice11, cxVariants,
  cxDataUtils,
  cxGridTableRowLayoutCustomizationForm,
  cxGridTableViewInplaceEditFormCustomizationForm,
  cxFilterControlUtils, cxLibraryConsts, cxGridRows, cxGridStrs, cxNavigator,
  dxDPIAwareUtils;
...
type
  ...
  TdxCustomLayoutItemViewInfoHelper = class helper for
...
begin
  ...
  begin
    ...
    ColumnContainerKind := TcxCustomGridColumnHitTest(Source)
      .ColumnContainerKind;
  end;
end;
...
function TcxGridColumnHeaderHitTest.DragAndDropObjectClass
  : TcxCustomGridDragAndDropObjectClass;
begin
  if Column.CanMove then
    Result := TcxGridTableView(GridView)
      .Controller.GetColumnHeaderDragAndDropObjectClass
  else
    Result := nil;
end;
...
function TcxGridColumnHeaderHorzSizingEdgeHitTest.DragAndDropObjectClass
  : TcxCustomGridDragAndDropObjectClass;
begin
...
begin
  Result := MultiSelect and
    ((GridView.OptionsSelection.CheckBoxPosition <> cbpIndicator) or
...
function TcxGridRowSizingEdgeHitTest.DragAndDropObjectClass
  : TcxCustomGridDragAndDropObjectClass;
begin
...
procedure TcxGridDataRowFixingMenu.Popup(ADataRow: TcxGridDataRow;
  AForBounds: TRect);
begin
  FDataRow := ADataRow;
  RecreateOperations;
...
procedure TcxGridDataRowFixingMenu.AddOperation(AFixedState
  : TcxDataControllerRowFixedState);
var
  AImageIndex: Integer;
  AText: string;
  AData: TObject;
...
procedure TcxGridDataRowFixingMenu.DoSelectItem(AItem: TdxCustomListBoxItem;
  ASelectedViaKeyboard: Boolean);
begin
  DataRow.FixedState := TcxDataControllerRowFixedState(AItem.Data);
end;

function TcxGridDataRowFixingMenu.GetOperationImageIndex
  (AFixedState: TcxDataControllerRowFixedState): Integer;
const
...
function TcxGridDataRowFixingMenu.GetOperationText
  (AFixedState: TcxDataControllerRowFixedState): string;
begin
  case AFixedState of
    rfsNotFixed:
    ...
    rfsFixedToBottom:
      Result := cxGetResourceString
        (@scxGridDataRowFixingPopupCommandFixToBottom);
  end;
end;

{ TcxGridRowLayoutOptions }

procedure TcxGridRowLayoutOptions.Assign(Source: TPersistent);
var
  AOptions: TcxGridRowLayoutOptions;
begin
  FIsAssigning := True;
  try
    inherited Assign(Source);
    ...
    begin
      AOptions := TcxGridRowLayoutOptions(Source);
...
function TcxGridRowLayoutOptions.GetActive: Boolean;
begin
  Result := GridView.RowLayoutController.Active;
end;

function TcxGridRowLayoutOptions.GetDefaultColumnCount: Integer;
begin
  Result := GridView.RowLayoutController.DefaultColumnCount;
end;

function TcxGridRowLayoutOptions.GetDefaultStretch: TcxGridRowLayoutStretch;
begin
  Result := GridView.RowLayoutController.DefaultStretch;
end;
...
function TcxGridRowLayoutOptions.GetItemHotTrack: Boolean;
begin
  Result := GridView.RowLayoutController.ItemHotTrack;
end;

function TcxGridRowLayoutOptions.GetUseDefaultLayout: Boolean;
begin
  Result := GridView.RowLayoutController.UseDefaultLayout;
end;

procedure TcxGridRowLayoutOptions.SetActive(AValue: Boolean);
begin
  GridView.RowLayoutController.Active := AValue;
end;

procedure TcxGridRowLayoutOptions.SetDefaultColumnCount(AValue: Integer);
begin
  GridView.RowLayoutController.DefaultColumnCount := AValue;
end;

procedure TcxGridRowLayoutOptions.SetDefaultStretch
  (AValue: TcxGridRowLayoutStretch);
begin
  GridView.RowLayoutController.DefaultStretch := AValue;
end;

procedure TcxGridRowLayoutOptions.SetItemHotTrack(AValue: Boolean);
begin
  GridView.RowLayoutController.ItemHotTrack := AValue;
end;

procedure TcxGridRowLayoutOptions.SetUseDefaultLayout(AValue: Boolean);
begin
  GridView.RowLayoutController.UseDefaultLayout := AValue;
end;
...
procedure TcxGridTableRowLayoutDataCellViewInfo.GetCaptionParams
  (var AParams: TcxViewParams);
begin
  if InvalidateOnStateChange and (State = gcsSelected) then
    GridView.Styles.GetRowLayoutItemHottrackParams(Item, AParams)
  else
    GridView.Styles.GetRowLayoutItemParams(GridRecord, Item, AParams);
end;

function TcxGridTableRowLayoutDataCellViewInfo.GetLayoutItemViewInfoInstance
  : TcxGridCustomLayoutItemViewInfo;
begin
  Result := TcxGridDataRowViewInfo(RecordViewInfo)
    .LayoutViewInfo.FindLayoutItemViewInfo(Item);
end;

function TcxGridTableRowLayoutDataCellViewInfo.InvalidateOnStateChange: Boolean;
begin
  Result := inherited InvalidateOnStateChange and
    (GridView.RowLayout.ItemHotTrack or
    not GridView.OptionsSelection.InvertSelect);
end;
...
function TcxGridTableRowLayoutContainer.CanCreateLayoutItem
  (AGridItem: TcxCustomGridTableItem): Boolean;
var
  AColumn: TcxCustomGridColumn absolute AGridItem;
begin
  Result := inherited CanCreateLayoutItem(AGridItem) and
    AColumn.IsVisibleForRowLayout and (AColumn.RowLayoutItem = nil);
end;

function TcxGridTableRowLayoutContainer.CanPlaceItem
...
function TcxGridTableRowLayoutContainer.GetActualViewInfo
  : TcxGridRowLayoutContainerViewInfo;
var
...
function TcxGridTableRowLayoutContainer.GetClientBounds: TRect;
begin
  if (CalculatedViewInfo <> nil) and (CalculatedViewInfo.RecordViewInfo <> nil)
  then
    Result := TcxGridDataRowViewInfo(CalculatedViewInfo.RecordViewInfo)
      .GetLayoutBounds
  else
    Result := inherited GetClientBounds;
end;

function TcxGridTableRowLayoutContainer.GetDefaultGroupClass
  : TdxLayoutGroupClass;
begin
...
function TcxGridTableRowLayoutContainer.GetViewInfoClass
  : TdxLayoutContainerViewInfoClass;
begin
  Result := TcxGridTableRowLayoutContainerViewInfo;
end;
...
procedure TcxGridTableRowLayoutSerializationOwner.GetChildren
...
procedure TcxGridTableRowLayoutSerializationOwner.SetContainer
  (AValue: TcxGridTableRowLayoutContainer);
begin
  FContainer := AValue;
end;

procedure TcxGridTableRowLayoutSerializationOwner.SetParentComponent
  (Value: TComponent);
begin
...
function TcxGridTableRowLayoutSerializationOwner.GetContainer
  : TdxLayoutContainer;
begin
  Result := FContainer;
end;
...
procedure TcxGridTableRowLayoutController.CopyCustomizationSetting
...
procedure TcxGridTableRowLayoutController.ActiveChanged;
begin
  inherited ActiveChanged;
  GridView.CheckItemsUsingInFindCriteria;
end;

function TcxGridTableRowLayoutController.CreateCustomizationController
  : TcxGridRowLayoutCustomizationController;
begin
  Result := TcxGridTableRowLayoutCustomizationController.Create(GridView);
end;

function TcxGridTableRowLayoutController.CreateContainerOwner
  : TcxGridTableRowLayoutSerializationOwner;
begin
  Result := TcxGridTableRowLayoutSerializationOwner.Create(nil);
end;

function TcxGridTableRowLayoutController.GetContainerClass
  : TcxGridRowLayoutContainerClass;
begin
  Result := TcxGridTableRowLayoutContainer;
end;

function TcxGridTableRowLayoutController.GetLayoutLookAndFeel
  : TcxGridRowLayoutLookAndFeel;
begin
  Result := GridView.RowLayoutLookAndFeel;
end;

function TcxGridTableRowLayoutController.GetResetDefaultLayoutQuery: string;
begin
  Result := GetResetCustomSettingLayoutQueryStr('row');
end;

function TcxGridTableRowLayoutController.IsAssigningOptions: Boolean;
begin
  Result := GridView.RowLayout.IsAssigning;
end;

procedure TcxGridTableRowLayoutController.SetSerializationOwner
  (AValue: TcxGridTableRowLayoutSerializationOwner);
begin
...
begin
  SetSerializationOwner(CreateContainerOwner);
  try
    FSerializationOwner.SetContainer(Container);
...
procedure TcxGridTableRowLayoutController.UseDefaultLayoutChanged;
begin
  inherited UseDefaultLayoutChanged;
  GridView.CheckItemsUsingInFindCriteria;
end;

function TcxGridTableRowLayoutController.GetContainer
  : TcxGridTableRowLayoutContainer;
begin
...
procedure TcxGridTableViewInplaceEditFormDataCellViewInfo.GetCaptionParams
  (var AParams: TcxViewParams);
begin
  if InvalidateOnStateChange and (State = gcsSelected) then
...
begin
  Result := TcxGridDataRowViewInfo(RecordViewInfo)
    .InplaceEditFormAreaViewInfo.GetBoundsForEdit(inherited GetEditBounds);
end;

function TcxGridTableViewInplaceEditFormDataCellViewInfo.
  GetLayoutItemViewInfoInstance: TcxGridCustomLayoutItemViewInfo;
begin
...
function TcxGridTableViewInplaceEditFormDataCellViewInfo.
  InvalidateOnStateChange: Boolean;
begin
  Result := inherited InvalidateOnStateChange and
    GridView.EditForm.ItemHotTrack;
end;

function TcxGridTableViewInplaceEditFormDataCellViewInfo.GetGridView
  : TcxGridTableView;
begin
  Result := TcxGridTableView(inherited GridView);
end;

function TcxGridTableViewInplaceEditFormDataCellViewInfo.GetGridViewInfo
...
begin
  ARowViewInfo := TcxGridDataRowViewInfo(RecordViewInfo);
  if (ARowViewInfo <> nil) and (ARowViewInfo.InplaceEditFormAreaViewInfo <> nil)
  then
  begin
    AColumn := TcxCustomGridColumn(AViewInfo.Item.GridViewItem);
    Result := ARowViewInfo.InplaceEditFormAreaViewInfo.FindCellViewInfo
      (AColumn);
  end
  else
    Result := nil;
...
function TcxGridTableViewInplaceEditFormContainer.CanCreateLayoutItem
  (AGridItem: TcxCustomGridTableItem): Boolean;
var
  AColumn: TcxCustomGridColumn absolute AGridItem;
begin
  Result := inherited CanCreateLayoutItem(AGridItem) and
    AColumn.IsVisibleForEditForm and (AColumn.LayoutItem = nil);
end;

function TcxGridTableViewInplaceEditFormContainer.CanPlaceItem
  (AItem: TcxGridRowLayoutItem): Boolean;
begin
  Result := inherited CanPlaceItem(AItem) and (AItem.GridViewItem <> nil) and
...
function TcxGridTableViewInplaceEditFormContainer.GetViewInfoClass
  : TdxLayoutContainerViewInfoClass;
begin
...
procedure TcxGridTableViewInplaceEditFormContainer.SetItemForGridItem
  (AGridItem: TcxCustomGridTableItem; AItem: TcxGridRowLayoutItem);
begin
  TcxGridColumn(AGridItem).LayoutItem :=
    TcxGridInplaceEditFormLayoutItem(AItem);
end;

function TcxGridTableViewInplaceEditFormContainer.GetInplaceEditForm
  : TcxGridTableViewInplaceEditForm;
begin
...
function TcxGridTableViewInplaceEditFormContainer.GetViewInfo
  : TcxGridTableViewInplaceEditFormContainerViewInfo;
begin
  Result := TcxGridTableViewInplaceEditFormContainerViewInfo
    (inherited ViewInfo);
...
function TcxGridTableViewInplaceEditFormCustomizationController.
  CreateForm: TForm;
begin
...
function TcxGridTableViewInplaceEditForm.GetContainer
  : TcxGridTableViewInplaceEditFormContainer;
begin
...
function TcxGridTableViewInplaceEditForm.GetContainerClass
  : TcxGridRowLayoutContainerClass;
begin
...
begin
  ...
  if ARecord.IsData and (ARecord.ViewInfo <> nil) then
    TcxGridDataRowViewInfo(ARecord.ViewInfo)
      .InplaceEditFormAreaViewInfo.InvalidateUpdateButtonInfo;
end;
...
function TcxGridTableViewInplaceEditForm.CreateCustomizationController
  : TcxGridRowLayoutCustomizationController;
begin
  Result := TcxGridTableViewInplaceEditFormCustomizationController.Create
    (GridView);
end;
...
begin
  ...
  DetachedForm.UseDefaultHeight := DetachedForm.UseDefaultHeight and
    (AHeight = DetachedForm.Height);
  DetachedForm.UseDefaultWidth := DetachedForm.UseDefaultWidth and
    (AWidth = DetachedForm.Width);
end;
...
function TcxGridTableViewInplaceEditForm.GetLayoutLookAndFeel
  : TcxGridRowLayoutLookAndFeel;
begin
...
function TcxGridEditFormOptions.GetCaptionMask: string;
begin
  Result := InplaceEditForm.CaptionMask;
end;
...
function TcxGridEditFormOptions.GetDefaultStretch
  : TcxGridInplaceEditFormStretch;
begin
...
function TcxGridEditFormOptions.GetInplaceEditForm
  : TcxGridTableViewInplaceEditForm;
begin
...
procedure TcxGridEditFormOptions.SetCaptionMask(const AValue: string);
begin
  InplaceEditForm.CaptionMask := AValue;
end;
...
procedure TcxGridEditFormOptions.SetUseDefaultLayout(AValue: Boolean);
begin
...
begin
  Result := inherited GetIsParentRecordLast(AIndex) or
    (Index = Controller.LastScrollRecordIndex);
end;
...
procedure TcxCustomGridRow.SetFixedState
  (AValue: TcxDataControllerRowFixedState);
begin
  // do nothing
end;
...
begin
  Result := (GridView.OptionsBehavior.EditMode <> emInplace) and
    not IsSpecial and (FixedState = rfsNotFixed);
end;
...
begin
  Result := InplaceEditForm.EditingRecordIndex = Index;
end;
...
begin
  case Key of
    VK_RETURN, VK_F2:
      if (GridView.OptionsBehavior.EditMode <> emInplace) and not EditFormVisible
      then
      begin
...
begin
  ...
  else if not GridView.IsDesigning and
    (GridView.OptionsBehavior.EditMode <> emInplace) then
    InplaceEditForm.Edit(Self);
end;

function TcxGridDataRow.ShowCheckBox: Boolean;
begin
  Result := (cbvDataRow in GridView.OptionsSelection.CheckBoxVisibility) and
    not IsSpecial;
end;
...
function TcxGridDataRow.GetViewInfoCacheItemClass
...
begin
  ...
  else if FixedState <> rfsNotFixed then
    FixedState := rfsNotFixed
  else if GridView.FixedDataRows.PinClickAction = rpcaFixToBottom then
...
procedure TcxGridFilterRow.ActualizeProperties(AProperties
...
function TcxGridFilterRow.GetFilterCriteriaItem(Index: Integer)
...
begin
  ...
  if (ACriteriaItem <> nil) and IsCriteriaItemSupported(Index, ACriteriaItem)
  then
...
function TcxGridFilterRow.GetOperator(Index: Integer; AValue: Variant)
...
procedure TcxGridFilterRow.SetOperator(Index: Integer;
  AOperator: TcxFilterOperatorKind);
var
  AColumn: TcxGridColumn;
  AValue: Variant;
begin
  if not GridView.FilterRow.OperatorCustomization or
    not Controller.IsFilterRowOperatorSupported(Index, AOperator) then
    Exit;
  ...
  try
    ...
    begin
      ...
      try
        ...
        AColumn.DataBinding.AddToFilter(nil, AOperator, AValue,
...
begin
  ...
  try
    ...
    begin
      ...
      try
        DataController.Filter.Active := True;
        AColumn.DataBinding.AddToFilter(nil, GetOperator(Index, Value), Value,
...
function TcxGridFilterRow.GetDisplayTextForValue(AIndex: Integer;
...
function TcxGridFilterRow.GetDefaultFilterOperatorKind(const AValue: Variant;
  ACheckMask: Boolean): TcxFilterOperatorKind;

  function HasMask(const AValue: string): Boolean;
  begin
    Result := (Pos(DataController.Filter.PercentWildcard, AValue) <> 0) or
...
function TcxGridFilterRow.IsCriteriaItemSupported(AIndex: Integer;
  ACriteriaItem: TcxFilterCriteriaItem): Boolean;
var
  AOperator: TcxFilterOperatorKind;
  AValue: Variant;
begin
  ...
  if GridView.FilterRow.OperatorCustomization then
    Result := Controller.IsFilterRowOperatorSupported(AIndex, AOperator) and
      not VarIsSoftNull(AValue)
  else
    Result := AOperator
      in [foEqual, GetDefaultFilterOperatorKind(AValue, False)];
end;
...
begin
  Result := IsValid and (ActiveDetailIndex <> -1) and DetailGridViewExists
    [ActiveDetailIndex];
end;
...
begin
  ...
  if (Result <> -1) and not GridView.IsDestroying then
    ...
    else if not GridViewLevel.Options.TabsForEmptyDetails and
      not DetailGridViewHasData[Result] then
    begin
      GridView.BeginUpdate;
      try
...
function TcxGridMasterDataRow.GetDetailGridView(Index: Integer)
  : TcxCustomGridView;
begin
  Result := DataController.GetDetailLinkObject(RecordIndex, Index)
    as TcxCustomGridView;
end;
...
begin
  ...
  begin
    ...
    TcxCustomGridAccess(AGridView.Control).DoActiveTabChangedEx
      (ANewActiveDetailLevel, RecordIndex);
  end;
end;
...
begin
  ...
  if not DataController.ChangeDetailExpanding(RecordIndex, True) then
    Exit;
  ...
  else if Expanded and ARecurse then
    for I := 0 to DetailGridViewCount - 1 do
    begin
      AGridView := DetailGridViews[I];
      if AGridView is TcxCustomGridTableView then
...
begin
  Result := (GridView.OptionsView.ExpandButtonsForEmptyDetails or HasChildren or
    Expanded) and (FixedState = rfsNotFixed);
end;
...
function TcxGridMasterDataRow.GetViewInfoCacheItemClass
  : TcxCustomGridViewInfoCacheItemClass;
begin
  Result := TcxGridMasterTableViewInfoCacheItem;
end;

function TcxGridMasterDataRow.GetViewInfoClass
...
function TcxGridMasterDataRow.GetInternalActiveDetailGridView
  (out AView: TcxCustomGridView): Boolean;
var
  AIndex: Integer;
begin
...
begin
  Result := (GridView.MasterRowDblClickAction = dcaSwitchExpandedState) and
    GridView.OptionsBehavior.ExpandMasterRowOnDblClick and Expandable or
    (GridView.MasterRowDblClickAction = dcaShowEditForm) and
    inherited ExpandOnDblClick;
end;
...
begin
  ...
  begin
    ...
    if (AGridView is TcxGridTableView) and TcxGridTableView(AGridView).ViewData.HasFilterRow
    then
      Result := TcxGridTableView(AGridView).ViewData.FilterRow
    else if AGridView is TcxCustomGridTableView then
      with TcxCustomGridTableView(AGridView) do
        if ViewData.HasNewItemRecord then
          Result := ViewData.NewItemRecord
        else
        begin
          AGridRecordIndex := Controller.FindNextRecord(-1, True, False,
            ACycleChanged);
...
function TcxGridMasterDataRow.GetLastFocusableChild(ARecursive: Boolean)
  : TcxCustomGridRecord;
var
  AGridView: TcxCustomGridView;
  AGridRecordIndex: Integer;
...
begin
  ...
  begin
    ...
    if AGridView is TcxCustomGridTableView then
      with TcxCustomGridTableView(AGridView) do
      begin
        AGridRecordIndex := Controller.FindNextRecord(-1, False, True,
          ACycleChanged);
        if AGridRecordIndex <> -1 then
        begin
          Result := ViewData.Records[AGridRecordIndex];
        ...
        else if ViewData.HasNewItemRecord then
          Result := ViewData.NewItemRecord
        else if (AGridView is TcxGridTableView) and TcxGridTableView(AGridView)
          .ViewData.HasFilterRow then
          Result := TcxGridTableView(AGridView).ViewData.FilterRow;
      end;
  end;
end;
...
function TcxGridGroupRow.GetDisplayCaptionByGroupedColumn
...
function TcxGridGroupRow.GetGroupedColumn(AGroupedColumnIndex: Integer)
  : TcxGridColumn;
var
  AItemIndex: Integer;
begin
  AItemIndex := DataController.Groups.
    GetGroupingItemIndexByLevelGroupedItemIndex(Level, AGroupedColumnIndex);
  Result := GridView.Columns[AItemIndex];
end;
...
function TcxGridGroupRow.GetGroupedColumnValue(AGroupedColumnIndex
  : Integer): Variant;
begin
...
begin
  if not ARecurse and not Expanded or not GridView.DoGroupRowCollapsing(Self)
  then
    Exit;
  AGridView := GridView;
  ...
  if not AIsEditing or
    (AFocusedGroupIndex = AGridView.Controller.GetGroupIndexByFocusedRowIndex)
  then
    AGridView.DoGroupRowCollapsed(AGridView.ViewData.Rows[AIndex]
      as TcxGridGroupRow);
end;
...
begin
  ...
  AGridView.DoGroupRowExpanded(AGridView.ViewData.Rows[AIndex]
    as TcxGridGroupRow);
end;
...
begin
  ...
  if (Result = cbsUnchecked) and (dcoMultiSelectionSyncGroupWithChildren
    in DataController.Options) and DataController.GroupContainsSelectedRows
    (Index) then
    Result := cbsGrayed;
end;
...
begin
  if ViewData.HasCustomDataHandling(GroupedColumn, doGrouping) then
    Result := ViewData.GetCustomDataDisplayText(RecordIndex, GroupedColumn.
      Index, doGrouping)
  else
    Result := inherited GetDisplayText(Index);
end;

function TcxGridGroupRow.GetDisplayTextByGroupedColumn(AGroupedColumnIndex
  : Integer): string;
var
  AColumn: TcxGridColumn;
...
begin
  ...
  if ViewData.HasCustomDataHandling(AColumn, doGrouping) then
    Result := ViewData.GetCustomDataDisplayText(RecordIndex, AColumnIndex,
      doGrouping)
  else
...
function TcxGridGroupRow.GetViewInfoCacheItemClass
  : TcxCustomGridViewInfoCacheItemClass;
begin
  Result := TcxGridTableViewInfoCacheItem;
end;
...
function TcxGridGroupRow.GetDisplayTextValueByGroupedColumn
  (AIndex: Integer): string;
var
  ASummaryText: string;
begin
...
function TcxGridGroupRow.GetGroupSummaryInfo(var ASummaryItems
  : TcxDataSummaryItems; var ASummaryValues: PVariant;
  AGroupedColumnIndex: Integer = 0): Boolean;
begin
  Result := DataController.Summary.GetGroupSummaryInfo(Index, ASummaryItems,
    ASummaryValues, AGroupedColumnIndex);
end;
...
function TcxGridViewData.GetFirstVisibleExpandedMasterRow: TcxGridMasterDataRow;
  ...
  begin
    for Result := Controller.TopRecordIndex to Controller.TopRecordIndex +
      ViewInfo.RecordsViewInfo.VisibleCount - 1 do
...
function TcxGridViewData.GetRecordByKind(AKind, AIndex: Integer)
  : TcxCustomGridRecord;
begin
...
function TcxGridViewData.GetDataRecordClass(const ARecordInfo: TcxRowInfo)
  : TcxCustomGridRecordClass;
begin
  Result := TcxGridDataRow;
end;

function TcxGridViewData.GetGroupRecordClass(const ARecordInfo: TcxRowInfo)
  : TcxCustomGridRecordClass;
begin
  Result := TcxGridGroupRow;
end;

function TcxGridViewData.GetMasterRecordClass(const ARecordInfo: TcxRowInfo)
  : TcxCustomGridRecordClass;
begin
...
function TcxGridViewData.GetTopGroup(ARowIndex: Integer; ALevel: Integer = 0)
  : TcxCustomGridRow;
var
...
function TcxGridViewData.GetTopGroupIndex(ARowIndex: Integer;
  ALevel: Integer = 0): Integer;
begin
...
function TcxGridViewData.MakeDetailVisible(ADetailLevel
  : TComponent { TcxGridLevel } ): TcxCustomGridView;
var
...
function TcxGridColumnHeaderMergeIndicator.CalculateBounds(const APosition
  : TPoint): TRect;
begin
...
function TcxGridColumnHeaderMergeIndicator.GetIndicatorPoints
  (const ABounds: TRect): TPoints;
var
  AHalfSize: Integer;
begin
  ...
  Result[6] := Point(ABounds.Left + 4 * AHalfSize - 1,
    ABounds.Top + 3 * AHalfSize - 1);
  Result[7] := Point(ABounds.Left + 3 * AHalfSize - 1,
    ABounds.Top + 3 * AHalfSize - 1);
  Result[8] := Point(ABounds.Left + 3 * AHalfSize - 1,
    ABounds.Top + 4 * AHalfSize - 1);
  Result[9] := Point(ABounds.Left + AHalfSize, ABounds.Top + 4 * AHalfSize - 1);
  Result[10] := Point(ABounds.Left + AHalfSize,
    ABounds.Top + 3 * AHalfSize - 1);
...
procedure TcxGridColumnHeaderMovingObject.Init(const P: TPoint;
...
procedure TcxGridColumnHeaderMovingObject.CalculateDestParams
...
begin
  Result := SourceItem.VisibleForCustomization and
    ...
    (GridView.Controller.Customization or
    GridView.OptionsCustomize.ColumnHiding));
end;

procedure TcxGridColumnHeaderMovingObject.CheckDestItemContainerKind
...
procedure TcxGridColumnHeaderMovingObject.DragAndDrop(const P: TPoint;
...
function TcxGridColumnHeaderMovingObject.GetArrowAreaBounds
  (APlace: TcxGridArrowPlace): TRect;
begin
...
begin
  ...
  if DestZone.ItemIndex = AGroupByBoxViewInfo.Count then
    ...
    begin
      AColumnHeaderViewInfo := AGroupByBoxViewInfo.Items
        [AGroupByBoxViewInfo.Count - 1];
...
function TcxGridColumnHeaderMovingObject.GetArrowAreaBoundsForHeader
  (APlace: TcxGridArrowPlace): TRect;
begin
...
function TcxGridColumnHeaderMovingObject.GetMergeIndicatorClass
  : TcxGridColumnHeaderMergeIndicatorClass;
begin
...
begin
  ...
  if ARightToLeft then
    ...
    Result := Point(ADragAndDropTopArrowBounds.Right,
      ADragAndDropTopArrowBounds.Top);
  Result := cxPointOffset(Result, GridView.Site.ClientOrigin);
  Result := cxPointOffset(Result, AOffsetX, AOffsetY);
end;

function TcxGridColumnHeaderMovingObject.GetSourceItemViewInfo
...
procedure TcxGridColumnHeaderMovingObject.HeaderBeginUpdate(AFromGroupByBox
  : Boolean);
begin
...
procedure TcxGridColumnHeaderMovingObject.HeaderEndUpdate(AFromGroupByBox
  : Boolean);
begin
  if AFromGroupByBox then
...
begin
  Result := (DestItemContainerKind = ckGroupByBox) and CanMergeByCtrl and
    IsCtrlPressed;
end;
...
begin
  ...
  begin
    case DestItemContainerKind of
      ckGroupByBox:
        Result := (SourceItem.GroupIndex = -1) and
          (not IsMerging or AllowMergeWithLeftColumn or
          AllowMergeWithRightColumn);
      ckHeader:
...
function TcxGridColumnHeaderMovingObject.
  IsValidDestinationForVisibleSource: Boolean;
begin
  case DestItemContainerKind of
    ckGroupByBox:
      if IsMerging then
        Result := AllowMergeWithLeftColumn and
          (SourceItem.GroupIndex <> DestZone.ItemIndex - 1) and
          not((SourceItem.GroupIndex = DestZone.ItemIndex) and
          SourceItem.IsChildInMergedGroup) or AllowMergeWithRightColumn and
          (SourceItem.GroupIndex <> DestZone.ItemIndex) and
          not((SourceItem.GroupIndex = DestZone.ItemIndex - 1) and
          GetRightGroupColumn.IsChildInMergedGroup)
      else
        Result := (DestZone.ItemIndex < SourceItem.GroupIndex) or
          (SourceItem.GroupIndex + 1 < DestZone.ItemIndex) or
          SourceItem.IsChildInMergedGroup or
          (SourceItem.GroupIndex <> GridView.GroupedColumnCount - 1) and
          GridView.GroupedColumns[SourceItem.GroupIndex + 1]
          .IsChildInMergedGroup;
    ckHeader:
      Result := (SourceItemContainerKind = ckGroupByBox) or
...
procedure TcxGridColumnHeaderMovingObject.MergeIndicatorPositionChanged
...
function TcxGridColumnHeaderMovingObject.ProcessKeyDown(AKey: Word;
  AShiftState: TShiftState): Boolean;
begin
  Result := inherited ProcessKeyDown(AKey, AShiftState) or
    (CanMergeByCtrl and (ssCtrl in AShiftState));
  if HasMergeIndicator then
    MergeIndicatorPositionChanged;
end;

function TcxGridColumnHeaderMovingObject.ProcessKeyUp(AKey: Word;
  AShiftState: TShiftState): Boolean;
begin
...
begin
  Result := (GetLeftGroupColumn <> nil) and
    (UnmergeableColumns.IndexOf(GetLeftGroupColumn) = -1);
end;

function TcxGridColumnHeaderMovingObject.AllowMergeWithRightColumn: Boolean;
begin
  Result := (GetRightGroupColumn <> nil) and
    (UnmergeableColumns.IndexOf(GetRightGroupColumn) = -1);
end;

function TcxGridColumnHeaderMovingObject.ColumnGrouping: Boolean;
begin
  if IsValidDestination then
    Result := SourceItem.GroupBy(GetGroupByIndex, True, MergeWithLeftColumn,
      MergeWithRightColumn)
  else
    Result := False;
end;
...
begin
  ...
  if Result then
  begin
    AFromGroupByBox := (SourceItemContainerKind = ckGroupByBox) and
      SourceItem.CanGroup;
  ...
  case SourceItemContainerKind of
    ckGroupByBox:
      Result := SourceItem.GroupBy(-1,
        ...
        (not GridView.OptionsCustomize.ColumnHiding or not SourceItem.CanHide)
        and not Controller.Customization);
    ckHeader:
...
begin
  Result := DestZone.ItemIndex - Byte((SourceItem.GroupIndex <> -1) and
    (SourceItem.GroupIndex < DestZone.ItemIndex));
end;
...
begin
  Result := nil;
  AUseSourceIndex := (SourceItem.GroupIndex <> -1) and
    (SourceItem.GroupIndex = DestZone.ItemIndex - 1);
...
var
  ...
  AIndex: Integer;
begin
  AUseGroupIndex := (SourceItem.GroupIndex <> -1) and
    (SourceItem.GroupIndex = DestZone.ItemIndex);
...
begin
  Result := IsMerging and AllowMergeWithLeftColumn and
    ((SourceItem.GroupIndex = -1) or
    (SourceItem.GroupIndex <> DestZone.ItemIndex - 1) or
    SourceItem.IsChildInMergedGroup);
end;

function TcxGridColumnHeaderMovingObject.MergeWithRightColumn: Boolean;
begin
  Result := IsMerging and AllowMergeWithRightColumn and
    ((SourceItem.GroupIndex = -1) or
    (SourceItem.GroupIndex <> DestZone.ItemIndex) or
    GetRightGroupColumn.IsChildInMergedGroup);
end;
...
function TcxCustomGridSizingObject.GetDragAndDropCursor
...
procedure TcxCustomGridSizingObject.DragAndDrop(const P: TPoint;
  var Accepted: Boolean);
begin
  if IsHorizontalSizing then
    DestPointX := P.X
...
procedure TcxCustomGridSizingObject.Init(const P: TPoint;
  AParams: TcxCustomGridHitTest);
begin
  inherited;
...
function TcxCustomGridColumnSizingObject.GetColumnHeaderViewInfo
...
procedure TcxCustomGridColumnSizingObject.Init(const P: TPoint;
  AParams: TcxCustomGridHitTest);
begin
  inherited;
...
procedure TcxGridRowSizingObject.Init(const P: TPoint;
  AParams: TcxCustomGridHitTest);
begin
  inherited;
...
begin
  Result := 2 * (LookAndFeelPainter.HeaderBorderSize +
...
procedure TcxGridTableItemsListBox.LookAndFeelChanged(Sender: TcxLookAndFeel;
...
begin
  ...
  ASelectionR.Deflate(LookAndFeelPainter.HeaderBorderSize);
  ATextR := cxRectInflate(ASelectionR,
    -ScaleFactor.Apply(cxGridCellTextOffset), 0);
  ...
  LookAndFeelPainter.DrawScaledHeader(ACanvas, R, ATextR, [], cxBordersAll,
    States[AFocused], AHorzAlignment, vaCenter, False, GetItemEndEllipsis,
    Items[AIndex], ACanvas.Font, ACanvas.Font.Color, Style.Color, ScaleFactor,
    DrawItemDrawBackgroundHandler);
  if AFocused then
...
function TcxGridTableColumnsListBox.DrawItemDrawBackgroundHandler
  (ACanvas: TcxCanvas; const ABounds: TRect): Boolean;
begin
  Result := GridView.ViewInfo.HeaderViewInfo.DrawColumnBackgroundHandler
    (ACanvas, ABounds);
end;
...
function TcxGridTableCustomizationForm.GetColumnsListBox
  : TcxGridTableColumnsListBox;
begin
...
function TcxGridTableCustomizationForm.GetItemsListBoxClass
...
function TcxGridDragOpenInfoMasterDataRowTab.Equals
...
procedure TcxGridColumnsCustomizationPopup.SetItemIndex(AItem: TObject;
  AIndex: Integer);
begin
  inherited;
...
begin
  ...
  if (GridView.FindPanel.Location = fplGroupByBox) and not Visible and not AWasVisible
  then
    Changed;
end;
...
begin
  ...
  else if Controller.InplaceEditForm.Visible then
    Controller.InplaceEditForm.UpdateModified;
end;

procedure TcxGridTableEditingController.DoEditKeyDown(var Key: Word;
  Shift: TShiftState);
var
  AKey: Word;
begin
  ...
  begin
    case AKey of
      VK_ESCAPE:
        if GridView.FilterRow.ApplyChanges in [fracImmediately, fracDelayed]
        then
        begin
          Edit.Reset;
  ...
  if (AKey = VK_ESCAPE) and Controller.InplaceEditForm.Visible then
    Controller.InplaceEditForm.UpdateModified;
end;

function TcxGridTableEditingController.GetHideEditOnFocusedRecordChange
  : Boolean;
begin
...
begin
  ...
  begin
    ...
    if (GridView.FilterRow.ApplyChanges = fracOnCellExit) and
      (Edit is TcxCustomTextEdit) and
      (Edit.ActiveProperties = TcxCustomTextEdit(Edit).Properties) then
      AddFilterValues(TcxCustomTextEdit(Edit).Properties.LookupItems);
  end;
end;

function TcxGridTableEditingController.
...
function TcxGridTableEditingController.
  NeedCellViewInfoWhenUpdateEditValue: Boolean;
begin
  Result := inherited NeedCellViewInfoWhenUpdateEditValue and
    not Controller.IsFilterRowFocused;
end;
...
begin
  ...
  AHeaderBottomBound := Site.ClientToScreen
    (ViewInfo.HeaderViewInfo.Bounds.BottomRight).Y;
...
procedure TcxGridTableColumnScrollAnimationHelper.AfterAnimationEnded
...
procedure TcxGridTableColumnScrollAnimationHelper.CheckPosition
  (var AValue: Integer);
begin
...
procedure TcxGridTableColumnScrollAnimationHelper.UpdateOwnerPosition
  (AValue: Integer);
begin
...
function TcxGridTableController.GetColumnsCustomizationPopup
  : TcxGridColumnsCustomizationPopup;
begin
  Result := TcxGridColumnsCustomizationPopup(ItemsCustomizationPopup);
end;

function TcxGridTableController.GetCustomizationForm
  : TcxGridTableCustomizationForm;
begin
...
function TcxGridTableController.GetEditingController
  : TcxGridTableEditingController;
begin
...
function TcxGridTableController.GetInplaceEditForm
  : TcxGridTableViewInplaceEditForm;
begin
  Result := GridView.InplaceEditForm;
end;
...
function TcxGridTableController.GetRowLayoutController
  : TcxGridTableRowLayoutController;
begin
  Result := GridView.RowLayoutController;
end;

function TcxGridTableController.GetSelectedColumn(Index: Integer)
  : TcxGridColumn;
begin
...
function TcxGridTableController.GetSelectedRow(Index: Integer)
  : TcxCustomGridRow;
begin
...
procedure TcxGridTableController.SetFocusedItemKind
  (AValue: TcxGridFocusedItemKind);
var
  ARecord: TcxCustomGridRecord;
begin
  ...
  begin
    ...
    if GridView.Visible and not GridView.IsUpdateLocked and
      InplaceEditForm.Visible and
    ...
    begin
      ...
      if ARecord.IsData and (ARecord.ViewInfo <> nil) then
        TcxGridDataRowViewInfo(ARecord.ViewInfo)
          .InplaceEditFormAreaViewInfo.ButtonsPanelViewInfo.Invalidate;
    end;
  end;
end;
...
procedure TcxGridTableController.AdjustOffsetForFixedGroupMode
  (ARow: TcxCustomGridRow);
var
...
begin
  if ViewInfo.RecordsViewInfo.GetFixedGroupsCount = 0 then
    Exit;
  AViewInfo := TcxCustomGridRowViewInfo
    (ViewInfo.RecordsViewInfo.GetRealItem(ARow));
  if (AViewInfo <> nil) and (AViewInfo.FixedState = rfsNotFixed) then
    PixelScrollRecordOffset :=
      ViewInfo.RecordsViewInfo.GetFixedGroupsBottomBound - AViewInfo.Bounds.Top;
end;
...
begin
  ...
  begin
    ...
    AAdjustedPosition := ViewInfo.RecordsViewInfo.
      GetAdjustedScrollPositionForFixedGroupMode(ARow, APosition);
...
begin
  Result := inherited CanAppend(ACheckOptions) and
    not ViewData.HasNewItemRecord;
end;

function TcxGridTableController.CanDataPost: Boolean;
begin
  Result := inherited CanDataPost and
    (not InplaceEditForm.Visible or (InplaceEditForm.CloseQuery = mrYes));
end;

function TcxGridTableController.CanDelete(ACheckOptions: Boolean): Boolean;
begin
  Result := inherited CanDelete(ACheckOptions) and not IsFilterRowFocused and
    not IsNewItemRowFocused;
end;
...
function TcxGridTableController.CanMakeItemVisible
  (AItem: TcxCustomGridColumn): Boolean;
begin
  Result := (AItem <> nil) and ((AItem.VisibleIndex <> -1) and
    (AItem.VisibleIndex < ViewInfo.HeaderViewInfo.Count) and
    (not GridView.RowLayout.Active or (FocusedRow <> nil) and
    FocusedRow.IsSpecial) or InplaceEditForm.Visible and TcxGridColumn(AItem)
    .IsVisibleForEditForm or GridView.RowLayout.Active and (FocusedRow <> nil)
    and FocusedRow.IsData and not FocusedRow.IsSpecial and
...
function TcxGridTableController.CheckBrowseModeOnRecordChanging(ANewRecordIndex
  : Integer): Boolean;
var
  ARecord: TcxCustomGridRecord;
begin
  Result := inherited CheckBrowseModeOnRecordChanging(ANewRecordIndex);
  if Result and InplaceEditForm.Visible then
  begin
    ARecord := ViewData.GetRecordByIndex(ANewRecordIndex);
    if (ARecord <> nil) and (not ARecord.IsData or not TcxGridDataRow(ARecord)
      .EditFormVisible) then
    begin
...
procedure TcxGridTableController.CheckInternalTopRecordIndex
  (var AIndex: Integer);
begin
...
procedure TcxGridTableController.DoMakeRecordVisible
  (ARecord: TcxCustomGridRecord);
var
  ARow: TcxCustomGridRow;
begin
...
procedure TcxGridTableController.FocusedItemChanged(APrevFocusedItem
  ...
  begin
    ...
    else if not InplaceEditForm.Visible then
...
procedure TcxGridTableController.FocusedRecordChanged(APrevFocusedRecordIndex,
  AFocusedRecordIndex, APrevFocusedDataRecordIndex, AFocusedDataRecordIndex
  : Integer; ANewItemRecordFocusingChanged: Boolean);
begin
  if IsFilterRowFocused and KeepFilterRowFocusing then
    Exit;
  inherited;
  if ViewData.HasFilterRow and ((AFocusedRecordIndex <> APrevFocusedRecordIndex)
    or ANewItemRecordFocusingChanged) then
...
function TcxGridTableController.GetDesignHitTest
...
function TcxGridTableController.GetFilterRowSupportedOperators
  : TcxFilterOperatorKinds;
begin
  if GridView.FilterRow.OperatorCustomization then
...
begin
  ...
  begin
    ...
    if (Result = nil) and ViewData.HasNewItemRecord and ViewData.NewItemRow.Selected
    then
...
function TcxGridTableController.GetGroupIndexByRowIndex
...
function TcxGridTableController.GetItemsCustomizationPopupClass
...
function TcxGridTableController.IsColumnFixedDuringHorzSizing
  (AColumn: TcxGridColumn): Boolean;
begin
  Result := (AColumn = ForcingWidthItem) or not ForcingWidthItem.IsLast and
    (AColumn.VisibleIndex < ForcingWidthItem.VisibleIndex);
end;
  ...
  begin
    ...
    begin
      ...
      if ARecordViewInfo <> nil then
        Result := ARecordViewInfo.Bounds.Top = ViewInfo.RecordsViewInfo.
          GetFixedGroupsBottomBound;
    end;
  end;
end;

function TcxGridTableController.IsKeyForMultiSelect(AKey: Word;
  AShift: TShiftState; AFocusedRecordChanged: Boolean): Boolean;
begin
  Result := inherited IsKeyForMultiSelect(AKey, AShift, AFocusedRecordChanged)
    or (AKey = VK_UP) or (AKey = VK_DOWN) or
    ((AKey = VK_HOME) or (AKey = VK_END)) and
    (not GridView.OptionsSelection.CellSelect or (FocusedRecord = nil) or
    not FocusedRecord.HasCells);
end;

function TcxGridTableController.IsPixelScrollBar(AKind: TScrollBarKind)
  : Boolean;
begin
...
begin
  Result := inherited IsScrollAnimationActive or
    FColumnScrollAnimationHelper.IsAnimationActive;
end;
...
procedure TcxGridTableController.MakeMasterRecordVisible
  (ARecord: TcxCustomGridRecord);
  ...
  begin
    ARecordViewInfo := ViewInfo.RecordsViewInfo.GetRecordViewInfo(AIndex,
      ANewlyCreated) as TcxGridMasterDataRowViewInfo;
    try
  ...
  begin
    ...
    Result := ARecord.PixelScrollPosition - ATopRecord.PixelScrollPosition +
      ViewInfo.RecordsViewInfo.ContentBounds.Top + AMasterRecordDataHeight +
      PixelScrollRecordOffset;
  end;
...
begin
  ...
  begin
    ...
    begin
      ADetailRecordBounds := cxRectOffset(MakeVisibleDetailRecordBounds, 0,
        GetDetailRecordOffset(ADataHeight));

      if AIndex = TopRecordIndex then
      begin
        if (ADetailRecordBounds.Top < AContentBounds.Top) or
          (ADetailRecordBounds.Height > AContentBounds.Height) then
        begin
          ATopRecordIndex := AIndex;
          APixelScrollRecordOffset :=
            Min(AContentBounds.Top - ADetailRecordBounds.Top +
            PixelScrollRecordOffset, 0);
          CheckTopRecordIndexAndOffset(ATopRecordIndex,
            APixelScrollRecordOffset);
          SetTopRecordIndexWithOffset(ATopRecordIndex,
            APixelScrollRecordOffset);
        end
        else if ADetailRecordBounds.Bottom > AContentBounds.Bottom then
        begin
          ATopRecordIndex := AIndex;
          APixelScrollRecordOffset := AContentBounds.Bottom -
            ADetailRecordBounds.Bottom + PixelScrollRecordOffset;
          CheckTopRecordIndexAndOffset(ATopRecordIndex,
            APixelScrollRecordOffset);
          SetTopRecordIndexWithOffset(ATopRecordIndex,
            APixelScrollRecordOffset);
      ...
      else if AIndex < TopRecordIndex then
      begin
        ATopRecordIndex := AIndex;
        APixelScrollRecordOffset := -ADataHeight -
          MakeVisibleDetailRecordBounds.Top;
      ...
      else if AIndex >= TopRecordIndex + ViewInfo.VisibleRecordCount then
      begin
        if ADetailRecordBounds.Bottom > AContentBounds.Bottom then
        begin
          ATopRecordIndex := AIndex;
          APixelScrollRecordOffset := -ADataHeight -
            MakeVisibleDetailRecordBounds.Bottom;
          ViewInfo.RecordsViewInfo.CalculatePixelScrollInfo(ATopRecordIndex,
            APixelScrollRecordOffset, RecordIndexNone,
            UnassignedPixelScrollOffset,
            ViewInfo.RecordsViewInfo.GetPixelScrollContentSize, AOverPan);
          SetTopRecordIndexWithOffset(ATopRecordIndex,
            APixelScrollRecordOffset);
        end;
      end;
      MakeVisibleDetailRecordBounds :=
        cxRectOffset(MakeVisibleDetailRecordBounds, 0,
        GetDetailRecordOffset(ADataHeight));
    end
    else
    begin
      ...
      for I := TopRecordIndex to ARecord.Index - 1 do
        AOffset.Y := AOffset.Y + ViewInfo.RecordsViewInfo.
          GetRecordScrollSize(I);
      AOffset.Y := AOffset.Y + ViewInfo.RecordsViewInfo.ContentBounds.Top +
        ADataHeight;
      MakeVisibleDetailRecordBounds :=
        cxRectOffset(MakeVisibleDetailRecordBounds, AOffset);
    end;
  end;
...
function TcxGridTableController.NeedsAdditionalRowsScrolling(AIsCallFromMaster
  : Boolean = False): Boolean;

  function IsMaxScrollPos: Boolean;
  begin
    Result := ScrollBarPos = inherited GetScrollBarRecordCount -
...
begin
  Result := False;
  if GridView.IsMaster and not IsRecordPixelScrolling and
    (ScrollRecordCount <> 0) and ((ViewInfo.VisibleRecordCount > 1) or
    AIsCallFromMaster) and (IsMaxScrollPos or AIsCallFromMaster and
    (ScrollRecordCount = 1)) and
  ...
  begin
    ...
    if ALastRow.Expanded and ALastRow.ActiveDetailGridViewExists then
      Result := not ALastRow.ActiveDetailGridView.Controller.IsDataFullyVisible
        (True) and TcxGridMasterDataRowViewInfo(ALastRow.ViewInfo)
        .DetailsSiteVisible and not TcxGridMasterDataRowViewInfo
        (ALastRow.ViewInfo).DetailsSiteViewInfo.HasMaxHeight;
  end;
end;
...
begin
  if (FocusedRecord <> Value) and ViewData.HasNewItemRecord then
    ...
    else if (FocusedRecord = ViewData.NewItemRow) and (Value = nil) then
  ...
  if ViewData.HasFilterRow then
    ...
    else if FocusedRow = ViewData.FilterRow then
    begin
      if Value = nil then
        AIndex := -1
      else
  ...
  try
    ...
    begin
      if ViewData.HasFilterRow and ViewData.FilterRow.Focused and
        (FocusedColumn = nil) then
        FocusNextItem(FocusedItemIndex, True, False, False,
...
procedure TcxGridTableController.ShowDataRowFixingMenu(ADataRow: TcxGridDataRow;
  AForBounds: TRect);
begin
  ...
  begin
    if IsRecordScrollAnimationActive then
      ATopRecordIndex := TargetRecordScrollIndex +
        Max(1, GetPageVisibleRecordCount(TargetRecordScrollIndex,
        TargetRecordScrollOffset) - 1)
    else
      ATopRecordIndex := InternalTopRecordIndex +
        Max(1, GetPageRecordCount - 1);
    if IsRecordPixelScrolling then
    begin
...
begin
  ...
  begin
    ...
    if DataController.IsGridMode and
      (ATopRecordIndex - (AVisibleRowCount - 1) = 0) and
  ...
  begin
    ...
    SetTopRecordIndexWithOffset(ATopRecordIndex, ATopRecordOffset,
      IsScrollAnimationEnabled);
  end
  else if DataController.IsGridMode then
    TopRecordIndex := InternalTopRecordIndex - (AVisibleRowCount - 1)
  else
    SetTopRecordIndexWithOffset(ATopRecordIndex - (AVisibleRowCount - 1), 0,
      IsScrollAnimationEnabled);
end;
...
begin
  Result := inherited WantSpecialKey(AKey) or
    ((AKey = VK_RETURN) and (IsFilterRowFocused or
    (GridView.OptionsBehavior.EditMode <> emInplace)));
end;
...
procedure TcxGridTableController.PopulateColumnHeaderDesignPopupMenu
  (AMenu: TPopupMenu);
begin
  AMenu.Items.Add(NewItem('Create Column', 0, False, True, CreateGridViewItem,
    0, 'chmiCreateColumn'));
  AMenu.Items.Add(NewLine);
  AMenu.Items.Add(NewItem('Delete', 0, False, True, DeleteGridViewItems, 0,
    'chmiDelete'));
end;

procedure TcxGridTableController.DoScroll(AScrollBarKind: TScrollBarKind;
  ...
  begin
    case AScrollCode of
      ...
      scLineDown:
        ScrollData(dirRight);
      scPageUp:
        SetLeftPosition(LeftPos - ViewInfo.ScrollableAreaWidth,
          IsScrollAnimationEnabled);
      scPageDown:
        SetLeftPosition(LeftPos + ViewInfo.ScrollableAreaWidth,
          IsScrollAnimationEnabled);
...
procedure TcxGridTableController.SetLeftPosition(AValue: Integer;
  AAnimated: Boolean);
begin
  if AAnimated then
...
function TcxGridTableController.CanScrollData(ADirection: TcxDirection)
  : Boolean;
var
  Value: Integer;
begin
...
function TcxGridTableController.CanPostponeRecordSelection
  (AShift: TShiftState): Boolean;
begin
  Result := inherited CanPostponeRecordSelection(AShift) and
    not CellMultiSelect;
end;

function TcxGridTableController.CanProcessMultiSelect
...
procedure TcxGridTableController.DoMouseNormalSelection
...
procedure TcxGridTableController.DoMouseRangeSelection(AClearSelection
...
begin
  ...
  try
    ...
    if CellMultiSelect then
    begin
      if (SelectedColumnCount = 1) and SelectedColumns[0].Focused then
        Exit;
      ClearCellSelection;
...
procedure TcxGridTableController.MultiSelectKeyDown(var Key: Word;
  Shift: TShiftState);
begin
  if CellMultiSelect then
...
procedure TcxGridTableController.CheckFocusedItem(AItemViewInfo
  : TcxGridTableViewInplaceEditFormDataCellViewInfo);

  function GetNextFocusedItem(AGroupViewInfo: TdxLayoutGroupViewInfo;
    out AFocusedItem: TcxCustomGridTableItem): Boolean;
  var
    I: Integer;
  ...
  begin
    ...
    begin
      if AGroupViewInfo.ItemViewInfos[I] is TdxLayoutGroupViewInfo then
        Result := GetNextFocusedItem(AGroupViewInfo.ItemViewInfos[I]
          as TdxLayoutGroupViewInfo, AFocusedItem)
      else if (AGroupViewInfo.ItemViewInfos[I]
        is TcxGridCustomLayoutItemViewInfo) then
      begin
        ALayoutItemViewInfo := TcxGridCustomLayoutItemViewInfo
          (AGroupViewInfo.ItemViewInfos[I]);
        Result := TcxGridTableViewInplaceEditFormDataCellViewInfo
          (ALayoutItemViewInfo.GridItemViewInfo).CanFocus;
        if Result then
  ...
  function GetParentViewInfo(AItemViewInfo: TdxCustomLayoutItemViewInfo;
    out AParentViewInfo: TdxLayoutGroupViewInfo): Boolean;
  begin
    Result := AItemViewInfo.ParentViewInfo <> nil;
    if Result then
    begin
      Result := AItemViewInfo.ParentViewInfo.Expanded and
        AItemViewInfo.ParentViewInfo.IsActuallyVisible;
      if Result then
        AParentViewInfo := AItemViewInfo.ParentViewInfo
      else
        Result := GetParentViewInfo(AItemViewInfo.ParentViewInfo,
          AParentViewInfo);
    end;
    if not Result then
      AParentViewInfo := nil;
...
begin
  ...
  begin
    if (AItemViewInfo.LayoutItemViewInfo <> nil) and
      GetParentViewInfo(AItemViewInfo.LayoutItemViewInfo, AParentViewInfo) and
      GetNextFocusedItem(AParentViewInfo, AFocusedItem) then
      FocusedItem := AFocusedItem
    else if not FocusFirstAvailableItem then
      FocusedItem := nil;
  end;
end;
...
function TcxGridTableController.FocusNextEditFormItem
...
function TcxGridTableController.FocusNextEditFormItem(AFocusedItemIndex
  : Integer; AGoForward: Boolean): Boolean;
var
  ACycleChanged: Boolean;
begin
  AFocusedItemIndex := GetNextLayoutItemIndex
    (InplaceEditForm.Container.ViewInfo, AFocusedItemIndex, AGoForward, False,
    GetNextEditFormItemIndexFunc, ACycleChanged);
...
function TcxGridTableController.FocusNextRowLayoutItem(AFocusedItemIndex
  : Integer; AGoForward, AGoOnCycle: Boolean;
  out ACycleChanged: Boolean): Boolean;
begin
  AFocusedItemIndex := GetNextLayoutItemIndex
    (RowLayoutController.Container.GetActualViewInfo, AFocusedItemIndex,
    AGoForward, AGoOnCycle, GetNextRowLayoutItemIndexFunc, ACycleChanged);
  Result := (AFocusedItemIndex <> -1) and
    (not AGoOnCycle or not ACycleChanged or FocusNextRecord(FocusedRecordIndex,
    AGoForward, False, False, False));
  if Result then
  begin
...
begin
  ...
  else if (Result < 0) and (FFocusedItemKind in [fikNone, fikGridItem]) then
  begin
    Result := -1;
    FocusedItemKind := fikCancelButton;
  end;
...
function TcxGridTableController.GetNextLayoutItemIndex(AContainerViewInfo
  : TcxGridRowLayoutContainerViewInfo; AFocusedIndex: Integer;
  AGoForward, AGoOnCycle: Boolean; AFunc: TcxGridGetNextItemFunc;
  out ACycleChanged: Boolean): Integer;
var
...
function TcxGridTableController.DefocusSpecialRow: Boolean;
  ...
  begin
    ...
    else if InternalTopRecordIndex > -1 then
    begin
...
procedure TcxGridTableController.DoPullFocusingScrolling
...
begin
  Result := not InplaceEditForm.Visible and inherited SupportsPullFocusing or
    CellMultiSelect;
end;

function TcxGridTableController.GetDragOpenInfo(AHitTest: TcxCustomGridHitTest)
...
begin
  ...
  if (Result = nil) and (AHitTest.HitTestCode = htTab) then
    with TcxGridDetailsSiteTabHitTest(AHitTest) do
      Result := TcxGridDragOpenInfoMasterDataRowTab.Create(Level,
        Owner as TcxGridMasterDataRow);
end;

function TcxGridTableController.GetDragScrollDirection(X, Y: Integer)
  : TcxDirection;
var
  R: TRect;
begin
  ...
  if PtInRect(R, Point(X, Y)) then
    if Y < R.Top + ScrollHotZoneWidth then
      Result := dirUp
    else if Y >= R.Bottom - ScrollHotZoneWidth then
      Result := dirDown;
  ...
  begin
    ...
    if PtInRect(R, Point(X, Y)) then
      if X < R.Left + ScrollHotZoneWidth then
        Result := dirLeft
      else if X >= R.Right - ScrollHotZoneWidth then
        Result := dirRight;
  end;
end;

function TcxGridTableController.CreateCustomizationController
  : TcxCustomGridCustomizationController;
begin
  Result := TcxGridTableCustomizationController.Create(GridView);
end;

function TcxGridTableController.GetColumnHeaderDragAndDropObjectClass
  : TcxGridColumnHeaderMovingObjectClass;
begin
  Result := TcxGridColumnHeaderMovingObject;
end;

function TcxGridTableController.GetCustomizationFormClass
  : TcxCustomGridCustomizationFormClass;
begin
...
begin
  Result := inherited CanNormalSelectionOnMouse or
    GridView.OptionsSelection.ClearPersistentSelectionOnOutsideClick;
end;

function TcxGridTableController.CanProcessCellMultiSelect(APrevFocusedColumn
  : TcxGridColumn): Boolean;
begin
  Result := CellMultiSelect and (FocusedColumn <> APrevFocusedColumn);
end;

procedure TcxGridTableController.CellMultiSelectKeyDown(var Key: Word;
  Shift: TShiftState);
begin
  if ssShift in Shift then
    DoRangeCellSelection
...
begin
  if VarIsStr(AValue) and (AValue <> '') and (GetBeginsWithMaskPos(AValue) = 0)
  then
...
function TcxGridTableController.GetBeginsWithMaskPos(const AValue
  : string): Integer;
begin
  if (Length(AValue) = 0) or
    (AValue[Length(AValue)] <> DataController.Filter.PercentWildcard) then
    Result := 0
  else
    Result := Length(AValue);
end;

function TcxGridTableController.GetEditingControllerClass
...
begin
  ...
  begin
    AIndex := DataController.Groups.GetGroupingItemIndexByLevelGroupedItemIndex
      (ALevel, I);
...
begin
  if InplaceEditForm.Visible and not CloseInplaceEditFormOnRecordInserting then
    Exit;
  inherited CreateNewRecord(AtEnd);
  if (GridView.OptionsBehavior.EditMode = emModalEditForm) and
    (dceInsert in DataController.EditState) and FocusedRow.IsData and
    not FocusedRow.IsSpecial then
...
begin
  ...
  if PtInRect(R, P) then
    if P.X < R.Left + ScrollHotZoneWidth then
      ADirection := dirLeft
    else if R.Right - ScrollHotZoneWidth <= P.X then
      ADirection := dirRight
    else
      ADirection := dirNone
  else
...
function TcxGridTableController.FocusNextCell(AGoForward: Boolean;
  AProcessCellsOnly: Boolean = True; AAllowCellsCycle: Boolean = True;
  AFollowVisualOrder: Boolean = True;
  ANeedNormalizeSelection: Boolean = False): Boolean;
begin
  if InplaceEditForm.Visible and
    (GridView.OptionsBehavior.EditMode <> emModalEditForm) then
...
begin
  if InplaceEditForm.Visible and
    (GridView.OptionsBehavior.EditMode <> emModalEditForm) then
    Result := FocusNextEditFormItem(AFocusedItemIndex, AGoForward)
  else if GridView.RowLayout.Active and
    ((FocusedRow = nil) or FocusedRow.IsData and not FocusedRow.IsSpecial) then
    Result := FocusNextRowLayoutItem(AFocusedItemIndex, AGoForward,
      AGoToNextRecordOnCycle, ACycleChanged)
  else
    Result := inherited FocusNextItem(AFocusedItemIndex, AGoForward, AGoOnCycle,
      AGoToNextRecordOnCycle, AFollowVisualOrder, ANeedNormalizeSelection);
end;
...
function TcxGridTableController.IsFilterRowOperatorSupported
  (AItemIndex: Integer; AOperator: TcxFilterOperatorKind): Boolean;
begin
  Result := (AOperator in GetFilterRowSupportedOperators) and
    GridView.Columns[AItemIndex].IsFilterOperatorSupported(AOperator);
end;
...
var
  ...
  begin
    if GridView.RowLayout.Active and (FocusedRow <> nil) and
      FocusedRow.IsData and not FocusedRow.IsSpecial then
      if FocusedRow.ViewInfo <> nil then
        ACell := TcxGridDataRowViewInfo(FocusedRow.ViewInfo)
          .LayoutViewInfo.FindCellViewInfo(AColumn)
      else
        ACell := nil
    else
  ...
  begin
    SetLeftPosition(LeftPos + ADelta, IsScrollAnimationEnabled and
...
begin
  ...
  begin
    ...
    if (ADataRowViewInfo <> nil) and
      (ADataRowViewInfo.InplaceEditFormAreaViewInfo <> nil) then
      ADataRowViewInfo.InplaceEditFormAreaViewInfo.MakeItemVisible(AColumn)
  end
  else if AColumn.CanScroll then
  begin
...
begin
  ...
  Controller.SetScrollBarInfo(sbHorizontal, 0, AScrollContentWidth - 1,
    HScrollDelta, ViewInfo.ClientWidth, APos, True, CanHScrollBarHide);
  AScrollContentHeight := DataScrollSize;
  Controller.SetScrollBarInfo(sbVertical, 0, AScrollContentHeight - 1, 1,
    VisibleDataScrollSize, ScrollBarPos, True, True);
end;

function TcxGridTableController.IsDataFullyVisible(AIsCallFromMaster
  : Boolean = False): Boolean;
begin
  ...
  case Key of
    VK_LEFT, VK_RIGHT:
      begin
        ...
        if FocusNextCell(AGoForward) then
          Exit; // Key := 0;
      end;
    VK_UP, VK_DOWN:
      if InplaceEditForm.Visible then
    ...
    VK_PRIOR:
      if FocusSpecialRow then
        Exit
      else if IsSpecialRowFocused then
      begin
        Key := 0;
        Exit;
      end;
    VK_NEXT:
      if DefocusSpecialRow then
        Exit;
  end;
  inherited;
  AGridViewLink := cxAddObjectLink(GridView);
        ...
        begin
          ...
          AllowRecordScrollAnimationOnMakeVisible(procedure
            begin
              ...
              try
                if not FocusNextRecord(AFocusedRowIndex, False, False,
                  not(ssShift in Shift), not(ssShift in Shift)) and IsSpecialRowFocused
                then
                  AKey := 0;
              finally
      ...
      VK_DOWN:
        ...
        begin
          ...
          try
            AllowRecordScrollAnimationOnMakeVisible(procedure
              begin
                FocusNextRecord(FocusedRowIndex, True, False,
...
procedure TcxGridTableController.MouseUp(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
  ...
  procedure ProcessSorting(AColumn: TcxGridColumn);
    ...
    begin
      ...
      if GridView.OptionsCustomize.GroupBySorting and (AColumn.SortIndex = 0)
        and (GridView.GroupedColumnCount = 0) and AColumn.CanGroup then
        AColumn.GroupIndex := 0;
    end;

  begin
    if not AColumn.CanSort then
      Exit;
    try
...
procedure TcxGridTableController.SelectCells(AFromColumn,
  AToColumn: TcxGridColumn; AFromRowIndex, AToRowIndex: Integer);
begin
  BeginUpdate;
  try
    if AFromRowIndex = -1 then
      AFromRowIndex := 0;
    if AToRowIndex = -1 then
      AToRowIndex := DataController.RowCount - 1;
...
procedure TcxGridTableController.SelectColumns(AFromColumn,
...
function TcxGridColumnContainerPainter.GetViewInfo
...
function TcxGridColumnHeaderAreaPainter.GetViewInfo
  : TcxGridColumnHeaderAreaViewInfo;
begin
...
begin
  with TcxGridColumnHeaderSortingMarkViewInfo(ViewInfo) do
    if ColumnHeaderViewInfo.SortByGroupSummary then
      LookAndFeelPainter.DrawScaledSummarySortingMark(Self.Canvas, Bounds,
        SortOrder = soAscending, ScaleFactor)
    else
      LookAndFeelPainter.DrawScaledSortingMark(Self.Canvas, Bounds,
        SortOrder = soAscending, ScaleFactor);
end;

{ TcxGridColumnHeaderFilterButtonPainter }

function TcxGridColumnHeaderFilterButtonPainter.GetSmartTagState
...
function TcxGridColumnHeaderFilterButtonPainter.GetViewInfo
...
begin
  with ViewInfo do
    if IsSmartTag then
      LookAndFeelPainter.DrawScaledFilterSmartTag(Self.Canvas, Bounds,
        SmartTagState, Active, ScaleFactor)
    else
      LookAndFeelPainter.DrawScaledFilterDropDownButton(Self.Canvas, Bounds,
        ButtonState, Active, ScaleFactor);
end;

{ TcxGridColumnHeaderGlyphPainter }

function TcxGridColumnHeaderGlyphPainter.GetViewInfo
...
begin
  AViewInfo := ViewInfo;
  cxDrawImage(Canvas.Handle, AViewInfo.Bounds, AViewInfo.Bounds,
    AViewInfo.Glyph, AViewInfo.Images, AViewInfo.ImageIndex, idmNormal, False,
    0, clNone, True, AViewInfo.ColorPalette);
end;

{ TcxGridColumnHeaderCheckBoxPainter }

function TcxGridColumnHeaderCheckBoxPainter.GetViewInfo
  : TcxGridColumnHeaderCheckBoxAreaViewInfo;
begin
...
begin
  ...
  begin
    ...
    LookAndFeelPainter.DrawScaledHeader(Self.Canvas, Bounds, TextAreaBounds,
      Neighbors, Borders, AState, AlignmentHorz, AlignmentVert,
      MultiLinePainting, ShowEndEllipsis, Text, Params.Font, Params.TextColor,
      Params.Color, ScaleFactor,
...
begin
  ViewInfo.LookAndFeelPainter.DrawScaledGroupByBoxSearchButtonGlyph(Canvas,
    ViewInfo.GlyphBounds, ViewInfo.ButtonState, ScaleFactor);
end;

function TcxGridGroupByBoxSearchButtonPainter.GetViewInfo
  : TcxGridGroupByBoxSearchButtonViewInfo;
begin
...
begin
  ViewInfo.LookAndFeelPainter.DrawFooterCell(Canvas, ViewInfo.Bounds,
    ViewInfo.AlignmentHorz, ViewInfo.AlignmentVert, ViewInfo.MultiLinePainting,
    ViewInfo.Text, ViewInfo.Params.Font, ViewInfo.Params.TextColor,
...
begin
  if ViewInfo.HasSeparator then
    DrawSeparator;
  ViewInfo.LookAndFeelPainter.DrawFooterBorderEx(Canvas, ViewInfo.BordersBounds,
    ViewInfo.Borders);
end;
...
begin
  ViewInfo.LookAndFeelPainter.DrawFooterSeparator(Canvas,
    ViewInfo.SeparatorBounds);
end;

{ TcxCustomGridIndicatorItemPainter }

function TcxCustomGridIndicatorItemPainter.GetViewInfo
  : TcxCustomGridIndicatorItemViewInfo;
begin
...
function TcxGridIndicatorHeaderItemPainter.GetViewInfo
  : TcxGridIndicatorHeaderItemViewInfo;
begin
  Result := TcxGridIndicatorHeaderItemViewInfo(inherited ViewInfo);
end;

function TcxGridIndicatorHeaderItemPainter.DrawBackgroundHandler
  (ACanvas: TcxCanvas; const ABounds: TRect): Boolean;
begin
  Result := ViewInfo.GridViewInfo.HeaderViewInfo.DrawColumnBackgroundHandler
    (ACanvas, ABounds);
end;

procedure TcxGridIndicatorHeaderItemPainter.DrawContent;
begin
  ViewInfo.LookAndFeelPainter.DrawScaledHeader(Canvas, ViewInfo.Bounds,
    ViewInfo.Bounds, [nRight], cxBordersAll,
    GridCellStateToButtonState(ViewInfo.State), taLeftJustify, vaTop, False,
    False, '', nil, clNone, ViewInfo.Params.Color, ViewInfo.ScaleFactor,
...
begin
  ViewInfo.LookAndFeelPainter.DrawScaledIndicatorCustomizationMark(Canvas,
    ViewInfo.GetImageAreaBounds, ViewInfo.Params.TextColor, ScaleFactor);
end;

{ TcxGridIndicatorRowItemPainter }

function TcxGridIndicatorRowItemPainter.GetViewInfo
  : TcxGridIndicatorRowItemViewInfo;
begin
...
begin
  ViewInfo.LookAndFeelPainter.DrawScaledIndicatorItem(Canvas, ViewInfo.Bounds,
    ViewInfo.GetImageAreaBounds, ViewInfo.IndicatorKind, ViewInfo.Params.Color,
    ScaleFactor, DrawBackgroundHandler, ViewInfo.GetNeighbors);
end;

{ TcxGridIndicatorFooterItemPainter }

function TcxGridIndicatorFooterItemPainter.GetViewInfo
...
begin
  if ViewInfo.GridView.LookAndFeel.SkinPainter = nil then
    ...
    with ViewInfo do
      LookAndFeelPainter.DrawScaledHeader(Canvas, Bounds, Bounds, [], [],
        cxbsNormal, taLeftJustify, vaTop, False, False, '', nil, clNone,
        Params.Color, ScaleFactor, DrawBackgroundHandler);
end;
...
procedure TcxCustomGridRowPainter.DrawIndentPart(ALevel: Integer;
const ABounds: TRect);
var
  R: TRect;
begin
...
begin
  if ViewInfo.HasFooters then
    DrawFooters;
  DrawIndent;
  if ViewInfo.HasLastHorzGridLine then
    DrawLastHorzGridLine;
  if ViewInfo.HasSeparator then
    DrawSeparator;
  inherited Paint;
end;
...
constructor TcxGridFixedDataRowsPainter.Create(ACanvas: TcxCanvas;
AViewInfo: TcxGridFixedDataRowsViewInfo);
begin
  inherited Create;
  FCanvas := ACanvas;
  FViewInfo := AViewInfo;
...
class procedure TcxGridRowsPainter.DrawDataRowCells(ARowViewInfo
...
begin
  Result := inherited CanOffset(AItemsOffset, DX, DY) and
    ...
    not GridView.InplaceEditForm.Visible and not GridView.RowLayout.Active and
...
constructor TcxGridTableFindPanelViewInfo.Create(AGridViewInfo
...
begin
  if Location = fplGroupByBox then
    Result := GridViewInfo.GroupByBoxViewInfo.CalculateFitElementBounds
...
function TcxGridTableFindPanelViewInfo.GetLocation
  : TcxGridTableFindPanelLocation;
begin
  Result := GridView.FindPanel.Location;
  if (Result = fplGroupByBox) and
    not(GridViewInfo.GroupByBoxViewInfo.Visible and
...
begin
  Result := inherited GetVisible and
    ((Location = fplSeparatePanel) or (Location = fplGroupByBox) and
    GridViewInfo.GroupByBoxViewInfo.Visible);
end;
...
constructor TcxGridColumnContainerViewInfo.Create(AGridViewInfo
  : TcxCustomGridTableViewInfo);
begin
  inherited;
  FItemHeight := -1;
...
function TcxGridColumnContainerViewInfo.GetInternalItem(Index: Integer)
  : TcxGridColumnHeaderViewInfo;
begin
  Result := TcxGridColumnHeaderViewInfo(FItems.List[Index]);
end;

function TcxGridColumnContainerViewInfo.GetItem(Index: Integer)
  : TcxGridColumnHeaderViewInfo;
begin
...
function TcxGridColumnContainerViewInfo.CreateItem(AIndex: Integer)
  : TcxGridColumnHeaderViewInfo;
begin
...
begin
  ...
  FIndex := TDictionary<TcxCustomGridColumn, TcxGridColumnHeaderViewInfo>.Create
    (ColumnCount);
end;
...
function TcxGridColumnContainerViewInfo.GetItemClass
...
begin
  CalculateParams;
  Result := GetItemClass.GetCellHeight(GridViewInfo.GetFontHeight(Params.Font),
    LookAndFeelPainter, ScaleFactor);
end;

function TcxGridColumnContainerViewInfo.FindItem(AColumn: TcxCustomGridColumn)
  : TcxGridColumnHeaderViewInfo;
var
  I: Integer;
begin
...
function TcxGridColumnContainerViewInfo.GetColumnAdditionalWidth
...
function TcxGridColumnContainerViewInfo.GetColumnMinWidth
  (AColumn: TcxGridColumn): Integer;
begin
  if not AColumn.Options.AutoWidthSizable and AColumn.GridView.HasColumnAutoWidth
  then
...
function TcxGridColumnContainerViewInfo.GetColumnIndentWidth
  (AColumn: TcxGridColumn): Integer;
begin
  Result := GetColumnAdditionalWidth(AColumn) + GetItemAdditionWidth
    (FindItem(AColumn));
end;

function TcxGridColumnContainerViewInfo.GetColumnNeighbors
  (AColumn: TcxGridColumn): TcxNeighbors;
begin
  Result := [];
end;

function TcxGridColumnContainerViewInfo.GetColumnWidth
  (AColumn: TcxGridColumn): Integer;
begin
  Result := AColumn.Width + GetColumnAdditionalWidth(AColumn) +
    GetItemAdditionWidth(FindItem(AColumn));
end;

function TcxGridColumnContainerViewInfo.GetItemAdditionWidth
  (AItem: TcxGridColumnHeaderViewInfo): Integer;
begin
  Result := AItem.GetAdditionalWidth;
end;

function TcxGridColumnContainerViewInfo.GetItemAreaBounds
  (AItem: TcxGridColumnHeaderViewInfo): TRect;
begin
  Result := GridViewInfo.ScrollableAreaBoundsHorz;
end;

function TcxGridColumnContainerViewInfo.GetItemMultiLinePainting
  (AItem: TcxGridColumnHeaderViewInfo): Boolean;
begin
  Result := False;
end;
...
function TcxGridColumnContainerViewInfo.GetItemsHitTest(const P: TPoint)
...
function TcxGridColumnContainerViewInfo.GetPainterClass
...
procedure TcxGridColumnContainerViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
  inherited;
...
function TcxGridColumnContainerViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
...
function TcxGridColumnContainerViewInfo.GetZone(const P: TPoint)
...
constructor TcxGridColumnHeaderAreaViewInfo.Create(AColumnHeaderViewInfo
  : TcxGridColumnHeaderViewInfo);
begin
...
function TcxGridColumnHeaderAreaViewInfo.HasMouse
  (AHitTest: TcxCustomGridHitTest): Boolean;
begin
...
procedure TcxGridColumnHeaderAreaViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
    ...
    case AlignmentHorz of
      ...
      taCenter:
        if OccupiesSpace and (ColumnHeaderViewInfo.AlignmentHorz = taCenter) and
          not((AlignmentVert = vaTop) and
          (ColumnHeaderViewInfo.AlignmentVert = vaBottom) or
          (AlignmentVert = vaBottom) and
          (ColumnHeaderViewInfo.AlignmentVert = vaTop)) then
        begin
          AAreaAndTextWidth := Width + ColumnHeaderViewInfo.TextWidthWithOffset;
          if AAreaAndTextWidth < Bounds.Right - Bounds.Left then
            Inc(Bounds.Left,
              (Bounds.Right - Bounds.Left - AAreaAndTextWidth) div 2);
          Bounds.Right := Bounds.Left + Width;
          ATextAreaBounds.Left := Bounds.Right;
          ATextAreaBounds.Right := Min(ATextAreaBounds.Right,
            ATextAreaBounds.Left + ColumnHeaderViewInfo.TextWidthWithOffset);
        end
        else
        begin
...
function TcxGridColumnHeaderSortingMarkViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
  Result := nil;
end;

function TcxGridColumnHeaderSortingMarkViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
function TcxGridColumnHeaderHorzSizingEdgeViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
  Result := TcxGridColumnHeaderHorzSizingEdgeHitTest;
end;

function TcxGridColumnHeaderHorzSizingEdgeViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := nil;
end;
...
procedure TcxGridColumnHeaderHorzSizingEdgeViewInfo.Calculate
  (const ABounds: TRect; var ATextAreaBounds: TRect);
begin
  inherited;
  OffsetRect(Bounds, Width div 2, 0);
end;

function TcxGridColumnHeaderHorzSizingEdgeViewInfo.MouseDown
...
begin
  Result := Visible and
    (AlwaysVisible or (ColumnHeaderViewInfo.State <> gcsNone) or
    (State = gcsPressed) or (IsSmartTag and Active));
end;

function TcxGridColumnHeaderFilterButtonViewInfo.GetDropDownWindowValue
  : TdxFilterPopupWindow;
begin
  Result := TdxFilterPopupWindow(inherited DropDownWindow);
end;

function TcxGridColumnHeaderFilterButtonViewInfo.
  GetFilterDropDownWindowLinkComponent: TComponent;
begin
  Result := Column;
end;

function TcxGridColumnHeaderFilterButtonViewInfo.GetFilterPopupMode
...
function TcxGridColumnHeaderFilterButtonViewInfo.
  GetFilterDropDownWindowOptions: TObject;
begin
...
begin
  GridView.Controller.IsFilterPopupOpenedFromHeader :=
    ColumnHeaderViewInfo.HasHeaderAsContainer;
  inherited;
end;

function TcxGridColumnHeaderFilterButtonViewInfo.
  EmulateMouseMoveAfterCalculate: Boolean;
begin
  Result := True;
end;
...
function TcxGridColumnHeaderFilterButtonViewInfo.GetAlignmentVert
  : TcxAlignmentVert;
begin
  if IsSmartTag then
    Result := vaTop
...
begin
  Result := (GridView.OptionsView.ShowColumnFilterButtons = sfbAlways) or
    (GridView.OptionsView.ShowColumnFilterButtons = sfbDefault) and
    cxIsTouchModeEnabled;
end;

function TcxGridColumnHeaderFilterButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridColumnHeaderFilterButtonViewInfo.
  GetIsVisibleForPainting: Boolean;
begin
  Result := ActuallyVisible;
end;

function TcxGridColumnHeaderFilterButtonViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  Result := not GridView.Controller.InplaceEditForm.Visible;
end;

function TcxGridColumnHeaderFilterButtonViewInfo.NeedsContainerHotTrack
  : Boolean;
begin
...
function TcxGridColumnHeaderFilterButtonViewInfo.
  CloseDropDownWindowOnDestruction: Boolean;
begin
  Result := False;
end;
...
function TcxGridColumnHeaderFilterButtonViewInfo.GetDropDownWindow
...
function TcxGridColumnHeaderFilterButtonViewInfo.
  GetDropDownWindowDefaultAlignHorz: TcxPopupAlignHorz;
begin
...
begin
  Result := inherited IsDropDownWindowOwner and
    (DropDownWindow.LinkComponent = GetFilterDropDownWindowLinkComponent) and
    (GridView.Controller.IsFilterPopupOpenedFromHeader = ColumnHeaderViewInfo.
    HasHeaderAsContainer);
end;
...
begin
  Result := (GridView.OptionsView.ItemFilterButtonShowMode = fbmSmartTag) or
    (GridView.OptionsView.ItemFilterButtonShowMode = fbmDefault) and
    not cxIsTouchModeEnabled;
end;

function TcxGridColumnHeaderFilterButtonViewInfo.MouseMove
  (AHitTest: TcxCustomGridHitTest; AShift: TShiftState): Boolean;
begin
...
constructor TcxGridColumnHeaderGlyphViewInfo.Create(AColumnHeaderViewInfo
  : TcxGridColumnHeaderViewInfo);
begin
...
function TcxGridColumnHeaderGlyphViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
  Result := nil;
end;
...
function TcxGridColumnHeaderGlyphViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  if GridView.DataController.AreAllRowsSelected then
    Result := cbsChecked
  else if Controller.SelectedRowCount > 0 then
    Result := cbsGrayed
  else
    Result := cbsUnchecked;
end;
...
constructor TcxGridRowCheckBoxViewInfo.Create(ARowViewInfo
  : TcxCustomGridRowViewInfo);
begin
...
begin
  Result := inherited GetIsVisibleForPainting and
    ((GridView.OptionsSelection.CheckBoxPosition = cbpIndicator) or
    not GridView.OptionsSelection.ShowCheckBoxesDynamically or
    ((CheckBoxState in [cbsChecked, cbsGrayed]) or IsHotTracked or
    (ButtonState = cxbsPressed) or RowViewInfo.Focused or
    RowViewInfo.IsHotTracked));
end;
...
constructor TcxGridColumnHeaderCheckBoxAreaViewInfo.Create(AColumnHeaderViewInfo
  : TcxGridColumnHeaderViewInfo);
begin
  inherited Create(AColumnHeaderViewInfo);
...
procedure TcxGridColumnHeaderCheckBoxAreaViewInfo.Calculate
  (const ABounds: TRect; var ATextAreaBounds: TRect);
begin
...
function TcxGridColumnHeaderCheckBoxAreaViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  AHitTest: TcxCustomGridHitTest;
begin
...
procedure TcxGridColumnHeaderCheckBoxAreaViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
...
function TcxGridColumnHeaderCheckBoxAreaViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
constructor TcxGridColumnHeaderViewInfo.Create
  (AContainer: TcxGridColumnContainerViewInfo; AColumn: TcxGridColumn);
begin
...
function TcxGridColumnHeaderViewInfo.GetAreaViewInfo(Index: Integer)
  : TcxGridColumnHeaderAreaViewInfo;
begin
...
begin
  ...
  begin
    FCellBoundsForHint := cxRectInflate(ClientBounds,
      -ScaleFactor.Apply(cxGridCellTextOffset));
    for I := 0 to AreaViewInfoCount - 1 do
      with AreaViewInfos[I] do
        if OccupiesSpace and not CanShowContainerHint then
          case AlignmentHorz of
            taRightJustify:
              FCellBoundsForHint.Right :=
                Min(Bounds.Left, FCellBoundsForHint.Right);
            taLeftJustify:
              FCellBoundsForHint.Left :=
                Max(Bounds.Right, FCellBoundsForHint.Left);
          end;
  end;
end;

function TcxGridColumnHeaderViewInfo.CalculateHasTextOffset
  (ASide: TAlignment): Boolean;
var
  I: Integer;
begin
  if Text <> '' then
  begin
    ...
    for I := 0 to AreaViewInfoCount - 1 do
      with AreaViewInfos[I] do
        if OccupiesSpace and (AlignmentHorz = ASide) then
          Exit;
  end;
  Result := False;
end;
...
begin
  ...
  begin
    for I := FAreaViewInfos.Count - 1 downto 0 do
      ...
      begin
        Result := Max(Result,
          GetCellHeight(TcxGridColumnHeaderGlyphViewInfo(AreaViewInfos[I])
          .CalculateHeight, LookAndFeelPainter, ScaleFactor));
        Break;
      end;
  end;
...
function TcxGridColumnHeaderViewInfo.CalculateOriginalWidth
  (Value: Integer): Integer;
begin
  Result := CalculateRealWidth(Value) - Container.GetItemAdditionWidth(Self);
end;

function TcxGridColumnHeaderViewInfo.CalculateRealWidth(Value: Integer)
  : Integer;
begin
...
procedure TcxGridColumnHeaderViewInfo.CalculateVisible(ALeftBound,
  AWidth: Integer);
begin
...
function TcxGridColumnHeaderViewInfo.FindArea
  (AAreaClass: TcxGridColumnHeaderAreaViewInfoClass)
  : TcxGridColumnHeaderAreaViewInfo;
var
  I: Integer;
begin
...
begin
  ...
  begin
    AWidth := ScaleFactor.Apply(cxGridDataCellCheckBoxLeftMargin) +
      LookAndFeelPainter.ScaledCheckButtonSize(ScaleFactor).cx +
  ...
  begin
    ...
    AWidth := ScaleFactor.Apply(APinWidth + cxGridPinLeftMargin +
      cxGridPinRightMargin);
    if HasDataCellCheckBoxAdditionalWidth then
      Inc(Result, AWidth)
    else
      Result := Max(Result, AWidth);
...
procedure TcxGridColumnHeaderViewInfo.GetAreaViewInfoClasses
...
class function TcxGridColumnHeaderViewInfo.GetCellBorderWidth
...
begin
  Result := GridView.IsDesigning and GridView.Controller.DesignController.
    IsObjectSelected(FColumn);
end;

function TcxGridColumnHeaderViewInfo.GetIsPressed: Boolean;
begin
  Result := (State = gcsPressed) or
    (GridViewInfo.Controller.PressedColumn = Column);
end;
...
begin
  Result := inherited GetMultiLinePainting or
    FContainer.GetItemMultiLinePainting(Self);
end;

function TcxGridColumnHeaderViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  Result := TextHeight + cxMarginsHeight(LookAndFeelPainter.HeaderContentOffsets
    (ScaleFactor));
end;

function TcxGridColumnHeaderViewInfo.GetTextWidthWithOffset: Integer;
begin
  Result := TextWidth + cxMarginsWidth(LookAndFeelPainter.HeaderContentOffsets
    (ScaleFactor));
end;
...
function TcxGridColumnHeaderViewInfo.HasDataCellCheckBoxAdditionalWidth
  : Boolean;
begin
  Result := (Container.Kind = ckHeader) and Column.IsMostLeft and
...
begin
  Result := (Container.Kind = ckHeader) and Column.IsMostLeft and
    (GridView.FixedDataRows.PinVisibility <> rpvNever);
end;

procedure TcxGridColumnHeaderViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
...
begin
  ...
  begin
    if not GridView.Controller.DesignController.IsObjectSelected(FColumn) then
      GridView.Controller.DesignController.SelectObject(FColumn,
...
procedure TcxGridColumnHeaderViewInfo.PopulateDesignPopupMenu
  (AMenu: TPopupMenu);
begin
...
function TcxGridColumnHeaderViewInfo.GetHintTextRect(const AMousePos
  : TPoint): TRect;
begin
  if IsHintForText then
...
AWidth: Integer = -1; AHeight: Integer = -1);
  ...
  procedure CheckHiddenBorders(var AAdditionalWidthAtLeft,
    AAdditionalHeightAtTop: Integer);
  var
...
procedure TcxGridColumnHeaderViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
  inherited DoRightToLeftConversion(ABounds);
  FCellBoundsForHint := TdxRightToLeftLayoutConverter.ConvertRect
    (FCellBoundsForHint, ABounds);
...
begin
  Result := inherited GetBestFitWidth - FAdditionalWidthAtLeft -
    Container.GetItemAdditionWidth(Self);
  if HasTextOffsetLeft then
...
function TcxGridColumnHeaderViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  I: Integer;
begin
...
procedure TcxGridColumnHeaderViewInfo.InitAutoWidthItem(AAutoWidthItem
  : TcxAutoWidthItem);
begin
...
constructor TcxGridHeaderViewInfoSpecific.Create(AContainerViewInfo
...
constructor TcxGridHeaderViewInfo.Create(AGridViewInfo
  : TcxCustomGridTableViewInfo);
begin
  inherited;
...
procedure TcxGridHeaderViewInfo.AddIndicatorItems(AIndicatorViewInfo
  : TcxGridIndicatorViewInfo; ATopBound: Integer);
begin
  AIndicatorViewInfo.AddItem(ATopBound, Height,
    TcxGridIndicatorHeaderItemViewInfo);
end;
...
begin
  ...
  try
    ...
    AAutoWidthObject.AvailableWidth := GridViewInfo.ClientWidth -
      IfThen(Count > 0, GridView.GetVerticalScrollBarAreaWidth);
  ...
  begin
    ...
    for I := 0 to Count - 1 do
      ...
      begin
        ...
        if AColumnHeight > Result then
          Result := AColumnHeight;
      end;
    if Result = 0 then
...
begin
  Result := GridViewInfo.SupportsAutoHeight and
    GridView.OptionsView.HeaderAutoHeight;
end;
...
function TcxGridHeaderViewInfo.GetColumnNeighbors(AColumn: TcxGridColumn)
  : TcxNeighbors;
begin
  Result := [];
...
begin
  Result := not GridView.RowLayout.Active;
end;

function TcxGridHeaderViewInfo.GetItemMultiLinePainting
  (AItem: TcxGridColumnHeaderViewInfo): Boolean;
begin
...
function TcxGridGroupByBoxColumnHeaderViewInfo.GetContainer
...
function TcxGridGroupByBoxColumnHeaderViewInfo.InheritedCalculateHeight
  : Integer;
begin
...
constructor TcxGridGroupByBoxSearchButtonViewInfo.Create(AGroupByBoxViewInfo
  : TcxGridGroupByBoxViewInfo);
begin
...
procedure TcxGridGroupByBoxSearchButtonViewInfo.Calculate(ALeftBound,
...
procedure TcxGridGroupByBoxSearchButtonViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
...
function TcxGridGroupByBoxSearchButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridGroupByBoxSearchButtonViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
constructor TcxGridGroupByBoxViewInfo.Create(AGridViewInfo
  : TcxCustomGridTableViewInfo);
begin
  inherited Create(AGridViewInfo);
...
begin
  ...
  begin
    Result := CanShowSearchButton and not Controller.IsFindPanelVisible and
      CanFitElement(SearchButtonViewInfo.Width);
...
function TcxGridGroupByBoxViewInfo.GetItemClass
  : TcxGridColumnHeaderViewInfoClass;
begin
  Result := TcxGridGroupByBoxColumnHeaderViewInfo;
end;

function TcxGridGroupByBoxViewInfo.CalculateFitElementBounds(AElementHeight,
  AElementWidth: Integer): TRect;
begin
  Result := Bounds;
...
function TcxGridGroupByBoxViewInfo.CalculateHeaderAreaHeight
  (ALevelCount: Integer): Integer;
...
begin
  ...
  for I := 0 to Count - 1 do
  begin
    AColumnHeight := TcxGridGroupByBoxColumnHeaderViewInfo(Items[I])
      .InheritedCalculateHeight;
    if AColumnHeight > Result then
      Result := AColumnHeight;
  end;
  if Result = 0 then
...
function TcxGridGroupByBoxViewInfo.CanFitElement(AElementWidth
  : Integer): Boolean;
var
...
begin
  ...
  if Count = 0 then
    Result := AAvailableWidth - cxGridCellTextOffset - TextWidth -
      GroupByBoxLeftOffset > 0
  else
  begin
    Result := True;
    for I := 0 to Count - 1 do
    begin
      ...
      else if not Items[I].Column.IsChildInMergedGroup then
...
begin
  Result := (GridViewInfo.FindPanelViewInfo.Location = fplGroupByBox) and
    (GridView.FindPanel.DisplayMode <> fpdmNever);
end;

function TcxGridGroupByBoxViewInfo.CanShowSearchButton: Boolean;
begin
  Result := (GridView.FindPanel.Location = fplGroupByBox) and
    (GridView.FindPanel.DisplayMode = fpdmManual);
end;

function TcxGridGroupByBoxViewInfo.CreateSearchButtonViewInfo
  : TcxGridGroupByBoxSearchButtonViewInfo;
begin
...
function TcxGridGroupByBoxViewInfo.GetColumnWidth
  (AColumn: TcxGridColumn): Integer;
begin
...
function TcxGridGroupByBoxViewInfo.GetItemAreaBounds
  (AItem: TcxGridColumnHeaderViewInfo): TRect;
begin
  SetRectEmpty(Result);
end;
...
function TcxGridGroupByBoxViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  ...
  begin
    ...
    if not AColumnHeaderViewInfo.Column.IsChildInMergedGroup then
    begin
      ALevel := GridView.DataController.Groups.GetLevelByItemGroupIndex
        (AColumnHeaderViewInfo.Column.GroupIndex);
      ASummaryItems := GridView.DataController.Summary.
        GroupSummaryItems[ALevel];
      AColumnHeaderViewInfo.FSortByGroupSummary :=
        ASummaryItems.SortedSummaryItem <> nil;
    end;
  ...
  begin
    ARect := CalculateFitElementBounds(SearchButtonViewInfo.Height,
      SearchButtonViewInfo.Width);
...
procedure TcxGridGroupByBoxViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
  ...
  if (GridViewInfo.FindPanelViewInfo.Location = fplGroupByBox) and
    GridViewInfo.FindPanelViewInfo.Visible then
    GridViewInfo.FindPanelViewInfo.RightToLeftConversion(ABounds);
end;

function TcxGridGroupByBoxViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  AHitTest: TcxCustomGridHitTest;
begin
...
constructor TcxGridFooterCellViewInfo.Create(AContainer
  : TcxGridColumnContainerViewInfo; AData: TcxGridFooterCellData);
begin
  FData := AData;
...
procedure TcxGridFooterCellViewInfo.GetAreaViewInfoClasses
  (AProc: TcxGridClassEnumeratorProc);
begin
end;
...
class function TcxGridFooterCellViewInfo.GetCellBorderWidth(ALookAndFeelPainter
  : TcxCustomLookAndFeelPainter): Integer;
begin
...
begin
  Result := ATextHeight + 2 * (GetCellBorderWidth(ALookAndFeelPainter) +
    cxHeaderTextOffset) + TdxVisualRefinements.Padding.ScaledHeight
    (AScaleFactor);
end;

function TcxGridFooterCellViewInfo.GetContentIndents: TRect;
begin
  Result.Init(cxHeaderTextOffset, cxHeaderTextOffset, cxHeaderTextOffset,
    cxHeaderTextOffset);
...
function TcxGridFooterCellViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  Result := TextWidth + ScaleFactor.Apply(cxGridCellTextOffset) * 2 +
...
begin
  ...
  begin
    GridView.Controller.DesignController.SelectObject(SummaryItem,
      not(ssShift in AShift));
    Result := True;
  end;
end;
...
function TcxGridFooterViewInfo.GetCellData(AIndex: Integer)
  : TcxGridFooterCellData;
begin
...
procedure TcxGridFooterViewInfo.AddAdornerTargetElementForColumn
  (AList: TStrings; AColumn: TcxCustomGridColumn; AName: string);
var
  I, AIndex: Integer;
...
function TcxGridFooterViewInfo.CreateItem(AIndex: Integer)
  : TcxGridColumnHeaderViewInfo;
begin
  Result := TcxGridFooterCellViewInfoClass(GetItemClass)
    .Create(Self, CellDataList[AIndex]);
end;
...
function TcxGridFooterViewInfo.CreateCellData(ASummaryItem: TcxDataSummaryItem)
  : TcxGridFooterCellData;
begin
...
procedure TcxGridFooterViewInfo.PopulateCellDataList(var AColumnHasSummaries
  : array of Boolean);
begin
  PopulateCellDataList(GridView.DataController.Summary.FooterSummaryItems,
    AColumnHasSummaries);
end;

procedure TcxGridFooterViewInfo.PopulateCellDataList(ASummaryItems
  : TcxDataSummaryItems; var AColumnHasSummaries: array of Boolean);
var
...
begin
  ...
  begin
    ...
    if (ASummaryItem.Position = spFooter) and
      (ASummaryItem.ItemLink is TcxGridColumn) then
    begin
      AColumnVisibleIndex := TcxGridColumn(ASummaryItem.ItemLink).VisibleIndex;
      if (AColumnVisibleIndex <> -1) and
        (CanShowMultipleSummaries or not AColumnHasSummaries
        [AColumnVisibleIndex]) then
      begin
...
begin
  ...
  if (GridViewInfo.IndicatorViewInfo.Width > 0) and (Result.Left = Result.Right)
  then
...
begin
  Result := inherited CalculateItemHeight + 2 *
    LookAndFeelPainter.FooterCellOffset;
end;

procedure TcxGridFooterViewInfo.CalculateItem(AIndex: Integer);
begin
  Items[AIndex].Calculate(GetItemLeftBound(AIndex), GetItemTopBound(AIndex), -1,
    GetItemHeight(AIndex));
...
function TcxGridFooterViewInfo.GetItemAreaBounds
  (AItem: TcxGridColumnHeaderViewInfo): TRect;
begin
...
function TcxGridFooterViewInfo.GetItemLeftBound(AColumn: TcxGridColumn)
  : Integer;
begin
...
begin
  Result := ItemsAreaBounds.Top + GridViewInfo.GetCellTopOffset
    (AColumn.VisibleIndex, ItemHeight);
end;

function TcxGridFooterViewInfo.GetItemTopBound(AIndex: Integer): Integer;
begin
  Result := GetItemTopBound(Items[AIndex].Column) + GetItemRowIndex(AIndex) *
    RowHeight;
end;
...
function TcxGridFooterViewInfo.IsColumnOnFirstLayer(AColumnIndex
  : Integer): Boolean;
begin
  Result := False;
end;
...
begin
  Result := GridViewInfo.HeaderViewInfo
    [Items[AIndex].Column.VisibleIndex].Visible;
end;
...
function TcxGridFooterViewInfo.GetCellBestFitWidth
  (AColumn: TcxGridColumn): Integer;
var
  I: Integer;
begin
...
function TcxGridFooterViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
...
constructor TcxCustomGridIndicatorItemViewInfo.Create
  (AContainer: TcxGridIndicatorViewInfo);
begin
  inherited Create(AContainer.GridViewInfo);
  FContainer := AContainer;
...
procedure TcxCustomGridIndicatorItemViewInfo.Calculate(ALeftBound: Integer;
ATopBound: Integer; AWidth: Integer = -1; AHeight: Integer = -1);
begin
  inherited Calculate(ALeftBound, ATopBound, AWidth, AHeight);
  if HasCheckBox then
...
function TcxCustomGridIndicatorItemViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  AHitTest: TcxCustomGridHitTest;
begin
...
function TcxCustomGridIndicatorItemViewInfo.GetGridViewInfo
  : TcxGridTableViewInfo;
begin
  Result := TcxGridTableViewInfo(inherited GridViewInfo);
end;
...
function TcxCustomGridIndicatorItemViewInfo.CustomDraw
...
procedure TcxCustomGridIndicatorItemViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
  if HasCheckBox then
...
function TcxCustomGridIndicatorItemViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxCustomGridIndicatorItemViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxCustomGridIndicatorItemPainter;
end;

procedure TcxCustomGridIndicatorItemViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
function TcxGridIndicatorHeaderItemViewInfo.GetDropDownWindowValue
...
function TcxGridIndicatorHeaderItemViewInfo.CreateCheckBox
  : TcxGridCheckBoxViewInfo;
begin
...
function TcxGridIndicatorHeaderItemViewInfo.GetHintTextRect(const AMousePos
  : TPoint): TRect;
begin
  Result := Bounds;
...
function TcxGridIndicatorHeaderItemViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridIndicatorHeaderItemViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
procedure TcxGridIndicatorHeaderItemViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
  GridView.Styles.GetHeaderParams(nil, AParams);
end;
...
begin
  Result := inherited ShowCheckBox and
    (cbvColumnHeader in GridView.OptionsSelection.CheckBoxVisibility);
end;
...
function TcxGridIndicatorHeaderItemViewInfo.
  CloseDropDownWindowOnDestruction: Boolean;
begin
  Result := False;
end;
...
function TcxGridIndicatorHeaderItemViewInfo.GetDropDownWindow
  : TdxUIElementPopupWindow;
begin
...
constructor TcxGridIndicatorRowItemViewInfo.Create
  (AContainer: TcxGridIndicatorViewInfo;
...
function TcxGridIndicatorRowItemViewInfo.CreateCheckBox
  : TcxGridCheckBoxViewInfo;
begin
...
function TcxGridIndicatorRowItemViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
begin
  Result := [nTop, nBottom];
  if (GridRecord.FixedState = rfsFixedToBottom) and
    (GridRecord.Index = GridView.Controller.LastScrollRecordIndex + 1) then
    Exclude(Result, nTop);
end;

function TcxGridIndicatorRowItemViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
procedure TcxGridIndicatorRowItemViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
  inherited;
  ...
  begin
    ...
    TcxGridRowIndicatorHitTest(AHitTest).MultiSelect :=
      GridView.Controller.MultiSelect;
  end;
end;
...
function TcxGridIndicatorRowItemViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
...
function TcxGridIndicatorRowItemViewInfo.MouseDown
  (AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
AShift: TShiftState): Boolean;
begin
  Result := inherited MouseDown(AHitTest, AButton, AShift);
...
function TcxGridIndicatorFooterItemViewInfo.GetBorderWidth
...
function TcxGridIndicatorFooterItemViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
constructor TcxGridIndicatorViewInfo.Create(AGridViewInfo
  : TcxGridTableViewInfo);
begin
  inherited Create(AGridViewInfo);
  FItems := TList.Create;
...
function TcxGridIndicatorViewInfo.GetItem(Index: Integer)
  : TcxCustomGridIndicatorItemViewInfo;
begin
...
function TcxGridIndicatorViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridIndicatorPainter;
end;

function TcxGridIndicatorViewInfo.GetRowItemClass(ARowViewInfo
  : TcxCustomGridRowViewInfo): TcxGridIndicatorRowItemViewInfoClass;
begin
...
function TcxGridIndicatorViewInfo.AddItem(AItemClass
  : TcxCustomGridIndicatorItemViewInfoClass)
  : TcxCustomGridIndicatorItemViewInfo;
begin
...
function TcxGridIndicatorViewInfo.AddRowItem(ARowViewInfo
  : TcxCustomGridRowViewInfo): TcxCustomGridIndicatorItemViewInfo;
begin
...
procedure TcxGridIndicatorViewInfo.CalculateRowItem(ARowViewInfo
  : TcxCustomGridRowViewInfo; AItem: TcxCustomGridIndicatorItemViewInfo);
begin
  AItem.Calculate(Bounds.Left, ARowViewInfo.Bounds.Top, Width,
    ARowViewInfo.Height);
end;

procedure TcxGridIndicatorViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
...
function TcxGridIndicatorViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  I: Integer;
begin
...
function TcxGridIndicatorViewInfo.GetRowItemBounds
  (AGridRecord: TcxCustomGridRow): TRect;
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
...
constructor TcxGridRowFooterCellData.Create(ASummaryItem: TcxDataSummaryItem;
...
begin
  try
    Result := Summary.GetGroupFooterSummaryText(GridRecord.Index,
      Container.GroupLevel, SummaryItem.Index, Data.GroupedColumnIndex);
  except
    Application.HandleException(Self);
  end;
end;

procedure TcxGridRowFooterCellViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
constructor TcxGridRowFooterViewInfo.Create(AContainer
  : TcxGridRowFootersViewInfo; ALevel: Integer);
begin
  FContainer := AContainer;
  FLevel := ALevel;
  inherited Create(AContainer.GridViewInfo);
...
function TcxGridRowFooterViewInfo.CreateCellData(ASummaryItem
  : TcxDataSummaryItem): TcxGridFooterCellData;
begin
  Result := TcxGridRowFooterCellData.Create(ASummaryItem,
    FPopulatedGroupedColumnIndex);
end;
...
function TcxGridRowFooterViewInfo.GetColumnWidth
  (AColumn: TcxGridColumn): Integer;
begin
...
function TcxGridRowFooterViewInfo.GetItemAreaBounds
  (AItem: TcxGridColumnHeaderViewInfo): TRect;
begin
  Result := Container.GridViewInfo.FooterViewInfo.GetItemAreaBounds(AItem);
end;

function TcxGridRowFooterViewInfo.GetItemClass
  : TcxGridColumnHeaderViewInfoClass;
begin
  Result := TcxGridRowFooterCellViewInfo;
end;

function TcxGridRowFooterViewInfo.GetItemHitTestClass
  : TcxCustomGridHitTestClass;
begin
  Result := TcxGridGroupFooterCellHitTest;
end;

function TcxGridRowFooterViewInfo.GetItemMultiLinePainting
  (AItem: TcxGridColumnHeaderViewInfo): Boolean;
begin
...
procedure TcxGridRowFooterViewInfo.PopulateCellDataList(var AColumnHasSummaries
  : array of Boolean);
var
  I, ACount: Integer;
  ASummaryItems: TcxDataGroupSummaryItems;
begin
  ...
  begin
    ASummaryItems := GridView.DataController.Summary.GetGroupSummaryItems
      (GroupLevel, I);
...
constructor TcxGridRowFootersViewInfo.Create(ARowViewInfo
  : TcxCustomGridRowViewInfo);
begin
  inherited Create;
  FRowViewInfo := ARowViewInfo;
...
function TcxGridRowFootersViewInfo.GetItem(Index: Integer)
  : TcxGridRowFooterViewInfo;
begin
  Result := TcxGridRowFooterViewInfo(FItems[Index]);
end;

function TcxGridRowFootersViewInfo.GetVisibleItem(ALevel: Integer)
  : TcxGridRowFooterViewInfo;
var
  I: Integer;
begin
...
procedure TcxGridRowFootersViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
...
function TcxGridRowFootersViewInfo.GetCellBestFitWidth
  (AColumn: TcxGridColumn): Integer;
var
  I: Integer;
begin
...
function TcxGridRowFootersViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  I: Integer;
begin
...
function TcxGridRowFootersViewInfo.GetTopBound(ALevel: Integer;
var ATopBound: Integer): Boolean;
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
...
constructor TcxCustomGridRowViewInfo.Create(ARecordsViewInfo
...
function TcxCustomGridRowViewInfo.GetLevelIndentHorzLineBounds
  (Index: Integer): TRect;
begin
  Result := CalculateLevelIndentHorzLineBounds(Index, LevelIndentBounds[Index]);
end;

function TcxCustomGridRowViewInfo.GetLevelIndentSpaceBounds
  (Index: Integer): TRect;
begin
  Result := CalculateLevelIndentSpaceBounds(Index, LevelIndentBounds[Index]);
end;

function TcxCustomGridRowViewInfo.GetLevelIndentVertLineBounds
  (Index: Integer): TRect;
begin
...
procedure TcxCustomGridRowViewInfo.AddAdornerTargetElementsForColumn
  (AList: TStrings; AColumn: TcxCustomGridColumn; AName: string);
begin
  // do nothing
end;
...
procedure TcxCustomGridRowViewInfo.CalculateExpandButtonBounds
  (var ABounds: TRect);
begin
  ...
  begin
    ...
    ABounds.Top := (ABounds.Top + ABounds.Bottom -
      GridViewInfo.ExpandButtonSize) div 2;
...
function TcxCustomGridRowViewInfo.CalculateLevelIndentHorzLineBounds
  (ALevel: Integer; const ABounds: TRect): TRect;
begin
  Result := ABounds;
...
function TcxCustomGridRowViewInfo.CalculateLevelIndentSpaceBounds
  (ALevel: Integer; const ABounds: TRect): TRect;
var
...
begin
  ...
  if (GridLines <> glNone) and ((GridLines <> glVertical) and
    AIsParentRecordLast) then
...
function TcxCustomGridRowViewInfo.CalculateLevelIndentVertLineBounds
  (ALevel: Integer; const ABounds: TRect): TRect;
begin
  Result := ABounds;
...
function TcxCustomGridRowViewInfo.GetCellTransparent
...
function TcxCustomGridRowViewInfo.GetFootersViewInfoClass
  : TcxGridRowFootersViewInfoClass;
begin
...
begin
  ...
  ASeparatorVisualLevel := GridViewInfo.GetVisualLevel
    (Level - GridRecord.LastParentRecordCount);
  Dec(Result.Left, (VisualLevel - ASeparatorVisualLevel) *
    GridViewInfo.LevelIndent);
...
begin
  ...
  begin
    ...
    Result := (0 <= ALevel) and (ALevel < Level) and
      GridRecord.IsParentRecordLast[ALevel] and Controller.CanShowGroupFooter
      (Level - 1 - ALevel);
  end;
end;
...
begin
  Result := RecordsViewInfo.HasLastHorzGridLine(Self) and
    (GridRecord.IsLast or (GridRecord.
    Index = Controller.LastScrollRecordIndex));
end;

function TcxCustomGridRowViewInfo.InvalidateOnChildHotTrackChanged: Boolean;
begin
  Result := inherited InvalidateOnChildHotTrackChanged or
    GridRecord.ShowCheckBox and
    (GridView.OptionsSelection.CheckBoxPosition = cbpFirstColumn);
end;
...
procedure TcxCustomGridRowViewInfo.SetFixedState
  (AValue: TcxDataControllerRowFixedState);
begin
...
begin
  Result := GridRecord.ShowCheckBox and
    (GridView.OptionsSelection.CheckBoxPosition = cbpFirstColumn);
end;
...
begin
  ...
  if HasFooters then
    FFootersViewInfo.Calculate(Bounds.Left, ATopBound + Height -
      BottomPartHeight);
end;

function TcxCustomGridRowViewInfo.Click(AHitTest: TcxCustomGridHitTest;
AButton: TMouseButton; AShift: TShiftState): Boolean;
var
...
begin
  ...
  try
    ...
    if Result and (ASelfLink.Ref <> nil) and NeedToggleExpandRecord(AHitTest,
      AButton, AShift) then
      DoToggleExpanded;
  finally
...
procedure TcxCustomGridRowViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
  if GridViewInfo.IsRightToLeftConverted then
...
function TcxCustomGridRowViewInfo.GetBoundsForInvalidate
...
function TcxCustomGridRowViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
  if HasFooters then
...
constructor TcxGridFixedDataRowsViewInfo.Create(ARowsViewInfo
  : TcxGridRowsViewInfo);
begin
  inherited Create;
...
function TcxGridFixedDataRowsViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  I: Integer;
  AHitTest: TcxCustomGridHitTest;
...
procedure TcxGridFixedDataRowsViewInfo.CalculateBottomItems(ALeftBound,
  ATopBound: Integer);
var
  I: Integer;
begin
...
procedure TcxGridFixedDataRowsViewInfo.CalculateTopItems(ALeftBound,
  ATopBound: Integer);
var
  I: Integer;
begin
...
function TcxGridFixedDataRowsViewInfo.CreateRowViewInfo(ARow: TcxCustomGridRow)
  : TcxCustomGridRowViewInfo;
begin
  Result := RowsViewInfo.CreateRowViewInfo(ARow);
end;

procedure TcxGridFixedDataRowsViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
...
function TcxGridFixedDataRowsViewInfo.GetPainterClass
  : TcxGridFixedDataRowsPainterClass;
begin
...
function TcxGridFixedDataRowsViewInfo.GetBottomItem(Index: Integer)
  : TcxCustomGridRowViewInfo;
var
  ARowIndex: Integer;
  ARow: TcxCustomGridRow;
...
function TcxGridFixedDataRowsViewInfo.GetTopItem(Index: Integer)
  : TcxCustomGridRowViewInfo;
var
  ARow: TcxCustomGridRow;
begin
...
procedure TcxGridFixedDataRowsViewInfo.RightToLeftConversion
  (const ABounds: TRect);
begin
  if not IsRightToLeftConverted then
  begin
...
procedure TcxGridRowsViewInfo.CorrectFixedGroupIndicatorsOrder
  (AFixedGroups: TdxFastList);
  ...
  begin
    ...
    begin
      ...
      if (AIndicatorItem is TcxGridIndicatorRowItemViewInfo) and
        not ARowIndicatorItem.GridRecord.IsSpecial and
        (not ARowIndicatorItem.GridRecord.IsData or
        (ARowIndicatorItem.GridRecord.FixedState = rfsNotFixed)) then
        Exit;
    end;
    Result := -1;
  end;

  function GetIndex(AIndicatorItem: TcxCustomGridIndicatorItemViewInfo)
    : Integer;
  begin
...
begin
  ...
  begin
    ...
    GridViewInfo.IndicatorViewInfo.MoveItem
      (GetIndex(AGroup.IndicatorItem), AIndex);
    Inc(AIndex);
  end;
end;
...
procedure TcxGridRowsViewInfo.CreateMissingItems(ABottomViewInfo
  : TcxCustomGridRowViewInfo; ATopBound: Integer);
  ...
  begin
    ...
    while ValidateIndex(AIndex) and (ATopBound <= ContentBounds.Bottom) and
      (AGroup.Level <> GridView.DataController.Groups.LevelCount - 1) and
      AGroup.Expanded and IsRowLocatedInGroup(AIndex, AGroup.Index,
      AGroup.Level) do
    begin
...
var
  AIndex: Integer;
begin
  if not ABottomViewInfo.GridRecord.IsData and
    (ABottomViewInfo.FixedState = rfsFixedToTop) then
...
begin
  ...
  begin
    ...
    if HasFixedDataRows then
      FixedDataRowsViewInfo.Calculate(Rect(ContentBounds.Left, ATopBound, -1,
        Bounds.Bottom));
  end;
...
function TcxGridRowsViewInfo.CalculateDataRowHeight(AConsideLayout
...
begin
  ...
  for I := 0 to GridView.GroupedColumnCount - 1 do
    if GridView.GroupedColumns[I].ShowGroupValuesWithImages then
      Result := Max(Result, GridView.GroupedColumns[I]
        .GetImageComboBoxProperties.Images.Height);
end;

function TcxGridRowsViewInfo.CalculateGroupRowDefaultHeight
  (AMinHeight: Boolean): Integer;
var
...
function TcxGridRowsViewInfo.CalculateRowDefaultHeight(AConsideLayout
  : Boolean = True): Integer;
var
...
begin
  if GridView.RowLayout.Active and AConsideLayout then
    if GridView.RowLayoutController.Container.ViewInfo.IsValid then
      Result := GridView.RowLayoutController.Container.ViewInfo.ContentHeight
    else
      Result := 0
  else
  begin
    ...
    begin
      ...
      begin
        GridView.Styles.GetDataCellParams(nil,
          HeaderViewInfo[I].Column, AParams);
        AFontHeight := HeaderViewInfo[I].Column.CalculateDefaultCellHeight
          (Canvas, AParams.Font);
        if AFontHeight > Result then
          Result := AFontHeight;
      end;
    end;
    Result := GetCellHeight(Result);
...
function TcxGridRowsViewInfo.CalculateRowHeight(AConsideLayout
  : Boolean = True): Integer;
begin
...
begin
  ...
  begin
    ...
    if GridViewInfo.CalculateDown and (I = MaxCount - 1) then
      Dec(AContentBottom, GridView.GetHorizontalScrollBarAreaHeight);
    if ALastBottom > AContentBottom then
      Break;
    Inc(FVisibleCount);
    if ALastBottom = AContentBottom then
      Break;
  ...
  begin
    if (FVisibleCount = FPartVisibleCount) and
      (GridViewInfo.CalculateDown and not Items[FVisibleCount - 1]
      .IsFullyVisible or not GridViewInfo.CalculateDown and
      not Items[0].IsFullyVisible) then
      Dec(FVisibleCount);
...
function TcxGridRowsViewInfo.CreateFixedGroupRowViewInfo(ARow: TcxCustomGridRow)
  : TcxCustomGridRowViewInfo;
begin
...
function TcxGridRowsViewInfo.CreateRowViewInfo(ARow: TcxCustomGridRow)
  : TcxCustomGridRowViewInfo;
begin
  Result := TcxCustomGridRowViewInfo(CreateRecordViewInfo(ARow));
end;

function TcxGridRowsViewInfo.GetAdjustedScrollPositionForFixedGroupMode
  (ARow: TcxCustomGridRow; APosition: Integer): Integer;
begin
  if Controller.IsRecordPixelScrolling then
...
function TcxGridRowsViewInfo.GetAdjustedPixelScrollPositionForFixedGroupsMode
  (ARow: TcxCustomGridRow; APosition: Integer): Integer;
var
  I: Integer;
...
begin
  ...
  else if (AViewInfo.FixedState = rfsNotFixed) and (GetFixedGroupsCount > 0)
  then
    for I := Count - 1 downto 0 do
      if (Items[I].Bounds.Top < GetFixedGroupsBottomBound) or
        (AViewInfo.Index = I) then
      begin
...
function TcxGridRowsViewInfo.GetAdjustedIndexScrollPositionForFixedGroupsMode
  (ARow: TcxCustomGridRow; APosition: Integer): Integer;
var
...
function TcxGridRowsViewInfo.GetFilterRowViewInfoClass
  : TcxCustomGridRowViewInfoClass;
begin
...
function TcxGridRowsViewInfo.GetNewItemRowViewInfoClass
  : TcxCustomGridRowViewInfoClass;
begin
  Result := TcxGridNewItemRowViewInfo;
end;

function TcxGridRowsViewInfo.GetNextNonOverlappedIndex(AIndex: Integer)
  : Integer;
begin
...
function TcxGridRowsViewInfo.GetViewInfoIndexByRecordIndex
...
function TcxGridRowsViewInfo.HasLastHorzGridLine(ARowViewInfo
  : TcxCustomGridRowViewInfo): Boolean;
begin
  Result := (GridLines = glVertical) and
    ((ARowViewInfo = nil) and (SeparatorWidth = 0) or (ARowViewInfo <> nil) and
    not ARowViewInfo.HasSeparator);
end;
...
function TcxGridRowsViewInfo.IsCellPartVisibleForFixedGroupsMode
  (ACellViewInfo: TcxGridTableDataCellViewInfo): Boolean;
var
...
function TcxGridRowsViewInfo.IsRowLocatedInGroup(ARowIndex, AGroupIndex,
...
begin
  ...
  begin
    AItem := Items[I];
    if (AItem.FixedState = rfsNotFixed) and
      (ContentBounds.Bottom >= AItem.Bounds.Bottom) then
      Inc(FVisibleCount);
  end;
  if not GridViewInfo.CalculateDown and (AVisibleCount < VisibleCount) then
    FVisibleCount := AVisibleCount;
...
begin
  ...
  if IsFilterRowVisible then
    FFilterRowViewInfo := GetFilterRowViewInfoClass.Create(Self,
      ViewData.FilterRow);
  if IsNewItemRowVisible then
    FNewItemRowViewInfo := GetNewItemRowViewInfoClass.Create(Self,
      ViewData.NewItemRow);
...
begin
  Result := Max(GridViewInfo.GetFontHeight(AParams.Font),
    GridViewInfo.ExpandButtonSize);
  ...
  if GridView.OptionsView.GroupRowStyle = grsOffice11 then
    Result := Max(Result, CalculateGroupImagesHeight);
  Inc(Result, cxMarginsHeight(GridViewInfo.LookAndFeelPainter.
    DefaultGroupContentOffsets));
end;

function TcxGridRowsViewInfo.CanDataRowSize: Boolean;
begin
  Result := GridViewInfo.SupportsAutoHeight and
    GridView.OptionsCustomize.DataRowSizing;
end;
...
function TcxGridRowsViewInfo.GetCellHeight(ACellContentHeight: Integer)
  : Integer;
begin
...
function TcxGridRowsViewInfo.GetFooterCellBestFitWidth
  (AColumn: TcxGridColumn): Integer;
var
  I: Integer;
  ARowViewInfo: TcxCustomGridRowViewInfo;
begin
  ...
  begin
    ...
    if (ARowViewInfo <> nil) and ARowViewInfo.HasFooters then
      Result := Max(Result, ARowViewInfo.FootersViewInfo.GetCellBestFitWidth
        (AColumn));
  end;
end;
...
begin
  ...
  else if ViewData.HasNewItemRecord and ARecord.IsNewItemRecord then
    Result := NewItemRowViewInfo
  else if ARecord.IsData and (TcxCustomGridRow(ARecord).FixedState <>
    rfsNotFixed) then
...
begin
  if IsRecordPixelScrollSizeCalculating then
    Result := cxMaxRectSize
  else if GridViewInfo.IsCalculating then
    Result := FRestHeight
  else
    Result := CalculateRestHeight(ATopBound);
end;

function TcxGridRowsViewInfo.IsCellMultiLine
...
begin
  Result := GridViewInfo.SupportsAutoHeight and
    (GridView.OptionsView.DataRowHeight <> 0);
end;
...
function TcxGridTableViewInfo.GetFindPanelViewInfo
...
procedure TcxGridTableViewInfo.CreateViewInfos;
  ...
  begin
    if (Controller.FindPanel = nil) or (FindPanelViewInfo.Alignment = gpaTop)
    then
...
begin
  try
    ...
    IndicatorViewInfo.Calculate(Bounds.Left, ClientBounds.Top -
      HeaderViewInfo.Height);
  finally
    inherited;
  end;
end;
...
begin
  ...
  begin
    ...
    ARequiredWidth := VisualLevelCount * LevelIndent;
    if GridView.RowLayoutController.Container.ViewInfo.IsValid then
      Inc(ARequiredWidth, GridView.RowLayoutController.Container.ViewInfo.
        ItemsViewInfo.MinWidth);
...
begin
  Result := RecordsViewInfo.CommonDataRowHeight +
    RecordsViewInfo.CommonPreviewHeight;
end;
...
begin
  ...
  if cxIsTouchModeEnabled and not dxElementSizeFitsForTouch(FLevelIndent,
    ScaleFactor) then
  begin
    ...
    FLevelIndent := FExpandButtonIndent + ExpandButtonSize +
      FExpandButtonIndent;
  end;
end;
...
begin
  MainCalculate(Classes.Bounds(cxInvisibleCoordinate, 0, AMaxSize.X,
    AMaxSize.Y));
  ...
  begin
    ...
    if RecordsViewInfo.HasFixedDataRows then
      Inc(AHeight, RecordsViewInfo.FixedDataRowsViewInfo.
        GetBottomContentHeight);
    Inc(AHeight, GridView.GetHorizontalScrollBarAreaHeight);
  end;
  AFullyVisible := (VisibleRecordCount = 0) or
    (VisibleRecordCount = Controller.LastScrollRecordIndex - FirstRecordIndex +
    1) and Controller.IsDataFullyVisible(True);
  inherited;
end;

function TcxGridTableViewInfo.CalculatePartBounds
...
begin
  ...
  Result := (Bounds.Bottom - Bounds.Top - ANonRecordsAreaHeight)
    div GetEqualHeightRecordScrollSize;
end;

procedure TcxGridTableViewInfo.CalculateWidth(const AMaxSize: TPoint;
var AWidth: Integer);
begin
  if GridView.HasColumnAutoWidth then
...
function TcxGridTableViewInfo.DoGetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
...
function TcxGridTableViewInfo.GetColumnFooterWidth(AFooterViewInfo
  : TcxGridFooterViewInfo; AColumn: TcxGridColumn): Integer;
begin
...
function TcxGridTableViewInfo.GetMultilineEditorBounds(const ACellEditBounds
...
function TcxGridTableViewInfo.GetNonRecordsAreaHeight(ACheckScrollBar
  : Boolean): Integer;
begin
...
begin
  ...
  if RecordsViewInfo.HasFixedDataRows then
    ...
    begin
      Dec(Result.Bottom, RecordsViewInfo.FixedDataRowsViewInfo.
        GetBottomContentHeight);
      if AFocusedRow.FixedState = rfsNotFixed then
        Inc(Result.Top, RecordsViewInfo.FixedDataRowsViewInfo.
          GetTopContentHeight);
    end;
end;
...
function TcxGridTableViewInfo.GetFooterViewInfoClass
  : TcxGridFooterViewInfoClass;
begin
  Result := TcxGridFooterViewInfo;
end;

function TcxGridTableViewInfo.GetGroupByBoxViewInfoClass
  : TcxGridGroupByBoxViewInfoClass;
begin
  Result := TcxGridGroupByBoxViewInfo;
end;

function TcxGridTableViewInfo.GetHeaderViewInfoClass
  : TcxGridHeaderViewInfoClass;
begin
  Result := TcxGridHeaderViewInfo;
end;

function TcxGridTableViewInfo.GetIndicatorViewInfoClass
  : TcxGridIndicatorViewInfoClass;
begin
  Result := TcxGridIndicatorViewInfo;
end;

function TcxGridTableViewInfo.GetHeaderViewInfoSpecificClass
  : TcxGridHeaderViewInfoSpecificClass;
begin
  Result := TcxGridHeaderViewInfoSpecific;
end;

function TcxGridTableViewInfo.GetRecordsViewInfoClass
  : TcxCustomGridRecordsViewInfoClass;
begin
  Result := TcxGridRowsViewInfo;
end;

function TcxGridTableViewInfo.GetCellBorders(AIsRight, AIsBottom: Boolean)
  : TcxBorders;
begin
  case GridLines of
    glBoth:
...
function TcxGridTableViewInfo.GetCellHeight(AIndex,
  ACellHeight: Integer): Integer;
begin
  Result := ACellHeight;
end;

function TcxGridTableViewInfo.GetCellTopOffset(AIndex,
  ACellHeight: Integer): Integer;
begin
  Result := 0;
end;
...
begin
  Result := DataWidth;
  if ((HeaderViewInfo.Width <> 0) or not GridView.HasColumnAutoWidth) then
    Inc(Result, GridView.GetVerticalScrollBarAreaWidth);
end;

function TcxGridTableViewInfo.GetOffsetBounds(AItemsOffset: Integer;
out AUpdateBounds: TRect): TRect;
var
...
begin
  ...
  AExcludeFocusedRecordFromOffsetBounds :=
    cxRectIntersect(APrevFocusedRecordDisplayBounds,
    RecordsViewInfo.PrevFocusedItemBounds, Result);
  if AExcludeFocusedRecordFromOffsetBounds then
  begin
    AExcludeFocusedRecordFromOffsetBounds :=
      ((ViewData.Controller.FocusedRecordIndex <>
      ViewData.Controller.PrevFocusedRecordIndex) or (AItemsOffset < 0) and
      (APrevFocusedRecordDisplayBounds.Bottom > Result.Bottom + AItemsOffset) or
      (AItemsOffset > 0) and (APrevFocusedRecordDisplayBounds.Top < Result.Top +
      AItemsOffset));
  end;
...
function TcxGridTableViewInfo.GetOffsetBounds(DX, DY: Integer;
out AUpdateBounds: TRect): TRect;
begin
...
var
  ARowCount: Integer;
begin
  ARowCount := (AHeight - GetNonRecordsAreaHeight(True))
    div GetEqualHeightRecordScrollSize;
  if ARowCount < 1 then
    ARowCount := 1;
  ...
  Result := GetNonRecordsAreaHeight(True) + ARowCount *
    GetEqualHeightRecordScrollSize;
end;

function TcxGridTableViewInfo.GetPopupHeight(ADropDownRowCount
  : Integer): Integer;
begin
  Result := GetNonRecordsAreaHeight(True) + ADropDownRowCount *
    GetEqualHeightRecordScrollSize;
...
function TcxGridMasterTableViewInfoCacheItem.GetGridRecord
  : TcxGridMasterDataRow;
begin
  Result := TcxGridMasterDataRow(inherited GridRecord);
end;

function TcxGridMasterTableViewInfoCacheItem.
  GetIsDetailsSiteCachedInfoAssigned: Boolean;
begin
  Result := DetailsSiteCachedInfo <> nil;
end;

procedure TcxGridMasterTableViewInfoCacheItem.SetDetailsSiteFullyVisible
  (Value: Boolean);
begin
...
procedure TcxGridMasterTableViewInfoCacheItem.SetDetailsSiteHeight
  (Value: Integer);
begin
...
procedure TcxGridMasterTableViewInfoCacheItem.SetDetailsSiteNormalHeight
  (Value: Integer);
begin
...
procedure TcxGridMasterTableViewInfoCacheItem.SetDetailsSiteWidth
  (Value: Integer);
begin
...
procedure TcxGridMasterTableViewInfoCacheItem.UnassignValues
  (AKeepMaster: Boolean);
var
  ADetailView: TcxCustomGridView;
begin
  if FUnassigningValues then
    Exit;
...
procedure TcxCustomGridColumnOptions.SetFilterRowOperator
  (Value: TcxFilterOperatorKind);
begin
...
procedure TcxCustomGridColumnOptions.SetShowGroupValuesWithImages
  (Value: Boolean);
begin
...
constructor TcxGridRowFooterCellPos.Create(ARow: TcxCustomGridRow;
AColumn: TcxGridColumn; AFooterGroupLevel: Integer;
ASummaryItem: TcxDataSummaryItem);
begin
  inherited Create;
...
constructor TcxGridGroupSummaryInfo.Create(ARow: TcxGridGroupRow;
ASummaryItem: TcxDataSummaryItem);
begin
  inherited Create;
  Row := ARow;
...
procedure TcxGridColumnStyles.SetOnGetFooterStyle
...
procedure TcxGridColumnStyles.SetOnGetFooterStyleEx
  (Value: TcxGridGetFooterStyleExEvent);
begin
...
procedure TcxGridColumnStyles.SetOnGetFooterSummaryStyle
  (Value: TcxGridGetFooterSummaryStyleEvent);
begin
...
procedure TcxGridColumnStyles.SetOnGetGroupSummaryStyle
  (Value: TcxGridGetGroupSummaryStyleEvent);
begin
...
procedure TcxGridColumnStyles.SetOnGetHeaderStyle
  (Value: TcxGridGetHeaderStyleEvent);
begin
...
procedure TcxGridColumnStyles.GetDefaultViewParams(Index: Integer;
...
begin
  ...
  if Assigned(FOnGetFooterSummaryStyle) and (ASummaryItem <> nil) then
    FOnGetFooterSummaryStyle(GridView, ARow, Item, AFooterGroupLevel,
      ASummaryItem, AStyle);
  ARowFooterCellPos := TcxGridRowFooterCellPos.Create(ARow, Item,
    AFooterGroupLevel, ASummaryItem);
  try
...
begin
  Result := GetSummaryItems(TcxGridSummariesIndex(Index))
    .GetDataItemFormat(Item.Index,
    GetSummaryItemsPosition(TcxGridSummariesIndex(Index)));
end;

function TcxGridColumnSummary.GetKind(Index: Integer): TcxSummaryKind;
begin
  Result := GetSummaryItems(TcxGridSummariesIndex(Index))
    .GetDataItemKind(Item.Index,
    GetSummaryItemsPosition(TcxGridSummariesIndex(Index)));
end;
...
begin
  GetSummaryItems(TcxGridSummariesIndex(Index)).SetDataItemFormat(Item.Index,
    GetSummaryItemsPosition(TcxGridSummariesIndex(Index)), Value);
end;

procedure TcxGridColumnSummary.SetKind(Index: Integer; Value: TcxSummaryKind);
begin
  GetSummaryItems(TcxGridSummariesIndex(Index)).SetDataItemKind(Item.Index,
    GetSummaryItemsPosition(TcxGridSummariesIndex(Index)), Value);
end;
...
function TcxGridColumnSummary.GetSummaryItems(AIndex: TcxGridSummariesIndex)
  : TcxDataSummaryItems;
begin
...
function TcxGridColumnSummary.GetSummaryItemsPosition
  (AIndex: TcxGridSummariesIndex): TcxSummaryPosition;
begin
...
procedure TcxCustomGridColumn.SetFilterRowOperator
  (AValue: TcxFilterOperatorKind);
begin
...
procedure TcxCustomGridColumn.SetHeaderGlyphAlignmentVert
...
procedure TcxCustomGridColumn.SetLayoutItem(const Value
...
procedure TcxCustomGridColumn.SetRowLayoutItem(const Value
  : TcxGridTableRowLayoutItem);
begin
...
function TcxCustomGridColumn.GetStoredProperties(AProperties: TStrings)
  : Boolean;
begin
  with AProperties do
  begin
...
procedure TcxCustomGridColumn.GetPropertyValue(const AName: string;
var AValue: Variant);
begin
  if AName = 'Width' then
    AValue := Width
  else if AName = 'GroupIndex' then
    AValue := GroupIndex
  else if AName = 'IsChildInMergedGroup' then
    AValue := IsChildInMergedGroup
  else if AName = 'FilterRowOperator' then
    AValue := Options.FilterRowOperator
  else
    inherited GetPropertyValue(AName, AValue);
end;

procedure TcxCustomGridColumn.SetPropertyValue(const AName: string;
...
begin
  ...
  begin
    ...
    if AFilterRow <> nil then
      AFilterRow.AddAdornerTargetElementsForColumn(AList, Self,
        'FilterRowCell');
    ANewItemRow := ARows.NewItemRowViewInfo;
    if ANewItemRow <> nil then
      ANewItemRow.AddAdornerTargetElementsForColumn(AList, Self,
        'NewItemRowCell');
  end;
end;

procedure TcxCustomGridColumn.Notification(AComponent: TComponent;
...
begin
  ...
  if Operation = opRemove then
    if AComponent = FLayoutItem then
      FLayoutItem := nil
    else if AComponent = FRowLayoutItem then
      FRowLayoutItem := nil;
end;
...
function TcxCustomGridColumn.GetOptionsClass
...
begin
  Result := inherited CanDataCellScroll or GridView.InplaceEditForm.Visible;
end;

function TcxCustomGridColumn.CanEdit: Boolean;
begin
  if Controller.IsFilterRowFocused then
    Result := CanFocus(Controller.FocusedRecord) and
...
begin
  Result := (not GridView.InplaceEditForm.Visible or AVisually) and
    inherited CanFilter(AVisually);
end;

function TcxCustomGridColumn.CanFilterMRUValueItems: Boolean;
begin
  Result := not GridView.InplaceEditForm.Visible and
    inherited CanFilterMRUValueItems;
end;

function TcxCustomGridColumn.CanFilterUsingChecks: Boolean;
begin
  Result := not GridView.InplaceEditForm.Visible and
    inherited CanFilterUsingChecks;
end;
...
begin
  Result := not GridView.InplaceEditForm.Visible and inherited CanGroup;
end;

function TcxCustomGridColumn.CanHorzSize: Boolean;
begin
  Result := inherited CanHorzSize and
    GridView.OptionsCustomize.ColumnHorzSizing;
end;

function TcxCustomGridColumn.CanIncSearch: Boolean;
begin
  Result := not GridView.InplaceEditForm.Visible and inherited CanIncSearch;
end;

function TcxCustomGridColumn.CanScroll: Boolean;
begin
  Result := inherited CanScroll and not GridView.InplaceEditForm.Visible;
end;

function TcxCustomGridColumn.CanSearchInGroupRows: Boolean;
begin
  Result := GridView.FindPanel.SearchInGroupRows and
    Options.FilteringWithFindPanel and (GroupIndex > -1);
end;
...
begin
  Result := not GridView.InplaceEditForm.Visible and inherited CanSort;
end;
...
begin
  ...
  else if not IsVisibleForEditForm then
    DestroyLayoutItem
  else if CanCreateLayoutItem then
    CreateLayoutItem;
end;
...
begin
  ...
  else if not IsVisibleForRowLayout then
    DestroyRowLayoutItem
  else if CanCreateRowLayoutItem then
    CreateRowLayoutItem;
end;
...
function TcxCustomGridColumn.GetImageComboBoxProperties
  : TcxImageComboBoxProperties;
begin
...
procedure TcxCustomGridColumn.InternalSetFilterRowOperator
  (AValue: TcxFilterOperatorKind);
begin
  FFilterRowOperator := AValue;
end;

function TcxCustomGridColumn.InternalGetFilterRowOperator
  : TcxFilterOperatorKind;
begin
...
function TcxCustomGridColumn.IsFilterOperatorSupported
  (AOperator: TcxFilterOperatorKind): Boolean;
var
...
begin
  ...
  AFilterControlSupportedOperators := AFilterHelper.GetSupportedFilterOperators
    (GetProperties, DataBinding.ValueTypeClass, True);
  if not DataController.Filter.SupportedLike then
    AFilterControlSupportedOperators := AFilterControlSupportedOperators -
      [fcoLike, fcoNotLike, fcoContains, fcoNotContains, fcoBeginsWith,
      fcoEndsWith];
...
begin
  ...
  begin
    ...
    if ARowViewInfo <> nil then
      Result := ARowViewInfo.IsInplaceEditFormCellPartVisible
        (FocusedCellViewInfo);
  end;
  if not Result and GridView.IsFixedGroupsMode and
    Controller.IsRecordPixelScrolling and not Controller.FocusedRow.IsSpecial
  then
  begin
    ARowsViewInfo := GridView.ViewInfo.RecordsViewInfo;
    Result := ARowsViewInfo.IsCellPartVisibleForFixedGroupsMode
      (FocusedCellViewInfo);
  end;
end;
...
begin
  ...
  else if GridView.RowLayout.Active then
...
begin
  Result := dxDefaultBooleanToBoolean(VisibleForEditForm,
    IsDefaultVisibleForEditForm) and not IsPreview;
end;

function TcxCustomGridColumn.IsVisibleForFocus
  (ARecord: TcxCustomGridRecord): Boolean;
begin
  Result := inherited IsVisibleForFocus(ARecord) or (ARecord <> nil) and
    ARecord.IsData and TcxGridDataRow(ARecord).EditFormVisible and
    (LayoutItem <> nil) and LayoutItem.ActuallyVisible or
    GridView.RowLayout.Active and (RowLayoutItem <> nil) and
    RowLayoutItem.ActuallyVisible;
end;

function TcxCustomGridColumn.IsVisibleForRowLayout: Boolean;
begin
  Result := dxDefaultBooleanToBoolean(VisibleForRowLayout,
    IsDefaultVisibleForRowLayout) and not IsPreview;
end;
...
begin
  Result := Options.ShowGroupValuesWithImages;
  if Result then
  begin
    AProperties := Safe<TcxImageComboBoxProperties>.Cast(GetProperties);
    Result := (AProperties <> nil) and (AProperties.Images <> nil);
  end;
end;

function TcxCustomGridColumn.SupportsBeginsWithFilterOperator
  (ARow: TcxCustomGridRow): Boolean;
var
  AProperties: TcxCustomEditProperties;
  AFilterHelper: TcxCustomFilterEditHelperClass;
begin
  ...
  Result := (AFilterHelper <> nil) and
    (fcoLike in AFilterHelper.GetSupportedFilterOperators(AProperties,
...
begin
  if GridView.RowLayout.Active then
    Result := not GridView.IsAssigningItems and Controller.FocusNextItem(Index,
      True, True, False, not Controller.IsMultiSelectPersistent)
  else
...
begin
  Result := not GridView.FilterRow.OperatorCustomization and
    IsFilterRowIncrementalFiltering and SupportsBeginsWithFilterOperator
    (ViewData.FilterRow);
end;
...
function TcxCustomGridColumn.GetHeaderViewInfoClass
  : TcxGridColumnHeaderViewInfoClass;
begin
  Result := TcxGridColumnHeaderViewInfo;
end;
...
begin
  Result := not HeaderGlyph.Empty or IsImageAssigned(GridView.GetImages,
    HeaderImageIndex);
end;

function TcxCustomGridColumn.GroupBy(AGroupIndex: Integer;
ACanShow: Boolean = True; AMergeWithLeftColumn: Boolean = False;
AMergeWithRightColumn: Boolean = False): Boolean;
begin
  Result := CanGroup;
  if not Result then
  ...
  try
    ...
    else if HideOnGrouping and CanHide then
      Visible := False;
  finally
    GridView.EndGroupingUpdate;
  end;
...
function TcxGridColumn.DoCompareValuesForCellMerging(ARow1: TcxGridDataRow;
AProperties1: TcxCustomEditProperties; const AValue1: TcxEditValue;
ARow2: TcxGridDataRow; AProperties2: TcxCustomEditProperties;
const AValue2: TcxEditValue): Boolean;
begin
  Result := (AProperties1 = AProperties2) and AProperties1.CompareDisplayValues
    (AValue1, AValue2);
  if Assigned(FOnCompareValuesForCellMerging) then
    FOnCompareValuesForCellMerging(Self, AProperties1, AValue1, AProperties2,
      AValue2, Result);
  if Assigned(FOnCompareRowValuesForCellMerging) then
    FOnCompareRowValuesForCellMerging(Self, ARow1, AProperties1, AValue1, ARow2,
      AProperties2, AValue2, Result);
end;
...
procedure TcxGridColumn.Assign(Source: TPersistent);
  ...
  function FindLayoutItem(AGridColumn: TcxGridColumn;
  AContainer: TcxGridCustomLayoutContainer): TcxGridCustomLayoutItem;
  var
    I: Integer;
  begin
...
begin
  ...
  begin
    ...
    OnCompareRowValuesForCellMerging :=
      AGridColumn.OnCompareRowValuesForCellMerging;
    ...
    ALayoutItem := FindLayoutItem(AGridColumn,
      GridView.InplaceEditForm.Container);
    if ALayoutItem <> nil then
      LayoutItem := TcxGridInplaceEditFormLayoutItem(ALayoutItem);
    ALayoutItem := FindLayoutItem(AGridColumn,
      GridView.RowLayoutController.Container);
    if ALayoutItem <> nil then
...
begin
  ...
  Inc(Result, (Ord(bLeft in ABorders) + Ord(bRight in ABorders)) *
    GridView.ViewInfo.GridLineWidth);
  if (VisibleIndex <> -1) and GridView.Visible then
  begin
    if GridView.OptionsView.Header then
      Result := Max(Result, GridView.ViewInfo.HeaderViewInfo[VisibleIndex]
        .GetBestFitWidth);
    if GridView.OptionsView.Footer then
      Result := Max(Result,
        GridView.ViewInfo.FooterViewInfo.GetCellBestFitWidth(Self));
    Result := Max(Result,
      GridView.ViewInfo.RecordsViewInfo.GetFooterCellBestFitWidth(Self));
  end;
end;

procedure TcxGridColumn.ChangeGrouping(AGroupIndex: Integer;
AMergeWithLeftColumn: Boolean = False; AMergeWithRightColumn: Boolean = False);
begin
  inherited ChangeGrouping(AGroupIndex, AMergeWithLeftColumn,
    AMergeWithRightColumn);
  CheckUsingInFindCriteria;
end;

function TcxGridColumn.GetFixed: Boolean;
begin
  Result := inherited GetFixed or (Controller.ForcingWidthItem <> nil) and
...
procedure TcxGridColumn.SetOnCompareRowValuesForCellMerging
  (Value: TcxGridColumnCompareRowValuesEvent);
begin
...
procedure TcxGridColumn.SetOnCompareValuesForCellMerging
  (Value: TcxGridColumnCompareValuesEvent);
begin
...
procedure TcxGridColumn.SetOnCustomDrawFooterCell
  (Value: TcxGridColumnCustomDrawHeaderEvent);
begin
...
procedure TcxGridColumn.SetOnCustomDrawGroupSummaryCell
  (Value: TcxGridGroupSummaryCellCustomDrawEvent);
begin
...
procedure TcxGridColumn.SetOnCustomDrawHeader
  (Value: TcxGridColumnCustomDrawHeaderEvent);
begin
...
function TcxGridTableBackgroundBitmaps.GetBitmapStyleIndex
...
function TcxGridTableViewNavigatorButtons.GetButtonEnabled
  (ADefaultIndex: Integer): Boolean;
begin
...
function TcxGridTableViewNavigator.GetNavigatorButtonsClass
...
procedure TcxGridTableFindPanelOptions.SetLocation(const AValue
  : TcxGridTableFindPanelLocation);
begin
...
function TcxGridTableOptionsBehavior.GetShowLockedStateImageOptions
  : TcxGridTableShowLockedStateImageOptions;
begin
...
function TcxGridTableOptionsBehavior.GetShowLockedStateImageOptionsClass
...
begin
  ...
  begin
    if GridView.InplaceEditForm.Visible and not GridView.InplaceEditForm.Close
    then
      Exit;
    FEditMode := AValue;
    if EditMode = emModalEditForm then
      GridView.Controller.InplaceEditForm.DisplayMode := efdmModal
    else
      GridView.Controller.InplaceEditForm.DisplayMode := efdmInplace;
...
procedure TcxGridTableOptionsBehavior.SetExpandMasterRowOnDblClick
  (Value: Boolean);
begin
...
procedure TcxGridTableFiltering.RunCustomizeDialog
...
function TcxGridTableFiltering.GetColumnExcelPopup
...
function TcxGridTableFiltering.
  GetColumnFilteredItemsListShowFilteredItemsOnly: Boolean;
begin
...
procedure TcxGridTableFiltering.SetColumnExcelPopup
...
procedure TcxGridTableFiltering.SetColumnFilteredItemsListShowFilteredItemsOnly
  (AValue: Boolean);
begin
...
procedure TcxGridTableFiltering.SetColumnPopup
  (Value: TcxGridItemFilterPopupOptions);
begin
  ItemPopup := Value;
end;

procedure TcxGridTableFiltering.SetColumnPopupMode
...
begin
  inherited;
  Filer.DefineProperty('ColumnPopupDropDownWidth', ReadItemPopupDropDownWidth,
    nil, True);
  Filer.DefineProperty('ColumnPopupMaxDropDownItemCount',
    ReadItemPopupMaxDropDownCount, nil, True);
end;
...
function TcxGridTableOptionsCustomize.
  GetColumnsQuickCustomizationMaxDropDownCount: Integer;
begin
  Result := ItemsQuickCustomizationMaxDropDownCount;
end;

function TcxGridTableOptionsCustomize.
  GetColumnsQuickCustomizationMultiColumnMode: Boolean;
begin
  Result := ItemsQuickCustomizationMultiColumnMode;
end;

function TcxGridTableOptionsCustomize.GetColumnsQuickCustomizationReordering
  : TcxGridQuickCustomizationReordering;
begin
...
function TcxGridTableOptionsCustomize.
  GetColumnsQuickCustomizationShowCommands: Boolean;
begin
  Result := ItemsQuickCustomizationShowCommands;
end;

function TcxGridTableOptionsCustomize.
  GetColumnsQuickCustomizationSorted: Boolean;
begin
...
procedure TcxGridTableOptionsCustomize.SetColumnExpressionEditing
  (Value: Boolean);
begin
...
procedure TcxGridTableOptionsCustomize.SetColumnHidingOnGrouping
  (Value: Boolean);
begin
...
procedure TcxGridTableOptionsCustomize.SetColumnsQuickCustomization
  (Value: Boolean);
begin
  ItemsQuickCustomization := Value;
end;

procedure TcxGridTableOptionsCustomize.
  SetColumnsQuickCustomizationMaxDropDownCount(Value: Integer);
begin
  ItemsQuickCustomizationMaxDropDownCount := Value;
end;

procedure TcxGridTableOptionsCustomize.
  SetColumnsQuickCustomizationMultiColumnMode(Value: Boolean);
begin
  ItemsQuickCustomizationMultiColumnMode := Value;
end;

procedure TcxGridTableOptionsCustomize.SetColumnsQuickCustomizationReordering
  (Value: TcxGridQuickCustomizationReordering);
begin
  ItemsQuickCustomizationReordering := Value;
end;

procedure TcxGridTableOptionsCustomize.SetColumnsQuickCustomizationShowCommands
  (Value: Boolean);
begin
  ItemsQuickCustomizationShowCommands := Value;
end;

procedure TcxGridTableOptionsCustomize.SetColumnsQuickCustomizationSorted
  (Value: Boolean);
begin
...
begin
  if Source is TcxGridTableOptionsCustomize then
    ...
    begin
      ...
      Self.ColumnsQuickCustomizationReordering :=
...
procedure TcxGridTableOptionsSelection.SetCheckBoxPosition
  (Value: TcxGridCheckBoxPosition);
begin
...
procedure TcxGridTableOptionsSelection.SetCheckBoxVisibility
  (Value: TcxGridCheckBoxVisibility);
begin
  if (CheckBoxVisibility <> Value) and
    (IsLoading or GridView.IsCheckBoxSelectionSupported or (Value = [])) then
  begin
...
procedure TcxGridTableOptionsSelection.SetClearPersistentSelectionOnOutsideClick
  (Value: Boolean);
begin
...
procedure TcxGridTableOptionsSelection.SetMultiSelectMode
  (Value: TcxGridMultiSelectMode);
begin
...
procedure TcxGridTableOptionsSelection.SetShowCheckBoxesDynamically
  (Value: Boolean);
begin
...
begin
  Result := MultiSelect and not CellMultiSelect and
    (MultiSelectMode = msmPersistent) and
...
begin
  if Source is TcxGridTableOptionsSelection then
    ...
    begin
      ...
      Self.ClearPersistentSelectionOnOutsideClick :=
...
procedure TcxGridFixedDataRowsOptions.SetPinClickAction
  (AValue: TcxGridDataRowPinClickAction);
begin
...
procedure TcxGridFixedDataRowsOptions.SetPinVisibility
  (AValue: TcxGridDataRowPinVisibility);
begin
...
procedure TcxGridFilterRowOptions.SetApplyChanges
...
begin
  Result := FExpandButtonsForEmptyDetails and
    ((GridView.Level = nil) or TcxGridLevel(GridView.Level)
    .Options.TabsForEmptyDetails);
end;
...
function TcxGridTableOptionsView.GetHeaderFilterButtonShowMode
...
function TcxGridTableOptionsView.GetShowColumnFilterButtons
...
procedure TcxGridTableOptionsView.SetExpandButtonsForEmptyDetails
  (Value: Boolean);
begin
...
procedure TcxGridTableOptionsView.SetGroupByHeaderLayout
  (Value: TcxGridGroupByHeaderLayout);
begin
...
procedure TcxGridTableOptionsView.SetGroupFooters
  (Value: TcxGridGroupFootersMode);
begin
  if FGroupFooters <> Value then
  begin
...
procedure TcxGridTableOptionsView.SetGroupSummaryLayout
  (Value: TcxGridGroupSummaryLayout);
begin
...
procedure TcxGridTableOptionsView.SetShowColumnFilterButtons
...
begin
  ...
  Filer.DefineProperty('NewItemRowSeparatorColor', ReadNewItemRowSeparatorColor,
    nil, True);
  Filer.DefineProperty('NewItemRowSeparatorWidth', ReadNewItemRowSeparatorWidth,
    nil, True);
end;
...
begin
  Result := GridView.ViewInfo.SupportsMultipleFooterSummaries and
...
begin
  ...
  if AValue > 0 then
  begin
    AMinValue := GridView.ViewInfo.RecordsViewInfo.
      CalculateGroupRowDefaultHeight(True);
    if AValue < AMinValue then
      AValue := AMinValue;
  end;
end;
...
function TcxGridTableOptionsView.GetGroupSummaryLayout
...
procedure TcxGridTableViewStyles.SetOnGetFooterStyle
  (Value: TcxGridGetCellStyleEvent);
begin
  if not dxSameMethods(FOnGetFooterStyle, Value) then
  begin
...
procedure TcxGridTableViewStyles.SetOnGetFooterStyleEx
  (Value: TcxGridGetFooterStyleExEvent);
begin
  if not dxSameMethods(FOnGetFooterStyleEx, Value) then
  begin
...
procedure TcxGridTableViewStyles.SetOnGetFooterSummaryStyle
  (Value: TcxGridGetFooterSummaryStyleEvent);
begin
  if not dxSameMethods(FOnGetFooterSummaryStyle, Value) then
  begin
...
procedure TcxGridTableViewStyles.SetOnGetGroupStyle
...
procedure TcxGridTableViewStyles.SetOnGetGroupSummaryStyle
  (Value: TcxGridGetGroupSummaryStyleEvent);
begin
  if not dxSameMethods(FOnGetGroupSummaryStyle, Value) then
  begin
...
procedure TcxGridTableViewStyles.SetOnGetHeaderStyle
  (Value: TcxGridGetHeaderStyleEvent);
begin
  if not dxSameMethods(FOnGetHeaderStyle, Value) then
  begin
...
procedure TcxGridTableViewStyles.SetOnGetInplaceEditFormItemStyle
  (Value: TcxGridGetCellStyleEvent);
begin
...
procedure TcxGridTableViewStyles.SetOnGetPreviewStyle
  (Value: TcxGridGetCellStyleEvent);
begin
...
procedure TcxGridTableViewStyles.GetDefaultViewParams(Index: Integer;
AData: TObject; out AParams: TcxViewParams);
  ...
  begin
    ...
    begin
      AParams.Color := LookAndFeelPainter.GridGroupRowStyleOffice11ContentColor
        (AData <> nil);
      AParams.TextColor :=
        LookAndFeelPainter.GridGroupRowStyleOffice11TextColor;
    end;
  end;
...
begin
  ...
  with AParams, LookAndFeelPainter do
    case Index of
      ...
      vsGroupFooterSortedSummary:
        if AData <> nil then
          TcxGridRowFooterCellPos(AData).Column.Styles.GetFooterParams
            (TcxGridRowFooterCellPos(AData).Row, TcxGridRowFooterCellPos(AData)
            .FooterGroupLevel, TcxGridRowFooterCellPos(AData)
            .SummaryItem, AParams)
        else
      ...
      vsInplaceEditFormItem, vsInplaceEditFormItemHotTrack, vsRowLayoutItem,
        vsRowLayoutItemHotTrack:
        begin
          if Index in [vsInplaceEditFormItemHotTrack, vsRowLayoutItemHotTrack]
          then
            AState := cxbsHot
          else
            AState := cxbsNormal;
      ...
      vsSelection, vsInactive:
        begin
          if (GridView.InplaceEditForm.Visible or GridView.RowLayout.Active) and
            (AData <> nil) then
          begin
            ACellPos := TcxGridCellPos(AData);
            ARow := TcxCustomGridRow(ACellPos.GridRecord);
...
procedure TcxGridTableViewStyles.GetRowLayoutGroupParams
  (out AParams: TcxViewParams);
begin
  GetViewParams(vsRowLayoutGroup, nil, nil, AParams);
end;

procedure TcxGridTableViewStyles.GetRowLayoutItemHottrackParams
  (AItem: TcxCustomGridTableItem; out AParams: TcxViewParams);
begin
  GetViewParams(vsRowLayoutItemHotTrack, AItem, nil, AParams);
end;

procedure TcxGridTableViewStyles.GetRowLayoutItemParams
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
out AParams: TcxViewParams);
var
  ACellPos: TcxGridDataCellPos;
begin
  if (AItem <> nil) and GridView.RowLayout.ItemHotTrack and
    GridView.DrawRecordFocused(ARecord) and AItem.Focused then
    GetSelectionParams(ARecord, AItem, AParams)
  else
  begin
    ACellPos := TcxGridDataCellPos.Create(ARecord, AItem);
    try
      GetViewParams(vsRowLayoutItem, ACellPos, nil, AParams);
    finally
      ACellPos.Free;
    end;
  end;
...
procedure TcxGridTableViewStyles.GetCellContentParams
...
begin
  ...
  begin
    if AItem is TcxDataSummaryItems then
      AItem := nil;
    GetGroupSummaryCellContentParams(ARecord as TcxGridGroupRow,
      TcxDataSummaryItem(AItem), AParams);
  end
  else
    inherited;
end;
...
begin
  if (AFooterGroupLevel <> -1) and (ASummaryItem <> nil) and ASummaryItem.Sorted
  then
  begin
    AFooterCellPos := TcxGridRowFooterCellPos.Create(ARow, AColumn,
      AFooterGroupLevel, ASummaryItem);
    try
    ...
    AColumn.Styles.GetFooterParams(ARow, AFooterGroupLevel,
      ASummaryItem, AParams);
end;
...
begin
  ...
  if Assigned(FOnGetFooterSummaryStyle) and (ASummaryItem <> nil) then
    FOnGetFooterSummaryStyle(GridView, ARow, AColumn, AFooterGroupLevel,
      ASummaryItem, AStyle);
...
begin
  ...
  begin
    if ARecord <> nil then
      ALevel := ARecord.Level;
    FOnGetGroupStyle(GridView, ARecord, ALevel, AStyle);
  end;
  GetViewParams(vsGroup, ARecord, AStyle, AParams);
end;

procedure TcxGridTableViewStyles.GetGroupSummaryCellContentParams
  (ARow: TcxGridGroupRow; ASummaryItem: TcxDataSummaryItem;
out AParams: TcxViewParams);
var
  ASummaryInfo: TcxGridGroupSummaryInfo;
begin
  if not FProcessingGroupSortedSummary and (ASummaryItem <> nil) and
    (ASummaryItem = ARow.GroupSummaryItems.SortedSummaryItem) then
  begin
  ...
  else if (ASummaryItem = nil) or (ASummaryItem.ItemLink = nil) then
    GetGroupSummaryParams(ARow, ASummaryItem, AParams)
  else
    TcxGridColumn(ASummaryItem.ItemLink).Styles.GetGroupSummaryParams(ARow,
      ASummaryItem, AParams);
end;

procedure TcxGridTableViewStyles.GetGroupSummaryCellParams
  (ARow: TcxGridGroupRow; ASummaryItem: TcxDataSummaryItem;
out AParams: TcxViewParams);
begin
...
procedure TcxGridTableViewStyles.GetInplaceEditFormGroupParams
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
out AParams: TcxViewParams);
var
  AStyle: TcxStyle;
...
procedure TcxGridTableViewStyles.GetInplaceEditFormItemHottrackParams
  (AItem: TcxCustomGridTableItem; out AParams: TcxViewParams);
begin
  GetViewParams(vsInplaceEditFormItemHotTrack, AItem, nil, AParams);
end;

procedure TcxGridTableViewStyles.GetInplaceEditFormItemParams
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
out AParams: TcxViewParams);
var
  AStyle: TcxStyle;
...
procedure TcxGridTableViewStyles.GetRecordContentParams
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
out AParams: TcxViewParams);
begin
...
procedure TcxGridTableViewStyleSheet.SetStylesValue
  (Value: TcxGridTableViewStyles);
begin
  SetStyles(Value);
end;
...
begin
  Result := TcxGridTableView((DataController as IcxCustomGridDataController)
    .GridView);
end;

function TcxGridTableSummaryGroupItemLink.QueryInterface(const IID: TGUID;
out Obj): HResult;
const
...
function TcxGridTableSummaryGroupItemLink.GetProperties
...
function TcxGridTableSummaryItem.QueryInterface(const IID: TGUID;
out Obj): HResult;
const
  E_NOINTERFACE = HResult($80004002);
begin
...
procedure TcxGridTableSummaryItem.GetPropertyValue(const AName: string;
var AValue: Variant);
begin
  if AName = 'Column' then
    if Column <> nil then
...
procedure TcxGridTableSummaryItem.SetPropertyValue(const AName: string;
const AValue: Variant);
begin
  if AName = 'Column' then
    Column := TcxGridColumn(GridView.FindItemByObjectName(AValue));
...
procedure TcxGridTableView.SetBackgroundBitmaps
  (Value: TcxGridTableBackgroundBitmaps);
begin
...
procedure TcxGridTableView.SetDateTimeHandling
  (Value: TcxGridTableDateTimeHandling);
begin
...
procedure TcxGridTableView.SetOnCustomDrawColumnHeader
  (Value: TcxGridColumnCustomDrawHeaderEvent);
begin
...
procedure TcxGridTableView.SetOnCustomDrawFooterCell
  (Value: TcxGridColumnCustomDrawHeaderEvent);
begin
  if not dxSameMethods(FOnCustomDrawFooterCell, Value) then
  begin
...
procedure TcxGridTableView.SetOnCustomDrawGroupCell
...
procedure TcxGridTableView.SetOnCustomDrawGroupSummaryCell
  (Value: TcxGridGroupSummaryCellCustomDrawEvent);
begin
  if not dxSameMethods(FOnCustomDrawGroupSummaryCell, Value) then
  begin
...
procedure TcxGridTableView.SetOnCustomDrawIndicatorCell
  (Value: TcxGridIndicatorCellCustomDrawEvent);
begin
...
procedure TcxGridTableView.SetOnDetachedEditFormInitialize
  (Value: TcxGridTableViewDetachedEditFormEvent);
begin
...
procedure TcxGridTableView.SetOnGetUnmergeableColumns
  (Value: TcxGridGetUnmergeableColumnsEvent);
begin
...
procedure TcxGridTableView.SetOptionsBehavior
  (Value: TcxGridTableOptionsBehavior);
begin
  inherited OptionsBehavior := Value;
end;

procedure TcxGridTableView.SetOptionsCustomize
  (Value: TcxGridTableOptionsCustomize);
begin
...
procedure TcxGridTableView.SetOptionsSelection
  (Value: TcxGridTableOptionsSelection);
begin
...
procedure TcxGridTableView.GetPropertyValue(const AName: string;
var AValue: Variant);
begin
  if AName = 'Footer' then
    AValue := OptionsView.Footer
  else if AName = 'GroupByBox' then
    AValue := OptionsView.GroupByBox
  else if AName = 'GroupFooters' then
    AValue := Variant(OptionsView.GroupFooters)
  else if AName = 'NewItemRow' then
    AValue := NewItemRow.Visible
  else if AName = 'DataRowHeight' then
    AValue := OptionsView.DataRowHeight
  else if AName = 'GroupRowHeight' then
    AValue := OptionsView.GroupRowHeight
  else if AName = 'EditFormUseDefaultLayout' then
    AValue := EditForm.UseDefaultLayout
  else if AName = 'RowUseDefaultLayout' then
    AValue := RowLayout.UseDefaultLayout
  else if AName = 'ColumnsQuickCustomizationSorted' then
    AValue := OptionsCustomize.ColumnsQuickCustomizationSorted
  else
    inherited;
end;

procedure TcxGridTableView.SetPropertyValue(const AName: string;
const AValue: Variant);
begin
  if AName = 'Footer' then
  ...
  else if (AName = 'DataRowHeight') and OptionsCustomize.DataRowSizing then
    OptionsView.DataRowHeight := AValue
  else if (AName = 'GroupRowHeight') and OptionsCustomize.GroupRowSizing then
...
begin
  ...
  FRowLayoutLookAndFeel := CreateRowLayoutLookAndFeel;
...
begin
  ...
  FreeAndNil(FRowLayoutLookAndFeel);
...
function TcxGridTableView.CreateInplaceEditFormLayoutLookAndFeel
  : TcxGridRowLayoutLookAndFeel;
begin
  Result := TcxGridRowLayoutLookAndFeel.Create(Self);
  UpdateInplaceEditFormStyles(Result);
end;

function TcxGridTableView.CreateRowLayoutLookAndFeel
  : TcxGridRowLayoutLookAndFeel;
begin
  Result := TcxGridRowLayoutLookAndFeel.Create(Self);
  UpdateRowLayoutLookAndFeel(Result);
end;

procedure TcxGridTableView.UpdateInplaceEditFormStyles(ALayoutLookAndFeel
  : TcxGridRowLayoutLookAndFeel);

  procedure UpdateCaptionOptions(AOptions: TdxLayoutLookAndFeelCaptionOptions;
  AParams: TcxViewParams);
  begin
...
begin
  ...
  try
    ...
    Styles.GetInplaceEditFormItemParams(nil, nil, AParams);
    UpdateCaptionOptions(ALayoutLookAndFeel.ItemOptions.CaptionOptions,
      AParams);
    Styles.GetInplaceEditFormGroupParams(nil, nil, AParams);
    UpdateCaptionOptions
      (ALayoutLookAndFeel.GroupOptions.CaptionOptions, AParams);
...
procedure TcxGridTableView.UpdateRowLayoutLookAndFeel(ALayoutLookAndFeel
  : TcxGridRowLayoutLookAndFeel);
...
begin
  ...
  UpdateInplaceEditFormStyles(FInplaceEditFormLayoutLookAndFeel);
  UpdateRowLayoutLookAndFeel(FRowLayoutLookAndFeel);
  RowLayoutController.Container.LayoutChanged;
end;
...
begin
  ...
  if (dceEdit in DataController.EditState) and
    (OptionsBehavior.EditMode in [emInplaceEditForm,
...
begin
  Result := AllowCellMerging and not FPreview.Active and
    not RowLayout.Active and (OptionsView.RowSeparatorWidth = 0);
end;

function TcxGridTableView.CanOffset(ARecordCountDelta,
  APixelScrollRecordOffsetDelta: Integer): Boolean;
begin
  Result := inherited CanOffset(ARecordCountDelta,
    APixelScrollRecordOffsetDelta) and not IsMaster and not IsFixedGroupsMode;
end;

function TcxGridTableView.CanOffsetHorz: Boolean;
begin
  Result := not IsUpdateLocked and
    (not IsMaster and not Controller.InplaceEditForm.Visible or
...
begin
  Result := inherited GetIsControlFocused or
    (Controller.HasFilterRowOperatorMenu and
    Controller.FilterRowOperatorMenu.Visible) or
    (Controller.HasDataRowFixingMenu and Controller.DataRowFixingMenu.Visible)
    or (Controller.InplaceEditForm.Visible and
    (OptionsBehavior.EditMode = emModalEditForm));
end;

procedure TcxGridTableView.GetItemsListForClipboard(AItems: TList;
ACopyAll: Boolean);
var
  I: Integer;
begin
  ...
  if OptionsBehavior.CopyPreviewToClipboard then
    if FPreview.Active then
      AItems.Add(FPreview.Column);
end;

function TcxGridTableView.GetResizeOnBoundsChange: Boolean;
begin
  Result := inherited GetResizeOnBoundsChange or HasColumnAutoWidth or
    Preview.Active or IsMaster;
end;

function TcxGridTableView.GetTouchScrollUIOwner(const APoint: TPoint)
...
begin
  if InplaceEditForm.Visible and (InplaceEditForm.Container <> nil) and
    (InplaceEditForm.Container.ViewInfo <> nil) and
    (InplaceEditForm.Container.ViewInfo.RecordViewInfo <> nil) then
  begin
    Result := nil;
    AInplaceEditFormAreaViewInfo :=
      (InplaceEditForm.Container.ViewInfo.RecordViewInfo as
      TcxGridDataRowViewInfo).InplaceEditFormAreaViewInfo;
    if AInplaceEditFormAreaViewInfo <> nil then
      if GetHitTest(APoint) = AInplaceEditFormAreaViewInfo.GetHitTest(APoint)
      then
...
begin
  Result := not(Preview.Active and (Preview.AutoHeight or
    Assigned(Styles.OnGetPreviewStyle)));
end;

function TcxGridTableView.IsRecordHeightDependsOnData: Boolean;
begin
  Result := inherited IsRecordHeightDependsOnData or Preview.Active and
    Preview.AutoHeight;
end;
...
begin
  ...
  if (OptionsBehavior.EditMode = emModalEditForm) and
    (dceEdit in DataController.EditState) then
  begin
...
function TcxGridTableView.NeedChangeLayoutOnSelectionChanged
  (AInfo: TcxSelectionChangedInfo): Boolean;
begin
  Result := inherited NeedChangeLayoutOnSelectionChanged(AInfo) or
    (cbvColumnHeader in OptionsSelection.CheckBoxVisibility) or
    (cbvGroupRow in OptionsSelection.CheckBoxVisibility) and
    (dcoMultiSelectionSyncGroupWithChildren in DataController.Options);
end;
...
begin
  ...
  if Controller.InplaceEditForm.Visible then
    Controller.InplaceEditForm.ValuesChanged;
end;
...
begin
  ...
  if OptionsBehavior.EditMode in [emInplaceEditForm,
    emInplaceEditFormHideCurrentRow] then
...
begin
  ...
  ANeedUpdateInplaceEditForm := OptionsBehavior.EditMode
    in [emInplaceEditForm, emInplaceEditFormHideCurrentRow];
...
begin
  ...
  begin
    if dceInsert in DataController.EditState then
    begin
      ARecord := ViewData.GetRecordByRecordIndex
        (DataController.EditingRecordIndex);
      if ARecord <> nil then
        TcxGridDataRow(ARecord).EditFormVisible := True;
    end
    else if InplaceEditForm.Visible then
      InplaceEditForm.Close;
  end
  else if (AInfo is TcxDataChangedInfo) and
    (TcxDataChangedInfo(AInfo).Kind in [dcTotal, dcRecord]) and
    (DataController.EditState = []) and InplaceEditForm.Visible then
    InplaceEditForm.Close;
end;

function TcxGridTableView.UpdateOnDetailDataChange
...
function TcxGridTableView.GetBackgroundBitmapsClass
  : TcxCustomGridBackgroundBitmapsClass;
begin
  Result := TcxGridTableBackgroundBitmaps;
end;

function TcxGridTableView.GetDateTimeHandlingClass
...
function TcxGridTableView.GetFilterRowOptionsClass
  : TcxGridFilterRowOptionsClass;
begin
  Result := TcxGridFilterRowOptions;
end;

function TcxGridTableView.GetFixedDataRowsOptionsClass
  : TcxGridFixedDataRowsOptionsClass;
begin
  Result := TcxGridFixedDataRowsOptions;
end;

function TcxGridTableView.GetInplaceEditFormClass
  : TcxGridTableViewInplaceEditFormClass;
begin
...
function TcxGridTableView.GetNewItemRowOptionsClass
  : TcxGridNewItemRowOptionsClass;
begin
  Result := TcxGridNewItemRowOptions;
end;

function TcxGridTableView.GetOptionsBehaviorClass
  : TcxCustomGridOptionsBehaviorClass;
begin
  Result := TcxGridTableOptionsBehavior;
end;

function TcxGridTableView.GetOptionsCustomizeClass
...
function TcxGridTableView.GetOptionsSelectionClass
...
function TcxGridTableView.GetRowLayoutControllerClass
  : TcxGridTableRowLayoutControllerClass;
begin
...
function TcxGridTableView.GetSummaryGroupItemLinkClass
...
function TcxGridTableView.CalculateDataCellSelected
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
AUseViewInfo: Boolean; ACellViewInfo: TcxGridTableCellViewInfo): Boolean;
begin
  if Controller.CellMultiSelect and TcxCustomGridRow(ARecord).SupportsCellMultiSelect
  then
    ...
    Result := inherited CalculateDataCellSelected(ARecord, AItem, AUseViewInfo,
      ACellViewInfo);
end;
...
procedure TcxGridTableView.DoGetUnmergeableColumns(AColumn: TcxGridColumn;
AUnmergeableColumns: TList);
begin
...
begin
  ...
  begin
    AMasterRecordController :=
      MasterGridView.Controller as TcxGridTableController;
    AMasterRecordController.MakeVisibleDetailRecordBounds :=
      Controller.MakeVisibleDetailRecordBounds;
...
function TcxGridTableView.DoGroupRowCollapsing(AGroup: TcxGridGroupRow)
  : Boolean;
begin
  Result := True;
...
function TcxGridTableView.MasterRowDblClickAction
...
begin
  Result := inherited IsEqualHeightRecords and
    ...
    IsPreviewHeightFixed and (GroupedColumnCount = 0) and not IsMaster and
...
class function TcxGridColumnAccess.CanCellMerging
  (AInstance: TcxGridColumn): Boolean;
begin
  Result := AInstance.CanCellMerging;
end;

class function TcxGridColumnAccess.CanSearchInGroupRows
  (AInstance: TcxGridColumn): Boolean;
begin
  Result := AInstance.CanSearchInGroupRows;
end;

class procedure TcxGridColumnAccess.DoCustomDrawGroupSummaryCell
  (AInstance: TcxGridColumn; ACanvas: TcxCanvas;
AViewInfo: TcxCustomGridViewCellViewInfo; var ADone: Boolean);
begin
  AInstance.DoCustomDrawGroupSummaryCell(ACanvas, AViewInfo, ADone);
end;

class function TcxGridColumnAccess.HasCustomDrawGroupSummaryCell
  (AInstance: TcxGridColumn): Boolean;
begin
  Result := AInstance.HasCustomDrawGroupSummaryCell;
end;

class function TcxGridColumnAccess.GetImageComboBoxProperties
  (AInstance: TcxGridColumn): TcxImageComboBoxProperties;
begin
  Result := AInstance.GetImageComboBoxProperties;
end;

class function TcxGridColumnAccess.ShowGroupValuesWithImages
  (AInstance: TcxGridColumn): Boolean;
begin
...
class procedure TcxGridTableViewAccess.DoColumnPosChanged
  (AInstance: TcxGridTableView; AColumn: TcxGridColumn);
begin
  AInstance.DoColumnPosChanged(AColumn);
end;

class procedure TcxGridTableViewAccess.DoCustomDrawGroupCell
  (AInstance: TcxGridTableView; ACanvas: TcxCanvas;
AViewInfo: TcxGridTableCellViewInfo; var ADone: Boolean);
begin
  AInstance.DoCustomDrawGroupCell(ACanvas, AViewInfo, ADone);
end;

class procedure TcxGridTableViewAccess.DoCustomDrawGroupSummaryCell
  (AInstance: TcxGridTableView; ACanvas: TcxCanvas;
AViewInfo: TcxCustomGridViewCellViewInfo; var ADone: Boolean);
begin
  AInstance.DoCustomDrawGroupSummaryCell(ACanvas, AViewInfo, ADone);
...
class function TcxGridTableViewAccess.GetFilterRowOperatorMenu
  (AInstance: TcxGridTableView): TcxFilterDropDownMenu;
begin
  Result := AInstance.Controller.FilterRowOperatorMenu;
end;

class function TcxGridTableViewAccess.GetInplaceEditForm
  (AInstance: TcxGridTableView): TcxGridTableViewInplaceEditForm;
begin
  Result := AInstance.InplaceEditForm;
end;

class function TcxGridTableViewAccess.GetRowLayoutController
  (AInstance: TcxGridTableView): TcxGridRowLayoutController;
begin
  Result := AInstance.RowLayoutController;
end;

class function TcxGridTableViewAccess.HasCustomDrawGroupCell
  (AInstance: TcxGridTableView): Boolean;
begin
  Result := AInstance.HasCustomDrawGroupCell;
end;

class function TcxGridTableViewAccess.HasCustomDrawGroupSummaryCell
  (AInstance: TcxGridTableView): Boolean;
begin
  Result := AInstance.HasCustomDrawGroupSummaryCell;
end;

class function TcxGridTableViewAccess.IsMultiSelectPersistent
  (AInstance: TcxGridTableView): Boolean;
begin
