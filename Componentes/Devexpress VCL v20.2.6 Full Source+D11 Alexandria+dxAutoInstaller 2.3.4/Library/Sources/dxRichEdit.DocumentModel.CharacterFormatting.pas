...
type
  ...
  public const
    MaskUseAll = [TdxUsedCharacterFormattingOption.UseFontName,
  ...
  private
    ...
    function GetValue(const AOption: TdxUsedCharacterFormattingOption)
      : Boolean; inline;
    procedure SetCoreValue(const Value: TdxUsedCharacterFormattingOptions);
    class function GetEmptyCharacterFormattingOption
      : TdxCharacterFormattingOptions; static;
    class function GetRootCharacterFormattingOption
      : TdxCharacterFormattingOptions; static;
  public
    ...
    class property EmptyCharacterFormattingOption: TdxCharacterFormattingOptions
      read GetEmptyCharacterFormattingOption;
    class property RootCharacterFormattingOption: TdxCharacterFormattingOptions
      read GetRootCharacterFormattingOption;
    ...
    procedure SetValue(const AOption: TdxUsedCharacterFormattingOption;
      const Value: Boolean);

    property Value: TdxUsedCharacterFormattingOptions read FValue
      write SetCoreValue;
    property UseFontName: Boolean index TdxUsedCharacterFormattingOption.
      UseFontName read GetValue write SetValue;
    property UseDoubleFontSize: Boolean index TdxUsedCharacterFormattingOption.
      UseDoubleFontSize read GetValue write SetValue;
    property UseFontBold: Boolean index TdxUsedCharacterFormattingOption.
      UseFontBold read GetValue write SetValue;
    property UseFontItalic: Boolean index TdxUsedCharacterFormattingOption.
      UseFontItalic read GetValue write SetValue;
    property UseFontStrikeoutType: Boolean
      index TdxUsedCharacterFormattingOption.UseFontStrikeoutType read GetValue
      write SetValue;
    property UseFontUnderlineType: Boolean
      index TdxUsedCharacterFormattingOption.UseFontUnderlineType read GetValue
      write SetValue;
    property UseAllCaps: Boolean index TdxUsedCharacterFormattingOption.
      UseAllCaps read GetValue write SetValue;
    property UseForeColor: Boolean index TdxUsedCharacterFormattingOption.
      UseForeColor read GetValue write SetValue;
    property UseBackColor: Boolean index TdxUsedCharacterFormattingOption.
      UseBackColor read GetValue write SetValue;
    property UseUnderlineColor: Boolean index TdxUsedCharacterFormattingOption.
      UseUnderlineColor read GetValue write SetValue;
    property UseStrikeoutColor: Boolean index TdxUsedCharacterFormattingOption.
      UseStrikeoutColor read GetValue write SetValue;
    property UseUnderlineWordsOnly: Boolean
      index TdxUsedCharacterFormattingOption.UseUnderlineWordsOnly read GetValue
      write SetValue;
    property UseStrikeoutWordsOnly: Boolean
      index TdxUsedCharacterFormattingOption.UseStrikeoutWordsOnly read GetValue
      write SetValue;
    property UseScript: Boolean index TdxUsedCharacterFormattingOption.UseScript
      read GetValue write SetValue;
    property UseHidden: Boolean index TdxUsedCharacterFormattingOption.UseHidden
      read GetValue write SetValue;
    property UseNoProof: Boolean index TdxUsedCharacterFormattingOption.
      UseNoProof read GetValue write SetValue;
  end;

  { TdxCharacterFormattingBase }

  TdxCharacterFormattingBase = class
    (TdxIndexBasedObjectB<TdxCharacterFormattingInfo,
    TdxCharacterFormattingOptions>, IdxCharacterProperties)
  private
    // IdxCharacterProperties
    function GetAllCaps: Boolean;
    function GetBackColor: TdxAlphaColor;
    ...
    procedure SetAllCaps(const Value: Boolean);
    procedure SetAllCapsCore(const AInfo: TdxCharacterFormattingInfo;
      const AValue: Boolean);
    procedure SetBackColor(const Value: TdxAlphaColor);
    procedure SetBackColorCore(const AInfo: TdxCharacterFormattingInfo;
      const AValue: TdxAlphaColor);
    procedure SetDoubleFontSize(const Value: Integer);
    procedure SetDoubleFontSizeCore(const AInfo: TdxCharacterFormattingInfo;
      const AValue: Integer);
    procedure SetFontBold(const Value: Boolean);
    procedure SetFontBoldCore(const AInfo: TdxCharacterFormattingInfo;
      const AValue: Boolean);
    procedure SetForeColor(const Value: TdxAlphaColor);
    procedure SetForeColorCore(const AInfo: TdxCharacterFormattingInfo;
      const AValue: TdxAlphaColor);
    procedure SetFontItalic(const Value: Boolean);
    procedure SetFontItalicCore(const AInfo: TdxCharacterFormattingInfo;
      const AValue: Boolean);
    procedure SetFontName(const Value: string);
    procedure SetFontNameCore(const AInfo: TdxCharacterFormattingInfo;
      const AValue: string);
    procedure SetFontUnderlineType(const Value: TdxUnderlineType);
    procedure SetFontUnderlineTypeCore(const AInfo: TdxCharacterFormattingInfo;
      const AValue: TdxUnderlineType);
    procedure SetFontStrikeoutType(const Value: TdxStrikeoutType);
    procedure SetFontStrikeoutTypeCore(const AInfo: TdxCharacterFormattingInfo;
      const AValue: TdxStrikeoutType);
    procedure SetHidden(const Value: Boolean);
    procedure SetHiddenCore(const AInfo: TdxCharacterFormattingInfo;
      const AValue: Boolean);
    procedure SetNoProof(const Value: Boolean);
    procedure SetNoProofCore(const AInfo: TdxCharacterFormattingInfo;
      const Value: Boolean);
    procedure SetScript(const Value: TdxCharacterFormattingScript);
    procedure SetScriptCore(const AInfo: TdxCharacterFormattingInfo;
      const AValue: TdxCharacterFormattingScript);
    procedure SetStrikeoutColor(const Value: TdxAlphaColor);
    procedure SetStrikeoutColorCore(const AInfo: TdxCharacterFormattingInfo;
      const AValue: TdxAlphaColor);
    procedure SetStrikeoutWordsOnly(const Value: Boolean);
    procedure SetStrikeoutWordsOnlyCore(const AInfo: TdxCharacterFormattingInfo;
      const AValue: Boolean);
    procedure SetUnderlineColor(const Value: TdxAlphaColor);
    procedure SetUnderlineColorCore(const AInfo: TdxCharacterFormattingInfo;
      const AValue: TdxAlphaColor);
    procedure SetUnderlineWordsOnly(const Value: Boolean);
    procedure SetUnderlineWordsOnlyCore(const AInfo: TdxCharacterFormattingInfo;
      const AValue: Boolean);
  protected
    function CloneCore: TdxCharacterFormattingBase; virtual;
    function PropertyEquals(const AOther
      : TdxIndexBasedObject<TdxCharacterFormattingInfo,
      TdxCharacterFormattingOptions>): Boolean; override;
  ...
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      ...
      const AFormattingInfo: TdxCharacterFormattingInfo;
      const AFormattingOptions: TdxCharacterFormattingOptions); reintroduce;

    procedure CopyFrom(Source: TdxCloneable); overload; override;
    procedure CopyFrom(const AInfo: TdxCharacterFormattingInfo;
      const AOptions: TdxCharacterFormattingOptions); reintroduce; overload;
  ...
  TdxCharacterProperties = class
    (TdxRichEditIndexBasedObject<TdxCharacterFormattingBase>,
    IdxCharacterProperties)
  private
  ...
  strict protected
    ...
    function GetUnderlineWordsOnly: Boolean;
    procedure SetAllCaps(const Value: Boolean);
    function SetAllCapsCore(const AInfo: TdxCharacterFormattingBase;
      const Value: Boolean): TdxDocumentModelChangeActions;
    procedure SetBackColor(const Value: TdxAlphaColor);
    function SetBackColorCore(const AInfo: TdxCharacterFormattingBase;
      const Value: TdxAlphaColor): TdxDocumentModelChangeActions;
    procedure SetDoubleFontSize(const Value: Integer);
    function SetDoubleFontSizeCore(const AInfo: TdxCharacterFormattingBase;
      const Value: Integer): TdxDocumentModelChangeActions;
    procedure SetFontBold(const Value: Boolean);
    function SetFontBoldCore(const AInfo: TdxCharacterFormattingBase;
      const Value: Boolean): TdxDocumentModelChangeActions;
    procedure SetFontItalic(const Value: Boolean);
    function SetFontItalicCore(const AInfo: TdxCharacterFormattingBase;
      const Value: Boolean): TdxDocumentModelChangeActions;
    procedure SetFontName(const Value: string);
    function SetFontNameCore(const AInfo: TdxCharacterFormattingBase;
      const Value: string): TdxDocumentModelChangeActions;
    procedure SetFontStrikeoutType(const Value: TdxStrikeoutType);
    function SetFontStrikeoutTypeCore(const AInfo: TdxCharacterFormattingBase;
      const Value: Integer): TdxDocumentModelChangeActions;
    procedure SetFontUnderlineType(const Value: TdxUnderlineType);
    function SetFontUnderlineTypeCore(const AInfo: TdxCharacterFormattingBase;
      const Value: Integer): TdxDocumentModelChangeActions;
    procedure SetForeColor(const Value: TdxAlphaColor);
    function SetForeColorCore(const AInfo: TdxCharacterFormattingBase;
      const Value: TdxAlphaColor): TdxDocumentModelChangeActions;
    procedure SetHidden(const Value: Boolean);
    function SetHiddenCore(const AInfo: TdxCharacterFormattingBase;
      const Value: Boolean): TdxDocumentModelChangeActions;
    procedure SetScript(const Value: TdxCharacterFormattingScript);
    function SetScriptCore(const AInfo: TdxCharacterFormattingBase;
      const Value: Integer): TdxDocumentModelChangeActions;
    procedure SetStrikeoutColor(const Value: TdxAlphaColor);
    function SetStrikeoutColorCore(const AInfo: TdxCharacterFormattingBase;
      const Value: TdxAlphaColor): TdxDocumentModelChangeActions;
    procedure SetStrikeoutWordsOnly(const Value: Boolean);
    function SetStrikeoutWordsOnlyCore(const AInfo: TdxCharacterFormattingBase;
      const Value: Boolean): TdxDocumentModelChangeActions;
    procedure SetUnderlineColor(const Value: TdxAlphaColor);
    function SetUnderlineColorCore(const AInfo: TdxCharacterFormattingBase;
      const Value: TdxAlphaColor): TdxDocumentModelChangeActions;
    procedure SetUnderlineWordsOnly(const Value: Boolean);
    function SetUnderlineWordsOnlyCore(const AInfo: TdxCharacterFormattingBase;
      const Value: Boolean): TdxDocumentModelChangeActions;
    procedure SetNoProof(const Value: Boolean);
    function SetNoProofCore(const AInfo: TdxCharacterFormattingBase;
      const AValue: Boolean): TdxDocumentModelChangeActions;
    function GetUseNoProof: Boolean;

    procedure CopyFrom(const ACharacterProperties
      : TdxMergedProperties<TdxCharacterFormattingInfo,
      TdxCharacterFormattingOptions>); overload;
    ...
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxCharacterFormattingBase>; override;
  ...
  public
    constructor Create(const AOwner: IdxCharacterPropertiesContainer);
      reintroduce;

    class procedure ApplyPropertiesDiff(ATarget: TdxCharacterProperties;
      ATargetMergedInfo, ASourceMergedInfo: TdxCharacterFormattingInfo);
    procedure CopyFrom(const AProperties
      : TdxMergedCharacterProperties); overload;
{$IFNDEF DELPHI17}
    procedure CopyFrom(const Source
      : TdxUndoableIndexBasedObject<TdxCharacterFormattingBase>);
      override; final;
    procedure CopyFrom(const Source: TdxCharacterFormattingBase);
      override; final;
{$ENDIF}
    procedure Merge(const AProperties: TdxCharacterProperties);
    procedure Reset;
    procedure ResetAllUse;
    procedure ResetUse(const AResetOption: TdxUsedCharacterFormattingOption);
      overload;
    procedure ResetUse(const AResetOptions
      : TdxUsedCharacterFormattingOptions); overload;
  ...
  TdxMergedCharacterProperties = class
    ...
    TdxCharacterFormattingOptions>)
  protected
    procedure MergeCore(const AInfo: TdxCharacterFormattingInfo;
      const AOptions: TdxCharacterFormattingOptions);
  public
    constructor Create(const AProperties: TdxCharacterProperties);
      reintroduce; overload;
    constructor Create(const AProperties: TdxMergedCharacterProperties);
      reintroduce; overload;
  ...
  TdxCharacterFormattingInfoCache = class
    (TdxUniqueItemsCache<TdxCharacterFormattingInfo>) // for internal use
  public const
    DefaultItemIndex = 0;
  public
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxCharacterFormattingInfo; override;
  end;

  { TdxCharacterFormattingCache }

  TdxCharacterFormattingCache = class
    (TdxUniqueItemsCache<TdxCharacterFormattingBase>) // for internal use
  public const
  ...
  public
    ...
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxCharacterFormattingBase; override;
  end;
  ...
  public
    class procedure AssignFont(const ACharacterProperties
      : IdxCharacterProperties; AFont: TFont); static;
  end;
  ...
  TdxCharacterFormattingChangeActionsCalculator = class sealed
  // for internal use
  public
  ...
  private
    procedure SetMergedCharacterProperties(const Value
      : TdxMergedCharacterProperties);
  public
    ...
    property MergedCharacterProperties: TdxMergedCharacterProperties
      read FMergedCharacterProperties write SetMergedCharacterProperties;
  end;

  { TdxRunMergedCharacterPropertiesCachedResult }

  TdxRunMergedCharacterPropertiesCachedResult = class
    (TdxParagraphMergedCharacterPropertiesCachedResult) // for internal use
  strict private
  ...
  public
    ...
    property CharacterPropertiesIndex: Integer read FCharacterPropertiesIndex
      write FCharacterPropertiesIndex;
  end;
...
type
  ...
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      const ADocumentModel: TdxCustomDocumentModel;
      const AFormattingInfo: TdxCharacterFormattingInfo;
      const AFormattingOptions: TdxCharacterFormattingOptions);
    destructor Destroy; override;
  end;

constructor TdxDefaultCharacterFormattingBase.Create
...
function TdxDefaultCharacterFormattingBase.CloneCore
  : TdxCharacterFormattingBase;
begin
  Result := TdxCharacterFormattingBase.Create(PieceTable, DocumentModel,
    Info, Options);
end;
...
procedure TdxCharacterFormattingInfo.SetBooleanValue(AMask: Cardinal;
  AValue: Boolean);
begin
  if AValue then
...
class function TdxCharacterFormattingInfo.CreateDefaultItem
  : TdxCharacterFormattingInfo;
begin
  Result := TdxCharacterFormattingInfo.Create;
  Result.FontName := TdxRichEditControlCompatibility.DefaultFontName;
  Result.DoubleFontSize := TdxRichEditControlCompatibility.
    DefaultDoubleFontSize;
end;
...
begin
  Result := TdxCharacterFormattingScript
    ((FPackedValues and MaskCharacterFormattingScript) shr 7);
end;
...
procedure TdxCharacterFormattingInfo.SetFontStrikeoutType
  (const Value: TdxStrikeoutType);
begin
  FPackedValues := FPackedValues and not MaskStrikeoutType;
  FPackedValues := FPackedValues or
    ((Cardinal(Ord(Value)) shl 5) and MaskStrikeoutType);
end;

procedure TdxCharacterFormattingInfo.SetFontUnderlineType
  (const Value: TdxUnderlineType);
begin
  FPackedValues := FPackedValues and not MaskUnderlineType;
  FPackedValues := FPackedValues or
    (Cardinal(Ord(Value)) and MaskUnderlineType);
end;
...
procedure TdxCharacterFormattingInfo.SetScript(const Value
  : TdxCharacterFormattingScript);
begin
  FPackedValues := FPackedValues and not MaskCharacterFormattingScript;
  FPackedValues := FPackedValues or
    ((Cardinal(Ord(Value)) shl 7) and MaskCharacterFormattingScript);
end;

procedure TdxCharacterFormattingInfo.SetStrikeoutColor
  (const Value: TdxAlphaColor);
begin
  FStrikeoutColor := Value;
end;

procedure TdxCharacterFormattingInfo.SetStrikeoutWordsOnly
  (const Value: Boolean);
begin
  SetBooleanValue(MaskStrikeoutWordsOnly, Value);
end;

procedure TdxCharacterFormattingInfo.SetUnderlineColor
  (const Value: TdxAlphaColor);
begin
  FUnderlineColor := Value;
end;

procedure TdxCharacterFormattingInfo.SetUnderlineWordsOnly
  (const Value: Boolean);
begin
...
begin
  ...
  Result := (FPackedValues = AInfo.FPackedValues) and
    (FForeColor = AInfo.FForeColor) and (FBackColor = AInfo.FBackColor) and
    (FUnderlineColor = AInfo.FUnderlineColor) and
    (FStrikeoutColor = AInfo.FStrikeoutColor) and
    (CompareStringW(LOCALE_USER_DEFAULT, NORM_IGNORECASE, PChar(FFontName),
    Length(FFontName), PChar(AInfo.FFontName), Length(AInfo.FFontName))
    = CSTR_EQUAL);
end;
...
begin
  Result := Integer(FPackedValues xor (Cardinal(ForeColor) shl 8)
    xor (Cardinal(BackColor) shl 8) xor Cardinal(dxElfHash(PChar(FFontName),
    Length(FFontName), PChar(@ABuffer), 512)));

end;

{ TdxCharacterFormattingOptions }

constructor TdxCharacterFormattingOptions.Create(AUsedValues
  : TdxUsedCharacterFormattingOptions);
begin
  FValue := AUsedValues;
end;

procedure TdxCharacterFormattingOptions.CopyFrom(const Source
  : TdxCharacterFormattingOptions);
begin
...
class function TdxCharacterFormattingOptions.GetEmptyCharacterFormattingOption
  : TdxCharacterFormattingOptions;
begin
...
class function TdxCharacterFormattingOptions.GetRootCharacterFormattingOption
  : TdxCharacterFormattingOptions;
begin
  Result := TdxCharacterFormattingOptions.Create
...
class operator TdxCharacterFormattingOptions.Equal(const A,
  B: TdxCharacterFormattingOptions): Boolean;
begin
  Result := A.FValue = B.FValue;
end;

procedure TdxCharacterFormattingOptions.ResetUse
  (AOptions: TdxUsedCharacterFormattingOptions);
begin
  FValue := FValue - AOptions;
end;

function TdxCharacterFormattingOptions.GetValue(const AOption
  : TdxUsedCharacterFormattingOption): Boolean;
begin
...
procedure TdxCharacterFormattingOptions.SetCoreValue
  (const Value: TdxUsedCharacterFormattingOptions);
begin
  FValue := Value;
end;

procedure TdxCharacterFormattingOptions.SetValue(const AOption
  : TdxUsedCharacterFormattingOption; const Value: Boolean);
begin
  if Value then
...
constructor TdxCharacterFormattingBase.Create(APieceTable: TdxCustomPieceTable;
  const ADocumentModel: TdxCustomDocumentModel;
  const AFormattingInfo: TdxCharacterFormattingInfo;
  const AFormattingOptions: TdxCharacterFormattingOptions);
begin
...
procedure TdxCharacterFormattingBase.ResetUse(AResetOptions
  : TdxUsedCharacterFormattingOptions);
var
...
procedure TdxCharacterFormattingBase.CopyFrom(const AInfo
...
function TdxCharacterFormattingBase.PropertyEquals(const AOther
  : TdxIndexBasedObject<TdxCharacterFormattingInfo,
  TdxCharacterFormattingOptions>): Boolean;
begin
...
procedure TdxCharacterFormattingBase.SetAllCapsCore
  (const AInfo: TdxCharacterFormattingInfo; const AValue: Boolean);
begin
...
begin
  if not SupportsFormatting or (Info.AllCaps = Value) and Options.UseAllCaps
  then
    Exit;
...
procedure TdxCharacterFormattingBase.SetBackColorCore
  (const AInfo: TdxCharacterFormattingInfo; const AValue: TdxAlphaColor);
begin
...
procedure TdxCharacterFormattingBase.SetDoubleFontSizeCore
  (const AInfo: TdxCharacterFormattingInfo; const AValue: Integer);
begin
...
begin
  if not SupportsFormatting or (Info.DoubleFontSize = Value) and Options.UseDoubleFontSize
  then
    Exit;
...
procedure TdxCharacterFormattingBase.SetFontBoldCore
  (const AInfo: TdxCharacterFormattingInfo; const AValue: Boolean);
begin
...
begin
  if not SupportsFormatting or (Info.FontBold = Value) and Options.UseFontBold
  then
    Exit;
...
procedure TdxCharacterFormattingBase.SetForeColorCore
  (const AInfo: TdxCharacterFormattingInfo; const AValue: TdxAlphaColor);
begin
...
begin
  if not SupportsFormatting or (Info.ForeColor = Value) and Options.UseForeColor
  then
    Exit;
...
procedure TdxCharacterFormattingBase.SetFontItalicCore
  (const AInfo: TdxCharacterFormattingInfo; const AValue: Boolean);
begin
...
begin
  if not SupportsFormatting or (Info.FontItalic = Value) and Options.UseFontItalic
  then
    Exit;
...
procedure TdxCharacterFormattingBase.SetFontNameCore
  (const AInfo: TdxCharacterFormattingInfo; const AValue: string);
begin
...
begin
  if not SupportsFormatting or Options.UseFontName and (Info.FontName = Value)
  then
    Exit;
...
procedure TdxCharacterFormattingBase.SetFontUnderlineTypeCore
  (const AInfo: TdxCharacterFormattingInfo; const AValue: TdxUnderlineType);
begin
  AInfo.FontUnderlineType := AValue;
end;

procedure TdxCharacterFormattingBase.SetFontUnderlineType
  (const Value: TdxUnderlineType);
begin
  if not SupportsFormatting or (Info.FontUnderlineType = Value) and Options.UseFontUnderlineType
  then
    Exit;
...
procedure TdxCharacterFormattingBase.SetFontStrikeoutTypeCore
  (const AInfo: TdxCharacterFormattingInfo; const AValue: TdxStrikeoutType);
begin
  AInfo.FontStrikeoutType := AValue;
end;

procedure TdxCharacterFormattingBase.SetFontStrikeoutType
  (const Value: TdxStrikeoutType);
begin
  if not SupportsFormatting or (Info.FontStrikeoutType = Value) and Options.UseFontStrikeoutType
  then
    Exit;
...
procedure TdxCharacterFormattingBase.SetHiddenCore
  (const AInfo: TdxCharacterFormattingInfo; const AValue: Boolean);
begin
  AInfo.Hidden := AValue;
end;
...
procedure TdxCharacterFormattingBase.SetNoProofCore
  (const AInfo: TdxCharacterFormattingInfo; const Value: Boolean);
begin
  AInfo.NoProof := Value;
end;
...
begin
  if not SupportsFormatting or (Info.NoProof = Value) and Options.UseNoProof
  then
    Exit;
...
procedure TdxCharacterFormattingBase.SetScriptCore
  (const AInfo: TdxCharacterFormattingInfo;
  const AValue: TdxCharacterFormattingScript);
begin
  AInfo.Script := AValue;
end;

procedure TdxCharacterFormattingBase.SetScript(const Value
  : TdxCharacterFormattingScript);
begin
...
procedure TdxCharacterFormattingBase.SetStrikeoutColorCore
  (const AInfo: TdxCharacterFormattingInfo; const AValue: TdxAlphaColor);
begin
  AInfo.StrikeoutColor := AValue;
end;

procedure TdxCharacterFormattingBase.SetStrikeoutColor
  (const Value: TdxAlphaColor);
begin
  if not SupportsFormatting or (Info.StrikeoutColor = Value) and Options.UseStrikeoutColor
  then
    Exit;
...
procedure TdxCharacterFormattingBase.SetStrikeoutWordsOnlyCore
  (const AInfo: TdxCharacterFormattingInfo; const AValue: Boolean);
begin
  AInfo.StrikeoutWordsOnly := AValue;
end;

procedure TdxCharacterFormattingBase.SetStrikeoutWordsOnly
  (const Value: Boolean);
begin
  if not SupportsFormatting or (Info.StrikeoutWordsOnly = Value) and Options.UseStrikeoutWordsOnly
  then
    Exit;
...
procedure TdxCharacterFormattingBase.SetUnderlineColorCore
  (const AInfo: TdxCharacterFormattingInfo; const AValue: TdxAlphaColor);
begin
  AInfo.UnderlineColor := AValue;
end;

procedure TdxCharacterFormattingBase.SetUnderlineColor
  (const Value: TdxAlphaColor);
begin
  if not SupportsFormatting or (Info.UnderlineColor = Value) and Options.UseUnderlineColor
  then
    Exit;
...
procedure TdxCharacterFormattingBase.SetUnderlineWordsOnlyCore
  (const AInfo: TdxCharacterFormattingInfo; const AValue: Boolean);
begin
  AInfo.UnderlineWordsOnly := AValue;
end;

procedure TdxCharacterFormattingBase.SetUnderlineWordsOnly
  (const Value: Boolean);
begin
  if not SupportsFormatting or (Info.UnderlineWordsOnly = Value) and Options.UseUnderlineWordsOnly
  then
    Exit;
...
constructor TdxCharacterProperties.Create(const AOwner
...
class procedure TdxCharacterProperties.ApplyPropertiesDiff
  (ATarget: TdxCharacterProperties; ATargetMergedInfo, ASourceMergedInfo
  : TdxCharacterFormattingInfo);
begin
  ...
  if ATargetMergedInfo.FontStrikeoutType <> ASourceMergedInfo.FontStrikeoutType
  then
    ATarget.FontStrikeoutType := ASourceMergedInfo.FontStrikeoutType;

  if ATargetMergedInfo.FontUnderlineType <> ASourceMergedInfo.FontUnderlineType
  then
  ...
  if ATargetMergedInfo.StrikeoutWordsOnly <> ASourceMergedInfo.StrikeoutWordsOnly
  then
  ...
  if ATargetMergedInfo.UnderlineWordsOnly <> ASourceMergedInfo.UnderlineWordsOnly
  then
...
procedure TdxCharacterProperties.CopyFrom(const AProperties
  : TdxMergedCharacterProperties);
var
...
procedure TdxCharacterProperties.CopyFrom(const Source
  : TdxUndoableIndexBasedObject<TdxCharacterFormattingBase>);
begin
...
procedure TdxCharacterProperties.Merge(const AProperties
  : TdxCharacterProperties);
var
...
begin
  ...
  AEmptyInfo := GetCache(DocumentModel)
    [TdxCharacterFormattingCache.EmptyCharacterFormattingIndex];
...
begin
  ...
  AInfo.ReplaceInfo(AFormattingInfo,
...
procedure TdxCharacterProperties.ResetUse(const AResetOption
  : TdxUsedCharacterFormattingOption);
begin
  ResetUse([AResetOption]);
end;

procedure TdxCharacterProperties.ResetUse(const AResetOptions
  : TdxUsedCharacterFormattingOptions);
var
  AInfo: TdxCharacterFormattingBase;
  AOptions: TdxCharacterFormattingOptions;
...
function TdxCharacterProperties.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.BatchUpdate);
end;

function TdxCharacterProperties.GetObtainAffectedRangeListener
...
procedure TdxCharacterProperties.CopyFrom(const ACharacterProperties
  : TdxMergedProperties<TdxCharacterFormattingInfo,
  TdxCharacterFormattingOptions>);
var
  AInfo: TdxCharacterFormattingBase;
...
function TdxCharacterProperties.CreateIndexChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
  Result := FOwner.CreateCharacterPropertiesChangedHistoryItem;
end;

function TdxCharacterProperties.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxCharacterFormattingBase>;
begin
  Result := TdxSimpleDocumentCache(ADocumentModel.Cache)
    .CharacterFormattingCache;
end;
...
function TdxCharacterProperties.SetAllCapsCore(const AInfo
  : TdxCharacterFormattingBase; const Value: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.AllCaps := Value;
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.AllCaps);
end;

function TdxCharacterProperties.SetBackColorCore(const AInfo
  : TdxCharacterFormattingBase; const Value: TdxAlphaColor)
  : TdxDocumentModelChangeActions;
begin
  AInfo.BackColor := Value;
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.BackColor);
end;
...
function TdxCharacterProperties.SetFontBoldCore(const AInfo
  : TdxCharacterFormattingBase; const Value: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.FontBold := Value;
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.FontBold);
end;
...
function TdxCharacterProperties.SetFontItalicCore
  (const AInfo: TdxCharacterFormattingBase; const Value: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.FontItalic := Value;
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.FontItalic);
end;
...
function TdxCharacterProperties.SetFontNameCore(const AInfo
  : TdxCharacterFormattingBase; const Value: string)
  : TdxDocumentModelChangeActions;
begin
  AInfo.FontName := Value;
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.FontName);
end;
...
function TdxCharacterProperties.SetDoubleFontSizeCore
  (const AInfo: TdxCharacterFormattingBase; const Value: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.DoubleFontSize := Value;
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.FontSize);
end;

procedure TdxCharacterProperties.SetFontStrikeoutType
  (const Value: TdxStrikeoutType);
begin
  SetPropertyValue<Integer>(SetFontStrikeoutTypeCore, Ord(Value));
end;

function TdxCharacterProperties.SetFontStrikeoutTypeCore
  (const AInfo: TdxCharacterFormattingBase; const Value: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.FontStrikeoutType := TdxStrikeoutType(Value);
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.FontStrikeoutType);
end;

procedure TdxCharacterProperties.SetFontUnderlineType
  (const Value: TdxUnderlineType);
begin
  SetPropertyValue<Integer>(SetFontUnderlineTypeCore, Ord(Value));
end;

function TdxCharacterProperties.SetFontUnderlineTypeCore
  (const AInfo: TdxCharacterFormattingBase; const Value: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.FontUnderlineType := TdxUnderlineType(Value);
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.FontUnderlineType);
end;

function TdxCharacterProperties.SetForeColorCore(const AInfo
  : TdxCharacterFormattingBase; const Value: TdxAlphaColor)
  : TdxDocumentModelChangeActions;
begin
  AInfo.ForeColor := Value;
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.ForeColor);
end;

procedure TdxCharacterProperties.SetForeColor(const Value: TdxAlphaColor);
begin
  if not IsUpdateLocked and Info.Options.UseForeColor and
    (Info.Info.ForeColor = Value) then
    Exit;
...
function TdxCharacterProperties.SetHiddenCore(const AInfo
  : TdxCharacterFormattingBase; const Value: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.Hidden := Value;
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.Hidden);
end;
...
function TdxCharacterProperties.SetNoProofCore(const AInfo
  : TdxCharacterFormattingBase; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.NoProof := AValue;
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.NoProof);
end;

procedure TdxCharacterProperties.SetScript(const Value
  : TdxCharacterFormattingScript);
begin
  SetPropertyValue<Integer>(SetScriptCore, Ord(Value));
end;

function TdxCharacterProperties.SetScriptCore(const AInfo
  : TdxCharacterFormattingBase; const Value: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.Script := TdxCharacterFormattingScript(Value);
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.Script);
end;

function TdxCharacterProperties.SetStrikeoutColorCore
  (const AInfo: TdxCharacterFormattingBase; const Value: TdxAlphaColor)
  : TdxDocumentModelChangeActions;
begin
  AInfo.StrikeoutColor := Value;
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.StrikeoutColor);
end;
...
function TdxCharacterProperties.SetStrikeoutWordsOnlyCore
  (const AInfo: TdxCharacterFormattingBase; const Value: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.StrikeoutWordsOnly := Value;
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.StrikeoutWordsOnly);
end;

function TdxCharacterProperties.SetUnderlineColorCore
  (const AInfo: TdxCharacterFormattingBase; const Value: TdxAlphaColor)
  : TdxDocumentModelChangeActions;
begin
  AInfo.UnderlineColor := Value;
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.UnderlineColor);
end;
...
function TdxCharacterProperties.SetUnderlineWordsOnlyCore
  (const AInfo: TdxCharacterFormattingBase; const Value: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.UnderlineWordsOnly := Value;
  Result := TdxCharacterFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxCharacterFormattingChangeType.UnderlineWordsOnly);
end;

function TdxCharacterProperties.UseVal
  (AMask: TdxUsedCharacterFormattingOption): Boolean;
begin
...
constructor TdxMergedCharacterProperties.Create(const AProperties
  : TdxMergedCharacterProperties);
begin
...
procedure TdxMergedCharacterProperties.Merge(const AProperties
  : TdxCharacterProperties);
var
  AInfo: TdxCharacterFormattingBase;
begin
...
procedure TdxMergedCharacterProperties.MergeCore(const AInfo
  : TdxCharacterFormattingInfo; const AOptions: TdxCharacterFormattingOptions);
begin
...
function TdxCharacterFormattingInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxCharacterFormattingInfo;
begin
...
constructor TdxCharacterFormattingCache.Create(const ADocumentModel
...
begin
  ...
  ADefaultCharacterFormattingInfo := TdxSimpleDocumentCache
    (ADocumentModel.Cache).CharacterFormattingInfoCache.DefaultItem;
  AppendItem(TdxDefaultCharacterFormattingBase.Create(DocumentModel.MainPart,
    DocumentModel, ADefaultCharacterFormattingInfo,
    TdxCharacterFormattingOptions.EmptyCharacterFormattingOption));
  AppendItem(TdxDefaultCharacterFormattingBase.Create(DocumentModel.MainPart,
    DocumentModel, ADefaultCharacterFormattingInfo,
...
function TdxCharacterFormattingCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxCharacterFormattingBase;
begin
  Result := nil;
end;
...
class function TdxCharacterFormattingChangeActionsCalculator.
  CalculateChangeActions(const AChange: TdxCharacterFormattingChangeType)
  : TdxDocumentModelChangeActions;
const
  CharacterFormattingChangeActionsMap: array [TdxCharacterFormattingChangeType]
...
class procedure TdxCharacterPropertiesFontAssignmentHelper.AssignFont
  (const ACharacterProperties: IdxCharacterProperties; AFont: TFont);
begin
...
procedure TdxParagraphMergedCharacterPropertiesCachedResult.
  SetMergedCharacterProperties(const Value: TdxMergedCharacterProperties);
begin
