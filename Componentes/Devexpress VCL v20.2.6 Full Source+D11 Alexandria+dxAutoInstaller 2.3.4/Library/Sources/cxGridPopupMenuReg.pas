...
uses
  DesignIntf, DesignEditors, Types, Windows, Classes, Messages, SysUtils,
  TypInfo, Dialogs,
  cxGridPopupMenu, cxGridCustomPopupMenu, dxCoreReg, cxGridReg,
  dxBuiltInPopupMenu, cxClasses;
...
procedure Register;
begin
  RegisterPropertyEditor(TypeInfo(TComponent), TcxPopupMenuInfo, 'PopupMenu',
    TcxGridPopupMenuProperty);
