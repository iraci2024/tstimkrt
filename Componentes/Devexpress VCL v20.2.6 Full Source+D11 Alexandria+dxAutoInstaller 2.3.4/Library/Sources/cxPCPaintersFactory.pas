...
uses
  Types, Classes, Controls, SysUtils, dxCore, cxClasses, cxLookAndFeels, cxPC,
  cxPCConsts;
...
type
  ...
  public
    ...
    function GetPainterClass(const StandardStyle: TcxPCStandardStyle)
      : TcxPCPainterClass; overload;
    function GetPainterClass(const StyleID: TcxPCStyleID)
      : TcxPCPainterClass; overload;
    function GetPainterClass(const StyleName: TCaption)
      : TcxPCPainterClass; overload;
    ...
    property PainterClasses[Index: Integer]: TcxPCPainterClass
      read InternalGetPainterClass;
...
function TcxPCPaintersFactory.GetDefaultStyleID(ALookAndFeel: TcxLookAndFeel)
  : TcxPCStyleID;
var
  I: Integer;
begin
  if PainterClassCount = 0 then
    OutError('GetDefaultStyleID',
      cxGetResourceString(@scxPCNoRegisteredStyles));
...
function TcxPCPaintersFactory.GetPainterClass(const StandardStyle
  : TcxPCStandardStyle): TcxPCPainterClass;
var
  I: Integer;
begin
...
function TcxPCPaintersFactory.GetPainterClass(const StyleID: TcxPCStyleID)
  : TcxPCPainterClass;
var
  I: Integer;
begin
  ...
  begin
    Result := PainterClasses[I];
    if Result.GetStyleID = StyleID then
      Exit;
  end;
  Result := nil;
end;

function TcxPCPaintersFactory.GetPainterClass(const StyleName: TCaption)
  : TcxPCPainterClass;
var
  I: Integer;
begin
...
function TcxPCPaintersFactory.GetStyleID(ALookAndFeel: TcxLookAndFeel)
  : TcxPCStyleID;
var
  I: Integer;
begin
...
function TcxPCPaintersFactory.InternalGetPainterClass(Index: Integer)
  : TcxPCPainterClass;
begin
  Result := TcxPCPainterClass(FPainterClassList.Items[Index]);
end;

class procedure TcxPCPaintersFactory.OutError(const SourceMethodName,
  Msg: string);
begin
  raise EdxException.Create('TcxPCPaintersFactory.' + SourceMethodName +
    ': ' + Msg);
end;

procedure TcxPCPaintersFactory.RegisterPCPainterClass(PCPainterClass
  : TcxPCPainterClass);
begin
...
procedure TcxPCPaintersFactory.UnregisterPCPainterClass(PCPainterClass
  : TcxPCPainterClass);
begin
