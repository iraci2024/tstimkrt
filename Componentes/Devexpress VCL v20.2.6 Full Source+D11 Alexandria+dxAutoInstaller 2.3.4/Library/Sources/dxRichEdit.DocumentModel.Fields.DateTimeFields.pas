...
type
  ...
  public
    ...
    procedure Initialize(APieceTable: TdxCustomPieceTable;
      ASwitches: TdxInstructionCollection); override;
...
procedure TdxDateField.Initialize(APieceTable: TdxCustomPieceTable;
...
function TdxDateField.GetCalculatedValueCore(ASourcePieceTable
...
var
  ...
  AResult: TDateTime;
begin
  ADateTimeService := TdxPieceTable(ASourcePieceTable)
    .DocumentModel.GetService<IdxDateTimeService>;
...
function TdxDateField.GetAllowedUpdateFieldTypes(const AOptions
...
function TdxTimeField.GetCalculatedValueCore(ASourcePieceTable
  : TdxCustomPieceTable; AMailMergeDataMode: TdxMailMergeDataMode;
  ADocumentField: TdxField): TdxCalculatedFieldValue;
begin
...
function TdxTimeField.GetAllowedUpdateFieldTypes(const AOptions
  : TdxFieldUpdateOnLoadOptions): TdxUpdateFieldOperationTypes;
begin
  Result := inherited GetAllowedUpdateFieldTypes(AOptions);
...
procedure TdxCreateDateField.Initialize(APieceTable: TdxCustomPieceTable;
...
function TdxCreateDateField.GetCalculatedValueCore(ASourcePieceTable
  : TdxCustomPieceTable; AMailMergeDataMode: TdxMailMergeDataMode;
  ADocumentField: TdxField): TdxCalculatedFieldValue;
begin
  Result := TdxCalculatedFieldValue.Create(TValue.From<TDateTime>(Now));
