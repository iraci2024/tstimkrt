...
type
  TdxSpreadSheetCellStyleEditDialogCapability = (csecNumber, csecAlignment,
    csecFont, csecBorder, csecFill, csecProtection);
  TdxSpreadSheetCellStyleEditDialogCapabilities = set of
  ...
  public
    ...
    procedure EnumCellStyles(AProcRef: TdxSpreadSheetCellStyleEnumProcRef;
      AEnumDefaultStyles: Boolean); virtual; abstract;
    function FormatFocusedCellValue(const AFormatCode: string)
      : TdxSpreadSheetNumberFormatResult; virtual;
    ...
    property Capabilities: TdxSpreadSheetCellStyleEditDialogCapabilities
      read FCapabilities;
  ...
  TdxSpreadSheetCellStyleEditDialogSingleStyleController = class
    (TdxSpreadSheetCellStyleEditDialogCustomController)
  strict private
  ...
  public
    constructor Create(ACellStyles: TdxSpreadSheetCellStyles;
...
function TdxSpreadSheetCellStyleEditDialogCustomController.
  FormatFocusedCellValue(const AFormatCode: string)
...
function TdxSpreadSheetCellStyleEditDialogCustomController.
  CanMergeAreas: Boolean;
begin
  Result := False;
end;

function TdxSpreadSheetCellStyleEditDialogCustomController.GetMergeAreasInfo
  : TcxCheckBoxState;
begin
  Result := cbsUnchecked;
end;
...
function TdxSpreadSheetCellStyleEditDialogCustomController.GetDefaultFont
  : TdxSpreadSheetFontHandle;
begin
  Result := CellStyles.DefaultStyle.Font;
end;

function TdxSpreadSheetCellStyleEditDialogCustomController.GetPredefinedFormats
...
function TdxSpreadSheetCellStyleEditDialogSingleStyleController.GetCellStyles
