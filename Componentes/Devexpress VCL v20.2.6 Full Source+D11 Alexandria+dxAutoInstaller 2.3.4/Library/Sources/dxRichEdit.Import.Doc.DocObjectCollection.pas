...
type
  TdxDocObjectType = (PictureFloatingObject, TextBoxFloatingObject, InlineImage,
    ImageCollection, AutoNumberedFootnoteReference, NoteNumber,
    AnnotationReference, EndnoteReference, FieldBegin, FieldSeparator, FieldEnd,
    HyperlinkFieldData, TextRun, TableCell, TableRow, Paragraph, Section,
    ExpectedFieldBegin, ExpectedFieldSeparator, ExpectedFieldEnd,
    UnsupportedObject);
  ...
  TdxDocObjectCollectionDictionary = class
    (TObjectDictionary<Integer, TdxDocObjectCollection>);
  ...
  protected
    ...
    function GetPosition: Integer;
  public
    constructor Create(const AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer); reintroduce;
      overload; virtual;
  ...
  public
    constructor Create(const AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer); override;
  ...
  TdxPictureDataFormat = (TiffFile = $0062, BmpFile = $0063,
    ShapeObject = $0064, ShapeFile = $0066);
  ...
  strict private
    class var FEmptyBorder: TdxBorderDescriptor97;
  ...
  protected
    ...
    procedure ReadCore(AReader: TBinaryReader; ASize: Integer;
      const AImageCreator: IdxDocOfficeImageCreator);
  ...
  public
    ...
    constructor Create(ARun: TdxInlinePictureRun; AShapeId: Integer;
      ABlipIndex: Integer); overload;
    destructor Destroy; override;
    class function FromStream(AReader: TBinaryReader; AOffset: Integer;
      const AImageCreator: IdxDocOfficeImageCreator)
      : TdxPictureDescriptor; static;
    ...
    property MetafileHeaders: TdxList<TdxDocMetafileHeader>
      read FMetafileHeaders;
  ...
  protected
    function GetDocObjectType: TdxDocObjectType; override;
  public
    constructor Create(var AObjectInfo: TdxDocObjectInfo;
  ...
  protected
    ...
    function GetHorizontalPositionAlignment
      (AMsoph: TdxDrawingGroupShapePosH.TMsoph)
      : TdxFloatingObjectHorizontalPositionAlignment;
    function GetHorizontalPositionType
      (AMsoprh: TdxDrawingGroupShapePosRelH.TMsoprh)
      : TdxFloatingObjectHorizontalPositionType;
    function GetVerticalPositionAlignment
      (AMsopv: TdxDrawingGroupShapePosV.TMsopv)
      : TdxFloatingObjectVerticalPositionAlignment;
    function GetVerticalPositionType
      (AMsoprv: TdxDrawingGroupShapePosRelV.TMsoprv)
      : TdxFloatingObjectVerticalPositionType;
    function GetRelativeFrom(ARelativeFrom
      : TdxDrawingGroupShape2SizeRelH.TRelativeFrom)
      : TdxFloatingObjectRelativeFromHorizontal; overload;
    function GetRelativeFrom(ARelativeFrom
      : TdxDrawingGroupShape2SizeRelV.TRelativeFrom)
      : TdxFloatingObjectRelativeFromVertical; overload;
    procedure SetOfficeArtPropertiesCore(AProperties: TdxOfficeArtProperties;
      AUnitConverter: TdxDocumentModelUnitConverter); virtual;
  ...
  public
    ...
    procedure SetOfficeArtProperties(AProperties
      : TdxOfficeArtProperties); virtual;
    procedure SetOfficeArtTertiaryProperties(AProperties
      : TdxOfficeArtTertiaryProperties); virtual;
    ...
    property WrapLeftDistance: Integer read FWrapLeftDistance
      write FWrapLeftDistance;
    property WrapRightDistance: Integer read FWrapRightDistance
      write FWrapRightDistance;
    property WrapTopDistance: Integer read FWrapTopDistance
      write FWrapTopDistance;
    property WrapBottomDistance: Integer read FWrapBottomDistance
      write FWrapBottomDistance;
  end;
  ...
  public
    constructor Create(var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer; ABlip: TdxBlipBase);
      overload;
    destructor Destroy; override;
  ...
  protected
    ...
    function GetApplyBorderByDefault: Boolean; override;
    procedure SetOfficeArtPropertiesCore(AProperties: TdxOfficeArtProperties;
      AUnitConverter: TdxDocumentModelUnitConverter); override;
  public
    constructor Create(var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer; AShapeId: Integer); overload;
    ...
    property UseFitShapeToText: Boolean read FUseFitShapeToText
      write FUseFitShapeToText;
  ...
  public
    constructor Create(APieceTable: TdxPieceTable;
      AFieldInfoStack: TdxObjectStack<TdxImportFieldInfo>);
    destructor Destroy; override;
    ...
    procedure ProcessFieldEnd(APosition: TdxInputPosition;
      APropertyContainer: TdxDocPropertyContainer); virtual;
    procedure ProcessHyperlinkData(AHyperlinkData
      : TdxDocHyperlinkFieldData); virtual;

    property ImportFieldStack: TdxObjectStack<TdxImportFieldInfo>
      read FFieldInfoStack;
  end;
  ...
  strict private
  const
    MapClassTable: array [TdxDocObjectType] of TdxDocObjectBaseClass = (nil,
    ...
    class var FInstance: TdxDocObjectFactory;
    class constructor Initialize;
    class destructor Finalize;
  strict private
  ...
  public
    destructor Destroy; override;
    function CreateDocObject(AObjectType: TdxDocObjectType;
...
constructor TdxDocObjectBase.Create(const AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
begin
...
constructor TdxDocTextRun.Create(const AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
begin
...
constructor TdxPictureDescriptor.Create(ARun: TdxInlinePictureRun;
  AShapeId: Integer; ABlipIndex: Integer);
var
...
begin
  ...
  FHorizontalScaleFactor := CalculateScaleFactor(AActualSize.cx,
    ASizeInTwips.cx);
  ...
  FInlineShapeContainer.Blips.Add
    (TdxFileBlipStoreEntry.Create(ARun.Image, False));
...
class function TdxPictureDescriptor.FromStream(AReader: TBinaryReader;
  AOffset: Integer; const AImageCreator: IdxDocOfficeImageCreator)
  : TdxPictureDescriptor;
begin
...
function TdxPictureDescriptor.CalculateScaleFactor(AFinalSize,
  AInitialSize: Integer): Word;
begin
...
begin
  ...
  begin
    FWidth := MaxImageSize;
    FHorizontalScaleFactor :=
      Trunc(ARun.ScaleX * (AImage.SizeInTwips.cx / MaxImageSize) * 10);
  end;
  ...
  begin
    ...
    FVerticalScaleFactor :=
      Trunc(ARun.ScaleY * (AImage.SizeInTwips.cy / MaxImageSize) * 10);
  end;
end;
...
function TdxPictureDescriptor.CheckReader(AReader: TBinaryReader;
...
procedure TdxPictureDescriptor.ReadCore(AReader: TBinaryReader; ASize: Integer;
  const AImageCreator: IdxDocOfficeImageCreator);
begin
  ...
  if (FDataFormat = TdxPictureDataFormat.ShapeFile) or
    (FDataFormat = TdxPictureDataFormat.ShapeObject) then
...
begin
  FInlineShapeContainer.Free;
  FInlineShapeContainer := TdxOfficeArtInlineShapeContainer.FromStream(AReader,
    ASize, AImageCreator);
...
procedure TdxPictureDescriptor.WritePictureDescriptorSize
  (AWriter: TBinaryWriter; AStart: Int64);
var
  ASize: Integer;
begin
...
constructor TdxDocImage.Create(var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer;
...
begin
  ...
  FScaleX :=
    Max(1, Round((ADescriptor.Width * ADescriptor.HorizontalScaleFactor) /
    (Image.SizeInTwips.cx * 10.0)));
  FScaleY := Max(1, Round((ADescriptor.Height * ADescriptor.VerticalScaleFactor)
    / (Image.SizeInTwips.cy * 10.0)));
...
constructor TdxDocImageCollection.Create(var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer;
  ADescriptor: TdxPictureDescriptor);
var
  I: Integer;
...
begin
  ...
  begin
    if ADescriptor.Images[I] = nil then
      Continue;
    AItem := TdxDocImage.Create(AObjectInfo, APropertyContainer,
      ADescriptor, I);
    Add(AItem);
  end;
end;
...
function TdxDocImageCollection.QueryInterface(const IID: TGUID;
  out Obj): HResult;
begin
...
constructor TdxDocFieldSeparator.Create(const AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
begin
  inherited Create(AObjectInfo, APropertyContainer);
  if APropertyContainer.CharacterInfo <> nil then
    FOleObject := APropertyContainer.CharacterInfo.EmbeddedObject or
      APropertyContainer.CharacterInfo.Ole2Object;
end;
...
constructor TdxExpectedDocObject.Create(const AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer);
begin
  inherited Create(AObjectInfo, APropertyContainer);
...
procedure TdxDocFloatingObjectBase.ApplyFileShapeAddress
...
begin
  ...
  AWidth := PropertyContainer.UnitConverter.TwipsToModelUnits
    (AAddress.Right) - X;
  AHeight := PropertyContainer.UnitConverter.TwipsToModelUnits
    (AAddress.Bottom) - Y;
...
procedure TdxDocFloatingObjectBase.SetOfficeArtProperties
...
procedure TdxDocFloatingObjectBase.SetOfficeArtTertiaryProperties
  (AProperties: TdxOfficeArtTertiaryProperties);
var
  AActualHorizPos, AActualVertPos: Integer;
  APt: TPoint;
begin
  if AProperties.UseRelativeWidth then
    Formatting.RelativeWidth := TdxFloatingObjectRelativeWidth.Create
      (GetRelativeFrom(AProperties.SizeRelH), AProperties.PctHoriz * 100);
  if AProperties.UseRelativeHeight then
    Formatting.RelativeHeight := TdxFloatingObjectRelativeHeight.Create
      (GetRelativeFrom(AProperties.SizeRelV), AProperties.PctVert * 100);
  AActualHorizPos := 0;
  AActualVertPos := 0;
  ...
  begin
    Formatting.HorizontalPositionAlignment := GetHorizontalPositionAlignment
      (AProperties.PosH);
    Formatting.HorizontalPositionType := GetHorizontalPositionType
      (AProperties.PosRelH);
  ...
  begin
    Formatting.VerticalPositionAlignment := GetVerticalPositionAlignment
      (AProperties.PosV);
    Formatting.VerticalPositionType := GetVerticalPositionType
      (AProperties.PosRelV);
    APt := Formatting.PercentOffset;
...
function TdxDocFloatingObjectBase.GetHorizontalPositionAlignment
  (AMsoph: TdxDrawingGroupShapePosH.TMsoph)
  : TdxFloatingObjectHorizontalPositionAlignment;
begin
  case AMsoph of
...
function TdxDocFloatingObjectBase.GetHorizontalPositionType
  (AMsoprh: TdxDrawingGroupShapePosRelH.TMsoprh)
  : TdxFloatingObjectHorizontalPositionType;
begin
  case AMsoprh of
...
function TdxDocFloatingObjectBase.GetVerticalPositionAlignment
  (AMsopv: TdxDrawingGroupShapePosV.TMsopv)
  : TdxFloatingObjectVerticalPositionAlignment;
begin
  case AMsopv of
...
function TdxDocFloatingObjectBase.GetVerticalPositionType
  (AMsoprv: TdxDrawingGroupShapePosRelV.TMsoprv)
  : TdxFloatingObjectVerticalPositionType;
begin
  case AMsoprv of
...
function TdxDocFloatingObjectBase.GetRelativeFrom(ARelativeFrom
  : TdxDrawingGroupShape2SizeRelH.TRelativeFrom)
...
procedure TdxDocFloatingObjectBase.SetOfficeArtPropertiesCore
  (AProperties: TdxOfficeArtProperties;
  AUnitConverter: TdxDocumentModelUnitConverter);
var
...
begin
  ...
  if ARotation <> 0 then
    Rotation := ARotation;
  if (ApplyBorderByDefault and not AProperties.UseLine) or
    (AProperties.UseLine and AProperties.Line) then
  begin
    LineWidth := AUnitConverter.EmuToModelUnits
      (TdxOfficeArtConstants.DefaultLineWidthInEmus);
  ...
  Formatting.LeftDistance := AUnitConverter.EmuToModelUnits
    (Trunc(IfThen(AProperties.UseWrapLeftDistance, AProperties.WrapLeftDistance,
    TdxDrawingWrapLeftDistance.DefaultValue)));
  Formatting.RightDistance := AUnitConverter.EmuToModelUnits
    (Trunc(IfThen(AProperties.UseWrapRightDistance,
    AProperties.WrapRightDistance, TdxDrawingWrapRightDistance.DefaultValue)));
  Formatting.TopDistance := AUnitConverter.EmuToModelUnits
    (Trunc(IfThen(AProperties.UseWrapTopDistance, AProperties.WrapTopDistance,
    TdxDrawingWrapTopDistance.DefaultValue)));
  Formatting.BottomDistance := AUnitConverter.EmuToModelUnits
    (Trunc(IfThen(AProperties.UseWrapBottomDistance,
    AProperties.WrapBottomDistance,
    TdxDrawingWrapBottomDistance.DefaultValue)));

  if not TdxAlphaColors.IsEmpty(AProperties.LineColor) then
    LineColor := AProperties.LineColor;
  if not TdxAlphaColors.IsEmpty(AProperties.FillColor) and
    AProperties.UseFilled and AProperties.Filled then
    FillColor := AProperties.FillColor;
end;

procedure TdxDocFloatingObjectBase.SetFormatting(const Value
...
constructor TdxDocPictureFloatingObject.Create(var AObjectInfo
...
constructor TdxDocTextBoxFloatingObject.Create(var AObjectInfo
  : TdxDocObjectInfo; APropertyContainer: TdxDocPropertyContainer;
  AShapeId: Integer);
begin
  inherited Create(AObjectInfo, APropertyContainer);
...
procedure TdxDocTextBoxFloatingObject.SetOfficeArtPropertiesCore
  (AProperties: TdxOfficeArtProperties;
  AUnitConverter: TdxDocumentModelUnitConverter);
begin
...
procedure TdxDocTextBoxFloatingObject.ApplyTextBoxProperties
...
constructor TdxDocFieldsImporter.Create(APieceTable: TdxPieceTable;
  AFieldInfoStack: TdxObjectStack<TdxImportFieldInfo>);
begin
...
procedure TdxDocFieldsImporter.ProcessFieldSeparator
...
procedure TdxDocFieldsImporter.ProcessFieldEnd(APosition: TdxInputPosition;
  APropertyContainer: TdxDocPropertyContainer);
var
  AFieldInfo: TdxImportFieldInfo;
begin
  ...
  try
    AFieldInfo.Locked := (APropertyContainer.FieldProperties and
      TdxFieldProperties.Locked) <> 0;
...
procedure TdxDocFieldsImporter.ProcessHyperlinkData(AHyperlinkData
  : TdxDocHyperlinkFieldData);
begin
end;
