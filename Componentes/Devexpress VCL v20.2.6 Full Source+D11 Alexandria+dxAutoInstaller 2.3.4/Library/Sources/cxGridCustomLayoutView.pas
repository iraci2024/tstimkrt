...
uses
  ...
  dxFilterPopupWindow,
  dxCoreClasses, cxClasses, cxGeometry, cxCustomData, cxLookAndFeelPainters,
  cxControls, dxFilterValueContainer,
  cxGridCustomView, cxGridCustomTableView, cxGridViewLayoutContainer,
...
type
  ...
  TcxGridCustomLayoutViewControllerClass = class of
  ...
  TcxGridCustomLayoutRecordViewInfoClass = class of
    TcxGridCustomLayoutRecordViewInfo;
  TcxGridCustomLayoutViewSeparatorsViewInfo = class;
  TcxGridCustomLayoutViewSeparatorsViewInfoClass = class of
  ...
  public
    ...
    property FirstVisible: TcxGridCustomLayoutRecordViewInfo
      read GetFirstVisible;
    property Items[Index: Integer]: TcxGridCustomLayoutRecordViewInfo
  ...
  protected
    ...
    property RecordsViewInfo: TcxGridCustomLayoutRecordsViewInfo
  ...
  public
    ...
    property Count: Integer read GetCount;
    property Items[Index: Integer]: TcxGridCustomLayoutViewBand
  ...
  TcxGridCustomLayoutViewControllerHelperClass = class of
    TcxGridCustomLayoutViewControllerHelper;

  TcxGridCustomLayoutViewControllerHorizontalHelper = class
    (TcxGridCustomLayoutViewControllerHelper)
  private
  ...
  TcxGridCustomLayoutViewControllerVerticalHelper = class
    (TcxGridCustomLayoutViewControllerHelper)
  private
  ...
  protected
    ...
    procedure ScrollDataScrollBar(AScrollCode: TScrollCode;
      var AScrollPos: Integer); virtual;

    procedure CreateHelper; virtual;
    procedure DestroyHelper; virtual;
    function GetHelperClass
      : TcxGridCustomLayoutViewControllerHelperClass; virtual;
    procedure InternalKeyDown(var Key: Word; Shift: TShiftState); virtual;
    function ProcessFocusedItemKeys(var AKey: Word; AShift: TShiftState;
      ARowGoOnCycle: Boolean): Boolean; virtual;

    property FocusedRecordViewInfo: TcxGridCustomLayoutRecordViewInfo
      read GetFocusedRecordViewInfo;
    property Helper: TcxGridCustomLayoutViewControllerHelper read FHelper;
    property ScrollRecordViewInfo: TcxGridCustomLayoutRecordViewInfo
      read FScrollRecordViewInfo write SetScrollRecordViewInfo;
    property ViewData: TcxGridCustomLayoutViewViewData read GetViewData;
    property ViewInfo: TcxGridCustomLayoutViewViewInfo read GetViewInfo;
  public
  ...
  TcxGridCustomLayoutViewInfoCacheItem = class
  ...
  TcxGridCustomLayoutViewItemFilterButtonViewInfo = class
    (TcxCustomGridViewCellViewInfo, IdxFilterPopupWindowOwner)
  private
  ...
  protected
    ...
    property CalculationPosition: TPoint read FCalculationPosition
      write FCalculationPosition;
  public
  ...
  protected
    ...
    property Records[Index: Integer]: TcxGridCustomLayoutRecordViewInfo
      read GetRecord;
  public
    constructor Create(ARecordsViewInfo
      : TcxGridCustomLayoutRecordsViewInfo); virtual;
  ...
  TcxGridCustomLayoutRecordsViewInfoBasedCalculatorClass = class of
    TcxGridCustomLayoutRecordsViewInfoBasedCalculator;

  TcxGridCustomLayoutViewInfoHorizontalCalculator = class
    (TcxGridCustomLayoutRecordsViewInfoBasedCalculator)
  protected
  ...
  TcxGridCustomLayoutViewInfoVerticalCalculator = class
    (TcxGridCustomLayoutRecordsViewInfoBasedCalculator)
  protected
    procedure AdjustContentBounds(var ABounds: TRect); override;
    procedure DoCalculate(const AContentBounds: TRect); override;
  ...
  protected
    ...
    function GetCalculatorClass
      : TcxGridCustomLayoutRecordsViewInfoBasedCalculatorClass; virtual;
    function GetBandsClass: TcxGridCustomLayoutViewBandsClass; virtual;
    function GetItemViewInfoClass
      : TcxGridCustomLayoutRecordViewInfoClass; virtual;
    ...
    property Calculator: TcxGridCustomLayoutRecordsViewInfoBasedCalculator
      read FCalculator;
  ...
  public
    ...
    function GetRealItem(ARecord: TcxCustomGridRecord)
      : TcxGridCustomLayoutRecordViewInfo; reintroduce; virtual;
  ...
  protected
    ...
    function GetSeparatorsViewInfoClass
      : TcxGridCustomLayoutViewSeparatorsViewInfoClass; virtual;
  public
    procedure DoRightToLeftConversion(const ABounds: TRect); override;
    ...
    property RecordsViewInfo: TcxGridCustomLayoutRecordsViewInfo
      read GetRecordsViewInfo;
    property SeparatorsViewInfo: TcxGridCustomLayoutViewSeparatorsViewInfo
      read FSeparatorsViewInfo;
  end;
  ...
  protected
    ...
    property CaptionSeparator: Char read FCaptionSeparator
      write SetCaptionSeparator
      default cxGridCustomLayoutViewDefaultRecordCaptionSeparator;
  ...
  private
    function GetController: TcxGridCustomLayoutViewController;
    function GetOptionsCustomize
      : TcxGridCustomLayoutViewOptionsCustomize; inline;
    ...
    procedure SetOptionsCustomize
      (Value: TcxGridCustomLayoutViewOptionsCustomize); inline;
  ...
  public
    property Controller: TcxGridCustomLayoutViewController read GetController;
    property OptionsCustomize: TcxGridCustomLayoutViewOptionsCustomize
      read GetOptionsCustomize write SetOptionsCustomize;
    property OptionsView: TcxGridCustomLayoutViewOptionsView read GetOptionsView
...
procedure TcxGridCustomLayoutViewBand.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
...
function TcxGridCustomLayoutViewBand.GetNearest(APos: Integer)
  : TcxGridCustomLayoutRecordViewInfo;
var
  I: Integer;
begin
  ...
  begin
    Result := Items[I];
    if APos < Result.Bounds.Bottom then
      Break;
  end;
end;
...
function TcxGridCustomLayoutViewBand.GetLastVisible
  : TcxGridCustomLayoutRecordViewInfo;
var
  I: Integer;
begin
...
function TcxGridCustomLayoutViewBand.GetItem(Index: Integer)
  : TcxGridCustomLayoutRecordViewInfo;
begin
...
function TcxGridCustomLayoutViewBand.GetFirstVisible
  : TcxGridCustomLayoutRecordViewInfo;
var
  I: Integer;
begin
...
procedure TcxGridCustomLayoutViewBand.SetItem(Index: Integer;
  Value: TcxGridCustomLayoutRecordViewInfo);
var
  I: Integer;
begin
  if Index < Count then
...
constructor TcxGridCustomLayoutViewBands.Create(ARecordsViewInfo
  : TcxGridCustomLayoutRecordsViewInfo);
begin
  inherited Create;
...
function TcxGridCustomLayoutViewBands.IsItemVisible(AColumn,
  ARow: Integer): Boolean;
begin
  Result := (AColumn < VisibleCount) and Items[AColumn].IsItemVisible(ARow);
end;

function TcxGridCustomLayoutViewBands.GetBandClass
  : TcxGridCustomLayoutViewBandClass;
begin
...
function TcxGridCustomLayoutViewBands.GetItem(Index: Integer)
  : TcxGridCustomLayoutViewBand;
begin
  if Index < Count then
...
function TcxGridCustomLayoutViewBands.GetLastVisible
  : TcxGridCustomLayoutViewBand;
var
  I: Integer;
begin
...
begin
  ...
  begin
    for Result := Count - 1 downto 0 do
      if Items[Result].VisibleCount > 0 then
        Break;
    Inc(Result);
  end;
end;
...
procedure TcxGridCustomLayoutViewBands.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
...
function TcxGridCustomLayoutViewViewData.GetRecordClass(const ARecordInfo
  : TcxRowInfo): TcxCustomGridRecordClass;
begin
  Result := TcxGridCustomLayoutRecord;
end;

function TcxGridCustomLayoutViewViewData.GetRecord(Index: Integer)
  : TcxGridCustomLayoutRecord;
begin
...
constructor TcxGridCustomLayoutViewControllerHelper.Create
  (AController: TcxGridCustomLayoutViewController);
begin
  inherited Create;
  FController := AController;
end;

function TcxGridCustomLayoutViewControllerHelper.
...
procedure TcxGridCustomLayoutViewControllerHelper.KeyDown(var Key: Word;
  Shift: TShiftState);
begin
  // do nothing
end;

procedure TcxGridCustomLayoutViewControllerHelper.MouseDown
  (Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  // do nothing
end;

procedure TcxGridCustomLayoutViewControllerHelper.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
  // do nothing
end;

procedure TcxGridCustomLayoutViewControllerHelper.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  // do nothing
end;

function TcxGridCustomLayoutViewControllerHelper.CanScrollBarVisible
  (AKind: TScrollBarKind): Boolean;
begin
  Result := IsDataScrollBar(AKind);
end;

function TcxGridCustomLayoutViewControllerHelper.GetPageRecordCount
  (AVisibleRecordCount: Integer): Integer;
begin
  Result := AVisibleRecordCount;
end;

procedure TcxGridCustomLayoutViewControllerHelper.DoInitScrollBarParameters
...
begin
  if IsDataScrollBar(AKind) then
    Controller.SetScrollBarInfo(AKind, 0, Controller.DataScrollSize - 1,
      Controller.ScrollDelta, Controller.VisibleDataScrollSize,
      Controller.ScrollBarPos, True, ACanHide)
end;

procedure TcxGridCustomLayoutViewControllerHelper.InitScrollBarParameters
  (AKind: TScrollBarKind; ACanHide: Boolean);
begin
...
function TcxGridCustomLayoutViewControllerHelper.IsDataScrollBar
  (AKind: TScrollBarKind): Boolean;
begin
  Result := True;
end;
...
function TcxGridCustomLayoutViewControllerHelper.GetDataController
...
function TcxGridCustomLayoutViewControllerHelper.
  GetScrollBarOffsetBegin: Integer;
begin
...
function TcxGridCustomLayoutViewControllerHelper.GetViewData
  : TcxGridCustomLayoutViewViewData;
begin
  Result := Controller.ViewData;
end;

function TcxGridCustomLayoutViewControllerHelper.GetViewInfo
  : TcxGridCustomLayoutViewViewInfo;
begin
...
function TcxGridCustomLayoutViewControllerHorizontalHelper.
...
procedure TcxGridCustomLayoutViewControllerHorizontalHelper.KeyDown
...
function TcxGridCustomLayoutViewControllerHorizontalHelper.IsDataScrollBar
  (AKind: TScrollBarKind): Boolean;
begin
  Result := AKind = sbHorizontal;
end;

procedure TcxGridCustomLayoutViewControllerHorizontalHelper.
  FocusRecordInNextColumn(ADirection: TcxDirection; AIsSelecting: Boolean);
var
  ...
  begin
    ...
    else if ADirection = dirLeft then
...
begin
  with Controller do
    try
      ...
      ARecordViewInfo := ViewInfo.RecordsViewInfo.Bands[NextCol]
        .GetNearest(ACheckPos);
...
function TcxGridCustomLayoutViewControllerVerticalHelper.
  GetMouseWheelMajorScrollBarKind: TScrollBarKind;
begin
  Result := sbVertical;
end;

function TcxGridCustomLayoutViewControllerVerticalHelper.GetScrollDelta
  : Integer;
begin
  Result := ViewInfo.RecordsViewInfo.Bands.Count;
end;

procedure TcxGridCustomLayoutViewControllerVerticalHelper.KeyDown(var Key: Word;
  Shift: TShiftState);
var
  AKey: Word;
begin
...
function TcxGridCustomLayoutViewControllerVerticalHelper.IsDataScrollBar
  (AKind: TScrollBarKind): Boolean;
begin
  Result := AKind = sbVertical;
end;

procedure TcxGridCustomLayoutViewControllerVerticalHelper.FocusRecordInNextRow
  (ADirection: TcxDirection; AIsSelecting: Boolean);
var
  ...
  begin
    Result := DataController.IsGridMode and
      (DataController.IsBOF and (ADirection = dirUp) or DataController.IsEOF and
      (ADirection = dirDown)) or not DataController.IsGridMode and
      AIsNewFocusedRecordOutOfRange;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if ANewFocusedRecordIndex < 0 then
          ANewFocusedRecordIndex := 0;
...
constructor TcxGridCustomLayoutViewController.Create
...
function TcxGridCustomLayoutViewController.IsDataFullyVisible(AIsCallFromMaster
...
procedure TcxGridCustomLayoutViewController.KeyDown(var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TcxGridCustomLayoutViewController.MakeItemVisible
  (AItem: TcxCustomGridTableItem);
begin
  MakeFocusedRecordVisible;
end;

procedure TcxGridCustomLayoutViewController.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TcxGridCustomLayoutViewController.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
...
procedure TcxGridCustomLayoutViewController.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
function TcxGridCustomLayoutViewController.FocusNextItemHorizontally(AGoForward,
  AGoOnCycle: Boolean): Boolean;
begin
  Result := False;
end;

function TcxGridCustomLayoutViewController.FocusNextItemVertically(AGoForward,
  AGoOnCycle: Boolean): Boolean;
begin
  Result := False;
end;

function TcxGridCustomLayoutViewController.CanScrollFocusedRecord
  (ADown: Boolean): Boolean;
begin
  Result := False;
end;

function TcxGridCustomLayoutViewController.ScrollFocusedRecord
  (ADown: Boolean): Boolean;
begin
  Result := False;
end;
...
procedure TcxGridCustomLayoutViewController.DoScroll(AScrollBarKind
...
function TcxGridCustomLayoutViewController.GetIsRecordsScrollHorizontal
  : Boolean;
begin
  Result := Helper.GetIsRecordsScrollHorizontal;
end;

function TcxGridCustomLayoutViewController.GetMouseWheelMajorScrollBarKind
  : TScrollBarKind;
begin
...
procedure TcxGridCustomLayoutViewController.ScrollContentScrollBar
  (AScrollCode: TScrollCode; var AScrollPos: Integer);
begin
  // do nothing
end;

procedure TcxGridCustomLayoutViewController.ScrollData
...
procedure TcxGridCustomLayoutViewController.ScrollDataScrollBar
  (AScrollCode: TScrollCode; var AScrollPos: Integer);
begin
  case AScrollCode of
    scLineUp:
...
function TcxGridCustomLayoutViewController.GetHelperClass
  : TcxGridCustomLayoutViewControllerHelperClass;
begin
  Result := TcxGridCustomLayoutViewControllerHelper;
end;

procedure TcxGridCustomLayoutViewController.InternalKeyDown(var Key: Word;
  Shift: TShiftState);
var
...
begin
  if FocusedRecordIndex <> -1 then
  begin
    if GridView.OptionsSelection.CellSelect and
      ProcessFocusedItemKeys(Key, Shift, False) then
      Exit;
    if ((Key = VK_UP) or (Key = VK_DOWN)) and ScrollFocusedRecord(Key = VK_DOWN)
    then
      Exit;
  end;
...
function TcxGridCustomLayoutViewController.ProcessFocusedItemKeys
  (var AKey: Word; AShift: TShiftState; ARowGoOnCycle: Boolean): Boolean;
var
  ARtlKey: Word;
begin
  if ViewInfo.UseRightToLeftAlignment then
  ...
  else if ARtlKey = VK_F2 then
    Result := FocusNextItem(-1, True, False, False, True);
end;

function TcxGridCustomLayoutViewController.GetFocusedRecordViewInfo
  : TcxGridCustomLayoutRecordViewInfo;
begin
...
function TcxGridCustomLayoutViewController.GetViewData
  : TcxGridCustomLayoutViewViewData;
begin
  Result := TcxGridCustomLayoutViewViewData(inherited ViewData);
end;

function TcxGridCustomLayoutViewController.GetViewInfo
  : TcxGridCustomLayoutViewViewInfo;
begin
  Result := TcxGridCustomLayoutViewViewInfo(inherited ViewInfo);
end;

procedure TcxGridCustomLayoutViewController.SetScrollRecordViewInfo
  (Value: TcxGridCustomLayoutRecordViewInfo);
var
...
function TcxGridCustomLayoutViewPainter.GetViewInfo
  : TcxGridCustomLayoutViewViewInfo;
begin
  Result := TcxGridCustomLayoutViewViewInfo(inherited ViewInfo);
end;
...
function TcxGridCustomLayoutViewItemFilterButtonViewInfo.
  GetFilterDropDownWindowLinkComponent: TComponent;
begin
  Result := GetItem;
end;

function TcxGridCustomLayoutViewItemFilterButtonViewInfo.GetFilterPopupMode
...
function TcxGridCustomLayoutViewItemFilterButtonViewInfo.CalculateWidth
  : Integer;
begin
  Result := 0;
end;
...
function TcxGridCustomLayoutViewItemFilterButtonViewInfo.GetDropDownWindow
...
function TcxGridCustomLayoutViewItemFilterButtonViewInfo.GetDropDownWindowValue
  : TdxFilterPopupWindow;
begin
  Result := TdxFilterPopupWindow(inherited DropDownWindow);
end;

function TcxGridCustomLayoutViewItemFilterButtonViewInfo.GetGridView
  : TcxGridCustomLayoutView;
begin
...
begin
  Result := GridViewInfo.LookAndFeelPainter.ScaledFilterDropDownButtonSize
    (ScaleFactor).X;
end;

function TcxGridCustomLayoutViewItemFilterButtonViewInfo.
  GetVisibleForHitTest: Boolean;
begin
...
begin
  Result := inherited IsDropDownWindowOwner and
    (DropDownWindow.LinkComponent = GetFilterDropDownWindowLinkComponent);
end;

function TcxGridCustomLayoutViewItemFilterButtonViewInfo.
  NeedsContainerHotTrack: Boolean;
begin
...
begin
  Result := (GridView.OptionsView.ShowItemFilterButtons = sfbAlways) or
    (GridView.OptionsView.ShowItemFilterButtons = sfbDefault) and
...
function TcxGridCustomLayoutRecordViewInfo.GetRecordsViewInfo
  : TcxGridCustomLayoutRecordsViewInfo;
begin
...
begin
  if TcxGridCustomLayoutViewController(Controller)
    .GetMouseWheelMajorScrollBarKind = sbVertical then
...
constructor TcxGridCustomLayoutViewSeparatorsViewInfo.Create
  (AGridViewInfo: TcxGridCustomLayoutViewViewInfo);
begin
  inherited Create;
...
function TcxGridCustomLayoutViewSeparatorsViewInfo.GetGridView
  : TcxGridCustomLayoutView;
begin
  Result := GridViewInfo.GridView;
end;

function TcxGridCustomLayoutViewSeparatorsViewInfo.GetItem
  (Index: Integer): TRect;
begin
  Result := PRect(FItems[Index])^;
end;

function TcxGridCustomLayoutViewSeparatorsViewInfo.GetRecordsViewInfo
  : TcxGridCustomLayoutRecordsViewInfo;
begin
...
procedure TcxGridCustomLayoutViewSeparatorsViewInfo.SetItem(Index: Integer;
const Value: TRect);
var
  ARect: PRect;
begin
...
begin
  ...
  InflateRect(Result, -RecordsViewInfo.RecordIndent,
    -RecordsViewInfo.RecordIndent);
end;
...
constructor TcxGridCustomLayoutRecordsViewInfoBasedCalculator.Create
  (ARecordsViewInfo: TcxGridCustomLayoutRecordsViewInfo);
begin
  inherited Create;
  FRecordsViewInfo := ARecordsViewInfo;
end;

procedure TcxGridCustomLayoutRecordsViewInfoBasedCalculator.AdjustContentBounds
  (var ABounds: TRect);
begin
...
procedure TcxGridCustomLayoutRecordsViewInfoBasedCalculator.Calculate
...
procedure TcxGridCustomLayoutRecordsViewInfoBasedCalculator.DoCalculate
  (const AContentBounds: TRect);
begin
end;

function TcxGridCustomLayoutRecordsViewInfoBasedCalculator.
  GetRecordIndent: Integer;
begin
  Result := RecordsViewInfo.RecordIndent;
end;

function TcxGridCustomLayoutRecordsViewInfoBasedCalculator.
  GetRecordSpaceHorz: Integer;
begin
  Result := 0;
end;

function TcxGridCustomLayoutRecordsViewInfoBasedCalculator.
  GetRecordSpaceVert: Integer;
begin
  Result := 0;
end;

function TcxGridCustomLayoutRecordsViewInfoBasedCalculator.
  GetSeparatorWidth: Integer;
begin
...
function TcxGridCustomLayoutRecordsViewInfoBasedCalculator.
  GetMaxColumnCount: Integer;
begin
  Result := 0;
end;

function TcxGridCustomLayoutRecordsViewInfoBasedCalculator.
  GetMaxRowCount: Integer;
begin
  Result := 0;
end;

function TcxGridCustomLayoutRecordsViewInfoBasedCalculator.GetRecord
  (Index: Integer): TcxGridCustomLayoutRecordViewInfo;
begin
...
procedure TcxGridCustomLayoutViewInfoHorizontalCalculator.AdjustContentBounds
  (var ABounds: TRect);
begin
  inherited;
...
procedure TcxGridCustomLayoutViewInfoHorizontalCalculator.DoCalculate
  (const AContentBounds: TRect);
var
...
begin
  ...
  ACol := 0;
  ARow := 0;
  ALeftBound := AContentBounds.Left + RecordsViewInfo.GridViewInfo.
  ...
  begin
    ...
    if I <> 0 then
    begin
      if (ATopBound + ARecordViewInfo.Height > AContentBounds.Bottom) or IsMaxRow
      then
      begin
        if ANeedBreak then
          Break;
        Inc(ACol);
        Inc(ALeftBound, RecordsViewInfo.GetMaxRecordWidth(ACol - 1) +
          GetRecordSpaceHorz);
        ATopBound := AContentBounds.Top;
        ARow := 0;
      end;
    ...
    begin
      ANeedBreak := IsMaxColumn or
        (ALeftBound + ARecordViewInfo.Width > AContentBounds.Right);
      if ANeedBreak then
...
function TcxGridCustomLayoutViewInfoHorizontalCalculator.
  GetRecordSpaceHorz: Integer;
begin
  Result := RecordsViewInfo.RecordIndent + GetSeparatorWidth +
    RecordsViewInfo.RecordIndent;
end;
...
procedure TcxGridCustomLayoutViewInfoVerticalCalculator.AdjustContentBounds
  (var ABounds: TRect);
begin
  inherited;
...
procedure TcxGridCustomLayoutViewInfoVerticalCalculator.DoCalculate
  (const AContentBounds: TRect);
var
...
begin
  ...
  ATopBound := AContentBounds.Top + RecordsViewInfo.GridViewInfo.
    PixelScrollRecordOffset;
  ARowHeight := 0;
  ...
  begin
    ARecordViewInfo := Records[I];
    if I <> 0 then
      if (ALeftBound + ARecordViewInfo.Width > AContentBounds.Right) or
        ((AMaxColumnCount > 0) and (AMaxColumnCount = ACol)) then
      begin
        if ANeedBreak then
          Break;
        ACol := 0;
    ...
    if not ANeedBreak then
    begin
      ANeedBreak := (ATopBound + ARecordViewInfo.Height > AContentBounds.Bottom)
        or ((AMaxRowCount > 0) and (AMaxRowCount = ARow));
      if ANeedBreak then
...
function TcxGridCustomLayoutViewInfoVerticalCalculator.
  GetRecordSpaceHorz: Integer;
begin
  Result := RecordsViewInfo.RecordIndent + GetSeparatorWidth +
    RecordsViewInfo.RecordIndent;
...
constructor TcxGridCustomLayoutRecordsViewInfo.Create(AGridViewInfo
...
function TcxGridCustomLayoutRecordsViewInfo.CanOffset(AItemCountDelta
  : Integer): Boolean;
begin
  Result := False;
end;

function TcxGridCustomLayoutRecordsViewInfo.GetRealItem
  (ARecord: TcxCustomGridRecord): TcxGridCustomLayoutRecordViewInfo;
begin
...
function TcxGridCustomLayoutRecordsViewInfo.GetItemLeftBound
  (AIndex: Integer): Integer;
begin
  Result := 0;
end;

function TcxGridCustomLayoutRecordsViewInfo.GetItemsOffset(AItemCountDelta
  : Integer): Integer;
begin
  Result := 0;
end;

function TcxGridCustomLayoutRecordsViewInfo.GetItemTopBound
  (AIndex: Integer): Integer;
begin
  Result := 0;
end;

procedure TcxGridCustomLayoutRecordsViewInfo.OffsetItem(AIndex,
  AOffset: Integer);
begin
end;

function TcxGridCustomLayoutRecordsViewInfo.CalculateHeight(var AFullyVisible
  : Boolean): Integer;
var
...
begin
  ...
  begin
    ...
    AIsParentViewInfoCalculatedDown :=
      (GridView.MasterGridView.ViewInfo as TcxCustomGridTableViewInfo)
      .CalculateDown;
...
function TcxGridCustomLayoutRecordsViewInfo.CalculateWidth
  (AMaxWidth: Integer): Integer;
begin
  if Bands.Count = 0 then
    Result := 0
  else if Bands.Count = Bands.VisibleCount then
    Result := Bands.LastVisible.FirstVisible.Bounds.Right + RecordIndent
  else
    Result := AMaxWidth;
end;

procedure TcxGridCustomLayoutRecordsViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
...
function TcxGridCustomLayoutRecordsViewInfo.GetCalculatorClass
  : TcxGridCustomLayoutRecordsViewInfoBasedCalculatorClass;
begin
  Result := TcxGridCustomLayoutRecordsViewInfoBasedCalculator;
end;

function TcxGridCustomLayoutRecordsViewInfo.GetBandsClass
  : TcxGridCustomLayoutViewBandsClass;
begin
  Result := TcxGridCustomLayoutViewBands;
end;

function TcxGridCustomLayoutRecordsViewInfo.GetItemViewInfoClass
  : TcxGridCustomLayoutRecordViewInfoClass;
begin
  Result := TcxGridCustomLayoutRecordViewInfo;
end;

function TcxGridCustomLayoutRecordsViewInfo.GetMaxRecordWidth
...
function TcxGridCustomLayoutRecordsViewInfo.GetMaxRecordHeight
...
begin
  Result := TcxGridCustomLayoutViewController(Controller)
    .GetMouseWheelMajorScrollBarKind = sbVertical;
end;

function TcxGridCustomLayoutRecordsViewInfo.GetItem(Index: Integer)
  : TcxGridCustomLayoutRecordViewInfo;
begin
  Result := TcxGridCustomLayoutRecordViewInfo(inherited Items[Index]);
end;

function TcxGridCustomLayoutRecordsViewInfo.GetGridView
  : TcxGridCustomLayoutView;
begin
  Result := TcxGridCustomLayoutView(inherited GridView);
end;

function TcxGridCustomLayoutRecordsViewInfo.GetGridViewInfo
  : TcxGridCustomLayoutViewViewInfo;
begin
...
procedure TcxGridCustomLayoutViewViewInfo.CalculateHeight(const AMaxSize
  : TPoint; var AHeight: Integer; var AFullyVisible: Boolean);
begin
...
procedure TcxGridCustomLayoutViewViewInfo.DestroyViewInfos
  (AIsRecreating: Boolean);
begin
  FreeAndNil(FSeparatorsViewInfo);
  inherited;
end;

procedure TcxGridCustomLayoutViewViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
  ...
  for I := 0 to FSeparatorsViewInfo.Count - 1 do
    FSeparatorsViewInfo[I] := TdxRightToLeftLayoutConverter.ConvertRect
      (FSeparatorsViewInfo[I], ABounds);
end;

function TcxGridCustomLayoutViewViewInfo.GetSeparatorsViewInfoClass
  : TcxGridCustomLayoutViewSeparatorsViewInfoClass;
begin
  Result := TcxGridCustomLayoutViewSeparatorsViewInfo;
end;

function TcxGridCustomLayoutViewViewInfo.GetController
  : TcxGridCustomLayoutViewController;
begin
...
function TcxGridCustomLayoutViewViewInfo.GetRecordsViewInfo
  : TcxGridCustomLayoutRecordsViewInfo;
begin
  Result := TcxGridCustomLayoutRecordsViewInfo(inherited RecordsViewInfo);
end;
...
constructor TcxGridCustomLayoutRecord.Create
...
function TcxGridCustomLayoutRecord.GetViewInfoCacheItemClass
  : TcxCustomGridViewInfoCacheItemClass;
begin
  Result := TcxGridCustomLayoutViewInfoCacheItem;
end;

function TcxGridCustomLayoutRecord.GetViewInfoClass
...
begin
  if Source is TcxGridCustomLayoutViewOptionsCustomize then
    Self.Expandable := TcxGridCustomLayoutViewOptionsCustomize(Source)
      .Expandable;
  inherited;
end;

function TcxGridCustomLayoutViewOptionsCustomize.GetGridView
  : TcxGridCustomLayoutView;
begin
  Result := TcxGridCustomLayoutView(inherited GridView);
end;
...
constructor TcxGridCustomLayoutViewOptionsView.Create
  (AGridView: TcxCustomGridView);
begin
  inherited;
...
begin
  ...
  begin
    CaptionSeparator := TcxGridCustomLayoutViewOptionsView(Source)
      .CaptionSeparator;
...
function TcxGridCustomLayoutView.GetControllerClass
  : TcxCustomGridControllerClass;
begin
  Result := TcxGridCustomLayoutViewController;
end;

function TcxGridCustomLayoutView.GetOptionsCustomizeClass
  : TcxCustomGridTableOptionsCustomizeClass;
begin
  Result := TcxGridCustomLayoutViewOptionsCustomize;
end;

function TcxGridCustomLayoutView.GetOptionsViewClass
...
function TcxGridCustomLayoutView.GetController
  : TcxGridCustomLayoutViewController;
begin
  Result := TcxGridCustomLayoutViewController(inherited Controller);
end;

function TcxGridCustomLayoutView.GetOptionsCustomize
  : TcxGridCustomLayoutViewOptionsCustomize;
begin
  Result := TcxGridCustomLayoutViewOptionsCustomize(inherited OptionsCustomize);
end;

function TcxGridCustomLayoutView.GetOptionsView
  : TcxGridCustomLayoutViewOptionsView;
begin
...
function TcxGridCustomLayoutView.IsDataScrollBar(AKind: TScrollBarKind)
  : Boolean;
begin
  Result := Controller.Helper.IsDataScrollBar(AKind);
end;

procedure TcxGridCustomLayoutView.SetOptionsCustomize
  (Value: TcxGridCustomLayoutViewOptionsCustomize);
begin
  inherited OptionsCustomize := Value;
end;

procedure TcxGridCustomLayoutView.SetOptionsView
  (Value: TcxGridCustomLayoutViewOptionsView);
begin
