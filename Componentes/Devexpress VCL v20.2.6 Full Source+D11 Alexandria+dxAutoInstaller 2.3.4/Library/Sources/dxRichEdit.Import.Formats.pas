...
type
  ...
  public
    ...
    function GetDocumentImporter
      : IdxImporter<TdxRichEditDocumentFormat, Boolean>; virtual; abstract;
  end;
  ...
  strict private
    class var FImportFileFormats: TdxObjectList<TdxImportFileFormat>;
    class destructor Finalize;
  protected
    class function GetImportFileFormat(ADocumentFormat
      : TdxRichEditDocumentFormat): TdxImportFileFormat;
  public
    class function GetImporter(ADocumentFormat: TdxRichEditDocumentFormat;
      ADocumentModel: TdxCustomDocumentModel;
      const AOptions: IdxImporterOptions): TdxDocumentModelImporter;
    class function IsFormatSupported(ADocumentFormat
      : TdxRichEditDocumentFormat): Boolean;

    class procedure RegisterFileFormat(AFileFormatClass
      : TdxImportFileFormatClass);
    class procedure UnRegisterFileFormat(AFileFormatClass
      : TdxImportFileFormatClass);

    class procedure RegisterDocumentImportFormats(ADocumentImportManager
...
class function TdxImportFileFormats.GetImporter(ADocumentFormat
  : TdxRichEditDocumentFormat; ADocumentModel: TdxCustomDocumentModel;
  const AOptions: IdxImporterOptions): TdxDocumentModelImporter;
var
...
class function TdxImportFileFormats.GetImportFileFormat(ADocumentFormat
  : TdxRichEditDocumentFormat): TdxImportFileFormat;
var
...
class function TdxImportFileFormats.IsFormatSupported(ADocumentFormat
  : TdxRichEditDocumentFormat): Boolean;
begin
  Result := GetImportFileFormat(ADocumentFormat) <> nil;
end;

class procedure TdxImportFileFormats.RegisterFileFormat(AFileFormatClass
  : TdxImportFileFormatClass);
begin
  if FImportFileFormats = nil then
...
class procedure TdxImportFileFormats.RegisterDocumentImportFormats
  (ADocumentImportManager: TdxDocumentImportManagerService);
var
  AFileFormat: TdxImportFileFormat;
...
class procedure TdxImportFileFormats.UnRegisterFileFormat(AFileFormatClass
  : TdxImportFileFormatClass);
var
  AFileFormat: TdxImportFileFormat;
begin
