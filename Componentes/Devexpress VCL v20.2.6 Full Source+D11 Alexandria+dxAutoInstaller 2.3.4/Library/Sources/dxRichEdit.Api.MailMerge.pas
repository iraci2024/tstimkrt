...
type
  ...
  TdxNativeMailMergeOptions = class(TInterfacedObject,
...
function TdxNativeMailMergeOptions.GetInternalMailMergeOptions
  : TdxMailMergeOptions;
begin
...
procedure TdxNativeMailMergeOptions.SetCopyTemplateStyles(const Value: Boolean);
begin
...
procedure TdxNativeMailMergeOptions.SetMergeMode(const Value
  : TdxRichEditMergeMode);
begin
  FMergeMode := Value;
end;

procedure TdxNativeMailMergeOptions.SetMergeRecords
  (const Value: TdxRichEditMergeRecords);
begin
  FMergeRecords := Value;
end;
