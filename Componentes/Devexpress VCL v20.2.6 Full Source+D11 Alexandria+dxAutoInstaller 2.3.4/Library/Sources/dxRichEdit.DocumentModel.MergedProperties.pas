...
type
  ...
  TdxMergedProperties<TInfo: TdxCloneable, constructor; TOptions> = class
    (TcxIUnknownObject)
  private
    FInfo: TInfo;
  protected
  ...
  TdxMergedCloneableOptionsProperties<TInfo: TdxCloneable, constructor;
  TOptions: TdxCloneable, constructor> = class
    (TdxMergedProperties<TInfo, TOptions>) // for internal use
  public
    constructor Create; reintroduce; overload;
    constructor Create(AInfo: TInfo; const AOptions: TOptions);
