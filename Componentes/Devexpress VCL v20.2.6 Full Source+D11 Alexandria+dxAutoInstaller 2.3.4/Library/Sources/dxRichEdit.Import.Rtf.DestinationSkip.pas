...
begin
  ...
  TdxRtfFormattingInfoAccess(Importer.Position.RtfFormattingInfo)
    .SetDecoder(TdxSkipCharacterDecoder.Create, False);
end;
...
function TdxSkipNestedTableDestination.CreateClone
  : TdxRichEditRtfDestinationBase;
begin
  Result := TdxSkipNestedTableDestination.Create(Importer);
end;

class function TdxSkipNestedTableDestination.CreateKeywordHT
...
class function TdxSkipNestedTableDestination.GetKeywordHT
  : TdxKeywordTranslatorTable;
begin
  Result := FKeywordHT;
end;
