...
type
  ...
  public
    function CreateTableGridCalculator(ADocumentModel: TdxDocumentModel;
      ...
      : TdxTableGridCalculator; override;
    function CreateTablesController: TdxTablesController; override;
    function GetEffectiveLineNumberingRestartTypeBase(ASection: TdxSection)
    ...
    function CreateFloatingObjectSizeAndPositionController
      : TdxFloatingObjectSizeAndPositionController; override;
  end;
  ...
  protected
    ...
    procedure UpdatePageWidthCore(AController
      : TdxDocumentFormattingController); virtual;
    procedure UpdatePageWidth; virtual;

    property InternalWordWrap: Boolean read FInternalWordWrap
      write SetInternalWordWrap;
...
uses
  Math, dxCore, dxTypeHelpers, dxThreading, cxLookAndFeels,
...
type
  ...
  protected
    function GetMaxWidth(AAreas: TdxPageAreaCollection): Integer;
      overload; virtual;
  ...
  public
    ...
    procedure FinalizePagePrimaryFormatting(APage: TdxPage;
      ASkipAddingFloatingObjects: Boolean); override;

    property MinPageWidth: Integer read FMinPageWidth write FMinPageWidth;
    property VirtualPageHeight: Integer read GetVirtualPageHeight
      write SetVirtualPageHeight;
    property VirtualPageWidth: Integer read GetVirtualPageWidth
      write SetVirtualPageWidth;
  end;
  ...
  public
    ...
    function CalculatePageClientBoundsCore(APageWidth, APageHeight, AMarginLeft,
      AMarginTop, AMarginRight, AMarginBottom: Integer): TRect; override;
  end;

  { TdxSimpleViewCurrentHorizontalPositionController }

  TdxSimpleViewCurrentHorizontalPositionController = class
  ...
  public
    procedure ProcessColumnCollection(ACollection
      : TdxColumnCollection); override;
  end;
  ...
  protected
    function GetSplitAnchorHorizontalCellBorders(ASplitAnchor
      : TdxTableCellVerticalAnchor): TdxHorizontalCellBordersInfoList; override;
  public
  ...
  protected
    function CreateTableViewInfoManager(AParentTableViewInfoManager
      ...
      ARowsController: TdxRowsController): TdxTableViewInfoManager; override;
  ...
  TdxSimpleViewFloatingObjectSizeAndPositionController = class
  ...
  strict protected
    function CreateCurrentHorizontalPosition
      : TdxCurrentHorizontalPositionController; overload; override;
    function CreateCurrentHorizontalPosition(APosition: Integer)
      : TdxCurrentHorizontalPositionController; overload; override;
  public
    constructor Create(AController: TdxSimpleViewDocumentFormattingController;
      APieceTable: TdxPieceTable; AColumnController: TdxColumnController;
      AMatchHorizontalTableIndentsToTextEdge: Boolean);
    property Controller: TdxSimpleViewDocumentFormattingController
      read FController;
  end;
  ...
  strict private
    FView: TdxSimpleView;
  public
    constructor Create(AView: TdxSimpleView; ADocumentLayout: TdxDocumentLayout;
  ...
  protected
    ...
    function GetNewClientBounds(const AClipBounds: TRect;
      const AOldClipBounds: TdxRectF): TdxRectF; override;
  end;
...
procedure TdxSimpleViewColumnsBoundsCalculator.PopulateColumnsBounds
...
procedure TdxSimpleViewColumnsBoundsCalculator.PopulateEqualWidthColumnsBounds
  (const AResult: TdxRectList; const ABounds: TRect;
...
function TdxSimpleViewFloatingObjectSizeAndPositionController.
...
constructor TdxSimpleViewRowsController.Create(AController
  : TdxSimpleViewDocumentFormattingController; APieceTable: TdxPieceTable;
  AColumnController: TdxColumnController;
  AMatchHorizontalTableIndentsToTextEdge: Boolean);
begin
  inherited Create(APieceTable, AColumnController,
    AMatchHorizontalTableIndentsToTextEdge);
  FController := AController;
end;

function TdxSimpleViewRowsController.CreateCurrentHorizontalPosition
  : TdxCurrentHorizontalPositionController;
begin
...
function TdxSimpleViewRowsController.CreateCurrentHorizontalPosition
  (APosition: Integer): TdxCurrentHorizontalPositionController;
begin
  Result := TdxSimpleViewCurrentHorizontalPositionController.Create(Self,
    APosition);
end;
...
function TdxSimpleViewPageViewInfoGenerator.
  GetVerticalScrollBarLargeChange: Integer;
begin
...
procedure TdxSimpleViewPageViewInfoGenerator.SetHorizontalPageGap
  (Value: Integer);
begin
end;
...
function TdxSimpleViewPageViewInfoGenerator.CanFitPageToPageRow(APage: TdxPage;
  ARow: TdxPageViewInfoRow): Boolean;
begin
  Result := False;
end;

function TdxSimpleViewPageViewInfoGenerator.CreateEmptyClone
  : TdxPageGeneratorLayoutManager;
begin
  Result := TdxSimpleViewPageViewInfoGenerator.Create(FView, FViewInfo);
end;

procedure TdxSimpleViewPageViewInfoGenerator.Reset
  (AStrategy: TdxPageGenerationStrategyType);
begin
  TotalWidth := MinInt64;
...
function TdxSimpleViewPageViewInfoGenerator.ProcessPage(APage: TdxPage;
...
function TdxSimpleViewPageViewInfoGenerator.CalculatePageLogicalTotalWidth
...
constructor TdxSimpleViewDocumentFormattingController.Create
  (AView: TdxSimpleView; ADocumentLayout: TdxDocumentLayout;
  APieceTable: TdxPieceTable);
begin
...
function TdxSimpleViewDocumentFormattingController.CreateColumnController
  : TdxColumnController;
begin
  Result := TdxSimpleViewColumnController.Create(PageAreaController);
end;

function TdxSimpleViewDocumentFormattingController.CreatePageController
  : TdxPageController;
begin
  Result := TdxSimpleViewPageController.Create(DocumentLayout);
end;

function TdxSimpleViewDocumentFormattingController.CreateRowController
  : TdxRowsController;
begin
  Result := TdxSimpleViewRowsController.Create(Self, PieceTable,
    ColumnController, DocumentModel.LayoutOptions.SimpleView.
    MatchHorizontalTableIndentsToTextEdge);
end;

{ TdxSimpleViewColumnController }

function TdxSimpleViewColumnController.CalculateColumnBoundsCore
  (AColumnIndex: Integer): TRect;
begin
  Result := ColumnsBounds[0];
end;

function TdxSimpleViewColumnController.CreateColumnBoundsCalculator
  : TdxColumnsBoundsCalculator;
begin
  Result := TdxSimpleViewColumnsBoundsCalculator.Create
    (PageAreaController.PageController.DocumentLayout.DocumentModel.
    ToDocumentLayoutUnitConverter);
end;

function TdxSimpleViewColumnController.
...
constructor TdxSimpleViewPageController.Create(ADocumentLayout
  : TdxDocumentLayout);
begin
...
function TdxSimpleViewPageController.CreatePageBoundsCalculator
  : TdxPageBoundsCalculator;
begin
  Result := TdxSimplePageBoundsCalculator.Create(Self);
end;

function TdxSimpleViewPageController.CreateHitTestCalculator(const ARequest
...
procedure TdxSimpleViewPageController.FinalizePagePrimaryFormatting
  (APage: TdxPage; ASkipAddingFloatingObjects: Boolean);
var
...
begin
  ...
  APage.ClientBounds := TRect.CreateSize(0, 0, APageBounds.Width,
    APageBounds.Height);
...
function TdxSimpleViewPageController.GetMaxWidth
...
procedure TdxSimpleViewPageController.SetVirtualPageHeight
  (const Value: Integer);
begin
  FPageSize.cy := Value;
end;
...
begin
  VirtualPageHeight := DocumentLayout.UnitConverter.
    DocumentsToLayoutUnits(4800);
...
function TdxSimpleViewTableViewInfoManager.GetSplitAnchorHorizontalCellBorders
...
function TdxSimpleViewTablesController.CreateTableViewInfoManager
...
begin
  Result := TdxSimpleViewTableViewInfoManager.Create
    (AParentTableViewInfoManager, APageController, ARowsController);
end;
...
function TdxSimpleViewTablesController.CanFitRowToColumn(ALastTextRowBottom
...
begin
  ...
  AFloatingObjects := RowsController.FloatingObjectsLayout.
    GetAllObjectsInRectangle(ARowBounds);
  try
...
function TdxSimpleViewRowsControllerBase.CreateTablesController
  : TdxTablesController;
begin
  Result := TdxSimpleViewTablesController.Create
    (ColumnController.PageAreaController.PageController, Self);
end;

function TdxSimpleViewRowsControllerBase.CreateTableGridCalculator
...
begin
  Result := TdxTableGridCalculator.Create(AWidthsCalculator, AMaxTableWidth,
    DocumentModel.LayoutOptions.SimpleView.
    AllowTablesToExtendIntoMargins, True);
end;

function TdxSimpleViewRowsControllerBase.
  GetEffectiveLineNumberingRestartTypeBase(ASection: TdxSection)
  : TdxLineNumberingRestart;
begin
  Result := inherited GetEffectiveLineNumberingRestartType(ASection);
end;

function TdxSimpleViewRowsControllerBase.GetEffectiveLineNumberingRestartType
...
function TdxSimpleViewRowsControllerBase.
  CreateFloatingObjectSizeAndPositionController
  : TdxFloatingObjectSizeAndPositionController;
begin
...
constructor TdxSimplePageBoundsCalculator.Create(AController
  : TdxSimpleViewPageController);
begin
...
function TdxSimplePageBoundsCalculator.CalculatePageBounds
  (ASection: TdxSection): TRect;
begin
  Result := CalculatePageClientBounds(ASection);
end;

function TdxSimplePageBoundsCalculator.CalculatePageClientBoundsCore(APageWidth,
  APageHeight, AMarginLeft, AMarginTop, AMarginRight, AMarginBottom
  : Integer): TRect;
begin
  Result.InitSize(cxNullPoint, FController.PageSize.cx,
    FController.PageSize.cy);
end;

{ TdxSimpleViewCurrentHorizontalPositionController }

function TdxSimpleViewCurrentHorizontalPositionController.CanFitBoxToCurrentRow
  (const ABoxSize: TSize): Boolean;
begin
  if TdxSimpleViewRowsController(RowsController).Controller.View.InternalWordWrap
  then
...
function TdxSimpleViewCurrentHorizontalPositionController.
...
procedure TdxSimpleViewBoxHitTestCalculator.ProcessColumnCollection
  (ACollection: TdxColumnCollection);
var
...
procedure TdxSimpleViewPainter.DrawEmptyComment(AGraphics: TdxGraphics;
...
procedure TdxSimpleViewPainter.DrawEmptyPage(AGraphics: TdxGraphics;
...
function TdxSimpleViewPainter.GetNewClientBounds(const AClipBounds: TRect;
...
procedure TdxSimpleViewBackgroundPainter.Draw(AGraphics: TdxGraphics;
  const ABounds: TRect);
begin
...
begin
  ...
  try
    ...
    begin
      AWidth := Max(TdxMaxWidthCalculator.GetMaxWidth(DocumentLayout.Pages[I]
        ), AWidth);
  ...
  Result := DocumentLayout.UnitConverter.LayoutUnitsToPixels
    (TSize.Create(AWidth, AHeight), DocumentModel.DpiX, DocumentModel.DpiY);
end;

function TdxSimpleView.CalculatePageContentClipBounds
...
function TdxSimpleView.CreateDocumentFormattingController
  : TdxDocumentFormattingController;
begin
  Result := TdxSimpleViewDocumentFormattingController.Create(Self,
...
function TdxSimpleView.CreateBackgroundPainter
...
begin
  ...
  begin
    ...
    if (Control.InnerControl.VerticalRuler <> nil) and
      Control.InnerControl.VerticalRuler.IsVisible then
...
function TdxSimpleView.GetPageViewInfoRowFromPoint(const APoint: TPoint;
...
procedure TdxSimpleView.OnResize(const ABounds: TRect;
...
function TdxSimpleView.PerformStrictPageViewInfoHitTest(APageViewInfo
  : TdxPageViewInfo; const APt: TPoint): Boolean;
var
  ABounds: TRect;
begin
...
function TdxSimpleView.CreateDocumentLayoutExporter(APainter: TdxPainter;
  AAdapter: TdxGraphicsDocumentLayoutExporterAdapter;
  APageViewInfo: TdxPageViewInfo; const ABounds: TRect)
...
begin
  if AllowDisplayLineNumbers then
    AExporter := TdxScreenOptimizedGraphicsDocumentLayoutExporter.Create
      (DocumentModel, APainter, AAdapter, ABounds, TextColors, ScaleFactor)
  else
    AExporter := TdxScreenOptimizedGraphicsDocumentLayoutExporterNoLineNumbers.
...
begin
  Result := Control.InnerControl.Options.Layout.SimpleView.
    MatchHorizontalTableIndentsToTextEdge;
end;
...
begin
  APageController := FormattingController.PageController as
    TdxSimpleViewPageController;
  Result := APageController.VirtualPageWidth <>
    Math.Max(DocumentLayout.UnitConverter.DocumentsToLayoutUnits(4),
    Trunc(Bounds.Width / ScaleFactor));
end;

procedure TdxSimpleView.OnAutoSizeModeChanged;
const
  ChangeActions = [TdxDocumentModelChangeAction.ResetAllPrimaryLayout,
...
procedure TdxSimpleView.UpdatePageWidthCore(AController
  : TdxDocumentFormattingController);
var
  APageController: TdxSimpleViewPageController;
begin
  ...
  APageController.VirtualPageWidth :=
    Math.Max(DocumentLayout.UnitConverter.DocumentsToLayoutUnits(4),
    Trunc(Bounds.Width / ScaleFactor));
