...
{$ENDIF}
  ...
  dxSpreadSheetProtection, cxLabel, dxForms;

type

  { TdxSpreadSheetProtectWorkbookDialogForm }

  TdxSpreadSheetProtectWorkbookDialogFormClass = class of
    TdxSpreadSheetProtectWorkbookDialogForm;
...
var
  dxSpreadSheetProtectWorkbookDialogClass
    : TdxSpreadSheetProtectWorkbookDialogFormClass =
    TdxSpreadSheetProtectWorkbookDialogForm;
...
begin
  ADialog := dxSpreadSheetProtectWorkbookDialogClass.Create
...
procedure TdxSpreadSheetProtectWorkbookDialogForm.Load
  (AOptions: TdxSpreadSheetWorkbookProtectionOptions);
begin
  cbProtectStructure.Checked :=
    not(AOptions.Protected and AOptions.AllowChangeStructure);
  cbProtectStructureClick(nil);
end;

procedure TdxSpreadSheetProtectWorkbookDialogForm.Save
  (AOptions: TdxSpreadSheetWorkbookProtectionOptions);
begin
...
begin
  if (edPassword.Text = '') or TdxSpreadSheetPasswordDialogForm.
    ExecuteConfirmation(Self, SpreadSheet, edPassword.Text) then
    ModalResult := mrOk;
end;

procedure TdxSpreadSheetProtectWorkbookDialogForm.cbProtectStructureClick
  (Sender: TObject);
begin
