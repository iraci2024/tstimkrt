...
type
  ...
  TcxGridServerModeScrollbarAnnotationOptionsHelper = class
  ...
  TcxGridServerModeScrollbarAnnotationOptions = class
  ...
  published
    ...
    property Options: TcxGridServerModeColumnOptions read GetOptions
      write SetOptions;
  end;

  { TcxGridServerModeSummaryItem }

  TcxGridServerModeSummaryItem = class(TdxServerModeSummaryItem, IUnknown,
  ...
  protected
    ...
    function CreateScrollbarAnnotations
      : TcxGridScrollbarAnnotationOptions; override;
  ...
  public
    ...
    function GetColumnByFieldName(const AFieldName: string)
      : TcxGridServerModeColumn;
    property Columns[Index: Integer]: TcxGridServerModeColumn read GetColumn
      write SetColumn;
  published
    property DataController: TcxGridServerModeDataController
      read GetDataController write SetDataController;
    property Filtering: TcxGridServerModeTableFiltering read GetFiltering
      write SetFiltering;
  end;
...
function TcxGridServerModeScrollbarAnnotationOptionsHelper.GetDefaultValue
  (Index: Integer): Boolean;
begin
  Result := Index in [1, 2];
end;

procedure TcxGridServerModeScrollbarAnnotationOptionsHelper.SetValue
...
function TcxGridServerModeScrollbarAnnotationOptions.CreateHelper
  : TcxGridScrollbarAnnotationOptionsHelper;
begin
  Result := TcxGridServerModeScrollbarAnnotationOptionsHelper.Create
...
procedure TcxGridServerModeColumn.GetBestFitRecordRange(out AFirstIndex,
  ALastIndex: Integer);
begin
  ...
  begin
    AFirstIndex := Max(0, Controller.TopRecordIndex -
      GridView.ViewInfo.VisibleRecordCount);
    ALastIndex := Min(ViewData.RecordCount - 1, Controller.TopRecordIndex + 2 *
      GridView.ViewInfo.VisibleRecordCount);
  end;
end;

function TcxGridServerModeColumn.GetDataBinding
...
function TcxGridServerModeColumn.GetOptionsClass
...
procedure TcxGridServerModeColumn.SetDataBinding
  (Value: TcxGridItemServerModeDataBinding);
begin
  // TODO:
...
procedure TcxGridServerModeColumn.SetOptions(const Value
  : TcxGridServerModeColumnOptions);
begin
...
function TcxGridServerModeSummaryItem.CanSetKind(Value: TcxSummaryKind)
  : Boolean;
begin
...
begin
  Result := TcxGridServerModeTableView(TcxGridDBDataController(DataController)
    .GridView);
end;

procedure TcxGridServerModeSummaryItem.SetColumn
  (Value: TcxGridServerModeColumn);
begin
  ItemLink := Value;
end;
...
procedure TcxGridServerModeSummaryItem.SetVisibleForCustomization
  (Value: Boolean);
begin
...
function TcxGridServerModeSummaryItem.QueryInterface(const IID: TGUID;
  out Obj): HResult;
const
...
function TcxGridServerModeSummaryItem.GetProperties
  (AProperties: TStrings): Boolean;
begin
  Result := False;
end;

procedure TcxGridServerModeSummaryItem.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
...
procedure TcxGridServerModeSummaryItem.SetPropertyValue(const AName: string;
  const AValue: Variant);
begin
  if AName = 'Column' then
    Column := TcxGridServerModeColumn
      (TcxCustomGridTableViewAccess.FindItemByObjectName(GridView, AValue));
end;
...
function TcxGridServerModeViewData.GetGroupRecordClass(const ARecordInfo
...
function TcxGridServerModeTableView.GetColumn(Index: Integer)
  : TcxGridServerModeColumn;
begin
  Result := TcxGridServerModeColumn(inherited Columns[Index]);
end;

procedure TcxGridServerModeTableView.SetColumn(Index: Integer;
  Value: TcxGridServerModeColumn);
begin
  inherited Columns[Index] := Value;
end;

function TcxGridServerModeTableView.GetDataController
  : TcxGridServerModeDataController;
begin
  Result := TcxGridServerModeDataController(FDataController);
end;

function TcxGridServerModeTableView.GetFiltering
  : TcxGridServerModeTableFiltering;
begin
  Result := TcxGridServerModeTableFiltering(inherited Filtering);
end;

procedure TcxGridServerModeTableView.SetDataController
  (Value: TcxGridServerModeDataController);
begin
  FDataController.Assign(Value);
end;

procedure TcxGridServerModeTableView.SetFiltering
  (Value: TcxGridServerModeTableFiltering);
begin
  inherited Filtering := Value;
end;

function TcxGridServerModeTableView.GetDataControllerClass
  : TcxCustomDataControllerClass;
begin
  Result := TcxGridServerModeDataController;
end;

function TcxGridServerModeTableView.GetFilteringClass
...
function TcxGridServerModeTableView.GetSummaryItemClass
  : TcxDataSummaryItemClass;
begin
  Result := TcxGridServerModeSummaryItem;
end;

function TcxGridServerModeTableView.GetViewDataClass
...
function TcxGridServerModeTableView.GetConditionalFormattingProvider
...
function TcxGridServerModeTableView.CreateScrollbarAnnotations
  : TcxGridScrollbarAnnotationOptions;
begin
  Result := TcxGridServerModeScrollbarAnnotationOptions.Create(Self);
end;

function TcxGridServerModeTableView.GetColumnByFieldName(const AFieldName
  : string): TcxGridServerModeColumn;
begin
  Result := TcxGridServerModeColumn
