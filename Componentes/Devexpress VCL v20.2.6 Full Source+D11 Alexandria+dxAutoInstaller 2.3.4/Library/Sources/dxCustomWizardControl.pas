...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Windows, SysUtils, Messages, Classes, Graphics, Controls, Math, Forms,
  Buttons,
  ImgList, dxCore, cxClasses, cxControls, cxGraphics, cxGeometry,
  cxDrawTextUtils,
...
type
  ...
  TdxWizardControlButtonKind = (wcbkBack, wcbkNext, wcbkCancel, wcbkHelp,
    wcbkFinish);
  TdxWizardControlCustomButtonsAlignment = (wccbaRight, wccbaLeft);
  TdxWizardControlElementVisibility = (wcevDefault, wcevAlwaysVisible,
    wcevAlwaysHidden);
  TdxWizardControlResizeAnimation = (wcraDefault, wcraEnabled, wcraDisabled);
  TdxWizardControlTransitionEffect = (wcteDefault, wcteNone, wcteFade,
    wcteSlide);
  ...
  TdxWizardControlInfoPanelClickEvent = procedure(Sender: TObject;
  ...
  TdxWizardControlHandleChildControlKeyEvent = procedure(const Message
    : TCMChildKey; var AHandled: Boolean) of object;
  ...
  TdxWizardControlChangeEvent = procedure(Sender: TObject;
    AChanges: TdxWizardControlChanges) of object;
  ...
  protected
    ...
    property OnChange: TdxWizardControlChangeEvent read FOnChange
      write FOnChange;
  public
  ...
  public
    ...
    property HitObject: TdxWizardControlCellViewInfo read FHitObject
      write FHitObject;
    property HitObjectAsButton: TdxWizardControlCustomButton
      read GetHitObjectAsButton;
  ...
  public
    ...
    procedure DrawButton(ACanvas: TcxCanvas; const ABounds: TRect;
      AState: TcxButtonState);
    procedure DrawCommandAreaBackground(ACanvas: TcxCanvas;
      const ABounds: TRect); virtual;
    procedure DrawHeaderBackground(ACanvas: TcxCanvas;
      const ABounds: TRect); virtual;
    ...
    function GetButtonFocusRect(ACanvas: TcxCanvas; const ABounds: TRect)
      : TRect; virtual;
    ...
    property CommandAreaDisabledTextColor: TColor
      read GetCommandAreaDisabledTextColor;
    ...
    property HeaderDescriptionTextColor: TColor
      read GetHeaderDescriptionTextColor;
  ...
  published
    ...
    property Stretch: TdxSkinStretchMode read GetStretch write SetStretch
      default smStretch;
  end;

  { TdxWizardControlHeader }

  TdxWizardControlHeaderAssignedValue = (wchvBackgroundImage,
    wchvDescriptionFont, wchvDescriptionVisibility, wchvDescriptionOffset,
    wchvGlyph, wchvGlyphVisibility, wchvTitleFont, wchvVisible);
  TdxWizardControlHeaderAssignedValues = set of
  ...
  private
    ...
    procedure BackgroundImageChanged(Sender: TObject;
      AChanges: TdxWizardControlChanges);
    ...
    procedure SetDescriptionVisibility
      (AValue: TdxWizardControlElementVisibility);
  ...
  public
    ...
    destructor Destroy; override;
  published
    property AssignedValues: TdxWizardControlHeaderAssignedValues
      read FAssignedValues write SetAssignedValues default [];
    property BackgroundImage: TdxWizardControlImage read FBackgroundImage
      write SetBackgroundImage stored IsBackgroundImageStored;
    property DescriptionFont: TFont read FDescriptionFont
      write SetDescriptionFont stored IsDescriptionFontStored;
    property DescriptionOffset: Integer read FDescriptionOffset
      write SetDescriptionOffset stored IsDescriptionOffsetStored;
    property DescriptionVisibility: TdxWizardControlElementVisibility
      read FDescriptionVisibility write SetDescriptionVisibility
      stored IsDescriptionVisibilityStored;
    property Glyph: TdxSmartGlyph read FGlyph write SetGlyph
      stored IsGlyphStored;
    property GlyphVisibility: TdxWizardControlElementVisibility
      read FGlyphVisibility write SetGlyphVisibility
      stored IsGlyphVisibilityStored;
    property TitleFont: TFont read FTitleFont write SetTitleFont
      stored IsTitleFontStored;
    property Visible: TdxWizardControlElementVisibility read FVisible
      write SetVisible stored IsVisibleStored default wcevDefault;
  end;
  ...
  TdxWizardControlWatermarkAssignedValue = (wcwavBackgroundImage,
    wcwavVisibility);
  TdxWizardControlWatermarkAssignedValues = set of
  ...
  private
    ...
    function CheckResetValue(AValue: TdxWizardControlWatermarkAssignedValue;
      const ANewAssignedValues
      : TdxWizardControlWatermarkAssignedValues): Boolean;
    procedure BackgroundImageChanged(Sender: TObject;
      AChanges: TdxWizardControlChanges);
    procedure SetAssignedValues
      (AValue: TdxWizardControlWatermarkAssignedValues);
    procedure SetBackgroundImage(AValue: TdxWizardControlImage);
  ...
  protected
    ...
    //
    property AssignedValues: TdxWizardControlWatermarkAssignedValues
      read FAssignedValues write SetAssignedValues;
  public
    constructor Create(AOwner: TPersistent); override;
    destructor Destroy; override;
  published
    ...
    property Visibility: TdxWizardControlElementVisibility read FVisibility
      write SetVisibility stored IsVisibilityStored;
  end;
  ...
  published
    ...
    property Enabled: Boolean read FEnabled write SetEnabled default True;
    property Glyph: TdxSmartGlyph read FGlyph write SetGlyph;
    property GlyphAlignment: TButtonLayout read FGlyphAlignment
      write SetGlyphAlignment default blGlyphLeft;
  ...
  protected
    ...
    procedure DoClick; override;
  published
    property AlwaysVisible: Boolean read FAlwaysVisible write SetAlwaysVisible
      default False;
  end;
  ...
  published
    ...
    property GlyphAlignment: TButtonLayout read GetGlyphAlignment
      write SetGlyphAlignment default blGlyphLeft;
  ...
  public
    ...
    property Items[Index: Integer]: TdxWizardControlCustomButtonCollectionItem
  ...
  private
    ...
    procedure SetAlignment(const AValue
  ...
  public
    ...
    destructor Destroy; override;
  published
    property Alignment: TdxWizardControlCustomButtonsAlignment read FAlignment
      write SetAlignment default wccbaRight;
    property Buttons: TdxWizardControlCustomButtonCollection read FButtons
      write SetButtons;
  end;
  ...
  published
    ...
    property Common: TdxWizardControlOptionsButtons read FCommon
      write SetCommon;
    property CustomButtons: TdxWizardControlCustomButtons read FCustomButtons
  ...
  protected
    procedure DoAssign(Source: TPersistent); override;
  published
    property ResizeAnimation: TdxWizardControlResizeAnimation
      read FResizeAnimation write FResizeAnimation default wcraDefault;
    property TransitionEffect: TdxWizardControlTransitionEffect
      read FTransitionEffect write FTransitionEffect default wcteDefault;
  end;
  ...
  public
    ...
    destructor Destroy; override;
  published
    property EnableTitleAero: Boolean read FEnableTitleAero
      write SetEnableTitleAero default True;
  ...
  public
    ...
    function CalculateHitTest(AHitTest: TdxWizardControlHitTest)
      : Boolean; virtual;
  ...
  public
    ...
    property Items[Index: Integer]: TdxWizardControlCellViewInfo read GetItem;
  ...
  protected
    function AddCell(ACellClass: TdxWizardControlCellViewInfoClass)
      : TdxWizardControlCellViewInfo;
  ...
  protected
    ...
    property ButtonViewInfo: TdxWizardControlButtonViewInfo
      read FButtonViewInfo;
  public
  ...
  protected
    ...
    procedure DrawButtonBackground(ACanvas: TcxCanvas; const R: TRect;
    ...
    property Button: TdxWizardControlCustomButton read FButton;
    property FadingHelper: TdxWizardControlButtonFadingHelper
      read FFadingHelper;
  public
    constructor Create(AControl: TdxCustomWizardControl;
      AButton: TdxWizardControlCustomButton); reintroduce; virtual;
    destructor Destroy; override;
  ...
  TdxWizardControlCustomCommandAreaViewInfo = class
    (TdxWizardControlContainerCellViewInfo)
  private
    ...
    function GetButtons: TdxWizardControlButtons;
    function GetCustomButtonViewInfos(Index: Integer)
      : TdxWizardControlButtonViewInfo;
  ...
  protected
    ...
    function AddButtonCell(AButton: TdxWizardControlCustomButton;
      AViewInfoClass: TdxWizardControlButtonViewInfoClass)
      : TdxWizardControlButtonViewInfo;
    function AlignButtonToRightSide(AButtonViewInfo
      : TdxWizardControlButtonViewInfo; var R: TRect): Boolean;
    function MeasureButtonWidth(AButtonViewInfo: TdxWizardControlButtonViewInfo;
      AIndent: Integer): Integer;
    ...
    function GetButtonViewInfo(AButton: TdxWizardControlCustomButton)
      : TdxWizardControlButtonViewInfo; virtual;
    ...
    property ActualNextButtonViewInfo: TdxWizardControlButtonViewInfo
      read GetActualNextButtonViewInfo;
    property ButtonsMaxMeasureHeight: Integer read FButtonsMaxMeasureHeight;
    property CancelButtonViewInfo: TdxWizardControlButtonViewInfo
      read FCancelButtonViewInfo;
    property CustomButtonViewInfos[Index: Integer]
      : TdxWizardControlButtonViewInfo read GetCustomButtonViewInfos;
    property CustomButtonViewInfosCount: Integer
      read GetCustomButtonViewInfosCount;
    property FinishButtonViewInfo: TdxWizardControlButtonViewInfo
      read FFinishButtonViewInfo;
    property HasCustomButtonsAlignedLeft: Boolean
      read GetHasCustomButtonsAlignedLeft;
    property HasCustomButtonsAlignedRight: Boolean
      read GetHasCustomButtonsAlignedRight;
    property HelpButtonViewInfo: TdxWizardControlButtonViewInfo
      read FHelpButtonViewInfo;
    property InfoPanelViewInfo: TdxWizardControlCellViewInfo
      read FInfoPanelViewInfo;
    property NextButtonViewInfo: TdxWizardControlButtonViewInfo
  ...
  public
    ...
    property IndentBetweenElementsInGroup: Integer
      read GetIndentBetweenElementsInGroup;
  ...
  public
    ...
    property BackgroundImageIsAvailable: Boolean
      read GetBackgroundImageIsAvailable;
    property ContentMargins: TRect read GetContentMargins;
  ...
  TdxWizardControlCustomTitleViewInfo = class
    (TdxWizardControlContainerCellViewInfo)
  private
  ...
  public
    ...
    property WatermarkVisibility: TdxWizardControlElementVisibility
      read GetWatermarkVisibility;
  end;
  ...
  protected
    ...
    function CreateCommandAreaViewInfo
      : TdxWizardControlCustomCommandAreaViewInfo; virtual; abstract;
    function CreateHeaderViewInfo: TdxWizardControlCustomHeaderViewInfo;
      virtual; abstract;
    ...
    function CreateWatermarkViewInfo: TdxWizardControlWatermarkViewInfo;
      virtual; abstract;
    ...
    procedure DrawBackground(ACanvas: TcxCanvas); override;
    // Animation
    function GetDefaultResizeAnimation: TdxWizardControlResizeAnimation;
      virtual; abstract;
    function GetDefaultTransitionEffect: TdxWizardControlTransitionEffect;
      virtual; abstract;
  ...
  public
    ...
    // for internal use
    //
    property CommandAreaViewInfo: TdxWizardControlCustomCommandAreaViewInfo
      read FCommandAreaViewInfo; // for internal use
    property HeaderViewInfo: TdxWizardControlCellViewInfo read FHeaderViewInfo;
    // for internal use
    property TitleViewInfo: TdxWizardControlCustomTitleViewInfo
      read FTitleViewInfo; // for internal use
    property WatermarkViewInfo: TdxWizardControlWatermarkViewInfo
      read FWatermarkViewInfo; // for internal use
    //
    property DefaultResizeAnimation: TdxWizardControlResizeAnimation
      read GetDefaultResizeAnimation;
    property DefaultTransitionEffect: TdxWizardControlTransitionEffect
      read GetDefaultTransitionEffect;
    property TransitionEffectAreaBounds: TRect
      read GetTransitionEffectAreaBounds;
  end;
  ...
  protected
    ...
    procedure ProcessInfoPanelClick(AInfoPanel
      : TdxWizardControlInfoPanel); virtual;
  public
    constructor Create(AWizardControl: TdxCustomWizardControl); override;
    destructor Destroy; override;
    procedure RefreshState; virtual;
    // Focus
    function FindNextFocusableCell(ACell: TdxWizardControlCellViewInfo;
      AGoForward: Boolean): TdxWizardControlCellViewInfo;
    ...
    // Keyboard
    function ProcessChildKey(AKey: Word; AShiftState: TShiftState)
      : Boolean; virtual;
    function ProcessDialogChar(ACharCode: Word): Boolean; virtual;
    ...
    property FocusedCell: TdxWizardControlCellViewInfo read FFocusedCell
      write SetFocusedCell; // for internal use
    property HitTest: TdxWizardControlHitTest read FHitTest;
    property HotCell: TdxWizardControlCellViewInfo read FHotCell
      write SetHotCell; // for internal use
    property PressedCell: TdxWizardControlCellViewInfo read FPressedCell
      write SetPressedCell; // for internal use
  ...
  TdxWizardControlAnimationControllerStage = (wctacsPrepare, wctacsTransition,
    wctacsResizing);
  ...
  protected
    ...
    function CalculateAnimationMode(ANewPage,
      APrevPage: TdxWizardControlCustomPage): TdxDrawAnimationMode;
    ...
    procedure ProcessMultiStageAnimation(ANewPage: TdxWizardControlCustomPage;
      APrevPage: TdxWizardControlCustomPage;
    ...
    procedure RunAnimation(AStartImage, AFinishImage: TBitmap; ATime: Cardinal;
      AMode: TdxDrawAnimationMode);
    //
    property AutoSize: Boolean read GetAutoSize;
  public
    procedure AnimateTransition(ANewPage,
      APrevPage: TdxWizardControlCustomPage);
    procedure Draw(ACanvas: TcxCanvas);
    //
    property Active: Boolean read FActive;
    property ActualResizeAnimation: Boolean read GetActualResizeAnimation;
    property ActualTransitionEffect: TdxWizardControlTransitionEffect
      read GetActualTransitionEffect;
  ...
  private
    ...
    procedure SetOptionsViewStyleAero
      (AValue: TdxWizardControlOptionsViewStyleAero);
    ...
    procedure CMTabStopChanged(var Message: TMessage);
      message CM_TABSTOPCHANGED;
  ...
  protected
    ...
    function CanActivatePage(APage: TdxWizardControlCustomPage)
      : Boolean; virtual;
    function CanAutoSize(var ANewWidth, ANewHeight: Integer): Boolean; override;
    function CanUseTransitionEffect(ANewPage,
      APrevPage: TdxWizardControlCustomPage): Boolean; virtual;
    ...
    function CreateAnimationController
      : TdxWizardControlAnimationController; virtual;
    ...
    function CreateOptionsViewStyleAero
      : TdxWizardControlOptionsViewStyleAero; virtual;
    ...
    // Events
    function DoButtonClick(AButtonKind: TdxWizardControlButtonKind)
      : Boolean; virtual;
    function DoHandleChildControlKey(const Message: TCMChildKey)
      : Boolean; virtual;
    function DoInfoPanelClick: Boolean; virtual;
    procedure DoPageChanged; virtual;
    function DoPageChanging(NewPage: TdxWizardControlCustomPage)
      : Boolean; virtual;
    ...
    property AnimationController: TdxWizardControlAnimationController
    ...
    property IsResizingAnimationActive: Boolean
      read GetIsResizingAnimationActive;
    property ViewInfo: TdxWizardControlViewInfo read FViewInfo;

    property OnButtonClick: TdxWizardControlButtonClickEvent read FOnButtonClick
      write FOnButtonClick;
    property OnHandleChildControlKey: TdxWizardControlHandleChildControlKeyEvent
      read FOnHandleChildControlKey write FOnHandleChildControlKey;
    property OnInfoPanelClick: TdxWizardControlInfoPanelClickEvent
      read FOnInfoPanelClick write FOnInfoPanelClick;
    property OnPageChanged: TNotifyEvent read FOnPageChanged
      write FOnPageChanged;
    property OnPageChanging: TdxWizardControlPageChangingEvent
      read FOnPageChanging write FOnPageChanging;
  public
    constructor Create(AComponent: TComponent); override;
    destructor Destroy; override;
    function AddPage(APageClass: TdxWizardControlCustomPageClass)
      : TdxWizardControlCustomPage; overload; virtual;
    ...
    function GetNextPage(ACurrentPage: TdxWizardControlCustomPage;
      ASearchForward: Boolean): TdxWizardControlCustomPage;
    procedure GoToNextPage; virtual;
    procedure GoToPrevPage; virtual;
    // IdxLocalizerListener
    procedure TranslationChanged; override;

    property ActivePage: TdxWizardControlCustomPage read FActivePage
      write SetActivePage;
    ...
    property InfoPanel: TdxWizardControlInfoPanel read FInfoPanel
      write SetInfoPanel;
    property OptionsAnimate: TdxWizardControlOptionsAnimate read FOptionsAnimate
      write SetOptionsAnimate;
    property OptionsViewStyleAero: TdxWizardControlOptionsViewStyleAero
      read FOptionsViewStyleAero write SetOptionsViewStyleAero;
    property PageCount: Integer read GetPageCount;
    property Pages[Index: Integer]: TdxWizardControlCustomPage read GetPage;
    property ViewStyle: TdxWizardControlViewStyle read FViewStyle
      write SetViewStyle default wcvsWizard97;
    property Watermark: TdxWizardControlWatermark read FWatermark
      write SetWatermark;
  end;
  ...
  protected
    ...
    procedure SelectionChanged;
    //
    property DesignSelector: TdxWizardControlDesignSelectorHelper
  ...
  public
    ...
    property OptionsSize: TdxWizardControlOptionsSize read FOptionsSize
      write SetOptionsSize;
    property PageIndex: Integer read GetPageIndex write SetPageIndex
      stored False;
    property PageVisible: Boolean read FPageVisible write SetPageVisible
      default True;
    property Watermark: TdxWizardControlPageWatermark read FWatermark
      write SetWatermark;
    property WizardControl: TdxCustomWizardControl read GetWizardControl
      write SetWizardControl;
  published
...
uses
  Types, ShellAPI, dxWizardControlViewStyleWizard97,
...
constructor TdxWizardControlCustomObject.Create(AWizardControl
  : TdxCustomWizardControl);
begin
  inherited Create;
...
procedure TdxWizardControlCustomPersistent.Changed
  (AChanges: TdxWizardControlChanges);
begin
...
procedure TdxWizardControlCustomPersistent.DoChanged
  (AChanges: TdxWizardControlChanges);
begin
...
function TdxWizardControlHitTest.GetHitObjectAsButton
  : TdxWizardControlCustomButton;
begin
  if HitAtButton then
...
constructor TdxWizardControlCustomPainter.Create(AWizardControl
  : TdxCustomWizardControl);
begin
...
procedure TdxWizardControlCustomPainter.DrawBackground(ACanvas: TcxCanvas;
  const ABounds: TRect);
begin
  LookAndFeelPainter.DrawWindowContent(ACanvas, ABounds);
end;

procedure TdxWizardControlCustomPainter.DrawButton(ACanvas: TcxCanvas;
  const ABounds: TRect; AState: TcxButtonState);
begin
  LookAndFeelPainter.DrawScaledButton(ACanvas, ABounds, AState, ScaleFactor);
end;

procedure TdxWizardControlCustomPainter.DrawCommandAreaBackground
...
procedure TdxWizardControlCustomPainter.DrawHeaderBackground(ACanvas: TcxCanvas;
  const ABounds: TRect);
begin
  DrawBackground(ACanvas, ABounds);
end;

procedure TdxWizardControlCustomPainter.DrawSeparator(ACanvas: TcxCanvas;
  const R: TRect);
begin
  LookAndFeelPainter.DrawLabelLine(ACanvas, R, clDefault, clDefault, False);
end;

procedure TdxWizardControlCustomPainter.DrawTitleBackground(ACanvas: TcxCanvas;
  const R: TRect);
begin
...
function TdxWizardControlCustomPainter.GetButtonFocusRect(ACanvas: TcxCanvas;
  const ABounds: TRect): TRect;
begin
  Result := LookAndFeelPainter.ScaledButtonFocusRect(ACanvas, ABounds,
    ScaleFactor);
end;

function TdxWizardControlCustomPainter.GetButtonOffset
  (AButtonState: TcxButtonState): TPoint;
begin
  if AButtonState = cxbsPressed then
    Result := Point(LookAndFeelPainter.ScaledButtonTextShift(ScaleFactor),
      LookAndFeelPainter.ScaledButtonTextShift(ScaleFactor))
  else
    Result := cxNullPoint;
end;

function TdxWizardControlCustomPainter.GetButtonTextColor
...
function TdxWizardControlCustomPainter.GetLookAndFeelPainter
...
function TdxWizardControlCellViewInfo.CalculateHitTest
  (AHitTest: TdxWizardControlHitTest): Boolean;
begin
...
function TdxWizardControlCellViewInfo.GetRightToLeftConvertedRect
  (const ARect: TRect): TRect;
begin
  Result := TdxRightToLeftLayoutConverter.ConvertRect(ARect,
    cxGetClientRect(WizardControl));
end;
...
function TdxWizardControlCellViewInfo.ProcessDialogChar
...
constructor TdxWizardControlContainerCellViewInfo.Create(AWizardControl
  : TdxCustomWizardControl);
begin
  inherited Create(AWizardControl);
...
procedure TdxWizardControlContainerCellViewInfo.DrawChildren
  (ACanvas: TcxCanvas);
begin
  CellList.Draw(ACanvas);
end;

function TdxWizardControlContainerCellViewInfo.ProcessDialogChar
  (ACharCode: Word): Boolean;
begin
  Result := inherited ProcessDialogChar(ACharCode) or
    CellList.ProcessDialogChar(ACharCode);
end;
...
function TdxWizardControlContainerCellViewInfo.CalculateHitTest
  (AHitTest: TdxWizardControlHitTest): Boolean;
begin
...
function TdxWizardControlCellViewInfoList.Add(ACustomCellViewInfo
  : TdxWizardControlCellViewInfo): Integer;
begin
...
function TdxWizardControlCellViewInfoList.CalculateHitTest
  (AHitTest: TdxWizardControlHitTest): Boolean;
var
  I: Integer;
begin
...
function TdxWizardControlCellViewInfoList.ProcessDialogChar
  (ACharCode: Word): Boolean;
var
  I: Integer;
begin
...
function TdxWizardControlCellViewInfoList.GetItem(Index: Integer)
  : TdxWizardControlCellViewInfo;
begin
...
constructor TdxWizardControlViewInfo.Create(AWizardControl
  : TdxCustomWizardControl);
begin
  inherited Create(AWizardControl);
...
begin
  HeaderViewInfo.Bounds := cxRectSetHeight(ABounds,
    HeaderViewInfo.MeasureHeight);
...
begin
  CommandAreaViewInfo.Bounds := cxRectSetBottom(ABounds, ABounds.Bottom,
    CommandAreaViewInfo.MeasureHeight);
  ABounds.Bottom := CommandAreaViewInfo.Bounds.Top;
end;

function TdxWizardControlViewInfo.CreateTitleViewInfo
  : TdxWizardControlCustomTitleViewInfo;
begin
...
begin
  WatermarkViewInfo.Bounds := cxRectSetWidth(ABounds,
    WatermarkViewInfo.MeasureWidth);
...
procedure TdxWizardControlViewInfo.GetTabOrderList
  (AList: TdxWizardControlCellViewInfoList);
begin
  // do nothing
end;
...
begin
  Result := Max(ScaleFactor.Apply(dxWizardControlMinHeight),
    CommandAreaViewInfo.MeasureHeight + Max(HeaderViewInfo.MeasureHeight,
    WatermarkViewInfo.MeasureHeight));
end;

function TdxWizardControlViewInfo.MeasureWidth: Integer;
begin
  Result := Max(ScaleFactor.Apply(dxWizardControlMinWidth),
    Max(CommandAreaViewInfo.MeasureWidth, HeaderViewInfo.MeasureWidth +
    WatermarkViewInfo.MeasureWidth));
end;
...
begin
  ...
  begin
    FTitleRect := cxRectSetHeight(TitleRect,
      TdxTextMeasurer.TextLineHeight(TitleFont));
...
procedure TdxWizardControlCustomHeaderViewInfo.DrawBackground
  (ACanvas: TcxCanvas);
begin
...
begin
  ...
  try
    ...
    begin
      ...
      ACanvas.Font.Color := cxGetActualColor(ACanvas.Font.Color,
        Painter.HeaderTitleTextColor);
    ...
    begin
      ...
      ACanvas.Font.Color := cxGetActualColor(ACanvas.Font.Color,
        Painter.HeaderDescriptionTextColor);
      cxDrawText(ACanvas, Header.Description, DescriptionRect,
        AFormat or DT_WORDBREAK);
    end;
  finally
...
begin
  ...
  begin
    ...
    if DescriptionIsVisible then
      Inc(Result, 2 * TdxTextMeasurer.TextLineHeight(DescriptionFont) +
        ScaleFactor.Apply(cxTextSpace));
    if GlyphIsVisible then
...
function TdxWizardControlCustomHeaderViewInfo.GetActualSettings
  (AValue: TdxWizardControlHeaderAssignedValue;
  out AActualSettings: TdxWizardControlHeader): Boolean;
begin
  if (Header <> nil) and (AValue in Header.AssignedValues) then
    AActualSettings := Header
  else if (AValue in WizardControl.Header.AssignedValues) then
...
function TdxWizardControlCustomHeaderViewInfo.
  GetBackgroundImageIsAvailable: Boolean;
var
...
begin
  Result := (WizardControl.Header.Visible = wcevAlwaysVisible) or
    ((WizardControl.Header.Visible = wcevDefault) and (Header <> nil) and
    (Header.Visible <> wcevAlwaysHidden));
end;

function TdxWizardControlCustomHeaderViewInfo.GetBackgroundImage
  : TdxWizardControlImage;
var
  ASettings: TdxWizardControlHeader;
begin
...
function TdxWizardControlCustomHeaderViewInfo.GetHeader
  : TdxWizardControlPageHeader;
begin
...
constructor TdxWizardControlCustomCommandAreaViewInfo.Create(AWizardControl
  : TdxCustomWizardControl);
var
  I: Integer;
...
begin
  ...
  FHelpButtonViewInfo := AddButtonCell(Buttons.Help,
    TdxWizardControlButtonViewInfo);
  FNextButtonViewInfo := AddButtonCell(Buttons.Next,
    TdxWizardControlButtonViewInfo);
  FFinishButtonViewInfo := AddButtonCell(Buttons.Finish,
    TdxWizardControlButtonViewInfo);
  FCancelButtonViewInfo := AddButtonCell(Buttons.Cancel,
    TdxWizardControlButtonViewInfo);
  FCustomButtonViewInfos := TList.Create;
  for I := Buttons.CustomButtons.Buttons.Count - 1 downto 0 do
  begin
    ACustomButton := AddButtonCell(Buttons.CustomButtons.Buttons.Items[I]
      .Button, TdxWizardControlButtonViewInfo);
...
begin
  ...
  begin
    ...
    AButtonViewInfo.Bounds := cxRectCenterVertically(ARect,
      ButtonsMaxMeasureHeight);
...
procedure TdxWizardControlCustomCommandAreaViewInfo.CalculateButtons
  (var ABounds: TRect);
begin
...
procedure TdxWizardControlCustomCommandAreaViewInfo.CalculateCustomButtons
  (var ABounds: TRect);
var
  I: Integer;
begin
  ...
  if (CustomButtonViewInfosCount > 0) and
    AlignButtonToRightSide(CustomButtonViewInfos[CustomButtonViewInfosCount -
    1], ABounds) then
    Dec(ABounds.Right, IndentBetweenGroups);
end;

procedure TdxWizardControlCustomCommandAreaViewInfo.CalculateInfoPanel
  (var ABounds: TRect);
begin
...
procedure TdxWizardControlCustomCommandAreaViewInfo.
  CalculateButtonsMaxMeasureHeight;
var
  I: Integer;
begin
  ...
  begin
    if NextButtonViewInfo <> nil then
      FButtonsMaxMeasureHeight := Max(FButtonsMaxMeasureHeight,
        NextButtonViewInfo.MeasureHeight);
    if FinishButtonViewInfo <> nil then
      FButtonsMaxMeasureHeight := Max(FButtonsMaxMeasureHeight,
        FinishButtonViewInfo.MeasureHeight);
  end
  else if ActualNextButtonViewInfo <> nil then
    FButtonsMaxMeasureHeight := Max(FButtonsMaxMeasureHeight,
      ActualNextButtonViewInfo.MeasureHeight);
  if CancelButtonViewInfo <> nil then
    FButtonsMaxMeasureHeight := Max(FButtonsMaxMeasureHeight,
      CancelButtonViewInfo.MeasureHeight);
  if HelpButtonViewInfo <> nil then
    FButtonsMaxMeasureHeight := Max(FButtonsMaxMeasureHeight,
      HelpButtonViewInfo.MeasureHeight);
  for I := 0 to CustomButtonViewInfosCount - 1 do
    FButtonsMaxMeasureHeight := Max(FButtonsMaxMeasureHeight,
      CustomButtonViewInfos[I].MeasureHeight);
end;
...
procedure TdxWizardControlCustomCommandAreaViewInfo.DrawBackground
  (ACanvas: TcxCanvas);
begin
...
begin
  ...
  if Buttons.Finish.AlwaysVisible then
  begin
    Inc(Result, MeasureButtonWidth(NextButtonViewInfo,
      IndentBetweenElementsInGroup));
    Inc(Result, MeasureButtonWidth(FinishButtonViewInfo,
      IndentBetweenElementsInGroup));
  end
  else
    Inc(Result, MeasureButtonWidth(ActualNextButtonViewInfo,
      IndentBetweenElementsInGroup));
  ...
  for I := 0 to CustomButtonViewInfosCount - 1 do
    Inc(Result, MeasureButtonWidth(CustomButtonViewInfos[I],
      IndentBetweenElementsInGroup));
end;

function TdxWizardControlCustomCommandAreaViewInfo.GetActualNextButtonViewInfo
  : TdxWizardControlButtonViewInfo;
begin
...
function TdxWizardControlCustomCommandAreaViewInfo.GetButtons
  : TdxWizardControlButtons;
begin
  Result := WizardControl.Buttons;
end;

function TdxWizardControlCustomCommandAreaViewInfo.GetCustomButtonViewInfos
  (Index: Integer): TdxWizardControlButtonViewInfo;
begin
  Result := TdxWizardControlButtonViewInfo(FCustomButtonViewInfos.Items[Index]);
end;

function TdxWizardControlCustomCommandAreaViewInfo.
  GetCustomButtonViewInfosCount: Integer;
begin
  Result := FCustomButtonViewInfos.Count;
end;

function TdxWizardControlCustomCommandAreaViewInfo.
  GetHasCustomButtonsAlignedLeft: Boolean;
begin
  Result := (Buttons.CustomButtons.Buttons.Count > 0) and
    (Buttons.CustomButtons.Alignment = wccbaLeft);
end;

function TdxWizardControlCustomCommandAreaViewInfo.
  GetHasCustomButtonsAlignedRight: Boolean;
begin
  Result := (Buttons.CustomButtons.Buttons.Count > 0) and
    (Buttons.CustomButtons.Alignment = wccbaRight);
end;

{ TdxWizardControlButtonFadingHelper }

constructor TdxWizardControlButtonFadingHelper.Create
  (AViewInfo: TdxWizardControlButtonViewInfo);
begin
  inherited Create;
...
begin
  Result := ButtonViewInfo.IsFadingAvailable and
    not ButtonViewInfo.WizardControl.IsDesigning;
end;
...
procedure TdxWizardControlButtonFadingHelper.GetFadingImages(out AFadeOutImage,
  ...
  begin
    case Button.GlyphAlignment of
      ...
      blGlyphBottom:
        begin
          FGlyphRect := cxRectCenterHorizontally(AContentBounds, AWidth);
          FGlyphRect := cxRectSetBottom(GlyphRect,
            AContentBounds.Bottom, AHeight);
        end;
    end;
  end;
...
begin
  if not Button.ActuallyEnabled then
    Result := cxbsDisabled
  else if IsPressed and (not WizardControl.MouseCapture or IsHot) then
    Result := cxbsPressed
  else if IsHot then
    Result := cxbsHot
...
const
  EnabledImageDrawModeMap: array [Boolean] of TcxImageDrawMode = (idmNormal,
    idmDisabled);
var
  AFlags: Integer;
  ...
  begin
    ...
    try
      cxDrawImage(ACanvas.Handle, cxRectOffset(GlyphRect, AOffset,
        not WizardControl.UseRightToLeftAlignment),
        cxRectOffset(GlyphRect, AOffset,
        not WizardControl.UseRightToLeftAlignment), AGlyphBitmap,
        WizardControl.Buttons.Images, Button.ImageIndex,
        EnabledImageDrawModeMap[State = cxbsDisabled], True);
    finally
      AGlyphBitmap.Free;
    end;
  end;
  ...
  try
    ...
    begin
      ...
      cxDrawText(ACanvas, Button.Caption, cxRectOffset(CaptionRect, AOffset,
        not WizardControl.UseRightToLeftAlignment), AFlags);
    end;
    if IsFocused then
...
function TdxWizardControlButtonViewInfo.MeasureHeight: Integer;
  ...
  begin
    if Button.GlyphAlignment in [blGlyphLeft, blGlyphRight] then
      Result := Max(GlyphSize.cy, TdxTextMeasurer.TextLineHeight(Font)) +
        cxMarginsHeight(Margins)
    else
    begin
...
function TdxWizardControlButtonViewInfo.ProcessDialogChar
  (ACharCode: Word): Boolean;
begin
  Result := False;
  if CanFocus then
...
begin
  Result := (Controller.FocusedCell = nil) and
    (Controller.ViewInfo.CommandAreaViewInfo.ActualNextButtonViewInfo = Self);
end;

function TdxWizardControlButtonViewInfo.IsImageAvailable: Boolean;
begin
  Result := (WizardControl.Buttons.Images <> nil) and (Button.ImageIndex <> -1)
    and IsImageAssigned(WizardControl.Buttons.Images, Button.ImageIndex);
end;
...
begin
  if not Button.Glyph.Empty or IsImageAvailable then
    Result := dxGetImageSize(Button.Glyph, WizardControl.Buttons.Images,
...
constructor TdxWizardControlInfoPanelViewInfo.Create
  (AControl: TdxCustomWizardControl);
begin
  inherited Create(AControl);
...
function TdxWizardControlInfoPanelViewInfo.CalculateHitTest
  (AHitTest: TdxWizardControlHitTest): Boolean;
begin
...
begin
  Result := cxTextWidth(Font, InfoPanel.Caption) +
    ScaleFactor.Apply(cxTextOffset) * 2;
end;
...
begin
  ...
  else if InfoPanel.Enabled then
    Result := cxGetActualColor(InfoPanel.Font.Color,
      Painter.CommandAreaTextColor)
  else
    Result := Painter.CommandAreaDisabledTextColor;
end;

procedure TdxWizardControlInfoPanelViewInfo.SetState(const AState
  : TcxButtonState);
begin
  if State <> AState then
  begin
...
function TdxWizardControlHeader.CheckResetValue
  (AValue: TdxWizardControlHeaderAssignedValue;
  const ANewAssignedValues: TdxWizardControlHeaderAssignedValues): Boolean;
begin
...
begin
  ...
  begin
    ...
    DescriptionVisibility := TdxWizardControlHeader(Source)
...
procedure TdxWizardControlHeader.BackgroundImageChanged(Sender: TObject;
  AChanges: TdxWizardControlChanges);
begin
...
procedure TdxWizardControlHeader.SetAssignedValues
  (AValue: TdxWizardControlHeaderAssignedValues);
begin
...
procedure TdxWizardControlHeader.SetBackgroundImage
  (AValue: TdxWizardControlImage);
begin
...
procedure TdxWizardControlHeader.SetDescriptionVisibility
  (AValue: TdxWizardControlElementVisibility);
begin
...
procedure TdxWizardControlHeader.SetGlyphVisibility
  (AValue: TdxWizardControlElementVisibility);
begin
...
procedure TdxWizardControlHeader.SetVisible
  (AValue: TdxWizardControlElementVisibility);
begin
...
begin
  ...
  begin
    Font.Assign(TdxCustomWizardControl(TdxWizardControlOptionsViewStyleAero
      (Owner).Owner).Font);
    FFontChanged := False;
  end;
end;
...
procedure TdxWizardControlCustomTitleViewInfo.DrawBackground
  (ACanvas: TcxCanvas);
begin
...
function TdxWizardControlWatermarkViewInfo.GetWatermarkImage
  : TdxWizardControlImage;
begin
  if (WizardControl.ActivePage <> nil) and
    (wcwavBackgroundImage in WizardControl.ActivePage.Watermark.AssignedValues)
  then
...
function TdxWizardControlWatermarkViewInfo.GetWatermarkVisibility
  : TdxWizardControlElementVisibility;
begin
  if (WizardControl.ActivePage <> nil) and
    (wcwavVisibility in WizardControl.ActivePage.Watermark.AssignedValues) then
...
begin
  ...
  Filer.DefineProperty('Description', ReadDescription, WriteDescription,
    IsDescriptionStored and (Description = ''));
  Filer.DefineProperty('Title', ReadTitle, WriteTitle, IsTitleStored and
    (Title = ''));
end;
...
begin
  AViewInfo := WizardControl.ViewInfo.CommandAreaViewInfo.
    GetButtonViewInfo(Self);
...
procedure TdxWizardControlCustomButton.SetGlyphAlignment
...
function TdxWizardControlCustomButtonCollection.Add
  : TdxWizardControlCustomButtonCollectionItem;
begin
  Result := TdxWizardControlCustomButtonCollectionItem(inherited Add);
end;

procedure TdxWizardControlCustomButtonCollection.ChangeScale(M: Integer;
  D: Integer);
var
  I: Integer;
begin
...
function TdxWizardControlCustomButtonCollection.GetCustomButtons
  : TdxWizardControlCustomButtons;
begin
  Result := Owner as TdxWizardControlCustomButtons;
end;

function TdxWizardControlCustomButtonCollection.GetItem(Index: Integer)
  : TdxWizardControlCustomButtonCollectionItem;
begin
  Result := TdxWizardControlCustomButtonCollectionItem
...
constructor TdxWizardControlCustomButtonCollectionItem.Create
  (Collection: TCollection);
var
  ACustomButtonCollection: TdxWizardControlCustomButtonCollection;
begin
  inherited Create(Collection);
  ACustomButtonCollection :=
    Collection as TdxWizardControlCustomButtonCollection;
  FButton := TdxWizardControlCustomButton.Create
    (ACustomButtonCollection.CustomButtons.OwnerButtons);
...
procedure TdxWizardControlCustomButtonCollectionItem.Assign
  (Source: TPersistent);
begin
  ...
  else if Source is TdxWizardControlCustomButton then
    FButton.Assign(TdxWizardControlCustomButton(Source))
  else
    inherited Assign(Source);
end;

procedure TdxWizardControlCustomButtonCollectionItem.ChangeScale(M: Integer;
  D: Integer);
begin
...
function TdxWizardControlCustomButtonCollectionItem.GetGlyphAlignment
  : TButtonLayout;
begin
  Result := Button.GlyphAlignment;
end;

function TdxWizardControlCustomButtonCollectionItem.GetImageIndex
  : TcxImageIndex;
begin
...
procedure TdxWizardControlCustomButtonCollectionItem.SetCaption
  (const AValue: string);
begin
  Button.Caption := AValue;
end;

procedure TdxWizardControlCustomButtonCollectionItem.SetEnabled
  (const AValue: Boolean);
begin
  Button.Enabled := AValue;
end;

procedure TdxWizardControlCustomButtonCollectionItem.SetFocused
  (const AValue: Boolean);
begin
  Button.Focused := AValue;
end;

procedure TdxWizardControlCustomButtonCollectionItem.SetGlyph
  (AValue: TdxSmartGlyph);
begin
  Button.Glyph := AValue;
end;

procedure TdxWizardControlCustomButtonCollectionItem.SetGlyphAlignment
  (const AValue: TButtonLayout);
begin
  Button.GlyphAlignment := AValue;
end;

procedure TdxWizardControlCustomButtonCollectionItem.SetImageIndex
  (AValue: TcxImageIndex);
begin
  Button.ImageIndex := AValue;
end;

procedure TdxWizardControlCustomButtonCollectionItem.SetOnClick
  (AValue: TNotifyEvent);
begin
  Button.OnClick := AValue;
end;

procedure TdxWizardControlCustomButtonCollectionItem.SetVisible
  (const AValue: Boolean);
begin
  Button.Visible := AValue;
end;

procedure TdxWizardControlCustomButtonCollectionItem.SetWidth
...
begin
  inherited Create(AOwner);
  FButtons := TdxWizardControlCustomButtonCollection.Create(Self,
    TdxWizardControlCustomButtonCollectionItem);
end;
...
procedure TdxWizardControlCustomButtons.SetAlignment(const AValue
  : TdxWizardControlCustomButtonsAlignment);
begin
...
procedure TdxWizardControlCustomButtons.SetButtons
  (AValue: TdxWizardControlCustomButtonCollection);
begin
...
procedure TdxWizardControlButtons.ChangeHandler(Sender: TObject;
  AChanges: TdxWizardControlChanges);
begin
  Changed(AChanges);
end;
...
procedure TdxWizardControlButtons.SetCancel
  (AValue: TdxWizardControlCancelButton);
begin
  FCancel.Assign(AValue);
end;

procedure TdxWizardControlButtons.SetCommon
  (AValue: TdxWizardControlOptionsButtons);
begin
  FCommon.Assign(AValue);
end;

procedure TdxWizardControlButtons.SetCustomButtons
  (AValue: TdxWizardControlCustomButtons);
begin
  FCustomButtons.Assign(AValue);
end;

procedure TdxWizardControlButtons.SetFinish
  (AValue: TdxWizardControlFinishButton);
begin
...
begin
  ...
  begin
    EnableTitleAero := TdxWizardControlOptionsViewStyleAero(Source)
      .EnableTitleAero;
    Title := TdxWizardControlOptionsViewStyleAero(Source).Title;
  end;
end;

procedure TdxWizardControlOptionsViewStyleAero.ChangeHandler(Sender: TObject;
  AChanges: TdxWizardControlChanges);
begin
  Changed(AChanges);
end;

procedure TdxWizardControlOptionsViewStyleAero.SetEnableTitleAero
  (AValue: Boolean);
begin
...
procedure TdxWizardControlOptionsViewStyleAero.SetTitle
  (AValue: TdxWizardControlTitle);
begin
...
procedure TdxWizardControlWatermark.BackgroundImageChanged(Sender: TObject;
  AChanges: TdxWizardControlChanges);
begin
  BeginUpdate;
  try
...
function TdxWizardControlWatermark.CheckResetValue
  (AValue: TdxWizardControlWatermarkAssignedValue;
...
procedure TdxWizardControlWatermark.SetAssignedValues
  (AValue: TdxWizardControlWatermarkAssignedValues);
begin
  if FAssignedValues <> AValue then
  begin
...
procedure TdxWizardControlWatermark.SetBackgroundImage
  (AValue: TdxWizardControlImage);
begin
  FBackgroundImage.Assign(AValue);
end;

procedure TdxWizardControlWatermark.SetVisibility
  (AValue: TdxWizardControlElementVisibility);
begin
  BeginUpdate;
  try
...
constructor TdxWizardControlController.Create(AWizardControl
  : TdxCustomWizardControl);
begin
  inherited Create(AWizardControl);
...
procedure TdxWizardControlController.CellRemoving
  (ACell: TdxWizardControlCellViewInfo);
begin
...
function TdxWizardControlController.FindNextFocusableCell
  (ACell: TdxWizardControlCellViewInfo; AGoForward: Boolean)
  : TdxWizardControlCellViewInfo;
const
...
procedure TdxWizardControlController.KeyDown(AKey: Word;
...
procedure TdxWizardControlController.KeyUp(AKey: Word;
  AShiftState: TShiftState);
begin
  if AKey = VK_SPACE then
  begin
...
procedure TdxWizardControlController.MouseDown(Button: TMouseButton;
...
procedure TdxWizardControlController.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
  CalculateHitTest(X, Y);
...
procedure TdxWizardControlController.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  CalculateHitTest(X, Y);
...
procedure TdxWizardControlController.ProcessAccel
  (ACell: TdxWizardControlCellViewInfo);
begin
  FocusedCell := ACell;
  ProcessClick(ACell);
...
function TdxWizardControlController.ProcessChildKey(AKey: Word;
...
begin
  ...
  else if [ssAlt, ssCtrl] * AShiftState = [ssAlt] then
  begin
    case AKey of
      VK_LEFT:
...
procedure TdxWizardControlController.ProcessClick
  (ACell: TdxWizardControlCellViewInfo);
begin
...
procedure TdxWizardControlController.ProcessInfoPanelClick
  (AInfoPanel: TdxWizardControlInfoPanel);
begin
...
procedure TdxWizardControlController.SetFocusedCell
  (AValue: TdxWizardControlCellViewInfo);
var
...
procedure TdxWizardControlController.SetHotCell
  (AValue: TdxWizardControlCellViewInfo);
begin
...
procedure TdxWizardControlController.SetPressedCell
  (AValue: TdxWizardControlCellViewInfo);
begin
...
function TdxWizardControlDesignSelectorHelper.IsHitTestTransparent
...
procedure TdxWizardControlAnimationController.AnimateTransition(ANewPage,
  APrevPage: TdxWizardControlCustomPage);
var
  AAnimationMode: TdxDrawAnimationMode;
begin
...
function TdxWizardControlAnimationController.CalculateAnimationMode(ANewPage,
  APrevPage: TdxWizardControlCustomPage): TdxDrawAnimationMode;
begin
  ...
  try
    ...
    try
      ...
      if APage.Visible then
        cxPaintTo(APage, Result.cxCanvas, ViewInfo.PageArea.TopLeft,
          APage.ClientRect)
      else
      begin
        WizardControl.DisableAlign;
        try
          APage.BoundsRect := cxRectOffset(ViewInfo.PageArea,
            -WizardControl.Width, 0);
          APage.Visible := True;
          cxPaintTo(APage, Result.cxCanvas, ViewInfo.PageArea.TopLeft,
            APage.ClientRect);
          APage.Visible := False;
...
procedure TdxWizardControlAnimationController.ProcessMultiStageAnimation
  (ANewPage, APrevPage: TdxWizardControlCustomPage;
  AAnimationMode: TdxDrawAnimationMode);

  procedure FadeOutToBlank(APage: TdxWizardControlCustomPage;
  ...
  procedure SwitchToNextPage(APage: TdxWizardControlCustomPage;
    AAnimationTime: Cardinal);
  var
    ANewSize: TSize;
    AProgress: Single;
        ...
        begin
          ...
          repeat
            ...
            WizardControl.SetBounds(WizardControl.Left, WizardControl.Top,
              Trunc(WizardControl.Width * (1 - AProgress) + ANewSize.cx *
              AProgress), Trunc(WizardControl.Height * (1 - AProgress) +
              ANewSize.cy * AProgress));
            RedrawArea(WizardControl.ClientRect);
  ...
  procedure FadeInFromBlank(APage: TdxWizardControlCustomPage;
    AAnimationTime: Cardinal);
  var
    APageBitmap, ABlankBitmap: TcxBitmap;
  begin
...
procedure TdxWizardControlAnimationController.RunAnimation(AStartImage,
  AFinishImage: TBitmap; ATime: Cardinal; AMode: TdxDrawAnimationMode);
begin
...
function TdxWizardControlAnimationController.GetActualTransitionEffect
...
function TdxWizardControlAnimationController.GetViewInfo
  : TdxWizardControlViewInfo;
begin
  Result := WizardControl.ViewInfo;
end;
...
function TdxCustomWizardControl.AddPage(APageClass
  : TdxWizardControlCustomPageClass): TdxWizardControlCustomPage;
begin
...
procedure TdxCustomWizardControl.AlignControls(AControl: TControl;
  var Rect: TRect);
var
  I: Integer;
begin
...
procedure TdxCustomWizardControl.CalculateAutoSize(var AWidth,
  AHeight: Integer);
begin
...
function TdxCustomWizardControl.CanActivatePage
  (APage: TdxWizardControlCustomPage): Boolean;
begin
  Result := (APage = nil) or (APage.WizardControl = Self) and
    (IsDesigning or APage.PageVisible);
end;

function TdxCustomWizardControl.CanAutoSize(var ANewWidth,
...
function TdxCustomWizardControl.CanUseTransitionEffect(ANewPage,
  APrevPage: TdxWizardControlCustomPage): Boolean;
begin
  Result := (AnimationController.ActualTransitionEffect <> wcteNone) and
    not IsDesigning and (ANewPage <> nil) and (APrevPage <> nil) and
    (APrevPage <> ANewPage) and HandleAllocated and Visible and
...
procedure TdxCustomWizardControl.ChangeHandler(Sender: TObject;
  AChanges: TdxWizardControlChanges);
begin
  Changed(AChanges);
end;

procedure TdxCustomWizardControl.ChangeScaleEx(M, D: Integer;
  IsDpiChange: Boolean);
begin
  inherited;
...
function TdxCustomWizardControl.CreateAnimationController
  : TdxWizardControlAnimationController;
begin
...
function TdxCustomWizardControl.CreateOptionsAnimate
  : TdxWizardControlOptionsAnimate;
begin
...
function TdxCustomWizardControl.CreateOptionsInfoPanel
  : TdxWizardControlInfoPanel;
begin
  Result := TdxWizardControlInfoPanel.Create(Self);
end;

function TdxCustomWizardControl.CreateOptionsViewStyleAero
  : TdxWizardControlOptionsViewStyleAero;
begin
  Result := TdxWizardControlOptionsViewStyleAero.Create(Self);
end;

function TdxCustomWizardControl.CreateOptionsWatermark
  : TdxWizardControlWatermark;
begin
...
function TdxCustomWizardControl.DoButtonClick(AButtonKind
  : TdxWizardControlButtonKind): Boolean;
begin
  Result := False;
...
function TdxCustomWizardControl.DoHandleChildControlKey(const Message
  : TCMChildKey): Boolean;
begin
  Result := False;
...
function TdxCustomWizardControl.DoPageChanging
  (NewPage: TdxWizardControlCustomPage): Boolean;
begin
  Result := True;
...
procedure TdxCustomWizardControl.InternalSetActivePage
...
procedure TdxCustomWizardControl.LookAndFeelChanged(Sender: TcxLookAndFeel;
...
procedure TdxCustomWizardControl.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TdxCustomWizardControl.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TdxCustomWizardControl.PageRemoving
  (APage: TdxWizardControlCustomPage);
var
...
begin
  ...
  if not((AComponent is TControl) and IsInternalControl(TControl(AComponent)))
  then
  begin
    if not((AComponent is TdxWizardControlCustomPage) or
      (AComponent is TdxWizardControlDesignSelectorHelper)) then
      raise EdxWizardControlException.Create
        (cxGetResourceString(@sdxWizardControlErrorWrongChild));
  end;
end;
...
procedure TdxCustomWizardControl.GetChildren(Proc: TGetChildProc;
  Root: TComponent);
var
  I: Integer;
begin
...
begin
  Result := AnimationController.Active and
    (AnimationController.Stage = wctacsResizing);
end;

function TdxCustomWizardControl.GetNextPage(ACurrentPage
  : TdxWizardControlCustomPage; ASearchForward: Boolean)
  : TdxWizardControlCustomPage;
...
function TdxCustomWizardControl.GetPage(APageIndex: Integer)
  : TdxWizardControlCustomPage;
begin
...
procedure TdxCustomWizardControl.SetChildOrder(Child: TComponent;
  Order: Integer);
begin
  TdxWizardControlCustomPage(Child).PageIndex := Order;
end;

procedure TdxCustomWizardControl.SetActivePage
  (APage: TdxWizardControlCustomPage);
begin
...
procedure TdxCustomWizardControl.SetInfoPanel
  (AValue: TdxWizardControlInfoPanel);
begin
  FInfoPanel.Assign(AValue);
end;

procedure TdxCustomWizardControl.SetOptionsAnimate
  (AValue: TdxWizardControlOptionsAnimate);
begin
  FOptionsAnimate.Assign(AValue);
end;

procedure TdxCustomWizardControl.SetOptionsViewStyleAero
  (AValue: TdxWizardControlOptionsViewStyleAero);
begin
  FOptionsViewStyleAero.Assign(AValue);
end;

procedure TdxCustomWizardControl.SetViewStyle
  (AValue: TdxWizardControlViewStyle);
begin
...
procedure TdxCustomWizardControl.SetWatermark
  (AValue: TdxWizardControlWatermark);
begin
...
begin
  if (Self = Message.Sender) and Controller.ProcessChildKey(Message.CharCode,
    KeyboardStateToShiftState) then
    Message.Result := 1
  else if (Message.Sender = Self) or
    (Message.Sender is TdxWizardControlCustomPage) or
    not DoHandleChildControlKey(Message) then
    case Message.CharCode of
      VK_RETURN:
        Message.Result := Ord(CanProcessSpecialKey and
          Controller.ProcessDialogChar(VK_RETURN));
      VK_ESCAPE:
        Message.Result := Ord(CanProcessSpecialKey and
          DoButtonClick(wcbkCancel));
    end;
...
function TdxCustomWizardControl.GetDesignHitTest(X, Y: Integer;
...
begin
  if (Message.DC = 0) and (ViewInfo <> nil) and ViewInfo.TitleViewInfo.IsPaintOnGlass
  then
...
procedure TdxWizardControlCustomPage.AlignControls(AControl: TControl;
  var Rect: TRect);
begin
...
procedure TdxWizardControlCustomPage.CalculateAutoSize(var AWidth,
  AHeight: Integer);
begin
...
begin
  if (AParent <> nil) and not(AParent is TdxCustomWizardControl) then
    raise EdxWizardControlException.Create
      (cxGetResourceString(@sdxWizardControlErrorWrongParent));
...
begin
  if DesignSelector <> nil then
    DesignSelector.SelectorBounds :=
      TdxControlsDesignSelectorHelper.CalculateBounds(ClientBounds,
      ScaleFactor);
end;
...
procedure TdxWizardControlCustomPage.ChangeHandler(Sender: TObject;
  AChanges: TdxWizardControlChanges);
begin
  Changed(AChanges);
end;
...
procedure TdxWizardControlCustomPage.SetHeader
  (AValue: TdxWizardControlPageHeader);
begin
  FHeader.Assign(AValue);
end;

procedure TdxWizardControlCustomPage.SetOptionsSize
  (AValue: TdxWizardControlOptionsSize);
begin
...
begin
  ...
  begin
    if (AValue < 0) or (AValue >= WizardControl.PageCount) then
      raise EdxWizardControlException.CreateFmt
        (sdxWizardControlErrorWrongPageIndex,
        [AValue, WizardControl.PageCount - 1]);
...
procedure TdxWizardControlCustomPage.SetWatermark
  (AValue: TdxWizardControlPageWatermark);
begin
  FWatermark.Assign(AValue);
end;

procedure TdxWizardControlCustomPage.SetWizardControl
  (AValue: TdxCustomWizardControl);
begin
  Parent := AValue;
end;
