...
type
  ...
  TdxWordProcessingMLBaseImporter = class abstract
  ...
  protected
    ...
    function GetColorValue(AReader: TdxXmlReader; const AAttributeName: string;
      ADefaultValue: TdxAlphaColor): TdxAlphaColor; overload;
    function GetPresetColorValue(AReader: TdxXmlReader;
      const AAttributeName: string; ADefaultValue: TdxAlphaColor)
      : TdxAlphaColor; overload;

    function ParseColor(const AValue: string; ADefaultValue: TdxAlphaColor)
      : TdxAlphaColor; virtual;
    function ParsePresetColor(const AValue: string;
      ADefaultValue: TdxAlphaColor): TdxAlphaColor; virtual;
    function LookupStyleIndexCore(const AStyleId: string;
      AStyleInfos: TdxOpenXmlStyleInfoCollection): Integer; virtual;
    procedure CreateStylesHierarchy; virtual;
    procedure CreateStylesHierarchyCore(AStyles: TdxStyleCollectionBase;
      AStyleInfos: TdxOpenXmlStyleInfoCollection); virtual;
    procedure LinkStyles; virtual;
    procedure CreateNumberingLists; virtual;
    procedure AppendNumberingList(AListInfo: TdxOpenXmlNumberingListInfo;
      AAbstractNumberingListIndex: Integer); virtual;
    procedure LinkParagraphStylesWithNumberingLists; virtual;
    procedure LinkNumberingListStyles; virtual;
    procedure LinkParagraphStyleWithNumberingLists
      (AStyleInfo: TdxOpenXmlStyleInfo); virtual;
  public
    ...
    function CreateOpenXmlSectionTextDirectionDestination
      : TdxSectionTextDirectionDestination; virtual; abstract;
    function CreateWordMLSectionTextDirectionDestination
      : TdxSectionTextDirectionDestination; virtual; abstract;
    function CreateBookmarkStartElementDestination(AReader: TdxXmlReader)
      : TdxDestination; virtual;
    function CreateBookmarkEndElementDestination(AReader: TdxXmlReader)
      : TdxDestination; virtual;

    function CreateRunDestination: TdxRunDestination; virtual;
    function CreateVersionDestination(AReader: TdxXmlReader)
      : TdxDestination; virtual;
    ...
    function CreateStyleParagraphPropertiesDestination(AStyleDestination
      ...
      ATabs: TdxTabFormattingInfo): TdxParagraphPropertiesBaseDestination;
      virtual; abstract;

    function GetEnumValue<T>(AReader: TdxXmlReader;
      const AAttributeName: string;
      ATable: TDictionary<T, TdxWordProcessingMLValue>; ADefaultValue: T)
      : T; overload;
    function GetEnumValue<T>(AReader: TdxXmlReader;
      const AAttributeName: string; ATable: TdxMLDictionary<T>;
      ADefaultValue: T): T; overload;

    function GetColorValue(AReader: TdxXmlReader; const AAttributeName: string)
      : TdxAlphaColor; overload;
    function GetPresetColorValue(AReader: TdxXmlReader;
      const AAttributeName: string): TdxAlphaColor; overload;

    function GetWpEnumValueCore<T>(const AValue: string;
      ATable: TDictionary<T, TdxWordProcessingMLValue>; ADefaultValue: T)
      : T; overload;
    function GetWpEnumValueCore<T>(const AValue: string;
      ATable: TdxMLDictionary<T>; ADefaultValue: T): T; overload;
    ...
    function GetWpSTColorValue(AReader: TdxXmlReader;
      const AAttributeName: string; ADefaultValue: TdxAlphaColor)
      : TdxAlphaColor; overload;
    function GetWpSTColorValue(AReader: TdxXmlReader;
      const AAttributeName: string): TdxAlphaColor; overload;
    function GetMSWordColorValue(AReader: TdxXmlReader;
      const AAttributeName: string): TdxAlphaColor;
    function GetWpSTColorOrNullValue(AReader: TdxXmlReader;
      const AAttributeName: string): TdxNullableValue<TdxAlphaColor>;

    function GetShadingPatternDef(AReader: TdxXmlReader;
      const AAttributeName: string; ADefault: TdxShadingPattern)
      : TdxShadingPattern;
    ...
    function ReadAttribute(AReader: TdxXmlReader; const AAttributeName: string)
      : string; override;
    function ReadAttribute(AReader: TdxXmlReader; const AAttributeName: string;
      const ANs: string): string; override;
    procedure LockAspectRatioTableAddValue(const AKey: string;
      const AValue: string);
    function LockAspectRatioTableGetValue(const AKey: string;
      out AUseLockAspectRatio: Boolean): Boolean;
    function LookupCharacterStyleIndex(const AStyleId: string)
      : Integer; override;
    function LookupParagraphStyleIndex(const AStyleId: string)
      : Integer; virtual;
    function LookupTableStyleIndex(const AStyleId: string): Integer; virtual;
    function LookupTableCellStyleIndex(const AStyleId: string)
      : Integer; virtual;
    function GetBoolValue(const AValue: string): Boolean;
    procedure BeginTable;
    procedure EndTable;
    function RegisterFootNote(ANote: TdxFootNote; const AId: string): Integer;
      virtual; abstract;
    function RegisterEndNote(ANote: TdxEndNote; const AId: string): Integer;
      virtual; abstract;

    property ParagraphStyleInfos: TdxOpenXmlStyleInfoCollection
      read FParagraphStyleInfos;
    property CharacterStyleInfos: TdxOpenXmlStyleInfoCollection
      read FCharacterStyleInfos;
    property TableStyleInfosStack: TdxObjectStack<TdxOpenXmlStyleInfoCollection>
      read FTableStyleInfosStack;
    property TableStyleInfos: TdxOpenXmlStyleInfoCollection
      read GetTableStyleInfos;
    property TableCellStyleInfosStack
      : TdxObjectStack<TdxOpenXmlStyleInfoCollection>
      read FTableCellStyleInfosStack;
    property TableCellStyleInfos: TdxOpenXmlStyleInfoCollection
      read GetTableCellStyleInfos;
    property NumberingStyleInfos: TdxOpenXmlStyleInfoCollection
      read FNumberingStyleInfos;
    property AbstractListInfos: TdxOpenXmlAbstractNumberingInfoCollection
      read FAbstractListInfos;
    property ListInfos: TdxOpenXmlNumberingListInfoCollection read FListInfos;
    property LockAspectRatioTable: TdxLockAspectRatioTable
      read FLockAspectRatioTable;
...
constructor TdxWordProcessingMLBaseImporter.Create(ADocumentModel
...
function TdxWordProcessingMLBaseImporter.GetTableStyleInfos
  : TdxOpenXmlStyleInfoCollection;
begin
  Result := FTableStyleInfosStack.Peek;
end;

function TdxWordProcessingMLBaseImporter.GetTableCellStyleInfos
  : TdxOpenXmlStyleInfoCollection;
begin
...
function TdxWordProcessingMLBaseImporter.ReadAttribute(AReader: TdxXmlReader;
  const AAttributeName: string): string;
begin
  Result := ReadAttribute(AReader, AAttributeName,
    WordProcessingNamespaceConst);
end;

function TdxWordProcessingMLBaseImporter.ReadAttribute(AReader: TdxXmlReader;
  const AAttributeName: string; const ANs: string): string;
begin
  Result := AReader.GetAttribute(AAttributeName, ANs);
end;

function TdxWordProcessingMLBaseImporter.GetWpSTColorValue
  (AReader: TdxXmlReader; const AAttributeName: string): TdxAlphaColor;
begin
...
function TdxWordProcessingMLBaseImporter.GetWpSTColorOrNullValue
  (AReader: TdxXmlReader; const AAttributeName: string)
...
function TdxWordProcessingMLBaseImporter.GetColorValue(AReader: TdxXmlReader;
  const AAttributeName: string): TdxAlphaColor;
begin
  Result := GetColorValue(AReader, AAttributeName, TdxAlphaColors.Empty);
end;

function TdxWordProcessingMLBaseImporter.GetPresetColorValue
  (AReader: TdxXmlReader; const AAttributeName: string): TdxAlphaColor;
begin
  Result := GetPresetColorValue(AReader, AAttributeName, TdxAlphaColors.Empty);
end;

function TdxWordProcessingMLBaseImporter.GetMSWordColorValue
  (AReader: TdxXmlReader; const AAttributeName: string): TdxAlphaColor;
var
  AValue: string;
...
begin
  ...
  for AKey in TdxWordProcessingMLBaseExporter.PredefinedBackgroundColors.Keys do
    if AMLValue.OpenXmlValue = TdxWordProcessingMLBaseExporter.
      PredefinedBackgroundColors[AKey].OpenXmlValue then
      Exit(AKey);

  if Length(AValue) >= 6 then
    AValue := TdxStringHelper.Substring(AValue, 0, 6)
  else if Length(AValue) = 3 then
    AValue := Format('%0:s%0:s%1:s%1:s%2:s%2:s',
...
function TdxWordProcessingMLBaseImporter.GetShadingPatternDef
  (AReader: TdxXmlReader; const AAttributeName: string;
  ADefault: TdxShadingPattern): TdxShadingPattern;
begin
  Result := GetWpEnumValue<TdxShadingPattern>(AReader, AAttributeName,
    TdxWordProcessingMLBaseExporter.ShadingPatternTable, ADefault);
end;

function TdxWordProcessingMLBaseImporter.GetColorValue(AReader: TdxXmlReader;
  const AAttributeName: string; ADefaultValue: TdxAlphaColor): TdxAlphaColor;
var
  AValue: string;
begin
  AValue := AReader.GetAttribute(AAttributeName);
...
function TdxWordProcessingMLBaseImporter.GetWpEnumValue<T>
  (AReader: TdxXmlReader; const AAttributeName: string;
...
function TdxWordProcessingMLBaseImporter.GetEnumValue<T>(AReader: TdxXmlReader;
  const AAttributeName: string;
  ATable: TDictionary<T, TdxWordProcessingMLValue>; ADefaultValue: T): T;
var
  AValue: string;
...
function TdxWordProcessingMLBaseImporter.GetWpEnumValueCore<T>
  (const AValue: string; ATable: TDictionary<T, TdxWordProcessingMLValue>;
  ADefaultValue: T): T;
var
  AKey: T;
...
begin
  ...
  begin
    ...
    if (AValue = AValueString.OpenXmlValue) or
      (AValue = AValueString.WordMLValue) then
      Exit(AKey);
  end;
  Result := ADefaultValue;
end;
...
function TdxWordProcessingMLBaseImporter.GetWpEnumValueCore<T>
  (const AValue: string; ATable: TdxMLDictionary<T>; ADefaultValue: T): T;
begin
  Result := ATable.GetKeyByStringDef(AValue, ADefaultValue);
end;

function TdxWordProcessingMLBaseImporter.ParseColor(const AValue: string;
  ADefaultValue: TdxAlphaColor): TdxAlphaColor;
var
...
function TdxWordProcessingMLBaseImporter.ParsePresetColor(const AValue: string;
  ADefaultValue: TdxAlphaColor): TdxAlphaColor;
begin
  if not TdxWordProcessingMLBaseExporter.PresetColors.TryGetValue(AValue, Result)
  then
    Result := ADefaultValue;
end;

function TdxWordProcessingMLBaseImporter.ReadToRootElement
  (AReader: TdxXmlReader; const AName: string): Boolean;
begin
  Result := ReadToRootElement(AReader, AName, WordProcessingNamespaceConst);
end;

function TdxWordProcessingMLBaseImporter.LookupParagraphStyleIndex
  (const AStyleId: string): Integer;
begin
  Result := LookupStyleIndexCore(AStyleId, ParagraphStyleInfos);
end;

function TdxWordProcessingMLBaseImporter.LookupCharacterStyleIndex
  (const AStyleId: string): Integer;
begin
  Result := LookupStyleIndexCore(AStyleId, CharacterStyleInfos);
end;

function TdxWordProcessingMLBaseImporter.LookupTableStyleIndex
  (const AStyleId: string): Integer;
begin
  Result := LookupStyleIndexCore(AStyleId, TableStyleInfos);
end;

function TdxWordProcessingMLBaseImporter.LookupTableCellStyleIndex
  (const AStyleId: string): Integer;
begin
  Result := LookupStyleIndexCore(AStyleId, TableCellStyleInfos);
end;

function TdxWordProcessingMLBaseImporter.LookupStyleIndexCore
  (const AStyleId: string; AStyleInfos: TdxOpenXmlStyleInfoCollection): Integer;
var
...
procedure TdxWordProcessingMLBaseImporter.CreateStylesHierarchyCore
  (AStyles: TdxStyleCollectionBase; AStyleInfos: TdxOpenXmlStyleInfoCollection);
var
  I: Integer;
...
begin
  ...
  begin
    ...
    if AParentStyleInfo <> nil then
      AStyles[AStyleInfo.StyleIndex].Parent :=
        AStyles[AParentStyleInfo.StyleIndex];
  end;
end;
...
begin
  ...
  begin
    ...
    ALinkedStyleInfo := ParagraphStyleInfos.LookupStyleById
      (AStyleInfo.LinkedStyleId);
    if ALinkedStyleInfo <> nil then
      DocumentModel.StyleLinkManager.CreateLink
        (AParagraphStyles[ALinkedStyleInfo.StyleIndex],
        ACharacterStyles[AStyleInfo.StyleIndex]);
  end;
  for I := 0 to ParagraphStyleInfos.Count - 1 do
  begin
    AStyleInfo := ParagraphStyleInfos[I];
    ANextStyleInfo := ParagraphStyleInfos.LookupStyleById
      (AStyleInfo.NextStyleId);
    if ANextStyleInfo <> nil then
      AParagraphStyles[AStyleInfo.StyleIndex].NextParagraphStyle :=
        AParagraphStyles[ANextStyleInfo.StyleIndex];
  end;
end;
...
begin
  ...
  begin
    ...
    AAbstractNumberingInfo := AbstractListInfos.FindById
      (AListInfo.AbstractNumberingListId);
    if AAbstractNumberingInfo <> nil then
      AppendNumberingList(AListInfo,
        AAbstractNumberingInfo.AbstractNumberingIndex);
  end;
end;

procedure TdxWordProcessingMLBaseImporter.AppendNumberingList
  (AListInfo: TdxOpenXmlNumberingListInfo;
...
begin
  ...
  begin
    ...
    AReferenceLevel := TdxNumberingListReferenceLevel
      (AList.Levels[AOverrideLevelIndex]);
    AList.Levels[AOverrideLevelIndex] :=
      AListLevelOverride.GetOverrideListLevelCore(AReferenceLevel);
  end;
...
begin
  ...
  begin
    ...
    DocumentModel.NumberingLists[AListInfo.ListIndex]
      .AbstractNumberingList.SetStyleLinkIndex(AStyleInfo.StyleIndex);
  end;
end;

procedure TdxWordProcessingMLBaseImporter.LinkParagraphStyleWithNumberingLists
  (AStyleInfo: TdxOpenXmlStyleInfo);
var
...
procedure TdxWordProcessingMLBaseImporter.LockAspectRatioTableAddValue
...
function TdxWordProcessingMLBaseImporter.LockAspectRatioTableGetValue
  (const AKey: string; out AUseLockAspectRatio: Boolean): Boolean;
begin
...
function TdxWordProcessingMLBaseImporter.GetBoolValue
  (const AValue: string): Boolean;
begin
  Result := AValue = 't';
end;

function TdxWordProcessingMLBaseImporter.CreateBookmarkStartElementDestination
  (AReader: TdxXmlReader): TdxDestination;
begin
  Result := TdxBookmarkStartElementDestination.Create(Self);
end;

function TdxWordProcessingMLBaseImporter.CreateBookmarkEndElementDestination
  (AReader: TdxXmlReader): TdxDestination;
begin
  Result := TdxBookmarkEndElementDestination.Create(Self);
end;

function TdxWordProcessingMLBaseImporter.CreateVersionDestination
  (AReader: TdxXmlReader): TdxDestination;
begin
  Result := TdxDocumentVersionDestination.Create(Self);
end;

function TdxWordProcessingMLBaseImporter.CreateRunDestination
  : TdxRunDestination;
begin
  Result := TdxRunDestination.Create(Self);
end;

function TdxWordProcessingMLBaseImporter.CreateParagraphDestination
