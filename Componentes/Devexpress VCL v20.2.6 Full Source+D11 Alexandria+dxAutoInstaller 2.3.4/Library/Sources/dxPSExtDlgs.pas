...
uses
  ...
  ExtCtrls, Buttons, Dialogs, dxCore, cxClasses, dxPSCore, dxExtCtrls,
  cxButtons;
...
type
  ...
  protected
    ...
    function TaskModalDialog(DialogFunc: Pointer; var DialogData)
      : Bool; override;
...
begin
  ...
  Filter := Format('%s (*.%1:s)|*.%1:s',
    [cxGetResourceString(@sdxPSReportFiles),
...
function TdxPSOpenReportDialog.TaskModalDialog(DialogFunc: Pointer;
  var DialogData): Bool;
var
  Wnd: HWND;
begin
