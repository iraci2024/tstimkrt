...
type
  TdxCustomRichEditFontNameComboBoxProperties = class
  ...
  TdxRichEditFontNameComboBoxProperties = class
    (TdxCustomRichEditFontNameComboBoxProperties)
  published
    property Alignment;
  ...
  published
    ...
    property PopupMenu;
    property Properties: TdxRichEditFontNameComboBoxProperties
...
constructor TdxCustomRichEditFontNameComboBoxProperties.Create
  (AOwner: TPersistent);
begin
...
function TdxRichEditFontNameComboBox.GetActiveProperties
  : TdxRichEditFontNameComboBoxProperties;
begin
  Result := TdxRichEditFontNameComboBoxProperties(InternalGetActiveProperties);
end;

function TdxRichEditFontNameComboBox.GetProperties
  : TdxRichEditFontNameComboBoxProperties;
begin
  Result := TdxRichEditFontNameComboBoxProperties(inherited Properties);
end;

class function TdxRichEditFontNameComboBox.GetPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TdxRichEditFontNameComboBoxProperties;
end;

procedure TdxRichEditFontNameComboBox.SetProperties
  (Value: TdxRichEditFontNameComboBoxProperties);
begin
