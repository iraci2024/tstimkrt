...
uses
  ...
  cxGridWizardCustomPage, cxGridWizardStrs, cxGridLayoutView,
  cxGridCustomTableView, dxLayoutLookAndFeels,
  cxGridCustomLayoutView, cxTextEdit, cxMaskEdit, cxDropDownEdit,
  cxCheckComboBox, cxNavigator;

type
  { TcxGridWizardLayoutViewOptionsInterfaceElementsPageFrame }

  TcxGridWizardLayoutViewOptionsInterfaceElementsPageFrame = class
...
procedure TcxGridWizardLayoutViewOptionsInterfaceElementsPageFrame.
  ApplyLocalization;
begin
  ...
  chbRecordCaption.Caption := cxGetResourceString
    (@scxgwUIElementsPageRecordCaption);
  chbRecordCaption.Hint := cxGetResourceString
...
function TcxGridWizardLayoutViewOptionsInterfaceElementsPageFrame.
