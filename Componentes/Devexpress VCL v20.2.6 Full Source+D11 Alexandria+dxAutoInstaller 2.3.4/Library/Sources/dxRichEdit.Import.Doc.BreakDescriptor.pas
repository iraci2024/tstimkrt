...
type
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader; AOffset: Integer;
      ASize: Integer): TdxBreakDescriptorTable; static;
    procedure Write(AWriter: TBinaryWriter);
    ...
    property BreakDescriptors: TObjectList<TdxBreakDescriptor>
      read FBreakDescriptors;
  end;
...
class function TdxBreakDescriptor.FromStream(AReader: TBinaryReader)
  : TdxBreakDescriptor;
begin
...
class function TdxBreakDescriptorTable.FromStream(AReader: TBinaryReader;
  AOffset: Integer; ASize: Integer): TdxBreakDescriptorTable;
begin
  Result := TdxBreakDescriptorTable.Create;
  Result.Read(AReader, AOffset, ASize);
end;

procedure TdxBreakDescriptorTable.Read(AReader: TBinaryReader; AOffset: Integer;
  ASize: Integer);
var
  ACount, I: Integer;
begin
  ...
  ACount := (ASize - TdxDocConstants.CharacterPositionSize)
    div (TdxDocConstants.CharacterPositionSize + TdxBreakDescriptor.Size);
