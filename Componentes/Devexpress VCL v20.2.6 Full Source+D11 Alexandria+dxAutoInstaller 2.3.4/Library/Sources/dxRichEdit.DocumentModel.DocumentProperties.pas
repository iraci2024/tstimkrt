...
type
  ...
  TdxDocumentPropertiesChangeType = (None = 0, DefaultTabWidth,
    HyphenateDocument, DifferentOddAndEvenPages, PageBackColor,
    DisplayBackgroundShape, UpdateDocVariablesBeforePrint, BatchUpdate);

  TdxUpdateDocVariablesBeforePrint = (Auto, Always, Never);
  ...
  public
    ...
    property HyphenateDocument: Boolean read FHyphenateDocument
      write FHyphenateDocument;
    property DifferentOddAndEvenPages: Boolean read FDifferentOddAndEvenPages
      write FDifferentOddAndEvenPages;
    property PageBackColor: TdxAlphaColor read FPageBackColor
      write FPageBackColor;
    property DisplayBackgroundShape: Boolean read FDisplayBackgroundShape
      write FDisplayBackgroundShape;
    property UpdateDocVariablesBeforePrint: TdxUpdateDocVariablesBeforePrint
      read FUpdateDocVariablesBeforePrint write FUpdateDocVariablesBeforePrint;
  end;
  ...
  public const
    UpdateDocVariableFieldsBeforePrintDocVarName =
      '__dx_updateDocVarBeforePrint';
  private
    ...
    procedure SetUpdateDocVariablesBeforePrint(const Value
  ...
  strict protected
    ...
    function SetUpdateDocVariablesBeforePrintCore(const AInfo: TdxDocumentInfo;
      const AValue: TdxUpdateDocVariablesBeforePrint)
    ...
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxDocumentInfo>; override;
  ...
  public
    ...
    procedure SetUpdateFieldsBeforePrintFromDocVar(const AValue
      : string); virtual;

    property DefaultTabWidth: Integer read GetDefaultTabWidth
      write SetDefaultTabWidth;
    property HyphenateDocument: Boolean read GetHyphenateDocument
      write SetHyphenateDocument;
    ...
    property UpdateDocVariablesBeforePrint: TdxUpdateDocVariablesBeforePrint
      read GetUpdateDocVariablesBeforePrint
      write SetUpdateDocVariablesBeforePrint;
    property OnPageBackgroundChanged: TdxEvent read FOnPageBackgroundChanged
  ...
  public
    class function CalculateChangeActions
      (AChange: TdxDocumentPropertiesChangeType)
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxDocumentInfo; override;
  end;

  TdxEncryptionPasswordQueryEvent = function(Sender: TObject;
    var APassword: string): Boolean of object;
...
constructor TdxDocumentProperties.Create(ADocumentModel
...
const
  AResultMap: array [TdxUpdateDocVariablesBeforePrint] of string = ('',
    'always', 'never');
begin
  Result := AResultMap[UpdateDocVariablesBeforePrint];
end;

procedure TdxDocumentProperties.SetUpdateFieldsBeforePrintFromDocVar
  (const AValue: string);
begin
...
function TdxDocumentProperties.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxDocumentPropertiesChangeActionsCalculator.CalculateChangeActions
    (TdxDocumentPropertiesChangeType.BatchUpdate);
end;

function TdxDocumentProperties.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxDocumentInfo>;
begin
...
function TdxDocumentProperties.SetDefaultTabWidthCore
  (const AInfo: TdxDocumentInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.DefaultTabWidth := AValue;
  Result := TdxDocumentPropertiesChangeActionsCalculator.CalculateChangeActions
    (TdxDocumentPropertiesChangeType.DefaultTabWidth);
end;

procedure TdxDocumentProperties.SetDifferentOddAndEvenPages
  (const Value: Boolean);
begin
...
function TdxDocumentProperties.SetDifferentOddAndEvenPagesCore
  (const AInfo: TdxDocumentInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.DifferentOddAndEvenPages := AValue;
  Result := TdxDocumentPropertiesChangeActionsCalculator.CalculateChangeActions
    (TdxDocumentPropertiesChangeType.DifferentOddAndEvenPages);
end;
...
function TdxDocumentProperties.GetUpdateDocVariablesBeforePrint
  : TdxUpdateDocVariablesBeforePrint;
begin
  Result := Info.UpdateDocVariablesBeforePrint;
end;

procedure TdxDocumentProperties.SetUpdateDocVariablesBeforePrint
  (const Value: TdxUpdateDocVariablesBeforePrint);
begin
  if UpdateDocVariablesBeforePrint = Value then
    Exit;
  SetPropertyValue<TdxUpdateDocVariablesBeforePrint>
    (SetUpdateDocVariablesBeforePrintCore, Value);
end;

function TdxDocumentProperties.SetDisplayBackgroundShapeCore
  (const AInfo: TdxDocumentInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.DisplayBackgroundShape := AValue;
  Result := TdxDocumentPropertiesChangeActionsCalculator.CalculateChangeActions
    (TdxDocumentPropertiesChangeType.DisplayBackgroundShape);
end;

function TdxDocumentProperties.SetUpdateDocVariablesBeforePrintCore
  (const AInfo: TdxDocumentInfo; const AValue: TdxUpdateDocVariablesBeforePrint)
  : TdxDocumentModelChangeActions;
begin
  AInfo.UpdateDocVariablesBeforePrint := AValue;
  Result := TdxDocumentPropertiesChangeActionsCalculator.CalculateChangeActions
    (TdxDocumentPropertiesChangeType.UpdateDocVariablesBeforePrint);
end;
...
function TdxDocumentProperties.SetHyphenateDocumentCore
  (const AInfo: TdxDocumentInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.HyphenateDocument := AValue;
  Result := TdxDocumentPropertiesChangeActionsCalculator.CalculateChangeActions
    (TdxDocumentPropertiesChangeType.HyphenateDocument);
end;
...
function TdxDocumentProperties.SetPageBackColorCore
  (const AInfo: TdxDocumentInfo; const AValue: TdxAlphaColor)
  : TdxDocumentModelChangeActions;
begin
  AInfo.PageBackColor := AValue;
  Result := TdxDocumentPropertiesChangeActionsCalculator.CalculateChangeActions
    (TdxDocumentPropertiesChangeType.PageBackColor);
end;

{ TdxDocumentPropertiesChangeActionsCalculator }

class function TdxDocumentPropertiesChangeActionsCalculator.
  CalculateChangeActions(AChange: TdxDocumentPropertiesChangeType)
  : TdxDocumentModelChangeActions;
const
  DocumentPropertiesChangeActionsMap: array [TdxDocumentPropertiesChangeType]
...
function TdxDocumentInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxDocumentInfo;
begin
...
constructor TdxDocumentEncryptionProperties.Create
  (AOwner: TdxCustomDocumentModel);
begin
  inherited Create;
  FOwner := AOwner;
  FTryCount := 1;
