...
type
  ...
  strict private
    class procedure ConnectionStringKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure QueryKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure DataSourceKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure FieldMapDataKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
  protected
  ...
  strict private
    ...
    class constructor Initialize;
    class destructor Finalize;
    class function CreateControlCharTable
  ...
  public
    constructor Create(AImporter: TdxRtfImporter;
      const AModifier: TPropertyModifier); reintroduce;
  ...
  strict private
    ...
    class function CreateKeywordTable: TdxKeywordTranslatorTable; static;
  strict private
    class function GetFieldMapDataForEdit(AImporter: TdxRtfImporter)
      : TdxFieldMapData; static;
    class procedure NullFieldTypeKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure ColumnFieldTypeKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure AddressFieldTypeKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure SalutationFieldTypeKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure MappedFieldTypeKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure BarcodeFieldTypeKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure ColumnNameKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure MappedNameKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure ColumnIndexKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure DynamicAddressKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure LanguageIdKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
  protected
    class function GetControlCharHT: TdxControlCharTranslatorTable; override;
    class function GetKeywordHT: TdxKeywordTranslatorTable; override;
...
class function TdxMailMergeDestination.CreateKeywordTable
...
class procedure TdxMailMergeDestination.ConnectionStringKeywordHandler
...
class procedure TdxMailMergeDestination.QueryKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
  AProperties: TdxMailMergeProperties;
begin
...
class procedure TdxMailMergeDestination.DataSourceKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
  AProperties: TdxMailMergeProperties;
begin
...
class procedure TdxMailMergeDestination.FieldMapDataKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  AImporter.Destination := TdxFieldMapDataDestination.Create(AImporter);
end;

class function TdxMailMergeDestination.GetControlCharHT
...
constructor TdxStringPropertyBaseDestination.Create(AImporter: TdxRtfImporter;
const AModifier: TPropertyModifier);
begin
...
class function TdxStringPropertyBaseDestination.CreateControlCharTable
  : TdxControlCharTranslatorTable;
begin
...
class function TdxStringPropertyBaseDestination.GetControlCharHT
  : TdxControlCharTranslatorTable;
begin
  Result := FControlCharHT;
end;

class function TdxStringPropertyBaseDestination.GetKeywordHT
  : TdxKeywordTranslatorTable;
begin
  Result := nil;
end;
...
function TdxStringPropertyBaseDestination.CreateClone
...
class function TdxFieldMapDataDestination.CreateKeywordTable
  : TdxKeywordTranslatorTable;
begin
  Result := TdxKeywordTranslatorTable.Create;
...
class function TdxFieldMapDataDestination.GetFieldMapDataForEdit
  (AImporter: TdxRtfImporter): TdxFieldMapData;
var
  AFieldsMapData: TdxNotificationCollection<TdxFieldMapData>;
begin
  AFieldsMapData := AImporter.DocumentModel.MailMergeProperties.
    DataSourceObjectProperties.FieldsMapData;
  if AFieldsMapData.Count = 0 then
    AFieldsMapData.Add(TdxFieldMapData.Create);
  Result := AFieldsMapData[AFieldsMapData.Count - 1];
end;

class procedure TdxFieldMapDataDestination.NullFieldTypeKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
...
class procedure TdxFieldMapDataDestination.ColumnFieldTypeKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
  AFieldMapData: TdxFieldMapData;
begin
...
class procedure TdxFieldMapDataDestination.AddressFieldTypeKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
end;

class procedure TdxFieldMapDataDestination.SalutationFieldTypeKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
end;

class procedure TdxFieldMapDataDestination.MappedFieldTypeKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
end;

class procedure TdxFieldMapDataDestination.BarcodeFieldTypeKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
end;

class procedure TdxFieldMapDataDestination.ColumnNameKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
  AFieldMapData: TdxFieldMapData;
begin
...
class procedure TdxFieldMapDataDestination.MappedNameKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
  AFieldMapData: TdxFieldMapData;
begin
...
class procedure TdxFieldMapDataDestination.ColumnIndexKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
  AFieldMapData: TdxFieldMapData;
begin
...
class procedure TdxFieldMapDataDestination.DynamicAddressKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
  AFieldMapData: TdxFieldMapData;
begin
...
class procedure TdxFieldMapDataDestination.LanguageIdKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
  AFieldMapData: TdxFieldMapData;
begin
...
class function TdxFieldMapDataDestination.GetControlCharHT
  : TdxControlCharTranslatorTable;
begin
  Result := nil;
end;

class function TdxFieldMapDataDestination.GetKeywordHT
  : TdxKeywordTranslatorTable;
begin
  Result := FKeywordHT;
end;
