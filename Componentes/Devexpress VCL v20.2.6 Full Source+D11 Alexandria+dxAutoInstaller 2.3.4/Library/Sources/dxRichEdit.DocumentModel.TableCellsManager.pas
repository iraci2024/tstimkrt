...
type
  ...
  strict private
    function CreateChildNodes(AFirstCell: TdxTableCell)
      : TdxTableCellNodeSortedList;
    ...
    procedure GetCellsByParagraphIndexCore(AParagraphIndex: TdxParagraphIndex;
  ...
  protected
    ...
    function GetCellsByParagraphIndex(AParagraphIndex: TdxParagraphIndex;
      ANestedLevel: Integer): TdxTableCellList;
    function GetSubTree(AStart, AEnd: TdxParagraphIndex;
      AFromNestedLevel: Integer): TdxTableCellNode;
    procedure RemoveCellNode(ATargetCellNode, ASourceCellNode: TdxTableCellNode;
  ...
  public
    ...
    function GetCellByParagraphIndex(AParagraphIndex: TdxParagraphIndex)
      : TdxTableCell;
    ...
    function GetCellByNestingLevel(AParagraphIndex: TdxParagraphIndex;
      ANestingLevel: Integer; ACellFromPreviousLevel: TdxTableCell)
      : TdxTableCell;
    procedure OnParagraphRemove(AIndex: TdxParagraphIndex);
    function OnParagraphInserted(AIndex: TdxParagraphIndex;
      ACellToInsert: Boolean): TdxTableCellNode;
    procedure Remove(ACell: TdxTableCell);
    property Cell: TdxTableCell read FCell;
    property ChildNodes: TdxTableCellNodeSortedList read GetChildNodes
      write SetChildNodes;
  end;
  ...
  strict private
    ...
    function OnParagraphInsertedRecursive(AIndex: TdxParagraphIndex;
  ...
  public
    ...
    procedure OnParagraphRemove(AIndex: TdxParagraphIndex);
    procedure OnParagraphInserted(AIndex: TdxParagraphIndex;
      ACell: TdxTableCell);
    procedure Clear;
    procedure Remove(ACell: TdxTableCell);
    function GetCellByNestingLevel(AParagraphIndex: TdxParagraphIndex;
    ...
    function GetCellsByParagraphIndex(AParagraphIndex: TdxParagraphIndex;
      ANestedLevel: Integer): TdxTableCellList;
    function GetCellSubTree(AStartParagraphIndex, AEndParagraphIndex
      : TdxParagraphIndex; AFromNestedLevel: Integer): TdxTableCellNode;
  end;

  { TdxTableCellsManager }

  TdxTableCellsManager = class(TcxIUnknownObject,
...
{$ENDREGION}
    ...
    procedure OnRunJoined(AParagraphIndex: TdxParagraphIndex;
      ...
      ASplitOffset, ATailRunLength: Integer); overload;
    ...
    procedure OnRunInserted(AParagraphIndex: TdxParagraphIndex;
      ...
      : Integer); overload;
    procedure OnParagraphRemove(ASectionIndex: TdxSectionIndex;
      AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
...
function TdxTableCellNodeAndCellComparer.CompareTo(const AOther
  : TdxTableCellNode): Integer;
var
...
begin
  ...
  if IsNestedCell(AOtherCell, FCellToInsert) then
    ...
    Result := AOtherCell.StartParagraphIndex -
      FCellToInsert.StartParagraphIndex;
end;

function TdxTableCellNodeAndCellComparer.IsNestedCell(ANestedCell,
  AOuterCell: TdxTableCell): Boolean;
begin
  Result := (ANestedCell.StartParagraphIndex >= AOuterCell.StartParagraphIndex)
    and (ANestedCell.EndParagraphIndex <= AOuterCell.EndParagraphIndex);
end;
...
function TdxTableCellNodeComparer.Compare(const X, Y: TdxTableCellNode)
  : Integer;
begin
...
constructor TdxTableCellNodeAndParagraphIndexComparer.Create
...
begin
  if FIndex < AOther.Cell.StartParagraphIndex then
    Result := 1
  else if FIndex > AOther.Cell.EndParagraphIndex then
    Result := -1
  else
    Result := 0;
end;
  ...
  begin
    ...
    begin
      ...
      while (ANextCellIndex < ChildNodes.Count) and
        ((ChildNodes[ANextCellIndex].Cell.EndParagraphIndex <
        ACell.EndParagraphIndex) or
        (ChildNodes[ANextCellIndex].Cell.EndParagraphIndex = ACell.
        EndParagraphIndex) and
        (ChildNodes[ANextCellIndex].Cell.Table.NestedLevel >
        ACell.Table.NestedLevel)) do
      begin
        ANextNode := ChildNodes[ANextCellIndex];
...
procedure TdxTableCellNode.AddChildAtPosition(ACell: TdxTableCell;
  APosition: Integer);
var
...
function TdxTableCellNode.CreateChildNodes(AFirstCell: TdxTableCell)
  : TdxTableCellNodeSortedList;
begin
...
function TdxTableCellNode.GetCellByNestingLevel(AParagraphIndex
  : TdxParagraphIndex; ANestingLevel: Integer;
  ACellFromPreviousLevel: TdxTableCell): TdxTableCell;
var
  AIndex: Integer;
...
begin
  ...
  AComparer := TdxTableCellNodeAndParagraphIndexComparer.Create
    (AParagraphIndex);
  ...
  if ACellNode.Table.NestedLevel = ANestingLevel then
    ...
    Result := ANode.GetCellByNestingLevel(AParagraphIndex, ANestingLevel,
      ACellNode);
end;

function TdxTableCellNode.GetCellByParagraphIndex(AParagraphIndex
  : TdxParagraphIndex): TdxTableCell;
var
  AIndex: Integer;
  AComparer: TdxTableCellNodeAndParagraphIndexComparer;
begin
...
function TdxTableCellNode.GetCellsByParagraphIndex(AParagraphIndex
  : TdxParagraphIndex; ANestedLevel: Integer): TdxTableCellList;
begin
  Result := TdxTableCellList.Create;
  GetCellsByParagraphIndexCore(AParagraphIndex, ANestedLevel, Result);
end;

procedure TdxTableCellNode.GetCellsByParagraphIndexCore(AParagraphIndex
  : TdxParagraphIndex; ANestedLevel: Integer; ACells: TdxTableCellList);
var
  AIndex: Integer;
  ANode: TdxTableCellNode;
...
begin
  ...
  begin
    ...
    for I := not AStartIndex to AEndIndex do
      if (ChildNodes[I].Cell.StartParagraphIndex <= AEnd) and
        (ChildNodes[I].Cell.EndParagraphIndex <= AEnd) then
  ...
  begin
    ...
    begin
      ...
      AAnother := ChildNodes[AEndIndex].GetSubTree(AStart, AEnd,
        AFromNestedLevel);
  ...
  if (ACurrentNode.Cell.StartParagraphIndex >= AStart) and
    (ACurrentNode.Cell.EndParagraphIndex <= AEnd) then
  begin
    Result.ChildNodes.Add(ACurrentNode.GetReference);
...
function TdxTableCellNode.IsParagraphInCell(AParagraphIndex
...
begin
  if FCell <> nil then
  begin
    Assert((FCell.StartParagraphIndex <= AIndex) and
      (AIndex <= FCell.EndParagraphIndex));
  ...
  else if not ACellToInsert then
    Inc(ANextCellIndex);
...
procedure TdxTableCellNode.RecalcNestedLevelRecursive
  (ACellNode: TdxTableCellNode);
var
  I: Integer;
...
begin
  ...
  begin
    ...
    else if (ACell.StartParagraphIndex >= ANestedCell.StartParagraphIndex) and
...
procedure TdxTableCellNode.RemoveCellNode(ATargetCellNode, ASourceCellNode
  : TdxTableCellNode; AStart, AEnd: TdxParagraphIndex);
begin
end;
...
procedure TdxTableCellNode.ResetCachedTableLayoutInfo(AFrom,
...
procedure TdxTableCellNode.SetChildNodes(const Value
  : TdxTableCellNodeSortedList);
begin
  FChildNodes := Value;
end;
...
function TdxTableCellTree.GetCellByNestingLevel(AParagraphIndex
  : TdxParagraphIndex; ANestingLevel: Integer): TdxTableCell;
begin
  Result := FRoot.GetCellByNestingLevel(AParagraphIndex, ANestingLevel, nil);
end;

function TdxTableCellTree.GetCellByParagraphIndex(AIndex: TdxParagraphIndex)
  : TdxTableCell;
begin
  Result := FRoot.GetCellByParagraphIndex(AIndex);
end;

function TdxTableCellTree.GetCellsByParagraphIndex(AParagraphIndex
  : TdxParagraphIndex; ANestedLevel: Integer): TdxTableCellList;
begin
...
function TdxTableCellTree.GetCellSubTree(AStartParagraphIndex,
  AEndParagraphIndex: TdxParagraphIndex; AFromNestedLevel: Integer)
  : TdxTableCellNode;
begin
  Result := FRoot.GetSubTree(AStartParagraphIndex, AEndParagraphIndex,
    AFromNestedLevel);
end;
...
procedure TdxTableCellTree.OnParagraphInserted(AIndex: TdxParagraphIndex;
  ACell: TdxTableCell);
var
  ANode: TdxTableCellNode;
begin
...
function TdxTableCellTree.OnParagraphInsertedRecursive
  (AIndex: TdxParagraphIndex; ATargetCell: TdxTableCell): TdxTableCellNode;
var
  AParentNode: TdxTableCellNode;
begin
  if ATargetCell <> nil then
  begin
    AParentNode := OnParagraphInsertedRecursive(AIndex,
      ATargetCell.Table.ParentCell);
...
procedure TdxTableCellTree.ResetCachedTableLayoutInfo(AFrom,
  ATo: TdxParagraphIndex);
begin
...
procedure TdxTableCellsManager.ConvertParagraphsIntoTableCells
  (ARow: TdxTableRow; AParagraphIndex: TdxParagraphIndex;
...
function TdxTableCellsManager.CreateTableCore(AFirstParagraphIndex
  : TdxParagraphIndex; ARowCount, ACellCount: Integer): TdxTable;
var
  ACell: TdxTableCell;
...
procedure TdxTableCellsManager.InitializeTableCell(ACell: TdxTableCell;
  AStartParagraphIndex, AEndParagraphIndex: TdxParagraphIndex);
begin
...
procedure TdxTableCellsManager.OnParagraphInserted
...
procedure TdxTableCellsManager.OnParagraphRemoved
  (APieceTable: TdxCustomPieceTable; ASectionIndex: TdxSectionIndex;
  AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
  AHistoryNotificationId: Integer);
begin
  Assert(PieceTable = APieceTable);
  OnParagraphRemove(ASectionIndex, AParagraphIndex, ARunIndex,
    AHistoryNotificationId);
end;

procedure TdxTableCellsManager.OnParagraphMerged(APieceTable
...
procedure TdxTableCellsManager.OnRunInserted(APieceTable: TdxCustomPieceTable;
  AParagraphIndex: TdxParagraphIndex; ANewRunIndex: TdxRunIndex;
...
procedure TdxTableCellsManager.OnRunRemoved(APieceTable: TdxCustomPieceTable;
...
procedure TdxTableCellsManager.OnBeginMultipleRunSplit
  (APieceTable: TdxCustomPieceTable);
begin
end;

procedure TdxTableCellsManager.OnEndMultipleRunSplit
  (APieceTable: TdxCustomPieceTable);
begin
end;

procedure TdxTableCellsManager.OnRunSplit(APieceTable: TdxCustomPieceTable;
  AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
...
procedure TdxTableCellsManager.OnRunJoined(APieceTable: TdxCustomPieceTable;
  AParagraphIndex: TdxParagraphIndex; AJoinedRunIndex: TdxRunIndex;
...
procedure TdxTableCellsManager.OnRunMerged(APieceTable: TdxCustomPieceTable;
  AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
...
procedure TdxTableCellsManager.OnRunUnmerged(APieceTable: TdxCustomPieceTable;
  AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
  ADeltaRunLength: Integer);
begin
  Assert(PieceTable = APieceTable);
...
procedure TdxTableCellsManager.OnFieldRemoved(APieceTable: TdxCustomPieceTable;
  AFieldIndex: Integer);
begin
  Assert(PieceTable = APieceTable);
...
procedure TdxTableCellsManager.OnFieldInserted(APieceTable: TdxCustomPieceTable;
  AFieldIndex: Integer);
begin
  Assert(PieceTable = APieceTable);
...
procedure TdxTableCellsManager.OnParagraphInserted(ASectionIndex
...
procedure TdxTableCellsManager.OnParagraphMerged(ASectionIndex: TdxSectionIndex;
  AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
  AHistoryNotificationId: Integer);
begin
...
procedure TdxTableCellsManager.OnParagraphRemove(ASectionIndex: TdxSectionIndex;
  AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
  AHistoryNotificationId: Integer);
begin
...
procedure TdxTableCellsManager.OnRunInserted(AParagraphIndex: TdxParagraphIndex;
  ANewRunIndex: TdxRunIndex; ALength, AHistoryNotificationId: Integer);
begin
end;

procedure TdxTableCellsManager.OnRunJoined(AParagraphIndex: TdxParagraphIndex;
  AJoinedRunIndex: TdxRunIndex; ASplitOffset, ATailRunLength: Integer);
begin
end;

procedure TdxTableCellsManager.OnRunMerged(AParagraphIndex: TdxParagraphIndex;
  ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
end;

procedure TdxTableCellsManager.OnRunRemoved(AParagraphIndex: TdxParagraphIndex;
  ARunIndex: TdxRunIndex; ALength, AHistoryNotificationId: Integer);
begin
end;

procedure TdxTableCellsManager.OnRunSplit(AParagraphIndex: TdxParagraphIndex;
  ARunIndex: TdxRunIndex; ASplitOffset: Integer);
begin
end;

procedure TdxTableCellsManager.OnRunUnmerged(AParagraphIndex: TdxParagraphIndex;
  ARunIndex: TdxRunIndex; ADeltaRunLength: Integer);
begin
end;
...
procedure TdxTableCellsManager.ResetCachedTableLayoutInfo(AFrom,
  ATo: TdxParagraphIndex);
var
  I: Integer;
...
procedure TdxTableCellsManager.RevertParagraphsFromTableCells
  (ARow: TdxTableRow);
var
  ACell: TdxTableCell;
  ACellIndex: Integer;
...
function TdxTableCellsManager.GetCell(AParagraph: TdxParagraphBase)
  : TdxTableCell;
begin
  Result := CellTree.GetCellByParagraphIndex(AParagraph.Index);
end;

function TdxTableCellsManager.GetCellByNestingLevel(AParagraphIndex
  : TdxParagraphIndex; ANestingLevel: Integer): TdxTableCell;
begin
  Result := CellTree.GetCellByNestingLevel(AParagraphIndex, ANestingLevel);
end;

function TdxTableCellsManager.GetCellsByParagraphIndex(AParagraphIndex
  : TdxParagraphIndex; ANestedLevel: Integer): TdxTableCellList;
begin
  Result := CellTree.GetCellsByParagraphIndex(AParagraphIndex, ANestedLevel);
end;

function TdxTableCellsManager.GetCellSubTree(AStartParagraphIndex,
  AEndParagraphIndex: TdxParagraphIndex; AFromNestedLevel: Integer)
  : TdxTableCellNode;
begin
  Result := CellTree.GetCellSubTree(AStartParagraphIndex, AEndParagraphIndex,
    AFromNestedLevel);
end;
