...
uses
  SysUtils, Classes, dxCore, dxCoreClasses, Generics.Defaults,
...
type
  ...
  IdxServiceCreatorCallback = interface
    ...
    function GetService(const AManager: TdxServiceManager;
      const AServiceType: TdxServiceType): IInterface;
  ...
  TdxServiceManager = class(TcxIUnknownObject, IdxServiceContainer,
    IdxServiceProvider)
  strict private
  ...
  public
    ...
    property Services: TObjectDictionary<TdxServiceType, IInterface>
      read FServices;
  ...
  protected
    ...
    class function ReplaceService(const AContainer: IdxServiceContainer;
      const ANewService: IInterface): T; static;
  end;
...
function TdxServiceManager.GetService(const AServiceType: TdxServiceType)
  : IInterface;
var
...
function TdxServiceManager.ServiceExists(const AServiceType
  : TdxServiceType): Boolean;
begin
  Result := FServices.ContainsKey(AServiceType);
end;

procedure TdxServiceManager.AddService(const AServiceType: TdxServiceType;
...
class function TdxServiceUtils<T>.GetService(const AProvider
  : IdxServiceProvider): T;
var
  AObj: T;
  AObject: IInterface;
  AGuid: TGUID;
...
class function TdxServiceUtils<T>.ReplaceService(const AContainer
  : IdxServiceContainer; const ANewService: IInterface): T;
var
  AGuid: TGUID;
begin
  AGuid := GetGuid;
