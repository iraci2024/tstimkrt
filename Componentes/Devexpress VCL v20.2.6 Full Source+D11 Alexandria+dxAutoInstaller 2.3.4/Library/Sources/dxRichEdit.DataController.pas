...
type
  ...
  IdxDataControllerCurrentSupport = interface
    ...
    procedure CurrentControllerRowObjectChanged
      (const E: TdxCurrentRowChangedEventArgs);
  end;
  ...
  public
    ...
    function GetCurrentRowValue(AColumnIndex: Integer): Variant;
      virtual; abstract;
  ...
  TdxRichEditDataControllerAdapterBase = class abstract
    (TdxOfficeDataControllerAdapterBase)
  public
  ...
  public
    ...
    function IsRowFit(AListSourceRow: Integer; AFit: Boolean)
      : TdxNullableBoolean;
    procedure CurrentControllerRowChanged(const E: TdxCurrentRowEventArgs);
    procedure CurrentControllerRowObjectChanged
      (const E: TdxCurrentRowChangedEventArgs);
...
constructor TdxCurrentRowChangedEventArgs.Create(APreviousRow,
  ACurrentRow: TdxDataRow);
begin
  inherited Create;
...
function TdxRichEditDataControllerAdapter.GetDataController
  : TdxOfficeDataController;
begin
...
procedure TdxRichEditDataControllerAdapter.SetDataSource
  (const AValue: TDataSource);
begin
  DataController.DataSource := AValue;
end;

procedure TdxRichEditDataControllerAdapter.SetMergeRecords
  (const Value: TdxMergeRecords);
begin
...
function TdxRichEditDataControllerAdapter.GetColumnNames
  : TArray<TdxMergeFieldName>;
var
...
begin
  if (DataController.DataSource = nil) or
    (DataController.DataSource.DataSet = nil) then
    Exit(nil);
  ...
  try
    for AField in ADataSet.Fields do
      AMergeFieldNames.Add(TdxMergeFieldName.Create(AField.FieldName,
        AField.DisplayLabel));
...
function TdxRichEditDataControllerAdapter.GetColumnIndex
...
function TdxRichEditDataControllerAdapter.GetCurrentRowValue
  (AColumnIndex: Integer): Variant;
begin
...
procedure TdxRichEditDataControllerAdapter.ListSourceChanged(ASender: TObject;
  E: TdxEventArgs);
begin
...
procedure TdxRichEditDataControllerAdapter.CurrentControllerRowChanged
  (const E: TdxCurrentRowEventArgs);
begin
  RaiseCurrentRowChangedEvent;
end;

procedure TdxRichEditDataControllerAdapter.CurrentControllerRowObjectChanged
  (const E: TdxCurrentRowChangedEventArgs);
begin
  RaiseCurrentRowChangedEvent;
end;
...
function TdxRichEditDataControllerAdapter.IsRowFit(AListSourceRow: Integer;
  AFit: Boolean): TdxNullableBoolean;
begin
...
constructor TdxOfficeDataControllerDataLink.Create
  (AController: TdxOfficeDataController);
begin
  inherited Create;
...
function TdxOfficeDataController.GetCurrentRowValue
