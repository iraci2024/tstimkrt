...
type
  ...
  TdxShowParagraphFormCommand = class
    (TdxChangeParagraphFormattingCommandBase<TdxMergedParagraphProperties>)
  protected
    procedure ShowParagraphFormCallback(AProperties
      : TdxMergedParagraphProperties; ACallbackData: TObject); virtual;
    ...
    function CreateModifier(const AState: IdxCommandUIState)
      : TdxParagraphPropertyModifier<TdxMergedParagraphProperties>; override;
  ...
  TdxTabsFormCommandUIState = class
    (TdxDefaultObjectValueBasedCommandUIState<TdxTabFormattingInfo>)
  strict private
    FDefaultTabWidth: Integer;
    FTabsFormOwner: IdxFormOwner;
  public
    property DefaultTabWidth: Integer read FDefaultTabWidth
      write FDefaultTabWidth;
    property TabsFormOwner: IdxFormOwner read FTabsFormOwner
      write FTabsFormOwner;
  end;

  { TdxShowTabsFormCommand }

  TdxShowTabsFormCommand = class
    (TdxChangeParagraphFormattingCommandBase<TdxTabFormattingInfo>)
  strict private
    FTabFormOwner: IdxFormOwner;
  protected
    procedure ShowTabsFormCallback(ATabInfo: TdxTabFormattingInfo;
      ADefaultTabWidth: Integer; ACallbackData: TObject); virtual;
    function CreateModifier(const AState: IdxCommandUIState)
      : TdxParagraphPropertyModifier<TdxTabFormattingInfo>; override;
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
  ...
  public
    ...
    constructor Create(const AControl: IdxRichEditControl;
      const ATabFormOwner: IdxFormOwner); reintroduce; overload;
    procedure ForceExecute(const AState: IdxCommandUIState); override;
  ...
  protected
    procedure ShowNumberingListFormCallback(AParagraphs: TdxParagraphList;
  ...
  TdxShowTablePropertiesFormMenuCommand = class
    (TdxShowTablePropertiesFormCommand)
  protected
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
  public
  ...
  TdxShowPageSetupFormCommandBase = class abstract
    (TdxChangeSectionFormattingCommandBase<TdxPageSetupInfo>)
  protected
    function GetInitialTabPage: TdxPageSetupFormInitialTabPage;
      virtual; abstract;
    function GetShowsModalDialog: Boolean; override;
    procedure ShowPageSetupFormCallback(AProperties: TdxPageSetupInfo;
      ACallbackData: TObject); virtual;
    procedure ModifyDocumentModelCore(const AState: IdxCommandUIState);
      override;
    procedure ShowPageSetupForm(AProperties: TdxPageSetupInfo;
      const ACallback: TdxShowPageSetupFormCallback;
      ACallbackData: TObject); virtual;
    function CreateModifier(const AState: IdxCommandUIState)
      : TdxSectionPropertyModifier<TdxPageSetupInfo>; override;
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
    function GetCurrentPropertyValue: TdxPageSetupInfo;
    function CalculateApplyType(AMinSectionIndex: TdxSectionIndex;
      AMaxSectionIndex: TdxSectionIndex): TdxSectionPropertiesApplyType;
    function CalculateAvailableApplyTypes(AMinSectionIndex, AMaxSectionIndex
      : TdxSectionIndex): TdxSectionPropertiesApplyTypes;

    property InitialTabPage: TdxPageSetupFormInitialTabPage
      read GetInitialTabPage;
  public
    procedure ForceExecute(const AState: IdxCommandUIState); override;
    function CreateDefaultCommandUIState: IdxCommandUIState; override;
  end;
  ...
  TdxChangeSectionPaperKindCommand = class
    (TdxToggleChangeSectionFormattingCommandBase<TdxPaperKind>)
  strict private
  class var
  ...
  protected
    function CreateModifier(const AState: IdxCommandUIState)
      : TdxSectionPropertyModifier<TdxPaperKind>; override;
  ...
  public
    ...
    class property DefaultPaperKindList: TdxPaperKindList
      read FDefaultPaperKindList;
  ...
  TdxSetPortraitPageOrientationCommand = class
    (TdxToggleChangeSectionFormattingCommandBase<Boolean>)
  protected
    function CreateModifier(const AState: IdxCommandUIState)
      : TdxSectionPropertyModifier<Boolean>; override;
  ...
  TdxSetLandscapePageOrientationCommand = class
    (TdxToggleChangeSectionFormattingCommandBase<Boolean>)
  protected
    function CreateModifier(const AState: IdxCommandUIState)
      : TdxSectionPropertyModifier<Boolean>; override;
  ...
  TdxFindAndReplaceStringCommand = class abstract
  ...
  TdxShowFontFormCommand = class
    (TdxChangeCharacterFormattingCommandBase<TdxMergedCharacterProperties>)
  protected
    function GetShowsModalDialog: Boolean; override;
    procedure ShowFontFormCallback(AProperties: TdxMergedCharacterProperties;
      ACallbackData: TObject); virtual;
    procedure ShowFontForm(ACharacterProperties: TdxMergedCharacterProperties;
      const ACallback: TdxShowFontFormCallback;
      ACallbackData: TObject); virtual;
    function CreateModifier(const AState: IdxCommandUIState)
      : TdxRunPropertyModifier<TdxMergedCharacterProperties>; override;
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
    function ObtainRunsPropertyValue(const AStart: TdxDocumentModelPosition;
      ALength: Integer;
      AModifier: TdxRunPropertyModifier<TdxMergedCharacterProperties>;
      out AValue: TdxMergedCharacterProperties): Boolean; override;
  public
    procedure ForceExecute(const AState: IdxCommandUIState); override;
    function CreateDefaultCommandUIState: IdxCommandUIState; override;
  ...
  protected
    ...
    function CalculateRowCountAfterMerge(ASelectedCellsCollection
      : TdxSelectedCellsCollection): Integer;
    function ShouldIgnoreRow(ASelectedCellsInRow: TdxSelectedCellsIntervalInRow)
      : Boolean; virtual;
    function GetActualRowsCount(ASelectedCellsCollection
      : TdxSelectedCellsCollection; AIsSelectedCellsSquare: Boolean): Integer;
    procedure ShowSplitTableCellsFormCallback(const AParameters
      : TdxSplitTableCellsParameters; ACallbackData: TObject);
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
  public
    function CreateDefaultCommandUIState: IdxCommandUIState; override;
    procedure ForceExecute(const AState: IdxCommandUIState); override;
  ...
  TdxShowSplitTableCellsFormMenuCommand = class
    (TdxShowSplitTableCellsFormCommand)
  protected
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
  public
  ...
  TdxShowInsertDeleteTableCellsFormCommandBase = class abstract
    (TdxRichEditCommand)
  strict private
    FInsertDeleteTableCellsCommand
      : TdxInsertDeleteTableCellsDispatcherCommandBase;
  protected
    function GetShowsModalDialog: Boolean; override;
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;

    function CreateTableCellsCommand
      : TdxInsertDeleteTableCellsDispatcherCommandBase;
    class function GetTableCellsCommandClass: TdxRichEditCommandClass; virtual;
    {$IFDEF DELPHIXE2}abstract; {$ENDIF}
    function GetTableCellsOperation: TdxTableCellOperation; virtual; abstract;
    procedure ShowInsertDeleteTableCellsForm(const AParameters
      : TdxTableCellsParameters;
      const ACallback: TdxShowInsertDeleteTableCellsFormCallback;
      ACallbackData: TObject); virtual; abstract;
    procedure ShowInsertDeleteTableCellsFormCallback(const AParameters
      : TdxTableCellsParameters; ACallbackData: TObject);

    property InsertDeleteTableCellsCommand
      : TdxInsertDeleteTableCellsDispatcherCommandBase
      read FInsertDeleteTableCellsCommand;
  public
  ...
  TdxShowInsertTableCellsFormCommand = class
    (TdxShowInsertDeleteTableCellsFormCommandBase)
  protected
  ...
  TdxShowDeleteTableCellsFormCommand = class
    (TdxShowInsertDeleteTableCellsFormCommandBase)
  protected
    class function GetTableCellsCommandClass: TdxRichEditCommandClass; override;
    function GetTableCellsOperation: TdxTableCellOperation; override;
  ...
  TdxShowDeleteTableCellsFormMenuCommand = class
    (TdxShowDeleteTableCellsFormCommand)
  protected
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
  public
  ...
  TdxShowColumnsSetupFormCommand = class
    (TdxChangeSectionFormattingCommandBase<TdxColumnsInfoUI>)
  protected
    function GetShowsModalDialog: Boolean; override;
    procedure ShowColumnsSetupFormCallback(const AProperties: TdxColumnsInfoUI;
      ACallbackData: TObject);
    procedure ModifyDocumentModelCore(const AState: IdxCommandUIState);
      override;
    procedure ShowColumnsSetupForm(AProperties: TdxColumnsInfoUI;
      const ACallback: TdxShowColumnsSetupFormCallback; ACallbackData: TObject);
    function CreateModifier(const AState: IdxCommandUIState)
      : TdxSectionPropertyModifier<TdxColumnsInfoUI>; override;
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
    function GetCurrentPropertyValue: TdxColumnsInfoUI;
    function CalculateApplyType(AMinSectionIndex: TdxSectionIndex;
      AMaxSectionIndex: TdxSectionIndex): TdxSectionPropertiesApplyType;
    function CalculateAvailableApplyTypes(AMinSectionIndex: TdxSectionIndex;
      AMaxSectionIndex: TdxSectionIndex): TdxSectionPropertiesApplyTypes;
  public
    procedure ForceExecute(const AState: IdxCommandUIState); override;
    function CreateDefaultCommandUIState: IdxCommandUIState; override;
  ...
  protected
    function GetShowsModalDialog: Boolean; override;
    procedure ShowEditStyleFormCallback(ASourceStyle,
      ATargetStyle: TdxStyleBase);
    procedure ShowEditStyleForm(ASourceStyle: TdxParagraphStyle;
      AIndex: TdxParagraphIndex;
      const ACallback: TdxShowEditStyleFormCallback); overload;
    procedure ShowEditStyleForm(ASourceStyle: TdxCharacterStyle;
      AIndex: TdxParagraphIndex;
      const ACallback: TdxShowEditStyleFormCallback); overload;
    procedure ExecuteCore; override;
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
  public
    ...
    procedure ModifyParagraphStyle(AParagraphSourceStyle: TdxParagraphStyle;
      AParagraphStyle: TdxParagraphStyle);
    procedure ModifyCharacterStyle(ACharacterSourceStyle: TdxCharacterStyle;
  ...
  TdxShowFloatingObjectLayoutOptionsFormCommand = class
    (TdxSelectionBasedCommandBase)
  private type
    TdxObjectType = (FloatingObject, InlineObject, None);
  private
    FIsFloatingObject: TdxObjectType;
  protected
    function GetShowsModalDialog: Boolean; override;
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
    procedure ShowFloatingInlineObjectLayoutOptionsFormCallback
      (const AParameters: TdxFloatingInlineObjectParameters;
      AData: TObject); virtual;
  public
    constructor Create(const ARichEditControl: IdxRichEditControl); override;
    procedure ForceExecute(const AState: IdxCommandUIState); override;
  ...
  TdxShowLineNumberingFormCommand = class
    (TdxChangeSectionFormattingCommandBase<TdxLineNumberingInfo>)
  protected
    procedure ShowLineNumberingFormCallback(AProperties: TdxLineNumberingInfo;
      ACallbackData: TObject);
    procedure ShowLineNumberingForm(AProperties: TdxLineNumberingInfo;
      const ACallback: TdxShowLineNumberingFormCallback;
      ACallbackData: TObject);
    function CreateModifier(const AState: IdxCommandUIState)
      : TdxSectionPropertyModifier<TdxLineNumberingInfo>; override;
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
  ...
  protected
    procedure ExecuteCore; override;
    procedure GetDefaultExt(AExporters: TdxExporterList; out AExtension: string;
      out AIndex: Integer);
    function GetDocumentFormat(const AFileName: string;
      AExporters: TdxExporterList): TdxRichEditDocumentFormat;
    function CreateExportFilters(AExporters: TdxExporterList): string;
    procedure CalculateMailMergeOptions(const AMergeRecordsParameters
      : TdxMergeRecordsParameters;
      const AOptions: IdxRichEditMailMergeOptions); virtual;
    procedure MailMergeToNewControl(const AOptions
      : IdxRichEditMailMergeOptions);
    procedure MailMergeToNewFile(const AOptions: IdxRichEditMailMergeOptions);
    procedure MergeToNewDocument(const AMergeRecordsParameters
      : TdxMergeRecordsParameters); virtual;
  end;
  ...
  protected
    procedure ShowMergeDatabaseRecordsFormCallBack(const AMergeRecordsParameters
      : TdxMergeRecordsParameters; AData: TObject);
    procedure CalculateMailMergeOptions(const AMergeRecordsParameters
      : TdxMergeRecordsParameters;
  ...
  public
    constructor Create(const AControl: IdxRichEditControl;
      AStyle: TdxTableStyle = nil); reintroduce;
    procedure ForceExecute(const AState: IdxCommandUIState); override;
    procedure FindStyleAndShowForm;
  ...
  TdxShowRangeEditingPermissionsFormCommand = class
    (TdxRichEditMenuItemSimpleCommand)
  protected
    function GetShowsModalDialog: Boolean; override;
    procedure ExecuteCore; override;
  ...
  strict private
    ...
    procedure ConvertToLandscapeMargins(var ATop, ABottom, ALeft,
      ARight: Single);
    procedure ConvertToPortraitMargins(var ATop, ABottom, ALeft,
      ARight: Single);
  protected
...
function TdxShowParagraphFormCommand.CreateDefaultCommandUIState
  : IdxCommandUIState;
begin
  Result := TdxDefaultObjectValueBasedCommandUIState<
    TdxMergedParagraphProperties>.Create;
end;

function TdxShowParagraphFormCommand.CreateModifier(const AState
  : IdxCommandUIState)
  : TdxParagraphPropertyModifier<TdxMergedParagraphProperties>;
var
  AValueBasedState: IdxValueBasedCommandUIState<TdxMergedParagraphProperties>;
begin
  AValueBasedState :=
    AState as IdxValueBasedCommandUIState<TdxMergedParagraphProperties>;
  Result := TdxParagraphPropertiesModifier.Create(AValueBasedState.Value);
end;

procedure TdxShowParagraphFormCommand.ForceExecute(const AState
  : IdxCommandUIState);
var
  AValueBasedState: IdxValueBasedCommandUIState<TdxMergedParagraphProperties>;
begin
  ...
  try
    AValueBasedState :=
      AState as IdxValueBasedCommandUIState<TdxMergedParagraphProperties>;
    ShowParagraphForm(AValueBasedState.Value, ShowParagraphFormCallback,
      TObject(AState));
  finally
...
function TdxShowParagraphFormCommand.GetCurrentPropertyValue
  : TdxMergedParagraphProperties;
var
  I, ACount: Integer;
...
begin
  AModifier := TdxMergedParagraphPropertyModifier<TdxMergedParagraphProperties>
    (CreateModifier(CreateDefaultCommandUIState));
  try
    ...
    begin
      ...
      AProperties := ActivePieceTable.ObtainMergedParagraphsProperties
        (AStart.LogPosition, Max(1, AEnd.LogPosition - AStart.LogPosition),
        AModifier);
      try
        if Result <> nil then
        begin
...
procedure TdxShowParagraphFormCommand.ShowParagraphForm(AParagraphProperties
  : TdxMergedParagraphProperties; const ACallback: TdxShowParagraphFormCallback;
  ACallbackData: TObject);
begin
  RichEditControl.ShowParagraphForm(AParagraphProperties, ACallback,
    ACallbackData);
end;

procedure TdxShowParagraphFormCommand.ShowParagraphFormCallback
  (AProperties: TdxMergedParagraphProperties; ACallbackData: TObject);
var
  AValueBasedState: IdxValueBasedCommandUIState<TdxMergedParagraphProperties>;
begin
  if not Supports(ACallbackData,
    IdxValueBasedCommandUIState<TdxMergedParagraphProperties>, AValueBasedState)
  then
...
procedure TdxShowParagraphFormCommand.UpdateUIStateCore
...
begin
  ...
  if Supports(AState, IdxValueBasedCommandUIState<TdxMergedParagraphProperties>,
    AValueBasedState) then
...
constructor TdxShowTabsFormCommand.Create(const AControl: IdxRichEditControl;
  const ATabFormOwner: IdxFormOwner);
begin
...
procedure TdxShowTabsFormCommand.ShowTabsForm(ACommandState
  : TdxTabsFormCommandUIState);
begin
  RichEditControl.ShowTabsForm(ACommandState.Value,
    ACommandState.DefaultTabWidth, ShowTabsFormCallback, ACommandState);
end;

procedure TdxShowTabsFormCommand.ShowTabsFormCallback
  (ATabInfo: TdxTabFormattingInfo; ADefaultTabWidth: Integer;
  ACallbackData: TObject);
var
...
function TdxShowTabsFormCommand.CreateModifier(const AState: IdxCommandUIState)
  : TdxParagraphPropertyModifier<TdxTabFormattingInfo>;
var
  ACommandState: TdxTabsFormCommandUIState;
begin
  ACommandState := TdxTabsFormCommandUIState(AState);
  Result := TdxPieceTableModifiers.CreateTabFormattingInfoModifier
    (ACommandState.Value, ACommandState.DefaultTabWidth);
end;

procedure TdxShowTabsFormCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
var
  ACommandState: TdxTabsFormCommandUIState;
begin
  ...
  ApplyCommandRestrictionOnEditableControl(AState,
    DocumentModel.DocumentCapabilities.ParagraphTabs);
  ...
  ACommandState.DefaultTabWidth := DocumentModel.DocumentProperties.
    DefaultTabWidth;
end;
...
procedure TdxShowNumberingListFormCommand.ShowNumberingListFormCallback
  (AParagraphs: TdxParagraphList; AData: TObject);
begin
end;

procedure TdxShowNumberingListFormCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
var
...
begin
  ...
  AEnabled := AOptions.MultiLevelAllowed or AOptions.BulletedAllowed or
    AOptions.SimpleAllowed;
  ...
  AState.Visible := RichEditControl.CanShowNumberingListForm and
    ...
    (AOptions.MultiLevel <> TdxDocumentCapability.Hidden) or
    (AOptions.Simple <> TdxDocumentCapability.Hidden));
  ApplyDocumentProtectionToSelectedParagraphs(AState);
end;

procedure TdxShowNumberingListFormCommand.ForceExecute
  (const AState: IdxCommandUIState);
var
...
begin
  ...
  try
    NotifyBeginCommandExecution(AState);
    try
      RichEditControl.ShowNumberingListForm(AParagraphs,
        ShowNumberingListFormCallback, nil);
    finally
      NotifyEndCommandExecution(AState);
    end;
  finally
...
procedure TdxShowTablePropertiesFormCommand.ForceExecute
  (const AState: IdxCommandUIState);
var
...
procedure TdxShowTablePropertiesFormCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
...
procedure TdxShowTablePropertiesFormMenuCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  inherited UpdateUIStateCore(AState);
...
procedure TdxShowPageSetupFormCommandBase.ForceExecute
  (const AState: IdxCommandUIState);
var
...
begin
  ...
  try
    ...
    ShowPageSetupForm(AValueBasedState.Value, ShowPageSetupFormCallback,
      TObject(AState));
  finally
    NotifyEndCommandExecution(AState);
  end;
...
procedure TdxShowPageSetupFormCommandBase.ShowPageSetupFormCallback
  (AProperties: TdxPageSetupInfo; ACallbackData: TObject);
var
  AValueBasedState: IdxValueBasedCommandUIState<TdxPageSetupInfo>;
begin
  Supports(ACallbackData, IdxValueBasedCommandUIState<TdxPageSetupInfo>,
    AValueBasedState);
  AValueBasedState.Value := AProperties;
  inherited ForceExecute(AValueBasedState);
end;

procedure TdxShowPageSetupFormCommandBase.ModifyDocumentModelCore
  (const AState: IdxCommandUIState);
var
  AValueBasedState: IdxValueBasedCommandUIState<TdxPageSetupInfo>;
...
begin
  ...
  if AValueBasedState.Value.ApplyType = TdxSectionPropertiesApplyType.WholeDocument
  then
  begin
    APieceTable := ActivePieceTable;
    AStart := TdxDocumentModelPosition.FromParagraphStart(APieceTable, 0);
    AEnd := TdxDocumentModelPosition.FromParagraphEnd(APieceTable,
      APieceTable.Paragraphs.Count - 1);
    AActions := ChangeProperty(AStart, AEnd, AState);
    APieceTable.ApplyChangesCore(AActions, dxRunIndexDontCare,
      dxRunIndexDontCare);
  end
  else
...
procedure TdxShowPageSetupFormCommandBase.ShowPageSetupForm
  (AProperties: TdxPageSetupInfo; const ACallback: TdxShowPageSetupFormCallback;
  ACallbackData: TObject);
begin
  RichEditControl.ShowPageSetupForm(AProperties, ACallback, ACallbackData,
    InitialTabPage);
end;
...
begin
  AValueBasedState := AState as IdxValueBasedCommandUIState<TdxPageSetupInfo>;
  Result := TdxPieceTableModifiers.CreateSectionPageSetupModifier
    (AValueBasedState.Value);
end;

procedure TdxShowPageSetupFormCommandBase.UpdateUIStateCore
  (const AState: IdxCommandUIState);
var
  AValueBasedState: IdxValueBasedCommandUIState<TdxPageSetupInfo>;
begin
...
function TdxShowPageSetupFormCommandBase.GetCurrentPropertyValue
  : TdxPageSetupInfo;
var
...
begin
  ...
  try
    ...
    begin
      ...
      AStart := CalculateStartPosition(AItem, False);
      AEnd := CalculateEndPosition(AItem, False);
      AProperties := AModifier.ObtainMergedSectionsPropertyValue(DocumentModel,
        AStart.LogPosition, Math.Max(1, AEnd.LogPosition - AStart.LogPosition));
      if Result <> nil then
        try
    ...
    Result.AvailableApplyType := CalculateAvailableApplyTypes(AMinSectionIndex,
      AMaxSectionIndex);
  finally
    AModifier.Free;
  end;
...
function TdxShowPageSetupFormCommandBase.CalculateApplyType(AMinSectionIndex
  : TdxSectionIndex; AMaxSectionIndex: TdxSectionIndex)
...
function TdxShowPageSetupFormCommandBase.CalculateAvailableApplyTypes
  (AMinSectionIndex, AMaxSectionIndex: TdxSectionIndex)
  : TdxSectionPropertiesApplyTypes;
begin
  if DocumentModel.Sections.Count = 1 then
    Exit([TdxSectionPropertiesApplyType.WholeDocument]);
  ...
  if AMinSectionIndex = AMaxSectionIndex then
    Exit([TdxSectionPropertiesApplyType.CurrentSection,
      TdxSectionPropertiesApplyType.WholeDocument]);

  Result := [TdxSectionPropertiesApplyType.SelectedSections,
    TdxSectionPropertiesApplyType.WholeDocument];
end;

function TdxShowPageSetupFormCommandBase.CreateDefaultCommandUIState
  : IdxCommandUIState;
begin
...
function TdxShowPageSetupFormCommand.GetInitialTabPage
...
function TdxShowPageMarginsSetupFormCommand.GetInitialTabPage
  : TdxPageSetupFormInitialTabPage;
begin
  Result := TdxPageSetupFormInitialTabPage.Margins;
end;
...
function TdxShowPagePaperSetupFormCommand.GetInitialTabPage
  : TdxPageSetupFormInitialTabPage;
begin
...
constructor TdxChangeSectionPaperKindCommand.Create(const ARichEditControl
  : IdxRichEditControl);
begin
...
function TdxChangeSectionPaperKindCommand.CreateDefaultCommandUIState
  : IdxCommandUIState;
var
...
class function TdxChangeSectionPaperKindCommand.CreateDefaultPaperKindList
  : TdxPaperKindList;
begin
...
class function TdxChangeSectionPaperKindCommand.CreateFullPaperKindList
  : TdxPaperKindList;
var
...
begin
  ...
  for APaperKind := Low(TdxPaperKind) to High(TdxPaperKind) do
    if not(APaperKind in [TdxPaperKind.Custom, TdxPaperKind.Reserved_48,
      TdxPaperKind.Reserved_49]) then
...
procedure TdxChangeSectionPaperKindCommand.ForceExecute
  (const AState: IdxCommandUIState);
var
...
function TdxChangeSectionPaperKindCommand.IsCheckedValue
  (AValue: TdxPaperKind): Boolean;
begin
...
begin
  Result := TdxPieceTableModifiers.
    CreateSectionPageOrientationLandscapeModifier(False);
end;
...
function TdxSetPortraitPageOrientationCommand.IsCheckedValue
...
begin
  Result := TdxPieceTableModifiers.
    CreateSectionPageOrientationLandscapeModifier(True);
end;
...
function TdxSetLandscapePageOrientationCommand.IsCheckedValue
  (AValue: Boolean): Boolean;
begin
  Result := AValue;
end;
...
procedure TdxFindAndReplaceStringCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  AState.Enabled := True;
  AState.Visible := True;
...
begin
  ...
  try
    AValueBasedState :=
      AState as IdxValueBasedCommandUIState<TdxMergedCharacterProperties>;
    ShowFontForm(AValueBasedState.Value, ShowFontFormCallback,
      AState as TdxDefaultCommandUIState);
  finally
    NotifyEndCommandExecution(AState);
  end;
end;

procedure TdxShowFontFormCommand.ShowFontFormCallback
  (AProperties: TdxMergedCharacterProperties; ACallbackData: TObject);
var
  AValueBasedState: IdxValueBasedCommandUIState<TdxMergedCharacterProperties>;
begin
  Supports(ACallbackData,
    IdxValueBasedCommandUIState<TdxMergedCharacterProperties>,
    AValueBasedState);
  AValueBasedState.Value := AProperties;
  inherited ForceExecute(AValueBasedState);
end;

procedure TdxShowFontFormCommand.ShowFontForm(ACharacterProperties
...
function TdxShowFontFormCommand.CreateModifier(const AState: IdxCommandUIState)
  : TdxRunPropertyModifier<TdxMergedCharacterProperties>;
var
  AValueBasedState: IdxValueBasedCommandUIState<TdxMergedCharacterProperties>;
begin
  AValueBasedState :=
...
procedure TdxShowFontFormCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
var
  AValueBasedState: IdxValueBasedCommandUIState<TdxMergedCharacterProperties>;
...
function TdxShowFontFormCommand.ObtainRunsPropertyValue
  (const AStart: TdxDocumentModelPosition; ALength: Integer;
  AModifier: TdxRunPropertyModifier<TdxMergedCharacterProperties>;
  out AValue: TdxMergedCharacterProperties): Boolean;
begin
  AValue := AModifier.ObtainMergedRunsPropertyValue(ActivePieceTable,
...
begin
  Result := TdxDefaultObjectValueBasedCommandUIState<
    TdxMergedCharacterProperties>.Create;
end;

{ TdxShowSymbolFormCommand }

function TdxShowSymbolFormCommand.CreateDefaultCommandUIState
  : IdxCommandUIState;
var
...
procedure TdxShowSymbolFormCommand.ForceExecute(const AState
  : IdxCommandUIState);
var
...
begin
  ...
  begin
    AModifier := TdxPieceTableModifiers.CreateRunFontNamePropertyModifier
      (AValueState.Value.FontName);
    try
      ARun := ActivePieceTable.Runs
        [DocumentModel.Selection.Interval.NormalizedEnd.RunIndex];
  ...
  NotifyBeginCommandExecution(AState);
  try
    ASymbolProperties := TdxSymbolProperties.Create
      (AValueState.Value.UnicodeChar, AValueState.Value.FontName);
...
procedure TdxShowSymbolFormCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
begin
  ActiveView.CheckExecutedAtUIThread;
  AState.Enabled := IsContentEditable;
...
function TdxShowSplitTableCellsFormCommand.CreateDefaultCommandUIState
  : IdxCommandUIState;
begin
  Result := TdxDefaultValueBasedCommandUIState<
    TdxSplitTableCellsParameters>.Create;
end;

procedure TdxShowSplitTableCellsFormCommand.ForceExecute
  (const AState: IdxCommandUIState);
var
...
begin
  ...
  try
    AValueBasedState :=
      AState as IdxValueBasedCommandUIState<TdxSplitTableCellsParameters>;
    AValueBasedState.Value := GetSplitTableCellsParameters;

    RichEditControl.ShowSplitTableCellsForm(AValueBasedState.Value,
      ShowSplitTableCellsFormCallback, AState as TObject);
  finally
    NotifyEndCommandExecution(AState);
  end;
end;

function TdxShowSplitTableCellsFormCommand.GetActualRowsCount
...
begin
  ...
  begin
    AColumnIndex := TdxTableCellVerticalBorderCalculator.GetStartColumnIndex
      (ASelectedCellsCollection.NormalizedFirst.NormalizedStartCell, False);
...
function TdxShowSplitTableCellsFormCommand.GetSplitTableCellsParameters
...
begin
  ...
  ASelectedCellsInRowCount := ASelectedCellsCollection.NormalizedFirst.
    NormalizedLength;
  AIsSelectedCellsSquare := ASelectedCellsCollection.IsSquare;
  AIsMergeCellsBeforeSplit := AIsSelectedCellsSquare and
    ((ASelectedCellsCollection.RowsCount > 1) or
    (ASelectedCellsInRowCount > 0));
  ...
  if AIsMergeCellsBeforeSplit then
    ...
    ARowCountAfterMerge := GetActualRowsCount(ASelectedCellsCollection,
      AIsSelectedCellsSquare);

  Result := TdxSplitTableCellsParameters.Create(AColumnsCount,
    ASelectedCellsCollection.RowsCount, AIsMergeCellsBeforeSplit,
    ARowCountAfterMerge);
  Result.IsSelectedCellsSquare := AIsSelectedCellsSquare;
end;

function TdxShowSplitTableCellsFormCommand.ShouldIgnoreRow(ASelectedCellsInRow
...
procedure TdxShowSplitTableCellsFormCommand.ShowSplitTableCellsFormCallback
  (const AParameters: TdxSplitTableCellsParameters; ACallbackData: TObject);
var
...
procedure TdxShowSplitTableCellsFormCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
...
procedure TdxShowSplitTableCellsFormMenuCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
var
  AIsSelectionInTable: Boolean;
begin
  AIsSelectionInTable := DocumentModel.Selection.IsWholeSelectionInOneTable;
  AState.Enabled := AIsSelectionInTable and
    DocumentModel.Selection.SelectedCells.SelectedOnlyOneCell;
  ApplyCommandRestrictionOnEditableControl(AState,
    DocumentModel.DocumentCapabilities.Tables, AState.Enabled);
  ApplyDocumentProtectionToSelectedParagraphs(AState);
  AState.Visible := AState.Enabled;
...
constructor TdxShowInsertDeleteTableCellsFormCommandBase.Create
...
function TdxShowInsertDeleteTableCellsFormCommandBase.
  CreateDefaultCommandUIState: IdxCommandUIState;
begin
...
class function TdxShowInsertDeleteTableCellsFormCommandBase.
...
class function TdxShowInsertDeleteTableCellsFormCommandBase.
  GetTableCellsCommandClass: TdxRichEditCommandClass;
begin
...
begin
  ...
  try
    AValueBasedState :=
      AState as IdxValueBasedCommandUIState<TdxTableCellsParameters>;
    AValueBasedState.Value := TdxTableCellsParameters.Create
      (GetTableCellsOperation);
    ShowInsertDeleteTableCellsForm(AValueBasedState.Value,
      ShowInsertDeleteTableCellsFormCallback, TObject(AState));
  finally
    NotifyEndCommandExecution(AState);
  end;
end;
...
function TdxShowInsertDeleteTableCellsFormCommandBase.
  GetShowsModalDialog: Boolean;
begin
  Result := True;
end;

function TdxShowInsertDeleteTableCellsFormCommandBase.CreateTableCellsCommand
  : TdxInsertDeleteTableCellsDispatcherCommandBase;
begin
  Result := TdxInsertDeleteTableCellsDispatcherCommandBase
    (GetTableCellsCommandClass.Create(RichEditControl));
end;

procedure TdxShowInsertDeleteTableCellsFormCommandBase.
  ShowInsertDeleteTableCellsFormCallback(const AParameters
  : TdxTableCellsParameters; ACallbackData: TObject);
var
  ATransaction: TdxHistoryTransaction;
...
begin
  ...
  try
    ...
    try
      ...
      begin
        AState := TdxDefaultValueBasedCommandUIState<
          TdxTableCellsParameters>.Create;
        AState.Value := AParameters;
...
class function TdxShowInsertTableCellsFormCommand.GetTableCellsCommandClass
  : TdxRichEditCommandClass;
begin
  Result := TdxInsertTableCellsDispatcherCommand;
end;

function TdxShowInsertTableCellsFormCommand.GetTableCellsOperation
...
procedure TdxShowInsertTableCellsFormCommand.ShowInsertDeleteTableCellsForm
  ...
  ACallbackData: TObject);
begin
  RichEditControl.ShowInsertTableCellsForm(AParameters, ACallback,
    ACallbackData);
end;

{ TdxShowDeleteTableCellsFormCommand }

class function TdxShowDeleteTableCellsFormCommand.GetTableCellsCommandClass
  : TdxRichEditCommandClass;
begin
  Result := TdxDeleteTableCellsDispatcherCommand;
end;

function TdxShowDeleteTableCellsFormCommand.GetTableCellsOperation
  : TdxTableCellOperation;
begin
...
procedure TdxShowDeleteTableCellsFormCommand.ShowInsertDeleteTableCellsForm
  ...
  ACallbackData: TObject);
begin
  RichEditControl.ShowDeleteTableCellsForm(AParameters, ACallback,
    ACallbackData);
end;
...
begin
  ...
  AState.Enabled := AState.Enabled and
    not ACellsCollection.IsSelectedEntireTableRows and
...
procedure TdxShowColumnsSetupFormCommand.ForceExecute
  (const AState: IdxCommandUIState);
var
...
begin
  ...
  try
    ...
    ShowColumnsSetupForm(AValueBasedState.Value, ShowColumnsSetupFormCallback,
      TObject(AState));
  finally
    NotifyEndCommandExecution(AState);
  end;
...
function TdxShowColumnsSetupFormCommand.CreateDefaultCommandUIState
  : IdxCommandUIState;
var
...
procedure TdxShowColumnsSetupFormCommand.ShowColumnsSetupFormCallback
  (const AProperties: TdxColumnsInfoUI; ACallbackData: TObject);
var
  AValueBasedState: IdxValueBasedCommandUIState<TdxColumnsInfoUI>;
begin
  if Supports(ACallbackData, IdxValueBasedCommandUIState<TdxColumnsInfoUI>,
    AValueBasedState) then
    AValueBasedState.Value := AProperties
  else
    TdxRichEditExceptions.ThrowInternalException;
...
procedure TdxShowColumnsSetupFormCommand.ModifyDocumentModelCore
  (const AState: IdxCommandUIState);
var
  AValueBasedState: IdxValueBasedCommandUIState<TdxColumnsInfoUI>;
  APieceTable: TdxPieceTable;
...
procedure TdxShowColumnsSetupFormCommand.ShowColumnsSetupForm
  (AProperties: TdxColumnsInfoUI;
  const ACallback: TdxShowColumnsSetupFormCallback; ACallbackData: TObject);
begin
  RichEditControl.ShowColumnsSetupForm(AProperties, ACallback, ACallbackData);
end;

function TdxShowColumnsSetupFormCommand.CreateModifier
  (const AState: IdxCommandUIState)
...
begin
  AValueBasedState := AState as IdxValueBasedCommandUIState<TdxColumnsInfoUI>;
  Result := TdxPieceTableModifiers.CreateSectionColumnsSetupModifier
    (AValueBasedState.Value);
end;

procedure TdxShowColumnsSetupFormCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
var
  AValueBasedState: IdxValueBasedCommandUIState<TdxColumnsInfoUI>;
begin
...
function TdxShowColumnsSetupFormCommand.GetCurrentPropertyValue
  : TdxColumnsInfoUI;
var
  ...
  try
    ...
    try
      ...
      begin
        ...
        AStart := CalculateStartPosition(AItem, False);
        AEnd := CalculateEndPosition(AItem, False);
        AProperties := AModifier.ObtainMergedSectionsPropertyValue
          (DocumentModel, AStart.LogPosition,
      ...
      Result.ApplyType := CalculateApplyType(AMinSectionIndex,
        AMaxSectionIndex);
      Result.AvailableApplyType := CalculateAvailableApplyTypes
        (AMinSectionIndex, AMaxSectionIndex);
    finally
      AModifier.Free;
    end;
  finally
...
function TdxShowColumnsSetupFormCommand.CalculateApplyType(AMinSectionIndex
  : TdxSectionIndex; AMaxSectionIndex: TdxSectionIndex)
  : TdxSectionPropertiesApplyType;
begin
  if DocumentModel.Sections.Count = 1 then
    Result := TdxSectionPropertiesApplyType.WholeDocument
  else if AMinSectionIndex = AMaxSectionIndex then
    Result := TdxSectionPropertiesApplyType.CurrentSection
  else
    Result := TdxSectionPropertiesApplyType.SelectedSections;
end;

function TdxShowColumnsSetupFormCommand.CalculateAvailableApplyTypes
  (AMinSectionIndex: TdxSectionIndex; AMaxSectionIndex: TdxSectionIndex)
  : TdxSectionPropertiesApplyTypes;
begin
  if DocumentModel.Sections.Count = 1 then
    Result := [TdxSectionPropertiesApplyType.WholeDocument]
...
constructor TdxShowEditStyleFormCommand.Create(const ARichEditControl
  : IdxRichEditControl);
begin
  inherited Create(ARichEditControl);
...
procedure TdxShowEditStyleFormCommand.ForceExecute(const AState
  : IdxCommandUIState);
begin
  CheckExecutedAtUIThread;
  NotifyBeginCommandExecution(AState);
...
begin
  ...
  begin
    ...
    if UseParagraphStyle then
      ShowEditStyleForm(AParagraphSourceStyle, AIndex,
        ShowEditStyleFormCallback)
    else
      ShowEditStyleForm(ACharacterSourceStyle, AIndex,
        ShowEditStyleFormCallback);
  end;
end;

procedure TdxShowEditStyleFormCommand.ModifyParagraphStyle(AParagraphSourceStyle
  : TdxParagraphStyle; AParagraphStyle: TdxParagraphStyle);
begin
  ...
  try
    ...
    AParagraphSourceStyle.NextParagraphStyle :=
      AParagraphStyle.NextParagraphStyle;
  finally
    AParagraphSourceStyle.EndUpdate;
  end;
end;

procedure TdxShowEditStyleFormCommand.ModifyCharacterStyle(ACharacterSourceStyle
  : TdxCharacterStyle; ACharacterStyle: TdxCharacterStyle);
begin
...
procedure TdxShowEditStyleFormCommand.ShowEditStyleFormCallback(ASourceStyle,
  ATargetStyle: TdxStyleBase);
var
...
procedure TdxShowEditStyleFormCommand.ShowEditStyleForm
  (ASourceStyle: TdxParagraphStyle; AIndex: TdxParagraphIndex;
...
procedure TdxShowEditStyleFormCommand.ShowEditStyleForm
  (ASourceStyle: TdxCharacterStyle; AIndex: TdxParagraphIndex;
  const ACallback: TdxShowEditStyleFormCallback);
begin
  RichEditControl.ShowEditStyleForm(ASourceStyle, AIndex, ACallback);
end;
...
procedure TdxShowEditStyleFormCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  CheckExecutedAtUIThread;

  ApplyCommandRestrictionOnEditableControl(AState,
    DocumentModel.DocumentCapabilities.CharacterStyle);
  ApplyCommandRestrictionOnEditableControl(AState,
    DocumentModel.DocumentCapabilities.ParagraphStyle);
  ApplyDocumentProtectionToSelectedParagraphs(AState);
end;

{ TdxShowFloatingObjectLayoutOptionsFormCommand }

constructor TdxShowFloatingObjectLayoutOptionsFormCommand.Create
  (const ARichEditControl: IdxRichEditControl);
begin
  inherited Create(ARichEditControl);
...
procedure TdxShowFloatingObjectLayoutOptionsFormCommand.ForceExecute
  (const AState: IdxCommandUIState);
var
...
begin
  ...
  try
    ...
    begin
      AFloatingObjectAnchorRun := Safe<TdxFloatingObjectAnchorRun>.Cast
        (ActivePieceTable.Runs[DocumentModel.Selection.Interval.NormalizedStart.
        RunIndex]);
      RichEditControl.ShowFloatingInlineObjectLayoutOptionsForm
        (TdxFloatingInlineObjectParameters.Create(AFloatingObjectAnchorRun),
        ShowFloatingInlineObjectLayoutOptionsFormCallback, nil);
    end
    else if FIsFloatingObject = TdxObjectType.InlineObject then
    begin
      AInlinePictureRun := Safe<TdxInlinePictureRun>.Cast
        (ActivePieceTable.Runs[DocumentModel.Selection.Interval.NormalizedStart.
        RunIndex]);
      RichEditControl.ShowFloatingInlineObjectLayoutOptionsForm
        (TdxFloatingInlineObjectParameters.Create(AInlinePictureRun),
        ShowFloatingInlineObjectLayoutOptionsFormCallback, nil);
    end;
  finally
    NotifyEndCommandExecution(AState);
...
class function TdxShowFloatingObjectLayoutOptionsFormCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
function TdxShowFloatingObjectLayoutOptionsFormCommand.
  GetShowsModalDialog: Boolean;
begin
  Result := True;
end;

class function TdxShowFloatingObjectLayoutOptionsFormCommand.Id
...
procedure TdxShowFloatingObjectLayoutOptionsFormCommand.
  ShowFloatingInlineObjectLayoutOptionsFormCallback(const AParameters
  : TdxFloatingInlineObjectParameters; AData: TObject);
begin
end;

procedure TdxShowFloatingObjectLayoutOptionsFormCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
var
  ANeedEnable: Boolean;
begin
  ...
  else if DocumentModel.Selection.IsInlinePictureSelected then
    FIsFloatingObject := TdxObjectType.InlineObject
  else
    FIsFloatingObject := TdxObjectType.None;

  ANeedEnable := IsContentEditable and
    (FIsFloatingObject <> TdxObjectType.None);
...
procedure TdxShowLineNumberingFormCommand.ForceExecute
  (const AState: IdxCommandUIState);
var
...
begin
  ...
  try
    AValueBasedState :=
      AState as IdxValueBasedCommandUIState<TdxLineNumberingInfo>;
    ShowLineNumberingForm(AValueBasedState.Value, ShowLineNumberingFormCallback,
      AState as TObject);
  finally
    NotifyEndCommandExecution(AState);
  end;
...
procedure TdxShowLineNumberingFormCommand.ShowLineNumberingFormCallback
  (AProperties: TdxLineNumberingInfo; ACallbackData: TObject);
var
  AValueBasedState: IdxValueBasedCommandUIState<TdxLineNumberingInfo>;
begin
  if Supports(ACallbackData, IdxValueBasedCommandUIState<TdxLineNumberingInfo>,
    AValueBasedState) then
    AValueBasedState.Value := AProperties
  else
    TdxRichEditExceptions.ThrowInternalException;
...
procedure TdxShowLineNumberingFormCommand.ShowLineNumberingForm
...
function TdxShowLineNumberingFormCommand.CreateModifier
  (const AState: IdxCommandUIState)
...
begin
  AValueBasedState :=
    AState as IdxValueBasedCommandUIState<TdxLineNumberingInfo>;
  Result := TdxPieceTableModifiers.CreateSectionLineNumberingModifier
    (AValueBasedState.Value);
end;

procedure TdxShowLineNumberingFormCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
var
  AValueBasedState: IdxValueBasedCommandUIState<TdxLineNumberingInfo>;
begin
...
function TdxShowLineNumberingFormCommand.GetCurrentPropertyValue
...
function TdxShowLineNumberingFormCommand.CreateDefaultCommandUIState
  : IdxCommandUIState;
begin
  Result := TdxDefaultObjectValueBasedCommandUIState<
    TdxLineNumberingInfo>.Create;
end;

{ TdxShowMergeFormCommandBase }

procedure TdxShowMergeFormCommandBase.CalculateMailMergeOptions
  (const AMergeRecordsParameters: TdxMergeRecordsParameters;
  const AOptions: IdxRichEditMailMergeOptions);
begin
end;

function TdxShowMergeFormCommandBase.CreateExportFilters
  (AExporters: TdxExporterList): string;
var
...
begin
  AExtension := LowerCase(TdxStringHelper.TrimStart
...
procedure TdxShowMergeFormCommandBase.MailMergeToNewControl(const AOptions
  : IdxRichEditMailMergeOptions);
var
...
procedure TdxShowMergeFormCommandBase.MailMergeToNewFile(const AOptions
  : IdxRichEditMailMergeOptions);
var
  ...
  AIndex: Integer;
begin
  AExportManagerService := RichEditControl.InnerControl.DocumentModel.
    GetService<IdxDocumentExportManagerService>;
  ...
  try
    ...
    try
      ...
      AFileSaveDialog.Options := AFileSaveDialog.Options +
        [TOpenOption.ofOverwritePrompt, TOpenOption.ofFileMustExist,
...
procedure TdxShowMergeFormCommandBase.MergeToNewDocument
  (const AMergeRecordsParameters: TdxMergeRecordsParameters);
var
...
procedure TdxShowMergeDatabaseRecordsFormCommand.CalculateMailMergeOptions
  ...
  const AOptions: IdxRichEditMailMergeOptions);
begin
  AOptions.DataSource := RichEditControl.InnerControl.Options.MailMerge.
    DataSource;
end;

procedure TdxShowMergeDatabaseRecordsFormCommand.ForceExecute
  (const AState: IdxCommandUIState);
var
...
begin
  ...
  RichEditControl.ShowMergeDatabaseRecordsForm(AMergeRecordsParameters,
    ShowMergeDatabaseRecordsFormCallBack);
end;
...
procedure TdxShowMergeDatabaseRecordsFormCommand.
  ShowMergeDatabaseRecordsFormCallBack(const AMergeRecordsParameters
  : TdxMergeRecordsParameters; AData: TObject);
begin
  MergeToNewDocument(AMergeRecordsParameters);
end;

procedure TdxShowMergeDatabaseRecordsFormCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
var
  ADataSource: TDataSource;
begin
  ADataSource := RichEditControl.InnerControl.Options.MailMerge.DataSource;
  AState.Enabled := (ADataSource <> nil) and (ADataSource.DataSet <> nil) and
    not ADataSource.DataSet.IsEmpty;
end;
...
procedure TdxShowTOCFormCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
var
...
begin
  ...
  FField := TdxFieldController.FindFieldBySelection<TdxTocField>
    (DocumentModel.Selection, ATocField);
  ATocField.Free;
  AState.Enabled := (FField <> nil) and IsContentEditable;
  AState.Visible := FField <> nil;
end;

function TdxShowTOCFormCommand.CanChangePosition
...
function TdxShowTOCFormCommand.
...
function TdxShowTOCFormCommand.ChangePosition
...
constructor TdxShowTableStyleFormCommand.Create(const AControl
  : IdxRichEditControl; AStyle: TdxTableStyle);
begin
  inherited Create(AControl);
  FStyle := AStyle;
end;
...
procedure TdxShowTableStyleFormCommand.ForceExecute(const AState
  : IdxCommandUIState);
begin
  CheckExecutedAtUIThread;
  NotifyBeginCommandExecution(AState);
...
begin
  ...
  AFirstRun := AModel.ActivePieceTable.Runs[AStartIndex];
  AIndex := AFirstRun.Paragraph.Index;
  ASourceCell := TdxTableCell(AFirstRun.PieceTable.Paragraphs[AIndex]
    .GetCellCore);
  ...
  begin
    ARun := AModel.ActivePieceTable.Runs[I];
    if TdxTableCell(ARun.PieceTable.Paragraphs[AIndex].GetCellCore)
      .Table.TableStyle <> ATargetTable.TableStyle then
    begin
...
procedure TdxShowTableStyleFormCommand.ShowTableStyleForm
...
procedure TdxShowTableStyleFormCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  CheckExecutedAtUIThread;
  ApplyCommandRestrictionOnEditableControl(AState,
    DocumentModel.DocumentCapabilities.TableStyle);
end;
...
begin
  ...
  begin
    RichEditControl.ShowDocumentProtectionQueryPasswordForm('',
...
procedure TdxUnprotectDocumentCommand.ShowPasswordFormCallback
  (const APassword: string);
begin
  if not DocumentModel.RemoveDocumentProtection(APassword) then
    RichEditControl.ShowWarningMessage
      (cxGetResourceString
      (@sdxRichEditExceptionDocumentProtectionInvalidPassword));
end;

procedure TdxUnprotectDocumentCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  CheckExecutedAtUIThread;
...
begin
  ...
  RichEditControl.ShowDocumentProtectionQueryNewPasswordForm('',
    ShowPasswordFormCallback);
end;
...
procedure TdxProtectDocumentCommand.ShowPasswordFormCallback
  (const APassword: string);
begin
  DocumentModel.EnforceDocumentProtection(APassword);
end;

procedure TdxProtectDocumentCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  CheckExecutedAtUIThread;
...
class function TdxShowRangeEditingPermissionsFormCommand.Id
  : TdxRichEditCommandId;
begin
...
procedure TdxShowRangeEditingPermissionsFormCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  AState.Enabled := not DocumentModel.ProtectionProperties.EnforceProtection;
...
begin
  ...
  RichEditControl.ShowDocumentEncryptQueryNewPasswordForm
    (DocumentModel.EncryptionProperties.Password, ShowPasswordFormCallback);
end;
...
procedure TdxEncryptDocumentCommand.ShowPasswordFormCallback
  (const APassword: string);
begin
  DocumentModel.EncryptionProperties.Password := APassword;
end;

procedure TdxEncryptDocumentCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  CheckExecutedAtUIThread;
...
procedure TdxProcessPaperSizeGalleryCommand.ForceExecute
  (const AState: IdxCommandUIState);
begin
  // do nothing
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if (FPageSetupInfo.Value <> nil) and FPageSetupInfo.Value.PaperKind.HasValue
      then
...
procedure TdxProcessPaperSizeGalleryCommand.SetPaperKind(const APaperKind
  : TdxPaperKind);
var
  ASize: TSize;
  ATemp: Integer;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        ASize := DocumentModel.UnitConverter.TwipsToModelUnits
          (TdxPaperSizeCalculator.CalculatePaperSize(APaperKind));
...
procedure TdxProcessPageMarginsGalleryCommand.ForceExecute
  (const AState: IdxCommandUIState);
begin
  // do nothing
end;
...
procedure TdxProcessPageMarginsGalleryCommand.GetPageMargins(out ATop, ABottom,
  ALeft, ARight: Single);
var
  APageSetupInfo: TdxPageSetupInfo;
  AState: IdxCommandUIState;
    ...
    begin
      ...
      begin
        ...
        if APageSetupInfo.TopMargin.HasValue then
          ATop := SimpleRoundTo(AUnitConverter.ModelUnitsToInchesF
            (APageSetupInfo.TopMargin));
        if APageSetupInfo.BottomMargin.HasValue then
          ABottom := SimpleRoundTo(AUnitConverter.ModelUnitsToInchesF
            (APageSetupInfo.BottomMargin));
        if APageSetupInfo.LeftMargin.HasValue then
          ALeft := SimpleRoundTo(AUnitConverter.ModelUnitsToInchesF
            (APageSetupInfo.LeftMargin));
        if APageSetupInfo.RightMargin.HasValue then
          ARight := SimpleRoundTo(AUnitConverter.ModelUnitsToInchesF
            (APageSetupInfo.RightMargin));
        if APageSetupInfo.Landscape.HasValue and APageSetupInfo.Landscape then
...
procedure TdxProcessPageMarginsGalleryCommand.SetPageMargins(ATop, ABottom,
  ALeft, ARight: Single);
var
  APageSetupInfo: TdxPageSetupInfo;
  AUnitConverter: TdxDocumentModelUnitConverter;
begin
  ...
  try
    ...
    begin
      ...
      APageSetupInfo.TopMargin :=
        Trunc(AUnitConverter.InchesToModelUnitsF(ATop));
      APageSetupInfo.BottomMargin :=
        Trunc(AUnitConverter.InchesToModelUnitsF(ABottom));
      APageSetupInfo.LeftMargin :=
        Trunc(AUnitConverter.InchesToModelUnitsF(ALeft));
      APageSetupInfo.RightMargin :=
        Trunc(AUnitConverter.InchesToModelUnitsF(ARight));
      ModifyDocumentModel(FPageSetupInfo);
    end;
  finally
    NotifyEndCommandExecution(FPageSetupInfo);
...
procedure TdxProcessPageMarginsGalleryCommand.ConvertToLandscapeMargins
  (var ATop, ABottom, ALeft, ARight: Single);
var
...
procedure TdxProcessPageMarginsGalleryCommand.ConvertToPortraitMargins(var ATop,
  ABottom, ALeft, ARight: Single);
var
  ATempTop, ATempBottom, ATempLeft, ATempRight: Single;
begin
  ATempTop := ATop;
