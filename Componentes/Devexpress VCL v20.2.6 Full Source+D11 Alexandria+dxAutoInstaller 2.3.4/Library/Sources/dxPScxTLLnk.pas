...
{$ENDIF}
  ...
  cxControls, cxGraphics, cxGeometry, cxStyles, cxLookAndFeels,
  ...
  cxImageList, cxImage, cxDataControllerConditionalFormatting,
  dxPSdxSpreadSheetLnk, dxSpreadSheetStyles;
...
type
  ...
  TcxTreeListReportLinkRowProducerClass = class of
  ...
  protected
    ...
    procedure CreateRowHost(const AHostInfo
      : TcxTreeListAttributeHostInfo); virtual;
  ...
  TcxTreeListReportLinkNodeSeparatorProducerClass = class of
    TcxTreeListReportLinkNodeSeparatorProducer;

  TcxTreeListReportLinkNodeSeparatorProducer = class
    (TcxTreeListReportLinkRowProducer)
  private
  ...
  TcxTreeListReportLinkRowSubItemsProducerClass = class of
    TcxTreeListReportLinkRowSubItemsProducer;

  TcxTreeListReportLinkRowSubItemsProducer = class
    (TcxTreeListReportLinkRowProducer)
  private
  ...
  TcxTreeListReportLinkBandsProducerClass = class of
    TcxTreeListReportLinkBandsProducer;

  TcxTreeListReportLinkBandsProducer = class
    (TcxTreeListReportLinkRowSubItemsProducer)
  protected
  ...
  TcxTreeListReportLinkFootersProducerClass = class of
    TcxTreeListReportLinkFootersProducer;

  TcxTreeListReportLinkBandedRowProducer = class
    (TcxTreeListReportLinkRowProducer)
  private
    FIndents: TList;
  ...
  protected
    ...
    function GetBandedDataItemBounds(AItem: TAbstractdxReportCellData)
      : TRect; virtual;
    function GetBandedDataItemClass(AColumn: TcxTreeListColumn)
    ...
    procedure InitializeBandedDataItem
      (AItem: TAbstractdxReportCellData); virtual;
    procedure InitializeBandedRow(ARow: TdxReportCell); virtual;
    procedure InitializeIndent(AnIndent: TdxReportCellExpandButton;
      AnIndex: Integer); virtual;
  ...
  TcxTreeListReportLinkFootersProducer = class
    (TcxTreeListReportLinkBandedRowProducer)
  private
  ...
  TcxTreeListReportLinkHeadersProducerClass = class of
    TcxTreeListReportLinkHeadersProducer;

  TcxTreeListReportLinkHeadersProducer = class
    (TcxTreeListReportLinkRowSubItemsProducer)
  protected
    procedure InitializeRow; override;
    procedure InitializeSubItem(ASubItem: TAbstractdxReportCellData;
  ...
  TcxTreeListReportLinkNodeProducerClass = class of
    TcxTreeListReportLinkNodeProducer;

  TcxTreeListReportLinkNodeProducer = class
    (TcxTreeListReportLinkBandedRowProducer)
  private
  ...
  protected
    ...
    procedure InitializeBandedDataItem
      (AItem: TAbstractdxReportCellData); override;
    procedure InitializeBandedRow(ARow: TdxReportCell); override;
    ...
    function GetBandedDataItemBounds(AItem: TAbstractdxReportCellData)
      : TRect; override;
    function GetBandedDataItemClass(AColumn: TcxTreeListColumn)
      : TdxReportCellDataClass; override;
    function GetBandedRowIndent: Integer; override;
  ...
  TcxTreeListReportLinkCategorizedNodeProducer = class
    (TcxTreeListReportLinkNodeProducer)
  protected
  ...
  public
    ...
    class function ProducerClass
      : TcxTreeListReportLinkNodeProducerClass; virtual;
  ...
  public
    ...
    property Helpers[Node: TcxTreeListNode]: TcxTreeListNodeHelper
  ...
  private
    ...
    function GetProducer(ProducerClass: TcxTreeListReportLinkRowProducerClass)
      : TcxTreeListReportLinkRowProducer;
  protected
    function IndexOf(AProducerClass
      : TcxTreeListReportLinkRowProducerClass): Integer;
    property Items[Index: Integer]: TcxTreeListReportLinkRowProducer
      read GetItem;
  public
    constructor Create(ABuilder: TcxTreeListReportLinkBuilder);
    property Builder: TcxTreeListReportLinkBuilder read FBuilder;
    property Producers[ProducerClass: TcxTreeListReportLinkRowProducerClass]
      : TcxTreeListReportLinkRowProducer read GetProducer; default;
  end;
  ...
  protected
    ...
    function GetBandsProducerClass
      : TcxTreeListReportLinkBandsProducerClass; virtual;
    { footers }
    ...
    function GetFootersProducerClass
      : TcxTreeListReportLinkFootersProducerClass; virtual;
    { headers }
    ...
    function GetHeadersProducerClass
      : TcxTreeListReportLinkHeadersProducerClass; virtual;
    { nodes }
    procedure CreateNode(ANode: TcxTreeListNode); virtual;
    procedure CreateNodes; virtual;
    function GetNodeProducer(ANode: TcxTreeListNode)
      : TcxTreeListReportLinkNodeProducer;
    function GetNodeProducerClass(ANode: TcxTreeListNode)
      : TcxTreeListReportLinkNodeProducerClass; virtual;
    { separators }
    procedure CreateNodeSeparator(ANode: TcxTreeListNode); virtual;
    function GetNodeSeparatorProducer
      : TcxTreeListReportLinkNodeSeparatorProducer;
    function GetNodeSeparatorProducerClass
      : TcxTreeListReportLinkNodeSeparatorProducerClass; virtual;

    procedure DoBuild; virtual;
    function IsAborted: Boolean;

    property ProducerCache: TcxTreeListReportLinkProducerCache
      read FProducerCache;
  ...
  protected
    ...
    procedure Calculate;
    { properties }
    class function GetProperties(AColumn: TcxTreeListColumn;
      ANode: TcxTreeListNode): TcxCustomEditProperties;
    class function GetPropertiesClass(AColumn: TcxTreeListColumn;
      ANode: TcxTreeListNode): TcxCustomEditPropertiesClass;
    class function GetRepositoryItem(AColumn: TcxTreeListColumn;
    ...
    function GetBandHeaderViewParams(ABand: TcxTreeListBand)
      : TcxViewParams; virtual;
    function GetColumnFooterViewParams(AColumn: TcxTreeListColumn)
      : TcxViewParams; virtual;
    function GetColumnHeaderViewParams(AColumn: TcxTreeListColumn)
      : TcxViewParams; virtual;
    function GetContentViewParams(ANode: TcxTreeListNode;
      AColumn: TcxTreeListColumn): TcxViewParams; virtual;
    function GetIndentViewParams(ANode: TcxTreeListNode; AnIndent: Integer)
      : TcxViewParams; virtual;
    function GetPreviewViewParams(ANode: TcxTreeListNode;
      AColumn: TcxTreeListColumn): TcxViewParams; virtual;
    ...
    function TryGetAdvancedStyle(AColumn: TcxTreeListColumn;
      ANode: TcxTreeListNode; out AStyle: TdxSpreadSheetCellDisplayStyle)
      : Boolean; virtual;
    { Backgrounds }
    function GetBackgroundBitmap(Index: Integer): TBitmap;
    function HasBackgroundBitmap(Index: Integer): Boolean;

    procedure DoGetLevelImages(ALevel: Integer;
    ...
    function HasNodeAttachedFooter(ANode, ASummaryNode
      : TcxTreeListNode): Boolean;
  ...
  public
    ...
    property FooterLineCount[ANode: TcxTreeListNode]: Integer
      read GetFooterLineCount;
    ...
    property IndentWidth: Integer read GetIndentWidth;
    property IsDefaultRowHeightAssigned: Boolean
      read GetIsDefaultRowHeightAssigned;
    property IsNodeColorUsedForIndents: Boolean
      read GetIsNodeColorUsedForIndents;
  ...
  protected
    ...
    function GetItemByColumn(Column: TcxTreeListColumn)
      : TcxTreeListColumnPlace; virtual;
  ...
  public
    ...
    property ItemsByColumn[Column: TcxTreeListColumn]: TcxTreeListColumnPlace
  ...
  public
    constructor Create(AController: TcxTreeListCustomBandPlace;
  ...
  protected
    ...
    function GetItemByColumn(Column: TcxTreeListColumn)
      : TcxTreeListColumnPlace; override;

    procedure AddItems; virtual;
    procedure AssignWidth;
    function CalculateHeight: Integer; virtual;
    function CalculateItemLeftBound(AnItem: TcxTreeListColumnPlace)
      : Integer; virtual;
    ...
    function CreateItem(AColumn: TcxTreeListColumn)
      : TcxTreeListColumnPlace; virtual;
    procedure InitAutoWidthItem(AnItem: TcxAutoWidthItem); virtual;
  ...
  public
    ...
    property ColumnIndexes[Column: TcxTreeListColumn]: Integer
      read GetColumnIndex;
    ...
    property Items[Index: Integer]: TcxTreeListColumnPlace
  ...
  public
    ...
    property ChildItems[Index: Integer]: TcxTreeListCustomBandPlace
      read GetChildItem;
  end;
  ...
  protected
    function CalculateHeaderLineCount: Integer; override;
    function CalculateWidth: Integer; override;
    function GetItemByColumn(AColumn: TcxTreeListColumn)
      : TcxTreeListColumnPlace; override;

    procedure AddItems; virtual;
    function CreateItem(ABand: TcxTreeListBand)
      : TcxTreeListCustomBandPlace; virtual;
    function GetItemClass(ABand: TcxTreeListBand)
      : TcxTreeListCustomBandPlaceClass; virtual;
    procedure RefreshBottomItems;
    procedure RefreshItems;
    procedure RefreshRootItems;

    function CalculateHeight: Integer; virtual;
    function CalculateItemHeight(AnItem: TcxTreeListCustomBandPlace)
      : Integer; virtual;
    function CalculateItemLeftBound(AnItem: TcxTreeListCustomBandPlace)
      : Integer; virtual;
    function CalculateItemTopBound(AnItem: TcxTreeListCustomBandPlace)
      : Integer; virtual;
  ...
  public
    ...
    property BottomItems[Index: Integer]: TcxTreeListCustomBandPlace
      read GetBottomItem;
    ...
    property RootItems[Index: Integer]: TcxTreeListCustomBandPlace
      read GetRootItem;
  end;
  ...
  protected
    ...
    function GetSummaryItems(ANode: TcxTreeListNode)
      : TcxTreeListReportLinkSummaryItems;
    function HasFooterCell(AColumn: TcxTreeListColumn;
    ...
    property Canvas: TdxPSReportRenderCustomCanvas read GetCanvas;
    property ItemPlaceController: TcxTreeListItemPlaceController
      read FItemPlaceController;
    property LevelInfos[ALevel: Integer]: TcxTreeListReportLinkLevelInfo
      read GetLevelInfos;
  ...
  public
    ...
    function GetBandItemViewParams(ABand: TcxTreeListBand)
    ...
    function GetNodeCheckCellSides(ANode: TcxTreeListNode; AnIndex: Integer)
      : TdxCellSides; virtual;
    function GetNodeCheckClass(ANode: TcxTreeListNode)
      : TdxCustomReportCellCheckClass; virtual;
    function GetNodeCheckViewParams(ANode: TcxTreeListNode; AnIndex: Integer)
      : TdxReportItemViewParams; virtual;
    { Footers }
    procedure DoInitializeFooterCell(AnItem: TAbstractdxReportCellData;
      AColumn: TcxTreeListColumn; ACellIndex: Integer;
      ANode: TcxTreeListNode); virtual;
    procedure DoInitializeFooterIndent(AnItem: TdxReportCellExpandButton;
      AnIndex, AnIndentCount: Integer; ANode: TcxTreeListNode);
    procedure DoInitializeFooterBandedRow(ARow: TdxReportCell;
      AIndentCount: Integer); virtual;
    procedure DoInitializeFooterRow(ARow: TdxReportCell); virtual;
    procedure DoReportLinkInitializeFooterCell
      (AnItem: TAbstractdxReportCellData;
      AColumnIndex, ACellIndex: Integer); virtual;
    function GetFooterCellBounds(AColumn: TcxTreeListColumn;
      ACellIndex, AIndent: Integer): TRect; virtual;
    function GetFooterCellClass: TdxReportCellTextClass; virtual;
    function GetFooterCellViewParams(AColumn: TcxTreeListColumn)
      : TdxReportItemViewParams; virtual;
    ...
    procedure DoReportLinkInitializeHeaderItem
      (AnItem: TAbstractdxReportCellData; AIndex: Integer); virtual;
    ...
    function GetHeaderItemViewParams(AColumn: TcxTreeListColumn)
      : TdxReportItemViewParams; virtual;
    { Images }
    procedure DoInitializeNodeImage(AnItem: TdxReportCellGraphic;
      ANode: TcxTreeListNode; AnIndex: Integer); virtual;
    procedure DoReportLinkInitializeNodeImage(AnItem: TAbstractdxReportCellData;
      ANode: TcxTreeListNode; AnIndex: Integer); virtual;
    function GetNodeImageCellSides(ANode: TcxTreeListNode; AnIndex: Integer)
      : TdxCellSides;
    function GetNodeImageClass: TdxReportCellGraphicClass; virtual;
    function GetNodeImageViewParams(ANode: TcxTreeListNode; AnIndex: Integer)
      : TdxReportItemViewParams; virtual;
    { Indents and Expand Buttons }
    procedure DoInitializeNodeIndent(AnItem: TdxReportCellExpandButton;
      AnIndex, AnIndentCount: Integer; ANode: TcxTreeListNode); virtual;
    procedure DoInitializeExpandButton(AnItem: TdxReportCellExpandButton;
      AnIndex, AnIndentCount: Integer; ANode: TcxTreeListNode); virtual;
    procedure DoReportLinkInitializeNodeIndent
      (AnItem: TAbstractdxReportCellData; AnIndex, AnIndentCount: Integer;
      ANode: TcxTreeListNode); virtual;
    function GetNodeIndentCellSides(ANode: TcxTreeListNode;
      AnIndex, AnIndentCount: Integer): TdxCellSides; virtual;
    function GetNodeIndentClass: TdxReportCellExpandButtonClass; virtual;
    function GetNodeIndentTreeLineMode(AnIndex, AnIndentCount: Integer;
      ANode: TcxTreeListNode): TdxPSTreeLineMode;
    function GetNodeIndentViewParams(ANode: TcxTreeListNode;
    ...
    function GetNodeItemBounds(ANode: TcxTreeListNode; AIndex: Integer)
      : TRect; virtual;
    function GetNodeItemCellSides(AColumn: TcxTreeListColumn;
      ANode: TcxTreeListNode): TdxCellSides;
    function GetNodeItemClass(AColumn: TcxTreeListColumn;
      ANode: TcxTreeListNode; AnIsPreview: Boolean = False)
      : TdxReportCellDataClass; virtual;
    function GetNodeItemViewParams(AColumn: TcxTreeListColumn;
      ANode: TcxTreeListNode): TdxReportItemViewParams; virtual;
    { Preview }
    procedure DoInitializePreview(AnItem: TAbstractdxReportCellData;
      AColumn: TcxTreeListColumn; ANode: TcxTreeListNode); virtual;
    function GetPreviewCellSides(ANode: TcxTreeListNode): TdxCellSides; virtual;
    function GetPreviewClass(AColumn: TcxTreeListColumn; ANode: TcxTreeListNode)
      : TdxReportCellDataClass; virtual;
    function GetPreviewViewParams(AColumn: TcxTreeListColumn;
      ANode: TcxTreeListNode): TdxReportItemViewParams; virtual;
    { Separators }
    procedure DoInitializeNodeSeparator
      (AnItem: TAbstractdxReportCellData); virtual;
    ...
    { State images }
    procedure DoInitializeNodeStateImage(AnItem: TdxReportCellGraphic;
      ANode: TcxTreeListNode; AnIndex: Integer); virtual;
    procedure DoReportLinkInitializeNodeStateImage
      (AnItem: TAbstractdxReportCellData; ANode: TcxTreeListNode;
      AnIndex: Integer); virtual;
    function GetNodeStateImageCellSides(ANode: TcxTreeListNode;
      AnIndex: Integer): TdxCellSides; virtual;
    function GetNodeStateImageClass: TdxReportCellGraphicClass; virtual;
    function GetNodeStateImageViewParams(ANode: TcxTreeListNode;
  ...
  public
    ...
    property ReportLink: TcxTreeListCustomReportLink read GetReportLink;
  published
    property AutoExpandNodes: Boolean read FAutoExpandNodes
      write SetAutoExpandNodes default False;
    property ExplicitlyExpandNodes: Boolean read FExplicitlyExpandNodes
      write SetExplicitlyExpandNodes default False;
  end;
  ...
  published
    ...
    property NodeSeparatorColor: TColor read FNodeSeparatorColor
      write SetNodeSeparatorColor default clDefault;
    property NodeSeparatorThickness: Integer read FNodeSeparatorThickness
      write SetNodeSeparatorThickness default 0;
  ...
  public
    ...
    procedure GetBandHeaderParams(ABand: TcxTreeListBand;
      out AParams: TcxViewParams); virtual;
    procedure GetColumnFooterParams(ANode: TcxTreeListNode;
      AColumn: TcxTreeListColumn; out AParams: TcxViewParams); virtual;
    procedure GetColumnHeaderParams(AColumn: TcxTreeListColumn;
      out AParams: TcxViewParams); virtual;
    procedure GetContentParams(ANode: TcxTreeListNode;
      AColumn: TcxTreeListColumn; out AParams: TcxViewParams); virtual;
    procedure GetFooterRowParams(out AParams: TcxViewParams); virtual;
    procedure GetImagesParams(ANode: TcxTreeListNode;
      out AParams: TcxViewParams); virtual;
    procedure GetIndentParams(ANode: TcxTreeListNode; AnIndent: Integer;
      out AParams: TcxViewParams); virtual;
    procedure GetPreviewParams(ANode: TcxTreeListNode;
      AColumn: TcxTreeListColumn; out AParams: TcxViewParams); virtual;
    procedure GetSelectionParams(out AParams: TcxViewParams); virtual;

    property ReportLink: TcxTreeListCustomReportLink read GetReportLink;
  published
    property BandBackground: TcxStyle Index vspsTreeListBandBackground
      read GetValue write SetValue;
    property BandHeader: TcxStyle Index vspsTreeListBandHeader read GetValue
      write SetValue;
    property Content: TcxStyle Index vspsTreeListContent read GetValue
      write SetValue;
    property ContentEven: TcxStyle Index vspsTreeListContentEven read GetValue
      write SetValue;
    property ContentOdd: TcxStyle Index vspsTreeListContentOdd read GetValue
      write SetValue;
    property Footer: TcxStyle Index vspsTreeListFooter read GetValue
      write SetValue;
    property FooterRow: TcxStyle Index vspsTreeListFooterRow read GetValue
      write SetValue;
    property Header: TcxStyle Index vspsTreeListHeader read GetValue
      write SetValue;
    property Preview: TcxStyle Index vspsTreeListPreview read GetValue
      write SetValue;
    property Selection: TcxStyle Index vspsTreeListSelection read GetValue
      write SetValue;
    property StyleSheet;
  ...
  published
    property Styles: TcxTreeListReportLinkStyles read GetStylesValue
  ...
  TcxTreeListAttributeHostInfoServicesClass = class of
  ...
  protected
    ...
    property OptionsOnEveryPage: TcxTreeListReportLinkOptionsOnEveryPage
  ...
  public
    ...
    property BandHeadersHostInfo: TcxTreeListAttributeHostInfo
    ...
    property FootersHostInfo: TcxTreeListAttributeHostInfo
      read GetFootersHostInfo;
    property HeadersHostInfo: TcxTreeListAttributeHostInfo
      read GetHeadersHostInfo;
    ...
    property PageDetailsHostInfo: TcxTreeListAttributeHostInfo
      read FPageDetailsHostInfo;
    property PageFootersHostInfo: TcxTreeListAttributeHostInfo
      read FPageFootersHostInfo;
    property PageHeadersHostInfo: TcxTreeListAttributeHostInfo
  ...
  TcxTreeListReportLinkGetCustomPageBreaksEvent = procedure
    (Sender: TcxTreeListCustomReportLink) of object;

  TcxTreeListReportLinkCustomDrawBandCellEvent = procedure
    (Sender: TcxTreeListCustomReportLink; ACanvas: TCanvas;
    ABand: TcxTreeListBand; AnItem: TdxReportCellImage; var ADone: Boolean)
    of object;

  TcxTreeListReportLinkCustomDrawCellEvent = procedure
    (Sender: TcxTreeListCustomReportLink; ACanvas: TCanvas;
    ANode: TcxTreeListNode; AColumn: TcxTreeListColumn;
    AnItem: TAbstractdxReportCellData; var ADone: Boolean) of object;

  TcxTreeListReportLinkCustomDrawFooterCellEvent = procedure
    (Sender: TcxTreeListCustomReportLink; ACanvas: TCanvas;
    AColumn: TcxTreeListColumn; AnItem: TdxReportCellString; var ADone: Boolean)
    of object;

  TcxTreeListReportLinkCustomDrawHeaderCellEvent = procedure
    (Sender: TcxTreeListCustomReportLink; ACanvas: TCanvas;
    AColumn: TcxTreeListColumn; AnItem: TdxReportCellImage; var ADone: Boolean)
    of object;

  TcxTreeListReportLinkCustomDrawIndentCellEvent = procedure
    (Sender: TcxTreeListCustomReportLink; ACanvas: TCanvas;
    ANode: TcxTreeListNode; AnIndex: Integer; AnItem: TAbstractdxReportCellData;
    var ADone: Boolean) of object;

  TcxTreeListReportLinkInitializeBandCellEvent = procedure
    (Sender: TcxTreeListCustomReportLink; ABand: TcxTreeListBand;
    AnItem: TdxReportCellImage) of object;

  TcxTreeListReportLinkInitializeCellEvent = procedure
    (Sender: TcxTreeListCustomReportLink; ANode: TcxTreeListNode;
    AColumn: TcxTreeListColumn; AnItem: TAbstractdxReportCellData) of object;

  TcxTreeListReportLinkInitializeFooterCellEvent = procedure
    (Sender: TcxTreeListCustomReportLink; ASummaryCellIndex: Integer;
    AColumn: TcxTreeListColumn; AnItem: TdxReportCellString) of object;

  TcxTreeListReportLinkInitializeHeaderCellEvent = procedure
    (Sender: TcxTreeListCustomReportLink; AColumn: TcxTreeListColumn;
    AnItem: TdxReportCellImage) of object;

  TcxTreeListReportLinkInitializeIndentCellEvent = procedure
    (Sender: TcxTreeListCustomReportLink; ANode: TcxTreeListNode;
    AnIndex: Integer; AnItem: TAbstractdxReportCellData) of object;
  ...
  private
    ...
    function GetOptionsView: TcxTreeListReportLinkOptionsView;
    function GetReportCellDataByColumn(AColumn: TcxTreeListColumn)
    ...
    procedure SetOnCustomDrawBandCell
      (Value: TcxTreeListReportLinkCustomDrawBandCellEvent);
    procedure SetOnCustomDrawCell
      (Value: TcxTreeListReportLinkCustomDrawCellEvent);
    procedure SetOnCustomDrawFooterCell
      (Value: TcxTreeListReportLinkCustomDrawFooterCellEvent);
    procedure SetOnCustomDrawHeaderCell
      (Value: TcxTreeListReportLinkCustomDrawHeaderCellEvent);
    procedure SetOnCustomDrawIndentCell
      (Value: TcxTreeListReportLinkCustomDrawIndentCellEvent);
    procedure SetOptionsExpanding(Value: TcxTreeListReportLinkOptionsExpanding);
    procedure SetOptionsFormatting
      (Value: TcxTreeListReportLinkOptionsFormatting);
    procedure SetOptionsOnEveryPage
      (Value: TcxTreeListReportLinkOptionsOnEveryPage);
  ...
  protected
    ...
    procedure DoCustomDrawFooterCell(ACanvas: TCanvas;
      AColumn: TcxTreeListColumn; AnItem: TdxReportCellString;
      var ADone: Boolean); dynamic;
    procedure DoCustomDrawHeaderCell(ACanvas: TCanvas;
      AColumn: TcxTreeListColumn; AnItem: TdxReportCellImage;
      var ADone: Boolean); dynamic;
    ...
    procedure DoInitializeBandCell(ABand: TcxTreeListBand;
      AnItem: TdxReportCellImage); dynamic;
    procedure DoInitializeCell(ANode: TcxTreeListNode;
      AColumn: TcxTreeListColumn; AnItem: TAbstractdxReportCellData); dynamic;
    procedure DoInitializeFooterCell(AColumn: TcxTreeListColumn;
      ASummaryCellIndex: Integer; AnItem: TdxReportCellString); dynamic;
    procedure DoInitializeHeaderCell(AColumn: TcxTreeListColumn;
      AnItem: TdxReportCellImage); dynamic;
    procedure DoInitializeIndentCell(ANode: TcxTreeListNode; AnIndex: Integer;
    ...
    function GetItemCustomDrawInfo(AnItem: TdxReportVisualItem;
      out ADrawInfo: TcxTreeListCellCustomDrawInfo)
      : TcxTreeListAttributeID; virtual;
    function IsCustomDrawn(AnAttributeID: TcxTreeListAttributeID)
      : Boolean; virtual;
    function MakeIndentIndex(AnIndex: Integer): DWORD;
    ...
    property HostInfoServices: TcxTreeListAttributeHostInfoServices
  ...
  public
    ...
    procedure AddHorizontalPageBreak(const AColumns
      : array of TcxTreeListColumn); overload;
    procedure AddHorizontalPageBreak(const AColumns
      : TcxTreeListColumnArray); overload;
    procedure AddHorizontalPageBreak(AColumns: TList); overload;
    // List of TcxTreeListColumn
    ...
    property DesignWindow: TdxfmTreeListReportLinkDesignWindow
      read GetDesignWindow;
    property ReportCellDataByColumn[AColumn: TcxTreeListColumn]
      : TAbstractdxReportCellData read GetReportCellDataByColumn;
    property ReportRowCount: Integer read GetReportRowCount;
    property ReportRows[Index: Integer]: TdxReportCell read GetReportRow;
    property ReportRowsByNode[Node: TcxTreeListNode]: TdxReportCell
      read GetReportRowByNode;
  published
    property Color;
    property Font;
    property OptionsExpanding: TcxTreeListReportLinkOptionsExpanding
      read GetOptionsExpanding write SetOptionsExpanding;
    property OptionsFormatting: TcxTreeListReportLinkOptionsFormatting
    ...
    property OptionsPreview: TcxTreeListReportLinkOptionsPreview
      read GetOptionsPreview write SetOptionsPreview;
    property OptionsRefinements: TcxTreeListReportLinkOptionsRefinements
      read GetOptionsRefinements write SetOptionsRefinements;
    property OptionsSelection: TcxTreeListReportLinkOptionsSelection
      read GetOptionsSelection write SetOptionsSelection;
    property OptionsSize: TcxTreeListReportLinkOptionsSize read GetOptionsSize
    ...
    property OnCustomDrawBandCell: TcxTreeListReportLinkCustomDrawBandCellEvent
      read FOnCustomDrawBandCell write SetOnCustomDrawBandCell;
    property OnCustomDrawCell: TcxTreeListReportLinkCustomDrawCellEvent
    ...
    property OnCustomDrawHeaderCell
      : TcxTreeListReportLinkCustomDrawHeaderCellEvent
      read FOnCustomDrawHeaderCell write SetOnCustomDrawHeaderCell;
    property OnCustomDrawIndentCell
      : TcxTreeListReportLinkCustomDrawIndentCellEvent
      read FOnCustomDrawIndentCell write SetOnCustomDrawIndentCell;
    property OnGetCustomPageBreaks
      : TcxTreeListReportLinkGetCustomPageBreaksEvent
      read FOnGetCustomPageBreaks write FOnGetCustomPageBreaks;
    property OnInitializeBandCell: TcxTreeListReportLinkInitializeBandCellEvent
      read FOnInitializeBandCell write FOnInitializeBandCell;
    property OnInitializeCell: TcxTreeListReportLinkInitializeCellEvent
      read FOnInitializeCell write FOnInitializeCell;
    property OnInitializeFooterCell
      : TcxTreeListReportLinkInitializeFooterCellEvent
      read FOnInitializeFooterCell write FOnInitializeFooterCell;
    property OnInitializeHeaderCell
      : TcxTreeListReportLinkInitializeHeaderCellEvent
      read FOnInitializeHeaderCell write FOnInitializeHeaderCell;
    property OnInitializeIndentCell
      : TcxTreeListReportLinkInitializeIndentCellEvent
      read FOnInitializeIndentCell Write FOnInitializeIndentCell;
  end;
  ...
  TdxfmTreeListReportLinkDesignWindow = class
    ...
    procedure PreviewTreeListCustomDrawBandHeaderCell(Sender: TcxCustomTreeList;
    ...
    procedure PreviewTreeListCustomDrawDataCell(Sender: TcxCustomTreeList;
      ...
      var ADone: Boolean);
    procedure PreviewTreeListCustomDrawFooterCell(Sender: TcxCustomTreeList;
      ACanvas: TcxCanvas; AViewInfo: TcxTreeListFooterCellViewInfo;
      var ADone: Boolean);
    procedure PreviewTreeListCustomDrawHeaderCell(Sender: TcxCustomTreeList;
      ACanvas: TcxCanvas; AViewInfo: TcxTreeListHeaderCellViewInfo;
      var ADone: Boolean);
  ...
  private
    ...
    procedure CustomDrawCheckMark(ACanvas: TcxCanvas;
      AViewInfo: TcxTreeListEditCellViewInfo);
    procedure CustomDrawColCarSpeedCount(ACanvas: TcxCanvas;
      AViewInfo: TcxTreeListEditCellViewInfo);
    procedure CustomDrawFooter(ACanvas: TcxCanvas; R: TRect;
      AViewInfo: TcxTreeListFooterCellViewInfo);
    procedure CustomDrawHeader(ACanvas: TcxCanvas; R: TRect;
      AViewInfo: TcxTreeListHeaderCellViewInfo);
    procedure CustomDrawTextRect(ACanvas: TcxCanvas; R: TRect;
      const AText: string; AnAlignmentHorz: TAlignment;
      AnAlignmentVert: TcxAlignmentVert; AParams: TcxViewParams);
    function ExtractAlignmentHorz(AViewInfo: TcxTreeListEditCellViewInfo)
      : TAlignment;
    function ExtractAlignmentVert(AViewInfo: TcxTreeListEditCellViewInfo)
      : TcxAlignmentVert;
    ...
    procedure UpdatePreviewTreeListStyles(const ACaption: string;
      AStyle: TcxStyle);
...
uses
  Variants, Forms, Registry, dxThemeManager, cxDataStorage, cxDataUtils,
  dxPSGlbl, dxPSRes, dxPSImgs,
  cxDrawTextUtils, dxPSPopupMan, dxPSUtl, dxBkgnd, Math, dxDPIAwareUtils,
  dxPSdxSpreadSheetLnkCore;

const
  CellSidesMap: array [TcxTreeListGridLines] of TdxCellSides = ([], csTopBottom,
    csLeftRight, csAll);
  SortOrderMap: array [TcxDataSortOrder] of TdxCellSortOrder = (csoNone, csoUp,
    csoDown);
  TreeLinesStyleMap: array [TcxTreeListTreeLineStyle] of TdxPSTreeLineStyle =
    (tlsDot, tlsDot, tlsSolid);

  DefaultDataRowLineHeight = 19;
  DefaultExpandButtonSize = 9;
  DefaultIndentWidth = 15;
  ExpandButtonInteriorColors: array [Boolean] of TColor = (clWindow,
    clBtnShadow);
...
type
  ...
  public
    class function Instance: TcxTreeListNodeHelperFactory; reintroduce;
      overload;
    property HelperClasses[Node: TcxTreeListNode]: TcxTreeListNodeHelperClass
      read GetHelperClass; default;
  end;
...
begin
  if Assigned(TcxCustomTreeListAccess(AInstance).OnGetLevelImages) then
    TcxCustomTreeListAccess(AInstance).OnGetLevelImages(AInstance, ALevel,
      AImages, AStateImages);
end;

function CustomTreeList_DoIsGroupNode(AInstance: TcxCustomTreeList;
  ANode: TcxTreeListNode): Boolean;
begin
  Result := TcxCustomTreeListAccess(AInstance).DoIsGroupNode(ANode);
end;

function CustomTreeList_GetImages(AInstance: TcxCustomTreeList)
  : TCustomImageList;
begin
  Result := TcxCustomTreeListAccess(AInstance).Images;
end;

function CustomTreeList_GetLookAndFeel(AInstance: TcxCustomTreeList)
  : TcxLookAndFeel;
begin
  Result := TcxCustomTreeListAccess(AInstance).LookAndFeel;
end;

function CustomTreeList_GetLookAndFeelPainter(AInstance: TcxCustomTreeList)
  : TcxCustomLookAndFeelPainter;
begin
  Result := TcxCustomTreeListAccess(AInstance).LookAndFeelPainter;
end;

function CustomTreeList_GetOptionsSelection(AInstance: TcxCustomTreeList)
  : TcxTreeListOptionsSelection;
begin
  Result := TcxCustomTreeListAccess(AInstance).OptionsSelection;
end;

function CustomTreeList_GetOptionsView(AInstance: TcxCustomTreeList)
  : TcxTreeListOptionsView;
begin
  Result := TcxCustomTreeListAccess(AInstance).OptionsView;
end;

function CustomTreeList_GetPreview(AInstance: TcxCustomTreeList)
  : TcxTreeListPreview;
begin
  Result := TcxCustomTreeListAccess(AInstance).Preview;
end;

function CustomTreeList_GetStateImages(AInstance: TcxCustomTreeList)
  : TCustomImageList;
begin
  Result := TcxCustomTreeListAccess(AInstance).StateImages;
end;

function CustomTreeList_GetStyles(AInstance: TcxCustomTreeList)
  : TcxTreeListStyles;
begin
...
function CustomTreeList_GetVisibleBandCount
  (AInstance: TcxCustomTreeList): Integer;
begin
...
function CustomTreeList_GetVisibleColumnCount
  (AInstance: TcxCustomTreeList): Integer;
begin
...
begin
  ...
  begin
    FDefaultdxPScxTreeListLinkStyleSheet :=
      TcxTreeListReportLinkStyleSheet.Create(nil);
    with FDefaultdxPScxTreeListLinkStyleSheet.Styles as
      TcxTreeListReportLinkStyles do
    begin
      ...
      Footer := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
      FooterRow := CreateStyle(dxPSCore.dxDefaultFixedColor,
        dxPSCore.dxPSDefaultFontColor);
...
class function TcxTreeListNodeHelperFactory.Instance
  : TcxTreeListNodeHelperFactory;
begin
  Result := inherited Instance as TcxTreeListNodeHelperFactory;
end;

function TcxTreeListNodeHelperFactory.GetHelperClass(Node: TcxTreeListNode)
  : TcxTreeListNodeHelperClass;
begin
...
constructor TcxTreeListReportLinkRowProducer.Create
  (ABuilder: TcxTreeListReportLinkBuilder);
begin
  inherited Create;
  FBuilder := ABuilder;
end;
...
function TcxTreeListReportLinkRowProducer.Formatter
  : TcxTreeListReportLinkFormatter;
begin
  Result := Builder.Formatter;
end;

function TcxTreeListReportLinkRowProducer.Produce
  (AHostInfo: TcxTreeListAttributeHostInfo): TdxReportCell;
begin
  CalculateRowHeight;
...
procedure TcxTreeListReportLinkRowProducer.CreateRowHost(const AHostInfo
...
function TcxTreeListReportLinkRowProducer.
...
function TcxTreeListReportLinkRowProducer.GetCanvas
...
function TcxTreeListReportLinkNodeSeparatorProducer.Produce
  (AHostInfo: TcxTreeListAttributeHostInfo): TdxReportCell;
begin
...
function TcxTreeListReportLinkNodeSeparatorProducer.GetItemClass
...
procedure TcxTreeListReportLinkRowSubItemsProducer.CreateDataItems
...
procedure TcxTreeListReportLinkRowSubItemsProducer.InitializeSubItem
  (ASubItem: TAbstractdxReportCellData; AnIndex: Integer);
begin
end;

function TcxTreeListReportLinkRowSubItemsProducer.GetHasSubItem
  (Index: Integer): Boolean;
begin
  Result := True;
end;

function TcxTreeListReportLinkRowSubItemsProducer.GetSubItemBound
  (Index: Integer): TRect;
begin
  Result := Rect(0, 0, -1, -1);
end;
...
function TcxTreeListReportLinkRowSubItemsProducer.GetColumn(Index: Integer)
  : TcxTreeListColumn;
begin
...
procedure TcxTreeListReportLinkBandsProducer.InitializeSubItem
  (ASubItem: TAbstractdxReportCellData; AnIndex: Integer);
begin
  inherited;
...
function TcxTreeListReportLinkBandsProducer.GetSubItemBound
  (Index: Integer): TRect;
begin
  Result := Formatter.GetBandItemBounds(Index);
end;

function TcxTreeListReportLinkBandsProducer.GetSubItemClass(Index: Integer)
  : TdxReportCellDataClass;
begin
...
constructor TcxTreeListReportLinkBandedRowProducer.Create
  (ABuilder: TcxTreeListReportLinkBuilder);
begin
...
function TcxTreeListReportLinkBandedRowProducer.Produce
  (AHostInfo: TcxTreeListAttributeHostInfo): TdxReportCell;
begin
  FIndents.Clear;
  Result := inherited Produce(AHostInfo);
...
procedure TcxTreeListReportLinkBandedRowProducer.CreateBandedDataItems
  (AParent: TdxReportCell);
var
  I: Integer;
  ...
  AItem: TAbstractdxReportCellData;
begin
  ABandPlace := Formatter.ItemPlaceController.GetItemByBand
    (TcxTreeListBand(AParent.Data));
...
procedure TcxTreeListReportLinkBandedRowProducer.CreateBandedRows
  (AParent: TdxReportCell);
var
  I: Integer;
  ABandPlace: TcxTreeListCustomBandPlace;
...
begin
  ...
  begin
    ...
    ABandRowBounds := Bounds(ABandPlace.LeftBound, 0, ABandPlace.Width,
      RowHeight);
...
procedure TcxTreeListReportLinkBandedRowProducer.CreateIndents
  (AParent: TdxReportCell);
var
  I: Integer;
...
procedure TcxTreeListReportLinkBandedRowProducer.CreateIndentsRow
  (AParent: TdxReportCell);
var
...
begin
  if Adapter.TreeList.Bands.ExpandableBand = nil then
    Exit;
  ABandPlace := Formatter.ItemPlaceController.ItemsByBand
    [Adapter.TreeList.Bands.ExpandableBand];
  ...
  AIndentsRow.BoundsRect := Bounds(ABandPlace.LeftBound, 0, GetBandedRowIndent,
    RowHeight);
...
function TcxTreeListReportLinkBandedRowProducer.GetIndentBound
...
procedure TcxTreeListReportLinkBandedRowProducer.InitializeIndent
  (AnIndent: TdxReportCellExpandButton; AnIndex: Integer);
begin
end;

function TcxTreeListReportLinkBandedRowProducer.GetIndent(Index: Integer)
...
function TcxTreeListReportLinkFootersProducer.Produce
  (AHostInfo: TcxTreeListAttributeHostInfo;
  AAttachedNode, ADataNode: TcxTreeListNode): TdxReportCell;
begin
...
procedure TcxTreeListReportLinkFootersProducer.CreateBandedDataItems
  (AParent: TdxReportCell);
var
...
begin
  ...
  begin
    AColumnPlace := ABandPlace.Items[I];
    for ACellIndex := 0 to Formatter.GetFooterCellCount(AColumnPlace.Column,
      FDataNode) - 1 do
    begin
      AItem := TdxReportCellString.Create(AParent);
      AItem.BoundsRect :=
        cxRectOffset(Formatter.GetFooterCellBounds(AColumnPlace.Column,
        ACellIndex, IndentArea), -AParent.Left, 0);
      Formatter.DoInitializeFooterCell(AItem, AColumnPlace.Column, ACellIndex,
        FDataNode);
    end;
  end;
end;
...
procedure TcxTreeListReportLinkFootersProducer.InitializeBandedRow
  (ARow: TdxReportCell);
begin
...
procedure TcxTreeListReportLinkFootersProducer.InitializeIndent
  (AnIndent: TdxReportCellExpandButton; AnIndex: Integer);
begin
  Formatter.DoInitializeFooterIndent(AnIndent, AnIndex, IndentCount,
    FAttachedNode);
  Formatter.DoReportLinkInitializeNodeIndent(AnIndent, AnIndex, IndentCount,
    FAttachedNode); // TODO FooterIndentinitialize
end;
...
function TcxTreeListReportLinkHeadersProducer.GetSubItemBound
  (Index: Integer): TRect;
begin
  Result := Formatter.GetHeaderItemBounds(Index);
end;

function TcxTreeListReportLinkHeadersProducer.GetSubItemClass(Index: Integer)
  : TdxReportCellDataClass;
begin
...
function TcxTreeListReportLinkNodeProducer.Produce
  (AHostInfo: TcxTreeListAttributeHostInfo; ANode: TcxTreeListNode)
  : TdxReportCell;
begin
  FNode := ANode;
  Result := inherited Produce(AHostInfo);
...
begin
  ...
  begin
    ...
    AViewData := TcxTreeListNodeViewData.Create(AViewInfo, FNode,
      Adapter.ColumnCount);
    try
      TcxTreeListViewInfoAccess(AViewInfo).InitializeRows(FRowHeight,
        AViewData);
    finally
      AViewData.Free;
    end;
...
procedure TcxTreeListReportLinkNodeProducer.CreateChecks
  (AParent: TdxReportCell);
begin
...
begin
  if Adapter.HasCheck(FNode) then
    CreateChecks(AParent);
  if Formatter.HasStateImages(FNode) then
    CreateStateImages(AParent);
  if Formatter.HasImages(FNode) then
    CreateImages(AParent);
end;

procedure TcxTreeListReportLinkNodeProducer.CreateImages
  (AParent: TdxReportCell);
begin
...
procedure TcxTreeListReportLinkNodeProducer.CreateIndents
  (AParent: TdxReportCell);
begin
...
procedure TcxTreeListReportLinkNodeProducer.CreatePreview
  (AParent: TdxReportCell);
begin
  FPreviewItem := Formatter.GetPreviewClass(PreviewColumn, FNode)
    .Create(AParent);
  ...
  Formatter.DoInitializePreview(FPreviewItem, PreviewColumn, FNode);
  // v3.1 because cxRichEdit
...
procedure TcxTreeListReportLinkNodeProducer.CreateStateImages
  (AParent: TdxReportCell);
begin
...
begin
  ...
  begin
    ...
    Result := dxPScxCommon.dxPSDataMaps.
      DoesItemParticipateInAutoHeightCalculation(AProperties);
  end;
end;
...
begin
  ...
  Formatter.DoInitializeNodeItem(AItem, TcxTreeListColumn(AItem.Data),
    FNode, False);
  Formatter.DoReportLinkInitializeNodeItem(AItem,
    TcxTreeListColumn(AItem.Data), FNode);
end;

procedure TcxTreeListReportLinkNodeProducer.InitializeBandedRow
  (ARow: TdxReportCell);
begin
  inherited InitializeBandedRow(ARow);
...
procedure TcxTreeListReportLinkNodeProducer.InitializeIndent
  (AnIndent: TdxReportCellExpandButton; AnIndex: Integer);
begin
  Formatter.DoInitializeNodeIndent(AnIndent, AnIndex, IndentCount, FNode);
  Formatter.DoReportLinkInitializeNodeIndent(AnIndent, AnIndex,
    IndentCount, FNode);
end;
...
procedure TcxTreeListReportLinkNodeProducer.InitializeStateImage
  (AnIndex: Integer);
begin
...
function TcxTreeListReportLinkNodeProducer.IsItemIndent
  (AnItem: TdxReportVisualItem): Boolean;
begin
...
var
  AColumnPlace: TcxTreeListColumnPlace;
begin
  AColumnPlace := Formatter.ItemPlaceController.GetItemByColumn
    (TcxTreeListColumn(AItem.Data));
...
begin
  Result := Bounds(IndentWidth * IndentCount, 0, Adapter.GetCheckWidth(FNode),
    RowHeight);
end;
...
begin
  Result := Bounds(IndentWidth * IndentCount, 0,
    Formatter.GetImagesWidth(FNode), RowHeight);
  OffsetRect(Result, Formatter.GetStateImagesWidth(FNode) +
    Adapter.GetCheckWidth(FNode), 0);
end;
...
begin
  ...
  if not(Formatter.PreviewAutoHeight and (Formatter.PreviewMaxLineCount = 0))
  then
...
begin
  if FPreviewItem <> nil then
    ...
    begin
      ...
      begin
        LineHeight := PreviewItem.MeasureFontHeight(Formatter.Canvas) - 2 *
          dxTextSpace;
        Result := Min(LineHeight * Formatter.PreviewMaxLineCount, Result);
      end;
    end
    else
      Result := PreviewItem.MeasureFontHeight(Formatter.Canvas) - 2 *
        dxTextSpace
  else
    Result := 0;
end;
...
function TcxTreeListReportLinkNodeProducer.GetPreviewPlace
...
procedure TcxTreeListReportLinkCategorizedNodeProducer.CreateBandedRows
  (AParent: TdxReportCell);
var
  AItem: TAbstractdxReportCellData;
begin
  AItem := Formatter.GetNodeItemClass(Adapter.CategorizedColumn, FNode, False)
    .Create(Row);
  AItem.BoundsRect := Rect(PreviewIndent, 0, RowWidth, RowHeight);
  Formatter.DoInitializeNodeItem(AItem, Adapter.CategorizedColumn,
    FNode, False);
  Formatter.DoReportLinkInitializeNodeItem(AItem,
    Adapter.CategorizedColumn, FNode);
end;
...
class function TcxTreeListNodeHelper.ProducerClass
  : TcxTreeListReportLinkNodeProducerClass;
begin
...
begin
  ...
  try
    with Node do
      ...
      begin
        Node := Items[I];
        if Node.Selected or Adapter.Helpers[Node].HasSelectedChildren then
          Exit;
      end;
  finally
    Node := SaveNode;
...
begin
  for Result := 0 to Count - 1 do
    if Items[Result].NodeClass = Node.ClassType then
      Exit;

  Result := Add(cxTreeListNodeHelperFactory.HelperClasses[Node]
    .Create(Adapter));
end;

function TcxTreeListNodeHelperCache.GetHelper(Node: TcxTreeListNode)
  : TcxTreeListNodeHelper;
begin
...
function TcxTreeListNodeHelperCache.GetItem(Index: Integer)
  : TcxTreeListNodeHelper;
begin
...
constructor TcxTreeListReportLinkProducerCache.Create
  (ABuilder: TcxTreeListReportLinkBuilder);
begin
  inherited Create;
  FBuilder := ABuilder;
...
function TcxTreeListReportLinkProducerCache.IndexOf(AProducerClass
  : TcxTreeListReportLinkRowProducerClass): Integer;
begin
  for Result := 0 to Count - 1 do
...
function TcxTreeListReportLinkProducerCache.GetProducer(ProducerClass
  : TcxTreeListReportLinkRowProducerClass): TcxTreeListReportLinkRowProducer;
begin
  Result := Items[IndexOf(ProducerClass)];
end;

function TcxTreeListReportLinkProducerCache.GetItem(Index: Integer)
  : TcxTreeListReportLinkRowProducer;
begin
...
constructor TcxTreeListReportLinkBuilder.Create(AReportLink
  : TcxTreeListCustomReportLink);
begin
  inherited Create;
...
class function TcxTreeListReportLinkBuilder.AdapterClass
  : TcxTreeListAdapterClass;
begin
...
class function TcxTreeListReportLinkBuilder.FormatterClass
  : TcxTreeListReportLinkFormatterClass;
begin
...
begin
  AddReportRow(GetBandsProducer.Produce
    (ReportLink.HostInfoServices.BandHeadersHostInfo));
end;

function TcxTreeListReportLinkBuilder.GetBandsProducer
  : TcxTreeListReportLinkBandsProducer;
begin
  Result := ProducerCache[GetBandsProducerClass]
    as TcxTreeListReportLinkBandsProducer;
end;

function TcxTreeListReportLinkBuilder.GetBandsProducerClass
  : TcxTreeListReportLinkBandsProducerClass;
begin
  Result := TcxTreeListReportLinkBandsProducer;
end;

procedure TcxTreeListReportLinkBuilder.CreateFooters
  (AHostInfo: TcxTreeListAttributeHostInfo;
...
function TcxTreeListReportLinkBuilder.GetFootersProducer
  : TcxTreeListReportLinkFootersProducer;
begin
  Result := ProducerCache[GetFootersProducerClass]
    as TcxTreeListReportLinkFootersProducer;
end;

function TcxTreeListReportLinkBuilder.GetFootersProducerClass
  : TcxTreeListReportLinkFootersProducerClass;
begin
...
begin
  AddReportRow(GetHeadersProducer.Produce
    (ReportLink.HostInfoServices.HeadersHostInfo));
end;

function TcxTreeListReportLinkBuilder.GetHeadersProducer
  : TcxTreeListReportLinkHeadersProducer;
begin
  Result := ProducerCache[GetHeadersProducerClass]
    as TcxTreeListReportLinkHeadersProducer;
end;

function TcxTreeListReportLinkBuilder.GetHeadersProducerClass
  : TcxTreeListReportLinkHeadersProducerClass;
begin
...
begin
  AddReportRow(GetNodeProducer(ANode)
    .Produce(ReportLink.HostInfoServices.PageDetailsHostInfo, ANode));
end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        while (ASummaryNodes.Count > 0) and Adapter.HasNodeAttachedFooter(ANode,
          TcxTreeListNode(ASummaryNodes.Peek)) do
...
function TcxTreeListReportLinkBuilder.GetNodeProducer(ANode: TcxTreeListNode)
  : TcxTreeListReportLinkNodeProducer;
begin
  Result := ProducerCache[GetNodeProducerClass(ANode)
    ] as TcxTreeListReportLinkNodeProducer;
end;

function TcxTreeListReportLinkBuilder.GetNodeProducerClass
  (ANode: TcxTreeListNode): TcxTreeListReportLinkNodeProducerClass;
begin
...
procedure TcxTreeListReportLinkBuilder.CreateNodeSeparator
  (ANode: TcxTreeListNode);
begin
  AddReportRow(GetNodeSeparatorProducer.Produce
    (ReportLink.HostInfoServices.PageDetailsHostInfo));
end;

function TcxTreeListReportLinkBuilder.GetNodeSeparatorProducer
  : TcxTreeListReportLinkNodeSeparatorProducer;
begin
  Result := ProducerCache[GetNodeSeparatorProducerClass]
    as TcxTreeListReportLinkNodeSeparatorProducer;
end;

function TcxTreeListReportLinkBuilder.GetNodeSeparatorProducerClass
...
begin
  ...
  if not IsAborted and Formatter.ShowFooters then
    CreateFooters(ReportLink.HostInfoServices.FootersHostInfo, nil,
      TreeList.Root);
end;
...
function TcxTreeListReportLinkBuilder.GetReportRow(Index: Integer)
  : TdxReportCell;
begin
...
constructor TcxTreeListReportLinkBuilderHandler.Create
  (ABuilder: TcxTreeListReportLinkBuilder);
begin
  inherited Create;
  FBuilder := ABuilder;
...
function TcxTreeListReportLinkBuilderHandler.Builder
  : TcxTreeListReportLinkBuilder;
begin
  Result := FBuilder;
end;

function TcxTreeListReportLinkBuilderHandler.GetReportLink
  : TcxTreeListCustomReportLink;
begin
...
begin
  ...
  if Supports(TreeList, IcxDataControllerConditionalFormattingProviderOwner,
...
begin
  ...
  begin
    ...
    FGroupFooterLineCount :=
      Max(1, TreeList.Summary.GroupFooterSummaryRowCount);
  end
  else
  begin
...
class function TcxTreeListAdapter.GetPropertiesClass(AColumn: TcxTreeListColumn;
  ANode: TcxTreeListNode): TcxCustomEditPropertiesClass;
begin
  Result := TcxCustomEditPropertiesClass(GetProperties(AColumn, ANode)
    .ClassType);
end;
...
function TcxTreeListAdapter.GetBandHeaderViewParams(ABand: TcxTreeListBand)
  : TcxViewParams;
begin
...
function TcxTreeListAdapter.GetColumnFooterViewParams
  (AColumn: TcxTreeListColumn): TcxViewParams;
begin
...
function TcxTreeListAdapter.GetColumnHeaderViewParams
  (AColumn: TcxTreeListColumn): TcxViewParams;
begin
  if AColumn = nil then
...
begin
  Result := (ConditionalFormattingProvider <> nil) and
    ...
    .TryGetStyle(cxPoint(AColumn.ItemIndex, ANode.AbsoluteIndex), AStyle);
end;
...
function TcxTreeListAdapter.HasNodeAttachedFooter(ANode,
  ASummaryNode: TcxTreeListNode): Boolean;
begin
  Result := not ANode.Expanded and
    ((ANode = ASummaryNode) or (ANode = ASummaryNode.GetLastChildVisible) or
...
begin
  Result := ANode.HasChildren and
    ((OptionsView.GroupFooters = tlgfAlwaysVisible) or
...
function TcxTreeListAdapter.GetHelper(Node: TcxTreeListNode)
  : TcxTreeListNodeHelper;
begin
...
constructor TcxTreeListColumnPlace.Create(AController
  : TcxTreeListCustomBandPlace; AColumn: TcxTreeListColumn);
begin
  inherited Create;
...
procedure TcxTreeListColumnPlace.InitAutoWidthItem(AnItem: TcxAutoWidthItem);
begin
...
begin
  ...
  begin
    Result := RowOffset[Column.Position.Row.LineOffset +
      Column.Position.LineCount] - RowOffset[Column.Position.Row.LineOffset];
  end;
end;

function TcxTreeListColumnPlace.GetFooterCellBounds(AIndex: Integer): TRect;
begin
  Result := Bounds(LeftBound, (RowIndex + AIndex * LineCount) *
    FooterLineHeight, Width, LineCount * FooterLineHeight);
...
constructor TcxTreeListCustomBandPlace.Create(AController
  : TcxTreeListItemPlaceController; AParent: TcxTreeListBandPlace;
...
function TcxTreeListCustomBandPlace.IndexOf(AColumn: TcxTreeListColumn)
  : Integer;
begin
...
function TcxTreeListCustomBandPlace.GetItemByColumn(Column: TcxTreeListColumn)
  : TcxTreeListColumnPlace;
var
  Index: Integer;
begin
...
function TcxTreeListCustomBandPlace.CreateItem(AColumn: TcxTreeListColumn)
  : TcxTreeListColumnPlace;
begin
...
function TcxTreeListCustomBandPlace.GetItem(AIndex: Integer)
  : TcxTreeListColumnPlace;
begin
...
function TcxTreeListBandPlace.GetChildItem(Index: Integer)
  : TcxTreeListCustomBandPlace;
begin
...
begin
  ...
  begin
    ...
    try
      for J := 0 to ARow.VisibleItemCount - 1 do
        ItemsByColumn[ARow.VisibleItems[J]].InitAutoWidthItem
          (AAutoWidthObject.AddItem);
      AAutoWidthObject.AvailableWidth := ItemsAvailableWidth;
      AAutoWidthObject.Calculate;
...
function TcxTreeListItemPlaceController.BottomIndexOf
  (AnItem: TcxTreeListCustomBandPlace): Integer;
begin
...
function TcxTreeListItemPlaceController.IndexOf(ABand: TcxTreeListBand)
  : Integer;
begin
  for Result := 0 to ItemCount - 1 do
...
function TcxTreeListItemPlaceController.CreateItem(ABand: TcxTreeListBand)
  : TcxTreeListCustomBandPlace;
begin
  Result := GetItemClass(ABand).Create(Self, nil, ABand);
end;

function TcxTreeListItemPlaceController.GetItemClass(ABand: TcxTreeListBand)
  : TcxTreeListCustomBandPlaceClass;
begin
...
function TcxTreeListItemPlaceController.GetBottomItem(AIndex: Integer)
  : TcxTreeListCustomBandPlace;
begin
...
function TcxTreeListItemPlaceController.GetItem(AIndex: Integer)
  : TcxTreeListCustomBandPlace;
begin
  Result := TcxTreeListCustomBandPlace(FItems[AIndex]);
end;

function TcxTreeListItemPlaceController.GetItemByBand(ABand: TcxTreeListBand)
  : TcxTreeListCustomBandPlace;
var
  AIndex: Integer;
begin
...
function TcxTreeListItemPlaceController.GetLevelHeight(AIndex: Integer)
  : Integer;
begin
  Result := Integer(FLevelHeights[AIndex]);
end;

function TcxTreeListItemPlaceController.GetRootItem(AIndex: Integer)
  : TcxTreeListCustomBandPlace;
begin
...
constructor TcxTreeListReportLinkFormatter.Create
  (ABuilder: TcxTreeListReportLinkBuilder);
begin
  inherited;
  FFont := TFont.Create;
...
procedure TcxTreeListReportLinkFormatter.DoInitializeBandItem
...
begin
  ...
  begin
    ...
    begin
      ...
      ImageLayout := HeaderImageLayoutMap[Band.Caption.GlyphAlignHorz,
        Band.Caption.GlyphAlignVert];
...
procedure TcxTreeListReportLinkFormatter.DoInitializeBandRow
  (ARow: TdxReportCell);
begin
...
function TcxTreeListReportLinkFormatter.GetBandBackgroundViewParams
...
function TcxTreeListReportLinkFormatter.GetBandItemBounds
  (Index: Integer): TRect;
var
...
function TcxTreeListReportLinkFormatter.GetBandItemClass(Index: Integer)
  : TdxReportCellTextClass;
begin
  Result := TdxReportCellImage;
end;

function TcxTreeListReportLinkFormatter.GetBandItemViewParams
  (ABand: TcxTreeListBand): TdxReportItemViewParams;
begin
  FillChar(Result, SizeOf(Result), 0);
...
procedure TcxTreeListReportLinkFormatter.DoInitializeNodeCheck
  (AnItem: TdxCustomReportCellCheck; ANode: TcxTreeListNode; AnIndex: Integer);
begin
  ...
  TdxReportCellCheck(AnItem).FlatBorder :=
    ReportLink.OptionsRefinements.FlatCheckMarks;
end;

function TcxTreeListReportLinkFormatter.GetNodeCheckCellSides
...
function TcxTreeListReportLinkFormatter.GetNodeCheckClass
  (ANode: TcxTreeListNode): TdxCustomReportCellCheckClass;
begin
...
function TcxTreeListReportLinkFormatter.GetNodeCheckViewParams
  (ANode: TcxTreeListNode; AnIndex: Integer): TdxReportItemViewParams;
begin
  FillChar(Result, SizeOf(Result), 0);
  if ReportLink.OptionsFormatting.UseNativeStyles then
  ...
  else if CanProcessSelectionStyle(ANode) then
...
procedure TcxTreeListReportLinkFormatter.DoInitializeFooterCell
  (AnItem: TAbstractdxReportCellData; AColumn: TcxTreeListColumn;
  ACellIndex: Integer; ANode: TcxTreeListNode);
var
  ...
  begin
    ...
    if (GetFooterCellCount(AColumn, ANode) <> 1) or
      ...
      begin
        if Text <> '' then
          Text := Text + ';';
        Text := Text + ANode.FooterSummaryTexts
          [GetSummaryItems(ANode)[AColumnIndex, I].AbsoluteIndex];
      end;
  end;
end;

procedure TcxTreeListReportLinkFormatter.DoInitializeFooterIndent
...
begin
  ...
  if ReportLink.OptionsView.TreeLines then
    AnItem.TreeLineMode := GetNodeFooterIndentTreeLineMode(AnIndex,
      AnIndentCount, ANode);
end;
...
begin
  ...
  if (AIndex = ALastIndex) or ABandPlace.Controller.BottomItems[AIndex + 1]
    .Expandable and (AIndentCount > 0) then
    ARow.CellSides := ARow.CellSides + [csRight];
end;

procedure TcxTreeListReportLinkFormatter.DoInitializeFooterRow
  (ARow: TdxReportCell);
begin
  ARow.Transparent := True;
...
procedure TcxTreeListReportLinkFormatter.DoReportLinkInitializeFooterCell
  (AnItem: TAbstractdxReportCellData; AColumnIndex, ACellIndex: Integer);
begin
  ReportLink.DoInitializeFooterCell(Columns[AColumnIndex], ACellIndex,
    TdxReportCellString(AnItem));
end;

function TcxTreeListReportLinkFormatter.GetFooterCellBounds
  (AColumn: TcxTreeListColumn; ACellIndex, AIndent: Integer): TRect;
var
...
function TcxTreeListReportLinkFormatter.GetFooterCellClass
  : TdxReportCellTextClass;
begin
  Result := TdxReportCellString;
end;

function TcxTreeListReportLinkFormatter.GetFooterCellViewParams
  (AColumn: TcxTreeListColumn): TdxReportItemViewParams;
begin
  FillChar(Result, SizeOf(Result), 0);
  if ReportLink.OptionsFormatting.UseNativeStyles then
...
function TcxTreeListReportLinkFormatter.GetNodeFooterIndentTreeLineMode(AnIndex,
...
function TcxTreeListReportLinkFormatter.GetFooterRowViewParams
  : TdxReportItemViewParams;
begin
  FillChar(Result, SizeOf(Result), 0);
  if ReportLink.OptionsFormatting.UseNativeStyles then
...
procedure TcxTreeListReportLinkFormatter.DoInitializeHeaderItem
  (AnItem: TAbstractdxReportCellData; AnIndex: Integer);
var
  AColumn: TcxTreeListColumn;
begin
  ...
  begin
    ...
    begin
      ...
      ImageLayout := HeaderImageLayoutMap[AColumn.Caption.GlyphAlignHorz,
        AColumn.Caption.GlyphAlignVert];
      IsTextDrawnForCenteredImage := True;
      IsTextShiftedForHorizontallyCenteredImage :=
        not(ImageLayout in [ilImageTopCenter, ilImageCenterCenter,
        ilImageBottomCenter]);
...
procedure TcxTreeListReportLinkFormatter.DoInitializeHeaderRow
  (ARow: TdxReportCell);
begin
...
procedure TcxTreeListReportLinkFormatter.DoReportLinkInitializeHeaderItem
  (AnItem: TAbstractdxReportCellData; AIndex: Integer);
begin
  ReportLink.DoInitializeHeaderCell(Columns[AIndex],
    TdxReportCellImage(AnItem));
end;

function TcxTreeListReportLinkFormatter.GetHeaderItemBounds
...
function TcxTreeListReportLinkFormatter.GetHeaderItemClass(AnIndex: Integer)
  : TdxReportCellTextClass;
begin
  Result := TdxReportCellImage;
end;

function TcxTreeListReportLinkFormatter.GetHeaderItemViewParams
  (AColumn: TcxTreeListColumn): TdxReportItemViewParams;
begin
  FillChar(Result, SizeOf(Result), 0);
  if ReportLink.OptionsFormatting.UseNativeStyles then
...
procedure TcxTreeListReportLinkFormatter.DoInitializeNodeImage
  (AnItem: TdxReportCellGraphic; ANode: TcxTreeListNode; AnIndex: Integer);
begin
...
procedure TcxTreeListReportLinkFormatter.DoReportLinkInitializeNodeImage
  (AnItem: TAbstractdxReportCellData; ANode: TcxTreeListNode; AnIndex: Integer);
begin
  ReportLink.DoInitializeIndentCell(ANode, AnIndex, AnItem);
end;

function TcxTreeListReportLinkFormatter.GetNodeImageCellSides
  (ANode: TcxTreeListNode; AnIndex: Integer): TdxCellSides;
begin
  Result := [];
  if ReportLink.OptionsView.Borders then
...
function TcxTreeListReportLinkFormatter.GetNodeImageClass
  : TdxReportCellGraphicClass;
begin
  Result := TdxReportCellGraphic;
end;

function TcxTreeListReportLinkFormatter.GetNodeImageViewParams
  (ANode: TcxTreeListNode; AnIndex: Integer): TdxReportItemViewParams;
begin
  FillChar(Result, SizeOf(Result), 0);
  if ReportLink.OptionsFormatting.UseNativeStyles then
...
procedure TcxTreeListReportLinkFormatter.DoInitializeNodeIndent
  (AnItem: TdxReportCellExpandButton; AnIndex, AnIndentCount: Integer;
  ANode: TcxTreeListNode);
begin
  SetViewParams(AnItem, GetNodeIndentViewParams(ANode, AnIndex, AnIndentCount));
  ...
  AnItem.Data := MakeIndentIndex(AnIndex);
  AnItem.ShowButton := (AnIndex = AnIndentCount - 1) and ANode.HasChildren and
    ReportLink.OptionsView.ExpandButtons;
  if AnItem.ShowButton then
    DoInitializeExpandButton(AnItem, AnIndex, AnIndentCount, ANode);
  if ReportLink.OptionsView.TreeLines then
    AnItem.TreeLineMode := GetNodeIndentTreeLineMode(AnIndex,
      AnIndentCount, ANode);
end;

procedure TcxTreeListReportLinkFormatter.DoInitializeExpandButton
  (AnItem: TdxReportCellExpandButton; AnIndex, AnIndentCount: Integer;
  ANode: TcxTreeListNode);
begin
  with AnItem do
...
procedure TcxTreeListReportLinkFormatter.DoReportLinkInitializeNodeIndent
  (AnItem: TAbstractdxReportCellData; AnIndex, AnIndentCount: Integer;
  ANode: TcxTreeListNode);
begin
  ReportLink.DoInitializeIndentCell(ANode, AnIndex, AnItem);
...
function TcxTreeListReportLinkFormatter.GetNodeIndentCellSides
  (ANode: TcxTreeListNode; AnIndex, AnIndentCount: Integer): TdxCellSides;
begin
  Result := [];
  if ReportLink.OptionsView.Borders and (AnIndex = AnIndentCount - 1) and
    not HasStateImages(ANode) and not HasImages(ANode) and
    not Adapter.HasCheck(ANode) then
    Result := [csRight];
end;

function TcxTreeListReportLinkFormatter.GetNodeIndentClass
...
begin
  ...
  if Parent = ANode then
    ...
    else if not HasParent(ANode) and IsNodeFirstChild(ANode) then
      Result := tlmTopRightCorner
    else
      Result := tlmCross
  else if IsNodeLastChild(Parent) then
    Result := tlmNone
  else
    Result := tlmVertical;
end;
...
function TcxTreeListReportLinkFormatter.GetNodeIndentViewParams
  (ANode: TcxTreeListNode; AnIndex, AnIndentCount: Integer)
  : TdxReportItemViewParams;
begin
...
procedure TcxTreeListReportLinkFormatter.DoInitializeNodeBandedRow
  (ARow: TdxReportCell);
const
...
procedure TcxTreeListReportLinkFormatter.DoInitializeNodeRow
  (ARow: TdxReportCell; ANode: TcxTreeListNode);
const
...
procedure TcxTreeListReportLinkFormatter.DoInitializeNodeItem
  (AnItem: TAbstractdxReportCellData; AColumn: TcxTreeListColumn;
  ANode: TcxTreeListNode; AnIsPreview: Boolean = False);
...
begin
  ...
  dxPScxCommon.dxPSDataMaps.InitializeItem(AnItem, Properties, CellValue, Self,
    ViewParams, AnIsPreview { , ANode.RecordIndex } );
  dxPScxCommon.dxPSDataMaps.GetImageLists(Properties,
    ReportLink.AppendImageList);

  if (ViewParams.NativeParams.Bitmap <> nil) and
    not ViewParams.NativeParams.Bitmap.Empty then
    AnItem.BackgroundBitmapIndex := ReportLink.AddBackgroundBitmapToPool
      (ViewParams.NativeParams.Bitmap);

  AnItem.Data := TdxNativeInt(AColumn);
end;

procedure TcxTreeListReportLinkFormatter.DoReportLinkInitializeNodeItem
  (AnItem: TAbstractdxReportCellData; AColumn: TcxTreeListColumn;
  ANode: TcxTreeListNode);
begin
...
function TcxTreeListReportLinkFormatter.GetCellValue
  (AProperties: TcxCustomEditProperties; AColumn: TcxTreeListColumn;
  ANode: TcxTreeListNode): TcxEditValue;
begin
...
function TcxTreeListReportLinkFormatter.GetNodeBackgroundBitmapStyleIndex
  (ANode: TcxTreeListNode): Integer;
...
begin
  Result := tlsv_Content;
  if IsOddNode(ANode) and HasBackgroundBitmap(ReportLink.Styles.StylesByCaption
    [cxGetResourceString(@sdxContentOddStyle)]) then
    Result := tlsv_ContentOdd
  else if not IsOddNode(ANode) and
    HasBackgroundBitmap(ReportLink.Styles.StylesByCaption
    [cxGetResourceString(@sdxContentEvenStyle)]) then
    Result := tlsv_ContentEven
end;

function TcxTreeListReportLinkFormatter.GetNodeItemBounds
  (ANode: TcxTreeListNode; AIndex: Integer): TRect;
var
  AItem: TcxTreeListColumnPlace;
begin
...
function TcxTreeListReportLinkFormatter.GetNodeItemCellSides
  (AColumn: TcxTreeListColumn; ANode: TcxTreeListNode): TdxCellSides;
begin
  if ReportLink.OptionsView.Borders then
    Result := csAll
  else
...
function TcxTreeListReportLinkFormatter.GetNodeItemClass
  (AColumn: TcxTreeListColumn; ANode: TcxTreeListNode;
  AnIsPreview: Boolean = False): TdxReportCellDataClass;
begin
  Result := dxPSDataMaps.ItemClass(Adapter.GetProperties(AColumn, ANode),
    GetNodeItemViewParams(AColumn, ANode), AnIsPreview);
end;
...
begin
  ...
  if Adapter.TryGetAdvancedStyle(AColumn, ANode, AStyle) and (AStyle <> nil)
  then
...
function TcxTreeListReportLinkFormatter.GetPreviewCellSides
  (ANode: TcxTreeListNode): TdxCellSides;
const
  CellSidesMap: array [Boolean] of TdxCellSides = ([], csAll);
begin
...
function TcxTreeListReportLinkFormatter.GetPreviewClass
  (AColumn: TcxTreeListColumn; ANode: TcxTreeListNode): TdxReportCellDataClass;
begin
...
begin
  ...
  Result.FontStyle := [];
  Result.Transparent := { True;// } IsColorTransparent
    (Result.NativeParams.Color); // ReportLink.Transparent;
end;

procedure TcxTreeListReportLinkFormatter.DoInitializeNodeSeparator
  (AnItem: TAbstractdxReportCellData);
begin
...
procedure TcxTreeListReportLinkFormatter.DoInitializeNodeSeparatorRow
  (ARow: TdxReportCell);
begin
end;

function TcxTreeListReportLinkFormatter.GetNodeSeparatorClass
...
procedure TcxTreeListReportLinkFormatter.DoInitializeNodeStateImage
  (AnItem: TdxReportCellGraphic; ANode: TcxTreeListNode; AnIndex: Integer);
begin
...
procedure TcxTreeListReportLinkFormatter.DoReportLinkInitializeNodeStateImage
  (AnItem: TAbstractdxReportCellData; ANode: TcxTreeListNode; AnIndex: Integer);
begin
  ReportLink.DoInitializeIndentCell(ANode, AnIndex, AnItem);
end;

function TcxTreeListReportLinkFormatter.GetNodeStateImageCellSides
  (ANode: TcxTreeListNode; AnIndex: Integer): TdxCellSides;
begin
  Result := [];
...
function TcxTreeListReportLinkFormatter.GetNodeStateImageClass
  : TdxReportCellGraphicClass;
begin
  Result := TdxReportCellGraphic;
end;

function TcxTreeListReportLinkFormatter.GetNodeStateImageViewParams
  (ANode: TcxTreeListNode; AnIndex: Integer): TdxReportItemViewParams;
begin
  FillChar(Result, SizeOf(Result), 0);
  if ReportLink.OptionsFormatting.UseNativeStyles then
...
function TcxTreeListReportLinkFormatter.QueryInterface(const IID: TGUID;
  out Obj): HResult;
begin
...
function TcxTreeListReportLinkFormatter.IdxPSCellParams_GetCanvas
  : TdxPSReportRenderCustomCanvas;
begin
  Result := Canvas;
end;

function TcxTreeListReportLinkFormatter.
...
function TcxTreeListReportLinkFormatter.IdxPSCellParams2_GetRichEditGraphicClass
  : TGraphicClass;
const
...
begin
  ...
  begin
    ...
    Builder.ReportCells.TreeLineStyle := TreeLinesStyleMap
...
begin
  ...
  begin
    ...
    if not Adapter.IsDefaultRowHeightAssigned and not AColumn.IsPreview then
      CalculateHeight(GetNodeItemViewParams(AColumn, Nodes[0]),
        FDetailsLineHeight);
  end;
  ...
  if PreviewColumn <> nil then
    CalculateHeight(GetPreviewViewParams(PreviewColumn, Nodes[0]),
      FPreviewLineHeight);
...
function TcxTreeListReportLinkFormatter.CanProcessSelectionStyle
  (ANode: TcxTreeListNode): Boolean;
begin
  Result := (ANode <> nil) and ReportLink.OptionsFormatting.
    ConsumeSelectionStyle and IsSelectedNode(ANode);
...
begin
  ...
  begin
    ...
    if ALevelInfo.FImages <> nil then
      FMaxNodeImageHeight := Max(FMaxNodeImageHeight,
        ALevelInfo.FImages.Height);
    if ALevelInfo.FStateImages <> nil then
      FMaxNodeImageHeight := Max(FMaxNodeImageHeight,
        ALevelInfo.FStateImages.Height);
  end;
end;
...
procedure TcxTreeListReportLinkFormatter.CreateNodeList;
  ...
  begin
    ...
    Result := not Adapter.MultiSelection or
      not ReportLink.OptionsSelection.ProcessSelection or
      (ANode.Selected or Helper.HasSelectedChildren or
      (not ReportLink.OptionsSelection.ProcessExactSelection and
      Helper.HasSelectedParents));
  end;
  ...
  begin
    ...
    if (ANode.Count > 0) and
      (ReportLink.OptionsExpanding.ExplicitlyExpandNodes or
      (ANode.Expanded or (ReportLink.OptionsExpanding.AutoExpandNodes and
      ANode.CanExpand))) then
      for I := 0 to ANode.Count - 1 do
      begin
        Node := ANode[I];
        if IsNodeProcessed(Node) then
          ProcessNode(Node);
      end;
  end;
...
begin
  ...
  begin
    ...
    if IsNodeProcessed(ANode) then
      ProcessNode(ANode);
  end;
end;

function TcxTreeListReportLinkFormatter.IsSelectedNode
  (ANode: TcxTreeListNode): Boolean;
begin
  Result := ReportLink.OptionsSelection.ProcessSelection or ANode.Selected;
end;

function TcxTreeListReportLinkFormatter.GetBackgroundBitmap
...
function TcxTreeListReportLinkFormatter.GetBackgroundBitmapIndex
  (Index: Integer): Integer;
begin
  Result := ReportLink.AddBackgroundBitmapToPool(GetBackgroundBitmap(Index));
end;

function TcxTreeListReportLinkFormatter.HasBackgroundBitmap
  (Index: Integer): Boolean;
var
  Bitmap: TBitmap;
begin
...
function TcxTreeListReportLinkFormatter.MapStyleBackgroundBitmapIndex
  (ATreeListBackgroundBitmapIndex: Integer): Integer;
begin
...
procedure TcxTreeListReportLinkFormatter.CalculateHeight(const AParams
  : TdxReportItemViewParams; var AHeight: Integer);
begin
  AHeight := Max(AHeight, CalculatePatternHeight(AParams));
end;

function TcxTreeListReportLinkFormatter.CalculatePatternHeight
...
begin
  ...
  begin
    ...
    if AColumn.ActuallyVisible then
...
procedure TcxTreeListReportLinkFormatter.CreateSummaryItems;
  ...
  procedure InternalCreateSummaryItems(AColumnIndex: Integer;
    AVisibleSummaryItems: TcxTreeListReportLinkSummaryItems;
  ...
  begin
    ...
    for ASummaryIndex := 0 to ASummaryItems.Count - 1 do
      ...
      begin
        AVisibleSummaryItems[AColumnIndex, AVisibleIndex] :=
          ASummaryItems[ASummaryIndex];
        Inc(AVisibleIndex);
      end;
  end;
...
function TcxTreeListReportLinkFormatter.GetFooterCellCount
  (AColumn: TcxTreeListColumn; ANode: TcxTreeListNode): Integer;
begin
  if HasFooterCell(AColumn, ANode) then
    Result := IfThen(Adapter.FMultiRows, 1,
      Length(GetSummaryItems(ANode)[FColumns.IndexOf(AColumn)]))
  else
    Result := 0;
end;

function TcxTreeListReportLinkFormatter.GetNodeIndent
  (ANode: TcxTreeListNode): Integer;
begin
...
function TcxTreeListReportLinkFormatter.GetNextNode(ANode: TcxTreeListNode)
  : TcxTreeListNode;
var
  Index: Integer;
begin
...
function TcxTreeListReportLinkFormatter.GetPrevNode(ANode: TcxTreeListNode)
  : TcxTreeListNode;
var
  Index: Integer;
begin
...
function TcxTreeListReportLinkFormatter.GetStyleFontIndex
  (const AParams: TdxReportItemViewParams): Integer;
begin
...
function TcxTreeListReportLinkFormatter.GetSummaryItems(ANode: TcxTreeListNode)
  : TcxTreeListReportLinkSummaryItems;
begin
...
function TcxTreeListReportLinkFormatter.HasFooterCell
  (AColumn: TcxTreeListColumn; ANode: TcxTreeListNode): Boolean;
begin
  if ANode = Adapter.TreeList.Root then
  ...
  Result := Result and
    (Length(GetSummaryItems(ANode)[FColumns.IndexOf(AColumn)]) > 0);
end;
...
begin
  ...
  if Result then
    Result := (ANode.ImageIndex > -1) and
      (ANode.ImageIndex < Images[ANode.Level].Count);
end;

function TcxTreeListReportLinkFormatter.HasParent
  (ANode: TcxTreeListNode): Boolean;
begin
...
begin
  ...
  if Result then
    Result := (ANode.StateIndex > -1) and
      (ANode.StateIndex < StateImages[ANode.Level].Count);
end;

function TcxTreeListReportLinkFormatter.IndexOfNode
  (ANode: TcxTreeListNode): Integer;
begin
  Result := FNodes.IndexOf(ANode);
end;

function TcxTreeListReportLinkFormatter.IsColorTransparent
  (AColor: TColor): Boolean;
begin
  Result := ColorToRGB(AColor) = ColorToRGB(TransparentColor);
end;

function TcxTreeListReportLinkFormatter.IsFirstNode(ANode: TcxTreeListNode)
  : Boolean;
begin
  Result := ANode = FNodes.First;
end;

function TcxTreeListReportLinkFormatter.IsLastNode(ANode: TcxTreeListNode)
  : Boolean;
begin
  Result := ANode = FNodes.Last;
end;

function TcxTreeListReportLinkFormatter.IsNodeExpanded
  (ANode: TcxTreeListNode): Boolean;
var
...
function TcxTreeListReportLinkFormatter.IsNodeFirstChild
  (ANode: TcxTreeListNode): Boolean;
begin
  Result := ANode.GetPrevSiblingVisible = nil;
end;

function TcxTreeListReportLinkFormatter.IsNodeLastChild
  (ANode: TcxTreeListNode): Boolean;
begin
  Result := ANode.GetNextSiblingVisible = nil;
end;

function TcxTreeListReportLinkFormatter.IsOddNode
  (ANode: TcxTreeListNode): Boolean;
begin
  Result := Odd(FNodes.IndexOf(ANode));
end;

function TcxTreeListReportLinkFormatter.IsNodeSelected
  (ANode: TcxTreeListNode): Boolean;
begin
  Result := ANode.Selected;
end;

procedure TcxTreeListReportLinkFormatter.RegisterLookAndFeelItem
...
procedure TcxTreeListReportLinkFormatter.SetViewParams
...
function TcxTreeListReportLinkFormatter.MakeIndentIndex
  (AnIndex: Integer): DWORD;
begin
...
begin
  if AutoWidth then
    if ReportLink.IsAggregated and Supports(TObject(ReportLink.Controller),
      IdxReportLinkController, AControllerIntf) then
...
function TcxTreeListReportLinkFormatter.GetBands(AIndex: Integer)
  : TcxTreeListBand;
begin
...
function TcxTreeListReportLinkFormatter.GetColumns(AIndex: Integer)
  : TcxTreeListColumn;
begin
  Result := FColumns[AIndex];
end;

function TcxTreeListReportLinkFormatter.GetCanvas
  : TdxPSReportRenderCustomCanvas;
begin
...
function TcxTreeListReportLinkFormatter.GetIndentCount
  (Node: TcxTreeListNode): Integer;
begin
  Result := Node.Level;
  if Adapter.ShowRoot then
    Inc(Result);
end;

function TcxTreeListReportLinkFormatter.GetImages(ALevel: Integer)
  : TCustomImageList;
begin
...
function TcxTreeListReportLinkFormatter.GetLevelInfos(ALevel: Integer)
  : TcxTreeListReportLinkLevelInfo;
begin
  Result := TcxTreeListReportLinkLevelInfo(FLevelInfos[ALevel]);
end;

function TcxTreeListReportLinkFormatter.GetLookAndFeelItem(Index: Integer)
  : TdxReportVisualItem;
begin
...
function TcxTreeListReportLinkFormatter.GetNode(Index: Integer)
  : TcxTreeListNode;
begin
...
function TcxTreeListReportLinkFormatter.GetStateImages(ALevel: Integer)
  : TCustomImageList;
begin
...
function TcxTreeListReportLinkFormatter.GetTreeLinesStyle
...
function TcxTreeListReportLinkOptionsExpanding.GetReportLink
  : TcxTreeListCustomReportLink;
begin
  Result := inherited ReportLink as TcxTreeListCustomReportLink;
end;

procedure TcxTreeListReportLinkOptionsExpanding.SetAutoExpandNodes
  (Value: Boolean);
begin
...
procedure TcxTreeListReportLinkOptionsExpanding.SetExplicitlyExpandNodes
  (Value: Boolean);
begin
...
function TcxTreeListReportLinkOptionsFormatting.
  GetActualNodeSeparatorColor: TColor;
begin
...
function TcxTreeListReportLinkOptionsFormatting.GetReportLink
  : TcxTreeListCustomReportLink;
begin
  Result := inherited ReportLink as TcxTreeListCustomReportLink;
end;

procedure TcxTreeListReportLinkOptionsFormatting.SetConsumeSelectionStyle
  (Value: Boolean);
begin
...
procedure TcxTreeListReportLinkOptionsFormatting.SetNodeSeparatorColor
  (Value: TColor);
begin
  if FNodeSeparatorColor <> Value then
  begin
    FNodeSeparatorColor := Value;
    if NodeSeparatorThickness <> 0 then
      Changed;
  end;
end;

procedure TcxTreeListReportLinkOptionsFormatting.SetNodeSeparatorThickness
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
function TcxTreeListReportLinkOptionsOnEveryPage.GetReportLink
  : TcxTreeListCustomReportLink;
begin
  Result := inherited ReportLink as TcxTreeListCustomReportLink;
end;
...
function TcxTreeListReportLinkOptionsPagination.GetReportLink
  : TcxTreeListCustomReportLink;
begin
  Result := inherited ReportLink as TcxTreeListCustomReportLink;
end;
...
function TcxTreeListReportLinkOptionsPreview.GetReportLink
  : TcxTreeListCustomReportLink;
begin
  Result := inherited ReportLink as TcxTreeListCustomReportLink;
end;
...
function TcxTreeListReportLinkOptionsRefinements.GetReportLink
  : TcxTreeListCustomReportLink;
begin
  Result := inherited ReportLink as TcxTreeListCustomReportLink;
end;
...
function TcxTreeListReportLinkOptionsSelection.GetReportLink
  : TcxTreeListCustomReportLink;
begin
  Result := inherited ReportLink as TcxTreeListCustomReportLink;
end;
...
function TcxTreeListReportLinkOptionsSize.GetReportLink
  : TcxTreeListCustomReportLink;
begin
  Result := inherited ReportLink as TcxTreeListCustomReportLink;
end;
...
function TcxTreeListReportLinkOptionsView.GetReportLink
  : TcxTreeListCustomReportLink;
begin
  Result := inherited ReportLink as TcxTreeListCustomReportLink;
end;
...
procedure TcxTreeListReportLinkStyles.GetBandHeaderParams
  (ABand: TcxTreeListBand; out AParams: TcxViewParams);
begin
  GetViewParams(vspsTreeListBandHeader, ABand, nil, AParams);
end;

procedure TcxTreeListReportLinkStyles.GetColumnFooterParams
  (ANode: TcxTreeListNode; AColumn: TcxTreeListColumn;
...
procedure TcxTreeListReportLinkStyles.GetColumnHeaderParams
...
const
  StyleIndexes: array [Boolean] of Integer = (vspsTreeListContentEven,
...
procedure TcxTreeListReportLinkStyles.GetFooterRowParams
  (out AParams: TcxViewParams);
begin
...
procedure TcxTreeListReportLinkStyles.GetSelectionParams
  (out AParams: TcxViewParams);
begin
...
procedure TcxTreeListReportLinkStyles.GetDefaultViewParams(Index: Integer;
  AData: TObject; out AParams: TcxViewParams);
const
  FixedParts = [vspsTreeListBandHeader, vspsTreeListFooter,
    vspsTreeListFooterRow, vspsTreeListHeader, vspsTreeListSelection];
begin
  inherited;
...
class function TcxTreeListReportLinkStyles.GetStyleCaption
...
function TcxTreeListReportLinkStyles.GetStyleIndexByCaption
...
class function TcxTreeListReportLinkStyleSheet.GetStylesClass
  : TcxCustomStylesClass;
begin
  Result := TcxTreeListReportLinkStyles;
end;

function TcxTreeListReportLinkStyleSheet.GetStylesValue
  : TcxTreeListReportLinkStyles;
begin
...
procedure TcxTreeListReportLinkStyleSheet.SetStylesValue
  (Value: TcxTreeListReportLinkStyles);
begin
  SetStyles(Value);
end;
...
constructor TcxTreeListAttributeHostInfoServices.Create
  (AReportLink: TcxTreeListCustomReportLink);
begin
  inherited Create;
  FReportLink := AReportLink;
  CreateHostInfos;
...
function TcxTreeListAttributeHostInfoServices.GetBandHeadersHostInfo
  : TcxTreeListAttributeHostInfo;
begin
...
function TcxTreeListAttributeHostInfoServices.GetFootersHostInfo
  : TcxTreeListAttributeHostInfo;
begin
...
function TcxTreeListAttributeHostInfoServices.GetHeadersHostInfo
  : TcxTreeListAttributeHostInfo;
begin
...
function TcxTreeListAttributeHostInfoServices.GetArePageFootersAssigned
  : Boolean;
begin
  Result := FootersHostInfo.Parent = ReportLink.ReportCells.FooterCells;
end;

function TcxTreeListAttributeHostInfoServices.GetArePageHeadersAssigned
  : Boolean;
begin
  with ReportLink.ReportCells do
    Result := (BandHeadersHostInfo.Parent = HeaderCells) or
      (HeadersHostInfo.Parent = HeaderCells);
end;

function TcxTreeListAttributeHostInfoServices.
...
function TcxTreeListAttributeHostInfoServices.
  GetCanUseFootersOnEveryPage: Boolean;
begin
  Result := not ReportLink.IsAggregated and OptionsOnEveryPage.Footers;
end;

function TcxTreeListAttributeHostInfoServices.
  GetCanUseHeadersOnEveryPage: Boolean;
begin
  Result := not ReportLink.IsAggregated and OptionsOnEveryPage.Headers and
    ((BandHeadersHostInfo = PageHeadersHostInfo) or
    not OptionsView.BandHeaders);
end;

function TcxTreeListAttributeHostInfoServices.
  GetIsInconsistentHeadersState: Boolean;
begin
  Result := OptionsOnEveryPage.Headers and OptionsView.Headers and
    OptionsView.BandHeaders and not OptionsOnEveryPage.BandHeaders;
end;

function TcxTreeListAttributeHostInfoServices.GetOptionsOnEveryPage
  : TcxTreeListReportLinkOptionsOnEveryPage;
begin
  Result := ReportLink.OptionsOnEveryPage;
end;

function TcxTreeListAttributeHostInfoServices.GetOptionsView
  : TcxTreeListReportLinkOptionsView;
begin
...
procedure TcxTreeListCustomReportLink.AddHorizontalPageBreak
  (AColumn: TcxTreeListColumn);
var
...
procedure TcxTreeListCustomReportLink.AddHorizontalPageBreak(const AColumns
  : array of TcxTreeListColumn);
var
  I: Integer;
begin
...
procedure TcxTreeListCustomReportLink.AddPageBreak(const ANodes
  : array of TcxTreeListNode);
var
  I: Integer;
begin
...
procedure TcxTreeListCustomReportLink.CustomDraw
...
begin
  ...
  with DrawInfo do
    case AttributeID of
      ...
      cxTreeListFooterID:
        DoCustomDrawFooterCell(ACanvas, Column,
          TdxReportCellString(AItem), ADone);
      cxTreeListHeaderID:
        DoCustomDrawHeaderCell(ACanvas, Column,
...
procedure TcxTreeListCustomReportLink.GetImageLists
...
function TcxTreeListCustomReportLink.GetRebuildOnPageParamsChange
...
begin
  ...
  if TreeList <> nil then
  begin
    OptionsFormatting.LookAndFeelKind := CustomTreeList_GetLookAndFeel
      (TreeList).Kind;
...
function TcxTreeListCustomReportLink.IsSupportedCustomDraw
...
function TcxTreeListCustomReportLink.GetStylesClass
  : TdxCustomReportLinkStylesClass;
begin
  Result := TcxTreeListReportLinkStyles;
end;

function TcxTreeListCustomReportLink.GetStyleSheetClass
  : TdxCustomReportLinkStyleSheetClass;
begin
  Result := TcxTreeListReportLinkStyleSheet;
end;

function TcxTreeListCustomReportLink.GetStyleSheetPrototype
...
procedure TcxTreeListCustomReportLink.DoInitializeBandCell
  (ABand: TcxTreeListBand; AnItem: TdxReportCellImage);
begin
...
procedure TcxTreeListCustomReportLink.DoInitializeFooterCell
  (AColumn: TcxTreeListColumn; ASummaryCellIndex: Integer;
...
procedure TcxTreeListCustomReportLink.DoInitializeHeaderCell
  (AColumn: TcxTreeListColumn; AnItem: TdxReportCellImage);
begin
...
procedure TcxTreeListCustomReportLink.DoInitializeIndentCell
  (ANode: TcxTreeListNode; AnIndex: Integer; AnItem: TAbstractdxReportCellData);
begin
...
procedure TcxTreeListCustomReportLink.AddHorizontalHardDelimiter
  (ADelimiter: Integer);
begin
  DelimitersHardHorz.Add(Pointer(ADelimiter));
end;

procedure TcxTreeListCustomReportLink.AddVerticalHardDelimiter
...
function TcxTreeListCustomReportLink.CreateBuilder
  : TcxTreeListReportLinkBuilder;
begin
  Result := GetBuilderClass.Create(Self);
end;

class function TcxTreeListCustomReportLink.GetBuilderClass
  : TcxTreeListReportLinkBuilderClass;
begin
  Result := TcxTreeListReportLinkBuilder;
end;

function TcxTreeListCustomReportLink.ExtractIndentIndex(AData: Integer)
  : Integer;
begin
  Result := (AData and NodeIndentMask) shr NodeIndentOffset;
end;

function TcxTreeListCustomReportLink.GetItemCustomDrawInfo
  (AnItem: TdxReportVisualItem; out ADrawInfo: TcxTreeListCellCustomDrawInfo)
  : TcxTreeListAttributeID;

  function IsAttributedRow(AData: DWORD;
    AAttributeClass: TcxTreeListAttributeClass): Boolean;
  begin
    try
...
function TcxTreeListCustomReportLink.IsCustomDrawn(AnAttributeID
  : TcxTreeListAttributeID): Boolean;
begin
  Result := False;
...
function TcxTreeListCustomReportLink.GetActiveStyles
  : TcxTreeListReportLinkStyles;
begin
  Result := inherited ActiveStyles as TcxTreeListReportLinkStyles;
end;

function TcxTreeListCustomReportLink.GetDesignWindow
  : TdxfmTreeListReportLinkDesignWindow;
begin
  Result := inherited DesignWindow as TdxfmTreeListReportLinkDesignWindow;
end;

function TcxTreeListCustomReportLink.GetReportRow(Index: Integer)
  : TdxReportCell;
begin
  Result := FReportRows[Index];
end;

function TcxTreeListCustomReportLink.GetReportRowByNode(Node: TcxTreeListNode)
  : TdxReportCell;
var
  I: Integer;
begin
  if (Node <> nil) and not Node.IsFirstVisible then
    ...
    begin
      Result := ReportRows[I];
      if Result.Data = TdxNativeInt(Node) then
        Exit;
    end;
  Result := nil;
end;
...
function TcxTreeListCustomReportLink.GetReportCellDataByColumn
  ...
  function FindColumn(AReportCell: TdxReportCell;
    var AData: TAbstractdxReportCellData): Boolean;
  var
    I: Integer;
  begin
...
function TcxTreeListCustomReportLink.GetOptionsExpanding
  : TcxTreeListReportLinkOptionsExpanding;
begin
  Result := inherited OptionsExpanding as TcxTreeListReportLinkOptionsExpanding;
end;

function TcxTreeListCustomReportLink.GetOptionsFormatting
  : TcxTreeListReportLinkOptionsFormatting;
begin
...
function TcxTreeListCustomReportLink.GetOptionsOnEveryPage
  : TcxTreeListReportLinkOptionsOnEveryPage;
begin
  Result := inherited OptionsOnEveryPage as
    TcxTreeListReportLinkOptionsOnEveryPage;
end;

function TcxTreeListCustomReportLink.GetOptionsPagination
  : TcxTreeListReportLinkOptionsPagination;
begin
...
function TcxTreeListCustomReportLink.GetOptionsPreview
  : TcxTreeListReportLinkOptionsPreview;
begin
  Result := inherited OptionsPreview as TcxTreeListReportLinkOptionsPreview;
end;

function TcxTreeListCustomReportLink.GetOptionsRefinements
  : TcxTreeListReportLinkOptionsRefinements;
begin
...
function TcxTreeListCustomReportLink.GetOptionsSelection
  : TcxTreeListReportLinkOptionsSelection;
begin
  Result := inherited OptionsSelection as TcxTreeListReportLinkOptionsSelection;
end;

function TcxTreeListCustomReportLink.GetOptionsSize
  : TcxTreeListReportLinkOptionsSize;
begin
  Result := inherited OptionsSize as TcxTreeListReportLinkOptionsSize;
end;

function TcxTreeListCustomReportLink.GetOptionsView
  : TcxTreeListReportLinkOptionsView;
begin
...
procedure TcxTreeListCustomReportLink.SetOnCustomDrawBandCell
  (Value: TcxTreeListReportLinkCustomDrawBandCellEvent);
begin
...
procedure TcxTreeListCustomReportLink.SetOnCustomDrawCell
  (Value: TcxTreeListReportLinkCustomDrawCellEvent);
begin
...
procedure TcxTreeListCustomReportLink.SetOnCustomDrawFooterCell
  (Value: TcxTreeListReportLinkCustomDrawFooterCellEvent);
begin
...
procedure TcxTreeListCustomReportLink.SetOnCustomDrawHeaderCell
  (Value: TcxTreeListReportLinkCustomDrawHeaderCellEvent);
begin
...
procedure TcxTreeListCustomReportLink.SetOnCustomDrawIndentCell
  (Value: TcxTreeListReportLinkCustomDrawIndentCellEvent);
begin
...
procedure TcxTreeListCustomReportLink.SetOptionsExpanding
  (Value: TcxTreeListReportLinkOptionsExpanding);
begin
  inherited OptionsExpanding := Value;
end;

procedure TcxTreeListCustomReportLink.SetOptionsFormatting
  (Value: TcxTreeListReportLinkOptionsFormatting);
begin
  inherited OptionsFormatting := Value;
end;

procedure TcxTreeListCustomReportLink.SetOptionsOnEveryPage
  (Value: TcxTreeListReportLinkOptionsOnEveryPage);
begin
  inherited OptionsOnEveryPage := Value;
end;

procedure TcxTreeListCustomReportLink.SetOptionsPagination
  (Value: TcxTreeListReportLinkOptionsPagination);
begin
  inherited OptionsPagination := Value;
end;

procedure TcxTreeListCustomReportLink.SetOptionsPreview
  (Value: TcxTreeListReportLinkOptionsPreview);
begin
  inherited OptionsPreview := Value;
end;

procedure TcxTreeListCustomReportLink.SetOptionsRefinements
  (Value: TcxTreeListReportLinkOptionsRefinements);
begin
  inherited OptionsRefinements := Value;
end;

procedure TcxTreeListCustomReportLink.SetOptionsSelection
  (Value: TcxTreeListReportLinkOptionsSelection);
begin
  inherited OptionsSelection := Value;
end;

procedure TcxTreeListCustomReportLink.SetOptionsSize
  (Value: TcxTreeListReportLinkOptionsSize);
begin
  inherited OptionsSize := Value;
end;

procedure TcxTreeListCustomReportLink.SetOptionsView
  (Value: TcxTreeListReportLinkOptionsView);
begin
  inherited OptionsView := Value;
end;

procedure TcxTreeListCustomReportLink.SetStyles
  (Value: TcxTreeListReportLinkStyles);
begin
...
begin
  ...
  chbxExplicitlyExpandNodes.Caption :=
    cxGetResourceString(@sdxExplicitlyExpandNodes);
...
const
  TransparentsMap: array [Boolean] of TcxImageTransparency = (gtOpaque,
    gtTransparent);
  TreeLineStylesMap: array [Boolean] of TcxTreeListTreeLineStyle =
    (tllsNone, tllsDot);
begin
  ...
  dxAssignFont(PreviewTreeList.Font, ReportLink.Font, ScaleFactor,
  ...
  PreviewTreeList.OptionsView.TreeLineStyle := TreeLineStylesMap
    [ReportLink.OptionsView.TreeLines];
...
procedure TdxfmTreeListReportLinkDesignWindow.SetDesignerTabIndex
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
procedure TdxfmTreeListReportLinkDesignWindow.DoFormActivated
  (AnActive: Boolean);
begin
  inherited;
  ...
  begin
    ...
    try
      ...
      try
        ...
        try
          Clear;
          AddObject(cxGetResourceString(@sdxBandBackgroundStyle),
...
procedure TdxfmTreeListReportLinkDesignWindow.DoStyleChanged(const ACaption
  : string; AStyle: TcxStyle);
begin
  inherited;
  UpdatePreviewTreeListStyles(ACaption, AStyle);
end;

procedure TdxfmTreeListReportLinkDesignWindow.DoStylesChanged
...
procedure TdxfmTreeListReportLinkDesignWindow.GetSelectedStyleNames
  (AStrings: TStrings);
var
  I: Integer;
begin
...
procedure TdxfmTreeListReportLinkDesignWindow.GetStyleNames
  (out AStrings: TStrings);
begin
  AStrings := lbxStyles.Items;
end;

procedure TdxfmTreeListReportLinkDesignWindow.GetStyleSheetNames
  (out AStrings: TStrings);
begin
...
function TdxfmTreeListReportLinkDesignWindow.
...
begin
  ...
  try
    ...
    begin
      ...
      if (Style <> nil) and (Style.Bitmap <> nil) and not Style.Bitmap.Empty
      then
        Exit;
    end;
  finally
...
function TdxfmTreeListReportLinkDesignWindow.GetReportLink
  : TcxTreeListCustomReportLink;
begin
  Result := inherited ReportLink as TcxTreeListCustomReportLink;
end;

procedure TdxfmTreeListReportLinkDesignWindow.PreviewMaxLineCountChanged
  (Sender: TObject);
begin
...
procedure TdxfmTreeListReportLinkDesignWindow.SeparatorColorChanged
  (Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
  ReportLink.OptionsFormatting.NodeSeparatorColor := TcxColorComboBox(Sender)
    .ColorValue;
  Modified := True;
end;

procedure TdxfmTreeListReportLinkDesignWindow.SeparatorThicknessChanged
  (Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
  ReportLink.OptionsFormatting.NodeSeparatorThickness :=
    TcxSpinEdit(Sender).Value;
  Modified := True;
end;
...
procedure TdxfmTreeListReportLinkDesignWindow.CustomDrawBorders
...
begin
  ...
  begin
    ...
    if GridLinesColor = clDefault then
      GridLinesColor := CustomTreeList_GetLookAndFeelPainter(PreviewTreeList)
        .DefaultGridLineColor;
  end;
  ACanvas.DrawComplexFrame(R, GridLinesColor, GridLinesColor,
    [bLeft, bBottom, bRight]);
end;
...
begin
  ...
  Params := PreviewTreeList.Styles.GetContentParams(AViewInfo.Node,
    AViewInfo.Column);
  ...
  begin
    ...
    cxBkgndDrawPicture(Params.Bitmap, ACanvas.Canvas, R, ppmTile, 1, 1,
      -R.Left, -R.Top);
  ...
  with cxLookAndFeelPaintersManager.GetPainter
    (StylesMap[ReportLink.OptionsRefinements.FlatCheckMarks]) do
    DrawScaledCheckButton(ACanvas, R, cxbsDefault, CheckValue = cbsChecked,
      ScaleFactor);
  ACanvas.Brush.Color := PrevColor;
end;

procedure TdxfmTreeListReportLinkDesignWindow.CustomDrawColCarSpeedCount
  (ACanvas: TcxCanvas; AViewInfo: TcxTreeListEditCellViewInfo);
  ...
  begin
    ...
    try
      ...
      try
        ...
        AViewData.Calculate(ACanvas, cxRectInflate(AViewInfo.BoundsRect, -2,
          -2), Point(0, 0), cxmbNone, [], ATrackBarViewInfo, False);
...
begin
  if ReportLink.OptionsRefinements.DisplayTrackBarsAsText then
    CustomDrawTextRect(ACanvas, cxRectInflate(AViewInfo.BoundsRect, -2, -2),
      AViewInfo.DisplayValue, taLeftJustify, vaCenter, AViewInfo.ViewParams)
  else
    DrawTrackBar(ACanvas);
end;

procedure TdxfmTreeListReportLinkDesignWindow.CustomDrawFooter
  (ACanvas: TcxCanvas; R: TRect; AViewInfo: TcxTreeListFooterCellViewInfo);
begin
  if AViewInfo.Hidden then
    Exit;
  case ReportLink.OptionsFormatting.LookAndFeelKind of
    lfStandard, lfFlat:
      ACanvas.DrawComplexFrame(R, AViewInfo.ViewParams.TextColor,
        clBtnHighlight);
    lfUltraFlat:
...
procedure TdxfmTreeListReportLinkDesignWindow.CustomDrawHeader
  (ACanvas: TcxCanvas; R: TRect; AViewInfo: TcxTreeListHeaderCellViewInfo);
const
...
procedure TdxfmTreeListReportLinkDesignWindow.CustomDrawTextRect
  (ACanvas: TcxCanvas; R: TRect; const AText: string;
  AnAlignmentHorz: TAlignment; AnAlignmentVert: TcxAlignmentVert;
...
begin
  if AParams.Bitmap = nil then
    ...
    cxBkgndDrawPicture(AParams.Bitmap, ACanvas.Canvas, R, ppmTile, 1, 1,
      -R.Left - 0, -R.Top - 0);
  ...
  ACanvas.DrawText(AText, R, AlignmentHorzMap[AnAlignmentHorz] or
    AlignmentVertMap[AnAlignmentVert] or cxSingleLine);
...
begin
  with AViewInfo.Column do
    if Properties <> nil then
      Result := EditAlignmentVertMap
        [cxEditProperties_GetAlignment(Properties).Vert]
    else
      Result := vaCenter;
end;
...
procedure TdxfmTreeListReportLinkDesignWindow.InitializePreviewTreeList;
  ...
  const
    ColumnProperties: array [0 .. 5] of string = ('TcxTextEditProperties',
      'TcxImageProperties', 'TcxTextEditProperties', 'TcxTextEditProperties',
      'TcxCheckBoxProperties', 'TcxTrackBarProperties');
  var
    I: Integer;
  begin
...
begin
  ...
  PreviewTreeList.Bands[0].Caption.Text :=
    cxGetResourceString(@sdxManufacturerBandCaption);
  PreviewTreeList.Bands[1].Caption.Text :=
...
begin
  ...
  else if ReportLink.TreeList <> nil then
...
procedure TdxfmTreeListReportLinkDesignWindow.LoadDataIntoPreviewTreeList;
  ...
  begin
    case AnIndex of
      0:
        Result := cxGetResourceString(@sdxCarManufacturerName5);
      1:
  ...
  begin
    case AnIndex of
      0:
        Result := cxGetResourceString(@sdxCarManufacturerCountry5);
      1:
  ...
  begin
    case AnIndex of
      0:
        Result := cxGetResourceString(@sdxCarModel5);
      1:
...
const
  ...
  AreCarsSUV: array [0 .. RecordCount - 1] of string = ('False', 'True',
    'True', 'True');
  AreCarSpeedCount: array [0 .. RecordCount - 1] of string = ('6', '5',
    '5', '6');
var
  I: Integer;
begin
...
procedure TdxfmTreeListReportLinkDesignWindow.RestoreSelectedStyles
  (AList: TList);
var
  I: Integer;
begin
...
procedure TdxfmTreeListReportLinkDesignWindow.UpdatePreviewTreeListStyles
  (const ACaption: string; AStyle: TcxStyle);
begin
  with PreviewTreeList.Styles do
  begin
    if dxPSUtl.dxSameText(ACaption, cxGetResourceString(@sdxBandBackgroundStyle))
    then
      BandBackground := AStyle
    else if dxPSUtl.dxSameText(ACaption,
      cxGetResourceString(@sdxBandHeaderStyle)) then
      BandHeader := AStyle
    ...
    then
      ColumnHeader := AStyle
    else if dxPSUtl.dxSameText(ACaption, cxGetResourceString(@sdxFooterRowStyle))
    then
      Footer := AStyle
    else if dxPSUtl.dxSameText(ACaption, cxGetResourceString(@sdxPreviewStyle))
    then
      Preview := AStyle
    else if dxPSUtl.dxSameText(ACaption, cxGetResourceString(@sdxSelectionStyle))
    then
      Selection := AStyle
  end;
end;
...
procedure TdxfmTreeListReportLinkDesignWindow.SetOptionsExpandingByIndex
...
begin
  ...
  with ReportLink.OptionsExpanding do
    case Index of
      ...
      1:
        ExplicitlyExpandNodes := Value;
    end;
  Modified := True;
end;

procedure TdxfmTreeListReportLinkDesignWindow.SetOptionsFormattingByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TdxfmTreeListReportLinkDesignWindow.SetOptionsOnEveryPageByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TdxfmTreeListReportLinkDesignWindow.SetOptionsRefinementsByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TdxfmTreeListReportLinkDesignWindow.SetOptionsSelectionByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TdxfmTreeListReportLinkDesignWindow.SetOptionsSizeByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TdxfmTreeListReportLinkDesignWindow.SetOptionsViewByIndex
  (Index: Integer; Value: Boolean);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TdxfmTreeListReportLinkDesignWindow.LookAndFeelChange
  (Sender: TObject);
begin
  if LockControlsUpdate then
    Exit;
...
procedure TdxfmTreeListReportLinkDesignWindow.cbxStyleSheetsClick
  (Sender: TObject);
begin
  ActiveStyleSheet := TcxCustomStyleSheet(TcxComboBox(Sender).ItemObject);
end;

procedure TdxfmTreeListReportLinkDesignWindow.btnStyleSheetNewClick
  (Sender: TObject);
begin
  PerformStyleSheetNew;
end;

procedure TdxfmTreeListReportLinkDesignWindow.btnStyleSheetCopyClick
  (Sender: TObject);
begin
  PerformStyleSheetCopy;
end;

procedure TdxfmTreeListReportLinkDesignWindow.btnStyleSheetDeleteClick
  (Sender: TObject);
begin
  PerformStyleSheetDelete;
end;

procedure TdxfmTreeListReportLinkDesignWindow.btnStyleSheetRenameClick
  (Sender: TObject);
begin
  PerformStyleSheetRename;
end;

procedure TdxfmTreeListReportLinkDesignWindow.miStylesSelectAllClick
  (Sender: TObject);
begin
  lbxStyles.SelectAll;
  UpdateControlsState;
...
procedure TdxfmTreeListReportLinkDesignWindow.StylesSaveAsClick
  (Sender: TObject);
begin
  PerformStylesSaveAsStyleSheet;
end;

procedure TdxfmTreeListReportLinkDesignWindow.cbxStyleSheetsKeyDown
...
procedure TdxfmTreeListReportLinkDesignWindow.
  PreviewTreeListCustomDrawBandHeaderCell(Sender: TcxCustomTreeList;
  ACanvas: TcxCanvas; AViewInfo: TcxTreeListHeaderCellViewInfo;
  var ADone: Boolean);
var
  R: TRect;
...
begin
  if AViewInfo.Column = colManufacturerLogo then
    ...
    begin
      CustomDrawTextRect(ACanvas, AViewInfo.BoundsRect,
        ReportLink.OptionsRefinements.GraphicsText,
        ExtractAlignmentHorz(AViewInfo), ExtractAlignmentVert(AViewInfo),
        AViewInfo.ViewParams);
...
procedure TdxfmTreeListReportLinkDesignWindow.
  PreviewTreeListCustomDrawFooterCell(Sender: TcxCustomTreeList;
  ACanvas: TcxCanvas; AViewInfo: TcxTreeListFooterCellViewInfo;
  var ADone: Boolean);
begin
  CustomDrawFooter(ACanvas, AViewInfo.BoundsRect,
    TcxTreeListFooterCellViewInfo(AViewInfo));
  ADone := True;
end;

procedure TdxfmTreeListReportLinkDesignWindow.
  PreviewTreeListCustomDrawHeaderCell(Sender: TcxCustomTreeList;
  ACanvas: TcxCanvas; AViewInfo: TcxTreeListHeaderCellViewInfo;
  var ADone: Boolean);
var
  R: TRect;
...
dxPSRegisterReportLink(TcxTreeListReportLink, TcxTreeList,
  TdxfmTreeListReportLinkDesignWindow);
dxPSRegisterReportLink(TcxDBTreeListReportLink, TcxDBTreeList,
  TdxfmTreeListReportLinkDesignWindow);
dxPSRegisterReportLink(TcxVirtualTreeListReportLink, TcxVirtualTreeList,
  TdxfmTreeListReportLinkDesignWindow);

finalization

dxPSUnregisterReportLink(TcxVirtualTreeListReportLink, TcxVirtualTreeList,
  TdxfmTreeListReportLinkDesignWindow);
dxPSUnregisterReportLink(TcxDBTreeListReportLink, TcxDBTreeList,
  TdxfmTreeListReportLinkDesignWindow);
dxPSUnregisterReportLink(TcxTreeListReportLink, TcxTreeList,
  TdxfmTreeListReportLinkDesignWindow);
