...
type
  ...
  TdxWizardControlViewStyleWizard97Painter = class
  ...
  TdxWizardControlViewStyleWizard97HeaderViewInfo = class
  ...
  TdxWizardControlViewStyleWizard97CommandAreaViewInfo = class
  ...
  protected
    ...
    //
    property BackButtonViewInfo: TdxWizardControlButtonViewInfo
  ...
  TdxWizardControlViewStyleWizard97WatermarkViewInfo = class
...
const
  ...
  dxWizardViewStyleWizard97OffsetFromBorders: TRect = (Left: 11; Top: 11;
    Right: 11; Bottom: 11);
...
begin
  inherited Calculate;
  FPageArea := cxRectContent(PageArea,
    ScaleFactor.Apply(dxWizardViewStyleWizard97OffsetFromBorders));
end;

function TdxWizardControlViewStyleWizard97ViewInfo.CreateCommandAreaViewInfo
  : TdxWizardControlCustomCommandAreaViewInfo;
begin
  Result := TdxWizardControlViewStyleWizard97CommandAreaViewInfo.Create
    (WizardControl);
end;

function TdxWizardControlViewStyleWizard97ViewInfo.CreateHeaderViewInfo
  : TdxWizardControlCustomHeaderViewInfo;
begin
  Result := TdxWizardControlViewStyleWizard97HeaderViewInfo.Create
    (WizardControl);
end;

function TdxWizardControlViewStyleWizard97ViewInfo.CreatePainter
  : TdxWizardControlCustomPainter;
begin
  Result := TdxWizardControlViewStyleWizard97Painter.Create(WizardControl);
end;

function TdxWizardControlViewStyleWizard97ViewInfo.CreateWatermarkViewInfo
  : TdxWizardControlWatermarkViewInfo;
begin
  Result := TdxWizardControlViewStyleWizard97WatermarkViewInfo.Create
    (WizardControl);
end;

function TdxWizardControlViewStyleWizard97ViewInfo.GetDefaultResizeAnimation
  : TdxWizardControlResizeAnimation;
begin
  Result := wcraDisabled;
end;

function TdxWizardControlViewStyleWizard97ViewInfo.GetDefaultTransitionEffect
  : TdxWizardControlTransitionEffect;
begin
  Result := wcteNone;
end;

procedure TdxWizardControlViewStyleWizard97ViewInfo.GetTabOrderList
...
procedure TdxWizardControlViewStyleWizard97Painter.DrawHeaderBackground
...
begin
  ACanvas.FillRect(ABounds,
    ...
    clWindow));
  DrawSeparator(ACanvas, cxRectSetBottom(ABounds, ABounds.Bottom,
    SeparatorSize));
end;
...
constructor TdxWizardControlViewStyleWizard97CommandAreaViewInfo.Create
  (AWizardControl: TdxCustomWizardControl);
begin
  inherited Create(AWizardControl);
  FBackButtonViewInfo := AddButtonCell(Buttons.Back,
    TdxWizardControlButtonViewInfo);
end;

procedure TdxWizardControlViewStyleWizard97CommandAreaViewInfo.CalculateButtons
  (var ABounds: TRect);
begin
...
procedure TdxWizardControlViewStyleWizard97CommandAreaViewInfo.
...
begin
  ...
  if BackButtonViewInfo <> nil then
    TdxWizardControlCellViewInfoAccess(BackButtonViewInfo)
      .DoRightToLeftConversion;
end;

function TdxWizardControlViewStyleWizard97CommandAreaViewInfo.
...
begin
  Result := ScaleFactor.Apply
    (dxWizardViewStyleWizard97IndentBetweenElementsInGroup);
end;
...
begin
  Result := inherited MeasureWidth + MeasureButtonWidth(BackButtonViewInfo,
    IndentBetweenElementsInGroup);
end;

{ TdxWizardControlViewStyleWizard97WatermarkViewInfo }

function TdxWizardControlViewStyleWizard97WatermarkViewInfo.
...
function TdxWizardControlViewStyleWizard97HeaderViewInfo.
  GetContentMargins: TRect;
begin
  Result := ScaleFactor.Apply(dxWizardViewStyleWizard97OffsetFromBorders);
