...
function TdxPlainTextDocumentExporter.FormatEquals(const AValue
...
function TdxPlainTextDocumentExporter.SaveDocument(const ADocumentModel
...
begin
  ...
  AModel.InternalAPI.SaveDocumentPlainTextContent(AStream,
    TdxPlainTextDocumentExporterOptions(AOptions));
  Result := True;
end;
