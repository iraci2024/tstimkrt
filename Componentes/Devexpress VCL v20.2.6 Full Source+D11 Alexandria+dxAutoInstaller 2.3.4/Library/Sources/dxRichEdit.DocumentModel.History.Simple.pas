...
type
  ...
  protected
    procedure ApplyFormattingToNewRun(ARuns: TdxTextRunCollection;
      ARun: TdxTextRunBase); virtual;
  ...
  private
    ...
    procedure AfterInsertRun(ADocumentModel: TdxSimpleDocumentModel;
      ARun: TdxTextRunBase; ARunIndex: TdxRunIndex);
  protected
    procedure UndoCore; override;
    procedure RedoCore; override;
    function CreateTextRun(AParagraph: TdxParagraphBase)
      : TdxTextRunBase; virtual;
  public
    constructor Create(APieceTable: TdxCustomPieceTable); override;
  ...
  protected
    ...
    property FirstSelection: TdxRichEditSelectionHistoryItem
      read GetFirstSelection;
    property LastSelection: TdxRichEditSelectionHistoryItem
      read GetLastSelection;
  public
  ...
  public
    constructor Create(ADocumentModel: TdxCustomDocumentModel;
      AParent: TdxRichEditCompositeHistoryItem;
      AStartTransactionLevel: Integer); reintroduce;
  ...
  public
    ...
    procedure AddRangeTextAppendedHistoryItem
      (AItem: TdxTextRunAppendTextHistoryItem); virtual;
  ...
  protected
    ...
    procedure RedoCore; override;
    procedure AfterInsertRun(ADocumentModel: TdxSimpleDocumentModel;
      ARun: TdxTextRunBase; ARunIndex: TdxRunIndex); virtual;
  public
    function CreateRun(AParagraph: TdxParagraphBase): TdxTextRunBase;
      virtual; abstract;
  end;
  ...
  private
    ...
    class procedure ChangeRangesParagraph(ARunIndex: TdxRunIndex;
      ARuns: TdxTextRunCollection;
      AOldParagraph, ANewParagraph: TdxSimpleParagraph); static;
  protected
    procedure UndoCore; override;
    procedure RedoCore; override;
  public
    ...
    property ParagraphMarkRunIndex: TdxRunIndex read FParagraphMarkRunIndex
      write FParagraphMarkRunIndex;
    property LogPosition: TdxDocumentLogPosition read FLogPosition
      write FLogPosition;
  end;
  ...
  TdxInlineCustomObjectRunInsertedHistoryItem = class
    (TdxTextRunInsertedBaseHistoryItem)
  private
  ...
  TdxInlinePictureRunInsertedHistoryItem = class
    (TdxTextRunInsertedBaseHistoryItem)
  private
  ...
  protected
    function CreateInlinePictureRun(AParagraph: TdxSimpleParagraph;
      AImage: TdxOfficeImageReference): TdxInlinePictureRun; virtual;
    procedure UndoCore; override;
    procedure RedoCore; override;
    procedure AfterInsertRun(ADocumentModel: TdxSimpleDocumentModel;
      ARun: TdxTextRunBase; ARunIndex: TdxRunIndex); virtual;
  ...
  private
    FRunIndex: TdxRunIndex;
  protected
    function GetProperties(ARun: TdxRunBase): TdxIndexBasedObject;
      virtual; abstract;
  public
    constructor Create(const APieceTable: TdxCustomPieceTable;
      ARunIndex: TdxRunIndex); reintroduce;
  ...
  TdxRunInlinePicturePropertiesChangedHistoryItem = class
    (TdxRunPropertiesChangedHistoryItemBase)
  protected
    function GetProperties(ATextRunBase: TdxRunBase)
      : TdxIndexBasedObject; override;
  end;

  { TdxRunCharacterPropertiesChangedHistoryItem }

  TdxRunCharacterPropertiesChangedHistoryItem = class
    (TdxRunPropertiesChangedHistoryItemBase)
  protected
  ...
  TdxFieldCodeStartRunInsertedHistoryItem = class
    (TdxMarkRunInsertedHistoryItemBase)
  public
    function CreateRun(AParagraph: TdxParagraphBase): TdxTextRunBase; override;
  end;
  ...
  TdxFieldResultEndRunInsertedHistoryItem = class
    (TdxMarkRunInsertedHistoryItemBase)
  public
    function CreateRun(AParagraph: TdxParagraphBase): TdxTextRunBase; override;
  end;
  ...
  TdxFieldCodeEndRunInsertedHistoryItem = class
    (TdxMarkRunInsertedHistoryItemBase)
  public
    function CreateRun(AParagraph: TdxParagraphBase): TdxTextRunBase; override;
  end;
  ...
  protected
    procedure AfterInsertRun(ADocumentModel: TdxSimpleDocumentModel;
      ARun: TdxTextRunBase; ARunIndex: TdxRunIndex); override;
  public
    function CreateRun(AParagraph: TdxParagraphBase): TdxTextRunBase; override;
  end;
  ...
  public
    ...
    property DeletedRunCount: Integer read FDeletedRunCount
      write FDeletedRunCount;
  end;
  ...
  public
    ...
    property DeletedParagraphsCount: Integer read FDeletedParagraphsCount
      write FDeletedParagraphsCount;
    property DocumentModel: TdxSimpleDocumentModel read GetDocumentModel;
  end;
  ...
  public
    ...
    property StartParagraph: TdxSimpleParagraph read FStartParagraph
      write FStartParagraph;
    property EndParagraph: TdxSimpleParagraph read FEndParagraph
      write FEndParagraph;
    property UseFirstParagraphStyle: Boolean read FUseFirstParagraphStyle
      write FUseFirstParagraphStyle;
  end;
...
constructor TdxParagraphBaseHistoryItem.Create(APieceTable
  : TdxCustomPieceTable);
begin
...
constructor TdxTextRunInsertedBaseHistoryItem.Create
...
procedure TdxTextRunInsertedBaseHistoryItem.ApplyFormattingToNewRun
  (ARuns: TdxTextRunCollection; ARun: TdxTextRunBase);
var
...
function TdxTextRunInsertedBaseHistoryItem.CalculateFormattingRunIndex
  (ARuns: TdxTextRunCollection): TdxRunIndex;
var
...
constructor TdxTextRunInsertedHistoryItem.Create(APieceTable
  : TdxCustomPieceTable);
begin
  inherited Create(APieceTable);
  FNewLength := -1;
...
procedure TdxTextRunInsertedHistoryItem.AfterInsertRun(ADocumentModel
  : TdxSimpleDocumentModel; ARun: TdxTextRunBase; ARunIndex: TdxRunIndex);
var
...
function TdxTextRunInsertedHistoryItem.CreateTextRun
...
begin
  ...
  TdxDocumentModelStructureChangedNotifier.NotifyRunInserted(PieceTable,
    PieceTable, ParagraphIndex, RunIndex, NewLength, FNotificationId);
...
begin
  ...
  TdxDocumentModelStructureChangedNotifier.NotifyRunRemoved(PieceTable,
    PieceTable, ParagraphIndex, RunIndex, NewLength, FNotificationId);
  PieceTable.ApplyChangesCore
    ([TdxDocumentModelChangeAction.RaiseContentChanged], dxRunIndexDontCare,
    dxRunIndexDontCare);
...
begin
  ...
  FHistoryItem := TdxTextRunInsertedHistoryItem
    (ALastInsertedRunInfo.HistoryItem);
  ALastInsertedRunInfo.LogPosition := LogPosition + TextLength;
  ALastInsertedRunInfo.Run.Length := ALastInsertedRunInfo.Run.Length +
    TextLength;
  TdxTextRunInsertedHistoryItem(ALastInsertedRunInfo.HistoryItem).NewLength :=
    TdxTextRunInsertedHistoryItem(ALastInsertedRunInfo.HistoryItem).NewLength +
    TextLength;
  DocumentModel.History.RaiseOperationCompleted;
  TdxDocumentModelStructureChangedNotifier.NotifyRunMerged(PieceTable,
    PieceTable, ParagraphIndex, RunIndex, TextLength);
end;
...
begin
  ...
  TdxTextRunInsertedHistoryItem(ALastInsertedRunInfo.HistoryItem).NewLength :=
    ...
    TextLength;
  DocumentModel.History.RaiseOperationCompleted;
  TdxDocumentModelStructureChangedNotifier.NotifyRunUnmerged(PieceTable,
    PieceTable, ParagraphIndex, RunIndex, -TextLength);
end;
...
constructor TdxSyntaxHighlightHistoryItem.Create(ADocumentModel
  : TdxCustomDocumentModel; AParent: TdxRichEditCompositeHistoryItem;
  AStartTransactionLevel: Integer);
begin
...
constructor TdxRichEditCompositeHistoryItem.Create(ADocumentModel
...
function TdxRichEditCompositeHistoryItem.GetDocumentModel
  : TdxSimpleDocumentModel;
begin
  Result := TdxSimpleDocumentModel(inherited DocumentModel);
end;

function TdxRichEditCompositeHistoryItem.GetFirstSelection
  : TdxRichEditSelectionHistoryItem;
begin
  if FFirstSelection = nil then
    FFirstSelection := TdxRichEditSelectionHistoryItem.Create
      (DocumentModel.GetActivePieceTableCore);
  Result := FFirstSelection;
end;

function TdxRichEditCompositeHistoryItem.GetLastSelection
  : TdxRichEditSelectionHistoryItem;
begin
  if FLastSelection = nil then
    FLastSelection := TdxRichEditSelectionHistoryItem.Create
      (DocumentModel.GetActivePieceTableCore);
...
begin
  ...
  begin
    if Transaction is TdxRichEditCompositeHistoryItem then
      Assert(TdxRichEditCompositeHistoryItem(Transaction)
        .SyntaxHighlightTransaction = nil);
  end;
  Result := inherited Add(AItem);
end;

procedure TdxRichEditDocumentHistory.AddRangeTextAppendedHistoryItem
...
function TdxRichEditDocumentHistory.CommitAsSingleItemCore
  (ASingleItem: TdxHistoryItem): TdxHistoryItem;
var
...
function TdxRichEditDocumentHistory.CreateCompositeHistoryItem
...
procedure TdxMarkRunInsertedHistoryItemBase.AfterInsertRun(ADocumentModel
  : TdxSimpleDocumentModel; ARun: TdxTextRunBase; ARunIndex: TdxRunIndex);
begin
end;
...
begin
  ...
  if FNotificationId = TdxNotificationIdGenerator.EmptyId then
    FNotificationId := DocumentModel.History.GetNotificationId;
  TdxDocumentModelStructureChangedNotifier.NotifyRunInserted(PieceTable,
    PieceTable, ParagraphIndex, RunIndex, 1, FNotificationId);
...
function TdxParagraphRunInsertedHistoryItem.CreateRun
  (AParagraph: TdxParagraphBase): TdxTextRunBase;
begin
...
constructor TdxParagraphInsertedBaseHistoryItem.Create
  (APieceTable: TdxCustomPieceTable);
begin
  inherited Create(APieceTable);
  FLogPosition := -1;
...
begin
  ...
  Assert((ASectionIndex >= 0) or ((ASectionIndex = dxRunIndexDontCare) and
    (PieceTable.ContentType.IsNote or PieceTable.ContentType.IsTextBox or
    PieceTable.ContentType.IsComment)));
  ...
  ChangeRangesParagraph(AParagraphLastRunIndex, PieceTable.Runs, AParagraph,
    FNewParagraph);
  if FNotificationId = TdxNotificationIdGenerator.EmptyId then
    FNotificationId := DocumentModel.History.GetNotificationId;
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphInserted(PieceTable,
    PieceTable, ASectionIndex, ParagraphIndex, ParagraphMarkRunIndex + 1, Cell,
    False, ParagraphIndex, FNotificationId);
...
begin
  ...
  ASectionIndex := PieceTable.LookupSectionIndexByParagraphIndex
    (ParagraphIndex);
  Assert((ASectionIndex >= 0) or ((ASectionIndex = dxSectionIndexDontCare) and
    (PieceTable.ContentType.IsNote or PieceTable.ContentType.IsTextBox or
    PieceTable.ContentType.IsComment)));
  ...
  ChangeRangesParagraph(FNewParagraph.LastRunIndex, PieceTable.Runs,
    FNewParagraph, AParagraph);
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphRemoved(PieceTable,
    PieceTable, ASectionIndex, ParagraphIndex, ARunIndex, FNotificationId);
  PieceTable.Paragraphs.RemoveAt(ParagraphIndex);
end;

class procedure TdxParagraphInsertedBaseHistoryItem.ChangeRangesParagraph
  (ARunIndex: TdxRunIndex; ARuns: TdxTextRunCollection;
...
begin
  ARuns := PieceTable.Runs;
  ANewRange := TdxInlineCustomObjectRun.Create(ARuns[RunIndex].Paragraph,
    FCustomObject);
...
procedure TdxInlinePictureRunInsertedHistoryItem.AfterInsertRun
  (ADocumentModel: TdxSimpleDocumentModel; ARun: TdxTextRunBase;
  ARunIndex: TdxRunIndex);
var
...
function TdxInlinePictureRunInsertedHistoryItem.CreateInlinePictureRun
  (AParagraph: TdxSimpleParagraph; AImage: TdxOfficeImageReference)
  : TdxInlinePictureRun;
begin
...
procedure TdxInlinePictureRunInsertedHistoryItem.SetImage
  (const Value: TdxOfficeImageReference);
begin
  FImage.Free;
...
constructor TdxRunPropertiesChangedHistoryItemBase.Create(const APieceTable
  : TdxCustomPieceTable; ARunIndex: TdxRunIndex);
begin
  inherited Create(APieceTable);
  Assert(ARunIndex >= 0);
  FRunIndex := ARunIndex;
...
function TdxRunCharacterPropertiesChangedHistoryItem.GetProperties
  (ARun: TdxRunBase): TdxIndexBasedObject;
begin
...
procedure TdxSeparatorRunInsertedHistoryItem.AfterInsertRun(ADocumentModel
  : TdxSimpleDocumentModel; ARun: TdxTextRunBase; ARunIndex: TdxRunIndex);
var
...
function TdxSeparatorRunInsertedHistoryItem.CreateRun
  (AParagraph: TdxParagraphBase): TdxTextRunBase;
begin
...
begin
  ...
  ATailRun := ARun.CreateRun(ARun.Paragraph, ARun.StartIndex + SplitOffset,
    ARun.Length - SplitOffset);
  ARuns.Insert(RunIndex + 1, ATailRun);
  ARun.Length := SplitOffset;
  ATailRun.InheritStyleAndFormattingFromCore(ARun, False);
  TdxDocumentModelStructureChangedNotifier.NotifyRunSplit(PieceTable,
    PieceTable, ParagraphIndex, RunIndex, SplitOffset);
  PieceTable.ApplyChanges(TdxDocumentModelChangeType.SplitRun, RunIndex,
    RunIndex + 1);
  DocumentModel.ResetMerging;
end;
...
begin
  ...
  try
    TdxDocumentModelStructureChangedNotifier.NotifyRunJoined(PieceTable,
      PieceTable, ParagraphIndex, RunIndex, SplitOffset, ATailRun.Length);
    PieceTable.ApplyChanges(TdxDocumentModelChangeType.JoinRun, RunIndex,
      RunIndex);
    DocumentModel.ResetMerging;
  finally
    FreeAndNil(ATailRun);
...
constructor TdxTextRunsJoinedHistoryItem.Create(APieceTable
  : TdxCustomPieceTable);
begin
  inherited Create(APieceTable);
  FSplitOffset := -1;
...
begin
  ...
  TdxDocumentModelStructureChangedNotifier.NotifyRunJoined(PieceTable,
    PieceTable, ParagraphIndex, RunIndex, FSplitOffset, ANextRunLength);
  PieceTable.ApplyChanges(TdxDocumentModelChangeType.JoinRun, RunIndex,
    RunIndex);
  DocumentModel.ResetMerging;
end;
...
begin
  ARuns := PieceTable.Runs;
  ARun := TdxTextRun(ARuns[RunIndex]);
  ATailRun := TdxTextRun.Create(ARun.Paragraph, ARun.StartIndex + FSplitOffset,
    ARun.Length - FSplitOffset);
  ARuns.Insert(RunIndex + 1, ATailRun);
  ARun.Length := FSplitOffset;
  ATailRun.InheritStyleAndFormattingFromCore(ARun, False);
  TdxDocumentModelStructureChangedNotifier.NotifyRunSplit(PieceTable,
    PieceTable, ParagraphIndex, RunIndex, FSplitOffset);
  PieceTable.ApplyChanges(TdxDocumentModelChangeType.SplitRun, RunIndex,
    RunIndex + 1);
  DocumentModel.ResetMerging;
end;
...
constructor TdxSimpleTextRunsDeletedHistoryItem.Create
  (APieceTable: TdxCustomPieceTable);
begin
  inherited Create(APieceTable);
  FDeletedRunCount := -1;
...
begin
  ...
  begin
    ...
    TdxDocumentModelStructureChangedNotifier.NotifyRunRemoved(PieceTable,
      PieceTable, ParagraphIndex, I, ALength, ANotificationId);
  end;
end;
...
begin
  ...
  begin
    ...
    ARuns.Insert(I, ARun);
    TdxDocumentModelStructureChangedNotifier.NotifyRunInserted(PieceTable,
      PieceTable, ParagraphIndex, I, ARun.Length,
      FNotificationIds[I - RunIndex]);
...
constructor TdxParagraphsDeletedHistoryItem.Create
  (APieceTable: TdxCustomPieceTable);
begin
  inherited Create(APieceTable);
...
begin
  ...
  begin
    ...
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphRemoved(PieceTable,
      PieceTable, SectionIndex, I, AFirstRunIndex,
      FNotificationIds[I - ParagraphIndex]);
    AParagraphs.RemoveAt(I);
    AParagraph.AfterRemove(AFirstRunIndex, ALastRunIndex, ALogPosition);
    DocumentModel.NotifyNumberingListParagraphRemoved
...
begin
  ...
  begin
    ...
    TdxDocumentModelStructureChangedNotifier.NotifyParagraphInserted(PieceTable,
      PieceTable, SectionIndex, I, AParagraphs[I].FirstRunIndex, Cell, False, I,
      FNotificationIds[I - ParagraphIndex]);
    DocumentModel.NotifyNumberingListParagraphAdded
      (AParagraph.GetOwnNumberingListIndex);
  end;
end;

function TdxParagraphsDeletedHistoryItem.GetDocumentModel
  : TdxSimpleDocumentModel;
begin
  Result := TdxSimpleDocumentModel(inherited DocumentModel);
end;
...
begin
  ...
  if FNotificationId = TdxNotificationIdGenerator.EmptyId then
    FNotificationId := DocumentModel.History.GetNotificationId;
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphMerged(PieceTable,
    PieceTable, ASectionIndex, EndParagraph.Index, EndParagraph.FirstRunIndex,
    FNotificationId);
...
begin
  ...
  TdxDocumentModelStructureChangedNotifier.NotifyParagraphInserted(PieceTable,
    PieceTable, ASectionIndex, EndParagraph.Index, EndParagraph.FirstRunIndex,
    Cell, True, EndParagraph.Index, FNotificationId);
  if not UseFirstParagraphStyle then
  begin
