...
class function TdxNavBarOffice1Painter.ButtonPainterClass
...
class function TdxNavBarOffice2Painter.SelectionPainterClass
...
class function TdxNavBarOffice3Painter.GetChildGroupViewInfoClass
  : TdxNavBarChildGroupViewInfoClass;
begin
  Result := TdxNavBarOffice3ChildGroupViewInfo;
end;

class function TdxNavBarOffice3Painter.GetLinkViewInfoClass
...
class procedure TdxNavBarOfficeButtonPainter.InternalDrawButton
...
begin
  ...
  if sPressed in AState then
    ...
    dxNavBarDrawSelectedFrame(ACanvas, ARect, LightLightBorderColor(AColor1),
      DarkDarkBorderColor(AColor1), clNone, clNone);
