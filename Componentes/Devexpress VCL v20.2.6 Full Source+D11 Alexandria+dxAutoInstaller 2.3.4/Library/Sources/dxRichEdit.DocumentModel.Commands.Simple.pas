...
type
  ...
  TdxSimplePieceTableInsertObjectAtLogPositionCommand = class
  ...
  TdxSimplePieceTableInsertObjectCommand = class
  ...
  TdxPieceTableInsertTextAtLogPositionCommand = class
    (TdxSimplePieceTableInsertObjectAtLogPositionCommand)
  private
    FText: string;
  protected
  ...
  TdxPieceTableDeleteFieldWithoutResultCommand = class
    (TdxSimplePieceTableCommand)
  private
    FField: TdxField;
  ...
  public
    constructor Create(APieceTable: TdxCustomPieceTable; AField: TdxField);
      reintroduce;
  end;

  { TdxPieceTableCreateFieldCommand }

  TdxPieceTableCreateFieldCommand = class
    (TdxSimplePieceTableInsertObjectAtLogPositionCommand)
  private
    FLength: Integer;
  ...
  TdxPieceTableCreateFieldWithResultCommand = class
    (TdxSimplePieceTableInsertObjectCommand)
  private
    FInsertedField: TdxField;
  ...
  protected
    ...
    function InsertEndCodeRun(AEndCodePosition: TdxDocumentLogPosition)
      : TdxRunIndex; virtual;
    function InsertEndResultRun(AEndResultPosition: TdxDocumentLogPosition)
      : TdxRunIndex; virtual;
  public
    constructor Create(APieceTable: TdxSimplePieceTable;
      AStartCode, AEndCode: TdxDocumentLogPosition; AResultLength: Integer;
      AForceVisible: Boolean); reintroduce;
  ...
  TdxPieceTableInsertObjectAtInputPositionCommand = class abstract
    (TdxSimplePieceTableInsertObjectCommand)
  private
    FForceVisible: Boolean;
  ...
  public
    constructor Create(APieceTable: TdxSimplePieceTable;
      APosition: TdxInputPosition; AForceVisible: Boolean); reintroduce;
  ...
  TdxPieceTableInsertTextAtInputPositionCommand = class
    (TdxPieceTableInsertObjectAtInputPositionCommand)
  private
    FText: string;
  protected
  ...
  public
    constructor Create(APieceTable: TdxSimplePieceTable;
      AInputPosition: TdxInputPosition; const AText: string;
      AForceVisible: Boolean); reintroduce;
  ...
  TdxPieceTableInsertInlinePictureAtLogPositionCommand = class
    (TdxSimplePieceTableInsertObjectAtLogPositionCommand)
  private
    FScaleX: Integer;
    FScaleY: Integer;
  ...
  public
    constructor Create(APieceTable: TdxSimplePieceTable;
      ...
      AScaleX, AScaleY: Integer; AForceVisible: Boolean); reintroduce;
  ...
  TdxPieceTableInsertInlineCustomObjectAtLogPositionCommand = class
    (TdxSimplePieceTableInsertObjectAtLogPositionCommand)
  private
  ...
  public
    constructor Create(APieceTable: TdxSimplePieceTable;
      ...
      const ACustomObject: IdxInlineCustomObject; AScaleX, AScaleY: Integer;
      AForceVisible: Boolean);
  ...
  public
    constructor Create(APieceTable: TdxSimplePieceTable;
      ALogPosition: TdxDocumentLogPosition; ALength: Integer); reintroduce;

    property DocumentLastParagraphSelected: Boolean
      read FDocumentLastParagraphSelected write FDocumentLastParagraphSelected;
    property LeaveFieldIfResultIsRemoved: Boolean
      read FLeaveFieldIfResultIsRemoved write FLeaveFieldIfResultIsRemoved;
    property LogPosition: TdxDocumentLogPosition read FLogPosition;
    property Length: Integer read FLength;
    property AllowPartiallyDeletingField: Boolean
      read FAllowPartiallyDeletingField write FAllowPartiallyDeletingField;
    property ForceRemoveInnerFields: Boolean read FForceRemoveInnerFields
      write FForceRemoveInnerFields;
  ...
  TdxPieceTableInsertPlainTextAtLogPositionCommand = class
    (TdxPieceTableInsertTextAtLogPositionCommand)
  protected
    procedure ExecuteCore; override;
    procedure InsertPlainTextCore(APosition: TdxDocumentLogPosition;
      const AText: string); virtual;
    class function GetNextLine(const ASource: string; var AIndex: Integer)
      : string; static;
    class function ShouldAddParagraph(const ASource: string;
      var AIndex: Integer): Boolean; static;
  end;

  { TdxPieceTableInsertPlainTextAtInputPositionCommand }

  TdxPieceTableInsertPlainTextAtInputPositionCommand = class
    (TdxPieceTableInsertObjectAtInputPositionCommand)
  private
    FText: string;
  protected
    function GetChangeType: TdxDocumentModelChangeType; override;
    procedure ExecuteCore; override;
    procedure InsertPlainTextCore(APosition: TdxInputPosition;
      const AText: string); virtual;
  public
    constructor Create(APieceTable: TdxSimplePieceTable;
      AInputPosition: TdxInputPosition; const AText: string;
  ...
  TdxPieceTableInsertParagraphAtLogPositionCommand = class
    (TdxSimplePieceTableInsertObjectAtLogPositionCommand)
  protected
    function GetChangeType: TdxDocumentModelChangeType; override;
    procedure ExecuteCore; override;
  ...
  TdxPieceTableInsertParagraphAtInputPositionCommand = class
    (TdxSimplePieceTableInsertObjectAtLogPositionCommand)
  strict private
...
function TdxSimplePieceTableInsertObjectAtLogPositionCommand.GetDocumentModel
  : TdxSimpleDocumentModel;
begin
  Result := TdxSimpleDocumentModel(inherited DocumentModel);
end;

function TdxSimplePieceTableInsertObjectAtLogPositionCommand.GetPieceTable
  : TdxSimplePieceTable;
begin
...
function TdxSimplePieceTableInsertObjectCommand.GetDocumentModel
  : TdxSimpleDocumentModel;
begin
  Result := TdxSimpleDocumentModel(inherited DocumentModel);
end;

function TdxSimplePieceTableInsertObjectCommand.GetPieceTable
  : TdxSimplePieceTable;
begin
  Result := TdxSimplePieceTable(inherited PieceTable);
end;
...
constructor TdxPieceTableInsertTextAtLogPositionCommand.Create
...
function TdxPieceTableInsertTextAtLogPositionCommand.GetChangeType
...
constructor TdxPieceTableDeleteFieldWithoutResultCommand.Create
...
procedure TdxPieceTableDeleteFieldWithoutResultCommand.
...
begin
  ...
  DocumentModel.UnsafeEditor.DeleteRuns(PieceTable, FField.Code.Start,
    ACodeRunsCount);
  DocumentModel.UnsafeEditor.DeleteRuns(PieceTable,
    FField.Result.&End - ACodeRunsCount, 1);
end;

{ TdxPieceTableCreateFieldCommand }

constructor TdxPieceTableCreateFieldCommand.Create
  (APieceTable: TdxSimplePieceTable; ALogPosition: TdxDocumentLogPosition;
...
begin
  AEndLogPosition := Min(LogPosition + Length,
  ...
  try
    ...
    AItem.CodeStartRunIndex := PieceTable.InsertFieldCodeStartRunCore
      (ParagraphIndex, LogPosition, ForceVisible);
    AItem.CodeEndRunIndex := PieceTable.InsertFieldCodeEndRunCore
      (AEndParagraphIndex, AEndLogPosition + 1, ForceVisible);
    AItem.ResultEndRunIndex := PieceTable.InsertFieldResultEndRunCore
      (AEndParagraphIndex, AEndLogPosition + 2, ForceVisible);
...
function TdxPieceTableCreateFieldCommand.GetChangeType
  : TdxDocumentModelChangeType;
begin
  Result := TdxDocumentModelChangeType.InsertText;
end;
...
constructor TdxPieceTableCreateFieldWithResultCommand.Create
...
function TdxPieceTableCreateFieldWithResultCommand.
...
begin
  ...
  try
    ...
    AEndResultPosition := Min(AEndCodePosition + FResultLength + 1,
      PieceTable.DocumentEndLogPosition);
...
function TdxPieceTableCreateFieldWithResultCommand.GetChangeType
  : TdxDocumentModelChangeType;
begin
  Result := TdxDocumentModelChangeType.InsertText;
end;
...
begin
  ...
  Result := PieceTable.InsertFieldCodeEndRunCore(AEndCodeParagraphIndex,
    AEndCodePosition, FForceVisible);
end;
...
begin
  ...
  Result := PieceTable.InsertFieldResultEndRunCore(AEndResultParagraphIndex,
    AEndResultPosition, FForceVisible);
end;

function TdxPieceTableCreateFieldWithResultCommand.InsertStartCodeRun
  : TdxRunIndex;
var
  AStartCodeParagraphIndex: TdxParagraphIndex;
begin
  AStartCodeParagraphIndex := ParagraphIndex;
  Result := PieceTable.InsertFieldCodeStartRunCore(AStartCodeParagraphIndex,
    FStartCode, FForceVisible);
end;

{ TdxPieceTableInsertObjectAtInputPositionCommand }

constructor TdxPieceTableInsertObjectAtInputPositionCommand.Create
  (APieceTable: TdxSimplePieceTable; APosition: TdxInputPosition;
  AForceVisible: Boolean);
begin
...
function TdxPieceTableInsertObjectAtInputPositionCommand.
  CalculateInsertionParagraphIndex: TdxParagraphIndex;
begin
...
constructor TdxPieceTableInsertTextAtInputPositionCommand.Create
  (APieceTable: TdxSimplePieceTable; AInputPosition: TdxInputPosition;
  const AText: string; AForceVisible: Boolean);
begin
  if AText = '' then
    TdxRichEditExceptions.ThrowArgumentException('text', Text);
...
function TdxPieceTableInsertTextAtInputPositionCommand.GetChangeType
  : TdxDocumentModelChangeType;
begin
  Result := TdxDocumentModelChangeType.InsertText;
end;
...
constructor TdxPieceTableInsertInlinePictureAtLogPositionCommand.Create
  (APieceTable: TdxSimplePieceTable; ALogPosition: TdxDocumentLogPosition;
  AImage: TdxOfficeImageReference; AScaleX, AScaleY: Integer;
  AForceVisible: Boolean);
begin
  Assert(AImage <> nil);
  Assert(AScaleX > 0);
...
begin
  &Result := PieceTable.InsertInlineImageCore(ParagraphIndex, LogPosition,
    Image, ScaleX, ScaleY, False, ForceVisible);
end;

function TdxPieceTableInsertInlinePictureAtLogPositionCommand.GetChangeType
  : TdxDocumentModelChangeType;
begin
...
constructor TdxPieceTableInsertInlineCustomObjectAtLogPositionCommand.Create
  (APieceTable: TdxSimplePieceTable; ALogPosition: TdxDocumentLogPosition;
  const ACustomObject: IdxInlineCustomObject; AScaleX, AScaleY: Integer;
  AForceVisible: Boolean);
begin
...
begin
  PieceTable.InsertInlineCustomObjectCore(ParagraphIndex, LogPosition,
    CustomObject, ScaleX, ScaleY, ForceVisible);
end;

function TdxPieceTableInsertInlineCustomObjectAtLogPositionCommand.GetChangeType
  : TdxDocumentModelChangeType;
begin
...
begin
  ...
  begin
    ASectionIndex := DocumentModel.FindSectionIndex
      (PieceTable.Paragraphs[FParagraphIndex].LogPosition);
    FParagraphIndex := DocumentModel.Sections[ASectionIndex]
      .FirstParagraphIndex;
  end;
...
constructor TdxPieceTableDeleteTextCommand.Create
  (APieceTable: TdxSimplePieceTable; ALogPosition: TdxDocumentLogPosition;
  ALength: Integer);
begin
  inherited Create(APieceTable);
...
function TdxPieceTableDeleteTextCommand.CreateDeleteContentOperation
...
begin
  ...
  try
    ...
    FSectionBreakDeleted := AOperation.Execute(LogPosition, Length,
      DocumentLastParagraphSelected);
  finally
    AOperation.Free;
  end;
end;
...
class function TdxPieceTableInsertPlainTextAtLogPositionCommand.GetNextLine
  (const ASource: string; var AIndex: Integer): string;
var
...
begin
  ...
  try
    ...
    while (AIndex <= ACount) and (ASource[AIndex] <> #10) and
      (ASource[AIndex] <> #13) do
    begin
...
procedure TdxPieceTableInsertPlainTextAtLogPositionCommand.InsertPlainTextCore
  (APosition: TdxDocumentLogPosition; const AText: string);
var
  ...
  begin
    ...
    begin
      ...
      if ARunFormattingSource <> nil then
        ALastInsertedRun.ApplyFormatting
          (ARunFormattingSource.CharacterProperties.Info.Info,
          ARunFormattingSource.CharacterProperties.Info.Options,
          ARunFormattingSource.CharacterStyleIndex, ForceVisible)
      else
...
class function TdxPieceTableInsertPlainTextAtLogPositionCommand.
  ShouldAddParagraph(const ASource: string; var AIndex: Integer): Boolean;
var
  ACount: Integer;
begin
  ACount := Length(ASource);
...
constructor TdxPieceTableInsertPlainTextAtInputPositionCommand.Create
  (APieceTable: TdxSimplePieceTable; AInputPosition: TdxInputPosition;
  const AText: string; AForceVisible: Boolean);
begin
  inherited Create(APieceTable, AInputPosition, AForceVisible);
...
function TdxPieceTableInsertPlainTextAtInputPositionCommand.GetChangeType
  : TdxDocumentModelChangeType;
begin
  Result := TdxDocumentModelChangeType.InsertText;
end;

procedure TdxPieceTableInsertPlainTextAtInputPositionCommand.InsertPlainTextCore
  (APosition: TdxInputPosition; const AText: string);
var
  AIndex: Integer;
  ALine: string;
begin
  ...
  begin
    ALine := TdxPieceTableInsertPlainTextAtLogPositionCommand.GetNextLine
      (AText, AIndex);
    if ALine <> '' then
      PieceTable.InsertTextCore(APosition, ALine);
    if TdxPieceTableInsertPlainTextAtLogPositionCommand.ShouldAddParagraph
      (AText, AIndex) then
...
function TdxPieceTableInsertParagraphAtLogPositionCommand.GetChangeType
  : TdxDocumentModelChangeType;
begin
...
constructor TdxPieceTableInsertParagraphAtInputPositionCommand.Create
  (APieceTable: TdxSimplePieceTable; ALogPosition: TdxDocumentLogPosition;
  AForceVisible: Boolean; AInputPosition: TdxInputPosition);
begin
  inherited Create(APieceTable, ALogPosition, AForceVisible);
  FInputPosition := AInputPosition;
end;

function TdxPieceTableInsertParagraphAtInputPositionCommand.GetChangeType
  : TdxDocumentModelChangeType;
begin
  Result := TdxDocumentModelChangeType.InsertParagraph;
end;
...
var
  ARunIndex: TdxRunIndex;
begin
  ARunIndex := PieceTable.InsertParagraphCore(ParagraphIndex, LogPosition,
    ForceVisible);
