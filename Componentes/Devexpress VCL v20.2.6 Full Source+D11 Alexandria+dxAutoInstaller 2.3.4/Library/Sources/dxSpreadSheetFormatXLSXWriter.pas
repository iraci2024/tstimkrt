...
{$ENDIF}
  ...
  dxCore, dxCoreClasses, cxClasses, cxGeometry, dxCustomTree, dxXMLDoc,
  dxZIPUtils,
  dxSpreadSheetCore, dxSpreadSheetTypes, dxSpreadSheetClasses,
  dxSpreadSheetStrs, dxSpreadSheetPackedFileFormatCore,
  dxSpreadSheetUtils, dxSpreadSheetGraphics, Generics.Defaults,
  Generics.Collections, dxGDIPlusClasses, dxCoreGraphics,
  dxSpreadSheetPrinting, dxSpreadSheetConditionalFormattingRules,
  dxSpreadSheetContainers, dxSpreadSheetHyperlinks,
  dxSpreadSheetFormatXLSXTags, dxSpreadSheetProtection, dxSpreadSheetCoreStyles,
  dxXMLWriter;
...
type
  ...
  protected
    ...
    procedure RegisterFile(const AFileName, AContentType: AnsiString;
      const ARelationship: AnsiString = '';
      ARels: TdxSpreadSheetXLSXWriterRels = nil); virtual;
    procedure WriteRels(const AFileName: AnsiString;
      ADocument: TdxSpreadSheetXLSXWriterRels);
  public
    constructor Create(AOwner: TdxCustomSpreadSheet; AStream: TStream);
      override;
    destructor Destroy; override;
    ...
    property CellStyleDefault: TdxSpreadSheetCellStyleHandle
      read FCellStyleDefault;
    property CellStyles: TdxSpreadSheetXLSXWriterResourceList read FCellStyles;
    property ConditionalFormattingStyles: TdxSpreadSheetXLSXWriterResourceList
      read FConditionalFormattingStyles;
    property CustomFormats: TdxSpreadSheetXLSXWriterResourceList
      read FCustomFormats;
    ...
    property SharedStrings: TdxSpreadSheetXLSXWriterResourceList
      read FSharedStrings;
    //
    property ColumnWidthHelper: TdxSpreadSheetExcelColumnWidthHelper
      read FColumnWidthHelper;
  end;

  { TdxSpreadSheetXLSXWriterCustomBuilder }

  TdxSpreadSheetXLSXWriterCustomBuilder = class
  ...
  protected
    procedure RegisterFile(const AFileName, AContentType: AnsiString;
      const ARelationship: AnsiString = '';
      ARels: TdxSpreadSheetXLSXWriterRels = nil); inline;
  public
    constructor Create(AOwner: TdxSpreadSheetXLSXWriter;
      AOwnerRels: TdxSpreadSheetXLSXWriterRels);
  ...
  TdxSpreadSheetXLSXWriterCustomFileBuilder = class
    (TdxSpreadSheetXLSXWriterCustomBuilder)
  strict private
  ...
  TdxSpreadSheetXLSXWriterCustomXMLBuilder = class
    (TdxSpreadSheetXLSXWriterCustomFileBuilder)
  strict private
  const
  ...
  { TdxSpreadSheetXLSXWriterMetadataBuilder }

  TdxSpreadSheetXLSXWriterMetadataBuilder = class
    (TdxSpreadSheetXLSXWriterCustomXMLBuilder)
  strict private
    function GetMetadata: TdxSpreadSheetOptionsMetadata;
    procedure WriteValue(AWriter: TdxXmlWriter; const ANamespace, AValueName,
      AValue: string); overload;
    procedure WriteValue(AWriter: TdxXmlWriter;
      const ANamespace, AValueName: string; const AValue: TDateTime); overload;
  protected
  ...
  TdxSpreadSheetXLSXWriterExternalLinkBuilder = class
    (TdxSpreadSheetXLSXWriterCustomFileBuilder)
  strict private
  ...
  TdxSpreadSheetXLSXWriterFormattedStringBuilder = class
    (TdxSpreadSheetXLSXWriterCustomBuilder)
  strict private
  ...
  public
    constructor Create(AOwner: TdxSpreadSheetXLSXWriter;
      AOwnerRels: TdxSpreadSheetXLSXWriterRels; AWriter: TdxXmlWriter;
  ...
  TdxSpreadSheetXLSXWriterSharedStringsBuilder = class
    (TdxSpreadSheetXLSXWriterCustomXMLBuilder)
  strict private
  ...
  TdxXLSXStyleForEachProc = reference to procedure(AWriter: TdxXmlWriter;
    AUserData: Pointer);

  TdxSpreadSheetXLSXWriterStylesBuilder = class
    (TdxSpreadSheetXLSXWriterCustomXMLBuilder)
  strict private
    ...
    function GetConditionalFormattingStyles
      : TdxSpreadSheetXLSXWriterResourceList; inline;
  ...
  protected
    ...
    procedure ProcessStylesGroup(AWriter: TdxXmlWriter; const ANodeName: string;
      AStyles: TdxSpreadSheetXLSXWriterResourceList;
      AProc: TdxXLSXStyleForEachProc);

    procedure ProcessStylesGroupBorders(AWriter: TdxXmlWriter; AData: Pointer);
    procedure ProcessStylesGroupCellStyle(AWriter: TdxXmlWriter;
      AData: Pointer);
    procedure ProcessStylesGroupConditionalFormatting(AWriter: TdxXmlWriter;
      AData: Pointer);
    ...
    procedure ProcessStylesGroupNumberFormat(AWriter: TdxXmlWriter;
      AData: Pointer);
  public
    destructor Destroy; override;
    procedure AfterConstruction; override;
    class procedure WriteColor(AWriter: TdxXmlWriter; const ANodeName: string;
      AColor: TColor);
    class procedure WriteFont(AWriter: TdxXmlWriter;
      const ANodeName, AFontNameNodeName: string;
    ...
    property CellStyleDefault: TdxSpreadSheetCellStyleHandle
      read GetCellStyleDefault;
    property CellStyles: TdxSpreadSheetXLSXWriterResourceList
      read GetCellStyles;
    property ConditionalFormattingStyles: TdxSpreadSheetXLSXWriterResourceList
      read GetConditionalFormattingStyles;
    property CustomFormats: TdxSpreadSheetXLSXWriterResourceList
      read GetCustomFormats;
  ...
  TdxSpreadSheetXLSXWriterWorkbookBuilder = class
    (TdxSpreadSheetXLSXWriterCustomFileBuilder)
  strict private
  ...
  public
    procedure AfterConstruction; override;
    procedure Execute; override;
    function HasPrintableAreas(AView: TdxSpreadSheetTableView)
      : Boolean; virtual;
    procedure WriteCalcProperties(AWorkbook: TdxXMLNode); virtual;
    procedure WriteDefinedName(ANode: TdxXMLNode;
      ADefinedName: TdxSpreadSheetDefinedName); overload;
    procedure WriteDefinedName(ANode: TdxXMLNode;
      const ACaption, AReference, AComment: string;
      AScope: TdxSpreadSheetCustomView); overload; virtual;
    procedure WriteDefinedNames(ANode: TdxXMLNode); virtual;
    procedure WriteExternalLink(const AFileName: AnsiString;
      ALink: TdxSpreadSheetExternalLink;
      ARels: TdxSpreadSheetXLSXWriterRels); virtual;
    procedure WriteExternalLinks(ANode: TdxXMLNode;
      ARels: TdxSpreadSheetXLSXWriterRels); virtual;
    procedure WritePrintableAreas(ANode: TdxXMLNode;
      AView: TdxSpreadSheetTableView); virtual;
    procedure WriteProperties(AWorkbook: TdxXMLNode); virtual;
    procedure WriteProtection(ANode: TdxXMLNode); virtual;
    procedure WriteSharedStrings(const AFileName: AnsiString;
      ARels: TdxSpreadSheetXLSXWriterRels); virtual;
    procedure WriteSheet(ANode: TdxXMLNode; AView: TdxSpreadSheetCustomView;
      ARels: TdxSpreadSheetXLSXWriterRels); virtual;
    procedure WriteSheets(ANode: TdxXMLNode;
      ARels: TdxSpreadSheetXLSXWriterRels); virtual;
    procedure WriteSheetView(const AFileName: AnsiString;
      AView: TdxSpreadSheetCustomView;
      ARels: TdxSpreadSheetXLSXWriterRels); virtual;
    procedure WriteStyles(const AFileName: AnsiString;
      ARels: TdxSpreadSheetXLSXWriterRels); virtual;
  end;

  { TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder }

  TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder = class
    (TdxSpreadSheetXLSXWriterCustomXMLBuilder)
  strict private
    ...
    procedure ExtendDimensionsByGroups(AGroups: TdxSpreadSheetTableItemGroups;
      var AStartIndex, AFinishIndex: Integer);
  protected
    class function GetContentRelationship: AnsiString; override;
    class function GetContentType: AnsiString; override;
  protected
    ...
    procedure WriteBreaks(AWriter: TdxXmlWriter; const ANodeName: string;
      AList: TList<Cardinal>; AMaxIndex: Integer); virtual;
    procedure WriteCell(AWriter: TdxXmlWriter; ACell: TdxSpreadSheetCell;
      ARowIndex, AColumnIndex: Integer); virtual;
    procedure WriteColumns(AWriter: TdxXmlWriter; ADimension: TRect); virtual;
    procedure WriteComments(AWriter: TdxXmlWriter;
      ARels: TdxSpreadSheetXLSXWriterRels); virtual;
    procedure WriteConditionalFormatting(AWriter: TdxXmlWriter); virtual;
    procedure WriteContainers(AWriter: TdxXmlWriter;
      ARels: TdxSpreadSheetXLSXWriterRels); virtual;
    procedure WriteContent(AWriter: TdxXmlWriter;
      ARels: TdxSpreadSheetXLSXWriterRels); virtual;
    procedure WriteExtensions(AWriter: TdxXmlWriter); virtual;
    procedure WriteFixedPaneProperties(AWriter: TdxXmlWriter); virtual;
    procedure WriteHeaderFooter(AWriter: TdxXmlWriter;
      AHeaderFooter: TdxSpreadSheetTableViewOptionsPrintHeaderFooter); virtual;
    procedure WriteHeaderFooterText(AWriter: TdxXmlWriter;
      const ANodeName: string;
      AText: TdxSpreadSheetTableViewOptionsPrintHeaderFooterText);
    procedure WriteHyperlink(AWriter: TdxXmlWriter;
      AHyperlink: TdxSpreadSheetHyperLink;
      ARels: TdxSpreadSheetXLSXWriterRels); virtual;
    procedure WriteHyperlinks(AWriter: TdxXmlWriter;
      ARels: TdxSpreadSheetXLSXWriterRels); virtual;
    procedure WriteMergedCells(AWriter: TdxXmlWriter;
      AMergedCells: TdxSpreadSheetMergedCellList); virtual;
    procedure WritePageMargins(AWriter: TdxXmlWriter;
      AMargins: TdxSpreadSheetTableViewOptionsPrintPageMargins); virtual;
    ...
    procedure WriteSelection(AWriter: TdxXmlWriter;
  ...
  TdxSpreadSheetXLSXWriterWorksheetTableViewSubFileBuilder = class
    (TdxSpreadSheetXLSXWriterCustomFileBuilder)
  strict private
    FOwnerWriter: TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder;
  public
    constructor Create(const ATargetFileName: AnsiString;
      AOwnerRels: TdxSpreadSheetXLSXWriterRels;
      AOwnerWriter: TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder);
    //
    property OwnerWriter: TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder
      read FOwnerWriter;
  end;
...
uses
  AnsiStrings, Math, TypInfo, StrUtils, dxColorPicker, cxGraphics, dxHashUtils,
  dxTypeHelpers,
  dxSpreadSheetFormulas, dxSpreadSheetFormatXLSX, dxSpreadSheetFormatUtils,
  dxSpreadSheetFormatXLSXWriterComments,
  dxSpreadSheetFormatXLSXWriterConditionalFormatting,
  dxSpreadSheetFormatXLSXWriterDrawing, dxOLECryptoContainer,
...
function TdxSpreadSheetXLSXWriterResourceList.IndexOf(AObject: TObject)
  : Integer;
begin
...
begin
  ...
  Root.AddChild(sdxXLSXNodeRelationships).Attributes.Add(sdxXLSXAttrXMLNS,
    sdxXLSXRelsNameSpace);
end;

procedure TdxSpreadSheetXLSXWriterRels.AddExternalRelationship(const AType,
  ATarget: TdxXMLString);
begin
  DoAddRelationship(AType, ATarget).Attributes.Add(sdxXLSXAttrTargetMode,
    sdxXLSXValueTargetModeExternal);
end;

procedure TdxSpreadSheetXLSXWriterRels.AddRelationship(const AType,
  ATarget: TdxXMLString);
begin
  DoAddRelationship(AType, ATarget);
end;

function TdxSpreadSheetXLSXWriterRels.GetRelationshipId(const ATarget
  : TdxXMLString): TdxXMLString;
var
  ANode: TdxXMLNode;
begin
  Result := '';
...
procedure TdxSpreadSheetXLSXWriterRels.ConvertToRelativePaths(const ARootPath
  : TdxXMLString);
var
  ANode: TdxXMLNode;
begin
  ...
  while ANode <> nil do
  begin
    if ANode.Attributes.GetValue(sdxXLSXAttrTargetMode) <> sdxXLSXValueTargetModeExternal
    then
    begin
      ANode.Attributes.SetValue(sdxXLSXAttrTarget,
        TdxZIPPathHelper.RelativePath(ARootPath,
        TdxZIPPathHelper.ExcludeRootPathDelimiter(ANode.Attributes.GetValue
        (sdxXLSXAttrTarget))));
    end;
    ANode := ANode.Next;
  end;
...
function TdxSpreadSheetXLSXWriterRels.DoAddRelationship(const AType,
  ATarget: TdxXMLString): TdxXMLNode;
begin
  Result := Root.First.AddChild(sdxXLSXNodeRelationship);
  Result.Attributes.Add(sdxXLSXAttrId,
    'rId' + dxStringToAnsiString(IntToStr(Root.First.Count)));
...
constructor TdxSpreadSheetXLSXCustomWriter.Create(AOwner: TdxCustomSpreadSheet;
  AStream: TStream);
begin
...
begin
  ...
  if FTargetStream <> nil then
    try
      TdxOLECryptoContainer.Encrypt(Stream, FTargetStream, SpreadSheet.Password,
...
constructor TdxSpreadSheetXLSXWriter.Create(AOwner: TdxCustomSpreadSheet;
  AStream: TStream);
begin
  inherited Create(AOwner, AStream);
  ...
  FCellStyleDefault := SpreadSheet.CellStyles.AddStyle
    (SpreadSheet.CellStyles.CreateStyle);
...
begin
  ...
  try
    ExecuteSubTask(TdxSpreadSheetXLSXWriterWorkbookBuilder.Create(Self, ARels,
      sdxXLSXWorkbookFileName));
    if SpreadSheet.OptionsMetadata.HasData then
      ExecuteSubTask(TdxSpreadSheetXLSXWriterMetadataBuilder.Create(Self, ARels,
        sdxXLSXCorePropertiesFileName));
    RegisterFile(TdxSpreadSheetXLSXUtils.GetRelsFileNameForFile(''),
      sdxXLSXRelsContentType);
...
function TdxSpreadSheetXLSXWriter.CreateProgressHelper
  : TdxSpreadSheetCustomFilerProgressHelper;
begin
  Result := TdxSpreadSheetCustomFilerProgressHelper.Create(Self,
...
begin
  Fills.Add(SpreadSheet.CellStyles.Brushes.AddBrush
    (SpreadSheet.CellStyles.Brushes.CreateBrush));
...
procedure TdxSpreadSheetXLSXWriter.InitializeContentTypes(ANode: TdxXMLNode);
  ...
  procedure AddDefaults(ANode: TdxXMLNode;
    const AExtension, AContentType: AnsiString);
  begin
...
procedure TdxSpreadSheetXLSXWriter.RegisterFile(const AFileName,
  AContentType: AnsiString; const ARelationship: AnsiString = '';
  ARels: TdxSpreadSheetXLSXWriterRels = nil);
var
  ANode: TdxXMLNode;
begin
  if ARels <> nil then
...
procedure TdxSpreadSheetXLSXWriter.WriteRels(const AFileName: AnsiString;
  ADocument: TdxSpreadSheetXLSXWriterRels);
var
  APath: AnsiString;
begin
...
function TdxSpreadSheetXLSXWriterCustomBuilder.WriteImage(AImage: TdxGPImage)
  : AnsiString;
const
  CodecMap: array [Boolean] of TdxImageDataFormat = (dxImagePng, dxImageJpeg);
  ExtMap: array [Boolean] of string = (sdxXLSXMimeTypePNGExt,
    sdxXLSXMimeTypeJPGExt);
var
...
begin
  ...
  begin
    ...
    try
      ...
      AFileName := Format(sdxXLSXFileTemplateImage,
        [Owner.Images.Count + 1, ExtMap[ASaveAsJPEG]]);
  ...
  OwnerRels.AddRelationship(sdxXLSXImageRelationship,
    dxUnixPathDelim + AFileName);
  Result := OwnerRels.GetRelationshipId(dxUnixPathDelim + AFileName);
end;

procedure TdxSpreadSheetXLSXWriterCustomBuilder.RegisterFile(const AFileName,
  AContentType: AnsiString; const ARelationship: AnsiString = '';
  ARels: TdxSpreadSheetXLSXWriterRels = nil);
begin
...
function TdxSpreadSheetXLSXWriterCustomBuilder.GetOwner
  : TdxSpreadSheetXLSXWriter;
begin
...
constructor TdxSpreadSheetXLSXWriterCustomFileBuilder.Create
  (AOwner: TdxSpreadSheetXLSXWriter; AOwnerRels: TdxSpreadSheetXLSXWriterRels;
  const ATargetFileName: AnsiString);
begin
...
function TdxSpreadSheetXLSXWriterCustomFileBuilder.GetTargetFileNameRels
  : AnsiString;
begin
...
begin
  ...
  try
    ...
    RegisterFile(TargetFileName, GetContentType, GetContentRelationship,
      OwnerRels);
  finally
...
procedure TdxSpreadSheetXLSXWriterMetadataBuilder.ExecuteCore
  (AWriter: TdxXmlWriter);
begin
  AWriter.WriteStartElement(sdxXLSXNamespaceCoreProperties,
    sdxXLSXNodeCoreProperties,
    'http://schemas.openxmlformats.org/package/2006/metadata/core-properties');
  AWriter.WriteAttributeString('xmlns', 'xsi', '',
    'http://www.w3.org/2001/XMLSchema-instance');
  AWriter.WriteAttributeString('xmlns', 'dcmitype', '',
    'http://purl.org/dc/dcmitype/');
  AWriter.WriteAttributeString('xmlns', 'dcterms', '',
    'http://purl.org/dc/terms/');
  AWriter.WriteAttributeString('xmlns', 'dc', '',
    'http://purl.org/dc/elements/1.1/');

  WriteValue(AWriter, sdxXLSXNamespaceDublinCore, sdxXLSXNodeTitle,
    Metadata.Title);
  WriteValue(AWriter, sdxXLSXNamespaceDublinCore, sdxXLSXNodeSubject,
    Metadata.Subject);
  WriteValue(AWriter, sdxXLSXNamespaceDublinCore, sdxXLSXNodeCreator,
    Metadata.CreatedBy);
  WriteValue(AWriter, sdxXLSXNamespaceCoreProperties, sdxXLSXNodeKeywords,
    Metadata.Keywords);
  WriteValue(AWriter, sdxXLSXNamespaceDublinCore, sdxXLSXNodeDescription,
    Metadata.Description);
  WriteValue(AWriter, sdxXLSXNamespaceCoreProperties, sdxXLSXNodeLastModifiedBy,
    Metadata.LastModifiedBy);
  WriteValue(AWriter, sdxXLSXNamespaceCoreProperties, sdxXLSXNodeLastPrinted,
    Metadata.LastPrinted);
  WriteValue(AWriter, sdxXLSXNamespaceDublinCoreTerms, sdxXLSXNodeCreationDate,
    Metadata.Created);
  WriteValue(AWriter, sdxXLSXNamespaceDublinCoreTerms,
    sdxXLSXNodeModificationDate, Metadata.LastModified);

  AWriter.WriteEndElement;
end;

class function TdxSpreadSheetXLSXWriterMetadataBuilder.GetContentRelationship
  : AnsiString;
begin
  Result := sdxXLSXCorePropertiesRelationship;
end;

class function TdxSpreadSheetXLSXWriterMetadataBuilder.GetContentType
  : AnsiString;
begin
  Result := sdxXLSXCorePropertiesContentType;
end;

procedure TdxSpreadSheetXLSXWriterMetadataBuilder.WriteValue
  (AWriter: TdxXmlWriter; const ANamespace, AValueName: string;
...
function TdxSpreadSheetXLSXWriterMetadataBuilder.GetMetadata
...
constructor TdxSpreadSheetXLSXWriterExternalLinkBuilder.Create
  (AOwner: TdxSpreadSheetXLSXWriter; AOwnerRels: TdxSpreadSheetXLSXWriterRels;
  ALink: TdxSpreadSheetExternalLink; const ATargetFileName: AnsiString);
begin
...
begin
  ...
  try
    ...
    try
      ADocRels.AddExternalRelationship
        (sdxXLSXExternalLinkPathRelationship, ATarget);

      ANode := ANode.AddChild(sdxXLSXNodeExternalBook);
      ANode.Attributes.SetValue(sdxXLSXAttrXMLNSR,
        sdxXLSXCommonRelationshipPath);
      ANode.Attributes.SetValue(sdxXLSXAttrRId,
        ADocRels.GetRelationshipId(ATarget));
    ...
    RegisterFile(TargetFileName, sdxXLSXExternalLinkContentType,
      sdxXLSXExternalLinkRelationship, OwnerRels);
...
function TdxSpreadSheetXLSXWriterExternalLinkBuilder.EncodePath
  (const APath: string): TdxXMLString;
begin
...
begin
  ...
  begin
    ...
    FWriter.WriteElementStringEx(sdxXLSXNodeText,
      Copy(FString.Value, 1, ALength));
  ...
  begin
    ...
    if ARun.FontHandle <> nil then
      TdxSpreadSheetXLSXWriterStylesBuilder.WriteFont(FWriter,
        sdxXLSXNodeRichTextRunParagraph, sdxXLSXNodeFontName, ARun.FontHandle);
    FWriter.WriteElementStringEx(sdxXLSXNodeText,
      Copy(FString.Value, ARun.StartIndex, ALength));
    FWriter.WriteEndElement;
  end;
end;
...
procedure TdxSpreadSheetXLSXWriterSharedStringsBuilder.ExecuteCore
  (AWriter: TdxXmlWriter);
var
...
begin
  ...
  try
    ...
    begin
      ...
      if (AString.ClassType <> TdxSpreadSheetSharedString) and
        (AString is TdxSpreadSheetFormattedSharedString) then
        ExecuteSubTask(TdxSpreadSheetXLSXWriterFormattedStringBuilder.Create
          (Owner, OwnerRels, AWriter,
          TdxSpreadSheetFormattedSharedString(AString)))
      else
...
class function TdxSpreadSheetXLSXWriterSharedStringsBuilder.
  GetContentRelationship: AnsiString;
begin
  Result := sdxXLSXSharedStringRelationship;
end;

class function TdxSpreadSheetXLSXWriterSharedStringsBuilder.GetContentType
  : AnsiString;
begin
  Result := sdxXLSXSharedStringsContentType;
end;

function TdxSpreadSheetXLSXWriterSharedStringsBuilder.GetSharedStrings
  : TdxSpreadSheetXLSXWriterResourceList;
begin
...
begin
  ...
  begin
    ...
    AWriter.WriteAttributeString(sdxXLSXAttrRGB,
      TdxColorHelper.AlphaColorToHexCode(dxColorToAlphaColor(AColor), False));
    AWriter.WriteEndElement;
  end;
end;

class procedure TdxSpreadSheetXLSXWriterStylesBuilder.WriteFont
  (AWriter: TdxXmlWriter; const ANodeName, AFontNameNodeName: string;
  AFont: TdxSpreadSheetFontHandle);
const
  ...
  try
    ...
    begin
      if AStyle in AFont.Style then
        AWriter.WriteElementString
          (dxAnsiStringToString(dxXLSXFontStyles[AStyle]), '');
    end;
  finally
    AWriter.WriteEndElement;
  end;
...
procedure TdxSpreadSheetXLSXWriterStylesBuilder.ExecuteCore
  (AWriter: TdxXmlWriter);
begin
  PrepareResources;
  ...
  try
    Owner.ProgressHelper.BeginStage(CellStyles.Count + Borders.Count +
      Formats.Count + Fonts.Count + ConditionalFormattingStyles.Count);
    try
      ProcessStylesGroup(AWriter, sdxXLSXNodeStyleNumberFormats, Formats,
        ProcessStylesGroupNumberFormat);
      ProcessStylesGroup(AWriter, sdxXLSXNodeStyleFonts, Fonts,
        ProcessStylesGroupFont);
      ProcessStylesGroup(AWriter, sdxXLSXNodeStyleFills, Fills,
        ProcessStylesGroupFill);
      ProcessStylesGroup(AWriter, sdxXLSXNodeStyleBorders, Borders,
        ProcessStylesGroupBorders);
      ...
      ProcessStylesGroup(AWriter, sdxXLSXNodeStyleCellXfs, CellStyles,
        ProcessStylesGroupCellStyle);
      ProcessStylesGroup(AWriter, sdxXLSXNodeDXFS, ConditionalFormattingStyles,
        ProcessStylesGroupConditionalFormatting);
    finally
      Owner.ProgressHelper.EndStage;
    end;
  finally
...
function TdxSpreadSheetXLSXWriterStylesBuilder.GetFormatID
  (AFormat: TdxSpreadSheetFormatHandle): Integer;
begin
...
procedure TdxSpreadSheetXLSXWriterStylesBuilder.ProcessStylesGroup
  (AWriter: TdxXmlWriter; const ANodeName: string;
  AStyles: TdxSpreadSheetXLSXWriterResourceList;
  AProc: TdxXLSXStyleForEachProc);
var
  I: Integer;
...
procedure TdxSpreadSheetXLSXWriterStylesBuilder.ProcessStylesGroupBorders
  (AWriter: TdxXmlWriter; AData: Pointer);
const
...
begin
  ...
  try
    ...
    begin
      ...
      AWriter.WriteStartElement
        (dxAnsiStringToString(dxXLSXBorderNames[ABorder]));
      if not ABordersHandle.BorderIsAuto[ABorder] then
      begin
        ABorderStyle := TdxSpreadSheetXLSXHelper.BorderStyleToString
          (ABordersHandle.BorderStyle[ABorder]);
        if ABorderStyle <> '' then
          AWriter.WriteAttributeString(sdxXLSXAttrStyle, ABorderStyle);
        WriteColor(AWriter, sdxXLSXNodeColor,
          ABordersHandle.BorderColor[ABorder]);
      end;
      AWriter.WriteEndElement;
    end;
...
procedure TdxSpreadSheetXLSXWriterStylesBuilder.ProcessStylesGroupCellStyle
  (AWriter: TdxXmlWriter; AData: Pointer);
var
...
begin
  ...
  try
    ...
    AWriter.WriteAttributeInteger(sdxXLSXAttrBorderId,
      Borders.IndexOf(AStyleHandle.Borders));
    AWriter.WriteAttributeInteger(sdxXLSXAttrFillId,
      Fills.IndexOf(AStyleHandle.Brush));
    AWriter.WriteAttributeInteger(sdxXLSXAttrFontId,
      Fonts.IndexOf(AStyleHandle.Font));
    AWriter.WriteAttributeInteger(sdxXLSXAttrNumFmtId,
      GetFormatID(AStyleHandle.DataFormat));
    AWriter.WriteAttributeInteger(sdxXLSXAttrXFId, 0);

    AWriter.WriteStartElement(sdxXLSXNodeAlignment);
    try
      AWriter.WriteAttributeString(sdxXLSXAttrHorizontal,
        TdxSpreadSheetXLSXHelper.AlignHorzToString(AStyleHandle.AlignHorz));
      AWriter.WriteAttributeString(sdxXLSXAttrVertical,
        TdxSpreadSheetXLSXHelper.AlignVertToString(AStyleHandle.AlignVert));
      if AStyleHandle.AlignHorzIndent <> 0 then
        AWriter.WriteAttributeInteger(sdxXLSXAttrIndent,
          Owner.ColumnWidthHelper.PixelsToSpacesNumber
          (AStyleHandle.AlignHorzIndent));
      AWriter.WriteAttributeInteger(sdxXLSXAttrTextRotation,
        AStyleHandle.Rotation);
      AWriter.WriteAttributeBoolean(sdxXLSXAttrShrinkToFit,
        csShrinkToFit in AStyleHandle.States);
      AWriter.WriteAttributeBoolean(sdxXLSXAttrWrapText,
        csWordWrap in AStyleHandle.States);
    finally
      AWriter.WriteEndElement;
    end;
    ...
    try
      AWriter.WriteAttributeBoolean(sdxXLSXAttrHidden,
        csHidden in AStyleHandle.States);
      AWriter.WriteAttributeBoolean(sdxXLSXAttrLocked,
        csLocked in AStyleHandle.States);
    finally
      AWriter.WriteEndElement;
    end;
  finally
...
procedure TdxSpreadSheetXLSXWriterStylesBuilder.
  ProcessStylesGroupConditionalFormatting(AWriter: TdxXmlWriter;
  AData: Pointer);
var
...
procedure TdxSpreadSheetXLSXWriterStylesBuilder.ProcessStylesGroupFill
  (AWriter: TdxXmlWriter; AData: Pointer);
var
...
begin
  ...
  try
    ...
    AWriter.WriteAttributeString(sdxXLSXAttrPatternType,
      TdxSpreadSheetXLSXHelper.FillStyleToString(ABrushHandle));

    if ABrushHandle.Style = sscfsSolid then
    begin
      WriteColor(AWriter, sdxXLSXNodeForegroundColor,
        ABrushHandle.BackgroundColor);
      WriteColor(AWriter, sdxXLSXNodeBackgroundColor,
        ABrushHandle.BackgroundColor);
    end
    else
    begin
      WriteColor(AWriter, sdxXLSXNodeForegroundColor,
        ABrushHandle.ForegroundColor);
      WriteColor(AWriter, sdxXLSXNodeBackgroundColor,
        ABrushHandle.BackgroundColor);
    end;
...
procedure TdxSpreadSheetXLSXWriterStylesBuilder.ProcessStylesGroupFont
  (AWriter: TdxXmlWriter; AData: Pointer);
begin
  WriteFont(AWriter, sdxXLSXNodeStyleFont, sdxXLSXNodeName,
    TdxSpreadSheetFontHandle(AData));
end;

procedure TdxSpreadSheetXLSXWriterStylesBuilder.ProcessStylesGroupNumberFormat
  (AWriter: TdxXmlWriter; AData: Pointer);
var
  AFormatID: Integer;
begin
  ...
  begin
    ...
    try
      AWriter.WriteAttributeString(sdxXLSXAttrFormatCode,
        TdxSpreadSheetFormatHandle(AData).FormatCode);
...
class function TdxSpreadSheetXLSXWriterStylesBuilder.GetContentRelationship
  : AnsiString;
begin
...
function TdxSpreadSheetXLSXWriterStylesBuilder.GetBorders
  : TdxSpreadSheetXLSXWriterResourceList;
begin
  Result := Owner.Borders;
end;

function TdxSpreadSheetXLSXWriterStylesBuilder.GetCellStyleDefault
  : TdxSpreadSheetCellStyleHandle;
begin
  Result := Owner.CellStyleDefault;
end;

function TdxSpreadSheetXLSXWriterStylesBuilder.GetCellStyles
  : TdxSpreadSheetXLSXWriterResourceList;
begin
  Result := Owner.CellStyles;
end;

function TdxSpreadSheetXLSXWriterStylesBuilder.GetConditionalFormattingStyles
  : TdxSpreadSheetXLSXWriterResourceList;
begin
  Result := Owner.ConditionalFormattingStyles;
end;

function TdxSpreadSheetXLSXWriterStylesBuilder.GetCustomFormats
  : TdxSpreadSheetXLSXWriterResourceList;
begin
  Result := Owner.CustomFormats;
end;

function TdxSpreadSheetXLSXWriterStylesBuilder.GetFills
  : TdxSpreadSheetXLSXWriterResourceList;
begin
  Result := Owner.Fills;
end;

function TdxSpreadSheetXLSXWriterStylesBuilder.GetFonts
  : TdxSpreadSheetXLSXWriterResourceList;
begin
  Result := Owner.Fonts;
end;
  ...
  try
    ...
    try
      ...
      if SpreadSheet.ExternalLinks.Count > 0 then
        WriteExternalLinks(ANode.AddChild(sdxXLSXNodeExternalReferences),
          AWorkbookRels);
    ...
    RegisterFile(TargetFileName, Owner.GetContentTypeID,
      sdxXLSXWorkbookRelationship, OwnerRels);
...
function TdxSpreadSheetXLSXWriterWorkbookBuilder.HasPrintableAreas
  (AView: TdxSpreadSheetTableView): Boolean;
begin
  Result := AView.OptionsPrint.Source.Area.Assigned or
    AView.OptionsPrint.Source.RowsToRepeat.Assigned or
    AView.OptionsPrint.Source.ColumnsToRepeat.Assigned;
end;

procedure TdxSpreadSheetXLSXWriterWorkbookBuilder.WriteCalcProperties
  (AWorkbook: TdxXMLNode);
const
...
begin
  ...
  ANode.Attributes.Add(sdxXLSXAttrRefMode,
    Map[SpreadSheet.OptionsView.R1C1Reference]);
  ...
  begin
    ...
    if SpreadSheet.OptionsBehavior.IterativeCalculationMaxCount <> 100 then
      ANode.Attributes.Add(sdxXLSXAttrIterateCount,
...
procedure TdxSpreadSheetXLSXWriterWorkbookBuilder.WriteDefinedName
  (ANode: TdxXMLNode; ADefinedName: TdxSpreadSheetDefinedName);
begin
  WriteDefinedName(ANode, ADefinedName.Caption, ADefinedName.reference,
    ADefinedName.Comment, ADefinedName.Scope);
end;

procedure TdxSpreadSheetXLSXWriterWorkbookBuilder.WriteDefinedName
  (ANode: TdxXMLNode; const ACaption, AReference, AComment: string;
  AScope: TdxSpreadSheetCustomView);
begin
  ANode.Attributes.SetValueAsString(sdxXLSXAttrName, ACaption);
  if AScope <> nil then
    ANode.Attributes.SetValueAsInteger(sdxXLSXAttrLocalSheetId, AScope.Index);
  if AComment <> '' then
    ANode.Attributes.SetValueAsString(sdxXLSXAttrComment, AComment);
  ANode.TextAsString := dxSpreadSheetFormulaExcludeEqualSymbol(AReference);
end;

procedure TdxSpreadSheetXLSXWriterWorkbookBuilder.WriteDefinedNames
  (ANode: TdxXMLNode);
var
  AView: TdxSpreadSheetCustomView;
  I: Integer;
begin
  for I := 0 to SpreadSheet.DefinedNames.Count - 1 do
    WriteDefinedName(ANode.AddChild(sdxXLSXNodeDefinedName),
      SpreadSheet.DefinedNames[I]);
...
procedure TdxSpreadSheetXLSXWriterWorkbookBuilder.WriteExternalLink
  (const AFileName: AnsiString; ALink: TdxSpreadSheetExternalLink;
  ARels: TdxSpreadSheetXLSXWriterRels);
begin
  ExecuteSubTask(TdxSpreadSheetXLSXWriterExternalLinkBuilder.Create(Owner,
    ARels, ALink, AFileName));
end;
...
begin
  ...
  begin
    ...
    ANode.AddChild(sdxXLSXNodeExternalReference).Attributes.Add(sdxXLSXAttrRId,
      ARels.GetRelationshipId(dxUnixPathDelim + AFileName));
  end;
end;

procedure TdxSpreadSheetXLSXWriterWorkbookBuilder.WritePrintableAreas
  (ANode: TdxXMLNode; AView: TdxSpreadSheetTableView);
begin
  if AView.OptionsPrint.Source.Area.Assigned then
  begin
    WriteDefinedName(ANode.AddChild(sdxXLSXNodeDefinedName),
      sdxXLSXPrintAreaDefinedName,
      dxReferenceToString(AView.OptionsPrint.Source.Area.Rect,
      SpreadSheet.OptionsView.R1C1Reference, [croSheetName], AView.Caption),
      '', AView);
  end;

  if AView.OptionsPrint.Source.RowsToRepeat.Assigned or
    AView.OptionsPrint.Source.ColumnsToRepeat.Assigned then
  begin
    WriteDefinedName(ANode.AddChild(sdxXLSXNodeDefinedName),
      sdxXLSXPrintTitlesDefinedName,
      TdxSpreadSheetPrintAreasHelper.BuildPrintTitlesReference(AView),
      '', AView);
  end;
end;

procedure TdxSpreadSheetXLSXWriterWorkbookBuilder.WriteProperties
  (AWorkbook: TdxXMLNode);
var
  ANode: TdxXMLNode;
begin
  ANode := AWorkbook.AddChild(sdxXLSXNodeWorkbookPr);
  ANode.Attributes.Add(sdxXLSXAttrDate1904,
    SpreadSheet.OptionsView.ActualDateTimeSystem = dts1904);

  if SpreadSheet.OptionsProtection.Protected then
    WriteProtection(AWorkbook.AddChild(sdxXLSXNodeWorkbookProtection));

  ANode := AWorkbook.AddChild(sdxXLSXNodeBookViews)
    .AddChild(sdxXLSXNodeWorkBookView);
  ANode.Attributes.Add(sdxXLSXAttrActiveTab, SpreadSheet.ActiveSheetIndex);
  ANode.Attributes.Add(sdxXLSXAttrShowHorizontalScroll,
    SpreadSheet.OptionsView.HorizontalScrollBar);
  ANode.Attributes.Add(sdxXLSXAttrShowVerticalScroll,
    SpreadSheet.OptionsView.VerticalScrollBar);
  ANode.Attributes.Add(sdxXLSXAttrShowSheetTabs,
    SpreadSheet.PageControl.Visible);
end;

procedure TdxSpreadSheetXLSXWriterWorkbookBuilder.WriteProtection
  (ANode: TdxXMLNode);
var
  AProtection: TdxSpreadSheetStrongProtectionInfo;
begin
  ANode.Attributes.Add(sdxXLSXAttrLockStructure,
    not SpreadSheet.OptionsProtection.AllowChangeStructure);

  if SpreadSheet.OptionsProtection.ProtectionInfo is TdxSpreadSheetStandardProtectionInfo
  then
  begin
    ANode.Attributes.Add(sdxXLSXAttrWorkbookPassword,
      TdxSpreadSheetStandardProtectionInfo
      (SpreadSheet.OptionsProtection.ProtectionInfo).KeyWordAsString);
  end
  else

    if SpreadSheet.OptionsProtection.ProtectionInfo is TdxSpreadSheetStrongProtectionInfo
  then
  begin
    AProtection := TdxSpreadSheetStrongProtectionInfo
      (SpreadSheet.OptionsProtection.ProtectionInfo);
    ANode.Attributes.Add(sdxXLSXAttrWorkbookAlgorithmName,
      dxXLSXHashAlgorithmTypeNames[AProtection.HashAlgorithm]);
    ANode.Attributes.Add(sdxXLSXAttrWorkbookHashValue,
      AProtection.HashValueAsString);
    ANode.Attributes.Add(sdxXLSXAttrWorkbookSaltValue,
      AProtection.SaltValueAsString);
    ANode.Attributes.Add(sdxXLSXAttrWorkbookSpinCount, AProtection.SpinCount);
  end;
end;

procedure TdxSpreadSheetXLSXWriterWorkbookBuilder.WriteSheets(ANode: TdxXMLNode;
  ARels: TdxSpreadSheetXLSXWriterRels);
var
  I: Integer;
begin
...
procedure TdxSpreadSheetXLSXWriterWorkbookBuilder.WriteSheetView(const AFileName
  : AnsiString; AView: TdxSpreadSheetCustomView;
  ARels: TdxSpreadSheetXLSXWriterRels);
var
...
begin
  ...
  begin
    ...
    ExecuteSubTask(TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.Create
      (Owner, ARels, AFileName, ATableView));
    FHasPrintableAreas := FHasPrintableAreas or HasPrintableAreas(ATableView);
  end
  else
    DoError(sdxErrorInternal, ['export of ' + AView.ClassName +
      ' is not supported'], ssmtError);
end;

procedure TdxSpreadSheetXLSXWriterWorkbookBuilder.WriteStyles(const AFileName
  : AnsiString; ARels: TdxSpreadSheetXLSXWriterRels);
begin
  ExecuteSubTask(TdxSpreadSheetXLSXWriterStylesBuilder.Create(Owner, ARels,
    AFileName));
end;
...
begin
  ExecuteSubTask(TdxSpreadSheetXLSXWriterSharedStringsBuilder.Create(Owner,
    ARels, AFileName));
end;

procedure TdxSpreadSheetXLSXWriterWorkbookBuilder.WriteSheet(ANode: TdxXMLNode;
  AView: TdxSpreadSheetCustomView; ARels: TdxSpreadSheetXLSXWriterRels);
var
  AFileName: AnsiString;
begin
  ...
  ANode.Attributes.Add(sdxXLSXAttrRId,
    ARels.GetRelationshipId(dxUnixPathDelim + AFileName));
end;

{ TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder }

constructor TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.Create
  (AOwner: TdxSpreadSheetXLSXWriter; AOwnerRels: TdxSpreadSheetXLSXWriterRels;
  const ATargetFileName: AnsiString; AView: TdxSpreadSheetTableView);
begin
  inherited Create(AOwner, AOwnerRels, ATargetFileName);
...
procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.ExecuteCore
  (AWriter: TdxXmlWriter);
var
  ARels: TdxSpreadSheetXLSXWriterRels;
begin
  ...
  try
    ...
    AWriter.WriteAttributeString(sdxXLSXAttrXMLNS, 'r', '',
      sdxXLSXCommonRelationshipPath);
...
class function TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.
  GetContentRelationship: AnsiString;
begin
  Result := sdxXLSXWorksheetRelationship;
end;

class function TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.GetContentType
  : AnsiString;
begin
  Result := sdxXLSXWorksheetContentType;
end;

procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.
  InitializeContainers;
var
...
function TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.ConvertRowHeight
  (const AValue: Integer): Double;
begin
  Result := TdxValueUnitsHelper.PixelsToPoints(Max(AValue, 1));
end;

function TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.EncodeFloat
  (const AValue: Double): string;
begin
  Result := FloatToStr(AValue, dxInvariantFormatSettings);
end;

function TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.GetActivePane
...
begin
  ...
  begin
    ...
    else if View.FrozenColumn >= 0 then
...
function TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.ValidateDimensions
  (const R: TRect): TRect;
begin
  Result := R;
...
procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.WriteBreaks
  (AWriter: TdxXmlWriter; const ANodeName: string; AList: TList<Cardinal>;
  AMaxIndex: Integer);
var
  I: Integer;
begin
  ...
  try
    ...
    AWriter.WriteAttributeInteger(sdxXLSXAttrBreaksManualBreakCount,
      AList.Count);
...
procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.WriteCell
  (AWriter: TdxXmlWriter; ACell: TdxSpreadSheetCell;
  ARowIndex, AColumnIndex: Integer);
const
  Map: array [TdxSpreadSheetCellDataType] of TdxSpreadSheetXLSXCellType =
    (sxctUnknown, sxctBoolean, sxctError, sxctFloat, sxctFloat, sxctFloat,
    sxctFloat, sxctSharedString, sxctFormula);
var
  ADataType: TdxSpreadSheetXLSXCellType;
begin
  AWriter.WriteStartElement('c');
  try
    AWriter.WriteAttributeString(sdxXLSXAttrCellColumn,
      dxReferenceToString(ARowIndex, AColumnIndex));
    AWriter.WriteAttributeInteger(sdxXLSXAttrStyleIndex,
      Owner.CellStyles.Add(ACell.StyleHandle));

    ADataType := Map[ACell.DataType];
    if ADataType <> sxctUnknown then
    begin
      AWriter.WriteAttributeString(sdxXLSXAttrCellType,
        dxXLSXCellDataTypeNames[ADataType]);
      case ADataType of
        sxctFloat:
          AWriter.WriteElementString(sdxXLSXNodeCellValue,
            EncodeFloat(ACell.AsFloat));
        sxctBoolean:
          AWriter.WriteElementString(sdxXLSXNodeCellValue,
            TdxXMLHelper.EncodeBoolean(ACell.AsBoolean));
        sxctError:
          AWriter.WriteElementString(sdxXLSXNodeCellValue,
            dxSpreadSheetErrorCodeToString(ACell.AsError));
        sxctSharedString:
          AWriter.WriteElementStringEx(sdxXLSXNodeCellValue,
            IntToStr(Owner.SharedStrings.Add(ACell.AsSharedString)));
        sxctFormula:
          begin
            ...
            begin
              AWriter.WriteAttributeString(sdxXLSXAttrCellType,
                sdxXLSXValueArray);
              AWriter.WriteAttributeString(sdxXLSXAttrRef,
                dxReferenceToString(cxRect(ACell.ColumnIndex, ACell.RowIndex,
...
procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.WriteColumns
  (AWriter: TdxXmlWriter; ADimension: TRect);
var
  ANodeStarted: Boolean;

  function CompareColumns(AColumn1, AColumn2
    : TdxSpreadSheetTableColumnAccess): Boolean;
  begin
    Result := (AColumn1 = nil) and (AColumn2 = nil) or (AColumn1 <> nil) and
      (AColumn2 <> nil) and (AColumn1.Style.Handle = AColumn2.Style.Handle) and
      (AColumn1.CustomSize = AColumn2.CustomSize) and
      (AColumn1.Visible = AColumn2.Visible);
  end;

  function GetColumnStyle(AColumn: TdxSpreadSheetTableColumnAccess)
    : TdxSpreadSheetCellStyleHandle;
  begin
    if AColumn <> nil then
  ...
  procedure AddColumnInfo(AColumn: TdxSpreadSheetTableColumnAccess;
    AColumnIndex: Integer; AColumnGroup: TdxSpreadSheetTableItemGroupAccess;
    ACollapsed: Boolean; AFinishIndex: Integer; AForce: Boolean = False);
  begin
    if not AForce and (AColumn = nil) and (AColumnGroup = nil) and not ACollapsed
    then
      Exit;
    ...
    try
      ...
      AWriter.WriteAttributeInteger(sdxXLSXAttrStyle,
        Owner.CellStyles.Add(GetColumnStyle(AColumn)));
      AWriter.WriteAttributeFloat(sdxXLSXAttrWidth,
        Owner.ColumnWidthHelper.PixelsToWidth(GetColumnSize(AColumn)));
      if AColumnGroup <> nil then
        AWriter.WriteAttributeInteger(sdxXLSXAttrOutlineLevel,
          AColumnGroup.Level + 1);
      if ACollapsed then
...
begin
  ...
  ExtendDimensionsByGroups(View.Columns.Groups, ADimension.Left,
    ADimension.Right);
  ...
  APrevColumnGroup := TdxSpreadSheetTableItemGroupAccess
    (View.Columns.Groups.Find(APrevColumnIndex));
  APrevColumn := TdxSpreadSheetTableColumnAccess
    (View.Columns.Items[APrevColumnIndex]);

  for AColumnIndex := ADimension.Left + 1 to ADimension.Right do
  begin
    AColumn := TdxSpreadSheetTableColumnAccess
      (View.Columns.Items[AColumnIndex]);
    AColumnGroup := TdxSpreadSheetTableItemGroupAccess
      (View.Columns.Groups.Find(AColumnIndex));

    if (APrevColumnGroup <> AColumnGroup) or not CompareColumns(AColumn,
      APrevColumn) then
    begin
      AddColumnInfo(APrevColumn, APrevColumnIndex, APrevColumnGroup, ACollapsed,
        AColumnIndex - 1);
      ACollapsed := (APrevColumnGroup <> nil) and
        APrevColumnGroup.IsCollapsedByUser;
  ...
  if Owner.CellStyleDefault <> SpreadSheet.DefaultCellStyle.Handle then
    AddColumnInfo(nil, ADimension.Right + 1, nil, False,
      dxXLSXMaxColumnIndex, True);
...
begin
  ...
  try
    ...
    ExecuteSubTask
      (TdxSpreadSheetXLSXWriterWorksheetTableViewLegacyDrawingBuilder.Create
      (AFileName, ARels, Self));
    ExecuteSubTask(TdxSpreadSheetXLSXWriterWorksheetTableViewCommentsBuilder.
      Create(Self, ARels, Format(sdxXLSXFileTemplateComments,
      [View.Index + 1])));
...
procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.
  WriteConditionalFormatting(AWriter: TdxXmlWriter);
begin
  ExecuteSubTask(TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingBuilder.
    Create(Owner, AWriter, View.ConditionalFormatting));
end;
...
begin
  ...
  try
    ...
    ExecuteSubTask(TdxSpreadSheetXLSXWriterWorksheetContainersBuilder.Create
      (AFileName, ARels, Self));
    AWriter.WriteAttributeString('r', 'id', '',
      ARels.GetRelationshipId(dxUnixPathDelim + AFileName));
  finally
...
begin
  ...
  AWriter.WriteAttributeBoolean(sdxXLSXAttrSummaryBelow,
    View.Rows.Groups.ExpandButtonPosition = gebpGroupFinish);
  AWriter.WriteAttributeBoolean(sdxXLSXAttrSummaryRight,
    View.Columns.Groups.ExpandButtonPosition = gebpGroupFinish);
  AWriter.WriteEndElement;
  if View.OptionsPrint.Page.ScaleMode <> oppsmDefault then
  begin
    AWriter.WriteStartElement(sdxXLSXNodePageSetUpPr);
    AWriter.WriteAttributeBoolean(sdxXLSXAttrFitToPage,
  ...
  if View.OptionsPrint.Pagination.RowPageBreaks.Count > 0 then
    WriteBreaks(AWriter, sdxXLSXNodeRowBreaks,
      View.OptionsPrint.Pagination.RowPageBreaks, View.Dimensions.Bottom);
  if View.OptionsPrint.Pagination.ColumnPageBreaks.Count > 0 then
    WriteBreaks(AWriter, sdxXLSXNodeColBreaks,
      View.OptionsPrint.Pagination.ColumnPageBreaks, View.Dimensions.Right);
...
procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.WriteExtensions
  (AWriter: TdxXmlWriter);
begin
  ExecuteSubTask
    (TdxSpreadSheetXLSXWriterWorksheetConditionalFormattingExBuilder.Create
    (Owner, AWriter, View.ConditionalFormatting));
end;

procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.
  WriteFixedPaneProperties(AWriter: TdxXmlWriter);
var
  AValue: string;
begin
  AWriter.WriteStartElement(sdxXLSXNodePane);
  try
    AWriter.WriteAttributeString(sdxXLSXAttrTopLeftCell,
      dxReferenceToString(TdxSpreadSheetTableViewAccess(View)
      .ViewInfo.FirstScrollableRow, TdxSpreadSheetTableViewAccess(View)
      .ViewInfo.FirstScrollableColumn));
...
begin
  ...
  try
    if AHeaderFooter.AlignWithMargins <> bDefault then
      AWriter.WriteAttributeBoolean(sdxXLSXAttrHeaderFooterAlignWithMargins,
        AHeaderFooter.AlignWithMargins = bTrue);
    if AHeaderFooter.ScaleWithDocument <> bDefault then
      AWriter.WriteAttributeBoolean(sdxXLSXAttrHeaderFooterScaleWithDocument,
        AHeaderFooter.ScaleWithDocument = bTrue);
    if AHeaderFooter.EvenPagesFooter.Assigned or AHeaderFooter.EvenPagesHeader.Assigned
    then
      AWriter.WriteAttributeBoolean
        (sdxXLSXAttrHeaderFooterDifferentOddEven, True);
    if AHeaderFooter.FirstPageFooter.Assigned or AHeaderFooter.FirstPageHeader.Assigned
    then
      AWriter.WriteAttributeBoolean
        (sdxXLSXAttrHeaderFooterDifferentFirst, True);

    WriteHeaderFooterText(AWriter, sdxXLSXNodeOddHeader,
      AHeaderFooter.CommonHeader);
    WriteHeaderFooterText(AWriter, sdxXLSXNodeOddFooter,
      AHeaderFooter.CommonFooter);

    if AHeaderFooter.EvenPagesFooter.Assigned or AHeaderFooter.EvenPagesHeader.Assigned
    then
    begin
      WriteHeaderFooterText(AWriter, sdxXLSXNodeEvenHeader,
        AHeaderFooter.EvenPagesHeader);
      WriteHeaderFooterText(AWriter, sdxXLSXNodeEvenFooter,
    ...
    then
    begin
      WriteHeaderFooterText(AWriter, sdxXLSXNodeFirstHeader,
        AHeaderFooter.FirstPageHeader);
      WriteHeaderFooterText(AWriter, sdxXLSXNodeFirstFooter,
...
procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.
  WriteHeaderFooterText(AWriter: TdxXmlWriter; const ANodeName: string;
  AText: TdxSpreadSheetTableViewOptionsPrintHeaderFooterText);
begin
  AWriter.WriteElementStringEx(ANodeName,
    TdxSpreadSheetHeaderFooterHelper.Build(AText));
end;

procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.WriteHyperlink
  (AWriter: TdxXmlWriter; AHyperlink: TdxSpreadSheetHyperLink;
  ARels: TdxSpreadSheetXLSXWriterRels);
var
...
begin
  ...
  try
    AWriter.WriteAttributeString(sdxXLSXAttrRef,
      dxReferenceToString(AHyperlink.Area));
    ...
    if AHyperlink.ValueType = hvtReference then
      AWriter.WriteAttributeString(sdxXLSXAttrLocation,
        dxSpreadSheetFormulaExcludeEqualSymbol(AHyperlink.Value))
    else
    begin
      ARelsNode := ARels.DoAddRelationship(sdxXLSXHyperlinkRelationship,
        dxStringToXMLString(AHyperlink.Value));
      ARelsNode.Attributes.Add(sdxXLSXAttrTargetMode,
        sdxXLSXValueTargetModeExternal);
      AWriter.WriteAttributeString('r', 'id', '',
        ARelsNode.Attributes.GetValue(sdxXLSXAttrId));
    end;
  finally
    AWriter.WriteEndElement;
  end;
...
begin
  ...
  try
    ...
    begin
      ...
      AWriter.WriteAttributeString(sdxXLSXAttrRef,
        dxReferenceToString(AItem.Area));
      AWriter.WriteEndElement;
...
procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.WritePageSetup
  (AWriter: TdxXmlWriter);
var
...
begin
  ...
  try
    ...
    AWriter.WriteAttributeString(sdxXLSXAttrPageSetupOrientation,
      dxXLSXPrintPageOrientation[APage.Orientation]);
    AWriter.WriteAttributeInteger(sdxXLSXAttrPageSetupFitToHeight,
      APage.FitToHeight);
    AWriter.WriteAttributeInteger(sdxXLSXAttrPageSetupFitToWidth,
      APage.FitToWidth);
    ...
    begin
      AWriter.WriteAttributeInteger(sdxXLSXAttrPageSetupFirstPageNumber,
        APage.FirstPageNumber);
      AWriter.WriteAttributeBoolean
        (sdxXLSXAttrPageSetupUseFirstPageNumber, True);
    end;
    ...
    begin
      if APaper.SizeID > 0 then
        AWriter.WriteAttributeInteger(sdxXLSXAttrPageSetupPaperSize,
          APaper.SizeID)
      else if (APaper.CustomSize.X > 0) and (APaper.CustomSize.Y > 0) then
      begin
        AWriter.WriteAttributeString(sdxXLSXAttrPageSetupPaperWidth,
          FloatToStr(APaper.CustomSize.X, dxInvariantFormatSettings) + 'in');
        AWriter.WriteAttributeString(sdxXLSXAttrPageSetupPaperHeight,
          FloatToStr(APaper.CustomSize.Y, dxInvariantFormatSettings) + 'in');
      end;
    end;

    APrinting := View.OptionsPrint.Printing;
    if APrinting.BlackAndWhite <> bDefault then
      AWriter.WriteAttributeBoolean(sdxXLSXAttrPageSetupBlackAndWhite,
        APrinting.BlackAndWhite = bTrue);
    if APrinting.Draft <> bDefault then
      AWriter.WriteAttributeBoolean(sdxXLSXAttrPageSetupDraft,
        APrinting.Draft = bTrue);
    if APrinting.Copies > 0 then
      AWriter.WriteAttributeInteger(sdxXLSXAttrPageSetupCopies,
        Min(APrinting.Copies, MAXSHORT));
    if APrinting.PageOrder <> opppDefault then
      AWriter.WriteAttributeString(sdxXLSXAttrPageSetupPageOrder,
        dxXLSXPrintPageOrder[APrinting.PageOrder]);
    if View.OptionsPrint.Source.ErrorIndication <> pseiDefault then
      AWriter.WriteAttributeString(sdxXLSXAttrPageSetupErrors,
        dxXLSXPrintErrorIndication[View.OptionsPrint.Source.ErrorIndication]);
    AWriter.WriteAttributeString(sdxXLSXAttrPageSetupCellComments,
      dxXLSXPrintCellComments[View.OptionsPrint.Source.CellComments]);
  finally
    AWriter.WriteEndElement;
  end;
end;

procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.WritePrintOptions
  (AWriter: TdxXmlWriter);

  function ArePrintOptionsAssigned: Boolean;
  begin
    Result := (View.OptionsPrint.Source.Headers <> bDefault) or
  ...
  begin
    ...
    try
      if View.OptionsPrint.Printing.HorizontalCentered <> bDefault then
        AWriter.WriteAttributeBoolean(sdxXLSXAttrPrintOptionsHorzCenter,
          View.OptionsPrint.Printing.HorizontalCentered = bTrue);
      if View.OptionsPrint.Printing.VerticalCentered <> bDefault then
        AWriter.WriteAttributeBoolean(sdxXLSXAttrPrintOptionsVertCenter,
          View.OptionsPrint.Printing.VerticalCentered = bTrue);
      if View.OptionsPrint.Source.Headers <> bDefault then
        AWriter.WriteAttributeBoolean(sdxXLSXAttrPrintOptionsHeadings,
          View.OptionsPrint.Source.Headers = bTrue);
      if View.OptionsPrint.Source.GridLines <> bDefault then
      begin
        AWriter.WriteAttributeBoolean(sdxXLSXAttrPrintOptionsGridLines,
          View.OptionsPrint.Source.GridLines = bTrue);
        AWriter.WriteAttributeBoolean
          (sdxXLSXAttrPrintOptionsGridLinesSet, True);
      end;
    finally
      AWriter.WriteEndElement;
    end;
...
procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.WriteProperties
  (AWriter: TdxXmlWriter);
begin
  AWriter.WriteStartElement(sdxXLSXNodeSheetFormatPr);
  try
    AWriter.WriteAttributeFloat(sdxXLSXAttrDefaultColumnWidth,
      Owner.ColumnWidthHelper.PixelsToWidth(View.Columns.DefaultSize));
    AWriter.WriteAttributeBoolean(sdxXLSXAttrCustomHeight, True);
    AWriter.WriteAttributeFloat(sdxXLSXAttrDefaultRowHeight,
      ConvertRowHeight(View.Rows.DefaultSize));
  finally
    AWriter.WriteEndElement;
  end;
end;

procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.WriteRows
  (AWriter: TdxXmlWriter; ADimension: TRect);
var
  ...
  try
    ...
    try
      ...
      begin
        ...
        AGroup := TdxSpreadSheetTableItemGroupAccess
          (View.Rows.Groups.Find(ARowIndex));
          ...
          begin
            ...
            begin
              if ARow.IsCustomSize then
                AWriter.WriteAttributeBoolean(sdxXLSXAttrCustomHeight, True);
              AWriter.WriteAttributeFloat(sdxXLSXAttrRowHeight,
                ConvertRowHeight(ARow.CustomSize));
            end;
            ...
            begin
              ...
              AWriter.WriteAttributeInteger(sdxXLSXAttrStyleIndex,
                Owner.CellStyles.Add(ARow.Style.Handle));
            end;

            ACell := ARow.RowCells.First;
            while ACell <> nil do
            begin
              WriteCell(AWriter, TdxSpreadSheetCell(ACell), ARowIndex,
                ACell.Index);
...
procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.WriteSelection
  ...
  begin
    ...
    for I := 0 to ASelection.Count - 1 do
      Result.Add(dxReferenceToString(ValidateDimensions(ASelection.Items
        [I].Rect)));
  end;
...
begin
  ...
  try
    ...
    if InRange(ASelection.FocusedRow, 0, dxXLSXMaxRowIndex) and
      InRange(ASelection.FocusedColumn, 0, dxXLSXMaxColumnIndex) then
      AWriter.WriteAttributeString(sdxXLSXAttrActiveCell,
        dxReferenceToString(ASelection.FocusedRow, ASelection.FocusedColumn));
  finally
    AWriter.WriteEndElement;
  end;
end;

procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.WriteViewProperties
  (AWriter: TdxXmlWriter);
var
  AZoomFactor: Integer;
begin
  ...
  AZoomFactor := Max(Min(View.Options.ZoomFactor, MaxZoomFactor),
    MinZoomFactor);
  ...
  AWriter.WriteAttributeBoolean(sdxXLSXAttrZeroValues,
    View.Options.ActualZeroValues);
  AWriter.WriteAttributeBoolean(sdxXLSXAttrShowFormulas,
    View.Options.ActualShowFormulas);
  AWriter.WriteAttributeBoolean(sdxXLSXAttrGridLines,
    View.Options.ActualGridLines);
  AWriter.WriteAttributeBoolean(sdxXLSXAttrShowRowColHeaders,
    View.Options.ActualHeaders);
...
procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.WriteViewProtection
  (AWriter: TdxXmlWriter);
var
  AProtection: TdxSpreadSheetStrongProtectionInfo;
begin
  ...
  try
    AWriter.WriteAttributeBoolean(sdxXLSXAttrSheet,
      View.OptionsProtection.Protected);
    AWriter.WriteAttributeBoolean(sdxXLSXAttrDeleteColumns,
      not View.OptionsProtection.AllowDeleteColumns);
    AWriter.WriteAttributeBoolean(sdxXLSXAttrDeleteRows,
      not View.OptionsProtection.AllowDeleteRows);
    AWriter.WriteAttributeBoolean(sdxXLSXAttrFormatCells,
      not View.OptionsProtection.AllowFormatCells);
    AWriter.WriteAttributeBoolean(sdxXLSXAttrFormatColumns,
      not View.OptionsProtection.AllowResizeColumns);
    AWriter.WriteAttributeBoolean(sdxXLSXAttrFormatRows,
      not View.OptionsProtection.AllowResizeRows);
    AWriter.WriteAttributeBoolean(sdxXLSXAttrInsertColumns,
      not View.OptionsProtection.AllowInsertColumns);
    AWriter.WriteAttributeBoolean(sdxXLSXAttrInsertRows,
      not View.OptionsProtection.AllowInsertRows);
    AWriter.WriteAttributeBoolean(sdxXLSXAttrInsertHyperlinks,
      not View.OptionsProtection.AllowEditHyperlinks);
    AWriter.WriteAttributeBoolean(sdxXLSXAttrObjects,
      not View.OptionsProtection.AllowEditContainers);
    AWriter.WriteAttributeBoolean(sdxXLSXAttrSelectLockedCells,
      not View.OptionsProtection.AllowSelectLockedCells);
    AWriter.WriteAttributeBoolean(sdxXLSXAttrSelectUnlockedCell,
      not View.OptionsProtection.AllowSelectUnlockedCells);
    AWriter.WriteAttributeBoolean(sdxXLSXAttrSort,
      not View.OptionsProtection.AllowSort);

    if View.OptionsProtection.ProtectionInfo is TdxSpreadSheetStandardProtectionInfo
    then
      AWriter.WriteAttributeString(sdxXLSXAttrPassword,
        TdxSpreadSheetStandardProtectionInfo
        (View.OptionsProtection.ProtectionInfo).KeyWordAsString)
    else

      if View.OptionsProtection.ProtectionInfo is TdxSpreadSheetStrongProtectionInfo
    then
    begin
      AProtection := TdxSpreadSheetStrongProtectionInfo
        (View.OptionsProtection.ProtectionInfo);
      AWriter.WriteAttributeString(sdxXLSXAttrAlgorithmName,
        dxXLSXHashAlgorithmTypeNames[AProtection.HashAlgorithm]);
      AWriter.WriteAttributeString(sdxXLSXAttrHashValue,
        AProtection.HashValueAsString);
      AWriter.WriteAttributeString(sdxXLSXAttrSaltValue,
        AProtection.SaltValueAsString);
      AWriter.WriteAttributeInteger(sdxXLSXAttrSpinCount,
        AProtection.SpinCount);
    end;
  finally
    AWriter.WriteEndElement;
  end;
...
procedure TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder.
  ExtendDimensionsByGroups(AGroups: TdxSpreadSheetTableItemGroups;
  var AStartIndex, AFinishIndex: Integer);
begin
...
constructor TdxSpreadSheetXLSXWriterWorksheetTableViewSubFileBuilder.Create
  (const ATargetFileName: AnsiString; AOwnerRels: TdxSpreadSheetXLSXWriterRels;
  AOwnerWriter: TdxSpreadSheetXLSXWriterWorksheetTableViewBuilder);
begin
