...
type
  ...
  TdxNativeReadOnlyParagraphCollection = class
    (TdxIUnknownList<IdxRichEditParagraph>,
    IdxRichEditReadOnlyParagraphCollection)
  strict private
    function GetCount: Integer;
  protected
    function CreateCollection: TdxNativeReadOnlyParagraphCollection; virtual;
    function Contains(const ARange: IdxRichEditDocumentRange;
      const AParagraph: IdxRichEditParagraph): Boolean;
  public
    function Get(const APos: IdxRichEditDocumentPosition): IdxRichEditParagraph;
      overload; virtual;
    function Get(const ARange: IdxRichEditDocumentRange)
      : IdxRichEditReadOnlyParagraphCollection; overload; virtual;
  end;
  ...
  public
    ...
    function Get(const APos: IdxRichEditDocumentPosition): IdxRichEditParagraph;
      overload; override;
    function Get(const ARange: IdxRichEditDocumentRange)
      : IdxRichEditReadOnlyParagraphCollection; overload; override;
  ...
  TdxNativeAbstractNumberingListBase = class abstract(TInterfacedObject,
  ...
  strict private
    ...
    function GetDocumentModel: TdxDocumentModel;
    function IdxRichEditNumberingListBase.GetLevels =
      GetNumberingListBaseLevels;
    function GetNumberingListBaseLevels
      : IdxReadOnlyListLevelCollection<IdxRichEditListLevel>;
  protected
    function GetInnerAbstractNumberingList: TdxAbstractNumberingList;
      virtual; abstract;
    ...
    property DocumentModel: TdxDocumentModel read GetDocumentModel;
    property InnerAbstractNumberingList: TdxAbstractNumberingList
      read GetInnerAbstractNumberingList;
  public
  ...
  TdxNativeNumberingList = class(TdxNativeAbstractNumberingListBase,
  ...
  strict private
    ...
    function GetNumberingListLevels
      : IdxRichEditListLevelCollection<IdxRichEditOverrideListLevel>;
  protected
  ...
  TdxNativeNumberedListCollectionBase<T: IInterface; TModelList: class> = class
    abstract(TInterfacedObject, IdxReadOnlyList<T>)
  strict private
  ...
  protected
    ...
    function GetModelListId(const AList: TModelList): Integer; virtual;
      abstract;
    function GetModelListIndex(const AList: TModelList): Integer;
      virtual; abstract;
  ...
  TdxNativeNumberingListCollection = class
    (TdxNativeNumberedListCollectionBase<IdxRichEditNumberingList,
    TdxNumberingList>, IdxRichEditNumberingListCollection)
  strict private
  ...
  protected
    ...
    function CreateList(AModelListIndex: Integer)
      : IdxRichEditNumberingList; override;
    function CreateModelList: TdxNumberingList; override;
    function GetModelList(const AList: IdxRichEditNumberingList)
      : TdxNumberingList; override;
    function GetModelListId(const AList: TdxNumberingList): Integer; override;
    function GetModelListIndex(const AList: TdxNumberingList): Integer;
      override;
  ...
  protected
    ...
    property InnerListLevelCollection: TdxListLevelCollection
      read GetInnerListLevelCollection;
  public
    constructor Create(ADocument: TdxNativeDocument;
  ...
  TdxNativeAbstractNumberingListCollection = class
    (TdxNativeNumberedListCollectionBase<IdxRichEditAbstractNumberingList,
    TdxAbstractNumberingList>, IdxRichEditAbstractNumberingListCollection)
  strict private
  ...
  protected
    ...
    function CreateList(AModelListIndex: Integer)
      : IdxRichEditAbstractNumberingList; override;
    function CreateModelList: TdxAbstractNumberingList; override;
    function GetModelList(const AList: IdxRichEditAbstractNumberingList)
      : TdxAbstractNumberingList; override;
    function GetModelListId(const AList: TdxAbstractNumberingList)
      : Integer; override;
    function GetModelListIndex(const AList: TdxAbstractNumberingList)
      : Integer; override;
    ...
    property InnerModelLists: TdxAbstractNumberingListCollection
      read GetInnerModelLists;
  public
    constructor Create(ADocument: TdxNativeDocument); override;
  ...
  TdxNativeAbstractNumberingList = class(TdxNativeAbstractNumberingListBase,
  ...
  TdxNativeTemplateAbstractNumberingList = class
    (TdxNativeAbstractNumberingListBase,
    IdxRichEditTemplateAbstractNumberingList)
  strict private
  ...
  protected
    ...
    property TemplatesList: TdxAbstractNumberingListCollection
      read GetTemplatesList;
  public
    constructor Create(ADocument: TdxNativeDocument;
      AType: TdxRichEditNumberingType);
...
type
  ...
  TdxNativeReadOnlyListLevelCollection = class(TInterfacedObject,
    IdxReadOnlyListLevelCollection<IdxRichEditListLevel>)
  strict private
  ...
  TdxNativeListLevel = class(TInterfacedObject, IdxRichEditListLevel,
  ...
  public
    constructor Create(ADocument: TdxNativeDocument;
      const AListLevel: IdxListLevel); virtual;
  ...
  TdxNativeOverrideListLevel = class(TdxNativeListLevel,
    IdxRichEditOverrideListLevel, IdxRichEditListLevel,
    IdxRichEditListLevelProperties)
  strict private
  ...
  public
    constructor Create(ADocument: TdxNativeDocument;
      const AListLevel: IdxListLevel); override;
...
constructor TdxNativeParagraph.Create(ADocument: TdxNativeSubDocument;
  AInnerParagraph: TdxParagraph);
begin
  inherited Create;
  FDocument := ADocument;
...
procedure TdxNativeParagraph.SetAlignment(const Value
...
procedure TdxNativeParagraph.SetLineSpacingRule(const Value
...
function TdxNativeParagraph.GetFirstLineIndentType
  : TdxRichEditParagraphFirstLineIndent;
begin
  CheckValid;
...
procedure TdxNativeParagraph.SetFirstLineIndentType
...
begin
  CheckValid;
  Result := TdxNativeStyleCollections.GetStyle
    (Document.MainDocument.ParagraphStyles, InnerParagraph.ParagraphStyle);
end;
...
begin
  ...
  if Value <> nil then
    ...
    AStyle := nil;
  InnerParagraph.ParagraphStyleIndex :=
    DocumentModel.ParagraphStyles.IndexOf(AStyle);
end;
...
begin
  if not FIsValid then
    TdxRichEditExceptions.ThrowInvalidOperationException
      (cxGetResourceString(@sdxRichEditExceptionUseDeletedParagraphError));
end;
...
begin
  AStart := TdxDocumentModelPosition.FromParagraphStart(PieceTable,
    InnerParagraph.Index);
  AEnd := TdxDocumentModelPosition.FromParagraphEnd(PieceTable,
    InnerParagraph.Index);
...
function TdxNativeParagraph.BeginUpdateTabs(AOnlyOwnTabs: Boolean)
  : IdxRichEditTabInfoCollection;
var
...
procedure TdxNativeParagraph.EndUpdateTabs(const ATabs
  : IdxRichEditTabInfoCollection);
var
...
begin
  ...
  try
    AModelParagraph := FInnerParagraph;
    AModelParagraph.PieceTable.ApplyListLevelIndexToParagraph
      (AModelParagraph, Value);
  finally
...
function TdxNativeReadOnlyParagraphCollection.Get
...
function TdxNativeReadOnlyParagraphCollection.Get(const ARange
  : IdxRichEditDocumentRange): IdxRichEditReadOnlyParagraphCollection;
var
...
function TdxNativeReadOnlyParagraphCollection.CreateCollection
  : TdxNativeReadOnlyParagraphCollection;
begin
...
constructor TdxNativeParagraphCollection.Create
...
function TdxNativeParagraphCollection.Insert(const APos
...
function TdxNativeParagraphCollection.Insert(const APos
  : IdxRichEditDocumentPosition; const AInsertOptions: TdxRichEditInsertOptions)
  : IdxRichEditParagraph;
var
...
begin
  ...
  ALogPosition := FDocument.NormalizeLogPosition
    (ANativePosition.Position.LogPosition);
...
function TdxNativeParagraphCollection.Get(const APos
  : IdxRichEditDocumentPosition): IdxRichEditParagraph;
var
  AParagraphIndex: TdxParagraphIndex;
begin
...
function TdxNativeParagraphCollection.Get(const ARange
  : IdxRichEditDocumentRange): IdxRichEditReadOnlyParagraphCollection;
var
...
procedure TdxNativeParagraphCollection.AddParagraphToList(const AParagraph
...
begin
  AddParagraphsToList(AParagraph.Range, FDocument.MainDocument.NumberingLists
    [ANumberingListIndex], ALevelIndex);
end;

procedure TdxNativeParagraphCollection.AddParagraphsToList
  (const ARange: IdxRichEditDocumentRange;
  const AList: IdxRichEditNumberingList; ALevelIndex: Integer);
var
...
begin
  ...
  try
    ...
    AIndex := TdxNativeNumberingListCollection
      (FDocument.MainDocument.NumberingLists).InnerLists.IndexOf
      (AInnerNumberingList);
    if AIndex < 0 then
      TdxRichEditExceptions.ThrowInvalidOperationException
        (cxGetResourceString
    ...
    begin
      ...
      if AModelParagraph.IsInList then
        AModelParagraph.PieceTable.RemoveNumberingFromParagraph
          (AModelParagraph);
      PieceTable.AddNumberingListToParagraph(AModelParagraph,
        ANumberingListIndex, ALevelIndex);
    end;
  finally
...
procedure TdxNativeParagraphCollection.RemoveNumberingFromParagraph
  (const AParagraph: IdxRichEditParagraph);
begin
  RemoveNumberingFromParagraphs(AParagraph.Range);
end;

procedure TdxNativeParagraphCollection.RemoveNumberingFromParagraphs
  (const ARange: IdxRichEditDocumentRange);
var
...
constructor TdxNativeAbstractNumberingListBase.Create
...
function TdxNativeAbstractNumberingListBase.GetNumberingListBaseLevels
  : IdxReadOnlyListLevelCollection<IdxRichEditListLevel>;
begin
  if FLevels = nil then
    FLevels := TdxNativeReadOnlyListLevelCollection.Create(Document,
      InnerAbstractNumberingList);
  Result := FLevels;
end;

function TdxNativeAbstractNumberingListBase.GetNumberingType
...
procedure TdxNativeAbstractNumberingListBase.SetNumberingType
  (const Value: TdxRichEditNumberingType);
begin
...
constructor TdxNativeNumberingList.Create(ADocument: TdxNativeDocument;
  ANumberingListIndex: TdxNumberingListIndex);
begin
  Create(ADocument, ADocument.DocumentModel.NumberingLists
    [ANumberingListIndex]);
end;
...
function TdxNativeNumberingList.GetInnerAbstractNumberingList
...
procedure TdxNativeNumberingList.SetNumberingType
  (const Value: TdxRichEditNumberingType);
begin
  if NumberingType = Value then
    Exit;
...
function TdxNativeNumberingList.GetAbstractNumberingList
  : IdxRichEditAbstractNumberingList;
begin
...
begin
  Result := DocumentModel.AbstractNumberingLists.IndexOf
    (InnerAbstractNumberingList);
end;
...
function TdxNativeNumberingList.GetNumberingListLevels
  : IdxRichEditListLevelCollection<IdxRichEditOverrideListLevel>;
begin
  if FOverrideLevels = nil then
    FOverrideLevels := TdxNativeOverrideListLevelCollection.Create(Document,
      FInnerNumberingList);
...
constructor TdxNativeNumberedListCollectionBase<T, TModelList>.Create
  (ADocument: TdxNativeDocument);
begin
  inherited Create;
  FDocument := ADocument;
...
function TdxNativeNumberedListCollectionBase<T, TModelList>.GetDocumentModel
  : TdxDocumentModel;
begin
...
procedure TdxNativeNumberedListCollectionBase<T, TModelList>.Add
  (const AList: T);
var
  AInnerList: TModelList;
begin
...
function TdxNativeNumberedListCollectionBase<T, TModelList>.GetList
  (AHashID: Integer; AIndex: Integer): T;
begin
  Result := Default (T);
  if AIndex < 0 then
    Exit;
...
procedure TdxNativeNumberingListCollection.AddCore(const AInnerList
  : TdxNumberingList);
begin
...
function TdxNativeNumberingListCollection.GetInnerLists
  : TdxList<TdxNumberingList>;
begin
  Result := DocumentModel.NumberingLists;
end;

function TdxNativeNumberingListCollection.CreateList(AModelListIndex: Integer)
  : IdxRichEditNumberingList;
begin
...
function TdxNativeNumberingListCollection.GetModelList
  (const AList: IdxRichEditNumberingList): TdxNumberingList;
begin
  Result := TdxNativeNumberingList(AList).InnerNumberingList;
end;

function TdxNativeNumberingListCollection.GetModelListId
  (const AList: TdxNumberingList): Integer;
begin
  Result := AList.Id;
end;

function TdxNativeNumberingListCollection.GetModelListIndex
  (const AList: TdxNumberingList): Integer;
begin
  Result := InnerLists.IndexOf(AList);
end;

function TdxNativeNumberingListCollection.Add(AAbstractNumberingListIndex
  : Integer): IdxRichEditNumberingList;
begin
  FLastIndex := AAbstractNumberingListIndex;
  Result := inherited Add;
end;

procedure TdxNativeNumberingListCollection.Add(const AList
  : IdxRichEditNumberingList);
begin
  FLastIndex := -1;
  inherited Add(AList);
...
function TdxNativeNumberingListCollection.CreateNew(AAbstractNumberingListIndex
  : Integer): IdxRichEditNumberingList;
begin
  FLastIndex := AAbstractNumberingListIndex;
...
function TdxNativeReadOnlyListLevelCollection.GetInnerListLevelCollection
  : TdxListLevelCollection;
begin
  Result := FAbstractNumberingList.Levels;
end;

function TdxNativeReadOnlyListLevelCollection.GetItem(Index: Integer)
  : IdxRichEditListLevel;
begin
  Result := nil;
  Result := TdxNativeListLevel.Create(Document,
    InnerListLevelCollection[Index]);
end;
...
procedure TdxNativeOverrideListLevelCollection.Add(const ALevel
  : IdxRichEditOverrideListLevel);
begin
  InnerListLevelCollection.Add
    (TdxAbstractListLevel(TdxNativeOverrideListLevel(ALevel).InnerListLevel));
end;
...
begin
  Result := CreateNew;
  InnerListLevelCollection.Add
    (TdxAbstractListLevel(TdxNativeOverrideListLevel(Result).InnerListLevel));
end;

function TdxNativeOverrideListLevelCollection.CreateNew
  : IdxRichEditOverrideListLevel;
var
...
function TdxNativeOverrideListLevelCollection.GetInnerListLevelCollection
  : TdxListLevelCollection;
begin
  Result := FInnerNumberingList.Levels;
end;

function TdxNativeOverrideListLevelCollection.GetItem(Index: Integer)
  : IdxRichEditOverrideListLevel;
begin
  Result := nil;
  Result := TdxNativeOverrideListLevel.Create(Document,
    FInnerNumberingList.Levels[index]);
end;
...
function TdxNativeListLevel.GetParagraphProperties
  : IdxRichEditParagraphPropertiesBase;
begin
  if FParagraphProperties = nil then
    FParagraphProperties :=
      TdxNativeProperties.GetNativeSimpleParagraphProperties(FDocument,
      InnerListLevel.ParagraphProperties);
...
begin
  Result := TdxNativeStyleCollections.GetStyle
    (FDocument.MainDocument.ParagraphStyles, InnerListLevel.ParagraphStyle);
end;
...
procedure TdxNativeListLevel.SetConvertPreviousLevelNumberingToDecimal
  (const Value: Boolean);
begin
  InnerListLevel.ListLevelProperties.
    ConvertPreviousLevelNumberingToDecimal := Value;
end;
...
procedure TdxNativeListLevel.SetNumberingFormat(const Value
...
procedure TdxNativeListLevel.SetParagraphStyle(const Value
...
begin
  if Value = nil then
    ...
    AStyle := TdxNativeStyleCollections.GetInnerStyle(Value);
  TdxListLevel(InnerListLevel).ParagraphStyleIndex :=
    FDocument.DocumentModel.ParagraphStyles.IndexOf(AStyle);
end;
...
constructor TdxNativeOverrideListLevel.Create(ADocument: TdxNativeDocument;
  const AListLevel: IdxListLevel);
begin
...
procedure TdxNativeAbstractNumberingListCollection.AddCore(const AInnerList
  : TdxAbstractNumberingList);
begin
...
function TdxNativeAbstractNumberingListCollection.CreateList(AModelListIndex
  : Integer): IdxRichEditAbstractNumberingList;
begin
  Result := TdxNativeAbstractNumberingList.Create(Document, AModelListIndex);
end;

function TdxNativeAbstractNumberingListCollection.CreateModelList
  : TdxAbstractNumberingList;
begin
...
function TdxNativeAbstractNumberingListCollection.GetBulletedListTemplate
  : IdxRichEditTemplateAbstractNumberingList;
begin
  if FBulletedListTemplate = nil then
    FBulletedListTemplate := TdxNativeTemplateAbstractNumberingList.Create
      (Document, TdxRichEditNumberingType.Bullet);
...
function TdxNativeAbstractNumberingListCollection.GetInnerLists
  : TdxList<TdxAbstractNumberingList>;
begin
  Result := DocumentModel.AbstractNumberingLists;
end;

function TdxNativeAbstractNumberingListCollection.GetInnerModelLists
...
function TdxNativeAbstractNumberingListCollection.GetMultiLevelListTemplate
  : IdxRichEditTemplateAbstractNumberingList;
begin
  if FMultiLevelListTemplate = nil then
    FMultiLevelListTemplate := TdxNativeTemplateAbstractNumberingList.Create
      (Document, TdxRichEditNumberingType.MultiLevel);
  Result := FMultiLevelListTemplate;
end;

function TdxNativeAbstractNumberingListCollection.GetNumberedListTemplate
  : IdxRichEditTemplateAbstractNumberingList;
begin
  if FNumberedListTemplate = nil then
    FNumberedListTemplate := TdxNativeTemplateAbstractNumberingList.Create
      (Document, TdxRichEditNumberingType.Simple);
  Result := FNumberedListTemplate;
end;

{ TdxNativeAbstractNumberingList }

constructor TdxNativeAbstractNumberingList.Create(ADocument: TdxNativeDocument;
  AListIndex: TdxAbstractNumberingListIndex);
begin
  inherited Create(ADocument);
  Assert(AListIndex >= 0);
...
function TdxNativeAbstractNumberingList.GetInnerAbstractNumberingList
  : TdxAbstractNumberingList;
begin
...
constructor TdxNativeTemplateAbstractNumberingList.Create
  (ADocument: TdxNativeDocument; AType: TdxNumberingType);
begin
  inherited Create(ADocument);
  FType := AType;
end;

function TdxNativeTemplateAbstractNumberingList.GetTemplatesList
  : TdxAbstractNumberingListCollection;
begin
  Result := Document.DocumentServer.DocumentModelTemplate.
    AbstractNumberingLists;
end;

function TdxNativeTemplateAbstractNumberingList.GetInnerAbstractNumberingList
  : TdxAbstractNumberingList;
begin
  Result := TdxNumberingListHelper.GetAbstractListByType(TemplatesList, FType);
end;

function TdxNativeTemplateAbstractNumberingList.CreateNew
  : IdxRichEditAbstractNumberingList;
var
  ...
  AListIndex: TdxAbstractNumberingListIndex;
begin
  ATemplateList := TemplatesList
    [TdxNumberingListHelper.GetAbstractListIndexByType(TemplatesList, FType)];
  ACalc := TdxNumberingListIndexCalculator.Create(DocumentModel,
    TdxNumberingListHelper.GetListType(ATemplateList));
  try
