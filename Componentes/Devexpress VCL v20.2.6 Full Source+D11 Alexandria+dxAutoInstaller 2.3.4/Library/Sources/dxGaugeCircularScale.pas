...
uses
  Windows, Classes, Graphics, cxGeometry, dxCoreGraphics, cxGraphics, dxCore,
  dxXMLDoc, dxGDIPlusClasses,
...
type
  ...
  TdxGaugeArcQuantitativeScaleParameterValues = set of
    TdxGaugeArcQuantitativeScaleParameterValue;
  TdxGaugeCircularScaleLabelOrientation = (loLeftToRight, loCircular,
    loCircularInward, loCircularOutward, loRadial);

  { TdxGaugeArcQuantitativeScaleDefaultParameters }

  TdxGaugeArcQuantitativeScaleDefaultParameters = class
  ...
  TdxGaugeCircularWideScaleDefaultParameters = class
    (TdxGaugeArcQuantitativeScaleDefaultParameters)
  public
  ...
  TdxGaugeArcQuantitativeScaleParameters = class
  ...
  published
    ...
    property RadiusFactor: Single read GetRadiusFactor write SetRadiusFactor
      stored False;
  end;
  ...
  private
    ...
    procedure SetLabelOrientation(const AValue
  ...
  published
    ...
    property AngleEnd: Integer read GetAngleEnd write SetAngleEnd
      stored IsAngleEndStored;
    property AngleStart: Integer read GetAngleStart write SetAngleStart
      stored IsAngleStartStored;
    property LabelOrientation: TdxGaugeCircularScaleLabelOrientation
      read GetLabelOrientation write SetLabelOrientation default loLeftToRight;
    property ShowNeedle: Boolean read GetShowValueIndicator
      write SetShowValueIndicator default True;
    property ShowSpindleCap: Boolean read GetShowSpindleCap
      write SetShowSpindleCap default True;
  end;

  { TdxGaugeArcQuantitativeScaleViewInfo }

  TdxGaugeArcQuantitativeScaleViewInfo = class
  ...
  protected
    ...
    function GetLabelTextRect(AAngle: Single; const AText: string)
      : TdxRectF; override;
  ...
  protected
    ...
    property OptionsView: TdxGaugeArcQuantitativeScaleOptionsView
  ...
  protected
    ...
    property OptionsLayout: TdxGaugeScaleOptionsArcLayout read GetOptionsLayout
      write SetOptionsLayout;
  end;

  { TdxGaugeCustomCircularScaleViewInfo }

  TdxGaugeCustomCircularScaleViewInfo = class
    (TdxGaugeArcQuantitativeScaleViewInfo)
  protected
  ...
  TdxGaugeCustomCircularQuarterLeftScale = class
    (TdxGaugeCustomCircularHalfScale)
  protected
    class function GetScaleName: string; override;
    class function GetScaleType: TdxGaugeScaleType; override;
  ...
  TdxGaugeCustomCircularQuarterRightScaleViewInfo = class
    (TdxGaugeArcQuantitativeScaleViewInfo)
  protected
  ...
  TdxGaugeCustomCircularQuarterRightScale = class
    (TdxGaugeCustomCircularHalfScale)
  protected
    class function GetScaleName: string; override;
    class function GetScaleType: TdxGaugeScaleType; override;
  ...
  TdxGaugeCustomCircularThreeFourthScaleViewInfo = class
    (TdxGaugeArcQuantitativeScaleViewInfo)
  protected
  ...
  TdxGaugeCustomCircularWideScaleViewInfo = class
    (TdxGaugeArcQuantitativeScaleViewInfo)
  private
  ...
  TdxGaugeArcQuantitativeScaleStyleReader = class
    (TdxGaugeQuantitativeScaleStyleReader)
  private
    procedure ReadSpindleCapParameters(ANode: TdxXMLNode;
  ...
  TdxGaugeCustomCircularHalfScaleStyleReader = class
    (TdxGaugeArcQuantitativeScaleStyleReader)
  protected
    class function GetResourceNamePrefix: string; override;
  end;
  ...
  TdxGaugeCircularWideScaleStyleReader = class
    (TdxGaugeArcQuantitativeScaleStyleReader)
  protected
    class function GetResourceNamePrefix: string; override;
  ...
  TdxGaugeCircularWideScaleRangeViewInfo = class
    (TdxGaugeCustomCircularScaleRangeViewInfo)
  protected
...
type
  TdxGaugeCustomCircularScaleRangeAccess = class
    (TdxGaugeCustomCircularScaleRange);
  TdxGaugeCustomCircularScaleRangeViewInfoAccess = class
    (TdxGaugeCustomCircularScaleRangeViewInfo);
  TdxGaugeScaleStyleAccess = class(TdxGaugeScaleStyle);

function dxGaugeArcScaleValueToAngle(AValue, AMinValue, AValueRange,
  AAngleStart, AAngleRange: Single): Single;
begin
  Result := AAngleStart - (AValue - AMinValue) * AAngleRange / AValueRange;
end;

function dxGaugeGetSectorRect(const ARect: TdxRectF; ASectorWidth: Single;
  AStartAngle, ASweepAngle: Single): TdxRectF;
  ...
  begin
    APath.FigureStart;
    R := cxRectContent(ARect, dxRectF(ASectorWidth, ASectorWidth, ASectorWidth,
      ASectorWidth));
    if (ASectorWidth < ARect.Width / 2) and (R.Width > 0) and (R.Height > 0)
    then
    begin
      APath.AddArc(R.Left, R.Top, R.Width, R.Height, -AStartAngle,
        -ASweepAngle);
      APath.AddArc(ARect.Left, ARect.Top, ARect.Width, ARect.Height,
        -AStartAngle - ASweepAngle, ASweepAngle);
    end
    else
      APath.AddPie(ARect.Left, ARect.Top, ARect.Width, ARect.Height,
        -AStartAngle, -ASweepAngle);
    APath.FigureFinish;
  end;
...
function TdxGaugeScaleOptionsArcLayout.GetScale
  : TdxGaugeCustomArcQuantitativeScale;
begin
...
function TdxGaugeArcQuantitativeScaleOptionsView.GetLabelOrientation
  : TdxGaugeCircularScaleLabelOrientation;
begin
...
procedure TdxGaugeArcQuantitativeScaleOptionsView.SetAngleEnd
  (const AValue: Integer);
begin
  GetScale.SetAngleEnd(AValue);
end;

procedure TdxGaugeArcQuantitativeScaleOptionsView.SetAngleStart
  (const AValue: Integer);
begin
  GetScale.SetAngleStart(AValue);
end;

procedure TdxGaugeArcQuantitativeScaleOptionsView.SetLabelOrientation
  (const AValue: TdxGaugeCircularScaleLabelOrientation);
begin
  GetScale.SetLabelOrientation(AValue);
end;

procedure TdxGaugeArcQuantitativeScaleOptionsView.SetShowSpindleCap
...
function TdxGaugeArcQuantitativeScaleOptionsView.GetScale
  : TdxGaugeCustomArcQuantitativeScale;
begin
  Result := inherited GetScale as TdxGaugeCustomArcQuantitativeScale;
end;
...
constructor TdxGaugeArcQuantitativeScaleViewInfo.Create
...
function TdxGaugeArcQuantitativeScaleViewInfo.GetScaleInfoClass
  : TdxGaugeCustomScaleInfoClass;
begin
  Result := TdxGaugeArcScaleInfo;
end;

function TdxGaugeArcQuantitativeScaleViewInfo.GetParametersClass
...
function TdxGaugeArcQuantitativeScaleViewInfo.GetLabelTextRect(AAngle: Single;
  const AText: string): TdxRectF;

  function GetTextRectReferencePointOffset(AQuarter: Integer;
    const AQuarterSize: TdxSizeF): Single;
  begin
    case AQuarter of
      0, 2:
        begin
  ...
  begin
    ...
    if ASign = 0 then
      ASign := 1;
    Result := dxRingPoint(RotatePoint, AParameters.Radius +
      ADefaultParameters.LabelOffset + ASign * AOffset, DegToRad(AAngle));
  end;
...
begin
  ...
  begin
    ...
    P := dxRingPoint(P, ARadius, DegToRad(180 + 90 * ATextRectQuarter +
      AAngle));
...
procedure TdxGaugeArcQuantitativeScaleViewInfo.DoDrawBackground
...
procedure TdxGaugeArcQuantitativeScaleViewInfo.DoDrawLayer
...
procedure TdxGaugeArcQuantitativeScaleViewInfo.DoDrawTickmarkLabel
  (AGPGraphics: TdxGPGraphics; AAngle: Single;
  const ADrawInfo: TdxGaugeQuantitativeScaleTickmarkLabelDrawInfo);
var
...
begin
  ...
  if AOrientation = loLeftToRight then
    dxGaugeDrawText(AGPGraphics, ADrawInfo.Text, ADrawInfo.Rect, Font,
      ADrawInfo.Color)
  else
  begin
    ...
    dxGaugeDrawText(AGPGraphics, ADrawInfo.Text, ADrawInfo.Rect, Font,
      ADrawInfo.Color, ARotationAngle - AAngle);
  end;
end;

procedure TdxGaugeArcQuantitativeScaleViewInfo.DoDrawTickmarkTick
  (AGPGraphics: TdxGPGraphics; AAngle: Single;
...
begin
  if GetDefaultParameters.RotateTicks then
    ...
    AAngleOffset := 0;
  dxGaugeRotateAndDrawImage(AGPGraphics, ADrawInfo.Image, ADrawInfo.Size,
    RotatePoint, GetParameters.Radius + ADrawInfo.Offset, AAngle, AAngleOffset);
end;

procedure TdxGaugeArcQuantitativeScaleViewInfo.DoDrawValueIndicator
  (AGPGraphics: TdxGPGraphics);
  ...
  begin
    ADefaultParameters := GetDefaultParameters;
    Result.cx := (GetParameters.Radius -
      ADefaultParameters.ValueIndicatorEndOffset - GetStartOffset) *
      ADefaultParameters.ValueIndicatorScaleFactor.X;
    Result.cy := (AImage.Height * Result.cx / AImage.Width) *
      ADefaultParameters.ValueIndicatorScaleFactor.Y;
  end;

begin
  dxGaugeRotateAndDrawImage(AGPGraphics, FNeedle, GetImageSize(FNeedle),
    RotatePoint, GetStartOffset, ScaleValuePosition);
end;
...
procedure TdxGaugeArcQuantitativeScaleViewInfo.PopulateParameters
...
function TdxGaugeArcQuantitativeScaleViewInfo.GetValidAngle
  (AAngle: Single): Integer;
var
  AScaleDefaultParameters: TdxGaugeArcQuantitativeScaleDefaultParameters;
begin
  AScaleDefaultParameters := GetDefaultParameters;
  Result := Round(Max(Min(AScaleDefaultParameters.AngleStart, AAngle),
    AScaleDefaultParameters.AngleEnd));
end;
...
begin
  ...
  ADefaultParameters := GetDefaultParameters;
  FRotatePoint.X := AContentBounds.Left + AContentBounds.Width *
    ADefaultParameters.CenterPointPositionFactor.X;
  FRotatePoint.Y := AContentBounds.Top + AContentBounds.Height *
    ADefaultParameters.CenterPointPositionFactor.Y;
end;

procedure TdxGaugeArcQuantitativeScaleViewInfo.DoDrawSpindleCap
  (AGPGraphics: TdxGPGraphics);
begin
  dxGaugeDrawImage(AGPGraphics, FSpindleCap, FSpindleCapBounds);
end;

function TdxGaugeArcQuantitativeScaleViewInfo.GetDefaultParameters
  : TdxGaugeArcQuantitativeScaleDefaultParameters;
begin
  Result := DefaultParameters as TdxGaugeArcQuantitativeScaleDefaultParameters;
end;

function TdxGaugeArcQuantitativeScaleViewInfo.GetLabelTextRectQuarter
  (AAngle: Single): Integer;
var
...
begin
  ...
  if (180 > AAngle) and (AAngle >= 90) or (-180 >= AAngle) and (AAngle > -270)
  then
    Result := 1 + AQuarterOffset;
  if (270 > AAngle) and (AAngle >= 180) or (-90 > AAngle) and (AAngle >= -180)
  then
...
function TdxGaugeArcQuantitativeScaleViewInfo.GetParameters
  : TdxGaugeArcQuantitativeScaleParameters;
begin
...
begin
  ADefaultParameters := GetDefaultParameters;
  Result := Min(125 * ADefaultParameters.ScaleArcRadiusFactor,
    125 * ADefaultParameters.ScaleArcRadiusFactor);
end;
...
begin
  ...
  FSpindleCapBounds := cxRectInflate(cxRectF(RotatePoint, RotatePoint),
    ASize, ASize);
end;

procedure TdxGaugeArcQuantitativeScaleViewInfo.DrawAxisLine
  (AGPGraphics: TdxGPGraphics);
var
  AAngleStart: Single;
  ABounds: TdxRectF;
...
begin
  ...
  begin
    ...
    ABounds := cxRectInflate(cxRectF(RotatePoint, RotatePoint),
      GetParameters.Radius);
    ADefaultParameters := GetDefaultParameters;
    dxGaugeDrawSector(AGPGraphics, ABounds, ADefaultParameters.AxisLineWidth,
      AAngleStart, AngleRange + MajorTicksDrawInfo.Size.cx / 10,
      ADefaultParameters.AxisLineColor, ADefaultParameters.AxisLineColor);
  end;
end;

procedure TdxGaugeArcQuantitativeScaleViewInfo.DrawSpindleCap
  (AGPGraphics: TdxGPGraphics);
begin
...
class function TdxGaugeCustomArcQuantitativeScale.GetStyleReaderClass
  : TdxGaugeCustomScaleStyleReaderClass;
begin
  Result := TdxGaugeArcQuantitativeScaleStyleReader;
end;

function TdxGaugeCustomArcQuantitativeScale.GetOptionsViewClass
  : TdxGaugeCustomScaleOptionsViewClass;
begin
  Result := TdxGaugeArcQuantitativeScaleOptionsView;
end;

function TdxGaugeCustomArcQuantitativeScale.GetParametersClass
  : TdxGaugeCustomScaleParametersClass;
begin
  Result := TdxGaugeArcQuantitativeScaleParameters;
end;

function TdxGaugeCustomArcQuantitativeScale.GetRangeClass
  : TdxGaugeCustomRangeClass;
begin
  Result := TdxGaugeCircularScaleRange;
end;

function TdxGaugeCustomArcQuantitativeScale.GetViewInfoClass
...
procedure TdxGaugeCustomArcQuantitativeScale.DoAssign
  (AScale: TdxGaugeCustomScale);
begin
  inherited DoAssign(AScale);
  FAssignedValues := (AScale as TdxGaugeCustomArcQuantitativeScale)
    .FAssignedValues;
end;
...
procedure TdxGaugeCustomArcQuantitativeScale.SetAngle(AAngle: Integer;
  var AScaleAngle: Integer);
begin
  AScaleAngle := AAngle;
end;
...
function TdxGaugeCustomArcQuantitativeScale.GetLabelOrientation
  : TdxGaugeCircularScaleLabelOrientation;
begin
  Result := GetScaleParameters.LabelOrientation;
end;

function TdxGaugeCustomArcQuantitativeScale.GetOptionsView
  : TdxGaugeArcQuantitativeScaleOptionsView;
begin
...
begin
  ...
  else if GetScaleParameters.Height = 0 then
    Result := GetScaleParameters.Width div 2
  else
    Result := Min(GetScaleParameters.Width div 2,
      GetScaleParameters.Height div 2);
end;

function TdxGaugeCustomArcQuantitativeScale.GetRadiusFactor: Single;
begin
  Result := Min(GetScaleParameters.WidthFactor / 2,
    GetScaleParameters.HeightFactor / 2);
end;
...
begin
  ...
  begin
    ...
    if GetScaleParameters.AngleEnd = GetViewInfo.GetDefaultParameters.AngleEnd
    then
...
procedure TdxGaugeCustomArcQuantitativeScale.SetAngleStart
  (const AValue: Integer);
begin
  if GetScaleParameters.AngleStart <> AValue then
  begin
    SetAngle(AValue, GetScaleParameters.AngleStart);
    if GetScaleParameters.AngleStart = GetViewInfo.GetDefaultParameters.AngleStart
    then
...
procedure TdxGaugeCustomArcQuantitativeScale.SetLabelOrientation
  (const AValue: TdxGaugeCircularScaleLabelOrientation);
begin
...
procedure TdxGaugeCustomArcQuantitativeScale.SetOptionsView
  (const AValue: TdxGaugeArcQuantitativeScaleOptionsView);
begin
...
procedure TdxGaugeCustomArcQuantitativeScale.SetRadiusFactor
  (const AValue: Single);
begin
...
procedure TdxGaugeCustomArcQuantitativeScale.SetShowSpindleCap
  (const AValue: Boolean);
begin
...
function TdxGaugeCustomArcQuantitativeScale.GetScaleParameters
  : TdxGaugeArcQuantitativeScaleParameters;
begin
  Result := Parameters as TdxGaugeArcQuantitativeScaleParameters;
end;

function TdxGaugeCustomArcQuantitativeScale.GetViewInfo
  : TdxGaugeArcQuantitativeScaleViewInfo;
begin
...
function TdxGaugeArcQuantitativeScale.GetOptionsLayoutClass
  : TdxGaugeScaleOptionsCustomLayoutClass;
begin
  Result := TdxGaugeScaleOptionsArcLayout;
end;

function TdxGaugeArcQuantitativeScale.GetOptionsLayout
  : TdxGaugeScaleOptionsArcLayout;
begin
  Result := inherited OptionsLayout as TdxGaugeScaleOptionsArcLayout;
end;

procedure TdxGaugeArcQuantitativeScale.SetOptionsLayout
  (const AValue: TdxGaugeScaleOptionsArcLayout);
begin
...
function TdxGaugeCustomCircularScaleViewInfo.GetValidAngle
  (AAngle: Single): Integer;
begin
  Result := Round(AAngle);
end;
...
function TdxGaugeCustomCircularScale.GetViewInfoClass
  : TdxGaugeCustomScaleViewInfoClass;
begin
  Result := TdxGaugeCustomCircularScaleViewInfo;
end;

procedure TdxGaugeCustomCircularScale.SetAngle(AAngle: Integer;
  var AScaleAngle: Integer);
begin
  inherited SetAngle(AAngle, AScaleAngle);
  if not IsReading and
    (GetScaleParameters.AngleStart = GetScaleParameters.AngleEnd) then
    Dec(AScaleAngle, 360);
end;
...
class function TdxGaugeCustomCircularHalfScale.GetStyleReaderClass
  : TdxGaugeCustomScaleStyleReaderClass;
begin
...
class function TdxGaugeCustomCircularQuarterLeftScale.GetScaleType
  : TdxGaugeScaleType;
begin
...
function TdxGaugeCustomCircularQuarterRightScaleViewInfo.GetReferencePoint
  : TdxPointF;
begin
...
class function TdxGaugeCustomCircularQuarterRightScale.GetScaleType
  : TdxGaugeScaleType;
begin
  Result := stCircularQuarterRightScale;
end;

function TdxGaugeCustomCircularQuarterRightScale.GetViewInfoClass
  : TdxGaugeCustomScaleViewInfoClass;
begin
...
function TdxGaugeCustomCircularThreeFourthScaleViewInfo.GetLayoutSize
...
class function TdxGaugeCustomCircularThreeFourthScale.GetScaleType
  : TdxGaugeScaleType;
begin
  Result := stCircularThreeFourthScale;
end;

function TdxGaugeCustomCircularThreeFourthScale.GetOptionsLayoutClass
  : TdxGaugeScaleOptionsCustomLayoutClass;
begin
  Result := TdxGaugeScaleOptionsArcLayout;
end;

function TdxGaugeCustomCircularThreeFourthScale.GetViewInfoClass
  : TdxGaugeCustomScaleViewInfoClass;
begin
  Result := TdxGaugeCustomCircularThreeFourthScaleViewInfo;
end;

function TdxGaugeCustomCircularThreeFourthScale.GetOptionsLayout
  : TdxGaugeScaleOptionsArcLayout;
begin
  Result := inherited OptionsLayout as TdxGaugeScaleOptionsArcLayout;
end;

procedure TdxGaugeCustomCircularThreeFourthScale.SetOptionsLayout
  (const AValue: TdxGaugeScaleOptionsArcLayout);
begin
  inherited OptionsLayout := AValue;
end;
...
function TdxGaugeCustomCircularWideScaleViewInfo.GetLayoutSize
  (const ABounds: TdxRectF): TdxSizeF;
begin
  Result := dxGaugeGetRectangularScaleLayoutSize(ABounds, FParameters.Width,
    FParameters.Height, FParameters.WidthFactor, FParameters.HeightFactor);
...
procedure TdxGaugeCustomCircularWideScaleViewInfo.DoDrawSpindleCap
  (AGPGraphics: TdxGPGraphics);
begin
...
procedure TdxGaugeCustomCircularWideScaleViewInfo.DoDrawValueIndicator
  (AGPGraphics: TdxGPGraphics);
begin
  AGPGraphics.SaveClipRegion;
  try
...
begin
  Result := GetContentBounds;
  Result := cxRectInflate(cxRectF(cxRectCenter(Result), cxRectCenter(Result)),
    Result.Width / 2, GetDefaultParameters.ValueIndicatorClipAreaHeightFactor *
    Result.Height / 2);
end;

function TdxGaugeCustomCircularWideScaleViewInfo.GetDefaultParameters
  : TdxGaugeCircularWideScaleDefaultParameters;
begin
...
class function TdxGaugeCustomCircularWideScale.GetStyleReaderClass
  : TdxGaugeCustomScaleStyleReaderClass;
begin
  Result := TdxGaugeCircularWideScaleStyleReader;
end;

function TdxGaugeCustomCircularWideScale.GetOptionsLayoutClass
  : TdxGaugeScaleOptionsCustomLayoutClass;
begin
  Result := TdxGaugeScaleOptionsRectangularLayout;
end;

function TdxGaugeCustomCircularWideScale.GetRangeClass
  : TdxGaugeCustomRangeClass;
begin
  Result := TdxGaugeCircularWideScaleRange;
end;

function TdxGaugeCustomCircularWideScale.GetViewInfoClass
  : TdxGaugeCustomScaleViewInfoClass;
begin
  Result := TdxGaugeCustomCircularWideScaleViewInfo;
end;

function TdxGaugeCustomCircularWideScale.GetOptionsLayout
  : TdxGaugeScaleOptionsRectangularLayout;
begin
  Result := inherited OptionsLayout as TdxGaugeScaleOptionsRectangularLayout;
end;

procedure TdxGaugeCustomCircularWideScale.SetOptionsLayout
...
class function TdxGaugeArcQuantitativeScaleStyleReader.
  GetResourceNamePrefix: string;
begin
  Result := 'Circular';
end;

function TdxGaugeArcQuantitativeScaleStyleReader.GetDefaultParametersClass
  : TdxGaugeCustomScaleDefaultParametersClass;
begin
  Result := TdxGaugeArcQuantitativeScaleDefaultParameters;
end;

procedure TdxGaugeArcQuantitativeScaleStyleReader.ReadCommonScaleParameters
...
begin
  ...
  ACustomCircularParameters :=
    AParameters as TdxGaugeArcQuantitativeScaleDefaultParameters;
  ACustomCircularParameters.AngleEnd := GetAttributeValueAsInteger
    (GetChildNode(ANode, 'AngleEnd'), 'Value');
  ACustomCircularParameters.AngleStart := GetAttributeValueAsInteger
    (GetChildNode(ANode, 'AngleStart'), 'Value');
  ACustomCircularParameters.ScaleArcRadiusFactor :=
    GetAttributeValueAsDouble(GetChildNode(ANode, 'ArcRadiusFactor'), 'Value');
  ...
  if ATempNode <> nil then
    ACustomCircularParameters.CenterPointPositionFactor :=
      GetAttributeValueAsPointF(GetChildNode(ANode,
  ...
  if GetChildNode(ANode, 'AxisLineColor', ATempNode) then
    ACustomCircularParameters.AxisLineColor :=
      dxColorToAlphaColor(GetAttributeValueAsColor(ATempNode, 'Value'));
  if GetChildNode(ANode, 'AxisLineWidth', ATempNode) then
    ACustomCircularParameters.AxisLineWidth :=
      GetAttributeValueAsDouble(ATempNode, 'Value');
end;

procedure TdxGaugeArcQuantitativeScaleStyleReader.ReadNeedleParameters
  (ANode: TdxXMLNode;
  AParameters: TdxGaugeArcQuantitativeScaleDefaultParameters);
var
...
begin
  ...
  begin
    AParameters.ValueIndicatorStartOffset :=
      GetAttributeValueAsDouble(GetChildNode(ANeedleNode,
      'StartOffset'), 'Value');
    AParameters.ValueIndicatorEndOffset := GetAttributeValueAsDouble
      (GetChildNode(ANeedleNode, 'EndOffset'), 'Value');
    if GetChildNode(ANeedleNode, 'ScaleFactor') <> nil then
      AParameters.ValueIndicatorScaleFactor :=
        GetAttributeValueAsPointF(GetChildNode(ANeedleNode,
        'ScaleFactor'), 'Value')
    else
...
procedure TdxGaugeArcQuantitativeScaleStyleReader.ReadSpindleCapParameters
  (ANode: TdxXMLNode;
  AParameters: TdxGaugeArcQuantitativeScaleDefaultParameters);
var
...
begin
  ...
  begin
    AParameters.SpindleCapSize := GetAttributeValueAsDouble
      (GetChildNode(ASpindleCapNode, 'Size'), 'Value');
    if GetChildNode(ASpindleCapNode, 'UnderNeedle') <> nil then
      AParameters.SpindleCapUnderNeedle := GetAttributeValueAsBoolean
        (GetChildNode(ASpindleCapNode, 'UnderNeedle'), 'Value');
  end;
end;

{ TdxGaugeCustomCircularHalfScaleStyleReader }

class function TdxGaugeCustomCircularHalfScaleStyleReader.
  GetResourceNamePrefix: string;
begin
  Result := 'CircularHalf';
end;
...
class function TdxGaugeCircularWideScaleStyleReader.
  GetResourceNamePrefix: string;
begin
  Result := inherited GetResourceNamePrefix + 'Wide';
end;

function TdxGaugeCircularWideScaleStyleReader.GetDefaultParametersClass
  : TdxGaugeCustomScaleDefaultParametersClass;
begin
  Result := TdxGaugeCircularWideScaleDefaultParameters;
end;

procedure TdxGaugeCircularWideScaleStyleReader.ReadNeedleParameters
  (ANode: TdxXMLNode;
  AParameters: TdxGaugeArcQuantitativeScaleDefaultParameters);
var
  ATempNode: TdxXMLNode;
begin
  ...
  if GetChildNode(ANode, 'Needle', ATempNode) and
    GetChildNode(ATempNode, 'ClipAreaHeightFactor', ATempNode) then
    TdxGaugeCircularWideScaleDefaultParameters(AParameters)
      .ValueIndicatorClipAreaHeightFactor :=
      GetAttributeValueAsDouble(ATempNode, 'Value')
  else
    TdxGaugeCircularWideScaleDefaultParameters(AParameters)
      .ValueIndicatorClipAreaHeightFactor := 1;
end;

{ TdxGaugeCustomCircularScaleRangeViewInfo }

function TdxGaugeCustomCircularScaleRangeViewInfo.GetParametersClass
...
begin
  ARadius := GetRadius;
  FBounds := cxRectInflate(cxRectF(GetScaleInfo.RotatePoint,
    GetScaleInfo.RotatePoint), ARadius, ARadius);
...
procedure TdxGaugeCustomCircularScaleRangeViewInfo.CalculateSelectionBounds;
  ...
  begin
    ...
    FSelectionBounds.Bottom := Min(ScaleInfo.Selection.Bottom,
      FSelectionBounds.Bottom);
    FSelectionBounds.Left := Max(ScaleInfo.Selection.Left,
      FSelectionBounds.Left);
    FSelectionBounds.Right := Min(ScaleInfo.Selection.Right,
      FSelectionBounds.Right);
  end;
...
begin
  AParameters := GetParameters;
  if (AParameters.ValueEnd <> AParameters.ValueStart) and
    (AParameters.ValueEndPosition <> AParameters.ValueStartPosition) then
    R := dxGaugeGetSectorRect(FBounds, FWidth, AParameters.ValueStartPosition,
      AParameters.ValueEndPosition - AParameters.ValueStartPosition)
  else
    R := dxGaugeGetSectorRect(FBounds, FWidth,
      ScaleInfo.GetValuePositionFunc(ScaleInfo.MaxValue),
      ScaleInfo.GetValuePositionFunc(ScaleInfo.MinValue) -
      ScaleInfo.GetValuePositionFunc(ScaleInfo.MaxValue));
  FSelectionBounds := R;
...
procedure TdxGaugeCustomCircularScaleRangeViewInfo.DoDraw
  (AGPGraphics: TdxGPGraphics);
var
  AParameters: TdxGaugeCircularRangeParameters;
begin
  AParameters := GetParameters;
  dxGaugeDrawSector(AGPGraphics, FBounds, FWidth,
    AParameters.ValueStartPosition, AParameters.ValueEndPosition -
...
begin
  ...
  if GetScaleInfo.RotatePoint.Y <= cxRectCenter(GetScaleInfo.ContentBounds).Y
  then
    Result.Top := GetScaleInfo.RotatePoint.Y
  else
    Result.Bottom := GetScaleInfo.RotatePoint.Y;
  if GetScaleInfo.RotatePoint.X <= cxRectCenter(GetScaleInfo.ContentBounds).X
  then
...
function TdxGaugeCustomCircularScaleRangeViewInfo.GetParameters
  : TdxGaugeCircularRangeParameters;
begin
  Result := Parameters as TdxGaugeCircularRangeParameters;
end;

function TdxGaugeCustomCircularScaleRangeViewInfo.GetScaleInfo
  : TdxGaugeArcScaleInfo;
begin
...
function TdxGaugeCustomCircularScaleRange.GetParametersClass
  : TdxGaugeCustomRangeParametersClass;
begin
  Result := TdxGaugeCircularRangeParameters;
end;

function TdxGaugeCustomCircularScaleRange.GetViewInfoClass
  : TdxGaugeCustomRangeViewInfoClass;
begin
...
begin
  ...
  AFiler.DefineProperty('RadiusFactor', ReadRadiusFactor, WriteRadiusFactor,
    SameValue(RadiusFactor, 0));
end;

function TdxGaugeCustomCircularScaleRange.GetViewInfo
  : TdxGaugeCustomCircularScaleRangeViewInfo;
begin
...
procedure TdxGaugeCustomCircularScaleRange.SetRadiusFactor
  (const AValue: Single);
begin
...
function TdxGaugeCustomCircularScaleRange.GetParameters
  : TdxGaugeCircularRangeParameters;
begin
  Result := Parameters as TdxGaugeCircularRangeParameters;
end;
...
begin
  Result := not SameValue(GetParameters.RadiusFactor,
    dxGaugeCircularScaleDefaultRadiusFactor);
end;
...
begin
  Result := Abs(GetScaleInfo.ContentBounds.Bottom - GetScaleInfo.RotatePoint.Y)
    + GetScaleInfo.ContentBounds.Height * GetParameters.RadiusFactor;
end;
...
procedure TdxGaugeCircularWideScaleRangeViewInfo.DoDraw
  (AGPGraphics: TdxGPGraphics);
begin
  AGPGraphics.SaveClipRegion;
  try
...
function TdxGaugeCircularWideScaleRange.GetViewInfoClass
  : TdxGaugeCustomRangeViewInfoClass;
begin
...
Classes.RegisterClasses([TdxGaugeCircularScaleRange,
  TdxGaugeCircularWideScaleRange]);

finalization

Classes.UnRegisterClasses([TdxGaugeCircularScaleRange,
  TdxGaugeCircularWideScaleRange]);
