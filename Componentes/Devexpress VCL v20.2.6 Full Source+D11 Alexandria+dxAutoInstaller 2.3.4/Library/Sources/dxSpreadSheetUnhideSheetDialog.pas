...
type
  ...
  TdxSpreadSheetUnhideSheetDialogFormClass = class of
    TdxSpreadSheetUnhideSheetDialogForm;
...
var
  dxSpreadSheetUnhideSheetDialogClass
    : TdxSpreadSheetUnhideSheetDialogFormClass =
    TdxSpreadSheetUnhideSheetDialogForm;
...
begin
  ADialog := dxSpreadSheetUnhideSheetDialogClass.Create
...
procedure TdxSpreadSheetUnhideSheetDialogForm.Initialize
...
begin
  ...
  lciHiddenSheets.Caption := cxGetResourceString
...
procedure TdxSpreadSheetUnhideSheetDialogForm.lbHiddenSheetsDblClick
  (Sender: TObject);
begin
  btnOk.Click;
end;
