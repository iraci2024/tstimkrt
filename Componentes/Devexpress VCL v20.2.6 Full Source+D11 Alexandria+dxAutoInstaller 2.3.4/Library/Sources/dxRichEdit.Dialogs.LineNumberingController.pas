...
type
  ...
  public
    constructor Create(const AControl: IdxRichEditControl;
      ALineNumberingInfo: TdxLineNumberingInfo);
  ...
  public
    ...
    property SourceLineNumberingInfo: TdxLineNumberingInfo
      read FSourceLineNumberingInfo;
...
constructor TdxLineNumberingFormControllerParameters.Create(const AControl
  : IdxRichEditControl; ALineNumberingInfo: TdxLineNumberingInfo);
begin
...
constructor TdxLineNumberingFormController.Create(AControllerParameters
  : TdxLineNumberingFormControllerParameters);
begin
  inherited Create;
...
procedure TdxLineNumberingFormController.SetStartingLineNumber
...
function TdxLineNumberingFormController.GetNumberingRestartType
  : TdxLineNumberingRestart;
begin
  Result := FLineNumberingInfo.NumberingRestartType;
end;

procedure TdxLineNumberingFormController.SetNumberingRestartType
