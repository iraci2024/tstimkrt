...
type
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader; AOffset: Integer;
      ASize: Integer): TdxDocCommentsAuthorTable; static;
  ...
  public
    ...
    destructor Destroy; override;
    class function FromStream(AReader: TBinaryReader; AOffset: Integer;
      ASize: Integer): TdxDocCommentsNameTable; static;
    procedure Write(AWriter: TBinaryWriter); override;
  ...
  public
    ...
    destructor Destroy; override;
    class function FromStream(AReader: TBinaryReader; AOffset: Integer;
      ASize: Integer): TdxDocCommentsFirstTable; static;
    ...
    property IndexCharacterPositions: TdxIntegerList
      read FIndexCharacterPositions;
  end;
  ...
  public
    ...
    destructor Destroy; override;
    class function FromStream(AReader: TBinaryReader; AOffset: Integer;
      ASize: Integer): TdxDocCommentsLimTable; static;
    procedure Write(AWriter: TBinaryWriter);
    procedure Finish(ALastCharacterPosition: Integer);
  ...
  public
    ...
    destructor Destroy; override;
    class function FromStream(AReader: TBinaryReader; AOffset: Integer;
      ASize: Integer): TdxDocCommentsInfoTable; static;
    procedure Write(AWriter: TBinaryWriter);
  ...
  protected
    ...
    property CommentsIndex: TDictionary<Integer, TdxComment>
      read FCommentsIndex;
  public
    constructor Create(AFib: TdxFileInformationBlock; AReader: TBinaryReader;
      AKeepCommentsForRemovedRanges: Boolean);
    destructor Destroy; override;
    ...
    function GetCommentsContent(ACharacterPosition: Integer)
      : TdxDocObjectCollection;
    procedure BeginEmbeddedContent(AStart: Integer; AEnd: Integer);
    procedure EndEmbeddedContent;

    property CommentsContent: TdxDocObjectCollectionDictionary
      read FCommentsContent;
...
class function TdxDocCommentsAuthorTable.FromStream(AReader: TBinaryReader;
  AOffset: Integer; ASize: Integer): TdxDocCommentsAuthorTable;
begin
  Result := TdxDocCommentsAuthorTable.Create;
  Result.Read(AReader, AOffset, ASize);
end;

procedure TdxDocCommentsAuthorTable.Read(AReader: TBinaryReader;
...
function TdxDocCommentsAuthorTable.CalcIsExtended
  (AReader: TBinaryReader): Boolean;
var
  ATypecode: Word;
begin
...
procedure TdxDocCommentsAuthorTable.WriteString(AWriter: TBinaryWriter;
  AIndex: Integer);
var
...
class function TdxDocCommentsNameTable.FromStream(AReader: TBinaryReader;
  AOffset: Integer; ASize: Integer): TdxDocCommentsNameTable;
begin
  Result := TdxDocCommentsNameTable.Create;
  Result.Read(AReader, AOffset, ASize);
end;

function TdxDocCommentsNameTable.CalcRecordsCount
  (AReader: TBinaryReader): Integer;
begin
  Result := Min(MaxNumberAnnotationBookmarks, AReader.ReadSmallInt);
end;

function TdxDocCommentsNameTable.CalcExtraDataSize
  (AReader: TBinaryReader): Integer;
begin
...
procedure TdxDocCommentsNameTable.WriteExtraData(AWriter: TBinaryWriter;
  AIndex: Integer);
var
  AName: Integer;
  AData: string;
...
class function TdxDocCommentsFirstTable.FromStream(AReader: TBinaryReader;
  AOffset: Integer; ASize: Integer): TdxDocCommentsFirstTable;
begin
  Result := TdxDocCommentsFirstTable.Create;
  Result.Read(AReader, AOffset, ASize);
end;

procedure TdxDocCommentsFirstTable.Read(AReader: TBinaryReader;
  AOffset: Integer; ASize: Integer);
var
...
class function TdxDocCommentsLimTable.FromStream(AReader: TBinaryReader;
  AOffset: Integer; ASize: Integer): TdxDocCommentsLimTable;
begin
  Result := TdxDocCommentsLimTable.Create;
  Result.Read(AReader, AOffset, ASize);
end;

procedure TdxDocCommentsLimTable.Read(AReader: TBinaryReader; AOffset: Integer;
  ASize: Integer);
var
...
class function TdxDocCommentsInfoTable.FromStream(AReader: TBinaryReader;
  AOffset: Integer; ASize: Integer): TdxDocCommentsInfoTable;
begin
  Result := TdxDocCommentsInfoTable.Create;
  Result.Read(AReader, AOffset, ASize);
end;

procedure TdxDocCommentsInfoTable.Read(AReader: TBinaryReader; AOffset: Integer;
  ASize: Integer);
var
  ACount, I: Integer;
begin
  AReader.BaseStream.Seek(AOffset, TSeekOrigin.soBeginning);
  ACount := (ASize - ReferenceLimSize)
    div (ReferenceLimSize + StructureATRDPre10Size);
  for I := 0 to ACount - 1 do
...
begin
  ...
  AResult := Copy(TdxEncoding.Unicode.GetString(ABuffer, 0, Length(ABuffer)),
    1, ALength);
...
procedure TdxDocCommentsInfoTable.ReadReferenceName(AReader: TBinaryReader;
  AIndex: Integer);
var
...
procedure TdxDocCommentsInfoTable.WriteInitials(AWriter: TBinaryWriter;
  AIndex: Integer);
var
...
begin
  ...
  AValidateStringInitials := TdxStringHelper.Substring(AStringInitials, 0,
    Min(InitialsSize - 2, Length(AStringInitials)));
...
procedure TdxDocCommentsInfoTable.WriteAuthorNumbers(AWriter: TBinaryWriter;
  AIndex: Integer);
begin
  AWriter.Write(SmallInt(AuthorIndexTable[AIndex]));
end;

procedure TdxDocCommentsInfoTable.WriteReferenceName(AWriter: TBinaryWriter;
  AIndex: Integer);
var
  AName: Integer;
  AReference: string;
...
procedure TdxDocCommentsInfoTable.WriteDateTime(AWriter: TBinaryWriter;
  AIndex: Integer);
begin
  AWriter.Write(DateTimeDTTMTable[AIndex]);
end;

procedure TdxDocCommentsInfoTable.WriteIdParent(AWriter: TBinaryWriter;
  AIndex: Integer);
begin
  AWriter.Write(ParentTable[AIndex]);
end;

procedure TdxDocCommentsInfoTable.WriteOffsetParent(AWriter: TBinaryWriter;
  AIndex: Integer);
begin
...
constructor TdxDocCommentsIterator.Create(AFib: TdxFileInformationBlock;
  AReader: TBinaryReader; AKeepCommentsForRemovedRanges: Boolean);
begin
...
procedure TdxDocCommentsIterator.Read(AFib: TdxFileInformationBlock;
  AReader: TBinaryReader);
begin
  FCommentsAuthorTable := TdxDocCommentsAuthorTable.FromStream(AReader,
    AFib.CommentsAuthorTableOffset, AFib.CommentsAuthorTableSize);
  FCommentsNameTable := TdxDocCommentsNameTable.FromStream(AReader,
    AFib.CommentsNameTableOffset, AFib.CommentsNameTableSize);
  FCommentsFirstTable := TdxDocCommentsFirstTable.FromStream(AReader,
    AFib.CommentsFirstTableOffset, AFib.CommentsFirstTableSize);
  FCommentsLimTable := TdxDocCommentsLimTable.FromStream(AReader,
    AFib.CommentsLimTableOffset, AFib.CommentsLimTableSize);
  FCommentsInfoTable := TdxDocCommentsInfoTable.FromStream(AReader,
    AFib.CommentsReferenceOffset, AFib.CommentsReferenceSize);
...
begin
  ...
  for I := 0 to ACount - 1 do
    if TdxStringHelper.Contains(AReferenceNameTable[I], PrefixNewCommentName)
    then
    begin
...
procedure TdxDocCommentsIterator.AdvanceNext(ALogPosition
...
begin
  ...
  if (AParentId > 0) and CommentsIndex.TryGetValue(AParentIndex, AParentComment)
  then
    Exit(AParentComment);
  Result := nil;
end;

function TdxDocCommentsIterator.GetIndexCharacterPosition(ACharacterPosition
  : Integer): Integer;
var
  I: Integer;
begin
...
function TdxDocCommentsIterator.GetCommentsContent(ACharacterPosition: Integer)
  : TdxDocObjectCollection;
begin
...
procedure TdxDocCommentsIterator.BeginEmbeddedContent(AStart: Integer;
  AEnd: Integer);
begin
