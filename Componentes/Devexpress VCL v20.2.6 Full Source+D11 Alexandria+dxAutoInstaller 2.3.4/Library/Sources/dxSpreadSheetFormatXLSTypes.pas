...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Windows, Classes, Generics.Defaults, Generics.Collections, Graphics, dxCore,
  dxXMLDoc, dxGDIPlusClasses, dxSpreadSheetCore,
  dxSpreadSheetFormatXLSXReader, dxSpreadSheetFormatXLSXTags,
  dxSpreadSheetClasses, cxVariants,
  cxGraphics, dxZIPUtils, dxSpreadSheetFormatUtils, dxSpreadSheetHyperlinks,
  dxCoreClasses, dxSpreadSheetGraphics,
...
type
  ...
  TdxXFExtPropertyID = (xfextRGBForeColor, xfextRGBBackColor, reserved1,
    reserved2, xfextForeColor, xfextBackColor, xfextGradientTint,
    xfextBorderColorTop, xfextBorderColorBottom, xfextBorderColorLeft,
    xfextBorderColorRight, xfextBorderColorDiag, reserved3, xfextTextColor,
    xfextFontScheme, xfextIndent);
  ...
  public
    ...
    procedure CorrectStyle(ABrush: TdxSpreadSheetBrushHandle;
      ABorders: TdxSpreadSheetBordersHandle;
      AStyle: TdxSpreadSheetCellStyleHandle);
    procedure SetThemeColorValue(APropID: TdxXFExtPropertyID;
      const AColorIndex: Integer; ATintShade: SmallInt);
  ...
  protected
    function ExtractDocument(AStream: TStream; const ADocName: AnsiString)
      : TdxXMLDocument;
  ...
  public
    ...
    function GetColor(AColorIndex: Integer; ATintShade: SmallInt;
  ...
  private
    ...
    FSize: Integer;
  public
    constructor Create(AName: TdxSpreadSheetDefinedName; ASize: Integer;
      AData: Pointer);
    destructor Destroy; override;
  ...
  TdxSpreadSheetURICreationFlag = (createAllowRelative,
    createAllowImplicitWildcardScheme, createAllowImplicitFileScheme,
    createNoFrag, createNoCanonicalize, createCanonicalize,
    createFileUseDosPath, createDecodeExtraInfo, createNoDecodeExtraInfo,
    createCrackUnknownSchemes, createNoCrackUnknownSchemes,
    createPreProcessHtmlUri, createNoPreProcessHtmlUri, createIESettings,
    createNoIESettings, createNoEncodeForbiddenCharacters);
  ...
  protected
    ...
    procedure ReadFromStream(AHelper: TdxBIFFHyperlinkHelper;
      AReader: TcxReader); virtual;
    procedure WriteToStream(AHelper: TdxBIFFHyperlinkHelper;
  ...
  public
    ...
    property URIFlags: TdxSpreadSheetURICreationFlags read FURIFlags
      write FURIFlags;
  ...
  strict private
    FDelimiter: string;
    FPath: string;
    function GetMonikerPart(AHelper: TdxBIFFHyperlinkHelper;
      AReader: TcxReader): string;
    procedure WriteMonikerPart(AHelper: TdxBIFFHyperlinkHelper;
      AWriter: TcxWriter; const AValue: string);
  protected
    procedure ReadFromStream(AHelper: TdxBIFFHyperlinkHelper;
      AReader: TcxReader); override;
    procedure WriteToStream(AHelper: TdxBIFFHyperlinkHelper;
  ...
  protected
    ...
    function ReadHTMLString(AReader: TcxReader; ASize: Integer;
      APosition: Integer = -1): string; overload;
  ...
  public
    ...
    property LinkType: TdxSpreadSheetHyperlinkType read FLinkType
      write FLinkType;
...
const
  ...
  DefaultURLFlags: TdxSpreadSheetURICreationFlags = [createAllowRelative,
    createAllowImplicitFileScheme, createCanonicalize, createDecodeExtraInfo,
    createNoDecodeExtraInfo, createCrackUnknownSchemes, createPreProcessHtmlUri,
    createIESettings, createNoEncodeForbiddenCharacters];
...
const
  ...
  BorderLineStyleMap: array [TdxSpreadSheetCellBorderStyle] of Byte = ($0, $7,
    $4, $B, $9, $3, $1, $C, $D, $A, $8, $2, $5, $6, $0);
  FillStyleMap: array [TdxSpreadSheetCellFillStyle] of Byte = ($01, $03, $02,
    $04, $11, $12, $05, $06, $07, $08, $09, $0A, $0B, $0C, $0D, $0E, $10, $0F);

  FillStyles: array [0 .. 17] of Byte = ($01, $03, $02, $04, $11, $12, $05, $06,
    $07, $08, $09, $0A, $0B, $0C, $0D, $0E, $10, $0F);
...
uses
  dxSpreadSheetFormatXLSFormulas, dxSpreadSheetFormatXLS, SysUtils,
  dxSpreadSheetFormulas, dxSpreadSheetFormatXLSReader,
...
procedure TdxXFExtPropertyData.CheckColors
  (ATheme: TdxSpreadSheetXLSReaderThemeHelper);
var
...
begin
  for APropID := Low(TdxXFExtPropertyID) to High(TdxXFExtPropertyID) do
    if APropID in AssignedThemeValues then
      if not ATheme.GetColor(DataValue[APropID], TintShade[APropID],
        DataValue[APropID]) then
      begin
...
procedure TdxXFExtPropertyData.SetThemeColorValue(APropID: TdxXFExtPropertyID;
  const AColorIndex: Integer; ATintShade: SmallInt);
begin
...
procedure TdxXFExtPropertyData.SetValue(APropID: TdxXFExtPropertyID;
...
function TdxSpreadSheetXLSReaderThemeHelper.GetColor(AColorIndex: Integer;
  ATintShade: SmallInt; var AColor: Integer): Boolean;
begin
  ...
  if ATintShade <> 0 then
    AColor := TdxSpreadSheetColorHelper.ApplyTint(ColorToRgb(AColor),
      ATintShade / MAXSHORT)
end;
...
function TdxSpreadSheetXLSReaderThemeHelper.ExtractDocument(AStream: TStream;
  const ADocName: AnsiString): TdxXMLDocument;
var
...
function TdxSpreadSheetXLSReaderThemeHelper.GetColorMap
  : TDictionary<TdxXMLString, TColor>;
begin
  Result := FColorMap;
end;

function TdxSpreadSheetXLSReaderThemeHelper.GetThemedBrushes
...
function TdxSpreadSheetXLSReaderThemeHelper.GetThemedPens
...
var
  I: Integer;
const
  StandardColors: array [0 .. 11] of TColor = (0, 0, $E1ECEE, $7D491F, $BD814F,
    $4D50C0, $59BB9B, $A26480, $C6AC4B, $4696F7, $FF0000, $800080);
begin
  Clear;
...
constructor TdxXLSNameDefinition.Create(AName: TdxSpreadSheetDefinedName;
...
begin
  AFormulasReader := TdxXLSFormulaReader.Create
    (TdxSpreadSheetXLSReader(AReader));
  try
...
begin
  ...
  else if (Hyperlink.ValueType = hvtEMail) or (Pos('http:', Hyperlink.Value) = 1)
  then
  begin
    AClassID := URLMoniker;
    AMonikerClass := TdxURLMoniker;
  end
  else if Hyperlink.ValueType <> hvtReference then
  begin
...
function TdxBIFFHyperlinkHelper.ReadHTMLString(AReader: TcxReader;
  ASize: Integer; APosition: Integer = -1): string;
begin
...
function TdxBIFFHyperlinkHelper.ReadNullTerminatedAnsiString(AReader: TcxReader)
  : AnsiString;
var
  AChar: AnsiChar;
begin
...
function TdxBIFFHyperlinkHelper.ReadNullTerminatedString
  (AReader: TcxReader): string;
var
  AChar: Char;
begin
...
procedure TdxBIFFHyperlinkHelper.WriteNullTerminatedString
  (const AValue: string);
begin
...
procedure TdxHyperlinkMonikerObject.Initialize
  (AHyperlink: TdxSpreadSheetHyperlink);
begin
end;

procedure TdxHyperlinkMonikerObject.ReadFromStream
  (AHelper: TdxBIFFHyperlinkHelper; AReader: TcxReader);
begin
end;

procedure TdxHyperlinkMonikerObject.WriteToStream
  (AHelper: TdxBIFFHyperlinkHelper; AWriter: TcxWriter);
begin
end;
...
procedure TdxURLMoniker.ReadFromStream(AHelper: TdxBIFFHyperlinkHelper;
  AReader: TcxReader);
var
  ASize: Integer;
begin
...
procedure TdxURLMoniker.WriteToStream(AHelper: TdxBIFFHyperlinkHelper;
  AWriter: TcxWriter);
begin
...
procedure TdxFileMoniker.ReadFromStream(AHelper: TdxBIFFHyperlinkHelper;
  AReader: TcxReader);
var
  ALen: Integer;
  APath: AnsiString;
...
procedure TdxFileMoniker.WriteToStream(AHelper: TdxBIFFHyperlinkHelper;
  AWriter: TcxWriter);
var
  S: AnsiString;
begin
...
procedure TdxItemMoniker.ReadFromStream(AHelper: TdxBIFFHyperlinkHelper;
  AReader: TcxReader);
begin
...
procedure TdxItemMoniker.WriteToStream(AHelper: TdxBIFFHyperlinkHelper;
  AWriter: TcxWriter);
begin
...
function TdxItemMoniker.GetMonikerPart(AHelper: TdxBIFFHyperlinkHelper;
  AReader: TcxReader): string;
var
  L: Integer;
  AStr: AnsiString;
...
procedure TdxItemMoniker.WriteMonikerPart(AHelper: TdxBIFFHyperlinkHelper;
  AWriter: TcxWriter; const AValue: string);
var
  AStr: AnsiString;
begin
