...
type
  ...
  public
    ...
    class function GetParentOperationClass
      : TcxGridPopupMenuOperationClass; virtual;
    ...
    property DownState: TcxGridPopupMenuOperationState read FDownState
      write FDownState default pmoDefault;
    property EnabledState: TcxGridPopupMenuOperationState read FEnabledState
      write FEnabledState default pmoDefault;
    property HitGridView: TcxCustomGridView read GetHitGridView;
    property GridPopupMenu: TcxGridPopupMenu read GetGridPopupMenu;
    property VisibleState: TcxGridPopupMenuOperationState read FVisibleState
      write FVisibleState default pmoDefault;
  end;
  ...
  protected
    function AddItem(AItemClass: TcxGridPopupMenuOperationClass)
  ...
  public
    ...
    property Items[Index: Integer]: TcxGridPopupMenuOperation
...
begin
  ...
  begin
    B := TBitmap.Create;
    try
      R := TResourceStream.Create(GetInstance, UpperCase(GetImageResourceName),
        RT_RCDATA);
      try
        B.LoadFromStream(R);
      finally
...
class function TcxGridPopupMenuOperation.GetParentOperationClass
  : TcxGridPopupMenuOperationClass;
begin
  Result := nil;
end;
...
function TcxGridPopupMenuOperation.GetGridOperationHelper
  : TcxGridOperationHelper;
begin
...
function TcxGridPopupMenuOperation.GetState
  (AState: TcxGridPopupMenuOperationState; AGetFunc: TcxGetStateFunc): Boolean;
begin
  case AState of
    pmoTrue:
      Result := True;
...
function TcxGridPopupMenuOperations.GetItem(Index: Integer)
  : TcxGridPopupMenuOperation;
begin
...
function TcxGridPopupMenuOperations.AddItem(AItemClass
  : TcxGridPopupMenuOperationClass): TcxGridPopupMenuOperation;
begin
...
function TcxGridPopupMenuOperations.CanProcess
