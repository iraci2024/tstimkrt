...
type
  ...
  TdxWizardControlViewStyleAeroBackButtonViewInfo = class
  ...
  public
    ...
    procedure Draw(DC: HDC; AFont: TFont; const ATextRect: TRect;
      const AText: string);
    procedure Flush;
  end;
  ...
  TdxWizardControlViewStyleAeroTitleViewInfo = class
  ...
  protected
    ...
    procedure DrawContent(ACanvas: TcxCanvas); override;
    //
    property Cache: TdxWizardControlViewStyleAeroTitleTextOnGlassCache
      read FCache;
  public
    ...
    function MeasureHeight: Integer; override;
    //
    property BackButtonViewInfo: TdxWizardControlViewStyleAeroBackButtonViewInfo
  ...
  TdxWizardControlViewStyleAeroHeaderViewInfo = class
  ...
  TdxWizardControlViewStyleAeroCommandAreaViewInfo = class
  ...
  TdxWizardControlViewStyleAeroWatermarkViewInfo = class
  ...
  protected
    function CreateCommandAreaViewInfo
      : TdxWizardControlCustomCommandAreaViewInfo; override;
    function CreateHeaderViewInfo
      : TdxWizardControlCustomHeaderViewInfo; override;
    ...
    function CreateWatermarkViewInfo
      : TdxWizardControlWatermarkViewInfo; override;
    function GetDefaultResizeAnimation
      : TdxWizardControlResizeAnimation; override;
    function GetDefaultTransitionEffect
      : TdxWizardControlTransitionEffect; override;
    function GetTransitionEffectAreaBounds: TRect; override;
  public
    procedure Calculate; override;
    procedure GetTabOrderList(AList: TdxWizardControlCellViewInfoList);
      override;
    //
    property TitleViewInfo: TdxWizardControlViewStyleAeroTitleViewInfo
      read GetTitleViewInfo;
  end;

implementation

uses
  cxGeometry, Math, dxGDIPlusClasses, cxDWMApi, SysUtils, dxCoreGraphics,
  dxUxTheme, dxDPIAwareUtils;
...
procedure TdxWizardControlViewStyleAeroPainter.DrawBackground
  (ACanvas: TcxCanvas; const ABounds: TRect);
begin
  ACanvas.FillRect(ABounds,
    cxGetActualColor(LookAndFeelPainter.DefaultEditorBackgroundColor(False),
    clWindow));
end;

procedure TdxWizardControlViewStyleAeroPainter.DrawCommandAreaBackground
  (ACanvas: TcxCanvas; const ABounds: TRect);
begin
...
procedure TdxWizardControlViewStyleAeroPainter.DrawSeparator(ACanvas: TcxCanvas;
  const R: TRect);
begin
  if IsSkinUsed then
...
procedure TdxWizardControlViewStyleAeroPainter.DrawTitleBackground
...
begin
  ...
  HeaderTitleFont.Size := ScaleFactor.Apply(12, HeaderTitleFont.PixelsPerInch,
    dxDefaultDPI);
...
function TdxWizardControlViewStyleAeroPainter.
  GetHeaderDescriptionTextColor: TColor;
begin
  if IsSkinUsed then
...
function TdxWizardControlViewStyleAeroWatermarkViewInfo.
  GetIsImageVisible: Boolean;
begin
...
function TdxWizardControlViewStyleAeroViewInfo.CreateCommandAreaViewInfo
  : TdxWizardControlCustomCommandAreaViewInfo;
begin
  Result := TdxWizardControlViewStyleAeroCommandAreaViewInfo.Create
    (WizardControl);
end;

function TdxWizardControlViewStyleAeroViewInfo.CreateHeaderViewInfo
  : TdxWizardControlCustomHeaderViewInfo;
begin
  Result := TdxWizardControlViewStyleAeroHeaderViewInfo.Create(WizardControl);
end;

function TdxWizardControlViewStyleAeroViewInfo.CreatePainter
  : TdxWizardControlCustomPainter;
begin
  Result := TdxWizardControlViewStyleAeroPainter.Create(WizardControl);
end;

function TdxWizardControlViewStyleAeroViewInfo.CreateTitleViewInfo
  : TdxWizardControlCustomTitleViewInfo;
begin
  Result := TdxWizardControlViewStyleAeroTitleViewInfo.Create(WizardControl);
end;

function TdxWizardControlViewStyleAeroViewInfo.CreateWatermarkViewInfo
  : TdxWizardControlWatermarkViewInfo;
begin
  Result := TdxWizardControlViewStyleAeroWatermarkViewInfo.Create
    (WizardControl);
end;

function TdxWizardControlViewStyleAeroViewInfo.GetDefaultResizeAnimation
  : TdxWizardControlResizeAnimation;
begin
  Result := wcraEnabled;
end;

function TdxWizardControlViewStyleAeroViewInfo.GetDefaultTransitionEffect
  : TdxWizardControlTransitionEffect;
begin
  Result := wcteFade;
end;

procedure TdxWizardControlViewStyleAeroViewInfo.GetTabOrderList
...
function TdxWizardControlViewStyleAeroViewInfo.GetTitleViewInfo
  : TdxWizardControlViewStyleAeroTitleViewInfo;
begin
  Result := inherited TitleViewInfo as
    TdxWizardControlViewStyleAeroTitleViewInfo;
end;

function TdxWizardControlViewStyleAeroViewInfo.
  GetTransitionEffectAreaBounds: TRect;
begin
  Result := Bounds;
...
function TdxWizardControlViewStyleAeroBackButtonViewInfo.CanDrawContent
  : Boolean;
begin
  Result := True;
end;
...
procedure TdxWizardControlViewStyleAeroBackButtonViewInfo.DrawContent
  (ACanvas: TcxCanvas);
begin
...
function TdxWizardControlViewStyleAeroBackButtonViewInfo.GetPainter
  : TdxWizardControlViewStyleAeroPainter;
begin
...
procedure TdxWizardControlViewStyleAeroCommandAreaViewInfo.CalculateButtons
  (var ABounds: TRect);
begin
  ...
  else if AlignButtonToRightSide(ActualNextButtonViewInfo, ABounds) then
    Dec(ABounds.Right, IndentBetweenGroups);
  if HasCustomButtonsAlignedLeft then
    CalculateCustomButtons(ABounds);
end;

function TdxWizardControlViewStyleAeroCommandAreaViewInfo.
...
function TdxWizardControlViewStyleAeroCommandAreaViewInfo.
  GetIndentBetweenElementsInGroup: Integer;
begin
  Result := ScaleFactor.Apply(dxViewStyleAeroIndentBetweenElementsInGroup);
end;

function TdxWizardControlViewStyleAeroCommandAreaViewInfo.
  GetIndentBetweenGroups: Integer;
begin
...
function TdxWizardControlViewStyleAeroHeaderViewInfo.
  GetDescriptionIsVisible: Boolean;
var
...
function TdxWizardControlViewStyleAeroHeaderViewInfo.
  GetIndentBetweenElements: Integer;
begin
  Result := ScaleFactor.Apply(dxViewStyleAeroIndentBetweenElementsInGroup);
end;
...
constructor TdxWizardControlViewStyleAeroTitleViewInfo.Create
...
procedure TdxWizardControlViewStyleAeroTitleViewInfo.CalculateBackButton
  (var R: TRect);
var
  ABackButtonBounds: TRect;
begin
  ABackButtonBounds := cxRectCenterVertically(R,
    BackButtonViewInfo.MeasureHeight);
  ABackButtonBounds := cxRectSetWidth(ABackButtonBounds,
    BackButtonViewInfo.MeasureWidth);
  ...
  R.Left := BackButtonViewInfo.Bounds.Right + ScaleFactor.Apply
    (dxViewStyleAeroIndentBetweenElementsInGroup);
end;

procedure TdxWizardControlViewStyleAeroTitleViewInfo.CalculateGlyph
  (var R: TRect);
begin
  ...
  begin
    ...
    R.Left := GlyphRect.Right + ScaleFactor.Apply
      (dxViewStyleAeroIndentBetweenElementsInGroup);
  end
  else
...
procedure TdxWizardControlViewStyleAeroTitleViewInfo.CalculateTextRect
  (var R: TRect);
begin
  if IsPaintOnGlass then
  begin
    cxScreenCanvas.Font := Font;
    FTextRect := cxRectSetWidth(R, cxScreenCanvas.TextWidth(Title.Text) + 2 *
      ScaleFactor.Apply(dxViewStyleAeroGlowingSize));
...
procedure TdxWizardControlViewStyleAeroTitleViewInfo.DrawContent
  (ACanvas: TcxCanvas);
var
  AFormat: Cardinal;
begin
  ...
  begin
    ...
    begin
      ...
      try
        ACanvas.Font := Font;
        ACanvas.Font.Color := cxGetActualColor(Painter.TitleTextColor,
          clWindowText);
...
begin
  Result := Max(TdxTextMeasurer.TextLineHeight(Font),
    BackButtonViewInfo.MeasureHeight);
  Result := Max(Result, GlyphAreaSize.cy);
  Result := Max(Result + 2 * ScaleFactor.Apply(cxTextSpace),
    ScaleFactor.Apply(dxViewStyleAeroTitleHeight));
  if IsPaintOnGlass then
...
begin
  Result := cxSize(dxGetSystemMetrics(SM_CXSMICON, ScaleFactor),
...
procedure TdxWizardControlViewStyleAeroTitleTextOnGlassCache.Draw(DC: HDC;
AFont: TFont; const ATextRect: TRect; const AText: string);

  function CheckFont(AFont: TFont): Boolean;
  begin
    Result := (AFont.Name = FFontName) and (AFont.Style = FFontStyle) and
      (AFont.Height = FFontHeight);
  end;
...
var
  AFlags: Integer;
begin
  if (FCache = nil) or not(CheckFont(AFont) and CheckSize(ATextRect)) or
    (FText <> AText) then
  begin
    Flush;
    FText := AText;
    ...
    try
      ...
      dxDrawTextOnGlass(Cache.Canvas.Handle, AText, AFont, Cache.ClientRect,
        clWindowText, AFlags, dxViewStyleAeroGlowingSize, True);
    finally
      Cache.Canvas.Unlock;
    end;
  end;
