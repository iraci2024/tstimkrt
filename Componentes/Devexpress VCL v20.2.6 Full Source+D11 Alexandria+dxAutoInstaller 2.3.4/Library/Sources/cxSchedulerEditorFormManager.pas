...
uses
  SysUtils, Classes, Controls, cxClasses, Graphics, cxSchedulerStorage, dxCore,
  dxCoreClasses,
  Forms;
...
type
  ...
  public
    class function CreateEditor(AEvent: TcxSchedulerControlEvent)
      : IcxSchedulerEventEditorForm; virtual;
    class function GetName: string; virtual;
    class function GetUnitName: string; virtual;
  end;

  TcxShedulerEventEditorFormStyleInfoClass = class of
  ...
  private
    ...
    function GetCurrentEditorFormStyleInfo
      : TcxShedulerEventEditorFormStyleInfoClass;
    function GetItem(Index: Integer)
      : TcxShedulerEventEditorFormStyleInfoClass; inline;
  ...
  public
    ...
    function CreateEditor(const ADialogsStyle: string;
    ...
    procedure RegisterShedulerEditorForm(AShedulerEditorFormStyleInfo
      : TcxShedulerEventEditorFormStyleInfoClass);
    procedure UnregisterShedulerEditorForm(AShedulerEditorFormStyleInfo
      : TcxShedulerEventEditorFormStyleInfoClass);

    property Count: Integer read GetCount;
    property CurrentEditorFormStyle: TCaption read GetCurrentEditorFormStyle
      write SetCurrentEditorFormStyle;
    property CurrentEditorFormStyleInfo
      : TcxShedulerEventEditorFormStyleInfoClass
      read GetCurrentEditorFormStyleInfo;
    property Items[Index: Integer]: TcxShedulerEventEditorFormStyleInfoClass
      read GetItem;
...
class function TcxShedulerEventEditorFormStyleInfo.CreateEditor
  (AEvent: TcxSchedulerControlEvent): IcxSchedulerEventEditorForm;
begin
  Result := nil;
end;
...
function TcxSchedulerEventEditorFormManager.CreateEditor(const ADialogsStyle
  : string; AEvent: TcxSchedulerControlEvent): IcxSchedulerEventEditorForm;
var
  AIndex: Integer;
begin
...
function TcxSchedulerEventEditorFormManager.GetIndexByName
...
procedure TcxSchedulerEventEditorFormManager.PopulateShedulerEditorFormList
  (AStrings: TStrings);
var
  I: Integer;
begin
...
function TcxSchedulerEventEditorFormManager.GetCurrentEditorFormStyleInfo
  : TcxShedulerEventEditorFormStyleInfoClass;
begin
  CheckItemIndex;
...
function TcxSchedulerEventEditorFormManager.GetItem(Index: Integer)
  : TcxShedulerEventEditorFormStyleInfoClass;
begin
...
procedure TcxSchedulerEventEditorFormManager.SetCurrentEditorFormStyle
  (AValue: TCaption);
begin
