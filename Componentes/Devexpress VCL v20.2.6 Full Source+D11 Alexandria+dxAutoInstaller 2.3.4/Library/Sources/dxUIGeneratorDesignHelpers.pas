...
{$IFDEF DELPHIXE3}
  Actions,
{$ENDIF}
  SysUtils, Classes, Controls, ActnList, dxCoreReg, dxUIGenerator, DesignIntf,
  ...
  begin
    ...
    try
      ...
      begin
        ...
        ACategory.Enum(procedure(AInfo: TdxUIGeneratorCommandInfo)
          begin
...
constructor TdxUIGeneratorComponentEditor.Create(AComponent: TComponent;
ADesigner: IDesigner);
var
  AInfo: TdxUIGeneratorComponentInfo;
begin
  inherited Create(AComponent, ADesigner);
  FHasGenerator := TdxUIGenerator.GetComponentInfo(Component, AInfo) and
    (TdxUIGenerator.AdapterCount > 0);
end;
