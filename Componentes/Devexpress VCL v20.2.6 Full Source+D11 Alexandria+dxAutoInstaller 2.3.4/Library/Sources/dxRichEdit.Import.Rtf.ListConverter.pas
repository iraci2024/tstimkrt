...
type
  ...
  private
    ...
    procedure CreateNumberingListsCore(AListOverrideTable: TdxListOverrideTable;
      AListTable: TdxRtfListTable);
    procedure CreateAbstractNumberingLists(AListTable: TdxRtfListTable);
    function CreateAbstractNumberingList(ARtfList: TdxRtfNumberingList)
      : TdxAbstractNumberingList;
    class procedure ConvertPropertyRtfToNumbering(ARtfLevel: TdxRtfListLevel;
      const ALevel: IdxListLevelProperties;
      ARestart, AReformat: Boolean); static;
    function FindAbstractNumberingListByStyle(AStyleIndex: Integer)
      : TdxAbstractNumberingListIndex;
    procedure FixBrokenListStyles;
    procedure LinkNumberingListStyles(AListOverrideTable: TdxListOverrideTable;
      AListTable: TdxRtfListTable);
  protected
    function IsHybridList(ARtfList: TdxRtfNumberingList): Boolean;
    function GetStyleIndex(ARtfParentStyleId: TdxRtfListId): Integer;
    function GetListIndex(AListId: Integer;
      ALists: TdxAbstractNumberingListCollection)
      : TdxAbstractNumberingListIndex;
    procedure ConvertRtfListToNumberingList(ARtfLevels
      : TdxObjectList<TdxRtfListLevel>; AList: TdxAbstractNumberingList);

  public
    constructor Create(AImporter: TdxRtfImporter);
    destructor Destroy; override;
    procedure Convert(AListTable: TdxRtfListTable;
      AListOverrideTable: TdxListOverrideTable);
    procedure ConvertRtfOverrideToNumbering(AList: TdxNumberingList;
      ARtfOverride: TdxRtfNumberingListOverride);
...
procedure TdxRtfListConverter.Convert(AListTable: TdxRtfListTable;
  AListOverrideTable: TdxListOverrideTable);
begin
...
procedure TdxRtfListConverter.CreateNumberingListsCore(AListOverrideTable
  : TdxListOverrideTable; AListTable: TdxRtfListTable);
var
...
begin
  ...
  begin
    ...
    ANumberingListIndex := DocumentModel.NumberingLists.Count - 1;
    Importer.ListOverrideIndexToNumberingListIndexMap.AddOrSetValue(AOverrideId,
      ANumberingListIndex);
    AList.SetId(DocumentModel.NumberingLists.Count);
  end;
end;

procedure TdxRtfListConverter.CreateAbstractNumberingLists
  (AListTable: TdxRtfListTable);
var
  I, ACount: Integer;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        if DocumentModel.NumberingListStyles.GetStyleIndexByName
          (ARtfList.StyleName) < 0 then
        begin
          AStyle := TdxNumberingListStyle.Create(DocumentModel,
            ARtfList.StyleName);
...
function TdxRtfListConverter.CreateAbstractNumberingList
  (ARtfList: TdxRtfNumberingList): TdxAbstractNumberingList;
begin
...
function TdxRtfListConverter.IsHybridList
  (ARtfList: TdxRtfNumberingList): Boolean;
var
...
procedure TdxRtfListConverter.LinkNumberingListStyles(AListOverrideTable
  : TdxListOverrideTable; AListTable: TdxRtfListTable);
var
  ACount, I: Integer;
  AAbstractNumberingLists: TdxAbstractNumberingListCollection;
...
begin
  ...
  begin
    ...
    begin
      ...
      AList.SetId(DocumentModel.NumberingLists.Count);
      AOverrideId := ARtfList.Id;
      Importer.ListOverrideIndexToNumberingListIndexMap.AddOrSetValue
        (AOverrideId, ANumberingListIndex);
      DocumentModel.NumberingListStyles[AAbstractList.StyleLinkIndex]
        .SetNumberingListIndex(ANumberingListIndex);
    end;
  end;
end;

function TdxRtfListConverter.GetStyleIndex(ARtfParentStyleId
...
function TdxRtfListConverter.GetListIndex(AListId: Integer;
  ALists: TdxAbstractNumberingListCollection): TdxAbstractNumberingListIndex;
var
...
procedure TdxRtfListConverter.ConvertRtfOverrideToNumbering
  (AList: TdxNumberingList; ARtfOverride: TdxRtfNumberingListOverride);
var
  I, ACount: Integer;
    ...
    begin
      ...
      try
        ALevel.ListLevelProperties.CopyFrom
          (AList.Levels[I].ListLevelProperties);
        ALevel.CharacterProperties.CopyFrom
          (ARtfOverride.Levels[I].Level.CharacterProperties);
        ALevel.ParagraphProperties.CopyFrom
          (ARtfOverride.Levels[I].Level.ParagraphProperties);
        ConvertPropertyRtfToNumbering(ARtfOverride.Levels[I].Level,
          ALevel.ListLevelProperties, ARestart, AReformat);
      finally
...
procedure TdxRtfListConverter.ConvertRtfListToNumberingList
  (ARtfLevels: TdxObjectList<TdxRtfListLevel>; AList: TdxAbstractNumberingList);
var
  I, ACount: Integer;
  ALevel: TdxListLevel;
begin
  ...
  begin
    ...
    ConvertPropertyRtfToNumbering(ARtfLevels[I], ALevel.ListLevelProperties,
      True, True);
  end;
end;

class procedure TdxRtfListConverter.ConvertPropertyRtfToNumbering
  (ARtfLevel: TdxRtfListLevel; const ALevel: IdxListLevelProperties;
  ARestart, AReformat: Boolean);
var
...
begin
  ...
  begin
    ...
    ALevel.ConvertPreviousLevelNumberingToDecimal :=
