...
type
  ...
  public
    ...
    function GetStoredValue(AValueSource: TcxDataEditValueSource;
      AFocused: Boolean): Variant; virtual;
    ...
    property VisualControl: TComponent read FVisualControl
      write SetVisualControl;
    property OnDataChange: TcxDataBindingNotifyEvent read FOnDataChange
      write FOnDataChange;
    property OnDataSetChange: TcxDataBindingNotifyEvent read FOnDataSetChange
      write FOnDataSetChange;
    property OnUpdateData: TcxDataBindingNotifyEvent read FOnUpdateData
      write FOnUpdateData;
  end;

  TcxCustomDataBindingClass = class of TcxCustomDataBinding;

function DataCompareText(const S1, S2: string; APartialCompare: Boolean;
  AIsAnywhere: Boolean = False): Boolean;
...
begin
  ...
  else if not APartialCompare then
    Result := AText1 = AText2
  else if AIsAnywhere then
...
function TcxCustomDataBinding.GetStoredValue(AValueSource
...
procedure TcxCustomDataBinding.SetStoredValue(AValueSource
