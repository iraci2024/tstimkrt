...
type
  ...
  public
    constructor Create(ADocumentModel: TdxCustomDocumentModel;
      const AOptions: IdxExporterOptions); reintroduce;
    destructor Destroy; override;

    function ExportSaveMemory: TdxChunkedStringBuilder; override;
    procedure ExportFootEndNotes(ANotes: TList<TdxFootNoteExportInfo>;
...
begin
  ...
  begin
    ...
    if (ATrail = #10#13) or (ATrail = #13#10) then
      Result := ALength - 2
    else if CharInSet(ATrail[1], [#13, #10]) then
      Result := ALength - 1
    else
      Result := ALength;
  end;
...
procedure TdxPlainTextExporter.ExportFirstPageHeader(ASectionHeader
  : TdxSectionHeader; ALinkedToPrevious: Boolean);
begin
end;

procedure TdxPlainTextExporter.ExportOddPageHeader(ASectionHeader
  : TdxSectionHeader; ALinkedToPrevious: Boolean);
begin
end;

procedure TdxPlainTextExporter.ExportEvenPageHeader(ASectionHeader
  : TdxSectionHeader; ALinkedToPrevious: Boolean);
begin
end;

procedure TdxPlainTextExporter.ExportFirstPageFooter(ASectionFooter
  : TdxSectionFooter; ALinkedToPrevious: Boolean);
begin
end;

procedure TdxPlainTextExporter.ExportOddPageFooter(ASectionFooter
  : TdxSectionFooter; ALinkedToPrevious: Boolean);
begin
end;

procedure TdxPlainTextExporter.ExportEvenPageFooter(ASectionFooter
  : TdxSectionFooter; ALinkedToPrevious: Boolean);
begin
end;

function TdxPlainTextExporter.ExportParagraph(AParagraph: TdxParagraph)
  : TdxParagraphIndex;
begin
  if FOptions.ExportBulletsAndNumbering and AParagraph.IsInList and AParagraph.ShouldExportNumbering
  then
...
procedure TdxPlainTextExporter.ExportFootEndNotes
  (ANotes: TList<TdxFootNoteExportInfo>; const ASeparator: string);
var
  ACount, I: Integer;
begin
  ACount := ANotes.Count;
...
begin
  ...
  begin
    ...
    ExportFootNoteRunReference(AInfo,
...
procedure TdxPlainTextExporter.ExportFootNoteRunReference
  (const AInfo: TdxFootNoteExportInfo; const AFormat: string);
begin
...
class function TdxExportPlainTextFormat.GetDocumentFormat
  : TdxRichEditDocumentFormat;
begin
  Result := TdxRichEditDocumentFormat.PlainText;
end;

function TdxExportPlainTextFormat.GetExporter(ADocumentModel
