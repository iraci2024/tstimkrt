...
type
  ...
  TdxDigitType = (Zero, SingleNumeral, Single, Teen, Tenth, Hundred, Thousand,
    Million, Billion, Trillion, Quadrillion, Quintillion, Separator);
  ...
  public
    constructor Create(const AProvider: IdxNumericsProvider;
      ANumber: Int64); virtual;
  ...
  public
    constructor Create;
    function TryConvert(ANumber: Integer; out AResult: string)
      : Boolean; virtual;
  end;
  ...
  protected
    function ConvertCore(AIntegerPart: Integer; AFractionPart: Integer)
      : string; virtual;
    function GetCardinalText(AIntegerPart: Integer): string;
    function GetContactString: string; virtual; abstract;
    function GetNumberConverter: TdxDescriptiveNumberConverterBase;
      virtual; abstract;
  public
  ...
  TdxDescriptiveNumberConverterBase = class abstract
  ...
  protected
    procedure GenerateQuintillionSeparator(ADigits: TdxDigitInfoCollection;
      const AProvider: IdxNumericsProvider; AValue: Int64); virtual;
    function GenerateQuintillionProvider: IdxNumericsProvider; virtual;
    procedure GenerateQuintillionDigits(ADigits: TdxDigitInfoCollection;
      AValue: Int64); virtual;
    procedure GenerateQuadrillionSeparator(ADigits: TdxDigitInfoCollection;
      const AProvider: IdxNumericsProvider; AValue: Int64); virtual;
    function GenerateQuadrillionProvider: IdxNumericsProvider; virtual;
    procedure GenerateQuadrillionDigits(ADigits: TdxDigitInfoCollection;
      AValue: Int64); virtual;
    procedure GenerateTrillionSeparator(ADigits: TdxDigitInfoCollection;
      const AProvider: IdxNumericsProvider; AValue: Int64); virtual;
    function GenerateTrillionProvider: IdxNumericsProvider; virtual;
    procedure GenerateTrillionDigits(ADigits: TdxDigitInfoCollection;
      AValue: Int64); virtual;
    procedure GenerateBillionSeparator(ADigits: TdxDigitInfoCollection;
      const AProvider: IdxNumericsProvider; AValue: Int64); virtual;
    function GenerateBillionProvider: IdxNumericsProvider; virtual;
    procedure GenerateBillionDigits(ADigits: TdxDigitInfoCollection;
      AValue: Int64); virtual;
    procedure GenerateMillionSeparator(ADigits: TdxDigitInfoCollection;
      const AProvider: IdxNumericsProvider; AValue: Int64); virtual;
    function GenerateMillionProvider: IdxNumericsProvider; virtual;
    procedure GenerateMillionDigits(ADigits: TdxDigitInfoCollection;
      AValue: Int64); virtual;
    procedure GenerateThousandSeparator(ADigits: TdxDigitInfoCollection;
      const AProvider: IdxNumericsProvider; AValue: Int64); virtual;
    function GenerateThousandProvider: IdxNumericsProvider; virtual;
    procedure GenerateThousandDigits(ADigits: TdxDigitInfoCollection;
      AValue: Int64); virtual;
    procedure GenerateHundredSeparator(ADigits: TdxDigitInfoCollection;
      const AProvider: IdxNumericsProvider); virtual;
    function GenerateHundredProvider: IdxNumericsProvider; virtual;
    procedure GenerateHundredDigits(ADigits: TdxDigitInfoCollection;
      AValue: Int64); virtual;
    procedure GenerateTenthsSeparator(ADigits: TdxDigitInfoCollection;
      const AProvider: IdxNumericsProvider); virtual;
    function GenerateTenthsProvider: IdxNumericsProvider; virtual;
    procedure GenerateTenthsDigits(ADigits: TdxDigitInfoCollection;
      AValue: Int64); virtual;
    procedure GenerateTeensSeparator(ADigits: TdxDigitInfoCollection;
      const AProvider: IdxNumericsProvider; AValue: Int64); virtual;
    function GenerateTeensProvider: IdxNumericsProvider; virtual;
    procedure GenerateTeensDigits(ADigits: TdxDigitInfoCollection;
      AValue: Int64); virtual;
    procedure GenerateSinglesSeparator(ADigits: TdxDigitInfoCollection;
      const AProvider: IdxNumericsProvider; AValue: Int64); virtual;
    function GenerateSinglesProvider: IdxNumericsProvider; virtual;
    procedure GenerateSinglesDigits(ADigits: TdxDigitInfoCollection;
      AValue: Int64); virtual;
    procedure GenerateDigitsInfo(ADigits: TdxDigitInfoCollection;
      AValue: Int64); virtual;
    procedure GenerateDigits(ADigits: TdxDigitInfoCollection;
      AValue: Int64); virtual;
    procedure AddZero(ADigits: TdxDigitInfoCollection); virtual;
    function ConvertDigitsToString(ADigits: TdxDigitInfoCollection)
      : string; virtual;
    ...
    property FlagQuadrillion: Boolean read FFlagQuadrillion
      write FFlagQuadrillion;
    property FlagQuintillion: Boolean read FFlagQuintillion
      write FFlagQuintillion;
...
constructor TdxDigitInfo.Create(const AProvider: IdxNumericsProvider;
  ANumber: Int64);
begin
  inherited Create;
  FProvider := AProvider;
...
constructor TdxSingleNumeralDigitInfo.Create(const AProvider
  : IdxNumericsProvider; ANumber: Int64);
begin
...
constructor TdxSingleDigitInfo.Create(const AProvider: IdxNumericsProvider;
  ANumber: Int64);
begin
  inherited Create(AProvider, ANumber - 1);
end;
...
constructor TdxTenthsDigitInfo.Create(const AProvider: IdxNumericsProvider;
  ANumber: Int64);
begin
...
constructor TdxHundredsDigitInfo.Create(const AProvider: IdxNumericsProvider;
  ANumber: Int64);
begin
  inherited Create(AProvider, ANumber - 1);
end;
...
begin
  Result := (FlagMillion) or (FlagBillion) or (FlagTrillion) or
    (FlagQuadrillion) or (FlagQuintillion);
end;
...
procedure TdxDescriptiveNumberConverterBase.GenerateQuintillionSeparator
  (ADigits: TdxDigitInfoCollection; const AProvider: IdxNumericsProvider;
  AValue: Int64);
begin
...
function TdxDescriptiveNumberConverterBase.GenerateQuintillionProvider
  : IdxNumericsProvider;
begin
  Result := TdxCardinalEnglishNumericsProvider.Create;
end;

procedure TdxDescriptiveNumberConverterBase.GenerateQuintillionDigits
  (ADigits: TdxDigitInfoCollection; AValue: Int64);
begin
...
procedure TdxDescriptiveNumberConverterBase.GenerateQuadrillionSeparator
  (ADigits: TdxDigitInfoCollection; const AProvider: IdxNumericsProvider;
  AValue: Int64);
begin
  if ADigits.Count <> 0 then
...
function TdxDescriptiveNumberConverterBase.GenerateQuadrillionProvider
  : IdxNumericsProvider;
begin
  Result := TdxCardinalEnglishNumericsProvider.Create;
end;

procedure TdxDescriptiveNumberConverterBase.GenerateQuadrillionDigits
  (ADigits: TdxDigitInfoCollection; AValue: Int64);
begin
...
procedure TdxDescriptiveNumberConverterBase.GenerateTrillionSeparator
  (ADigits: TdxDigitInfoCollection; const AProvider: IdxNumericsProvider;
  AValue: Int64);
begin
  if ADigits.Count <> 0 then
...
function TdxDescriptiveNumberConverterBase.GenerateTrillionProvider
  : IdxNumericsProvider;
begin
  Result := TdxCardinalEnglishNumericsProvider.Create;
end;

procedure TdxDescriptiveNumberConverterBase.GenerateTrillionDigits
  (ADigits: TdxDigitInfoCollection; AValue: Int64);
begin
  FlagTrillion := True;
  GenerateDigitsInfo(ADigits, AValue);
...
procedure TdxDescriptiveNumberConverterBase.GenerateBillionSeparator
  (ADigits: TdxDigitInfoCollection; const AProvider: IdxNumericsProvider;
  AValue: Int64);
begin
  if ADigits.Count <> 0 then
...
function TdxDescriptiveNumberConverterBase.GenerateBillionProvider
  : IdxNumericsProvider;
begin
  Result := TdxCardinalEnglishNumericsProvider.Create;
end;

procedure TdxDescriptiveNumberConverterBase.GenerateBillionDigits
  (ADigits: TdxDigitInfoCollection; AValue: Int64);
begin
  FlagBillion := True;
  GenerateDigitsInfo(ADigits, AValue);
...
procedure TdxDescriptiveNumberConverterBase.GenerateMillionSeparator
  (ADigits: TdxDigitInfoCollection; const AProvider: IdxNumericsProvider;
  AValue: Int64);
begin
  if ADigits.Count <> 0 then
...
function TdxDescriptiveNumberConverterBase.GenerateMillionProvider
  : IdxNumericsProvider;
begin
  Result := TdxCardinalEnglishNumericsProvider.Create;
end;

procedure TdxDescriptiveNumberConverterBase.GenerateMillionDigits
  (ADigits: TdxDigitInfoCollection; AValue: Int64);
begin
  FlagMillion := True;
  GenerateDigitsInfo(ADigits, AValue);
...
procedure TdxDescriptiveNumberConverterBase.GenerateThousandSeparator
  (ADigits: TdxDigitInfoCollection; const AProvider: IdxNumericsProvider;
  AValue: Int64);
begin
  if ADigits.Count <> 0 then
...
function TdxDescriptiveNumberConverterBase.GenerateThousandProvider
  : IdxNumericsProvider;
begin
  Result := TdxCardinalEnglishNumericsProvider.Create;
end;

procedure TdxDescriptiveNumberConverterBase.GenerateThousandDigits
  (ADigits: TdxDigitInfoCollection; AValue: Int64);
begin
  FlagThousand := True;
  GenerateDigitsInfo(ADigits, AValue);
...
procedure TdxDescriptiveNumberConverterBase.GenerateHundredSeparator
  (ADigits: TdxDigitInfoCollection; const AProvider: IdxNumericsProvider);
begin
  if ADigits.Count <> 0 then
    ADigits.Add(TdxSeparatorDigitInfo.Create(AProvider, 0));
...
function TdxDescriptiveNumberConverterBase.GenerateHundredProvider
  : IdxNumericsProvider;
begin
  Result := TdxCardinalEnglishNumericsProvider.Create;
end;

procedure TdxDescriptiveNumberConverterBase.GenerateHundredDigits
  (ADigits: TdxDigitInfoCollection; AValue: Int64);
begin
...
procedure TdxDescriptiveNumberConverterBase.GenerateTenthsSeparator
  (ADigits: TdxDigitInfoCollection; const AProvider: IdxNumericsProvider);
begin
  if ADigits.Count <> 0 then
    ADigits.Add(TdxSeparatorDigitInfo.Create(AProvider, 0));
...
function TdxDescriptiveNumberConverterBase.GenerateTenthsProvider
  : IdxNumericsProvider;
begin
  Result := TdxCardinalEnglishNumericsProvider.Create;
end;

procedure TdxDescriptiveNumberConverterBase.GenerateTenthsDigits
  (ADigits: TdxDigitInfoCollection; AValue: Int64);
begin
...
procedure TdxDescriptiveNumberConverterBase.GenerateTeensSeparator
  (ADigits: TdxDigitInfoCollection; const AProvider: IdxNumericsProvider;
  AValue: Int64);
begin
  if ADigits.Count <> 0 then
...
function TdxDescriptiveNumberConverterBase.GenerateTeensProvider
  : IdxNumericsProvider;
begin
  Result := TdxCardinalEnglishNumericsProvider.Create;
end;

procedure TdxDescriptiveNumberConverterBase.GenerateTeensDigits
  (ADigits: TdxDigitInfoCollection; AValue: Int64);
begin
...
procedure TdxDescriptiveNumberConverterBase.GenerateSinglesSeparator
  (ADigits: TdxDigitInfoCollection; const AProvider: IdxNumericsProvider;
  AValue: Int64);
begin
  if ADigits.Count <> 0 then
...
function TdxDescriptiveNumberConverterBase.GenerateSinglesProvider
  : IdxNumericsProvider;
begin
  Result := TdxCardinalEnglishNumericsProvider.Create;
end;

procedure TdxDescriptiveNumberConverterBase.GenerateSinglesDigits
  (ADigits: TdxDigitInfoCollection; AValue: Int64);
begin
  if AValue = 0 then
    Exit;
  ...
  if FlagThousand then
    ADigits.Add(TdxSingleNumeralDigitInfo.Create
      (GenerateSinglesProvider, AValue))
  else
    ADigits.Add(TdxSingleDigitInfo.Create(GenerateSinglesProvider, AValue));
  FlagThousand := False;
end;

procedure TdxDescriptiveNumberConverterBase.GenerateDigitsInfo
  (ADigits: TdxDigitInfoCollection; AValue: Int64);
begin
...
procedure TdxDescriptiveNumberConverterBase.GenerateDigits
  (ADigits: TdxDigitInfoCollection; AValue: Int64);
begin
  GenerateDigitsInfo(ADigits, AValue);
  if ADigits.Count = 0 then
...
procedure TdxDescriptiveNumberConverterBase.AddZero
  (ADigits: TdxDigitInfoCollection);
begin
  ADigits.Add(TdxZeroDigitInfo.Create(GenerateSinglesProvider));
end;

function TdxDescriptiveNumberConverterBase.ConvertNumberCore
  (AValue: Int64): string;
var
  ADigits: TdxDigitInfoCollection;
begin
...
function TdxDescriptiveNumberConverterBase.ConvertDigitsToString
  (ADigits: TdxDigitInfoCollection): string;
var
...
function TdxDescriptiveNumberConverterBase.IsDigitInfoGreaterHundred
  (AInfo: TdxDigitInfo): Boolean;
begin
  Result := (AInfo.&Type = TdxDigitType.Thousand) or
    (IsDigitInfoGreaterThousand(AInfo));
end;

function TdxDescriptiveNumberConverterBase.IsDigitInfoGreaterThousand
  (AInfo: TdxDigitInfo): Boolean;
var
  AType: TdxDigitType;
begin
  ...
  Result := (AType = TdxDigitType.Million) or (AType = TdxDigitType.Billion) or
    (AType = TdxDigitType.Trillion) or (AType = TdxDigitType.Quadrillion) or
    (AType = TdxDigitType.Quintillion);
end;
...
function TdxNumberToDollarTextConverter.ConvertCore(AIntegerPart: Integer;
  AFractionPart: Integer): string;
var
...
begin
  ...
  if (0 < AFractionPart) and (AFractionPart < 100) then
    Result := Format('%s %s %d/100', [ACardinalText, AContactString,
      AFractionPart])
  else
    Result := Format('%s %s 00/100', [ACardinalText, AContactString]);
end;

function TdxNumberToDollarTextConverter.GetCardinalText
  (AIntegerPart: Integer): string;
var
