...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Windows, Messages, Types, Classes, Graphics, SysUtils, Forms,
  Controls {must be after Forms for D11} , ImgList,
  dxCore, cxClasses, cxGraphics, cxControls, cxLookAndFeels,
  cxLookAndFeelPainters, dxCustomHint, dxGDIPlusClasses,
...
type
  ...
  TdxOnGetScreenTip = procedure(Sender: TObject; var AScreenTip: TdxScreenTip)
    of object;
  ...
  published
    ...
    property GlyphFixedWidth: Boolean read FGlyphFixedWidth
      write SetGlyphFixedWidth default True;
    property PlainText: Boolean read FPlainText write SetPlainText default True;
    property Text: string read FText write SetText;
    property TextAlign: TdxScreenTipBandTextAlign read FTextAlign
      write SetTextAlign default stbtaRight;
  end;
  ...
  public
    constructor Create(AScreenTip: TdxScreenTip;
      ABandType: TdxScreenTipBandType); virtual;
  ...
  public
    ...
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    function GetBandForCalculation(Index: TdxScreenTipBandType)
      : TdxCustomScreenTipBand;
    function GetWidth: Integer; virtual;

    property Collection: TdxScreenTipCollection read GetCollection;
  published
    property Header: TdxScreenTipBand index stbHeader read GetBand
      write SetBand;
    property Description: TdxScreenTipBand index stbDescription read GetBand
      write SetBand;
    property Footer: TdxScreenTipBand index stbFooter read GetBand
      write SetBand;
    property UseHintAsHeader: Boolean read FUseHintAsHeader
      write FUseHintAsHeader default False;
    property UseStandardFooter: Boolean read FUseStandardFooter
      write FUseStandardFooter default False;
  ...
  public
    ...
    property Repository: TdxScreenTipRepository read FRepository;
    property Items[Index: Integer]: TdxScreenTip read GetItem
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property AssignedFonts: TdxScreenTipRepositoryFonts read FAssignedFonts
      write FAssignedFonts default [];
    property Items: TdxScreenTipCollection read FItems write SetItems;
    property DescriptionFont: TFont index stbDescription read GetFont
      write SetFont stored IsFontStored;
    property FooterFont: TFont index stbFooter read GetFont write SetFont
      stored IsFontStored;
    property HeaderFont: TFont index stbHeader read GetFont write SetFont
      stored IsFontStored;
    property StandardFooter: TdxScreenTipFooterBand read FStandardFooter
      write SetStandardFooter;
    property ShowDescription: Boolean read FShowDescription
      write FShowDescription default True;
  end;
  ...
  protected
    ...
    procedure CalculateTextHeight(ACanvas: TCanvas; AText: string;
      var ARect: TRect);
  ...
  public
    constructor Create(ABand: TdxCustomScreenTipBand;
      const AHintText, AShortCut: string; AScaleFactor: TdxScaleFactor);
    procedure Calculate(ACanvas: TCanvas; APainter: TdxScreenTipPainter;
      ATop, AWidth: Integer);
  ...
  protected
    function CreateBandViewInfo(ABand: TdxCustomScreenTipBand)
      : TdxScreenTipBandViewInfo; virtual;
  ...
  public
    ...
    property BandViewInfos[Index: Integer]: TdxScreenTipBandViewInfo
      read GetBandViewInfos;
  end;
  ...
  public
    constructor Create(AScreenTip: TdxScreenTip;
      APainter: TcxCustomLookAndFeelPainter; const AHintText: string;
      AShortCut: string = '');
  end;
  ...
  protected
    function FindLinkByComponent(AComponent: TComponent)
      : TdxCustomScreenTipLink;
  ...
  public
    ...
    property Items[Index: Integer]: TdxScreenTipLink read GetItem
      write SetItem; default;
  end;
  ...
  public
    ...
    property Items[Index: Integer]: TdxScreenTipActionLink read GetItem
      write SetItem; default;
  end;
  ...
  protected
    ...
    procedure GetScreenTipInfo(AControl: TControl; out AScreenTip: TdxScreenTip;
  ...
  public
    ...
    function GetScreenTipBounds(AScreenTip: TdxScreenTip;
      const AHint: string = ''): TRect;
    procedure ShowScreenTip(X, Y: Integer; AScreenTip: TdxScreenTip;
      const AHint: string = '');
  published
    property ScreenTipLinks: TdxScreenTipLinks read FScreenTipLinks
      write SetScreenTipLinks;
    property ScreenTipActionLinks: TdxScreenTipActionLinks
      read FScreenTipActionLinks write SetScreenTipActionLinks;
  end;
...
function TdxScreenTipRepository.GetBandFont
  (ABandType: TdxScreenTipBandType): TFont;
begin
...
procedure TdxScreenTipRepository.GetChildren(Proc: TGetChildProc;
  Root: TComponent);
var
  I: Integer;
begin
...
function TdxScreenTipRepository.GetSystemFont
  (ABandType: TdxScreenTipBandType): TFont;
begin
  Result := FSystemFont;
...
function TdxScreenTipRepository.IsDefaultBandTextColor
  (ABandType: TdxScreenTipBandType): Boolean;
begin
...
procedure TdxScreenTipRepository.SetStandardFooter
  (Value: TdxScreenTipFooterBand);
begin
...
constructor TdxScreenTipCollection.Create(AParentComponent: TComponent;
...
constructor TdxScreenTipFooterBand.Create(ARepository: TdxScreenTipRepository);
begin
...
function TdxScreenTip.GetBandForCalculation(Index: TdxScreenTipBandType)
  : TdxCustomScreenTipBand;
begin
...
function TdxScreenTip.GetCollectionFromParent(AParent: TComponent)
...
constructor TdxScreenTipLikeHintViewInfo.Create
  (APainter: TcxCustomLookAndFeelPainter; const AHint, AShortCut: string;
...
begin
  ...
  begin
    ...
    if Band.TextAlign = stbtaRight then
    begin
      FGlyphBounds.Left := GetHorzIndent +
        (GetAvailGlyphWidth - FGlyphSize.cx) div 2;
      FGlyphBounds.Right := FGlyphBounds.Left + FGlyphSize.cx;
    end
    else
    begin
      FGlyphBounds.Right := AWidth -
        (GetHorzIndent + (GetAvailGlyphWidth - FGlyphSize.cx) div 2);
...
procedure TdxScreenTipBandViewInfo.CorrectMinWidth(ACanvas: TCanvas;
  var AWidth: Integer);
var
  AMinWidth: Integer;
begin
...
begin
  ...
  else if Band.BandType = stbDescription then
...
function TdxScreenTipBandViewInfo.GetVertIndent
  (APainter: TdxScreenTipPainter): Integer;
begin
  Result := 6;
...
procedure TdxScreenTipBandViewInfo.Paint(ACanvas: TcxCanvas;
  APainter: TdxScreenTipPainter);
...
begin
  ...
  if HasGlyph then
  begin
    cxDrawImage(ACanvas.Handle, GlyphBounds, GlyphBounds, Band.Glyph, nil, -1,
      idmNormal, False, 0, clDefault, True, APainter.GetColorPalette);
  end;
...
procedure TdxScreenTipBandViewInfo.CalculateTextHeight(ACanvas: TCanvas;
  AText: string; var ARect: TRect);
begin
  if IsPlainText then
...
begin
  ...
  else if IsTextCenter then
    Result := Result or DT_SINGLELINE or IfThen(not AIsCalculate, DT_VCENTER);
end;

function TdxScreenTipBandViewInfo.GetTextSize(ACanvas: TCanvas;
...
constructor TdxScreenTipViewInfoHelper.Create(AScreenTip: TdxScreenTip;
  APainter: TdxScreenTipPainter; const AHintText: string;
  AShortCut: string = '');
begin
  inherited Create;
  FScreenTip := AScreenTip;
...
procedure TdxScreenTipViewInfoHelper.Paint(ACanvas: TCanvas);
  ...
  begin
    Result := CreateRoundRectRgn(ARect.Left, ARect.Top, ARect.Right + 1,
      ARect.Bottom + 1, 2, 2);
  end;
...
begin
  ...
  try
    cxPaintCanvas.SetClipRegion(TcxRegion.Create(CreateRoundRgn(BoundsRect)),
      roIntersect);
...
function TdxScreenTipViewInfoHelper.GetBandViewInfos(Index: Integer)
  : TdxScreenTipBandViewInfo;
begin
...
function TdxScreenTipWindow.CalcHintRect(MaxWidth: Integer; const AHint: string;
  ...
  begin
    ...
    begin
      ...
      if AControl <> nil then
        TdxScreenTipStyle(AHintStyle).GetScreenTipInfo(AControl, AScreenTip,
          AShortCut);
    end;
  end;

  function CreateViewInfo(AHintStyle: TcxCustomHintStyle)
  ...
  begin
    ...
    if (AScreenTip <> nil) and AScreenTip.Collection.Repository.ShowDescription
    then
    begin
      if AScreenTip.UseHintAsHeader then
        AShortCut := '';
      Result := TdxScreenTipViewInfo.Create(AScreenTip, GetPainter, AHintText,
        AShortCut);
    end
    else
    begin
      if (AScreenTip <> nil) and not AScreenTip.UseHintAsHeader and
        (AScreenTip.Header.Text <> '') then
        AHintText := AScreenTip.Header.Text
      else
        AShortCut := '';

      Result := TdxScreenTipLikeHintViewInfo.Create(GetPainter, AHintText,
        AShortCut, GetMouseCursorPos);
    end;
  end;
...
function TdxCustomScreenTipLinks.FindLinkByComponent(AComponent: TComponent)
  : TdxCustomScreenTipLink;
var
  I: Integer;
...
begin
  if (FScreenTipLinks <> nil) and (FScreenTipActionLinks <> nil) and
    ((AComponent is TdxScreenTip) or (AComponent is TControl) or
...
begin
  AHintWindow := (Owner as TcxCustomHintStyleController)
    .HintWindow as TdxScreenTipWindow;
...
procedure TdxScreenTipStyle.DoShowHint(var AHintStr: string;
...
begin
  ...
  begin
    ...
    if (AScreenTip <> nil) and not AScreenTip.UseHintAsHeader then
      AHintStr := IfThen(AScreenTip.Header.Text <> '',
        AScreenTip.Header.Text, ' ');
  end;
end;
...
procedure TdxScreenTipStyle.GetScreenTipInfo(AControl: TControl;
  ...
  begin
    Result := Supports(AControl, IdxScreenTipProvider, AScreenTipProvider) or
      ...
      Supports(AManagedObject.GetManager, IdxScreenTipProvider,
      AScreenTipProvider);
  end;
...
begin
  ...
  else if GetScreenTipProvider(AControl, AScreenTipProvider) then
  begin
    AScreenTip := AScreenTipProvider.GetScreenTip;
    if (AScreenTip = nil) and (AScreenTipProvider.GetAction <> nil) then
      AScreenTip := ScreenTipActionLinks.FindScreenTipByAction
        (AScreenTipProvider.GetAction);
...
procedure TdxScreenTipStyle.SetScreenTipActionLinks
  (const Value: TdxScreenTipActionLinks);
begin
...
function TdxScreenTipLinks.FindScreenTipByControl(AControl: TControl)
  : TdxScreenTip;
var
  ALink: TdxCustomScreenTipLink;
begin
...
function TdxScreenTipActionLinks.FindScreenTipByAction(AAction: TBasicAction)
  : TdxScreenTip;
var
  ALink: TdxCustomScreenTipLink;
begin
...
function TdxScreenTipActionLinks.GetItem(Index: Integer)
  : TdxScreenTipActionLink;
begin
...
constructor TdxScreenTipLikeHintViewInfoHelper.Create
  (APainter: TdxScreenTipPainter; const AHint, AShortCut: string;
  const ACursorPos: TPoint);
begin
...
RegisterClasses([TdxScreenTip, TdxScreenTipBand, TdxScreenTipCollection,
  TdxScreenTipStyle, TdxScreenTipLinks, TdxScreenTipLink,
  TdxScreenTipActionLinks, TdxScreenTipActionLink]);
