...
type
  ...
  TdxDocTableCellBorder = (Top, Left, Bottom, Right, TopLeftToBottomRight,
    TopRightToBottomLeft);
  TdxDocTableCellBorders = set of TdxDocTableCellBorder;

  TdxChangeActionType = (None, Character, Paragraph, Section, TableCell,
    TableRow, Table, Frame);
  ...
  public
    ...
    class function CreateDefault(ADocumentModel: TdxDocumentModel)
      : TdxSectionInfo; static;
    ...
    property SectionGeneralSettings: TdxGeneralSectionInfo
      read FGeneralSectionInfo;
  ...
  public
    ...
    destructor Destroy; override;
    class function CreateDefault(ADocumentModel: TdxDocumentModel)
      : TdxParagraphInfo; static;

    property FormattingInfo: TdxParagraphFormattingInfo read FFormattingInfo
      write SetFormattingInfo;
    property FormattingOptions: TdxParagraphFormattingOptions
      read FFormattingOptions write FFormattingOptions;
    ...
    property NestedTableTrailer: Boolean read FNestedTableTrailer
      write FNestedTableTrailer;
  ...
  public
    ...
    property FormattingInfo: TdxParagraphFrameFormattingInfo
      read FFormattingInfo write SetFormattingInfo;
    property FormattingOptions: TdxParagraphFrameFormattingOptions
      read FFormattingOptions write FFormattingOptions;
  end;
  ...
  public
    destructor Destroy; override;
    class function CreateDefault(ADocumentModel: TdxDocumentModel)
      : TdxCharacterInfo; static;

    property FormattingInfo: TdxDocCharacterFormattingInfo read FFormattingInfo
      write SetFormattingInfo;
    property FormattingOptions: TdxCharacterFormattingOptions
      read FFormattingOptions write FFormattingOptions;
    property SpecialCharactersFontFamilyNameIndex: SmallInt
      read FSpecialCharactersFontFamilyNameIndex
      write FSpecialCharactersFontFamilyNameIndex;
    ...
    property PictureBulletInformation: TdxDocPictureBulletInformation
      read FPictureBulletInformation;
  end;
  ...
  public
    ...
    property TableDefinition: TdxTableDefinitionOperand read FTableDefinition
      write SetTableDefinition;
  end;
  ...
  public
    ...
    property MergingState: TdxMergingState read FMergingState
      write FMergingState;
  end;
  ...
  strict private
    ...
    FSplit: Boolean;
  public
    constructor Create(AFirstCellIndex: Byte; ALastCellIndex: Byte;
      ASplit: Boolean);
  ...
  strict private
    ...
    FCellRangeVerticalAlignmentActions
      : TdxCellRangeVerticalAlignmentOperandList;
  ...
  public
    ...
    destructor Destroy; override;
    class function CreateDefault(ADocumentModel: TdxDocumentModel)
      : TdxTableRowInfo; static;

    property HorizontalMerging: TdxObjectList<TdxHorizontalMergeInfo>
      read FHorizontalMerging;
    property VerticalMerging: TdxVerticalMergeInfoList read FVerticalMerging;
    property PreferredCellWidths: TdxTableCellWidthOperandList
      read FPreferredCellWidths;
    property ColumnWidthActions: TdxColumnWidthOperandList
      read FColumnWidthActions;
    property InsertActions: TdxInsertOperandList read FInsertActions;
    property CellMarginsActions: TdxCellSpacingOperandList
      read FCellMarginActions;
    property OverrideCellBordersActions: TdxTableBordersOverrideOperandList
      read FOverrideCellBordersActions;
    property CellRangeVerticalAlignmentActions
      : TdxCellRangeVerticalAlignmentOperandList
      read FCellRangeVerticalAlignmentActions;
    property CellHideMarkActions: TdxCellHideMarkOperandList
      read FCellHideMarkActions;
    ...
    property RightBorders: TdxDocTableBorderColorReferenceList
      read FRightBorders;
    property BottomBorders: TdxDocTableBorderColorReferenceList
      read FBottomBorders;
    ...
    property WidthBeforeAssign: Boolean read FWidthBeforeAssign
      write FWidthBeforeAssign;
    property RowLeft: Integer read FRowLeft write FRowLeft;
    property RowLeftAssigned: Boolean read FRowLeftAssigned
      write FRowLeftAssigned;
    property RowLeftOffset: Integer read FRowLeftOffset write FRowLeftOffset;
    property RowLeftOffsetAssigned: Boolean read FRowLeftOffsetAssigned
      write FRowLeftOffsetAssigned;
  ...
  public
    constructor Create(AFactory: TdxDocCommandFactoryBase;
    ...
    property DataStreamOffset: Integer read FDataStreamOffset
      write FDataStreamOffset;
    property CharacterInfo: TdxCharacterInfo read FCharacterInfo
      write FCharacterInfo;
    property ParagraphInfo: TdxParagraphInfo read FParagraphInfo
      write FParagraphInfo;
    ...
    property TableRowInfo: TdxTableRowInfo read FTableRowInfo
      write FTableRowInfo;
    property TableCellInfo: TdxTableCellInfo read FTableCellInfo
      write FTableCellInfo;
  ...
  public
    ...
    procedure Execute(APropertyContainer: TdxDocPropertyContainer;
      ADataStreamReader: TBinaryReader); virtual; abstract;
  ...
  public
    class function FromByteArray(const AData: TBytes; AStartIndex: Integer)
      : TdxWidthUnitOperand; static;
    class function NonNegativeFromByteArray(const AData: TBytes;
      AStartIndex: Integer): TdxWidthUnitOperand; static;
    procedure ConvertFromWidthUnitInfo(AInfo: TdxWidthUnitInfo;
      AUnitConverter: TdxDocumentModelUnitConverter);
  ...
  public
    constructor Create;
    destructor Destroy; override;
    class function FromByteArray(const AData: TBytes)
      : TdxTableCellWidthOperand; static;
    function GetBytes: TBytes;
  ...
  const
    TabAlignments: array [0 .. 3] of TdxTabAlignmentType =
      (TdxTabAlignmentType.Left, TdxTabAlignmentType.Center,
      TdxTabAlignmentType.Right, TdxTabAlignmentType.Decimal);

    TabLeaders: array [0 .. 5] of TdxTabLeaderType = (TdxTabLeaderType.None,
      TdxTabLeaderType.Dots, TdxTabLeaderType.Hyphens,
  ...
  public
    constructor Create(AAlignment: TdxTabAlignmentType;
      ALeader: TdxTabLeaderType); overload;
  ...
  protected
    ...
    function ReadDeletedTabs(const ATabs: TBytes; ACurrentPosition: Integer)
      : Integer; virtual;
    procedure ReadAddedTabs(const ATabs: TBytes;
      ACurrentPosition: Integer); virtual;
  public
    constructor Create;
    destructor Destroy; override;
    procedure Write(AWriter: TBinaryWriter);
    procedure ConvertFromFormattingTabInfo(AInfo: TdxTabFormattingInfo;
      AUnitConverter: TdxDocumentModelUnitConverter);
    procedure AddTabs(AFormattingInfo: TdxTabFormattingInfo;
      AUnitConverter: TdxDocumentModelUnitConverter);
  ...
  public
    constructor Create;
    destructor Destroy; override;
    class function FromByteArray(const ATabs: TBytes)
      : TdxTabsOperandClose; static;
  ...
  public
    ...
    destructor Destroy; override;
    class function FromByteArray(const AData: TBytes)
      : TdxTableBordersOperand80; static;
    procedure Write(AWriter: TBinaryWriter);
    procedure ApplyProperties(ADestination: TdxTableBorders;
      AUnitConverter: TdxDocumentModelUnitConverter);
    ...
    property BottomBorder: TdxBorderDescriptor97 read FBottomBorder;
    property RightBorder: TdxBorderDescriptor97 read FRightBorder;
    property InsideHorizontalBorder: TdxBorderDescriptor97
      read FInsideHorizontalBorder;
    property InsideVerticalBorder: TdxBorderDescriptor97
  ...
  public
    ...
    property InsideHorizontalBorder: TdxBorderDescriptor
      read FInsideHorizontalBorder;
    property InsideVerticalBorder: TdxBorderDescriptor
      read FInsideVerticalBorder;
  end;
  ...
  public
    ...
    destructor Destroy; override;
    class function FromByteArray(const AData: TBytes)
      : TdxTableBordersOverrideOperand; static;
    procedure Write(AWriter: TBinaryWriter);
    procedure ApplyProperties(ADestination: TdxTableCellBorders;
      AUnitConverter: TdxDocumentModelUnitConverter);
    procedure ApplyPropertiesCore(ABorder: TdxBorderBase;
      AUnitConverter: TdxDocumentModelUnitConverter);
    function Clone: TdxTableBordersOverrideOperand;

    property StartIndex: Byte read FStartIndex write FStartIndex;
    property EndIndex: Byte read FEndIndex write FEndIndex;
    property CellBorders: TdxDocTableCellBorders read FCellBorders
      write FCellBorders;
    property Border: TdxBorderDescriptor read FBorder;
  end;

  TdxTableBordersOverrideOperandList = class
    (TdxObjectList<TdxTableBordersOverrideOperand>);
  ...
  public
    ...
    destructor Destroy; override;
    class function FromByteArray(const AData: TBytes)
      : TdxCellSpacingOperand; static;
    procedure Write(AWriter: TBinaryWriter);
    procedure ApplyProperties(ADestination: TdxCellMargins;
      AUnitConverter: TdxDocumentModelUnitConverter);
  ...
  public
    class function FromByteArray(const AData: TBytes)
      : TdxCellRangeVerticalAlignmentOperand; static;
    procedure Write(AWriter: TBinaryWriter);
  ...
  TdxCellRangeVerticalAlignmentOperandList = class
    (TdxObjectList<TdxCellRangeVerticalAlignmentOperand>);
  ...
  protected
    procedure ApplyBorderProperties(ABorder: TdxBorderInfo;
      AUnitConverter: TdxDocumentModelUnitConverter);
  ...
  public
    ...
    destructor Destroy; override;
    class function FromByteArray(const AData: TBytes)
      : TdxTableDefinitionOperand; static;
...
{$REGION 'strict private type'}
  ...
  const
    KnownStyles: array [0 .. 39] of string = (TKnownStyleNames.NormalTable,
      TKnownStyleNames.TableSimple1, TKnownStyleNames.TableSimple2,
      TKnownStyleNames.TableSimple3, TKnownStyleNames.TableClassic1,
      TKnownStyleNames.TableClassic2, TKnownStyleNames.TableClassic3,
      TKnownStyleNames.TableClassic4, TKnownStyleNames.TableColorful1,
      TKnownStyleNames.TableColorful2, TKnownStyleNames.TableColorful3,
      TKnownStyleNames.TableColumns1, TKnownStyleNames.TableColumns2,
      TKnownStyleNames.TableColumns3, TKnownStyleNames.TableColumns4,
      TKnownStyleNames.TableColumns5, TKnownStyleNames.TableGrid1,
      TKnownStyleNames.TableGrid2, TKnownStyleNames.TableGrid3,
      TKnownStyleNames.TableGrid4, TKnownStyleNames.TableGrid5,
      TKnownStyleNames.TableGrid6, TKnownStyleNames.TableGrid7,
      TKnownStyleNames.TableGrid8, TKnownStyleNames.TableList1,
      TKnownStyleNames.TableList2, TKnownStyleNames.TableList3,
      TKnownStyleNames.TableList4, TKnownStyleNames.TableList5,
      TKnownStyleNames.TableList6, TKnownStyleNames.TableList7,
      TKnownStyleNames.TableList8, TKnownStyleNames.Table3DEffects1,
      TKnownStyleNames.Table3DEffects2, TKnownStyleNames.Table3DEffects3,
      TKnownStyleNames.TableContemporary, TKnownStyleNames.TableElegant,
      TKnownStyleNames.TableProfessional, TKnownStyleNames.TableSubtle1,
...
{$ENDREGION} strict private
  ...
  public
    ...
    procedure ApplyPropertiesCore(AStyle: TdxTableStyle;
  ...
  public
    ...
    function CreatePropertyContainer(AChangeType: TdxChangeActionTypes)
      : TdxDocPropertyContainer;
    procedure UpdatePropertyContainer(AContainer: TdxDocPropertyContainer;
      AChangeType: TdxChangeActionTypes); virtual; abstract;

    property DocumentProperties: TdxDocDocumentProperties
      read FDocumentProperties write FDocumentProperties;
...
class function TdxSectionInfo.CreateDefault(ADocumentModel: TdxDocumentModel)
  : TdxSectionInfo;
var
...
begin
  ...
  Result.FGeneralSectionInfo := ACache.GeneralSectionInfoCache.
    DefaultItem.Clone;
...
class function TdxParagraphInfo.CreateDefault(ADocumentModel: TdxDocumentModel)
  : TdxParagraphInfo;
begin
  Result := TdxParagraphInfo.Create;
  Result.FFormattingInfo := ADocumentModel.Cache.ParagraphFormattingInfoCache.
    DefaultItem.Clone;
  Result.FFormattingOptions := TdxParagraphFormattingOptions.
    EmptyParagraphFormattingOption;
  Result.FTabInfo := ADocumentModel.Cache.TabFormattingInfoCache.
    DefaultItem.Clone;
  Result.FParagraphStyleIndex :=
    SmallInt(ADocumentModel.ParagraphStyles.DefaultItemIndex);
end;

procedure TdxParagraphInfo.SetFormattingInfo(const AValue
...
class function TdxFrameInfo.CreateDefault(ADocumentModel: TdxDocumentModel)
  : TdxFrameInfo;
begin
  Result := TdxFrameInfo.Create;
  Result.FFormattingInfo :=
    ADocumentModel.Cache.ParagraphFrameFormattingInfoCache.DefaultItem.Clone;
  Result.FFormattingOptions := TdxParagraphFrameFormattingOptions.
    EmptyParagraphFrameFormattingOption;
end;

procedure TdxFrameInfo.SetFormattingInfo(const AValue
...
class function TdxCharacterInfo.CreateDefault(ADocumentModel: TdxDocumentModel)
  : TdxCharacterInfo;
begin
  Result := TdxCharacterInfo.Create;
  Result.FFormattingInfo := TdxDocCharacterFormattingInfo.CreateDefault;
  Result.FFormattingOptions := ADocumentModel.Cache.CharacterFormattingCache
    [TdxCharacterFormattingInfoCache.DefaultItemIndex].Options.Clone;
  Result.FPictureBulletInformation := TdxDocPictureBulletInformation.Create;
end;

procedure TdxCharacterInfo.SetFormattingInfo(const AValue
...
class function TdxDocTableInfo.CreateDefault(ADocumentModel: TdxDocumentModel)
  : TdxDocTableInfo;
begin
  Result := TdxDocTableInfo.Create;
  Result.FTableProperties := TdxTableProperties.Create
    (ADocumentModel.MainPieceTable);
  Result.FTableProperties.SetIndexInitial
...
procedure TdxDocTableInfo.SetTableDefinition(const AValue
  : TdxTableDefinitionOperand);
begin
  FTableDefinition.Free;
...
constructor TdxVerticalMergeInfo.Create(ACellIndex: Byte;
...
constructor TdxHorizontalMergeInfo.Create(AFirstCellIndex: Byte;
  ALastCellIndex: Byte; ASplit: Boolean);
begin
...
begin
  ...
  FCellRangeVerticalAlignmentActions :=
    TdxCellRangeVerticalAlignmentOperandList.Create;
...
class function TdxTableRowInfo.CreateDefault(ADocumentModel: TdxDocumentModel)
  : TdxTableRowInfo;
begin
  Result := TdxTableRowInfo.Create;
  Result.FTableRowProperties.Free;
  Result.FTableRowProperties := TdxTableRowProperties.Create
    (ADocumentModel.MainPieceTable);
  Result.FTableRowProperties.SetIndexInitial
...
class function TdxTableCellInfo.CreateDefault(ADocumentModel: TdxDocumentModel)
  : TdxTableCellInfo;
begin
  Result := TdxTableCellInfo.Create;
  Result.FTableCellProperties := TdxTableCellProperties.Create
    (ADocumentModel.MainPieceTable, ADocumentModel);
  Result.FTableCellProperties.SetIndexInitial
...
constructor TdxTabDescriptor.Create(AAlignment: TdxTabAlignmentType;
...
begin
  case Leader of
    TdxTabLeaderType.EqualSign, TdxTabLeaderType.None:
      Result := $00;
...
function TdxTabsOperandBase.ReadDeletedTabs(const ATabs: TBytes;
  ACurrentPosition: Integer): Integer;
var
  I: Integer;
begin
  for I := 0 to DeletedTabsCount - 1 do
    FDeletedTabsPositions.Add
      (PSmallInt(@ATabs[I * PositionSize + ACurrentPosition])^);
  Result := DeletedTabsCount * PositionSize;
end;

procedure TdxTabsOperandBase.ReadAddedTabs(const ATabs: TBytes;
  ACurrentPosition: Integer);
var
  I: Integer;
begin
  for I := 0 to AddedTabsCount - 1 do
    FAddedTabsPositions.Add
      (PSmallInt(@ATabs[I * PositionSize + ACurrentPosition])^);
...
begin
  Assert(AWriter <> nil, 'writer');
  ATotalSize := Byte(1 + DeletedTabsCount * PositionSize + 1 + AddedTabsCount *
    (1 + PositionSize));
  AWriter.Write(ATotalSize);
  AWriter.Write(DeletedTabsCount);
  for I := 0 to DeletedTabsCount - 1 do
    AWriter.Write(SmallInt(Min(TdxDocConstants.MaxXASValue,
      DeletedTabsPositions[I])));
  AWriter.Write(AddedTabsCount);
  for I := 0 to AddedTabsCount - 1 do
    AWriter.Write(SmallInt(Min(TdxDocConstants.MaxXASValue,
      AddedTabsPositions[I])));
  for I := 0 to AddedTabsCount - 1 do
    AddedTabs[I].Write(AWriter);
end;

procedure TdxTabsOperandBase.ConvertFromFormattingTabInfo
  (AInfo: TdxTabFormattingInfo; AUnitConverter: TdxDocumentModelUnitConverter);
var
  I: Integer;
...
begin
  for I := 0 to AInfo.Count - 1 do
    if AInfo[I].Deleted then
      FDeletedTabsPositions.Add(AUnitConverter.ModelUnitsToTwips
        (AInfo[I].Position))
    else
    begin
      FAddedTabsPositions.Add(AUnitConverter.ModelUnitsToTwips
        (AInfo[I].Position));
...
procedure TdxTabsOperandBase.AddTabs(AFormattingInfo: TdxTabFormattingInfo;
  AUnitConverter: TdxDocumentModelUnitConverter);
var
  ACount, I: Integer;
  AInfo: TdxTabInfo;
begin
  ...
  begin
    AInfo := TdxTabInfo.Create(AUnitConverter.TwipsToModelUnits
      (DeletedTabsPositions[I]), TdxTabAlignmentType.Left,
      TdxTabLeaderType.None, True, False);
  ...
  begin
    AInfo := TdxTabInfo.Create(AUnitConverter.TwipsToModelUnits
      (AddedTabsPositions[I]), AddedTabs[I].Alignment, AddedTabs[I].Leader,
      False, False);
    AFormattingInfo.Add(AInfo);
  end;
end;
...
class function TdxTabsOperand.FromByteArray(const ATabs: TBytes)
  : TdxTabsOperand;
begin
...
class function TdxTabsOperandClose.FromByteArray(const ATabs: TBytes)
  : TdxTabsOperandClose;
begin
...
function TdxTabsOperandClose.ReadDeletedTabs(const ATabs: TBytes;
  ACurrentPosition: Integer): Integer;
var
  I: Integer;
begin
...
class function TdxTableCellDescriptor.FromByteArray(const AData: TBytes;
  AStartIndex: Integer): TdxTableCellDescriptor;
begin
  Result := TdxTableCellDescriptor.Create;
  Result.Read(AData, AStartIndex);
end;

procedure TdxTableCellDescriptor.Read(const AData: TBytes;
  AStartIndex: Integer);
var
...
begin
  ...
  FHorizontalMerging := TdxMergingStateCalculator.CalcHorizontalMergingState
    (Byte(ABitwiseField and $3));
  FTextDirection := TdxTextDirectionCalculator.CalcTextDirection
    (Byte((ABitwiseField and $1C) shr 2));
  FVerticalMerging := TdxMergingStateCalculator.CalcVerticalMergingState
    (Byte((ABitwiseField and $60) shr 5));
  FVerticalAlignment := TdxAlignmentCalculator.CalcVerticalAlignment
    (Byte((ABitwiseField and $0180) shr 7));
  FType := TdxWidthUnitCalculator.CalcWidthUnitType
    (Byte((ABitwiseField and $0E00) shr 9));
...
class function TdxColumnWidthOperand.FromByteArray(const AData: TBytes)
  : TdxColumnWidthOperand;
begin
...
class function TdxWidthUnitOperand.FromByteArray(const AData: TBytes;
  AStartIndex: Integer): TdxWidthUnitOperand;
begin
  Result := TdxWidthUnitOperand.Create;
  Result.Read(AData, AStartIndex);
end;

class function TdxWidthUnitOperand.NonNegativeFromByteArray(const AData: TBytes;
  AStartIndex: Integer): TdxWidthUnitOperand;
begin
  Result := TdxWidthUnitOperand.Create;
  Result.Read(AData, AStartIndex);
...
procedure TdxWidthUnitOperand.ConvertFromWidthUnitInfo(AInfo: TdxWidthUnitInfo;
  AUnitConverter: TdxDocumentModelUnitConverter);
begin
  FType := AInfo.&Type;
  case FType of
    ...
    TdxWidthUnitType.ModelUnits:
      FValue := SmallInt(Min(AUnitConverter.ModelUnitsToTwips(AInfo.Value),
        TdxDocConstants.MaxXASValue));
  else
...
class function TdxTableCellWidthOperand.FromByteArray(const AData: TBytes)
  : TdxTableCellWidthOperand;
begin
...
procedure TdxTableCellWidthOperand.SetWidthUnit(const Value
  : TdxWidthUnitOperand);
begin
  FWidthUnit.Free;
  FWidthUnit := Value;
...
class function TdxInsertOperand.FromByteArray(const AData: TBytes)
  : TdxInsertOperand;
begin
...
class function TdxTableBordersOperand80.FromByteArray(const AData: TBytes)
  : TdxTableBordersOperand80;
begin
...
begin
  ...
  FBottomBorder.Free;
  FBottomBorder := TdxBorderDescriptor97.FromByteArray(AData,
    ACurrentStartIndex);
  Inc(ACurrentStartIndex, TdxBorderDescriptor97.BorderDescriptorSize);

  FRightBorder.Free;
  FRightBorder := TdxBorderDescriptor97.FromByteArray(AData,
    ACurrentStartIndex);
  Inc(ACurrentStartIndex, TdxBorderDescriptor97.BorderDescriptorSize);

  FInsideHorizontalBorder.Free;
  FInsideHorizontalBorder := TdxBorderDescriptor97.FromByteArray(AData,
    ACurrentStartIndex);
  Inc(ACurrentStartIndex, TdxBorderDescriptor97.BorderDescriptorSize);

  FInsideVerticalBorder.Free;
  FInsideVerticalBorder := TdxBorderDescriptor97.FromByteArray(AData,
    ACurrentStartIndex);
end;
...
procedure TdxTableBordersOperand80.ApplyProperties(ADestination
  : TdxTableBorders; AUnitConverter: TdxDocumentModelUnitConverter);
begin
  BottomBorder.ApplyProperties(ADestination.BottomBorder, AUnitConverter);
  InsideHorizontalBorder.ApplyProperties(ADestination.InsideHorizontalBorder,
    AUnitConverter);
  InsideVerticalBorder.ApplyProperties(ADestination.InsideVerticalBorder,
    AUnitConverter);
...
class function TdxTableBordersOperand.FromByteArray(const AData: TBytes)
  : TdxTableBordersOperand;
begin
...
begin
  ...
  FInsideHorizontalBorder.Free;
  FInsideHorizontalBorder := TdxBorderDescriptor.FromByteArray(AData,
    ACurrentStartIndex);
  Inc(ACurrentStartIndex, TdxBorderDescriptor.BorderDescriptorSize);

  FInsideVerticalBorder.Free;
  FInsideVerticalBorder := TdxBorderDescriptor.FromByteArray(AData,
    ACurrentStartIndex);
end;
...
procedure TdxTableBordersOperand.ApplyProperties(ADestination: TdxTableBorders;
  AUnitConverter: TdxDocumentModelUnitConverter);
begin
  BottomBorder.ApplyProperties(ADestination.BottomBorder, AUnitConverter);
  InsideHorizontalBorder.ApplyProperties(ADestination.InsideHorizontalBorder,
...
class function TdxTableBordersOverrideOperand.FromByteArray(const AData: TBytes)
  : TdxTableBordersOverrideOperand;
begin
...
procedure TdxTableBordersOverrideOperand.ApplyProperties
  (ADestination: TdxTableCellBorders;
  AUnitConverter: TdxDocumentModelUnitConverter);
begin
...
procedure TdxTableBordersOverrideOperand.ApplyPropertiesCore
  (ABorder: TdxBorderBase; AUnitConverter: TdxDocumentModelUnitConverter);
begin
  ABorder.BeginUpdate;
  try
...
class function TdxCellSpacingOperand.FromByteArray(const AData: TBytes)
  : TdxCellSpacingOperand;
begin
...
procedure TdxCellSpacingOperand.ApplyProperties(ADestination: TdxCellMargins;
  AUnitConverter: TdxDocumentModelUnitConverter);
begin
...
class function TdxCellRangeVerticalAlignmentOperand.FromByteArray
  (const AData: TBytes): TdxCellRangeVerticalAlignmentOperand;
begin
...
begin
  ...
  AWriter.Write(FStartIndex);
  AWriter.Write(Byte(FEndIndex + 1));
  AWriter.Write(TdxAlignmentCalculator.CalcVerticalAlignmentTypeCode
    (FVerticalAlignment));
end;

function TdxCellRangeVerticalAlignmentOperand.Clone
  : TdxCellRangeVerticalAlignmentOperand;
begin
  Result := TdxCellRangeVerticalAlignmentOperand.Create;
  Result.FStartIndex := FStartIndex;
...
procedure TdxDocCommandParagraphBorder97.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
end;

procedure TdxDocCommandParagraphBorder97.ApplyBorderProperties
  (ABorder: TdxBorderInfo; AUnitConverter: TdxDocumentModelUnitConverter);
begin
  ABorder.Width := AUnitConverter.TwipsToModelUnits
    (CurrentBorder.Width * 5 div 2);
  ABorder.Style := TdxDocBorderCalculator.MapToBorderLineStyle
    (CurrentBorder.Style);
...
procedure TdxDocCommandParagraphTopBorder.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
...
procedure TdxDocCommandParagraphLeftBorder.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
  AParagraphInfo: TdxParagraphInfo;
  ABorder: TdxBorderInfo;
...
procedure TdxDocCommandParagraphBottomBorder.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
  AParagraphInfo: TdxParagraphInfo;
  ABorder: TdxBorderInfo;
...
procedure TdxDocCommandParagraphRightBorder.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
  AParagraphInfo: TdxParagraphInfo;
  ABorder: TdxBorderInfo;
...
procedure TdxDocCommandParagraphBorder.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
begin
end;

procedure TdxDocCommandParagraphBorder.ApplyBorderProperties
  (ABorder: TdxBorderInfo; AUnitConverter: TdxDocumentModelUnitConverter);
begin
  ABorder.Width := AUnitConverter.TwipsToModelUnits
    (CurrentBorder.Width * 5 div 2);
...
procedure TdxDocCommandParagraphTopBorderNew.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
  AParagraphInfo: TdxParagraphInfo;
  ABorder: TdxBorderInfo;
...
procedure TdxDocCommandParagraphLeftBorderNew.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
  AParagraphInfo: TdxParagraphInfo;
  ABorder: TdxBorderInfo;
...
procedure TdxDocCommandParagraphBottomBorderNew.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
  AParagraphInfo: TdxParagraphInfo;
  ABorder: TdxBorderInfo;
...
procedure TdxDocCommandParagraphRightBorderNew.Execute(APropertyContainer
  : TdxDocPropertyContainer; ADataStreamReader: TBinaryReader);
var
  AParagraphInfo: TdxParagraphInfo;
  ABorder: TdxBorderInfo;
...
class function TdxTableDefinitionOperand.FromByteArray(const AData: TBytes)
  : TdxTableDefinitionOperand;
begin
...
begin
  ...
  for I := 0 to ACount - 1 do
    FCells.Add(TdxTableCellDescriptor.FromByteArray(AData,
      ACurrentPosition + I * TdxTableCellDescriptor.Size));
end;
...
begin
  if (FItl <= High(KnownStyles)) and (FItl >= 0) then
    Result := TdxTableStyle(ADocumentModel.TableStyles.GetStyleByName
      (KnownStyles[FItl]))
  else
    Result := nil;
end;

procedure TLP.ApplyPropertiesCore(AStyle: TdxTableStyle;
  AProperties: TdxTableProperties);
begin
...
class function TdxCellHideMarkOperand.FromByteArray(const AData: TBytes)
  : TdxCellHideMarkOperand;
begin
...
function TdxDocCommandFactoryBase.CreatePropertyContainer
  (AChangeType: TdxChangeActionTypes): TdxDocPropertyContainer;
begin
  Result := TdxDocPropertyContainer.Create(Self, FModel.UnitConverter);
  UpdatePropertyContainer(Result, AChangeType);
end;

class function TdxDocCommandFactoryBase.GetOpcodeByType(ACommandType: TClass)
  : SmallInt;
begin
  Result := -1;
end;

function TdxDocCommandFactoryBase.GetUnitConverter
...
constructor TdxDocPropertyContainer.Create(AFactory: TdxDocCommandFactoryBase;
  AUnitConverter: TdxDocumentModelUnitConverter);
begin
