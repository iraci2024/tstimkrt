...
type
  ...
  published
    ...
    property FileType: TdxMapItemFileType read FFileType write SetFileType
      default miftKml;
...
begin
  ...
  else if FileType = miftShape then
  begin
...
procedure TdxMapItemFileLayer.LoadShapeFileFromStream(AShpStream,
  ADbfStream: TStream);
begin
  FileType := miftShape;
  try
