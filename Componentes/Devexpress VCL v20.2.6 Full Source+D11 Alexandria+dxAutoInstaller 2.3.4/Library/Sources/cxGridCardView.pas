...
type
  ...
  protected
    ...
    property DestZone: TcxGridCardRowContainerZone read GetDestZone
      write SetDestZone;
    property GridView: TcxGridCardView read GetGridView;
    property RowLayout: TcxGridCardViewRowLayoutObject read GetRowLayout;
    property SourceGridRecord: TcxCustomGridRecord read FSourceGridRecord
      write FSourceGridRecord;
    property SourceItem: TcxGridCardViewRow read GetSourceItem
      write SetSourceItem;
    property ViewInfo: TcxGridCardViewViewInfo read GetViewInfo;
    property VisibleRowLayout: TcxGridCardViewVisibleRowLayoutObject
      read GetVisibleRowLayout;
  public
  ...
  protected
    function GetHelperClass
      : TcxGridCustomLayoutViewControllerHelperClass; override;

    function CanFocusNextItem(AFocusedItemIndex, ANextItemIndex: Integer;
      AGoForward, AGoOnCycle, AGoToNextRecordOnCycle: Boolean)
      : Boolean; override;
    function FindNextRow(ACard: TcxGridCard; ARows: TList;
      ARow: TcxGridCardViewRow; AGoForward, AGoOnCycle: Boolean;
    ...
    procedure RowExpandedChanging(ARow: TcxGridCardViewRow;
    ...
    function GetRowDragAndDropObjectClass
      : TcxGridCardRowMovingObjectClass; virtual;

    property FocusedCardViewInfo: TcxGridCardViewInfo
      read GetFocusedCardViewInfo;
    property ScrollCardViewInfo: TcxGridCardViewInfo read GetScrollCardViewInfo
      write SetScrollCardViewInfo;
  ...
  public
    ...
    function FocusNextItemHorizontally(AGoForward, AGoOnCycle: Boolean)
      : Boolean; override;
    function FocusNextItemVertically(AGoForward, AGoOnCycle: Boolean)
      : Boolean; override;

    property CustomizationForm: TcxGridCardViewCustomizationForm
      read GetCustomizationForm;
    property FocusedCard: TcxGridCard read GetFocusedCard write SetFocusedCard;
    property FocusedItem: TcxGridCardViewRow read GetFocusedRow
      write SetFocusedRow;
    property FocusedRow: TcxGridCardViewRow read GetFocusedRow
      write SetFocusedRow;
    property GridView: TcxGridCardView read GetGridView;
  ...
  TcxGridCardViewRowLayerPosition = (rlpBeforeRow, rlpAfterRow, rlpBeforeLayer,
    rlpAfterLayer);
  ...
  protected
    ...
    function GetCoordinates(const APosition: TcxGridCardRowPosition)
      : TcxGridCardRowCoordinates; overload;
    function GetPosition(const ACoordinates: TcxGridCardRowCoordinates)
      : TcxGridCardRowPosition; overload;

    function GetLayerIndex(ARowIndex: Integer): Integer; overload;
    function GetLayerPosition(APosition: TcxPosition)
      : TcxGridCardViewRowLayerPosition;
    function GetLength(ARow: TcxGridCardViewRow): Integer;
    function GetOffsetInLayer(ALayerIndex, AIndexInLayer: Integer)
      : Integer; overload;
  ...
  public
    ...
    function GetCoordinates(ARow: TcxGridCardViewRow)
      : TcxGridCardRowCoordinates; overload;
    ...
    function GetPosition(ARow: TcxGridCardViewRow)
      : TcxGridCardRowPosition; overload;
    ...
    property LayerFirstRow[ALayerIndex: Integer]: TcxGridCardViewRow
      read GetLayerFirstRow;
    property LayerFirstRowIndex[ALayerIndex: Integer]: Integer
      read GetLayerFirstRowIndex;
    property LayerRowCount[ALayerIndex: Integer]: Integer read GetLayerRowCount
      write SetLayerRowCount;
    property LayerRows[ALayerIndex, AIndex: Integer]: TcxGridCardViewRow
      read GetLayerRow;
  ...
  public
    ...
    procedure GetInsertionParams(ARow: TcxGridCardViewRow;
      APosition: TcxPosition; out AInsertionIndex: Integer;
      out AInsertionPos: TcxGridCardRowInsertionPos);
  ...
  protected
    ...
    procedure MoveRows(ARows: TList; AIndex: Integer;
      ARowLayout: TcxGridCardRowLayoutObject); overload;

    procedure LayerIndexChanged;
    property OnLayerIndexChanged: TNotifyEvent read FOnLayerIndexChanged
      write FOnLayerIndexChanged;
  public
    ...
    procedure SetCoordinates(ARow: TcxGridCardViewRow;
    ...
    procedure SetPosition(ARow: TcxGridCardViewRow;
      const APosition: TcxGridCardRowPosition);

    property BeginsLayer[ARow: TcxGridCardViewRow]: Boolean read GetBeginsLayer
      write SetBeginsLayer;
  ...
  public
    constructor Create(AGridView: TcxGridCardView);
    function GetLastVisibleSubItem(ARow: TcxGridCardViewRow)
      : TcxGridCardViewRow;
  ...
  TcxGridCardViewRowLayoutControllerClass = class of
  ...
  protected
    ...
    function CreateCardRowLayout(ACardViewInfo: TcxGridCardViewInfo)
  ...
  public
    ...
    procedure SetCoordinates(ARow: TcxGridCardViewRow;
      AColIndex, ARowIndex: Integer); overload;
    procedure SetCoordinates(ARow: TcxGridCardViewRow;
      ACoordinates: TcxGridCardRowCoordinates); overload;
    function GetVisibleCoordinates(ARow: TcxGridCardViewRow)
      : TcxGridCardRowCoordinates;

    function GetPosition(ARow: TcxGridCardViewRow): TcxGridCardRowPosition;
    procedure SetPosition(ARow: TcxGridCardViewRow;
      ALayerIndex, AIndexInLayer: Integer);
    function GetVisiblePosition(ARow: TcxGridCardViewRow)
      : TcxGridCardRowPosition;

    // navigation

    function FindNextRow(ACard: TcxGridCard; ARow: TcxGridCardViewRow;
      ASameLayer, AGoForward, AGoOnCycle: Boolean; out ACycleChanged: Boolean)
      : TcxGridCardViewRow;

    function FindNextRowHorizontally(ACard: TcxGridCard;
      ARow: TcxGridCardViewRow; AGoForward, AGoOnCycle: Boolean;
      out ACycleChanged: Boolean): TcxGridCardViewRow;
    ...
    property VisibleLayoutObject: TcxGridCardViewVisibleRowLayoutObject
      read FVisibleLayoutObject;
  end;
  ...
  public
    ...
    property Rows[Index: Integer]: TcxGridCardViewInfo read GetRow
  ...
  public
    constructor Create(ARowViewInfo: TcxGridCardRowViewInfo);
      reintroduce; virtual;
  ...
  TcxGridCardRowFilterButtonViewInfoClass = class of
  ...
  public
    constructor Create(ARowCaptionViewInfo: TcxGridCardRowCaptionViewInfo);
      reintroduce; virtual;
    property Row: TcxGridCardViewRow read GetRow;
    property RowCaptionViewInfo: TcxGridCardRowCaptionViewInfo
      read FRowCaptionViewInfo;
  end;
  ...
  protected
    ...
    function GetFilterButtonViewInfoClass
      : TcxGridCardRowFilterButtonViewInfoClass; virtual;
    function GetHitTestClass: TcxCustomGridHitTestClass; override;
  ...
  public
    ...
    property FilterButtonViewInfo: TcxGridCardRowFilterButtonViewInfo
      read FFilterButtonViewInfo;
  ...
  protected
    ...
    function CalculateHeight: Integer; override;
    class function CalculateSimpleHeight(ARow: TcxGridCardViewRow;
      ACanvas: TcxCanvas): Integer; virtual;
    function CalculateWidth: Integer; override;
    ...
    class function GetCaptionViewInfoClass
      : TcxGridCardRowCaptionViewInfoClass; virtual;
    function GetCaptionWidth: Integer; virtual;
    class function GetDataViewInfoClass
      : TcxGridCardRowDataViewInfoClass; virtual;
    ...
    class function GetExpandButtonAreaSize
      (APainter: TcxCustomLookAndFeelPainter; AScaleFactor: TdxScaleFactor)
      : Integer; virtual;
    function GetExpandButtonBounds: TRect; virtual;
    class function GetExpandButtonSize(APainter: TcxCustomLookAndFeelPainter;
    ...
    class function GetSimpleViewParams(ARow: TcxGridCardViewRow;
      AIsCaption: Boolean): TcxViewParams; virtual;
    function GetWidth: Integer; override;
    procedure InitHitTest(AHitTest: TcxCustomGridHitTest); override;

    procedure GetCaptionViewParams(var AParams: TcxViewParams;
      AIgnoreSelection: Boolean); virtual; abstract;
  ...
  public
    constructor Create(ACardViewInfo: TcxGridCardViewInfo; AIndex: Integer);
      reintroduce; virtual;
    destructor Destroy; override;
    procedure BeforeRecalculation; override;
    procedure Calculate(const ABounds: TRect); override;
    function CalculateVisibleCounts(var AVisibleRowCount, APartVisibleRowCount
      : Integer): Boolean;
    ...
    property CaptionViewInfo: TcxGridCardRowCaptionViewInfo
  ...
  public
    constructor Create(ACardViewInfo: TcxGridCardViewInfo);
      reintroduce; virtual;
    property IsDownButton: Boolean read GetIsDownButton;
    property CardViewInfo: TcxGridCardViewInfo read FCardViewInfo;
  end;

  TcxGridCardScrollButtonDownViewInfoClass = class of
    TcxGridCardScrollButtonDownViewInfo;

  TcxGridCardScrollButtonDownViewInfo = class
  ...
  TcxGridCardScrollButtonUpViewInfoClass = class of
    TcxGridCardScrollButtonUpViewInfo;

  TcxGridCardScrollButtonUpViewInfo = class
    (TcxCustomGridCardScrollButtonViewInfo)
  protected
    function GetHitTestClass: TcxCustomGridHitTestClass; override;
    function GetIsDownButton: Boolean; override;
  ...
  TcxGridCardExpandButtonViewInfoClass = class of
  ...
  private
    ...
    function GetLayerRowViewInfo(ALayerIndex, AIndex: Integer)
  ...
  protected
    procedure BeforeCalculation; virtual;
    procedure CalculateLayerBounds(ALayer: TcxGridCardRowLayer;
      AMaxRowHeight: Integer; var ABounds: TRect); virtual; abstract;
    procedure CalculateLayers(AWidth: Integer); virtual;
    function CalculateRowsHeaderWidth(ARows: TList; AWidth: Integer)
      : Integer; virtual;
    ...
    function IsLayerVisible(ALayer: TcxGridCardRowLayer; ATopRowIndex: Integer)
      : Boolean; overload; virtual;
    function IsLayerVisible(const ABounds, ALayerBounds: TRect): Boolean;
      overload; virtual;
  ...
  public
    constructor Create(ACardViewInfo: TcxGridCardViewInfo;
      ASimple: Boolean); virtual;
    destructor Destroy; override;
    procedure Calculate(AWidth: Integer); virtual;
    procedure CalculateRows(const ABounds: TRect;
      ATopRowIndex, AMaxRowHeight: Integer;
      var AVisibleRowCount, APartVisibleRowCount: Integer); virtual;
    function GetHeaderWidth(ARowViewInfo: TcxGridCardRowViewInfo): Integer;
      virtual; abstract;
    function GetIndexInLayer(ARowViewInfo: TcxGridCardRowViewInfo)
      : Integer; overload;
    function GetLayerIndex(ARowViewInfo: TcxGridCardRowViewInfo)
      : Integer; overload;
    function GetLayerIndex(const P: TPoint): Integer; overload;
    function GetSeparatorBounds(AIndex: Integer): TRect; virtual; abstract;
    function IsLeft(ARowViewInfo: TcxGridCardRowViewInfo): Boolean;
      virtual; abstract;
    function IsTop(ARowViewInfo: TcxGridCardRowViewInfo): Boolean;
      virtual; abstract;
    function IsZoneVertical(AZone: TcxGridCardRowContainerZone): Boolean;
      virtual; abstract;

    property CardViewInfo: TcxGridCardViewInfo read FCardViewInfo;
    property LayerRowViewInfos[ALayerIndex, AIndex: Integer]
      : TcxGridCardRowViewInfo read GetLayerRowViewInfo;
  ...
  protected
    function CalculateFirstColumnRowsHeaderWidth(AWidth: Integer)
      : Integer; virtual;
    procedure CalculateLayerBounds(ALayer: TcxGridCardRowLayer;
      AMaxRowHeight: Integer; var ABounds: TRect); override;
    function GetLayerClass: TcxGridCardRowLayerClass; override;
    function GetLayersHeight: Integer; override;
    function IsLayerVisible(ALayer: TcxGridCardRowLayer; ATopRowIndex: Integer)
      : Boolean; override;
    function IsLayerVisible(const ABounds, ALayerBounds: TRect)
      : Boolean; override;
  public
    constructor Create(ACardViewInfo: TcxGridCardViewInfo;
      ASimple: Boolean); override;
    ...
    function IsZoneVertical(AZone: TcxGridCardRowContainerZone)
      : Boolean; override;
    property FirstColumnRowsHeaderWidth: Integer
      read FFirstColumnRowsHeaderWidth;
  end;
  ...
  protected
    ...
    function GetExpandButtonAlignment
      : TcxGridCardExpandButtonAlignment; virtual;
    ...
    function GetScrollButtonDownViewInfoClass
      : TcxGridCardScrollButtonDownViewInfoClass; virtual;
    function GetScrollButtonUpViewInfoClass
      : TcxGridCardScrollButtonUpViewInfoClass; virtual;
    function GetScrollButtonHeight: Integer; virtual;
    function GetScrollButtonUpBounds: TRect; virtual;
    procedure GetViewParams(var AParams: TcxViewParams); override;
    function GetWidth: Integer; override;
    function HasCategorySeparator(ARowViewInfo: TcxGridCardCategoryRowViewInfo)
      : Boolean; overload; virtual;
    class function HasCategorySeparator(ARow: TcxGridCardViewRow): Boolean;
      overload; virtual;
    function HasIndent(ARowViewInfo: TcxGridCardRowViewInfo): Boolean; virtual;
    function HasLayerSeparators: Boolean; virtual;
    function IsRowPartiallyVisible(ARowViewInfo: TcxGridCardRowViewInfo)
      : Boolean; virtual;
    function IsRowVisible(ARowViewInfo: TcxGridCardRowViewInfo)
      : Boolean; virtual;
    function SupportsScrolling: Boolean; virtual;

    function GetZone(AHitTest: TcxCustomGridHitTest)
      : TcxGridItemContainerZone; virtual;
    function GetZoneBounds(AZone: TcxGridCardRowContainerZone): TRect; virtual;
    function IsZoneVertical(AZone: TcxGridCardRowContainerZone)
      : Boolean; virtual;

    function GetExpandButtonViewInfoClass
      : TcxGridCardExpandButtonViewInfoClass; virtual;
    class function GetRowViewInfoClass(ARow: TcxGridCardViewRow)
      : TcxGridCardRowViewInfoClass; virtual;
    ...
    property ExpandButtonSize: Integer read GetExpandButtonSizeValue;
    property FirstCaptionRowViewInfo: TcxGridCardRowViewInfo
      read GetFirstCaptionRowViewInfo;
  ...
  public
    ...
    function VisibleRowViewInfoIndexOf(ARow: TcxGridCardViewRow)
      : Integer; overload;
    function VisibleRowViewInfoIndexOf(ARowViewInfo: TcxGridCardRowViewInfo)
      : Integer; overload;

    property CardBorderWidth: Integer read GetCardBorderWidth;
    // property DataWidth: Integer read GetDataWidth;
    property ExpandButtonAlignment: TcxGridCardExpandButtonAlignment
      read GetExpandButtonAlignment;
    property ExpandButtonViewInfo: TcxGridCardExpandButtonViewInfo
    ...
    property RowViewInfos[Index: Integer]: TcxGridCardRowViewInfo
      read GetRowViewInfo;
    property ScrollableAreaBounds: TRect read GetScrollableAreaBounds;
    property ScrollButtonDown: TcxGridCardScrollButtonDownViewInfo
      read FScrollButtonDown;
    property ScrollButtonUp: TcxGridCardScrollButtonUpViewInfo
      read FScrollButtonUp;
    ...
    property VisibleRowViewInfos[Index: Integer]: TcxGridCardRowViewInfo
      read GetVisibleRowViewInfo;
  end;

  // cards

  TcxGridCardsViewInfoHorizontalCalculator = class
    (TcxGridCustomLayoutViewInfoHorizontalCalculator)
  protected
    function GetRecordSpaceVert: Integer; override;
  end;

  TcxGridCardsViewInfoVerticalCalculator = class
    (TcxGridCustomLayoutViewInfoVerticalCalculator)
  protected
  ...
  protected
    ...
    function GetItemViewInfoClass
      : TcxGridCustomLayoutRecordViewInfoClass; override;
    function GetSeparatorWidth: Integer; override;

    function GetCalculatorClass
      : TcxGridCustomLayoutRecordsViewInfoBasedCalculatorClass; override;
  ...
  public
    ...
    function GetRealItem(ARecord: TcxCustomGridRecord): TcxGridCardViewInfo;
      reintroduce; virtual;
    function GetZone(AHitTest: TcxCustomGridHitTest)
      : TcxGridItemContainerZone; virtual;
  ...
  protected
    ...
    property CardsViewInfo: TcxGridCardsViewInfo read GetCardsViewInfo;
  public
    function GetHitTest(const P: TPoint)
      : TcxGridCardViewSeparatorHitTest; virtual;

    property Color: TColor read GetColor;
  end;

  TcxGridCardViewSeparatorsHorizontalViewInfo = class
  ...
  TcxGridCardViewSeparatorsVerticalViewInfo = class
    (TcxGridCardViewSeparatorsViewInfo)
  protected
    function GetHitTestItem(Index: Integer): TRect; override;
    function GetHitTestItemCount: Integer; override;
  ...
  protected
    ...
    function GetSeparatorsViewInfoClass
      : TcxGridCustomLayoutViewSeparatorsViewInfoClass; override;
  ...
  public
    property RecordsViewInfo: TcxGridCardsViewInfo read GetRecordsViewInfo;
    property SeparatorsViewInfo: TcxGridCardViewSeparatorsViewInfo
      read GetSeparatorsViewInfo;
  end;
  ...
  public
    ...
    property IsTopRowIndexAssigned: Boolean read FIsTopRowIndexAssigned
      write FIsTopRowIndexAssigned;
  end;
  ...
  published
    ...
    property IndexInLayer: Integer read GetIndexInLayer write SetIndexInLayer
      stored False;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
    procedure GetCaptionParams(ARecord: TcxCustomGridRecord;
      out AParams: TcxViewParams); virtual;
    procedure GetCaptionRowParams(ARecord: TcxCustomGridRecord;
      out AParams: TcxViewParams); virtual;
    procedure GetCategoryRowParams(ARecord: TcxCustomGridRecord;
      out AParams: TcxViewParams); virtual;
  ...
  published
    ...
    property CaptionRow: TcxStyle index isCaptionRow read GetValue
      write SetValue;
    property CategoryRow: TcxStyle index isCategoryRow read GetValue
      write SetValue;
    property OnGetCaptionRowStyle: TcxGridGetCellStyleEvent
      read FOnGetCaptionRowStyle write SetOnGetCaptionRowStyle;
    property OnGetCaptionStyle: TcxGridGetCellStyleEvent read FOnGetCaptionStyle
      write SetOnGetCaptionStyle;
    property OnGetCategoryRowStyle: TcxGridGetCellStyleEvent
      read FOnGetCategoryRowStyle write SetOnGetCategoryRowStyle;
  end;
  ...
  protected
    ...
    property GridView: TcxGridCardView read GetGridView;
    property LockPositionSync: Boolean read FLockPositionSync
      write FLockPositionSync;
  public
    ...
    property CategoryItems[AIndex: Integer]: TcxGridCardViewRow
      read GetCategoryItem;
    property CategoryRow: TcxGridCardViewRow read FCategoryRow
      write SetCategoryRow;
  ...
  published
    ...
    property Kind: TcxGridCardViewRowKind read FKind write SetKind
      default rkData;
    property Options: TcxGridCardViewRowOptions read GetOptions
      write SetOptions;
    property Position: TcxGridCardViewRowPosition read FPosition
      write SetPosition;
    property SortIndex;
    property SortOrder;
  ...
  published
    property CaptionRow: TBitmap index bbCaptionRow read GetValue
      write SetValue;
    property CardBorder: TBitmap index bbCardBorder read GetValue
      write SetValue;
    property RowCaption: TBitmap index bbRowCaption read GetValue
      write SetValue;
  end;
  ...
  public
    ...
    property RowPopupDropDownWidth: Integer read GetItemPopupDropDownWidth
      write SetItemPopupDropDownWidth;
    // obsolete - use RowPopup.MaxDropDownItemCount
    property MaxDropDownCount;
    property RowPopupMaxDropDownItemCount: Integer
      read GetItemPopupMaxDropDownItemCount
      write SetItemPopupMaxDropDownItemCount;
  published
    property RowAddValueItems: Boolean read GetRowAddValueItems
      write SetRowAddValueItems default True;
    property RowExcelPopup: TcxGridItemExcelFilterPopupOptions
      read GetRowExcelPopup write SetRowExcelPopup;
    property RowFilteredItemsList: Boolean read GetRowFilteredItemsList
      write SetRowFilteredItemsList default False;
    property RowFilteredItemsListShowFilteredItemsOnly: Boolean
      read GetRowFilteredItemsListShowFilteredItemsOnly
      write SetRowFilteredItemsListShowFilteredItemsOnly default True;
    property RowMRUItemsList: Boolean read GetRowMRUItemsList
      write SetRowMRUItemsList default True;
    property RowMRUItemsListCount: Integer read GetRowMRUItemsListCount
      write SetRowMRUItemsListCount
      default cxGridFilterDefaultItemMRUItemsListCount;
    property RowPopup: TcxGridItemFilterPopupOptions read GetRowPopup
      write SetRowPopup;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property ExpandRowOnDblClick: Boolean read FExpandRowOnDblClick
      write SetExpandRowOnDblClick default True;
    property ImmediateEditor;
    property PullFocusing;
    property RowCaptionHints: Boolean read FRowCaptionHints
      write SetRowCaptionHints default True;
  end;
  ...
  public
    ...
    property GridView: TcxGridCardView read GetGridView;
  published
    property CardExpanding: Boolean read GetCardExpanding write SetCardExpanding
      default False;
    property CardSizing: Boolean read FCardSizing write SetCardSizing
      default True;
    property LayeredRows: Boolean read FLayeredRows write SetLayeredRows
      default False;
    property RowExpanding: Boolean read FRowExpanding write SetRowExpanding
      default True;
    property RowFiltering: Boolean read GetRowFiltering write SetRowFiltering
      default True;
    property RowHiding: Boolean read GetRowHiding write SetRowHiding
      default False;
    property RowMoving: Boolean read GetRowMoving write SetRowMoving
      default False;
  end;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property CardBorderSelection: Boolean read FCardBorderSelection
      write SetCardBorderSelection default True;
  ...
  strict private
    ...
    procedure SetCardExpandButtonAlignment
      (Value: TcxGridCardExpandButtonAlignment);
  ...
  published
    ...
    property CaptionWidth: Integer read FCaptionWidth write SetCaptionWidth
      default 0;
    property CardAutoWidth: Boolean read FCardAutoWidth write SetCardAutoWidth
      default False;
    property CardBorderWidth: Integer read FCardBorderWidth
      write SetCardBorderWidth default cxGridDefaultCardBorderWidth;
    property CardExpandButtonAlignment: TcxGridCardExpandButtonAlignment
      read FCardExpandButtonAlignment write SetCardExpandButtonAlignment
      default cebaRight;
    ...
    property CardWidth: Integer read FCardWidth write SetCardWidth
      default cxGridCardDefaultWidth;
    property CategoryIndent: Integer read FCategoryIndent
      write SetCategoryIndent default cxGridCardDefaultCategoryIndent;
    property CategoryRowCaptionInRowAlternateCaption: Boolean
      read FCategoryRowCaptionInRowAlternateCaption
    ...
    property CategorySeparatorWidth: Integer read FCategorySeparatorWidth
      write SetCategorySeparatorWidth
      default cxGridCardDefaultCategorySeparatorWidth;
    ...
    property LayerSeparatorWidth: Integer read FLayerSeparatorWidth
      write SetLayerSeparatorWidth default cxGridCardDefaultLayerSeparatorWidth;
    ...
    property RowCaptionEndEllipsis: Boolean read GetRowCaptionEndEllipsis
      write SetRowCaptionEndEllipsis default False;
    property SeparatorColor;
    property SeparatorWidth;
    property ShowRowFilterButtons: TcxGridShowItemFilterButtons
      read GetShowRowFilterButtons write SetShowRowFilterButtons
      default sfbDefault;
  end;
  ...
  public
    ...
    procedure GetCardBorderParams(ARecord: TcxCustomGridRecord;
      out AParams: TcxViewParams); virtual;
    procedure GetCardBorderVisualParams(ARecord: TcxCustomGridRecord;
      out AParams: TcxViewParams); virtual;
    procedure GetCategoryRowParams(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem; out AParams: TcxViewParams); virtual;
    ...
    procedure GetRowCaptionParams(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem; out AParams: TcxViewParams); virtual;
    property GridView: TcxGridCardView read GetGridViewValue;
  published
    property CaptionRow: TcxStyle index vsCaptionRow read GetValue
      write SetValue;
    property CardBorder: TcxStyle index vsCardBorder read GetValue
      write SetValue;
    property CategoryRow: TcxStyle index vsCategoryRow read GetValue
      write SetValue;
    property CategorySeparator: TcxStyle index vsCategorySeparator read GetValue
      write SetValue;
    property Inactive;
    property LayerSeparator: TcxStyle index vsLayerSeparator read GetValue
      write SetValue;
    property RowCaption: TcxStyle index vsRowCaption read GetValue
      write SetValue;
    property Selection;
    property StyleSheet;
    property OnGetCaptionRowStyle: TcxGridGetCellStyleEvent
      read FOnGetCaptionRowStyle write SetOnGetCaptionRowStyle;
    property OnGetCardBorderStyle: TcxGridGetRecordStyleEvent
      read FOnGetCardBorderStyle write SetOnGetCardBorderStyle;
    property OnGetCategoryRowStyle: TcxGridGetCellStyleEvent
      read FOnGetCategoryRowStyle write SetOnGetCategoryRowStyle;
    property OnGetRowCaptionStyle: TcxGridGetCellStyleEvent
      read FOnGetRowCaptionStyle write SetOnGetRowCaptionStyle;
  end;
  ...
  published
    property Styles: TcxGridCardViewStyles read GetStylesValue
      write SetStylesValue;
  end;

  // view

  TcxGridCardRowEvent = procedure(Sender: TcxGridCardView;
    ARow: TcxGridCardViewRow) of object;
  TcxGridCardRowChangingEvent = procedure(Sender: TcxGridCardView;
    ARow: TcxGridCardViewRow; var AAllow: Boolean) of object;
  ...
  protected
    ...
    function GetRowLayoutControllerClass
      : TcxGridCardViewRowLayoutControllerClass; virtual;
    ...
    procedure SetRowCoordinates(const ACoordinates
    ...
    procedure RowExpandedChanged(ARow: TcxGridCardViewRow); virtual;
    function RowExpandedChanging(ARow: TcxGridCardViewRow; AValue: Boolean)
      : Boolean; virtual;
    ...
    function DrawCardBorderSelected(ARecord: TcxCustomGridRecord)
      : Boolean; virtual;
  ...
  public
    ...
    property RowLayoutController: TcxGridCardViewRowLayoutController
  ...
  published
    property BackgroundBitmaps: TcxGridCardViewBackgroundBitmaps
    ...
    property DateTimeHandling: TcxGridCardViewDateTimeHandling
      read GetDateTimeHandling write SetDateTimeHandling;
    property Filtering: TcxGridCardViewFiltering read GetFiltering
      write SetFiltering;
    property LayoutDirection: TcxGridCardViewLayoutDirection
      read FLayoutDirection write SetLayoutDirection default ldHorizontal;
    property OptionsBehavior: TcxGridCardViewOptionsBehavior
      read GetOptionsBehavior write SetOptionsBehavior;
    property OptionsCustomize: TcxGridCardViewOptionsCustomize
    ...
    property OptionsSelection: TcxGridCardViewOptionsSelection
    ...
    property RowLayout: TcxGridCardViewRowLayout read FRowLayout
      write SetRowLayout default rlHorizontal;
    property Styles: TcxGridCardViewStyles read GetStyles write SetStyles;
    property OnCustomization;
    property OnRowCollapsed: TcxGridCardRowEvent read FOnRowCollapsed
      write SetOnRowCollapsed;
    property OnRowCollapsing: TcxGridCardRowChangingEvent read FOnRowCollapsing
      write SetOnRowCollapsing;
    property OnRowExpanded: TcxGridCardRowEvent read FOnRowExpanded
      write SetOnRowExpanded;
    property OnRowExpanding: TcxGridCardRowChangingEvent read FOnRowExpanding
      write SetOnRowExpanding;
    property OnRowPosChanged: TcxGridCardRowEvent read FOnRowPosChanged
      write SetOnRowPosChanged;
  end;

implementation

uses
  SysUtils, Math, cxScrollBar, cxGridStrs, dxCoreGraphics, cxLookAndFeels,
  dxTypeHelpers;
...
function TcxGridCardRowCellHitTest.DragAndDropObjectClass
  : TcxCustomGridDragAndDropObjectClass;
begin
  if ((GridRecord = nil) or GridRecord.Visible) and TcxGridCardViewRow(Item).CanMove
  then
...
function TcxGridCardViewSeparatorHitTest.DragAndDropObjectClass
  : TcxCustomGridDragAndDropObjectClass;
begin
...
function TcxGridCard.GetViewInfoCacheItemClass
...
begin
  ...
  begin
    ...
    if ARow.IsVisibleInCard(Self) then
      ARows.Add(ARow);
  end;
end;
...
function TcxGridCardViewViewData.GetRecordClass(const ARecordInfo: TcxRowInfo)
...
function TcxGridCardRowContainerZone.IsEqual
...
function TcxGridCardRowMovingObject.GetRowLayout
...
function TcxGridCardRowMovingObject.GetVisibleRowLayout
  : TcxGridCardViewVisibleRowLayoutObject;
begin
  Result := GridView.RowLayoutController.VisibleLayoutObject;
end;

procedure TcxGridCardRowMovingObject.SetDestZone
  (Value: TcxGridCardRowContainerZone);
begin
...
procedure TcxGridCardRowMovingObject.CalculateDestParams
...
begin
  ...
  begin
    ...
    begin
      ...
      if (SourceItem.Kind = rkCategory) and (ADestRow <> nil) and
        (ADestRow.CategoryRow <> nil) then
      begin
        ...
        begin
          AFirstIndexInLayer := ADestRow.CategoryRow.Position.
            VisibleIndexInLayer;
          ALastVisibleSubItem := VisibleRowLayout.GetLastVisibleSubItem
            (ADestRow.CategoryRow);
          ALastIndexInLayer := ALastVisibleSubItem.Position.VisibleIndexInLayer;
          if ADestRow.Position.VisibleIndexInLayer >
            (AFirstIndexInLayer + ALastIndexInLayer) div 2 then
          begin
            AZone.ItemIndex := ALastVisibleSubItem.VisibleIndex + 1;
            if (TcxGridCardRowContainerZone(AZone).Item = nil) or
              (TcxGridCardRowContainerZone(AZone)
              .Item.Position.LayerVisibleIndex <> ALayerIndex) then
        ...
        begin
          if ADestRow.Position.LayerVisibleIndex - ALayerIndex >=
            MulDiv(ALayerCount, 1, 2) then
            AZone.ItemIndex := VisibleRowLayout.LayerFirstRowIndex
              [ALayerIndex + ALayerCount];
  ...
  begin
    if DestZone.InsertionPos = ripNewLayer then
      ...
      begin
        ...
        if Result > 0 then
          Result := VisibleRowLayout.LayerFirstRow[Result - 1]
            .Position.LayerIndex + 1;
      end
    else
      Result := AInsertionRow.Position.LayerIndex;
  end;
    ...
    case DestZone.InsertionPos of
      ...
      ripSameLayer:
        begin
          ...
          else if AInsertionRow.Position.VisibleIndexInLayer = 0 then
            Result := 0
          else
          begin
            ALayerIndex := SourceItem.Position.LayerVisibleIndex;
            Result := AInsertionRow.Position.VisibleIndexInLayer - 1;
            Result := VisibleRowLayout.LayerRows[ALayerIndex, Result]
              .Position.IndexInLayer + 1;
          end;
          if SourceItem.Position.IndexInLayer < Result then
            Dec(Result);
        end;
...
begin
  ...
  RowLayout.SetLayerIndex(SourceItem, GetLayerIndex(AInsertionRow),
    IsNewLayer, True);
  if GetIndexInLayer(AInsertionRow) <> -1 then
    RowLayout.SetIndexInLayer(SourceItem, GetIndexInLayer(AInsertionRow), True);
end;

function TcxGridCardRowMovingObject.GetArrowAreaBounds
...
function TcxGridCardRowMovingObject.GetSourceItemViewInfo
  : TcxCustomGridCellViewInfo;
begin
  if SourceItemContainerKind = ckRows then
    Result := ViewInfo.RecordsViewInfo.GetRealItem(FSourceGridRecord)
      .RowViewInfos[SourceItem.VisibleIndex]
  else
      ...
      begin
        ...
        if not Result then
          case DestZone.InsertionPos of
            ...
            ripSameLayer:
              Result := DestZone.Item.Position.LayerIndex <>
                SourceItem.Position.LayerIndex;
          end;
      end;
    // do not allow to insert category row just after its items
    if Result and (SourceItem.Kind = rkCategory) and SourceItem.Visible and
      SourceItem.Expanded and ((DestZone.InsertionPos <> ripNewLayer) or
      VisibleRowLayout.IsWholeLayer(SourceItem)) and
      ((DestZone.Item = nil) or (DestZone.Item.Kind = rkCategory) and
      (SourceItem.VisibleIndex < DestZone.ItemIndex)) and
      (GridView.VisibleRows[DestZone.ItemIndex - 1].CategoryRow = SourceItem)
    then
      Result := False;
  end;
end;
...
procedure TcxGridCardRowMovingObject.DragAndDrop(const P: TPoint;
...
begin
  ...
  begin
    ...
    begin
      StartRowExpanding(TcxGridCardViewRow(TcxGridCardRowExpandButtonHitTest
        (AHitTest).Item));
      AKeepRowExpanding := True;
    end
  end;
  if not AKeepRowExpanding then
    StopRowExpanding;
end;
...
procedure TcxGridCardRowMovingObject.EndDragAndDrop(Accepted: Boolean);
  ...
  function GetTopRowIndex: Integer;
  begin
    if Assigned(SourceGridRecord) and
      (SourceGridRecord.ViewInfo is TcxGridCardViewInfo) then
  ...
  begin
    ...
    try
      if APrevTopRowIndex >= 0 then
        TcxGridCardViewInfo(SourceGridRecord.ViewInfo).TopRowIndex :=
          APrevTopRowIndex;
...
procedure TcxGridCardRowMovingObject.StartRowExpanding
  (ARow: TcxGridCardViewRow);
begin
  if (FRowExpandingTimer <> nil) and (FExpandingRow = ARow) then
    Exit;
  StopRowExpanding;
  FExpandingRow := ARow;
...
procedure TcxGridCardRowMovingObject.Init(const P: TPoint;
...
begin
  ...
  if AParams is TcxGridCardRowCaptionHitTest then
    SourceItemContainerKind := TcxGridCardRowCaptionHitTest(AParams)
      .RowContainerKind
  else
...
begin
  ...
  if Result < cxGridCardMinWidth then
    Result := cxGridCardMinWidth;
end;
...
function TcxGridCardSizingObject.GetDragAndDropCursor
...
begin
  ...
  repeat
    ...
    if R.Left >= ViewInfo.ClientBounds.Right then
      Exit;
...
procedure TcxGridCardSizingObject.Init(const P: TPoint;
  AParams: TcxCustomGridHitTest);
begin
  inherited;
...
begin
  Result := TcxGridCardRowCaptionViewInfo.GetCellHeight
    (TdxTextMeasurer.TextLineHeight(Font), LookAndFeelPainter, ScaleFactor);
end;
...
begin
  ...
  if UseRightToLeftAlignment then
    AHorzAlignment := TdxRightToLeftLayoutConverter.ConvertcxDrawTextAlignment
      (AHorzAlignment);
...
function TcxGridCardViewCustomizationForm.GetItemsListBoxClass
...
function TcxGridCardViewController.GetCustomizationForm
  : TcxGridCardViewCustomizationForm;
begin
...
procedure TcxGridCardViewController.SetScrollCardViewInfo
  (Value: TcxGridCardViewInfo);
begin
...
function TcxGridCardViewController.GetHelperClass
  : TcxGridCustomLayoutViewControllerHelperClass;
begin
...
function TcxGridCardViewController.CanFocusNextItem(AFocusedItemIndex,
  ANextItemIndex: Integer; AGoForward, AGoOnCycle, AGoToNextRecordOnCycle
  : Boolean): Boolean;
begin
  Result := inherited CanFocusNextItem(AFocusedItemIndex, ANextItemIndex,
    AGoForward, AGoOnCycle, AGoToNextRecordOnCycle) and
    (not AGoToNextRecordOnCycle or (not AGoForward and
    (not CanScrollFocusedCard(False) or (ANextItemIndex < AFocusedItemIndex)) or
    AGoForward and (not CanScrollFocusedCard(True) or
    (ANextItemIndex > AFocusedItemIndex))));
end;
...
function CanFocusRow(AOwner: TcxCustomGridTableView; AItemIndex: Integer;
  AData: TObject): Boolean;
begin
  Result := TcxGridCardViewRow(TCanFocusRowData(AData).Rows[AItemIndex])
    .CanFocus(TCanFocusRowData(AData).Card);
end;
...
begin
  ...
  try
    AData.Card := ACard;
    AData.Rows := ARows;
    if FindNextCustomItem(ARows.IndexOf(ARow), ARows.Count, AGoForward,
      AGoOnCycle, @CanFocusRow, AData, ARowIndex, ACycleChanged) then
...
function TcxGridCardViewController.GetDesignHitTest
  (AHitTest: TcxCustomGridHitTest): Boolean;
begin
  Result := inherited GetDesignHitTest(AHitTest);
  if not Result then
    Result := AHitTest.HitTestCode in [htExpandButton, htCardRowExpandButton,
      htRowCaption, htCell];
end;
...
begin
  Result := inherited IsKeyForMultiSelect(AKey, AShift, AFocusedRecordChanged)
    or (AKey = VK_LEFT) or (AKey = VK_RIGHT) or
    ((AKey = VK_UP) or (AKey = VK_DOWN) or (AKey = VK_HOME) or (AKey = VK_END))
    and (not GridView.OptionsSelection.CellSelect or (FocusedItem = nil) or
    AFocusedRecordChanged);
end;

procedure TcxGridCardViewController.RowExpandedChanged
  (ARow: TcxGridCardViewRow);
begin
end;

procedure TcxGridCardViewController.RowExpandedChanging
  (ARow: TcxGridCardViewRow; AValue: Boolean);
begin
  if IsDragging then
...
function TcxGridCardViewController.CanScrollData
...
function TcxGridCardViewController.GetScrollDataTimeInterval
...
function TcxGridCardViewController.GetCustomizationFormClass
...
begin
  ...
  case AHitTest.HitTestCode of
    htCardScrollButtonUp, htCardScrollButtonDown:
      begin
        ScrollCardViewInfo := TcxCustomGridCardScrollButtonViewInfo
          (AHitTest.ViewInfo).CardViewInfo;
...
procedure TcxGridCardViewController.MakeItemVisible
...
function TcxGridCardViewController.CanScrollFocusedCard(ADown: Boolean)
  : Boolean;
begin
  Result := (FocusedCardViewInfo <> nil) and
    (not ADown and FocusedCardViewInfo.NeedsScrollingUp or ADown and
    FocusedCardViewInfo.NeedsScrollingDown);
end;
...
begin
  if (FocusedRecordIndex <> -1) and (FocusedRow <> nil) and FocusedRow.CanExpand
  then
    case Key of
      VK_ADD:
...
function TcxGridCardViewController.FocusNextItemHorizontally(AGoForward,
  AGoOnCycle: Boolean): Boolean;
var
  ARow: TcxGridCardViewRow;
...
function TcxGridCardViewController.FocusNextItemVertically(AGoForward,
  AGoOnCycle: Boolean): Boolean;
var
  ARow: TcxGridCardViewRow;
  ACycleChanged: Boolean;
...
function TcxCustomGridCardRowLayoutObject.GetLayerFirstRow(ALayerIndex: Integer)
  : TcxGridCardViewRow;
begin
  Result := Rows[LayerFirstRowIndex[ALayerIndex]];
end;

function TcxCustomGridCardRowLayoutObject.GetLayerFirstRowIndex
...
function TcxCustomGridCardRowLayoutObject.GetLayerRow(ALayerIndex,
  AIndex: Integer): TcxGridCardViewRow;
begin
  Result := Rows[LayerFirstRowIndex[ALayerIndex] + AIndex];
end;

function TcxCustomGridCardRowLayoutObject.GetLayerRowCount
  (ALayerIndex: Integer): Integer;
begin
  Result := Integer(FLayerRowCounts[ALayerIndex]);
end;

procedure TcxCustomGridCardRowLayoutObject.SetLayerRowCount(ALayerIndex,
  Value: Integer);
begin
  FLayerRowCounts[ALayerIndex] := TObject(Value);
end;

function TcxCustomGridCardRowLayoutObject.GetCoordinates(const APosition
  : TcxGridCardRowPosition): TcxGridCardRowCoordinates;
begin
  case Layout of
    rlHorizontal:
      begin
...
function TcxCustomGridCardRowLayoutObject.GetPosition(const ACoordinates
  : TcxGridCardRowCoordinates): TcxGridCardRowPosition;
begin
  case Layout of
    rlHorizontal:
      begin
...
function TcxCustomGridCardRowLayoutObject.GetLayerIndex
  (ARowIndex: Integer): Integer;
begin
  Result := GetPosition(ARowIndex).LayerIndex;
end;

function TcxCustomGridCardRowLayoutObject.GetLayerPosition
  (APosition: TcxPosition): TcxGridCardViewRowLayerPosition;
begin
  Result := rlpBeforeRow;
  case Layout of
    rlHorizontal:
...
function TcxCustomGridCardRowLayoutObject.GetLength
...
function TcxCustomGridCardRowLayoutObject.GetOffsetInLayer(ALayerIndex,
  AIndexInLayer: Integer): Integer;
var
  I: Integer;
begin
  case Layout of
...
function TcxCustomGridCardRowLayoutObject.GetPosition(ARowIndex: Integer)
  : TcxGridCardRowPosition;
var
  I: Integer;
begin
...
function TcxCustomGridCardRowLayoutObject.GetCoordinates
  (ARow: TcxGridCardViewRow): TcxGridCardRowCoordinates;
begin
  Result := GetCoordinates(GetPosition(ARow));
end;

function TcxCustomGridCardRowLayoutObject.GetIndexInLayer
  (ARow: TcxGridCardViewRow): Integer;
begin
...
function TcxCustomGridCardRowLayoutObject.GetOffsetInLayer
  (ARow: TcxGridCardViewRow): Integer;
begin
...
function TcxCustomGridCardRowLayoutObject.GetPosition(ARow: TcxGridCardViewRow)
  : TcxGridCardRowPosition;
begin
  Result := GetPosition(GetRowIndex(ARow));
end;

function TcxCustomGridCardRowLayoutObject.GetRowAtOffset(ALayerIndex,
  AOffset: Integer): TcxGridCardViewRow;
var
...
function TcxCustomGridCardRowLayoutObject.IsFirstInLayer
  (ARow: TcxGridCardViewRow): Boolean;
begin
  Result := GetIndexInLayer(ARow) = 0;
end;

function TcxCustomGridCardRowLayoutObject.IsLastInLayer
  (ARow: TcxGridCardViewRow): Boolean;
begin
  Result := GetIndexInLayer(ARow) = LayerRowCount[GetLayerIndex(ARow)] - 1;
end;

function TcxCustomGridCardRowLayoutObject.IsWholeLine
  (ARow: TcxGridCardViewRow): Boolean;
begin
  case Layout of
    rlHorizontal:
...
function TcxGridCardRowLayoutObject.GetRowIndex
  (ARow: TcxGridCardViewRow): Integer;
begin
...
procedure TcxGridCardVisibleRowLayoutObject.GetInsertionParams
  (ARow: TcxGridCardViewRow; APosition: TcxPosition;
...
begin
  ...
  if ARow.GridView.UseRightToLeftAlignment and (APosition in [posLeft, posRight])
  then
  ...
  case ALayerPosition of
    ...
    rlpAfterRow:
      ...
      begin
        AInsertionIndex := LayerRows[GetLayerIndex(ARow),
          GetIndexInLayer(ARow) + 1].VisibleIndex;
        AInsertionPos := ripSameLayer;
      end;
    rlpBeforeLayer:
      begin
...
procedure TcxGridCardVisibleRowLayoutObject.GetLayerRows
  (ARowInLayer: TcxGridCardViewRow; ARows: TList);
var
  ALayerIndex, I: Integer;
begin
...
procedure TcxGridCardVisibleRowLayoutObject.GetRowsAtOffset
  (ARowAtOffset: TcxGridCardViewRow; ARows: TList);
var
...
function TcxGridCardViewRowLayoutObject.GetBeginsLayer
  (ARow: TcxGridCardViewRow): Boolean;
begin
  Result := IsFirstInLayer(ARow);
end;

procedure TcxGridCardViewRowLayoutObject.SetBeginsLayer
  (ARow: TcxGridCardViewRow; Value: Boolean);
var
...
function TcxGridCardViewRowLayoutObject.GetRow(AIndex: Integer)
  : TcxGridCardViewRow;
begin
...
function TcxGridCardViewRowLayoutObject.GetRowIndex
  (ARow: TcxGridCardViewRow): Integer;
begin
  Result := ARow.Index;
end;
...
procedure TcxGridCardViewRowLayoutObject.RemoveRowFromLayer
  (ALayerIndex: Integer);
begin
  LayerRowCount[ALayerIndex] := LayerRowCount[ALayerIndex] - 1;
...
procedure TcxGridCardViewRowLayoutObject.MoveRows(ARows: TList;
  AIndex: Integer);
var
...
begin
  if Assigned(FOnLayerIndexChanged) then
    FOnLayerIndexChanged(Self);
end;

procedure TcxGridCardViewRowLayoutObject.BreakLayer(ALayerIndex,
  AIndexInLayer: Integer);
{ var
  I: Integer; }
begin
  if AIndexInLayer = 0 then
    Exit;
...
begin
  if ALayerIndex = 0 then
    Exit;
  LayerRowCount[ALayerIndex - 1] := LayerRowCount[ALayerIndex - 1] +
    LayerRowCount[ALayerIndex];
  RemoveLayer(ALayerIndex);
  LayerIndexChanged;
  GridView.Changed(vcSize);
end;

procedure TcxGridCardViewRowLayoutObject.SetCoordinates
  (ARow: TcxGridCardViewRow; const ACoordinates: TcxGridCardRowCoordinates);
begin
  SetPosition(ARow, GetPosition(ACoordinates));
end;

procedure TcxGridCardViewRowLayoutObject.SetIndexInLayer
  (ARow: TcxGridCardViewRow; AValue: Integer; AMoveSubItems: Boolean = False);
var
  ALayerIndex: Integer;
begin
...
procedure TcxGridCardViewRowLayoutObject.SetLayerIndex(ARow: TcxGridCardViewRow;
  ...
  begin
    ...
    if AMoveSubItems and (ARow.Kind = rkCategory) and (Result < RowCount) and
      (Rows[Result].CategoryRow <> nil) then
      for Result := Result - 1 downto 0 do
        if (Rows[Result].Kind = rkCategory) or IsFirstInLayer(Rows[Result]) then
          Break;
    if ARow.Index < Result then
      Dec(Result);
  end;
...
begin
  ...
  ALayerIndex := GetLayerIndex(ARow);
  if (ALayerIndex <> AValue) or ANewLayer and (LayerRowCount[ALayerIndex] > 1)
  then
  begin
    GridView.BeginUpdate;
...
constructor TcxGridCardViewVisibleRowLayoutObject.Create
  (AGridView: TcxGridCardView);
begin
  inherited Create;
  FGridView := AGridView;
...
function TcxGridCardViewVisibleRowLayoutObject.GetLayout
  : TcxGridCardViewRowLayout;
begin
  Result := FGridView.RowLayout;
end;

function TcxGridCardViewVisibleRowLayoutObject.GetLastVisibleSubItem
  (ARow: TcxGridCardViewRow): TcxGridCardViewRow;
var
  ARows: TList;
  I: Integer;
...
function TcxGridCardViewVisibleRowLayoutObject.GetLayerCount
  (ARow: TcxGridCardViewRow): Integer;
var
  ALastVisibleSubItem: TcxGridCardViewRow;
begin
...
function TcxGridCardViewVisibleRowLayoutObject.IsWholeLayer
  (ARow: TcxGridCardViewRow): Boolean;
var
  ALastVisibleSubItem: TcxGridCardViewRow;
begin
...
constructor TcxGridCardViewRowLayoutController.Create
  (AGridView: TcxGridCardView);
begin
  inherited Create;
  FGridView := AGridView;
  ...
  FVisibleLayoutObject := TcxGridCardViewVisibleRowLayoutObject.Create
    (FGridView);
end;
...
function TcxGridCardViewRowLayoutController.GetBeginsLayer
  (ARow: TcxGridCardViewRow): Boolean;
begin
...
procedure TcxGridCardViewRowLayoutController.SetBeginsLayer
  (ARow: TcxGridCardViewRow; Value: Boolean);
begin
...
procedure TcxGridCardViewRowLayoutController.RowIndexChanged
  (ARow: TcxGridCardViewRow; AOldIndex: Integer);
begin
  if AOldIndex = -1 then
    LayoutObject.AddRow(ARow)
  else if ARow.Index = -1 then
...
function TcxGridCardViewRowLayoutController.CreateCardRowLayout
  (ACardViewInfo: TcxGridCardViewInfo): TcxGridCardRowLayout;
begin
  Result := GetCardRowLayoutClass.Create(ACardViewInfo, IsSimpleLayout);
end;

function TcxGridCardViewRowLayoutController.GetCardRowLayoutClass
  : TcxGridCardRowLayoutClass;
begin
  case Layout of
    rlHorizontal:
...
function TcxGridCardViewRowLayoutController.IsWholeLine
  (ARow: TcxGridCardViewRow): Boolean;
begin
  Result := VisibleLayoutObject.IsWholeLine(ARow);
end;

function TcxGridCardViewRowLayoutController.GetCoordinates
  (ARow: TcxGridCardViewRow): TcxGridCardRowCoordinates;
begin
  Result := LayoutObject.GetCoordinates(ARow);
end;

procedure TcxGridCardViewRowLayoutController.SetCoordinates
  (ARow: TcxGridCardViewRow; AColIndex, ARowIndex: Integer);
var
...
procedure TcxGridCardViewRowLayoutController.SetCoordinates
  (ARow: TcxGridCardViewRow; ACoordinates: TcxGridCardRowCoordinates);
begin
  LayoutObject.SetCoordinates(ARow, ACoordinates);
end;

function TcxGridCardViewRowLayoutController.GetVisibleCoordinates
  (ARow: TcxGridCardViewRow): TcxGridCardRowCoordinates;
begin
  Result := VisibleLayoutObject.GetCoordinates(ARow);
end;

function TcxGridCardViewRowLayoutController.GetPosition
  (ARow: TcxGridCardViewRow): TcxGridCardRowPosition;
begin
  Result := LayoutObject.GetPosition(ARow);
end;

procedure TcxGridCardViewRowLayoutController.SetPosition
  (ARow: TcxGridCardViewRow; ALayerIndex, AIndexInLayer: Integer);
var
  APosition: TcxGridCardRowPosition;
begin
...
function TcxGridCardViewRowLayoutController.GetVisiblePosition
  (ARow: TcxGridCardViewRow): TcxGridCardRowPosition;
begin
...
function TcxGridCardViewRowLayoutController.FindNextRowHorizontally
  (ACard: TcxGridCard; ARow: TcxGridCardViewRow;
  AGoForward, AGoOnCycle: Boolean; out ACycleChanged: Boolean)
  : TcxGridCardViewRow;
begin
  Result := FindNextRow(ACard, ARow, IsHorizontalLayout, AGoForward, AGoOnCycle,
    ACycleChanged);
end;

function TcxGridCardViewRowLayoutController.FindNextRowVertically
  (ACard: TcxGridCard; ARow: TcxGridCardViewRow;
  AGoForward, AGoOnCycle: Boolean; out ACycleChanged: Boolean)
  : TcxGridCardViewRow;
begin
  Result := FindNextRow(ACard, ARow, not IsHorizontalLayout, AGoForward,
    AGoOnCycle, ACycleChanged);
end;

{ TcxGridCardRowFilterButtonPainter }

function TcxGridCardRowFilterButtonPainter.GetViewInfo
  : TcxGridCardRowFilterButtonViewInfo;
begin
...
begin
  with ViewInfo do
    GridViewInfo.LookAndFeelPainter.DrawScaledFilterDropDownButton(Self.Canvas,
      Bounds, ButtonState, Active, ScaleFactor);
end;

{ TcxGridCardRowCaptionPainter }

function TcxGridCardRowCaptionPainter.GetViewInfo
...
begin
  ...
  ViewInfo.LookAndFeelPainter.DrawScaledExpandButton(Canvas,
    ViewInfo.ExpandButtonBounds, ViewInfo.Expanded, ScaleFactor);
end;
...
begin
  with ViewInfo do
    if DataViewInfo.Focused then
      GridViewInfo.Painter.DrawFocusRect(ContentBounds,
        CardViewInfo.HideFocusRectOnExit);
end;
...
function TcxGridCardScrollButtonPainter.GetViewInfo
  : TcxCustomGridCardScrollButtonViewInfo;
begin
...
const
  ScrollBarParts: array [Boolean] of TcxScrollBarPart = (sbpLineUp,
    sbpLineDown);
begin
  ViewInfo.GridViewInfo.LookAndFeelPainter.DrawScaledScrollBarPart(Canvas,
    False, ViewInfo.Bounds, ScrollBarParts[ViewInfo.IsDownButton],
    ViewInfo.ButtonState, ScaleFactor);
end;
...
function TcxGridCardExpandButtonPainter.GetViewInfo
  : TcxGridCardExpandButtonViewInfo;
begin
...
begin
  ...
  if AParams.Bitmap = nil then
    ...
    begin
      Canvas.FillRect(Rect(ABounds.Left, ABounds.Top, ABounds.Right, Top),
        AParams.Bitmap);
      ...
      Canvas.FillRect(Rect(ABounds.Left, Bottom, ABounds.Right, ABounds.Bottom),
        AParams.Bitmap);
    end;
end;
...
begin
  ...
  try
    ...
    try
      ...
      for I := ViewInfo.TopRowIndex to ViewInfo.TopRowIndex +
        ViewInfo.PartVisibleRowCount - 1 do
      begin
...
begin
  DrawCardBorder;
  DrawScrollButtons;
  if ViewInfo.HasLayerSeparators then
    DrawLayerSeparators;
  DrawRows;
  inherited;
end;
...
function TcxGridCardViewColumn.GetNearestRow(APos: Integer)
  : TcxGridCardViewInfo;
begin
...
procedure TcxGridCardViewColumn.SetRow(Index: Integer;
  Value: TcxGridCardViewInfo);
begin
...
constructor TcxGridCardRowCellViewInfo.Create(ARowViewInfo
  : TcxGridCardRowViewInfo);
begin
  ...
  try
    ...
    if (ASelfLink.Ref <> nil) and (AButton = mbLeft) then
      if ssDouble in AShift then
        if Result and Row.CanExpand and GridView.OptionsBehavior.ExpandRowOnDblClick
        then
        begin
      ...
      else if GridView.IsDesigning then
      begin
        GridView.Controller.DesignController.SelectObject(Row,
...
constructor TcxGridCardRowFilterButtonViewInfo.Create(ARowCaptionViewInfo
  : TcxGridCardRowCaptionViewInfo);
begin
...
function TcxGridCardRowFilterButtonViewInfo.GetHitTestClass
...
function TcxGridCardRowFilterButtonViewInfo.GetPainterClass
...
begin
  Result := OccupiesSpace or (RowCaptionViewInfo.State <> gcsNone) or
    (State <> gcsNone);
end;

procedure TcxGridCardRowFilterButtonViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
  inherited;
...
function TcxGridCardRowFilterButtonViewInfo.GetFilterPopupMode
...
constructor TcxGridCardRowCaptionViewInfo.Create(ARowViewInfo
  : TcxGridCardRowViewInfo);
begin
  inherited;
  if CanFilter then
...
procedure TcxGridCardRowCaptionViewInfo.Calculate(ALeftBound,
...
procedure TcxGridCardRowCaptionViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
...
function TcxGridCardRowCaptionViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
  if (FilterButtonViewInfo <> nil) and FilterButtonViewInfo.VisibleForHitTest
  then
  begin
...
class function TcxGridCardRowCaptionViewInfo.CalculateSimpleHeight
...
begin
  ...
  ADefaultCaptionHeight := GetCellHeight(ACanvas.FontHeight(AFont),
    ARow.GridView.LookAndFeelPainter, AScaleFactor);
...
begin
  ...
  if Row.HasCardExpandButton and
    ...
    (CardViewInfo.ExpandButtonAlignment = cebaRight) and
    not RowViewInfo.DataViewInfo.Visible) then
...
function TcxGridCardRowCaptionViewInfo.GetFilterButtonViewInfoClass
  : TcxGridCardRowFilterButtonViewInfoClass;
begin
  Result := TcxGridCardRowFilterButtonViewInfo;
end;

function TcxGridCardRowCaptionViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
begin
  Result := (FilterButtonViewInfo <> nil) and
    FilterButtonViewInfo.NeedsContainerHotTrack;
end;

function TcxGridCardRowCaptionViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  ...
  if (FilterButtonViewInfo <> nil) and FilterButtonViewInfo.OccupiesSpace then
    Dec(Result.Right, ScaleFactor.Apply(cxGridCellTextOffset) +
      FilterButtonViewInfo.Width);
end;

procedure TcxGridCardRowCaptionViewInfo.GetViewParams
...
procedure TcxGridCardRowCaptionViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
  inherited;
...
begin
  CalculateParams;
  if MultiLine then
    Result := CardViewInfo.RecordsViewInfo.GetCellHeight
      (inherited CalculateHeight)
  else
    Result := CalculateSimpleHeight(Row, Canvas, Params.Font);
end;

class function TcxGridCardRowDataViewInfo.CalculateSimpleHeight
  (ARow: TcxGridCardViewRow; ACanvas: TcxCanvas; AFont: TFont): Integer;
var
...
begin
  ...
  begin
    ...
    CheckHeight(TcxGridCardViewInfoClass(CardViewInfo.ClassType), Row, Self,
      LookAndFeelPainter, ScaleFactor, Result);
  end;
end;

class function TcxGridCardRowViewInfo.CalculateSimpleHeight
  (ARow: TcxGridCardViewRow; ACanvas: TcxCanvas): Integer;
...
begin
  ...
  CheckHeight(TcxGridCardViewInfoClass(ARow.GridView.ViewInfo.RecordsViewInfo.
    GetItemViewInfoClass), ARow, nil, ARow.GridView.LookAndFeelPainter,
    ARow.GridView.ScaleFactor, Result);
end;
...
class procedure TcxGridCardRowViewInfo.CheckHeight(ACardViewInfoClass
  : TcxGridCardViewInfoClass; ARow: TcxGridCardViewRow;
  ARowViewInfo: TcxGridCardRowViewInfo;
  ALookAndFeelPainter: TcxCustomLookAndFeelPainter;
  AScaleFactor: TdxScaleFactor; var AHeight: Integer);
begin
  if ARow.HasCardExpandButton then
    AHeight := Max(AHeight, ACardViewInfoClass.GetExpandButtonSize
      (ALookAndFeelPainter, AScaleFactor));
  if ARow.HasExpandButton then
    AHeight := Max(AHeight, GetExpandButtonAreaSize(ALookAndFeelPainter,
      AScaleFactor));
end;

class function TcxGridCardRowViewInfo.GetCaptionViewInfoClass
...
class function TcxGridCardRowViewInfo.GetDataViewInfoClass
...
class function TcxGridCardRowViewInfo.GetExpandButtonAreaSize
  ...
  : Integer;
begin
  Result := CardRowExpandButtonOffset + GetExpandButtonSize(APainter,
    AScaleFactor) + CardRowExpandButtonOffset;
  dxAdjustToTouchableSize(Result, AScaleFactor);
end;

function TcxGridCardRowViewInfo.GetExpandButtonBounds: TRect;
begin
  Result := cxRectCenter(ExpandButtonAreaBounds, ExpandButtonSize,
    ExpandButtonSize);
end;
...
class function TcxGridCardRowViewInfo.GetSimpleViewParams
  (ARow: TcxGridCardViewRow; AIsCaption: Boolean): TcxViewParams;
begin
...
begin
  ...
  inherited;
  CalculateVisibles;
  FCaptionViewInfo.Calculate(ContentBounds.Left, ContentBounds.Top, -1,
    ContentHeight);
  FDataViewInfo.Calculate(ContentBounds.Left + FCaptionViewInfo.Width,
    ContentBounds.Top, -1, ContentHeight);
end;

function TcxGridCardRowViewInfo.CalculateVisibleCounts(var AVisibleRowCount,
...
function TcxGridCardRowViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
  ...
  else if HasExpandButton and PtInRect(ExpandButtonAreaBounds, P) then
  begin
...
procedure TcxGridCardDataRowViewInfo.GetCaptionViewParams
  (var AParams: TcxViewParams; AIgnoreSelection: Boolean);
begin
  GridView.Styles.GetDataCellParams(GridRecord, Row, AParams, False, nil,
    AIgnoreSelection);
end;

class function TcxGridCardDataRowViewInfo.GetDataViewInfoClass
  : TcxGridCardRowDataViewInfoClass;
begin
  Result := TcxGridCardDataRowDataViewInfo;
end;

procedure TcxGridCardDataRowViewInfo.GetDataViewParams
  (var AParams: TcxViewParams);
begin
  Row.Styles.GetContentParams(GridRecord, AParams);
end;

class function TcxGridCardDataRowViewInfo.GetSimpleViewParams
  (ARow: TcxGridCardViewRow; AIsCaption: Boolean): TcxViewParams;
begin
  if AIsCaption then
...
procedure TcxGridCardCaptionRowDataViewInfo.GetEditViewDataContentOffsets
  (var R: TRect);
var
  R1, R2: TRect;
begin
...
function TcxGridCardCaptionRowDataViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
  Result := TcxGridCardRowCellHitTest;
end;
...
class function TcxGridCardCaptionRowViewInfo.GetCaptionViewInfoClass
  : TcxGridCardRowCaptionViewInfoClass;
begin
...
class function TcxGridCardCaptionRowViewInfo.GetDataViewInfoClass
  : TcxGridCardRowDataViewInfoClass;
begin
  Result := TcxGridCardCaptionRowDataViewInfo;
end;

procedure TcxGridCardCaptionRowViewInfo.GetDataViewParams
  (var AParams: TcxViewParams);
begin
  GetViewParams(AParams);
end;

procedure TcxGridCardCaptionRowViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
class procedure TcxGridCardCategoryRowViewInfo.CheckHeight(ACardViewInfoClass
  : TcxGridCardViewInfoClass; ARow: TcxGridCardViewRow;
  ARowViewInfo: TcxGridCardRowViewInfo;
  ALookAndFeelPainter: TcxCustomLookAndFeelPainter;
  AScaleFactor: TdxScaleFactor; var AHeight: Integer);
begin
  ...
  if (ARowViewInfo = nil) and HasSeparator(ACardViewInfoClass, ARow) or
    (ARowViewInfo <> nil) and TcxGridCardCategoryRowViewInfo(ARowViewInfo).HasSeparator
  then
    Inc(AHeight, ARow.GridView.OptionsView.CategorySeparatorWidth);
end;

function TcxGridCardCategoryRowViewInfo.GetBorderColor
...
function TcxGridCardCategoryRowViewInfo.GetBorderWidth
...
procedure TcxGridCardCategoryRowViewInfo.GetDataViewParams
  (var AParams: TcxViewParams);
begin
...
class function TcxGridCardCategoryRowViewInfo.HasSeparator(ACardViewInfoClass
  : TcxGridCardViewInfoClass; ARow: TcxGridCardViewRow): Boolean;
begin
  Result := ACardViewInfoClass.HasCategorySeparator(ARow);
end;

function TcxGridCardCategoryRowViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
...
constructor TcxCustomGridCardScrollButtonViewInfo.Create(ACardViewInfo
  : TcxGridCardViewInfo);
begin
  inherited Create(ACardViewInfo.GridViewInfo);
  FCardViewInfo := ACardViewInfo;
...
procedure TcxCustomGridCardScrollButtonViewInfo.ScrollTimerHandler
  (Sender: TObject);
begin
  if Visible then
    Scroll
...
function TcxCustomGridCardScrollButtonViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridCardScrollButtonPainter;
end;

procedure TcxCustomGridCardScrollButtonViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
...
function TcxGridCardScrollButtonDownViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridCardScrollButtonUpViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
constructor TcxGridCardExpandButtonViewInfo.Create(ACardViewInfo
  : TcxGridCardViewInfo);
begin
  inherited Create(ACardViewInfo.GridViewInfo);
  FCardViewInfo := ACardViewInfo;
...
function TcxGridCardExpandButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridCardExpandButtonViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
procedure TcxGridCardExpandButtonViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
  inherited;
...
constructor TcxGridCardRowLayer.Create(AOwner: TcxGridCardRowLayout;
  AIndex: Integer);
begin
  inherited Create;
  FOwner := AOwner;
...
function TcxGridCardRowLayout.GetLayerRowViewInfo(ALayerIndex, AIndex: Integer)
  : TcxGridCardRowViewInfo;
begin
  Result := CardViewInfo.RowViewInfos
    [LayerRows[ALayerIndex, AIndex].VisibleIndex];
end;
...
function TcxGridCardRowLayout.CalculateRowsHeaderWidth(ARows: TList;
...
function TcxGridCardRowLayout.HasSeparator(ALayer: TcxGridCardRowLayer)
  : Boolean;
begin
...
function TcxGridCardRowLayout.IsLayerVisible(const ABounds,
  ALayerBounds: TRect): Boolean;
begin
  Result := True;
end;
...
procedure TcxGridCardRowLayout.CalculateRows(const ABounds: TRect;
  ATopRowIndex, AMaxRowHeight: Integer;
  var AVisibleRowCount, APartVisibleRowCount: Integer);
var
  R: TRect;
  I: Integer;
begin
  ...
  for I := 0 to LayerCount - 1 do
    ...
    begin
      ...
      if IsLayerVisible(ABounds, R) then
        Layers[I].CalculateRows(R, ATopRowIndex, AVisibleRowCount,
          APartVisibleRowCount);
    end;
end;

function TcxGridCardRowLayout.GetIndexInLayer(ARowViewInfo
  : TcxGridCardRowViewInfo): Integer;
begin
  Result := GetIndexInLayer(ARowViewInfo.Row);
end;

function TcxGridCardRowLayout.GetLayerIndex(ARowViewInfo
  : TcxGridCardRowViewInfo): Integer;
begin
...
begin
  for Result := 0 to LayerCount - 1 do
    if Layers[Result].HasPoint(P) then
      Exit;
  Result := -1;
end;
...
procedure TcxGridCardRowHorizontalLayer.CalculateRowWidths(AAvailableWidth
  : Integer);
var
...
constructor TcxGridCardRowHorizontalLayout.Create(ACardViewInfo
  : TcxGridCardViewInfo; ASimple: Boolean);
begin
  inherited;
  FFirstColumnRowsHeaderWidth := -1;
end;

function TcxGridCardRowHorizontalLayout.CalculateFirstColumnRowsHeaderWidth
  (AWidth: Integer): Integer;
var
  ARows: TList;
  I: Integer;
...
procedure TcxGridCardRowHorizontalLayout.CalculateLayerBounds
  (ALayer: TcxGridCardRowLayer; AMaxRowHeight: Integer; var ABounds: TRect);
begin
...
function TcxGridCardRowHorizontalLayout.IsLayerVisible
  (ALayer: TcxGridCardRowLayer; ATopRowIndex: Integer): Boolean;
begin
  Result := inherited IsLayerVisible(ALayer, ATopRowIndex) and
    (not Simple or (ALayer.Index >= ATopRowIndex));
end;

function TcxGridCardRowHorizontalLayout.IsLayerVisible(const ABounds,
  ALayerBounds: TRect): Boolean;
begin
  Result := inherited IsLayerVisible(ABounds, ALayerBounds) and
    (not Simple or (ABounds.Top <= ALayerBounds.Top) and
    (ALayerBounds.Top < ABounds.Bottom));
end;
...
function TcxGridCardRowHorizontalLayout.GetHeaderWidth
  (ARowViewInfo: TcxGridCardRowViewInfo): Integer;
begin
...
function TcxGridCardRowHorizontalLayout.GetSeparatorBounds
...
function TcxGridCardRowHorizontalLayout.IsLeft(ARowViewInfo
  : TcxGridCardRowViewInfo): Boolean;
begin
  Result := GetIndexInLayer(ARowViewInfo) = 0;
end;

function TcxGridCardRowHorizontalLayout.IsTop(ARowViewInfo
  : TcxGridCardRowViewInfo): Boolean;
begin
  Result := GetLayerIndex(ARowViewInfo) = 0;
end;

function TcxGridCardRowHorizontalLayout.IsZoneVertical
  (AZone: TcxGridCardRowContainerZone): Boolean;
begin
...
begin
  ...
  begin
    ...
    ARowViewInfo.Calculate(R);
    R.Top := R.Bottom;
    if not ARowViewInfo.CalculateVisibleCounts(AVisibleRowCount,
      APartVisibleRowCount) then
      Break;
  end;
end;
...
procedure TcxGridCardRowVerticalLayout.CalculateLayerBounds
  (ALayer: TcxGridCardRowLayer; AMaxRowHeight: Integer; var ABounds: TRect);
begin
...
procedure TcxGridCardRowVerticalLayout.CalculateLayerWidths(AAvailableWidth
  : Integer);
var
  AWidths: array of Integer;
  I: Integer;
...
function TcxGridCardRowVerticalLayout.GetHeaderWidth(ARowViewInfo
  : TcxGridCardRowViewInfo): Integer;
begin
  Result := TcxGridCardRowVerticalLayer(Layers[GetLayerIndex(ARowViewInfo)])
    .RowsHeaderWidth;
end;

function TcxGridCardRowVerticalLayout.GetSeparatorBounds
  (AIndex: Integer): TRect;
begin
  Result := CardViewInfo.LayerSeparatorAreaBounds;
...
function TcxGridCardRowVerticalLayout.IsLeft(ARowViewInfo
  : TcxGridCardRowViewInfo): Boolean;
begin
  Result := True;
end;

function TcxGridCardRowVerticalLayout.IsTop(ARowViewInfo
  : TcxGridCardRowViewInfo): Boolean;
begin
  Result := GetIndexInLayer(ARowViewInfo) = 0;
end;

function TcxGridCardRowVerticalLayout.IsZoneVertical
  (AZone: TcxGridCardRowContainerZone): Boolean;
begin
  Result := AZone.InsertionPos = ripNewLayer;
end;
...
constructor TcxGridCardViewInfo.Create(ARecordsViewInfo
...
function TcxGridCardViewInfo.GetRowViewInfo(Index: Integer)
  : TcxGridCardRowViewInfo;
begin
...
function TcxGridCardViewInfo.GetVisibleRowViewInfo(Index: Integer)
  : TcxGridCardRowViewInfo;
begin
...
begin
  ...
  Layout.CalculateRows(R, TopRowIndex, MaxRowViewInfoHeight, FVisibleRowCount,
    FPartVisibleRowCount);
end;
...
begin
  ...
  begin
    ...
    if not ARowViewInfo.CalculateVisibleCounts(FVisibleRowCount,
      FPartVisibleRowCount) then
      Break;
  end;
end;
...
function TcxGridCardViewInfo.GetExpandButtonAlignment
...
function TcxGridCardViewInfo.GetScrollButtonDownViewInfoClass
  : TcxGridCardScrollButtonDownViewInfoClass;
begin
  Result := TcxGridCardScrollButtonDownViewInfo;
end;

function TcxGridCardViewInfo.GetScrollButtonUpViewInfoClass
  : TcxGridCardScrollButtonUpViewInfoClass;
begin
...
function TcxGridCardViewInfo.HasCategorySeparator(ARowViewInfo
  : TcxGridCardCategoryRowViewInfo): Boolean;
begin
  Result := not Layout.IsTop(ARowViewInfo) and
    Layout.IsWholeLine(ARowViewInfo.Row);
end;

class function TcxGridCardViewInfo.HasCategorySeparator
  (ARow: TcxGridCardViewRow): Boolean;
begin
  Result := (ARow.Position.VisibleRowIndex <> 0) and ARow.Position.IsWholeLine;
end;

function TcxGridCardViewInfo.HasIndent(ARowViewInfo
  : TcxGridCardRowViewInfo): Boolean;
begin
  Result := (ARowViewInfo.Row.CategoryRow <> nil) and
    Layout.IsLeft(ARowViewInfo);
end;
...
function TcxGridCardViewInfo.IsRowPartiallyVisible(ARowViewInfo
  : TcxGridCardRowViewInfo): Boolean;
begin
  Result := not Layout.Simple or
    (ARowViewInfo.Bounds.Top < ContentBounds.Bottom);
end;

function TcxGridCardViewInfo.IsRowVisible(ARowViewInfo
  : TcxGridCardRowViewInfo): Boolean;
begin
  Result := not Layout.Simple or
    (ARowViewInfo.Bounds.Bottom <= ContentBounds.Bottom);
end;
...
function TcxGridCardViewInfo.GetZone(AHitTest: TcxCustomGridHitTest)
  ...
  begin
    ...
    begin
      ...
      if P.X < ARect.Left + AHorzAreaWidth then
        Result := posLeft
      else if P.X >= ARect.Right - AHorzAreaWidth then
        Result := posRight;
    end;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      APosition := GetPointPosition(RowViewInfos[ARow.VisibleIndex]
        .ContentBounds, AHitTest.Pos, GridView.SupportsLayeredRows);
    end
    else if AHitTest.HitTestCode = htCardScrollButtonUp then
    begin
      ARow := VisibleRowViewInfos[TopRowIndex].Row;
      APosition := posTop;
    end
    else if (AHitTest.HitTestCode = htCardScrollButtonDown) or
      PtInRect(RestSpaceBounds, AHitTest.Pos) then
    begin
    ...
    else if PtInRect(ContentBounds, AHitTest.Pos) then
    begin
  ...
  if AInsertionIndex <> -1 then
    Result := TcxGridCardRowContainerZone.Create(GridRecord, AInsertionIndex,
      AInsertionPos)
  else
    Result := nil;
end;

function TcxGridCardViewInfo.GetZoneBounds
  (AZone: TcxGridCardRowContainerZone): TRect;
var
...
begin
  ...
  begin
    AUseFirstPart := False;
    if AZone.ItemIndex > VisibleRowViewInfos[TopRowIndex + PartVisibleRowCount -
      1].Row.VisibleIndex then
      Result := VisibleRowViewInfos[TopRowIndex + PartVisibleRowCount -
        1].Bounds
    else if AZone.InsertionPos = ripPrevLayer then
      Result := VisibleRowViewInfos
        [VisibleRowViewInfoIndexOf(RowViewInfos[AZone.ItemIndex]) - 1].Bounds
    else
    begin
...
function TcxGridCardViewInfo.IsZoneVertical
  (AZone: TcxGridCardRowContainerZone): Boolean;
begin
  Result := Layout.IsZoneVertical(AZone);
end;

function TcxGridCardViewInfo.GetExpandButtonViewInfoClass
  : TcxGridCardExpandButtonViewInfoClass;
begin
  Result := TcxGridCardExpandButtonViewInfo;
end;

class function TcxGridCardViewInfo.GetRowViewInfoClass(ARow: TcxGridCardViewRow)
  : TcxGridCardRowViewInfoClass;
const
  RowViewInfoClasses: array [TcxGridCardViewRowKind]
    of TcxGridCardRowViewInfoClass = (TcxGridCardDataRowViewInfo,
    TcxGridCardCaptionRowViewInfo, TcxGridCardCategoryRowViewInfo);
begin
...
function TcxGridCardViewInfo.GetBoundsForItem
...
procedure TcxGridCardViewInfo.GetCardBorderViewParams
  (var AParams: TcxViewParams);
begin
  GridView.Styles.GetCardBorderVisualParams(GridRecord, AParams);
end;

function TcxGridCardViewInfo.GetCellViewInfoByItem
...
begin
  ...
  if AVisibleRowIndex = -1 then
    Exit;
  if AVisibleRowIndex <= TopRowIndex then
    TopRowIndex := AVisibleRowIndex
  else if AVisibleRowIndex >= TopRowIndex + VisibleRowCount then
    repeat
      TopRowIndex := TopRowIndex + 1;
    until VisibleRowViewInfos[AVisibleRowIndex].Visible or
      (AVisibleRowIndex = TopRowIndex);
end;
...
function TcxGridCardViewInfo.VisibleRowViewInfoIndexOf
  (ARow: TcxGridCardViewRow): Integer;
begin
...
function TcxGridCardsViewInfo.CalculateCardRowHeight
  (ARow: TcxGridCardViewRow): Integer;
begin
  Result := TcxGridCardViewInfoClass(GetItemViewInfoClass)
    .GetRowViewInfoClass(ARow).CalculateSimpleHeight(ARow, Canvas);
end;
...
function TcxGridCardsViewInfo.GetItemViewInfoClass
  : TcxGridCustomLayoutRecordViewInfoClass;
begin
...
function TcxGridCardsViewInfo.GetCalculatorClass
  : TcxGridCustomLayoutRecordsViewInfoBasedCalculatorClass;
begin
  case GridView.LayoutDirection of
    ldHorizontal:
...
function TcxGridCardsViewInfo.GetZone(AHitTest: TcxCustomGridHitTest)
  : TcxGridItemContainerZone;
begin
  if (AHitTest is TcxGridRecordHitTest) and TcxGridCardViewController
    (Controller).CanHandleHitTest(AHitTest) then
    Result := GetRealItem(TcxGridRecordHitTest(AHitTest).GridRecord)
      .GetZone(AHitTest)
  else
    Result := nil;
end;
...
begin
  Result := (CardRowHeights <> nil) and not AutoCellHeight and
    (not AutoDataRecordHeight or
    (GridView.OptionsView.CategorySeparatorWidth = 0)
    { or (no category rows) } );
end;
...
function TcxGridCardViewSeparatorsViewInfo.GetGridViewInfo
  : TcxGridCardViewViewInfo;
begin
  Result := TcxGridCardViewViewInfo(inherited GridViewInfo);
end;

function TcxGridCardViewSeparatorsViewInfo.GetCardsViewInfo
  : TcxGridCardsViewInfo;
begin
  Result := TcxGridCardsViewInfo(inherited RecordsViewInfo);
end;

function TcxGridCardViewSeparatorsViewInfo.GetHitTest(const P: TPoint)
  : TcxGridCardViewSeparatorHitTest;
var
  I: Integer;
begin
  if GridView.SupportsCardSizing and PtInRect(GridViewInfo.ClientBounds, P) then
    for I := 0 to HitTestItemCount - 1 do
      ...
      begin
        Result := TcxGridCardViewSeparatorHitTest
          (TcxGridCardViewSeparatorHitTest.Instance(P));
...
function TcxGridCardViewSeparatorsHorizontalViewInfo.GetHitTestItem
  (Index: Integer): TRect;
begin
  Result := Items[Index];
...
function TcxGridCardViewSeparatorsHorizontalViewInfo.
  GetHitTestItemCount: Integer;
begin
  Result := Count;
end;
...
begin
  ...
  begin
    R.Left := CardsViewInfo.Columns[I][0].Bounds.Right +
      CardsViewInfo.RecordIndent;
...
function TcxGridCardViewSeparatorsVerticalViewInfo.GetHitTestItem
  (Index: Integer): TRect;
begin
  Result := Bounds;
...
var
  ...
  I: Integer;
begin
  if CardsViewInfo.Columns.Count = 0 then
    Exit;
  R := Bounds;
...
function TcxGridCardViewViewInfo.GetSeparatorsViewInfo
  : TcxGridCardViewSeparatorsViewInfo;
begin
...
function TcxGridCardViewViewInfo.DoGetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
...
begin
  if (RecordsViewInfo.RecordWidth = 0) or (RecordsViewInfo.RecordHeight = 0)
  then
  begin
...
begin
  ...
  IntersectRect(Result, Result,
    Controller.FocusedCardViewInfo.ScrollableAreaBounds);
end;

function TcxGridCardViewViewInfo.GetRecordsViewInfoClass
  : TcxCustomGridRecordsViewInfoClass;
begin
  Result := TcxGridCardsViewInfo;
end;

function TcxGridCardViewViewInfo.GetSeparatorsViewInfoClass
  : TcxGridCustomLayoutViewSeparatorsViewInfoClass;
begin
  case GridView.LayoutDirection of
    ldHorizontal:
...
procedure TcxGridCardViewRowStyles.SetOnGetCaptionRowStyle
...
procedure TcxGridCardViewRowStyles.SetOnGetCaptionStyle
  (Value: TcxGridGetCellStyleEvent);
begin
...
procedure TcxGridCardViewRowStyles.SetOnGetCategoryRowStyle
  (Value: TcxGridGetCellStyleEvent);
begin
...
procedure TcxGridCardViewRowStyles.GetDefaultViewParams(Index: Integer;
  AData: TObject; out AParams: TcxViewParams);
begin
  case Index of
    isCaptionRow:
      GridView.Styles.GetCaptionRowParams(TcxCustomGridRecord(AData),
        Item, AParams);
    isCategoryRow:
      GridView.Styles.GetCategoryRowParams(TcxCustomGridRecord(AData),
        Item, AParams);
    isRowCaption:
      GridView.Styles.GetRowCaptionParams(TcxCustomGridRecord(AData),
        Item, AParams);
  else
    inherited;
  end;
...
procedure TcxGridCardViewRowStyles.GetCaptionParams
...
procedure TcxGridCardViewRowStyles.GetCaptionRowParams
  (ARecord: TcxCustomGridRecord; out AParams: TcxViewParams);
var
  AStyle: TcxStyle;
begin
...
procedure TcxGridCardViewRowStyles.GetCategoryRowParams
  (ARecord: TcxCustomGridRecord; out AParams: TcxViewParams);
var
  AStyle: TcxStyle;
begin
...
function TcxGridCardViewRow.GetCategoryItem(AIndex: Integer)
  : TcxGridCardViewRow;
begin
...
begin
  if (FKind <> rkCategory) and (CategoryRow <> Value) then
    ...
    else if Value.Kind = rkCategory then
      Index := Value.Index + Value.CategoryItemCount + 1 -
        Ord(Index < Value.Index);
end;
...
begin
  ...
  begin
    if not GridView.RowExpandedChanging(Self, Value) then
      Exit;
    GridView.BeginUpdate;
    try
...
procedure TcxGridCardViewRow.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
...
procedure TcxGridCardViewRow.SetPropertyValue(const AName: string;
...
begin
  Result := Expandable and GridView.OptionsCustomize.RowExpanding and
    Options.Expanding;
end;
...
begin
  ...
  if GridView.OptionsView.CategoryRowCaptionInRowAlternateCaption and
    (CategoryRow <> nil) then
    Result := CategoryRow.GetAlternateCaption +
      cxGridCardViewAlternateCaptionSeparator + Result;
end;
...
begin
  Result := GridView.OptionsCustomize.CardExpanding and (FKind = rkCaption) and
    (GridView.FirstCaptionRow = Self);
end;
...
begin
  ...
  if Result and (FKind <> rkCaption) then
    Result := ACard.Expanded and
      ((FKind <> rkData) or GridView.OptionsView.EmptyRows or ACard.IsEditing or
      not VarIsNull(ACard.Values[Index]));
end;
...
function TcxGridCardViewBackgroundBitmaps.GetBitmapStyleIndex
...
function TcxGridCardViewFiltering.GetRowExcelPopup
...
function TcxGridCardViewFiltering.
  GetRowFilteredItemsListShowFilteredItemsOnly: Boolean;
begin
...
procedure TcxGridCardViewFiltering.SetRowExcelPopup
...
procedure TcxGridCardViewFiltering.SetRowFilteredItemsListShowFilteredItemsOnly
  (AValue: Boolean);
begin
...
procedure TcxGridCardViewFiltering.SetRowPopup
  (Value: TcxGridItemFilterPopupOptions);
begin
  ItemPopup := Value;
end;

procedure TcxGridCardViewFiltering.SetRowPopupMode
...
begin
  inherited;
  Filer.DefineProperty('RowPopupDropDownWidth', ReadItemPopupDropDownWidth,
    nil, True);
  Filer.DefineProperty('RowPopupMaxDropDownItemCount',
...
constructor TcxGridCardViewOptionsCustomize.Create
...
constructor TcxGridCardViewOptionsSelection.Create
  (AGridView: TcxCustomGridView);
begin
  inherited;
...
procedure TcxGridCardViewOptionsSelection.SetCardBorderSelection
  (Value: Boolean);
begin
...
begin
  ...
  if Source is TcxGridCardViewOptionsSelection then
    CardBorderSelection := TcxGridCardViewOptionsSelection(Source)
      .CardBorderSelection;
end;
...
function TcxGridCardViewOptionsView.GetShowRowFilterButtons
...
begin
  if Value < cxGridCardBorderMinWidth then
    Value := cxGridCardBorderMinWidth;
...
procedure TcxGridCardViewOptionsView.SetCardExpandButtonAlignment
  (Value: TcxGridCardExpandButtonAlignment);
begin
...
begin
  if Value < cxGridCardMinWidth then
    Value := cxGridCardMinWidth;
...
procedure TcxGridCardViewOptionsView.SetCategoryRowCaptionInRowAlternateCaption
  (Value: Boolean);
begin
...
procedure TcxGridCardViewOptionsView.SetShowRowFilterButtons
...
begin
  if Source is TcxGridCardViewOptionsView then
    ...
    begin
      ...
      Self.CategoryRowCaptionInRowAlternateCaption :=
        CategoryRowCaptionInRowAlternateCaption;
...
procedure TcxGridCardViewStyles.SetOnGetCaptionRowStyle
  (Value: TcxGridGetCellStyleEvent);
begin
  if not dxSameMethods(FOnGetCaptionRowStyle, Value) then
  begin
...
procedure TcxGridCardViewStyles.SetOnGetCardBorderStyle
...
procedure TcxGridCardViewStyles.SetOnGetCategoryRowStyle
  (Value: TcxGridGetCellStyleEvent);
begin
  if not dxSameMethods(FOnGetCategoryRowStyle, Value) then
  begin
...
procedure TcxGridCardViewStyles.SetOnGetRowCaptionStyle
  (Value: TcxGridGetCellStyleEvent);
begin
...
function TcxGridCardViewStyles.GetBackgroundBitmapIndex(Index: Integer)
  : Integer;
begin
  case Index of
    vsCardBorder:
...
procedure TcxGridCardViewStyles.GetDefaultViewParams(Index: Integer;
  AData: TObject; out AParams: TcxViewParams);
begin
...
procedure TcxGridCardViewStyles.GetCaptionRowParams
...
procedure TcxGridCardViewStyles.GetCardBorderParams
  (ARecord: TcxCustomGridRecord; out AParams: TcxViewParams);
var
  AStyle: TcxStyle;
begin
...
procedure TcxGridCardViewStyles.GetCardBorderVisualParams
  (ARecord: TcxCustomGridRecord; out AParams: TcxViewParams);
begin
...
procedure TcxGridCardViewStyles.GetCategoryRowParams
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
  out AParams: TcxViewParams);
var
  AStyle: TcxStyle;
...
procedure TcxGridCardViewStyles.GetDataCellContentParams
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
  out AParams: TcxViewParams);
begin
  if AItem = nil then
...
procedure TcxGridCardViewStyles.GetRowCaptionParams
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
  out AParams: TcxViewParams);
var
  AStyle: TcxStyle;
...
procedure TcxGridCardViewStyleSheet.SetStylesValue
  (Value: TcxGridCardViewStyles);
begin
  SetStyles(Value);
end;
...
begin
  ...
  begin
    Result := Rows[I];
    if Result.Kind = rkCategory then
      Exit;
  end;
  Result := nil;
end;
...
procedure TcxGridCardView.SetBackgroundBitmaps
  (Value: TcxGridCardViewBackgroundBitmaps);
begin
...
procedure TcxGridCardView.SetDateTimeHandling
  (Value: TcxGridCardViewDateTimeHandling);
begin
...
procedure TcxGridCardView.SetLayoutDirection
  (Value: TcxGridCardViewLayoutDirection);
begin
...
procedure TcxGridCardView.SetOnRowCollapsing
  (Value: TcxGridCardRowChangingEvent);
begin
...
procedure TcxGridCardView.SetOptionsBehavior
  (Value: TcxGridCardViewOptionsBehavior);
begin
  inherited OptionsBehavior := Value;
end;

procedure TcxGridCardView.SetOptionsCustomize
  (Value: TcxGridCardViewOptionsCustomize);
begin
...
procedure TcxGridCardView.SetOptionsSelection
  (Value: TcxGridCardViewOptionsSelection);
begin
...
procedure TcxGridCardView.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
...
procedure TcxGridCardView.SetPropertyValue(const AName: string;
  const AValue: Variant);
begin
  if AName = 'CardWidth' then
...
begin
  inherited;
  OptionsView.CardWidth := (ALayoutView as TcxGridCardView)
    .OptionsView.CardWidth;
end;
...
function TcxGridCardView.GetRowLayoutControllerClass
  : TcxGridCardViewRowLayoutControllerClass;
begin
...
procedure TcxGridCardView.SetRowCoordinates(const ACoordinates
  : TcxGridCardRowCoordinatesArray);
var
  ARows: TList;
  I: Integer;
begin
  ...
  try
    ...
    for I := 0 to ARows.Count - 1 do
      RowLayoutController.SetCoordinates(TcxGridCardViewRow(ARows[I]),
        ACoordinates[I]);
  finally
    EndUpdate;
    ARows.Free;
...
procedure TcxGridCardView.ItemVisibilityChanged(AItem: TcxCustomGridTableItem;
  Value: Boolean);
begin
  if not Value and AItem.Focused and
    (TcxGridCardViewRow(AItem).CategoryRow <> nil) then
...
function TcxGridCardView.RowExpandedChanging(ARow: TcxGridCardViewRow;
...
function TcxGridCardView.GetOptionsBehaviorClass
  : TcxCustomGridOptionsBehaviorClass;
begin
  Result := TcxGridCardViewOptionsBehavior;
end;

function TcxGridCardView.GetOptionsCustomizeClass
...
function TcxGridCardView.GetOptionsSelectionClass
...
begin
  if Assigned(FOnRowCollapsed) then
    FOnRowCollapsed(Self, ARow);
end;

function TcxGridCardView.DoRowCollapsing(ARow: TcxGridCardViewRow): Boolean;
begin
  Result := True;
  if Assigned(FOnRowCollapsing) then
    FOnRowCollapsing(Self, ARow, Result);
end;

procedure TcxGridCardView.DoRowExpanded(ARow: TcxGridCardViewRow);
begin
  if Assigned(FOnRowExpanded) then
    FOnRowExpanded(Self, ARow);
end;

function TcxGridCardView.DoRowExpanding(ARow: TcxGridCardViewRow): Boolean;
begin
  Result := True;
  if Assigned(FOnRowExpanding) then
    FOnRowExpanding(Self, ARow, Result);
end;

procedure TcxGridCardView.DoRowPositionChanged(ARow: TcxGridCardViewRow);
begin
  if Assigned(FOnRowPosChanged) then
    FOnRowPosChanged(Self, ARow);
end;
