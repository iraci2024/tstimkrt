...
uses
  ...
  Controls, Forms, Dialogs, dxRichEdit.Dialogs.CustomDialog, cxGraphics,
  cxControls, cxLookAndFeels, cxCheckBox,
...
type
  ...
  protected
    ...
    class procedure UpdateCheckEdit(ACheckEdit: TcxCheckBox;
      const ACheck: TdxNullableBoolean); static;
    class function CheckStateToNullableBool(ACheckState: TcxCheckBoxState)
      : TdxNullableValue<Boolean>; static;
  public
  end;

var
  dxRichEditCustomTableOptionsDialogForm
    : TdxRichEditCustomTableOptionsDialogForm;
...
begin
  ...
  lciTopMargin.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditCustomTableOptionsDialogTopMargin);
  lciLeftMargin.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditCustomTableOptionsDialogLeftMargin);
  lciRightMargin.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditCustomTableOptionsDialogRightMargin);
  lciBottomMargin.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditCustomTableOptionsDialogBottomMargin);
end;
...
begin
  ...
  InitializeMeasurementUnitEdit(edtTopMargin, AMeasurementType,
    ...
    ModelUnitsToUIUnit(TdxTableOptionsFormHelper.MinTopMarginByDefault),
    ModelUnitsToUIUnit(TdxTableOptionsFormHelper.MaxTopMarginByDefault)));
  InitializeMeasurementUnitEdit(edtRightMargin, AMeasurementType,
    TdxMeasurementUnitEditHelper.Create(UnitTypeDescription, 0.1, 2,
    ModelUnitsToUIUnit(TdxTableOptionsFormHelper.MinRightMarginByDefault),
    ModelUnitsToUIUnit(TdxTableOptionsFormHelper.MaxRightMarginByDefault)));
  InitializeMeasurementUnitEdit(edtBottomMargin, AMeasurementType,
    TdxMeasurementUnitEditHelper.Create(UnitTypeDescription, 0.1, 2,
    ModelUnitsToUIUnit(TdxTableOptionsFormHelper.MinBottomMarginByDefault),
    ModelUnitsToUIUnit(TdxTableOptionsFormHelper.MaxBottomMarginByDefault)));
  InitializeMeasurementUnitEdit(edtLeftMargin, AMeasurementType,
    TdxMeasurementUnitEditHelper.Create(UnitTypeDescription, 0.1, 2,
    ModelUnitsToUIUnit(TdxTableOptionsFormHelper.MinLeftMarginByDefault),
    ModelUnitsToUIUnit(TdxTableOptionsFormHelper.MaxLeftMarginByDefault)));
end;

procedure TdxRichEditCustomTableOptionsDialogForm.SetMarginControlsEnabled
  (AValue: Boolean);
begin
...
class procedure TdxRichEditCustomTableOptionsDialogForm.UpdateCheckEdit
  (ACheckEdit: TcxCheckBox; const ACheck: TdxNullableBoolean);
begin
