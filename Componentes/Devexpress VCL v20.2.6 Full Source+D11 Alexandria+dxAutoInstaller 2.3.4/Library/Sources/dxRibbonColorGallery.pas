...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Windows, dxBar, Classes, cxClasses, dxCoreClasses, dxCore, Graphics,
  cxGraphics, dxRibbonGallery, dxActions,
...
type
  TdxRibbonColorGalleryColorMap = array [0 .. dxRibbonColorGalleryColorMapSize -
    1] of TColor;
  TdxRibbonColorGalleryAccentColorScheme = array
    [0 .. dxRibbonColorGalleryAccentColorSchemeSize - 1]
    of TdxRibbonColorGalleryColorMap;

  TdxRibbonColorGalleryTheme = (rcptDefault, rcptTheme1, rcptTheme2, rcptTheme3,
    rcptTheme4, rcptTheme5);
  ...
  strict private
    ...
    procedure SelectColorHandler(Sender: TdxRibbonGalleryItem;
  ...
  protected
    procedure AddColorItem(AGalleryGroup: TdxRibbonGalleryGroup;
      AColor: TColor);
    procedure AddColorRow(AGalleryGroup: TdxRibbonGalleryGroup;
      AColorMap: TdxRibbonColorGalleryColorMap);
    procedure AddCustomColor(AColor: TdxAlphaColor);
    procedure AssignColorBitmap(ATarget: TdxSmartGlyph; AColor: TColor);
    procedure BuildAccentColorScheme(ASource: TdxRibbonColorGalleryColorMap;
      var AResult: TdxRibbonColorGalleryAccentColorScheme); virtual;
    function CreateColorBitmap(AColor: TColor; AGlyphSize: Integer)
      : TcxAlphaBitmap;
    ...
    property StandardColorsGroup: TdxRibbonGalleryGroup
      read FStandardColorsGroup;
  ...
  published
    property AutoMenuItemColor: TColor read FAutoMenuItemColor
      write SetAutoMenuItemColor default clDefault;
    property Color: TColor read FColor write SetColor default clDefault;
    property CustomColors: TStrings read FCustomColors write SetCustomColors;
    property ShowItemBorders: Boolean read FShowItemBorders
      write SetShowItemBorders default True;
    property Theme: TdxRibbonColorGalleryTheme read FTheme write FTheme
      default rcptDefault;
  ...
  TdxRibbonColorGalleryItemActionLink = class(TdxBarItemActionLink, IUnknown,
  ...
  protected
    function GetSubMenuControlClass
      : TdxBarContainerItemSubMenuControlClass; override;
  end;

  { TdxRibbonColorGalleryItemSubMenuControl }

  TdxRibbonColorGalleryItemSubMenuControl = class
...
type
  TAccent = (aLight80, aLight60, aLight50, aLight40, aLight35, aLight25,
    aLight15, aLight5, aDark10, aDark25, aDark50, aDark75, aDark90);

const
  StandardColorMap: TdxRibbonColorGalleryColorMap = ($0000C0, $0000FF, $00C0FF,
    $00FFFF, $50D092, $50B000, $F0B000, $C07000, $602000, $A03070);

  ThemeColorMaps: array [TdxRibbonColorGalleryTheme]
    of TdxRibbonColorGalleryColorMap = (($FFFFFF, 0, $D2B48C, $00008B, $0000FF,
    $FF0000, $556B2F, $800080, $FFFF00, $FFA500), ($FFFFFF, 0, $7D491F, $E1ECEE,
    $BD814F, $4D50C0, $59BB9B, $A26480, $C6AC4B, $4696F7),
    ($FFFFFF, 0, $6D6769, $D1C2C9, $66B9CE, $84B09C, $C9B16B, $CF8565, $C96B7E,
    $BB79A3), ($FFFFFF, 0, $323232, $D1DEE3, $097FF0, $36299F, $7C581B, $42854E,
    $784860, $5998C1), ($FFFFFF, 0, $866B64, $D7D1C5, $4963D1, $00B4CC, $AEAD8C,
    $707B8C, $8CB08F, $4990D1), ($FFFFFF, 0, $464646, $FAF5DE, $BFA22D, $281FDA,
    $1B64EB, $9D6339, $784B47, $4A3C7D));
...
procedure TdxRibbonColorGalleryItem.AddColorItem(AGalleryGroup
  : TdxRibbonGalleryGroup; AColor: TColor);
var
  AColorName: string;
  AItem: TdxRibbonGalleryGroupItem;
begin
...
procedure TdxRibbonColorGalleryItem.AddColorRow(AGalleryGroup
  : TdxRibbonGalleryGroup; AColorMap: TdxRibbonColorGalleryColorMap);
var
  I: Integer;
begin
...
begin
  ...
  for I := Low(TdxColorDialogCustomColors)
    to High(TdxColorDialogCustomColors) do
  begin
...
procedure TdxRibbonColorGalleryItem.AssignColorBitmap(ATarget: TdxSmartGlyph;
  AColor: TColor);
var
...
procedure TdxRibbonColorGalleryItem.BuildAccentColorScheme
  (ASource: TdxRibbonColorGalleryColorMap;
  var AResult: TdxRibbonColorGalleryAccentColorScheme);

  function GetBrightness(ARGBColor: DWORD): Integer;
  begin
    Result := (GetBValue(ARGBColor) + GetGValue(ARGBColor) +
      GetRValue(ARGBColor)) div 3;
  end;

  procedure CreateAccent(AAccents: array of TAccent; AMapIndex: Integer);
  const
    AccentMap: array [TAccent] of Integer = (80, 60, 50, 40, 35, 25, 15, 5, -10,
      -25, -50, -75, -90);
  var
    I: Integer;
  begin
    for I := Low(AAccents) to High(AAccents) do
      AResult[I][AMapIndex] := dxGetColorTint(ASource[AMapIndex],
        AccentMap[AAccents[I]]);
  end;
...
function TdxRibbonColorGalleryItem.CreateColorBitmap(AColor: TColor;
  AGlyphSize: Integer): TcxAlphaBitmap;
begin
...
begin
  FAutoColorButton := BarDesignController.AddInternalItem(TdxBarButton,
    BarManager, BarManager, FInternalItems) as TdxBarButton;
  FAutoColorButton.Caption := cxGetResourceString
  ...
  FColorGallery := BarDesignController.AddInternalItem(TdxRibbonGalleryItem,
    BarManager, BarManager, FInternalItems) as TdxRibbonGalleryItem;
  ...
  FThemeColorsGroup.Header.Caption :=
    cxGetResourceString(@sdxRibbonColorGalleryGroupThemeColors);
  ...
  FStandardColorsGroup.Header.Caption :=
    cxGetResourceString(@sdxRibbonColorGalleryGroupStandardColors);
  FCustomColorsGroup := FColorGallery.GalleryGroups.Add;
  FCustomColorsGroup.Header.Caption :=
    cxGetResourceString(@sdxRibbonColorGalleryGroupCustomColors);

  FMoreColorsButton := BarDesignController.AddInternalItem(TdxBarButton,
    BarManager, BarManager, FInternalItems) as TdxBarButton;
  FMoreColorsButton.OnClick := MoreColorsClickHandler;
  FMoreColorsButton.Caption := cxGetResourceString
    (@sdxRibbonColorGalleryMoreColors);
  FMoreColorsButton.FreeNotification(Self);
end;

procedure TdxRibbonColorGalleryItem.Notification(AComponent: TComponent;
...
function TdxRibbonColorGalleryItem.GetActionLinkClass
...
procedure TdxRibbonColorGalleryItem.SelectColorHandler
...
procedure TdxRibbonColorGalleryItemActionLink.UpdateValue
...
procedure TdxRibbonColorGalleryItemActionLink.ActionValueChanged
  (const AValue: Variant);
begin
  if FUpdateValueLockCount = 0 then
  begin
...
function TdxRibbonColorGalleryItemActionLink.QueryInterface(const IID: TGUID;
  out Obj): HResult;
begin
...
function TdxRibbonColorGalleryItemControl.GetSubMenuControlClass
  : TdxBarContainerItemSubMenuControlClass;
begin
...
function TdxRibbonColorGalleryItemSubMenuControl.GetBehaviorOptions
...
dxBarRegisterItem(TdxRibbonColorGalleryItem,
  TdxRibbonColorGalleryItemControl, True);
