...
constructor TdxDocSectionPropertiesActions.Create(AOutput: TdxMemoryStream;
  ASection: TdxSection);
begin
...
begin
  ...
  try
    AActions := TdxDocGeneralSettingsActions.Create(AGeneralSettingsStream,
      FSection.GeneralSettings);
    try
...
begin
  ...
  try
    AActions := TdxDocPageNumberingActions.Create(APageNumberingStream,
      FSection.PageNumbering);
    try
...
begin
  ...
  try
    AActions := TdxDocLineNumberingActions.Create(ALineNumberingStream,
      FSection.LineNumbering);
    try
...
begin
  ...
  try
    AActions := TdxDocFootNoteActions.Create(AFootNoteStream,
      FSection.FootNote, True);
    try
      AActions.NumberingFormatAction;
      AActions.NumberingRestartTypeAction;
...
begin
  ...
  try
    AActions := TdxDocFootNoteActions.Create(AEndNoteStream,
      FSection.EndNote, False);
    try
      AActions.NumberingFormatAction;
      AActions.NumberingRestartTypeAction;
      AActions.PositionAction;
