...
uses
  ...
  cxControls, cxContainer, cxGraphics, cxListBox, dxPScxEditorProducers,
  cxImage, cxEdit, cxMemo, dxPSCore,
...
begin
  ...
  Proportional := cxImageProperties_GetProportional
    (cxEdit_GetProperties(cxCustomImage));
end;
...
procedure TdxCustomBarCodeReportLink.ConstructReport(AReportCells
  : TdxReportCells);
var
  Cell: TdxReportCell;
...
begin
  ...
  begin
    ...
    Data.BoundsRect := Rect(0, 0, dxCustomBarCode.Width,
      dxCustomBarCode.Height);
...
function TdxCustomBarCodeReportLink.GetCriticalSize(AReportCells
  : TdxReportCells): Integer;
begin
  Result := Max(inherited GetCriticalSize(AReportCells),
...
procedure TdxCustomBarCodeReportLink.InitializeBarCodeItem
  (AnItem: TdxReportCellBarCode);
var
...
dxPSRegisterReportLink(TcxListBoxReportLink, TcxListBox,
  TdxLBxReportLinkDesignWindow);
dxPSRegisterReportLink(TcxImageReportLink, TcxImage, nil);
dxPSRegisterReportLink(TcxMemoReportLink, TcxMemo,
...
dxPSUnregisterReportLink(TcxMemoReportLink, TcxMemo,
  TdxfmTextReportLinkDesignWindow);
dxPSUnregisterReportLink(TcxImageReportLink, TcxImage, nil);
dxPSUnregisterReportLink(TcxListBoxReportLink, TcxListBox,
  TdxLBxReportLinkDesignWindow);
