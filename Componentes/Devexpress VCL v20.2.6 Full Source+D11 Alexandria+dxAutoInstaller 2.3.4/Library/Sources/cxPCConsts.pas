...
resourcestring
  ...
  scxPCTabVisibleIndexOutsOfBounds =
...
procedure AddExpressPageControlResourceStringNames
...
begin
  ...
  InternalAdd('scxPCTabVisibleIndexOutsOfBounds',
    @scxPCTabVisibleIndexOutsOfBounds);
  ...
  InternalAdd('scxPCDefaultHintGoDialogButton',
    @scxPCDefaultHintGoDialogButton);
  InternalAdd('scxPCDefaultHintTopLeftButton', @scxPCDefaultHintTopLeftButton);
  InternalAdd('scxPCDefaultHintBottomRightButton',
    @scxPCDefaultHintBottomRightButton);
  InternalAdd('scxPCDefaultHintTabCloseButton',
    @scxPCDefaultHintTabCloseButton);
  InternalAdd('scxPCDefaultHintNewButton', @scxPCDefaultHintNewButton);
end;

initialization

dxResourceStringsRepository.RegisterProduct('ExpressPageControl',
  @AddExpressPageControlResourceStringNames);
