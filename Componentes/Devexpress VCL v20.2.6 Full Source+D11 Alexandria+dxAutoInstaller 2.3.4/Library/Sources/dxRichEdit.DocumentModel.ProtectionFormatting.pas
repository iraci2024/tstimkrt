...
type
  TdxDocumentProtectionType = (None, ReadOnly);
  ...
  public
    ...
    property EnforceProtection: Boolean read FEnforceProtection
      write FEnforceProtection;
    property ProtectionType: TdxDocumentProtectionType read FProtectionType
      write FProtectionType;
    property HashAlgorithmType: TdxHashAlgorithmType read FHashAlgorithmType
      write FHashAlgorithmType;
    property HashIterationCount: Integer read FHashIterationCount
      write FHashIterationCount;
    property PasswordHash: TArray<Byte> read FPasswordHash write FPasswordHash;
    property PasswordPrefix: TArray<Byte> read FPasswordPrefix
      write FPasswordPrefix;
    property Word2003PasswordHash: TArray<Byte> read FWord2003PasswordHash
      write FWord2003PasswordHash;
    property OpenOfficePasswordHash: TArray<Byte> read FOpenOfficePasswordHash
      write FOpenOfficePasswordHash;
  end;

  { TdxDocumentProtectionInfoCache }

  TdxDocumentProtectionInfoCache = class
    (TdxUniqueItemsCache<TdxDocumentProtectionInfo>)
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxDocumentProtectionInfo; override;
  end;
  ...
  TdxRangePermissionProperties = class
    (TdxRichEditIndexBasedObject<TdxRangePermissionInfo>)
  strict private
  ...
  strict protected
    function SetUserNameCore(const AInfo: TdxRangePermissionInfo;
      const AValue: string): TdxDocumentModelChangeActions; virtual;
    function SetGroupCore(const AInfo: TdxRangePermissionInfo;
      const AValue: string): TdxDocumentModelChangeActions; virtual;
    ...
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxRangePermissionInfo>; override;
  public
  ...
  TdxRangePermissionInfoCache = class
    (TdxUniqueItemsCache<TdxRangePermissionInfo>)
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxRangePermissionInfo; override;
  end;

  { TdxDocumentProtectionProperties }

  TdxDocumentProtectionProperties = class
    (TdxRichEditIndexBasedObject<TdxDocumentProtectionInfo>)
  strict private
  ...
  strict protected
    function SetEnforceProtectionCore(const AInfo: TdxDocumentProtectionInfo;
      const AValue: Boolean): TdxDocumentModelChangeActions; virtual;
    function SetProtectionTypeCore(const AInfo: TdxDocumentProtectionInfo;
      const AValue: TdxDocumentProtectionType)
      : TdxDocumentModelChangeActions; virtual;
    function SetHashAlgorithmTypeCore(const AInfo: TdxDocumentProtectionInfo;
      const AValue: TdxHashAlgorithmType)
      : TdxDocumentModelChangeActions; virtual;
    function SetHashIterationCountCore(const AInfo: TdxDocumentProtectionInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetPasswordHashCore(const AInfo: TdxDocumentProtectionInfo;
      const AValue: TArray<Byte>): TdxDocumentModelChangeActions; virtual;
    function SetPasswordPrefixCore(const AInfo: TdxDocumentProtectionInfo;
      const AValue: TArray<Byte>): TdxDocumentModelChangeActions; virtual;
    function SetWord2003PasswordHashCore(const AInfo: TdxDocumentProtectionInfo;
      const AValue: TArray<Byte>): TdxDocumentModelChangeActions; virtual;
    function SetOpenOfficePasswordHashCore(const AInfo
      : TdxDocumentProtectionInfo; const AValue: TArray<Byte>)
      : TdxDocumentModelChangeActions; virtual;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxDocumentProtectionInfo>; override;
    function GetBatchUpdateChangeActions
      : TdxDocumentModelChangeActions; override;
  public
    ...
    property ProtectionType: TdxDocumentProtectionType read GetProtectionType
      write SetProtectionType;
    property HashAlgorithmType: TdxHashAlgorithmType read GetHashAlgorithmType
      write SetHashAlgorithmType;
    property HashIterationCount: Integer read GetHashIterationCount
      write SetHashIterationCount;
    property PasswordHash: TArray<Byte> read GetPasswordHash
      write SetPasswordHash;
    property PasswordPrefix: TArray<Byte> read GetPasswordPrefix
      write SetPasswordPrefix;
    property Word2003PasswordHash: TArray<Byte> read GetWord2003PasswordHash
      write SetWord2003PasswordHash;
    property OpenOfficePasswordHash: TArray<Byte> read GetOpenOfficePasswordHash
      write SetOpenOfficePasswordHash;
  end;

function dxGetHashAlgorithm(AHashAlgorithmType: TdxHashAlgorithmType)
  : TdxHashAlgorithmClass;
...
begin
  ...
  Result := (EnforceProtection = AInfo.EnforceProtection) and
...
function TdxDocumentProtectionInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxDocumentProtectionInfo;
begin
...
function TdxRangePermissionProperties.SetUserNameCore
  (const AInfo: TdxRangePermissionInfo; const AValue: string)
...
function TdxRangePermissionProperties.SetGroupCore
  (const AInfo: TdxRangePermissionInfo; const AValue: string)
  : TdxDocumentModelChangeActions;
begin
  AInfo.Group := AValue;
...
function TdxRangePermissionProperties.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
...
function TdxRangePermissionProperties.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxRangePermissionInfo>;
begin
...
function TdxRangePermissionInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxRangePermissionInfo;
begin
...
constructor TdxDocumentProtectionProperties.Create(ADocumentModel
...
procedure TdxDocumentProtectionProperties.SetEnforceProtection
...
function TdxDocumentProtectionProperties.SetEnforceProtectionCore
  (const AInfo: TdxDocumentProtectionInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
...
function TdxDocumentProtectionProperties.GetProtectionType
  : TdxDocumentProtectionType;
begin
  Result := Info.ProtectionType;
end;

procedure TdxDocumentProtectionProperties.SetProtectionType
  (const AValue: TdxDocumentProtectionType);
begin
...
function TdxDocumentProtectionProperties.SetProtectionTypeCore
  (const AInfo: TdxDocumentProtectionInfo;
...
function TdxDocumentProtectionProperties.GetHashAlgorithmType
  : TdxHashAlgorithmType;
begin
  Result := Info.HashAlgorithmType;
end;

procedure TdxDocumentProtectionProperties.SetHashAlgorithmType
  (const AValue: TdxHashAlgorithmType);
begin
...
function TdxDocumentProtectionProperties.SetHashAlgorithmTypeCore
  (const AInfo: TdxDocumentProtectionInfo; const AValue: TdxHashAlgorithmType)
  : TdxDocumentModelChangeActions;
begin
...
procedure TdxDocumentProtectionProperties.SetHashIterationCount
...
function TdxDocumentProtectionProperties.SetHashIterationCountCore
  (const AInfo: TdxDocumentProtectionInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
...
procedure TdxDocumentProtectionProperties.SetPasswordHash
...
function TdxDocumentProtectionProperties.SetPasswordHashCore
  (const AInfo: TdxDocumentProtectionInfo; const AValue: TArray<Byte>)
  : TdxDocumentModelChangeActions;
begin
...
procedure TdxDocumentProtectionProperties.SetPasswordPrefix
  (const AValue: TArray<Byte>);
begin
...
function TdxDocumentProtectionProperties.SetPasswordPrefixCore
  (const AInfo: TdxDocumentProtectionInfo; const AValue: TArray<Byte>)
  : TdxDocumentModelChangeActions;
begin
...
procedure TdxDocumentProtectionProperties.SetWord2003PasswordHash
  (const AValue: TArray<Byte>);
begin
...
function TdxDocumentProtectionProperties.SetWord2003PasswordHashCore
  (const AInfo: TdxDocumentProtectionInfo; const AValue: TArray<Byte>)
  : TdxDocumentModelChangeActions;
begin
...
function TdxDocumentProtectionProperties.GetOpenOfficePasswordHash
  : TArray<Byte>;
begin
  Result := Info.OpenOfficePasswordHash;
end;

procedure TdxDocumentProtectionProperties.SetOpenOfficePasswordHash
  (const AValue: TArray<Byte>);
begin
...
function TdxDocumentProtectionProperties.SetOpenOfficePasswordHashCore
  (const AInfo: TdxDocumentProtectionInfo; const AValue: TArray<Byte>)
  : TdxDocumentModelChangeActions;
begin
...
function TdxDocumentProtectionProperties.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxDocumentProtectionInfo>;
begin
  Result := TdxDocumentCache(ADocumentModel.Cache).DocumentProtectionInfoCache;
end;

function TdxDocumentProtectionProperties.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := [TdxDocumentModelChangeAction.RaiseContentChanged,
    TdxDocumentModelChangeAction.RaiseModifiedChanged,
