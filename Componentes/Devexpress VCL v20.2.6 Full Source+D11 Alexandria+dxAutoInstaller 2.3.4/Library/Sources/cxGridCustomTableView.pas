...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Variants, Windows, Messages, Classes, Graphics, Controls, Forms, StdCtrls,
  Dialogs, MultiMon, SysUtils,
  ...
  dxCoreClasses, dxGdiPlusClasses, dxScrollAnimation, cxMemo, cxDropDownEdit,
  cxMRUEdit,
  cxTextEdit, dxIncrementalFiltering, dxUIElementPopupWindow, cxFindPanel,
  cxDataControllerSpreadSheetExpressionProvider,
  dxSpreadSheetTypes, dxSpreadSheetStyles, dxSpreadSheetConditionalFormatting,
  cxDataControllerConditionalFormatting,
  dxFilterPopupWindow, dxFilterValueContainer, cxDateUtils, dxDateRanges,
  dxFilterBox, dxScrollbarAnnotations, dxCoreGraphics;
...
const
  ...
  cxGridFindPanelDefaultMRUItemsListDropDownCount =
    cxFindPanelDefaultMRUItemsListDropDownCount;
...
type
  ...
  public
    constructor Create(AGridView: TcxCustomGridView;
      ARecord: TcxCustomGridRecord; ARecordIndex: Integer;
      AItem: TcxCustomGridTableItem = nil); reintroduce; virtual;
    procedure Execute; override;
  ...
  public
    constructor Create(AGridView: TcxCustomGridView;
      APrevFocusedRecordIndex, AFocusedRecordIndex, APrevFocusedDataRecordIndex,
    ...
    property NewItemRecordFocusingChanged: Boolean
      read FNewItemRecordFocusingChanged;
  ...
  public
    function IsDisplayFormatDefined(AIsCurrencyValueAccepted: Boolean)
      : Boolean; override;
  end;
  ...
  IcxGridDataController = interface
    ...
    function GetItemDefaultValuesProviderClass
  ...
  TcxGridDataController = class(TcxDataController, IcxCustomGridDataController,
  ...
  protected
    ...
    function CompareByField(ARecordIndex1, ARecordIndex2: Integer;
      AField: TcxCustomDataField; AMode: TcxDataControllerComparisonMode)
      : Integer; override;
    function CreateExpressionProvider: TcxDataCustomExpressionProvider;
      override;
    ...
    function GetFilterDisplayText(ARecordIndex, AItemIndex: Integer)
      : string; override;
    ...
    function GetSortingBySummaryEngineClass
      : TcxSortingBySummaryEngineClass; override;
    function GetSummaryGroupItemLinkClass
      : TcxDataSummaryGroupItemLinkClass; override;
  ...
  public
    ...
    function GetDetailDataControllerByLinkObject(ALinkObject: TObject)
      : TcxCustomDataController; override;
    function GetDisplayText(ARecordIndex, AItemIndex: Integer): string;
      override;
    function GetFilterDataValue(ARecordIndex: Integer;
      AField: TcxCustomDataField): Variant; override;
    function GetFilterItemFieldCaption(AItem: TObject): string; override;
    function GetItem(Index: Integer): TObject; override;
    function GetItemSortByDisplayText(AItemIndex: Integer;
      ASortByDisplayText: Boolean): Boolean; override;
    function GetItemValueSource(AItemIndex: Integer)
  ...
  protected
    ...
    procedure AddDateTimeAbsoluteFilters(AItem: TcxCustomGridTableItem);
      overload; virtual;
    procedure AddDateTimeRelativeFilters
      (AItem: TcxCustomGridTableItem); virtual;
    function IsSpecialOperatorKindSupported(AKind: TcxFilterOperatorKind)
      : Boolean; virtual;
    procedure Load(AItem: TcxCustomGridTableItem;
      AInitSortByDisplayText: Boolean; AUseFilteredValues: Boolean;
  ...
  public
    ...
    function GetIndexByCriteriaItem(ACriteriaItem: TcxFilterCriteriaItem)
      : Integer; override;
    procedure Load(AItem: TcxCustomGridTableItem;
      AInitSortByDisplayText: Boolean = True;
  ...
  protected
    function GetDefaultValuesProviderClass
      : TcxCustomEditDefaultValuesProviderClass;
    function GetDefaultValueTypeClass: TcxValueTypeClass; virtual;
    function GetFilterFieldName: string; virtual;
    function GetFilterMRUValueItemsClass
      : TcxGridFilterMRUValueItemsClass; virtual;
    procedure GetFilterStrings(AStrings: TStrings;
      AValueList: TcxGridFilterValueList; AValuesOnly: Boolean;
      AUniqueOnly: Boolean); overload;
    procedure GetFilterValues(AValueList: TcxGridFilterValueList;
      AValuesOnly: Boolean; AInitSortByDisplayText: Boolean;
      ACanUseFilteredValues: Boolean; AUniqueOnly: Boolean); overload;
    procedure Init; virtual;
    function IsValueTypeStored: Boolean; virtual;
    procedure SetFilterActiveValue(AOperatorKind: TcxFilterOperatorKind;
      const AValue: Variant; const ADisplayText: string);
    procedure SetFilterActiveValueIndex(AValueList: TcxGridFilterValueList;
      AIndex: Integer; AFilterList: TcxFilterCriteriaItemList;
      AReplaceExistent, AAddToMRUItemsList: Boolean);
    procedure SetFilterActiveValues(AValueInfos: TdxFastObjectList;
      ABoolOperator: TcxFilterBoolOperatorKind);

    property DefaultValuesProvider: TcxCustomEditDefaultValuesProvider
      read FDefaultValuesProvider;
    property StoredExpression: string read GetStoredExpression
      write SetStoredExpression;
  public
    ...
    function DefaultWidth(ATakeHeaderIntoAccount: Boolean = True)
      : Integer; virtual;
    function GetAllowedSummaryKinds: TcxSummaryKinds;
    function GetDefaultValuesProvider(AProperties
      : TcxCustomEditProperties = nil): IcxEditDefaultValuesProvider;
    function IsDisplayFormatDefined(AIsCurrencyValueAccepted: Boolean): Boolean;

    function AddToFilter(AParent: TcxFilterCriteriaItemList;
      AOperatorKind: TcxFilterOperatorKind; const AValue: Variant;
      const ADisplayText: string = ''; AReplaceExistent: Boolean = True)
      : TcxFilterCriteriaItem;
    procedure GetFilterDisplayText(const AValue: Variant;
      var ADisplayText: string);
    procedure GetFilterStrings(AStrings: TStrings;
      AValueList: TcxGridFilterValueList); overload;
    procedure GetFilterValues(AValueList: TcxGridFilterValueList;
      AValuesOnly: Boolean = True; AInitSortByDisplayText: Boolean = False;
      ACanUseFilteredValues: Boolean = False); overload;
  ...
  protected
    ...
    function GetViewInfoCacheItemClass: TcxCustomGridViewInfoCacheItemClass;
      virtual; abstract;
    function GetViewInfoClass: TcxCustomGridRecordViewInfoClass;
      virtual; abstract;

    property IsParent: Boolean read GetIsParent;
    property IsParentRecordLast[AIndex: Integer]: Boolean
      read GetIsParentRecordLast;
  ...
  public
    ...
    function GetLastFocusableChild(ARecursive: Boolean)
      : TcxCustomGridRecord; virtual;
  ...
  protected
    ...
    function GetRecordByKind(AKind, AIndex: Integer)
      : TcxCustomGridRecord; virtual;
    function GetRecordClass(const ARecordInfo: TcxRowInfo)
      : TcxCustomGridRecordClass; virtual; abstract;
    ...
    property Controller: TcxCustomGridTableController read GetController;
    property InternalRecords[Index: Integer]: TcxCustomGridRecord
      read GetInternalRecord;
  ...
  public
    ...
    function AddItemToFilter(AParent: TcxFilterCriteriaItemList;
      AItem: TcxCustomGridTableItem; AOperatorKind: TcxFilterOperatorKind;
      const AValue: Variant; ADisplayText: string = '';
      AReplaceExistent: Boolean = True): TcxFilterCriteriaItem;
    function CreateFilterValueList: TcxGridFilterValueList;
    function GetDisplayText(ARecordIndex, AItemIndex: Integer;
      out AText: string; AUseCustomValue: Boolean = False;
      ACustomValueOperation: TcxGridDataOperation = doGrouping)
      : Boolean; virtual;
    function GetDisplayTextFromValue(AItem: TcxCustomGridTableItem;
      AProperties: TcxCustomEditProperties; const AValue: Variant;
      AUseCustomValue: Boolean = False;
      ACustomValueOperation: TcxGridDataOperation = doGrouping)
      : string; overload;
    function GetDisplayTextFromValue(ARecordIndex, AItemIndex: Integer;
      const AValue: Variant; AUseCustomValue: Boolean = False;
      ACustomValueOperation: TcxGridDataOperation = doGrouping)
      : string; overload;

    // custom data handling
    function CustomCompareDataValues(AField: TcxCustomDataField;
      const AValue1, AValue2: Variant; AMode: TcxDataControllerComparisonMode)
      : Integer; virtual;
    function GetCustomDataDisplayText(ARecordIndex, AItemIndex: Integer;
      AOperation: TcxGridDataOperation): string; overload; virtual;
    function GetCustomDataDisplayText(AItemIndex: Integer;
      const AValue: Variant): string; overload; virtual;
    function GetCustomDataValue(AField: TcxCustomDataField;
      const AValue: Variant; AOperation: TcxGridDataOperation)
      : Variant; overload;
    function GetCustomDataValue(AItem: TcxCustomGridTableItem;
      const AValue: Variant; AOperation: TcxGridDataOperation): Variant;
      overload; virtual;
    function HasCustomDataHandling(AField: TcxCustomDataField;
      AOperation: TcxGridDataOperation): Boolean; overload;
    function HasCustomDataHandling(AItem: TcxCustomGridTableItem;
      AOperation: TcxGridDataOperation): Boolean; overload; virtual;
    function NeedsCustomDataComparison(AField: TcxCustomDataField;
      AMode: TcxDataControllerComparisonMode): Boolean; virtual;
  ...
  protected
    ...
    property Controller: TcxCustomGridTableController read GetController;
    property CustomizationForm: TcxCustomGridTableCustomizationForm
      read GetCustomizationForm;
  end;
  ...
  protected
    procedure CalculateDestParams(AHitTest: TcxCustomGridHitTest;
      out AContainerKind: TcxGridItemContainerKind;
      out AZone: TcxGridItemContainerZone); virtual;
    procedure CheckDestItemContainerKind(var AValue
      : TcxGridItemContainerKind); virtual;
    ...
    property DestItemContainerKind: TcxGridItemContainerKind
      read FDestItemContainerKind write SetDestItemContainerKind;
    property DestZone: TcxGridItemContainerZone read FDestZone
      write SetDestZone;
    property SourceItemContainerKind: TcxGridItemContainerKind
  ...
  TdxCustomGridQuickCustomizationControl = class
  ...
  protected
    ...
    procedure HandleItemClicked(AItem: TObject; AChecked: Boolean);
      virtual; abstract;
    ...
    property CheckListBox: TdxQuickCustomizationCustomCheckListBox
      read GetCheckListBox;
  public
    constructor Create(AGridView: TcxCustomGridView); override;
    destructor Destroy; override;
    procedure CloseUp; override;
    procedure CorrectBoundsWithDesktopWorkArea(var APosition: TPoint;
      var ASize: TSize); override;
    procedure Popup; override;
    //
    property CustomizationControl: TdxCustomGridQuickCustomizationControl
      read FCustomizationControl;
    property GridView: TcxCustomGridTableView read GetGridView;
  end;

  TcxCustomGridItemsCustomizationPopupClass = class of
  ...
  protected
    ...
    function CreateEditAutoHeightProperties
      : TcxAutoHeightInplaceEditProperties; virtual;
    ...
    function PrepareEdit(AItem: TcxCustomGridTableItem; AOnMouseEvent: Boolean)
      : Boolean; virtual;
    ...
    property EditingCellViewInfo: TcxGridTableDataCellViewInfo
      read GetEditingCellViewInfo;
    property EditingProperties: TcxCustomEditProperties
      read GetEditingProperties;
  ...
  public
    ...
    procedure ShowEdit(AItem: TcxCustomGridTableItem; Key: Char);
      reintroduce; overload;
    procedure ShowEdit(AItem: TcxCustomGridTableItem; Shift: TShiftState;
      X, Y: Integer); reintroduce; overload;
    ...
    property EditingItem: TcxCustomGridTableItem read FEditingItem
      write SetEditingItem;
    property GridView: TcxCustomGridTableView read GetGridView;
  end;
  ...
  TcxCustomGridTableRecordScrollAnimationHelper = class
    (TdxRecordPixelScrollAnimationHelper)
  strict private
  ...
  protected
    ...
    function CalculateAnimatedPosition(var APosition: Integer)
      : TdxRecordPixelScrollData; override;
    function CalculateScrollDelta(AValue: TdxRecordPixelScrollData)
      : Integer; override;
  ...
  protected
    ...
    function CanChangeFocusedRecordIndex(APrevRecordIndex, ANewRecordIndex
    ...
    procedure DoSetTopRecordIndexWithOffset(ATopRecordIndex, ATopRecordOffset
      : Integer);
    procedure EndGestureScroll; override;
    function FindNextCustomItem(AFocusedItemIndex, AItemCount: Integer;
      AGoForward, AGoOnCycle: Boolean;
      ACanFocus: TcxCustomGridTableCanItemFocus; AData: TObject;
      var AItemIndex: Integer; out ACycleChanged: Boolean): Boolean;
    procedure FocusedItemChanged(APrevFocusedItem
      : TcxCustomGridTableItem); virtual;
    ...
    procedure GetBestFitRecordRange(out AFirstIndex,
      ALastIndex: Integer); virtual;
    function GetCancelEditingOnExit: Boolean; virtual;
    function GetDlgCode: Integer; override;
    function GetFilterMRUItemsPopupClass
      : TcxGridFilterMRUItemsPopupClass; virtual;
    ...
    function GetItemsCustomizationPopupClass
      : TcxCustomGridItemsCustomizationPopupClass; virtual;
    function GetLastVisibleRecordIndex: Integer; virtual;
    function GetMaxTopRecordIndexValue: Integer; virtual;
    procedure GetPixelScrollTopRecordIndexAndOffsetByBottomRecord
      (ABottomRecordIndex: Integer; out ATopRecordIndex,
      ATopRecordPixelScrollOffset: Integer); virtual;
    procedure GetPixelScrollTopRecordIndexAndOffsetMaxValues(out ARecordIndex,
      APixelScrollOffset: Integer); virtual;
    ...
    function GetTopRecordIndexByBottomRecord(ABottomRecordIndex: Integer)
      : Integer; virtual;
    function GetVisibleRecordCount(AFirstRecordIndex: Integer;
      APixelScrollRecordOffset: Integer; ACalculateDown: Boolean = True)
      : Integer; virtual;
    ...
    procedure SetFocusOnMouseClick(AButton: TMouseButton;
      X, Y: Integer); override;
    procedure SetScrollBarPos(Value: Integer); virtual;
    procedure SetTopRecordIndexWithOffset(ATopRecordIndex, ATopRecordOffset
      : Integer; AAnimated: Boolean = False); overload;
    ...
    property GridModeBufferCountUpdateNeeded: Boolean
      read FGridModeBufferCountUpdateNeeded;
    ...
    procedure CheckPixelScrollTopRecordIndexAndOffsetValues(var ATopRecordIndex,
      APixelScrollRecordOffset: Integer);
    procedure DoOverpan(AScrollKind: TScrollBarKind; ADelta: Integer); virtual;
    function GetFirstScrollRecordIndex: Integer; virtual;
    function GetFirstIndexInScrollBand(ARecordIndexInBand: Integer)
      : Integer; virtual;
    ...
    function GetRecordCountInScrollBand(ARecordIndexInBand: Integer)
      : Integer; virtual;
    function IsRecordFullyVisibleAtBottom(ARecordIndex: Integer)
      : Boolean; virtual;
    ...
    procedure ScrollContentByGesture(AScrollKind: TScrollBarKind;
    ...
    function GetScrollDataTimeInterval(ADirection: TcxDirection)
      : Integer; virtual;
    property ScrollDirection: TcxDirection read FScrollDirection
      write SetScrollDirection;

    // selection
    function CanPostponeRecordSelection(AShift: TShiftState): Boolean; virtual;
    function CanProcessMultiSelect(AIsKeyboard: Boolean): Boolean;
      overload; virtual;
    ...
    procedure ChangeRecordSelection(ARecord: TcxCustomGridRecord;
      Value: Boolean);
    ...
    procedure DoMouseRangeSelection(AClearSelection: Boolean = True;
      AData: TObject = nil); virtual;
    ...
    procedure MultiSelectMouseDown(AHitTest: TcxCustomGridHitTest;
      AShift: TShiftState); virtual;
    procedure MultiSelectMouseUp(AHitTest: TcxCustomGridHitTest;
      AShift: TShiftState); virtual;
    ...
    function CanFocusNextItem(AFocusedItemIndex, ANextItemIndex: Integer;
      AGoForward, AGoOnCycle, AGoToNextRecordOnCycle: Boolean)
      : Boolean; virtual;
    function FocusedRecordHasCells(ACheckCellSelectionAbility: Boolean)
      : Boolean;
    ...
    function IsKeyForController(AKey: Word; AShift: TShiftState)
      : Boolean; virtual;
    ...
    function GetPullFocusingScrollingDirection(X, Y: Integer;
      out ADirection: TcxDirection): Boolean; virtual;
    ...
    property PullFocusingOriginHitTest: TcxCustomGridHitTest
      read FPullFocusingOriginHitTest;
    ...
    function IsFirstRecordForDragScroll(ARecord: TcxCustomGridRecord)
      : Boolean; virtual;
    function IsLastRecordForDragScroll(ARecord: TcxCustomGridRecord)
      : Boolean; virtual;
    ...
    // ---
    function GetDragOpenInfo(AHitTest: TcxCustomGridHitTest)
      : TcxCustomGridDragOpenInfo; virtual;
    function IsDragOpenHitTest(AHitTest: TcxCustomGridHitTest;
      out ADragOpenInfo: TcxCustomGridDragOpenInfo): Boolean;
    // ---
    property DragHighlightedRecord: TcxCustomGridRecord
      read FDragHighlightedRecord write SetDragHighlightedRecord;
    ...
    property ItemForIncSearching: TcxCustomGridTableItem
      read GetItemForIncSearching;
    ...
    property AllowAppendRecord: Boolean read FAllowAppendRecord
      write FAllowAppendRecord;
    property AllowCheckEdit: Boolean read FAllowCheckEdit write FAllowCheckEdit;
    property BlockRecordKeyboardHandling: Boolean
      read FBlockRecordKeyboardHandling write FBlockRecordKeyboardHandling;
    ...
    property FocusOnRecordFocusing: Boolean read FFocusOnRecordFocusing
      write FFocusOnRecordFocusing;
    property ForcingWidthItem: TcxCustomGridTableItem read FForcingWidthItem
      write FForcingWidthItem;
    property InternalTopRecordIndex: Integer read GetInternalTopRecordIndex
      write SetInternalTopRecordIndex;
    property IsReadyForImmediateEditing: Boolean
      read FIsReadyForImmediateEditing write FIsReadyForImmediateEditing;
    property IsRecordsScrollHorizontal: Boolean
      read GetIsRecordsScrollHorizontal;
    ...
    property MakeVisibleDetailRecordBounds: TRect
      read FMakeVisibleDetailRecordBounds write FMakeVisibleDetailRecordBounds;
    property MultiSelect: Boolean read GetMultiSelect;
    property NeedUpdateSiteOnFocusedRecordChanged: Boolean
      read FNeedUpdateSiteOnFocusedRecordChanged
      write FNeedUpdateSiteOnFocusedRecordChanged;
    property PixelScrollRecordOffset: Integer read FPixelScrollRecordOffset
      write SetPixelScrollRecordOffset;
  ...
  public
    ...
    function FindNextItem(AFocusedItemIndex: Integer;
      ...
      out ACycleChanged: Boolean; ARecord: TcxCustomGridRecord)
      : Integer; virtual;
    ...
    function IsDataFullyVisible(AIsCallFromMaster: Boolean = False)
      : Boolean; override;
    procedure KeyDown(var Key: Word; Shift: TShiftState); override;
    ...
    procedure MouseUp(Button: TMouseButton; Shift: TShiftState;
      X, Y: Integer); override;
    function ProcessDetailDialogChar(ADetail: TcxCustomGridView;
      ACharCode: Word): Boolean; override;
    function ProcessDialogChar(ACharCode: Word): Boolean; override;
    function SupportsTabAccelerators(AGridRecord: TcxCustomGridRecord)
      : Boolean; virtual;
    ...
    function CheckEditing(var AFocusedRecordIndex: Integer;
    ...
    function FocusNextCell(AGoForward: Boolean;
      AProcessCellsOnly: Boolean = True; AAllowCellsCycle: Boolean = True;
      AFollowVisualOrder: Boolean = True;
      ANeedNormalizeSelection: Boolean = False): Boolean; virtual;
    function FocusNextItem(AFocusedItemIndex: Integer;
      AGoForward, AGoOnCycle, AGoToNextRecordOnCycle, AFollowVisualOrder
      : Boolean; ANeedNormalizeSelection: Boolean = False): Boolean; virtual;
    ...
    function FocusNextRecordWithSelection(AFocusedRecordIndex: Integer;
      AGoForward, AGoOnCycle, AGoIntoDetail: Boolean;
      ASyncSelection: Boolean = True): Boolean;
    function FocusRecord(AFocusedRecordIndex: Integer;
    ...
    function GoToLast(AGoIntoDetail: Boolean;
      ASyncSelection: Boolean = True): Boolean;
    function GoToNext(AGoIntoDetail: Boolean;
      ASyncSelection: Boolean = True): Boolean;
    function GoToPrev(AGoIntoDetail: Boolean;
      ASyncSelection: Boolean = True): Boolean;
    function IsFinish: Boolean;
    function IsStart: Boolean;

    property ClickedCellViewInfo: TcxGridTableDataCellViewInfo
      read FClickedCellViewInfo write FClickedCellViewInfo;
    property EditingController: TcxGridEditingController
      read FEditingController;
    property EditingItem: TcxCustomGridTableItem read GetEditingItem
      write SetEditingItem;
    property FilterMRUItemsPopup: TcxGridFilterMRUItemsPopup
      read GetFilterMRUItemsPopup;
    property FilterPopup: TcxGridFilterPopup read GetFilterPopup;
    property FocusedItem: TcxCustomGridTableItem read FFocusedItem
      write SetFocusedItem;
    property FocusedItemIndex: Integer read GetFocusedItemIndex
      write SetFocusedItemIndex;
    property FocusedRecord: TcxCustomGridRecord read FFocusedRecord
      write SetFocusedRecord;
    property FocusedRecordIndex: Integer read GetFocusedRecordIndex
      write SetFocusedRecordIndex;
    property GridView: TcxCustomGridTableView read GetGridView;
    property IncSearchingItem: TcxCustomGridTableItem read GetIncSearchingItem;
    property IncSearchingText: string read GetIncSearchingText
      write SetIncSearchingText;
    ...
    property ItemsCustomizationPopup: TcxCustomGridItemsCustomizationPopup
      read GetItemsCustomizationPopup;
    property MasterController: TcxCustomGridTableController
      read GetMasterController;
    property MovingItem: TcxCustomGridTableItem read FMovingItem;
    property NewItemRecordFocused: Boolean read GetNewItemRecordFocused
      write SetNewItemRecordFocused;
    property PrevFocusedRecordIndex: Integer read GetPrevFocusedRecordIndex
      write FPrevFocusedRecordIndex;
    property SelectedRecordCount: Integer read GetSelectedRecordCount;
    property SelectedRecords[Index: Integer]: TcxCustomGridRecord
      read GetSelectedRecord;
    property TopRecordIndex: Integer read GetTopRecordIndex
      write SetTopRecordIndex;
  end;
  ...
  public
    constructor Create(ACanvas: TcxCanvas;
      AViewInfo: TcxCustomGridRecordsViewInfo); virtual;
    procedure MainPaint;
  end;
  ...
  public
    constructor Create(AGridViewInfo: TcxCustomGridTableViewInfo);
      reintroduce; virtual;
  ...
  TcxGridPartContainerItemViewInfoClass = class of
  ...
  public
    constructor Create(AContainer: TcxGridPartContainerButtonsViewInfo);
      reintroduce; virtual;

    function MouseDown(AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
      AShift: TShiftState): Boolean; override;
    function MouseMove(AHitTest: TcxCustomGridHitTest; AShift: TShiftState)
      : Boolean; override;
  ...
  protected
    ...
    property Container: TcxGridFilterButtonsViewInfo read GetContainer;
    property DropDownWindow: TcxGridFilterMRUItemsPopup
  ...
  protected
    ...
    function IsItemCalculatedSingly(AItem: TcxGridPartCustomCellViewInfo)
      : Boolean; virtual;
    function GetButtonsOffset: Integer; virtual;
    function GetFirstOffset: Integer; virtual;
    function GetTopBound(AItem: TcxGridPartCustomCellViewInfo; ABounds: TRect)
      : Integer; virtual;
    function GetWidth(AAlignment: TcxGridFilterButtonAlignment)
      : Integer; virtual;
    function GetEnabled: Boolean; virtual;
  ...
  public
    ...
    function AddItem(AItemClass: TcxGridPartContainerItemViewInfoClass)
      : TcxGridPartContainerItemViewInfo;
    ...
    property IsRightToLeftConverted: Boolean read FIsRightToLeftConverted
      write FIsRightToLeftConverted;
    property Items[Index: Integer]: TcxGridPartContainerItemViewInfo
  ...
  public
    property DropDownButtonViewInfo: TcxGridFilterDropDownButtonViewInfo
      read FDropDownButtonViewInfo;
  end;
  ...
  protected
    ...
    property FindPanelViewInfo: TcxGridFindPanelViewInfo
      read GetFindPanelViewInfo;
  public
    procedure Calculate(const ABounds: TRect); override;
  end;
  ...
  protected
    ...
    function CreateButtonsViewInfo: TcxGridPartContainerButtonsViewInfo;
      virtual; abstract;
  ...
  public
    ...
    property ButtonsViewInfo: TcxGridPartContainerButtonsViewInfo
      read FButtonsViewInfo;
  end;
  ...
  private
    ...
    // IdxFilterBoxTokenCriteriaViewInfoOwner
    function IdxFilterBoxTokenCriteriaViewInfoOwner.GetControl =
      GetTokenCriteriaControl;
    function IdxFilterBoxTokenCriteriaViewInfoOwner.GetCriteria =
      GetTokenCriteria;
    function IdxFilterBoxTokenCriteriaViewInfoOwner.GetOptions =
      GetTokenCriteriaOptions;
    procedure IdxFilterBoxTokenCriteriaViewInfoOwner.GetViewParams =
      GetTokenCriteriaParams;
  ...
  protected
    ...
    function CreateButtonsViewInfo
      : TcxGridPartContainerButtonsViewInfo; override;
    function CreateTokenCriteriaViewInfo
      : TdxFilterBoxTokenCriteriaViewInfo; virtual;
    ...
    property TokenCriteriaViewInfo: TdxFilterBoxTokenCriteriaViewInfo
      read FTokenCriteriaViewInfo;
  public
    constructor Create(AGridViewInfo: TcxCustomGridTableViewInfo); override;
    destructor Destroy; override;
    ...
    property ButtonsViewInfo: TcxGridFilterButtonsViewInfo
      read GetButtonsViewInfo;
  end;
  ...
  protected
    ...
    property FindPanel: TcxGridFindPanel read GetFindPanel;
  public
    property ButtonsViewInfo: TcxGridFindPanelButtonsViewInfo
      read GetButtonsViewInfo;
  end;
  ...
  protected
    ...
    function GetHitTestClass: TcxCustomGridHitTestClass; override;
    function GetHotTrack: Boolean; override;
    procedure GetFindTextSelectionInfo(out ASelStart: Integer;
      out AHighlightedText: string); virtual;
  ...
  private
    ...
    procedure AfterDrawCellBackgroundHandler(Sender: TcxCustomEditViewInfo;
      ACanvas: TcxCanvas);
    procedure AfterDrawCellValueHandler(Sender: TcxCustomEditViewInfo;
      ACanvas: TcxCanvas);
    procedure CalculateEditorBoundsHandler(AViewInfo: TcxCustomEditViewInfo;
      var R: TRect);
    procedure CanDrawEditValueHandler(Sender: TcxCustomEditViewInfo;
      var Allow: Boolean);
  ...
  protected
    ...
    procedure GetEditViewDataFindTextSelectionInfo(out ASelStart: Integer;
      out AHighlightedText: string); virtual;
    function GetEditViewDataTextSelectionInfo(out AParams: TcxViewParams;
      out ASelStart, ASelLength: Integer): Boolean;
    ...
    procedure InitHitTest(AHitTest: TcxCustomGridHitTest); override;
    procedure InitializeByHiddenEditor(AEditViewInfo: TcxCustomEditViewInfo;
    ...
    // IcxEditOwner
    function EditOwnerGetViewData(out AIsViewDataCreated: Boolean)
      : TcxCustomEditViewData;
    procedure EditOwnerInvalidate(const R: TRect;
      AEraseBackground: Boolean = True);
    ...
    property UsedForPaintingHiddenEditor: Boolean
      read FUsedForPaintingHiddenEditor write SetUsedForPaintingHiddenEditor;
  ...
  protected
    ...
    function GetCanvas: TcxCanvas; override;
    function GetCellTransparent(ACell: TcxGridTableCellViewInfo)
      : Boolean; virtual;
  ...
  public
    ...
    procedure DoRightToLeftConversion(const ABounds: TRect); override;
    function GetBoundsForInvalidate(AItem: TcxCustomGridTableItem)
      : TRect; virtual;
    function GetBoundsForItem(AItem: TcxCustomGridTableItem): TRect; virtual;
    function GetCellViewInfoByItem(AItem: TcxCustomGridTableItem)
    ...
    property RecordsViewInfo: TcxCustomGridRecordsViewInfo
      read FRecordsViewInfo;
    property Selected: Boolean read GetSelected;
  end;
  ...
  private
    ...
    function CreateRecordViewInfo(AIndex: Integer)
      : TcxCustomGridRecordViewInfo; overload;
  protected
    ...
    function CalculateIncSearchingCellViewInfo
      : TcxGridTableDataCellViewInfo; virtual;
    procedure CalculatePixelScrollInfo(var ARecordIndex, ARecordOffset: Integer;
      AMaxRecordIndex, AMaxRecordOffset: Integer; ADelta: Integer;
      out AOverPan: Boolean); virtual;
    function GetPixelScrollOffset(AFirstRecordIndex, AFirstRecordOffset
      : Integer; ALastRecordIndex, ALastRecordOffset: Integer): Integer;
    procedure CalculateVisibleCount; virtual;
    procedure Clear;
    procedure CreateEditViewDatas;
    function CreateRecordViewInfo(ARecord: TcxCustomGridRecord)
      : TcxCustomGridRecordViewInfo; overload;
    procedure DeleteItem(AIndex: Integer); virtual;
    procedure DestroyEditViewDatas;
    function GetAreaBoundsForCell(ACellViewInfo: TcxGridTableDataCellViewInfo)
      : TRect; virtual;
    ...
    function GetItemPixelScrollSize(AItem: TcxCustomGridRecordViewInfo)
      : Integer; virtual;
    function GetItemsOffset(AItemCountDelta: Integer): Integer;
      virtual; abstract;
    ...
    function GetViewInfoIndexByRecordIndex(ARecordIndex: Integer)
      : Integer; virtual;
    ...
    property GridViewInfo: TcxCustomGridTableViewInfo read FGridViewInfo;
    property IncSearchingCellViewInfo: TcxGridTableDataCellViewInfo
      read GetIncSearchingCellViewInfo;
    property IsRecordPixelScrollSizeCalculating: Boolean
      read GetIsRecordPixelScrollSizeCalculating;
  ...
  public
    ...
    function GetHitTest(const P: TPoint): TcxCustomGridHitTest; virtual;
    function GetRealItem(ARecord: TcxCustomGridRecord)
      : TcxCustomGridRecordViewInfo; virtual;
    ...
    procedure OffsetRecords(AItemCountDelta, APixelScrollRecordOffsetDelta
      : Integer); virtual;
    procedure Paint;
    procedure RightToLeftConversion(const ABounds: TRect);
    ...
    property IsRightToLeftConverted: Boolean read FIsRightToLeftConverted
      write FIsRightToLeftConverted;
    property Items[Index: Integer]: TcxCustomGridRecordViewInfo
      read GetItem; default;
    property ItemsOffset: Integer read FItemsOffset;
    property PartVisibleCount: Integer read FPartVisibleCount;
    property PrevFocusedItemBounds: TRect read FPrevFocusedItemBounds
      write FPrevFocusedItemBounds;
  ...
  TcxGridCustomTableNavigatorViewInfoClass = class of
  ...
  public
    ...
    function MouseUp(AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
      AShift: TShiftState): Boolean; override;
    property GridViewInfo: TcxCustomGridTableViewInfo read GetGridViewInfo;
    property NavigatorViewInfo: TcxGridCustomTableNavigatorViewInfo
      read FNavigatorViewInfo;
  end;
  ...
  protected
    ...
    procedure CalculateNavigator;
    function CalculatePartBounds(APart: TcxCustomGridPartViewInfo)
      : TRect; virtual;
    ...
    function GetMultilineEditorBounds(const ACellEditBounds: TRect;
      ACalculatedHeight: Integer; AAutoHeight: TcxInplaceEditAutoHeight)
      : TRect; virtual;
    function GetNavigatorOffset: Integer; virtual;
    function GetNavigatorSiteViewInfoClass
      : TcxNavigatorSiteViewInfoClass; virtual;
    function GetNavigatorViewInfoClass
      : TcxGridCustomTableNavigatorViewInfoClass; virtual;
    ...
    function GetNonRecordsAreaHeight(ACheckScrollBar: Boolean)
      : Integer; virtual;
    function GetPixelScrollRecordOffset: Integer; virtual;
    function GetRecordsViewInfoClass: TcxCustomGridRecordsViewInfoClass;
      virtual; abstract;
    ...
    procedure Offset(DX, DY: Integer); virtual;
    procedure OffsetRecords(ARecordCountDelta, APixelScrollRecordOffsetDelta
      : Integer); virtual;
  ...
  public
    constructor Create(AGridView: TcxCustomGridView); override;
    destructor Destroy; override;
    function CanOffset(ARecordCountDelta, APixelScrollRecordOffsetDelta, DX,
      DY: Integer): Boolean; virtual;
    function CanOffsetView(ARecordCountDelta: Integer): Boolean; virtual;
    procedure DoOffset(ARecordCountDelta, APixelScrollRecordOffsetDelta, DX,
      DY: Integer); virtual;
    procedure DoRightToLeftConversion(const ABounds: TRect); override;

    // for extended lookup edit
    function GetNearestPopupHeight(AHeight: Integer;
      AAdditionalRecord: Boolean = False): Integer; virtual;
    ...
    property FindPanelViewInfo: TcxGridFindPanelViewInfo
      read FFindPanelViewInfo;
    property FirstRecordIndex: Integer read GetFirstRecordIndex
      write FFirstRecordIndex;
    property GridView: TcxCustomGridTableView read GetGridView;
    property NavigatorBounds: TRect read GetNavigatorBounds;
    property NavigatorOffset: Integer read GetNavigatorOffset;
    property NavigatorSiteViewInfo: TcxNavigatorSiteViewInfo
      read FNavigatorSiteViewInfo;
    ...
    property NoDataInfoTextAreaVisible: Boolean
      read GetNoDataInfoTextAreaVisible;
    property PartsBottomHeight: Integer read GetPartsBottomHeight;
    property PartsTopHeight: Integer read GetPartsTopHeight;
    property PixelScrollRecordOffset: Integer read GetPixelScrollRecordOffset
      write FPixelScrollRecordOffset;
    property RecordsViewInfo: TcxCustomGridRecordsViewInfo
      read FRecordsViewInfo;
    property ScrollableAreaBounds: TRect read GetScrollableAreaBounds;
    property ScrollableAreaBoundsForEdit: TRect
      read GetScrollableAreaBoundsForEdit;
  ...
  public
    ...
    property IsHeightAssigned: Boolean read FIsHeightAssigned
      write FIsHeightAssigned;
  end;
  ...
  protected
    function GetItemClass(Index: Integer)
      : TcxCustomGridViewInfoCacheItemClass; override;
    property ViewData: TcxCustomGridTableViewData read GetViewData;
  end;
  ...
  TcxCustomGridTableItemOptions = class(TcxCustomGridTableItemCustomOptions,
    IdxFilterPopupWindowOptions, IdxExcelFilterPopupWindowOptions)
  private
    ...
    FFilteringExcelPopupApplyChanges
      : TdxExcelFilterValueContainerApplyChangesMode;
    FFilteringExcelPopupDateTimeValuesPageType
    ...
    FFilteringExcelPopupNumericValuesPageType
    ...
    FFilteringPopupIncrementalFilteringOptions
    ...
    procedure SetFilteringExcelPopupApplyChanges
      (AValue: TdxExcelFilterValueContainerApplyChangesMode);
    procedure SetFilteringExcelPopupDateTimeValuesPageType
      (const AValue: TdxExcelFilterValueContainerDateTimeValuesPageType);
    procedure SetFilteringExcelPopupDefaultPage(const AValue
      : TdxExcelFilterValueContainerDefaultPage);
    procedure SetFilteringExcelPopupNumericValuesPageType
      (const AValue: TdxExcelFilterValueContainerNumericValuesPageType);
    procedure SetFilteringFilteredItemsList(Value: Boolean);
    procedure SetFilteringFilteredItemsListShowFilteredItemsOnly
      (AValue: Boolean);
  ...
  protected
    ...
    function IdxFilterPopupWindowOptions.GetApplyMode =
      GetFilterPopupWindowApplyMode;
    function IdxFilterPopupWindowOptions.GetButtonCaption =
      GetFilterPopupWindowButtonCaption;
    function IdxFilterPopupWindowOptions.GetIncrementalFiltering =
      GetFilterPopupWindowIncrementalFiltering;
    function IdxFilterPopupWindowOptions.GetIncrementalFilteringOptions =
      GetFilterPopupWindowIncrementalFilteringOptions;
    function IdxFilterPopupWindowOptions.GetVisibleItemCount =
      GetFilterPopupWindowVisibleItemCount;
    function IdxFilterPopupWindowOptions.GetShowCheckBoxes =
      GetFilterPopupWindowShowCheckBoxes;
    ...
    function GetFilterPopupWindowIncrementalFilteringOptions
      : TcxTextEditIncrementalFilteringOptions;
    ...
    function IdxExcelFilterPopupWindowOptions.GetDateTimeValuesPageType =
      GetExcelFilterPopupDateTimeValuesPageType;
    function IdxExcelFilterPopupWindowOptions.GetDefaultPage =
      GetExcelFilterPopupDefaultPage;
    function IdxExcelFilterPopupWindowOptions.GetApplyChanges =
      GetExcelFilterPopupApplyChanges;
    function IdxExcelFilterPopupWindowOptions.GetNumericValuesPageType =
      GetExcelFilterPopupNumericValuesPageType;
    function GetExcelFilterPopupApplyChanges
      : TdxExcelFilterValueContainerApplyChangesMode;
    function GetExcelFilterPopupDateTimeValuesPageType
      : TdxExcelFilterValueContainerDateTimeValuesPageType;
    function GetExcelFilterPopupDefaultPage
      : TdxExcelFilterValueContainerDefaultPage;
    function GetExcelFilterPopupNumericValuesPageType
      : TdxExcelFilterValueContainerNumericValuesPageType;

    procedure BeforeShowCaptionChange; virtual;

    property EditAutoHeight: TcxItemInplaceEditAutoHeight read FEditAutoHeight
      write SetEditAutoHeight default ieahDefault;
    property ExpressionEditing: Boolean read FExpressionEditing
      write FExpressionEditing default True;
    ...
    property ShowCaption: Boolean read FShowCaption write SetShowCaption
      default True;
    property SortByDisplayText: TcxGridItemSortByDisplayText
      read FSortByDisplayText write SetSortByDisplayText default isbtDefault;
  ...
  public
    ...
    property FilteringAddValueItems: Boolean read FFilteringAddValueItems
      write SetFilteringAddValueItems default True;
    property FilteringExcelPopupApplyChanges
      : TdxExcelFilterValueContainerApplyChangesMode
      read FFilteringExcelPopupApplyChanges
      write SetFilteringExcelPopupApplyChanges default efacDefault;
    property FilteringExcelPopupDateTimeValuesPageType
      : TdxExcelFilterValueContainerDateTimeValuesPageType
      read FFilteringExcelPopupDateTimeValuesPageType
      write SetFilteringExcelPopupDateTimeValuesPageType default dvptDefault;
    property FilteringExcelPopupDefaultPage
      : TdxExcelFilterValueContainerDefaultPage
      read FFilteringExcelPopupDefaultPage
      write SetFilteringExcelPopupDefaultPage default dpDefault;
    property FilteringExcelPopupNumericValuesPageType
      : TdxExcelFilterValueContainerNumericValuesPageType
      read FFilteringExcelPopupNumericValuesPageType
      write SetFilteringExcelPopupNumericValuesPageType default nvptDefault;
    property FilteringFilteredItemsList: Boolean
      read FFilteringFilteredItemsList write SetFilteringFilteredItemsList
      default True;
    property FilteringFilteredItemsListShowFilteredItemsOnly: Boolean
      read FFilteringFilteredItemsListShowFilteredItemsOnly
    ...
    property FilteringPopup: Boolean read FFilteringPopup
      write SetFilteringPopup default True;
    property FilteringPopupIncrementalFiltering: Boolean
      read FFilteringPopupIncrementalFiltering
      write FFilteringPopupIncrementalFiltering default False;
    property FilteringPopupIncrementalFilteringOptions
      : TcxTextEditIncrementalFilteringOptions
      read FFilteringPopupIncrementalFilteringOptions
      write FFilteringPopupIncrementalFilteringOptions
      default [ifoHighlightSearchText, ifoUseContainsOperator];
    property FilteringPopupMode: TdxFilterPopupWindowMode
      read FFilteringPopupMode write SetFilteringPopupMode default fpmDefault;
  ...
  published
    ...
    property FilteringWithFindPanel: Boolean read FFilteringWithFindPanel
      write SetFilteringWithFindPanel default True;
    property Focusing: Boolean read FFocusing write SetFocusing default True;
    property IgnoreTimeForFiltering: Boolean read FIgnoreTimeForFiltering
      write SetIgnoreTimeForFiltering default True;
    property IncSearch: Boolean read FIncSearch write SetIncSearch default True;
  end;

  TcxGridGetCellStyleEvent = procedure(Sender: TcxCustomGridTableView;
    ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
    {$IFDEF BCBCOMPATIBLE}var {$ELSE}out {$ENDIF} AStyle: TcxStyle) of object;

  TcxGridGetRecordStyleEvent = procedure(Sender: TcxCustomGridTableView;
...
{$IFDEF BCBCOMPATIBLE}var {$ELSE}out {$ENDIF} AStyle: TcxStyle) of object;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
    procedure GetContentParams(ARecord: TcxCustomGridRecord;
  ...
  published
    ...
    property OnGetContentStyle: TcxGridGetCellStyleEvent read FOnGetContentStyle
      write SetOnGetContentStyle;
  end;

  TcxGridSortOrder = TcxDataSortOrder;

  TcxGridTableDataCellCustomDrawEvent = procedure
    (Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
    AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean) of object;

  TcxGridGetCellHintEvent = procedure(Sender: TcxCustomGridTableItem;
    ARecord: TcxCustomGridRecord; ACellViewInfo: TcxGridTableDataCellViewInfo;
    const AMousePos: TPoint; var AHintText: TCaption;
    var AIsHintMultiLine: Boolean; var AHintTextRect: TRect) of object;
  ...
  TcxGridGetPropertiesEvent = procedure(Sender: TcxCustomGridTableItem;
    ...
    of object;
  TcxGridInitDateRangesEvent = procedure(Sender: TcxCustomGridTableItem;
    ADateRanges: TcxGridDateRanges) of object;
  TcxGridTableItemGetStoredPropertiesEvent = procedure
    (Sender: TcxCustomGridTableItem; AProperties: TStrings) of object;
  TcxGridTableItemGetStoredPropertyValueEvent = procedure
    (Sender: TcxCustomGridTableItem; const AName: string; var AValue: Variant)
    of object;
  TcxGridTableItemSetStoredPropertyValueEvent = procedure
  ...
  TcxGridValidateDrawValueEvent = procedure(Sender: TcxCustomGridTableItem;
    ARecord: TcxCustomGridRecord; const AValue: TcxEditValue;
    AData: TcxEditValidateInfo) of object;

  TcxCustomGridTableItemClass = class of TcxCustomGridTableItem;

  TcxCustomGridTableItem = class(TcxComponent, IcxEditRepositoryItemListener,
    IcxStoredObject, IdxScaleFactor, IdxFilterableComponent,
    IdxExcelFilterableComponent, IdxDateTimeHandling,
    IdxFilteringDateTimeHandling, IdxGroupingDateTimeHandling,
  ...
  private
    ...
    procedure SetOnGetFilterDisplayText
      (Value: TcxGridGetFilterDisplayTextEvent);
    ...
    procedure SetOnGetStoredProperties
      (Value: TcxGridTableItemGetStoredPropertiesEvent);
    procedure SetOnGetStoredPropertyValue
      (Value: TcxGridTableItemGetStoredPropertyValueEvent);
    ...
    procedure SetOnSetStoredPropertyValue
      (Value: TcxGridTableItemSetStoredPropertyValueEvent);
  ...
  protected
    ...
    procedure IcxEditRepositoryItemListener.PropertiesChanged =
      RepositoryItemPropertiesChanged;
    ...
    procedure GetPropertyValue(const AName: string;
      var AValue: Variant); virtual;
    procedure SetPropertyValue(const AName: string;
      const AValue: Variant); virtual;
    // IdxScaleFactor
    ...
    procedure GetFilterActiveValueIndexes(AValues: TcxFilterValueList;
    ...
    procedure PopulateFilterValues(AValues: TcxFilterValueList;
      ADisplayValues: TStrings; AValuesOnly: Boolean; AUniqueOnly: Boolean);
    procedure SetFilterActiveValueIndex(AValues: TcxFilterValueList;
      AIndex: Integer; AFilterList: TcxFilterCriteriaItemList;
      AReplaceExistent, AAddToMRUItemsList: Boolean);
    procedure SetFilterActiveValueIndexes(AValues: TcxFilterValueList;
    ...
    function IdxDateTimeHandling.GetMonthFormat =
      GetDateTimeHandlingMonthFormat;
    ...
    function IdxFilteringDateTimeHandling.GetFilters =
      GetDateTimeHandlingFilters;
    function GetDateTimeHandlingFilters: TdxDateTimeFilters;
    // IdxGroupingDateTimeHandling
    function IdxGroupingDateTimeHandling.GetGrouping =
      GetDateTimeHandlingGrouping;
    ...
    function GetFilteringDateRangesClass
      : TcxGridFilteringDateRangesClass; virtual;
    function GetGroupingDateRangesClass
      : TcxGridGroupingDateRangesClass; virtual;
    ...
    procedure ChangeGrouping(AGroupIndex: Integer;
      AMergeWithLeftColumn: Boolean = False;
      AMergeWithRightColumn: Boolean = False); virtual;
    ...
    procedure GetFilterDisplayText(const AValue: Variant;
      var ADisplayText: string); virtual;
    ...
    function SupportsGroupingDateRanges(ACheckCustomHandlers: Boolean)
      : Boolean; virtual;
    ...
    procedure InitStyle(AStyle: TcxCustomEditStyle;
      const AParams: TcxViewParams; AFocused: Boolean); virtual;
    ...
    function CreateEditViewData(AProperties: TcxCustomEditProperties)
      : TcxCustomEditViewData;
    ...
    procedure EditViewDataGetDisplayTextHandler(Sender: TcxCustomEditViewData;
      var AText: string);
    function GetEditViewData(AProperties: TcxCustomEditProperties;
      out AIsLocalCopy: Boolean; ANeedLocalCopy: Boolean = False)
      : TcxCustomEditViewData;
    procedure ReleaseEditViewData(var AEditViewData: TcxCustomEditViewData;
    ...
    procedure DoGetCellHint(ARecord: TcxCustomGridRecord;
    ...
    procedure DoGetDisplayText(ARecord: TcxCustomGridRecord;
      var AText: string); virtual;
    procedure DoGetFilterValues(AValueList: TcxDataFilterValueList); virtual;
    function DoGetProperties(ARecord: TcxCustomGridRecord)
      : TcxCustomEditProperties; virtual;
    procedure DoGetPropertiesForEdit(ARecord: TcxCustomGridRecord;
      var AProperties: TcxCustomEditProperties); virtual;
    procedure DoInitFilteringDateRanges; virtual;
    procedure DoInitGroupingDateRanges; virtual;
    procedure DoUserFiltering(const AValue: Variant;
      const ADisplayText: string); virtual;
    procedure DoUserFilteringEx(AFilterList: TcxFilterCriteriaItemList;
      const AValue: Variant; const ADisplayText: string); virtual;
    procedure DoValidateDrawValue(ARecord: TcxCustomGridRecord;
      const AValue: TcxEditValue; AData: TcxEditValidateInfo); virtual;
    ...
    property Controller: TcxCustomGridTableController read GetController;
    property DataController: TcxCustomDataController read GetDataController;
    property DateTimeGrouping: TcxGridDateTimeGrouping read FDateTimeGrouping
      write SetDateTimeGrouping default dtgDefault;
    property EditingProperties: TcxCustomEditProperties
      read GetEditingProperties;
    ...
    property GroupIndex: Integer read GetGroupIndex write SetGroupIndex
      default -1;
    property GroupingDateRanges: TcxGridGroupingDateRanges
      read FGroupingDateRanges;
    property HeaderAlignmentHorz: TAlignment read GetHeaderAlignmentHorz
      write SetHeaderAlignmentHorz stored IsHeaderAlignmentHorzStored;
    ...
    // obsolete, use VisibleForCustomization
    property IgnoreLoadingStatus: Boolean read FIgnoreLoadingStatus
      write FIgnoreLoadingStatus;
    ...
    property VisibleInQuickCustomizationPopup: Boolean
      read GetVisibleInQuickCustomizationPopup;
    property WasVisibleBeforeGrouping: Boolean read FWasVisibleBeforeGrouping;
    property Width: Integer read GetWidth write SetWidth stored IsWidthStored;

    property OnInitGroupingDateRanges: TcxGridInitDateRangesEvent
      read FOnInitGroupingDateRanges write SetOnInitGroupingDateRanges;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    ...
    function CalculateDefaultCellHeight(ACanvas: TcxCanvas; AFont: TFont)
      : Integer; virtual;
    ...
    function GetProperties(ARecord: TcxCustomGridRecord)
      : TcxCustomEditProperties; overload;
    function GetProperties(ARecordIndex: Integer)
      : TcxCustomEditProperties; overload;
    ...
    property BestFitMaxWidth: Integer read FBestFitMaxWidth
      write SetBestFitMaxWidth default 0;
    ...
    property Filtered: Boolean read GetFiltered write SetFiltered;
    property FilteringDateRanges: TcxGridFilteringDateRanges
      read FFilteringDateRanges;
    property Focused: Boolean read GetFocused write SetFocused;
    property FocusedCellViewInfo: TcxGridTableDataCellViewInfo
    ...
    property IsFirst: Boolean read GetIsFirst;
    property IsLast: Boolean read GetIsLast;
    property Options: TcxCustomGridTableItemOptions read FOptions
      write SetOptions;
    property PropertiesClass: TcxCustomEditPropertiesClass read FPropertiesClass
      write SetPropertiesClass;
    property SortIndex: Integer read GetSortIndex write SetSortIndex default -1;
    property SortOrder: TcxGridSortOrder read GetSortOrder write SetSortOrder
      stored IsSortOrderStored;
  ...
  published
    property AlternateCaption: string read FAlternateCaption
      write SetAlternateCaption;
    property Caption: string read GetCaption write SetCaption
      stored IsCaptionStored;
    property DataBinding: TcxGridItemDataBinding read FDataBinding
    ...
    property VisibleForExpressionEditor: TdxDefaultBoolean
      read FVisibleForExpressionEditor write FVisibleForExpressionEditor
      default bDefault;
    property PropertiesEvents: TNotifyEvent read FSubClassEvents
      write FSubClassEvents;
    property StylesEvents: TNotifyEvent read FSubClassEvents
      write FSubClassEvents;
    property Tag: TcxTag read GetTag write SetTag stored IsTagStored;
    property OnCustomDrawCell: TcxGridTableDataCellCustomDrawEvent
      read FOnCustomDrawCell write SetOnCustomDrawCell;
    property OnGetCellHint: TcxGridGetCellHintEvent read FOnGetCellHint
      write SetOnGetCellHint;
    property OnGetDataText: TcxGridGetDataTextEvent read FOnGetDataText
      write SetOnGetDataText;
    property OnGetDisplayText: TcxGridGetDisplayTextEvent read FOnGetDisplayText
      write SetOnGetDisplayText;
    property OnGetFilterDisplayText: TcxGridGetFilterDisplayTextEvent
      read FOnGetFilterDisplayText write SetOnGetFilterDisplayText;
    property OnGetFilterValues: TcxGridGetFilterValuesEvent
      read FOnGetFilterValues write SetOnGetFilterValues;
    property OnGetProperties: TcxGridGetPropertiesEvent read FOnGetProperties
      write SetOnGetProperties;
    property OnGetPropertiesForEdit: TcxGridGetPropertiesEvent
      read FOnGetPropertiesForEdit write SetOnGetPropertiesForEdit;
    ...
    property OnInitFilteringDateRanges: TcxGridInitDateRangesEvent
      read FOnInitFilteringDateRanges write SetOnInitFilteringDateRanges;
    ...
    property OnUserFiltering: TcxGridUserFilteringEvent read FOnUserFiltering
      write SetOnUserFiltering;
    property OnUserFilteringEx: TcxGridUserFilteringExEvent
      read FOnUserFilteringEx write SetOnUserFilteringEx;
    property OnValidateDrawValue: TcxGridValidateDrawValueEvent
      read FOnValidateDrawValue write SetOnValidateDrawValue;
  end;
  ...
  TcxCustomGridTableDateTimeHandlingClass = class of
  ...
  protected
    ...
    property Grouping: TcxGridDateTimeGrouping read FGrouping write SetGrouping
      default dtgByDateAndTime;
    property HourFormat: string read FHourFormat write SetHourFormat;
    property UseLongDateFormat: Boolean read FUseLongDateFormat
      write SetUseLongDateFormat default True;
    property UseShortTimeFormat: Boolean read FUseShortTimeFormat
      write SetUseShortTimeFormat default True;
  public
    constructor Create(AGridView: TcxCustomGridView); override;
    procedure Assign(Source: TPersistent); override;
    ...
    property GridView: TcxCustomGridTableView read GetGridView;
  published
    property Filters: TcxGridDateTimeFilters read FFilters write SetFilters
      default [];
    property IgnoreTimeForFiltering: Boolean read FIgnoreTimeForFiltering
      write SetIgnoreTimeForFiltering default False;
  ...
  public
    constructor Create(AFiltering: TcxCustomGridTableFiltering);
      reintroduce; virtual;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property ItemRemoval: Boolean read GetItemRemoval write SetItemRemoval
      default True;
  end;
  ...
  public
    ...
    property GridView: TcxCustomGridTableView read GetGridView;
  published
    property CriteriaDisplayStyle: TcxFilterCriteriaDisplayStyle
      read FCriteriaDisplayStyle write SetCriteriaDisplayStyle
      default fcdsDefault;
    ...
    property CustomizeDialog: Boolean read FCustomizeDialog
      write SetCustomizeDialog default True;
    property MRUItemsListDropDownCount: Integer read FMRUItemsListDropDownCount
      write SetMRUItemsListDropDownCount default 0;
    property Position: TcxGridFilterPosition read FPosition write SetPosition
      default fpBottom;
    property TokenCriteria: TcxGridFilterBoxTokenCriteriaOptions
      read FTokenCriteria write SetTokenCriteria;
    property Visible: TcxGridFilterVisible read FVisible write SetVisible
      default fvNonEmpty;
  end;
  ...
  public
    constructor Create(AController: TcxCustomGridTableController);
      reintroduce; virtual;
  ...
  published
    property ApplyInputDelay: Integer read GetApplyInputDelay
      write SetApplyInputDelay default 1000;
    property Behavior: TcxDataFindCriteriaBehavior read GetBehavior
      write SetBehavior default fcbDefault;
    property ClearFindFilterTextOnClose: Boolean
      read GetClearFindFilterTextOnClose write SetClearFindFilterTextOnClose
      default True;
    property DisplayMode: TcxFindPanelDisplayMode read GetDisplayMode
      write SetDisplayMode default fpdmNever;
    property FocusViewOnApplyFilter: Boolean read GetFocusViewOnApplyFilter
      write SetFocusViewOnApplyFilter default False;
    property HighlightSearchResults: Boolean read GetHighlightSearchResults
      write SetHighlightSearchResults default True;
    property InfoText: string read GetInfoText write SetInfoText
      stored IsInfoTextStored;
    property Layout: TcxFindPanelLayout read GetLayout write SetLayout
      default fplDefault;
    property MRUItemsListCount: Integer read GetMRUItemsListCount
      write SetMRUItemsListCount
      default cxGridFindPanelDefaultMRUItemsListCount;
    property MRUItemsListDropDownCount: Integer
      read GetMRUItemsListDropDownCount write SetMRUItemsListDropDownCount
      default cxGridFindPanelDefaultMRUItemsListDropDownCount;
    property Position: TcxFindPanelPosition read GetPosition write SetPosition
      default fppTop;
    property ShowClearButton: Boolean read GetShowClearButton
      write SetShowClearButton default True;
    property ShowCloseButton: Boolean read GetShowCloseButton
      write SetShowCloseButton default True;
    property ShowFindButton: Boolean read GetShowFindButton
      write SetShowFindButton default True;
    property ShowNextButton: Boolean read GetShowNextButton
      write SetShowNextButton default True;
    property ShowPreviousButton: Boolean read GetShowPreviousButton
      write SetShowPreviousButton default True;
    property UseDelayedFind: Boolean read GetUseDelayedFind
      write SetUseDelayedFind default True;
    property UseExtendedSyntax: Boolean read GetUseExtendedSyntax
      write SetUseExtendedSyntax default False;
  end;
  ...
  strict private
    ...
    procedure SetApplyMultiSelectChanges
      (AValue: TcxGridItemFilterPopupApplyChangesMode);
  ...
  published
    property ApplyMultiSelectChanges: TcxGridItemFilterPopupApplyChangesMode
      read FApplyMultiSelectChanges write SetApplyMultiSelectChanges
      default fpacImmediately;
    ...
    property MaxDropDownItemCount: Integer read FMaxDropDownItemCount
      write SetMaxDropDownItemCount
      default cxGridFilterDefaultItemPopupMaxDropDownItemCount;
  ...
  TcxGridItemExcelFilterPopupOptionsClass = class of
    TcxGridItemExcelFilterPopupOptions;
  ...
  strict private
    ...
    procedure SetApplyChanges
      (AValue: TdxExcelFilterValueContainerApplyChangesMode);
    procedure SetDateTimeValuesPageType(const AValue
      : TdxExcelFilterValueContainerDateTimeValuesPageType);
    procedure SetDefaultPage(const AValue
      : TdxExcelFilterValueContainerDefaultPage);
    procedure SetNumericValuesPageType(const AValue
      : TdxExcelFilterValueContainerNumericValuesPageType);
  public
    procedure Assign(ASource: TPersistent); override;
  published
    property ApplyChanges: TdxExcelFilterValueContainerApplyChangesMode
      read FApplyChanges write SetApplyChanges default efacDefault;
    property DateTimeValuesPageType
      : TdxExcelFilterValueContainerDateTimeValuesPageType
      read FDateTimeValuesPageType write SetDateTimeValuesPageType
      default dvptDefault;
    property DefaultPage: TdxExcelFilterValueContainerDefaultPage
      read FDefaultPage write SetDefaultPage default dpDefault;
    property NumericValuesPageType
      : TdxExcelFilterValueContainerNumericValuesPageType
      read FNumericValuesPageType write SetNumericValuesPageType
      default nvptDefault;
  end;
  ...
  protected
    ...
    function GetItemExcelPopupClass
      : TcxGridItemExcelFilterPopupOptionsClass; virtual;
    function GetMRUItemsClass: TcxGridFilterMRUItemsClass; virtual;
    function IsFilterBoxEnabled: Boolean; virtual;
    function IsMRUItemsListAvailable: Boolean; virtual;
    procedure MRUItemsVisibleCountChanged(AOldCount,
      ANewCount: Integer); virtual;

    property ItemAddValueItems: Boolean read FItemAddValueItems
      write SetItemAddValueItems default True;
    property ItemExcelPopup: TcxGridItemExcelFilterPopupOptions
      read FItemExcelPopup write SetItemExcelPopup;
    property ItemFilteredItemsList: Boolean read FItemFilteredItemsList
      write SetItemFilteredItemsList default False;
    property ItemFilteredItemsListShowFilteredItemsOnly: Boolean
      read FItemFilteredItemsListShowFilteredItemsOnly
      write SetItemFilteredItemsListShowFilteredItemsOnly default True;
    property ItemMRUItemsList: Boolean read FItemMRUItemsList
      write SetItemMRUItemsList default True;
    property ItemMRUItemsListCount: Integer read FItemMRUItemsListCount
      write SetItemMRUItemsListCount
      default cxGridFilterDefaultItemMRUItemsListCount;
    property ItemPopup: TcxGridItemFilterPopupOptions read FItemPopup
      write SetItemPopup;
    property ItemPopupMode: TdxFilterPopupWindowMode read FItemPopupMode
      write SetItemPopupMode default fpmDefault;
    ...
    property DropDownWidth: Integer read GetItemPopupDropDownWidth
      write SetItemPopupDropDownWidth;
    // obsolete - use ItemPopup.MaxDropDownItemCount
    property MaxDropDownCount: Integer read GetItemPopupMaxDropDownItemCount
      write SetItemPopupMaxDropDownItemCount;
  public
    constructor Create(AGridView: TcxCustomGridView); override;
    destructor Destroy; override;
    ...
    property CustomizeDialog: Boolean read GetCustomizeDialog
  ...
  published
    property ExpressionEditing: Boolean read GetExpressionEditing
      write SetExpressionEditing default False;
    property MRUItemsList: Boolean read FMRUItemsList write SetMRUItemsList
      default True;
    property MRUItemsListCount: Integer read FMRUItemsListCount
      write SetMRUItemsListCount default cxGridFilterDefaultMRUItemsListCount;
  end;
  ...
  strict private
    ...
    procedure SetVisible(Value: Boolean);
  protected
    function GetNavigatorButtonsClass
      : TcxGridViewNavigatorButtonsClass; virtual;
  public
    constructor Create(AGridView: TcxCustomGridView); override;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    ...
    property GridView: TcxCustomGridTableView read GetGridView;
  published
    property Buttons: TcxGridViewNavigatorButtons read FButtons
      write SetButtons;
    property InfoPanel: TcxGridViewNavigatorInfoPanel read FInfoPanel
      write SetInfoPanel;
  ...
  protected
    property BestFit: TcxGridShowLockedStateImageMode read FBestFit
      write FBestFit default lsimPending;
    property Filtering: TcxGridShowLockedStateImageMode read FFiltering
      write FFiltering default lsimPending;
    property Grouping: TcxGridShowLockedStateImageMode read FGrouping
      write FGrouping default lsimPending;
    property Sorting: TcxGridShowLockedStateImageMode read FSorting
      write FSorting default lsimPending;
    property Posting: TcxGridShowLockedStateImageMode read FPosting
      write FPosting default lsimNever;
  public
  ...
  private
    ...
    function GetGridView: TcxCustomGridTableView; inline;
    function GetShowLockedStateImageOptions
    ...
    procedure SetShowLockedStateImageOptions
      (Value: TcxCustomGridTableShowLockedStateImageOptions);
  protected
    function GetShowLockedStateImageOptionsClass
      : TcxCustomGridShowLockedStateImageOptionsClass; override;

    property EditAutoHeight: TcxInplaceEditAutoHeight read FEditAutoHeight
      write SetEditAutoHeight default eahNone;
    property FocusCellOnCycle: Boolean read FFocusCellOnCycle
      write SetFocusCellOnCycle default False;
    property RecordScrollMode: TcxRecordScrollMode read FRecordScrollMode
      write SetRecordScrollMode default rsmDefault;
    property ShowLockedStateImageOptions
      : TcxCustomGridTableShowLockedStateImageOptions
      read GetShowLockedStateImageOptions write SetShowLockedStateImageOptions;
    property PullFocusing: Boolean read FPullFocusing write SetPullFocusing
      default False;
    property RepaintVisibleRecordsOnScroll: Boolean
      read FRepaintVisibleRecordsOnScroll write SetRepaintVisibleRecordsOnScroll
      default False;
  public
    constructor Create(AGridView: TcxCustomGridView); override;
    procedure Assign(Source: TPersistent); override;

    property BestFitMaxRecordCount: Integer read FBestFitMaxRecordCount
      write SetBestFitMaxRecordCount default 0;
    property ImmediateEditor: Boolean read FImmediateEditor
      write SetImmediateEditor default True;
    property GridView: TcxCustomGridTableView read GetGridView;
  published
    property AlwaysShowEditor: Boolean read FAlwaysShowEditor
      write SetAlwaysShowEditor default False;
    property CellHints: Boolean read FCellHints write SetCellHints
      default False;
    property CopyCaptionsToClipboard: Boolean read FCopyCaptionsToClipboard
      write SetCopyCaptionsToClipboard default True;
    property CopyRecordsToClipboard: Boolean read FCopyRecordsToClipboard
      write SetCopyRecordsToClipboard default True;
    property DragDropText: Boolean read FDragDropText write SetDragDropText
      default False;
    property DragFocusing: TcxGridDragFocusing read FDragFocusing
      write SetDragFocusing default dfNone;
    property DragHighlighting: Boolean read FDragHighlighting
      write SetDragHighlighting default True;
    property DragOpening: Boolean read FDragOpening write SetDragOpening
      default True;
    property DragScrolling: Boolean read FDragScrolling write SetDragScrolling
      default True;
    property FocusCellOnTab: Boolean read FFocusCellOnTab
      write SetFocusCellOnTab default False;
    ...
    property GoToNextCellOnEnter: Boolean read FGoToNextCellOnEnter
      write SetGoToNextCellOnEnter default False;
    property HintHidePause;
    property IncSearch: Boolean read FIncSearch write SetIncSearch
      default False;
    property IncSearchItem: TcxCustomGridTableItem read FIncSearchItem
      write SetIncSearchItem;
    property NavigatorHints: Boolean read FNavigatorHints
      write SetNavigatorHints default False;
  ...
  TcxCustomGridTableOptionsCustomizeClass = class of
  ...
  private
    ...
    procedure SetItemsQuickCustomizationReordering
      (Value: TcxGridQuickCustomizationReordering);
    procedure SetItemsQuickCustomizationShowCommands(Value: Boolean);
    procedure SetItemsQuickCustomizationSorted(Value: Boolean);
  protected
    property ItemExpressionEditing: Boolean read FItemExpressionEditing
      write FItemExpressionEditing default False;
    property ItemFiltering: Boolean read FItemFiltering write SetItemFiltering
      default True;
    property ItemGrouping: Boolean read FItemGrouping write SetItemGrouping
      default True;
    property ItemHiding: Boolean read FItemHiding write SetItemHiding
      default False;
    property ItemMoving: Boolean read FItemMoving write SetItemMoving
      default True;
    property ItemSorting: Boolean read FItemSorting write SetItemSorting
      default True;
    property ItemsQuickCustomization: Boolean read FItemsQuickCustomization
      write SetItemsQuickCustomization default False;
    property ItemsQuickCustomizationMaxDropDownCount: Integer
      read FItemsQuickCustomizationMaxDropDownCount
      write SetItemsQuickCustomizationMaxDropDownCount default 0;
    property ItemsQuickCustomizationMultiColumnMode: Boolean
      read FItemsQuickCustomizationMultiColumnMode
      write SetItemsQuickCustomizationMultiColumnMode default True;
    property ItemsQuickCustomizationReordering
      : TcxGridQuickCustomizationReordering
      read FItemsQuickCustomizationReordering
      write SetItemsQuickCustomizationReordering default qcrDefault;
    property ItemsQuickCustomizationShowCommands: Boolean
      read FItemsQuickCustomizationShowCommands
      write SetItemsQuickCustomizationShowCommands default True;
    property ItemsQuickCustomizationSorted: Boolean
      read FItemsQuickCustomizationSorted write SetItemsQuickCustomizationSorted
      default False;
  public
    constructor Create(AGridView: TcxCustomGridView); override;
    procedure Assign(Source: TPersistent); override;
  ...
  TcxGridScrollbarAnnotations = class(TdxScrollbarAnnotations)
  // for internal use
  strict private
    FGridView: TcxCustomGridTableView;
  protected
    ...
    function GetRecordIndexByScrollableRecordIndex(AIndex: Integer)
      : Integer; override;
    procedure Populate(AKind: TdxScrollbarAnnotationKind;
      AList: TdxScrollbarAnnotationRowIndexList); override;
    procedure SetCurrentRecordIndex(AIndex: Integer); override;
  public
    constructor Create(AOwner: TcxCustomGridTableView); virtual;
    procedure GetHint(AAnnotationRowIndexLists
      : TdxScrollbarAnnotationRowIndexLists; var AHint: string); override;
    function GetLastIndexInScrollBand(ARecordIndex: Integer): Integer; override;
    function GetRecordPixelScrollPosition(ARecordIndex: Integer)
      : Integer; override;
    function GetScrollableRecordCount: Integer; override;
    function GetScrollableRecordIndexByRecordIndex(AIndex: Integer)
      : Integer; override;
    function IsRecordIndexBasedRendering: Boolean; override;
  end;

  TcxGridScrollbarAnnotationOptionsHelper = class(TdxScrollbarAnnotationOptions)
  // for internal use
  strict private
  ...
  protected
    ...
    procedure RefreshScrollbarAnnotations(AChangedAnnotationKinds
      : TdxScrollbarAnnotationKinds = dxAllScrollbarAnnotationKinds); override;
  public
    constructor Create(AOwner: TcxCustomGridTableView); virtual;
  end;
  ...
  strict private
    ...
    procedure SetCustomScrollbarAnnotations(const Value
  ...
  published
    ...
    property CustomAnnotations: TdxCustomScrollbarAnnotations
      read GetCustomScrollbarAnnotations write SetCustomScrollbarAnnotations;
  ...
  public
    ...
    property GridView: TcxCustomGridTableView read GetGridView;
  published
    property Appending: Boolean read FAppending write SetAppending
      default False;
    property CancelOnExit: Boolean read FCancelOnExit write SetCancelOnExit
      default True;
  ...
  public
    ...
    property HideFocusRect: Boolean read FHideFocusRectOnExit
      write SetHideFocusRectOnExit stored False; // for compatibility
    property HideFocusRectOnExit: Boolean read FHideFocusRectOnExit
      write SetHideFocusRectOnExit default True;
    property HideSelection: Boolean read FHideSelection write SetHideSelection
      default False;
    property InvertSelect: Boolean read FInvertSelect write SetInvertSelect
      default True;
    property UnselectFocusedRecordOnExit: Boolean
      read FUnselectFocusedRecordOnExit write SetUnselectFocusedRecordOnExit
      default True;
  published
    property CellSelect: Boolean read FCellSelect write SetCellSelect
      default True;
  ...
  strict private
    ...
    procedure SetItemFilterButtonShowMode
  ...
  protected
    ...
    property CellAutoHeight: Boolean read FCellAutoHeight
      write SetCellAutoHeight default False;
    property CellTextMaxLineCount: Integer read FCellTextMaxLineCount
      write SetCellTextMaxLineCount default 0;
    property EditAutoHeightBorderColor: TColor read FEditAutoHeightBorderColor
      write SetEditAutoHeightBorderColor default clDefault;
    property ItemCaptionAutoHeight: Boolean read FItemCaptionAutoHeight
      write SetItemCaptionAutoHeight default False;
    property ItemFilterButtonShowMode: TcxGridItemFilterButtonShowMode
      read FItemFilterButtonShowMode write SetItemFilterButtonShowMode
      default fbmDefault;
    property ItemCaptionEndEllipsis: Boolean read FItemCaptionEndEllipsis
      write SetItemCaptionEndEllipsis default False;
    property ShowItemFilterButtons: TcxGridShowItemFilterButtons
      read FShowItemFilterButtons write SetShowItemFilterButtons
      default sfbDefault;
  public
    constructor Create(AGridView: TcxCustomGridView); override;
    procedure Assign(Source: TPersistent); override;
    ...
    property GridView: TcxCustomGridTableView read GetGridView;
  published
    property CellEndEllipsis: Boolean read FCellEndEllipsis
      write SetCellEndEllipsis default False;
    property FocusRect: Boolean read FFocusRect write SetFocusRect default True;
    property NavigatorOffset: Integer read FNavigatorOffset
      write SetNavigatorOffset default cxGridNavigatorDefaultOffset;
  ...
  TcxGridDataCellPos = class
    GridRecord: TcxCustomGridRecord;
    Item: TcxCustomGridTableItem;
    constructor Create(AGridRecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem); overload;
  end;
  ...
  private
    ...
    procedure SetOnGetContentStyle(Value: TcxGridGetCellStyleEvent);
  protected
    procedure GetConditionalFormattingContentParams
      (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
  ...
  public
    ...
    procedure GetCellContentParams(ARecord: TcxCustomGridRecord; AItem: TObject;
      out AParams: TcxViewParams); virtual;
    procedure GetContentParams(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem; out AParams: TcxViewParams); virtual;
    procedure GetDataCellContentParams(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem; out AParams: TcxViewParams); virtual;
    procedure GetDataCellParams(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem; out AParams: TcxViewParams;
      AUseViewInfo: Boolean = False;
      ACellViewInfo: TcxGridTableCellViewInfo = nil;
      AIgnoreSelection: Boolean = False); virtual;
    procedure GetRecordContentParams(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem; out AParams: TcxViewParams); virtual;
  ...
  published
    ...
    property ContentEven: TcxStyle index vsContentEven read GetValue
      write SetValue;
    property ContentOdd: TcxStyle index vsContentOdd read GetValue
      write SetValue;
    ...
    property NavigatorInfoPanel: TcxStyle index vsNavigatorInfoPanel
      read GetValue write SetValue;
    property SearchResultHighlight: TcxStyle index vsSearchResultHighlight
      read GetValue write SetValue;
    property UseOddEvenStyles: TdxDefaultBoolean read FUseOddEvenStyles
      write SetUseOddEvenStyles default bDefault;
    property OnGetContentStyle: TcxGridGetCellStyleEvent read FOnGetContentStyle
      write SetOnGetContentStyle;
  end;
  ...
  protected
    ...
    function GetEditProperties(AItem: TObject)
      : TcxCustomEditProperties; override;
  ...
  TcxGridDetailModeConditionalFormattingProvider = class
    (TcxGridConditionalFormattingProvider)
  strict private
    FCustomAreaInfoCache
      : TObjectDictionary<string, TdxSpreadSheetConditionalFormattingAreaInfo>;
  protected
    function CalculateStyle(const AStyle: TdxSpreadSheetCellDisplayStyle;
      ARow: Integer; AColumn: Integer; ACell: IdxSpreadSheetCellData)
      : Boolean; override;
  ...
  TcxGridViewRestoringFilterAttributes = set of
    TcxGridViewRestoringFilterAttribute;
  ...
  TcxGridCustomTableViewEvent = procedure(Sender: TcxCustomGridTableView)
    of object;
  TcxGridEditingEvent = procedure(Sender: TcxCustomGridTableView;
    AItem: TcxCustomGridTableItem; var AAllow: Boolean) of object;
  TcxGridEditDblClickEvent = procedure(Sender: TcxCustomGridTableView;
    AItem: TcxCustomGridTableItem; AEdit: TcxCustomEdit) of object;
  TcxGridEditKeyEvent = procedure(Sender: TcxCustomGridTableView;
  ...
  TcxGridFindPanelVisibilityChangedEvent = procedure
    (Sender: TcxCustomGridTableView; const AVisible: Boolean) of object;
  ...
  TcxGridFocusedRecordChangedEvent = procedure(Sender: TcxCustomGridTableView;
    ...
    ANewItemRecordFocusingChanged: Boolean) of object;
  TcxGridGetCellHeightEvent = procedure(Sender: TcxCustomGridTableView;
    ...
    of object;
  TcxGridPopulateCustomScrollbarAnnotationRowIndexList = procedure
    (Sender: TcxCustomGridTableView; AAnnotationIndex: Integer;
    ARowIndexList: TdxScrollbarAnnotationRowIndexList) of object;
  ...
  TcxGridPartCustomDrawBackgroundEvent = procedure
    (Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
    AViewInfo: TcxCustomGridCellViewInfo; var ADone: Boolean) of object;
  TcxGridRecordEvent = procedure(Sender: TcxCustomGridTableView;
    ARecord: TcxCustomGridRecord) of object;

  TcxGridDataControllerChange = (dccItemAdded, dccItemRemoved,
    dccIndexesChanged);

  TcxCustomGridTableView = class(TcxCustomGridView, IcxFilterControl,
    IcxFilterControlEx, IcxNavigator, IcxNavigatorRecordPosition,
  ...
  private
    ...
    FOnPopulateCustomScrollbarAnnotationRowIndexList
      : TcxGridPopulateCustomScrollbarAnnotationRowIndexList;
    ...
    function GetInternalConditionalFormattingProvider
      : TcxGridConditionalFormattingProvider;
    ...
    procedure SetScrollbarAnnotations
      (AValue: TcxGridScrollbarAnnotationOptions);
    ...
    procedure SetOnCustomDrawCell(Value: TcxGridTableDataCellCustomDrawEvent);
    procedure SetOnCustomDrawPartBackground
      (Value: TcxGridPartCustomDrawBackgroundEvent);
    ...
    procedure SetOnFindPanelVisibilityChanged
      (Value: TcxGridFindPanelVisibilityChangedEvent);
    procedure SetOnFocusedItemChanged(Value: TcxGridFocusedItemChangedEvent);
    procedure SetOnFocusedRecordChanged
      (Value: TcxGridFocusedRecordChangedEvent);
    procedure SetOnGetCellHeight(Value: TcxGridGetCellHeightEvent);
    procedure SetOnPopulateCustomScrollbarAnnotationRowIndexList
      (const Value: TcxGridPopulateCustomScrollbarAnnotationRowIndexList);
    procedure SetOnGetDragDropText(Value: TcxGridGetDragDropTextEvent);
    procedure SetOnGetScrollbarAnnotationHint
      (Value: TcxGridGetScrollbarAnnotationHint);
    procedure SetOnInitFilteringDateRanges(Value: TcxGridInitDateRangesEvent);
    procedure SetOnInitGroupingDateRanges(Value: TcxGridInitDateRangesEvent);
  ...
  protected
    ...
    function GetFilterValueType(Index: Integer)
      : cxDataStorage.TcxValueTypeClass;
    // IcxFilterControlEx
    function IcxFilterControlEx.AllowExpressionEditing =
      AllowFilterExpressionEditing;
    ...
    // IcxDataControllerConditionalFormattingProviderOwner
    function GetConditionalFormattingProvider
      : TcxDataControllerConditionalFormattingProvider; virtual;
    // IcxNavigatorRecordPosition
    function IcxNavigatorRecordPosition.GetRecordCount =
      NavigatorGetRecordCount;
    function IcxNavigatorRecordPosition.GetRecordIndex =
      NavigatorGetRecordIndex;
    ...
    // IcxStoredParent
    function CreateStoredObject(const AObjectName, AClassName: string)
      : TObject; override;
    ...
    property AssigningGroupedItems: TcxGridOpenTableItemList
      read FAssigningGroupedItems;
    property AssigningSortedItems: TcxGridOpenTableItemList
      read FAssigningSortedItems;
    property IsAfterAssigningItems: Boolean read FIsAfterAssigningItems;
    function CanOffset(ARecordCountDelta, APixelScrollRecordOffsetDelta
      : Integer): Boolean; virtual;
    ...
    function FindItemByObjectName(const AObjectName: string)
      : TcxCustomGridTableItem; virtual;
    ...
    procedure GetItemsListForClipboard(AItems: TList;
      ACopyAll: Boolean); virtual;
    function GetItemSortByDisplayText(AItemIndex: Integer;
    ...
    procedure GetScrollbarAnnotationHint(AAnnotationRowIndexLists
      : TdxScrollbarAnnotationRowIndexLists; var AHint: string); virtual;
    ...
    procedure Offset(ARecordCountDelta, APixelScrollRecordOffsetDelta, DX,
      DY: Integer); virtual;
    procedure PopulateScrollbarAnnotations(AKind: TdxScrollbarAnnotationKind;
      AList: TdxScrollbarAnnotationRowIndexList); virtual;
    procedure ChangeScale(M, D: Integer); override;
    procedure RefreshScrollbarAnnotations(AChangedAnnotationKinds
      : TdxScrollbarAnnotationKinds = dxAllScrollbarAnnotationKinds); virtual;
    procedure SetChildOrder(Child: TComponent; Order: Integer); override;
    procedure SetControl(Value: TcxControl); override;
    procedure SetCurrentScrollbarAnnotationRecordIndex
    ...
    function CreateScrollbarAnnotationHelper
      : TcxGridScrollbarAnnotations; virtual;
    function CreateScrollbarAnnotations
      : TcxGridScrollbarAnnotationOptions; virtual;
    ...
    procedure ChangeItemIndex(AItem: TcxCustomGridTableItem;
      Value: Integer); virtual;
    procedure CheckItemVisibles;
    procedure SaveItemVisibles;
    procedure ItemIndexChanged(AItem: TcxCustomGridTableItem;
      AOldIndex: Integer); virtual;
    procedure ItemVisibilityChanged(AItem: TcxCustomGridTableItem;
    ...
    procedure FocusedItemChanged(APrevFocusedItem, AFocusedItem
      : TcxCustomGridTableItem); virtual;
    procedure FocusedRecordChanged(APrevFocusedRecordIndex, AFocusedRecordIndex,
      APrevFocusedDataRecordIndex, AFocusedDataRecordIndex: Integer;
      ANewItemRecordFocusingChanged: Boolean); virtual;
    ...
    function NeedChangeLayoutOnSelectionChanged(AInfo: TcxSelectionChangedInfo)
      : Boolean; virtual;
    ...
    function DrawDataCellSelected(ARecord: TcxCustomGridRecord;
    ...
    procedure DoCustomDrawCell(ACanvas: TcxCanvas;
      AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean); virtual;
    procedure DoCustomDrawPartBackground(ACanvas: TcxCanvas;
      AViewInfo: TcxCustomGridCellViewInfo; var ADone: Boolean); virtual;
    procedure DoEditChanged(AItem: TcxCustomGridTableItem); virtual;
    procedure DoEditDblClick(AItem: TcxCustomGridTableItem;
      AEdit: TcxCustomEdit); virtual;
    procedure DoEditKeyDown(AItem: TcxCustomGridTableItem; AEdit: TcxCustomEdit;
      var Key: Word; Shift: TShiftState); virtual;
    procedure DoEditKeyPress(AItem: TcxCustomGridTableItem;
      AEdit: TcxCustomEdit; var Key: Char); virtual;
    ...
    function DoFilterDialogShow(AItem: TcxCustomGridTableItem)
      : Boolean; virtual;
    procedure DoFocusedRecordChanged(APrevFocusedRecordIndex,
      AFocusedRecordIndex, APrevFocusedDataRecordIndex, AFocusedDataRecordIndex
      : Integer; ANewItemRecordFocusingChanged: Boolean); virtual;
    procedure DoGetCellHeight(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem;
      ACellViewInfo: TcxGridTableDataCellViewInfo;
      var AHeight: Integer); virtual;
    function DoGetDragDropText(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem): string; virtual;
    procedure DoInitEdit(AItem: TcxCustomGridTableItem;
      AEdit: TcxCustomEdit); virtual;
    procedure DoInitEditValue(AItem: TcxCustomGridTableItem;
      AEdit: TcxCustomEdit; var AValue: TcxEditValue); virtual;
    ...
    procedure DoUpdateEdit(AItem: TcxCustomGridTableItem;
      AEdit: TcxCustomEdit); virtual;
    ...
    function CreateConditionalFormattingProvider
      : TcxGridConditionalFormattingProvider; virtual;
    ...
    function GetBackgroundBitmapsClass
      : TcxCustomGridBackgroundBitmapsClass; override;
    function GetDateTimeHandlingClass
      : TcxCustomGridTableDateTimeHandlingClass; virtual;
    ...
    function GetOptionsBehaviorClass
      : TcxCustomGridOptionsBehaviorClass; override;
    function GetOptionsCustomizeClass
      : TcxCustomGridTableOptionsCustomizeClass; virtual;
    function GetOptionsDataClass: TcxCustomGridOptionsDataClass; override;
    function GetOptionsSelectionClass
      : TcxCustomGridOptionsSelectionClass; override;
    ...
    function GetSummaryGroupItemLinkClass
      : TcxDataSummaryGroupItemLinkClass; virtual;
    function GetSummaryItemClass: TcxDataSummaryItemClass; virtual;

    property BackgroundBitmaps: TcxCustomGridTableBackgroundBitmaps
      read GetBackgroundBitmaps write SetBackgroundBitmaps;
    property ConditionalFormattingProvider: TcxGridConditionalFormattingProvider
      read GetInternalConditionalFormattingProvider;
    property DontMakeMasterRecordVisible: Boolean
      read FDontMakeMasterRecordVisible write FDontMakeMasterRecordVisible;
    property FilterableItemCount: Integer read GetFilterableItemCount;
    property FilterableItems[Index: Integer]: TcxCustomGridTableItem
      read GetFilterableItem;
    property FilterBoxTokenCriteria: TdxFilterBoxTokenCriteria
      read GetFilterBoxTokenCriteria;
    property HighlightIncrementalFilteringText: Boolean
      read FHighlightIncrementalFilteringText
      write FHighlightIncrementalFilteringText;
    property IgnorePropertiesChanges: Boolean read FIgnorePropertiesChanges
      write FIgnorePropertiesChanges;
    property ItemsList: TList read FItems;
    property NavigatorNotifier: TcxNavigatorControlNotifier
      read FNavigatorNotifier;
  ...
  public
    ...
    procedure ApplyBestFit(AItem: TcxCustomGridTableItem = nil;
      ACheckSizingAbility: Boolean = False;
      AFireEvents: Boolean = False); virtual;
    ...
    function GoToNextScrollbarAnnotation
      (AKinds: TdxScrollbarAnnotationKinds = dxAllScrollbarAnnotationKinds;
    ...
    property ConditionalFormatting: TcxDataControllerConditionalFormatting
      read GetConditionalFormatting;
    property Controller: TcxCustomGridTableController read GetController;
    property DateTimeHandling: TcxCustomGridTableDateTimeHandling
      read FDateTimeHandling write SetDateTimeHandling;
    property Filtering: TcxCustomGridTableFiltering read FFiltering
      write SetFiltering;
    property GroupedItemCount: Integer read GetGroupedItemCount;
    property GroupedItems[Index: Integer]: TcxCustomGridTableItem
      read GetGroupedItem;
    ...
    property SortedItems[Index: Integer]: TcxCustomGridTableItem
      read GetSortedItem;
    ...
    property VisibleItems[Index: Integer]: TcxCustomGridTableItem
      read GetVisibleItem;
  published
    ...
    property FindPanel: TcxGridFindPanelOptions read FFindPanel
      write SetFindPanel;
    property ScrollbarAnnotations: TcxGridScrollbarAnnotationOptions
      read FScrollbarAnnotations write SetScrollbarAnnotations;

    property NavigatorButtons: TcxNavigatorControlButtons
      read GetNavigatorButtons write SetNavigatorButtons stored False;
    property NavigatorEvents: TNotifyEvent read FSubClassEvents
      write FSubClassEvents;
    property OnCanFocusRecord: TcxGridAllowRecordOperationEvent
      read FOnCanFocusRecord write SetOnCanFocusRecord;
    property OnCanSelectRecord: TcxGridAllowRecordOperationEvent
      read FOnCanSelectRecord write SetOnCanSelectRecord;
    property OnCellClick: TcxGridCellClickEvent read FOnCellClick
      write SetOnCellClick;
    property OnCellDblClick: TcxGridCellClickEvent read FOnCellDblClick
      write SetOnCellDblClick;
    property OnCustomDrawCell: TcxGridTableDataCellCustomDrawEvent
      read FOnCustomDrawCell write SetOnCustomDrawCell;
    ...
    property OnEditChanged: TcxGridCustomTableItemEvent read FOnEditChanged
      write SetOnEditChanged;
    property OnEditDblClick: TcxGridEditDblClickEvent read FOnEditDblClick
      write SetOnEditDblClick;
    property OnEditKeyDown: TcxGridEditKeyEvent read FOnEditKeyDown
      write SetOnEditKeyDown;
    property OnEditKeyPress: TcxGridEditKeyPressEvent read FOnEditKeyPress
      write SetOnEditKeyPress;
    property OnEditKeyUp: TcxGridEditKeyEvent read FOnEditKeyUp
      write SetOnEditKeyUp;
    property OnEditValueChanged: TcxGridCustomTableItemEvent
      read FOnEditValueChanged write SetOnEditValueChanged;
    property OnFilterControlDialogShow: TNotifyEvent
      read FOnFilterControlDialogShow write SetOnFilterControlDialogShow;
    property OnFilterCustomization: TcxGridFilterCustomizationEvent
      read FOnFilterCustomization write SetOnFilterCustomization;
    property OnFilterDialogShow: TcxGridFilterDialogShowEvent
      read FOnFilterDialogShow write SetOnFilterDialogShow;
    property OnFindPanelVisibilityChanged
      : TcxGridFindPanelVisibilityChangedEvent
      read FOnFindPanelVisibilityChanged write SetOnFindPanelVisibilityChanged;
    property OnFocusedItemChanged: TcxGridFocusedItemChangedEvent
      read FOnFocusedItemChanged write SetOnFocusedItemChanged;
    property OnFocusedRecordChanged: TcxGridFocusedRecordChangedEvent
      read FOnFocusedRecordChanged write SetOnFocusedRecordChanged;
    property OnGetCellHeight: TcxGridGetCellHeightEvent read FOnGetCellHeight
      write SetOnGetCellHeight;
    property OnPopulateCustomScrollbarAnnotationRowIndexList
      : TcxGridPopulateCustomScrollbarAnnotationRowIndexList
      read FOnPopulateCustomScrollbarAnnotationRowIndexList
      write SetOnPopulateCustomScrollbarAnnotationRowIndexList;
    property OnGetDragDropText: TcxGridGetDragDropTextEvent
      read FOnGetDragDropText write SetOnGetDragDropText;
    property OnGetScrollbarAnnotationHint: TcxGridGetScrollbarAnnotationHint
      read FOnGetScrollbarAnnotationHint write SetOnGetScrollbarAnnotationHint;
    property OnInitEdit: TcxGridInitEditEvent read FOnInitEdit
      write SetOnInitEdit;
    property OnInitEditValue: TcxGridInitEditValueEvent read FOnInitEditValue
      write SetOnInitEditValue;
    property OnInitFilteringDateRanges: TcxGridInitDateRangesEvent
      read FOnInitFilteringDateRanges write SetOnInitFilteringDateRanges;
    property OnInitStoredObject;
    property OnSelectionChanged: TcxGridCustomTableViewEvent
      read FOnSelectionChanged write SetOnSelectionChanged;
    property OnTopRecordIndexChanged: TNotifyEvent read FOnTopRecordIndexChanged
      write SetOnTopRecordIndexChanged;
    property OnUpdateEdit: TcxGridInitEditEvent read FOnUpdateEdit
      write SetOnUpdateEdit;
  end;
  ...
  public
    class function CanFilter(AInstance: TcxCustomGridTableItem;
      AVisually: Boolean): Boolean; static;
    ...
    class function CanHorzSize(AInstance: TcxCustomGridTableItem)
      : Boolean; static;
    ...
    class procedure CheckWidthValue(AInstance: TcxCustomGridTableItem;
      var Value: Integer); static;
    class procedure DoGetDataText(AInstance: TcxCustomGridTableItem;
      ARecordIndex: Integer; var AText: string); static;
    class procedure DoGetDisplayText(AInstance: TcxCustomGridTableItem;
      ARecord: TcxCustomGridRecord; var AText: string); static;
    class function GetGroupIndex(AInstance: TcxCustomGridTableItem)
      : Integer; static;

    class function GetFilterCaption(AInstance: TcxCustomGridTableItem)
      : string; static;
  end;
  ...
  public
    class function GetPullFocusing(AInstance: TcxCustomGridTableOptionsBehavior)
      : Boolean; static;
    class procedure SetPullFocusing(AInstance
      : TcxCustomGridTableOptionsBehavior; Value: Boolean); static;
  end;
  ...
  public
    class function GetCellAutoHeight(AInstance: TcxCustomGridTableOptionsView)
      : Boolean; static;
  end;
  ...
  public
    class function CanSelectRecord(AInstance: TcxCustomGridTableView;
      ARecordIndex: Integer): Boolean; static;
    ...
    class function FindItemByObjectName(AInstance: TcxCustomGridTableView;
      const AObjectName: string): TcxCustomGridTableItem; static;
    class procedure FocusEdit(AInstance: TcxCustomGridTableView;
      AItemIndex: Integer; var ADone: Boolean); static;
    class procedure FocusDataControl(AInstance: TcxCustomGridTableView;
      AItemIndex: Integer; var ADone: Boolean); static;
    class function GetDefaultActiveDetailIndex
      (AInstance: TcxCustomGridTableView): Integer; static;
    class function GetItemClass(AInstance: TcxCustomGridTableView)
      : TcxCustomGridTableItemClass; static;
    class function GetItemSortByDisplayText(AInstance: TcxCustomGridTableView;
      AItemIndex: Integer; ASortByDisplayText: Boolean): Boolean; static;
    class function GetItemValueSource(AInstance: TcxCustomGridTableView;
      AItemIndex: Integer): TcxDataEditValueSource; static;
    class function GetSummaryGroupItemLinkClass
      (AInstance: TcxCustomGridTableView)
      : TcxDataSummaryGroupItemLinkClass; static;
    class function GetSummaryItemClass(AInstance: TcxCustomGridTableView)
      : TcxDataSummaryItemClass; static;
    class function IsEqualHeightRecords(AInstance: TcxCustomGridTableView)
      : Boolean; static;
    class function IsGetCellHeightAssigned(AInstance: TcxCustomGridTableView)
      : Boolean; static;
    class procedure ItemValueTypeClassChanged(AInstance: TcxCustomGridTableView;
      AItemIndex: Integer); static;
    class procedure RefreshNavigators(AInstance
      : TcxCustomGridTableView); static;
    class procedure UpdateRecord(AInstance: TcxCustomGridTableView); static;
    class procedure BeginLockedStatePaintOnPost
      (AInstance: TcxCustomGridTableView); static;
    class procedure EndLockedStatePaint(AInstance
      : TcxCustomGridTableView); static;
  end;
  ...
  public
    class function GetDefaultGridModeBufferCount
      (AInstance: TcxCustomGridTableViewInfo): Integer; static;
  end;
...
type
  ...
  TcxDataControllerConditionalFormattingAccess = class
    (TcxDataControllerConditionalFormatting);
  TdxCustomCheckListBoxAccess = class(TdxCustomCheckListBox);
  TdxQuickCustomizationCustomControlAccess = class
    (TdxQuickCustomizationCustomControl);
...
begin
  Result := AOwner.VisibleItems[AItemIndex].CanFocus
    (TcxCustomGridRecord(AData));
end;

function cxCustomGridTableControllerCanFocusRecord
  (AOwner: TcxCustomGridTableView; AItemIndex: Integer; AData: TObject)
  : Boolean;
begin
  Result := AOwner.ViewData.Records[AItemIndex].CanFocus;
end;

function cxCustomGridTableViewGetItem(ACaller: TComponent; Index: Integer)
  : TComponent;
begin
...
function TcxCustomGridTableViewData.GetInternalRecord(Index: Integer)
  : TcxCustomGridRecord;
begin
  Result := TcxCustomGridRecord(FRecords[Index]);
end;

function TcxCustomGridTableViewData.GetRecord(Index: Integer)
  : TcxCustomGridRecord;
begin
...
function TcxCustomGridTableViewData.CreateRecord(AIndex: Integer)
  : TcxCustomGridRecord;
var
...
function TcxCustomGridTableViewData.GetFilterValueListClass
  : TcxGridFilterValueListClass;
begin
  Result := TcxGridFilterValueList;
end;

function TcxCustomGridTableViewData.GetRecordByKind(AKind, AIndex: Integer)
  : TcxCustomGridRecord;
begin
  case AKind of
    rkNormal:
...
function TcxCustomGridTableViewData.GetRecordKind
...
function TcxCustomGridTableViewData.GetNewItemRecordClass
...
function TcxCustomGridTableViewData.GetRecordByIndex(AIndex: Integer)
  : TcxCustomGridRecord;
begin
  if (0 <= AIndex) and (AIndex < RecordCount) then
    Result := Records[AIndex]
...
function TcxCustomGridTableViewData.GetRecordByRecordIndex
  ...
  begin
    ...
    begin
      ...
      if (Result <> nil) and Result.IsData and
        (Result.RecordIndex = ARecordIndex) then
        Exit;
    end;
    Result := nil;
  end;
...
var
  AIndex: Integer;
begin
  if HasNewItemRecord and (ARecordIndex = DataController.NewItemRecordIndex)
  then
    Result := FNewItemRecord
  else if (0 <= ARecordIndex) and (ARecordIndex < DataController.RecordCount)
  then
...
function TcxCustomGridTableViewData.GetRecordIndexByRecord
  (ARecord: TcxCustomGridRecord): Integer;
begin
  if ARecord = nil then
...
function TcxCustomGridTableViewData.IsRecordIndexValid(AIndex: Integer)
  : Boolean;
begin
...
function TcxCustomGridTableViewData.AddItemToFilter
  (AParent: TcxFilterCriteriaItemList; AItem: TcxCustomGridTableItem;
  AOperatorKind: TcxFilterOperatorKind; const AValue: Variant;
  ADisplayText: string; AReplaceExistent: Boolean): TcxFilterCriteriaItem;
begin
  ...
  Result := DataController.Filter.AddItem(AParent, AItem, AOperatorKind, AValue,
    ADisplayText);
end;

function TcxCustomGridTableViewData.CreateFilterValueList
  : TcxGridFilterValueList;
begin
  Result := GetFilterValueListClass.Create(DataController.Filter);
end;

function TcxCustomGridTableViewData.GetDisplayText(ARecordIndex,
  AItemIndex: Integer; out AText: string; AUseCustomValue: Boolean = False;
  ACustomValueOperation: TcxGridDataOperation = doGrouping): Boolean;
var
  AValue: Variant;
  AItem: TcxCustomGridTableItem;
...
begin
  ...
  Result := AUseCustomValue or (AProperties.GetEditValueSource(False)
    = evsValue) or (AProperties.GetEditValueSource(False) = evsText) and
    AProperties.IsValueFormattedByProperties;
  if not Result then
    Exit;
  if AUseCustomValue or (AProperties.GetEditValueSource(False) = evsValue) then
    ...
    AValue := TcxDataControllerAccess(DataController).GetInternalDisplayText
      (ARecordIndex, AItemIndex);
  AText := GetDisplayTextFromValue(AItem, AProperties, AValue, AUseCustomValue,
    ACustomValueOperation);
end;

function TcxCustomGridTableViewData.GetDisplayTextFromValue
  (AItem: TcxCustomGridTableItem; AProperties: TcxCustomEditProperties;
  const AValue: Variant; AUseCustomValue: Boolean = False;
...
function TcxCustomGridTableViewData.GetDisplayTextFromValue(ARecordIndex,
  AItemIndex: Integer; const AValue: Variant; AUseCustomValue: Boolean = False;
  ACustomValueOperation: TcxGridDataOperation = doGrouping): string;
var
  AItem: TcxCustomGridTableItem;
  AProperties: TcxCustomEditProperties;
begin
  AItem := GridView.Items[AItemIndex];
  AProperties := AItem.GetProperties(ARecordIndex);
  Result := GetDisplayTextFromValue(AItem, AProperties, AValue, AUseCustomValue,
    ACustomValueOperation);
end;

function TcxCustomGridTableViewData.CustomCompareDataValues
  (AField: TcxCustomDataField; const AValue1, AValue2: Variant;
...
function TcxCustomGridTableViewData.GetCustomDataDisplayText(ARecordIndex,
  AItemIndex: Integer; AOperation: TcxGridDataOperation): string;
begin
  Result := '';
  if AOperation = doGrouping then
    Result := GetCustomDataDisplayText(AItemIndex,
      DataController.Values[ARecordIndex, AItemIndex]);
  if Result = '' then
    GetDisplayText(ARecordIndex, AItemIndex, Result, True, AOperation);
end;

function TcxCustomGridTableViewData.GetCustomDataDisplayText
  (AItemIndex: Integer; const AValue: Variant): string;
var
  ADate: TDateTime;
...
function TcxCustomGridTableViewData.GetCustomDataValue
  (AField: TcxCustomDataField; const AValue: Variant;
  AOperation: TcxGridDataOperation): Variant;
begin
  Result := GetCustomDataValue(TcxCustomGridTableItem(AField.Item), AValue,
    AOperation);
end;

function TcxCustomGridTableViewData.GetCustomDataValue
  (AItem: TcxCustomGridTableItem; const AValue: Variant;
  AOperation: TcxGridDataOperation): Variant;
var
  ADate: TDateTime;
  ADateRange: TcxCustomGridDateRange;
begin
  if VarIsNull(AValue) then
    Result := AValue
  else if AOperation in [doSorting, doGrouping] then
  begin
    ...
    if ADateRange = nil then
      Result := ADate
    else if AOperation = doGrouping then
...
function TcxCustomGridTableViewData.HasCustomDataHandling
  (AField: TcxCustomDataField; AOperation: TcxGridDataOperation): Boolean;
begin
  Result := (AField.Item <> nil) and HasCustomDataHandling
    (TcxCustomGridTableItem(AField.Item), AOperation);
end;

function TcxCustomGridTableViewData.HasCustomDataHandling
  (AItem: TcxCustomGridTableItem; AOperation: TcxGridDataOperation): Boolean;
begin
  Result := (AOperation = doGrouping) and AItem.SupportsGroupingDateRanges
    (False) or (AOperation = doFiltering) and AItem.CanIgnoreTimeForFiltering;
end;

function TcxCustomGridTableViewData.NeedsCustomDataComparison
  (AField: TcxCustomDataField; AMode: TcxDataControllerComparisonMode): Boolean;
var
  AItem: TcxCustomGridTableItem;
  AItemGroupIndex: Integer;
begin
  AItem := TcxCustomGridTableItem(AField.Item);
  Result := (AItem <> nil) and ((AMode = dccmGrouping) or (AMode = dccmSorting))
    and HasCustomDataHandling(AField, doGrouping);
  if Result and (AMode = dccmSorting) then
  begin
    AItemGroupIndex := AItem.GroupIndex;
    Result := (AItemGroupIndex <> -1) and
      ((AItemGroupIndex < GridView.GroupedItemCount - 1) or
      AItem.GroupingDateRanges.NeedSortingByTime);
  end;
end;
...
function TcxGridFilteringDateRanges.GetDateTimeHandling
  : TcxCustomGridTableDateTimeHandling;
begin
...
function TcxGridGroupingDateRanges.GetLastMonthRangeClass
  : TdxCustomDateRangeClass;
begin
  Result := TcxGridLastMonthRange;
end;

function TcxGridGroupingDateRanges.GetLastWeekRangeClass
  : TdxCustomDateRangeClass;
begin
  Result := TcxGridLastWeekRange;
end;

function TcxGridGroupingDateRanges.GetLastYearRangeClass
  : TdxCustomDateRangeClass;
begin
...
function TcxGridGroupingDateRanges.GetNextMonthRangeClass
  : TdxCustomDateRangeClass;
begin
  Result := TcxGridNextMonthRange;
end;

function TcxGridGroupingDateRanges.GetNextWeekRangeClass
  : TdxCustomDateRangeClass;
begin
  Result := TcxGridNextWeekRange;
end;

function TcxGridGroupingDateRanges.GetNextYearRangeClass
  : TdxCustomDateRangeClass;
begin
  Result := TcxGridNextYearRange;
end;

function TcxGridGroupingDateRanges.GetThisMonthRangeClass
  : TdxCustomDateRangeClass;
begin
  Result := TcxGridThisMonthRange;
end;

function TcxGridGroupingDateRanges.GetThisWeekRangeClass
  : TdxCustomDateRangeClass;
begin
  Result := TcxGridThisWeekRange;
end;

function TcxGridGroupingDateRanges.GetThisYearRangeClass
  : TdxCustomDateRangeClass;
begin
...
function TcxGridGroupingDateRanges.GetTomorrowRangeClass
  : TdxCustomDateRangeClass;
begin
...
function TcxGridGroupingDateRanges.GetYesterdayRangeClass
  : TdxCustomDateRangeClass;
begin
  Result := TcxGridYesterdayRange;
end;

function TcxGridGroupingDateRanges.GetDateTimeHandling
  : TcxCustomGridTableDateTimeHandling;
begin
  Result := TcxCustomGridTableDateTimeHandling(inherited DateTimeHandling);
end;
...
procedure TcxCustomGridTableViewStyles.GetConditionalFormattingContentParams
  ...
  var AParams: TcxViewParams);
begin
  if (ARecord <> nil) and (AItem <> nil) and GridView.HasConditionalFormattingProvider
  then
  begin
...
procedure TcxCustomGridTableViewStyles.SetUseOddEvenStyles
  (const AValue: TdxDefaultBoolean);
begin
...
procedure TcxCustomGridTableViewStyles.SetOnGetContentStyle
...
procedure TcxCustomGridTableViewStyles.GetDefaultViewParams(Index: Integer;
  AData: TObject; out AParams: TcxViewParams);
const
  StyleIndexes: array [Boolean] of Integer = (vsContentEven, vsContentOdd);
begin
  inherited;
  if ((Index = vsContentEven) or (Index = vsContentOdd)) and not ActuallyUseOddEvenStyles
  then
    Index := vsContent;
    ...
    case Index of
      vsContent:
        if ActuallyUseOddEvenStyles and (AData is TcxCustomGridRecord) then
          GetDefaultViewParams(StyleIndexes[Odd(TcxCustomGridRecord(AData).
            Index)], AData, AParams)
        else
        begin
...
procedure TcxCustomGridTableViewStyles.GetSelectionParams
...
begin
  ...
  AParams.Bitmap := nil;
  // to use selection color even if [content] bitmap is assigned
end;
...
begin
  ...
  if UseOddEvenStyles = bDefault then
    FActuallyUseOddEvenStyles := (ContentOdd <> nil) or (ContentEven <> nil) or
      (LookAndFeelPainter <> nil) and
      LookAndFeelPainter.GridLikeControlDefaultUseOddEvenStyle
  else
    FActuallyUseOddEvenStyles := UseOddEvenStyles = bTrue;
end;
...
procedure TcxCustomGridTableViewStyles.GetContentParams
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
...
begin
  ...
  if (ARecord <> nil) and ActuallyUseOddEvenStyles and
    (GetValue(StyleIndexes[Odd(ARecord.Index)]) <> nil) then
  begin
    ADataCellPos := TcxGridDataCellPos.Create(ARecord, AItem);
    try
      GetViewParams(StyleIndexes[Odd(ARecord.Index)], ADataCellPos,
        AStyle, AParams);
    finally
      ADataCellPos.Free;
    end;
...
procedure TcxCustomGridTableViewStyles.GetDataCellParams
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
  out AParams: TcxViewParams; AUseViewInfo: Boolean = False;
  ACellViewInfo: TcxGridTableCellViewInfo = nil;
  AIgnoreSelection: Boolean = False);
begin
  if not AIgnoreSelection and (AUseViewInfo and ACellViewInfo.Selected or
    not AUseViewInfo and GridView.DrawDataCellSelected(ARecord, AItem, False,
    nil)) then
  begin
    if (ARecord <> nil) and (AItem <> nil) and GridView.HasConditionalFormattingProvider
    then
...
procedure TcxCustomGridTableViewStyles.GetRecordContentParams
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
  out AParams: TcxViewParams);
begin
...
constructor TcxGridConditionalFormattingProvider.Create
...
begin
  ...
  begin
    for I := 0 to FOwner.CloneCount - 1 do
      TcxCustomGridTableView(FOwner.Clones[I])
        .ConditionalFormattingProvider.ConditionalFormattingChanged;
  end;
end;
...
function TcxGridConditionalFormattingProvider.GetEditProperties(AItem: TObject)
...
function TcxGridConditionalFormattingProvider.GetItemDisplayName
...
function TcxGridConditionalFormattingProvider.IsItemVisible
...
begin
  Result := SysLocale.MiddleEast and (FOwner.Site <> nil) and
    (FOwner.Site.BiDiMode <> bdLeftToRight);
end;

function TcxGridConditionalFormattingProvider.IsRowVisible
...
function TcxGridDetailModeConditionalFormattingProvider.CalculateStyle
  (const AStyle: TdxSpreadSheetCellDisplayStyle; ARow: Integer;
  AColumn: Integer; ACell: IdxSpreadSheetCellData): Boolean;
var
...
procedure TcxGridDetailModeConditionalFormattingProvider.
  SynchronizeMasterClasses;
begin
  FCellStyles := Owner.PatternGridView.ConditionalFormattingProvider.CellStyles;
  FFormulaController := Owner.PatternGridView.ConditionalFormattingProvider.
    FormulaController;
  FConditionalFormatting := Owner.PatternGridView.ConditionalFormattingProvider.
    ConditionalFormatting;
  FFormatSettings := Owner.PatternGridView.ConditionalFormattingProvider.
    FormatSettings;
  FCustomAreaInfoCache :=
    TObjectDictionary<string, TdxSpreadSheetConditionalFormattingAreaInfo>.
    Create([doOwnsValues]);
...
function TcxGridOpenTableItemList.GetItem(Index: Integer)
  : TcxCustomGridTableItem;
begin
  Result := TcxCustomGridTableItem(inherited Items[Index]);
end;

procedure TcxGridOpenTableItemList.SetItem(Index: Integer;
...
function TcxCustomGridTableView.GetBackgroundBitmaps
  : TcxCustomGridTableBackgroundBitmaps;
begin
  Result := TcxCustomGridTableBackgroundBitmaps(inherited BackgroundBitmaps);
end;

function TcxCustomGridTableView.GetConditionalFormatting
  : TcxDataControllerConditionalFormatting;
begin
...
function TcxCustomGridTableView.GetFilterableItem(Index: Integer)
  : TcxCustomGridTableItem;
begin
...
function TcxCustomGridTableView.GetFilterBoxTokenCriteria
...
function TcxCustomGridTableView.GetGroupedItem(Index: Integer)
  : TcxCustomGridTableItem;
begin
...
begin
  if MasterGridRecordIndex = -1 then
    Result := nil
  else if (MasterGridView as TcxCustomGridTableView).ViewData.IsRecordIndexValid
    (MasterGridRecordIndex) then
    Result := TcxCustomGridTableView(MasterGridView).ViewData.Records
      [MasterGridRecordIndex]
  else
    Result := nil;
end;
...
function TcxCustomGridTableView.GetOptionsBehavior
...
function TcxCustomGridTableView.GetOptionsSelection
...
function TcxCustomGridTableView.GetSortedItem(Index: Integer)
  : TcxCustomGridTableItem;
begin
...
function TcxCustomGridTableView.GetVisibleItem(Index: Integer)
  : TcxCustomGridTableItem;
begin
...
procedure TcxCustomGridTableView.SetBackgroundBitmaps
  (Value: TcxCustomGridTableBackgroundBitmaps);
begin
  inherited BackgroundBitmaps := Value;
end;

procedure TcxCustomGridTableView.SetDateTimeHandling
...
procedure TcxCustomGridTableView.SetFiltering
  (Value: TcxCustomGridTableFiltering);
begin
...
procedure TcxCustomGridTableView.SetItem(Index: Integer;
  Value: TcxCustomGridTableItem);
begin
...
procedure TcxCustomGridTableView.SetNavigatorButtons
  (Value: TcxNavigatorControlButtons);
begin
  FNavigator.Buttons.Assign(Value);
end;

procedure TcxCustomGridTableView.SetScrollbarAnnotations
  (AValue: TcxGridScrollbarAnnotationOptions);
begin
  FScrollbarAnnotations.Assign(AValue);
end;

procedure TcxCustomGridTableView.SetOnCanFocusRecord
  (Value: TcxGridAllowRecordOperationEvent);
begin
...
procedure TcxCustomGridTableView.SetOnCanSelectRecord
  (Value: TcxGridAllowRecordOperationEvent);
begin
...
procedure TcxCustomGridTableView.SetOnCellDblClick
  (Value: TcxGridCellClickEvent);
begin
...
procedure TcxCustomGridTableView.SetOnCustomDrawCell
  (Value: TcxGridTableDataCellCustomDrawEvent);
begin
...
procedure TcxCustomGridTableView.SetOnCustomDrawPartBackground
  (Value: TcxGridPartCustomDrawBackgroundEvent);
begin
...
procedure TcxCustomGridTableView.SetOnEditChanged
  (Value: TcxGridCustomTableItemEvent);
begin
...
procedure TcxCustomGridTableView.SetOnEditDblClick
  (Value: TcxGridEditDblClickEvent);
begin
...
procedure TcxCustomGridTableView.SetOnEditKeyPress
  (Value: TcxGridEditKeyPressEvent);
begin
...
procedure TcxCustomGridTableView.SetOnEditValueChanged
  (Value: TcxGridCustomTableItemEvent);
begin
...
procedure TcxCustomGridTableView.SetOnFilterControlDialogShow
  (Value: TNotifyEvent);
begin
...
procedure TcxCustomGridTableView.SetOnFilterCustomization
  (Value: TcxGridFilterCustomizationEvent);
begin
...
procedure TcxCustomGridTableView.SetOnFilterDialogShow
  (Value: TcxGridFilterDialogShowEvent);
begin
...
procedure TcxCustomGridTableView.SetOnFindPanelVisibilityChanged
  (Value: TcxGridFindPanelVisibilityChangedEvent);
begin
  if not dxSameMethods(FOnFilterDialogShow, Value) then
  begin
...
procedure TcxCustomGridTableView.SetOnFocusedItemChanged
  (Value: TcxGridFocusedItemChangedEvent);
begin
...
procedure TcxCustomGridTableView.SetOnFocusedRecordChanged
  (Value: TcxGridFocusedRecordChangedEvent);
begin
...
procedure TcxCustomGridTableView.SetOnGetCellHeight
  (Value: TcxGridGetCellHeightEvent);
begin
...
procedure TcxCustomGridTableView.
  SetOnPopulateCustomScrollbarAnnotationRowIndexList
  (const Value: TcxGridPopulateCustomScrollbarAnnotationRowIndexList);
begin
  if not dxSameMethods(FOnPopulateCustomScrollbarAnnotationRowIndexList, Value)
  then
  begin
...
procedure TcxCustomGridTableView.SetOnGetDragDropText
  (Value: TcxGridGetDragDropTextEvent);
begin
...
procedure TcxCustomGridTableView.SetOnGetScrollbarAnnotationHint
  (Value: TcxGridGetScrollbarAnnotationHint);
begin
...
procedure TcxCustomGridTableView.SetOnInitFilteringDateRanges
  (Value: TcxGridInitDateRangesEvent);
begin
...
procedure TcxCustomGridTableView.SetOnInitGroupingDateRanges
  (Value: TcxGridInitDateRangesEvent);
begin
...
procedure TcxCustomGridTableView.SetOnInitEditValue
  (Value: TcxGridInitEditValueEvent);
begin
...
procedure TcxCustomGridTableView.SetOnSelectionChanged
  (Value: TcxGridCustomTableViewEvent);
begin
...
procedure TcxCustomGridTableView.SetOnTopRecordIndexChanged
  (Value: TNotifyEvent);
begin
...
procedure TcxCustomGridTableView.SetOptionsBehavior
  (Value: TcxCustomGridTableOptionsBehavior);
begin
  inherited OptionsBehavior := Value;
end;

procedure TcxCustomGridTableView.SetOptionsCustomize
  (Value: TcxCustomGridTableOptionsCustomize);
begin
  FOptionsCustomize.Assign(Value);
end;

procedure TcxCustomGridTableView.SetOptionsData
  (Value: TcxCustomGridTableOptionsData);
begin
  inherited OptionsData := Value;
end;

procedure TcxCustomGridTableView.SetOptionsSelection
  (Value: TcxCustomGridTableOptionsSelection);
begin
  inherited OptionsSelection := Value;
end;

procedure TcxCustomGridTableView.SetOptionsView
  (Value: TcxCustomGridTableOptionsView);
begin
...
procedure TcxCustomGridTableView.CopyForEachRowProc(ARowIndex: Integer;
  ARowInfo: TcxRowInfo);
var
  I, AIndex: Integer;
begin
...
begin
  Result := (FConditionalFormattingProvider <> nil) or
    ((PatternGridView <> Self) and
    PatternGridView.HasConditionalFormattingProvider);
end;

procedure TcxCustomGridTableView.
  InvalidateRecordPixelScrollSizeDependendScrollbarAnnotations;
begin
  if (FScrollbarAnnotationHelper <> nil) and not FScrollbarAnnotationHelper.IsRecordIndexBasedRendering
  then
...
function TcxCustomGridTableView.GetFilterProperties(Index: Integer)
  : TcxCustomEditProperties;
begin
  Result := FilterableItems[Index].GetProperties;
end;

function TcxCustomGridTableView.GetFilterValueType(Index: Integer)
  : cxDataStorage.TcxValueTypeClass;
begin
...
function TcxCustomGridTableView.GetExpressionprovider
  : TcxCustomExpressionProvider;
begin
  Result := DataController.ExpressionProvider;
end;

procedure TcxCustomGridTableView.RegisterFilterControl
  (AControl: TcxCustomFilterControl);
begin
  if FLinkedFilterControls.IndexOf(AControl) = -1 then
    FLinkedFilterControls.Add(AControl)
end;

procedure TcxCustomGridTableView.UnregisterFilterControl
  (AControl: TcxCustomFilterControl);
begin
...
begin
  if Supports(TObject(DataController), IcxGridDataController,
    AIcxGridDataController) then
...
function TcxCustomGridTableView.NavigatorGetNotifier
  : TcxNavigatorControlNotifier;
begin
  Result := FNavigatorNotifier;
end;

function TcxCustomGridTableView.NavigatorIsActionSupported
...
procedure TcxCustomGridTableView.NavigatorCreateNewRecordExecute
  (AtEnd: Boolean);
begin
  Controller.CreateNewRecord(AtEnd);
end;

function TcxCustomGridTableView.GetConditionalFormattingProvider
  : TcxDataControllerConditionalFormattingProvider;
begin
...
procedure TcxCustomGridTableView.GetPropertyValue(const AName: string;
  ...
  begin
    ...
    else if Pos(FilterMRUItemBaseName, AName) = 1 then
    begin
      AIndex := StrToInt(Copy(AName, Length(FilterMRUItemBaseName) + 1,
        MaxInt));
...
begin
  if (gsoUseFilter in StorageOptions) and GetFilter then
    Exit;
  inherited;
end;
...
begin
  if (gsoUseFilter in StorageOptions) and SetFilter then
    Exit;
  inherited;
end;

function TcxCustomGridTableView.CreateStoredObject(const AObjectName,
  ...
  begin
    ...
    else if Pos('DefaultGroupSummaryItem', AObjectName) = 1 then
      Result := DataController.Summary.DefaultGroupSummaryItems.Add
    else if Pos('SummaryGroup', AObjectName) = 1 then
    begin
      ASummaryGroupIndex := GetSummaryGroupIndex;
      if ASummaryGroupIndex >= 0 then
        if Pos('Item', AObjectName) <> 0 then
        begin
          if ASummaryGroupIndex < DataController.Summary.SummaryGroups.Count
          then
            Result := DataController.Summary.SummaryGroups[ASummaryGroupIndex]
              .SummaryItems.Add;
        end
        else if Pos('Link', AObjectName) <> 0 then
        begin
          if ASummaryGroupIndex < DataController.Summary.SummaryGroups.Count
          then
            Result := DataController.Summary.SummaryGroups[ASummaryGroupIndex]
...
begin
  ...
  if AClassName = GetItemClass.ClassName then
    Result := CreateItem
  else if gsoUseSummary in StorageOptions then
      ...
      begin
        ...
        with Items[I].SummaryItems do
          for J := 0 to Count - 1 do
            AChildren.AddObject('SummaryGroup' + IntToStr(I) + '_Item' +
              IntToStr(J), Items[J]);
        with Items[I].Links do
          for J := 0 to Count - 1 do
            AChildren.AddObject('SummaryGroup' + IntToStr(I) + '_Link' +
              IntToStr(J), Items[J]);
      end;
  end;
...
begin
  ...
  if gsoUseSummary in StorageOptions then
    AddSummary;
  AChildren.AddObject('ConditionalFormattingProvider',
    ConditionalFormattingProvider);
end;
...
procedure TcxCustomGridTableView.BeforeEditLayout
    ...
    try
      ...
      begin
        ...
        try
          AStream := TMemoryStream.Create;
          try
            StringToStream(dxVariantToAnsiString(FRestoringFilterMRUItems[I]
              ), AStream);
            AStream.Position := 0;
...
function TcxCustomGridTableView.CanOffset(ARecordCountDelta,
  APixelScrollRecordOffsetDelta: Integer): Boolean;
begin
...
begin
  ...
  else if (APrevVisibleDetailCount = 0) or (AVisibleDetailCount = 0) then
    DataChanged;
end;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        Self.OnPopulateCustomScrollbarAnnotationRowIndexList :=
          OnPopulateCustomScrollbarAnnotationRowIndexList;
...
function TcxCustomGridTableView.FindItemByObjectName(const AObjectName: string)
  : TcxCustomGridTableItem;
begin
...
procedure TcxCustomGridTableView.FocusDataControl(AItemIndex: Integer;
  var ADone: Boolean);
begin
...
procedure TcxCustomGridTableView.FocusEdit(AItemIndex: Integer;
  var ADone: Boolean);
begin
...
procedure TcxCustomGridTableView.GetChildren(Proc: TGetChildProc;
  Root: TComponent);
const
  scxDoesNotMatchPropertyType =
    'The Properties property type of the %s component doesn' +
    ...
    if AItem.Owner = Root then
      try
        ...
        if csAncestor in ComponentState then
          raise Exception.Create(Format(scxDoesNotMatchPropertyType,
            [AItem.Name]))
        else
          raise;
      end;
...
function TcxCustomGridTableView.
  GetCurrentScrollbarAnnotationRecordIndex: Integer;
begin
...
function TcxCustomGridTableView.GetInternalConditionalFormattingProvider
  : TcxGridConditionalFormattingProvider;
begin
...
begin
  Result := inherited GetIsControlFocused or
    Controller.EditingController.IsEditing and
    Controller.EditingController.Edit.IsFocused or
    Controller.HasFilterMRUItemsPopup and
    Controller.FilterMRUItemsPopup.Visible or Controller.HasFilterPopup and
    Controller.FilterPopup.Visible or Controller.HasItemsCustomizationPopup and
    Controller.ItemsCustomizationPopup.Visible or
    Controller.IsFindPanelVisible and Controller.FindPanel.IsEditFocused;
end;

procedure TcxCustomGridTableView.GetItemsListForClipboard(AItems: TList;
  ACopyAll: Boolean);
begin
...
function TcxCustomGridTableView.GetItemValueSource(AItemIndex: Integer)
...
function TcxCustomGridTableView.GetPostingLockedStateMode
...
procedure TcxCustomGridTableView.GetScrollbarAnnotationHint
  (AAnnotationRowIndexLists: TdxScrollbarAnnotationRowIndexLists;
  var AHint: string);
begin
...
function TcxCustomGridTableView.GetScrollbarAnnotationHelper
...
begin
  Result := IsDetail and ((MasterGridView as TcxCustomGridTableView)
    .IsRecordPixelScrolling or (MasterGridView as TcxCustomGridTableView)
    .HasPixelScrollingMaster);
end;
...
function TcxCustomGridTableView.IsDetailVisible
...
begin
  Result := not DataController.IsGridMode and
    ...
    ((OptionsBehavior.RecordScrollMode = rsmDefault) and
    (cxIsTouchModeEnabled or IsScrollAnimationEnabled)));
end;
...
begin
  Result := (LookAndFeel <> nil) and ((LookAndFeel.ScrollMode = scmSmooth) or
    (LookAndFeel.ScrollMode = scmDefault) and
    (cxDefaultLookAndFeelScrollMode = scmSmooth));
end;

function TcxCustomGridTableView.IsScrollbarAnnotationVisible
  (AKind: Integer): Boolean;
begin
  case AKind of
    ...
    dxSearchResultScrollbarAnnotationID:
      Result := not DataController.IsGridMode and
        DataController.FindCriteria.IsActive;
...
procedure TcxCustomGridTableView.Offset(ARecordCountDelta,
  APixelScrollRecordOffsetDelta, DX, DY: Integer);
begin
...
begin
  case AKind of
    ...
    dxErrorScrollbarAnnotationID:
      for I := Controller.FirstScrollRecordIndex to Controller.
        LastScrollRecordIndex do
...
procedure TcxCustomGridTableView.RefreshScrollbarAnnotations
  (AChangedAnnotationKinds: TdxScrollbarAnnotationKinds =
  dxAllScrollbarAnnotationKinds);
begin
  if IsLoading then
    FLoadedChangedScrollbarAnnotationKinds :=
      FLoadedChangedScrollbarAnnotationKinds + AChangedAnnotationKinds
  else if FScrollbarAnnotationHelper <> nil then
    FScrollbarAnnotationHelper.Refresh(AChangedAnnotationKinds);
end;

procedure TcxCustomGridTableView.SetChildOrder(Child: TComponent;
  Order: Integer);
begin
  inherited;
...
procedure TcxCustomGridTableView.SetCurrentScrollbarAnnotationRecordIndex
  (AIndex: Integer);
begin
  Controller.AllowRecordScrollAnimationOnMakeVisible(procedure
    begin
...
begin
  ...
  if AInfo is TcxDataChangedInfo then
    UpdateData(AInfo)
  else if AInfo is TcxLayoutChangedInfo then
    DataLayoutChanged
  else if AInfo is TcxFocusedRecordChangedInfo then
    UpdateFocusedRecord(AInfo)
  else if AInfo is TcxSelectionChangedInfo then
    SelectionChanged(TcxSelectionChangedInfo(AInfo))
  else if AInfo is TcxSearchChangedInfo then
    SearchChanged
  else if AInfo is TcxUpdateRecordInfo then
    RecordChanged(TcxUpdateRecordInfo(AInfo).RecordIndex)
  else if AInfo is TcxGroupingChangingInfo then
    GroupingChanging;
...
procedure TcxCustomGridTableView.UpdateDataController
  (AChange: TcxGridDataControllerChange; AItem: TcxCustomGridTableItem);
begin
...
procedure TcxCustomGridTableView.UpdateFocusedRecord
  (AInfo: TcxUpdateControlInfo);
var
  AChangedInfo: TcxFocusedRecordChangedInfo;
begin
  AChangedInfo := TcxFocusedRecordChangedInfo(AInfo);
  Controller.FocusedRecordChanged(AChangedInfo.PrevFocusedRowIndex,
    AChangedInfo.FocusedRowIndex, AChangedInfo.PrevFocusedRecordIndex,
    AChangedInfo.FocusedRecordIndex, AChangedInfo.NewItemRowFocusingChanged);
end;
...
function TcxCustomGridTableView.CreateFilterBoxTokenCriteria
  : TdxFilterBoxTokenCriteria;
begin
...
function TcxCustomGridTableView.CreateScrollbarAnnotationHelper
  : TcxGridScrollbarAnnotations;
begin
  Result := TcxGridScrollbarAnnotations.Create(Self);
end;

function TcxCustomGridTableView.CreateScrollbarAnnotations
...
procedure TcxCustomGridTableView.ItemVisibilityChanged
  (AItem: TcxCustomGridTableItem; Value: Boolean);
begin
  if Value then
  begin
    RefreshVisibleItemsList;
...
function TcxCustomGridTableView.GetItemDataBindingClass
  : TcxGridItemDataBindingClass;
var
  AIGridDataController: IcxGridDataController;
begin
  if Supports(TObject(DataController), IcxGridDataController,
    AIGridDataController) then
...
function TcxCustomGridTableView.DoCellClick(ACellViewInfo
  : TcxGridTableDataCellViewInfo; AButton: TMouseButton;
...
function TcxCustomGridTableView.DoCellDblClick(ACellViewInfo
  : TcxGridTableDataCellViewInfo; AButton: TMouseButton;
AShift: TShiftState): Boolean;
begin
  Result := False;
...
function TcxCustomGridTableView.DoEditing
...
procedure TcxCustomGridTableView.DoUnlockNotification
  (AInfo: TcxUpdateControlInfo);
begin
...
procedure TcxCustomGridTableView.FindCriteriaChanged
  (AInfo: TcxFindCriteriaChangedInfo);
begin
  if Controller.IsFindPanelVisible then
    Controller.FindPanel.CriteriaChanged
      (TcxFindCriteriaChangedInfo(AInfo).Changes);
  RefreshScrollbarAnnotations([dxSearchResultScrollbarAnnotationID]);
  LayoutChanged;
end;

procedure TcxCustomGridTableView.FocusedItemChanged(APrevFocusedItem,
  AFocusedItem: TcxCustomGridTableItem);
begin
...
procedure TcxCustomGridTableView.FocusedRecordChanged(APrevFocusedRecordIndex,
  AFocusedRecordIndex, APrevFocusedDataRecordIndex, AFocusedDataRecordIndex
  : Integer; ANewItemRecordFocusingChanged: Boolean);
begin
...
procedure TcxCustomGridTableView.ItemCaptionChanged
  (AItem: TcxCustomGridTableItem);
begin
  DataController.UpdateExpressionItems;
...
procedure TcxCustomGridTableView.SelectionChanged
  (AInfo: TcxSelectionChangedInfo);
var
  I: Integer;
  Var1: TcxCustomGridRecord;
begin
  if NeedChangeLayoutOnSelectionChanged(AInfo) then
    ...
    begin
      Var1 :=
        ViewData.GetRecordByIndex(AInfo.RowIndexes[I]);
      if Var1 <> nil then
        Var1.Invalidate;
    end;
...
function TcxCustomGridTableView.CalculateDataCellSelected
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
AUseViewInfo: Boolean; ACellViewInfo: TcxGridTableCellViewInfo): Boolean;
...
begin
  if not(ARecord.HasCells and ARecord.CanFocusCells) then
    Result := True
  else if OptionsSelection.InvertSelect then
    Result := (AItem = nil) or not AItem.Focused or not GetRecordFocused
  else
    Result := (OptionsSelection.MultiSelect or (AItem <> nil) and
      AItem.Focused and GetRecordFocused) and
      (not(ACellViewInfo is TcxGridTableDataCellViewInfo) or
      not TcxGridTableDataCellViewInfo(ACellViewInfo).Editing);
end;

function TcxCustomGridTableView.DrawDataCellSelected
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
AUseViewInfo: Boolean = False;
ACellViewInfo: TcxGridTableCellViewInfo = nil): Boolean;
  ...
  begin
    if (ACellViewInfo <> nil) and ACellViewInfo.AlwaysSelected then
      ...
      Result := CalculateDataCellSelected(ARecord, AItem, AUseViewInfo,
        ACellViewInfo);
  end;

begin
  Result := ((ACellViewInfo = nil) or ACellViewInfo.CanDrawSelected) and
    (ARecord <> nil) and GetRecordSelected and GetCellSelected and
    DrawSelection;
end;

function TcxCustomGridTableView.DrawRecordActive
  (ARecord: TcxCustomGridRecord): Boolean;
begin
  Result := IsControlFocused or ARecord.DragHighlighted;
end;

function TcxCustomGridTableView.DrawRecordFocused
  (ARecord: TcxCustomGridRecord): Boolean;
begin
  Result := ARecord.Focused and Focused;
end;

function TcxCustomGridTableView.DrawRecordSelected
  (ARecord: TcxCustomGridRecord): Boolean;
begin
...
function TcxCustomGridTableView.DoCanFocusRecord
  (ARecord: TcxCustomGridRecord): Boolean;
begin
  Result := True;
  if Assigned(FOnCanFocusRecord) then
    FOnCanFocusRecord(Self, ARecord, Result);
end;
...
begin
  if Assigned(FOnEditDblClick) then
    FOnEditDblClick(Self, AItem, AEdit);
end;
...
begin
  if Assigned(FOnEditKeyDown) then
    FOnEditKeyDown(Self, AItem, AEdit, Key, Shift);
end;
...
begin
  if Assigned(FOnEditKeyPress) then
    FOnEditKeyPress(Self, AItem, AEdit, Key);
end;
...
begin
  if Assigned(FOnEditKeyUp) then
    FOnEditKeyUp(Self, AItem, AEdit, Key, Shift);
end;

procedure TcxCustomGridTableView.DoEditValueChanged
  (AItem: TcxCustomGridTableItem);
begin
...
function TcxCustomGridTableView.DoFilterDialogShow
  (AItem: TcxCustomGridTableItem): Boolean;
begin
  Result := False;
...
procedure TcxCustomGridTableView.DoInitEdit(AItem: TcxCustomGridTableItem;
AEdit: TcxCustomEdit);
begin
  if Assigned(FOnInitEdit) then
    FOnInitEdit(Self, AItem, AEdit);
end;

procedure TcxCustomGridTableView.DoInitEditValue(AItem: TcxCustomGridTableItem;
AEdit: TcxCustomEdit; var AValue: TcxEditValue);
begin
  if Assigned(FOnInitEditValue) then
    FOnInitEditValue(Self, AItem, AEdit, AValue);
end;

procedure TcxCustomGridTableView.DoInitFilteringDateRanges
  (AItem: TcxCustomGridTableItem);
begin
...
procedure TcxCustomGridTableView.DoInitGroupingDateRanges
  (AItem: TcxCustomGridTableItem);
begin
...
procedure TcxCustomGridTableView.DoUpdateEdit(AItem: TcxCustomGridTableItem;
AEdit: TcxCustomEdit);
begin
  if Assigned(FOnUpdateEdit) then
    FOnUpdateEdit(Self, AItem, AEdit);
end;
...
begin
  Result := DataController.FindCriteria.IsActive and
    FindPanel.HighlightSearchResults;
end;
...
function TcxCustomGridTableView.NeedChangeLayoutOnSelectionChanged
  (AInfo: TcxSelectionChangedInfo): Boolean;
begin
  Result := (AInfo.Count = 0);
end;

procedure TcxCustomGridTableView.Notification(AComponent: TComponent;
Operation: TOperation);
begin
  inherited Notification(AComponent, Operation);
  if not IsDestroying and (Operation = opRemove) and
    (AComponent = Navigator.Buttons.Images) then
    Navigator.Buttons.Images := nil;
end;

procedure TcxCustomGridTableView.NotifySelectionChanged
  (AInfo: TcxSelectionChangedInfo = nil);
begin
...
function TcxCustomGridTableView.CreateConditionalFormattingProvider
  : TcxGridConditionalFormattingProvider;
begin
...
function TcxCustomGridTableView.GetControllerClass
  : TcxCustomGridControllerClass;
begin
...
function TcxCustomGridTableView.GetViewInfoCacheClass
  : TcxCustomGridViewInfoCacheClass;
begin
...
function TcxCustomGridTableView.GetBackgroundBitmapsClass
  : TcxCustomGridBackgroundBitmapsClass;
begin
  Result := TcxCustomGridTableBackgroundBitmaps;
end;

function TcxCustomGridTableView.GetDateTimeHandlingClass
  : TcxCustomGridTableDateTimeHandlingClass;
begin
...
function TcxCustomGridTableView.GetFilteringClass
  : TcxCustomGridTableFilteringClass;
begin
...
function TcxCustomGridTableView.GetOptionsBehaviorClass
  : TcxCustomGridOptionsBehaviorClass;
begin
  Result := TcxCustomGridTableOptionsBehavior;
end;

function TcxCustomGridTableView.GetOptionsCustomizeClass
  : TcxCustomGridTableOptionsCustomizeClass;
begin
  Result := TcxCustomGridTableOptionsCustomize;
end;

function TcxCustomGridTableView.GetOptionsDataClass
  : TcxCustomGridOptionsDataClass;
begin
  Result := TcxCustomGridTableOptionsData;
end;

function TcxCustomGridTableView.GetOptionsSelectionClass
  : TcxCustomGridOptionsSelectionClass;
begin
  Result := TcxCustomGridTableOptionsSelection;
end;

function TcxCustomGridTableView.GetOptionsViewClass
...
procedure TcxCustomGridTableView.ApplyBestFit
  (AItem: TcxCustomGridTableItem = nil; ACheckSizingAbility: Boolean = False;
...
procedure TcxCustomGridTableView.CopyToClipboard(ACopyAll: Boolean);
  ...
  begin
    for I := 0 to FCopyToClipboardItems.Count - 1 do
      FCopyToClipboardStr := FCopyToClipboardStr + TcxCustomGridTableItem
        (FCopyToClipboardItems[I]).GetAlternateCaption + ColumnSeparator;
    if FCopyToClipboardItems.Count <> 0 then
      FCopyToClipboardStr := Copy(FCopyToClipboardStr, 1,
        Length(FCopyToClipboardStr) - Length(ColumnSeparator));
    FCopyToClipboardStr := FCopyToClipboardStr + dxCRLF;
...
begin
  ...
  try
    ...
    if (Length(FCopyToClipboardStr) >= Length(dxCRLF)) and
      (Copy(FCopyToClipboardStr, Length(FCopyToClipboardStr) - Length(dxCRLF) +
      1, Length(dxCRLF)) = dxCRLF) then
      SetLength(FCopyToClipboardStr, Length(FCopyToClipboardStr) -
        Length(dxCRLF));
  finally
...
function TcxCustomGridTableView.FindItemByID(AID: Integer)
  : TcxCustomGridTableItem;
var
  I: Integer;
begin
...
function TcxCustomGridTableView.FindItemByName(const AName: string)
  : TcxCustomGridTableItem;
var
  I: Integer;
begin
...
function TcxCustomGridTableView.FindItemByTag(ATag: TcxTag)
  : TcxCustomGridTableItem;
var
  I: Integer;
begin
...
function TcxCustomGridTableView.IndexOfItem
  (AItem: TcxCustomGridTableItem): Integer;
begin
  Result := FItems.IndexOf(AItem);
end;

function TcxCustomGridTableView.GoToNextScrollbarAnnotation
  (AKinds: TdxScrollbarAnnotationKinds = dxAllScrollbarAnnotationKinds;
AGoForward: Boolean = True; AGoOnCycle: Boolean = False): Boolean;
begin
...
begin
  ShowHourglassCursor;
  GridBeginLockedStatePaint
    (OptionsBehavior.ShowLockedStateImageOptions.BestFit);
end;
...
begin
  ShowHourglassCursor;
  GridBeginLockedStatePaint(OptionsBehavior.ShowLockedStateImageOptions.
    Filtering);
end;
...
function TcxCustomGridTableView.GetSummaryGroupItemLinkClass
  : TcxDataSummaryGroupItemLinkClass;
begin
  Result := nil;
end;
...
begin
  Result := GetGridViewInfo.LookAndFeelPainter.ScaledButtonFocusRect(Canvas,
    ViewInfo.Bounds, ScaleFactor);
end;
...
begin
  ViewInfo.LookAndFeelPainter.DrawScaledCheckButton(Canvas,
    cxRectCenter(ViewInfo.Bounds,
    ViewInfo.LookAndFeelPainter.ScaledCheckButtonSize(ScaleFactor)),
...
begin
  ViewInfo.LookAndFeelPainter.DrawPin(ViewInfo.Canvas, ViewInfo.GetImageBounds,
    ViewInfo.Params.TextColor, ViewInfo.Pinned);
end;
...
function TcxGridPartCustomButtonPainter.GetViewInfo
...
begin
  ViewInfo.LookAndFeelPainter.DrawScaledFilterCloseButton(Canvas,
    ViewInfo.Bounds, ViewInfo.ButtonState, ScaleFactor);
  DrawFocusRect;
end;
...
begin
  ...
  ViewInfo.LookAndFeelPainter.DrawScaledButton(Canvas, ViewInfo.Bounds,
    ViewInfo.Text, ViewInfo.ButtonState, ScaleFactor);
  DrawFocusRect;
end;

{ TcxGridFilterActivateButtonPainter }

function TcxGridFilterActivateButtonPainter.GetViewInfo
...
begin
  ViewInfo.LookAndFeelPainter.DrawScaledFilterDropDownButton(Canvas,
    ViewInfo.Bounds, ViewInfo.ButtonState, False, ScaleFactor);
end;
...
begin
  ViewInfo.LookAndFeelPainter.DrawFindPanel(Canvas, R, ViewInfo.Transparent,
    ViewInfo.Params.Color, ViewInfo.BackgroundBitmap);
end;

procedure TcxGridFindPanelPainter.DrawBorders;
begin
  if ViewInfo.HasBorders then
    ViewInfo.LookAndFeelPainter.DrawFindPanelBorder(Canvas, ViewInfo.Bounds,
      ViewInfo.Borders);
end;
...
begin
  ViewInfo.GridViewInfo.Painter.DrawFocusRect(GetFocusRect,
    ViewInfo.GridView.OptionsSelection.HideFocusRectOnExit);
end;
...
begin
  ...
  try
    ViewInfo.GridViewInfo.LookAndFeelPainter.DrawScaledExpandButton(Canvas,
      ViewInfo.ExpandButtonBounds, ViewInfo.Expanded, ScaleFactor, clDefault,
...
begin
  Result := False;
  // ViewInfo.GridViewInfo.LookAndFeelPainter.DrawExpandButtonFirst; - for speed
end;

procedure TcxCustomGridRecordPainter.DrawFocusRect;
begin
  if ViewInfo.Focused and ViewInfo.HasFocusRect then
    ViewInfo.GridViewInfo.Painter.DrawFocusRect(ViewInfo.FocusRectBounds,
      ViewInfo.HideFocusRectOnExit);
end;
...
begin
  if not ViewInfo.Selected then
    Result := cebsNormal
  else if ViewInfo.GridView.DrawRecordActive(ViewInfo.GridRecord) then
    Result := cebsSelected
  else
    Result := cebsInactive;
end;
...
function TcxCustomGridTablePainter.CanOffset(AItemsOffset, DX,
  DY: Integer): Boolean;
begin
  Result := not GridView.IsDesigning and // because of the DesignSelector
    ...
    (ViewInfo.BackgroundBitmap = nil) and
...
begin
  if not Site.HandleAllocated then
    Exit;
...
procedure TcxCustomGridTablePainter.DrawFocusRect(const R: TRect;
AHideFocusRect: Boolean);
begin
  if ViewInfo.GridView.OptionsView.FocusRect then
    inherited;
end;
...
function TcxCustomGridTableItem.GetCell(Index: Integer)
  : TcxGridTableDataCellViewInfo;
begin
...
procedure TcxCustomGridTableItem.SetDateTimeGrouping
...
procedure TcxCustomGridTableItem.SetHeaderAlignmentVert
...
procedure TcxCustomGridTableItem.SetOnCustomDrawCell
  (Value: TcxGridTableDataCellCustomDrawEvent);
begin
  if not dxSameMethods(FOnCustomDrawCell, Value) then
  begin
...
procedure TcxCustomGridTableItem.SetOnGetCellHint
  (Value: TcxGridGetCellHintEvent);
begin
...
procedure TcxCustomGridTableItem.SetOnGetDataText
  (Value: TcxGridGetDataTextEvent);
begin
...
procedure TcxCustomGridTableItem.SetOnGetDisplayText
  (Value: TcxGridGetDisplayTextEvent);
begin
...
procedure TcxCustomGridTableItem.SetOnGetFilterDisplayText
  (Value: TcxGridGetFilterDisplayTextEvent);
begin
...
procedure TcxCustomGridTableItem.SetOnGetFilterValues
  (Value: TcxGridGetFilterValuesEvent);
begin
...
procedure TcxCustomGridTableItem.SetOnGetProperties
  (Value: TcxGridGetPropertiesEvent);
begin
...
procedure TcxCustomGridTableItem.SetOnGetPropertiesForEdit
  (Value: TcxGridGetPropertiesEvent);
begin
...
procedure TcxCustomGridTableItem.SetOnGetStoredProperties
  (Value: TcxGridTableItemGetStoredPropertiesEvent);
begin
...
procedure TcxCustomGridTableItem.SetOnGetStoredPropertyValue
  (Value: TcxGridTableItemGetStoredPropertyValueEvent);
begin
...
procedure TcxCustomGridTableItem.SetOnInitFilteringDateRanges
  (Value: TcxGridInitDateRangesEvent);
begin
  if not dxSameMethods(FOnInitFilteringDateRanges, Value) then
  begin
...
procedure TcxCustomGridTableItem.SetOnInitGroupingDateRanges
  (Value: TcxGridInitDateRangesEvent);
begin
  if not dxSameMethods(FOnInitGroupingDateRanges, Value) then
  begin
...
procedure TcxCustomGridTableItem.SetOnSetStoredPropertyValue
  (Value: TcxGridTableItemSetStoredPropertyValueEvent);
begin
...
procedure TcxCustomGridTableItem.SetOnUserFiltering
  (Value: TcxGridUserFilteringEvent);
begin
...
procedure TcxCustomGridTableItem.SetOnUserFilteringEx
  (Value: TcxGridUserFilteringExEvent);
begin
...
procedure TcxCustomGridTableItem.SetOnValidateDrawValue
  (Value: TcxGridValidateDrawValueEvent);
begin
...
procedure TcxCustomGridTableItem.SetOptions
  (Value: TcxCustomGridTableItemOptions);
begin
...
procedure TcxCustomGridTableItem.SetPropertiesClass
...
procedure TcxCustomGridTableItem.SetRepositoryItem
...
function TcxCustomGridTableItem.GetDataBindingClass
  : TcxGridItemDataBindingClass;
begin
...
begin
  ...
  Filer.DefineProperty('IsCaptionAssigned', ReadIsCaptionAssigned,
    WriteIsCaptionAssigned, IsCaptionAssigned and (Caption = ''));
end;
...
procedure TcxCustomGridTableItem.RepositoryItemPropertiesChanged
...
function TcxCustomGridTableItem.GetStoredProperties
...
procedure TcxCustomGridTableItem.GetPropertyValue(const AName: string;
var AValue: Variant);
begin
  if AName = 'AlignmentHorz' then
    ...
    AValue := Index
  else if AName = 'Visible' then
    AValue := Visible
  else if AName = 'SortOrder' then
    AValue := Variant(SortOrder)
  else if AName = 'SortIndex' then
    AValue := SortIndex
  else if AName = 'WasVisibleBeforeGrouping' then
    AValue := WasVisibleBeforeGrouping
  else if AName = 'Expression' then
    AValue := DataBinding.StoredExpression
  else if Assigned(FOnGetStoredPropertyValue) then
    FOnGetStoredPropertyValue(Self, AName, AValue);
end;

procedure TcxCustomGridTableItem.SetPropertyValue(const AName: string;
const AValue: Variant);
begin
  if AName = 'AlignmentHorz' then
  ...
  else if Assigned(FOnSetStoredPropertyValue) then
...
procedure TcxCustomGridTableItem.GetFilterActiveValueIndexes
  (AValues: TcxFilterValueList; var AIndexes: TdxIntegerIndexes);
var
...
function TcxCustomGridTableItem.GetFilterSelectedValueIndex
  (AValues: TcxFilterValueList): Integer;
begin
...
procedure TcxCustomGridTableItem.PopulateFilterValues
  (AValues: TcxFilterValueList; ADisplayValues: TStrings; AValuesOnly: Boolean;
AUniqueOnly: Boolean);
var
  AValueList: TcxGridFilterValueList absolute AValues;
begin
  DataBinding.GetFilterStrings(ADisplayValues, AValueList, AValuesOnly,
    AUniqueOnly);
end;

procedure TcxCustomGridTableItem.SetFilterActiveValueIndex
  (AValues: TcxFilterValueList; AIndex: Integer;
AFilterList: TcxFilterCriteriaItemList;
AReplaceExistent, AAddToMRUItemsList: Boolean);
var
  AValueList: TcxGridFilterValueList absolute AValues;
begin
  DataBinding.SetFilterActiveValueIndex(AValueList, AIndex, AFilterList,
    AReplaceExistent, AAddToMRUItemsList);
end;

procedure TcxCustomGridTableItem.SetFilterActiveValueIndexes
  (AValues: TcxFilterValueList; const AIndexes: TdxIntegerIndexes;
AAddToMRUItemsList: Boolean = False);
var
  AValueList: TcxGridFilterValueList absolute AValues;
begin
  DataBinding.SetFilterActiveValueIndexes(AValueList, AIndexes,
    AAddToMRUItemsList);
end;
...
procedure TcxCustomGridTableItem.SetFilterActiveValue(AOperatorKind
  : TcxFilterOperatorKind; const AValue: Variant; const ADisplayText: string);
begin
  DataBinding.SetFilterActiveValue(AOperatorKind, AValue, ADisplayText);
end;

procedure TcxCustomGridTableItem.SetFilterActiveValues
  (AValueInfos: TdxFastObjectList; ABoolOperator: TcxFilterBoolOperatorKind);
begin
...
function TcxCustomGridTableItem.GetDateTimeHandlingGrouping
  : TdxDateTimeGrouping;
begin
...
function TcxCustomGridTableItem.GetFilteringDateRangesClass
  : TcxGridFilteringDateRangesClass;
begin
  Result := TcxGridFilteringDateRanges;
end;

function TcxCustomGridTableItem.GetGroupingDateRangesClass
  : TcxGridGroupingDateRangesClass;
begin
  Result := TcxGridGroupingDateRanges;
end;

function TcxCustomGridTableItem.GetOptionsClass
  : TcxCustomGridTableItemOptionsClass;
begin
  Result := TcxCustomGridTableItemOptions;
end;

function TcxCustomGridTableItem.GetStylesClass
    ...
    try
      ...
      begin
        ...
        begin
          ...
          AEditViewData.InplaceEditParams.Position.RecordIndex :=
            ARecord.RecordIndex;
          ...
          AWidth := AEditViewData.GetEditContentSize(ACanvas, AValue,
            AEditSizeProperties, AErrorData).cx;
          if GridView.HasConditionalFormattingProvider then
          begin
            APoint := TPoint.Create(Index, ARecord.Index);
            AWidth := GridView.ConditionalFormattingProvider.
              CalculateBestFitWidth(APoint, AWidth);
          end;
...
begin
  Result := CanFocus(Controller.FocusedRecord) and Editable and
    not IsExpression and (FocusedCellViewInfo <> nil) and
    FocusedCellViewInfo.SupportsEditing and
    (dceoShowEdit in DataController.EditOperations);
end;

function TcxCustomGridTableItem.CanFilter(AVisually: Boolean): Boolean;
begin
  Result := (esoFiltering in GetProperties.GetSupportedOperations) and
    FOptions.Filtering and
    (not AVisually or GridView.OptionsCustomize.ItemFiltering and
    FOptions.FilteringPopup);
end;

function TcxCustomGridTableItem.CanFilterUsingChecks: Boolean;
begin
  Result := GridView.Filtering.ItemPopup.MultiSelect and
    FOptions.FilteringPopupMultiSelect;
end;

function TcxCustomGridTableItem.CanFilterMRUValueItems: Boolean;
begin
  Result := GridView.Filtering.ItemMRUItemsList and
    FOptions.FilteringMRUItemsList and not CanFilterUsingChecks;
end;
...
begin
  Result := IsDateTimeValueTypeClass(FDataBinding.ValueTypeClass) and
    GridView.DateTimeHandling.IgnoreTimeForFiltering and
    FOptions.IgnoreTimeForFiltering;
end;
...
begin
  Result := IsDesigning or GridView.OptionsCustomize.ItemMoving and
    Options.Moving;
end;
...
procedure TcxCustomGridTableItem.ChangeGrouping(AGroupIndex: Integer;
AMergeWithLeftColumn: Boolean = False; AMergeWithRightColumn: Boolean = False);
begin
  ...
  try
    if GroupIndex = -1 then
      ...
      else if not GridView.IsAfterAssigningItems then
        FWasVisibleBeforeGrouping := Visible;
    DataController.Groups.ChangeGrouping(Index, AGroupIndex,
      AMergeWithLeftColumn, AMergeWithRightColumn);
  finally
...
begin
  if Value < ActualMinWidth then
    Value := ActualMinWidth;
end;
...
procedure TcxCustomGridTableItem.GetBestFitRecordRange(out AFirstIndex,
  ALastIndex: Integer);
begin
...
begin
  if Controller.FocusedRecord <> nil then
    Result := DataController.GetEditValue(Index,
      EditingProperties.GetEditValueSource(True))
  else
    Result := Unassigned;
end;
...
function TcxCustomGridTableItem.GetFocusedCellViewInfo
  : TcxGridTableDataCellViewInfo;
begin
  with Controller do
...
begin
  ...
  // because of EditViewData - it needs Style which needs GridView
    Result := nil
  else if UseOwnProperties then
    Result := FProperties
  else
  begin
    ARepositoryItem := GetRepositoryItem;
    if ARepositoryItem <> nil then
      Result := cxGetScaledEditProperties(FRepositoryItemTempProperties,
        ARepositoryItem.Properties, GridView.ScaleFactor)
    else
      Result := nil;
  end;
end;
...
procedure TcxCustomGridTableItem.InitProperties(AProperties
  : TcxCustomEditProperties);
begin
  if AProperties <> nil then
  begin
...
function TcxCustomGridTableItem.IsSortingByDisplayText(ASortByDisplayText
  : Boolean): Boolean;
begin
...
function TcxCustomGridTableItem.IsVisibleForFocus
  (ARecord: TcxCustomGridRecord): Boolean;
begin
...
begin
  Result := dxDefaultBooleanToBoolean(VisibleForExpressionEditor,
    IsDefaultVisibleForExpressionEditor);
end;
...
begin
  if GridView.PatternGridView.IgnorePropertiesChanges then
    Exit;
...
begin
  ...
  if not IsDestroying and (FPropertiesValue <> nil) and
    (FPropertiesValue <> APrevPropertiesValue) then
    DataController.SortByDisplayTextChanged;
  // for Options.SortByDisplayText = isbtDefault
end;
...
begin
  if GridView.IsDestroying or not TryResetFocusToNext then
    Controller.FocusedItem := nil;
end;

procedure TcxCustomGridTableItem.SetEditValue(const Value: Variant);
begin
  DataController.SetEditValue(Index, Value,
    EditingProperties.GetEditValueSource(True));
end;
...
begin
  ...
  Result := (FOptions.ShowEditButtons = isebAlways) or
...
function TcxCustomGridTableItem.SupportsGroupingDateRanges(ACheckCustomHandlers
  : Boolean): Boolean;
begin
  Result := IsDateTimeValueTypeClass(FDataBinding.ValueTypeClass) and
...
begin
  Result := Controller.FocusNextItem(VisibleIndex, True, True, False,
    not Controller.IsMultiSelectPersistent)
end;

function TcxCustomGridTableItem.UseFilteredValuesForFilterValueList: Boolean;
begin
  Result := GridView.Filtering.ItemFilteredItemsList and
    FOptions.FilteringFilteredItemsList;
end;
...
begin
  Result := Options.FilteringAddValueItems and
    GridView.Filtering.ItemAddValueItems;
end;

procedure TcxCustomGridTableItem.ValidateEditData(AEditProperties
  : TcxCustomEditProperties);
begin
...
begin
  ...
  if FCellStyleUseCounter = 0 then
    FreeAndNil(FCellStyle);
end;
...
procedure TcxCustomGridTableItem.RemoveCell
  (ACell: TcxGridTableDataCellViewInfo);
begin
  FCells.Remove(ACell);
end;

function TcxCustomGridTableItem.CreateEditViewData
  (AProperties: TcxCustomEditProperties): TcxCustomEditViewData;
begin
  if AProperties <> nil then
  begin
...
procedure TcxCustomGridTableItem.DestroyEditViewData(var AEditViewData
  : TcxCustomEditViewData);
begin
...
procedure TcxCustomGridTableItem.EditViewDataGetDisplayTextHandler
...
function TcxCustomGridTableItem.GetEditViewData(AProperties
  : TcxCustomEditProperties; out AIsLocalCopy: Boolean;
ANeedLocalCopy: Boolean = False): TcxCustomEditViewData;
begin
  AIsLocalCopy := ANeedLocalCopy or HasCustomPropertiesHandler or
    (FEditViewData = nil);
...
procedure TcxCustomGridTableItem.ReleaseEditViewData(var AEditViewData
  : TcxCustomEditViewData; AIsLocalCopy: Boolean);
begin
  if AIsLocalCopy then
    DestroyEditViewData(AEditViewData)
  else
...
begin
  if HasCellHintHandler then
    FOnGetCellHint(Self, ARecord, ACellViewInfo, AMousePos, AHintText,
      AIsHintMultiLine, AHintTextRect);
end;

procedure TcxCustomGridTableItem.DoGetDataText(ARecordIndex: Integer;
var AText: string);
begin
  if HasDataTextHandler then
    FOnGetDataText(Self, ARecordIndex, AText);
end;
...
begin
  if Assigned(FOnGetDisplayText) then
    FOnGetDisplayText(Self, ARecord, AText);
end;

procedure TcxCustomGridTableItem.DoGetFilterValues
...
function TcxCustomGridTableItem.DoGetProperties(ARecord: TcxCustomGridRecord)
  : TcxCustomEditProperties;
begin
  Result := FPropertiesValue;
  if HasCustomPropertiesHandler then
    FOnGetProperties(Self, ARecord, Result);
end;

procedure TcxCustomGridTableItem.DoGetPropertiesForEdit
  (ARecord: TcxCustomGridRecord; var AProperties: TcxCustomEditProperties);
begin
...
procedure TcxCustomGridTableItem.DoUserFiltering(const AValue: Variant;
...
procedure TcxCustomGridTableItem.DoUserFilteringEx
  (AFilterList: TcxFilterCriteriaItemList; const AValue: Variant;
const ADisplayText: string);
begin
...
procedure TcxCustomGridTableItem.DoValidateDrawValue
  (ARecord: TcxCustomGridRecord; const AValue: TcxEditValue;
...
begin
  Result := GridView.HasInitFilteringDateRangesHandler or
...
begin
  Result := GridView.HasInitGroupingDateRangesHandler or
    HasInitGroupingDateRangesHandler;
end;
...
procedure TcxCustomGridTableItem.ApplyBestFit(ACheckSizingAbility
  : Boolean = False; AFireEvents: Boolean = False);
begin
  if GridView.IsPattern or ACheckSizingAbility and not CanHorzSize then
    Exit;
...
begin
  ...
  try
    ...
    AViewData := GetProperties.CreateViewData(AEditStyle, True);
    try
      AViewData.ScaleFactor.Assign(GetScaleFactor);
...
function TcxCustomGridTableItem.GetDefaultValuesProvider
  (AProperties: TcxCustomEditProperties = nil): IcxEditDefaultValuesProvider;
begin
  if FDataBinding = nil then
    Result := nil
  else
...
function TcxCustomGridTableItem.GetProperties(ARecord: TcxCustomGridRecord)
  : TcxCustomEditProperties;
begin
...
function TcxCustomGridTableItem.GetProperties(ARecordIndex: Integer)
  : TcxCustomEditProperties;
var
  ARecord: TcxCustomGridRecord;
begin
...
function TcxCustomGridTableBackgroundBitmaps.GetBitmapStyleIndex
...
procedure TcxGridFilterValueList.AddDateTimeAbsoluteFilters
  (ADateRange: TcxCustomGridDateRange; AIgnoreTime: Boolean);
var
  I: Integer;
  ADateTime: TDateTime;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Add(fviSpecial, ADateRangeValue,
          ADateRange.GetDisplayText(ADateTime), True);
        Inc(I);
      end;
    end;
    Inc(I);
...
begin
  ...
  for I := 0 to AItem.FilteringDateRanges.Count - 1 do
    AddDateTimeAbsoluteFilters(AItem.FilteringDateRanges[I],
      AItem.CanIgnoreTimeForFiltering);
end;

procedure TcxGridFilterValueList.AddDateTimeRelativeFilters
  (AItem: TcxCustomGridTableItem);
var
  ...
  for AFilter := Low(AFilter) to High(AFilter) do
    if AFilter in AFilters then
      case AFilter of
        dtfRelativeDays:
          begin
            Add(fviSpecial, foYesterday,
              cxGetResourceString(@scxGridYesterday), True);
            Add(fviSpecial, foToday, cxGetResourceString(@scxGridToday), True);
            Add(fviSpecial, foTomorrow,
              cxGetResourceString(@scxGridTomorrow), True);
          end;
        dtfRelativeDayPeriods:
          begin
            Add(fviSpecial, foLast30Days,
              cxGetResourceString(@scxGridLast30Days), True);
            Add(fviSpecial, foLast14Days,
              cxGetResourceString(@scxGridLast14Days), True);
            Add(fviSpecial, foLast7Days,
              cxGetResourceString(@scxGridLast7Days), True);
            Add(fviSpecial, foNext7Days,
              cxGetResourceString(@scxGridNext7Days), True);
            Add(fviSpecial, foNext14Days,
              cxGetResourceString(@scxGridNext14Days), True);
            Add(fviSpecial, foNext30Days,
              cxGetResourceString(@scxGridNext30Days), True);
          end;
        dtfRelativeWeeks:
          begin
            Add(fviSpecial, foLastTwoWeeks,
              cxGetResourceString(@scxGridLastTwoWeeks), True);
            Add(fviSpecial, foLastWeek,
              cxGetResourceString(@scxGridLastWeek), True);
            Add(fviSpecial, foThisWeek,
              cxGetResourceString(@scxGridThisWeek), True);
            Add(fviSpecial, foNextWeek,
              cxGetResourceString(@scxGridNextWeek), True);
            Add(fviSpecial, foNextTwoWeeks,
              cxGetResourceString(@scxGridNextTwoWeeks), True);
          end;
        dtfRelativeMonths:
          begin
            Add(fviSpecial, foLastMonth,
              cxGetResourceString(@scxGridLastMonth), True);
            Add(fviSpecial, foThisMonth,
              cxGetResourceString(@scxGridThisMonth), True);
            Add(fviSpecial, foNextMonth,
              cxGetResourceString(@scxGridNextMonth), True);
          end;
        dtfRelativeYears:
          begin
            Add(fviSpecial, foLastYear,
              cxGetResourceString(@scxGridLastYear), True);
            Add(fviSpecial, foThisYear,
              cxGetResourceString(@scxGridThisYear), True);
            Add(fviSpecial, foNextYear,
              cxGetResourceString(@scxGridNextYear), True);
          end;
        dtfPastFuture:
          begin
            Add(fviSpecial, foInPast, cxGetResourceString(@scxGridPast), True);
            Add(fviSpecial, foInFuture,
              cxGetResourceString(@scxGridFuture), True);
          end;
      end;
  (* !!!
...
function TcxGridFilterValueList.IsSpecialOperatorKindSupported
  (AKind: TcxFilterOperatorKind): Boolean;
begin
...
AInitSortByDisplayText: Boolean; AUseFilteredValues: Boolean;
AAddValueItems: Boolean; AUniqueOnly: Boolean;
AFilteredValuesShowFilteredItemsOnly: Boolean);
begin
  inherited Load(AItem.Index, AInitSortByDisplayText, AUseFilteredValues,
    AAddValueItems, AUniqueOnly, AFilteredValuesShowFilteredItemsOnly);
  ...
  begin
    ...
    if dxContainDateTimeAbsoluteFilters(AItem.GetDateTimeHandlingFilters) or
      AItem.HasInitFilteringDateRangesHandlers then
      AddDateTimeAbsoluteFilters(AItem);
  end;
end;

procedure TcxGridFilterValueList.ApplyFilter(AItem: TcxCustomGridTableItem;
AIndex: Integer; AFilterList: TcxFilterCriteriaItemList;
AReplaceExistent, AAddToMRUItemsList: Boolean);

  function GetVarArrayDisplayText(const AValue: Variant): string;
  begin
    Result := AItem.GetProperties.GetDisplayText(AValue[0], True, False) + ';' +
...
begin
  ...
  try
    case AListItem.Kind of
      ...
      fviUserEx:
        AItem.DoUserFilteringEx(AFilterList, AListItem.Value,
          AListItem.DisplayText);
      fviValue, fviMRU:
        begin
          AItem.DataBinding.AddToFilter(AFilterList, foEqual, AListItem.Value,
            AListItem.DisplayText, AReplaceExistent);
          if AAddToMRUItemsList then
            AItem.DataBinding.FilterMRUValueItems.Add(AListItem.Value,
              AListItem.DisplayText);
        end;
      fviSpecial:
        ...
        else if IsSpecialOperatorKindSupported
          (TcxFilterOperatorKind(AListItem.Value)) then
          AItem.DataBinding.AddToFilter(AFilterList,
            TcxFilterOperatorKind(AListItem.Value), Null, '', AReplaceExistent);
    end;
  finally
...
function TcxGridFilterValueList.GetIndexByCriteriaItem(ACriteriaItem
  : TcxFilterCriteriaItem): Integer;
begin
  Result := -1;
  ...
  begin
    ...
    if Result = -1 then
      ...
      else if ACriteriaItem.OperatorKind = foBetween then
...
begin
  Load(AItem, AInitSortByDisplayText, AUseFilteredValues, AAddValueItems,
    True, True);
end;
...
procedure TcxCustomGridTableItemStyles.SetOnGetContentStyle
  (Value: TcxGridGetCellStyleEvent);
begin
  if not dxSameMethods(FOnGetContentStyle, Value) then
  begin
...
procedure TcxCustomGridTableItemStyles.GetDefaultViewParams(Index: Integer;
AData: TObject; out AParams: TcxViewParams);
begin
  if Index = isContent then
    GridView.Styles.GetRecordContentParams(TcxCustomGridRecord(AData),
      Item, AParams)
  else
    inherited;
end;
...
procedure TcxCustomGridTableItemStyles.GetContentParams
...
begin
  ...
  if GridView.HasConditionalFormattingProvider then
    GridView.Styles.GetConditionalFormattingContentParams(ARecord,
      Item, AParams);
end;

{ TcxGridFilterMRUItems }

constructor TcxGridFilterMRUItems.Create(AFiltering
  : TcxCustomGridTableFiltering);
begin
  inherited Create;
...
constructor TcxGridFilterBoxTokenCriteriaOptions.Create
...
function TcxGridFilterBox.CreateTokenCriteria
  : TcxGridFilterBoxTokenCriteriaOptions;
begin
...
begin
  Result := (CriteriaDisplayStyle = fcdsTokens) or
    (CriteriaDisplayStyle = fcdsDefault) and
...
procedure TcxGridFilterBox.SetButtonPosition(const Value
...
procedure TcxGridFilterBox.SetCriteriaDisplayStyle
  (Value: TcxFilterCriteriaDisplayStyle);
begin
...
procedure TcxGridFilterBox.SetTokenCriteria
  (Value: TcxGridFilterBoxTokenCriteriaOptions);
begin
...
begin
  if Controller.FocusRecord(0, True) then
    inherited FocusControlContent;
end;

procedure TcxGridFindPanel.GetControlContentViewParams
  (var AParams: TcxViewParams);
begin
...
procedure TcxGridFindPanelOptions.SetBehavior
  (AValue: TcxDataFindCriteriaBehavior);
begin
  Options.Behavior := AValue;
end;

procedure TcxGridFindPanelOptions.SetClearFindFilterTextOnClose
  (AValue: Boolean);
begin
  Options.ClearOnClose := AValue;
end;

procedure TcxGridFindPanelOptions.SetDisplayMode
  (AValue: TcxFindPanelDisplayMode);
begin
...
begin
  ...
  if (ViewInfo is TcxGridTableDataCellViewInfo) and
    (TcxGridTableDataCellViewInfo(ViewInfo).EditViewInfo <> nil) and
    Item.CanFocus(GridRecord) and TcxGridTableDataCellViewInfo(ViewInfo).HotTrack
  then
    Result := TcxCustomEditViewInfoAccess(TcxGridTableDataCellViewInfo(ViewInfo)
      .EditViewInfo).GetCurrentCursor(Pos);
end;
...
function TcxGridDataFilterCriteriaItem.IsItemLinkSupportsMultiThreading
  : Boolean;
var
  AProperties: TcxCustomEditProperties;
begin
  AProperties := TcxCustomGridTableItem(ItemLink).GetProperties;
  Result := TcxCustomEditPropertiesAccess(AProperties).SupportsMultiThreading
...
begin
  Result := TcxGridItemDataBinding(Owner).IsDisplayFormatDefined
    (AIsCurrencyValueAccepted);
end;

{ TcxGridCellPos }

constructor TcxGridCellPos.Create(AGridRecord: TcxCustomGridRecord;
AItem: TObject);
begin
  inherited Create;
...
constructor TcxCustomGridTableDateTimeHandling.Create
  (AGridView: TcxCustomGridView);
begin
  inherited;
...
procedure TcxCustomGridTableDateTimeHandling.SetFilters
  (Value: TcxGridDateTimeFilters);
begin
...
procedure TcxCustomGridTableDateTimeHandling.SetGrouping
  (Value: TcxGridDateTimeGrouping);
begin
  if Value = dtgDefault then
    Value := dtgByDateAndTime;
...
procedure TcxCustomGridTableDateTimeHandling.SetIgnoreTimeForFiltering
  (Value: Boolean);
begin
...
procedure TcxCustomGridTableDateTimeHandling.SetMonthFormat
  (const Value: string);
begin
...
procedure TcxCustomGridTableDateTimeHandling.SetUseLongDateFormat
  (Value: Boolean);
begin
...
procedure TcxCustomGridTableDateTimeHandling.SetUseShortTimeFormat
  (Value: Boolean);
begin
...
begin
  ...
  begin
    ...
    Filtering := TcxCustomGridTableShowLockedStateImageOptions(Source)
      .Filtering;
...
constructor TcxCustomGridTableOptionsBehavior.Create
  (AGridView: TcxCustomGridView);
begin
  inherited Create(AGridView);
...
function TcxCustomGridTableOptionsBehavior.GetShowLockedStateImageOptions
  : TcxCustomGridTableShowLockedStateImageOptions;
begin
  Result := TcxCustomGridTableShowLockedStateImageOptions
    (inherited ShowLockedStateImageOptions);
end;
...
procedure TcxCustomGridTableOptionsBehavior.SetBestFitMaxRecordCount
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
procedure TcxCustomGridTableOptionsBehavior.SetCopyCaptionsToClipboard
  (Value: Boolean);
begin
...
procedure TcxCustomGridTableOptionsBehavior.SetCopyRecordsToClipboard
  (Value: Boolean);
begin
...
procedure TcxCustomGridTableOptionsBehavior.SetDragFocusing
  (Value: TcxGridDragFocusing);
begin
...
procedure TcxCustomGridTableOptionsBehavior.SetEditAutoHeight
  (Value: TcxInplaceEditAutoHeight);
begin
...
procedure TcxCustomGridTableOptionsBehavior.SetFocusFirstCellOnNewRecord
  (Value: Boolean);
begin
...
procedure TcxCustomGridTableOptionsBehavior.SetGoToNextCellOnEnter
  (Value: Boolean);
begin
...
procedure TcxCustomGridTableOptionsBehavior.SetIncSearchItem
  (Value: TcxCustomGridTableItem);
begin
...
procedure TcxCustomGridTableOptionsBehavior.SetRecordScrollMode
  (Value: TcxRecordScrollMode);
begin
...
procedure TcxCustomGridTableOptionsBehavior.SetRepaintVisibleRecordsOnScroll
  (Value: Boolean);
begin
...
function TcxCustomGridTableOptionsBehavior.GetShowLockedStateImageOptionsClass
  : TcxCustomGridShowLockedStateImageOptionsClass;
begin
  Result := TcxCustomGridTableShowLockedStateImageOptions;
end;
...
constructor TcxCustomGridTableOptionsCustomize.Create
  (AGridView: TcxCustomGridView);
begin
  inherited;
  FItemFiltering := True;
...
procedure TcxCustomGridTableOptionsCustomize.SetItemsQuickCustomization
  (Value: Boolean);
begin
...
procedure TcxCustomGridTableOptionsCustomize.
  SetItemsQuickCustomizationMaxDropDownCount(Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
procedure TcxCustomGridTableOptionsCustomize.
  SetItemsQuickCustomizationMultiColumnMode(Value: Boolean);
begin
...
procedure TcxCustomGridTableOptionsCustomize.
  SetItemsQuickCustomizationReordering
  (Value: TcxGridQuickCustomizationReordering);
begin
...
procedure TcxCustomGridTableOptionsCustomize.
  SetItemsQuickCustomizationShowCommands(Value: Boolean);
begin
  FItemsQuickCustomizationShowCommands := Value;
end;

procedure TcxCustomGridTableOptionsCustomize.SetItemsQuickCustomizationSorted
  (Value: Boolean);
begin
...
begin
  if Source is TcxCustomGridTableOptionsCustomize then
    ...
    begin
      ...
      Self.ItemsQuickCustomizationMaxDropDownCount :=
        ItemsQuickCustomizationMaxDropDownCount;
      Self.ItemsQuickCustomizationMultiColumnMode :=
        ItemsQuickCustomizationMultiColumnMode;
      Self.ItemsQuickCustomizationReordering :=
        ItemsQuickCustomizationReordering;
      Self.ItemsQuickCustomizationShowCommands :=
        ItemsQuickCustomizationShowCommands;
      Self.ItemsQuickCustomizationSorted := ItemsQuickCustomizationSorted;
    end;
  inherited;
end;

function TcxCustomGridTableOptionsCustomize.
  SupportsItemsQuickCustomizationReordering: Boolean;
begin
  Result := not ItemsQuickCustomizationSorted and
    (GridView.IsDesigning or (ItemsQuickCustomizationReordering = qcrEnabled) or
...
procedure TcxGridScrollbarAnnotations.GetHint(AAnnotationRowIndexLists
  : TdxScrollbarAnnotationRowIndexLists; var AHint: string);
begin
...
function TcxGridScrollbarAnnotations.GetScrollableRecordIndexByRecordIndex
...
function TcxGridScrollbarAnnotations.GetLastIndexInScrollBand
...
function TcxGridScrollbarAnnotations.GetRecordIndexByScrollableRecordIndex
  (AIndex: Integer): Integer;
begin
  Result := AIndex + FGridView.Controller.FirstScrollRecordIndex;
end;

function TcxGridScrollbarAnnotations.GetRecordPixelScrollPosition
  (ARecordIndex: Integer): Integer;
begin
...
begin
  Result := not FGridView.Controller.IsPixelBasedScrollDataPos or
    FGridView.IsEqualScrollSizeRecords;
end;

procedure TcxGridScrollbarAnnotations.Populate
  (AKind: TdxScrollbarAnnotationKind;
AList: TdxScrollbarAnnotationRowIndexList);
begin
...
function TcxGridScrollbarAnnotationOptionsHelper.IsVisible
  (AKind: Integer): Boolean;
begin
  Result := inherited IsVisible(AKind) and
    FOwner.IsScrollbarAnnotationVisible(AKind);
end;
...
constructor TcxGridScrollbarAnnotationOptions.Create
  (AGridView: TcxCustomGridView);
begin
  inherited Create(AGridView);
...
function TcxGridScrollbarAnnotationOptions.GetCustomScrollbarAnnotations
  : TdxCustomScrollbarAnnotations;
begin
  Result := FHelper.CustomAnnotations;
end;

function TcxGridScrollbarAnnotationOptions.CreateHelper
  : TcxGridScrollbarAnnotationOptionsHelper;
begin
  Result := TcxGridScrollbarAnnotationOptionsHelper.Create
...
function TcxGridScrollbarAnnotationOptions.GetValue
  (const Index: Integer): Boolean;
begin
  Result := FHelper.GetValue(Index);
end;

function TcxGridScrollbarAnnotationOptions.IsValueStored
  (Index: Integer): Boolean;
begin
  Result := FHelper.GetDefaultValue(Index) <> GetValue(Index);
end;

procedure TcxGridScrollbarAnnotationOptions.SetCustomScrollbarAnnotations
  (const Value: TdxCustomScrollbarAnnotations);
begin
  FHelper.CustomAnnotations := Value;
end;

procedure TcxGridScrollbarAnnotationOptions.SetValue(const Index: Integer;
const Value: Boolean);
begin
...
constructor TcxCustomGridTableOptionsSelection.Create
  (AGridView: TcxCustomGridView);
begin
  inherited Create(AGridView);
  FCellSelect := True;
...
procedure TcxCustomGridTableOptionsSelection.SetHideFocusRectOnExit
  (Value: Boolean);
begin
...
procedure TcxCustomGridTableOptionsSelection.SetUnselectFocusedRecordOnExit
  (Value: Boolean);
begin
...
procedure TcxCustomGridTableOptionsView.SetEditAutoHeightBorderColor
  (Value: TColor);
begin
...
procedure TcxCustomGridTableOptionsView.SetItemCaptionAutoHeight
  (Value: Boolean);
begin
...
procedure TcxCustomGridTableOptionsView.SetItemCaptionEndEllipsis
  (Value: Boolean);
begin
...
procedure TcxCustomGridTableOptionsView.SetNoDataToDisplayInfoText
  (const Value: string);
begin
...
procedure TcxCustomGridTableOptionsView.SetShowEditButtons
  (Value: TcxGridShowEditButtons);
begin
...
procedure TcxCustomGridTableOptionsView.SetShowItemFilterButtons
  (Value: TcxGridShowItemFilterButtons);
begin
...
function TcxCustomGridTableOptionsView.
  IsNoDataToDisplayInfoTextAssigned: Boolean;
begin
...
begin
  Result := (0 <= RecordIndex) and
    (RecordIndex < ViewData.DataController.RecordCount);
end;
...
begin
  if Level = 0 then
    ...
    for Result := 0 to Level - 1 do
      if not IsParentRecordLast[Result] then
        Break;
end;
...
begin
  ...
  else if GridView.IsDetail then
...
begin
  ...
  begin
    GridView.VisibleItems[I].DoValidateDrawValue(Self,
      Values[GridView.VisibleItems[I].Index], AErrorData);
...
procedure TcxCustomGridRecord.SetDisplayText(Index: Integer;
const Value: string);
begin
...
function TcxCustomGridRecord.GetLastFocusableChild(ARecursive: Boolean)
  : TcxCustomGridRecord;
begin
  Result := nil;
end;
...
function TcxCustomGridTableCustomizationForm.GetItemsListBoxClass
  : TcxCustomGridTableItemsListBoxClass;
begin
...
constructor TcxGridFilterMRUItemsPopup.Create
...
procedure TdxCustomGridQuickCustomizationControl.DoCheckAllItems
  (AValue: Boolean);
var
    ...
    try
      repeat
        ...
        if AValue then
          ...
          AExpectedCount := 0;
      until TdxCustomCheckListBoxAccess(CheckListBox)
        .GetCheckedCount = AExpectedCount;
    finally
...
begin
  Popup.SetQuickCustomizationSorted
    ((Sender as TdxQuickCustomizationCustomCommand).Checked);
...
begin
  ...
  begin
    AddCommand(cxGetResourceString(@scxQuickCustomizationAllCommandCaption),
      True, CheckAllItems);
...
function TdxCustomGridQuickCustomizationControl.GetGridView
  : TcxCustomGridTableView;
begin
  Result := Popup.GridView;
end;

function TdxCustomGridQuickCustomizationControl.GetPopup
  : TcxCustomGridCustomizationPopup;
begin
  Result := Owner as TcxCustomGridCustomizationPopup;
end;

function TdxCustomGridQuickCustomizationControl.GetCheckingAllState
  : TcxCheckBoxState;
const
...
procedure TdxCustomGridQuickCustomizationControl.KeyDown(var Key: Word;
Shift: TShiftState);
begin
...
constructor TcxCustomGridCustomizationPopup.Create
  (AGridView: TcxCustomGridView);
begin
  inherited;
...
procedure TcxCustomGridCustomizationPopup.CorrectBoundsWithDesktopWorkArea
  (var APosition: TPoint; var ASize: TSize);

  function GetScrollbarAreaSize: TSize;
  begin
    Result := cxSize(TcxControlAccess(CheckListBox)
      .GetVScrollBarDefaultAreaWidth, TcxControlAccess(CheckListBox)
...
begin
  ...
  if (APosition.Y < ADesktopWorkArea.Top) or
    ((APosition.Y < AOwnerScreenBounds.Bottom) and
    (APosition.Y + ASize.cy > AOwnerScreenBounds.Top)) or
    (APosition.Y + ASize.cy > ADesktopWorkArea.Bottom) then
  begin
    if ADesktopWorkArea.Bottom - AOwnerScreenBounds.Bottom >
      AOwnerScreenBounds.Top - ADesktopWorkArea.Top then
  ...
  begin
    AMaxRowCount := (ADesktopSpace - CustomizationControl.CheckListBox.Top)
      div CustomizationControl.CheckListBox.ItemHeight - 1;
    ...
    begin
      ...
      repeat
        ...
        SetVisibleRowCount(Min(AMaxRowCount,
          CustomizationControl.CheckListBox.Count div AColumnCount + 1));
        ...
        Dec(AColumnCount);
      until (APosition.X + ASize.cx <= ADesktopWorkArea.Right) or
        (APosition.X - ASize.cx >= ADesktopWorkArea.Left);
    end
    else
    begin
      RestoreControlsBounds;
...
procedure TcxCustomGridCustomizationPopup.CheckListBoxAction
...
begin
  ...
  if CustomizationControl.HasCommands then
    CustomizationControl.CommandListBox.States[0] :=
      CustomizationControl.GetCheckingAllState;
end;

procedure TcxCustomGridCustomizationPopup.CheckListBoxCheckClicked
  (AIndex: Integer; AChecked: Boolean);
begin
  ItemClicked(CheckListBox.Items[AIndex].Data, AChecked);
end;

procedure TcxCustomGridCustomizationPopup.CheckListBoxItemDragOver
  (AItem: Pointer; var AAccept: Boolean);
begin
  AAccept := CanMoveItem(AItem);
end;

procedure TcxCustomGridCustomizationPopup.CheckListBoxInitializeSelection
  (Sender: TObject);
var
  I: Integer;
begin
  ...
  try
    if GridView.IsDesigning then
      for I := 0 to CheckListBox.Count - 1 do
        if GridView.Controller.DesignController.IsObjectSelected
          (CheckListBox.Items[I].Data as TPersistent) then
        begin
...
procedure TcxCustomGridCustomizationPopup.CheckListBoxSelectionChanged
  (Sender: TObject);
var
  AItems: TList;
  AFocusedItem: TObject;
begin
  if not GridView.IsDesigning or FSelectionInitializingInProcess then
    Exit;
  AItems := TList.Create;
  try
...
procedure TcxCustomGridCustomizationPopup.
  CheckListSelectedItemCheckedStateChanging(Sender: TObject);
var
  AFocusedItem: TObject;
  I: Integer;
begin
  ...
  for I := 0 to FChangingItems.Count - 1 do
    FChangingItemsCheckStates[I] :=
      Integer(IsVisibleGridItem(FChangingItems[I]));
end;

procedure TcxCustomGridCustomizationPopup.
  CheckListSelectedItemCheckedStateChanged(Sender: TObject);
var
  I, AIndex: Integer;
  AItems: TList;
  AFocusedItem: TObject;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        if (AIndex = -1) or
          (Integer((IsVisibleGridItem(CheckListBox.Items[AIndex].Data))) <>
          FChangingItemsCheckStates[I]) then
          HandleItemClicked(FChangingItems[I],
            IsVisibleGridItem(FChangingItems[I]));
      end;
...
procedure TcxCustomGridCustomizationPopup.CheckListBoxDragDrop(Sender,
...
var
  ...
  AFocusedItem: TObject;
begin
  AIndex := TdxCustomCheckListBoxAccess(CheckListBox)
  ...
  try
    ...
    TdxQuickCustomizationCustomControlAccess(CustomizationControl)
      .PopulateCheckListBox;
    SetCheckListBoxSelectedItems(AItems, AFocusedItem);
  finally
    CheckListBox.EndUpdate;
...
begin
  ...
  CustomizationControl.CheckListBox.OnSelectionChanged :=
    CheckListBoxSelectionChanged;
  CustomizationControl.CheckListBox.OnSelectedItemCheckedStateChanging :=
    CheckListSelectedItemCheckedStateChanging;
  CustomizationControl.CheckListBox.OnSelectedItemCheckedStateChanged :=
    CheckListSelectedItemCheckedStateChanged;
end;
...
function TcxCustomGridCustomizationPopup.GetCheckListBox
...
procedure TcxCustomGridCustomizationPopup.ItemClicked(AItem: TObject;
AChecked: Boolean);
begin
...
begin
  TdxCustomCheckListBoxAccess(CheckListBox).SortOptions :=
    [lbsAnsiSort, lbsCaseInsensitive];
end;
...
procedure TcxCustomGridCustomizationPopup.GetCheckListBoxSelectedItems
  (AItems: TList; var AFocusedItem: TObject);
var
  I: Integer;
begin
  for I := 0 to CheckListBox.Count - 1 do
...
procedure TcxCustomGridCustomizationPopup.SetCheckListBoxSelectedItems
  (AItems: TList; AFocusedItem: TObject);
var
...
begin
  ...
  // to prevent popup from closing because of ViewInfo recalculation
  inherited Popup;
end;
  ...
  try
    ...
    begin
      ...
      if AItem.VisibleInQuickCustomizationPopup then
        CheckListBox.Items.AddObject(AItem.GetAlternateCaption, AItem).Checked
          := AItem.Visible;
    end;
...
procedure TcxCustomGridItemsCustomizationPopup.SetQuickCustomizationSorted
  (AValue: Boolean);
begin
...
procedure TcxCustomGridItemsCustomizationPopup.
  SynchronizeTableItemsVisibilityWithListBox;
var
  I: Integer;
begin
  for I := 0 to CheckListBox.Count - 1 do
    (CheckListBox.Items[I].Data as TcxCustomGridTableItem).Visible :=
...
procedure TcxCustomGridItemsCustomizationPopup.HandleItemClicked(AItem: TObject;
AChecked: Boolean);
begin
...
function TcxCustomGridItemsCustomizationPopup.IsGridItem
  (AItem: TObject): Boolean;
begin
  Result := AItem is TcxCustomGridTableItem;
end;

function TcxCustomGridItemsCustomizationPopup.IsVisibleGridItem
  (AItem: TObject): Boolean;
begin
  Result := IsGridItem(AItem) and TcxCustomGridTableItem(AItem).Visible;
end;

function TcxCustomGridItemsCustomizationPopup.GetItemIndex
...
function TcxCustomGridItemsCustomizationPopup.CanMoveItem
...
class function TcxCustomGridTableItemAccess.CanFilter
  (AInstance: TcxCustomGridTableItem; AVisually: Boolean): Boolean;
begin
  Result := AInstance.CanFilter(AVisually);
end;

class function TcxCustomGridTableItemAccess.CanGroup
  (AInstance: TcxCustomGridTableItem): Boolean;
begin
  Result := AInstance.CanGroup;
end;

class function TcxCustomGridTableItemAccess.CanHide
  (AInstance: TcxCustomGridTableItem): Boolean;
begin
  Result := AInstance.CanHide;
end;

class function TcxCustomGridTableItemAccess.CanHorzSize
  (AInstance: TcxCustomGridTableItem): Boolean;
begin
  Result := AInstance.CanHorzSize;
end;

class function TcxCustomGridTableItemAccess.CanSort
  (AInstance: TcxCustomGridTableItem): Boolean;
begin
...
class function TcxCustomGridTableViewAccess.FindItemByObjectName
  (AInstance: TcxCustomGridTableView; const AObjectName: string)
  : TcxCustomGridTableItem;
begin
...
class procedure TcxCustomGridTableViewAccess.FocusDataControl
  (AInstance: TcxCustomGridTableView; AItemIndex: Integer; var ADone: Boolean);
begin
...
class function TcxCustomGridTableViewAccess.GetItemClass
...
class procedure TcxCustomGridTableViewAccess.BeginLockedStatePaintOnPost
  (AInstance: TcxCustomGridTableView);
begin
  AInstance.GridBeginLockedStatePaint
    (AInstance.OptionsBehavior.ShowLockedStateImageOptions.Posting);
end;

class procedure TcxCustomGridTableViewAccess.EndLockedStatePaint
  (AInstance: TcxCustomGridTableView);
begin
...
function TcxCustomGridTableMovingObject.GetController
  : TcxCustomGridTableController;
begin
  Result := TcxCustomGridTableController(inherited Controller);
end;

function TcxCustomGridTableMovingObject.GetCustomizationForm
  : TcxCustomGridTableCustomizationForm;
begin
  Result := TcxCustomGridTableCustomizationForm(inherited CustomizationForm);
end;

procedure TcxCustomGridTableMovingObject.DragAndDrop(const P: TPoint;
...
function TcxGridItemContainerZone.IsEqual
  (Value: TcxGridItemContainerZone): Boolean;
begin
...
procedure TcxCustomGridTableItemMovingObject.SetDestItemContainerKind
  (Value: TcxGridItemContainerKind);
begin
...
procedure TcxCustomGridTableItemMovingObject.SetDestZone
  (Value: TcxGridItemContainerZone);
begin
  if (FDestZone <> Value) and ((FDestZone = nil) or not FDestZone.IsEqual(Value)
    or (Value = nil) or not Value.IsEqual(FDestZone)) then
  begin
    Dirty := True;
    FDestZone.Free;
    FDestZone := Value;
...
procedure TcxCustomGridTableItemMovingObject.CalculateDestParams
  (AHitTest: TcxCustomGridHitTest; out AContainerKind: TcxGridItemContainerKind;
...
procedure TcxCustomGridTableItemMovingObject.CheckDestItemContainerKind
  (var AValue: TcxGridItemContainerKind);
begin
...
function TcxCustomGridTableItemMovingObject.GetCustomizationFormListBox
...
procedure TcxCustomGridTableItemMovingObject.DragAndDrop(const P: TPoint;
var Accepted: Boolean);
var
...
begin
  ...
  begin
    ...
    try
      ...
      begin
        AItem := GridView.Items[I];
        if AItem.CanMove and AItem.VisibleForCustomization and not AItem.Visible
        then
...
begin
  if (RecordViewInfo = nil) or (FItem <> nil) and not IsItemVisible or
    not GridView.Changeable then
    Exit;
  RecordViewInfo.Recalculate;
  GridView.ViewChanged(RecordViewInfo.GetBoundsForInvalidate(FItem));
end;

function TcxGridRecordChange.IsCompatibleWith
  (AChange: TcxCustomGridChange): Boolean;
begin
  Result := inherited IsCompatibleWith(AChange) or
    ((AChange is TcxGridLayoutChange) or (AChange is TcxGridSizeChange) or
    (AChange is TcxGridDataChange)) and
    (TcxCustomGridViewChange(AChange).GridView <> nil) and
    (TcxCustomGridViewChange(AChange).GridView = GridView);
end;
...
begin
  Result := (GridView.IndexOfItem(FItem) <> -1) and
    FItem.IsVisibleForRecordChange; // ActuallyVisible or FItem.SpecialVisible);
end;
...
begin
  ...
  begin
    ...
    if (FFocusedRecordIndex <> FPrevFocusedRecordIndex) or FNewItemRecordFocusingChanged
    then
    begin
...
procedure TcxGridItemFilterPopupOptions.SetApplyMultiSelectChanges
  (AValue: TcxGridItemFilterPopupApplyChangesMode);
begin
...
procedure TcxGridItemFilterPopupOptions.SetMaxDropDownItemCount
  (AValue: Integer);
begin
  AValue := Max(AValue, 0);
...
procedure TcxGridItemExcelFilterPopupOptions.SetApplyChanges
  (AValue: TdxExcelFilterValueContainerApplyChangesMode);
begin
...
procedure TcxGridItemExcelFilterPopupOptions.SetDefaultPage
...
begin
  Result := FExpressionEditing and TcxFilterCriteriaAccess
    (GridView.DataController.Filter).IsExpressionsSupported;
end;
...
procedure TcxCustomGridTableFiltering.SetItemExcelPopup
  (Value: TcxGridItemExcelFilterPopupOptions);
begin
...
procedure TcxCustomGridTableFiltering.
  SetItemFilteredItemsListShowFilteredItemsOnly(AValue: Boolean);
begin
...
begin
  ...
  begin
    ...
    for I := 0 to GridView.ItemCount - 1 do
      GridView.Items[I].DataBinding.FilterMRUValueItems.MaxCount :=
        FItemMRUItemsListCount;
    Changed(vcProperty);
  end;
end;

procedure TcxCustomGridTableFiltering.SetItemPopup
  (Value: TcxGridItemFilterPopupOptions);
begin
  FItemPopup.Assign(Value);
end;

procedure TcxCustomGridTableFiltering.SetItemPopupMode
  (Value: TdxFilterPopupWindowMode);
begin
...
procedure TcxCustomGridTableFiltering.SetMRUItemsListDropDownCount
  (Value: Integer);
begin
...
procedure TcxCustomGridTableFiltering.AfterFilterControlDialogApply
  (Sender: TObject);
begin
...
procedure TcxCustomGridTableFiltering.BeforeFilterControlDialogApply
  (Sender: TObject);
begin
  FSynchronizeWithControlDialog := (Sender as TfmFilterControlDialog)
    .FilterControl.IsNeedSynchronize;
  if FSynchronizeWithControlDialog then
    GridView.BeginFilteringUpdate;
end;
...
procedure TcxCustomGridTableFiltering.ReadMRUItemsListDropDownCount
  (Reader: TReader);
begin
...
begin
  Position := TcxGridFilterPosition
    (GetEnumValue(TypeInfo(TcxGridFilterPosition), Reader.ReadIdent));
end;

procedure TcxCustomGridTableFiltering.ReadVisible(Reader: TReader);
begin
  Visible := TcxGridFilterVisible(GetEnumValue(TypeInfo(TcxGridFilterVisible),
    Reader.ReadIdent));
end;
...
begin
  ...
  Filer.DefineProperty('MaxDropDownCount', ReadItemPopupMaxDropDownCount,
    nil, True);
  Filer.DefineProperty('MRUItemsListDropDownCount',
    ReadMRUItemsListDropDownCount, nil, True);
...
function TcxCustomGridTableFiltering.GetItemPopupClass
  : TcxGridItemFilterPopupOptionsClass;
begin
  Result := TcxGridItemFilterPopupOptions;
end;

function TcxCustomGridTableFiltering.GetItemExcelPopupClass
  : TcxGridItemExcelFilterPopupOptionsClass;
begin
  Result := TcxGridItemExcelFilterPopupOptions;
end;

function TcxCustomGridTableFiltering.GetMRUItemsClass
...
procedure TcxCustomGridTableFiltering.MRUItemsVisibleCountChanged(AOldCount,
  ANewCount: Integer);
begin
...
procedure TcxCustomGridTableFiltering.SetItemPopupMaxDropDownItemCount
  (Value: Integer);
begin
  FItemPopup.MaxDropDownItemCount := Value;
end;

procedure TcxCustomGridTableFiltering.ReadItemPopupDropDownWidth
  (Reader: TReader);
begin
  DropDownWidth := Reader.ReadInteger;
end;

procedure TcxCustomGridTableFiltering.ReadItemPopupMaxDropDownCount
  (Reader: TReader);
begin
  MaxDropDownCount := Reader.ReadInteger;
end;

procedure TcxCustomGridTableFiltering.AddFilterToMRUItems
  (AFilter: TcxDataFilterCriteria = nil);
begin
  if AFilter = nil then
...
begin
  if Source is TcxCustomGridTableFiltering then
    ...
    begin
      ...
      Self.ItemFilteredItemsListShowFilteredItemsOnly :=
...
procedure TcxCustomGridTableFiltering.RunCustomizeDialog
  (AItem: TcxCustomGridTableItem);
begin
  if GridView.DoFilterDialogShow(AItem) then
    Exit;
  if (AItem = nil) or IsFilterControlDialogNeeded(GridView.DataController.Filter)
  then
    if not GridView.DoFilterCustomization then
      ExecuteFilterControlDialog(GridView, GridView.LookAndFeel,
        ...
        BeforeFilterControlDialogApply, AfterFilterControlDialogApply,
        GridView.Control)
    else
  else if ShowFilterDialog(GridView.DataController.Filter, AItem,
    AItem.GetProperties, AItem.FilterCaption, AItem.DataBinding.ValueTypeClass,
    GridView.LookAndFeel, TcxCustomGrid(GridView.Control).Font, GridView.Control)
  then
  begin
...
constructor TcxGridViewNavigatorButtons.Create
  (AGridView: TcxCustomGridTableView);
begin
...
begin
  Result := inherited GetAdornerTargetElementVisible and
    GridView.ViewInfo.NavigatorSiteViewInfo.Visible;
end;
...
begin
  inherited Create(AGridView);
  FButtons := GetNavigatorButtonsClass.Create(GridView)
    as TcxGridViewNavigatorButtons;
...
function TcxGridViewNavigator.GetNavigatorButtonsClass
  : TcxGridViewNavigatorButtonsClass;
begin
...
procedure TcxGridViewNavigator.SetInfoPanel
  (Value: TcxGridViewNavigatorInfoPanel);
begin
...
begin
  Result := DataController.ItemExpressions[Item.Index];
  if Result <> '' then
    Result := InvariantExpressionFlag + DataController.ExpressionProvider.
      ExpressionToInvariantExpression(Result);
end;
...
begin
  ...
  begin
    ...
    AExpression := DataController.ExpressionProvider.
      InvariantExpressionToExpression(AExpression);
  end;
...
function TcxGridItemDataBinding.GetDefaultValuesProviderClass
  : TcxCustomEditDefaultValuesProviderClass;
var
  AIcxGridDataController: IcxGridDataController;
begin
...
function TcxGridItemDataBinding.GetFilterMRUValueItemsClass
  : TcxGridFilterMRUValueItemsClass;
begin
  Result := TcxGridFilterMRUValueItems;
end;

procedure TcxGridItemDataBinding.GetFilterStrings(AStrings: TStrings;
AValueList: TcxGridFilterValueList; AValuesOnly: Boolean; AUniqueOnly: Boolean);
var
  I: Integer;
  S: string;
begin
...
procedure TcxGridItemDataBinding.GetFilterValues
  (AValueList: TcxGridFilterValueList; AValuesOnly: Boolean;
AInitSortByDisplayText: Boolean; ACanUseFilteredValues: Boolean;
AUniqueOnly: Boolean);
var
  I: Integer;
begin
  AValueList.Load(Item, AInitSortByDisplayText, ACanUseFilteredValues and
    Item.UseFilteredValuesForFilterValueList,
    Item.UseValueItemsForFilterValueList, AUniqueOnly,
    Item.ShowFilteredItemsOnlyForFilteredValues);
  ...
  if AValuesOnly then
    ...
    else if Item.CanFilterMRUValueItems then
...
procedure TcxGridItemDataBinding.SetFilterActiveValue(AOperatorKind
  : TcxFilterOperatorKind; const AValue: Variant; const ADisplayText: string);
begin
  GridView.BeginFilteringUpdate;
  try
...
procedure TcxGridItemDataBinding.SetFilterActiveValueIndex
  (AValueList: TcxGridFilterValueList; AIndex: Integer;
AFilterList: TcxFilterCriteriaItemList;
AReplaceExistent, AAddToMRUItemsList: Boolean);
begin
  AValueList.ApplyFilter(Item, AIndex, AFilterList, AReplaceExistent,
    AAddToMRUItemsList);
end;

procedure TcxGridItemDataBinding.SetFilterActiveValues
  (AValueInfos: TdxFastObjectList; ABoolOperator: TcxFilterBoolOperatorKind);
var
  I: Integer;
  ...
  try
    ...
    try
      ...
      begin
        ...
        AddToFilter(AList, AInfo.OperatorKind, AInfo.Value,
          AInfo.DisplayText, False);
      end;
      Filter.Active := True;
    finally
      Filter.EndUpdate;
...
function TcxGridItemDataBinding.DefaultWidth(ATakeHeaderIntoAccount
...
function TcxGridItemDataBinding.GetDefaultValuesProvider
  (AProperties: TcxCustomEditProperties = nil): IcxEditDefaultValuesProvider;
begin
  Result := FDefaultValuesProvider;
end;

function TcxGridItemDataBinding.IsDisplayFormatDefined(AIsCurrencyValueAccepted
  : Boolean): Boolean;
begin
  Result := DataController.IsDisplayFormatDefined(FItem.Index,
    not AIsCurrencyValueAccepted) or FItem.HasDataTextHandler;
end;

function TcxGridItemDataBinding.AddToFilter(AParent: TcxFilterCriteriaItemList;
AOperatorKind: TcxFilterOperatorKind; const AValue: Variant;
const ADisplayText: string; AReplaceExistent: Boolean): TcxFilterCriteriaItem;
begin
...
procedure TcxGridItemDataBinding.GetFilterValues
  (AValueList: TcxGridFilterValueList; AValuesOnly: Boolean = True;
AInitSortByDisplayText: Boolean = False;
ACanUseFilteredValues: Boolean = False);
begin
  GetFilterValues(AValueList, AValuesOnly, AInitSortByDisplayText,
    ACanUseFilteredValues, True);
end;

procedure TcxGridItemDataBinding.GetFilterActiveValueIndexes
  (AValueList: TcxGridFilterValueList; var AIndexes: TcxGridIndexes);

  procedure CheckFilterItem(AFilterItem: TcxFilterCriteriaItem);
  var
    AValueIndex: Integer;
  begin
    if AFilterItem.ItemLink <> FItem then
      Exit;
...
procedure TcxGridItemDataBinding.SetFilterActiveValueIndexes
  (AValueList: TcxGridFilterValueList; const AIndexes: TcxGridIndexes;
AAddToMRUItemsList: Boolean = False);
  ...
  try
    ...
    try
      ...
      for I := 0 to Length(AIndexes) - 1 do
        SetFilterActiveValueIndex(AValueList, AIndexes[I], AFilterList, False,
          AAddToMRUItemsList);
    finally
      Filter.EndUpdate;
    end;
...
constructor TcxGridEditingController.Create(AController
  : TcxCustomGridTableController);
begin
...
function TcxGridEditingController.GetEditingCellViewInfo
  : TcxGridTableDataCellViewInfo;
begin
...
procedure TcxGridEditingController.SetEditingItem
  (Value: TcxCustomGridTableItem);
begin
  if FEditingItem <> Value then
  begin
    if EditingItemSetting then
      Exit;
    EditingItemSetting := True;
    try
      if Value <> nil then
      begin
        if not Value.CanEdit or not GridView.DoEditing(Value) then
          Exit;
...
begin
  Result := Controller.CanUseAutoHeightEditing and
    EditingItem.CanEditAutoHeight and
    (esoEditingAutoHeight in FEdit.ActiveProperties.GetSupportedOperations);
end;

function TcxGridEditingController.GetAdjustedMultilineEditBounds
...
procedure TcxGridEditingController.SetupMultilineEdit
  (AEdit: TcxAutoHeightInplaceEdit);
begin
...
begin
  ...
  begin
    ...
    else if AHeightChanged then
      GridView.SizeChanged(True);
  end;
end;

procedure TcxGridEditingController.UpdateMultilineEditBounds
  (const ABounds: TRect);
begin
...
begin
  Result := (FEditingItem <> nil) and (EditingCellViewInfo <> nil) and
    not FEditingItem.EditPartVisible and not Controller.Tracking;
end;
...
function TcxGridEditingController.CellEditBoundsToEditBounds(ACellEditBounds
  : TRect): TRect;
begin
...
function TcxGridEditingController.CreateEditAutoHeightProperties
...
procedure TcxGridEditingController.DoEditKeyDown(var Key: Word;
Shift: TShiftState);
var
  AModified: Boolean;
begin
...
begin
  ...
  begin
    ...
    Edit.ActiveProperties.Update
      (FEditingItem.GetProperties(Controller.FocusedRecord));
  end;
  EditingItem := nil;
...
begin
  ...
  begin
    ...
    if IsRectEmpty(ACellViewInfo.Bounds) then
      Exit;
...
begin
  Result := not GridView.OptionsBehavior.AlwaysShowEditor or
    ...
    (IsEditAutoHeight or FEditingItem.HasCustomPropertiesHandler or
    FEditingItem.HasCustomPropertiesForEditHandler or
    FEditingItem.ShowButtons(False) or
    (esoAlwaysHotTrack in FEditingItem.GetProperties.GetSupportedOperations)) or
    Assigned(GridView.OnEditing) or Assigned(GridView.OnInitEdit) or
    Assigned(GridView.OnUpdateEdit);
end;
...
begin
  ARowViewInfo := Controller.GetViewInfo.RecordsViewInfo.GetRealItem
    (Controller.FocusedRecord);
...
function TcxGridEditingController.
  IsNeedInvokeEditChangedEventsBeforePost: Boolean;
begin
...
begin
  ...
  try
    ...
    if EditPreparing or EditHiding or (AItem = nil) or
      (Controller.FocusedRecord = nil) then
      Exit;
    FEditPreparing := True;
    try
...
procedure TcxGridEditingController.UpdateEditStyle(AEditCellViewInfo
  : TcxGridTableDataCellViewInfo);
begin
...
procedure TcxGridEditingController.EditAfterKeyDown(Sender: TObject;
...
procedure TcxGridEditingController.RemoveEdit(AProperties
  : TcxCustomEditProperties);
begin
...
procedure TcxGridEditingController.StartEditShowingTimer
  (AItem: TcxCustomGridTableItem);
begin
...
function TcxGridDragOpenInfoExpand.Equals
  (AInfo: TcxCustomGridDragOpenInfo): Boolean;
begin
...
function TcxCustomGridTableRecordScrollAnimationHelper.CalculateScrollDelta
...
begin
  ...
  FIsScrollingByRecord := Abs(ALastIndex - AFirstIndex) >
    FOwner.ViewInfo.RecordsViewInfo.GetPixelScrollContentSize;
  if FIsScrollingByRecord then
    Result := ALastIndex - AFirstIndex
  else
    Result := FOwner.ViewInfo.RecordsViewInfo.GetPixelScrollOffset
      (GetOwnerPosition.Index, GetOwnerPosition.ScrollOffset, AValue.Index,
      AValue.ScrollOffset);
end;

procedure TcxCustomGridTableRecordScrollAnimationHelper.AfterAnimationEnded
  (AIsRaiseEvent: Boolean);
begin
...
function TcxCustomGridTableRecordScrollAnimationHelper.CalculateAnimatedPosition
...
begin
  ...
  begin
    ...
    begin
      ...
      FOwner.ViewInfo.RecordsViewInfo.CalculatePixelScrollInfo(Result.Index,
        Result.ScrollOffset, MaxInt, MinInt, -ADelta, AOverPan);
  end;
end;

function TcxCustomGridTableRecordScrollAnimationHelper.GetOwnerPosition
  : TdxRecordPixelScrollData;
begin
  Result := TdxRecordPixelScrollData.Create(FOwner.InternalTopRecordIndex,
    FOwner.PixelScrollRecordOffset);
end;
...
procedure TcxCustomGridTableRecordScrollAnimationHelper.SetTargetPosition
...
procedure TcxCustomGridTableRecordScrollAnimationHelper.UpdateOwnerPosition
  (AValue: TdxRecordPixelScrollData);
begin
...
function TcxCustomGridTableController.GetAdjustedTopRecordIndex(ATopRecordIndex
  : Integer): Integer;
begin
...
function TcxCustomGridTableController.GetFilterMRUItemsPopup
  : TcxGridFilterMRUItemsPopup;
begin
...
function TcxCustomGridTableController.GetIncSearchingItem
  : TcxCustomGridTableItem;
begin
...
function TcxCustomGridTableController.GetItemsCustomizationPopup
  : TcxCustomGridItemsCustomizationPopup;
begin
  if FItemsCustomizationPopup = nil then
    FItemsCustomizationPopup := GetItemsCustomizationPopupClass.Create
      (GridView);
  Result := FItemsCustomizationPopup;
end;

function TcxCustomGridTableController.GetMasterController
  : TcxCustomGridTableController;
begin
...
function TcxCustomGridTableController.GetSelectedRecord(Index: Integer)
  : TcxCustomGridRecord;
begin
...
procedure TcxCustomGridTableController.SetDragHighlightedRecord
  (Value: TcxCustomGridRecord);
var
...
procedure TcxCustomGridTableController.SetEditingItem
  (Value: TcxCustomGridTableItem);
begin
  FEditingController.EditingItem := Value;
end;

procedure TcxCustomGridTableController.SetFocusedItem
  (Value: TcxCustomGridTableItem);
var
  APrevFocusedItem: TcxCustomGridTableItem;
begin
  if (Value <> nil) and not Value.CanFocus(FocusedRecord) then
    Exit;
...
begin
  if (Value < -1) or (Value >= GridView.VisibleItemCount) then
    Exit;
  if Value = -1 then
    FocusedItem := nil
  else
...
var
  AIndexesAreEqual, ANeedUseLockedStatePaint: Boolean;
begin
  if not CanChangeFocusedRecordIndex(FocusedRecordIndex, Value) then
    Exit;
  AIndexesAreEqual := FocusedRecordIndex = Value;
  ANeedUseLockedStatePaint := (GridView.GetPostingLockedStateMode <> lsimNever)
    and DataController.CanFocusedRecordIndexChangePostData;
  try
...
procedure TcxCustomGridTableController.SetIncSearchingText(const Value: string);
  ...
  begin
    ...
    else if ItemForIncSearching = nil then
      Result := -1
    else
...
begin
  if (IncSearchingText <> Value) and (GetItemIndex <> -1) then
    if Value = '' then
      ...
      DataController.Search.Locate(GetItemIndex, Value, False,
        not IsMultiSelectPersistent)
end;

procedure TcxCustomGridTableController.SetInternalTopRecordIndex
  (Value: Integer);
begin
...
procedure TcxCustomGridTableController.SetPixelScrollRecordOffset
  (const Value: Integer);
begin
...
procedure TcxCustomGridTableController.GridModeBufferCountUpdateTimerHandler
  (Sender: TObject);
begin
  CheckGridModeBufferCountUpdatePost;
end;

procedure TcxCustomGridTableController.PullFocusingScrollingTimerHandler
  (Sender: TObject);
begin
...
begin
  ...
  begin
    ...
    begin
      Site.Update;
      TcxControlAccess(Site).DragAndDrop(Site.ScreenToClient(GetMouseCursorPos),
        AAccepted);
    end;
  end;
end;
...
function TcxCustomGridTableController.AllowPan(AScrollKind
  : TScrollBarKind): Boolean;
begin
  Result := inherited AllowPan(AScrollKind) and
    ViewInfo.RecordsViewInfo.AllowPan(AScrollKind);
end;
...
function TcxCustomGridTableController.
  CanCancelDragStartOnCaptureObjectClear: Boolean;
begin
...
procedure TcxCustomGridTableController.CheckInternalTopRecordIndex
  (var AIndex: Integer);
begin
  CheckTopRecordIndex(AIndex);
end;

procedure TcxCustomGridTableController.DetailFocused
  (ADetail: TcxCustomGridView);
var
...
begin
  if not FEditingController.CanRemoveEditFocus then
    Exit;
  inherited;
  InvalidateFocusedRecord;
  PostCheckEdit;
...
procedure TcxCustomGridTableController.AllowRecordScrollAnimationOnMakeVisible
  (AProc: TProc);
begin
...
function TcxCustomGridTableController.CanAppend(ACheckOptions: Boolean)
  : Boolean;
begin
  Result := AllowAppendRecord and (dceoAppend in DataController.EditOperations)
    and (not ACheckOptions or GridView.OptionsData.Appending);
end;
...
function TcxCustomGridTableController.CanChangeFocusedRecordIndex
  (APrevRecordIndex, ANewRecordIndex: Integer): Boolean;
begin
  Result := False;
  if EditingController.IsErrorOnPost then
    Exit;
  if (0 <= ANewRecordIndex) and (ANewRecordIndex < ViewData.RecordCount) and
    not ViewData.Records[ANewRecordIndex].CanFocus then
    Exit;
...
function TcxCustomGridTableController.CanDelete(ACheckOptions: Boolean)
  : Boolean;
begin
...
begin
  Result := (FocusedItem <> nil) and GridView.OptionsData.Editing and
    ([dceoEdit, dceoShowEdit] * DataController.EditOperations = [dceoEdit,
    dceoShowEdit]);
end;
...
function TcxCustomGridTableController.CanInsert(ACheckOptions: Boolean)
  : Boolean;
begin
...
function TcxCustomGridTableController.CanMakeRecordVisible
  (ARecord: TcxCustomGridRecord): Boolean;
var
  AFocusedView: TcxCustomGridView;
begin
  Result := (ARecord <> nil) and (GridView.Control <> nil) and
    IsRecordScrollable(ARecord.Index);
  if Result then
  begin
    AFocusedView := TcxCustomGrid(GridView.Control).FocusedView;
    Result := GridView.Focused or not((AFocusedView is TcxCustomGridTableView)
      and AFocusedView.HasAsMaster(GridView) and
      TcxCustomGridTableView(AFocusedView).DontMakeMasterRecordVisible);
  end;
end;
...
function TcxCustomGridTableController.CheckBrowseModeOnRecordChanging
  (ANewRecordIndex: Integer): Boolean;
begin
  Result := True;
end;
...
procedure TcxCustomGridTableController.CheckTopRecordIndexAndOffset(var AIndex,
  AOffset: Integer);

  function IsGridModeAndScrollable: Boolean;
  begin
    Result := DataController.IsGridMode and
      not(dceInsert in DataController.EditState) and not IsCheckingCoordinates;
  end;
...
begin
  ...
  try
    ...
    if (not IsRecordPixelScrolling or (ScrollRecordCount = 0)) and
      (AIndex > LastScrollRecordIndex) then
    begin
    ...
    if (AIndex < FirstScrollRecordIndex) or not DataController.IsGridMode and
      (AIndex = InternalTopRecordIndex) and
      (ViewInfo.VisibleRecordCount < ScrollRecordCount - AIndex) then
      Exit;

    if IsRecordPixelScrolling then
      CheckPixelScrollTopRecordIndexAndOffsetValues(AIndex, AOffset)
    else if AIndex <> FirstScrollRecordIndex then
    begin
...
var
  ...
  I: Integer;
begin
  APrevIsScrollbarAnnotationsRenderingByRecordPixelScrollPosition :=
    FIsScrollbarAnnotationsRenderingByRecordPixelScrollPosition;
  ...
  if not FIsScrollbarAnnotationsRenderingByRecordPixelScrollPosition and APrevIsScrollbarAnnotationsRenderingByRecordPixelScrollPosition
  then
  begin
...
begin
  if (ViewInfo.VisibleRecordCount > 0) and
    (InternalTopRecordIndex >= FirstScrollRecordIndex) then
  begin
    AScrollRecordDelta := InternalTopRecordIndex - FirstScrollRecordIndex;
    if IsPixelBasedScrollDataPos then
      if GridView.IsEqualScrollSizeRecords then
        Result := AScrollRecordDelta * ViewInfo.GetEqualHeightRecordScrollSize -
          PixelScrollRecordOffset
      else
        Result := ViewData.Records[InternalTopRecordIndex].PixelScrollPosition -
          PixelScrollRecordOffset
    else
...
procedure TcxCustomGridTableController.DoMakeRecordVisible
  (ARecord: TcxCustomGridRecord);
...
procedure TcxCustomGridTableController.DoScroll(AScrollBarKind: TScrollBarKind;
...
begin
  Result := GridView.IsScrollAnimationEnabled and
    not IsNavigationKeyAutoRepeat and IsRecordPixelScrolling;
end;
...
procedure TcxCustomGridTableController.DoSetScrollBarPos(Value: Integer);
  ...
  begin
    ...
    if GridView.IsEqualScrollSizeRecords then
    begin
      ATopRecordIndex := FirstScrollRecordIndex +
        Value div ViewInfo.GetEqualHeightRecordScrollSize;
      ATopRecordPixelScrollOffset :=
        -Value mod ViewInfo.GetEqualHeightRecordScrollSize;
    end
    else
...
begin
  ...
  if IsPixelBasedScrollDataPos then
  begin
    CalculateTopRecordIndexAndOffset(Value, ATopRecordIndex,
      ATopRecordPixelScrollOffset);
  ...
  begin
    ...
    begin
      ATopRecordPixelScrollOffset := 0;
      CheckTopRecordIndexAndOffset(ATopRecordIndex,
        ATopRecordPixelScrollOffset);
      SetTopRecordIndexWithOffset(ATopRecordIndex, ATopRecordPixelScrollOffset);
    end
    else
...
procedure TcxCustomGridTableController.DoSetTopRecordIndexWithOffset
...
begin
  ...
  begin
    ...
    try
      if GridView.CanOffset(ARecordCountDelta, APixelScrollRecordOffsetDelta)
      then
      begin
        if ((ARecordCountDelta <> 0) or (APixelScrollRecordOffsetDelta <> 0))
        then
          GridView.Offset(ARecordCountDelta,
            APixelScrollRecordOffsetDelta, 0, 0)
      end
      else if GridView.IsMaster then
...
function TcxCustomGridTableController.FindNextCustomItem(AFocusedItemIndex,
  AItemCount: Integer; AGoForward, AGoOnCycle: Boolean;
ACanFocus: TcxCustomGridTableCanItemFocus; AData: TObject;
var AItemIndex: Integer; out ACycleChanged: Boolean): Boolean;
var
  AFromIndex: Integer;
  ...
  begin
    if AFocusedItemIndex = -1 then
      if AGoForward then
        Result := 0
      else if AGoOnCycle then
        Result := AItemCount - 1
      else
        Result := -1
    else if AGoForward then
...
begin
  ...
  repeat
    if not CheckIndex(AItemIndex) then
      Exit;
    if (AItemIndex = AFocusedItemIndex) and not ACycleChanged then
      Exit;
    Result := ACanFocus(GridView, AItemIndex, AData);
    if Result or ACycleChanged and ((AItemIndex = AFocusedItemIndex) or
      (AFocusedItemIndex = -1)) then
      Exit;
    GetNextIndex(AItemIndex);
  until (AItemIndex = AFromIndex) or (AItemIndex = -1) and
    (AFocusedItemIndex = -1);
end;

procedure TcxCustomGridTableController.FocusedItemChanged(APrevFocusedItem
  : TcxCustomGridTableItem);
begin
  if GridView.IsLoading or GridView.IsDestroying then
    Exit;
...
procedure TcxCustomGridTableController.FocusedRecordChanged
  (APrevFocusedRecordIndex, AFocusedRecordIndex, APrevFocusedDataRecordIndex,
  AFocusedDataRecordIndex: Integer; ANewItemRecordFocusingChanged: Boolean);
begin
  AssignFocusedRecord;
  ...
  GridView.FocusedRecordChanged(APrevFocusedRecordIndex, AFocusedRecordIndex,
    APrevFocusedDataRecordIndex, AFocusedDataRecordIndex,
    ANewItemRecordFocusingChanged);
end;
...
procedure TcxCustomGridTableController.GetBestFitRecordRange(out AFirstIndex,
  ALastIndex: Integer);
begin
...
begin
  Result := GridView.OptionsData.CancelOnExit and
    (DataController.EditState * [dceInsert, dceChanging, dceModified] =
    [dceInsert]);
end;
...
function TcxCustomGridTableController.GetFilterMRUItemsPopupClass
  : TcxGridFilterMRUItemsPopupClass;
begin
  Result := TcxGridFilterMRUItemsPopup;
end;

function TcxCustomGridTableController.GetFilterPopupClass
  : TcxGridFilterPopupClass;
begin
...
function TcxCustomGridTableController.GetItemsCustomizationPopupClass
  : TcxCustomGridItemsCustomizationPopupClass;
begin
...
begin
  if IsRecordPixelScrolling then
    Result := InternalTopRecordIndex +
      ViewInfo.RecordsViewInfo.PartVisibleCount - 1
  else
...
begin
  Result := LastScrollRecordIndex - GetPageVisibleRecordCount
    (LastScrollRecordIndex, 0, False) + 1;
end;

procedure TcxCustomGridTableController.
  GetPixelScrollTopRecordIndexAndOffsetByBottomRecord(ABottomRecordIndex
  : Integer; out ATopRecordIndex, ATopRecordPixelScrollOffset: Integer);
var
  AOverPan: Boolean;
begin
  ATopRecordIndex := ABottomRecordIndex;
  ATopRecordPixelScrollOffset := -ViewInfo.RecordsViewInfo.GetRecordScrollSize
    (ABottomRecordIndex);
  ...
  ViewInfo.RecordsViewInfo.CalculatePixelScrollInfo(ATopRecordIndex,
    ATopRecordPixelScrollOffset, cxRecordIndexNone, UnassignedPixelScrollOffset,
    ViewInfo.RecordsViewInfo.GetPixelScrollContentSize, AOverPan);
end;

procedure TcxCustomGridTableController.
  GetPixelScrollTopRecordIndexAndOffsetMaxValues(out ARecordIndex,
  APixelScrollOffset: Integer);
begin
  GetPixelScrollTopRecordIndexAndOffsetByBottomRecord(LastScrollRecordIndex,
    ARecordIndex, APixelScrollOffset);
end;

function TcxCustomGridTableController.GetPageVisibleRecordCount
  (AFirstRecordIndex: Integer; APixelScrollRecordOffset: Integer;
ACalculateDown: Boolean = True): Integer;
begin
  Result := GetVisibleRecordCount(AFirstRecordIndex, APixelScrollRecordOffset,
    ACalculateDown);
  if (Result = 0) and (ScrollRecordCount > 0) then
    Result := 1;
end;

function TcxCustomGridTableController.GetPatternObject(AObject: TPersistent)
  : TPersistent;
begin
  if AObject is TcxCustomGridTableItem then
    Result := TcxCustomGridTableView(GridView.PatternGridView)
      .FindItemByID(TcxCustomGridTableItem(AObject).ID)
  else
...
function TcxCustomGridTableController.GetTopRecordIndexByBottomRecord
  (ABottomRecordIndex: Integer): Integer;
begin
  Result := ABottomRecordIndex - GetPageVisibleRecordCount(ABottomRecordIndex,
    0, False) + 1;
end;

function TcxCustomGridTableController.GetVisibleRecordCount(AFirstRecordIndex
  : Integer; APixelScrollRecordOffset: Integer;
ACalculateDown: Boolean = True): Integer;
var
  ...
  begin
    AVisibleEqualHeightRecordCount :=
      ViewInfo.CalculateVisibleEqualHeightRecordCount;
...
begin
  if IsRectEmpty(ViewInfo.Bounds) then
    Result := 0
  else if GridView.IsEqualHeightRecords and CanCalculateVisibleEqualHeightRecordCount
  then
  begin // -2-4 ms
    ...
    else if AFirstRecordIndex - Result + 1 < FirstScrollRecordIndex then
...
begin
  if FAllowCheckEdit then
    FCheckEditNeeded := True;
end;
...
procedure TcxCustomGridTableController.SetFocusedRecord
  (Value: TcxCustomGridRecord);
begin
  if Value = nil then
...
var
  AIcxGridDataController: IcxGridDataController;
begin
  if not Supports(TObject(DataController), IcxGridDataController,
    AIcxGridDataController) or not AIcxGridDataController.SetScrollBarPos(Value)
  then
    if DataController.IsGridMode then
...
procedure TcxCustomGridTableController.SetTopRecordIndexWithOffset
  (ATopRecordIndex, ATopRecordOffset: Integer; AAnimated: Boolean = False);
var
  APrevTopRecordIndex: Integer;
begin
  if AAnimated then
    FRecordScrollAnimationHelper.SetPosition
      (TdxRecordPixelScrollData.Create(ATopRecordIndex, ATopRecordOffset))
  else
  begin
    if IsRecordScrollAnimationActive then
    begin
...
begin
  Result := inherited WantSpecialKey(AKey) or
    ((AKey = VK_RETURN) and (FocusedRecord <> nil) and
...
procedure TcxCustomGridTableController.
  CheckPixelScrollTopRecordIndexAndOffsetValues(var ATopRecordIndex,
  APixelScrollRecordOffset: Integer);
begin
  UpdatePixelScrollTopRecordIndexAndOffsetMaxValues;
  if (ATopRecordIndex > FPixelScrollTopRecordIndexMaxValue) or
    (ATopRecordIndex = FPixelScrollTopRecordIndexMaxValue) and
    (APixelScrollRecordOffset < FPixelScrollTopRecordOffsetMaxValue) then
  begin
...
procedure TcxCustomGridTableController.DoOverpan(AScrollKind: TScrollBarKind;
ADelta: Integer);
var
  AOverPan: TPoint;
begin
  ...
  TcxGridSiteAccess(Site).CheckOverpan(AScrollKind, 0, 1, -1, AOverPan.X,
    AOverPan.Y);
end;
...
function TcxCustomGridTableController.GetFirstIndexInScrollBand
  (ARecordIndexInBand: Integer): Integer;
begin
  Result := ARecordIndexInBand;
end;

function TcxCustomGridTableController.GetLastIndexInScrollBand
  (ARecordIndexInBand: Integer): Integer;
begin
  Result := GetFirstIndexInScrollBand(ARecordIndexInBand) +
    GetRecordCountInScrollBand(ARecordIndexInBand) - 1;
end;
...
begin
  ...
  if ScrollRecordCount > 0 then
    ANextBandRecordIndex := FirstScrollRecordIndex +
      Max(1, GetRecordCountInScrollBand(FirstScrollRecordIndex))
  else
  ...
  begin
    ...
    AIsAnyRowHeightChanged := AIsAnyRowHeightChanged or
      (ViewData.Records[I].FPixelScrollPosition <> Result);
    ViewData.Records[I].FPixelScrollPosition := Result;
  end;
  if LastScrollRecordIndex > -1 then
    Result := Result + ViewInfo.RecordsViewInfo.GetRecordScrollSize
      (LastScrollRecordIndex);
  if AIsAnyRowHeightChanged then
    GridView.InvalidateRecordPixelScrollSizeDependendScrollbarAnnotations;
end;

function TcxCustomGridTableController.GetRecordCountInScrollBand
  (ARecordIndexInBand: Integer): Integer;
begin
  Result := ScrollDelta;
end;

function TcxCustomGridTableController.IsRecordFullyVisibleAtBottom
  (ARecordIndex: Integer): Boolean;
begin
  Result := ARecordIndex < InternalTopRecordIndex + ViewInfo.VisibleRecordCount;
end;

function TcxCustomGridTableController.IsRecordFullyVisibleAtTop
  (ARecordIndex: Integer): Boolean;
begin
  Result := (ARecordIndex >= InternalTopRecordIndex) and
    not IsRecordPartVisibleAtTop(ARecordIndex);
end;

function TcxCustomGridTableController.IsRecordPartVisibleAtTop
  (ARecordIndex: Integer): Boolean;
begin
  Result := (PixelScrollRecordOffset <> 0) and
    (GetFirstIndexInScrollBand(ARecordIndex) = InternalTopRecordIndex);
end;

procedure TcxCustomGridTableController.
  UpdatePixelScrollTopRecordIndexAndOffsetMaxValues;
begin
  GetPixelScrollTopRecordIndexAndOffsetMaxValues
    (FPixelScrollTopRecordIndexMaxValue, FPixelScrollTopRecordOffsetMaxValue);
end;

procedure TcxCustomGridTableController.ScrollContentByGesture
  (AScrollKind: TScrollBarKind; ADelta: Integer);
var
  ARecordIndex, APixelScrollRecordOffset: Integer;
  AOverPan: Boolean;
begin
  if (ADelta = 0) or ViewData.IsEmpty then
    Exit;
  ARecordIndex := InternalTopRecordIndex;
  APixelScrollRecordOffset := PixelScrollRecordOffset;
  ViewInfo.RecordsViewInfo.CalculatePixelScrollInfo(ARecordIndex,
    APixelScrollRecordOffset, FPixelScrollTopRecordIndexMaxValue,
    FPixelScrollTopRecordOffsetMaxValue, ADelta, AOverPan);
...
function TcxCustomGridTableController.CanScrollData
  (ADirection: TcxDirection): Boolean;
begin
  Result := False;
end;

function TcxCustomGridTableController.GetScrollDataTimeInterval
  (ADirection: TcxDirection): Integer;
begin
  Result := ScrollTimeInterval;
end;

function TcxCustomGridTableController.CanPostponeRecordSelection
  (AShift: TShiftState): Boolean;
begin
  Result := not((ssLeft in AShift) and IsEditing) and
    (not(ssDouble in AShift) or (ssRight in AShift));
end;

function TcxCustomGridTableController.CanProcessMultiSelect
  (AIsKeyboard: Boolean): Boolean;
begin
...
begin
  Result := CanProcessMultiSelect(True) and IsKeyForMultiSelect(AKey, AShift,
    AFocusedRecordChanged);
end;

procedure TcxCustomGridTableController.ChangeRecordSelection
  (ARecord: TcxCustomGridRecord; Value: Boolean);
begin
  if MultiSelect then
    DataController.ChangeRowSelection(ARecord.Index, Value);
end;

procedure TcxCustomGridTableController.CheckFocusedRecordSelectionWhenExit
  (ARecord: TcxCustomGridRecord);
begin
  if GridView.OptionsSelection.UnselectFocusedRecordOnExit and MultiSelect and
    (ARecord <> nil) and (SelectedRecordCount = 1) and ARecord.Selected and not IsMultiSelectPersistent
  then
    ARecord.Selected := False;
end;

procedure TcxCustomGridTableController.DoMouseNormalSelection
  (AHitTest: TcxCustomGridHitTest);
begin
...
procedure TcxCustomGridTableController.DoMouseRangeSelection(AClearSelection
  : Boolean = True; AData: TObject = nil);
begin
...
procedure TcxCustomGridTableController.DoRangeSelection(AClearSelection
  : Boolean = True);
begin // !!!
  if (FocusedRecordIndex <> -1)
  { and not (dceInsert in DataController.EditState) } then
    DataController.SelectFromAnchor(FocusedRecordIndex,
      IsMultiSelectPersistent or not AClearSelection);
end;
...
begin
  Result := (AKey = VK_SPACE) or (AKey = VK_PRIOR) or (AKey = VK_NEXT) or
    AFocusedRecordChanged and not(((AKey = VK_INSERT) or (AKey = Ord('C'))) and
    (AShift = [ssCtrl])); // for grid mode
end;
...
function TcxCustomGridTableController.IsRecordSelected
  (ARecord: TcxCustomGridRecord): Boolean;
begin
  Result := DataController.IsRowSelected(ARecord.Index);
end;

procedure TcxCustomGridTableController.MultiSelectKeyDown(var Key: Word;
Shift: TShiftState);
begin
  ...
  else if (ssShift in Shift) and (Key <> 0) then
    DoRangeSelection
  else
  begin
...
procedure TcxCustomGridTableController.MultiSelectMouseDown
  (AHitTest: TcxCustomGridHitTest; AShift: TShiftState);
var
...
begin
  ...
  else if (ASelectionShift = [ssShift]) or (ASelectionShift = [ssCtrl, ssShift])
  then
    DoMouseRangeSelection(not(ssCtrl in AShift) or
      not SupportsAdditiveSelection, AHitTest)
  else
    ProcessNormalSelection;
end;

procedure TcxCustomGridTableController.MultiSelectMouseUp
  (AHitTest: TcxCustomGridHitTest; AShift: TShiftState);
var
  ASelectionShift: TShiftState;
begin
  if FIsRecordUnselecting and (FUnselectingRecordIndex <> -1) and
    (FUnselectingRecordIndex = TcxGridRecordHitTest(AHitTest).GridRecord.Index)
  then
  begin
    ASelectionShift := AShift - [ssLeft, ssRight, ssMiddle, ssDouble,
      ssPen, ssTouch];
    if (ASelectionShift = [ssCtrl]) and SupportsRecordSelectionToggling then
      DoToggleRecordSelection
    else if CanNormalSelectionOnMouse then
      DoNormalSelection;
  end;
end;
...
procedure TcxCustomGridTableController.SetSelectionAnchor(AGridRecordIndex
  : Integer);
begin
...
function TcxCustomGridTableController.CanFocusNextItem(AFocusedItemIndex,
  ANextItemIndex: Integer; AGoForward, AGoOnCycle, AGoToNextRecordOnCycle
  : Boolean): Boolean;
begin
  Result := ANextItemIndex <> -1;
end;

function TcxCustomGridTableController.FocusedRecordHasCells
  (ACheckCellSelectionAbility: Boolean): Boolean;
begin
...
procedure TcxCustomGridTableController.FocusPrevPage(ASyncSelection: Boolean);
  ...
  begin
    if IsRecordScrollAnimationActive then
      Result := FocusedRecordIndex = TargetRecordScrollIndex
      // IsFirstPageRecordFocused overrided !!!
    else
...
function TcxCustomGridTableController.IsKeyForController(AKey: Word;
AShift: TShiftState): Boolean;
begin
  Result := (AKey = VK_TAB) or (AKey = VK_UP) or (AKey = VK_DOWN) or
    (AKey = VK_PRIOR) or (AKey = VK_NEXT) or (AKey = VK_INSERT) or
    (AKey = VK_ESCAPE);
  Result := Result or ((AKey = Ord('F')) and (AShift = [ssCtrl]) and
    FindPanel.CanShow);
...
begin
  if not Supports(TObject(DataController), IcxGridDataController,
    AIcxGridDataController) or not AIcxGridDataController.DoScrollPage(AForward)
  then
    if AForward then
      ShowNextPage
    else
...
procedure TcxCustomGridTableController.ScrollRecords(AForward: Boolean;
ACount: Integer);
var
  APrevAllowAppendRecord: Boolean;
  AIcxGridDataController: IcxGridDataController;
...
begin
  ...
  try
    if not Supports(TObject(DataController), IcxGridDataController,
      AIcxGridDataController) or not AIcxGridDataController.DoScroll(AForward)
    then
    begin
      if IsRecordScrollAnimationActive then
      begin
      ...
      else if not IsRecordPixelScrolling or (ARecordOffset = 0) then
...
begin
  ...
  begin
    if IsRecordScrollAnimationActive then
      ATopRecordIndex := TargetRecordScrollIndex + GetPageVisibleRecordCount
        (TargetRecordScrollIndex, TargetRecordScrollOffset, True)
    else
...
begin
  ...
  begin
    ...
    Dec(ATopRecordIndex, GetPageVisibleRecordCount(ATopRecordIndex,
      ATopRecordOffset, False));
  end
  else
  begin
  ...
  SetTopRecordIndexWithOffset(ATopRecordIndex, 0, IsScrollAnimationEnabled and
    IsRecordPixelScrolling);
end;

procedure TcxCustomGridTableController.DoPullFocusing
  (AHitTest: TcxGridRecordHitTest);
begin
...
procedure TcxCustomGridTableController.DoPullFocusingScrolling
...
begin
  ...
  begin
    case ADirection of
      ...
      dirDown:
        FocusedRecordIndex := InternalTopRecordIndex +
          ViewInfo.VisibleRecordCount - 1;
    end;
    APrevAllowAppendRecord := AllowAppendRecord;
    AllowAppendRecord := False;
    try
      FocusNextRecord(FocusedRecordIndex, ADirection = dirDown, False,
        False, False);
    finally
      AllowAppendRecord := APrevAllowAppendRecord;
    end;
...
function TcxCustomGridTableController.GetPullFocusingScrollingDirection(X,
  Y: Integer; out ADirection: TcxDirection): Boolean;
var
  R: TRect;
begin
  Result := False;
...
begin
  Result := (FPullFocusingItem <> FocusedItem) or
    not VarEqualsExact(FPullFocusingRecordId,
    DataController.GetRowId(FocusedRecordIndex));
end;
...
procedure TcxCustomGridTableController.StartPullFocusing
  (AHitTest: TcxCustomGridHitTest);
begin
...
procedure TcxCustomGridTableController.StartPullFocusingScrolling
  (ADirection: TcxDirection);
begin
  FPullFocusingScrollingDirection := ADirection;
  if FPullFocusingScrollingTimer <> nil then
    Exit;
...
function TcxCustomGridTableController.GetDragScrollDirection(X, Y: Integer)
  : TcxDirection;
const
  ADirections: array [Boolean, Boolean] of TcxDirection = ((dirUp, dirDown),
    (dirLeft, dirRight));
var
  AHitTest: TcxCustomGridHitTest;
  ARecord: TcxCustomGridRecord;
begin
  ...
  begin
    ...
    else if IsLastRecordForDragScroll(ARecord) then
...
function TcxCustomGridTableController.IsFirstRecordForDragScroll
  (ARecord: TcxCustomGridRecord): Boolean;
begin
  Result := ARecord.Index = InternalTopRecordIndex;
end;

function TcxCustomGridTableController.IsLastRecordForDragScroll
  (ARecord: TcxCustomGridRecord): Boolean;
begin
...
begin
  ...
  else if AHitTest is TcxCustomGridViewHitTest then
    TcxCustomGridViewHitTest(AHitTest).GridView.Focused := True;
end;

procedure TcxCustomGridTableController.StartDragScroll
  (ADirection: TcxDirection);
begin
...
function TcxCustomGridTableController.GetDragOpenInfo
  (AHitTest: TcxCustomGridHitTest): TcxCustomGridDragOpenInfo;
begin
  if AHitTest.HitTestCode = htExpandButton then
    Result := TcxGridDragOpenInfoExpand.Create
      (TcxGridExpandButtonHitTest(AHitTest).GridRecord)
  else
    Result := nil;
end;

function TcxCustomGridTableController.IsDragOpenHitTest
  (AHitTest: TcxCustomGridHitTest;
out ADragOpenInfo: TcxCustomGridDragOpenInfo): Boolean;
begin
...
function TcxCustomGridTableController.GetItemForIncSearching
  : TcxCustomGridTableItem;
begin
...
procedure TcxCustomGridTableController.IncSearchKeyDown(var Key: Word;
Shift: TShiftState);
begin
  case Key of
    VK_ESCAPE:
    ...
    VK_BACK:
      begin
        IncSearchingText := Copy(IncSearchingText, 1,
          Length(IncSearchingText) - 1);
        Key := 0;
      end;
    VK_UP, VK_DOWN:
      if Shift = [ssCtrl] then
      begin
        DataController.Search.LocateNext(Key = VK_DOWN, False,
          not IsMultiSelectPersistent);
        Key := 0;
      end;
  end;
...
function TcxCustomGridTableController.GetEditingControllerClass
  : TcxGridEditingControllerClass;
begin
...
procedure TcxCustomGridTableController.DoKeyDown(var Key: Word;
Shift: TShiftState);
var
...
begin
  ...
  try
    try
      ...
      inherited;
      if AGridViewLink.Ref <> nil then
        if not(ASaveKey in [VK_TAB, VK_RETURN]) and
          CanProcessMultiSelect(Key, Shift, FocusedRecordIndex <>
          APrevFocusedRecordIndex) then
...
begin
  if not FindNextCustomItem(AFocusedItemIndex, GridView.VisibleItemCount,
    AGoForward, AGoOnCycle, @cxCustomGridTableControllerCanFocusItem, ARecord,
    Result, ACycleChanged) then
    Result := -1;
end;

function TcxCustomGridTableController.FindNextRecord(AFocusedRecordIndex
  : Integer; AGoForward, AGoOnCycle: Boolean;
out ACycleChanged: Boolean): Integer;
begin
  if DataController.IsGridMode then
    if AGoForward then
      if not DataController.IsEof and
        (AFocusedRecordIndex = ViewData.RecordCount - 1) then
      begin
    ...
    else if (AFocusedRecordIndex = 0) and not DataController.IsBof then
    begin
      DataController.Scroll(-1);
      if not DataController.IsBof then
        Inc(AFocusedRecordIndex);
    end;
  if not FindNextCustomItem(AFocusedRecordIndex, ViewData.RecordCount,
    AGoForward, AGoOnCycle, @cxCustomGridTableControllerCanFocusRecord, nil,
    Result, ACycleChanged) then
    Result := -1;
end;
...
begin
  ...
  { IsEditing } (FEditingController.Edit <> nil) and
    FEditingController.Edit.IsFocused or IsFindPanelVisible and
...
function TcxCustomGridTableController.IMEComposition(var AMessage
  : TMessage): Boolean;
begin
...
function TcxCustomGridTableController.IsClickableRecordHitTest
...
begin
  Result := (ACell <> nil) and (FClickedDataCellInfo.Cell <> nil) and
    ...
    (ACell.Item = FClickedDataCellInfo.Item) and
    (ACell.GridRecord.RecordIndex = FClickedDataCellInfo.RecordIndex));
end;

function TcxCustomGridTableController.IsPixelBasedScrollDataPos: Boolean;
begin
  Result := IsRecordPixelScrolling and
    (ScrollRecordCount < ViewInfo.RecordsViewInfo.GetPixelScrollContentSize);
end;
...
function TcxCustomGridTableController.IsRecordScrollable
  (ARecordIndex: Integer): Boolean;
begin
  Result := (ARecordIndex >= FirstScrollRecordIndex) and
    (ARecordIndex <= LastScrollRecordIndex);
end;
...
begin
  Result := not ViewData.IsRecordIndexValid(FInternalTopRecordIndex) and
    not(DataController.IsGridMode and
    (FInternalTopRecordIndex = cxRecordIndexNone));
end;

function TcxCustomGridTableController.IsDataFullyVisible(AIsCallFromMaster
  : Boolean = False): Boolean;
begin
  Result := ViewInfo.VisibleRecordCount = ScrollRecordCount;
end;

procedure TcxCustomGridTableController.KeyDown(var Key: Word;
Shift: TShiftState);
var
...
begin
  ...
  case Key of
    VK_INSERT:
      ...
      else if (Shift = [ssCtrl]) and CanCopyToClipboard then
    ...
    VK_ESCAPE:
      ...
      begin
        DataController.Cancel;
        if not DataController.IsEditing and MultiSelect and
          (FocusedRecord <> nil) then
          FocusedRecord.Selected := True;
        Key := 0;
      end;
    VK_RETURN, VK_TAB:
      if (Key = VK_RETURN) and GridView.OptionsBehavior.GoToNextCellOnEnter or
        (Key = VK_TAB) and (GridView.OptionsBehavior.FocusCellOnTab or
        IsFindPanelVisible) then
      begin
        ARemoveFocus := False;
        if (Key = VK_TAB) and IsFindPanelVisible and
          not GridView.OptionsBehavior.FocusCellOnTab then
          ARemoveFocus := not EditingController.IsEditing
        else if Shift + [ssShift] = [ssShift] then
          if FocusNextCell(Shift = [], False, True, False, MultiSelect and
            not IsMultiSelectPersistent) or (Key = VK_RETURN) then
            Key := 0
          else
            ARemoveFocus := not EditingController.IsEditing
        else
          ARemoveFocus := (Key = VK_TAB) and
            (Shift + [ssShift, ssCtrl] = [ssShift, ssCtrl]);
        if ARemoveFocus then
          TcxCustomGrid(GridView.Control).RemoveFocus(not(ssShift in Shift));
      end;
    VK_PRIOR:
      AllowRecordScrollAnimationOnMakeVisible(procedure
        begin
          FocusPrevPage(False);
        end);
    VK_NEXT:
    ...
    VK_F3:
      if (DataController.FindCriteria.Behavior = fcbSearch) and
        DataController.FindCriteria.IsActive then
      begin
        AllowRecordScrollAnimationOnMakeVisible(procedure
          begin
...
begin
  ...
  // inc search
  if IsIncSearchStartChar(Key) and (ItemForIncSearching <> nil) and
    ItemForIncSearching.CanIncSearch and not DataController.IsEditing then
  begin
    if Key <> #8 then
  ...
  // editing
  if IsEditStartChar(Key) and (FocusedRecord <> nil) and
    FocusedRecord.HasCells and (FocusedItem <> nil) then
  begin
    ...
    try
      ...
      begin
        ...
        begin
          ...
          if cxShiftStateLeftOnly(Shift) and IsClickableRecordHitTest(AHitTest)
            and SupportsPullFocusing and Site.MouseCapture and
            (GridView.DragMode = dmManual) then
...
procedure TcxCustomGridTableController.MouseMove(Shift: TShiftState;
X, Y: Integer);
var
  AHitTest: TcxCustomGridHitTest;
  ADirection: TcxDirection;
begin
  ...
  begin
    ...
    else if GetPullFocusingScrollingDirection(X, Y, ADirection) then
...
function TcxCustomGridTableController.ProcessDetailDialogChar
  (ADetail: TcxCustomGridView; ACharCode: Word): Boolean;
var
  ARecord: TcxCustomGridRecord;
begin
...
function TcxCustomGridTableController.ProcessDialogChar
  (ACharCode: Word): Boolean;
begin
  Result := (FocusedRecord <> nil) and (FocusedRecord.ViewInfo <> nil) and
    FocusedRecord.ViewInfo.ProcessDialogChar(ACharCode) or
    inherited ProcessDialogChar(ACharCode);
end;

procedure TcxCustomGridTableController.SetFocusOnMouseClick
...
function TcxCustomGridTableController.SupportsTabAccelerators
  (AGridRecord: TcxCustomGridRecord): Boolean;
begin
...
State: TDragState; var Accept: Boolean);
  ...
  begin
    AHitTest := ViewInfo.GetHitTest(X, Y);
    if (State <> dsDragLeave) and IsDragOpenHitTest(AHitTest, ADragOpenInfo)
    then
...
begin
  ...
  if (State <> dsDragLeave) and
    (GridView.OptionsBehavior.DragFocusing = dfDragOver) then
    ProcessDragFocusing(X, Y);
end;

procedure TcxCustomGridTableController.DrawDragImage(ACanvas: TcxCanvas;
R: TRect);
var
  AParams: TcxViewParams;
...
function TcxCustomGridTableController.GetDragDropText
  (ADragObject: TDragObject): string;
begin
...
procedure TcxCustomGridTableController.GetDragDropTextViewParams
  (out AParams: TcxViewParams);
begin
...
begin
  ...
  begin
    ...
    Result := Point(DragDropTextAreaOffset + DragDropTextIndent +
      ACanvas.TextWidth(FDragDropText) + DragDropTextIndent,
      DragDropTextIndent + ACanvas.TextHeight(FDragDropText) +
      DragDropTextIndent);
  end;
end;
...
function TcxCustomGridTableController.CheckEditing(var AFocusedRecordIndex
  : Integer; AGoForward: Boolean): Boolean;
...
begin
  ...
  try
    try
      if DataController.IsEditing then
      begin
        ACheckFocusedRecordIndex := CheckFocusedRecordIndex
          (DataController.IsImmediatePost);
...
begin
  ...
  else if CanInsert(False) then
  begin
    DataController.Insert;
    if MultiSelect and (ViewData.EditingRecord <> nil) then
      ViewData.EditingRecord.Selected := True;
  end;
  if (dceInsert in DataController.EditState) and GridView.OptionsBehavior.FocusFirstCellOnNewRecord
  then
  begin
...
AProcessCellsOnly: Boolean = True; AAllowCellsCycle: Boolean = True;
AFollowVisualOrder: Boolean = True;
ANeedNormalizeSelection: Boolean = False): Boolean;
begin
  ...
  else if AProcessCellsOnly or not GridView.OptionsBehavior.FocusCellOnCycle
  then
    Result := False
  else
  begin
    Result := FocusNextRecord(FocusedRecordIndex, AGoForward, False,
      False, False);
    if FocusedRecordHasCells(True) then
      FocusNextItem(-1, AGoForward, True, False, AFollowVisualOrder,
        ANeedNormalizeSelection);
  end;
end;

function TcxCustomGridTableController.FocusNextItem(AFocusedItemIndex: Integer;
AGoForward, AGoOnCycle, AGoToNextRecordOnCycle, AFollowVisualOrder: Boolean;
ANeedNormalizeSelection: Boolean = False): Boolean;
var
...
begin
  ANextItemIndex := FindNextItem(AFocusedItemIndex, AGoForward,
    AGoOnCycle or AGoToNextRecordOnCycle, AFollowVisualOrder, ACycleChanged,
    FocusedRecord);
...
function TcxCustomGridTableController.FocusNextRecord(AFocusedRecordIndex
  : Integer; AGoForward, AGoOnCycle, AGoIntoDetail, AGoOutOfDetail
  : Boolean): Boolean;
var
  AGridViewLink: TcxObjectLink;
  ...
  begin
    if GridView.Focused = APrevFocused then
      Exit;
  ...
  try
    ...
    try
      if AGoForward and AGoIntoDetail and GridView.IsMaster and
        ...
        ANextRecord := ViewData.Records[AFocusedRecordIndex]
      ...
      begin
        ...
        else if AGoForward and CanAppend(True) and
          (DataController.EditState <> [dceInsert]) then
        begin
          CreateNewRecord(True);
          Result := True;
          Exit;
        end
        else if GridView.IsDetail and AGoOutOfDetail then
...
function TcxCustomGridTableController.FocusNextRecordWithSelection
  (AFocusedRecordIndex: Integer; AGoForward, AGoOnCycle, AGoIntoDetail: Boolean;
ASyncSelection: Boolean = True): Boolean;
begin
...
begin
  if not IsFocusing and not(FIsDetailRecordFocusing and
    (IsRecordPixelScrolling or GridView.HasPixelScrollingMaster)) then
    MakeRecordVisible(FocusedRecord);
end;

procedure TcxCustomGridTableController.MakeRecordVisible
  (ARecord: TcxCustomGridRecord);
begin
...
function TcxCustomGridTableController.GoToFirst(ASyncSelection
...
procedure TcxCustomGridTableController.InternalDoMakeRecordVisible
  (ARecord: TcxCustomGridRecord);
var
...
begin
  ...
  AAnimated := FAllowRecordScrollAnimationOnMakeVisible and
    IsScrollAnimationEnabled and not EditingController.EditingItemSetting;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        if IsRecordPixelScrolling then
        begin
          GetPixelScrollTopRecordIndexAndOffsetByBottomRecord(AIndex, ATopIndex,
            ATopOffset);
...
begin
  if DataController.IsGridMode then
    ...
    Result := FindNextRecord(FocusedRecordIndex, True, False,
      ACycleChanged) = -1;
end;
...
begin
  if DataController.IsGridMode then
    ...
    Result := FindNextRecord(FocusedRecordIndex, False, False,
      ACycleChanged) = -1;
end;
...
procedure TcxGridDataController.AssignData(ADataController
...
function TcxGridDataController.GetItemDataBindingClass
  : TcxGridItemDataBindingClass;
begin
  Result := TcxGridItemDataBinding;
end;

function TcxGridDataController.GetItemDefaultValuesProviderClass
  : TcxCustomEditDefaultValuesProviderClass;
begin
...
function TcxGridDataController.CompareByField(ARecordIndex1,
...
begin
  if GridView.ViewData.NeedsCustomDataComparison(AField, AMode) then
    Result := GridView.ViewData.CustomCompareDataValues(AField,
      GetComparedValue(ARecordIndex1, AField), GetComparedValue(ARecordIndex2,
      AField), AMode)
  else
    Result := inherited CompareByField(ARecordIndex1, ARecordIndex2,
      AField, AMode);
end;

function TcxGridDataController.CreateExpressionProvider
...
function TcxGridDataController.GetFilterCriteriaClass
  : TcxDataFilterCriteriaClass;
begin
  Result := TcxGridDataFilterCriteria;
end;

function TcxGridDataController.GetFilterDisplayText(ARecordIndex,
  AItemIndex: Integer): string;
begin
  if GridView.ViewData.HasCustomDataHandling(Fields[AItemIndex], doFiltering)
  then
    Result := GridView.ViewData.GetCustomDataDisplayText(ARecordIndex,
      AItemIndex, doFiltering)
  else
...
function TcxGridDataController.GetSortingBySummaryEngineClass
  : TcxSortingBySummaryEngineClass;
begin
  Result := GridView.ViewData.GetSortingBySummaryEngineClass;
end;

function TcxGridDataController.GetSummaryGroupItemLinkClass
  : TcxDataSummaryGroupItemLinkClass;
begin
...
function TcxGridDataController.CreateDetailLinkObject
  (ARelation: TcxCustomDataRelation; ARecordIndex: Integer): TObject;
begin
  Result := TcxGridLevelAccess(ARelation.Item).CreateLinkObject(ARelation,
    ARecordIndex);
end;

procedure TcxGridDataController.FocusControl(AItemIndex: Integer;
var Done: Boolean);
begin
  inherited;
...
function TcxGridDataController.GetDetailDataControllerByLinkObject
...
function TcxGridDataController.GetDisplayText(ARecordIndex,
  AItemIndex: Integer): string;
begin
...
function TcxGridDataController.GetFilterDataValue(ARecordIndex: Integer;
...
function TcxGridDataController.GetFilterItemFieldCaption
  (AItem: TObject): string;
begin
...
function TcxGridDataController.GetItemValueSource(AItemIndex: Integer)
  : TcxDataEditValueSource;
begin
...
constructor TcxCustomGridPartViewInfo.Create(AGridViewInfo
...
function TcxCustomGridPartViewInfo.CustomDrawBackground
...
function TcxCustomGridPartViewInfo.GetPainterClass
...
procedure TcxGridPinViewInfo.Calculate(ALeftBound, ATopBound: Integer;
...
begin
  Result := ScaleFactor.Apply(Rect(cxGridPinLeftMargin, 0,
    cxGridPinRightMargin, 0));
end;
...
constructor TcxGridPartContainerItemViewInfo.Create
  (AContainer: TcxGridPartContainerButtonsViewInfo);
begin
  inherited Create(AContainer.Owner.GridViewInfo);
  FContainer := AContainer;
end;

function TcxGridPartContainerItemViewInfo.MouseDown
...
function TcxGridPartContainerItemViewInfo.MouseUp
  (AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
AShift: TShiftState): Boolean;
begin
  if not Enabled then
...
function TcxGridPartContainerItemViewInfo.
  GetAdornerTargetElementVisible: Boolean;
begin
  Result := inherited GetAdornerTargetElementVisible and
    Container.Owner.Visible;
end;

function TcxGridPartContainerItemViewInfo.GetAlignment
  : TcxGridFilterButtonAlignment;
begin
  Result := fbaLeft;
end;
...
procedure TcxGridFindPanelEditViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
...
function TcxGridFindPanelEditViewInfo.GetHitTest(const P: TPoint)
...
begin
  AWidth := EnsureRange(AWidth, Container.GetEditMinWidth,
    Container.GetEditMaxWidth);
end;
...
procedure TcxGridFindPanelEditViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
  GridView.Styles.GetViewParams(vsFindPanel, nil, nil, AParams);
end;
...
function TcxGridFindPanelEditViewInfo.GetContainer
  : TcxGridFindPanelButtonsViewInfo;
begin
  Result := TcxGridFindPanelButtonsViewInfo(inherited Container);
end;

function TcxGridFindPanelEditViewInfo.GetController
  : TcxCustomGridTableController;
begin
  Result := TcxCustomGridTableController(inherited Controller);
end;
...
function TcxGridPartCloseButtonViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  Result := BorderWidth[bTop] + BorderWidth[bBottom] + TextHeightWithOffset + 2
    * LookAndFeelPainter.ScaledButtonTextOffset(ScaleFactor);
end;

function TcxGridPartButtonViewInfo.DoCalculateWidth: Integer;
begin
  Result := BorderWidth[bLeft] + BorderWidth[bRight] + TextWidthWithOffset + 2 *
    LookAndFeelPainter.ScaledButtonTextOffset(ScaleFactor);
end;
...
function TcxGridPartButtonViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  Result := Controller.FindPanel.IsItemFocused(Kind) and
    GridView.IsControlFocused;
end;

function TcxGridFindPanelCloseButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridFindPanelCloseButtonViewInfo.GetContainer
  : TcxGridFindPanelButtonsViewInfo;
begin
  Result := TcxGridFindPanelButtonsViewInfo(inherited Container);
end;

function TcxGridFindPanelCloseButtonViewInfo.GetController
  : TcxCustomGridTableController;
begin
  Result := TcxCustomGridTableController(inherited Controller);
end;
...
begin
  Result := Max(inherited DoCalculateHeight,
    ScaleFactor.Apply(FindPanel.ButtonMinHeight));
end;

function TcxGridFindPanelButtonViewInfo.DoCalculateWidth: Integer;
begin
  Result := Max(inherited DoCalculateWidth,
    ScaleFactor.Apply(FindPanel.ButtonMinWidth));
end;

function TcxGridFindPanelButtonViewInfo.GetAlignment
  : TcxGridFilterButtonAlignment;
begin
  Result := fbaRight;
end;
...
function TcxGridFindPanelButtonViewInfo.GetContainer
  : TcxGridFindPanelButtonsViewInfo;
begin
  Result := TcxGridFindPanelButtonsViewInfo(inherited Container);
end;

function TcxGridFindPanelButtonViewInfo.GetController
  : TcxCustomGridTableController;
begin
  Result := TcxCustomGridTableController(inherited Controller);
end;
...
function TcxGridFindPanelFindButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridFindPanelClearButtonViewInfo.
  GetAdornerTargetElementName: string;
begin
  Result := 'ClearButton';
end;

function TcxGridFindPanelClearButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridFindPanelNextButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridFindPanelPreviousButtonViewInfo.
  GetAdornerTargetElementName: string;
begin
  Result := 'Previous';
end;

function TcxGridFindPanelPreviousButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridFilterCloseButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridFilterCloseButtonViewInfo.GetContainer
  : TcxGridFilterButtonsViewInfo;
begin
...
function TcxGridFilterActivateButtonViewInfo.GetContainer
  : TcxGridFilterButtonsViewInfo;
begin
  Result := TcxGridFilterButtonsViewInfo(inherited Container);
end;
...
function TcxGridFilterActivateButtonViewInfo.
  GetAdornerTargetElementName: string;
begin
  Result := 'ActivationButton';
end;

function TcxGridFilterActivateButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
  Result := TcxGridFilterActivateButtonHitTest;
end;

function TcxGridFilterActivateButtonViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
function TcxGridFilterDropDownButtonViewInfo.GetContainer
  : TcxGridFilterButtonsViewInfo;
begin
  Result := TcxGridFilterButtonsViewInfo(inherited Container);
end;

function TcxGridFilterDropDownButtonViewInfo.GetDropDownWindowValue
  : TcxGridFilterMRUItemsPopup;
begin
...
function TcxGridFilterDropDownButtonViewInfo.
  GetAdornerTargetElementName: string;
begin
  Result := 'MRUListButton';
end;

function TcxGridFilterDropDownButtonViewInfo.GetAlignment
  : TcxGridFilterButtonAlignment;
begin
  Result := fbaRight;
end;

function TcxGridFilterDropDownButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
  Result := TcxGridFilterDropDownButtonHitTest;
end;

function TcxGridFilterDropDownButtonViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
function TcxGridFilterDropDownButtonViewInfo.GetDropDownWindow
...
function TcxGridFilterDropDownButtonViewInfo.
  GetDropDownWindowOwnerBounds: TRect;
begin
  Result := Bounds;
...
procedure TcxGridFilterDropDownButtonViewInfo.Calculate(ALeftBound,
  ATopBound: Integer; AWidth: Integer = -1; AHeight: Integer = -1);
begin
  ALeftBound := Min(ALeftBound, Container.FilterViewInfo.TextBounds.Right +
    ScaleFactor.Apply(cxGridCellTextOffset) + FilterTextOffset +
    Container.GetButtonsOffset);
  inherited;
end;
...
function TcxGridFilterCustomizeButtonViewInfo.
  GetAdornerTargetElementName: string;
begin
  Result := 'CustomizationButton';
end;

function TcxGridFilterCustomizeButtonViewInfo.GetAlignment
  : TcxGridFilterButtonAlignment;
begin
  Result := GridView.FilterBox.CustomizeButtonAlignment;
end;

function TcxGridFilterCustomizeButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
procedure TcxGridFilterCustomizeButtonViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
function TcxGridFilterCustomizeButtonViewInfo.GetContainer
  : TcxGridFilterButtonsViewInfo;
begin
  Result := TcxGridFilterButtonsViewInfo(inherited Container);
end;
...
constructor TcxGridPartContainerButtonsViewInfo.Create
  (AOwner: TcxGridPartContainerViewInfo);
begin
  inherited Create;
  FOwner := AOwner;
...
function TcxGridPartContainerButtonsViewInfo.AddItem
  (AItemClass: TcxGridPartContainerItemViewInfoClass)
  : TcxGridPartContainerItemViewInfo;
begin
...
function TcxGridPartContainerButtonsViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  I: Integer;
begin
...
procedure TcxGridPartContainerButtonsViewInfo.AddAdornerTargetElements
  (AList: TStrings);
var
  I: Integer;
begin
...
function TcxGridPartContainerButtonsViewInfo.IsItemCalculatedSingly
  (AItem: TcxGridPartCustomCellViewInfo): Boolean;
begin
  Result := False;
end;

procedure TcxGridPartContainerButtonsViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
...
function TcxGridPartContainerButtonsViewInfo.GetTopBound
  (AItem: TcxGridPartCustomCellViewInfo; ABounds: TRect): Integer;
begin
...
function TcxGridPartContainerButtonsViewInfo.GetGridView
  : TcxCustomGridTableView;
begin
...
begin
  ...
  for I := 0 to Count - 1 do
    ...
    begin
      ...
      if Result < AItemHeight then
        Result := AItemHeight;
    end;
  if Result <> 0 then
  begin
    Inc(Result, 2 * GetFirstOffset);
    Inc(Result, TdxVisualRefinements.Padding.ScaledHeight(ScaleFactor));
  end;
end;

function TcxGridPartContainerButtonsViewInfo.GetItem(Index: Integer)
  : TcxGridPartContainerItemViewInfo;
begin
...
function TcxGridPartContainerButtonsViewInfo.GetWidth
  (AAlignment: TcxGridFilterButtonAlignment): Integer;
var
  I: Integer;
...
begin
  ...
  begin
    AItem := Items[I];
    if AItem.Visible and not IsItemCalculatedSingly(AItem) and
      (AItem.Alignment = AAlignment) then
...
procedure TcxGridPartContainerButtonsViewInfo.RightToLeftConversion
  (const ABounds: TRect);
begin
...
begin
  ...
  FDropDownButtonViewInfo := AddItem(TcxGridFilterDropDownButtonViewInfo)
    as TcxGridFilterDropDownButtonViewInfo;
end;
...
function TcxGridFilterButtonsViewInfo.GetWidth
  (AAlignment: TcxGridFilterButtonAlignment): Integer;
begin
...
begin
  ...
  FEditViewInfo := TcxGridFindPanelEditViewInfo
    (AddItem(TcxGridFindPanelEditViewInfo));
...
procedure TcxGridFindPanelButtonsViewInfo.CalculateEditViewInfo
  (const ABounds: TRect);
var
  AWidth: Integer;
begin
  AWidth := Max(0, cxRectWidth(ABounds) - WidthLeftPart - WidthRightPart);
  EditViewInfo.Calculate(ABounds.Left + WidthLeftPart,
    GetTopBound(EditViewInfo, ABounds), AWidth);
end;
...
function TcxGridFindPanelButtonsViewInfo.GetWidth
  (AAlignment: TcxGridFilterButtonAlignment): Integer;
begin
  Result := inherited GetWidth(AAlignment);
...
function TcxGridFindPanelButtonsViewInfo.IsItemCalculatedSingly
  (AItem: TcxGridPartCustomCellViewInfo): Boolean;
begin
...
begin
  ...
  for I := Count - 1 downto 0 do
    ...
    begin
      ...
      begin
        AOffset := EditViewInfo.Bounds.Right + GetButtonsOffset -
          Items[I].Bounds.Left;
...
function TcxGridFindPanelButtonsViewInfo.GetFindPanelViewInfo
  : TcxGridFindPanelViewInfo;
begin
...
constructor TcxGridPartContainerViewInfo.Create(AGridViewInfo
  : TcxCustomGridTableViewInfo);
begin
  inherited;
...
function TcxGridPartContainerViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
...
procedure TcxGridPartContainerViewInfo.GetAdornerTargetElements
  (AList: TStrings);
begin
  inherited GetAdornerTargetElements(AList);
...
procedure TcxGridPartContainerViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
...
constructor TcxGridFilterViewInfo.Create(AGridViewInfo
  : TcxCustomGridTableViewInfo);
begin
  inherited Create(AGridViewInfo);
...
procedure TcxGridFilterViewInfo.Calculate(ALeftBound: Integer;
ATopBound: Integer; AWidth: Integer = -1; AHeight: Integer = -1);
begin
  inherited Calculate(ALeftBound, ATopBound, AWidth, AHeight);
...
begin
  if IsTokenCriteriaVisible and TokenCriteriaViewInfo.HasMouse(AHitTest.Pos)
  then
  begin
...
function TcxGridFilterViewInfo.MouseMove(AHitTest: TcxCustomGridHitTest;
AShift: TShiftState): Boolean;
begin
  if IsTokenCriteriaVisible and TokenCriteriaViewInfo.HasMouse(AHitTest.Pos)
  then
...
begin
  CalculateParams;
  Result := Max(inherited CalculateHeight, TextHeightWithOffset + 2 *
    FilterTextOffset);
  if TokenCriteriaViewInfo <> nil then
    Result := Max(Result, TokenCriteriaViewInfo.ContentHeight + 2 *
      GetFirstOffset);
end;
...
begin
  ...
  Result.Left := Result.Left + FButtonsViewInfo.WidthLeftPart +
    FilterTextOffset;
  Result.Right := Result.Right - FButtonsViewInfo.WidthRightPart -
    FilterTextOffset;
end;

function TcxGridFilterViewInfo.CreateButtonsViewInfo
  : TcxGridPartContainerButtonsViewInfo;
begin
  Result := TcxGridFilterButtonsViewInfo.Create(Self);
end;

function TcxGridFilterViewInfo.CreateTokenCriteriaViewInfo
...
function TcxGridFilterViewInfo.HasMouse(AHitTest: TcxCustomGridHitTest)
  : Boolean;
begin
...
begin
  Result := GridView.Filtering.IsMRUItemsListAvailable and
    not GridView.FilterBox.UseTokens;
end;
...
function TcxGridFilterViewInfo.GetTokenCriteriaOptions
  : IdxFilterBoxTokenCriteriaOptions;
begin
  Result := GridView.FilterBox.TokenCriteria;
end;

procedure TcxGridFilterViewInfo.GetTokenCriteriaParams
  (var AParams: TcxViewParams);
begin
...
function TcxGridFindPanelViewInfo.CreateButtonsViewInfo
  : TcxGridPartContainerButtonsViewInfo;
begin
...
begin
  Result := FindPanel.ButtonsOffset;
end;
...
function TcxGridFindPanelViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
function TcxGridFindPanelViewInfo.GetButtonsViewInfo
  : TcxGridFindPanelButtonsViewInfo;
begin
...
constructor TcxGridTableCellViewInfo.Create(ARecordViewInfo
...
function TcxGridTableCellViewInfo.GetCacheItem
...
begin
  Result := inherited GetHotTrack or
    RecordViewInfo.InvalidateOnChildHotTrackChanged;
end;

procedure TcxGridTableCellViewInfo.GetFindTextSelectionInfo
  (out ASelStart: Integer; out AHighlightedText: string);
begin
  ASelStart := -1;
  AHighlightedText := '';
end;
...
var
  AParams, AHighlightParams: TcxViewParams;
begin
  GetViewParams(AParams);
  GridView.Styles.GetViewParams(vsSearchResultHighlight, nil, nil,
    AHighlightParams);
  TextSelBkColor := AHighlightParams.Color;
  TextSelColor := AHighlightParams.TextColor;
  if TextSelBkColor = clDefault then
    if TextSelColor = clDefault then
      if AParams.Color = clHighlight then
      begin
        TextSelBkColor := clBlack;
        TextSelColor := clWhite;
      end
      else
      begin
        TextSelBkColor := clHighlight;
        TextSelColor := clHighlightText;
      end
    else
      TextSelBkColor := dxInvertColor(TextSelColor)
  else if TextSelColor = clDefault then
    TextSelColor := dxInvertColor(TextSelBkColor)
end;
...
constructor TcxGridTableDataCellViewInfo.Create(ARecordViewInfo
  : TcxCustomGridRecordViewInfo; AItem: TcxCustomGridTableItem);
begin
...
procedure TcxGridTableDataCellViewInfo.AfterDrawCellBackgroundHandler
  (Sender: TcxCustomEditViewInfo; ACanvas: TcxCanvas);
begin
  if FConditionalFormattingProvider <> nil then
    FConditionalFormattingProvider.AfterDrawCellBackground(Self,
      Sender.BackgroundColor, ACanvas);
end;

procedure TcxGridTableDataCellViewInfo.AfterDrawCellValueHandler
  (Sender: TcxCustomEditViewInfo; ACanvas: TcxCanvas);
begin
  if FConditionalFormattingProvider <> nil then
...
procedure TcxGridTableDataCellViewInfo.CalculateEditorBoundsHandler
  (AViewInfo: TcxCustomEditViewInfo; var R: TRect);
begin
  if FConditionalFormattingProvider <> nil then
    FConditionalFormattingProvider.CalculateCellEditorBounds(Self, R);
end;

procedure TcxGridTableDataCellViewInfo.CanDrawEditValueHandler
  (Sender: TcxCustomEditViewInfo; var Allow: Boolean);
begin
  if FConditionalFormattingProvider <> nil then
...
procedure TcxGridTableDataCellViewInfo.SetUsedForPaintingHiddenEditor
  (AValue: Boolean);
begin
...
procedure TcxGridTableDataCellViewInfo.InitializeByHiddenEditor
  (AEditViewInfo: TcxCustomEditViewInfo; AEdit: TcxCustomEdit);
var
...
begin
  ...
  AViewData := TcxCustomEditAccess(AEdit).CreateViewData;
  try
    AViewData.Focused := True;
    if AEdit is TcxCustomTextEdit then
    begin
      ATextEdit := TcxCustomTextEdit(AEdit);
      ATextViewData := TcxCustomTextEditViewData(AViewData);
      ATextViewData.DisplayValueToDrawValue(ATextEdit.EditingText,
        AEditViewInfo);
      ATextViewData.SelStart := ATextEdit.SelStart;
      ATextViewData.SelLength := ATextEdit.SelLength;
      ATextViewData.SelBackgroundColor := clHighlight;
      ATextViewData.SelTextColor := clHighlightText;
      ATextViewData.PrepareSelection(AEditViewInfo);
    end
    else
      AViewData.EditValueToDrawValue(AEdit.EditingValue, AEditViewInfo);
  finally
    AViewData.Free;
  end;
end;

procedure TcxGridTableDataCellViewInfo.CalculateEditViewInfo
...
begin
  ...
  try
    ...
    FEditViewData.Calculate(Canvas, EditViewDataBounds, AMousePos, cxmbNone, [],
      AEditViewInfo, True);
  finally
    DestroyEditViewData;
  end;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        Inc(Width, 2 * (ScaleFactor.Apply(cxGridCellTextOffset) -
          cxGridEditOffset));
      end;
      ...
      if Result <> Item.EmptyEditorHeight then
        Inc(Result, 2 * cxGridEditOffset)
      else if not SupportsZeroHeight then
...
function TcxGridTableDataCellViewInfo.CanActivateEditOnMouseDown
  (AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
AShift: TShiftState): Boolean;
begin
...
function TcxGridTableDataCellViewInfo.CanImmediateEdit
  (AHitTest: TcxCustomGridHitTest): Boolean;
begin
...
begin
  ...
  Result := (AControl <> nil) and AControl.HandleAllocated and
    not(csDestroyingHandle in AControl.ControlState);
end;
...
procedure TcxGridTableDataCellViewInfo.CheckEditHotTrack
...
function TcxGridTableDataCellViewInfo.EditOwnerGetViewData
...
procedure TcxGridTableDataCellViewInfo.EditOwnerInvalidate(const R: TRect;
...
begin
  ...
  if GridView.HasConditionalFormattingProvider then
    Result := GridView.ConditionalFormattingProvider.FormatDisplayValue
      (Self, Result);
end;
...
function TcxGridTableDataCellViewInfo.GetEditSize(AEditSizeProperties
  : TcxEditSizeProperties): TSize;
begin
  FEditViewData.InplaceEditParams.Position := GetInplaceEditPosition;
  with Controller do
  begin
    if AutoHeight and (EditingItem = Item) and
      EditingController.IsEditAutoHeight and RecordViewInfo.Focused then
      Result := FEditViewData.GetEditingSize(Canvas,
        EditingController.Edit.EditingValue, AEditSizeProperties)
    else
      Result := FEditViewData.GetEditSize(Canvas, DisplayValue,
        AEditSizeProperties);
  end
end;
...
procedure TcxGridTableDataCellViewInfo.GetEditViewDataContentOffsets
  (var R: TRect);
begin
  R.Init(cxGridEditOffset, cxGridEditOffset, cxGridEditOffset,
    cxGridEditOffset);
end;

procedure TcxGridTableDataCellViewInfo.GetEditViewDataFindTextSelectionInfo
  (out ASelStart: Integer; out AHighlightedText: string);
begin
  ASelStart := GridView.DataController.FindCriteria.
    GetTextStartPositionByRowIndex(GridRecord.Index, Item.Index,
    AHighlightedText);
end;

function TcxGridTableDataCellViewInfo.GetEditViewDataTextSelectionInfo
  (out AParams: TcxViewParams; out ASelStart, ASelLength: Integer): Boolean;
var
  AText: string;
...
begin
  ...
  else if RecordViewInfo.RecordsViewInfo.IncSearchingCellViewInfo = Self then
  begin
    ASelStart := 0;
  ...
  begin
    if GridView.HighlightIncrementalFilteringText and
      Controller.DataController.HasIncrementalFilter and
      (Item.Index = Controller.DataController.GetIncrementalFilterField.Index)
    then
    begin
...
begin
  Result := FItem.Focused and RecordViewInfo.Focused and
    (FItem.FocusedCellViewInfo = Self);
end;

function TcxGridTableDataCellViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
begin
  Result := inherited GetHotTrack or ShowButtons or
    (esoAlwaysHotTrack in FProperties.GetSupportedOperations) and
    (GridView.OptionsBehavior.ImmediateEditor or Focused);
end;

function TcxGridTableDataCellViewInfo.GetItemProperties
  : TcxCustomEditProperties;
begin
  if UsedForPaintingHiddenEditor then
...
function TcxGridTableDataCellViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
procedure TcxGridTableDataCellViewInfo.GetRealEditViewDataContentOffsets
  (var R: TRect);
begin
...
begin
  Result := cxRectInflate(EditViewDataBounds,
    -ScaleFactor.Apply(cxGridCellTextOffset));
end;
...
procedure TcxGridTableDataCellViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
procedure TcxGridTableDataCellViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
  inherited;
...
function TcxGridTableDataCellViewInfo.NeedHighlightEditViewDataFindText
  : Boolean;
begin
...
procedure TcxGridTableDataCellViewInfo.RestoreParams(const AParams
  : TcxViewParams);
begin
...
out AHintText: TCaption; out AIsHintMultiLine: Boolean;
out ATextRect: TRect): Boolean;
begin
  if CanShowAutoHint then
    if UseStandardNeedShowHint then
      Result := inherited NeedShowHint(AMousePos, AHintText, AIsHintMultiLine,
        ATextRect)
    else
      Result := FEditViewInfo.NeedShowHint(Canvas, AMousePos,
        GetAreaBoundsForHint, AHintText, AIsHintMultiLine, ATextRect,
        GetMaxLineCount)
  else
    Result := False;
...
begin
  ...
  if Item.HasValidateDrawValueHandler then
    FItem.DoValidateDrawValue(GridRecord, DisplayValue,
      FEditViewInfo.ErrorData);
end;
...
begin
  FEditViewData := FItem.GetEditViewData(GetProperties,
    FIsLocalCopyOfEditViewData, NeedLocalCopyOfEditViewData);
...
procedure TcxGridTableDataCellViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
  CalculateEditViewInfo(FEditViewInfo, MousePos);
...
function TcxGridTableDataCellViewInfo.GetInplaceEditPosition
  : TcxInplaceEditPosition;
begin
  Result.Item := FItem;
      ...
      begin
        ...
        begin
          ...
          if AItem.Focused then
            if (AButton <> mbMiddle) and (AShift * [ssCtrl, ssShift] = []) and AActivateEdit
            then
            begin
              AItem.GridView.Site.FinishDragAndDrop(False);
              if AHotTrack then
                AItem.Controller.EditingController.ShowEdit(AItem, AShift,
                  AHitTest.Pos.X, AHitTest.Pos.Y)
              else
...
var
  ...
  begin
    ...
    try
      AController.EditingController.ShowEdit(FItem, AShift, AHitTest.Pos.X,
        AHitTest.Pos.Y);
    finally
...
begin
  ...
  if (AButton = mbLeft) and (AShift * [ssCtrl, ssShift] = []) and Focused and CanShowEdit
  then
  begin
    if not Editing then
    begin
      ...
      else if AGridView.OptionsBehavior.ImmediateEditor then
      begin
        if AController.IsReadyForImmediateEditing then
          ShowEdit;
      end
      else if FWasFocusedBeforeClick and not AController.IsDblClick then
...
constructor TcxCustomGridRecordViewInfo.Create(ARecordsViewInfo
  : TcxCustomGridRecordsViewInfo; ARecord: TcxCustomGridRecord);
begin
...
function TcxCustomGridRecordViewInfo.GetCacheItem
  : TcxCustomGridTableViewInfoCacheItem;
begin
  if FRecord = nil then
    Result := nil
    ...
    Result := TcxCustomGridTableViewInfoCacheItem
      (GridView.ViewInfoCache[FRecord.Index]);
end;
...
function TcxCustomGridRecordViewInfo.GetGridViewInfo
  : TcxCustomGridTableViewInfo;
begin
...
function TcxCustomGridRecordViewInfo.AdjustToIntegralBottomBound
  (var ABound: Integer): Boolean;
begin
...
function TcxCustomGridRecordViewInfo.GetCellTransparent
  (ACell: TcxGridTableCellViewInfo): Boolean;
begin
  Result := Transparent;
end;
...
begin
  ...
  if IsRightToLeftConverted then
    Result := TdxRightToLeftLayoutConverter.ConvertRect(Result,
      GetExpandButtonOwnerCellBounds);
end;
...
begin
  Result := not GridRecord.CanFocusCells or
    GridView.OptionsSelection.InvertSelect;
end;

procedure TcxCustomGridRecordViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
  inherited;
...
function TcxCustomGridRecordViewInfo.IsClickHitTest
  (AHitTest: TcxCustomGridHitTest): Boolean;
begin
  Result := TcxCustomGridTableController(Controller).IsClickableRecordHitTest
    (AHitTest);
end;

function TcxCustomGridRecordViewInfo.IsDetailVisible
  (ADetail: TcxCustomGridView): Boolean;
begin
  Result := False;
end;
...
procedure TcxCustomGridRecordViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
  if GridRecord.Expandable then
    FExpandButtonBounds := TdxRightToLeftLayoutConverter.ConvertRect
      (FExpandButtonBounds, ABounds);
end;

function TcxCustomGridRecordViewInfo.GetBoundsForInvalidate
  (AItem: TcxCustomGridTableItem): TRect;
begin
  if AItem = nil then
    Result := Bounds
  else
...
function TcxCustomGridRecordViewInfo.GetBoundsForItem
  (AItem: TcxCustomGridTableItem): TRect;
begin
  Result := Rect(0, 0, 0, 0);
end;

function TcxCustomGridRecordViewInfo.GetCellViewInfoByItem
...
function TcxCustomGridRecordViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
  if CanGenerateExpandButtonHitTest and GridRecord.Expandable and
    PtInRect(ExpandButtonAreaBounds, P) then
  begin
...
procedure TcxCustomGridRecordViewInfo.MainCalculate(ALeftBound,
  ATopBound: Integer);
begin
  FSelectedCalculated := False;
...
begin
  ...
  if not Result and (AButton = mbLeft) and
    (AHitTest.HitTestCode = htExpandButton) then
  begin
...
function TcxCustomGridRecordViewInfo.ProcessDialogChar(ACharCode: Word)
  : Boolean;
begin
  Result := False;
end;
...
constructor TcxCustomGridRecordsViewInfo.Create(AGridViewInfo
  : TcxCustomGridTableViewInfo);
begin
  inherited Create;
...
function TcxCustomGridRecordsViewInfo.GetController
  : TcxCustomGridTableController;
begin
...
function TcxCustomGridRecordsViewInfo.GetIncSearchingCellViewInfo
  : TcxGridTableDataCellViewInfo;
begin
...
function TcxCustomGridRecordsViewInfo.
  GetIsRecordPixelScrollSizeCalculating: Boolean;
begin
  Result := FRecordPixelScrollSizeCalculatingLockCount > 0;
end;

function TcxCustomGridRecordsViewInfo.GetItem(Index: Integer)
  : TcxCustomGridRecordViewInfo;
begin
  if Index < Count then
  begin
...
begin
  if (FirstRecordIndex < Controller.FirstScrollRecordIndex) or
    (Controller.ScrollRecordCount = 0) then
    Result := 0
  else if GridViewInfo.CalculateDown then
...
function TcxCustomGridRecordsViewInfo.CreateRecordViewInfo(AIndex: Integer)
  : TcxCustomGridRecordViewInfo;
begin
  Result := CreateRecordViewInfo(ViewData.Records[GetRecordIndex(AIndex)]);
end;

function TcxCustomGridRecordsViewInfo.AddRecordViewInfo
  (AViewInfo: TcxCustomGridRecordViewInfo): Integer;
begin
...
procedure TcxCustomGridRecordsViewInfo.AdjustEditorBoundsToIntegralHeight
  (var AEditorBounds: TRect);
var
  I, ARowIndex: Integer;
  ARowViewInfo: TcxCustomGridRecordViewInfo;
begin
...
function TcxCustomGridRecordsViewInfo.AllowPan(AScrollKind
  : TScrollBarKind): Boolean;
begin
  Result := True;
end;
...
function TcxCustomGridRecordsViewInfo.CalculateIncSearchingCellViewInfo
  : TcxGridTableDataCellViewInfo;
begin
...
procedure TcxCustomGridRecordsViewInfo.CalculatePixelScrollInfo
  (var ARecordIndex, ARecordOffset: Integer;
AMaxRecordIndex, AMaxRecordOffset: Integer; ADelta: Integer;
out AOverPan: Boolean);
...
begin
  ...
  begin
    ...
    begin
      AScrollDelta := Controller.GetRecordCountInScrollBand(ARecordIndex);
      ALastIndexInScrollBand := Controller.GetLastIndexInScrollBand
        (ARecordIndex);
...
function TcxCustomGridRecordsViewInfo.GetPixelScrollOffset(AFirstRecordIndex,
  AFirstRecordOffset: Integer; ALastRecordIndex, ALastRecordOffset
  : Integer): Integer;
var
  AIndex: Integer;
  ARecordSize: Integer;
...
begin
  ...
  if (AFirstRecordIndex > ALastRecordIndex) or
    (AFirstRecordIndex = ALastRecordIndex) and
    (AFirstRecordOffset < ALastRecordOffset) then
  begin
...
function TcxCustomGridRecordsViewInfo.CreateRecordViewInfo
  (ARecord: TcxCustomGridRecord): TcxCustomGridRecordViewInfo;
begin
...
function TcxCustomGridRecordsViewInfo.GetAreaBoundsForCell
  (ACellViewInfo: TcxGridTableDataCellViewInfo): TRect;
begin
...
function TcxCustomGridRecordsViewInfo.GetItemPixelScrollSize
  (AItem: TcxCustomGridRecordViewInfo): Integer;
begin
  Result := AItem.GetPixelScrollSize;
end;

function TcxCustomGridRecordsViewInfo.GetRecordIndex(AViewInfoIndex
  : Integer): Integer;
begin
...
function TcxCustomGridRecordsViewInfo.GetRecordScrollSize
  (ARecordIndex: Integer): Integer;
var
  ARecordViewInfo: TcxCustomGridRecordViewInfo;
...
function TcxCustomGridRecordsViewInfo.GetViewInfoIndexByRecordIndex
  (ARecordIndex: Integer): Integer;
begin
  if FGridViewInfo.CalculateDown then
...
function TcxCustomGridRecordsViewInfo.GetPainterClass
  : TcxCustomGridRecordsPainterClass;
begin
  Result := TcxCustomGridRecordsPainter;
end;

procedure TcxCustomGridRecordsViewInfo.InsertItem(AIndex: Integer;
AItem: Pointer);
begin
  FItems.Insert(AIndex, AItem);
end;

function TcxCustomGridRecordsViewInfo.CanOffset(AItemCountDelta
  : Integer): Boolean;
begin
  Result := (Count <> 0) and (Abs(AItemCountDelta) < Count);
end;

procedure TcxCustomGridRecordsViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
...
function TcxCustomGridRecordsViewInfo.GetCellHeight(ACellContentHeight
  : Integer): Integer;
begin
  Result := ACellContentHeight;
end;

function TcxCustomGridRecordsViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  I: Integer;
begin
...
function TcxCustomGridRecordsViewInfo.IsCellMultiLine
  (AItem: TcxCustomGridTableItem): Boolean;
begin
  Result := False;
end;
...
procedure TcxCustomGridRecordsViewInfo.OffsetRecords(AItemCountDelta,
  ...
  begin
    ...
    with FItems do
      System.Move(List[AIndexFrom], List[AIndexFrom - AItemCountDelta],
        SizeOf(Pointer) * AMovedRecordCount);
  end;
...
begin
  ...
  begin
    if AItemCountDelta > 0 then
      CalculateContentOffset(GetItemsOffset(AItemCountDelta) +
        APixelScrollRecordOffsetDelta);
    DeleteItems;
...
procedure TcxCustomGridRecordsViewInfo.RightToLeftConversion
  (const ABounds: TRect);
begin
  if not IsRightToLeftConverted then
  begin
...
constructor TcxGridCustomTableNavigatorViewInfo.Create(AGridViewInfo
  : TcxCustomGridTableViewInfo);
begin
  inherited Create(AGridViewInfo);
  FGridViewInfo := AGridViewInfo;
...
function TcxGridCustomTableNavigatorViewInfo.GetLookAndFeelPainter
...
procedure TcxGridCustomTableNavigatorViewInfo.UpdateNavigatorSiteBounds
  (const ABounds: TRect);
begin
...
constructor TcxNavigatorSiteViewInfo.Create(AGridViewInfo
  : TcxCustomGridViewInfo);
begin
  inherited Create(AGridViewInfo);
  FNavigatorViewInfo := GridViewInfo.GetNavigatorViewInfoClass.Create
    (GridViewInfo);
end;
...
function TcxNavigatorSiteViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
function TcxCustomGridTableViewInfo.GetPart(Index: Integer)
  : TcxCustomGridPartViewInfo;
begin
...
function TcxCustomGridTableViewInfo.GetPartsCustomHeight
  (AAlignment: TcxGridPartAlignment): Integer;
var
  I: Integer;
begin
  Result := 0;
...
procedure TcxCustomGridTableViewInfo.RemovePart
  (AItem: TcxCustomGridPartViewInfo);
begin
  FParts.Remove(AItem);
end;
...
function TcxCustomGridTableViewInfo.GetNavigatorButtons
...
procedure TcxCustomGridTableViewInfo.NavigatorChanged
  (AChangeType: TcxNavigatorChangeType);
const
  ChangeKinds: array [TcxNavigatorChangeType] of TcxGridViewChangeKind =
    (vcProperty, vcLayout, vcLayout);
begin
...
begin
  if GridView.IsPattern or GridView.AssigningPattern or (GridView.Control = nil)
  then
    Exit;
...
function TcxCustomGridTableViewInfo.GetNavigatorInfoPanel
...
function TcxCustomGridTableViewInfo.CreateFindPanelViewInfo
  : TcxGridFindPanelViewInfo;
begin
...
procedure TcxCustomGridTableViewInfo.CalculateHeight(const AMaxSize: TPoint;
var AHeight: Integer; var AFullyVisible: Boolean);
begin
  if NavigatorSiteViewInfo.Visible and
    (TcxControlAccess(Site).IsPopupScrollBars or not Site.HScrollBarVisible)
  then
...
function TcxCustomGridTableViewInfo.CalculatePartBounds
  (APart: TcxCustomGridPartViewInfo): TRect;
var
  I: Integer;
begin
  Result := ClientBounds;
...
function TcxCustomGridTableViewInfo.
  CalculateVisibleEqualHeightRecordCount: Integer;
begin
  Result := -1;
end;
...
function TcxCustomGridTableViewInfo.DoGetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  I: Integer;
begin
...
function TcxCustomGridTableViewInfo.GetFilterViewInfoClass
...
begin
  Result := inherited GetIsInternalUse or IsFirstRecordIndexAssigned or
    (RecordsViewInfo <> nil) and
    RecordsViewInfo.IsRecordPixelScrollSizeCalculating;
end;
...
function TcxCustomGridTableViewInfo.GetNavigatorSiteViewInfoClass
  : TcxNavigatorSiteViewInfoClass;
begin
  Result := TcxNavigatorSiteViewInfo;
end;

function TcxCustomGridTableViewInfo.GetNavigatorViewInfoClass
  : TcxGridCustomTableNavigatorViewInfoClass;
begin
...
procedure TcxCustomGridTableViewInfo.GetNoDataInfoTextParams
  (out AParams: TcxViewParams);
begin
...
function TcxCustomGridTableViewInfo.GetNonRecordsAreaHeight(ACheckScrollBar
  : Boolean): Integer;
begin
...
procedure TcxCustomGridTableViewInfo.OffsetRecords(ARecordCountDelta,
  APixelScrollRecordOffsetDelta: Integer);
begin
  RecordsViewInfo.OffsetRecords(ARecordCountDelta,
    APixelScrollRecordOffsetDelta);
end;
...
begin
  ...
  // should be here for correct hiding (focus)
  FindPanelViewInfo.VisibilityChanged(AVisible);
end;

function TcxCustomGridTableViewInfo.CanOffset(ARecordCountDelta,
  APixelScrollRecordOffsetDelta, DX, DY: Integer): Boolean;
begin
  Result := True;
end;

function TcxCustomGridTableViewInfo.CanOffsetView(ARecordCountDelta
  : Integer): Boolean;
begin
  Result := not cxRectIsEmpty(Bounds) and RecordsViewInfo.CanOffset
    (ARecordCountDelta);
end;

procedure TcxCustomGridTableViewInfo.DoOffset(ARecordCountDelta,
  APixelScrollRecordOffsetDelta, DX, DY: Integer);
begin
...
procedure TcxCustomGridTableViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
...
function TcxCustomGridTableViewInfo.GetPopupHeight(ADropDownRecordCount
  : Integer): Integer;
begin
  Result := 0;
end;
...
procedure TcxCustomGridTableViewInfoCacheItem.UnassignValues
  (AKeepMaster: Boolean);
begin
  inherited;
...
function TcxCustomGridTableViewInfoCache.GetViewData
  : TcxCustomGridTableViewData;
begin
  Result := TcxCustomGridTableViewData(inherited ViewData);
end;

function TcxCustomGridTableViewInfoCache.GetItemClass(Index: Integer)
  : TcxCustomGridViewInfoCacheItemClass;
begin
...
constructor TcxCustomGridTableItemCustomOptions.Create
  (AItem: TcxCustomGridTableItem);
begin
  inherited Create(AItem);
end;

function TcxCustomGridTableItemCustomOptions.GetGridView
  : TcxCustomGridTableView;
begin
  Result := Item.GridView;
end;
...
procedure TcxCustomGridTableItemCustomOptions.Changed
  (AChange: TcxGridTableItemChange = ticLayout);
begin
...
begin
  ...
  FFilteringPopupIncrementalFilteringOptions :=
    [ifoHighlightSearchText, ifoUseContainsOperator];
...
procedure TcxCustomGridTableItemOptions.SetFilteringAddValueItems
  (Value: Boolean);
begin
...
procedure TcxCustomGridTableItemOptions.SetFilteringExcelPopupApplyChanges
  (AValue: TdxExcelFilterValueContainerApplyChangesMode);
begin
...
procedure TcxCustomGridTableItemOptions.
  SetFilteringExcelPopupDateTimeValuesPageType(const AValue
  : TdxExcelFilterValueContainerDateTimeValuesPageType);
begin
...
procedure TcxCustomGridTableItemOptions.SetFilteringExcelPopupDefaultPage
  (const AValue: TdxExcelFilterValueContainerDefaultPage);
begin
...
procedure TcxCustomGridTableItemOptions.
  SetFilteringExcelPopupNumericValuesPageType(const AValue
  : TdxExcelFilterValueContainerNumericValuesPageType);
begin
...
procedure TcxCustomGridTableItemOptions.SetFilteringFilteredItemsList
  (Value: Boolean);
begin
...
procedure TcxCustomGridTableItemOptions.
  SetFilteringFilteredItemsListShowFilteredItemsOnly(AValue: Boolean);
begin
...
procedure TcxCustomGridTableItemOptions.SetFilteringMRUItemsList
  (Value: Boolean);
begin
...
procedure TcxCustomGridTableItemOptions.SetEditAutoHeight
  (Value: TcxItemInplaceEditAutoHeight);
begin
  if FEditAutoHeight <> Value then
  begin
    FEditAutoHeight := Value;
...
procedure TcxCustomGridTableItemOptions.SetFilteringPopupMode
  (const AValue: TdxFilterPopupWindowMode);
begin
...
procedure TcxCustomGridTableItemOptions.SetFilteringPopupMultiSelect
  (Value: Boolean);
begin
...
procedure TcxCustomGridTableItemOptions.SetFilteringWithFindPanel
  (AValue: Boolean);
begin
...
procedure TcxCustomGridTableItemOptions.SetIgnoreTimeForFiltering
  (Value: Boolean);
begin
  if FIgnoreTimeForFiltering <> Value then
  begin
...
procedure TcxCustomGridTableItemOptions.SetShowEditButtons
  (Value: TcxGridItemShowEditButtons);
begin
  if FShowEditButtons <> Value then
  begin
    FShowEditButtons := Value;
...
procedure TcxCustomGridTableItemOptions.SetSortByDisplayText
  (Value: TcxGridItemSortByDisplayText);
begin
...
function TcxCustomGridTableItemOptions.GetFilterPopupWindowApplyMode
  : TdxFilterApplyChangesMode;
begin
  Result := GridView.Filtering.ItemPopup.ApplyMultiSelectChanges;
end;

function TcxCustomGridTableItemOptions.
  GetFilterPopupWindowButtonCaption: string;
begin
  Result := cxGetResourceString(@scxGridFilterApplyButtonCaption);
end;

function TcxCustomGridTableItemOptions.
  GetFilterPopupWindowIncrementalFiltering: Boolean;
begin
...
function TcxCustomGridTableItemOptions.
  GetFilterPopupWindowVisibleItemCount: Integer;
begin
  Result := GridView.Filtering.ItemPopup.MaxDropDownItemCount;
end;

function TcxCustomGridTableItemOptions.
  GetFilterPopupWindowShowCheckBoxes: Boolean;
begin
...
function TcxCustomGridTableItemOptions.GetExcelFilterPopupApplyChanges
  : TdxExcelFilterValueContainerApplyChangesMode;
begin
...
function TcxCustomGridTableItemOptions.GetExcelFilterPopupDefaultPage
  : TdxExcelFilterValueContainerDefaultPage;
begin
...
begin
  if Source is TcxCustomGridTableItemOptions then
    ...
    begin
      ...
      Self.FilteringExcelPopupDateTimeValuesPageType :=
      ...
      Self.FilteringPopupIncrementalFiltering :=
        FilteringPopupIncrementalFiltering;
      Self.FilteringPopupIncrementalFilteringOptions :=
