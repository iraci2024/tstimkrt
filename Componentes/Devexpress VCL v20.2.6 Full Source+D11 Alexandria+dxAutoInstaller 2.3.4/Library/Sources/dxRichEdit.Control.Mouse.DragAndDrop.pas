...
uses
  Types, Classes, Controls, SysUtils, ActiveX, Generics.Defaults,
...
type
  ...
  public
    ...
    procedure ShowCaret(ACaretLogPosition: TdxDocumentLogPosition);
      virtual; abstract;
    procedure HideCaret(ACaretLogPosition: TdxDocumentLogPosition);
      virtual; abstract;
  end;
  ...
  public
    ...
    property CancelOnRightMouseUp: Boolean read FCancelOnRightMouseUp
      write FCancelOnRightMouseUp;
    property CancelOnPopupMenu: Boolean read FCancelOnPopupMenu
      write FCancelOnPopupMenu;
  ...
  private
    procedure HandleEndDocumentUpdate(ASender: TObject;
  ...
  public
    ...
    property ResetSelectionOnMouseUp: Boolean read FResetSelectionOnMouseUp
      write FResetSelectionOnMouseUp;
  end;

  { TdxBeginMouseDragHyperlinkClickHandleHelperState }

  TdxBeginMouseDragHyperlinkClickHandleHelperState = class
    (TdxRichEditBeginMouseDragHelperState)
  private
  ...
  TdxCancellableDragMouseHandlerStateBase = class abstract
    (TdxRichEditMouseCustomState, IdxKeyboardHandlerService)
  strict private
  ...
  protected
    ...
    function CalculateHitTest(const P: TPoint)
      : TdxRichEditHitTestResult; override;

    function GetDataObject(const AData: IDataObject): IdxDataObject; virtual;
    function GetHitTestDetailsLevel: TdxDocumentLayoutDetailsLevel;
      virtual; abstract;
    ...
    function CalculateMouseCursor(AShiftState: TShiftState): TCursor;
      virtual; abstract;
    function CreateDataObject: IdxDataObject; virtual; abstract;
    function CommitDrag(const P: TPoint; AShiftState: TShiftState;
      const ADataObject: IdxDataObject): Boolean; virtual; abstract;
    function ContinueDrag(const Args: TdxDragEventArgs)
      : TdxDragDropEffects; overload;
    function ContinueDrag(const P: TPoint;
      const AllowedEffects: TdxDragDropEffects; AShiftState: TShiftState;
      const ADataObject: IdxDataObject): TdxDragDropEffects; overload;
      virtual; abstract;

    property DataObject: IdxDataObject read FDataObject;
    property HitTestDetailsLevel: TdxDocumentLayoutDetailsLevel
      read GetHitTestDetailsLevel;
  public
    procedure Start; override;
    procedure Finish; override;
    procedure HandleMouseMove(const Args: TdxMouseEventArgs); override;
  ...
  TdxDragContentMouseHandlerStateBase = class
    (TdxCancellableDragMouseHandlerStateBase)
  public const
  ...
  protected
    ...
    function CalculateDragDropEffects(ASiftState: TShiftState)
      : TdxDragDropEffects; virtual;
    function CanDropData(const ADataObject: IdxDataObject): Boolean;
      overload; virtual;
    ...
    function CreateDropCommand(APos: PdxDocumentModelPosition;
      const ADataObject: IdxDataObject; AIsControlPressed: Boolean)
      : TdxCommand; virtual;
    function GetHitTestDocumentModelPosition(AHitTestResult
      : TdxRichEditHitTestResult): TdxDocumentModelPosition;
    function ShouldShowVisualFeedback(const P: TPoint): Boolean; virtual;
    function UpdateModelPosition(const APos: TdxDocumentModelPosition)
    ...
    function CommitDrag(const APoint: TPoint; AShiftState: TShiftState;
      const ADataObject: IdxDataObject): Boolean; override;
    function CreateDataObject: IdxDataObject; override;

    property Calculator: TdxDragContentMouseHandlerStateCalculator
      read FCalculator;
    property CaretVisualizer: TdxRichEditDragCaretVisualizer
      read FCaretVisualizer;
  public
    ...
    property CaretLogPosition: TdxDocumentLogPosition read FCaretLogPosition
      write FCaretLogPosition;
  end;

  { TdxDragContentStandardMouseHandlerStateBase }

  TdxDragContentStandardMouseHandlerStateBase = class abstract
    (TdxDragContentMouseHandlerStateBase)
  protected
  ...
  TdxDragContentStandardMouseHandlerState = class
    (TdxDragContentStandardMouseHandlerStateBase)
  private
  ...
  TdxDragExternalContentMouseHandlerState = class
    (TdxDragContentStandardMouseHandlerStateBase)
  protected
    function CalculateDragDropEffects(ASiftState: TShiftState)
      : TdxDragDropEffects; override;
    function CreateDataObject: IdxDataObject; override;
    function ContinueDrag(const P: TPoint;
      const AllowedEffects: TdxDragDropEffects; AShiftState: TShiftState;
      const ADataObject: IdxDataObject): TdxDragDropEffects; override;
    ...
    function CreateDropCommand(APos: PdxDocumentModelPosition;
      const ADataObject: IdxDataObject; AIsControlPressed: Boolean)
      : TdxCommand; override;
    procedure UpdateTableViewInfoController(const APhysicalPoint: TPoint;
  ...
  TdxDragContentManuallyMouseHandlerState = class
    (TdxDragContentMouseHandlerStateBase)
  public
    procedure Start; override;
  end;
  ...
  TdxDragContentMouseHandlerStateBaseStrategy = class abstract
    (TdxRichEditMouseHandlerStateStrategyBase)
  private
    function GetState: TdxDragContentMouseHandlerStateBase;
  protected
    function CreateCaretVisualizer: TdxRichEditDragCaretVisualizer;
      virtual; abstract;
  public
  ...
  TdxDragFloatingObjectManuallyMouseHandlerStateStrategy = class abstract
    (TdxRichEditMouseHandlerStateStrategyBase)
  strict private
  ...
  protected
    procedure ShowVisualFeedbackCore(const ABounds: TRect;
      APageViewInfo: TdxPageViewInfo; AImage: TdxOfficeImage); virtual;
      abstract;
    procedure HideVisualFeedbackCore(const ABounds: TRect;
      APageViewInfo: TdxPageViewInfo); virtual; abstract;
    function CreateFeedbackImage(AOriginalImage: TdxOfficeImage)
      : TdxOfficeImage; virtual; abstract;
    ...
    property State: TdxDragFloatingObjectManuallyMouseHandlerState
      read GetState;
  ...
  protected
    ...
    function CreatePlatformStrategy
      : TdxDragFloatingObjectManuallyMouseHandlerStateStrategy; virtual;
    function CreateFeedbackImage(AOriginalImage: TdxOfficeImage)
  ...
  public
    constructor Create(AController: TdxRichEditMouseController;
      AHitTestResult: TdxRichEditHitTestResult); reintroduce;
    destructor Destroy; override;
...
class function TdxRichEditCursorsHelper.GetCursor
  (AEffect: TdxDragDropEffects): TCursor;
begin
  if TdxDragDropEffect.Scroll in AEffect then
    Result := TdxRichEditCursors.Hand
  else if TdxDragDropEffect.Link in AEffect then
    Result := TdxRichEditCursors.Hand
  else if TdxDragDropEffect.Copy in AEffect then
    Result := TdxRichEditCursors.Hand
  else if TdxDragDropEffect.Move in AEffect then
    Result := TdxRichEditCursors.Hand
  else
...
constructor TdxRichEditDragCaretVisualizer.Create(const AControl
  : IdxRichEditControl);
begin
  inherited Create;
  FControl := AControl;
...
procedure TdxRichEditDragCaretVisualizer.DrawCaret(ACaretLogPosition
...
constructor TdxBeginMouseDragHelperState.Create(AController
  : TdxRichEditMouseController; ADragState: TdxRichEditMouseCustomState;
  const P: TPoint);
begin
...
procedure TdxBeginMouseDragHelperState.HandleMouseUp
  (const Args: TdxMouseEventArgs);
begin
  if (mbLeft in Args.Buttons) or
    ((mbRight in Args.Buttons) and CancelOnRightMouseUp) then
    Controller.SwitchToDefaultState;
end;

procedure TdxBeginMouseDragHelperState.HandleMouseWheel
  (const Args: TdxMouseEventArgs);
begin
...
function TdxBeginMouseDragHelperState.HandlePopupMenu
...
begin
  ...
  Result := (Abs(InitialPoint.X - Args.MousePos.X) > ADragSize.cx) or
    (Abs(InitialPoint.Y - Args.MousePos.Y) > ADragSize.cy);
end;
...
procedure TdxRichEditBeginMouseDragHelperState.HandleMouseWheel
  (const Args: TdxMouseEventArgs);
begin
...
procedure TdxRichEditBeginMouseDragHelperState.HandleEndDocumentUpdate
...
constructor TdxBeginContentDragHelperState.Create
...
procedure TdxBeginMouseDragHyperlinkClickHandleHelperState.
  ValidateCursorPosition(const AControl: IdxRichEditControl);
var
...
begin
  ...
  if (ACursorPos < ActivePieceTable.DocumentStartLogPosition) or
    (ACursorPos = ASelection.Start) then
    Exit;
...
begin
  ...
  ARequest.Accuracy := Controller.ActiveView.DefaultHitTestPageAccuracy or
    NearestPageArea or NearestColumn or NearestTableRow or NearestTableCell or
    NearestRow or NearestBox or NearestCharacter;
...
function TdxCancellableDragMouseHandlerStateBase.GetDataObject
  (const AData: IDataObject): IdxDataObject;
begin
  if AData = nil then
    Result := nil
  else if not Supports(AData, IdxDataObject, Result) then
...
function TdxCancellableDragMouseHandlerStateBase.ContinueDrag
  (const Args: TdxDragEventArgs): TdxDragDropEffects;
var
  ADataObject: IdxDataObject;
begin
  ADataObject := GetDataObject(Args.Data);
  try
    Result := ContinueDrag(Args.P, Args.AllowedEffect, Args.KeyState,
      ADataObject);
  finally
    ADataObject := nil;
  end;
...
function TdxCancellableDragMouseHandlerStateBase.HandleDragDropManually
  : Boolean;
begin
  Result := True;
end;
...
function TdxCancellableDragMouseHandlerStateBase.HandleKeyDown
  (const Args: TdxKeyEventArgs): Boolean;
begin
  Result := False;
...
function TdxCancellableDragMouseHandlerStateBase.HandleKeyUp
  (const Args: TdxKeyEventArgs): Boolean;
begin
  SetMouseCursor(CalculateMouseCursor(Args.ShiftState));
  Result := False;
...
function TdxCancellableDragMouseHandlerStateBase.HandleKeyPress
...
begin
  if HandleDragDropManually then
    ContinueDrag(Args.MousePos, [TdxDragDropEffect.Move,
      TdxDragDropEffect.Copy], Args.Shift, DataObject);
end;
...
begin
  ...
  ContinueDrag(Args.MousePos, [TdxDragDropEffect.Move, TdxDragDropEffect.Copy],
    Args.Shift, nil);
end;
...
function TdxCancellableDragMouseHandlerStateBase.
...
function TdxDragContentMouseHandlerStateBase.CanDropData
  (var Args: TdxDragEventArgs): Boolean;
var
  AData: IdxDataObject;
begin
...
function TdxDragContentMouseHandlerStateBase.CreateCaretVisualizer
  : TdxRichEditDragCaretVisualizer;
begin
  Result := TdxRichEditDragCaretVisualizer.Create(Control);
end;

function TdxDragContentMouseHandlerStateBase.CreateDropCommand
  (APos: PdxDocumentModelPosition; const ADataObject: IdxDataObject;
  AIsControlPressed: Boolean): TdxCommand;
begin
...
function TdxDragContentMouseHandlerStateBase.CalculateDragDropEffects
  (ASiftState: TShiftState): TdxDragDropEffects;
begin
...
begin
  Result := FCalculator.CanDropContentTo(AHitTestResult,
    DocumentModel.ActivePieceTable);
end;

function TdxDragContentMouseHandlerStateBase.CanDropData(const ADataObject
  : IdxDataObject): Boolean;
var
...
begin
  ...
  try
    if not CanDropData(ADataObject) or (AHitTestResult = nil) or
      not CanDropContentTo(AHitTestResult) then
    begin
      HideVisualFeedback;
    ...
    AShouldShowVisualFeedback := ShouldShowVisualFeedback
...
function TdxDragContentMouseHandlerStateBase.CalculateMouseCursor
  (AShiftState: TShiftState): TCursor;
begin
  ...
  try
    ...
    try
      ...
      try
        ...
        try
          AOptions.ExportFinalParagraphMark :=
            TdxExportFinalParagraphMark.Never;
          AData := AManager.GetRtfText(ASelection.PieceTable, ASelections,
            AOptions, True, True);
          ...
          AData := AManager.GetSuppressStoreImageSizeCollection
            (ASelection.PieceTable, ASelections);
...
begin
  if AHitTestResult.Character <> nil then
    Result := AHitTestResult.Character.GetFirstPosition
...
function TdxDragContentMouseHandlerStateBase.GetHitTestDetailsLevel
...
function TdxDragContentStandardMouseHandlerStateBase.
  HandleDragDropManually: Boolean;
begin
  Result := False;
end;
...
procedure TdxDragContentStandardMouseHandlerStateBase.DoDragOver
  (var Args: TdxDragEventArgs);
begin
  Args.Effect := ContinueDrag(Args);
end;

procedure TdxDragContentStandardMouseHandlerStateBase.DoDragDrop
  (var Args: TdxDragEventArgs);
begin
...
procedure TdxDragContentStandardMouseHandlerStateBase.QueryContinueDrag
...
procedure TdxDragContentStandardMouseHandlerStateBase.DoDragDropCore
  (var Args: TdxDragEventArgs);
var
  ADataObject: IdxDataObject;
begin
...
begin
  ...
  Control.DoDragDrop(DataObject, [TdxDragDropEffect.Move,
    TdxDragDropEffect.Copy]);
end;

procedure TdxDragContentStandardMouseHandlerState.DoDragEnter
  (var Args: TdxDragEventArgs);
begin
...
procedure TdxDragContentStandardMouseHandlerState.QueryContinueDrag
  (Args: PdxQueryContinueDragEventArgs);
begin
...
procedure TdxDragExternalContentMouseHandlerState.DoDragOver
  (var Args: TdxDragEventArgs);
var
...
function TdxDragExternalContentMouseHandlerState.CalculateDragDropEffects
  (ASiftState: TShiftState): TdxDragDropEffects;
begin
  Result := [TdxDragDropEffect.Copy];
end;

function TdxDragExternalContentMouseHandlerState.CreateDataObject
  : IdxDataObject;
begin
  Result := nil;
end;
...
function TdxDragExternalContentMouseHandlerState.CommitDrag(const P: TPoint;
  AShiftState: TShiftState; const ADataObject: IdxDataObject): Boolean;
var
  ACommand: TdxPasteLoadDocumentFromFileCommand;
begin
...
function TdxDragExternalContentMouseHandlerState.CreateDropCommand
  (APos: PdxDocumentModelPosition; const ADataObject: IdxDataObject;
  AIsControlPressed: Boolean): TdxCommand;
begin
  Result := TdxDragCopyExternalContentCommand.Create(Control, APos,
    ADataObject);
end;

procedure TdxDragExternalContentMouseHandlerState.UpdateTableViewInfoController
  (const APhysicalPoint: TPoint; AHitTestResult: TdxRichEditHitTestResult);
var
...
function TdxDragContentMouseHandlerStateBaseStrategy.GetState
  : TdxDragContentMouseHandlerStateBase;
begin
...
function TdxDragFloatingObjectManuallyMouseHandlerStateStrategy.GetDocumentModel
  : TdxDocumentModel;
begin
  Result := State.DocumentModel;
end;

function TdxDragFloatingObjectManuallyMouseHandlerStateStrategy.
  GetInitialShapeBounds: TRect;
begin
  Result := State.InitialShapeBounds;
end;

function TdxDragFloatingObjectManuallyMouseHandlerStateStrategy.
  GetInitialContentBounds: TRect;
begin
  Result := State.InitialContentBounds;
end;

function TdxDragFloatingObjectManuallyMouseHandlerStateStrategy.GetRun
  : TdxFloatingObjectAnchorRun;
begin
  Result := State.Run;
end;

function TdxDragFloatingObjectManuallyMouseHandlerStateStrategy.GetState
  : TdxDragFloatingObjectManuallyMouseHandlerState;
begin
...
constructor TdxDragFloatingObjectManuallyMouseHandlerState.Create
  (AController: TdxRichEditMouseController;
  AHitTestResult: TdxRichEditHitTestResult);
var
...
begin
  ...
  FClickPointLogicalOffset.Init(FOldTopLeftCorner.X -
    FInitialLogicalClickPoint.X, FOldTopLeftCorner.Y -
    FInitialLogicalClickPoint.Y);
  ...
  FCalculator :=
    AController.CreateDragFloatingObjectMouseHandlerStateCalculator;
...
function TdxDragFloatingObjectManuallyMouseHandlerState.GetHitTestDetailsLevel
  : TdxDocumentLayoutDetailsLevel;
begin
  Result := TdxDocumentLayoutDetailsLevel.None;
end;

function TdxDragFloatingObjectManuallyMouseHandlerState.CreatePlatformStrategy
  : TdxDragFloatingObjectManuallyMouseHandlerStateStrategy;
begin
  Result := TdxWinFormsDragFloatingObjectManuallyMouseHandlerStateStrategy.
    Create(Self);
end;
...
begin
  ...
  begin
    ...
    ARunInfo := ASelection.PieceTable.FindRunInfo(ASelection.NormalizedStart,
      ASelection.Length);
    try
...
function TdxDragFloatingObjectManuallyMouseHandlerState.CreateFeedbackImage
  (AOriginalImage: TdxOfficeImage): TdxOfficeImage;
begin
  Result := FPlatformStrategy.CreateFeedbackImage(AOriginalImage);
end;

function TdxDragFloatingObjectManuallyMouseHandlerState.CalculateMouseCursor
  (AShiftState: TShiftState): TCursor;
begin
  Result := TdxRichEditCursors.Default;
end;

function TdxDragFloatingObjectManuallyMouseHandlerState.CreateDataObject
  : IdxDataObject;
begin
  Result := nil;
end;

function TdxDragFloatingObjectManuallyMouseHandlerState.
  CalculateHitTestAndCurrentPoint(const APoint: TPoint): Boolean;
var
  ARequest: TdxRichEditHitTestRequest;
begin
  ARequest := TdxRichEditHitTestRequest.Create(DocumentModel.ActivePieceTable);
  ...
  FCurrentTopLeftCorner.X := FCurrentTopLeftCorner.X +
    FClickPointLogicalOffset.X;
  FCurrentTopLeftCorner.Y := FCurrentTopLeftCorner.Y +
    FClickPointLogicalOffset.Y;
  Result := True;
end;

function TdxDragFloatingObjectManuallyMouseHandlerState.
  CalculateMinAffectedRunIndex(APage: TdxPage): TdxRunIndex;
var
  ASelection: TdxSelection;
  ARunInfo: TdxRunInfo;
...
begin
  ...
  ARunInfo := ASelection.PieceTable.FindRunInfo(ASelection.NormalizedStart,
    ASelection.Length);
  try
    FRun := Safe<TdxFloatingObjectAnchorRun>.Cast
      (ASelection.PieceTable.Runs[ARunInfo.Start.RunIndex]);
  ...
  if (FRun = nil) and AParagraph.HasParagraphFrame and not AParagraph.IsInCell
  then
  ...
  APageController := Control.InnerControl.Formatter.DocumentFormatter.
    Controller.PageController;
  AHitTestResult := TdxRichEditHitTestResult.Create
    (APageController.DocumentLayout, APieceTable);
  try
...
function TdxDragFloatingObjectManuallyMouseHandlerState.CommitDrag
  (const APoint: TPoint; AShiftState: TShiftState;
...
begin
  if not TdxPieceTable(FRun.PieceTable).CanEditSelection or
    not Control.InnerControl.IsEditable then
    Exit(False);
  ...
  try
    ...
    ATopLeftPhysicalPoint.X := ATopLeftPhysicalPoint.X +
      Round(FClickPointLogicalOffset.X * AScaleFactor);
    ATopLeftPhysicalPoint.Y := ATopLeftPhysicalPoint.Y +
      Round(FClickPointLogicalOffset.Y * AScaleFactor);

    AModifier := TdxFloatingObjectLayoutModifier.Create(Control, FRun,
...
function TdxDragFloatingObjectManuallyMouseHandlerState.ContinueDrag
  (const P: TPoint; const AllowedEffects: TdxDragDropEffects;
  AShiftState: TShiftState; const ADataObject: IdxDataObject)
  : TdxDragDropEffects;
begin
...
function TdxDragFloatingObjectManuallyMouseHandlerState.
  CreateVisualFeedbackTransform: TdxTransformMatrix;
begin
  if FCurrentTopLeftCorner.IsEqual(Unassigned) or (FPageViewInfo = nil) or
    (FCurrentHitTestResult = nil) then
    Exit(nil);

  Result := TdxFloatingObjectBox.CreateTransformUnsafe(FRotationAngle,
    TRect.CreateSize(FCurrentTopLeftCorner, FInitialShapeBounds.Size));
end;
...
begin
  if FCurrentTopLeftCorner.IsEqual(Unassigned) or (FPageViewInfo = nil) or
    (FCurrentHitTestResult = nil) then
    Exit;
  ShowVisualFeedbackCore(TRect.CreateSize(FCurrentTopLeftCorner,
    FInitialShapeBounds.Size), FPageViewInfo, FImage);
end;
...
procedure TdxDragFloatingObjectManuallyMouseHandlerState.ShowVisualFeedbackCore
  (const ABounds: TRect; APageViewInfo: TdxPageViewInfo;
  AImage: TdxOfficeImage);
begin
  FPlatformStrategy.ShowVisualFeedbackCore(ABounds, APageViewInfo, AImage);
end;

procedure TdxDragFloatingObjectManuallyMouseHandlerState.HideVisualFeedbackCore
  (const ABounds: TRect; APageViewInfo: TdxPageViewInfo);
begin
