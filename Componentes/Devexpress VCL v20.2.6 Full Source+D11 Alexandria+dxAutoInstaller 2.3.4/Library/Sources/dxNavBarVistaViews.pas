...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Windows, Graphics, SysUtils, Types, dxNavBar, dxNavBarStyles,
  dxNavBarCustomPainters, dxNavBarSkinBasedViews,
  dxNavBarExplorerViews, dxNavBarXPViews, dxNavBarOfficeViews, dxNavBarCollns,
  dxSkinsCore,
...
type
  ...
  TdxNavBarVistaExplorerBarSelectionPainter = class
  ...
  TdxNavBarVistaExplorerBarLinkViewInfo = class
    (TdxNavBarSkinBasedExplorerBarLinkViewInfo);

  TdxNavBarVistaExplorerBarGroupViewInfo = class
...
uses
  cxControls, dxOffice11, dxUxTheme, dxNavBarViewsFact, dxNavBarConsts;
...
begin
  ...
  begin
    ...
    AElement := TdxNavBarVistaExplorerBarPainter(Painter)
      .FSkinBasedPainterHelper.NavBarItem;
...
class procedure TdxNavBarVistaExplorerBarSelectionPainter.GetColors
...
class procedure TdxNavBarVistaExplorerBarButtonPainter.InternalDrawButton
...
begin
  ...
  DrawSkinElement(FSkinBasedPainterHelper.NavBarBackground, Canvas,
    ViewInfo.ClientRect, ScaleFactor);
end;

procedure TdxNavBarVistaExplorerBarPainter.DrawChildGroupSelection
  (AChildGroupViewInfo: TdxNavBarChildGroupViewInfo);
begin
  if not DrawSkinElement(FSkinBasedPainterHelper.NavBarItem, Canvas,
    AChildGroupViewInfo.SelectionRect, ScaleFactor, 0,
    NavBarObjectStateToSkinState(AChildGroupViewInfo.State)) then
    inherited;
end;

procedure TdxNavBarVistaExplorerBarPainter.DrawGroupControlSplitter
  (AGroupViewInfo: TdxNavBarExplorerBarGroupViewInfo);
var
  ARect: TRect;
begin
  ARect := cxRectSetBottom(AGroupViewInfo.SplitterRect,
    AGroupViewInfo.SplitterRect.Top + 1, 1);
...
begin
  if not DrawSkinElement(FSkinBasedPainterHelper.NavBarItem, Canvas,
    ALinkViewInfo.SelectionRect, ScaleFactor, 0,
    NavBarObjectStateToSkinState(ALinkViewInfo.State)) then
    inherited;
end;

class function TdxNavBarVistaExplorerBarPainter.GetGroupViewInfoClass
  : TdxNavBarGroupViewInfoClass;
begin
  Result := TdxNavBarVistaExplorerBarGroupViewInfo;
end;

class function TdxNavBarVistaExplorerBarPainter.GetLinkViewInfoClass
  : TdxNavBarLinkViewInfoClass;
begin
  Result := TdxNavBarVistaExplorerBarLinkViewInfo;
end;

class function TdxNavBarVistaExplorerBarPainter.GetViewInfoClass
  : TdxNavBarViewInfoClass;
begin
  Result := TdxNavBarVistaExplorerBarViewInfo;
end;

class function TdxNavBarVistaExplorerBarPainter.GetSkinPainterHelperClass
  : TdxNavBarSkinBasedPainterHelperClass;
begin
  Result := TdxNavBarVistaPainterHelper;
end;

class function TdxNavBarVistaExplorerBarPainter.ButtonPainterClass
  : TdxNavBarCustomButtonPainterClass;
begin
  Result := TdxNavBarVistaExplorerBarButtonPainter;
end;

class function TdxNavBarVistaExplorerBarPainter.SelectionPainterClass
  : TdxNavBarCustomSelectionPainterClass;
begin
  Result := TdxNavBarVistaExplorerBarSelectionPainter;
end;

class function TdxNavBarVistaExplorerBarPainter.GetChildGroupViewInfoClass
  : TdxNavBarChildGroupViewInfoClass;
begin
  Result := TdxNavBarOffice3ChildGroupViewInfo;
end;

function TdxNavBarVistaExplorerBarPainter.GetDefaultColorSchemeName
  : TdxSkinName;
begin
  Result := 'Vista';
end;
...
begin
  RegisterView(dxNavBarVistaExplorerBarView, 'VistaExplorerBarView',
    TdxNavBarVistaExplorerBarPainter);
end;
