...
uses
  ...
  StdCtrls, Menus, dxBar, cxGraphics,
  cxLookAndFeels, cxLookAndFeelPainters, cxButtons, cxControls, cxContainer,
  cxEdit, cxClasses, cxTextEdit, cxMaskEdit,
...
function dxBarItemAddEditor(ABarManager: TdxBarManager; ACategoryIndex: Integer)
  : TdxBarItem;
...
begin
  Edit1.Text := BarManager.GetUniqueItemName(RegdxItemList.VisibleItemClass
    [ComboBox1.ItemIndex]);
end;

procedure TdxBarItemAddEditor.BOkClick(Sender: TObject);
begin
  BarItem := BarManager.AddItem(RegdxItemList.VisibleItemClass
    [ComboBox1.ItemIndex]);
  try
