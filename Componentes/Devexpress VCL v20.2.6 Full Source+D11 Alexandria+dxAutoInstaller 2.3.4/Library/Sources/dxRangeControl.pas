...
uses
  ...
  dxCore, dxCoreClasses, cxClasses, cxContainer, cxControls, dxGdiPlusClasses,
  dxCoreGraphics,
  cxEdit, cxExtEditConsts, cxExtEditUtils, cxLookAndFeelPainters, cxGeometry,
  dxThemeConsts, cxCustomCanvas,
  cxFilterControlUtils, cxGraphics, cxLookAndFeels, cxTextEdit, cxVariants,
  Math, dxCustomHint, dxTypeHelpers,
...
type
  ...
  TdxRangeControlClientPropertiesClass = class of
    TdxRangeControlCustomClientProperties;
  TdxRangeControlDateTimeAutoFormatHelperClass = class of
  ...
  TdxRangeControlDateTimeScaleUnit = (rcduSecond, rcduMinute, rcduHour, rcduDay,
    rcduWeek, rcduMonth, rcduQuarter, rcduYear);
  ...
  public
    ...
    procedure Calculate;
    procedure Paint(ACanvas: TcxCanvas); override;
    property Elements: TObjectList<TdxRangeControlScaleElementViewInfo>
      read FElements;
  ...
  TdxRangeControlDateTimeHeaderClientRulerViewInfo = class
  ...
  public
    constructor Create(AViewInfo: TdxCustomRangeControlViewInfo); override;
    destructor Destroy; override;
    function AddScale(AScale: TdxRangeControlDateTimeScale)
      : TdxRangeControlRulerScaleViewInfo;
    procedure Calculate;
    procedure Paint(ACanvas: TcxCanvas); override;
    property ScaleInfos: TObjectList<TdxRangeControlRulerScaleViewInfo>
      read FScaleInfos;
  end;
  ...
  TdxRangeControlZoomScrollBarZoomGripViewInfo = class
  ...
  TdxRangeControlZoomScrollBarViewportScrollThumbViewInfo = class
    (TdxRangeControlElementViewInfo)
  protected
    function GetHitTestIndex: Integer; override;
  public
  ...
  TdxRangeControlZoomScrollBarSelectionScrollThumbViewInfo = class
    (TdxRangeControlElementViewInfo)
  protected
    function GetHitTestIndex: Integer; override;
  public
  ...
  strict private
    FSelectionScrollThumb
      : TdxRangeControlZoomScrollBarSelectionScrollThumbViewInfo;
    FViewportScrollThumb
      : TdxRangeControlZoomScrollBarViewportScrollThumbViewInfo;
  ...
  public
    ...
    procedure CalculateBounds(const ABounds: TRect); override;
    procedure Paint(ACanvas: TcxCanvas); override;
    property MaxZoomGrip: TdxRangeControlZoomScrollBarZoomGripViewInfo
      read FMaxZoomGrip; // for internal use
    property MinZoomGrip: TdxRangeControlZoomScrollBarZoomGripViewInfo
      read FMinZoomGrip; // for internal use
    property SelectionScrollThumb
      : TdxRangeControlZoomScrollBarSelectionScrollThumbViewInfo
      read FSelectionScrollThumb; // for internal use
    property ViewportScrollThumb
      : TdxRangeControlZoomScrollBarViewportScrollThumbViewInfo
      read FViewportScrollThumb; // for internal use
  end;

  TdxRangeControlClientAreaSelectedRangeTargetViewInfo = class
    (TdxRangeControlElementViewInfo)
  public
    procedure Paint(ACanvas: TcxCanvas); override;
  end;

  TdxRangeControlClientAreaSelectedRangeViewInfo = class
    (TdxRangeControlElementViewInfo)
  protected
    function GetHitTestIndex: Integer; override;
  public
  ...
  TdxRangeControlClientAreaSelectionThumbViewInfo = class
    (TdxRangeControlElementViewInfo)
  strict private
    FType: TdxRangeElementType;
  protected
  ...
  public
    ...
    procedure CalculateBounds(const ABounds: TRect); override;
    procedure Paint(ACanvas: TcxCanvas); override;
    property MaxSelectionThumb: TdxRangeControlClientAreaSelectionThumbViewInfo
      read FMaxSelectionThumb; // for internal use
    property MinSelectionThumb: TdxRangeControlClientAreaSelectionThumbViewInfo
      read FMinSelectionThumb; // for internal use
    property SelectedRange: TdxRangeControlClientAreaSelectedRangeViewInfo
      read FSelectedRange; // for internal use
    property SelectedRangeTarget
      : TdxRangeControlClientAreaSelectedRangeTargetViewInfo
      read FSelectedRangeTarget; // for internal use
  end;
  ...
  protected
    ...
    property Properties: TdxRangeControlCustomClientProperties
      read GetProperties;
  public
  ...
  protected
    ...
    property NormalizedFirstTickMarkValue: Double
      read FNormalizedFirstTickMarkValue write FNormalizedFirstTickMarkValue;
  ...
  protected
    ...
    function CreateViewInfo(AViewInfo: TdxCustomRangeControlViewInfo)
      : TdxRangeControlCustomClientViewInfo; virtual;
    procedure DoAssign(Source: TPersistent); override;
    function DoGetNextNormalizedAcceptableValue(const AValue: Double;
      AInterval: Variant; out AIsOverflow: Boolean): Double; virtual;
    function DoGetNextValue(const AOriginal, AInterval: Variant)
      : Variant; virtual;
    ...
    function GetNextValue(const AOriginal, AInterval: Variant;
      out AIsOverflow: Boolean): Variant; virtual;
    ...
    function GetOriginalValue(const AValue: Double; AType: Word): Variant;
      overload; virtual;
    ...
    property ScaleInterval: Variant read GetScaleInterval
      write SetScaleInterval;
  public
    ...
    function GetNearestNormalizedAcceptableValue(const AValue: Double)
      : Double; virtual;
    function GetNextNormalizedAcceptableValue(const AValue: Double;
      const AInterval: Variant; out AIsOverflow: Boolean): Double; virtual;
    ...
    property ScaleIntervalMinWidth: Integer read FScaleIntervalMinWidth
      write SetScaleIntervalMinWidth;
  ...
  strict private
    function GetProperties: TdxRangeControlCustomClientProperties;
    procedure CalculateLabelPosition(ACanvas: TcxCanvas; const AText: string;
      ATickMarkPos: Integer; out ARect: TRect);
  public
    procedure Paint(ACanvas: TcxCanvas); override;
    property Properties: TdxRangeControlCustomClientProperties
      read GetProperties;
  ...
  TdxRangeControlNumericClientViewInfo = class
  ...
  public
    ...
    property Properties: TdxRangeControlCustomNumericClientProperties
      read GetProperties;
  end;
  ...
  public
    constructor Create(AOwner: TPersistent); override;
  published
    property GridLineColor: TdxAlphaColor read FGridLineColor
      write SetGridLineColor default dxacDefault;
    property RulerColor: TdxAlphaColor read FRulerColor write SetRulerColor
      default dxacDefault;
    property RulerTextColor: TColor read FRulerTextColor write SetRulerTextColor
      default clDefault;
  end;
  ...
  protected
    ...
    function CreateViewInfo(AViewInfo: TdxCustomRangeControlViewInfo)
      : TdxRangeControlCustomClientViewInfo; override;
    procedure DoAssign(Source: TPersistent); override;
    ...
    function GetMaxPossibleRangeInterval(AType: Word): Variant;
      overload; virtual;
    function GetMinPossibleRangeInterval(AType: Word): Variant; virtual;
    function GetNextValue(const AOriginal, AInterval: Variant;
      out AIsOverflow: Boolean): Variant; override;
    function GetOriginalValue(const AValue: Double; AType: Word): Variant;
      overload; override;
  ...
  public
    ...
    property RangeValueType: Word read FRangeValueType write SetRangeValueType
      default varInteger;
  end;
  ...
  protected
    class function IncQuarter(const AValue: TDateTime;
      ANumberOfQuarters: Integer = 1): TDateTime;
    class function QuarterSpan(const AMin: TDateTime; AMax: TDateTime): Double;
  public
    class function CeilDate(const ADate: TDateTime;
      AScaleUnit: TdxRangeControlDateTimeScaleUnit): TDateTime;
    class function GetDateInterval(const AMin, AMax: TDateTime;
      AScaleUnit: TdxRangeControlDateTimeScaleUnit): Double;
    class function IncDate(const AValue: Double;
      AScaleUnit: TdxRangeControlDateTimeScaleUnit;
      AIncrementValue: Int64 = 1): Double;
    class function RoundDate(const ADate: TDateTime;
      AScaleUnit: TdxRangeControlDateTimeScaleUnit): TDateTime;
    class function TruncDate(const ADate: TDateTime;
      AScaleUnit: TdxRangeControlDateTimeScaleUnit): TDateTime;
  end;

  TdxRangeControlDateTimeClientViewInfo = class
    (TdxRangeControlCustomClientViewInfo)
  strict private
  ...
  public
    procedure CalculateBounds(const ABounds: TRect); override;
    property Properties: TdxRangeControlCustomDateTimeClientProperties
      read GetProperties;
  end;
  ...
  protected
    ...
    property AutoFormatHelper: TdxRangeControlDateTimeAutoFormatHelperClass
      read GetAutoFormatHelper;
  ...
  public
    ...
    function IncDate(const AValue: Double; AIncrementValue: Int64 = 1)
      : Double; virtual;
    function RoundDate(const ADate: TDateTime): TDateTime; virtual;
    function TruncDate(const ADate: TDateTime): TDateTime; virtual;
  public
    function GetDisplayText(const ADate: TDateTime; AFormatId: Integer)
      : string; virtual;
  ...
  public
    constructor Create(AOwner: TPersistent;
      AScaleUnit: TdxRangeControlDateTimeScaleUnit); reintroduce; virtual;
  ...
  public
    function GetDisplayText(const ADate: TDateTime; AFormatId: Integer): string;
      override;
    function GetDefaultDisplayText(const ADate: TDateTime): string; override;
  published
  ...
  protected
    procedure Changed;
    function CreatePredefinedDateTimeScale(AScaleUnit
      : TdxRangeControlDateTimeScaleUnit)
      : TdxRangeControlDateTimeScale; virtual;
    procedure DoAssign(Source: TPersistent); override;
    property CustomScales: TdxRangeControlDateTimeScaleList read FCustomScales;
    property PrimaryScale: TdxRangeControlDateTimeScale read GetPrimaryScale
      write SetPrimaryScale;
  public
    constructor Create(AOwner: TPersistent); override;
    destructor Destroy; override;
    function GetScale(AScaleUnit: TdxRangeControlDateTimeScaleUnit)
      : TdxRangeControlDateTimeScale;
    function RegisterScale(AClass: TdxRangeControlDateTimeScaleClass)
      : TdxRangeControlDateTimeScale;
  ...
  published
    ...
    property Quarter: TdxRangeControlDateTimeScale read FQuarter
      write SetQuarter;
  ...
  TdxRangeControlDateTimeClientGetLabelTextEvent = procedure(Sender: TObject;
    const AValue: TDateTime; var ADisplayText: string) of object;
  ...
  protected
    function CeilDate(const ADate: TDateTime): TDateTime; virtual;
    function CreatePredefinedDateTimeScale
    ...
    property ActualPrimaryScale: TdxRangeControlDateTimeScale
      read GetActualPrimaryScale;
    property PrimaryScale: TdxRangeControlDateTimeScale read GetPrimaryScale
      write SetPrimaryScale;
    property OnGetLabelText: TdxRangeControlDateTimeClientGetLabelTextEvent
      read FOnGetLabelText write FOnGetLabelText;
  public
    constructor Create(AOwner: TPersistent); override;
    destructor Destroy; override;
    function GetInterval(const AMin, AMax: Double): Variant; override;
    function GetNearestNormalizedAcceptableValue(const AValue: Double): Double;
      override;
  ...
  published
    ...
    property MinValue;
    property ScaleInterval;
    property Scale: TdxRangeControlDateTimeScale read GetScale write SetScale
      stored False;
    property Scales;
    property Style;
  ...
  TdxRangeControlDateTimeAutoFormatHelper = class
  strict private
    class var FDayFormats: TStringList;
  strict private
...
{$HINTS ON}
{$ENDIF}
    class function FindBeginOfSequence(const AStr: string;
      AStartPosition: Integer; const ASoughtForChars: string;
      AForward: Boolean): Integer;
    class function FindEndOfSequence(const AStr: string;
      AStartPosition: Integer; const ASoughtForChar: Char): Integer;
  protected
    class function ChooseFormat(const ADate: TDateTime; AFont: TFont;
      AWidth: Integer; AScale: TdxRangeControlDateTimeScale): Integer; virtual;
    class procedure InitializeDayFormats; virtual;
    class function Strip(const APattern: string; AFormatChar: Char;
  ...
  public
    class function FormatDay(const ADate: TDateTime; AFormatId: Integer)
      : string; virtual;
    class function FormatHour(const ADate: TDateTime; AFormatId: Integer)
      : string; virtual;
    class function FormatMonth(const ADate: TDateTime; AFormatId: Integer)
      : string; virtual;
    class function FormatMinute(const ADate: TDateTime; AFormatId: Integer)
      : string; virtual;
    class function FormatQuarter(const ADate: TDateTime; AFormatId: Integer)
      : string; virtual;
    class function FormatSecond(const ADate: TDateTime; AFormatId: Integer)
      : string; virtual;
    class function FormatWeek(const ADate: TDateTime; AFormatId: Integer)
      : string; virtual;
    class function FormatYear(const ADate: TDateTime; AFormatId: Integer)
      : string; virtual;
    class function GetFormatCount(AScaleUnit: TdxRangeControlDateTimeScaleUnit)
      : Integer; virtual;
  end;

  TdxRangeControlDateTimeHeaderClientContentElementViewInfo = class
    (TdxRangeControlElementViewInfo)
  strict private
    FMinDate: TDateTime;
    FMaxDate: TDateTime;
  ...
  TdxRangeControlDateTimeHeaderClientContentViewInfo = class
    (TdxRangeControlContentViewInfo)
  strict private
    FElements: TList<TdxRangeControlDateTimeHeaderClientContentElementViewInfo>;
  protected
    function AddElement
      : TdxRangeControlDateTimeHeaderClientContentElementViewInfo;
    function CreateContentElementViewInfo
      : TdxRangeControlDateTimeHeaderClientContentElementViewInfo; virtual;
  public
    constructor Create(AViewInfo: TdxCustomRangeControlViewInfo); override;
    destructor Destroy; override;
    procedure CalculateBounds(const ABounds: TRect); override;
    procedure Paint(ACanvas: TcxCanvas); override;
    property Elements
      : TList<TdxRangeControlDateTimeHeaderClientContentElementViewInfo>
      read FElements;
  end;

  TdxRangeControlDateTimeHeaderClientViewInfo = class
    (TdxRangeControlCustomClientViewInfo)
  strict private
  ...
  public
    procedure CalculateBounds(const ABounds: TRect); override;
    property Content: TdxRangeControlDateTimeHeaderClientContentViewInfo
      read GetContent;
    property Properties: TdxRangeControlCustomDateTimeHeaderClientProperties
      read GetProperties;
    property Ruler: TdxRangeControlDateTimeHeaderClientRulerViewInfo
      read GetRuler;
  end;
  ...
  public
    constructor Create(AOwner: TPersistent); override;
  published
    property RulerHeaderColor: TdxAlphaColor read FRulerHeaderColor
      write SetRulerHeaderColor default dxacDefault;
    property RulerHeaderHotColor: TdxAlphaColor read FRulerHeaderHotColor
      write SetRulerHeaderHotColor default dxacDefault;
    property RulerHeaderTextColor: TColor read FRulerHeaderTextColor
      write SetRulerHeaderTextColor default clDefault;
  end;
  ...
  protected
    function CreatePredefinedDateTimeScale
      (AScales: TdxRangeControlDateTimeScales;
      AScaleUnit: TdxRangeControlDateTimeScaleUnit)
      : TdxRangeControlDateTimeScale; override;
    function CreateStyle: TdxRangeControlCustomClientStyle; override;
    function CreateViewInfo(AViewInfo: TdxCustomRangeControlViewInfo)
      : TdxRangeControlCustomClientViewInfo; override;
    procedure DoAssign(Source: TPersistent); override;
    procedure DoUpdateVisibleScales
    ...
    property VisibleScales: TdxRangeControlDateTimeScaleList
      read FVisibleScales;
  public
    constructor Create(AOwner: TPersistent); override;
    destructor Destroy; override;
    ...
    property AutoFormatHelper: TdxRangeControlDateTimeAutoFormatHelperClass
      read FAutoFormatHelper write SetAutoFormatHelper;
    property AutoFormatScaleCaptions: Boolean read FAutoFormatScaleCaptions
      write SetAutoFormatScaleCaptions default True;
  end;
  ...
  public
    procedure Clear;
    property HitAtZoomScrollBar: Boolean index rchtZoomScrollBar
      read GetBitState;
    property HitAtZoomScrollBarSelectionScrollThumb: Boolean
      index rchtZoomScrollBarSelectionScrollThumb read GetBitState;
    property HitAtZoomScrollBarViewportScrollThumb: Boolean
      index rchtZoomScrollBarViewportScrollThumb read GetBitState;
    property HitAtZoomScrollBarMinZoomGrip: Boolean
      index rchtZoomScrollBarMinZoomGrip read GetBitState;
    property HitAtZoomScrollBarMaxZoomGrip: Boolean
      index rchtZoomScrollBarMaxZoomGrip read GetBitState;
    property HitAtClientArea: Boolean index rchtClientArea read GetBitState;
    property HitAtClientAreaSelectedRange: Boolean
      index rchtClientAreaSelectedRange read GetBitState;
    property HitAtClientAreaMinSelectionThumb: Boolean
      index rchtClientAreaMinSelectionThumb read GetBitState;
    property HitAtClientAreaMaxSelectionThumb: Boolean
      index rchtClientAreaMaxSelectionThumb read GetBitState;
    property HitAtRulerElement: Boolean index rchtRulerElement read GetBitState;
    property HitObject: TdxRangeControlElementViewInfo read FHitObject
      write FHitObject;
  ...
  protected
    ...
    procedure CheckCursorAtPoint(const APoint: TPoint;
    ...
    function GetPositionInClientAreaFromNormalValue(const AValue
      : Double): Integer;
    ...
    property HotInfo: TdxRangeControlElementViewInfo read FHotInfo
      write FHotInfo;
    property Painter: TcxCustomLookAndFeelPainter read GetPainter;
    property PressedInfo: TdxRangeControlElementViewInfo read FPressedInfo
      write FPressedInfo;
  ...
  public
    ...
    // for internal use
    property ZoomScrollBar: TdxRangeControlZoomScrollBarViewInfo
      read FZoomScrollBar; // for internal use

    property HitTest: TdxCustomRangeControlHitTest read FHitTest;
    property ClientProperties: TdxRangeControlCustomClientProperties
      read GetClientProperties;
  end;
  ...
  public
    ...
    property DisabledColor: TdxAlphaColor read FDisabledColor
      write SetDisabledColor default $A000000;
    property ElementBorderColor: TdxAlphaColor read FElementBorderColor
      write SetElementBorderColor default dxacDefault;
    property OutOfRangeColor: TdxAlphaColor read FOutOfRangeColor
      write SetOutOfRangeColor default dxacDefault;
    property SelectedRangeThumbColor: TColor read FSelectedRangeThumbColor
      write SetSelectedRangeThumbColor default clDefault;
    property SelectionBorderColor: TdxAlphaColor read FSelectionBorderColor
      write SetSelectionBorderColor default dxacDefault;
    property SelectionColor: TdxAlphaColor read FSelectionColor
      write SetSelectionColor default dxacDefault;
    property ZoomScrollBarColor: TColor read FZoomScrollBarColor
      write SetZoomScrollBarColor default clDefault;
    property ZoomScrollBarSelectedRangeThumbColor: TColor
      read FZoomScrollBarSelectedRangeThumbColor
      write SetZoomScrollBarSelectedRangeThumbColor default clDefault;
    property ZoomScrollBarVisibleRangeThumbColor: TColor
      read FZoomScrollBarVisibleRangeThumbColor
      write SetZoomScrollBarVisibleRangeThumbColor default clDefault;
  end;
  ...
  const
    AnimationTime = 450;
    AnimationTransitionEffect: TdxAnimationTransitionEffect =
  ...
  strict private
    ...
    procedure DoSelectedRangeAnimate(Sender: TdxAnimationTransition;
      var APosition: Integer; var AFinished: Boolean);
    procedure DoSelectedRangeAnimationTerminate(Sender: TObject);
    procedure DoVisibleRangeAnimate(Sender: TdxAnimationTransition;
      var APosition: Integer; var AFinished: Boolean);
    ...
    procedure GetNormalizedIntervalFromPosInClientArea(APos: Integer;
      out AMin, AMax: Double);
    function GetNormalizedValueFromPosition(APos: Integer;
      AScaleAreaViewInfo: TdxRangeControlElementViewInfo;
      const AMin, AMax: Double): Double;
    function GetNormalizedValueFromPositionInClientArea(APos: Integer): Double;
    function GetNormalizedValueFromPositionInZoomScrollBarArea
      (APos: Integer): Double;
    ...
    procedure RecreateClientProperties
      (Value: TdxRangeControlClientPropertiesClass);
    procedure SetClient(Value: TComponent);
    procedure SetClientProperties(Value: TdxRangeControlCustomClientProperties);
    procedure SetClientPropertiesClass
      (Value: TdxRangeControlClientPropertiesClass);
  ...
  protected
    ...
    procedure SetNormalizedSelectedRange(const AMin, AMax: Double;
      AChangeType: TdxRangeElementTypes; AAnimated: Boolean);
    ...
    function DoOnDrawContent(ACanvas: TcxCanvas;
      AViewInfo: TdxRangeControlCustomClientViewInfo): Boolean;
    function DoOnDrawScale(ACanvas: TcxCanvas;
      AViewInfo: TdxRangeControlCustomClientViewInfo): Boolean;
    ...
    property NormalizedSelectedRangeMaxValue: Double
      read FNormalizedSelectedRangeMaxValue
      write FNormalizedSelectedRangeMaxValue;
    property NormalizedSelectedRangeMinValue: Double
      read FNormalizedSelectedRangeMinValue
      write FNormalizedSelectedRangeMinValue;
    property NormalizedVisibleRangeMaxValue: Double
      read FNormalizedVisibleRangeMaxValue
      write SetNormalizedVisibleRangeMaxValue;
    property NormalizedVisibleRangeMinValue: Double
      read FNormalizedVisibleRangeMinValue
      write SetNormalizedVisibleRangeMinValue;
    property ViewInfo: TdxCustomRangeControlViewInfo read FViewInfo;
    property OnDrawContent: TdxRangeControlClientDrawEvent read FOnDrawContent
      write FOnDrawContent;
    property OnDrawScale: TdxRangeControlClientDrawEvent read FOnDrawScale
      write FOnDrawScale;
    property OnSelectedRangeChanged: TNotifyEvent read FOnSelectedRangeChanged
      write FOnSelectedRangeChanged;
  public
    ...
    property ClientPropertiesClassName: string read GetClientPropertiesClassName
      write SetClientPropertiesClassName;
    property ClientProperties: TdxRangeControlCustomClientProperties
      read FClientProperties write SetClientProperties;
    property ClientPropertiesClass: TdxRangeControlClientPropertiesClass
      read FClientPropertiesClass write SetClientPropertiesClass;
    property HitTest: TdxCustomRangeControlHitTest read GetHitTest;
    property SelectedRangeMaxValue: TdxRangeEditValue
      read GetSelectedRangeMaxValue write SetSelectedRangeMaxValue
      stored IsRangeValueStored;
    property SelectedRangeMinValue: TdxRangeEditValue
      read GetSelectedRangeMinValue write SetSelectedRangeMinValue
      stored IsRangeValueStored;
    property ShowRuler: Boolean read FShowRuler write SetShowRuler default True;
    property ShowZoomScrollBar: Boolean read FShowZoomScrollBar
      write SetShowZoomScrollBar default True;
    property Style: TdxCustomRangeControlStyle read FStyle write SetStyle;
    property VisibleRangeMaxScaleFactor: Double
      read GetVisibleRangeMaxScaleFactor write SetVisibleRangeMaxScaleFactor;
    property VisibleRangeMaxValue: TdxRangeEditValue
      read GetVisibleRangeMaxValue write SetVisibleRangeMaxValue
      stored IsRangeValueStored;
    property VisibleRangeMinValue: TdxRangeEditValue
      read GetVisibleRangeMinValue write SetVisibleRangeMinValue
      stored IsRangeValueStored;
    property ClientPropertiesEvents: TNotifyEvent read FClientPropertiesEvents
      write FClientPropertiesEvents;
  end;
...
function TdxRangeControlElementViewInfo.PtInElement(const APoint
  : TPoint): Boolean;
begin
...
procedure TdxRangeControlElementViewInfo.SetHitTest
...
begin
  ...
  FTextBounds := cxRectCenter(AContentBounds,
    cxTextSize(ViewInfo.GetRulerLabelFont, FText));
  if FTextBounds.Width > AContentBounds.Width then
  begin
    FTextBounds := cxRectOffsetHorz(FTextBounds, AContentBounds.Left -
      FTextBounds.Left);
...
begin
  AIsHot := (ViewInfo.PressedInfo = Self) or (ViewInfo.HotInfo = Self) and
    (ViewInfo.PressedInfo = nil);
  AStyle := ViewInfo.ClientProperties.Style as
  ...
  Painter.DrawRangeControlScaledRulerHeader(ACanvas, Bounds, AIsHot, AColor,
    ViewInfo.GetElementBorderColor, ScaleFactor);
...
constructor TdxRangeControlRulerScaleViewInfo.Create
  (AViewInfo: TdxCustomRangeControlViewInfo);
begin
  inherited;
...
function TdxRangeControlRulerScaleViewInfo.AddElement
  : TdxRangeControlScaleElementViewInfo;
begin
...
function TdxRangeControlDateTimeHeaderClientRulerViewInfo.AddScale
  (AScale: TdxRangeControlDateTimeScale): TdxRangeControlRulerScaleViewInfo;
begin
...
procedure TdxRangeControlDateTimeHeaderClientRulerViewInfo.Paint
  (ACanvas: TcxCanvas);
var
  I: Integer;
begin
...
procedure TdxRangeControlZoomScrollBarZoomGripViewInfo.CalculateBounds
  (const ABounds: TRect);
var
  R: TRect;
begin
  inherited CalculateBounds(ABounds);
  R := cxRectCenter(Bounds, Painter.GetRangeControlScaledSizingGlyphSize
    (ScaleFactor));
...
procedure TdxRangeControlZoomScrollBarZoomGripViewInfo.Paint
  (ACanvas: TcxCanvas);
begin
  Painter.DrawRangeControlScaledSizingGlyph(ACanvas, FGlyphBounds,
    ViewInfo.GetElementBorderColor, ScaleFactor);
end;

{ TdxRangeControlZoomAndScrollBarViewportScrollThumbViewInfo }

function TdxRangeControlZoomScrollBarViewportScrollThumbViewInfo.
  GetHitTestIndex: Integer;
begin
  Result := rchtZoomScrollBarViewportScrollThumb;
end;

procedure TdxRangeControlZoomScrollBarViewportScrollThumbViewInfo.Paint
  (ACanvas: TcxCanvas);
var
...
function TdxRangeControlZoomScrollBarSelectionScrollThumbViewInfo.
  GetHitTestIndex: Integer;
begin
...
constructor TdxRangeControlZoomScrollBarViewInfo.Create
  (AViewInfo: TdxCustomRangeControlViewInfo);
begin
  inherited Create(AViewInfo);
  FSelectionScrollThumb :=
    TdxRangeControlZoomScrollBarSelectionScrollThumbViewInfo.Create(AViewInfo);
  FViewportScrollThumb :=
    TdxRangeControlZoomScrollBarViewportScrollThumbViewInfo.Create(AViewInfo);
  FMinZoomGrip := TdxRangeControlZoomScrollBarZoomGripViewInfo.Create
    (AViewInfo, retMin);
  FMaxZoomGrip := TdxRangeControlZoomScrollBarZoomGripViewInfo.Create
    (AViewInfo, retMax);
end;
...
procedure TdxRangeControlZoomScrollBarViewInfo.CalculateBounds
  (const ABounds: TRect);
var
  R: TRect;
...
begin
  ...
  try
    ...
    if FSelectionScrollThumb.PtInElement(R.TopLeft) then
      ...
      APenStyle := psSolid;
    dxGPPaintCanvas.Line(R.Left, R.Top, R.Left, R.Bottom, ABorderColor, 1,
      APenStyle);

    if FSelectionScrollThumb.PtInElement(cxPointOffset(R.BottomRight,
      -ScaleFactor.Apply(1), -ScaleFactor.Apply(1))) then
      APenStyle := psDot
    else
      APenStyle := psSolid;
    dxGPPaintCanvas.Line(R.Right, R.Top, R.Right, R.Bottom, ABorderColor, 1,
      APenStyle);
...
begin
  inherited SetHitTest(AHitTest);
  if not FMinZoomGrip.GetHitTest(AHitTest) and not FMaxZoomGrip.GetHitTest
    (AHitTest) and not FSelectionScrollThumb.GetHitTest(AHitTest) then
...
function TdxRangeControlClientAreaSelectedRangeViewInfo.GetHitTestIndex
  : Integer;
begin
  Result := rchtClientAreaSelectedRange;
end;

procedure TdxRangeControlClientAreaSelectedRangeViewInfo.Paint
  (ACanvas: TcxCanvas);
var
  R: TRect;
  ABorderColor: TdxAlphaColor;
...
function TdxRangeControlClientAreaSelectionThumbViewInfo.
  GetHitTestIndex: Integer;
begin
  if FType = retMin then
...
procedure TdxRangeControlClientAreaSelectionThumbViewInfo.Paint
  (ACanvas: TcxCanvas);
begin
  if FType = retMin then
    Painter.DrawRangeControlScaledLeftThumb(ACanvas, Bounds,
      ViewInfo.GetSelectedRangeThumbColor, ViewInfo.GetElementBorderColor,
      ScaleFactor)
  else
...
begin
  inherited Create(AViewInfo);
  FSelectedRange := TdxRangeControlClientAreaSelectedRangeViewInfo.Create
    (AViewInfo);
  FMinSelectionThumb := TdxRangeControlClientAreaSelectionThumbViewInfo.Create
    (AViewInfo, retMin);
  FMaxSelectionThumb := TdxRangeControlClientAreaSelectionThumbViewInfo.Create
    (AViewInfo, retMax);
  FSelectedRangeTarget := TdxRangeControlClientAreaSelectedRangeTargetViewInfo.
    Create(AViewInfo);
end;
...
begin
  ...
  try
    ...
    R := Rect(Bounds.Left + 1, Bounds.Top, FSelectedRange.Bounds.Left,
      Bounds.Bottom);
    if R.Width > 0 then
    begin
    ...
    R := Rect(FSelectedRange.Bounds.Right + 1, Bounds.Top, Bounds.Right - 1,
      Bounds.Bottom);
    if R.Width > 0 then
      dxGPPaintCanvas.FillRectangle(R, AOutOfRangeColor);
  finally
...
function TdxRangeControlCustomClientStyle.GetProperties
  : TdxRangeControlCustomClientProperties;
begin
...
constructor TdxRangeControlCustomClientViewInfo.Create
  (AViewInfo: TdxCustomRangeControlViewInfo);
begin
  inherited Create(AViewInfo);
...
procedure TdxRangeControlCustomClientViewInfo.CalculateBounds
  (const ABounds: TRect);
var
  ARect: TRect;
begin
...
function TdxRangeControlCustomClientViewInfo.CreateContentInfo
  : TdxRangeControlContentViewInfo;
begin
  Result := TdxRangeControlContentViewInfo.Create(ViewInfo);
end;

function TdxRangeControlCustomClientViewInfo.CreateRulerInfo
  : TdxRangeControlRulerViewInfo;
begin
  Result := nil;
end;
...
begin
  ...
  try
    AIsOverflow := False;
    while (AValue <= Control.NormalizedVisibleRangeMaxValue) and
      not AIsOverflow do
    begin
      ...
      AValue := Properties.GetNextNormalizedAcceptableValue(AValue,
        ScaleInterval, AIsOverflow);
    end;
  finally
    dxGPPaintCanvas.EndPaint;
  end;
...
function TdxRangeControlCustomClientViewInfo.GetProperties
  : TdxRangeControlCustomClientProperties;
begin
...
begin
  Result := TdxTextMeasurer.TextLineHeight(ViewInfo.GetRulerLabelFont) +
    ScaleFactor.Apply(7);
end;
...
procedure TdxRangeControlCustomClientProperties.CheckMinPossibleRangeInterval
  (var AValue: Double);
begin
end;
...
function TdxRangeControlCustomClientProperties.CreateStyle
  : TdxRangeControlCustomClientStyle;
begin
  Result := nil;
end;

function TdxRangeControlCustomClientProperties.CreateViewInfo
  (AViewInfo: TdxCustomRangeControlViewInfo)
  : TdxRangeControlCustomClientViewInfo;
begin
...
function TdxRangeControlCustomClientProperties.
  DoGetNextNormalizedAcceptableValue(const AValue: Double; AInterval: Variant;
  out AIsOverflow: Boolean): Double;
var
  AOriginal: Variant;
  ANextValue: Variant;
begin
  ...
  if AIsOverflow and (AInterval > 0) then
    Result := 1
  else if AIsOverflow and (AInterval < 0) then
    Result := 0
  else
    Result := GetNormalizedValue(ANextValue);
end;

function TdxRangeControlCustomClientProperties.DoGetNextValue(const AOriginal,
  AInterval: Variant): Variant;
begin
  Result := AOriginal + AInterval;
end;

function TdxRangeControlCustomClientProperties.DoGetNormalizedValue
  (const AValue: Variant): Double;
var
  ARangeDelta: Variant;
begin
...
function TdxRangeControlCustomClientProperties.GetInterval(const AMin,
  AMax: Double): Variant;
begin
  Result := 0;
end;

function TdxRangeControlCustomClientProperties.GetLabelText
...
function TdxRangeControlCustomClientProperties.GetRangeControl
...
function TdxRangeControlCustomClientProperties.
  GetNearestNormalizedAcceptableValue(const AValue: Double): Double;
begin
  Result := AValue;
end;

function TdxRangeControlCustomClientProperties.GetNextNormalizedAcceptableValue
  (const AValue: Double; const AInterval: Variant;
  out AIsOverflow: Boolean): Double;
begin
  AIsOverflow := False;
  if AInterval = 0 then
    ...
    Result := DoGetNextNormalizedAcceptableValue(AValue, AInterval,
      AIsOverflow);
end;

function TdxRangeControlCustomClientProperties.GetNextValue(const AOriginal,
  AInterval: Variant; out AIsOverflow: Boolean): Variant;
begin
  Result := DoGetNextValue(AOriginal, AInterval);
  AIsOverflow := (MaxValue < Result) or (Result < MinValue);
end;

function TdxRangeControlCustomClientProperties.GetNormalizedValue
  (const AValue: Variant): Double;
begin
...
function TdxRangeControlCustomClientProperties.
  GetNormalizedVisibleRangeMaxInterval: Double;
begin
  Result := 1;
end;

function TdxRangeControlCustomClientProperties.GetOriginalValue
  (const AValue: Double): Variant;
begin
  Result := GetOriginalValue(AValue, GetRangeValueType);
end;

function TdxRangeControlCustomClientProperties.GetOriginalValue
  (const AValue: Double; AType: Word): Variant;
begin
  ...
  try
    ...
    begin
      ...
      try
        ...
        try
          RangeControl.VisibleRangeMaxScaleFactor :=
            RangeControl.VisibleRangeMaxScaleFactor;
...
procedure TdxRangeControlCustomClientProperties.SetScaleIntervalMinWidth
  (AValue: Integer);
begin
  AValue := Max(AValue, 1);
...
procedure TdxRangeControlCustomClientProperties.SetScaleInterval
  (Value: Variant);
begin
...
procedure TdxRangeControlCustomClientProperties.SetStyle
  (Value: TdxRangeControlCustomClientStyle);
begin
  FStyle.Assign(Value);
end;
...
procedure TdxRangeControlSimpleRulerViewInfo.Paint(ACanvas: TcxCanvas);
  ...
  procedure DrawLabel(ACanvas: TcxCanvas; const AText: string;
    const ARect: TRect);
  var
    ATextColor: TColor;
...
begin
  ...
  try
    ...
    dxGPPaintCanvas.Line(Bounds.Left, Bounds.Top, Bounds.Right, Bounds.Top,
      ViewInfo.GetElementBorderColor);
  finally
    dxGPPaintCanvas.EndPaint;
  end;
  ...
  begin
    ...
    if AIsOverflow then
      Break;
    AValue := Properties.GetNextNormalizedAcceptableValue(AValue,
      ViewInfo.ClientInfo.ScaleInterval, AIsOverflow);
  end;
end;

function TdxRangeControlSimpleRulerViewInfo.GetProperties
  : TdxRangeControlCustomClientProperties;
begin
  Result := ViewInfo.ClientInfo.Properties;
end;

procedure TdxRangeControlSimpleRulerViewInfo.CalculateLabelPosition
  (ACanvas: TcxCanvas; const AText: string; ATickMarkPos: Integer;
  out ARect: TRect);
var
...
begin
  ...
  else if ATickMarkPos + ATextWidthHalf > Bounds.Right then
  begin
...
procedure TdxRangeControlNumericClientViewInfo.CalculateBounds
  (const ABounds: TRect);
var
...
begin
  ...
  ANormalScaleInterval := Properties.GetNextNormalizedAcceptableValue(0,
    ScaleInterval, AIsOverflow);
  ...
  begin
    ...
    ScaleInterval := VarAsType(Properties.GetOriginalValue(ANormalScaleInterval)
      - Properties.MinValue, Properties.GetScaleIntervalValueType);
  end;
  NormalizedFirstTickMarkValue := Ceil(Control.NormalizedVisibleRangeMinValue /
    ANormalScaleInterval) * ANormalScaleInterval;
end;

function TdxRangeControlNumericClientViewInfo.CreateRulerInfo
  : TdxRangeControlRulerViewInfo;
begin
...
function TdxRangeControlNumericClientViewInfo.GetProperties
  : TdxRangeControlCustomNumericClientProperties;
begin
  Result := Control.ClientProperties as
    TdxRangeControlCustomNumericClientProperties;
end;
...
constructor TdxRangeControlCustomNumericClientProperties.Create
  (AOwner: TPersistent);
begin
...
begin
  if FMaxValue < FMinValue then
    FMaxValue := FMinValue
  else if GetMaxPossibleRangeInterval > 0 then
    if (FMaxValue > 0) and ((FMaxValue - GetMaxPossibleRangeInterval) >
      FMinValue) or (FMaxValue <= 0) and
      ((FMinValue + GetMaxPossibleRangeInterval) < FMaxValue) then
      FMaxValue := FMinValue + GetMaxPossibleRangeInterval;
end;

procedure TdxRangeControlCustomNumericClientProperties.
  CheckMinPossibleRangeInterval(var AValue: Double);
var
  ARange: Double;
...
begin
  ...
  if (ARange >= AMinPossibleRangeInterval) and
    (ARange <= AMinPossibleRangeInterval * MaxDouble) then
...
function TdxRangeControlCustomNumericClientProperties.Convert
  (const AValue: Variant; AType: Word): Variant;
...
begin
  ...
  else if (AMinPossibleValue <> 0) and (AValue <= AMinPossibleValue) then
    Result := VarAsType(AMinPossibleValue, AType)
  else
    Result := VarAsType(AValue, AType);
end;

function TdxRangeControlCustomNumericClientProperties.CreateStyle
  : TdxRangeControlCustomClientStyle;
begin
  Result := TdxRangeControlClientStyle.Create(Self);
end;

function TdxRangeControlCustomNumericClientProperties.
  IsDisplayFormatStored: Boolean;
begin
...
function TdxRangeControlCustomNumericClientProperties.GetInterval(const AMin,
  AMax: Double): Variant;
begin
...
procedure TdxRangeControlCustomNumericClientProperties.DoAssign
  (Source: TPersistent);
var
...
function TdxRangeControlCustomNumericClientProperties.GetNextValue
  (const AOriginal, AInterval: Variant; out AIsOverflow: Boolean): Variant;

  function IsUpOverflow(AValue, AIncrement: Variant): Boolean;
  begin
    Result := (GetMaxPossibleRangeInterval <> 0) and
      ((AIncrement > 0) and (AValue >= (GetMaxPossibleRangeInterval -
      AIncrement)));
  end;
...
begin
  ...
  else if IsDownOverflow(AOriginal, AInterval) then
  begin
    Result := MinValue;
    AIsOverflow := True;
  end
...
function TdxRangeControlCustomNumericClientProperties.GetLabelText
  (const Value: Variant): string;

  function IsDefaultFormat: Boolean;
  begin
    Result := (FDisplayFormat = '') or SameText(FDisplayFormat,
...
begin
  ...
  if not IsDefaultFormat then
    Result := StringReplace(FDisplayFormat, GetLabelPattern, Result,
      [rfReplaceAll]);
end;

function TdxRangeControlCustomNumericClientProperties.
  GetMaxPossibleRangeInterval: Variant;
begin
  Result := GetMaxPossibleRangeInterval(GetRangeValueType);
end;

function TdxRangeControlCustomNumericClientProperties.
  GetMaxPossibleRangeInterval(AType: Word): Variant;
begin
  case AType of
    varDouble:
      Result := MaxDouble;
...
function TdxRangeControlCustomNumericClientProperties.
  GetMinPossibleRangeInterval(AType: Word): Variant;
begin
  case AType of
    varDouble:
      Result := MinDouble;
...
function TdxRangeControlCustomNumericClientProperties.GetOriginalValue
  (const AValue: Double; AType: Word): Variant;
var
...
function TdxRangeControlCustomNumericClientProperties.
  GetScaleIntervalValueType: Word;
begin
  Result := FRangeValueType;
end;

function TdxRangeControlCustomNumericClientProperties.
  GetVisibleRangeValueType: Word;
begin
...
function TdxRangeControlCustomNumericClientProperties.IsRangeValueTypeSupported
  (AValue: Word): Boolean;
begin
  Result := AValue in [varDouble, varSingle, varCurrency, varSmallInt,
...
procedure TdxRangeControlCustomNumericClientProperties.SetDisplayFormat
  (const Value: string);
begin
...
procedure TdxRangeControlCustomNumericClientProperties.SetRangeValueType
  (Value: Word);
begin
...
class function TdxRangeControlDateTimeClientHelper.CeilDate
  (const ADate: TDateTime; AScaleUnit: TdxRangeControlDateTimeScaleUnit)
  : TDateTime;
begin
...
class function TdxRangeControlDateTimeClientHelper.DayOfTheQuarter
...
class function TdxRangeControlDateTimeClientHelper.DaysInQuarter
...
class function TdxRangeControlDateTimeClientHelper.GetDateInterval(const AMin,
  AMax: TDateTime; AScaleUnit: TdxRangeControlDateTimeScaleUnit): Double;
begin
  case AScaleUnit of
    rcduSecond:
...
class function TdxRangeControlDateTimeClientHelper.IncQuarter
  (const AValue: TDateTime; ANumberOfQuarters: Integer = 1): TDateTime;
begin
  Result := IncMonth(AValue, 3 * ANumberOfQuarters);
end;

class function TdxRangeControlDateTimeClientHelper.IncDate(const AValue: Double;
  AScaleUnit: TdxRangeControlDateTimeScaleUnit;
  AIncrementValue: Int64 = 1): Double;
begin
  case AScaleUnit of
...
class function TdxRangeControlDateTimeClientHelper.QuarterSpan
  (const AMin: TDateTime; AMax: TDateTime): Double;
begin
  Result := MonthSpan(AMax, AMin) / 3;
end;

class function TdxRangeControlDateTimeClientHelper.RoundDate
  (const ADate: TDateTime; AScaleUnit: TdxRangeControlDateTimeScaleUnit)
  : TDateTime;
begin
  Result := ADate;
...
class function TdxRangeControlDateTimeClientHelper.StartOfTheQuarter
...
class function TdxRangeControlDateTimeClientHelper.TruncDate
  (const ADate: TDateTime; AScaleUnit: TdxRangeControlDateTimeScaleUnit)
  : TDateTime;
begin
  case AScaleUnit of
    ...
    rcduMinute:
      Result := RecodeTime(ADate, RecodeLeaveFieldAsIs,
...
procedure TdxRangeControlDateTimeClientViewInfo.CalculateBounds
  (const ABounds: TRect);
var
  AValue: TDateTime;
  ANormalValue: Double;
...
begin
  ...
  begin
    ...
    ScaleInterval := VarAsType(Properties.GetDateInterval(Properties.MinValue,
      AValue), Properties.GetScaleIntervalValueType);
  end;
  NormalizedFirstTickMarkValue := Properties.GetNormalizedValue
    (Properties.IncDate(Properties.MinValue,
    Ceil(Properties.GetDateInterval(Properties.MinValue,
    Control.VisibleRangeMinValue) / ScaleInterval) * ScaleInterval));
end;

function TdxRangeControlDateTimeClientViewInfo.CreateRulerInfo
  : TdxRangeControlRulerViewInfo;
begin
  Result := TdxRangeControlSimpleRulerViewInfo.Create(ViewInfo);
end;
...
function TdxRangeControlDateTimeClientViewInfo.GetProperties
  : TdxRangeControlCustomDateTimeClientProperties;
begin
  Result := Control.ClientProperties as
    TdxRangeControlCustomDateTimeClientProperties;
...
constructor TdxRangeControlCustomDateTimeClientProperties.Create
  (AOwner: TPersistent);
begin
  inherited Create(AOwner);
...
function TdxRangeControlCustomDateTimeClientProperties.GetInterval(const AMin,
  AMax: Double): Variant;
begin
  Result := Round(GetDateInterval(GetOriginalValue(AMin),
    GetOriginalValue(AMax)));
end;

function TdxRangeControlCustomDateTimeClientProperties.
  GetNearestNormalizedAcceptableValue(const AValue: Double): Double;
begin
  Result := GetNormalizedValue(RoundDate(GetOriginalValue(AValue)));
end;

function TdxRangeControlCustomDateTimeClientProperties.IncDate
  (const AValue: Double; AIncrementValue: Int64 = 1): Double;
begin
  Result := ActualPrimaryScale.IncDate(AValue, AIncrementValue);
end;

function TdxRangeControlCustomDateTimeClientProperties.TruncDate
  (const ADate: TDateTime): TDateTime;
begin
  Result := ActualPrimaryScale.TruncDate(ADate);
end;

function TdxRangeControlCustomDateTimeClientProperties.CeilDate
  (const ADate: TDateTime): TDateTime;
begin
...
function TdxRangeControlCustomDateTimeClientProperties.
  CreatePredefinedDateTimeScale(AScales: TdxRangeControlDateTimeScales;
...
function TdxRangeControlCustomDateTimeClientProperties.CreateScales
  : TdxRangeControlDateTimeScales;
begin
  Result := TdxRangeControlDateTimeScales.Create(Self);
end;

function TdxRangeControlCustomDateTimeClientProperties.CreateStyle
  : TdxRangeControlCustomClientStyle;
begin
  Result := TdxRangeControlClientStyle.Create(Self);
end;

function TdxRangeControlCustomDateTimeClientProperties.CreateViewInfo
  (AViewInfo: TdxCustomRangeControlViewInfo)
  : TdxRangeControlCustomClientViewInfo;
begin
...
procedure TdxRangeControlCustomDateTimeClientProperties.DoAssign
  (Source: TPersistent);
var
...
procedure TdxRangeControlCustomDateTimeClientProperties.DoGetLabelText
  (const AValue: TDateTime; var ADisplayText: string);
begin
  if Assigned(FOnGetLabelText) then
    FOnGetLabelText(Self, AValue, ADisplayText);
end;

function TdxRangeControlCustomDateTimeClientProperties.RoundDate
  (const ADate: TDateTime): TDateTime;
begin
  Result := ActualPrimaryScale.RoundDate(ADate);
end;

function TdxRangeControlCustomDateTimeClientProperties.GetDateInterval
  (const AMin, AMax: TDateTime): Double;
begin
  Result := ActualPrimaryScale.GetDateInterval(AMin, AMax);
end;

function TdxRangeControlCustomDateTimeClientProperties.GetLabelText
...
function TdxRangeControlCustomDateTimeClientProperties.DoGetNextValue
  (const AOriginal, AInterval: Variant): Variant;
begin
  Result := IncDate(RoundDate(AOriginal), Round(AInterval));
end;

function TdxRangeControlCustomDateTimeClientProperties.GetActualPrimaryScale
  : TdxRangeControlDateTimeScale;
begin
  Result := PrimaryScale;
end;

function TdxRangeControlCustomDateTimeClientProperties.GetPrimaryScale
  : TdxRangeControlDateTimeScale;
begin
...
procedure TdxRangeControlCustomDateTimeClientProperties.SetMaxValue
  (Value: Variant);
begin
...
procedure TdxRangeControlCustomDateTimeClientProperties.SetMinValue
  (Value: Variant);
begin
...
procedure TdxRangeControlCustomDateTimeClientProperties.SetPrimaryScale
  (Value: TdxRangeControlDateTimeScale);
begin
  Scales.PrimaryScale := Value;
end;

procedure TdxRangeControlCustomDateTimeClientProperties.SetScales
  (AValue: TdxRangeControlDateTimeScales);
begin
...
function TdxRangeControlDateTimeClientProperties.GetScale
  : TdxRangeControlDateTimeScale;
begin
  Result := PrimaryScale;
end;
...
function TdxRangeControlDateTimeScale.CeilDate(const ADate: TDateTime)
  : TDateTime;
begin
...
function TdxRangeControlDateTimeScale.GetDisplayText(const ADate: TDateTime;
  AFormatId: Integer): string;
begin
  Result := GetDefaultDisplayText(ADate);
end;

function TdxRangeControlDateTimeScale.GetDefaultDisplayText
...
function TdxRangeControlDateTimeScale.GetAutoFormatHelper
  : TdxRangeControlDateTimeAutoFormatHelperClass;
begin
  Result := (Scales.Owner as
    TdxRangeControlCustomDateTimeHeaderClientProperties).AutoFormatHelper;
end;

function TdxRangeControlDateTimeScale.GetDateInterval(const AMin,
  AMax: TDateTime): Double;
begin
  Result := TdxRangeControlDateTimeClientHelper.GetDateInterval(AMin, AMax,
    ScaleUnit);
end;
...
function TdxRangeControlDateTimeScale.IncDate(const AValue: Double;
  AIncrementValue: Int64 = 1): Double;
begin
  Result := TdxRangeControlDateTimeClientHelper.IncDate(AValue, ScaleUnit,
    AIncrementValue);
end;

function TdxRangeControlDateTimeScale.RoundDate(const ADate: TDateTime)
  : TDateTime;
begin
  Result := TdxRangeControlDateTimeClientHelper.RoundDate(ADate, ScaleUnit);
end;

function TdxRangeControlDateTimeScale.TruncDate(const ADate: TDateTime)
  : TDateTime;
begin
...
constructor TdxRangeControlPredefinedDateTimeScale.Create(AOwner: TPersistent;
  AScaleUnit: TdxRangeControlDateTimeScaleUnit);
begin
  inherited Create(AOwner);
...
function TdxRangeControlPredefinedDateTimeScale.GetDefaultDisplayText
  (const ADate: TDateTime): string;
var
...
begin
  ...
  begin
    case ScaleUnit of
      ...
      rcduQuarter:
        Result := Format('Q%d'' ', [(MonthOf(ADate) - 1) div 3 + 1]) +
...
function TdxRangeControlPredefinedDateTimeScale.GetScaleUnit
  : TdxRangeControlDateTimeScaleUnit;
begin
  Result := FScaleUnit;
end;

procedure TdxRangeControlPredefinedDateTimeScale.SetDisplayFormat
  (const Value: string);
begin
  if FDisplayFormat <> Value then
  begin
...
function TdxRangeControlPredefinedDateHeaderScale.GetDisplayText
  (const ADate: TDateTime; AFormatId: Integer): string;
begin
  case ScaleUnit of
    rcduMinute:
...
function TdxRangeControlPredefinedDateHeaderScale.GetDefaultDisplayText
  (const ADate: TDateTime): string;
var
  ADisplayFormat: string;
begin
  ...
  else if ScaleUnit = rcduQuarter then
  begin
    ADisplayFormat := StringReplace(ADisplayFormat, '{Value}', '%d', []);
    Result := Format(ADisplayFormat, [(MonthOf(ADate) - 1) div 3 + 1]);
  end
...
function TdxRangeControlPredefinedDateHeaderScale.
  GetDefaultDisplayFormat: string;
begin
  case ScaleUnit of
    rcduSecond:
...
function TdxRangeControlPredefinedDateHeaderScale.IsDisplayFormatStored
  : Boolean;
begin
...
function TdxRangeControlDateTimeScales.CreatePredefinedDateTimeScale
  (AScaleUnit: TdxRangeControlDateTimeScaleUnit): TdxRangeControlDateTimeScale;
begin
  Result := (Owner as TdxRangeControlCustomDateTimeClientProperties)
    .CreatePredefinedDateTimeScale(Self, AScaleUnit);
end;
...
function TdxRangeControlDateTimeScales.RegisterScale
  (AClass: TdxRangeControlDateTimeScaleClass): TdxRangeControlDateTimeScale;
var
  AIndex: Integer;
begin
...
procedure TdxRangeControlDateTimeScales.SetPrimaryScale
  (Value: TdxRangeControlDateTimeScale);
begin
  if FPrimaryScale <> Value then
  begin
    FPrimaryScale := Value;
    (Owner as TdxRangeControlCustomDateTimeClientProperties)
      .PrimaryScaleChanged;
  end;
end;

function TdxRangeControlDateTimeScales.GetPrimaryScale
  : TdxRangeControlDateTimeScale;
begin
...
procedure TdxRangeControlDateTimeScales.SetDay
  (Value: TdxRangeControlDateTimeScale);
begin
  FDay.Assign(Value);
end;

procedure TdxRangeControlDateTimeScales.SetHour
  (Value: TdxRangeControlDateTimeScale);
begin
  FHour.Assign(Value);
end;

procedure TdxRangeControlDateTimeScales.SetMinute
  (Value: TdxRangeControlDateTimeScale);
begin
  FMinute.Assign(Value);
end;

procedure TdxRangeControlDateTimeScales.SetMonth
  (Value: TdxRangeControlDateTimeScale);
begin
  FMonth.Assign(Value);
end;

procedure TdxRangeControlDateTimeScales.SetQuarter
  (AValue: TdxRangeControlDateTimeScale);
begin
  FQuarter.Assign(AValue);
end;

procedure TdxRangeControlDateTimeScales.SetWeek
  (Value: TdxRangeControlDateTimeScale);
begin
  FWeek.Assign(Value);
end;

procedure TdxRangeControlDateTimeScales.SetYear
  (Value: TdxRangeControlDateTimeScale);
begin
  FYear.Assign(Value);
end;

procedure TdxRangeControlDateTimeScales.UnRegisterScale
...
class function TdxRangeControlDateTimeAutoFormatHelper.ChooseFormat
  (const ADate: TDateTime; AFont: TFont; AWidth: Integer;
  AScale: TdxRangeControlDateTimeScale): Integer;
var
  I: Integer;
  ATextWidth: Integer;
begin
...
class function TdxRangeControlDateTimeAutoFormatHelper.FormatDay
  (const ADate: TDateTime; AFormatId: Integer): string;
begin
...
class function TdxRangeControlDateTimeAutoFormatHelper.FindBeginOfSequence
  (const AStr: string; AStartPosition: Integer; const ASoughtForChars: string;
  AForward: Boolean): Integer;
var
  ACurrentChar: Char;
  ACount: Integer;
...
begin
  ...
  begin
    ...
    else if not AInStringLiteral and (Pos(ACurrentChar, ASoughtForChars) > 0)
    then
    begin
      Result := I;
      Break;
...
class function TdxRangeControlDateTimeAutoFormatHelper.FindEndOfSequence
  (const AStr: string; AStartPosition: Integer;
  const ASoughtForChar: Char): Integer;
var
  ACount: Integer;
  I: Integer;
begin
...
class function TdxRangeControlDateTimeAutoFormatHelper.FormatMonth
  (const ADate: TDateTime; AFormatId: Integer): string;
begin
  case AFormatId of
    0:
      Result := FormatDateTime('mm', ADate);
    1:
      Result := FormatDateTime('mmm', ADate);
  else
    Result := FormatDateTime('mmmm', ADate);
  end;
end;

class function TdxRangeControlDateTimeAutoFormatHelper.GetFormatCount
  (AScaleUnit: TdxRangeControlDateTimeScaleUnit): Integer;
begin
  case AScaleUnit of
    rcduMinute:
      Result := 1;
...
class function TdxRangeControlDateTimeAutoFormatHelper.FormatHour
  (const ADate: TDateTime; AFormatId: Integer): string;
begin
  Result := FormatDateTime('hh', ADate);
end;

class function TdxRangeControlDateTimeAutoFormatHelper.FormatMinute
  (const ADate: TDateTime; AFormatId: Integer): string;
begin
  Result := FormatDateTime('nn', ADate);
end;

class function TdxRangeControlDateTimeAutoFormatHelper.FormatQuarter
  (const ADate: TDateTime; AFormatId: Integer): string;
var
...
class function TdxRangeControlDateTimeAutoFormatHelper.FormatSecond
  (const ADate: TDateTime; AFormatId: Integer): string;
begin
  Result := FormatDateTime('ss', ADate);
end;

class function TdxRangeControlDateTimeAutoFormatHelper.FormatWeek
  (const ADate: TDateTime; AFormatId: Integer): string;
begin
...
class function TdxRangeControlDateTimeAutoFormatHelper.FormatYear
  (const ADate: TDateTime; AFormatId: Integer): string;
begin
  Result := FormatDateTime('yyyy', ADate);
end;
...
begin
  ...
  ALongFormat := StripYear(cxFormatController.LocalFormatSettings.
    LongDateFormat);
...
class function TdxRangeControlDateTimeAutoFormatHelper.Strip(const APattern
  : string; AFormatChar: Char; ALength: Integer): string;
...
begin
  ...
  ASequenceEnd := 0;
  repeat
    ASequenceStart := FindBeginOfSequence(APattern, ASequenceEnd + 1,
      AFormatChar, True);
    if ASequenceStart > 0 then
      ASequenceEnd := FindEndOfSequence(APattern, ASequenceStart, AFormatChar);
  until (ASequenceStart <= 0) or (ALength = -1) or
    (ALength = ASequenceEnd - ASequenceStart);

  if ASequenceStart > 0 then
  begin
    if ASequenceStart = 1 then
    begin
      AYearSuffixEnd := FindBeginOfSequence(Result, ASequenceEnd,
        DateTimePatterns, True);
      if AYearSuffixEnd = 0 then
        Result := ''
      else
        Result := Copy(Result, 1, ASequenceStart - 1) +
          Copy(Result, AYearSuffixEnd, Length(Result));
    end
    else if ASequenceEnd > Length(Result) then
    begin
      AYearPrefixStart := FindBeginOfSequence(Result, ASequenceStart - 1,
        DateTimePatterns, False);
      if AYearPrefixStart = 0 then
        Result := ''
      else
        Result := Copy(Result, 1, AYearPrefixStart) + Copy(Result, ASequenceEnd,
          Length(Result));
    end
    else
    begin
      AYearSuffixEnd := FindBeginOfSequence(Result, ASequenceEnd,
        AComposedTerminators, True);
      AYearPrefixStart := FindBeginOfSequence(Result, ASequenceStart - 1,
        DateTimePatterns, False);
      AWhiteSpace := '';
      if (AYearPrefixStart > 0) and (AYearSuffixEnd > 0) then
      begin
        APrevChar := IfThen(AYearPrefixStart > 1, Result[AYearPrefixStart],
          DateTimePatterns[1]);
        ANextChar := Result[AYearSuffixEnd];
        if (Pos(APrevChar, DateTimePatterns) > 0) and
          (Pos(ANextChar, DateTimePatterns) > 0) then
          AWhiteSpace := ' ';
      end;
      if AYearSuffixEnd = 0 then
        Result := Copy(Result, 1, ASequenceStart - 1)
      ...
      begin
        ...
        if (AYearPrefixStart <= APatternLength) and
          (ASequenceStart <= APatternLength) then
        begin
        ...
        Result := Copy(Result, 1, AYearPrefixStart) + AWhiteSpace +
          Copy(Result, ASequenceStart, Length(Result));
      end;
    end;
    Result := Trim(Result);
  end;
...
class function TdxRangeControlDateTimeAutoFormatHelper.StripDay
...
class function TdxRangeControlDateTimeAutoFormatHelper.StripDayOfWeek
  (const APattern: string): string;
begin
...
class function TdxRangeControlDateTimeAutoFormatHelper.StripMonth
  (const APattern: string): string;
begin
  Result := Strip(APattern, 'M', -1);
end;

class function TdxRangeControlDateTimeAutoFormatHelper.StripYear
  (const APattern: string): string;
begin
...
constructor TdxRangeControlDateTimeHeaderClientContentViewInfo.Create
  (AViewInfo: TdxCustomRangeControlViewInfo);
begin
  inherited Create(AViewInfo);
  FElements :=
    TObjectList<
    TdxRangeControlDateTimeHeaderClientContentElementViewInfo>.Create;
end;
...
procedure TdxRangeControlDateTimeHeaderClientContentViewInfo.Paint
  (ACanvas: TcxCanvas);
var
  I: Integer;
begin
...
function TdxRangeControlDateTimeHeaderClientContentViewInfo.AddElement
  : TdxRangeControlDateTimeHeaderClientContentElementViewInfo;
begin
...
procedure TdxRangeControlDateTimeHeaderClientContentViewInfo.CalculateBounds
  (const ABounds: TRect);

  function CreateContentElement(APrimaryScale: TdxRangeControlDateTimeScale;
    ADate: TDateTime; const ARect: TRect)
    : TdxRangeControlDateTimeHeaderClientContentElementViewInfo;
  begin
    Result := AddElement;
...
begin
  inherited CalculateBounds(ABounds);
  Elements.Clear;
  AProperties := ViewInfo.ClientProperties as
    TdxRangeControlCustomDateTimeHeaderClientProperties;
  ...
  begin
    ...
    AIntervalCount := APrimaryScale.GetDateInterval(AVisibleRangeMinValue,
      AVisibleRangeMaxValue);
    ...
    begin
      ...
      while CreateContentElement(APrimaryScale, ADate, ARect).MaxDate <
        AVisibleRangeMaxValue do
      begin
...
function TdxRangeControlDateTimeHeaderClientContentViewInfo.
  CreateContentElementViewInfo
  : TdxRangeControlDateTimeHeaderClientContentElementViewInfo;
begin
  Result := TdxRangeControlDateTimeHeaderClientContentElementViewInfo.Create
    (ViewInfo);
end;

{ TdxRangeControlDateTimeHeaderClientViewInfo }

procedure TdxRangeControlDateTimeHeaderClientViewInfo.CalculateBounds
  (const ABounds: TRect);
  ...
  function CreateRulerElement(AScaleInfo: TdxRangeControlRulerScaleViewInfo;
    ADate: TDateTime; const ARect: TRect): TdxRangeControlScaleElementViewInfo;
  begin
...
begin
  ...
  Properties.FMaxIntervalCount := (Bounds.Width - 1) /
    Properties.ScaleIntervalMinWidth;

  if (Properties.FMaxIntervalCount >= 1) and ViewInfo.RangeControl.ShowRuler
  then
    CreateScales;
  ...
  AAutoFormat := Properties.AutoFormatScaleCaptions and
    (Properties.AutoFormatHelper <> nil);
  AVisibleRangeMaxValue := Control.VisibleRangeMaxValue;
  AVisibleRangeMinValue := Control.VisibleRangeMinValue;
  ...
  begin
    ...
    AMinFormatId := MaxInt;
    while CreateRulerElement(ACurrentScaleInfo, ADate, AElementRect).MaxValue <
      AVisibleRangeMaxValue do
    begin
      ARulerElement := ACurrentScaleInfo.Elements.Last;
      AElementRect.Right := ViewInfo.GetPositionFromValue
        (ARulerElement.MaxValue);
      ARulerElement.CalculateBounds(AElementRect);
      if AAutoFormat and (ARulerElement <> ACurrentScaleInfo.Elements.First)
      then
      begin
        AFormatId := Properties.AutoFormatHelper.ChooseFormat
          (ARulerElement.MinValue, ViewInfo.GetRulerLabelFont,
          ARulerElement.Bounds.Width -
          cxMarginsWidth(ARulerElement.GetContentOffsets),
          ACurrentScaleInfo.Scale);
    ...
    begin
      ...
      begin
        ...
        AMinFormatId := Properties.AutoFormatHelper.ChooseFormat
          (ARulerElement.MinValue, ViewInfo.GetRulerLabelFont,
          ARulerElement.Bounds.Width -
          cxMarginsWidth(ARulerElement.GetContentOffsets),
          ACurrentScaleInfo.Scale);
      ...
      for J := 0 to ACurrentScaleInfo.Elements.Count - 1 do
        ACurrentScaleInfo.Elements[J].Text :=
          ACurrentScaleInfo.Scale.GetDisplayText
          (ACurrentScaleInfo.Elements[J].MinValue, AMinFormatId);
    end
    else
      for J := 0 to ACurrentScaleInfo.Elements.Count - 1 do
        ACurrentScaleInfo.Elements[J].Text :=
          ACurrentScaleInfo.Scale.GetDefaultDisplayText
          (ACurrentScaleInfo.Elements[J].MinValue);
  end;
...
function TdxRangeControlDateTimeHeaderClientViewInfo.CreateContentInfo
  : TdxRangeControlContentViewInfo;
begin
  Result := TdxRangeControlDateTimeHeaderClientContentViewInfo.Create(ViewInfo);
end;

function TdxRangeControlDateTimeHeaderClientViewInfo.CreateRulerInfo
  : TdxRangeControlRulerViewInfo;
begin
  Result := TdxRangeControlDateTimeHeaderClientRulerViewInfo.Create(ViewInfo);
end;

function TdxRangeControlDateTimeHeaderClientViewInfo.GetContent
  : TdxRangeControlDateTimeHeaderClientContentViewInfo;
begin
  Result := inherited Content as
    TdxRangeControlDateTimeHeaderClientContentViewInfo;
end;

function TdxRangeControlDateTimeHeaderClientViewInfo.GetProperties
  : TdxRangeControlCustomDateTimeHeaderClientProperties;
begin
  Result := Control.ClientProperties as
    TdxRangeControlCustomDateTimeHeaderClientProperties;
...
function TdxRangeControlDateTimeHeaderClientViewInfo.GetRuler
  : TdxRangeControlDateTimeHeaderClientRulerViewInfo;
begin
...
constructor TdxRangeControlDateTimeHeaderClientStyle.Create
  (AOwner: TPersistent);
begin
  inherited;
...
procedure TdxRangeControlDateTimeHeaderClientStyle.DoAssign
  (Source: TPersistent);
var
...
procedure TdxRangeControlDateTimeHeaderClientStyle.SetRulerHeaderColor
  (Value: TdxAlphaColor);
begin
...
procedure TdxRangeControlDateTimeHeaderClientStyle.SetRulerHeaderHotColor
  (Value: TdxAlphaColor);
begin
...
procedure TdxRangeControlDateTimeHeaderClientStyle.SetRulerHeaderTextColor
  (Value: TColor);
begin
...
constructor TdxRangeControlCustomDateTimeHeaderClientProperties.Create
  (AOwner: TPersistent);
begin
  inherited Create(AOwner);
...
procedure TdxRangeControlCustomDateTimeHeaderClientProperties.
  CheckVisibleRangeMaxInterval;
begin
  RangeControl.ViewInfo.FCheckZoomNeeded := True;
end;

function TdxRangeControlCustomDateTimeHeaderClientProperties.
  CreatePredefinedDateTimeScale(AScales: TdxRangeControlDateTimeScales;
  AScaleUnit: TdxRangeControlDateTimeScaleUnit): TdxRangeControlDateTimeScale;
begin
  Result := TdxRangeControlPredefinedDateHeaderScale.Create(AScales,
    AScaleUnit);
end;

function TdxRangeControlCustomDateTimeHeaderClientProperties.CreateStyle
  : TdxRangeControlCustomClientStyle;
begin
  Result := TdxRangeControlDateTimeHeaderClientStyle.Create(Self);
end;

function TdxRangeControlCustomDateTimeHeaderClientProperties.CreateViewInfo
  (AViewInfo: TdxCustomRangeControlViewInfo)
  : TdxRangeControlCustomClientViewInfo;
begin
...
function TdxRangeControlCustomDateTimeHeaderClientProperties.
  GetMinSelectedInterval: Variant;
begin
  Result := 1;
end;

procedure TdxRangeControlCustomDateTimeHeaderClientProperties.DoAssign
  (Source: TPersistent);
var
...
procedure TdxRangeControlCustomDateTimeHeaderClientProperties.
  DoUpdateVisibleScales(AValues: TdxRangeControlDateTimeScaleList);
...
var
  ...
  I: Integer;
begin
  for AScaleUnit := High(TdxRangeControlDateTimeScaleUnit)
    downto Low(TdxRangeControlDateTimeScaleUnit) do
...
procedure TdxRangeControlCustomDateTimeHeaderClientProperties.
  SetAutoFormatHelper(Value: TdxRangeControlDateTimeAutoFormatHelperClass);
begin
...
procedure TdxRangeControlCustomDateTimeHeaderClientProperties.
  SetAutoFormatScaleCaptions(Value: Boolean);
begin
...
procedure TdxRangeControlCustomDateTimeHeaderClientProperties.SetMaxValue
  (Value: Variant);
begin
  CheckVisibleRangeMaxInterval;
  inherited SetMaxValue(Value);
...
procedure TdxRangeControlCustomDateTimeHeaderClientProperties.SetMinValue
  (Value: Variant);
begin
  CheckVisibleRangeMaxInterval;
  inherited SetMinValue(Value);
...
constructor TdxCustomRangeControlViewInfo.Create(ARangeControl
  : TdxCustomRangeControl);
begin
  inherited Create;
...
begin
  ...
  begin
    ...
    FMinZoomScrollBarVisiblePos := AStartPos +
      Round(ANormalizedVisibleRangeMin * AFactor);
    FMaxZoomScrollBarVisiblePos := AStartPos +
      Round(ANormalizedVisibleRangeMax * AFactor);
    FMinZoomScrollBarSelectedPos := AStartPos +
      Round(FRangeControl.FNormalizedSelectedEditingMinValue * AFactor);
    FMaxZoomScrollBarSelectedPos := AStartPos +
      Round(FRangeControl.FNormalizedSelectedEditingMaxValue * AFactor);
    FClientAreaNormalFactor := AFactor /
      (ANormalizedVisibleRangeMax - ANormalizedVisibleRangeMin);
    FMinClientSelectedPos := GetPositionInClientAreaFromNormalValue
      (FRangeControl.FNormalizedSelectedEditingMinValue);
    FMaxClientSelectedPos := GetPositionInClientAreaFromNormalValue
      (FRangeControl.FNormalizedSelectedEditingMaxValue);
    if PressedInfo = ClientArea then
    begin
      FMinClientSelectedTargetPos := GetPositionInClientAreaFromNormalValue
        (Min(FRangeControl.FStartSelectionTargetIntervalMinValue,
        FRangeControl.FEndSelectionTargetIntervalMinValue));
      FMaxClientSelectedTargetPos := GetPositionInClientAreaFromNormalValue
        (Max(FRangeControl.FStartSelectionTargetIntervalMaxValue,
        FRangeControl.FEndSelectionTargetIntervalMaxValue));
    end;

    R.Top := R.Bottom - IfThen(RangeControl.ShowZoomScrollBar,
      Painter.GetRangeControlScaledScrollAreaHeight(RangeControl.ScaleFactor));
    ...
    CalculateHitTest(RangeControl.ScreenToClient(cxControls.GetMouseCursorPos),
      KeyboardStateToShiftState);
    HotInfo := HitTest.HitObject;
  end;
end;

procedure TdxCustomRangeControlViewInfo.CalculateHitTest(const APoint: TPoint;
  AShift: TShiftState);
begin
  FHitTest.Clear;
...
const
  GrayScaleFilter: TdxGpColorMatrix = ((0.3, 0.3, 0.3, 0, 0),
    (0.59, 0.59, 0.59, 0, 0), (0.11, 0.11, 0.11, 0, 0), (0, 0, 0, 0.35, 0),
    (0, 0, 0, 0, 1));
  ...
  begin
    ...
    try
      AAttributes.SetColorMatrix(@AColorMatrix, ColorMatrixFlagsDefault,
  ...
  begin
    ...
    try
      ...
      dxGPPaintCanvas.FillRectangle(ABitmap.ClientRect,
        dxColorToAlphaColor(GetBackgroundColor));
      dxGPPaintCanvas.EndPaint;
...
begin
  ...
  begin
    ...
    begin
      ...
      if not cxRectIntersect(R, R, FClientArea.Bounds) or
        (R.Width < FClientArea.Bounds.Width) then
      begin
        dxGPPaintCanvas.BeginPaint(ACanvas.Handle, FClientArea.Bounds);
        try
          if R.Width > 0 then
            dxGPPaintCanvas.SetClipRect(R, gmExclude);
          dxGPPaintCanvas.Draw(FContentMaskImage, FClientArea.Bounds,
            FContentMaskImage.ClientRect);
        finally
          dxGPPaintCanvas.EndPaint;
        end;
      end;
      ...
      begin
        ...
        try
          ...
          dxGPPaintCanvas.Draw(FContentImage, FClientArea.Bounds,
            FContentImage.ClientRect);
        finally
          dxGPPaintCanvas.EndPaint;
        end;
      end;
...
function TdxCustomRangeControlViewInfo.GetPositionFromValue
  (const AValue: Variant): Integer;
begin
  Result := GetPositionInClientAreaFromNormalValue
    (ClientProperties.GetNormalizedValue(AValue));
end;

procedure TdxCustomRangeControlViewInfo.CheckCursorAtPoint(const APoint: TPoint;
  var ACursor: TCursor);
begin
  CalculateHitTest(APoint, []);
  if FHitTest.HitAtZoomScrollBarMinZoomGrip or
    FHitTest.HitAtZoomScrollBarMaxZoomGrip or
    FHitTest.HitAtClientAreaMinSelectionThumb or FHitTest.HitAtClientAreaMaxSelectionThumb
  then
    ACursor := crHSplit;
end;

function TdxCustomRangeControlViewInfo.CreateHitTest
  : TdxCustomRangeControlHitTest;
begin
...
function TdxCustomRangeControlViewInfo.GetClientProperties
  : TdxRangeControlCustomClientProperties;
begin
...
function TdxCustomRangeControlViewInfo.GetPositionInClientAreaFromNormalValue
  (const AValue: Double): Integer;
begin
  Result := Round(FBounds.Left +
    (AValue - RangeControl.NormalizedVisibleRangeMinValue) *
    FClientAreaNormalFactor);
end;
...
function TdxCustomRangeControlViewInfo.GetSelectedRegionBackgroundColor
  : TdxAlphaColor;
begin
...
function TdxCustomRangeControlViewInfo.GetSelectedRegionBorderColor
  : TdxAlphaColor;
begin
...
begin
  ...
  begin
    ...
    ZoomScrollBarSelectedRangeThumbColor :=
      ASource.ZoomScrollBarSelectedRangeThumbColor;
    ZoomScrollBarVisibleRangeThumbColor :=
      ASource.ZoomScrollBarVisibleRangeThumbColor;
  end;
end;
...
procedure TdxCustomRangeControlStyle.SetElementBorderColor
  (Value: TdxAlphaColor);
begin
...
procedure TdxCustomRangeControlStyle.SetSelectionBorderColor
  (Value: TdxAlphaColor);
begin
...
procedure TdxCustomRangeControlStyle.SetZoomScrollBarSelectedRangeThumbColor
  (Value: TColor);
begin
...
procedure TdxCustomRangeControlStyle.SetZoomScrollBarVisibleRangeThumbColor
  (Value: TColor);
begin
...
procedure TdxCustomRangeControl.SetNormalizedSelectedRange(const AMin,
  AMax: Double; AChangeType: TdxRangeElementTypes; AAnimated: Boolean);
var
...
procedure TdxCustomRangeControl.SetNormalizedSelectedRangeByMaxValue
  (AValue: Double);
var
  AIsOverflow: Boolean;
begin
  AValue := EnsureRange(AValue,
    ClientProperties.GetNextNormalizedAcceptableValue(0,
    ClientProperties.GetMinSelectedInterval, AIsOverflow), 1);
  if FNormalizedSelectedRangeMaxValue <> AValue then
  begin
    FNormalizedSelectedRangeMaxValue := AValue;
    FNormalizedSelectedRangeMinValue :=
      EnsureRange(FNormalizedSelectedRangeMinValue, 0,
      ClientProperties.GetNextNormalizedAcceptableValue
      (FNormalizedSelectedRangeMaxValue,
      -ClientProperties.GetMinSelectedInterval, AIsOverflow));
  end;
end;

procedure TdxCustomRangeControl.SetNormalizedSelectedRangeByMinValue
  (AValue: Double);
var
  AIsOverflow: Boolean;
begin
  AValue := EnsureRange(AValue, 0,
    ClientProperties.GetNextNormalizedAcceptableValue(1,
    -ClientProperties.GetMinSelectedInterval, AIsOverflow));
  if FNormalizedSelectedRangeMinValue <> AValue then
  begin
    FNormalizedSelectedRangeMinValue := AValue;
    FNormalizedSelectedRangeMaxValue :=
      EnsureRange(FNormalizedSelectedRangeMaxValue,
      ClientProperties.GetNextNormalizedAcceptableValue
      (FNormalizedSelectedRangeMinValue,
      ClientProperties.GetMinSelectedInterval, AIsOverflow), 1);
  end;
...
begin
  ...
  begin
    ...
    if (ClientProperties <> nil) and ClientProperties.IsAutoZoomSupported and
      ...
      UpdateVisibleRangeMaxInterval
        (ClientProperties.GetNormalizedVisibleRangeMaxInterval);
    FIsViewInfoDirty := False;
    Invalidate;
  end;
end;

procedure TdxCustomRangeControl.ChangeScaleEx(M, D: Integer;
  isDpiChange: Boolean);
begin
  inherited;
  if ClientProperties <> nil then
...
procedure TdxCustomRangeControl.DoSelectedRangeAnimate
...
begin
  if FNormalizedSelectedEditingMinValue <> FNormalizedSelectedRangeMinValue then
    FNormalizedSelectedEditingMinValue :=
      FSelectedRangeAnimationNormalizedMinStartValue +
      (FNormalizedSelectedRangeMinValue -
      FSelectedRangeAnimationNormalizedMinStartValue) * APosition /
      FSelectedRangeAnimationLength;
  if FNormalizedSelectedEditingMaxValue <> FNormalizedSelectedRangeMaxValue then
    FNormalizedSelectedEditingMaxValue :=
      FSelectedRangeAnimationNormalizedMaxStartValue +
      (FNormalizedSelectedRangeMaxValue -
      FSelectedRangeAnimationNormalizedMaxStartValue) * APosition /
      FSelectedRangeAnimationLength;
  Changed;
end;

procedure TdxCustomRangeControl.DoSelectedRangeAnimationTerminate
  (Sender: TObject);
begin
...
function TdxCustomRangeControl.DoOnDrawContent(ACanvas: TcxCanvas;
  AViewInfo: TdxRangeControlCustomClientViewInfo): Boolean;
begin
...
function TdxCustomRangeControl.DoOnDrawScale(ACanvas: TcxCanvas;
  AViewInfo: TdxRangeControlCustomClientViewInfo): Boolean;
begin
...
procedure TdxCustomRangeControl.DoVisibleRangeAnimate
  (Sender: TdxAnimationTransition; var APosition: Integer;
  var AFinished: Boolean);
var
  AInterval: Double;
begin
  AInterval := FNormalizedVisibleRangeMaxValue -
    FNormalizedVisibleRangeMinValue;
  BeginUpdate;
  try
    NormalizedVisibleRangeMinValue :=
      FVisibleRangeAnimationNormalizedMinStartValue +
      (FVisibleRangeAnimationNormalizedMinFinishValue -
      FVisibleRangeAnimationNormalizedMinStartValue) * APosition /
      FVisibleRangeAnimationLength;
    NormalizedVisibleRangeMaxValue := NormalizedVisibleRangeMinValue +
      AInterval;
  finally
...
procedure TdxCustomRangeControl.DoVisibleRangeAnimationTerminate
  (Sender: TObject);
begin
...
begin
  ACanvas.FrameRect(Bounds, cxGetActualColor(Style.BorderColor,
    LookAndFeelPainter.GetRangeControlBorderColor));
end;
...
begin
  Result := (FLockCount > 0) or IsLoading or IsDestroying or
    not HandleAllocated;
end;
...
begin
  ...
  begin
    GetNormalizedIntervalFromPosInClientArea(X,
      FStartSelectionTargetIntervalMinValue,
      FStartSelectionTargetIntervalMaxValue);
    ...
    FEndSelectionTargetIntervalMinValue :=
      FStartSelectionTargetIntervalMinValue;
    FEndSelectionTargetIntervalMaxValue :=
      FStartSelectionTargetIntervalMaxValue;
    if HitTest.HitAtClientArea then
      Changed;
  end
  else if ViewInfo.PressedInfo = ViewInfo.ZoomScrollBar then
...
procedure TdxCustomRangeControl.MouseMove(Shift: TShiftState; X, Y: Integer);
  ...
  begin
    ...
    else if ViewInfo.PressedInfo = ViewInfo.ClientArea.MaxSelectionThumb then
    begin
      FNormalizedSelectedEditingMaxValue :=
        EnsureRange(GetNormalizedValueFromPositionInClientArea(X),
        FNormalizedSelectedEditingMinValue, 1);
      Changed;
    end
    else if ViewInfo.PressedInfo = ViewInfo.ClientArea.MinSelectionThumb then
    begin
      FNormalizedSelectedEditingMinValue :=
        EnsureRange(GetNormalizedValueFromPositionInClientArea(X), 0,
        FNormalizedSelectedEditingMaxValue);
      Changed;
    end
    else if ViewInfo.PressedInfo = ViewInfo.ClientArea.SelectedRange then
    begin
      ARangeInterval := FNormalizedSelectedEditingMaxValue -
        FNormalizedSelectedEditingMinValue;
      FNormalizedSelectedEditingMinValue :=
        EnsureRange(GetNormalizedValueFromPositionInClientArea
        (X - FDragPointOffset), 0, 1 - ARangeInterval);
      FNormalizedSelectedEditingMaxValue := FNormalizedSelectedEditingMinValue +
        ARangeInterval;
      Changed;
    end
    else if ViewInfo.PressedInfo = ViewInfo.ZoomScrollBar.ViewportScrollThumb
    then
      SetViewportPosition(X - FDragPointOffset, False)
    else if ViewInfo.PressedInfo = ViewInfo.ZoomScrollBar.MinZoomGrip then
    begin
      AMin := EnsureRange(GetNormalizedValueFromPositionInZoomScrollBarArea
        (X - FDragPointOffset), Max(0, NormalizedVisibleRangeMaxValue -
        FNormalizedVisibleRangeMaxInterval), NormalizedVisibleRangeMaxValue -
        FNormalizedVisibleRangeMinInterval);
      NormalizedVisibleRangeMinValue := AMin;
      StoreVisibleRangeInterval;
    end
    else if ViewInfo.PressedInfo = ViewInfo.ZoomScrollBar.MaxZoomGrip then
    begin
      AMax := EnsureRange(GetNormalizedValueFromPositionInZoomScrollBarArea
        (X - FDragPointOffset), NormalizedVisibleRangeMinValue +
        FNormalizedVisibleRangeMinInterval,
        Min(1, NormalizedVisibleRangeMinValue +
        FNormalizedVisibleRangeMaxInterval));
      NormalizedVisibleRangeMaxValue := AMax;
      StoreVisibleRangeInterval;
    end
    else if ViewInfo.PressedInfo = ViewInfo.ZoomScrollBar.SelectionScrollThumb
    then
    begin
      ARangeInterval := FNormalizedSelectedEditingMaxValue -
        FNormalizedSelectedEditingMinValue;
      FNormalizedSelectedEditingMinValue :=
        EnsureRange(GetNormalizedValueFromPositionInZoomScrollBarArea
        (X - FDragPointOffset), 0, 1 - ARangeInterval);
      FNormalizedSelectedEditingMaxValue := FNormalizedSelectedEditingMinValue +
        ARangeInterval;
      Changed;
  ...
  begin
    Result := (ViewInfo.PressedInfo <> nil) and (Abs(X - MouseDownPos.X) > 3);
    // check ViewInfo.PressedInfo.CanDrag
  end;
  ...
  begin
    ...
    if (ViewInfo.PressedInfo = ViewInfo.ClientArea.MinSelectionThumb) and
      ((X - FDragPointOffset) >=
      (ViewInfo.ClientArea.MaxSelectionThumb.Bounds.Left)) then
      ViewInfo.PressedInfo := ViewInfo.ClientArea.MaxSelectionThumb
    else if (ViewInfo.PressedInfo = ViewInfo.ClientArea.MaxSelectionThumb) and
      ((X - FDragPointOffset) <=
      (ViewInfo.ClientArea.MinSelectionThumb.Bounds.Left)) then
...
begin
  ...
  else if CanStartDragging(Shift, X, Y) then
...
procedure TdxCustomRangeControl.MouseUp(Button: TMouseButton;
  ...
  var
    AMin, AMax: Double;
  begin
    AMin := Min(FStartSelectionTargetIntervalMinValue,
      FEndSelectionTargetIntervalMinValue);
    AMax := Max(FStartSelectionTargetIntervalMaxValue,
      FEndSelectionTargetIntervalMaxValue);
...
begin
  ...
  begin
    ...
    begin
      AMin := ClientProperties.GetNearestNormalizedAcceptableValue
        (FNormalizedSelectedEditingMinValue);
      AValue := ClientProperties.GetNextNormalizedAcceptableValue(AMin,
        ClientProperties.GetMinSelectedInterval, AIsOverflow);
      if FNormalizedSelectedEditingMaxValue < AValue then
        AMax := AValue
      else
        AMax := ClientProperties.GetNearestNormalizedAcceptableValue
          (FNormalizedSelectedEditingMaxValue);
    ...
    begin
      AMax := ClientProperties.GetNearestNormalizedAcceptableValue
        (FNormalizedSelectedEditingMaxValue);
      AValue := ClientProperties.GetNextNormalizedAcceptableValue(AMax,
        -ClientProperties.GetMinSelectedInterval, AIsOverflow);
    ...
    else if (ViewInfo.PressedInfo = ViewInfo.ClientArea.SelectedRange) or
      (ViewInfo.PressedInfo = ViewInfo.ZoomScrollBar.SelectionScrollThumb) then
    begin
      AMin := ClientProperties.GetNearestNormalizedAcceptableValue
        (FNormalizedSelectedEditingMinValue);
      ...
      begin
        AInterval := ClientProperties.GetInterval
          (FNormalizedSelectedRangeMinValue, FNormalizedSelectedRangeMaxValue);
        AMax := ClientProperties.GetNextNormalizedAcceptableValue
          (FNormalizedSelectedEditingMinValue, AInterval, AIsOverflow);
        if AIsOverflow then
          AMin := ClientProperties.GetNextNormalizedAcceptableValue(AMax,
            -AInterval, AIsOverflow);
      end
      else
        AMax := ClientProperties.GetNearestNormalizedAcceptableValue
          (FNormalizedSelectedEditingMaxValue);
  ...
  begin
    AMin := ClientProperties.GetNormalizedValue
      (TdxRangeControlScaleElementViewInfo(ViewInfo.PressedInfo).MinValue);
    ANearestValue := ClientProperties.GetNearestNormalizedAcceptableValue(AMin);
    if ANearestValue <= AMin then
      AMin := ANearestValue
    else
      AMin := ClientProperties.GetNextNormalizedAcceptableValue(ANearestValue,
        -1, AIsOverflow);
    AMax := ClientProperties.GetNormalizedValue
      (TdxRangeControlScaleElementViewInfo(ViewInfo.PressedInfo).MaxValue);
    ANearestValue := ClientProperties.GetNearestNormalizedAcceptableValue(AMax);
    if ANearestValue >= AMax then
      AMax := ANearestValue
    else
      AMax := ClientProperties.GetNextNormalizedAcceptableValue(ANearestValue,
        1, AIsOverflow);
    SetNormalizedSelectedRange(AMin, AMax, [retMin, retMax], True);
  end;
  ViewInfo.PressedInfo := nil;
...
procedure TdxCustomRangeControl.SynchronizeSelectedRangeEditingValue
  (AAnimated: Boolean);
begin
  ...
  begin
    ...
    FSelectedRangeAnimationController := TdxAnimationTransition.Create
      (AnimationTime, AnimationTransitionEffect, FSelectedRangeAnimationLength);
    FSelectedRangeAnimationController.OnAnimate := DoSelectedRangeAnimate;
    FSelectedRangeAnimationController.OnTerminate :=
      DoSelectedRangeAnimationTerminate;
...
procedure TdxCustomRangeControl.GetNormalizedIntervalFromPosInClientArea
  (APos: Integer; out AMin, AMax: Double);
var
...
begin
  ...
  AAcceptableValue :=
    ClientProperties.GetNearestNormalizedAcceptableValue(AValue);
  ...
  begin
    ...
    AMax := ClientProperties.GetNextNormalizedAcceptableValue(AAcceptableValue,
      AInterval, AIsOverflow);
  end
  else
  begin
    AMax := AAcceptableValue;
    AMin := ClientProperties.GetNextNormalizedAcceptableValue(AAcceptableValue,
      -AInterval, AIsOverflow);
  end;
end;

function TdxCustomRangeControl.GetNormalizedValueFromPosition(APos: Integer;
  AScaleAreaViewInfo: TdxRangeControlElementViewInfo;
  const AMin, AMax: Double): Double;
begin
  Result := AMin + (APos - AScaleAreaViewInfo.Bounds.Left) * (AMax - AMin) /
    AScaleAreaViewInfo.Bounds.Width;
...
function TdxCustomRangeControl.GetPositionFromValue(const AValue
  : Variant): Integer;
begin
...
begin
  if ClientProperties <> nil then
    Result := ClientProperties.GetOriginalValue
      (FNormalizedSelectedRangeMaxValue)
  else
    Result := Null;
end;
...
begin
  if ClientProperties <> nil then
    Result := ClientProperties.GetOriginalValue(FNormalizedVisibleRangeMaxValue,
      ClientProperties.GetVisibleRangeValueType)
  else
    Result := Null;
end;
...
begin
  if ClientProperties <> nil then
    Result := ClientProperties.GetOriginalValue(FNormalizedVisibleRangeMinValue,
      ClientProperties.GetVisibleRangeValueType)
  else
    Result := Null;
end;
...
begin
  FNormalizedSelectedEditingMinValue :=
    ClientProperties.GetNearestNormalizedAcceptableValue
    (FNormalizedSelectedEditingMinValue);
  FNormalizedSelectedEditingMaxValue :=
    ClientProperties.GetNextNormalizedAcceptableValue
    (FNormalizedSelectedEditingMinValue,
    ClientProperties.GetMinSelectedInterval, AIsOverflow);
  FNormalizedVisibleRangeMaxValue := FNormalizedVisibleRangeMinValue +
    FNormalizedVisibleRangeMaxInterval;
...
function TdxCustomRangeControl.InternalMouseWheel(Shift: TShiftState;
...
begin
  ...
  begin
    ...
    begin
      ARangeInterval := FNormalizedVisibleRangeMaxValue -
        FNormalizedVisibleRangeMinValue;
      BeginUpdate;
      try
        ...
        begin
          ...
          begin
            ACenter := (FNormalizedVisibleRangeMaxValue +
              FNormalizedVisibleRangeMinValue) / 2;
            ANewInterval := Min(ARangeInterval * Factor,
              FNormalizedVisibleRangeMaxInterval);
            NormalizedVisibleRangeMinValue := ACenter - ANewInterval / 2;
            NormalizedVisibleRangeMaxValue := FNormalizedVisibleRangeMinValue +
              ANewInterval;
            NormalizedVisibleRangeMinValue := NormalizedVisibleRangeMaxValue -
              ANewInterval;
            StoreVisibleRangeInterval;
          end;
        end
        ...
        begin
          ...
          begin
            ACenter := (FNormalizedVisibleRangeMaxValue +
              FNormalizedVisibleRangeMinValue) / 2;
            ANewInterval := Max(ARangeInterval / Factor,
              FNormalizedVisibleRangeMinInterval);
            NormalizedVisibleRangeMinValue := ACenter - ANewInterval / 2;
            NormalizedVisibleRangeMaxValue := FNormalizedVisibleRangeMinValue +
              ANewInterval;
      ...
      OffsetVisibleRange(-Sign(WheelDelta) * Mouse.WheelScrollLines *
        0.02, False);
  end;
end;
...
function TdxCustomRangeControl.IsMouseWheelHandleNeeded(Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
  Result := ClientProperties <> nil;
end;
...
begin
  ...
  if (Key = VK_ESCAPE) and IsCancelModeNeeded then
    ...
    case Key of
      ...
      VK_END:
        SetViewportStartValue(1 - FNormalizedVisibleRangeMaxValue +
          FNormalizedVisibleRangeMinValue, True);
      VK_PRIOR:
        OffsetVisibleRange(-FNormalizedVisibleRangeMaxValue +
          FNormalizedVisibleRangeMinValue, True);
      VK_NEXT:
        OffsetVisibleRange(FNormalizedVisibleRangeMaxValue -
          FNormalizedVisibleRangeMinValue, True);
...
var
  ...
  AValue: Double;
begin
  ASelectedRangeDelta := FNormalizedSelectedRangeMaxValue -
    FNormalizedSelectedRangeMinValue;
  AVisibleRangeDelta := FNormalizedVisibleRangeMaxValue -
    FNormalizedVisibleRangeMinValue;
  if AVisibleRangeDelta >= ASelectedRangeDelta then
    AValue := (FNormalizedSelectedRangeMinValue +
      FNormalizedSelectedRangeMaxValue - AVisibleRangeDelta) / 2
  else
    AValue := FNormalizedSelectedRangeMinValue;
  AValue := Max(AValue, 0);
...
procedure TdxCustomRangeControl.OffsetVisibleRange(const AValue: Double;
  AAnimated: Boolean);
var
...
procedure TdxCustomRangeControl.RecreateClientProperties
  (Value: TdxRangeControlClientPropertiesClass);
begin
...
procedure TdxCustomRangeControl.SetClientProperties
  (Value: TdxRangeControlCustomClientProperties);
begin
  if ClientProperties <> nil then
    FClientProperties.Assign(Value);
end;

procedure TdxCustomRangeControl.SetClientPropertiesClass
  (Value: TdxRangeControlClientPropertiesClass);
begin
  ...
  begin
    ...
    try
      if (FClient <> nil) and
        ((Value = nil) or not Value.InheritsFrom(GetClient.GetPropertiesClass))
      then
        Client := nil;
...
procedure TdxCustomRangeControl.SetClientPropertiesClassName
  (const AValue: string);
begin
  ClientPropertiesClass := TdxRangeControlClientPropertiesClass
    (dxRangeControlClients.FindByClassName(AValue));
end;

procedure TdxCustomRangeControl.SetNormalizedVisibleRangeMaxValue
  (AValue: Double);

  procedure CheckNormalizedVisibleRangeMinValue;
  begin
    FNormalizedVisibleRangeMinValue :=
      EnsureRange(FNormalizedVisibleRangeMinValue,
      Max(0, FNormalizedVisibleRangeMaxValue -
      FNormalizedVisibleRangeMaxInterval), FNormalizedVisibleRangeMaxValue -
      FNormalizedVisibleRangeMinInterval);
  end;
...
procedure TdxCustomRangeControl.SetNormalizedVisibleRangeMinValue
  (AValue: Double);

  procedure CheckNormalizedVisibleRangeMaxValue;
  begin
    FNormalizedVisibleRangeMaxValue :=
      EnsureRange(FNormalizedVisibleRangeMaxValue,
      FNormalizedVisibleRangeMinValue + FNormalizedVisibleRangeMinInterval,
      Min(1, FNormalizedVisibleRangeMinValue +
      FNormalizedVisibleRangeMaxInterval));
  end;
...
procedure TdxCustomRangeControl.SetSelectedRangeMaxValue
  (Value: TdxRangeEditValue);
var
...
begin
  ...
  begin
    ...
    ANormalizedValue := ClientProperties.GetNearestNormalizedAcceptableValue
      (ANormalizedValue);
    SetNormalizedSelectedRange(NormalizedSelectedRangeMinValue,
      ANormalizedValue, [retMax], True);
  end;
end;

procedure TdxCustomRangeControl.SetSelectedRangeMinValue
  (Value: TdxRangeEditValue);
var
  ANormalizedValue: Double;
begin
  ...
  begin
    ...
    ANormalizedValue := ClientProperties.GetNearestNormalizedAcceptableValue
      (ANormalizedValue);
    SetNormalizedSelectedRange(ANormalizedValue,
      NormalizedSelectedRangeMaxValue, [retMin], True);
  end;
end;
...
procedure TdxCustomRangeControl.SetViewportPosition(APos: Integer;
  AAnimated: Boolean);
var
  AValue: Double;
  ARangeInterval: Double;
begin
  ARangeInterval := FNormalizedVisibleRangeMaxValue -
    FNormalizedVisibleRangeMinValue;
  AValue := EnsureRange(GetNormalizedValueFromPositionInZoomScrollBarArea(APos),
    0, 1 - ARangeInterval);
  SetViewportStartValue(AValue, AAnimated);
end;

procedure TdxCustomRangeControl.SetViewportStartValue(const AValue: Double;
  AAnimated: Boolean);
var
  ARangeInterval: Double;
begin
  ...
  begin
    ...
    FVisibleRangeAnimationController := TdxAnimationTransition.Create
      (AnimationTime, AnimationTransitionEffect, FVisibleRangeAnimationLength);
    FVisibleRangeAnimationController.OnAnimate := DoVisibleRangeAnimate;
    FVisibleRangeAnimationController.OnTerminate :=
      DoVisibleRangeAnimationTerminate;
...
procedure TdxCustomRangeControl.SetVisibleRangeMaxValue
  (Value: TdxRangeEditValue);
begin
  if ClientProperties <> nil then
  begin
    StopVisibleRangeAnimation;
    NormalizedVisibleRangeMaxValue :=
      ClientProperties.GetNormalizedValue(Value);
    StoreVisibleRangeInterval;
  end;
end;

procedure TdxCustomRangeControl.SetVisibleRangeMinValue
  (Value: TdxRangeEditValue);
begin
  if ClientProperties <> nil then
  begin
...
begin
  FNormalizedVisibleRangeStoredInterval := NormalizedVisibleRangeMaxValue -
    NormalizedVisibleRangeMinValue;
end;
...
begin
  ...
  begin
    ACheckIntervalNeeded := (AValue > FNormalizedVisibleRangeMaxInterval) and
      (FNormalizedVisibleRangeStoredInterval > 0);
    FNormalizedVisibleRangeMaxInterval := AValue;
    if FNormalizedVisibleRangeMinInterval > FNormalizedVisibleRangeMaxInterval
    then
      VisibleRangeMaxScaleFactor := VisibleRangeMaxScaleFactor;
    if (NormalizedVisibleRangeMaxValue - NormalizedVisibleRangeMinValue) > AValue
    then
    ...
    begin
      if NormalizedVisibleRangeMaxValue = 1 then
        NormalizedVisibleRangeMinValue :=
          1 - FNormalizedVisibleRangeStoredInterval
      else
        NormalizedVisibleRangeMaxValue := NormalizedVisibleRangeMinValue +
          FNormalizedVisibleRangeStoredInterval;
    end;
  end;
end;
...
begin
  ...
  if (NormalizedVisibleRangeMaxValue - NormalizedVisibleRangeMinValue) < AInterval
  then
    if NormalizedVisibleRangeMaxValue = 1 then
...
dxRangeControlClients.Register(TdxRangeControlNumericClientProperties,
  'Numeric');
dxRangeControlClients.Register(TdxRangeControlDateTimeClientProperties,
  'DateTime');
dxRangeControlClients.Register(TdxRangeControlDateTimeHeaderClientProperties,
  'DateTimeHeader');
