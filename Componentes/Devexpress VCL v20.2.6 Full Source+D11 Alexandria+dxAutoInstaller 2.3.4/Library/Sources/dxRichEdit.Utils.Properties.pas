...
type
  ...
  TdxTableCellOperation = (ShiftToTheHorizontally, ShiftToTheVertically,
    RowOperation, ColumnOperation);

  { TdxMergeDestination }

  TdxMergeDestination = (NewTab, &File);
  ...
  public
    ...
    class function Create(AUnicodeChar: Char; const AFontName: string)
      : TdxSymbolProperties; overload; static;
  ...
  public
    constructor Create(AColumnsCount, ARowsCount: Integer;
      AMergeCellsBeforeSplit: Boolean; ARowCountAfterMerge: Integer);
    ...
    property MergeCellsBeforeSplit: Boolean read FMergeCellsBeforeSplit
      write SetMergeCellsBeforeSplit;
    property IsSelectedCellsSquare: Boolean read FIsSelectedCellsSquare
      write SetIsSelectedCellsSquare;
    property RowCountAfterMerge: Integer read FRowCountAfterMerge
      write SetRowCountAfterMerge;
  end;
  ...
  public
    ...
    property CellOperation: TdxTableCellOperation read FCellOperation
      write FCellOperation;
  end;
  ...
  protected
    ...
    procedure CalculateNotEqualColumnsOnChangeCount(APreviousCount
      : Integer); virtual;
    procedure CorrectColumns; virtual;
    procedure DisableTheLastSpacing; virtual;
    procedure CalculateUniformColumnsCore(AColumnWidth: Integer;
      AColumnSpacing: Integer; ARestWidth: Integer;
      ARestSpacing: Integer); virtual;
  ...
  public
    ...
    procedure CalculateUniformColumnsByColumnWidth(AColumnWidth
      : Integer); overload;
    procedure CalculateUniformColumnsByColumnSpacing; overload;
    procedure CalculateUniformColumnsByColumnSpacing(AColumnSpacing
      : Integer); overload;
    ...
    property AvailableApplyType: TdxSectionPropertiesApplyTypes
      read FAvailableApplyType write FAvailableApplyType;
    property ApplyType: TdxSectionPropertiesApplyType read FApplyType
      write FApplyType;
    property PageWidth: Integer read FPageWidth write FPageWidth;
    property ColumnCount: TdxNullableInteger read FColumnCount
      write FColumnCount;
    property EqualColumnWidth: TdxNullableBoolean read FEqualColumnWidth
      write FEqualColumnWidth;
  ...
  public const
    Spacing = 1800;
  public
    function MatchTo(AColumnsInfo: TdxColumnsInfoUI): Boolean; virtual;
      abstract;
    ...
    class function CreateTwoUniformColumnsInfoPreset
      : TdxColumnsInfoPreset; static;
    class function CreateThreeUniformColumnsInfoPreset
      : TdxColumnsInfoPreset; static;
    class function CreateLeftNarrowColumnsInfoPreset
      : TdxColumnsInfoPreset; static;
    class function CreateRightNarrowColumnsInfoPreset
      : TdxColumnsInfoPreset; static;
  end;
  ...
  public
    constructor Create(AFloatingObjectAnchorRun
    ...
    property FloatingObjectAnchorRun: TdxFloatingObjectAnchorRun
      read FFloatingObjectAnchorRun write FFloatingObjectAnchorRun;
  ...
  public
    ...
    property AvailableApplyType: TdxSectionPropertiesApplyTypes
      read FAvailableApplyTypes write FAvailableApplyTypes;
    property ApplyType: TdxSectionPropertiesApplyType read FApplyType
      write FApplyType;
    property LeftMargin: TdxNullableInteger read FLeftMargin write FLeftMargin;
    property RightMargin: TdxNullableInteger read FRightMargin
      write FRightMargin;
    property TopMargin: TdxNullableInteger read FTopMargin write FTopMargin;
    property BottomMargin: TdxNullableInteger read FBottomMargin
      write FBottomMargin;
    property PaperWidth: TdxNullableInteger read FPaperWidth write FPaperWidth;
    property PaperHeight: TdxNullableInteger read FPaperHeight
      write FPaperHeight;
    property PaperKind: TdxNullableValue<TdxPaperKind> read FPaperKind
      write FPaperKind;
    property Landscape: TdxNullableBoolean read FLandscape write FLandscape;
    property SectionStartType: TdxNullableValue<TdxSectionStartType>
      read FSectionStartType write FSectionStartType;
    property DifferentFirstPage: TdxNullableBoolean read FDifferentFirstPage
      write FDifferentFirstPage;
    property DifferentOddAndEvenPages: TdxNullableBoolean
      read FDifferentOddAndEvenPages write FDifferentOddAndEvenPages;
  end;
  ...
  public
    constructor Create(AMergeRecords: TdxMergeRecords;
      AMergeDestination: TdxMergeDestination);
    property MergeRecords: TdxMergeRecords read FMergeRecords
      write FMergeRecords;
    property MergeDestination: TdxMergeDestination read FMergeDestination
      write FMergeDestination;
  end;
...
type
  ...
  protected
    ...
    function HasEnoughSpaceForDistribution(AFrom, ATo, ASpace: Integer)
      : Boolean;
    function SetMinValues(AFrom, ATo, ASpace: Integer): Integer;
    procedure CorrectValue(AIndex: Integer);
    function DistributeRemainder(AFrom: Integer; ATo: Integer;
      ARemainder: Integer): Integer;
    function DistributeSpaceCore(AFrom: Integer; ATo: Integer;
      ASpace: Integer): Integer;
    function DistributeSpace(AFrom: Integer; ATo: Integer;
      ASpace: Integer): Integer;
    procedure SetAllValues(AValue: Integer; ARest: Integer);
    function GetValue(AColumn: TdxColumnInfoUI): Integer; virtual; abstract;
    procedure SetValue(AColumn: TdxColumnInfoUI; AValue: Integer);
      virtual; abstract;
  public
  ...
  TdxColumnsDistributionWidthPriorityCalculator = class
    (TdxColumnsDistributionCalculator)
  protected
  ...
  TdxColumnsDistributionSpacingPriorityCalculator = class
    (TdxColumnsDistributionCalculator)
  protected
    function GetMinValue: Integer; override;
    function GetValue(AColumn: TdxColumnInfoUI): Integer; override;
...
class function TdxSymbolProperties.Create(AUnicodeChar: Char;
  const AFontName: string): TdxSymbolProperties;
begin
  Result.UnicodeChar := AUnicodeChar;
  Result.FontName := AFontName;
end;

class operator TdxSymbolProperties.Equal(const A,
  B: TdxSymbolProperties): Boolean;
begin
...
constructor TdxCreateTableParameters.Create(ARowCount: Integer;
...
constructor TdxSplitTableCellsParameters.Create(AColumnsCount,
  ARowsCount: Integer; AMergeCellsBeforeSplit: Boolean;
...
procedure TdxSplitTableCellsParameters.SetIsSelectedCellsSquare
  (const Value: Boolean);
begin
  FIsSelectedCellsSquare := Value;
end;

procedure TdxSplitTableCellsParameters.SetMergeCellsBeforeSplit
  (const Value: Boolean);
begin
  FMergeCellsBeforeSplit := Value;
end;

procedure TdxSplitTableCellsParameters.SetRowCountAfterMerge
  (const Value: Integer);
begin
...
constructor TdxTableCellsParameters.Create(ACellOperation
  : TdxTableCellOperation);
begin
...
begin
  ...
  AvailableApplyType := [TdxSectionPropertiesApplyType.CurrentSection,
    TdxSectionPropertiesApplyType.SelectedSections,
...
procedure TdxColumnsInfoUI.CalculateNotEqualColumnsOnChangeCount
  (APreviousCount: Integer);
var
...
begin
  ...
  for I := 0 to ACalculateCount - 1 do
    Columns[I].Width := Max(MinColumnWidth, MulDiv(Columns[I].Width.Value,
      APreviousCount, Columns.Count));

  for I := 0 to ACalculateCount - 1 - 1 do
    Columns[I].Spacing := Max(MinSpacingWidth, MulDiv(Columns[I].Spacing.Value,
      (APreviousCount - 1), Columns.Count - 1));
...
var
  ADifference, ASumWidth, ASumSpacing, ADifferenceWidth,
    ADifferenceSpacing: Integer;
...
begin
  ...
  ACalculatorWidth := TdxColumnsDistributionWidthPriorityCalculator.
    Create(Columns);
  ACalculatorSpacing := TdxColumnsDistributionSpacingPriorityCalculator.
    Create(Columns);
  try
    ...
    ACalculatorSpacing.DistributeSpace(0, Columns.Count - 2,
      ADifferenceSpacing);
  finally
...
procedure TdxColumnsInfoUI.RecalculateColumnsBySpacingAfterIndex
  (AIndex: Integer);
begin
  if HasColumnsInfoUINull then
    Exit;
...
procedure TdxColumnsInfoUI.CalculateUniformColumnsCore(AColumnWidth: Integer;
  AColumnSpacing: Integer; ARestWidth: Integer; ARestSpacing: Integer);
var
  ACalculatorWidth, ACalculatorSpacing: TdxColumnsDistributionCalculator;
begin
  ACalculatorWidth := TdxColumnsDistributionWidthPriorityCalculator.
...
begin
  ...
  if AColumnSpacing * (FColumnCount.Value - 1) > FPageWidth - MinColumnWidth *
    FColumnCount.Value then
    AColumnSpacing := (FPageWidth - MinColumnWidth * FColumnCount.Value)
      div (FColumnCount.Value - 1);
...
procedure TdxColumnsInfoUI.ChangeColumnsNotEqualByWidthAfterIndex
  (AIndex: Integer);
var
  ACalculatorWidth, ACalculatorSpacing: TdxColumnsDistributionCalculator;
  ADifference: Integer;
begin
  if FColumnCount.IsNull or (FColumnCount.Value <= 0) or
    (AIndex >= FColumnCount.Value) then
    Exit;
  ...
  try
    ...
    ADifference := -CalculateAvailableSpace;
    ADifference := ACalculatorWidth.DistributeSpace(AIndex + 1,
      FColumnCount.Value - 1, ADifference);
    ADifference := ACalculatorWidth.DistributeSpace(0, AIndex - 1, ADifference);
    ADifference := ACalculatorSpacing.DistributeSpace(0, FColumnCount.Value - 2,
      ADifference);
...
procedure TdxColumnsInfoUI.ChangeColumnsNotEqualBySpacingAfterIndex
  (AIndex: Integer);
var
  ACalculatorWidth, ACalculatorSpacing: TdxColumnsDistributionCalculator;
  ADifference: Integer;
begin
  ...
  try
    ...
    ADifference := ACalculatorSpacing.DistributeSpace(0, AIndex - 1,
      ADifference);
    ADifference := ACalculatorSpacing.DistributeSpace(AIndex + 1,
      FColumnCount.Value - 2, ADifference);
...
constructor TdxColumnsDistributionCalculator.Create
  (AColumns: TdxObjectList<TdxColumnInfoUI>);
begin
  inherited Create;
  FColumns := AColumns;
end;

function TdxColumnsDistributionCalculator.CalculateTotal(AFrom,
  ATo: Integer): Integer;
var
  I: Integer;
begin
...
function TdxColumnsDistributionCalculator.HasEnoughSpaceForDistribution(AFrom,
  ATo, ASpace: Integer): Boolean;
var
  ATotal: Integer;
begin
...
function TdxColumnsDistributionCalculator.SetMinValues(AFrom, ATo,
  ASpace: Integer): Integer;
var
  I: Integer;
begin
...
function TdxColumnsDistributionCalculator.DistributeRemainder(AFrom: Integer;
  ATo: Integer; ARemainder: Integer): Integer;
var
...
function TdxColumnsDistributionCalculator.DistributeSpaceCore(AFrom: Integer;
  ATo: Integer; ASpace: Integer): Integer;
var
...
function TdxColumnsDistributionCalculator.DistributeSpace(AFrom: Integer;
  ATo: Integer; ASpace: Integer): Integer;
begin
  if AFrom > ATo then
    Result := ASpace
  else if HasEnoughSpaceForDistribution(AFrom, ATo, ASpace) then
    Result := DistributeSpaceCore(AFrom, ATo, ASpace)
  else
    Result := SetMinValues(AFrom, ATo, ASpace);
end;

procedure TdxColumnsDistributionCalculator.SetAllValues(AValue: Integer;
  ARest: Integer);
var
  ACount, I: Integer;
begin
...
function TdxColumnsDistributionWidthPriorityCalculator.GetValue
  (AColumn: TdxColumnInfoUI): Integer;
begin
  if not AColumn.Width.IsNull then
...
procedure TdxColumnsDistributionWidthPriorityCalculator.SetValue
  (AColumn: TdxColumnInfoUI; AValue: Integer);
begin
...
function TdxColumnsDistributionSpacingPriorityCalculator.GetValue
  (AColumn: TdxColumnInfoUI): Integer;
begin
  if not AColumn.Spacing.IsNull then
...
procedure TdxColumnsDistributionSpacingPriorityCalculator.SetValue
  (AColumn: TdxColumnInfoUI; AValue: Integer);
begin
...
function TdxUniformColumnsInfoPreset.MatchTo(AColumnsInfo
  : TdxColumnsInfoUI): Boolean;
begin
  if AColumnsInfo.EqualColumnWidth.IsNull then
    Result := False
  else if not AColumnsInfo.EqualColumnWidth.Value then
    Result := False
  else if AColumnsInfo.ColumnCount.IsNull then
    Result := False
  else
...
function TdxTwoNonUniformColumnsInfoPreset.MatchTo(AColumnsInfo
  : TdxColumnsInfoUI): Boolean;
var
  ATotalWidth: Integer;
begin
  if AColumnsInfo.EqualColumnWidth.IsNull or AColumnsInfo.EqualColumnWidth.Value
  then
    Exit(False);
  ...
  if AColumnsInfo.Columns[0].Width <>
    Round(ATotalWidth * FirstColumnRelativeWidth) then
    Exit(False);
  if AColumnsInfo.Columns[0].Spacing <> Spacing then
    Exit(False);
  if AColumnsInfo.Columns[1].Width <>
    Round(ATotalWidth - AColumnsInfo.Columns[0].Width.Value) then
    Exit(False);

  Result := AColumnsInfo.Columns[1].Spacing = 0;
end;

procedure TdxTwoNonUniformColumnsInfoPreset.ApplyTo(AColumnsInfo
  : TdxColumnsInfoUI);
var
  ATotalWidth: Integer;
begin
  ...
  ATotalWidth := AColumnsInfo.PageWidth - Spacing;
  AColumnsInfo.Columns[0].Width :=
    Round(ATotalWidth * FirstColumnRelativeWidth);
  AColumnsInfo.Columns[0].Spacing := Spacing;
  AColumnsInfo.Columns[1].Width :=
    Round(ATotalWidth - AColumnsInfo.Columns[0].Width.Value);
...
constructor TdxFloatingInlineObjectParameters.Create(AInlinePictureRun
  : TdxInlinePictureRun);
begin
...
constructor TdxFloatingInlineObjectParameters.Create(AFloatingObjectAnchorRun
...
constructor TdxMergeRecordsParameters.Create(AMergeRecords: TdxMergeRecords;
  AMergeDestination: TdxMergeDestination);
begin
...
class function TdxColumnsInfoPreset.CreateLeftNarrowColumnsInfoPreset
  : TdxColumnsInfoPreset;
begin
  Result := TdxLeftNarrowColumnsInfoPreset.Create;
end;

class function TdxColumnsInfoPreset.CreateRightNarrowColumnsInfoPreset
  : TdxColumnsInfoPreset;
begin
  Result := TdxRightNarrowColumnsInfoPreset.Create;
end;

class function TdxColumnsInfoPreset.CreateSingleColumnsInfoPreset
  : TdxColumnsInfoPreset;
begin
  Result := TdxSingleColumnsInfoPreset.Create;
end;

class function TdxColumnsInfoPreset.CreateThreeUniformColumnsInfoPreset
  : TdxColumnsInfoPreset;
begin
  Result := TdxThreeUniformColumnsInfoPreset.Create;
end;

class function TdxColumnsInfoPreset.CreateTwoUniformColumnsInfoPreset
  : TdxColumnsInfoPreset;
begin
