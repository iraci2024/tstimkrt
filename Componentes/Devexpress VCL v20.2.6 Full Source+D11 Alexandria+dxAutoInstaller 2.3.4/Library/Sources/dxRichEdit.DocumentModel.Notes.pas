...
type
  ...
  public
    procedure GetPieceTables(AResult: TdxFastList;
  ...
  private
    function GetItem(Index: Integer): TdxFootNote; inline;
  public
  ...
  private
    function GetItem(Index: Integer): TdxEndNote; inline;
  public
...
function TdxFootNoteBase.LookupSectionIndexByParagraphIndex(AParagraphIndex
  : TdxParagraphIndex): TdxSectionIndex;
begin
  Result := dxSectionIndexDontCare;
end;

procedure TdxFootNoteBase.FixLastParagraphOfLastSection(AOriginalParagraphCount
  : Integer);
begin
end;
