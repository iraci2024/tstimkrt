...
type
  ...
  TdxStyleType = (ParagraphStyle, CharacterStyle, TableStyle,
    NumberingListStyle, TableCellStyle);
  ...
  TdxStyleBase = class(TdxCustomStyleObject, IdxStyle, IdxBatchUpdatable,
  ...
  protected
    function CalculateChangeActions: TdxDocumentModelChangeActions;
      virtual; abstract;
    ...
    function GetSemihidden: Boolean;
    procedure ResetCachedIndices(AResetFormattingCacheType
      : TdxResetFormattingCacheType); virtual;
  ...
  public
    ...
    function Copy(ATargetModel: TdxCustomDocumentModel): Integer;
      virtual; abstract;
  ...
  protected
    ...
    procedure NotifyPieceTableStyleDeleting(APieceTable: TdxCustomPieceTable;
      AStyle: TdxStyleBase); virtual; abstract;
    procedure RaiseCollectionChanged;
    procedure ResetItemCachedIndices(AStyle: TdxStyleBase;
  ...
  public
    ...
    function GetStyleIndexByName(const AStyleName: string;
    ...
    property OnCollectionChanged: TNotifyEvent read FOnCollectionChanged
      write FOnCollectionChanged;
  end;
...
type
  ...
  public
    constructor Create(AStyle: TdxStyleBase;
      AOldParentStyle, ANewParentStyle: T); reintroduce;
  ...
  public
    constructor Create(AStyle: TdxStyleBase;
      const AOldStyleName, ANewStyleName: string); reintroduce;
    property Style: TdxStyleBase read FStyle;
  ...
  protected
    ...
    procedure RedoCore; override;
  public
    constructor Create(AOwner: TdxStyleCollectionBase; AStyle: TdxStyleBase);
      reintroduce;
...
constructor TdxChangeParentStyleHistoryItem<T>.Create(AStyle: TdxStyleBase;
  AOldParentStyle, ANewParentStyle: T);
begin
...
constructor TdxChangeStyleNameHistoryItem.Create(AStyle: TdxStyleBase;
  const AOldStyleName, ANewStyleName: string);
begin
  inherited Create(AStyle.DocumentModel.MainPart);
  FStyle := AStyle;
...
constructor TdxDeleteStyleHistoryItem.Create(AOwner: TdxStyleCollectionBase;
  AStyle: TdxStyleBase);
begin
...
constructor TdxAddStyleHistoryItem.Create(AOwner: TdxStyleCollectionBase;
  AStyle: TdxStyleBase);
begin
  inherited Create(AStyle);
  FOwner := AOwner;
...
constructor TdxAddDeletedStyleHistoryItem.Create(AOwner: TdxStyleCollectionBase;
  AStyle: TdxStyleBase);
begin
  inherited Create(AStyle);
  FOwner := AOwner;
...
begin
  ...
  DocumentModel.ApplyChangesCore(PieceTable, Actions, 0,
    PieceTable.Runs.Count - 1);
end;
...
procedure TdxStyleBase.ResetCachedIndices(AResetFormattingCacheType
  : TdxResetFormattingCacheType);
begin
end;
...
begin
  ...
  begin
    if (DocumentModel.DeferredChanges = nil) or
      not DocumentModel.DeferredChanges.IsSetContentMode then
  ...
  AItem := TdxChangeParentStyleHistoryItem<TdxStyleBase>.Create(Self,
    Parent, Value);
...
begin
  ...
  begin
    AHistoryItem := TdxChangeStyleNameHistoryItem.Create(Self,
      FStyleName, Value);
...
constructor TdxStyleCollectionBase.Create(ADocumentModel
...
function TdxStyleCollectionBase.GetStyleIndexByName(const AStyleName: string;
  AIgnoreCase: Boolean = False): Integer;
var
  I: Integer;
begin
...
function TdxStyleCollectionBase.GetStyleByName(const AStyleName: string)
  : TdxStyleBase;
var
  AIndex: Integer;
begin
...
procedure TdxStyleCollectionBase.ResetCachedIndices(AResetFormattingCacheType
  : TdxResetFormattingCacheType);
var
  I: Integer;
begin
...
procedure TdxStyleCollectionBase.NotifyChildrenParentDeleting
  (AItem: TdxStyleBase);
var
  I: Integer;
  AStyle: TdxStyleBase;
...
procedure TdxStyleCollectionBase.NotifyDocumentStyleDeleting
  (AItem: TdxStyleBase);
var
...
begin
  ...
  Result := (AParent <> nil) and (not FItems.Contains(AParent) or
    AParent.Deleted);
end;
