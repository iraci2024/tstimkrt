...
type
  ...
  public
    constructor Create(ACharacterStyleIndex, ACharacterPropertiesIndex
      : Integer);
  ...
  public
    constructor Create(AParagraphStyleIndex: Integer;
      AParagraphPropertiesIndex: Integer;
      ANumberingListIndex: TdxNumberingListIndex; ANumberingListLevel: Integer);
  ...
  private
    ...
    FParagraphPropertiesIndex: Integer;
  public
    constructor Create(AParagraphStyleIndex, AParagraphPropertiesIndex
      : Integer);
    property ParagraphStyleIndex: Integer read FParagraphStyleIndex;
    property ParagraphPropertiesIndex: Integer read FParagraphPropertiesIndex;
  end;
  ...
  strict private
    ...
    FIsInserted: Boolean;
    FMapSourceToTargetCharacterFormatting
      : TDictionary<TdxRunCharacterFormatting, TdxRunCharacterFormatting>;
    FMapSourceToTargetParagraphFormatting
      : TDictionary<TdxRunParagraphFormattingKey, TdxRunParagraphFormatting>;
  strict private
  ...
  strict protected
    ...
    property MapSourceToTargetCharacterFormatting
      : TDictionary<TdxRunCharacterFormatting, TdxRunCharacterFormatting>
      read FMapSourceToTargetCharacterFormatting;
    property MapSourceToTargetParagraphFormatting
      : TDictionary<TdxRunParagraphFormattingKey, TdxRunParagraphFormatting>
      read FMapSourceToTargetParagraphFormatting;
  public
    constructor Create(ASourcePieceTable, ATargetPieceTable
      ...
      TdxFormattingCopyOptions.UseDestinationStyles); virtual;
    ...
    property FormattingCopyOptions: TdxFormattingCopyOptions
      read FFormattingCopyOptions;
    property ParagraphWasInsertedBeforeTable: Boolean
      read FParagraphWasInsertedBeforeTable
      write FParagraphWasInsertedBeforeTable;
  end;
...
constructor TdxRunCharacterFormatting.Create(ACharacterStyleIndex,
  ACharacterPropertiesIndex: Integer);
begin
...
constructor TdxRunParagraphFormattingKey.Create(AParagraphStyleIndex: Integer;
  AParagraphPropertiesIndex: Integer;
  ANumberingListIndex: TdxNumberingListIndex; ANumberingListLevel: Integer);
begin
...
constructor TdxRunParagraphFormatting.Create(AParagraphStyleIndex,
  AParagraphPropertiesIndex: Integer);
begin
  FParagraphStyleIndex := AParagraphStyleIndex;
  FParagraphPropertiesIndex := AParagraphPropertiesIndex;
...
constructor TdxCustomDocumentModelCopyManager.Create(ASourcePieceTable,
...
begin
  ...
  FMapSourceToTargetCharacterFormatting :=
    TDictionary<TdxRunCharacterFormatting, TdxRunCharacterFormatting>.Create;
  FMapSourceToTargetParagraphFormatting :=
    TDictionary<TdxRunParagraphFormattingKey, TdxRunParagraphFormatting>.Create;
end;
...
procedure TdxCustomDocumentModelCopyManager.CopyAdditionalInfo
  (ACopyBetweenInternalModels: Boolean);
begin
end;

function TdxCustomDocumentModelCopyManager.GetSourceModel
  : TdxCustomDocumentModel;
begin
  Result := SourcePieceTable.DocumentModel;
end;

function TdxCustomDocumentModelCopyManager.GetTargetModel
  : TdxCustomDocumentModel;
begin
...
function TdxCustomDeleteContentOperation.GetDocumentModel
  : TdxCustomDocumentModel;
begin
