...
procedure AddExpressVerticalGridResourceStringNames
...
begin
  ...
  InternalAdd('cxSvgDeletingFocusedConfirmationText',
    @cxSvgDeletingFocusedConfirmationText);
  InternalAdd('cxSvgDeletingConfirmationCaption',
    @cxSvgDeletingConfirmationCaption);
  ...
  InternalAdd('cxSvgCustomizeCategoriesCaption',
  ...
  InternalAdd('cxSvgRTTICollectionEditCaption',
    @cxSvgRTTICollectionEditCaption);
  ...
  InternalAdd('cxSvgRTTICollectionMoveDownHint',
    @cxSvgRTTICollectionMoveDownHint);
  InternalAdd('scxSvgFindPanelClearButtonCaption',
    @scxSvgFindPanelClearButtonCaption);
  InternalAdd('scxSvgFindPanelInfoText', @scxSvgFindPanelInfoText);
  InternalAdd('scxSvgFindPanelFindButtonCaption',
    @scxSvgFindPanelFindButtonCaption);
  InternalAdd('cxSvgFilterApplyButtonCaption', @cxSvgFilterApplyButtonCaption);
  InternalAdd('cxSvgFilterCustomizeButtonCaption',
...
dxResourceStringsRepository.RegisterProduct('ExpressVerticalGrid',
  @AddExpressVerticalGridResourceStringNames);
