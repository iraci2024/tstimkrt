...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Forms, StdCtrls, Graphics, Classes, Controls, SysUtils, Windows, cxClasses,
  cxGeometry,
  cxControls, cxLookAndFeelPainters, cxCustomData, dxScrollAnimation,
  cxGridCustomView, cxGridCustomTableView,
  dxCoreClasses, cxGraphics, cxStyles, cxEdit, cxGridCommon, cxTextEdit, cxMemo,
  cxImage, ImgList;
...
type
  ...
  TcxGridWinExplorerViewDisplayMode = (dmContent, dmExtraLargeImages,
    dmLargeImages, dmList, dmMediumImages, dmSmallImages, dmTiles);

  { TcxGridWinExplorerViewRecordExpandButtonPainter }

  TcxGridWinExplorerViewRecordExpandButtonPainter = class
  ...
  protected
    ...
    property ViewInfo: TcxGridWinExplorerViewExpandButtonViewInfo
      read GetViewInfo;
  end;
  ...
  protected
    ...
    property ViewInfo: TcxGridWinExplorerViewCustomRecordViewInfo
      read GetViewInfo;
  end;

  { TcxGridWinExplorerViewGroupRecordPainter }

  TcxGridWinExplorerViewGroupRecordPainter = class
    (TcxGridWinExplorerViewCustomRecordPainter)
  private
  ...
  protected
    ...
    property ViewInfo: TcxGridWinExplorerViewGroupRecordViewInfo
      read GetViewInfo;
  end;

  { TcxGridWinExplorerViewRecordPainter }

  TcxGridWinExplorerViewRecordPainter = class
    (TcxGridWinExplorerViewCustomRecordPainter)
  private
  ...
  TcxGridWinExplorerViewContentModeRecordPainter = class
    (TcxGridWinExplorerViewRecordPainter)
  private
    function GetViewInfo
      : TcxGridWinExplorerViewContentModeRecordViewInfo; inline;
  protected
    function CanDrawCheckBox: Boolean; override;
    procedure DrawSeparator; virtual;
    procedure Paint; override;

    property ViewInfo: TcxGridWinExplorerViewContentModeRecordViewInfo
      read GetViewInfo;
  end;

  { TcxGridWinExplorerViewTilesModeRecordPainter }

  TcxGridWinExplorerViewTilesModeRecordPainter = class
    (TcxGridWinExplorerViewRecordPainter)
  protected
    function CanDrawCheckBox: Boolean; override;
  end;
  ...
  TcxGridWinExplorerViewListModeRecordsPainter = class
    (TcxGridWinExplorerViewRecordsPainter)
  private
  ...
  protected
    ...
    property ViewInfo: TcxGridWinExplorerViewListModeRecordsViewInfo
      read GetViewInfo;
  end;
  ...
  protected
    function CanOffset(AItemsOffset: Integer; DX: Integer; DY: Integer)
      : Boolean; override;
  ...
  protected
    ...
    property RecordViewInfo: TcxGridWinExplorerViewGroupRecordViewInfo
      read FRecordViewInfo;
  public
    constructor Create(ARecordViewInfo
      : TcxGridWinExplorerViewGroupRecordViewInfo); reintroduce; virtual;
  end;
  ...
  protected
    ...
    function GetHotTrack: Boolean; override;
    function GetInternalPropertiesClass: TcxCustomEditPropertiesClass;
      virtual; abstract;
    ...
    property InternalProperties: TcxCustomEditProperties
      read FInternalProperties;
  public
    constructor Create(ARecordViewInfo: TcxCustomGridRecordViewInfo;
      AItem: TcxCustomGridTableItem); override;
    ...
    property RecordViewInfo: TcxGridWinExplorerViewRecordViewInfo
      read GetRecordViewInfo;
  end;

  { TcxGridWinExplorerViewCheckBoxViewInfo }

  TcxGridWinExplorerViewCheckBoxViewInfo = class
    (TcxGridWinExplorerViewCustomCellViewInfo)
  protected
    function GetBorders: TcxBorders; override;
  ...
  TcxGridWinExplorerViewTextViewInfo = class
    (TcxGridWinExplorerViewCustomCellViewInfo)
  private
  ...
  protected
    ...
    property InternalProperties: TcxTextEditProperties
      read GetInternalProperties;
  end;

  { TcxGridWinExplorerViewDescriptionViewInfo }

  TcxGridWinExplorerViewDescriptionViewInfo = class
    (TcxGridWinExplorerViewCustomCellViewInfo)
  private
  ...
  public
    ...
    property GridView: TcxGridWinExplorerView read GetGridView;
    property OptionsDisplayMode: TcxGridWinExplorerViewOptionsDisplayMode
      read GetOptionsDisplayMode;
    property RecordsViewInfo: TcxGridWinExplorerViewRecordsViewInfo
      read GetRecordsViewInfo;
  end;
  ...
  public
    ...
    TcxGridWinExplorerViewGroupRecordViewInfo = class
      (TcxGridWinExplorerViewCustomRecordViewInfo)private FClickTimer
      : TcxGridWinExplorerViewGroupClickTimer;
    ...
    procedure StartClickTimer(AHitTest: TcxCustomGridHitTest;
  ...
  protected
    ...
    property ExpandButtonViewInfo: TcxGridWinExplorerViewExpandButtonViewInfo
      read FExpandButtonViewInfo;
  ...
  TcxGridWinExplorerViewListModeGroupRecordViewInfo = class
    (TcxGridWinExplorerViewGroupRecordViewInfo)
  private
  ...
  public
    property RecordsViewInfo: TcxGridWinExplorerViewListModeRecordsViewInfo
      read GetRecordsViewInfo;
  end;
  ...
  protected
    ...
    function FindCell(AItem: TcxCustomGridTableItem)
      : TcxGridWinExplorerViewCustomCellViewInfo;
    ...
    function GetImageItem(out AImageList: TCustomImageList)
      : TcxGridWinExplorerViewItem; overload; virtual;
    ...
    procedure GetViewParams(var AParams: TcxViewParams); override;
    function GetWidth: Integer; override;
    procedure InitDescriptionProperties(AProperties
      : TcxMemoProperties); virtual;
  ...
  public
    ...
    property CheckBoxViewInfo: TcxGridWinExplorerViewCheckBoxViewInfo
      read FCheckBoxViewInfo;
    property DescriptionBounds: TRect read FDescriptionBounds;
    property DescriptionViewInfo: TcxGridWinExplorerViewDescriptionViewInfo
      read FDescriptionViewInfo;
    property ImageBounds: TRect read FImageBounds;
    property ImageViewInfo: TcxGridWinExplorerViewImageViewInfo
      read FImageViewInfo;
    property ItemSet: TcxGridWinExplorerViewItemSet read GetItemSet;
    property TextBounds: TRect read FTextBounds;
    property TextViewInfo: TcxGridWinExplorerViewTextViewInfo
      read FTextViewInfo;
  end;
  ...
  TcxGridWinExplorerViewSmallImagesModeRecordViewInfo = class
    (TcxGridWinExplorerViewRecordViewInfo)
  private
    function GetOptionsDisplayMode
      : TcxGridWinExplorerViewOptionsCustomSmallImagesDisplayMode;
  protected
    function CalculateCheckBoxBounds: TRect; override;
    function CalculateDescriptionBounds: TRect; override;
    function CalculateHeight: Integer; override;
  ...
  TcxGridWinExplorerViewListModeRecordViewInfo = class
    (TcxGridWinExplorerViewSmallImagesModeRecordViewInfo);

  { TcxGridWinExplorerViewTilesModeRecordViewInfo }

  TcxGridWinExplorerViewTilesModeRecordViewInfo = class
    (TcxGridWinExplorerViewSmallImagesModeRecordViewInfo)
  protected
    function CalculateCheckBoxBounds: TRect; override;
    function CalculateImageBounds: TRect; override;
  ...
  TcxGridWinExplorerViewMediumImagesModeRecordViewInfo = class
    (TcxGridWinExplorerViewRecordViewInfo)
  protected
    function CalculateCheckBoxBounds: TRect; override;
    function CalculateDescriptionBounds: TRect; override;
    ...
    function GetTextWidth: Integer; override;
    procedure InitDescriptionProperties(AProperties
      : TcxMemoProperties); override;
    procedure InitTextProperties(AProperties: TcxTextEditProperties); override;
  end;

  { TcxGridWinExplorerViewLargeModeRecordViewInfo }

  TcxGridWinExplorerViewLargeImagesModeRecordViewInfo = class
    (TcxGridWinExplorerViewMediumImagesModeRecordViewInfo)
  protected
    function GetImageType: TcxGridWinExplorerViewImageType; override;
  end;
  ...
  TcxGridWinExplorerViewExtraLargeImagesModeRecordViewInfo = class
  ...
  protected
    ...
    function GetDataRecordViewInfoClass
      : TcxCustomGridRecordViewInfoClass; virtual;
    function GetGroupRecordViewInfoClass
      : TcxCustomGridRecordViewInfoClass; virtual;
    ...
    function GetOptionsDisplayModeInstance
      : TcxGridWinExplorerViewOptionsDisplayMode; virtual; abstract;
    function GetFirstRecordIndexInBand(ARecordIndexInBand: Integer)
      : Integer; virtual;
    ...
    function IsRecordFullyVisibleAtBottom(ARecordIndex: Integer)
      : Boolean; virtual;
    function NeedConsideredRecordOffset
      (AItem: TcxGridWinExplorerViewCustomRecordViewInfo): Boolean; virtual;
    ...
    property OptionsDisplayMode: TcxGridWinExplorerViewOptionsDisplayMode
      read GetOptionsDisplayMode;
    property ViewData: TcxGridWinExplorerViewViewData read GetViewData;
    property DisplayModes: TcxGridWinExplorerViewOptionsDisplayModes
      read GetDisplayModes;
  public
    procedure DoRightToLeftConversion(const ABounds: TRect); override;
    procedure Offset(DX: Integer; DY: Integer); override;

    property GridView: TcxGridWinExplorerView read GetGridView;
    property Items[Index: Integer]: TcxGridWinExplorerViewCustomRecordViewInfo
      read GetItem; default;
  end;

  { TcxGridWinExplorerViewContentModeRecordsViewInfo }

  TcxGridWinExplorerViewContentModeRecordsViewInfo = class
    (TcxGridWinExplorerViewRecordsViewInfo)
  protected
    ...
    function GetDataRecordViewInfoClass
      : TcxCustomGridRecordViewInfoClass; override;
    function GetOptionsDisplayModeInstance
      : TcxGridWinExplorerViewOptionsDisplayMode; override;
  ...
  TcxGridWinExplorerViewCustomImagesModeRecordsViewInfo = class
    (TcxGridWinExplorerViewRecordsViewInfo)
  protected
  ...
  TcxGridWinExplorerViewImagesModeRecordsViewInfo = class
    (TcxGridWinExplorerViewCustomImagesModeRecordsViewInfo)
  protected
    function CalculateBounds: TRect; override;
    function CalculateContentBounds: TRect; override;
    procedure CalculatePartVisibleCount; override;
    function GetColumnCountByItem(AItem: TcxCustomGridRecordViewInfo)
      : Integer; virtual;
    ...
    function GetItemColumnIndex
      ...
      overload; virtual;
    function GetItemColumnIndex(ARecordIndex: Integer): Integer;
      overload; virtual;
    ...
    function GetContentScrollSize: Integer; override;
    function NeedConsideredRecordOffset
      (AItem: TcxGridWinExplorerViewCustomRecordViewInfo): Boolean; override;
    procedure UpdateVisibleCount; override;
  end;

  { TcxGridWinExplorerViewExtraLargeModeRecordsViewInfo }

  TcxGridWinExplorerViewExtraLargeImagesModeRecordsViewInfo = class
    (TcxGridWinExplorerViewImagesModeRecordsViewInfo)
  protected
    function GetDataRecordViewInfoClass
      : TcxCustomGridRecordViewInfoClass; override;
  ...
  TcxGridWinExplorerViewLargeImagesModeRecordsViewInfo = class
    (TcxGridWinExplorerViewImagesModeRecordsViewInfo)
  protected
    function GetDataRecordViewInfoClass
      : TcxCustomGridRecordViewInfoClass; override;
  ...
  TcxGridWinExplorerViewMediumImagesModeRecordsViewInfo = class
    (TcxGridWinExplorerViewImagesModeRecordsViewInfo)
  protected
    function GetDataRecordViewInfoClass
      : TcxCustomGridRecordViewInfoClass; override;
  ...
  TcxGridWinExplorerViewSmallImagesModeRecordsViewInfo = class
    (TcxGridWinExplorerViewImagesModeRecordsViewInfo)
  protected
    function GetDataRecordViewInfoClass
      : TcxCustomGridRecordViewInfoClass; override;
  ...
  TcxGridWinExplorerViewTilesModeRecordsViewInfo = class
    (TcxGridWinExplorerViewImagesModeRecordsViewInfo)
  protected
    function GetDataRecordViewInfoClass
      : TcxCustomGridRecordViewInfoClass; override;
  ...
  protected
    ...
    function GetItemPixelScrollSize(AItem: TcxCustomGridRecordViewInfo)
      : Integer; override;
    function GetItemRowIndex(AItem: TcxGridWinExplorerViewCustomRecordViewInfo)
    ...
    function GetRecordScrollSize(ARecordIndex: Integer): Integer; override;
    function GetRowCountByItem(AItem: TcxCustomGridRecordViewInfo)
      : Integer; virtual;
    ...
    property FixedGroupItem: TcxCustomGridRecordViewInfo read FFixedGroupItem
      write SetFixedGroupItem;
  public
    destructor Destroy; override;
    procedure DoRightToLeftConversion(const ABounds: TRect); override;

    function GetHitTest(const P: TPoint): TcxCustomGridHitTest; override;
    procedure OffsetRecords(AItemCountDelta: Integer;
      APixelScrollRecordOffsetDelta: Integer); override;
  end;
  ...
  public
    ...
    property Item: TcxGridWinExplorerViewItem read GetItem;
  published
    property TextItem: TcxStyle index isWinExplorerViewItemTextItem
      read GetValue write SetValue;
    property DescriptionItem: TcxStyle
      index isWinExplorerViewItemDescriptionItem read GetValue write SetValue;
    property OnGetTextItemStyle: TcxGridGetCellStyleEvent
      read FOnGetTextItemStyle write SetOnGetTextItemStyle;
    property OnGetDescriptionItemStyle: TcxGridGetCellStyleEvent
      read FOnGetDescriptionItemStyle write SetOnGetDescriptionItemStyle;
  end;
  ...
  published
    property Options: TcxGridWinExplorerViewItemOptions read GetOptions
      write SetOptions;
    property SortIndex;
    property SortOrder;
    property Styles: TcxGridWinExplorerViewItemStyles read GetStyles
      write SetStyles;
  end;

  { TcxGridWinExplorerViewInfoCacheItem }

  TcxGridWinExplorerViewInfoCacheItem = class
  ...
  private
    function GetGridView: TcxGridWinExplorerView;
  protected
    function GetRecordChildCount(ARecord: TcxCustomGridRecord)
      : Integer; virtual;
    ...
    function GetLastChildRecordIndex(AParentRecord: TcxCustomGridRecord)
      : Integer; virtual;
  ...
  protected
    ...
    function NeedAdjustScrollPosOnDataScroll(AScrollCode: TScrollCode)
      : Boolean; virtual;
  ...
  TcxGridWinExplorerViewControllerHelperClass = class of
    TcxGridWinExplorerViewControllerHelper;

  { TcxGridWinExplorerViewControllerContentModeHelper }

  TcxGridWinExplorerViewControllerContentModeHelper = class
    (TcxGridWinExplorerViewControllerHelper)
  protected
  ...
  TcxGridWinExplorerViewControllerImagesModeHelper = class
    (TcxGridWinExplorerViewControllerHelper)
  private
  ...
  protected
    ...
    property RecordsViewInfo: TcxGridWinExplorerViewImagesModeRecordsViewInfo
      read GetRecordsViewInfo;
  end;

  { TcxGridWinExplorerViewControllerListModeHelper }

  TcxGridWinExplorerViewControllerListModeHelper = class
    (TcxGridWinExplorerViewControllerHelper)
  private
    function GetRecordsViewInfo: TcxGridWinExplorerViewListModeRecordsViewInfo;
  protected
  ...
  TcxGridWinExplorerContentScrollAnimationHelper = class
  ...
  protected
    ...
    function GetHelperClass
      : TcxGridWinExplorerViewControllerHelperClass; virtual;
    ...
    function GetRecordCountInScrollBand(ARecordIndexInBand: Integer)
      : Integer; override;
    function GetScrollBarLineDownDirection(AScrollBarKind: TScrollBarKind)
      : TcxDirection; virtual;
    function GetScrollBarLineUpDirection(AScrollBarKind: TScrollBarKind)
      : TcxDirection; virtual;
    function GetTopRecordIndexByBottomRecord(ABottomRecordIndex: Integer)
      : Integer; override;
    function GetVisibleChildCountOnTop(AParentRecord: TcxCustomGridRecord)
      : Integer; virtual;
    procedure InternalSetScrollPos(AValue: Integer);
    function IsRecordFullyVisibleAtBottom(ARecordIndex: Integer)
      : Boolean; override;
    function IsScrollAnimationActive: Boolean; override;
    function NeedAdjustDataScrollBarPosOnDataScroll(AScrollCode: TScrollCode)
      : Boolean; virtual;
    procedure ScrollData(ADirection: TcxDirection); override;
    procedure StopScrollAnimation; override;
    procedure DisplayModeChanged; virtual;

    property ContentScrollPos: Integer read FContentScrollPos
      write SetContentScrollPos;
  ...
  public
    ...
    function FindNextItem(AFocusedItemIndex: Integer; AGoForward: Boolean;
      AGoOnCycle: Boolean; AFollowVisualOrder: Boolean;
  ...
  TcxGridWinExplorerViewDateTimeHandling = class
  ...
  TcxGridWinExplorerViewOptionsBehavior = class
  ...
  private
    ...
    FIndex: Integer;
  public
    constructor Create(AGridItem: TcxGridWinExplorerViewItem;
  ...
  protected
    ...
    procedure SetValue(AIndex: Integer;
      AValue: TcxGridWinExplorerViewItem); virtual;
    ...
    property Items[AIndex: Integer]: TcxGridWinExplorerViewItemSetItem
      read GetItem;
  public
    constructor Create(AGridView: TcxCustomGridView); override;
    destructor Destroy; override;
    ...
    property GridView: TcxGridWinExplorerView read GetGridView;
  published
    property CheckBoxItem: TcxGridWinExplorerViewItem index isiCheckBoxItem
      read GetValue write SetValue;
    property DescriptionItem: TcxGridWinExplorerViewItem
      index isiDescriptionItem read GetValue write SetValue;
    property ExtraLargeImageItem: TcxGridWinExplorerViewItem
      index isiExtraLargeImageItem read GetValue write SetValue;
    property ExtraLargeImageIndexItem: TcxGridWinExplorerViewItem
      index isiExtraLargeImageIndexItem read GetValue write SetValue;
    property GroupItem: TcxGridWinExplorerViewItem index isiGroupItem
      read GetValue write SetValue;
    property LargeImageItem: TcxGridWinExplorerViewItem index isiLargeImageItem
      read GetValue write SetValue;
    property LargeImageIndexItem: TcxGridWinExplorerViewItem
      index isiLargeImageIndexItem read GetValue write SetValue;
    property MediumImageItem: TcxGridWinExplorerViewItem
      index isiMediumImageItem read GetValue write SetValue;
    property MediumImageIndexItem: TcxGridWinExplorerViewItem
      index isiMediumImageIndexItem read GetValue write SetValue;
    property SmallImageItem: TcxGridWinExplorerViewItem index isiSmallImageItem
      read GetValue write SetValue;
    property SmallImageIndexItem: TcxGridWinExplorerViewItem
      index isiSmallImageIndexItem read GetValue write SetValue;
    property TextItem: TcxGridWinExplorerViewItem index isiTextItem
      read GetValue write SetValue;
  end;

  { TcxGridWinExplorerViewOptionsDisplayModeIndents }

  TcxGridWinExplorerViewOptionsDisplayModeIndentsClass = class of
    TcxGridWinExplorerViewOptionsDisplayModeIndents;
  ...
  protected
    ...
    property BetweenCheckBoxAndImage: Integer read FBetweenCheckBoxAndImage
      write SetIndentBetweenCheckBoxAndImage
      default cxGridWinExplorerViewRecordItemIndent;
    property BetweenGroupAndItem: Integer read FBetweenGroupAndItem
      write SetIndentBetweenGroupAndItem default 0;
    property BetweenGroups: Integer read FBetweenGroups
      write SetIndentBetweenGroups default 0;
    property BetweenImageAndDescription: Integer
      read FBetweenImageAndDescription write SetBetweenImageAndDescription
      default cxGridWinExplorerViewRecordItemIndent;
    property BetweenImageAndText: Integer read FBetweenImageAndText
      write SetIndentBetweenImageAndText
      default cxGridWinExplorerViewRecordItemIndent;
    property BetweenTextAndDescription: Integer read FBetweenTextAndDescription
      write SetIndentBetweenTextAndDescription
      default cxGridWinExplorerViewRecordItemIndent;
  public
    constructor Create(AGridView: TcxCustomGridView); override;
  ...
  published
    ...
    property BetweenImageAndText
      default cxGridWinExplorerViewContentModeIndentBetweenImageAndText;
    property BetweenTextAndDescription;
  end;

  { TcxGridWinExplorerViewOptionsExtraLargeDisplayModeIndents }

  TcxGridWinExplorerViewOptionsExtraLargeDisplayModeIndents = class
    (TcxGridWinExplorerViewOptionsDisplayModeIndents)
  published
    property BetweenCheckBoxAndImage;
  ...
  TcxGridWinExplorerViewOptionsLargeDisplayModeIndents = class
    (TcxGridWinExplorerViewOptionsDisplayModeIndents)
  published
    property BetweenCheckBoxAndImage;
    property BetweenGroupAndItem;
  ...
  TcxGridWinExplorerViewOptionsMediumDisplayModeIndents = class
    (TcxGridWinExplorerViewOptionsDisplayModeIndents)
  published
    property BetweenCheckBoxAndImage;
    property BetweenGroupAndItem;
  ...
  TcxGridWinExplorerViewOptionsSmallDisplayModeIndents = class
    (TcxGridWinExplorerViewOptionsDisplayModeIndents)
  published
    property BetweenCheckBoxAndImage;
    property BetweenGroupAndItem;
  ...
  TcxGridWinExplorerViewOptionsListDisplayModeIndents = class
    (TcxGridWinExplorerViewOptionsDisplayModeIndents)
  published
    property BetweenCheckBoxAndImage;
    property BetweenGroupAndItem;
  ...
  TcxGridWinExplorerViewOptionsTilesDisplayModeIndents = class
    (TcxGridWinExplorerViewOptionsDisplayModeIndents)
  published
    property BetweenGroupAndItem;
    property BetweenGroups;
  ...
  strict private
    ...
    procedure SetIndents(AValue
      : TcxGridWinExplorerViewOptionsDisplayModeIndents);
    procedure SetRecordWidth(AValue: Integer);
    procedure SetShowItemDescriptions(AValue: Boolean);
  protected
    procedure ChangeScale(M: Integer; D: Integer); override;
    function GetDefaultDisplayModeKind
      : TcxGridWinExplorerViewDisplayMode; virtual;
    function GetDisplayModeKind: TcxGridWinExplorerViewDisplayMode;
      virtual; abstract;
    function GetImageHeightDefaultValue: Integer; virtual;
    function GetImageWidthDefaultValue: Integer; virtual;
    function GetIndentsClass
      : TcxGridWinExplorerViewOptionsDisplayModeIndentsClass; virtual;
    function GetShowItemDescriptionsDefaultValue: Boolean; virtual;

    property RecordWidth: Integer read FRecordWidth write SetRecordWidth
      default cxGridWinExplorerViewDefaultRecordWidth;
  public
    constructor Create(AGridView: TcxCustomGridView); override;
    destructor Destroy; override;
  ...
  published
    ...
    property Indents: TcxGridWinExplorerViewOptionsDisplayModeIndents
      read FIndents write SetIndents;
    property ShowItemDescriptions: Boolean read FShowItemDescriptions
      write SetShowItemDescriptions default False;
  end;

  { TcxGridWinExplorerViewOptionsContentDisplayMode }

  TcxGridWinExplorerViewOptionsContentDisplayMode = class
    (TcxGridWinExplorerViewOptionsDisplayMode)
  private
  ...
  protected
    ...
    function GetIndentsClass
      : TcxGridWinExplorerViewOptionsDisplayModeIndentsClass; override;
  ...
  published
    property Indents: TcxGridWinExplorerViewOptionsContentDisplayModeIndents
      read GetIndents write SetIndents;
    property ShowItemDescriptions default True;
  end;

  { TcxGridWinExplorerViewOptionsExtraLargeImagesDisplayMode }

  TcxGridWinExplorerViewOptionsExtraLargeImagesDisplayMode = class
    (TcxGridWinExplorerViewOptionsDisplayMode)
  private
    function GetIndents
      : TcxGridWinExplorerViewOptionsExtraLargeDisplayModeIndents;
  ...
  protected
    ...
    function GetDisplayModeKind: TcxGridWinExplorerViewDisplayMode; override;
  published
    property Indents: TcxGridWinExplorerViewOptionsExtraLargeDisplayModeIndents
      read GetIndents write SetIndents;
  ...
  TcxGridWinExplorerViewOptionsLargeImagesDisplayMode = class
    (TcxGridWinExplorerViewOptionsDisplayMode)
  private
  ...
  protected
    ...
    function GetDisplayModeKind: TcxGridWinExplorerViewDisplayMode; override;
  published
    property Indents: TcxGridWinExplorerViewOptionsLargeDisplayModeIndents
      read GetIndents write SetIndents;
    property RecordWidth;
  end;
  ...
  TcxGridWinExplorerViewOptionsMediumDisplayMode = class
    (TcxGridWinExplorerViewOptionsDisplayMode)
  private
  ...
  protected
    ...
    function GetDisplayModeKind: TcxGridWinExplorerViewDisplayMode; override;
  published
    property Indents: TcxGridWinExplorerViewOptionsMediumDisplayModeIndents
      read GetIndents write SetIndents;
    property RecordWidth;
  end;
  ...
  TcxGridWinExplorerViewOptionsSmallImagesDisplayMode = class
    (TcxGridWinExplorerViewOptionsCustomSmallImagesDisplayMode)
  private
  ...
  protected
    ...
    function GetDisplayModeKind: TcxGridWinExplorerViewDisplayMode; override;
  published
    property Indents: TcxGridWinExplorerViewOptionsSmallDisplayModeIndents
      read GetIndents write SetIndents;
  end;

  { TcxGridWinExplorerViewOptionsListDisplayMode }

  TcxGridWinExplorerViewOptionsListDisplayMode = class
    (TcxGridWinExplorerViewOptionsCustomSmallImagesDisplayMode)
  private
  ...
  protected
    ...
    function GetDisplayModeKind: TcxGridWinExplorerViewDisplayMode; override;
  published
    property Indents: TcxGridWinExplorerViewOptionsListDisplayModeIndents
      read GetIndents write SetIndents;
  end;

  { TcxGridWinExplorerViewOptionsTilesDisplayMode }

  TcxGridWinExplorerViewOptionsTilesDisplayMode = class
    (TcxGridWinExplorerViewOptionsCustomSmallImagesDisplayMode)
  private
  ...
  protected
    ...
    function GetDisplayModeKind: TcxGridWinExplorerViewDisplayMode; override;
  published
    property Indents: TcxGridWinExplorerViewOptionsTilesDisplayModeIndents
      read GetIndents write SetIndents;
    property ShowItemDescriptions default True;
  end;
  ...
  strict private
    ...
    procedure SetContent(AValue
      : TcxGridWinExplorerViewOptionsContentDisplayMode);
    procedure SetExtraLargeImages
      (AValue: TcxGridWinExplorerViewOptionsExtraLargeImagesDisplayMode);
    procedure SetLargeImages(AValue
      : TcxGridWinExplorerViewOptionsLargeImagesDisplayMode);
    procedure SetList(AValue: TcxGridWinExplorerViewOptionsListDisplayMode);
    procedure SetMediumImages
      (AValue: TcxGridWinExplorerViewOptionsMediumDisplayMode);
    procedure SetSmallImages(AValue
      : TcxGridWinExplorerViewOptionsSmallImagesDisplayMode);
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property Content: TcxGridWinExplorerViewOptionsContentDisplayMode
      read FContent write SetContent;
    property ExtraLargeImages
      : TcxGridWinExplorerViewOptionsExtraLargeImagesDisplayMode
      read FExtraLargeImages write SetExtraLargeImages;
    property LargeImages: TcxGridWinExplorerViewOptionsLargeImagesDisplayMode
      read FLargeImages write SetLargeImages;
    property List: TcxGridWinExplorerViewOptionsListDisplayMode read FList
      write SetList;
    property MediumImages: TcxGridWinExplorerViewOptionsMediumDisplayMode
      read FMediumImages write SetMediumImages;
    property SmallImages: TcxGridWinExplorerViewOptionsSmallImagesDisplayMode
      read FSmallImages write SetSmallImages;
    property Tiles: TcxGridWinExplorerViewOptionsTilesDisplayMode read FTiles
      write SetTiles;
  end;
  ...
  TcxGridWinExplorerViewOptionsSelection = class
  ...
  public
    ...
    property GridView: TcxGridWinExplorerView read GetGridView;
  published
    property ShowItemCheckBoxes: Boolean read FShowItemCheckBoxes
      write SetShowItemCheckBoxes default False;
    property ShowExpandButtons: Boolean read FShowExpandButtons
      write SetShowExpandButtons default False;
  end;
  ...
  protected
    procedure GetDefaultViewParams(Index: Integer; AData: TObject;
      out AParams: TcxViewParams); override;
    procedure GetDefaultTextItemParams(AData: TObject;
      out AParams: TcxViewParams); virtual;
    procedure GetTextItemParams(ARecord: TcxCustomGridRecord;
  ...
  public
    ...
    procedure GetDataCellParams(ARecord: TcxCustomGridRecord;
      ...
      AIgnoreSelection: Boolean = False); override;
    ...
    procedure GetDescriptionItemCellParams(ARecord: TcxCustomGridRecord;
      AItem: TcxGridWinExplorerViewItem; out AParams: TcxViewParams); virtual;
    procedure GetGroupParams(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem; out AParams: TcxViewParams); virtual;
  published
    property TextItem: TcxStyle index vsWinExplorerTextItem read GetValue
      write SetValue;
    property DescriptionItem: TcxStyle index vsWinExplorerDescriptionItem
      read GetValue write SetValue;
    property Group: TcxStyle index vsWinExplorerGroup read GetValue
      write SetValue;
    property OnGetTextItemStyle: TcxGridGetCellStyleEvent
      read FOnGetTextItemStyle write SetOnGetTextItemStyle;
    property OnGetDescriptionItemStyle: TcxGridGetCellStyleEvent
      read FOnGetDescriptionItemStyle write SetOnGetDescriptionItemStyle;
    property OnGetGroupStyle: TcxGridGetRecordStyleEvent read FOnGetGroupStyle
  ...
  public
    ...
    property GridView: TcxGridWinExplorerView read GetGridView;
  published
    property ExtraLargeImages: TCustomImageList read FExtraLargeImages
      write SetExtraLargeImages;
    property LargeImages: TCustomImageList read FLargeImages
      write SetLargeImages;
    property MediumImages: TCustomImageList read FMediumImages
      write SetMediumImages;
  ...
  strict private
    ...
    procedure SetDateTimeHandling
      (AValue: TcxGridWinExplorerViewDateTimeHandling);
    ...
    procedure SetOptionsSelection
      (AValue: TcxGridWinExplorerViewOptionsSelection);
    ...
    procedure SetDisplayModes
      (AValue: TcxGridWinExplorerViewOptionsDisplayModes);
  protected
    ...
    // scrolling
    function CanOffset(ARecordCountDelta: Integer;
      APixelScrollRecordOffsetDelta: Integer): Boolean; override;
    function IsDataScrollBar(AKind: TScrollBarKind): Boolean; override;
    function IsRecordPixelScrolling: Boolean; override;
    procedure Offset(ARecordCountDelta: Integer; APixelScrollRecordOffsetDelta,
      DX, DY: Integer); override;
  ...
  public
    ...
    property ViewInfo: TcxGridWinExplorerViewViewInfo read GetViewInfo;
  published
    property ActiveDisplayMode: TcxGridWinExplorerViewDisplayMode
      read FActiveDisplayMode write SetActiveDisplayMode default dmContent;
    property DateTimeHandling: TcxGridWinExplorerViewDateTimeHandling
    ...
    property Filtering: TcxGridWinExplorerViewFiltering read GetFiltering
      write SetFiltering;
    property ItemSet: TcxGridWinExplorerViewItemSet read GetItemSet
      write SetItemSet;
    property OptionsBehavior: TcxGridWinExplorerViewOptionsBehavior
    ...
    property ImageSet: TcxGridWinExplorerViewImageSet read GetImageSet
      write SetImageSet;
    property OptionsSelection: TcxGridWinExplorerViewOptionsSelection
    ...
    property Styles: TcxGridWinExplorerViewStyles read GetStyles
      write SetStyles;
    property DisplayModes: TcxGridWinExplorerViewOptionsDisplayModes
      read FDisplayModes write SetDisplayModes;
  end;

implementation

uses
  Types, Math, Variants, RTLConsts, dxCore, cxCheckBox, dxCoreGraphics;
...
function TcxGridWinExplorerViewRecordExpandButtonPainter.GetViewInfo
  : TcxGridWinExplorerViewExpandButtonViewInfo;
begin
...
begin
  ViewInfo.LookAndFeelPainter.WinExplorerViewDrawScaledRecordExpandButton
    (Canvas, ViewInfo.Bounds, ViewInfo.ButtonState,
    ViewInfo.RecordViewInfo.Expanded, ScaleFactor);
end;
...
begin
  ...
  begin
    ...
    if VarIsOrdinal(AValue) then
      cxDrawImage(Canvas, ViewInfo.Bounds, nil, ViewInfo.ImageList, AValue,
...
function TcxGridWinExplorerViewImageCellPainter.GetViewInfo
  : TcxGridWinExplorerViewImageViewInfo;
begin
...
begin
  ...
  if ViewInfo.Focused and not ViewInfo.Selected and not ViewInfo.HasFocusRect
  then
    Canvas.FrameRect(ViewInfo.ContentBackgroundBounds,
      ViewInfo.LookAndFeelPainter.DefaultGridLineColor, 1, cxBordersAll, True);
end;
...
procedure TcxGridWinExplorerViewCustomRecordPainter.DrawContentBackground
  (const ABounds: TRect);
begin
  // do nothing
end;

function TcxGridWinExplorerViewCustomRecordPainter.GetViewInfo
  : TcxGridWinExplorerViewCustomRecordViewInfo;
begin
...
begin
  ViewInfo.LookAndFeelPainter.WinExplorerViewDrawGroupCaptionLine(Canvas,
    ViewInfo.CaptionLineBounds);
end;

procedure TcxGridWinExplorerViewGroupRecordPainter.DrawContentBackground
  (const ABounds: TRect);
var
...
begin
  ...
  if AState <> cxbsNormal then
    ViewInfo.LookAndFeelPainter.WinExplorerViewDrawGroup(Canvas, ABounds,
      AState, ViewInfo.Params.Color, ViewInfo.Params.Bitmap);
end;
...
function TcxGridWinExplorerViewGroupRecordPainter.GetViewInfo
  : TcxGridWinExplorerViewGroupRecordViewInfo;
begin
...
procedure TcxGridWinExplorerViewRecordPainter.DrawContentBackground
  (const ABounds: TRect);
var
  AState: TcxButtonState;
begin
  AState := ViewInfo.GetPaintState;
  if AState <> cxbsNormal then
    ViewInfo.LookAndFeelPainter.WinExplorerViewDrawRecord(Canvas, ABounds,
      AState, ViewInfo.Params.Color, ViewInfo.Params.Bitmap);
end;
...
function TcxGridWinExplorerViewRecordPainter.GetViewInfo
  : TcxGridWinExplorerViewRecordViewInfo;
begin
...
function TcxGridWinExplorerViewContentModeRecordPainter.CanDrawCheckBox
  : Boolean;
begin
  Result := inherited CanDrawCheckBox and
    ((ViewInfo.GetPaintState <> cxbsNormal) or
    (ViewInfo.CheckBoxViewInfo.Value = True));
end;

procedure TcxGridWinExplorerViewContentModeRecordPainter.DrawSeparator;
begin
  ViewInfo.LookAndFeelPainter.DrawSeparator(Canvas,
    ViewInfo.GetSeparatorBounds, False);
end;
...
function TcxGridWinExplorerViewContentModeRecordPainter.GetViewInfo
  : TcxGridWinExplorerViewContentModeRecordViewInfo;
begin
...
function TcxGridWinExplorerViewListModeRecordsPainter.GetViewInfo
  : TcxGridWinExplorerViewListModeRecordsViewInfo;
begin
...
function TcxGridWinExplorerViewPainter.CanOffset(AItemsOffset: Integer;
  DX: Integer; DY: Integer): Boolean;
begin
...
function TcxGridWinExplorerViewPainter.GetViewData
...
constructor TcxGridWinExplorerViewExpandButtonViewInfo.Create(ARecordViewInfo
  : TcxGridWinExplorerViewGroupRecordViewInfo);
begin
...
function TcxGridWinExplorerViewExpandButtonViewInfo.CaptureMouseOnPress
  : Boolean;
begin
  Result := True;
end;
...
function TcxGridWinExplorerViewExpandButtonViewInfo.GetHitTestClass
...
function TcxGridWinExplorerViewExpandButtonViewInfo.GetPainterClass
...
procedure TcxGridWinExplorerViewExpandButtonViewInfo.InitHitTest
...
function TcxGridWinExplorerViewExpandButtonViewInfo.GetRecord
  : TcxGridWinExplorerViewGroupRecord;
begin
...
constructor TcxGridWinExplorerViewCustomCellViewInfo.Create(ARecordViewInfo
...
begin
  ...
  TcxCustomEditPropertiesAccess(FInternalProperties)
    .ScaleFactor.Assign(ARecordViewInfo.ScaleFactor);
end;
...
begin
  ...
  try
    ...
    if (ASelfLink.Ref <> nil) and (AButton = mbLeft) and GridView.IsDesigning
    then
    begin
      GridView.Controller.DesignController.SelectObject(Item,
...
function TcxGridWinExplorerViewCustomCellViewInfo.GetBorderColor
  (AIndex: TcxBorder): TColor;
begin
  Result := LookAndFeelPainter.DefaultGridLineColor;
end;

function TcxGridWinExplorerViewCustomCellViewInfo.GetBorderWidth
  (AIndex: TcxBorder): Integer;
begin
  Result := LookAndFeelPainter.BorderSize;
end;

function TcxGridWinExplorerViewCustomCellViewInfo.
  GetDesignSelectionBounds: TRect;
begin
  Result := Bounds;
end;
...
function TcxGridWinExplorerViewCustomCellViewInfo.GetItemProperties
...
begin
  Result := inherited GetTransparent or
    (not Editing and (RecordViewInfo.GetPaintState <> cxbsNormal));
end;

procedure TcxGridWinExplorerViewCustomCellViewInfo.GetViewParams
...
function TcxGridWinExplorerViewCustomCellViewInfo.
  NeedLocalCopyOfEditViewData: Boolean;
begin
  Result := True;
end;

function TcxGridWinExplorerViewCustomCellViewInfo.
  NeedShowEditOnDblClick: Boolean;
begin
  Result := True;
end;

procedure TcxGridWinExplorerViewCustomCellViewInfo.StateChanged
  (APrevState: TcxGridCellState);
begin
  inherited StateChanged(APrevState);
  if not IsDestroying and ((State = gcsSelected) or (APrevState = gcsSelected))
  then
    RecordViewInfo.CellHotTrackStateChanged;
end;

function TcxGridWinExplorerViewCustomCellViewInfo.UseInternalProperties
  : Boolean;
begin
  Result := True;
end;

function TcxGridWinExplorerViewCustomCellViewInfo.GetGridView
  : TcxGridWinExplorerView;
begin
  Result := TcxGridWinExplorerView(inherited GridView);
end;

function TcxGridWinExplorerViewCustomCellViewInfo.GetItem
  : TcxGridWinExplorerViewItem;
begin
  Result := TcxGridWinExplorerViewItem(inherited Item);
end;

function TcxGridWinExplorerViewCustomCellViewInfo.GetRecordViewInfo
  : TcxGridWinExplorerViewRecordViewInfo;
begin
...
function TcxGridWinExplorerViewCheckBoxViewInfo.GetInternalPropertiesClass
...
function TcxGridWinExplorerViewTextViewInfo.GetInternalPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
begin
  CalculateParams;
  Result := TdxTextMeasurer.TextLineHeight(Params.Font) + cxTextOffset * 2;
end;

procedure TcxGridWinExplorerViewTextViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
function TcxGridWinExplorerViewTextViewInfo.GetInternalProperties
...
function TcxGridWinExplorerViewDescriptionViewInfo.GetInternalPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
procedure TcxGridWinExplorerViewDescriptionViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
function TcxGridWinExplorerViewDescriptionViewInfo.GetInternalProperties
  : TcxMemoProperties;
begin
...
constructor TcxGridWinExplorerViewImageViewInfo.Create(ARecordViewInfo
  : TcxCustomGridRecordViewInfo; AItem: TcxCustomGridTableItem;
...
function TcxGridWinExplorerViewImageViewInfo.GetInternalPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TcxImageProperties;
end;

function TcxGridWinExplorerViewImageViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
function TcxGridWinExplorerViewImageViewInfo.GetInternalProperties
  : TcxImageProperties;
begin
...
function TcxGridWinExplorerViewCustomRecordViewInfo.
  AllowChangeStateOnMouseDown: Boolean;
begin
  Result := False;
end;
...
procedure TcxGridWinExplorerViewCustomRecordViewInfo.GetBackViewParams
  (var AParams: TcxViewParams);
begin
...
function TcxGridWinExplorerViewCustomRecordViewInfo.
  GetContentBackgroundBounds: TRect;
begin
  Result := cxRectInflate(ContentBounds,
    -ScaleFactor.Apply(cxGridWinExplorerViewContentBackgroundIndent));
end;
...
function TcxGridWinExplorerViewCustomRecordViewInfo.GetPaintState
  : TcxButtonState;
begin
  if Selected then
    if GridView.DrawRecordActive(GridRecord) then
      ...
      Result := cxbsDisabled
  else if HotTrack and IsHotTracking then
    Result := cxbsHot
  else
    Result := cxbsNormal;
end;
...
procedure TcxGridWinExplorerViewCustomRecordViewInfo.StateChanged
  (APrevState: TcxGridCellState);
begin
...
function TcxGridWinExplorerViewCustomRecordViewInfo.GetController
  : TcxGridWinExplorerViewController;
begin
  Result := TcxGridWinExplorerViewController(inherited Controller);
end;

function TcxGridWinExplorerViewCustomRecordViewInfo.GetGridRecord
  : TcxGridWinExplorerViewCustomRecord;
begin
  Result := TcxGridWinExplorerViewCustomRecord(inherited GridRecord);
end;

function TcxGridWinExplorerViewCustomRecordViewInfo.GetGridView
  : TcxGridWinExplorerView;
begin
  Result := TcxGridWinExplorerView(inherited GridView);
end;

function TcxGridWinExplorerViewCustomRecordViewInfo.GetOptionsDisplayMode
  : TcxGridWinExplorerViewOptionsDisplayMode;
begin
  Result := RecordsViewInfo.OptionsDisplayMode;
end;

function TcxGridWinExplorerViewCustomRecordViewInfo.GetRecordsViewInfo
  : TcxGridWinExplorerViewRecordsViewInfo;
begin
...
constructor TcxGridWinExplorerViewGroupRecordViewInfo.Create(ARecordsViewInfo
...
function TcxGridWinExplorerViewGroupRecordViewInfo.Click
  (AHitTest: TcxCustomGridHitTest; AButton: TMouseButton;
  AShift: TShiftState): Boolean;
var
...
procedure TcxGridWinExplorerViewGroupRecordViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
...
function TcxGridWinExplorerViewGroupRecordViewInfo.GetHitTest(const P: TPoint)
...
procedure TcxGridWinExplorerViewGroupRecordViewInfo.CalculateExpandButtonBounds
  (var ABounds: TRect);
begin
  ...
  begin
    ...
    ABounds := cxRectSetLeft(ABounds,
      ABounds.Left + ScaleFactor.Apply
      (cxGridWinExplorerViewGroupExpandButtonIndent), ExpandButtonSize);
...
begin
  CalculateParams;
  Result := Max(TdxTextMeasurer.TextLineHeight(Params.Font) + 2 *
...
function TcxGridWinExplorerViewGroupRecordViewInfo.GetAlignmentVert
  : TcxAlignmentVert;
begin
  Result := vaCenter;
end;
...
begin
  Result := cxRectCenterVertically(ContentBounds,
    LookAndFeelPainter.WinExplorerViewGroupCaptionLineHeight);
  if IsRightToLeftConverted then
    Result.Right := TextAreaBounds.Left
  else
    Result.Left := TextAreaBounds.Right;
  Result := cxRectInflate(Result,
    -ScaleFactor.Apply(cxGridWinExplorerViewGroupCaptionLineIndent), 0);
end;

function TcxGridWinExplorerViewGroupRecordViewInfo.
  GetExpandButtonAreaBounds: TRect;
begin
...
begin
  Result := LookAndFeelPainter.WinExplorerViewScaledExpandButtonSize
    (ScaleFactor);
end;

function TcxGridWinExplorerViewGroupRecordViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  ...
  begin
    ...
    AIndent := R.Right + ScaleFactor.Apply
      (cxGridWinExplorerViewGroupIndentBetweenExpandButtonAndText);
    Result := cxRectSetLeft(Result,
      AIndent + ScaleFactor.Apply(cxGridCellTextOffset), TextWidth);
  end
  else
  begin
...
procedure TcxGridWinExplorerViewGroupRecordViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
procedure TcxGridWinExplorerViewGroupRecordViewInfo.Offset(DX: Integer;
  DY: Integer);
begin
...
procedure TcxGridWinExplorerViewGroupRecordViewInfo.PrepareCanvas
  (ACanvas: TcxCanvas);
begin
  inherited;
...
procedure TcxGridWinExplorerViewGroupRecordViewInfo.ClickTimerHandler
  (Sender: TObject);
begin
...
function TcxGridWinExplorerViewGroupRecordViewInfo.GetGridRecord
  : TcxGridWinExplorerViewGroupRecord;
begin
...
function TcxGridWinExplorerViewGroupRecordViewInfo.
  GetRealExpandButtonAreaBounds: TRect;
begin
...
function TcxGridWinExplorerViewListModeGroupRecordViewInfo.
...
begin
  ...
  if not GridRecord.Expanded then
    Exit;
  AChildItem := RecordsViewInfo.GetRecordViewInfo(GridRecord.Index + 1,
    ANewlyCreated);
  try
    ...
    Result := AColumnCount *
      (AChildItem.Width + RecordsViewInfo.GetItemHorizontalIndent);
  finally
...
function TcxGridWinExplorerViewListModeGroupRecordViewInfo.GetRecordsViewInfo
  : TcxGridWinExplorerViewListModeRecordsViewInfo;
begin
  Result := TcxGridWinExplorerViewListModeRecordsViewInfo
    (inherited RecordsViewInfo);
end;
...
constructor TcxGridWinExplorerViewRecordViewInfo.Create(ARecordsViewInfo
  : TcxCustomGridRecordsViewInfo; ARecord: TcxCustomGridRecord);
var
  AImageList: TCustomImageList;
...
begin
  ...
  if CanShowCheckBox then
    FCheckBoxViewInfo := TcxGridWinExplorerViewCheckBoxViewInfo.Create(Self,
      ItemSet.CheckBoxItem);
  if CanShowDescription then
    FDescriptionViewInfo := TcxGridWinExplorerViewDescriptionViewInfo.Create
      (Self, ItemSet.DescriptionItem);
  if CanShowImage then
  begin
    AItem := GetImageItem(AImageList);
    FImageViewInfo := TcxGridWinExplorerViewImageViewInfo.Create(Self, AItem,
      AImageList);
  end;
  if CanShowText then
    FTextViewInfo := TcxGridWinExplorerViewTextViewInfo.Create(Self,
      ItemSet.TextItem);
end;
...
procedure TcxGridWinExplorerViewRecordViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
  if HasCheckBox then
    FCheckBoxBounds := TdxRightToLeftLayoutConverter.ConvertRect
      (FCheckBoxBounds, ABounds);
  FImageBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (FImageBounds, ABounds);
  if HasText then
    FTextBounds := TdxRightToLeftLayoutConverter.ConvertRect
      (FTextBounds, ABounds);
  if HasDescription then
    FDescriptionBounds := TdxRightToLeftLayoutConverter.ConvertRect
      (FDescriptionBounds, ABounds);
  CalculateCellViewInfos;
end;

function TcxGridWinExplorerViewRecordViewInfo.GetCellViewInfoByItem
...
function TcxGridWinExplorerViewRecordViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  AHitTest: TcxCustomGridHitTest;
begin
...
begin
  ImageViewInfo.Calculate(FImageBounds.Left, FImageBounds.Top,
    cxRectWidth(FImageBounds), cxRectHeight(FImageBounds));
end;

procedure TcxGridWinExplorerViewRecordViewInfo.CalculateText;
begin
  TextViewInfo.Calculate(FTextBounds.Left, FTextBounds.Top,
    cxRectWidth(FTextBounds), cxRectHeight(FTextBounds));
end;
...
begin
  Result := CanShowText and OptionsDisplayMode.ShowItemDescriptions and
    ItemSet.HasDescriptionItem;
end;
...
procedure TcxGridWinExplorerViewRecordViewInfo.CorrectTextCellViewParams
  (var AParams: TcxViewParams);
begin
  // do nothing
end;

function TcxGridWinExplorerViewRecordViewInfo.FindCell
  (AItem: TcxCustomGridTableItem): TcxGridWinExplorerViewCustomCellViewInfo;
begin
  Result := nil;
  if HasCheckBox and (CheckBoxViewInfo.Item = AItem) then
...
function TcxGridWinExplorerViewRecordViewInfo.GetImageItem
  : TcxGridWinExplorerViewItem;
var
  AImageList: TCustomImageList;
begin
...
function TcxGridWinExplorerViewRecordViewInfo.GetImageItem(out AImageList
  : TCustomImageList): TcxGridWinExplorerViewItem;

  function GetAssignedItem(AImageItem, AImageIndexItem
    : TcxGridWinExplorerViewItem; ACheckImageList: TCustomImageList;
    out AImageList: TCustomImageList): TcxGridWinExplorerViewItem;
  begin
    AImageList := nil;
    Result := AImageItem;
...
begin
  ...
  begin
    ...
    case ACheckImageType of
      itSmall:
        Result := GetAssignedItem(ItemSet.SmallImageItem,
          ItemSet.SmallImageIndexItem, GridView.ImageSet.SmallImages,
          AImageList);
      itMedium:
        Result := GetAssignedItem(ItemSet.MediumImageItem,
          ItemSet.MediumImageIndexItem, GridView.ImageSet.MediumImages,
          AImageList);
      itLarge:
        Result := GetAssignedItem(ItemSet.LargeImageItem,
          ItemSet.LargeImageIndexItem, GridView.ImageSet.LargeImages,
          AImageList);
      itExtraLarge:
        Result := GetAssignedItem(ItemSet.ExtraLargeImageItem,
          ItemSet.ExtraLargeImageIndexItem, GridView.ImageSet.ExtraLargeImages,
          AImageList);
    end;
    if ACheckImageType = High(ACheckImageType) then
      ACheckIndex := AIndex - 1
    else if ACheckIndex >= AIndex then
      Inc(ACheckIndex)
    else
      Dec(ACheckIndex);
  end;
...
function TcxGridWinExplorerViewRecordViewInfo.GetImageType
  : TcxGridWinExplorerViewImageType;
begin
  Result := itMedium;
end;

function TcxGridWinExplorerViewRecordViewInfo.
  GetIndentBetweenCheckBoxAndImage: Integer;
begin
  Result := OptionsDisplayMode.Indents.BetweenCheckBoxAndImage;
end;

function TcxGridWinExplorerViewRecordViewInfo.
  GetIndentBetweenImageAndText: Integer;
begin
  Result := OptionsDisplayMode.Indents.BetweenImageAndText;
end;

function TcxGridWinExplorerViewRecordViewInfo.
  GetIndentBetweenItemAndBorders: Integer;
begin
  Result := ScaleFactor.Apply
    (cxGridWinExplorerViewIndentBetweenItemAndRecordBorder);
end;

function TcxGridWinExplorerViewRecordViewInfo.
  GetIndentBetweenTextAndDescription: Integer;
begin
  Result := OptionsDisplayMode.Indents.BetweenTextAndDescription;
end;

function TcxGridWinExplorerViewRecordViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
procedure TcxGridWinExplorerViewRecordViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
begin
  Result := (DescriptionViewInfo <> nil) and
    DescriptionViewInfo.Item.Visible and HasText;
end;
...
procedure TcxGridWinExplorerViewRecordViewInfo.InitDescriptionProperties
  (AProperties: TcxMemoProperties);
begin
  AProperties.Alignment := taLeftJustify;
  AProperties.UseLeftAlignmentOnEditing := False;
end;

procedure TcxGridWinExplorerViewRecordViewInfo.InitImageProperties
  (AProperties: TcxImageProperties);
begin
  AProperties.FitMode := ifmProportionalStretch;
end;

procedure TcxGridWinExplorerViewRecordViewInfo.InitTextProperties
  (AProperties: TcxTextEditProperties);
begin
...
procedure TcxGridWinExplorerViewRecordViewInfo.OffsetCells(DX: Integer;
  DY: Integer);
begin
  if HasCheckBox then
...
procedure TcxGridWinExplorerViewRecordViewInfo.OffsetRects(DX: Integer;
  DY: Integer);
begin
...
function TcxGridWinExplorerViewRecordViewInfo.GetItemSet
  : TcxGridWinExplorerViewItemSet;
begin
...
constructor TcxGridWinExplorerViewContentModeRecordViewInfo.Create
...
function TcxGridWinExplorerViewContentModeRecordViewInfo.
  CalculateCheckBoxBounds: TRect;
begin
  Result := cxRectCenterVertically(Bounds, GetCheckBoxSize.cy);
  Result := cxRectSetLeft(Result, Bounds.Left + GetIndentBetweenItemAndBorders,
    GetCheckBoxSize.cx);
end;

function TcxGridWinExplorerViewContentModeRecordViewInfo.
  CalculateDescriptionBounds: TRect;
begin
  Result := cxRectSetLeft(cxNullRect, TextBounds.Right +
    GetIndentBetweenTextAndDescription, GetDescriptionWidth);
  Result := cxRectSetTop(Result, Bounds.Top + GetIndentBetweenItemAndBorders,
...
begin
  ...
  Result := Max(Result,
    ScaleFactor.Apply(cxGridWinExplorerViewContentModeRecordMinHeight));
...
begin
  ...
  if HasCheckBox then
    Result := cxRectSetLeft(Result, CheckBoxBounds.Right +
      GetIndentBetweenCheckBoxAndImage, GetImageSize.Width)
  else
    Result := cxRectSetLeft(Result,
      Bounds.Left + GetIndentBetweenItemAndBorders, GetImageSize.Width);
end;

function TcxGridWinExplorerViewContentModeRecordViewInfo.
  CalculateTextBounds: TRect;
begin
  Result := cxRectSetLeft(cxNullRect, ImageBounds.Right +
    GetIndentBetweenImageAndText, GetTextWidth);
  Result := cxRectSetTop(Result, Bounds.Top + GetIndentBetweenItemAndBorders,
    GetTextHeight);
end;

function TcxGridWinExplorerViewContentModeRecordViewInfo.CalculateWidth
  : Integer;
begin
  Result := cxRectWidth(RecordsViewInfo.ContentBounds);
end;

procedure TcxGridWinExplorerViewContentModeRecordViewInfo.
  CorrectTextCellViewParams(var AParams: TcxViewParams);
begin
  if AParams.Font <> TextFont then
  begin
    TextFont.Assign(AParams.Font);
    TextFont.Size :=
      Round(TextFont.Size * cxGridWinExplorerViewContentModeTextFontFactor);
...
begin
  ...
  Result.Bottom := GetSeparatorBounds.Top - ScaleFactor.Apply
    (cxGridWinExplorerViewContentBackgroundIndent);
end;

function TcxGridWinExplorerViewContentModeRecordViewInfo.
  GetDescriptionHeight: Integer;
begin
  Result := Max(inherited GetDescriptionHeight, cxRectHeight(Bounds) - 2 *
    GetIndentBetweenItemAndBorders);
end;

function TcxGridWinExplorerViewContentModeRecordViewInfo.
  GetDescriptionWidth: Integer;
begin
  Result := Bounds.Right - GetIndentBetweenItemAndBorders - TextBounds.Right -
    GetIndentBetweenTextAndDescription;
end;

function TcxGridWinExplorerViewContentModeRecordViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  Result := Max(inherited GetTextHeight,
    ScaleFactor.Apply(cxGridWinExplorerViewContentModeTextHeight));
end;
...
function TcxGridWinExplorerViewSmallImagesModeRecordViewInfo.
  CalculateCheckBoxBounds: TRect;
begin
  Result := cxRectCenterVertically(Bounds, GetCheckBoxSize.cy);
  Result := cxRectSetLeft(Result, Bounds.Left + GetIndentBetweenItemAndBorders,
...
begin
  Result := cxRectSetLeft(cxNullRect, ImageBounds.Right +
    GetIndentBetweenImageAndDescription, GetDescriptionWidth);
...
function TcxGridWinExplorerViewSmallImagesModeRecordViewInfo.
  GetDescriptionHeight: Integer;
begin
  Result := Max(inherited GetDescriptionHeight,
    Height - GetIndentBetweenItemAndBorders - GetTextHeight -
    GetIndentBetweenTextAndDescription);
end;

function TcxGridWinExplorerViewSmallImagesModeRecordViewInfo.
  GetDescriptionMinHeight: Integer;
begin
  Result := Max(DescriptionViewInfo.GetRequiredHeight,
    ScaleFactor.Apply
    (cxGridWinExplorerViewSmallImagesModeDescriptionMinHeight));
end;
...
begin
  Result := GetTextWidth;
  if OptionsDisplayMode.RecordWidth <> -1 then
    Result := Result + GetIndentBetweenImageAndText -
      GetIndentBetweenImageAndDescription;
end;

function TcxGridWinExplorerViewSmallImagesModeRecordViewInfo.GetImageType
  : TcxGridWinExplorerViewImageType;
begin
  Result := itSmall;
end;
...
function TcxGridWinExplorerViewSmallImagesModeRecordViewInfo.
  GetIndentBetweenImageAndDescription: Integer;
begin
...
begin
  Result := Max(inherited GetTextHeight,
    ScaleFactor.Apply(cxGridWinExplorerViewSmallImagesModeTextHeight));
end;
...
begin
  ...
  begin
    Result := Width - GetImageSize.Width - GetIndentBetweenImageAndText - 2 *
      GetIndentBetweenItemAndBorders;
    if HasCheckBox then
...
function TcxGridWinExplorerViewSmallImagesModeRecordViewInfo.
  GetOptionsDisplayMode
  : TcxGridWinExplorerViewOptionsCustomSmallImagesDisplayMode;
begin
  Result := TcxGridWinExplorerViewOptionsCustomSmallImagesDisplayMode
    (inherited OptionsDisplayMode);
end;

{ TcxGridWinExplorerViewTilesModeRecordViewInfo }

function TcxGridWinExplorerViewTilesModeRecordViewInfo.
  CalculateCheckBoxBounds: TRect;
var
  AImageRect: TRect;
begin
...
function TcxGridWinExplorerViewTilesModeRecordViewInfo.GetImageType
  : TcxGridWinExplorerViewImageType;
begin
  Result := itMedium;
end;

function TcxGridWinExplorerViewTilesModeRecordViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
function TcxGridWinExplorerViewMediumImagesModeRecordViewInfo.
  CalculateCheckBoxBounds: TRect;
var
  ATop: Integer;
begin
  Result := cxRectSetLeft(cxNullRect,
    Bounds.Left + GetIndentBetweenItemAndBorders, GetCheckBoxSize.cx);
  ATop := Bounds.Top + Round(GetImageSize.Height / 2) -
    Round(GetCheckBoxSize.cy / 2) + GetIndentBetweenItemAndBorders;
...
begin
  Result := cxRectSetLeft(cxNullRect,
    Bounds.Left + GetIndentBetweenItemAndBorders, GetDescriptionWidth);
  Result := cxRectSetTop(Result, TextBounds.Bottom +
    GetIndentBetweenTextAndDescription, GetDescriptionHeight);
end;
...
function TcxGridWinExplorerViewMediumImagesModeRecordViewInfo.
  CalculateImageBounds: TRect;
begin
  Result := cxRectSetTop(Bounds, Bounds.Top + GetIndentBetweenItemAndBorders,
    GetImageSize.Height);
  if HasCheckBox then
...
begin
  Result := cxRectSetLeft(cxNullRect,
    Bounds.Left + GetIndentBetweenItemAndBorders, GetTextWidth);
  Result := cxRectSetTop(Result, ImageBounds.Bottom +
    GetIndentBetweenImageAndText, GetTextHeight);
end;
...
begin
  Result := Max(inherited GetDescriptionHeight,
    ScaleFactor.Apply(cxGridWinExplorerViewMediumImagesModeDescriptionHeight));
end;
...
begin
  Result := Max(inherited GetTextHeight,
    ScaleFactor.Apply(cxGridWinExplorerViewMediumImagesModeTextHeight));
end;
...
procedure TcxGridWinExplorerViewMediumImagesModeRecordViewInfo.
  InitDescriptionProperties(AProperties: TcxMemoProperties);
begin
...
procedure TcxGridWinExplorerViewMediumImagesModeRecordViewInfo.
  InitTextProperties(AProperties: TcxTextEditProperties);
begin
...
function TcxGridWinExplorerViewLargeImagesModeRecordViewInfo.GetImageType
  : TcxGridWinExplorerViewImageType;
begin
  Result := itLarge;
end;
...
function TcxGridWinExplorerViewExtraLargeImagesModeRecordViewInfo.GetImageType
  : TcxGridWinExplorerViewImageType;
begin
  Result := itExtraLarge;
end;
...
procedure TcxGridWinExplorerViewRecordsViewInfo.Offset(DX: Integer;
  DY: Integer);
var
  I: Integer;
begin
...
procedure TcxGridWinExplorerViewRecordsViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
...
function TcxGridWinExplorerViewRecordsViewInfo.GetDataRecordViewInfoClass
  : TcxCustomGridRecordViewInfoClass;
begin
  Result := TcxGridWinExplorerViewRecordViewInfo;
end;

function TcxGridWinExplorerViewRecordsViewInfo.GetGroupRecordViewInfoClass
  : TcxCustomGridRecordViewInfoClass;
begin
...
function TcxGridWinExplorerViewRecordsViewInfo.GetItemsOffset(AItemCountDelta
  : Integer): Integer;
var
  I: Integer;
...
begin
  ...
  if (AItemCountDelta > 0) xor (IsRightToLeftConverted and IsHorizontalScrolling)
  then
    Result := -Result;
end;

function TcxGridWinExplorerViewRecordsViewInfo.
  GetIndentBetweenGroupAndItem: Integer;
begin
...
function TcxGridWinExplorerViewRecordsViewInfo.GetFirstRecordIndexInBand
  (ARecordIndexInBand: Integer): Integer;
begin
  Result := ARecordIndexInBand;
end;

function TcxGridWinExplorerViewRecordsViewInfo.GetItemCountInBand
  (ARecordIndexInBand: Integer): Integer;
begin
  Result := 1;
end;

function TcxGridWinExplorerViewRecordsViewInfo.GetLastRecordIndexInBand
  (ARecordIndexInBand: Integer): Integer;
begin
  Result := Controller.GetLastIndexInScrollBand(ARecordIndexInBand);
end;

function TcxGridWinExplorerViewRecordsViewInfo.GetPainterClass
...
function TcxGridWinExplorerViewRecordsViewInfo.IsRecordFullyVisibleAtBottom
...
function TcxGridWinExplorerViewRecordsViewInfo.NeedConsideredRecordOffset
  (AItem: TcxGridWinExplorerViewCustomRecordViewInfo): Boolean;
begin
  Result := True;
end;

procedure TcxGridWinExplorerViewRecordsViewInfo.OffsetItem(AIndex: Integer;
  AOffset: Integer);
begin
...
function TcxGridWinExplorerViewRecordsViewInfo.GetController
  : TcxGridWinExplorerViewController;
begin
  Result := TcxGridWinExplorerViewController(inherited Controller);
end;

function TcxGridWinExplorerViewRecordsViewInfo.GetGridView
  : TcxGridWinExplorerView;
begin
  Result := TcxGridWinExplorerView(inherited GridView);
end;

function TcxGridWinExplorerViewRecordsViewInfo.GetItem(Index: Integer)
  : TcxGridWinExplorerViewCustomRecordViewInfo;
begin
  Result := TcxGridWinExplorerViewCustomRecordViewInfo(inherited Items[Index]);
end;

function TcxGridWinExplorerViewRecordsViewInfo.GetOptionsDisplayMode
  : TcxGridWinExplorerViewOptionsDisplayMode;
begin
  Result := GetOptionsDisplayModeInstance;
end;

function TcxGridWinExplorerViewRecordsViewInfo.GetViewData
  : TcxGridWinExplorerViewViewData;
begin
  Result := TcxGridWinExplorerViewViewData(inherited ViewData);
end;

function TcxGridWinExplorerViewRecordsViewInfo.GetDisplayModes
  : TcxGridWinExplorerViewOptionsDisplayModes;
begin
...
function TcxGridWinExplorerViewContentModeRecordsViewInfo.
  CalculateContentBounds: TRect;
begin
  Result := cxRectInflate(inherited CalculateContentBounds, 0,
    -GetVerticalIndent, 0, 0);
end;

procedure TcxGridWinExplorerViewContentModeRecordsViewInfo.
  CalculatePartVisibleCount;
var
  I, ATopPos: Integer;
  AItem: TcxGridWinExplorerViewCustomRecordViewInfo;
...
function TcxGridWinExplorerViewContentModeRecordsViewInfo.GetItemLeftBound
  (AIndex: Integer): Integer;
begin
  Result := ContentBounds.Left + GetHorizontalIndent;
end;

function TcxGridWinExplorerViewContentModeRecordsViewInfo.GetItemTopBound
  (AIndex: Integer): Integer;
begin
  if AIndex = 0 then
...
function TcxGridWinExplorerViewContentModeRecordsViewInfo.
  GetDataRecordViewInfoClass: TcxCustomGridRecordViewInfoClass;
begin
  Result := TcxGridWinExplorerViewContentModeRecordViewInfo;
end;

function TcxGridWinExplorerViewContentModeRecordsViewInfo.
  GetOptionsDisplayModeInstance: TcxGridWinExplorerViewOptionsDisplayMode;
begin
  Result := DisplayModes.Content;
end;

function TcxGridWinExplorerViewContentModeRecordsViewInfo.
  GetContentScrollSize: Integer;
begin
...
function TcxGridWinExplorerViewCustomImagesModeRecordsViewInfo.
  GetHorizontalIndent: Integer;
begin
  Result := 10;
end;
...
begin
  ...
  Result := cxRectSetLeft(Result, Result.Left - Controller.ContentScrollPos,
    GetDataWidth);
end;

function TcxGridWinExplorerViewImagesModeRecordsViewInfo.
  CalculateContentBounds: TRect;
begin
  Result := cxRectInflate(inherited CalculateContentBounds, 0,
    -GetVerticalIndent, 0, 0);
...
procedure TcxGridWinExplorerViewImagesModeRecordsViewInfo.
  CalculatePartVisibleCount;

  function GetDataItemIndent
    (AItem: TcxGridWinExplorerViewCustomRecordViewInfo): Integer;
  begin
  ...
  function GetIndent(AItem: TcxGridWinExplorerViewCustomRecordViewInfo)
    : Integer;
  begin
...
begin
  ...
  begin
    if ATopPos >= GridViewInfo.ClientBounds.Bottom then
      Break;
    AItem := Items[I];
    ANeedIncTop := not AItem.IsData or
      (GetItemColumnIndex(AItem) = GetColumnCountByItem(AItem) - 1) or
...
function TcxGridWinExplorerViewImagesModeRecordsViewInfo.GetColumnCountByItem
...
function TcxGridWinExplorerViewImagesModeRecordsViewInfo.
  GetColumnCountByItemWidth(AValue: Integer): Integer;
const
  AMinColumnCount = 1;
var
...
begin
  ...
  AAllowedColumnCount := (AAvailableWidth + GetItemHorizontalIndent)
    div (AValue + GetItemHorizontalIndent);
  Result := Max(AAllowedColumnCount, AMinColumnCount);
end;

function TcxGridWinExplorerViewImagesModeRecordsViewInfo.
  GetColumnCountByRecordIndex(AValue: Integer): Integer;
var
  ANewlyCreated: Boolean;
  AItem: TcxCustomGridRecordViewInfo;
begin
...
function TcxGridWinExplorerViewImagesModeRecordsViewInfo.GetItemColumnIndex
  (AItem: TcxGridWinExplorerViewCustomRecordViewInfo): Integer;
var
...
begin
  ...
  try
    Result := GetItemColumnIndex
      (AItem as TcxGridWinExplorerViewCustomRecordViewInfo);
  finally
    if ANewlyCreated then
      AItem.Free;
  end;
...
function TcxGridWinExplorerViewImagesModeRecordsViewInfo.
  GetItemHorizontalIndent: Integer;
begin
  Result := ScaleFactor.Apply(cxGridWinExplorerViewImagesModeHorizontalIndent);
end;

function TcxGridWinExplorerViewImagesModeRecordsViewInfo.GetItemLeftBound
  (AIndex: Integer): Integer;
var
  AItem: TcxGridWinExplorerViewCustomRecordViewInfo;
begin
...
function TcxGridWinExplorerViewImagesModeRecordsViewInfo.GetItemTopBound
  (AIndex: Integer): Integer;

  function GetDataItemTopBound(AItem, APrevItem
    : TcxGridWinExplorerViewCustomRecordViewInfo): Integer;
  begin
  ...
  function GetGroupItemTopBound(APrevItem
    : TcxGridWinExplorerViewCustomRecordViewInfo): Integer;
  begin
    if APrevItem.IsData then
      Result := APrevItem.Bounds.Bottom + GetIndentBetweenGroupAndItem
...
function TcxGridWinExplorerViewImagesModeRecordsViewInfo.
  GetItemVerticalIndent: Integer;
begin
  Result := ScaleFactor.Apply(cxGridWinExplorerViewImagesModeVerticalIndent);
end;

function TcxGridWinExplorerViewImagesModeRecordsViewInfo.GetRecordScrollSize
  (ARecordIndex: Integer): Integer;
...
function TcxGridWinExplorerViewImagesModeRecordsViewInfo.
  GetFirstRecordIndexInBand(ARecordIndexInBand: Integer): Integer;
var
  ARecord: TcxCustomGridRecord;
begin
...
function TcxGridWinExplorerViewImagesModeRecordsViewInfo.GetItemCountInBand
  (ARecordIndexInBand: Integer): Integer;
var
  ARecord: TcxCustomGridRecord;
...
function TcxGridWinExplorerViewImagesModeRecordsViewInfo.
  NeedConsideredRecordOffset
  (AItem: TcxGridWinExplorerViewCustomRecordViewInfo): Boolean;
begin
  Result := not AItem.IsData or
    (GetItemColumnIndex(AItem) = GetColumnCountByItem(AItem) - 1) or
...
function TcxGridWinExplorerViewExtraLargeImagesModeRecordsViewInfo.
  GetDataRecordViewInfoClass: TcxCustomGridRecordViewInfoClass;
begin
...
function TcxGridWinExplorerViewLargeImagesModeRecordsViewInfo.
  GetDataRecordViewInfoClass: TcxCustomGridRecordViewInfoClass;
begin
...
function TcxGridWinExplorerViewMediumImagesModeRecordsViewInfo.
  GetDataRecordViewInfoClass: TcxCustomGridRecordViewInfoClass;
begin
...
function TcxGridWinExplorerViewSmallImagesModeRecordsViewInfo.
  GetDataRecordViewInfoClass: TcxCustomGridRecordViewInfoClass;
begin
...
begin
  Result := ScaleFactor.Apply
    (cxGridWinExplorerViewSmallImagesModeHorizontalIndent);
end;
...
begin
  Result := ScaleFactor.Apply
    (cxGridWinExplorerViewSmallImagesModeVerticalIndent);
end;
...
function TcxGridWinExplorerViewTilesModeRecordsViewInfo.
  GetDataRecordViewInfoClass: TcxCustomGridRecordViewInfoClass;
begin
...
function TcxGridWinExplorerViewListModeRecordsViewInfo.GetHitTest
...
procedure TcxGridWinExplorerViewListModeRecordsViewInfo.OffsetRecords
  (AItemCountDelta: Integer; APixelScrollRecordOffsetDelta: Integer);
begin
...
begin
  Result := inherited CalculateBounds;
  Result := cxRectSetTop(Result, Result.Top - Controller.ContentScrollPos,
    GetDataHeight);
end;

function TcxGridWinExplorerViewListModeRecordsViewInfo.
  CalculateContentBounds: TRect;
begin
  Result := cxRectInflate(inherited CalculateContentBounds,
    -GetHorizontalIndent, 0, 0, 0);
end;

procedure TcxGridWinExplorerViewListModeRecordsViewInfo.CalculateItems;
begin
  if HasFixedGroupItem then
    FFixedGroupItem.MainCalculate(GetFixedGroupTopLeft.X,
      GetFixedGroupTopLeft.Y);
  inherited CalculateItems;
end;

procedure TcxGridWinExplorerViewListModeRecordsViewInfo.
  CalculatePartVisibleCount;
var
  I, ALeftPos: Integer;
...
begin
  ...
  begin
    ...
    ANeedIncLeft := AItem.IsData and
      ((GetItemRowIndex(AItem) = GetRowCountByItem(AItem) - 1) or
      (ViewData.IsGrouped and ViewData.IsLastChildRecord(AItem.GridRecord)));
    if ANeedIncLeft then
    begin
      ALeftPos := ALeftPos + AItem.Width + GetItemHorizontalIndent;
      if ViewData.IsGrouped and ViewData.IsLastChildRecord(AItem.GridRecord)
      then
...
procedure TcxGridWinExplorerViewListModeRecordsViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
  if HasFixedGroupItem then
...
function TcxGridWinExplorerViewListModeRecordsViewInfo.GetFirstRecordIndexInBand
  (ARecordIndexInBand: Integer): Integer;
var
  ARecord: TcxCustomGridRecord;
begin
...
function TcxGridWinExplorerViewListModeRecordsViewInfo.
  GetFixedGroupTopLeft: TPoint;
begin
  Result := Point(GetHorizontalIndent, GetVerticalIndent);
end;

function TcxGridWinExplorerViewListModeRecordsViewInfo.
  GetGroupRecordViewInfoClass: TcxCustomGridRecordViewInfoClass;
begin
...
function TcxGridWinExplorerViewListModeRecordsViewInfo.GetItemLeftBound
  (AIndex: Integer): Integer;

  function GetDataItemLeftBound(AItem, APrevItem
    : TcxGridWinExplorerViewCustomRecordViewInfo): Integer;
  var
    R: TRect;
  begin
  ...
  function GetGroupItemLeftBound(APrevItem
    : TcxGridWinExplorerViewCustomRecordViewInfo): Integer;
  begin
    Result := APrevItem.Bounds.Right + GetItemHorizontalIndent +
      GetIndentBetweenGroups;
  end;
...
function TcxGridWinExplorerViewListModeRecordsViewInfo.GetItemPixelScrollSize
  (AItem: TcxCustomGridRecordViewInfo): Integer;
begin
  Result := AItem.Width;
end;
...
function TcxGridWinExplorerViewListModeRecordsViewInfo.GetItemTopBound
  (AIndex: Integer): Integer;
var
  AItem: TcxGridWinExplorerViewCustomRecordViewInfo;
...
begin
  ...
  Result := Result + GetItemRowIndex(AItem) *
    (AItem.Height + GetItemVerticalIndent);
end;
...
function TcxGridWinExplorerViewListModeRecordsViewInfo.GetPainterClass
  : TcxCustomGridRecordsPainterClass;
begin
...
function TcxGridWinExplorerViewListModeRecordsViewInfo.
  GetPixelScrollContentSize: Integer;
begin
  Result := cxRectWidth(ContentBounds);
end;

function TcxGridWinExplorerViewListModeRecordsViewInfo.GetRecordScrollSize
  (ARecordIndex: Integer): Integer;
var
  ARecord: TcxCustomGridRecord;
  ALastRecordIndexInBand: Integer;
...
function TcxGridWinExplorerViewListModeRecordsViewInfo.GetRowCountByItem
  (AItem: TcxCustomGridRecordViewInfo): Integer;
begin
  Result := GetRowCountByItemHeight(AItem.Height);
end;

function TcxGridWinExplorerViewListModeRecordsViewInfo.GetRowCountByItemHeight
...
begin
  ...
  Result := (AAvailableHeight + GetItemVerticalIndent)
    div (AValue + GetItemVerticalIndent);
  Result := Max(Result, AMinRowCount);
end;

function TcxGridWinExplorerViewListModeRecordsViewInfo.GetRowCountByRecordIndex
  (AValue: Integer): Integer;
var
  ANewlyCreated: Boolean;
  AItem: TcxCustomGridRecordViewInfo;
...
function TcxGridWinExplorerViewListModeRecordsViewInfo.GetItemCountInBand
  (ARecordIndexInBand: Integer): Integer;
var
  ARecord: TcxCustomGridRecord;
  ADataRecordIndex, AFirstRecordIndexInBand, ALastRecordIndex,
    ALastIndexInBand: Integer;
begin
  AFirstRecordIndexInBand := GetFirstRecordIndexInBand(ARecordIndexInBand);
...
function TcxGridWinExplorerViewListModeRecordsViewInfo.
  IsRecordFullyVisibleAtBottom(ARecordIndex: Integer): Boolean;
var
  AItem: TcxCustomGridRecordViewInfo;
  ARecord: TcxCustomGridRecord;
begin
...
function TcxGridWinExplorerViewListModeRecordsViewInfo.
  ...
  (AItem: TcxGridWinExplorerViewCustomRecordViewInfo): Boolean;
begin
  Result := AItem.IsData and
    ((GetItemRowIndex(AItem) = GetRowCountByItem(AItem) - 1) or
    ViewData.IsLastChildRecord(AItem.GridRecord) or AItem.GridRecord.IsLast);
end;

procedure TcxGridWinExplorerViewListModeRecordsViewInfo.OffsetItem
  (AIndex: Integer; AOffset: Integer);
begin
...
begin
  ...
  begin
    ...
    begin
      AItem := Items[I];
      if not AItem.IsData or not IsRightToLeftConverted and
        (AItem.Bounds.Right <= ContentBounds.Right) or
        IsRightToLeftConverted and (AItem.Bounds.Left >= ContentBounds.Left)
      then
        Inc(FVisibleCount);
    end;
  end
...
procedure TcxGridWinExplorerViewListModeRecordsViewInfo.SetFixedGroupItem
  (AValue: TcxCustomGridRecordViewInfo);
begin
...
procedure TcxGridWinExplorerViewViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
...
function TcxGridWinExplorerViewViewInfo.GetRecordsViewInfoClass
...
function TcxGridWinExplorerViewViewInfo.GetRecordsViewInfo
  : TcxGridWinExplorerViewRecordsViewInfo;
begin
  Result := TcxGridWinExplorerViewRecordsViewInfo(inherited RecordsViewInfo);
end;
...
procedure TcxGridWinExplorerViewItemStyles.GetTextItemParams
...
procedure TcxGridWinExplorerViewItemStyles.GetDescriptionItemParams
  (ARecord: TcxCustomGridRecord; out AParams: TcxViewParams);
var
  AStyle: TcxStyle;
begin
...
procedure TcxGridWinExplorerViewItemStyles.GetDefaultViewParams(Index: Integer;
  AData: TObject; out AParams: TcxViewParams);
begin
  case Index of
    isWinExplorerViewItemTextItem:
      GridView.Styles.GetTextItemParams(TcxCustomGridRecord(AData),
        Item, AParams);
    isWinExplorerViewItemDescriptionItem:
      GridView.Styles.GetDescriptionItemParams(TcxCustomGridRecord(AData),
        Item, AParams);
  else
    inherited;
  end;
...
function TcxGridWinExplorerViewItemStyles.GetGridViewValue
  : TcxGridWinExplorerView;
begin
  Result := TcxGridWinExplorerView(inherited GridView);
end;
...
procedure TcxGridWinExplorerViewItemStyles.SetOnGetTextItemStyle
...
procedure TcxGridWinExplorerViewItemStyles.SetOnGetDescriptionItemStyle
  (Value: TcxGridGetCellStyleEvent);
begin
...
function TcxGridWinExplorerViewItem.GetOptions
  : TcxGridWinExplorerViewItemOptions;
begin
...
procedure TcxGridWinExplorerViewItem.SetOptions
  (AValue: TcxGridWinExplorerViewItemOptions);
begin
  inherited Options := AValue;
end;

procedure TcxGridWinExplorerViewItem.SetStyles
  (Value: TcxGridWinExplorerViewItemStyles);
begin
  inherited Styles := Value;
end;

function TcxGridWinExplorerViewItem.GetOptionsClass
  : TcxCustomGridTableItemOptionsClass;
begin
  Result := TcxGridWinExplorerViewItemOptions;
end;

function TcxGridWinExplorerViewItem.GetStylesClass
...
begin
  Result := (RepositoryItem = nil) and (Properties = nil) and
    not HasCustomPropertiesHandler;
end;

{ TcxGridWinExplorerViewCustomRecord }

function TcxGridWinExplorerViewCustomRecord.GetViewInfoCacheItemClass
...
function TcxGridWinExplorerViewCustomRecord.GetViewInfo
  : TcxGridWinExplorerViewCustomRecordViewInfo;
begin
  Result := TcxGridWinExplorerViewCustomRecordViewInfo(inherited ViewInfo);
end;
...
begin
  Result := not((dcoGroupsAlwaysExpanded in DataController.Options) or
    GridView.GroupsAlwaysExpanded);
end;
...
function TcxGridWinExplorerViewGroupRecord.GetDisplayText
  (Index: Integer): string;
begin
  if ViewData.HasCustomDataHandling(GroupItem, doGrouping) then
    Result := ViewData.GetCustomDataDisplayText(RecordIndex, GroupItem.Index,
      doGrouping)
  else
...
function TcxGridWinExplorerViewGroupRecord.GetViewInfoClass
  : TcxCustomGridRecordViewInfoClass;
begin
  Result := GridView.ViewInfo.RecordsViewInfo.GetGroupRecordViewInfoClass;
end;

function TcxGridWinExplorerViewGroupRecord.GetGroupItem
  : TcxGridWinExplorerViewItem;
begin
...
function TcxGridWinExplorerViewDataRecord.GetViewInfoClass
  : TcxCustomGridRecordViewInfoClass;
begin
...
function TcxGridWinExplorerViewViewData.GetRecordChildCount
  (ARecord: TcxCustomGridRecord): Integer;
var
  AGroupIndex: Integer;
begin
  AGroupIndex := GridView.DataController.Groups.DataGroupIndexByRowIndex
    [ARecord.Index];
  Result := GridView.DataController.Groups.ChildCount[AGroupIndex];
end;

function TcxGridWinExplorerViewViewData.GetDataRecordClass
  : TcxCustomGridRecordClass;
begin
  Result := TcxGridWinExplorerViewDataRecord;
end;

function TcxGridWinExplorerViewViewData.GetGroupRecordClass
  : TcxCustomGridRecordClass;
begin
  Result := TcxGridWinExplorerViewGroupRecord;
end;

function TcxGridWinExplorerViewViewData.GetLastChildRecordIndex
  (AParentRecord: TcxCustomGridRecord): Integer;
begin
  Result := AParentRecord.Index + GetRecordChildCount(AParentRecord);
end;

function TcxGridWinExplorerViewViewData.GetRecordClass(const ARecordInfo
  : TcxRowInfo): TcxCustomGridRecordClass;
begin
...
function TcxGridWinExplorerViewViewData.IsGroup(const ARecordInfo
  : TcxRowInfo): Boolean;
begin
...
function TcxGridWinExplorerViewViewData.IsLastChildRecord
  (ARecord: TcxCustomGridRecord): Boolean;
var
  AParentRecord: TcxCustomGridRecord;
begin
  AParentRecord := ARecord.ParentRecord;
  Result := (AParentRecord <> nil) and
    (ARecord.Index = GetLastChildRecordIndex(AParentRecord));
end;
...
constructor TcxGridWinExplorerViewControllerHelper.Create
  (AController: TcxGridWinExplorerViewController);
begin
  inherited Create;
...
procedure TcxGridWinExplorerViewControllerHelper.AdjustContentScrollPos
  (var Value: Integer);
begin
...
function TcxGridWinExplorerViewControllerHelper.
  GetContentScrollPageSize: Integer;
begin
  Result := ViewInfo.ClientWidth;
end;

function TcxGridWinExplorerViewControllerHelper.
  GetContentScrollPosition: Integer;
begin
...
function TcxGridWinExplorerViewControllerHelper.
  GetIsRecordsScrollHorizontal: Boolean;
begin
  Result := IsDataScrollBar(sbHorizontal);
end;

function TcxGridWinExplorerViewControllerHelper.GetMouseWheelMajorScrollBarKind
  : TScrollBarKind;
begin
  Result := sbVertical;
end;

function TcxGridWinExplorerViewControllerHelper.GetScrollableAreaSize
...
begin
  Controller.SetScrollBarInfo(sbHorizontal, 0, HScrollBarMaxValue,
    HScrollBarStep, HScrollBarPageSize, HScrollBarPosition, True,
    Controller.CanHScrollBarHide);
end;
...
begin
  Controller.SetScrollBarInfo(sbVertical, 0, VScrollBarMaxValue, VScrollBarStep,
    VScrollBarPageSize, VScrollBarPosition, True, True);
end;

function TcxGridWinExplorerViewControllerHelper.IsDataScrollBar
...
procedure TcxGridWinExplorerViewControllerHelper.KeyDown(var Key: Word;
  Shift: TShiftState);
begin
  case Key of
    VK_LEFT:
...
function TcxGridWinExplorerViewControllerHelper.NeedAdjustScrollPosOnDataScroll
  (AScrollCode: TScrollCode): Boolean;
begin
  Result := True;
end;

function TcxGridWinExplorerViewControllerHelper.ScrollBarMaxValue
  (AKind: TScrollBarKind): Integer;
begin
...
function TcxGridWinExplorerViewControllerHelper.ScrollBarPageSize
  (AKind: TScrollBarKind): Integer;
begin
  if IsDataScrollBar(AKind) then
...
function TcxGridWinExplorerViewControllerHelper.ScrollBarPosition
  (AKind: TScrollBarKind): Integer;
begin
  if IsDataScrollBar(AKind) then
    Result := GetDataScrollPosition
  else if GetScrollableAreaSize(AKind) > 0 then
    Result := GetContentScrollPosition
  else
    Result := -1;
end;

function TcxGridWinExplorerViewControllerHelper.ScrollBarStep
  (AKind: TScrollBarKind): Integer;
begin
  if IsDataScrollBar(AKind) then
...
procedure TcxGridWinExplorerViewControllerHelper.ScrollData
...
function TcxGridWinExplorerViewControllerHelper.GetRecordsViewInfo
  : TcxGridWinExplorerViewRecordsViewInfo;
begin
...
function TcxGridWinExplorerViewControllerHelper.GetViewData
  : TcxGridWinExplorerViewViewData;
begin
  Result := Controller.ViewData;
end;

function TcxGridWinExplorerViewControllerHelper.GetViewInfo
  : TcxGridWinExplorerViewViewInfo;
begin
  Result := Controller.ViewInfo;
end;

procedure TcxGridWinExplorerViewControllerContentModeHelper.ScrollData
  (ADirection: TcxDirection);
begin
  case ADirection of
    dirUp:
...
begin
  ...
  begin
    ANextIndex := AFocusedRecord.Index +
      RecordsViewInfo.GetColumnCountByRecordIndex(AFocusedRecord.Index);
    if ViewData.IsGrouped then
      ALastRecordIndex := ViewData.GetLastChildRecordIndex
        (AFocusedRecord.ParentRecord)
    else
      ALastRecordIndex := ViewData.RecordCount - 1;
    if ANextIndex > ALastRecordIndex then
      if RecordsViewInfo.GetItemColumnIndex(AFocusedRecord.Index) >
        RecordsViewInfo.GetItemColumnIndex(ALastRecordIndex) then
        ANextIndex := ALastRecordIndex
      else if ViewData.IsGrouped and ViewData.IsRecordIndexValid
        (ALastRecordIndex + 1) then
...
begin
  ...
  begin
    AColumnCount := RecordsViewInfo.GetColumnCountByRecordIndex
      (AFocusedRecord.Index);
    if ViewData.IsGrouped and
      (AFocusedRecord.Index - AFocusedRecord.ParentRecord.Index < AColumnCount)
    then
...
procedure TcxGridWinExplorerViewControllerImagesModeHelper.ScrollData
  (ADirection: TcxDirection);
var
  APos: Integer;
begin
  ...
  case ADirection of
    ...
    dirUp:
      Controller.ScrollRecords(False, 1);
    dirDown:
      Controller.ScrollRecords(True, Controller.GetRecordCountInScrollBand
        (Controller.TopRecordIndex));
  end;
end;

function TcxGridWinExplorerViewControllerImagesModeHelper.GetRecordsViewInfo
  : TcxGridWinExplorerViewImagesModeRecordsViewInfo;
begin
  Result := TcxGridWinExplorerViewImagesModeRecordsViewInfo
    (inherited RecordsViewInfo);
end;
...
begin
  ...
  if ViewData.IsGrouped and (ARecord <> nil) and
    ViewData.IsLastChildRecord(ARecord) and ViewData.IsRecordIndexValid
    (ARecord.Index + 1) then
    Controller.FocusNextRecordWithSelection(ARecord.Index + 1, True, False,
      False, False)
  else
    Controller.GoToNext(False, False);
end;
...
procedure TcxGridWinExplorerViewControllerListModeHelper.
  FocusRecordInNextColumn;
var
  AFocusedRecord, ANextGroup: TcxCustomGridRecord;
  AFocusedRecordRowIndex, ANextIndex, ANextGroupIndex, ALastRecordIndex
    : Integer;
begin
  AFocusedRecord := Controller.FocusedRecord;
  if (AFocusedRecord = nil) then
  ...
  begin
    ANextIndex := AFocusedRecord.Index +
      RecordsViewInfo.GetRowCountByRecordIndex(AFocusedRecord.Index);
    if ViewData.IsGrouped then
      ALastRecordIndex := ViewData.GetLastChildRecordIndex
        (AFocusedRecord.ParentRecord)
    else
    ...
    if ANextIndex > ALastRecordIndex then
    begin
      AFocusedRecordRowIndex := RecordsViewInfo.GetItemRowIndex
        (AFocusedRecord.Index);
      if AFocusedRecordRowIndex > RecordsViewInfo.GetItemRowIndex
        (ALastRecordIndex) then
        ANextIndex := ALastRecordIndex
      else
      begin
        ANextIndex := -1;
        if ViewData.IsGrouped then
        begin
          ANextGroupIndex := ViewData.GetLastChildRecordIndex
            (AFocusedRecord.ParentRecord) + 1;
          if ViewData.IsRecordIndexValid(ANextGroupIndex) then
          begin
            ANextGroup := ViewData.Records[ANextGroupIndex];
            if AFocusedRecordRowIndex > ViewData.GetRecordChildCount
              (ANextGroup) - 1 then
...
begin
  ...
  begin
    APrevIndex := AFocusedRecord.Index -
      RecordsViewInfo.GetRowCountByRecordIndex(AFocusedRecord.Index);
    if ViewData.IsGrouped then
    ...
    begin
      ...
      begin
        ...
        begin
          APrevGroupLastChildRecordRowIndex := RecordsViewInfo.GetItemRowIndex
            (APrevGroupLastChildRecordIndex);
          if AFocusedRecordRowIndex > APrevGroupLastChildRecordRowIndex then
            APrevIndex := APrevGroupLastChildRecordIndex
          else
            APrevIndex := APrevGroupLastChildRecordIndex +
              AFocusedRecordRowIndex - APrevGroupLastChildRecordRowIndex;
        end
      end;
    end;
  end;
...
function TcxGridWinExplorerViewControllerListModeHelper.
  GetContentScrollPageSize: Integer;
begin
...
function TcxGridWinExplorerViewControllerListModeHelper.
  GetContentScrollStep: Integer;
begin
  Result := VScrollDelta;
end;

function TcxGridWinExplorerViewControllerListModeHelper.
  GetDataScrollPageSize: Integer;
var
  ARecord: TcxCustomGridRecord;
  AIndex: Integer;
begin
  Result := inherited GetDataScrollPageSize;
  if NeedDataScroll and ViewData.IsRecordIndexValid(Controller.TopRecordIndex)
  then
  begin
...
begin
  ...
  begin
    ALastRecordIndex := ViewData.RecordCount - 1;
    AItemCountInLastBand := RecordsViewInfo.GetItemCountInBand
      (ALastRecordIndex);
...
function TcxGridWinExplorerViewControllerListModeHelper.
  GetMouseWheelMajorScrollBarKind: TScrollBarKind;
begin
  Result := sbHorizontal;
end;

function TcxGridWinExplorerViewControllerListModeHelper.IsDataScrollBar
  (AKind: TScrollBarKind): Boolean;
begin
...
function TcxGridWinExplorerViewControllerListModeHelper.
  NeedAdjustScrollPosOnDataScroll(AScrollCode: TScrollCode): Boolean;
begin
...
procedure TcxGridWinExplorerViewControllerListModeHelper.ScrollData
  (ADirection: TcxDirection);
var
  APos: Integer;
begin
...
function TcxGridWinExplorerViewControllerListModeHelper.GetRecordsViewInfo
  : TcxGridWinExplorerViewListModeRecordsViewInfo;
begin
  Result := TcxGridWinExplorerViewListModeRecordsViewInfo
    (inherited RecordsViewInfo);
...
procedure TcxGridWinExplorerContentScrollAnimationHelper.AfterAnimationEnded
...
procedure TcxGridWinExplorerContentScrollAnimationHelper.CheckPosition
  (var AValue: Integer);
begin
  FOwner.Helper.AdjustContentScrollPos(AValue);
end;

function TcxGridWinExplorerContentScrollAnimationHelper.
  GetOwnerPosition: Integer;
begin
  Result := FOwner.ContentScrollPos;
end;

procedure TcxGridWinExplorerContentScrollAnimationHelper.UpdateOwnerPosition
  (AValue: Integer);
begin
...
constructor TcxGridWinExplorerViewController.Create
  (AGridView: TcxCustomGridView);
begin
  inherited Create(AGridView);
  CreateHelper;
  FContentScrollAnimationHelper :=
    TcxGridWinExplorerContentScrollAnimationHelper.Create(Self);
end;
...
procedure TcxGridWinExplorerViewController.KeyDown(var Key: Word;
Shift: TShiftState);
begin
...
function TcxGridWinExplorerViewController.FindNextItem(AFocusedItemIndex
  : Integer; AGoForward: Boolean; AGoOnCycle: Boolean;
AFollowVisualOrder: Boolean; out ACycleChanged: Boolean;
ARecord: TcxCustomGridRecord): Integer;
...
procedure TcxGridWinExplorerViewController.MakeItemVisible
  (AItem: TcxCustomGridTableItem);
begin
  MakeFocusedRecordVisible;
end;

procedure TcxGridWinExplorerViewController.MouseUp(Button: TMouseButton;
...
begin
  ...
  if (GetActiveCellViewInfo(AHitTest) = nil) and (Shift * [ssCtrl, ssShift] = [])
  then
...
procedure TcxGridWinExplorerViewController.DataScroll(AScrollBarKind
...
procedure TcxGridWinExplorerViewController.DoSetContentScrollPos
  (AValue: Integer);
begin
...
procedure TcxGridWinExplorerViewController.DoScroll(AScrollBarKind
  : TScrollBarKind; AScrollCode: TScrollCode; var AScrollPos: Integer);
begin
...
function TcxGridWinExplorerViewController.GetDesignHitTest
...
begin
  Result := ViewInfo.RecordsViewInfo.GetItemCountInBand(0) *
    inherited GetDragScrollInterval;
end;

function TcxGridWinExplorerViewController.GetFirstIndexInScrollBand
  (ARecordIndexInBand: Integer): Integer;
begin
  Result := ViewInfo.RecordsViewInfo.GetFirstRecordIndexInBand
    (ARecordIndexInBand);
end;

function TcxGridWinExplorerViewController.GetHelperClass
  : TcxGridWinExplorerViewControllerHelperClass;
begin
  case GridView.ActiveDisplayMode of
    dmContent:
...
function TcxGridWinExplorerViewController.GetMouseWheelMajorScrollBarKind
  : TScrollBarKind;
begin
  Result := Helper.GetMouseWheelMajorScrollBarKind;
end;

function TcxGridWinExplorerViewController.GetRecordCountInScrollBand
  (ARecordIndexInBand: Integer): Integer;
begin
  Result := ViewInfo.RecordsViewInfo.GetItemCountInBand(ARecordIndexInBand);
end;

function TcxGridWinExplorerViewController.GetScrollBarLineDownDirection
  (AScrollBarKind: TScrollBarKind): TcxDirection;
begin
...
function TcxGridWinExplorerViewController.GetScrollBarLineUpDirection
  (AScrollBarKind: TScrollBarKind): TcxDirection;
begin
  if AScrollBarKind = sbHorizontal then
    Result := dirLeft
...
function TcxGridWinExplorerViewController.GetTopRecordIndexByBottomRecord
...
begin
  if (GridView.ActiveDisplayMode = dmList) and (ViewData.RecordCount > 0) then
  begin
    ATopIndex := ABottomRecordIndex - GetPageVisibleRecordCount
      (TopRecordIndex, 0);
...
function TcxGridWinExplorerViewController.GetVisibleChildCountOnTop
  (AParentRecord: TcxCustomGridRecord): Integer;

  function IsParentLocatedOnTop(AParentRecord: TcxCustomGridRecord): Boolean;
  begin
    Result := ViewData.IsRecordIndexValid(TopRecordIndex) and
      (AParentRecord = ViewData.Records[TopRecordIndex].ParentRecord);
  end;

begin
  if IsParentLocatedOnTop(AParentRecord) then
    Result := ViewData.GetLastChildRecordIndex(AParentRecord) -
      GetFirstIndexInScrollBand(TopRecordIndex) + 1
  else
    Result := ViewData.GetRecordChildCount(AParentRecord);
end;

procedure TcxGridWinExplorerViewController.InternalSetScrollPos
  (AValue: Integer);
var
  ADelta: Integer;
begin
...
function TcxGridWinExplorerViewController.IsRecordFullyVisibleAtBottom
  (ARecordIndex: Integer): Boolean;
begin
...
begin
  Result := inherited IsScrollAnimationActive or
    FContentScrollAnimationHelper.IsAnimationActive;
end;

function TcxGridWinExplorerViewController.NeedAdjustDataScrollBarPosOnDataScroll
  (AScrollCode: TScrollCode): Boolean;
begin
...
function TcxGridWinExplorerViewController.CanProcessMultiSelect
...
procedure TcxGridWinExplorerViewController.ContentScroll(AScrollBarKind
  : TScrollBarKind; AScrollCode: TScrollCode; var AScrollPos: Integer);
var
  APos: Integer;
begin
  ...
  case AScrollCode of
    ...
    scLineDown:
      ScrollData(GetScrollBarLineDownDirection(AScrollBarKind));
    scPageUp:
      DoSetContentScrollPos(APos - Helper.GetScrollableAreaSize
        (AScrollBarKind));
    scPageDown:
      DoSetContentScrollPos(APos + Helper.GetScrollableAreaSize
        (AScrollBarKind));
...
function TcxGridWinExplorerViewController.GetItemSet
  : TcxGridWinExplorerViewItemSet;
begin
  Result := GridView.ItemSet;
end;

function TcxGridWinExplorerViewController.GetViewData
  : TcxGridWinExplorerViewViewData;
begin
  Result := TcxGridWinExplorerViewViewData(inherited ViewData);
end;

function TcxGridWinExplorerViewController.GetViewInfo
  : TcxGridWinExplorerViewViewInfo;
begin
...
constructor TcxGridWinExplorerViewOptionsBehavior.Create
  (AGridView: TcxCustomGridView);
begin
  inherited Create(AGridView);
  FHotTrack := True;
...
procedure TcxGridWinExplorerViewItemSet.Assign(Source: TPersistent);
  ...
  function GetOwnSimilarItem(ASourceItem: TcxGridWinExplorerViewItem)
    : TcxGridWinExplorerViewItem;
  begin
    if ASourceItem = nil then
      Result := nil
    else
      Result := GridView.FindItemByID(ASourceItem.ID)
        as TcxGridWinExplorerViewItem;
  end;
...
begin
  ...
  begin
    ...
    ExtraLargeImageIndexItem :=
      GetOwnSimilarItem(ASource.ExtraLargeImageIndexItem);
...
function TcxGridWinExplorerViewItemSet.GetValue(AIndex: Integer)
  : TcxGridWinExplorerViewItem;
var
  AItemIndex: Integer;
begin
...
procedure TcxGridWinExplorerViewItemSet.SetValue(AIndex: Integer;
AValue: TcxGridWinExplorerViewItem);
...
function TcxGridWinExplorerViewItemSet.FindItemIndex(AGridItemIndex
  : Integer): Integer;
var
  I: Integer;
begin
...
procedure TcxGridWinExplorerViewItemSet.GridItemRemove
...
function TcxGridWinExplorerViewItemSet.GetItem(AIndex: Integer)
  : TcxGridWinExplorerViewItemSetItem;
begin
...
constructor TcxGridWinExplorerViewOptionsDisplayModeIndents.Create
  (AGridView: TcxCustomGridView);
begin
  inherited Create(AGridView);
...
procedure TcxGridWinExplorerViewOptionsDisplayModeIndents.Assign
  (Source: TPersistent);
var
...
procedure TcxGridWinExplorerViewOptionsDisplayModeIndents.ChangeScale(M,
  D: Integer);
begin
  inherited;
...
function TcxGridWinExplorerViewOptionsDisplayModeIndents.
  GetIndentBetweenImageAndTextDefaultValue: Integer;
begin
  Result := cxGridWinExplorerViewRecordItemIndent;
end;

procedure TcxGridWinExplorerViewOptionsDisplayModeIndents.
  SetIndentBetweenCheckBoxAndImage(AValue: Integer);
begin
  if AValue < 0 then
    AValue := 0;
...
procedure TcxGridWinExplorerViewOptionsDisplayModeIndents.
  SetIndentBetweenGroupAndItem(AValue: Integer);
begin
  if AValue < 0 then
    AValue := 0;
...
procedure TcxGridWinExplorerViewOptionsDisplayModeIndents.SetIndentBetweenGroups
  (AValue: Integer);
begin
  if AValue < 0 then
    AValue := 0;
...
procedure TcxGridWinExplorerViewOptionsDisplayModeIndents.
  SetBetweenImageAndDescription(AValue: Integer);
begin
  if AValue < 0 then
    AValue := 0;
...
procedure TcxGridWinExplorerViewOptionsDisplayModeIndents.
  SetIndentBetweenImageAndText(AValue: Integer);
begin
  if AValue < 0 then
    AValue := 0;
...
procedure TcxGridWinExplorerViewOptionsDisplayModeIndents.
  SetIndentBetweenTextAndDescription(AValue: Integer);
begin
  if AValue < 0 then
    AValue := 0;
...
function TcxGridWinExplorerViewOptionsContentDisplayModeIndents.
  GetIndentBetweenImageAndTextDefaultValue: Integer;
begin
...
constructor TcxGridWinExplorerViewOptionsDisplayMode.Create
  (AGridView: TcxCustomGridView);
begin
  inherited Create(AGridView);
  FImageSize := TcxSize.Create(nil, GetImageWidthDefaultValue,
    GetImageHeightDefaultValue);
...
function TcxGridWinExplorerViewOptionsDisplayMode.GetDefaultDisplayModeKind
  : TcxGridWinExplorerViewDisplayMode;
begin
  Result := dmContent;
end;

function TcxGridWinExplorerViewOptionsDisplayMode.
  GetImageHeightDefaultValue: Integer;
begin
  Result := 0;
end;

function TcxGridWinExplorerViewOptionsDisplayMode.
  GetImageWidthDefaultValue: Integer;
begin
  Result := 0;
end;

function TcxGridWinExplorerViewOptionsDisplayMode.GetIndentsClass
  : TcxGridWinExplorerViewOptionsDisplayModeIndentsClass;
begin
  Result := TcxGridWinExplorerViewOptionsDisplayModeIndents;
end;

function TcxGridWinExplorerViewOptionsDisplayMode.
  GetShowItemDescriptionsDefaultValue: Boolean;
begin
  Result := False;
end;
...
function TcxGridWinExplorerViewOptionsDisplayMode.GetGridView
  : TcxGridWinExplorerView;
begin
  Result := TcxGridWinExplorerView(inherited GridView);
end;

procedure TcxGridWinExplorerViewOptionsDisplayMode.ImageSizeChangeHandler
  (Sender: TObject);
begin
  Changed(vcSize);
end;
...
procedure TcxGridWinExplorerViewOptionsDisplayMode.SetImageSize
  (AValue: TcxSize);
begin
  FImageSize.Assign(AValue);
end;

procedure TcxGridWinExplorerViewOptionsDisplayMode.SetIndents
  (AValue: TcxGridWinExplorerViewOptionsDisplayModeIndents);
begin
  FIndents.Assign(AValue);
end;

procedure TcxGridWinExplorerViewOptionsDisplayMode.SetRecordWidth
  (AValue: Integer);
begin
  if AValue < -1 then
    AValue := -1;
...
procedure TcxGridWinExplorerViewOptionsDisplayMode.SetShowItemDescriptions
  (AValue: Boolean);
begin
...
function TcxGridWinExplorerViewOptionsContentDisplayMode.
  GetImageHeightDefaultValue: Integer;
begin
...
function TcxGridWinExplorerViewOptionsContentDisplayMode.GetIndentsClass
  : TcxGridWinExplorerViewOptionsDisplayModeIndentsClass;
begin
...
function TcxGridWinExplorerViewOptionsContentDisplayMode.GetDisplayModeKind
  : TcxGridWinExplorerViewDisplayMode;
begin
  Result := dmContent;
end;

function TcxGridWinExplorerViewOptionsContentDisplayMode.GetIndents
  : TcxGridWinExplorerViewOptionsContentDisplayModeIndents;
begin
  Result := TcxGridWinExplorerViewOptionsContentDisplayModeIndents
    (inherited Indents);
...
procedure TcxGridWinExplorerViewOptionsContentDisplayMode.SetIndents
  (AValue: TcxGridWinExplorerViewOptionsContentDisplayModeIndents);
begin
...
function TcxGridWinExplorerViewOptionsExtraLargeImagesDisplayMode.
  GetImageHeightDefaultValue: Integer;
begin
...
function TcxGridWinExplorerViewOptionsExtraLargeImagesDisplayMode.
  GetIndentsClass: TcxGridWinExplorerViewOptionsDisplayModeIndentsClass;
begin
  Result := TcxGridWinExplorerViewOptionsExtraLargeDisplayModeIndents;
end;

function TcxGridWinExplorerViewOptionsExtraLargeImagesDisplayMode.
  GetDisplayModeKind: TcxGridWinExplorerViewDisplayMode;
begin
  Result := dmExtraLargeImages;
end;

function TcxGridWinExplorerViewOptionsExtraLargeImagesDisplayMode.GetIndents
  : TcxGridWinExplorerViewOptionsExtraLargeDisplayModeIndents;
begin
  Result := TcxGridWinExplorerViewOptionsExtraLargeDisplayModeIndents
    (inherited Indents);
...
procedure TcxGridWinExplorerViewOptionsExtraLargeImagesDisplayMode.SetIndents
  (AValue: TcxGridWinExplorerViewOptionsExtraLargeDisplayModeIndents);
begin
  inherited Indents := AValue;
end;
...
function TcxGridWinExplorerViewOptionsLargeImagesDisplayMode.
  GetImageHeightDefaultValue: Integer;
begin
...
function TcxGridWinExplorerViewOptionsLargeImagesDisplayMode.GetIndentsClass
  : TcxGridWinExplorerViewOptionsDisplayModeIndentsClass;
begin
  Result := TcxGridWinExplorerViewOptionsLargeDisplayModeIndents;
end;

function TcxGridWinExplorerViewOptionsLargeImagesDisplayMode.GetDisplayModeKind
  : TcxGridWinExplorerViewDisplayMode;
begin
  Result := dmLargeImages;
end;

function TcxGridWinExplorerViewOptionsLargeImagesDisplayMode.GetIndents
  : TcxGridWinExplorerViewOptionsLargeDisplayModeIndents;
begin
  Result := TcxGridWinExplorerViewOptionsLargeDisplayModeIndents
    (inherited Indents);
...
procedure TcxGridWinExplorerViewOptionsLargeImagesDisplayMode.SetIndents
  (AValue: TcxGridWinExplorerViewOptionsLargeDisplayModeIndents);
begin
  inherited Indents := AValue;
end;
...
function TcxGridWinExplorerViewOptionsMediumDisplayMode.
  GetImageHeightDefaultValue: Integer;
begin
  Result := cxGridWinExplorerViewImageMediumSize;
end;
...
function TcxGridWinExplorerViewOptionsMediumDisplayMode.GetIndentsClass
  : TcxGridWinExplorerViewOptionsDisplayModeIndentsClass;
begin
  Result := TcxGridWinExplorerViewOptionsMediumDisplayModeIndents;
end;

function TcxGridWinExplorerViewOptionsMediumDisplayMode.GetDisplayModeKind
  : TcxGridWinExplorerViewDisplayMode;
begin
  Result := dmMediumImages;
end;

function TcxGridWinExplorerViewOptionsMediumDisplayMode.GetIndents
  : TcxGridWinExplorerViewOptionsMediumDisplayModeIndents;
begin
  Result := TcxGridWinExplorerViewOptionsMediumDisplayModeIndents
    (inherited Indents);
...
procedure TcxGridWinExplorerViewOptionsMediumDisplayMode.SetIndents
  (AValue: TcxGridWinExplorerViewOptionsMediumDisplayModeIndents);
begin
  inherited Indents := AValue;
end;
...
function TcxGridWinExplorerViewOptionsCustomSmallImagesDisplayMode.
  GetImageHeightDefaultValue: Integer;
begin
...
function TcxGridWinExplorerViewOptionsSmallImagesDisplayMode.GetIndentsClass
  : TcxGridWinExplorerViewOptionsDisplayModeIndentsClass;
begin
  Result := TcxGridWinExplorerViewOptionsSmallDisplayModeIndents;
end;

function TcxGridWinExplorerViewOptionsSmallImagesDisplayMode.GetDisplayModeKind
  : TcxGridWinExplorerViewDisplayMode;
begin
  Result := dmSmallImages;
end;

function TcxGridWinExplorerViewOptionsSmallImagesDisplayMode.GetIndents
  : TcxGridWinExplorerViewOptionsSmallDisplayModeIndents;
begin
  Result := TcxGridWinExplorerViewOptionsSmallDisplayModeIndents
    (inherited Indents);
...
procedure TcxGridWinExplorerViewOptionsSmallImagesDisplayMode.SetIndents
  (AValue: TcxGridWinExplorerViewOptionsSmallDisplayModeIndents);
begin
  inherited Indents := AValue;
end;
...
function TcxGridWinExplorerViewOptionsListDisplayMode.GetIndentsClass
  : TcxGridWinExplorerViewOptionsDisplayModeIndentsClass;
begin
  Result := TcxGridWinExplorerViewOptionsListDisplayModeIndents;
end;

function TcxGridWinExplorerViewOptionsListDisplayMode.GetDisplayModeKind
  : TcxGridWinExplorerViewDisplayMode;
begin
  Result := dmList;
end;

function TcxGridWinExplorerViewOptionsListDisplayMode.GetIndents
  : TcxGridWinExplorerViewOptionsListDisplayModeIndents;
begin
  Result := TcxGridWinExplorerViewOptionsListDisplayModeIndents
    (inherited Indents);
...
procedure TcxGridWinExplorerViewOptionsListDisplayMode.SetIndents
  (AValue: TcxGridWinExplorerViewOptionsListDisplayModeIndents);
begin
  inherited Indents := AValue;
end;
...
function TcxGridWinExplorerViewOptionsTilesDisplayMode.
  GetImageHeightDefaultValue: Integer;
begin
  Result := cxGridWinExplorerViewImageMediumSize;
end;
...
function TcxGridWinExplorerViewOptionsTilesDisplayMode.GetIndentsClass
  : TcxGridWinExplorerViewOptionsDisplayModeIndentsClass;
begin
...
function TcxGridWinExplorerViewOptionsTilesDisplayMode.GetDisplayModeKind
  : TcxGridWinExplorerViewDisplayMode;
begin
  Result := dmTiles;
end;

function TcxGridWinExplorerViewOptionsTilesDisplayMode.GetIndents
  : TcxGridWinExplorerViewOptionsTilesDisplayModeIndents;
begin
  Result := TcxGridWinExplorerViewOptionsTilesDisplayModeIndents
    (inherited Indents);
...
procedure TcxGridWinExplorerViewOptionsTilesDisplayMode.SetIndents
  (AValue: TcxGridWinExplorerViewOptionsTilesDisplayModeIndents);
begin
  inherited Indents := AValue;
end;
...
constructor TcxGridWinExplorerViewOptionsDisplayModes.Create
  (AGridView: TcxCustomGridView);
begin
  inherited Create(AGridView);
  ...
  FExtraLargeImages := TcxGridWinExplorerViewOptionsExtraLargeImagesDisplayMode.
    Create(GridView);
  FLargeImages := TcxGridWinExplorerViewOptionsLargeImagesDisplayMode.Create
    (GridView);
  FList := TcxGridWinExplorerViewOptionsListDisplayMode.Create(GridView);
  FMediumImages := TcxGridWinExplorerViewOptionsMediumDisplayMode.Create
    (GridView);
  FSmallImages := TcxGridWinExplorerViewOptionsSmallImagesDisplayMode.Create
    (GridView);
...
procedure TcxGridWinExplorerViewOptionsDisplayModes.SetContent
  (AValue: TcxGridWinExplorerViewOptionsContentDisplayMode);
begin
  FContent.Assign(AValue);
end;

procedure TcxGridWinExplorerViewOptionsDisplayModes.SetExtraLargeImages
  (AValue: TcxGridWinExplorerViewOptionsExtraLargeImagesDisplayMode);
begin
  FExtraLargeImages.Assign(AValue);
end;

procedure TcxGridWinExplorerViewOptionsDisplayModes.SetLargeImages
  (AValue: TcxGridWinExplorerViewOptionsLargeImagesDisplayMode);
begin
  FLargeImages.Assign(AValue);
end;

procedure TcxGridWinExplorerViewOptionsDisplayModes.SetList
  (AValue: TcxGridWinExplorerViewOptionsListDisplayMode);
begin
  FList.Assign(AValue);
end;

procedure TcxGridWinExplorerViewOptionsDisplayModes.SetMediumImages
  (AValue: TcxGridWinExplorerViewOptionsMediumDisplayMode);
begin
  FMediumImages.Assign(AValue);
end;

procedure TcxGridWinExplorerViewOptionsDisplayModes.SetSmallImages
  (AValue: TcxGridWinExplorerViewOptionsSmallImagesDisplayMode);
begin
  FSmallImages.Assign(AValue);
end;

procedure TcxGridWinExplorerViewOptionsDisplayModes.SetTiles
  (AValue: TcxGridWinExplorerViewOptionsTilesDisplayMode);
begin
...
procedure TcxGridWinExplorerViewOptionsView.SetShowItemCheckBoxes
  (AValue: Boolean);
begin
...
procedure TcxGridWinExplorerViewOptionsView.SetShowExpandButtons
  (AValue: Boolean);
begin
...
procedure TcxGridWinExplorerViewStyles.GetDefaultViewParams(Index: Integer;
AData: TObject; out AParams: TcxViewParams);
begin
  inherited GetDefaultViewParams(Index, AData, AParams);
  case Index of
    vsContent, vsWinExplorerGroup, vsWinExplorerRecordHotTrack, vsSelection,
      vsInactive:
      begin
        AParams.Color := LookAndFeelPainter.WinExplorerViewDefaultRecordColor
          (GetState(Index));
        if IsGroupParams(Index) then
          AParams.TextColor := LookAndFeelPainter.WinExplorerViewGroupTextColor
            (GetState(Index))
        else
          AParams.TextColor := LookAndFeelPainter.WinExplorerViewRecordTextColor
            (GetState(Index));
      end;
...
procedure TcxGridWinExplorerViewStyles.GetDefaultTextItemParams(AData: TObject;
...
begin
  ...
  begin
    ...
    ACell := TcxGridWinExplorerViewRecordViewInfo(ARecord.ViewInfo)
      .FindCell(AItem);
  end
  else
  begin
...
procedure TcxGridWinExplorerViewStyles.GetTextItemParams
  (ARecord: TcxCustomGridRecord; AItem: TcxGridWinExplorerViewItem;
out AParams: TcxViewParams);
var
  AStyle: TcxStyle;
...
procedure TcxGridWinExplorerViewStyles.GetDescriptionItemParams
  (ARecord: TcxCustomGridRecord; AItem: TcxGridWinExplorerViewItem;
out AParams: TcxViewParams);
var
  AStyle: TcxStyle;
...
procedure TcxGridWinExplorerViewStyles.GetDataCellParams
...
begin
  if not AIgnoreSelection and (AWinRecord <> nil) and
    (AWinRecord.ViewInfo.GetPaintState = cxbsHot) then
    GetViewParams(vsWinExplorerRecordHotTrack, ARecord, nil, AParams)
  else
    inherited GetDataCellParams(ARecord, AItem, AParams, AUseViewInfo,
      ACellViewInfo, AIgnoreSelection);
end;

procedure TcxGridWinExplorerViewStyles.GetTextItemCellParams
  (ARecord: TcxCustomGridRecord; AItem: TcxGridWinExplorerViewItem;
out AParams: TcxViewParams);
begin
  if AItem = nil then
...
procedure TcxGridWinExplorerViewStyles.GetDescriptionItemCellParams
  (ARecord: TcxCustomGridRecord; AItem: TcxGridWinExplorerViewItem;
out AParams: TcxViewParams);
begin
  if AItem = nil then
...
procedure TcxGridWinExplorerViewStyles.GetGroupParams
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
out AParams: TcxViewParams);
var
  AStyle: TcxStyle;
begin
  ...
  FIsGroupParams := True;
  try
    if TcxGridWinExplorerViewGroupRecord(ARecord).ViewInfo.GetPaintState <> cxbsNormal
    then
...
procedure TcxGridWinExplorerViewStyles.SetOnGetTextItemStyle
  (Value: TcxGridGetCellStyleEvent);
begin
  if not dxSameMethods(FOnGetTextItemStyle, Value) then
  begin
...
procedure TcxGridWinExplorerViewStyles.SetOnGetDescriptionItemStyle
  (Value: TcxGridGetCellStyleEvent);
begin
  if not dxSameMethods(FOnGetDescriptionItemStyle, Value) then
  begin
...
procedure TcxGridWinExplorerViewStyles.SetOnGetGroupStyle
...
procedure TcxGridWinExplorerViewImageSet.SetExtraLargeImages
  (Value: TCustomImageList);
begin
  cxSetImageList(Value, FExtraLargeImages, FExtraLargeImagesChangeLink,
    GridView);
end;

procedure TcxGridWinExplorerViewImageSet.SetLargeImages
  (Value: TCustomImageList);
begin
  cxSetImageList(Value, FLargeImages, FLargeImagesChangeLink, GridView);
end;

procedure TcxGridWinExplorerViewImageSet.SetMediumImages
  (Value: TCustomImageList);
begin
  cxSetImageList(Value, FMediumImages, FMediumImagesChangeLink, GridView);
end;

procedure TcxGridWinExplorerViewImageSet.SetSmallImages
  (Value: TCustomImageList);
begin
...
function TcxGridWinExplorerView.GetControllerClass
  : TcxCustomGridControllerClass;
begin
  Result := TcxGridWinExplorerViewController;
end;

function TcxGridWinExplorerView.GetDataControllerClass
  : TcxCustomDataControllerClass;
begin
  Result := TcxGridDataController;
end;

function TcxGridWinExplorerView.GetDateTimeHandlingClass
  : TcxCustomGridTableDateTimeHandlingClass;
begin
  Result := TcxGridWinExplorerViewDateTimeHandling;
end;

function TcxGridWinExplorerView.GetFilteringClass
...
function TcxGridWinExplorerView.CanOffset(ARecordCountDelta: Integer;
APixelScrollRecordOffsetDelta: Integer): Boolean;
begin
  Result := inherited CanOffset(ARecordCountDelta,
    APixelScrollRecordOffsetDelta) and
...
procedure TcxGridWinExplorerView.Notification(AComponent: TComponent;
...
procedure TcxGridWinExplorerView.SelectionChanged
  ...
  begin
    ...
    try
      ...
      begin
        ...
        ARecord := ViewData.Records[ARecordIndex];
        if not ARecord.IsData and ARecord.Focused and ARecord.Selected and
          ARecord.Expanded then
...
function TcxGridWinExplorerView.GetDateTimeHandling
  : TcxGridWinExplorerViewDateTimeHandling;
begin
...
function TcxGridWinExplorerView.GetOptionsBehavior
  : TcxGridWinExplorerViewOptionsBehavior;
begin
  Result := TcxGridWinExplorerViewOptionsBehavior(inherited OptionsBehavior);
end;

function TcxGridWinExplorerView.GetOptionsData
  : TcxGridWinExplorerViewOptionsData;
begin
...
function TcxGridWinExplorerView.GetOptionsSelection
  : TcxGridWinExplorerViewOptionsSelection;
begin
...
procedure TcxGridWinExplorerView.SetActiveDisplayMode
  (AValue: TcxGridWinExplorerViewDisplayMode);
begin
...
function TcxGridWinExplorerView.GetOptionsView
  : TcxGridWinExplorerViewOptionsView;
begin
...
procedure TcxGridWinExplorerView.SetDataController
  (AValue: TcxGridDataController);
begin
  FDataController.Assign(AValue);
end;

procedure TcxGridWinExplorerView.SetDateTimeHandling
  (AValue: TcxGridWinExplorerViewDateTimeHandling);
begin
  inherited DateTimeHandling := AValue;
end;

procedure TcxGridWinExplorerView.SetFiltering
  (AValue: TcxGridWinExplorerViewFiltering);
begin
  inherited Filtering := AValue;
end;

procedure TcxGridWinExplorerView.SetItemSet
  (AValue: TcxGridWinExplorerViewItemSet);
begin
  FItemSet.Assign(AValue);
end;

procedure TcxGridWinExplorerView.SetOptionsBehavior
  (AValue: TcxGridWinExplorerViewOptionsBehavior);
begin
  inherited OptionsBehavior := AValue;
end;

procedure TcxGridWinExplorerView.SetOptionsData
  (AValue: TcxGridWinExplorerViewOptionsData);
begin
  inherited OptionsData := AValue;
end;

procedure TcxGridWinExplorerView.SetImageSet
  (AValue: TcxGridWinExplorerViewImageSet);
begin
  FImageSet.Assign(AValue);
end;

procedure TcxGridWinExplorerView.SetOptionsSelection
  (AValue: TcxGridWinExplorerViewOptionsSelection);
begin
  inherited OptionsSelection := AValue;
end;

procedure TcxGridWinExplorerView.SetOptionsView
  (AValue: TcxGridWinExplorerViewOptionsView);
begin
...
procedure TcxGridWinExplorerView.SetDisplayModes
  (AValue: TcxGridWinExplorerViewOptionsDisplayModes);
begin
