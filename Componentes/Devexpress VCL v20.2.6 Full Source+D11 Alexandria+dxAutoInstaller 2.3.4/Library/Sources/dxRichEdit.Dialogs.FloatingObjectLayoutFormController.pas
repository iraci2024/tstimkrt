...
type
  ...
  TdxFloatingInlineObjectLayoutOptionsFormControllerParameters = class
  ...
  protected
    property InitialTabPage: TdxPageSetupFormInitialTabPage read FInitialTabPage
      write FInitialTabPage;
    property PlacementInfo: TdxFloatingObjectTargetPlacementInfo
      read FPlacementInfo;
  ...
  public
    ...
    procedure InitialFillPlacementInfo(APieceTable: TdxCustomPieceTable;
      AParagraph: TdxParagraphBase);
    property FloatingInlineObjectParameters: TdxFloatingInlineObjectParameters
      read FFloatingInlineObjectParameters;
  ...
  public
    constructor Create(ADefaultUnitType: TdxMeasurementUnit;
    ...
    property ValueUnitConverter: TdxDocumentModelUnitConverter
      read FValueUnitConverter;
  end;
  ...
  public
    ...
    constructor Create(ATextWrapType: TdxFloatingObjectTextWrapType;
      AIsBehindDocument: Boolean);
  end;
  ...
  strict private
    FControllerParameters
      : TdxFloatingInlineObjectLayoutOptionsFormControllerParameters;
    FFloatingInlineObjectParameters: TdxFloatingInlineObjectParameters;
    FUIUnitConverter: TdxUIUnitConverter;
    FHorizontalPositionAlignment
      : TdxNullableValue<TdxFloatingObjectHorizontalPositionAlignment>;
    FVerticalPositionAlignment
      : TdxNullableValue<TdxFloatingObjectVerticalPositionAlignment>;
    FVerticalPositionType
      : TdxNullableValue<TdxFloatingObjectVerticalPositionType>;
    FHorizontalPositionType
      : TdxNullableValue<TdxFloatingObjectHorizontalPositionType>;
    ...
    FFloatingObjectRichTextIndentEditProperties
      : TdxFloatingObjectRichTextIndentEditProperties;
    ...
    procedure SetFloatingObjectProperties(const Value
      : TdxFloatingObjectProperties);
    function GetHorizontalPositionAlignmentTable
      (Index: TdxFloatingObjectHorizontalPositionAlignment): string;
    function GetHorizontalPositionTypeTable
      (Index: TdxFloatingObjectHorizontalPositionType): string;
    function GetVerticalPositionAlignmentTable
      (Index: TdxFloatingObjectVerticalPositionAlignment): string;
    function GetVerticalPositionTypeTable
  ...
  protected
    ...
    procedure SetSizeOptions(ARun: TdxFloatingObjectAnchorRun;
    ...
    property ControllerParameters
      : TdxFloatingInlineObjectLayoutOptionsFormControllerParameters
      read FControllerParameters;
    property FloatingInlineObjectParameters: TdxFloatingInlineObjectParameters
      read FFloatingInlineObjectParameters;
    property FloatingObjectAnchorRun: TdxFloatingObjectAnchorRun
      read GetFloatingObjectAnchorRun;
    property InlinePictureRun: TdxInlinePictureRun read GetInlinePictureRun;
    property FloatingObjectProperties: TdxFloatingObjectProperties
      read GetFloatingObjectProperties write SetFloatingObjectProperties;
  ...
  public
    constructor Create(AControllerParameters
      : TdxFloatingInlineObjectLayoutOptionsFormControllerParameters);
    ...
    procedure RecalculateSizeDependingOnHeight(ALockAspectRatio: Boolean;
      ANewHeight: Integer);
    procedure RecalculateSizeDependingOnWidth(ALockAspectRatio: Boolean;
      ANewWidth: Integer);
    ...
    property FloatingObjectRichTextIndentEditProperties
      : TdxFloatingObjectRichTextIndentEditProperties
      read FFloatingObjectRichTextIndentEditProperties;
    property PlacementInfo: TdxFloatingObjectTargetPlacementInfo
      read GetPlacementInfo;
    ...
    property VerticalPositionType
      : TdxNullableValue<TdxFloatingObjectVerticalPositionType>
      read FVerticalPositionType write FVerticalPositionType;
    property HorizontalPositionType
      : TdxNullableValue<TdxFloatingObjectHorizontalPositionType>
    ...
    property TextWrapType: TdxFloatingObjectTextWrapType read FTextWrapType
      write FTextWrapType;
    property TextWrapSide: TdxNullableValue<TdxFloatingObjectTextWrapSide>
      read FTextWrapSide write FTextWrapSide;
    property IsBehindDocument: TdxNullableBoolean read FIsBehindDocument
      write FIsBehindDocument;
    property TopDistance: TdxNullableInteger read FTopDistance
      write FTopDistance;
    property BottomDistance: TdxNullableInteger read FBottomDistance
      write FBottomDistance;
    property LeftDistance: TdxNullableInteger read FLeftDistance
      write FLeftDistance;
    property RightDistance: TdxNullableInteger read FRightDistance
      write FRightDistance;

    property HorizontalPositionTypeTable
      [Index: TdxFloatingObjectHorizontalPositionType]: string
      read GetHorizontalPositionTypeTable;
    property HorizontalPositionAlignmentTable
      [Index: TdxFloatingObjectHorizontalPositionAlignment]: string
      read GetHorizontalPositionAlignmentTable;
    property VerticalPositionTypeTable
      [Index: TdxFloatingObjectVerticalPositionType]: string
      read GetVerticalPositionTypeTable;
    property VerticalPositionAlignmentTable
      [Index: TdxFloatingObjectVerticalPositionAlignment]: string
      read GetVerticalPositionAlignmentTable;
    ...
    property IsHorizontalAbsolutePosition: Boolean
      read FIsHorizontalAbsolutePosition write FIsHorizontalAbsolutePosition;
    property IsVerticalAbsolutePosition: Boolean
      read FIsVerticalAbsolutePosition write FIsVerticalAbsolutePosition;
...
constructor TdxFloatingInlineObjectLayoutOptionsFormControllerParameters.Create
  (const AControl: IdxRichEditControl; const AFloatingInlineObjectParameters
...
begin
  ...
  begin
    FFloatingObjectProperties := AFloatingInlineObjectParameters.
      FloatingObjectAnchorRun.FloatingObjectProperties;
    InitialFillPlacementInfo
      (AFloatingInlineObjectParameters.FloatingObjectAnchorRun.PieceTable,
      AFloatingInlineObjectParameters.FloatingObjectAnchorRun.Paragraph);

    FOriginalSize := AFloatingInlineObjectParameters.FloatingObjectAnchorRun.
      OriginalSize;
  end
  else
  begin
    FFloatingObjectProperties := nil;
    InitialFillPlacementInfo(AFloatingInlineObjectParameters.InlinePictureRun.
      PieceTable, AFloatingInlineObjectParameters.InlinePictureRun.Paragraph);
    FOriginalSize := AFloatingInlineObjectParameters.InlinePictureRun.
      OriginalSize;
  end;
end;

procedure TdxFloatingInlineObjectLayoutOptionsFormControllerParameters.
  InitialFillPlacementInfo(APieceTable: TdxCustomPieceTable;
  AParagraph: TdxParagraphBase);
var
  AActiveView: TdxRichEditView;
  ALogPosition: TdxDocumentLogPosition;
  APositionWithDetailsLevelColumn, APositionWithDetailsLevelPage
...
begin
  ...
  APositionWithDetailsLevelColumn :=
    AActiveView.DocumentLayout.CreateLayoutPosition(APieceTable, ALogPosition,
    0) as TdxDocumentLayoutPosition;
  try
    APositionWithDetailsLevelColumn.Update(AActiveView.DocumentLayout.Pages,
      TdxDocumentLayoutDetailsLevel.Column);
    FPlacementInfo.ColumnBounds :=
      APositionWithDetailsLevelColumn.Column.Bounds;

    APositionWithDetailsLevelPage :=
      AActiveView.DocumentLayout.CreateLayoutPosition(APieceTable, ALogPosition,
      0) as TdxDocumentLayoutPosition;
    try
      APositionWithDetailsLevelPage.Update(AActiveView.DocumentLayout.Pages,
        TdxDocumentLayoutDetailsLevel.Page);
      FPlacementInfo.PageBounds := APositionWithDetailsLevelColumn.Page.Bounds;
      FPlacementInfo.PageClientBounds :=
        APositionWithDetailsLevelColumn.Page.ClientBounds;
    finally
...
constructor TdxFloatingObjectRichTextIndentEditProperties.Create
  (ADefaultUnitType: TdxMeasurementUnit;
  AValueUnitConverter: TdxDocumentModelUnitConverter);
begin
...
function TdxFloatingObjectRichTextIndentEditProperties.GetMinValue
  (AAllowNegativeValues: Boolean): Integer;
begin
...
constructor TdxTextWrapTypeInfoPreset.Create(ATextWrapType
  : TdxFloatingObjectTextWrapType; AIsBehindDocument: Boolean);
begin
...
constructor TdxFloatingObjectLayoutOptionsFormController.Create
...
begin
  ...
  FFloatingInlineObjectParameters :=
    AControllerParameters.FloatingInlineObjectParameters;
  FUIUnitConverter := TdxUIUnitConverter.Create
    (TdxUnitPrecisions.DefaultPrecisions);
  InitializeController;
end;

function TdxFloatingObjectLayoutOptionsFormController.GetFloatingObjectAnchorRun
  : TdxFloatingObjectAnchorRun;
begin
  Result := FFloatingInlineObjectParameters.FloatingObjectAnchorRun;
end;

function TdxFloatingObjectLayoutOptionsFormController.GetInlinePictureRun
  : TdxInlinePictureRun;
begin
  Result := FloatingInlineObjectParameters.InlinePictureRun;
end;

function TdxFloatingObjectLayoutOptionsFormController.
  GetFloatingObjectProperties: TdxFloatingObjectProperties;
begin
  Result := FControllerParameters.FloatingObjectProperties;
end;

function TdxFloatingObjectLayoutOptionsFormController.
  GetHorizontalPositionAlignmentTable
  (Index: TdxFloatingObjectHorizontalPositionAlignment): string;
begin
  case Index of
...
function TdxFloatingObjectLayoutOptionsFormController.
  GetHorizontalPositionTypeTable
  (Index: TdxFloatingObjectHorizontalPositionType): string;
begin
  case Index of
...
function TdxFloatingObjectLayoutOptionsFormController.GetControl
  : IdxRichEditControl;
begin
  Result := ControllerParameters.Control;
end;

function TdxFloatingObjectLayoutOptionsFormController.GetUIType
  : TdxMeasurementUnit;
begin
...
function TdxFloatingObjectLayoutOptionsFormController.
  GetVerticalPositionAlignmentTable
  (Index: TdxFloatingObjectVerticalPositionAlignment): string;
begin
  case Index of
...
function TdxFloatingObjectLayoutOptionsFormController.GetDocumentModel
  : TdxDocumentModel;
begin
  Result := Control.InnerControl.DocumentModel;
end;

function TdxFloatingObjectLayoutOptionsFormController.GetActiveView
  : TdxRichEditView;
begin
  Result := Control.InnerControl.ActiveView;
end;

function TdxFloatingObjectLayoutOptionsFormController.GetInitialTabPage
  : TdxPageSetupFormInitialTabPage;
begin
  Result := ControllerParameters.InitialTabPage;
end;

function TdxFloatingObjectLayoutOptionsFormController.GetPlacementInfo
...
function TdxFloatingObjectLayoutOptionsFormController.
  GetToDocumentLayoutUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
begin
  Result := Control.InnerControl.DocumentModel.ToDocumentLayoutUnitConverter;
end;

function TdxFloatingObjectLayoutOptionsFormController.GetOriginalSize
  : TdxNullableValue<TSize>;
begin
...
begin
  ...
  FFloatingObjectRichTextIndentEditProperties :=
    TdxFloatingObjectRichTextIndentEditProperties.Create(AInnerControl.UIUnit,
    AUnitConverter);
  ...
  begin
    HorizontalPositionAlignment :=
      FloatingObjectProperties.HorizontalPositionAlignment;
    VerticalPositionAlignment :=
      FloatingObjectProperties.VerticalPositionAlignment;
    ...
    IsHorizontalAbsolutePosition :=
      (HorizontalPositionAlignment =
      TdxFloatingObjectHorizontalPositionAlignment.None);
    IsVerticalAbsolutePosition :=
      (VerticalPositionAlignment =
    ...
    Rotation := FloatingInlineObjectParameters.FloatingObjectAnchorRun.
      Shape.Rotation;
  end;
end;

procedure TdxFloatingObjectLayoutOptionsFormController.
...
procedure TdxFloatingObjectLayoutOptionsFormController.
  SetFloatingObjectProperties(const Value: TdxFloatingObjectProperties);
begin
  FControllerParameters.FloatingObjectProperties := Value;
end;

procedure TdxFloatingObjectLayoutOptionsFormController.SetPositionProperties
  (AFloatObjProp: TdxFloatingObjectProperties);
begin
  if HorizontalPositionType.HasValue and
    (AFloatObjProp.HorizontalPositionType <> HorizontalPositionType.Value) then
  ...
  begin
    if VerticalPositionAlignment.HasValue and
      (HorizontalPositionAlignment <> AFloatObjProp.HorizontalPositionAlignment)
    then
      AFloatObjProp.HorizontalPositionAlignment :=
        HorizontalPositionAlignment.Value;
    AFloatObjProp.OffsetX := 0;
  end;

  if VerticalPositionType.HasValue and
    (AFloatObjProp.VerticalPositionType <> VerticalPositionType.Value) then
  ...
  begin
    if VerticalPositionAlignment.HasValue and
      (VerticalPositionAlignment <> AFloatObjProp.VerticalPositionAlignment)
    then
      AFloatObjProp.VerticalPositionAlignment :=
        VerticalPositionAlignment.Value;
...
procedure TdxFloatingObjectLayoutOptionsFormController.SetWrappingOptions
  (AFloatObjProp: TdxFloatingObjectProperties);
begin
  ...
  if BottomDistance.HasValue and (BottomDistance <> AFloatObjProp.BottomDistance)
  then
    AFloatObjProp.BottomDistance := BottomDistance.Value;

  if RightDistance.HasValue and (RightDistance <> AFloatObjProp.RightDistance)
  then
  ...
  if IsBehindDocument.HasValue and
    (IsBehindDocument <> AFloatObjProp.IsBehindDoc) then
    AFloatObjProp.IsBehindDoc := IsBehindDocument.Value;
end;

procedure TdxFloatingObjectLayoutOptionsFormController.SetSizeOptions
...
procedure TdxFloatingObjectLayoutOptionsFormController.
  ApplyChangesFloatingObject(ARun: TdxFloatingObjectAnchorRun);
var
  AFloatObjProp: TdxFloatingObjectProperties;
begin
...
function TdxFloatingObjectLayoutOptionsFormController.
  SubstituteInlineToFloatingObjectRun: TdxFloatingObjectAnchorRun;
var
...
begin
  APieceTable := TdxPieceTable(FloatingInlineObjectParameters.InlinePictureRun.
    PieceTable);
  ALogPosition := DocumentModel.Selection.Interval.NormalizedStart.LogPosition;
  AParagraphIndex := FloatingInlineObjectParameters.InlinePictureRun.
    Paragraph.Index;

  ANewRun := APieceTable.InsertFloatingObjectAnchorCore(AParagraphIndex,
    ALogPosition);
  ANewContent := TdxPictureFloatingObjectContent.Create(ANewRun,
    FloatingInlineObjectParameters.InlinePictureRun.Image);
...
begin
  ...
  if (TextWrapType = TdxFloatingObjectTextWrapType.Inline) and
    ((not Rotation.HasValue) or ((Rotation = 0))) then
    ApplyChangesInlinePicture
  else
  begin
    ...
    begin
      ApplyChangesFloatingObject
        (FloatingInlineObjectParameters.FloatingObjectAnchorRun);
    end;
  end;
  DocumentModel.EndUpdate;
end;

procedure TdxFloatingObjectLayoutOptionsFormController.ApplyPreset
...
procedure TdxFloatingObjectLayoutOptionsFormController.
  RecalculateSizeDependingOnHeight(ALockAspectRatio: Boolean;
  ANewHeight: Integer);
begin
  ...
  begin
    if OriginalSize.HasValue and (OriginalSize.Value.Height <> 0) then
      ActualWidth := MulDiv(OriginalSize.Value.Width, ActualHeight,
...
procedure TdxFloatingObjectLayoutOptionsFormController.
  RecalculateSizeDependingOnWidth(ALockAspectRatio: Boolean;
  ANewWidth: Integer);
begin
  ...
  begin
    if OriginalSize.HasValue and (OriginalSize.Value.Width <> 0) then
      ActualHeight := MulDiv(OriginalSize.Value.Height, ActualWidth,
...
function TdxFloatingObjectLayoutOptionsFormController.StringToTwips
...
begin
  if S = '' then
    Exit(0);
  AUnit := TdxUIUnit.Create(S, UIType,
    TdxUnitPrecisions.DefaultPrecisions, False);
  Result := FUIUnitConverter.ToTwipsUnit(AUnit, False);
end;

function TdxFloatingObjectLayoutOptionsFormController.
  OriginalHeightAsString: string;
var
  AHeight: Integer;
  AUnit: TdxUIUnit;
begin
