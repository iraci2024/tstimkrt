...
begin
  ...
  cbxMode.Properties.Items.Add
    (cxGetResourceString(@sdxTitleModeOnEveryTopPage));
...
procedure TdxfmReportTitleProperties.LoadFromIniFile(AIniFile: TCustomIniFile;
...
procedure TdxfmReportTitleProperties.SaveToIniFile(AIniFile: TCustomIniFile;
  const ASectionName: string);
begin
