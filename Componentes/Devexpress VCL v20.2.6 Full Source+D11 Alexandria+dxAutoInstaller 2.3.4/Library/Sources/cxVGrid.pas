...
{$ENDIF}
  ...
  dxCore, dxCoreClasses, cxControls, Graphics, dxUxTheme, dxThemeManager,
  cxGraphics,
  ...
  cxCustomData, dxFilterPopupWindow, cxFindPanel, cxStorage, cxVGridUtils,
  cxGeometry, dxForms, dxMessages,
  dxScrollAnimation, cxListBox, cxPC, dxDateRanges, dxScrollbarAnnotations,
...
type
  ...
  TcxvgCustomPaintStyleCalcHelperClass = class of
  ...
  TcxVerticalGridConditionalFormattingProvider = class
  ...
  published
    property AlwaysShowEditor: Boolean read GetAlwaysShowEditor
      write SetAlwaysShowEditor stored FAlwaysShowEditorAssigned;
    property BandSizing: Boolean read FBandSizing write FBandSizing
      default True;
    property CellHints default True;
    property FocusCellOnCycle;
    property HeaderSizing: Boolean read FHeaderSizing write FHeaderSizing
      default True;
    property RowFiltering: TdxDefaultBoolean read GetRowFiltering
      write SetRowFiltering default bDefault;
    property RowSizing: Boolean read FRowSizing write FRowSizing default False;
    property RowTracking: Boolean read FRowTracking write FRowTracking
      default True;
  end;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property AllowChangeRecord: Boolean read FAllowChangeRecord
      write SetAllowChangeRecord default True;
    property FocusFirstCellOnNewRecord;
    property IncSearch;
    property IncSearchItem: TcxCustomEditorRow read GetIncSearchItem
  ...
  private
    class var FAddRecordOnEditIfEmpty: Boolean;
  private
    FAppending: Boolean;
    FDeleting: Boolean;
    FInserting: Boolean;
  ...
  public
    ...
    class property AddRecordOnEditIfEmpty: Boolean read FAddRecordOnEditIfEmpty
      write FAddRecordOnEditIfEmpty;
  published
    ...
    property MultiThreadedFiltering: TdxDefaultBoolean
      read GetMultiThreadedFiltering write SetMultiThreadedFiltering
      default bDefault;
  end;
  ...
  TcxVerticalGridFilteringRowPopupOptions = class
  ...
  TcxVerticalGridFilteringRowExcelPopupOptions = class
  ...
  private
    ...
    procedure SetRowExcelPopup
      (AValue: TcxVerticalGridFilteringRowExcelPopupOptions);
  ...
  public
    procedure RunCustomizeDialog(AEditorRowProperties
      : TcxCustomEditorRowProperties = nil); reintroduce; virtual;
  published
    property RowExcelPopup: TcxVerticalGridFilteringRowExcelPopupOptions
      read GetRowExcelPopup write SetRowExcelPopup;
    property RowPopup: TcxVerticalGridFilteringRowPopupOptions read GetRowPopup
      write SetRowPopup;
    property RowPopupMode: TdxFilterPopupWindowMode read GetRowPopupMode
      write SetRowPopupMode default fpmDefault;
  end;
  ...
  published
    property AutoScaleBands: Boolean read FAutoScaleBands
      write SetAutoScaleBands default True;
    property BandsInterval: Integer read FBandsInterval write SetBandsInterval
      default 2;
    property CategoryExplorerStyle: Boolean read FCategoryExplorerStyle
      write SetCategoryExplorerStyle default False;
    property PaintStyle: TcxvgPaintStyle read FPaintStyle write SetPaintStyle
      stored IsPaintStyleStored;
    property GridLineColor: TColor read GetGridLineColor write SetGridLineColor
      stored FGridLineColorAssigned;
    property RowHeaderFilterButtonShowMode: TcxFilterButtonShowMode
      read GetRowHeaderFilterButtonShowMode
      write SetRowHeaderFilterButtonShowMode default fbmDefault;
    property RowHeaderMinWidth: Integer read FRowHeaderMinWidth
      write SetRowHeaderMinWidth default 24;
    property RowHeaderWidth: Integer read FRowHeaderWidth
      write SetRowHeaderWidth default 100;
    ...
    property ShowEmptyRowImage: Boolean read FShowEmptyRowImage
      write SetShowEmptyRowImage default False;
    property ShowHeaders: Boolean read FShowHeaders write SetShowHeaders
      default True;
    property ShowRowHeaderFilterButtons: TcxShowFilterButtons
      read GetShowRowHeaderFilterButtons write SetShowRowHeaderFilterButtons
      default sfbDefault;
    property GridLines: TcxvgGridLines read FGridLines write SetGridLines
      default vglBoth;
    property ValueWidth: Integer read FValueWidth write SetValueWidth
      default 100;
    property ValueMinWidth: Integer read FValueMinWidth write SetValueMinWidth
      default 40;
  end;
  ...
  private
    ...
    procedure SetMultiRecordEvenOddContentStyle(const Value
  ...
  published
    property MultiRecordEvenOddContentStyle: TcxMultiRecordEvenOddContentStyle
      read FMultiRecordEvenOddContentStyle
      write SetMultiRecordEvenOddContentStyle default mrcsByRow;
    property NavigatorOffset;
    property RecordsInterval: Integer read FRecordsInterval
      write SetRecordsInterval default 0;
  end;

  { TcxCustomRowProperties }

  TcxCustomRowProperties = class(TcxInterfacedCollectionItem, IcxStoredObject)
  private
  ...
  protected
    ...
    property HeaderRealAlignmentHorz: TAlignment
      read GetRealHeaderAlignmentHorz;
  public
  ...
  public
    ...
    procedure RestoreDefaults; virtual;
  published
    property CanAutoHeight: Boolean read FCanAutoHeight write SetCanAutoHeight
      default True;
    property CanMovedToCustomizationForm: Boolean
      read FCanMovedToCustomizationForm write FCanMovedToCustomizationForm
      default True;
    property CanResized: Boolean read FCanResized write FCanResized
      default True;
    ...
    property ShowExpandButton: Boolean read FShowExpandButton
      write SetShowExpandButton default True;
    property ShowInCustomizationForm: Boolean read FShowInCustomizationForm
      write SetShowInCustomizationForm default True;
  ...
  TcxCustomRow = class(TComponent, IcxStoredObject, IcxStoredParent,
    IdxScaleFactor)
  private
    FExpanded: Boolean;
    FHeight: Integer;
  ...
  TcxEditorRowPropertiesFilterPopupIncrementalFilteringOptions = class
  ...
  private
    ...
    procedure SetExcelFilterPopup
      (AValue: TcxEditorRowPropertiesExcelFilterPopupOptions);
  protected
  ...
  published
    property Editing;
    property ExcelFilterPopup: TcxEditorRowPropertiesExcelFilterPopupOptions
      read GetExcelFilterPopup write SetExcelFilterPopup;
    property Filtering;
    property FilteringWithFindPanel;
    property FilterPopup: TcxEditorRowPropertiesFilterPopupOptions
  ...
  protected
    ...
    procedure CheckInitializeViewInfoByHiddenEditor(ACellViewInfo
      : TcxRowValueInfo); virtual;
    procedure DoCalculateEditViewInfo(AEditViewInfo
      : TcxEditCellViewInfo); override;
    ...
    function GetDisplayValue(AProperties: TcxCustomEditProperties;
      ARecordIndex: Integer): Variant; override;
    ...
    procedure ValidateDrawValue(const Value: Variant;
  ...
  public
    ...
    property EditRowProperties: TcxCustomEditorRowProperties
      read FEditRowProperties;
    property Options;
    property Row: TcxCustomRow read FRow;
    property ViewInfo: TcxCustomRowViewInfo read GetViewInfo;
  end;
  ...
  TcxVerticalGridGetDisplayTextEvent = procedure
    (Sender: TcxCustomEditorRowProperties; ARecord: Integer; var AText: string)
    of object;
  TcxVerticalGridGetEditPropertiesEvent = procedure
    (Sender: TcxCustomEditorRowProperties; ARecordIndex: Integer;
    var AProperties: TcxCustomEditProperties) of object;
  TcxVerticalGridValidateDrawValueEvent = procedure
    (Sender: TcxCustomEditorRowProperties; ARecordIndex: Integer;
    const AValue: Variant; AData: TcxEditValidateInfo) of object;
  ...
  strict private
    ...
    procedure SetOnGetEditingProperties
      (Value: TcxVerticalGridGetEditPropertiesEvent);
    procedure SetOnGetEditProperties
      (Value: TcxVerticalGridGetEditPropertiesEvent);
  ...
  protected
    ...
    procedure DoGetDisplayTextEvent(ARecordIndex: Integer;
      var Text: string); virtual;
    procedure DoValidateDrawValue(const Value: Variant; ARecordIndex: Integer;
    ...
    property IEditorPropertiesContainer: IcxEditorPropertiesContainer
      read GetIEditorPropertiesContainer
      implements IcxEditorPropertiesContainer;
    property DataBinding: TcxItemDataBinding read GetDataBinding
      write SetDataBinding;
    property Options: TcxEditorRowPropertiesOptions read GetOptions
      write SetOptions;
    property Value: Variant read GetValue write SetValue;
    property OnGetDisplayText: TcxVerticalGridGetDisplayTextEvent
      read FOnGetDisplayText write FOnGetDisplayText;
    property OnGetEditProperties: TcxVerticalGridGetEditPropertiesEvent
      read GetOnGetEditProperties write SetOnGetEditProperties;
    property OnGetFilterValues: TcxGetFilterValuesEvent
      read GetOnGetFilterValues write SetOnGetFilterValues;
    property OnInitFilteringDateRanges: TdxInitDateRangesEvent
      read GetOnInitFilteringDateRanges write SetOnInitFilteringDateRanges;
    property OnGetEditingProperties: TcxVerticalGridGetEditPropertiesEvent
      read GetOnGetEditingProperties write SetOnGetEditingProperties;
    property OnValidateDrawValue: TcxVerticalGridValidateDrawValueEvent
      read FOnValidateDrawValue write FOnValidateDrawValue;
    property OnUserFiltering: TcxUserFilteringEvent read GetOnUserFiltering
      write SetOnUserFiltering;
    property OnUserFilteringEx: TcxUserFilteringExEvent
      read GetOnUserFilteringEx write SetOnUserFilteringEx;
  public
    constructor CreateEx(ARow: TcxCustomRow); override;
    destructor Destroy; override;
    ...
    property DisplayEditProperties[Index: Integer]: TcxCustomEditProperties
      read GetDisplayEditProperty;
    property DisplayTexts[Index: Integer]: string read GetDisplayText;
    property EditPropertiesClass: TcxCustomEditPropertiesClass
      read GetEditPropertiesClass write SetEditPropertiesClass;
    property Filtered;
    property FilteringDateRanges: TdxFilteringDateRanges
      read GetFilteringDateRanges;
  ...
  published
    property EditPropertiesClassName: string read GetEditPropertiesClassName
      write SetEditPropertiesClassName;
    property EditProperties: TcxCustomEditProperties read GetEditProperties
      write SetEditProperties;
    property RepositoryItem: TcxEditRepositoryItem read GetRepositoryItem
      write SetRepositoryItem;
    property VisibleForExpressionEditor: TdxDefaultBoolean
      read GetVisibleForExpressionEditor write SetVisibleForExpressionEditor
      default bDefault;
  end;
  ...
  protected
    ...
    property Properties: TcxCustomEditorRowProperties read GetProperties
      write SetProperties;
  public
    function CreateHeaderInfo: TcxCustomRowHeaderInfo; override;
    function CreateViewInfo: TcxCustomRowViewInfo; override;
  published
    property EditPropertiesEvents: TNotifyEvent read FEditPropertiesEvents
      write FEditPropertiesEvents;
    property Options;
  ...
  published
    ...
    property Height;
    property Options;
    property Properties: TcxEditorRowProperties read GetProperties
      write SetProperties;
    property Styles;
    property Visible;
  end;
  ...
  protected
    ...
    function GetOwner: TPersistent; override;
    //
    property Options: TcxMultiEditorRowPropertiesOptions read GetOptions
      write SetOptions;
  public
    constructor CreateEx(ARow: TcxCustomRow); override;
    procedure Assign(Source: TPersistent); override;
  ...
  public
    ...
    property Items[Index: Integer]: TcxEditorRowItemProperties
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property Editors: TcxEditorPropertiesCollection read FEditors
      write FEditors;
    property Fixed: Boolean read FFixed write SetFixed default False;
    property SeparatorAlignmentVert: TcxAlignmentVert
      read FSeparatorAlignmentVert write SetSeparatorAlignmentVert
      default vaTop;
    property SeparatorKind: TSeparatorKind read FSeparatorKind
      write SetSeparatorKind default skVertLine;
    property SeparatorString: string read FSeparatorString
      write SetSeparatorString;
  end;
  ...
  protected
    ...
    property Styles: TcxEditorRowStyles read GetStyles write SetStyles;
    property Properties: TcxMultiEditorRowProperties read GetProperties
      write SetProperties;
  public
    function CreateHeaderInfo: TcxCustomRowHeaderInfo; override;
    function CreateViewInfo: TcxCustomRowViewInfo; override;
  ...
  public
    ...
    property Count: Integer read GetCount;
    property Items[Index: Integer]: TcxCustomRow read GetRow
      write SetRow; default;
  end;
  ...
  protected
    ...
    function CanCalcRowsOnTheNextBand(ALeft, ANextBandIndex: Integer)
      : Boolean; virtual;
    function CanRecordPixelScrolling: Boolean; virtual;
    procedure CheckLeftVisibleRecordAndOffset(var ALeftVisibleRecord,
      APixelScrollOffset: Integer); virtual;
    function DataScrollSize: Integer; virtual;
    procedure DoCheckLeftVisibleRecordAndOffset(var ALeftVisibleRecord,
      APixelScrollOffset: Integer); virtual;
    function DoGetScrollBarPos: Integer; virtual;
    procedure DoScrollRecords(AScrollCode: TScrollCode;
      var AScrollPos: Integer); virtual;
    procedure DoSetLeftVisibleRecordAndOffset(ALeftVisibleRecord,
    ...
    function GetFullRowHeight(ARow: TcxCustomRow;
    ...
    procedure ScrollH(AScrollCode: TScrollCode;
      var AScrollPos: Integer); virtual;
    procedure ScrollV(AScrollCode: TScrollCode;
      var AScrollPos: Integer); virtual;
    procedure SetLeftVisibleBand(Value: Integer); virtual; abstract;
    procedure SetLeftVisibleRecord(Value: Integer); virtual;
    procedure SetLeftVisibleRecordAndOffset(ALeftVisibleRecord,
      APixelScrollRecordOffset: Integer; AAnimated: Boolean); virtual;
  ...
  public
    ...
    property LeftVisibleBand: Integer read GetLeftVisibleBand
      write SetLeftVisibleBand;
    property LeftVisibleRecord: Integer read FLeftVisibleRecord
      write SetLeftVisibleRecord;
    ...
    property TopVisibleRowIndex: Integer read FTopVisibleRowIndex
      write SetTopVisibleRowIndex;
    property VerticalGrid: TcxCustomVerticalGrid read GetVerticalGrid;
  ...
  protected
    ...
    function GetBandInterval: Integer; override;
    function GetLeftVisibleBand: Integer; override;
    procedure GetPixelScrollLeftRecordIndexAndOffsetByRightRecord
      (ARightRecord: Integer; out ALeftRecord, APixelScrollRecordOffset
      : Integer);
    ...
    procedure RecordScrollAnimated(ALeftVisibleRecord, APixelScrollOffset
      : Integer);
    procedure SetLeftVisibleRecordAndOffset(ALeftVisibleRecord,
      APixelScrollRecordOffset: Integer; AAnimated: Boolean); override;
  ...
  protected
    ...
    function InternalSetLeftVisibleBand(ABandIndex: Integer;
  ...
  protected
    ...
    function CreateScrollStrategy(AScroller: TcxvgScroller)
      : TcxvgCustomScrollStrategy; virtual;
  ...
  public
    ...
    procedure SetLeftVisibleRecordAndOffset(ATopRecordIndex, ATopRecordOffset
      : Integer; AAnimated: Boolean);
    function SetRecordVisible(ARecordIndex: Integer): Boolean; virtual;
    ...
    property CheckDecrease: Boolean read GetCheckDecrease
      write SetCheckDecrease;
    property LeftVisibleBand: Integer read GetLeftVisibleBand
      write SetLeftVisibleBand;
    property LeftVisibleRecord: Integer read GetLeftVisibleRecord
      write SetLeftVisibleRecord;
    property PixelScrollRecordOffset: Integer read GetPixelScrollRecordOffset;
    property TopVisibleRowIndex: Integer read GetTopVisibleRowIndex
      write SetTopVisibleRowIndex;
    property VisibleRowCount: Integer read GetVisibleRowCount;
    property VisibleValueCount: Integer read GetVisibleValueCount;
  end;
  ...
  protected
    ...
    function CalcRowHeaderHitTest(AHeaderInfo: TcxCustomRowHeaderInfo)
      : Boolean; virtual;
    ...
    function CanSizing(var ASizeDirection: TcxDragSizingDirection): Boolean;
      overload; virtual;
  ...
  public
    ...
    property HitAtCaptionFilterButton: Boolean
      index vghc_HitAtCaptionFilterButton read GetState;
  ...
  protected
    ...
    function FocusNextCell(AForward, ANextRow, ATabStopNavigation: Boolean)
      : Boolean; reintroduce;
    procedure FocusRecordRowCell(ARecordIndex: Integer; ARow: TcxCustomRow;
      ACellIndex: Integer);
    function GetContainerCount(ARowIndex: Integer): Integer;

    function GetCellIndexForNextRow(AForward: Boolean;
  ...
  protected
    ...
    procedure DoUpdateRowAndCell(ANewRow: TcxCustomRow;
      ANewCellIndex: Integer); virtual;
    ...
    procedure SetFocusedRowAndCell(Value: TcxCustomRow;
      ACellIndex: Integer); virtual;
    ...
    property FocusedItem: TcxCellEdit read GetFocusedItem
      write SetFocusedItemInternal;
  ...
  protected
    ...
    procedure FocusedRecordChanged(APrevFocusedRowIndex, AFocusedRowIndex
      : Integer); override;
    function GetCancelEditingOnExit: Boolean; override;
    ...
    property OptionsBehavior: TcxvgMultiRecordsOptionsBehavior
  ...
  TcxVerticalGridDrawHeaderEvent = procedure(Sender: TObject;
    ...
    AHeaderViewInfo: TcxCustomRowHeaderInfo; var Done: Boolean) of object;

  TcxVerticalGridDrawValueEvent = procedure(Sender: TObject; ACanvas: TcxCanvas;
  ...
  TcxCustomVerticalGrid = class(TcxExtEditingControl, IcxStoredObject,
    IcxStoredParent, IcxDataControllerConditionalFormattingProviderOwner,
    IdxSkinSupport)
  private
    FCategoryFont: TFont;
  ...
  protected
    ...
    function DoDrawBackgroundPart(const R: TRect;
      const AViewParams: TcxViewParams): Boolean; virtual;
    function DoDrawRowHeader(AHeaderViewInfo: TcxCustomRowHeaderInfo)
      : Boolean; virtual;
    function DoDrawValue(AValueInfo: TcxRowValueInfo): Boolean; virtual;
    procedure DoItemChanged(AOldRow: TcxCustomRow;
      AOldCellIndex: Integer); virtual;
    ...
    function GetRowContentStyleIndex(AProperties: TcxCustomEditorRowProperties;
      ARecordIndex: Integer): Integer; virtual;
    function GetScrollStrategyClass: TcxvgCustomScrollStrategyClass;
      virtual; abstract;
    ...
    property Controller: TcxvgController read GetController;
    property Customizing: TcxVerticalGridCustomizing read FCustomizing
      write FCustomizing;
    property DateTimeHandling: TcxVerticalGridDateTimeHandling
      read GetDateTimeHandling write SetDateTimeHandling;
    property DragHeaderInfo: TcxCustomRowHeaderInfo read GetDragHeaderInfo;
    property FilterBox: TcxVerticalGridFilterBox read GetFilterBox
      write SetFilterBox;
    property Filtering: TcxVerticalGridFiltering read GetFiltering
      write SetFiltering;
    property LeftVisibleRecord: Integer read GetLeftVisibleRecord
      write SetLeftVisibleRecord;
    ...
    property OnDrawBackground: TcxVerticalGridDrawBackgroundEvent
      read FOnDrawBackground write FOnDrawBackground;
    property OnDrawRowHeader: TcxVerticalGridDrawHeaderEvent
      read FOnDrawRowHeader write FOnDrawRowHeader;
    property OnDrawValue: TcxVerticalGridDrawValueEvent read FOnDrawValue
      write FOnDrawValue;
    property OnEdited: TcxVerticalGridChangedEvent read FOnEdited
      write FOnEdited;
    property OnEditing: TcxVerticalGridEditingEvent read FOnEditing
      write FOnEditing;
    property OnEditValueChanged: TcxVerticalGridChangedEvent
      read FOnEditValueChanged write FOnEditValueChanged;
    property OnItemChanged: TcxVerticalGridItemChangedEvent read FOnItemChanged
      write FOnItemChanged;
    property OnLayoutChanged: TNotifyEvent read FOnLayoutChanged
      write FOnLayoutChanged;
    property OnLeftVisibleBandIndexChanged: TNotifyEvent
      read FOnLeftVisibleBandIndexChanged write FOnLeftVisibleBandIndexChanged;
    property OnLeftVisibleRecordIndexChanged: TNotifyEvent
      read FOnLeftVisibleRecordIndexChanged
      write FOnLeftVisibleRecordIndexChanged;
    property OnTopRowIndexChanged: TNotifyEvent read FOnTopRowIndexChanged
      write FOnTopRowIndexChanged;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    ...
    function AddChild(AParent: TcxCustomRow; ARowClass: TcxCustomRowClass)
      : TcxCustomRow;
    ...
    property OptionsBehavior: TcxvgOptionsBehavior read GetOptionsBehavior
  ...
  protected
    ...
    property LayoutStyle: TcxvgUnboundLayoutStyle read FLayoutStyle
      write SetLayoutStyle default ulsSingleRecordView;
  public
    constructor Create(AOwner: TComponent); override;
  end;
  ...
  TcxVerticalGridFocusedRecordChangedEvent = procedure
    (Sender: TcxVirtualVerticalGrid;
  ...
  TcxVerticalGridScrollbarAnnotationOptionsHelper = class
  ...
  TcxVirtualVerticalGrid = class(TcxCustomVerticalGrid, IcxVGridDesignerRows,
    IcxNavigator, IcxFilterControl, IcxFilterControlEx)
  strict private
  ...
  private
    ...
    procedure SetScrollbarAnnotations
      (Value: TcxVerticalGridScrollbarAnnotationOptions);
  protected
    // IcxFilterControl
    ...
    procedure DoFocusedRecordChanged(APrevFocusedRecord, AFocusedRecord
      : Integer); virtual;
    ...
    function GetOptionsViewClass: TcxControlOptionsViewClass; override;
    function GetRowContentStyleIndex(AProperties: TcxCustomEditorRowProperties;
      ARecordIndex: Integer): Integer; override;
    function GetScrollStrategyClass: TcxvgCustomScrollStrategyClass; override;
    function GetViewInfoClass: TcxCustomControlViewInfoClass; override;
  ...
  published
    ...
    property Font;
    property Images;
    property LayoutStyle: TcxvgLayoutStyle read FLayoutStyle
      write SetLayoutStyle default lsSingleRecordView;
    property LookAndFeel;
    ...
    property ParentFont;
    property PopupMenu;
    property ScrollbarAnnotations: TcxVerticalGridScrollbarAnnotationOptions
    ...
    property OnFilterRecord: TcxDataFilterRecordEvent read GetFilterRecordEvent
      write SetFilterRecordEvent;
  ...
  protected
    ...
    property EditorRowProperties: TcxCustomEditorRowProperties
      read GetEditorRowProperties;
  public
  ...
  TcxRowCaptionInfo = class(TPersistent, IUnknown, IcxHotTrackElement,
    IcxHintableObject, IdxUIElementPopupWindowOwner, IdxFilterPopupWindowOwner)
  strict private
    FCaption: string;
  ...
  protected
    ...
    property VerticalGrid: TcxCustomVerticalGrid read GetVerticalGrid;
  public
    constructor Create(AHeaderInfo: TcxCustomRowHeaderInfo;
      ARowProperties: TcxCaptionRowProperties); virtual;
    destructor Destroy; override;
    // IUnknown
    function QueryInterface(const IID: TGUID; out Obj): HResult;
      virtual; stdcall;
    ...
    property FilterSmartTagState: TcxFilterSmartTagState
      read GetFilterSmartTagState;
  ...
  protected
    ...
    procedure AddNextIndentInfo(const ABounds: TRect;
      const AViewParams: TcxViewParams; AToCategories, AUnderline,
    ...
    procedure CalcIndentBounds(ANextRow: TcxCustomRow;
      ACalculate: Boolean); virtual;
    function CalcIndentsInfo(ALevelCount: Integer; ANextRow: TcxCustomRow)
      : TIndentRectInfoList; virtual;
  ...
  private
    ...
    function GetRowValueInfo(ARecordIndex, ACellIndex: Integer)
      : TcxRowValueInfo;
    function GetVerticalGrid: TcxCustomVerticalGrid;
    function GetViewInfo: TcxvgCustomViewInfo;
  protected
    ...
    function GetValuesHeight(ABandWidth: Integer;
      AViewInfo: TcxvgCustomViewInfo): Integer; virtual;
    procedure InitValuesInfo;
    function NeedLTRBounds: Boolean;
    procedure RightToLeftConversion(const AClientBounds: TRect);

    property RightToLeftConversionClientBounds: TRect
      read FRightToLeftConversionClientBounds;
    property ValuesInfo: TcxValueInfoList read FValuesInfo;
    property ViewInfo: TcxvgCustomViewInfo read GetViewInfo;
  public
    constructor Create(ARow: TcxCustomRow); virtual;
    destructor Destroy; override;
    procedure Calc(const ARowRect: TRect; AViewInfo: TcxvgCustomViewInfo;
    ...
    property CalculatedHeight: Integer read GetCalculatedHeight
      write FCalculatedHeight;
    property HeaderInfo: TcxCustomRowHeaderInfo read FHeaderInfo;
    property IsRightToLeftConverted: Boolean read FIsRightToLeftConverted;
    property Row: TcxCustomRow read FRow;
    property RowRect: TRect read FRowRect;
    property RowValueInfo[ARecordIndex, ACellIndex: Integer]: TcxRowValueInfo
      read GetRowValueInfo;
  ...
  protected
    ...
    procedure AddBottomValueSide(ARowViewInfo: TcxCustomRowViewInfo;
      const R: TRect);
    procedure AddEmptyRects; virtual; abstract;
    procedure AddRightValueSide(ARowViewInfo: TcxCustomRowViewInfo;
      const R: TRect; ALast: Boolean); virtual;
    ...
    function CanAddRowToBand(const ARowRect, ABandRect: TRect;
      ABandRowIndex: Integer): Boolean; virtual;
    function CanUpdateRecord(ARecordIndex: Integer): Boolean; virtual;
    procedure ChangeScale(M, D: Integer); virtual;
    procedure CheckBiDiMode; virtual;
    procedure CheckMaxRowHeaderWidth(var Value: Integer;
      AValueMinWidth: Integer); virtual;
    ...
    function GetLTRValueRect(AValueIndex: Integer;
      ARowViewInfo: TcxCustomRowViewInfo): TRect; virtual;
    function GetLTRValuesRect(ARowViewInfo: TcxCustomRowViewInfo)
      : TRect; virtual;
    ...
    function ScaleRowRects(ARowViewInfo: TcxCustomRowViewInfo)
      : TRectScaler; virtual;
    ...
    property ViewHeaderWidth: Integer read FViewHeaderWidth
      write FViewHeaderWidth;
  public
    constructor Create(AOwner: TcxEditingControl); override;
    destructor Destroy; override;
    procedure CalcEditCell(const ABounds: TRect;
      ARowValueInfo: TcxRowValueInfo); virtual;
    ...
    // properties
    property BandBorderColor: TColor read FBandBorderColor
      write FBandBorderColor;
  ...
  public
    ...
    procedure AddBoundHeaderLines(ARowHeaderInfo: TcxCustomRowHeaderInfo);
      virtual; abstract;
    ...
    function ChangeFocusedRow(ANewFocus, AOldFocus: TcxCustomRow): TRect;
      virtual; abstract;
    function GetBackgroundColor: TColor; virtual;
    function GetCategoryColor: TColor; virtual; abstract;
    function GetCategoryFocusRect(ARowHeaderInfo: TcxCustomRowHeaderInfo)
    ...
    function GetIndentViewParams(ARow, AParentIndentRow: TcxCustomRow)
      : TcxViewParams; virtual; abstract;
  ...
  public
    procedure AddBoundHeaderLines(ARowHeaderInfo
      : TcxCustomRowHeaderInfo); override;
    procedure AddDivider(ALinesInfo: TLineInfoList; const R: TRect;
    ...
    function ChangeFocusedRow(ANewFocus, AOldFocus: TcxCustomRow)
      : TRect; override;
  ...
  protected
    ...
    function GetExpandButtonState(ARowHeader: TcxCustomRowHeaderInfo)
      : TcxExpandButtonState; virtual;
  ...
  public
    ...
    procedure DrawCategoryExplorerStyleRowHeader
      (ARowHeader: TcxCustomRowHeaderInfo; ATheme: TdxTheme); virtual;
    procedure DrawCategoryRowHeader(ARowHeader
      : TcxCustomRowHeaderInfo); virtual;
    procedure DrawCategoryRowIndent(ARowHeader
      : TcxCustomRowHeaderInfo); virtual;
    ...
    procedure DrawRowHeaderCell(ACaptionInfo: TcxRowCaptionInfo;
      ATransparent: Boolean); virtual;
    procedure DrawRowHeaderCellFilterButton(ACaptionInfo
      : TcxRowCaptionInfo); virtual;
    procedure DrawRowHeaderCells(ARowHeader: TcxCustomRowHeaderInfo); virtual;
    procedure DrawRowHeaderFocusRect(ARowHeader
      : TcxCustomRowHeaderInfo); virtual;
    procedure DrawRowHeaderSelected(ARowHeader
      : TcxCustomRowHeaderInfo); virtual;
  ...
  public
    procedure Assign(Source: TPersistent); override;
    function GetContentParams(AEditorRowProperties
      : TcxCustomEditorRowProperties; AFocused: Boolean; ARecordIndex: Integer)
      : TcxViewParams;
  published
  ...
  published
    property Styles: TcxVerticalGridStyles read GetStylesValue
  ...
  protected
    ...
    function GetSelectedHeaderParams(ARow: TcxCustomRow; AFocused: Boolean)
      : TcxViewParams; overload;
  ...
  public
    ...
    function GetSelectedHeaderParams(ARow: TcxCustomRow)
      : TcxViewParams; overload;
  published
    property Category: TcxStyle index vgs_Category read GetValue write SetValue;
    property ContentEven: TcxStyle index vgs_ContentEven read GetValue
      write SetValue;
    property ContentOdd: TcxStyle index vgs_ContentOdd read GetValue
      write SetValue;
    property Header: TcxStyle index vgs_Header read GetValue write SetValue;
    property IncSearch: TcxStyle index vgs_IncSearch read GetValue
      write SetValue;
    property UseOddEvenStyles: TdxDefaultBoolean read FUseOddEvenStyles
      write SetUseOddEvenStyles default bDefault;
    property OnGetCategoryStyle: TcxvgOnGetItemStyleEvent
      read FOnGetCategoryStyle write FOnGetCategoryStyle;
    property OnGetHeaderStyle: TcxvgOnGetItemStyleEvent read FOnGetHeaderStyle
      write FOnGetHeaderStyle;
    property OnGetContentStyle: TcxvgOnGetContentStyleEvent
  ...
  protected
    procedure CalcHeaderViewInfo(const R: TRect;
      AHeaderInfo: TcxCustomRowHeaderInfo); virtual;
    procedure DragOver(Source: TObject; X, Y: Integer; State: TDragState;
      var Accept: Boolean); override;
  ...
  protected
    ...
    procedure ValidateListBox(AListBox: TcxVerticalGridItemsCustomizeListBox;
      AIndex: Integer);
    procedure Update; virtual;
    // IcxVerticalGridDesigner
    procedure ComponentRemoved(Sender: TObject); virtual;
    procedure Modified; virtual;
    property CategoryListBox: TcxVerticalGridItemsCustomizeListBox
      read FCategoryListBox;
  ...
  public
    ...
    property ShowCategoryButtons: Boolean read FShowCategoryButtons
      write SetShowCategoryButtons;
    property ShowCategoryTab: Boolean read FShowCategoryTab
      write FShowCategoryTab;
    property Visible: Boolean read GetVisible write SetVisible;
  end;

function GetTextAligmentFlags(AProperties: TcxCaptionRowProperties)
  : Integer; overload;
function GetTextAligmentFlags(AHorz: TAlignment; AVert: TcxAlignmentVert)
  : Integer; overload;
...
uses
  ...
  cxTextEdit, cxLibraryConsts, dxDPIAwareUtils, dxCoreGraphics;
...
type
  ...
  public
    function StartEdit(AItemIndex: Integer;
      AOptionsData: TcxvgMultiRecordsOptionsData): Boolean;
  end;

const
  HorzAlignment: array [TAlignment] of Integer = (CXTO_LEFT, CXTO_RIGHT,
    CXTO_CENTER_HORIZONTALLY);
  VertAlignment: array [TcxAlignmentVert] of Integer = (CXTO_TOP, CXTO_BOTTOM,
    CXTO_CENTER_VERTICALLY);

function GetTextAligmentFlags(AProperties: TcxCaptionRowProperties)
  : Integer; overload;
begin
  Result := GetTextAligmentFlags(AProperties.HeaderRealAlignmentHorz,
    AProperties.HeaderAlignmentVert);
end;
...
function TcxDataControllerHelper.StartEdit(AItemIndex: Integer;
  AOptionsData: TcxvgMultiRecordsOptionsData): Boolean;
var
...
function TcxVerticalGridFindPanel.GetItemCaption
...
function TcxVerticalGridFilterValueList.GetDateTimeRelativeFilterDisplayText
...
constructor TcxVerticalGridConditionalFormattingProvider.Create
...
function TcxVerticalGridConditionalFormattingProvider.IsItemVisible
...
function TcxVerticalGridConditionalFormattingProvider.IsRowVisible
  (const ARow: Integer): Boolean;
begin
  Result := (ARow >= FOwner.LeftVisibleRecord) and
    (ARow <= FOwner.LeftVisibleRecord +
    FOwner.Controller.Scroller.VisibleValueCount);
end;
...
function TcxVerticalGridConditionalFormattingProvider.GetController
  : TcxCustomControlController;
begin
  Result := FOwner.Controller;
end;

function TcxVerticalGridConditionalFormattingProvider.GetItemDisplayName
...
function TcxVerticalGridConditionalFormattingProvider.GetLookAndFeel
  : TcxLookAndFeel;
begin
...
function TcxVerticalGridConditionalFormattingProvider.DoGetParentForm
  : TCustomForm;
begin
  Result := Forms.GetParentForm(FOwner);
end;

function TcxVerticalGridConditionalFormattingProvider.GetScaleFactor
  : TdxScaleFactor;
begin
...
function TcxvgCustomPaintStyleCalcHelper.GetContentEvenColor
  (AFocused: Boolean): TColor;
begin
...
function TcxvgCustomPaintStyleCalcHelper.GetContentOddColor
  (AFocused: Boolean): TColor;
begin
  Result := GetContentColor(AFocused);
end;
...
function TcxvgCustomPaintStyleCalcHelper.GetPainter
...
function TcxvgCustomPaintStyleCalcHelper.IsBottomLineNeeded
  (ANextRow: TcxCustomRow): Boolean;
begin
  Result := ANextRow <> nil;
end;
...
procedure TcxvgDotNetStyleCalcHelper.AddBoundHeaderLines(ARowHeaderInfo
  : TcxCustomRowHeaderInfo);
begin
  with ARowHeaderInfo do
    AddBottomHorzLine(cxRectBounds(IndentBounds.Right, IndentBounds.Top,
      HeaderRect.Right - IndentBounds.Right, IndentBounds.Bottom -
      IndentBounds.Top));
end;

procedure TcxvgDotNetStyleCalcHelper.AddDivider(ALinesInfo: TLineInfoList;
  const R: TRect; AColor: TColor; AIsSeparator: Boolean);
begin
  with ViewInfo do
    if DividerWidth > 0 then
      ALinesInfo.Add(R.Right, R.Top, VertLineWidth,
        R.Bottom - R.Top + HorzLineWidth, VertLineBrush);
end;

procedure TcxvgDotNetStyleCalcHelper.AddHeaderIndentLines(ARowHeaderInfo
  : TcxCustomRowHeaderInfo; const R: TRect; const AViewParams: TcxViewParams;
...
begin
  ...
  begin
    ...
    if AAddVertLine and (VertLineWidth > 0) then
      ARowHeaderInfo.LinesInfo.Add(R.Right - VertLineWidth, R.Top,
        VertLineWidth, R.Bottom - R.Top + HorzLineWidth, VertLineBrush);
    ...
    begin
      ...
      if AAddVertLine then
        Dec(W, VertLineWidth);
      if AUnderline then
        ARowHeaderInfo.LinesInfo.Add(R.Left, R.Bottom, W, HorzLineWidth,
          HorzLineBrush)
      else if (AViewParams.Bitmap <> nil) and not AViewParams.Bitmap.Empty then
        ARowHeaderInfo.RowIndents.Add(cxRectBounds(R.Left, R.Bottom, W,
          HorzLineWidth), AViewParams)
      else
        ARowHeaderInfo.LinesInfo.Add(R.Left, R.Bottom, W, HorzLineWidth,
          AViewParams.Color);
    end;
...
function TcxvgDotNetStyleCalcHelper.ChangeFocusedRow(ANewFocus,
  AOldFocus: TcxCustomRow): TRect;
var
  ...
  begin
    ...
    begin
      ...
      ARecalcChild := ARecalcChild or
        ((ASaveColor <> HeaderInfo.IndentViewParams.Color) and Row.IsCategory);
    end;
...
function TcxvgDotNetStyleCalcHelper.GetCategoryFocusRect(ARowHeaderInfo
  : TcxCustomRowHeaderInfo): TRect;
var
  ATextRect: TRect;
  ASize: TSize;
  ACaption: string;
...
begin
  Result := cxNullRect;
  if VerticalGrid.FocusedRow <> ARowHeaderInfo.Row then
    Exit;
  ...
  case AProperties.HeaderAlignmentHorz of
    taLeftJustify:
      ATextRect.Right := ATextRect.Left + ASize.cx;
    taRightJustify:
      ATextRect.Left := ATextRect.Right - ASize.cx;
  else
    ATextRect := cxRectCenter(ATextRect, ASize.cx,
      ATextRect.Bottom - ATextRect.Top);
  end;
  case AProperties.HeaderAlignmentVert of
    vaTop:
      ATextRect.Bottom := ATextRect.Top + ASize.cy;
    vaBottom:
      ATextRect.Top := ATextRect.Bottom - ASize.cy;
  else
    ATextRect := cxRectCenter(ATextRect, ATextRect.Right - ATextRect.Left,
      ASize.cy);
  end;
  cxRectIntersect(Result, cxRectInflate(ATextRect, 1, 1),
    AHeaderInfo.HeaderRect);
end;
...
function TcxvgDotNetStyleCalcHelper.GetIndentViewParams(ARow, AParentIndentRow
  : TcxCustomRow): TcxViewParams;
begin
...
procedure TcxvgStyle3DCalcHelper.AddBoundHeaderLines(ARowHeaderInfo
  : TcxCustomRowHeaderInfo);
begin
  if ViewInfo.HorzLineWidth > 0 then
    with ARowHeaderInfo do
      LinesInfo.Add(HeaderRect.Left, HeaderRect.Bottom,
        HeaderRect.Right - HeaderRect.Left, ViewInfo.HorzLineWidth,
        ViewInfo.HorzLineBrush);
end;

procedure TcxvgStyle3DCalcHelper.AddHeaderIndentLines(ARowHeaderInfo
  : TcxCustomRowHeaderInfo; const R: TRect; const AViewParams: TcxViewParams;
  AToCategories, AUnderline, AAddVertLine: Boolean);
begin
end;
  ...
  with ViewInfo do
    if DividerWidth > 0 then
      ...
      begin
        ...
        ALinesInfo.Add(R.Right, R.Top + 2, 1, R.Bottom - R.Top + HorzLineWidth -
          5, clBtnShadow);
        ALinesInfo.Add(R.Right + 1, R.Top + 2, 1,
          R.Bottom - R.Top + HorzLineWidth - 5, clBtnHighlight);
      end
      else
      begin
        ALinesInfo.Add(R.Right, R.Top, 1, R.Bottom - R.Top + HorzLineWidth,
          clBtnShadow);
        ALinesInfo.Add(R.Right + 1, R.Top, 1, R.Bottom - R.Top + HorzLineWidth,
          clBtnHighlight);
      end;
end;
...
var
  ...
  R: TRect;
begin
  if VerticalGrid.FocusedRow = nil then
    Exit;
  R := ARowViewInfo.RowRect;
  if ANextRow = VerticalGrid.FocusedRow then
  begin
    AFocusedRowBandIndex := Scroller.GetBandIndexByRowIndex
      (ANextRow.VisibleIndex);
    if AFocusedRowBandIndex = ARowViewInfo.BandIndex then
    begin
      ViewInfo.FocusLinesInfo.Add(R.Left, R.Bottom - 1, R.Right - R.Left, 1,
        cl3DDkShadow);
      ViewInfo.FocusLinesInfo.Add(R.Left + 1, R.Bottom, R.Right - R.Left - 1, 1,
        clBtnShadow);
    end;
  end;
  ...
  begin
    ViewInfo.FocusLinesInfo.Add(R.Left, R.Bottom - 1, R.Right - R.Left, 1,
      clBtnFace);
    ViewInfo.FocusLinesInfo.Add(R.Left, R.Bottom, R.Right - R.Left, 1,
      clBtnHighlight);
    ViewInfo.FocusLinesInfo.Add(R.Left, R.Top - 1, 1, R.Bottom - R.Top + 1,
      cl3DDkShadow);
    ViewInfo.FocusLinesInfo.Add(R.Left + 1, R.Top, 1, R.Bottom - R.Top - 1,
      clBtnShadow);
  end;
end;

function TcxvgStyle3DCalcHelper.ChangeFocusedRow(ANewFocus,
  AOldFocus: TcxCustomRow): TRect;
...
function TcxvgStyle3DCalcHelper.GetCategoryFocusRect(ARowHeaderInfo
  : TcxCustomRowHeaderInfo): TRect;
begin
  Result := cxNullRect;
end;
...
function TcxvgStyle3DCalcHelper.GetIndentViewParams(ARow, AParentIndentRow
  : TcxCustomRow): TcxViewParams;
begin
  Result := ARow.ViewInfo.HeaderInfo.ViewParams;
end;
...
begin
  Result := cxCreateHalftoneBrush(VerticalGrid.OptionsView.GridLineColor,
    clBtnFace);
end;
...
procedure TcxvgSkinCalcHelper.AddBoundHeaderLines(ARowHeaderInfo
  : TcxCustomRowHeaderInfo);
begin
  ...
  begin
    ...
    begin
      with ARowHeaderInfo do
      begin
        ARowHeaderInfo.LinesInfo.Add(IndentBounds.Right,
          IndentBounds.Top - ViewInfo.HorzLineWidth,
          HeaderRect.Right - IndentBounds.Right, ViewInfo.HorzLineWidth,
          ViewInfo.BandBorderColor);
        ARowHeaderInfo.LinesInfo.Add(IndentBounds.Right, IndentBounds.Bottom,
          HeaderRect.Right - IndentBounds.Right, ViewInfo.HorzLineWidth,
          ViewInfo.BandBorderColor);
      end;
    end;
...
procedure TcxvgSkinCalcHelper.AddHeaderIndentLines(ARowHeaderInfo
  : TcxCustomRowHeaderInfo; const R: TRect; const AViewParams: TcxViewParams;
  AToCategories, AUnderline, AAddVertLine: Boolean);
begin
...
function TcxvgSkinCalcHelper.IsBottomLineNeeded(ANextRow: TcxCustomRow)
  : Boolean;
begin
...
function TcxCustomRowProperties.GetStoredProperties
  (AProperties: TStrings): Boolean;
begin
  Result := False;
end;

procedure TcxCustomRowProperties.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
  // do nothing
end;

procedure TcxCustomRowProperties.SetPropertyValue(const AName: string;
...
function TcxvgController.QueryInterface(const IID: TGUID; out Obj): HResult;
begin
...
procedure TcxvgController.KeyDown(var Key: Word; Shift: TShiftState);
var
  ...
  begin
    ...
    begin
      ...
      else if AIndex < Properties.Editors.Count - 1 then
        repeat
          Inc(AIndex);
          with Properties.Editors[AIndex].EditContainer do
            if CanFocus and CanTabStop then
  ...
  begin
    Result := VerticalGrid.OptionsView.ShowButtons and (FocusedRow <> nil) and
      FocusedRow.Options.ShowExpandButton and (FocusedRow.Count > 0) and
      not IsEditing;
  end;
...
begin
  ...
  if ((Key = VK_LEFT) or (Key = VK_RIGHT)) and not CanProcessProcessMultiEditorRow
  then
  begin
  ...
  case Key of
    ...
    VK_RETURN, VK_TAB:
      ...
      begin
        ...
        if ARemoveFocus and VerticalGrid.IsFocused then
          PostMessage(GetParentForm(VerticalGrid).Handle, WM_NEXTDLGCTL,
    ...
    VK_DELETE:
      if CanHandleDeleteRecordKeys and ((Shift = []) or (Shift = [ssCtrl])) and
        CanDelete(True) then
      begin
        DeleteSelection;
        Key := 0;
...
begin
  if IsLocked or (FFocusedRow = nil) then
    Exit;
...
procedure TcxvgController.MouseDown(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
  ...
  begin
    with HitTest do
      Result := ARow.Options.ShowExpandButton and
        (HitAtButton or (IsDblClick and HitAtCaption and
        ARow.HasVisibleChildren));
  end;
  ...
  begin
    with HitTest do
      Result := (ARow <> nil) and ARow.CanFocus and
        (not IsItemEditCell or not TcxRowValueInfo(EditCellViewInfo)
        .EditContainer.CanFocus);
  end;
...
procedure TcxvgController.Scroll(AScrollBarKind: TScrollBarKind;
...
function TcxvgController.CanSizing(ADirection: TcxDragSizingDirection): Boolean;
begin
  HitTest.Recalculate(GetMouseCursorPos);
  Result := HitTest.CanSizing(ADirection);
end;

function TcxvgController.GetSizingBoundsRect(ADirection
...
function TcxvgController.GetSizingIncrement(ADirection
...
procedure TcxvgController.SetSizeDelta(ADirection: TcxDragSizingDirection;
  ADelta: Integer);
const
  ASign: array [Boolean] of Integer = (-1, 1);
begin
  Inc(FSizingValue, ASign[(ResizeKind = rkRowSizing) or
    not ViewInfo.IsRightToLeftConverted] * ADelta);
  case ResizeKind of
    rkRowSizing:
...
begin
  ...
  if (not Assigned(VerticalGrid.OnDragOver) or Accept) and
    IsInternalDragging(Source) then
    with HitTest do
    begin
      HitPoint := cxPoint(X, Y);
      Accept := HitAtEmpty or HitAtRowHeader and (DragRow <> HitRow) and
        not DragRow.IsParent(HitRow);
    end;
end;
...
begin
  Result := FTrackingEnabled and (ssLeft in AShift) and
    (VerticalGrid.DragAndDropState = ddsNone) and not VerticalGrid.Dragging and
    not VerticalGrid.IsLocked;
end;
  ...
  begin
    ...
    for I := 0 to ViewInfo.RowsViewInfo.Count - 1 do
      with ViewInfo.RowsViewInfo[I] do
        if cxRectPtIn(RowRect, X, Y) or
          ((Y >= RowRect.Top) and (Y < RowRect.Bottom)) and Row.CanFocus then
        begin
          StopScrollTimer;
...
procedure TcxvgController.ControlFocusChanged;
  ...
  begin
    Result := (VerticalGrid.ActivateType = atByMouse) and
      (HitTest.HitRow <> nil);
  end;
...
procedure TcxvgController.DoMouseDown(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
var
  ATopRow: Integer;
  P: TPoint;
begin
  ...
  begin
    ...
    FTrackingEnabled := (Button = mbLeft) and (DragMode <> dmAutomatic) and
      ...
      not HitAtButton and OptionsBehavior.RowTracking and (GetCapture = Handle)
      and not(IsItemEditCell and EditCellViewInfo.EditViewInfo.IsHotTrack(P));
    if CanMoving and not FTrackingEnabled then
      FDragRow := HitRow;
  end;
end;

procedure TcxvgController.DoMouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
  StopScrollTimer;
  FTrackingEnabled := False;
...
procedure TcxvgController.DoNextPage(AForward: Boolean; Shift: TShiftState);
const
...
begin
  ...
  else if FCellIndex <> ANewCellIndex then
  begin
...
procedure TcxvgController.FocusedItemChanged(APrevFocusedItem
...
function TcxvgController.GetFocusedCellViewInfo(AEditContainer
...
begin
  if ResizeKind = rkRowSizing then
    Result := dsdVert
  else
    Result := dsdHorz;
end;
...
begin
  Result := inherited IsKeyForController(AKey, AShift) or
    (IsEditing and (ssCtrl in AShift) and (AKey in [VK_MULTIPLY, VK_ADD,
    VK_SUBTRACT]));
end;
...
procedure TcxvgController.SetFocusedRowAndCell(Value: TcxCustomRow;
  ACellIndex: Integer);
...
begin
  if VerticalGrid.IsDesigning or Assigned(Value) and not Value.CanFocus then
    Exit;
  CorrectCellIndex;
  if (FCellIndex = ACellIndex) and (FFocusedRow = Value) then
    Exit;
  Inc(FLockUpdate);
  try
    if Value <> nil then
...
begin
  if not DragFromCustomizingForm and HitTest.HitAtCustomize and DragRow.Options.CanMovedToCustomizationForm
  then
  begin
    with VerticalGrid do
    begin
...
procedure TcxvgController.SetResizeKind(Value: TcxvgResizeKind);
begin
  FResizeKind := Value;
  case Value of
    rkDivider:
...
begin
  Result := (dceoDelete in DataController.EditOperations) and
    (not ACheckOptions or OptionsData.Deleting) and
    (DataController.RowCount > 0);
end;
...
begin
  if IsIncSearching then
  begin
    ACellEdit := VerticalGrid.ContainerList.List
      [DataController.Search.ItemIndex];
    FLockIncSearch := True;
    try
...
procedure TcxvgMultiRecordsController.SetFocusedRecordIndex
  (Value: TdxNativeInt);
var
...
function TcxvgMultiRecordsController.GetOptionsBehavior
  : TcxvgMultiRecordsOptionsBehavior;
begin
  Result := VerticalGrid.OptionsBehavior;
end;

function TcxvgMultiRecordsController.GetOptionsData
  : TcxvgMultiRecordsOptionsData;
begin
...
procedure TcxRowValueInfo.CalculateCellEditorBounds
...
begin
  ...
  FFocusRect := TdxRightToLeftLayoutConverter.ConvertRect(FFocusRect,
    AClientBounds);
end;
...
procedure TcxRowValueInfo.GetFindTextInfo(out AStart: Integer;
  out ALength: Integer);
var
  AText: string;
begin
  AStart := VerticalGrid.DataController.FindCriteria.
    GetTextStartPositionByRowIndex(RecordIndex, EditContainer.ItemIndex, AText);
...
begin
  Result := (AIndex >= 0) and (AIndex < EditContainer.DataController.RowCount)
    and not EditContainer.DataController.IsDataLoading;
end;
...
function TcxRowValueInfo.GetConditionalFormattingProvider
  : TcxVerticalGridConditionalFormattingProvider;
begin
...
procedure TcxCustomEditorRowProperties.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
...
procedure TcxCustomEditorRowProperties.SetPropertyValue(const AName: string;
  const AValue: Variant);
begin
  if AName = 'Expression' then
...
function TcxCustomEditorRowProperties.GetStoredProperties
  (AProperties: TStrings): Boolean;
begin
...
function TcxCustomEditorRowProperties.GetInplaceEditContainerClass
  : TcxCellEditClass;
begin
  Result := TcxCellEdit;
end;
...
function TcxCustomEditorRowProperties.
...
function TcxCustomEditorRowProperties.GetDisplayEditProperty(Index: Integer)
...
begin
  ...
  AEditContainerDisplayValue := EditContainer.GetDisplayValue
    (ADisplayEditProperties, Index);
  ADisplayText := DisplayEditProperties[Index].GetDisplayText
    (AEditContainerDisplayValue, AFullText);
...
function TcxCustomEditorRowProperties.GetEditProperties
  : TcxCustomEditProperties;
begin
  Result := FEditContainer.Properties;
end;

function TcxCustomEditorRowProperties.GetEditPropertiesClass
...
function TcxCustomEditorRowProperties.GetFilteringDateRanges
  : TdxFilteringDateRanges;
begin
  Result := EditContainer.FilteringDateRanges;
end;

function TcxCustomEditorRowProperties.GetIEditorPropertiesContainer
  : IcxEditorPropertiesContainer;
begin
...
function TcxCustomEditorRowProperties.GetPropertiesValue
  : TcxCustomEditProperties;
begin
...
function TcxCustomEditorRowProperties.GetVisibleForExpressionEditor
  : TdxDefaultBoolean;
begin
...
begin
  ...
  begin
    ...
    if dceEdit in EditState then
      ...
      Values[FilteredRecordIndex[FocusedRowIndex],
        FEditContainer.ItemIndex] := Value;
  end;
end;

procedure TcxCustomEditorRowProperties.SetVisibleForExpressionEditor
  (AValue: TdxDefaultBoolean);
begin
  EditContainer.VisibleForExpressionEditor := AValue;
end;

function TcxCustomEditorRowProperties.GetOnGetEditingProperties
  : TcxVerticalGridGetEditPropertiesEvent;
begin
  Result := TcxVerticalGridGetEditPropertiesEvent
    (EditContainer.OnGetEditingProperties);
end;

function TcxCustomEditorRowProperties.GetOnGetEditProperties
  : TcxVerticalGridGetEditPropertiesEvent;
begin
  Result := TcxVerticalGridGetEditPropertiesEvent
    (EditContainer.OnGetEditProperties);
end;

function TcxCustomEditorRowProperties.GetOnGetFilterValues
  : TcxGetFilterValuesEvent;
begin
  Result := EditContainer.OnGetFilterValues;
end;

function TcxCustomEditorRowProperties.GetOnInitFilteringDateRanges
  : TdxInitDateRangesEvent;
begin
...
function TcxCustomEditorRowProperties.GetOnUserFilteringEx
  : TcxUserFilteringExEvent;
begin
...
procedure TcxCustomEditorRowProperties.SetOnGetFilterValues
  (Value: TcxGetFilterValuesEvent);
begin
  EditContainer.OnGetFilterValues := Value;
end;

procedure TcxCustomEditorRowProperties.SetOnInitFilteringDateRanges
  (Value: TdxInitDateRangesEvent);
begin
  EditContainer.OnInitFilteringDateRanges := Value;
end;

procedure TcxCustomEditorRowProperties.SetOnUserFiltering
  (Value: TcxUserFilteringEvent);
begin
  EditContainer.OnUserFiltering := Value;
end;

procedure TcxCustomEditorRowProperties.SetOnUserFilteringEx
  (Value: TcxUserFilteringExEvent);
begin
...
begin
  ...
  Result := Max(inherited GetDefaultHeight,
    EditContainer.GetEditDefaultHeight(AFont) + cxTextOffset);
end;
...
function TcxvgOptionsView.GetRowHeaderFilterButtonShowMode
  ...
  begin
    ...
    if Value then
      if VerticalGrid.Controller <> nil then
        VerticalGrid.Controller.Scroller.ScrollStrategy.
          SetTopVisibleRowIndex(0);
    Changed;
  end;
end;
...
procedure TcxvgOptionsView.SetRowHeaderFilterButtonShowMode
...
procedure TcxvgOptionsView.SetShowRowHeaderFilterButtons
...
function TcxvgScroller.GetBandIndexByRowIndex(ARowIndex: Integer): Integer;
begin
...
procedure TcxvgScroller.SetLeftVisibleRecordAndOffset(ATopRecordIndex,
  ATopRecordOffset: Integer; AAnimated: Boolean);
begin
  ScrollStrategy.SetLeftVisibleRecordAndOffset(ATopRecordIndex,
    ATopRecordOffset, AAnimated);
end;
...
begin
  if (ARow = nil) or (ARow.VisibleIndex < 0) then
    Exit;
...
begin
  ...
  if AIndex < TopVisibleRowIndex then
    ATopIndex := AIndex
  else if TopVisibleRowIndex + VisibleRowCount <= AIndex then
  begin
...
function TcxvgScroller.CreateScrollStrategy(AScroller: TcxvgScroller)
  : TcxvgCustomScrollStrategy;
begin
...
begin
  if not FCheckDecreaseTopIndex or (TopVisibleRowIndex = 0) then
    Exit;
  FScrollStrategy.CheckDecreaseTopIndex(ViewInfo.ClientRect.Bottom -
    ViewInfo.ClientRect.Top);
...
function TcxvgScroller.GetVisibleCountFromBottom(ARowIndex: Integer): Integer;
begin
  Result := FScrollStrategy.GetVisibleCountFromBottom(ARowIndex,
    cxRectHeight(ViewInfo.ClientRect));
end;
...
procedure TcxvgScroller.SetLeftVisibleRecord(Value: Integer);
begin
...
procedure TcxVerticalGridRows.AssignRows(Source: TcxVerticalGridRows);
  ...
  begin
    AddedRow := Owner.AddChild(AParent,
      TcxCustomRowClass(ASourceRow.ClassType));
...
begin
  ...
  if ARow.Visible then
    repeat
      ...
      else if not(ARow.Expanded and ARow.Visible) then
        Exit;
    until False;
end;
...
procedure TcxVerticalGridRows.AddChild(AParent, ARow: TcxCustomRow);
begin
...
function TcxVerticalGridRows.FindRowByStoredName(const AName: string)
  : TcxCustomRow;
var
  I: Integer;
begin
...
procedure TcxVerticalGridRows.SetRow(Index: Integer; const Value: TcxCustomRow);
begin
  if (Index < 0) or (Index >= Count) then // call Count -> refresh if need
    cxVerticalGridError(cxSvgIndexError);
  FList[Index] := Value;
...
function TcxvgDragRowObject.GetDragCursor(Accepted: Boolean;
  X, Y: Integer): TCursor;
begin
...
function TcxStyle3DPainter.GetExpandButtonState
  (ARowHeader: TcxCustomRowHeaderInfo): TcxExpandButtonState;
begin
  Result := cebsNormal;
end;
...
function TcxvgCustomRowStyles.GetHeaderParams(ARow: TcxCustomRow)
  : TcxViewParams;
begin
...
procedure TcxCategoryRowStyles.GetDefaultViewParams(Index: Integer;
...
function TcxEditorRowStyles.GetContentParams(AEditorRowProperties
  : TcxCustomEditorRowProperties; AFocused: Boolean; ARecordIndex: Integer)
  : TcxViewParams;
var
  ...
  case Index of
    vgrs_Content:
      AParams := VerticalGrid.Styles.GetContentParams
        (AContentInfo.EditorRowProperties, AContentInfo.Focused,
        AContentInfo.Index);
    vgrs_Header:
...
procedure TcxVerticalGridStyleSheet.SetStylesValue
  (Value: TcxVerticalGridStyles);
begin
  SetStyles(Value);
end;
...
procedure TcxVerticalGridStyles.SetUseOddEvenStyles(const AValue
  : TdxDefaultBoolean);
begin
...
function TcxVerticalGridStyles.GetCategoryParams(ARow: TcxCustomRow)
  : TcxViewParams;
var
  AStyle: TcxStyle;
begin
...
function TcxVerticalGridStyles.GetContentParams(AEditorRowProperties
  : TcxCustomEditorRowProperties; AFocused: Boolean; ARecordIndex: Integer)
  : TcxViewParams;
const
...
begin
  ...
  begin
    if Assigned(FOnGetContentStyle) then
      FOnGetContentStyle(Control, AEditorRowProperties, AFocused,
        ARecordIndex, AStyle);
    AData.Index := VerticalGrid.GetRowContentStyleIndex(AEditorRowProperties,
      ARecordIndex);
  end
  else
    AData.Index := ARecordIndex;
  AStyleIndex := StyleIndexes[Odd(AData.Index)];
  // otherwise: [Fatal Error] cxVGrid.pas(12420): Internal error: C1475
  ...
  if Assigned(AEditorRowProperties) then
    VerticalGrid.ConditionalFormattingProvider.CalculateViewParams(Result,
      ARecordIndex, AEditorRowProperties.ItemIndex);
end;

function TcxVerticalGridStyles.GetHeaderParams(ARow: TcxCustomRow)
  : TcxViewParams;
var
  AStyle: TcxStyle;
begin
...
function TcxVerticalGridStyles.GetSelectedHeaderParams(ARow: TcxCustomRow;
  AFocused: Boolean): TcxViewParams;
const
...
function TcxVerticalGridStyles.GetSelectedHeaderParams(ARow: TcxCustomRow)
  : TcxViewParams;
begin
  Result := GetSelectedHeaderParams(ARow, VerticalGrid.Controller.Focused or
    VerticalGrid.IsFocused);
end;
...
procedure TcxVerticalGridStyles.GetDefaultViewParams(Index: Integer;
  AData: TObject; out AParams: TcxViewParams);
const
  ContentIndexMap: array [Boolean] of Integer = (vgs_ContentEven,
    vgs_ContentOdd);
var
  AContentInfo: PcxvgContentParamsData absolute AData;
begin
  ...
  with AParams do
  begin
    if not ActuallyUseOddEvenStyles and
      ((Index = vgs_ContentEven) or (Index = vgs_ContentOdd)) then
      Index := vgs_Content;
    case Index of
      ecs_Background:
        Color := CalcHelper.GetBackgroundColor;
      vgs_Content:
        if (AContentInfo <> nil) and (AContentInfo.EditorRowProperties <> nil)
          and ActuallyUseOddEvenStyles then
          GetDefaultViewParams(ContentIndexMap[Odd(AContentInfo.Index)],
            AData, AParams)
        else
        begin
          TextColor := CalcHelper.GetContentTextColor;
          Color := CalcHelper.GetContentColor((AContentInfo <> nil) and
...
begin
  with ViewInfo do
    if HorzLineWidth > 0 then
      Self.LinesInfo.Add(R.Left, R.Bottom, R.Right - R.Left, HorzLineWidth,
        HorzLineBrush);
end;
...
procedure TcxCustomRowHeaderInfo.Calc(const AHeaderRect: TRect;
  AViewInfo: TcxvgCustomViewInfo; ANextRow: TcxCustomRow; ACalcBounds: Boolean);
begin
  FViewInfo := AViewInfo;
  Clear;
  FTransparent := False;
...
function TcxCustomRowHeaderInfo.CalcCaptionInfo(ARowProperties
  : TcxCaptionRowProperties; const R: TRect): TcxRowCaptionInfo;
begin
...
begin
  ...
  begin
    ...
    Result.Add(cxSize(ViewInfo.RowIndentWidth, cxRectHeight(HeaderRect)),
      AIsCategory, AUnderline, ViewInfo.CalcHelper.GetIndentViewParams(Row,
      ACurRow));
        ...
        begin
          ...
          begin
            ...
            if not cxRectIsEmpty(R) then
              AddNextIndentInfo(R, AIndents[ALevelCount - J].ViewParams, False,
                ANextLevel - I <= 0, True);
            Inc(ABoundsWidth, W);
          end;
          ...
          if not cxRectIsEmpty(R) then
            AddNextIndentInfo(cxRectBounds(HeaderRect.Left + ABoundsWidth,
              HeaderRect.Top, Size.cx + W, Size.cy), ViewParams, True,
              Underline, I < ALevelCount);
          Inc(ABoundsWidth, cxSetValue(I < ALevelCount, W,
            cxSetValue(IncreaseBoundsByLastVertLine, W, 0)));
          R := cxRectBounds(HeaderRect.Left + ABoundsWidth + Size.cx,
            HeaderRect.Top, 0, AHeight);
        end
        else
        begin
          Inc(R.Right, Size.cx);
...
begin
  ACaptionInfo := CalcCaptionInfo(TcxCaptionRowProperties(Row.FProperties),
    HeaderCellsRect);
...
begin
  ...
  AButtonPlace := cxRect(IndentBounds.Right - AWidth, IndentBounds.Top,
    IndentBounds.Right, IndentBounds.Bottom);
  FButtonRect := cxRectCenter(AButtonPlace, ViewInfo.ButtonSize,
    ViewInfo.ButtonSize);
  FButtonAreaBounds := cxRectCenter(AButtonPlace, ViewInfo.ButtonAreaSize,
    ViewInfo.ButtonAreaSize);
end;

procedure TcxCustomRowHeaderInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  FCaptionsInfo.RightToLeftConversion(AClientBounds);
  FButtonAreaBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (FButtonAreaBounds, AClientBounds);
  FButtonRect := TdxRightToLeftLayoutConverter.ConvertRect(FButtonRect,
    AClientBounds);
  FFocusRect := TdxRightToLeftLayoutConverter.ConvertRect(FFocusRect,
    AClientBounds);
  FHeaderCellsRect := TdxRightToLeftLayoutConverter.ConvertRect
    (FHeaderCellsRect, AClientBounds);
  FHeaderRect := TdxRightToLeftLayoutConverter.ConvertRect(FHeaderRect,
    AClientBounds);
  FIndentBounds := TdxRightToLeftLayoutConverter.ConvertRect(FIndentBounds,
    AClientBounds);
...
var
  I: Integer;
begin
  FIndentViewParams := VerticalGrid.Styles.GetSelectedHeaderParams(Row,
    AFocused);
...
procedure TcxCustomRowHeaderInfo.Recalculate(ANextRow: TcxCustomRow;
  ACalcBounds: Boolean);
begin
  Calc(HeaderRect, VerticalGrid.ViewInfo, ANextRow, ACalcBounds);
end;

procedure TcxCustomRowHeaderInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
...
begin
  ...
  begin
    ARowRect := TdxRightToLeftLayoutConverter.ConvertRect(RowRect,
      RightToLeftConversionClientBounds);
...
begin
  ...
  begin
    FValuesRect := TdxRightToLeftLayoutConverter.ConvertRect(FValuesRect,
      RightToLeftConversionClientBounds);
    FRowRect := TdxRightToLeftLayoutConverter.ConvertRect(FRowRect,
      RightToLeftConversionClientBounds);
    CalcValuesInfo;
    DoSpecialRightToLeftConversion;
  end;
...
function TcxCustomRowViewInfo.AddValueInfo(ARecordIndex, ACellIndex: Integer)
  : TcxRowValueInfo;
begin
...
begin
  ...
  CalculatedHeight := Max(CalculatedHeight, GetValuesHeight(ABandWidth,
    ViewInfo));
end;
...
function TcxCustomRowViewInfo.GetRowValueInfo(ARecordIndex, ACellIndex: Integer)
  : TcxRowValueInfo;
var
  I: Integer;
...
begin
  Result := nil;
  if (ValuesInfo = nil) or
    ((ARecordIndex < 0) and not TcxvgMultiRecordsOptionsData.
    AddRecordOnEditIfEmpty) then
    Exit;
  for I := 0 to ValuesInfo.Count - 1 do
  begin
...
procedure TcxCustomRowViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  FRowRect := TdxRightToLeftLayoutConverter.ConvertRect(FRowRect,
    AClientBounds);
...
procedure TcxCustomRowViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
  if not FIsRightToLeftConverted then
  begin
...
begin
  inherited Create(AOwner);
  FConditionalFormattingProvider :=
    TcxVerticalGridConditionalFormattingProvider.Create(Self);
...
function TcxCustomVerticalGrid.IsInternalDragging(ADragObject: TObject)
  : Boolean;
begin
...
function TcxCustomVerticalGrid.NextVisibleRow(ARow: TcxCustomRow): TcxCustomRow;
var
  I, AIndex: Integer;
begin
  Rows.CheckList;
...
function TcxCustomVerticalGrid.RowByCaption(const ACaption: string)
  : TcxCustomRow;
...
procedure TcxCustomVerticalGrid.ShowEditByMouse(X, Y: Integer;
  AShift: TShiftState);
begin
  if not OptionsData.Editing then
    Exit;
...
begin
  ...
  else if AName = 'HeaderWidth' then
    AValue := OptionsView.RowHeaderWidth
  else if AName = 'ValueWidth' then
    AValue := OptionsView.ValueWidth
  else if AName = 'NewLoad' then
    AValue := 1
  else
    AValue := Null;
end;
...
function TcxCustomVerticalGrid.CreateChild(const AObjectName,
...
begin
  ...
  begin
    ...
    ARow.Name := CreateUniqueName(Owner, Self, ARow, 'Tcx',
      'RuntimeCreatedRow');
    Result := ARow;
  end
  else
...
function TcxCustomVerticalGrid.GetConditionalFormattingProvider
  : TcxDataControllerConditionalFormattingProvider;
begin
...
procedure TcxCustomVerticalGrid.GetChildren(Proc: TGetChildProc;
  Root: TComponent);
var
  I: Integer;
begin
...
procedure TcxCustomVerticalGrid.Notification(AComponent: TComponent;
...
function cxVerticalGridGetItem(ACaller: TComponent; Index: Integer): TComponent;
begin
...
begin
  ...
  begin
    RenameComponents(Self, Owner, Name, AOldName, Rows.Count,
      @cxVerticalGridGetItem);
...
procedure TcxCustomVerticalGrid.ChangeScaleEx(M, D: Integer;
  isDpiChange: Boolean);
var
  I: Integer;
begin
...
function TcxCustomVerticalGrid.CreateExpressionProvider
...
begin
  ...
  RefreshScrollbarAnnotations(dxAllCustomScrollbarAnnotationKinds +
    [dxSearchResultScrollbarAnnotationID, dxErrorScrollbarAnnotationID]);
end;
...
procedure TcxCustomVerticalGrid.DoEdited(AItem: TcxCustomInplaceEditContainer);
begin
...
function TcxCustomVerticalGrid.GetControllerClass
  : TcxCustomControlControllerClass;
begin
  Result := TcxvgController;
end;

function TcxCustomVerticalGrid.GetControlStylesClass
  : TcxCustomControlStylesClass;
begin
  Result := TcxVerticalGridStyles;
end;

function TcxCustomVerticalGrid.GetDateTimeHandlingClass
...
function TcxCustomVerticalGrid.GetEditCellDataBindingClass
  : TcxItemDataBindingClass;
begin
  Result := TcxItemDataBinding;
end;

function TcxCustomVerticalGrid.GetFilterValueListClass
  : TcxControlFilterValueListClass;
begin
  Result := TcxVerticalGridFilterValueList;
end;

function TcxCustomVerticalGrid.GetHitTestControllerClass
  : TcxHitTestControllerClass;
begin
  Result := TcxvgHitTest;
end;

function TcxCustomVerticalGrid.GetOptionsBehaviorClass
  : TcxControlOptionsBehaviorClass;
begin
  Result := TcxvgOptionsBehavior;
end;

function TcxCustomVerticalGrid.GetOptionsFilterBoxClass
  : TcxControlOptionsFilterBoxClass;
begin
  Result := TcxVerticalGridFilterBox;
end;

function TcxCustomVerticalGrid.GetOptionsFilteringClass
...
function TcxCustomVerticalGrid.NeedCallChangedOnItemRemoved
  (AItem: TcxCustomInplaceEditContainer): Boolean;
begin
...
begin
  Result := ((DragAndDropState = ddsNone) or ((DragMode <> dmAutomatic) or
    not HitTest.HitAtValue));
  if Result then
    Result := DataController.StartEdit(AItemIndex,
      Safe<TcxvgMultiRecordsOptionsData>.Cast(OptionsData));
end;
...
begin
  if (ARowClass = nil) or not(ARowClass.InheritsFrom(GetEditorRowClass) or
    ARowClass.InheritsFrom(TcxCategoryRow) or
    ARowClass.InheritsFrom(GetMultiEditorRowClass)) then
...
begin
  ...
  if Assigned(FOnDrawBackground) then
    FOnDrawBackground(Self, TcxvgPainter(Painter).Canvas, R,
      AViewParams, Result);
end;

function TcxCustomVerticalGrid.DoDrawRowHeader(AHeaderViewInfo
  : TcxCustomRowHeaderInfo): Boolean;
begin
  Result := False;
...
function TcxCustomVerticalGrid.DoDrawValue(AValueInfo: TcxRowValueInfo)
  : Boolean;
begin
  Result := False;
...
function TcxCustomVerticalGrid.GetCalcHelperClass
  : TcxvgCustomPaintStyleCalcHelperClass;
begin
  if LookAndFeel.SkinPainter <> nil then
    Result := TcxvgSkinCalcHelper
  else if OptionsView.PaintStyle = psdotNet then
...
function TcxCustomVerticalGrid.GetCustomizingClass
  : TcxVerticalGridCustomizingClass;
begin
...
function TcxCustomVerticalGrid.GetConditionalFormatting
...
function TcxCustomVerticalGrid.GetDateTimeHandling
  : TcxVerticalGridDateTimeHandling;
begin
...
procedure TcxCustomVerticalGrid.SetDateTimeHandling
  (AValue: TcxVerticalGridDateTimeHandling);
begin
...
function TcxUnboundVerticalGrid.GetScrollStrategyClass
  : TcxvgCustomScrollStrategyClass;
begin
...
procedure TcxVerticalGridScrollbarAnnotationOptionsHelper.SetValue
...
function TcxVerticalGridScrollbarAnnotationOptions.CreateHelper
  : TcxControlScrollbarAnnotationOptionsHelper;
begin
  Result := TcxVerticalGridScrollbarAnnotationOptionsHelper.Create
...
function TcxVirtualVerticalGrid.GoToNextScrollbarAnnotation
  (AKinds: TdxScrollbarAnnotationKinds = dxAllScrollbarAnnotationKinds;
  AGoForward: Boolean = True; AGoOnCycle: Boolean = False): Boolean;
begin
...
function TcxVirtualVerticalGrid.NavigatorGetNotifier
...
function TcxVirtualVerticalGrid.CreateScrollbarAnnotations
  : TcxControlScrollbarAnnotationOptions;
begin
...
begin
  Result := OptionsBehavior.BandSizing and
    ((FLayoutStyle = lsMultiRecordView) or ((FLayoutStyle = lsBandsView) and
    not OptionsView.AutoScaleBands));
end;
...
procedure TcxVirtualVerticalGrid.DoFocusedRecordChanged(APrevFocusedRecord,
...
function TcxVirtualVerticalGrid.GetControllerClass
  : TcxCustomControlControllerClass;
begin
...
function TcxVirtualVerticalGrid.GetOptionsBehaviorClass
  : TcxControlOptionsBehaviorClass;
begin
...
function TcxVirtualVerticalGrid.GetRowContentStyleIndex
  (AProperties: TcxCustomEditorRowProperties; ARecordIndex: Integer): Integer;
begin
...
function TcxVirtualVerticalGrid.IsRecordHasErrors(ARecordIndex
  : Integer): Boolean;
var
  I: Integer;
begin
  ...
  for I := 0 to ContainerCount - 1 do
    if TcxCellEdit(Containers[I]).Row.Visible and TcxCellEdit(Containers[I])
      .HasErrors(ARecordIndex) then
    begin
      Result := True;
      Break;
    end;
...
function TcxVirtualVerticalGrid.IsScrollBarBasedGestureScroll
...
procedure TcxVirtualVerticalGrid.ScrollContentByGesture
  (AScrollKind: TScrollBarKind; ADelta: Integer);
begin
  ViewInfo.Scroller.ScrollStrategy.ScrollContentByGesture(AScrollKind, ADelta);
end;

function TcxVirtualVerticalGrid.
  CanScrollContentByGestureWithoutScrollBars: Boolean;
begin
...
function TcxVirtualVerticalGrid.IsScrollbarAnnotationVisible
...
function TcxVirtualVerticalGrid.GetScrollStrategyClass
  : TcxvgCustomScrollStrategyClass;
begin
...
function TcxVirtualVerticalGrid.GetOnFindCriteriaBeforeChange
  : TcxDataFindCriteriaBeforeChangeEvent;
begin
  Result := DataController.OnFindCriteriaBeforeChange;
end;

function TcxVirtualVerticalGrid.GetOnFindCriteriaChanged
...
function TcxVirtualVerticalGrid.GetOptionsBehavior
  : TcxvgMultiRecordsOptionsBehavior;
begin
...
function TcxVirtualVerticalGrid.GetScrollbarAnnotations
  : TcxVerticalGridScrollbarAnnotationOptions;
begin
  Result := TcxVerticalGridScrollbarAnnotationOptions
...
procedure TcxVirtualVerticalGrid.LookAndFeelChanged(Sender: TcxLookAndFeel;
  AChangedValues: TcxLookAndFeelValues);
begin
  InvalidateScrollbarAnnotations;
  inherited LookAndFeelChanged(Sender, AChangedValues);
...
procedure TcxVirtualVerticalGrid.PopulateScrollbarAnnotations
...
procedure TcxVirtualVerticalGrid.RefreshScrollbarAnnotations
...
procedure TcxVirtualVerticalGrid.SetCurrentScrollbarAnnotationRecordIndex
  (AIndex: Integer);
begin
...
procedure TcxVirtualVerticalGrid.SetOnFindCriteriaBeforeChange
  (Value: TcxDataFindCriteriaBeforeChangeEvent);
begin
  DataController.OnFindCriteriaBeforeChange := Value;
end;

procedure TcxVirtualVerticalGrid.SetOnFindCriteriaChanged
...
procedure TcxVirtualVerticalGrid.SetScrollbarAnnotations
  (Value: TcxVerticalGridScrollbarAnnotationOptions);
begin
...
function TcxVerticalGridItemsCustomizeListBox.DrawItem(ACanvas: TcxCanvas;
  AIndex: Integer; const ARect: TRect; AState: TOwnerDrawState): Boolean;

  procedure InternalDrawItem(ACanvas: TcxCanvas; AIndex: Integer;
    const ARect: TRect);
  var
    AHeaderInfo: TcxCustomRowHeaderInfo;
...
begin
  ...
  R := cxRectOffset(ItemRect(FDragAndDropItemIndex), -FMouseDownPos.X,
    -FMouseDownPos.Y);
  AIsRightToLeftConverted := AHeaderInfo.IsRightToLeftConverted;
...
procedure TcxVerticalGridItemsCustomizeListBox.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  AItem: Integer;
  R: TRect;
...
procedure TcxVerticalGridItemsCustomizeListBox.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
  inherited MouseMove(Shift, X, Y);
  if (FDragAndDropItemIndex <> -1) and not IsPointInDragDetectArea
    (FMouseDownPos, X, Y) then
  begin
...
procedure TcxVerticalGridItemsCustomizeListBox.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TcxVerticalGridItemsCustomizeListBox.RefreshList;
  ...
  begin
    if (ARow.IsCategory = AIsCategory) and not ARow.Visible and ARow.Options.ShowInCustomizationForm
    then
...
procedure TcxVerticalGridItemsCustomizeListBox.ScaleFactorChangeHandler
  (Sender: TObject; M, D: Integer; IsLoading: Boolean);
begin
  PostMessage(Handle, DXM_RECALCULATE, 0, 0);
end;

procedure TcxVerticalGridItemsCustomizeListBox.DXMRecalculate
...
function TcxVerticalGridCustomizationForm.GetVerticalGrid
  : TcxCustomVerticalGrid;
begin
...
begin
  if IsIconic(Application.Handle) then
    Visible := False
  else if not IsControlVisible(VerticalGrid) then
...
begin
  if Visible and ((FTabSheetCategories <> nil) and
    (FCategoryListBox.Parent = FTabSheetCategories)) then
...
function TcxVerticalGridCustomizing.CanDrop(const P: TPoint): Boolean;
  ...
  function CheckListBox(AListBox: TcxVerticalGridItemsCustomizeListBox)
    : Boolean;
  begin
...
begin
  ...
  begin
    ...
    try
      ...
      ARow.Name := CreateUniqueName(VerticalGrid.Owner, VerticalGrid, ARow,
        'Tcx', 'RuntimeCreatedRow');
    finally
      Modified;
      VerticalGrid.EndUpdate;
    end;
...
begin
  FRowListBox := TcxVerticalGridItemsCustomizeListBox.CreateEx(FForm,
    VerticalGrid, False);
  ...
  begin
    FCategoryListBox := TcxVerticalGridItemsCustomizeListBox.CreateEx(FForm,
      VerticalGrid, True);
    FCategoryListBox.OnClick := UpdateButtons;
    FTabSheetCategories := TcxTabSheet.Create(FPageControl);
    FTabSheetCategories.Caption :=
      cxGetResourceString(@cxSvgCustomizeCategoriesCaption);
...
begin
  ...
  if AParentForm.FormStyle = fsStayOnTop then
    SetWindowPos(FForm.Handle, Application.Handle, 0, 0, 0, 0,
...
procedure TcxVerticalGridCustomizing.SetControlParent(AControl,
  AParent: TWinControl);
begin
...
begin
  ...
  begin
    ...
    try
      ...
      FMultiRecordEvenOddContentStyle := TcxvgMultiRecordsOptionsView(Source)
        .MultiRecordEvenOddContentStyle;
      inherited Assign(Source);
    finally
...
constructor TcxRowCaptionInfo.Create(AHeaderInfo: TcxCustomRowHeaderInfo;
  ARowProperties: TcxCaptionRowProperties);
begin
  inherited Create;
  FState := cxbsNormal;
...
function TcxRowCaptionInfo.QueryInterface(const IID: TGUID; out Obj): HResult;
begin
  if GetInterface(IID, Obj) then
    Result := 0
  else
...
begin
  ...
  begin
    AText := Caption;
    ASize := ACanvas.TextExtent(AText);
    cxRectIntersect(ATextRect, CaptionTextRect,
      Row.ViewInfo.HeaderInfo.HeaderRect);
    cxRectIntersect(AVisibleCaptionBounds, ATextRect,
      VerticalGrid.ClientBounds);
    IsNeedOffsetHint := False;
    Result := (cxRectWidth(AVisibleCaptionBounds) < ASize.cx - 1) or
      (cxRectHeight(AVisibleCaptionBounds) < ASize.cy - 1);
  end;
  AIsMultiLine := False;
end;
...
begin
  ...
  TdxVisualRefinements.HeaderPadding.InflatePadding(AEditTextOffset,
    ScaleFactor);
...
begin
  if IsFilterButtonVisible then
  begin
    Result := cxRectInflate(CaptionRect,
      -cxVerticalGridHeaderCellFilterButtonIndent);
...
begin
  FCaptionRect := TdxRightToLeftLayoutConverter.ConvertRect(FCaptionRect,
    AClientBounds);
  FCaptionTextRect := TdxRightToLeftLayoutConverter.ConvertRect
    (FCaptionTextRect, AClientBounds);
  FFilterButtonRect := TdxRightToLeftLayoutConverter.ConvertRect
    (FFilterButtonRect, AClientBounds);
  FImageRect := TdxRightToLeftLayoutConverter.ConvertRect(FImageRect,
    AClientBounds);
end;
...
procedure TcxRowCaptionInfo.UpdateFilterButtonHotTrackState
  (const APoint: TPoint);
begin
  if (FilterButtonState <> cxbsPressed) then
...
begin
  if (Images <> nil) and (RowProperties.ImageIndex >= 0) and
    (RowProperties.ImageIndex < Images.Count) then
...
begin
  ...
  else if (Row.FProperties is TcxMultiEditorRowProperties) then
    with TcxMultiEditorRowProperties(Row.FProperties),
      Row.ViewInfo.HeaderInfo do
...
begin
  Result := IsFilterable and (IsFilterButtonAlwaysVisible or
    ...
    (IsFilterSmartTag and IsFilterButtonActive));
end;
...
begin
  Result := (Images <> nil) and
    ((ImageIndex >= 0) or VerticalGrid.OptionsView.ShowEmptyRowImage);
end;
...
begin
  ...
  begin
    Painter.DrawScaledExpandButton(Canvas, ARowHeader.ButtonRect,
      ARowHeader.Row.Expanded, ScaleFactor, ARowHeader.ButtonColor,
      GetExpandButtonState(ARowHeader));
  end;
end;

procedure TcxvgPainter.DrawCategoryExplorerStyleRowHeader
  (ARowHeader: TcxCustomRowHeaderInfo; ATheme: TdxTheme);
const
  Parts: array [Boolean, 0 .. 1] of Integer = ((EBP_NORMALGROUPEXPAND,
    EBNGE_NORMAL), (EBP_NORMALGROUPCOLLAPSE, EBNGC_NORMAL));
var
  R: TRect;
begin
  with ARowHeader do
  begin
    ...
    if (Row.Level > 0) and (PaintStyle = psdotNet) then
      R.Left := IndentBounds.Right -
        (ViewInfo.RowIndentWidth + ViewInfo.VertLineWidth);
    Canvas.FillRect(R);
    ...
    begin
      ...
      TcxWinXPLookAndFeelPainter.DrawScaledThemeBackground(ATheme,
        Canvas.Handle, Parts[Row.Expanded, 0], Parts[Row.Expanded, 1], R,
        ScaleFactor, True);
    end;
...
procedure TcxvgPainter.DrawCategoryRowHeader(ARowHeader
  : TcxCustomRowHeaderInfo);
var
  ATheme: TdxTheme;
begin
...
procedure TcxvgPainter.DrawCategoryRowIndent(ARowHeader
  : TcxCustomRowHeaderInfo);
var
  I: Integer;
begin
...
var
  ...
  AOffset, R: TRect;
begin
  if not(ARowHeader is TcxMultiEditorRowHeaderInfo) then
    Exit;
  ...
  begin
    ...
    begin
      ...
      cxTextOut(Canvas.Canvas, SeparatorInfo.Caption, R,
...
begin
  ...
  try
    ...
    cxDrawImage(Canvas, ACaptionInfo.ImageRect, nil, ACaptionInfo.Images,
      ACaptionInfo.ImageIndex, True, nil, ScaleFactor);
  finally
...
procedure TcxvgPainter.DrawRowHeaderCell(ACaptionInfo: TcxRowCaptionInfo;
...
procedure TcxvgPainter.DrawRowHeaderCellFilterButton(ACaptionInfo
  : TcxRowCaptionInfo);
begin
  ...
  if ACaptionInfo.IsFilterSmartTag then
    Painter.DrawScaledFilterSmartTag(Canvas, ACaptionInfo.FilterButtonRect,
      ACaptionInfo.FilterSmartTagState, ACaptionInfo.IsFilterButtonActive,
      ScaleFactor)
  else
    Painter.DrawScaledFilterDropDownButton(Canvas,
      ACaptionInfo.FilterButtonRect, ACaptionInfo.FilterButtonState,
      ACaptionInfo.IsFilterButtonActive, ScaleFactor);
end;
...
procedure TcxvgPainter.DrawRowHeaderFocusRect
  (ARowHeader: TcxCustomRowHeaderInfo);
begin
...
procedure TcxvgPainter.DrawRowHeaderSelected(ARowHeader
  : TcxCustomRowHeaderInfo);
begin
...
var
  I: Integer;
begin
  if ARowHeader.Transparent then
    Exit;
  with ARowHeader do
  begin
...
function TcxvgPainter.GetExpandButtonState(ARowHeader: TcxCustomRowHeaderInfo)
  : TcxExpandButtonState;
begin
  Result := cebsNormal;
  if ARowHeader.Focused and
    not(ARowHeader.Row.ViewInfo is TcxCategoryRowViewInfo) then
  begin
...
begin
  Result := ViewInfo.UseCategoryExplorerStyle and
...
begin
  Result := not cxRectIsEmpty(AValueInfo.DisplayRect) and
    Canvas.RectVisible(AValueInfo.DisplayRect);
end;
...
begin
  ...
  begin
    ...
    if Focused and Self.ViewInfo.CalcHelper.IsDrawValueFocusRect and
      not cxRectIsEmpty(FocusRect) then
      Canvas.DrawFocusRect(FocusRect);
  end;
end;
...
var
  ...
  R, AOffset: TRect;
begin
  if not(ARowViewInfo is TcxMultiEditorRowViewInfo) then
    Exit;
  with TcxMultiEditorRowViewInfo(ARowViewInfo) do
  begin
    if (FValuesInfo.Count = 0) or (SeparatorRects.Count = 0) then
      Exit;
    AOffset := EditContentDefaultOffsets[True];
    for I := 0 to SeparatorRects.Count - 1 do
    begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if Check(CR) then
          SetHitState(vghc_HitAtDivider, True);
      end;
...
begin
  Result := VerticalGrid.Customizing.CanDrop
    (VerticalGrid.ClientToScreen(HitPoint));
  if Result then
...
begin
  if ViewInfo.IsFilterBoxVisible and
    PtInRect(ViewInfo.FilterBoxViewInfo.BoundsRect, HitPoint) then
  begin
...
begin
  if ViewInfo.IsFindPanelVisible and
    PtInRect(ViewInfo.FindPanelViewInfo.BoundsRect, HitPoint) then
  begin
...
function TcxvgHitTest.CalcRowHeaderHitTest(AHeaderInfo
  : TcxCustomRowHeaderInfo): Boolean;
var
  I: Integer;
  ACaptionInfo: TcxRowCaptionInfo;
begin
  ...
  begin
    ...
    else if Check(FHeaderCellsRect) then
      for I := 0 to CaptionsInfo.Count - 1 do
      begin
...
function TcxvgHitTest.CalcRowHitTest(ARowViewInfo
  : TcxCustomRowViewInfo): Boolean;
begin
  with ARowViewInfo do
  begin
    Result := Check(cxRect(RowRect.Left, RowRect.Top, RowRect.Right,
      RowRect.Bottom + ViewInfo.HorzLineWidth));
    if not Result then
      Exit;
    FHitRow := Row;
...
procedure TcxvgHitTest.CalcRowValuesHitTest(ARowViewInfo: TcxCustomRowViewInfo);
var
  I: Integer;
  AValueInfo: TcxRowValueInfo;
  AUseValue: Boolean;
...
procedure TcxvgHitTest.CalcRowsHitTest(AViewInfo: TcxvgCustomViewInfo);
var
  I: Integer;
  ARowSizing: Boolean;
  ARowViewInfo: TcxCustomRowViewInfo;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        R := ARowViewInfo.RowRect;
        if Check(cxRect(R.Left, R.Bottom - 1, R.Right, Min(R.Bottom + 1,
      ...
      if CalcRowHitTest(ARowViewInfo) then
        Exit;
    end;
...
function TcxvgHitTest.CanSizing(var ASizeDirection
...
begin
  ...
  if (VerticalGrid.DragAndDropState <> ddsNone) and
    not(VerticalGrid.DragAndDropObject is TcxSizingDragAndDropObject) then
    Exit;
  if Result = crDefault then
    if CanSizing(ADirection) then
      Result := ACursors[ADirection]
    else if (VerticalGrid.DragAndDropState = ddsNone) and IsItemEditCell and
      HitRow.CanFocus then
    begin
      P := cxPointOffset(VerticalGrid.ScreenToClient(GetMouseCursorPos),
        EditCellViewInfo.ContentRect.TopLeft, False);
      Result := TcxCustomEditViewInfoAccess(EditCellViewInfo.EditViewInfo)
        .GetCurrentCursor(P);
    end;
end;
...
begin
  Result := HitAtCaption or HitAtIndent or HitAtImage or HitAtButton or
...
begin
  Result := Max(VerticalGrid.OptionsView.RowHeight,
    TdxTextMeasurer.TextLineHeight(VerticalGrid.Styles.GetCategoryParams(Self)
    .Font) + ScaleFactor.Apply(cxTextOffset) * 2);
  Inc(Result, TdxVisualRefinements.HeaderPadding.ScaledHeight(ScaleFactor));

  if VerticalGrid.ViewInfo.UseCategoryExplorerStyle and
    (VerticalGrid.LookAndFeel.SkinPainter = nil) then
...
function TcxEditorRowPropertiesFilterPopupOptions.
...
function TcxEditorRowPropertiesFilterPopupOptions.GetIncrementalFiltering
  : TcxEditorRowPropertiesFilterPopupIncrementalFilteringOptions;
begin
  Result := TcxEditorRowPropertiesFilterPopupIncrementalFilteringOptions
...
function TcxEditorRowPropertiesOptions.GetFilterPopup
  : TcxEditorRowPropertiesFilterPopupOptions;
begin
  Result := TcxEditorRowPropertiesFilterPopupOptions(inherited FilterPopup);
end;

procedure TcxEditorRowPropertiesOptions.SetFilterPopup
  (AValue: TcxEditorRowPropertiesFilterPopupOptions);
begin
  inherited FilterPopup := AValue;
end;

procedure TcxEditorRowPropertiesOptions.SetExcelFilterPopup
  (AValue: TcxEditorRowPropertiesExcelFilterPopupOptions);
begin
...
begin
  ...
  try
    ...
    ACellViewInfo.ViewData.UseRightToLeftAlignment :=
      VerticalGrid.UseRightToLeftAlignment;
    ACellViewInfo.ViewData.UseRightToLeftReading :=
      VerticalGrid.UseRightToLeftReading;
    ACellViewInfo.ViewData.UseRightToLeftScrollBar :=
      VerticalGrid.UseRightToLeftScrollBar;
    if not cxRectIsEmpty(ACellViewInfo.ContentRect) then
      CalculateEditViewInfo(ACellViewInfo.CellValue, ACellViewInfo,
        cxInvalidPoint);
...
procedure TcxCellEdit.CheckInitializeViewInfoByHiddenEditor
  (ACellViewInfo: TcxRowValueInfo);
var
  AEdit: TcxCustomEdit;
begin
  if Editing and (Controller.FocusedRecordIndex = ACellViewInfo.RecordIndex)
  then
  begin
...
procedure TcxCellEdit.DoCalculateEditViewInfo(AEditViewInfo
  : TcxEditCellViewInfo);
begin
  inherited DoCalculateEditViewInfo(AEditViewInfo);
  VerticalGrid.ConditionalFormattingProvider.CalculateStyleViewInfo
    (AEditViewInfo);
end;

procedure TcxCellEdit.DoGetDisplayText(ARecordIndex: TdxNativeInt;
  var AText: string);
begin
  ...
  begin
    ...
    begin
      if (AProperties.GetEditValueSource(False) = evsValue) or
        ...
        (not IsExpression or (ErrorCodes[FilteredRecordIndex[ARecordIndex],
        ItemIndex] = 0)) then
...
begin
  ...
  try
    EditRowProperties.DoValidateDrawValue
      (GetDisplayValue(DoGetEditProperties(Pointer(ARecordIndex)),
...
procedure TcxCellEdit.ValidateDrawValue(const Value: Variant;
  AEditViewInfo: TcxEditCellViewInfo);
begin
  inherited;
  EditRowProperties.DoValidateDrawValue(Value, AEditViewInfo.RecordIndex,
...
function TcxvgMultiRecordsOptionsData.GetMultiThreadedFiltering
  : TdxDefaultBoolean;
begin
...
procedure TcxVerticalGridFiltering.RunCustomizeDialog(AEditorRowProperties
  : TcxCustomEditorRowProperties = nil);
var
...
procedure TcxVerticalGridFiltering.SetRowExcelPopup
  (AValue: TcxVerticalGridFilteringRowExcelPopupOptions);
begin
  ItemExcelPopup := AValue;
end;

procedure TcxVerticalGridFiltering.SetRowPopup
  (AValue: TcxVerticalGridFilteringRowPopupOptions);
begin
  ItemPopup := AValue;
end;

procedure TcxVerticalGridFiltering.SetRowPopupMode
...
constructor TcxCollectionItemEditorRowProperties.CreateEx(ARow: TcxCustomRow);
begin
...
procedure TcxCollectionItemEditorRowProperties.GetPropertyValue
...
procedure TcxCollectionItemEditorRowProperties.SetPropertyValue
...
function TcxCollectionItemEditorRowProperties.GetStoredProperties
  (AProperties: TStrings): Boolean;
begin
  AProperties.Add('Expression');
  Result := True;
...
function TcxCollectionItemEditorRowProperties.GetOptions
  : TcxMultiEditorRowPropertiesOptions;
begin
...
begin
  ...
  try
    ...
    try
      for I := 0 to Count - 1 do
        AIndexes.AddOrSetValue(Items[I].EditContainer.EditRowProperties.Caption,
          Items[I].EditContainer.ItemIndex);
      inherited Assign(Source);
      for I := 0 to Count - 1 do
      begin
        if AIndexes.TryGetValue
          (Items[I].EditContainer.EditRowProperties.Caption, AIndex) then
          Row.VerticalGrid.ContainerList.Move
            (Items[I].EditContainer.ItemIndex, AIndex);
      end;
...
function TcxEditorPropertiesCollection.GetCollectionItemClass
...
function TcxEditorPropertiesCollection.GetItem(Index: Integer)
  : TcxEditorRowItemProperties;
begin
...
function TcxMultiEditorRowProperties.GetCollectionClass
  : TcxEditorPropertiesCollectionClass;
begin
...
begin
  for I := 0 to Properties.Editors.Count - 1 do
    AChildren.AddObject(Properties.Editors[I].GetObjectName,
      Properties.Editors[I]);
end;
...
begin
  if Properties.Locked or VerticalGrid.IsLoading then
    Exit;
...
begin
  ...
  for I := 0 to Properties.Editors.Count - 1 do
  begin
    AFont := VerticalGrid.Styles.GetContentParams(Properties.Editors[I],
      False, -1).Font;
    Result := Max(Result, Properties.Editors[I]
      .EditContainer.GetEditDefaultHeight(AFont) + cxTextOffset);
  end;
end;

function TcxCustomMultiEditorRow.GetEditContainer(ACellIndex: Integer)
  : TcxCellEdit;
begin
...
procedure TcxCustomMultiEditorRow.SetProperties(const Value
  : TcxMultiEditorRowProperties);
begin
  FProperties.Assign(Value);
end;
...
begin
  ...
  begin
    EditingControl.BeginUpdate;
    try
      AllowChangeRecord := TcxvgMultiRecordsOptionsBehavior(Source)
        .AllowChangeRecord;
      RecordScrollMode := TcxvgMultiRecordsOptionsBehavior(Source)
        .RecordScrollMode;
    finally
      EditingControl.EndUpdate;
    end;
...
begin
  if Value <> nil then
    inherited IncSearchItem := TcxCustomEditorRowProperties(Value.FProperties)
      .EditContainer
  else
    inherited IncSearchItem := nil;
end;

procedure TcxvgMultiRecordsOptionsBehavior.SetRecordScrollMode
...
procedure TcxvgCustomScrollStrategy.CheckDecreaseTopIndex(AScrollRectHeight
  : Integer);
var
...
function TcxvgCustomScrollStrategy.CheckTopVisibleIndex(AIndex,
  AStep: Integer): Integer;
var
  ACount: Integer;
begin
  Result := AIndex;
  ACount := ViewInfo.VisibleRowCount;
  cxRange(Result, 0, ACount - GetVisibleCountFromBottom(ACount - 1,
    cxRectHeight(ViewInfo.ClientRect) - GetHScrollbarAreaHeight));
end;

function TcxvgCustomScrollStrategy.FindNextCustomItem(AFocusedItemIndex,
  AItemCount: Integer; AGoForward: Boolean; var AItemIndex: Integer): Boolean;
...
begin
  if DataController.IsGridMode then
    if AGoForward then
      if not DataController.IsEof and
        (AFocusedRecordIndex = DataController.RowCount - 1) then
      begin
  ...
  if not FindNextCustomItem(AFocusedRecordIndex, DataController.RowCount,
    AGoForward, Result) then
    Result := -1;
end;
...
function TcxvgCustomScrollStrategy.FocusNextRecord(AFocusedRecordIndex: Integer;
  ...
  begin
    if DataController.IsGridMode and (AFocusedRecordIndex = -1) and AGoForward
    then
...
function TcxvgCustomScrollStrategy.GetFirstRowByBandIndex(ABandIndex: Integer)
  : TcxCustomRow;
begin
...
begin
  VerticalGrid.SetScrollBarInfo(sbHorizontal, 0, DataScrollSize - 1, 1,
    VisibleDataScrollSize, ScrollBarPos, not IsHideHScrollBar,
    ViewInfo.CanHScrollBarHide);
end;

procedure TcxvgCustomScrollStrategy.InitVScrollBarParameters;
begin
  VerticalGrid.SetScrollBarInfo(sbVertical, 0, ViewInfo.VisibleRowCount - 1,
    // min max
    1, VisibleRowCount, TopVisibleRowIndex, not IsHideVScrollBar, True);
end;

function TcxvgCustomScrollStrategy.GetVisibleCountFromBottom(ABottomIndex,
  AHeight: Integer): Integer;
begin
  Result := GetVisibleCount(ABottomIndex, AHeight, -1, False);
end;

function TcxvgCustomScrollStrategy.GetVisibleCountFromTop(ATopIndex,
  AHeight: Integer): Integer;
begin
...
begin
  ...
  begin
    N := GetVisibleCountFromTop(FTopVisibleRowIndex,
      cxRectHeight(ViewInfo.ClientRect));
...
procedure TcxvgCustomScrollStrategy.CheckLeftVisibleRecordAndOffset
  (var ALeftVisibleRecord, APixelScrollOffset: Integer);
var
  AIsGridMode: Boolean;
begin
  if FCheckingCoordinate or ViewInfo.IsDirty then
    Exit;
...
var
  ...
  begin
    ...
    if AScrollRecordCount = -1 then
      AScrollRecordCount := DataController.RowCount + ScrollBarOffsetBegin +
        ScrollBarOffsetEnd;
...
procedure TcxvgCustomScrollStrategy.DoCheckLeftVisibleRecordAndOffset
  (var ALeftVisibleRecord, APixelScrollOffset: Integer);
var
  AMaxValue: Integer;
begin
  ...
  begin
    if DataController.IsGridMode and not DataController.IsEof and
...
procedure TcxvgCustomScrollStrategy.DoScrollRecords(AScrollCode: TScrollCode;
  var AScrollPos: Integer);
begin
  case AScrollCode of
    scLineUp:
...
begin
  if (ALeftVisibleRecord <> -1) and
    ...
    (FLeftVisibleRecord = ALeftVisibleRecord) and
    (FPixelScrollRecordOffset <> APixelScrollRecordOffset)) then
  begin
...
function TcxvgCustomScrollStrategy.GetBottomVisibleChild(ARow: TcxCustomRow)
  : TcxCustomRow;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Inc(ABandCount);
        if not CanCalcRowsOnTheNextBand(ALeft, ABandCount) then
          Break;
      end;
...
begin
  Result := cxRectWidth(ViewInfo.ClientRect) - 2 <
    VerticalGrid.VScrollBar.Width;
end;
...
procedure TcxvgCustomScrollStrategy.ScrollContentByGesture
  (AScrollKind: TScrollBarKind; ADelta: Integer);
begin
end;

procedure TcxvgCustomScrollStrategy.ScrollH(AScrollCode: TScrollCode;
  var AScrollPos: Integer);
...
procedure TcxvgCustomScrollStrategy.ScrollV(AScrollCode: TScrollCode;
  var AScrollPos: Integer);
begin
  case AScrollCode of
    scLineUp:
...
procedure TcxvgCustomScrollStrategy.SetLeftVisibleRecordAndOffset
  (ALeftVisibleRecord, APixelScrollRecordOffset: Integer; AAnimated: Boolean);
var
...
function TcxvgCustomScrollStrategy.SetRecordVisible(ARecordIndex
  : Integer): Boolean;
var
...
procedure TcxvgCustomScrollStrategy.SetTopVisibleRowIndexAndBand
  (Index: Integer);
begin
...
begin
  Result := GetVisibleCountFromTop(TopVisibleRowIndex,
    cxRectHeight(ViewInfo.ClientRect) - GetHScrollbarAreaHeight);
end;
...
constructor TcxvgRecordScrollAnimationHelper.Create
  (AOwner: TcxvgMultiRecordsScrollStrategy);
begin
  inherited Create;
  FOwner := AOwner;
end;

procedure TcxvgRecordScrollAnimationHelper.AfterAnimationEnded
  (AIsRaiseEvent: Boolean);
begin
  inherited AfterAnimationEnded(AIsRaiseEvent);
  TcxEditingControllerAccess(FOwner.Controller.EditingController)
    .FinalizeCellAfterScrollAnimation;
end;

procedure TcxvgRecordScrollAnimationHelper.BeforeAnimationStarted;
begin
  TcxEditingControllerAccess(FOwner.Controller.EditingController)
    .InitializeCellBeforeScrollAnimation;
...
begin
  ...
  FOwner.CalculatePixelScrollInfo(Result.Index, Result.ScrollOffset, MaxInt,
    MinInt, -Sign(AnimationLength) * (APosition - PrevAnimatedPosition),
    AOverPan);
end;
...
begin
  Result := FOwner.GetPixelScrollOffset(GetOwnerPosition.Index,
    GetOwnerPosition.ScrollOffset, AValue.Index, AValue.ScrollOffset);
end;

function TcxvgRecordScrollAnimationHelper.GetOwnerPosition
  : TdxRecordPixelScrollData;
begin
  Result := TdxRecordPixelScrollData.Create(FOwner.LeftVisibleRecord,
...
begin
  ...
  begin
    ...
    DoCheckLeftVisibleRecordAndOffset(ALeftVisibleRecordIndex,
      APixelScrollRecordOffset);
    DoSetLeftVisibleRecordAndOffset(ALeftVisibleRecordIndex,
      APixelScrollRecordOffset);
  end
  else
  begin
...
begin
  ...
  begin
    ...
    if (ARecordIndex > AMaxRecordIndex) or
      ((ARecordIndex = AMaxRecordIndex) and (ARecordOffset < AMaxRecordOffset))
    then
    begin
...
procedure TcxvgMultiRecordsScrollStrategy.
  CheckMaxLeftVisibleRecordIndexAndOffset(var ALeftVisibleRecordIndex,
  APixelScrollRecordOffset: Integer);
begin
...
begin
  if IsPixelBasedScrollDataPos then
    Result := (ViewInfo.ViewValueWidth + GetRecordSpace) *
      (VerticalGrid.RecordCount - 1) + ViewInfo.ViewValueWidth +
      ViewInfo.VertLineWidth + GetVScrollbarAreaWidth
  else
...
begin
  ...
  begin
    ...
    if (ALeftVisibleRecord > FMaxLeftVisibleRecord) or
      (ALeftVisibleRecord = FMaxLeftVisibleRecord) and
      (APixelScrollOffset < FMaxPixelScrollRecordOffset) then
    begin
    ...
    inherited DoCheckLeftVisibleRecordAndOffset(ALeftVisibleRecord,
      APixelScrollOffset);
end;
...
begin
  if IsPixelBasedScrollDataPos then
    Result := LeftVisibleRecord * (ViewInfo.ViewValueWidth + GetRecordSpace) -
      PixelScrollRecordOffset
  else
    Result := inherited DoGetScrollBarPos;
end;

procedure TcxvgMultiRecordsScrollStrategy.DoScrollRecords
  (AScrollCode: TScrollCode; var AScrollPos: Integer);
var
  ...
  begin
    ...
    case AScrollCode of
      ...
      scLineDown:
        Scroller.SetLeftVisibleRecordAndOffset(ALeftVisibleRecord + 1, 0, True);
      scPageUp:
        Scroller.SetLeftVisibleRecordAndOffset(ALeftVisibleRecord -
          VisibleValueCount, 0, True);
      scPageDown:
        Scroller.SetLeftVisibleRecordAndOffset(ALeftVisibleRecord +
          VisibleValueCount, 0, True)
    else
...
begin
  ...
  begin
    ARecordIndex := 0;
    AOffset := 0;
    CalculatePixelScrollInfo(ARecordIndex, AOffset, MaxInt, 1, -Value,
      AOverPan);
...
procedure TcxvgMultiRecordsScrollStrategy.
  GetPixelScrollLeftRecordIndexAndOffsetByRightRecord(ARightRecord: Integer;
...
begin
  ...
  CalculatePixelScrollInfo(ALeftRecord, APixelScrollRecordOffset, MaxInt, 1,
    ViewInfo.GetPixelScrollContentSize + GetRecordSpace, AOverPan);
end;

function TcxvgMultiRecordsScrollStrategy.GetPixelScrollOffset(AFirstRecordIndex,
...
begin
  if IsRecordScrollAnimationActive then
    APixelScrollRecordOffset := FRecordScrollAnimationHelper.TargetPosition.
      ScrollOffset
  else
    APixelScrollRecordOffset := PixelScrollRecordOffset;
  with ViewInfo do
  begin
    ...
    ARecordsWidth := ViewInfo.GetPixelScrollContentSize + ARecordSpace -
      ViewInfo.VertLineWidth - APixelScrollRecordOffset;
    ACount := Max(1, (ARecordsWidth - GetVScrollbarAreaWidth)
      div (ViewValueWidth + ARecordSpace));
  end;
...
begin
  Result := IsRecordPixelScrolling and
    (VerticalGrid.RecordCount < ViewInfo.GetPixelScrollContentSize);
end;
...
var
  ...
  AOverPan: Boolean;
begin
  if (ADelta = 0) or (VerticalGrid.RecordCount = 0) then
    Exit;
  ALeftVisibleRecord := LeftVisibleRecord;
  APixelScrollRecordOffset := PixelScrollRecordOffset;
  CalculatePixelScrollInfo(ALeftVisibleRecord, APixelScrollRecordOffset,
    FMaxLeftVisibleRecord, FMaxPixelScrollRecordOffset, ADelta, AOverPan);
  DoSetLeftVisibleRecordAndOffset(ALeftVisibleRecord, APixelScrollRecordOffset);
...
function TcxvgMultiRecordsScrollStrategy.SetRecordVisible
...
begin
  if IsRecordPixelScrolling then
  begin
    AAnimated := IsScrollAnimationEnabled and not TcxEditingControllerAccess
      (Controller.EditingController).EditingItemSetting;
    AOldLeftVisibleRecord := LeftVisibleRecord;
    AOldRecordPixelScrollOffset := PixelScrollRecordOffset;
    if (ARecordIndex < LeftVisibleRecord) or
      ((ARecordIndex = LeftVisibleRecord) and (PixelScrollRecordOffset <> 0))
    then
      SetLeftVisibleRecordAndOffset(ARecordIndex, 0, AAnimated)
    else if LeftVisibleRecord + VisibleValueCount <= ARecordIndex then
    begin
      GetPixelScrollLeftRecordIndexAndOffsetByRightRecord(ARecordIndex,
        ANewRecordIndex, ANewRecordPixelScrollOffset);
      SetLeftVisibleRecordAndOffset(ANewRecordIndex,
        ANewRecordPixelScrollOffset, AAnimated);
    end
    else if IsRecordScrollAnimationActive then
      FRecordScrollAnimationHelper.StopAnimation(True);
    Result := (LeftVisibleRecord <> AOldLeftVisibleRecord) or
      (PixelScrollRecordOffset <> AOldRecordPixelScrollOffset);
  end
  else
...
begin
  ...
  FMaxPixelScrollRecordOffset := -ViewInfo.ViewValueWidth - GetRecordSpace -
    GetVScrollbarAreaWidth;
  CalculatePixelScrollInfo(FMaxLeftVisibleRecord, FMaxPixelScrollRecordOffset,
    MaxInt, 1, ViewInfo.GetPixelScrollContentSize + GetRecordSpace, AOverPan);
end;
...
procedure TcxvgMultiRecordsScrollStrategy.RecordScrollAnimated
  (ALeftVisibleRecord, APixelScrollOffset: Integer);
begin
  FRecordScrollAnimationHelper.SetPosition
    (TdxRecordPixelScrollData.Create(ALeftVisibleRecord, APixelScrollOffset));
end;
...
procedure TcxvgMultiRecordsScrollStrategy.SetLeftVisibleRecordAndOffset
  (ALeftVisibleRecord, APixelScrollRecordOffset: Integer; AAnimated: Boolean);
var
  APrevLeftVisibleRecord: Integer;
begin
  if AAnimated then
  begin
    CheckLeftVisibleRecordAndOffset(ALeftVisibleRecord,
      APixelScrollRecordOffset);
  ...
  begin
    if IsRecordScrollAnimationActive then
    begin
      APrevLeftVisibleRecord :=
        FRecordScrollAnimationHelper.StartPosition.Index;
    ...
    CheckLeftVisibleRecordAndOffset(ALeftVisibleRecord,
      APixelScrollRecordOffset);
    DoSetLeftVisibleRecordAndOffset(ALeftVisibleRecord,
      APixelScrollRecordOffset);
    if FLeftVisibleRecord <> APrevLeftVisibleRecord then
      VerticalGrid.DoLeftVisibleRecordIndexChanged;
  end;
...
procedure TcxvgBandsScrollStrategy.CheckDecreaseTopIndex(AScrollRectHeight
  : Integer);
var
  ALeftBand: Integer;
begin
...
function TcxvgBandsScrollStrategy.CheckTopVisibleIndex(AIndex,
  AStep: Integer): Integer;
var
  ARow: TcxCustomRow;
  ABandIndex: Integer;
...
begin
  ...
  begin
    ...
    if (ARowIndex >= AFirstIndex) and
      (ARowIndex < AFirstIndex + ABandInfo.RowsCount) then
    begin
      Result := I;
      Break;
    end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if AHeight + ARowViewInfo.CalculatedHeight + HorzLineWidth > AClientHeight
      then
      begin
...
function TcxvgBandsScrollStrategy.CanCalcRowsOnTheNextBand(ALeft,
  ANextBandIndex: Integer): Boolean;
var
  X: Integer;
begin
  Result := True;
  if IsBehindRightClientEdge(ALeft + BandWidth + ViewInfo.BandsInterval + 1)
  then
  begin
...
begin
  ...
  Result := Min(BandsInfo.Count,
    Max(1, (cxRectWidth(ViewInfo.ClientRect) - AIndents) div W));
end;
...
function TcxvgBandsScrollStrategy.InternalSetLeftVisibleBand
  (ABandIndex: Integer; ACheckTopVisibleRow: Boolean): Boolean;
begin
...
procedure TcxCaptionRowProperties.SetCaption(const Value: TCaption);
begin
  if FIsCaptionAssigned and (Value = FCaption) then
    Exit;
  FCaption := Value;
...
procedure TcxCaptionRowProperties.SetImageIndex(const Value: TcxImageIndex);
begin
...
begin
  if (Action in [lnAdded, lnDeleted]) and
...
procedure TcxCustomRow.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
  if AName = 'Visible' then
    AValue := Visible
  else if AName = 'Height' then
    AValue := Height
  else if AName = 'Expanded' then
    AValue := Expanded
  else if AName = 'AParentID' then
  begin
    if VerticalGrid.FNewLoadMode then
...
procedure TcxCustomRow.SetPropertyValue(const AName: string;
  const AValue: Variant);
begin
  if AName = 'Visible' then
    Visible := AValue
...
function TcxCustomRow.CreateChild(const AObjectName,
  AClassName: string): TObject;
begin
  Result := nil;
end;
...
begin
  ...
  if Value <> nil then
    ...
    else if Value is TcxCustomRow then
...
begin
  ...
  Filer.DefineProperty('ParentID', ReadLoadedParentID,
    WriteLoadedParentID, True);
...
begin
  AHeaderHeight := TdxTextMeasurer.TextLineHeight
    (VerticalGrid.Styles.GetHeaderParams(Self).Font) +
    ScaleFactor.Apply(cxTextOffset);
  Inc(AHeaderHeight, TdxVisualRefinements.HeaderPadding.ScaledHeight
    (ScaleFactor));
...
function TcxvgCellNavigator.FocusNextCell(AForward, ANextRow, ATabStopNavigation
  : Boolean): Boolean;
begin
...
function TcxvgCellNavigator.GetContainerCount(ARowIndex: Integer): Integer;
begin
...
function TcxvgCellNavigator.FindNextRow(var ARow: TcxCustomRow;
  var ACellIndex: Integer; AForward: Boolean): Boolean;
var
  ARowIndex: Integer;
begin
  Result := False;
...
function TcxvgCellNavigator.GetRowForNextRecord(AForward: Boolean)
  : TcxCustomRow;
begin
  Result := nil;
  if RowCount > 0 then
...
begin
  ...
  begin
    ...
    if not AHasEditCell or not ValidateNextCell(ACurRow, AForward, ACurCell)
    then
    begin
      ...
      begin
        ...
        if ValidateNextCell(ACurRow, AForward, ACurCell) then
          FocusRecordRowCell(Controller.FocusedRecordIndex + cxIntOffs
            [AForward], ACurRow, ACurCell)
        else
...
function TcxvgCellNavigator.NavigateMultiEditorRow(ARow: TcxCustomRow;
  AForward: Boolean): Boolean;
var
  ACurCell: Integer;
begin
...
function TcxvgCellNavigator.NavigateVertical(AForward, AForceNextRow
  : Boolean): Boolean;
var
  ACurCell: Integer;
  ACurRow: TcxCustomRow;
begin
  ...
  begin
    ...
    if FindNextRow(ACurRow, ACurCell, AForward) then
      Controller.SetFocusedRowAndCell(ACurRow, ACurCell)
    else if Controller.GetFocusCellOnCycle then
    begin
      if ACurRow <> nil then
      begin
        ACurRow := GetRowForNextRecord(AForward);
        ACurCell := GetCellIndexForNextRow(AForward, ACurRow);
        if ValidateNextCell(ACurRow, AForward, ACurCell) or
          FindNextRow(ACurRow, ACurCell, AForward) then
        begin
          if Controller.CanChangeRecord then
          begin
            if FindNextRecord(AForward) then
              FocusRecordRowCell(Controller.FocusedRecordIndex +
                cxIntOffs[AForward], ACurRow, ACurCell)
          end
          else
            Controller.SetFocusedRowAndCell(ACurRow, ACurCell)
        end;
...
function TcxvgCellNavigator.ValidateNextCell(ARow: TcxCustomRow;
  AForward: Boolean; var ACellIndex: Integer): Boolean;
var
...
constructor TcxvgCustomViewInfo.Create(AOwner: TcxEditingControl);
begin
  inherited Create(AOwner);
  FVerticalGrid := TcxCustomVerticalGrid(AOwner);
  FLinesInfo := TLineInfoList.Create;
...
procedure TcxvgCustomViewInfo.CalcEditCell(const ABounds: TRect;
  ARowValueInfo: TcxRowValueInfo);
begin
...
procedure TcxvgCustomViewInfo.ChangeFocusedRow(ANewFocus,
...
function TcxvgCustomViewInfo.GetRowViewInfo(ARow: TcxCustomRow)
  : TcxCustomRowViewInfo;
begin
...
begin
  with ARowViewInfo do
    Result := cxRect(ValuesRect.Left, RowRect.Top, RowRect.Right,
      RowRect.Bottom);
end;

function TcxvgCustomViewInfo.GetLTRValuesRect(ARowViewInfo
  : TcxCustomRowViewInfo): TRect;
begin
  with ARowViewInfo do
    Result := cxRect(RowRect.Left + ViewHeaderWidth + DividerWidth, RowRect.Top,
...
function TcxvgCustomViewInfo.GetValuesRect(ARowViewInfo
  : TcxCustomRowViewInfo): TRect;
begin
...
var
  I: Integer;
begin
  if not CanUpdateRecord(ARecordIndex) then
    Exit;
  for I := 0 to RowsViewInfo.Count - 1 do
...
begin
  if HorzLineWidth > 0 then
  begin
    LinesInfo.Add(R.Left, R.Top, R.Right - R.Left, HorzLineWidth,
      BandBorderColor);
...
procedure TcxvgCustomViewInfo.AddBottomValueSide(ARowViewInfo
  : TcxCustomRowViewInfo; const R: TRect);
begin
  if HorzLineWidth > 0 then
    ARowViewInfo.ValuesLinesInfo.Add(R.Left, R.Bottom, R.Right - R.Left,
      HorzLineWidth, HorzLineBrush);
end;

procedure TcxvgCustomViewInfo.AddRightValueSide(ARowViewInfo
  : TcxCustomRowViewInfo; const R: TRect; ALast: Boolean);
begin
  if VertLineWidth > 0 then
    if ALast then
      ARowViewInfo.ValuesLinesInfo.Add(R.Right, R.Top, VertLineWidth,
        R.Bottom - R.Top + HorzLineWidth, BandBorderColor)
    else
      ARowViewInfo.ValuesLinesInfo.Add(R.Right, R.Top, VertLineWidth,
        R.Bottom - R.Top + HorzLineWidth, VertLineBrush);
...
procedure TcxvgCustomViewInfo.CalcBandRowsViewInfo(var AFirstRowIndex: Integer;
  const ABandRect: TRect; ABandIndex, ABandRowCount: Integer);
var
...
begin
  if ShowHeaders then
    FCalcHelper.AddDivider(LinesInfo, cxRect(ClientRect.Left, ClientRect.Top,
      ClientRect.Left + ViewHeaderWidth, ClientRect.Bottom), clNone, False);
end;

procedure TcxvgCustomViewInfo.CalcCategoryExplorerStyle;
begin
  FUseCategoryExplorerStyle := VerticalGrid.OptionsView.CategoryExplorerStyle
    and (VerticalGrid.LookAndFeel.SkinPainter = nil) and
    GetThemeScaledPartSize(totExplorerBar, ScaleFactor, EBP_NORMALGROUPEXPAND,
    FExplorerButtonSize, EBNGE_NORMAL, tssNoScaling);
...
begin
  ...
  begin
    ...
    FClipRect := cxRectInflate(Self.ClientRect, -FVertLineWidth,
      -FHorzLineWidth);
    ...
    FButtonAreaSize := LookAndFeel.Painter.ScaledExpandButtonAreaSize
      (ScaleFactor);
    ...
    FBandMinWidth := FRowHeaderMinWidth + OptionsView.ValueMinWidth +
      DividerWidth;
...
begin
  if not CheckShowRowHeader(ARowViewInfo) then
    Exit;
  with ARowViewInfo do
  begin
    FHeaderInfo.HeaderRect := cxRect(RowRect.Left, RowRect.Top,
      RowRect.Left + ViewHeaderWidth, RowRect.Bottom);
    FValuesRect := cxRect(RowRect.Left + ViewHeaderWidth + DividerWidth,
      RowRect.Top, RowRect.Right, RowRect.Bottom);
  end;
end;
  ...
  begin
    ...
    begin
      ...
      if R.Left > ClientRect.Right then
        ...
        CalcBandRowsViewInfo(ARowIndex, R, ABandIndex,
          BandsInfo[ABandIndex].RowsCount);
    end;
  end;
...
function TcxvgCustomViewInfo.CanAddRowToBand(const ARowRect, ABandRect: TRect;
...
procedure TcxvgCustomViewInfo.CheckMaxRowHeaderWidth(var Value: Integer;
...
procedure TcxvgCustomViewInfo.CreateBand(ABandHeight, ABandWidth: Integer);
var
...
begin
  ...
  R := cxRectBounds(ALeft, ClientRect.Top, ABandWidth,
    Min(ABandHeight, AClientHeight));
  ViewRects.BandRects.Add(R);
  if R.Bottom - R.Top < AClientHeight then
    ViewRects.EmptyRects.Add(cxRectBounds(R.Left, R.Bottom, ABandWidth,
      AClientHeight - (R.Bottom - R.Top)));
end;
...
begin
  if not IsRightToLeftConverted then
    Result := cxRect(ABandRect.Right - 1, ABandRect.Top, ABandRect.Right + 2,
      ClientRect.Bottom)
  else
    Result := cxRect(ABandRect.Left - 2, ABandRect.Top, ABandRect.Left + 1,
      ClientRect.Bottom);
end;
...
begin
  ...
  if ARow <> nil then
    Result := Result and ARow.Options.CanAutoHeight and
...
begin
  Result := ClientRect.Right - ClientRect.Left -
    Scroller.ScrollStrategy.GetVScrollbarAreaWidth;
end;

function TcxvgCustomViewInfo.GetViewHeaderWidth: Integer;
begin
  if ShowHeaders then
    Result := Max(GetViewMinHeaderWidth,
...
function TcxvgCustomViewInfo.ScaleRowRects(ARowViewInfo: TcxCustomRowViewInfo)
  : TRectScaler;
begin
...
begin
  ...
  Result := TdxTextMeasurer.TextLineHeight(VerticalGrid.Font) + 2 *
    ScaleFactor.Apply(cxTextOffset);
...
function TcxvgCustomViewInfo.GetVisibleRow(Index: Integer): TcxCustomRow;
begin
