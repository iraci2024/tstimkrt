...
type
  ...
  protected
    ...
    function FindBookmarkByName(ABookmarks: TdxBookmarkList;
  ...
  public
    ...
    function GetBookmarksSortedByName(AIncludeHiddenBookmarks: Boolean = True)
      : TdxBookmarkList;
    function GetBookmarksSortedByLocation(AIncludeHiddenBookmarks
      : Boolean = True): TdxBookmarkList;
    function ValidateName(const AName: string): Boolean; inline;
    procedure CreateBookmark(const AName: string;
      const ARecreate: TdxPredicate);
...
function TdxBookmarkNameComparer.Compare(const Left,
  Right: TdxDocumentInterval): Integer;
begin
...
constructor TdxBookmarkFormController.Create(AControllerParameters
  : TdxBookmarkFormControllerParameters);
begin
  inherited Create;
...
function TdxBookmarkFormController.GetBookmarks(AIncludeHiddenBookmarks
  : Boolean): TdxBookmarkList;
begin
  Result := Control.InnerControl.DocumentModel.GetBookmarks
    (AIncludeHiddenBookmarks);
end;
...
function TdxBookmarkFormController.GetBookmarksSortedByName
  (AIncludeHiddenBookmarks: Boolean): TdxBookmarkList;
var
...
function TdxBookmarkFormController.GetBookmarksSortedByLocation
  (AIncludeHiddenBookmarks: Boolean): TdxBookmarkList;
begin
  Result := GetBookmarks(AIncludeHiddenBookmarks);
end;

procedure TdxBookmarkFormController.CreateBookmark(const AName: string;
  const ARecreate: TdxPredicate);
var
...
function TdxBookmarkFormController.FindBookmarkByName
  (ABookmarks: TdxBookmarkList; const AName: string): TdxBookmark;
var
  ABookmark: TdxBookmark;
  I: Integer;
begin
...
function TdxBookmarkFormController.CanSelectBookmark
  (ABookmark: TdxBookmark): Boolean;
begin
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        if (ABoundary.Order = TdxBookmarkBoundaryOrder.Start) and
          (ALogPosition <= ABoundary.VisitableInterval.&End) then
