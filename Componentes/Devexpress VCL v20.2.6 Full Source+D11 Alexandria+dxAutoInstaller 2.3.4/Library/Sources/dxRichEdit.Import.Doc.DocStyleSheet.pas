...
type
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader; AOffset: Integer)
      : TdxStyleSheetInformation; static;
    ...
    property IsBuiltInStyleNamesStored: Boolean
      read GetIsBuiltInStyleNamesStored;
    property MaxStyleIdentifier: SmallInt read FMaxStyleIdentifier;
    property FixedIndexStylesCount: SmallInt read FFixedIndexStylesCount
      write FFixedIndexStylesCount;
    property BuiltInStyleNameVersion: SmallInt read FBuiltInStyleNamesVersion;
    property DefaultASCIIFont: SmallInt read FDefaultASCIIFont
      write FDefaultASCIIFont;
  ...
  strict private
    ...
    FStyleName: string;
  protected
    procedure Read(AReader: TBinaryReader; ABaseSize: SmallInt;
      AIsExtended: Boolean);
    procedure ReadUPX(AReader: TBinaryReader); virtual; abstract;
    procedure WriteUPX(AWriter: TBinaryWriter); virtual; abstract;
    function ReadParagraphUPX(AReader: TBinaryReader;
      AParagraphUPXLength: Integer): TArray<Byte>; virtual;
  ...
  public
    ...
    property StyleIdentifier: SmallInt read FStyleIdentifier
      write FStyleIdentifier;
    ...
    property BaseStyleIndex: SmallInt read FBaseStyleIndex
      write FBaseStyleIndex;
    property NextStyleIndex: SmallInt read FNextStyleIndex
      write FNextStyleIndex;
    property LinkedStyleIndex: SmallInt read FLinkedStyleIndex
      write FLinkedStyleIndex;
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader; AOffset: Integer;
      ASize: Integer): TdxDocStyleSheet; static;
    class function CreateDefault: TdxDocStyleSheet; static;
    procedure Write(AWriter: TBinaryWriter);
    function GetStyles(AReader: TBinaryReader; AOffset: Integer; ASize: Integer)
      : TdxList<TdxStyleDescriptionBase>;
    function GetStyleType(AReader: TBinaryReader): TdxStyleType;

    property StylesInformation: TdxStyleSheetInformation
      read FStyleSheetInformation write FStyleSheetInformation;
  ...
  public
    class function CreateStyleDescription(AReader: TBinaryReader;
      AType: TdxStyleType; AInfo: TdxStyleSheetInformation)
      : TdxStyleDescriptionBase; static;
  end;
...
begin
  FBaseStyleDescriptionSize :=
    TdxDocStyleSheet.ExtendedStyleDescriptionBaseInFile;
  FFlags := DefaultFlags;
...
class function TdxStyleSheetInformation.FromStream(AReader: TBinaryReader;
  AOffset: Integer): TdxStyleSheetInformation;
begin
...
procedure TdxStyleSheetInformation.Read(AReader: TBinaryReader;
  AOffset: Integer);
begin
...
constructor TdxStyleDescriptionBase.Create(AStyleType: TdxStyleType;
  AUpxCount: SmallInt);
begin
...
procedure TdxStyleDescriptionBase.Read(AReader: TBinaryReader;
  ABaseSize: SmallInt; AIsExtended: Boolean);
var
...
procedure TdxStyleDescriptionBase.Write(AWriter: TBinaryWriter;
  AIsExtended: Boolean);
var
...
begin
  ...
  AWriter.BaseStream.Seek(Start + BaseSize + SizeOfBytesCount,
...
function TdxStyleDescriptionBase.ReadParagraphUPX(AReader: TBinaryReader;
  AParagraphUPXLength: Integer): TBytes;
begin
...
class function TdxDocStyleSheet.FromStream(AReader: TBinaryReader;
  AOffset: Integer; ASize: Integer): TdxDocStyleSheet;
begin
...
procedure TdxDocStyleSheet.Read(AReader: TBinaryReader; AOffset: Integer;
  ASize: Integer);
var
...
begin
  ...
  FStyleSheetInformation.Free;
  FStyleSheetInformation := TdxStyleSheetInformation.FromStream(AReader,
    AStyleSheetInformationOffset);
  AReader.BaseStream.Seek(AStyleSheetInformationOffset +
    AStyleSheetInformationSize, TSeekOrigin.soBeginning);
...
function TdxDocStyleSheet.GetStyles(AReader: TBinaryReader; AOffset: Integer;
  ASize: Integer): TdxList<TdxStyleDescriptionBase>;
var
...
begin
  ...
  begin
    ...
    begin
      ...
      AStyleDescription := TdxStyleDescriptionFactory.CreateStyleDescription
        (AReader, GetStyleType(AReader), StylesInformation);
      AStyleDescription.StyleIndex := Result.Count;
      Result.Add(AStyleDescription);
      AReader.BaseStream.Seek(ACurrentPosition + AStyleDescriptionLength,
        TSeekOrigin.soBeginning);
    end
    else
      Result.Add(nil);
...
class function TdxStyleDescriptionFactory.CreateStyleDescription
  (AReader: TBinaryReader; AType: TdxStyleType; AInfo: TdxStyleSheetInformation)
  : TdxStyleDescriptionBase;
var
  ASize: SmallInt;
  AIsExtended: Boolean;
begin
  ...
  case AType of
    TdxStyleType.ParagraphStyle:
      Result := TdxParagraphStyleDescription.FromStream(AReader, ASize,
        AIsExtended);
    TdxStyleType.CharacterStyle:
      Result := TdxCharacterStyleDescription.FromStream(AReader, ASize,
        AIsExtended);
    TdxStyleType.TableStyle:
      Result := TdxTableStyleDescription.FromStream(AReader, ASize,
        AIsExtended);
