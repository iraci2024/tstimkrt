...
uses
  ...
  cxGridCustomView, cxGraphics, dxCore, cxGridBandedTableView,
...
type
  ...
  published
    ...
    property Options: TcxGridServerModeBandedColumnOptions read GetOptions
      write SetOptions;
  end;

  { TcxGridServerModeBandedSummaryItem }

  TcxGridServerModeBandedSummaryItem = class(TdxServerModeSummaryItem, IUnknown,
  ...
  published
    property Column: TcxGridServerModeBandedColumn read GetColumn
      write SetColumn;
  ...
  public
    ...
    function GetColumnByFieldName(const AFieldName: string)
      : TcxGridServerModeBandedColumn;
    property Columns[Index: Integer]: TcxGridServerModeBandedColumn
...
procedure TcxGridServerModeBandedColumn.GetBestFitRecordRange(out AFirstIndex,
  ALastIndex: Integer);
begin
...
function TcxGridServerModeBandedSummaryItem.GetColumn
  : TcxGridServerModeBandedColumn;
begin
  Result := TcxGridServerModeBandedColumn(ItemLink);
end;

function TcxGridServerModeBandedSummaryItem.GetGridView
  : TcxGridServerModeBandedTableView;
begin
  Result := TcxGridServerModeBandedTableView
    (TcxGridDBDataController(DataController).GridView);
end;

procedure TcxGridServerModeBandedSummaryItem.SetColumn
  (Value: TcxGridServerModeBandedColumn);
begin
  ItemLink := Value;
end;

procedure TcxGridServerModeBandedSummaryItem.SetDisplayText
  (const Value: string);
begin
...
procedure TcxGridServerModeBandedSummaryItem.SetVisibleForCustomization
  (Value: Boolean);
begin
...
function TcxGridServerModeBandedSummaryItem.QueryInterface(const IID: TGUID;
  out Obj): HResult;
const
...
function TcxGridServerModeBandedSummaryItem.GetProperties
  (AProperties: TStrings): Boolean;
begin
  Result := False;
end;

procedure TcxGridServerModeBandedSummaryItem.GetPropertyValue
...
procedure TcxGridServerModeBandedSummaryItem.SetPropertyValue
  (const AName: string; const AValue: Variant);
begin
  if AName = 'Column' then
    Column := TcxGridServerModeBandedColumn
...
function TcxGridServerModeBandedTableView.GetColumn(Index: Integer)
  : TcxGridServerModeBandedColumn;
begin
  Result := TcxGridServerModeBandedColumn(inherited Columns[Index]);
end;

procedure TcxGridServerModeBandedTableView.SetColumn(Index: Integer;
  Value: TcxGridServerModeBandedColumn);
begin
  inherited Columns[Index] := Value;
end;

function TcxGridServerModeBandedTableView.GetDataController
  : TcxGridServerModeDataController;
begin
  Result := TcxGridServerModeDataController(FDataController);
end;

procedure TcxGridServerModeBandedTableView.SetDataController
  (Value: TcxGridServerModeDataController);
begin
  FDataController.Assign(Value);
end;

function TcxGridServerModeBandedTableView.GetDataControllerClass
  : TcxCustomDataControllerClass;
begin
  Result := TcxGridServerModeDataController;
end;

function TcxGridServerModeBandedTableView.GetItemClass
  : TcxCustomGridTableItemClass;
begin
  Result := TcxGridServerModeBandedColumn;
end;

function TcxGridServerModeBandedTableView.GetSummaryItemClass
  : TcxDataSummaryItemClass;
begin
  Result := TcxGridServerModeBandedSummaryItem;
end;

function TcxGridServerModeBandedTableView.GetViewDataClass
...
function TcxGridServerModeBandedTableView.GetConditionalFormattingProvider
...
function TcxGridServerModeBandedTableView.
  IsPersistentMultiSelectSupported: Boolean;
begin
  Result := False;
end;

function TcxGridServerModeBandedTableView.CreateColumn
  : TcxGridServerModeBandedColumn;
begin
  Result := TcxGridServerModeBandedColumn(inherited CreateColumn);
end;

function TcxGridServerModeBandedTableView.CreateScrollbarAnnotations
  : TcxGridScrollbarAnnotationOptions;
begin
  Result := TcxGridServerModeScrollbarAnnotationOptions.Create(Self);
end;

function TcxGridServerModeBandedTableView.GetColumnByFieldName(const AFieldName
  : string): TcxGridServerModeBandedColumn;
begin
  Result := TcxGridServerModeBandedColumn
...
cxGridRegisteredViews.Register(TcxGridServerModeBandedTableView,
  'Server Mode Banded Table');
