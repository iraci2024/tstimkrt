...
constructor TdxInsertTableFormControllerParameters.Create(const AControl
  : IdxRichEditControl; const AParameters: TdxCreateTableParameters);
begin
...
constructor TdxInsertTableFormController.Create(AControllerParameters
  : TdxInsertTableFormControllerParameters);
begin
  inherited Create;
