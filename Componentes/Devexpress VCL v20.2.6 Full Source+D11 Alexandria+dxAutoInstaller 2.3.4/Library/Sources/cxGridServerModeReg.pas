...
uses
  ...
  cxGridCustomTableView, cxGridServerModeDataDefinitions,
...
function TcxServerModeDataBindingFieldNamePropertyEditor.GetAttributes
  : TPropertyAttributes;
begin
  Result := [paValueList, paSortList];
end;

function TcxServerModeDataBindingFieldNamePropertyEditor.GetDataBinding
...
{$IFNDEF NONDB}
  ...
  RegisterPropertyEditor(TypeInfo(string), TcxGridItemServerModeDataBinding,
    'FieldName', TcxServerModeDataBindingFieldNamePropertyEditor);
  ...
  UnlistPublishedProperty(TcxGridServerModeColumn,
    'VisibleForExpressionEditor');
  UnlistPublishedProperty(TcxGridServerModeBandedColumn,
    'VisibleForExpressionEditor');
  ...
  UnlistPublishedProperty(TcxGridServerModeScrollbarAnnotationOptions,
    'ShowErrors');
  UnlistPublishedProperty(TcxGridServerModeScrollbarAnnotationOptions,
    'ShowSearchResults');
...
{$ENDIF}
  RegisterPropertyEditor(TypeInfo(TcxGridServerModeColumn),
    TcxGridServerModeSummaryItem, 'Column',
