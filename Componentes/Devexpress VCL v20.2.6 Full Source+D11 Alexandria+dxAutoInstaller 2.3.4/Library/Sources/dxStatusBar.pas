...
uses
  ...
  ExtCtrls,
  dxThemeManager, dxCore, cxClasses, cxGraphics, cxGeometry, cxControls,
  cxLookAndFeels,
...
type
  ...
  protected
    ...
    procedure DrawContent(ACanvas: TcxCanvas; R: TRect;
      APainter: TdxStatusBarPainterClass); virtual;
  ...
  TdxStatusBarTextEvent = procedure(Sender: TObject; const R: TRect;
  ...
  protected
    ...
    procedure DrawContent(ACanvas: TcxCanvas; R: TRect;
      APainter: TdxStatusBarPainterClass); override;
  public
  ...
  published
    ...
    property ImageIndex: TcxImageIndex read FImageIndex write SetImageIndex
      default -1;
    property EllipsisType: TdxStatusBarEllipsisType read FEllipsisType
      write SetEllipsisType default dxetNone;
    property Font;
    property ParentFont;
  ...
  TdxStatusBarStateIndicatorType = (sitOff, sitYellow, sitBlue, sitGreen,
    sitRed, sitTeal, sitPurple);
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property IndicatorType: TdxStatusBarStateIndicatorType read FIndicatorType
      write SetIndicatorType default sitOff;
  ...
  public
    ...
    property Items[Index: Integer]: TdxStatusBarStateIndicatorItem read GetItem
  ...
  published
    property Color;
    property Indicators: TdxStatusBarStateIndicators read FIndicators
      write SetIndicators;
  ...
  TdxStatusBarKeyboardState = (dxksCapsLock, dxksNumLock, dxksScrollLock,
    dxksInsert);
  ...
  public
    ...
    function GetRectWidth(ACanvas: TcxCanvas; AScaleFactor: TdxScaleFactor)
      : Integer; overload;

    property Code: Integer read FCode;
    property Id: TdxStatusBarKeyboardState read FId;
  published
    property ActiveFontColor: TColor read FActiveFontColor
      write SetActiveFontColor default clWindowText;
    property InactiveFontColor: TColor read FInactiveFontColor
      write SetInactiveFontColor default clBtnShadow;
    property ActiveCaption: string read FActiveCaption write SetActiveCaption;
    property InactiveCaption: string read FInactiveCaption
      write SetInactiveCaption;
  end;
  ...
  strict private
    ...
    procedure SetAppearance(Index: Integer;
      Value: TdxStatusBarKeyStateAppearance);
  ...
  published
    property Color;
    property Font;
    property KeyboardStates: TdxStatusBarKeyboardStates read FKeyboardStates
      write SetKeyboardStates default [dxksCapsLock, dxksNumLock,
      dxksScrollLock, dxksInsert];
    property FullRect: Boolean read FFullRect write SetFullRect default False;

    property CapsLockKeyAppearance: TdxStatusBarKeyStateAppearance index 0
      read GetAppearance write SetAppearance;
    property NumLockKeyAppearance: TdxStatusBarKeyStateAppearance index 1
      read GetAppearance write SetAppearance;
    property ScrollLockKeyAppearance: TdxStatusBarKeyStateAppearance index 2
      read GetAppearance write SetAppearance;
    property InsertKeyAppearance: TdxStatusBarKeyStateAppearance index 3
      read GetAppearance write SetAppearance;
    property ParentFont;
  end;
  ...
  public
    ...
    procedure RestoreDefaults; override;
  published
    property AlignControl: Boolean read FAlignControl write FAlignControl
      default True;
    property Container: TdxStatusBarContainerControl read FContainer
      write SetContainer; // for internal use
  end;

  { TdxStatusBarPanel }

  TdxStatusBarPanelBevel = (dxpbNone, dxpbLowered, dxpbRaised);
  TdxStatusBarDrawPanelEvent = procedure(Sender: TdxStatusBarPanel;
    ACanvas: TcxCanvas; const ARect: TRect; var ADone: Boolean) of object;
  ...
  public
    ...
    property PanelStyleClass: TdxStatusBarPanelStyleClass read FPanelStyleClass
      write SetPanelStyleClass;
    property StatusBarControl: TdxCustomStatusBar read GetStatusBarControl;
  published
    property PanelStyleClassName: string read GetPanelStyleClassName
      write SetPanelStyleClassName;
    property PanelStyle: TdxStatusBarPanelStyle read FPanelStyle
      write SetPanelStyle;
    property PanelStyleEvents: TNotifyEvent read FPanelStyleEvents
      write FPanelStyleEvents;

    property Bevel: TdxStatusBarPanelBevel read FBevel write SetBevel
      default dxpbLowered;
    ...
    property OnDrawPanel: TdxStatusBarDrawPanelEvent read FOnDrawPanel
      write FOnDrawPanel;
  end;
  ...
  public
    ...
    property Items[Index: Integer]: TdxStatusBarPanel read GetItem
      write SetItem; default;
  end;
  ...
  TdxStatusBarPaintStyle = (stpsStandard, stpsFlat, stpsXP, stpsOffice11,
    stpsUseLookAndFeel);

  TdxStatusBarPainter = class
  protected
    class function GetSizeGripBackgroundColor(AStatusBar: TdxCustomStatusBar)
      : TColor; virtual;
    class procedure DrawSizeGripCore(ACanvas: TcxCanvas; const ARect: TRect;
      AScaleFactor: TdxScaleFactor); virtual;
    class procedure DrawContainerControl(APanelStyle
      : TdxStatusBarContainerPanelStyle); virtual;
  public
    // calc
    class procedure AdjustTextColor(AStatusBar: TdxCustomStatusBar;
      var AColor: TColor; Active: Boolean); virtual;
    class function ContentExtents(AStatusBar: TdxCustomStatusBar)
      : TRect; virtual;
    ...
    class function IsSizeGripInPanelArea(AStatusBar: TdxCustomStatusBar)
      : Boolean; virtual;
    class function PanelBorderSizes(ABevel: TdxStatusBarPanelBevel)
      : TRect; virtual;
    class function PanelContentExtents(AStatusBar: TdxCustomStatusBar;
      AHasBorders: Boolean): TRect; virtual;
    class function SeparatorSize(AStatusBar: TdxCustomStatusBar)
      : Integer; virtual;
    class function SizeGripMargins(AStatusBar: TdxCustomStatusBar)
      : TRect; virtual;
    class function TopBorderSize: Integer; virtual;
    // draw
    class procedure DrawBorder(AStatusBar: TdxCustomStatusBar;
      ACanvas: TcxCanvas; var R: TRect); virtual;
    class procedure DrawEmptyPanel(AStatusBar: TdxCustomStatusBar;
    ...
    class procedure DrawPanelBorder(AStatusBar: TdxCustomStatusBar;
      ABevel: TdxStatusBarPanelBevel; ACanvas: TcxCanvas;
      var R: TRect); virtual;
    ...
    class procedure DrawSizeGrip(AStatusBar: TdxCustomStatusBar;
      ACanvas: TcxCanvas; R: TRect); virtual;
    class procedure DrawTopBorder(AStatusBar: TdxCustomStatusBar;
      ACanvas: TcxCanvas; const R: TRect); virtual;
    class procedure FillBackground(AStatusBar: TdxCustomStatusBar;
      APanel: TdxStatusBarPanel; ACanvas: TcxCanvas; const R: TRect); virtual;
    class function GetPanelBevel(APanel: TdxStatusBarPanel)
      : TdxStatusBarPanelBevel; virtual;
    class function GetPanelColor(AStatusBar: TdxCustomStatusBar;
      APanel: TdxStatusBarPanel): TColor; virtual;
  ...
  public
    ...
    class function ContentExtents(AStatusBar: TdxCustomStatusBar)
      : TRect; override;
    class function GripAreaSize(AStatusBar: TdxCustomStatusBar): TSize;
      override;
    class function SeparatorSize(AStatusBar: TdxCustomStatusBar)
      : Integer; override;
    class function SizeGripMargins(AStatusBar: TdxCustomStatusBar)
  ...
  protected
    ...
    procedure CalculatePanelsViewInfos(const ABounds: TRect;
      AAutoWidthObject: TcxAutoWidthObject);
    function CalculateSizeGripRect(const ABounds: TRect): TRect;
    function CreatePanelViewInfo(APanel: TdxStatusBarPanel)
      : TdxStatusBarPanelViewInfo; virtual;
    function CreateSimplePanelViewInfo
      : TdxStatusBarSimplePanelViewInfo; virtual;
    procedure DoRightToLeftConversion(const ABounds: TRect); virtual;
  ...
  public
    ...
    property PanelViewInfo[Index: Integer]: TdxStatusBarPanelViewInfo
      read GetPanelViewInfo;
    property SimplePanelViewInfo: TdxStatusBarSimplePanelViewInfo
      read FSimplePanelViewInfo;
  ...
  protected
    ...
    procedure DoRightToLeftConversion(const ABounds: TRect); virtual;
    class function GetDefaultPanelStyleClass
      : TdxStatusBarPanelStyleClass; virtual;
    ...
    property PaintStyle: TdxStatusBarPaintStyle read FPaintStyle
      write SetPaintStyle default stpsStandard;
    property Panels: TdxStatusBarPanels read FPanels write SetPanels;
    property SimplePanelStyle: TdxStatusBarSimplePanelStyle
      read FSimplePanelStyle write SetSimplePanelStyle;
  ...
  public
    ...
    function CanAcceptPanelStyle(Value: TdxStatusBarPanelStyleClass)
      : Boolean; virtual;
...
procedure LoadIndicatorBitmap(ABitmap: TBitmap;
  AIndicatorType: TdxStatusBarStateIndicatorType); overload;
procedure LoadIndicatorBitmap(ABitmap: TBitmap;
  AIndicatorType: TdxStatusBarStateIndicatorType;
...
uses
  ActnList, StdActns, Types, Math, dxThemeConsts, dxUxTheme, dxOffice11,
  dxDPIAwareUtils, dxSkinsdxStatusBarPainter, dxCoreGraphics;
...
procedure LoadIndicatorBitmap(ABitmap: TBitmap;
  AIndicatorType: TdxStatusBarStateIndicatorType; AScaleFactor: TdxScaleFactor);
const
  Names: array [TdxStatusBarStateIndicatorType] of string = ('DXSTATUSBAR_GRAY',
    'DXSTATUSBAR_YELLOW', 'DXSTATUSBAR_BLUE', 'DXSTATUSBAR_GREEN',
...
procedure GenContainerName(APanel: TdxStatusBarPanel;
  AContainer: TdxStatusBarContainerControl);
var
  I: Integer;
begin
  I := APanel.Id;
  while I <> -1 do
    try
      AContainer.Name := APanel.StatusBarControl.Name + 'Container' +
        IntToStr(I);
      I := -1;
    except
...
begin
  ...
  begin
    if (StatusBarControl.ViewInfo.PanelCount > 0) and
      (StatusBarControl.ViewInfo.Panels[StatusBarControl.ViewInfo.PanelCount -
      1] = Owner) then
...
procedure TdxStatusBarTextPanelStyle.DrawContent(ACanvas: TcxCanvas; R: TRect;
  APainter: TdxStatusBarPainterClass);
const
  AShowEndEllipsis: array [TdxStatusBarEllipsisType] of Integer = (0,
    cxShowEndEllipsis, cxShowPathEllipsis);
var
...
begin
  ...
  begin
    ...
    cxDrawImage(ACanvas, cxRectBounds(ARealLeft, ATop, AImageSize.cx,
      AImageSize.cy), nil, StatusBarControl.Images, ImageIndex, True, nil,
      ScaleFactor);
  end;
  ...
  if StatusBarControl.UseRightToLeftAlignment then
    AAlignmentFlag := TdxRightToLeftLayoutConverter.ConvertcxDrawTextAlignment
      (cxAlignmentsHorz[Alignment])
  else
...
begin
  ...
  begin
    for I := 0 to StatusBarControl.Panels.Count - 1 do
      if StatusBarControl.Panels[I].PanelStyle is TdxStatusBarTextPanelStyle
      then
        TdxStatusBarTextPanelStyle(StatusBarControl.Panels[I].PanelStyle)
          .FAutoHint := False;
    FAutoHint := Value;
  end;
end;

procedure TdxStatusBarTextPanelStyle.SetEllipsisType
  (Value: TdxStatusBarEllipsisType);
begin
...
begin
  Result := Visible and (FIndicatorBitmap <> nil) and
    not FIndicatorBitmap.Empty;
end;

procedure TdxStatusBarStateIndicatorItem.UpdateResources;
begin
  LoadIndicatorBitmap(FIndicatorBitmap, FIndicatorType,
    dxGetScaleFactor(TdxStatusBarStateIndicators(Collection).Owner));
  Changed(False);
end;

procedure TdxStatusBarStateIndicatorItem.SetIndicatorType
...
function TdxStatusBarStateIndicators.Insert(AIndex: Integer)
  : TdxStatusBarStateIndicatorItem;
begin
  BeginUpdate;
  try
...
function TdxStatusBarStateIndicators.GetItem(Index: Integer)
  : TdxStatusBarStateIndicatorItem;
begin
  Result := TdxStatusBarStateIndicatorItem(inherited GetItem(Index));
end;

procedure TdxStatusBarStateIndicators.SetItem(Index: Integer;
  Value: TdxStatusBarStateIndicatorItem);
begin
...
constructor TdxStatusBarStateIndicatorPanelStyle.Create
  ...
  for I := 0 to Indicators.Count - 1 do
    ...
    begin
      ...
      if StatusBarControl.UseRightToLeftAlignment then
        ...
        AItemLeft := R.Left;
      ACanvas.Draw(AItemLeft, (R.Top + R.Bottom - ABitmap.Height)
        div 2, ABitmap);
...
begin
  ...
  begin
    ...
    begin
      if Indicators[I].CanDisplay then
        Inc(Result, Indicators[I].IndicatorBitmap.Width +
          ScaleFactor.Apply(Spacing));
    end;
    Inc(Result, cxMarginsWidth(Painter.PanelContentExtents(StatusBarControl,
...
procedure TdxStatusBarStateIndicatorPanelStyle.IndicatorChangeHandler
  (Sender: TObject);
begin
  Owner.Changed(False);
end;

procedure TdxStatusBarStateIndicatorPanelStyle.SetIndicators
  (Value: TdxStatusBarStateIndicators);
begin
...
constructor TdxStatusBarKeyboardStateNotifier.Create
...
constructor TdxStatusBarKeyStateAppearance.Create
  (AId: TdxStatusBarKeyboardState; ACode: Integer; const AActiveCaption: string;
  AActiveFontColor: TColor; const AInactiveCaption: string;
  AInactiveFontColor: TColor; AChangeHandler: TNotifyEvent);
begin
  inherited Create;
  FId := AId;
  FCode := ACode;
...
begin
  ...
  begin
    ...
    InactiveFontColor := TdxStatusBarKeyStateAppearance(Source)
      .InactiveFontColor;
...
function TdxStatusBarKeyStateAppearance.GetRectWidth
  (ACanvas: TcxCanvas): Integer;
begin
  Result := GetRectWidth(ACanvas, dxSystemScaleFactor);
end;

function TdxStatusBarKeyStateAppearance.GetRectWidth(ACanvas: TcxCanvas;
  AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := Max(ACanvas.TextWidth(FActiveCaption),
    ACanvas.TextWidth(FInactiveCaption)) + 2 * AScaleFactor.Apply(cxTextOffset);
end;
...
procedure TdxStatusBarKeyStateAppearance.SetInactiveCaption
  (const Value: string);
begin
...
constructor TdxStatusBarKeyboardStatePanelStyle.Create
  (AOwner: TdxStatusBarPanel);
var
  I: Integer;
begin
  inherited Create(AOwner);
  FKeyInfos[0] := TdxStatusBarKeyStateAppearance.Create(dxksCapsLock,
    VK_CAPITAL, 'CAPS', FFont.Color, 'CAPS', clBtnShadow, NamesChangeHandler);
  FKeyInfos[1] := TdxStatusBarKeyStateAppearance.Create(dxksNumLock, VK_NUMLOCK,
    'NUM', FFont.Color, 'NUM', clBtnShadow, NamesChangeHandler);
  FKeyInfos[2] := TdxStatusBarKeyStateAppearance.Create(dxksScrollLock,
    VK_SCROLL, 'SCRL', FFont.Color, 'SCRL', clBtnShadow, NamesChangeHandler);
  FKeyInfos[3] := TdxStatusBarKeyStateAppearance.Create(dxksInsert, VK_INSERT,
    'OVR', FFont.Color, 'INS', clBtnShadow, NamesChangeHandler);
  FKeyboardStates := [FKeyInfos[0].Id, FKeyInfos[1].Id, FKeyInfos[2].Id,
    FKeyInfos[3].Id];
...
begin
  ...
  begin
    ...
    begin
      AActive := not(csDesigning in StatusBarControl.ComponentState) and
        (Lo(GetKeyState(AKeyInfo.Code)) = 1);
      if AActive then
      begin
      ...
      R.Right := R.Left + AKeyInfo.GetRectWidth(ACanvas, ScaleFactor) +
        cxMarginsWidth(APainter.PanelContentExtents(StatusBarControl,
        not FullRect));
      ARect := R;
      if StatusBarControl.UseRightToLeftAlignment then
      ...
      ACanvas.Brush.Style := bsClear;
      ACanvas.DrawText(ACaption, ARect, cxSingleLine or cxAlignVCenter or
        cxAlignHCenter, StatusBarControl.Enabled);
      ACanvas.Brush.Style := bsSolid;
...
function TdxStatusBarKeyboardStatePanelStyle.GetAppearance(Index: Integer)
  : TdxStatusBarKeyStateAppearance;
begin
  Result := FKeyInfos[Index];
end;

procedure TdxStatusBarKeyboardStatePanelStyle.NamesChangeHandler
  (Sender: TObject);
begin
  Owner.Changed(False);
end;
...
procedure TdxStatusBarKeyboardStatePanelStyle.SetAppearance(Index: Integer;
  Value: TdxStatusBarKeyStateAppearance);
begin
  FKeyInfos[Index].Assign(Value);
end;

procedure TdxStatusBarKeyboardStatePanelStyle.SetKeyboardStates
  (Value: TdxStatusBarKeyboardStates);
begin
...
begin
  Result := (FPanelStyle <> nil) and FPanelStyle.AlignControl and
    not FPanelStyle.StatusBarControl.IsDesigning;
end;
...
procedure TdxStatusBarContainerControl.CMControlChange
...
begin
  inherited Create(AOwner);
  FAlignControl := True;
  if StatusBarControl.ComponentState * [csUpdating, csLoading, csReading] = []
  then
  begin
...
begin
  ...
  begin
    R := cxRectContent(ABounds,
      Painter.PanelBorderSizes(Painter.GetPanelBevel(Owner)));
    CheckSizeGripRect(R);
...
procedure TdxStatusBarContainerPanelStyle.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  if Container <> nil then
    Container.BoundsRect := TdxRightToLeftLayoutConverter.ConvertRect
      (FContainerBoundsRect, ABounds);
end;
...
begin
  if Container <> nil then
    Container.Visible := Owner.Visible and
      not Owner.StatusBarControl.SimplePanelStyle.Active;
end;

procedure TdxStatusBarContainerPanelStyle.SetContainer
  (Value: TdxStatusBarContainerControl);
begin
  ...
  begin
    ...
    begin
      ...
      if StatusBarControl.ComponentState * [csDestroying, csUpdating, csLoading,
        csReading] <> [] then
        FContainer := nil
      else
...
begin
  if (StatusBarControl.ComponentState * [csDestroying, csUpdating, csLoading,
    csReading] = []) and (PanelStyle <> nil) and not PanelStyle.CanDelete then
...
begin
  ...
  begin
    ...
    if StatusBarControl.SizeGripAllocated then
    begin
      if Self = StatusBarControl.ViewInfo.Panels
        [StatusBarControl.ViewInfo.PanelCount - 1] then
...
begin
  if not FIsMinWidthAssigned or (PanelStyle <> nil) and not PanelStyle.CanSizing
  then
    Result := DefaultMinWidth
  else
...
begin
  if not FIsWidthAssigned or (PanelStyle <> nil) and not PanelStyle.CanSizing
  then
    Result := DefaultWidth
  else
...
procedure TdxStatusBarPanel.SetPanelStyleClass(const Value
  : TdxStatusBarPanelStyleClass);
begin
  if (FPanelStyleClass <> Value) and StatusBarControl.CanAcceptPanelStyle(Value)
  then
  begin
    DestroyPanelStyle;
...
procedure TdxStatusBarViewInfo.AddCalculatedItems(AAutoWidthObject
  : TcxAutoWidthObject);
  ...
  procedure AddAutoWidthPanel(APanel: TdxStatusBarPanel; APanelIndex: Integer;
    var ANonFixedExists: Boolean);
  var
...
begin
  ...
  if cxRectIsEmpty(SizeGripRect) or IsSizeGripInPanelArea then
    AWidth := cxRectWidth(ABounds) + cxMarginsWidth
      (Painter.ContentExtents(StatusBar))
  else
    AWidth := SizeGripRect.Left - Painter.SizeGripMargins(StatusBar).Left -
      ABounds.Left;
...
procedure TdxStatusBarViewInfo.CalculatePanelsViewInfos(const ABounds: TRect;
  AAutoWidthObject: TcxAutoWidthObject);
var
...
begin
  ...
  begin
    ...
    APanelViewInfo.Bounds := cxRectSetWidth(R,
      AAutoWidthObject[AIndex].AutoWidth);
    R.Left := APanelViewInfo.Bounds.Right;
    if AIndex + 1 < AAutoWidthObject.Count then
    begin
      APanelViewInfo.SeparatorRect :=
        cxRectSetWidth(R, AAutoWidthObject[AIndex + 1].AutoWidth);
...
function TdxStatusBarViewInfo.CalculateSizeGripRect(const ABounds
  : TRect): TRect;
begin
...
function TdxStatusBarViewInfo.CreatePanelViewInfo(APanel: TdxStatusBarPanel)
  : TdxStatusBarPanelViewInfo;
begin
  Result := TdxStatusBarPanelViewInfo.Create(APanel);
end;

function TdxStatusBarViewInfo.CreateSimplePanelViewInfo
  : TdxStatusBarSimplePanelViewInfo;
begin
...
var
  I: Integer;
begin
  FSizeGripRect := TdxRightToLeftLayoutConverter.ConvertRect
    (FSizeGripRect, ABounds);
  if StatusBar.SimplePanelStyle.Active then
...
function TdxStatusBarViewInfo.GetPanelViewInfo(Index: Integer)
  : TdxStatusBarPanelViewInfo;
begin
...
begin
  Result := cxRectSetRight(SizeGripRect, SizeGripRect.Right,
    cxRectWidth(SizeGripRect) + Painter.SeparatorSize(StatusBar));
end;
...
constructor TdxStatusBarCustomPanelViewInfo.Create
  (AStatusBar: TdxCustomStatusBar);
begin
  inherited Create;
  FStatusBar := AStatusBar;
...
begin
  Result := Max(Painter.GripAreaSize(StatusBar).cy,
    TdxTextMeasurer.TextLineHeight(PanelFont) +
    cxMarginsHeight(Painter.PanelContentExtents(StatusBar,
    PanelBevel <> dxpbNone))) + cxMarginsHeight
    (Painter.PanelBorderSizes(PanelBevel));
end;

procedure TdxStatusBarCustomPanelViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
...
procedure TdxStatusBarCustomPanelViewInfo.RightToLeftConversion
  (const ABounds: TRect);
begin
  if not FIsRightToLeftConverted then
  begin
...
procedure TdxStatusBarPanelViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
  FSeparatorRect := TdxRightToLeftLayoutConverter.ConvertRect
    (FSeparatorRect, ABounds);
...
begin
  Painter.DrawSimplePanel(StatusBar, StatusBar.SimplePanelStyle.Text,
    ACanvas, Bounds);
end;
...
function TdxCustomStatusBar.CanAcceptPanelStyle
  (Value: TdxStatusBarPanelStyleClass): Boolean;
begin
  Result := (Value = nil) or (Value.GetVersion = 0);
end;

function TdxCustomStatusBar.CanAutoSize(var NewWidth,
...
function TdxCustomStatusBar.ContainerByName(const AName: string)
  : TdxStatusBarContainerControl;
var
  I: Integer;
begin
  ...
  for I := 0 to ControlCount - 1 do
    if (Controls[I] is TdxStatusBarContainerControl) and
      (CompareText(TdxStatusBarContainerControl(Controls[I]).Name, AName) = 0)
    then
    begin
...
begin
  Result := False;
  if not(csDesigning in ComponentState) and (Action is THintAction) and not DoHint
  then
  begin
...
procedure TdxCustomStatusBar.AdjustTextColor(var AColor: TColor;
  Active: Boolean);
begin
end;
...
procedure TdxCustomStatusBar.LookAndFeelChanged(Sender: TcxLookAndFeel;
...
procedure TdxCustomStatusBar.Notification(AComponent: TComponent;
...
class function TdxCustomStatusBar.GetDefaultPanelStyleClass
  : TdxStatusBarPanelStyleClass;
begin
...
begin
  if (PaintStyle = stpsUseLookAndFeel) and Assigned(dxStatusBarSkinPainterClass)
    and Assigned(LookAndFeel.SkinPainter) then
...
const
  AStyles: array [TcxLookAndFeelKind] of TdxStatusBarPaintStyle = (stpsStandard,
    stpsStandard, stpsFlat, stpsOffice11);
begin
...
procedure TdxCustomStatusBar.SetSimplePanelStyle
  (Value: TdxStatusBarSimplePanelStyle);
begin
  ...
  if not(csDesigning in ComponentState) and SizeGripAllocated then
    ...
    begin
      ...
      R := Rect(ABounds.Right - Painter.GripAreaSize(Self).cx - 2,
        ABounds.Bottom - Painter.GripAreaSize(Self).cy - 2, ABounds.Right,
        ABounds.Bottom);
      if UseRightToLeftAlignment then
...
class procedure TdxStatusBarPainter.AdjustTextColor
  (AStatusBar: TdxCustomStatusBar; var AColor: TColor; Active: Boolean);
begin
end;

class function TdxStatusBarPainter.ContentExtents
  (AStatusBar: TdxCustomStatusBar): TRect;
begin
  Result := Rect(AStatusBar.BorderWidth, AStatusBar.BorderWidth + TopBorderSize,
    AStatusBar.BorderWidth, AStatusBar.BorderWidth);
end;

class function TdxStatusBarPainter.GripAreaSize
  (AStatusBar: TdxCustomStatusBar): TSize;
begin
  Result := AStatusBar.ScaleFactor.Apply(cxSize(16));
end;

class function TdxStatusBarPainter.GripSize(AStatusBar
  : TdxCustomStatusBar): TSize;
begin
...
class function TdxStatusBarPainter.IsSizeGripInPanelArea
  (AStatusBar: TdxCustomStatusBar): Boolean;
begin
  Result := True;
end;

class function TdxStatusBarPainter.PanelBorderSizes
  (ABevel: TdxStatusBarPanelBevel): TRect;
begin
  Result := cxNullRect;
end;
...
class function TdxStatusBarPainter.SeparatorSize
  (AStatusBar: TdxCustomStatusBar): Integer;
begin
  Result := 2;
end;

class function TdxStatusBarPainter.SizeGripMargins
  (AStatusBar: TdxCustomStatusBar): TRect;
begin
...
begin
  // top border
  DrawTopBorder(AStatusBar, ACanvas, Rect(R.Left, R.Top, R.Right,
    R.Top + TopBorderSize));
  ...
  begin
    ...
    ACanvas.FillRect(Rect(R.Left, R.Top, R.Right,
      R.Top + AStatusBar.BorderWidth));
    Inc(R.Top, AStatusBar.BorderWidth);
    ACanvas.FillRect(Rect(R.Left, R.Bottom - AStatusBar.BorderWidth, R.Right,
      R.Bottom));
    Dec(R.Bottom, AStatusBar.BorderWidth);
    ACanvas.FillRect(Rect(R.Left, R.Top, R.Left + AStatusBar.BorderWidth,
      R.Bottom));
    Inc(R.Left, AStatusBar.BorderWidth);
    ACanvas.FillRect(Rect(R.Right - AStatusBar.BorderWidth, R.Top, R.Right,
      R.Bottom));
    Dec(R.Right, AStatusBar.BorderWidth);
  end;
end;

class procedure TdxStatusBarPainter.DrawEmptyPanel
...
begin
  ...
  else if not APanel.Visible then
    FillBackground(AStatusBar, nil, ACanvas, R)
  else
  begin
    ACanvas.SaveState;
...
class procedure TdxStatusBarPainter.DrawPanelBorder
  (AStatusBar: TdxCustomStatusBar; ABevel: TdxStatusBarPanelBevel;
  ACanvas: TcxCanvas; var R: TRect);
begin
end;

class procedure TdxStatusBarPainter.DrawPanelSeparator
  (AStatusBar: TdxCustomStatusBar; ACanvas: TcxCanvas; const R: TRect);
begin
end;

class procedure TdxStatusBarPainter.DrawSimplePanel
  (AStatusBar: TdxCustomStatusBar; const AText: string; ACanvas: TcxCanvas;
  R: TRect);

  procedure DrawSimplePanelText(ACanvas: TcxCanvas; R: TRect;
    const AText: string);
  var
    ATextColor: TColor;
    AFlags: Cardinal;
...
begin
  dxRotateSizeGrip(ACanvas, R, AStatusBar.ScaleFactor,
    GetSizeGripBackgroundColor(AStatusBar),
    CornerMap[AStatusBar.UseRightToLeftAlignment], DrawSizeGripCore);
end;

class procedure TdxStatusBarPainter.DrawTopBorder
  (AStatusBar: TdxCustomStatusBar; ACanvas: TcxCanvas; const R: TRect);
begin
  ACanvas.Brush.Color := AStatusBar.Color;
  ACanvas.FillRect(R);
...
class procedure TdxStatusBarPainter.FillBackground
  (AStatusBar: TdxCustomStatusBar; APanel: TdxStatusBarPanel;
  ACanvas: TcxCanvas; const R: TRect);
begin
end;

class function TdxStatusBarPainter.GetPanelBevel(APanel: TdxStatusBarPanel)
  : TdxStatusBarPanelBevel;
begin
  if APanel <> nil then
  begin
...
class function TdxStatusBarPainter.GetSizeGripBackgroundColor
  (AStatusBar: TdxCustomStatusBar): TColor;
begin
  Result := AStatusBar.Color;
end;

class procedure TdxStatusBarPainter.DrawSizeGripCore(ACanvas: TcxCanvas;
  const ARect: TRect; AScaleFactor: TdxScaleFactor);
begin
  cxLookAndFeelPaintersManager.GetPainter(lfsStandard).DoDrawSizeGrip(ACanvas,
    ARect, AScaleFactor);
end;

class procedure TdxStatusBarPainter.DrawContainerControl
...
begin
  ...
  FillBackground(APanelStyle.StatusBarControl, APanelStyle.Owner,
    AControl.Canvas, AControl.ClientRect);
end;

class procedure TdxStatusBarStandardPainter.DrawPanelBorder
  (AStatusBar: TdxCustomStatusBar; ABevel: TdxStatusBarPanelBevel;
  ACanvas: TcxCanvas; var R: TRect);
const
  ABorders: array [TdxStatusBarPanelBevel] of Integer = (0, BDR_SUNKENOUTER,
    BDR_RAISEDINNER);
begin
  DrawEdge(ACanvas.Handle, R, ABorders[ABevel], BF_RECT or BF_ADJUST);
end;

class procedure TdxStatusBarStandardPainter.DrawPanelSeparator
  (AStatusBar: TdxCustomStatusBar; ACanvas: TcxCanvas; const R: TRect);
begin
  ACanvas.Brush.Color := AStatusBar.Color;
  ACanvas.FillRect(R);
...
class procedure TdxStatusBarStandardPainter.FillBackground
  (AStatusBar: TdxCustomStatusBar; APanel: TdxStatusBarPanel;
  ACanvas: TcxCanvas; const R: TRect);
begin
...
class function TdxStatusBarStandardPainter.PanelBorderSizes
  (ABevel: TdxStatusBarPanelBevel): TRect;
begin
...
class function TdxStatusBarFlatPainter.PanelBorderSizes
  (ABevel: TdxStatusBarPanelBevel): TRect;
begin
  if ABevel = dxpbNone then
    Result := cxNullRect
...
class function TdxStatusBarOffice11Painter.ContentExtents
  (AStatusBar: TdxCustomStatusBar): TRect;
begin
  Result := AStatusBar.ScaleFactor.Apply(Rect(1, 1, 1, 1));
end;

class procedure TdxStatusBarOffice11Painter.DrawSizeGripCore(ACanvas: TcxCanvas;
  const ARect: TRect; AScaleFactor: TdxScaleFactor);
begin
  Office11DrawSizeGrip(ACanvas.Handle, ARect);
end;

class function TdxStatusBarOffice11Painter.GetSizeGripBackgroundColor
  (AStatusBar: TdxCustomStatusBar): TColor;
begin
  Result := clNone;
end;
...
begin
  Office11FillTubeGradientRect(ACanvas.Handle, R, dxOffice11ToolbarsColor1,
...
begin
  if ABevel <> dxpbNone then
  begin
    ACanvas.Brush.Color := dxGetMiddleRGB(dxOffice11ToolbarsColor2,
      clBlack { clBtnShadow } , 90);
    ACanvas.FrameRect(R);
  end;
  R := cxRectContent(R, PanelBorderSizes(ABevel));
end;
...
class function TdxStatusBarOffice11Painter.PanelBorderSizes
  (ABevel: TdxStatusBarPanelBevel): TRect;
begin
  if ABevel = dxpbNone then
    Result := cxNullRect
...
class function TdxStatusBarOffice11Painter.SizeGripMargins
  (AStatusBar: TdxCustomStatusBar): TRect;
begin
...
class function TdxStatusBarXPPainter.ContentExtents
  (AStatusBar: TdxCustomStatusBar): TRect;
begin
  Result := AStatusBar.ScaleFactor.Apply(Rect(0, TopBorderSize, 0, 0));
end;

class procedure TdxStatusBarXPPainter.DrawSizeGripCore(ACanvas: TcxCanvas;
  const ARect: TRect; AScaleFactor: TdxScaleFactor);
begin
  dxDrawThemeBackground(ACanvas.Handle, totStatus, AScaleFactor, ARect,
    SP_GRIPPER, 0);
end;

class function TdxStatusBarXPPainter.GripAreaSize
  (AStatusBar: TdxCustomStatusBar): TSize;
begin
  Result := GetThemeScaledPartSize(totStatus, AStatusBar.ScaleFactor,
    SP_GRIPPER, 0);
end;

class function TdxStatusBarXPPainter.SeparatorSize
  (AStatusBar: TdxCustomStatusBar): Integer;
begin
  Result := GetThemeScaledPartSize(totStatus, AStatusBar.ScaleFactor,
    SP_PANE, 0).cx;
...
class function TdxStatusBarXPPainter.SizeGripMargins
  (AStatusBar: TdxCustomStatusBar): TRect;
begin
  Result := AStatusBar.ScaleFactor.Apply(Rect(1, 0, 1, 0));
end;
...
class procedure TdxStatusBarXPPainter.DrawBorder(AStatusBar: TdxCustomStatusBar;
  ACanvas: TcxCanvas; var R: TRect);
begin
  dxDrawThemeBackground(ACanvas.Handle, totStatus,
    AStatusBar.ScaleFactor, R, 0, 0);
  Inc(R.Top, TopBorderSize);
end;

class procedure TdxStatusBarXPPainter.DrawPanelSeparator
  (AStatusBar: TdxCustomStatusBar; ACanvas: TcxCanvas; const R: TRect);
begin
  dxDrawThemeBackground(ACanvas.Handle, totStatus, AStatusBar.ScaleFactor, R,
    SP_PANE, 0);
end;

initialization

GetRegisteredStatusBarPanelStyles.Register(TdxStatusBarTextPanelStyle,
  cxSTextPanelStyle);
GetRegisteredStatusBarPanelStyles.Register(TdxStatusBarContainerPanelStyle,
  cxSContainerPanelStyle);
GetRegisteredStatusBarPanelStyles.Register(TdxStatusBarKeyboardStatePanelStyle,
  cxSKeyboardStatePanelStyle);
GetRegisteredStatusBarPanelStyles.Register(TdxStatusBarStateIndicatorPanelStyle,
  cxSStateIndicatorPanelStyle);
...
GetRegisteredStatusBarPanelStyles.Unregister
  (TdxStatusBarKeyboardStatePanelStyle);
GetRegisteredStatusBarPanelStyles.Unregister
  (TdxStatusBarStateIndicatorPanelStyle);
