...
uses
  ...
  cxTextEdit, cxMaskEdit, cxDropDownEdit, dxLayoutControl,
  cxGridWizardCustomPage, cxGridWizardStrs, cxGridLevel,
  cxGridCustomView, cxGridDBDataDefinitions, dxBevel, cxGroupBox,
  dxLayoutLookAndFeels, cxLabel, cxDBData;
...
type
  ...
  protected
    ...
    procedure PopulateDataSetFields(ADataSource: TDataSource;
...
begin
  ...
  lbMasterKeyFields.Caption := cxGetResourceString
    (@scxgwDataSourcePageMasterViewKeyFieldNames);
  lbMasterKeyFields.Hint := cxGetResourceString
    (@scxgwDataSourcePageMasterViewKeyFieldNamesHint);

  lbDetailKeyField.Caption := cxGetResourceString
    (@scxgwDataSourcePageDetailKeyFieldNames);
  lbDetailKeyField.Hint := cxGetResourceString
...
function TcxGridWizardDBViewsDataSourcePageFrame.CanBeMasterView
...
function TcxGridWizardDBViewsDataSourcePageFrame.GetDataController
  : TcxDBDataController;
begin
  Result := (Helper as IcxGridWizardHelperDBDataControllerSupport)
    .GetDataController;
end;
...
procedure TcxGridWizardDBViewsDataSourcePageFrame.PopulateDataSetFields
  (ADataSource: TDataSource; AComboBox: TcxComboBox);
var
  I: Integer;
begin
...
var
  I: Integer;
begin
  Helper.PopulateComponents(TDataSource, @CheckDataSet,
    cbDataSource.Properties.Items);
...
procedure TcxGridWizardDBViewsDataSourcePageFrame.
  PopulateMasterViewDataSetFields;
var
  AMasterGridViewDataController: TcxDBDataController;
begin
  AMasterGridViewDataController :=
    TcxDBDataController((cbMasterView.ItemObject as TcxCustomGridView)
    .DataController);
  PopulateDataSetFields(AMasterGridViewDataController.DataSource,
    cbMasterKeyField);
...
procedure TcxGridWizardDBViewsDataSourcePageFrame.cbDataSourcePropertiesChange
  (Sender: TObject);
begin
...
procedure TcxGridWizardDBViewsDataSourcePageFrame.
  cbDetailKeyFieldPropertiesChange(Sender: TObject);
begin
  DataController.DetailKeyFieldNames := cbDetailKeyField.Text;
end;

procedure TcxGridWizardDBViewsDataSourcePageFrame.cbKeyFieldPropertiesChange
  (Sender: TObject);
begin
...
procedure TcxGridWizardDBViewsDataSourcePageFrame.
  cbMasterKeyFieldPropertiesChange(Sender: TObject);
begin
  DataController.MasterKeyFieldNames := cbMasterKeyField.Text;
end;

procedure TcxGridWizardDBViewsDataSourcePageFrame.cbMasterViewPropertiesChange
  (Sender: TObject);
begin
  PopulateMasterViewDataSetFields;
  UpdateOwnerButtonsState;
...
procedure TcxGridWizardDBViewsDataSourcePageFrame.chbDetailPropertiesChange
  (Sender: TObject);
begin
