...
{ ExpressGaugeControl }
{ }
{ Copyright (c) 2013-2021 Developer Express Inc. }
{ ALL RIGHTS RESERVED }
{ }
...
uses
  ...
  dxCoreClasses, cxClasses, dxCore, cxGeometry, cxGraphics, dxCoreGraphics,
  dxGDIPlusClasses, dxXMLDoc, cxDataUtils,
...
type
  ...
  TdxGaugeCustomScaleDefaultParametersClass = class of
  ...
  TdxGaugeCustomCaptionParametersClass = class of
    TdxGaugeCustomCaptionParameters;
  TdxGaugeCustomCaptionOptionsView = class;
  TdxGaugeCustomCaptionOptionsViewClass = class of
  ...
  TdxGaugeScaleOptionsCustomLayoutClass = class of
  ...
  TdxGaugeScaleDragOperation = (sdoMove, sdoResizeTop, sdoResizeBottom,
    sdoResizeLeft, sdoResizeRight, sdoResizeTopLeft, sdoResizeBottomRight,
    sdoResizeTopRight, sdoResizeBottomLeft);
  TdxGaugeElementType = (etBackground1, etBackground2, etDigitalBackgroundStart,
    etDigitalBackgroundMiddle, etDigitalBackgroundEnd, etTick1, etTick2,
    etTick3, etTick4, etTick5, etSpindleCap, etNeedle, etLinearBarStart,
    etLinearBarEnd, etLinearBarEmpty, etLinearBarPacked);
  TdxGaugeScalePositionType = (sptFactor, sptPixels);
  TdxGaugeScaleType = (stCircularScale, stDigitalScale, stLinearScale,
    stCircularHalfScale, stCircularQuarterLeftScale,
    stCircularQuarterRightScale, stCircularThreeFourthScale,
    stCircularWideScale, stContainerScale);
  TdxGaugeScaleZOrderChangeType = (octBringToFront, octBringForward,
    octSendBackward, octSendToBack);

  TdxGaugeScaleLayerDrawProc = procedure(AGPGraphics: TdxGPGraphics) of object;

  { IdxGaugeSelectableElement }

  IdxGaugeSelectableElement = interface // for internal use
  ...
  TdxGaugeCustomScaleInfo = class // for internal use
  public
    Value: Variant; // have to be top
  ...
  protected
    ...
    property WidthFactor: Single read GetWidthFactor write SetWidthFactor
      stored IsWidthFactorStored;
  published
    property CenterPositionX: Integer read GetCenterPositionX
      write SetCenterPositionX default 0;
    property CenterPositionFactorX: Single read GetCenterPositionFactorX
      write SetCenterPositionFactorX stored IsCenterPositionFactorXStored;
    property CenterPositionY: Integer read GetCenterPositionY
      write SetCenterPositionY default 0;
    property CenterPositionFactorY: Single read GetCenterPositionFactorY
      write SetCenterPositionFactorY stored IsCenterPositionFactorYStored;
    property CenterPositionType: TdxGaugeScalePositionType
      read GetCenterPositionType write SetCenterPositionType default sptFactor;
  end;
  ...
  published
    property ShowBackground: Boolean read GetShowBackground
      write SetShowBackground default True;
  end;
  ...
  private
    ...
    procedure RecreateStyle(AScaleType: TdxGaugeScaleType;
  ...
  protected
    ...
    procedure Calculate(AParameters: TdxGaugeCustomScaleParameters;
      const ABounds: TdxRectF); virtual;
    ...
    procedure DoDrawLayer(AGPGraphics: TdxGPGraphics;
      ALayerIndex: Integer); virtual;
    procedure PopulateParameters(AParameters
      : TdxGaugeCustomScaleParameters); virtual;

    function CanDrawBackground: Boolean; virtual;
    procedure CreateStyle(AScaleType: TdxGaugeScaleType;
      const AStyleName: string); virtual;
    ...
    function GetScaledRect(const AOriginalSize: TdxSizeF;
      const AScaleFactor: TdxPointF): TdxRectF; overload;
    ...
    function GetElementImageSize(AImage: TGraphic;
      const AImageScaleFactor: TdxPointF): TdxSizeF;
    procedure DrawLayer(AGPGraphics: TdxGPGraphics; ALayerIndex: Integer);

    property DefaultParameters: TdxGaugeCustomScaleDefaultParameters
      read GetDefaultParameters;
  ...
  private
    ...
    function GetAnchorScaleByIndex(AAnchorScaleIndex: Integer)
      : TdxGaugeCustomScale;
    ...
    procedure ScaleElementChangeHandler(ASender: TObject;
  ...
  protected
    ...
    class function GetStyleReaderClass
      : TdxGaugeCustomScaleStyleReaderClass; virtual;
    ...
    function GetOptionsLayoutClass: TdxGaugeScaleOptionsCustomLayoutClass;
      virtual; abstract;
    ...
    procedure DrawLayer(AGPGraphics: TdxGPGraphics;
      ALayerIndex: Integer); virtual;
    procedure DrawScaleComponents(AGPGraphics: TdxGPGraphics;
      ALayerIndex: Integer); virtual;
    ...
    // Internal properties
    property AnchorScale: TdxGaugeCustomScale read FAnchorScale
      write SetAnchorScale;
    property Bounds: TdxRectF read GetBounds;
    property CenterPositionX: Integer read GetCenterPositionX
      write SetCenterPositionX;
    property CenterPositionFactorX: Single read GetCenterPositionFactorX
      write SetCenterPositionFactorX;
    property CenterPositionY: Integer read GetCenterPositionY
      write SetCenterPositionY;
    property CenterPositionFactorY: Single read GetCenterPositionFactorY
      write SetCenterPositionFactorY;
    property CenterPositionType: TdxGaugeScalePositionType
      read GetCenterPositionType write SetCenterPositionType;
    property ClientRect: TdxRectF read GetClientRect;
    property ChangedLayers: TdxGaugeScaleChangedLayers read FChangedLayers
      write FChangedLayers;
    ...
    property AnchorScaleIndex: Integer read GetAnchorScaleIndex
      write SetAnchorScaleIndex stored IsAnchorScaleIndexStored;
    property Captions: TdxGaugeCaptionCollection read FCaptions
      write SetCaptions;
    property DataBinding: TcxCustomDataBinding read FDataBinding
      write SetDataBinding;
    property OptionsView: TdxGaugeCustomScaleOptionsView read FOptionsView
      write SetOptionsView;
    property OptionsLayout: TdxGaugeScaleOptionsCustomLayout read FOptionsLayout
  ...
  protected
    ...
    procedure CalculateSizeFactor(const ASize: TdxSizeF;
      const ABounds: TdxRectF);
    procedure CreateStyle(AScaleType: TdxGaugeScaleType;
      const AStyleName: string); override;
    ...
    property CalculateExplicitSize: Boolean read FCalculateExplicitSize
      write FCalculateExplicitSize;
  public
    constructor Create(AScaleType: TdxGaugeScaleType;
      const AStyleName: string); override;
  end;
  ...
  private
    ...
    procedure SetOptionsLayout(const AValue
      : TdxGaugeContainerScaleOptionsLayout);
  protected
    function GetOptionsLayoutClass
      : TdxGaugeScaleOptionsCustomLayoutClass; override;
  published
    property AnchorScaleIndex;
    property OptionsLayout: TdxGaugeContainerScaleOptionsLayout
      read GetOptionsLayout write SetOptionsLayout;
  end;
  ...
  public
    ...
    property Items[Index: Integer]: TdxGaugeCustomScale read GetScale
      write SetScale; default;
  end;
  ...
  protected
    ...
    procedure AddElement(AElementType: TdxGaugeElementType;
      AElement: TdxCompositeShape);

    property BaseStyleName: string read FBaseStyleName write FBaseStyleName;
    property DefaultParameters: TdxGaugeCustomScaleDefaultParameters
      read FDefaultParameters write FDefaultParameters;
  ...
  TdxGaugeCustomScaleStyleReader = class // for internal use
  private
    ...
    function ReadDefaultParameters(ADocument: TdxXMLDocument)
      : TdxGaugeCustomScaleDefaultParameters;
  protected
    class function GetParametersNodeName: AnsiString;
    class function GetResourceNamePrefix: string; virtual;

    function GetDefaultParametersClass
      : TdxGaugeCustomScaleDefaultParametersClass; virtual; abstract;
    procedure ReadParameters(ANode: TdxXMLNode;
      AParameters: TdxGaugeCustomScaleDefaultParameters); virtual; abstract;

    function CreateStyle(ADocument: TdxXMLDocument): TdxGaugeScaleStyle;
    function GetAttributeValueAsAlphaColor(ANode: TdxXMLNode;
      const AAttributeName: AnsiString): TdxAlphaColor;
    function GetAttributeValueAsBoolean(ANode: TdxXMLNode;
      const AAttributeName: AnsiString): Boolean;
    function GetAttributeValueAsColor(ANode: TdxXMLNode;
      const AAttributeName: AnsiString): TColor;
    function GetAttributeValueAsDouble(ANode: TdxXMLNode;
      const AAttributeName: AnsiString): Double;
    function GetAttributeValueAsElementType(ANode: TdxXMLNode;
      const AAttributeName: AnsiString): TdxGaugeElementType;
    function GetAttributeValueAsInteger(ANode: TdxXMLNode;
      const AAttributeName: AnsiString): Integer;
    function GetAttributeValueAsPointF(ANode: TdxXMLNode;
      const AAttributeName: AnsiString): TdxPointF;
    function GetAttributeValueAsString(ANode: TdxXMLNode;
      const AAttributeName: AnsiString): string;
    function GetChildNode(ANode: TdxXMLNode; const AChildNodeName: AnsiString)
      : TdxXMLNode; overload;
    function GetChildNode(ANode: TdxXMLNode; const AChildNodeName: AnsiString;
      out AChildNode: TdxXMLNode): Boolean; overload;
  ...
  public
    constructor Create(AOwner: TPersistent;
      AParameters: TdxGaugeCustomCaptionParameters); reintroduce; virtual;
  end;
  ...
  public
    constructor Create(AOwner: TPersistent;
      AParameters: TdxGaugeCustomCaptionParameters); override;
    destructor Destroy; override;
  published
  ...
  protected
    ...
    function GetTextCenter(AScaleInfo: TdxGaugeCustomScaleInfo)
      : TdxPointF; virtual;
    procedure Calculate(AParameters: TdxGaugeCustomCaptionParameters;
  ...
  TdxGaugeCustomCaption = class(TcxComponentCollectionItem,
    IdxGaugeSelectableElement)
  private
  ...
  protected
    ...
    function GetOptionsViewClass
      : TdxGaugeCustomCaptionOptionsViewClass; virtual;
    function GetParametersClass: TdxGaugeCustomCaptionParametersClass; virtual;
    ...
    property OptionsLayout: TdxGaugeCustomCaptionOptionsLayout
      read FOptionsLayout write SetOptionsLayout;
    property OptionsView: TdxGaugeCustomCaptionOptionsView read FOptionsView
      write SetOptionsView;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
  ...
  protected
    ...
    property Items[Index: Integer]: TdxGaugeCustomCaption read GetCaption
      write SetCaption; default;
  public
    procedure Assign(ASource: TPersistent); override;
  end;

  // Scale Styles
function dxGaugeRegisterStyle(AScaleType: TdxGaugeScaleType;
  const AStyleName: string): Boolean;
function dxGaugeRegisterStyleFromFile(AScaleType: TdxGaugeScaleType;
  const AFileName: string): Boolean;
procedure dxGaugeGetPredefinedStyleNames(AList: TStringList);
procedure dxGaugeGetRegisteredStyleNames(AScaleType: TdxGaugeScaleType;
  AList: TStringList);
procedure dxGaugeSaveStyleToFile(AScaleType: TdxGaugeScaleType;
  const AStyleName, AFileName: string);
procedure dxGaugeSaveStyleToStream(AScaleType: TdxGaugeScaleType;
  const AStyleName: string; AStream: TStream);
procedure dxGaugeUnregisterStyle(AScaleType: TdxGaugeScaleType;
  const AStyleName: string);
procedure dxGaugeUnregisterStyles(AScaleType: TdxGaugeScaleType);

// Scales
procedure dxGaugeGetRegisteredScaleClasses(AList: TList);
procedure dxGaugeRegisterScale(AScaleClass: TdxGaugeCustomScaleClass;
  ARegisterPredefinedStyle: Boolean = True);
procedure dxGaugeUnregisterScale(AScaleClass: TdxGaugeCustomScaleClass;
...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, SysUtils, StrUtils, Math, Variants, dxGDIPlusAPI, dxGaugeControl,
  dxGaugeUtils, dxDPIAwareUtils, cxControls;
...
const
  ...
  dxGaugeStyleElementNameMap: array [TdxGaugeElementType] of string =
    (dxGaugeBackground1, dxGaugeBackground2, dxGaugeDigitalBackgroundStart,
    dxGaugeDigitalBackgroundMiddle, dxGaugeDigitalBackgroundEnd, dxGaugeTick1,
    dxGaugeTick2, dxGaugeTick3, dxGaugeTick4, dxGaugeTick5, dxGaugeSpindleCap,
    dxGaugeNeedle, dxGaugeLinearBarStart, dxGaugeLinearBarEnd,
    dxGaugeLinearBarEmpty, dxGaugeLinearBarPacked);
  ...
  sdxGaugeScaleStyleCollectionInvalidStyleCount =
    'No style is registered for the ' + '''' + '%s' + '''' + ' scale type';
  sdxGaugeScaleStyleCollectionDuplicateStyleName = 'Duplicate style name ' +
    '''' + '%s' + '''' + ' is found for the ' + '''' + '%s' + '''' +
    ' scale type';
  sdxGaugeScaleStyleCollectionBaseStyleUnregistered = 'The ' + '''' + '%s' +
    '''' + ' style used as the base for the ' + '''' + '%s' + '''' +
    ' style of the ' + '''' + '%s' + '''' +
    ' scale type is not registered for the ' + '''' + '%s' + '''' +
    ' scale type';
  sdxGaugeScaleFactoryDuplicateScaleClassName = 'Duplicate scale class name ' +
    '''' + '%s' + '''';

type
  TdxCompositeShapeAccess = class(TdxCompositeShape);
  TdxCustomGaugeControlAccess = class(TdxCustomGaugeControl);
  TdxCustomGaugeControlControllerAccess = class
  ...
  private
    function CreateFromResource(AInstance: THandle; const AResName: string)
      : TdxGaugeScaleStyle;
    function CreateFromStream(AStream: TStream): TdxGaugeScaleStyle;
    function CreateFromStyle(ADestinationStyleInfo, ASourceStyleInfo
      : TdxGaugeScaleStyleInfo): TdxGaugeScaleStyle;
    function GetStyleReaderClass(ADocument: TdxXMLDocument)
      : TdxGaugeCustomScaleStyleReaderClass;
  ...
  protected
    function CreateStyle(AStyleInfo: TdxGaugeScaleStyleInfo)
      : TdxGaugeScaleStyle; overload;
    function CreateStyle(AInstance: THandle; const AResName: string)
      : TdxXMLDocument; overload;
    function CreateStyle(const AFileName: string): TdxGaugeScaleStyle; overload;
    function CreateStyleDocument(AStyleInfo: TdxGaugeScaleStyleInfo)
      : TdxXMLDocument; overload;
    function CreateStyleDocument(const AFileName: string)
      : TdxXMLDocument; overload;
  end;
  ...
  private
    ...
    function ExtractStyleToDocument(AScaleType: TdxGaugeScaleType;
      const AStyleName: string): TdxXMLDocument;
    function GetStyleInfo(AStyles: TStringList; const AStyleName: string)
      : TdxGaugeScaleStyleInfo;
    function InternalCreateStyle(AStyleInfo: TdxGaugeScaleStyleInfo)
      : TdxGaugeScaleStyle;
    function InternalRegisterStyle(AScaleType: TdxGaugeScaleType;
      AStyleInfo: TdxGaugeScaleStyleInfo): Boolean;
    function InternalUnregisterStyle(AStyles: TStringList;
      const AStyleName: string): Boolean;
    function IsInheritedStyle(AScaleType: TdxGaugeScaleType): Boolean;
    function IsRegisteredStyle(AScaleType: TdxGaugeScaleType;
      const AStyleName: string): Boolean;
    ...
    procedure ProcessError(AStyleInfo: TdxGaugeScaleStyleInfo;
      AErrorCode: Integer);
  protected
    function CreateStyle(AScaleType: TdxGaugeScaleType;
    ...
    function RegisterStyle(AScaleType: TdxGaugeScaleType;
      const AStyleName: string): Boolean;
    function RegisterStyleFromFile(AScaleType: TdxGaugeScaleType;
      const AFileName: string): Boolean;
    ...
    procedure SaveStyleToFile(AScaleType: TdxGaugeScaleType;
      const AStyleName, AFileName: string);
    procedure SaveStyleToStream(AScaleType: TdxGaugeScaleType;
      const AStyleName: string; AStream: TStream);
    procedure UnregisterPredefinedStyles(AScaleClass: TdxGaugeCustomScaleClass);
    procedure UnregisterStyle(AScaleType: TdxGaugeScaleType;
      const AStyleName: string);
  ...
  protected
    ...
    procedure RegisterScale(AScaleClass: TdxGaugeCustomScaleClass;
      ARegisterPredefinedStyle: Boolean = True);
    procedure UnregisterScale(AScaleClass: TdxGaugeCustomScaleClass;
      AUnregisterPredefinedStyle: Boolean = True);
  ...
  private
    ...
    function CreateTypeInfo(AReaderClass: TdxGaugeCustomScaleStyleReaderClass;
...
function dxGaugeRegisterStyleFromFile(AScaleType: TdxGaugeScaleType;
  const AFileName: string): Boolean;
begin
  Result := dxGaugeScaleStyleFactory.RegisterStyleFromFile(AScaleType,
    AFileName);
end;
...
begin
  if dxgGaugeScaleFactory <> nil then
    dxgGaugeScaleStyleFactory.SaveStyleToFile(AScaleType, AStyleName,
      AFileName);
end;
...
begin
  if dxgGaugeScaleFactory <> nil then
    dxgGaugeScaleStyleFactory.SaveStyleToStream(AScaleType, AStyleName,
      AStream);
end;
...
begin
  if dxgGaugeScaleFactory <> nil then
    dxgGaugeScaleFactory.UnregisterScale(AScaleClass,
      AUnregisterPredefinedStyle);
end;
...
function dxGaugeController(ACollection: TdxGaugeScaleCollection)
  : TdxCustomGaugeControlControllerAccess;
var
...
begin
  ...
  begin
    AGaugeControl := TdxCustomGaugeControlAccess
      (ACollection.ParentComponent as TdxCustomGaugeControl);
...
function TdxGaugeScaleTypeInfos.GetTypeByName(const ATypeName: string)
  : TdxGaugeScaleType;
var
  I: Integer;
begin
...
function TdxGaugeScaleTypeInfos.GetTypeInfo(AIndex: Integer)
  : TdxGaugeScaleTypeInfo;
begin
  Result := FTypeInfos[AIndex];
end;

function TdxGaugeScaleTypeInfos.GetTypeName(AScaleType
  : TdxGaugeScaleType): string;
var
  I: Integer;
begin
  Result := '';
...
function TdxGaugeScaleTypeInfos.GetFormatedTypeName
  (AScaleType: TdxGaugeScaleType): string;
var
  I: Integer;
...
procedure TdxGaugeScaleTypeInfos.AddTypeInfo(AScaleClass
  : TdxGaugeCustomScaleClass);
var
  ATypeName: string;
begin
  ATypeName := StringReplace(AScaleClass.GetScaleName, ' ', '', [rfReplaceAll]);
  ATypeName := StringReplace(ATypeName, '-', '', [rfReplaceAll]);
  FTypeInfos.Add(CreateTypeInfo(AScaleClass.GetStyleReaderClass,
    AScaleClass.GetScaleType, ATypeName));
end;

function TdxGaugeScaleTypeInfos.CreateTypeInfo(AReaderClass
  : TdxGaugeCustomScaleStyleReaderClass; AType: TdxGaugeScaleType;
...
procedure TdxGaugeCustomScaleParameters.Assign
  (ASource: TdxGaugeCustomScaleParameters);
begin
...
function TdxGaugeCustomCaptionViewInfo.GetParametersClass
  : TdxGaugeCustomCaptionParametersClass;
begin
  Result := TdxGaugeCustomCaptionParameters;
end;

function TdxGaugeCustomCaptionViewInfo.GetTextCenter
  (AScaleInfo: TdxGaugeCustomScaleInfo): TdxPointF;
begin
  Result.X := AScaleInfo.ContentBounds.Left + FParameters.CenterPositionFactor.X
    * AScaleInfo.ContentBounds.Width;
  Result.Y := AScaleInfo.ContentBounds.Top + FParameters.CenterPositionFactor.Y
    * AScaleInfo.ContentBounds.Height;
end;

procedure TdxGaugeCustomCaptionViewInfo.Calculate
...
procedure TdxGaugeCustomCaptionViewInfo.CalculateBounds
  (AScaleInfo: TdxGaugeCustomScaleInfo);
var
  R: TdxRectF;
  P: TdxPointF;
...
begin
  ...
  begin
    R := cxRectF(cxRectCenter(FParameters.Bounds),
      cxRectCenter(FParameters.Bounds));
  ...
  begin
    R := cxRectF(cxRectCenter(FSelectionBounds),
      cxRectCenter(FSelectionBounds));
    FSelectionBounds := cxRectInflate(R, Max(FSelectionBounds.Width,
      FSelectionBounds.Height) / 2, Max(FSelectionBounds.Width,
      FSelectionBounds.Height) / 2);
  end;
...
procedure TdxGaugeCustomCaptionViewInfo.DoDraw(AGPGraphics: TdxGPGraphics);
  ...
  procedure DrawText;
  begin
    dxGaugeDrawText(AGPGraphics, FParameters.Text, FParameters.Bounds,
      FParameters.Font);
  end;
...
begin
  ...
  begin
    ...
    try
      AGPGraphics.RotateWorldTransform(360 - FParameters.RotationAngle,
        cxRectCenter(FParameters.Bounds));
      DrawText;
    finally
...
function TdxGaugeCustomCaption.GetCollectionFromParent(AParent: TComponent)
  : TcxComponentCollection;
begin
  Result := (AParent as TdxGaugeCustomScale).Captions;
end;

function TdxGaugeCustomCaption.GetOptionsViewClass
  : TdxGaugeCustomCaptionOptionsViewClass;
begin
  Result := TdxGaugeCustomCaptionOptionsView;
end;

function TdxGaugeCustomCaption.GetParametersClass
  : TdxGaugeCustomCaptionParametersClass;
begin
  Result := TdxGaugeCustomCaptionParameters;
end;

function TdxGaugeCustomCaption.GetViewInfoClass
  : TdxGaugeCustomCaptionViewInfoClass;
begin
  Result := TdxGaugeCustomCaptionViewInfo;
end;

function TdxGaugeCustomCaption.GetFont(AScaleInfo
  : TdxGaugeCustomScaleInfo): TFont;
begin
...
begin
  ...
  FOptionsLayout := TdxGaugeCustomCaptionOptionsLayout.Create(Self,
    FParameters);
...
begin
  Result := TdxControlsDesignSelectorHelper.CalculateBounds(GetSelectionRect, 2,
    8, dxGetScaleFactor(Collection.ParentComponent));
end;
...
procedure TdxGaugeCustomCaption.SetOptionsLayout(const AValue
  : TdxGaugeCustomCaptionOptionsLayout);
begin
  OptionsLayout.Assign(AValue);
end;

procedure TdxGaugeCustomCaption.SetOptionsView(const AValue
  : TdxGaugeCustomCaptionOptionsView);
begin
...
function TdxGaugeCustomScaleViewInfo.GetScaledRect(const AOriginalSize
  : TdxSizeF): TdxRectF;
var
  P: TdxPointF;
begin
  P := cxRectCenter(ScaleInfo.Bounds);
  Result := cxRectFBounds(P.X - AOriginalSize.cx / 2, P.Y - AOriginalSize.cy /
    2, AOriginalSize.cx, AOriginalSize.cy);
end;

function TdxGaugeCustomScaleViewInfo.GetScaledRect(const AOriginalSize
  : TdxSizeF; const AScaleFactor: TdxPointF): TdxRectF;
begin
  Result := GetScaledRect(dxSizeF(AOriginalSize.cx * AScaleFactor.X,
    AOriginalSize.cy * AScaleFactor.Y));
end;

function TdxGaugeCustomScaleViewInfo.NeedDrawElement: Boolean;
begin
  Result := FParameters.Visible and (FScaleFactor.X > 0.01) and
    (FScaleFactor.Y > 0.01);
end;

procedure TdxGaugeCustomScaleViewInfo.DrawLayer(AGPGraphics: TdxGPGraphics;
  ALayerIndex: Integer);
begin
...
procedure TdxGaugeCustomScaleViewInfo.SetStyle(const AValue
  : TdxGaugeScaleStyle);
begin
  FreeAndNil(FStyle);
  FStyle := AValue;
...
function TdxGaugeCustomScaleViewInfo.GetDefaultParameters
  : TdxGaugeCustomScaleDefaultParameters;
begin
  Result := FStyle.DefaultParameters;
end;

function TdxGaugeCustomScaleViewInfo.GetParameters
  : TdxGaugeCustomScaleParameters;
begin
  Result := FParameters as TdxGaugeCustomScaleParameters;
end;

procedure TdxGaugeCustomScaleViewInfo.DrawBackground
...
procedure TdxGaugeCustomScaleViewInfo.RecreateStyle
  (AScaleType: TdxGaugeScaleType; const AStyleName: string);
begin
  FreeAndNil(FStyle);
...
begin
  ...
  CreateSubClasses;
  InitParameters;
  FViewInfo := TdxGaugeCustomScaleViewInfoClass(GetViewInfoClass)
    .Create(GetScaleType, FStyleName);
...
function TdxGaugeCustomScale.GetCollectionFromParent(AParent: TComponent)
  : TcxComponentCollection;
begin
  Result := (AParent as TdxCustomGaugeControl).Scales;
end;

procedure TdxGaugeCustomScale.GetChildren(AProc: TGetChildProc;
  ARoot: TComponent);
begin
...
class function TdxGaugeCustomScale.GetStyleReaderClass
  : TdxGaugeCustomScaleStyleReaderClass;
begin
...
function TdxGaugeCustomScale.GetOptionsViewClass
  : TdxGaugeCustomScaleOptionsViewClass;
begin
  Result := TdxGaugeCustomScaleOptionsView;
end;

function TdxGaugeCustomScale.GetParametersClass
  : TdxGaugeCustomScaleParametersClass;
begin
...
begin
  inherited DefineProperties(AFiler);
  AFiler.DefineProperty('CenterPositionFactorX', ReadCenterPositionFactorX,
    WriteCenterPositionFactorX, SameValue(CenterPositionFactorX, 0));
  AFiler.DefineProperty('CenterPositionFactorY', ReadCenterPositionFactorY,
    WriteCenterPositionFactorY, SameValue(CenterPositionFactorY, 0));
end;
...
function TdxGaugeScaleOptionsCustomLayout.GetCenterPositionType
...
procedure TdxGaugeScaleOptionsCustomLayout.SetCenterPositionFactorX
  (const AValue: Single);
begin
  GetScale.SetCenterPositionFactorX(AValue);
end;

procedure TdxGaugeScaleOptionsCustomLayout.SetCenterPositionFactorY
  (const AValue: Single);
begin
  GetScale.SetCenterPositionFactorY(AValue);
end;

procedure TdxGaugeScaleOptionsCustomLayout.SetCenterPositionX
  (const AValue: Integer);
begin
  GetScale.SetCenterPositionX(AValue);
end;

procedure TdxGaugeScaleOptionsCustomLayout.SetCenterPositionY
  (const AValue: Integer);
begin
  GetScale.SetCenterPositionY(AValue);
end;

procedure TdxGaugeScaleOptionsCustomLayout.SetCenterPositionType
  (const AValue: TdxGaugeScalePositionType);
begin
...
procedure TdxGaugeScaleOptionsCustomLayout.SetHeightFactor
  (const AValue: Single);
begin
...
procedure TdxGaugeScaleOptionsCustomLayout.ReadCenterPositionFactorX
  (AReader: TReader);
begin
  CenterPositionFactorX := AReader.ReadDouble;
end;

procedure TdxGaugeScaleOptionsCustomLayout.ReadCenterPositionFactorY
  (AReader: TReader);
begin
  CenterPositionFactorY := AReader.ReadDouble;
end;

procedure TdxGaugeScaleOptionsCustomLayout.WriteCenterPositionFactorX
  (AWriter: TWriter);
begin
  AWriter.WriteDouble(CenterPositionFactorX);
end;

procedure TdxGaugeScaleOptionsCustomLayout.WriteCenterPositionFactorY
  (AWriter: TWriter);
begin
  AWriter.WriteDouble(CenterPositionFactorY);
end;

function TdxGaugeScaleOptionsCustomLayout.IsCenterPositionFactorXStored
  : Boolean;
begin
  Result := GetScale.IsCenterPositionFactorXStored;
end;

function TdxGaugeScaleOptionsCustomLayout.IsCenterPositionFactorYStored
  : Boolean;
begin
...
procedure TdxGaugeCustomScaleOptionsView.SetShowBackground
...
function TdxGaugeContainerScale.GetOptionsLayoutClass
  : TdxGaugeScaleOptionsCustomLayoutClass;
begin
  Result := TdxGaugeContainerScaleOptionsLayout;
end;

function TdxGaugeContainerScale.GetOptionsLayout
  : TdxGaugeContainerScaleOptionsLayout;
begin
  Result := inherited OptionsLayout as TdxGaugeContainerScaleOptionsLayout;
end;

procedure TdxGaugeContainerScale.SetOptionsLayout(const AValue
  : TdxGaugeContainerScaleOptionsLayout);
begin
...
begin
  ...
  begin
    ...
    for I := 0 to TdxGaugeScaleCollection(ASource).Count - 1 do
      Add(TdxGaugeCustomScaleClass(TdxGaugeScaleCollection(ASource)
        .Items[I].ClassType));
    for I := 0 to TdxGaugeScaleCollection(ASource).Count - 1 do
...
function TdxGaugeScaleCollection.Add(AScaleClass: TdxGaugeCustomScaleClass)
  : TdxGaugeCustomScale;
begin
...
procedure TdxGaugeScaleCollection.Notify(AItem: TcxComponentCollectionItem;
  AAction: TcxComponentCollectionNotification);
begin
  if (ParentComponent <> nil) and
    not(csDestroying in ParentComponent.ComponentState) then
    case AAction of
      ccnAdded:
...
procedure TdxGaugeScaleCollection.SetScale(AIndex: Integer;
  const AValue: TdxGaugeCustomScale);
begin
...
function TdxGaugeScaleStyle.GetElement(AElementType: TdxGaugeElementType)
  : TdxCompositeShape;
begin
  if FElements[AElementType] = nil then
  begin
    FElements[AElementType] := TdxCompositeShape.Create;
    TdxCompositeShapeAccess(FElements[AElementType]).LoadFromShape(FShapes,
      dxGaugeStyleElementNameMap[AElementType]);
...
procedure TdxGaugeScaleStyle.AddElement(AElementType: TdxGaugeElementType;
  AElement: TdxCompositeShape);
begin
  if FElements[AElementType] <> nil then
    FreeAndNil(FElements[AElementType]);
...
function TdxGaugeCustomScaleStyleReader.CreateStyle(ADocument: TdxXMLDocument)
  : TdxGaugeScaleStyle;
begin
  Result := TdxGaugeScaleStyle.Create
    (GetAttributeValueAsString(ADocument.Root.First, 'Name'),
  ...
  Result.ScaleTypeName := GetAttributeValueAsString
    (ADocument.Root.First, 'Type');
end;

function TdxGaugeCustomScaleStyleReader.GetAttributeValueAsAlphaColor
  (ANode: TdxXMLNode; const AAttributeName: AnsiString): TdxAlphaColor;
begin
  Result := dxColorNameToAlphaColor
    (ANode.Attributes.GetValueAsString(AAttributeName));
end;

function TdxGaugeCustomScaleStyleReader.GetAttributeValueAsBoolean
  (ANode: TdxXMLNode; const AAttributeName: AnsiString): Boolean;
begin
  if ANode <> nil then
...
function TdxGaugeCustomScaleStyleReader.GetAttributeValueAsColor
  (ANode: TdxXMLNode; const AAttributeName: AnsiString): TColor;
begin
  Result := dxAlphaColorToColor
    (dxColorNameToAlphaColor(ANode.Attributes.GetValueAsString
    (AAttributeName)));
end;

function TdxGaugeCustomScaleStyleReader.GetAttributeValueAsDouble
  (ANode: TdxXMLNode; const AAttributeName: AnsiString): Double;
begin
  Result := ANode.Attributes.GetValueAsFloat(AAttributeName);
end;

function TdxGaugeCustomScaleStyleReader.GetAttributeValueAsElementType
  (ANode: TdxXMLNode; const AAttributeName: AnsiString): TdxGaugeElementType;
begin
  Result := GetElementType(ANode.Attributes.GetValueAsString(AAttributeName));
end;

function TdxGaugeCustomScaleStyleReader.GetAttributeValueAsInteger
  (ANode: TdxXMLNode; const AAttributeName: AnsiString): Integer;
begin
  Result := ANode.Attributes.GetValueAsInteger(AAttributeName);
end;

function TdxGaugeCustomScaleStyleReader.GetAttributeValueAsPointF
  (ANode: TdxXMLNode; const AAttributeName: AnsiString): TdxPointF;
begin
  if ANode <> nil then
...
function TdxGaugeCustomScaleStyleReader.GetAttributeValueAsString
  (ANode: TdxXMLNode; const AAttributeName: AnsiString): string;
begin
  Result := ANode.Attributes.GetValueAsString(AAttributeName);
end;

function TdxGaugeCustomScaleStyleReader.GetChildNode(ANode: TdxXMLNode;
  const AChildNodeName: AnsiString; out AChildNode: TdxXMLNode): Boolean;
begin
...
function TdxGaugeCustomScaleStyleReader.GetChildNode(ANode: TdxXMLNode;
  const AChildNodeName: AnsiString): TdxXMLNode;
var
...
function TdxGaugeCustomContainerScale.GetViewInfoClass
  : TdxGaugeCustomScaleViewInfoClass;
begin
...
procedure TdxGaugeCustomContainerScale.DoDrawLayer(AGPGraphics: TdxGPGraphics;
  ALayerIndex: Integer);
begin
  if IsDesigning then
...
function TdxGaugeCustomContainerScale.GetViewInfo
  : TdxGaugeCustomContainerScaleViewInfo;
begin
  Result := inherited ViewInfo as TdxGaugeCustomContainerScaleViewInfo;
end;

function TdxGaugeCustomScaleStyleReader.GetElementType(const ATypeName: string)
  : TdxGaugeElementType;
var
  I: TdxGaugeElementType;
begin
  Result := etBackground1;
  for I := Low(dxGaugeStyleElementNameMap)
    to High(dxGaugeStyleElementNameMap) do
...
function TdxGaugeCustomScaleStyleReader.GetStyleRootNode
  (ADocument: TdxXMLDocument): TdxXMLNode;
begin
  Result := GetChildNode(ADocument.Root, 'ScaleStyle');
end;

function TdxGaugeCustomScaleStyleReader.ReadCompositeShape
  (ADocument: TdxXMLDocument): TdxCompositeShape;
var
  ACompositeShapeNode: TdxXMLNode;
begin
  if GetChildNode(GetStyleRootNode(ADocument), 'CompositeShape',
    ACompositeShapeNode) then
  begin
...
function TdxGaugeCustomScaleStyleReader.ReadDefaultParameters
  (ADocument: TdxXMLDocument): TdxGaugeCustomScaleDefaultParameters;
var
  ADefaultParametersNode: TdxXMLNode;
  ACustomScaleParametersNode: TdxXMLNode;
begin
  if GetChildNode(GetStyleRootNode(ADocument), 'DefaultParameters',
    ADefaultParametersNode) then
  begin
    Result := GetDefaultParametersClass.Create;
    if ADefaultParametersNode.FindChild(GetParametersNodeName,
      ACustomScaleParametersNode) then
...
procedure TdxGaugeCustomCaptionParameters.Assign
  (ASource: TdxGaugeCustomCaptionParameters);
begin
  dxGaugeCopyParameters(ASource, Self, True);
  Text := ASource.Text;
end;
...
procedure TdxGaugeCustomCaptionOptionsLayout.SetCenterPositionFactorX
  (const AValue: Single);
begin
...
procedure TdxGaugeCustomCaptionOptionsLayout.SetCenterPositionFactorY
  (const AValue: Single);
begin
...
procedure TdxGaugeCustomCaptionOptionsLayout.ReadCenterPositionFactorX
  (AReader: TReader);
begin
  CenterPositionFactorX := AReader.ReadDouble;
end;

procedure TdxGaugeCustomCaptionOptionsLayout.ReadCenterPositionFactorY
  (AReader: TReader);
begin
  CenterPositionFactorY := AReader.ReadDouble;
end;

procedure TdxGaugeCustomCaptionOptionsLayout.WriteCenterPositionFactorX
  (AWriter: TWriter);
begin
  AWriter.WriteDouble(CenterPositionFactorX);
end;

procedure TdxGaugeCustomCaptionOptionsLayout.WriteCenterPositionFactorY
  (AWriter: TWriter);
begin
  AWriter.WriteDouble(CenterPositionFactorY);
end;

function TdxGaugeCustomCaptionOptionsLayout.
  IsCenterPositionFactorXStored: Boolean;
begin
  Result := not SameValue(FParameters.CenterPositionFactor.X,
    dxGaugeDefaultCenterPositionFactor.X);
end;

function TdxGaugeCustomCaptionOptionsLayout.
  IsCenterPositionFactorYStored: Boolean;
begin
  Result := not SameValue(FParameters.CenterPositionFactor.Y,
    dxGaugeDefaultCenterPositionFactor.Y);
end;

{ TdxGaugeCustomCaptionOptionsView }

constructor TdxGaugeCustomCaptionOptionsView.Create(AOwner: TPersistent;
  AParameters: TdxGaugeCustomCaptionParameters);
begin
...
procedure TdxGaugeCustomCaptionOptionsView.SetRotationAngle
  (const AValue: Single);
begin
...
begin
  Result := LeftStr(ItemClass.ClassName, Length(ItemClass.ClassName) -
    Length('Caption'));
end;

function TdxGaugeCaptionCollection.GetCaption(AIndex: Integer)
  : TdxGaugeCustomCaption;
begin
  Result := inherited GetItem(AIndex) as TdxGaugeCustomCaption;
end;

procedure TdxGaugeCaptionCollection.SetCaption(AIndex: Integer;
  const AValue: TdxGaugeCustomCaption);
begin
  inherited SetItem(AIndex, AValue);
end;
...
function TdxGaugeScaleStyleCreator.CreateStyle
  (AStyleInfo: TdxGaugeScaleStyleInfo): TdxGaugeScaleStyle;
begin
...
function TdxGaugeScaleStyleCreator.CreateStyle(AInstance: THandle;
  const AResName: string): TdxXMLDocument;
var
...
function TdxGaugeScaleStyleCreator.CreateStyle(const AFileName: string)
  : TdxGaugeScaleStyle;
var
  Var1: TStream;
begin
...
function TdxGaugeScaleStyleCreator.CreateStyleDocument
  (AStyleInfo: TdxGaugeScaleStyleInfo): TdxXMLDocument;
begin
  if AStyleInfo <> nil then
    if not AStyleInfo.IsExternalStyle then
...
function TdxGaugeScaleStyleCreator.CreateStyleDocument(const AFileName: string)
  : TdxXMLDocument;
var
  AStream: TFileStream;
begin
...
function TdxGaugeScaleStyleCreator.CreateFromResource(AInstance: THandle;
  const AResName: string): TdxGaugeScaleStyle;
var
  AStream: TResourceStream;
begin
  AStream := TResourceStream.Create(AInstance, AResName, RT_RCDATA);
...
function TdxGaugeScaleStyleCreator.CreateFromStream(AStream: TStream)
  : TdxGaugeScaleStyle;
var
...
function TdxGaugeScaleStyleCreator.CreateFromStyle(ADestinationStyleInfo,
  ASourceStyleInfo: TdxGaugeScaleStyleInfo): TdxGaugeScaleStyle;
  ...
  begin
    for I := Low(TdxGaugeElementType) to High(TdxGaugeElementType) do
      ...
      begin
        ...
        TdxCompositeShapeAccess(AShape).LoadFromShape(ASourceStyle.Shapes,
          dxGaugeStyleElementNameMap[I]);
...
function TdxGaugeScaleStyleCreator.GetStyleReaderClass
  (ADocument: TdxXMLDocument): TdxGaugeCustomScaleStyleReaderClass;
var
  ANode: TdxXMLNode;
begin
  Result := TdxGaugeCustomScaleStyleReader;
  if not(IsStyleDocumentAvailable(ADocument) and
    ADocument.Root.FindChild('ScaleStyle', ANode) and
    ANode.FindChild('DefaultParameters', ANode) and IdentifyReaderClass(ANode,
    Result)) then
    dxGaugeRaiseException
      (sdxGaugeScaleStyleCollectionInvalidStyleFileFormat, []);
end;

function TdxGaugeScaleStyleCreator.IdentifyReaderClass(ADefaultParametersNode
  : TdxXMLNode; var AReaderClass: TdxGaugeCustomScaleStyleReaderClass): Boolean;
var
  I: Integer;
...
begin
  ...
  begin
    ...
    Result := ADefaultParametersNode.FindChild
      (ATypeInfo.ReaderClass.GetParametersNodeName) <> nil;
    if Result then
    begin
...
function TdxGaugeScaleStyleCreator.InternalCreateStyleDocument(AStream: TStream)
  : TdxXMLDocument;
begin
...
function TdxGaugeScaleStyleCreator.IsStyleDocumentAvailable
  (ADocument: TdxXMLDocument): Boolean;
begin
...
function TdxGaugeScaleStyleFactory.CreateStyle(AScaleType: TdxGaugeScaleType;
  const AStyleName: string): TdxGaugeScaleStyle;
begin
  Result := InternalCreateStyle(GetStyleInfo(GetStyles(AScaleType),
    AStyleName));
end;

function TdxGaugeScaleStyleFactory.CreateStyleFromFile(const AFileName: string)
  : TdxGaugeScaleStyle;
begin
  Result := FStyleCreator.CreateStyle(AFileName);
end;

function TdxGaugeScaleStyleFactory.GetFirstStyleName
  (AScaleType: TdxGaugeScaleType): string;
begin
  Result := GetStyles(AScaleType).Strings[0];
end;

function TdxGaugeScaleStyleFactory.GetStyles(AScaleType: TdxGaugeScaleType)
  : TStringList;
var
  AList: TStringList;
begin
...
function TdxGaugeScaleStyleFactory.HasStyles(AScaleType
  : TdxGaugeScaleType): Boolean;
begin
  Result := GetStyles(AScaleType).Count > 0;
end;

function TdxGaugeScaleStyleFactory.RegisterStyle(AScaleType: TdxGaugeScaleType;
  const AStyleName: string): Boolean;
...
// # internal styles are always valid
  ...
  begin
    ...
    Result.ResourceName := dxGaugeScaleTypeInfos.GetTypeName(AScaleType) +
      AStyleName;
...
function TdxGaugeScaleStyleFactory.RegisterStyleFromFile
  (AScaleType: TdxGaugeScaleType; const AFileName: string): Boolean;
begin
...
procedure TdxGaugeScaleStyleFactory.RegisterPredefinedStyles
  (AScaleClass: TdxGaugeCustomScaleClass);

  function CheckPredefineStyleName(const AStyleName: string): Boolean;
  begin
    Result := FindResource(HInstance,
      PChar(dxgGaugeScaleTypeInfos.GetTypeName(AScaleClass.GetScaleType) +
      AStyleName), RT_RCDATA) <> 0;
  end;
...
procedure TdxGaugeScaleStyleFactory.SaveStyleToFile
  (AScaleType: TdxGaugeScaleType; const AStyleName, AFileName: string);
var
  AXMLDocument: TdxXMLDocument;
begin
...
begin
  ...
  AScaleInfo := TdxGaugeCustomElementViewInfoAccess(FViewInfo)
    .ScaleInfo as TdxGaugeCustomScaleInfo;
...
procedure TdxGaugeCustomScale.DoDrawLayer(AGPGraphics: TdxGPGraphics;
  ALayerIndex: Integer);
begin
...
procedure TdxGaugeCustomScale.DrawLayer(AGPGraphics: TdxGPGraphics;
  ALayerIndex: Integer);
var
  AMatrix: TdxGPMatrix;
begin
...
procedure TdxGaugeCustomScale.DrawScaleComponents(AGPGraphics: TdxGPGraphics;
  ALayerIndex: Integer);
begin
...
begin
  Result := TdxControlsDesignSelectorHelper.CalculateBounds(GetSelectionRect, 5,
    10, dxGetScaleFactor(Collection.ParentComponent));
end;
...
procedure TdxGaugeCustomScale.ProcessCollection(ACollection
  : TcxComponentCollection; AProc: TGetChildProc; ARoot: TComponent);
var
  I: Integer;
begin
...
begin
  if Collection <> nil then
    Result := dxGaugeController(TdxGaugeScaleCollection(Collection))
      .ZOrders.IndexOf(Self)
  else
    Result := -1;
end;
...
begin
  if (AValue = nil) or dxGaugeController(Collection as TdxGaugeScaleCollection)
    .CanAnchorScale(Index, AValue.Index) then
  begin
    FAnchorScale := AValue;
    ScaleChanged([sclStaticLayer, sclDynamicLayer]);
  end;
...
begin
  ...
  else if dxGaugeController(Collection as TdxGaugeScaleCollection)
    .CanAnchorScale(Index, AValue) then
  begin
...
procedure TdxGaugeCustomScale.SetCenterPositionType(const AValue
  : TdxGaugeScalePositionType);
begin
...
begin
  ...
  begin
    Parameters.CenterPositionFactor :=
      dxPointF(AValue, Parameters.CenterPositionFactor.Y);
    ScaleChanged([sclStaticLayer, sclDynamicLayer]);
  end;
end;
...
begin
  ...
  begin
    Parameters.CenterPositionFactor :=
      dxPointF(Parameters.CenterPositionFactor.X, AValue);
    ScaleChanged([sclStaticLayer, sclDynamicLayer]);
  end;
end;

procedure TdxGaugeCustomScale.SetOptionsLayout(const AValue
  : TdxGaugeScaleOptionsCustomLayout);
begin
  OptionsLayout.Assign(AValue);
end;
...
function TdxGaugeCustomScale.GetAnchorScaleByIndex(AAnchorScaleIndex: Integer)
  : TdxGaugeCustomScale;
begin
...
begin
  Result := not SameValue(Parameters.CenterPositionFactor.X,
    dxGaugeDefaultCenterPositionFactor.X);
end;

function TdxGaugeCustomScale.IsCenterPositionFactorYStored: Boolean;
begin
  Result := not SameValue(Parameters.CenterPositionFactor.Y,
    dxGaugeDefaultCenterPositionFactor.Y);
end;
...
procedure TdxGaugeCustomScale.SetCaptions(const AValue
  : TdxGaugeCaptionCollection);
begin
  FCaptions.Assign(AValue);
end;

procedure TdxGaugeCustomScale.SetDataBinding(const AValue
  : TcxCustomDataBinding);
begin
  FDataBinding.Assign(AValue);
end;

procedure TdxGaugeCustomScale.SetOptionsView(const AValue
  : TdxGaugeCustomScaleOptionsView);
begin
  FOptionsView.Assign(AValue);
end;
...
begin
  ...
  begin
    ...
    Collection.BeginUpdate;
    try
      (FViewInfo as TdxGaugeCustomScaleViewInfo).RecreateStyle(GetScaleType,
        FStyleName);
      ApplyStyleParameters;
    finally
      Collection.EndUpdate(False);
...
procedure TdxGaugeCustomScale.ScaleElementChangeHandler(ASender: TObject;
  AItem: TcxComponentCollectionItem;
  AAction: TcxComponentCollectionNotification);
begin
  ScaleChanged([sclDynamicLayer]);
...
procedure TdxGaugeCustomScale.CalculateCaptions
  (AScaleInfo: TdxGaugeCustomScaleInfo);
var
  I: Integer;
begin
...
begin
  Result := not SameText(FStyleName, dxgGaugeScaleStyleFactory.GetFirstStyleName
    (GetScaleType));
end;

{ TdxGaugeCustomContainerScaleViewInfo }

constructor TdxGaugeCustomContainerScaleViewInfo.Create
  (AScaleType: TdxGaugeScaleType; const AStyleName: string);
begin
...
function TdxGaugeCustomContainerScaleViewInfo.GetLayoutSize
  (const ABounds: TdxRectF): TdxSizeF;
begin
...
procedure TdxGaugeCustomContainerScaleViewInfo.CalculateSizeFactor
  (const ASize: TdxSizeF; const ABounds: TdxRectF);
begin
...
procedure TdxGaugeCustomContainerScaleViewInfo.CreateStyle
  (AScaleType: TdxGaugeScaleType; const AStyleName: string);
begin
  // do nothing
end;

procedure TdxGaugeCustomContainerScaleViewInfo.DoDrawBackground
  (AGPGraphics: TdxGPGraphics);
begin
  AGPGraphics.Rectangle(ScaleInfo.ContentBounds, dxColorToAlphaColor($BD8753,
    40), dxColorToAlphaColor($582801, 10));
end;

function TdxGaugeCustomContainerScaleViewInfo.GetExplicitSize
  (const ABounds: TdxRectF): TdxSizeF;
begin
  if (FExplicitSize.cx <> -1) and (FExplicitSize.cy <> -1) and
    (FSizeFactor.X > 0) and (FSizeFactor.Y > 0) and
    not SameValue(FParameters.HeightFactor, FSizeFactor.Y) and
    not SameValue(FParameters.WidthFactor, FSizeFactor.X) then
    FExplicitSize := dxGaugeGetRectangularScaleLayoutSize(ABounds,
      FParameters.Width, FParameters.Height, FSizeFactor.X, FSizeFactor.Y)
  else
    FExplicitSize := inherited GetLayoutSize(ABounds);
  Result := FExplicitSize;
end;

function TdxGaugeCustomContainerScaleViewInfo.GetProportionalSize
  (const ASize: TdxSizeF): TdxSizeF;
var
  ARatio: Single;
begin
...
constructor TdxGaugeCustomScaleViewInfo.Create(AScaleType: TdxGaugeScaleType;
  const AStyleName: string);
begin
  if dxgGaugeScaleStyleFactory.HasStyles(AScaleType) or
    (AScaleType = stContainerScale) then
  begin
    inherited Create;
    CreateSubClasses;
    CreateStyle(AScaleType, AStyleName);
...
function TdxGaugeCustomScaleViewInfo.GetScaleInfoClass
  : TdxGaugeCustomScaleInfoClass;
begin
  Result := TdxGaugeCustomScaleInfo;
end;

function TdxGaugeCustomScaleViewInfo.GetParametersClass
  : TdxGaugeCustomScaleParametersClass;
begin
  Result := TdxGaugeCustomScaleParameters;
end;
...
function TdxGaugeCustomScaleViewInfo.GetLayoutSize(const ABounds: TdxRectF)
  : TdxSizeF;
begin
  Result := dxGaugeGetRectangularScaleLayoutSize(ABounds, FParameters.Width,
    FParameters.Height, FParameters.WidthFactor, FParameters.HeightFactor);
end;

procedure TdxGaugeCustomScaleViewInfo.Calculate(AParameters
  : TdxGaugeCustomScaleParameters; const ABounds: TdxRectF);
begin
...
begin
  ...
  ScaleInfo.Bounds := cxRectInflate(cxRectF(ACenter, ACenter),
    dxRectF(ASize.cx, ASize.cy, ASize.cx, ASize.cy));
end;
...
begin
  ...
  ScaleInfo.Selection :=
    cxRect(GetScaledRect(ASize, dxPointF(ScaleInfo.Bounds.Width / ASize.cx,
...
var
  Var1: TdxSizeF;
begin
  Var1 := GetContentOriginalSize;
  FScaleFactor.X := ScaleInfo.Bounds.Width /
    Var1.cx;
  FScaleFactor.Y := ScaleInfo.Bounds.Height /
    Var1.cy;
...
procedure TdxGaugeCustomScaleViewInfo.DoDrawLayer(AGPGraphics: TdxGPGraphics;
  ALayerIndex: Integer);
begin
...
procedure TdxGaugeCustomScaleViewInfo.PopulateParameters
  (AParameters: TdxGaugeCustomScaleParameters);
begin
  FParameters.Assign(AParameters);
end;
...
procedure TdxGaugeCustomScaleViewInfo.CreateStyle(AScaleType: TdxGaugeScaleType;
  const AStyleName: string);
begin
...
procedure TdxGaugeCustomScaleViewInfo.DoDrawBackground
  (AGPGraphics: TdxGPGraphics);
begin
...
function TdxGaugeCustomScaleViewInfo.GetElementImage(AType: TdxGaugeElementType)
  : TGraphic;
begin
  Result := FStyle.GetElement(AType);
end;

function TdxGaugeCustomScaleViewInfo.GetElementImageOriginalSize
  (AImage: TGraphic): TdxSizeF;
begin
...
function TdxGaugeCustomScaleViewInfo.GetCenter(const ABounds: TdxRectF)
  : TdxPointF;
var
  AOffset: TdxPointF;
begin
...
procedure TdxGaugeScaleStyleFactory.SaveStyleToStream
  (AScaleType: TdxGaugeScaleType; const AStyleName: string; AStream: TStream);
var
  AXMLDocument: TdxXMLDocument;
begin
  AXMLDocument := ExtractStyleToDocument(AScaleType, AStyleName);
...
procedure TdxGaugeScaleStyleFactory.UnregisterPredefinedStyles
  (AScaleClass: TdxGaugeCustomScaleClass);
var
  I: Integer;
begin
...
procedure TdxGaugeScaleStyleFactory.UnregisterStyle
  (AScaleType: TdxGaugeScaleType; const AStyleName: string);
var
...
procedure TdxGaugeScaleStyleFactory.UnregisterStyles
  ...
  procedure UnregistryStyles(Var1
    : TStringList);
  begin
    if Var1 <> nil then
      while Var1.Count > 0 do
        DeleteStyle(Var1, 0);
  end;
...
function TdxGaugeScaleStyleFactory.CreateStyleInfo(const AFileName: string)
  : TdxGaugeScaleStyleInfo;
var
...
begin
  ...
  try
    ...
    Result.ScaleType := dxGaugeScaleTypeInfos.GetTypeByName
      (AStyle.ScaleTypeName);
...
function TdxGaugeScaleStyleFactory.ExtractStyleToDocument
  (AScaleType: TdxGaugeScaleType; const AStyleName: string): TdxXMLDocument;
var
...
function TdxGaugeScaleStyleFactory.GetStyleInfo(AStyles: TStringList;
  const AStyleName: string): TdxGaugeScaleStyleInfo;
var
  AIndex: Integer;
begin
  if AStyles <> nil then
...
function TdxGaugeScaleStyleFactory.InternalCreateStyle
  (AStyleInfo: TdxGaugeScaleStyleInfo): TdxGaugeScaleStyle;
begin
  if not SameText(AStyleInfo.BaseStyleName, '') then
    Result := FStyleCreator.CreateFromStyle(AStyleInfo,
      GetStyleInfo(GetStyles(stCircularScale), AStyleInfo.BaseStyleName))
  else
    Result := FStyleCreator.CreateStyle(AStyleInfo);
end;

function TdxGaugeScaleStyleFactory.InternalRegisterStyle
  (AScaleType: TdxGaugeScaleType; AStyleInfo: TdxGaugeScaleStyleInfo): Boolean;
var
  AStyles: TStringList;
begin
...
function TdxGaugeScaleStyleFactory.InternalUnregisterStyle(AStyles: TStringList;
  const AStyleName: string): Boolean;
var
  AIndex: Integer;
begin
...
function TdxGaugeScaleStyleFactory.IsInheritedStyle
  (AScaleType: TdxGaugeScaleType): Boolean;
begin
  Result := not(AScaleType in [stDigitalScale, stLinearScale, stCircularScale]);
end;

function TdxGaugeScaleStyleFactory.IsRegisteredStyle
  (AScaleType: TdxGaugeScaleType; const AStyleName: string): Boolean;
var
  AStyles: TStringList;
begin
...
procedure TdxGaugeScaleStyleFactory.DeleteStyle(AStyles: TStringList;
  AIndex: Integer);
begin
  if AStyles <> nil then
  begin
...
procedure TdxGaugeScaleStyleFactory.ProcessError
  (AStyleInfo: TdxGaugeScaleStyleInfo; AErrorCode: Integer);
var
...
begin
  ...
  case AErrorCode of
    0:
      dxGaugeRaiseException(sdxGaugeScaleStyleCollectionBaseStyleUnregistered,
        [ABaseStyleName, AStyleName, dxGaugeScaleTypeInfos.GetFormatedTypeName
        (AScaleType), dxGaugeScaleTypeInfos.GetFormatedTypeName
        (stCircularScale)]);
    1:
      dxGaugeRaiseException
        (sdxGaugeScaleStyleCollectionInvalidStyleFileFormat, []);
    2:
      dxGaugeRaiseException(sdxGaugeScaleStyleCollectionDuplicateStyleName,
...
function TdxGaugeScaleFactory.IsRegisteredScale(AScaleClass
  : TdxGaugeCustomScaleClass): Boolean;
begin
  Result := GetIndexByClass(AScaleClass) <> -1;
end;

procedure TdxGaugeScaleFactory.RegisterScale(AScaleClass
  : TdxGaugeCustomScaleClass; ARegisterPredefinedStyle: Boolean = True);
begin
  ...
  begin
    ...
    begin
      ...
      dxGaugeRaiseException(sdxGaugeScaleFactoryDuplicateScaleClassName,
        [AScaleClass.GetScaleName]);
  end;
end;

procedure TdxGaugeScaleFactory.UnregisterScale(AScaleClass
  : TdxGaugeCustomScaleClass; AUnregisterPredefinedStyle: Boolean = True);
