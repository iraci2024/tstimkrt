...
uses
  ...
  dxUIGeneratorDesignHelpers, dxSpreadSheetFormulaBar;
...
begin
  ...
  RegisterComponents(dxCoreLibraryProductPage,
    [TdxSpreadSheet, TdxSpreadSheetFormulaBar]);
  ...
  RegisterComponentEditor(TdxSpreadSheetFormulaBar,
    TdxSpreadSheetComponentEditor);
  RegisterSelectionEditor(TdxSpreadSheetFormulaBar,
    TdxSpreadSheetSelectionEditor);
end;
