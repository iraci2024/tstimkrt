...
begin
  ...
  begin
    ...
    RegisterActions(TdxUIGeneratorHelper.GenerateCategoryName(ACategory),
      ...
      TdxRichEditControlShowPrintPreviewForm], nil);
  end;
end;
...
begin
  ...
  dxPSRegisterReportLinkUnit('dxPSRichEditControlLnk',
    TdxRichEditControlReportLink);

  HideProperty(TypeInfo(Boolean), TdxRichEditControlReportLink, 'ShowDesigner');
  HideProperty(TypeInfo(Boolean), TdxRichEditControlReportLink,
    'ShowPageFooter');
  HideProperty(TypeInfo(Boolean), TdxRichEditControlReportLink,
    'ShowPageHeader');
  HideProperty(TypeInfo(Boolean), TdxRichEditControlReportLink,
  ...
  HideProperty(TypeInfo(Integer), TdxRichEditControlReportLink,
    'StartPageIndex');
  HideProperty(TypeInfo(Integer), TdxRichEditControlReportLink, 'TimeFormat');
  HideProperty(TypeInfo(string), TdxRichEditControlReportLink,
    'DesignerCaption');
  HideProperty(TypeInfo(TdxAssignedFormatValues), TdxRichEditControlReportLink,
    'AssignedFormatValues');
  HideProperty(TypeInfo(TdxPageNumberFormat), TdxRichEditControlReportLink,
    'PageNumberFormat');
  HideProperty(TypeInfo(TdxPrinterPage), TdxRichEditControlReportLink,
    'PrinterPage');
  HideProperty(TypeInfo(TdxReportFootnotes), TdxRichEditControlReportLink,
    'ReportFootnotes');
  HideProperty(TypeInfo(TdxReportTitle), TdxRichEditControlReportLink,
    'ReportTitle');
  HideProperty(TypeInfo(THelpContext), TdxRichEditControlReportLink,
    'DesignerHelpContext');
