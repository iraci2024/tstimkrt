...
{$ENDIF}
  ...
  cxLookAndFeelPainters, dxSkinsCore, dxLayoutLookAndFeels, cxClasses,
  dxLayoutContainer,
  dxLayoutControl, dxLayoutControlAdapters, StdCtrls, cxButtons, cxContainer,
  cxEdit, cxListBox, cxRadioGroup,
...
type
  ...
  protected
    ...
    property DatabaseFieldsNames: TArray<TdxMergeFieldName>
      read FDatabaseFieldsNames;
  public
...
procedure TdxRichEditInsertMergeFieldForm.CreateParams
...
begin
  ...
  btnInsert.Caption := cxGetResourceString
    (@sdxRichEditInsertMergeFieldButtonInsert);
  btnCancel.Caption := cxGetResourceString
    (@sdxRichEditInsertMergeFieldButtonCancel);
  lblFields.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditInsertMergeFieldFields);
end;
...
function TdxRichEditInsertMergeFieldForm.CreateController(AControllerParameters
...
function TdxRichEditInsertMergeFieldForm.GetFieldNames
...
begin
  ...
  try
    ...
    TdxCustomRichEditControlAccess(AControl).DoCustomizeMergeFields
      (AControl, AArgs);
...
begin
  ...
  ACommand := Safe<TdxInsertMergeFieldCommand>.Cast
    (Control.InnerControl.CreateCommand
...
procedure TdxRichEditInsertMergeFieldForm.lbMergeFieldsDblClick
  (Sender: TObject);
begin
  InsertMergeField;
end;
  ...
  try
    ...
    begin
      for AFieldName in AFieldNames do
        lbMergeFields.Items.AddObject(AFieldName.DisplayName,
          AFieldName as TdxMergeFieldName);
