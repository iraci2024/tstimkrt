...
type
  ...
  TcxPivotGridDesignHelper = class(TcxPivotGridCustomDesignHelper, IUnknown,
    IcxPivotGridDesignerHelper, IDesignNotification)
  protected
    Listeners: TList;
    // IUnknown
...
begin
  Result := TcxDBPivotGrid(TcxDBPivotGridFieldDataBinding(GetComponent(0))
...
function TcxPivotGridFieldGroupIntervalAdvancedProperty.GetAttributes
  : TPropertyAttributes;
begin
  Result := inherited GetAttributes - [paSubProperties, paReadOnly] +
    [paValueList];
end;
...
procedure TcxPivotGridFieldGroupIntervalAdvancedProperty.GetValues
  (Proc: TGetStrProc);
var
  I: Integer;
begin
...
procedure TcxPivotGridFieldGroupIntervalAdvancedProperty.SetValue
  (const Value: string);
var
...
procedure TcxDBPivotGridComponentEditor.PrepareLinkableSubItem
  (const AItem: TDesignMenuItem);
begin
  AItem.Checked := (Component as TcxDBPivotGrid)
...
procedure TcxPivotGridDesignHelper.AddListener(APivotGrid: TcxCustomPivotGrid);
begin
...
procedure TcxPivotGridDesignHelper.Select(AObject: TPersistent;
  AShift: TShiftState);
var
...
function TcxPivotGridDesignHelper.QueryInterface(const IID: TGUID;
  out Obj): HResult;
const
...
// IDesignNotification
procedure TcxPivotGridDesignHelper.ItemDeleted(const ADesigner: IDesigner;
  AItem: TPersistent);
begin
...
procedure TcxPivotGridDesignHelper.ItemInserted(const ADesigner: IDesigner;
  AItem: TPersistent);
begin
end;
...
procedure TcxPivotGridDesignHelper.SelectionChanged(const ADesigner: IDesigner;
  const ASelection: IDesignerSelections);
var
  I: Integer;
begin
...
procedure TcxPivotGridDesignHelper.DesignerOpened(const ADesigner: IDesigner;
  AResurrecting: Boolean);
begin
end;

procedure TcxPivotGridDesignHelper.DesignerClosed(const ADesigner: IDesigner;
  AGoingDormant: Boolean);
begin
end;
...
begin
  ...
  RegisterNoIcon([TcxPivotGridField, TcxDBPivotGridField, TcxPivotGridOLAPField,
    TcxPivotGridStyleSheet]);
  RegisterClasses([TcxPivotGridField, TcxDBPivotGridField,
    TcxPivotGridOLAPField, TcxPivotGridStyleSheet]);
  RegisterClasses([TcxPivotGridFieldDataBinding,
  ...
  RegisterComponentEditor(TcxPivotGridSummaryDataSet,
    TcxCustomPivotGridComponentEditor);
  RegisterComponentEditor(TcxPivotGridDrillDownDataSet,
    TcxCustomPivotGridComponentEditor);

  RegisterPropertyEditor(TypeInfo(Boolean), TcxPivotGridField,
    'IsCaptionAssigned', nil);
  RegisterPropertyEditor(TypeInfo(Boolean), TcxPivotGridFieldGroup,
    'IsCaptionAssigned', nil);
  RegisterPropertyEditor(TypeInfo(Boolean), TcxPivotGridOptionsDataField,
    'IsCaptionAssigned', nil);

  RegisterPropertyEditor(TypeInfo(TComponent), TcxPivotGridFieldHeaderMenu,
    'PopupMenu', TcxControlPopupMenuProperty);
  RegisterPropertyEditor(TypeInfo(TComponent), TcxPivotGridGroupValueMenu,
    'PopupMenu', TcxControlPopupMenuProperty);
  RegisterPropertyEditor(TypeInfo(TComponent), TcxPivotGridHeaderAreaMenu,
    'PopupMenu', TcxControlPopupMenuProperty);
  ...
  RegisterPropertyEditor(TypeInfo(TcxPivotGridField),
    TcxPivotGridSortBySummaryInfo, 'Field', TcxPivotGridSummaryFieldProperty);
  RegisterPropertyEditor(TypeInfo(string), TcxPivotGridField,
