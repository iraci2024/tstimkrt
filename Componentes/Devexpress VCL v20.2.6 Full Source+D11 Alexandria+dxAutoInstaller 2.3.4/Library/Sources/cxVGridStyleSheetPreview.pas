...
class function TcxVerticalGridStyleSheetEditorPreview.GetStyleSheetClass
...
const
  Captions: array [0 .. 3] of string = ('Text edit', 'Currency edit',
    'Spin edit', 'Date edit');
  ValueTypes: array [0 .. 3] of string = ('String', 'Currency',
    'Integer', 'Date');
...
begin
  ...
  try
    ...
    for I := 0 to 3 do
    begin
      AEditorRow := TcxEditorRow(VerticalGrid.AddChild(ACategoryRow,
        TcxEditorRow));
      with AEditorRow do
      begin
        Properties.HeaderAlignmentVert := vaCenter;
