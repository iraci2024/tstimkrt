...
uses
  Types, Math, Classes, SysUtils, Variants, StrUtils, Generics.Collections,
  Generics.Defaults,
  // cx
  cxClasses,
  cxDateUtils,
...
type
  ...
  TdxSpreadSheetFunctionParamKindInfo = array of
    TdxSpreadSheetFunctionParamKind;

  TdxSpreadSheetForEachCallBack = function(const AValue: Variant;
    ACanConvertStrToNumber: Boolean;
    var AErrorCode: TdxSpreadSheetFormulaErrorCode;
    AData, AInfo: Pointer): Boolean;

  TdxSpreadSheetFormulaEnumReferencesProc = reference to procedure
    (const AArea: TRect; AView: TObject);
  TdxSpreadSheetFormulaEnumReferenceTokensProc = reference to procedure
    (const AArea: TRect; AView: TObject; AToken: TdxSpreadSheetFormulaToken);
  ...
  public
    property Items[Index: Integer]: TdxSpreadSheetCustomFormula
      read GetItem; default;
  end;

  { TdxSpreadSheetCustomFormulaController }

  TdxSpreadSheetEnumFormulasFunc = reference to function
    (AFormula: TdxSpreadSheetCustomFormula): Boolean;

  TdxSpreadSheetCustomFormulaController = class abstract(TcxObjectList,
    IcxFormatControllerListener, IdxLocalizerListener, IUnknown)
  strict private
  ...
  protected
    ...
    function CreateParser: TObject;
    { TdxSpreadSheetCustomFormulaParser } virtual; abstract;
    ...
    function ExtractVector(AView: TObject; ARow, AColumn, ALength: Integer;
      AIsVertical: Boolean; var AErrorCode: TdxSpreadSheetFormulaErrorCode)
      : TdxSpreadSheetVector;
    procedure GetCellValue(const AViewData: IdxSpreadSheetViewData;
      ARow, AColumn: Integer; out AValue: Variant;
      out AErrorCode: TdxSpreadSheetFormulaErrorCode); inline;
    procedure GetCellValueCore(const AViewData: IdxSpreadSheetViewData;
      ARow, AColumn: Integer; out AValue: Variant;
      out AErrorCode: TdxSpreadSheetFormulaErrorCode);

    // Array Formulas
    function GetArrayFormulaSlaveCellValue(AViewData: IdxSpreadSheetViewData;
      AArrayFormula: TdxSpreadSheetCustomFormula; const ARow, AColumn: Integer;
    ...
    function IsPartOfArrayFormula(AView: TObject; const ARow, AColumn: Integer;
      var AFormulaArea: TRect; AFormula: PdxSpreadSheetCustomFormula = nil)
      : TdxSpreadSheetArrayFormulaPart;
    procedure UpdateSlaveCells(AView: TObject;
    ...
    property CircularReference: Boolean read FCircularReference
      write FCircularReference;
    property HasCircularReferences: Boolean read FHasCircularReferences
      write FHasCircularReferences;
    property UpdatingSlaveCells: Boolean read FUpdatingSlaveCells;
    property ArrayFormulas
      : TDictionary<TObject, TdxSpreadSheetCustomFormulaList>
      read FArrayFormulas;
  public
    constructor Create;
    ...
    procedure EnumArrayFormulas(AView: TObject;
      AProc: TdxSpreadSheetEnumFormulasFunc);
    ...
    property CircularReferencePathsAsString: string
      read GetCircularReferencePathsAsString;
  ...
  protected
    ...
    procedure CleanFunctionTokenCachedResults(AExpression
      : TdxSpreadSheetFormulaToken); overload;
    procedure ClearResult; virtual;
    procedure DestroyTokens;
    procedure ForceRefresh;

    function Calculate(AExpression: TdxSpreadSheetFormulaToken)
      : TdxSpreadSheetFormulaResult;
    function CalculateAsArrayParam(AExpression: TdxSpreadSheetFormulaToken)
      : TdxSpreadSheetFormulaResult;
    ...
    procedure SetError(AErrorCode: TdxSpreadSheetFormulaErrorCode;
      AErrorIndex: Integer);

    function UpdateReferences(AView: TObject; const AArea: TRect;
      const ATargetOrigin: TPoint;
      AMode: TdxSpreadSheetFormulaUpdateReferencesMode): Boolean; virtual;
    procedure UpdateSlaveCells;

    property ActualErrorCode: TdxSpreadSheetFormulaErrorCode
      read GetActualErrorCode;
    property ActualResult: TdxSpreadSheetFormulaResult read GetActualResult;
    property NeedCalculateParamsAsArray: Boolean
      read FNeedCalculateParamsAsArray;
  ...
  public
    ...
    procedure EnumReferences(AProc: TdxSpreadSheetFormulaEnumReferencesProc;
      AProcessDefinedNames: Boolean = False); overload;
    procedure EnumReferences
    ...
    property IsArrayFormula: Boolean read FIsArrayFormula
      write SetIsArrayFormula;
    //
    property Controller: TdxSpreadSheetCustomFormulaController
      read GetController;
    property FormatSettings: TdxSpreadSheetFormatSettings
      read GetFormatSettings;
  ...
  protected
    ...
    procedure CalculateDimension(var ADimension
    ...
    function ExtractColumn(const AIndex: Integer;
      var AErrorCode: TdxSpreadSheetFormulaErrorCode)
      : TdxSpreadSheetVector; virtual;
    function ExtractRow(const AIndex: Integer;
      var AErrorCode: TdxSpreadSheetFormulaErrorCode)
      : TdxSpreadSheetVector; virtual;
    function ExtractValueAsVector(var AErrorCode
      : TdxSpreadSheetFormulaErrorCode): TdxSpreadSheetVector; virtual;
    function ForEach(AProc: TdxSpreadSheetForEachCallBack; const AData: Pointer;
      var AErrorCode: TdxSpreadSheetFormulaErrorCode): Boolean; virtual;
    function ForEachCell(AView: TObject; AStartColumn, AStartRow, AFinishColumn,
      AFinishRow: Integer; AProc: TdxSpreadSheetForEachCallBack;
      const AData: Pointer;
  ...
  public
    ...
    procedure EnumReferences
      (AProc: TdxSpreadSheetFormulaEnumReferenceTokensProc;
      AProcessDefinedNames: Boolean = False); virtual;
    function ExtractFromList: TdxSpreadSheetFormulaToken;
    function GetDimension(var AErrorCode: TdxSpreadSheetFormulaErrorCode)
      : TdxSpreadSheetFormulaTokenDimension;
    ...
    procedure GetCellValue(AView: TObject; const ARow, AColumn: Integer;
      var AValue: Variant;
      var AErrorCode: TdxSpreadSheetFormulaErrorCode); virtual;
    procedure GetCellValueAsOrdinal(AView: TObject;
      const ARow, AColumn: Integer; var AValue: Variant;
      var AErrorCode: TdxSpreadSheetFormulaErrorCode); inline;
    ...
    function GetValueFromArray(ARowIndex, AColumnIndex: Integer;
      var AErrorCode: TdxSpreadSheetFormulaErrorCode): Variant;
    procedure GetValueRelatedWithCell(const ACell: TPoint; var AValue: Variant;
      var AErrorCode: TdxSpreadSheetFormulaErrorCode); virtual;

    // Utilities
    class function Add(APrev, AToken: TdxSpreadSheetFormulaToken)
      : TdxSpreadSheetFormulaToken; inline;
    class procedure AddChild(AParent, AToken: TdxSpreadSheetFormulaToken);
    class function Append(APrev, AToken: TdxSpreadSheetFormulaToken)
      : TdxSpreadSheetFormulaToken; inline;
    class procedure DestroyTokens(var ATokens: TdxSpreadSheetFormulaToken);
    class function FindToken(ASourcePosition: Integer;
      ATokens: TdxSpreadSheetFormulaToken): TdxSpreadSheetFormulaToken;
    class procedure Remove(var AList: TdxSpreadSheetFormulaToken;
      AToken: TdxSpreadSheetFormulaToken); inline;
    class procedure Replace(var ASource: TdxSpreadSheetFormulaToken;
      const ADest: TdxSpreadSheetFormulaToken); overload;
    class procedure Replace(var AList, ASource: TdxSpreadSheetFormulaToken;
      const ADest: TdxSpreadSheetFormulaToken); overload;
    ...
    property Items[Index: Integer]: TdxSpreadSheetFormulaToken
      read GetItem; default;
  ...
  public
    constructor Create(AView: TObject;
      AFormulaController: TdxSpreadSheetCustomFormulaController;
      AIsRow: Boolean; ATableItemIndex, AAnchorItemsIndex, ALength: Integer);
      reintroduce; virtual;
    function GetNextItemIndex(AIndex: Integer; AForward: Boolean)
      : Integer; override;
  ...
  TdxSpreadSheet3DReferenceCustomLinkClass = class of
    TdxSpreadSheet3DReferenceCustomLink;
  ...
  TdxSpreadSheet3DReferenceCustomExternalLink = class
    (TdxSpreadSheet3DReferenceCustomLink)
  strict private
    FName: string;
  public
    constructor Create(AData: TObject; const AName: string);
  ...
  protected
    ...
    function DoExtractDateTimeParameter(var AParameter: Variant;
      const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer;
      AWithoutBoolean: Boolean): Boolean;
  public
    ...
    function ConvertToNumeric(var AValue: Variant;
      ACanConvertStr, AWithoutBoolean: Boolean): Boolean;
    procedure Delete(Index: Integer);
    function FirstItem: TdxSpreadSheetFormulaToken; inline;
    function LastItem: TdxSpreadSheetFormulaToken; inline;

    procedure ExtractCondition(AParams: TdxSpreadSheetFormulaToken;
      AMaxCount, AIndex: Integer; var AConditionValue: Variant;
      var AOperation: TdxSpreadSheetFormulaOperation);
    function ExtractColumnFromRange(const ARange: TdxSpreadSheetFormulaToken;
      AColumnIndex: Integer; var AErrorCode: TdxSpreadSheetFormulaErrorCode)
      : TdxSpreadSheetVector; inline;
    function ExtractDateTimeOnlyParameter(var AParameter: Variant;
      const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer = 0): Boolean;
    function ExtractDateTimeParameter(var AParameter: Variant;
      const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer = 0): Boolean;
    function ExtractDateTimeParameterWithoutBoolean(var AParameter: Variant;
      const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer = 0): Boolean;
    function ExtractErrorCode(const AParams: TdxSpreadSheetFormulaToken)
      : TdxSpreadSheetFormulaErrorCode; overload;
    function ExtractNumericParameter(var AParameter: Variant;
      const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer = 0)
      : Boolean; overload;
    function ExtractNumericParameterDef(var AParameter: Variant;
      const ADefaultIfNoExist, ADefaultIfNull: Variant;
      const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer = 0)
      : Boolean; overload;
    function ExtractNumericParameterDef(var AParameter: Variant;
      const ADefaultIfNull: Variant; const AParams: TdxSpreadSheetFormulaToken;
      AIndex: Integer = 0): Boolean; overload;
    function ExtractNumericParameterDefWithoutBoolean(var AParameter: Variant;
      const ADefault: Variant; const AParams: TdxSpreadSheetFormulaToken;
      AIndex: Integer = 0): Boolean;
    function ExtractNumericParameterWithoutBoolean(var AParameter: Variant;
      const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer = 0): Boolean;
    function ExtractNumericValue(var AValue: Variant): Boolean;
    function ExtractParameter(var AParameter: Variant;
      const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer = 0)
      : Boolean; overload;
    function ExtractParameter(var AParameter: Variant;
      out ACanConvertStrToNumber: Boolean;
      const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer = 0)
      : Boolean; overload;
    function ExtractParameterDef(var AParameter: Variant;
      ADefaultIfNoExist, ADefaultIfNull: Variant;
      const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer = 0)
      : Boolean; overload;
    function ExtractParameterDef(var AParameter: Variant;
      ADefaultIfNull: Variant; const AParams: TdxSpreadSheetFormulaToken;
      AIndex: Integer = 0): Boolean; overload;
    function ExtractRowFromRange(const ARange: TdxSpreadSheetFormulaToken;
      ARowIndex: Integer; var AErrorCode: TdxSpreadSheetFormulaErrorCode)
      : TdxSpreadSheetVector; inline;
    function ExtractStringParameter(const AParams: TdxSpreadSheetFormulaToken;
      AIndex: Integer = 0): string; inline;
    function ExtractStringValue: Variant; inline;
    procedure ExtractToken(AToken: TdxSpreadSheetFormulaToken;
      out AOwnership: TStreamOwnership);
    function ExtractValue(out ACanConvertStrToNumber: Boolean): Variant; inline;
    function ExtractValueToken(out AOwnership: TStreamOwnership)
      : TdxSpreadSheetFormulaToken;
    procedure ForEach(AParams: TdxSpreadSheetFormulaToken;
      AProc: TdxSpreadSheetForEachCallBack; const AData: Pointer); overload;
    function GetParamsCount(const AParams: TdxSpreadSheetFormulaToken)
      : Integer; inline;
    function ParameterExists(const AParams: TdxSpreadSheetFormulaToken;
      AIndex: Integer): Boolean; inline;
    function ParameterIsNull(var AParameter: Variant;
      const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer = 0): Boolean;
      overload; inline;
    function ParameterIsNull(var AParameter: Variant;
      out ACanConvertStrToNumber: Boolean;
...
function CheckCellReference(ARow, AColumn: Integer;
  var AErrorCode: TdxSpreadSheetFormulaErrorCode): Boolean; inline;
procedure dxSpreadSheetCalculateExpression(AExpression
  : TdxSpreadSheetFormulaToken; var AResult: TdxSpreadSheetFormulaResult;
  const AForceConvertNullValueToZero: Boolean = False);
function dxSpreadSheetExpressionToText(AExpression: TdxSpreadSheetFormulaToken)
  : string; overload;
procedure dxSpreadSheetExpressionToText(ABuffer: TStringBuilder;
  AExpression: TdxSpreadSheetFormulaToken); overload;
procedure dxSpreadSheetInitializeParamInfo(const ACount: Integer;
  var AParamCount: Integer;
  var AParamKind: TdxSpreadSheetFunctionParamKindInfo); inline;
function dxSpreadSheetIsReferenceToken(var AToken: TdxSpreadSheetFormulaToken;
  var AResult: TdxSpreadSheetFormulaResult): Boolean;
function dxSpreadSheetParseCellReference(AReference: string;
  AController: TdxSpreadSheetCustomFormulaController; out AScope: TObject;
  out AArea: TRect): Boolean;
procedure dxSpreadSheetParseReference(reference: string; var Formula);

function dxSpreadSheetEscapeString(const S: string): string; overload; inline;
function dxSpreadSheetEscapeString(const S: string; const AMarkChar: Char)
  : string; overload;
function dxSpreadSheetTextValueAsString(const S: string): string;
function dxSpreadSheetUnescapeString(const S: string): string; overload; inline;
function dxSpreadSheetUnescapeString(const S: string; const AMarkChar: Char)
  : string; overload;
...
begin
  if not Supports(AView, IdxSpreadSheetViewData, Result) then
    raise EdxSpreadSheetError.Create
      ('The IdxSpreadSheetViewData was not supported');
end;

function CheckCellReference(ARow, AColumn: Integer;
  var AErrorCode: TdxSpreadSheetFormulaErrorCode): Boolean;
begin
  if (ARow < 0) or (ARow > dxSpreadSheetMaxRowIndex) or (AColumn < 0) or
    (AColumn > dxSpreadSheetMaxColumnIndex) then
    AErrorCode := ecRefErr
  else
    AErrorCode := ecNone;
...
function dxSpreadSheetExpressionToText(AExpression
  : TdxSpreadSheetFormulaToken): string;
var
...
begin
  Result := dxSpreadSheetEscapeString(S, dxStringMarkChar);
end;

function dxSpreadSheetEscapeString(const S: string;
  const AMarkChar: Char): string;
begin
...
begin
  Result := dxSpreadSheetUnescapeString(S, dxStringMarkChar);
end;

function dxSpreadSheetUnescapeString(const S: string;
  const AMarkChar: Char): string;
begin
  Result := StringReplace(S, AMarkChar + AMarkChar, AMarkChar, [rfReplaceAll]);
end;
...
begin
  ...
  try
    ...
    try
      if not AParser.ParseFormula(dxSpreadSheetFormulaIncludeEqualSymbol
        (AReference), AFormula) then
        Exit(False);
    finally
      AParser.Free;
    end;
    ...
    if AFormula.FTokens is TdxSpreadSheetFormulaReferenceToken then
      Exit(TReferenceTokenAccess(AFormula.FTokens)
        .ExtractReference(AScope, AArea));
    Result := False;
  finally
    AFormula.Free;
  end;
...
var
  ...
  AParser: TdxSpreadSheetCustomFormulaParser;
begin
  AParser := AFormula.Controller.CreateParser as
  ...
  try
    ...
    begin
      ...
      raise EdxSpreadSheetError.CreateFmt
        (cxGetResourceString(@sdxErrorInvalidReference),
        [reference, AErrorIndex]);
    end;
  finally
    AParser.Free;
  end;
...
constructor TdxSpreadSheetFakeFormula.Create(AController
  : TdxSpreadSheetCustomFormulaController);
begin
  inherited Create;
...
function TdxSpreadSheetFakeFormula.GetController
  : TdxSpreadSheetCustomFormulaController;
begin
  Result := FController;
end;
...
begin
  ...
  FArrayFormulas := TObjectDictionary<TObject, TdxSpreadSheetCustomFormulaList>.
    Create([doOwnsValues]);
end;
...
procedure TdxSpreadSheetCustomFormulaController.AddArrayFormula
  (AFormula: TdxSpreadSheetCustomFormula);
var
  ...
  try
    ...
    begin
      ...
      if not AFormula.IsArrayFormula and
        (IsPartOfArrayFormula(AFormula.View, AFormula.AnchorRow,
        AFormula.AnchorColumn, AFormulaArea) = afpSlaveCell) then
      begin
        AFormula.Free;
        Continue;
      end;
      ...
      try
        ...
        begin
          ...
          CircularReference := False;
          FCircularPath := TdxSpreadSheetReferencePath.Create
            (AFormula.AnchorRow, AFormula.AnchorColumn, AFormula.View);
          try
            AFormula.GetResultValue;
          finally
            if CircularReference then
...
procedure TdxSpreadSheetCustomFormulaController.EnumArrayFormulas
  (AView: TObject; AProc: TdxSpreadSheetEnumFormulasFunc);
var
  AList: TdxSpreadSheetCustomFormulaList;
  I: Integer;
begin
...
procedure TdxSpreadSheetCustomFormulaController.Remove
  (AFormula: TdxSpreadSheetCustomFormula);
var
  AList: TdxSpreadSheetCustomFormulaList;
begin
...
procedure TdxSpreadSheetCustomFormulaController.AddPath(ARow, AColumn: Integer;
  AView: TObject);
begin
...
procedure TdxSpreadSheetCustomFormulaController.RemovePath(ARow,
  AColumn: Integer; AView: TObject);
begin
...
begin
  ...
  if HasCircularReferences then
    raise EdxSpreadSheetCircularReferencesError.Create
      (cxGetResourceString(@sdxErrorCircularMessage));
end;

function TdxSpreadSheetCustomFormulaController.CircularPathToString
  (APath: TdxSpreadSheetReferencePath): string;
var
  ABuffer: TStringBuilder;
begin
  ABuffer := TdxStringBuilderManager.Get;
...
function TdxSpreadSheetCustomFormulaController.
...
begin
  ...
  begin
    ...
    Result := AResultToken.GetValueFromArray(ARow - AArrayFormula.AnchorRow,
      AColumn - AArrayFormula.AnchorColumn, AErrorCode);
    if (AResultToken.Dimension.RowCount = 0) and
      (AResultToken.Dimension.ColumnCount = 0) then
...
function TdxSpreadSheetCustomFormulaController.IsPartOfArrayFormula
  (AView: TObject; const ARow, AColumn: Integer; var AFormulaArea: TRect;
  AFormula: PdxSpreadSheetCustomFormula): TdxSpreadSheetArrayFormulaPart;
var
...
procedure TdxSpreadSheetCustomFormulaController.UpdateSlaveCells(AView: TObject;
  AFormula: TdxSpreadSheetCustomFormula);
var
  ...
  try
    ...
    for ARow := AArrayFormulaArea.Top to AArrayFormulaArea.Bottom do
      for AColumn := AArrayFormulaArea.Left to AArrayFormulaArea.Right do
        if (ARow <> AArrayFormulaArea.Top) or (AColumn <> AArrayFormulaArea.Left)
        then
        begin
          AValue := GetArrayFormulaSlaveCellValue(AViewData, AFormula, ARow,
            AColumn, AErrorCode);
...
function TdxSpreadSheetCustomFormulaController.ExtractVector(AView: TObject;
  ARow, AColumn, ALength: Integer; AIsVertical: Boolean;
...
procedure TdxSpreadSheetCustomFormulaController.GetCellValue(const AViewData
  : IdxSpreadSheetViewData; ARow, AColumn: Integer; out AValue: Variant;
  out AErrorCode: TdxSpreadSheetFormulaErrorCode);
begin
...
procedure TdxSpreadSheetCustomFormulaController.GetCellValueCore(const AViewData
  : IdxSpreadSheetViewData; ARow, AColumn: Integer; out AValue: Variant;
  out AErrorCode: TdxSpreadSheetFormulaErrorCode);
var
...
function TdxSpreadSheetCustomFormulaController.QueryInterface(const IID: TGUID;
  out Obj): HResult;
begin
...
function TdxSpreadSheetCustomFormulaController.
  GetCircularReferencePathsAsString: string;
var
  I: Integer;
begin
  Result := '';
  ...
  begin
    ...
    Result := Result + CircularPathToString
      (TdxSpreadSheetReferencePath(CircularReferencePaths[I]));
  end;
end;

function TdxSpreadSheetCustomFormulaController.GetItem(AIndex: Integer)
  : TdxSpreadSheetCustomFormula;
begin
...
procedure TdxSpreadSheetCustomFormula.EnumReferences
  ...
  AProcessDefinedNames: Boolean = False);
begin
  EnumReferences(
...
var
  ...
  procedure DoCheckTokens(AToken: TdxSpreadSheetFormulaToken;
  const ATokenLevel: Integer);
  var
    ACount: Integer;
  begin
    ACount := 0;
...
begin
  ...
  begin
    ...
    AIsCorrectFormula := (ARangeCount <= MaxRangeCount) and
      (AArgsCount <= MaxArgsCount) and (ALevel <= MaxLevel);
  end;
...
function TdxSpreadSheetCustomFormula.Calculate(AExpression
  : TdxSpreadSheetFormulaToken): TdxSpreadSheetFormulaResult;
var
...
function TdxSpreadSheetCustomFormula.CalculateAsArrayParam
  (AExpression: TdxSpreadSheetFormulaToken): TdxSpreadSheetFormulaResult;
begin
...
var
  AMaxIterationCount: Integer;
  APrevIteration: Integer;
  ATempResult: TdxSpreadSheetFormulaResult;
begin
  AMaxIterationCount := GetMaxIterationCount;

  ATempResult := nil;
  APrevIteration := FIteration;
  Inc(FIteration);
  try
    if (Iteration > 1) and (Iteration >= AMaxIterationCount) then
    begin
      ATempResult := TdxSpreadSheetFormulaResult.Create(Self);
      ATempResult.AddValue(0);
      Controller.CircularReference := Controller.CircularReference or
        (AMaxIterationCount = 1)
    end
    else
    ...
    if (APrevIteration = 0) and (AMaxIterationCount > 1) then
      CacheResultValue(ATempResult.Value);
    FreeAndNil(FResultValue);
...
function TdxSpreadSheetCustomFormula.GetActualResult
  : TdxSpreadSheetFormulaResult;
begin
  Result := nil;
...
function TdxSpreadSheetCustomFormula.GetResultValue
  : TdxSpreadSheetFormulaResult;
begin
...
function TdxSpreadSheetCustomFormula.GetController
  : TdxSpreadSheetCustomFormulaController;
begin
  Result := nil;
end;
...
procedure TdxSpreadSheetCustomFormula.SetError
  (AErrorCode: TdxSpreadSheetFormulaErrorCode; AErrorIndex: Integer);
begin
  FErrorCode := AErrorCode;
  FErrorIndex := AErrorIndex;
end;

function TdxSpreadSheetCustomFormula.UpdateReferences(AView: TObject;
const AArea: TRect; const ATargetOrigin: TPoint;
AMode: TdxSpreadSheetFormulaUpdateReferencesMode): Boolean;
var
  AToken: TdxSpreadSheetFormulaToken;
begin
  Result := False;
...
function TdxSpreadSheetCustomFormula.GetActualErrorCode
...
function TdxSpreadSheetCustomFormula.GetFormatSettings
...
procedure TdxSpreadSheetFormulaToken.AddResult
  (AToken: TdxSpreadSheetFormulaToken);
begin
  // do nothing
end;

procedure TdxSpreadSheetFormulaToken.Calculate
...
begin
  Result := (Owner <> nil) and (Controller <> nil) and
    Controller.CircularReference;
end;
...
function TdxSpreadSheetFormulaToken.ExtractColumn(const AIndex: Integer;
var AErrorCode: TdxSpreadSheetFormulaErrorCode): TdxSpreadSheetVector;
begin
  Result := ExtractValueAsVector(AErrorCode);
end;

function TdxSpreadSheetFormulaToken.ExtractRow(const AIndex: Integer;
var AErrorCode: TdxSpreadSheetFormulaErrorCode): TdxSpreadSheetVector;
begin
  Result := ExtractValueAsVector(AErrorCode);
end;

function TdxSpreadSheetFormulaToken.ExtractValueAsVector(var AErrorCode
  : TdxSpreadSheetFormulaErrorCode): TdxSpreadSheetVector;
var
  AValue: Variant;
...
function TdxSpreadSheetFormulaToken.ForEach
  (AProc: TdxSpreadSheetForEachCallBack; const AData: Pointer;
var AErrorCode: TdxSpreadSheetFormulaErrorCode): Boolean;
var
  AValue: Variant;
begin
  GetValue(AValue, AErrorCode);
  Result := AProc(AValue, CanConvertStrToNumber, AErrorCode, AData, nil) and
    (AErrorCode = ecNone);
end;

function TdxSpreadSheetFormulaToken.ForEachCell(AView: TObject;
AStartColumn, AStartRow, AFinishColumn, AFinishRow: Integer;
AProc: TdxSpreadSheetForEachCallBack; const AData: Pointer;
var AErrorCode: TdxSpreadSheetFormulaErrorCode): Boolean;

  function ApplyConditionsForEmptyCells(ABeginRow, AEndRow: Integer;
  var ACellReference: TdxSpreadSheetCellReference): Boolean;
  var
  ...
  begin
    ...
    Result := AProc(Unassigned, CanConvertStrToNumber, AErrorCode, AData,
      @ACellReference);
    if Result and (AErrorCode = ecNone) then
    begin
      AResultData.CountValues := AResultData.CountValues +
        (AResultData.CountValues - ACountValues) * (AEndRow - ABeginRow);
      AResultData.ResultValue := AResultData.ResultValue +
        (AResultData.ResultValue - AResultValue) * (AEndRow - ABeginRow);
    end;
  end;

  function CheckRange: Boolean;
  begin
    Result := InRange(AStartRow, 0, dxSpreadSheetMaxRowIndex) and
      InRange(AFinishRow, 0, dxSpreadSheetMaxRowIndex) and
      InRange(AStartColumn, 0, dxSpreadSheetMaxColumnIndex) and
      InRange(AFinishColumn, 0, dxSpreadSheetMaxColumnIndex);
  end;
  ...
  begin
    ...
    begin
      ...
      if CheckCircularReference then
        Break;
      Result := AProc(AValue, CanConvertStrToNumber, AErrorCode, AData,
        @ACellReference);
      if Result and (AErrorCode = ecNone) then
        if ARowIndex < AFinishRow then
        begin
          AOldRowIndex := ARowIndex;
          ARowIndex := ADataProvider.GetNextRowWithNonEmptyCell(ARowIndex,
            AColumnIndex, True);
          ...
          if ARowIndex - AOldRowIndex > 1 then
            if TObject(AData) is TdxSpreadSheetEnumValuesWithCondition then
              Result := ApplyConditionsForEmptyCells(AOldRowIndex + 1,
                Min(ARowIndex - 1, AFinishRow), ACellReference)
            else if TObject(AData) is TdxSpreadSheetEnumValues then
              TdxSpreadSheetEnumValues(AData).IncrementPassedCellCount
                (Min(ARowIndex - 1, AFinishRow) - AOldRowIndex);
        end
        else
          Inc(ARowIndex);
...
begin
  if CheckCellReference(ARow, AColumn, AErrorCode) then
  begin
    if Supports(AView, IdxSpreadSheetViewData, AViewData) then
    begin
      if Controller.IsPartOfArrayFormula(AView, ARow, AColumn, AFormulaArea,
        @AArrayFormula) <> afpNone then
        AValue := Controller.GetArrayFormulaSlaveCellValue(AViewData,
          AArrayFormula, ARow, AColumn, AErrorCode)
      else
        Controller.GetCellValueCore(AViewData, ARow, AColumn, AValue,
          AErrorCode);
    end
    else
      AErrorCode := ecRefErr;
...
begin
  ...
  if VarIsStr(ACellValue) and
    not((ACell <> nil) and (ACell.DataType = cdtString)) and
    not dxTryStrToOrdinal(ACellValue, AValue, Owner.FormatSettings) then
    AValue := ACellValue;
end;

procedure TdxSpreadSheetFormulaToken.GetValueAsArrayItem(const ARow,
  AColumn: Integer; var AValue: Variant;
var AErrorCode: TdxSpreadSheetFormulaErrorCode);
begin
  GetValue(AValue, AErrorCode);
end;
...
procedure TdxSpreadSheetFormulaToken.CalculateDimension(var ADimension
  : TdxSpreadSheetFormulaTokenDimension;
var AErrorCode: TdxSpreadSheetFormulaErrorCode);
begin
...
function TdxSpreadSheetFormulaToken.GetDimension(var AErrorCode
  : TdxSpreadSheetFormulaErrorCode): TdxSpreadSheetFormulaTokenDimension;
begin
...
procedure TdxSpreadSheetFormulaToken.GetValue(var AValue: Variant;
var AErrorCode: TdxSpreadSheetFormulaErrorCode);
var
...
function TdxSpreadSheetFormulaToken.GetValueFromArray(ARowIndex,
  AColumnIndex: Integer;
var AErrorCode: TdxSpreadSheetFormulaErrorCode): Variant;
...
procedure TdxSpreadSheetFormulaToken.GetValueRelatedWithCell
  (const ACell: TPoint; var AValue: Variant;
var AErrorCode: TdxSpreadSheetFormulaErrorCode);
begin
  GetValue(AValue, AErrorCode);
end;
...
class function TdxSpreadSheetFormulaToken.Add(APrev,
  AToken: TdxSpreadSheetFormulaToken): TdxSpreadSheetFormulaToken;
begin
  Result := AToken;
  if APrev = nil then
    Exit;
...
class procedure TdxSpreadSheetFormulaToken.AddChild(AParent,
  AToken: TdxSpreadSheetFormulaToken);
var
...
class function TdxSpreadSheetFormulaToken.Append(APrev,
  AToken: TdxSpreadSheetFormulaToken): TdxSpreadSheetFormulaToken;
begin
  if APrev <> nil then
  begin
...
class procedure TdxSpreadSheetFormulaToken.DestroyTokens
  (var ATokens: TdxSpreadSheetFormulaToken);
var
...
class function TdxSpreadSheetFormulaToken.FindToken(ASourcePosition: Integer;
ATokens: TdxSpreadSheetFormulaToken): TdxSpreadSheetFormulaToken;
begin
  Result := nil;
  while ATokens <> nil do
  begin
    if (ASourcePosition >= ATokens.SourceStart) and
      (ASourcePosition <= ATokens.SourceFinish) or
      (ASourcePosition = ATokens.SourceStart) and
      (ATokens.SourceStart > ATokens.SourceFinish) then
    begin
...
class procedure TdxSpreadSheetFormulaToken.Remove
  (var AList: TdxSpreadSheetFormulaToken; AToken: TdxSpreadSheetFormulaToken);
begin
...
class procedure TdxSpreadSheetFormulaToken.Replace(var AList,
  ASource: TdxSpreadSheetFormulaToken; const ADest: TdxSpreadSheetFormulaToken);
begin
...
class procedure TdxSpreadSheetFormulaToken.Replace
  (var ASource: TdxSpreadSheetFormulaToken;
const ADest: TdxSpreadSheetFormulaToken);
begin
...
procedure TdxSpreadSheetFormulaToken.SetLink(var AField;
...
procedure TdxSpreadSheetFormulaToken.SetNext(ANextToken
  : TdxSpreadSheetFormulaToken);
begin
  FNext := ANextToken;
end;

procedure TdxSpreadSheetFormulaToken.SetOwner(const Value
  : TdxSpreadSheetCustomFormula);
var
  AToken: TdxSpreadSheetFormulaToken;
begin
...
procedure TdxSpreadSheetFormulaToken.UpdateReferences(AView: TObject;
const AArea: TRect; const ATargetOrigin: TPoint;
...
function TdxSpreadSheetFormulaToken.GetController
  : TdxSpreadSheetCustomFormulaController;
begin
  Result := Owner.Controller;
end;

function TdxSpreadSheetFormulaToken.GetCount
  (AToken: TdxSpreadSheetFormulaToken): Integer;
begin
  Result := 0;
  while AToken <> nil do
  begin
...
function TdxSpreadSheetFormulaToken.GetFormatSettings
  : TdxSpreadSheetFormatSettings;
begin
  Result := Owner.FormatSettings;
end;

function TdxSpreadSheetFormulaToken.GetItem(AIndex: Integer)
  : TdxSpreadSheetFormulaToken;
begin
  if AIndex < 0 then
    Result := nil
...
constructor TdxSpreadSheetReferenceVector.Create(AView: TObject;
AFormulaController: TdxSpreadSheetCustomFormulaController; AIsRow: Boolean;
ATableItemIndex, AAnchorItemsIndex, ALength: Integer);
begin
  inherited Create;
  FIsRow := AIsRow;
  FLength := ALength;
  ...
  if IsRow then
    FIsAllItems := (FAnchorItemsIndex = 0) and
      (Length = dxSpreadSheetMaxColumnCount)
  else
    FIsAllItems := (FAnchorItemsIndex = 0) and
      (Length = dxSpreadSheetMaxRowCount);
...
function TdxSpreadSheetReferenceVector.GetItem(Index: Integer)
...
begin
  ...
  begin
    if IsRow then
      FormulaController.GetCellValue(ViewData, TableItemIndex,
        AnchorItemsIndex + Index, AValue, AErrorCode)
    else
      FormulaController.GetCellValue(ViewData, AnchorItemsIndex + Index,
        TableItemIndex, AValue, AErrorCode);
  end;

  Result := TdxSpreadSheetVectorValue.Create(AValue, AErrorCode);
end;

function TdxSpreadSheetReferenceVector.GetNextItemIndex(AIndex: Integer;
...
begin
  ...
  if IsRow then
    Result := ViewData.GetNextColumnWithNonEmptyCell(TableItemIndex,
      AnchorItemsIndex + AIndex, AForward) - AnchorItemsIndex
  else
    Result := ViewData.GetNextRowWithNonEmptyCell(AnchorItemsIndex + AIndex,
      TableItemIndex, AForward) - AnchorItemsIndex;
...
function TdxSpreadSheet3DReferenceCustomLink.Clone
  : TdxSpreadSheet3DReferenceCustomLink;
begin
...
begin
  ...
  begin
    if not Supports(AValue, IdxSpreadSheetObjectLink, FLink) then
      raise EdxSpreadSheetError.Create
        ('IdxSpreadSheetObjectLink is not supported');
  end
  else
    FLink := nil;
end;
...
constructor TdxSpreadSheet3DReferenceCustomExternalLink.Create(AData: TObject;
const AName: string);
begin
...
function TdxSpreadSheet3DReferenceCustomExternalLink.Clone
  : TdxSpreadSheet3DReferenceCustomLink;
begin
  Result := inherited;
...
constructor TdxSpreadSheetFormulaResult.Create
...
procedure TdxSpreadSheetFormulaResult.AddTemporary
...
procedure TdxSpreadSheetFormulaResult.AddResultValue(const AValue
  : TdxSpreadSheetFormulaResult);
begin
  if AValue = nil then
    SetError(ecValue)
...
begin
  if (Values.Count = 0) or not TdxSpreadSheetFormulaToken(Values.Last).IsEnumeration
  then
    GetValue;
end;
...
function dxTryConvertFormattedStringToFloat(const S: string;
out AFloatValue: Double; out AIsCurrency: Boolean;
...
begin
  ...
  begin
    Result := (P = 1) or
      (P = Length(st) - Length(AFormatSettings.CurrencyFormat) + 1);
    if Result then
    begin
      Delete(st, P, Length(AFormatSettings.CurrencyFormat));
      st := Trim(st);
      Result := (Pos(AFormatSettings.CurrencyFormat, st) = 0) and
        (Length(st) > 0);
    end;
  end;
  if not Result then
...
function dxTryCreateDateOnShort(ANumber1, ANumber2: Word; var AValue: TDateTime;
const ASettings: TFormatSettings): Boolean; inline;
var
  ADay, AMonth: Word;
begin
  Result := False;
  ...
  begin
    ...
    else if InRange(ANumber2, 30, 99) then
      AValue := EncodeDate(1900 + ANumber2, ANumber1, 1)
    else if ANumber2 > 1899 then
    ...
    try
      if Pos('D', UpperCase(ASettings.ShortDateFormat)) <
        Pos('M', UpperCase(ASettings.ShortDateFormat)) then
      begin
        ADay := ANumber1;
        AMonth := ANumber2;
      end
...
function dxIsShortDate(const AText: string; var AValue: TDateTime;
const ASettings: TFormatSettings): Boolean; inline;
var
...
function TdxSpreadSheetFormulaResult.ConvertToNumeric(var AValue: Variant;
ACanConvertStr, AWithoutBoolean: Boolean): Boolean;
var
  ANumeric: Double;
  ADate: TDateTime;
...
begin
  if VarIsStr(AValue) and not ACanConvertStr then
    SetError(ecValue)
  else if dxSpreadSheetIsNullValue(AValue) then
    AValue := 0
  ...
  begin
    if VarIsStr(AValue) and (TryStrToFloat(AValue, ANumeric) or
      dxTryConvertFormattedStringToFloat(AValue, ANumeric, AIsCurrency,
      FormatSettings)) then
      AValue := ANumeric
    else
    begin
      ...
      begin
        if dxTryStrToDateTime(AValue, ADate, FormatSettings.Data) or
          dxIsShortDate(AValue, ADate, FormatSettings.Data) then
        begin
          if FormatSettings.DateTimeSystem = dts1904 then
            ADate := dxRealDateTimeToDateTime(ADate,
              FormatSettings.DateTimeSystem)
          else if (ADate >= 1) and (ADate <= 60) then
            ADate := ADate - 1;
          AValue := Double(ADate);
        end
        else
...
procedure TdxSpreadSheetFormulaResult.ExtractCondition
  (AParams: TdxSpreadSheetFormulaToken; AMaxCount, AIndex: Integer;
...
begin
  ...
  if (AParamCount <= AIndex) or (AMaxCount > 0) and (AParamCount > AMaxCount)
  then
    SetError(ecValue);
  ...
  try
    ...
    if VarIsNull(AConditionValue) or VarIsEmpty(AConditionValue) then
      AConditionValue := 0;
    dxSpreadSheetExtractConditionParams(VarToStr(AConditionValue),
      Owner.FormatSettings, AConditionValue, AOperation);
  finally
    ARes.Free;
  end;
end;

function TdxSpreadSheetFormulaResult.ExtractColumnFromRange
  (const ARange: TdxSpreadSheetFormulaToken; AColumnIndex: Integer;
var AErrorCode: TdxSpreadSheetFormulaErrorCode): TdxSpreadSheetVector;
begin
  AErrorCode := ecNone;
...
function TdxSpreadSheetFormulaResult.ExtractRowFromRange
  (const ARange: TdxSpreadSheetFormulaToken; ARowIndex: Integer;
var AErrorCode: TdxSpreadSheetFormulaErrorCode): TdxSpreadSheetVector;
begin
  AErrorCode := ecNone;
...
function TdxSpreadSheetFormulaResult.GetFormatSettings
  : TdxSpreadSheetFormatSettings;
begin
  Result := Owner.FormatSettings;
end;

function TdxSpreadSheetFormulaResult.GetItem(AIndex: Integer)
  : TdxSpreadSheetFormulaToken;
begin
...
function TdxSpreadSheetFormulaResult.DoExtractDateTimeParameter
  (var AParameter: Variant; const AParams: TdxSpreadSheetFormulaToken;
AIndex: Integer; AWithoutBoolean: Boolean): Boolean;
var
  ADateTimeSystem: TdxSpreadSheetDateTimeSystem;
  ACanConvertStrToNumber: Boolean;
  ADate: TDateTime;
begin
  Result := ExtractParameter(AParameter, ACanConvertStrToNumber,
    AParams, AIndex);
  if not Result then
    Exit;
  ...
  else if not dxConvertToXLSDate(AParameter, ADate) or
    ((ADateTimeSystem = dts1904) and (ADate < 1462)) then
  begin
...
function TdxSpreadSheetFormulaResult.ExtractDateTimeOnlyParameter
  (var AParameter: Variant; const AParams: TdxSpreadSheetFormulaToken;
AIndex: Integer = 0): Boolean;
var
  ADate: TDateTime;
...
begin
  if ExtractParameter(AParameter, AParams, AIndex) then
    if VarIsStr(AParameter) and TryStrToFloat(VarToStr(AParameter), AFloat) then
      SetError(ecValue)
    else if not dxConvertToXLSDate(AParameter, ADate) then
      SetError(ecValue)
    else
      AParameter := ADate;
  Result := Validate;
...
function TdxSpreadSheetFormulaResult.ExtractDateTimeParameter
  (var AParameter: Variant; const AParams: TdxSpreadSheetFormulaToken;
AIndex: Integer = 0): Boolean;
begin
...
function TdxSpreadSheetFormulaResult.ExtractDateTimeParameterWithoutBoolean
  (var AParameter: Variant; const AParams: TdxSpreadSheetFormulaToken;
AIndex: Integer = 0): Boolean;
begin
...
function TdxSpreadSheetFormulaResult.ExtractErrorCode(const AParams
  : TdxSpreadSheetFormulaToken): TdxSpreadSheetFormulaErrorCode;
var
...
function TdxSpreadSheetFormulaResult.ExtractNumericValue
...
function TdxSpreadSheetFormulaResult.ExtractNumericParameter(var AParameter
  : Variant; const AParams: TdxSpreadSheetFormulaToken;
AIndex: Integer = 0): Boolean;
var
  ADate: TDateTime;
  AValue: Variant;
...
function TdxSpreadSheetFormulaResult.ExtractNumericParameterDef
  (var AParameter: Variant; const ADefaultIfNoExist, ADefaultIfNull: Variant;
const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer = 0): Boolean;
begin
  Result := True;
  if not ParameterExists(AParams, AIndex) then
    ...
    Result := ExtractNumericParameterDef(AParameter, ADefaultIfNull,
      AParams, AIndex);
end;

function TdxSpreadSheetFormulaResult.ExtractNumericParameterDef
  (var AParameter: Variant; const ADefaultIfNull: Variant;
const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer = 0): Boolean;
var
  ACanConvertStrToNumber: Boolean;
begin
  Result := ParameterIsNull(AParameter, ACanConvertStrToNumber,
    AParams, AIndex);
  if Result then
...
function TdxSpreadSheetFormulaResult.ExtractNumericParameterDefWithoutBoolean
  (var AParameter: Variant; const ADefault: Variant;
const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer = 0): Boolean;
var
  ACanConvertStrToNumber: Boolean;
begin
  Result := not ParameterExists(AParams, AIndex) or
    ParameterIsNull(AParameter, ACanConvertStrToNumber, AParams, AIndex);
  if Result then
    AParameter := ADefault
  else
...
function TdxSpreadSheetFormulaResult.ExtractNumericParameterWithoutBoolean
  (var AParameter: Variant; const AParams: TdxSpreadSheetFormulaToken;
AIndex: Integer = 0): Boolean;
var
  ACanConvertStrToNumber: Boolean;
begin
  Result := ExtractParameter(AParameter, ACanConvertStrToNumber, AParams,
    AIndex) and ConvertToNumeric(AParameter, ACanConvertStrToNumber, True);
end;

function TdxSpreadSheetFormulaResult.ExtractParameter(var AParameter: Variant;
const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer = 0): Boolean;
var
  ACanConvertStrToNumber: Boolean;
begin
...
function TdxSpreadSheetFormulaResult.ExtractParameter(var AParameter: Variant;
out ACanConvertStrToNumber: Boolean; const AParams: TdxSpreadSheetFormulaToken;
AIndex: Integer = 0): Boolean;
var
  AItemIndex: Integer;
...
function TdxSpreadSheetFormulaResult.ExtractParameterDef(var AParameter
  : Variant; ADefaultIfNull: Variant; const AParams: TdxSpreadSheetFormulaToken;
AIndex: Integer = 0): Boolean;
begin
...
function TdxSpreadSheetFormulaResult.ExtractParameterDef(var AParameter
  : Variant; ADefaultIfNoExist, ADefaultIfNull: Variant;
const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer = 0): Boolean;
begin
  AParameter := ADefaultIfNoExist;
...
procedure TdxSpreadSheetFormulaResult.ExtractToken
  (AToken: TdxSpreadSheetFormulaToken; out AOwnership: TStreamOwnership);
begin
...
function TdxSpreadSheetFormulaResult.ExtractValue(out ACanConvertStrToNumber
  : Boolean): Variant;
var
  AOwnership: TStreamOwnership;
  AValue: TdxSpreadSheetFormulaToken;
...
function TdxSpreadSheetFormulaResult.ExtractValueToken(out AOwnership
  : TStreamOwnership): TdxSpreadSheetFormulaToken;
begin
  Result := nil;
  if Validate then
  begin
...
procedure TdxSpreadSheetFormulaResult.ForEach
  (AParams: TdxSpreadSheetFormulaToken; AProc: TdxSpreadSheetForEachCallBack;
const AData: Pointer);
var
  I: Integer;
  AItemResult: TdxSpreadSheetFormulaResult;
    ...
    try
      ...
      begin
        ...
        begin
          ...
          AItemResult.AddTemporary(TdxSpreadSheetFormulaErrorValueToken.Create
            (AItemResult.ErrorCode));
        end;
        AErrorCode := AItemResult.ErrorCode;
...
function TdxSpreadSheetFormulaResult.GetParamsCount(const AParams
  : TdxSpreadSheetFormulaToken): Integer;
var
  AParam: TdxSpreadSheetFormulaToken;
begin
  if AParams = nil then
    Result := 0
  else if AParams.Parent <> nil then
...
function TdxSpreadSheetFormulaResult.ParameterExists(const AParams
  : TdxSpreadSheetFormulaToken; AIndex: Integer): Boolean;
begin
...
const AParams: TdxSpreadSheetFormulaToken; AIndex: Integer = 0): Boolean;
begin
  Result := ExtractParameter(AParameter, AParams, AIndex) and
    VarIsNull(AParameter);
end;
...
begin
  Result := ExtractParameter(AParameter, ACanConvertStrToNumber, AParams,
    AIndex) and VarIsNull(AParameter);
end;

procedure TdxSpreadSheetFormulaResult.SetError
...
function TdxSpreadSheetCustomFormulaList.GetItem(Index: Integer)
  : TdxSpreadSheetCustomFormula;
begin
