...
{$REGION 'FloatingObjectTextWrapTypeTable'}
    FloatingObjectTextWrapTypeTable: array [TdxFloatingObjectTextWrapType]
      of Integer = (3, 1, 4, 5, 2, 3);
{$ENDREGION}
{$REGION 'FloatingObjectTextWrapSideTable'}
    FloatingObjectTextWrapSideTable: array [TdxFloatingObjectTextWrapSide]
      of Integer = (0, 1, 2, 3);
{$ENDREGION}
{$REGION 'FloatingObjectHorizontalPositionTypeTable'}
    FloatingObjectHorizontalPositionTypeTable
      : array [TdxFloatingObjectHorizontalPositionType] of Integer = (1, 3, 2,
      0, 4, 5, 6, 7);
{$ENDREGION}
{$REGION 'FloatingObjectHorizontalPositionAlignmentTable'}
    FloatingObjectHorizontalPositionAlignmentTable
      : array [TdxFloatingObjectHorizontalPositionAlignment] of Integer = (0, 1,
      2, 3, 4, 5);
{$ENDREGION}
{$REGION 'FloatingObjectVerticalPositionTypeTable'}
    FloatingObjectVerticalPositionTypeTable
      : array [TdxFloatingObjectVerticalPositionType] of Integer = (1, 3, 2, 0,
      4, 5, 6, 7);
{$ENDREGION}
{$REGION 'FloatingObjectVerticalPositionAlignmentTable'}
    FloatingObjectVerticalPositionAlignmentTable
      : array [TdxFloatingObjectVerticalPositionAlignment] of Integer = (0, 1,
      2, 3, 4, 5);
{$ENDREGION}
{$REGION 'FloatingObjectRelativeFromHorizontalTable'}
    FloatingObjectRelativeFromHorizontalTable
      : array [TdxFloatingObjectRelativeFromHorizontal] of Integer = (0, 1,
      2, 3, 4, 5);
{$ENDREGION}
{$REGION 'FloatingObjectRelativeFromVerticalTable'}
    FloatingObjectRelativeFromVerticalTable
      : array [TdxFloatingObjectRelativeFromVertical] of Integer = (0, 1,
      2, 3, 4, 5);
{$ENDREGION}
  end;
