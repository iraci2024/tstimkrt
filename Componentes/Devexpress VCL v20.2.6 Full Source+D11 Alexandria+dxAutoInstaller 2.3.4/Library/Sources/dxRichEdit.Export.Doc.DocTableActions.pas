...
type
  ...
  protected
    function CalculateCellContentWidthsCore(ACell: TdxTableCell;
      APercentBaseWidth: Integer; ASmpleView: Boolean)
  ...
  public
    ...
    function CreateTableLayoutInfo(ATableGrid: TdxTableGrid;
      AMaxTableWidth: TdxModelUnit; AAllowTablesToExtendIntoMargins: Boolean;
      ASimpleView: Boolean; APercentBaseWidth: TdxModelUnit)
  ...
  public
    ...
    procedure CreateTableCellPropertyModifiers(ATableDepth: Integer;
      AFinalParagraphInCell: Boolean);
  ...
  protected
    ...
    property ToLayoutUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter
      read FModelUnitToTwipsUnitConverter;
    property Grid: TdxTableGrid read FGrid;
  public
    constructor Create(AOutput: TdxMemoryStream; ARow: TdxTableRow;
      AGrid: TdxTableGrid);
    destructor Destroy; override;
    procedure CreateTableRowPropertyModifiers(ATableDepth: Integer;
    ...
    procedure CreateCellBorderCommandCore(AInfo: TdxBorderInfo;
      ACellBorderType: TdxDocTableCellBorders; AIndex: Integer);
    procedure CellMarginsAction;
    procedure CreateCellMarginsCommands(ACell: TdxTableCell);
    procedure CreateCellMarginCommandCore(AInfo: TdxWidthUnitInfo;
      ACellBorderType: TdxDocTableCellBorders; AIndex: Integer);
    procedure CellsBackgroundColorAction;
    procedure DefineTableShadingsActionCore(AStartGroupIndex: Integer;
      AEndGroupIndex: Integer; ACommandType: TClass);
    ...
    function GetCellWidth(AFirstColumnIndex: Integer; ACell: TdxTableCell)
      : SmallInt;
  ...
  public
    ...
    constructor Create(AOutput: TdxMemoryStream;
      ATableStyle: TdxTableStyle); overload;
...
constructor TdxDocTableWidthsCalculator.Create
...
function TdxDocTableWidthsCalculator.CalculateCellContentWidthsCore
  (ACell: TdxTableCell; APercentBaseWidth: Integer; ASmpleView: Boolean)
...
function TdxDocTableWidthsCalculator.CanUseCachedTableLayoutInfo
  (ATableLayoutInfo: TdxTableLayoutInfo): Boolean;
begin
  Result := False;
end;

function TdxDocTableWidthsCalculator.CreateTableLayoutInfo
  (ATableGrid: TdxTableGrid; AMaxTableWidth: TdxModelUnit;
  AAllowTablesToExtendIntoMargins: Boolean; ASimpleView: Boolean;
  APercentBaseWidth: TdxModelUnit): TdxTableLayoutInfo;
begin
  Result := nil;
end;
...
constructor TdxDocTableCellActions.Create(AOutput: TdxMemoryStream;
  ACell: TdxTableCell);
begin
...
procedure TdxDocTableCellActions.CreateTableCellPropertyModifiers
  (ATableDepth: Integer; AFinalParagraphInCell: Boolean);
begin
  InTableAction;
...
procedure TdxDocTableCellActions.TableDepthAction(ATableDepth: Integer;
  AFinalParagraphInCell: Boolean);
var
...
begin
  ...
  if AInfo.IsHorizontalAbsolutePositionUse and AInfo.IsVerticalAbsolutePositionUse
  then
    Exit;
...
constructor TdxDocTableRowActions.Create(AOutput: TdxMemoryStream;
  ARow: TdxTableRow; AGrid: TdxTableGrid);
begin
  FWriter := TBinaryWriter.Create(AOutput);
  FRow := ARow;
  FDocumentModel := TdxDocumentModel(ARow.DocumentModel);
  FUnitConverter := ARow.DocumentModel.UnitConverter;
  FModelUnitToTwipsUnitConverter := FUnitConverter.CreateConverterToLayoutUnits
...
procedure TdxDocTableRowActions.CreateTableRowPropertyModifiers
  (ATableDepth: Integer; ATableStyleIndex: Integer);
begin
...
procedure TdxDocTableRowActions.CreateInsertCommand(ACellIndex: Integer;
  ATotalWidth: SmallInt);
var
...
procedure TdxDocTableRowActions.CreatePreferredCellWidthCommand(I: Integer;
  ACell: TdxTableCell);
var
...
begin
  ...
  try
    ...
    ACommand.TableCellWidth.WidthUnit.ConvertFromWidthUnitInfo
      (ACell.PreferredWidth.Info, UnitConverter);
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
  end;
...
begin
  ...
  if ABorders.UseBottomBorder then
    CreateCellBorderCommandCore(ABorders.BottomBorder.Info,
      [TdxDocTableCellBorder.Bottom], ACell.IndexInRow);
  if ABorders.UseLeftBorder then
    CreateCellBorderCommandCore(ABorders.LeftBorder.Info,
      [TdxDocTableCellBorder.Left], ACell.IndexInRow);
  if ABorders.UseRightBorder then
    CreateCellBorderCommandCore(ABorders.RightBorder.Info,
      [TdxDocTableCellBorder.Right], ACell.IndexInRow);
  if ABorders.UseTopBorder then
    CreateCellBorderCommandCore(ABorders.TopBorder.Info,
      [TdxDocTableCellBorder.Top], ACell.IndexInRow);
end;

procedure TdxDocTableRowActions.CreateCellBorderCommandCore
  (AInfo: TdxBorderInfo; ACellBorderType: TdxDocTableCellBorders;
  AIndex: Integer);
var
...
begin
  ...
  try
    ...
    ACommand.OverriddenBorders.Border.ConvertFromBorderInfo(AInfo,
      UnitConverter);
...
begin
  if ACell.Properties.UseBottomMargin then
    CreateCellMarginCommandCore(ACell.Properties.CellMargins.Bottom.Info,
      [TdxDocTableCellBorder.Bottom], ACell.IndexInRow);
  if ACell.Properties.UseLeftMargin then
    CreateCellMarginCommandCore(ACell.Properties.CellMargins.Left.Info,
      [TdxDocTableCellBorder.Left], ACell.IndexInRow);
  if ACell.Properties.UseRightMargin then
    CreateCellMarginCommandCore(ACell.Properties.CellMargins.Right.Info,
      [TdxDocTableCellBorder.Right], ACell.IndexInRow);
  if ACell.Properties.UseTopMargin then
    CreateCellMarginCommandCore(ACell.Properties.CellMargins.Top.Info,
      [TdxDocTableCellBorder.Top], ACell.IndexInRow);
end;

procedure TdxDocTableRowActions.CreateCellMarginCommandCore
  (AInfo: TdxWidthUnitInfo; ACellBorderType: TdxDocTableCellBorders;
  AIndex: Integer);
var
...
begin
  ...
  try
    ...
    ACommand.CellSpacing.WidthUnit.ConvertFromWidthUnitInfo(AInfo,
      UnitConverter);
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
...
begin
  DefineTableShadingsActionCore(0, FirstCellsGroupCount,
    TdxDocCommandDefineTableShadings);
  DefineTableShadingsActionCore(FirstCellsGroupCount, SecondCellsGroupCount,
    TdxDocCommandDefineTableShadings2nd);
  DefineTableShadingsActionCore(SecondCellsGroupCount, ThirdCellsGroupCount,
    TdxDocCommandDefineTableShadings3rd);
end;

procedure TdxDocTableRowActions.DefineTableShadingsActionCore(AStartGroupIndex
  : Integer; AEndGroupIndex: Integer; ACommandType: TClass);
var
...
procedure TdxDocTableRowActions.CreateCellVertacalAlignmentCommand
  (ACell: TdxTableCell);
var
...
begin
  ...
  try
    ...
    ACommand.CellRangeVerticalAlignment.VerticalAlignment :=
      ACell.VerticalAlignment;
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
  end;
...
begin
  if not Row.Properties.UseWidthBefore and
    not Row.Table.TableProperties.UseTableIndent and
    not Row.Table.TableProperties.UseCellSpacing then
    Exit;
...
begin
  if not Row.Table.TableProperties.UseLeftMargin and
    not Row.Table.TableProperties.UseRightMargin then
    Exit;
...
function TdxDocTableRowActions.GetCellWidth(AFirstColumnIndex: Integer;
  ACell: TdxTableCell): SmallInt;
var
...
begin
  ...
  Result := SmallInt(Min(ConvertLayoutUnitsToTwips(ATotalWidth),
...
begin
  if Row.Table.TableProperties.TableIndent.&Type = TdxWidthUnitType.ModelUnits
  then
    Result := UnitConverter.ModelUnitsToTwips
      (Row.Table.TableProperties.TableIndent.Value)
  else
    Result := 0;
end;
...
begin
  if Row.Table.TableProperties.CellSpacing.&Type = TdxWidthUnitType.ModelUnits
  then
    Result := UnitConverter.ModelUnitsToTwips
      (Row.Table.TableProperties.CellSpacing.Value)
  else
    Result := 0;
end;
...
begin
  ...
  if AProperties.UseLeftMargin and
    (ATable.LeftMargin.&Type = TdxWidthUnitType.ModelUnits) then
    Inc(AResult, UnitConverter.ModelUnitsToTwips(ATable.LeftMargin.Value));
  if AProperties.UseRightMargin and
    (ATable.RightMargin.&Type = TdxWidthUnitType.ModelUnits) then
    Inc(AResult, UnitConverter.ModelUnitsToTwips(ATable.RightMargin.Value));
  Result := AResult div 2;
end;

function TdxDocTableRowActions.ConvertLayoutUnitsToTwips
...
begin
  ...
  if (ATablePropertiesException = nil) or
    (ATablePropertiesException.Info.Value = TdxTablePropertiesOptions.
    MaskUseNone) then
  begin
...
begin
  ...
  try
    ACommand.WidthUnit.ConvertFromWidthUnitInfo
      (TableProperties.Info.PreferredWidth, UnitConverter);
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
  end;
...
begin
  ...
  try
    ACommand.TableBorders.BottomBorder.ConvertFromBorderInfo
      (ABorders.BottomBorder, FUnitConverter);
    ACommand.TableBorders.InsideHorizontalBorder.ConvertFromBorderInfo
      (ABorders.InsideHorizontalBorder, FUnitConverter);
    ACommand.TableBorders.InsideVerticalBorder.ConvertFromBorderInfo
      (ABorders.InsideVerticalBorder, FUnitConverter);
    ACommand.TableBorders.LeftBorder.ConvertFromBorderInfo(ABorders.LeftBorder,
      FUnitConverter);
    ACommand.TableBorders.RightBorder.ConvertFromBorderInfo
      (ABorders.RightBorder, FUnitConverter);
    ACommand.TableBorders.TopBorder.ConvertFromBorderInfo(ABorders.TopBorder,
      FUnitConverter);
...
begin
  ...
  try
    ...
    ACommand.CellSpacing.WidthUnit.ConvertFromWidthUnitInfo
      (TableProperties.Info.CellMargins.Bottom, UnitConverter);
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
  end;
...
begin
  ...
  try
    ...
    ACommand.CellSpacing.WidthUnit.ConvertFromWidthUnitInfo
      (TableProperties.Info.CellMargins.Left, UnitConverter);
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
  end;
...
begin
  ...
  try
    ...
    ACommand.CellSpacing.WidthUnit.ConvertFromWidthUnitInfo
      (TableProperties.Info.CellMargins.Right, UnitConverter);
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
  end;
...
begin
  ...
  try
    ...
    ACommand.CellSpacing.WidthUnit.ConvertFromWidthUnitInfo
      (TableProperties.Info.CellMargins.Top, UnitConverter);
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
  end;
...
begin
  ...
  try
    ACommand.WidthUnit.ConvertFromWidthUnitInfo
      (TableProperties.Info.TableIndent, UnitConverter);
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
  end;
...
begin
  ...
  try
    ACommand.TableAlignment := TableProperties.Info.GeneralSettings.
      TableAlignment;
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
...
begin
  ...
  try
    ACommand.CellSpacing.CellBorders := [TdxDocTableCellBorder.Top,
      TdxDocTableCellBorder.Left, TdxDocTableCellBorder.Bottom,
      TdxDocTableCellBorder.Right];
    ACommand.CellSpacing.WidthUnit.ConvertFromWidthUnitInfo(CellSpacing.Info,
      UnitConverter);
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
...
begin
  ...
  try
    ACommand.ShadingDescriptor.BackgroundColor :=
      TableProperties.Info.GeneralSettings.BackgroundColor;
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
  end;
...
begin
  ...
  try
    ACommand.Value := UnitConverter.ModelUnitsToTwips
...
begin
  ...
  try
    ACommand.Value := UnitConverter.ModelUnitsToTwips
      (FloatingPosition.RightFromText);
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
  end;
...
begin
  case FloatingPosition.HorizontalAlign of
    ...
    Result := UnitConverter.ModelUnitsToTwips
      (FloatingPosition.TableHorizontalPosition);
  end;
end;
...
begin
  case FloatingPosition.VerticalAlign of
    ...
    Result := UnitConverter.ModelUnitsToTwips
      (FloatingPosition.TableVerticalPosition);
  end;
end;
...
begin
  ...
  try
    ACommand.Value :=
      Byte(TableProperties.Info.GeneralSettings.TableStyleRowBandSize);
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
  end;
...
begin
  ...
  try
    ACommand.Value :=
      Byte(TableProperties.Info.GeneralSettings.TableStyleColBandSize);
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
  end;
...
var
  ACommand: TdxDocCommandTablePosition;
begin
  ACommand := TdxDocCommandTablePosition.Create
    (TableProperties.Info.FloatingPosition);
  try
    ACommand.Write(FWriter);
  finally
    ACommand.Free;
