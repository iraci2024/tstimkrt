...
resourcestring
  dxSBAR_DBNAVERROR1 =
    'You already have an existing DBNavigator button with the same defined style';
...
procedure AddBarsDBNavigatorResourceStringNames
...
begin
  ...
  InternalAdd('dxSBAR_DBNAVIGATORCATEGORYNAME',
    @dxSBAR_DBNAVIGATORCATEGORYNAME);
...
dxResourceStringsRepository.RegisterProduct('ExpressBars DB Navigator',
  @AddBarsDBNavigatorResourceStringNames);
