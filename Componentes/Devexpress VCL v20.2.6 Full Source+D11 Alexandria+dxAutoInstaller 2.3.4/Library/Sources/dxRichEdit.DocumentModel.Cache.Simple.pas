...
type
  ...
  protected
    function CreateParagraphFormattingInfoCache(AUnitConverter
      ...
      : TdxParagraphFormattingInfoCache; virtual;
    function CreateParagraphFormattingCache(ADocumentModel
      : TdxCustomDocumentModel): TdxParagraphFormattingCache; virtual;
  public
    ...
    property CharacterFormattingCache: TdxCharacterFormattingCache
      read FCharacterFormattingCache;
    property CharacterFormattingInfoCache: TdxCharacterFormattingInfoCache
      read FCharacterFormattingInfoCache;
    property DocumentInfoCache: TdxDocumentInfoCache read FDocumentInfoCache;
    property HeightUnitInfoCache: TdxHeightUnitInfoCache
      read FHeightUnitInfoCache;
    property InlineCustomObjectInfoCache: TdxInlineCustomObjectInfoCache
      read FInlineCustomObjectInfoCache;
    property InlinePictureInfoCache: TdxInlinePictureInfoCache
      read FInlinePictureInfoCache;
    property MergedCharacterFormattingInfoCache: TdxCharacterFormattingInfoCache
      read FMergedCharacterFormattingInfoCache;
    property MergedParagraphFormattingInfoCache: TdxParagraphFormattingInfoCache
      read FMergedParagraphFormattingInfoCache;
    property ParagraphFormattingCache: TdxParagraphFormattingCache
      read FParagraphFormattingCache;
    property ParagraphFormattingInfoCache: TdxParagraphFormattingInfoCache
      read FParagraphFormattingInfoCache;
    property ParagraphFrameFormattingCache: TdxParagraphFrameFormattingCache
      read FParagraphFrameFormattingCache;
    property TabFormattingInfoCache: TdxTabFormattingInfoCache
      read FTabFormattingInfoCache;
...
procedure TdxSimpleDocumentCache.Initialize(ADocumentModel
...
begin
  ...
  FMergedCharacterFormattingInfoCache := TdxCharacterFormattingInfoCache.Create
    (AUnitConverter);
  FCharacterFormattingInfoCache := TdxCharacterFormattingInfoCache.Create
    (AUnitConverter);
  FCharacterFormattingCache := TdxCharacterFormattingCache.Create
    (ADocumentModel);
  FParagraphFormattingInfoCache := CreateParagraphFormattingInfoCache
    (AUnitConverter);
  FParagraphFrameFormattingCache := TdxParagraphFrameFormattingCache.Create
    (ADocumentModel);
  FMergedParagraphFormattingInfoCache := CreateParagraphFormattingInfoCache
    (AUnitConverter);
  ...
  FInlineCustomObjectInfoCache := TdxInlineCustomObjectInfoCache.Create
    (AUnitConverter);
