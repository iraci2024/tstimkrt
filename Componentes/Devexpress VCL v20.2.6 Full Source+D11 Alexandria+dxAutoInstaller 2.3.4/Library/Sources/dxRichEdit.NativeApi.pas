...
type
  ...
  TdxRichEditDocumentFormat = (Undefined, PlainText, Rtf, Html, OpenXml, Doc);
  ...
  TdxRichEditDocumentUnit = (Document, Inch, Millimeter, Centimeter, Point);
  ...
  IdxInnerRichEditDocumentContainerOwner = interface
    ...
    function CreateDocumentContainer(ADocumentModel: TObject)
      : IdxRichEditDocumentContainer;
  end;
  ...
  TdxRichEditSearchOption = (CaseSensitive, WholeWord);
  TdxRichEditSearchOptions = set of TdxRichEditSearchOption;

  TdxRichEditSearchDirection = (Forward, Backward);
  ...
  IdxRichEditRegexSearchGroupCollection = interface
    (IdxReadOnlyList<IdxRichEditRegexSearchGroup>)
  end;
  ...
  TdxRichEditUsedCharacterFormattingOption = (UseFontName, UseDoubleFontSize,
    UseFontBold, UseFontItalic, UseFontStrikeoutType, UseFontUnderlineType,
    UseAllCaps, UseForeColor, UseBackColor, UseUnderlineColor,
    UseStrikeoutColor, UseUnderlineWordsOnly, UseStrikeoutWordsOnly, UseScript,
    UseHidden, UseNoProof);

  TdxRichEditCharacterPropertiesMask = set of
    TdxRichEditUsedCharacterFormattingOption;

  TdxRichEditStrikeoutType = (None = 0, Single = 1, Double = 2);

  TdxRichEditUnderlineType = (None = 0, Single = 1, Dotted = 2, Dashed = 3,
    DashDotted = 4, DashDotDotted = 5, Double = 6, HeavyWave = 7,
    LongDashed = 8, ThickSingle = 9, ThickDotted = 10, ThickDashed = 11,
    ThickDashDotted = 12, ThickDashDotDotted = 13, ThickLongDashed = 14,
    DoubleWave = 15, Wave = 16, DashSmallGap = 17);
  ...
  IdxRichEditCharacterPropertiesBase = interface
    ...
    property BackColor: TdxNullableValue<TdxAlphaColor> read GetBackColor
      write SetBackColor;
    ...
    property ForeColor: TdxNullableValue<TdxAlphaColor> read GetForeColor
      write SetForeColor;
    ...
    property Strikeout: TdxNullableValue<TdxRichEditStrikeoutType>
      read GetStrikeout write SetStrikeout;
    property StrikeoutColor: TdxNullableValue<TdxAlphaColor>
      read GetStrikeoutColor write SetStrikeoutColor;
    property Subscript: TdxNullableBoolean read GetSubscript write SetSubscript;
    property Superscript: TdxNullableBoolean read GetSuperscript
      write SetSuperscript;
    property Underline: TdxNullableValue<TdxRichEditUnderlineType>
      read GetUnderline write SetUnderline;
    property UnderlineColor: TdxNullableValue<TdxAlphaColor>
      read GetUnderlineColor write SetUnderlineColor;
  end;
  ...
  IdxRichEditCharacterStyle = interface(IdxRichEditCharacterPropertiesBase)
    ...
    property LinkedStyle: IdxRichEditParagraphStyle read GetLinkedStyle
      write SetLinkedStyle;
  ...
  TdxRichEditTabAlignmentType = (Left, Center, Right, Decimal);

  TdxRichEditTabLeaderType = (None, Dots, MiddleDots, Hyphens, Underline,
    ThickLine, EqualSign);
  ...
  IdxRichEditTabInfo = interface
    ...
    property Alignment: TdxRichEditTabAlignmentType read GetAlignment
      write SetAlignment;
  ...
  TdxRichEditUsedParagraphFormattingOption = (UseAlignment, UseLeftIndent,
    UseRightIndent, UseSpacingBefore, UseSpacingAfter, UseLineSpacing,
    UseFirstLineIndent, UseSuppressHyphenation, UseSuppressLineNumbers,
    UseContextualSpacing, UsePageBreakBefore, UseBeforeAutoSpacing,
    UseAfterAutoSpacing, UseKeepWithNext, UseKeepLinesTogether,
    UseWidowOrphanControl, UseOutlineLevel, UseBackColor, UseLeftBorder,
    UseRightBorder, UseTopBorder, UseBottomBorder);

  TdxRichEditParagraphPropertiesMask = set of
    TdxRichEditUsedParagraphFormattingOption;

  TdxRichEditParagraphAlignment = (Left, Right, Center, Justify);

  TdxRichEditParagraphLineSpacing = (Single, Sesquialteral, Double, Multiple,
    Exactly, AtLeast);

  TdxRichEditParagraphFirstLineIndent = (None, Indented, Hanging);
  ...
  IdxRichEditParagraphPropertiesBase = interface
    ...
    property Alignment: TdxNullableValue<TdxRichEditParagraphAlignment>
      read GetAlignment write SetAlignment;
    property BackColor: TdxNullableValue<TdxAlphaColor> read GetBackColor
      write SetBackColor;
    property ContextualSpacing: TdxNullableBoolean read GetContextualSpacing
      write SetContextualSpacing;
    property FirstLineIndent: TdxNullableSingle read GetFirstLineIndent
      write SetFirstLineIndent;
    property FirstLineIndentType
      : TdxNullableValue<TdxRichEditParagraphFirstLineIndent>
      read GetFirstLineIndentType write SetFirstLineIndentType;
    property KeepLinesTogether: TdxNullableBoolean read GetKeepLinesTogether
      write SetKeepLinesTogether;
    property LeftIndent: TdxNullableSingle read GetLeftIndent
      write SetLeftIndent;
    property LineSpacing: TdxNullableSingle read GetLineSpacing
      write SetLineSpacing;
    property LineSpacingMultiplier: TdxNullableSingle
      read GetLineSpacingMultiplier write SetLineSpacingMultiplier;
    property LineSpacingRule: TdxNullableValue<TdxRichEditParagraphLineSpacing>
      read GetLineSpacingRule write SetLineSpacingRule;
    property OutlineLevel: TdxNullableInteger read GetOutlineLevel
      write SetOutlineLevel;
    property PageBreakBefore: TdxNullableBoolean read GetPageBreakBefore
      write SetPageBreakBefore;
    property RightIndent: TdxNullableSingle read GetRightIndent
      write SetRightIndent;
    property SpacingAfter: TdxNullableSingle read GetSpacingAfter
      write SetSpacingAfter;
    property SpacingBefore: TdxNullableSingle read GetSpacingBefore
      write SetSpacingBefore;
    property SuppressHyphenation: TdxNullableBoolean read GetSuppressHyphenation
      write SetSuppressHyphenation;
    property SuppressLineNumbers: TdxNullableBoolean read GetSuppressLineNumbers
  ...
  IdxRichEditParagraphStyle = interface(IdxRichEditParagraphPropertiesWithTabs)
    ...
    property IsDeleted: Boolean read GetIsDeleted;
    property LinkedStyle: IdxRichEditCharacterStyle read GetLinkedStyle
      write SetLinkedStyle;
    property ListLevelIndex: Integer read GetListLevelIndex
      write SetListLevelIndex;
    property Name: string read GetName write SetName;
    property NextStyle: IdxRichEditParagraphStyle read GetNextStyle
      write SetNextStyle;
  ...
  TdxRichEditTableBorderLineStyle = (&Nil = TdxBorderLineStyleValues.&Nil,
  ...
  TdxRichEditTableCellVerticalAlignment = (Top, Center, Bottom);

  TdxRichEditTableRowAlignment = (Both, Center, Distribute, Left,
    NumTab, Right);

  TdxRichEditTableLayoutType = (Fixed, Autofit);

  TdxRichEditConditionalTableStyleFormattingType = (BottomLeftCell,
    BottomRightCell, TopLeftCell, TopRightCell, EvenRowBanding, OddRowBanding,
    EvenColumnBanding, OddColumnBanding, LastColumn, FirstColumn, LastRow,
    FirstRow, WholeTable);
  TdxRichEditConditionalTableStyleFormattingTypes = set of
  ...
  TdxRichEditUsedTableCellFormattingOption = (UsePreferredWidth, UseNoWrap,
    UseLeftPadding, UseRightPadding, UseTopPadding, UseBottomPadding,
    UseVerticalAlignment, UseLeftBorder, UseRightBorder, UseTopBorder,
    UseBottomBorder, UseInsideHorizontalBorder, UseInsideVerticalBorder,
    UseTopLeftDiagonalBorder, UseTopRightDiagonalBorder, UseBackgroundColor);
  TdxRichEditTableCellPropertiesMask = set of
  ...
  TdxRichEditUsedTableFormattingOption = (UseLeftPadding, UseRightPadding,
    UseTopPadding, UseBottomPadding, UseCellSpacing, UseTableIndent,
    UseTableLayout, UseTableLook, UsePreferredWidth, UseTableStyleColBandSize,
    UseTableStyleRowBandSize, UseLeftBorder, UseRightBorder, UseTopBorder,
    UseBottomBorder, UseInsideHorizontalBorder, UseInsideVerticalBorder,
    UseBackgroundColor, UseTableAlignment, UseBorders);
  ...
  IdxRichEditTableConditionalStyleProperties = interface
    ...
    function CreateConditionalStyle(const ACondition
      : TdxRichEditConditionalTableStyleFormattingType)
      : IdxRichEditTableConditionalStyle;
    property Items[const ACondition
      : TdxRichEditConditionalTableStyleFormattingType]
      : IdxRichEditTableConditionalStyle read GetItem;
  ...
  IdxRichEditCharacterStyleCollection = interface
    (IdxRichEditStyleCollection<IdxRichEditCharacterStyle>)
  end;

  IdxRichEditParagraphStyleCollection = interface
    (IdxRichEditStyleCollection<IdxRichEditParagraphStyle>)
  end;

  IdxRichEditTableStyleCollection = interface
    (IdxRichEditStyleCollection<IdxRichEditTableStyle>)
  end;

  TdxRichEditMergeMode = (NewParagraph, NewSection, JoinTables);

  TdxRichEditMergeRecords = (All, Selected);
  ...
  IdxRichEditMailMergeOptions = interface
    ...
    property CopyTemplateStyles: Boolean read GetCopyTemplateStyles
      write SetCopyTemplateStyles;
    property DataSource: TDataSource read GetDataSource write SetDataSource;
    property HeaderFooterLinkToPrevious: Boolean
      read GetHeaderFooterLinkToPrevious write SetHeaderFooterLinkToPrevious;
    property MergeMode: TdxRichEditMergeMode read GetMergeMode
      write SetMergeMode;
    property MergeRecords: TdxRichEditMergeRecords read GetMergeRecords
      write SetMergeRecords;
  end;
  ...
  IdxRichEditReadOnlyFieldCollection = interface
    (IdxReadOnlyList<IdxRichEditField>)
  ...
  IdxRichEditFieldCollection = interface(IdxRichEditReadOnlyFieldCollection)
    function CreateField(const ARange: IdxRichEditDocumentRange)
  ...
  IdxRichEditDocumentVariableCollection = interface
    ...
    property Count: Integer read GetCount;
    property Items[const AName: string]: TValue read GetItem
  ...
  IdxRichEditParagraph = interface
    ...
    property Alignment: TdxRichEditParagraphAlignment read GetAlignment
      write SetAlignment;
    ...
    property ContextualSpacing: Boolean read GetContextualSpacing
      write SetContextualSpacing;
    property FirstLineIndent: Single read GetFirstLineIndent
      write SetFirstLineIndent;
    property FirstLineIndentType: TdxRichEditParagraphFirstLineIndent
      read GetFirstLineIndentType write SetFirstLineIndentType;
    ...
    property LineSpacingMultiplier: Single read GetLineSpacingMultiplier
      write SetLineSpacingMultiplier;
    property LineSpacingRule: TdxRichEditParagraphLineSpacing
      read GetLineSpacingRule write SetLineSpacingRule;
  ...
  IdxRichEditReadOnlyParagraphCollection = interface
    (IdxReadOnlyList<IdxRichEditParagraph>)
    function Get(const APos: IdxRichEditDocumentPosition)
      : IdxRichEditParagraph; overload;
    function Get(const ARange: IdxRichEditDocumentRange)
      : IdxRichEditReadOnlyParagraphCollection; overload;
  end;

  { IdxRichEditParagraphCollection }

  IdxRichEditParagraphCollection = interface
    (IdxRichEditReadOnlyParagraphCollection)
    ...
    function Insert(const APos: IdxRichEditDocumentPosition)
      : IdxRichEditParagraph; overload;
    function Insert(const APos: IdxRichEditDocumentPosition;
  ...
  TdxRichEditPaperKind = (Custom = 0, Letter = 1, LetterSmall = 2, Tabloid = 3,
    Ledger = 4, Legal = 5, Statement = 6, Executive = 7, A3 = 8, A4 = 9,
    A4Small = 10, A5 = 11, B4 = 12, B5 = 13, Folio = 14, Quarto = 15,
    Standard10x14 = 16, Standard11x17 = 17, Note = 18, Number9Envelope = 19,
    Number10Envelope = 20, Number11Envelope = 21, Number12Envelope = 22,
    Number14Envelope = 23, CSheet = 24, DSheet = 25, ESheet = 26,
    DLEnvelope = 27, C5Envelope = 28, C3Envelope = 29, C4Envelope = 30,
    C6Envelope = 31, C65Envelope = 32, B4Envelope = 33, B5Envelope = 34,
    B6Envelope = 35, ItalyEnvelope = 36, MonarchEnvelope = 37,
    PersonalEnvelope = 38, USStandardFanfold = 39, GermanStandardFanfold = 40,
    GermanLegalFanfold = 41, IsoB4 = 42, JapanesePostcard = 43,
    Standard9x11 = 44, Standard10x11 = 45, Standard15x11 = 46,
    InviteEnvelope = 47,
    // Reserved -- do not use
    Reserved_48 = 48,
    // Reserved -- do not use
    Reserved_49 = 49, LetterExtra = 50, LegalExtra = 51, TabloidExtra = 52,
    A4Extra = 53, LetterTransverse = 54, A4Transverse = 55,
    LetterExtraTransverse = 56, APlus = 57, BPlus = 58, LetterPlus = 59,
    A4Plus = 60, A5Transverse = 61, B5Transverse = 62, A3Extra = 63,
    A5Extra = 64, B5Extra = 65, A2 = 66, A3Transverse = 67,
    A3ExtraTransverse = 68, JapaneseDoublePostcard = 69, A6 = 70,
    JapaneseEnvelopeKakuNumber2 = 71, JapaneseEnvelopeKakuNumber3 = 72,
    JapaneseEnvelopeChouNumber3 = 73, JapaneseEnvelopeChouNumber4 = 74,
    LetterRotated = 75, A3Rotated = 76, A4Rotated = 77, A5Rotated = 78,
    B4JisRotated = 79, B5JisRotated = 80, JapanesePostcardRotated = 81,
    JapaneseDoublePostcardRotated = 82, A6Rotated = 83,
    JapaneseEnvelopeKakuNumber2Rotated = 84,
    JapaneseEnvelopeKakuNumber3Rotated = 85,
    JapaneseEnvelopeChouNumber3Rotated = 86,
    JapaneseEnvelopeChouNumber4Rotated = 87, B6Jis = 88, B6JisRotated = 89,
    Standard12x11 = 90, JapaneseEnvelopeYouNumber4 = 91,
    JapaneseEnvelopeYouNumber4Rotated = 92, Prc16K = 93, Prc32K = 94,
    Prc32KBig = 95, PrcEnvelopeNumber1 = 96, PrcEnvelopeNumber2 = 97,
    PrcEnvelopeNumber3 = 98, PrcEnvelopeNumber4 = 99, PrcEnvelopeNumber5 = 100,
    PrcEnvelopeNumber6 = 101, PrcEnvelopeNumber7 = 102,
    PrcEnvelopeNumber8 = 103, PrcEnvelopeNumber9 = 104,
    PrcEnvelopeNumber10 = 105, Prc16KRotated = 106, Prc32KRotated = 107,
    Prc32KBigRotated = 108, PrcEnvelopeNumber1Rotated = 109,
    PrcEnvelopeNumber2Rotated = 110, PrcEnvelopeNumber3Rotated = 111,
    PrcEnvelopeNumber4Rotated = 112, PrcEnvelopeNumber5Rotated = 113,
    PrcEnvelopeNumber6Rotated = 114, PrcEnvelopeNumber7Rotated = 115,
    PrcEnvelopeNumber8Rotated = 116, PrcEnvelopeNumber9Rotated = 117,
  ...
  IdxRichEditSectionPage = interface
    ...
    property PaperKind: TdxRichEditPaperKind read GetPaperKind
      write SetPaperKind;
  ...
  IdxRichEditSectionColumnCollection = interface
    (IdxRichEditList<IdxRichEditSectionColumn>)
  end;
  ...
  IdxRichEditSectionColumns = interface
    ...
    function CreateUniformColumns(AColumnWidth, AColumnSpacing: Single;
      AColumnCount: Integer): IdxRichEditSectionColumnCollection; overload;
    function CreateUniformColumns(const APage: IdxRichEditSectionPage;
      AColumnSpacing: Single; AColumnCount: Integer)
      : IdxRichEditSectionColumnCollection; overload;
  ...
  TdxRichEditLineNumberingRestart = (NewPage, NewSection, Continuous);
  ...
  IdxRichEditSectionLineNumbering = interface
    ...
    property RestartType: TdxRichEditLineNumberingRestart read GetRestartType
      write SetRestartType;
    property Start: Integer read GetStart write SetStart;
  end;

  { IdxRichEditSectionPageNumbering }

  TdxRichEditNumberingFormat = (Decimal, AIUEOHiragana, AIUEOFullWidthHiragana,
    ArabicAbjad, ArabicAlpha, Bullet, CardinalText, Chicago, ChineseCounting,
    ChineseCountingThousand, ChineseLegalSimplified, Chosung,
    DecimalEnclosedCircle, DecimalEnclosedCircleChinese,
    DecimalEnclosedFullstop, DecimalEnclosedParentheses, DecimalFullWidth,
    DecimalFullWidth2, DecimalHalfWidth, DecimalZero, Ganada, Hebrew1, Hebrew2,
    Hex, HindiConsonants, HindiDescriptive, HindiNumbers, HindiVowels,
    IdeographDigital, IdeographEnclosedCircle, IdeographLegalTraditional,
    IdeographTraditional, IdeographZodiac, IdeographZodiacTraditional, Iroha,
    IrohaFullWidth, JapaneseCounting, JapaneseDigitalTenThousand, JapaneseLegal,
    KoreanCounting, KoreanDigital, KoreanDigital2, KoreanLegal, LowerLetter,
    LowerRoman, None, NumberInDash, Ordinal, OrdinalText, RussianLower,
    RussianUpper, TaiwaneseCounting, TaiwaneseCountingThousand,
    TaiwaneseDigital, ThaiDescriptive, ThaiLetters, ThaiNumbers, UpperLetter,
    UpperRoman, VietnameseDescriptive);
  ...
  IdxRichEditSectionPageNumbering = interface
    ...
    property ContinueNumbering: Boolean read GetContinueNumbering
      write SetContinueNumbering;
    property FirstPageNumber: Integer read GetFirstPageNumber
      write SetFirstPageNumber;
    property NumberingFormat: TdxRichEditNumberingFormat read GetNumberingFormat
  ...
  TdxRichEditSectionStartType = (NextPage, OddPage, EvenPage,
    Continuous, Column);

  TdxRichEditHeaderFooterType = (First, Odd, Even);
  ...
  IdxRichEditSection = interface
    ...
    function BeginUpdateHeader(AType: TdxRichEditHeaderFooterType)
      : IdxRichEditSubDocument; overload;
    ...
    function BeginUpdateFooter(AType: TdxRichEditHeaderFooterType)
      : IdxRichEditSubDocument; overload;
    ...
    function IsHeaderLinkedToPrevious(AType: TdxRichEditHeaderFooterType)
      : Boolean; overload;
    procedure LinkHeaderToPrevious(AType: TdxRichEditHeaderFooterType);
      overload;
    procedure UnlinkHeaderFromPrevious
      (AType: TdxRichEditHeaderFooterType); overload;

    function IsFooterLinkedToPrevious(AType: TdxRichEditHeaderFooterType)
      : Boolean; overload;
    procedure LinkFooterToPrevious(AType: TdxRichEditHeaderFooterType);
      overload;
    procedure UnlinkFooterFromPrevious
      (AType: TdxRichEditHeaderFooterType); overload;
    ...
    function IsHeaderLinkedToNext(AType: TdxRichEditHeaderFooterType)
      : Boolean; overload;
    procedure LinkHeaderToNext(AType: TdxRichEditHeaderFooterType); overload;
    procedure UnlinkHeaderFromNext(AType: TdxRichEditHeaderFooterType);
      overload;

    function IsFooterLinkedToNext(AType: TdxRichEditHeaderFooterType)
      : Boolean; overload;
    procedure LinkFooterToNext(AType: TdxRichEditHeaderFooterType); overload;
    procedure UnlinkFooterFromNext(AType: TdxRichEditHeaderFooterType);
      overload;

    property Columns: IdxRichEditSectionColumns read GetColumns;
    property DifferentFirstPage: Boolean read GetDifferentFirstPage
      write SetDifferentFirstPage;
    property FirstPageTray: Integer read GetFirstPageTray
      write SetFirstPageTray;
    property LineNumbering: IdxRichEditSectionLineNumbering
      read GetLineNumbering;
    property Margins: IdxRichEditSectionMargins read GetMargins;
    property OtherPagesTray: Integer read GetOtherPagesTray
      write SetOtherPagesTray;
    property Page: IdxRichEditSectionPage read GetPage;
    property PageNumbering: IdxRichEditSectionPageNumbering
      read GetPageNumbering;
    property Paragraphs: IdxRichEditReadOnlyParagraphCollection
      read GetParagraphs;
    property StartType: TdxRichEditSectionStartType read GetStartType
      write SetStartType;
  end;
  ...
  IdxRichEditSelectionCollection = interface
    (IdxReadOnlyList<IdxRichEditDocumentRange>)
  ...
  IdxRichEditReadOnlyDocumentImageCollection = interface
    (IdxReadOnlyList<IdxRichEditDocumentImage>)
    function Get(const ARange: IdxRichEditDocumentRange)
      : IdxRichEditReadOnlyDocumentImageCollection;
  end;
  ...
  IdxRichEditDocumentImageCollection = interface
    ...
    function Insert(const APos: IdxRichEditDocumentPosition; AImage: TGraphic)
      : IdxRichEditDocumentImage;
  end;
  ...
  IdxRichEditReadOnlyHyperlinkCollection = interface
    (IdxReadOnlyList<IdxRichEditHyperlink>)
    function Get(const ARange: IdxRichEditDocumentRange)
      : IdxRichEditReadOnlyHyperlinkCollection;
  end;
  ...
  IdxRichEditHyperlinkCollection = interface
    ...
    function FindHyperlink(AFieldIndex: Integer;
  ...
  IdxRichEditReadOnlyBookmarkCollection = interface
    (IdxReadOnlyList<IdxRichEditBookmark>)
    function Get(const ARange: IdxRichEditDocumentRange)
      : IdxRichEditReadOnlyBookmarkCollection;
  end;
  ...
  IdxRichEditBookmarkCollection = interface
    ...
    property Items[const Name: string]: IdxRichEditBookmark
      read GetItem; default;
  end;

  TdxRichEditShapeHorizontalAlignment = (None, Left, Center, Right,
    Inside, Outside);

  TdxRichEditShapeVerticalAlignment = (None, Top, Center, Bottom,
    Inside, Outside);

  TdxRichEditShapeRelativeHorizontalPosition = (Page, Character, Column, Margin,
    LeftMargin, RightMargin, InsideMargin, OutsideMargin);

  TdxRichEditShapeRelativeVerticalPosition = (Page, Line, Paragraph, Margin,
    TopMargin, BottomMargin, InsideMargin, OutsideMargin);

  TdxRichEditTextWrappingType = (Square, Tight, Through, TopAndBottom,
    BehindText, InFrontOfText);

  TdxRichEditTextBoxSizeRule = (Auto, Exact);
  ...
  IdxRichEditTextBox = interface
    ...
    property HeightRule: TdxRichEditTextBoxSizeRule read GetHeightRule
      write SetHeightRule;
  ...
  IdxRichEditShape = interface
    ...
    function GetRange: IdxRichEditDocumentRange;
    function GetRelativeHorizontalPosition
    ...
    procedure SetHorizontalAlignment(const Value
    ...
    procedure SetRelativeHorizontalPosition(const Value
      : TdxRichEditShapeRelativeHorizontalPosition);
    procedure SetRelativeVerticalPosition(const Value
      : TdxRichEditShapeRelativeVerticalPosition);
    ...
    property HorizontalAlignment: TdxRichEditShapeHorizontalAlignment
    ...
    property Range: IdxRichEditDocumentRange read GetRange;
    property RelativeHorizontalPosition
      : TdxRichEditShapeRelativeHorizontalPosition
      read GetRelativeHorizontalPosition write SetRelativeHorizontalPosition;
    property RelativeVerticalPosition: TdxRichEditShapeRelativeVerticalPosition
      read GetRelativeVerticalPosition write SetRelativeVerticalPosition;
    ...
    property TextWrapping: TdxRichEditTextWrappingType read GetTextWrapping
      write SetTextWrapping;
    property VerticalAlignment: TdxRichEditShapeVerticalAlignment
      read GetVerticalAlignment write SetVerticalAlignment;
  ...
  IdxRichEditReadOnlyShapeCollection = interface
    (IdxReadOnlyList<IdxRichEditShape>)
    function Get(const ARange: IdxRichEditDocumentRange)
      : IdxRichEditReadOnlyShapeCollection;
  end;
  ...
  IdxRichEditShapeCollection = interface(IdxRichEditReadOnlyShapeCollection)
    ...
    function InsertPicture(const APos: IdxRichEditDocumentPosition;
      AImage: TGraphic): IdxRichEditShape;
  ...
  IdxRichEditRangePermissionCollection = interface
    (IdxRichEditList<IdxRichEditRangePermission>)
    function CreateRangePermission(const ARange: IdxRichEditDocumentRange)
      : IdxRichEditRangePermission;
  end;

  TdxRichEditWidthType = (None = TdxWidthUnitTypeValues.&Nil,
  ...
  TdxRichEditHeightType = (AtLeast, Auto, Exact);

  TdxRichEditTableLookType = (ApplyFirstRow, ApplyLastRow, ApplyFirstColumn,
    ApplyLastColumn, DoNotApplyRowBanding, DoNotApplyColumnBanding);
  ...
  IdxRichEditTableCell = interface
    ...
    property Height: Single read GetHeight write SetHeight;
    property HeightType: TdxRichEditHeightType read GetHeightType
      write SetHeightType;
    property Index: Integer read GetIndex;
    ...
    property PreferredWidth: Single read GetPreferredWidth
      write SetPreferredWidth;
    property PreferredWidthType: TdxRichEditWidthType read GetPreferredWidthType
      write SetPreferredWidthType;
    ...
    property VerticalAlignment: TdxRichEditTableCellVerticalAlignment
      read GetVerticalAlignment write SetVerticalAlignment;
  ...
  IdxRichEditTableCellCollection = interface
    (IdxReadOnlyList<IdxRichEditTableCell>)
  ...
  IdxRichEditTableRow = interface
    ...
    property Items[AColumn: Integer]: IdxRichEditTableCell
      read GetItem; default;
    ...
    property Range: IdxRichEditDocumentRange read GetRange;
    property Table: IdxRichEditTable read GetTable;
    property TableRowAlignment: TdxRichEditTableRowAlignment
      read GetTableRowAlignment write SetTableRowAlignment;
  end;

  { IdxRichEditTableRowCollection }

  IdxRichEditTableRowCollection = interface
    (IdxReadOnlyList<IdxRichEditTableRow>)
  ...
  TdxRichEditTableCellProcessorDelegate = reference to procedure
    (const ACell: IdxRichEditTableCell; ARowIndex, ACellIndex: Integer);
  TdxRichEditTableRowProcessorDelegate = reference to procedure
    (const ARow: IdxRichEditTableRow; ARowIndex: Integer);
  ...
  IdxRichEditTable = interface
    ...
    procedure SetPreferredWidth(AWidth: Single;
      AWidthType: TdxRichEditWidthType); overload;
    procedure ForEachCell(const ACellProcessor
      : TdxRichEditTableCellProcessorDelegate);
    procedure ForEachRow(const ARowProcessor
      : TdxRichEditTableRowProcessorDelegate);
    ...
    property Self[ARow, AColumn: Integer]: IdxRichEditTableCell
      read GetItem; default;
    property Style: IdxRichEditTableStyle read GetStyle write SetStyle;
    property TableAlignment: TdxRichEditTableRowAlignment read GetTableAlignment
      write SetTableAlignment;
    property TableBackgroundColor: TdxAlphaColor read GetTableBackgroundColor
      write SetTableBackgroundColor;
    property TableCellSpacing: Single read GetTableCellSpacing
      write SetTableCellSpacing;
    property TableLayout: TdxRichEditTableLayoutType read GetTableLayout
      write SetTableLayout;
    property TableLook: TdxRichEditTableLookTypes read GetTableLook
      write SetTableLook;
    property TopPadding: Single read GetTopPadding write SetTopPadding;
  end;
  ...
  IdxRichEditReadOnlyTableCollection = interface
    (IdxReadOnlyList<IdxRichEditTable>)
    function Get(const ARange: IdxRichEditDocumentRange)
      : IdxRichEditReadOnlyTableCollection;
    function GetTableCell(const APos: IdxRichEditDocumentPosition)
      : IdxRichEditTableCell;
  end;
  ...
  IdxRichEditTableCollection = interface(IdxRichEditReadOnlyTableCollection)
    ...
    function Add(const APos: IdxRichEditDocumentPosition;
  ...
  TdxRichEditNumberingType = (MultiLevel, Simple, Bullet);
  ...
  IdxRichEditListLevelProperties = interface
    ...
    property ConvertPreviousLevelNumberingToDecimal: Boolean
      read GetConvertPreviousLevelNumberingToDecimal
      write SetConvertPreviousLevelNumberingToDecimal;
    property DisplayFormatString: string read GetDisplayFormatString
      write SetDisplayFormatString;
    property NumberingFormat: TdxRichEditNumberingFormat read GetNumberingFormat
      write SetNumberingFormat;
    property RelativeRestartLevel: Integer read GetRelativeRestartLevel
      write SetRelativeRestartLevel;
  ...
  IdxRichEditListLevel = interface(IdxRichEditListLevelProperties)
    ...
    property ParagraphProperties: IdxRichEditParagraphPropertiesBase
      read GetParagraphProperties;
    property ParagraphStyle: IdxRichEditParagraphStyle read GetParagraphStyle
      write SetParagraphStyle;
  end;

  { IdxReadOnlyListLevelCollection<T> }

  IdxReadOnlyListLevelCollection<T: IdxRichEditListLevel> = interface
    (IdxReadOnlyList<T>)
  end;
  ...
  IdxRichEditNumberingListBase = interface
    ...
    property Levels: IdxReadOnlyListLevelCollection<IdxRichEditListLevel>
      read GetLevels;
    property NumberingType: TdxRichEditNumberingType read GetNumberingType
      write SetNumberingType;
  end;
  ...
  IdxRichEditListLevelCollection<T: IdxRichEditListLevel> = interface
    (IdxReadOnlyListLevelCollection<T>)
  ...
  IdxRichEditNumberingList = interface(IdxRichEditNumberingListBase)
    ...
    property AbstractNumberingList: IdxRichEditAbstractNumberingList
      read GetAbstractNumberingList;
    property AbstractNumberingListIndex: Integer
      read GetAbstractNumberingListIndex;
    property Index: Integer read GetIndex;
    property Levels
      : IdxRichEditListLevelCollection<IdxRichEditOverrideListLevel>
      read GetLevels;
  ...
  IdxRichEditTemplateAbstractNumberingList = interface
    (IdxRichEditNumberingListBase)
  ...
  IdxRichEditAbstractNumberingListCollection = interface
    (IdxReadOnlyList<IdxRichEditAbstractNumberingList>)
    function GetBulletedListTemplate: IdxRichEditTemplateAbstractNumberingList;
    function GetMultiLevelListTemplate
      : IdxRichEditTemplateAbstractNumberingList;
    ...
    property BulletedListTemplate: IdxRichEditTemplateAbstractNumberingList
      read GetBulletedListTemplate;
    property MultiLevelListTemplate: IdxRichEditTemplateAbstractNumberingList
      read GetMultiLevelListTemplate;
    property NumberedListTemplate: IdxRichEditTemplateAbstractNumberingList
      read GetNumberedListTemplate;
  end;

  { IdxRichEditNumberingListCollection }

  IdxRichEditNumberingListCollection = interface
    (IdxReadOnlyList<IdxRichEditNumberingList>)
    function Add(AAbstractNumberingListIndex: Integer)
      : IdxRichEditNumberingList; overload;
    procedure Add(const AList: IdxRichEditNumberingList); overload;
    function CreateNew(AAbstractNumberingListIndex: Integer)
      : IdxRichEditNumberingList;
  end;

  TdxRichEditSubDocumentType = (Main, Header, Footer, TextBox);
  ...
  IdxRichEditSubDocument = interface
    ...
    function GetRtfText(const ARange: IdxRichEditDocumentRange)
      : string; overload;
    function GetOpenXmlBytes(const ARange: IdxRichEditDocumentRange)
      : TBytes; overload;
    ...
    property Range: IdxRichEditDocumentRange read GetRange;
    property Length: Integer read GetLength;
    property PageBackColor: TdxAlphaColor read GetPageBackColor
      write SetPageBackColor;
    property Paragraphs: IdxRichEditParagraphCollection read GetParagraphs;
    property ShowPageBackground: Boolean read GetShowPageBackground
      write SetShowPageBackground;
  ...
  IdxRichEditDocument = interface(IdxRichEditSubDocument)
    ...
    property DefaultCharacterProperties: IdxRichEditCharacterPropertiesBase
      read GetDefaultCharacterProperties;
    property DefaultParagraphProperties: IdxRichEditParagraphPropertiesBase
      read GetDefaultParagraphProperties;
    property DefaultTableProperties: IdxRichEditTablePropertiesBase
...
class function TdxRichEditTextFragmentOptions.Create
  : TdxRichEditTextFragmentOptions;
begin
