...
type
  ...
  protected
    ...
    class procedure ThrowException(const AMessage: TcxResourceStringID);
      overload; static;
    class procedure ThrowException(const AMessage: TcxResourceStringID;
      const AArgument: array of const); overload; static;
    class procedure UpdateCurrentCulture; static;
  public
    constructor Create;
    class procedure ThrowIncorrectNumericFieldFormatError; static;
    class procedure ThrowSyntaxError(const AIncorrectFormat: string);
      overload; static;
  ...
  protected
    ...
    function InternalFormat(const AValue: T; const AFormat: string): string;
      virtual; abstract;
  public
    function Format(const AValue: T; const AFormat: string;
      AHasFormat: Boolean): string;
  end;
  ...
  protected
    ...
    function FormatCore(const AValue: TValue;
      const AFormattedValue, AKeyword: string): string; virtual;
    function FormatAsNumber(const AValue: TValue;
      const AFormattedValue, AKeyword: string): string; virtual;
    function FormatAsString(const AValue: TValue;
      const AFormattedValue, AKeyword: string): string; virtual;
    function TryGetValue(const ANotation: string; out AResult: Double)
      : Boolean; virtual;
  public
    function Format(const AValue: TValue; const AFormattedValue: string;
      const AKeyword: string): string; virtual;
    function IsGeneralDocumentModelStringFormatter(const AKeyword: string)
      : Boolean; virtual;

    // for internal use
    procedure FormatPieceTable(APieceTable
      : TdxCustomPieceTable { TdxPieceTable }; const AKeyword: string); virtual;
  end;

  { TdxGeneralFormatterBase }

  TdxFormatKeywordHandler = reference to function(const Value: TValue;
    const ACulture: TdxCultureInfo): string;
  TdxFormatKeywordTable = class
    (TdxNamedDelegateDictionary<TdxFormatKeywordHandler>);

  TdxGeneralFormatterBase = class abstract
  strict private
    FCulture: TdxCultureInfo;
  protected
    class function GetUpperCaseString(const AStr: string;
      const ACulture: TdxCultureInfo): string; static;
    class function GetLowerCaseString(const AStr: string;
      const ACulture: TdxCultureInfo): string; static;
  ...
  public
    ...
    function Format(const AValue: TValue; const AKeyword: string)
      : string; virtual;
    class function ContainsKeyword(const AKeyword: string;
      const ACulture: TdxCultureInfo): Boolean; virtual;
  end;
  ...
  strict private
    class var FNumberFormatKeywords: TdxFormatKeywordTable;
  strict private
    class constructor Initialize;
    class destructor Finalize;
    class function CreateNumberFormatKeywordTable
      : TdxFormatKeywordTable; static;
    class function ConvertToUppercaseAlphabeticLatinCharacters
      (const AValue: TValue; const ACulture: TdxCultureInfo): string; static;
    class function ConvertToLowercaseAlphabeticLatinCharacters
      (const AValue: TValue; const ACulture: TdxCultureInfo): string; static;
    class function ValidateValueForConvertingToLatinChars(const AValue: TValue)
      : Integer; static;
    class function ConvertToArabicCardinalNumerals(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToArabicCardinalNumeralsWithDashes
      (const AValue: TValue; const ACulture: TdxCultureInfo): string; static;
    class function ConvertToLowercaseCardinalText(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToLowercaseOrdinalText(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToLowercaseText(const AValue: TValue;
      AConverter: TdxDescriptiveNumberConverterBase;
      const ACulture: TdxCultureInfo): string; static;
    class function GetDescriptiveCardinalNumberConverter(const ACultureName
      : string): TdxDescriptiveNumberConverterBase; static;
    class function GetDescriptiveOrdinalNumberConverter(const ACultureName
      : string): TdxDescriptiveNumberConverterBase; static;
    class function ConvertToOrdinalNumber(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function GetOrdinalNumberConverter(const ACultureName: string)
      : TdxOrdinalBasedNumberConverter; static;
    class function ConvertToNumberEnclosedInCircle(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToNumberFollowedByPeriod(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToNumberEnclosedInBrackets(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToIdeographsEnclosedInBrackets(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToNumericalTraditionalIdeographs(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToNumericalZodiacIdeographs(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToNumericalTraditionalZodiacIdeographs
      (const AValue: TValue; const ACulture: TdxCultureInfo): string; static;
    class function ConvertNumberToCharacter(const AValue: TValue;
      AConverter: TdxNumberToSingleCharConverter;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToDoubleByteArabicNumber(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToSequentialDigitalIdeographs(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToDollarText(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function GetDollarTextConverter(const ACultureName: string)
      : TdxNumberToDollarTextConverter; static;
    class function ConvertToNumberEnclosedInCircleTruncated
      (const AValue: TValue; const ACulture: TdxCultureInfo): string; static;
    class function ConvertToHexadecimalNumber(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToUppercaseRomanNumber(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToLowercaseRomanNumber(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToArabicNumber(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    ...
    class function GetNumberString(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; overload; static;
    class function GetNumberString(const AValue: Integer;
      const ACulture: TdxCultureInfo): string; overload; static;
    class function GetFormattedNumberString(const AFormat: string;
      AValue: Integer; const ACulture: TdxCultureInfo): string; static;
  protected
  ...
  strict private
    class var FStringFormatKeywords: TdxFormatKeywordTable;
  strict private
    class constructor Initialize;
    class destructor Finalize;
    class function CreateStringFormatKeywordsTable
      : TdxFormatKeywordTable; static;
    class function CapitalizesFirstLetterOfEachWord(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function SkipCharacters(AIndex: Integer; AStr: TStringBuilder;
      const APredicate: TdxPredicate<Char>): Integer; static;
    ...
    class function CapitalizesFirstLetterOfFirstWord(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToLowercaseString(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
    class function ConvertToUppercaseString(const AValue: TValue;
      const ACulture: TdxCultureInfo): string; static;
  protected
    class function GetKeywords: TdxFormatKeywordTable; override;
  end;
...
type
  ...
  TdxNumberToEnclosedCircleNumberConverter = class
  ...
  TdxNumberToNumberFollowedByPeriodConverter = class
    (TdxNumberToSingleCharConverter)
  protected
    function CreateAlphanumericCharsTable: TArray<Char>; override;
  end;
  ...
  TdxNumberToEnclosedBracketsNumberConverter = class
    (TdxNumberToSingleCharConverter)
  protected
    function CreateAlphanumericCharsTable: TArray<Char>; override;
  end;
  ...
  TdxNumberToIdeographsEnclosedBracketsConverter = class
    (TdxNumberToSingleCharConverter)
  protected
    function CreateAlphanumericCharsTable: TArray<Char>; override;
  end;
  ...
  TdxNumberToTraditionalIdeographsConverter = class
    (TdxNumberToSingleCharConverter)
  protected
    function CreateAlphanumericCharsTable: TArray<Char>; override;
  end;
  ...
  public
    function Convert(ANumber: Double; const ACulture: TdxCultureInfo)
      : string; virtual;
  end;

  { TdxNumberToDoubleByteNumberConverter }

  TdxNumberToDoubleByteNumberConverter = class
    (TdxNumberToMultipleCharsConverter)
  private const
  ...
  TdxNumberToDigitalIdeographsConverter = class
    (TdxNumberToMultipleCharsConverter)
  strict private
  const
    ZeroCharCode = 48;
    class var FDigitalIdeographs: TArray<Char>;
    class constructor Initialize;
  protected
    function ConvertSingleChar(ACh: Char): Char; override;
  end;
...
class procedure TdxFieldFormatter.ThrowException(const AMessage
  : TcxResourceStringID);
var
  S: string;
begin
...
class procedure TdxFieldFormatter.ThrowException(const AMessage
  : TcxResourceStringID; const AArgument: array of const);
var
  S: string;
begin
  S := cxGetResourceString(AMessage);
...
begin
  ThrowException(@sdxRichEditExceptionSyntaxErrorInFieldPattern,
    [AIncorrectFormat]);
end;
...
function TdxGeneralFieldFormatter.Format(const AValue: TValue;
  const AFormattedValue: string; const AKeyword: string): string;
begin
  BeginFormat;
  try
...
function TdxGeneralFieldFormatter.IsGeneralDocumentModelStringFormatter
  (const AKeyword: string): Boolean;
begin
  Result := TdxGeneralDocumentModelStringFormatter.ContainsKeyword
    (AKeyword, Culture);
end;

procedure TdxGeneralFieldFormatter.FormatPieceTable
  (APieceTable: TdxCustomPieceTable { TdxPieceTable }; const AKeyword: string);
begin
  if TdxGeneralDocumentModelStringFormatter.ContainsKeyword(AKeyword, Culture)
  then
  begin
    BeginFormat;
    try
...
function TdxGeneralFieldFormatter.FormatCore(const AValue: TValue;
  const AFormattedValue, AKeyword: string): string;
begin
  if FNumberFormatter.ContainsKeyword(AKeyword, Culture) then
    Exit(FormatAsNumber(AValue, AFormattedValue, AKeyword))
  else if FStringFormatter.ContainsKeyword(AKeyword, Culture) then
...
function TdxGeneralFieldFormatter.FormatAsNumber(const AValue: TValue;
  const AFormattedValue, AKeyword: string): string;
var
...
function TdxGeneralFieldFormatter.FormatAsString(const AValue: TValue;
  const AFormattedValue, AKeyword: string): string;
begin
...
function TdxGeneralFieldFormatter.TryGetValue(const ANotation: string;
...
class function TdxGeneralFormatterBase.GetUpperCaseString(const AStr: string;
  const ACulture: TdxCultureInfo): string;
begin
{$IFDEF DELPHIXE4}
  Result := AStr.ToUpper;
...
class function TdxGeneralFormatterBase.GetLowerCaseString(const AStr: string;
  const ACulture: TdxCultureInfo): string;
begin
{$IFDEF DELPHIXE4}
  Result := AStr.ToLower;
...
function TdxGeneralFormatterBase.Format(const AValue: TValue;
  const AKeyword: string): string;
var
...
class function TdxGeneralFormatterBase.ContainsKeyword(const AKeyword: string;
  const ACulture: TdxCultureInfo): Boolean;
begin
...
function TdxGeneralFormatterBase.GetCaseSensitiveKeyword(const AKeyword
  : string): string;
begin
  if {$IFDEF DELPHIXE4}AKeyword[1].IsUpper{$ELSE}TCharacter.IsUpper(AKeyword[1]
    ){$ENDIF} then
...
class function TdxGeneralNumberFormatter.CreateNumberFormatKeywordTable
  : TdxFormatKeywordTable;
begin
...
class function TdxGeneralNumberFormatter.
  ConvertToUppercaseAlphabeticLatinCharacters(const AValue: TValue;
  const ACulture: TdxCultureInfo): string;
var
...
begin
  ...
  AConverter := TdxOrdinalBasedNumberConverter.
    GetUpperLatinLetterNumberConverter;
  try
...
class function TdxGeneralNumberFormatter.
  ConvertToLowercaseAlphabeticLatinCharacters(const AValue: TValue;
  const ACulture: TdxCultureInfo): string;
var
  AIntegerValue: Integer;
  AConverter: TdxOrdinalBasedNumberConverter;
begin
  AIntegerValue := ValidateValueForConvertingToLatinChars(AValue);
  AConverter := TdxOrdinalBasedNumberConverter.
    GetLowerLatinLetterNumberConverter;
  try
    Result := AConverter.ConvertNumber(AIntegerValue);
  finally
    AConverter.Free;
...
class function TdxGeneralNumberFormatter.ValidateValueForConvertingToLatinChars
...
class function TdxGeneralNumberFormatter.ConvertToArabicCardinalNumerals
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
  AIntegerValue: Integer;
begin
  AIntegerValue := ConvertToInteger(AValue);
...
class function TdxGeneralNumberFormatter.
  ConvertToArabicCardinalNumeralsWithDashes(const AValue: TValue;
  const ACulture: TdxCultureInfo): string;
var
  AIntegerValue: Integer;
begin
  AIntegerValue := ConvertToInteger(AValue);
  Result := SysUtils.Format('- %s -',
    [GetFormattedNumberString('0', AIntegerValue, ACulture)]);
end;

class function TdxGeneralNumberFormatter.ConvertToLowercaseCardinalText
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
  AConverter: TdxDescriptiveNumberConverterBase;
begin
  AConverter := GetDescriptiveCardinalNumberConverter
    (ACulture.Parent.EnglishName);
  try
...
class function TdxGeneralNumberFormatter.ConvertToLowercaseOrdinalText
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
  AConverter: TdxDescriptiveNumberConverterBase;
begin
  AConverter := GetDescriptiveOrdinalNumberConverter
    (ACulture.Parent.EnglishName);
  try
    Result := ConvertToLowercaseText(AValue, AConverter, ACulture);
  finally
...
class function TdxGeneralNumberFormatter.ConvertToLowercaseText
  (const AValue: TValue; AConverter: TdxDescriptiveNumberConverterBase;
  const ACulture: TdxCultureInfo): string;
var
  AIntegerValue: Integer;
begin
  ...
  if (AIntegerValue < 0) or (999999 < AIntegerValue) then
    TdxFieldFormatter.ThrowIncorrectNumericFieldFormatError;
  Result := GetLowerCaseString(AConverter.ConvertNumber(AIntegerValue),
    ACulture);
end;

class function TdxGeneralNumberFormatter.GetDescriptiveCardinalNumberConverter
  (const ACultureName: string): TdxDescriptiveNumberConverterBase;
begin
  Result := TdxDescriptiveCardinalEnglishNumberConverter.Create;
end;

class function TdxGeneralNumberFormatter.GetDescriptiveOrdinalNumberConverter
  (const ACultureName: string): TdxDescriptiveNumberConverterBase;
begin
  Exit(TdxDescriptiveOrdinalEnglishNumberConverter.Create);
end;

class function TdxGeneralNumberFormatter.ConvertToOrdinalNumber
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
  AIntegerValue: Integer;
  AConverter: TdxOrdinalBasedNumberConverter;
...
class function TdxGeneralNumberFormatter.GetOrdinalNumberConverter
  (const ACultureName: string): TdxOrdinalBasedNumberConverter;
begin
  Exit(TdxOrdinalEnglishNumberConverter.Create);
end;

class function TdxGeneralNumberFormatter.ConvertToNumberEnclosedInCircle
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
...
class function TdxGeneralNumberFormatter.ConvertToNumberFollowedByPeriod
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
...
class function TdxGeneralNumberFormatter.ConvertToNumberEnclosedInBrackets
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
...
class function TdxGeneralNumberFormatter.ConvertToIdeographsEnclosedInBrackets
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
...
class function TdxGeneralNumberFormatter.ConvertToNumericalTraditionalIdeographs
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
...
class function TdxGeneralNumberFormatter.ConvertToNumericalZodiacIdeographs
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
...
class function TdxGeneralNumberFormatter.
  ConvertToNumericalTraditionalZodiacIdeographs(const AValue: TValue;
  const ACulture: TdxCultureInfo): string;
var
  AIntegerValue: Integer;
...
class function TdxGeneralNumberFormatter.ConvertNumberToCharacter
  (const AValue: TValue; AConverter: TdxNumberToSingleCharConverter;
  const ACulture: TdxCultureInfo): string;
var
  AIntegerValue: Integer;
begin
...
class function TdxGeneralNumberFormatter.ConvertToDoubleByteArabicNumber
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
...
class function TdxGeneralNumberFormatter.ConvertToSequentialDigitalIdeographs
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
  ARoundValue: Double;
...
class function TdxGeneralNumberFormatter.ConvertToDollarText
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
...
class function TdxGeneralNumberFormatter.GetDollarTextConverter
  (const ACultureName: string): TdxNumberToDollarTextConverter;
begin
  Exit(TdxNumberToEnglishDollarTextConverter.Create);
end;

class function TdxGeneralNumberFormatter.
  ConvertToNumberEnclosedInCircleTruncated(const AValue: TValue;
  const ACulture: TdxCultureInfo): string;
var
  AIntegerValue: Integer;
begin
...
class function TdxGeneralNumberFormatter.ConvertToHexadecimalNumber
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
  AIntegerValue: Integer;
begin
...
class function TdxGeneralNumberFormatter.ConvertToUppercaseRomanNumber
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
  AIntegerValue: Integer;
  AConverter: TdxOrdinalBasedNumberConverter;
begin
  AIntegerValue := ConvertToShortInteger(AValue);
  AConverter := TdxOrdinalBasedNumberConverter.
    GetUpperRomanNumberConverterClassic;
  try
    Result := AConverter.ConvertNumber(AIntegerValue);
  finally
    AConverter.Free;
...
class function TdxGeneralNumberFormatter.ConvertToLowercaseRomanNumber
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
  AIntegerValue: Integer;
  AConverter: TdxOrdinalBasedNumberConverter;
begin
  AIntegerValue := ConvertToShortInteger(AValue);
  AConverter := TdxOrdinalBasedNumberConverter.
    GetLowerRomanNumberConverterClassic;
  try
    Result := AConverter.ConvertNumber(AIntegerValue);
  finally
    AConverter.Free;
...
class function TdxGeneralNumberFormatter.ConvertToArabicNumber
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
begin
  Result := GetNumberString(AValue, ACulture);
end;

class function TdxGeneralNumberFormatter.ConvertToInteger
  (const AValue: TValue): Integer;
begin
  try
...
class function TdxGeneralNumberFormatter.ConvertToShortInteger
  (const AValue: TValue): Integer;
begin
  try
    Result := Round(AValue.ToFloat);
...
class function TdxGeneralNumberFormatter.GetNumberString(const AValue: TValue;
  const ACulture: TdxCultureInfo): string;
var
  AFormattingString: string;
begin
  AFormattingString := '0.' + StringOfChar('#', 14);
  Result := FormatFloat(AFormattingString, AValue.ToFloat,
    ACulture.FormatSettings);
end;

class function TdxGeneralNumberFormatter.GetNumberString(const AValue: Integer;
  const ACulture: TdxCultureInfo): string;
begin
  Result := IntToStr(AValue);
end;

class function TdxGeneralNumberFormatter.GetFormattedNumberString
  (const AFormat: string; AValue: Integer;
  const ACulture: TdxCultureInfo): string;
var
  ATemp: Double;
begin
...
class function TdxGeneralStringFormatter.CreateStringFormatKeywordsTable
  : TdxFormatKeywordTable;
begin
  Result := TdxFormatKeywordTable.Create;
...
class function TdxGeneralStringFormatter.CapitalizesFirstLetterOfEachWord
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
...
begin
  ABuilder := TStringBuilder.Create
    ({$IFDEF DELPHIXE4}AValue.AsString.ToLower{$ELSE}TCharacter.ToLower
    (AValue.AsString){$ENDIF});
  try
    AIndex := 0;
    while AIndex < ABuilder.Length do
    begin
      ABuilder[AIndex] :=
      {$IFDEF DELPHIXE4}ABuilder[AIndex].ToUpper{$ELSE}TCharacter.ToUpper
        (ABuilder[AIndex]){$ENDIF};
...
class function TdxGeneralStringFormatter.SkipCharacters(AIndex: Integer;
  AStr: TStringBuilder; const APredicate: TdxPredicate<Char>): Integer;
begin
...
class function TdxGeneralStringFormatter.IsLetterOrDigit
  (const ACh: Char): Boolean;
begin
  Result := {$IFDEF DELPHIXE4}ACh.IsLetterOrDigit{$ELSE}TCharacter.
    IsLetterOrDigit(ACh){$ENDIF};
end;

class function TdxGeneralStringFormatter.IsNotLetterOrDigit
  (const ACh: Char): Boolean;
begin
  Result := not IsLetterOrDigit(ACh);
end;

class function TdxGeneralStringFormatter.CapitalizesFirstLetterOfFirstWord
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
  ABuilder: TStringBuilder;
begin
  ...
  try
    if ABuilder.Length > 0 then
      ABuilder[0] :=
      {$IFDEF DELPHIXE4}ABuilder[0].ToUpper{$ELSE}TCharacter.ToUpper
        (ABuilder[0]){$ENDIF};
    Result := ABuilder.ToString;
  finally
    ABuilder.Free;
...
class function TdxGeneralStringFormatter.ConvertToLowercaseString
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
begin
  Result := {$IFDEF DELPHIXE4}AValue.AsString.ToLower{$ELSE}TCharacter.ToLower
    (AValue.AsString){$ENDIF};
end;

class function TdxGeneralStringFormatter.ConvertToUppercaseString
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
begin
  Result := {$IFDEF DELPHIXE4}AValue.AsString.ToUpper{$ELSE}TCharacter.ToUpper
    (AValue.AsString){$ENDIF};
end;
...
class function TdxGeneralDocumentModelStringFormatter.
  CreateStringFormatKeywordsTable: TdxFormatKeywordTable;
begin
  Result := TdxFormatKeywordTable.Create;
...
class function TdxGeneralDocumentModelStringFormatter.
  CapitalizesFirstLetterOfEachWord(const AValue: TValue;
  const ACulture: TdxCultureInfo): string;
var
...
begin
  ...
  try
    ...
    begin
      ...
      ATextBuffer[APosition] :=
      {$IFDEF DELPHIXE4}ATextBuffer[APosition].ToUpper{$ELSE}TCharacter.ToUpper
        (ATextBuffer[APosition]){$ENDIF};
      APos := AIterator.MoveForward(APos);
    end;
    Result := '';
  finally
...
class function TdxGeneralDocumentModelStringFormatter.
  CapitalizesFirstLetterOfFirstWord(const AValue: TValue;
  const ACulture: TdxCultureInfo): string;
var
  ATable: TdxPieceTable;
  AIterator: TdxWordsDocumentModelIterator;
...
class function TdxGeneralDocumentModelStringFormatter.ConvertToLowercaseString
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
  ATable: TdxPieceTable;
  ATextBuffer: TdxChunkedStringBuilder;
...
begin
  ...
  for I := 0 to ACount - 1 do
    ATextBuffer[I] :=
    {$IFDEF DELPHIXE4}ATextBuffer[I].ToLower{$ELSE}TCharacter.ToLower
      (ATextBuffer[I]){$ENDIF};
  Result := '';
end;

class function TdxGeneralDocumentModelStringFormatter.ConvertToUppercaseString
  (const AValue: TValue; const ACulture: TdxCultureInfo): string;
var
  ATable: TdxPieceTable;
  ATextBuffer: TdxChunkedStringBuilder;
...
begin
  ...
  for I := 0 to ACount - 1 do
    ATextBuffer[I] :=
    {$IFDEF DELPHIXE4}ATextBuffer[I].ToUpper{$ELSE}TCharacter.ToUpper
      (ATextBuffer[I]){$ENDIF};
  Result := '';
end;

class function TdxGeneralDocumentModelStringFormatter.GetKeywords
  : TdxFormatKeywordTable;
begin
  Result := FStringFormatKeywords;
end;
...
function TdxNumberToEnclosedCircleNumberConverter.CreateAlphanumericCharsTable
  : TArray<Char>;
begin
  Result := TArray<Char>.Create(#$2460, #$2461, #$2462, #$2463, #$2464, #$2465,
    #$2466, #$2467, #$2468, #$2469, #$246A, #$246B, #$246C, #$246D, #$246E,
    #$246F, #$2470, #$2471, #$2472, #$2473);
end;

{ TdxNumberToNumberFollowedByPeriodConverter }

function TdxNumberToNumberFollowedByPeriodConverter.CreateAlphanumericCharsTable
  : TArray<Char>;
begin
  Result := TArray<Char>.Create(#$2488, #$2489, #$248A, #$248B, #$248C, #$248D,
    #$248E, #$248F, #$2490, #$2491, #$2492, #$2493, #$2494, #$2495, #$2496,
    #$2497, #$2498, #$2499, #$249A, #$249B);
end;

{ TdxNumberToEnclosedBracketsNumberConverter }

function TdxNumberToEnclosedBracketsNumberConverter.CreateAlphanumericCharsTable
  : TArray<Char>;
begin
  Result := TArray<Char>.Create(#$2474, #$2475, #$2476, #$2477, #$2478, #$2479,
    #$247A, #$247B, #$247C, #$247D, #$247E, #$247F, #$2480, #$2481, #$2482,
    #$2483, #$2484, #$2485, #$2486, #$2487);
end;

{ TdxNumberToIdeographsEnclosedBracketsConverter }

function TdxNumberToIdeographsEnclosedBracketsConverter.
  CreateAlphanumericCharsTable: TArray<Char>;
begin
  Result := TArray<Char>.Create(#$3220, #$3221, #$3222, #$3223, #$3224, #$3225,
    #$3226, #$3227, #$3228, #$3229);
end;

{ TdxNumberToTraditionalIdeographsConverter }

function TdxNumberToTraditionalIdeographsConverter.CreateAlphanumericCharsTable
  : TArray<Char>;
begin
  Result := TArray<Char>.Create(#$7532, #$4E59, #$4E19, #$4E01, #$620A, #$5DF1,
    #$5E9A, #$8F9B, #$58EC, #$7678);
end;

{ TdxNumberToZodiacIdeographsConverter }

function TdxNumberToZodiacIdeographsConverter.CreateAlphanumericCharsTable
  : TArray<Char>;
begin
  Result := TArray<Char>.Create(#$5B50, #$4E11, #$5BC5, #$536F, #$8FB0, #$5DF3,
    #$5348, #$672A, #$7533, #$9149, #$620D, #$4EA5);
end;
...
function TdxNumberToTraditionalZodiacIdeographsConverter.Convert
...
begin
  ...
  try
    ABuilder.Append(FHeavenlyTrunksIdeographs
      [AValue mod Length(FHeavenlyTrunksIdeographs)]);
    ABuilder.Append(FEarthlyBranchesIdeographs
      [AValue mod Length(FEarthlyBranchesIdeographs)]);
    Result := ABuilder.ToString;
  finally
    ABuilder.Free;
  end;
...
begin
  FDigitalIdeographs := TArray<Char>.Create(#$3007, #$4E00, #$4E8C, #$4E09,
    #$56DB, #$4E94, #$516D, #$4E03, #$516B, #$4E5D);
end;
...
function TdxNumberToEnglishDollarTextConverter.GetNumberConverter
