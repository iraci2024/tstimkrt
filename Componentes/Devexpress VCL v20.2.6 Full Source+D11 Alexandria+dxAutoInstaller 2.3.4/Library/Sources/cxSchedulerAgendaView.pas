...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, DateUtils, Windows, Forms, Classes, SysUtils, Math, StdCtrls, Graphics,
  Controls, ExtCtrls, Menus, Variants, StrUtils,
  Contnrs, Generics.Collections, dxCore, cxControls, cxGraphics, cxStyles,
  cxGeometry, cxClasses, cxFormats, cxVariants,
  cxContainer, cxLookAndFeelPainters, cxDateUtils, cxSchedulerCustomControls,
  cxSchedulerCustomResourceView, dxGenerics,
  cxSchedulerUtils, cxSchedulerStorage, cxSchedulerStrs, cxEdit, dxTouch,
  dxCoreClasses, cxSchedulerDayView;

type
  TcxSchedulerAgendaViewDayHeaderOrientation = (dhoHorizontal, dhoVertical);
  TcxSchedulerAgendaViewDisplayMode = (avmAllDays, avmSelectedDays,
    avmSelectedNonEmptyDays);
  TcxSchedulerAgendaViewTimeAreaArrows = (avtaNone, avtaContinueArrowStart,
    avtaContinueArrowEnd, avtaContinueArrowsBoth);
  ...
  private
    ...
    function GetCellIndexOnNextPage(ACurrentIndex: Integer;
      AMostBottom: Boolean): Integer;
    function GetCellIndexOnPriorPage(ACurrentIndex: Integer;
      AMostTop: Boolean): Integer;
    function GetEventSelection: TcxSchedulerEventSelection;
    function GetFirstEventCell(ADayHeader
      : TcxSchedulerAgendaViewDayHeaderCellViewInfo)
      : TcxSchedulerAgendaViewEventCellViewInfo;
    function GetFirstInfoCell(ADayHeader
      : TcxSchedulerAgendaViewDayHeaderCellViewInfo)
      : TcxSchedulerCustomViewInfoItem;
    function GetFreeDayCell(ADate: TDate)
      : TcxSchedulerAgendaViewFreeDayCellViewInfo;
    function GetNewFocusedEventCellAfterDeletingOfCurrent
      : TcxSchedulerAgendaViewEventCellViewInfo;
    function GetViewInfo: TcxSchedulerAgendaViewViewInfo;
    function NeedUnselectStartCell(const AStartIndex,
      AEndIndex: Integer): Boolean;
    procedure SelectFreeDayCell(ADate: TDate; AShift: TShiftState;
      ANeedRefresh: Boolean);
    procedure SelectCell(ACell: TcxSchedulerCustomViewInfoItem;
      AShift: TShiftState; ANeedRefresh: Boolean); overload;
    procedure SelectCell(AIndex: Integer; AShift: TShiftState;
      ANeedRefresh: Boolean); overload;
    procedure SelectCells(AStartIndex, AEndIndex: Integer;
      const ANeedUnselectByMouse: Boolean);
  ...
  protected
    ...
    procedure DoFocusFirstEventCell(ADayHeader
      : TcxSchedulerAgendaViewDayHeaderCellViewInfo);
    ...
    procedure SelectNextCell(AForward: Boolean; AShift: TShiftState);
      reintroduce; virtual;
    ...
    procedure StoreFocusedCellDateAsActualPeriodForEventInitialize
      (var ADate: TDateTime);
    ...
    property IsTopDayCanBeChangedInsideOfScrolling: Boolean
      read FIsTopDayCanBeChangedInsideOfScrolling
      write FIsTopDayCanBeChangedInsideOfScrolling;
  public
    ...
    property FocusedCell: TcxSchedulerCustomViewInfoItem read FFocusedCell
  ...
  private
    ...
    procedure ExtractCellStartAndFinish(ACell: TcxSchedulerCustomViewInfoItem;
      const AIsNext: Boolean; var AStart, AFinish: TDateTime);
    function GetNextCell(AEventCell: TcxSchedulerAgendaViewEventCellViewInfo;
      var AStart, AFinish: TDateTime): TcxSchedulerCustomViewInfoItem;
    function GetPriorCell(ACell: TcxSchedulerCustomViewInfoItem;
      var AStart, AFinish: TDateTime): TcxSchedulerCustomViewInfoItem;
  protected
    ...
    property AgendaView: TcxSchedulerAgendaView read GetAgendaView;
    property AgendaViewInfo: TcxSchedulerAgendaViewViewInfo
      read GetAgendaViewInfo;
  ...
  private
    ...
    function GetHitTest: TcxSchedulerAgendaViewHitTest;
    function GetViewInfo: TcxSchedulerAgendaViewViewInfo;
    procedure SetDayHeaderOrientation
      (AValue: TcxSchedulerAgendaViewDayHeaderOrientation);
  ...
  protected
    ...
    procedure DoBeforeReallyDeleting(AEvent: TcxSchedulerControlEvent);
      override;
    ...
    function GetNextDayWithEvents(AStart: TDate;
      const AForward: Boolean): TDate;
  ...
  published
    property CanShow;
    property Active;
    property DayHeaderOrientation: TcxSchedulerAgendaViewDayHeaderOrientation
      read FDayHeaderOrientation write SetDayHeaderOrientation
      default dhoHorizontal;
    property DisplayMode: TcxSchedulerAgendaViewDisplayMode read FDisplayMode
      write SetDisplayMode default avmAllDays;
    property EventTextMinWidth: Integer read FEventTextMinWidth
      write SetEventTextMinWidth default 121;
    property ShowLocations: Boolean read FShowLocations write SetShowLocations
      default True;
    property ShowMessages: Boolean read FShowMessages write SetShowMessages
      default True;
    property ShowResources: Boolean read FShowResources write SetShowResources
      default True;
  ...
  protected
    procedure StoreHitEventCellParameters(AEventCell
      : TcxSchedulerAgendaViewEventCellViewInfo);
  end;
  ...
  protected
    ...
    procedure CorrectBoundsForVerticalOrientation(ACurrentDayLastCell
      : TcxSchedulerCustomViewInfoItem);
    ...
    property AgendaViewInfo: TcxSchedulerAgendaViewViewInfo
      read FAgendaViewInfo;
    property Orientation: TcxSchedulerAgendaViewDayHeaderOrientation
      read GetOrientation;
  public
  ...
  protected
    ...
    procedure InitializeDayHeader(ADayHeader
      : TcxSchedulerAgendaViewDayHeaderCellViewInfo);
    ...
    property AgendaViewInfo: TcxSchedulerAgendaViewViewInfo
      read GetAgendaViewInfo;
    property DayHeader: TcxSchedulerAgendaViewDayHeaderCellViewInfo
      read FDayHeader;
  public
  ...
  protected
    ...
    procedure CalculateActualEditRect(AEditViewData: TcxCustomEditViewData;
      var AMessageRect: TRect); override;
    ...
    procedure InitializeServiceFields(ADayHeader
      : TcxSchedulerAgendaViewDayHeaderCellViewInfo;
  ...
  TcxSchedulerAgendaViewEventCellViewInfoClass = class of
    TcxSchedulerAgendaViewEventCellViewInfo;

  { TcxSchedulerAgendaViewEventCellModernViewInfo }

  TcxSchedulerAgendaViewEventCellModernViewInfo = class
    (TcxSchedulerAgendaViewEventCellViewInfo)
  protected
    procedure CalculateTimeLineLayout; override;
    procedure DrawState; override;
  ...
  private
    ...
    function GetAgendaView: TcxSchedulerAgendaView;
    function GetBottomVisibleDayHeader
      : TcxSchedulerAgendaViewDayHeaderCellViewInfo;
    function GetController: TcxSchedulerAgendaViewController;
    function GetDayHeaderOrientation
  ...
  protected
    ...
    function AddDayHeaderInfo(const ADate: TDateTime)
      : TcxSchedulerAgendaViewDayHeaderCellViewInfo; virtual;
    function AddEventInfo(AEvent: TcxSchedulerControlEvent;
      ADayHeader: TcxSchedulerAgendaViewDayHeaderCellViewInfo;
      const AIsOnlyEventInDay, AInFreeDay: Boolean)
      : TcxSchedulerAgendaViewEventCellViewInfo; virtual;
    function AddFreeDayInfo(ADayHeader
      : TcxSchedulerAgendaViewDayHeaderCellViewInfo)
      : TcxSchedulerAgendaViewFreeDayCellViewInfo; virtual;
    ...
    procedure DoRightToLeftConversion(const AClientBounds: TRect); override;
    procedure ExtractEvents(ASource, ADest: TcxSchedulerEventList;
      ADate: TDateTime); virtual;
    procedure ExtractCloneEvents(ADest: TcxSchedulerEventList;
      ADate: TDateTime);
    ...
    function GetDayHeader(ACell: TcxSchedulerCustomViewInfoItem)
      : TcxSchedulerAgendaViewDayHeaderCellViewInfo;
    ...
    function GetEventStart(AEvent: TcxSchedulerControlEvent; ADate: TDateTime)
      : TDateTime;
    function GetEventFinish(AEvent: TcxSchedulerControlEvent; ADate: TDateTime)
      : TDateTime;
    function GetInfoCell(AIndex: Integer)
      : TcxSchedulerCustomViewInfoItem; overload;
    function GetInfoCell(AEvent: TcxSchedulerControlEvent;
      const ADate: TDateTime): TcxSchedulerCustomViewInfoItem; overload;
    function GetLastVisibleCell: TcxSchedulerCustomViewInfoItem;
    function GetTopScrollPosPreliminaryValue
      (ACell: TcxSchedulerCustomViewInfoItem): Integer;
    function GetTopScrollPosToDisplayCell
      (ACell: TcxSchedulerCustomViewInfoItem): Integer;
    ...
    procedure MeasureVerticalDayHeaderDayNumberFontSize(const AAreaHeight
      : Integer; var AFont: TFont);
    ...
    procedure RestoreCanvasFontParams(const AFontSize: Integer;
      const AFontStyle: TFontStyles);
    procedure StoreCanvasFontParams(var AFontSize: Integer;
    ...
    property BottomVisibleDayHeader: TcxSchedulerAgendaViewDayHeaderCellViewInfo
      read FBottomVisibleDayHeader;
    property CellDefaultHeight: Integer read FCellDefaultHeight;
    property CloneEventCells: TcxSchedulerEventCellViewInfoList
      read FCloneEventCells;
    ...
    property DayHeaderOrientation: TcxSchedulerAgendaViewDayHeaderOrientation
      read GetDayHeaderOrientation;
    property DragEventHelper: TcxAgendaViewDragEventHelper
      read GetDragEventHelper;
    property EventCellCaptionRectPattern: TRect
      read FEventCellCaptionRectPattern;
    ...
    property EventCellLocationRectPattern: TRect
      read FEventCellLocationRectPattern;
    property EventCellResourceRectPattern: TRect
      read FEventCellResourceRectPattern;
    ...
    property InfoCell[Index: Integer]: TcxSchedulerCustomViewInfoItem
      read GetInfoCell;
    property InfoCells: TcxObjectList read FInfoCells;
    property TopVisibleDayHeader: TcxSchedulerAgendaViewDayHeaderCellViewInfo
      read FTopVisibleDayHeader;
    property Controller: TcxSchedulerAgendaViewController read GetController;
  public
    constructor Create(AOwner: TcxSchedulerSubControl); override;
    destructor Destroy; override;
...
procedure cxRectCenterVerticallyRelativelyOfArea(var ARect: TRect;
  const AArea: TRect);
var
...
constructor TcxSchedulerAgendaViewController.Create
...
function TcxSchedulerAgendaViewController.
  CanCreateEventUsingInplaceEdit: Boolean;
begin
  Result := False;
end;
...
begin
  ...
  if PtInRect(ATop, APos) then
    AScrollCode := scLineUp
  else if PtInRect(ABottom, APos) then
...
procedure TcxSchedulerAgendaViewController.ClearFreeDaysSelection
  (AShift: TShiftState);
begin
...
function TcxSchedulerAgendaViewController.CreateDragEventHelper
  : TcxDragEventHelper;
begin
  Result := TcxAgendaViewDragEventHelper.Create(Scheduler);
end;

procedure TcxSchedulerAgendaViewController.DoFocusFirstEventCell
  (ADayHeader: TcxSchedulerAgendaViewDayHeaderCellViewInfo);
var
...
procedure TcxSchedulerAgendaViewController.EndDrag(Target: TObject;
  X, Y: Integer);
begin
...
function TcxSchedulerAgendaViewController.GetCellIndexOnNextPage
  (ACurrentIndex: Integer; AMostBottom: Boolean): Integer;
var
...
begin
  ...
  begin
    ...
    begin
      ...
      if (ABounds.Top >= APageHeight) and
        ((ABounds.Top - ATop > APageHeight) or
        (ABounds.Bottom - ATop > APageHeight)) then
      begin
        Dec(Result);
        Break;
      end;
...
function TcxSchedulerAgendaViewController.GetCellIndexOnPriorPage
  (ACurrentIndex: Integer; AMostTop: Boolean): Integer;
var
...
begin
  ...
  begin
    ...
    begin
      Result := I;
      ABounds := ViewInfo.InfoCell[Result].Bounds;
      if (ABounds.Bottom <= AHeaderHeight) and
        ((ATop - ABounds.Top > APageHeight) or
        (ATop - ABounds.Bottom > APageHeight)) then
      begin
        Inc(Result);
        Break;
      end;
...
function TcxSchedulerAgendaViewController.GetDragEventCell
  : TcxSchedulerAgendaViewEventCellViewInfo;
var
  I: Integer;
begin
  ...
  begin
    Result := TcxSchedulerAgendaViewEventCellViewInfo
      (ViewInfo.CloneEventCells[I]);
    if (Result.Event.Source = DragEvent) and
      (Int(TcxAgendaViewDragEventHelper(DragEventHelper).DestinationTime)
      = Int(Result.ActualStart)) then
      Break
    else
      Result := nil;
  end;
...
function TcxSchedulerAgendaViewController.GetEventSelection
...
begin
  ...
  for I := 0 to ViewInfo.EventCells.Count - 1 do
    if TcxSchedulerAgendaViewEventCellViewInfo(ViewInfo.EventCells[I])
      .DayHeader = ADayHeader then
    begin
...
function TcxSchedulerAgendaViewController.GetFirstInfoCell
  (ADayHeader: TcxSchedulerAgendaViewDayHeaderCellViewInfo)
  : TcxSchedulerCustomViewInfoItem;
var
  I: Integer;
  ...
  if Result = nil then
    for I := 0 to ViewInfo.InfoCells.Count - 1 do
      if (ViewInfo.InfoCell[I] is TcxSchedulerAgendaViewFreeDayCellViewInfo) and
        (TcxSchedulerAgendaViewFreeDayCellViewInfo(ViewInfo.InfoCell[I])
        .DayHeader = ADayHeader) then
      begin
...
begin
  ...
  begin
    ...
    if ViewInfo.InfoCell[AIndex] is TcxSchedulerAgendaViewFreeDayCellViewInfo
    then
      Result := TcxSchedulerAgendaViewFreeDayCellViewInfo
        (ViewInfo.InfoCell[AIndex]).DayHeader.DateTime
    else
      Result := TcxSchedulerAgendaViewEventCellViewInfo
        (ViewInfo.InfoCell[AIndex]).EventFinish;
  end
  else if ViewInfo.ActualVisibleDays.Count > 0 then
...
function TcxSchedulerAgendaViewController.
  GetNewFocusedEventCellAfterDeletingOfCurrent
  : TcxSchedulerAgendaViewEventCellViewInfo;

  function CanBeNewFocusedEventCell(const AIndex: Integer;
    const ACurrentDate: TDate): Boolean;
  begin
    Result := (ViewInfo.InfoCell[AIndex]
      is TcxSchedulerAgendaViewEventCellViewInfo) and
      ((AgendaView.DisplayMode = avmSelectedNonEmptyDays) or
      (Int(TcxSchedulerAgendaViewEventCellViewInfo(ViewInfo.InfoCell[AIndex])
      .FDateTime) = ACurrentDate))
  end;
...
begin
  ...
  ACurrentFocusedCellDate :=
    Int((FocusedCell as TcxSchedulerAgendaViewEventCellViewInfo).FDateTime);
  if (AIndex + 1 < ViewInfo.InfoCells.Count) and
    CanBeNewFocusedEventCell(AIndex + 1, ACurrentFocusedCellDate) then
    Result := TcxSchedulerAgendaViewEventCellViewInfo
      (ViewInfo.InfoCell[AIndex + 1])
  else if (AIndex > 0) and CanBeNewFocusedEventCell(AIndex - 1,
    ACurrentFocusedCellDate) then
    Result := TcxSchedulerAgendaViewEventCellViewInfo
      (ViewInfo.InfoCell[AIndex - 1]);
end;

function TcxSchedulerAgendaViewController.GetFreeDayCell(ADate: TDate)
  : TcxSchedulerAgendaViewFreeDayCellViewInfo;
var
  I: Integer;
begin
...
function TcxSchedulerAgendaViewController.GetViewInfo
  : TcxSchedulerAgendaViewViewInfo;
begin
  Result := AgendaView.ViewInfo;
end;

procedure TcxSchedulerAgendaViewController.GotoNextPage(AForward,
  AMostFinal: Boolean; AShift: TShiftState);
var
...
begin
  ...
  else if not(ssShift in AShift) then
    SelectCell(ANewIndex, [], True);
  ViewInfo.MakeFocusedCellVisible;
end;

procedure TcxSchedulerAgendaViewController.InitTimer(AllowStart: Boolean;
  AScrollCode: TScrollCode);
begin
...
function TcxSchedulerAgendaViewController.IsSelected
  (ACell: TcxSchedulerCustomViewInfoItem): Boolean;
begin
  Result := False;
  if ACell <> nil then
...
procedure TcxSchedulerAgendaViewController.KeyDown(var Key: Word;
  Shift: TShiftState);
var
...
begin
  ...
  if APrevVScrollPos <> TcxCustomSchedulerAccess(Scheduler).VScrollBar.Position
  then
    TcxCustomSchedulerAccess(Scheduler).ShowTouchScrollUI(Scheduler, True);
end;

procedure TcxSchedulerAgendaViewController.MouseDown(Button: TMouseButton;
  ...
  procedure PrepareSelectionInfo(var AOldFocusedCellIndex, ANewFocusedCellIndex
    : Integer; var AIsFreeDay, ANeedUnselect: Boolean);
  begin
    AOldFocusedCellIndex := GetFocusedCellIndex;
    if IsRightClickOnContent then
    begin
      if FreeDaysSelection.IndexOf(ViewInfo.GetCellDate(HitTest.ContentCell)) < 0
      then
      begin
  ...
  procedure ApplySelectionInfo(const AOldFocusedCellIndex, ANewFocusedCellIndex
    : Integer; const ADate: TDateTime; const AIsFreeDay: Boolean;
    const ANeedUnselect: Boolean);
  begin
    if IsRightClickOnContent then
      SelectFreeDayCell(ADate, [ssShift], True)
    else if (ssShift in Shift) and (AOldFocusedCellIndex >= 0) then
    begin
      FIsTopDayCanBeChangedInsideOfScrolling := True;
      try
        if ViewInfo.InfoCell[ANewFocusedCellIndex] is TcxSchedulerAgendaViewEventCellViewInfo
        then
  ...
  procedure ExpandSelectionRange(var AStart, AFinish: Integer;
  ...
  begin
    ...
    begin
      ...
      AFinish := Max(AFinish,
        Trunc(FreeDaysSelection[FreeDaysSelection.Count - 1]));
    end;
    ...
    try
      ...
      try
        ...
        TcxCustomSchedulerAccess(Scheduler).ReplaceSelParams(AStart, AFinish,
...
begin
  ...
  begin
    ...
    else if EventSelection.Count > 0 then
      CheckSelectionParams(Trunc(EventSelection[0].Start));
    ADate := HitTest.Time;
    ANeedUpdate := (FFocusedCell is TcxSchedulerAgendaViewFreeDayCellViewInfo)
      and (FreeDaysSelection.Count = 1) and
      (TcxCustomSchedulerAccess(Scheduler).EventList.Selection.Count = 0) and
      (ADate = TcxSchedulerAgendaViewFreeDayCellViewInfo(FFocusedCell)
      .DateTime);
  end
  else
  begin
    ...
    begin
      AIsInfoCell := True;
      PrepareSelectionInfo(AOldFocusedCellIndex, ANewFocusedCellIndex,
        AIsFreeDay, ANeedUnselect);
    end;
    StoreFocusedCellDateAsActualPeriodForEventInitialize(ADate);
    ViewInfo.FTopScrollPos := ViewInfo.GetTopScrollPosPreliminaryValue
      (FFocusedCell);
  end;
  ...
  if AIsInfoCell then
  begin
    ApplySelectionInfo(AOldFocusedCellIndex, ANewFocusedCellIndex, ADate,
      AIsFreeDay, ANeedUnselect);
    if AIsFreeDay then
...
begin
  ...
  for I := 0 to ViewInfo.Events.Clones.Count - 1 do
    FDragEventStoredSelection.Add(TcxSchedulerControlEventID.Create
      (TcxSchedulerEvent(ViewInfo.Events.Clones[I])));
end;

procedure TcxSchedulerAgendaViewController.
  RestoreEventSelectionFromDragEventStoredSelection;
var
  I: Integer;
begin
  EventSelection.Clear;
  for I := 0 to FDragEventStoredSelection.Count - 1 do
    TcxSchedulerEventSelectionAccess(EventSelection)
      .FKeys.Add(TcxSchedulerControlEventIDAccess.Create
      (FDragEventStoredSelection[I] as TcxSchedulerControlEventID));
  EventSelection.Update;
end;

procedure TcxSchedulerAgendaViewController.ProcessDeletedEvent
  (AEvent: TcxSchedulerControlEvent);
var
  AFocusedEventCell, ANewFocusedEventCell
    : TcxSchedulerAgendaViewEventCellViewInfo;
begin
  FEventDeletingInProcess := True;
  if (FocusedCell <> nil) and
    (FocusedCell is TcxSchedulerAgendaViewEventCellViewInfo) and
  ...
  begin
    ...
    begin
      ...
      FStoredFocusedEventKey := TcxSchedulerControlEventID.Create
        (ANewFocusedEventCell.Event);
    end
  end;
end;
...
procedure TcxSchedulerAgendaViewController.SelectFreeDayCell(ADate: TDate;
  AShift: TShiftState; ANeedRefresh: Boolean);
begin
  SelectCell(GetFreeDayCell(ADate), AShift, ANeedRefresh);
end;

procedure TcxSchedulerAgendaViewController.SelectCell
  (ACell: TcxSchedulerCustomViewInfoItem; AShift: TShiftState;
  ANeedRefresh: Boolean);
var
  ADate: TDate;
begin
  ...
  begin
    ...
    if not(ssCtrl in AShift) then
      TcxCustomSchedulerAccess(Scheduler).EventList.Selection.Add
        (TcxSchedulerAgendaViewEventCellViewInfo(ACell).Event, AShift);
  end
  else
  begin
...
procedure TcxSchedulerAgendaViewController.SelectCell(AIndex: Integer;
  AShift: TShiftState; ANeedRefresh: Boolean);
begin
  SelectCell(ViewInfo.InfoCell[AIndex], AShift, ANeedRefresh);
end;

function TcxSchedulerAgendaViewController.NeedUnselectStartCell
  (const AStartIndex, AEndIndex: Integer): Boolean;
var
...
begin
  ...
  begin
    ...
    if Int(AEndEvent.Start) < Int(AEndEvent.Finish) then
      while ((AStartIndex <= AEndIndex) and (I - 1 >= 0)) or
        ((AStartIndex > AEndIndex) and (I + 1 < ViewInfo.InfoCells.Count)) do
      begin
        ACell := ViewInfo.InfoCell[I];
        if not IsSelected(ACell) then
          Break;
        if (ACell is TcxSchedulerAgendaViewEventCellViewInfo) and
          (TcxSchedulerAgendaViewEventCellViewInfo(ACell).Event = AEndEvent)
        then
          Result := False;
        if not Result then
          Break;
...
procedure TcxSchedulerAgendaViewController.SelectCells(AStartIndex,
  AEndIndex: Integer; const ANeedUnselectByMouse: Boolean);
var
  AIndex: Integer;
  ANeedUnselect: Boolean;
  ACell: TcxSchedulerCustomViewInfoItem;
begin
  ANeedUnselect := ANeedUnselectByMouse or NeedUnselectStartCell(AStartIndex,
    AEndIndex);
  AIndex := AStartIndex;
  repeat
    ...
    else if IsSelected(ACell) then
      DoSwitchCellSelection(ACell);

    Inc(AIndex, Direction[AStartIndex <= AEndIndex]);
  until ((AStartIndex <= AEndIndex) and (AIndex > AEndIndex)) or
    ((AStartIndex >= AEndIndex) and (AIndex < AEndIndex));
  AgendaView.Refresh;
end;

procedure TcxSchedulerAgendaViewController.DoSwitchCellSelection
  (ACell: TcxSchedulerCustomViewInfoItem);
var
  ADate: TDateTime;
  AIndex: Integer;
begin
  if ACell = nil then
    Exit;
  if ACell is TcxSchedulerAgendaViewEventCellViewInfo then
    EventSelection.Add(TcxSchedulerAgendaViewEventCellViewInfo(ACell)
      .Event, [ssCtrl])
  else
  begin
...
procedure TcxSchedulerAgendaViewController.SwitchCellSelection
  (ACell: TcxSchedulerCustomViewInfoItem);
begin
  DoSwitchCellSelection(ACell);
  AgendaView.Refresh;
...
begin
  ...
  else if ViewInfo.InfoCells.Count = 0 then
    SetCellAsFocused(nil)
  else
  begin
    FocusedCell := ViewInfo.InfoCell
      [ViewInfo.InfoCells.IndexOf(GetFirstInfoCell
      (ViewInfo.TopVisibleDayHeader))];
    SwitchCellSelection(FocusedCell);
  end;
end;

procedure TcxSchedulerAgendaViewController.SelectTopInfoCell
  (ANeedRefresh: Boolean);
var
  ACell: TcxSchedulerCustomViewInfoItem;
begin
...
procedure TcxSchedulerAgendaViewController.SelectNextCell(AForward: Boolean;
  AShift: TShiftState);
  ...
  procedure CheckCellsIndexes(ACell, ANewCell: TcxSchedulerCustomViewInfoItem;
    var AIndex, ANewIndex: Integer);
  var
    I: Integer;
...
begin
  ...
  begin
    ...
    if AIndex = -1 then
    begin
      AIndex := ViewInfo.InfoCells.IndexOf
        (GetFirstInfoCell(ViewInfo.TopVisibleDayHeader));
    ...
    begin
      ...
      else if (ssShift in AShift) and (AIndex >= 0) and (ANewIndex >= 0) and
        NeedUnselectStartCell(AIndex, ANewIndex) then
        DoSwitchCellSelection(ViewInfo.InfoCell[AIndex]);
      SelectCell(FocusedCell, AShift, True);
    end
    else if ANeedSelectCurrentCell then
      SelectCell(ViewInfo.InfoCell[AIndex], AShift, True);
  end;
end;

procedure TcxSchedulerAgendaViewController.SetCellAsFocused
  (ACell: TcxSchedulerCustomViewInfoItem);
begin
  FFocusedCell := ACell;
...
procedure TcxSchedulerAgendaViewController.SetFocusedCell
  (ACell: TcxSchedulerCustomViewInfoItem);
begin
...
procedure TcxSchedulerAgendaViewController.SilentAddEventSelection
  (AEvent: TcxSchedulerEvent);
begin
  if AEvent = nil then
    Exit;
  TcxSchedulerEventSelectionAccess(EventSelection)
    .FKeys.Add(TcxSchedulerEventSelectionAccess(EventSelection)
    .CreateItem(AEvent));
  EventSelection.Update;
end;

procedure TcxSchedulerAgendaViewController.StartDrag(var DragObject
  : TDragObject);
begin
...
begin
  ...
  begin
    ...
    if FFocusedCell is TcxSchedulerAgendaViewEventCellViewInfo then
      FStoredFocusedEventKey := TcxSchedulerControlEventID.Create
        (TcxSchedulerAgendaViewEventCellViewInfo(FFocusedCell).Event);
  end;
end;

procedure TcxSchedulerAgendaViewController.
  StoreFocusedCellDateAsActualPeriodForEventInitialize(var ADate: TDateTime);
begin
  ...
  TcxCustomSchedulerAccess(Scheduler).ReplaceSelParams(ADate, ADate,
    Scheduler.SelResource);
end;
...
begin
  if not IsSelected(FocusedCell) then
    ClearSelection
  else if (FreeDaysSelection.Count + EventSelection.Count) > 1 then
  begin
    FreeDaysSelection.Clear;
    EventSelection.Clear;
    if FocusedCell is TcxSchedulerAgendaViewEventCellViewInfo then
      SilentAddEventSelection(TcxSchedulerAgendaViewEventCellViewInfo
        (FocusedCell).Event)
    else
      FreeDaysSelection.Add(TcxSchedulerAgendaViewFreeDayCellViewInfo
        (FocusedCell).DateTime);
  end;
  AgendaView.Refresh;
end;
...
procedure TcxAgendaViewDragEventHelper.DragOver(const P: TPoint;
...
function TcxAgendaViewDragEventHelper.GetAgendaViewInfo
  : TcxSchedulerAgendaViewViewInfo;
begin
  Result := Controller.ViewInfo;
end;

function TcxAgendaViewDragEventHelper.GetController
  : TcxSchedulerAgendaViewController;
begin
...
begin
  ...
  if not Result and not IsAtOrigin and (HitTest.HitAtDayHeader or HitAtEvent)
  then
  begin
...
begin
  Result := InRange(HitTest.HitY, HitTest.FHitObjectBounds.Top,
    (HitTest.FHitObjectBounds.Top + HitTest.FHitObjectBounds.Bottom) div 2);
end;
...
procedure TcxAgendaViewDragEventHelper.ExtractCellStartAndFinish
  (ACell: TcxSchedulerCustomViewInfoItem; const AIsNext: Boolean;
...
function TcxAgendaViewDragEventHelper.GetNextCell
...
begin
  ...
  if (Result <> nil) and ((Result is TcxSchedulerAgendaViewEventCellViewInfo)
    and (TcxSchedulerAgendaViewEventCellViewInfo(Result).DayHeader <>
    AEventCell.DayHeader)) then
    Result := TcxSchedulerAgendaViewEventCellViewInfo(Result).DayHeader;
  ExtractCellStartAndFinish(Result, True, AStart, AFinish);
end;

function TcxAgendaViewDragEventHelper.GetPriorCell
  (ACell: TcxSchedulerCustomViewInfoItem; var AStart, AFinish: TDateTime)
  : TcxSchedulerCustomViewInfoItem;
var
  AIndex: Integer;
begin
  ...
  begin
    AIndex := AgendaViewInfo.InfoCells.IndexOf
      (Controller.GetFirstInfoCell
      (TcxSchedulerAgendaViewDayHeaderCellViewInfo(ACell)));
    if AIndex > 0 then
      Result := AgendaViewInfo.InfoCell[AIndex - 1];
  end
  else
  begin
    ...
    begin
      Result := AgendaViewInfo.InfoCell[AIndex - 1];
      if Result.Bounds.Bottom <
        (ACell as TcxSchedulerAgendaViewEventCellViewInfo).DayHeader.Bounds.Bottom
      then
...
function TcxAgendaViewDragEventHelper.GetDragEventCellDestinationTime
  : TDateTime;
var
...
begin
  ...
  begin
    if (AgendaViewInfo.InfoCells.Count > 0) then
      if (AgendaViewInfo.InfoCells[AgendaViewInfo.InfoCells.Count - 1]
        is TcxSchedulerAgendaViewEventCellViewInfo) then
      begin
        AEventCell := TcxSchedulerAgendaViewEventCellViewInfo
          (AgendaViewInfo.InfoCells[AgendaViewInfo.InfoCells.Count - 1]);
        ...
        FNeedDockToNextCell := AgendaViewInfo.InfoCells
          [AgendaViewInfo.InfoCells.Count - 1]
          is TcxSchedulerAgendaViewFreeDayCellViewInfo;
    Exit;
  end;
  ...
  begin
    FNeedDockToNextCell :=
      HitTest.FHitObject is TcxSchedulerAgendaViewFreeDayCellViewInfo;
    Exit;
  end;

  if (HitTest.FHitObject is TcxSchedulerAgendaViewEventCellViewInfo) and
    TcxSchedulerAgendaViewEventCellViewInfo(HitTest.FHitObject).Event.IsAllDayOrLonger
  then
  begin
    ...
    begin
      ...
      while (ANextCell is TcxSchedulerAgendaViewEventCellViewInfo) and
        TcxSchedulerAgendaViewEventCellViewInfo(ANextCell)
        .Event.IsAllDayOrLonger and (ACellStart = Int(Result)) do
      begin
        AEventCell := TcxSchedulerAgendaViewEventCellViewInfo(ANextCell);
        ANextCell := GetNextCell(AEventCell, ACellStart, ACellFinish);
      end;
      if (ANextCell = nil) or
        (ANextCell is TcxSchedulerAgendaViewDayHeaderCellViewInfo) or
        (ANextCell is TcxSchedulerAgendaViewFreeDayCellViewInfo) then
        Result := Int(Result)
      else
        Result := Max(Result, ACellStart - DragEvent.Duration);
      FNeedDockToNextCell :=
        (ANextCell is TcxSchedulerAgendaViewEventCellViewInfo) and
        (AEventCell.ActualStart = Int(TcxSchedulerAgendaViewEventCellViewInfo
        (ANextCell).ActualStart));
    end;
    Exit;
  end;
  ...
  if AIsTopHalf then
  begin
    APriorCell := GetPriorCell
      (HitTest.FHitObject as TcxSchedulerCustomViewInfoItem, ACellStart,
      ACellFinish);
  ...
  begin
    ...
    ANextCell := GetNextCell
      (HitTest.FHitObject as TcxSchedulerAgendaViewEventCellViewInfo,
      ACellStart, ACellFinish);
    if (ANextCell = nil) or
      (ANextCell is TcxSchedulerAgendaViewDayHeaderCellViewInfo) then
    begin
      ANextDate := Int(AEventCell.EventStart) + 1;
      if Result > ANextDate then
        Result := Min(IncMinute(AEventCell.EventStart, 1),
          IncMinute(ANextDate, -1));
    end
    else
    begin
      if Result > ACellStart then
...
begin
  ...
  begin
    FDayHeaderOrientation := TcxSchedulerAgendaView(Source)
      .DayHeaderOrientation;
...
function TcxSchedulerAgendaView.
...
function TcxSchedulerAgendaView.CreateController
...
begin
  ...
  if ACell <> nil then
    if ACell is TcxSchedulerAgendaViewFreeDayCellViewInfo then
      Result := TcxSchedulerAgendaViewFreeDayCellViewInfo(ACell)
        .DayHeader.DateTime
    else
...
procedure TcxSchedulerAgendaView.InitEventBySelectedTime
...
begin
  ...
  SetScrollBarInfo(GetScrollBarKind, AMin, AMax, 1, ViewInfo.VertScrollPage,
    ViewInfo.TopScrollPos, True, True);
end;
...
procedure TcxSchedulerAgendaView.MakeEventVisible
...
function TcxSchedulerAgendaView.GetNextDayWithEvents(AStart: TDate;
  const AForward: Boolean): TDate;
var
  AIndex: Integer;
...
begin
  Result := AStart;
  AEventDays := TcxSchedulerCustomDateNavigatorAccess(Scheduler.DateNavigator)
    .EventDays;
...
procedure TcxSchedulerAgendaView.Scroll(AScrollBarKind: TScrollBarKind;
...
begin
  ...
  if FIsTrackingScroll and (AScrollCode = scPosition) and
    (DisplayMode = avmAllDays) then
  begin
    FIsTrackingScroll := AScrollCode = scTrack;
    DoAutoSelectTopDay(TcxSchedulerAgendaViewViewInfo(ViewInfo)
      .TopVisibleDayHeader.DateTime);
  end
  else
  begin
    FIsTrackingScroll := AScrollCode = scTrack;
...
procedure TcxSchedulerAgendaView.SetDayHeaderOrientation
  (AValue: TcxSchedulerAgendaViewDayHeaderOrientation);
begin
...
procedure TcxSchedulerAgendaView.SetDisplayMode
  (AValue: TcxSchedulerAgendaViewDisplayMode);
begin
...
begin
  ...
  try
    ...
    TcxSchedulerCustomDateNavigatorAccess(Scheduler.DateNavigator)
...
procedure TcxSchedulerAgendaView.DoBeforeReallyDeleting
  (AEvent: TcxSchedulerControlEvent);
begin
  Controller.ProcessDeletedEvent(AEvent);
end;

procedure TcxSchedulerAgendaView.GetRangeControlRange(out AMin,
  AMax: TDateTime);
begin
  if DisplayMode <> avmAllDays then
  begin
...
procedure TcxSchedulerAgendaViewHitTest.StoreHitEventCellParameters
  (AEventCell: TcxSchedulerAgendaViewEventCellViewInfo);
begin
...
const
  AViewParams: TcxViewParams = (Bitmap: nil; Color: clWhite; Font: nil;
    TextColor: clDefault);
begin
...
function TcxSchedulerAgendaViewPainter.GetViewInfo
  : TcxSchedulerAgendaViewViewInfo;
begin
  Result := TcxSchedulerAgendaViewViewInfo(inherited ViewInfo);
end;
...
constructor TcxSchedulerAgendaViewDayHeaderCellViewInfo.Create
...
procedure TcxSchedulerAgendaViewDayHeaderCellViewInfo.Calculate
  (const AText: string);
const
...
begin
  ...
  ANeedShiftYearCaption := CanDrawYearTextOnTheRight and
  ...
  AMax := Max(Bounds.Top + AgendaViewInfo.DayHeaderDefaultHeight,
    FTextRect.Bottom + 2 * ScaleFactor.Apply(dxDPITextOffset));
  FVerticalDayHeaderDayNumberRect := cxNullRect;
  if Orientation = dhoVertical then
  begin
    AlignVert := vaTop;
    FTextRect := cxRectOffset(cxRectInflate(FTextRect,
      -ScaleFactor.Apply(dxDPITextOffset), 0), 0,
      ScaleFactor.Apply(dxDPIDoubleTextOffset));
    FYearTextRect := TextRect;
    FTextRect.Bottom := FTextRect.Top +
      AgendaViewInfo.FVerticalDayHeaderTextHeight;
    FTextRect.Right := FTextRect.Left +
      AgendaViewInfo.FVerticalDayHeaderDayNumberWidth;
    FTextRect := cxRectOffsetVert(FTextRect, FBounds.Top - FTextRect.Top);
    FYearTextRect.Left := FTextRect.Right + ScaleFactor.Apply
      (dxDPITripleTextOffset);
    FYearTextRect.Right := FYearTextRect.Left +
      AgendaViewInfo.FVerticalDayHeaderYearCaptionWidth;
    FDayNameRect := cxRectOffsetVert(FYearTextRect,
      AgendaViewInfo.DayHeaderLineHeight + ScaleFactor.Apply(dxDPITextOffset));
    AMax := Max(Bounds.Top + AgendaViewInfo.DayHeaderDefaultHeight,
      Max(FTextRect.Bottom, FDayNameRect.Bottom) +
      ScaleFactor.Apply(dxDPITextOffset));

    FVerticalDayHeaderDayNumberRect := TextRect;
    if Length(FDayNum) < 2 then
      Inc(FVerticalDayHeaderDayNumberRect.Left,
        AgendaViewInfo.FDayHeaderDigitWidth);
  ...
  begin
    ...
    FYearTextRect.Left := FYearTextRect.Right -
      AgendaViewInfo.FHorizontalDayHeaderYearTextWidth;
    if ANeedShiftYearCaption then
      Dec(FYearTextRect.Left, AgendaViewInfo.FDayHeaderDigitWidth div 2);
  end
end;

function TcxSchedulerAgendaViewDayHeaderCellViewInfo.
  CanDrawYearTextOnTheRight: Boolean;
begin
  Result := (Orientation = dhoHorizontal) and
    (cxTextWidth(AgendaViewInfo.GetCurrentFont, FDisplayText) <
    cxRectWidth(TextRect));
end;

function TcxSchedulerAgendaViewDayHeaderCellViewInfo.ConvertDateToDisplayText
  (AType: Integer = 0): Integer;

  function InternalExtractMonth(const ADayAsStr: string): string;
  begin
    Result := ADayAsStr;
    Delete(Result, Pos(AnsiUpperCase(FDayName), AnsiUpperCase(Result)),
      Length(FDayName));
...
begin
  ...
  if Bounds.Top < 0 then
    ...
    begin
      DY := -FBounds.Top;
      if FDayNameRect.Bottom + ScaleFactor.Apply(dxDPITripleTextOffset) + DY >
        FBounds.Bottom then
        DY := FBounds.Bottom - FDayNameRect.Bottom -
          ScaleFactor.Apply(dxDPITripleTextOffset);
...
procedure TcxSchedulerAgendaViewDayHeaderCellViewInfo.
  CorrectBoundsForVerticalOrientation(ACurrentDayLastCell
  : TcxSchedulerCustomViewInfoItem);
begin
  ...
  begin
    ...
    TcxSchedulerCustomViewInfoItemAccess(ACurrentDayLastCell).FBounds.Bottom :=
      FBounds.Bottom;
  end;
  StoreRealAreas;
end;

procedure TcxSchedulerAgendaViewDayHeaderCellViewInfo.DrawCaption
  ...
  try
    ...
    begin
      ...
      try
        ...
        Canvas.DrawTexT(DisplayText, FVerticalDayHeaderDayNumberRect,
          GetTextOutcxFlags);
      finally
    ...
    if (Orientation = dhoVertical) or ACanDrawYearTextOnTheRight then
      Canvas.DrawTexT(FYearText, FYearTextRect,
        MakeTextOutcxFlags(AAlignHorz[UseRightToLeftAlignment],
        AAlignVert[Orientation = dhoHorizontal], AutoHeight));
    if Orientation = dhoVertical then
      Canvas.DrawTexT(FDayName, FDayNameRect,
        MakeTextOutcxFlags(AAlignHorz[UseRightToLeftAlignment], vaTop,
        AutoHeight));
  finally
...
procedure TcxSchedulerAgendaViewDayHeaderCellViewInfo.DoRightToLeftConversion
...
begin
  ...
  DoRightToLeftConversionWithChecking(FVerticalDayHeaderDayNumberRect,
    AClientBounds);
  ...
  DoRightToLeftConversionWithChecking(FRealVerticalDayHeaderDayNumberRect,
    AClientBounds);
end;

procedure TcxSchedulerAgendaViewDayHeaderCellViewInfo.DoScroll(const DX,
  DY: Integer);
begin
...
function TcxSchedulerAgendaViewDayHeaderCellViewInfo.GetOrientation
  : TcxSchedulerAgendaViewDayHeaderOrientation;
begin
  Result := AgendaViewInfo.DayHeaderOrientation;
end;

class function TcxSchedulerAgendaViewDayHeaderCellViewInfo.GetLongDayName
  (const ADayNum: Integer): string;
begin
  Result := dxFormatSettings.LongDayNames[ADayNum];
end;

procedure TcxSchedulerAgendaViewDayHeaderCellViewInfo.Scroll(const DX,
  DY: Integer);
begin
  RestoreRealAreas;
  DoScroll(DX, DY);
...
begin
  ...
  try
    ...
    DrawRect(Bounds, Borders,
      AgendaView.LookAndFeelPainter.DefaultGridLineColor);
    if Focused then
      ExternalPainter.DrawCellFocus(Self,
        AgendaViewInfo.GetEventCellTextColor(Selected));
    DrawCaption;
  finally
    Canvas.RestoreClipRegion;
  end;
...
procedure TcxSchedulerAgendaViewFreeDayCellViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited DoRightToLeftConversion(AClientBounds);
...
const
  AHorizontalAlignment: array [Boolean] of Cardinal = (cxAlignLeft,
    cxAlignRight);
begin
  Canvas.IntersectClipRect(FCaptionRect);
  Canvas.Font.Color := FViewParams.TextColor;
  Canvas.DrawTexT(FCaption, FCaptionRect,
    AHorizontalAlignment[UseRightToLeftAlignment] or cxAlignVCenter or
    cxShowEndEllipsis);
end;

function TcxSchedulerAgendaViewFreeDayCellViewInfo.GetAgendaView
  : TcxSchedulerAgendaView;
begin
  Result := DayHeader.AgendaViewInfo.AgendaView;
end;

function TcxSchedulerAgendaViewFreeDayCellViewInfo.GetAgendaViewInfo
  : TcxSchedulerAgendaViewViewInfo;
begin
...
procedure TcxSchedulerAgendaViewFreeDayCellViewInfo.InitializeDayHeader
  (ADayHeader: TcxSchedulerAgendaViewDayHeaderCellViewInfo);
begin
...
procedure TcxSchedulerAgendaViewFreeDayCellViewInfo.Scroll(const DX,
  DY: Integer);
begin
  OffsetRect(FBounds, DX, DY);
...
procedure TcxSchedulerAgendaViewAdapter.GetPageResources
...
begin
  FEventTimeRect := cxRectSetTop(AgendaViewInfo.EventCellStateRectPattern,
    Bounds.Top);
...
begin
  FLabelRect := cxRectOffsetVert(AgendaViewInfo.EventCellLabelRectPattern,
    FContentTop);
end;
...
begin
  ...
  if AgendaView.ShowLocations then
    FLocationRect := cxRectSetTop(AgendaViewInfo.EventCellLocationRectPattern,
      FContentTop);
end;
...
begin
  FCaptionRect := cxRectSetTop(AgendaViewInfo.EventCellCaptionRectPattern,
    FContentTop);
  CalculateLocationRect;
  FResourceText := CreateResourceText;
  if AgendaView.ShowResources then
    FResourceRect := cxRectSetTop(AgendaViewInfo.EventCellResourceRectPattern,
      FContentTop);
  if FShowMessage then
  begin
    AOffsetVert := ScaleFactor.Apply(dxDPIEventCellContentVerticalOffset);
    FMessageRect := cxRectSetTop(FCaptionRect,
      FCaptionRect.Top + GetCaptionHeight + AOffsetVert, 1);
    InitializeEditViewInfo(FMessageRect);
  end;
  if Images.Count > 0 then
  begin
    AOffsetHorz := ScaleFactor.Apply(dxDPITripleTextOffset);
    AOffsetVert := FLabelRect.Top - Bounds.Top -
      ScaleFactor.Apply(dxDPITextOffset);
    AImagesWidth := TcxSchedulerEventImagesAccess(Images)
      .Calculate(InternalGetImagesBounds);
    TcxSchedulerEventImagesAccess(Images)
      .Offset(FCaptionRect.Left - Bounds.Left, AOffsetVert);
    Inc(FCaptionRect.Left, AImagesWidth + AOffsetHorz);
  end;
end;

procedure TcxSchedulerAgendaViewEventCellViewInfo.CalculateActualEditRect
...
procedure TcxSchedulerAgendaViewEventCellViewInfo.InitializeEditViewInfo
  ...
  case FTimeAreaArrows of
    ...
    if Event.AllDayEvent then
      ...
      FStartText := Format(cxGetResourceString(@secxTimeRange),
        [DateTimeHelper.TimeToStr(Event.Start),
        DateTimeHelper.TimeToStr(Event.Finish)]);
  end;
end;
...
begin
  ...
  FTimeAreaRect := cxRectSetTop(AgendaViewInfo.EventCellTimeAreaPattern,
    FContentTop);
  if ViewData.ShowTimeAsClock then
...
begin
  ...
  ASizeStart := ScaleFactor.Apply
    (TcxSchedulerPainterHelper.GetStartContinueArrowSize);
  ASizeEnd := ScaleFactor.Apply
    (TcxSchedulerPainterHelper.GetEndContinueArrowSize);
  case FTimeAreaArrows of
    avtaNone:
      begin
        FStartRect := cxRectSetSize(FTimeAreaRect, AClockSize);
        FFinishRect := cxRectOffset(FStartRect,
          FStartRect.Right - FStartRect.Left + 2 *
    ...
    avtaContinueArrowStart:
      begin
        ...
        FFinishRect := cxRectOffset(cxRectSetSize(FTimeAreaRect, AClockSize),
          FStartContinueArrowRect.Right - FStartContinueArrowRect.Left + 2 *
          ScaleFactor.Apply(cxTextOffset), 0);
        cxRectCenterVerticallyRelativelyOfArea(FStartContinueArrowRect,
          FTimeAreaRect);
      end;
    ...
    avtaContinueArrowEnd:
      begin
        FStartRect := cxRectSetSize(FTimeAreaRect, AClockSize);
        FEndContinueArrowRect :=
          cxRectOffset(cxRectSetSize(FStartRect, ASizeEnd),
          FStartRect.Right - FStartRect.Left + 2 *
          ScaleFactor.Apply(cxTextOffset), 0);
        cxRectCenterVerticallyRelativelyOfArea(FStartRect, FTimeAreaRect);
        cxRectCenterVerticallyRelativelyOfArea(FEndContinueArrowRect,
          FTimeAreaRect);
      end
  ...
  case FTimeAreaArrows of
    avtaContinueArrowsBoth:
      begin
        ...
        FTimeTextRect.Left := FStartContinueArrowRect.Right + 2 *
          ScaleFactor.Apply(cxTextOffset);
        FTimeTextRect.Right := FTimeTextRect.Left +
          AgendaViewInfo.AllDayCaptionWidth;
        FEndContinueArrowRect := cxRectSetHeight(cxRectSetWidth(FTimeTextRect,
          FTimeTextRect.Right, ASizeEnd.cx), ASizeEnd.cy);
        cxRectCenterVerticallyRelativelyOfArea(FStartContinueArrowRect,
          FTimeAreaRect);
        cxRectCenterVerticallyRelativelyOfArea(FEndContinueArrowRect,
          FTimeAreaRect);
    ...
    avtaContinueArrowStart:
      begin
        FStartContinueArrowRect := cxRectSetSize(FTimeTextRect, ASizeStart);
        FTimeTextRect := cxRectSetWidth(FTimeTextRect,
          FStartContinueArrowRect.Right + ScaleFactor.Apply(dxDPITextOffset),
          cxTextWidth(Canvas.Font, FStartText) +
          ScaleFactor.Apply(dxDPITextOffset));
        cxRectCenterVerticallyRelativelyOfArea(FStartContinueArrowRect,
          FTimeAreaRect);
      end;
...
function TcxSchedulerAgendaViewEventCellViewInfo.CreateResourceText: string;
  ...
  begin
    ...
    begin
      ...
      if (VarCompare(AInfo.ResourceItem.ResourceID, AResourceID) = 0) and
        AInfo.ResourceItem.Visible then
      begin
...
begin
  FContentTop := Bounds.Top + ScaleFactor.Apply
    (dxDPIEventCellContentVerticalOffset);
  CalculateTimeArea;
  CalculateLabelRect;
...
begin
  ...
  begin
    R := CaptionRect;
    R.Bottom := R.Bottom + ScaleFactor.Apply
      (dxDPIEventCellContentVerticalOffset);
  end;
  if not cxRectIsNull(R) then
    dH := R.Bottom - Bounds.Bottom
  else if (AgendaView.DayHeaderOrientation = dhoVertical) and IsOnlyEventInDay
  then
    dH := cxRectHeight(DayHeader.Bounds) - cxRectHeight(Bounds);
...
begin
  ...
  if Event.AllDayEvent or ((Event.Start = FDateTime) and
    (Event.Finish = FDateTime + 1)) then
    Exit;
...
procedure TcxSchedulerAgendaViewEventCellViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited DoRightToLeftConversion(AClientBounds);
    ...
    try
      ...
      begin
        ...
        try
          ...
          cxAlphaBlend(ABitmap, cxRectOffset(ABounds, -ABounds.Left,
            -ABounds.Top), ColorToRgb(clWhite), 128);
...
begin
  if AgendaView.ShowLocations and (Event.Location <> '') and
    (cxRectWidth(LocationRect) > 0) then
    cxTextOut(Canvas.Canvas, Event.Location, FLocationRect,
      AHorizontalAlignment[UseRightToLeftAlignment] or CXTO_TOP or
      CXTO_SINGLELINE or CXTO_END_ELLIPSIS, 0, 0, Canvas.Font, clNone, clNone,
...
begin
  ...
  begin
    ...
    begin
      ...
      if (AStyle <> nil) and (cxStyles.svTextColor in AStyle.AssignedValues) and
        (AStyle.TextColor <> clDefault) then
...
begin
  PainterHelper.DrawState(Canvas, FEventTimeRect, Event.State,
    [bLeft, bRight], clNone);
end;
...
begin
  ...
  begin
    ...
    if FTimeAreaArrows = avtaContinueArrowsBoth then
      AStart := 0;
    PainterHelper.DrawClock(Canvas, FStartRect, AStart, FViewParams,
      ScaleFactor)
  end;

  if FTimeAreaArrows in [avtaNone, avtaContinueArrowStart] then
    PainterHelper.DrawClock(Canvas, FFinishRect, Event.Finish - 1 / 24 / 60 /
      60, FViewParams, ScaleFactor);
end;
...
const
  AHorizontalAlignment: array [Boolean] of Cardinal = (cxAlignLeft,
    cxAlignRight);
begin
  DrawTexT(FTimeTextRect, FStartText,
    AHorizontalAlignment[UseRightToLeftAlignment] or cxAlignTop or
    cxSingleLine);
end;

function TcxSchedulerAgendaViewEventCellViewInfo.GetAgendaView
  : TcxSchedulerAgendaView;
begin
  Result := DayHeader.AgendaViewInfo.AgendaView;
end;

function TcxSchedulerAgendaViewEventCellViewInfo.GetAgendaViewInfo
  : TcxSchedulerAgendaViewViewInfo;
begin
  Result := DayHeader.AgendaViewInfo;
end;

function TcxSchedulerAgendaViewEventCellViewInfo.GetCaptionFontStyle
  : TFontStyles;
begin
  Result := inherited GetCaptionFontStyle + [fsBold];
end;

function TcxSchedulerAgendaViewEventCellViewInfo.
  GetDetailCaptionFlagValue: Boolean;
begin
  Result := FIsDetailInfo;
end;

function TcxSchedulerAgendaViewEventCellViewInfo.GetDetailInfoFlagValue
  : Boolean;
begin
...
const
  AHorizontalAlignment: array [Boolean] of Cardinal = (cxAlignLeft,
    cxAlignRight);
begin
  Result := AHorizontalAlignment[UseRightToLeftAlignment] or cxAlignTop or
    cxShowEndEllipsis;
end;
...
procedure TcxSchedulerAgendaViewEventCellViewInfo.InitHitTest
...
procedure TcxSchedulerAgendaViewEventCellViewInfo.InitializeServiceFields
  (ADayHeader: TcxSchedulerAgendaViewDayHeaderCellViewInfo;
  const AIsOnlyEventInDay: Boolean);
begin
  FDayHeader := ADayHeader;
...
procedure TcxSchedulerAgendaViewEventCellViewInfo.MeasureCaptionExtent
  (var R: TRect);
var
...
procedure TcxSchedulerAgendaViewEventCellViewInfo.OffsetRects(const DX,
  DY: Integer);
begin
...
function TcxSchedulerAgendaViewEventCellModernViewInfo.GetViewStyle
...
constructor TcxSchedulerAgendaViewViewInfo.Create
  (AOwner: TcxSchedulerSubControl);
begin
  inherited Create(AOwner);
...
function TcxSchedulerAgendaViewViewInfo.AddDayHeaderInfo(const ADate: TDateTime)
  : TcxSchedulerAgendaViewDayHeaderCellViewInfo;
begin
  CreateCellInstance(TcxSchedulerAgendaViewDayHeaderCellViewInfo,
    cxRectOffsetVert(FDayHeaderBoundsPattern, FNextTop),
...
var
  AIsSelected: Boolean;
begin
  CreateCellInstance(TcxSchedulerAgendaViewFreeDayCellViewInfo,
    cxRectOffsetVert(FFreeDayBoundsPattern, FNextTop),
...
function TcxSchedulerAgendaViewViewInfo.AddEventInfo
  (AEvent: TcxSchedulerControlEvent;
  ADayHeader: TcxSchedulerAgendaViewDayHeaderCellViewInfo;
  const AIsOnlyEventInDay, AInFreeDay: Boolean)
  : TcxSchedulerAgendaViewEventCellViewInfo;
  ...
  begin
    Result := AInFreeDay or ((AEvent.Source = Controller.DragEvent) and
      (DragEventHelper <> nil) and (Int(DragEventHelper.DestinationTime)
      = ADayHeader.DateTime) and DragEventHelper.NeedDockToNextCell);
  end;
...
begin
  ...
  begin
    ...
    AViewData := CreateEventViewData(AEvent, cxRectOffsetVert(ABounds,
      FNextTop), GetEventStart(AEvent, ADate), GetEventFinish(AEvent, ADate),
      nil, ADate);
    AViewData.AutoHeight := AgendaView.ShowMessages;
    AViewData.ViewParams.Color := LookAndFeelPainter.DefaultContentColor;
    AViewData.ViewParams.TextColor :=
      LookAndFeelPainter.DefaultContentTextColor;
    Result := CreateEventCellViewInfo(AViewData, False)
      as TcxSchedulerAgendaViewEventCellViewInfo;
  ...
  Result := AddEventCell(AViewData, False)
    as TcxSchedulerAgendaViewEventCellViewInfo;
  Result.InitializeServiceFields(ADayHeader, AIsOnlyEventInDay);
  if not Controller.InDraggingProcess then
    CheckAsNewFocusedCell(Result);
  if Controller.NavigationButtonClicked and (Result = Controller.FocusedCell)
    and (Events.Clones.Count = 0) then
...
begin
  ...
  begin
    Result := cxRectIntersect(EventCells[I].Bounds,
      TcxSchedulerAgendaViewEventCellViewInfo(EventCells[I])
      .ViewData.VisibleRect);
    if Result then
      Break;
  end;
end;

function TcxSchedulerAgendaViewViewInfo.AreThereEventsInVisibleInterval
  (AResourceIndex: Integer): Boolean;
begin
  Result := AreDisplayedAnyEvents;
end;

function cxCompareAgendaViewEvents(AEvent1,
...
begin
  inherited Calculate;
  if AgendaView.IsSelectedDaysChanged and (AgendaView.DisplayMode <> avmAllDays)
  then
    MakeFocusedCellVisible;
  AgendaView.ResetIsSelectedDaysChanged;
end;

procedure TcxSchedulerAgendaViewViewInfo.CalculateHitTest
  (AHitTest: TcxSchedulerCustomResourceViewHitTest);
begin
  inherited CalculateHitTest(AHitTest);
  if TcxSchedulerAgendaViewHitTest(AHitTest).Flags = 1 shl htcControl then
    TcxSchedulerAgendaViewHitTest(AHitTest).SetHitTime(htcTime,
      Controller.GetLastInfoCellTime);
end;
...
begin
  ...
  if DayHeaderOrientation = dhoVertical then
    FDayHeaderBoundsPattern.Right := FDayHeaderBoundsPattern.Left +
      FVerticalDayHeaderWidth;
end;
...
begin
  ...
  FFreeDayBoundsPattern.Bottom := FFreeDayBoundsPattern.Top +
    FreeDayDefaultHeight;
end;
...
begin
  ...
  AWidth := Max(TcxSchedulerPainterHelper.IconsWidth(ScaleFactor) * 3 +
    ScaleFactor.Apply(dxDPIFourfoldTextOffset),
    Max(cxTextWidth(StylesAdapter.GetEventParams(nil).Font,
    Format(cxGetResourceString(@secxTimeRange), [APattern, APattern])) +
    ScaleFactor.Apply(dxDPIDoubleTextOffset), AllDayCaptionWidth + ASize1.cx +
    ASize2.cx));
  ...
  FEventCellTimeAreaPattern.Bottom := FEventCellTimeAreaPattern.Top +
    FEventCellLineHeight;
end;
...
begin
  ...
  if ASize.cy < cxRectHeight(FEventCellTimeAreaPattern) then
    FEventCellLabelRectPattern.Top :=
      (FEventCellTimeAreaPattern.Top + FEventCellTimeAreaPattern.Bottom) div 2 -
      ASize.cy div 2;
...
begin
  AOffsetHorz := ScaleFactor.Apply(dxDPITripleTextOffset);
  FEventCellCaptionRectPattern := cxRectSetLeft(FEventCellBoundsPattern,
    EventCellLabelRectPattern.Right + AOffsetHorz * 2);
  ...
  begin
    ASmallWidth :=
      Max((FEventCellBoundsPattern.Right - FEventCellCaptionRectPattern.Left)
      div 5 - AOffsetHorz, 10);
    ABase := Max(FEventCellCaptionRectPattern.Left +
      AgendaView.EventTextMinWidth, FEventCellBoundsPattern.Right - 2 *
      (AOffsetHorz + ASmallWidth));
    ALeft2 := ABase + AOffsetHorz;
    ALeft3 := ALeft2 + ASmallWidth + AOffsetHorz;
    if AgendaView.ShowLocations then
    begin
      FEventCellLocationRectPattern := cxRectSetWidth(FEventCellBoundsPattern,
        ALeft2, ASmallWidth);
      ...
      FEventCellCaptionRectPattern.Right := FEventCellLocationRectPattern.Left -
        AOffsetHorz;
    end;
    if AgendaView.ShowResources then
    begin
      FEventCellResourceRectPattern := cxRectSetWidth(FEventCellBoundsPattern,
        ALeft3, ASmallWidth);
      ...
      if not AgendaView.ShowLocations then
        FEventCellCaptionRectPattern.Right := FEventCellResourceRectPattern.Left
          - AOffsetHorz;
    end;
  end;
end;
...
begin
  ...
  try
    ...
    begin
      ...
      ACount := AList.Count;
      if (ACount > 0) or ((Scheduler.Storage <> nil) and
        (AgendaView.DisplayMode <> avmSelectedNonEmptyDays)) then
      begin
        ...
        begin
          ...
          begin
            AEventCell := AddEventInfo(TcxSchedulerControlEvent(AList[J]),
              AHeader, AIsOnlyEventInDay, AIsFreeDay);
        ...
        if AIsVerticalDayHeaders then
          AHeader.FClipRect := AHeader.CalculateClipRect
            (AHeader.Bounds, Bounds);
      end;
    end;
  finally
    AList.Free;
...
begin
  ...
  try
    ...
    FFreeDayDefaultHeight := FEventCellLineHeight + 2 *
      ScaleFactor.Apply(cxTextOffset + dxDPIEventCellContentVerticalOffset);
    FAllDayCaptionWidth := cxTextWidth(AFont, cxGetResourceString(@secxAllDay))
      + ScaleFactor.Apply(dxDPIDoubleTextOffset);
...
procedure TcxSchedulerAgendaViewViewInfo.CalculateMetricsForVerticalDayHeader
  (AFont: TFont);
  ...
  begin
    ...
    for AMonth := 1 to 12 do
      Result := Max(Result, cxTextWidth(AFont, dxFormatSettings.LongMonthNames
        [MonthOf(EncodeDate(AYear, AMonth, 1))] + ', 2000'));
  end;
  ...
  begin
    ...
    for ADay := 1 to 7 do
      Result := Max(Result, cxTextWidth(AFont,
        TcxSchedulerAgendaViewDayHeaderCellViewInfo.GetLongDayName(ADay)));
  end;
...
begin
  ...
  FVerticalDayHeaderYearCaptionWidth := Max(AYearTextMaxLength,
    ADayNameMaxText);
  MeasureVerticalDayHeaderDayNumberFontSize(2 * FDayHeaderLineHeight +
    ScaleFactor.Apply(dxDPIQuintupleTextOffset), AFont);
  FVerticalDayHeaderTextHeight := cxTextHeight(AFont);
  FDayHeaderDigitWidth := cxTextWidth(AFont, '0');
  if AIsItalic then
    FVerticalDayHeaderDayNumberWidth := cxTextWidth(AFont, '000') -
      FDayHeaderDigitWidth div 2
  else
    FVerticalDayHeaderDayNumberWidth := cxTextWidth(AFont, '00');
  FVerticalDayHeaderWidth := 3 * ScaleFactor.Apply(dxDPITripleTextOffset) +
    FVerticalDayHeaderDayNumberWidth + FVerticalDayHeaderYearCaptionWidth;
end;
...
begin
  ...
  if (DayHeaderOrientation = dhoHorizontal) and
    (TopVisibleDayHeader.Bounds.Top > 0) then
...
begin
  ...
  if Controller.FIsDeletingOfFocusedEvent and (TopScrollPos > 0) and
    (FNextTop < Bounds.Bottom) then
...
procedure TcxSchedulerAgendaViewViewInfo.DoContentNavigationButtonClick
...
procedure TcxSchedulerAgendaViewViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited DoRightToLeftConversion(AClientBounds);
  TcxSchedulerViewInfoCellListAccess(CloneEventCells).DoRightToLeftConversion
    (AClientBounds);
end;

procedure TcxSchedulerAgendaViewViewInfo.ExtractEvents(ASource,
  ADest: TcxSchedulerEventList; ADate: TDateTime);
var
...
procedure TcxSchedulerAgendaViewViewInfo.ExtractCloneEvents
  (ADest: TcxSchedulerEventList; ADate: TDateTime);
var
  ADateWithoutTime: Integer;
  AEvent: TcxSchedulerEvent;
  I: Integer;
begin
  if (Events.Clones.Count = 0) or not Controller.HitTest.HitAtControl or
    (Controller.FCurrentDragState = dsDragLeave) then
    Exit;
  ADateWithoutTime := Trunc(ADate);
  for I := 0 to Events.Clones.Count - 1 do
  begin
...
function TcxSchedulerAgendaViewViewInfo.GetBottomVisibleDayHeader
  : TcxSchedulerAgendaViewDayHeaderCellViewInfo;
var
  I: Integer;
  ADayHeader: TcxSchedulerAgendaViewDayHeaderCellViewInfo;
...
function TcxSchedulerAgendaViewViewInfo.GetCellDate
  (ACell: TcxSchedulerCustomViewInfoItem): TDate;
begin
  if ACell = nil then
    Result := -1
  else
...
function TcxSchedulerAgendaViewViewInfo.GetController
  : TcxSchedulerAgendaViewController;
begin
...
function TcxSchedulerAgendaViewViewInfo.GetDayContentHeight
  (const ADate: TDate): Integer;
var
...
function TcxSchedulerAgendaViewViewInfo.GetDayHeader
  (ACell: TcxSchedulerCustomViewInfoItem)
  : TcxSchedulerAgendaViewDayHeaderCellViewInfo;
begin
  if ACell is TcxSchedulerAgendaViewEventCellViewInfo then
...
function TcxSchedulerAgendaViewViewInfo.GetDayHeaderOrientation
  : TcxSchedulerAgendaViewDayHeaderOrientation;
begin
  Result := AgendaView.DayHeaderOrientation;
end;

function TcxSchedulerAgendaViewViewInfo.GetDragEventHelper
  : TcxAgendaViewDragEventHelper;
begin
  Result := Controller.DragEventHelper as TcxAgendaViewDragEventHelper;
end;

function TcxSchedulerAgendaViewViewInfo.GetEventCellColor(const AIsSelected
  : Boolean): TColor;
var
  AStyle: TcxStyle;
begin
...
function TcxSchedulerAgendaViewViewInfo.GetEventCellTextColor(const AIsSelected
  : Boolean): TColor;
var
  AStyle: TcxStyle;
begin
...
function TcxSchedulerAgendaViewViewInfo.EventCellClass
...
function TcxSchedulerAgendaViewViewInfo.GetEventHint
...
function TcxSchedulerAgendaViewViewInfo.GetEventStart
  (AEvent: TcxSchedulerControlEvent; ADate: TDateTime): TDateTime;
begin
  Result := Max(Int(ADate), AEvent.Start);
end;

function TcxSchedulerAgendaViewViewInfo.GetEventFinish
  (AEvent: TcxSchedulerControlEvent; ADate: TDateTime): TDateTime;
begin
  Result := Min(Int(ADate + 1), AEvent.Finish);
end;

function TcxSchedulerAgendaViewViewInfo.GetInfoCell(AIndex: Integer)
  : TcxSchedulerCustomViewInfoItem;
begin
  Result := TcxSchedulerCustomViewInfoItem(FInfoCells[AIndex]);
end;

function TcxSchedulerAgendaViewViewInfo.GetInfoCell
  (AEvent: TcxSchedulerControlEvent; const ADate: TDateTime)
  : TcxSchedulerCustomViewInfoItem;
var
  I: Integer;
...
function TcxSchedulerAgendaViewViewInfo.GetLastVisibleCell
  : TcxSchedulerCustomViewInfoItem;
var
  I: Integer;
  ACell: TcxSchedulerCustomViewInfoItem;
...
function TcxSchedulerAgendaViewViewInfo.GetTopScrollPosPreliminaryValue
  (ACell: TcxSchedulerCustomViewInfoItem): Integer;
begin
...
function TcxSchedulerAgendaViewViewInfo.GetTopScrollPosToDisplayCell
  (ACell: TcxSchedulerCustomViewInfoItem): Integer;
var
  AVisibleTop: Integer;
begin
  ...
  begin
    ...
    else if ACell.Bounds.Bottom > Bounds.Bottom then
      Result := TopScrollPos + ACell.Bounds.Bottom - Bounds.Bottom;
  end;
end;

function TcxSchedulerAgendaViewViewInfo.GetTopVisibleCell
  : TcxSchedulerCustomViewInfoItem;
var
  I: Integer;
  ACell: TcxSchedulerCustomViewInfoItem;
...
function TcxSchedulerAgendaViewViewInfo.GetResourceText(AEventResourceID
  : Variant): string;
...
begin
  Result := '';
  if not IsResourcePresent(AEventResourceID) then
    Exit;
  ...
  begin
    ...
    for I := ALow to AHigh do
      Result := Result + GetSimpleResourceCaption(AEventResourceID[I]) +
        ADelimiter;
    while (Length(Result) > 1) and
      (Copy(Result, Length(Result) - 1, 2) = ADelimiter) do
...
procedure TcxSchedulerAgendaViewViewInfo.CheckAsNewFocusedCell
  (ACell: TcxSchedulerCustomViewInfoItem);
var
  AEvent: TcxSchedulerControlEvent;
...
begin
  ...
  begin
    AIsNewFocusedCell := GetCellDate(ACell)
      = Int(Controller.FStoredFocusedCellDate);
    if Controller.FIsDeletingOfFocusedEvent then
    ...
    if AEvent <> nil then
    begin
      AIsNewFocusedCell := Controller.FIsDeletingOfFocusedEvent or
        (Controller.FStoredFocusedEventKey <> nil);
      if AIsNewFocusedCell then
      begin
        AKey := TcxSchedulerControlEventID.Create(AEvent);
        try
          AIsNewFocusedCell := cxCompareSelectionKeys
            (Controller.FStoredFocusedEventKey, AKey) = 0;
        finally
          AKey.Free;
        end;
      end;
...
function TcxSchedulerAgendaViewViewInfo.IsResourcePresent(AEventResourceID
  : Variant): Boolean;
begin
  Result := AgendaView.ShowResources and
    not(VarIsNull(AEventResourceID) or VarIsEmpty(AEventResourceID));
end;

function TcxSchedulerAgendaViewViewInfo.
  IsScrollBarsParametersWasChanged: Boolean;
var
  APos: Integer;
begin
  Result := False;
...
function TcxSchedulerAgendaViewViewInfo.IsTopVisibleCell
  (ACell: TcxSchedulerCustomViewInfoItem): Boolean;
var
...
begin
  ...
  begin
    ...
    Result := (ABounds.Top <= AHeaderHeight) and
      (ABounds.Bottom > AHeaderHeight);
  end
  else
    Result := (ABounds.Top <= 0) and (ABounds.Bottom > 0);
end;

procedure TcxSchedulerAgendaViewViewInfo.MakeCellVisible
  (ACell: TcxSchedulerCustomViewInfoItem);
begin
...
begin
  ...
  ADayContentBounds := cxRectSetHeight(TopVisibleDayHeader.Bounds,
    GetDayContentHeight(ADate));
  AHeaderHeight := cxRectHeight(TopVisibleDayHeader.Bounds);
  if (Controller.IsTopDayCanBeChangedInsideOfScrolling or
    Scheduler.Storage.EditingEventInfoList.IsLocked or
    not AgendaView.IsSelectedDaysChanged) and
    (((ADayContentBounds.Top < 0) and (ADayContentBounds.Bottom > 0)) or
    (InRange(ADayContentBounds.Top, 1, AHeaderHeight - 1))) then
  begin
    CorrectTopVisibleHeaderBounds;
    FBottomVisibleDayHeader := GetBottomVisibleDayHeader;
  end
...
procedure TcxSchedulerAgendaViewViewInfo.
  MeasureVerticalDayHeaderDayNumberFontSize(const AAreaHeight: Integer;
  var AFont: TFont);
var
...
function TcxSchedulerAgendaViewViewInfo.NeedClearResources
  (AGroupingKind: TcxSchedulerGroupingKind): Boolean;
begin
  Result := False;
end;

procedure TcxSchedulerAgendaViewViewInfo.OnContentNavigationButtonClick
  (Sender: TcxSchedulerContentNavigationButtonViewInfo);
begin
...
begin
  ...
  begin
    ...
    if (ActualVisibleDayStart - AStart > AgendaView.GetVisibleDaysRange div 2)
      or (AFinish - ActualSelectedDayFinish >
      AgendaView.GetVisibleDaysRange div 2) then
    begin
      FTopScrollPos := 0;
      FActualVisibleDays.Clear;
...
begin
  ...
  if AIndex >= 0 then
  begin
    AHeader := DayHeaderCells[AIndex]
      as TcxSchedulerAgendaViewDayHeaderCellViewInfo;
    AHeader.StoreRealAreas;
    AHeader.DoScroll(0, -(AHeader.Bounds.Top + cxRectHeight(AHeader.Bounds) -
      TopVisibleDayHeader.Bounds.Top));
  end;
end;

procedure TcxSchedulerAgendaViewViewInfo.ResetTopScrollPos;
begin
  if (AgendaView.DisplayMode <> avmAllDays) and
    not Controller.FEventDeletingInProcess and
    ((Scheduler.Storage = nil) or not Scheduler.Storage.EditingEventInfoList.
    IsLocked) then
    FTopScrollPos := 0;
end;

procedure TcxSchedulerAgendaViewViewInfo.ReturnVisibleInterval(var AStart,
  AEnd: TDateTime);
begin
  if AgendaView.DisplayMode = avmAllDays then
  begin
...
begin
  ...
  for I := 0 to DayHeaderCells.Count - 1 do
    TcxSchedulerAgendaViewDayHeaderCellViewInfo(DayHeaderCells[I])
      .Scroll(0, -DY);
  for I := 0 to InfoCells.Count - 1 do
  ...
  CheckVisibleDayHeaders;
  if (AOldTopVisibleDayHeader <> TopVisibleDayHeader) and
    (AgendaView.DisplayMode = avmAllDays) then
...
begin
  DoScroll(DY);
  AgendaView.HitTest.HitPoint := AgendaView.Scheduler.ScreenToClient
    (GetMouseCursorPos);
...
procedure TcxSchedulerAgendaViewViewInfo.SetContentNavigationButtonsIntervals;
  ...
  function GetPreviousEventDateInsideSelection(const ADate: TDateTime)
    : TDateTime;
  var
    I: Integer;
  begin
    ...
    if AgendaView.DisplayMode <> avmAllDays then
      for I := 0 to EventCells.Count - 1 do
        if TcxSchedulerAgendaViewEventCellViewInfo(EventCells[I]).FDateTime < ADate
        then
          Result := TcxSchedulerAgendaViewEventCellViewInfo(EventCells[I])
            .FDateTime
        else
          Break;
  end;
    ...
    begin
      ...
      try
        ...
        try
          ...
          ACalculator.FindNavigationIntervals(Scheduler.Storage, AIntervals,
            AStart, AFinish, True, False, GetScaleUnit);
        finally
          ACalculator.Free;
        end;
        ...
        begin
          ABefore := TcxSchedulerContentNavigationInfo(AIntervals[0])
            .FIntervalBefore;
          FNearestEventDateBeforeSelection := AStart - Trunc(ABefore);
          if Frac(ABefore) <> 0 then
            FNearestEventDateBeforeSelection :=
              FNearestEventDateBeforeSelection - 1;
        end
        else
        ...
        if Abs(ANext) = MaxDateTime then
          FNearestEventDateAfterSelection := AFinish +
            Trunc(TcxSchedulerContentNavigationInfo(AIntervals[0])
            .FIntervalAfter)
        else
...
begin
  ...
  else if (NavigationButtons.Count > 0) and (TopVisibleDayHeader <> nil) then
  begin
    APrevious := GetPreviousEventDateInsideSelection
      (TopVisibleDayHeader.DateTime);
    ANext := GetNextEventDateInsideSelection(TopVisibleDayHeader.DateTime);
    InternalCheck(APrevious, ANext);

    ANavigationButton := TcxSchedulerContentNavigationButtonViewInfo
      (FNavigationButtons[0]);
    if Abs(APrevious) < MaxDateTime then
...
procedure TcxSchedulerAgendaViewViewInfo.
  TryAddContentNavigationButtonsAtScrolling;
begin
...
procedure TcxSchedulerAgendaViewViewInfo.CheckNewTopScrollPos
  (var AValue: Integer);
begin
...
procedure TcxSchedulerAgendaViewViewInfo.RestoreCanvasFontParams(const AFontSize
  : Integer; const AFontStyle: TFontStyles);
begin
  GetCurrentFont.Size := AFontSize;
  GetCurrentFont.Style := AFontStyle;
end;

procedure TcxSchedulerAgendaViewViewInfo.StoreCanvasFontParams
  (var AFontSize: Integer; var AFontStyle: TFontStyles);
begin
