...
type
  ...
  public
    ...
    property InTableParagraph: Boolean read FInTableParagraph
      write FInTableParagraph;
    ...
    property ProcessedBorder: TdxBorderInfo read FProcessedBorder
      write FProcessedBorder;
    property RtfLineSpacingMultiplier: Integer read FRtfLineSpacingMultiplier
      write FRtfLineSpacingMultiplier;
    property RtfLineSpacingType: Integer read FRtfLineSpacingType
      write FRtfLineSpacingType;
    property RtfTableStyleIndexForRowOrCell: Integer
      read FRtfTableStyleIndexForRowOrCell
      write FRtfTableStyleIndexForRowOrCell;
    ...
    property TabAlignment: TdxTabAlignmentType read FTabAlignment
      write FTabAlignment;
    property TabLeader: TdxTabLeaderType read FTabLeader write FTabLeader;
    property Tabs: TdxTabFormattingInfo read FTabs;
    property UseLineSpacingMultiplier: Boolean read FUseLineSpacingMultiplier
      write FUseLineSpacingMultiplier;
  end;
...
function TdxRtfParagraphFormattingInfo.CalcLineSpacing(AUnitConverter
  : TdxDocumentModelUnitConverter): Single;
begin
  ...
  begin
    ...
    else if RtfLineSpacingType <> 0 then
      Result := Max(AUnitConverter.TwipsToModelUnits
        (Abs(RtfLineSpacingType)), 1)
    else
      Result := 0;
  end
  else
...
function TdxRtfParagraphFormattingInfo.CalcLineSpacingType
