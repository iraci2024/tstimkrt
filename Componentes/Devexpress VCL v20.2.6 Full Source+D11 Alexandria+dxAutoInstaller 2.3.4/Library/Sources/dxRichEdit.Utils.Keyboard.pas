...
uses
  Types, Windows, SysUtils, Classes, Controls, Generics.Defaults,
...
type
  ...
  public
    class function ArgsToShortCut(const Args: TdxKeyEventArgs)
      : TShortCut; static;
    class function CharToShortCut(AValue: Char; const AShiftState: TShiftState)
      : TShortCut; static;
    class function KeysToShortCut(AKey: Word; const AShiftState: TShiftState)
      : TShortCut; static;
    class function IsValidShortCutChar(AValue: Char; out AKey: Word)
      : Boolean; static;
    ...
    class property IsAltGrPressed: Boolean index VK_RMENU
...
class function TdxKeyboardHelper.ArgsToShortCut(const Args: TdxKeyEventArgs)
  : TShortCut;
begin
  Result := KeysToShortCut(Args.KeyData, Args.ShiftState);
end;

class function TdxKeyboardHelper.CharToShortCut(AValue: Char;
...
class function TdxKeyboardHelper.CheckIsKeyPressed
...
class function TdxKeyboardHelper.KeysToShortCut(AKey: Word;
  const AShiftState: TShiftState): TShortCut;
begin
  Result := ShortCut(AKey, AShiftState);
end;

class function TdxKeyboardHelper.IsValidShortCutChar(AValue: Char;
  out AKey: Word): Boolean;
begin
...
class function TdxKeyboardHelper.GetShiftState(AShortCut: TShortCut)
  : TShiftState;
begin
  Result := [];
...
procedure TdxCustomKeyboardController.AddHandler(const AHandler
  : IdxKeyboardHandlerService);
begin
  FHandlers.Add(AHandler);
end;

procedure TdxCustomKeyboardController.RemoveHandler(const AHandler
  : IdxKeyboardHandlerService);
begin
  FHandlers.Remove(AHandler);
end;

function TdxCustomKeyboardController.CanKeyDownModifyEdit(Key: Word;
...
procedure TdxCustomKeyboardController.KeyDown(var Key: Word;
  Shift: TShiftState);
var
  Args: TdxKeyEventArgs;
  AHandler: IdxKeyboardHandlerService;
