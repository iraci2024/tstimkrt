...
resourcestring
  ...
  sdxConditionalFormattingDataBarRuleStyleEditDialogAxisAuto =
    'A&utomatic (display at variable position based on negative values)';
  ...
  sdxConditionalFormattingDataBarRuleStyleEditDialogAxisNone =
    'Non&e (show negative value bars in same direction as positive)';
  ...
  sdxConditionalFormattingDataBarRuleStyleEditDialogNegativeBarBorderColorAuto =
    'A&pply same border color as positive bar';
  ...
  sdxConditionalFormattingRuleEditDialogErrorIncorrectStopsOrder =
    'The order of stops is incorrect';
  sdxConditionalFormattingRuleEditDialogErrorInvalidExpression =
    'One or more expressions are incorrect';
  ...
  sdxConditionalFormattingRuleEditDialogRuleNameTwoColorScale =
    'Format all cells based on their values via two color scale';
  sdxConditionalFormattingRuleEditDialogRuleNameUniqueValues =
    'Format only unique values';
  ...
  sdxExpressionEditorOperatorPowerDescription =
    'Raises the first value by the power of the second.';
  ...
  sdxExpressionEditorOperatorLEDescription =
    'Returns TRUE if the first value is less than the second or if they are equal; otherwise FALSE.';
  ...
  sdxExpressionEditorOperatorGEDescription =
    'Returns TRUE if the first value is greater than the second or if they are equal; otherwise FALSE.';
  ...
  sdxExpressionEditorOperatorNEDescription =
    'Returns TRUE if two values are not equal; otherwise FALSE.';
  sdxExpressionEditorOperatorPercentDescription =
    'Specifies that the entered numeric value is a percentage.';
  ...
  sdxExpressionEditorUnknownFieldOrFunctionConfirmation =
    'The expression contains a reference to an unknown field or function. Save changes?';
  sdxExpressionEditorCloseDialogConfirmation =
    'The expression was modified. Save changes?';

const
  dxCellFillStyleNames: array [TdxSpreadSheetCellFillStyle] of Pointer =
    (@sdxCellFillStyleSolid, @sdxCellFillStyleGray75, @sdxCellFillStyleGray50,
    @sdxCellFillStyleGray25, @sdxCellFillStyleGray12, @sdxCellFillStyleGray6,
    @sdxCellFillStyleHorzStrip, @sdxCellFillStyleVertStrip,
    @sdxCellFillStyleRevDiagonalStrip, @sdxCellFillStyleDiagonalStrip,
    @sdxCellFillStyleDiagCrossHatch, @sdxCellFillStyleThickDiagonalCrossHatch,
    @sdxCellFillStyleThinHorzStrip, @sdxCellFillStyleThinVertStrip,
    @sdxCellFillStyleThinRevDiagonalStrip, @sdxCellFillStyleThinDiagonalStrip,
    @sdxCellFillStyleThinDiagCrossHatch, @sdxCellFillStyleThinHorzCrossHatch);

  dxFontStyleNames: array [TFontStyle] of Pointer = (@sdxFontStyleBold,
    @sdxFontStyleItalic, @sdxFontStyleUnderline, @sdxFontStyleStrikeOut);

  dxSpreadSheetDataHorzAlignNames: array [TdxSpreadSheetDataAlignHorz]
    of Pointer = (@sdxHorzAlignGeneral, @sdxHorzAlignLeft, @sdxHorzAlignCenter,
    @sdxHorzAlignRight, @sdxHorzAlignFill, @sdxHorzAlignJustify,
    @sdxHorzAlignDistributed);

  dxSpreadSheetDataVertAlignNames: array [TdxSpreadSheetDataAlignVert]
    of Pointer = (@sdxVertAlignTop, @sdxVertAlignCenter, @sdxVertAlignBottom,
    @sdxVertAlignJustify, @sdxVertAlignDistributed);

  dxSpreadSheetNumberFormatCategoryNames
    : array [TdxSpreadSheetNumberFormatCategory] of Pointer =
    (@sdxFormatCellsDialogCategoryGeneral, @sdxFormatCellsDialogCategoryNumber,
    @sdxFormatCellsDialogCategoryCurrency,
    @sdxFormatCellsDialogCategoryAccounting, @sdxFormatCellsDialogCategoryDate,
    @sdxFormatCellsDialogCategoryTime, @sdxFormatCellsDialogCategoryPercentage,
    @sdxFormatCellsDialogCategoryFraction,
    @sdxFormatCellsDialogCategoryScientific, @sdxFormatCellsDialogCategoryText,
    @sdxFormatCellsDialogCategoryCustom);
...
begin
  AProduct.Add('sdxCellFillStyleDiagCrossHatch',
    @sdxCellFillStyleDiagCrossHatch);
  ...
  AProduct.Add('sdxCellFillStyleRevDiagonalStrip',
    @sdxCellFillStyleRevDiagonalStrip);
  AProduct.Add('sdxCellFillStyleSolid', @sdxCellFillStyleSolid);
  AProduct.Add('sdxCellFillStyleThickDiagonalCrossHatch',
    @sdxCellFillStyleThickDiagonalCrossHatch);
  AProduct.Add('sdxCellFillStyleThinDiagCrossHatch',
    @sdxCellFillStyleThinDiagCrossHatch);
  AProduct.Add('sdxCellFillStyleThinDiagonalStrip',
    @sdxCellFillStyleThinDiagonalStrip);
  AProduct.Add('sdxCellFillStyleThinHorzCrossHatch',
    @sdxCellFillStyleThinHorzCrossHatch);
  AProduct.Add('sdxCellFillStyleThinHorzStrip', @sdxCellFillStyleThinHorzStrip);
  AProduct.Add('sdxCellFillStyleThinRevDiagonalStrip',
    @sdxCellFillStyleThinRevDiagonalStrip);
  ...
  AProduct.Add('sdxFormatCellsDialogBackgroundColor',
    @sdxFormatCellsDialogBackgroundColor);
  AProduct.Add('sdxFormatCellsDialogBorder', @sdxFormatCellsDialogBorder);
  AProduct.Add('sdxFormatCellsDialogBorderInside',
    @sdxFormatCellsDialogBorderInside);
  AProduct.Add('sdxFormatCellsDialogBorderLine',
    @sdxFormatCellsDialogBorderLine);
  AProduct.Add('sdxFormatCellsDialogBorderLineColor',
    @sdxFormatCellsDialogBorderLineColor);
  AProduct.Add('sdxFormatCellsDialogBorderLineStyle',
    @sdxFormatCellsDialogBorderLineStyle);
  AProduct.Add('sdxFormatCellsDialogBorderNone',
    @sdxFormatCellsDialogBorderNone);
  AProduct.Add('sdxFormatCellsDialogBorderOutline',
    @sdxFormatCellsDialogBorderOutline);
  AProduct.Add('sdxFormatCellsDialogBorderPresets',
    @sdxFormatCellsDialogBorderPresets);
  AProduct.Add('sdxFormatCellsDialogBordersHint',
    @sdxFormatCellsDialogBordersHint);
  AProduct.Add('sdxFormatCellsDialogButtonCancel',
    @sdxFormatCellsDialogButtonCancel);
  AProduct.Add('sdxFormatCellsDialogButtonColorAuto',
    @sdxFormatCellsDialogButtonColorAuto);
  ...
  AProduct.Add('sdxFormatCellsDialogButtonResetFont',
  ...
  AProduct.Add('sdxFormatCellsDialogCategoryAccounting',
    @sdxFormatCellsDialogCategoryAccounting);
  AProduct.Add('sdxFormatCellsDialogCategoryAccountingDescription',
    @sdxFormatCellsDialogCategoryAccountingDescription);
  AProduct.Add('sdxFormatCellsDialogCategoryCurrency',
    @sdxFormatCellsDialogCategoryCurrency);
  AProduct.Add('sdxFormatCellsDialogCategoryCurrencyDescription',
    @sdxFormatCellsDialogCategoryCurrencyDescription);
  AProduct.Add('sdxFormatCellsDialogCategoryCustom',
    @sdxFormatCellsDialogCategoryCustom);
  AProduct.Add('sdxFormatCellsDialogCategoryCustomDescription',
    @sdxFormatCellsDialogCategoryCustomDescription);
  AProduct.Add('sdxFormatCellsDialogCategoryDate',
    @sdxFormatCellsDialogCategoryDate);
  AProduct.Add('sdxFormatCellsDialogCategoryDateDescription',
    @sdxFormatCellsDialogCategoryDateDescription);
  AProduct.Add('sdxFormatCellsDialogCategoryDateNote',
    @sdxFormatCellsDialogCategoryDateNote);
  AProduct.Add('sdxFormatCellsDialogCategoryFraction',
    @sdxFormatCellsDialogCategoryFraction);
  AProduct.Add('sdxFormatCellsDialogCategoryGeneral',
    @sdxFormatCellsDialogCategoryGeneral);
  AProduct.Add('sdxFormatCellsDialogCategoryGeneralNotes',
    @sdxFormatCellsDialogCategoryGeneralNotes);
  AProduct.Add('sdxFormatCellsDialogCategoryNumber',
    @sdxFormatCellsDialogCategoryNumber);
  AProduct.Add('sdxFormatCellsDialogCategoryNumberDescription',
    @sdxFormatCellsDialogCategoryNumberDescription);
  AProduct.Add('sdxFormatCellsDialogCategoryPercentage',
    @sdxFormatCellsDialogCategoryPercentage);
  AProduct.Add('sdxFormatCellsDialogCategoryPercentageDescription',
    @sdxFormatCellsDialogCategoryPercentageDescription);
  AProduct.Add('sdxFormatCellsDialogCategoryScientific',
    @sdxFormatCellsDialogCategoryScientific);
  AProduct.Add('sdxFormatCellsDialogCategoryText',
    @sdxFormatCellsDialogCategoryText);
  AProduct.Add('sdxFormatCellsDialogCategoryTextNotes',
    @sdxFormatCellsDialogCategoryTextNotes);
  AProduct.Add('sdxFormatCellsDialogCategoryTime',
    @sdxFormatCellsDialogCategoryTime);
  AProduct.Add('sdxFormatCellsDialogCategoryTimeDescription',
    @sdxFormatCellsDialogCategoryTimeDescription);
  AProduct.Add('sdxFormatCellsDialogCustomCode',
    @sdxFormatCellsDialogCustomCode);
  AProduct.Add('sdxFormatCellsDialogDecimalPlaces',
    @sdxFormatCellsDialogDecimalPlaces);
  AProduct.Add('sdxFormatCellsDialogFill', @sdxFormatCellsDialogFill);
  AProduct.Add('sdxFormatCellsDialogFillSample',
    @sdxFormatCellsDialogFillSample);
  ...
  AProduct.Add('sdxFormatCellsDialogFontNotInstalled',
    @sdxFormatCellsDialogFontNotInstalled);
  AProduct.Add('sdxFormatCellsDialogFontPreview',
    @sdxFormatCellsDialogFontPreview);
  AProduct.Add('sdxFormatCellsDialogFontPrintNotes',
    @sdxFormatCellsDialogFontPrintNotes);
  AProduct.Add('sdxFormatCellsDialogFontSize', @sdxFormatCellsDialogFontSize);
  AProduct.Add('sdxFormatCellsDialogFontStrikethrough',
    @sdxFormatCellsDialogFontStrikethrough);
  AProduct.Add('sdxFormatCellsDialogFontStyle', @sdxFormatCellsDialogFontStyle);
  AProduct.Add('sdxFormatCellsDialogFontUnderline',
    @sdxFormatCellsDialogFontUnderline);
  AProduct.Add('sdxFormatCellsDialogGroupFontEffects',
    @sdxFormatCellsDialogGroupFontEffects);
  AProduct.Add('sdxFormatCellsDialogGroupNumber',
    @sdxFormatCellsDialogGroupNumber);
  AProduct.Add('sdxFormatCellsDialogGroupTextAlignment',
  ...
  AProduct.Add('sdxFormatCellsDialogMergeCells',
    @sdxFormatCellsDialogMergeCells);
  AProduct.Add('sdxFormatCellsDialogMoreColors',
  ...
  AProduct.Add('sdxFormatCellsDialogNumberFormatTemplates',
    @sdxFormatCellsDialogNumberFormatTemplates);
  AProduct.Add('sdxFormatCellsDialogPatternColor',
    @sdxFormatCellsDialogPatternColor);
  AProduct.Add('sdxFormatCellsDialogPatternStyle',
    @sdxFormatCellsDialogPatternStyle);
  AProduct.Add('sdxFormatCellsDialogPreviewText',
    @sdxFormatCellsDialogPreviewText);
  AProduct.Add('sdxFormatCellsDialogProtection',
    @sdxFormatCellsDialogProtection);
  AProduct.Add('sdxFormatCellsDialogProtectionNotes',
    @sdxFormatCellsDialogProtectionNotes);
  AProduct.Add('sdxFormatCellsDialogSample', @sdxFormatCellsDialogSample);
  AProduct.Add('sdxFormatCellsDialogShrinkToFit',
    @sdxFormatCellsDialogShrinkToFit);
  AProduct.Add('sdxFormatCellsDialogTextAlignHorz',
    @sdxFormatCellsDialogTextAlignHorz);
  AProduct.Add('sdxFormatCellsDialogTextAlignHorzIndent',
    @sdxFormatCellsDialogTextAlignHorzIndent);
  AProduct.Add('sdxFormatCellsDialogTextAlignment',
    @sdxFormatCellsDialogTextAlignment);
  AProduct.Add('sdxFormatCellsDialogTextAlignVert',
    @sdxFormatCellsDialogTextAlignVert);
  AProduct.Add('sdxFormatCellsDialogTextControl',
    @sdxFormatCellsDialogTextControl);
  AProduct.Add('sdxFormatCellsDialogUnderlineNone',
    @sdxFormatCellsDialogUnderlineNone);
  AProduct.Add('sdxFormatCellsDialogUnderlineSingle',
    @sdxFormatCellsDialogUnderlineSingle);
  AProduct.Add('sdxFormatCellsDialogUseThousandSeparator',
    @sdxFormatCellsDialogUseThousandSeparator);
  ...
  AProduct.Add('sdxConditionalFormattingRuleEditDialogScaleMaxStop',
    @sdxConditionalFormattingRuleEditDialogScaleMaxStop);
  AProduct.Add('sdxConditionalFormattingRuleEditDialogScaleMidStop',
    @sdxConditionalFormattingRuleEditDialogScaleMidStop);
  AProduct.Add('sdxConditionalFormattingRuleEditDialogScaleMinStop',
    @sdxConditionalFormattingRuleEditDialogScaleMinStop);
  ...
  AProduct.Add('sdxExpressionEditorButtonCancel',
    @sdxExpressionEditorButtonCancel);
  AProduct.Add('sdxExpressionEditorCaption', @sdxExpressionEditorCaption);
  AProduct.Add('sdxExpressionEditorFieldsCategoryCaption',
    @sdxExpressionEditorFieldsCategoryCaption);
  AProduct.Add('sdxExpressionEditorConstantsCategoryCaption',
    @sdxExpressionEditorConstantsCategoryCaption);
  AProduct.Add('sdxExpressionEditorOperatorsCategoryCaption',
    @sdxExpressionEditorOperatorsCategoryCaption);
  AProduct.Add('sdxExpressionEditorFunctionGroupsCategoryCaption',
    @sdxExpressionEditorFunctionGroupsCategoryCaption);
  AProduct.Add('sdxExpressionEditorFieldDescription',
    @sdxExpressionEditorFieldDescription);
  AProduct.Add('sdxExpressionEditorFilterTextHint',
    @sdxExpressionEditorFilterTextHint);
  AProduct.Add('sdxExpressionEditorNoSuggestions',
    @sdxExpressionEditorNoSuggestions);

  AProduct.Add('sdxExpressionEditorOperatorAddDescription',
    @sdxExpressionEditorOperatorAddDescription);
  AProduct.Add('sdxExpressionEditorOperatorSubDescription',
    @sdxExpressionEditorOperatorSubDescription);
  AProduct.Add('sdxExpressionEditorOperatorMulDescription',
    @sdxExpressionEditorOperatorMulDescription);
  AProduct.Add('sdxExpressionEditorOperatorDivDescription',
    @sdxExpressionEditorOperatorDivDescription);
  AProduct.Add('sdxExpressionEditorOperatorPowerDescription',
    @sdxExpressionEditorOperatorPowerDescription);
  AProduct.Add('sdxExpressionEditorOperatorConcatDescription',
    @sdxExpressionEditorOperatorConcatDescription);
  AProduct.Add('sdxExpressionEditorOperatorLTDescription',
    @sdxExpressionEditorOperatorLTDescription);
  AProduct.Add('sdxExpressionEditorOperatorLEDescription',
    @sdxExpressionEditorOperatorLEDescription);
  AProduct.Add('sdxExpressionEditorOperatorEQDescription',
    @sdxExpressionEditorOperatorEQDescription);
  AProduct.Add('sdxExpressionEditorOperatorGEDescription',
    @sdxExpressionEditorOperatorGEDescription);
  AProduct.Add('sdxExpressionEditorOperatorGTDescription',
    @sdxExpressionEditorOperatorGTDescription);
  AProduct.Add('sdxExpressionEditorOperatorNEDescription',
    @sdxExpressionEditorOperatorGTDescription);
  AProduct.Add('sdxExpressionEditorOperatorPercentDescription',
    @sdxExpressionEditorOperatorPercentDescription);

  AProduct.Add('sdxExpressionEditorMissingClosingFieldMark',
    @sdxExpressionEditorMissingClosingFieldMark);
  AProduct.Add('sdxExpressionEditorMissingClosingStringMark',
    @sdxExpressionEditorMissingClosingStringMark);
  AProduct.Add('sdxExpressionEditorSyntaxError',
    @sdxExpressionEditorSyntaxError);
  AProduct.Add('sdxExpressionEditorUnknownField',
    @sdxExpressionEditorUnknownField);
  AProduct.Add('sdxExpressionEditorUnknownFunction',
    @sdxExpressionEditorUnknownFunction);
  AProduct.Add('sdxExpressionEditorInvalidExpressionExceptionText',
    @sdxExpressionEditorInvalidExpressionExceptionText);
  AProduct.Add('sdxExpressionEditorUnknownFieldOrFunctionConfirmation',
    @sdxExpressionEditorUnknownFieldOrFunctionConfirmation);
  AProduct.Add('sdxExpressionEditorCloseDialogConfirmation',
    @sdxExpressionEditorCloseDialogConfirmation);
end;
