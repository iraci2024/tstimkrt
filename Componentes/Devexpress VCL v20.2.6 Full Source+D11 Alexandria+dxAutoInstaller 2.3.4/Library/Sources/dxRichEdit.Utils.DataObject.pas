...
uses
  SysUtils, Classes, Windows, ActiveX, Clipbrd, Generics.Defaults,
...
{$ENDIF}
  IdxDataObject = interface(IDataObject)
    ...
    function ContainsData(const AFormat: string;
      AutoConvert: Boolean = True): Boolean;
    function GetData(const AFormat: string;
      AutoConvert: Boolean = False): TBytes;
    procedure SetData(const AFormat: string; const AData); overload;
    procedure SetData(const AFormat: string; AutoConvert: Boolean;
      const AData); overload;
...
{$ENDIF}
  ...
  strict private
    ...
    function SetData(const formatetc: TFormatEtc; var medium: TStgMedium;
      fRelease: BOOL): HResult; overload; stdcall;
  ...
  public
    ...
    function ContainsData(const AFormat: string;
      AutoConvert: Boolean = True): Boolean;
    function GetData(const AFormat: string; AutoConvert: Boolean = False)
      : TBytes; overload;
    procedure SetData(const AFormat: string; const AData); overload;
    procedure SetData(const AFormat: string; AutoConvert: Boolean;
      const AData); overload;
  ...
  public
    ...
    class function CreateDataObjectItem(const AFormat: string)
      : TdxDataObjectItem;
  ...
  TdxDragAndDropDataObject = class(TInterfacedObject, IdxDataObject,
    IDataObject)
  strict private
    FLockCount: Integer;
  ...
  TdxDragAndDropExternalDataObject = class(TInterfacedObject, IdxDataObject,
    IDataObject)
  strict private
  ...
  IdxPasteSource = interface
    ...
    function GetData(const AFormat: string;
      AutoConvert: Boolean = False): TBytes;
    function GetDataAsText(const AFormat: string;
      AutoConvert: Boolean = False): string;
    function ContainsData(const AFormat: string;
      AutoConvert: Boolean = False): Boolean;
  end;
  ...
  public
    ...
    function GetDataAsText(const AFormat: string; AutoConvert: Boolean = False)
      : string; virtual;
    function ContainsData(const AFormat: string; AutoConvert: Boolean = False)
  ...
  public
    ...
    class function RegisterFormat(const AFormat: string;
      ADataObjectClass: TdxDataObjectItemClass = nil): Word;

    property Rtf: TArray<Byte> read GetRtf write SetRtf;
    property RtfWithoutObjects: TArray<Byte> read GetRtfWithoutObjects
      write SetRtfWithoutObjects;
    property SuppressStoreImageSize: AnsiString read GetSuppressStoreImageSize
      write SetSuppressStoreImageSize;
...
function TdxEnumFormatEtc.Next(celt: Longint; out elt;
...
function TdxDataObject.GetData(const formatetcIn: TFormatEtc;
  out medium: TStgMedium): HResult;
begin
  Result := IDataObject(FInnerData).GetData(formatetcIn, medium);
end;

function TdxDataObject.GetDataHere(const formatetc: TFormatEtc;
  out medium: TStgMedium): HResult;
begin
...
function TdxDataObject.GetCanonicalFormatEtc(const formatetc: TFormatEtc;
  out formatetcOut: TFormatEtc): HResult;
begin
  Result := IDataObject(FInnerData).GetCanonicalFormatEtc(formatetc,
    formatetcOut);
end;

function TdxDataObject.SetData(const formatetc: TFormatEtc;
  var medium: TStgMedium; fRelease: BOOL): HResult;
begin
  Result := IDataObject(FInnerData).SetData(formatetc, medium, fRelease);
end;

function TdxDataObject.EnumFormatEtc(dwDirection: Longint;
  out EnumFormatEtc: IEnumFormatEtc): HResult;
begin
  Result := IDataObject(FInnerData).EnumFormatEtc(dwDirection, EnumFormatEtc);
end;

function TdxDataObject.DAdvise(const formatetc: TFormatEtc; advf: Longint;
  const advSink: IAdviseSink; out dwConnection: Longint): HResult;
begin
  Result := IDataObject(FInnerData).DAdvise(formatetc, advf, advSink,
    dwConnection);
end;
...
function TdxDataObject.ContainsData(const AFormat: string;
  AutoConvert: Boolean = True): Boolean;
begin
  Result := FInnerData.ContainsData(AFormat, AutoConvert);
end;

function TdxDataObject.GetData(const AFormat: string;
  AutoConvert: Boolean = False): TBytes;
begin
  Result := nil;
end;
...
procedure TdxDataObject.SetData(const AFormat: string; AutoConvert: Boolean;
  const AData);
begin
...
class function TdxDataObjectItem.CreateDataObjectItem(const AFormat: string)
  : TdxDataObjectItem;
var
...
function TdxDataStore.GetData(const formatetcIn: TFormatEtc;
  out medium: TStgMedium): HResult;
begin
  Result := S_FALSE;
...
function TdxDataStore.GetDataHere(const formatetc: TFormatEtc;
  out medium: TStgMedium): HResult;
begin
  Result := S_FALSE;
  Assert(False, 'not implemented');
...
function TdxDataStore.GetCanonicalFormatEtc(const formatetc: TFormatEtc;
  out formatetcOut: TFormatEtc): HResult;
begin
  Result := S_FALSE;
  Assert(False, 'not implemented');
...
function TdxDataStore.SetData(const formatetc: TFormatEtc;
  var medium: TStgMedium; fRelease: BOOL): HResult;
begin
  Result := S_FALSE;
  Assert(False, 'not implemented');
...
function TdxDataStore.EnumFormatEtc(dwDirection: Longint;
  out EnumFormatEtc: IEnumFormatEtc): HResult;
begin
  Result := S_FALSE;
  Assert(False, 'not implemented');
...
function TdxDataStore.DAdvise(const formatetc: TFormatEtc; advf: Longint;
  const advSink: IAdviseSink; out dwConnection: Longint): HResult;
begin
  Result := S_FALSE;
  Assert(False, 'not implemented');
...
function TdxDataStore.ContainsData(const AFormat: string;
  AutoConvert: Boolean = True): Boolean;
begin
  Result := Clipboard.ContainsData(AFormat);
end;

function TdxDataStore.GetData(const AFormat: string;
  AutoConvert: Boolean = False): TBytes;
begin
  Result := nil;
  Assert(False, 'not implemented');
...
begin
  ...
  else if AFormat = TdxOfficeDataFormats.UnicodeText then
    Clipboard.UnicodeText := string(AData)
  else if AFormat = TdxOfficeDataFormats.RtfWithoutObjects then
...
function TdxEmptyPasteSource.GetData(const AFormat: string;
  AutoConvert: Boolean = False): TBytes;
begin
  Result := nil;
end;
...
class function TdxClipboard.RegisterFormat(const AFormat: string;
  ADataObjectClass: TdxDataObjectItemClass = nil): Word;
begin
...
begin
  Result := (AFormat = TdxOfficeDataFormats.Text) or
...
begin
  SetBuffer(CF_SuppressStoreImageSize, PAnsiChar(Value)^,
...
function TdxClipboard.GetData(const AFormat: string;
  AutoConvert: Boolean = False): TBytes;
var
  S: string;
  AHandle: THandle;
...
function TdxClipboard.GetDataAsText(const AFormat: string;
  AutoConvert: Boolean = False): string;
begin
  if AFormat = TdxOfficeDataFormats.Text then
    ...
    Result := UnicodeText
  else if AFormat = TdxOfficeDataFormats.Rtf then
    Result := TdxEncoding.Unicode.GetString(TEncoding.Convert(TdxEncoding.ANSI,
      TdxEncoding.Unicode, Rtf))
  else if AFormat = TdxOfficeDataFormats.SuppressStoreImageSize then
...
function TdxClipboardPasteSource.GetData(const AFormat: string;
  AutoConvert: Boolean = False): TBytes;
begin
  Result := Clipboard.GetData(AFormat, AutoConvert);
end;

function TdxClipboardPasteSource.GetDataAsText(const AFormat: string;
  AutoConvert: Boolean = False): string;
begin
...
function TdxPasteSource.GetDataAsText(const AFormat: string;
  AutoConvert: Boolean = False): string;
var
  ASize: Cardinal;
  AData: TBytes;
...
function TdxDragAndDropDataObject.GetData(const formatetcIn: TFormatEtc;
  out medium: TStgMedium): HResult;
var
  AFormat: string;
  ASize: Cardinal;
...
begin
  Result := S_FALSE;
  if (QueryGetData(formatetcIn) = S_OK) and CFToFormat(formatetcIn.cfFormat,
    AFormat) then
  begin
...
function TdxDragAndDropDataObject.GetDataHere(const formatetc: TFormatEtc;
  out medium: TStgMedium): HResult;
begin
  Result := E_NOTIMPL;
end;

function TdxDragAndDropDataObject.QueryGetData(const formatetc
  : TFormatEtc): HResult;
const
...
function TdxDragAndDropDataObject.GetCanonicalFormatEtc(const formatetc
  : TFormatEtc; out formatetcOut: TFormatEtc): HResult;
begin
  Result := E_NOTIMPL;
end;

function TdxDragAndDropDataObject.SetData(const formatetc: TFormatEtc;
  var medium: TStgMedium; fRelease: BOOL): HResult;
var
  AFormat: string;
begin
...
function TdxDragAndDropDataObject.EnumFormatEtc(dwDirection: Longint;
  out EnumFormatEtc: IEnumFormatEtc): HResult;
begin
...
function TdxDragAndDropDataObject.DAdvise(const formatetc: TFormatEtc;
  advf: Longint; const advSink: IAdviseSink; out dwConnection: Longint)
  : HResult;
begin
  Result := E_NOTIMPL;
end;
...
function TdxDragAndDropDataObject.EnumDAdvise(out enumAdvise
...
function TdxDragAndDropDataObject.ContainsData(const AFormat: string;
  AutoConvert: Boolean = True): Boolean;
begin
  Result := FDataObjects.ContainsKey(AFormat);
end;

function TdxDragAndDropDataObject.GetData(const AFormat: string;
  AutoConvert: Boolean = False): TBytes;
var
  AItem: TdxDataObjectItem;
begin
...
function TdxDragAndDropDataObject.GetFormats(AutoConvert: Boolean = True)
  : TArray<string>;
begin
...
procedure TdxDragAndDropDataObject.SetData(const AFormat: string; const AData);
begin
  SetData(AFormat, True, AData);
end;
...
constructor TdxDragAndDropExternalDataObject.Create(const ADataObject
  : IDataObject);
begin
  inherited Create;
  FDataObject := ADataObject;
...
function TdxDragAndDropExternalDataObject.GetFormatetc(const AFormat: string)
  : TFormatEtc;
begin
...
function TdxDragAndDropExternalDataObject.GetData(const formatetcIn: TFormatEtc;
  out medium: TStgMedium): HResult;
begin
  Result := FDataObject.GetData(formatetcIn, medium);
end;

function TdxDragAndDropExternalDataObject.GetDataHere(const formatetc
  : TFormatEtc; out medium: TStgMedium): HResult;
begin
  Result := FDataObject.GetDataHere(formatetc, medium);
end;

function TdxDragAndDropExternalDataObject.QueryGetData(const formatetc
  : TFormatEtc): HResult;
begin
  Result := FDataObject.QueryGetData(formatetc);
end;

function TdxDragAndDropExternalDataObject.GetCanonicalFormatEtc(const formatetc
  : TFormatEtc; out formatetcOut: TFormatEtc): HResult;
begin
  Result := FDataObject.GetCanonicalFormatEtc(formatetc, formatetcOut);
end;

function TdxDragAndDropExternalDataObject.SetData(const formatetc: TFormatEtc;
  var medium: TStgMedium; fRelease: BOOL): HResult;
begin
  Result := FDataObject.SetData(formatetc, medium, fRelease);
end;

function TdxDragAndDropExternalDataObject.EnumFormatEtc(dwDirection: Longint;
  out EnumFormatEtc: IEnumFormatEtc): HResult;
begin
  Result := FDataObject.EnumFormatEtc(dwDirection, EnumFormatEtc);
end;

function TdxDragAndDropExternalDataObject.DAdvise(const formatetc: TFormatEtc;
  advf: Longint; const advSink: IAdviseSink; out dwConnection: Longint)
  : HResult;
begin
...
function TdxDragAndDropExternalDataObject.DUnadvise(dwConnection
  : Longint): HResult;
begin
  Result := FDataObject.DUnadvise(dwConnection);
end;

function TdxDragAndDropExternalDataObject.EnumDAdvise(out enumAdvise
  : IEnumStatData): HResult;
begin
  Result := FDataObject.EnumDAdvise(enumAdvise);
end;

function TdxDragAndDropExternalDataObject.ContainsData(const AFormat: string;
  AutoConvert: Boolean = True): Boolean;
var
...
function TdxDragAndDropExternalDataObject.GetData(const AFormat: string;
  AutoConvert: Boolean = False): TBytes;
var
  AFormatetc: TFormatEtc;
  AMedium: TStgMedium;
...
procedure TdxDragAndDropExternalDataObject.SetData(const AFormat: string;
  const AData);
begin
...
function TdxDragAndDropExternalDataObject.GetFormats
...
function TdxDataObjectPasteSource.ContainsData(const AFormat: string;
  AutoConvert: Boolean): Boolean;
begin
  Result := (DataObject <> nil) and DataObject.ContainsData(AFormat,
    AutoConvert);
end;

function TdxDataObjectPasteSource.GetData(const AFormat: string;
  AutoConvert: Boolean = False): TBytes;
begin
...
begin
  ...
  FFormats.AddOrSetValue(TdxOfficeDataFormats.SuppressStoreImageSize,
    CF_SuppressStoreImageSize);
  ...
  FFormats.AddOrSetValue(TdxOfficeDataFormats.RtfWithoutObjects,
    CF_RTFWithoutObjects);
  FFormats.AddOrSetValue(TdxOfficeDataFormats.XMLSpreadsheet,
    CF_XMLSpreadsheet);
...
begin
  FFormatDataObjectItems.AddOrSetValue(TdxOfficeDataFormats.Text,
    TdxDataObjectAnsiItem);
  FFormatDataObjectItems.AddOrSetValue(TdxOfficeDataFormats.UnicodeText,
    TdxDataObjectUnicodeItem);
  FFormatDataObjectItems.AddOrSetValue
    (TdxOfficeDataFormats.SuppressStoreImageSize, TdxDataObjectAnsiItem);
  FFormatDataObjectItems.AddOrSetValue(TdxOfficeDataFormats.FileDrop,
    TdxDataObjectUnicodeItem);
  FFormatDataObjectItems.AddOrSetValue(TdxOfficeDataFormats.Rtf,
    TdxDataObjectAnsiItem);
  FFormatDataObjectItems.AddOrSetValue(TdxOfficeDataFormats.RtfWithoutObjects,
    TdxDataObjectAnsiItem);
end;
...
CF_XMLSpreadsheet := RegisterClipboardFormat
  (TdxOfficeDataFormats.XMLSpreadsheet);
CF_SuppressStoreImageSize := RegisterClipboardFormat
  (TdxOfficeDataFormats.SuppressStoreImageSize);
CF_RTFWithoutObjects := RegisterClipboardFormat
  (TdxOfficeDataFormats.RtfWithoutObjects);
CF_MsSourceUrl := RegisterClipboardFormat(TdxOfficeDataFormats.MsSourceUrl);
FFormats := TdxNamedOrdinalDictionary<Word>.Create;
PopulateFormats;
FFormatDataObjectItems :=
  TdxNamedOrdinalDictionary<TdxDataObjectItemClass>.Create;
