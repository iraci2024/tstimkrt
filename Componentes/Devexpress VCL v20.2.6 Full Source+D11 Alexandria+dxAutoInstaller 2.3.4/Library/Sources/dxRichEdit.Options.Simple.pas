...
type
  ...
  TdxSimpleDocumentCapabilitiesOptions = class
  ...
  published
    property CharacterFormatting: TdxDocumentCapability
      read FCharacterFormatting write SetCharacterFormatting
      default TdxDocumentCapability.Default;
    property Hyperlinks: TdxDocumentCapability read FHyperlinks
      write SetHyperlinks default TdxDocumentCapability.Default;
    property InlinePictures: TdxDocumentCapability read FInlinePictures
      write SetInlinePictures default TdxDocumentCapability.Default;
    property ParagraphFormatting: TdxDocumentCapability
      read FParagraphFormatting write SetParagraphFormatting
      default TdxDocumentCapability.Default;
  end;

  { TdxSimpleFormattingMarkVisibilityOptions }

  TdxSimpleFormattingMarkVisibilityOptions = class
  ...
  private
    ...
    procedure SetParagraphMark(const Value
  ...
  public
    // for internal use
    property ShowHiddenText: Boolean read FShowHiddenText
      write SetShowHiddenText;
  published
    property ParagraphMark: TdxRichEditFormattingMarkVisibility
      read FParagraphMark write SetParagraphMark
      default DefaultParagraphMarkVisibility;
    property Space: TdxRichEditFormattingMarkVisibility read FSpace
      write SetSpace default DefaultSpaceVisibility;
    property HiddenText: TdxRichEditFormattingMarkVisibility read FHiddenText
      write SetHiddenText default DefaultHiddenTextVisibility;
  end;
...
function TdxSimpleDocumentCapabilitiesOptions.
...
procedure TdxSimpleDocumentCapabilitiesOptions.SetCharacterFormatting
...
procedure TdxSimpleDocumentCapabilitiesOptions.SetHyperlinks
  (const Value: TdxDocumentCapability);
begin
...
procedure TdxSimpleDocumentCapabilitiesOptions.SetInlinePictures
  (const Value: TdxDocumentCapability);
begin
...
procedure TdxSimpleDocumentCapabilitiesOptions.SetParagraphFormatting
  (const Value: TdxDocumentCapability);
begin
...
procedure TdxSimpleFormattingMarkVisibilityOptions.SetHiddenText
...
procedure TdxSimpleFormattingMarkVisibilityOptions.SetParagraphMark
  (const Value: TdxRichEditFormattingMarkVisibility);
begin
...
procedure TdxSimpleFormattingMarkVisibilityOptions.SetShowHiddenText
  (const Value: Boolean);
begin
...
procedure TdxSimpleFormattingMarkVisibilityOptions.SetSpace
  (const Value: TdxRichEditFormattingMarkVisibility);
begin
  if Space <> Value then
  begin
...
constructor TdxFieldUpdateOnLoadOptions.Create(AUpdateDateField,
  AUpdateTimeField: Boolean);
begin
  inherited Create;
