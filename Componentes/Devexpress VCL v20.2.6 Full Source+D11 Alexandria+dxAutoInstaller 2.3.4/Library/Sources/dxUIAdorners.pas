...
uses
  Windows, Classes, Controls, Messages, Graphics, ComCtrls, cxClasses,
  cxControls, cxGraphics, dxGDIPlusClasses, cxGeometry,
...
type
  ...
  TdxAdornerCustomDrawEvent = procedure(AManager: TdxUIAdornerManager;
    AAdorner: TdxCustomAdorner; ACanvas: TdxGPCanvas;
    AViewInfo: TdxCustomAdornerViewInfo; var ADone: Boolean) of object;
  TdxAdornerNotifyEvent = procedure(AManager: TdxUIAdornerManager;
    AAdorner: TdxCustomAdorner) of object;
  TdxAdornersNotifyEvent = procedure(AManager: TdxUIAdornerManager;
    AAdorners: TdxCustomAdorners) of object;
  TdxGuideGetCalloutPopupControl = procedure(AManager: TdxUIAdornerManager;
    AGuide: TdxGuide;
{$IFDEF BCBCOMPATIBLE}var {$ELSE}out
    {$ENDIF} AControl: TWinControl) of object;
  ...
  TdxUIAdornerManagerCustomDesignHelperClass = class of
    TdxUIAdornerManagerCustomDesignHelper;
  ...
  protected
    ...
    function IsCoverChanged(AChangedHandle: HWND;
      ABounds, AOldBounds: TRect): Boolean;
    function IsFullyCovered: Boolean;
    function IsPositionChanged(AChangedHandle: HWND;
      AWasControlAvailable: Boolean): Boolean;
  ...
  strict private
    ...
    class function DoFindElement(const APath: string; AElements: TStrings)
      : IdxAdornerTargetElement; overload;
    class function DoFindElement(const APath, AParentPath: string;
      AElements: TStrings): IdxAdornerTargetElement; overload;
    class function FindElement(const APath: string;
      AElementCollection: IdxAdornerTargetElementCollection)
      : IdxAdornerTargetElement; overload;
    class function FindElement(const APath: string; AElements: TStrings)
      : IdxAdornerTargetElement; overload;
    class function PopulateElement(ANodes: TTreeNodes; AParentNode: TTreeNode;
      AElement: TObject; AElementName: string): Boolean;
    class function PopulateElements(ANodes: TTreeNodes; AParentNode: TTreeNode;
      AElements: TStrings): Boolean; overload;
    class function PopulateElements(ANodes: TTreeNodes; AParentNode: TTreeNode;
      AElementCollection: IdxAdornerTargetElementCollection): Boolean; overload;

    // IdxAdornerTargetElementCollection
    procedure GetElements(AList: TStrings);
  protected
    procedure Build(ANodes: TTreeNodes); overload;
    class function CreateInstance(AManager: TdxUIAdornerManager)
      : TdxUIAdornerManagerTargetElementTree; virtual;
    function FindElement(const APath: string): IdxAdornerTargetElement;
      overload;
  ...
  public
    ...
    class procedure Build(AManager: TdxUIAdornerManager;
      ANodes: TTreeNodes); overload;
    class function FindElement(AManager: TdxUIAdornerManager;
      const APath: string): IdxAdornerTargetElement; overload;
  end;
  ...
  protected
    ...
    property OwnerControlWndProcObject: TcxWindowProcLinkedObject
      read FOwnerControlWndProcObject;
  ...
  public
    constructor Create(AViewInfo: TdxCustomAdornerViewInfo;
      ACanvas: TdxGPCanvas); virtual;
  ...
  public
    constructor Create(AViewInfo: TdxGuideLayerViewInfo;
      ACanvas: TdxGPCanvas); virtual;
  ...
  protected
    ...
    function CreatePainter(ACanvas: TdxGPCanvas): TdxCustomAdornerPainter;
      virtual; abstract;
  ...
  protected
    function CreatePainter(ACanvas: TdxGPCanvas)
      : TdxCustomAdornerPainter; override;
  ...
  TdxGuideViewInfo = class(TdxCustomAdornerViewInfo, IcxMouseTrackingCaller,
  ...
  protected
    ...
    function CreateHitTest(const APoint: TPoint)
      : TdxAdornerCustomHitTest; virtual;
    function CreatePainter(ACanvas: TdxGPCanvas)
      : TdxCustomAdornerPainter; override;
    ...
    procedure DoCalculate; override;
    function DoGetHitTest(const APoint: TPoint)
      : TdxAdornerCustomHitTest; virtual;
    function GetHitTest(const APoint: TPoint): TdxAdornerCustomHitTest;
      overload;
  ...
  strict private
    ...
    function GetTargetElementClassName(AValue: TdxAdornerCustomTargetElement)
      : string; overload;
  ...
  protected
    ...
    function GetDefaultTargetElementClass
      : TdxAdornerCustomTargetElementClass; virtual;
    function GetDisplayName: string; override;
    ...
    procedure DoChanged;
    procedure DoClick;
    procedure DoCustomDraw(AViewInfo: TdxCustomAdornerViewInfo;
  ...
  public
    ...
    property Manager: TdxUIAdornerManager read GetManager;
    property TargetElementClass: TdxAdornerCustomTargetElementClass
      read FTargetElementClass write SetTargetElementClass;
  published
    property TargetElementClassName: string read GetTargetElementClassName
      write SetTargetElementClassName stored IsTargetElementClassNameStored;
    property TargetElement: TdxAdornerCustomTargetElement read FTargetElement
      write SetTargetElement;
    property Visible: Boolean read FVisible write SetVisible default True;
    property OnChanged: TdxAdornerNotifyEvent read FOnChanged
      write SetOnChanged;
    property OnClick: TdxAdornerNotifyEvent read FOnClick write SetOnClick;
    property OnCustomDraw: TdxAdornerCustomDrawEvent read FOnCustomDraw
      write SetOnCustomDraw;
    property OnCustomDrawBackground: TdxAdornerCustomDrawEvent
      read FOnCustomDrawBackground write SetOnCustomDrawBackground;
  end;
  ...
  protected
    ...
    property OwnedScaledControl: TWinControl read FOwnedScaledControl
      write SetOwnedScaledControl;
  ...
  published
    ...
    property Background: TdxBadgeBackground read FBackground
      write SetBackground;
  ...
  strict private
    ...
    procedure SetOnGetCalloutPopupControl
      (AValue: TdxGuideGetCalloutPopupControl);
  protected
  ...
  published
    property AllowCalloutPopup: Boolean read FAllowCalloutPopup
      write SetAllowCalloutPopup default True;
    property BorderColor: TColor read FBorderColor write SetBorderColor
      default clDefault;
    property CalloutPopupAlignment: TdxCalloutPopupAlignment
      read FCalloutPopupAlignment write SetCalloutPopupAlignment
      default cpaBottomCenter;
    property TabOrder: TTabOrder read FTabOrder write SetTabOrder default 0;
    property OnGetCalloutPopupControl: TdxGuideGetCalloutPopupControl
      read FOnGetCalloutPopupControl write SetOnGetCalloutPopupControl;
  end;
  ...
  protected
    ...
    procedure SelectNext(AGuide: TdxGuide; AGoForward: Boolean = True);
      overload; virtual;
  ...
  protected
    ...
    procedure CheckAdornerCovers(AChangedHandle: HWND;
      ABounds, AOldBounds: TRect); virtual;
  ...
  public
    ...
    property Items[Index: Integer]: TdxCustomAdorner read GetItem
  ...
  public
    ...
    property Items[Index: Integer]: TdxBadge read GetItem
      write SetItem; default;
  published
    property Color: TColor read FColor write SetColor default clDefault;
    property Font: TFont read FFont write SetFont stored IsFontStored;
  ...
  public
    ...
    property Items[Index: Integer]: TdxGuide read GetItem
      write SetItem; default;
  published
    property AllowArrowKeyNavigation: Boolean read FAllowArrowKeyNavigation
      write SetAllowArrowKeyNavigation default True;
    property AllowTabKeyNavigation: Boolean read FAllowTabKeyNavigation
      write SetAllowTabKeyNavigation default True;
    property BorderColor: TColor read FBorderColor write SetBorderColor
      default clDefault;
    property DeactivateKey: TShortCut read FDeactivateKey write SetDeactivateKey
      stored IsDeactivateKeyStored;
    property LayerColor: TdxAlphaColor read FLayerColor write SetLayerColor
      stored IsLayerColorStored;
  end;
  ...
  strict private
    ...
    procedure SetOnAdornerCustomDrawBackground
      (Value: TdxAdornerCustomDrawEvent);
    procedure SetOnGuideGetCalloutPopupControl
      (AValue: TdxGuideGetCalloutPopupControl);
  protected
    function CreateAdornerTargetElementTree
      : TdxUIAdornerManagerTargetElementTree; virtual;
    ...
    procedure DoAdornerCustomDraw(AItem: TdxCustomAdorner;
      AViewInfo: TdxCustomAdornerViewInfo; ACanvas: TdxGPCanvas;
      var ADone: Boolean);
    procedure DoAdornerCustomDrawBackground(AItem: TdxCustomAdorner;
      AViewInfo: TdxCustomAdornerViewInfo; ACanvas: TdxGPCanvas;
      var ADone: Boolean);
    procedure DoGuideGetCalloutPopupControl(AGuide: TdxGuide;
      out AControl: TWinControl);

    property DesignHelper: TdxUIAdornerManagerCustomDesignHelper
      read GetDesignHelper;
  ...
  published
    ...
    property OnActiveChanged: TdxAdornersNotifyEvent read FOnActiveChanged
      write SetOnActiveChanged;
    property OnAdornerChanged: TdxAdornerNotifyEvent read FOnAdornerChanged
      write SetOnAdornerChanged;
    property OnAdornerClick: TdxAdornerNotifyEvent read FOnAdornerClick
      write SetOnAdornerClick;
    property OnAdornerCustomDraw: TdxAdornerCustomDrawEvent
      read FOnAdornerCustomDraw write SetOnAdornerCustomDraw;
    property OnAdornerCustomDrawBackground: TdxAdornerCustomDrawEvent
      read FOnAdornerCustomDrawBackground
      write SetOnAdornerCustomDrawBackground;
    property OnGuideGetCalloutPopupControl: TdxGuideGetCalloutPopupControl
      read FOnGuideGetCalloutPopupControl
...
var
  dxUIAdornerManagerDesignHelperClass
    : TdxUIAdornerManagerCustomDesignHelperClass;
...
uses
  Forms, Types, Menus, RTLConsts, SysUtils, Math, dxCore, cxEditConsts,
  dxGDIPlusAPI, dxSkinsCore, dxHooks,
...
type
  ...
  strict private
    ...
    function GetInstance(AClass: TdxAdornerCustomHitTestClass)
      : TdxAdornerCustomHitTest;
    function GetItem(Index: Integer): TdxAdornerCustomHitTest; inline;
  protected
    function GetObjectByClass(AClass: TdxAdornerCustomHitTestClass)
      : TdxAdornerCustomHitTest;
  ...
  public
    ...
    property Instances[AClass: TdxAdornerCustomHitTestClass]
      : TdxAdornerCustomHitTest read GetInstance; default;
  end;
  ...
  protected
    class procedure CheckAdornerCovers(AChangedHandle: HWND;
      AWindowPos: PWindowPos); overload;
    class procedure CheckAdornerCovers(AChangedHandle: HWND;
      ABounds, AOldBounds: TRect); overload;
    class procedure CheckAdornerCovers(AChangedHandle: HWND;
      ABounds, AOldBounds: TRect; AManager: TdxUIAdornerManager); overload;
    class procedure CheckAdornerPositions(AChangedHandle: HWND); overload;
    class procedure CheckAdornerPositions(AChangedHandle: HWND;
      AManager: TdxUIAdornerManager); overload;
    class procedure WindowPosChangedMessageHandler(AHandle: HWND;
      AWindowPos: PWindowPos);
    class procedure WndProc(ACode: Integer; AWParam: WPARAM; ALParam: LPARAM;
...
begin
  ...
  begin
    ...
    FGuideNormalBorderGlyph.LoadFromResource(HInstance,
      'CX_GUIDENORMALBORDERS', 'PNG');
  end;
...
begin
  ...
  begin
    ...
    FGuideSelectedBorderGlyph.LoadFromResource(HInstance,
      'CX_GUIDESELECTEDBORDERS', 'PNG');
  end;
...
procedure dxManagerWndProcHook(ACode: Integer; AWParam: WPARAM; ALParam: LPARAM;
  var AHookResult: LRESULT);
begin
  TdxUIAdornerManagerHookController.WndProc(ACode, AWParam, ALParam,
    AHookResult);
end;
...
begin
  Result := (Application.MainForm <> nil) and
...
function TdxHitTests.GetInstance(AClass: TdxAdornerCustomHitTestClass)
  : TdxAdornerCustomHitTest;
begin
...
function TdxHitTests.GetObjectByClass(AClass: TdxAdornerCustomHitTestClass)
  : TdxAdornerCustomHitTest;
var
  I: Integer;
begin
...
class procedure TdxUIAdornerManagerHookController.CheckAdornerCovers
  (AChangedHandle: HWND; AWindowPos: PWindowPos);
var
  ABounds, AOldBounds: TRect;
...
begin
  ...
  ABounds := Rect(AWindowPos^.X, AWindowPos^.Y, AWindowPos^.X + AWindowPos^.cx,
    AWindowPos^.Y + AWindowPos^.cy);
...
class procedure TdxUIAdornerManagerHookController.CheckAdornerCovers
  (AChangedHandle: HWND; ABounds, AOldBounds: TRect);
var
  I: Integer;
begin
  for I := 0 to dxRegisteredManagers.Count - 1 do
    CheckAdornerCovers(AChangedHandle, ABounds, AOldBounds,
      TdxUIAdornerManager(dxRegisteredManagers[I]));
end;
...
class procedure TdxUIAdornerManagerHookController.CheckAdornerPositions
  (AChangedHandle: HWND; AManager: TdxUIAdornerManager);
begin
...
begin
  for I := 0 to dxRegisteredManagers.Count - 1 do
    CheckAdornerPositions(AChangedHandle,
      TdxUIAdornerManager(dxRegisteredManagers[I]));
end;

class procedure TdxUIAdornerManagerHookController.WindowPosChangedMessageHandler
  (AHandle: HWND; AWindowPos: PWindowPos);
const
  AFlags = SWP_SHOWWINDOW or SWP_HIDEWINDOW;
  ANoFlags = SWP_NOSIZE or SWP_NOMOVE or SWP_NOZORDER;
begin
  if (AWindowPos^.flags and AFlags = 0) and
    (AWindowPos^.flags and ANoFlags = ANoFlags) then
    Exit;
  CheckAdornerPositions(AHandle);
  CheckAdornerCovers(AHandle, AWindowPos);
end;

class procedure TdxUIAdornerManagerHookController.WndProc(ACode: Integer;
  AWParam: WPARAM; ALParam: LPARAM; var AHookResult: LRESULT);
var
  AMessage: PCWPStruct;
begin
  ...
  case AMessage.Message of
    WM_WINDOWPOSCHANGED:
      WindowPosChangedMessageHandler(AMessage.HWND,
        PWindowPos(AMessage.LPARAM));
...
procedure TdxUIAdornerManagerCustomDesignHelper.DesignSelectionChanged
  (ASelection: TList);
begin
  Manager.Update;
end;
...
begin
  Result := HasControl and IsControlVisible(Control) and
    not cxRectIsEmpty(Bounds) and VisibleForControl and VisibleForParents and
    not IsFullyCovered;
end;
...
function TdxAdornerCustomTargetElement.IsCoverChanged(AChangedHandle: HWND;
  ABounds, AOldBounds: TRect): Boolean;
var
  AHandle: HWND;
begin
  ...
  try
    Result := False;
    if HasControl and IsControlVisible(Control) and
      (cxRectIntersect(ScreenBounds, AOldBounds) or
  ...
  try
    ...
    begin
      ...
      begin
        ...
        try
          Result := CombineRgn(AElementRegion, AElementRegion, ARegion,
            RGN_DIFF) = NULLREGION;
        finally
...
function TdxAdornerCustomTargetElement.IsPositionChanged(AChangedHandle: HWND;
  AWasControlAvailable: Boolean): Boolean;
var
...
begin
  ...
  try
    ...
    Result := AIsControlAvailable and ((AChangedHandle = Control.Handle) or
      IsChild(AChangedHandle, Control.Handle)) or not AIsControlAvailable and
      AWasControlAvailable;
  finally
    EndUseCache;
  end;
end;

procedure TdxAdornerCustomTargetElement.TargetControlFreed(ATargetControl
  : TControl);
begin
  // do nothing
end;
...
procedure TdxAdornerTargetElementControl.AssignControlByElement
  (AElement: TdxAdornerTargetElementControl);
var
...
procedure TdxAdornerTargetElementControl.TargetControlFreed(ATargetControl
  : TControl);
begin
...
procedure TdxAdornerTargetElementControl.ControlFreeNotificationHandler
  (Sender: TComponent);
begin
...
begin
  if IsUsingCache then
    ...
    Result := TdxUIAdornerManagerTargetElementTree.FindElement
      (Adorner.Manager, Path)
  else
    Result := nil;
end;
...
constructor TdxUIAdornerManagerTargetElementTree.Create
  (AManager: TdxUIAdornerManager);
begin
  inherited Create;
  FManager := AManager;
...
class function TdxUIAdornerManagerTargetElementTree.CreateInstance
  (AManager: TdxUIAdornerManager): TdxUIAdornerManagerTargetElementTree;
begin
  Result := TdxUIAdornerManagerTargetElementTree.Create(AManager);
end;

function TdxUIAdornerManagerTargetElementTree.FindElement(const APath: string)
  : IdxAdornerTargetElement;
begin
  Result := FindElement(APath, Self);
end;

class procedure TdxUIAdornerManagerTargetElementTree.Build
  (AManager: TdxUIAdornerManager; ANodes: TTreeNodes);
var
...
class function TdxUIAdornerManagerTargetElementTree.FindElement
  (AManager: TdxUIAdornerManager; const APath: string): IdxAdornerTargetElement;
var
  AInstance: TdxUIAdornerManagerTargetElementTree;
begin
  AInstance := CreateInstance(AManager);
...
class function TdxUIAdornerManagerTargetElementTree.DoFindElement
  (const APath: string; AElements: TStrings): IdxAdornerTargetElement;
var
  AElementIndex: Integer;
begin
  AElementIndex := AElements.IndexOf(APath);
  if (AElementIndex = -1) or not Supports(AElements.Objects[AElementIndex],
    IdxAdornerTargetElement, Result) then
    Result := nil;
end;

class function TdxUIAdornerManagerTargetElementTree.DoFindElement(const APath,
  AParentPath: string; AElements: TStrings): IdxAdornerTargetElement;
var
  AParentIndex: Integer;
  AIntfElementCollection: IdxAdornerTargetElementCollection;
begin
  AParentIndex := AElements.IndexOf(AParentPath);
  if (AParentIndex <> -1) and Supports(AElements.Objects[AParentIndex],
    IdxAdornerTargetElementCollection, AIntfElementCollection) then
...
class function TdxUIAdornerManagerTargetElementTree.FindElement
  (const APath: string; AElementCollection: IdxAdornerTargetElementCollection)
  : IdxAdornerTargetElement;
var
  AElements: TStrings;
begin
...
begin
  ...
  begin
    ...
    AElementPath := Copy(APath, ASeparatorPos + 1,
      Length(APath) - ASeparatorPos);
    Result := DoFindElement(AElementPath, AParentPath, AElements);
  end
end;

class function TdxUIAdornerManagerTargetElementTree.PopulateElement
  (ANodes: TTreeNodes; AParentNode: TTreeNode; AElement: TObject;
  AElementName: string): Boolean;
var
  ANode: TTreeNode;
  AIsParent: Boolean;
...
begin
  ...
  AIsParent := Supports(AElement, IdxAdornerTargetElementCollection,
    AIntfElementCollection);
  if Result or AIsParent then
  begin
    ANode := ANodes.AddChild(AParentNode, AElementName);
    ANode.Data := Pointer(Result);
    if AIsParent then
      Result := PopulateElements(ANodes, ANode, AIntfElementCollection)
        or Result;
    if not Result then
      ANodes.Delete(ANode);
  end;
...
class function TdxUIAdornerManagerTargetElementTree.PopulateElements
  (ANodes: TTreeNodes; AParentNode: TTreeNode; AElements: TStrings): Boolean;
var
  I: Integer;
begin
  Result := False;
  for I := 0 to AElements.Count - 1 do
    Result := PopulateElement(ANodes, AParentNode, AElements.Objects[I],
      AElements[I]) or Result;
end;
...
begin
  ...
  begin
    ...
    if not(csDestroying in AComponent.ComponentState) and
      (AComponent.Name <> '') and Supports(AComponent,
      IdxAdornerRootTargetElement, AInfRootElement) then
...
procedure TdxUIAdornerManagerCustomLayeredWindow.CreateParams
...
procedure TdxBadgeLayeredWindow.MouseDown(Button: TMouseButton;
...
procedure TdxBadgeLayeredWindow.MouseMove(Shift: TShiftState; X: Integer;
  Y: Integer);
begin
...
procedure TdxBadgeLayeredWindow.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X: Integer; Y: Integer);
begin
...
begin
  inherited Create(nil);
  FGuides := AGuides;
  FOwnerControlWndProcObject := cxWindowProcController.Add(OwnerControl,
    OwnerWindowWndProc);
end;
...
procedure TdxGuideLayeredWindow.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X: Integer; Y: Integer);
begin
  inherited MouseDown(Button, Shift, X, Y);
...
procedure TdxGuideLayeredWindow.MouseMove(Shift: TShiftState; X: Integer;
  Y: Integer);
begin
  inherited MouseMove(Shift, X, Y);
...
procedure TdxGuideLayeredWindow.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X: Integer; Y: Integer);
begin
  inherited MouseUp(Button, Shift, X, Y);
...
procedure TdxGuideLayeredWindow.WMWindowPosChanged
...
begin
  ...
  else if Message.WindowPos^.flags and SWP_HIDEWINDOW = SWP_HIDEWINDOW then
...
class function TdxAdornerCustomHitTest.Instance(const APos: TPoint)
  : TdxAdornerCustomHitTest;
begin
...
constructor TdxCustomAdornerPainter.Create(AViewInfo: TdxCustomAdornerViewInfo;
  ACanvas: TdxGPCanvas);
begin
  inherited Create;
  FViewInfo := AViewInfo;
...
begin
  ...
  begin
    Canvas.Rectangle(ARect, dxColorToAlphaColor(clBlack),
      dxColorToAlphaColor(clBlack, 0));
...
begin
  ADC := Canvas.GetHDC;
  try
    dxDrawTextOnGlass(ADC, ViewInfo.Text, ViewInfo.Font,
      ViewInfo.TextAreaBounds, ViewInfo.Font.Color, ViewInfo.TextFlags,
      0, True);
  finally
    Canvas.ReleaseHDC(ADC);
  end;
...
begin
  ...
  try
    ...
    try
      cxDrawImage(ABitmap.cxCanvas, ABitmap.ClientRect, ViewInfo.Glyph,
        ViewInfo.Images, ViewInfo.ImageIndex, ViewInfo.FitMode, idmNormal, True,
        nil, ViewInfo.ScaleFactor);
    ...
    dxGpDrawImage(Canvas.Handle, ViewInfo.Bounds, cxRect(AGlyph.Size),
      AGlyph.Handle);
  finally
    AGlyph.Free;
  end;
...
begin
  dxGPDrawText(Canvas, ViewInfo.Text, ViewInfo.TextAreaBounds, ViewInfo.Font,
    dxColorToAlphaColor(ViewInfo.Font.Color), taCenter, taVerticalCenter, False,
    TextRenderingHintAntiAlias, StringTrimmingEllipsisCharacter,
...
constructor TdxGuideLayerPainter.Create(AViewInfo: TdxGuideLayerViewInfo;
  ACanvas: TdxGPCanvas);
begin
  inherited Create;
  FViewInfo := AViewInfo;
...
const
  ASubstrateAlpha = 1;
begin
  Canvas.FillRectangle(ViewInfo.Bounds, dxColorToAlphaColor(ViewInfo.LayerColor,
    ASubstrateAlpha));
end;
...
begin
  Result := Adorner.Adorners.Active and Adorner.Visible and
    Adorner.TargetElementVisible;
end;
...
procedure TdxCustomAdornerViewInfo.MouseDown(X, Y: Integer;
...
procedure TdxCustomAdornerViewInfo.MouseMove(X, Y: Integer;
  AShift: TShiftState);
begin
  // do nothing
end;

procedure TdxCustomAdornerViewInfo.MouseUp(X, Y: Integer; AButton: TMouseButton;
  AShift: TShiftState);
begin
  // do nothing
end;
...
function TdxCustomAdornerViewInfo.CustomDrawBackground
  (ACanvas: TdxGPCanvas): Boolean;
begin
  Result := False;
...
begin
  Result := Manager.HasDesignHelper and
    Manager.DesignHelper.IsObjectSelected(Adorner);
end;

function TdxCustomAdornerViewInfo.GetTargetElement
  : TdxAdornerCustomTargetElement;
begin
...
function TdxBadgeViewInfo.CreatePainter(ACanvas: TdxGPCanvas)
  : TdxCustomAdornerPainter;
begin
...
begin
  ...
  if Result = 0 then
  begin
    Result := Adorner.TextMargins.Top + TextSize.cy +
      Adorner.TextMargins.Bottom;
    if HasGlyph then
      Result := Max(Result, dxGetImageSize(Glyph, Images, ImageIndex,
        ScaleFactor).cy)
    else
...
begin
  Result := DT_CENTER or DT_VCENTER or DT_SINGLELINE or DT_END_ELLIPSIS or
    DT_NOPREFIX;
...
begin
  ...
  begin
    ...
    if AParent.UseRightToLeftAlignment and dxWindowHasRightToLeftLayout
      (AParent.Handle) then
...
begin
  ...
  if Result = 0 then
  begin
    Result := Adorner.TextMargins.Left + TextSize.cx +
      Adorner.TextMargins.Right;
    if HasGlyph then
      Result := Max(Result, dxGetImageSize(Glyph, Images, ImageIndex,
        ScaleFactor).cx)
    else
...
function TdxGuideViewInfo.CreateHitTest(const APoint: TPoint)
  : TdxAdornerCustomHitTest;
begin
  Result := TdxGuideHitTest.Instance(APoint);
end;

function TdxGuideViewInfo.CreatePainter(ACanvas: TdxGPCanvas)
  : TdxCustomAdornerPainter;
begin
...
function TdxGuideViewInfo.DoGetHitTest(const APoint: TPoint)
  : TdxAdornerCustomHitTest;
begin
...
function TdxGuideViewInfo.GetHitTest(const APoint: TPoint)
  : TdxAdornerCustomHitTest;
begin
...
var
  AOffset: TPoint;
begin
  AOffset := cxPointOffset(TargetElement.ScreenBounds.TopLeft,
    Guides.ViewInfo.LayerBounds.TopLeft, False);
  Result := cxRectSetOrigin(TargetElement.ScreenBounds, AOffset);
end;

procedure TdxGuideViewInfo.MouseDown(X, Y: Integer; AButton: TMouseButton;
  AShift: TShiftState);
begin
...
procedure TdxGuideViewInfo.MouseUp(X, Y: Integer; AButton: TMouseButton;
  AShift: TShiftState);
begin
...
function TdxGuideLayerViewInfo.CreateHitTest(const APoint: TPoint)
  : TdxAdornerCustomHitTest;
begin
  Result := TdxAdornerNoneHitTest.Instance(APoint);
end;

function TdxGuideLayerViewInfo.CreatePainter(ACanvas: TdxGPCanvas)
  : TdxGuideLayerPainter;
begin
...
begin
  Result := dxMapWindowRect(Manager.OwnerControl.Handle, 0,
    Manager.OwnerControl.ClientRect);
  if Manager.OwnerControl.UseRightToLeftAlignment and
    dxWindowHasRightToLeftLayout(Manager.OwnerControl.Handle) then
    Result := cxRectOffsetHorz(Result, -cxRectWidth(Result));
end;

procedure TdxGuideLayerViewInfo.CalculateVisibility;
begin
  FVisible := Guides.Active and IsControlVisible(Manager.OwnerControl) and
    not dxIsMainFormIconic;
end;
...
function TdxGuideLayerViewInfo.DoGetHitTest(const APoint: TPoint)
  : TdxAdornerCustomHitTest;
var
  I: Integer;
begin
...
function TdxGuideLayerViewInfo.FindGuideViewInfo(AGuide: TdxGuide)
  : TdxGuideViewInfo;
var
  I: Integer;
begin
...
function TdxGuideLayerViewInfo.GetHitTest(const APoint: TPoint)
  : TdxAdornerCustomHitTest;
begin
  Result := DoGetHitTest(APoint);
end;

function TdxGuideLayerViewInfo.GetHitTest(X, Y: Integer)
  : TdxAdornerCustomHitTest;
begin
  Result := GetHitTest(Point(X, Y));
end;
...
procedure TdxCustomAdorner.CheckCover(AChangedHandle: HWND;
  ABounds, AOldBounds: TRect);
begin
  if Adorners.Active and Visible and HasTargetElement and
    TargetElement.IsCoverChanged(AChangedHandle, ABounds, AOldBounds) then
    Update;
end;
...
function TdxCustomAdorner.GetDefaultTargetElementClass
  : TdxAdornerCustomTargetElementClass;
begin
...
function TdxCustomAdorner.GetManagerFromParent(AParent: TComponent)
  : TdxUIAdornerManager;
begin
...
procedure TdxCustomAdorner.DoCustomDraw(AViewInfo: TdxCustomAdornerViewInfo;
  ACanvas: TdxGPCanvas; var ADone: Boolean);
begin
...
procedure TdxCustomAdorner.DoCustomDrawBackground
  (AViewInfo: TdxCustomAdornerViewInfo; ACanvas: TdxGPCanvas;
  var ADone: Boolean);
begin
...
function TdxCustomAdorner.GetTargetElementClassName
  (AValue: TdxAdornerCustomTargetElement): string;
begin
  if AValue <> nil then
...
procedure TdxCustomAdorner.ScaleFactorChangeHandler(Sender: TObject;
...
procedure TdxCustomAdorner.SetTargetElement
  (AValue: TdxAdornerCustomTargetElement);
begin
...
procedure TdxCustomAdorner.SetTargetElementClass
  (AValue: TdxAdornerCustomTargetElementClass);
begin
  if AValue = nil then
...
begin
  if not SameText(TargetElementClassName, AValue) then
    TargetElementClass := TdxAdornerCustomTargetElementClass
      (dxRegisteredAdornerTargetElementTypes.FindByClassName(AValue));
end;
...
procedure TdxCustomAdorner.SetOnCustomDrawBackground
  (AValue: TdxAdornerCustomDrawEvent);
begin
...
begin
  Result := TcxEditAlignment.Create(Self, dxBadgeDefaultHorz,
    cxEditDefaultVertAlignment);
end;
...
begin
  if Adorners.Active and Visible and HasTargetElement and
    TargetElement.IsPositionChanged(AChangedHandle, ViewInfo.Visible) then
    Update;
end;
...
function TdxBadge.GetCollectionFromParent(AParent: TComponent)
...
procedure TdxBadge.SetOwnedScaledControl(AValue: TWinControl);
  ...
  procedure FindOwnedScaleFactor(out AControl: TWinControl;
    out AOwnedScaleFactor: IdxScaleFactor);
  begin
    AControl := AValue;
    if AControl <> nil then
    begin
    ...
    while not Supports(AControl, IdxScaleFactor, AOwnedScaleFactor) and
      (AControl <> nil) do
...
function TdxGuide.GetCollectionFromParent(AParent: TComponent)
  : TcxComponentCollection;
begin
...
procedure TdxGuide.SetOnGetCalloutPopupControl
  (AValue: TdxGuideGetCalloutPopupControl);
begin
...
procedure TdxGuideController.MouseDown(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
var
...
begin
  ...
  if AHitTest is TdxGuideHitTest then
    TdxGuideHitTest(AHitTest).ViewInfo.MouseDown(AHitTest.Pos.X, AHitTest.Pos.Y,
      Button, Shift)
  else
    CalloutPopup.Close;
end;
...
begin
  AHitTest := Guides.ViewInfo.GetHitTest(X, Y);
  if AHitTest is TdxGuideHitTest then
    TdxGuideHitTest(AHitTest).ViewInfo.MouseMove(AHitTest.Pos.X,
      AHitTest.Pos.Y, Shift);
end;

procedure TdxGuideController.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
var
  AHitTest: TdxAdornerCustomHitTest;
begin
  AHitTest := Guides.ViewInfo.GetHitTest(X, Y);
  if AHitTest is TdxGuideHitTest then
    TdxGuideHitTest(AHitTest).ViewInfo.MouseUp(AHitTest.Pos.X, AHitTest.Pos.Y,
      Button, Shift);
end;

procedure TdxGuideController.KeyDown(var Key: Word; Shift: TShiftState);
begin
  if (Guides.DeactivateKey <> scNone) and
    (Guides.DeactivateKey = ShortCut(Key, Shift)) then
  begin
    Guides.Active := False;
    Exit;
  end;
...
begin
  ...
  if AGuide1.TabOrder < AGuide2.TabOrder then
    Result := -1
  else if AGuide1.TabOrder > AGuide2.TabOrder then
    Result := 1
  else
    Result := 0;
end;

function TdxGuideController.FindNext(AGuide: TdxGuide;
  AGoForward: Boolean = True): TdxGuide;
var
  AIndex: Integer;
  ...
  try
    ...
    if AGoForward then
      if AIndex = AList.Count - 1 then
        ...
        Inc(AIndex)
    else if (AIndex = 0) or (AIndex = -1) then
...
procedure TdxGuideController.SelectNext(AGuide: TdxGuide;
...
begin
  ...
  begin
    ...
    Guides.LayeredWindow.ScaleFactor.Assign
      (dxGetScaleFactor(Guides.LayeredWindow.OwnerControl));
...
procedure TdxCustomAdorners.CheckAdornerCovers(AChangedHandle: HWND;
  ABounds, AOldBounds: TRect);
var
  I: Integer;
begin
...
procedure TdxCustomAdorners.Update(AItem: TcxComponentCollectionItem;
...
begin
  ...
  FFont := CreateFont;
  FOwnerControlWndProcObject := cxWindowProcController.Add(Manager.OwnerControl,
    OwnerWindowWndProc);
...
begin
  if Active and Manager.OwnerControl.HandleAllocated and
    ((AChangedHandle = Manager.OwnerControl.Handle) or IsChild(AChangedHandle,
    Manager.OwnerControl.Handle) or IsChild(Manager.OwnerControl.Handle,
    AChangedHandle)) then
    UpdateLayer;
end;
...
procedure TdxGuides.Update(AItem: TcxComponentCollectionItem;
  AAction: TcxComponentCollectionNotification);
begin
  RecreateViewInfo;
  inherited Update(AItem, AAction);
...
begin
  ...
  if not(AOwner is TWinControl) then
    raise EdxException.Create
      (cxGetResourceString(@sdxUIAdornerManagerBadOwner));
  FIsCreating := False;
  inherited Create(AOwner);
...
function TdxUIAdornerManager.CreateAdornerTargetElementTree
  : TdxUIAdornerManagerTargetElementTree;
begin
...
function TdxUIAdornerManager.CreateDesignHelper
  : TdxUIAdornerManagerCustomDesignHelper;
begin
...
procedure TdxUIAdornerManager.CheckAdornerCovers(AChangedHandle: HWND;
  ABounds, AOldBounds: TRect);
begin
...
procedure TdxUIAdornerManager.GetChildren(Proc: TGetChildProc;
  Root: TComponent);
begin
...
procedure TdxUIAdornerManager.Notification(AComponent: TComponent;
...
procedure TdxUIAdornerManager.DoAdornerCustomDraw(AItem: TdxCustomAdorner;
  AViewInfo: TdxCustomAdornerViewInfo; ACanvas: TdxGPCanvas;
  var ADone: Boolean);
begin
...
procedure TdxUIAdornerManager.DoAdornerCustomDrawBackground
  (AItem: TdxCustomAdorner; AViewInfo: TdxCustomAdornerViewInfo;
  ACanvas: TdxGPCanvas; var ADone: Boolean);
begin
...
procedure TdxUIAdornerManager.DoGuideGetCalloutPopupControl(AGuide: TdxGuide;
  out AControl: TWinControl);
begin
...
function TdxUIAdornerManager.GetDesignHelper
  : TdxUIAdornerManagerCustomDesignHelper;
begin
  if IsDesigning and not IsDestroying and (FDesignHelper = nil) and
    (dxUIAdornerManagerDesignHelperClass <> nil) then
...
procedure TdxUIAdornerManager.SetOnActiveChanged
  (AValue: TdxAdornersNotifyEvent);
begin
...
procedure TdxUIAdornerManager.SetOnAdornerChanged
  (AValue: TdxAdornerNotifyEvent);
begin
...
procedure TdxUIAdornerManager.SetOnAdornerCustomDraw
  (Value: TdxAdornerCustomDrawEvent);
begin
...
procedure TdxUIAdornerManager.SetOnAdornerCustomDrawBackground
  (Value: TdxAdornerCustomDrawEvent);
begin
...
procedure TdxUIAdornerManager.SetOnGuideGetCalloutPopupControl
  (AValue: TdxGuideGetCalloutPopupControl);
begin
...
begin
  ...
  dxRegisteredAdornerTargetElementTypes.Register(TdxAdornerTargetElementControl,
    'Control');
  dxRegisteredAdornerTargetElementTypes.Register
    (TdxAdornerTargetElementPath, 'Path');
end;
