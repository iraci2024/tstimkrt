...
type
  ...
  public
    constructor Create(AOutput: TdxMemoryStream; AFootNote: TdxSectionFootNote;
      AIsFootNote: Boolean);
...
constructor TdxDocFootNoteActions.Create(AOutput: TdxMemoryStream;
  AFootNote: TdxSectionFootNote; AIsFootNote: Boolean);
begin
