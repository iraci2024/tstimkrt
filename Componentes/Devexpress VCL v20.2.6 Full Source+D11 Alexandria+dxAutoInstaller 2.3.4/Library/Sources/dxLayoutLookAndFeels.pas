...
{$ENDIF}
  ...
  dxCore, cxGeometry, cxGraphics, cxClasses, cxLookAndFeels,
  cxLookAndFeelPainters, dxLayoutCommon, dxCoreGraphics;
...
type
  ...
  TdxLayoutLookAndFeelCaptionOptionsClass = class of
    TdxLayoutLookAndFeelCaptionOptions;
  ...
  published
    ...
    property TextColor: TColor read FTextColor write SetTextColor
      default clDefault;
    property TextDisabledColor: TColor read FTextDisabledColor
      write SetTextDisabledColor default clDefault;
    ...
    property UseDefaultFont: Boolean read FUseDefaultFont
      write SetUseDefaultFont default True;
  end;
  ...
  public
    ...
    function GetPaddingRect(ATargetScaleFactor: TdxScaleFactor): TRect;
      overload;
  published
    property AssignedValues: TdxLayoutPaddingAssignedValues read FAssignedValues
      write SetAssignedValues default [];
    property Bottom: Integer index 1 read GetValue write SetValue
      stored IsValueStored;
    property Left: Integer index 2 read GetValue write SetValue
      stored IsValueStored;
    property Right: Integer index 3 read GetValue write SetValue
      stored IsValueStored;
    property Top: Integer index 4 read GetValue write SetValue
      stored IsValueStored;
  end;
  ...
  protected
    procedure ChangeScaleCore(M, D: Integer); override;
    function GetCaptionOptionsClass
      : TdxLayoutLookAndFeelCaptionOptionsClass; virtual;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property CaptionOptions: TdxLayoutLookAndFeelCaptionOptions
      read FCaptionOptions write SetCaptionOptions;
    property Padding: TdxLayoutLookAndFeelPadding read FPadding
      write SetPadding;
  end;

  { TdxLayoutLookAndFeelGroupOptions }

  TdxLayoutLookAndFeelGroupOptionsClass = class of
    TdxLayoutLookAndFeelGroupOptions;
  ...
  published
    ...
    property SpaceBetweenButtons: Cardinal read FSpaceBetweenButtons
      write SetSpaceBetweenButtons default 0;
  end;
  ...
  TdxLayoutLookAndFeelItemOptionsClass = class of
    TdxLayoutLookAndFeelItemOptions;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property ControlOffsetHorz: Integer index 0 read GetValue write SetValue
      stored IsValueStored;
    property ControlOffsetVert: Integer index 1 read GetValue write SetValue
      stored IsValueStored;
    property ItemOffset: Integer index 2 read GetValue write SetValue
      stored IsValueStored;
    property ItemsAreaOffsetHorz: Integer index 3 read GetValue write SetValue
      stored IsValueStored;
    property ItemsAreaOffsetVert: Integer index 4 read GetValue write SetValue
      stored IsValueStored;
    property RootItemsAreaOffsetHorz: Integer index 5 read GetValue
      write SetValue stored IsValueStored;
    property RootItemsAreaOffsetVert: Integer index 6 read GetValue
      write SetValue stored IsValueStored;
    property TabSheetContentOffsetHorz: Integer index 7 read GetValue
      write SetValue stored IsValueStored;
    property TabSheetContentOffsetVert: Integer index 8 read GetValue
      write SetValue stored IsValueStored;
  end;
  ...
  protected
    ...
    function GetFrameWidth(ASide, ACaptionSide: TdxLayoutSide)
      : Integer; virtual;
    ...
    function IsGroupTransparent(AViewInfo: TObject { TdxLayoutGroupViewInfo } )
      : Boolean; virtual;
    function IsNativeStyle: Boolean; virtual;
    function IsSkinPainterUsed: Boolean; virtual;

    // options classes
    function GetGroupOptionsClass
      : TdxLayoutLookAndFeelGroupOptionsClass; virtual;
  ...
  public
    ...
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    procedure AssignTo(var ALookAndFeel: TdxCustomLayoutLookAndFeel;
      ATargetPPI: Integer = 0); reintroduce; overload;
    ...
    procedure InitializeSubControlCxLookAndFeel(AcxLookAndFeel
      : TcxLookAndFeel); virtual;
    ...
    // painter classes
    function GetGroupPainterClass: TClass { TdxLayoutGroupPainterClass };
      virtual; abstract;
    function GetBasicItemPainterClass
      : TClass { TdxLayoutBasicItemPainterClass }; virtual;
    function GetEmptySpaceItemPainterClass
      : TClass { TdxLayoutEmptySpaceItemPainter }; virtual;
    function GetItemPainterClass: TClass { TdxLayoutItemPainterClass }; virtual;
    function GetLabeledItemPainterClass
      : TClass { TdxLayoutLabeledItemPainterClass }; virtual;
    function GetSeparatorItemPainterClass
      : TClass { TdxLayoutSeparatorItemPainterClass }; virtual;
    function GetSplitterItemPainterClass
      : TClass { TdxLayoutSplitterItemPainterClass }; virtual;

    // dimensions
    procedure CorrectGroupButtonsAreaBounds
      (AViewInfo: TObject { TdxLayoutGroupViewInfo };
      var ABounds: TRect); virtual;
    procedure CorrectGroupCaptionAreaBounds
      (AViewInfo: TObject { TdxLayoutGroupViewInfo };
      var ABounds: TRect); virtual;
    procedure CorrectGroupMinVisibleSize(AViewInfo
      : TObject { TdxLayoutGroupViewInfo }; var ASize: Integer;
      AOrientation: TdxOrientation); virtual;
    procedure CorrectGroupMinVisibleHeight
      (AViewInfo: TObject { TdxLayoutGroupViewInfo };
      var AHeight: Integer); virtual;
    procedure CorrectGroupMinVisibleWidth
      (AViewInfo: TObject { TdxLayoutGroupViewInfo };
      var AWidth: Integer); virtual;
    procedure CorrectGroupCaptionFont(AViewInfo
      : TObject { TdxLayoutGroupCaptionViewInfo }; AFont: TFont); virtual;
    procedure CorrectGroupCaptionHeight(AViewInfo
      : TObject { TdxLayoutGroupViewInfo }; var AHeight: Integer); virtual;
    procedure CorrectGroupCaptionWidth(AViewInfo
      : TObject { TdxLayoutGroupViewInfo }; var AWidth: Integer); virtual;
    ...
    function GetGroupButtonsOffset(AViewInfo
      : TObject { TdxLayoutGroupViewInfo } ): Integer; virtual;
    function GetGroupBorderOffset(AContainer: TComponent;
      ASide, ACaptionSide: TdxLayoutSide): Integer; virtual;
    function GetTabControlBorderOffset(AContainer: TComponent;
      ASide, ACaptionSide: TdxLayoutSide): Integer; virtual;
    function GetGroupBorderWidth(AContainer: TComponent;
      ASide, ACaptionSide: TdxLayoutSide; AHasCaption, AIsExpanded: Boolean)
      : Integer; virtual;
    function GetGroupCaptionOffset(AViewInfo
      : TObject { TdxLayoutGroupViewInfo } ): Integer; virtual;
    function GetGroupCaptionContentOffsets
      (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TRect; virtual;
    function GetGroupFrameBounds(AViewInfo: TObject { TdxLayoutGroupViewInfo } )
      : TRect; virtual;
    function GetGroupRestSpaceBounds(AViewInfo
      : TObject { TdxLayoutGroupViewInfo } ): TRect; virtual;
    function GetGroupCaptionAlignHorz(AViewInfo
      : TObject { TdxLayoutGroupViewInfo } ): TAlignment; virtual;
    function GetGroupCaptionAlignVert(AViewInfo
      : TObject { TdxLayoutGroupViewInfo } ): TdxAlignmentVert; virtual;
    ...
    function GetRootItemsAreaOffsetHorz(AContainer: TComponent)
      : Integer; virtual;
    function GetRootItemsAreaOffsetVert(AContainer: TComponent)
      : Integer; virtual;
    function GetTabSheetContentOffsetHorz(AContainer: TComponent)
      : Integer; virtual;
    function GetTabSheetContentOffsetVert(AContainer: TComponent)
      : Integer; virtual;
    ...
    procedure DrawItemControlBorder(ACanvas: TcxCanvas;
      AItemOptions: TdxLayoutLookAndFeelItemOptions; R: TRect); virtual;
    // colors
    function GetEmptyAreaColor: TColor; virtual;
    function GetGroupCaptionColor(AViewInfo
      : TObject { TdxLayoutGroupViewInfo } ): TColor; virtual;
    function GetGroupButtonColorPalette(AState: TcxButtonState)
      : IdxColorPalette; virtual;
    function GetItemCaptionColorPalette: IdxColorPalette; virtual;
    function GetTabbedGroupCaptionColorPalette(AIsActive: Boolean)
      : IdxColorPalette; virtual;

    property FrameWidths[ASide, ACaptionSide: TdxLayoutSide]: Integer
      read GetFrameWidth;
  ...
  published
    ...
    property Offsets: TdxLayoutLookAndFeelOffsets read FOffsets
      write SetOffsets;
  end;
  ...
  protected
    function GetCaptionOptionsClass
      : TdxLayoutLookAndFeelCaptionOptionsClass; override;
  ...
  protected
    function GetGroupOptionsClass
      : TdxLayoutLookAndFeelGroupOptionsClass; override;
    function GetItemOptionsClass: TdxLayoutLookAndFeelItemOptionsClass;
      override;
    function GetFrameWidth(ASide, ACaptionSide: TdxLayoutSide)
      : Integer; override;
  ...
  public
    ...
    function GetGroupPainterClass
      : TClass { TdxLayoutGroupPainterClass }; override;

    procedure CorrectGroupMinVisibleSize(AViewInfo
      : TObject { TdxLayoutGroupViewInfo }; var ASize: Integer;
      AOrientation: TdxOrientation); override;
    function GetGroupBorderWidth(AContainer: TComponent;
      ASide, ACaptionSide: TdxLayoutSide; AHasCaption, AIsExpanded: Boolean)
      : Integer; override;
    function GetGroupCaptionOffset(AViewInfo
      : TObject { TdxLayoutGroupViewInfo } ): Integer; override;
    function GetGroupCaptionContentOffsets
      (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TRect; override;
    function GetGroupFrameBounds(AViewInfo: TObject { TdxLayoutGroupViewInfo } )
      : TRect; override;
  end;
  ...
  published
    ...
    property SeparatorWidth: Integer read FSeparatorWidth
      write SetSeparatorWidth default 0;
  end;
  ...
  strict private
    ...
    procedure SetCaptionOptions
      (Value: TdxLayoutWebLookAndFeelGroupCaptionOptions);
  ...
  private
    ...
    function HasCaptionSeparator(AViewInfo
      : TObject { TdxLayoutGroupViewInfo } ): Boolean;
  protected
  ...
  public
    ...
    procedure CorrectGroupCaptionAreaBounds
      ...
      var ABounds: TRect); override;
    procedure CorrectGroupCaptionHeight(AViewInfo
      : TObject { TdxLayoutGroupViewInfo }; var AHeight: Integer); override;
    procedure CorrectGroupCaptionWidth(AViewInfo
      : TObject { TdxLayoutGroupViewInfo }; var AWidth: Integer); override;
    procedure CorrectGroupMinVisibleSize(AViewInfo
      : TObject { TdxLayoutGroupViewInfo }; var ASize: Integer;
      AOrientation: TdxOrientation); override;
    function GetGroupBorderOffset(AContainer: TComponent;
      ASide, ACaptionSide: TdxLayoutSide): Integer; override;
    function GetGroupBorderWidth(AContainer: TComponent;
      ASide, ACaptionSide: TdxLayoutSide; AHasCaption, AIsExpanded: Boolean)
      : Integer; override;
    function GetGroupCaptionColor(AViewInfo
      : TObject { TdxLayoutGroupViewInfo } ): TColor; override;
    function GetGroupCaptionOffset(AViewInfo
      : TObject { TdxLayoutGroupViewInfo } ): Integer; override;
    function GetGroupCaptionSeparatorAreaBounds
      (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TRect;
    function GetGroupCaptionSeparatorBounds
      (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TRect;
    function GetGroupRestSpaceBounds(AViewInfo
      : TObject { TdxLayoutGroupViewInfo } ): TRect; override;
    function GetGroupCaptionAlignHorz(AViewInfo
      : TObject { TdxCustomLayoutItemViewInfo } ): TAlignment; override;
    function GetGroupCaptionAlignVert(AViewInfo
      : TObject { TdxCustomLayoutItemViewInfo } ): TdxAlignmentVert; override;
  published
    property GroupOptions: TdxLayoutWebLookAndFeelGroupOptions
      read GetGroupOptions write SetGroupOptions;
  end;
  ...
  TdxLayoutCxLookAndFeelItemCaptionOptions = class
    (TdxLayoutLookAndFeelCaptionOptions)
  private
    function GetLookAndFeel: TdxLayoutCxLookAndFeel;
  protected
  ...
  public
    ...
    // dimensions
    procedure CorrectGroupCaptionFont(ACaptionSide: TdxLayoutSide;
      AFont: TFont); reintroduce; overload;
    procedure CorrectGroupCaptionFont(AViewInfo
      : TObject { TdxLayoutGroupCaptionViewInfo }; AFont: TFont);
      overload; override;
    function GetGroupBorderWidth(AContainer: TComponent;
      ASide, ACaptionSide: TdxLayoutSide; AHasCaption, AIsExpanded: Boolean)
      : Integer; override;
    function GetGroupCaptionContentOffsets(AIsVertical: Boolean;
      ACaptionSide: TdxLayoutSide): TRect; reintroduce; overload;
    function GetGroupCaptionContentOffsets
      (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TRect;
      overload; override;
    function GetGroupCaptionOffset(AViewInfo
    ...
    function IsGroupBoxCaptionTextDrawnOverBorder(ACaptionSide
      : TdxLayoutSide): Boolean;

    // drawing routines
    procedure DrawLayoutControlBackground(ACanvas: TcxCanvas;
      const R: TRect); override;
    procedure DrawItemControlBorder(ACanvas: TcxCanvas;
      AItemOptions: TdxLayoutLookAndFeelItemOptions; R: TRect); override;
    ...
    function GetGroupPainterClass
      : TClass { TdxLayoutGroupPainterClass }; override;
    function GetItemPainterClass: TClass { TdxLayoutItemPainterClass };
      override;
    //
  ...
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    function CreateItem(AClass: TdxCustomLayoutLookAndFeelClass)
      : TdxCustomLayoutLookAndFeel;
    property Count: Integer read GetCount;
    property Items[Index: Integer]: TdxCustomLayoutLookAndFeel
  ...
  public
    constructor Create;
    destructor Destroy; override;
    function GetItemByDescription(const Value: string)
    ...
    property Count: Integer read GetCount;
    property Items[Index: Integer]: TdxCustomLayoutLookAndFeelClass
      read GetItem; default;
  end;
...
uses
  UxTheme, Math, SysUtils, Forms, cxControls, dxLayoutContainer,
  dxLayoutPainters, dxDPIAwareUtils;
...
const
  CaptionSideToCaptionPosition: array [TdxLayoutSide]
    of TcxGroupBoxCaptionPosition = (cxgpLeft, cxgpRight, cxgpTop, cxgpBottom);
...
function GroupViewInfo(AViewInfo: TObject { TdxLayoutGroupViewInfo } )
  : TdxLayoutGroupViewInfoAccess;
begin
  Result := TdxLayoutGroupViewInfoAccess(AViewInfo as TdxLayoutGroupViewInfo);
end;

function GroupCaptionViewInfo(AViewInfo: TObject { TdxLayoutGroupViewInfo } )
  : TdxLayoutGroupCaptionViewInfoAccess;
begin
  Result := TdxLayoutGroupCaptionViewInfoAccess(GroupViewInfo(AViewInfo)
    .CaptionViewInfo as TdxLayoutGroupCaptionViewInfo);
end;

function GroupButtonsViewInfo(AViewInfo: TObject { TdxLayoutGroupViewInfo } )
  : TdxLayoutGroupButtonsViewInfo;
begin
  Result := TdxLayoutGroupButtonsViewInfoAccess(GroupViewInfo(AViewInfo)
    .ButtonsViewInfo as TdxLayoutGroupButtonsViewInfo);
end;

function ContainerViewInfo(AViewInfo: TObject { TdxLayoutGroupViewInfo } )
  : TdxLayoutContainerViewInfoAccess;
begin
  Result := TdxLayoutContainerViewInfoAccess(GroupViewInfo(AViewInfo)
    .ContainerViewInfo);
end;

function GetOppositeSide(ASide: TdxLayoutSide): TdxLayoutSide;
const
  ResultMap: array [TdxLayoutSide] of TdxLayoutSide = (sdRight, sdLeft,
    sdBottom, sdTop);
begin
...
constructor TdxCustomLayoutLookAndFeelPart.Create(ALookAndFeel
  : TdxCustomLayoutLookAndFeel);
begin
  inherited Create;
...
constructor TdxLayoutLookAndFeelCaptionOptions.Create
...
procedure TdxLayoutLookAndFeelCaptionOptions.SetHotTrackStyles
...
procedure TdxLayoutLookAndFeelCaptionOptions.SetTextDisabledColor
  (Value: TColor);
begin
...
function TdxLayoutLookAndFeelCaptionOptions.GetDefaultFont
  (AContainer: TComponent): TFont;
begin
...
function TdxLayoutLookAndFeelCaptionOptions.GetFont
  (AContainer: TComponent): TFont;
var
...
begin
  ...
  else if Supports(AContainer, IdxScaleFactor, AScaleFactor) and
    not AScaleFactor.Value.Equals(ScaleFactor) then
  begin
...
function TdxLayoutLookAndFeelPadding.GetPaddingRect(ATargetScaleFactor
...
procedure TdxLayoutLookAndFeelPadding.SetAssignedValues
...
constructor TdxCustomLayoutLookAndFeelOptions.Create(ALookAndFeel
  : TdxCustomLayoutLookAndFeel);
begin
...
function TdxCustomLayoutLookAndFeelOptions.GetCaptionOptionsClass
  : TdxLayoutLookAndFeelCaptionOptionsClass;
begin
  Result := TdxLayoutLookAndFeelCaptionOptions;
end;

function TdxCustomLayoutLookAndFeelOptions.GetPaddingClass
  : TdxLayoutLookAndFeelPaddingClass;
begin
  Result := TdxLayoutLookAndFeelPadding;
end;

procedure TdxCustomLayoutLookAndFeelOptions.SetCaptionOptions
  (Value: TdxLayoutLookAndFeelCaptionOptions);
begin
  FCaptionOptions.Assign(Value);
end;

procedure TdxCustomLayoutLookAndFeelOptions.SetPadding
  (const Value: TdxLayoutLookAndFeelPadding);
begin
...
constructor TdxLayoutLookAndFeelGroupOptions.Create(ALookAndFeel
  : TdxCustomLayoutLookAndFeel);
begin
  inherited;
  FColor := clDefault;
...
procedure TdxLayoutLookAndFeelGroupOptions.SetSpaceBetweenButtons
  (AValue: Cardinal);
begin
...
constructor TdxLayoutLookAndFeelItemOptions.Create(ALookAndFeel
  : TdxCustomLayoutLookAndFeel);
begin
  inherited;
...
procedure TdxLayoutLookAndFeelItemOptions.SetControlBorderStyle
  (Value: TdxLayoutBorderStyle);
begin
...
constructor TdxLayoutLookAndFeelOffsets.Create(ALookAndFeel
  : TdxCustomLayoutLookAndFeel);
var
  I: Integer;
begin
...
begin
  case Index of
    0:
      Result := FControlOffsetHorz;
    1:
      Result := FControlOffsetVert;
    2:
      Result := FItemOffset;
    3:
    ...
    5:
      Result := FRootItemsAreaOffsetHorz;
    6:
      Result := FRootItemsAreaOffsetVert;
    7:
      Result := FTabSheetClientOffsetHorz;
    8:
      Result := FTabSheetClientOffsetVert;
  else
    Result := 0;
  end;
end;
...
begin
  ...
  begin
    case Index of
      0:
        FControlOffsetHorz := Value;
      1:
        FControlOffsetVert := Value;
      2:
        FItemOffset := Value;
      3:
        FItemsAreaOffsetHorz := Value;
      4:
        FItemsAreaOffsetVert := Value;
      5:
        FRootItemsAreaOffsetHorz := Value;
      6:
        FRootItemsAreaOffsetVert := Value;
      7:
        FTabSheetClientOffsetHorz := Value;
      8:
        FTabSheetClientOffsetVert := Value;
    end;
    Changed;
  end;
end;
...
procedure TdxCustomLayoutLookAndFeel.AssignTo(var ALookAndFeel
  : TdxCustomLayoutLookAndFeel; ATargetPPI: Integer = 0);
var
  AOwner: TComponent;
begin
  ...
  if InRange(ATargetPPI, dxMinDPI, dxMaxDPI) then
    ALookAndFeel.ChangeScale(ATargetPPI * ScaleFactor.Denominator,
      dxDefaultDPI * ScaleFactor.Numerator);
end;
...
function TdxCustomLayoutLookAndFeel.GetUser(Index: Integer)
...
procedure TdxCustomLayoutLookAndFeel.SetGroupOptions
  (Value: TdxLayoutLookAndFeelGroupOptions);
begin
  FGroupOptions.Assign(Value);
end;

procedure TdxCustomLayoutLookAndFeel.SetItemOptions
  (Value: TdxLayoutLookAndFeelItemOptions);
begin
...
procedure TdxCustomLayoutLookAndFeel.SetOffsets
  (Value: TdxLayoutLookAndFeelOffsets);
begin
...
function TdxCustomLayoutLookAndFeel.GetFrameWidth(ASide,
  ACaptionSide: TdxLayoutSide): Integer;
begin
  Result := 0;
end;

function TdxCustomLayoutLookAndFeel.GetGroupCaptionFont
  (AContainer: TComponent): TFont;
begin
  Result := FGroupOptions.CaptionOptions.GetFont(AContainer);
end;

function TdxCustomLayoutLookAndFeel.IsGroupTransparent
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): Boolean;
var
...
begin
  ...
  Result := AGroupViewInfo.IsDefaultColor and
    (IsNativeStyle or (ContainerViewInfo(AViewInfo).IsTransparentBackground and
    ((AGroupViewInfo.ParentViewInfo <> nil) or AGroupViewInfo.Group.IsRoot)));
end;
...
function TdxCustomLayoutLookAndFeel.GetItemCaptionFont
  (AContainer: TComponent): TFont;
begin
...
function TdxCustomLayoutLookAndFeel.GetGroupOptionsClass
  : TdxLayoutLookAndFeelGroupOptionsClass;
begin
  Result := TdxLayoutLookAndFeelGroupOptions;
end;

function TdxCustomLayoutLookAndFeel.GetItemOptionsClass
  : TdxLayoutLookAndFeelItemOptionsClass;
begin
  Result := TdxLayoutLookAndFeelItemOptions;
end;

function TdxCustomLayoutLookAndFeel.GetOffsetsClass
  : TdxLayoutLookAndFeelOffsetsClass;
begin
...
procedure TdxCustomLayoutLookAndFeel.InitializeSubControlCxLookAndFeel
  (AcxLookAndFeel: TcxLookAndFeel);
begin
  AcxLookAndFeel.MasterLookAndFeel := LookAndFeel;
end;

procedure TdxCustomLayoutLookAndFeel.DrawLayoutControlBackground
  (ACanvas: TcxCanvas; const R: TRect);
begin
  ACanvas.FillRect(R, GetEmptyAreaColor);
end;

procedure TdxCustomLayoutLookAndFeel.DrawItemControlBorder(ACanvas: TcxCanvas;
  AItemOptions: TdxLayoutLookAndFeelItemOptions; R: TRect);
...
begin
  if FNotifyingAboutDestroying then
    Exit;
  FUsers.Remove(AUser);
end;
...
function TdxCustomLayoutLookAndFeel.DLUToPixels(AFont: TFont;
  ADLU: Integer): Integer;
var
  ATextMetric: TTextMetric;
begin
  GetTextMetric(AFont, ATextMetric);
  Result := (MulDiv(ADLU, ATextMetric.tmAveCharWidth, 4) + MulDiv(ADLU,
    ATextMetric.tmHeight, 8)) div 2;
end;

function TdxCustomLayoutLookAndFeel.HDLUToPixels(AFont: TFont;
  ADLU: Integer): Integer;
var
  ATextMetric: TTextMetric;
begin
...
function TdxCustomLayoutLookAndFeel.VDLUToPixels(AFont: TFont;
  ADLU: Integer): Integer;
var
  ATextMetric: TTextMetric;
begin
...
function TdxCustomLayoutLookAndFeel.GetItemPainterClass
  : TClass { TdxLayoutItemPainterClass };
begin
  Result := TdxLayoutItemPainter;
end;

function TdxCustomLayoutLookAndFeel.GetLabeledItemPainterClass
  : TClass { TdxLayoutLabeledItemPainterClass };
begin
  Result := TdxLayoutLabeledItemPainter;
end;

function TdxCustomLayoutLookAndFeel.GetSeparatorItemPainterClass
  : TClass { TdxLayoutSeparatorItemPainterClass };
begin
  Result := TdxLayoutSeparatorItemPainter;
end;

function TdxCustomLayoutLookAndFeel.GetSplitterItemPainterClass
  : TClass { TdxLayoutSplitterItemPainterClass };
begin
  Result := TdxLayoutSplitterItemPainter;
end;

procedure TdxCustomLayoutLookAndFeel.CorrectGroupButtonsAreaBounds
  (AViewInfo: TObject { TdxLayoutGroupViewInfo }; var ABounds: TRect);
begin
  // do nothing
end;

procedure TdxCustomLayoutLookAndFeel.CorrectGroupCaptionAreaBounds
  (AViewInfo: TObject { TdxLayoutGroupViewInfo }; var ABounds: TRect);
begin
  // do nothing
end;

procedure TdxCustomLayoutLookAndFeel.CorrectGroupMinVisibleSize
  (AViewInfo: TObject { TdxLayoutGroupViewInfo }; var ASize: Integer;
  AOrientation: TdxOrientation);
begin
  // do nothing
end;

procedure TdxCustomLayoutLookAndFeel.CorrectGroupMinVisibleHeight
  (AViewInfo: TObject { TdxLayoutGroupViewInfo }; var AHeight: Integer);
begin
  CorrectGroupMinVisibleSize(AViewInfo, AHeight, orVertical);
end;

procedure TdxCustomLayoutLookAndFeel.CorrectGroupMinVisibleWidth
  (AViewInfo: TObject { TdxLayoutGroupViewInfo }; var AWidth: Integer);
begin
  CorrectGroupMinVisibleSize(AViewInfo, AWidth, orHorizontal);
end;

procedure TdxCustomLayoutLookAndFeel.CorrectGroupCaptionFont
  (AViewInfo: TObject { TdxLayoutGroupViewInfo }; AFont: TFont);
begin
  // do nothing
end;

procedure TdxCustomLayoutLookAndFeel.CorrectGroupCaptionHeight
  (AViewInfo: TObject { TdxLayoutGroupViewInfo }; var AHeight: Integer);
begin
  // do nothing
end;

procedure TdxCustomLayoutLookAndFeel.CorrectGroupCaptionWidth
  (AViewInfo: TObject { TdxLayoutGroupViewInfo }; var AWidth: Integer);
begin
  // do nothing
end;

function TdxCustomLayoutLookAndFeel.GetElementOffsetHorz
  (AContainer: TComponent): Integer;
begin
  Result := DLUToPixels(GetItemCaptionFont(AContainer),
    ScaleFactor.Revert(Offsets.ControlOffsetHorz));
end;

function TdxCustomLayoutLookAndFeel.GetElementOffsetVert
  (AContainer: TComponent): Integer;
begin
  Result := DLUToPixels(GetItemCaptionFont(AContainer),
    ScaleFactor.Revert(Offsets.ControlOffsetVert));
end;

function TdxCustomLayoutLookAndFeel.GetGroupBorderWidth(AContainer: TComponent;
  ASide, ACaptionSide: TdxLayoutSide;
  AHasCaption, AIsExpanded: Boolean): Integer;
begin
  Result := 0;
end;

function TdxCustomLayoutLookAndFeel.GetGroupButtonsOffset
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): Integer;
begin
  Result := GetGroupCaptionOffset(AViewInfo);
end;

function TdxCustomLayoutLookAndFeel.GetGroupCaptionOffset
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): Integer;
begin
  Result := GroupViewInfo(AViewInfo).GetBorderWidth(sdLeft);
end;

function TdxCustomLayoutLookAndFeel.GetGroupCaptionContentOffsets
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TRect;
begin
  Result := GroupCaptionViewInfo(AViewInfo).Padding;
end;

function TdxCustomLayoutLookAndFeel.GetGroupFrameBounds
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TRect;
begin
  Result := GroupViewInfo(AViewInfo).Bounds;
end;

function TdxCustomLayoutLookAndFeel.GetGroupRestSpaceBounds
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TRect;
begin
  Result := GroupViewInfo(AViewInfo).Bounds;
end;

function TdxCustomLayoutLookAndFeel.GetGroupCaptionAlignHorz
  (AViewInfo: TObject { TdxCustomLayoutItemViewInfo } ): TAlignment;
begin
  Result := GroupViewInfo(AViewInfo).Group.CaptionOptions.AlignHorz;
end;

function TdxCustomLayoutLookAndFeel.GetGroupCaptionAlignVert
  (AViewInfo: TObject { TdxCustomLayoutItemViewInfo } ): TdxAlignmentVert;
begin
  Result := GroupViewInfo(AViewInfo).Group.CaptionOptions.AlignVert;
end;

function TdxCustomLayoutLookAndFeel.GetItemControlBorderWidth
...
function TdxCustomLayoutLookAndFeel.GetItemOffset
  (AContainer: TComponent): Integer;
begin
  Result := DLUToPixels(GetItemCaptionFont(AContainer),
    ScaleFactor.Revert(Offsets.ItemOffset));
end;

function TdxCustomLayoutLookAndFeel.GetGroupBorderOffset(AContainer: TComponent;
  ASide, ACaptionSide: TdxLayoutSide): Integer;
begin
  Result := DLUToPixels(GetGroupCaptionFont(AContainer), 7);
end;

function TdxCustomLayoutLookAndFeel.GetTabControlBorderOffset
  (AContainer: TComponent; ASide, ACaptionSide: TdxLayoutSide): Integer;
begin
  Result := GetGroupBorderOffset(AContainer, ASide, ACaptionSide);
end;

function TdxCustomLayoutLookAndFeel.GetItemsAreaOffsetHorz
  (AContainer: TComponent): Integer;
begin
  Result := DLUToPixels(GetGroupCaptionFont(AContainer),
    ScaleFactor.Revert(Offsets.ItemsAreaOffsetHorz));
end;

function TdxCustomLayoutLookAndFeel.GetItemsAreaOffsetVert
  (AContainer: TComponent): Integer;
begin
  Result := DLUToPixels(GetGroupCaptionFont(AContainer),
    ScaleFactor.Revert(Offsets.ItemsAreaOffsetVert));
end;

function TdxCustomLayoutLookAndFeel.GetRootItemsAreaOffsetHorz
  (AContainer: TComponent): Integer;
begin
  Result := DLUToPixels(GetGroupCaptionFont(AContainer),
    ScaleFactor.Revert(Offsets.RootItemsAreaOffsetHorz));
end;

function TdxCustomLayoutLookAndFeel.GetRootItemsAreaOffsetVert
  (AContainer: TComponent): Integer;
begin
  Result := DLUToPixels(GetGroupCaptionFont(AContainer),
    ScaleFactor.Revert(Offsets.RootItemsAreaOffsetVert));
end;

function TdxCustomLayoutLookAndFeel.GetTabSheetContentOffsetHorz
  (AContainer: TComponent): Integer;
begin
  Result := DLUToPixels(GetGroupCaptionFont(AContainer),
    ScaleFactor.Revert(Offsets.TabSheetContentOffsetHorz));
end;

function TdxCustomLayoutLookAndFeel.GetTabSheetContentOffsetVert
  (AContainer: TComponent): Integer;
begin
  Result := DLUToPixels(GetGroupCaptionFont(AContainer),
    ScaleFactor.Revert(Offsets.TabSheetContentOffsetVert));
end;
...
function TdxCustomLayoutLookAndFeel.GetGroupCaptionColor
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TColor;
begin
  Result := GroupViewInfo(AViewInfo).Color;
end;

function TdxCustomLayoutLookAndFeel.GetGroupButtonColorPalette
...
function TdxCustomLayoutLookAndFeel.GetTabbedGroupCaptionColorPalette
  (AIsActive: Boolean): IdxColorPalette;
begin
  Result := nil;
end;
...
function TdxLayoutStandardLookAndFeelGroupCaptionOptions.
  GetDefaultTextColor: TColor;
begin
...
function TdxLayoutStandardLookAndFeelItemCaptionOptions.
  GetDefaultTextColor: TColor;
begin
  Result := clBtnText;
end;
...
function TdxLayoutStandardLookAndFeelItemOptions.GetCaptionOptionsClass
  : TdxLayoutLookAndFeelCaptionOptionsClass;
begin
...
function TdxLayoutStandardLookAndFeel.GetGroupOptionsClass
  : TdxLayoutLookAndFeelGroupOptionsClass;
begin
  Result := TdxLayoutStandardLookAndFeelGroupOptions;
end;

function TdxLayoutStandardLookAndFeel.GetItemOptionsClass
  : TdxLayoutLookAndFeelItemOptionsClass;
begin
  Result := TdxLayoutStandardLookAndFeelItemOptions;
end;

function TdxLayoutStandardLookAndFeel.GetFrameWidth(ASide,
  ACaptionSide: TdxLayoutSide): Integer;
begin
  Result := 2;
end;
...
function TdxLayoutStandardLookAndFeel.GetGroupPainterClass
  : TClass { TdxLayoutGroupPainterClass };
begin
  Result := TdxLayoutGroupStandardPainter;
end;

procedure TdxLayoutStandardLookAndFeel.CorrectGroupMinVisibleSize
  (AViewInfo: TObject { TdxLayoutGroupViewInfo }; var ASize: Integer;
  AOrientation: TdxOrientation);
begin
  if (AOrientation = orVertical) and GroupViewInfo(AViewInfo)
    .IsVerticalCaption or (AOrientation = orHorizontal) and
    not GroupViewInfo(AViewInfo).IsVerticalCaption then
  begin
    if GroupViewInfo(AViewInfo).HasCaption then
      Inc(ASize, 2 * GetGroupCaptionOffset(AViewInfo))
    else if GroupViewInfo(AViewInfo).HasButtons then
      Inc(ASize, 2 * GetGroupButtonsOffset(AViewInfo));
  end;
end;

function TdxLayoutStandardLookAndFeel.GetGroupCaptionOffset
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): Integer;
begin
  Result := HDLUToPixels(GroupCaptionViewInfo(AViewInfo).Font, 7) - 2;
end;

function TdxLayoutStandardLookAndFeel.GetGroupCaptionContentOffsets
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TRect;
begin
...
function TdxLayoutStandardLookAndFeel.GetGroupFrameBounds
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TRect;
var
  AIndent: Integer;
begin
  ...
  begin
    Result := GroupViewInfo(AViewInfo).Bounds;
    AIndent := VDLUToPixels(GroupCaptionViewInfo(AViewInfo).Font, 4) -
      FrameWidths[GroupViewInfo(AViewInfo).CaptionSide, GroupViewInfo(AViewInfo)
      .CaptionSide] div 2;
    case GroupViewInfo(AViewInfo).CaptionSide of
      sdTop, sdBottom:
        AIndent := AIndent + (GroupCaptionViewInfo(AViewInfo).GetAvailableHeight
          - GroupCaptionViewInfo(AViewInfo).GetAvailableTextHeight) div 2;
      sdLeft, sdRight:
        AIndent := AIndent + (GroupCaptionViewInfo(AViewInfo).GetAvailableWidth
          - GroupCaptionViewInfo(AViewInfo).GetAvailableTextWidth) div 2;
    end;
    case GroupViewInfo(AViewInfo).CaptionSide of
      sdLeft:
        Result.Left := GroupViewInfo(AViewInfo).FCaptionAreaBounds.Left
          + AIndent;
      sdTop:
        Result.Top := GroupViewInfo(AViewInfo).FCaptionAreaBounds.Top + AIndent;
      sdRight:
        Result.Right := GroupViewInfo(AViewInfo).FCaptionAreaBounds.Right
          - AIndent;
      sdBottom:
        Result.Bottom := GroupViewInfo(AViewInfo).FCaptionAreaBounds.Bottom
          - AIndent;
    end;
...
function TdxLayoutStandardLookAndFeel.GetGroupBorderWidth
  (AContainer: TComponent; ASide, ACaptionSide: TdxLayoutSide;
  AHasCaption, AIsExpanded: Boolean): Integer;
var
  AFont: TFont;
begin
  ...
  if ASide = ACaptionSide then
    Result := VDLUToPixels(AFont, 4) + FrameWidths[ASide, ACaptionSide] div 2 +
      GetGroupBorderOffset(AContainer, ASide, ACaptionSide)
  else
    Result := FrameWidths[ASide, ACaptionSide] +
      IfThen(AIsExpanded or (ASide <> GetOppositeSide(ACaptionSide)),
      GetGroupBorderOffset(AContainer, ACaptionSide, ASide), 0);
end;

{ TdxLayoutOfficeLookAndFeel }

function TdxLayoutOfficeLookAndFeel.GetFrameWidth(ASide,
  ACaptionSide: TdxLayoutSide): Integer;
begin
  if ASide = ACaptionSide then
...
function TdxLayoutOfficeLookAndFeel.GetGroupPainterClass
  : TClass { TdxLayoutGroupPainterClass };
begin
  Result := TdxLayoutGroupOfficePainter;
end;

procedure TdxLayoutOfficeLookAndFeel.CorrectGroupMinVisibleSize
  (AViewInfo: TObject { TdxLayoutGroupViewInfo }; var ASize: Integer;
  AOrientation: TdxOrientation);
begin
  if (GroupViewInfo(AViewInfo).HasCaption or GroupViewInfo(AViewInfo)
    .HasButtons) and ((AOrientation = orVertical) and GroupViewInfo(AViewInfo)
    .IsVerticalCaption or (AOrientation = orHorizontal) and
    not GroupViewInfo(AViewInfo).IsVerticalCaption) then
    Inc(ASize, 20);
end;
...
begin
  if ASide = GetOppositeSide(ACaptionSide) then
    Result := IfThen(AIsExpanded,
      DLUToPixels(GetGroupCaptionFont(AContainer), 3), 0)
  else
    Result := inherited GetGroupBorderWidth(AContainer, ASide, ACaptionSide,
      AHasCaption, AIsExpanded);
end;

function TdxLayoutOfficeLookAndFeel.GetGroupCaptionOffset
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): Integer;
begin
  Result := 0;
end;

function TdxLayoutOfficeLookAndFeel.GetGroupCaptionContentOffsets
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TRect;
var
  AOffset: Integer;
begin
...
function TdxLayoutOfficeLookAndFeel.GetGroupFrameBounds
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TRect;
const
  BorderWidth = 2;
begin
...
constructor TdxLayoutWebLookAndFeelGroupCaptionOptions.Create
  (AOptions: TdxCustomLayoutLookAndFeelOptions);
begin
  inherited;
  FColor := clDefault;
...
function TdxLayoutWebLookAndFeelGroupCaptionOptions.GetOptions
...
procedure TdxLayoutWebLookAndFeelGroupCaptionOptions.SetSeparatorWidth
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
function TdxLayoutWebLookAndFeelGroupCaptionOptions.GetDefaultFont
  (AContainer: TComponent): TFont;
begin
...
constructor TdxLayoutWebLookAndFeelGroupOptions.Create
...
function TdxLayoutWebLookAndFeelGroupOptions.GetCaptionOptions
  : TdxLayoutWebLookAndFeelGroupCaptionOptions;
begin
  Result := TdxLayoutWebLookAndFeelGroupCaptionOptions
    (inherited CaptionOptions);
end;

procedure TdxLayoutWebLookAndFeelGroupOptions.SetCaptionOptions
  (Value: TdxLayoutWebLookAndFeelGroupCaptionOptions);
begin
...
function TdxLayoutWebLookAndFeelGroupOptions.GetCaptionOptionsClass
  : TdxLayoutLookAndFeelCaptionOptionsClass;
begin
  Result := TdxLayoutWebLookAndFeelGroupCaptionOptions;
end;
...
function TdxLayoutWebLookAndFeelGroupOptions.HasCaptionSeparator
  (AHasCaption: Boolean): Boolean;
begin
...
constructor TdxLayoutWebLookAndFeelItemOptions.Create
  (ALookAndFeel: TdxCustomLayoutLookAndFeel);
begin
  inherited;
...
function TdxLayoutWebLookAndFeelItemOptions.GetCaptionOptionsClass
  : TdxLayoutLookAndFeelCaptionOptionsClass;
begin
...
function TdxLayoutWebLookAndFeel.GetGroupOptions
  : TdxLayoutWebLookAndFeelGroupOptions;
begin
  Result := TdxLayoutWebLookAndFeelGroupOptions(inherited GroupOptions);
end;

procedure TdxLayoutWebLookAndFeel.SetGroupOptions
  (Value: TdxLayoutWebLookAndFeelGroupOptions);
begin
  inherited GroupOptions := Value;
end;

function TdxLayoutWebLookAndFeel.HasCaptionSeparator
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): Boolean;
begin
  Result := GroupViewInfo(AViewInfo).IsExpanded and
    GroupOptions.HasCaptionSeparator(GroupViewInfo(AViewInfo).HasCaption or
    GroupViewInfo(AViewInfo).HasButtons);
end;
...
function TdxLayoutWebLookAndFeel.GetGroupOptionsClass
  : TdxLayoutLookAndFeelGroupOptionsClass;
begin
  Result := TdxLayoutWebLookAndFeelGroupOptions;
end;

function TdxLayoutWebLookAndFeel.GetItemOptionsClass
  : TdxLayoutLookAndFeelItemOptionsClass;
begin
...
function TdxLayoutWebLookAndFeel.GetGroupPainterClass
  : TClass { TdxLayoutGroupPainterClass };
begin
  Result := TdxLayoutGroupWebPainter;
end;

procedure TdxLayoutWebLookAndFeel.CorrectGroupButtonsAreaBounds
  (AViewInfo: TObject { TdxLayoutGroupViewInfo }; var ABounds: TRect);
begin
  if GroupViewInfo(AViewInfo).IsVerticalCaption then
    ABounds := cxRectOffset(ABounds, GroupOptions.FrameWidth,
      -GroupOptions.FrameWidth, GroupViewInfo(AViewInfo).CaptionSide = sdLeft)
  else
    ABounds := cxRectOffset(ABounds, -GroupOptions.FrameWidth,
      GroupOptions.FrameWidth, GroupViewInfo(AViewInfo).CaptionSide = sdTop);
end;

procedure TdxLayoutWebLookAndFeel.CorrectGroupCaptionAreaBounds
  (AViewInfo: TObject { TdxLayoutGroupViewInfo }; var ABounds: TRect);
begin
  if GroupViewInfo(AViewInfo).IsVerticalCaption then
  begin
    ABounds := cxRectOffset(ABounds, GroupOptions.FrameWidth, 0,
      GroupViewInfo(AViewInfo).CaptionSide = sdLeft);
    if GroupCaptionViewInfo(AViewInfo).AlignVert in [tavTop, tavBottom] then
      ABounds := cxRectOffset(ABounds, 0, GroupOptions.FrameWidth,
        GroupCaptionViewInfo(AViewInfo).AlignVert = tavTop);
  end
  else
  begin
    ABounds := cxRectOffset(ABounds, 0, GroupOptions.FrameWidth,
      GroupViewInfo(AViewInfo).CaptionSide = sdTop);
    if GroupCaptionViewInfo(AViewInfo).AlignHorz
      in [taLeftJustify, taRightJustify] then
      ABounds := cxRectOffset(ABounds, GroupOptions.FrameWidth, 0,
        GroupCaptionViewInfo(AViewInfo).AlignHorz = taLeftJustify);
  end;
end;

procedure TdxLayoutWebLookAndFeel.CorrectGroupCaptionHeight
  (AViewInfo: TObject { TdxLayoutGroupViewInfo }; var AHeight: Integer);
begin
  if not GroupCaptionViewInfo(AViewInfo).IsVerticalCaption then
    AHeight := VDLUToPixels(GroupCaptionViewInfo(AViewInfo).Font, 11 { 12 } ) +
      Max(GroupCaptionViewInfo(AViewInfo).GetAvailableTextHeight,
      GroupCaptionViewInfo(AViewInfo).GetImageHeight) -
      GroupCaptionViewInfo(AViewInfo).GetAvailableTextHeight;
end;

procedure TdxLayoutWebLookAndFeel.CorrectGroupCaptionWidth
  (AViewInfo: TObject { TdxLayoutGroupViewInfo }; var AWidth: Integer);
begin
  if GroupCaptionViewInfo(AViewInfo).IsVerticalCaption then
    AWidth := VDLUToPixels(GroupCaptionViewInfo(AViewInfo).Font, 11 { 12 } ) +
      Max(GroupCaptionViewInfo(AViewInfo).GetAvailableTextWidth,
      GroupCaptionViewInfo(AViewInfo).GetImageWidth) -
      GroupCaptionViewInfo(AViewInfo).GetAvailableTextWidth
end;

procedure TdxLayoutWebLookAndFeel.CorrectGroupMinVisibleSize
  (AViewInfo: TObject { TdxLayoutGroupViewInfo }; var ASize: Integer;
  AOrientation: TdxOrientation);
begin
  if (AOrientation = orVertical) and GroupViewInfo(AViewInfo)
  ...
  else if HasCaptionSeparator(AViewInfo) then
    Inc(ASize, GroupOptions.CaptionOptions.SeparatorWidth);
end;

function TdxLayoutWebLookAndFeel.GetGroupBorderOffset(AContainer: TComponent;
  ASide, ACaptionSide: TdxLayoutSide): Integer;
begin
...
begin
  ...
  if ASide in [ACaptionSide, GetOppositeSide(ACaptionSide)] then
  begin
    Result := IfThen(AIsExpanded, GetGroupBorderOffset(AContainer, ASide,
      ACaptionSide), 0);
    if ASide = ACaptionSide then
    begin
      if AHasCaption then
  ...
  else if GroupOptions.OffsetItems then
    Result := GetGroupBorderOffset(AContainer, ASide, ACaptionSide)
  else
...
function TdxLayoutWebLookAndFeel.GetGroupCaptionColor
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TColor;
begin
  Result := GroupOptions.CaptionOptions.GetColor;
end;

function TdxLayoutWebLookAndFeel.GetGroupCaptionOffset
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): Integer;
begin
...
function TdxLayoutWebLookAndFeel.GetGroupCaptionSeparatorAreaBounds
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TRect;
begin
...
function TdxLayoutWebLookAndFeel.GetGroupCaptionSeparatorBounds
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TRect;
begin
  ...
  if not GroupOptions.OffsetCaption and not GroupOptions.OffsetItems and
    (GroupOptions.FrameWidth = 0) and
    (GroupCaptionViewInfo(AViewInfo).Color = GroupViewInfo(AViewInfo).Color)
  then
  begin
...
function TdxLayoutWebLookAndFeel.GetGroupRestSpaceBounds
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TRect;
var
  ACaptionWidth: Integer;
  ACaptionHeight: Integer;
begin
  Result := cxRectInflate(inherited GetGroupRestSpaceBounds(AViewInfo),
    -GroupOptions.FrameWidth, -GroupOptions.FrameWidth);
  case GroupViewInfo(AViewInfo).CaptionSide of
    sdLeft:
      begin
        ACaptionWidth :=
          Max(cxRectWidth(GroupCaptionViewInfo(AViewInfo).Bounds),
          cxRectWidth(GroupButtonsViewInfo(AViewInfo).Bounds));
        if GroupViewInfo(AViewInfo).HasCaption or GroupViewInfo(AViewInfo).HasButtons
        then
    ...
    sdTop:
      begin
        ACaptionHeight :=
          Max(cxRectHeight(GroupCaptionViewInfo(AViewInfo).Bounds),
          cxRectHeight(GroupButtonsViewInfo(AViewInfo).Bounds));
        if GroupViewInfo(AViewInfo).HasCaption or GroupViewInfo(AViewInfo).HasButtons
        then
...
function TdxLayoutWebLookAndFeel.GetGroupCaptionAlignHorz
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TAlignment;
begin
  if GroupViewInfo(AViewInfo).IsVerticalCaption then
    Result := taCenter
  else
...
function TdxLayoutWebLookAndFeel.GetGroupCaptionAlignVert
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TdxAlignmentVert;
begin
  if GroupViewInfo(AViewInfo).IsVerticalCaption then
...
function TdxLayoutLookAndFeelList.GetItem(Index: Integer)
  : TdxCustomLayoutLookAndFeel;
begin
...
procedure TdxLayoutLookAndFeelList.RemoveItem
...
procedure TdxLayoutLookAndFeelList.ItemListChanged(Sender: TObject;
...
procedure TdxLayoutLookAndFeelList.GetChildren(Proc: TGetChildProc;
  Root: TComponent);
var
  I: Integer;
begin
...
function TdxLayoutLookAndFeelList.CreateItem
  (AClass: TdxCustomLayoutLookAndFeelClass): TdxCustomLayoutLookAndFeel;
begin
...
function TdxLayoutLookAndFeelDefs.GetItem(Index: Integer)
  : TdxCustomLayoutLookAndFeelClass;
begin
  Result := TdxCustomLayoutLookAndFeelClass(FItems[Index]);
end;

function TdxLayoutLookAndFeelDefs.GetItemByDescription(const Value: string)
  : TdxCustomLayoutLookAndFeelClass;
var
  I: Integer;
begin
...
procedure TdxLayoutLookAndFeelDefs.Register
...
procedure TdxLayoutLookAndFeelDefs.Unregister
  (AClass: TdxCustomLayoutLookAndFeelClass);
begin
...
begin
  for Result := 0 to Count - 1 do
    if Items[Result].Font = AFont then
      Exit;
  Result := -1;
end;
...
begin
  for Result := 0 to Count - 1 do
    if Items[Result].Font.Handle = AFont.Handle then
      Exit;
  Result := -1;
end;
...
function TdxLayoutCxLookAndFeelGroupOptions.GetCaptionOptionsClass
  : TdxLayoutLookAndFeelCaptionOptionsClass;
begin
  Result := TdxLayoutCxLookAndFeelGroupCaptionOptions;
end;

function TdxLayoutCxLookAndFeelGroupOptions.GetLookAndFeel
...
function TdxLayoutCxLookAndFeelGroupCaptionOptions.GetLookAndFeel
  : TdxLayoutCxLookAndFeel;
begin
...
function TdxLayoutCxLookAndFeelGroupCaptionOptions.
  GetDefaultTextDisabledColor: TColor;
begin
  Result := LookAndFeel.LookAndFeelPainter.GroupBoxTextColor(False, cxgpTop);
end;

function TdxLayoutCxLookAndFeelGroupCaptionOptions.
  GetDefaultTextHotColor: TColor;
begin
  Result := LookAndFeel.LookAndFeelPainter.GroupBoxTextColor(True, cxgpTop);
end;
...
function TdxLayoutCxLookAndFeelItemOptions.GetCaptionOptionsClass
  : TdxLayoutLookAndFeelCaptionOptionsClass;
begin
...
function TdxLayoutCxLookAndFeelItemCaptionOptions.
  GetDefaultTextDisabledColor: TColor;
begin
...
function TdxLayoutCxLookAndFeelItemCaptionOptions.GetLookAndFeel
  : TdxLayoutCxLookAndFeel;
begin
  Result := TdxLayoutCxLookAndFeel(Options.LookAndFeel);
end;
...
procedure TdxLayoutCxLookAndFeel.DrawLayoutControlBackground(ACanvas: TcxCanvas;
  const R: TRect);
begin
  LookAndFeelPainter.DrawLayoutControlBackground(ACanvas, R);
end;

procedure TdxLayoutCxLookAndFeel.DrawItemControlBorder(ACanvas: TcxCanvas;
  AItemOptions: TdxLayoutLookAndFeelItemOptions; R: TRect);
begin
...
function TdxLayoutCxLookAndFeel.GetGroupButtonColorPalette
  (AState: TcxButtonState): IdxColorPalette;
begin
  Result := LookAndFeelPainter.
    LayoutControlGetColorPaletteForGroupButton(AState);
end;
...
function TdxLayoutCxLookAndFeel.GetTabbedGroupCaptionColorPalette
  (AIsActive: Boolean): IdxColorPalette;
begin
  Result := LookAndFeelPainter.LayoutControlGetColorPaletteForTabbedGroupCaption
    (AIsActive);
end;

procedure TdxLayoutCxLookAndFeel.CorrectGroupCaptionFont
  (ACaptionSide: TdxLayoutSide; AFont: TFont);
begin
  LookAndFeelPainter.GroupBoxAdjustCaptionFont(AFont,
    CaptionSideToCaptionPosition[ACaptionSide])
end;

procedure TdxLayoutCxLookAndFeel.CorrectGroupCaptionFont(AViewInfo: TObject;
  AFont: TFont);
begin
...
begin
  if not IsSkinPainterUsed then
    Exit(inherited GetGroupBorderWidth(AContainer, ASide, ACaptionSide,
      AHasCaption, AIsExpanded));

  ACaptionFont := GetGroupCaptionFont(AContainer);
  AIsCaptionSideOrOpposite := ASide
    in [ACaptionSide, GetOppositeSide(ACaptionSide)];
  if AIsExpanded or not AIsCaptionSideOrOpposite then
    Result := FrameWidths[ASide, ACaptionSide] + DLUToPixels(ACaptionFont,
      FrameSizeMap[AIsCaptionSideOrOpposite])
  else
    Result := LookAndFeelPainter.GroupBoxCaptionTailSize
      (CaptionSideToCaptionPosition[ACaptionSide]);
  ...
  begin
    ...
    begin
      ...
      if ASide in [sdLeft, sdRight] then
        Inc(Result, cxMarginsWidth(GetGroupCaptionContentOffsets(True,
          ACaptionSide)))
      else
        Inc(Result, cxMarginsHeight(GetGroupCaptionContentOffsets(False,
          ACaptionSide)));
    end;
  end;
end;

function TdxLayoutCxLookAndFeel.GetGroupCaptionOffset
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): Integer;
begin
  if IsSkinPainterUsed and not IsGroupBoxCaptionTextDrawnOverBorder
    (GroupViewInfo(AViewInfo).CaptionSide) then
    Result := 0
  else
    Result := inherited GetGroupCaptionOffset(AViewInfo);
end;

function TdxLayoutCxLookAndFeel.GetGroupCaptionContentOffsets
  (AIsVertical: Boolean; ACaptionSide: TdxLayoutSide): TRect;
begin
  Result := LookAndFeelPainter.GroupBoxBorderSize(True,
    CaptionSideToCaptionPosition[ACaptionSide]);
  if not IsSkinPainterUsed or IsGroupBoxCaptionTextDrawnOverBorder(ACaptionSide)
  then
  begin
    if AIsVertical then
    begin
...
begin
  AGroupViewInfo := GroupViewInfo(AViewInfo);
  Result := GetGroupCaptionContentOffsets(AGroupViewInfo.IsVerticalCaption,
    AGroupViewInfo.CaptionSide);
end;

function TdxLayoutCxLookAndFeel.GetGroupFrameBounds
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): TRect;
begin
  if IsSkinPainterUsed then
  begin
      ...
      case GroupViewInfo(AViewInfo).CaptionSide of
        sdLeft:
          Result.Left := Result.Left +
            Max(GroupCaptionViewInfo(AViewInfo).GetAvailableWidth,
            GroupButtonsViewInfo(AViewInfo).CalculateWidth);
        sdRight:
          Result.Right := Result.Right -
            Max(GroupCaptionViewInfo(AViewInfo).GetAvailableWidth,
            GroupButtonsViewInfo(AViewInfo).CalculateWidth);
        sdTop:
          Result.Top := Result.Top + Max(GroupCaptionViewInfo(AViewInfo)
            .GetAvailableHeight, GroupButtonsViewInfo(AViewInfo)
            .CalculateHeight);
        sdBottom:
          Result.Bottom := Result.Bottom -
            Max(GroupCaptionViewInfo(AViewInfo).GetAvailableHeight,
            GroupButtonsViewInfo(AViewInfo).CalculateHeight);
      end;
    end;
  end
  else
...
function TdxLayoutCxLookAndFeel.GetItemControlBorderWidth
  (ASide: TdxLayoutSide): Integer;
begin
  Result := LookAndFeelPainter.BorderSize;
end;

function TdxLayoutCxLookAndFeel.IsGroupBoxCaptionTextDrawnOverBorder
  (ACaptionSide: TdxLayoutSide): Boolean;
begin
  Result := LookAndFeelPainter.IsGroupBoxCaptionTextDrawnOverBorder
    (CaptionSideToCaptionPosition[ACaptionSide]);
end;
...
function TdxLayoutCxLookAndFeel.GetItemPainterClass
  : TClass { TdxLayoutItemPainterClass };
begin
  Result := TdxLayoutItemCxLookAndFeelPainter;
end;

function TdxLayoutCxLookAndFeel.IsGroupTransparent
  (AViewInfo: TObject { TdxLayoutGroupViewInfo } ): Boolean;
var
  AGroupViewInfo: TdxLayoutGroupViewInfoAccess;
begin
  ...
  Result := not IsSkinPainterUsed and AGroupViewInfo.IsDefaultColor and
    (IsNativeStyle or (LookAndFeel.Kind = lfOffice11) or
    ContainerViewInfo(AViewInfo).IsTransparent);
end;
...
function TdxLayoutCxLookAndFeel.GetLookAndFeelPainter
...
function TdxLayoutCxLookAndFeel.GetFrameWidth(ASide, ACaptionSide
  : TdxLayoutSide): Integer;
var
  ACaptionBorderSize: TRect;
begin
  if IsSkinPainterUsed then
  begin
    ACaptionBorderSize := LookAndFeelPainter.GroupBoxBorderSize(True,
      CaptionSideToCaptionPosition[ACaptionSide]);
...
function TdxLayoutCxLookAndFeel.GetGroupOptionsClass
  : TdxLayoutLookAndFeelGroupOptionsClass;
begin
  Result := TdxLayoutCxLookAndFeelGroupOptions;
end;

function TdxLayoutCxLookAndFeel.GetItemOptionsClass
  : TdxLayoutLookAndFeelItemOptionsClass;
begin
...
procedure TdxLayoutCxLookAndFeel.LookAndFeelChanged(Sender: TcxLookAndFeel;
  AChangedValues: TcxLookAndFeelValues);
begin
  Changed;
end;
