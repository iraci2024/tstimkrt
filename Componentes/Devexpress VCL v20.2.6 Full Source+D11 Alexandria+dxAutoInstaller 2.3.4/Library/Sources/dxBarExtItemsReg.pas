...
uses
  DesignIntf, DesignEditors, Classes, SysUtils, Graphics, ImgList,
  dxBarExtItems, dxBarImageComboEditor,
...
begin
  ...
  RegisterNoIcon([TdxBarStatic, TdxBarColorCombo, TdxBarFontNameCombo,
    ...
    TdxBarToolbarsListItem, TdxBarSpinEdit, TdxBarControlContainerItem,
    TdxBarProgressItem, TdxBarMRUListItem, TdxBarInPlaceSubItem]);
