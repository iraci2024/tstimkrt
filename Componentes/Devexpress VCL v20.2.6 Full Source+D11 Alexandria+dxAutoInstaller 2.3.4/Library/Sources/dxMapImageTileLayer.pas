...
type
  ...
  public
    ...
    property ProviderClass: TdxMapControlImageTileProviderClass
      read GetProviderClass write SetProviderClass;
  published
    ...
    property Provider: TdxMapControlImageTileProvider read FProvider
      write SetProvider;
  end;
...
function TdxMapImageTileLayer.GetMapSizeInPixels(AZoomLevel: Double)
  : TdxSizeDouble;
var
  ASize: Double;
begin
...
function TdxMapImageTileLayer.GetProviderClass
  : TdxMapControlImageTileProviderClass;
begin
...
procedure TdxMapImageTileLayer.UpdateTileSource(ATileSource
  : TdxMapControlMultiScaleTileSource);
begin
  FMultiScaleImage.Source := ATileSource;
end;

procedure TdxMapImageTileLayer.SetProvider(const Value
  : TdxMapControlImageTileProvider);
begin
  FProvider.Assign(Value);
end;

procedure TdxMapImageTileLayer.SetProviderClass(const Value
  : TdxMapControlImageTileProviderClass);
begin
...
procedure TdxMapImageTileLayer.SetProviderClassName(const Value: string);
begin
  ProviderClass := TdxMapControlImageTileProviderClass
