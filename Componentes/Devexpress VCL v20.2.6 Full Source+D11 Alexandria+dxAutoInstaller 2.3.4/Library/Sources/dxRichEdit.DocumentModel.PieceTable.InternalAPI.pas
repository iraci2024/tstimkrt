...
type
  ...
  TdxInternalAPI = class(TdxCustomInternalAPI,
    IdxDocumentModelStructureChangedListener, IdxDocumentExporterFactory,
  ...
  strict private
    ...
    procedure RaiseParagraphInserted(APieceTable: TdxCustomPieceTable;
      ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex);
    procedure RaiseParagraphRemoved(APieceTable: TdxCustomPieceTable;
      ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex);
    procedure RaiseParagraphMerged(APieceTable: TdxCustomPieceTable;
      ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex);
  strict private
    procedure UpdateAnchors(const AnchorAction
      : TdxAction<TdxDocumentModelPositionAnchor>);

    function PrepareModelForExport(AFormat: TdxRichEditDocumentFormat)
      : TdxDocumentModel;
    function GetDocumentRtfContentCore
    ...
    function GetDocumentPlainTextContentCore
  ...
  protected
    ...
    procedure SetExporterFactory(const Value
      : IdxDocumentExporterFactory); override;
    procedure SetImporterFactory(const Value
      : IdxDocumentImporterFactory); override;
...
{$ENDREGION}
    ...
    function GetDocumentRtfContentSaveMemory
      (AOptions: TdxRtfDocumentExporterOptions;
      ALastParagraphRunNotSelected: Boolean = False;
      AForceRaiseBeforeExport: Boolean = False;
      AForceRaiseAfterExport: Boolean = False): TdxChunkedStringBuilder;
    function GetDocumentPlainTextContentSaveMemory
      (AOptions: TdxPlainTextDocumentExporterOptions): TdxChunkedStringBuilder;

    procedure LoadDocumentPlainTextContentCore(AStream: TStream;
      AOptions: TdxPlainTextDocumentImporterOptions); virtual;

    procedure ApplyDefaultOptions(AOptions
      : TdxDocumentImporterOptions); overload;
    procedure ApplyDefaultOptions(AOptions
      : TdxDocumentExporterOptions); overload;
  ...
  public
    ...
    function GetDocumentRtfContent(AOptions
      ...
      AKeepFieldCodeViewState: Boolean = False;
      AForceRaiseBeforeExport: Boolean = False;
      AForceRaiseAfterExport: Boolean = False): string; override;
    procedure SaveDocumentRtfContent(AStream: TStream;
      AOptions: TdxRtfDocumentExporterOptions); override;
    procedure SetDocumentRtfContent(const ARtfContent: string); overload;
    procedure SetDocumentRtfContent(const ARtfContent: string;
      AOptions: TdxRtfDocumentImporterOptions); overload;
    procedure LoadDocumentRtfContent(AStream: TStream;
      AOptions: TdxRtfDocumentImporterOptions); override;

    function GetDocumentPlainTextContent
      (AOptions: TdxPlainTextDocumentExporterOptions = nil): string; override;
    procedure SetDocumentPlainTextContent(const APlainTextContent
      : string); overload;
    ...
    procedure SetDocumentPlainTextContentCore(const APlainTextContent: string;
      AChangeType: TdxDocumentModelChangeType);
    procedure SaveDocumentPlainTextContent(AStream: TStream;
      AOptions: TdxPlainTextDocumentExporterOptions); override;
    procedure LoadDocumentPlainTextContent(AStream: TStream;
      AOptions: TdxPlainTextDocumentImporterOptions); override;
    ...
    procedure SetDocumentOpenXmlContent(const AContent: TArray<Byte>;
      AOptions: TdxOpenXmlDocumentImporterOptions); overload;
    procedure LoadDocumentOpenXmlContent(AStream: TStream;
      AOptions: TdxOpenXmlDocumentImporterOptions); override;
    procedure SaveDocumentOpenXmlContent(AStream: TStream;
      AOptions: TdxOpenXmlDocumentExporterOptions); override;

    procedure LoadDocumentHtmlContent(AStream: TStream;
      AOptions: TdxHtmlDocumentImporterOptions); override;
    procedure SaveDocumentHtmlContent(AStream: TStream;
      AOptions: TdxHtmlDocumentExporterOptions); override;
    function GetDocumentHtmlContent: string; overload;
    function GetDocumentHtmlContent(AOptions: TdxHtmlDocumentExporterOptions)
      : string; overload;
    procedure SetDocumentHtmlContent(const AContent: string); overload;
    procedure SetDocumentHtmlContent(const AContent: string;
      AOptions: TdxHtmlDocumentImporterOptions); overload;

    function GetDocumentDocContent(AOptions: TdxDocDocumentExporterOptions)
      : TArray<Byte>; overload; override;
    ...
    procedure SetDocumentDocContent(const AContent: TArray<Byte>;
      AOptions: TdxDocDocumentImporterOptions); overload;
    procedure LoadDocumentDocContent(AStream: TStream;
      AOptions: TdxDocDocumentImporterOptions); override;
    procedure SaveDocumentDocContent(AStream: TStream;
      AOptions: TdxDocDocumentExporterOptions); override;
    ...
    property OpenXmlBytes: TArray<Byte> read GetOpenXmlBytes
      write SetOpenXmlBytes;
    ...
    procedure RaiseFieldInserted(APieceTable: TdxCustomPieceTable;
      AFieldIndex: Integer);
    procedure RaiseFieldRemoved(APieceTable: TdxCustomPieceTable;
      AFieldIndex: Integer);
    ...
    procedure SetDocumentContent<T>(AValue: T;
      const ASetterMethod: TdxAction<T>);

    procedure OnDocumentModelContentChanged(Sender: TObject;
      E: TdxEventArgs); virtual;
    procedure OnEndDocumentUpdate(Sender: TObject;
      E: TdxDocumentUpdateCompleteEventArgs); virtual;
    procedure OnEndDocumentUpdateSetContentMode(Sender: TObject;
      E: TdxDocumentUpdateCompleteEventArgs); virtual;
    procedure OnDocumentReplaced; virtual;
    procedure OnHyperlinkInfoDeleted(Sender: TObject;
      E: TdxHyperlinkInfoEventArgs);
    procedure OnHyperlinkInfoInserted(Sender: TObject;
      E: TdxHyperlinkInfoEventArgs);
    procedure CreateNewDocument; override;

    procedure OnSectionInserted(Sender: TObject;
      E: TdxSectionEventArgs); virtual;
    procedure OnSectionRemoved(Sender: TObject;
      E: TdxSectionEventArgs); virtual;
    ...
    property ParagraphInserted: TdxParagraphEventHandler
      read FOnParagraphInserted;
    property ParagraphRemoved: TdxParagraphEventHandler
      read FOnParagraphRemoved;
...
function TdxInternalAPI.RemoveParagraphs(const APlainTextContent
  : string): string;
var
  L: Integer;
...
begin
  if FCachedDocContent.HasValue and
    (StringOf(FCachedDocContent.Value) = StringOf(AValue)) then
    Exit;
...
procedure TdxInternalAPI.SetDocumentContent<T>(AValue: T;
  const ASetterMethod: TdxAction<T>);
begin
  ResetCachedContent;
  UnsubscribeDocumentModelEvents;
...
function TdxInternalAPI.GetDocumentRtfContent
  (AOptions: TdxRtfDocumentExporterOptions = nil;
  ALastParagraphRunNotSelected: Boolean = False;
  AKeepFieldCodeViewState: Boolean = False;
  AForceRaiseBeforeExport: Boolean = False;
...
begin
  AResult := GetDocumentRtfContentCore(AOptions, ALastParagraphRunNotSelected,
    AKeepFieldCodeViewState, AForceRaiseBeforeExport, AForceRaiseAfterExport);
  try
...
var
  ...
  APreamble: TBytes;
begin
  DocumentModel.RaiseBeforeExport(TdxRichEditDocumentFormat.PlainText,
    AOptions);
...
procedure TdxInternalAPI.SaveDocumentRtfContent(AStream: TStream;
  AOptions: TdxRtfDocumentExporterOptions);
var
  AContent: TdxChunkedStringBuilder;
  ABytes: TBytes;
...
begin
  FUnitConverters[TdxMeasurementUnit.Document] :=
    TdxDocumentsToModelUnitsConverter.Create(DocumentModel.UnitConverter);
  FUnitConverters[TdxMeasurementUnit.Inch] :=
    TdxInchesToModelUnitsConverter.Create(DocumentModel.UnitConverter);
  FUnitConverters[TdxMeasurementUnit.Millimeter] :=
    TdxMillimetersToModelUnitsConverter.Create(DocumentModel.UnitConverter);
  FUnitConverters[TdxMeasurementUnit.Centimeter] :=
    TdxCentimetersToModelUnitsConverter.Create(DocumentModel.UnitConverter);
  FUnitConverters[TdxMeasurementUnit.Point] :=
    TdxPointsToModelUnitsConverter.Create(DocumentModel.UnitConverter);
end;
...
function TdxInternalAPI.GetConverter(Index: TdxMeasurementUnit)
  : TdxUnitConverter;
begin
  Result := FUnitConverters[Index];
end;

function TdxInternalAPI.GetDocumentPlainTextContent
...
function TdxInternalAPI.CreateHtmlExporter(ADocumentModel: TdxDocumentModel;
  AOptions: TdxDocumentExporterOptions): TObject;
begin
  Assert(AOptions is TdxHtmlDocumentExporterOptions);
  Result := TdxExportFileFormats.GetExporter(TdxRichEditDocumentFormat.Html,
    ADocumentModel, AOptions);
end;

function TdxInternalAPI.CreateHtmlImporter(ADocumentModel: TdxDocumentModel;
  AOptions: TdxDocumentImporterOptions): TObject;
begin
  Assert(AOptions is TdxHtmlDocumentImporterOptions);
  Result := TdxImportFileFormats.GetImporter(TdxRichEditDocumentFormat.Html,
    ADocumentModel, AOptions);
end;
...
begin
  ...
  try
    ...
    SetDocumentPlainTextContentCore('',
      TdxDocumentModelChangeType.CreateEmptyDocument);
...
procedure TdxInternalAPI.OnParagraphInserted(APieceTable: TdxCustomPieceTable;
  ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
  ARunIndex: TdxRunIndex; ACell: TdxCustomTableCell;
  AIsParagraphMerged: Boolean; AActualParagraphIndex: TdxParagraphIndex;
  AHistoryNotificationId: Integer);
begin
  UpdateAnchors(procedure(const Sender: TdxDocumentModelPositionAnchor)
    begin
      TdxDocumentModelStructureChangedNotifier.NotifyParagraphInserted(Sender,
        APieceTable, ASectionIndex, AParagraphIndex, ARunIndex, ACell,
        AIsParagraphMerged, AActualParagraphIndex, AHistoryNotificationId);
    end);
  RaiseParagraphInserted(TdxPieceTable(APieceTable), ASectionIndex,
    AActualParagraphIndex);
end;

procedure TdxInternalAPI.OnParagraphRemoved(APieceTable: TdxCustomPieceTable;
ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; AHistoryNotificationId: Integer);
begin
  UpdateAnchors(procedure(const Sender: TdxDocumentModelPositionAnchor)
    begin
      TdxDocumentModelStructureChangedNotifier.NotifyParagraphRemoved(Sender,
...
procedure TdxInternalAPI.OnParagraphMerged(APieceTable: TdxCustomPieceTable;
ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex;
ARunIndex: TdxRunIndex; AHistoryNotificationId: Integer);
begin
  UpdateAnchors(procedure(const Sender: TdxDocumentModelPositionAnchor)
    begin
      TdxDocumentModelStructureChangedNotifier.NotifyParagraphMerged(Sender,
        APieceTable, ASectionIndex, AParagraphIndex, ARunIndex,
        AHistoryNotificationId);
    end);
...
procedure TdxInternalAPI.OnRunInserted(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ANewRunIndex: TdxRunIndex;
ALength, AHistoryNotificationId: Integer);
begin
  UpdateAnchors(procedure(const Sender: TdxDocumentModelPositionAnchor)
    begin
      TdxDocumentModelStructureChangedNotifier.NotifyRunInserted(Sender,
        APieceTable, AParagraphIndex, ANewRunIndex, ALength,
        AHistoryNotificationId);
    end);
end;

procedure TdxInternalAPI.OnRunRemoved(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ALength, AHistoryNotificationId: Integer);
begin
  UpdateAnchors(procedure(const Sender: TdxDocumentModelPositionAnchor)
    begin
      TdxDocumentModelStructureChangedNotifier.NotifyRunRemoved(Sender,
        APieceTable, AParagraphIndex, ARunIndex, ALength,
        AHistoryNotificationId);
    end);
end;

procedure TdxInternalAPI.OnRunSplit(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ASplitOffset: Integer);
begin
  UpdateAnchors(procedure(const Sender: TdxDocumentModelPositionAnchor)
    begin
      TdxDocumentModelStructureChangedNotifier.NotifyRunSplit(Sender,
        APieceTable, AParagraphIndex, ARunIndex, ASplitOffset);
    end);
end;

procedure TdxInternalAPI.OnRunJoined(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; AJoinedRunIndex: TdxRunIndex;
ASplitOffset, ATailRunLength: Integer);
begin
  UpdateAnchors(procedure(const Sender: TdxDocumentModelPositionAnchor)
    begin
      TdxDocumentModelStructureChangedNotifier.NotifyRunJoined(Sender,
        APieceTable, AParagraphIndex, AJoinedRunIndex, ASplitOffset,
        ATailRunLength);
    end);
end;

procedure TdxInternalAPI.OnRunMerged(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ADeltaRunLength: Integer);
begin
  UpdateAnchors(procedure(const AAnchor: TdxDocumentModelPositionAnchor)
    begin
      TdxDocumentModelStructureChangedNotifier.NotifyRunMerged(AAnchor,
        APieceTable, AParagraphIndex, ARunIndex, ADeltaRunLength);
    end);
end;

procedure TdxInternalAPI.OnRunUnmerged(APieceTable: TdxCustomPieceTable;
AParagraphIndex: TdxParagraphIndex; ARunIndex: TdxRunIndex;
ADeltaRunLength: Integer);
begin
  UpdateAnchors(procedure(const AAnchor: TdxDocumentModelPositionAnchor)
    begin
      TdxDocumentModelStructureChangedNotifier.NotifyRunUnmerged(AAnchor,
        APieceTable, AParagraphIndex, ARunIndex, ADeltaRunLength);
    end);
end;
...
procedure TdxInternalAPI.OnFieldRemoved(APieceTable: TdxCustomPieceTable;
AFieldIndex: Integer);
begin
  RaiseFieldRemoved(APieceTable, AFieldIndex);
end;

procedure TdxInternalAPI.OnFieldInserted(APieceTable: TdxCustomPieceTable;
AFieldIndex: Integer);
begin
  RaiseFieldInserted(APieceTable, AFieldIndex);
end;

procedure TdxInternalAPI.OnBeginMultipleRunSplit(APieceTable
  : TdxCustomPieceTable);
begin
end;
...
procedure TdxInternalAPI.OnHyperlinkInfoDeleted(Sender: TObject;
E: TdxHyperlinkInfoEventArgs);
begin
  RaiseHyperlinkInfoDeleted(E);
end;

procedure TdxInternalAPI.OnHyperlinkInfoInserted(Sender: TObject;
E: TdxHyperlinkInfoEventArgs);
begin
...
begin
  ...
  if [TdxDocumentModelChangeAction.RaiseDocumentLoaded,
    ...
    TdxDocumentModelChangeAction.RaiseContentChanged] * AChangeActions <> []
  then
    ResetCachedContent;
  if [TdxDocumentModelChangeAction.RaiseDocumentLoaded,
    TdxDocumentModelChangeAction.RaiseEmptyDocumentCreated] * AChangeActions
    <> [] then
    OnDocumentReplaced;
end;
...
begin
  ...
  if (TdxDocumentModelChangeAction.RaiseDocumentLoaded in AChangeActions) or
    (TdxDocumentModelChangeAction.RaiseEmptyDocumentCreated in AChangeActions)
  then
    OnDocumentReplaced;
end;

procedure TdxInternalAPI.OnEndMultipleRunSplit(APieceTable
  : TdxCustomPieceTable);
begin
...
function TdxInternalAPI.GetDocumentRtfContentSaveMemory
  (AOptions: TdxRtfDocumentExporterOptions;
ALastParagraphRunNotSelected: Boolean = False;
AForceRaiseBeforeExport: Boolean = False;
AForceRaiseAfterExport: Boolean = False): TdxChunkedStringBuilder;
begin
  Result := GetDocumentRtfContentCore(AOptions, ALastParagraphRunNotSelected,
    False, AForceRaiseBeforeExport, AForceRaiseAfterExport);
end;

function TdxInternalAPI.GetDocumentPlainTextContentCore
  (AOptions: TdxPlainTextDocumentExporterOptions = nil)
  : TdxChunkedStringBuilder;
var
...
begin
  ...
  try
    if ARaiseEvents then
      AModelForExport.RaiseBeforeExport(TdxRichEditDocumentFormat.PlainText,
        AOptions);
    AExporter := TdxExportFileFormats.GetExporter
      (TdxRichEditDocumentFormat.PlainText, AModelForExport, AOptions);
    try
...
procedure TdxInternalAPI.ApplyDefaultOptions
  (AOptions: TdxDocumentImporterOptions);
var
  ADefaultOptions: TdxDocumentImporterOptions;
begin
  ADefaultOptions := DocumentModel.DocumentImportOptions.GetOptions
    (AOptions.Format);
...
begin
  ADefaultOptions := DocumentModel.DocumentExportOptions.GetOptions
    (AOptions.Format);
  if ADefaultOptions <> nil then
    AOptions.CopyFrom(ADefaultOptions);
end;
...
begin
  DocumentModel.BeforeEndDocumentUpdate.Remove
    (OnEndDocumentUpdateSetContentMode);
  DocumentModel.AfterEndDocumentUpdate.Remove
    (OnEndDocumentUpdateSetContentMode);
end;

procedure TdxInternalAPI.UpdateAnchors(const AnchorAction
  : TdxAction<TdxDocumentModelPositionAnchor>);
var
  I: Integer;
  AAnchor: TdxDocumentModelPositionAnchor;
...
begin
  if not FCachedPlainTextContent.IsNull and (FCachedPlainTextContent = Value)
    and ((Length(FCachedPlainTextContent.Value) > 0) or DocumentModel.IsEmpty)
  then
    Exit;
...
begin
  if FCachedOpenXmlContent.HasValue and
    (StringOf(FCachedOpenXmlContent.Value) = StringOf(AValue)) then
    Exit;
...
begin
  DocumentModel.RaiseBeforeImport(TdxRichEditDocumentFormat.PlainText,
    AOptions);
...
begin
  ...
  try
    ...
    AContent := AOptions.ActualEncoding.GetString(ABytes, APreambleLength,
      Length(ABytes) - APreambleLength);
...
function TdxInternalAPI.PrepareModelForExport
  (AFormat: TdxRichEditDocumentFormat): TdxDocumentModel;
begin
...
function TdxInternalAPI.GetDocumentRtfContentCore
  (AOptions: TdxRtfDocumentExporterOptions = nil;
ALastParagraphRunNotSelected: Boolean = False;
AKeepFieldCodeViewState: Boolean = False;
AForceRaiseBeforeExport: Boolean = False;
...
begin
  ...
  try
    if AForceRaiseBeforeExport then
      AModelForExport.RaiseBeforeExport(TdxRichEditDocumentFormat.Rtf,
        AOptions);

    AExporter := TdxExportFileFormats.GetExporter(TdxRichEditDocumentFormat.Rtf,
      DocumentModel, AOptions);
    try
...
procedure TdxInternalAPI.SetDocumentPlainTextContent(const APlainTextContent
  : string; AOptions: TdxPlainTextDocumentImporterOptions);
begin
  SetDocumentPlainTextContentCore(APlainTextContent,
    TdxDocumentModelChangeType.LoadNewDocument);
end;

procedure TdxInternalAPI.SetDocumentPlainTextContentCore(const APlainTextContent
  : string; AChangeType: TdxDocumentModelChangeType);
var
  S: string;
begin
...
procedure TdxInternalAPI.LoadDocumentOpenXmlContent(AStream: TStream;
...
begin
  ...
  try
    AImporter := TdxImportFileFormats.GetImporter
      (TdxRichEditDocumentFormat.OpenXml, DocumentModel, AOptions);
    ...
    on EdxOLECryptoContainerError do
      raise;
    on E: Exception do
    begin
      DocumentModel.RaiseInvalidFormatException(E);
...
procedure TdxInternalAPI.SaveDocumentOpenXmlContent(AStream: TStream;
...
function TdxInternalAPI.GetDocumentOpenXmlContent
  (AOptions: TdxOpenXmlDocumentExporterOptions): TArray<Byte>;
var
...
begin
  ...
  if ARaiseEvents then
    AModelForExport.RaiseBeforeExport(TdxRichEditDocumentFormat.OpenXml,
      AOptions);
  try
    AExporter := TdxExportFileFormats.GetExporter
      (TdxRichEditDocumentFormat.OpenXml, DocumentModel, AOptions);
...
procedure TdxInternalAPI.SetDocumentOpenXmlContent(const AContent
  : TArray<Byte>);
var
  AOptions: TdxOpenXmlDocumentImporterOptions;
begin
  ...
  try
    ApplyDefaultOptions(AOptions);
    DocumentModel.RaiseBeforeImport(TdxRichEditDocumentFormat.OpenXml,
      AOptions);
...
procedure TdxInternalAPI.LoadDocumentHtmlContent(AStream: TStream;
...
begin
  ...
  try
    AImporter := TdxImportFileFormats.GetImporter
      (TdxRichEditDocumentFormat.Html, DocumentModel, AOptions);
    if AImporter <> nil then
      try
        AImporter.Import(AStream);
      finally
...
procedure TdxInternalAPI.SaveDocumentHtmlContent(AStream: TStream;
...
begin
  ...
  AExporter := TdxExportFileFormats.GetExporter(TdxRichEditDocumentFormat.Html,
    DocumentModel, AOptions);
  if AExporter <> nil then
    try
      AExporter.Export(AStream);
...
function TdxInternalAPI.GetDocumentHtmlContent
  (AOptions: TdxHtmlDocumentExporterOptions): string;
var
  AIsDefaultOptions: Boolean;
  AExporter: TdxCustomDocumentModelExporter;
  AStream: TdxMemoryStream;
...
procedure TdxInternalAPI.LoadDocumentDocContent(AStream: TStream;
...
begin
  ...
  try
    AImporter := TdxImportFileFormats.GetImporter(TdxRichEditDocumentFormat.Doc,
      DocumentModel, AOptions);
    if AImporter <> nil then
      try
        AImporter.Import(AStream);
...
procedure TdxInternalAPI.SaveDocumentDocContent(AStream: TStream;
...
begin
  ...
  AExporter := TdxExportFileFormats.GetExporter(TdxRichEditDocumentFormat.Doc,
    DocumentModel, AOptions);
  if AExporter <> nil then
    try
      AExporter.Export(AStream);
...
function TdxInternalAPI.GetDocumentDocContent
  (AOptions: TdxDocDocumentExporterOptions): TArray<Byte>;
var
  AIsDefaultOptions: Boolean;
  AModelForExport: TdxDocumentModel;
  AExporter: TdxCustomDocumentModelExporter;
...
procedure TdxInternalAPI.SetExporterFactory(const Value
  : IdxDocumentExporterFactory);
begin
  FExporterFactory := Value;
end;

procedure TdxInternalAPI.SetImporterFactory(const Value
  : IdxDocumentImporterFactory);
begin
...
procedure TdxInternalAPI.RaiseHyperlinkInfoInserted
  (E: TdxHyperlinkInfoEventArgs);
begin
...
procedure TdxInternalAPI.RaiseHyperlinkInfoDeleted
  (E: TdxHyperlinkInfoEventArgs);
begin
...
procedure TdxInternalAPI.RaiseParagraphInserted(APieceTable
...
begin
  if FOnParagraphInserted.Empty then
    Exit;
  Args := TdxParagraphEventArgs.Create(APieceTable, ASectionIndex,
    AParagraphIndex);
  try
...
procedure TdxInternalAPI.RaiseParagraphRemoved(APieceTable: TdxCustomPieceTable;
ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex);
var
  Args: TdxParagraphEventArgs;
begin
...
procedure TdxInternalAPI.RaiseParagraphMerged(APieceTable: TdxCustomPieceTable;
ASectionIndex: TdxSectionIndex; AParagraphIndex: TdxParagraphIndex);
var
  Args: TdxParagraphEventArgs;
begin
