...
uses
  ...
  cxButtons, cxContainer, cxEdit, cxListBox, dxLayoutControl,
  cxGridBandedTableView, cxClasses, cxGeometry,
  cxGridWizardCustomPage, cxGridWizardStrs, cxGridWizardCustomHelper,
...
type
  ...
  TcxGridWizardBandedTableViewOptionsBandsPageFrame = class
  ...
  protected
    ...
    property BandedTableViewHelper: IcxGridWizardBandedTableView
      read GetBandedTableViewHelper;
...
function TcxGridWizardBandedTableViewOptionsBandsPageFrame.
  GetCanJumpToNextPage: Boolean;
begin
...
procedure TcxGridWizardBandedTableViewOptionsBandsPageFrame.AddBand
...
begin
  ...
  acMoveDown.Enabled := (lbBands.SelCount > 0) and not lbBands.Selected
    [lbBands.Count - 1];
  acMoveUp.Enabled := (lbBands.SelCount > 0) and not lbBands.Selected[0];
end;

procedure TcxGridWizardBandedTableViewOptionsBandsPageFrame.DeleteBand
...
function TcxGridWizardBandedTableViewOptionsBandsPageFrame.
  GetBandedTableViewHelper: IcxGridWizardBandedTableView;
begin
  Result := inherited Helper as IcxGridWizardBandedTableView;
end;

function TcxGridWizardBandedTableViewOptionsBandsPageFrame.GetBands
  : TcxGridBands;
begin
...
procedure TcxGridWizardBandedTableViewOptionsBandsPageFrame.
...
procedure TcxGridWizardBandedTableViewOptionsBandsPageFrame.SwapBands
...
procedure TcxGridWizardBandedTableViewOptionsBandsPageFrame.acAddBandExecute
  (Sender: TObject);
const
  FormatStr = '%s %d';
var
...
begin
  ...
  if cxgwExecuteEditItemDialog(Self,
    cxGetResourceString(@scxgwBandsPageInputQueryCaptionAdd), ABandCaption) then
  begin
...
procedure TcxGridWizardBandedTableViewOptionsBandsPageFrame.acEditBandExecute
  (Sender: TObject);
var
  ANewCaption: string;
begin
  ...
  if cxgwExecuteEditItemDialog(Self,
    cxGetResourceString(@scxgwBandsPageInputQueryCaptionEdit), ANewCaption) then
  begin
...
procedure TcxGridWizardBandedTableViewOptionsBandsPageFrame.
  acDeleteAllBandsExecute(Sender: TObject);
var
  I: Integer;
begin
...
procedure TcxGridWizardBandedTableViewOptionsBandsPageFrame.
  acDeleteSelectedBandsExecute(Sender: TObject);
var
  I: Integer;
begin
  for I := lbBands.Count - 1 downto 0 do
...
procedure TcxGridWizardBandedTableViewOptionsBandsPageFrame.acMoveDownExecute
  (Sender: TObject);
var
  I: Integer;
begin
...
procedure TcxGridWizardBandedTableViewOptionsBandsPageFrame.acMoveUpExecute
  (Sender: TObject);
var
  I: Integer;
begin
...
procedure TcxGridWizardBandedTableViewOptionsBandsPageFrame.lbBandsClick
  (Sender: TObject);
begin
  CheckBandsCount;
end;

procedure TcxGridWizardBandedTableViewOptionsBandsPageFrame.lbBandsDragOver
...
procedure TcxGridWizardBandedTableViewOptionsBandsPageFrame.lbBandsEndDrag
