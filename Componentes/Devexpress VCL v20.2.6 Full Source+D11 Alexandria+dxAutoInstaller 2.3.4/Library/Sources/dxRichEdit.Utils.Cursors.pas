...
begin
  TdxCursorManager.Register(crcxRichEditControlBeginRotate, HInstance,
    'DXRICHEDITCONTROLBEGINROTATE');
  TdxCursorManager.Register(crcxRichEditControlIBeamItalic, HInstance,
    'DXRICHEDITCONTROLIBEAMITALIC');
  TdxCursorManager.Register(crcxRichEditControlResizeColumn, HInstance,
    'DXRICHEDITCONTROLRESIZECOLUMN');
  TdxCursorManager.Register(crcxRichEditControlResizeRow, HInstance,
    'DXRICHEDITCONTROLRESIZEROW');
  TdxCursorManager.Register(crcxRichEditControlReverseArrow, HInstance,
    'DXRICHEDITCONTROLREVERSEARROW');
  TdxCursorManager.Register(crcxRichEditControlRotate, HInstance,
    'DXRICHEDITCONTROLROTATE');
  TdxCursorManager.Register(crcxRichEditControlSelectColumn, HInstance,
    'DXRICHEDITCONTROLSELECTCOLUMN');
  TdxCursorManager.Register(crcxRichEditControlSelectTableCell, HInstance,
    'DXRICHEDITCONTROLSELECTTABLECELL');
end;
