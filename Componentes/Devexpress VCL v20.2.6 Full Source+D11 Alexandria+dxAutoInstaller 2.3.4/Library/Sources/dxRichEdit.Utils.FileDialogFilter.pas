...
type
  ...
  protected
    ...
    procedure AppendExtension(AStringBuilder: TStringBuilder;
      const AExtension: string); virtual;
    function CreateFilterString: string; virtual;
  public
    constructor Create; overload;
    constructor Create(const ADescription, AExtension: string); overload;
    constructor Create(const ADescription: string;
      const AExtensions: array of string); overload;
    constructor Create(const ADescription: string;
      AExtensions: TStrings); overload;
...
begin
  FAllFiles := TdxFileDialogFilter.Create
    (cxGetResourceString(@sdxRichEditFileFilterDescription_AllFiles), '*');
  FEmpty := TdxFileDialogFilter.Create;
  FOpenXMLFiles := TdxFileDialogFilter.Create
    (cxGetResourceString
    (@sdxRichEditFileFilterDescription_OpenXmlFiles), 'docx');
  FRtfFiles := TdxFileDialogFilter.Create
    (cxGetResourceString(@sdxRichEditFileFilterDescription_RtfFiles), 'rtf');
  FHtmlFiles := TdxFileDialogFilter.Create
    (cxGetResourceString(@sdxRichEditFileFilterDescription_HtmlFiles),
    ['htm', 'html']);
  FDocFiles := TdxFileDialogFilter.Create
    (cxGetResourceString(@sdxRichEditFileFilterDescription_DocFiles), ['doc']);
end;
