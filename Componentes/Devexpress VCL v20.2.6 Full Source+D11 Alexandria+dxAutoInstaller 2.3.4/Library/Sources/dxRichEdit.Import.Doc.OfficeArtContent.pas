...
type
  ...
  TdxDocContentState = (MainDocument, Footnotes, HeadersFootersStory,
    HeadersFootersEnd, Macro, Comments, Endnotes, TextBoxes,
    HeaderTextBoxes, Final);
  ...
  IdxOfficeArtPropertiesBase = interface
    ...
    property UseIsBehindDoc: Boolean read GetUseIsBehindDoc
      write SetUseIsBehindDoc;
    ...
    property UseLayoutInCell: Boolean read GetUseLayoutInCell
      write SetUseLayoutInCell;
  end;
  ...
  IdxOfficeArtProperties = interface(IdxOfficeArtPropertiesBase)
    ...
    property UseTextBottom: Boolean read GetUseTextBottom
      write SetUseTextBottom;
    ...
    property UseFitShapeToText: Boolean read GetUseFitShapeToText
      write SetUseFitShapeToText;
    property FitShapeToText: Boolean read GetFitShapeToText
      write SetFitShapeToText;
    ...
    property WrapLeftDistance: Integer read GetWrapLeftDistance
      write SetWrapLeftDistance;
    property UseWrapLeftDistance: Boolean read GetUseWrapLeftDistance
      write SetUseWrapLeftDistance;
    property WrapRightDistance: Integer read GetWrapRightDistance
      write SetWrapRightDistance;
    property UseWrapRightDistance: Boolean read GetUseWrapRightDistance
      write SetUseWrapRightDistance;
    property WrapTopDistance: Integer read GetWrapTopDistance
      write SetWrapTopDistance;
    property UseWrapTopDistance: Boolean read GetUseWrapTopDistance
      write SetUseWrapTopDistance;
    property WrapBottomDistance: Integer read GetWrapBottomDistance
      write SetWrapBottomDistance;
    property UseWrapBottomDistance: Boolean read GetUseWrapBottomDistance
      write SetUseWrapBottomDistance;
    property CropFromTop: Double read GetCropFromTop write SetCropFromTop;
    property CropFromBottom: Double read GetCropFromBottom
      write SetCropFromBottom;
  ...
  TdxOfficeDrawingPropertyBase = class abstract(TInterfacedObject,
    IdxOfficeDrawingProperty)
  public const
  ...
  public type
    TMsoph = (msophAbs, msophLeft, msophCenter, msophRight, msophInside,
      msophOutside);
  strict private
  ...
  public type
    TMsopv = (msopvAbs, msopvTop, msopvCenter, msopvBottom, msopvInside,
      msopvOutside);
  strict private
  ...
  public type
    TMsoprh = (msoprhMargin, msoprhPage, msoprhText, msoprhChar);
  strict private
  ...
  public type
    TMsoprv = (msoprvMargin, msoprvPage, msoprvText, msoprvLine);
  strict private
  ...
  IdxOfficeArtTertiaryProperties = interface(IdxOfficeArtPropertiesBase)
    ...
    procedure SetSizeRelH(const Value
      : TdxDrawingGroupShape2SizeRelH.TRelativeFrom);
    procedure SetSizeRelV(const Value
      : TdxDrawingGroupShape2SizeRelV.TRelativeFrom);
    ...
    property PosRelH: TdxDrawingGroupShapePosRelH.TMsoprh read GetPosRelH
      write SetPosRelH;
    property PosRelV: TdxDrawingGroupShapePosRelV.TMsoprv read GetPosRelV
      write SetPosRelV;
    property SizeRelH: TdxDrawingGroupShape2SizeRelH.TRelativeFrom
      read GetSizeRelH write SetSizeRelH;
    property SizeRelV: TdxDrawingGroupShape2SizeRelV.TRelativeFrom
      read GetSizeRelV write SetSizeRelV;
  end;
  ...
  protected
    ...
    function GetSize: Integer; override;
  public
    class function FromStream(AReader: TBinaryReader;
      AHeader: TdxOfficeArtRecordHeader)
      : TdxOfficeArtFileDrawingGroupRecord; static;

    property MainDocumentFloatingObjectsCount: Integer
      read FMainDocumentPicturesCount write FMainDocumentPicturesCount;
    property HeaderFloatingObjectsCount: Integer read FHeaderPicturesCount
      write FHeaderPicturesCount;
  ...
  protected
    ...
    procedure WriteCore(AWriter: TBinaryWriter; AEmbeddedWriter: TBinaryWriter);
      overload; virtual;
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader;
      ...
      const AImageCreator: IdxDocOfficeImageCreator)
      : TdxOfficeArtBlipStoreContainer; static;
    procedure Write(AWriter: TBinaryWriter; AEmbeddedWriter: TBinaryWriter);

    property Blips: TdxList<TdxBlipBase> read FBlips;
  end;

  TdxOfficeColorUse = (None = $0000, UseFillColor = $00F0,
    UseLineOrFillColor = $00F1, UseLineColor = $00F2, UseShadowColor = $00F3,
    UseCurrentColor = $00F4, UseFillBackColor = $00F5, UseLineBackColor = $00F6,
    UseFillOrLineColor = $00F7);

  TdxOfficeColorTransform = (None = $0000, Darken = $0100, Lighten = $0200,
    AddGray = $0300, SubtractGray = $0400, ReverseSubtractGray = $0500,
    Threshold = $0600, Invert = $2000, ToggleHighBit = $4000,
  ...
  public
    ...
    constructor Create(AColorUse: TdxOfficeColorUse;
      ATransform: TdxOfficeColorTransform; ATransformValue: Byte); overload;
    class function FromStream(AReader: TBinaryReader)
      : TdxOfficeColorRecord; static;
    class function FromBytes(const AData: TBytes; AOffset: Integer)
      : TdxOfficeColorRecord; static;
    procedure Write(AWriter: TBinaryWriter);
    ...
    property ColorSchemeIndex: Byte read GetColorSchemeIndex
      write SetColorSchemeIndex;
    property SystemColorIndex: Integer read GetSystemColorIndex
      write SetSystemColorIndex;
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader;
      AHeader: TdxOfficeArtRecordHeader): TdxOfficeArtFileDrawingRecord; static;
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader;
      AHeader: TdxOfficeArtRecordHeader)
      : TdxOfficeArtSplitMenuColorContainer; static;
  ...
  public
    constructor Create;
    class function FromStream(AReader: TBinaryReader;
      AEmbeddedReader: TBinaryReader;
      const AImageCreator: IdxDocOfficeImageCreator)
      : TdxOfficeArtDrawingContainer; static;
    procedure Write(AWriter: TBinaryWriter; AEmbeddedWriter: TBinaryWriter);
    procedure ParseHeader(AReader: TBinaryReader;
      AEmbeddedReader: TBinaryReader;
      const AImageCreator: IdxDocOfficeImageCreator);

    property FileDrawingBlock: TdxOfficeArtFileDrawingGroupRecord
      read FFileDrawingBlock;
    property BlipContainer: TdxOfficeArtBlipStoreContainer read FBlipContainer;
    property SplitMenuColorContainer: TdxOfficeArtSplitMenuColorContainer
      read FSplitMenuColorContainer;
  end;
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader): TdxOfficeArtShapeRecord;
      overload; static;
    class function FromStream(AReader: TBinaryReader;
      AHeader: TdxOfficeArtRecordHeader): TdxOfficeArtShapeRecord;
      overload; static;

    property ShapeIdentifier: Integer read FShapeIdentifier
      write FShapeIdentifier;
    ...
    property HaveShapeType: Boolean read GetHaveShapeType
      write SetHaveShapeType;
  end;
  ...
  TdxOfficeArtProperties = class(TdxOfficeArtPropertiesBase,
    IdxOfficeArtProperties, IdxOfficeArtPropertiesBase)
  strict private
    FBlipIndex: Integer;
    FTextIndex: Integer;
    FZOrder: Integer;
  ...
  public
    class function FromStream(AReader: TBinaryReader;
      AHeader: TdxOfficeArtRecordHeader): TdxOfficeArtProperties; static;
    ...
    property TextBoxProperties: TdxTextBoxProperties read FTextBoxProperties
      write FTextBoxProperties;
    property FloatingObjectProperties: TdxFloatingObjectProperties
      read FFloatingObjectProperties write FFloatingObjectProperties;
  ...
  TdxOfficeArtTertiaryProperties = class(TdxOfficeArtPropertiesBase,
    IdxOfficeArtTertiaryProperties)
  public const
  ...
  protected
    ...
    procedure SetSizeRelH(const AValue
      : TdxDrawingGroupShape2SizeRelH.TRelativeFrom);
    procedure SetSizeRelV(const AValue
      : TdxDrawingGroupShape2SizeRelV.TRelativeFrom);
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader;
      AHeader: TdxOfficeArtRecordHeader)
      : TdxOfficeArtTertiaryProperties; static;
    procedure CreateProperties; override;
  ...
  protected
    ...
    procedure ParseHeader(AReader: TBinaryReader);
  public
    constructor Create(AShapeTypeCode
      : Integer = TdxOfficeArtHeaderInfos.PictureFrameShape);
    class function FromStream(AReader: TBinaryReader;
      AHeader: TdxOfficeArtRecordHeader): TdxOfficeArtShapeContainer; static;
    ...
    property ArtTertiaryProperties: TdxOfficeArtTertiaryProperties
      read FArtTertiaryProperties;
  end;
  ...
  strict private
    ...
    FBlips: TdxList<TdxBlipBase>;
  protected
    procedure Read(AReader: TBinaryReader; ASize: Integer;
      const AImageCreator: IdxDocOfficeImageCreator);
  public
    constructor Create;
    destructor Destroy; override;
    class function FromStream(AReader: TBinaryReader; ASize: Integer;
      const AImageCreator: IdxDocOfficeImageCreator)
      : TdxOfficeArtInlineShapeContainer; static;
    procedure Write(AWriter: TBinaryWriter);
  ...
  TdxOfficeDrawingMsoArrayPropertyBase = class abstract
    (TdxOfficeDrawingPropertyBase)
  strict private
    FValue: Integer;
  protected
  ...
  TdxOfficeDrawingColorPropertyBase = class abstract
    (TdxOfficeDrawingPropertyBase)
  strict private
  ...
  public
    ...
    property ColorRecord: TdxOfficeColorRecord read FColorRecord
      write SetColorRecord;
  end;
  ...
  protected
    function GetComplex: Boolean; override;
  public
    constructor Create(AWidth: Integer = TdxOfficeArtConstants.
      DefaultLineWidthInEmus);
    procedure Execute(AOwner: TdxOfficeArtPropertiesBase); override;
  end;

  { TdxOfficeDrawingBooleanPropertyBase }

  TdxOfficeDrawingBooleanPropertyBase = class abstract
    (TdxOfficeDrawingIntPropertyBase)
  public const
  ...
  TdxDrawingBooleanProtectionProperties = class
    (TdxOfficeDrawingBooleanPropertyBase)
  public const
  ...
  public
    ...
    property LockAdjustHandles: Boolean read GetLockAdjustHandles
      write SetLockAdjustHandles;
    ...
    property UseLockAdjustHandles: Boolean read GetUseLockAdjustHandles
      write SetUseLockAdjustHandles;
    property UseLockText: Boolean read GetUseLockText write SetUseLockText;
    property UseLockVertices: Boolean read GetUseLockVertices
      write SetUseLockVertices;
    property UseLockCropping: Boolean read GetUseLockCropping
      write SetUseLockCropping;
    property UseLockSelect: Boolean read GetUseLockSelect
      write SetUseLockSelect;
    property UseLockPosition: Boolean read GetUseLockPosition
      write SetUseLockPosition;
    property UseLockAspectRatio: Boolean read GetUseLockAspectRatio
      write SetUseLockAspectRatio;
    property UseLockRotation: Boolean read GetUseLockRotation
      write SetUseLockRotation;
    property UseLockUngroup: Boolean read GetUseLockUngroup
      write SetUseLockUngroup;
  end;
  ...
  protected
    function GetComplex: Boolean; override;
  public
    property UsePicturePreserveGrays: Boolean read GetUsePicturePreserveGrays
      write SetUsePicturePreserveGrays;
    ...
    property UseNoHitTestPicture: Boolean read GetUseNoHitTestPicture
      write SetUseNoHitTestPicture;
    property UsePictureGray: Boolean read GetUsePictureGray
      write SetUsePictureGray;
    property UsePictureBiLevel: Boolean read GetUsePictureBiLevel
      write SetUsePictureBiLevel;
    property UsePictureActive: Boolean read GetUsePictureActive
      write SetUsePictureActive;
    property PicturePreserveGrays: Boolean read GetPicturePreserveGrays
      write SetPicturePreserveGrays;
    property Rewind: Boolean read GetRewind write SetRewind;
    property Looping: Boolean read GetLooping write SetLooping;
    property NoHitTestPicture: Boolean read GetNoHitTestPicture
      write SetNoHitTestPicture;
    property PictureGray: Boolean read GetPictureGray write SetPictureGray;
    property PictureBiLevel: Boolean read GetPictureBiLevel
      write SetPictureBiLevel;
    property PictureActive: Boolean read GetPictureActive
      write SetPictureActive;
  end;

  { TdxDrawingFillStyleBooleanProperties }

  TdxDrawingFillStyleBooleanProperties = class
    (TdxOfficeDrawingBooleanPropertyBase)
  public type
    TFillStyle = class
    public const
  ...
  public
    ...
    property NoFillHitTest: Boolean read GetNoFillHitTest
      write SetNoFillHitTest;
    property UseNoFillHitTest: Boolean read GetUseNoFillHitTest
      write SetUseNoFillHitTest;
    property FillUseRect: Boolean read GetFillUseRect write SetFillUseRect;
    property UseFillUseRect: Boolean read GetUseFillUseRect
      write SetUseFillUseRect;
    ...
    property UseHitTestFill: Boolean read GetUseHitTestFill
      write SetUseHitTestFill;
    property Filled: Boolean read GetFilled write SetFilled;
    property UseFilled: Boolean read GetUseFilled write SetUseFilled;
    property ShapeAnchor: Boolean read GetShapeAnchor write SetShapeAnchor;
    property UseShapeAnchor: Boolean read GetUseShapeAnchor
      write SetUseShapeAnchor;
    property RecolorFillAsPicture: Boolean read GetRecolorFillAsPicture
      write SetRecolorFillAsPicture;
    property UseRecolorFillAsPicture: Boolean read GetUseRecolorFillAsPicture
      write SetUseRecolorFillAsPicture;
  end;

  { TdxDrawingLineStyleBooleanProperties }

  TdxDrawingLineStyleBooleanProperties = class
    (TdxOfficeDrawingBooleanPropertyBase)
  public type
  ...
  TdxDrawingGroupShapeBooleanProperties = class
    (TdxOfficeDrawingBooleanPropertyBase)
  public const
  ...
  public
    ...
    property UseBehindDocument: Boolean read GetUseBehindDocument
      write SetUseBehindDocument;
    property UseLayoutInCell: Boolean read GetUseLayoutInCell
      write SetUseLayoutInCell;
  end;
  ...
  TdxDrawingShadowStyleBooleanProperties = class
    (TdxOfficeDrawingBooleanPropertyBase)
  public const
  ...
  protected
    function GetComplex: Boolean; override;
  public
    property ShadowObscured: Boolean read GetShadowObscured
      write SetShadowObscured;
    property Shadow: Boolean read GetShadow write SetShadow;
    property UseShadowObscured: Boolean read GetUseShadowObscured
      write SetUseShadowObscured;
  ...
  public
    constructor Create; override;
    property IsBackground: Boolean read GetIsBackground write SetIsBackground;
    property LockShapeType: Boolean read GetLockShapeType
      write SetLockShapeType;
    property PreferRelativeResize: Boolean read GetPreferRelativeResize
      write SetPreferRelativeResize;
    property FlipVOverride: Boolean read GetFlipVOverride
      write SetFlipVOverride;
    property FlipHOverride: Boolean read GetFlipHOverride
      write SetFlipHOverride;
    property UseBackground: Boolean read GetUseBackground
      write SetUseBackground;
    property UseLockShapeType: Boolean read GetUseLockShapeType
      write SetUseLockShapeType;
    property UsePreferRelativeResize: Boolean read GetUsePreferRelativeResize
      write SetUsePreferRelativeResize;
    property UseFlipVOverride: Boolean read GetUseFlipVOverride
      write SetUseFlipVOverride;
    property UseFlipHOverride: Boolean read GetUseFlipHOverride
      write SetUseFlipHOverride;
  end;

  { TdxOfficeDrawingStringPropertyValueBase }

  TdxOfficeDrawingStringPropertyValueBase = class abstract
    (TdxOfficeDrawingIntPropertyBase)
  strict private
    FData: string;
  ...
  public
    ...
    property FitShapeToText: Boolean read GetFitShapeToText
      write SetFitShapeToText;
    property AutoTextMargins: Boolean read GetAutoTextMargins
      write SetAutoTextMargins;
    property SelectText: Boolean read GetSelectText write SetSelectText;
    property UseFitShapeToText: Boolean read GetUseFitShapeToText
      write SetUseFitShapeToText;
    property UseAutoTextMargins: Boolean read GetUseAutoTextMargins
      write SetUseAutoTextMargins;
    property UseSelectText: Boolean read GetUseSelectText
      write SetUseSelectText;
  end;
  ...
  class var
    ...
    class procedure AddProperty(AId: Integer;
      AType: TdxOfficeDrawingPropertyClass); static;
  public
    class function CreateProperty(AReader: TBinaryReader)
      : IdxOfficeDrawingProperty; static;
  ...
  strict private
    ...
    FShapeArtTertiaryProperties
      : TDictionary<Integer, TdxOfficeArtTertiaryProperties>;
    FShapeRecords: TDictionary<Integer, TdxOfficeArtShapeRecord>;
  public
    constructor Create;
    destructor Destroy; override;

    property ShapeArtProperties: TDictionary<Integer, TdxOfficeArtProperties>
      read FShapeArtProperties;
    property ShapeArtTertiaryProperties
      : TDictionary<Integer, TdxOfficeArtTertiaryProperties>
      read FShapeArtTertiaryProperties;
    property ShapeRecords: TDictionary<Integer, TdxOfficeArtShapeRecord>
      read FShapeRecords;
  ...
  protected
    ...
    function GetHeaderVersion: Integer; override;
    procedure Read(AReader: TBinaryReader; AHeader: TdxOfficeArtRecordHeader);
    function CreateShapeContainer(AReader: TBinaryReader)
      : TdxOfficeDrawingPartBase;
  public
    constructor Create(ALocation: Byte); overload;
    class function FromStream(AReader: TBinaryReader;
      AHeader: TdxOfficeArtRecordHeader)
      : TdxOfficeArtShapeGroupContainer; static;
  end;
  ...
  public
    ...
    property CoordinateSystem: TdxOfficeArtShapeGroupCoordinateSystem
      read FCoordinateSystem;
    property ShapeRecord: TdxOfficeArtShapeRecord read FShapeRecord;
  end;

  { TdxOfficeArtDrawingObjectsContainerBase }

  TdxOfficeArtDrawingObjectsContainerBase = class abstract
    (TdxCompositeOfficeDrawingPartBase)
  strict private
  ...
  protected
    ...
    procedure Read(AReader: TBinaryReader);
    procedure ParseHeader(AReader: TBinaryReader);
    function TryRead(AReader: TBinaryReader; AHeader: TdxOfficeArtRecordHeader)
      : Boolean; virtual;
  public
    constructor Create(ALocation: Byte;
      ADrawingId, AShapeIdentifier: Integer); overload;
    constructor Create; overload;
    procedure CheckHeader(AHeader: TdxOfficeArtRecordHeader);
    ...
    property BackgroundShape: TdxOfficeArtShapeContainer
      read GetBackgroundShape;
  end;
  ...
  protected
    procedure Read(AReader: TBinaryReader);
    function ReadDrawingObjectsContainer(AReader: TBinaryReader)
      : TdxOfficeArtDrawingObjectsContainerBase;
  public
    constructor Create; overload;
    constructor Create(ALocation: Byte; ADrawingId: Integer;
      AShapeId: Integer); overload;
    destructor Destroy; override;
    class function FromStream(AReader: TBinaryReader)
      : TdxOfficeArtWordDrawing; static;
    function CreateDrawingObjectsContainer(ADrawingId: Integer;
      AShapeId: Integer): TdxOfficeArtDrawingObjectsContainerBase;
    procedure Write(AWriter: TBinaryWriter);

    property Location: Byte read FLocation;
    property DrawingObjectsContainer: TdxOfficeArtDrawingObjectsContainerBase
      read FDrawingContainer;
  end;
  ...
  protected
    ...
    procedure Read(AReader: TBinaryReader; AEmbeddedReader: TBinaryReader;
      AOffset: Integer; ASize: Integer;
      const AImageCreator: IdxDocOfficeImageCreator);
  public
    constructor Create;
    destructor Destroy; override;
    class function FromStream(AReader, AEmbeddedReader: TBinaryReader;
      AOffset, ASize: Integer; const AImageCreator: IdxDocOfficeImageCreator)
      : TdxOfficeArtContent; static;
    procedure SetPageBackColor(APageBackColor: TdxAlphaColor);
    procedure InsertPictureFloatingObject(AImage: TdxOfficeImageReference;
      AState: TdxDocContentState; AShapeIdentifier: Integer;
      ARun: TdxFloatingObjectAnchorRun;
      AUnitConverter: TdxDocumentModelUnitConverter);
    procedure InsertTextBoxFloatingObject(AState: TdxDocContentState;
      AShapeIdentifier, ATextIdentifier: Integer;
      ARun: TdxFloatingObjectAnchorRun;
      AUnitConverter: TdxDocumentModelUnitConverter);
    procedure InsertPictureFloatingObjectCore(AImage: TdxOfficeImageReference;
      AState: TdxDocContentState; AShapeIdentifier: Integer;
      ARun: TdxFloatingObjectAnchorRun;
      AUnitConverter: TdxDocumentModelUnitConverter);
    procedure InitializeArtProperties(AArtProperties: TdxOfficeArtProperties;
      ARun: TdxFloatingObjectAnchorRun;
      AUnitConverter: TdxDocumentModelUnitConverter);
    procedure InsertTextBoxFloatingObjectCore(AState: TdxDocContentState;
      AShapeIdentifier, ATextIdentifier: Integer;
      ARun: TdxFloatingObjectAnchorRun;
      AUnitConverter: TdxDocumentModelUnitConverter);
    procedure ApplyFloatingObjectDistancesProperties(AArtProperties
      : TdxOfficeArtProperties;
      AArtTertiaryProperties: TdxOfficeArtTertiaryProperties;
      AFloatingObjectProperties: TdxFloatingObjectProperties);
    procedure ApplyRelativeWidth(AArtTertiaryProperties
      : TdxOfficeArtTertiaryProperties;
      AFloatingObjectProperties: TdxFloatingObjectProperties);
    procedure ApplyRelativeHeight(AArtTertiaryProperties
      : TdxOfficeArtTertiaryProperties;
      AFloatingObjectProperties: TdxFloatingObjectProperties);
    procedure ApplyHorizontalPositionAlignment(AArtTertiaryProperties
      : TdxOfficeArtTertiaryProperties;
      AFloatingObjectProperties: TdxFloatingObjectProperties);
    procedure ApplyVerticalPositionAlignment(AArtTertiaryProperties
      : TdxOfficeArtTertiaryProperties;
      AFloatingObjectProperties: TdxFloatingObjectProperties);
    procedure ApplyPercentOffset(AArtTertiaryProperties
      : TdxOfficeArtTertiaryProperties;
      AFloatingObjectProperties: TdxFloatingObjectProperties);
    function GetPosRelH(AType: TdxFloatingObjectHorizontalPositionType)
      : TdxDrawingGroupShapePosRelH.TMsoprh;
    function GetPosRelV(AType: TdxFloatingObjectVerticalPositionType)
      : TdxDrawingGroupShapePosRelV.TMsoprv;
    function GetPosH(AAlignment: TdxFloatingObjectHorizontalPositionAlignment)
      : TdxDrawingGroupShapePosH.TMsoph;
    function GetPosV(AAlignment: TdxFloatingObjectVerticalPositionAlignment)
      : TdxDrawingGroupShapePosV.TMsopv;
    procedure ApplyTextBoxProperties(AArtProperties: TdxOfficeArtProperties;
      ATextBoxProperties: TdxTextBoxProperties);
    function CreateShapeContainer(AState: TdxDocContentState;
      AShapeIdentifier: Integer): TdxOfficeArtFloatingShapeContainer;
    function GetDrawingByState(AState: TdxDocContentState)
      : TdxOfficeArtWordDrawing;
    procedure Write(AWriter: TBinaryWriter; AEmbeddedWriter: TBinaryWriter);

    property DrawingContainer: TdxOfficeArtDrawingContainer
      read FDrawingContainer;
    property MainDocumentBlips: TdxBlipsWithProperties read FMainDocumentBlips;
    property MainDocumentDrawing: TdxOfficeArtWordDrawing
      read GetMainDocumentDrawing;
  ...
  TdxOfficeArtDrawingObjectsContainerSupprortsBackgroundShape = class
    (TdxOfficeArtDrawingObjectsContainerBase)
  public const
  ...
  public
    constructor Create; overload;
    constructor Create(ALocation: Byte; ADrawingId: Integer;
      AShapeIdentifier: Integer); overload;
    class function FromStream(AReader: TBinaryReader)
      : TdxOfficeArtDrawingObjectsContainerSupprortsBackgroundShape; static;
    function CreateBackgroundShape(AShapeIdentifier: Integer)
      : TdxOfficeArtShapeContainer;
  ...
  TdxOfficeArtDrawingObjectsContainer = class
    (TdxOfficeArtDrawingObjectsContainerBase)
  protected
    function GetBackgroundShape: TdxOfficeArtShapeContainer; override;
  public
    class function FromStream(AReader: TBinaryReader)
      : TdxOfficeArtDrawingObjectsContainer; static;
    procedure SetBackgroundShapeProperties; override;
  end;
...
class function TdxFixedPoint.FromBytes(const AData: TBytes; AOffset: Integer)
  : TdxFixedPoint;
var
  AFractional: Word;
  AIntegral: SmallInt;
...
class function TdxOfficeArtFileDrawingGroupRecord.FromStream
  (AReader: TBinaryReader; AHeader: TdxOfficeArtRecordHeader)
  : TdxOfficeArtFileDrawingGroupRecord;
begin
...
procedure TdxOfficeArtFileDrawingGroupRecord.Read(AReader: TBinaryReader;
  AHeader: TdxOfficeArtRecordHeader);
var
...
begin
  ...
  AReader.ReadInt32;
  AReader.ReadInt32;
  AReader.BaseStream.Seek(AIdClustersCount * IdClusterSize,
...
procedure TdxOfficeArtFileDrawingGroupRecord.WriteClustersInfo
...
begin
  if HasPicturesInHeader then
    Result := TdxOfficeArtConstants.DefaultHeaderShapeIdentifier +
      HeaderFloatingObjectsCount + 1
  else
    Result := TdxOfficeArtConstants.DefaultMainDocumentShapeIdentifier +
      MainDocumentFloatingObjectsCount + 1;
end;
...
begin
  ...
  FBlips.Free;
  FBlips := TdxBlipFactory.ReadAllBlips(AReader, AEmbeddedReader, AEnd,
    AImageCreator);
end;

procedure TdxOfficeArtBlipStoreContainer.Write(AWriter: TBinaryWriter;
  AEmbeddedWriter: TBinaryWriter);
begin
  if not ShouldWrite then
    Exit;
  WriteHeader(AWriter);
...
procedure TdxOfficeArtBlipStoreContainer.WriteCore(AWriter: TBinaryWriter;
  AEmbeddedWriter: TBinaryWriter);
var
  I: Integer;
...
constructor TdxOfficeColorRecord.Create(AColorUse: TdxOfficeColorUse;
  ATransform: TdxOfficeColorTransform; ATransformValue: Byte);
begin
  ...
  FData := Cardinal(MaskSystemColor or (Cardinal(ATransformValue) shl 16) or
    (Cardinal(ATransform) shl 8) or Cardinal(AColorUse));
end;
...
class function TdxOfficeColorRecord.FromStream(AReader: TBinaryReader)
  : TdxOfficeColorRecord;
begin
...
class function TdxOfficeColorRecord.FromBytes(const AData: TBytes;
  AOffset: Integer): TdxOfficeColorRecord;
begin
  Result := TdxOfficeColorRecord.Create;
...
begin
  Result := TdxAlphaColors.FromArgb(Integer((FData and $0000FF)),
    Integer((FData and $00FF00)) shr 8, Integer((FData and $00FF0000)) shr 16);
end;

procedure TdxOfficeColorRecord.SetColor(const AValue: TdxAlphaColor);
begin
  FData := Cardinal(Integer(TdxAlphaColors.R(AValue)) or
    (Integer(TdxAlphaColors.G(AValue)) shl 8) or
    (Integer(TdxAlphaColors.B(AValue) shl 16)));
end;
...
class function TdxOfficeArtFileDrawingRecord.FromStream(AReader: TBinaryReader;
  AHeader: TdxOfficeArtRecordHeader): TdxOfficeArtFileDrawingRecord;
begin
...
procedure TdxOfficeArtFileDrawingRecord.Read(AReader: TBinaryReader;
  AHeader: TdxOfficeArtRecordHeader);
begin
...
class function TdxOfficeArtSplitMenuColorContainer.FromStream
  (AReader: TBinaryReader; AHeader: TdxOfficeArtRecordHeader)
  : TdxOfficeArtSplitMenuColorContainer;
begin
...
procedure TdxOfficeArtSplitMenuColorContainer.Read(AReader: TBinaryReader;
  AHeader: TdxOfficeArtRecordHeader);
begin
  if AHeader.Length <> RecordLength then
    TdxOfficeArtExceptions.ThrowInvalidContent;
...
procedure TdxOfficeArtDrawingContainer.CheckHeader
  (AHeader: TdxOfficeArtRecordHeader);
begin
...
procedure TdxOfficeArtDrawingContainer.Write(AWriter: TBinaryWriter;
  AEmbeddedWriter: TBinaryWriter);
begin
  WriteHeader(AWriter);
...
procedure TdxOfficeArtDrawingContainer.ParseHeader(AReader: TBinaryReader;
  AEmbeddedReader: TBinaryReader;
  const AImageCreator: IdxDocOfficeImageCreator);
var
  AHeader: TdxOfficeArtRecordHeader;
  ...
  try
    case AHeader.TypeCode of
      TdxOfficeArtTypeCodes.FileDrawingGroupRecord:
        begin
          FFileDrawingBlock := TdxOfficeArtFileDrawingGroupRecord.FromStream
            (AReader, AHeader);
          ObjectsToDelete.Add(FFileDrawingBlock);
        end;
      TdxOfficeArtTypeCodes.BlipStoreContainer:
        begin
          FBlipContainer := TdxOfficeArtBlipStoreContainer.FromStream(AReader,
            AEmbeddedReader, AHeader, AImageCreator);
          ObjectsToDelete.Add(FBlipContainer);
        end;
      TdxOfficeArtTypeCodes.SplitMenuColorContainer:
        begin
          FSplitMenuColorContainer := TdxOfficeArtSplitMenuColorContainer.
            FromStream(AReader, AHeader);
...
class function TdxOfficeArtShapeRecord.FromStream(AReader: TBinaryReader)
  : TdxOfficeArtShapeRecord;
begin
...
procedure TdxOfficeArtPropertiesBase.Read(AReader: TBinaryReader;
  AHeader: TdxOfficeArtRecordHeader);
var
  AStart: Int64;
  ACount, I: Integer;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            TArray.Copy<Byte>(AMsoArrayData, AComplexData, 0, 6,
              System.Length(AMsoArrayData));
            AMsoArrayProperty.SetComplexData(AComplexData);
          end
          else
            AMsoArrayProperty.SetComplexData
              (AReader.ReadBytes(AMsoArrayProperty.Value));
        end;
      end;
    end;
...
class function TdxOfficeArtProperties.FromStream(AReader: TBinaryReader;
  AHeader: TdxOfficeArtRecordHeader): TdxOfficeArtProperties;
begin
...
begin
  ...
  if TextBoxProperties.UseLeftMargin then
    Properties.Add(TdxDrawingTextLeft.Create(UnitConverter.ModelUnitsToEmu
      (TextBoxProperties.LeftMargin)));
  if TextBoxProperties.UseTopMargin then
    Properties.Add(TdxDrawingTextTop.Create(UnitConverter.ModelUnitsToEmu
      (TextBoxProperties.TopMargin)));
  if TextBoxProperties.UseRightMargin then
    Properties.Add(TdxDrawingTextRight.Create(UnitConverter.ModelUnitsToEmu
      (TextBoxProperties.RightMargin)));
  if TextBoxProperties.UseBottomMargin then
    Properties.Add(TdxDrawingTextBottom.Create(UnitConverter.ModelUnitsToEmu
      (TextBoxProperties.BottomMargin)));
end;
...
begin
  if (Shape <> nil) and Shape.UseRotation then
    Properties.Add(TdxDrawingRotation.Create(UnitConverter.ModelUnitsToDegree
      (Integer(Shape.Rotation))));
end;
...
begin
  if (Shape <> nil) and Shape.UseFillColor and
    not TdxAlphaColors.IsTransparentOrEmpty(Shape.FillColor) then
...
begin
  ...
  if Shape.UseOutlineWidth then
    Properties.Add(TdxDrawingLineWidth.Create(UnitConverter.ModelUnitsToEmu
      (Integer(Shape.OutlineWidth))));
end;
...
begin
  ...
  if (TextBoxProperties <> nil) and TextBoxProperties.UseResizeShapeToFitText
  then
  begin
...
constructor TdxOfficeArtShapeContainer.Create;
// (AShapeTypeCode: Integer = TdxOfficeArtHeaderInfos.PictureFrameShap);
begin
  inherited Create;
...
class function TdxOfficeArtShapeContainer.FromStream(AReader: TBinaryReader;
  AHeader: TdxOfficeArtRecordHeader): TdxOfficeArtShapeContainer;
begin
...
procedure TdxOfficeArtShapeContainer.Read(AReader: TBinaryReader;
  AHeader: TdxOfficeArtRecordHeader);
var
  AEndPosition: Int64;
begin
  ...
  try
    case AHeader.TypeCode of
      ...
      TdxOfficeArtTypeCodes.TertiaryPropertiesTable:
        begin
          FArtTertiaryProperties := TdxOfficeArtTertiaryProperties.FromStream
            (AReader, AHeader);
...
class function TdxOfficeArtInlineShapeContainer.FromStream
  (AReader: TBinaryReader; ASize: Integer;
  const AImageCreator: IdxDocOfficeImageCreator)
  : TdxOfficeArtInlineShapeContainer;
begin
...
procedure TdxOfficeArtInlineShapeContainer.Read(AReader: TBinaryReader;
...
procedure TdxOfficeDrawingPropertyBase.Merge(const AOther
  : IdxOfficeDrawingProperty);
begin
end;
...
procedure TdxOfficeDrawingIntPropertyBase.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
begin
end;
...
procedure TdxOfficeDrawingIntPropertyBase.SetFlag(AMask: Integer;
  AFlag: Boolean);
begin
  if AFlag then
...
procedure TdxDrawingGroupShapePosRelH.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
var
  AArtProperties: IdxOfficeArtTertiaryProperties;
begin
...
procedure TdxDrawingGroupShapePosRelV.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
var
  AArtProperties: IdxOfficeArtTertiaryProperties;
begin
...
procedure TdxDrawingGroupShape2SizeRelH.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
var
  AArtProperties: IdxOfficeArtTertiaryProperties;
begin
...
procedure TdxDrawingGroupShape2SizeRelV.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
var
  AArtProperties: IdxOfficeArtTertiaryProperties;
begin
...
constructor TdxOfficeArtTertiaryProperties.Create(AWriteAlways
  : Boolean = False);
begin
  inherited Create;
...
function TdxOfficeArtTertiaryProperties.GetPosH
  : TdxDrawingGroupShapePosH.TMsoph;
begin
  Result := FPosH;
end;

function TdxOfficeArtTertiaryProperties.GetPosRelH
  : TdxDrawingGroupShapePosRelH.TMsoprh;
begin
  Result := FPosRelH;
end;

function TdxOfficeArtTertiaryProperties.GetPosRelV
  : TdxDrawingGroupShapePosRelV.TMsoprv;
begin
  Result := FPosRelV;
end;

function TdxOfficeArtTertiaryProperties.GetPosV
  : TdxDrawingGroupShapePosV.TMsopv;
begin
  Result := FPosV;
end;

function TdxOfficeArtTertiaryProperties.GetSizeRelH
  : TdxDrawingGroupShape2SizeRelH.TRelativeFrom;
begin
  Result := FSizeRelH;
end;

function TdxOfficeArtTertiaryProperties.GetSizeRelV
  : TdxDrawingGroupShape2SizeRelV.TRelativeFrom;
begin
  Result := FSizeRelV;
end;
...
procedure TdxOfficeArtTertiaryProperties.SetPosH(const AValue
  : TdxDrawingGroupShapePosH.TMsoph);
begin
  FPosH := AValue;
end;

procedure TdxOfficeArtTertiaryProperties.SetPosRelH(const AValue
  : TdxDrawingGroupShapePosRelH.TMsoprh);
begin
  FPosRelH := AValue;
end;

procedure TdxOfficeArtTertiaryProperties.SetPosRelV(const AValue
  : TdxDrawingGroupShapePosRelV.TMsoprv);
begin
  FPosRelV := AValue;
end;

procedure TdxOfficeArtTertiaryProperties.SetPosV(const AValue
  : TdxDrawingGroupShapePosV.TMsopv);
begin
  FPosV := AValue;
end;

procedure TdxOfficeArtTertiaryProperties.SetSizeRelH(const AValue
  : TdxDrawingGroupShape2SizeRelH.TRelativeFrom);
begin
  FSizeRelH := AValue;
end;

procedure TdxOfficeArtTertiaryProperties.SetSizeRelV(const AValue
  : TdxDrawingGroupShape2SizeRelV.TRelativeFrom);
begin
  FSizeRelV := AValue;
end;
...
procedure TdxOfficeArtTertiaryProperties.SetUseRelativeHeight
...
procedure TdxOfficeDrawingMsoArrayPropertyBase.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
begin
end;
...
begin
  FPropertyIdentifiers := TDictionary<TdxOfficeDrawingPropertyClass,
    SmallInt>.Create;
...
class procedure TdxOfficePropertiesFactory.AddProperty(AId: Integer;
...
class function TdxOfficePropertiesFactory.CreateProperty(AReader: TBinaryReader)
  : IdxOfficeDrawingProperty;
var
  ABitwiseField: Word;
  AOpcode: SmallInt;
...
class function TdxOfficePropertiesFactory.GetOpcodeByType(APropertyType: TClass)
  : SmallInt;
begin
  if not FPropertyIdentifiers.TryGetValue
    (TdxOfficeDrawingPropertyClass(APropertyType), Result) then
    Result := $0000;
end;
...
procedure TdxOfficeDrawingFixedPointPropertyBase.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
begin
end;
...
constructor TdxDrawingLineWidth.Create
  (AWidth: Integer = TdxOfficeArtConstants.DefaultLineWidthInEmus);
begin
  Value := AWidth;
end;
...
procedure TdxOfficeDrawingBooleanPropertyBase.Merge(const AOther
  : IdxOfficeDrawingProperty);
var
...
procedure TdxDrawingBooleanProtectionProperties.SetLockGroup
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetLockAdjustHandles
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetLockText
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetLockVertices
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetLockCropping
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetLockSelect
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetLockPosition
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetLockAspectRatio
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetLockRotation
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetLockUngroup
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetUseLockGroup
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetUseLockAdjustHandles
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetUseLockText
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetUseLockVertices
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetUseLockCropping
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetUseLockSelect
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetUseLockPosition
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetUseLockAspectRatio
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetUseLockRotation
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBooleanProtectionProperties.SetUseLockUngroup
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBlipBooleanProperties.SetUsePicturePreserveGrays
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBlipBooleanProperties.SetUseNoHitTestPicture
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBlipBooleanProperties.SetUsePictureGray
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBlipBooleanProperties.SetUsePictureBiLevel
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBlipBooleanProperties.SetUsePictureActive
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBlipBooleanProperties.SetPicturePreserveGrays
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBlipBooleanProperties.SetNoHitTestPicture
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBlipBooleanProperties.SetPictureBiLevel
  (const AValue: Boolean);
begin
...
procedure TdxDrawingBlipBooleanProperties.SetPictureActive
  (const AValue: Boolean);
begin
...
begin
  Result := (FFillStyle and TFillStyle.NoFillHitTest)
    = TFillStyle.NoFillHitTest;
end;

procedure TdxDrawingFillStyleBooleanProperties.SetNoFillHitTest
  (const AValue: Boolean);
begin
  if AValue then
...
begin
  Result := (FFillStyle and TFillStyle.UseNoFillHitTest)
    = TFillStyle.UseNoFillHitTest;
end;

procedure TdxDrawingFillStyleBooleanProperties.SetUseNoFillHitTest
  (const AValue: Boolean);
begin
  if AValue then
...
procedure TdxDrawingFillStyleBooleanProperties.SetFillUseRect
  (const AValue: Boolean);
begin
  if AValue then
...
begin
  Result := (FFillStyle and TFillStyle.UseFillUseRect)
    = TFillStyle.UseFillUseRect;
end;

procedure TdxDrawingFillStyleBooleanProperties.SetUseFillUseRect
  (const AValue: Boolean);
begin
  if AValue then
...
procedure TdxDrawingFillStyleBooleanProperties.SetFillShape
  (const AValue: Boolean);
begin
  if AValue then
...
procedure TdxDrawingFillStyleBooleanProperties.SetUseFillShape
  (const AValue: Boolean);
begin
  if AValue then
...
procedure TdxDrawingFillStyleBooleanProperties.SetHitTestFill
  (const AValue: Boolean);
begin
  if AValue then
...
begin
  Result := (FFillStyle and TFillStyle.UseHitTestFill)
    = TFillStyle.UseHitTestFill;
end;

procedure TdxDrawingFillStyleBooleanProperties.SetUseHitTestFill
  (const AValue: Boolean);
begin
  if AValue then
...
procedure TdxDrawingFillStyleBooleanProperties.SetUseFilled
  (const AValue: Boolean);
begin
  if AValue then
...
procedure TdxDrawingFillStyleBooleanProperties.SetShapeAnchor
  (const AValue: Boolean);
begin
  if AValue then
...
begin
  Result := (FFillStyle and TFillStyle.UseShapeAnchor)
    = TFillStyle.UseShapeAnchor;
end;

procedure TdxDrawingFillStyleBooleanProperties.SetUseShapeAnchor
  (const AValue: Boolean);
begin
  if AValue then
...
begin
  Result := (FFillStyle and TFillStyle.RecolorFillAsPicture)
    = TFillStyle.RecolorFillAsPicture;
end;

procedure TdxDrawingFillStyleBooleanProperties.SetRecolorFillAsPicture
  (const AValue: Boolean);
begin
  if AValue then
...
function TdxDrawingFillStyleBooleanProperties.
  GetUseRecolorFillAsPicture: Boolean;
begin
  Result := (FFillStyle and TFillStyle.UseRecolorFillAsPicture)
    = TFillStyle.UseRecolorFillAsPicture;
end;

procedure TdxDrawingFillStyleBooleanProperties.SetUseRecolorFillAsPicture
  (const AValue: Boolean);
begin
  if AValue then
...
procedure TdxDrawingFillStyleBooleanProperties.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
var
...
begin
  Result := (FLineStyle and TDrawingLineStyle.UseLine)
    = TDrawingLineStyle.UseLine;
end;

procedure TdxDrawingLineStyleBooleanProperties.SetUseLine
  (const AValue: Boolean);
begin
  if AValue then
...
procedure TdxDrawingLineStyleBooleanProperties.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
var
  AArtProperties: IdxOfficeArtProperties;
begin
...
procedure TdxDrawingGroupShapeBooleanProperties.SetHidden
  (const AValue: Boolean);
begin
...
procedure TdxDrawingGroupShapeBooleanProperties.SetIsBehindDoc
  (const AValue: Boolean);
begin
...
procedure TdxDrawingGroupShapeBooleanProperties.SetLayoutInCell
  (const AValue: Boolean);
begin
...
procedure TdxDrawingGroupShapeBooleanProperties.SetUsePrint
  (const AValue: Boolean);
begin
...
procedure TdxDrawingGroupShapeBooleanProperties.SetUseHidden
  (const AValue: Boolean);
begin
...
procedure TdxDrawingGroupShapeBooleanProperties.SetUseBehindDocument
  (const AValue: Boolean);
begin
...
procedure TdxDrawingGroupShapeBooleanProperties.SetUseLayoutInCell
  (const AValue: Boolean);
begin
  SetFlag(CUseLayoutInCell, AValue);
end;

procedure TdxDrawingGroupShapeBooleanProperties.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
var
  AArtProperties: IdxOfficeArtPropertiesBase;
begin
...
procedure TdxDrawingShadowStyleBooleanProperties.SetShadowObscured
  (const AValue: Boolean);
begin
...
procedure TdxDrawingShadowStyleBooleanProperties.SetShadow
  (const AValue: Boolean);
begin
...
procedure TdxDrawingShadowStyleBooleanProperties.SetUseShadowObscured
  (const AValue: Boolean);
begin
...
procedure TdxDrawingShadowStyleBooleanProperties.SetUseShadow
  (const AValue: Boolean);
begin
...
procedure TdxDrawingShapeBooleanProperties.SetIsBackground
  (const AValue: Boolean);
begin
...
procedure TdxDrawingShapeBooleanProperties.SetLockShapeType
  (const AValue: Boolean);
begin
...
procedure TdxDrawingShapeBooleanProperties.SetPreferRelativeResize
  (const AValue: Boolean);
begin
...
procedure TdxDrawingShapeBooleanProperties.SetFlipVOverride
  (const AValue: Boolean);
begin
...
procedure TdxDrawingShapeBooleanProperties.SetFlipHOverride
  (const AValue: Boolean);
begin
...
procedure TdxDrawingShapeBooleanProperties.SetUseBackground
  (const AValue: Boolean);
begin
...
procedure TdxDrawingShapeBooleanProperties.SetUseLockShapeType
  (const AValue: Boolean);
begin
...
procedure TdxDrawingShapeBooleanProperties.SetUsePreferRelativeResize
  (const AValue: Boolean);
begin
...
procedure TdxDrawingShapeBooleanProperties.SetUseFlipVOverride
  (const AValue: Boolean);
begin
...
procedure TdxDrawingShapeBooleanProperties.SetUseFlipHOverride
  (const AValue: Boolean);
begin
...
procedure TdxOfficeDrawingStringPropertyValueBase.SetStringData
  (const AValue: string);
begin
...
procedure TdxDrawingTextBooleanProperties.SetFitShapeToText
  (const AValue: Boolean);
begin
...
procedure TdxDrawingTextBooleanProperties.SetAutoTextMargins
  (const AValue: Boolean);
begin
...
procedure TdxDrawingTextBooleanProperties.SetUseFitShapeToText
  (const AValue: Boolean);
begin
...
procedure TdxDrawingTextBooleanProperties.SetUseAutoTextMargins
  (const AValue: Boolean);
begin
...
procedure TdxDrawingTextBooleanProperties.SetUseSelectText
  (const AValue: Boolean);
begin
  SetFlag(CUseSelectText, AValue);
end;

procedure TdxDrawingTextBooleanProperties.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
var
  AArtProperties: IdxOfficeArtProperties;
begin
...
procedure TdxDrawingGroupShape2PctHorizPos.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
var
  AArtProperties: IdxOfficeArtTertiaryProperties;
begin
...
procedure TdxDrawingGroupShape2PctVertPos.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
var
  AArtProperties: IdxOfficeArtTertiaryProperties;
begin
...
procedure TdxDrawingGroupShape2PctHoriz.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
var
  AArtProperties: IdxOfficeArtTertiaryProperties;
begin
...
procedure TdxDrawingGroupShape2PctVert.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
var
  AArtProperties: IdxOfficeArtTertiaryProperties;
begin
...
procedure TdxDrawingWrapLeftDistance.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
var
  AArtProperties: IdxOfficeArtProperties;
begin
...
procedure TdxDrawingWrapRightDistance.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
var
  AArtProperties: IdxOfficeArtProperties;
begin
...
procedure TdxDrawingWrapBottomDistance.Execute
  (AOwner: TdxOfficeArtPropertiesBase);
var
  AArtProperties: IdxOfficeArtProperties;
begin
...
begin
  FBlips := TObjectDictionary<Integer, TdxBlipBase>.Create
    ([ { doOwnsValues } ]);
  FShapeArtProperties := TObjectDictionary<Integer, TdxOfficeArtProperties>.
    Create([ { doOwnsValues } ]);
  FShapeArtTertiaryProperties :=
    TObjectDictionary<Integer, TdxOfficeArtTertiaryProperties>.Create
    ([ { doOwnsValues } ]);
  FShapeRecords := TObjectDictionary<Integer, TdxOfficeArtShapeRecord>.Create
    ([ { doOwnsValues } ]);
end;
...
class function TdxOfficeArtShapeGroupContainer.FromStream
  (AReader: TBinaryReader; AHeader: TdxOfficeArtRecordHeader)
  : TdxOfficeArtShapeGroupContainer;
begin
...
procedure TdxOfficeArtShapeGroupContainer.Read(AReader: TBinaryReader;
  AHeader: TdxOfficeArtRecordHeader);
var
  AEndPosition: Int64;
begin
...
function TdxOfficeArtShapeGroupContainer.CreateShapeContainer
  (AReader: TBinaryReader): TdxOfficeDrawingPartBase;
var
...
procedure TdxOfficeArtShapeGroupCoordinateSystem.WriteCore
  (AWriter: TBinaryWriter);
begin
  AWriter.Write(Left);
  AWriter.Write(Top);
...
procedure TdxOfficeArtTopmostShapeContainer.InitializeShapeRecord
  (ALocation: Byte);
begin
  FShapeRecord := TdxOfficeArtShapeRecord.Create
    (TdxOfficeArtHeaderInfos.NotPrimitiveShape);
...
constructor TdxOfficeArtDrawingObjectsContainerBase.Create(ALocation: Byte;
  ADrawingId, AShapeIdentifier: Integer);
begin
  inherited Create;
...
procedure TdxOfficeArtDrawingObjectsContainerBase.CheckHeader
  (AHeader: TdxOfficeArtRecordHeader);
begin
  if (AHeader.Version <> TdxOfficeArtVersions.DefaultHeaderVersion) or
    (AHeader.InstanceInfo <> TdxOfficeArtHeaderInfos.EmptyHeaderInfo) or
    (AHeader.TypeCode <> TdxOfficeArtTypeCodes.DrawingObjectsContainer) then
    TdxOfficeArtExceptions.ThrowInvalidContent;
end;
...
procedure TdxOfficeArtDrawingObjectsContainerBase.ParseHeader
...
function TdxOfficeArtDrawingObjectsContainerBase.TryRead(AReader: TBinaryReader;
  AHeader: TdxOfficeArtRecordHeader): Boolean;
begin
...
constructor TdxOfficeArtWordDrawing.Create(ALocation: Byte; ADrawingId: Integer;
  AShapeId: Integer);
begin
  FLocation := ALocation;
...
class function TdxOfficeArtWordDrawing.FromStream(AReader: TBinaryReader)
  : TdxOfficeArtWordDrawing;
begin
...
function TdxOfficeArtWordDrawing.CreateDrawingObjectsContainer
  (ADrawingId: Integer; AShapeId: Integer)
  : TdxOfficeArtDrawingObjectsContainerBase;
begin
  if FLocation = TdxOfficeArtConstants.MainDocumentDrawingLocation then
    Result := TdxOfficeArtDrawingObjectsContainerSupprortsBackgroundShape.Create
      (FLocation, ADrawingId, AShapeId)
  else
    Result := TdxOfficeArtDrawingObjectsContainer.Create(FLocation, ADrawingId,
      AShapeId);
end;
...
function TdxOfficeArtWordDrawing.ReadDrawingObjectsContainer
  (AReader: TBinaryReader): TdxOfficeArtDrawingObjectsContainerBase;
begin
  if FLocation = TdxOfficeArtConstants.MainDocumentDrawingLocation then
    Result := TdxOfficeArtDrawingObjectsContainerSupprortsBackgroundShape.
      FromStream(AReader)
  else
...
constructor TdxOfficeArtContent.TOfficeArtContentHelper.Create
  (AContent: TdxOfficeArtContent);
begin
  FContent := AContent;
end;
...
begin
  ...
  begin
    ...
    if (ADrawing.Location = TdxOfficeArtConstants.MainDocumentDrawingLocation)
    then
...
procedure TdxOfficeArtContent.TOfficeArtContentHelper.Process
  ...
  begin
    ...
    begin
      ...
      if (AShapeBlipIndex > 0) and (AShapeBlipIndex <= ABlips.Count) then
        FActiveShapes.Blips.Add(AShape.ShapeRecord.ShapeIdentifier,
          ABlips[AShapeBlipIndex - 1]);
      FActiveShapes.ShapeArtProperties.Add(AShape.ShapeRecord.ShapeIdentifier,
        AShape.ArtProperties);
      FActiveShapes.ShapeArtTertiaryProperties.Add
        (AShape.ShapeRecord.ShapeIdentifier, AShape.ArtTertiaryProperties);
      FActiveShapes.ShapeRecords.Add(AShape.ShapeRecord.ShapeIdentifier,
        AShape.ShapeRecord);
...
class function TdxOfficeArtContent.FromStream(AReader, AEmbeddedReader
  : TBinaryReader; AOffset, ASize: Integer;
  const AImageCreator: IdxDocOfficeImageCreator): TdxOfficeArtContent;
begin
...
begin
  FMainDocumentDrawing := TdxOfficeArtWordDrawing.Create
    (MainDocumentDrawingLocation, Drawings.Count + 1,
    TdxOfficeArtConstants.DefaultMainDocumentShapeIdentifier);
  Drawings.Add(FMainDocumentDrawing);
end;

procedure TdxOfficeArtContent.InitHeaderDrawing;
begin
  FHeaderDrawing := TdxOfficeArtWordDrawing.Create
    (HeaderDocumentDrawingLocation, Drawings.Count + 1,
    TdxOfficeArtConstants.DefaultHeaderShapeIdentifier);
  Drawings.Add(FHeaderDrawing);
end;

procedure TdxOfficeArtContent.SetPageBackColor(APageBackColor: TdxAlphaColor);
begin
  MainDocumentDrawing.DrawingObjectsContainer.BackgroundShape.ArtProperties.
    FillColor := APageBackColor;
end;

procedure TdxOfficeArtContent.InsertPictureFloatingObject
  (AImage: TdxOfficeImageReference; AState: TdxDocContentState;
  AShapeIdentifier: Integer; ARun: TdxFloatingObjectAnchorRun;
  AUnitConverter: TdxDocumentModelUnitConverter);
begin
  if (AState <> TdxDocContentState.MainDocument) and
    (AState <> TdxDocContentState.HeadersFootersStory) then
    Exit;
  InsertPictureFloatingObjectCore(AImage, AState, AShapeIdentifier, ARun,
    AUnitConverter);
end;

procedure TdxOfficeArtContent.InsertTextBoxFloatingObject
  (AState: TdxDocContentState; AShapeIdentifier, ATextIdentifier: Integer;
  ARun: TdxFloatingObjectAnchorRun;
  AUnitConverter: TdxDocumentModelUnitConverter);
begin
  if (AState <> TdxDocContentState.MainDocument) and
    (AState <> TdxDocContentState.HeadersFootersStory) then
    Exit;
  InsertTextBoxFloatingObjectCore(AState, AShapeIdentifier, ATextIdentifier,
    ARun, AUnitConverter);
end;

procedure TdxOfficeArtContent.InsertPictureFloatingObjectCore
  (AImage: TdxOfficeImageReference; AState: TdxDocContentState;
  AShapeIdentifier: Integer; ARun: TdxFloatingObjectAnchorRun;
  AUnitConverter: TdxDocumentModelUnitConverter);
var
...
begin
  ...
  DrawingContainer.BlipContainer.Blips.Add
    (TdxFileBlipStoreEntry.Create(AImage, True));

  AShapeContainer.ArtProperties.BlipIndex :=
    DrawingContainer.BlipContainer.Blips.Count;
  InitializeArtProperties(AShapeContainer.ArtProperties, ARun, AUnitConverter);
  ApplyFloatingObjectDistancesProperties(AShapeContainer.ArtProperties,
    AShapeContainer.ArtTertiaryProperties, ARun.FloatingObjectProperties);
  AShapeContainer.ArtProperties.CreateProperties;
  AShapeContainer.ArtTertiaryProperties.CreateProperties;
end;

procedure TdxOfficeArtContent.InitializeArtProperties(AArtProperties
  : TdxOfficeArtProperties; ARun: TdxFloatingObjectAnchorRun;
  AUnitConverter: TdxDocumentModelUnitConverter);
begin
...
procedure TdxOfficeArtContent.InsertTextBoxFloatingObjectCore
  (AState: TdxDocContentState; AShapeIdentifier, ATextIdentifier: Integer;
  ARun: TdxFloatingObjectAnchorRun;
  AUnitConverter: TdxDocumentModelUnitConverter);
var
...
begin
  ...
  ApplyTextBoxProperties(AShapeContainer.ArtProperties,
    ATextBoxContent.TextBoxProperties);
  ApplyFloatingObjectDistancesProperties(AShapeContainer.ArtProperties,
    AShapeContainer.ArtTertiaryProperties, ARun.FloatingObjectProperties);
  AShapeContainer.ArtProperties.CreateProperties;
  AShapeContainer.ArtTertiaryProperties.CreateProperties;
...
procedure TdxOfficeArtContent.ApplyFloatingObjectDistancesProperties
  (AArtProperties: TdxOfficeArtProperties;
  AArtTertiaryProperties: TdxOfficeArtTertiaryProperties;
  AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
...
begin
  ...
  AArtTertiaryProperties.SizeRelH := TdxDrawingGroupShape2SizeRelH.TRelativeFrom
    (ARelativeWidth.From);
  AArtTertiaryProperties.PctHoriz := ARelativeWidth.Width div 100;
end;

procedure TdxOfficeArtContent.ApplyRelativeHeight(AArtTertiaryProperties
  : TdxOfficeArtTertiaryProperties;
  AFloatingObjectProperties: TdxFloatingObjectProperties);
var
...
begin
  ...
  AArtTertiaryProperties.SizeRelV := TdxDrawingGroupShape2SizeRelV.TRelativeFrom
    (ARelativeHeight.From);
  AArtTertiaryProperties.PctVert := ARelativeHeight.Height div 100;
end;

procedure TdxOfficeArtContent.ApplyHorizontalPositionAlignment
  (AArtTertiaryProperties: TdxOfficeArtTertiaryProperties;
  AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  AArtTertiaryProperties.PosRelH :=
    GetPosRelH(AFloatingObjectProperties.HorizontalPositionType);
  AArtTertiaryProperties.PosH :=
    GetPosH(AFloatingObjectProperties.HorizontalPositionAlignment);
  AArtTertiaryProperties.UsePosH := True;
end;

procedure TdxOfficeArtContent.ApplyVerticalPositionAlignment
  (AArtTertiaryProperties: TdxOfficeArtTertiaryProperties;
  AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  AArtTertiaryProperties.PosRelV :=
    GetPosRelV(AFloatingObjectProperties.VerticalPositionType);
  AArtTertiaryProperties.PosV :=
    GetPosV(AFloatingObjectProperties.VerticalPositionAlignment);
  AArtTertiaryProperties.UsePosV := True;
end;

procedure TdxOfficeArtContent.ApplyPercentOffset(AArtTertiaryProperties
  : TdxOfficeArtTertiaryProperties;
  AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  ...
  begin
    AArtTertiaryProperties.PctHorizPos :=
  ...
  begin
    AArtTertiaryProperties.PctVertPos :=
...
function TdxOfficeArtContent.GetPosRelH
...
function TdxOfficeArtContent.GetPosRelV
...
function TdxOfficeArtContent.GetPosH(AAlignment
...
function TdxOfficeArtContent.GetPosV(AAlignment
...
procedure TdxOfficeArtContent.ApplyTextBoxProperties(AArtProperties
  : TdxOfficeArtProperties; ATextBoxProperties: TdxTextBoxProperties);
begin
  AArtProperties.TextBoxProperties := ATextBoxProperties;
end;

function TdxOfficeArtContent.CreateShapeContainer(AState: TdxDocContentState;
  AShapeIdentifier: Integer): TdxOfficeArtFloatingShapeContainer;
var
  ADrawing: TdxOfficeArtWordDrawing;
  AShapes: TdxList<TdxOfficeDrawingPartBase>;
...
function TdxOfficeArtContent.GetDrawingByState(AState: TdxDocContentState)
  : TdxOfficeArtWordDrawing;
begin
...
procedure TdxOfficeArtContent.Read(AReader: TBinaryReader;
  AEmbeddedReader: TBinaryReader; AOffset: Integer; ASize: Integer;
  const AImageCreator: IdxDocOfficeImageCreator);
var
  AEndPosition: Int64;
begin
  ...
  AEndPosition := AReader.BaseStream.Position + ASize;
  FDrawingContainer.Free;
  FDrawingContainer := TdxOfficeArtDrawingContainer.FromStream(AReader,
    AEmbeddedReader, AImageCreator);
  while AReader.BaseStream.Position < AEndPosition do
    Drawings.Add(TdxOfficeArtWordDrawing.FromStream(AReader));
  FContentHelper.Traverse;
end;

procedure TdxOfficeArtContent.Write(AWriter: TBinaryWriter;
  AEmbeddedWriter: TBinaryWriter);
var
  ACount, I: Integer;
begin
...
constructor TdxOfficeArtDrawingObjectsContainerSupprortsBackgroundShape.Create
  (ALocation: Byte; ADrawingId: Integer; AShapeIdentifier: Integer);
begin
...
class function TdxOfficeArtDrawingObjectsContainerSupprortsBackgroundShape.
  FromStream(AReader: TBinaryReader)
  : TdxOfficeArtDrawingObjectsContainerSupprortsBackgroundShape;
begin
  Result := TdxOfficeArtDrawingObjectsContainerSupprortsBackgroundShape.Create;
  Result.Read(AReader);
...
function TdxOfficeArtDrawingObjectsContainerSupprortsBackgroundShape.
  GetBackgroundShape: TdxOfficeArtShapeContainer;
begin
  Result := FBackgroundShape;
end;

function TdxOfficeArtDrawingObjectsContainerSupprortsBackgroundShape.
  CreateBackgroundShape(AShapeIdentifier: Integer): TdxOfficeArtShapeContainer;
begin
  Result := TdxOfficeArtShapeContainer.Create
    (TdxOfficeArtHeaderInfos.RectangleShape);
  Result.ShapeRecord.Flags := Result.ShapeRecord.Flags or BackgroundFlag;
  Result.ShapeRecord.ShapeIdentifier := AShapeIdentifier;
  Result.Items.Add(TdxOfficeClientData.Create);
end;

procedure TdxOfficeArtDrawingObjectsContainerSupprortsBackgroundShape.
  SetBackgroundShapeProperties;
var
...
function TdxOfficeArtDrawingObjectsContainerSupprortsBackgroundShape.TryRead
  (AReader: TBinaryReader; AHeader: TdxOfficeArtRecordHeader): Boolean;
begin
...
procedure TdxOfficeArtDrawingObjectsContainerSupprortsBackgroundShape.WriteCore
  (AWriter: TBinaryWriter);
begin
...
class function TdxOfficeArtDrawingObjectsContainer.FromStream
  (AReader: TBinaryReader): TdxOfficeArtDrawingObjectsContainer;
begin
  Result := TdxOfficeArtDrawingObjectsContainer.Create;
  Result.Read(AReader);
end;

function TdxOfficeArtDrawingObjectsContainer.GetBackgroundShape
  : TdxOfficeArtShapeContainer;
begin
  Result := nil;
end;
