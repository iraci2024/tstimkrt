...
type
  ...
  TdxNullableParagraphFirstLineIndent =
    TdxNullableValue<TdxParagraphFirstLineIndent>;
  ...
  public
    ...
    property ParagraphProperties: TdxMergedParagraphProperties
  ...
  public
    ...
    property UnitConverter: TdxDocumentModelUnitConverter read FUnitConverter;
    property Alignment: TdxNullableParagraphAlignment read FAlignment
      write FAlignment;
    property FirstLineIndent: TdxNullableInteger read FFirstLineIndent
      write FFirstLineIndent;
    property FirstLineIndentType: TdxNullableParagraphFirstLineIndent
      read FFirstLineIndentType write FFirstLineIndentType;
    property LeftIndent: TdxNullableInteger read FLeftIndent write FLeftIndent;
    property RightIndent: TdxNullableInteger read FRightIndent
      write FRightIndent;
    property SpacingAfter: TdxNullableInteger read FSpacingAfter
      write FSpacingAfter;
    property SpacingBefore: TdxNullableInteger read FSpacingBefore
      write FSpacingBefore;
    property LineSpacing: TdxNullableSingle read FLineSpacing
      write FLineSpacing;
    property LineSpacingType: TdxNullableParagraphLineSpacing
      read FLineSpacingType write FLineSpacingType;
    property SuppressHyphenation: TdxNullableBoolean read FSuppressHyphenation
      write FSuppressHyphenation;
    property SuppressLineNumbers: TdxNullableBoolean read FSuppressLineNumbers
      write FSuppressLineNumbers;
    property OutlineLevel: TdxNullableInteger read FOutlineLevel
      write FOutlineLevel;
    property KeepLinesTogether: TdxNullableBoolean read FKeepLinesTogether
      write FKeepLinesTogether;
    property PageBreakBefore: TdxNullableBoolean read FPageBreakBefore
      write FPageBreakBefore;
    property ContextualSpacing: TdxNullableBoolean read FContextualSpacing
      write FContextualSpacing;
    property CanEditTabs: Boolean read FCanEditTabs;

    property SourceProperties: TdxMergedParagraphProperties
      read FSourceProperties;
  end;
...
constructor TdxParagraphFormControllerParameters.Create(const AControl
  : IdxRichEditControl; AParagraphProperties: TdxMergedParagraphProperties;
  AUnitConverter: TdxDocumentModelUnitConverter);
begin
...
function TdxParagraphFormController.GetSourceOptions
...
begin
  SourceOptions.UseAlignment := not Alignment.IsNull and
    ((SourceInfo.Alignment <> Alignment.Value) or
    not SourceOptions.UseAlignment);
...
begin
  SourceOptions.UseContextualSpacing := not ContextualSpacing.IsNull and
    ((SourceInfo.ContextualSpacing <> ContextualSpacing.Value) or
    not SourceOptions.UseContextualSpacing);
...
begin
  SourceOptions.UseFirstLineIndent := not FirstLineIndentType.IsNull and
    (not FirstLineIndent.IsNull or
    (FirstLineIndentType.Value = TdxParagraphFirstLineIndent.None)) and
    ((FirstLineIndent.IsNull or (SourceInfo.FirstLineIndent <>
    FirstLineIndent.Value)) or (SourceInfo.FirstLineIndentType <>
    FirstLineIndentType.Value) or not SourceOptions.UseLeftIndent);
...
begin
  SourceOptions.UseKeepLinesTogether := not KeepLinesTogether.IsNull and
    ((SourceInfo.KeepLinesTogether <> KeepLinesTogether.Value) or
    not SourceOptions.UseKeepLinesTogether);
...
begin
  SourceOptions.UseLeftIndent := not LeftIndent.IsNull and
    ((SourceInfo.LeftIndent <> LeftIndent.Value) or
...
begin
  SourceOptions.UseLineSpacing := not LineSpacingType.IsNull and
    (LineSpacing.IsNull or (SourceInfo.LineSpacing <> LineSpacing.Value) or
    (SourceInfo.LineSpacingType <> LineSpacingType.Value) or
    not SourceOptions.UseLeftIndent);
...
begin
  SourceOptions.UseOutlineLevel := not OutlineLevel.IsNull and
    ((SourceInfo.OutlineLevel <> OutlineLevel.Value) or
    not SourceOptions.UseOutlineLevel);
...
begin
  SourceOptions.UsePageBreakBefore := not PageBreakBefore.IsNull and
    ((SourceInfo.PageBreakBefore <> PageBreakBefore.Value) or
    not SourceOptions.UsePageBreakBefore);
...
begin
  SourceOptions.UseRightIndent := not RightIndent.IsNull and
    ((SourceInfo.RightIndent <> RightIndent.Value) or
    not SourceOptions.UseRightIndent);
...
begin
  SourceOptions.UseSpacingAfter := not SpacingAfter.IsNull and
    ((SourceInfo.SpacingAfter <> SpacingAfter.Value) or
    not SourceOptions.UseSpacingAfter);
...
begin
  SourceOptions.UseSpacingBefore := not SpacingBefore.IsNull and
    ((SourceInfo.SpacingBefore <> SpacingBefore.Value) or
    not SourceOptions.UseSpacingBefore);
...
begin
  SourceOptions.UseSuppressHyphenation := not SuppressHyphenation.IsNull and
    ((SourceInfo.SuppressHyphenation <> SuppressHyphenation.Value) or
    not SourceOptions.UseSuppressHyphenation);
...
begin
  SourceOptions.UseSuppressLineNumbers := not SuppressLineNumbers.IsNull and
    ((SourceInfo.SuppressLineNumbers <> SuppressLineNumbers.Value) or
    not SourceOptions.UseSuppressLineNumbers);
  if SourceOptions.UseSuppressLineNumbers then
    SourceInfo.SuppressLineNumbers := SuppressLineNumbers.Value;
end;

constructor TdxParagraphFormController.Create(AControllerParameters
  : TdxParagraphFormControllerParameters);
var
...
begin
  ...
  begin
    ACapabilityOptions := AControllerParameters.Control.InnerControl.
      DocumentModel.DocumentCapabilities;
    FCanEditTabs := ACapabilityOptions.ParagraphFormattingAllowed and
      ACapabilityOptions.ParagraphTabsAllowed;
  end
  else
    FCanEditTabs := True;
...
begin
  LeftIndent := TdxNullableValue<Integer>.Create(SourceOptions.UseLeftIndent,
    SourceInfo.LeftIndent);
  RightIndent := TdxNullableValue<Integer>.Create(SourceOptions.UseRightIndent,
    SourceInfo.RightIndent);
  FirstLineIndent := TdxNullableValue<Integer>.Create
    (SourceOptions.UseFirstLineIndent, SourceInfo.FirstLineIndent);
  FirstLineIndentType := TdxNullableValue<TdxParagraphFirstLineIndent>.Create
    (SourceOptions.UseFirstLineIndent, SourceInfo.FirstLineIndentType);
  Alignment := TdxNullableValue<TdxParagraphAlignment>.Create
    (SourceOptions.UseAlignment, SourceInfo.Alignment);
  SpacingAfter := TdxNullableValue<Integer>.Create
    (SourceOptions.UseSpacingAfter, SourceInfo.SpacingAfter);
  SpacingBefore := TdxNullableValue<Integer>.Create
    (SourceOptions.UseSpacingBefore, SourceInfo.SpacingBefore);
  LineSpacing := TdxNullableValue<Single>.Create(SourceOptions.UseLineSpacing,
    SourceInfo.LineSpacing);
  LineSpacingType := TdxNullableValue<TdxParagraphLineSpacing>.Create
    (SourceOptions.UseLineSpacing, SourceInfo.LineSpacingType);
  SuppressHyphenation := TdxNullableValue<Boolean>.Create
    (SourceOptions.UseSuppressHyphenation, SourceInfo.SuppressHyphenation);
  SuppressLineNumbers := TdxNullableValue<Boolean>.Create
    (SourceOptions.UseSuppressLineNumbers, SourceInfo.SuppressLineNumbers);
  OutlineLevel := TdxNullableValue<Integer>.Create
    (SourceOptions.UseOutlineLevel, SourceInfo.OutlineLevel);
  KeepLinesTogether := TdxNullableValue<Boolean>.Create
    (SourceOptions.UseKeepLinesTogether, SourceInfo.KeepLinesTogether);
  PageBreakBefore := TdxNullableValue<Boolean>.Create
    (SourceOptions.UsePageBreakBefore, SourceInfo.PageBreakBefore);
  ContextualSpacing := TdxNullableValue<Boolean>.Create
    (SourceOptions.UseContextualSpacing, SourceInfo.ContextualSpacing);
end;
