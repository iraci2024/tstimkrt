...
type
  ...
  TdxPageViewInfoGeneratorState = (InvisibleEmptyRow, InvisibleRow,
    PartialVisibleEmptyRow, PartialVisibleRow, VisibleEmptyRow, VisibleRow,
  ...
  public
    ...
    function GetPageAtPoint(const APoint: TPoint; AStrictSearch: Boolean)
      : TdxPageViewInfo;
    ...
    property Items[AIndex: Integer]: TdxPageViewInfo read GetItem
      write SetItem; default;
  end;

  { PageViewInfoRowCollection }

  TdxPageViewInfoRowCollection = class
    (TdxReferencedObjectList<TdxPageViewInfoRow>)
  protected
    function FindByBound(Y: Integer; out AFoundIndex: Integer): Boolean;
  public
    function GetRowAtPoint(const APoint: TPoint; AStrictSearch: Boolean)
      : TdxPageViewInfoRow;
  ...
  protected
    ...
    function CalculateVisibleHeightFactor(APageViewInfo: TdxPageViewInfo;
      const AViewPort: TRect): Single;
    function CalculateVisibleWidthFactor(APageViewInfo: TdxPageViewInfo;
      const AViewPort: TRect): Single;
    ...
    procedure AlignPagesHorizontally(ARow: TdxPageViewInfoRow;
      ARowLeftOffset: Integer);
    ...
    procedure OnLayoutUnitChanging(AUnitConverter
      : TdxDocumentLayoutUnitConverter); virtual;
    procedure OnLayoutUnitChanged(AUnitConverter
      : TdxDocumentLayoutUnitConverter); virtual;
  public
    ...
    function CalculatePageVisibleLogicalWidth(APageViewInfo: TdxPageViewInfo)
      : Integer; overload;
    function CalculatePageVisibleLogicalWidth(APageViewInfo: TdxPageViewInfo;
      const AViewPort: TRect): Integer; overload;
    function CalculatePageVisibleLogicalHeight(APageViewInfo: TdxPageViewInfo)
      : Integer; overload;
    function CalculatePageVisibleLogicalHeight(APageViewInfo: TdxPageViewInfo;
      const AViewPort: TRect): Integer; overload;
    function CalculatePagesTotalLogicalHeight(ARow: TdxPageViewInfoRow): Int64;
    function CalculatePagesTotalVisibleLogicalHeight(ARow: TdxPageViewInfoRow)
      : Int64; overload;
    function CalculatePagesTotalVisibleLogicalHeight(ARow: TdxPageViewInfoRow;
      const AViewPort: TRect): Int64; overload;
    function CalculatePagesTotalLogicalHeightAbove(ARow: TdxPageViewInfoRow;
      ALogicalY: Integer): Int64;
    function CalculatePagesTotalLogicalHeightBelow(ARow: TdxPageViewInfoRow;
      ALogicalY: Integer): Int64;
    function CalculatePageLogicalWidth(APage: TdxPage): Integer;
    ...
    function OffsetRectangle(const ARect: TRect;
      ADeltaX, ADeltaY: Integer): TRect;
    ...
    property HorizontalPageGap: Integer read GetHorizontalPageGap
      write SetHorizontalPageGap;
    property VerticalPageGap: Integer read GetVerticalPageGap
      write SetVerticalPageGap;
  end;
  ...
  public
    ...
    function PreProcessPage(APage: TdxPage; APageIndex: Integer)
      : TdxProcessPageResult; virtual;
    function ProcessPage(APage: TdxPage; APageIndex: Integer)
      : TdxProcessPageResult; virtual;
    procedure ResetAnchors;
    procedure Reset(AStrategy: TdxPageGenerationStrategyType); virtual;
    function GetPageRowAtPoint(const APoint: TPoint)
      : TdxPageViewInfoRow; overload;
    function GetPageRowAtPoint(const APoint: TPoint; AStrictSearch: Boolean)
      : TdxPageViewInfoRow; overload;

    procedure OnLayoutUnitChanging(AUnitConverter
      : TdxDocumentLayoutUnitConverter); override;
    procedure OnLayoutUnitChanged(AUnitConverter
      : TdxDocumentLayoutUnitConverter); override;
    ...
    property LeftInvisibleWidth: Int64 read FLeftInvisibleWidth
      write FLeftInvisibleWidth;
    property VisibleHeight: Int64 read GetVisibleHeight;
    property TotalHeight: Int64 read GetTotalHeight;
    property TopInvisibleHeight: Int64 read GetTopInvisibleHeight
      write SetTopInvisibleHeight;
    property ActiveGenerator: TdxPageViewInfoGeneratorBase
      read FActiveGenerator;
    property RunningHeightAnchor: TdxRunningHeightFirstPageAnchor
      read FRunningHeightAnchor;
    property FirstPageOffsetAnchor: TdxFirstPageOffsetFirstPageAnchor
      read FFirstPageOffsetAnchor;
  end;
  ...
  protected
    ...
    function CreateInvisibleEmptyRowState: TdxPageViewInfoGeneratorStateBase;
      virtual; abstract;
    function CreateInvisibleRowState: TdxPageViewInfoGeneratorStateBase;
      virtual; abstract;
    function CreatePartialVisibleEmptyRowState
      : TdxPageViewInfoGeneratorStateBase; virtual; abstract;
    function CreatePartialVisibleRowState: TdxPageViewInfoGeneratorStateBase;
      virtual; abstract;
    function CreateState(AStateType: TdxPageViewInfoGeneratorState)
      : TdxPageViewInfoGeneratorStateBase;
  public
    constructor Create(ALayoutManager: TdxPageGeneratorLayoutManager;
      AFirstPageAnchor: TdxFirstPageAnchor; APages: TdxPageViewInfoCollection);
    destructor Destroy; override;

    function ChangeState(AStateType: TdxPageViewInfoGeneratorState;
      AFreePrevState: Boolean = True)
      : TdxPageViewInfoGeneratorStateBase; virtual;
    function GetPageRowAtPoint(const APoint: TPoint; AStrictSearch: Boolean)
      : TdxPageViewInfoRow; virtual;
    function PreProcessPage(APage: TdxPage; APageIndex: Integer)
      : TdxProcessPageResult; virtual;
    function ProcessPage(APage: TdxPage; APageIndex: Integer)
      : TdxProcessPageResult; virtual;
    ...
    property OnRowFinished: TdxEventHandler read FOnRowFinished
      write FOnRowFinished;
  end;
  ...
  protected
    function CreateInvisibleEmptyRowState
      : TdxPageViewInfoGeneratorStateBase; override;
    function CreateInvisibleRowState
      : TdxPageViewInfoGeneratorStateBase; override;
    function CreatePartialVisibleEmptyRowState
      : TdxPageViewInfoGeneratorStateBase; override;
    function CreatePartialVisibleRowState
      : TdxPageViewInfoGeneratorStateBase; override;
  public
    property RunningHeight: Int64 read FRunningHeight write FRunningHeight;
    property FirstPageAnchor: TdxRunningHeightFirstPageAnchor
      read GetFirstPageAnchor;
  end;
  ...
  protected
    ...
    function CreatePartialVisibleRowState
      : TdxPageViewInfoGeneratorStateBase; override;
  public
    property FirstPageAnchor: TdxFirstPageOffsetFirstPageAnchor
      read GetFirstPageAnchor;
  end;
  ...
  public
    ...
    function PreProcessPage(APage: TdxPage; APageIndex: Integer)
      : TdxProcessPageResult; virtual;
    function ProcessPage(APage: TdxPage; APageIndex: Integer)
      : TdxStateProcessPageResult; virtual; abstract;
  ...
  public
    constructor Create(APages: TdxPageCollection;
      ASourceLayoutManager: TdxPageGeneratorLayoutManager);
    destructor Destroy; override;
    function GenerateNextRow: TdxPageViewInfoRow;

    property FirstPageIndex: Integer read FFirstPageIndex
      write SetFirstPageIndex;
    property FirstInvalidPageIndex: Integer read FFirstInvalidPageIndex
      write SetFirstInvalidPageIndex;
    property Generator: TdxPageViewInfoGeneratorBase read FGenerator;
    property LayoutManager: TdxPageGeneratorLayoutManager read FLayoutManager;
  end;
...
type
  ...
  protected
    ...
    procedure RecalculateCurrentRowPagesLayout(APage: TdxPage);
      virtual; abstract;
    ...
    procedure UpdateHeights(APage: TdxPage;
      APageViewInfo: TdxPageViewInfo); virtual;
    function CalculatePageBounds(APage: TdxPage): TRect; virtual;
    function CalculatePageVisibility(APage: TdxPage; APageIndex: Integer)
      : TdxPageVisibility; virtual;
  ...
  protected
    ...
    procedure HideStateCurrentRow(ANewState
      : TdxPageViewInfoGeneratorStateBase); virtual;
    procedure FinishCurrentRow; override;
    procedure RecalculateCurrentRowPagesLayout(APage: TdxPage); override;
    function IsPageFullyVisible(APage: TdxPage; APageIndex: Integer): Boolean;
      virtual; abstract;
    function IsPageFullyInvisible(APage: TdxPage; APageIndex: Integer): Boolean;
      virtual; abstract;
  public
  ...
  public
    function ProcessPage(APage: TdxPage; APageIndex: Integer)
      : TdxStateProcessPageResult; override;
  end;
  ...
  protected
    ...
    function SwitchToPartialVisibleRowState(APage: TdxPage; APageIndex: Integer)
      : TdxStateProcessPageResult; virtual;
  public
    function ProcessPage(APage: TdxPage; APageIndex: Integer)
      : TdxStateProcessPageResult; override;
  end;
  ...
  protected
    procedure UpdateHeights(APage: TdxPage;
      APageViewInfo: TdxPageViewInfo); override;
    function IsPageFullyVisible(APage: TdxPage; APageIndex: Integer)
      : Boolean; override;
    function IsPageFullyInvisible(APage: TdxPage; APageIndex: Integer)
      : Boolean; override;
  public
  ...
  protected
    ...
    function IsPageFullyInvisible(APage: TdxPage; APageIndex: Integer)
      : Boolean; override;
  public
    property Generator: TdxPageViewInfoGeneratorFirstPageOffset
      read GetGenerator;
  end;
  ...
  TdxStatePartialVisibleEmptyRowRunningHeight = class
    (TdxStatePartialVisibleEmptyRow)
  strict private
    function GetGenerator: TdxPageViewInfoGeneratorRunningHeight;
  protected
  ...
  protected
    ...
    function CheckRowOffset(AOffset: Integer; ATotalInvisibleRowHeight: Int64)
      : Integer; virtual;
  public
    property Generator: TdxPageViewInfoGeneratorRunningHeight read GetGenerator;
  end;
  ...
  TdxStatePartialVisibleEmptyRowFirstPageOffset = class
    (TdxStatePartialVisibleEmptyRow)
  strict private
    function GetGenerator: TdxPageViewInfoGeneratorFirstPageOffset;
  protected
  ...
  public
    ...
    property InitialVisibleHeight: Int64 read FInitialVisibleHeight
      write FInitialVisibleHeight;
  end;

  { TdxStateVisiblePagesGenerationComplete }

  TdxStateVisiblePagesGenerationComplete = class
    (TdxPageViewInfoGeneratorStateBase)
  protected
    function GetCurrentRow: TdxPageViewInfoRow; override;
    function GetType: TdxPageViewInfoGeneratorState; override;
  ...
  TdxPageGeneratorLayoutManagerHelper = class helper for
    TdxPageGeneratorLayoutManager
  strict private
...
function TdxPageViewInfoRow.IntersectsWithHorizontalLine
  (ALineY: Integer): Boolean;
begin
...
procedure TdxPageViewInfoRow.SetItem(AIndex: Integer;
...
function TdxPageViewInfoRow.GetPageAtPoint(const APoint: TPoint;
...
function TdxPageViewInfoRow.FindByBound(X: Integer;
...
function TdxPageViewInfoRowCollection.GetRowAtPoint(const APoint: TPoint;
...
function TdxPageViewInfoRowCollection.FindByBound(Y: Integer;
  out AFoundIndex: Integer): Boolean;
var
  L, H, AMedian: Integer;
  ABounds: TRect;
...
constructor TdxPageGeneratorLayoutManager.Create(AView: TObject;
  AViewInfo: TObject);
var
...
procedure TdxPageGeneratorLayoutManager.CopyFrom
  (AManager: TdxPageGeneratorLayoutManager);
begin
...
function TdxPageGeneratorLayoutManager.CalculatePageLogicalWidth
  (APage: TdxPage): Integer;
begin
  Result := APage.Bounds.Width + HorizontalPageGap;
end;

function TdxPageGeneratorLayoutManager.CalculatePageLogicalTotalWidth
  (APage: TdxPage): Integer;
begin
  Result := CalculatePageLogicalWidth(APage);
end;

function TdxPageGeneratorLayoutManager.CalculatePagePhysicalWidth
  (APage: TdxPage): Integer;
begin
  Result := Ceil(CalculatePageLogicalWidth(APage) * ScaleFactor);
end;

function TdxPageGeneratorLayoutManager.CalculatePageLogicalHeight
  (APage: TdxPage): Integer;
begin
  Result := APage.Bounds.Height + VerticalPageGap;
end;

function TdxPageGeneratorLayoutManager.CalculatePagePhysicalHeight
  (APage: TdxPage): Integer;
begin
  Result := Ceil(CalculatePageLogicalHeight(APage) * ScaleFactor);
end;

function TdxPageGeneratorLayoutManager.CalculatePageLogicalSize
  (APage: TdxPage): TSize;
var
  APageBounds: TRect;
begin
  APageBounds := APage.Bounds;
  Result.Init(APageBounds.Width + HorizontalPageGap,
    APageBounds.Height + VerticalPageGap);
end;

function TdxPageGeneratorLayoutManager.CalculatePagePhysicalSize
  (APage: TdxPage): TSize;
var
  APageBounds: TRect;
begin
...
function TdxPageGeneratorLayoutManager.CanFitPageToPageRow(APage: TdxPage;
  ARow: TdxPageViewInfoRow): Boolean;
var
  APageSize: TSize;
begin
...
function TdxPageGeneratorLayoutManager.CalculateVisibleHeightFactor
  (APageViewInfo: TdxPageViewInfo; const AViewPort: TRect): Single;
var
  APageViewInfoTotalHeight: Integer;
  APageViewInfoVisibleBounds: TRect;
begin
  APageViewInfoVisibleBounds.InitSize(0, AViewPort.Top, MaxInt,
    AViewPort.Height);
...
function TdxPageGeneratorLayoutManager.CalculateVisibleWidthFactor
  (APageViewInfo: TdxPageViewInfo; const AViewPort: TRect): Single;
var
  APageViewInfoTotalWidth: Integer;
  APageViewInfoVisibleBounds: TRect;
begin
  APageViewInfoVisibleBounds.InitSize(0, AViewPort.Top,
    AViewPort.Width, MaxInt);
  APageViewInfoVisibleBounds.Intersect(APageViewInfo.Bounds);
...
function TdxPageGeneratorLayoutManager.CalculatePageVisibleLogicalWidth
...
begin
  ...
  if AVisibleWidthFactor <= 0 then
    Exit(0);
  AResultF := AVisibleWidthFactor * CalculatePageLogicalWidth
    (APageViewInfo.Page);
  Result := Round(AResultF);
end;

function TdxPageGeneratorLayoutManager.CalculatePageVisibleLogicalHeight
  (APageViewInfo: TdxPageViewInfo): Integer;
begin
...
begin
  AVisibleHeightFactor := CalculateVisibleHeightFactor(APageViewInfo,
    AViewPort);
  if AVisibleHeightFactor <= 0 then
    Exit(0);
  AResultF := AVisibleHeightFactor * CalculatePageLogicalHeight
    (APageViewInfo.Page);
  Result := Round(AResultF);
end;

function TdxPageGeneratorLayoutManager.CalculatePagesTotalLogicalHeight
  (ARow: TdxPageViewInfoRow): Int64;
var
  I: Integer;
begin
  Result := 0;
...
function TdxPageGeneratorLayoutManager.CalculatePagesTotalVisibleLogicalHeight
  (ARow: TdxPageViewInfoRow): Int64;
begin
...
function TdxPageGeneratorLayoutManager.CalculatePagesTotalVisibleLogicalHeight
  (ARow: TdxPageViewInfoRow; const AViewPort: TRect): Int64;
var
  I: Integer;
begin
  Result := 0;
...
function TdxPageGeneratorLayoutManager.CalculatePagesTotalLogicalHeightAbove
  (ARow: TdxPageViewInfoRow; ALogicalY: Integer): Int64;
var
  AViewPort: TRect;
begin
...
function TdxPageGeneratorLayoutManager.CalculatePagesTotalLogicalHeightBelow
  (ARow: TdxPageViewInfoRow; ALogicalY: Integer): Int64;
var
  AViewPort: TRect;
begin
...
procedure TdxPageGeneratorLayoutManager.UpdatePageClientBounds
...
begin
  ...
  AClientBounds.Offset(AHorizontalGapPhysicalSize div 2,
    AVerticalGapPhysicalSize div 2);
  APageViewInfo.ClientBounds := AClientBounds;
end;

function TdxPageGeneratorLayoutManager.OffsetRectangle(const ARect: TRect;
  ADeltaX, ADeltaY: Integer): TRect;
begin
  Result := ARect;
...
procedure TdxPageGeneratorLayoutManager.OffsetRowVertically
  (ARow: TdxPageViewInfoRow; AOffset: Integer);
var
  APageViewInfo: TdxPageViewInfo;
  I: Integer;
begin
...
function TdxPageGeneratorLayoutManager.CreateInitialPageViewInfoRowBounds
  (Y: Integer): TRect;
begin
...
function TdxPageGeneratorLayoutManager.CalculateFirstPageLeftOffset
...
begin
  ...
  ARow.Bounds := TRect.CreateSize(AOffset, ARow.Bounds.Top, ATotalPagesWidth,
    ARow.Bounds.Height);
end;

procedure TdxPageGeneratorLayoutManager.AlignPagesVertically
...
begin
  ...
  begin
    ...
    APageViewInfo.Bounds := TRect.CreateSize(R.Left,
      ARow.Bounds.Top + (ARowHeight - R.Height) div 2, R.Width, R.Height);
  end;
end;

procedure TdxPageGeneratorLayoutManager.AlignPagesHorizontally
  (ARow: TdxPageViewInfoRow; ARowLeftOffset: Integer);
var
  R: TRect;
  APageViewInfo: TdxPageViewInfo;
  I, X: Integer;
...
procedure TdxPageGeneratorLayoutManager.UpdatePagesClientBounds
  (ARow: TdxPageViewInfoRow);
var
  I: Integer;
begin
...
procedure TdxPageGeneratorLayoutManager.OnLayoutUnitChanging(AUnitConverter
  : TdxDocumentLayoutUnitConverter);
begin
end;

procedure TdxPageGeneratorLayoutManager.OnLayoutUnitChanged(AUnitConverter
  : TdxDocumentLayoutUnitConverter);
begin
end;
...
function TdxPageViewInfoGenerator.PreProcessPage(APage: TdxPage;
  APageIndex: Integer): TdxProcessPageResult;
begin
  Result := FActiveGenerator.PreProcessPage(APage, APageIndex);
end;

function TdxPageViewInfoGenerator.ProcessPage(APage: TdxPage;
  APageIndex: Integer): TdxProcessPageResult;
begin
...
procedure TdxPageViewInfoGenerator.Reset(AStrategy
...
begin
  ...
  begin
    ANewRunningHeightGenerator := TdxPageViewInfoGeneratorRunningHeight.Create
      (Self, FRunningHeightAnchor, View.PageViewInfos);
  ...
  begin
    ANewFirstPageOffsetGenerator := TdxPageViewInfoGeneratorFirstPageOffset.
      Create(Self, FFirstPageOffsetAnchor, View.PageViewInfos);
    if FActiveGenerator <> FFirstPageOffsetGenerator then
...
function TdxPageViewInfoGenerator.GetPageRowAtPoint(const APoint: TPoint)
  : TdxPageViewInfoRow;
begin
...
procedure TdxPageViewInfoGenerator.OnLayoutUnitChanging(AUnitConverter
  : TdxDocumentLayoutUnitConverter);
begin
  ...
  FRunningHeightAnchor.TopInvisibleHeight := AUnitConverter.LayoutUnitsToTwips
    (FRunningHeightAnchor.TopInvisibleHeight);
  FFirstPageOffsetAnchor.VerticalOffset := AUnitConverter.LayoutUnitsToTwips
    (FFirstPageOffsetAnchor.VerticalOffset);
end;

procedure TdxPageViewInfoGenerator.OnLayoutUnitChanged(AUnitConverter
  : TdxDocumentLayoutUnitConverter);
begin
  ...
  FRunningHeightAnchor.TopInvisibleHeight := AUnitConverter.TwipsToLayoutUnits
    (FRunningHeightAnchor.TopInvisibleHeight);
  FFirstPageOffsetAnchor.VerticalOffset := AUnitConverter.TwipsToLayoutUnits
    (FFirstPageOffsetAnchor.VerticalOffset);
end;
...
begin
  ...
  begin
    ...
    begin
      APage := ARow[0];
      ATotalWidthValue := Max(ATotalWidthValue,
        CalculatePageLogicalWidth(APage.Page));
      AVisibleWidthValue := Max(AVisibleWidthValue,
        CalculatePageVisibleLogicalWidth(APage));
    end;
  end;
...
begin
  ...
  try
    for I := 0 to ACount - 1 do
    begin
      APage.Bounds := View.FormattingController.PageController.
        CalculatePageBounds(ASections[I]);
...
begin
  ...
  FFirstPageOffsetAnchor.PageIndex := View.FormattingController.PageController.
    Pages.IndexOf(APageViewInfo.Page);
  FFirstPageOffsetAnchor.VerticalOffset := CalculatePageLogicalHeight
    (APageViewInfo.Page) - CalculatePageVisibleLogicalHeight(APageViewInfo,
    AViewPort);
end;

function TdxPageViewInfoGenerator.LookupFirstVisiblePage
  (ARow: TdxPageViewInfoRow): TdxPageViewInfo;
var
  I: Integer;
begin
  for I := 0 to ARow.Count - 1 do
...
constructor TdxPageViewInfoGeneratorBase.Create(ALayoutManager
  : TdxPageGeneratorLayoutManager; AFirstPageAnchor: TdxFirstPageAnchor;
  APages: TdxPageViewInfoCollection);
begin
  inherited Create;
...
function TdxPageViewInfoGeneratorBase.PreProcessPage(APage: TdxPage;
  APageIndex: Integer): TdxProcessPageResult;
begin
  Result := State.PreProcessPage(APage, APageIndex);
end;

function TdxPageViewInfoGeneratorBase.ProcessPage(APage: TdxPage;
  APageIndex: Integer): TdxProcessPageResult;
begin
  while True do
    if State.ProcessPage(APage, APageIndex) = TdxStateProcessPageResult.Success
    then
      Break;

  if State.&Type <> TdxPageViewInfoGeneratorState.VisiblePagesGenerationComplete
  then
...
function TdxPageViewInfoGeneratorBase.ChangeState
  (AStateType: TdxPageViewInfoGeneratorState; AFreePrevState: Boolean = True)
  : TdxPageViewInfoGeneratorStateBase;
begin
...
function TdxPageViewInfoGeneratorBase.CreateState
  (AStateType: TdxPageViewInfoGeneratorState)
  : TdxPageViewInfoGeneratorStateBase;
begin
  case AStateType of
...
function TdxPageViewInfoGeneratorBase.GetPageRowAtPoint(const APoint: TPoint;
  AStrictSearch: Boolean): TdxPageViewInfoRow;
begin
  Result := PageRows.GetRowAtPoint(APoint, AStrictSearch);
end;

procedure TdxPageViewInfoGeneratorBase.SetCurrentPageRow
  (Value: TdxPageViewInfoRow);
begin
...
function TdxPageViewInfoGeneratorRunningHeight.CreateInvisibleEmptyRowState
  : TdxPageViewInfoGeneratorStateBase;
begin
  Result := TdxStateInvisibleEmptyRowRunningHeight.Create(Self);
end;

function TdxPageViewInfoGeneratorRunningHeight.CreateInvisibleRowState
  : TdxPageViewInfoGeneratorStateBase;
begin
  Result := TdxStateInvisibleRowRunningHeight.Create(Self);
end;

function TdxPageViewInfoGeneratorRunningHeight.CreatePartialVisibleEmptyRowState
  : TdxPageViewInfoGeneratorStateBase;
begin
  Result := TdxStatePartialVisibleEmptyRowRunningHeight.Create(Self);
end;

function TdxPageViewInfoGeneratorRunningHeight.CreatePartialVisibleRowState
  : TdxPageViewInfoGeneratorStateBase;
begin
  Result := TdxStatePartialVisibleRowRunningHeight.Create(Self);
end;

function TdxPageViewInfoGeneratorRunningHeight.GetFirstPageAnchor
...
function TdxPageViewInfoGeneratorFirstPageOffset.CreateInvisibleEmptyRowState
  : TdxPageViewInfoGeneratorStateBase;
begin
  Result := TdxStateInvisibleEmptyRowFirstPageOffset.Create(Self);
end;

function TdxPageViewInfoGeneratorFirstPageOffset.CreateInvisibleRowState
  : TdxPageViewInfoGeneratorStateBase;
begin
  Result := TdxStateInvisibleRowFirstPageOffset.Create(Self);
end;

function TdxPageViewInfoGeneratorFirstPageOffset.
  CreatePartialVisibleEmptyRowState: TdxPageViewInfoGeneratorStateBase;
begin
  Result := TdxStatePartialVisibleEmptyRowFirstPageOffset.Create(Self);
end;

function TdxPageViewInfoGeneratorFirstPageOffset.CreatePartialVisibleRowState
  : TdxPageViewInfoGeneratorStateBase;
begin
  Result := TdxStatePartialVisibleRowFirstPageOffset.Create(Self);
end;

function TdxPageViewInfoGeneratorFirstPageOffset.GetFirstPageAnchor
...
constructor TdxPageViewInfoGeneratorStateBase.Create
  (AGenerator: TdxPageViewInfoGeneratorBase);
begin
  inherited Create;
...
function TdxPageViewInfoGeneratorStateBase.GetFirstPageAnchor
  : TdxFirstPageAnchor;
begin
...
procedure TdxPageViewInfoGeneratorStateBase.SetVisibleHeight
  (const Value: Int64);
begin
  Generator.VisibleHeight := Value;
end;

function TdxPageViewInfoGeneratorStateBase.PreProcessPage(APage: TdxPage;
  APageIndex: Integer): TdxProcessPageResult;
begin
  Result := TdxProcessPageResult.VisiblePagesGenerationIncomplete;
end;

function TdxPageViewInfoGeneratorStateBase.ChangeState
  (AStateType: TdxPageViewInfoGeneratorState; AFreePrevState: Boolean = True)
  : TdxPageViewInfoGeneratorStateBase;
begin
...
procedure TdxPageViewInfoGeneratorStateBase.AddPageToOutput
  (APage: TdxPageViewInfo);
begin
...
begin
  ...
  APageViewInfo.Bounds := TRect.CreateSize(ARow.Bounds.Right, ARow.Bounds.Top,
    LayoutManager.CalculatePagePhysicalSize(APage));
  ARow.Add(APageViewInfo);
  RecalculateCurrentRowPagesLayout(APage);
  LayoutManager.UpdatePageClientBounds(APageViewInfo);
  ARow.Bounds := TRect.CreateSize(ARow.Bounds.Location,
    ARow.Bounds.Width + APageViewInfo.Bounds.Width,
...
procedure TdxAddPageGeneratorStateBase.UpdateVisibleHeight
  (APageViewInfo: TdxPageViewInfo);
var
  APageVisibleLogicalHeight: Integer;
begin
  APageVisibleLogicalHeight := LayoutManager.CalculatePageVisibleLogicalHeight
    (APageViewInfo);
...
procedure TdxAddPageGeneratorStateBase.UpdateVisibleHeightCore
  (AVisiblePageHeight: Integer);
begin
  VisibleHeight := VisibleHeight + AVisiblePageHeight;
end;

procedure TdxAddPageGeneratorStateBase.UpdateHeights(APage: TdxPage;
  APageViewInfo: TdxPageViewInfo);
begin
...
function TdxAddPageGeneratorStateBase.CalculatePageBounds
  (APage: TdxPage): TRect;
var
  APageSize: TSize;
  ARowBounds: TRect;
...
function TdxAddPageGeneratorStateBase.CalculatePageVisibility(APage: TdxPage;
...
begin
  ...
  AExtendedViewPortBounds.InitSize(0, ViewPortBounds.Top, MaxInt,
  ...
  else if (APageViewInfoVisibleBounds.Width > 0) and
    (APageViewInfoVisibleBounds.Height > 0) then
...
begin
  ...
  ANewRow.Bounds := LayoutManager.CreateInitialPageViewInfoRowBounds
    (CurrentRow.Bounds.Bottom);
...
constructor TdxStateInvisibleRowBase.Create(AGenerator
  : TdxPageViewInfoGeneratorBase);
begin
...
function TdxStateInvisibleRowBase.CalculatePageVisibility(APage: TdxPage;
  APageIndex: Integer): TdxPageVisibility;
begin
...
procedure TdxStateInvisibleRowBase.UpdateVisibleHeight(APageViewInfo
  : TdxPageViewInfo);
begin
  // do nothing
end;

procedure TdxStateInvisibleRowBase.CopyPagesTo
...
procedure TdxStateInvisibleRowBase.HideStateCurrentRow
  (ANewState: TdxPageViewInfoGeneratorStateBase);
var
  ARow: TdxPageViewInfoRow;
begin
...
procedure TdxStateInvisibleRowBase.RecalculateCurrentRowPagesLayout
  (APage: TdxPage);
begin
  // do nothing
end;
  ...
  case CalculatePageVisibility(APage, APageIndex) of
    TdxPageVisibility.Invisible:
      begin
        ...
        try
          ANewState :=
            ChangeState(TdxPageViewInfoGeneratorState.InvisibleRow, False);
...
function TdxStateInvisibleRow.ProcessPage(APage: TdxPage; APageIndex: Integer)
  : TdxStateProcessPageResult;
begin
  if IsPageFullyVisible(APage, APageIndex) then
  begin
...
function TdxStateInvisibleRow.SwitchToPartialVisibleRowState(APage: TdxPage;
  APageIndex: Integer): TdxStateProcessPageResult;
var
...
begin
  ...
  try
    AState := ChangeState
      (TdxPageViewInfoGeneratorState.PartialVisibleRow, False);
...
function TdxStateInvisibleEmptyRowRunningHeight.IsPageFullyInvisible
  (APage: TdxPage; APageIndex: Integer): Boolean;
var
  ARunningHeight: Int64;
begin
  ARunningHeight := Generator.RunningHeight +
    LayoutManager.CalculatePageLogicalHeight(APage);
  Result := ARunningHeight <= Generator.FirstPageAnchor.TopInvisibleHeight;
end;

function TdxStateInvisibleEmptyRowRunningHeight.IsPageFullyVisible
  (APage: TdxPage; APageIndex: Integer): Boolean;
begin
  Result := Generator.RunningHeight = Generator.FirstPageAnchor.
    TopInvisibleHeight;
end;

procedure TdxStateInvisibleEmptyRowRunningHeight.UpdateHeights(APage: TdxPage;
  APageViewInfo: TdxPageViewInfo);
begin
  inherited UpdateHeights(APage, APageViewInfo);
  Generator.RunningHeight := Generator.RunningHeight +
    LayoutManager.CalculatePageLogicalHeight(APage);
end;

function TdxStateInvisibleEmptyRowRunningHeight.GetGenerator
  : TdxPageViewInfoGeneratorRunningHeight;
begin
...
begin
  Generator.RunningHeight := Generator.RunningHeight -
    LayoutManager.CalculatePagesTotalLogicalHeight(CurrentRow);
end;

procedure TdxStateInvisibleRowRunningHeight.UpdateHeights(APage: TdxPage;
  APageViewInfo: TdxPageViewInfo);
begin
  inherited UpdateHeights(APage, APageViewInfo);
  Generator.RunningHeight := Generator.RunningHeight +
...
function TdxStateInvisibleRowRunningHeight.GetGenerator
  : TdxPageViewInfoGeneratorRunningHeight;
begin
  Result := TdxPageViewInfoGeneratorRunningHeight(inherited Generator);
end;
...
function TdxStateInvisibleEmptyRowFirstPageOffset.GetGenerator
  : TdxPageViewInfoGeneratorFirstPageOffset;
begin
  Result := TdxPageViewInfoGeneratorFirstPageOffset(inherited Generator);
end;

function TdxStateInvisibleEmptyRowFirstPageOffset.IsPageFullyInvisible
  (APage: TdxPage; APageIndex: Integer): Boolean;
var
...
function TdxStateInvisibleEmptyRowFirstPageOffset.IsPageFullyVisible
  (APage: TdxPage; APageIndex: Integer): Boolean;
begin
  Result := False;
end;
...
var
  ...
  ARow: TdxPageViewInfoRow;
begin
  ALastPageOffset := Ceil(Generator.FirstPageAnchor.VerticalOffset *
    ScaleFactor);
  ARow := ANewState.CurrentRow;
...
function TdxStateInvisibleRowFirstPageOffset.IsPageFullyInvisible
  (APage: TdxPage; APageIndex: Integer): Boolean;
var
  AAnchor: TdxFirstPageOffsetFirstPageAnchor;
begin
...
function TdxStateInvisibleRowFirstPageOffset.SwitchToPartialVisibleRowState
  (APage: TdxPage; APageIndex: Integer): TdxStateProcessPageResult;
begin
  AddPage(APage, APageIndex);
...
function TdxStateInvisibleRowFirstPageOffset.GetGenerator
  : TdxPageViewInfoGeneratorFirstPageOffset;
begin
  Result := TdxPageViewInfoGeneratorFirstPageOffset(inherited Generator);
end;
...
function TdxStatePartialVisibleEmptyRow.ProcessPage(APage: TdxPage;
  APageIndex: Integer): TdxStateProcessPageResult;
begin
...
procedure TdxStatePartialVisibleEmptyRow.RecalculateCurrentRowPagesLayout
  (APage: TdxPage);
var
  ARow: TdxPageViewInfoRow;
  APageViewInfo: TdxPageViewInfo;
...
begin
  ...
  ARow.Bounds := LayoutManager.OffsetRectangle(ARow.Bounds, 0,
    -AInvisiblePageAreaHeight);
  APageViewInfo := ARow[0];
  APageViewInfo.Bounds := LayoutManager.OffsetRectangle(APageViewInfo.Bounds, 0,
    -AInvisiblePageAreaHeight);
  LayoutManager.UpdatePageClientBounds(APageViewInfo);
end;

procedure TdxStatePartialVisibleEmptyRow.UpdateHeights(APage: TdxPage;
  APageViewInfo: TdxPageViewInfo);
begin
  AlignPagesVertically;
  inherited UpdateHeights(APage, APageViewInfo);
...
function TdxStatePartialVisibleRow.PreProcessPage(APage: TdxPage;
  APageIndex: Integer): TdxProcessPageResult;
begin
  if (CurrentRow.Bounds.Bottom >= ViewPortBounds.Bottom) and
    not CanAddPage(APage) then
    Result := TdxProcessPageResult.VisiblePagesGenerationComplete
  else
    Result := TdxProcessPageResult.VisiblePagesGenerationIncomplete;
end;

function TdxStatePartialVisibleRow.ProcessPage(APage: TdxPage;
  APageIndex: Integer): TdxStateProcessPageResult;
begin
  if not CanAddPage(APage) then
  begin
...
procedure TdxStatePartialVisibleRow.UpdateHeights(APage: TdxPage;
  APageViewInfo: TdxPageViewInfo);
begin
  AlignPagesVertically;
  inherited UpdateHeights(APage, APageViewInfo);
...
procedure TdxStatePartialVisibleRow.UpdateVisibleHeight(APageViewInfo
  : TdxPageViewInfo);
begin
  VisibleHeight := LayoutManager.CalculatePagesTotalVisibleLogicalHeight
    (CurrentRow);
end;
...
function TdxStatePartialVisibleEmptyRowRunningHeight.
  CalculateVerticalRowOffset: Integer;
begin
  Result := Round((Generator.FirstPageAnchor.TopInvisibleHeight -
    Generator.RunningHeight) * ScaleFactor);
end;

function TdxStatePartialVisibleEmptyRowRunningHeight.GetGenerator
  : TdxPageViewInfoGeneratorRunningHeight;
begin
  Result := TdxPageViewInfoGeneratorRunningHeight(inherited Generator);
end;
...
function TdxStatePartialVisibleRowRunningHeight.
  CalculatePartialRowOffset: Integer;
var
  ALow, AHi, AMedian, ACompareResult: Integer;
  ATotalInvisibleRowHeight: Int64;
begin
  ATotalInvisibleRowHeight :=
    Ceil((Generator.FirstPageAnchor.TopInvisibleHeight -
    Generator.RunningHeight) * ScaleFactor);
  ALow := 1;
...
function TdxStatePartialVisibleRowRunningHeight.CheckRowOffset(AOffset: Integer;
  ATotalInvisibleRowHeight: Int64): Integer;
var
...
begin
  ...
  begin
    ...
    ADelta := Min(AInvisibleBounds.Bottom, APageBounds.Bottom) -
      APageBounds.Top;
    if ADelta > 0 then
      Inc(ATotal, ADelta);
  end;
...
procedure TdxStatePartialVisibleRowRunningHeight.
  RecalculateCurrentRowPagesLayout(APage: TdxPage);
var
...
begin
  ...
  APageViewInfo.Bounds := LayoutManager.OffsetRectangle(APageViewInfo.Bounds, 0,
    (ARow.Bounds.Height - APhysicalPageHeight) div 2);
  if APageViewInfo.Bounds.Top < ARow.Bounds.Top then
    ARow.Bounds := TRect.CreateSize(ARow.Bounds.Left, APageViewInfo.Bounds.Top,
      ARow.Bounds.Width, APageViewInfo.Bounds.Height);
...
function TdxStatePartialVisibleRowRunningHeight.GetGenerator
  : TdxPageViewInfoGeneratorRunningHeight;
begin
  Result := TdxPageViewInfoGeneratorRunningHeight(inherited Generator);
end;
...
function TdxStatePartialVisibleEmptyRowFirstPageOffset.
  CalculateVerticalRowOffset: Integer;
begin
  Result := Ceil(Generator.FirstPageAnchor.VerticalOffset * ScaleFactor);
end;

function TdxStatePartialVisibleEmptyRowFirstPageOffset.GetGenerator
  : TdxPageViewInfoGeneratorFirstPageOffset;
begin
  Result := TdxPageViewInfoGeneratorFirstPageOffset(inherited Generator);
end;
...
procedure TdxStatePartialVisibleRowFirstPageOffset.
  RecalculateCurrentRowPagesLayout(APage: TdxPage);
begin
  // do nothing
end;

procedure TdxStatePartialVisibleRowFirstPageOffset.UpdateHeights(APage: TdxPage;
  APageViewInfo: TdxPageViewInfo);
begin
  AlignPagesVertically;
  inherited UpdateHeights(APage, APageViewInfo);
...
function TdxStatePartialVisibleRowFirstPageOffset.GetGenerator
  : TdxPageViewInfoGeneratorFirstPageOffset;
begin
  Result := TdxPageViewInfoGeneratorFirstPageOffset(inherited Generator);
end;
...
function TdxStateVisibleEmptyRow.ProcessPage(APage: TdxPage;
  APageIndex: Integer): TdxStateProcessPageResult;
var
  AState: TdxStateVisibleRow;
  AInitialVisibleHeight: Int64;
begin
  if CalculatePageVisibility(APage, APageIndex) = TdxPageVisibility.Invisible
  then
  begin
    RemoveLastRow;
  ...
  begin
    ...
    AddPage(APage, APageIndex);
    AState := TdxStateVisibleRow
      (ChangeState(TdxPageViewInfoGeneratorState.VisibleRow));
    AState.InitialVisibleHeight := AInitialVisibleHeight;
    Result := TdxStateProcessPageResult.Success;
  end;
end;

procedure TdxStateVisibleEmptyRow.RecalculateCurrentRowPagesLayout
  (APage: TdxPage);
begin
  // do nothing
end;
...
procedure TdxStateVisibleEmptyRow.UpdateHeights(APage: TdxPage;
  APageViewInfo: TdxPageViewInfo);
begin
  AlignPagesVertically;
  inherited UpdateHeights(APage, APageViewInfo);
...
function TdxStateVisibleRow.PreProcessPage(APage: TdxPage; APageIndex: Integer)
  : TdxProcessPageResult;
begin
  if (CurrentRow.Bounds.Bottom >= ViewPortBounds.Bottom) and
    not CanAddPage(APage) then
    Result := TdxProcessPageResult.VisiblePagesGenerationComplete
...
function TdxStateVisibleRow.ProcessPage(APage: TdxPage; APageIndex: Integer)
  : TdxStateProcessPageResult;
begin
  if not CanAddPage(APage) then
  begin
  ...
  case CalculatePageVisibility(APage, APageIndex) of
    TdxPageVisibility.Partial, TdxPageVisibility.Entire:
      begin
        AddPage(APage, APageIndex);
...
procedure TdxStateVisibleRow.UpdateVisibleHeight(APageViewInfo
  : TdxPageViewInfo);
begin
  AlignPagesVertically;
  VisibleHeight := InitialVisibleHeight +
    LayoutManager.CalculatePagesTotalVisibleLogicalHeight(CurrentRow);
end;
...
function TdxStateVisiblePagesGenerationComplete.GetCurrentRow
  : TdxPageViewInfoRow;
begin
  Result := nil;
end;

function TdxStateVisiblePagesGenerationComplete.GetType
  : TdxPageViewInfoGeneratorState;
begin
  Result := TdxPageViewInfoGeneratorState.VisiblePagesGenerationComplete;
end;

function TdxStateVisiblePagesGenerationComplete.ProcessPage(APage: TdxPage;
  APageIndex: Integer): TdxStateProcessPageResult;
begin
  TotalHeight := TotalHeight + LayoutManager.CalculatePageLogicalHeight(APage);
  Result := TdxStateProcessPageResult.Success;
...
constructor TdxInvisiblePageRowsGenerator.Create(APages: TdxPageCollection;
  ASourceLayoutManager: TdxPageGeneratorLayoutManager);
var
...
begin
  ...
  FGenerator := TdxPageViewInfoGeneratorRunningHeight.Create(LayoutManager,
    FRunningHeightFirstPageAnchor, FPageViewInfoCollection);
  Reset;
end;
