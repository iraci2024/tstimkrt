...
type
  ...
  TcxSchedulerRangeControlContentElementViewInfo = class
  ...
  public
    ...
    property Properties: TcxSchedulerCustomRangeControlClientProperties
      read GetProperties;
  end;

  TcxSchedulerRangeControlContentViewInfo = class
  ...
  protected
    function CreateContentElementViewInfo
      : TdxRangeControlDateTimeHeaderClientContentElementViewInfo; override;
  ...
  TcxSchedulerRangeControlClientViewInfo = class
  ...
  private
    ...
    FEventInfos: TDictionary<TDateTime,
  ...
  public
    ...
    destructor Destroy; override;
  published
    property EventCounterFont: TFont read FEventCounterFont
      write SetEventCounterFont;
    property EventCounterTextColor: TColor read FEventCounterTextColor
      write SetEventCounterTextColor default clDefault;
  end;

  TcxSchedulerRangeControlAutoAdjustment = (aaClient, aaRangeControl);
  TcxSchedulerRangeControlAutoAdjustments = set of
  ...
  private
    ...
    FOnAutoAdjustRangeControlSettings
      : TcxSchedulerRangeControlAutoAdjustingEvent;
    ...
    procedure SetAutoAdjustments
      (Value: TcxSchedulerRangeControlAutoAdjustments);
    procedure SetDataDisplayType
      (Value: TcxSchedulerRangeControlDataDisplayType);
  ...
  public
    constructor Create(AOwner: TPersistent); override;
    destructor Destroy; override;
    procedure DoAutoAdjustRangeControlSettings
      (AInfo: TcxSchedulerRangeControlAutoAdjustingInfo);
    property ActualPrimaryScale;
    property AutoAdjustments: TcxSchedulerRangeControlAutoAdjustments
      read GetAutoAdjustments write SetAutoAdjustments
      default [aaClient, aaRangeControl];
    property DataDisplayType: TcxSchedulerRangeControlDataDisplayType
      read FDataDisplayType write SetDataDisplayType default ddtAuto;
    property ThumbnailHeight: Integer read FThumbnailHeight
      write SetThumbnailHeight default 0;
    property OnAutoAdjustRangeControlSettings
      : TcxSchedulerRangeControlAutoAdjustingEvent
      read FOnAutoAdjustRangeControlSettings
      write FOnAutoAdjustRangeControlSettings;
  end;

  TcxSchedulerRangeControlClientProperties = class
    (TcxSchedulerCustomRangeControlClientProperties)
  published
...
function DateTimeInRange(ADateTime: TDateTime;
  AStartDateTime, AEndDateTime: TDateTime; aInclusive: Boolean = True): Boolean;
begin
{$IFDEF DELPHIXE}
  Result := DateUtils.DateTimeInRange(ADateTime, AStartDateTime, AEndDateTime,
    aInclusive);
{$ELSE}
  if aInclusive then
...
procedure TcxSchedulerRangeControlContentElementViewInfo.CalculateBounds
  (const ABounds: TRect);
var
...
begin
  ...
  begin
    FThumbnailRowHeight := IfThen(Properties.ThumbnailHeight <> 0,
      Properties.ThumbnailHeight, ScaleFactor.Apply(ThumbnailDefaultRowHeight));
    AThumbnailsHeight := FEventColors.Count *
      (FThumbnailRowHeight + ScaleFactor.Apply(ThumbnailRowIndent)) +
      ScaleFactor.Apply(ThumbnailRowIndent);
    FIsThumbnailMode := (Properties.DataDisplayType = ddtThumbnail) or
      (Properties.DataDisplayType = ddtAuto) and
      (AThumbnailsHeight <= (Bounds.Height - 2 *
      ScaleFactor.Apply(ContentOffset)));
    if not FIsThumbnailMode then
    begin
      ATextSize := cxTextSize
        ((ViewInfo.ClientInfo.Content as
        TcxSchedulerRangeControlContentViewInfo).GetFont,
        IntToStr(FEventColors.Count));
      FIsEnoughSpaceForText :=
        (ATextSize.cx <= (cxRectWidth(Bounds) - ScaleFactor.Apply(4))) and
        (ATextSize.cy <= (cxRectHeight(Bounds) - ScaleFactor.Apply(4)));
    end;
  end;
end;

function TcxSchedulerRangeControlContentElementViewInfo.GetProperties
  : TcxSchedulerCustomRangeControlClientProperties;
begin
  Result := ViewInfo.ClientProperties as
    TcxSchedulerCustomRangeControlClientProperties;
end;

procedure TcxSchedulerRangeControlContentElementViewInfo.Paint
  (ACanvas: TcxCanvas);
var
  I: Integer;
...
begin
  ...
  begin
    ARect := cxRectInflate(Bounds, -ScaleFactor.Apply(ContentOffset),
      -ScaleFactor.Apply(ContentOffset));
    ...
    ACanvas.DrawTexT(IntToStr(FEventColors.Count), Bounds, cxAlignVCenter or
      cxAlignHCenter);
end;

{ TcxSchedulerRangeControlContentViewInfo }

constructor TcxSchedulerRangeControlContentViewInfo.Create
...
procedure TcxSchedulerRangeControlContentViewInfo.CalculateBounds
  (const ABounds: TRect);
begin
...
function TcxSchedulerRangeControlContentViewInfo.CreateContentElementViewInfo
  : TdxRangeControlDateTimeHeaderClientContentElementViewInfo;
begin
...
function TcxSchedulerRangeControlContentViewInfo.GetStyle
  : TcxSchedulerRangeControlClientStyle;
begin
  Result := ViewInfo.ClientProperties.Style as
    TcxSchedulerRangeControlClientStyle;
end;
...
function TcxSchedulerRangeControlClientViewInfo.CreateContentInfo
  : TdxRangeControlContentViewInfo;
begin
  Result := TcxSchedulerRangeControlContentViewInfo.Create(ViewInfo);
end;

function TcxSchedulerRangeControlClientViewInfo.GetProperties
  : TcxSchedulerCustomRangeControlClientProperties;
begin
...
procedure TcxSchedulerCustomRangeControlClientProperties.ChangeScale(M,
  D: Integer);
begin
  inherited;
...
constructor TcxSchedulerCustomRangeControlClientProperties.Create
  (AOwner: TPersistent);
begin
  inherited;
...
function TcxSchedulerCustomRangeControlClientProperties.CreateViewInfo
  (AViewInfo: TdxCustomRangeControlViewInfo)
...
procedure TcxSchedulerCustomRangeControlClientProperties.DoAssign
  (Source: TPersistent);
var
...
procedure TcxSchedulerCustomRangeControlClientProperties.DoUpdateVisibleScales
...
procedure TcxSchedulerCustomRangeControlClientProperties.
  DoAutoAdjustRangeControlSettings
  (AInfo: TcxSchedulerRangeControlAutoAdjustingInfo);
begin
...
function TcxSchedulerCustomRangeControlClientProperties.GetScheduler
  : TcxScheduler;
begin
...
procedure TcxSchedulerCustomRangeControlClientProperties.
  SetAllowChangeActiveView(Value: Boolean);
begin
...
procedure TcxSchedulerCustomRangeControlClientProperties.SetAutoAdjustments
  (Value: TcxSchedulerRangeControlAutoAdjustments);
begin
...
procedure TcxSchedulerCustomRangeControlClientProperties.SetAutoAdjustMode
  (Value: Boolean);
begin
...
procedure TcxSchedulerCustomRangeControlClientProperties.SetDataDisplayType
  (Value: TcxSchedulerRangeControlDataDisplayType);
begin
...
procedure TcxSchedulerCustomRangeControlClientProperties.SetThumbnailHeight
  (Value: Integer);
begin
  Value := Max(0, Value);
...
procedure TcxSchedulerCustomRangeControlClientProperties.AdjustPrimaryScale
...
function TcxSchedulerCustomRangeControlClientProperties.CreateStyle
  : TdxRangeControlCustomClientStyle;
begin
  Result := TcxSchedulerRangeControlClientStyle.Create(Self);
end;

function TcxSchedulerCustomRangeControlClientProperties.GetActualPrimaryScale
...
function TcxSchedulerCustomRangeControlClientProperties.GetAutoAdjustments
...
constructor TcxSchedulerRangeControlEventsCache.Create
  (AOwner: TcxSchedulerCustomRangeControlClientProperties);
begin
  inherited Create;
  FOwner := AOwner;
  FTimeSortedEventInfos := TcxSchedulerRangeControlIntervalEventInfos.Create;
  FEventInfos := TDictionary<TDateTime,
    TcxSchedulerRangeControlIntervalEventInfo>.Create;
end;
...
function TcxSchedulerRangeControlEventsCache.AddEvents(const AMin,
  AMax: TDateTime): TList<TColor>;
const
...
begin
  ...
  begin
    if FEventInfos.Count >= MaxCachedIntervalCount then
      ...
      begin
        AInfo := FTimeSortedEventInfos.First as
          TcxSchedulerRangeControlIntervalEventInfo;
    ...
    try
      ...
      begin
        AVisibleResourceCount := Storage.Resources.ResourceItems.
          VisibleResourceCount;
        AResourceIDs := VarArrayCreate([0, AVisibleResourceCount], varVariant);
        for I := 0 to AVisibleResourceCount - 1 do
          AResourceIDs[I] := Storage.Resources.ResourceItems.VisibleResources[I]
            .ResourceID;
...
function TcxSchedulerRangeControlEventsCache.GetEvents(const AMin,
  AMax: TDateTime): TList<TColor>;
var
  AInfo: TcxSchedulerRangeControlIntervalEventInfo;
begin
...
function TcxSchedulerRangeControlEventsCache.GetStorage
...
function TcxSchedulerRangeControlIntervalEventInfos.AddInfo
  : TcxSchedulerRangeControlIntervalEventInfo;
begin
...
procedure TcxSchedulerRangeControlIntervalEventInfos.MakeLast
  (AInfo: TcxSchedulerRangeControlIntervalEventInfo);
begin
  if FLast <> AInfo then
  begin
...
procedure TcxSchedulerRangeControlClientStyle.SetEventCounterTextColor
  (Value: TColor);
begin
...
dxRangeControlClients.Register(TcxSchedulerRangeControlClientProperties,
  'Scheduler');
