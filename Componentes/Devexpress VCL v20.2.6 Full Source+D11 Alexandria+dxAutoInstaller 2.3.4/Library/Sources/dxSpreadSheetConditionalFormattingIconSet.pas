...
type
  ...
  public
    ...
    constructor Create(const AName: string;
      AIndexes: array of Integer); overload;
  ...
  public
    function Add(const AName, ADescription: string;
      AIndexes: array of Integer): Integer;
    function FindByCount(const ACount: Integer;
      out APreset: TdxSpreadSheetConditionalFormattingIconSetPreset): Boolean;
    function FindByIconIndex(const AIconIndex: Integer;
      out APreset: TdxSpreadSheetConditionalFormattingIconSetPreset;
      out AIndexInPreset: Integer): Boolean;
...
function ConditionalFormattingIconSet
  : TdxSpreadSheetConditionalFormattingIconSet;
...
constructor TdxSpreadSheetConditionalFormattingIconSetPreset.Create
  (const AName: string);
begin
  inherited Create;
  FName := AName;
...
constructor TdxSpreadSheetConditionalFormattingIconSetPreset.Create
  (const AName: string; AIndexes: array of Integer);
var
  I: Integer;
begin
  Create(AName);
...
function TdxSpreadSheetConditionalFormattingIconSetPreset.IndexOf
  (IconIndex: Integer): Integer;
begin
  Result := FIconIndexes.IndexOf(IconIndex);
end;

function TdxSpreadSheetConditionalFormattingIconSetPreset.GetIconIndex
  (Index: Integer): Integer;
begin
  Result := FIconIndexes[Index];
end;

function TdxSpreadSheetConditionalFormattingIconSetPreset.
  GetIconIndexCount: Integer;
begin
...
function TdxSpreadSheetConditionalFormattingIconSetPresets.Add(const AName,
  ADescription: string; AIndexes: array of Integer): Integer;
var
  APreset: TdxSpreadSheetConditionalFormattingIconSetPreset;
begin
  APreset := TdxSpreadSheetConditionalFormattingIconSetPreset.Create(AName,
    AIndexes);
...
function TdxSpreadSheetConditionalFormattingIconSetPresets.FindByIconIndex
...
begin
  ...
  try
    ASmartImage.LoadFromResource(HInstance,
      'DXSPREADSHEET_CONDITIONAL_FORMATTING_ICONSET', 'PNG');
...
begin
  ...
  Presets.Add('3TrafficLights1', sdxIconSet3TrafficLights1Description,
    [11, 10, 9]);
  Presets.Add('3TrafficLights2', sdxIconSet3TrafficLights2Description,
    [15, 14, 13]);
  ...
  Presets.Add('4RedToBlack', sdxIconSet4RedToBlackDescription,
    [31, 30, 29, 28]);
  Presets.Add('4TrafficLights', sdxIconSet4TrafficLightsDescription,
    [12, 11, 10, 9]);
  Presets.Add('5Arrows', sdxIconSet5ArrowsDescription, [2, 25, 1, 24, 0]);
  Presets.Add('5ArrowsGray', sdxIconSet5ArrowsGrayDescription,
    [5, 27, 4, 26, 3]);
  Presets.Add('5Boxes', sdxIconSet5BoxesDescription, [51, 50, 49, 48, 47]);
  Presets.Add('5Quarters', sdxIconSet5QuartersDescription,
    [35, 34, 33, 32, 31]);
...
const
  ...
  var
    ...
    R: TRect;
  begin
    ABitmap := TcxBitmap32.CreateSize(FPresetPreviews.Width,
      FPresetPreviews.Height, True);
    try
...
function TdxSpreadSheetConditionalFormattingIconSet.GetPresetPreviews
  : TcxImageList;
begin
