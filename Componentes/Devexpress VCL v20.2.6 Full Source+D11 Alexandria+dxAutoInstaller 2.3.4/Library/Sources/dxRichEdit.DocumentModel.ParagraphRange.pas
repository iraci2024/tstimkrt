...
function TdxParagraphRun.Copy(ACopyManager: TdxCustomDocumentModelCopyManager)
  : TdxTextRunBase;
begin
...
procedure TdxParagraphRun.Export(const AExporter
...
function TdxParagraphRun.GetPlainText(ABuffer: TdxChunkedStringBuilder;
  AFrom, ATo: Integer): string;
begin
  Result := GetPlainText(ABuffer);
end;

function TdxParagraphRun.GetRawTextFast
...
procedure TdxParagraphRun.Measure(ABoxInfo: TdxBoxInfo;
  const AMeasurer: IdxObjectMeasurer);
begin
  TdxRichEditExceptions.ThrowInternalException;
end;

function TdxParagraphRun.TryAdjustEndPositionToFit(ABoxInfo: TdxBoxInfo;
