...
type
  ...
  protected
    ...
    property MergeDestination: TdxMergeDestination read GetMergeDestination
      write SetMergeDestination;
...
function TdxRichEditMergeOptionsDialogForm.GetController
...
begin
  ...
  rbMergeAllRecords.Caption := cxGetResourceString
    (@sdxRichEditMergeOptionsDialogMergeAllRecords);
  rbMergeSelectedRecords.Caption :=
    cxGetResourceString(@sdxRichEditMergeOptionsDialogMergeSelectedRecords);
  rbMergeToWindow.Caption := cxGetResourceString
    (@sdxRichEditMergeOptionsDialogMergeToWindow);
  rbMergeToFile.Caption := cxGetResourceString
    (@sdxRichEditMergeOptionsDialogMergeToFile);
  liMergeRecords.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditMergeOptionsDialogMergeRecords);
  liMergeTo.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditMergeOptionsDialogMergeTo);
end;
...
begin
  Result := TdxMergeOptionsFormController.Create
    (AControllerParameters as TdxMergeOptionsFormControllerParameters);
end;

function TdxRichEditMergeOptionsDialogForm.GetMergeDestination
  : TdxMergeDestination;
begin
...
procedure TdxRichEditMergeOptionsDialogForm.rbMergeRecordsClick
  (Sender: TObject);
begin
...
procedure TdxRichEditMergeOptionsDialogForm.SetMergeDestination
  (const Value: TdxMergeDestination);
begin
...
procedure TdxRichEditMergeOptionsDialogForm.SetMergeRecords
