...
function TcxGridTableViewStorage.GetOptionsBehavior
  : TcxGridTableOptionsBehavior;
begin
  Result := TableView.OptionsBehavior;
end;

function TcxGridTableViewStorage.GetOptionsCustomize
...
function TcxGridTableViewStorage.GetOptionsSelection
...
begin
  if GridView.OptionsBehavior.EditMode <> emInplace then
    Items.AddItem('Customize Edit Form Layout...',
      ShowInplaceEditFormCustomizationForm);
...
procedure TcxGridTableViewMenuProvider.ShowRowLayoutCustomizationForm
  (Sender: TcxGridViewMenuItem);
begin
