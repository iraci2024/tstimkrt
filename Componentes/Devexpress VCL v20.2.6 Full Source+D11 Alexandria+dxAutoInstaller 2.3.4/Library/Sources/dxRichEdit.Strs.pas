...
resourcestring
  ...
  sdxRichEditFileFilterDescription_HtmlFiles =
  ...
  sdxRichEditConfirmSaveDocumentWithPasswordProtection =
    'This document is password protected. Saving it in a format ' +
...
procedure AddRichEditResourceStringNames(AProduct: TdxProductResourceStrings);
begin
  AProduct.Add('sdxRichEditFileFilterDescription_AllFiles',
    @sdxRichEditFileFilterDescription_AllFiles);
  AProduct.Add('sdxRichEditFileFilterDescription_RtfFiles',
    @sdxRichEditFileFilterDescription_RtfFiles);
  AProduct.Add('sdxRichEditFileFilterDescription_OpenXmlFiles',
    @sdxRichEditFileFilterDescription_OpenXmlFiles);
  AProduct.Add('sdxRichEditFileFilterDescription_TextFiles',
    @sdxRichEditFileFilterDescription_TextFiles);
  AProduct.Add('sdxRichEditFileFilterDescription_HtmlFiles',
    @sdxRichEditFileFilterDescription_HtmlFiles);
  AProduct.Add('sdxRichEditFileFilterDescription_DocFiles',
    @sdxRichEditFileFilterDescription_DocFiles);

  AProduct.Add('sdxRichEditFileFilterDescription_BitmapFiles',
    @sdxRichEditFileFilterDescription_BitmapFiles);
  AProduct.Add('sdxRichEditFileFilterDescription_JPEGFiles',
    @sdxRichEditFileFilterDescription_JPEGFiles);
  AProduct.Add('sdxRichEditFileFilterDescription_PNGFiles',
    @sdxRichEditFileFilterDescription_PNGFiles);
  AProduct.Add('sdxRichEditFileFilterDescription_GifFiles',
    @sdxRichEditFileFilterDescription_GifFiles);
  AProduct.Add('sdxRichEditFileFilterDescription_TiffFiles',
    @sdxRichEditFileFilterDescription_TiffFiles);
  AProduct.Add('sdxRichEditFileFilterDescription_EmfFiles',
    @sdxRichEditFileFilterDescription_EmfFiles);
  AProduct.Add('sdxRichEditFileFilterDescription_WmfFiles',
    @sdxRichEditFileFilterDescription_WmfFiles);
  AProduct.Add('sdxCurrentDocumentHyperlinkTooltip',
    @sdxCurrentDocumentHyperlinkTooltip);

  AProduct.Add('sdxRichEditCaption_PageHeader', @sdxRichEditCaption_PageHeader);
  AProduct.Add('sdxRichEditCaption_FirstPageHeader',
    @sdxRichEditCaption_FirstPageHeader);
  AProduct.Add('sdxRichEditCaption_OddPageHeader',
    @sdxRichEditCaption_OddPageHeader);
  AProduct.Add('sdxRichEditCaption_EvenPageHeader',
    @sdxRichEditCaption_EvenPageHeader);
  AProduct.Add('sdxRichEditCaption_PageFooter', @sdxRichEditCaption_PageFooter);
  AProduct.Add('sdxRichEditCaption_FirstPageFooter',
    @sdxRichEditCaption_FirstPageFooter);
  AProduct.Add('sdxRichEditCaption_OddPageFooter',
    @sdxRichEditCaption_OddPageFooter);
  AProduct.Add('sdxRichEditCaption_EvenPageFooter',
    @sdxRichEditCaption_EvenPageFooter);
  AProduct.Add('sdxRichEditCaption_SameAsPrevious',
    @sdxRichEditCaption_SameAsPrevious);
  ...
  AProduct.Add('sdxRichEditCaptionUnitCentimeters',
    @sdxRichEditCaptionUnitCentimeters);
  AProduct.Add('sdxRichEditCaptionUnitMillimeters',
  ...
  AProduct.Add('sdxRichEditConfirmSaveDocumentWithPasswordProtection',
    @sdxRichEditConfirmSaveDocumentWithPasswordProtection);
end;
...
dxResourceStringsRepository.RegisterProduct(dxRichEditProductName,
  @AddRichEditResourceStringNames);
