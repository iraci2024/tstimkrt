...
type
  ...
  public
    constructor Create(const AFileName: string; AStream: TStream;
      AStreamLength: Integer);
    destructor Destroy; override;
    function GetMemoryStream(AOwnerStreamList: TdxFastObjectList)
      : TMemoryStream;
...
constructor TdxPackageFile.Create(const AFileName: string; AStream: TStream;
  AStreamLength: Integer);
begin
  Assert(AFileName <> '');
  Assert(AStream <> nil);
...
function TdxPackageFile.GetMemoryStream(AOwnerStreamList: TdxFastObjectList)
  : TMemoryStream;
begin
