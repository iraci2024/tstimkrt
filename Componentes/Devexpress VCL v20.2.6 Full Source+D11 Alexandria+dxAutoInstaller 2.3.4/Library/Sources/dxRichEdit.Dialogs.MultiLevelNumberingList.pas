...
uses
  ...
  dxCore, cxClasses, cxGraphics, cxControls, cxLookAndFeels, cxLabel, cxButtons,
  dxLayoutControl, cxListBox,
  cxLookAndFeelPainters, cxContainer, cxEdit, dxLayoutControlAdapters,
  dxLayoutcxEditAdapters,
  dxLayoutContainer, cxSpinEdit, dxMeasurementUnitEdit, cxTextEdit, cxMaskEdit,
  cxDropDownEdit, dxLayoutLookAndFeels,
...
type
  TdxRichEditMultiLevelNumberingListDialogForm = class
    (TdxRichEditCustomSimpleNumberingListForm)
  ...
  public
    property Controller: TdxMultiLevelNumberingListFormController
      read GetController;
  end;
...
function TdxRichEditMultiLevelNumberingListDialogForm.GetController
...
begin
  ...
  lblNumberFormat.Caption :=
    StripHotkey(cxGetResourceString
    (@sdxRichEditCustomNumberingListNumberFormat));
  lciDisplayFormat.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditCustomNumberingListDisplayFormat);
  lciLevel.CaptionOptions.Text := cxGetResourceString
    (@sdxRichEditMultiLevelNumberingListDialogLevel);
  lcilFollowNumberWith.CaptionOptions.Text :=
    cxGetResourceString
...
procedure TdxRichEditMultiLevelNumberingListDialogForm.ChangeFocus
...
procedure TdxRichEditMultiLevelNumberingListDialogForm.
  FollowNumberSelectedIndexChanged(Sender: TObject);
begin
  case cmbFollowNumber.ItemIndex of
    0:
      Controller.Separator := TdxCharacters.TabMark;
    1:
      Controller.Separator := ' ';
    2:
      Controller.Separator := #$0000;
  end;
end;

procedure TdxRichEditMultiLevelNumberingListDialogForm.LevelSelectedIndexChanged
  (Sender: TObject);
var
  AIndex: Integer;
begin
