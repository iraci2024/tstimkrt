...
type
  ...
  TcxSchedulerGridConnectionGridPopupMenuEventsProperty = class
...
function TcxSchedulerGridConnectionGridPopupMenuEventsProperty.GetInstance
  : TPersistent;
begin
...
begin
  ...
  RegisterComponentEditor(TcxSchedulerGridConnection,
    cxSchedulerComponentEditor);
