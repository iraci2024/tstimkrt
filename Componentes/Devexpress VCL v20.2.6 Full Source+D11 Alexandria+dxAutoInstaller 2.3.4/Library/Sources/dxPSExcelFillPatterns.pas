...
const
  Bits: TdxPSPatternBitRows = ($1111, $4444, $1111, $4444, $1111, $4444,
    $1111, $4444);
begin
  APattern := Bits;
end;
...
const
  Bits: TdxPSPatternBitRows = ($EEEE, $BBBB, $EEEE, $BBBB, $EEEE, $BBBB,
    $EEEE, $BBBB);
begin
  APattern := Bits;
end;
...
const
  Bits: TdxPSPatternBitRows = ($FFFF, $EEEE, $FFFF, $BBBB, $FFFF, $EEEE,
    $FFFF, $BBBB);
begin
  APattern := Bits;
end;
...
const
  Bits: TdxPSPatternBitRows = ($FFFF, $FBFB, $FFFF, $BFBF, $FFFF, $FBFB,
    $FFFF, $BFBF);
begin
  APattern := Bits;
end;
...
class procedure TdxPSHorizontalStripeFillPattern.Bits
  (var APattern: TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($0000, $0000, $FFFF, $FFFF, $0000, $0000,
    $FFFF, $FFFF);
begin
  APattern := Bits;
end;
...
class procedure TdxPSVerticalStripeFillPattern.Bits(var APattern
  : TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($9999, $9999, $9999, $9999, $9999, $9999,
    $9999, $9999);
begin
  APattern := Bits;
end;
...
class procedure TdxPSReverseDiagonalStripeFillPattern.Bits
  (var APattern: TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($CCCC, $6666, $3333, $9999, $CCCC, $6666,
    $3333, $9999);
begin
  APattern := Bits;
end;
...
class procedure TdxPSDiagonalStripeFillPattern.Bits(var APattern
  : TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($CCCC, $9999, $3333, $6666, $CCCC, $9999,
    $3333, $6666);
begin
  APattern := Bits;
end;
...
class procedure TdxPSDiagonalCrossHatchFillPattern.Bits
  (var APattern: TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($CCCC, $CCCC, $3333, $3333, $CCCC, $CCCC,
    $3333, $3333);
begin
  APattern := Bits;
end;
...
class procedure TdxPSThickCrossHatchFillPattern.Bits(var APattern
  : TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($CCCC, $0000, $3333, $0000, $CCCC, $0000,
    $3333, $0000);
begin
  APattern := Bits;
end;
...
class procedure TdxPSThinHorizontalStripeFillPattern.Bits
  (var APattern: TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($0000, $FFFF, $FFFF, $FFFF, $0000, $FFFF,
    $FFFF, $FFFF);
begin
  APattern := Bits;
end;
...
class procedure TdxPSThinVerticalStripeFillPattern.Bits
  (var APattern: TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($BBBB, $BBBB, $BBBB, $BBBB, $BBBB, $BBBB,
    $BBBB, $BBBB);
begin
  APattern := Bits;
end;
...
class procedure TdxPSThinReverseDiagonalStripeFillPattern.Bits
  (var APattern: TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($DDDD, $EEEE, $7777, $BBBB, $DDDD, $EEEE,
    $7777, $BBBB);
begin
  APattern := Bits;
end;
...
class procedure TdxPSThinDiagonalStripeFillPattern.Bits
  (var APattern: TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($EEEE, $DDDD, $BBBB, $7777, $EEEE, $DDDD,
    $BBBB, $7777);
begin
  APattern := Bits;
end;
...
class procedure TdxPSThinHorizontalCrossHatchFillPattern.Bits
  (var APattern: TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($0000, $BBBB, $BBBB, $BBBB, $0000, $BBBB,
    $BBBB, $BBBB);
begin
  APattern := Bits;
end;
...
class procedure TdxPSThinDiagonalCrossHatchFillPattern.Bits
  (var APattern: TdxPSPatternBitRows);
const
  Bits: TdxPSPatternBitRows = ($BBBB, $5555, $EEEE, $5555, $BBBB, $5555,
    $EEEE, $5555);
begin
  APattern := Bits;
end;
