...
uses
  ...
  cxMemo, dxSpellChecker,
  dxSpellCheckerBaseForm, cxGraphics, cxLookAndFeels, dxLayoutcxEditAdapters,
...
constructor TdxCustomDictionaryForm.CreateEx(ADictionary
...
constructor TfmCustomDictionaryForm.CreateEx(ADictionary
  : TdxUserSpellCheckerDictionary);
begin
