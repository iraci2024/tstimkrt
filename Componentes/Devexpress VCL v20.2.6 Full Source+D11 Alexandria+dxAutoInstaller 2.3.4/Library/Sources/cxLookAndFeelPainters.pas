...
{$ENDIF}
  ...
  Controls, ImgList,
  dxCoreGraphics, dxOffice11, cxClasses, cxGraphics, cxGeometry,
  dxGDIPlusClasses, cxCustomCanvas, dxThemeConsts;
...
type
  ...
  TcxGroupBoxCaptionPosition = (cxgpTop, cxgpBottom, cxgpLeft, cxgpRight,
    cxgpCenter);
  TcxNeighbor = (nLeft, nTop, nRight, nBottom);
  TcxNeighbors = set of TcxNeighbor;
  TcxScrollBarPart = (sbpNone, sbpLineUp, sbpLineDown, sbpThumbnail, sbpPageUp,
    sbpPageDown);
  ...
  TdxBreadcrumbEditButtonState = (dxbcbsNormal, dxbcbsFocused, dxbcbsHot,
    dxbcbsPressed, dxbcbsDisabled);
  ...
  TcxButtonState = (cxbsDefault, cxbsNormal, cxbsHot, cxbsPressed,
    cxbsDisabled);
  ...
  TdxListViewItemState = (dxlisFocused, dxlisHot, dxlisSelected, dxlisDisabled,
    dxlisInactive);
  TdxListViewItemStates = set of TdxListViewItemState;
  TdxListViewGroupHeaderState = (dxlgsFocused, dxlgsHot, dxlgsCollapsed,
    dxlgsInactive);
  ...
  TcxEditStateColorKind = (esckNormal, esckDisabled, esckInactive,
    esckReadOnly);
  ...
  TcxIndicatorKind = (ikNone, ikArrow, ikEdit, ikInsert, ikMultiDot,
    ikMultiArrow, ikFilter, ikInplaceEdit);
  TdxAlertWindowButtonKind = (awbkClose, awbkPin, awbkDropdown, awbkPrevious,
    awbkNext, awbkCustom);
  TcxFilterSmartTagState = (fstsNormal, fstsHot, fstsPressed, fstsParentHot);
  TdxMapControlElementState = (mcesNormal, mcesHot, mcesPressed, mcesSelected,
    mcesDisabled);
  TdxMapControlElementStates = set of TdxMapControlElementState;
  TcxCalendarElementState = (cesNormal, cesHot, cesPressed, cesSelected,
    cesFocused, cesMarked, cesDisabled);
  ...
  TcxDrawBackgroundEvent = function(ACanvas: TcxCanvas; const ABounds: TRect)
    : Boolean of object;
  TdxDrawEvent = procedure(ACanvas: TcxCanvas; const ARect: TRect) of object;
  TdxDrawScaledRectEvent = procedure(ACanvas: TcxCanvas; const ARect: TRect;
    AScaleFactor: TdxScaleFactor) of object;

  IcxLookAndFeelPainterListener = interface
    ['{DCEF5205-2C4B-48B9-2861-A5490E7EA468}']
  ...
  strict private
    ...
    function GetRangeTrackBarThumbDrawRect(const R: TRect;
      ATicks: TcxTrackBarTicksAlign; AHorizontal: Boolean): TRect;
  ...
  protected
    ...
    procedure DoDrawScaledScrollBarPart(ACanvas: TcxCustomCanvas;
    ...
    procedure DrawBackground(ACanvas: TcxCanvas; const ARect: TRect;
      ...
      const ABackgroundBitmap: TBitmap); virtual;
    procedure DrawButtonArrow(ACanvas: TcxCanvas; const R: TRect;
      AColor: TColor); virtual;
    procedure DrawContent(ACanvas: TcxCanvas;
      const ABounds, ATextAreaBounds: TRect; AState: TcxButtonState;
    ...
    procedure DrawListViewColumnHeaderSortingArrow(ACanvas: TcxCustomCanvas;
    ...
    procedure DrawMonthHeaderLeftArrow(ACanvas: TcxCanvas; const ABounds: TRect;
      AColor: TColor);
    procedure DrawMonthHeaderRightArrow(ACanvas: TcxCanvas;
    ...
    procedure DrawSchedulerNavigationButtonContent(ACanvas: TcxCanvas;
      ...
      AState: TcxButtonState; const AIsVertical: Boolean = True); virtual;
    ...
    function GetArrowDirection(AHorizontal: Boolean; APart: TcxScrollBarPart)
      : TcxArrowDirection;
    function GetFilterAddButtonColor(AState: TcxButtonState)
      : TdxAlphaColor; virtual;
    function GetFilterRemoveButtonColor(AState: TcxButtonState)
      : TdxAlphaColor; virtual;
    function GetFilterSmartTagColor(AState: TcxFilterSmartTagState;
      AIsFilterActive: Boolean): TColor; virtual;
    function GetSeparatorBounds(const R: TRect; AWidth: Integer;
      AIsVertical: Boolean): TRect; virtual;
    ...
    property FilterControlAddButtonGlyph: TdxSmartImage
      read GetFilterControlAddButtonGlyph;
    property FilterControlRemoveButtonGlyph: TdxSmartImage
      read GetFilterControlRemoveButtonGlyph;
    property FilterPanelRemoveButtonGlyph: TdxSmartImage
      read GetFilterPanelRemoveButtonGlyph;
    property FindPanelNextButtonGlyph: TdxSmartImage
      read GetFindPanelNextButtonGlyph;
    property FindPanelPreviousButtonGlyph: TdxSmartImage
      read GetFindPanelPreviousButtonGlyph;
    property FixedGroupIndicator: TdxSmartImage read GetFixedGroupIndicator;
    property GroupByBoxSearchButtonGlyph: TdxSmartImage
      read GetGroupByBoxSearchButtonGlyph;
    property MapPushpin: TdxSmartImage read GetMapPushpin;
    property NavigationBarCustomizationButton: TdxSmartImage
      read GetNavigationBarCustomizationButton;
    property PasswordRevealButtonGlyphs[Index: Boolean]: TdxSmartImage
      read GetPasswordRevealButtonGlyphs;
    property RatingControlIndicator: TdxSmartImage
      read GetRatingControlIndicator;
  ...
  public
    ...
    function DefaultEditorBackgroundColor(AIsDisabled: Boolean)
      : TColor; virtual;
    ...
    function DefaultSchedulerDateNavigatorArrowColor(AIsHighlight: Boolean)
      : TColor; virtual;
    function DefaultSchedulerHeaderContainerAlternateBackgroundColor
      : TColor; virtual;
    function DefaultSchedulerHeaderContainerBackgroundColor(ASelected: Boolean)
      : TColor; virtual;
    ...
    // LayoutView
    function DefaultLayoutViewCaptionColor(AState: TcxButtonState)
      : TColor; virtual;
    function DefaultLayoutViewCaptionTextColor(ACaptionPosition
      : TcxGroupBoxCaptionPosition; AState: TcxButtonState): TColor; virtual;
    ...
    // Arrow
    procedure CalculateArrowPoints(R: TRect; var P: TcxArrowPoints;
      AArrowDirection: TcxArrowDirection; AProportional: Boolean;
      AArrowSize: Integer = 0);
    procedure DrawArrow(ACanvas: TcxCustomCanvas; const R: TRect;
      AArrowDirection: TcxArrowDirection; AColor: TColor); overload; virtual;
    procedure DrawArrow(ACanvas: TcxCustomCanvas; const R: TRect;
      AState: TcxButtonState; AArrowDirection: TcxArrowDirection;
      ADrawBorder: Boolean = True); overload;
    procedure DrawArrowBorder(ACanvas: TcxCustomCanvas; const R: TRect;
      AState: TcxButtonState);
    procedure DrawCollapseArrow(ACanvas: TcxCanvas; R: TRect; AColor: TColor;
      ALineWidth: Integer = 1); virtual;
    procedure DrawScaledArrow(ACanvas: TcxCustomCanvas; const R: TRect;
      AState: TcxButtonState; AArrowDirection: TcxArrowDirection;
      AScaleFactor: TdxScaleFactor; ADrawBorder: Boolean = True);
      overload; virtual;
    procedure DrawScaledArrowBorder(ACanvas: TcxCustomCanvas; const R: TRect;
      AState: TcxButtonState; AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawScaledScrollBarArrow(ACanvas: TcxCustomCanvas; R: TRect;
      AState: TcxButtonState; AArrowDirection: TcxArrowDirection;
      AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawScrollBarArrow(ACanvas: TcxCanvas; R: TRect;
      AState: TcxButtonState; AArrowDirection: TcxArrowDirection);

    // Border
    function BorderSize: Integer; virtual;
    function SeparatorSize: Integer; virtual;
    procedure DrawBorder(ACanvas: TcxCustomCanvas; R: TRect); virtual;
    ...
    procedure DoDrawSeparator(ACanvas: TcxCanvas; R: TRect;
      AIsVertical: Boolean); virtual;
    procedure DrawSeparator(ACanvas: TcxCanvas; const R: TRect;
      AIsVertical: Boolean);

    // Pin
    procedure DrawPin(ACanvas: TcxCanvas; const ABounds: TRect; AColor: TColor;
      APinned: Boolean);

    // Buttons
    function ButtonBorderSize(AState: TcxButtonState = cxbsNormal): Integer;
      virtual; // abstract;
    ...
    function ScaledButtonFocusRect(ACanvas: TcxCanvas; R: TRect;
      AScaleFactor: TdxScaleFactor): TRect; virtual;
    function ScaledButtonTextOffset(AScaleFactor: TdxScaleFactor): Integer;
      virtual; // abstract;
    function ScaledButtonTextShift(AScaleFactor: TdxScaleFactor): Integer;
      virtual; // abstract;
    ...
    procedure DrawButtonBorder(ACanvas: TcxCustomCanvas; R: TRect;
      AState: TcxButtonState); virtual; // abstract;
    procedure DrawButtonCross(ACanvas: TcxCanvas; const R: TRect;
      AColor: TColor; AState: TcxButtonState); overload;
    procedure DrawButtonCross(ACanvas: TcxCanvas; const R: TRect;
      AColor: TColor; AState: TcxButtonState; ASize: Integer); overload;
    procedure DrawScaledButton(ACanvas: TcxCustomCanvas; R: TRect;
      AState: TcxButtonState; AScaleFactor: TdxScaleFactor;
      APart: TcxButtonPart; AColor: TColor = clDefault); overload;
    procedure DrawScaledButton(ACanvas: TcxCustomCanvas; R: TRect;
      AState: TcxButtonState; AScaleFactor: TdxScaleFactor;
      ADrawBorder: Boolean = True; AIsToolButton: Boolean = False;
      APart: TcxButtonPart = cxbpButton; AColor: TColor = clDefault);
      overload; virtual;
    procedure DrawScaledButton(ACanvas: TcxCanvas; R: TRect;
      const ACaption: string; AState: TcxButtonState;
      AScaleFactor: TdxScaleFactor; ADrawBorder: Boolean = True;
      AColor: TColor = clDefault; ATextColor: TColor = clDefault;
      AWordWrap: Boolean = False; AIsToolButton: Boolean = False;
      APart: TcxButtonPart = cxbpButton); overload;
    procedure DrawScaledButtonCross(ACanvas: TcxCanvas; const R: TRect;
      AColor: TColor; AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
    procedure DrawScaledButtonCrossEx(ACanvas: TcxCanvas; const R: TRect;
      AColor: TColor; AState: TcxButtonState; ASize: Integer;
      AScaleFactor: TdxScaleFactor);
    ...
    procedure DrawScaledDropDownButtonArrow(ACanvas: TcxCustomCanvas; R: TRect;
      AState: TcxButtonState; AScaleFactor: TdxScaleFactor;
      AColor: TColor = clDefault); virtual;
    procedure DrawScaledSearchEditButtonGlyph(ACanvas: TcxCanvas; R: TRect;
      AState: TcxButtonState; AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawScaledPasswordRevealButton(ACanvas: TcxCanvas;
      const ARect: TRect; AButtonState: TcxButtonState; AColor: TColor;
      AScaleFactor: TdxScaleFactor);
    procedure DrawSearchEditButtonGlyph(ACanvas: TcxCanvas; R: TRect;
      AState: TcxButtonState);
    ...
    function IsPointOverGroupExpandButton(const R: TRect; const P: TPoint)
      : Boolean; virtual;
    function ScaledSearchButtonGlyphSize(AScaleFactor: TdxScaleFactor)
      : TSize; virtual;
    ...
    procedure DrawExpandMark(ACanvas: TcxCanvas; const R: TRect; AColor: TColor;
      AExpanded: Boolean);
    ...
    procedure DrawScaledExpandButtonEx(ACanvas: TcxCanvas; const R: TRect;
      ...
      ARotationAngle: TcxRotationAngle = ra0); overload; virtual;
    procedure DrawScaledExpandMark(ACanvas: TcxCanvas; const R: TRect;
      AColor: TColor; AExpanded: Boolean;
      AScaleFactor: TdxScaleFactor); virtual;
    ...
    procedure DrawScaledSmallExpandButton(ACanvas: TcxCanvas; R: TRect;
      ...
      AColor: TColor = clDefault); virtual;
    procedure DrawSmallExpandButton(ACanvas: TcxCanvas; R: TRect;
    ...
    function ScaledExpandButtonAreaSize(AScaleFactor: TdxScaleFactor)
      : Integer; virtual;
    function ScaledExpandButtonSize(AScaleFactor: TdxScaleFactor): Integer;
      virtual; abstract;
    function ScaledGroupExpandButtonSize(AScaleFactor: TdxScaleFactor)
      : Integer; virtual;
    function ScaledSmallExpandButtonSize(AScaleFactor: TdxScaleFactor)
      : Integer; virtual;

    // CommandLink
    function DefaultCommandLinkTextColor(AState: TcxButtonState;
      ADefaultColor: TColor = clDefault): TColor; virtual;
    procedure DrawCommandLinkBackground(ACanvas: TcxCanvas; R: TRect;
      AState: TcxButtonState; AColor: TColor = clDefault);
    procedure DrawCommandLinkGlyph(ACanvas: TcxCanvas; const AGlyphPos: TPoint;
      AState: TcxButtonState);
    procedure DrawScaledCommandLinkBackground(ACanvas: TcxCanvas; R: TRect;
      AState: TcxButtonState; AScaleFactor: TdxScaleFactor;
      AColor: TColor = clDefault); virtual;
    procedure DrawScaledCommandLinkGlyph(ACanvas: TcxCanvas;
      const AGlyphPos: TPoint; AState: TcxButtonState;
      AScaleFactor: TdxScaleFactor); virtual;
    function GetCommandLinkGlyphSize: TSize;
    function GetCommandLinkMargins: TRect;
    function GetScaledCommandLinkGlyphSize(AScaleFactor: TdxScaleFactor)
      : TSize; virtual;
    function GetScaledCommandLinkMargins(AScaleFactor: TdxScaleFactor)
      : TRect; virtual;
    ...
    procedure DrawHeaderEx(ACanvas: TcxCanvas;
      const ABounds, ATextAreaBounds: TRect; ANeighbors: TcxNeighbors;
      ABorders: TcxBorders; AState: TcxButtonState; AAlignmentHorz: TAlignment;
      AAlignmentVert: TcxAlignmentVert; AMultiLine, AShowEndEllipsis: Boolean;
      const AText: string; AFont: TFont; ATextColor, ABkColor: TColor;
    ...
    procedure DrawHeaderControlSection(ACanvas: TcxCanvas;
      const ABounds, ATextAreaBounds: TRect; ANeighbors: TcxNeighbors;
      ABorders: TcxBorders; AState: TcxButtonState; AAlignmentHorz: TAlignment;
      AAlignmentVert: TcxAlignmentVert; AMultiLine, AShowEndEllipsis: Boolean;
      const AText: string; AFont: TFont; ATextColor, ABkColor: TColor);
    ...
    procedure DrawHeaderControlSectionContent(ACanvas: TcxCanvas;
      const ABounds, ATextAreaBounds: TRect; AState: TcxButtonState;
      AAlignmentHorz: TAlignment; AAlignmentVert: TcxAlignmentVert;
      AMultiLine, AShowEndEllipsis: Boolean; const AText: string; AFont: TFont;
    ...
    procedure DrawScaledHeader(ACanvas: TcxCustomCanvas; const ABounds: TRect;
      ...
      AIsGroup: Boolean = False); overload; virtual;
    ...
    procedure DrawScaledHeaderEx(ACanvas: TcxCanvas;
      ...
      const AText: string; AFont: TFont; ATextColor, ABkColor: TColor;
      AScaleFactor: TdxScaleFactor;
      AOnDrawBackground: TcxDrawBackgroundEvent = nil); overload; virtual;
    procedure DrawScaledHeaderControlSection(ACanvas: TcxCanvas;
      const ABounds, ATextAreaBounds: TRect; ANeighbors: TcxNeighbors;
      ABorders: TcxBorders; AState: TcxButtonState; AAlignmentHorz: TAlignment;
      AAlignmentVert: TcxAlignmentVert; AMultiLine, AShowEndEllipsis: Boolean;
      const AText: string; AFont: TFont; ATextColor, ABkColor: TColor;
      AScaleFactor: TdxScaleFactor); overload; virtual;
    ...
    function HeaderContentBounds(const ABounds: TRect;
      ABorders: TcxBorders): TRect;
    function HeaderContentOffsets(AScaleFactor: TdxScaleFactor): TRect; virtual;
    function HeaderControlSectionBorderSize(AState: TcxButtonState = cxbsNormal)
      : Integer; virtual;
    ...
    function ScaledHeaderContentBounds(const ABounds: TRect;
      ABorders: TcxBorders; AScaleFactor: TdxScaleFactor): TRect; virtual;
    function ScaledHeaderHeight(AFontHeight: Integer;
      AScaleFactor: TdxScaleFactor): Integer; virtual;
    function ScaledHeaderWidth(ACanvas: TcxCanvas; ABorders: TcxBorders;
      const AText: string; AFont: TFont; AScaleFactor: TdxScaleFactor)
      : Integer; virtual;
    ...
    procedure DrawScaledSummaryValueSortingMark(ACanvas: TcxCanvas;
      ...
      AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawSortingMark(ACanvas: TcxCanvas; const R: TRect;
      AAscendingSorting: Boolean);
    procedure DrawSummarySortingMark(ACanvas: TcxCanvas; const R: TRect;
      AAscendingSorting: Boolean);
    procedure DrawSummaryValueSortingMark(ACanvas: TcxCanvas; const R: TRect;
      AAscendingSorting: Boolean);
    ...
    function ScaledSortingMarkAreaSize(AScaleFactor: TdxScaleFactor)
      : TPoint; virtual;
    function ScaledSortingMarkSize(AScaleFactor: TdxScaleFactor): TPoint;
      virtual; abstract;
    function ScaledSummarySortingMarkSize(AScaleFactor: TdxScaleFactor): TPoint;
      virtual; abstract;
    function ScaledSummaryValueSortingMarkSize(AScaleFactor: TdxScaleFactor)
      : TPoint; overload; virtual;
    ...
    procedure DrawGroupByBox(ACanvas: TcxCanvas; const ARect: TRect;
      ATransparent: Boolean; ABackgroundColor: TColor;
      const ABackgroundBitmap: TBitmap); virtual;
    procedure DrawScaledFindPanelNextButtonGlyph(ACanvas: TcxCanvas;
      const ARect: TRect; const AState: TcxButtonState;
      AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawScaledFindPanelPreviousButtonGlyph(ACanvas: TcxCanvas;
      const ARect: TRect; const AState: TcxButtonState;
      AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawScaledGroupByBoxSearchButtonGlyph(ACanvas: TcxCanvas;
      const ARect: TRect; const AState: TcxButtonState;
      AScaleFactor: TdxScaleFactor); virtual;
    ...
    procedure LayoutViewDrawRecordBorder(ACanvas: TcxCanvas;
    ...
    procedure LayoutViewDrawRecordContent(ACanvas: TcxCanvas;
      ...
      AState: TcxButtonState; ABorders: TcxBorders = cxBordersAll); virtual;
    ...
    function LayoutViewRecordCaptionTailSize(ACaptionPosition
      : TcxGroupBoxCaptionPosition): Integer; virtual;
    function LayoutViewRecordCaptionTextBold: Boolean; virtual;

    // WinExplorer View
    function WinExplorerViewDefaultRecordColor(AState: TcxButtonState)
      : TColor; virtual;
    ...
    procedure WinExplorerViewDrawRecord(ACanvas: TcxCanvas;
      ...
      const ABitmap: TBitmap = nil); virtual;
    procedure WinExplorerViewDrawRecordExpandButton(ACanvas: TcxCanvas;
      const ABounds: TRect; AState: TcxButtonState; AExpanded: Boolean);
    ...
    function WinExplorerViewRecordTextColor(AState: TcxButtonState)
      : TColor; virtual;
    function WinExplorerViewScaledExpandButtonSize(AScaleFactor: TdxScaleFactor)
    ...
    procedure DrawFooterCellContent(ACanvas: TcxCanvas; const ABounds: TRect;
      ...
      ATextColor, ABkColor: TColor;
      AOnDrawBackground: TcxDrawBackgroundEvent = nil); virtual;
    procedure DrawFooterBorder(ACanvas: TcxCanvas; const R: TRect); virtual;
    // abstract;
    procedure DrawFooterBorderEx(ACanvas: TcxCanvas; const R: TRect;
      ABorders: TcxBorders); virtual;
    procedure DrawFooterCellBorder(ACanvas: TcxCanvas; const R: TRect); virtual;
    // abstract;
    ...
    // Filter
    procedure DrawFilterActivateButton(ACanvas: TcxCanvas; R: TRect;
      AState: TcxButtonState; AChecked: Boolean);
    procedure DrawFilterCloseButton(ACanvas: TcxCanvas; R: TRect;
      AState: TcxButtonState);
    procedure DrawFilterDropDownButton(ACanvas: TcxCanvas; R: TRect;
      AState: TcxButtonState; AIsFilterActive: Boolean);
    procedure DrawFilterPanel(ACanvas: TcxCanvas; const ARect: TRect;
      ATransparent: Boolean; ABackgroundColor: TColor;
      const ABackgroundBitmap: TGraphic); virtual;
    procedure DrawFilterSmartTag(ACanvas: TcxCanvas; R: TRect;
      AState: TcxFilterSmartTagState; AIsFilterActive: Boolean);
    procedure DrawScaledFilterActivateButton(ACanvas: TcxCanvas; R: TRect;
    ...
    procedure DrawScaledFilterDropDownButton(ACanvas: TcxCanvas; R: TRect;
      AState: TcxButtonState; AIsFilterActive: Boolean;
      AScaleFactor: TdxScaleFactor); virtual; abstract;
    ...
    function ScaledFilterCloseButtonSize(AScaleFactor: TdxScaleFactor)
      : TPoint; virtual;
    function ScaledFilterDropDownButtonSize(AScaleFactor: TdxScaleFactor)
      : TPoint; virtual;
    ...
    procedure DrawScaledFilterBoolOperatorBackground(ACanvas: TcxCanvas;
      ...
      AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawScaledFilterControlAddButtonGlyph(ACanvas: TcxCanvas;
      const R: TRect; AState: TcxButtonState;
      AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawScaledFilterControlRemoveButtonGlyph(ACanvas: TcxCanvas;
      const R: TRect; AState: TcxButtonState;
      AScaleFactor: TdxScaleFactor); virtual;
    ...
    procedure DrawScaledFilterPanelBrackets(ACanvas: TcxCanvas; const R: TRect;
      AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawScaledFilterPanelRemoveButtonGlyph(ACanvas: TcxCanvas;
      const R: TRect; AState: TcxButtonState;
      AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawScaledFilterPanelRemovingArea(ACanvas: TcxCanvas;
      const R: TRect; AScaleFactor: TdxScaleFactor); virtual;
    ...
    procedure GetScaledFilterTokenParams(out AParams: TdxFilterTokenParams;
      AScaleFactor: TdxScaleFactor); virtual; // for internal use only
    ...
    procedure DrawTab(ACanvas: TcxCanvas; R: TRect; ABorders: TcxBorders;
      const AText: string; AState: TcxButtonState; AVertical: Boolean;
      AFont: TFont; ATextColor, ABkColor: TColor;
      AShowPrefix: Boolean = False); virtual;
    procedure DrawTabBorder(ACanvas: TcxCanvas; R: TRect; ABorder: TcxBorder;
      ABorders: TcxBorders; AVertical: Boolean); virtual; // abstract;
    procedure DrawTabsRoot(ACanvas: TcxCanvas; const R: TRect;
      ABorders: TcxBorders; AVertical: Boolean); virtual; // abstract;
    ...
    // Indicator
    procedure DrawIndicatorCustomizationMark(ACanvas: TcxCanvas; const R: TRect;
      AColor: TColor);
    procedure DrawIndicatorImage(ACanvas: TcxCanvas; const R: TRect;
      AKind: TcxIndicatorKind);
    procedure DrawIndicatorItem(ACanvas: TcxCanvas;
      const R, AImageAreaBounds: TRect; AKind: TcxIndicatorKind; AColor: TColor;
      AOnDrawBackground: TcxDrawBackgroundEvent = nil); overload;
    procedure DrawIndicatorItem(ACanvas: TcxCanvas; const R: TRect;
      AKind: TcxIndicatorKind; AColor: TColor;
      AOnDrawBackground: TcxDrawBackgroundEvent = nil); overload;
    ...
    procedure DrawScaledIndicatorImage(ACanvas: TcxCanvas; const R: TRect;
      AKind: TcxIndicatorKind; AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawScaledIndicatorItem(ACanvas: TcxCanvas;
      const R, AImageAreaBounds: TRect; AKind: TcxIndicatorKind; AColor: TColor;
      AScaleFactor: TdxScaleFactor;
      AOnDrawBackground: TcxDrawBackgroundEvent = nil;
      ANeighbors: TcxNeighbors = [nTop, nBottom]); overload; virtual;
    procedure DrawScaledIndicatorItem(ACanvas: TcxCanvas; const R: TRect;
    ...
    procedure DrawScaledIndicatorCustomizationMark(ACanvas: TcxCustomCanvas;
      const R: TRect; AColor: TColor; AScaleFactor: TdxScaleFactor); virtual;
    function IndicatorDrawItemsFirst: Boolean; virtual;

    // ScrollBars
    procedure DrawScrollBarBackground(ACanvas: TcxCustomCanvas; const R: TRect;
      AHorizontal: Boolean);
    procedure DrawScrollBarPart(ACanvas: TcxCustomCanvas; AHorizontal: Boolean;
      R: TRect; APart: TcxScrollBarPart; AState: TcxButtonState);
    procedure DrawScrollBarSplitter(ACanvas: TcxCustomCanvas; const R: TRect;
      AState: TcxButtonState);
    ...
    procedure CalculatePopupPanelClientRect(var AClientRect, APanelRect,
      AGripRect, ACloseButtonRect: TRect; ACorner: TdxCorner;
      const ABorders, APanelBorders: TRect; APanelHeight: Integer = 0;
      AShowCloseButton: Boolean = True; AShowGripSize: Boolean = True);
    procedure CalculateScaledPopupPanelClientRect(var AClientRect, APanelRect,
      AGripRect, ACloseButtonRect: TRect; ACorner: TdxCorner;
      const ABorders, APanelBorders: TRect; AScaleFactor: TdxScaleFactor;
      APanelHeight: Integer = 0; AShowCloseButton: Boolean = True;
      AShowGripSize: Boolean = True); virtual;
    procedure DrawPopupNCPanel(AHandle: HWND;
      AMouseAboveCloseButton, ACloseButtonIsTracking: Boolean;
      ACorner: TdxCorner; ACloseButtonRect, AGripRect: TRect;
      ABorderColor: TColor);
    procedure DrawPopupPanelBand(ACanvas: TcxCanvas;
      const ABounds, AGripRect, ACloseButtonRect: TRect; AGripCorner: TdxCorner;
      ACloseButtonState: TcxButtonState; ABorders: TRect; ABorderColor: TColor;
      AShowGripSize: Boolean = True; AShowCloseButton: Boolean = True);
    procedure DrawScaledPopupPanelBand(ACanvas: TcxCanvas;
      const ABounds, AGripRect, ACloseButtonRect: TRect; AGripCorner: TdxCorner;
      ACloseButtonState: TcxButtonState; ABorders: TRect; ABorderColor: TColor;
      AScaleFactor: TdxScaleFactor; AShowGripSize: Boolean = True;
      AShowCloseButton: Boolean = True);
    procedure DrawScaledPopupNCPanel(AHandle: HWND;
      AMouseAboveCloseButton, ACloseButtonIsTracking: Boolean;
      ACorner: TdxCorner; ACloseButtonRect, AGripRect: TRect;
      ABorderColor: TColor; AScaleFactor: TdxScaleFactor); virtual;
    ...
    procedure DrawSizeGrip(ACanvas: TcxCanvas; const ARect: TRect;
      ABackgroundColor: TColor = clDefault;
      ACorner: TdxCorner = coBottomRight); virtual;
    procedure DrawScaledSizeGrip(ACanvas: TcxCanvas; const ARect: TRect;
      AScaleFactor: TdxScaleFactor; ABackgroundColor: TColor = clDefault;
      ACorner: TdxCorner = coBottomRight); virtual;
    ...
    function ScaledSliderButtonSize(ADirection: TcxArrowDirection;
      AScaleFactor: TdxScaleFactor): TSize; virtual;
    ...
    procedure DrawSmallButton(ACanvas: TcxCanvas; R: TRect;
      AState: TcxButtonState);
    procedure DrawSmallCloseButton(ACanvas: TcxCanvas; R: TRect;
      AState: TcxButtonState);
    ...
    function ScaledSmallCloseButtonSize(AScaleFactor: TdxScaleFactor)
      : TSize; virtual;
    ...
    procedure CalculateSchedulerNavigationButtonRects(AIsNextButton: Boolean;
      ...
      const AIsVertical: Boolean = True); overload; virtual;
    procedure CalculateSchedulerNavigationButtonRects(AIsNextButton: Boolean;
      ACollapsed: Boolean; APrevButtonTextSize: TSize;
      ANextButtonTextSize: TSize; var ABounds: TRect; out ATextRect: TRect;
      out AArrowRect: TRect; const AIsVertical: Boolean = True);
      overload; virtual;
    ...
    procedure DrawSchedulerScaledEventProgress(ACanvas: TcxCanvas;
      const ABounds, AProgress: TRect; AViewParams: TcxViewParams;
      ATransparent: Boolean; AScaleFactor: TdxScaleFactor); virtual;
    ...
    procedure DrawSchedulerScaledGroupSeparator(ACanvas: TcxCanvas;
      ...
      AScaleFactor: TdxScaleFactor;
      AOnDrawBackground: TcxDrawBackgroundEvent = nil); virtual;
    procedure DrawSchedulerGroupSeparator(ACanvas: TcxCanvas;
      const ABounds: TRect; ABackgroundColor: TColor;
      AOnDrawBackground: TcxDrawBackgroundEvent = nil);
    ...
    procedure DrawSchedulerNavigationButton(ACanvas: TcxCanvas;
      ...
      const AText: string; const ATextRect: TRect; const AArrowRect: TRect;
      const AIsVertical: Boolean = True); virtual;
    procedure DrawSchedulerNavigationButtonArrow(ACanvas: TcxCanvas;
      const ARect: TRect; AIsNextButton: Boolean; AColor: TColor;
      const AForVertical: Boolean); virtual;
    ...
    procedure DrawSchedulerSplitterBorder(ACanvas: TcxCanvas; R: TRect;
      const AViewParams: TcxViewParams; AIsHorizontal: Boolean); virtual;
    procedure DrawSchedulerTaskExpandButton(ACanvas: TcxCanvas; R: TRect;
      AExpanded: Boolean; AScaleFactor: TdxScaleFactor); virtual;
    ...
    procedure DrawScaledZoomOutButton(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState; AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawZoomInButton(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState);
    procedure DrawZoomOutButton(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState);
    ...
    function GetScaledBackButtonSize(AScaleFactor: TdxScaleFactor)
      : TSize; virtual;
    procedure DrawBackButton(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState);
    ...
    procedure DrawNavigatorButton(ACanvas: TcxCanvas; R: TRect;
      AState: TcxButtonState; ABackgroundColor: TColor);
    procedure DrawNavigatorButtonGlyph(ACanvas: TcxCanvas;
    ...
    function NavigatorScaledButtonGlyphSize(AScaleFactor: TdxScaleFactor)
      : TSize; overload; virtual;
    function NavigatorScaledButtonMinSize(AScaleFactor: TdxScaleFactor): TSize;
      overload; virtual;
    ...
    procedure DrawProgressBarChunk(ACanvas: TcxCanvas; ARect: TRect;
      AVertical: Boolean); virtual;
    procedure DrawProgressBarText(ACanvas: TcxCanvas;
      AVertical, ASolid: Boolean; const AText: string;
    ...
    procedure DrawGroupBoxScaledButton(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState; AScaleFactor: TdxScaleFactor); overload; virtual;
    procedure DrawGroupBoxButton(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState);
    ...
    function GroupBoxTextColor(AEnabled: Boolean;
      ACaptionPosition: TcxGroupBoxCaptionPosition): TColor; virtual;
    function IsGroupBoxCaptionTextDrawnOverBorder(ACaptionPosition
      : TcxGroupBoxCaptionPosition): Boolean; virtual;
    ...
    function CheckButtonColor(AState: TcxButtonState;
      ACheckState: TcxCheckBoxState): TColor; virtual;
    function CheckButtonSize: TSize;
    function ScaledCheckButtonAreaSize(AScaleFactor: TdxScaleFactor)
      : TSize; virtual;
    function ScaledCheckButtonSize(AScaleFactor: TdxScaleFactor): TSize;
      overload; virtual;
    procedure DrawCheck(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState; AChecked: Boolean; AColor: TColor); overload;
    procedure DrawCheck(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState; ACheckState: TcxCheckBoxState; AColor: TColor);
      overload;
    procedure DrawCheckBorder(ACanvas: TcxCanvas; R: TRect;
      AState: TcxButtonState); virtual; // abstract;
    procedure DrawCheckButton(ACanvas: TcxCanvas; R: TRect;
      AState: TcxButtonState; AChecked: Boolean); overload;
    procedure DrawCheckButton(ACanvas: TcxCanvas; R: TRect;
      AState: TcxButtonState; ACheckState: TcxCheckBoxState); overload;
    procedure DrawScaledCheck(ACanvas: TcxCanvas; const R: TRect;
    ...
    // ToggleSwitch
    procedure DrawScaledToggleSwitch(ACanvas: TcxCanvas; ABounds: TRect;
      AState: TcxButtonState; AThumbBounds: TRect;
      AScaleFactor: TdxScaleFactor); virtual;
    ...
    procedure DrawScaledToggleSwitchThumb(ACanvas: TcxCanvas; ABounds: TRect;
      AState: TcxButtonState; AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawToggleSwitch(ACanvas: TcxCanvas; ABounds: TRect;
      AState: TcxButtonState; AThumbBounds: TRect);
    procedure DrawToggleSwitchState(ACanvas: TcxCanvas; ABounds: TRect;
      AState: TcxButtonState; AChecked: Boolean);
    procedure DrawToggleSwitchStateIndicator(ACanvas: TcxCanvas; ABounds: TRect;
      AText: string; AFont: TFont); virtual;
    procedure DrawToggleSwitchThumb(ACanvas: TcxCanvas; ABounds: TRect;
      AState: TcxButtonState);
    ...
    procedure DrawScaledRadioButton(ACanvas: TcxCanvas; X, Y: Integer;
      ...
      AIsDesigning: Boolean = False); overload; virtual;
    function RadioButtonBodyColor(AState: TcxButtonState): TColor; virtual;
    function RadioButtonSize: TSize;
    function ScaledRadioButtonSize(AScaleFactor: TdxScaleFactor): TSize;
      overload; virtual;
    ...
    procedure OfficeNavigationBarDrawScaledButtonItemBackground
      ...
      AScaleFactor: TdxScaleFactor); virtual;
    procedure OfficeNavigationBarDrawScaledCustomizationButton
      (ACanvas: TcxCanvas; const ARect: TRect; AState: TcxCalendarElementState;
      AScaleFactor: TdxScaleFactor;
      AColor: TdxAlphaColor = dxacDefault); virtual;
    ...
    function OfficeNavigationBarButtonItemTextColor
      (AState: TcxCalendarElementState): TColor; virtual;
    ...
    function OfficeNavigationBarScaledContentOffsets(AScaleFactor
      : TdxScaleFactor): TRect; virtual;
    function OfficeNavigationBarScaledCustomizationButtonSize
      (AScaleFactor: TdxScaleFactor): TSize; virtual;
    ...
    function PDFViewerNavigationPaneButtonOverlay(AScaleFactor: TdxScaleFactor)
      : TPoint; virtual;
    function PDFViewerNavigationPaneButtonRect(const ARect: TRect;
      AState: TcxButtonState; ASelected: Boolean;
    ...
    procedure PDFViewerDrawNavigationPaneBackground(ACanvas: TcxCanvas;
      const ARect: TRect; AScaleFactor: TdxScaleFactor); virtual;
    procedure PDFViewerDrawNavigationPaneButton(ACanvas: TcxCanvas;
      ...
      AMinimized, ASelected, AIsFirst: Boolean); virtual;
    ...
    procedure PDFViewerDrawFindPanelBackground(ACanvas: TcxCanvas;
      const R: TRect; ABorders: TcxBorders); virtual;
    ...
    procedure DrawSpreadSheetGroupExpandButton(ACanvas: TcxCanvas;
      const R: TRect; AState: TcxButtonState);
    procedure DrawSpreadSheetGroupExpandButtonGlyph(ACanvas: TcxCanvas;
      const R: TRect; AState: TcxButtonState; AExpanded: Boolean;
      ADefaultGlyphs: TCustomImageList = nil);
    procedure DrawSpreadSheetHeader(ACanvas: TcxCanvas;
      const ABounds, ATextAreaBounds: TRect; ANeighbors: TcxNeighbors;
      ABorders: TcxBorders; AState: TcxButtonState; AAlignmentHorz: TAlignment;
      AAlignmentVert: TcxAlignmentVert; AMultiLine, AShowEndEllipsis: Boolean;
      const AText: string; AFont: TFont; ATextColor, ABkColor: TColor;
    ...
    function SpreadSheetScaledGroupExpandButtonContentOffsets
      (AScaleFactor: TdxScaleFactor): TRect; virtual;
    function SpreadSheetScaledGroupExpandButtonGlyphSize
      (AScaleFactor: TdxScaleFactor): TSize; overload; virtual;
    function SpreadSheetScaledGroupLevelMarkSize(AScaleFactor: TdxScaleFactor)
      : TSize; overload; virtual;
    ...
    procedure DrawSpreadSheetFormulaBarScaledSeparator(ACanvas: TcxCanvas;
      const R: TRect; AScaleFactor: TdxScaleFactor); virtual;
    function SpreadSheetFormulaBarGetScaledSeparatorSize
      (AScaleFactor: TdxScaleFactor): Integer; virtual;

    // Panel
    procedure DrawPanelBackground(ACanvas: TcxCanvas; AControl: TWinControl;
      ABounds: TRect; AColorFrom: TColor = clDefault;
      AColorTo: TColor = clDefault); virtual;
    procedure DrawPanelBorders(ACanvas: TcxCanvas;
      const ABorderRect: TRect); virtual;
    ...
    procedure DrawTrackBarScaledTrack(ACanvas: TcxCanvas;
      ...
      AHorizontal: Boolean; ATrackColor: TColor; AScaleFactor: TdxScaleFactor);
      overload; virtual;
    procedure DrawTrackBarTrack(ACanvas: TcxCanvas;
      const ARect, ASelection: TRect; AShowSelection, AEnabled,
      AHorizontal: Boolean; ATrackColor: TColor);
    procedure DrawTrackBarTrackBounds(ACanvas: TcxCanvas;
      const ARect: TRect); virtual;
    ...
    procedure DrawTrackBarThumbBorderBoth(ACanvas: TcxCanvas;
      const ARect: TRect); virtual;
    function TrackBarScaledThumbSize(AHorizontal: Boolean;
      AScaleFactor: TdxScaleFactor): TSize; overload; virtual;
    function TrackBarScaledTrackSize(AScaleFactor: TdxScaleFactor): Integer;
      overload; virtual;
    ...
    procedure DrawRangeControlScaledRulerHeader(ACanvas: TcxCanvas;
      ...
      overload; virtual;
    procedure DrawRangeControlRulerHeader(ACanvas: TcxCanvas;
      const ARect: TRect; AIsHot: Boolean; AColor: TdxAlphaColor;
    ...
    procedure DrawRangeControlScaledSizingGlyph(ACanvas: TcxCanvas;
      ...
      AScaleFactor: TdxScaleFactor); overload; virtual;
    procedure DrawRangeControlSizingGlyph(ACanvas: TcxCanvas;
      const ARect: TRect; ABorderColor: TdxAlphaColor);
    ...
    // RangeTrackBar
    function RangeTrackBarLeftThumbSize(AHorizontal: Boolean;
      ATicks: TcxTrackBarTicksAlign): TSize;
    function RangeTrackBarRightThumbSize(AHorizontal: Boolean;
      ATicks: TcxTrackBarTicksAlign): TSize;
    ...
    procedure DrawRangeTrackBarScaledLeftThumb(ACanvas: TcxCanvas;
      ...
      ATicks: TcxTrackBarTicksAlign; AThumbColor: TColor;
      AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawRangeTrackBarLeftThumb(ACanvas: TcxCanvas; const ARect: TRect;
      AState: TcxButtonState; AHorizontal: Boolean;
      ATicks: TcxTrackBarTicksAlign; AThumbColor: TColor);
    procedure DrawRangeTrackBarScaledRightThumb(ACanvas: TcxCanvas;
      ...
      ATicks: TcxTrackBarTicksAlign; AThumbColor: TColor;
      AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawRangeTrackBarRightThumb(ACanvas: TcxCanvas;
      const ARect: TRect; AState: TcxButtonState; AHorizontal: Boolean;
      ATicks: TcxTrackBarTicksAlign; AThumbColor: TColor);
    ...
    procedure DrawScaledSplitter(ACanvas: TcxCustomCanvas; const ARect: TRect;
      ...
      AArrowDirection: TcxArrowDirection = adLeft); virtual;
    procedure DrawSplitter(ACanvas: TcxCustomCanvas; const ARect: TRect;
      AHighlighted, AClicked, AHorizontal: Boolean);
    procedure DrawSplitterCloseMark(ACanvas: TcxCustomCanvas;
      const ARect: TRect; AHighlighted, AClicked, AHorizontal: Boolean;
      AScaleFactor: TdxScaleFactor; AArrowDirection: TcxArrowDirection);
    function GetScaledSplitterSize(AHorizontal: Boolean;
      AScaleFactor: TdxScaleFactor): TSize; virtual;
    function GetSplitterSize(AHorizontal: Boolean): TSize;
    function HasSplitterInnerLine(AHorizontal: Boolean;
    ...
    function LayoutControlGetColorPaletteForTabbedGroupCaption
      (AIsActive: Boolean): IdxColorPalette; virtual;
    ...
    procedure DrawMessageBox(ACanvas: TcxCanvas; const ABounds: TRect;
      const AMessage: string; AFont: TFont = nil;
      AColor: TColor = clNone); virtual;
    ...
    function BreadcrumbEditButtonColorPalette
      (AState: TdxBreadcrumbEditButtonState): IdxColorPalette; virtual;
    function BreadcrumbEditButtonContentOffsets(AIsFirst,
      AIsLast: Boolean): TRect;
    ...
    function BreadcrumbEditScaledButtonContentOffsets(AIsFirst,
      AIsLast: Boolean; AScaleFactor: TdxScaleFactor): TRect; virtual;
    function BreadcrumbEditScaledDropDownButtonWidth(AScaleFactor
      : TdxScaleFactor): Integer; virtual;
    function BreadcrumbEditScaledNodeDelimiterSize(AScaleFactor: TdxScaleFactor)
      : Integer; virtual;
    ...
    procedure DrawBreadcrumbEditBorders(ACanvas: TcxCanvas; const ARect: TRect;
      ABorders: TcxBorders; AState: TdxBreadcrumbEditState); virtual;
    ...
    procedure DrawBreadcrumbEditDropDownButtonGlyph(ACanvas: TcxCanvas;
      const ARect: TRect; AState: TdxBreadcrumbEditButtonState;
      AIsInEditor: Boolean);
    procedure DrawBreadcrumbEditNode(ACanvas: TcxCanvas; const R: TRect;
    ...
    procedure DrawBreadcrumbEditNodeMoreButtonGlyph(ACanvas: TcxCanvas;
      const R: TRect; AState: TdxBreadcrumbEditButtonState);
    procedure DrawBreadcrumbEditProgressChunk(ACanvas: TcxCanvas;
      const R: TRect);
    procedure DrawBreadcrumbEditProgressChunkOverlay(ACanvas: TcxCanvas;
      const R: TRect);
    procedure DrawBreadcrumbEditScaledButton(ACanvas: TcxCanvas;
      const ARect: TRect; AState: TdxBreadcrumbEditButtonState;
      AIsFirst, AIsLast: Boolean; AScaleFactor: TdxScaleFactor); virtual;
    ...
    procedure DrawBreadcrumbEditScaledDropDownButton(ACanvas: TcxCanvas;
      const ARect: TRect; AState: TdxBreadcrumbEditButtonState;
      AIsInEditor: Boolean; AScaleFactor: TdxScaleFactor); virtual;
    ...
    procedure DrawDropDownListBoxBackground(ACanvas: TcxCanvas;
      const ARect: TRect; AHasBorders: Boolean); virtual;
    procedure DrawDropDownListBoxGutterBackground(ACanvas: TcxCanvas;
      const ARect: TRect);
    ...
    // AlertWindow
    function AlertWindowButtonContentOffsets
      (AKind: TdxAlertWindowButtonKind): TRect;
    function AlertWindowButtonGetColorPalette(AState: TcxButtonState)
      : IdxColorPalette; virtual;
    ...
    function AlertWindowScaledButtonContentOffsets
      ...
      : TRect; virtual;
    function AlertWindowScaledButtonGlyphSize(AKind: TdxAlertWindowButtonKind;
      AScaleFactor: TdxScaleFactor): TSize; virtual;
    ...
    function GetGalleryItemCaptionTextColor(const AState
      : TdxGalleryItemViewState): TColor; virtual;
    ...
    procedure DrawGalleryItemSelection(ACanvas: TcxCustomCanvas; const R: TRect;
      AViewState: TdxGalleryItemViewState); virtual;
    procedure DrawGalleryItemImageFrame(ACanvas: TcxCustomCanvas;
      const R: TRect); virtual;

    // ColorGallery
    function GetColorGalleryGlyphFrameColor: TColor; virtual;
    procedure DrawColorGalleryItemSelection(ACanvas: TcxCustomCanvas;
      const R: TRect; AViewState: TdxGalleryItemViewState); virtual;

    // Bevel
    procedure DrawBevelFrame(ACanvas: TcxCanvas; const R: TRect;
      AColor1, AColor2: TColor; ABoxStyle: Boolean); virtual;
    procedure DrawBevelLine(ACanvas: TcxCanvas; const R: TRect;
      AColor1, AColor2: TColor; AIsVertical: Boolean); virtual;
    procedure DrawBevelShape(ACanvas: TcxCanvas; const R: TRect;
      AShape: TdxBevelShape; AStyle: TdxBevelStyle); virtual;
    ...
    procedure DrawCalendarDateCellSelection(ACanvas: TcxCanvas;
      const ARect: TRect; AStates: TcxCalendarElementStates); virtual;
    // ModernCalendar
    procedure DrawModernCalendarArrow(ACanvas: TcxCanvas; const ARect: TRect;
      ADirection: TcxArrowDirection; AState: TcxCalendarElementState); virtual;
    ...
    function GetModernCalendarDateHeaderTextColor
      (AStates: TcxCalendarElementStates): TColor; virtual;
    ...
    procedure DrawModernClockHands(ACanvas: TcxCanvas; const ARect: TRect;
      ADateTime: TDateTime; AColor: TColor);
    procedure DrawScaledModernCalendarArrow(ACanvas: TcxCanvas;
      const ARect: TRect; ADirection: TcxArrowDirection;
      AState: TcxCalendarElementState; AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawScaledModernClockHands(ACanvas: TcxCanvas; const ARect: TRect;
      ADateTime: TDateTime; AColor: TColor;
      AScaleFactor: TdxScaleFactor); virtual;

    // RatingControl
    procedure DrawRatingControlIndicator(ACanvas: TcxCanvas;
    ...
    function GetRatingControlIndicatorColorPalette
      (AState: TdxRatingControlIndicatorState): IdxColorPalette; virtual;
    ...
    procedure DrawScaledFixedGroupIndicator(ACanvas: TcxCanvas;
      const ABounds: TRect; AScaleFactor: TdxScaleFactor); virtual;
    function GetFixedGroupIndicatorSize: TSize;
    function GetScaledFixedGroupIndicatorSize(AScaleFactor: TdxScaleFactor)
      : TSize; virtual;

    // WheelPicker
    function GetWheelPickerBorderItemColor(AState: TcxButtonState)
      : TColor; virtual;
    function GetWheelPickerColorPalette(AState: TcxButtonState)
      : IdxColorPalette; virtual;
    function GetWheelPickerFillItemColor(AState: TcxButtonState)
      : TColor; virtual;
    procedure DrawWheelPickerItem(ACanvas: TcxCanvas; const ARect: TRect;
      AState: TcxButtonState); virtual;
    procedure DrawWheelPickerItemBackground(ACanvas: TcxCanvas;
      const ARect: TRect; AState: TcxButtonState); virtual;
    procedure DrawWheelPickerItemBorder(ACanvas: TcxCanvas; const ARect: TRect;
      AState: TcxButtonState); virtual;
    ...
    procedure DrawScaledTokenBackground(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState; AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawScaledTokenCloseGlyph(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState; AScaleFactor: TdxScaleFactor); virtual;
    procedure DrawTokenBackground(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState);
    procedure DrawTokenCloseGlyph(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState);
    function GetScaledTokenCloseGlyphSize(AScaleFactor: TdxScaleFactor)
      : TSize; virtual;
    function GetScaledTokenContentOffsets(AScaleFactor: TdxScaleFactor)
      : TRect; virtual;
    function GetScaledTokenDefaultGlyphSize(AScaleFactor: TdxScaleFactor)
      : TSize; virtual;
    ...
    procedure DoDrawGanttSheetHeaderBackground(ACanvas: TcxCustomCanvas;
      const R: TRect; AState: TcxButtonState); virtual;
    procedure DoDrawGanttSummaryTaskProgress(ACanvas: TcxCustomCanvas;
      const R: TRect; AScaleFactor: TdxScaleFactor;
      const AColor: TColor = clDefault); virtual;
    ...
    // ListView
    procedure DrawListViewBackground(ACanvas: TcxCustomCanvas; ABounds: TRect;
      AExplorerStyle: Boolean); virtual; // for internal use
    procedure DrawListViewCheckButton(ACanvas: TcxCustomCanvas;
      const ABounds: TRect; AState: TcxButtonState; AChecked: Boolean;
      AScaleFactor: TdxScaleFactor); virtual; // for internal use
    procedure DrawListViewSortingMark(ACanvas: TcxCustomCanvas; const R: TRect;
      AAscendingSorting: Boolean; AScaleFactor: TdxScaleFactor); virtual;
    // for internal use
    procedure DrawListViewGroupExpandButton(ACanvas: TcxCustomCanvas;
      const ABounds: TRect; AState: TcxButtonState; AExpanded: Boolean;
      AExplorerStyle: Boolean; AScaleFactor: TdxScaleFactor); virtual;
    // for internal use
    ...
    procedure DrawListViewGroupHeaderLine(ACanvas: TcxCustomCanvas;
      const ABounds: TRect); virtual; // for internal use
    procedure DrawListViewItemBackground(ACanvas: TcxCustomCanvas;
      const ABounds: TRect; AState: TdxListViewItemStates;
      AExplorerStyle: Boolean); virtual; // for internal use
    function GetListViewExpandButtonSize(AScaleFactor: TdxScaleFactor): Integer;
      overload; virtual; // for internal use
    function GetListViewColumnHeaderSortingMarkSize(AScaleFactor
      : TdxScaleFactor): TPoint; virtual; // for internal use
    ...
    function GetListViewItemColorPalette(AState: TdxListViewItemState)
      : IdxColorPalette; virtual; // for internal use
    function GetListViewItemContentPadding: TRect; virtual; // for internal use
    function GetListViewItemTextColor(AState: TdxListViewItemStates;
      AExplorerStyle: Boolean): TColor; virtual; // for internal use
    function GetListViewColumnHeaderTextColor(AState: TcxButtonState;
      AExplorerStyle: Boolean): TColor; virtual; // for internal use
  end;
  ...
  public
    ...
    function ButtonBorderSize(AState: TcxButtonState = cxbsNormal)
      : Integer; override;
    function ScaledButtonTextOffset(AScaleFactor: TdxScaleFactor)
      : Integer; override;
    function ScaledButtonTextShift(AScaleFactor: TdxScaleFactor)
      : Integer; override;
    procedure DrawButtonBorder(ACanvas: TcxCustomCanvas; R: TRect;
    ...
    function HeaderControlSectionBorderSize(AState: TcxButtonState = cxbsNormal)
      : Integer; override;
    function ScaledSortingMarkSize(AScaleFactor: TdxScaleFactor)
      : TPoint; override;
    ...
    // tabs
    procedure DrawTabBorder(ACanvas: TcxCanvas; R: TRect; ABorder: TcxBorder;
      ABorders: TcxBorders; AVertical: Boolean); override;
    procedure DrawTabsRoot(ACanvas: TcxCanvas; const R: TRect;
      ABorders: TcxBorders; AVertical: Boolean); override;
  ...
  protected
    ...
    procedure DoDrawScaledScrollBarPart(ACanvas: TcxCustomCanvas;
      ...
      AState: TcxButtonState; AScaleFactor: TdxScaleFactor); override;
    // filter
    function FilterDropDownButtonBorderColor(AState: TcxButtonState)
      : TColor; virtual;
    // Scheduler
    procedure DrawSchedulerNavigationButtonContent(ACanvas: TcxCanvas;
      const ARect: TRect; const AArrowRect: TRect; AIsNextButton: Boolean;
  ...
  public
    ...
    function ButtonSymbolState(AState: TcxButtonState): TcxButtonState;
      override;
    function ScaledButtonTextOffset(AScaleFactor: TdxScaleFactor)
      : Integer; override;
    function ScaledButtonTextShift(AScaleFactor: TdxScaleFactor)
  ...
  public
    ...
    // checkbox
    function CheckButtonColor(AState: TcxButtonState;
      ACheckState: TcxCheckBoxState): TColor; override;
    // RadioButton
    function RadioButtonBodyColor(AState: TcxButtonState): TColor; override;
    // filter
    procedure DrawScaledFilterDropDownButton(ACanvas: TcxCanvas; R: TRect;
    ...
    procedure DrawPanelBackground(ACanvas: TcxCanvas; AControl: TWinControl;
      ABounds: TRect; AColorFrom: TColor = clDefault;
      AColorTo: TColor = clDefault); override;
    // Layout Control
    procedure DrawLayoutControlBackground(ACanvas: TcxCanvas;
    ...
    procedure DrawDropDownListBoxScaledGutterBackground(ACanvas: TcxCanvas;
      const ARect: TRect; AScaleFactor: TdxScaleFactor); override;
    procedure DrawDropDownListBoxScaledSelection(ACanvas: TcxCanvas;
      const ARect: TRect; const AGutterRect: TRect;
      AScaleFactor: TdxScaleFactor); override;
    procedure DrawDropDownListBoxScaledSeparator(ACanvas: TcxCanvas;
      const ARect: TRect; const AGutterRect: TRect;
      AScaleFactor: TdxScaleFactor); override;
    ...
    // Gantt
    procedure DoDrawGanttSheetHeaderBackground(ACanvas: TcxCustomCanvas;
      const R: TRect; AState: TcxButtonState); override;
  end;
  ...
  strict private
  const
    ButtonStateToHeaderState: array [TcxButtonState] of Integer = (HIS_NORMAL,
      HIS_NORMAL, HIS_HOT, HIS_PRESSED, HIS_NORMAL);
  strict private
    FZoomInButtonGlyph: TcxBitmap32;
    FZoomOutButtonGlyph: TcxBitmap32;

    procedure DrawNativeRangeTrackBarThumb(ACanvas: TcxCanvas;
      const ARect: TRect; AState: TcxButtonState; AHorizontal: Boolean;
      ATicks: TcxTrackBarTicksAlign; AThumbColor: TColor;
      AScaleFactor: TdxScaleFactor);
    function DoDrawThemeBackground(ACanvas: TcxCustomCanvas;
      AThemedObjectType: TdxThemedObjectType; AScaleFactor: TdxScaleFactor;
      const R: TRect; APartId, AStateId: Integer): Boolean;
    function DoDrawScaledThemeBackground(ACanvas: TcxCustomCanvas;
      AThemedObjectType: TdxThemedObjectType; AScaleFactor: TdxScaleFactor;
      const R: TRect; APartId, AStateId: Integer): Boolean;
  protected
    procedure DoDrawScaledButtonCaption(ACanvas: TcxCanvas; R: TRect;
    ...
    procedure DrawBreadcrumbEditNodePart(ACanvas: TcxCanvas; const R: TRect;
      AState: TdxBreadcrumbEditButtonState; ABorders: TcxBorders;
      AScaleFactor: TdxScaleFactor);
    procedure DrawContent(ACanvas: TcxCanvas; ATheme: TdxTheme;
      APartId, AStateId: Integer; const ABounds, ATextAreaBounds: TRect;
      AAlignmentHorz: TAlignment; AAlignmentVert: TcxAlignmentVert;
      AMultiLine, AShowEndEllipsis, AShowPrefix: Boolean; const AText: string;
    ...
    procedure DrawThemedTab(ACanvas: TcxCanvas; R: TRect; ABorders: TcxBorders;
      const AText: string; ATheme: TdxTheme; AState: Integer;
      AVertical: Boolean; AFont: TFont; ATextColor, ABkColor: TColor;
      AShowPrefix: Boolean = False);
    function NativeZoomButtonDraw(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxButtonState; AScaleFactor: TdxScaleFactor;
      AGlyph: TBitmap): Boolean;
    function NativeZoomButtonGetMinSize(AGlyph: TBitmap;
      AScaleFactor: TdxScaleFactor; out ASize: TSize): Boolean;
  ...
  public
    ...
    class procedure DrawScaledThemeBackground(ATheme: TdxTheme; DC: HDC;
      APartId, AStateId: Integer; const R: TRect; AScaleFactor: TdxScaleFactor;
      AForceScale: Boolean = False; AUseThemePartSize: Boolean = True);
    ...
    procedure DrawScaledArrow(ACanvas: TcxCustomCanvas; const R: TRect;
      AState: TcxButtonState; AArrowDirection: TcxArrowDirection;
      AScaleFactor: TdxScaleFactor; ADrawBorder: Boolean = True); override;
    procedure DrawScaledArrowBorder(ACanvas: TcxCustomCanvas; const R: TRect;
      AState: TcxButtonState; AScaleFactor: TdxScaleFactor); override;
    // border
    function BorderSize: Integer; override;
    ...
    procedure DrawTab(ACanvas: TcxCanvas; R: TRect; ABorders: TcxBorders;
      const AText: string; AState: TcxButtonState; AVertical: Boolean;
      AFont: TFont; ATextColor, ABkColor: TColor;
      AShowPrefix: Boolean = False); override;
    procedure DrawTabBorder(ACanvas: TcxCanvas; R: TRect; ABorder: TcxBorder;
      ABorders: TcxBorders; AVertical: Boolean); override;
    procedure DrawTabsRoot(ACanvas: TcxCanvas; const R: TRect;
      ABorders: TcxBorders; AVertical: Boolean); override;
    ...
    function NavigatorScaledButtonMinSize(AScaleFactor: TdxScaleFactor)
      : TSize; override;
    // DropDownListBox
    function DropDownListBoxItemTextColor(ASelected: Boolean): TColor; override;
    function DropDownListBoxScaledSeparatorSize(AScaleFactor: TdxScaleFactor)
    ...
    // WheelPicker
    procedure DrawWheelPickerItemBackground(ACanvas: TcxCanvas;
      const ARect: TRect; AState: TcxButtonState); override;
    procedure DrawWheelPickerItemBorder(ACanvas: TcxCanvas; const ARect: TRect;
      AState: TcxButtonState); override;
    ...
    procedure DrawListViewSortingMark(ACanvas: TcxCustomCanvas; const R: TRect;
      AAscendingSorting: Boolean; AScaleFactor: TdxScaleFactor); override;
    function GetListViewColumnHeaderSortingMarkSize(AScaleFactor
      : TdxScaleFactor): TPoint; override;
    function GetListViewColumnHeaderTextColor(AState: TcxButtonState;
  ...
  strict private
    ...
    FStandardPainters: array [TcxLookAndFeelStyle]
      of TcxCustomLookAndFeelPainter;

    function GetCount: Integer;
    function GetItem(AIndex: Integer): TcxCustomLookAndFeelPainter;
    class function CompareProc(AItem1, AItem2: TcxCustomLookAndFeelPainter)
      : Integer; static;
  protected
  ...
  public
    ...
    function GetPainter(AStyle: TcxLookAndFeelStyle)
      : TcxCustomLookAndFeelPainter; overload;
    function GetPainter(AStyle: TcxLookAndFeelStyle;
      out APainter: TcxCustomLookAndFeelPainter): Boolean; overload;
    function GetPainter(const AName: string)
      : TcxCustomLookAndFeelPainter; overload;
    function GetPainter(const AName: string;
      out APainter: TcxCustomLookAndFeelPainter): Boolean; overload;
    ...
    property Items[Index: Integer]: TcxCustomLookAndFeelPainter
      read GetItem; default;
  end;

var
  cxContainerBorderWidths: array [TcxContainerBorderStyle] of Integer = (
    0,
    1,
    2,
    2,
...
procedure dxAdjustToTouchableSize(var AElementSize: TSize;
  AScaleFactor: TdxScaleFactor = nil); overload;
function dxGetTouchableSize(AElementSizeDimension: Integer;
  AScaleFactor: TdxScaleFactor = nil): Integer; overload;
function dxGetTouchableSize(const AElementSize: TSize;
  AScaleFactor: TdxScaleFactor = nil): TSize; overload;
...
function dxElementSizeFitsForTouch(AElementSizeDimension: Integer)
  : Boolean; overload;
function dxElementSizeFitsForTouch(AElementSizeDimension: Integer;
  AScaleFactor: TdxScaleFactor): Boolean; overload;
procedure dxRotateSizeGrip(ACanvas: TcxCanvas; const ARect: TRect;
  ABackgroundColor: TColor; ACorner: TdxCorner;
  AOnDrawSizeGrip: TdxDrawEvent); overload;
procedure dxRotateSizeGrip(ACanvas: TcxCanvas; const ARect: TRect;
  AScaleFactor: TdxScaleFactor; ABackgroundColor: TColor; ACorner: TdxCorner;
  AOnDrawSizeGrip: TdxDrawScaledRectEvent); overload;
...
uses
  Messages,
  Forms, SysUtils, cxControls, cxLookAndFeels, Math, cxDrawTextUtils,
  dxSkinsCore, cxLibraryStrs,
...
const
  ...
  BreadcrumbButtonStateToButtonState: array [TdxBreadcrumbEditButtonState]
    of TcxButtonState = (cxbsNormal, cxbsNormal, cxbsHot, cxbsPressed,
    cxbsDisabled);

  TrackBarThumbThemeParts: array [TcxTrackBarTicksAlign, Boolean]
    of Byte = ((TKP_THUMBLEFT, TKP_THUMBTOP), (TKP_THUMBRIGHT, TKP_THUMBBOTTOM),
...
procedure TcxWinXPLookAndFeelPainter.DrawContent(ACanvas: TcxCanvas;
  ATheme: TdxTheme; APartId, AStateId: Integer;
  const ABounds, ATextAreaBounds: TRect; AAlignmentHorz: TAlignment;
  AAlignmentVert: TcxAlignmentVert; AMultiLine, AShowEndEllipsis,
  AShowPrefix: Boolean; const AText: string; AFont: TFont;
  ATextColor, ABkColor: TColor);
const
...
begin
  ...
  DrawThemeText(ATheme, ACanvas.Handle, APartId, AStateId, AText, -1,
    DT_EDITCONTROL or SystemAlignmentsHorz[AAlignmentHorz] or
    SystemAlignmentsVert[AAlignmentVert] or ShowEndEllipses[AShowEndEllipsis] or
    ShowPrefixes[AShowPrefix] or MultiLines[AMultiLine], 0, R);
end;
...
const
  ...
  States: array [TcxButtonState] of Integer = (TIS_NORMAL, TIS_NORMAL, TIS_HOT,
    TIS_SELECTED, TIS_DISABLED);
var
  ABitmap: TcxBitmap;
  ATheme: TdxTheme;
begin
  ...
  begin
    ...
    try
      ...
      DrawThemeBackground(ATheme, ABitmap.Canvas.Handle, TABP_TABITEM,
        States[AState], cxGetImageClientRect(ABitmap));

      if AIsVertical then
        ABitmap.Rotate(RotationAngle[AIsNextButton])
      else if not AIsNextButton then
        ABitmap.Rotate(ra180);

      cxBitBlt(ACanvas.Handle, ABitmap.Canvas.Handle, ARect,
        cxNullPoint, SRCCOPY);
...
begin
  if not cxGetThemeColor(totComboBox, CP_DROPDOWNBUTTON, CBXS_NORMAL,
    TMT_BORDERCOLOR, Result) then
...
const
  States: array [TcxArrowDirection, TcxButtonState] of Integer =
    ...
    (ABS_DOWNNORMAL, ABS_DOWNNORMAL, ABS_DOWNHOT, ABS_DOWNPRESSED,
    ABS_DOWNDISABLED), (ABS_LEFTNORMAL, ABS_LEFTNORMAL, ABS_LEFTHOT,
    ABS_LEFTPRESSED, ABS_LEFTDISABLED), (ABS_RIGHTNORMAL, ABS_RIGHTNORMAL,
    ABS_RIGHTHOT, ABS_RIGHTPRESSED, ABS_RIGHTDISABLED));
begin
  if not DoDrawThemeBackground(ACanvas, totScrollBar, AScaleFactor, R,
    SBP_ARROWBTN, States[AArrowDirection, AState]) then
    inherited
end;

procedure TcxWinXPLookAndFeelPainter.DrawScaledArrowBorder
  (ACanvas: TcxCustomCanvas; const R: TRect; AState: TcxButtonState;
  AScaleFactor: TdxScaleFactor);
begin
  if not DoDrawThemeBackground(ACanvas, totButton, AScaleFactor, R,
    BP_PUSHBUTTON, BtnStateToXPBtnState(AState)) then
    inherited;
end;
...
procedure TcxWinXPLookAndFeelPainter.DrawBorder(ACanvas: TcxCustomCanvas;
  R: TRect);
var
  ATheme: TdxTheme;
begin
  ...
  if ATheme <> 0 then
  begin
    ACanvas.DrawNativeObject(R, TcxCanvasBasedResourceCacheKey.Create
      (Pointer(ATheme), cxSize(R), 0, LVP_EMPTYTEXT),
...
procedure TcxWinXPLookAndFeelPainter.DoDrawSeparator(ACanvas: TcxCanvas;
R: TRect; AIsVertical: Boolean);
const
  PartMap: array [Boolean] of Cardinal = (TP_SEPARATORVERT, TP_SEPARATOR);
begin
  if not dxDrawThemeBackground(ACanvas.Handle, totToolBar, R,
    PartMap[AIsVertical], TS_NORMAL) then
    inherited;
end;

function TcxWinXPLookAndFeelPainter.ButtonBorderSize
...
begin
  ...
  begin
    R := Rect(0, 0, 100, 100);
    GetThemeBackgroundContentRect(ATheme, 0, BP_PUSHBUTTON,
      BtnStateToXPBtnState(AState), R, R);
    Result := R.Left;
  end
  else
...
begin
  if not cxGetThemeColor(totButton, BP_PUSHBUTTON, BtnStateToXPBtnState(AState),
    TMT_COLOR, Result) then
    Result := inherited ButtonColor(AState);
end;

function TcxWinXPLookAndFeelPainter.ScaledButtonFocusRect(ACanvas: TcxCanvas;
R: TRect; AScaleFactor: TdxScaleFactor): TRect;
var
  ATheme: TdxTheme;
begin
  ATheme := OpenTheme(totButton, AScaleFactor);
  if (ATheme <> 0) and (GetThemeBackgroundContentRect(ATheme, ACanvas.Handle,
    BP_PUSHBUTTON, PBS_NORMAL, R, R) = S_OK) then
    Result := R
  else
    Result := inherited ScaledButtonFocusRect(ACanvas, R, AScaleFactor);
end;

function TcxWinXPLookAndFeelPainter.ButtonSymbolColor(AState: TcxButtonState;
ADefaultColor: TColor = clDefault): TColor;
begin
  if not cxGetThemeColor(totButton, BP_PUSHBUTTON, BtnStateToXPBtnState(AState),
    TMT_TEXTCOLOR, Result) then
    Result := inherited ButtonSymbolColor(AState, ADefaultColor);
end;

function TcxWinXPLookAndFeelPainter.ScaledButtonTextOffset
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(cxTextOffset);
end;

function TcxWinXPLookAndFeelPainter.ScaledButtonTextShift
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := 0;
end;

procedure TcxWinXPLookAndFeelPainter.DrawScaledButton(ACanvas: TcxCustomCanvas;
R: TRect; AState: TcxButtonState; AScaleFactor: TdxScaleFactor;
ADrawBorder: Boolean; AIsToolButton: Boolean; APart: TcxButtonPart;
AColor: TColor);
const
  ButtonObjectType: array [Boolean] of TdxThemedObjectType = (totButton,
    totToolBar);
begin
  if not DoDrawThemeBackground(ACanvas, ButtonObjectType[AIsToolButton],
    AScaleFactor, R, BP_PUSHBUTTON, BtnStateToXPBtnState(AState)) then
    inherited;
end;
...
begin
  ...
  begin
    if cxGetThemeColor(totButton, BP_COMMANDLINK, BtnStateToXPBtnState(AState),
      TMT_TEXTCOLOR, Result) then
      Exit;
  end;
...
procedure TcxWinXPLookAndFeelPainter.DrawScaledCommandLinkBackground
  (ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState;
AScaleFactor: TdxScaleFactor; AColor: TColor = clDefault);
begin
  if not(IsWinVistaOrLater and dxDrawThemeBackground(ACanvas.Handle, totButton,
    AScaleFactor, R, BP_COMMANDLINK, BtnStateToXPBtnState(AState))) then
    cxLookAndFeelPaintersManager.GetPainter(lfsFlat).DrawScaledButton(ACanvas,
      R, AState, AScaleFactor, (AState = cxbsHot) or (AState = cxbsPressed),
      False, cxbpButton, AColor);
end;

procedure TcxWinXPLookAndFeelPainter.DrawScaledCommandLinkGlyph
...
begin
  ...
  begin
    ARect.InitSize(AGlyphPos.X, AGlyphPos.Y,
      GetScaledCommandLinkGlyphSize(AScaleFactor));
    cxRightToLeftDependentDraw(ACanvas, ARect, procedure
      begin
    ...
    inherited DrawScaledCommandLinkGlyph(ACanvas, AGlyphPos, AState,
      AScaleFactor);
end;

function TcxWinXPLookAndFeelPainter.GetScaledCommandLinkGlyphSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  if not(IsWinVistaOrLater and GetThemeScaledPartSize(totButton, AScaleFactor,
    BP_COMMANDLINKGLYPH, Result)) then
    Result := inherited GetScaledCommandLinkGlyphSize(AScaleFactor);
end;

function TcxWinXPLookAndFeelPainter.GetScaledCommandLinkMargins
  (AScaleFactor: TdxScaleFactor): TRect;
var
  ATheme: TdxTheme;
begin
  ATheme := OpenTheme(totButton, AScaleFactor);
  if (ATheme <> 0) and IsWinVistaOrLater then
    Result := AScaleFactor.Apply(GetThemeMargins(ATheme, BP_COMMANDLINK, 0,
      TMT_CONTENTMARGINS))
  else
...
begin
  if not DoDrawScaledThemeBackground(ACanvas, totTreeView, AScaleFactor, R,
    TVP_GLYPH, States[AExpanded]) then
    inherited;
end;
...
procedure TcxWinXPLookAndFeelPainter.DrawScaledGroupExpandButton
  (ACanvas: TcxCanvas; const R: TRect; AExpanded: Boolean;
AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
const
  Buttons: array [Boolean] of Integer = (EBP_NORMALGROUPEXPAND,
    EBP_NORMALGROUPCOLLAPSE);
  States: array [cxbsNormal .. cxbsPressed] of Integer = (EBNGE_NORMAL,
    EBNGE_HOT, EBNGE_PRESSED);
begin
  if not dxDrawThemeBackground(ACanvas.Handle, totExplorerBar, AScaleFactor, R,
    Buttons[AExpanded], States[AState]) then
    inherited;
end;

procedure TcxWinXPLookAndFeelPainter.DrawScaledSmallButton(ACanvas: TcxCanvas;
R: TRect; AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
begin
  DrawScaledButton(ACanvas, R, AState, AScaleFactor);
end;

procedure TcxWinXPLookAndFeelPainter.DrawScaledSmallExpandButton
...
function TcxWinXPLookAndFeelPainter.ScaledExpandButtonSize
  (AScaleFactor: TdxScaleFactor): Integer;
var
  ASize: TSize;
begin
  if GetThemeScaledPartSize(totTreeView, AScaleFactor, TVP_GLYPH, ASize,
    GLPS_OPENED) then
    Result := ASize.cx
  else
...
function TcxWinXPLookAndFeelPainter.ScaledGroupExpandButtonSize
  (AScaleFactor: TdxScaleFactor): Integer;
var
  ASize: TSize;
begin
  if GetThemeScaledPartSize(totExplorerBar, AScaleFactor, EBP_NORMALGROUPEXPAND,
    ASize, EBNGE_NORMAL, tssNoScaling) then
    Result := ASize.cx
  else
    Result := inherited ScaledGroupExpandButtonSize(AScaleFactor);
end;

function TcxWinXPLookAndFeelPainter.ScaledSmallExpandButtonSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
...
begin
  ...
  if ATheme <> 0 then
  begin
    GetThemeBackgroundRegion(ATheme, 0, EBP_NORMALGROUPEXPAND, EBNGE_HOT,
      @R, ARegion);
...
function TcxWinXPLookAndFeelPainter.ScaledCheckButtonSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  if not GetThemeScaledPartSize(totButton, AScaleFactor, BP_CHECKBOX, Result,
    CBS_CHECKEDNORMAL) then
    Result := inherited ScaledCheckButtonSize(AScaleFactor);
end;

procedure TcxWinXPLookAndFeelPainter.DrawScaledCheck(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState; ACheckState: TcxCheckBoxState;
AColor: TColor; AScaleFactor: TdxScaleFactor);
const
  NativeCheckStateMap: array [TcxCheckBoxState, TcxButtonState] of Integer =
    ((CBS_UNCHECKEDNORMAL, CBS_UNCHECKEDNORMAL, CBS_UNCHECKEDHOT,
    CBS_UNCHECKEDPRESSED, CBS_UNCHECKEDDISABLED),
    (CBS_CHECKEDNORMAL, CBS_CHECKEDNORMAL, CBS_CHECKEDHOT, CBS_CHECKEDPRESSED,
    CBS_CHECKEDDISABLED), (CBS_MIXEDNORMAL, CBS_MIXEDNORMAL, CBS_MIXEDHOT,
    CBS_MIXEDPRESSED, CBS_MIXEDDISABLED));
var
  ATheme: TdxTheme;
begin
  ATheme := OpenTheme(totButton, AScaleFactor);
  if ATheme <> 0 then
    DrawScaledThemeBackground(ATheme, ACanvas.Handle, BP_CHECKBOX,
      NativeCheckStateMap[ACheckState, AState], R, AScaleFactor)
  else
    inherited;
end;

procedure TcxWinXPLookAndFeelPainter.DrawCheckBorder(ACanvas: TcxCanvas;
...
procedure TcxWinXPLookAndFeelPainter.DrawScaledRadioButton(ACanvas: TcxCanvas;
X, Y: Integer; AButtonState: TcxButtonState; AChecked: Boolean;
AFocused: Boolean; ABrushColor: TColor; AScaleFactor: TdxScaleFactor;
AIsDesigning: Boolean = False);
  ...
  const
    NativeStateMap: array [Boolean, TcxButtonState] of Integer =
      ...
      (RBS_CHECKEDNORMAL, RBS_CHECKEDNORMAL, RBS_CHECKEDHOT, RBS_CHECKEDPRESSED,
      RBS_CHECKEDDISABLED));
  begin
...
begin
  DrawScaledThemeBackground(OpenTheme(totButton, AScaleFactor), ACanvas.Handle,
    BP_RADIOBUTTON, GetNativeState, cxRectBounds(X, Y,
    ScaledRadioButtonSize(AScaleFactor)), AScaleFactor);
end;

function TcxWinXPLookAndFeelPainter.ScaledRadioButtonSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  if not GetThemeScaledPartSize(totButton, AScaleFactor, BP_RADIOBUTTON, Result,
    RBS_UNCHECKEDNORMAL) then
    Result := inherited;
end;

procedure TcxWinXPLookAndFeelPainter.DrawScaledHeader(ACanvas: TcxCustomCanvas;
const ABounds: TRect; AState: TcxButtonState; ANeighbors: TcxNeighbors;
...
AIsGroup: Boolean = False);
  ...
  begin
    if AIsLast and (ButtonStateToHeaderState[AState] = HIS_NORMAL) and
...
begin
  ...
  begin
    ...
    ACanvas.DrawNativeObject(ABounds, TcxCanvasBasedResourceCacheKey.Create
      (Pointer(ATheme), cxSize(ABounds), Ord(AState), AItem),
      procedure(ACanvas: TcxGdiBasedCanvas; const R: TRect)
      begin
        if IsWin10OrLater then
          ACanvas.FillRect(R, clWindow);
        DrawThemeBackground(ATheme, ACanvas.Handle, AItem,
          ButtonStateToHeaderState[AState], R);
      end);
  end
  else
    inherited;
...
procedure TcxWinXPLookAndFeelPainter.DrawScaledHeader(ACanvas: TcxCanvas;
const ABounds, ATextAreaBounds: TRect; ANeighbors: TcxNeighbors;
ABorders: TcxBorders; AState: TcxButtonState; AAlignmentHorz: TAlignment;
AAlignmentVert: TcxAlignmentVert; AMultiLine, AShowEndEllipsis: Boolean;
const AText: string; AFont: TFont; ATextColor, ABkColor: TColor;
...
begin
  ...
  if ATheme <> 0 then
  begin
    DrawScaledHeader(ACanvas, ABounds, AState, ANeighbors, ABorders,
      AScaleFactor, AIsLast, AInGroupByBox);
    R := ATextAreaBounds;
    if AState = cxbsPressed then
      OffsetRect(R, 1, 1);
    DrawContent(ACanvas, ATheme, HP_HEADERITEM,
      ButtonStateToHeaderState[AState], ABounds, R, AAlignmentHorz,
      AAlignmentVert, AMultiLine, AShowEndEllipsis, False, AText, AFont,
      ATextColor, ABkColor);
  end
  else
    inherited;
...
begin
  ...
  DrawScaledHeader(ACanvas, ABounds, ATextAreaBounds, [nRight], ABorders,
    AState, AAlignmentHorz, AAlignmentVert, AMultiLine, AShowEndEllipsis, AText,
    AFont, ATextColor, ABkColor, AScaleFactor);
end;

procedure TcxWinXPLookAndFeelPainter.DrawScaledSortingMark(ACanvas: TcxCanvas;
...
procedure TcxWinXPLookAndFeelPainter.DrawSpreadSheetScaledHeader
  (ACanvas: TcxCanvas; const ABounds, ATextAreaBounds: TRect;
ANeighbors: TcxNeighbors; ABorders: TcxBorders; AState: TcxButtonState;
AAlignmentHorz: TAlignment; AAlignmentVert: TcxAlignmentVert;
AMultiLine, AShowEndEllipsis: Boolean; const AText: string; AFont: TFont;
...
procedure TcxWinXPLookAndFeelPainter.DrawScaledSummarySortingMark
  (ACanvas: TcxCanvas; const R: TRect; AAscendingSorting: Boolean;
AScaleFactor: TdxScaleFactor);
begin
  DrawSummarySortingArrow(ACanvas, R, clBtnShadow, clBtnShadow,
    AAscendingSorting, AScaleFactor);
end;
...
function TcxWinXPLookAndFeelPainter.ScaledSortingMarkSize
  (AScaleFactor: TdxScaleFactor): TPoint;
begin
  Result := AScaleFactor.Apply(Point(7, 8));
end;

procedure TcxWinXPLookAndFeelPainter.DrawFilterRowSeparator(ACanvas: TcxCanvas;
...
begin
  ...
  if ATheme <> 0 then
    DrawThemeEdge(ATheme, ACanvas.Handle, 0, 0, @R, BDR_RAISEDINNER,
      BF_RECT, nil)
  else
    inherited;
end;
...
begin
  ...
  if ATheme <> 0 then
  begin
    DrawThemeBackground(ATheme, ACanvas.Handle, TKP_TRACK, TRS_NORMAL,
      @ABounds);
    DrawContent(ACanvas, ATheme, TKP_TRACK, TRS_NORMAL, ABounds,
      FooterCellTextAreaBounds(ABounds), AAlignmentHorz, AAlignmentVert,
      AMultiLine, False, False, AText, AFont, ATextColor, ABkColor);
  end
  else
    inherited;
end;
...
begin
  ...
  begin
    DrawScaledThemeBackground(ATheme, ACanvas.Handle, WP_SMALLCLOSEBUTTON,
      States[AState], R, AScaleFactor,
      not(IsThemeScalingSupported or
      AScaleFactor.Equals(dxDefaultScaleFactor)));
  end
  else
    inherited;
end;
...
const
  States: array [TcxButtonState] of Integer = (CBXS_NORMAL, CBXS_NORMAL,
    CBXS_HOT, CBXS_PRESSED, CBXS_DISABLED);
begin
  if not dxDrawThemeBackground(ACanvas.Handle, totComboBox, AScaleFactor, R,
    CP_DROPDOWNBUTTON, States[AState]) then
    inherited;
end;

function TcxWinXPLookAndFeelPainter.ScaledFilterActivateButtonSize
  (AScaleFactor: TdxScaleFactor): TPoint;
var
  ASize: TSize;
begin
  if GetThemeScaledPartSize(totButton, AScaleFactor, BP_CHECKBOX, ASize,
    CBS_CHECKEDNORMAL) then
  begin
    Result.X := ASize.cx;
    Result.Y := ASize.cy;
...
function TcxWinXPLookAndFeelPainter.ScaledFilterCloseButtonSize
  (AScaleFactor: TdxScaleFactor): TPoint;
var
  ADelta: Integer;
  ASize: TSize;
...
function TcxWinXPLookAndFeelPainter.DefaultLayoutViewContentTextColor
...
begin
  if OpenTheme(totTab) <> 0 then
    ...
    Result := inherited DefaultLayoutViewCaptionTextColor
      (ACaptionPosition, AState);
end;
...
begin
  ...
  ATheme := OpenTheme(totTab);
  if ATheme <> 0 then
    DrawThemedTab(ACanvas, ABounds, [], '', ATheme, States[AState],
      APosition <> cxgpTop, nil, clDefault, clDefault)
  else
    inherited DrawTab(ACanvas, ABounds, [], '', AState, APosition <> cxgpTop,
      nil, clDefault, clDefault);
end;

procedure TcxWinXPLookAndFeelPainter.LayoutViewDrawItem(ACanvas: TcxCanvas;
const ABounds: TRect; AState: TcxButtonState; ABorders: TcxBorders = []);
begin
  if AState in [cxbsHot, cxbsPressed, cxbsDisabled] then
  begin
    if dxDrawThemeBackground(ACanvas.Handle, totMenu, ABounds, MENU_POPUPITEM,
      IfThen(AState <> cxbsDisabled, 2, 4)) then
      Exit;
  end;
  inherited;
end;

procedure TcxWinXPLookAndFeelPainter.WinExplorerViewDrawRecord
...
function TcxWinXPLookAndFeelPainter.WinExplorerViewRecordTextColor
  (AState: TcxButtonState): TColor;
begin
  if OpenTheme(totTab) <> 0 then
    Result := DefaultTabTextColor
...
begin
  ...
  DrawContent(ACanvas, ATheme, TABP_TABITEM, AState, R, ADrawR, taCenter,
    vaCenter, False, False, AShowPrefix, AText, AFont, ATextColor, ABkColor);
end;
...
begin
  ATheme := OpenTheme(totTab);
  if ATheme <> 0 then
    DrawThemedTab(ACanvas, R, ABorders, AText, ATheme, States[AState],
      AVertical, AFont, ATextColor, ABkColor, AShowPrefix)
  else
    inherited;
end;
...
begin
  ...
  begin
    ...
    if AVertical then
    begin
      Inc(AFullR.Bottom, (R.Bottom - AContentR.Bottom) -
        (AContentR.Top - R.Top));
      Inc(AFullR.Right, 10);
    end
    else
    begin
      Inc(AFullR.Right, (R.Right - AContentR.Right) -
        (AContentR.Left - R.Left));
...
function TcxWinXPLookAndFeelPainter.IsDrawTabImplemented
  (AVertical: Boolean): Boolean;
begin
  Result := (OpenTheme(totTab) <> 0) or inherited IsDrawTabImplemented
    (AVertical);
end;
...
procedure TcxWinXPLookAndFeelPainter.DrawScaledSplitter
  (ACanvas: TcxCustomCanvas; const ARect: TRect;
AHighlighted, AClicked, AHorizontal: Boolean; AScaleFactor: TdxScaleFactor;
AHasCloseMark: Boolean = False; AArrowDirection: TcxArrowDirection = adLeft);
begin
  if AHasCloseMark then
    DrawSplitterCloseMark(ACanvas, ARect, AHighlighted, AClicked, AHorizontal,
      AScaleFactor, AArrowDirection);
end;

procedure TcxWinXPLookAndFeelPainter.DrawScaledIndicatorItem(ACanvas: TcxCanvas;
const R, AImageAreaBounds: TRect; AKind: TcxIndicatorKind; AColor: TColor;
AScaleFactor: TdxScaleFactor; AOnDrawBackground: TcxDrawBackgroundEvent = nil;
...
begin
  if cxLookAndFeelPaintersManager.GetPainter(lfsFlat, APainter) then
    APainter.DrawScaledIndicatorItem(ACanvas, R, AImageAreaBounds, AKind,
      AColor, AScaleFactor, AOnDrawBackground, ANeighbors)
  else
    inherited DrawScaledIndicatorItem(ACanvas, R, AImageAreaBounds, AKind,
      AColor, AScaleFactor, AOnDrawBackground, ANeighbors);
end;

function TcxWinXPLookAndFeelPainter.ScaledScrollBarMinimalThumbSize
  (AVertical: Boolean; AScaleFactor: TdxScaleFactor): Integer;
const
  ThumbnailKind: array [Boolean] of Integer = (SBP_THUMBBTNHORZ,
    SBP_THUMBBTNVERT);

  function GetThumbSize(ATheme: TdxTheme; out ASize: TSize): Boolean;
  begin
    Result := GetThemePartSize(ATheme, 0, ThumbnailKind[AVertical],
      SCRBS_NORMAL, TS_MIN, ASize) = S_OK;
  end;
...
begin
  ...
  begin
    if IsWinVistaOrLater then
      AMargins := GetThemeMargins(ATheme, ThumbnailKind[AVertical],
        SCRBS_NORMAL, TMT_CONTENTMARGINS)
    else
      AMargins := cxNullRect;
    ...
    begin
      ...
      if IsWinVistaOrLater then
        Inc(Result, cxMarginsHeight(AMargins));
    end
    else
    begin
      Result := AThumbSize.cx;
      if IsWinVistaOrLater then
        Inc(Result, cxMarginsWidth(AMargins));
    end;
    Result := AScaleFactor.Apply(Result);
  end
  else
    Result := inherited ScaledScrollBarMinimalThumbSize(AVertical,
      AScaleFactor);
end;
...
AScaleFactor: TdxScaleFactor);
begin
  inherited DrawScaledSplitter(ACanvas, cxTextRect(R), AState = cxbsHot,
    AState = cxbsPressed, False, AScaleFactor);
end;
...
function TcxWinXPLookAndFeelPainter.
  DefaultSchedulerViewContentColorClassic: TColor;
begin
  Result := $D5FFFF;
end;

procedure TcxWinXPLookAndFeelPainter.DrawScaledMonthHeader(ACanvas: TcxCanvas;
const ABounds: TRect; const AText: string; ANeighbors: TcxNeighbors;
const AViewParams: TcxViewParams; AArrows: TcxArrowDirections;
ASideWidth: Integer; AScaleFactor: TdxScaleFactor;
AOnDrawBackground: TcxDrawBackgroundEvent = nil);
begin
  DrawScaledHeader(ACanvas, ABounds, ABounds, ANeighbors, cxBordersAll,
    ...
    not(nRight in ANeighbors));
  DrawMonthHeaderArrows(ACanvas, ABounds, AArrows, ASideWidth, clWindowText);
end;

procedure TcxWinXPLookAndFeelPainter.DrawSchedulerScaledEventProgress
...
AScaleFactor: TdxScaleFactor);
const
  ButtonStates: array [TcxButtonState] of Integer = (TS_HOT, TS_HOT, TS_CHECKED,
    TS_PRESSED, TS_DISABLED);
begin
  if not dxDrawThemeBackground(ACanvas.Handle, totToolBar, AScaleFactor, R,
    TP_BUTTON, ButtonStates[AState]) then
    inherited;
end;
...
var
  AColor: TColor;
begin
  if (OpenTheme(totListView) <> 0) and cxGetThemeColor(totComboBox,
    CP_DROPDOWNBUTTON, CBXS_NORMAL, TMT_BORDERCOLOR, AColor) then
  begin
    ...
    inherited DrawSchedulerSplitterBorder(ACanvas, R, AViewParams,
      AIsHorizontal);
end;

function TcxWinXPLookAndFeelPainter.ScaledSizeGripSize
  (AScaleFactor: TdxScaleFactor): TSize;
var
...
begin
  ...
  if not GetThemeScaledPartSize(totScrollBar, AScaleFactor, SBP_SIZEBOX, Result,
    SZB_RIGHTALIGN, AScaleSource) then
    Result := inherited ScaledSizeGripSize(AScaleFactor);
end;

procedure TcxWinXPLookAndFeelPainter.DoDrawSizeGrip(ACanvas: TcxCanvas;
const ARect: TRect; AScaleFactor: TdxScaleFactor);
begin
  if not dxDrawThemeBackground(ACanvas.Handle, totScrollBar, AScaleFactor,
    ARect, SBP_SIZEBOX, SZB_RIGHTALIGN) then
    inherited;
end;
...
begin
  ...
  if ATheme <> 0 then
  begin
    GetThemePartSize(ATheme, 0, WP_SMALLCLOSEBUTTON, CBXS_NORMAL,
      TS_TRUE, Result);
...
begin
  if not dxDrawThemeBackground(ACanvas.Handle, totButton, R, BP_GROUPBOX,
    StateMap[AEnabled]) then
    inherited DrawGroupBoxFrame(ACanvas, R, AEnabled, ACaptionPosition,
      ABorders);
end;

function TcxWinXPLookAndFeelPainter.GroupBoxTextColor(AEnabled: Boolean;
ACaptionPosition: TcxGroupBoxCaptionPosition): TColor;
const
  GroupBoxStateMap: array [Boolean] of Integer = (GBS_DISABLED, GBS_NORMAL);
begin
  if not cxGetThemeColor(totButton, BP_GROUPBOX, GroupBoxStateMap[AEnabled],
    TMT_TEXTCOLOR, Result) then
...
begin
  if IsWinVistaOrLater then
    dxDrawThemeBackground(ACanvas.Handle, totListBox, R, LBCP_BORDER_NOSCROLL,
      LBPSN_HOT)
  else
...
function TcxWinXPLookAndFeelPainter.GetEditPopupWindowBorderWidth
  (AStyle: TcxEditPopupBorderStyle): Integer;
begin
  Result := 1;
end;

function TcxWinXPLookAndFeelPainter.GetEditPopupWindowClientEdgeWidth
  (AStyle: TcxEditPopupBorderStyle): Integer;
begin
  Result := 2;
end;
...
function TcxWinXPLookAndFeelPainter.GetScaledZoomInButtonSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  if not NativeZoomButtonGetMinSize(ZoomInButtonGlyph, AScaleFactor, Result)
  then
    Result := inherited GetScaledZoomInButtonSize(AScaleFactor);
end;

function TcxWinXPLookAndFeelPainter.GetScaledZoomOutButtonSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  if not NativeZoomButtonGetMinSize(ZoomOutButtonGlyph, AScaleFactor, Result)
  then
    Result := inherited GetScaledZoomOutButtonSize(AScaleFactor);
end;

procedure TcxWinXPLookAndFeelPainter.DrawScaledZoomInButton(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
begin
  if not NativeZoomButtonDraw(ACanvas, R, AState, AScaleFactor,
    ZoomInButtonGlyph) then
    inherited DrawScaledZoomInButton(ACanvas, R, AState, AScaleFactor);
end;

procedure TcxWinXPLookAndFeelPainter.DrawScaledZoomOutButton(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
begin
  if not NativeZoomButtonDraw(ACanvas, R, AState, AScaleFactor,
    ZoomOutButtonGlyph) then
    inherited DrawScaledZoomOutButton(ACanvas, R, AState, AScaleFactor);
end;

procedure TcxWinXPLookAndFeelPainter.DrawHintBackground(ACanvas: TcxCanvas;
const ARect: TRect; AColor: TColor);
begin
  if not dxDrawThemeBackground(ACanvas.Handle, totToolTip,
    cxRectInflate(ARect, 4), TTP_STANDARD, 1) then
...
begin
  if not cxGetThemeColor(totToolTip, TTP_STANDARD, 1, TMT_TEXTCOLOR, Result)
  then
...
begin
  ...
  if ATheme <> 0 then
  begin
    GetThemePartSize(ATheme, ACanvas.Handle, TrackBarThumbThemeParts[ATicks,
      AHorizontal], TUS_NORMAL, ARect, TS_DRAW, AThumbSize);
...
procedure TcxWinXPLookAndFeelPainter.DrawTrackBarScaledTrack(ACanvas: TcxCanvas;
...
begin
  if not dxDrawThemeBackground(ACanvas.Handle, totTrackBar, AScaleFactor, ARect,
    TrackTypeMap[AHorizontal], TUS_NORMAL) then
    inherited;
end;

procedure TcxWinXPLookAndFeelPainter.DrawTrackBarScaledThumb(ACanvas: TcxCanvas;
const ARect: TRect; AState: TcxButtonState; AHorizontal: Boolean;
ATicks: TcxTrackBarTicksAlign; AThumbColor: TColor;
AScaleFactor: TdxScaleFactor);
const
  StateMap: array [TcxButtonState] of Byte = (TUS_HOT, TUS_NORMAL, TUS_HOT,
    TUS_PRESSED, TUS_DISABLED);
var
  ATheme: TdxTheme;
begin
  ATheme := OpenTheme(totTrackBar, AScaleFactor);
...
procedure TcxWinXPLookAndFeelPainter.DrawRangeTrackBarScaledLeftThumb
...
AScaleFactor: TdxScaleFactor);
begin
  DrawNativeRangeTrackBarThumb(ACanvas, ARect, AState, AHorizontal, ATicks,
    AThumbColor, AScaleFactor);
end;

procedure TcxWinXPLookAndFeelPainter.DrawRangeTrackBarScaledRightThumb
  (ACanvas: TcxCanvas; const ARect: TRect; AState: TcxButtonState;
AHorizontal: Boolean; ATicks: TcxTrackBarTicksAlign; AThumbColor: TColor;
AScaleFactor: TdxScaleFactor);
begin
...
begin
  DrawThemeBackground(OpenTheme(totHeader), ACanvas.Handle, HP_HEADERITEMLEFT,
    HIS_NORMAL, R);
end;
...
begin
  ...
  begin
    ...
    cxDrawImage(ACanvas, R, AGlyph, nil, -1, ifmNormal, idmNormal, True, nil,
      AScaleFactor);
  end;
end;

function TcxWinXPLookAndFeelPainter.NativeZoomButtonGetMinSize(AGlyph: TBitmap;
AScaleFactor: TdxScaleFactor; out ASize: TSize): Boolean;
var
  AMargins: TRect;
  ATheme: TdxTheme;
begin
  ...
  begin
    ...
    ASize := cxSize(AGlyph.Width + cxMarginsWidth(AMargins),
      AGlyph.Height + cxMarginsHeight(AMargins));
    ASize := AScaleFactor.Apply(ASize);
  end;
end;

function TcxWinXPLookAndFeelPainter.NavigatorScaledButtonMinSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  Result := AScaleFactor.Apply(Size(18, 19));
end;

function TcxWinXPLookAndFeelPainter.DropDownListBoxItemTextColor
  (ASelected: Boolean): TColor;
begin
  if not cxGetThemeColor(totMenu, MENU_POPUPITEM, MPI_NORMAL, TMT_TEXTCOLOR,
    Result) then
    Result := inherited DropDownListBoxItemTextColor(ASelected);
end;

function TcxWinXPLookAndFeelPainter.DropDownListBoxScaledSeparatorSize
  (AScaleFactor: TdxScaleFactor): Integer;
var
  ASize: TSize;
begin
  if GetThemeScaledPartSize(totMenu, AScaleFactor, MENU_POPUPSEPARATOR, ASize,
    0, tssNoScaling) then
    Result := ASize.cy
  else
...
procedure TcxWinXPLookAndFeelPainter.DrawDropDownListBoxBackground
  ...
  function GetMenuEdgeColor(ATheme: TdxTheme; APropID: Integer;
...
begin
  ...
  begin
    ...
    if AHasBorders then
    begin
      ACanvas.FrameRect(R, GetMenuEdgeColor(ATheme, TMT_EDGELIGHTCOLOR,
        clBtnShadow));
      R.Inflate(-1, -1);
      ACanvas.FrameRect(R, GetMenuEdgeColor(ATheme, TMT_EDGEHIGHLIGHTCOLOR,
        clBtnHighlight));
      R.Inflate(-1, -1);
    end;
    if ATheme <> 0 then
      DrawThemeBackground(ATheme, ACanvas.Handle, MENU_POPUPBACKGROUND,
        0, R, nil)
    else
      ACanvas.FillRect(R, clWindow);
  end
...
begin
  if not dxDrawThemeBackground(ACanvas.Handle, totMenu, AScaleFactor, ARect,
    MENU_POPUPGUTTER, 0) then
...
begin
  ...
  if ATheme <> 0 then
  begin
    GetThemePartSize(ATheme, ACanvas.Handle, MENU_POPUPSEPARATOR, 0, nil,
      TS_TRUE, @ASize);
...
function TcxWinXPLookAndFeelPainter.BreadcrumbEditScaledProgressChunkPadding
  (AScaleFactor: TdxScaleFactor): TRect;
begin
  Result := cxNullRect;
end;

function TcxWinXPLookAndFeelPainter.BreadcrumbEditScaledProgressChunkOverlaySize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  if not(IsWinVistaOrLater and GetThemeScaledPartSize(totProgress, AScaleFactor,
    PP_MOVEOVERLAY, Result, 0, tssSystemDpi)) then
...
begin
  ATheme := OpenTheme(totButton);
  if ATheme <> 0 then
    Result := AScaleFactor.Apply(GetThemeMargins(ATheme, BP_PUSHBUTTON, 0,
      TMT_CONTENTMARGINS), dxSystemScaleFactor)
  else
...
const
  ...
  StatesMap: array [TdxBreadcrumbEditState] of Integer = (ETS_NORMAL,
    ETS_FOCUSED, ETS_HOT, ETS_DISABLED);

  function ExcludeBorders(const R: TRect;
  const ASizingMargins: TdxMargins): TRect;
  begin
    Result := R;
    if not(bLeft in ABorders) then
  ...
  begin
    DrawThemeBackground(ATheme, ACanvas.Handle, PartsMap[IsWinVistaOrLater],
      StatesMap[AState], R);
  end;
...
begin
  ...
  else if ABorders <> cxBordersAll then
  begin
    ACanvas.SaveClipRegion;
    try
      ACanvas.IntersectClipRect(ARect);
      GetThemeMargins(ATheme, 0, PartsMap[IsWinVistaOrLater], 0,
        TMT_SIZINGMARGINS, nil, AMargins);
...
AIsFirst, AIsLast: Boolean; AScaleFactor: TdxScaleFactor);
  ...
  begin
    Result := BreadcrumbEditScaledButtonContentOffsets(AIsFirst, AIsLast,
      AScaleFactor);
    Result.Left := 1;
    Result.Right := 1;
  end;
...
const
  StateMap: array [TdxBreadcrumbEditButtonState] of Integer = (-1, PBS_NORMAL,
    PBS_HOT, PBS_PRESSED, -1);
var
  ATheme: TdxTheme;
begin
  ATheme := OpenTheme(totButton, AScaleFactor);
  if ATheme = 0 then
    inherited DrawBreadcrumbEditScaledButton(ACanvas, ARect, AState, AIsFirst,
      AIsLast, AScaleFactor)
  else if StateMap[AState] >= 0 then
  begin
    ACanvas.SaveClipRegion;
    try
      ACanvas.IntersectClipRect(ARect);
...
begin
  DrawBreadcrumbEditScaledButton(ACanvas, ARect, AState, True, True,
    AScaleFactor);
end;

procedure TcxWinXPLookAndFeelPainter.DrawBreadcrumbEditScaledNode
...
class procedure TcxWinXPLookAndFeelPainter.DrawScaledThemeBackground
  (ATheme: TdxTheme; DC: HDC; APartId, AStateId: Integer; const R: TRect;
AScaleFactor: TdxScaleFactor; AForceScale: Boolean = False;
AUseThemePartSize: Boolean = True);
var
  ABitmap: TcxBitmap32;
  APartSize: TSize;
...
begin
  ...
  begin
    ...
    try
      DrawThemeBackground(ATheme, ABitmap.Canvas.Handle, APartId, AStateId,
        ABitmap.ClientRect);
...
begin
  ...
  if ATheme <> 0 then
    DrawThemeText(ATheme, ACanvas.Handle, BP_PUSHBUTTON,
      BtnStateToXPBtnState(AState), ACaption, -1, DT_CENTER or DT_VCENTER or
      DT_SINGLELINE, 0, R)
  else
    inherited;
end;

procedure TcxWinXPLookAndFeelPainter.DoDrawScaledScrollBarPart
...
const
  ThumbnailKind: array [Boolean] of Integer = (SBP_THUMBBTNVERT,
    SBP_THUMBBTNHORZ);
  ThumbnailGripperKind: array [Boolean] of Integer = (SBP_GRIPPERVERT,
    SBP_GRIPPERHORZ);
  ...
  function CanDrawThumbnailGripper(ATheme: TdxTheme; AElement: Integer)
    : Boolean;
  var
    ASize: TSize;
  begin
    Result := True;
    if GetThemePartSize(ATheme, 0, AElement, SCRBS_NORMAL, TS_TRUE, ASize) = S_OK
    then
      if AHorizontal then
  ...
  procedure DrawPageArea(ATheme: TdxTheme; const R: TRect;
  AState, APart: Integer);
  begin
    ACanvas.DrawNativeObject(R, TcxCanvasBasedResourceCacheKey.Create
      (Pointer(ATheme), R.Size, AState, APart),
      procedure(ACanvas: TcxGdiBasedCanvas; const R: TRect)
      begin
  ...
  procedure DrawThumbnail(ATheme: TdxTheme; const R: TRect;
  AState, APart: Integer);
  var
      ...
      begin
        ...
        if ADrawThumbnailGripper then
          DrawThemeBackground(ATheme, ACanvas.Handle,
            ThumbnailGripperKind[AHorizontal], AState, R);
      end);
  end;
...
begin
  ...
  if ATheme = TC_NONE then
    inherited DoDrawScaledScrollBarPart(ACanvas, AHorizontal, R, APart, AState,
      AScaleFactor)
  else
    case APart of
      sbpLineUp, sbpLineDown:
        DrawScaledArrow(ACanvas, R, AState, GetArrowDirection(AHorizontal,
          APart), AScaleFactor);
      sbpPageUp, sbpPageDown:
        DrawPageArea(ATheme, R, GetThumbnailState, ThumbnailPage[AHorizontal,
          APart = sbpPageUp]);
      sbpThumbnail:
...
begin
  ...
  begin
    ...
    try
      ...
      AContentExtends := BreadcrumbEditScaledButtonContentOffsets(True, True,
        AScaleFactor);
...
begin
  if not dxDrawThemeBackground(ACanvas.Handle, totProgress, AScaleFactor, R,
    PP_CHUNK, 1) then
    inherited DrawBreadcrumbEditScaledProgressChunk(ACanvas, R, AScaleFactor);
end;

procedure TcxWinXPLookAndFeelPainter.
  DrawBreadcrumbEditScaledProgressChunkOverlay(ACanvas: TcxCanvas;
const R: TRect; AScaleFactor: TdxScaleFactor);
begin
  if IsWinVistaOrLater then
    dxDrawThemeBackground(ACanvas.Handle, totProgress, AScaleFactor, R,
      PP_MOVEOVERLAY, 0);
end;
...
function TcxWinXPLookAndFeelPainter.GetScaledBackButtonSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  if not GetThemeScaledPartSize(totNavigation, AScaleFactor, NAV_BACKBUTTON,
    Result) then
    Result := inherited GetScaledBackButtonSize(AScaleFactor);
end;

procedure TcxWinXPLookAndFeelPainter.DrawScaledBackButton(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
const
  StatesMap: array [TcxButtonState] of Integer = (NAV_BB_NORMAL, NAV_BB_NORMAL,
    NAV_BB_HOT, NAV_BB_PRESSED, NAV_BB_DISABLED);
var
  ATheme: TdxTheme;
begin
  ATheme := OpenTheme(totNavigation, AScaleFactor);
  if ATheme <> 0 then
    DrawScaledThemeBackground(ATheme, ACanvas.Handle, NAV_BACKBUTTON,
      StatesMap[AState], R, AScaleFactor)
  else
...
function TcxWinXPLookAndFeelPainter.GetBevelMinimalShapeSize
...
begin
  Result := (OpenTheme(totExplorerListView) <> 0) or
    inherited DrawGalleryItemSelectionFirst;
end;
...
AViewState: TdxGalleryItemViewState);
  ...
  begin
    if AViewState.Pressed then
      Result := LIS_SELECTED
    else if AViewState.Checked then
    begin
    ...
    else if AViewState.Focused then
      Result := LIS_SELECTEDNOTFOCUS
    else if AViewState.Hover then
      Result := LIS_HOT
    else
      Result := LIS_NORMAL;
  end;
...
begin
  ...
  begin
    ...
    begin
      ACanvas.DrawNativeObject(R, TcxCanvasBasedResourceCacheKey.Create
        (Pointer(ATheme), cxSize(R), AState, LVP_LISTITEM),
        procedure(ACanvas: TcxGdiBasedCanvas; const R: TRect)
        begin
...
procedure TcxWinXPLookAndFeelPainter.DrawScaledToggleSwitchState
...
begin
  ...
  try
    dxGPPaintCanvas.Rectangle(ABounds, $707070,
      ToggleSwitchToggleColor(AChecked), 1, psSolid, 255, 255);
  finally
...
function TcxWinXPLookAndFeelPainter.ToggleSwitchToggleColor
  (AChecked: Boolean): TColor;
begin
  if AChecked then
    Result := $A0A0A0
  else
...
function TcxWinXPLookAndFeelPainter.ScaledClockSize(AScaleFactor
...
AScaleFactor: TdxScaleFactor);
begin
  DrawModernCalendarClock(ACanvas, ARect, ADateTime, ABackgroundColor,
    AScaleFactor);
end;
  ...
  begin
    if cesSelected in AStates then
      if cesHot in AStates then
        Result := LIS_HOTSELECTED
      else if cesFocused in AStates then
        Result := LIS_SELECTED
      else
        Result := LIS_SELECTEDNOTFOCUS
    else if cesHot in AStates then
      Result := LIS_HOT
    else
      Result := LIS_NORMAL;
  end;
...
begin
  ...
  begin
    if AStates * [cesHot, cesSelected] <> [] then
      DrawThemeBackground(ATheme, ACanvas.Handle, LVP_LISTITEM,
        GetThemePartState(AStates), ARect, nil);
...
function TcxWinXPLookAndFeelPainter.GetModernCalendarHeaderTextColor
  (AStates: TcxCalendarElementStates): TColor;
begin
  if not cxGetThemeColor(totTextStyle, TEXT_HYPERLINKTEXT, TS_HYPERLINK_NORMAL,
    TMT_TEXTCOLOR, Result) then
    Result := inherited GetModernCalendarHeaderTextColor(AStates);
end;

procedure TcxWinXPLookAndFeelPainter.DrawFindPanelBorder(ACanvas: TcxCanvas;
...
begin
  ...
  begin
    if dxDrawThemeBackground(ACanvas.Handle, totExplorerListView, ARect,
      LVP_LISTITEM, GetThemePartState) then
      Exit;
  end;
  inherited;
end;

procedure TcxWinXPLookAndFeelPainter.DrawWheelPickerItemBorder
  (ACanvas: TcxCanvas; const ARect: TRect; AState: TcxButtonState);
begin
  if (OpenTheme(totExplorerListView) = 0) or
    not(AState in [cxbsPressed, cxbsHot]) then
    inherited;
end;
...
AScaleFactor: TdxScaleFactor);
const
  ButtonStateMap: array [TcxButtonState] of Integer = (-1, -1, PBS_HOT,
    PBS_PRESSED, -1);
var
  ATheme: TdxTheme;
begin
  ...
  else if (ButtonStateMap[AState] >= 0) and not cxRectIsEmpty(R) then
  begin
    ACanvas.SaveClipRegion;
    try
      DrawThemeBackground(ATheme, ACanvas.Handle, BP_PUSHBUTTON,
        ButtonStateMap[AState], cxRectInflate(R, GetThemeMargins(ATheme,
        BP_PUSHBUTTON, 0, TMT_CONTENTMARGINS)));
    finally
      ACanvas.RestoreClipRegion;
    end;
  end;
...
procedure TcxWinXPLookAndFeelPainter.DrawListViewBackground
  (ACanvas: TcxCustomCanvas; ABounds: TRect; AExplorerStyle: Boolean);
const
  ObjectTypeMap: array [Boolean] of TdxThemedObjectType = (totListView,
    totItemsViewListView);
var
  AColor: TColor;
begin
  if cxGetThemeColor(ObjectTypeMap[AExplorerStyle], 0, 0, TMT_FILLCOLOR, AColor)
  then
    ACanvas.FillRect(ABounds, AColor)
  else
    inherited DrawListViewBackground(ACanvas, ABounds, AExplorerStyle);
end;

procedure TcxWinXPLookAndFeelPainter.DrawListViewGroupExpandButton
  (ACanvas: TcxCustomCanvas; const ABounds: TRect; AState: TcxButtonState;
AExpanded: Boolean; AExplorerStyle: Boolean; AScaleFactor: TdxScaleFactor);
const
  ObjectTypeMap: array [Boolean] of TdxThemedObjectType = (totListView,
    totItemsViewListView);
  PartMap: array [Boolean] of Integer = (LVP_COLLAPSEBUTTON, LVP_EXPANDBUTTON);
  StateMap: array [TcxButtonState] of Integer = (1, 1, 2, 3, 1);
begin
  if not(IsWinVistaOrLater and DoDrawThemeBackground(ACanvas,
    ObjectTypeMap[AExplorerStyle], nil, ABounds, PartMap[AExpanded],
    StateMap[AState])) then
    inherited
end;

procedure TcxWinXPLookAndFeelPainter.DrawListViewGroupHeaderBackground
...
AScaleFactor: TdxScaleFactor);
  ...
  begin
    if not(IsWinVistaOrLater and DoDrawThemeBackground(ACanvas,
      totExplorerListView, nil, ABounds, LVP_GROUPHEADER, APartState)) then
...
begin
  ...
  if (dxlgsFocused in AState) and not(dxlgsInactive in AState) then
  begin
    ...
    begin
      R := ABounds;
      R.Deflate(1);
      (ACanvas as TcxCanvas).DrawFocusRect(R);
    end;
  end;
end;

procedure TcxWinXPLookAndFeelPainter.DrawListViewItemBackground
  (ACanvas: TcxCustomCanvas; const ABounds: TRect;
AState: TdxListViewItemStates; AExplorerStyle: Boolean);
  ...
  begin
    if not(IsWinVistaOrLater and DoDrawThemeBackground(ACanvas,
      totItemsViewListView, nil, ABounds, LVP_LISTITEM, APartState)) then
      inherited DrawListViewItemBackground(ACanvas, ABounds, AState,
        AExplorerStyle);
  end;

  procedure DrawNormalItemBackground;
  begin
    DrawListViewBackground(ACanvas, ABounds, AExplorerStyle);
  end;
...
procedure TcxWinXPLookAndFeelPainter.DrawListViewSortingMark
...
begin
  if not IsWinSevenOrLater then
    inherited
  else if not DoDrawThemeBackground(ACanvas, totHeader, AScaleFactor, R,
    HP_HEADERSORTARROW, States[AAscendingSorting]) then
    inherited;
end;

procedure TcxWinXPLookAndFeelPainter.DrawListViewGroupHeaderLine
  (ACanvas: TcxCustomCanvas; const ABounds: TRect);
const
  LineColor = $E5E5E5;
begin
...
function TcxWinXPLookAndFeelPainter.GetListViewColumnHeaderTextColor
  (AState: TcxButtonState; AExplorerStyle: Boolean): TColor;
const
  ObjectTypeMap: array [Boolean] of TdxThemedObjectType = (totHeader,
    totItemsViewHeader);
  PartStateMap: array [TcxButtonState] of Integer = (HIS_NORMAL, HIS_NORMAL,
    HIS_HOT, HIS_PRESSED, HIS_NORMAL);
begin
  if not cxGetThemeColor(ObjectTypeMap[AExplorerStyle], HP_HEADERITEM,
    PartStateMap[AState], TMT_TEXTCOLOR, Result) then
    Result := inherited GetListViewColumnHeaderTextColor(AState,
      AExplorerStyle);
end;

function TcxWinXPLookAndFeelPainter.GetListViewColumnHeaderSortingMarkSize
  (AScaleFactor: TdxScaleFactor): TPoint;
var
  ASize: TSize;
begin
  ...
  ASize := GetThemeScaledPartSize(totHeader, AScaleFactor, HP_HEADERSORTARROW,
    HSAS_SORTEDDOWN);
  if ASize.IsZero then
    Result := inherited GetListViewColumnHeaderSortingMarkSize(AScaleFactor);
end;

function TcxWinXPLookAndFeelPainter.GetListViewItemTextColor
  (AState: TdxListViewItemStates; AExplorerStyle: Boolean): TColor;
const
  ItemStates: array [Boolean] of Cardinal = (MPI_NORMAL, MPI_DISABLED);
begin
  if not cxGetThemeColor(totMenu, MENU_POPUPITEM,
    ItemStates[dxlisDisabled in AState], TMT_TEXTCOLOR, Result) then
    Result := inherited GetListViewItemTextColor(AState, AExplorerStyle);
end;

function TcxWinXPLookAndFeelPainter.GetListViewGroupTextColor
  (AKind: TdxListViewGroupTextKind; AState: TdxListViewGroupHeaderStates;
AExplorerStyle: Boolean): TColor;
const
  PartMap: array [TdxListViewGroupTextKind] of Integer = (TMT_HEADING1TEXTCOLOR,
    TMT_HEADING2TEXTCOLOR, TMT_BODYTEXTCOLOR);
...
const
  ObjectTypeMap: array [Boolean] of TdxThemedObjectType = (totListView,
    totItemsViewListView);
begin
  if not cxGetThemeColor(ObjectTypeMap[AExplorerStyle], LVP_GROUPHEADER,
    GetPartState, PartMap[AKind], Result) then
    Result := inherited GetListViewGroupTextColor(AKind, AState,
      AExplorerStyle);
end;

procedure TcxWinXPLookAndFeelPainter.DrawGanttSheetHeader
  (ACanvas: TcxCustomCanvas; const ABounds: TRect; AState: TcxButtonState;
...
begin
  ...
  DrawTrackBarScaledThumb(ACanvas, R, AState, AHorizontal, tbtaBoth,
    AThumbColor, AScaleFactor);
end;

function TcxWinXPLookAndFeelPainter.DoDrawThemeBackground
  (ACanvas: TcxCustomCanvas; AThemedObjectType: TdxThemedObjectType;
AScaleFactor: TdxScaleFactor; const R: TRect;
...
begin
  ...
  begin
    ACanvas.DrawNativeObject(R, TcxCanvasBasedResourceCacheKey.Create
      (Pointer(ATheme), cxSize(R), AStateId, APartId),
      procedure(ACanvas: TcxGdiBasedCanvas; const R: TRect)
      begin
        AResult := DrawThemeBackground(ATheme, ACanvas.Handle, APartId,
          AStateId, R);
      end);
...
begin
  ...
  begin
    ACanvas.DrawNativeObject(R, TcxCanvasBasedResourceCacheKey.Create
      (Pointer(ATheme), cxSize(R), AStateId, APartId, AScaleFactor.TargetDPI),
      procedure(ACanvas: TcxGdiBasedCanvas; const R: TRect)
      begin
        DrawScaledThemeBackground(ATheme, ACanvas.Handle, APartId, AStateId, R,
          AScaleFactor);
      end);
  end;
end;
...
procedure TcxUltraFlatLookAndFeelPainter.DrawBorder(ACanvas: TcxCustomCanvas;
R: TRect);
begin
  ACanvas.FrameRect(R, clBtnShadow);
end;

procedure TcxUltraFlatLookAndFeelPainter.DoDrawSeparator(ACanvas: TcxCanvas;
R: TRect; AIsVertical: Boolean);
begin
  ACanvas.FillRect(R, clBtnShadow);
end;

function TcxUltraFlatLookAndFeelPainter.ButtonBorderSize
  (AState: TcxButtonState = cxbsNormal): Integer;
begin
...
function TcxUltraFlatLookAndFeelPainter.ButtonColor
  (AState: TcxButtonState): TColor;
begin
  case AState of
    cxbsHot:
...
function TcxUltraFlatLookAndFeelPainter.ScaledButtonFocusRect
  (ACanvas: TcxCanvas; R: TRect; AScaleFactor: TdxScaleFactor): TRect;
begin
  Result := R;
...
function TcxUltraFlatLookAndFeelPainter.ButtonSymbolState
  (AState: TcxButtonState): TcxButtonState;
begin
  Result := cxbsNormal;
end;

function TcxUltraFlatLookAndFeelPainter.ScaledButtonTextOffset
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(2);
end;

function TcxUltraFlatLookAndFeelPainter.ScaledButtonTextShift
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := 0;
end;

procedure TcxUltraFlatLookAndFeelPainter.DrawButtonBorder
...
function TcxUltraFlatLookAndFeelPainter.ScaledExpandButtonSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
...
function TcxUltraFlatLookAndFeelPainter.
  DefaultSchedulerTimeRulerBorderColor: TColor;
begin
  Result := DefaultSchedulerTimeRulerBorderColorClassic;
end;

function TcxUltraFlatLookAndFeelPainter.
  DefaultSchedulerTimeRulerTextColor: TColor;
begin
  Result := DefaultSchedulerTimeRulerTextColorClassic;
end;

procedure TcxUltraFlatLookAndFeelPainter.DrawCheckBorder(ACanvas: TcxCanvas;
R: TRect; AState: TcxButtonState);
begin
  ACanvas.FrameRect(R, clBtnText);
  InflateRect(R, -1, -1);
...
function TcxUltraFlatLookAndFeelPainter.RadioButtonBodyColor
  (AState: TcxButtonState): TColor;
begin
  case AState of
    cxbsHot:
...
procedure TcxUltraFlatLookAndFeelPainter.DrawHeaderBorder
  (ACanvas: TcxCustomCanvas; const R: TRect; ANeighbors: TcxNeighbors;
ABorders: TcxBorders);
begin
  ACanvas.FrameRect(R, clBtnText, 1, ABorders + [bRight, bBottom]);
end;
...
function TcxUltraFlatLookAndFeelPainter.HeaderBorders(ANeighbors: TcxNeighbors)
  : TcxBorders;
begin
...
function TcxUltraFlatLookAndFeelPainter.ScaledSortingMarkSize
  (AScaleFactor: TdxScaleFactor): TPoint;
begin
  Result := AScaleFactor.Apply(Point(7, 8));
end;

function TcxUltraFlatLookAndFeelPainter.ScaledSummarySortingMarkSize
  (AScaleFactor: TdxScaleFactor): TPoint;
begin
...
procedure TcxUltraFlatLookAndFeelPainter.DrawFooterCellBorder
...
procedure TcxUltraFlatLookAndFeelPainter.DrawScaledFilterDropDownButton
  (ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState;
AIsFilterActive: Boolean; AScaleFactor: TdxScaleFactor);
...
function TcxUltraFlatLookAndFeelPainter.ScaledFilterCloseButtonSize
  (AScaleFactor: TdxScaleFactor): TPoint;
begin
  Result := inherited ScaledFilterCloseButtonSize(AScaleFactor);
  Inc(Result.Y);
...
procedure TcxUltraFlatLookAndFeelPainter.DrawTabBorder(ACanvas: TcxCanvas;
R: TRect; ABorder: TcxBorder; ABorders: TcxBorders; AVertical: Boolean);
begin
  if AVertical and (ABorder = bBottom) or not AVertical and (ABorder = bRight)
  then
  begin
...
const R: TRect; ABorders: TcxBorders; AVertical: Boolean);
begin
  ACanvas.DrawComplexFrame(R, TabBorderHighlightColor, TabBorderHighlightColor,
    ABorders, TabBorderSize(AVertical));
end;

function TcxUltraFlatLookAndFeelPainter.TabBorderSize
...
const AIsVertical: Boolean = True);
const
  Borders: array [Boolean, Boolean] of TcxBorders = (([bLeft, bRight, bBottom],
    [bLeft, bTop, bRight]), ([bRight, bTop, bBottom], [bLeft, bTop, bBottom]));
var
  AColor: TColor;
  R: TRect;
begin
  ...
  ACanvas.DrawComplexFrame(R, AColor, AColor,
    Borders[AIsVertical, AIsNextButton]);
  DrawSchedulerNavigationButtonArrow(ACanvas, AArrowRect, AIsNextButton,
    ButtonSymbolColor(AState), AIsVertical);
end;

function TcxUltraFlatLookAndFeelPainter.FilterDropDownButtonBorderColor
  (AState: TcxButtonState): TColor;
begin
...
procedure TcxUltraFlatLookAndFeelPainter.DrawTrackBarTrackBounds
  (ACanvas: TcxCanvas; const ARect: TRect);
begin
  ACanvas.FrameRect(ARect, clWindowText);
end;

procedure TcxUltraFlatLookAndFeelPainter.DrawTrackBarThumbBorderUpDown
  (ACanvas: TcxCanvas; const ALightPolyLine, AShadowPolyLine,
  ADarkPolyLine: TPoints);
begin
...
procedure TcxUltraFlatLookAndFeelPainter.DrawTrackBarThumbBorderBoth
  (ACanvas: TcxCanvas; const ARect: TRect);
begin
  ACanvas.FrameRect(ARect, clWindowText);
end;
...
begin
  ...
  AColor := RGB(GetUltraFlatValue(GetRValue(AColor)),
    GetUltraFlatValue(GetGValue(AColor)), GetUltraFlatValue(GetBValue(AColor)));
  ACanvas.FillRect(R, AColor);
end;

function TcxUltraFlatLookAndFeelPainter.GetSplitterOuterColor
  (AHighlighted: Boolean): TColor;
begin
...
function TcxUltraFlatLookAndFeelPainter.GetScaledSplitterSize
  (AHorizontal: Boolean; AScaleFactor: TdxScaleFactor): TSize;
begin
...
procedure TcxUltraFlatLookAndFeelPainter.DrawNavigatorScaledButton
  (ACanvas: TcxCustomCanvas; R: TRect; AState: TcxButtonState;
...
procedure TcxUltraFlatLookAndFeelPainter.DrawNavigatorBorder
...
procedure TcxUltraFlatLookAndFeelPainter.
  DrawDropDownListBoxScaledGutterBackground(ACanvas: TcxCanvas;
const ARect: TRect; AScaleFactor: TdxScaleFactor);
begin
  ACanvas.FillRect(ARect, clBtnFace);
end;

function TcxUltraFlatLookAndFeelPainter.DropDownListBoxItemTextColor
  (ASelected: Boolean): TColor;
begin
  Result := clMenuText;
end;
...
function TcxUltraFlatLookAndFeelPainter.
  BreadcrumbEditScaledButtonAreaSeparatorSize(AScaleFactor
  : TdxScaleFactor): Integer;
begin
  Result := 1;
end;
...
function TcxUltraFlatLookAndFeelPainter.BreadcrumbEditScaledButtonContentOffsets
  (AIsFirst, AIsLast: Boolean; AScaleFactor: TdxScaleFactor): TRect;
begin
  Result := AScaleFactor.Apply(cxRect(3 - Ord(AIsFirst), 3,
    3 - Ord(AIsLast), 3));
end;
...
AState: TdxBreadcrumbEditState);
const
  ColorMap: array [TdxBreadcrumbEditState] of TColor = (clBtnShadow,
    clHighlight, clHighlight, clBtnShadow);
begin
  ACanvas.FrameRect(ARect, ColorMap[AState], 1, ABorders);
end;

procedure TcxUltraFlatLookAndFeelPainter.
  DrawBreadcrumbEditScaledButtonAreaSeparator(ACanvas: TcxCanvas;
const ARect: TRect; AState: TdxBreadcrumbEditState;
AScaleFactor: TdxScaleFactor);
begin
...
ABorders: TcxBorders);
const
  BorderColorsMap: array [TdxBreadcrumbEditButtonState] of TColor = (clNone,
    clBtnShadow, clHighlight, clHighlight, clNone);
begin
...
function TcxUltraFlatLookAndFeelPainter.GetBevelMinimalShapeSize
  (AShape: TdxBevelShape): TSize;
begin
  Result := cxSize(1, 1);
end;

procedure TcxUltraFlatLookAndFeelPainter.GetBevelShapeColors(out AColor1,
  AColor2: TColor);
begin
  AColor1 := clBtnShadow;
  AColor2 := clNone;
...
AScaleFactor: TdxScaleFactor);
const
  ColorMap: array [TcxButtonState] of TColor = (clBtnShadow, clBtnShadow,
    clHighlight, clHighlight, clBtnShadow);
begin
...
function TcxUltraFlatLookAndFeelPainter.ToggleSwitchToggleColor
  (AChecked: Boolean): TColor;
begin
  if AChecked then
    Result := $FF9933
...
procedure TcxUltraFlatLookAndFeelPainter.DoDrawScaledScrollBarPart
  (ACanvas: TcxCustomCanvas; AHorizontal: Boolean; R: TRect;
APart: TcxScrollBarPart; AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
begin
    ...
    sbpThumbnail, sbpLineUp, sbpLineDown:
      begin
        ...
        if APart <> sbpThumbnail then
          DrawScaledScrollBarArrow(ACanvas, R, AState,
            GetArrowDirection(AHorizontal, APart), AScaleFactor);
      end;
  end;
end;
...
begin
  ACanvas.RoundRect(R.Left, R.Top, R.Right, R.Bottom, R.Width - 1,
    R.Height - 1);
end;
...
AButtonState: TcxButtonState; AChecked, AFocused, AIsDesigning: Boolean);
  ...
  begin
    ...
    try
      ...
      cxDrawImage(ACanvas.Handle, AGlyphRect, AGlyphRect, ABitmap, nil, -1,
        idmNormal, True, 0, clDefault, False)
    finally
      ABitmap.Free;
    end;
  end;
...
begin
  ...
  if ABrushColor = clDefault then
    cxDrawImage(ACanvas.Handle, ARect, ARect, nil, FList, AImageIndex,
      idmNormal, True, 0, clDefault, False)
  else
...
var
  ...
  function GetRadioButtonBodyColor(ALookAndFeelKind: TcxLookAndFeelKind;
  AButtonState: TcxButtonState): TColor;
  var
    APainter: TcxCustomLookAndFeelPainter;
  begin
    if cxLookAndFeelPaintersManager.GetPainter
      (cxLookAndFeelStyleMap[ALookAndFeelKind], APainter) then
  ...
  begin
    ...
    case ALookAndFeelKind of
      ...
      lfUltraFlat:
        begin
          if AFocused or (AButtonState in [cxbsHot, cxbsPressed]) or
            (AIsDesigning and (AButtonState <> cxbsDisabled)) then
      ...
      lfOffice11: // TODO: to method
        begin
          ...
          else if AFocused or (AButtonState in [cxbsHot, cxbsPressed]) or AIsDesigning
          then
            AColorMap[1] := dxOffice11SelectedBorderColor
          else
            AColorMap[1] := clBtnText;
          // dxOffice11BarFloatingBorderColor1; //clBtnShadow;
          AColorMap[2] := AColorMap[1];
          AColorMap[3] := AColorMap[5];
          AColorMap[4] := AColorMap[5];
        end;
    ...
    else if AButtonState <> cxbsDisabled then
      AColorMap[6] := clWindowText
    else if ALookAndFeelKind = lfOffice11 then
  ...
  try
    ...
    for AFocused := False to True do
      for AIsDesigning := False to True do
        for ALookAndFeelKind := Low(TcxLookAndFeelKind)
          to High(TcxLookAndFeelKind) do
          for AChecked := False to True do
            for AButtonState := Succ(Low(TcxButtonState))
              to High(TcxButtonState) do
            begin
              ...
              for I := 0 to FRadioButtonSize.cy - 1 do
                for J := 0 to FRadioButtonSize.cx - 1 do
                  AColors[I * ABitmap.Width + J] :=
                    dxColorToRGBQuad(AColorMap[FRadioButtonPattern[I, J]]);

              SetBitmapBits(ABitmap, AColors, True);
              FList.Add(ABitmap, FButtonMask);
              AImageListIndexMapIndex := GetImageListIndexMapIndex
                (ALookAndFeelKind, AButtonState, AChecked, AFocused,
                AIsDesigning);
              if AImageListIndexMapIndex + 1 >
                Length(FRadioButtonImageListIndexes) then
                SetLength(FRadioButtonImageListIndexes,
                  AImageListIndexMapIndex + 1);
              FRadioButtonImageListIndexes[AImageListIndexMapIndex] :=
                FList.Count - 1;
            end;
  finally
    ABitmap.Free;
...
begin
  ...
  FRadioButtonMaskSize.cx := ScaleFactor.Apply(B.bmWidth div 4,
    dxSystemScaleFactor);
  FRadioButtonMaskSize.cy := ScaleFactor.Apply(B.bmHeight div 3,
    dxSystemScaleFactor);
  ABitmap := cxCreateBitmap(FRadioButtonMaskSize);
  try
    ABitmap.Canvas.Brush.Color := 0;
    ABitmap.Canvas.FillRect(Rect(0, 0, FRadioButtonMaskSize.cx,
      FRadioButtonMaskSize.cy));
    ...
    ABitmap.Canvas.FillRect(Rect(0, 0, FRadioButtonMaskSize.cx,
      FRadioButtonMaskSize.cy));
    DrawFrameControl(ABitmap.Canvas.Handle, Rect(0, 0, FRadioButtonMaskSize.cx,
      FRadioButtonMaskSize.cy), DFC_BUTTON, DFCS_BUTTONRADIOIMAGE + DFCS_FLAT +
      DFCS_CHECKED);
...
function TcxRadioButtonImageList.GetImageIndex(ALookAndFeelKind
  : TcxLookAndFeelKind; AButtonState: TcxButtonState;
AChecked, AFocused, AIsDesigning: Boolean): Integer;
begin
...
function TcxRadioButtonImageList.GetImageListIndexMapIndex(ALookAndFeelKind
  : TcxLookAndFeelKind; AButtonState: TcxButtonState;
AChecked, AFocused, AIsDesigning: Boolean): Integer;
var
...
begin
  ...
  Result := (Integer(AFocused) * 2 * ALookAndFeelKindCount +
    Integer(AIsDesigning) * ALookAndFeelKindCount + Integer(ALookAndFeelKind)) *
    8 + Integer(AChecked) * 4 + AButtonStateIndex;
end;
...
procedure TcxRadioButtonImageList.PrepareRadioButtonPattern;
    ...
    try
      ...
      begin
        ...
        begin
          ...
          else if (FRadioButtonSize.cy - 1) * (FRadioButtonSize.cx - 1 - J) < I
            * (FRadioButtonSize.cx - 1) then
  ...
  procedure PrepareInnerCircle;
    ...
    var
      ASign: Integer;
    begin
      ASign := (FRadioButtonSize.cy - 1) * (FRadioButtonSize.cx - 1 - J) - I *
        (FRadioButtonSize.cx - 1);
      if ASign = 0 then
...
begin
  if (ScaleFactor.Denominator <> AScaleFactor.Denominator) or
    (ScaleFactor.Numerator <> AScaleFactor.Numerator) then
  begin
    FScaleFactor.Assign(AScaleFactor);
    Reinitialize;
  end;
...
function TcxCustomLookAndFeelPainter.CreateLookAndFeelPainterDetails: TObject;
  ...
  var
    AResName: string;
  begin
    AResName := 'CX_LOOKANDFEELSTYLEICON_' + UpperCase(LookAndFeelName) +
      SuffixMap[AIcon];
...
function TcxCustomLookAndFeelPainter.
  DefaultDateNavigatorHeaderHighlightTextColor: TColor;
begin
  if IsWinVistaOrLater then
    Result := clHotLight
  else
...
procedure TcxCustomLookAndFeelPainter.DoDrawScaledScrollBarPart
  (ACanvas: TcxCustomCanvas; AHorizontal: Boolean; R: TRect;
APart: TcxScrollBarPart; AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
begin
  case APart of
    sbpPageUp, sbpPageDown:
      ACanvas.DrawNativeObject(R, TcxCanvasBasedResourceCacheKey.Create(Self,
        cxSize(R), Ord(AState), Ord(APart), AScaleFactor.TargetDPI),
        procedure(ACanvas: TcxGdiBasedCanvas; const R: TRect)
        begin
          FillRect(ACanvas.Handle, R,
            StdScrollBrushes[AState = cxbsPressed].Handle);
        end);
  end;
end;
...
begin
  ...
  else if ABackgroundBitmap <> nil then
...
var
  ...
  begin
    ASize := _GetSize;
    P[0] := Point((R.Left + R.Right - ASize.X) div 2,
      MulDiv(R.Top + R.Bottom - ASize.Y, 1, 2));
...
begin
  ...
  begin
    ...
    ACanvas.Font.Color := ATextColor;
    ACanvas.Brush.Style := bsClear;
    ACanvas.DrawText(AText, ATextAreaBounds, cxAlignmentsHorz[AAlignmentHorz] or
...
procedure TcxCustomLookAndFeelPainter.DrawContentBackground
  (ACanvas: TcxCustomCanvas; const R: TRect; AState: TcxButtonState;
...
procedure TcxCustomLookAndFeelPainter.DrawExpandButtonCross
  (ACanvas: TcxCustomCanvas; const R: TRect; AExpanded: Boolean; AColor: TColor;
AScaleFactor: TdxScaleFactor);
var
  ASize, X, Y: Integer;
begin
  ...
  ACanvas.FillRect(Rect(X - ASize div 2, Y, X + ASize div 2 + 1,
    Y + 1), AColor);
  if not AExpanded then
    ACanvas.FillRect(Rect(X, Y - ASize div 2, X + 1,
      Y + ASize div 2 + 1), AColor);
end;

procedure TcxCustomLookAndFeelPainter.DrawListViewColumnHeaderSortingArrow
  (ACanvas: TcxCustomCanvas; const R: TRect; AColor1, AColor2: TColor;
AAscendingSorting: Boolean; AScaleFactor: TdxScaleFactor);
var
...
begin
  DrawScaledIndicatorCustomizationMark(ACanvas, R, AColor,
...
begin
  ...
  begin
    ADestRect := R;
    cxRightToLeftDependentDraw(ACanvas.Handle, ADestRect,
      ACanvas.UseRightToLeftAlignment and (AKind in [ikArrow, ikMultiArrow]),
      procedure
      begin
        cxDrawImage(ACanvas, ADestRect, nil, cxIndicatorImages, Ord(AKind) - 1,
          ifmNormal, idmNormal, False, nil, AScaleFactor);
      end);
  end;
end;

procedure TcxCustomLookAndFeelPainter.DrawMonthHeaderLeftArrow
...
procedure TcxCustomLookAndFeelPainter.DrawMonthHeaderRightArrow
  (ACanvas: TcxCanvas; const ABounds: TRect; AColor: TColor);
var
  R: TRect;
begin
...
procedure TcxCustomLookAndFeelPainter.DrawMonthHeaderArrows(ACanvas: TcxCanvas;
const ABounds: TRect; AArrows: TcxArrowDirections; ASideWidth: Integer;
AColor: TColor);
begin
...
procedure TcxCustomLookAndFeelPainter.DrawSummarySortingArrow
...
begin
  Result := ABounds;
  Result.Deflate(FooterCellBorderSize, FooterCellBorderSize);
end;
...
begin
  ...
  Result.Deflate(cxTextOffset, cxTextOffset);
  Result.Deflate(TdxVisualRefinements.Padding);
end;

function TcxCustomLookAndFeelPainter.GetArrowDirection(AHorizontal: Boolean;
APart: TcxScrollBarPart): TcxArrowDirection;
const
  ArrowKind: array [Boolean, Boolean] of TcxArrowDirection = ((adUp, adDown),
    (adLeft, adRight));
begin
  Result := ArrowKind[AHorizontal, APart <> sbpLineUp];
end;

function TcxCustomLookAndFeelPainter.GetFilterAddButtonColor
...
function TcxCustomLookAndFeelPainter.GetFilterRemoveButtonColor
  (AState: TcxButtonState): TdxAlphaColor;
begin
  case AState of
    cxbsHot, cxbsDefault:
...
function TcxCustomLookAndFeelPainter.GetSeparatorBounds(const R: TRect;
AWidth: Integer; AIsVertical: Boolean): TRect;
var
  P: TPoint;
begin
  P := cxRectCenter(R);
...
function TcxCustomLookAndFeelPainter.DefaultContentGlyphColorPalette
...
function TcxCustomLookAndFeelPainter.DefaultCustomScrollbarAnnotationColor
  : TdxAlphaColor;
begin
  Result := $FFA9A9A9;
end;
...
function TcxCustomLookAndFeelPainter.
  DefaultDateNavigatorHolydayTextColor: TColor;
begin
  Result := clRed;
end;
...
function TcxCustomLookAndFeelPainter.
  DefaultDateNavigatorSeparator1Color: TColor;
begin
  Result := clBtnShadow;
end;

function TcxCustomLookAndFeelPainter.
  DefaultDateNavigatorSeparator2Color: TColor;
begin
  Result := clWindow;
end;

function TcxCustomLookAndFeelPainter.
  DefaultDateNavigatorTodayFrameColor: TColor;
begin
  Result := clMaroon;
end;
...
function TcxCustomLookAndFeelPainter.DefaultDateNavigatorTodayTextColor
  (ASelected: Boolean): TColor;
begin
  if ASelected then
    Result := clDefault
...
begin
  Result := DefaultEditorBackgroundColorEx
    (cxEditStateColorKindMap[not AIsDisabled]);
end;
...
function TcxCustomLookAndFeelPainter.DefaultErrorScrollbarAnnotationColor
  : TdxAlphaColor;
begin
...
function TcxCustomLookAndFeelPainter.DefaultFocusedScrollbarAnnotationColor
  : TdxAlphaColor;
begin
...
function TcxCustomLookAndFeelPainter.DefaultGroupContentOffsets
...
function TcxCustomLookAndFeelPainter.DefaultSearchResultAnnotationColor
  : TdxAlphaColor;
begin
  Result := $96FFA500;
end;

function TcxCustomLookAndFeelPainter.DefaultSelectedScrollbarAnnotationColor
  : TdxAlphaColor;
begin
...
function TcxCustomLookAndFeelPainter.
  DefaultSchedulerDayHeaderBorderColor: TColor;
begin
  Result := $E1E1E1;
end;
...
function TcxCustomLookAndFeelPainter.DefaultSchedulerDateNavigatorArrowColor
  (AIsHighlight: Boolean): TColor;
begin
  if AIsHighlight then
    Result := DefaultDateNavigatorHeaderHighlightTextColor
...
function TcxCustomLookAndFeelPainter.
  DefaultSchedulerTimeRulerBorderColorClassic: TColor;
begin
  Result := clBtnShadow;
end;
...
function TcxCustomLookAndFeelPainter.
  DefaultSchedulerTimeRulerColorClassic: TColor;
begin
  Result := DefaultHeaderColor;
end;
...
function TcxCustomLookAndFeelPainter.DefaultSchedulerEventColor
...
function TcxCustomLookAndFeelPainter.DefaultSchedulerEventColorClassic
  (AIsAllDayEvent: Boolean): TColor;
const
...
function TcxCustomLookAndFeelPainter.
  DefaultSchedulerHeaderContainerAlternateBackgroundColor: TColor;
begin
  Result := dxOffice11SelectedDownColor1;
end;

function TcxCustomLookAndFeelPainter.
  DefaultSchedulerHeaderContainerBackgroundColor(ASelected: Boolean): TColor;
begin
  if ASelected then
...
function TcxCustomLookAndFeelPainter.DefaultSchedulerHeaderContainerTextColor
  (ASelected: Boolean): TColor;
begin
  if ASelected then
...
function TcxCustomLookAndFeelPainter.
  DefaultSchedulerHeaderContainerBorderColor: TColor;
begin
  Result := $E1E1E1;
end;
...
function TcxCustomLookAndFeelPainter.
  DefaultSchedulerSelectedEventBorderColor: TColor;
begin
  Result := clBlack;
end;
...
function TcxCustomLookAndFeelPainter.
  DefaultChartDiagramValueBorderColor: TColor;
begin
  Result := clBlack;
end;

function TcxCustomLookAndFeelPainter.
  DefaultChartDiagramValueCaptionTextColor: TColor;
begin
  Result := clBlack;
end;
...
function TcxCustomLookAndFeelPainter.
  DefaultChartPieDiagramSeriesSiteBorderColor: TColor;
begin
  Result := clBtnShadow;
end;

function TcxCustomLookAndFeelPainter.
  DefaultChartPieDiagramSeriesSiteCaptionColor: TColor;
begin
  Result := clSkyBlue;
end;

function TcxCustomLookAndFeelPainter.
  DefaultChartPieDiagramSeriesSiteCaptionTextColor: TColor;
begin
  Result := clNavy;
end;
...
function TcxCustomLookAndFeelPainter.DefaultLayoutViewCaptionColor
  (AState: TcxButtonState): TColor;
begin
  case AState of
    cxbsHot:
...
function TcxCustomLookAndFeelPainter.DefaultLayoutViewCaptionTextColor
  (ACaptionPosition: TcxGroupBoxCaptionPosition;
AState: TcxButtonState): TColor;
begin
...
function TcxCustomLookAndFeelPainter.DefaultLayoutViewContentTextColor
  (AState: TcxButtonState): TColor;
begin
  case AState of
    cxbsPressed:
...
function TcxCustomLookAndFeelPainter.DefaultGridOptionsTreeViewCategoryColor
  (ASelected: Boolean): TColor;
begin
  if ASelected then
    Result := clHighlight
...
function TcxCustomLookAndFeelPainter.DefaultGridOptionsTreeViewCategoryTextColor
  (ASelected: Boolean): TColor;
begin
  if ASelected then
    Result := clHighlightText
...
function TcxCustomLookAndFeelPainter.GetGalleryScaledGroupHeaderContentOffsets
  (AScaleFactor: TdxScaleFactor): TRect;
begin
...
function TcxCustomLookAndFeelPainter.GetGalleryItemCaptionTextColor
...
function TcxCustomLookAndFeelPainter.GetGalleryItemColorPalette
  (const AState: TdxGalleryItemViewState): IdxColorPalette;
begin
  Result := nil;
end;

function TcxCustomLookAndFeelPainter.GetGalleryItemDescriptionTextColor
  (const AState: TdxGalleryItemViewState): TColor;
begin
  Result := clGrayText;
end;

procedure TcxCustomLookAndFeelPainter.DrawGalleryBackground
  (ACanvas: TcxCustomCanvas; const ABounds: TRect);
begin
  ACanvas.FillRect(ABounds, clWhite);
end;

procedure TcxCustomLookAndFeelPainter.DrawGalleryGroupHeader
  (ACanvas: TcxCustomCanvas; const ABounds: TRect);
begin
  DrawScaledHeader(ACanvas, ABounds, cxbsNormal, [], cxBordersAll,
    dxDefaultScaleFactor);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawGalleryItemImageFrame
  (ACanvas: TcxCustomCanvas; const R: TRect);
begin
...
begin
  ...
  begin
    ...
    FCalendarButtonGlyph.LoadFromResource(HInstance,
      'CX_CALENDARBUTTON', 'SVG');
  end;
...
function TcxCustomLookAndFeelPainter.GetFilterControlAddButtonGlyph
  : TdxSmartImage;
begin
  if FFilterControlAddButtonGlyph = nil then
  begin
    FFilterControlAddButtonGlyph := TdxSmartImage.Create;
    FFilterControlAddButtonGlyph.LoadFromResource(HInstance,
      'DX_FILTERCONTROLADDBUTTON', 'SVG');
  end;
  Result := FFilterControlAddButtonGlyph;
end;

function TcxCustomLookAndFeelPainter.GetFilterControlRemoveButtonGlyph
  : TdxSmartImage;
begin
  if FFilterControlRemoveButtonGlyph = nil then
  begin
    FFilterControlRemoveButtonGlyph := TdxSmartImage.Create;
    FFilterControlRemoveButtonGlyph.LoadFromResource(HInstance,
      'DX_FILTERCONTROLREMOVEBUTTON', 'SVG');
  end;
  Result := FFilterControlRemoveButtonGlyph;
end;

function TcxCustomLookAndFeelPainter.GetFilterPanelRemoveButtonGlyph
  : TdxSmartImage;
begin
  if FFilterPanelRemoveButtonGlyph = nil then
  begin
    FFilterPanelRemoveButtonGlyph := TdxSmartImage.Create;
    FFilterPanelRemoveButtonGlyph.LoadFromResource(HInstance,
      'DX_FILTERPANELREMOVEBUTTON', 'SVG');
  end;
...
function TcxCustomLookAndFeelPainter.GetFindPanelPreviousButtonGlyph
  : TdxSmartImage;
begin
...
begin
  ...
  begin
    ...
    FFixedGroupIndicator.LoadFromResource(HInstance,
      'CX_FIXEDGROUPINDICATOR', 'PNG');
  end;
  Result := FFixedGroupIndicator;
end;

function TcxCustomLookAndFeelPainter.GetGroupByBoxSearchButtonGlyph
  : TdxSmartImage;
begin
  if FGroupByBoxSearchButtonGlyph = nil then
  begin
    FGroupByBoxSearchButtonGlyph := TdxSmartImage.Create;
    FGroupByBoxSearchButtonGlyph.LoadFromResource(HInstance,
      'CX_GROUPBYBOXSEARCHBUTTON', 'SVG');
  end;
...
function TcxCustomLookAndFeelPainter.GetNavigationBarCustomizationButton
  : TdxSmartImage;
begin
  if FNavigationBarCustomizationButton = nil then
  begin
    FNavigationBarCustomizationButton := TdxSmartImage.Create;
    FNavigationBarCustomizationButton.LoadFromResource(HInstance,
      'DX_NAVIGATIONBARCUSTOMIZATIONBUTTON', 'PNG');
  end;
  Result := FNavigationBarCustomizationButton;
end;

function TcxCustomLookAndFeelPainter.GetPasswordRevealButtonGlyphs
  (Index: Boolean): TdxSmartImage;
...
begin
  ...
  begin
    FPasswordRevealButtonGlyphs[True] :=
      LoadGlyph('DX_PASSWORDREVEALVISIBLEBUTTON');
    FPasswordRevealButtonGlyphs[False] :=
      LoadGlyph('DX_PASSWORDREVEALINVISIBLEBUTTON');
  end;
...
begin
  ...
  begin
    ...
    FRatingControlIndicator.LoadFromResource(HInstance,
      'CX_RATINGCONTROLINDICATOR', 'PNG');
  end;
...
begin
  ...
  begin
    ...
    FSearchButtonGlyph.LoadFromResource(HInstance,
      'DX_SEARCHBUTTONGLYPH', 'PNG');
  end;
...
function TcxCustomLookAndFeelPainter.GetScaledBackButtonSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  Result := AScaleFactor.Apply(cxSize(BackButton.Width,
    BackButton.Height div 4));
end;

procedure TcxCustomLookAndFeelPainter.DrawBackButton(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState);
begin
  DrawScaledBackButton(ACanvas, R, AState, dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledBackButton(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
const
...
var
  ASourceRect: TRect;
begin
  ASourceRect := cxRectSetHeight(BackButton.ClientRect,
    GetScaledBackButtonSize(dxDefaultScaleFactor).cy);
  ASourceRect := cxRectOffset(ASourceRect, 0, OffsetMap[AState] *
    GetScaledBackButtonSize(dxDefaultScaleFactor).cy);
  BackButton.StretchDraw(ACanvas.Handle, R, ASourceRect);
end;

procedure TcxCustomLookAndFeelPainter.DrawBevelFrame(ACanvas: TcxCanvas;
const R: TRect; AColor1, AColor2: TColor; ABoxStyle: Boolean);
var
...
const R: TRect; AColor1, AColor2: TColor; AIsVertical: Boolean);
const
  BordersMap: array [Boolean] of TcxBorders = ([bTop, bBottom],
    [bLeft, bRight]);
begin
  if AColor2 <> clNone then
...
procedure TcxCustomLookAndFeelPainter.DrawBevelShape(ACanvas: TcxCanvas;
const R: TRect; AShape: TdxBevelShape; AStyle: TdxBevelStyle);
...
begin
  ...
  case AShape of
    dxbsLineTop:
      DrawBevelLine(ACanvas, cxRectSetHeight(R, AMinSize.cy), AColor1,
        AColor2, False);
    dxbsLineBottom:
      DrawBevelLine(ACanvas, cxRectSetBottom(R, R.Bottom, AMinSize.cy), AColor1,
        AColor2, False);
    dxbsLineLeft:
      DrawBevelLine(ACanvas, cxRectSetWidth(R, AMinSize.cx), AColor1,
        AColor2, True);
    dxbsLineRight:
      DrawBevelLine(ACanvas, cxRectSetRight(R, R.Right, AMinSize.cx), AColor1,
        AColor2, True);
    dxbsLineCenteredHorz:
      DrawBevelLine(ACanvas, cxRectCenterHorizontally(R, AMinSize.cx), AColor1,
        AColor2, True);
    dxbsLineCenteredVert:
      DrawBevelLine(ACanvas, cxRectCenterVertically(R, AMinSize.cy), AColor1,
        AColor2, False);
    dxbsBox, dxbsFrame:
...
function TcxCustomLookAndFeelPainter.GetBevelMinimalShapeSize
  (AShape: TdxBevelShape): TSize;
begin
  Result := cxSize(2);
end;

procedure TcxCustomLookAndFeelPainter.GetBevelShapeColors(out AColor1,
  AColor2: TColor);
begin
  AColor1 := clBtnShadow;
...
procedure TcxCustomLookAndFeelPainter.DrawModernCalendarArrow
  (ACanvas: TcxCanvas; const ARect: TRect; ADirection: TcxArrowDirection;
AState: TcxCalendarElementState);
begin
  DrawScaledModernCalendarArrow(ACanvas, ARect, ADirection, AState,
    dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledModernCalendarArrow
  (ACanvas: TcxCanvas; const ARect: TRect; ADirection: TcxArrowDirection;
...
begin
  ...
  else if AState = cesDisabled then
    AColor := clGrayText
  else
    AColor := clBtnText;
  ACanvas.Brush.Color := AColor;
...
procedure TcxCustomLookAndFeelPainter.DrawModernCalendarClock
  (ACanvas: TcxCanvas; const ARect: TRect; ADateTime: TDateTime;
ABackgroundColor: TColor; AScaleFactor: TdxScaleFactor);
var
  ABitmap: TcxBitmap;
begin
  ...
  try
    ...
    DrawScaledModernClockHands(ABitmap.cxCanvas, ARect, ADateTime, $464646,
      AScaleFactor);
...
function TcxCustomLookAndFeelPainter.GetModernCalendarCellTextColor
  (AStates: TcxCalendarElementStates): TColor;
begin
  if cesDisabled in AStates then
    Result := clGrayText
  else if (cesHot in AStates) or
...
function TcxCustomLookAndFeelPainter.GetModernCalendarHeaderTextColor
  (AStates: TcxCalendarElementStates): TColor;
begin
  Result := clHotLight;
end;
...
function TcxCustomLookAndFeelPainter.
  GetModernCalendarMarkedCellBorderColor: TColor;
begin
  Result := clHotLight;
end;
...
procedure TcxCustomLookAndFeelPainter.DrawModernClockHands(ACanvas: TcxCanvas;
const ARect: TRect; ADateTime: TDateTime; AColor: TColor);
begin
  DrawScaledModernClockHands(ACanvas, ARect, ADateTime, AColor,
    dxDefaultScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledModernClockHands
  (ACanvas: TcxCanvas; const ARect: TRect; ADateTime: TDateTime; AColor: TColor;
AScaleFactor: TdxScaleFactor);

  procedure DrawHand(AGPGraphics: TdxGPGraphics; const R: TRect; AAngle: Single;
  AStartOffset, AEndOffset: Single; AWidth: Single; AHandColor: TColor);
  var
  ...
  begin
    ...
    AGPGraphics.Line(ACenter.X - ARadius.X * AStartOffset * Cos(AAngle),
      ACenter.Y - ARadius.Y * AStartOffset * Sin(AAngle),
      ACenter.X + ARadius.X * AEndOffset * Cos(AAngle), ACenter.Y + ARadius.Y *
      AEndOffset * Sin(AAngle), dxColorToAlphaColor(AHandColor),
      AWidth * AScaleFactor.Numerator / AScaleFactor.Denominator);
  end;
...
begin
  ...
  try
    ...
    AAngle := Pi * 2 * ((AHour mod 12) * 60 * 60 + AMin * 60 + ASec - 3 * 60 *
      60) / 12 / 60 / 60;
...
begin
  DrawRatingControlScaledIndicator(ACanvas, ABounds, AState,
    dxSystemScaleFactor);
end;
...
function TcxCustomLookAndFeelPainter.GetRatingControlScaledIndicatorSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  Result := AScaleFactor.Apply(cxSize(RatingControlIndicator.Width,
    RatingControlIndicator.Height div 3));
end;

procedure TcxCustomLookAndFeelPainter.DrawFixedGroupIndicator
  (ACanvas: TcxCanvas; const ABounds: TRect);
begin
...
function TcxCustomLookAndFeelPainter.GetScaledFixedGroupIndicatorSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  Result := AScaleFactor.Apply(FixedGroupIndicator.Size)
end;

function TcxCustomLookAndFeelPainter.GetWheelPickerBorderItemColor
  (AState: TcxButtonState): TColor;
begin
  case AState of
    cxbsHot:
...
function TcxCustomLookAndFeelPainter.GetWheelPickerColorPalette
  (AState: TcxButtonState): IdxColorPalette;
begin
  Result := nil;
end;

function TcxCustomLookAndFeelPainter.GetWheelPickerFillItemColor
  (AState: TcxButtonState): TColor;
begin
  case AState of
    cxbsHot:
...
procedure TcxCustomLookAndFeelPainter.DrawWheelPickerItem(ACanvas: TcxCanvas;
const ARect: TRect; AState: TcxButtonState);
begin
...
procedure TcxCustomLookAndFeelPainter.DrawWheelPickerItemBackground
  (ACanvas: TcxCanvas; const ARect: TRect; AState: TcxButtonState);
begin
  ACanvas.FillRect(ARect, GetWheelPickerFillItemColor(AState));
end;

procedure TcxCustomLookAndFeelPainter.DrawWheelPickerItemBorder
  (ACanvas: TcxCanvas; const ARect: TRect; AState: TcxButtonState);
begin
...
function TcxCustomLookAndFeelPainter.
  RichEditControlHeaderFooterLineColor: TColor;
begin
  Result := clBtnShadow;
end;
...
function TcxCustomLookAndFeelPainter.
  RichEditRulerTabTypeToggleBorderColor: TColor;
begin
  Result := cl3DDkShadow;
end;
...
procedure TcxCustomLookAndFeelPainter.DrawTokenBackground(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState);
begin
...
AScaleFactor: TdxScaleFactor);
begin
  DrawScaledButtonCrossEx(ACanvas, R, GetTokenTextColor(AState), AState, 7,
    AScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawTokenCloseGlyph(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState);
begin
...
function TcxCustomLookAndFeelPainter.GetScaledTokenCloseGlyphSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
...
function TcxCustomLookAndFeelPainter.GetTokenColorPalette
  (AState: TcxButtonState): IdxColorPalette;
begin
  Result := nil;
end;

function TcxCustomLookAndFeelPainter.GetScaledTokenContentOffsets
  (AScaleFactor: TdxScaleFactor): TRect;
begin
...
function TcxCustomLookAndFeelPainter.GetScaledTokenDefaultGlyphSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
...
function TcxCustomLookAndFeelPainter.GetTokenTextColor
  (AState: TcxButtonState): TColor;
begin
  Result := ButtonSymbolColor(AState);
end;
...
var P: TcxArrowPoints; AArrowDirection: TcxArrowDirection;
AProportional: Boolean; AArrowSize: Integer = 0);
...
begin
  ...
  begin
    ADelta := (R.Right - R.Left) - (R.Bottom - R.Top);
    if ADelta > 0 then
  ...
  case AArrowDirection of
    adUp:
      begin
        P[cxArrowTopPointIndex] := Point((R.Left + R.Right - 1) div 2,
          MulDiv(R.Top + R.Bottom - ASize.cy, 1, 2) { - 1 } );
        P[cxArrowLeftBasePointIndex] :=
          Point((R.Left + R.Right - ASize.cx) div 2, P[cxArrowTopPointIndex].Y +
          ASize.cy - 1);
        P[cxArrowRightBasePointIndex] :=
          Point(P[cxArrowLeftBasePointIndex].X + ASize.cx - 1,
          P[cxArrowLeftBasePointIndex].Y);
      end;
    adDown:
      begin
        P[cxArrowRightBasePointIndex] :=
          Point((R.Left + R.Right - ASize.cx) div 2,
          MulDiv(R.Top + R.Bottom - ASize.cy, 1, 2));
        P[cxArrowLeftBasePointIndex] :=
          Point(P[cxArrowRightBasePointIndex].X + ASize.cx - 1,
          P[cxArrowRightBasePointIndex].Y);
        P[cxArrowTopPointIndex] := Point((R.Left + R.Right - 1) div 2,
          P[cxArrowRightBasePointIndex].Y + ASize.cy - 1);
      end;
    adLeft:
      begin
        P[cxArrowTopPointIndex] := Point((R.Left + R.Right - ASize.cx) div 2,
          (R.Top + R.Bottom (* *) ) div 2);
        P[cxArrowRightBasePointIndex] :=
          Point(P[cxArrowTopPointIndex].X + ASize.cx - 1,
          MulDiv(R.Top + R.Bottom - ASize.cy, 1, 2));
        P[cxArrowLeftBasePointIndex] := Point(P[cxArrowRightBasePointIndex].X,
          P[cxArrowRightBasePointIndex].Y + ASize.cy - 1);
      end;
    adRight:
      begin
        P[cxArrowLeftBasePointIndex] :=
          Point((R.Left + R.Right - ASize.cx) div 2,
          MulDiv(R.Top + R.Bottom - ASize.cy, 1, 2));
        P[cxArrowTopPointIndex] :=
          Point(P[cxArrowLeftBasePointIndex].X + ASize.cx - 1,
          (R.Top + R.Bottom (* *) ) div 2);
        P[cxArrowRightBasePointIndex] := Point(P[cxArrowLeftBasePointIndex].X,
          P[cxArrowLeftBasePointIndex].Y + ASize.cy - 1);
      end;
  end;
end;
...
begin
  DrawScaledArrow(ACanvas, R, AState, AArrowDirection, dxSystemScaleFactor,
    ADrawBorder);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawArrowBorder(ACanvas: TcxCustomCanvas;
const R: TRect; AState: TcxButtonState);
begin
  DrawScaledArrowBorder(ACanvas, R, AState, dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawCollapseArrow(ACanvas: TcxCanvas;
R: TRect; AColor: TColor; ALineWidth: Integer = 1);
...
procedure TcxCustomLookAndFeelPainter.DrawScaledScrollBarArrow
  (ACanvas: TcxCustomCanvas; R: TRect; AState: TcxButtonState;
...
begin
  DrawScaledScrollBarArrow(ACanvas, R, AState, AArrowDirection,
    dxSystemScaleFactor);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawBorder(ACanvas: TcxCustomCanvas;
R: TRect);
begin
  // do nothing
end;

procedure TcxCustomLookAndFeelPainter.DrawContainerBorder(ACanvas: TcxCanvas;
...
begin
  case AStyle of
    ...
    cbs3D:
      begin
        ACanvas.DrawEdge(R, True, True, ABorders);
        ACanvas.DrawComplexFrame(cxRectInflate(R, -1, -1), cl3DDkShadow,
          cl3DLight, ABorders);
      end;
  end;
end;

procedure TcxCustomLookAndFeelPainter.DoDrawSeparator(ACanvas: TcxCanvas;
R: TRect; AIsVertical: Boolean);
begin
  Dec(R.Right);
  Dec(R.Bottom);
...
procedure TcxCustomLookAndFeelPainter.DrawSeparator(ACanvas: TcxCanvas;
const R: TRect; AIsVertical: Boolean);
begin
  DoDrawSeparator(ACanvas, GetSeparatorBounds(R, SeparatorSize, AIsVertical),
    AIsVertical);
end;

function TcxCustomLookAndFeelPainter.ButtonBorderSize
  (AState: TcxButtonState = cxbsNormal): Integer;
begin
  Result := 0;
end;

function TcxCustomLookAndFeelPainter.ButtonColor
  (AState: TcxButtonState): TColor;
begin
  Result := clBtnFace;
end;

function TcxCustomLookAndFeelPainter.ButtonColorPalette(AState: TcxButtonState)
  : IdxColorPalette;
begin
  Result := nil;
end;
...
function TcxCustomLookAndFeelPainter.ScaledButtonFocusRect(ACanvas: TcxCanvas;
R: TRect; AScaleFactor: TdxScaleFactor): TRect;
begin
  Result := R;
...
function TcxCustomLookAndFeelPainter.ButtonFocusRect(ACanvas: TcxCanvas;
R: TRect): TRect;
begin
  Result := ScaledButtonFocusRect(ACanvas, R, dxSystemScaleFactor);
end;

function TcxCustomLookAndFeelPainter.ScaledButtonTextOffset
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := 0;
end;
...
function TcxCustomLookAndFeelPainter.ScaledButtonTextShift
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := ScaledButtonTextShift(dxSystemScaleFactor);
end;

function TcxCustomLookAndFeelPainter.ButtonSymbolColor(AState: TcxButtonState;
ADefaultColor: TColor = clDefault): TColor;
begin
  if AState = cxbsDisabled then
    Result := clBtnShadow
...
function TcxCustomLookAndFeelPainter.ButtonSymbolState(AState: TcxButtonState)
  : TcxButtonState;
begin
  Result := AState;
end;
...
R: TRect; AState: TcxButtonState; AScaleFactor: TdxScaleFactor;
APart: TcxButtonPart; AColor: TColor);
begin
  DrawScaledButton(ACanvas, R, AState, AScaleFactor, True, False,
    APart, AColor);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawScaledButton(ACanvas: TcxCanvas;
R: TRect; const ACaption: string; AState: TcxButtonState;
AScaleFactor: TdxScaleFactor; ADrawBorder: Boolean = True;
AColor: TColor = clDefault; ATextColor: TColor = clDefault;
AWordWrap: Boolean = False; AIsToolButton: Boolean = False;
APart: TcxButtonPart = cxbpButton);
begin
  DrawScaledButton(ACanvas, R, AState, AScaleFactor, ADrawBorder, AIsToolButton,
    APart, AColor);
  if ACaption <> '' then
    DoDrawScaledButtonCaption(ACanvas, R, ACaption, AState, ATextColor,
      ADrawBorder, AIsToolButton, AWordWrap, AScaleFactor, APart);
end;

procedure TcxCustomLookAndFeelPainter.DrawButton(ACanvas: TcxCanvas; R: TRect;
...
function TcxCustomLookAndFeelPainter.GetScaledClearButtonGlyphSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  Result := AScaleFactor.Apply(ClearButtonGlyph.Size);
end;

function TcxCustomLookAndFeelPainter.GetScaledDropDownButtonRightPartSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
...
procedure TcxCustomLookAndFeelPainter.DrawScaledCommandLinkBackground
  (ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState;
AScaleFactor: TdxScaleFactor; AColor: TColor = clDefault);
begin
...
AColor: TColor = clDefault);
begin
  DrawScaledCommandLinkBackground(ACanvas, R, AState,
    dxSystemScaleFactor, AColor);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledCommandLinkGlyph
  (ACanvas: TcxCanvas; const AGlyphPos: TPoint; AState: TcxButtonState;
AScaleFactor: TdxScaleFactor);
var
  ADestRect: TRect;
...
begin
  ...
  try
    ACommandLinkGlyphs.LoadFromResource(HInstance,
      'CX_COMMANDLINKGLYPH', 'PNG');
    ...
    if AState = cxbsHot then
      ASrcRect := cxRectSetOrigin(ASrcRect,
        Point(0, GetScaledCommandLinkGlyphSize(dxDefaultScaleFactor).cy));
    cxRightToLeftDependentDraw(ACanvas, ADestRect, procedure
      begin
...
function TcxCustomLookAndFeelPainter.GetScaledCommandLinkGlyphSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
...
function TcxCustomLookAndFeelPainter.GetScaledCommandLinkMargins
  (AScaleFactor: TdxScaleFactor): TRect;
begin
...
begin
  ...
  if not Odd(ASize) then
    Dec(ASize);
  DrawScaledButtonCrossEx(ACanvas, R, AColor, AState, ASize,
    dxDefaultScaleFactor);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawScaledButtonCrossEx
  (ACanvas: TcxCanvas; const R: TRect; AColor: TColor; AState: TcxButtonState;
ASize: Integer; AScaleFactor: TdxScaleFactor);

  procedure DrawOneMark(ADelta: Integer);
  var
    P: TPoint;
  begin
    P := Point((R.Left + R.Right - ASize) div 2 + ADelta,
      (R.Top + R.Bottom - ASize) div 2);
    if AState = cxbsPressed then
    begin
      Inc(P.X);
      Inc(P.Y);
...
procedure TcxCustomLookAndFeelPainter.DrawButtonBorder(ACanvas: TcxCustomCanvas;
R: TRect; AState: TcxButtonState);
begin
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledClearButtonGlyph
  (ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
AScaleFactor: TdxScaleFactor);
var
...
procedure TcxCustomLookAndFeelPainter.DrawScaledDropDownButtonArrow
  (ACanvas: TcxCustomCanvas; R: TRect; AState: TcxButtonState;
AScaleFactor: TdxScaleFactor; AColor: TColor = clDefault);
begin
  DrawScaledButton(ACanvas, R, AState, AScaleFactor, False, False,
    cxbpDropDownRightPart, AColor);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawScaledPasswordRevealButton
  (ACanvas: TcxCanvas; const ARect: TRect; AButtonState: TcxButtonState;
AColor: TColor; AScaleFactor: TdxScaleFactor);
var
...
begin
  ...
  PasswordRevealButtonGlyphs[AButtonState = cxbsPressed].StretchDraw
    (ACanvas.Handle, ARect, MaxByte, APalette);
end;

procedure TcxCustomLookAndFeelPainter.DrawSearchEditButtonGlyph
  (ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState);
begin
...
procedure TcxCustomLookAndFeelPainter.DrawScaledExpandButton(ACanvas: TcxCanvas;
const R: TRect; AExpanded: Boolean; AScaleFactor: TdxScaleFactor;
AColor: TColor = clDefault; AState: TcxExpandButtonState = cebsNormal);
begin
  DrawScaledExpandButton(TcxCustomCanvas(ACanvas), R, AExpanded, AScaleFactor,
    AColor, AState);
  ACanvas.ExcludeClipRect(R);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledExpandButtonEx
  (ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
AExpanded: Boolean; AScaleFactor: TdxScaleFactor;
ARotationAngle: TcxRotationAngle = ra0);
var
...
begin
  ...
  try
    ...
    DrawScaledExpandMark(ABitmap.cxCanvas, ABitmap.ClientRect,
      ButtonSymbolColor(AState), AExpanded, AScaleFactor);
...
procedure TcxCustomLookAndFeelPainter.DrawExpandButtonEx(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState; AExpanded: Boolean;
ARotationAngle: TcxRotationAngle = ra0);
begin
  DrawScaledExpandButtonEx(ACanvas, R, AState, AExpanded, dxSystemScaleFactor,
    ARotationAngle);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawScaledGroupExpandButton
  (ACanvas: TcxCanvas; const R: TRect; AExpanded: Boolean;
AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
begin
  DrawScaledButton(ACanvas, R, AState, AScaleFactor);
  DrawScaledExpandMark(ACanvas, R, ButtonSymbolColor(AState), AExpanded,
    AScaleFactor);
end;
...
begin
  DrawScaledGroupExpandButton(ACanvas, R, AExpanded, AState,
    dxSystemScaleFactor);
end;
...
begin
  DrawScaledSmallExpandButton(ACanvas, R, AExpanded, ABorderColor,
    dxSystemScaleFactor, AColor);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledSmallExpandButton
  (ACanvas: TcxCanvas; R: TRect; AExpanded: Boolean; ABorderColor: TColor;
AScaleFactor: TdxScaleFactor; AColor: TColor = clDefault);
begin
...
function TcxCustomLookAndFeelPainter.ScaledExpandButtonAreaSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := ScaledExpandButtonSize(AScaleFactor);
...
function TcxCustomLookAndFeelPainter.ScaledGroupExpandButtonSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(15);
end;
...
function TcxCustomLookAndFeelPainter.IsPointOverGroupExpandButton
  (const R: TRect; const P: TPoint): Boolean;
begin
  Result := PtInRect(R, P);
end;

function TcxCustomLookAndFeelPainter.ScaledSearchButtonGlyphSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
...
function TcxCustomLookAndFeelPainter.ScaledSmallExpandButtonSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
...
function TcxCustomLookAndFeelPainter.ScaledCheckButtonAreaSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
...
function TcxCustomLookAndFeelPainter.CheckButtonColor(AState: TcxButtonState;
ACheckState: TcxCheckBoxState): TColor;
const
  Colors1: array [TcxCheckBoxState] of TColor = (clWindow, clWindow, clBtnFace);
  Colors2: array [TcxButtonState] of TColor = (clWindow, clWindow, clWindow,
    clBtnFace, clBtnFace);
begin
  if AState = cxbsNormal then
...
function TcxCustomLookAndFeelPainter.ScaledCheckButtonSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
...
procedure TcxCustomLookAndFeelPainter.DrawScaledCheck(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState; ACheckState: TcxCheckBoxState;
AColor: TColor; AScaleFactor: TdxScaleFactor);
  ...
  begin
    ...
    begin
      Result[I].X := MulDiv(ATemplate[I].X, ASize.cx, 1000) -
        (Trunc(ASize.cx * 0.15) + 1);
...
procedure TcxCustomLookAndFeelPainter.DrawCheck(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState; ACheckState: TcxCheckBoxState;
AColor: TColor);
begin
...
procedure TcxCustomLookAndFeelPainter.DrawScaledCheck(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState; AChecked: Boolean; AColor: TColor;
AScaleFactor: TdxScaleFactor);
const
  CheckStatesMap: array [Boolean] of TcxCheckBoxState = (cbsUnchecked,
    cbsChecked);
begin
  DrawScaledCheck(ACanvas, R, AState, CheckStatesMap[AChecked], AColor,
    AScaleFactor);
end;
...
begin
  DrawScaledCheckButton(ACanvas, R, AState, CheckStates[AChecked],
    AScaleFactor);
end;
...
function TcxCustomLookAndFeelPainter.ToggleSwitchToggleColor
  (AChecked: Boolean): TColor;
begin
  Result := 0;
end;
...
ABounds: TRect; AState: TcxButtonState; AThumbBounds: TRect;
AScaleFactor: TdxScaleFactor);
  ...
  begin
    ...
    try
      ...
      DrawScaledToggleSwitchState(ACanvas, ABounds, AState, AChecked,
        AScaleFactor);
    finally
...
begin
  if ABounds.Left = AThumbBounds.Left then
    DrawScaledToggleSwitchState(ACanvas, ABounds, AState,
      ACanvas.UseRightToLeftAlignment, AScaleFactor)
  else if ABounds.Right = AThumbBounds.Right then
    DrawScaledToggleSwitchState(ACanvas, ABounds, AState,
      not ACanvas.UseRightToLeftAlignment, AScaleFactor)
  else
  begin
...
procedure TcxCustomLookAndFeelPainter.DrawToggleSwitch(ACanvas: TcxCanvas;
ABounds: TRect; AState: TcxButtonState; AThumbBounds: TRect);
begin
  DrawScaledToggleSwitch(ACanvas, ABounds, AState, AThumbBounds,
    dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawToggleSwitchState(ACanvas: TcxCanvas;
ABounds: TRect; AState: TcxButtonState; AChecked: Boolean);
begin
  DrawScaledToggleSwitchState(ACanvas, ABounds, AState, AChecked,
    dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledToggleSwitchState
  (ACanvas: TcxCanvas; ABounds: TRect; AState: TcxButtonState;
AChecked: Boolean; AScaleFactor: TdxScaleFactor);
begin
  // do nothing
...
begin
  ...
  try
    ACanvas.Font := AFont;
    cxDrawText(ACanvas, AText, ABounds, DT_SINGLELINE or DT_CENTER or
      DT_VCENTER, GetToggleSwitchTextColor);
  finally
    ACanvas.RestoreState;
  end;
end;
...
procedure TcxCustomLookAndFeelPainter.DrawToggleSwitchThumb(ACanvas: TcxCanvas;
ABounds: TRect; AState: TcxButtonState);
begin
  DrawScaledToggleSwitchThumb(ACanvas, ABounds, AState, dxSystemScaleFactor);
end;

function TcxCustomLookAndFeelPainter.GetToggleSwitchColorPalette
  : IdxColorPalette;
begin
  Result := nil;
end;
...
procedure TcxCustomLookAndFeelPainter.DrawScaledRadioButton(ACanvas: TcxCanvas;
X, Y: Integer; AButtonState: TcxButtonState; AChecked, AFocused: Boolean;
ABrushColor: TColor; AScaleFactor: TdxScaleFactor;
AIsDesigning: Boolean = False);
begin
  TcxRadioButtonImageListManager.Get(AScaleFactor).Draw(ACanvas, X, Y,
    ABrushColor, cxLookAndFeelKindMap[LookAndFeelStyle], AButtonState, AChecked,
    AFocused, AIsDesigning);
end;
...
ABrushColor: TColor; AIsDesigning: Boolean = False);
begin
  DrawScaledRadioButton(ACanvas, X, Y, AButtonState, AChecked, AFocused,
    ABrushColor, dxSystemScaleFactor, AIsDesigning);
end;

function TcxCustomLookAndFeelPainter.RadioButtonBodyColor
  (AState: TcxButtonState): TColor;
begin
  case AState of
...
function TcxCustomLookAndFeelPainter.ScaledRadioButtonSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
...
begin
  ...
  ACanvas.DrawComplexFrame(R, AOuterColor, AInnerColor,
...
procedure TcxCustomLookAndFeelPainter.DrawGaugeControlBackground
...
function TcxCustomLookAndFeelPainter.MapControlPanelHotTrackedTextColor
  : TdxAlphaColor;
begin
  Result := $FFFFFFFF;
end;

function TcxCustomLookAndFeelPainter.MapControlPanelPressedTextColor
  : TdxAlphaColor;
begin
  Result := $FF7E8383;
end;
...
function TcxCustomLookAndFeelPainter.MapControlGetMapPushpinSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  Result := AScaleFactor.Apply(MapPushpin.Size);
end;

function TcxCustomLookAndFeelPainter.MapControlGetMapPushpinTextOrigin
  (AScaleFactor: TdxScaleFactor): TPoint;
begin
  Result := AScaleFactor.Apply(Point(17, 17));
end;

function TcxCustomLookAndFeelPainter.MapControlMapCustomElementSelectionOffset
  (AScaleFactor: TdxScaleFactor): TRect;
begin
  Result := AScaleFactor.Apply(cxRect(14, 14, 14, 14));
end;

function TcxCustomLookAndFeelPainter.MapControlMapCustomElementTextColor
  : TdxAlphaColor;
begin
  Result := $FF000000;
end;

function TcxCustomLookAndFeelPainter.MapControlMapCustomElementTextGlowColor
  : TdxAlphaColor;
begin
  Result := $FFFFFFFF;
end;

function TcxCustomLookAndFeelPainter.MapControlMapPushpinTextColor
  : TdxAlphaColor;
begin
  Result := $FF000000;
end;

function TcxCustomLookAndFeelPainter.MapControlMapPushpinTextGlowColor
  : TdxAlphaColor;
begin
  Result := $FFFFFFFF;
end;
...
function TcxCustomLookAndFeelPainter.MapControlSelectedRegionBackgroundColor
  : TdxAlphaColor;
begin
  Result := $800072AE;
end;

function TcxCustomLookAndFeelPainter.MapControlSelectedRegionBorderColor
  : TdxAlphaColor;
begin
  Result := $FF3399FF;
end;
...
function TcxCustomLookAndFeelPainter.MapControlShapeBorderWidth
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(1);
end;

function TcxCustomLookAndFeelPainter.MapControlShapeHighlightedColor
  : TdxAlphaColor;
begin
  Result := $FFD7D7D7;
end;

function TcxCustomLookAndFeelPainter.MapControlShapeBorderHighlightedColor
  : TdxAlphaColor;
begin
  Result := $FFFFFFFF;
end;

function TcxCustomLookAndFeelPainter.MapControlShapeBorderHighlightedWidth
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(1);
end;

function TcxCustomLookAndFeelPainter.MapControlShapeSelectedColor
  : TdxAlphaColor;
begin
  Result := $FFD7D7D7;
end;

function TcxCustomLookAndFeelPainter.MapControlShapeBorderSelectedColor
  : TdxAlphaColor;
begin
  Result := $FFFFFFFF;
end;

function TcxCustomLookAndFeelPainter.MapControlShapeBorderSelectedWidth
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(1);
end;

procedure TcxCustomLookAndFeelPainter.DrawMapCustomElementBackground
...
begin
  ...
  try
    AGPGraphics.SmoothingMode := smAntiAlias;
    AGPGraphics.RoundRect(cxRectInflate(ARect, -GetBorderWidth,
      -GetBorderWidth), GetBorderColor, GetBackgroundColor, 4, 4,
      GetBorderWidth);
  finally
    dxGpEndPaint(AGPGraphics);
  end;
...
procedure TcxCustomLookAndFeelPainter.DrawMapPushpin(ACanvas: TcxCanvas;
...
AColor: TdxAlphaColor);
begin
  OfficeNavigationBarDrawScaledCustomizationButton(ACanvas, ARect, AState,
    dxSystemScaleFactor, AColor);
end;

procedure TcxCustomLookAndFeelPainter.OfficeNavigationBarDrawBackground
  (ACanvas: TcxCanvas; const ARect: TRect);
begin
...
procedure TcxCustomLookAndFeelPainter.OfficeNavigationBarDrawImageSelection
  (ACanvas: TcxCanvas; const ARect: TRect; AState: TcxCalendarElementState);
begin
  OfficeNavigationBarDrawScaledImageSelection(ACanvas, ARect, AState,
    dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.
  OfficeNavigationBarButtonItemDrawBackground(ACanvas: TcxCanvas;
const ARect: TRect; AState: TcxCalendarElementState);
begin
  OfficeNavigationBarDrawScaledButtonItemBackground(ACanvas, ARect, AState,
    dxSystemScaleFactor);
end;
...
procedure TcxCustomLookAndFeelPainter.OfficeNavigationBarItemDrawBackground
  (ACanvas: TcxCanvas; const ARect: TRect; AState: TcxCalendarElementState);
begin
  OfficeNavigationBarDrawScaledItemBackground(ACanvas, ARect, AState,
    dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.
  OfficeNavigationBarDrawScaledCustomizationButton(ACanvas: TcxCanvas;
const ARect: TRect; AState: TcxCalendarElementState;
AScaleFactor: TdxScaleFactor; AColor: TdxAlphaColor = dxacDefault);
var
  AImage: TdxGPImage;
begin
...
procedure TcxCustomLookAndFeelPainter.
  OfficeNavigationBarDrawScaledItemBackground(ACanvas: TcxCanvas;
const ARect: TRect; AState: TcxCalendarElementState;
AScaleFactor: TdxScaleFactor);
begin
  // do nothing
...
procedure TcxCustomLookAndFeelPainter.
  OfficeNavigationBarDrawScaledImageSelection(ACanvas: TcxCanvas;
const ARect: TRect; AState: TcxCalendarElementState;
AScaleFactor: TdxScaleFactor);
begin
  case AState of
...
function TcxCustomLookAndFeelPainter.
  OfficeNavigationBarCustomizationButtonSize: TSize;
begin
  Result := OfficeNavigationBarScaledCustomizationButtonSize
    (dxSystemScaleFactor);
end;

function TcxCustomLookAndFeelPainter.
  OfficeNavigationBarButtonItemContentOffsets: TRect;
begin
  Result := OfficeNavigationBarScaledButtonItemContentOffsets
    (dxSystemScaleFactor);
end;

function TcxCustomLookAndFeelPainter.
  OfficeNavigationBarButtonItemFontSize: Integer;
begin
  Result := OfficeNavigationBarScaledButtonItemFontSize(dxSystemScaleFactor);
end;

function TcxCustomLookAndFeelPainter.OfficeNavigationBarButtonItemTextColor
...
function TcxCustomLookAndFeelPainter.
  OfficeNavigationBarItemContentOffsets: TRect;
begin
  Result := OfficeNavigationBarScaledItemContentOffsets(dxSystemScaleFactor);
end;

function TcxCustomLookAndFeelPainter.OfficeNavigationBarItemTextColor
  (AState: TcxCalendarElementState): TColor;
begin
  case AState of
    cesNormal:
...
function TcxCustomLookAndFeelPainter.OfficeNavigationBarScaledButtonItemFontSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(9);
end;

function TcxCustomLookAndFeelPainter.OfficeNavigationBarScaledContentOffsets
  (AScaleFactor: TdxScaleFactor): TRect;
begin
...
function TcxCustomLookAndFeelPainter.
  OfficeNavigationBarScaledCustomizationButtonSize(AScaleFactor
  : TdxScaleFactor): TSize;
begin
  Result := AScaleFactor.Apply(NavigationBarCustomizationButton.Size);
end;

function TcxCustomLookAndFeelPainter.OfficeNavigationBarScaledItemContentOffsets
  (AScaleFactor: TdxScaleFactor): TRect;
begin
  Result := AScaleFactor.Apply(cxRect(2, 2, 2, 2));
end;

function TcxCustomLookAndFeelPainter.OfficeNavigationBarScaledItemFontSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(19);
end;

function TcxCustomLookAndFeelPainter.PDFViewerNavigationPaneButtonColorPalette
  (AState: TcxButtonState): IdxColorPalette;
begin
  Result := nil;
end;

function TcxCustomLookAndFeelPainter.PDFViewerNavigationPaneButtonContentOffsets
  (AScaleFactor: TdxScaleFactor): TRect;
begin
  Result := AScaleFactor.Apply(cxRect(2, 2, 2, 2));
end;

function TcxCustomLookAndFeelPainter.PDFViewerNavigationPaneButtonOverlay
  (AScaleFactor: TdxScaleFactor): TPoint;
begin
  Result.X := PDFViewerNavigationPaneContentOffsets(AScaleFactor).Left;
  Result.Y := PDFViewerNavigationPaneContentOffsets(AScaleFactor).Top +
    BorderSize;
end;

function TcxCustomLookAndFeelPainter.PDFViewerNavigationPaneButtonRect
  (const ARect: TRect; AState: TcxButtonState; ASelected: Boolean;
AScaleFactor: TdxScaleFactor): TRect;
var
  ADelta: TPoint;
begin
...
function TcxCustomLookAndFeelPainter.PDFViewerNavigationPaneButtonSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  Result := AScaleFactor.Apply(cxSize(42, 42));
end;

function TcxCustomLookAndFeelPainter.PDFViewerNavigationPaneContentOffsets
  (AScaleFactor: TdxScaleFactor): TRect;
begin
  Result := AScaleFactor.Apply(cxRect(4, 4, 4, 4));
end;
...
function TcxCustomLookAndFeelPainter.PDFViewerNavigationPanePageContentOffsets
  (AScaleFactor: TdxScaleFactor): TRect;
begin
...
procedure TcxCustomLookAndFeelPainter.PDFViewerDrawNavigationPaneBackground
  (ACanvas: TcxCanvas; const ARect: TRect; AScaleFactor: TdxScaleFactor);
begin
  PDFViewerDrawFindPanelBackground(ACanvas, ARect, [bRight]);
end;

procedure TcxCustomLookAndFeelPainter.PDFViewerDrawNavigationPaneButton
  (ACanvas: TcxCanvas; const ARect: TRect; AState: TcxButtonState;
AScaleFactor: TdxScaleFactor; AMinimized, ASelected, AIsFirst: Boolean);
var
  AButtonRect: TRect;
begin
  AButtonRect := PDFViewerNavigationPaneButtonRect(ARect, cxbsPressed,
    ASelected, AScaleFactor);
  ...
  begin
    ...
    ACanvas.FillRect(cxRectContent(AButtonRect, cxRect(0, BorderSize, 0,
      BorderSize)), DefaultControlColor);
  end;
end;

procedure TcxCustomLookAndFeelPainter.PDFViewerDrawNavigationPanePageBackground
  (ACanvas: TcxCanvas; const ARect: TRect);
begin
  PDFViewerDrawFindPanelBackground(ACanvas, ARect, [bRight]);
end;

procedure TcxCustomLookAndFeelPainter.PDFViewerDrawNavigationPanePageButton
  (ACanvas: TcxCanvas; const ARect: TRect; AState: TcxButtonState;
AScaleFactor: TdxScaleFactor);
begin
  if AState in [cxbsHot, cxbsPressed] then
...
procedure TcxCustomLookAndFeelPainter.PDFViewerDrawFindPanelBackground
  (ACanvas: TcxCanvas; const R: TRect; ABorders: TcxBorders);
var
  ARect: TRect;
begin
...
procedure TcxCustomLookAndFeelPainter.
  PDFViewerDrawPageThumbnailPreviewBackground(ACanvas: TcxCanvas;
const ARect: TRect);
begin
...
procedure TcxCustomLookAndFeelPainter.DrawSpreadSheetGroupExpandButton
  (ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState);
begin
  DrawSpreadSheetScaledGroupExpandButton(ACanvas, R, AState,
    dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawSpreadSheetGroupExpandButtonGlyph
  (ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
AExpanded: Boolean; ADefaultGlyphs: TCustomImageList = nil);
begin
  DrawSpreadSheetScaledGroupExpandButtonGlyph(ACanvas, R, AState, AExpanded,
    dxSystemScaleFactor, ADefaultGlyphs);
end;

procedure TcxCustomLookAndFeelPainter.
  DrawSpreadSheetScaledGroupExpandButtonGlyph(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState; AExpanded: Boolean;
AScaleFactor: TdxScaleFactor; ADefaultGlyphs: TCustomImageList = nil);
begin
  DrawNavigatorScaledButtonGlyph(ACanvas, ADefaultGlyphs,
    IfThen(AExpanded, 8, 6), cxRectCenter(R,
    NavigatorScaledButtonGlyphSize(AScaleFactor)), True, False, AScaleFactor);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawSpreadSheetHeader(ACanvas: TcxCanvas;
const ABounds, ATextAreaBounds: TRect; ANeighbors: TcxNeighbors;
ABorders: TcxBorders; AState: TcxButtonState; AAlignmentHorz: TAlignment;
AAlignmentVert: TcxAlignmentVert; AMultiLine, AShowEndEllipsis: Boolean;
const AText: string; AFont: TFont; ATextColor, ABkColor: TColor;
...
AIsGroup: Boolean = False);
begin
  DrawSpreadSheetScaledHeader(ACanvas, ABounds, ATextAreaBounds, ANeighbors,
    ABorders, AState, AAlignmentHorz, AAlignmentVert, AMultiLine,
    AShowEndEllipsis, AText, AFont, ATextColor, ABkColor, dxSystemScaleFactor,
...
function TcxCustomLookAndFeelPainter.
  SpreadSheetFrozenPaneSeparatorColor: TColor;
begin
  Result := clBlack;
end;
...
function TcxCustomLookAndFeelPainter.
  SpreadSheetGroupExpandButtonContentOffsets: TRect;
begin
  Result := SpreadSheetScaledGroupExpandButtonContentOffsets
    (dxSystemScaleFactor);
end;

function TcxCustomLookAndFeelPainter.SpreadSheetScaledGroupExpandButtonGlyphSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
...
function TcxCustomLookAndFeelPainter.
  SpreadSheetGroupExpandButtonGlyphSize: TSize;
begin
  Result := SpreadSheetScaledGroupExpandButtonGlyphSize(dxSystemScaleFactor);
end;

function TcxCustomLookAndFeelPainter.SpreadSheetGroupExpandButtonTextColor
  (AState: TcxButtonState): TColor;
begin
  Result := ButtonSymbolColor(AState);
end;

function TcxCustomLookAndFeelPainter.SpreadSheetScaledGroupLevelMarkSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
...
procedure TcxCustomLookAndFeelPainter.
  DrawSpreadSheetFormulaBarScaledExpandButton(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState; AExpanded: Boolean;
AScaleFactor: TdxScaleFactor);
const
...
function TcxCustomLookAndFeelPainter.SpreadSheetFormulaBarGetScaledSeparatorSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := GetScaledSplitterSize(False, AScaleFactor).cx;
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledHeader(ACanvas: TcxCustomCanvas;
const ABounds: TRect; AState: TcxButtonState; ANeighbors: TcxNeighbors;
ABorders: TcxBorders; AScaleFactor: TdxScaleFactor; AIsLast, AIsGroup: Boolean);
begin
  DrawHeaderBorder(ACanvas, ABounds, ANeighbors, ABorders);
  DrawContentBackground(ACanvas, HeaderContentBounds(ABounds, ABorders), AState,
    DefaultHeaderColor, False);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledHeader(ACanvas: TcxCanvas;
const ABounds, ATextAreaBounds: TRect; ANeighbors: TcxNeighbors;
ABorders: TcxBorders; AState: TcxButtonState; AAlignmentHorz: TAlignment;
AAlignmentVert: TcxAlignmentVert; AMultiLine, AShowEndEllipsis: Boolean;
const AText: string; AFont: TFont; ATextColor, ABkColor: TColor;
...
begin
  DrawScaledHeader(ACanvas, ABounds, ATextAreaBounds, ANeighbors, ABorders,
    AState, AAlignmentHorz, AAlignmentVert, AMultiLine, AShowEndEllipsis, AText,
    AFont, ATextColor, ABkColor, dxDefaultScaleFactor, AOnDrawBackground,
    AIsLast, AIsGroup);
end;
...
AOnDrawBackground: TcxDrawBackgroundEvent = nil);
begin
  DrawScaledHeaderEx(ACanvas, ABounds, ATextAreaBounds, ANeighbors, ABorders,
    AState, AAlignmentHorz, AAlignmentVert, AMultiLine, AShowEndEllipsis, AText,
    AFont, ATextColor, ABkColor, dxDefaultScaleFactor, AOnDrawBackground);
end;

procedure TcxCustomLookAndFeelPainter.DrawHeaderBorder(ACanvas: TcxCustomCanvas;
...
procedure TcxCustomLookAndFeelPainter.DrawScaledHeaderControlSection
  (ACanvas: TcxCanvas; const ABounds, ATextAreaBounds: TRect;
ANeighbors: TcxNeighbors; ABorders: TcxBorders; AState: TcxButtonState;
AAlignmentHorz: TAlignment; AAlignmentVert: TcxAlignmentVert;
AMultiLine, AShowEndEllipsis: Boolean; const AText: string; AFont: TFont;
...
procedure TcxCustomLookAndFeelPainter.DrawHeaderControlSection
  (ACanvas: TcxCanvas; const ABounds, ATextAreaBounds: TRect;
ANeighbors: TcxNeighbors; ABorders: TcxBorders; AState: TcxButtonState;
AAlignmentHorz: TAlignment; AAlignmentVert: TcxAlignmentVert;
AMultiLine, AShowEndEllipsis: Boolean; const AText: string; AFont: TFont;
ATextColor, ABkColor: TColor);
begin
  DrawScaledHeaderControlSection(ACanvas, ABounds, ATextAreaBounds, ANeighbors,
    ABorders, AState, AAlignmentHorz, AAlignmentVert, AMultiLine,
    AShowEndEllipsis, AText, AFont, ATextColor, ABkColor, dxSystemScaleFactor);
end;
...
begin
  ...
  DrawHeaderControlSectionText(ACanvas,
    HeaderControlSectionTextAreaBounds(ATextAreaBounds, AState), AState,
    AAlignmentHorz, AAlignmentVert, AMultiLine, AShowEndEllipsis, AText, AFont,
    ATextColor);
end;
...
begin
  ...
  ACanvas.FillRect(cxRectSetLeft(ABounds, ABounds.Right - AIndentSize),
    AViewParams);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawSummaryValueSortingMark
  (ACanvas: TcxCanvas; const R: TRect; AAscendingSorting: Boolean);
begin
  DrawScaledSummaryValueSortingMark(ACanvas, R, AAscendingSorting,
    dxSystemScaleFactor);
end;
...
AScaleFactor: TdxScaleFactor);
begin
  cxDrawImage(ACanvas, R, nil, cxIndicatorImages, Integer(High(TcxIndicatorKind)
    ), ifmNormal, idmNormal, False, nil, AScaleFactor);
end;

function TcxCustomLookAndFeelPainter.HeaderBorders(ANeighbors: TcxNeighbors)
  : TcxBorders;
begin
  Result := cxBordersAll;
end;
...
function TcxCustomLookAndFeelPainter.HeaderContentOffsets
  (AScaleFactor: TdxScaleFactor): TRect;
begin
...
function TcxCustomLookAndFeelPainter.ScaledHeaderContentBounds
  (const ABounds: TRect; ABorders: TcxBorders;
AScaleFactor: TdxScaleFactor): TRect;
begin
  Result := ABounds;
  if bLeft in ABorders then
...
function TcxCustomLookAndFeelPainter.HeaderGlyphColorPalette
  (AState: TcxButtonState): IdxColorPalette;
begin
  Result := nil;
end;

function TcxCustomLookAndFeelPainter.ScaledHeaderHeight(AFontHeight: Integer;
AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := AFontHeight + 2 * HeaderBorderSize +
    cxMarginsHeight(HeaderContentOffsets(AScaleFactor));
  dxAdjustToTouchableSize(Result, AScaleFactor);
end;

function TcxCustomLookAndFeelPainter.HeaderHeight(AFontHeight: Integer)
  : Integer;
begin
...
begin
  Result := ScaledHeaderWidth(ACanvas, ABorders, AText, AFont,
    dxSystemScaleFactor);
end;

function TcxCustomLookAndFeelPainter.ScaledHeaderWidth(ACanvas: TcxCanvas;
ABorders: TcxBorders; const AText: string; AFont: TFont;
AScaleFactor: TdxScaleFactor): Integer;
begin
  ACanvas.Font := AFont;
  Result := ACanvas.TextWidth(AText) +
    cxMarginsWidth(HeaderContentOffsets(AScaleFactor));
  if bLeft in ABorders then
...
function TcxCustomLookAndFeelPainter.ScaledSortingMarkAreaSize
  (AScaleFactor: TdxScaleFactor): TPoint;
begin
  if cxIsTouchModeEnabled then
    Result := Point(AScaleFactor.Apply(SortingTouchableMarkAreaWidth),
      ScaledSortingMarkSize(AScaleFactor).Y)
  else
    Result := Point(AScaleFactor.Apply(SortingMarkAreaWidth),
      ScaledSortingMarkSize(AScaleFactor).Y);
end;
...
function TcxCustomLookAndFeelPainter.ScaledSummaryValueSortingMarkSize
  (AScaleFactor: TdxScaleFactor): TPoint;
begin
...
AOnDrawBackground: TcxDrawBackgroundEvent = nil);
begin
  DrawContent(ACanvas, FooterCellContentBounds(ABounds),
    FooterCellTextAreaBounds(ABounds), cxbsNormal, AAlignmentHorz,
    AAlignmentVert, AMultiLine, False, AText, AFont, ATextColor, ABkColor,
    AOnDrawBackground, True);
end;

procedure TcxCustomLookAndFeelPainter.DrawFilterRowSeparator(ACanvas: TcxCanvas;
const ARect: TRect; ABackgroundColor: TColor);
begin
  DrawScaledHeader(ACanvas, ARect, ARect, [], cxBordersAll, cxbsNormal,
    taLeftJustify, vaTop, False, False, '', nil, clWindowText, ABackgroundColor,
    dxDefaultScaleFactor);
end;
...
const ABackgroundBitmap: TBitmap);
begin
  DrawBackground(ACanvas, ARect, ATransparent, ABackgroundColor,
    ABackgroundBitmap);
end;

function TcxCustomLookAndFeelPainter.GridGroupRowStyleOffice11ContentColor
...
procedure TcxCustomLookAndFeelPainter.DrawScaledFindPanelNextButtonGlyph
  (ACanvas: TcxCanvas; const ARect: TRect; const AState: TcxButtonState;
AScaleFactor: TdxScaleFactor);
var
  AColor: TColor;
  APalette: TdxSimpleColorPalette;
begin
  ...
  APalette := TdxSimpleColorPalette.Create(dxColorToAlphaColor(AColor),
    TdxAlphaColors.Empty);
  FindPanelNextButtonGlyph.StretchDraw(ACanvas.Handle, ARect, MaxByte,
    APalette);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledFindPanelPreviousButtonGlyph
  (ACanvas: TcxCanvas; const ARect: TRect; const AState: TcxButtonState;
AScaleFactor: TdxScaleFactor);
var
  AColor: TColor;
...
begin
  ...
  APalette := TdxSimpleColorPalette.Create(dxColorToAlphaColor(AColor),
    TdxAlphaColors.Empty);
  FindPanelPreviousButtonGlyph.StretchDraw(ACanvas.Handle, ARect, MaxByte,
    APalette);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledGroupByBoxSearchButtonGlyph
  (ACanvas: TcxCanvas; const ARect: TRect; const AState: TcxButtonState;
AScaleFactor: TdxScaleFactor);
var
  AColor: TColor;
...
begin
  ...
  APalette := TdxSimpleColorPalette.Create(dxColorToAlphaColor(AColor),
    TdxAlphaColors.Empty);
  GroupByBoxSearchButtonGlyph.StretchDraw(ACanvas.Handle, ARect, MaxByte,
    APalette);
end;
...
function TcxCustomLookAndFeelPainter.
  GridLikeControlDefaultUseOddEvenStyle: Boolean;
begin
...
function TcxCustomLookAndFeelPainter.LayoutViewGetPadding
  (AElement: TcxLayoutElement): TRect;
begin
  Result := cxNullRect;
end;

function TcxCustomLookAndFeelPainter.LayoutViewGetSpacing
  (AElement: TcxLayoutElement): TRect;
begin
  Result := cxNullRect;
end;
...
procedure TcxCustomLookAndFeelPainter.LayoutViewDrawScaledRecordExpandButton
  (ACanvas: TcxCanvas; const ABounds: TRect; AState: TcxButtonState;
AExpanded: Boolean; AScaleFactor: TdxScaleFactor);
begin
  DrawScaledGroupExpandButton(ACanvas, ABounds, AExpanded, AState,
    AScaleFactor);
end;
...
AExpanded: Boolean);
begin
  LayoutViewDrawScaledRecordExpandButton(ACanvas, ABounds, AState, AExpanded,
    dxSystemScaleFactor);
end;
...
function TcxCustomLookAndFeelPainter.WinExplorerViewDefaultRecordColor
  (AState: TcxButtonState): TColor;
begin
  case AState of
    cxbsHot:
...
procedure TcxCustomLookAndFeelPainter.WinExplorerViewDrawGroup
  (ACanvas: TcxCanvas; const ABounds: TRect; AState: TcxButtonState;
AColor: TColor = clDefault; const ABitmap: TBitmap = nil);
begin
...
procedure TcxCustomLookAndFeelPainter.WinExplorerViewDrawGroupCaptionLine
  (ACanvas: TcxCanvas; const ABounds: TRect);
begin
  DrawSeparator(ACanvas, ABounds, False);
end;

procedure TcxCustomLookAndFeelPainter.WinExplorerViewDrawRecord
  (ACanvas: TcxCanvas; const ABounds: TRect; AState: TcxButtonState;
AColor: TColor = clDefault; const ABitmap: TBitmap = nil);
begin
  if AState in [cxbsHot, cxbsPressed, cxbsDisabled] then
...
AExpanded: Boolean);
begin
  WinExplorerViewDrawScaledRecordExpandButton(ACanvas, ABounds, AState,
    AExpanded, dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.
  WinExplorerViewDrawScaledRecordExpandButton(ACanvas: TcxCanvas;
const ABounds: TRect; AState: TcxButtonState; AExpanded: Boolean;
AScaleFactor: TdxScaleFactor);
begin
  DrawScaledGroupExpandButton(ACanvas, ABounds, AExpanded, AState,
...
function TcxCustomLookAndFeelPainter.WinExplorerViewScaledExpandButtonSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
...
function TcxCustomLookAndFeelPainter.WinExplorerViewGroupTextColor
  (AState: TcxButtonState): TColor;
begin
...
function TcxCustomLookAndFeelPainter.WinExplorerViewRecordTextColor
  (AState: TcxButtonState): TColor;
begin
  case AState of
    cxbsPressed:
...
procedure TcxCustomLookAndFeelPainter.DrawFooterCellBorder(ACanvas: TcxCanvas;
const R: TRect);
begin
end;
...
begin
  DrawScaledFilterActivateButton(ACanvas, R, AState, AChecked,
    dxSystemScaleFactor);
end;
...
begin
  ...
  DrawScaledButtonCross(ACanvas, R, ButtonSymbolColor(AState),
    ButtonSymbolState(AState), AScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawFilterDropDownButton
  (ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState;
AIsFilterActive: Boolean);
begin
  DrawScaledFilterDropDownButton(ACanvas, R, AState, AIsFilterActive,
    dxSystemScaleFactor);
end;
...
begin
  DrawScaledFilterSmartTag(ACanvas, R, AState, AIsFilterActive,
    dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledFilterSmartTag
  (ACanvas: TcxCanvas; R: TRect; AState: TcxFilterSmartTagState;
AIsFilterActive: Boolean; AScaleFactor: TdxScaleFactor);
begin
  SmartTagGlyph.StretchDraw(ACanvas.Handle, R, MaxByte,
    TdxSimpleColorPalette.Create(TdxAlphaColors.Empty,
    dxColorToAlphaColor(GetFilterSmartTagColor(AState, AIsFilterActive))));
end;

function TcxCustomLookAndFeelPainter.ScaledFilterActivateButtonSize
  (AScaleFactor: TdxScaleFactor): TPoint;
begin
  Result := AScaleFactor.Apply(Point(FilterActiveButtonWidth,
    FilterActiveButtonHeight));
end;
...
function TcxCustomLookAndFeelPainter.ScaledFilterCloseButtonSize
  (AScaleFactor: TdxScaleFactor): TPoint;
begin
  Result := AScaleFactor.Apply(Point(FilterCloseButtonWidth,
    FilterCloseButtonHeight));
end;

function TcxCustomLookAndFeelPainter.FilterControlMenuGetColorPalette
  : IdxColorPalette;
begin
  Result := nil;
end;
...
function TcxCustomLookAndFeelPainter.ScaledFilterDropDownButtonSize
  (AScaleFactor: TdxScaleFactor): TPoint;
begin
...
function TcxCustomLookAndFeelPainter.ScaledFilterSmartTagSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  Result := AScaleFactor.Apply(cxSize(10, 10));
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledFilterBoolOperatorBackground
  (ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
AScaleFactor: TdxScaleFactor);
var
  AColor: TColor;
...
procedure TcxCustomLookAndFeelPainter.DrawScaledFilterControlAddButtonGlyph
  (ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
AScaleFactor: TdxScaleFactor);
var
  APalette: TdxSimpleColorPalette;
begin
  APalette := TdxSimpleColorPalette.Create(GetFilterAddButtonColor(AState),
    TdxAlphaColors.Empty);
  FilterControlAddButtonGlyph.StretchDraw(ACanvas.Handle, R, MaxByte, APalette);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledFilterControlRemoveButtonGlyph
  (ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
AScaleFactor: TdxScaleFactor);
var
  APalette: TdxSimpleColorPalette;
begin
  APalette := TdxSimpleColorPalette.Create(GetFilterRemoveButtonColor(AState),
    TdxAlphaColors.Empty);
  FilterControlRemoveButtonGlyph.StretchDraw(ACanvas.Handle, R, MaxByte,
    APalette);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledFilterItemCaptionBackground
  (ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
AScaleFactor: TdxScaleFactor);
var
  AColor: TColor;
...
procedure TcxCustomLookAndFeelPainter.DrawScaledFilterOperatorBackground
  (ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
AScaleFactor: TdxScaleFactor);
var
  AColor: TColor;
...
procedure TcxCustomLookAndFeelPainter.DrawScaledFilterPanelBrackets
  (ACanvas: TcxCanvas; const R: TRect; AScaleFactor: TdxScaleFactor);
  ...
  procedure DrawCloseBracket(ACanvas: TcxCanvas; const R: TRect;
  AColor: TColor);
  var
    APoints: array [0 .. 3] of TPoint;
  begin
...
procedure TcxCustomLookAndFeelPainter.DrawScaledFilterPanelRemoveButtonGlyph
  (ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
AScaleFactor: TdxScaleFactor);
var
  APalette: TdxSimpleColorPalette;
begin
  APalette := TdxSimpleColorPalette.Create(GetFilterRemoveButtonColor(AState),
    TdxAlphaColors.Empty);
  FilterPanelRemoveButtonGlyph.StretchDraw(ACanvas.Handle, R, MaxByte,
    APalette);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledFilterPanelRemovingArea
  (ACanvas: TcxCanvas; const R: TRect; AScaleFactor: TdxScaleFactor);
var
  AColor: TColor;
begin
...
procedure TcxCustomLookAndFeelPainter.DrawScaledFilterValueBackground
  (ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
AScaleFactor: TdxScaleFactor);
var
  AColor: TColor;
...
procedure TcxCustomLookAndFeelPainter.GetScaledFilterTokenParams
...
const ABackgroundBitmap: TGraphic);
begin
  DrawFilterPanel(ACanvas, ARect, ATransparent, ABackgroundColor,
    ABackgroundBitmap);
end;

procedure TcxCustomLookAndFeelPainter.DrawFindPanelBorder(ACanvas: TcxCanvas;
const R: TRect; ABorders: TcxBorders);
begin
  DrawFooterBorderEx(ACanvas, R, ABorders);
end;

procedure TcxCustomLookAndFeelPainter.DrawEditPopupWindowBorder
  (ACanvas: TcxCanvas; var R: TRect; ABorderStyle: TcxEditPopupBorderStyle;
AClientEdge: Boolean);
begin
...
procedure TcxCustomLookAndFeelPainter.DrawScaledZoomInButton(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
const
  PlusSignIndent = 3;
begin
  DrawScaledZoomOutButton(ACanvas, R, AState, AScaleFactor);
  ACanvas.MoveTo((R.Left + R.Right) div 2,
    R.Top + AScaleFactor.Apply(PlusSignIndent));
  ACanvas.LineTo((R.Left + R.Right) div 2,
    R.Bottom - AScaleFactor.Apply(PlusSignIndent));
end;
...
begin
  ...
  ACanvas.MoveTo(R.Left + AScaleFactor.Apply(MinusSignIndent),
    (R.Top + R.Bottom) div 2);
  ACanvas.LineTo(R.Right - AScaleFactor.Apply(MinusSignIndent),
    (R.Top + R.Bottom) div 2);
end;

function TcxCustomLookAndFeelPainter.GetEditPopupWindowBorderWidth
  (AStyle: TcxEditPopupBorderStyle): Integer;
begin
  Result := cxEditPopupWindowFrameWidthA[AStyle];
end;

function TcxCustomLookAndFeelPainter.GetEditPopupWindowClientEdgeWidth
  (AStyle: TcxEditPopupBorderStyle): Integer;
begin
...
procedure TcxCustomLookAndFeelPainter.DrawHintBackground(ACanvas: TcxCanvas;
const ARect: TRect; AColor: TColor);
begin
...
procedure TcxCustomLookAndFeelPainter.ScreenTipDrawBackground
  ...
  begin
    ...
    ACanvas.Brush.Style := bsClear;
    ACanvas.Canvas.RoundRect(ARect.Left, ARect.Top, ARect.Right,
      ARect.Bottom, 2, 2);
    ACanvas.Brush.Style := bsSolid;
  end;
...
procedure TcxCustomLookAndFeelPainter.ScreenTipDrawFooterLine
  (ACanvas: TcxCanvas; const ARect: TRect);
begin
...
function TcxCustomLookAndFeelPainter.IsDrawTabImplemented
  (AVertical: Boolean): Boolean;
begin
  Result := False;
end;
...
AScaleFactor: TdxScaleFactor; AOnDrawBackground: TcxDrawBackgroundEvent = nil);
begin
  DrawScaledIndicatorItem(ACanvas, R, R, AKind, AColor, AScaleFactor,
    AOnDrawBackground);
end;
...
AOnDrawBackground: TcxDrawBackgroundEvent = nil);
begin
  DrawScaledIndicatorItem(ACanvas, R, AKind, AColor, dxSystemScaleFactor,
    AOnDrawBackground);
end;
...
AOnDrawBackground: TcxDrawBackgroundEvent = nil);
begin
  DrawScaledIndicatorItem(ACanvas, R, AImageAreaBounds, AKind, AColor,
    dxSystemScaleFactor, AOnDrawBackground);
end;
...
begin
  DrawScaledHeader(ACanvas, R, R, [], HeaderBorders(ANeighbors), cxbsNormal,
    taLeftJustify, vaTop, False, False, '', nil, clNone, AColor, AScaleFactor,
    AOnDrawBackground);
...
AOnDrawBackground: TcxDrawBackgroundEvent = nil);
begin
  DrawScaledIndicatorItemEx(ACanvas, R, AKind, AColor, dxSystemScaleFactor,
    AOnDrawBackground);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledIndicatorItemEx
  (ACanvas: TcxCanvas; const R: TRect; AKind: TcxIndicatorKind; AColor: TColor;
AScaleFactor: TdxScaleFactor; AOnDrawBackground: TcxDrawBackgroundEvent = nil);
begin
  DrawScaledHeaderEx(ACanvas, R, R, [], cxBordersAll, cxbsNormal, taLeftJustify,
    vaTop, False, False, '', nil, clNone, AColor, AScaleFactor,
    AOnDrawBackground);
...
const
  ...
  begin
    ...
    ACanvas.FillRect(cxRectBounds(X + ASize + AScaleFactor.Apply(1), Y,
      ALineWidth - ASize - AScaleFactor.Apply(1), ASize), AColor);
  end;
...
begin
  ...
  Y := (R.Top + R.Bottom - ((AScaleFactor.Apply(LineHeight) + 1) * LineCount -
    1)) div 2;
...
AScaleFactor: TdxScaleFactor);
begin
  DrawScaledScrollBarPart(ACanvas, AHorizontal, R, sbpPageUp, cxbsNormal,
    AScaleFactor);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawScaledScrollBarPart
  (ACanvas: TcxCustomCanvas; AHorizontal: Boolean; R: TRect;
APart: TcxScrollBarPart; AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
var
...
begin
  ...
  DoDrawScaledScrollBarPart(ACanvas, AHorizontal, R, ARealPart, AState,
    AScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawScrollBarPart
  (ACanvas: TcxCustomCanvas; AHorizontal: Boolean; R: TRect;
APart: TcxScrollBarPart; AState: TcxButtonState);
begin
  DrawScaledScrollBarPart(ACanvas, AHorizontal, R, APart, AState,
    dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawScrollBarSplitter
  (ACanvas: TcxCustomCanvas; const R: TRect; AState: TcxButtonState);
begin
...
begin
  ...
  DrawScaledSplitter(ACanvas, cxTextRect(R), AState = cxbsHot,
    AState = cxbsPressed, False, AScaleFactor);
end;

function TcxCustomLookAndFeelPainter.ScaledPopupPanelSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := 2 + dxGetSystemMetrics(SM_CYHSCROLL, AScaleFactor);
  Inc(Result);
  Result := Max(Max(Result, ScaledSizeGripSize(AScaleFactor).cy + 2 * 2),
    ScaledSmallCloseButtonSize(AScaleFactor).cy + 2 * 3);
end;
...
APanelHeight: Integer = 0; AShowCloseButton: Boolean = True;
AShowGripSize: Boolean = True);
begin
  CalculateScaledPopupPanelClientRect(AClientRect, APanelRect, AGripRect,
    ACloseButtonRect, ACorner, ABorders, APanelBorders, dxSystemScaleFactor,
    APanelHeight, AShowCloseButton, AShowGripSize);
end;

procedure TcxCustomLookAndFeelPainter.CalculateScaledPopupPanelClientRect
  (var AClientRect, APanelRect, AGripRect, ACloseButtonRect: TRect;
ACorner: TdxCorner; const ABorders, APanelBorders: TRect;
AScaleFactor: TdxScaleFactor; APanelHeight: Integer = 0;
AShowCloseButton: Boolean = True; AShowGripSize: Boolean = True);
  ...
  begin
    ...
    begin
      ...
      if ACorner in [coTopRight, coBottomRight] then
        ACloseButtonRect.Right := ACloseButtonRect.Left +
          cxRectHeight(ACloseButtonRect)
      else
        ACloseButtonRect.Left := ACloseButtonRect.Right -
          cxRectHeight(ACloseButtonRect);
      ACloseButtonRect := cxRectCenter(ACloseButtonRect,
        ScaledSmallCloseButtonSize(AScaleFactor));
    end
    else
...
begin
  DrawScaledPopupNCPanel(AHandle, AMouseAboveCloseButton,
    ACloseButtonIsTracking, ACorner, ACloseButtonRect, AGripRect, ABorderColor,
    dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledPopupNCPanel(AHandle: HWND;
AMouseAboveCloseButton, ACloseButtonIsTracking: Boolean; ACorner: TdxCorner;
ACloseButtonRect, AGripRect: TRect; ABorderColor: TColor;
AScaleFactor: TdxScaleFactor);
var
  ...
  begin
    if AMouseAboveCloseButton and ACloseButtonIsTracking then
      Result := cxbsPressed
    else if AMouseAboveCloseButton or ACloseButtonIsTracking then
      Result := cxbsHot
    else
      Result := cxbsNormal;
  end;
...
begin
  ...
  try
    ...
    DrawScaledPopupPanelBand(cxPaintCanvas, ABandBounds, AGripRect,
      ACloseButtonRect, ACorner, GetButtonState, GetBorders, ABorderColor,
      AScaleFactor);
  finally
...
begin
  DrawScaledPopupPanelBand(ACanvas, ABounds, AGripRect, ACloseButtonRect,
    AGripCorner, ACloseButtonState, ABorders, ABorderColor, dxSystemScaleFactor,
    AShowGripSize, AShowCloseButton);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledPopupPanelBand
  (ACanvas: TcxCanvas; const ABounds, AGripRect, ACloseButtonRect: TRect;
AGripCorner: TdxCorner; ACloseButtonState: TcxButtonState; ABorders: TRect;
ABorderColor: TColor; AScaleFactor: TdxScaleFactor;
AShowGripSize: Boolean = True; AShowCloseButton: Boolean = True);
var
  ABitmap: TcxBitmap;
begin
  ...
  begin
    ...
    try
      ...
      DrawScaledSizeGrip(ABitmap.cxCanvas, ABitmap.ClientRect, AScaleFactor,
        clNone, AGripCorner);
  ...
  begin
    ...
    DrawScaledSmallCloseButton(ACanvas, ACloseButtonRect, ACloseButtonState,
      AScaleFactor);
...
function TcxCustomLookAndFeelPainter.ScaledSizeGripSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  Result := Size(dxGetSystemMetrics(SM_CXVSCROLL, AScaleFactor),
    dxGetSystemMetrics(SM_CYHSCROLL, AScaleFactor));
end;
...
begin
  DrawScaledSizeGrip(ACanvas, ARect, dxSystemScaleFactor,
    ABackgroundColor, ACorner);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledSizeGrip(ACanvas: TcxCanvas;
const ARect: TRect; AScaleFactor: TdxScaleFactor;
ABackgroundColor: TColor = clDefault; ACorner: TdxCorner = coBottomRight);
begin
  dxRotateSizeGrip(ACanvas, ARect, AScaleFactor, ABackgroundColor, ACorner,
    DoDrawSizeGrip);
end;

function TcxCustomLookAndFeelPainter.SliderButtonSize
  (ADirection: TcxArrowDirection): TSize;
begin
  Result := ScaledSliderButtonSize(ADirection, dxSystemScaleFactor);
end;

function TcxCustomLookAndFeelPainter.ScaledSliderButtonSize
  (ADirection: TcxArrowDirection; AScaleFactor: TdxScaleFactor): TSize;
begin
  Result := ScaledSizeGripSize(AScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledSliderButton
...
begin
  DrawScaledScrollBarPart(ACanvas, ADirection in [adLeft, adRight], ARect,
    APart[ADirection in [adRight, adDown]], AState, AScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawSliderButton(ACanvas: TcxCustomCanvas;
const ARect: TRect; ADirection: TcxArrowDirection; AState: TcxButtonState);
begin
  DrawScaledSliderButton(ACanvas, ARect, ADirection, AState,
    dxSystemScaleFactor);
end;

function TcxCustomLookAndFeelPainter.GetSmallButtonColorPalette
  (AState: TcxButtonState): IdxColorPalette;
begin
  Result := nil;
end;
...
function TcxCustomLookAndFeelPainter.ScaledSmallCloseButtonSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
...
procedure TcxCustomLookAndFeelPainter.DrawScaledSmallButton(ACanvas: TcxCanvas;
R: TRect; AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
begin
  DrawButtonBorder(ACanvas, R, AState);
...
procedure TcxCustomLookAndFeelPainter.DrawSmallButton(ACanvas: TcxCanvas;
R: TRect; AState: TcxButtonState);
begin
...
procedure TcxCustomLookAndFeelPainter.DrawScaledMonthHeader(ACanvas: TcxCanvas;
const ABounds: TRect; const AText: string; ANeighbors: TcxNeighbors;
const AViewParams: TcxViewParams; AArrows: TcxArrowDirections;
ASideWidth: Integer; AScaleFactor: TdxScaleFactor;
AOnDrawBackground: TcxDrawBackgroundEvent = nil);
...
ASideWidth: Integer; AOnDrawBackground: TcxDrawBackgroundEvent = nil);
begin
  DrawScaledMonthHeader(ACanvas, ABounds, AText, ANeighbors, AViewParams,
    AArrows, ASideWidth, dxSystemScaleFactor, AOnDrawBackground);
end;
...
begin
  SchedulerNavigationButtonSizes(AIsNextButton, ABorders, AArrowSize,
    AHasTextArea, AScaleFactor, AIsVertical);
  if AIsVertical then
  begin
    ...
    begin
      ...
      ABounds.Top := (cxMarginsHeight(ABounds) - cxMarginsHeight(ABorders) -
        AArrowZoneLength) div 2;
      ABounds.Bottom := ABounds.Top + AArrowZoneLength +
        cxMarginsHeight(ABorders);
      AArrowRect := cxRectCenter(ABounds, AArrowSize);
    end
    else
    begin
      AContent := cxRectContent(ABounds, ABorders);
      AArrowRect := cxRectCenter(cxRectSetHeight(AContent, AArrowZoneLength),
        AArrowSize);
      ATextRect := AContent;
  ...
  begin
    ...
    begin
      ATextRect := cxNullRect;
      ABounds.Left := (cxMarginsWidth(ABounds) - cxMarginsWidth(ABorders) -
        AArrowZoneLength) div 2;
      ABounds.Right := ABounds.Left + AArrowZoneLength +
        cxMarginsWidth(ABorders);
      AArrowRect := cxRectCenter(ABounds, AArrowSize);
    end
    else
    begin
...
procedure TcxCustomLookAndFeelPainter.CalculateSchedulerNavigationButtonRects
  (AIsNextButton, ACollapsed: Boolean; APrevButtonTextSize, ANextButtonTextSize
  : TSize; var ABounds: TRect; out ATextRect, AArrowRect: TRect;
const AIsVertical: Boolean = True);
begin
  CalculateSchedulerNavigationButtonRects(AIsNextButton, ACollapsed,
    APrevButtonTextSize, ANextButtonTextSize, ABounds, ATextRect, AArrowRect,
    dxSystemScaleFactor, AIsVertical);
end;

procedure TcxCustomLookAndFeelPainter.DrawSchedulerBorder(ACanvas: TcxCanvas;
R: TRect);
begin
  DrawBorder(ACanvas, R);
end;

procedure TcxCustomLookAndFeelPainter.DrawSchedulerDayHeader(ACanvas: TcxCanvas;
const ABounds, ATextAreaBounds: TRect; ANeighbors: TcxNeighbors;
ABorders: TcxBorders; AState: TcxButtonState; AAlignmentHorz: TAlignment;
AAlignmentVert: TcxAlignmentVert; AMultiLine, AShowEndEllipsis: Boolean;
const AText: string; AFont: TFont; ATextColor, ABkColor: TColor;
...
AViewParams: TcxViewParams; ATransparent: Boolean);
begin
  DrawSchedulerScaledEventProgress(ACanvas, ABounds, AProgress, AViewParams,
    ATransparent, dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawSchedulerScaledEventProgress
  (ACanvas: TcxCanvas; const ABounds, AProgress: TRect;
AViewParams: TcxViewParams; ATransparent: Boolean;
AScaleFactor: TdxScaleFactor);
begin
...
procedure TcxCustomLookAndFeelPainter.DrawSchedulerGroup(ACanvas: TcxCanvas;
...
begin
  DrawSchedulerScaledGroupSeparator(ACanvas, ABounds, ABackgroundColor,
    dxSystemScaleFactor, AOnDrawBackground);
end;

procedure TcxCustomLookAndFeelPainter.DrawSchedulerScaledGroupSeparator
  (ACanvas: TcxCanvas; const ABounds: TRect; ABackgroundColor: TColor;
AScaleFactor: TdxScaleFactor; AOnDrawBackground: TcxDrawBackgroundEvent = nil);
begin
  DrawScaledHeader(ACanvas, ABounds, ABounds, [nRight, nLeft], cxBordersAll,
    cxbsNormal, taLeftJustify, vaCenter, False, False, '', nil, clNone,
    ABackgroundColor, AScaleFactor, AOnDrawBackground);
end;

procedure TcxCustomLookAndFeelPainter.DrawSchedulerMilestone(ACanvas: TcxCanvas;
const R: TRect);
var
  APoints: TPoints;
begin
...
begin
  DrawSchedulerNavigationButtonContent(ACanvas, ARect, AArrowRect,
    AIsNextButton, AState, AIsVertical);
  if not IsRectEmpty(ATextRect) and
    (SchedulerNavigationButtonTextColor(AIsNextButton, AState, clDefault) <>
    clNone) then
    cxDrawText(ACanvas, AText, ATextRect, DT_CENTER or DT_VCENTER or
      DT_SINGLELINE, SchedulerNavigationButtonTextColor(AIsNextButton, AState,
      ACanvas.Font.Color), AAngle[AIsVertical]);
end;

procedure TcxCustomLookAndFeelPainter.DrawSchedulerNavigationButtonArrow
  (ACanvas: TcxCanvas; const ARect: TRect; AIsNextButton: Boolean;
AColor: TColor; const AForVertical: Boolean);
const
...
begin
  ...
  begin
    ACount := (ARect.Bottom - ARect.Top) div 2 +
      Integer(Odd(ARect.Bottom - ARect.Top));
...
const
  Borders: array [Boolean, Boolean] of TcxBorders = (([bLeft, bRight, bBottom],
    [bLeft, bTop, bRight]), ([bRight, bTop, bBottom], [bLeft, bTop, bBottom]));
  BottomRightColors: array [Boolean] of TColor = (clBtnFace, clBtnHighlight);
  TopLeftColors: array [Boolean] of TColor = (clBtnHighlight, clBtnShadow);
var
  R: TRect;
begin
  R := ARect;
  ...
  ACanvas.DrawComplexFrame(R, TopLeftColors[AState = cxbsPressed],
    BottomRightColors[AState = cxbsPressed],
    Borders[AIsVertical, AIsNextButton]);
  DrawSchedulerNavigationButtonArrow(ACanvas, AArrowRect, AIsNextButton,
    ButtonSymbolColor(AState), AIsVertical);
end;
...
const AIsVertical: Boolean = True);
const
  AButtonBorders: array [Boolean, Boolean] of TRect = (((Left: 6; Top: 0;
    Right: 6; Bottom: 2), (Left: 6; Top: 2; Right: 6; Bottom: 0)),
    ((Left: 0; Top: 6; Right: 2; Bottom: 6), (Left: 2; Top: 6; Right: 0;
    Bottom: 6)));
begin
...
procedure TcxCustomLookAndFeelPainter.SchedulerNavigationButtonSizes
  (AIsNextButton: Boolean; var ABorders: TRect; var AArrowSize: TSize;
var AHasTextArea: Boolean; const AIsVertical: Boolean = True);
begin
  SchedulerNavigationButtonSizes(AIsNextButton, ABorders, AArrowSize,
    AHasTextArea, dxSystemScaleFactor, AIsVertical);
end;

function TcxCustomLookAndFeelPainter.SchedulerTaskExpandButtonSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
...
function TcxCustomLookAndFeelPainter.
  ChartToolBoxDataLevelInfoBorderSize: Integer;
begin
  Result := 1;
end;

function TcxCustomLookAndFeelPainter.ScaledClockSize(AScaleFactor
  : TdxScaleFactor): TSize;
begin
...
const ARect: TRect; ADateTime: TDateTime; ABackgroundColor: TColor);
begin
  DrawScaledClock(ACanvas, ARect, ADateTime, ABackgroundColor,
    dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledClock(ACanvas: TcxCanvas;
const ARect: TRect; ADateTime: TDateTime; ABackgroundColor: TColor;
AScaleFactor: TdxScaleFactor);
  ...
  begin
    if AHourDot then
    begin
      R := cxRectCenter(cxRectBounds(X, Y, 0, 0),
        cxSize(AScaleFactor.Apply(2)));
...
begin
  ...
  begin
    AAngle := 2 * Pi * I / 60;
    DrawDot(Round(ACenter.X + RX * Cos(AAngle)),
      Round(ACenter.Y + RY * Sin(AAngle)), I mod 5 = 0);
  end;
  ACanvas.FillRect(ARect, ABackgroundColor);
  DrawHands;
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledEditorButton(ACanvas: TcxCanvas;
const ARect: TRect; AButtonKind: TcxEditBtnKind; AState: TcxButtonState;
AScaleFactor: TdxScaleFactor; APosition: TcxEditBtnPosition);
begin
  // do nothing
end;

procedure TcxCustomLookAndFeelPainter.DrawScaledEditorButtonGlyph
...
procedure TcxCustomLookAndFeelPainter.DrawEditorButton(ACanvas: TcxCanvas;
const ARect: TRect; AButtonKind: TcxEditBtnKind; AState: TcxButtonState;
APosition: TcxEditBtnPosition = cxbpRight);
begin
  DrawScaledEditorButton(ACanvas, ARect, AButtonKind, AState,
    dxSystemScaleFactor, APosition);
end;

procedure TcxCustomLookAndFeelPainter.DrawEditorButtonGlyph(ACanvas: TcxCanvas;
const ARect: TRect; AButtonKind: TcxEditBtnKind; AState: TcxButtonState;
APosition: TcxEditBtnPosition = cxbpRight);
begin
  DrawScaledEditorButtonGlyph(ACanvas, ARect, AButtonKind, AState,
    dxSystemScaleFactor, APosition);
end;
...
function TcxCustomLookAndFeelPainter.EditButtonColorPalette
  (AState: TcxButtonState): IdxColorPalette;
begin
  Result := nil;
end;
...
function TcxCustomLookAndFeelPainter.GetContainerBorderColor(AIsHighlightBorder
  : Boolean): TColor;
begin
  Result := clBtnText;
end;
...
procedure TcxCustomLookAndFeelPainter.DrawNavigatorBorder
  (ACanvas: TcxCustomCanvas; R: TRect; ASelected: Boolean);
begin
  // do nothing
end;

procedure TcxCustomLookAndFeelPainter.DrawNavigatorScaledButton
  (ACanvas: TcxCustomCanvas; R: TRect; AState: TcxButtonState;
ABackgroundColor: TColor; AScaleFactor: TdxScaleFactor);
begin
  DrawScaledButton(ACanvas, R, AState, AScaleFactor);
...
procedure TcxCustomLookAndFeelPainter.DrawNavigatorScaledButtonGlyph
...
AScaleFactor: TdxScaleFactor);
begin
  cxDrawImage(ACanvas.Handle, AGlyphRect, AGlyphRect, nil, AImageList,
    AImageIndex, EnabledImageDrawModeMap[AEnabled], False, 0, clDefault, True,
    NavigatorButtonColorPalette(AEnabled));
end;

procedure TcxCustomLookAndFeelPainter.DrawNavigatorButtonGlyph
  (ACanvas: TcxCanvas; AImageList: TCustomImageList; AImageIndex: TcxImageIndex;
const AGlyphRect: TRect; AEnabled: Boolean; AUserGlyphs: Boolean);
begin
  DrawNavigatorScaledButtonGlyph(ACanvas, AImageList, AImageIndex, AGlyphRect,
    AEnabled, AUserGlyphs, dxSystemScaleFactor);
end;
...
function TcxCustomLookAndFeelPainter.NavigatorButtonColorPalette
  (AEnabled: Boolean): IdxColorPalette;
begin
  Result := nil;
end;

function TcxCustomLookAndFeelPainter.NavigatorScaledButtonGlyphPadding
  (AScaleFactor: TdxScaleFactor): TRect;
begin
...
function TcxCustomLookAndFeelPainter.NavigatorScaledButtonGlyphSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
...
function TcxCustomLookAndFeelPainter.NavigatorButtonTextColor
  (AState: TcxButtonState): TColor;
begin
  Result := clBtnText;
end;

function TcxCustomLookAndFeelPainter.NavigatorScaledButtonMinSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
...
procedure TcxCustomLookAndFeelPainter.DrawProgressBarChunk(ACanvas: TcxCanvas;
...
ATextColor: TColor = clDefault);
  ...
  begin
    ...
    begin
      ...
      cxRotatedTextOut(DC, ATextRect, AText, ACanvas.Font, taLeft, taTop, False,
        True, True, vtdTopToBottom);
    end
    else
      cxTextOut(DC, AText, ATextRect, CXTO_DEFAULT_FORMAT or
        IfThen(ACanvas.UseRightToLeftAlignment, CXTO_RTLREADING));
  end;
...
begin
  ...
  try
    ...
    else if ProgressBarTextColorEx(True) = clDefault then
      DrawInvertedText(ACanvas, ATextRect)
    else if cxRectIntersect(ARect, ATextRect, AProgressChunkRect) then
    begin
      ATextBmp := TcxBitmap.CreateSize(ARect);
      try
        cxBitBlt(ATextBmp.Canvas.Handle, ACanvas.Handle, ATextBmp.ClientRect,
          ARect.TopLeft, SRCCOPY);
        ACanvas.Font.Color := ProgressBarTextColorEx(False);
        InternalDrawText(ACanvas.Handle, ATextRect);
        cxBitBlt(ACanvas.Handle, ATextBmp.Canvas.Handle, ARect,
          cxNullPoint, SRCCOPY);
        ACanvas.IntersectClipRect(ARect);
...
procedure TcxCustomLookAndFeelPainter.DrawProgressBarBorder(ACanvas: TcxCanvas;
ARect: TRect; AVertical: Boolean);
begin
end;

function TcxCustomLookAndFeelPainter.ProgressBarBorderSize
...
function TcxCustomLookAndFeelPainter.ProgressBarTextColorEx
...
procedure TcxCustomLookAndFeelPainter.DrawGroupBoxExpandButton
  (ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
AExpanded: Boolean; ARotationAngle: TcxRotationAngle = ra0);
begin
  DrawGroupBoxScaledExpandButton(ACanvas, R, AState, AExpanded,
    dxSystemScaleFactor, ARotationAngle);
end;

procedure TcxCustomLookAndFeelPainter.DrawGroupBoxScaledExpandButton
  (ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
AExpanded: Boolean; AScaleFactor: TdxScaleFactor;
ARotationAngle: TcxRotationAngle = ra0);
begin
  DrawScaledExpandButtonEx(ACanvas, R, AState, AExpanded, AScaleFactor,
    ARotationAngle);
end;

procedure TcxCustomLookAndFeelPainter.DrawGroupBoxButton(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState);
begin
...
AExpanded: Boolean);
begin
  DrawGroupBoxScaledExpandGlyph(ACanvas, R, AState, AExpanded,
    dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawGroupBoxScaledExpandGlyph
  (ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
AExpanded: Boolean; AScaleFactor: TdxScaleFactor);
begin
  DrawScaledExpandMark(ACanvas, R, ButtonSymbolColor(AState), AExpanded,
...
function TcxCustomLookAndFeelPainter.GroupBoxCaptionTailSize(ACaptionPosition
  : TcxGroupBoxCaptionPosition): Integer;
begin
  Result := 0;
end;

function TcxCustomLookAndFeelPainter.GroupBoxTextColor(AEnabled: Boolean;
ACaptionPosition: TcxGroupBoxCaptionPosition): TColor;
begin
  if AEnabled then
    Result := clWindowText
...
procedure TcxCustomLookAndFeelPainter.DrawPanelBackground(ACanvas: TcxCanvas;
AControl: TWinControl; ABounds: TRect; AColorFrom: TColor = clDefault;
AColorTo: TColor = clDefault);
begin
  DrawGroupBoxBackground(ACanvas, ABounds, ABounds);
end;

procedure TcxCustomLookAndFeelPainter.DrawPanelContent(ACanvas: TcxCustomCanvas;
const ARect: TRect);
begin
  ACanvas.FillRect(ARect, clBtnFace);
end;
...
ATrackColor: TColor);
begin
  DrawTrackBarScaledTrack(ACanvas, ARect, ASelection, AShowSelection, AEnabled,
    AHorizontal, ATrackColor, dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawTrackBarScaledTrack
  (ACanvas: TcxCanvas; const ARect, ASelection: TRect;
...
procedure TcxCustomLookAndFeelPainter.DrawTrackBarTrackBounds
  (ACanvas: TcxCanvas; const ARect: TRect);
begin
  // do nothing
end;
...
ATicks: TcxTrackBarTicksAlign; AThumbColor: TColor);
begin
  DrawTrackBarScaledThumb(ACanvas, ARect, AState, AHorizontal, ATicks,
    AThumbColor, dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawTrackBarScaledThumb
  (ACanvas: TcxCanvas; const ARect: TRect; AState: TcxButtonState;
AHorizontal: Boolean; ATicks: TcxTrackBarTicksAlign; AThumbColor: TColor;
AScaleFactor: TdxScaleFactor);

  procedure GetBottomRightThumbShape(const AThumbRect: TRect;
  AHorizontal: Boolean; var ALightPolyLine, AShadowPolyLine, ADarkPolyLine,
    APolygon: TPoints);
  var
    AThumbSize: Integer;
    AMiddle: TPoint;
  ...
  procedure GetTopLeftThumbShape(const AThumbRect: TRect; AHorizontal: Boolean;
...
begin
  ...
  case ATicks of
    tbtaUp:
      begin
        GetTopLeftThumbShape(ARect, AHorizontal, ALightPolyLine,
          AShadowPolyLine, ADarkPolyLine, APolygon);
        ACanvas.Polygon(APolygon);
        DrawTrackBarThumbBorderUpDown(ACanvas, ALightPolyLine, AShadowPolyLine,
          ADarkPolyLine);
      end;
    tbtaDown:
      begin
        GetBottomRightThumbShape(ARect, AHorizontal, ALightPolyLine,
          AShadowPolyLine, ADarkPolyLine, APolygon);
        ACanvas.Polygon(APolygon);
        DrawTrackBarThumbBorderUpDown(ACanvas, ALightPolyLine, AShadowPolyLine,
          ADarkPolyLine);
...
procedure TcxCustomLookAndFeelPainter.DrawTrackBarThumbBorderUpDown
  (ACanvas: TcxCanvas; const ALightPolyLine, AShadowPolyLine,
  ADarkPolyLine: TPoints);
begin
  //
...
procedure TcxCustomLookAndFeelPainter.DrawTrackBarThumbBorderBoth
  (ACanvas: TcxCanvas; const ARect: TRect);
begin

end;

function TcxCustomLookAndFeelPainter.TrackBarScaledThumbSize
  (AHorizontal: Boolean; AScaleFactor: TdxScaleFactor): TSize;
begin
  Result := cxNullSize;
end;

function TcxCustomLookAndFeelPainter.TrackBarThumbSize
  (AHorizontal: Boolean): TSize;
begin
...
function TcxCustomLookAndFeelPainter.TrackBarScaledTrackSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := 0;
end;
...
ABorderColor: TdxAlphaColor);
begin
  DrawRangeControlScaledLeftThumb(ACanvas, ARect, AColor, ABorderColor,
    dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawRangeControlScaledLeftThumb
  (ACanvas: TcxCanvas; const ARect: TRect; AColor: TColor;
ABorderColor: TdxAlphaColor; AScaleFactor: TdxScaleFactor);
begin
...
ABorderColor: TdxAlphaColor);
begin
  DrawRangeControlScaledRightThumb(ACanvas, ARect, AColor, ABorderColor,
    dxSystemScaleFactor);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawRangeControlRulerHeader
  (ACanvas: TcxCanvas; const ARect: TRect; AIsHot: Boolean;
AColor, ABorderColor: TdxAlphaColor);
begin
  DrawRangeControlScaledRulerHeader(ACanvas, ARect, AIsHot, AColor,
    ABorderColor, dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawRangeControlScaledRulerHeader
  (ACanvas: TcxCanvas; const ARect: TRect; AIsHot: Boolean;
AColor, ABorderColor: TdxAlphaColor; AScaleFactor: TdxScaleFactor);
const
  BackColor = $FFFFFFFF;
...
begin
  ...
  try
    ...
    dxGPPaintCanvas.Line(APoint1.X, APoint1.Y, APoint2.X, APoint2.Y,
      ABorderColor);
    APoint1 := APoint2;
...
begin
  DrawRangeControlScaledSizingGlyph(ACanvas, ARect, ABorderColor,
    dxSystemScaleFactor);
end;
...
begin
  dxGPPaintCanvas.BeginPaint(ACanvas.Handle, ARect);
  try
    R := cxRectCenter(ARect, Size(AScaleFactor.Apply(1),
      ARect.Height - AScaleFactor.Apply(4)));
    APoint1 := R.TopLeft;
    APoint2 := Point(R.Left, R.Bottom - 1);
    dxGPPaintCanvas.Line(APoint1.X, APoint1.Y, APoint2.X, APoint2.Y,
      ABorderColor, AScaleFactor.ApplyF(1));
  finally
    dxGPPaintCanvas.EndPaint;
  end;
end;
...
function TcxCustomLookAndFeelPainter.GetRangeControlElementsBorderColor
  : TdxAlphaColor;
begin
  Result := $FFB6B8BF;
end;
...
function TcxCustomLookAndFeelPainter.GetRangeControlOutOfRangeColor
  : TdxAlphaColor;
begin
  Result := $1E9DA0AA;
end;
...
function TcxCustomLookAndFeelPainter.
  GetRangeControlSelectedRegionBackgroundColor: TdxAlphaColor;
begin
  Result := $64A8C3F1;
end;

function TcxCustomLookAndFeelPainter.GetRangeControlSelectedRegionBorderColor
  : TdxAlphaColor;
begin
  Result := $644571BA;
end;
...
function TcxCustomLookAndFeelPainter.
  GetRangeControlViewPortPreviewColor: TColor;
begin
  Result := $F2F1F0;
end;
...
function TcxCustomLookAndFeelPainter.GetRangeControlScaledScrollAreaHeight
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(11);
end;
...
function TcxCustomLookAndFeelPainter.GetRangeControlScaledSizingGlyphSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
...
function TcxCustomLookAndFeelPainter.GetRangeControlScaledThumbSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
...
function TcxCustomLookAndFeelPainter.RangeTrackBarLeftThumbSize
  (AHorizontal: Boolean; ATicks: TcxTrackBarTicksAlign): TSize;
begin
  Result := RangeTrackBarScaledLeftThumbSize(AHorizontal, ATicks,
    dxSystemScaleFactor);
end;

function TcxCustomLookAndFeelPainter.RangeTrackBarRightThumbSize
  (AHorizontal: Boolean; ATicks: TcxTrackBarTicksAlign): TSize;
begin
  Result := RangeTrackBarScaledRightThumbSize(AHorizontal, ATicks,
    dxSystemScaleFactor);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawRangeTrackBarScaledLeftThumb
  (ACanvas: TcxCanvas; const ARect: TRect; AState: TcxButtonState;
AHorizontal: Boolean; ATicks: TcxTrackBarTicksAlign; AThumbColor: TColor;
AScaleFactor: TdxScaleFactor);
...
begin
  ...
  case ATicks of
    tbtaUp:
      begin
        GetTopLeftThumbShape(R, AHorizontal, ALightPolyLine, AShadowPolyLine,
          ADarkPolyLine, APolygon);
        ACanvas.Polygon(APolygon);
        DrawTrackBarThumbBorderUpDown(ACanvas, ALightPolyLine, AShadowPolyLine,
          ADarkPolyLine);
      end;
    tbtaDown:
      begin
        GetBottomRightThumbShape(R, AHorizontal, ALightPolyLine,
          AShadowPolyLine, ADarkPolyLine, APolygon);
        ACanvas.Polygon(APolygon);
        DrawTrackBarThumbBorderUpDown(ACanvas, ALightPolyLine, AShadowPolyLine,
          ADarkPolyLine);
...
procedure TcxCustomLookAndFeelPainter.DrawRangeTrackBarLeftThumb
  (ACanvas: TcxCanvas; const ARect: TRect; AState: TcxButtonState;
AHorizontal: Boolean; ATicks: TcxTrackBarTicksAlign; AThumbColor: TColor);
begin
  DrawRangeTrackBarScaledLeftThumb(ACanvas, ARect, AState, AHorizontal, ATicks,
    AThumbColor, dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawRangeTrackBarRightThumb
  (ACanvas: TcxCanvas; const ARect: TRect; AState: TcxButtonState;
AHorizontal: Boolean; ATicks: TcxTrackBarTicksAlign; AThumbColor: TColor);
begin
  DrawRangeTrackBarScaledRightThumb(ACanvas, ARect, AState, AHorizontal, ATicks,
    AThumbColor, dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawRangeTrackBarScaledRightThumb
  (ACanvas: TcxCanvas; const ARect: TRect; AState: TcxButtonState;
AHorizontal: Boolean; ATicks: TcxTrackBarTicksAlign; AThumbColor: TColor;
AScaleFactor: TdxScaleFactor);
...
function TcxCustomLookAndFeelPainter.GetSplitterInnerColor
  (AHighlighted: Boolean): TColor;
begin
  Result := clWhite;
end;

function TcxCustomLookAndFeelPainter.GetSplitterOuterColor
  (AHighlighted: Boolean): TColor;
begin
  Result := clBtnShadow;
end;
...
AHasCloseMark: Boolean = False; AArrowDirection: TcxArrowDirection = adLeft);
  ...
  begin
    ...
    if AHasCloseMark then
    begin
      P1 := Point(P1.X + Ord(AHorizontal) + 2 * Ord(AHorizontal and
        AHasInnerLine), P1.Y + Ord(not AHorizontal) + 2 *
        Ord(not AHorizontal and AHasInnerLine));
    end;
    ACanvas.Line(P1, P2, AColor);
  end;
...
begin
  ...
  R := cxRectCenter(ARect, IfThen(AHorizontal, cxRectWidth(ARect), 1),
    IfThen(AHorizontal, 1, cxRectHeight(ARect)));
  R := Rect(R.Left, R.Top, R.Right - IfThen(AHorizontal and AHasInnerLine, 1,
    0), R.Bottom - IfThen(not AHorizontal and AHasInnerLine, 1, 0));
...
const ARect: TRect; AHighlighted: Boolean; AClicked: Boolean;
AHorizontal: Boolean);
begin
  DrawScaledSplitter(ACanvas, ARect, AHighlighted, AClicked, AHorizontal,
    dxSystemScaleFactor)
end;

procedure TcxCustomLookAndFeelPainter.DrawSplitterCloseMark
  (ACanvas: TcxCustomCanvas; const ARect: TRect;
AHighlighted, AClicked, AHorizontal: Boolean; AScaleFactor: TdxScaleFactor;
...
begin
  ...
  ACenter.X := ACenter.X + Ord(AHorizontal and HasSplitterInnerLine(AHorizontal,
    AScaleFactor) and (((ARect.Right - ARect.Left) mod 2) <> 0));

  ACenter.Y := ACenter.Y + Ord(not AHorizontal and
    HasSplitterInnerLine(AHorizontal, AScaleFactor) and
    (((ARect.Bottom - ARect.Top) mod 2) <> 0));
  case AArrowDirection of
    adUp:
      for I := 0 to AScaleFactor.Apply(3) do
      begin
        ACanvas.Line(Point(ACenter.X - I, ACenter.Y - AScaleFactor.Apply(3) +
          I), Point(ACenter.X - I, ACenter.Y - AScaleFactor.Apply(5) +
          I), AColor);
        ACanvas.Line(Point(ACenter.X + I, ACenter.Y - AScaleFactor.Apply(3) +
          I), Point(ACenter.X + I, ACenter.Y - AScaleFactor.Apply(5) +
          I), AColor);
    ...
    adDown:
      for I := 0 to AScaleFactor.Apply(3) do
      begin
        ACanvas.Line(Point(ACenter.X - I, ACenter.Y + AScaleFactor.Apply(2) -
          I), Point(ACenter.X - I, ACenter.Y + AScaleFactor.Apply(4) -
          I), AColor);
        ACanvas.Line(Point(ACenter.X + I, ACenter.Y + AScaleFactor.Apply(2) -
          I), Point(ACenter.X + I, ACenter.Y + AScaleFactor.Apply(4) -
          I), AColor);
    ...
    adLeft:
      for I := 0 to AScaleFactor.Apply(3) do
      begin
        ACanvas.Line(Point(ACenter.X - AScaleFactor.Apply(3) + I,
          ACenter.Y - I), Point(ACenter.X - AScaleFactor.Apply(5) + I,
          ACenter.Y - I), AColor);
        ACanvas.Line(Point(ACenter.X - AScaleFactor.Apply(3) + I,
          ACenter.Y + I), Point(ACenter.X - AScaleFactor.Apply(5) + I,
          ACenter.Y + I), AColor);
...
function TcxCustomLookAndFeelPainter.GetScaledSplitterSize(AHorizontal: Boolean;
AScaleFactor: TdxScaleFactor): TSize;
begin
  if AHorizontal then
    Result := Size(17, 2)
...
function TcxCustomLookAndFeelPainter.GetSplitterSize
  (AHorizontal: Boolean): TSize;
begin
  Result := GetScaledSplitterSize(AHorizontal, dxSystemScaleFactor);
end;

function TcxCustomLookAndFeelPainter.HasSplitterInnerLine(AHorizontal: Boolean;
AScaleFactor: TdxScaleFactor): Boolean;
var
  ASplitterSize: TSize;
begin
  ASplitterSize := GetScaledSplitterSize(AHorizontal, AScaleFactor);
  Result := (AHorizontal and (ASplitterSize.cy > 1)) or
    (not AHorizontal and (ASplitterSize.cx > 1));
end;
...
function TcxCustomLookAndFeelPainter.GetScaledZoomInButtonSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  Result := AScaleFactor.Apply(Size(ZoomButtonWidth, ZoomButtonHeight));
end;

function TcxCustomLookAndFeelPainter.GetScaledZoomOutButtonSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  Result := AScaleFactor.Apply(Size(ZoomButtonWidth, ZoomButtonHeight));
end;
...
procedure TcxCustomLookAndFeelPainter.DrawZoomInButton(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState);
begin
  DrawScaledZoomInButton(ACanvas, R, AState, dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawZoomOutButton(ACanvas: TcxCanvas;
const R: TRect; AState: TcxButtonState);
begin
...
function TcxCustomLookAndFeelPainter.LayoutControlGetColorPaletteForGroupButton
  (AState: TcxButtonState): IdxColorPalette;
begin
  Result := nil;
end;

function TcxCustomLookAndFeelPainter.LayoutControlGetColorPaletteForItemCaption
  : IdxColorPalette;
begin
  Result := nil;
end;
...
procedure TcxCustomLookAndFeelPainter.DrawScrollBoxBackground
  (ACanvas: TcxCanvas; const R: TRect; AColor: TColor);
begin
  ACanvas.FillRect(R, AColor);
end;
...
function TcxCustomLookAndFeelPainter.PrintPreviewPageBordersScaledWidth
  (AScaleFactor: TdxScaleFactor): TRect;
begin
  Result := Rect(2, 2, 4, 4);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawPrintPreviewScaledBackground
  (ACanvas: TcxCanvas; const R: TRect; AScaleFactor: TdxScaleFactor);
begin
  ACanvas.FillRect(R, clBtnShadow);
end;
...
begin
  DrawPrintPreviewPageScaledBackground(ACanvas, ABorderRect, AContentRect,
    ASelected, ADrawContent, dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawPrintPreviewPageScaledBackground
  (ACanvas: TcxCanvas; const ABorderRect, AContentRect: TRect;
...
const
  BtnColors: array [TcxCalcButtonKind] of TColor = (clMaroon, clMaroon,
    clMaroon, clRed, clRed, clRed, clRed, clBlue, clBlue, clBlue, clBlue,
    clBlue, clBlue, clBlue, clBlue, clBlue, clBlue, clBlue, clBlue, clRed,
    clRed, clRed, clRed, clNavy, clNavy, clNavy, clRed, clBlue);
begin
...
const ABounds: TRect; const AMessage: string; AFont: TFont = nil;
...
function TcxCustomLookAndFeelPainter.BreadcrumbEditScaledButtonAreaSeparatorSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := 2;
end;
...
function TcxCustomLookAndFeelPainter.
  BreadcrumbEditButtonAreaSeparatorSize: Integer;
begin
...
function TcxCustomLookAndFeelPainter.BreadcrumbEditButtonColorPalette
...
function TcxCustomLookAndFeelPainter.BreadcrumbEditScaledDropDownButtonWidth
  (AScaleFactor: TdxScaleFactor): Integer;
begin
...
function TcxCustomLookAndFeelPainter.BreadcrumbEditScaledNodeDelimiterSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
...
function TcxCustomLookAndFeelPainter.BreadcrumbEditScaledNodeTextOffsets
  (AScaleFactor: TdxScaleFactor): TRect;
begin
  Result := AScaleFactor.Apply(cxRect(4, 4, 4, 4));
end;
...
function TcxCustomLookAndFeelPainter.BreadcrumbEditScaledProgressChunkPadding
  (AScaleFactor: TdxScaleFactor): TRect;
begin
  Result := cxSimpleRect;
end;
...
function TcxCustomLookAndFeelPainter.
  BreadcrumbEditScaledProgressChunkOverlaySize(AScaleFactor
  : TdxScaleFactor): TSize;
begin
  Result := cxNullSize;
end;
...
function TcxCustomLookAndFeelPainter.
  BreadcrumbEditProgressChunkOverlaySize: TSize;
begin
  Result := BreadcrumbEditScaledProgressChunkOverlaySize(dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawBreadcrumbEditBorders
  (ACanvas: TcxCanvas; const ARect: TRect; ABorders: TcxBorders;
AState: TdxBreadcrumbEditState);
begin
...
procedure TcxCustomLookAndFeelPainter.DrawBreadcrumbEditButtonAreaSeparator
  (ACanvas: TcxCanvas; const ARect: TRect; AState: TdxBreadcrumbEditState);
begin
  DrawBreadcrumbEditScaledButtonAreaSeparator(ACanvas, ARect, AState,
    dxSystemScaleFactor);
end;
...
begin
  DrawBreadcrumbEditScaledButton(ACanvas, ARect, AState, AIsFirst, AIsLast,
    dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawBreadcrumbEditScaledButton
  (ACanvas: TcxCanvas; const ARect: TRect; AState: TdxBreadcrumbEditButtonState;
AIsFirst, AIsLast: Boolean; AScaleFactor: TdxScaleFactor);
begin
  if not(AState in [dxbcbsNormal, dxbcbsDisabled]) then
    DrawScaledButton(ACanvas, ARect, BreadcrumbButtonStateToButtonState[AState],
      AScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawBreadcrumbEditScaledDropDownButton
  (ACanvas: TcxCanvas; const ARect: TRect; AState: TdxBreadcrumbEditButtonState;
AIsInEditor: Boolean; AScaleFactor: TdxScaleFactor);
begin
  if AIsInEditor then
...
AIsInEditor: Boolean);
begin
  DrawBreadcrumbEditScaledDropDownButton(ACanvas, ARect, AState, AIsInEditor,
    dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.
  DrawBreadcrumbEditScaledDropDownButtonGlyph(ACanvas: TcxCanvas;
const ARect: TRect; AState: TdxBreadcrumbEditButtonState; AIsInEditor: Boolean;
AScaleFactor: TdxScaleFactor);
begin
  DrawButtonArrow(ACanvas, cxRectInflate(ARect,
    -AScaleFactor.Apply(cxTextOffset)),
...
AIsInEditor: Boolean);
begin
  DrawBreadcrumbEditScaledDropDownButtonGlyph(ACanvas, ARect, AState,
    AIsInEditor, dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawBreadcrumbEditScaledNode
  (ACanvas: TcxCanvas; const R: TRect; AState: TdxBreadcrumbEditButtonState;
AHasDelimiter: Boolean; AScaleFactor: TdxScaleFactor);
begin
  DrawBreadcrumbEditScaledButton(ACanvas, R, AState, False, AHasDelimiter,
    AScaleFactor);
end;
...
begin
  DrawBreadcrumbEditScaledNode(ACanvas, R, AState, AHasDelimiter,
    dxSystemScaleFactor);
end;
...
AScaleFactor: TdxScaleFactor);
begin
  DrawBreadcrumbEditScaledButton(ACanvas, R, AState, False, False,
    AScaleFactor);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawBreadcrumbEditNodeDelimiter
  (ACanvas: TcxCanvas; const R: TRect; AState: TdxBreadcrumbEditButtonState);
begin
  DrawBreadcrumbEditScaledNodeDelimiter(ACanvas, R, AState,
    dxSystemScaleFactor);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawBreadcrumbEditNodeDelimiterGlyph
  (ACanvas: TcxCanvas; const R: TRect; AState: TdxBreadcrumbEditButtonState);
begin
  DrawBreadcrumbEditScaledNodeDelimiterGlyph(ACanvas, R, AState,
    dxSystemScaleFactor);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawBreadcrumbEditNodeMoreButtonGlyph
  (ACanvas: TcxCanvas; const R: TRect; AState: TdxBreadcrumbEditButtonState);
begin
  DrawBreadcrumbEditScaledNodeMoreButtonGlyph(ACanvas, R, AState,
    dxSystemScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.
  DrawBreadcrumbEditScaledNodeMoreButtonGlyph(ACanvas: TcxCanvas;
const R: TRect; AState: TdxBreadcrumbEditButtonState;
AScaleFactor: TdxScaleFactor);
begin
...
procedure TcxCustomLookAndFeelPainter.DrawDropDownListBoxGutterBackground
  (ACanvas: TcxCanvas; const ARect: TRect);
begin
  DrawDropDownListBoxScaledGutterBackground(ACanvas, ARect,
    dxSystemScaleFactor);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawDropDownListBoxSelection
  (ACanvas: TcxCanvas; const ARect, AGutterRect: TRect);
begin
  DrawDropDownListBoxScaledSelection(ACanvas, ARect, AGutterRect,
    dxSystemScaleFactor);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawDropDownListBoxSeparator
  (ACanvas: TcxCanvas; const ARect, AGutterRect: TRect);
begin
  DrawDropDownListBoxScaledSeparator(ACanvas, ARect, AGutterRect,
    dxSystemScaleFactor);
end;
...
AScaleFactor: TdxScaleFactor);
begin
  ACanvas.DrawComplexFrame(cxRectCenterVertically(ARect, 2), clBtnShadow,
    clBtnHighlight, [bTop, bBottom]);
end;
...
function TcxCustomLookAndFeelPainter.DropDownListBoxScaledItemImageOffsets
  (AScaleFactor: TdxScaleFactor): TRect;
begin
  Result := AScaleFactor.Apply(cxRect(5, 3, 5, 3));
end;

function TcxCustomLookAndFeelPainter.DropDownListBoxItemTextColor
  (ASelected: Boolean): TColor;
begin
  if ASelected then
    Result := clHighlightText
...
function TcxCustomLookAndFeelPainter.DropDownListBoxScaledItemTextOffsets
  (AScaleFactor: TdxScaleFactor): TRect;
begin
...
function TcxCustomLookAndFeelPainter.DropDownListBoxScaledSeparatorSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
...
function TcxCustomLookAndFeelPainter.AlertWindowButtonGetColorPalette
  (AState: TcxButtonState): IdxColorPalette;
begin
...
function TcxCustomLookAndFeelPainter.AlertWindowScaledContentOffsets
  (AScaleFactor: TdxScaleFactor): TRect;
begin
  Result := AScaleFactor.Apply(cxRect(4, 4, 4, 4));
end;
...
function TcxCustomLookAndFeelPainter.
  AlertWindowNavigationPanelTextColor: TColor;
begin
...
begin
  ...
  ACanvas.Canvas.RoundRect(ABounds.Left, ABounds.Top, ABounds.Right,
    ABounds.Bottom, AlertWindowCornerRadius, AlertWindowCornerRadius);
end;
...
ADown: Boolean = False);
begin
  DrawAlertWindowScaledButton(ACanvas, ABounds, AState, AKind,
    dxSystemScaleFactor, ADown);
end;

procedure TcxCustomLookAndFeelPainter.DrawAlertWindowScaledButton
  (ACanvas: TcxCanvas; const ABounds: TRect; AState: TcxButtonState;
AKind: TdxAlertWindowButtonKind; AScaleFactor: TdxScaleFactor;
ADown: Boolean = False);
var
...
begin
  ...
  R := cxRectContent(ABounds, AlertWindowScaledButtonContentOffsets(AKind,
    AScaleFactor));
  case AKind of
    awbkClose:
      DrawScaledButtonCross(ACanvas, R, ButtonSymbolColor(AState), AState,
        AScaleFactor);
    awbkPin:
...
const ABounds: TRect; AColor: TColor; APinned: Boolean);
  ...
  const
    SizeMap: array [0 .. 2, 0 .. 1] of Single = ((0.5, 0.5), (0.9, 0.1),
      (0.1, 0.5));
  begin
...
begin
  ...
  begin
    S := GetElementSize(I);
    if APinned then
      R := cxRectCenterHorizontally(cxRectSetTop(ABounds, R.Bottom - 1,
        S.cy), S.cx)
    else
      R := cxRectCenterVertically(cxRectSetRight(ABounds, R.Left + 1,
        S.cy), S.cx);
    if I = 0 then
    begin
...
const R: TRect; AColor: TColor; AExpanded: Boolean;
AScaleFactor: TdxScaleFactor);
var
...
procedure TcxCustomLookAndFeelPainter.DrawExpandMark(ACanvas: TcxCanvas;
const R: TRect; AColor: TColor; AExpanded: Boolean);
begin
...
begin
  ...
  try
    ...
    R := cxRectCenter(ARect, Size(AScaleFactor.Apply(2) * 2 + 1,
      cxRectHeight(ARect) - AScaleFactor.Apply(8)));
...
procedure TcxCustomLookAndFeelPainter.DoDrawGanttSheetHeaderBackground
  (ACanvas: TcxCustomCanvas; const R: TRect; AState: TcxButtonState);
var
  AColor: TColor;
begin
  case AState of
    ...
    cxbsPressed:
      AColor := dxGetDarkerColor(DefaultHeaderColor, 85);
  else
...
function TcxCustomLookAndFeelPainter.
  DefaultGanttCurrentDateGridLineColor: TColor;
begin
  Result := $32CD32;
end;

function TcxCustomLookAndFeelPainter.
  DefaultGanttProjectStartGridLineColor: TColor;
var
  AColor: TColor;
begin
  AColor := ColorToRGB(DefaultContentTextColor);
  Result := RGB(MulDiv(GetRValue(AColor), 80, 100),
    MulDiv(GetGValue(AColor), 80, 100), MulDiv(GetBValue(AColor), 80, 100));
end;

function TcxCustomLookAndFeelPainter.
  DefaultGanttProjectFinishGridLineColor: TColor;
begin
  Result := DefaultGanttProjectStartGridLineColor;
end;

procedure TcxCustomLookAndFeelPainter.DoDrawGanttSummaryTaskProgress
...
begin
  ...
  ACanvas.FillRect(cxRectSetRight(ARect, ARect.Right, AWidth),
    AActualColor, 128);
end;

procedure TcxCustomLookAndFeelPainter.DoDrawGanttTaskProgress
...
procedure TcxCustomLookAndFeelPainter.DrawGanttDependencyEditPoint
...
procedure TcxCustomLookAndFeelPainter.DrawGanttFocusedRow
  (ACanvas: TcxCustomCanvas; const R: TRect; const AIsActive: Boolean = True);
begin
  ACanvas.FillRect(R, clBtnShadow, 32);
end;

procedure TcxCustomLookAndFeelPainter.DrawGanttSheetHeader
  (ACanvas: TcxCustomCanvas; const ABounds: TRect; AState: TcxButtonState;
ANeighbors: TcxNeighbors; ABorders: TcxBorders; AScaleFactor: TdxScaleFactor);
begin
  DrawHeaderBorder(ACanvas, ABounds, ANeighbors, ABorders);
  DoDrawGanttSheetHeaderBackground(ACanvas, HeaderContentBounds(ABounds,
    ABorders), AState);
end;

procedure TcxCustomLookAndFeelPainter.DrawGanttMilestone
  (ACanvas: TcxCustomCanvas; const R: TRect; AScaleFactor: TdxScaleFactor;
const AColor: TColor = clDefault);
var
  AActualColor: TColor;
  APoints: TPoints;
begin
  APoints := cxGetSchedulerMilestonePolygon
    (cxRectCenter(R, AScaleFactor.Apply(GetGanttMilestoneSize)));
  try
...
procedure TcxCustomLookAndFeelPainter.DrawGanttSummaryTask
  (ACanvas: TcxCustomCanvas; const R: TRect; AScaleFactor: TdxScaleFactor;
const AColor: TColor = clDefault);
var
  AActualColor: TColor;
...
procedure TcxCustomLookAndFeelPainter.DrawGanttSummaryTaskProgress
  (ACanvas: TcxCustomCanvas; const ATaskRect, AProgressRect: TRect;
...
procedure TcxCustomLookAndFeelPainter.DrawGanttTask(ACanvas: TcxCustomCanvas;
const R: TRect; const AColor: TColor = clDefault);
begin
  ACanvas.FillRect(R, cxGetActualColor(AColor, clBtnFace), 128);
end;

procedure TcxCustomLookAndFeelPainter.DrawGanttTaskProgress
  (ACanvas: TcxCustomCanvas; const ATaskRect, AProgressRect: TRect;
const AColor: TColor = clDefault);
begin
  ACanvas.SaveClipRegion;
...
procedure TcxCustomLookAndFeelPainter.DrawGanttTaskTextLabel
  (ACanvas: TcxCustomCanvas; const R: TRect);
begin
  ACanvas.FrameRect(R, clBtnShadow);
end;

function TcxCustomLookAndFeelPainter.GetGanttDependencyEditPointSize
...
function TcxCustomLookAndFeelPainter.GetGanttTaskColor(AManualSchedule
  : Boolean): TColor;
begin
...
procedure TcxCustomLookAndFeelPainter.DrawListViewItemBackground
  (ACanvas: TcxCustomCanvas; const ABounds: TRect;
AState: TdxListViewItemStates; AExplorerStyle: Boolean);
const
  FrameColor = $CC0000;
...
function TcxCustomLookAndFeelPainter.GetListViewExpandButtonSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := ScaledGroupExpandButtonSize(AScaleFactor);
end;

function TcxCustomLookAndFeelPainter.GetListViewColumnHeaderSortingMarkSize
  (AScaleFactor: TdxScaleFactor): TPoint;
begin
...
procedure TcxCustomLookAndFeelPainter.DrawListViewCheckButton
  (ACanvas: TcxCustomCanvas; const ABounds: TRect; AState: TcxButtonState;
AChecked: Boolean; AScaleFactor: TdxScaleFactor);
begin
  ACanvas.DrawNativeObject(ABounds, TcxCanvasBasedResourceCacheKey.Create
    (Pointer(Self), cxSize(ABounds), Ord(AState), BP_CHECKBOX,
    AScaleFactor.TargetDPI),
    procedure(ACanvas: TcxGdiBasedCanvas; const R: TRect)
    begin
      DrawScaledCheckButton(ACanvas as TcxCanvas, R, AState, AChecked,
        AScaleFactor);
    end);
end;

procedure TcxCustomLookAndFeelPainter.DrawListViewSortingMark
  (ACanvas: TcxCustomCanvas; const R: TRect; AAscendingSorting: Boolean;
AScaleFactor: TdxScaleFactor);
begin
  DrawListViewColumnHeaderSortingArrow(ACanvas, R, clBtnShadow, clBtnShadow,
    AAscendingSorting, AScaleFactor);
end;

procedure TcxCustomLookAndFeelPainter.DrawListViewGroupExpandButton
  (ACanvas: TcxCustomCanvas; const ABounds: TRect; AState: TcxButtonState;
AExpanded: Boolean; AExplorerStyle: Boolean; AScaleFactor: TdxScaleFactor);
begin
  ACanvas.DrawNativeObject(ABounds, TcxCanvasBasedResourceCacheKey.Create
    (Pointer(Self), cxSize(ABounds), Ord(AState), LVP_EXPANDBUTTON,
    AScaleFactor.TargetDPI),
    procedure(ACanvas: TcxGdiBasedCanvas; const R: TRect)
    begin
      WinExplorerViewDrawScaledRecordExpandButton(ACanvas as TcxCanvas, R,
        AState, AExpanded, AScaleFactor);
    end);
end;

procedure TcxCustomLookAndFeelPainter.DrawListViewGroupHeaderBackground
  (ACanvas: TcxCustomCanvas; const ABounds: TRect;
AState: TdxListViewGroupHeaderStates; AExplorerStyle: Boolean;
AScaleFactor: TdxScaleFactor);
const
...
procedure TcxCustomLookAndFeelPainter.DrawListViewGroupHeaderLine
  (ACanvas: TcxCustomCanvas; const ABounds: TRect);
const
  LineColor = $FF953D;
begin
...
function TcxCustomLookAndFeelPainter.GetListViewItemColorPalette
  (AState: TdxListViewItemState): IdxColorPalette;
begin
  Result := nil;
end;
...
function TcxCustomLookAndFeelPainter.GetListViewItemTextColor
  (AState: TdxListViewItemStates; AExplorerStyle: Boolean): TColor;
begin
  if dxlisHot in AState then
  begin
...
function TcxCustomLookAndFeelPainter.GetListViewColumnHeaderTextColor
  (AState: TcxButtonState; AExplorerStyle: Boolean): TColor;
begin
  Result := DefaultHeaderTextColor;
end;

function TcxCustomLookAndFeelPainter.GetListViewGroupTextColor
  (AKind: TdxListViewGroupTextKind; AState: TdxListViewGroupHeaderStates;
AExplorerStyle: Boolean): TColor;
begin
...
begin
  ...
  if cxIsTouchModeEnabled and (AElementSizeDimension > 0) then
    AElementSizeDimension := Max(AElementSizeDimension,
      AScaleFactor.Apply(cxTouchElementMinSize));
end;
...
function dxGetTouchableSize(AElementSizeDimension: Integer;
AScaleFactor: TdxScaleFactor = nil): Integer;
begin
...
function dxGetTouchableSize(const AElementSize: TSize;
AScaleFactor: TdxScaleFactor = nil): TSize;
begin
  Result := AElementSize;
  dxAdjustToTouchableSize(Result, AScaleFactor);
end;
...
begin
  Result := dxElementSizeFitsForTouch(AElementSizeDimension,
    dxSystemScaleFactor)
end;
...
procedure TcxFlatLookAndFeelPainter.DrawBorder(ACanvas: TcxCustomCanvas;
R: TRect);
begin
  ACanvas.DrawEdge(R, True, True);
end;

function TcxFlatLookAndFeelPainter.ButtonBorderSize
  (AState: TcxButtonState = cxbsNormal): Integer;
begin
  if AState = cxbsDefault then
    Result := 2
...
function TcxFlatLookAndFeelPainter.ScaledButtonTextOffset
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(1);
end;

function TcxFlatLookAndFeelPainter.ScaledButtonTextShift
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(1);
end;

procedure TcxFlatLookAndFeelPainter.DrawButtonBorder(ACanvas: TcxCustomCanvas;
R: TRect; AState: TcxButtonState);
begin
  if AState = cxbsPressed then
...
begin
  ...
  DrawExpandButtonCross(ACanvas, cxRectInflate(R, -1), AExpanded, clBtnText,
    AScaleFactor);
end;

function TcxFlatLookAndFeelPainter.ScaledExpandButtonSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(11);
end;
...
procedure TcxFlatLookAndFeelPainter.DrawCheckBorder(ACanvas: TcxCanvas;
R: TRect; AState: TcxButtonState);
begin
  ACanvas.DrawEdge(R, True, True);
  InflateRect(R, -1, -1);
...
procedure TcxFlatLookAndFeelPainter.DrawScaledSortingMark(ACanvas: TcxCanvas;
const R: TRect; AAscendingSorting: Boolean; AScaleFactor: TdxScaleFactor);
begin
...
procedure TcxFlatLookAndFeelPainter.DrawScaledSummarySortingMark
  (ACanvas: TcxCanvas; const R: TRect; AAscendingSorting: Boolean;
AScaleFactor: TdxScaleFactor);
begin
  DrawSummarySortingArrow(ACanvas, R, clBtnShadow, clBtnHighlight,
    AAscendingSorting, AScaleFactor);
end;
...
function TcxFlatLookAndFeelPainter.ScaledSortingMarkSize
  (AScaleFactor: TdxScaleFactor): TPoint;
begin
  Result := AScaleFactor.Apply(Point(8, 7));
end;

function TcxFlatLookAndFeelPainter.ScaledSummarySortingMarkSize
  (AScaleFactor: TdxScaleFactor): TPoint;
begin
...
procedure TcxFlatLookAndFeelPainter.DrawFooterCellBorder(ACanvas: TcxCanvas;
const R: TRect);
begin
  ACanvas.DrawEdge(R, True, True);
end;

procedure TcxFlatLookAndFeelPainter.DrawScaledFilterDropDownButton
  (ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState;
AIsFilterActive: Boolean; AScaleFactor: TdxScaleFactor);
...
procedure TcxFlatLookAndFeelPainter.DrawTabsRoot(ACanvas: TcxCanvas;
const R: TRect; ABorders: TcxBorders; AVertical: Boolean);
begin
...
procedure TcxFlatLookAndFeelPainter.DrawTrackBarTrackBounds(ACanvas: TcxCanvas;
const ARect: TRect);
var
  R: TRect;
begin
...
procedure TcxFlatLookAndFeelPainter.DrawTrackBarThumbBorderUpDown
  (ACanvas: TcxCanvas; const ALightPolyLine, AShadowPolyLine,
  ADarkPolyLine: TPoints);
begin
...
procedure TcxFlatLookAndFeelPainter.DrawTrackBarThumbBorderBoth
  (ACanvas: TcxCanvas; const ARect: TRect);
begin
...
function TcxFlatLookAndFeelPainter.GetSplitterOuterColor
  (AHighlighted: Boolean): TColor;
begin
  Result := inherited GetSplitterOuterColor(AHighlighted);
  if AHighlighted then
...
procedure TcxFlatLookAndFeelPainter.DrawScaledToggleSwitchState
  (ACanvas: TcxCanvas; ABounds: TRect; AState: TcxButtonState;
AChecked: Boolean; AScaleFactor: TdxScaleFactor);
begin
  ACanvas.FillRect(ABounds, ToggleSwitchToggleColor(AChecked));
...
function TcxFlatLookAndFeelPainter.ToggleSwitchToggleColor
  (AChecked: Boolean): TColor;
begin
  if AChecked then
    Result := $A0A0A0
...
procedure TcxFlatLookAndFeelPainter.DrawFindPanelBorder(ACanvas: TcxCanvas;
const R: TRect; ABorders: TcxBorders);
begin
end;

procedure TcxFlatLookAndFeelPainter.DoDrawScaledScrollBarPart
  (ACanvas: TcxCustomCanvas; AHorizontal: Boolean; R: TRect;
APart: TcxScrollBarPart; AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
begin
  if IsRectEmpty(R) or ((APart = sbpThumbnail) and (AState = cxbsDisabled)) then
...
procedure TcxStandardLookAndFeelPainter.DrawBorder(ACanvas: TcxCustomCanvas;
R: TRect);
begin
  ACanvas.DrawComplexFrame(R, clBtnShadow, clBtnHighlight);
  InflateRect(R, -1, -1);
...
function TcxStandardLookAndFeelPainter.ButtonBorderSize
  (AState: TcxButtonState = cxbsNormal): Integer;
begin
  if AState = cxbsDefault then
    Result := 3
...
function TcxStandardLookAndFeelPainter.ScaledButtonTextOffset
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(1);
end;

function TcxStandardLookAndFeelPainter.ScaledButtonTextShift
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(1);
end;

procedure TcxStandardLookAndFeelPainter.DrawButtonBorder
  (ACanvas: TcxCustomCanvas; R: TRect; AState: TcxButtonState);
begin
  if AState = cxbsPressed then
  begin
...
procedure TcxStandardLookAndFeelPainter.DrawScaledGroupExpandButton
  (ACanvas: TcxCanvas; const R: TRect; AExpanded: Boolean;
AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
var
  APainter: TcxCustomLookAndFeelPainter;
begin
  if cxLookAndFeelPaintersManager.GetPainter(lfsFlat, APainter) then
    APainter.DrawScaledGroupExpandButton(ACanvas, R, AExpanded, AState,
      AScaleFactor)
  else
    inherited DrawScaledGroupExpandButton(ACanvas, R, AExpanded, AState,
      AScaleFactor);
end;

function TcxStandardLookAndFeelPainter.ScaledExpandButtonSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
...
function TcxStandardLookAndFeelPainter.
  DefaultSchedulerTimeRulerBorderColor: TColor;
begin
  Result := DefaultSchedulerTimeRulerBorderColorClassic;
end;
...
procedure TcxStandardLookAndFeelPainter.DrawCheckBorder(ACanvas: TcxCanvas;
R: TRect; AState: TcxButtonState);
begin
...
function TcxStandardLookAndFeelPainter.ScaledSortingMarkSize
  (AScaleFactor: TdxScaleFactor): TPoint;
begin
  Result := AScaleFactor.Apply(Point(8, 7));
end;

function TcxStandardLookAndFeelPainter.ScaledSummarySortingMarkSize
  (AScaleFactor: TdxScaleFactor): TPoint;
begin
  Result := AScaleFactor.Apply(Point(8, 8));
end;
...
procedure TcxStandardLookAndFeelPainter.DrawFooterCellBorder(ACanvas: TcxCanvas;
const R: TRect);
begin
  ACanvas.DrawEdge(R, True, True);
end;

procedure TcxStandardLookAndFeelPainter.DrawScaledFilterDropDownButton
  (ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState;
AIsFilterActive: Boolean; AScaleFactor: TdxScaleFactor);
...
procedure TcxStandardLookAndFeelPainter.DrawTabBorder(ACanvas: TcxCanvas;
R: TRect; ABorder: TcxBorder; ABorders: TcxBorders; AVertical: Boolean);
const
  Colors: array [Boolean] of TColor = (clBtnShadow, clBtnHighlight);
...
procedure TcxStandardLookAndFeelPainter.DrawTabsRoot(ACanvas: TcxCanvas;
const R: TRect; ABorders: TcxBorders; AVertical: Boolean);
begin
  ACanvas.DrawEdge(R, False, False, ABorders);
end;

function TcxStandardLookAndFeelPainter.TabBorderSize
  (AVertical: Boolean): Integer;
begin
  Result := 1;
end;

procedure TcxStandardLookAndFeelPainter.DrawScaledMonthHeader
  (ACanvas: TcxCanvas; const ABounds: TRect; const AText: string;
ANeighbors: TcxNeighbors; const AViewParams: TcxViewParams;
AArrows: TcxArrowDirections; ASideWidth: Integer; AScaleFactor: TdxScaleFactor;
AOnDrawBackground: TcxDrawBackgroundEvent = nil);
const
  Borders: array [Boolean, Boolean] of TcxBorders =
    ((cxBordersAll, [bTop, bBottom, bLeft]), ([bTop, bBottom, bRight],
    [bTop, bBottom]));
var
  ABorders: TcxBorders;
  R: TRect;
begin
  ...
  DrawScaledHeader(ACanvas, R, R, ANeighbors, cxBordersAll, cxbsNormal,
    taCenter, vaCenter, False, False, AText, AViewParams.Font,
    AViewParams.TextColor, AViewParams.Color, AScaleFactor, AOnDrawBackground);
  DrawMonthHeaderArrows(ACanvas, ABounds, AArrows, ASideWidth, clWindowText);
end;
...
procedure TcxStandardLookAndFeelPainter.DrawTrackBarTrackBounds
  (ACanvas: TcxCanvas; const ARect: TRect);
var
  R: TRect;
begin
...
procedure TcxStandardLookAndFeelPainter.DrawTrackBarThumbBorderUpDown
  (ACanvas: TcxCanvas; const ALightPolyLine, AShadowPolyLine,
  ADarkPolyLine: TPoints);
begin
  ACanvas.Pen.Color := clBtnHighlight;
...
procedure TcxStandardLookAndFeelPainter.DrawTrackBarThumbBorderBoth
  (ACanvas: TcxCanvas; const ARect: TRect);
var
  R: TRect;
begin
...
begin
  ...
  begin
    ...
    else if AState in [dxbcbsFocused, dxbcbsHot] then
      ACanvas.DrawComplexFrame(ARect, clBtnHighlight, clBtnShadow);
  end;
end;
...
begin
  ACanvas.FillRect(ABounds, ToggleSwitchToggleColor(AChecked));
  DrawContainerBorder(ACanvas, ABounds, cbs3D, 2, $696969,
    [bLeft, bTop, bRight, bBottom]);
end;

function TcxStandardLookAndFeelPainter.ToggleSwitchToggleColor
  (AChecked: Boolean): TColor;
begin
  if AChecked then
    Result := $219921
...
procedure TcxStandardLookAndFeelPainter.DrawFindPanelBorder(ACanvas: TcxCanvas;
const R: TRect; ABorders: TcxBorders);
begin
end;
...
begin
  ...
  case AState of
    cxbsHot:
      ACanvas.DrawComplexFrame(cxRectInflate(R, -1), clBtnHighlight,
        clBtnShadow);
    cxbsPressed:
      ACanvas.DrawComplexFrame(cxRectInflate(R, -1), clBtnShadow,
        clBtnHighlight);
  end;
end;

procedure TcxStandardLookAndFeelPainter.DoDrawScaledScrollBarPart
  (ACanvas: TcxCustomCanvas; AHorizontal: Boolean; R: TRect;
APart: TcxScrollBarPart; AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
  ...
  begin
    ...
    else if AState = cxbsPressed then
  ...
  begin
    ...
    ACanvas.DrawNativeObject(R, TcxCanvasBasedResourceCacheKey.Create(Self,
      cxSize(R), AArrowState, DFC_SCROLL),
      procedure(ACanvas: TcxGdiBasedCanvas; const R: TRect)
      begin
...
function TcxOffice11LookAndFeelPainter.
  DefaultDateNavigatorSelectionColor: TColor;
begin
...
procedure TcxOffice11LookAndFeelPainter.DrawBorder(ACanvas: TcxCustomCanvas;
R: TRect);
begin
  ACanvas.FrameRect(R, dxOffice11ControlBorderColor);
end;

procedure TcxOffice11LookAndFeelPainter.DoDrawSeparator(ACanvas: TcxCanvas;
R: TRect; AIsVertical: Boolean);
begin
  Dec(R.Right);
  Dec(R.Bottom);
...
function TcxOffice11LookAndFeelPainter.GetBevelMinimalShapeSize
  (AShape: TdxBevelShape): TSize;
begin
  Result := cxSize(2);
end;

procedure TcxOffice11LookAndFeelPainter.GetBevelShapeColors(out AColor1,
  AColor2: TColor);
begin
...
function TcxOffice11LookAndFeelPainter.ScaledClockSize
  (AScaleFactor: TdxScaleFactor): TSize;
begin
  Result := AScaleFactor.Apply(ClockFace.Size);
end;

procedure TcxOffice11LookAndFeelPainter.DrawScaledClock(ACanvas: TcxCanvas;
const ARect: TRect; ADateTime: TDateTime; ABackgroundColor: TColor;
AScaleFactor: TdxScaleFactor);
begin
  DrawModernCalendarClock(ACanvas, ARect, ADateTime, ABackgroundColor,
...
begin
  ...
  if cxColorIsValid(AColor1) and cxColorIsValid(AColor2) then
    Office11FillTubeGradientRect(ACanvas.Handle, cxRectInflate(R, -1), AColor1,
      AColor2, False);
end;

procedure TcxOffice11LookAndFeelPainter.DoDrawGanttSheetHeaderBackground
  (ACanvas: TcxCustomCanvas; const R: TRect; AState: TcxButtonState);
begin
  if AState = cxbsPressed then
  begin
    DrawContentBackground(ACanvas, R, cxbsNormal, DefaultHeaderColor, False);
    ACanvas.FillRectByGradient(Rect(R.Left - 1, R.Bottom - 2, R.Right,
      R.Bottom + 1), dxOffice11SelectedColor1, dxOffice11SelectedColor2, False);
  end
  else
    DrawContentBackground(ACanvas, R, AState, DefaultHeaderColor, False);
end;

function TcxOffice11LookAndFeelPainter.ButtonColor
  (AState: TcxButtonState): TColor;
begin
  case AState of
    cxbsHot:
...
function TcxOffice11LookAndFeelPainter.ButtonSymbolColor(AState: TcxButtonState;
ADefaultColor: TColor = clDefault): TColor;
begin
  if (AState = cxbsPressed) and not IsXPStandardScheme then
    Result := clHighlightText
  else if AState = cxbsDisabled then
    Result := dxOffice11TextDisabledColor
  else
    Result := dxOffice11TextEnabledColor;
end;

procedure TcxOffice11LookAndFeelPainter.DrawButtonBorder
  (ACanvas: TcxCustomCanvas; R: TRect; AState: TcxButtonState);
...
begin
  ACanvas.DrawNativeObject(R, TcxCanvasBasedResourceCacheKey.Create(Self,
    cxSize(R), Ord(AExpanded), 0, AScaleFactor.TargetDPI),
    procedure(ACanvas: TcxGdiBasedCanvas; const R: TRect)
    var
      ABitmap: TBitmap;
    begin
      ...
      cxDrawImage(ACanvas, R, ABitmap, ifmProportionalStretch, nil,
        AScaleFactor);
    end);
end;
...
procedure TcxOffice11LookAndFeelPainter.DrawScaledSmallExpandButton
  (ACanvas: TcxCanvas; R: TRect; AExpanded: Boolean; ABorderColor: TColor;
AScaleFactor: TdxScaleFactor; AColor: TColor = clDefault);
begin
...
function TcxOffice11LookAndFeelPainter.ScaledExpandButtonSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := AScaleFactor.Apply(11);
end;

function TcxOffice11LookAndFeelPainter.ScaledSmallExpandButtonSize
  (AScaleFactor: TdxScaleFactor): Integer;
begin
  Result := ScaledExpandButtonSize(AScaleFactor);
end;

function TcxOffice11LookAndFeelPainter.CheckButtonColor(AState: TcxButtonState;
ACheckState: TcxCheckBoxState): TColor;
begin
  case AState of
...
function TcxOffice11LookAndFeelPainter.RadioButtonBodyColor
  (AState: TcxButtonState): TColor;
begin
  if AState = cxbsNormal then
    Result := clWindow
...
procedure TcxOffice11LookAndFeelPainter.DrawContentBackground
  (ACanvas: TcxCustomCanvas; const R: TRect; AState: TcxButtonState;
ABackgroundColor: TColor; AIsFooter: Boolean);
var
  AColor1, AColor2: TColor;
begin
  ...
  begin
    ...
    ACanvas.FillRectByGradient(Rect(R.Left, R.Bottom - 4, R.Right, R.Bottom),
      AColor1, AColor2, False);
  end;
...
procedure TcxOffice11LookAndFeelPainter.DrawScaledHeader(ACanvas: TcxCanvas;
const ABounds, ATextAreaBounds: TRect; ANeighbors: TcxNeighbors;
ABorders: TcxBorders; AState: TcxButtonState; AAlignmentHorz: TAlignment;
AAlignmentVert: TcxAlignmentVert; AMultiLine, AShowEndEllipsis: Boolean;
const AText: string; AFont: TFont; ATextColor, ABkColor: TColor;
...
begin
  inherited DrawScaledHeader(ACanvas, ABounds, ATextAreaBounds, ANeighbors,
    ABorders, AState, AAlignmentHorz, AAlignmentVert, AMultiLine,
    AShowEndEllipsis, AText, AFont, ATextColor, ABkColor, dxDefaultScaleFactor,
    TcxDrawBackgroundEvent(nil), AIsLast, False);
end;
...
begin
  ...
  begin
    ...
    begin
      Y1 := R.Top + 1;
      ACanvas.FillPixel(R.Right - 1, R.Top, dxGetMiddleRGB(AColor1,
        HeaderDarkEdgeColor, 50));
      Y2 := R.Bottom - 2;
      ACanvas.FillPixel(R.Right - 1, R.Bottom - 2,
        dxGetMiddleRGB(AColor2, HeaderDarkEdgeColor, 50));
    end;
...
AScaleFactor: TdxScaleFactor);
begin
  DrawSortingArrow(ACanvas, R, HeaderDarkEdgeColor, HeaderHighlightEdgeColor,
    AAscendingSorting, AScaleFactor);
end;
...
AScaleFactor: TdxScaleFactor);
begin
  DrawSummarySortingArrow(ACanvas, R, HeaderDarkEdgeColor,
    HeaderHighlightEdgeColor, AAscendingSorting, AScaleFactor);
end;

function TcxOffice11LookAndFeelPainter.HeaderBorders(ANeighbors: TcxNeighbors)
  : TcxBorders;
begin
  Result := cxBordersAll;
end;
...
begin
  LayoutViewDrawRecordBorder(ACanvas, ABounds, AState, cxBordersAll);
  DrawContent(ACanvas, ABounds, cxEmptyRect, AState, taLeftJustify, vaTop,
    False, False, '', nil, clDefault, clDefault, nil, APosition = cxgpTop);
end;

function TcxOffice11LookAndFeelPainter.ScaledScrollBarMinimalThumbSize
  (AVertical: Boolean; AScaleFactor: TdxScaleFactor): Integer;
var
  APainter: TcxCustomLookAndFeelPainter;
begin
...
const ARect: TRect; AScaleFactor: TdxScaleFactor);
begin
  Office11DrawSizeGrip(ACanvas.Handle, ARect, clDefault, clDefault,
    AScaleFactor);
end;

procedure TcxOffice11LookAndFeelPainter.DrawScaledMonthHeader
  (ACanvas: TcxCanvas; const ABounds: TRect; const AText: string;
ANeighbors: TcxNeighbors; const AViewParams: TcxViewParams;
AArrows: TcxArrowDirections; ASideWidth: Integer; AScaleFactor: TdxScaleFactor;
AOnDrawBackground: TcxDrawBackgroundEvent = nil);
...
begin
  if cxLookAndFeelPaintersManager.GetPainter(lfsNative, APainter) then
    APainter.DrawSchedulerScaledNavigatorButton(ACanvas, R, AState,
      AScaleFactor)
  else
...
procedure TcxOffice11LookAndFeelPainter.DrawSchedulerBorder(ACanvas: TcxCanvas;
R: TRect);
begin
...
begin
  Result := dxGetMiddleRGB(dxOffice11ToolbarsColor1,
    dxOffice11ToolbarsColor2, 50);
end;

procedure TcxOffice11LookAndFeelPainter.DoDrawScaledScrollBarPart
  (ACanvas: TcxCustomCanvas; AHorizontal: Boolean; R: TRect;
APart: TcxScrollBarPart; AState: TcxButtonState; AScaleFactor: TdxScaleFactor);
var
  APainter: TcxCustomLookAndFeelPainter;
begin
  if cxLookAndFeelPaintersManager.GetPainter(lfsNative, APainter) then
    APainter.DoDrawScaledScrollBarPart(ACanvas, AHorizontal, R, APart, AState,
      AScaleFactor)
  else
    inherited DoDrawScaledScrollBarPart(ACanvas, AHorizontal, R, APart, AState,
      AScaleFactor);
...
function TcxOffice11LookAndFeelPainter.FilterDropDownButtonBorderColor
  (AState: TcxButtonState): TColor;
begin
  if AState = cxbsNormal then
    Result := HeaderDarkEdgeColor
...
function cxDataRowFixingImages: TcxImageList;
  ...
  begin
    ...
    if FDataRowFixingImages = nil then
      FDataRowFixingImages := TcxImageList.CreateSize(ASmartImage.Width,
        ASmartImage.Height);
...
begin
  ...
  begin
    ...
    try
      ...
      FLookAndFeelPaintersManager.Register
        (TcxOffice11LookAndFeelPainter.Create);
      FLookAndFeelPaintersManager.Register
        (TcxStandardLookAndFeelPainter.Create);
      FLookAndFeelPaintersManager.Register
        (TcxUltraFlatLookAndFeelPainter.Create);
...
begin
  if AreVisualStylesAvailable([totButton]) and
    cxLookAndFeelPaintersManager.GetPainter(lfsNative, APainter) then
...
function TcxOffice11LookAndFeelPainter.GroupBoxTextColor(AEnabled: Boolean;
ACaptionPosition: TcxGroupBoxCaptionPosition): TColor;
var
  APainter: TcxCustomLookAndFeelPainter;
begin
...
procedure TcxOffice11LookAndFeelPainter.DrawTrackBarTrackBounds
  (ACanvas: TcxCanvas; const ARect: TRect);
begin
  ACanvas.FrameRect(ARect, clBtnText);
end;

procedure TcxOffice11LookAndFeelPainter.DrawTrackBarThumbBorderUpDown
  (ACanvas: TcxCanvas; const ALightPolyLine, AShadowPolyLine,
  ADarkPolyLine: TPoints);
begin
...
procedure TcxOffice11LookAndFeelPainter.DrawTrackBarThumbBorderBoth
  (ACanvas: TcxCanvas; const ARect: TRect);
begin
  ACanvas.FrameRect(ARect, clBtnText);
end;

procedure TcxOffice11LookAndFeelPainter.DrawPanelBackground(ACanvas: TcxCanvas;
AControl: TWinControl; ABounds: TRect; AColorFrom, AColorTo: TColor);
begin
  if AColorFrom = clDefault then
    cxDrawTransparentControlBackground(AControl, ACanvas, ABounds)
  else if AColorTo = clDefault then
    ACanvas.FillRect(ABounds, AColorFrom)
  else
...
procedure TcxOffice11LookAndFeelPainter.DrawLayoutControlBackground
  (ACanvas: TcxCanvas; const R: TRect);
begin
  FillGradientRect(ACanvas.Handle, R, dxOffice11ToolbarsColor1,
...
function TcxOffice11LookAndFeelPainter.GetSplitterInnerColor
  (AHighlighted: Boolean): TColor;
begin
  Result := dxOffice11BarSeparatorColor2;
end;

function TcxOffice11LookAndFeelPainter.GetSplitterOuterColor
  (AHighlighted: Boolean): TColor;
begin
  if AHighlighted then
    Result := dxOffice11SelectedBorderColor
...
procedure TcxOffice11LookAndFeelPainter.DrawBreadcrumbEditBorders
  (ACanvas: TcxCanvas; const ARect: TRect; ABorders: TcxBorders;
AState: TdxBreadcrumbEditState);
begin
...
begin
  ...
  FillRectByColor(ACanvas.Handle, cxRectCenterVertically(R, 1),
    dxOffice11BarSeparatorColor1);
end;

procedure TcxOffice11LookAndFeelPainter.
  DrawDropDownListBoxScaledGutterBackground(ACanvas: TcxCanvas;
const ARect: TRect; AScaleFactor: TdxScaleFactor);
begin
  Office11FillTubeGradientRect(ACanvas.Handle, ARect,
...
class function TcxRadioButtonImageListManager.Get(AScaleFactor: TdxScaleFactor)
  : TcxRadioButtonImageList;
begin
  if FCache = nil then
    FCache := TObjectDictionary<Integer, TcxRadioButtonImageList>.Create
      ([doOwnsValues]);
...
procedure TcxLookAndFeelPaintersManager.AddListener(const AListener
...
procedure TcxLookAndFeelPaintersManager.DoPainterAdded
  (APainter: TcxCustomLookAndFeelPainter);
var
  I: Integer;
begin
...
procedure TcxLookAndFeelPaintersManager.DoPainterRemoved
  (APainter: TcxCustomLookAndFeelPainter);
var
  I: Integer;
begin
...
function TcxLookAndFeelPaintersManager.GetPainter(AStyle: TcxLookAndFeelStyle)
  : TcxCustomLookAndFeelPainter;
begin
...
function TcxLookAndFeelPaintersManager.GetPainter(AStyle: TcxLookAndFeelStyle;
out APainter: TcxCustomLookAndFeelPainter): Boolean;
begin
  APainter := FStandardPainters[AStyle];
  Result := APainter <> nil;
end;

function TcxLookAndFeelPaintersManager.GetPainter(const AName: string;
out APainter: TcxCustomLookAndFeelPainter): Boolean;
var
  I: Integer;
begin
...
function TcxLookAndFeelPaintersManager.Register
  (APainter: TcxCustomLookAndFeelPainter): Boolean;
begin
...
procedure TcxLookAndFeelPaintersManager.RemoveListener(const AListener
  : IcxLookAndFeelPainterListener);
begin
...
function TcxLookAndFeelPaintersManager.GetItem(AIndex: Integer)
  : TcxCustomLookAndFeelPainter;
begin
  Result := TcxCustomLookAndFeelPainter(FPainters[AIndex]);
end;

class function TcxLookAndFeelPaintersManager.CompareProc(AItem1,
  AItem2: TcxCustomLookAndFeelPainter): Integer;
begin
...
procedure dxRotateSizeGrip(ACanvas: TcxCanvas; const ARect: TRect;
AScaleFactor: TdxScaleFactor; ABackgroundColor: TColor; ACorner: TdxCorner;
AOnDrawSizeGrip: TdxDrawScaledRectEvent);
const
  ARotationMap: array [Boolean] of TcxRotationAngle = (ra0, ra180);
var
  ABitmap: TcxBitmap;
...
FreeAndNil(FLookAndFeelPaintersManager);
