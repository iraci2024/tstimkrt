...
uses
  Controls, Types, MultiMon, cxControls, cxContainer, dxIncrementalFiltering,
  cxLookAndFeels;
...
type
  ...
  TdxUIElementPopupWindowViewInfo = class
...
procedure TdxUIElementPopupWindow.CorrectBoundsWithDesktopWorkArea
...
procedure TdxUIElementPopupWindow.UpdateInnerControlsHeight(var AClientHeight
  : Integer);
begin
  // do nothing
end;
...
begin
  ...
  begin
    if (AValue = nil) and Visible and
      ((OwnerIntf = nil) or OwnerIntf.ClosePopupWhenSetNil) then
      CloseUp;
    FOwner := AValue;
    OwnerChanged;
  end;
