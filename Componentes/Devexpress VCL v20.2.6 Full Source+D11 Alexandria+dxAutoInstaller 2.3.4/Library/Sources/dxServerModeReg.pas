...
uses
  Graphics, Forms, Controls, StdCtrls, DsnDBCst, DsnDB, DesignIntf,
  cxPropEditors,
...
type
  ...
  TdxServerModeKeyFieldNamesProperty = class(TStringProperty,
...
begin
  ...
  if (ADataSet <> nil) and (ADataSet.Owner is TdxServerModeCustomDataSource)
  then
...
function TdxServerModeSummaryItemFieldNameProperty.GetAttributes
  : TPropertyAttributes;
begin
  Result := [paValueList, paSortList];
end;

procedure TdxServerModeSummaryItemFieldNameProperty.GetValues
  (Proc: TGetStrProc);
var
...
function TdxServerModeSummaryItemFieldNameProperty.GetSummaryItem
...
constructor TdxServerModeKeyFieldNamesProperty.Create(const ADesigner
  : IDesigner; APropCount: Integer);
begin
...
function TdxServerModeKeyFieldNamesProperty.GetDataSource
  : TdxServerModeCustomDataSourceAccess;
begin
...
begin
  AdapterClass := TdxServerModeCustomSQLAdapterClass
    (dxGetServerModeSQLAdapters.FindByClassName(Value));
  if AdapterClass = nil then
    AdapterClass := TdxServerModeCustomSQLAdapterClass
      (dxGetServerModeSQLAdapters.FindByDescription(Value));
  for I := 0 to PropCount - 1 do
    TdxServerModeCustomDataSource(GetComponent(I)).SQLAdapterClass :=
      AdapterClass;
  Modified;
end;
...
function TdxServerModeCustomDataSourceEditor.InternalGetVerb
...
procedure TdxServerModeCustomDataSourceEditor.InternalExecuteVerb
  (AIndex: Integer);
begin
  if AIndex = 0 then
    ExecuteFieldsEditor
...
function TdxServerModeCustomDataSourceEditor.GetDataSource
...
{$IFNDEF NONDB}
  ...
  RegisterPropertyEditor(TypeInfo(string), TdxServerModeDataSource, 'TableName',
    TdxServerModeTableNameProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxServerModeCustomDataSource,
    'KeyFieldNames', TdxServerModeKeyFieldNamesProperty);
  RegisterPropertyEditor(TypeInfo(TdxServerModeCustomSQLAdapter),
    TdxServerModeCustomDataSource, 'SQLAdapter',
    TdxServerModeSQLAdapterProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxServerModeCustomDataSource,
    'SQLAdapterClassName', nil);
  RegisterPropertyEditor(TypeInfo(string), TdxServerModeSummaryItem,
    'FieldName', TdxServerModeSummaryItemFieldNameProperty);
  RegisterPropertyEditor(TypeInfo(TNotifyEvent), TdxServerModeCustomDataSource,
    'SQLAdapterEvents', TdxServerModeSQLAdapterEventsProperty);
  RegisterComponentEditor(TdxServerModeCustomDataSource,
    TdxServerModeCustomDataSourceEditor);
  RegisterSprigType(TdxServerModeDataSource, TdxServerModeDataSourceSprig);
  RegisterSprigType(TdxServerModeQueryDataSource,
    TdxServerModeQueryDataSourceSprig);
