...
type
  ...
  IdxTabPropertiesContainer = interface
    ...
    function CreateTabPropertiesChangedHistoryItem
  ...
  IdxStylesContainer = interface
    ...
    property CharacterStyles: TdxCharacterStyleCollection
    ...
    property ParagraphStyles: TdxParagraphStyleCollection
  ...
  TdxParagraphPropertiesBasedStyle = class(TdxStyleBase,
    IdxParagraphPropertiesContainer, IdxTabPropertiesContainer)
  private
  ...
  public
    constructor Create(ADocumentModel: TdxCustomDocumentModel;
      AParent: TdxParagraphPropertiesBasedStyle = nil;
    ...
    function GetParagraphProperties(AMask: TdxUsedParagraphFormattingOption)
      : TdxParagraphProperties; overload; virtual;
    ...
    property Parent: TdxParagraphPropertiesBasedStyle read GetParentStyle
      write SetParentStyle;
  ...
  TdxParagraphStyle = class(TdxParagraphPropertiesBasedStyle,
  ...
  public
    constructor Create(ADocumentModel: TdxCustomDocumentModel;
      AParentStyle: TdxParagraphStyle = nil; const AStyleName: string = '');
      reintroduce;
    destructor Destroy; override;
    ...
    procedure SetNumberingListIndex(ANumberingListIndex
    ...
    property NextParagraphStyle: TdxParagraphStyle read FNextParagraphStyle
      write SetNextParagraphStyle;
  ...
  private
    function CreateHeadingParagraphStyle(const AStyleName: string;
  ...
  protected
    ...
    function CreateHeadingCharacterStyle(const AStyleName: string;
      ALevel: Integer): Integer;
    function GetHeadingCharacterStyleCore(ALevel: Integer): Integer;
    procedure SetupHeadingCharacterStyle(AStyle: TdxCharacterStyle;
      ALevel: Integer);
  public
  ...
  private
    ...
    FParagraphStyleToCharacterStyleLinks
      : TDictionary<TdxParagraphStyle, TdxCharacterStyle>;
    FCharacterStyleToParagraphStyleLinks
      : TDictionary<TdxCharacterStyle, TdxParagraphStyle>;
  public
    constructor Create(ADocumentModel: TdxCustomDocumentModel);
    destructor Destroy; override;

    procedure CreateLink(AParagraphStyle: TdxParagraphStyle;
      ACharacterStyle: TdxCharacterStyle);
    procedure CreateLinkCore(AParagraphStyle: TdxParagraphStyle;
      ACharacterStyle: TdxCharacterStyle);
    procedure DeleteLinkCore(AParagraphStyle: TdxParagraphStyle;
      ACharacterStyle: TdxCharacterStyle);
    ...
    function GetLinkedParagraphStyle(ACharacterStyle: TdxCharacterStyle)
      : TdxParagraphStyle;
    function GetLinkedCharacterStyle(AParagraphStyle: TdxParagraphStyle)
      : TdxCharacterStyle;
    function HasLinkedParagraphStyle(ACharacterStyle
      : TdxCharacterStyle): Boolean;
    function HasLinkedCharacterStyle(AParagraphStyle
      : TdxParagraphStyle): Boolean;
  ...
  TdxStyleTopologicalComparer<T: TdxStyleBase> = class(TInterfacedObject,
    IComparer<T>)
  public
    // IComparer
...
type
  ...
  public
    constructor Create(AParagraphStyle: TdxParagraphStyle;
      ACharacterStyle: TdxCharacterStyle); reintroduce;
...
constructor TdxStyleLinkHistoryItemBase.Create(AParagraphStyle
  : TdxParagraphStyle; ACharacterStyle: TdxCharacterStyle);
begin
...
constructor TdxParagraphPropertiesBasedStyle.Create(ADocumentModel
  : TdxCustomDocumentModel; AParent: TdxParagraphPropertiesBasedStyle = nil;
...
function TdxParagraphPropertiesBasedStyle.GetDocumentModel
  : TdxCustomDocumentModel;
begin
  Result := inherited DocumentModel;
end;

function TdxParagraphPropertiesBasedStyle.GetMergedFrameProperties
...
begin
  if Deleted then
    TdxRichEditExceptions.ThrowInvalidOperationException
      (cxGetResourceString(@sdxRichEditExceptionUseDeletedStyleError));
...
function TdxParagraphPropertiesBasedStyle.GetMergedParagraphProperties
...
function TdxParagraphPropertiesBasedStyle.
  GetMergedWithDefaultParagraphProperties: TdxMergedParagraphProperties;
begin
  Assert(not Deleted);
...
function TdxParagraphPropertiesBasedStyle.GetParagraphProperties
  (AMask: TdxUsedParagraphFormattingOption): TdxParagraphProperties;
begin
  if Deleted then
    TdxRichEditExceptions.ThrowInvalidOperationException
      (cxGetResourceString(@sdxRichEditExceptionUseDeletedStyleError));
...
function TdxParagraphPropertiesBasedStyle.CalculateChangeActions
...
function TdxParagraphPropertiesBasedStyle.GetParentStyle
  : TdxParagraphPropertiesBasedStyle;
begin
...
procedure TdxParagraphPropertiesBasedStyle.CopyProperties
  (ASource: TdxStyleBase);
var
...
function TdxParagraphPropertiesBasedStyle.
  CreateParagraphPropertiesChangedHistoryItem: TdxIndexChangedHistoryItemCore;
begin
  Result := TdxIndexChangedHistoryItem.Create(DocumentModel.MainPart,
    ParagraphProperties);
end;

function TdxParagraphPropertiesBasedStyle.CreateTabPropertiesChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
...
procedure TdxParagraphPropertiesBasedStyle.SetFrameProperties
  (const Value: TdxFrameProperties);
begin
...
procedure TdxParagraphPropertiesBasedStyle.SetParentStyle
  (const Value: TdxParagraphPropertiesBasedStyle);
begin
...
constructor TdxParagraphStyle.Create(ADocumentModel: TdxCustomDocumentModel;
  AParentStyle: TdxParagraphStyle = nil; const AStyleName: string = '');
begin
...
begin
  ...
  if NextParagraphStyle <> nil then
    ACopy.NextParagraphStyle := ATarget.ParagraphStyles
      [NextParagraphStyle.Copy(ATargetModel)];
end;

function TdxParagraphStyle.CopyFrom(ATargetModel: TdxCustomDocumentModel)
  : TdxParagraphStyle;
begin
...
var
  AMergedWithDefaultParagraphProperties,
    AStyleMergedWithDefaultParagraphProperties: TdxMergedParagraphProperties;
...
begin
  ...
  if GetOwnNumberingListIndex >= 0 then
    AStyle.SetNumberingListIndex(TdxSimpleDocumentModel(DocumentModel)
      .GetNumberingListIndex(AStyle.DocumentModel, GetOwnNumberingListIndex,
  ...
  if Parent <> nil then
    AStyle.Parent := AStyle.Container.ParagraphStyles
      [Parent.Copy(AStyle.DocumentModel)];
  ...
  AStyleMergedWithDefaultCharacterProperties :=
    AStyle.GetMergedWithDefaultCharacterProperties;
  try
...
begin
  ...
  else if (FNumberingListIndex = NumberingListIndexNoNumberingList) or
    (Parent = nil) then
    Result := 0
  else if (FListLevelIndex > 0) and
    (Parent.GetNumberingListIndex >= NumberingListIndexMinValue) then
    Result := FListLevelIndex
  else
    Result := Parent.GetListLevelIndex;
end;

function TdxParagraphStyle.GetMergedCharacterProperties
...
function TdxParagraphStyle.GetMergedWithDefaultCharacterProperties
  : TdxMergedCharacterProperties;
begin
  Assert(not Deleted);
...
begin
  if (FNumberingListIndex >= NumberingListIndexMinValue) or
    (FNumberingListIndex = NumberingListIndexNoNumberingList) or (Parent = nil)
  then
...
procedure TdxParagraphStyle.SetNumberingListIndex(ANumberingListIndex
  : TdxNumberingListIndex);
begin
  FNumberingListIndex := ANumberingListIndex;
end;

procedure TdxParagraphStyle.SetNumberingListLevelIndex(AListLevelIndex
  : Integer);
begin
...
function TdxParagraphStyle.CreateCharacterPropertiesChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
  Result := TdxIndexChangedHistoryItem.Create(PieceTable, CharacterProperties);
end;

function TdxParagraphStyle.CreateParagraphPropertiesChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
...
procedure TdxParagraphStyle.OnObtainAffectedRange(ASender: TObject;
  E: TdxObtainAffectedRangeEventArgs);
begin
  E.Start := 0;
  E.&End := MaxInt;
...
begin
  if NextParagraphStyle = Value then
    Exit;
  AItem := TdxParagraphStyleChangeNextParagraphStylePropertyHistoryItem.Create
    (Self, NextParagraphStyle, Value);
  DocumentModel.History.Add(AItem);
  AItem.Execute;
...
begin
  AStyle := TdxParagraphStyle.Create(DocumentModel, DefaultItem,
    GetTocStyleName(ALevel));
  Result := Add(AStyle);
  SetupTocStyle(AStyle, ALevel);
end;

function TdxParagraphStyleCollection.GetHeadingParagraphStyle
  (ALevel: Integer): Integer;
var
...
begin
  ...
  ACharacterStyleIndex := AContainer.CharacterStyles.
    GetHeadingCharacterStyleCore(ALevel);
  AParagraphStyle := Items[AParagraphStyleIndex];
  ACharacterStyle := AContainer.CharacterStyles[ACharacterStyleIndex];
  if not AParagraphStyle.HasLinkedStyle and not ACharacterStyle.HasLinkedStyle
  then
...
begin
  Result := TdxParagraphStyle.Create(DocumentModel, nil,
    DefaultParagraphStyleName);
end;

function TdxParagraphStyleCollection.CreateHeadingParagraphStyle
  (const AStyleName: string; ALevel: Integer): Integer;
var
  AStyle: TdxParagraphStyle;
begin
...
function TdxParagraphStyleCollection.GetHeadingParagraphStyleCore
  (ALevel: Integer): Integer;
var
  AStyleName: string;
  AIndex: Integer;
...
procedure TdxParagraphStyleCollection.SetupHeadingParagraphStyle
  (AStyle: TdxParagraphStyle; ALevel: Integer);
var
...
begin
  ...
  if ALevel = 1 then
    AStyle.ParagraphProperties.SpacingBefore :=
      AUnitConverter.PointsToModelUnits(24)
  else
    AStyle.ParagraphProperties.SpacingBefore :=
      AUnitConverter.PointsToModelUnits(10);
  ...
  case ALevel of
    1:
      begin
        ...
        ACharacterProperties.ForeColor := TdxAlphaColors.FromArgb($36,
          $5F, $91);
      end;
    2:
      begin
        ...
        ACharacterProperties.FontBold := True;
        ACharacterProperties.ForeColor := TdxAlphaColors.FromArgb($4F,
          $81, $BD);
      end;
    3:
      begin
    ...
    6:
      begin
        ACharacterProperties.FontItalic := True;
        ACharacterProperties.ForeColor := TdxAlphaColors.FromArgb($24,
          $3F, $60);
      end;
    7:
      begin
        ACharacterProperties.FontItalic := True;
        ACharacterProperties.ForeColor := TdxAlphaColors.FromArgb($40,
          $40, $40);
      end;
    8:
      begin
...
procedure TdxParagraphStyleCollection.SetupTocStyle(AStyle: TdxParagraphStyle;
  ALevel: Integer);
begin
  AStyle.ParagraphProperties.OutlineLevel := 0;
  AStyle.ParagraphProperties.SpacingAfter :=
    DocumentModel.UnitConverter.PointsToModelUnits(5);
  AStyle.ParagraphProperties.LeftIndent := 221 * (ALevel - 1);
end;

procedure TdxParagraphStyleCollection.NotifyDocumentStyleDeleting
  (AParagraphStyle: TdxStyleBase);
var
  I: Integer;
...
procedure TdxParagraphStyleCollection.NotifyPieceTableStyleDeleting
  (APieceTable: TdxCustomPieceTable; AParagraphStyle: TdxStyleBase);
var
  I: Integer;
...
function TdxCharacterStyle.CalculateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxParagraphFormattingChangeActionsCalculator.CalculateChangeActions
    (TdxParagraphFormattingChangeType.ParagraphStyle);
...
begin
  ...
  CharacterProperties.CopyFrom(TdxCharacterStyle(ASource)
    .CharacterProperties.Info);
end;

function TdxCharacterStyle.GetMergedCharacterProperties
  : TdxMergedCharacterProperties;
var
  AParentProperties: TdxMergedCharacterProperties;
begin
...
function TdxCharacterStyle.GetMergedWithDefaultCharacterProperties
  : TdxMergedCharacterProperties;
begin
  Assert(not Deleted);
  Result := GetMergedCharacterProperties;
...
function TdxCharacterStyle.CopyFrom(ATargetModel: TdxCustomDocumentModel)
  : TdxCharacterStyle;
begin
...
begin
  ...
  AStyle.StyleName := StyleName;
  if Parent <> nil then
    AStyle.Parent := AStyle.Container.CharacterStyles
      [Parent.Copy(AStyle.DocumentModel)];
  AStyleMergedWithDefaultCharacterProperties :=
    AStyle.GetMergedWithDefaultCharacterProperties;
  try
...
function TdxCharacterStyle.CreateCharacterPropertiesChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
  Result := TdxIndexChangedHistoryItem.Create(PieceTable, CharacterProperties);
end;
...
constructor TdxCharacterStyleCollection.Create(ADocumentModel
  : TdxCustomDocumentModel);
begin
...
begin
  Result := TdxCharacterStyle.Create(DocumentModel, nil,
    DefaultCharacterStyleName);
...
function TdxCharacterStyleCollection.CreateLineNumberingStyle
  : TdxCharacterStyle;
begin
  Result := TdxCharacterStyle.Create(DocumentModel,
    Items[EmptyCharacterStyleIndex], LineNumberingStyleName);
  Result.SemihiddenCore := True;
end;

function TdxCharacterStyleCollection.CreateHeadingCharacterStyle
  (const AStyleName: string; ALevel: Integer): Integer;
var
  AStyle: TdxCharacterStyle;
begin
...
function TdxCharacterStyleCollection.GetHeadingCharacterStyleCore
  (ALevel: Integer): Integer;
var
  AStyleName: string;
  AIndex: Integer;
...
procedure TdxCharacterStyleCollection.SetupHeadingCharacterStyle
  (AStyle: TdxCharacterStyle; ALevel: Integer);
begin
  AStyle.Hidden := True;
end;
...
begin
  ...
  FParagraphStyleToCharacterStyleLinks :=
    TDictionary<TdxParagraphStyle, TdxCharacterStyle>.Create;
  FCharacterStyleToParagraphStyleLinks :=
    TDictionary<TdxCharacterStyle, TdxParagraphStyle>.Create;
end;
...
procedure TdxStyleLinkManager.CreateLink(AParagraphStyle: TdxParagraphStyle;
  ACharacterStyle: TdxCharacterStyle);
var
...
begin
  ...
  if AParagraphStyle.Deleted or ACharacterStyle.Deleted then
    TdxRichEditExceptions.ThrowInvalidOperationException
      (cxGetResourceString(@sdxRichEditExceptionErrorLinkDeletedStyle));

  DocumentModel.BeginUpdate;
  try
    ATransaction := TdxHistoryTransaction.Create(DocumentModel.History);
    try
      ACharacterStyle.CharacterProperties.CopyFrom
        (AParagraphStyle.CharacterProperties);
      AItem := TdxCreateStyleLinkHistoryItem.Create(AParagraphStyle,
        ACharacterStyle);
      DocumentModel.History.Add(AItem);
      AItem.Execute;
    finally
...
procedure TdxStyleLinkManager.CreateLinkCore(AParagraphStyle: TdxParagraphStyle;
  ACharacterStyle: TdxCharacterStyle);
begin
...
procedure TdxStyleLinkManager.DeleteLinkCore(AParagraphStyle: TdxParagraphStyle;
  ACharacterStyle: TdxCharacterStyle);
begin
...
begin
  if not ACharacterStyle.HasLinkedStyle then
    TdxRichEditExceptions.ThrowArgumentException('CharacterStyle',
      ACharacterStyle);
...
begin
  if not AParagraphStyle.HasLinkedStyle then
    TdxRichEditExceptions.ThrowArgumentException('ParagraphStyle',
      AParagraphStyle);
  DeleteLinkCore(AParagraphStyle, AParagraphStyle.LinkedStyle);
end;

function TdxStyleLinkManager.GetLinkedParagraphStyle(ACharacterStyle
  : TdxCharacterStyle): TdxParagraphStyle;
begin
  if not FCharacterStyleToParagraphStyleLinks.TryGetValue(ACharacterStyle,
    Result) then
    Result := nil;
end;

function TdxStyleLinkManager.GetLinkedCharacterStyle(AParagraphStyle
  : TdxParagraphStyle): TdxCharacterStyle;
begin
  if not FParagraphStyleToCharacterStyleLinks.TryGetValue(AParagraphStyle,
    Result) then
    Result := nil;
end;

function TdxStyleLinkManager.HasLinkedParagraphStyle(ACharacterStyle
  : TdxCharacterStyle): Boolean;
begin
  Result := FCharacterStyleToParagraphStyleLinks.ContainsKey(ACharacterStyle);
end;

function TdxStyleLinkManager.HasLinkedCharacterStyle(AParagraphStyle
  : TdxParagraphStyle): Boolean;
begin
...
begin
  if Left.Parent = TdxStyleBase(Right) then
    Result := 1
  else if Right.Parent = TdxStyleBase(Left) then
    Result := -1
  else
    Result := 0;
end;
