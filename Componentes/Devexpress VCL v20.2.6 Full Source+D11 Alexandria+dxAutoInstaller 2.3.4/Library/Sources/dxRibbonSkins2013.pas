...
type
  ...
  protected
    ...
    // Color Palettes
    function CreateBackstageViewMenuPalette
      : IdxRibbonSkinColorPaletteSet; virtual;
    ...
    procedure LoadGlyphs(ABitmap: GpBitmap; var AParts; const R: TRect;
      AID: Integer; AStateCount: Integer;
    ...
    procedure LoadRibbonFormBorderIconsGlyphs(ABitmap: GpBitmap;
      X, Y, AWidth, AHeight: Integer); override;
    procedure LoadRibbonTexturesSet(AImage: TdxGPImage); override;

    // ColorfulButton
    procedure DrawColorfulButton(DC: HDC; const R: TRect;
    ...
    function GetFormCaptionAreaColor(AApplicationMenuState
      : TdxRibbonApplicationMenuState = ramsHidden; AActive: Boolean = True)
      : TColor; virtual;
    ...
    function GetFormBorderIconGlyphColor(AIcon: TdxRibbonBorderDrawIcon;
      AState: TdxRibbonBorderIconState): TColor; virtual;
    ...
    function GetMenuBackgroundColor(const ALightnessDelta: Double)
      : TColor; overload;
  ...
  public
    ...
    procedure DrawApplicationMenuBackground(DC: HDC; const R: TRect;
      const AContentRect: TRect); override;
    ...
    procedure DrawScrollBarPartGlyph(DC: HDC; const R: TRect;
    ...
    function GetTabAreaBackgroundColor(AApplicationMenuState
      : TdxRibbonApplicationMenuState): TColor; virtual;
...
begin
  ...
  else if not AUseAeroGlass then
    FillRectByColor(DC, R, GetTabAreaBackgroundColor(AApplicationMenuState));
end;

function TdxCustomRibbon2013Skin.GetTabAreaBackgroundColor(AApplicationMenuState
  : TdxRibbonApplicationMenuState): TColor;
begin
  Result := GetFormCaptionAreaColor(AApplicationMenuState);
end;

procedure TdxCustomRibbon2013Skin.InitializePaintData(const APaintData
  : IdxRibbonPaintData);
var
...
procedure TdxCustomRibbon2013Skin.DrawRibbonClientTopArea(DC: HDC;
  const R: TRect);
begin
  if LowColors then
...
procedure TdxCustomRibbon2013Skin.DrawApplicationMenuBackground(DC: HDC;
  const R: TRect; const AContentRect: TRect);
begin
  if LowColors then
  ...
  begin
    ...
    FillRectByColor(DC, cxRectSetTop(R, AContentRect.Bottom,
      R.Bottom - AContentRect.Bottom), $F0F0F0);
    FillRectByColor(DC, cxRectSetBottom(R, AContentRect.Top,
      AContentRect.Top - R.Top), GetMenuBackgroundColor);
    DrawFrame(DC, R, clNone, GetFormBorderColor(True));
  end;
end;

procedure TdxCustomRibbon2013Skin.DrawApplicationMenuButton(DC: HDC;
...
begin
  InternalDrawGlyph(DC, R, FPinButtonGlyphs[AChecked],
    GetPartColor(DXBAR_BACKSTAGEVIEW_GALLERYCONTROL_ITEMPINBUTTONGLYPH,
    AState), False);
end;

procedure TdxCustomRibbon2013Skin.DrawMenuExtraSeparator(DC: HDC;
...
procedure TdxCustomRibbon2013Skin.AdjustBackstageViewTabButtonFont
  (AFont: TFont);
begin
  // do nothing
end;
...
procedure TdxCustomRibbon2013Skin.DrawBackstageViewBackButton(DC: HDC;
  ...
  var
    ...
    ARect: TRect;
  begin
    AImage := TdxSmartImage.CreateSize
      (cxRect(0, 0, APart.Size.cx + 2 * SizeOfSmoothingZone,
      APart.Size.cy + 2 * SizeOfSmoothingZone), 0);
    try
      AImageCanvas := AImage.CreateCanvas;
      try
        APart.DrawEx(AImageCanvas.Handle, cxRectCenter(AImage.ClientRect,
          APart.Size));
      finally
        AImageCanvas.Free;
      end;
...
procedure TdxCustomRibbon2013Skin.DrawBackstageViewGalleryGroupHeader(DC: HDC;
const R: TRect);
begin
...
procedure TdxCustomRibbon2013Skin.DrawBackstageViewMenuBackground(DC: HDC;
const R: TRect);
begin
  if LowColors then
...
procedure TdxCustomRibbon2013Skin.DrawBackstageViewMenuHeader(DC: HDC;
const R: TRect);
begin
  if LowColors then
...
procedure TdxCustomRibbon2013Skin.DrawBackstageViewMenuSeparator(DC: HDC;
const R: TRect; AState: Integer);
begin
  if LowColors then
    ...
    FillRectByColor(DC, cxRectInflate(cxRectCenterVertically(R, 1), -15, 0),
      GetPartColor(DXBAR_BACKSTAGEVIEW_MENUBAR_SEPARATOR));
end;
...
procedure TdxCustomRibbon2013Skin.DrawButtonGroupBorderLeft(DC: HDC;
const R: TRect);
begin
  // do nothing
end;

procedure TdxCustomRibbon2013Skin.DrawButtonGroupBorderMiddle(DC: HDC;
const R: TRect; AState: Integer);
begin
  // do nothing
end;

procedure TdxCustomRibbon2013Skin.DrawButtonGroupBorderRight(DC: HDC;
const R: TRect);
begin
  // do nothing
end;
...
procedure TdxCustomRibbon2013Skin.DrawButtonGroupSplitButtonSeparator(DC: HDC;
const R: TRect; AState: Integer);
begin
  // do nothing
end;

procedure TdxCustomRibbon2013Skin.DrawCollapsedToolbarGlyphBackground(DC: HDC;
const R: TRect; AState: Integer);
begin
  if LowColors then
...
procedure TdxCustomRibbon2013Skin.DrawCollapsedToolbarBackground(DC: HDC;
const R: TRect; AState: Integer);
begin
  if LowColors then
...
procedure TdxCustomRibbon2013Skin.AdjustContextFont(AFont: TFont;
...
procedure TdxCustomRibbon2013Skin.DrawContextBackground(DC: HDC; const R: TRect;
...
procedure TdxCustomRibbon2013Skin.DrawContextBackgroundGlass(DC: HDC;
...
begin
  ...
  try
    DrawContextBackground(ABitmap.Canvas.Handle, ABitmap.ClientRect,
      AContextColor);
...
procedure TdxCustomRibbon2013Skin.DrawContextTabBackground(DC: HDC;
...
procedure TdxCustomRibbon2013Skin.DrawContextTabGroupsArea(DC: HDC;
...
procedure TdxCustomRibbon2013Skin.DrawContextTabSeparator(DC: HDC;
const R: TRect; ABeginGroup: Boolean);
begin
  // do nothing
end;

procedure TdxCustomRibbon2013Skin.DrawDropDownGalleryBackground(DC: HDC;
const R: TRect);
begin
  if LowColors then
...
procedure TdxCustomRibbon2013Skin.DrawDropDownGalleryBottomSizingBand(DC: HDC;
const R: TRect);
begin
  if LowColors then
...
procedure TdxCustomRibbon2013Skin.DrawDropDownGalleryTopSizingBand(DC: HDC;
const R: TRect);
begin
  if LowColors then
...
procedure TdxCustomRibbon2013Skin.DrawGalleryFilterBandBackground(DC: HDC;
const R: TRect);
begin
  if LowColors then
...
procedure TdxCustomRibbon2013Skin.DrawGalleryGroupHeaderBackground(DC: HDC;
const R: TRect);
begin
  if LowColors then
    inherited
...
procedure TdxCustomRibbon2013Skin.DrawEditButton(DC: HDC; const R: TRect;
AState: Integer);
begin
  if LowColors then
...
begin
  ...
  InternalDrawFormBorderIconGlyph(DC, R, AIcon, AState,
    GetFormBorderIconGlyphColor(AIcon, AState),
    AlignmentMap[AIcon <> rbdiAutoHideModeShowUI]);
end;

procedure TdxCustomRibbon2013Skin.DrawFormBorderIconBackground(DC: HDC;
...
begin
  ...
  begin
    ASaveIndex := SaveDC(DC);
    try
      cxExcludeClipRect(DC, cxRectContent(FormPaintData.GetBounds,
        ABordersWidth));
      FillRectByColor(DC, FormPaintData.GetBounds,
        GetFormBorderColor(FormPaintData.GetIsActive));
    finally
      RestoreDC(DC, ASaveIndex)
    end;
  end;
...
begin
  ...
  begin
    ...
    if UseExternalBorders then
      ...
      ABorders := BordersMap[FormPaintData.GetState = wsMinimized];
    DrawFrame(DC, R, GetFormCaptionAreaColor(PaintData.GetApplicationMenuState,
      AIsActive), GetFormBorderColor(AIsActive), ABorders);
  end;
end;

procedure TdxCustomRibbon2013Skin.DrawRibbonFormBackground(DC: HDC;
const R: TRect; ARibbonHeight: Integer);
var
...
begin
  ...
  begin
    ...
    FillGradientRect(DC, cxRectSetBottom(R, R.Bottom,
      cxRectHeight(R) - ARibbonHeight), AColor1, AColor2, False);
  end;
end;
  ...
  if LowColors then
    ...
    case AState of
      DXBAR_ACTIVE, DXBAR_ACTIVEDISABLED:
        DrawFrame(DC, R, $FEFEFE, GetHighlightContentColor,
          [bTop .. bBottom], 1, True);
    else
      DrawSmallButton(DC, R, AState);
    end;
...
procedure TdxCustomRibbon2013Skin.DrawLargeButton(DC: HDC; const R: TRect;
AState: Integer);
begin
  if LowColors then
...
begin
  if LowColors then
    ...
    case AState of
      DXBAR_ACTIVE, DXBAR_ACTIVEDISABLED:
        DrawFrame(DC, R, clNone, GetHighlightContentColor,
...
begin
  if LowColors then
    ...
    Parts[FLaunchButtonDefaultGlyphs[AState]].DrawColored(DC, R,
      GetLaunchButtonDefaultGlyphColor(AState), 255, UseRightToLeftAlignment);
end;
...
begin
  if LowColors then
    ...
    DrawFrame(DC, R, GetPartColor(DXBAR_EDIT_BACKGROUND),
      GetPartColor(DXBAR_EDIT_BORDER));
end;
...
procedure TdxCustomRibbon2013Skin.DrawMenuCheckMark(DC: HDC; const R: TRect;
AState: Integer);
begin
  if LowColors then
...
procedure TdxCustomRibbon2013Skin.DrawMenuSeparatorHorz(DC: HDC;
const R: TRect);
begin
  if LowColors then
    inherited DrawMenuSeparatorHorz(DC, R)
  else
    FillRectByColor(DC, cxRectCenterVertically(R, 1),
      GetPartColor(DXBAR_MENUSEPARATORHORZ));
end;

procedure TdxCustomRibbon2013Skin.DrawMenuSeparatorVert(DC: HDC;
const R: TRect);
begin
  DrawMenuContent(DC, R);
end;

procedure TdxCustomRibbon2013Skin.DrawQuickAccessToolbar(DC: HDC;
const R: TRect; ABellow, ANonClientDraw, AHasApplicationButton, AIsActive,
...
procedure TdxCustomRibbon2013Skin.DrawQuickAccessToolbarPopup(DC: HDC;
const R: TRect);
begin
  if LowColors then
...
begin
  if LowColors then
    ...
    DrawFrame(DC, R, GetGroupScrollButtonContentColor(AState),
      GetGroupScrollButtonBorderColor(AState));
end;

function TdxCustomRibbon2013Skin.GetGroupScrollButtonBorderColor
...
function TdxCustomRibbon2013Skin.GetGroupScrollButtonContentColor
  (AState: Integer): TColor;
begin
  case AState of
    DXBAR_HOT:
...
begin
  ...
  begin
    if APart in [sbpThumbnail, sbpLineUp, sbpLineDown] then
      DrawFrame(DC, R, GetScrollBarPartContentColor(APart, AState),
        GetScrollBarPartBorderColor(APart, AState));
    DrawScrollBarPartGlyph(DC, R, APart, AState, AHorizontal);
  end;
end;

procedure TdxCustomRibbon2013Skin.DrawScrollBarPartGlyph(DC: HDC;
  ...
  case APart of
    sbpLineUp:
      InternalDrawGlyph(DC, R, FScrollBarButtonLeftTopGlyph[AHorizontal],
        GetScrollBarGlyphColor, False);
    sbpLineDown:
      InternalDrawGlyph(DC, R, FScrollBarButtonRightBottomGlyph[AHorizontal],
        GetScrollBarGlyphColor, False);
  end;
end;

procedure TdxCustomRibbon2013Skin.DrawScrollBoxSizeGripArea(DC: HDC;
const R: TRect);
begin
...
function TdxCustomRibbon2013Skin.GetScrollBarPartBorderColor
...
function TdxCustomRibbon2013Skin.GetScrollBarPartContentColor
  (APart: TcxScrollBarPart; AState: Integer): TColor;
begin
  Result := clWhite;
end;

procedure TdxCustomRibbon2013Skin.DrawSeparatorBackground(DC: HDC;
const R: TRect);
begin
  if LowColors then
...
procedure TdxCustomRibbon2013Skin.DrawStatusBarGripBackground(DC: HDC;
const R: TRect);
begin
  DrawStatusBar(DC, R);
end;

procedure TdxCustomRibbon2013Skin.DrawStatusBarSizeGrip(DC: HDC;
const R: TRect);
begin
  // do nothing
end;

procedure TdxCustomRibbon2013Skin.DrawStatusBarPanelSeparator(DC: HDC;
const R: TRect);
begin
  // do nothing
end;

procedure TdxCustomRibbon2013Skin.DrawStatusBarToolbarSeparator(DC: HDC;
const R: TRect);
begin
  // do nothing
end;
...
procedure TdxCustomRibbon2013Skin.DrawTabGroupBackground(DC: HDC;
...
procedure TdxCustomRibbon2013Skin.DrawTabGroupHeaderBackground(DC: HDC;
const R: TRect; AState: Integer; AIsInPopup: Boolean);
var
  R1: TRect;
begin
...
procedure TdxCustomRibbon2013Skin.DrawTabGroupsArea(DC: HDC; const R: TRect;
...
begin
  if LowColors then
    ...
    InternalDrawGlyph(DC, R, FMinimizeRibbonButtonGlyph[AGlyph]
      [AState = cxbsDisabled], GetMinimizeRibbonButtonGlyphColor
      (StateMap[AState]), False);
end;

procedure TdxCustomRibbon2013Skin.DrawItemSeparator(DC: HDC; const R: TRect;
AHorizontal: Boolean);
begin
  if LowColors then
...
function TdxCustomRibbon2013Skin.AreBordersThin: Boolean;
begin
  Result := True;
end;
...
function TdxCustomRibbon2013Skin.GetWindowBordersWidth(AHasStatusBar
  : Boolean): TRect;
begin
  Result := Rect(1, 0, 1, 1);
end;
...
function TdxCustomRibbon2013Skin.CreateBackstageViewMenuPalette
  : IdxRibbonSkinColorPaletteSet;
begin
  Result := TdxRibbonSkinColorPaletteSet.Create;
  Result.Add(DXBAR_NORMAL, TdxRibbonSkinColorPalette.Create($FFFFFF, $FFFFFF,
    GetMenuBackgroundColor, $FFFFFF, $FFFFFF, $FFFFFF));
  Result.Add(DXBAR_DISABLED, TdxRibbonSkinColorPalette.Create($F0F0F0, $F0F0F0,
    GetMenuBackgroundColor, $F0F0F0, $F0F0F0, $F0F0F0));
end;

function TdxCustomRibbon2013Skin.CreateMajorColorPalette
  : IdxRibbonSkinColorPaletteSet;
begin
  Result := TdxRibbonSkinColorPaletteSet.Create;
  Result.Add(DXBAR_NORMAL, TdxRibbonSkinColorPalette.Create($4463D8, $97A776,
    $FFFFFF, $727272, $82C2EA, $B8824D));
  Result.Add(DXBAR_DISABLED, TdxRibbonSkinColorPalette.Create($BDBDBD, $BDBDBD,
    $FFFFFF, $BDBDBD, $BDBDBD, $BDBDBD));
end;
...
function TdxCustomRibbon2013Skin.DoGetPartColor(APart: Integer;
...
const R: TRect; AID: Integer; AStateCount: Integer;
AInterpolationMode: Integer = InterpolationModeNearestNeighbor);
var
  I: Integer;
begin
  for I := 0 to AStateCount - 1 do
    TStatesArray(AParts)[I] := AddPart3x3(ABitmap, R, cxNullRect, AID + I, '',
      AInterpolationMode);
end;
...
procedure TdxCustomRibbon2013Skin.LoadRibbonFormBorderIcons(ABitmap: Pointer);
  ...
  begin
    ...
    LoadGlyphs(ABitmap, FMDIButtonGlyphs[mdibMinimize],
      cxRectBounds(X, Y, W, H), rspMDIButtonMinimize, 4);
    LoadGlyphs(ABitmap, FMDIButtonGlyphs[mdibRestore],
      cxRectBounds(X + 2 * (W + 1), Y, W, H), rspMDIButtonRestore, 4);
    LoadGlyphs(ABitmap, FMDIButtonGlyphs[mdibClose],
      cxRectBounds(X + 3 * (W + 1), Y, W, H), rspMDIButtonClose, 4);
  end;
...
procedure TdxCustomRibbon2013Skin.LoadRibbonFormBorderIconsGlyphs
...
begin
  ...
  begin
    LoadGlyphs(ABitmap, FBorderIconGlyph[I], cxRectBounds(X, Y, AWidth,
      AHeight), ID, 4, InterpolationModeNearestNeighbor);
    Inc(X, AWidth + 1);
    Inc(ID, 4);
  end;
end;
...
const
  ColorMap: array [TdxRibbonColorSchemeAccent] of TColor = ($3EA5EA, $9A572B,
    $457220, $2647D2, $7B3880);
begin
  Result := ColorMap[ColorSchemeAccent];
end;

procedure TdxCustomRibbon2013Skin.DrawColorfulButton(DC: HDC; const R: TRect;
AState: Integer);
begin
  FillRectByColor(DC, R, GetColorfulButtonColor(AState));
end;

function TdxCustomRibbon2013Skin.GetColorfulButtonColor
  (AState: Integer): TColor;
begin
  Result := clNone;
end;

function TdxCustomRibbon2013Skin.GetAccentColor(const ALightnessDelta
  : Double): TColor;
begin
  Result := TdxColorHelper.ChangeLightness(GetAccentColor, ALightnessDelta);
end;

function TdxCustomRibbon2013Skin.GetBackstageViewBackButtonGlyphColor
  (AState: Integer): TColor;
begin
  case AState of
    DXBAR_HOT:
...
function TdxCustomRibbon2013Skin.GetFormCaptionAreaColor(AApplicationMenuState
...
const
  ColorMap: array [TdxRibbonColorSchemeAccent] of TColor = ($9CD0F4, $E2BCA2,
    $A0BF86, $9CB9F4, $DEBFE0);
begin
  Result := ColorMap[ColorSchemeAccent];
end;
...
const
  ColorMap: array [TdxRibbonColorSchemeAccent] of TColor = ($C8E3FD, $F2E1D5,
    $E0F0D3, $DDE5FD, $EEDAF0);
begin
  Result := ColorMap[ColorSchemeAccent];
end;

function TdxCustomRibbon2013Skin.GetLaunchButtonDefaultGlyphColor
  (AState: Integer): TColor;
begin
...
function TdxCustomRibbon2013Skin.GetMenuBackgroundColor(const ALightnessDelta
  : Double): TColor;
begin
  Result := TdxColorHelper.ChangeLightness(GetMenuBackgroundColor,
    ALightnessDelta);
end;

function TdxCustomRibbon2013Skin.GetMinimizeRibbonButtonGlyphColor
  (AState: Integer): TColor;
begin
  Result := GetGlyphColor(AState);
end;
...
function TdxLightGrayRibbon2013Skin.GetScrollBarPartContentColor
  (APart: TcxScrollBarPart; AState: Integer): TColor;
begin
...
function TdxDarkGrayRibbon2013Skin.GetScrollBarPartContentColor
  (APart: TcxScrollBarPart; AState: Integer): TColor;
begin
  if AState <> DXBAR_PRESSED then
    Result := clWhite
  else if APart = sbpThumbnail then
    Result := $E1E1E1
  else
    Result := $F0F0F0;
end;
...
function TdxWhiteRibbon2013Skin.DoGetPartColor(APart: Integer;
AState: Integer = 0): TColor;
begin
...
function TdxWhiteRibbon2013Skin.GetScrollBarPartBorderColor
  (APart: TcxScrollBarPart; AState: Integer): TColor;
begin
...
function TdxWhiteRibbon2013Skin.GetScrollBarPartContentColor
  (APart: TcxScrollBarPart; AState: Integer): TColor;
begin
  Result := clWhite;
  case AState of
