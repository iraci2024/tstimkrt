...
uses
  ...
  StdCtrls, dxPSForm, Menus, cxClasses,
  dxCore, cxLookAndFeelPainters, cxButtons, cxControls, cxContainer, cxEdit,
  cxTextEdit, cxLabel, cxGroupBox,
...
begin
  ...
  begin
    ...
    if not Result then
      MessageWarning(Format(cxGetResourceString(@sdxFileAlreadyExists),
        [FileName]));
  end;
end;
