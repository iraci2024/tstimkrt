...
type
  ...
  TdxFloatingObjectRelativeFromHorizontal = (Margin, Page, LeftMargin,
    RightMargin, InsideMargin, OutsideMargin);

  TdxFloatingObjectRelativeFromVertical = (Margin, Page, TopMargin,
    BottomMargin, InsideMargin, OutsideMargin);

  TdxFloatingObjectTextWrapType = (None, TopAndBottom, Tight, Through,
    Square, &Inline);

  TdxFloatingObjectTextWrapSide = (Both, Left, Right, Largest);
  ...
  IdxFloatingObjectPropertiesContainer = interface // for internal use
    ...
    function CreateFloatingObjectPropertiesChangedHistoryItem
  ...
  public
    constructor Create(AFrom: TdxFloatingObjectRelativeFromHorizontal;
      AWidth: Integer);
    ...
    class operator NotEqual(const A, B: TdxFloatingObjectRelativeWidth)
      : Boolean;
  ...
  public
    constructor Create(AFrom: TdxFloatingObjectRelativeFromVertical;
      AHeight: Integer);
    ...
    class operator NotEqual(const A,
      B: TdxFloatingObjectRelativeHeight): Boolean;
  ...
  IdxFloatingObjectLocation = interface // for internal use
    ...
    property HorizontalPositionAlignment
      : TdxFloatingObjectHorizontalPositionAlignment
      read GetHorizontalPositionAlignment;
    property VerticalPositionAlignment
      : TdxFloatingObjectVerticalPositionAlignment
      read GetVerticalPositionAlignment;
    property HorizontalPositionType: TdxFloatingObjectHorizontalPositionType
      read GetHorizontalPositionType;
    property VerticalPositionType: TdxFloatingObjectVerticalPositionType
      read GetVerticalPositionType;
    ...
    property RelativeWidth: TdxFloatingObjectRelativeWidth
      read GetRelativeWidth;
    property RelativeHeight: TdxFloatingObjectRelativeHeight
      read GetRelativeHeight;
  end;
  ...
  public
    ...
    property LayoutInTableCell: Boolean read FLayoutInTableCell
      write FLayoutInTableCell;
    property Locked: Boolean read FLocked write FLocked;
    property LockAspectRatio: Boolean read FLockAspectRatio
      write FLockAspectRatio;
    ...
    property TextWrapType: TdxFloatingObjectTextWrapType read FTextWrapType
      write FTextWrapType;
    property TextWrapSide: TdxFloatingObjectTextWrapSide read FTextWrapSide
      write FTextWrapSide;
    property HorizontalPositionType: TdxFloatingObjectHorizontalPositionType
      read FHorizontalPositionType write FHorizontalPositionType;
    property HorizontalPositionAlignment
      : TdxFloatingObjectHorizontalPositionAlignment
      read FHorizontalPositionAlignment write FHorizontalPositionAlignment;
    property VerticalPositionType: TdxFloatingObjectVerticalPositionType
      read FVerticalPositionType write FVerticalPositionType;
    property VerticalPositionAlignment
      : TdxFloatingObjectVerticalPositionAlignment
      read FVerticalPositionAlignment write FVerticalPositionAlignment;
    property Offset: TPoint read FOffset write FOffset;
    property PercentOffset: TPoint read FPercentOffset write FPercentOffset;
    property RelativeWidth: TdxFloatingObjectRelativeWidth read FRelativeWidth
      write FRelativeWidth;
    property RelativeHeight: TdxFloatingObjectRelativeHeight
      read FRelativeHeight write FRelativeHeight;
  ...
  TdxUseFloatingObjectOption = (UseAllowOverlap, UseHidden,
    UseLayoutInTableCell, UseLocked, UseLeftDistance, UseRightDistance,
    UseTopDistance, UseBottomDistance, UseZOrder, UseActualSize,
    UseTextWrapType, UseTextWrapSide, UseHorizontalPositionType,
    UseHorizontalPositionAlignment, UseVerticalPositionType,
    UseVerticalPositionAlignment, UseOffset, UseLockAspectRatio, UseIsBehindDoc,
    UsePseudoInline, UseRelativeWidth, UseRelativeHeight, UsePercentOffset);
  ...
  private const
    MaskUseNone = [];
    MaskUseAll = [Low(TdxUseFloatingObjectOption)
      .. High(TdxUseFloatingObjectOption)];
  private
    ...
    class function GetEmptyFloatingObjectOption
      : TdxFloatingObjectOptions; static;
  ...
  public
    ...
    class property EmptyFloatingObjectOption: TdxFloatingObjectOptions
      read GetEmptyFloatingObjectOption;

    property UseAllowOverlap: Boolean
      index TdxUseFloatingObjectOption.UseAllowOverlap read GetVal write SetVal;
    property UseHidden: Boolean index TdxUseFloatingObjectOption.UseHidden
      read GetVal write SetVal;
    property UseLayoutInTableCell: Boolean
      index TdxUseFloatingObjectOption.UseLayoutInTableCell read GetVal
      write SetVal;
    property UseLocked: Boolean index TdxUseFloatingObjectOption.UseLocked
      read GetVal write SetVal;
    property UseLockAspectRatio: Boolean
      index TdxUseFloatingObjectOption.UseLockAspectRatio read GetVal
      write SetVal;
    property UseLeftDistance: Boolean
      index TdxUseFloatingObjectOption.UseLeftDistance read GetVal write SetVal;
    property UseRightDistance: Boolean
      index TdxUseFloatingObjectOption.UseRightDistance read GetVal
      write SetVal;
    property UseTopDistance: Boolean
      index TdxUseFloatingObjectOption.UseTopDistance read GetVal write SetVal;
    property UseBottomDistance: Boolean
      index TdxUseFloatingObjectOption.UseBottomDistance read GetVal
      write SetVal;
    property UseZOrder: Boolean index TdxUseFloatingObjectOption.UseZOrder
      read GetVal write SetVal;
    property UseActualSize: Boolean
      index TdxUseFloatingObjectOption.UseActualSize read GetVal write SetVal;
    property UseTextWrapType: Boolean
      index TdxUseFloatingObjectOption.UseTextWrapType read GetVal write SetVal;
    property UseTextWrapSide: Boolean
      index TdxUseFloatingObjectOption.UseTextWrapSide read GetVal write SetVal;
    property UseHorizontalPositionType: Boolean
      index TdxUseFloatingObjectOption.UseHorizontalPositionType read GetVal
      write SetVal;
    property UseHorizontalPositionAlignment: Boolean
      index TdxUseFloatingObjectOption.UseHorizontalPositionAlignment
      read GetVal write SetVal;
    property UseVerticalPositionType: Boolean
      index TdxUseFloatingObjectOption.UseVerticalPositionType read GetVal
      write SetVal;
    property UseVerticalPositionAlignment: Boolean
      index TdxUseFloatingObjectOption.UseVerticalPositionAlignment read GetVal
      write SetVal;
    property UseOffset: Boolean index TdxUseFloatingObjectOption.UseOffset
      read GetVal write SetVal;
    property UseIsBehindDoc: Boolean
      index TdxUseFloatingObjectOption.UseIsBehindDoc read GetVal write SetVal;
    property UsePseudoInline: Boolean
      index TdxUseFloatingObjectOption.UsePseudoInline read GetVal write SetVal;
    property UseRelativeWidth: Boolean
      index TdxUseFloatingObjectOption.UseRelativeWidth read GetVal
      write SetVal;
    property UseRelativeHeight: Boolean
      index TdxUseFloatingObjectOption.UseRelativeHeight read GetVal
      write SetVal;
    property UsePercentOffset: Boolean
      index TdxUseFloatingObjectOption.UsePercentOffset read GetVal
      write SetVal;
  end;

  { TdxFloatingObjectFormatting }

  TdxFloatingObjectFormatting = class
    (TdxIndexBasedObjectB<TdxFloatingObjectInfo, TdxFloatingObjectOptions>)
  private
    procedure SetAllowOverlapCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: Boolean);
    procedure SetHiddenCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: Boolean);
    procedure SetLayoutInTableCellCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: Boolean);
    procedure SetLockedCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: Boolean);
    procedure SetLockAspectRatioCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: Boolean);
    procedure SetLeftDistanceCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: Integer);
    procedure SetRightDistanceCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: Integer);
    procedure SetTopDistanceCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: Integer);
    procedure SetBottomDistanceCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: Integer);
    procedure SetZOrderCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: Integer);
    procedure SetActualSizeCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: TSize);
    procedure SetRelativeWidthCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: TdxFloatingObjectRelativeWidth);
    procedure SetRelativeHeightCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: TdxFloatingObjectRelativeHeight);
    procedure SetTextWrapSideCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: Integer);
    procedure SetTextWrapTypeCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: Integer);
    procedure SetHorizontalPositionTypeCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: Integer);
    procedure SetHorizontalPositionAlignmentCore(const AInfo
      : TdxFloatingObjectInfo; const AValue: Integer);
    procedure SetVerticalPositionTypeCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: Integer);
    procedure SetVerticalPositionAlignmentCore(const AInfo
      : TdxFloatingObjectInfo; const AValue: Integer);
    procedure SetOffsetCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: TPoint);
    procedure SetPercentOffsetCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: TPoint);
    procedure SetIsBehindDocCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: Boolean);
    procedure SetPseudoInlineCore(const AInfo: TdxFloatingObjectInfo;
      const AValue: Boolean);
    ...
    procedure SetHorizontalPositionAlignment(const Value
      : TdxFloatingObjectHorizontalPositionAlignment);
    procedure SetHorizontalPositionType(const Value
      : TdxFloatingObjectHorizontalPositionType);
    ...
    procedure SetVerticalPositionAlignment(const Value
      : TdxFloatingObjectVerticalPositionAlignment);
    procedure SetVerticalPositionType(const Value
      : TdxFloatingObjectVerticalPositionType);
    procedure SetZOrder(const Value: Integer);
  protected
    function CanSetPropertyValue: Boolean; override;
    function PropertyEquals(const AOther
      : TdxIndexBasedObject<TdxFloatingObjectInfo, TdxFloatingObjectOptions>)
      : Boolean; override;
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      const ADocumentModel: TdxCustomDocumentModel;
      const AFormattingInfo: TdxFloatingObjectInfo;
      const AFormattingOptions: TdxFloatingObjectOptions); reintroduce;
      overload;

    function Clone: TdxCloneable; override;
    procedure CopyFrom(Source: TdxCloneable); overload; override;
    procedure CopyFrom(const AInfo: TdxFloatingObjectInfo;
      const AOptions: TdxFloatingObjectOptions); reintroduce; overload;

    property AllowOverlap: Boolean read GetAllowOverlap write SetAllowOverlap;
    property Hidden: Boolean read GetHidden write SetHidden;
    property LayoutInTableCell: Boolean read GetLayoutInTableCell
      write SetLayoutInTableCell;
    ...
    property RelativeWidth: TdxFloatingObjectRelativeWidth read GetRelativeWidth
      write SetRelativeWidth;
    property RelativeHeight: TdxFloatingObjectRelativeHeight
      read GetRelativeHeight write SetRelativeHeight;
    property TextWrapType: TdxFloatingObjectTextWrapType read GetTextWrapType
      write SetTextWrapType;
    property TextWrapSide: TdxFloatingObjectTextWrapSide read GetTextWrapSide
      write SetTextWrapSide;
    property HorizontalPositionType: TdxFloatingObjectHorizontalPositionType
      read GetHorizontalPositionType write SetHorizontalPositionType;
    property HorizontalPositionAlignment
      : TdxFloatingObjectHorizontalPositionAlignment
      read GetHorizontalPositionAlignment write SetHorizontalPositionAlignment;
    property VerticalPositionType: TdxFloatingObjectVerticalPositionType
      read GetVerticalPositionType write SetVerticalPositionType;
    property VerticalPositionAlignment
      : TdxFloatingObjectVerticalPositionAlignment
      read GetVerticalPositionAlignment write SetVerticalPositionAlignment;
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxFloatingObjectInfo; override;
  end;

  TdxFloatingObjectChangeType = (None = 0, AllowOverlap, Hidden,
    LayoutInTableCell, Locked, LockAspectRatio, LeftDistance, RightDistance,
    TopDistance, BottomDistance, ZOrder, ActualSize, TextWrapType, TextWrapSide,
    HorizontalPositionType, HorizontalPositionAlignment, VerticalPositionType,
    VerticalPositionAlignment, Offset, PercentOffset, BatchUpdate, IsBehindDoc,
    PseudoInline, RelativeWidth, RelativeHeight);

  { TdxFloatingObjectChangeActionsCalculator }

  TdxFloatingObjectChangeActionsCalculator = class // for internal use
  public
    class function CalculateChangeActions(AChange: TdxFloatingObjectChangeType)
      : TdxDocumentModelChangeActions; static;
  end;

  { TdxFloatingObjectProperties }

  TdxFloatingObjectProperties = class
    (TdxRichEditIndexBasedObject<TdxFloatingObjectFormatting>,
  ...
  strict protected
    ...
    function SetAllowOverlapCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: Boolean): TdxDocumentModelChangeActions; virtual;
    function SetHiddenCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: Boolean): TdxDocumentModelChangeActions; virtual;
    function SetLayoutInTableCellCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: Boolean): TdxDocumentModelChangeActions; virtual;
    function SetLockedCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: Boolean): TdxDocumentModelChangeActions; virtual;
    function SetLockAspectRatioCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: Boolean): TdxDocumentModelChangeActions; virtual;
    function SetLeftDistanceCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetRightDistanceCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetTopDistanceCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetBottomDistanceCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetZOrderCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetActualSizeCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: TSize): TdxDocumentModelChangeActions; virtual;
    function SetRelativeWidthCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: TdxFloatingObjectRelativeWidth)
      : TdxDocumentModelChangeActions; virtual;
    function SetRelativeHeightCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: TdxFloatingObjectRelativeHeight)
      : TdxDocumentModelChangeActions; virtual;
    function SetTextWrapTypeCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetTextWrapSideCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetHorizontalPositionTypeCore(const AInfo
      : TdxFloatingObjectFormatting; const AValue: Integer)
      : TdxDocumentModelChangeActions; virtual;
    function SetHorizontalPositionAlignmentCore(const AInfo
      : TdxFloatingObjectFormatting; const AValue: Integer)
      : TdxDocumentModelChangeActions; virtual;
    function SetVerticalPositionTypeCore(const AInfo
      : TdxFloatingObjectFormatting; const AValue: Integer)
      : TdxDocumentModelChangeActions; virtual;
    function SetVerticalPositionAlignmentCore(const AInfo
      : TdxFloatingObjectFormatting; const AValue: Integer)
      : TdxDocumentModelChangeActions; virtual;
    function SetOffsetCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: TPoint): TdxDocumentModelChangeActions; virtual;
    function SetPercentOffsetCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: TPoint): TdxDocumentModelChangeActions; virtual;
    function SetIsBehindDocCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: Boolean): TdxDocumentModelChangeActions; virtual;
    function SetPseudoInlineCore(const AInfo: TdxFloatingObjectFormatting;
      const AValue: Boolean): TdxDocumentModelChangeActions; virtual;
    ...
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxFloatingObjectFormatting>; override;
  ...
  public
    constructor Create(const AOwner: IdxFloatingObjectPropertiesContainer);
      reintroduce;
    procedure ChangeIndexCore(ANewIndex: Integer;
      const AChangeActions: TdxDocumentModelChangeActions); override;
    procedure Reset;
    ...
    property PercentOffset: TPoint read GetPercentOffset write SetPercentOffset;
    property PercentOffsetX: Integer read GetPercentOffsetX
      write SetPercentOffsetX;
    property PercentOffsetY: Integer read GetPercentOffsetY
      write SetPercentOffsetY;
    ...
    property UseHorizontalPositionAlignment: Boolean
      read GetUseHorizontalPositionAlignment;
    property UseHorizontalPositionType: Boolean
      read GetUseHorizontalPositionType;
    ...
    property UseVerticalPositionAlignment: Boolean
      read GetUseVerticalPositionAlignment;
  ...
  TdxFloatingObjectFormattingCache = class
    (TdxUniqueItemsCache<TdxFloatingObjectFormatting>) // for internal use
  public const
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxFloatingObjectFormatting; override;
  public
    constructor Create(ADocumentModel: TdxCustomDocumentModel); reintroduce;
    destructor Destroy; override;

    property DefaultFloatingObjectInfo: TdxFloatingObjectInfo
      read FDefaultFloatingObjectInfo;
  end;
  ...
  public
    procedure BringToFront(const AObjects: TdxIZOrderedObjectList;
      AObjectIndex: Integer); virtual;
    procedure BringForward(const AObjects: TdxIZOrderedObjectList;
      AObjectIndex: Integer); virtual;
    procedure Swap(const AObjects: TdxIZOrderedObjectList;
      AObjectIndex: Integer; ASecondIndex: Integer);
    procedure IncrementZOrders(const AFloatingObjectList
      : TdxIZOrderedObjectList; AFrom: Integer; ATo: Integer);
    procedure SendBackward(const AObjects: TdxIZOrderedObjectList;
      AObjectIndex: Integer); virtual;
    procedure SendToBack(const AObjects: TdxIZOrderedObjectList;
      AObjectIndex: Integer); virtual;
  ...
  public
    ...
    property ResizeShapeToFitText: Boolean read FResizeShapeToFitText
      write FResizeShapeToFitText;
  ...
  TdxUseTextBoxOption = (UseLeftMargin, UseRightMargin, UseTopMargin,
    UseBottomMargin, UseResizeShapeToFitText, UseWrapText, UseVerticalAlignment,
    UseUpright);
  ...
  public
    ...
    class property EmptyTextBoxOption: TdxTextBoxOptions
      read GetEmptyTextBoxOption;
    property Value: TdxUseTextBoxOptions read FVal write FVal;

    property UseLeftMargin: Boolean index TdxUseTextBoxOption.UseLeftMargin
      read GetVal write SetVal;
    property UseRightMargin: Boolean index TdxUseTextBoxOption.UseRightMargin
      read GetVal write SetVal;
    property UseTopMargin: Boolean index TdxUseTextBoxOption.UseTopMargin
      read GetVal write SetVal;
    property UseBottomMargin: Boolean index TdxUseTextBoxOption.UseBottomMargin
      read GetVal write SetVal;
    property UseResizeShapeToFitText: Boolean
      index TdxUseTextBoxOption.UseResizeShapeToFitText read GetVal
      write SetVal;
    property UseWrapText: Boolean index TdxUseTextBoxOption.UseWrapText
      read GetVal write SetVal;
    property UseVerticalAlignment: Boolean
      index TdxUseTextBoxOption.UseVerticalAlignment read GetVal write SetVal;
    property UseUpright: Boolean index TdxUseTextBoxOption.UseUpright
      read GetVal write SetVal;
  end;

  { TdxTextBoxFormatting }

  TdxTextBoxFormatting = class(TdxIndexBasedObjectB<TdxTextBoxInfo,
    TdxTextBoxOptions>) // for internal use
  strict private
    procedure SetLeftMarginCore(const AInfo: TdxTextBoxInfo;
      const AValue: Integer);
    procedure SetRightMarginCore(const AInfo: TdxTextBoxInfo;
      const AValue: Integer);
    procedure SetTopMarginCore(const AInfo: TdxTextBoxInfo;
      const AValue: Integer);
    procedure SetBottomMarginCore(const AInfo: TdxTextBoxInfo;
      const AValue: Integer);
    procedure SetResizeShapeToFitTextCore(const AInfo: TdxTextBoxInfo;
      const AValue: Boolean);
    procedure SetWrapTextCore(const AInfo: TdxTextBoxInfo;
      const AValue: Boolean);
    procedure SetVerticalAlignmentCore(const AInfo: TdxTextBoxInfo;
      const AValue: Integer);
    procedure SetUprightCore(const AInfo: TdxTextBoxInfo;
      const AValue: Boolean);
  ...
  protected
    function CanSetPropertyValue: Boolean; override;
    function PropertyEquals(const AOther: TdxIndexBasedObject<TdxTextBoxInfo,
      TdxTextBoxOptions>): Boolean; override;
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      const ADocumentModel: TdxCustomDocumentModel;
      const AFormattingInfo: TdxTextBoxInfo;
      const AFormattingOptions: TdxTextBoxOptions); reintroduce;

    function Clone: TdxCloneable; override;
    procedure CopyFrom(Source: TdxCloneable); overload; override;
    procedure CopyFrom(const AInfo: TdxTextBoxInfo;
      const AOptions: TdxTextBoxOptions); reintroduce; overload;
    ...
    property ResizeShapeToFitText: Boolean read GetResizeShapeToFitText
      write SetResizeShapeToFitText;
  ...
  TdxTextBoxProperties = class
    (TdxRichEditIndexBasedObject<TdxTextBoxFormatting>) // for internal use
  strict private
    FOwner: IdxTextBoxPropertiesContainer;
    class function GetPieceTable(const AOwner: IdxTextBoxPropertiesContainer)
      : TdxCustomPieceTable; static;
    function GetLeftMargin: Integer;
  ...
  strict protected
    function SetLeftMarginCore(const AInfo: TdxTextBoxFormatting;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetRightMarginCore(const AInfo: TdxTextBoxFormatting;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetTopMarginCore(const AInfo: TdxTextBoxFormatting;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetBottomMarginCore(const AInfo: TdxTextBoxFormatting;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetResizeShapeToFitTextCore(const AInfo: TdxTextBoxFormatting;
      const AValue: Boolean): TdxDocumentModelChangeActions; virtual;
    function SetWrapTextCore(const AInfo: TdxTextBoxFormatting;
      const AValue: Boolean): TdxDocumentModelChangeActions; virtual;
    function SetVerticalAlignmentCore(const AInfo: TdxTextBoxFormatting;
      const AValue: TdxVerticalAlignment)
      : TdxDocumentModelChangeActions; virtual;
    function SetUprightCore(const AInfo: TdxTextBoxFormatting;
      const AValue: Boolean): TdxDocumentModelChangeActions; virtual;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxTextBoxFormatting>; override;
    ...
    function CreateIndexChangedHistoryItem
      : TdxIndexChangedHistoryItemCore; override;
  public
    constructor Create(const AOwner: IdxTextBoxPropertiesContainer);
      reintroduce;
    procedure Reset;
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxTextBoxFormatting; override;
    function CreateDefaultInfoItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxTextBoxInfo;
  public
    constructor Create(ADocumentModel: TdxCustomDocumentModel); reintroduce;
    destructor Destroy; override;
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxTextBoxInfo; override;
    class function CreateDefaultItemCore(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxTextBoxInfo; static;
  end;
...
type
  ...
  public
    class function CalculateChangeActions
      (AChange: TdxTextBoxPropertiesChangeType)
      : TdxDocumentModelChangeActions; static;
  end;

  { TdxTextBoxPropertiesChangeActionsCalculator }

class function TdxTextBoxPropertiesChangeActionsCalculator.
  CalculateChangeActions(AChange: TdxTextBoxPropertiesChangeType)
  : TdxDocumentModelChangeActions;
const
  TextBoxPropertiesChangeActionsMap: array [TdxTextBoxPropertiesChangeType]
...
constructor TdxFloatingObjectRelativeWidth.Create
  (AFrom: TdxFloatingObjectRelativeFromHorizontal; AWidth: Integer);
begin
  FWidth := AWidth;
  FFrom := AFrom;
end;

class function TdxFloatingObjectRelativeWidth.CreateEmpty
  : TdxFloatingObjectRelativeWidth;
begin
...
class operator TdxFloatingObjectRelativeWidth.Equal(const A,
  B: TdxFloatingObjectRelativeWidth): Boolean;
begin
  Result := (A.Width = B.Width) and (A.From = B.From);
end;

class operator TdxFloatingObjectRelativeWidth.NotEqual(const A,
  B: TdxFloatingObjectRelativeWidth): Boolean;
begin
  Result := not(A = B);
end;
...
constructor TdxFloatingObjectRelativeHeight.Create
  (AFrom: TdxFloatingObjectRelativeFromVertical; AHeight: Integer);
begin
  FHeight := AHeight;
  FFrom := AFrom;
end;

class function TdxFloatingObjectRelativeHeight.CreateEmpty
  : TdxFloatingObjectRelativeHeight;
begin
...
class operator TdxFloatingObjectRelativeHeight.Equal(const A,
  B: TdxFloatingObjectRelativeHeight): Boolean;
begin
  Result := (A.Height = B.Height) and (A.From = B.From);
end;

class operator TdxFloatingObjectRelativeHeight.NotEqual(const A,
  B: TdxFloatingObjectRelativeHeight): Boolean;
begin
  Result := not(A = B);
end;
...
begin
  ...
  HorizontalPositionAlignment :=
    AFloatingObjectInfo.HorizontalPositionAlignment;
...
begin
  Result := Offset.IsEqual(AInfo.Offset) and
    ActualSize.IsEqual(AInfo.ActualSize) and (AllowOverlap = AInfo.AllowOverlap)
    and (Hidden = AInfo.Hidden) and
    (LayoutInTableCell = AInfo.LayoutInTableCell) and (Locked = AInfo.Locked)
    and (LockAspectRatio = AInfo.LockAspectRatio) and
    (LeftDistance = AInfo.LeftDistance) and
    (RightDistance = AInfo.RightDistance) and (TopDistance = AInfo.TopDistance)
    and (BottomDistance = AInfo.BottomDistance) and (ZOrder = AInfo.ZOrder) and
    (TextWrapType = AInfo.TextWrapType) and (TextWrapSide = AInfo.TextWrapSide)
    and (HorizontalPositionType = AInfo.HorizontalPositionType) and
    ...
    (IsBehindDoc = AInfo.IsBehindDoc) and (PseudoInline = AInfo.PseudoInline)
    and (RelativeWidth = AInfo.RelativeWidth) and
...
constructor TdxFloatingObjectOptions.Create(const AVal
  : TdxUseFloatingObjectOptions);
begin
  FVal := AVal;
end;

class operator TdxFloatingObjectOptions.Equal(const A,
  B: TdxFloatingObjectOptions): Boolean;
begin
  Result := A.FVal = B.FVal;
end;

procedure TdxFloatingObjectOptions.CopyFrom(const Source
  : TdxFloatingObjectOptions);
begin
  FVal := Source.Value;
end;

class function TdxFloatingObjectOptions.GetEmptyFloatingObjectOption
  : TdxFloatingObjectOptions;
begin
...
function TdxFloatingObjectOptions.GetVal
  (AMask: TdxUseFloatingObjectOption): Boolean;
begin
...
procedure TdxFloatingObjectOptions.SetVal(AMask: TdxUseFloatingObjectOption;
  AValue: Boolean);
begin
  if AValue then
    Include(FVal, AMask)
...
constructor TdxFloatingObjectFormatting.Create(APieceTable: TdxCustomPieceTable;
  const ADocumentModel: TdxCustomDocumentModel;
  const AFormattingInfo: TdxFloatingObjectInfo;
  const AFormattingOptions: TdxFloatingObjectOptions);
begin
  inherited Create(APieceTable, ADocumentModel, AFormattingInfo,
    AFormattingOptions);
end;
...
begin
  if Self = nil then
    Exit(nil);
  Result := TdxFloatingObjectFormatting.Create(PieceTable, DocumentModel,
    Info, Options);
end;
...
function TdxFloatingObjectFormatting.GetHorizontalPositionAlignment
  : TdxFloatingObjectHorizontalPositionAlignment;
begin
  Result := Info.HorizontalPositionAlignment;
end;

function TdxFloatingObjectFormatting.GetHorizontalPositionType
  : TdxFloatingObjectHorizontalPositionType;
begin
...
function TdxFloatingObjectFormatting.GetRelativeHeight
  : TdxFloatingObjectRelativeHeight;
begin
  Result := Info.RelativeHeight;
end;

function TdxFloatingObjectFormatting.GetRelativeWidth
  : TdxFloatingObjectRelativeWidth;
begin
...
function TdxFloatingObjectFormatting.GetTextWrapSide
  : TdxFloatingObjectTextWrapSide;
begin
  Result := Info.TextWrapSide;
end;

function TdxFloatingObjectFormatting.GetTextWrapType
...
function TdxFloatingObjectFormatting.GetVerticalPositionAlignment
  : TdxFloatingObjectVerticalPositionAlignment;
begin
  Result := Info.VerticalPositionAlignment;
end;

function TdxFloatingObjectFormatting.GetVerticalPositionType
  : TdxFloatingObjectVerticalPositionType;
begin
...
procedure TdxFloatingObjectFormatting.SetActualSizeCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: TSize);
begin
...
procedure TdxFloatingObjectFormatting.SetAllowOverlapCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Boolean);
begin
...
procedure TdxFloatingObjectFormatting.SetBottomDistanceCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Integer);
begin
...
procedure TdxFloatingObjectFormatting.SetHiddenCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Boolean);
begin
  AInfo.Hidden := AValue;
end;
...
begin
  if (Info.HorizontalPositionAlignment = Value) and Options.UseHorizontalPositionAlignment
  then
    Exit;
...
procedure TdxFloatingObjectFormatting.SetHorizontalPositionAlignmentCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Integer);
begin
  AInfo.HorizontalPositionAlignment :=
    TdxFloatingObjectHorizontalPositionAlignment(AValue);
end;

procedure TdxFloatingObjectFormatting.SetHorizontalPositionType
  (const Value: TdxFloatingObjectHorizontalPositionType);
begin
  if (Info.HorizontalPositionType = Value) and Options.UseHorizontalPositionType
  then
    Exit;
...
procedure TdxFloatingObjectFormatting.SetHorizontalPositionTypeCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Integer);
begin
  AInfo.HorizontalPositionType :=
    TdxFloatingObjectHorizontalPositionType(AValue);
end;
...
procedure TdxFloatingObjectFormatting.SetIsBehindDocCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Boolean);
begin
  AInfo.IsBehindDoc := AValue;
end;

procedure TdxFloatingObjectFormatting.SetLayoutInTableCell
  (const Value: Boolean);
begin
...
procedure TdxFloatingObjectFormatting.SetLayoutInTableCellCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Boolean);
begin
...
procedure TdxFloatingObjectFormatting.SetLeftDistanceCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Integer);
begin
...
procedure TdxFloatingObjectFormatting.SetLockAspectRatioCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Boolean);
begin
...
procedure TdxFloatingObjectFormatting.SetLockedCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Boolean);
begin
  AInfo.Locked := AValue;
end;
...
procedure TdxFloatingObjectFormatting.SetOffsetCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: TPoint);
begin
  AInfo.Offset := AValue;
end;
...
procedure TdxFloatingObjectFormatting.SetPercentOffsetCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: TPoint);
begin
...
function TdxFloatingObjectFormatting.PropertyEquals(const AOther
  : TdxIndexBasedObject<TdxFloatingObjectInfo,
  TdxFloatingObjectOptions>): Boolean;
begin
...
procedure TdxFloatingObjectFormatting.SetPseudoInlineCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Boolean);
begin
  AInfo.PseudoInline := AValue;
end;

procedure TdxFloatingObjectFormatting.SetRelativeHeight
  (const Value: TdxFloatingObjectRelativeHeight);
begin
  if (Info.RelativeHeight = Value) and Options.UseRelativeHeight then
    Exit;
  SetPropertyValue<TdxFloatingObjectRelativeHeight>
    (SetRelativeHeightCore, Value);
  Options.UseRelativeHeight := True;
end;

procedure TdxFloatingObjectFormatting.SetRelativeHeightCore
  (const AInfo: TdxFloatingObjectInfo;
  const AValue: TdxFloatingObjectRelativeHeight);
begin
  AInfo.RelativeHeight := AValue;
end;

procedure TdxFloatingObjectFormatting.SetRelativeWidth
  (const Value: TdxFloatingObjectRelativeWidth);
begin
...
procedure TdxFloatingObjectFormatting.SetRelativeWidthCore
  (const AInfo: TdxFloatingObjectInfo;
  const AValue: TdxFloatingObjectRelativeWidth);
begin
...
procedure TdxFloatingObjectFormatting.SetRightDistanceCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Integer);
begin
  AInfo.RightDistance := AValue;
end;

procedure TdxFloatingObjectFormatting.SetTextWrapSide
  (const Value: TdxFloatingObjectTextWrapSide);
begin
...
procedure TdxFloatingObjectFormatting.SetTextWrapSideCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Integer);
begin
  AInfo.TextWrapSide := TdxFloatingObjectTextWrapSide(AValue);
end;

procedure TdxFloatingObjectFormatting.SetTextWrapType
  (const Value: TdxFloatingObjectTextWrapType);
begin
...
procedure TdxFloatingObjectFormatting.SetTextWrapTypeCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Integer);
begin
...
procedure TdxFloatingObjectFormatting.SetTopDistanceCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Integer);
begin
...
begin
  if (Info.VerticalPositionAlignment = Value) and Options.UseVerticalPositionAlignment
  then
    Exit;
...
procedure TdxFloatingObjectFormatting.SetVerticalPositionAlignmentCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Integer);
begin
  AInfo.VerticalPositionAlignment :=
    TdxFloatingObjectVerticalPositionAlignment(AValue);
end;

procedure TdxFloatingObjectFormatting.SetVerticalPositionType
  (const Value: TdxFloatingObjectVerticalPositionType);
begin
  if (Info.VerticalPositionType = Value) and Options.UseVerticalPositionType
  then
    Exit;
...
procedure TdxFloatingObjectFormatting.SetVerticalPositionTypeCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Integer);
begin
...
procedure TdxFloatingObjectFormatting.SetZOrderCore
  (const AInfo: TdxFloatingObjectInfo; const AValue: Integer);
begin
  AInfo.ZOrder := AValue;
end;
...
procedure TdxFloatingObjectFormatting.CopyFrom(const AInfo
  : TdxFloatingObjectInfo; const AOptions: TdxFloatingObjectOptions);
begin
...
function TdxFloatingObjectInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxFloatingObjectInfo;
begin
...
begin
  Result := (TextWrapType = TdxFloatingObjectTextWrapType.Square) or
    (TextWrapType = TdxFloatingObjectTextWrapType.Through) or
    (TextWrapType = TdxFloatingObjectTextWrapType.Tight);
end;
...
constructor TdxFloatingObjectProperties.Create(const AOwner
  : IdxFloatingObjectPropertiesContainer);
begin
...
function TdxFloatingObjectProperties.CreateIndexChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
...
function TdxFloatingObjectProperties.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.BatchUpdate);
end;
...
function TdxFloatingObjectProperties.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxFloatingObjectFormatting>;
begin
  Result := TdxDocumentCache(ADocumentModel.Cache)
    .FloatingObjectFormattingCache;
end;

function TdxFloatingObjectProperties.GetCanPutTextAtLeft: Boolean;
begin
  Result := AllowTextWrapAround and
    (TextWrapSide <> TdxFloatingObjectTextWrapSide.Right);
end;

function TdxFloatingObjectProperties.GetCanPutTextAtRight: Boolean;
begin
  Result := AllowTextWrapAround and
    (TextWrapSide <> TdxFloatingObjectTextWrapSide.Left);
end;
...
function TdxFloatingObjectProperties.GetHorizontalPositionAlignment
  : TdxFloatingObjectHorizontalPositionAlignment;
begin
  Result := Info.HorizontalPositionAlignment;
end;

function TdxFloatingObjectProperties.GetHorizontalPositionType
  : TdxFloatingObjectHorizontalPositionType;
begin
  Result := Info.HorizontalPositionType;
end;
...
begin
  Result := AllowTextWrapAround and
    (TextWrapSide = TdxFloatingObjectTextWrapSide.Largest);
end;

function TdxFloatingObjectProperties.GetRelativeHeight
  : TdxFloatingObjectRelativeHeight;
begin
  Result := Info.RelativeHeight;
end;

function TdxFloatingObjectProperties.GetRelativeWidth
  : TdxFloatingObjectRelativeWidth;
begin
  Result := Info.RelativeWidth;
end;
...
function TdxFloatingObjectProperties.GetTextWrapSide
  : TdxFloatingObjectTextWrapSide;
begin
  Result := Info.TextWrapSide;
end;

function TdxFloatingObjectProperties.GetTextWrapType
  : TdxFloatingObjectTextWrapType;
begin
  Result := Info.TextWrapType;
end;
...
function TdxFloatingObjectProperties.GetVerticalPositionAlignment
  : TdxFloatingObjectVerticalPositionAlignment;
begin
  Result := Info.VerticalPositionAlignment;
end;

function TdxFloatingObjectProperties.GetVerticalPositionType
  : TdxFloatingObjectVerticalPositionType;
begin
  Result := Info.VerticalPositionType;
end;
...
begin
  ...
  AEmptyInfo := GetCache(DocumentModel)
    [TdxFloatingObjectFormattingCache.EmptyFloatingObjectFormattingIndex];
...
function TdxFloatingObjectProperties.SetActualSizeCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: TSize)
  : TdxDocumentModelChangeActions;
begin
  AInfo.ActualSize := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.ActualSize);
end;
...
function TdxFloatingObjectProperties.SetAllowOverlapCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.AllowOverlap := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.AllowOverlap);
end;
...
function TdxFloatingObjectProperties.SetBottomDistanceCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.BottomDistance := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.BottomDistance);
end;
...
function TdxFloatingObjectProperties.SetHiddenCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.Hidden := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.Hidden);
end;

procedure TdxFloatingObjectProperties.SetHorizontalPositionAlignment
  (const Value: TdxFloatingObjectHorizontalPositionAlignment);
begin
  if (Info.HorizontalPositionAlignment = Value) and UseHorizontalPositionAlignment
  then
    Exit;
  SetPropertyValue<Integer>(SetHorizontalPositionAlignmentCore, Ord(Value));
end;

function TdxFloatingObjectProperties.SetHorizontalPositionAlignmentCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.HorizontalPositionAlignment :=
    TdxFloatingObjectHorizontalPositionAlignment(AValue);
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.HorizontalPositionAlignment);
end;

procedure TdxFloatingObjectProperties.SetHorizontalPositionType
  (const Value: TdxFloatingObjectHorizontalPositionType);
begin
...
function TdxFloatingObjectProperties.SetHorizontalPositionTypeCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.HorizontalPositionType :=
    TdxFloatingObjectHorizontalPositionType(AValue);
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.HorizontalPositionType);
end;
...
function TdxFloatingObjectProperties.SetIsBehindDocCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.IsBehindDoc := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.IsBehindDoc);
end;

procedure TdxFloatingObjectProperties.SetLayoutInTableCell
  (const Value: Boolean);
begin
...
function TdxFloatingObjectProperties.SetLayoutInTableCellCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.LayoutInTableCell := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.LayoutInTableCell);
end;
...
function TdxFloatingObjectProperties.SetLeftDistanceCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.LeftDistance := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.LeftDistance);
end;
...
function TdxFloatingObjectProperties.SetLockAspectRatioCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.LockAspectRatio := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.LockAspectRatio);
end;
...
function TdxFloatingObjectProperties.SetLockedCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.Locked := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.Locked);
end;
...
function TdxFloatingObjectProperties.SetOffsetCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: TPoint)
  : TdxDocumentModelChangeActions;
begin
  AInfo.Offset := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.Offset);
end;
...
function TdxFloatingObjectProperties.SetPercentOffsetCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: TPoint)
  : TdxDocumentModelChangeActions;
begin
  AInfo.PercentOffset := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.PercentOffset);
end;
...
function TdxFloatingObjectProperties.SetPseudoInlineCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.PseudoInline := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.PseudoInline);
end;

procedure TdxFloatingObjectProperties.SetRelativeHeight
  (const Value: TdxFloatingObjectRelativeHeight);
begin
...
function TdxFloatingObjectProperties.SetRelativeHeightCore
  (const AInfo: TdxFloatingObjectFormatting;
  const AValue: TdxFloatingObjectRelativeHeight): TdxDocumentModelChangeActions;
begin
  AInfo.RelativeHeight := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.RelativeHeight);
end;

procedure TdxFloatingObjectProperties.SetRelativeWidth
  (const Value: TdxFloatingObjectRelativeWidth);
begin
...
function TdxFloatingObjectProperties.SetRelativeWidthCore
  (const AInfo: TdxFloatingObjectFormatting;
  const AValue: TdxFloatingObjectRelativeWidth): TdxDocumentModelChangeActions;
begin
  AInfo.RelativeWidth := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.RelativeWidth);
end;
...
function TdxFloatingObjectProperties.SetRightDistanceCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.RightDistance := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.RightDistance);
end;

procedure TdxFloatingObjectProperties.SetTextWrapSide
  (const Value: TdxFloatingObjectTextWrapSide);
begin
...
function TdxFloatingObjectProperties.SetTextWrapSideCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.TextWrapSide := TdxFloatingObjectTextWrapSide(AValue);
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.TextWrapSide);
end;

procedure TdxFloatingObjectProperties.SetTextWrapType
  (const Value: TdxFloatingObjectTextWrapType);
begin
...
function TdxFloatingObjectProperties.SetTextWrapTypeCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.TextWrapType := TdxFloatingObjectTextWrapType(AValue);
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.TextWrapType);
end;
...
function TdxFloatingObjectProperties.SetTopDistanceCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.TopDistance := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.TopDistance);
end;

procedure TdxFloatingObjectProperties.SetVerticalPositionAlignment
  (const Value: TdxFloatingObjectVerticalPositionAlignment);
begin
  if (Info.VerticalPositionAlignment = Value) and UseVerticalPositionAlignment
  then
    Exit;
  SetPropertyValue<Integer>(SetVerticalPositionAlignmentCore, Ord(Value));
end;

function TdxFloatingObjectProperties.SetVerticalPositionAlignmentCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.VerticalPositionAlignment :=
    TdxFloatingObjectVerticalPositionAlignment(AValue);
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.VerticalPositionAlignment);
end;

procedure TdxFloatingObjectProperties.SetVerticalPositionType
  (const Value: TdxFloatingObjectVerticalPositionType);
begin
...
function TdxFloatingObjectProperties.SetVerticalPositionTypeCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.VerticalPositionType := TdxFloatingObjectVerticalPositionType(AValue);
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.VerticalPositionType);
end;
...
function TdxFloatingObjectProperties.SetZOrderCore
  (const AInfo: TdxFloatingObjectFormatting; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.ZOrder := AValue;
  Result := TdxFloatingObjectChangeActionsCalculator.CalculateChangeActions
    (TdxFloatingObjectChangeType.ZOrder);
end;

function TdxFloatingObjectProperties.UseVal
  (AMask: TdxUseFloatingObjectOption): Boolean;
begin
...
const
  FloatingObjectChangeActionsMap: array [TdxFloatingObjectChangeType]
    of TdxDocumentModelChangeActions = ([],
    [TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetPrimaryLayout,
    TdxDocumentModelChangeAction.ResetSecondaryLayout,
...
constructor TdxFloatingObjectFormattingCache.Create(ADocumentModel
...
begin
  ...
  AppendItem(TdxFloatingObjectFormatting.Create(DocumentModel.MainPart,
    DocumentModel, FDefaultFloatingObjectInfo,
    TdxFloatingObjectOptions.EmptyFloatingObjectOption));
end;

function TdxFloatingObjectFormattingCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxFloatingObjectFormatting;
begin
  Result := nil;
end;
...
procedure TdxZOrderManager.BringToFront(const AObjects: TdxIZOrderedObjectList;
...
procedure TdxZOrderManager.BringForward(const AObjects: TdxIZOrderedObjectList;
  AObjectIndex: Integer);
var
  AMaxIndex: Integer;
begin
  ...
  begin
    if (AObjectIndex + 2 <= AMaxIndex) and
      ((AObjects[AObjectIndex + 2].ZOrder - AObjects[AObjectIndex + 1]
      .ZOrder = 1)) then
...
procedure TdxZOrderManager.Swap(const AObjects: TdxIZOrderedObjectList;
  AObjectIndex: Integer; ASecondIndex: Integer);
var
  AZOrder: Integer;
begin
...
procedure TdxZOrderManager.IncrementZOrders(const AFloatingObjectList
  : TdxIZOrderedObjectList; AFrom: Integer; ATo: Integer);
var
  I: Integer;
begin
  ...
  begin
    if AFloatingObjectList[I].ZOrder - AFloatingObjectList[I - 1].ZOrder >= 1
    then
      Break;
...
procedure TdxZOrderManager.SendBackward(const AObjects: TdxIZOrderedObjectList;
  AObjectIndex: Integer);
begin
  if (AObjectIndex <= 0) or (AObjectIndex > AObjects.Count - 1) then
    Exit;

  if (AObjectIndex - 2 >= 0) and
    (Abs(AObjects[AObjectIndex - 1].ZOrder - AObjects[AObjectIndex - 2]
    .ZOrder) = 1) then
    Swap(AObjects, AObjectIndex, AObjectIndex - 1);
...
procedure TdxZOrderManager.SendToBack(const AObjects: TdxIZOrderedObjectList;
  AObjectIndex: Integer);
var
  AMinZOrder: Integer;
begin
  ...
  else if AObjects[0].ZOrder >= 1 then
...
type
  TdxZOrderedObjectComparer = class(TcxIUnknownObject,
    IComparer<IdxZOrderedObject>)
  public
    function Compare(const Left, Right: IdxZOrderedObject): Integer;
  end;

function TdxZOrderedObjectComparer.Compare(const Left,
  Right: IdxZOrderedObject): Integer;
begin
  ...
  try
    ...
    try
      ...
      begin
        ...
        else if AObj.ZOrder <> APrev.ZOrder then
          Inc(AIndex);
        AObj.ZOrder := AIndex;
        APrev := AObj;
      end;
...
begin
  ...
  Result := (LeftMargin = AInfo.LeftMargin) and
    (RightMargin = AInfo.RightMargin) and (TopMargin = AInfo.TopMargin) and
    (BottomMargin = AInfo.BottomMargin) and
    (ResizeShapeToFitText = AInfo.ResizeShapeToFitText) and
    (WrapText = AInfo.WrapText) and (Upright = AInfo.Upright) and
...
constructor TdxTextBoxFormatting.Create(APieceTable: TdxCustomPieceTable;
  const ADocumentModel: TdxCustomDocumentModel;
  const AFormattingInfo: TdxTextBoxInfo;
  const AFormattingOptions: TdxTextBoxOptions);
begin
  inherited Create(APieceTable, ADocumentModel, AFormattingInfo,
    AFormattingOptions);
end;
...
procedure TdxTextBoxFormatting.CopyFrom(const AInfo: TdxTextBoxInfo;
  const AOptions: TdxTextBoxOptions);
begin
  CopyFromCore(AInfo, AOptions);
end;
...
function TdxTextBoxFormatting.PropertyEquals(const AOther
  : TdxIndexBasedObject<TdxTextBoxInfo, TdxTextBoxOptions>): Boolean;
begin
  Assert(AOther <> nil);
  Result := (Options.Value = AOther.Options.Value) and Info.Equals(AOther.Info);
end;
...
begin
  if Self = nil then
    Exit(nil);
  Result := TdxTextBoxFormatting.Create(PieceTable, DocumentModel,
    Info, Options);
end;
...
procedure TdxTextBoxFormatting.SetBottomMarginCore(const AInfo: TdxTextBoxInfo;
  const AValue: Integer);
begin
...
procedure TdxTextBoxFormatting.SetLeftMarginCore(const AInfo: TdxTextBoxInfo;
  const AValue: Integer);
begin
...
begin
  if (Info.ResizeShapeToFitText = Value) and Options.UseResizeShapeToFitText
  then
    Exit;
...
procedure TdxTextBoxFormatting.SetResizeShapeToFitTextCore
  (const AInfo: TdxTextBoxInfo; const AValue: Boolean);
begin
...
procedure TdxTextBoxFormatting.SetRightMarginCore(const AInfo: TdxTextBoxInfo;
  const AValue: Integer);
begin
...
procedure TdxTextBoxFormatting.SetTopMarginCore(const AInfo: TdxTextBoxInfo;
  const AValue: Integer);
begin
...
procedure TdxTextBoxFormatting.SetUprightCore(const AInfo: TdxTextBoxInfo;
  const AValue: Boolean);
begin
  AInfo.Upright := AValue;
end;

procedure TdxTextBoxFormatting.SetVerticalAlignment
...
procedure TdxTextBoxFormatting.SetVerticalAlignmentCore
  (const AInfo: TdxTextBoxInfo; const AValue: Integer);
begin
...
procedure TdxTextBoxFormatting.SetWrapTextCore(const AInfo: TdxTextBoxInfo;
  const AValue: Boolean);
begin
...
constructor TdxTextBoxProperties.Create(const AOwner
  : IdxTextBoxPropertiesContainer);
begin
...
class function TdxTextBoxProperties.GetPieceTable(const AOwner
  : IdxTextBoxPropertiesContainer): TdxCustomPieceTable;
begin
  Assert(AOwner <> nil);
...
function TdxTextBoxProperties.SetLeftMarginCore(const AInfo
  : TdxTextBoxFormatting; const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.LeftMargin := AValue;
  Result := TdxTextBoxPropertiesChangeActionsCalculator.CalculateChangeActions
    (TdxTextBoxPropertiesChangeType.LeftMargin);
end;
...
function TdxTextBoxProperties.SetRightMarginCore(const AInfo
  : TdxTextBoxFormatting; const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.RightMargin := AValue;
  Result := TdxTextBoxPropertiesChangeActionsCalculator.CalculateChangeActions
    (TdxTextBoxPropertiesChangeType.RightMargin);
end;
...
function TdxTextBoxProperties.SetTopMarginCore(const AInfo
  : TdxTextBoxFormatting; const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.TopMargin := AValue;
  Result := TdxTextBoxPropertiesChangeActionsCalculator.CalculateChangeActions
    (TdxTextBoxPropertiesChangeType.TopMargin);
end;
...
function TdxTextBoxProperties.SetBottomMarginCore
  (const AInfo: TdxTextBoxFormatting; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.BottomMargin := AValue;
  Result := TdxTextBoxPropertiesChangeActionsCalculator.CalculateChangeActions
    (TdxTextBoxPropertiesChangeType.BottomMargin);
end;
...
function TdxTextBoxProperties.SetResizeShapeToFitTextCore
  (const AInfo: TdxTextBoxFormatting; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.ResizeShapeToFitText := AValue;
  Result := TdxTextBoxPropertiesChangeActionsCalculator.CalculateChangeActions
    (TdxTextBoxPropertiesChangeType.ResizeShapeToFitText);
end;
...
function TdxTextBoxProperties.SetWrapTextCore(const AInfo: TdxTextBoxFormatting;
  const AValue: Boolean): TdxDocumentModelChangeActions;
begin
  AInfo.WrapText := AValue;
  Result := TdxTextBoxPropertiesChangeActionsCalculator.CalculateChangeActions
    (TdxTextBoxPropertiesChangeType.WrapText);
end;
...
procedure TdxTextBoxProperties.SetVerticalAlignment(const AValue
...
function TdxTextBoxProperties.SetVerticalAlignmentCore
  (const AInfo: TdxTextBoxFormatting; const AValue: TdxVerticalAlignment)
  : TdxDocumentModelChangeActions;
begin
  AInfo.VerticalAlignment := AValue;
  Result := TdxTextBoxPropertiesChangeActionsCalculator.CalculateChangeActions
    (TdxTextBoxPropertiesChangeType.VerticalAlignment);
end;
...
function TdxTextBoxProperties.SetUprightCore(const AInfo: TdxTextBoxFormatting;
  const AValue: Boolean): TdxDocumentModelChangeActions;
begin
  AInfo.Upright := AValue;
  Result := TdxTextBoxPropertiesChangeActionsCalculator.CalculateChangeActions
    (TdxTextBoxPropertiesChangeType.Upright);
end;

function TdxTextBoxProperties.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxTextBoxFormatting>;
begin
...
begin
  AInfo := GetInfoForModification(AIsDeferred);
  AEmptyInfo := GetCache(DocumentModel)
    [TdxTextBoxFormattingCache.EmptyTextBoxFormattingIndex];
  AInfo.ReplaceInfo(AEmptyInfo.Info, AEmptyInfo.Options);
  ReplaceInfo(AInfo, BatchUpdateChangeActions);
  if not AIsDeferred then
    AInfo.Free;
...
begin
  AInfo := GetInfoForModification(AIsDeferredInfo);
  ATextBoxInfo := AInfo.Info;
  AInfo.ReplaceInfo(ATextBoxInfo,
    TdxTextBoxOptions.Create(TdxTextBoxOptions.MaskUseNone));
  ReplaceInfo(AInfo, BatchUpdateChangeActions);
  if not AIsDeferredInfo then
    AInfo.Free;
end;
...
function TdxTextBoxProperties.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxTextBoxPropertiesChangeActionsCalculator.CalculateChangeActions
    (TdxTextBoxPropertiesChangeType.BatchUpdate);
end;
...
function TdxTextBoxProperties.CreateIndexChangedHistoryItem
  : TdxIndexChangedHistoryItemCore;
begin
...
constructor TdxTextBoxFormattingCache.Create(ADocumentModel
  : TdxCustomDocumentModel);
begin
  inherited Create(ADocumentModel.UnitConverter, ADocumentModel);
  FDefaultTextBoxInfo := CreateDefaultInfoItem(ADocumentModel.UnitConverter);
  AppendItem(TdxTextBoxFormatting.Create(DocumentModel.MainPart, DocumentModel,
    FDefaultTextBoxInfo, TdxTextBoxOptions.EmptyTextBoxOption));
end;

function TdxTextBoxFormattingCache.CreateDefaultInfoItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxTextBoxInfo;
begin
  Result := TdxTextBoxInfoCache.CreateDefaultItemCore(AUnitConverter);
end;

function TdxTextBoxFormattingCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxTextBoxFormatting;
begin
  Result := nil;
end;
...
function TdxTextBoxInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxTextBoxInfo;
begin
  Result := CreateDefaultItemCore(AUnitConverter);
end;

class function TdxTextBoxInfoCache.CreateDefaultItemCore(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxTextBoxInfo;
begin
