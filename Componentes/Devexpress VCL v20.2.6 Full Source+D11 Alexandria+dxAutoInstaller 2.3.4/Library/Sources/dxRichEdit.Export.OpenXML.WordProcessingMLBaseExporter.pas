...
type
  ...
  protected
    ...
    function CreateXmlContent(const AAction: TdxXMLWriteAction)
      : TStream; virtual;
    function CreateCompressedXmlContent(const AAction: TdxXMLWriteAction)
      : TdxCompressedStream; overload; virtual;
    function CreateCompressedXmlContent(const AAction: TdxXMLWriteAction;
      AEncoding: TEncoding): TdxCompressedStream; overload; virtual;
    procedure AddPackageContent(const AFileName: string; AContent: TStream);
      overload; virtual;
    procedure AddPackageContent(const AFileName: string;
      const AContent: TArray<Byte>); overload; virtual;
    procedure AddCompressedPackageContent(const AFileName: string;
      AContent: TdxCompressedStream); virtual;
    procedure AddPackageImage(const AFileName: string;
      AImage: TdxOfficeImage); virtual;
  ...
  public
    ...
    constructor Create(const AOpenXmlValue: string;
      const AWordMLValue: string); overload;
  ...
  TdxMLDictionary<TEnumeration> = class
    (TdxEnumeratedDictionary<TEnumeration, TdxWordProcessingMLValue>)
  public
    procedure AddValue(AKey: TEnumeration; const AValue: string);
    function GetKeyByStringDef(const AValue: string; ADefaultKey: TEnumeration)
      : TEnumeration;
    function GetKeyByOpenXmlStringDef(const AValue: string;
      ADefaultKey: TEnumeration): TEnumeration;
    function GetKeyByWordMLStringDef(const AValue: string;
      ADefaultKey: TEnumeration): TEnumeration;
    function TryGetKeyByOpenXmlString(const AValue: string;
      out AKey: TEnumeration): Boolean;
    function TryGetKeyByWordMLString(const AValue: string;
      out AKey: TEnumeration): Boolean;
  end;

  TdxWordProcessingMLBaseExporter = class abstract
    (TdxXmlBasedDocumentModelExporter)
  public const
  ...
  strict private
  class var
    FPredefinedBackgroundColors
      : TDictionary<TdxAlphaColor, TdxWordProcessingMLValue>;
    ...
    FFloatingObjectHorizontalPositionAlignmentTable
      : TdxMLDictionary<TdxFloatingObjectHorizontalPositionAlignment>;
    FFloatingObjectVerticalPositionAlignmentTable
      : TdxMLDictionary<TdxFloatingObjectVerticalPositionAlignment>;
    FFloatingObjectHorizontalPositionTypeTable
      : TdxMLDictionary<TdxFloatingObjectHorizontalPositionType>;
    FFloatingObjectCssRelativeFromHorizontalTable
      : TdxMLDictionary<TdxFloatingObjectRelativeFromHorizontal>;
    FFloatingObjectCssRelativeFromVerticalTable
      : TdxMLDictionary<TdxFloatingObjectRelativeFromVertical>;
    FFloatingObjectRelativeFromHorizontalTable
      : TdxMLDictionary<TdxFloatingObjectRelativeFromHorizontal>;
    FFloatingObjectRelativeFromVerticalTable
      : TdxMLDictionary<TdxFloatingObjectRelativeFromVertical>;
    FFloatingObjectVerticalPositionTypeTable
      : TdxMLDictionary<TdxFloatingObjectVerticalPositionType>;
    FFloatingObjectTextWrapSideTable
      : TdxMLDictionary<TdxFloatingObjectTextWrapSide>;
    FFloatingObjectTextWrapTypeTable
      : TdxMLDictionary<TdxFloatingObjectTextWrapType>;
    FTextBoxVerticalAlignmentTable: TdxMLDictionary<TdxVerticalAlignment>;
    FConditionalTableStyleFormattingTypesTable
      : TdxMLDictionary<TdxConditionalTableStyleFormattingType>;
  ...
  protected
    ...
    function AllowExportTableCellProperties(ACell: TdxTableCell)
      : Boolean; virtual;
    function ConvertAlignment(AAlignment: TdxParagraphAlignment)
      : string; virtual;
    ...
    function ConvertConditionalStyleType(AStyleType
      : TdxConditionalTableStyleFormattingType): string;
    ...
    function ConvertHorizontalAnchorTypes
      (AValue: TdxHorizontalAnchorTypes): string;
    function ConvertHorizontalPositionAlignment(AHorizontalPositionAlignment
      : TdxFloatingObjectHorizontalPositionAlignment): string;
      overload; virtual;
    function ConvertHorizontalPositionAlignment(AHorizontalPositionAlignment
      : TdxParagraphFrameHorizontalPositionAlignment): string;
      overload; virtual;
    function ConvertHorizontalPositionType(AHorizontalPositionType
      : TdxFloatingObjectHorizontalPositionType): string; overload; virtual;
    function ConvertHorizontalPositionType(AHorizontalPositionType
      : TdxParagraphFrameHorizontalPositionType): string; overload; virtual;
    function ConvertHorizontalRule(AHorizontalRule
      : TdxParagraphFrameHorizontalRule): string; virtual;
    function ConvertLineNumberingRestartType
      (AValue: TdxLineNumberingRestart): string;
    function ConvertLineSpacing(ALineSpacing: TdxParagraphLineSpacing)
      : string; virtual;
    function ConvertLineSpacingValue(ALineSpacing: TdxParagraphLineSpacing;
      AValue: Single): Integer; virtual;
    ...
    function ConvertScript(AScript: TdxCharacterFormattingScript)
      : string; virtual;
    ...
    function ConvertTabAlignment(AAlignment: TdxTabAlignmentType)
      : string; virtual;
    ...
    function ConvertUnderlineType(AUnderline: TdxUnderlineType)
      : string; virtual;
    ...
    function ConvertVerticalPositionAlignment(AVerticalPositionAlignment
      : TdxFloatingObjectVerticalPositionAlignment): string; overload; virtual;
    function ConvertVerticalPositionAlignment(AVerticalPositionAlignment
      : TdxParagraphFrameVerticalPositionAlignment): string; overload; virtual;
    function ConvertVerticalPositionType(AVerticalPositionType
      : TdxFloatingObjectVerticalPositionType): string; overload; virtual;
    function ConvertVerticalPositionType(AVerticalPositionType
      : TdxParagraphFrameVerticalPositionType): string; overload; virtual;
    function ConvertWidthUnitTypes(AValue: TdxWidthUnitType): string;
    function ConvertWrapType(AWrapType: TdxFloatingObjectTextWrapType): string;
      overload; virtual;
    function ConvertWrapType(AWrapType: TdxParagraphFrameTextWrapType): string;
      overload; virtual;
    function EncodeVariableValue(const AValue: string): string;
    function ExportBinData(AImage: TdxOfficeImage): string; virtual;
    function ExportImageStyle(AFloatingObjectProperties
      : TdxFloatingObjectProperties;
      ATextBoxContent: TdxTextBoxFloatingObjectContent;
      AShape: TdxShape): string;
    ...
    function GenerateFloatingObjectName(const AName: string;
      const ADefaultNamePrefix: string; AId: Integer): string;
    ...
    function GetExportedImageTable: TDictionary<TdxOfficeImage, string>;
      virtual; abstract;
    function GetGroupName(const AGroupName: string): string;
    function GetHorizontalPositionAlignment
      (AFloatingObjectHorizontalPositionAlignment
      : TdxFloatingObjectHorizontalPositionAlignment): string;
    function GetHorizontalPositionType(AFloatingObjectHorizontalPositionType
      : TdxFloatingObjectHorizontalPositionType): string;
    function GetHorizontalPositionTypeAttributeTable
      : TdxMLDictionary<TdxFloatingObjectHorizontalPositionType>;
      virtual; abstract;
    function GetImagePath(AImage: TdxOfficeImage): string; overload; virtual;
    function GetNumberingListIndexForExport(ANumberingListIndex
    ...
    function GetRelativeHeight(const ARelativeHeight
      : TdxFloatingObjectRelativeHeight): string;
    function GetRelativeSizeFromHorizontal(const ARelativeWidth
      : TdxFloatingObjectRelativeWidth): string;
    function GetRelativeSizeFromVertical(const ARelativeHeight
      : TdxFloatingObjectRelativeHeight): string;
    function GetRelativeWidth(const ARelativeWidth
      : TdxFloatingObjectRelativeWidth): string;
    function GetTableCellStyleId(AStyleIndex: Integer): string;
    function GetTableStyleId(AStyleIndex: Integer): string;
    function GetVerticalAlignment(AVerticalAlignment
      : TdxVerticalAlignment): string;
    function GetVerticalPositionAlignment
      (AFloatingObjectVerticalPositionAlignment
      : TdxFloatingObjectVerticalPositionAlignment): string;
    function GetVerticalPositionType(AFloatingObjectVerticalPositionType
      : TdxFloatingObjectVerticalPositionType): string;
    function GetVerticalPositionTypeAttributeTable
      : TdxMLDictionary<TdxFloatingObjectVerticalPositionType>;
      virtual; abstract;
    function GetWordProcessingMLValue(AValue: TdxWordProcessingMLValue): string;
      overload; virtual; abstract;
    function GetWordProcessingMLValue(const AOpenXmlValue: string): string;
      overload; virtual;
    ...
    function ShouldExportCellMargins(ACellMargins: TdxCellMargins)
      : Boolean; virtual;
    function ShouldExportFloatingPosition(AFloatingPosition
      : TdxTableFloatingPosition): Boolean; virtual;
    function ShouldExportLineNumbering(ANumbering: TdxSectionLineNumbering)
      : Boolean; virtual;
    function ShouldExportPageNumbering(ANumbering: TdxSectionPageNumbering)
      : Boolean; virtual;
    function ShouldExportPaperSource(ASettings: TdxSectionGeneralSettings)
      : Boolean; virtual;
    function ShouldExportParagraphBorder(ADefaultParagraphProperties: Boolean;
      ABorderInfo: TdxBorderInfo): Boolean;
    function ShouldExportParagraphNumbering(ANumberingListIndex
      : TdxNumberingListIndex): Boolean; virtual;
    function ShouldExportParagraphProperties(AParagraph: TdxParagraph)
      : Boolean; virtual;
    function ShouldExportRunProperties(ARun: TdxTextRunBase): Boolean; virtual;
    function ShouldExportSectionEndNote(ANote: TdxSectionFootNote)
      : Boolean; virtual;
    function ShouldExportSectionFootNote(ANote: TdxSectionFootNote)
      : Boolean; virtual;
    function ShouldExportSectionMargins(AMargins: TdxSectionMargins)
      : Boolean; virtual;
    function ShouldExportSectionPage(APage: TdxSectionPage): Boolean; virtual;
    function ShouldExportSectionProperties(AParagraph: TdxParagraph)
      : Boolean; virtual;
    function ShouldExportTableBorders(ABorders: TdxTableBorders)
      : Boolean; virtual;
    function ShouldExportTabProperties(ATabs: TdxTabFormattingInfo)
      : Boolean; virtual;
    ...
    procedure ExportAbstractNumberingList(AList: TdxAbstractNumberingList;
      AId: Integer); virtual; abstract;
    procedure ExportAbstractNumberingLists; virtual;
    procedure ExportBreak(const AValue: string); virtual;
    procedure ExportCell(ACell: TdxTableCell;
      ATableInfo: TdxTableInfo); override;
    procedure ExportCellMargin(const ATag: string;
      AMargin: TdxMarginUnitBase); overload;
    procedure ExportCellMargins(ATableProperties: TdxTableProperties); overload;
    procedure ExportCellMargins(const ATag: string;
      ACellMargins: TdxCellMargins); overload; virtual;
    ...
    procedure ExportConditionalFormatting(AConditionalFormatting
      : TdxConditionalTableStyleFormattingTypes); virtual;
    ...
    procedure ExportDoubleFontSize(ACharacterProperties
      : TdxCharacterProperties);
    procedure ExportEndNoteCore(AWriter: TdxXmlWriter;
      AEndNote: TdxFootNoteBase; AId: Integer); virtual;
    ...
    procedure ExportFieldChar(ARun: TdxTextRun; const AFieldCharType: string;
      AWriteDisableUpdate: Boolean); virtual;
    ...
    procedure ExportFloatingPosition(AFloatingPosition
      : TdxTableFloatingPosition); virtual;
    procedure ExportFootNoteCore(AWriter: TdxXmlWriter;
      AFootNote: TdxFootNoteBase; AId: Integer); overload; virtual;
    procedure ExportFootNoteCore(AWriter: TdxXmlWriter; ANote: TdxFootNoteBase;
      AId: Integer; const ATagName: string); overload; virtual;
    ...
    procedure ExportInlinePictureImageReference
      (ARun: TdxInlinePictureRun); virtual;
    procedure ExportInlinePictureRun(ARun: TdxInlinePictureRun);
      overload; override;
    ...
    procedure ExportLevelCharacterProperties(AProperties
      : TdxCharacterProperties);
    procedure ExportLevelOverride(ALevel: TdxAbstractListLevel;
      ALevelIndex: Integer);
    procedure ExportLevelParagraphProperties(AProperties
      : TdxParagraphProperties; ATabs: TdxTabProperties);
    procedure ExportLevelProperties(const ALevel: IdxListLevel;
      ALevelIndex: Integer); virtual;
    ...
    procedure ExportLockAspectRatio(AFloatingObjectProperties
      : TdxFloatingObjectProperties);
    ...
    procedure ExportNumberFormatValue(AProperties: TdxListLevelProperties);
      virtual; abstract;
    procedure ExportNumberingCore;
    procedure ExportNumberingList(AList: TdxNumberingList; AId: Integer);
      virtual; abstract;
    ...
    procedure ExportParagraphBorder(const ATag: string;
      ABorder: TdxBorderInfo); virtual;
    procedure ExportParagraphBorders(AProperties: TdxParagraphProperties;
      ADefaultParagraphProperties: Boolean); virtual;
    procedure ExportParagraphFrame(AProperties: TdxFrameProperties); virtual;
    procedure ExportParagraphIndentation(AProperties
      : TdxParagraphProperties); virtual;
    procedure ExportParagraphListReference(AParagraph: TdxParagraph);
      virtual; abstract;
    procedure ExportParagraphOutlineLevel(AProperties
      : TdxParagraphProperties); virtual;
    procedure ExportParagraphProperties(AParagraph: TdxParagraph); virtual;
    procedure ExportParagraphPropertiesCore(AParagraph: TdxParagraph;
      const AParagraphNumberingExporter: TdxAction); overload; virtual;
    procedure ExportParagraphPropertiesCore(AProperties: TdxParagraphProperties;
      ADefaultParagraphProperties: Boolean; const AFramePropertiesExporter,
      AParagraphNumberingExporter, ATabsExporter: TdxAction); overload; virtual;
    procedure ExportParagraphSpacing(AProperties
      : TdxParagraphProperties); virtual;
    procedure ExportParagraphStyle(AStyleIndex: Integer); virtual;
    procedure ExportParagraphStyleListReference(ANumberingListIndex
      : TdxNumberingListIndex; AListLevelIndex: Integer); virtual; abstract;
    ...
    procedure ExportRunFontName(ACharacterProperties
      : TdxCharacterProperties); virtual;
    procedure ExportRunFontScript(ACharacterProperties
      : TdxCharacterProperties); virtual;
    procedure ExportRunFontStrikeout(ACharacterProperties
      : TdxCharacterProperties); virtual;
    procedure ExportRunFontUnderline(ACharacterProperties
      : TdxCharacterProperties); virtual;
    ...
    procedure ExportRunLangInfo(ACharacterProperties
      : TdxCharacterProperties); virtual;
    procedure ExportRunNoProof(ACharacterProperties
      : TdxCharacterProperties); virtual;
    procedure ExportRunProperties(ARun: TdxTextRunBase); virtual;
    procedure ExportRunPropertiesCore(ACharacterProperties
      : TdxCharacterProperties); virtual;
    ...
    procedure ExportSectionFootNoteCore(const ATagName: string;
      ANote: TdxSectionFootNote; ADefaultInfo: TdxFootNoteInfo); virtual;
    procedure ExportSectionGeneralSettings
      (ASettings: TdxSectionGeneralSettings); virtual;
    procedure ExportSectionHeadersFooters(ASection: TdxSection); override;
    procedure ExportSectionLineNumbering(ANumbering
      : TdxSectionLineNumbering); virtual;
    ...
    procedure ExportSectionPageNumbering(ANumbering
      : TdxSectionPageNumbering); virtual;
    ...
    procedure ExportStyleCharacterProperties(ACharacterProperties
      : TdxCharacterProperties); virtual;
    procedure ExportStyleName(const AStyle: IdxStyle); virtual;
    procedure ExportStyleParagraphProperties(AParagraphProperties
      : TdxParagraphProperties; ATabInfo: TdxTabFormattingInfo;
      AOwnNumberingListIndex: TdxNumberingListIndex; AListLevelIndex: Integer;
      AMergedStyleListIndex: TdxNumberingListIndex); virtual;
    ...
    procedure ExportTableBorder(const ATag: string;
      ABorder: TdxBorderBase); virtual;
    procedure ExportTableBorderCore(ABorder: TdxBorderBase;
      AExportAutoColor: Boolean);
    procedure ExportTableBorders(ABorders: TdxTableBorders); virtual;
    procedure ExportTableCellBackgroundColor(ACellProperties
      : TdxTableCellProperties); virtual;
    procedure ExportTableCellBorder(const ATag: string;
      ABorder: TdxBorderBase); virtual;
    ...
    procedure ExportTableCellProperties(ACellProperties
      : TdxTableCellProperties); overload; virtual;
    procedure ExportTableCellProperties(ACellProperties: TdxTableCellProperties;
      AExportBorders: Boolean); overload; virtual;
    procedure ExportTableCellPropertiesCore(ACellProperties
      : TdxTableCellProperties); overload;
    procedure ExportTableCellPropertiesCore(ACellProperties
      : TdxTableCellProperties; AExportBorders: Boolean); overload;
    procedure ExportTableCellPropertiesVerticalMerging(AVerticalMerging
      : TdxMergingState); virtual;
    procedure ExportTableCellStyle(AStyleIndex: Integer); virtual;
    procedure ExportTableCellStyles; virtual;
    procedure ExportTableConditionalStyle(AStyleType
      : TdxConditionalTableStyleFormattingType;
      AStyle: TdxTableConditionalStyle); virtual;
    ...
    procedure ExportTablePropertiesCore(ATableProperties: TdxTableProperties);
      overload; virtual;
    procedure ExportTablePropertiesCore(ATableProperties: TdxTableProperties;
      AExportTableLayout: Boolean); overload;
    procedure ExportTablePropertiesException(ATableProperties
      : TdxTableProperties); virtual;
    procedure ExportTableRowHeight(AHeight: TdxHeightUnit); virtual;
    procedure ExportTableRowProperties(ARowProperties: TdxTableRowProperties);
      overload; virtual;
    procedure ExportTableRowProperties(ARowProperties: TdxTableRowProperties;
      AIsStyle: Boolean); overload; virtual;
    procedure ExportTableStyle(AStyleIndex: Integer); virtual;
    procedure ExportTableStyleConditionalProperties
      (ATableConditionalStyleProperties
      : TdxTableConditionalStyleProperties); virtual;
    ...
    procedure ExportTextCore(const ARunText: string; AFrom: Integer;
      ALength: Integer); overload; virtual;
    procedure ExportTextRun(ARun: TdxTextRun); override;
    procedure ExportTextRunCore(ARun: TdxTextRun;
      const ARunText: string); virtual;
    procedure ExportTextShading(ABackground: TdxAlphaColor);
    procedure ExportWidthUnit(AWidthUnit: TdxWidthUnit); virtual;
    procedure ExportWidthUnitValue(const ATag: string;
      AValue: TdxWidthUnit); virtual;
    ...
    procedure WriteFloatingObjectPict(AFloatingObjectProperties
      : TdxFloatingObjectProperties;
      ATextBoxContent: TdxTextBoxFloatingObjectContent;
      APictureContent: TdxPictureFloatingObjectContent; AShape: TdxShape;
      const AName: string);
    procedure WriteFloatingObjectShape(AFloatingObjectProperties
      : TdxFloatingObjectProperties;
      ATextBoxContent: TdxTextBoxFloatingObjectContent;
      APictureContent: TdxPictureFloatingObjectContent; AShape: TdxShape;
      AShapeTypeId: Integer; const AName: string);
    procedure WriteFloatingObjectShapeAllColorsAndOutlineWeight
      (AShape: TdxShape);
    procedure WriteFloatingObjectTextBox(ATextBoxContent
      : TdxTextBoxFloatingObjectContent);
    procedure WriteFloatingObjectTxbxContent
    ...
    procedure WriteStringAttr(const APrefix: string; const AAttr: string;
      const ANs: string; const AValue: string); virtual;
    procedure WriteStringValue(const APrefix: string; const ATag: string;
      const AValue: string); overload; virtual;
    procedure WriteStringValue(const ATag: string; const AValue: string);
      overload; virtual;
    ...
    procedure WriteWpBoolValueAsTag(const ATag: string;
      AValue: Boolean); virtual;
    procedure WriteWpEmptyElement(const ATag: string); virtual;
    procedure WriteWpEmptyOrFalseValue(const ATag: string;
      AValue: Boolean); virtual;
    ...
    procedure WriteWpStringAttr(const AAttr: string;
      const AValue: string); virtual;
    procedure WriteWpStringValue(const ATag: string;
      const AValue: string); virtual;
    ...
    property CurrentSection: TdxSection read FCurrentSection
      write FCurrentSection;
    property DocumentContentWriter: TdxXmlWriter read FDocumentContentWriter
      write FDocumentContentWriter;
    ...
    property ForbidExecuteBaseExportTableCell: Boolean
      read FForbidExecuteBaseExportTableCell
      write FForbidExecuteBaseExportTableCell;
    property ExportedImageTable: TDictionary<TdxOfficeImage, string>
      read GetExportedImageTable;
    property HorizontalPositionTypeAttributeTable
      : TdxMLDictionary<TdxFloatingObjectHorizontalPositionType>
      read GetHorizontalPositionTypeAttributeTable;
    property VerticalPositionTypeAttributeTable
      : TdxMLDictionary<TdxFloatingObjectVerticalPositionType>
      read GetVerticalPositionTypeAttributeTable;
  public
    constructor Create(ADocumentModel: TdxCustomDocumentModel;
      const AOptions: IdxExporterOptions); override;
    destructor Destroy; override;

    class property PredefinedGroupNames: TdxStringsDictionary
      read FPredefinedGroupNames;
    class property PredefinedBackgroundColors
      : TDictionary<TdxAlphaColor, TdxWordProcessingMLValue>
      read FPredefinedBackgroundColors;
    class property PresetColors: TdxStringColorDictionary read FPresetColors;
    class property UnderlineTable: TdxMLDictionary<TdxUnderlineType>
      read FUnderlineTable;
    class property RunBreaksTable: TDictionary<Char, TdxWordProcessingMLValue>
      read FRunBreaksTable;
    class property ParagraphAlignmentTable
      : TdxMLDictionary<TdxParagraphAlignment> read FParagraphAlignmentTable;
    class property LineSpacingTable: TdxMLDictionary<TdxParagraphLineSpacing>
      read FLineSpacingTable;
    class property TabAlignmentTable: TdxMLDictionary<TdxTabAlignmentType>
      read FTabAlignmentTable;
    class property TabLeaderTable: TdxMLDictionary<TdxTabLeaderType>
      read FTabLeaderTable;
    class property TextDirectionTable: TdxMLDictionary<TdxTextDirection>
      read FTextDirectionTable;
    class property ShadingPatternTable: TdxMLDictionary<TdxShadingPattern>
      read FShadingPatternTable;
    class property VerticalAlignmentTable: TdxMLDictionary<TdxVerticalAlignment>
      read FVerticalAlignmentTable;
    class property SectionStartTypeTable: TdxMLDictionary<TdxSectionStartType>
      read FSectionStartTypeTable;
    class property LineNumberingRestartTable
      : TdxMLDictionary<TdxLineNumberingRestart>
      read FLineNumberingRestartTable;
    class property PageNumberingFormatTable: TdxMLDictionary<TdxNumberingFormat>
      read FPageNumberingFormatTable;
    class property ChapterSeparatorsTable
      : TDictionary<Char, TdxWordProcessingMLValue>
      read FChapterSeparatorsTable;
    class property NumberingListTypeTable: TdxMLDictionary<TdxNumberingType>
      read FNumberingListTypeTable;
    class property ListNumberAlignmentTable
      : TdxMLDictionary<TdxListNumberAlignment> read FListNumberAlignmentTable;
    class property ListNumberSeparatorTable
      : TDictionary<Char, TdxWordProcessingMLValue>
      read FListNumberSeparatorTable;
    class property ContentTypeTable: TdxStringsDictionary
      read FContentTypeTable;
    class property WidthUnitTypesTable: TdxMLDictionary<TdxWidthUnitType>
      read FWidthUnitTypesTable;
    class property TableLayoutTypeTable: TdxMLDictionary<TdxTableLayoutType>
      read FTableLayoutTypeTable;
    class property BorderLineStyleTable: TdxMLDictionary<TdxBorderLineStyle>
      read FBorderLineStyleTable;
    class property HorizontalAlignModeTable
      : TdxMLDictionary<TdxHorizontalAlignMode> read FHorizontalAlignModeTable;
    class property HorizontalAnchorTypesTable
      : TdxMLDictionary<TdxHorizontalAnchorTypes>
      read FHorizontalAnchorTypesTable;
    class property VerticalAlignModeTable: TdxMLDictionary<TdxVerticalAlignMode>
      read FVerticalAlignModeTable;
    class property VerticalAnchorTypesTable
      : TdxMLDictionary<TdxVerticalAnchorTypes> read FVerticalAnchorTypesTable;
    class property HeightUnitTypeTable: TdxMLDictionary<TdxHeightUnitType>
      read FHeightUnitTypeTable;
    class property MergingStateTable: TdxMLDictionary<TdxMergingState>
      read FMergingStateTable;
    class property TableRowAlignmentTable: TdxMLDictionary<TdxTableRowAlignment>
      read FTableRowAlignmentTable;
    class property FootNotePlacementTable: TdxMLDictionary<TdxFootNotePosition>
      read FFootNotePlacementTable;
    class property FloatingObjectHorizontalPositionAlignmentTable
      : TdxMLDictionary<TdxFloatingObjectHorizontalPositionAlignment>
      read FFloatingObjectHorizontalPositionAlignmentTable;
    class property FloatingObjectVerticalPositionAlignmentTable
      : TdxMLDictionary<TdxFloatingObjectVerticalPositionAlignment>
      read FFloatingObjectVerticalPositionAlignmentTable;
    class property FloatingObjectHorizontalPositionTypeTable
      : TdxMLDictionary<TdxFloatingObjectHorizontalPositionType>
      read FFloatingObjectHorizontalPositionTypeTable;
    class property FloatingObjectCssRelativeFromHorizontalTable
      : TdxMLDictionary<TdxFloatingObjectRelativeFromHorizontal>
      read FFloatingObjectCssRelativeFromHorizontalTable;
    class property FloatingObjectCssRelativeFromVerticalTable
      : TdxMLDictionary<TdxFloatingObjectRelativeFromVertical>
      read FFloatingObjectCssRelativeFromVerticalTable;
    class property FloatingObjectRelativeFromHorizontalTable
      : TdxMLDictionary<TdxFloatingObjectRelativeFromHorizontal>
      read FFloatingObjectRelativeFromHorizontalTable;
    class property FloatingObjectRelativeFromVerticalTable
      : TdxMLDictionary<TdxFloatingObjectRelativeFromVertical>
      read FFloatingObjectRelativeFromVerticalTable;
    class property FloatingObjectVerticalPositionTypeTable
      : TdxMLDictionary<TdxFloatingObjectVerticalPositionType>
      read FFloatingObjectVerticalPositionTypeTable;
    class property FloatingObjectTextWrapSideTable
      : TdxMLDictionary<TdxFloatingObjectTextWrapSide>
      read FFloatingObjectTextWrapSideTable;
    class property FloatingObjectTextWrapTypeTable
      : TdxMLDictionary<TdxFloatingObjectTextWrapType>
      read FFloatingObjectTextWrapTypeTable;
    class property TextBoxVerticalAlignmentTable
      : TdxMLDictionary<TdxVerticalAlignment>
      read FTextBoxVerticalAlignmentTable;
    class property ConditionalTableStyleFormattingTypesTable
      : TdxMLDictionary<TdxConditionalTableStyleFormattingType>
      read FConditionalTableStyleFormattingTypesTable;
  end;
...
constructor TdxXmlBasedDocumentModelExporter.Create(ADocumentModel
  : TdxCustomDocumentModel; const AOptions: IdxExporterOptions);
begin
  inherited Create(ADocumentModel, AOptions);
  FNow := SysUtils.Now;
end;

function TdxXmlBasedDocumentModelExporter.CreateXmlWriterSettings
...
procedure TdxXmlBasedDocumentModelExporter.BeforeCreateXmlContent
  (AWriter: TdxXmlWriter);
begin
end;

function TdxXmlBasedDocumentModelExporter.CreateXmlContent
  (const AAction: TdxXMLWriteAction): TStream;
var
  AWriter: TdxXmlWriter;
begin
...
function TdxXmlBasedDocumentModelExporter.CreateCompressedXmlContent
  (const AAction: TdxXMLWriteAction): TdxCompressedStream;
begin
  Result := CreateCompressedXmlContent(AAction, TEncoding.UTF8);
end;

function TdxXmlBasedDocumentModelExporter.CreateCompressedXmlContent
  (const AAction: TdxXMLWriteAction; AEncoding: TEncoding): TdxCompressedStream;
var
  AWriter: TdxXmlWriter;
begin
  if Package = nil then
...
procedure TdxXmlBasedDocumentModelExporter.AddPackageContent(const AFileName
...
procedure TdxXmlBasedDocumentModelExporter.AddPackageContent(const AFileName
  : string; const AContent: TArray<Byte>);
begin
  Package.AddFile(AnsiString(AFileName), PByte(AContent), Length(AContent));
end;

procedure TdxXmlBasedDocumentModelExporter.AddCompressedPackageContent
  (const AFileName: string; AContent: TdxCompressedStream);
begin
  Package.AddFile(AnsiString(AFileName), AContent, True);
end;

procedure TdxXmlBasedDocumentModelExporter.AddPackageImage(const AFileName
  : string; AImage: TdxOfficeImage);
var
  AImageBytes: TArray<Byte>;
begin
  AImageBytes := GetImageBytes(AImage);
  Package.AddFile(AnsiString(AFileName), PByte(AImageBytes),
    Length(AImageBytes));
end;

function TdxXmlBasedDocumentModelExporter.GetImageExtension
  (AImage: TdxOfficeImage): string;
begin
...
function TdxXmlBasedDocumentModelExporter.GetImageBytesStream
  (AImage: TdxOfficeImage): TStream;
begin
  Result := AImage.GetImageBytesStreamSafe(AImage.RawFormat);
end;

function TdxXmlBasedDocumentModelExporter.GetImageBytes(AImage: TdxOfficeImage)
  : TArray<Byte>;
begin
...
procedure TdxMLDictionary<TEnumeration>.AddValue(AKey: TEnumeration;
  const AValue: string);
begin
  Add(AKey, TdxWordProcessingMLValue.Create(AValue));
end;

function TdxMLDictionary<TEnumeration>.GetKeyByStringDef(const AValue: string;
  ADefaultKey: TEnumeration): TEnumeration;
var
...
begin
  ...
  for AIndex := MinValue to MaxValue do
    ...
    begin
      ...
      else if AValue = Map.ValueTable[AIndex].WordMLValue then
        AWordMLOrdKey := AIndex;
    end;
  if AOpenXmlOrdKey <> MinInt then
    TdxOrdinalHelper.SetValue(KeySize, AOpenXmlOrdKey, @Result)
  else if AWordMLOrdKey <> MinInt then
    TdxOrdinalHelper.SetValue(KeySize, AWordMLOrdKey, @Result);
end;

function TdxMLDictionary<TEnumeration>.GetKeyByOpenXmlStringDef
  (const AValue: string; ADefaultKey: TEnumeration): TEnumeration;
var
  AIndex: Integer;
begin
  Result := ADefaultKey;
...
function TdxMLDictionary<TEnumeration>.GetKeyByWordMLStringDef
  (const AValue: string; ADefaultKey: TEnumeration): TEnumeration;
var
  AIndex: Integer;
begin
...
function TdxMLDictionary<TEnumeration>.TryGetKeyByOpenXmlString
  (const AValue: string; out AKey: TEnumeration): Boolean;
var
  AIndex: Integer;
begin
...
function TdxMLDictionary<TEnumeration>.TryGetKeyByWordMLString
  (const AValue: string; out AKey: TEnumeration): Boolean;
var
  AIndex: Integer;
begin
...
class function TdxWordProcessingMLValue.ConvertToWordML(const AOpenXmlValue
  : string): string;
var
...
constructor TdxWordProcessingMLBaseExporter.Create(ADocumentModel
  : TdxCustomDocumentModel; const AOptions: IdxExporterOptions);
begin
  inherited Create(ADocumentModel, AOptions);
  FDrawingElementId := 1;
...
begin
  ...
  Result.AddValue(TdxBorderLineStyle.ThinThickThinLargeGap,
    'thinThickThinLargeGap');
  Result.AddValue(TdxBorderLineStyle.ThinThickThinMediumGap,
    'thinThickThinMediumGap');
  Result.AddValue(TdxBorderLineStyle.ThinThickThinSmallGap,
...
function CreateChapterSeparatorsTable
  : TDictionary<Char, TdxWordProcessingMLValue>;
begin
...
function CreateConditionalTableStyleFormattingTypesTable
  : TdxMLDictionary<TdxConditionalTableStyleFormattingType>;
begin
  Result := TdxMLDictionary<TdxConditionalTableStyleFormattingType>.Create;
  Result.Add(TdxConditionalTableStyleFormattingType.BottomLeftCell,
    TdxWordProcessingMLValue.Create('swCell', 'swCell'));
  Result.Add(TdxConditionalTableStyleFormattingType.BottomRightCell,
    TdxWordProcessingMLValue.Create('seCell', 'seCell'));
  Result.Add(TdxConditionalTableStyleFormattingType.EvenColumnBanding,
    TdxWordProcessingMLValue.Create('band2Vert', 'band2Vert'));
  Result.Add(TdxConditionalTableStyleFormattingType.EvenRowBanding,
    TdxWordProcessingMLValue.Create('band2Horz', 'band2Horz'));
  Result.Add(TdxConditionalTableStyleFormattingType.FirstColumn,
    TdxWordProcessingMLValue.Create('firstCol', 'firstCol'));
  Result.Add(TdxConditionalTableStyleFormattingType.FirstRow,
    TdxWordProcessingMLValue.Create('firstRow', 'firstRow'));
  Result.Add(TdxConditionalTableStyleFormattingType.LastColumn,
    TdxWordProcessingMLValue.Create('lastCol', 'lastCol'));
  Result.Add(TdxConditionalTableStyleFormattingType.LastRow,
    TdxWordProcessingMLValue.Create('lastRow', 'lastRow'));
  Result.Add(TdxConditionalTableStyleFormattingType.OddColumnBanding,
    TdxWordProcessingMLValue.Create('band1Vert', 'band1Vert'));
  Result.Add(TdxConditionalTableStyleFormattingType.OddRowBanding,
    TdxWordProcessingMLValue.Create('band1Horz', 'band1Horz'));
  Result.Add(TdxConditionalTableStyleFormattingType.TopLeftCell,
    TdxWordProcessingMLValue.Create('nwCell', 'nwCell'));
  Result.Add(TdxConditionalTableStyleFormattingType.TopRightCell,
    TdxWordProcessingMLValue.Create('neCell', 'neCell'));
  Result.Add(TdxConditionalTableStyleFormattingType.WholeTable,
    TdxWordProcessingMLValue.Create('wholeTable', 'wholeTable'));
end;
...
function CreateFloatingObjectCssRelativeFromHorizontalTable
  : TdxMLDictionary<TdxFloatingObjectRelativeFromHorizontal>;
begin
  ...
  Result.AddValue(TdxFloatingObjectRelativeFromHorizontal.LeftMargin,
    'left-margin-area');
  Result.AddValue(TdxFloatingObjectRelativeFromHorizontal.RightMargin,
    'right-margin-area');
  Result.AddValue(TdxFloatingObjectRelativeFromHorizontal.OutsideMargin,
    'outer-margin-area');
  Result.AddValue(TdxFloatingObjectRelativeFromHorizontal.InsideMargin,
    'inner-margin-area');
end;

function CreateFloatingObjectCssRelativeFromVerticalTable
  : TdxMLDictionary<TdxFloatingObjectRelativeFromVertical>;
begin
  ...
  Result.AddValue(TdxFloatingObjectRelativeFromVertical.TopMargin,
    'top-margin-area');
  Result.AddValue(TdxFloatingObjectRelativeFromVertical.BottomMargin,
    'bottom-margin-area');
  Result.AddValue(TdxFloatingObjectRelativeFromVertical.OutsideMargin,
    'outer-margin-area');
  Result.AddValue(TdxFloatingObjectRelativeFromVertical.InsideMargin,
    'inner-margin-area');
end;

function CreateFloatingObjectHorizontalPositionAlignmentTable
  : TdxMLDictionary<TdxFloatingObjectHorizontalPositionAlignment>;
begin
  Result := TdxMLDictionary<
    TdxFloatingObjectHorizontalPositionAlignment>.Create;
  Result.AddValue(TdxFloatingObjectHorizontalPositionAlignment.Left, 'left');
  Result.AddValue(TdxFloatingObjectHorizontalPositionAlignment.Center,
    'center');
  Result.AddValue(TdxFloatingObjectHorizontalPositionAlignment.Right, 'right');
  Result.AddValue(TdxFloatingObjectHorizontalPositionAlignment.Inside,
    'inside');
  Result.AddValue(TdxFloatingObjectHorizontalPositionAlignment.Outside,
    'outside');
end;

function CreateFloatingObjectHorizontalPositionTypeTable
  : TdxMLDictionary<TdxFloatingObjectHorizontalPositionType>;
begin
  Result := TdxMLDictionary<TdxFloatingObjectHorizontalPositionType>.Create;
  Result.Add(TdxFloatingObjectHorizontalPositionType.Column,
    TdxWordProcessingMLValue.Create('column', 'text'));
  ...
  Result.Add(TdxFloatingObjectHorizontalPositionType.Character,
    TdxWordProcessingMLValue.Create('character', 'char'));
  Result.Add(TdxFloatingObjectHorizontalPositionType.LeftMargin,
    TdxWordProcessingMLValue.Create('leftMargin', 'page'));
  Result.Add(TdxFloatingObjectHorizontalPositionType.RightMargin,
    TdxWordProcessingMLValue.Create('rightMargin', 'page'));
  Result.Add(TdxFloatingObjectHorizontalPositionType.InsideMargin,
    TdxWordProcessingMLValue.Create('insideMargin', 'page'));
  Result.Add(TdxFloatingObjectHorizontalPositionType.OutsideMargin,
    TdxWordProcessingMLValue.Create('outsideMargin', 'page'));
end;

function CreateFloatingObjectRelativeFromHorizontalTable
  : TdxMLDictionary<TdxFloatingObjectRelativeFromHorizontal>;
begin
  Result := TdxMLDictionary<TdxFloatingObjectRelativeFromHorizontal>.Create;
  Result.AddValue(TdxFloatingObjectRelativeFromHorizontal.Margin, 'margin');
...
function CreateFloatingObjectRelativeFromVerticalTable
  : TdxMLDictionary<TdxFloatingObjectRelativeFromVertical>;
begin
  Result := TdxMLDictionary<TdxFloatingObjectRelativeFromVertical>.Create;
  Result.AddValue(TdxFloatingObjectRelativeFromVertical.Margin, 'margin');
...
function CreateFloatingObjectTextWrapSideTable
  : TdxMLDictionary<TdxFloatingObjectTextWrapSide>;
begin
  Result := TdxMLDictionary<TdxFloatingObjectTextWrapSide>.Create;
  Result.Add(TdxFloatingObjectTextWrapSide.Both,
    TdxWordProcessingMLValue.Create('bothSides', 'both-sides'));
...
function CreateFloatingObjectTextWrapTypeTable
  : TdxMLDictionary<TdxFloatingObjectTextWrapType>;
begin
  Result := TdxMLDictionary<TdxFloatingObjectTextWrapType>.Create;
  Result.Add(TdxFloatingObjectTextWrapType.TopAndBottom,
    TdxWordProcessingMLValue.Create('wrapTopAndBottom', 'topAndBottom'));
  Result.Add(TdxFloatingObjectTextWrapType.Square,
    TdxWordProcessingMLValue.Create('wrapSquare', 'square'));
  Result.Add(TdxFloatingObjectTextWrapType.Through,
    TdxWordProcessingMLValue.Create('wrapThrough', 'through'));
  Result.Add(TdxFloatingObjectTextWrapType.Tight,
    TdxWordProcessingMLValue.Create('wrapTight', 'tight'));
  Result.Add(TdxFloatingObjectTextWrapType.None,
    TdxWordProcessingMLValue.Create('wrapNone', 'none'));
end;

function CreateFloatingObjectVerticalPositionAlignmentTable
  : TdxMLDictionary<TdxFloatingObjectVerticalPositionAlignment>;
begin
  ...
  Result.AddValue(TdxFloatingObjectVerticalPositionAlignment.Outside,
    'outside');
end;

function CreateFloatingObjectVerticalPositionTypeTable
  : TdxMLDictionary<TdxFloatingObjectVerticalPositionType>;
begin
  ...
  Result.Add(TdxFloatingObjectVerticalPositionType.Page,
    TdxWordProcessingMLValue.Create('page', 'margin'));
  Result.AddValue(TdxFloatingObjectVerticalPositionType.Line, 'line');
  Result.Add(TdxFloatingObjectVerticalPositionType.Paragraph,
    TdxWordProcessingMLValue.Create('paragraph', 'text'));
  Result.Add(TdxFloatingObjectVerticalPositionType.TopMargin,
    TdxWordProcessingMLValue.Create('topMargin', 'page'));
  Result.Add(TdxFloatingObjectVerticalPositionType.BottomMargin,
    TdxWordProcessingMLValue.Create('bottomMargin', 'page'));
  Result.Add(TdxFloatingObjectVerticalPositionType.InsideMargin,
    TdxWordProcessingMLValue.Create('insideMargin', 'page'));
  Result.Add(TdxFloatingObjectVerticalPositionType.OutsideMargin,
    TdxWordProcessingMLValue.Create('outsideMargin', 'page'));
end;
...
function CreateHorizontalAlignModeTable
  : TdxMLDictionary<TdxHorizontalAlignMode>;
begin
...
function CreateHorizontalAnchorTypesTable
  : TdxMLDictionary<TdxHorizontalAnchorTypes>;
begin
...
function CreateLineNumberingRestartTable
  : TdxMLDictionary<TdxLineNumberingRestart>;
begin
...
function CreateListNumberAlignmentTable
  : TdxMLDictionary<TdxListNumberAlignment>;
begin
...
function CreateListNumberSeparatorTable
  : TDictionary<Char, TdxWordProcessingMLValue>;
begin
  Result := TDictionary<Char, TdxWordProcessingMLValue>.Create;
...
begin
  ...
  Result.Add(TdxNumberingType.Bullet,
    TdxWordProcessingMLValue.Create('hybridMultilevel', 'HybridMultilevel'));
  Result.Add(TdxNumberingType.Simple,
    TdxWordProcessingMLValue.Create('hybridMultilevel', 'HybridMultilevel'));
  Result.Add(TdxNumberingType.MultiLevel,
    TdxWordProcessingMLValue.Create('multilevel', 'Multilevel'));
end;
...
begin
  ...
  Result.AddValue(TdxNumberingFormat.ChineseCountingThousand,
    'chineseCountingThousand');
  Result.AddValue(TdxNumberingFormat.ChineseLegalSimplified,
    'chineseLegalSimplified');
  Result.AddValue(TdxNumberingFormat.Chosung, 'chosung');
  Result.AddValue(TdxNumberingFormat.DecimalEnclosedCircle,
    'decimalEnclosedCircle');
  Result.AddValue(TdxNumberingFormat.DecimalEnclosedCircleChinese,
    'decimalEnclosedCircleChinese');
  Result.AddValue(TdxNumberingFormat.DecimalEnclosedFullstop,
    'decimalEnclosedFullstop');
  Result.AddValue(TdxNumberingFormat.DecimalEnclosedParentheses,
  ...
  Result.AddValue(TdxNumberingFormat.IdeographEnclosedCircle,
    'ideographEnclosedCircle');
  Result.AddValue(TdxNumberingFormat.IdeographLegalTraditional,
    'ideographLegalTraditional');
  Result.AddValue(TdxNumberingFormat.IdeographTraditional,
    'ideographTraditional');
  Result.AddValue(TdxNumberingFormat.IdeographZodiac, 'ideographZodiac');
  Result.AddValue(TdxNumberingFormat.IdeographZodiacTraditional,
  ...
  Result.AddValue(TdxNumberingFormat.JapaneseDigitalTenThousand,
  ...
  Result.AddValue(TdxNumberingFormat.TaiwaneseCountingThousand,
  ...
  Result.AddValue(TdxNumberingFormat.VietnameseDescriptive,
    'vietnameseCounting');
end;
...
function CreateParagraphLineSpacingTable
  : TdxMLDictionary<TdxParagraphLineSpacing>;
begin
...
function CreatePredefinedBackgroundColors
  : TDictionary<TdxAlphaColor, TdxWordProcessingMLValue>;
begin
  ...
  Result.Add(TdxAlphaColors.FromArgb($00, $00, $FF),
    TdxWordProcessingMLValue.Create('blue'));
  Result.Add(TdxAlphaColors.FromArgb($00, $FF, $FF),
    TdxWordProcessingMLValue.Create('cyan'));
  Result.Add(TdxAlphaColors.FromArgb($00, $00, $80),
    TdxWordProcessingMLValue.Create('darkBlue'));
  Result.Add(TdxAlphaColors.FromArgb($00, $80, $80),
    TdxWordProcessingMLValue.Create('darkCyan'));
  Result.Add(TdxAlphaColors.FromArgb($80, $80, $80),
    TdxWordProcessingMLValue.Create('darkGray'));
  Result.Add(TdxAlphaColors.FromArgb($00, $80, $00),
    TdxWordProcessingMLValue.Create('darkGreen'));
  Result.Add(TdxAlphaColors.FromArgb($80, $00, $80),
    TdxWordProcessingMLValue.Create('darkMagenta'));
  Result.Add(TdxAlphaColors.FromArgb($80, $00, $00),
    TdxWordProcessingMLValue.Create('darkRed'));
  Result.Add(TdxAlphaColors.FromArgb($80, $80, $00),
    TdxWordProcessingMLValue.Create('darkYellow'));
  Result.Add(TdxAlphaColors.FromArgb($00, $FF, $00),
    TdxWordProcessingMLValue.Create('green'));
  Result.Add(TdxAlphaColors.FromArgb($C0, $C0, $C0),
    TdxWordProcessingMLValue.Create('lightGray'));
  Result.Add(TdxAlphaColors.FromArgb($FF, $00, $FF),
    TdxWordProcessingMLValue.Create('magenta'));
  Result.Add(TdxAlphaColors.FromArgb($FF, $00, $00),
    TdxWordProcessingMLValue.Create('red'));
  Result.Add(TdxAlphaColors.FromArgb($FF, $FF, $FF),
    TdxWordProcessingMLValue.Create('white'));
  Result.Add(TdxAlphaColors.FromArgb($FF, $FF, $00),
    TdxWordProcessingMLValue.Create('yellow'));
end;
...
begin
  ...
  Result.AddValue(TdxShadingPattern.ThinReverseDiagStripe,
...
function CreateTextBoxVerticalAlignmentTable
  : TdxMLDictionary<TdxVerticalAlignment>;
begin
  Result := TdxMLDictionary<TdxVerticalAlignment>.Create;
  Result.Add(TdxVerticalAlignment.Top,
    TdxWordProcessingMLValue.Create('t', 'top'));
  Result.Add(TdxVerticalAlignment.Center, TdxWordProcessingMLValue.Create('ctr',
    'middle'));
  Result.Add(TdxVerticalAlignment.Both,
    TdxWordProcessingMLValue.Create('just'));
  Result.Add(TdxVerticalAlignment.Bottom, TdxWordProcessingMLValue.Create('b',
    'bottom'));
end;
...
function CreateVerticalAnchorTypesTable
  : TdxMLDictionary<TdxVerticalAnchorTypes>;
begin
...
begin
  ...
  FConditionalTableStyleFormattingTypesTable :=
    CreateConditionalTableStyleFormattingTypesTable;
  FContentTypeTable := CreateContentTypeTable;
  FFloatingObjectCssRelativeFromHorizontalTable :=
    CreateFloatingObjectCssRelativeFromHorizontalTable;
  FFloatingObjectCssRelativeFromVerticalTable :=
    CreateFloatingObjectCssRelativeFromVerticalTable;
  FFloatingObjectHorizontalPositionAlignmentTable :=
    CreateFloatingObjectHorizontalPositionAlignmentTable;
  FFloatingObjectHorizontalPositionTypeTable :=
    CreateFloatingObjectHorizontalPositionTypeTable;
  FFloatingObjectRelativeFromHorizontalTable :=
    CreateFloatingObjectRelativeFromHorizontalTable;
  FFloatingObjectRelativeFromVerticalTable :=
    CreateFloatingObjectRelativeFromVerticalTable;
  ...
  FFloatingObjectVerticalPositionAlignmentTable :=
    CreateFloatingObjectVerticalPositionAlignmentTable;
  FFloatingObjectVerticalPositionTypeTable :=
    CreateFloatingObjectVerticalPositionTypeTable;
...
function TdxWordProcessingMLBaseExporter.GetUnitConverter
...
procedure TdxWordProcessingMLBaseExporter.WriteWpBoolValue(const ATag: string;
  AValue: Boolean);
begin
  WriteWpStringValue(ATag, ConvertBoolToString(AValue));
end;

procedure TdxWordProcessingMLBaseExporter.WriteWpBoolValueAsTag
  (const ATag: string; AValue: Boolean);
begin
  if AValue then
  begin
...
procedure TdxWordProcessingMLBaseExporter.WriteBoolValue(const ATag: string;
  AValue: Boolean);
begin
  WriteStringAttr('', ATag, '', ConvertBoolToString(AValue));
end;

procedure TdxWordProcessingMLBaseExporter.WriteWpIntValue(const ATag: string;
  AValue: Integer);
begin
  WriteWpStringValue(ATag, IntToStr(AValue));
end;

procedure TdxWordProcessingMLBaseExporter.WriteIntValue(const ATag: string;
  AValue: Integer);
begin
  WriteStringAttr('', ATag, '', IntToStr(AValue));
end;

procedure TdxWordProcessingMLBaseExporter.WriteWpStringValue(const ATag: string;
  const AValue: string);
begin
  WriteStringValue(WordProcessingPrefix, ATag, AValue);
end;

procedure TdxWordProcessingMLBaseExporter.WriteStringValue(const ATag: string;
  const AValue: string);
begin
  WriteStringAttr('', ATag, '', AValue);
end;

procedure TdxWordProcessingMLBaseExporter.WriteWpBoolAttr(const AAttr: string;
  AValue: Boolean);
begin
  WriteWpStringAttr(AAttr, ConvertBoolToString(AValue));
end;

procedure TdxWordProcessingMLBaseExporter.WriteWpIntAttr(const AAttr: string;
  AValue: Integer);
begin
  WriteWpStringAttr(AAttr, IntToStr(AValue));
end;

procedure TdxWordProcessingMLBaseExporter.WriteWpStringAttr(const AAttr: string;
  const AValue: string);
begin
  FDocumentContentWriter.WriteAttributeString(WordProcessingPrefix, AAttr,
    WordProcessingNamespace, AValue);
end;

procedure TdxWordProcessingMLBaseExporter.WriteStringAttr(const APrefix: string;
  const AAttr: string; const ANs: string; const AValue: string);
begin
  FDocumentContentWriter.WriteAttributeString(APrefix, AAttr, ANs, AValue);
end;

procedure TdxWordProcessingMLBaseExporter.WriteWpStartElement
  (const ATag: string);
begin
  FDocumentContentWriter.WriteStartElement(WordProcessingPrefix, ATag,
...
procedure TdxWordProcessingMLBaseExporter.WriteStringValue
  (const APrefix: string; const ATag: string; const AValue: string);
begin
  FDocumentContentWriter.WriteStartElement(APrefix, ATag,
    WordProcessingNamespace);
  try
    FDocumentContentWriter.WriteAttributeString(APrefix, 'val',
      WordProcessingNamespace, AValue);
  finally
    FDocumentContentWriter.WriteEndElement;
  end;
...
procedure TdxWordProcessingMLBaseExporter.WriteWpEmptyElement
  (const ATag: string);
begin
  WriteWpStartElement(ATag);
  WriteWpEndElement;
...
procedure TdxWordProcessingMLBaseExporter.WriteWpEmptyOrFalseValue
  (const ATag: string; AValue: Boolean);
begin
  if AValue then
...
function TdxWordProcessingMLBaseExporter.ShouldPreserveSpace
  (const AText: string): Boolean;
begin
  Result := (Length(AText) > 0) and
    ((AText[1] = ' ') or (AText[Length(AText)] = ' ') or
    (Pos('  ', AText) > 0));
end;

function TdxWordProcessingMLBaseExporter.ShouldExportRunProperties
  (ARun: TdxTextRunBase): Boolean;
var
  ACharacterProperties: TdxCharacterProperties;
begin
  ACharacterProperties := ARun.CharacterProperties;
  Result := ACharacterProperties.UseFontName or
    ACharacterProperties.UseDoubleFontSize or
    ACharacterProperties.UseFontBold or ACharacterProperties.UseFontItalic or
    ACharacterProperties.UseFontUnderlineType or
    (ACharacterProperties.UseUnderlineColor and
    not TdxAlphaColors.IsTransparentOrEmpty(ACharacterProperties.UnderlineColor)
    ) or ACharacterProperties.UseUnderlineWordsOnly or
    ACharacterProperties.UseFontStrikeoutType or
    ACharacterProperties.UseAllCaps or ACharacterProperties.UseForeColor or
    ACharacterProperties.UseScript or ACharacterProperties.UseBackColor or
    ACharacterProperties.UseHidden or ACharacterProperties.UseNoProof or
    (ARun.CharacterStyleIndex > 0);
end;

procedure TdxWordProcessingMLBaseExporter.ExportTextRunCore(ARun: TdxTextRun;
  const ARunText: string);
var
...
begin
  ...
  DocumentContentWriter.WriteStartElement(WordProcessingPrefix, 'br',
    WordProcessingNamespace);
  try
    DocumentContentWriter.WriteAttributeString(WordProcessingPrefix, 'type',
      WordProcessingNamespace, AValue);
  finally
...
procedure TdxWordProcessingMLBaseExporter.ExportTextCore(const ARunText
  : string);
var
  AText: string;
begin
  ...
  try
    if ShouldPreserveSpace(AText) then
      FDocumentContentWriter.WriteAttributeString('xml', 'space', '',
        'preserve');
...
procedure TdxWordProcessingMLBaseExporter.ExportRunProperties
  (ARun: TdxTextRunBase);
begin
  ...
  try
    if ARun.CharacterStyleIndex > 0 then
      WriteWpStringValue('rStyle',
        GetCharacterStyleId(ARun.CharacterStyleIndex));
...
procedure TdxWordProcessingMLBaseExporter.ExportRunPropertiesCore
  (ACharacterProperties: TdxCharacterProperties);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportRunFontName(ACharacterProperties
  : TdxCharacterProperties);
var
  AFontName: string;
begin
...
function TdxWordProcessingMLBaseExporter.PrepareFontName
  (const AName: string): string;
begin
  Result := AName;
end;

procedure TdxWordProcessingMLBaseExporter.ExportRunFontBold(ACharacterProperties
  : TdxCharacterProperties);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportRunFontItalic
  (ACharacterProperties: TdxCharacterProperties);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportRunAllCaps(ACharacterProperties
  : TdxCharacterProperties);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportRunHidden(ACharacterProperties
  : TdxCharacterProperties);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportRunForeColor
  (ACharacterProperties: TdxCharacterProperties);
var
...
procedure TdxWordProcessingMLBaseExporter.ExportDoubleFontSize
  (ACharacterProperties: TdxCharacterProperties);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportRunFontUnderline
  (ACharacterProperties: TdxCharacterProperties);
begin
  if (not ACharacterProperties.UseFontUnderlineType and
    (not ACharacterProperties.UseUnderlineColor or
    (TdxAlphaColors.IsTransparentOrEmpty(ACharacterProperties.UnderlineColor))))
    and not ACharacterProperties.UseUnderlineWordsOnly then
    Exit;

  WriteWpStartElement('u');
  try
    if ACharacterProperties.UseUnderlineWordsOnly and
      ACharacterProperties.UnderlineWordsOnly and
      ACharacterProperties.UseFontUnderlineType and
      (ACharacterProperties.FontUnderlineType = TdxUnderlineType.Single) then
      WriteWpStringAttr('val', 'words')
    else if ACharacterProperties.UseFontUnderlineType then
      WriteWpStringAttr('val',
        ConvertUnderlineType(ACharacterProperties.FontUnderlineType));

    if ACharacterProperties.UseUnderlineColor and
      not TdxAlphaColors.IsTransparentOrEmpty
      (ACharacterProperties.UnderlineColor) then
      WriteWpStringAttr('color',
        ConvertColorToString(ACharacterProperties.UnderlineColor));
  finally
    WriteWpEndElement;
  end;
end;

procedure TdxWordProcessingMLBaseExporter.ExportRunFontStrikeout
  (ACharacterProperties: TdxCharacterProperties);
begin
  ...
  else if ACharacterProperties.FontStrikeoutType = TdxStrikeoutType.None then
    WriteWpBoolValue('strike', False)
  else
    WriteWpBoolValue('strike', True);
end;

procedure TdxWordProcessingMLBaseExporter.ExportRunFontScript
  (ACharacterProperties: TdxCharacterProperties);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportRunLangInfo(ACharacterProperties
  : TdxCharacterProperties);
begin
end;

procedure TdxWordProcessingMLBaseExporter.ExportRunNoProof(ACharacterProperties
  : TdxCharacterProperties);
begin
...
function TdxWordProcessingMLBaseExporter.ExportParagraph
...
procedure TdxWordProcessingMLBaseExporter.ExportParagraphProperties
...
begin
  ...
  try
    ...
    if ShouldExportParagraphNumbering(AParagraph.GetOwnNumberingListIndex) and
      AParagraph.ShouldExportNumbering then
      AParagraphNumberingExporter :=
      procedure()begin ExportParagraphListReference(AParagraph);
  end;
...
function TdxWordProcessingMLBaseExporter.ShouldExportParagraphNumbering
  (ANumberingListIndex: TdxNumberingListIndex): Boolean;
begin
  Result := (ANumberingListIndex = NumberingListIndexNoNumberingList) or
    (ANumberingListIndex >= NumberingListIndexMinValue);
end;

procedure TdxWordProcessingMLBaseExporter.ExportParagraphPropertiesCore
  (AParagraph: TdxParagraph; const AParagraphNumberingExporter: TdxAction);
var
  AFrameExporter, ATabsExporter: TdxAction;
  AWebSettings: TdxWebSettings;
begin
  if AParagraph.ParagraphStyleIndex > 0 then
    WriteWpStringValue('pStyle',
      GetParagraphStyleId(AParagraph.ParagraphStyleIndex));
  AFrameExporter := nil;
  if AParagraph.FrameProperties <> nil then
    AFrameExporter :=
    procedure()begin ExportParagraphFrame(AParagraph.FrameProperties);
end;
ATabsExporter := procedure()
  var
...
ExportParagraphPropertiesCore(AParagraph.ParagraphProperties, False,
  AFrameExporter, AParagraphNumberingExporter, ATabsExporter);
...
procedure TdxWordProcessingMLBaseExporter.ExportParagraphPropertiesCore
  (AProperties: TdxParagraphProperties; ADefaultParagraphProperties: Boolean;
  const AFramePropertiesExporter, AParagraphNumberingExporter,
  ATabsExporter: TdxAction);
begin
  ...
  if AProperties.UseSuppressLineNumbers then
    WriteWpBoolValue(GetWordProcessingMLValue(TdxWordProcessingMLValue.Create
      ('suppressLineNumbers', 'supressLineNumbers')),
      AProperties.SuppressLineNumbers);
  if (AProperties.UseLeftBorder) or (AProperties.UseRightBorder) or
    (AProperties.UseTopBorder) or (AProperties.UseBottomBorder) then
  ...
  if (AProperties.UseSpacingBefore) or (AProperties.UseSpacingAfter) or
    (AProperties.UseLineSpacingType) or (AProperties.UseLineSpacing) or
    (AProperties.UseBeforeAutoSpacing) or (AProperties.UseAfterAutoSpacing) then
    ExportParagraphSpacing(AProperties);
  if (AProperties.UseFirstLineIndentType) or (AProperties.UseFirstLineIndent) or
    (AProperties.UseLeftIndent) or (AProperties.UseRightIndent) then
...
function TdxWordProcessingMLBaseExporter.GetNumberingListIndexForExport
  (ANumberingListIndex: TdxNumberingListIndex): Integer;
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportTabProperties
  (ATabs: TdxTabFormattingInfo);
var
  ACount, I: Integer;
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportParagraphFrame
...
begin
  ...
  try
    ...
    if AProperties.UseHorizontalRule then
      WriteWpStringAttr(GetWordProcessingMLValue('hRule'),
        ConvertHorizontalRule(AProperties.HorizontalRule));
    if AProperties.UseTextWrapType then
      WriteWpStringAttr(GetWordProcessingMLValue('wrap'),
        ConvertWrapType(AProperties.TextWrapType));

    if AProperties.UseVerticalPositionType then
      WriteWpStringAttr(GetWordProcessingMLValue('vAnchor'),
        ConvertVerticalPositionType(AProperties.VerticalPositionType));
    if AProperties.UseHorizontalPositionType then
      WriteWpStringAttr(GetWordProcessingMLValue('hAnchor'),
        ConvertHorizontalPositionType(AProperties.HorizontalPositionType));

    if AProperties.UseX then
      WriteWpIntAttr('x', UnitConverter.ModelUnitsToTwips(AProperties.X));
    if AProperties.HorizontalPositionAlignment <>
      TdxParagraphFrameHorizontalPositionAlignment.None then
      WriteWpStringAttr(GetWordProcessingMLValue('xAlign'),
        ConvertHorizontalPositionAlignment
    ...
    if AProperties.VerticalPositionAlignment <>
      TdxParagraphFrameVerticalPositionAlignment.None then
      WriteWpStringAttr(GetWordProcessingMLValue('yAlign'),
        ConvertVerticalPositionAlignment
...
function TdxWordProcessingMLBaseExporter.ConvertHorizontalRule(AHorizontalRule
  : TdxParagraphFrameHorizontalRule): string;
begin
...
function TdxWordProcessingMLBaseExporter.ConvertWrapType
  (AWrapType: TdxFloatingObjectTextWrapType): string;
begin
  case AWrapType of
...
function TdxWordProcessingMLBaseExporter.ConvertVerticalPositionType
  (AVerticalPositionType: TdxFloatingObjectVerticalPositionType): string;
begin
...
function TdxWordProcessingMLBaseExporter.ConvertHorizontalPositionType
  (AHorizontalPositionType: TdxFloatingObjectHorizontalPositionType): string;
begin
...
function TdxWordProcessingMLBaseExporter.ConvertHorizontalPositionAlignment
  (AHorizontalPositionAlignment
  : TdxFloatingObjectHorizontalPositionAlignment): string;
begin
...
function TdxWordProcessingMLBaseExporter.ConvertVerticalPositionAlignment
...
function TdxWordProcessingMLBaseExporter.ConvertWrapType
  (AWrapType: TdxParagraphFrameTextWrapType): string;
begin
  case AWrapType of
...
function TdxWordProcessingMLBaseExporter.ConvertVerticalPositionType
  (AVerticalPositionType: TdxParagraphFrameVerticalPositionType): string;
begin
  case AVerticalPositionType of
...
function TdxWordProcessingMLBaseExporter.ConvertHorizontalPositionType
  (AHorizontalPositionType: TdxParagraphFrameHorizontalPositionType): string;
begin
  case AHorizontalPositionType of
...
function TdxWordProcessingMLBaseExporter.ConvertVerticalPositionAlignment
  (AVerticalPositionAlignment
  : TdxParagraphFrameVerticalPositionAlignment): string;
begin
  case AVerticalPositionAlignment of
...
procedure TdxWordProcessingMLBaseExporter.ExportParagraphSpacing
  (AProperties: TdxParagraphProperties);
begin
  WriteWpStartElement('spacing');
  try
    if AProperties.UseLineSpacingType then
      WriteWpStringAttr(GetWordProcessingMLValue('lineRule'),
        ConvertLineSpacing(AProperties.LineSpacingType));
    if (AProperties.UseLineSpacing) or (AProperties.UseLineSpacingType) then
      WriteWpIntAttr('line',
        ConvertLineSpacingValue(AProperties.LineSpacingType,
        AProperties.LineSpacing));
    if AProperties.UseSpacingBefore then
      WriteWpIntAttr('before', UnitConverter.ModelUnitsToTwips
        (AProperties.SpacingBefore));
    if AProperties.UseSpacingAfter then
      WriteWpIntAttr('after', UnitConverter.ModelUnitsToTwips
        (AProperties.SpacingAfter));
    if AProperties.UseBeforeAutoSpacing then
      WriteWpBoolAttr(GetWordProcessingMLValue(TdxWordProcessingMLValue.Create
        ('beforeAutospacing', 'before-autospacing')),
        AProperties.BeforeAutoSpacing);
    if AProperties.UseAfterAutoSpacing then
      WriteWpBoolAttr(GetWordProcessingMLValue(TdxWordProcessingMLValue.Create
        ('afterAutospacing', 'after-autospacing')),
        AProperties.AfterAutoSpacing);
  finally
    WriteWpEndElement;
  end;
end;

procedure TdxWordProcessingMLBaseExporter.ExportParagraphOutlineLevel
  (AProperties: TdxParagraphProperties);
var
  ALevel: Integer;
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportParagraphBackground
  (ABackground: TdxAlphaColor);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportParagraphIndentation
  (AProperties: TdxParagraphProperties);
begin
  ...
  try
    ...
    begin
      case AProperties.FirstLineIndentType of
        TdxParagraphFirstLineIndent.Hanging:
          begin
            WriteWpIntAttr('hanging',
              UnitConverter.ModelUnitsToTwips(AProperties.FirstLineIndent));
            if AProperties.UseLeftIndent then
              WriteWpIntAttr('left',
                UnitConverter.ModelUnitsToTwips(AProperties.LeftIndent));
          end;
        TdxParagraphFirstLineIndent.Indented:
          begin
            WriteWpIntAttr(GetWordProcessingMLValue('firstLine'),
              UnitConverter.ModelUnitsToTwips(AProperties.FirstLineIndent));
            if AProperties.UseLeftIndent then
              WriteWpIntAttr('left',
                UnitConverter.ModelUnitsToTwips(AProperties.LeftIndent));
    ...
    else if AProperties.UseLeftIndent then
      WriteWpIntAttr('left', UnitConverter.ModelUnitsToTwips
        (AProperties.LeftIndent));
    if AProperties.UseRightIndent then
      WriteWpIntAttr('right', UnitConverter.ModelUnitsToTwips
        (AProperties.RightIndent));
  finally
    WriteWpEndElement;
  end;
end;

procedure TdxWordProcessingMLBaseExporter.ExportParagraphBorders
  (AProperties: TdxParagraphProperties; ADefaultParagraphProperties: Boolean);
var
  AShouldExportBottomBorder, AShouldExportLeftBorder, AShouldExportRightBorder,
    AShouldExportTopBorder, AShouldExportBorder: Boolean;
begin

  AShouldExportBottomBorder := AProperties.UseBottomBorder and
    ShouldExportParagraphBorder(ADefaultParagraphProperties,
    AProperties.BottomBorder);
  AShouldExportLeftBorder := AProperties.UseLeftBorder and
    ShouldExportParagraphBorder(ADefaultParagraphProperties,
    AProperties.LeftBorder);
  AShouldExportRightBorder := AProperties.UseRightBorder and
    ShouldExportParagraphBorder(ADefaultParagraphProperties,
    AProperties.RightBorder);
  AShouldExportTopBorder := AProperties.UseTopBorder and
    ShouldExportParagraphBorder(ADefaultParagraphProperties,
    AProperties.TopBorder);
  AShouldExportBorder := (AShouldExportBottomBorder) or
    (AShouldExportLeftBorder) or (AShouldExportRightBorder) or
    (AShouldExportTopBorder);
...
function TdxWordProcessingMLBaseExporter.ShouldExportParagraphBorder
  (ADefaultParagraphProperties: Boolean; ABorderInfo: TdxBorderInfo): Boolean;
begin
  if ADefaultParagraphProperties then
    Result := (ABorderInfo.Style <> TdxBorderLineStyle.None) or
      (ABorderInfo.Width <> 0)
  else
    Result := True;
end;

procedure TdxWordProcessingMLBaseExporter.ExportParagraphBorder
  (const ATag: string; ABorder: TdxBorderInfo);
begin
  WriteWpStartElement(ATag);
  try
    WriteWpStringAttr('val', ConvertBorderLineStyle(ABorder.Style));
    WriteWpIntAttr('sz',
      Trunc(UnitConverter.ModelUnitsToPointsF(ABorder.Width * 8.0)));
    WriteWpIntAttr('space',
      Trunc(UnitConverter.ModelUnitsToPointsF(ABorder.Offset)));
...
function TdxWordProcessingMLBaseExporter.ConvertLineSpacingValue
  (ALineSpacing: TdxParagraphLineSpacing; AValue: Single): Integer;
begin
  if (ALineSpacing = TdxParagraphLineSpacing.AtLeast) or
    (ALineSpacing = TdxParagraphLineSpacing.Exactly) then
    Result := Round(UnitConverter.ModelUnitsToTwipsF(AValue))
  else
  begin
    if ALineSpacing = TdxParagraphLineSpacing.Single then
      AValue := 1
    else if ALineSpacing = TdxParagraphLineSpacing.Double then
      AValue := 2
    else if ALineSpacing = TdxParagraphLineSpacing.Sesquialteral then
      AValue := 1.5;
    Result := Round(AValue * 240);
  end;
end;

function TdxWordProcessingMLBaseExporter.ConvertTabAlignment
  (AAlignment: TdxTabAlignmentType): string;
var
...
function TdxWordProcessingMLBaseExporter.ConvertTabLeader
  (ALeaderType: TdxTabLeaderType): string;
var
  AResult: TdxWordProcessingMLValue;
begin
...
function TdxWordProcessingMLBaseExporter.ConvertAlignment
  (AAlignment: TdxParagraphAlignment): string;
var
  AResult: TdxWordProcessingMLValue;
begin
...
function TdxWordProcessingMLBaseExporter.ConvertLineSpacing
  (ALineSpacing: TdxParagraphLineSpacing): string;
var
  AResult: TdxWordProcessingMLValue;
begin
...
function TdxWordProcessingMLBaseExporter.ConvertTextDirection
  (AValue: TdxTextDirection): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FTextDirectionTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue
      (FTextDirectionTable[TdxTextDirection.LeftToRightTopToBottom]);
end;

function TdxWordProcessingMLBaseExporter.ConvertShadingPattern
  (AValue: TdxShadingPattern): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FShadingPatternTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue
      (FShadingPatternTable[TdxShadingPattern.Clear]);
end;

function TdxWordProcessingMLBaseExporter.ConvertVerticalAlignment
  (AValue: TdxVerticalAlignment): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FVerticalAlignmentTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue
      (FVerticalAlignmentTable[TdxVerticalAlignment.Top]);
end;

function TdxWordProcessingMLBaseExporter.ConvertWidthUnitTypes
  (AValue: TdxWidthUnitType): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FWidthUnitTypesTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue
      (FWidthUnitTypesTable[TdxWidthUnitType.ModelUnits]);
end;

function TdxWordProcessingMLBaseExporter.ConvertTableLayoutType
  (AValue: TdxTableLayoutType): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FTableLayoutTypeTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue
      (FTableLayoutTypeTable[TdxTableLayoutType.Autofit]);
end;

function TdxWordProcessingMLBaseExporter.ConvertBorderLineStyle
  (AValue: TdxBorderLineStyle): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FBorderLineStyleTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue
      (FBorderLineStyleTable[TdxBorderLineStyle.None]);
end;

function TdxWordProcessingMLBaseExporter.ConvertHorizontalAlignMode
  (AValue: TdxHorizontalAlignMode): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FHorizontalAlignModeTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue(FHorizontalAlignModeTable
      [TdxHorizontalAlignMode.Left]);
end;

function TdxWordProcessingMLBaseExporter.ConvertHorizontalAnchorTypes
  (AValue: TdxHorizontalAnchorTypes): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FHorizontalAnchorTypesTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue(FHorizontalAnchorTypesTable
      [TdxHorizontalAnchorTypes.Column]);
end;

function TdxWordProcessingMLBaseExporter.ConvertConditionalStyleType
  (AStyleType: TdxConditionalTableStyleFormattingType): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FConditionalTableStyleFormattingTypesTable.TryGetValue(AStyleType, AResult)
  then
    Result := GetWordProcessingMLValue(AResult)
  else
    Result := GetWordProcessingMLValue
...
function TdxWordProcessingMLBaseExporter.ConvertVerticalAlignMode
  (AValue: TdxVerticalAlignMode): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FVerticalAlignModeTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue
      (FVerticalAlignModeTable[TdxVerticalAlignMode.Bottom]);
end;

function TdxWordProcessingMLBaseExporter.ConvertVerticalAnchorTypes
  (AValue: TdxVerticalAnchorTypes): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FVerticalAnchorTypesTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue(FVerticalAnchorTypesTable
      [TdxVerticalAnchorTypes.Margin]);
end;

function TdxWordProcessingMLBaseExporter.ConvertHeightUnitType
  (AValue: TdxHeightUnitType): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FHeightUnitTypeTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue
      (FHeightUnitTypeTable[TdxHeightUnitType.Auto]);
end;

function TdxWordProcessingMLBaseExporter.ConvertMergingState
  (AValue: TdxMergingState): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FMergingStateTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue
      (FMergingStateTable[TdxMergingState.Restart]);
end;

function TdxWordProcessingMLBaseExporter.ConvertTableRowAlignment
  (AValue: TdxTableRowAlignment): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if AValue = TdxTableRowAlignment.Both then
    Exit(GetWordProcessingMLValue(FTableRowAlignmentTable
...
function TdxWordProcessingMLBaseExporter.ShouldExportParagraphProperties
...
begin
  ...
  Result := AProperties.UseAlignment or AProperties.UseFirstLineIndent or
    AProperties.UseFirstLineIndentType or AProperties.UseLeftIndent or
    AProperties.UseRightIndent or AProperties.UseLineSpacing or
    AProperties.UseLineSpacingType or AProperties.UseSpacingAfter or
    AProperties.UseSpacingBefore or AProperties.UseSuppressHyphenation or
    AProperties.UseSuppressLineNumbers or AProperties.UseContextualSpacing or
    AProperties.UsePageBreakBefore or AProperties.UseBeforeAutoSpacing or
    AProperties.UseAfterAutoSpacing or AProperties.UseKeepWithNext or
    AProperties.UseKeepLinesTogether or AProperties.UseWidowOrphanControl or
    AProperties.UseOutlineLevel or AProperties.UseBackColor or
    (AParagraph.ParagraphStyleIndex > 0) or ShouldExportRunProperties
    (PieceTable.Runs[AParagraph.LastRunIndex]) or AParagraph.IsInList or
...
function TdxWordProcessingMLBaseExporter.ShouldExportSectionProperties
  (AParagraph: TdxParagraph): Boolean;
begin
  Result := PieceTable.IsMain and
    (AParagraph.Index = CurrentSection.LastParagraphIndex) and
    (AParagraph.Index <> PieceTable.Paragraphs.Count - 1) and
    DocumentModel.DocumentCapabilities.SectionsAllowed;
end;

function TdxWordProcessingMLBaseExporter.ShouldExportTabProperties
  (ATabs: TdxTabFormattingInfo): Boolean;
var
...
procedure TdxWordProcessingMLBaseExporter.ExportSection(const ASection
  : TdxSection);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportSectionHeadersFooters
  (ASection: TdxSection);
begin
end;

procedure TdxWordProcessingMLBaseExporter.ExportSectionProperties
  (ASection: TdxSection);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportSectionPropertiesCore
  (ASection: TdxSection);
begin
  ExportSectionFootNote(ASection.FootNote);
  ExportSectionEndNote(ASection.EndNote);
  WriteWpStringValue('type',
    ConvertSectionStartType(ASection.GeneralSettings.StartType));
...
procedure TdxWordProcessingMLBaseExporter.ExportSectionGeneralSettings
...
begin
  ...
  then
    WriteWpStringValue('vAlign',
      ConvertVerticalAlignment(ASettings.VerticalTextAlignment));
  ...
  begin
    ...
    WriteWpStringValue(GetWordProcessingMLValue(ATag),
      ConvertTextDirection(ASettings.TextDirection));
  end;
...
function TdxWordProcessingMLBaseExporter.ShouldExportPaperSource
  (ASettings: TdxSectionGeneralSettings): Boolean;
var
  ADefaultSettings: TdxGeneralSectionInfo;
begin
  ADefaultSettings := DocumentModel.Cache.GeneralSectionInfoCache.DefaultItem;

  Result := (ASettings.FirstPagePaperSource <>
    ADefaultSettings.FirstPagePaperSource) or
    (ASettings.OtherPagePaperSource <> ADefaultSettings.OtherPagePaperSource);
end;

procedure TdxWordProcessingMLBaseExporter.ExportSectionPage
...
function TdxWordProcessingMLBaseExporter.ShouldExportSectionPage
  (APage: TdxSectionPage): Boolean;
var
  ADefaultPage: TdxPageInfo;
begin
  ADefaultPage := DocumentModel.Cache.PageInfoCache.DefaultItem;
  Result := (APage.Width <> ADefaultPage.Width) or
    (APage.Height <> ADefaultPage.Height) or
    (APage.PaperKind <> ADefaultPage.PaperKind) or (APage.Landscape);
end;

procedure TdxWordProcessingMLBaseExporter.ExportSectionMargins
...
begin
  ...
  try
    ...
    WriteWpIntAttr('header', UnitConverter.ModelUnitsToTwips
      (AMargins.HeaderOffset));
    WriteWpIntAttr('footer', UnitConverter.ModelUnitsToTwips
      (AMargins.FooterOffset));
...
function TdxWordProcessingMLBaseExporter.ShouldExportSectionMargins
  (AMargins: TdxSectionMargins): Boolean;
var
  ADefaultMargins: TdxMarginsInfo;
begin
  ADefaultMargins := DocumentModel.Cache.MarginsInfoCache.DefaultItem;
  Result := (AMargins.Left <> ADefaultMargins.Left) or
...
procedure TdxWordProcessingMLBaseExporter.ExportSectionColumns
  (AColumns: TdxSectionColumns);
begin
  if not TdxDocumentFormatsHelper.ShouldExportSectionColumns(AColumns,
    DocumentModel) then
    Exit;
...
procedure TdxWordProcessingMLBaseExporter.ExportEqualWidthColumns
  (AColumns: TdxSectionColumns);
var
...
begin
  ...
  if AColumns.DrawVerticalSeparator <> ADefaultColumns.DrawVerticalSeparator
  then
    WriteWpBoolAttr('sep', AColumns.DrawVerticalSeparator);
end;

procedure TdxWordProcessingMLBaseExporter.ExportNonUniformColumns
  (AColumns: TdxSectionColumns);
var
...
procedure TdxWordProcessingMLBaseExporter.ExportSectionPageNumbering
  (ANumbering: TdxSectionPageNumbering);
var
...
begin
  ...
  ADefaultPageNumbering := DocumentModel.Cache.PageNumberingInfoCache.
    DefaultItem;
  ...
  try
    ...
    if ANumbering.ChapterSeparator <> ADefaultPageNumbering.ChapterSeparator
    then
      WriteWpStringAttr(GetWordProcessingMLValue('chapSep'),
        ConvertChapterSeparator(ANumbering.ChapterSeparator));
  finally
    WriteWpEndElement;
  end;
end;

function TdxWordProcessingMLBaseExporter.ShouldExportPageNumbering
  (ANumbering: TdxSectionPageNumbering): Boolean;
var
  ADefaultPageNumbering: TdxPageNumberingInfo;
begin
  ADefaultPageNumbering := DocumentModel.Cache.PageNumberingInfoCache.
    DefaultItem;
  Result := not ANumbering.ContinueNumbering or
    (ANumbering.NumberingFormat <> ADefaultPageNumbering.NumberingFormat) or
    (ANumbering.ChapterSeparator <> ADefaultPageNumbering.ChapterSeparator);
end;

procedure TdxWordProcessingMLBaseExporter.ExportSectionLineNumbering
  (ANumbering: TdxSectionLineNumbering);
var
  ADefaultLineNumbering: TdxLineNumberingInfo;
begin
  if not ShouldExportLineNumbering(ANumbering) then
    Exit;
  ADefaultLineNumbering := DocumentModel.Cache.LineNumberingInfoCache.
    DefaultItem;
  WriteWpStartElement('lnNumType');
  try
    if ANumbering.StartingLineNumber <> ADefaultLineNumbering.StartingLineNumber
    then
    ...
    if ANumbering.Distance <> ADefaultLineNumbering.Distance then
      WriteWpIntAttr('distance', UnitConverter.ModelUnitsToTwips
        (ANumbering.Distance));
    if ANumbering.NumberingRestartType <> ADefaultLineNumbering.NumberingRestartType
    then
      WriteWpStringAttr('restart',
        ConvertLineNumberingRestartType(ANumbering.NumberingRestartType));
  finally
    WriteWpEndElement;
  end;
end;

function TdxWordProcessingMLBaseExporter.ShouldExportLineNumbering
  (ANumbering: TdxSectionLineNumbering): Boolean;
var
  ADefaultLineNumbering: TdxLineNumberingInfo;
begin
  ADefaultLineNumbering := DocumentModel.Cache.LineNumberingInfoCache.
...
procedure TdxWordProcessingMLBaseExporter.ExportSectionFootNote
  (ANote: TdxSectionFootNote);
begin
  if not ShouldExportSectionFootNote(ANote) then
    Exit;

  ExportSectionFootNoteCore('footnotePr', ANote,
    DocumentModel.Cache.FootNoteInfoCache
    [TdxFootNoteInfoCache.DefaultFootNoteItemIndex]);
end;

function TdxWordProcessingMLBaseExporter.ShouldExportSectionFootNote
  (ANote: TdxSectionFootNote): Boolean;
begin
  Result := DocumentModel.DocumentCapabilities.FootNotesAllowed and
    (ANote.Index <> TdxFootNoteInfoCache.DefaultFootNoteItemIndex);
end;

procedure TdxWordProcessingMLBaseExporter.ExportSectionEndNote
  (ANote: TdxSectionFootNote);
begin
  if not ShouldExportSectionEndNote(ANote) then
    Exit;

  ExportSectionFootNoteCore('endnotePr', ANote,
    DocumentModel.Cache.FootNoteInfoCache
    [TdxFootNoteInfoCache.DefaultEndNoteItemIndex]);
end;

function TdxWordProcessingMLBaseExporter.ShouldExportSectionEndNote
  (ANote: TdxSectionFootNote): Boolean;
begin
  Result := DocumentModel.DocumentCapabilities.EndNotesAllowed and
    (ANote.Index <> TdxFootNoteInfoCache.DefaultEndNoteItemIndex);
end;

procedure TdxWordProcessingMLBaseExporter.ExportSectionFootNoteCore
  (const ATagName: string; ANote: TdxSectionFootNote;
...
begin
  ...
  try
    ...
    if ANote.NumberingRestartType <> ADefaultInfo.NumberingRestartType then
      WriteWpStringValue('numRestart',
        ConvertLineNumberingRestartType(ANote.NumberingRestartType));
  finally
    WriteWpEndElement;
  end;
end;

function TdxWordProcessingMLBaseExporter.ConvertSectionStartType
  (AValue: TdxSectionStartType): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FSectionStartTypeTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue
      (FSectionStartTypeTable[TdxSectionStartType.NextPage]);
end;

function TdxWordProcessingMLBaseExporter.ConvertLineNumberingRestartType
  (AValue: TdxLineNumberingRestart): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FLineNumberingRestartTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue(FLineNumberingRestartTable
      [TdxLineNumberingRestart.NewPage]);
end;

function TdxWordProcessingMLBaseExporter.ConvertFootNotePlacement
  (AValue: TdxFootNotePosition): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FFootNotePlacementTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue
      (FFootNotePlacementTable[TdxFootNotePosition.BottomOfPage]);
end;

function TdxWordProcessingMLBaseExporter.ConvertNumberFormat
  (AValue: TdxNumberingFormat): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FPageNumberingFormatTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue(FPageNumberingFormatTable
      [TdxNumberingFormat.Decimal]);
end;

function TdxWordProcessingMLBaseExporter.ConvertChapterSeparator
  (AValue: Char): string;
var
  AResult: TdxWordProcessingMLValue;
begin
...
function TdxWordProcessingMLBaseExporter.ExportTable(ATableInfo: TdxTableInfo)
  : TdxParagraphIndex;
var
  ATable: TdxTable;
begin
  ...
  try
    ...
    if (ATable.TableProperties.Info.Value <>
      TdxTablePropertiesOptions.MaskUseNone) or (ATable.StyleIndex > 0) then
...
procedure TdxWordProcessingMLBaseExporter.ExportTableProperties
  (ATable: TdxTable);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportTablePropertiesCore
...
procedure TdxWordProcessingMLBaseExporter.ExportTablePropertiesCore
  (ATableProperties: TdxTableProperties; AExportTableLayout: Boolean);
begin
  ...
  if ATableProperties.UseTableStyleRowBandSize then
    WriteWpIntValue('tblStyleRowBandSize',
      Max(ATableProperties.TableStyleRowBandSize, 1));
  if ATableProperties.UseTableStyleColBandSize then
    WriteWpIntValue('tblStyleColBandSize',
      Max(ATableProperties.TableStyleColBandSize, 1));
  ...
  if ATableProperties.UseTableAlignment then
    WriteWpStringValue('jc',
      ConvertTableRowAlignment(ATableProperties.TableAlignment));
...
procedure TdxWordProcessingMLBaseExporter.ExportCellMargins(ATableProperties
  : TdxTableProperties);
var
  ACellMargins: TdxCellMargins;
begin

  if ((not ATableProperties.UseLeftMargin and not ATableProperties.UseTopMargin)
    and not ATableProperties.UseRightMargin) and not ATableProperties.UseBottomMargin
  then
    Exit;
...
procedure TdxWordProcessingMLBaseExporter.ExportCellMargin(const ATag: string;
...
procedure TdxWordProcessingMLBaseExporter.ExportTableBorders
...
function TdxWordProcessingMLBaseExporter.ShouldExportTableBorders
  (ABorders: TdxTableBorders): Boolean;
begin
  Result := (ABorders.UseBottomBorder and (ABorders.BottomBorder.Style <>
    TdxBorderLineStyle.&Nil)) or
    (ABorders.UseLeftBorder and (ABorders.LeftBorder.Style <>
    TdxBorderLineStyle.&Nil)) or
    (ABorders.UseRightBorder and (ABorders.RightBorder.Style <>
    TdxBorderLineStyle.&Nil)) or
    (ABorders.UseTopBorder and (ABorders.TopBorder.Style <>
    TdxBorderLineStyle.&Nil)) or (ABorders.UseInsideHorizontalBorder and
    (ABorders.InsideHorizontalBorder.Style <> TdxBorderLineStyle.&Nil)) or
    (ABorders.UseInsideVerticalBorder and (ABorders.InsideVerticalBorder.Style
    <> TdxBorderLineStyle.&Nil));
end;

procedure TdxWordProcessingMLBaseExporter.ExportTableBorder(const ATag: string;
...
procedure TdxWordProcessingMLBaseExporter.ExportTableCellBorder
  (const ATag: string; ABorder: TdxBorderBase);
begin
  if ABorder.Style = TdxBorderLineStyle.&Nil then
    Exit;
...
procedure TdxWordProcessingMLBaseExporter.ExportTableBorderCore
  (ABorder: TdxBorderBase; AExportAutoColor: Boolean);
begin
  WriteWpStringAttr('val', ConvertBorderLineStyle(ABorder.Style));
  WriteWpIntAttr('sz',
    Trunc(UnitConverter.ModelUnitsToPointsF(ABorder.Width * 8.0)));
...
function TdxWordProcessingMLBaseExporter.ShouldExportCellMargins
  (ACellMargins: TdxCellMargins): Boolean;
begin
  Result := not ForbidExportWidthUnit(ACellMargins.Bottom) or
...
procedure TdxWordProcessingMLBaseExporter.ExportCellMargins(const ATag: string;
  ACellMargins: TdxCellMargins);
begin
  WriteWpStartElement(ATag);
  try
...
procedure TdxWordProcessingMLBaseExporter.ExportWidthUnitValue
  (const ATag: string; AValue: TdxWidthUnit);
begin
...
function TdxWordProcessingMLBaseExporter.ForbidExportWidthUnit
  (AWidthUnit: TdxWidthUnit): Boolean;
begin
  Result := (AWidthUnit.&Type = TdxWidthUnitType.Nil) and
    (AWidthUnit.Value = 0);
end;

procedure TdxWordProcessingMLBaseExporter.ExportWidthUnit
  (AWidthUnit: TdxWidthUnit);
var
  AValue: Integer;
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportTableLook
...
procedure TdxWordProcessingMLBaseExporter.ExportTableLayout
  (ATableLayout: TdxTableLayoutType);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportTableBackground
  (ABackground: TdxAlphaColor);
begin
  ExportTextShading(ABackground);
end;

procedure TdxWordProcessingMLBaseExporter.ExportRunBackColor
  (ACharacterProperties: TdxCharacterProperties);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportTextShading
  (ABackground: TdxAlphaColor);
begin
  WriteWpStartElement('shd');
  try
...
procedure TdxWordProcessingMLBaseExporter.ExportIsTableOverlap(AIsTableOverlap
  : Boolean);
begin
...
function TdxWordProcessingMLBaseExporter.ShouldExportFloatingPosition
  (AFloatingPosition: TdxTableFloatingPosition): Boolean;
begin

  Result := AFloatingPosition.TextWrapping <> TdxTextWrapping.Never;
end;

procedure TdxWordProcessingMLBaseExporter.ExportFloatingPosition
  (AFloatingPosition: TdxTableFloatingPosition);
begin
  WriteWpStartElement('tblpPr');
  try
    if AFloatingPosition.BottomFromText <> 0 then
      WriteWpIntAttr('bottomFromText',
        UnitConverter.ModelUnitsToTwips(AFloatingPosition.BottomFromText));
    if AFloatingPosition.LeftFromText <> 0 then
      WriteWpIntAttr('leftFromText',
        UnitConverter.ModelUnitsToTwips(AFloatingPosition.LeftFromText));
    if AFloatingPosition.RightFromText <> 0 then
      WriteWpIntAttr('rightFromText',
        UnitConverter.ModelUnitsToTwips(AFloatingPosition.RightFromText));
    if AFloatingPosition.TopFromText <> 0 then
      WriteWpIntAttr('topFromText',
        UnitConverter.ModelUnitsToTwips(AFloatingPosition.TopFromText));
    if AFloatingPosition.TableHorizontalPosition <> 0 then
      WriteWpIntAttr('tblpX', UnitConverter.ModelUnitsToTwips
        (AFloatingPosition.TableHorizontalPosition))
    else
      WriteWpIntAttr('tblpX', 1);
    if AFloatingPosition.TableVerticalPosition <> 0 then
      WriteWpIntAttr('tblpY', UnitConverter.ModelUnitsToTwips
        (AFloatingPosition.TableVerticalPosition))
    else
      WriteWpIntAttr('tblpY', 1);
    if AFloatingPosition.HorizontalAnchor <> TdxHorizontalAnchorTypes.Column
    then
      WriteWpStringAttr('horzAnchor',
        ConvertHorizontalAnchorTypes(AFloatingPosition.HorizontalAnchor));
    if AFloatingPosition.VerticalAnchor <> TdxVerticalAnchorTypes.Margin then
      WriteWpStringAttr('vertAnchor',
        ConvertVerticalAnchorTypes(AFloatingPosition.VerticalAnchor));
    if AFloatingPosition.IsHorizontalRelativePositionUse then
      WriteWpStringAttr('tblpXSpec',
        ConvertHorizontalAlignMode(AFloatingPosition.HorizontalAlign));
    if AFloatingPosition.IsVerticalRelativePositionUse then
      WriteWpStringAttr('tblpYSpec',
        ConvertVerticalAlignMode(AFloatingPosition.VerticalAlign));
  finally
    WriteWpEndElement;
  end;
end;

procedure TdxWordProcessingMLBaseExporter.ExportRow(ARow: TdxTableRow;
  ATableInfo: TdxTableInfo);
begin
  WriteWpStartElement('tr');
  try
    ExportTablePropertiesException(ARow.TablePropertiesException);
    if ARow.Properties.Info.Value <> TdxTableRowPropertiesOptions.MaskUseNone
    then
...
procedure TdxWordProcessingMLBaseExporter.ExportTablePropertiesException
  (ATableProperties: TdxTableProperties);
var
  AShouldExport: Boolean;
begin
  AShouldExport := ATableProperties.UsePreferredWidth or
    ATableProperties.UseTableAlignment or ATableProperties.UseCellSpacing or
    ATableProperties.UseTableIndent or ShouldExportTableBorders
    (ATableProperties.Borders) or ATableProperties.UseBackgroundColor or
    ATableProperties.UseTableLayout or ShouldExportCellMargins
    (ATableProperties.CellMargins) or (ATableProperties.TableLook <> []);
...
procedure TdxWordProcessingMLBaseExporter.ExportTableRowProperties
...
procedure TdxWordProcessingMLBaseExporter.ExportTableRowProperties
  (ARowProperties: TdxTableRowProperties; AIsStyle: Boolean);
begin
  ...
  try
    ...
    if ARowProperties.TableRowAlignment <> TdxTableRowAlignment.Left then
      WriteWpStringValue('jc',
        ConvertTableRowAlignment(ARowProperties.TableRowAlignment));
...
procedure TdxWordProcessingMLBaseExporter.ExportTableRowHeight
...
procedure TdxWordProcessingMLBaseExporter.ExportHeightUnit
  (AHeightUnit: TdxHeightUnit);
begin
  if AHeightUnit.&Type <> TdxHeightUnitType.Auto then
    WriteWpStringAttr('hRule', ConvertHeightUnitType(AHeightUnit.&Type));
  WriteWpIntAttr('val', DocumentModel.UnitConverter.ModelUnitsToTwips
    (AHeightUnit.Value));
end;

procedure TdxWordProcessingMLBaseExporter.ExportCell(ACell: TdxTableCell;
  ATableInfo: TdxTableInfo);
begin
...
function TdxWordProcessingMLBaseExporter.AllowExportTableCellProperties
  (ACell: TdxTableCell): Boolean;
var
  ACellProperties: TdxTableCellProperties;
begin
  ACellProperties := ACell.Properties;
  Result := (ACellProperties.Info.Value <>
    TdxTableCellPropertiesOptions.MaskUseNone) or
    (ACellProperties.ColumnSpan > 1) or
    (ACellProperties.VerticalMerging <> TdxMergingState.None);
end;

procedure TdxWordProcessingMLBaseExporter.ExportTableCellPropertiesCore
  (ACellProperties: TdxTableCellProperties);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportTableCellPropertiesCore
  (ACellProperties: TdxTableCellProperties; AExportBorders: Boolean);
begin
  ...
  if ACellProperties.UseTextDirection then
    WriteWpStringValue('textDirection',
      ConvertTextDirection(ACellProperties.TextDirection));
  ...
  if ACellProperties.UseVerticalAlignment then
    WriteWpStringValue('vAlign',
      ConvertVerticalAlignment(ACellProperties.VerticalAlignment));
  if ACellProperties.UseHideCellMark then
    WriteWpEmptyOrFalseValue('hideMark', ACellProperties.HideCellMark);
end;

procedure TdxWordProcessingMLBaseExporter.ExportTableCellProperties
  (ACellProperties: TdxTableCellProperties);
begin
...
procedure TdxWordProcessingMLBaseExporter.WriteTableCellStyle
  (ACell: TdxTableCell);
begin
end;
...
procedure TdxWordProcessingMLBaseExporter.
  ExportTableCellPropertiesVerticalMerging(AVerticalMerging: TdxMergingState);
begin
  WriteWpStringValue('vMerge', ConvertMergingState(AVerticalMerging));
end;

procedure TdxWordProcessingMLBaseExporter.ExportTableCellBackgroundColor
  (ACellProperties: TdxTableCellProperties);
var
  AColor: TdxAlphaColor;
begin
  if not ACellProperties.UseBackgroundColor and not ACellProperties.UseForegroundColor
  then
    Exit;
  FDocumentContentWriter.WriteStartElement(WordProcessingPrefix, 'shd',
    WordProcessingNamespace);
  try
    if ACellProperties.UseShading then
      FDocumentContentWriter.WriteAttributeString(WordProcessingPrefix, 'val',
        WordProcessingNamespace, ConvertShadingPattern(ACellProperties.Shading))
    else
      FDocumentContentWriter.WriteAttributeString(WordProcessingPrefix, 'val',
        WordProcessingNamespace, 'clear');
    if ACellProperties.UseForegroundColor and not TdxAlphaColors.IsEmpty
      (ACellProperties.ForegroundColor) then
      FDocumentContentWriter.WriteAttributeString(WordProcessingPrefix, 'color',
        WordProcessingNamespace,
        ConvertColorToString(ACellProperties.ForegroundColor))
    else
      FDocumentContentWriter.WriteAttributeString(WordProcessingPrefix, 'color',
        WordProcessingNamespace, 'auto');
    AColor := ACellProperties.BackgroundColor;
    if ACellProperties.UseBackgroundColor then
    begin
      if TdxAlphaColors.IsEmpty(AColor) then
        FDocumentContentWriter.WriteAttributeString(WordProcessingPrefix,
          'fill', WordProcessingNamespace, 'FFFFFF')
      else
        FDocumentContentWriter.WriteAttributeString(WordProcessingPrefix,
          'fill', WordProcessingNamespace, ConvertColorToString(AColor));
    end
    else
      FDocumentContentWriter.WriteAttributeString(WordProcessingPrefix, 'fill',
        WordProcessingNamespace, 'FFFFFF');
  finally
    FDocumentContentWriter.WriteEndElement;
  end;
end;

procedure TdxWordProcessingMLBaseExporter.ExportTableCellBorders
  (ABorders: TdxTableCellBorders);
var
  AHasBorders: Boolean;
begin
  AHasBorders := (ABorders.UseBottomBorder and
    (ABorders.BottomBorder.Style <> TdxBorderLineStyle.&Nil)) or
    (ABorders.UseLeftBorder and (ABorders.LeftBorder.Style <>
    TdxBorderLineStyle.&Nil)) or
    (ABorders.UseRightBorder and (ABorders.RightBorder.Style <>
    TdxBorderLineStyle.&Nil)) or
    ...
    (ABorders.InsideHorizontalBorder.&Style <> TdxBorderLineStyle.Nil)) or
    (ABorders.UseInsideVerticalBorder and (ABorders.InsideVerticalBorder.Style
    <> TdxBorderLineStyle.&Nil)) or (ABorders.UseTopLeftDiagonalBorder and
    (ABorders.TopLeftDiagonalBorder.Style <> TdxBorderLineStyle.&Nil)) or
    (ABorders.UseTopRightDiagonalBorder and
    (ABorders.TopRightDiagonalBorder.Style <> TdxBorderLineStyle.&Nil));
...
procedure TdxWordProcessingMLBaseExporter.ExportConditionalFormatting
  (AConditionalFormatting: TdxConditionalTableStyleFormattingTypes);
var
...
procedure TdxWordProcessingMLBaseExporter.ExportStyleName
  (const AStyle: IdxStyle);
begin
  WriteWpStringValue('name', AStyle.StyleName);
end;

procedure TdxWordProcessingMLBaseExporter.ExportCharacterStyle
  (AStyleIndex: Integer);
var
...
procedure TdxWordProcessingMLBaseExporter.ExportNumberingListStyle
  (AStyleIndex: Integer);
var
...
begin
  ...
  try
    ...
    begin
      ...
      WriteWpIntAttr('val', GetNumberingListIndexForExport
        (AStyle.NumberingListIndex));
      WriteWpEndElement;
      WriteWpEndElement;
      WriteWpEndElement;
    end;
...
procedure TdxWordProcessingMLBaseExporter.ExportParentCharacterStyle
  (AStyle: TdxCharacterStyle);
var
...
procedure TdxWordProcessingMLBaseExporter.ExportLinkedCharacterStyle
  (AStyle: TdxCharacterStyle);
var
...
procedure TdxWordProcessingMLBaseExporter.ExportParagraphStyle
  (AStyleIndex: Integer);
var
...
begin
  ...
  try
    ...
    if AStyle.Semihidden then
      WriteWpEmptyElement('semiHidden');
    WriteWpBoolValueAsTag('qFormat', AStyle.Primary);
    ExportStyleParagraphProperties(AStyle.ParagraphProperties, AStyle.Tabs.Info,
      AStyle.GetOwnNumberingListIndex, AStyle.GetOwnListLevelIndex,
...
procedure TdxWordProcessingMLBaseExporter.ExportParentParagraphStyle
  (AStyle: TdxParagraphStyle);
var
  AParentStyleIndex: Integer;
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportNextParagraphStyle
  (AStyle: TdxParagraphStyle);
var
...
begin
  ...
  begin
    ANextStyleIndex := DocumentModel.ParagraphStyles.IndexOf
      (AStyle.NextParagraphStyle);
    if ANextStyleIndex >= 0 then
      WriteWpStringValue('next', GetParagraphStyleId(ANextStyleIndex));
  end;
end;

procedure TdxWordProcessingMLBaseExporter.ExportLinkedParagraphStyle
  (AStyle: TdxParagraphStyle);
var
...
procedure TdxWordProcessingMLBaseExporter.ExportTableStyle
  (AStyleIndex: Integer);
var
...
begin
  ...
  try
    ...
    if AStyle.Semihidden then
      WriteWpEmptyElement('semiHidden');
    WriteWpBoolValueAsTag('qFormat', AStyle.Primary);
    if AStyle.ParagraphProperties.Info.Options.Value <>
      TdxParagraphFormattingOptions.MaskUseNone then
      ExportStyleParagraphProperties(AStyle.ParagraphProperties,
        AStyle.Tabs.Info, NumberingListIndexListIndexNotSet, 0,
        NumberingListIndexListIndexNotSet);

    if AStyle.CharacterProperties.Info.Options.Value <>
      TdxCharacterFormattingOptions.MaskUseNone then
      ExportStyleCharacterProperties(AStyle.CharacterProperties);
...
procedure TdxWordProcessingMLBaseExporter.ExportParentTableStyle
  (AStyle: TdxTableStyle);
var
  AParentStyleIndex: Integer;
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportTableCellStyle
  (AStyleIndex: Integer);
var
...
procedure TdxWordProcessingMLBaseExporter.ExportParentTableCellStyle
  (AStyle: TdxTableCellStyle);
var
  AParentStyleIndex: Integer;
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportTableStyleConditionalProperties
  (ATableConditionalStyleProperties: TdxTableConditionalStyleProperties);
var
...
procedure TdxWordProcessingMLBaseExporter.ExportTableConditionalStyle
  (AStyleType: TdxConditionalTableStyleFormattingType;
...
procedure TdxWordProcessingMLBaseExporter.ExportStyleParagraphProperties
  (AParagraphProperties: TdxParagraphProperties; ATabInfo: TdxTabFormattingInfo;
  AOwnNumberingListIndex: TdxNumberingListIndex; AListLevelIndex: Integer;
...
begin
  ...
  try
    AParagraphNumberingExporter := nil;
    if (ShouldExportParagraphNumbering(AOwnNumberingListIndex)) or
      (ShouldExportParagraphNumbering(AMergedStyleListIndex)) then
      AParagraphNumberingExporter :=
      procedure()begin ExportParagraphStyleListReference(AOwnNumberingListIndex,
        AListLevelIndex);
  end;
  ATabsExporter := procedure()
    begin
  ...
  ExportParagraphPropertiesCore(AParagraphProperties, False, nil,
    AParagraphNumberingExporter, ATabsExporter);
finally
  WriteWpEndElement;
end;
end;

procedure TdxWordProcessingMLBaseExporter.ExportStyleCharacterProperties
  (ACharacterProperties: TdxCharacterProperties);
begin
  WriteWpStartElement('rPr');
  try
...
begin
  ...
  WriteWpBoolValue('displayBackgroundShape',
    AProperties.DisplayBackgroundShape);
  ExportDocumentProtectionSettings;
  WriteWpIntValue('defaultTabStop',
    UnitConverter.ModelUnitsToTwips(AProperties.DefaultTabWidth));
  ...
  try
    ...
    begin
      ...
      try
        ...
        WriteWpStringAttr('val',
          EncodeVariableValue(AVariables[AName].ToString));
      finally
        WriteWpEndElement;
      end;
    end;
...
function TdxWordProcessingMLBaseExporter.EncodeVariableValue
...
procedure TdxWordProcessingMLBaseExporter.ExportOverrideLevels
...
procedure TdxWordProcessingMLBaseExporter.ExportLevelOverride
  (ALevel: TdxAbstractListLevel; ALevelIndex: Integer);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportStartOverride
  (ANewStart: Integer);
begin
  WriteWpIntValue('startOverride', ANewStart);
end;

procedure TdxWordProcessingMLBaseExporter.ExportLevel
...
begin
  ...
  try
    ...
    if ALevel.ListLevelProperties.TemplateCode <> 0 then
      WriteWpStringAttr('tplc',
        ConvertToHexBinary(ALevel.ListLevelProperties.TemplateCode));
...
procedure TdxWordProcessingMLBaseExporter.ExportAbstractLevelProperties
  (ALevel: TdxListLevel);
var
...
begin
  ...
  if (AParagraphStyleIndex < 0) or
    (AParagraphStyleIndex >= DocumentModel.ParagraphStyles.Count) then
    Exit;
  WriteWpStringValue('pStyle', GetParagraphStyleId(AParagraphStyleIndex));
end;

procedure TdxWordProcessingMLBaseExporter.ExportLevelParagraphProperties
  (AProperties: TdxParagraphProperties; ATabs: TdxTabProperties);
begin
  WriteWpStartElement('pPr');
  try
...
procedure TdxWordProcessingMLBaseExporter.ExportLevelCharacterProperties
...
procedure TdxWordProcessingMLBaseExporter.ExportLevels
  (ALevels: TdxListLevelCollection);
var
  ACount, I: Integer;
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportLevelProperties
  (const ALevel: IdxListLevel; ALevelIndex: Integer);
var
...
begin
  ...
  else if AProperties.RelativeRestartLevel <> 0 then
    WriteWpIntValue('lvlRestart',
      ALevelIndex - AProperties.RelativeRestartLevel);
  ...
  if AProperties.ConvertPreviousLevelNumberingToDecimal then
    WriteWpBoolValue('isLgl',
      AProperties.ConvertPreviousLevelNumberingToDecimal);
  WriteWpStringValue('suff', ConvertNumberingSeparator(AProperties.Separator));
  WriteWpStringValue('lvlText',
    ConvertFormatString(AProperties.DisplayFormatString));
  if AProperties.Legacy then
  begin
    WriteWpStartElement('legacy');
    try
      WriteWpIntAttr('legacy', 1);
      WriteWpIntAttr('legacyIndent',
        UnitConverter.ModelUnitsToTwips(AProperties.LegacyIndent));
      WriteWpIntAttr('legacySpace',
        UnitConverter.ModelUnitsToTwips(AProperties.LegacySpace));
    finally
      WriteWpEndElement;
    end;
  end;
  WriteWpStringValue('lvlJc',
    ConvertListNumberAlignment(AProperties.Alignment));
end;

procedure TdxWordProcessingMLBaseExporter.ExportFloatingObjectAnchorRun
...
procedure TdxWordProcessingMLBaseExporter.ExportInlinePictureRun
...
begin
  ...
  try
    ...
    if TdxInlinePictureRun.ShouldExportInlinePictureRunCharacterProperties
      (AInfo.Info, AInfo.Options) then
      ExportRunProperties(ARun);
...
procedure TdxWordProcessingMLBaseExporter.ExportInlinePictureImageReference
  (ARun: TdxInlinePictureRun);
begin
  ExportImageReference(ARun);
end;
...
function TdxWordProcessingMLBaseExporter.GenerateImageRelationId
  (const AImageId: string): string;
begin
  Result := 'Rel' + AImageId;
end;

function TdxWordProcessingMLBaseExporter.ConvertColorToString
  (AValue: TdxAlphaColor): string;
begin
  if TdxAlphaColors.IsTransparentOrEmpty(AValue) then
    Result := 'auto'
  else
    Result := Format('%.2x%.2x%.2x', [TdxAlphaColors.R(AValue),
      TdxAlphaColors.G(AValue), TdxAlphaColors.B(AValue)]);
end;

function TdxWordProcessingMLBaseExporter.ConvertToHexString
  (AValue: Integer): string;
begin
  Result := Format('%x', [AValue]);
end;

function TdxWordProcessingMLBaseExporter.ConvertToHexBinary
  (ANumber: Integer): string;
begin
  Result := Format('%.8x', [ANumber]);
end;

function TdxWordProcessingMLBaseExporter.ConvertBackColorToString
  (AValue: TdxAlphaColor): string;
var
  AResult: TdxWordProcessingMLValue;
...
begin
  if TdxAlphaColors.IsTransparentOrEmpty(AValue) then
    Exit(GetWordProcessingMLValue(FPredefinedBackgroundColors
      [TdxAlphaColors.Empty]));

  if FPredefinedBackgroundColors.TryGetValue(AValue, AResult) then
    Exit(GetWordProcessingMLValue(AResult));

  ABestMatchColor := TdxAlphaColors.CalculateNearestColor
    (FPredefinedBackgroundColors.Keys.ToArray, AValue);

  ACurrentTableBackgroundColor := CurrentTableBackgroundColor;
  if not TdxAlphaColors.IsTransparentOrEmpty(ACurrentTableBackgroundColor) and
    (ACurrentTableBackgroundColor = AValue) and (ABestMatchColor <> AValue) then
    Exit('');

  Result := GetWordProcessingMLValue(FPredefinedBackgroundColors
    [ABestMatchColor]);
end;

function TdxWordProcessingMLBaseExporter.ConvertScript
  (AScript: TdxCharacterFormattingScript): string;
begin
  case AScript of
...
function TdxWordProcessingMLBaseExporter.ConvertUnderlineType
  (AUnderline: TdxUnderlineType): string;
var
...
begin
  if FUnderlineTable.TryGetValue(AUnderline, AValue) then
    ...
    Result := GetWordProcessingMLValue
      (FUnderlineTable[TdxUnderlineType.Single]);
end;

function TdxWordProcessingMLBaseExporter.ConvertFormatString
  (const AValue: string): string;
begin
  Result := Format(AValue, ['%1', '%2', '%3', '%4', '%5', '%6', '%7',
    '%8', '%9']);
end;

function TdxWordProcessingMLBaseExporter.ConvertListNumberAlignment
  (AValue: TdxListNumberAlignment): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FListNumberAlignmentTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue(FListNumberAlignmentTable
      [TdxListNumberAlignment.Left]);
end;

function TdxWordProcessingMLBaseExporter.ConvertNumberingSeparator
  (AValue: Char): string;
var
  AResult: TdxWordProcessingMLValue;
begin
...
function TdxWordProcessingMLBaseExporter.ConvertNumberingListType
  (AValue: TdxNumberingType): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FNumberingListTypeTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue
      (FNumberingListTypeTable[TdxNumberingType.Bullet]);
end;

procedure TdxWordProcessingMLBaseExporter.ExportFieldCodeStartRun
...
procedure TdxWordProcessingMLBaseExporter.ExportFieldCodeEndRun
...
procedure TdxWordProcessingMLBaseExporter.ExportFieldResultEndRun
  (ARun: TdxFieldResultEndRun);
begin
  ExportFieldChar(ARun, 'end', False);
end;

procedure TdxWordProcessingMLBaseExporter.ExportFieldChar(ARun: TdxTextRun;
  const AFieldCharType: string; AWriteDisableUpdate: Boolean);
begin
  WriteWpStartElement('r');
  try
    ExportRunProperties(ARun);
    ...
    try
      ...
      if AWriteDisableUpdate and PieceTable.FindFieldByRunIndex
        (ARun.GetRunIndex).DisableUpdate then
...
procedure TdxWordProcessingMLBaseExporter.ExportRangePermissionStart
...
function TdxWordProcessingMLBaseExporter.GetGroupName(const AGroupName
  : string): string;
var
  AResult: string;
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportRangePermissionEnd
  (ARangePermission: TdxRangePermission);
var
  AId: string;
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportFootNoteRun
  (ARun: TdxFootNoteRun);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportFootNoteReference
  (ARun: TdxFootNoteRun);
begin
  ExportFootNoteCore(DocumentContentWriter, ARun.Note, -1);
end;

procedure TdxWordProcessingMLBaseExporter.ExportFootNoteSelfReference
  (ARun: TdxFootNoteRun);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportFootNoteCore
  (AWriter: TdxXmlWriter; AFootNote: TdxFootNoteBase; AId: Integer);
begin
  ExportFootNoteCore(AWriter, AFootNote, AId, 'footnote');
end;

procedure TdxWordProcessingMLBaseExporter.ExportFootNoteCore
  (AWriter: TdxXmlWriter; ANote: TdxFootNoteBase; AId: Integer;
...
begin
  ...
  try
    ...
    try
      ...
      PerformExportPieceTable(TdxPieceTable(ANote.PieceTable),
        ExportPieceTable);
    finally
      WriteWpEndElement;
    end;
...
procedure TdxWordProcessingMLBaseExporter.ExportEndNoteReference
  (ARun: TdxEndNoteRun);
begin
  ExportEndNoteCore(DocumentContentWriter, ARun.Note, -1);
end;

procedure TdxWordProcessingMLBaseExporter.ExportEndNoteSelfReference
  (ARun: TdxEndNoteRun);
begin
...
procedure TdxWordProcessingMLBaseExporter.ExportEndNoteCore
  (AWriter: TdxXmlWriter; AEndNote: TdxFootNoteBase; AId: Integer);
begin
  ExportFootNoteCore(AWriter, AEndNote, AId, 'endnote');
end;

function TdxWordProcessingMLBaseExporter.GetParagraphStyleId
  (AStyleIndex: Integer): string;
begin
  Result := 'P' + IntToStr(AStyleIndex);
end;

function TdxWordProcessingMLBaseExporter.GetCharacterStyleId
  (AStyleIndex: Integer): string;
begin
  Result := 'C' + IntToStr(AStyleIndex);
end;

function TdxWordProcessingMLBaseExporter.GetTableStyleId
  (AStyleIndex: Integer): string;
begin
  Result := 'T' + IntToStr(AStyleIndex);
end;

function TdxWordProcessingMLBaseExporter.GetTableCellStyleId
  (AStyleIndex: Integer): string;
begin
  Result := 'TC' + IntToStr(AStyleIndex);
end;

function TdxWordProcessingMLBaseExporter.GetNumberingStyleId
  (AStyleIndex: Integer): string;
begin
  Result := 'N' + IntToStr(AStyleIndex);
end;

function TdxWordProcessingMLBaseExporter.GetWordProcessingMLValue
  (const AOpenXmlValue: string): string;
begin
  Result := GetWordProcessingMLValue
    (TdxWordProcessingMLValue.Create(AOpenXmlValue));
end;

function TdxWordProcessingMLBaseExporter.ExportImageStyle
...
var
  AFinalWidth, AFinalHeight, ATopDistance, ABottomDistance, ALeftDistance,
    ARightDistance, AOffsetX, AOffsetY: Single;
  AZOrder: Integer;
  AHPositionType, AVPositionType, AHPositionAlignment, AVPositionAlignment,
    ARelativeWidth, ARelativeHeight: string;
  ATextBoxProperties: TdxTextBoxProperties;
begin
  AFinalWidth := UnitConverter.ModelUnitsToPointsF
    (AFloatingObjectProperties.ActualSize.Width);
  AFinalHeight := UnitConverter.ModelUnitsToPointsF
    (AFloatingObjectProperties.ActualSize.Height);
  AZOrder := AFloatingObjectProperties.ZOrder;
  ATopDistance := UnitConverter.ModelUnitsToPointsF
    (AFloatingObjectProperties.TopDistance);
  ABottomDistance := UnitConverter.ModelUnitsToPointsF
    (AFloatingObjectProperties.BottomDistance);
  ALeftDistance := UnitConverter.ModelUnitsToPointsF
    (AFloatingObjectProperties.LeftDistance);
  ARightDistance := UnitConverter.ModelUnitsToPointsF
    (AFloatingObjectProperties.RightDistance);
  AOffsetX := UnitConverter.ModelUnitsToPointsF
    (AFloatingObjectProperties.Offset.X);
  AOffsetY := UnitConverter.ModelUnitsToPointsF
    (AFloatingObjectProperties.Offset.Y);
  AHPositionType := GetHorizontalPositionType
    (AFloatingObjectProperties.HorizontalPositionType);
  AVPositionType := GetVerticalPositionType
    (AFloatingObjectProperties.VerticalPositionType);
  AHPositionAlignment := GetHorizontalPositionAlignment
    (AFloatingObjectProperties.HorizontalPositionAlignment);
  AVPositionAlignment := GetVerticalPositionAlignment
  ...
  if AFloatingObjectProperties.UseRelativeHeight then
    ARelativeHeight := GetRelativeHeight
      (AFloatingObjectProperties.RelativeHeight)
  else
    ARelativeHeight := '';
  Result := TdxStringHelper.Format
    ('position:absolute;width:%gpt;height:%gpt;z-index:%d;mso-wrap-distance-left:%gpt;'
    ...
    [AFinalWidth, AFinalHeight, AZOrder, ALeftDistance, ATopDistance,
    ARightDistance, ABottomDistance, AOffsetX, AOffsetY, AHPositionAlignment,
    AHPositionType, AVPositionAlignment, AVPositionType]);
  ...
  begin
    if AFloatingObjectProperties.PercentOffsetX <> 0 then
      Result := Result + ';' + TdxStringHelper.Format('mso-left-percent:%g',
        [AFloatingObjectProperties.PercentOffsetX / 100]);
    if AFloatingObjectProperties.PercentOffsetY <> 0 then
      Result := Result + ';' + TdxStringHelper.Format('mso-top-percent:%g',
        [AFloatingObjectProperties.PercentOffsetY / 100]);
  end;
  ...
  begin
    ...
    if ATextBoxProperties.UseWrapText then
      Result := Result + ';mso-wrap-style:' +
        GetWrapText(ATextBoxProperties.WrapText);
    if ATextBoxProperties.UseVerticalAlignment then
      Result := Result + ';v-text-anchor:' + GetVerticalAlignment
        (ATextBoxProperties.VerticalAlignment);
  end;
  if (AShape <> nil) and AShape.UseRotation then
  begin
    if AShape.Rotation mod 60000 = 0 then
      Result := Result + ';rotation:' +
        IntToStr(UnitConverter.ModelUnitsToDegree(AShape.Rotation))
    else
      Result := Result + ';rotation:' +
        IntToStr(UnitConverter.ModelUnitsToFD(AShape.Rotation)) + 'fd';
  end;
end;

function TdxWordProcessingMLBaseExporter.GetVerticalAlignment(AVerticalAlignment
  : TdxVerticalAlignment): string;
var
  AVAlignment: TdxWordProcessingMLValue;
begin
  if FTextBoxVerticalAlignmentTable.TryGetValue(AVerticalAlignment, AVAlignment)
  then
  begin
...
function TdxWordProcessingMLBaseExporter.GetWrapText
  (AWrapText: Boolean): string;
begin
  if AWrapText then
    Result := 'square'
  else
...
function TdxWordProcessingMLBaseExporter.GetRelativeWidth(const ARelativeWidth
  : TdxFloatingObjectRelativeWidth): string;
begin
  if ARelativeWidth.From <> TdxFloatingObjectRelativeFromHorizontal.Page then
    Result := Format('mso-width-relative:%s;mso-width-percent:%d',
      [GetRelativeSizeFromHorizontal(ARelativeWidth),
      ARelativeWidth.Width div 100])
  else
    Result := Format('mso-width-percent:%d', [ARelativeWidth.Width div 100]);
end;

function TdxWordProcessingMLBaseExporter.GetRelativeHeight(const ARelativeHeight
  : TdxFloatingObjectRelativeHeight): string;
begin
  if ARelativeHeight.From <> TdxFloatingObjectRelativeFromVertical.Page then
    Result := Format('mso-height-relative:%s;mso-height-percent:%d',
      [GetRelativeSizeFromVertical(ARelativeHeight),
      ARelativeHeight.Height div 100])
  else
    Result := Format('mso-height-percent:%d', [ARelativeHeight.Height div 100]);
end;

function TdxWordProcessingMLBaseExporter.GetRelativeSizeFromHorizontal
  (const ARelativeWidth: TdxFloatingObjectRelativeWidth): string;
var
  ARelativeFrom: TdxWordProcessingMLValue;
begin
  if FFloatingObjectCssRelativeFromHorizontalTable.TryGetValue
    (ARelativeWidth.From, ARelativeFrom) then
    Result := ARelativeFrom.WordMLValue
  else
    Result := FFloatingObjectCssRelativeFromHorizontalTable
      [TdxFloatingObjectRelativeFromHorizontal.Margin].WordMLValue;
end;

function TdxWordProcessingMLBaseExporter.GetRelativeSizeFromVertical
  (const ARelativeHeight: TdxFloatingObjectRelativeHeight): string;
var
  ARelativeFrom: TdxWordProcessingMLValue;
begin
  if FFloatingObjectCssRelativeFromVerticalTable.TryGetValue
    (ARelativeHeight.From, ARelativeFrom) then
    Result := ARelativeFrom.WordMLValue
  else
    Result := FFloatingObjectCssRelativeFromVerticalTable
      [TdxFloatingObjectRelativeFromVertical.Margin].WordMLValue;
end;
...
begin
  if FFloatingObjectVerticalPositionAlignmentTable.TryGetValue
    (AFloatingObjectVerticalPositionAlignment, AHPositionAlignment) then
...
begin
  if FFloatingObjectHorizontalPositionAlignmentTable.TryGetValue
    (AFloatingObjectHorizontalPositionAlignment, AVPositionAlignment) then
    Result := AVPositionAlignment.WordMLValue
  else
    Result := 'absolute';
end;

function TdxWordProcessingMLBaseExporter.GetVerticalPositionType
  (AFloatingObjectVerticalPositionType
  : TdxFloatingObjectVerticalPositionType): string;
var
  AVPositionType: TdxWordProcessingMLValue;
begin
  if VerticalPositionTypeAttributeTable.TryGetValue
    (AFloatingObjectVerticalPositionType, AVPositionType) then
    Result := AVPositionType.OpenXmlValue
  else
    Result := 'margin';
end;

function TdxWordProcessingMLBaseExporter.GetHorizontalPositionType
  (AFloatingObjectHorizontalPositionType
  : TdxFloatingObjectHorizontalPositionType): string;
var
  AHPositionType: TdxWordProcessingMLValue;
begin
  if HorizontalPositionTypeAttributeTable.TryGetValue
    (AFloatingObjectHorizontalPositionType, AHPositionType) then
    Result := AHPositionType.OpenXmlValue
  else
    Result := 'page';
end;

procedure TdxWordProcessingMLBaseExporter.ExportLockAspectRatio
  (AFloatingObjectProperties: TdxFloatingObjectProperties);
begin
  if not AFloatingObjectProperties.UseLockAspectRatio then
    Exit;
  DocumentContentWriter.WriteStartElement(OPrefix, 'lock',
    OfficeNamespaceConst);
  try
    DocumentContentWriter.WriteAttributeString('aspectratio',
      ConvertBoolValueToString(AFloatingObjectProperties.LockAspectRatio));
  finally
    DocumentContentWriter.WriteEndElement;
  end;
end;

function TdxWordProcessingMLBaseExporter.ConvertBoolValueToString
...
procedure TdxWordProcessingMLBaseExporter.WriteWrap(AFloatingObjectProperties
  : TdxFloatingObjectProperties);
var
...
begin
  ...
  if FFloatingObjectTextWrapTypeTable.TryGetValue
    (AFloatingObjectProperties.TextWrapType, AWrapType) then
  begin
  ...
  try
    ...
    begin
      ATextWrapSide := '';
      if FFloatingObjectTextWrapSideTable.TryGetValue
        (AFloatingObjectProperties.TextWrapSide, AWrapSide) then
...
procedure TdxWordProcessingMLBaseExporter.WriteFloatingObjectTextBox
  (ATextBoxContent: TdxTextBoxFloatingObjectContent);
var
  ATextBoxProperties: TdxTextBoxProperties;
begin
  ...
  try
    ...
    if ATextBoxProperties.UseResizeShapeToFitText then
      DocumentContentWriter.WriteAttributeString('style',
        'mso-fit-shape-to-text:' + ConvertBoolValueToString
        (ATextBoxProperties.ResizeShapeToFitText));
    if ATextBoxProperties.UseLeftMargin or ATextBoxProperties.UseRightMargin or
      ATextBoxProperties.UseTopMargin or ATextBoxProperties.UseBottomMargin then
      DocumentContentWriter.WriteAttributeString('inset',
        Format('%dmm,%dmm,%dmm,%dmm',
        [Round(UnitConverter.ModelUnitsToMillimetersF
        (ATextBoxProperties.LeftMargin)),
        Round(UnitConverter.ModelUnitsToMillimetersF
        (ATextBoxProperties.TopMargin)),
        Round(UnitConverter.ModelUnitsToMillimetersF
        (ATextBoxProperties.RightMargin)),
        Round(UnitConverter.ModelUnitsToMillimetersF
        (ATextBoxProperties.BottomMargin))]));
...
procedure TdxWordProcessingMLBaseExporter.WriteFloatingObjectTxbxContent
  (AContent: TdxTextBoxFloatingObjectContent);
begin
  DocumentContentWriter.WriteStartElement(WordProcessingPrefix, 'txbxContent',
    WordProcessingNamespace);
  try
...
procedure TdxWordProcessingMLBaseExporter.WriteFloatingObjectAnchorLock
  (ALocked: Boolean);
begin
  if ALocked then
  begin
    DocumentContentWriter.WriteStartElement(W10MLPrefix, 'anchorlock',
      W10MLNamespace);
    DocumentContentWriter.WriteEndElement;
  end;
end;

function TdxWordProcessingMLBaseExporter.GenerateFloatingObjectName
  (const AName: string; const ADefaultNamePrefix: string; AId: Integer): string;
begin
  if AName <> '' then
    Result := AName
  else
...
procedure TdxWordProcessingMLBaseExporter.WriteFloatingObjectPict
  (AFloatingObjectProperties: TdxFloatingObjectProperties;
  ATextBoxContent: TdxTextBoxFloatingObjectContent;
  APictureContent: TdxPictureFloatingObjectContent; AShape: TdxShape;
  const AName: string);
...
begin
  DocumentContentWriter.WriteStartElement(WordProcessingPrefix, 'pict',
    WordProcessingNamespace);
  try
    AShapeTypeId := WriteFloatingObjectShapeType;
    WriteFloatingObjectShape(AFloatingObjectProperties, ATextBoxContent,
      APictureContent, AShape, AShapeTypeId, AName);
  finally
    DocumentContentWriter.WriteEndElement;
  end;
end;
...
begin
  ...
  try
    ...
    DocumentContentWriter.WriteAttributeString('path',
...
procedure TdxWordProcessingMLBaseExporter.WriteFloatingObjectShape
  (AFloatingObjectProperties: TdxFloatingObjectProperties;
  ATextBoxContent: TdxTextBoxFloatingObjectContent;
  APictureContent: TdxPictureFloatingObjectContent; AShape: TdxShape;
  AShapeTypeId: Integer; const AName: string);
...
begin
  ...
  try
    AImageStyle := ExportImageStyle(AFloatingObjectProperties,
      ATextBoxContent, AShape);
    DocumentContentWriter.WriteAttributeString('type',
      '#' + IntToStr(AShapeTypeId));
    ...
    if AFloatingObjectProperties.UseLayoutInTableCell then
      WriteStringAttr(OPrefix, 'allowincell', OfficeNamespaceConst,
        GetBoolValueAsString(AFloatingObjectProperties.LayoutInTableCell));
    if AFloatingObjectProperties.UseAllowOverlap then
      WriteStringAttr(OPrefix, 'allowoverlap', OfficeNamespaceConst,
        GetBoolValueAsString(AFloatingObjectProperties.AllowOverlap));

    if APictureContent <> nil then
      ExportImageData(AImagePath)
    else if ATextBoxContent <> nil then
...
procedure TdxWordProcessingMLBaseExporter.
  WriteFloatingObjectShapeAllColorsAndOutlineWeight(AShape: TdxShape);
begin
  if AShape.UseFillColor then
    DocumentContentWriter.WriteAttributeString('fillcolor',
      '#' + ConvertColorToString(AShape.FillColor));
  if AShape.UseOutlineColor then
    DocumentContentWriter.WriteAttributeString('strokecolor',
      '#' + ConvertColorToString(AShape.OutlineColor));
  if AShape.UseOutlineWidth then
    DocumentContentWriter.WriteAttributeString('strokeweight',
      IntToStr(Trunc(UnitConverter.ModelUnitsToPointsF(AShape.OutlineWidth)
      )) + 'pt');
  if TdxAlphaColors.IsTransparentOrEmpty(AShape.OutlineColor) then
    DocumentContentWriter.WriteAttributeString('stroked', 'f');
end;

function TdxWordProcessingMLBaseExporter.GetBoolValueAsString
  (AValue: Boolean): string;
begin
  if AValue then
    Result := 't'
...
procedure TdxWordProcessingMLBaseExporter.ExportImageData
...
begin
  ...
  try
    ...
    DocumentContentWriter.WriteAttributeString(OfficePrefix, 'title',
      OfficeNamespace, '');
  finally
    DocumentContentWriter.WriteEndElement;
  end;
...
function TdxWordProcessingMLBaseExporter.ExportBinData
  (AImage: TdxOfficeImage): string;
var
  AImagePath: string;
...
function TdxWordProcessingMLBaseExporter.GetImagePath
  (AImage: TdxOfficeImage): string;
var
  AExtension: string;
begin
