...
{$ENDIF}
  ...
  cxDataStorage, cxDataUtils, cxGeometry,
  cxEdit, cxDropDownEdit, cxTextEdit, cxMaskEdit, cxButtons, cxDateUtils,
  dxCalendarUtils, dxGdiPlusClasses,
  cxEditConsts, cxFormats, cxTimeEdit, cxFilterControlUtils, cxLookAndFeels,
  cxLookAndFeelPainters, dxAnimation,
  dxFading, dxDateTimeWheelPicker, dxTypeHelpers;
...
type
  ...
  public
    constructor Create(ACalendar: TcxCustomCalendar;
      ADirection: TcxArrowDirection); reintroduce; virtual;
  ...
  TcxCalendarModernDecadeCellViewInfo = class
  ...
  protected
    ...
    property DateCells[Index: Integer]: TcxCalendarDateCellViewInfo
      read GetDateCells;
  end;
  ...
  protected
    ...
    function GetDayOfWeekName(ADay: TDay; AFontCharset: TFontCharset)
      : string; virtual;
    function GetMinSize: TSize; override;
  ...
  TcxCalendarModernYearTableViewInfo = class
  ...
  TcxCalendarModernDecadeTableViewInfo = class
    (TcxCalendarModernLargeCellTableViewInfo)
  protected
    function CreateDateCell: TcxCalendarDateCellViewInfo; override;
    function IsDateEnabled(ADate: TDateTime): Boolean; override;
  ...
  TcxCalendarModernCenturyTableViewInfo = class
    (TcxCalendarModernLargeCellTableViewInfo)
  protected
    function CreateDateCell: TcxCalendarDateCellViewInfo; override;
    function IsDateEnabled(ADate: TDateTime): Boolean; override;
  ...
  TcxCalendarYearDateHeaderCellViewInfo = class
    (TcxCalendarDateHeaderCellViewInfo)
  protected
    function GetText: string; override;
  end;

  TcxCalendarMonthDateHeaderCellViewInfo = class
    (TcxCalendarDateHeaderCellViewInfo)
  protected
    function GetText: string; override;
    procedure MouseDown(Button: TMouseButton; Shift: TShiftState;
  ...
  TcxCalendarModernDateHeaderCellViewInfo = class
    (TcxCalendarDateHeaderCellViewInfo)
  private
    FText: string;
  protected
  ...
  protected
    procedure AddVisibleElements; override;
    procedure CalculateBounds; override;
    function CreateArrowViewInfo(ADirection: TcxArrowDirection)
      : TcxCalendarArrowViewInfo; virtual;
    procedure CreateElements; override;
    function CreateTextCellViewInfo: TcxCalendarDateHeaderCellViewInfo; virtual;
    procedure DestroyElements; override;
    property TextCellViewInfo: TcxCalendarDateHeaderCellViewInfo
      read FTextCellViewInfo;
  end;
  ...
  TcxCalendarModernMonthDateHeaderViewInfo = class
    (TcxCalendarMonthDateHeaderViewInfo)
  protected
    function CreateArrowViewInfo(ADirection: TcxArrowDirection)
      : TcxCalendarArrowViewInfo; override;
    function CreateTextCellViewInfo: TcxCalendarDateHeaderCellViewInfo;
      override;
  end;
  ...
  protected
    ...
    procedure CalculateBounds; override;
    procedure CreateElements; override;
    function CreateMonthHeaderViewInfo
      : TcxCalendarMonthDateHeaderViewInfo; virtual;
    procedure DestroyElements; override;
    procedure DoCalculateBounds; virtual;
    function DoCalculateSize: TSize; override;
  public
    property MonthHeaderViewInfo: TcxCalendarMonthDateHeaderViewInfo
      read FMonthHeaderViewInfo;
  end;
  ...
  private
    ...
    procedure CalculateMaxYearAndMonthNameLengths(var AMaxYearNameWidth,
      AMaxMonthNameWidth: Integer);
  protected
    procedure AddVisibleElements; override;
    procedure CreateElements; override;
    procedure DestroyElements; override;
    ...
    procedure Paint(ACanvas: TcxCanvas); override;
  public
    property YearHeaderViewInfo: TcxCalendarYearDateHeaderViewInfo
      read FYearHeaderViewInfo;
  end;

  TcxCalendarModernDateHeadersViewInfo = class(TcxCalendarDateHeadersViewInfo)
  protected
    function CreateMonthHeaderViewInfo
      : TcxCalendarMonthDateHeaderViewInfo; override;
    function DoCalculateSize: TSize; override;
  end;
  ...
  public
    ...
    property MonthTableViewInfo: TcxCalendarMonthTableViewInfo
      read FMonthTableViewInfo;
    property HeadersViewInfo: TcxCalendarDateHeadersViewInfo
      read FHeadersViewInfo;
  end;

  TcxCalendarModernDateViewStyle = (cvdsMonth, cvdsYear, cvdsDecade,
    cvdsCentury);
  ...
  public
    ...
    property StartState: TcxCalendarAnimatedImageState read FStartState
      write FStartState;
    property EndState: TcxCalendarAnimatedImageState read FEndState
      write FEndState;
  end;
  ...
  protected
    property ImageInfo[AIndex: Integer]: TcxCalendarAnimatedImageInfo
      read GetImageInfo;
  public
  ...
  private
    ...
    function GetTableViewInfo(AViewStyle: TcxCalendarModernDateViewStyle)
  ...
  protected
    ...
    property ViewStyle: TcxCalendarModernDateViewStyle read FViewStyle
      write SetViewStyle;
  public
    constructor Create(ACalendar: TcxCustomCalendar); override;
    destructor Destroy; override;
    procedure ChangeFirstDate(Value: Double; AAnimated: Boolean); override;
    procedure ChangeViewStyle(AValue: TcxCalendarModernDateViewStyle;
      AAnimated: Boolean);
    procedure ChangeSelectDate(AValue: Double; ARepositionVisibleDates: Boolean;
      AAnimated: Boolean); override;
    property TableViewInfo[AView: TcxCalendarModernDateViewStyle]
      : TcxCalendarDateTableViewInfo read GetTableViewInfo;
  end;
  ...
  public
    constructor Create(ACalendar: TcxCustomCalendar; AType: TCalendarButton);
      reintroduce; virtual;
    destructor Destroy; override;
  end;
  ...
  protected
    ...
    procedure DoSetSelectDate(AValue: Double; ARepositionVisibleDates: Boolean;
      AAnimated: Boolean); virtual;
    ...
    procedure SetSelectDate(AValue: Double; ARepositionVisibleDates: Boolean;
      AAnimated: Boolean); virtual;
  ...
  public
    ...
    property HeaderViewInfo: TcxCalendarModernHeaderViewInfo
  ...
  public
    ...
    property HitAtDateHeaderArrow: Boolean index cchtDateHeaderArrow
      read GetBitState;
    property HitAtDateTableCell: Boolean index cchtDateTableCell
      read GetBitState;
    property HitAtHeader: Boolean index cchtHeader read GetBitState;
    property HitAtMonthDateHeader: Boolean index cchtMonthHeader
      read GetBitState;
    property HitAtYearDateHeader: Boolean index cchtYearHeader read GetBitState;
    property HitObject: TcxCalendarElementViewInfo read FHitObject
      write FHitObject;
  ...
  protected
    ...
    property HotElement: TcxCalendarElementViewInfo read FHotElement
      write SetHotElement;
    property PressedElement: TcxCalendarElementViewInfo read FPressedElement
      write SetPressedElement;
  public
    constructor Create(ACalendar: TcxCustomCalendar);
    destructor Destroy; override;
    ...
    procedure DblClick;
    procedure HidePopup(Sender: TcxControl;
      AReason: TcxEditCloseUpReason); virtual;
  ...
  public
    procedure HidePopup(Sender: TcxControl;
      AReason: TcxEditCloseUpReason); override;
  ...
  private
    ...
    function GetLookAndFeelPainter: TcxCustomLookAndFeelPainter;
  protected
    procedure DrawArrow(ACanvas: TcxCanvas;
      AViewInfo: TcxCalendarArrowViewInfo); virtual;
    procedure DrawButtonsBackground(ACanvas: TcxCanvas;
      AViewInfo: TcxCalendarButtonsViewInfo); virtual;
    procedure DrawDateCellText(ACanvas: TcxCanvas;
      AViewInfo: TcxCalendarDateCellViewInfo); virtual;
    procedure DrawDateCellBackground(ACanvas: TcxCanvas;
      AViewInfo: TcxCalendarDateCellViewInfo); virtual;
    procedure DrawDateCellSelection(ACanvas: TcxCanvas;
      AViewInfo: TcxCalendarDateCellViewInfo); virtual;
    procedure DrawDateHeaderCell(ACanvas: TcxCanvas;
      AViewInfo: TcxCalendarDateHeaderCellViewInfo); virtual;
    procedure DrawDateHeaderCellText(ACanvas: TcxCanvas;
      AViewInfo: TcxCalendarDateHeaderCellViewInfo); virtual;
    procedure DrawHeader(ACanvas: TcxCanvas;
      AViewInfo: TcxCalendarHeaderViewInfo); virtual;
    procedure DrawHeaderText(ACanvas: TcxCanvas;
      AViewInfo: TcxCalendarHeaderViewInfo); virtual;
    function GetCellTextColor(ADrawStates: TcxCalendarElementStates)
      : TColor; virtual;
    property LookAndFeelPainter: TcxCustomLookAndFeelPainter
      read GetLookAndFeelPainter;
  public
  ...
  protected
    procedure DrawArrow(ACanvas: TcxCanvas;
      AViewInfo: TcxCalendarArrowViewInfo); override;
    procedure DrawDateCellBackground(ACanvas: TcxCanvas;
      AViewInfo: TcxCalendarDateCellViewInfo); override;
    procedure DrawDateCellSelection(ACanvas: TcxCanvas;
      AViewInfo: TcxCalendarDateCellViewInfo); override;
    procedure DrawDateHeaderCell(ACanvas: TcxCanvas;
      AViewInfo: TcxCalendarDateHeaderCellViewInfo); override;
    procedure DrawDateHeaderCellText(ACanvas: TcxCanvas;
      AViewInfo: TcxCalendarDateHeaderCellViewInfo); override;
    procedure DrawHeader(ACanvas: TcxCanvas;
      AViewInfo: TcxCalendarHeaderViewInfo); override;
    procedure DrawHeaderText(ACanvas: TcxCanvas;
      AViewInfo: TcxCalendarHeaderViewInfo); override;
    function GetCellTextColor(ADrawStates: TcxCalendarElementStates)
      : TColor; override;
  ...
  TcxCalendarGetDayOfWeekStateEvent = procedure(Sender: TObject;
    ...
    var ABackgroundColor: TColor) of object;

  TcxCalendarGetDayStateEvent = procedure(Sender: TObject; ADate: TDateTime;
  ...
  protected
    ...
    procedure InternalSetSelectDate(Value: Double;
      ARepositionVisibleDates: Boolean); overload;
    ...
    property ShowOnlyValidDates: Boolean read FShowOnlyValidDates
      write FShowOnlyValidDates;
  ...
  public
    ...
    property ArrowsForYear: Boolean read FArrowsForYear write SetArrowsForYear
      default True;
    property CalendarButtons: TDateButtons read FCalendarButtons
      write SetCalendarButtons;
    ...
    property TimeFormat: TcxTimeEditTimeFormat read FTimeFormat
      write SetTimeFormat default tfHourMinSec;
    property View: TcxCalendarView read FView write SetView;
    property Use24HourFormat: Boolean read FUse24HourFormat
    ...
    property OnGetDayOfWeekState: TcxCalendarGetDayOfWeekStateEvent
      read FOnGetDayOfWeekState write FOnGetDayOfWeekState;
    property OnGetDayState: TcxCalendarGetDayStateEvent read FOnGetDayState
      write FOnGetDayState;
  end;
  ...
  public
    ...
    property OnHidePopup: TcxEditClosePopupEvent read FOnHidePopup
      write FOnHidePopup;
  end;
  ...
  published
    ...
    property MaxDate: Boolean read GetMaxDate write SetMaxDate
      stored IsMaxDateStored;
    property MinDate: Boolean read GetMinDate write SetMinDate
      stored IsMinDateStored;
  end;
  ...
  private
    ...
    procedure CalendarGetDayOfWeekStateEventHandler(Sender: TObject;
      ADayOfWeek: TDay; AState: TCustomDrawState; AFont: TFont;
      var ABackgroundColor: TColor);
    procedure CalendarGetDayStateEventHandler(Sender: TObject; ADate: TDateTime;
      AState: TCustomDrawState; AFont: TFont; var ABackgroundColor: TColor);
  ...
  protected
    ...
    class function GetAssignedValuesClass
      : TcxCustomEditPropertiesValuesClass; override;
    function GetDisplayFormatOptions: TcxEditDisplayFormatOptions; override;
    function GetModeClass(AMaskKind: TcxEditMaskKind)
      : TcxMaskEditCustomModeClass; override;
    class function GetPopupWindowClass: TcxCustomEditPopupWindowClass; override;
    function IsEditValueEmpty(const AEditValue: TcxEditValue): Boolean;
      override;
    ...
    function GetTimeZoneInfo(APos: Integer; out AInfo: TcxTimeEditZoneInfo)
      : Boolean; virtual;
    procedure InternalPrepareEditValue(ADisplayValue: string;
      out AEditValue: TcxEditValue);
  ...
  public
    ...
    property ShowOnlyValidDates: Boolean read FShowOnlyValidDates
      write FShowOnlyValidDates default False;
  ...
  protected
    procedure KeyDown(var Key: Word; Shift: TShiftState); override;
    function IsPopupCalendarKey(Key: Word; Shift: TShiftState)
      : Boolean; virtual;
  public
    constructor Create(AOwnerControl: TWinControl); override;
  end;
  ...
  protected
    ...
    function IsCharValidForPos(var AChar: Char; APos: Integer)
      : Boolean; override;
    ...
    function GetRecognizableDisplayValue(ADate: TDateTime)
  ...
  public
    ...
    property ActiveProperties: TcxCustomDateEditProperties
  ...
  public
    class function GetFilterDataType(AValueTypeClass: TcxValueTypeClass)
      : TcxFilterDataType; override;
    class function GetFilterEditClass: TcxCustomEditClass; override;
    class function GetSupportedFilterOperators(AProperties
      : TcxCustomEditProperties; AValueTypeClass: TcxValueTypeClass;
...
const
  cxEditTimeFormatA: array [TcxTimeEditTimeFormat, Boolean] of string =
    (('hh:nn:ss ampm', 'hh:nn:ss'), ('hh:nn ampm', 'hh:nn'), ('hh ampm', 'hh'));
...
begin
  if AView <> cavDefault then
    Result := AView
  else if cxCalendarUseClassicViewAsDefault then
    Result := cavClassic
  else if cxIsTouchModeEnabled then
    Result := cavTouchUI
  else
    Result := cavModern;
end;

function CalendarElementStateToCustomDrawState
  (AStates: TcxCalendarElementStates): TCustomDrawState;
var
...
begin
  if (AYear < dxMinYear) or (AYear > dxMaxYear) or (AMonth < 1) or (AMonth > 12)
    or (ADay < 1) or (ADay > DaysInAMonth(AYear, AMonth)) then
    Result := InvalidDate
  else
...
procedure GetTimeFormat(const ADateTimeFormatInfo: TcxDateTimeFormatInfo;
  ...
  function GetFormatInfoItemIndex(AItemKind: TcxDateTimeFormatItemKind)
    : Integer;
  var
    I: Integer;
  begin
...
begin
  ...
  if AFormatInfoItemIndex <> -1 then
    AUse24HourFormat := Copy(ADateTimeFormatInfo.Items[AFormatInfoItemIndex]
      .Data, 1, 2) = '24'
  else
    AUse24HourFormat := False;
end;

function GetDateNavigatorContentColor(APainter: TcxCustomLookAndFeelPainter;
...
begin
  LookAndFeelPainter.DrawScaledClock(Canvas, ClientRect, TDateTime(FTime),
    BackgroundColor, ScaleFactor);
end;
...
procedure TcxMonthListBox.Popup(AFocusedControl: TWinControl);
  ...
  begin
    ...
    while (Result > 0) and
      (not Calendar.CanShowMonth(CalendarTable.ToDateTime(ADate)) or
  ...
  function GetItemCount(const ACurrentDate: TcxDateTime;
    ATopItemsCount: Cardinal): Cardinal;
  var
    ADate: TcxDateTime;
  ...
  begin
    if ShowYears then
      ...
      AMaxItemCount := CalendarTable.GetMonthsInYear(ACurrentDate.Year) -
        ACurrentDate.Month + ATopItemsCount + 1;

    ADate := CalendarTable.FromDateTime(CalendarTable.AddMonths(ACurrentDate,
      -ATopItemsCount));
    Result := 0;
    while (Result < AMaxItemCount) and
      Calendar.CanShowMonth(CalendarTable.ToDateTime(ADate)) and
...
begin
  ...
  begin
    ...
    if ShowYears then
      FOrigin.Y := (R.Top + R.Bottom) div 2 + TopMonthDelta * FItemHeight -
        FItemHeight div 2
    else
...
begin
  ...
  ADateMax := CalendarTable.AddMonths(FCurrentDate,
    FItemCount + ATopMonthDelta - 1);
...
begin
  if ItemIndex = -1 then
    ...
    Result := dxChangeDay(CalendarTable.AddMonths(FCurrentDate,
      TopMonthDelta + ItemIndex), 1);
end;
...
begin
  inherited Click;
  CloseUp;
  ADate := CalendarTable.FromDateTime(CalendarTable.AddMonths(FCurrentDate,
    TopMonthDelta));
  if ItemIndex <> -1 then
    Calendar.SetFirstDate
      (CalendarTable.AddMonths(CalendarTable.ToDateTime(ADate), ItemIndex));
end;
  ...
  begin
    ...
    begin
      ...
      if ShowYears then
        ...
        S := cxGetLocalMonthName(CalendarTable.ToDateTime(ADate),
          CalendarTable);
...
procedure TcxCalendarElementViewInfo.AddHandleNeededElement
  (AElement: TcxCalendarElementViewInfo);
begin
...
procedure TcxCalendarElementViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  FBounds := TdxRightToLeftLayoutConverter.ConvertRect(FBounds, ABounds);
end;

function TcxCalendarElementViewInfo.GetForbiddenStates
  : TcxCalendarElementStates;
begin
  Result := [];
end;
...
var
  I: Integer;
begin
  Result := (GetHitTestIndex <> cchtNone) and
    PtInElement((AHitTest as TcxCalendarHitTest).HitPoint);
  if Result then
    SetHitTest(AHitTest);
  for I := FVisibleElements.Count - 1 downto 0 do
    if (FVisibleElements[I] as TcxCalendarElementViewInfo).GetHitTest(AHitTest)
    then
    begin
      Result := True;
      Break;
...
procedure TcxCalendarElementViewInfo.KeyDown(var AKey: Word;
  AShift: TShiftState);
begin
end;
...
procedure TcxCalendarElementViewInfo.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
end;
...
procedure TcxCalendarElementViewInfo.Remove
  (AElement: TcxCalendarElementViewInfo);
begin
  FVisibleElements.Remove(AElement);
end;

procedure TcxCalendarElementViewInfo.RightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
  ...
  begin
    ...
    for I := 0 to VisibleElements.Count - 1 do
      (VisibleElements[I] as TcxCalendarElementViewInfo)
...
begin
  if not CanFade or not dxFader.DrawFadeImage(FadingHelper, ACanvas.Handle,
    Bounds) then
    DrawFadeImage(ACanvas);
end;

procedure TcxCalendarElementViewInfo.UpdateFader(const Value
  : TcxCalendarElementState);
begin
  if (Value = cesHot) and (FState = cesNormal) then
    FadingHelper.FadeIn
  else if (Value = cesNormal) and (FState = cesHot) then
...
function TcxCalendarElementViewInfo.GetLookAndFeelPainter
...
procedure TcxCalendarElementViewInfo.SetState(const Value
  : TcxCalendarElementState);
begin
...
constructor TcxCalendarArrowViewInfo.Create(ACalendar: TcxCustomCalendar;
...
const
  AAction: array [TcxCalendarModernDateViewStyle, adLeft .. adRight]
    of TcxCalendarArrow = ((caPrevMonth, caNextMonth), (caPrevYear, caNextYear),
    (caPrevDecade, caNextDecade), (caPrevCentury, caNextCentury));
begin
  Result := AAction[(ViewInfo.FDateViewInfo as TcxCalendarModernDateViewInfo)
    .ViewStyle, FDirection];
end;
...
procedure TcxCalendarDateCellViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
...
procedure TcxCalendarDateCellViewInfo.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
...
procedure TcxCalendarDateCellViewInfo.Paint(ACanvas: TcxCanvas);
  ...
  begin
    Result := (AValue <> InvalidDate) and
      cxGetLocalCalendar.IsValidDate(AValue);
  end;
...
procedure TcxCalendarDateCellViewInfo.UpdateFader
...
begin
  ...
  Result := cxRectCenter(Bounds, 3 * TdxTextMeasurer.TextWidthTO(Font, '0'),
    ASize.cy);
...
function TcxCalendarDayCellViewInfo.GetForbiddenStates
  : TcxCalendarElementStates;
begin
...
function TcxCalendarModernDayCellViewInfo.GetForbiddenStates
  : TcxCalendarElementStates;
begin
  Result := [];
end;
...
begin
  Result := dxGetTouchableSize
    (cxSizeInflate((ViewInfo as TcxCalendarModernViewInfo)
    .FMaxDayOfWeekNameSize, GetContentOffset), Calendar.ScaleFactor);
end;
...
begin
  Result := (ViewInfo as TcxCalendarModernViewInfo).DateViewInfo.TableViewInfo
    [cvdsYear].CellSize;
end;
...
begin
  Result := dxGetTouchableSize(cxSizeInflate(TdxTextMeasurer.TextSizeDT(Font,
    'Feb'), GetContentOffset), Calendar.ScaleFactor);
end;
...
begin
  FYear := cxGetLocalCalendar.GetYear(Calendar.SelectDate) div 10 * 10 - 1 +
    Word(Index);
...
begin
  Result := dxGetTouchableSize(cxSizeInflate(TdxTextMeasurer.TextSizeDT(Font,
    '9999'), GetContentOffset), Calendar.ScaleFactor);
end;
...
begin
  ...
  Result := dxGetTouchableSize(cxSizeInflate(Result, GetContentOffset),
    Calendar.ScaleFactor);
end;
...
function TcxCalendarDateTableViewInfo.CreateDateCell
  : TcxCalendarDateCellViewInfo;
begin
  Result := nil;
end;
...
function TcxCalendarDateTableViewInfo.GetSelectedCell
  : TcxCalendarDateCellViewInfo;
var
  I: Integer;
begin
...
function TcxCalendarDateTableViewInfo.GetDateInNextRow(ASelectDate: TDateTime)
  : TDateTime;
begin
  Result := NullDate;
end;

function TcxCalendarDateTableViewInfo.GetDateInPreviousRow
  (ASelectDate: TDateTime): TDateTime;
begin
  Result := NullDate;
end;

function TcxCalendarDateTableViewInfo.GetFirstDate(ASelectDate: TDateTime)
  : TDateTime;
begin
  Result := NullDate;
end;

function TcxCalendarDateTableViewInfo.GetFirstDateInRow(ASelectDate: TDateTime)
  : TDateTime;
begin
  Result := NullDate;
end;

function TcxCalendarDateTableViewInfo.GetLastDate(ASelectDate: TDateTime)
  : TDateTime;
begin
  Result := NullDate;
end;

function TcxCalendarDateTableViewInfo.GetLastDateInRow(ASelectDate: TDateTime)
  : TDateTime;
begin
  Result := NullDate;
end;

function TcxCalendarDateTableViewInfo.GetNextDate(ADate: TDateTime): TDateTime;
begin
  Result := NullDate;
end;

function TcxCalendarDateTableViewInfo.GetNextPageDate(ADate: TDateTime)
  : TDateTime;
begin
  Result := NullDate;
end;

function TcxCalendarDateTableViewInfo.GetPreviousDate(ADate: TDateTime)
  : TDateTime;
begin
  Result := NullDate;
end;

function TcxCalendarDateTableViewInfo.GetPreviousPageDate(ADate: TDateTime)
  : TDateTime;
begin
  Result := NullDate;
end;

function TcxCalendarDateTableViewInfo.GetDateCells(Index: Integer)
  : TcxCalendarDateCellViewInfo;
begin
...
begin
  ...
  begin
    ...
    ACellPos := Point(Bounds.Left + GetWeekNumbersRegionWidth + DateCells[I]
      .Column * DateCells[I].Size.cx, Bounds.Top + FDaysOfWeekHeight +
      DateCells[I].Row * DateCells[I].Size.cy);
    DateCells[I].Bounds := cxRectSetOrigin(ACellRect, ACellPos);
  end;
  inherited CalculateBounds;
end;

function TcxCalendarMonthTableViewInfo.CreateDateCell
  : TcxCalendarDateCellViewInfo;
begin
...
begin
  ...
  ACanvas.FillRect(Rect(ATextRect.Left - 8, ATextRect.Top, ATextRect.Left,
    ATextRect.Bottom + 2));
  ACanvas.FillRect(Rect(ATextRect.Right, ATextRect.Top, ATextRect.Right + 8,
    ATextRect.Bottom + 2));

  InternalPolyLine(ACanvas, [Point(ATextRect.Left, ATextRect.Bottom),
    Point(ATextRect.Right - 1, ATextRect.Bottom)],
  ...
  begin
    P1 := Point(ATextRect.Left, Calendar.ClientHeight -
      ViewInfo.FButtonsAreaHeight - 1);
    P2 := Point(ATextRect.Right - 1, Calendar.ClientHeight -
      ViewInfo.FButtonsAreaHeight - 1);
  ...
  begin
    ...
    if not IsRightToLeftConverted then
    begin
      AWeekNumbersDelimiterPos := Bounds.Left + FWeekNumberWidth +
        WeekNumbersDelimiterOffset.Left;
      ACanvas.FillRect(Rect(Bounds.Left, ATextRect.Top,
        AWeekNumbersDelimiterPos, Bounds.Bottom));
      InternalPolyLine(ACanvas, [Point(AWeekNumbersDelimiterPos, Bounds.Top),
        Point(AWeekNumbersDelimiterPos, ATextRect.Bottom - 1)],
        Calendar.BackgroundColor, True);
      if (ViewInfo.Kind = ckDate) and ViewInfo.IsButtonsVisible then
      begin
        P1 := Point(AWeekNumbersDelimiterPos, ATextRect.Bottom);
        P2 := Point(AWeekNumbersDelimiterPos, Calendar.ClientHeight -
          ViewInfo.FButtonsAreaHeight - 1);
        InternalPolyLine(ACanvas, [P1, P2], clBtnShadow, True);
        P1 := P2;
        P2 := Point(AWeekNumbersDelimiterPos + 1, Calendar.ClientHeight -
          ViewInfo.FButtonsAreaHeight - 1);
      ...
      begin
        InternalPolyLine(ACanvas, [Point(AWeekNumbersDelimiterPos,
          ATextRect.Bottom), Point(AWeekNumbersDelimiterPos, Bounds.Bottom - 3)
          ], LookAndFeelPainter.DefaultDateNavigatorSeparator1Color, True);
        InternalPolyLine(ACanvas, [Point(AWeekNumbersDelimiterPos,
          Bounds.Bottom - 2), Point(AWeekNumbersDelimiterPos, Bounds.Bottom - 1)
          ], Calendar.BackgroundColor, True);
      end;
      InternalPolyLine(ACanvas, [Point(AWeekNumbersDelimiterPos + 1,
        ATextRect.Bottom), Point(AWeekNumbersDelimiterPos + 1, ATextRect.Bottom)
        ], LookAndFeelPainter.DefaultDateNavigatorSeparator1Color, True);
      InternalPolyLine(ACanvas, [Point(AWeekNumbersDelimiterPos + 1,
        ATextRect.Bottom + 1), Point(AWeekNumbersDelimiterPos + 1,
        ATextRect.Bottom + 1)], ASeparator2Color, True);
      InternalPolyLine(ACanvas, [Point(AWeekNumbersDelimiterPos + 1,
        ATextRect.Bottom + 2), Point(AWeekNumbersDelimiterPos + 1,
        Bounds.Bottom - 1)], Calendar.BackgroundColor, True);
    end
    else
    begin
      AWeekNumbersDelimiterPos := Bounds.Right - FWeekNumberWidth -
        WeekNumbersDelimiterOffset.Left;
      ACanvas.Brush.Color := Calendar.BackgroundColor;
      ACanvas.FillRect(Rect(AWeekNumbersDelimiterPos, ATextRect.Top,
      ...
      begin
        ...
        InternalPolyLine(ACanvas, [P1, P2], clBtnShadow, True);
        P1 := P2;
        P2 := Point(AWeekNumbersDelimiterPos - 2, Calendar.ClientHeight -
          ViewInfo.FButtonsAreaHeight - 1);
        InternalPolyLine(ACanvas, [P2, P2], clBtnShadow, True);
      ...
      begin
        InternalPolyLine(ACanvas, [Point(AWeekNumbersDelimiterPos - 1,
          ATextRect.Bottom), Point(AWeekNumbersDelimiterPos - 1,
          Bounds.Bottom - 3)],
          LookAndFeelPainter.DefaultDateNavigatorSeparator1Color, True);
        InternalPolyLine(ACanvas, [Point(AWeekNumbersDelimiterPos - 1,
          Bounds.Bottom - 2), Point(AWeekNumbersDelimiterPos - 1,
          Bounds.Bottom - 2)], Calendar.BackgroundColor, True);
      end;
      InternalPolyLine(ACanvas, [Point(AWeekNumbersDelimiterPos - 2,
        ATextRect.Bottom), Point(AWeekNumbersDelimiterPos - 2, ATextRect.Bottom)
        ], LookAndFeelPainter.DefaultDateNavigatorSeparator1Color, True);
      InternalPolyLine(ACanvas, [Point(AWeekNumbersDelimiterPos - 2,
        ATextRect.Bottom + 1), Point(AWeekNumbersDelimiterPos - 2,
        ATextRect.Bottom + 1)], ASeparator2Color, True);
      InternalPolyLine(ACanvas, [Point(AWeekNumbersDelimiterPos - 2,
        ATextRect.Bottom + 2), Point(AWeekNumbersDelimiterPos - 2,
        Bounds.Bottom - 1)], Calendar.BackgroundColor, True);
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    try
      ...
      begin
        AColor := ACanvas.Brush.Color;
        Calendar.FOnGetDayOfWeekState(Calendar, J, [cdsDefault],
          ACanvas.Font, AColor);
      ...
      TrueTextRect(ACanvas.Canvas, ATextRect, ALeft,
...
begin
  ...
  begin
    ...
    ACanvas.DrawText(IntToStr(cxGetLocalCalendar.GetWeekNumber
      (Calendar.GetDateFromCell(0, I), TDay(cxFormatController.StartOfWeek),
      cxFormatController.FirstWeekOfYear)), R,
      AHorzAlign[IsRightToLeftConverted] or cxAlignVCenter);
  end;
  ACanvas.Font := Font;
end;
...
begin
  ...
  FWeekNumberWidth := TdxTextMeasurer.TextWidthTO(Font, '99',
    MulDiv(Font.Size, 2, 3));
end;
...
function TcxCalendarMonthTableViewInfo.GetDateInNextRow(ASelectDate: TDateTime)
  : TDateTime;
begin
...
function TcxCalendarMonthTableViewInfo.GetFirstDate(ASelectDate: TDateTime)
  : TDateTime;
begin
  Result := dxChangeDay(ASelectDate, 1);
end;

function TcxCalendarMonthTableViewInfo.GetFirstDateInRow(ASelectDate: TDateTime)
  : TDateTime;
begin
  Result := ASelectDate - dxDayOfWeekOffset(ASelectDate);
end;

function TcxCalendarMonthTableViewInfo.GetLastDate(ASelectDate: TDateTime)
  : TDateTime;
begin
  Result := dxGetEndDateOfMonth(ASelectDate, True);
end;

function TcxCalendarMonthTableViewInfo.GetLastDateInRow(ASelectDate: TDateTime)
  : TDateTime;
begin
...
function TcxCalendarMonthTableViewInfo.GetNextPageDate(ADate: TDateTime)
  : TDateTime;
begin
  Result := cxGetLocalCalendar.AddMonths(ADate, 1);
end;

function TcxCalendarMonthTableViewInfo.GetNextWeekDayTextRect(const ATextRect
  : TRect): TRect;
begin
  Result := ATextRect;
  if not IsRightToLeftConverted then
...
function TcxCalendarMonthTableViewInfo.GetPreviousDate(ADate: TDateTime)
  : TDateTime;
begin
  Result := ADate - 1;
end;

function TcxCalendarMonthTableViewInfo.GetPreviousPageDate(ADate: TDateTime)
  : TDateTime;
begin
  Result := cxGetLocalCalendar.AddMonths(ADate, -1);
end;
...
function TcxCalendarModernMonthTableViewInfo.CreateDateCell
  : TcxCalendarDateCellViewInfo;
begin
  Result := TcxCalendarModernDayCellViewInfo.Create(Calendar);
end;

procedure TcxCalendarModernMonthTableViewInfo.DrawDelimeters
  (ACanvas: TcxCanvas);
var
  R: TRect;
begin
...
begin
  ...
  if not IsRightToLeftConverted then
  begin
    ATextRect.Left := DateCells[0].Bounds.Left;
    // Bounds.Left + GetWeekNumbersRegionWidth;
    ATextRect.Right := ATextRect.Left;
  end
  else
  begin
  ...
  begin
    ...
    try
      ...
      S := GetDayOfWeekName(J, ACanvas.Font.Charset);
      cxDrawText(ACanvas, S, ATextRect, DT_WORDBREAK or DT_EDITCONTROL or
        DT_CENTER);
    finally
      ACanvas.RestoreState;
    end;
...
begin
  ...
  if AMinSize.cx < AMaxSize.cx then
    FCellSize.cx := DateCells[0].GetMinSize.cx + (AMaxSize.cx - AMinSize.cx)
      div GetTableSize.cx;
  if AMinSize.cy < AMaxSize.cy then
    FCellSize.cy := DateCells[0].GetMinSize.cy + (AMaxSize.cy - AMinSize.cy)
      div GetTableSize.cy;
...
function TcxCalendarModernYearTableViewInfo.CreateDateCell
  : TcxCalendarDateCellViewInfo;
begin
...
begin
  Result := cxGetLocalCalendar.GetYear(Calendar.FirstDate)
    = cxGetLocalCalendar.GetYear(ADate);
end;
...
function TcxCalendarModernYearTableViewInfo.GetFirstDate(ASelectDate: TDateTime)
  : TDateTime;
begin
...
function TcxCalendarModernYearTableViewInfo.GetLastDate(ASelectDate: TDateTime)
  : TDateTime;
begin
...
function TcxCalendarModernYearTableViewInfo.GetNextDate(ADate: TDateTime)
  : TDateTime;
begin
  Result := cxGetLocalCalendar.AddMonths(ADate, 1);
end;

function TcxCalendarModernYearTableViewInfo.GetNextPageDate(ADate: TDateTime)
  : TDateTime;
begin
  Result := cxGetLocalCalendar.AddYears(ADate, 1);
end;

function TcxCalendarModernYearTableViewInfo.GetPreviousDate(ADate: TDateTime)
  : TDateTime;
begin
  Result := cxGetLocalCalendar.AddMonths(ADate, -1);
end;
...
function TcxCalendarModernDecadeTableViewInfo.CreateDateCell
  : TcxCalendarDateCellViewInfo;
begin
...
begin
  Result := cxGetLocalCalendar.GetYear(Calendar.FirstDate)
    div 10 = cxGetLocalCalendar.GetYear(ADate) div 10;
end;
...
function TcxCalendarModernDecadeTableViewInfo.GetFirstDate
  (ASelectDate: TDateTime): TDateTime;
begin
  Result := dxChangeYear(ASelectDate, cxGetLocalCalendar.GetYear(ASelectDate)
    div 10 * 10);
end;
...
function TcxCalendarModernDecadeTableViewInfo.GetNextDate(ADate: TDateTime)
  : TDateTime;
begin
  Result := cxGetLocalCalendar.AddYears(ADate, 1);
end;

function TcxCalendarModernDecadeTableViewInfo.GetNextPageDate(ADate: TDateTime)
  : TDateTime;
begin
  Result := cxGetLocalCalendar.AddYears(ADate, 10);
end;

function TcxCalendarModernDecadeTableViewInfo.GetPreviousDate(ADate: TDateTime)
  : TDateTime;
begin
  Result := cxGetLocalCalendar.AddYears(ADate, -1);
end;
...
function TcxCalendarModernCenturyTableViewInfo.CreateDateCell
  : TcxCalendarDateCellViewInfo;
begin
...
begin
  Result := cxGetLocalCalendar.GetYear(Calendar.FirstDate)
    div 100 = cxGetLocalCalendar.GetYear(ADate) div 100;
end;
...
function TcxCalendarModernCenturyTableViewInfo.GetFirstDate
  (ASelectDate: TDateTime): TDateTime;
begin
  Result := dxChangeDecade(ASelectDate, cxGetLocalCalendar.GetYear(ASelectDate)
    div 100 * 100);
end;
...
function TcxCalendarModernCenturyTableViewInfo.GetNextDate(ADate: TDateTime)
  : TDateTime;
begin
  Result := cxGetLocalCalendar.AddYears(ADate, 10);
end;

function TcxCalendarModernCenturyTableViewInfo.GetNextPageDate(ADate: TDateTime)
  : TDateTime;
begin
  Result := cxGetLocalCalendar.AddYears(ADate, 100);
end;

function TcxCalendarModernCenturyTableViewInfo.GetPreviousDate(ADate: TDateTime)
  : TDateTime;
begin
  Result := cxGetLocalCalendar.AddYears(ADate, -10);
end;
...
procedure TcxCalendarDateHeaderCellViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
  FTextRect := TdxRightToLeftLayoutConverter.ConvertRect(FTextRect, ABounds);
...
function TcxCalendarDateHeaderCellViewInfo.GetDrawStates
  : TcxCalendarElementStates;
begin
  Result := [State];
  if not IsEnabled then
...
begin
  Result := (ViewInfo.DateViewInfo as TcxCalendarModernDateViewInfo).ViewStyle
    <> cvdsCentury;
end;
...
begin
  ...
  FArrowsViewInfo[adRight].Bounds :=
    cxRectOffsetHorz(FArrowsViewInfo[adLeft].Bounds,
    cxRectWidth(Bounds) - AArrowSize.cx);
  R := Bounds;
...
function TcxCalendarDateHeaderViewInfo.CreateTextCellViewInfo
  : TcxCalendarDateHeaderCellViewInfo;
begin
...
function TcxCalendarModernMonthDateHeaderViewInfo.CreateTextCellViewInfo
  : TcxCalendarDateHeaderCellViewInfo;
begin
...
function TcxCalendarYearDateHeaderViewInfo.CreateTextCellViewInfo
  : TcxCalendarDateHeaderCellViewInfo;
begin
...
function TcxCalendarDateHeadersViewInfo.CreateMonthHeaderViewInfo
  : TcxCalendarMonthDateHeaderViewInfo;
begin
...
begin
  ...
  begin
    ...
    ASpaceWidth := ADateRegionWidth - ABorderWidth * 2 - AHeaderOffset.Left -
      AHeaderOffset.Right - AMaxMonthNameWidth - AMaxYearNameWidth - 4 *
      AArrowSize.cx;
    AMonthRegionWidth := AMaxMonthNameWidth + ASpaceWidth *
      AMaxMonthNameWidth div (AMaxMonthNameWidth + AMaxYearNameWidth);
...
begin
  ...
  begin
    ASkinPainter.DrawScaledHeader(ACanvas, Bounds, cxEmptyRect, [],
      HeaderBorders[ViewInfo.Kind = ckDateTime], cxbsNormal, taCenter, vaCenter,
      False, False, '', Font, 0, 0, Calendar.ScaleFactor);
  end
  else if LookAndFeelPainter.LookAndFeelStyle = lfsNative then
    dxDrawThemeBackground(ACanvas.Handle, totHeader, Calendar.ScaleFactor,
      Bounds, HP_HEADERITEMLEFT, HIS_NORMAL)
  else if not AIsTransparent then
  ...
  if not AIsTransparent then
    ...
    else if ViewInfo.Kind = ckDateTime then
...
procedure TcxCalendarClassicDateHeadersViewInfo.
  CalculateMaxYearAndMonthNameLengths(var AMaxYearNameWidth, AMaxMonthNameWidth
  : Integer);
var
  I: Integer;
...
begin
  ...
  try
    for I := 1 to cxGetLocalCalendar.GetMonthsInYear(AConvertDate.Era,
      AConvertDate.Year) do
    begin
      AMonthNameWidth := cxScreenCanvas.TextWidth
        (cxGetLocalMonthName(cxGetLocalCalendar.AddMonths(Calendar.FirstDate,
        I), cxGetLocalCalendar));
      if AMonthNameWidth > AMaxMonthNameWidth then
        AMaxMonthNameWidth := AMonthNameWidth;
      AYearNameWidth := cxScreenCanvas.TextWidth
        (cxGetLocalYear(cxGetLocalCalendar.AddYears(Calendar.FirstDate, I),
        cxGetLocalCalendar));
...
function TcxCalendarModernDateHeadersViewInfo.CreateMonthHeaderViewInfo
  : TcxCalendarMonthDateHeaderViewInfo;
begin
...
begin
  ...
  H := MonthHeaderViewInfo.TextCellViewInfo.Size.cy +
    cxMarginsHeight(LookAndFeelPainter.GetModernCalendarHeaderTextOffsets);
...
begin
  R := Bounds;
  R.TopLeft := cxPoint(Bounds.Left + GetTableOffsets.Left,
    FHeadersViewInfo.Bounds.Bottom + GetTableOffsets.Top);
  FMonthTableViewInfo.Bounds :=
    cxRectSetSize(R, FMonthTableViewInfo.GetMinSize);
end;
...
begin
  ...
  Result.cy := FHeadersViewInfo.Size.cy + GetTableOffsets.Top +
    GetTableOffsets.Bottom + FMonthTableViewInfo.GetMinSize.cy;
end;
...
var
  ...
  ASize: TSize;
begin
  AScale := dxSizeF(StartState.Scale.cx + FScaleCoefficient.cx * APosition,
    StartState.Scale.cy + FScaleCoefficient.cy * APosition);
  AOffset := dxPointF(StartState.Offset.X + FOffsetCoefficient.X * APosition,
...
begin
  FScaleCoefficient := dxSizeF((EndState.Scale.cx - StartState.Scale.cx) /
    ALength, (EndState.Scale.cy - StartState.Scale.cy) / ALength);
  FOffsetCoefficient := dxPointF((EndState.Offset.X - StartState.Offset.X) /
    ALength, (EndState.Offset.Y - StartState.Offset.Y) / ALength);
...
function TcxCalendarModernDateViewAnimationController.AddImage
  : TcxCalendarAnimatedImageInfo;
begin
...
begin
  if (AValue <> FViewStyle) and (AValue >= Low(FViewStyle)) and
    (AValue <= High(FViewStyle)) then
  begin
...
begin
  ...
  begin
    ...
    begin
      FDirection := GetHorizontalAnimationDirection
        (AValue < Calendar.SelectDate);
      RecreateImage(FStartImage);
      InternalChangeSelectDate(AValue);
      Recalculate;
      RecreateImage(FEndImage);
...
begin
  FMaxTableSize.cx := Max(FMonthTableViewInfo.GetMinSize.cx,
    Max(FYearTableViewInfo.GetMinSize.cx,
    Max(FDecadeTableViewInfo.GetMinSize.cx,
    FCenturyTableViewInfo.GetMinSize.cx)));
  FMaxTableSize.cy := Max(FMonthTableViewInfo.GetMinSize.cy,
    Max(FYearTableViewInfo.GetMinSize.cy,
    Max(FDecadeTableViewInfo.GetMinSize.cy,
    FCenturyTableViewInfo.GetMinSize.cy)));
  inherited CalculateChildSizes;
end;
...
begin
  ...
  Calendar.InternalSetSelectDate(dxChangeDay(Calendar.FirstDate,
    ASelectDate.Day));
end;
...
begin
  ...
  FCenturyTableViewInfo := TcxCalendarModernCenturyTableViewInfo.Create
    (Calendar);
end;
...
begin
  ...
  Result.cy := FHeadersViewInfo.Size.cy + GetTableOffsets.Top +
    GetTableOffsets.Bottom + FMaxTableSize.cy;
end;

function TcxCalendarModernDateViewInfo.GetHorizontalAnimationDirection
  (ARight: Boolean): TcxDirection;
begin
  if ARight then
    Result := dirRight
  else
...
begin
  if (AShift = [ssCtrl]) and (AKey in [VK_UP, VK_DOWN]) then
    if AKey = VK_UP then
      ...
      PreviousViewStyle
  else if AKey in [VK_SPACE, VK_RETURN] then
    PreviousViewStyle
  else
...
{$ENDIF}
  ...
  begin
    ...
    ACanvas.ExcludeClipRect
      (HeadersViewInfo.MonthHeaderViewInfo.TextCellViewInfo.Bounds);
...
procedure TcxCalendarModernDateViewInfo.InternalSetViewStyle
  (AValue: TcxCalendarModernDateViewStyle);
begin
...
procedure TcxCalendarModernDateViewInfo.RecreateImage
  (var AImage: TdxSmartImage);
var
  ABitmap: TcxBitmap;
  ACanvas: TcxCanvas;
begin
...
begin
  ...
  begin
    AState.Scale := dxSizeF(cxRectWidth(FNextSelectCellBounds) /
      cxRectWidth(FTableAreaBounds), cxRectHeight(FNextSelectCellBounds) /
      cxRectHeight(FTableAreaBounds));
    AState.Offset := dxPointF(GetRectCenterOffset(FTableAreaBounds,
      FNextSelectCellBounds));
  end
  else
  begin
    AScale := dxSizeF(cxRectWidth(FTableAreaBounds) /
      cxRectWidth(FPrevSelectCellBounds), cxRectHeight(FTableAreaBounds) /
      cxRectHeight(FPrevSelectCellBounds));
    AState.Scale := AScale;
  ...
  if FDirection = dirUp then
  begin
    AState.Scale := dxSizeF(cxRectWidth(FTableAreaBounds) /
      cxRectWidth(FNextSelectCellBounds), cxRectHeight(FTableAreaBounds) /
      cxRectHeight(FNextSelectCellBounds));
    AOffset := GetRectCenterOffset(FNextSelectCellBounds, FTableAreaBounds);
    AState.Offset := dxPointF(AOffset.X * AState.Scale.cx,
      AOffset.Y * AState.Scale.cy);
  end
  else
  begin
    AState.Scale := dxSizeF(cxRectWidth(FPrevSelectCellBounds) /
      cxRectWidth(FTableAreaBounds), cxRectHeight(FPrevSelectCellBounds) /
      cxRectHeight(FTableAreaBounds));
    AState.Offset := dxPointF(GetRectCenterOffset(FTableAreaBounds,
      FPrevSelectCellBounds));
  end;
  AImageInfo.StartState := AState;
  AState.Alpha := 255;
  AState.Scale := dxSizeF(1, 1);
...
function TcxCalendarModernDateViewInfo.GetCurrentTableViewInfo
  : TcxCalendarDateTableViewInfo;
begin
  Result := GetTableViewInfo(FViewStyle);
end;

function TcxCalendarModernDateViewInfo.GetTableViewInfo
  (AViewStyle: TcxCalendarModernDateViewStyle): TcxCalendarDateTableViewInfo;
begin
  case AViewStyle of
    cvdsMonth:
...
begin
  ...
  if dxGetMonthNumber(Calendar.SelectDate) <> dxGetMonthNumber(Date) then
    (ViewInfo.DateViewInfo as TcxCalendarModernDateViewInfo)
      .ChangeViewStyle(cvdsMonth, False);
  ViewInfo.SetSelectDate(Date, True, Calendar.CanAnimate and
    ((ViewInfo.DateViewInfo as TcxCalendarModernDateViewInfo)
    .ViewStyle = cvdsMonth));
  (ViewInfo.DateViewInfo as TcxCalendarModernDateViewInfo).ViewStyle :=
    cvdsMonth;
end;
...
begin
  Result := inherited DoCalculateSize;
  Inc(Result.cy, cxMarginsHeight
    (LookAndFeelPainter.GetModernCalendarHeaderTextOffsets));
end;
...
procedure TcxCalendarClockViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
  FClock.BoundsRect := TdxRightToLeftLayoutConverter.ConvertRect
    (FClock.BoundsRect, ABounds);
end;
...
procedure TcxCalendarTimeEditViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
  FTimeEdit.BoundsRect := TdxRightToLeftLayoutConverter.ConvertRect
    (FTimeEdit.BoundsRect, ABounds);
end;
...
begin
  ...
  cxScreenCanvas.Font := Font;
  Result := FTimeEdit.ActiveProperties.GetEditSize(cxScreenCanvas,
    FTimeEdit.Style, True, 0, AEditSizeProperties).cx +
    cxScreenCanvas.TextWidth('0');
  cxScreenCanvas.Dormant;
end;
...
begin
  ...
  AButtonVOffset := (ViewInfo.FButtonsAreaHeight - 1 -
    ViewInfo.FButtonsHeight) div 2;
...
function TcxCalendarTimeViewInfo.CreateTimeEditViewInfo
  : TcxCalendarTimeEditViewInfo;
begin
...
function TcxCalendarModernTimeViewInfo.CreateClockViewInfo
  : TcxCalendarClockViewInfo;
begin
...
begin
  R := Bounds;
  ATimeEditOffset := (ViewInfo.FButtonsAreaHeight -
    FTimeEditInfo.Size.cy) div 2;
...
constructor TcxCalendarButtonViewInfo.Create(ACalendar: TcxCustomCalendar;
...
procedure TcxCalendarButtonViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
  FButton.BoundsRect := TdxRightToLeftLayoutConverter.ConvertRect
    (FButton.BoundsRect, ABounds);
end;
...
begin
  ...
  FButton.Enabled := (FType in [btnClear, btnOk, btnCancel]) or
    Calendar.CanShowDate(Date);
  if FType = btnOk then
    FButton.Default := True
end;
...
const
  AButtonType: array [Ord(btnClear) .. Ord(High(TCalendarButton))
    ] of TCalendarButton = (btnToday, btnNow, btnClear, btnOk, btnCancel);
var
  I: Integer;
begin
...
procedure TcxCalendarButtonsViewInfo.DoCalculateBounds;
  ...
  begin
    Result := cxRectBounds((Calendar.Width - FMaxButtonWidth -
      Byte(VisibleElementsCount = 2) * FMaxButtonWidth)
      div (3 - Byte(VisibleElementsCount = 1)), Calendar.ClientHeight -
      ViewInfo.FButtonsAreaHeight + ViewInfo.FButtonsOffset,
  ...
  begin
    Result := cxRectBounds(Calendar.Width - FMaxButtonWidth -
      (Calendar.Width - Byte(VisibleElementsCount = 2) * FMaxButtonWidth -
      FMaxButtonWidth) div (3 - Byte(VisibleElementsCount = 1)),
      Calendar.ClientHeight - ViewInfo.FButtonsAreaHeight +
      ViewInfo.FButtonsOffset, FMaxButtonWidth + 1, ViewInfo.FButtonsHeight);
  end;
  ...
  begin
    ...
    (VisibleElements[VisibleElementsCount - 1] as TcxCalendarElementViewInfo)
      .Bounds := cxRectBounds(Bounds.Right - AButtonsOffset - FMaxButtonWidth -
      1, AButtonsTop, FMaxButtonWidth + 1, ViewInfo.FButtonsHeight);
    if VisibleElementsCount > 1 then
      if VisibleElementsCount = 2 then
        (VisibleElements[0] as TcxCalendarElementViewInfo).Bounds :=
          cxRectBounds((VisibleElements[1] as TcxCalendarElementViewInfo)
          .Bounds.Left - AButtonsOffset - FMaxButtonWidth - 1, AButtonsTop,
          FMaxButtonWidth + 1, ViewInfo.FButtonsHeight)
      else
      begin
        ...
        begin
          (VisibleElements[I] as TcxCalendarElementViewInfo).Bounds :=
            cxRectBounds(AButtonLeft, AButtonsTop, FMaxButtonWidth + 1,
            ViewInfo.FButtonsHeight);
...
begin
  ...
  Result.cx := (FMaxButtonWidth + ViewInfo.GetButtonSpace) *
    VisibleElementsCount + ViewInfo.GetButtonSpace;
  Result.cy := ViewInfo.FButtonsAreaHeight;
end;

function TcxCalendarButtonsViewInfo.IsNative: Boolean;
begin
  Result := FButtons[btnToday].FButton.LookAndFeel.NativeStyle and
...
begin
  for AButtonType := Low(TCalendarButton) to High(TCalendarButton) do
  begin
    FButtons[AButtonType] := TcxCalendarButtonViewInfo.Create(Calendar,
      AButtonType);
...
begin
  ...
  for AType := Low(TCalendarButton) to High(TCalendarButton) do
    FMaxButtonWidth := Max(FMaxButtonWidth, FButtons[AType].GetCaptionWidth);
  Inc(FMaxButtonWidth, ViewInfo.FColWidth);
  Result.cx := (FMaxButtonWidth + GetButtonsOffset) * VisibleElementsCount +
    GetButtonsOffset;
  Result.cy := ViewInfo.FButtonsAreaHeight;
end;
...
begin
  ...
  if (Kind = ckDate) and
    (FCalendar.LookAndFeelPainter.LookAndFeelStyle = lfsOffice11) then
    Dec(FHeaderHeight);

  FButtonsOffset := FFontSize div 2;
  FButtonsHeight := dxGetTouchableSize(MulDiv(ATextHeight, 20, 13) + 1,
    Calendar.ScaleFactor);
  ...
  begin
    ...
    FButtonsAreaHeight := FButtonsOffset + (FButtonsHeight - 1) +
      MulDiv(FFontSize, 3, 4);
...
begin
  ...
  Result.cx := DateViewInfo.Size.cx + GetDateInfoOffsets.Left +
    GetDateInfoOffsets.Right;
  if IsTimeVisible then
  begin
    FTimeViewInfo.Height := Result.cy - FButtonsViewInfo.Size.cy - FHeaderHeight
      - Calendar.GetMonthCalendarOffset.Y;
...
procedure TcxCalendarViewInfo.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
  if AllowHidePopupOnMouseUp and not Calendar.IsShowOnlyValidDates then
    Calendar.Hide(crEnter);
end;
...
procedure TcxCalendarViewInfo.DoCalculateBounds;
  ...
  begin
    Result := cxPoint(FSpaceWidth + GetDateInfoOffsets.Left,
      FHeaderViewInfo.Bounds.Bottom);
    if IsTimeVisible then
...
procedure TcxCalendarViewInfo.SetSelectDate(AValue: Double;
  ARepositionVisibleDates: Boolean; AAnimated: Boolean);
begin
  if (Calendar.SelectDate <> AValue) and Calendar.CanShowDate(AValue) and
    cxIsDateValid(AValue) then
...
begin
  inherited Initialize;
  FMonthListBox.ShowYears := not Calendar.ArrowsForYear or
    Calendar.YearsInMonthList;
end;

function TcxCalendarClassicViewInfo.GetMonthListBoxOwnerBounds: TRect;
begin
  Result := DateViewInfo.HeadersViewInfo.MonthHeaderViewInfo.
    TextCellViewInfo.Bounds;
end;

function TcxCalendarClassicViewInfo.CreateButtonsViewInfo
  : TcxCalendarButtonsViewInfo;
begin
...
function TcxCalendarClassicViewInfo.CreateHeaderViewInfo
  : TcxCalendarHeaderViewInfo;
begin
...
function TcxCalendarModernViewInfo.CreateButtonsViewInfo
  : TcxCalendarButtonsViewInfo;
begin
...
function TcxCalendarModernViewInfo.CreateHeaderViewInfo
  : TcxCalendarHeaderViewInfo;
begin
...
begin
  Result := inherited AllowHidePopupOnMouseUp and
    (DateViewInfo.ViewStyle = cvdsMonth);
end;
...
begin
  ...
  if FDateViewInfo.Size.cx < FButtonsViewInfo.Size.cx then
    R.Left := GetDateInfoOffsets.Left +
      (FButtonsViewInfo.Size.cx - FDateViewInfo.Size.cx) div 2
  else
    R.Left := GetDateInfoOffsets.Left;
...
begin
  ...
  if IsHeaderVisible then
    Result.cy := Result.cy + Max(FHeaderHeight, FHeaderViewInfo.Size.cy) +
      GetHeaderOffset;
...
begin
  ...
  case DateViewInfo.ViewStyle of
    cvdsMonth:
      Result := cxGetLocalMonthYear(ASelectDate, cxGetLocalCalendar);
    cvdsYear:
      Result := cxGetLocalYear(ASelectDate, cxGetLocalCalendar);
    cvdsDecade:
      Result := GetYearsGroup(ASelectDate, 10);
  else // cvdsCentury
...
function TcxCalendarModernViewInfo.GetDateViewInfo
  : TcxCalendarModernDateViewInfo;
begin
  Result := inherited DateViewInfo as TcxCalendarModernDateViewInfo;
end;

function TcxCalendarModernViewInfo.GetHeaderViewInfo
  : TcxCalendarModernHeaderViewInfo;
begin
...
function TcxCalendarTouchUIViewInfo.CreateButtonsViewInfo
  : TcxCalendarButtonsViewInfo;
begin
...
procedure TcxCalendarTouchUIViewInfo.DoSetFirstDate(Value: Double;
  AAnimated: Boolean);
begin
  Calendar.InternalSetFirstDate(Value);
end;

procedure TcxCalendarTouchUIViewInfo.DoSetSelectDate(AValue: Double;
  ARepositionVisibleDates: Boolean; AAnimated: Boolean);
begin
  Calendar.InternalSetSelectDate(AValue);
end;
...
begin
  ...
  FDateTimeWheelPicker.Style.LookAndFeel.MasterLookAndFeel :=
    Calendar.LookAndFeel;
  if Calendar.LookAndFeel.NativeStyle then
    FDateTimeWheelPicker.Style.BorderStyle := ebsNone
  else
  begin
    FDateTimeWheelPicker.Style.AssignedValues :=
      FDateTimeWheelPicker.Style.AssignedValues - [csvBorderStyle];
...
function TcxCalendarTouchUIViewInfo.IsButtonVisible
  (AType: TCalendarButton): Boolean;
begin
...
begin
  ...
  if IsTimeVisible then
    Result := dxDateOf(Result) + cxSign(Result) *
      dxTimeOf(TDateTime(Calendar.Time));
end;
...
begin
  ...
  begin
    if (FPressedElement <> nil) and (FPressedElement.State <> cesSelected) then
...
begin
  ...
  if ViewInfo.FMonthListBox.Showing then
...
begin
  ...
  if FCalendar.IsPopup then
    case AKey of
      VK_ESCAPE:
        if not ViewInfo.FMonthListBox.ShowYears and ViewInfo.FMonthListBox.IsVisible
        then
          ViewInfo.FMonthListBox.CloseUp
        else
...
begin
  ...
  begin
    ...
    Result := HitTest.HitAtMonthDateHeader or HitTest.HitAtYearDateHeader;
  end;
end;
...
begin
  ...
  begin
    ...
    InternalPolyLine(ACanvas, [Point(R.Left, R.Bottom - 1), Point(R.Right - 1,
      R.Bottom - 1)], FCalendar.GetHeaderColor, True);
    if FCalendar.FFlat and (FCalendar.Kind = ckDate) and
      (LookAndFeelPainter.LookAndFeelStyle <> lfsOffice11) then
      Inc(R.Top);
    Dec(R.Bottom);
  end;
  ...
  LookAndFeelPainter.CalculateArrowPoints(R, P,
    AViewInfo.GetRealDirection, False);
  ACanvas.Brush.Color :=
    LookAndFeelPainter.DefaultDateNavigatorHeaderTextColor(False);
  ACanvas.Pen.Color :=
    LookAndFeelPainter.DefaultDateNavigatorHeaderTextColor(False);
  ACanvas.Polygon(P);
...
begin
  R := AViewInfo.Bounds;
  R1 := R;
  InternalPolyLine(ACanvas, [R1.TopLeft, Point(R1.Right - 1, R1.Top)],
    FCalendar.ContainerBorderColor, True);
  Inc(R1.Top);
...
procedure TcxCalendarPainter.DrawDateCellBackground(ACanvas: TcxCanvas;
...
procedure TcxCalendarPainter.DrawDateCellSelection(ACanvas: TcxCanvas;
  AViewInfo: TcxCalendarDateCellViewInfo);
begin
  LookAndFeelPainter.DrawCalendarDateCellSelection(ACanvas, AViewInfo.Bounds,
    AViewInfo.GetDrawStates);
end;
...
var
  ...
  ASize: TSize;
begin
  AFormat := { DT_WORDBREAK or } SystemAlignmentsHorz[AViewInfo.HorzAlignment]
    or DT_EDITCONTROL;
...
begin
  ...
  ACanvas.Font.Color := LookAndFeelPainter.DefaultDateNavigatorHeaderTextColor
    (AViewInfo.State = cesHot);
  R := AViewInfo.Bounds;
  FCalendar.CorrectHeaderTextRect(R);
  cxDrawText(ACanvas, AViewInfo.GetText, R, DT_CENTER + DT_VCENTER +
...
function TcxCalendarPainter.GetCellTextColor(ADrawStates
  : TcxCalendarElementStates): TColor;
begin
...
procedure TcxCalendarModernPainter.DrawArrow(ACanvas: TcxCanvas;
  AViewInfo: TcxCalendarArrowViewInfo);
begin
  LookAndFeelPainter.DrawScaledModernCalendarArrow(ACanvas, AViewInfo.Bounds,
    AViewInfo.GetRealDirection, AViewInfo.State, FCalendar.ScaleFactor);
end;
...
begin
  ...
  if [cesSelected, cesHot, cesMarked] * AStates <> [] then
    LookAndFeelPainter.DrawModernCalendarDateCellSelection(ACanvas,
      AViewInfo.Bounds, AStates);
end;
...
begin
  ...
  LookAndFeelPainter.DrawModernCalendarDateHeaderSelection(ACanvas,
    cxRectInflate((AViewInfo.TextRect),
    LookAndFeelPainter.GetModernCalendarHeaderTextOffsets),
    AViewInfo.GetDrawStates);
end;
...
begin
  ACanvas.Font := AViewInfo.Font;
  ACanvas.Font.Color := LookAndFeelPainter.GetModernCalendarDateHeaderTextColor
    (AViewInfo.GetDrawStates);
  cxDrawText(ACanvas, AViewInfo.GetText, AViewInfo.TextRect, DT_WORDBREAK or
    DT_EDITCONTROL);
end;
...
{$ENDIF}
  ACanvas.Font := AViewInfo.Font;
  LookAndFeelPainter.DrawModernCalendarHeaderSelection(ACanvas,
    cxRectInflate(AViewInfo.TextRect, AViewInfo.TextOffsets),
    [AViewInfo.State]);
end;
...
procedure TcxCalendarModernPainter.DrawHeaderText(ACanvas: TcxCanvas;
  AViewInfo: TcxCalendarHeaderViewInfo);
begin
  ACanvas.Font.Color := LookAndFeelPainter.GetModernCalendarHeaderTextColor
    ([AViewInfo.State]);
  cxDrawText(ACanvas, AViewInfo.GetText, AViewInfo.TextRect, DT_WORDBREAK or
    DT_EDITCONTROL);
end;
...
begin
  if Assigned(FOnDateTimeChanged) then
...
begin
  if (Kind = ckDate) and (LookAndFeelPainter.LookAndFeelStyle = lfsOffice11)
  then
    Result := Rect(Office11HeaderOffset, Office11HeaderOffset,
      Office11HeaderOffset, 0)
  else
    Result := cxEmptyRect;
end;
...
function TcxCustomCalendar.InternalMouseWheel(Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
  Result := inherited InternalMouseWheel(Shift, WheelDelta, MousePos);
  if not Result and FController.IsMouseWheelHandleNeeded(Shift, WheelDelta,
    MousePos) then
...
function TcxCustomCalendar.IsMouseWheelHandleNeeded(Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
...
procedure TcxCustomCalendar.MouseDown(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
...
procedure TcxCustomCalendar.DrawOpaqueBackground(ACanvas: TcxCanvas;
  const ARect: TRect);
begin
...
function TcxCustomCalendar.CalculateNextDate(ADate: Double;
  AArrow: TcxCalendarArrow): Double;
begin
  case AArrow of
    caPrevMonth:
...
procedure TcxCustomCalendar.HidePopup(Sender: TcxControl;
  AReason: TcxEditCloseUpReason);
begin
...
procedure TcxPopupCalendar.HidePopup(Sender: TcxControl;
  AReason: TcxEditCloseUpReason);
begin
  inherited HidePopup(Sender, AReason);
...
function TcxCustomDateEditProperties.GetAssignedValues
  : TcxDateEditPropertiesValues;
begin
...
begin
  ...
  else if GetCalendarRealView(View) = cavClassic then
...
procedure TcxCustomDateEditProperties.CalendarGetDayOfWeekStateEventHandler
  (Sender: TObject; ADayOfWeek: TDay; AState: TCustomDrawState; AFont: TFont;
  var ABackgroundColor: TColor);
begin
...
procedure TcxCustomDateEditProperties.CalendarGetDayStateEventHandler
  (Sender: TObject; ADate: TDateTime; AState: TCustomDrawState; AFont: TFont;
  var ABackgroundColor: TColor);
begin
...
begin
  ...
  begin
    if Kind = ckDateTime then
      ...
      Result := (ShowTime and (dxTimeOf(ADate) <> 0) and
        (InputKind = ikStandard)) or (EditFormat <> '');
  end
  else
...
procedure TcxCustomDateEditProperties.DoAssign(AProperties
...
class function TcxCustomDateEditProperties.GetAssignedValuesClass
  : TcxCustomEditPropertiesValuesClass;
begin
  Result := TcxDateEditPropertiesValues;
end;

function TcxCustomDateEditProperties.GetDisplayFormatOptions
  : TcxEditDisplayFormatOptions;
begin
  Result := [dfoSupports, dfoNoCurrencyValue];
end;

function TcxCustomDateEditProperties.GetModeClass(AMaskKind: TcxEditMaskKind)
  : TcxMaskEditCustomModeClass;
begin
...
class function TcxCustomDateEditProperties.GetPopupWindowClass
  : TcxCustomEditPopupWindowClass;
begin
  Result := TcxDateEditPopupWindow;
end;

function TcxCustomDateEditProperties.IsEditValueEmpty(const AEditValue
...
begin
  ...
  begin
    ...
    Result := Result + Copy(S, Length(S) - ATimeStringLength + 1,
      ATimeStringLength);
  end;
end;
...
begin
  if not GetTimeZoneInfo(APos, ATimeZoneInfo) then
    Result := ' '
  else if ATimeZoneInfo.Kind = tzTimeSuffix then
    Result := #0
  else
    Result := '0';
end;
...
begin
  Result := False;
  if (Kind <> ckDateTime) or (InputKind <> ikMask) or cxFormatController.AssignedStandardDateTimeEditMask
  then
    Exit;
  Result := cxFormatController.GetDateTimeFormatItemStandardMaskInfo
    (cxFormatController.DateTimeFormatInfo, APos, AItemInfo);
  Result := Result and (AItemInfo.Kind in [dtikHour, dtikMin, dtikSec,
    dtikTimeSuffix]);
  if Result then
  begin
    ...
    AInfo.Use24HourFormat := not cxFormatController.DateTimeFormatInfo.
      DefinedItems[dtikTimeSuffix];
  end;
end;
...
begin
  ...
  if not InternalCompareString(ADisplayValue, GetEmptyDisplayValue(True), True)
  then
  begin
    if TextToDateEx(ADisplayValue, ADate, EditFormat) then
      AEditValue := ADate
    else if DateOnError = deToday then
      if Kind = ckDate then
...
function TcxCustomDateEditProperties.GetEditValueSource(AEditFocused: Boolean)
  : TcxDataEditValueSource;
begin
  Result := GetValueEditorEditValueSource(AEditFocused);
end;

function TcxCustomDateEditProperties.IsDisplayValueValid(var DisplayValue
  : TcxEditValue; AEditFocused: Boolean): Boolean;
var
  ADate: TDateTime;
begin
...
function TcxCustomDateEditProperties.IsEditValueValid(var EditValue
  : TcxEditValue; AEditFocused: Boolean): Boolean;
var
  AValue: TcxEditValue;
begin
...
procedure TcxCustomDateEditProperties.DoPrepareDisplayValue(const AEditValue
  : TcxEditValue; var ADisplayValue: TcxEditValue; AEditFocused: Boolean);
  ...
  begin
    ...
    else if not(VarIsStr(AEditValue) or VarIsDate(AEditValue) or
      VarIsNumericEx(AEditValue)) then
      raise EConvertError.CreateFmt
        (cxGetResourceString(@cxSEditDateConvertError), [])
    else
    begin
      ...
      if AEditFocused then
        if EditFormat <> '' then
          ...
          Result := DateTimeToTextEx(AValue, InputKind = ikMask,
            Kind = ckDateTime)
...
begin
  ...
  if AEditFocused and IsMasked and cxFormatController.IsStandardMaskValid and
    (EditFormat = '') then
    inherited DoPrepareDisplayValue(ADisplayValue, ADisplayValue, AEditFocused);
end;

procedure TcxCustomDateEditProperties.ValidateDisplayValue(var ADisplayValue
  ...
  begin
    ...
    begin
      AEditValueChanged := not InternalVarEqualsExact(ADateEdit.FEditValue,
        ADateEdit.FSavedTime);
...
function TcxDateEditPopupWindow.IsPopupCalendarKey(Key: Word;
  ...
  begin
    ...
    begin
      ...
      Result := (AContainer is TcxTimeEdit) and not TcxTimeEdit(AContainer)
        .ModifiedAfterEnter;
    end;
  end;

begin
  Result := (Key = VK_ESCAPE) and CanEscape or ((Key = VK_UP) or (Key = VK_DOWN)
    ) and (ssAlt in Shift) or (Key = VK_F4) and not(ssAlt in Shift);
end;
...
begin
  ...
  try
    ...
    if ActiveProperties.Kind = ckDateTime then
      ADate := dxDateOf(ADate) + cxSign(ADate) *
        dxTimeOf(TDateTime(Calendar.Time))
    else if ActiveProperties.SaveTime and (ADate <> NullDate) then
      if ADate >= 0 then
        ADate := ADate + dxTimeOf(FDateDropDown)
      else
        ADate := ADate - dxTimeOf(FDateDropDown);
    ADisplayValue := GetRecognizableDisplayValue(ADate);
    if ((Date <> ADate) or not InternalCompareString(DisplayText,
      VarToStr(ADisplayValue), True)) and DoEditing then
    begin
...
function TcxCustomDateEdit.GetRecognizableDisplayValue(ADate: TDateTime)
  : TcxEditValue;
...
begin
  ...
  begin
    ...
    Result := DateTimeToTextEx(ADate, False,
      ActiveProperties.Kind = ckDateTime, True);
    Result := TrimRight(Result);
  end
  else
...
begin
  ...
  try
    ...
    else if ActiveProperties.IsValueBoundDefined(evbMax) and
...
begin
  ...
  try
    ...
    Calendar.Flat := PopupControlsLookAndFeel.Kind
      in [lfFlat, lfUltraFlat, lfOffice11];
    ...
    if ActiveProperties.AssignedValues.MaxDate and
      (ActiveProperties.MaxDate <> NullDate) then
      Calendar.MaxDate := ActiveProperties.MaxDate
    else
      Calendar.MaxDate := MaxDateTime;

    if ActiveProperties.AssignedValues.MinDate and
      (ActiveProperties.MinDate <> NullDate) then
...
procedure TcxCustomDateEdit.InternalSetEditValue(const Value: TcxEditValue;
  ...
  var
    ADate: TDateTime;
  begin
    if not ActiveProperties.SaveTime or
      not(VarIsStr(Value) or VarIsNumericEx(Value) or VarIsDate(Value)) then
      FSavedTime := 0
    else if VarIsStr(Value) then
    begin
      cxStrToDateTime(Value,
...
procedure TcxCustomDateEdit.InternalValidateDisplayValue(const ADisplayValue
  : TcxEditValue);
begin
...
begin
  ...
  FCalendar.OnGetDayOfWeekState :=
    ActiveProperties.CalendarGetDayOfWeekStateEventHandler;
end;
...
class function TcxCustomDateEdit.GetPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TcxCustomDateEditProperties;
end;

procedure TcxCustomDateEdit.PrepareEditValue(const ADisplayValue: TcxEditValue;
...
class function TcxFilterDateEditHelper.GetFilterDataType(AValueTypeClass
  : TcxValueTypeClass): TcxFilterDataType;
begin
  Result := fdtDate;
end;
...
begin
  ...
  if AExtendedSet then
    Result := Result + [fcoBetween, fcoNotBetween, fcoInList, fcoNotInList,
      fcoYesterday, fcoToday, fcoTomorrow, fcoLast7Days, fcoLastWeek,
      fcoLast14Days, fcoLastTwoWeeks, fcoLast30Days, fcoLastMonth, fcoLastYear,
      fcoInPast, fcoThisWeek, fcoThisMonth, fcoThisYear, fcoNext7Days,
      fcoNextWeek, fcoNext14Days, fcoNextTwoWeeks, fcoNext30Days, fcoNextMonth,
      fcoNextYear, fcoInFuture];
end;
...
GetRegisteredEditProperties.Register(TcxDateEditProperties,
  scxSEditRepositoryDateItem);
FilterEditsController.Register(TcxDateEditProperties, TcxFilterDateEditHelper);

finalization

FilterEditsController.Unregister(TcxDateEditProperties,
  TcxFilterDateEditHelper);
