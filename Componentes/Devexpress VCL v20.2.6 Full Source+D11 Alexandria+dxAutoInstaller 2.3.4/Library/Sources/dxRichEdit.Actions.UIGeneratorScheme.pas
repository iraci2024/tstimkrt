...
const
  ...
  dxRichEditBarShapeStylesPictureName =
    'Rich Edit\FloatingObjectOutlineColor_16x16.png';
  ...
  dxRichEditBarRowAndColumnsPictureName =
    'Rich Edit\InsertTableRowsAbove_16x16.png';
...
constructor TdxRichEditControlUIGenerator.Create(AComponentInfo
...
procedure TdxRichEditControlUIGenerator.AddCommandAutoFit
  (ACategoryInfo: TdxUIGeneratorCategoryInfo);
var
  ACommand: TdxUIGeneratorCommandInfo;
begin
  ACommand := ACategoryInfo.Add
    (TdxRichEditControlCommandsImages.AutoFitContents,
...
procedure TdxRichEditControlUIGenerator.AddCommandBorders
  (ACategoryInfo: TdxUIGeneratorCategoryInfo);
var
  ACommand: TdxUIGeneratorCommandInfo;
begin
...
procedure TdxRichEditControlUIGenerator.AddCommandBreaks(ACategoryInfo
  : TdxUIGeneratorCategoryInfo);
var
  ACommand: TdxUIGeneratorCommandInfo;
begin
  ACommand := ACategoryInfo.Add
    (TdxRichEditControlCommandsImages.InsertPageBreak, sdxRichEditSubItemBreaks,
    [ugivlLargeIcon]);
...
procedure TdxRichEditControlUIGenerator.AddCommandBringToFront
  (ACategoryInfo: TdxUIGeneratorCategoryInfo);
var
  ACommand: TdxUIGeneratorCommandInfo;
begin
...
procedure TdxRichEditControlUIGenerator.AddCommandChangeCase
  (ACategoryInfo: TdxUIGeneratorCategoryInfo);
var
  ACommand: TdxUIGeneratorCommandInfo;
begin
  ACommand := ACategoryInfo.Add(dxRichEditSubItemChangeCasePictureName,
    sdxRichEditSubItemChangeCase, [ugivlSmallIcon], ugigpStart,
    ugipContinuesRow);
...
procedure TdxRichEditControlUIGenerator.AddCommandColumns
  (ACategoryInfo: TdxUIGeneratorCategoryInfo);
var
  ACommand: TdxUIGeneratorCommandInfo;
begin
  ACommand := ACategoryInfo.Add
    (TdxRichEditControlCommandsImages.SetSectionTwoColumns,
...
procedure TdxRichEditControlUIGenerator.AddCommandDelete(ACategoryInfo
  : TdxUIGeneratorCategoryInfo);
var
  ACommand: TdxUIGeneratorCommandInfo;
begin
...
procedure TdxRichEditControlUIGenerator.AddCommandLineNumbers
  (ACategoryInfo: TdxUIGeneratorCategoryInfo);
var
  ACommand: TdxUIGeneratorCommandInfo;
begin
  ...
  ACommand.Add(TdxRichEditControlShowLineNumberingForm,
    dxUIGeneratorItemDefaultViewLevels, ugigpNone, ugipBeginsNewRow, True)
end;

procedure TdxRichEditControlUIGenerator.AddCommandLineSpacing
  (ACategoryInfo: TdxUIGeneratorCategoryInfo);
var
  ACommand: TdxUIGeneratorCommandInfo;
begin
  ACommand := ACategoryInfo.Add(dxRichEditSubItemLineSpacingPictureName,
    sdxRichEditSubItemLineSpacing, [ugivlSmallIcon], ugigpStart,
    ugipContinuesRow);
...
procedure TdxRichEditControlUIGenerator.AddCommandOrientation
  (ACategoryInfo: TdxUIGeneratorCategoryInfo);
var
  ACommand: TdxUIGeneratorCommandInfo;
begin
...
procedure TdxRichEditControlUIGenerator.AddCommandPosition
  (ACategoryInfo: TdxUIGeneratorCategoryInfo);
var
  ACommand: TdxUIGeneratorCommandInfo;
begin
  ACommand := ACategoryInfo.Add
    (TdxRichEditControlCommandsImages.ImagePositionTopRight,
...
procedure TdxRichEditControlUIGenerator.AddCommandSendToBack
  (ACategoryInfo: TdxUIGeneratorCategoryInfo);
var
  ACommand: TdxUIGeneratorCommandInfo;
begin
...
procedure TdxRichEditControlUIGenerator.AddCommandWrapText
  (ACategoryInfo: TdxUIGeneratorCategoryInfo);
var
  ACommand: TdxUIGeneratorCommandInfo;
begin
...
begin
  ...
  ACategoryInfo.Add(TdxRichEditControlToggleTableCellsTopLeftAlignment,
    [ugivlSmallIcon]);
  ACategoryInfo.Add(TdxRichEditControlToggleTableCellsTopCenterAlignment,
    [ugivlSmallIcon], ugigpNone, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlToggleTableCellsTopRightAlignment,
    [ugivlSmallIcon], ugigpNone, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlToggleTableCellsMiddleLeftAlignment,
    [ugivlSmallIcon]);
  ACategoryInfo.Add(TdxRichEditControlToggleTableCellsMiddleCenterAlignment,
    [ugivlSmallIcon], ugigpNone, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlToggleTableCellsMiddleRightAlignment,
    [ugivlSmallIcon], ugigpNone, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlToggleTableCellsBottomLeftAlignment,
    [ugivlSmallIcon]);
  ACategoryInfo.Add(TdxRichEditControlToggleTableCellsBottomCenterAlignment,
    [ugivlSmallIcon], ugigpNone, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlToggleTableCellsBottomRightAlignment,
    [ugivlSmallIcon], ugigpNone, ugipContinuesRow);
end;
...
var
  ACategoryInfo: TdxUIGeneratorCategoryInfo;
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabPictureFormat,
    sdxRichEditBarArrange, dxRichEditBarArrangePictureName);
...
var
  ACategoryInfo: TdxUIGeneratorCategoryInfo;
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabPageLayout,
    sdxRichEditBarPageBackground, dxRichEditBarPageBackgroundPictureName);
...
var
  ...
  ACommand: TdxUIGeneratorCommandInfo;
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabReferences,
    sdxRichEditBarCaptions, '');
...
var
  ACategoryInfo: TdxUIGeneratorCategoryInfo;
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabHome,
    sdxRichEditBarClipboard, dxRichEditBarClipboardPictureName);
  ACategoryInfo.Add(TdxRichEditControlPasteSelection);
  ACategoryInfo.Add(TdxRichEditControlCutSelection,
    [ugivlSmallIcon, ugivlText]);
  ACategoryInfo.Add(TdxRichEditControlCopySelection,
    [ugivlSmallIcon, ugivlText]);
...
var
  ACategoryInfo: TdxUIGeneratorCategoryInfo;
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabView,
    sdxRichEditBarDocumentViews, dxRichEditBarDocumentViewsPictureName);
...
begin
  ...
  ACategoryInfo.Add(TdxRichEditControlSearchReplace,
    [ugivlSmallIcon, ugivlText]);
...
var
  ACategoryInfo: TdxUIGeneratorCategoryInfo;
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabHome, sdxRichEditBarFont,
    dxRichEditBarFontPictureName);
  ACategoryInfo.Add(TdxRichEditControlChangeFontName, [ugivlText]);
  ACategoryInfo.Add(TdxRichEditControlChangeFontSize, [ugivlText], ugigpNone,
    ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlIncreaseFontSize, [ugivlSmallIcon],
    ugigpStart, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlDecreaseFontSize, [ugivlSmallIcon],
    ugigpMember, ugipContinuesRow);
  AddCommandChangeCase(ACategoryInfo);
  ACategoryInfo.Add(TdxRichEditControlToggleFontBold, [ugivlSmallIcon],
    ugigpStart);
  ACategoryInfo.Add(TdxRichEditControlToggleFontItalic, [ugivlSmallIcon],
    ugigpMember, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlToggleFontUnderline, [ugivlSmallIcon],
    ugigpMember, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlToggleFontDoubleUnderline,
    [ugivlSmallIcon], ugigpMember, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlToggleFontStrikeout, [ugivlSmallIcon],
    ugigpMember, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlToggleFontDoubleStrikeout,
    [ugivlSmallIcon], ugigpMember, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlToggleFontSubscript, [ugivlSmallIcon],
    ugigpMember, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlToggleFontSuperscript, [ugivlSmallIcon],
    ugigpMember, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlTextHighlight, [ugivlSmallIcon],
    ugigpStart, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlChangeFontColor, [ugivlSmallIcon],
    ugigpMember, ugipContinuesRow);
end;
...
var
  ACategoryInfo: TdxUIGeneratorCategoryInfo;
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabInsert,
    sdxRichEditBarHeaderAndFooter, dxRichEditBarHeaderAndFooterPictureName);
...
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabInsert,
    sdxRichEditBarIllustrations, dxRichEditBarIllustrationsPictureName);
...
var
  ACategoryInfo: TdxUIGeneratorCategoryInfo;
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabMailMerge,
    sdxRichEditBarMailMerge, dxRichEditTabMailMergePictureName);
...
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabPageLayout,
    sdxRichEditBarPageSetup, dxRichEditBarPageSetupPictureName);
  AGallery := ACategoryInfo.Add(TdxRichEditControlPageMarginsGallery, True,
    True, True, False, 1, 2);
  AGallery.Add(TdxRichEditControlShowPageMarginsSetupForm);
  AddCommandOrientation(ACategoryInfo);
  AGallery := ACategoryInfo.Add(TdxRichEditControlPaperSizeGallery, True, True,
    True, False, 1, 1);
...
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabHome,
    sdxRichEditBarParagraph, dxRichEditBarParagraphPictureName);
  ACategoryInfo.Add(TdxRichEditControlToggleBulletedList, [ugivlSmallIcon],
    ugigpStart);
  ACategoryInfo.Add(TdxRichEditControlToggleSimpleNumberingList,
    [ugivlSmallIcon], ugigpMember, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlToggleMultiLevelList, [ugivlSmallIcon],
    ugigpMember, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlDecrementIndent, [ugivlSmallIcon],
    ugigpStart, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlIncrementIndent, [ugivlSmallIcon],
    ugigpMember, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlToggleShowWhitespace, [ugivlSmallIcon],
    ugigpStart, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlToggleParagraphAlignmentLeft,
    [ugivlSmallIcon], ugigpStart);
  ACategoryInfo.Add(TdxRichEditControlToggleParagraphAlignmentCenter,
    [ugivlSmallIcon], ugigpMember, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlToggleParagraphAlignmentRight,
    [ugivlSmallIcon], ugigpMember, ugipContinuesRow);
  ACategoryInfo.Add(TdxRichEditControlToggleParagraphAlignmentJustify,
    [ugivlSmallIcon], ugigpMember, ugipContinuesRow);
...
var
  ACategoryInfo: TdxUIGeneratorCategoryInfo;
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabReview,
    sdxRichEditBarProtect, dxRichEditBarEditRangePermission);
...
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabPictureFormat,
    sdxRichEditBarShapeStyles, dxRichEditBarShapeStylesPictureName);
  ACategoryInfo.Add(TdxRichEditControlChangeFloatingObjectFillColor,
    [ugivlSmallIcon, ugivlText]);
  ACategoryInfo.Add(TdxRichEditControlChangeFloatingObjectOutlineColor,
    [ugivlSmallIcon, ugivlText]);
end;
...
var
  ACategoryInfo: TdxUIGeneratorCategoryInfo;
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabView, sdxRichEditBarShow,
    dxRichEditBarShowPictureName);
...
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabReview,
    sdxRichEditBarProofing, dxRichEditBarSpellCheckPictureName);
...
var
  ACategoryInfo: TdxUIGeneratorCategoryInfo;
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabHome, sdxRichEditBarStyles,
    dxRichEditBarStylesPictureName);
  ACategoryInfo.Add(TdxRichEditControlQuickStylesGallery, False, False,
    False, True, 4);
end;
...
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabInsert,
    sdxRichEditBarSymbols, dxRichEditBarSymbolsPictureName);
...
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabTableLayout,
    sdxRichEditBarTable, dxRichEditBarTablePictureName);
...
var
  ACategoryInfo: TdxUIGeneratorCategoryInfo;
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabInsert, sdxRichEditBarTables,
    dxRichEditBarTablesPictureName);
...
var
  ACategoryInfo: TdxUIGeneratorCategoryInfo;
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabTableDesign,
    sdxRichEditBarTableStyles, dxRichEditBarTableStylesPictureName);
  ACategoryInfo.Add(TdxRichEditControlTableStylesGallery, False, False,
    False, True, 7);
...
var
  ACategoryInfo: TdxUIGeneratorCategoryInfo;
begin
  ACategoryInfo := ComponentInfo.Add(sdxRichEditTabInsert, sdxRichEditBarText,
    dxRichEditBarTextPictureName);
...
procedure RegisterRichEditUIGeneratorScheme;
begin
  GenerateUI(TdxUIGenerator.RegisterComponent(TdxRichEditControl,
    sdxRichEditControlCategory));
end;
