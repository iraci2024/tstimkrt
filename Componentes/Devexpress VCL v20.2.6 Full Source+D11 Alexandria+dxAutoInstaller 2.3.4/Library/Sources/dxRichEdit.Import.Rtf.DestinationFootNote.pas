...
type
  ...
  strict private
    ...
    class procedure ConvertToEndNoteHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure FootNoteSelfReferenceHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
  protected
  ...
  public
    constructor Create(AImporter: TdxRtfImporter;
      ATargetPieceTable: TdxFootNoteBase); reintroduce; overload;
    constructor Create(AImporter: TdxRtfImporter;
      AFootNoteContentType: TdxFootNoteBase;
...
constructor TdxFootNoteDestinationBase.Create(AImporter: TdxRtfImporter;
  ATargetPieceTable: TdxFootNoteBase);
begin
...
class function TdxFootNoteDestinationBase.CreateKeywordTable
...
class function TdxFootNoteDestinationBase.GetKeywordHT
  : TdxKeywordTranslatorTable;
begin
  Result := FKeywordHT;
end;
...
class procedure TdxFootNoteDestinationBase.ConvertToEndNoteHandler
...
class procedure TdxFootNoteDestinationBase.FootNoteSelfReferenceHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
...
var
  ARun: TdxFootNoteRun;
begin
  ARun := TdxFootNoteRun(TdxPieceTable(Note.PieceTable)
    .InsertFootNoteRun(Importer.Position, -1));
...
var
  ARun: TdxEndNoteRun;
begin
  ARun := TdxEndNoteRun(TdxPieceTable(Note.PieceTable)
    .InsertEndNoteRun(Importer.Position, -1));
  SelfReferenceRuns.Add(ARun);
end;
