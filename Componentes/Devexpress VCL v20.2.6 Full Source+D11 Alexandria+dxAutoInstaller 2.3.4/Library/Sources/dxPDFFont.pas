...
uses
  Types, SysUtils, Generics.Defaults, Generics.Collections, Classes, cxGeometry,
  dxCoreClasses, cxClasses, dxPDFBase,
  dxPDFTypes, dxPDFCore, dxPDFCharacterMapping, dxPDFFontEncoding, dxPDFText,
  dxFontFile;

type
  { TdxPDFType0FontDescriptor }

  TdxPDFType0FontDescriptor = class(TdxPDFCustomFontDescriptor)
  protected
  ...
  TdxPDFType0Font = class(TdxPDFCustomFont)
  strict private
    FCIDBaseFont: string;
  ...
  protected
    ...
    function GetFontDictionary(ADictionary: TdxPDFReaderDictionary)
      : TdxPDFReaderDictionary; override;
    ...
    procedure WriteCIDToGIDMap(AHelper: TdxPDFWriterHelper;
      ADictionary: TdxPDFWriterDictionary); virtual;
  public
    class function GetDictionary(ADictionary: TdxPDFReaderDictionary)
      : TdxPDFReaderDictionary; static;
  ...
  TdxPDFCIDType0FontDescriptor = class(TdxPDFType0FontDescriptor)
  protected
    ...
    function WriteFontFileData(AHelper: TdxPDFWriterHelper;
      AData: TdxPDFType1FontFileData): TdxPDFObject;
  end;

  { TdxPDFCIDType0Font }

  TdxPDFCIDType0Font = class(TdxPDFType0Font)
  strict private
  ...
  public
    class function GetSubTypeName: string; override;
    property FontDescriptor: TdxPDFCIDType0FontDescriptor
      read GetFontDescriptor;
  end;

  { TdxPDFCIDType2FontDescriptor }

  TdxPDFCIDType2FontDescriptor = class(TdxPDFType0FontDescriptor)
  protected
    FontFileData: TBytes;
    procedure ReadProperties(ADictionary: TdxPDFReaderDictionary); override;
    procedure WriteFontFile(AHelper: TdxPDFWriterHelper;
  ...
  TdxPDFCIDType2Font = class(TdxPDFType0Font)
  strict private
  ...
  public
    class function GetSubTypeName: string; override;
    property FontDescriptor: TdxPDFCIDType2FontDescriptor
      read GetFontDescriptor;
  end;
  ...
  public
    constructor Create(const ABaseFont: string;
      AFontDescriptor: TdxPDFCIDType2FontDescriptor); reintroduce;
  end;
  ...
  TdxPDFTrueTypeFontDescriptor = class(TdxPDFCustomFontDescriptor)
  protected
    CompactFontFileData: TBytes;
    FontFileData: TBytes;
    OpenTypeFontFileData: TBytes;
    ...
    class procedure WriteFontData(AHelper: TdxPDFWriterHelper;
      ADictionary: TdxPDFWriterDictionary; const AData: TBytes);
  ...
  public
    class function GetSubTypeName: string; override;
    property FontDescriptor: TdxPDFTrueTypeFontDescriptor
      read GetFontDescriptor;
  end;
  ...
  strict private
    FCharProcs: TObjectDictionary<string, TdxPDFCommandList>;
    FFontBBox: TdxRectF;
    ...
    procedure WriteCharProcs(AHelper: TdxPDFWriterHelper;
  ...
  public
    ...
    property CharProcs: TObjectDictionary<string, TdxPDFCommandList>
      read FCharProcs;
...
uses
  Windows, Math, StrUtils, dxCore, dxPDFParser, dxPDFCommand, dxPDFType1Font,
  dxPDFFontUtils,
  dxPDFUtils;
...
type
  ...
  TdxPDFStreamObjectAccess = class(TdxPDFStreamObject);
  ...
  strict private
    ...
    procedure ReadCIDFontProgramOperators(AFontProgram
  ...
  class var
    ...
    function GetStandardFontDefaultWidthsMap
      : TDictionary<string, TGetDefaultWidthsFunc>;
    function GetSymbolWidths: TdxPDFWordDictionary;
    function GetZapfDingbatsWidths: TdxPDFWordDictionary;

    property StandardFontDefaultWidthsMap
      : TDictionary<string, TGetDefaultWidthsFunc>
      read GetStandardFontDefaultWidthsMap;
  public
    constructor Create;
    destructor Destroy; override;
    function GetDefaultWidthsDictionary(const AFontName: string)
      : TdxPDFWordDictionary;
  end;

  { TdxFontFileCMapGlyphRangeComparer }

  TdxFontFileCMapGlyphRangeComparer = class(TInterfacedObject,
    IComparer<TdxFontFileCMapGlyphRange>)
  strict private
...
function TdxFontFileCMapGlyphRangeComparer.Compare(const Left,
  Right: TdxFontFileCMapGlyphRange): Integer;
begin
...
constructor TdxPDFCompactFontFormatTopDictIndexWriter.Create
...
class function TdxPDFCompactFontFormatTopDictIndexWriter.
...
procedure TdxPDFCompactFontFormatTopDictIndexWriter.DoWrite
  (AStream: TdxFontFileStream);
var
  I: Integer;
...
procedure TdxPDFCompactFontFormatTopDictIndexWriter.
  Read(AFontProgram: TdxType1FontCompactFontProgram);
begin
  ...
  if AFontProgram is TdxType1FontCompactCIDFontProgram then
    ReadCIDFontProgramOperators(TdxType1FontCompactCIDFontProgram
      (AFontProgram));
  ReadFontInfoOperators(AFontProgram.FontInfo);
  if AFontProgram.FontType <> TdxType1FontCompactFontProgram.DefaultFontType
  then
    FOperators.Add(TdxCompactFontFormatDictIndexCharstringTypeOperator.Create
      (AFontProgram.FontType));
  if AFontProgram.UniqueID <> TdxType1CustomFontProgram.DefaultUniqueID then
    FOperators.Add(TdxCompactFontFormatDictIndexUniqueIDOperator.Create
      (AFontProgram.UniqueID));
  if AFontProgram.FontBBox <> TdxType1FontCompactFontProgram.DefaultFontBBox
  then
    FOperators.Add(TdxCompactFontFormatDictIndexFontBBoxOperator.Create
      (AFontProgram.FontBBox));
  if AFontProgram.StrokeWidth <> TdxType1CustomFontProgram.DefaultStrokeWidth
  then
    FOperators.Add(TdxCompactFontFormatDictIndexStrokeWidthOperator.Create
      (AFontProgram.StrokeWidth));
  if Length(AFontProgram.XUID) > 0 then
    FOperators.Add(TdxCompactFontFormatDictIndexXUIDOperator.Create
      (AFontProgram.XUID));
  ...
  if AFontProgram.PostScript <> '' then
    FOperators.Add(TdxCompactFontFormatDictIndexPostScriptOperator.Create
      (AFontProgram.PostScript));
  if AFontProgram.FontInfo.BaseFontName <> '' then
    FOperators.Add(TdxCompactFontFormatDictIndexBaseFontNameOperator.Create
      (AFontProgram.FontInfo.BaseFontName));
  if Length(AFontProgram.BaseFontBlend) > 0 then
    FOperators.Add(TdxCompactFontFormatDictIndexBaseFontBlendOperator.Create
      (AFontProgram.BaseFontBlend));
  if AFontProgram.CIDFontName <> '' then
    FOperators.Add(TdxCompactFontFormatDictIndexFontNameOperator.Create
      (AFontProgram.CIDFontName));
  CalculateOffsets;
end;

procedure TdxPDFCompactFontFormatTopDictIndexWriter.ReadCIDFontProgramOperators
  (AFontProgram: TdxType1FontCompactCIDFontProgram);
var
  I: Integer;
...
begin
  FOperators.Add(TdxCompactFontFormatDictIndexROSOperator.Create
    (AFontProgram.Registry, AFontProgram.Ordering, AFontProgram.Supplement));
  if AFontProgram.CIDFontVersion <> TdxType1FontCompactCIDFontProgram.DefaultCIDFontVersion
  then
    FOperators.Add(TdxCompactFontFormatDictIndexCIDFontVersionOperator.Create
      (AFontProgram.CIDFontVersion));

  if AFontProgram.CIDCount <> TdxType1FontCompactCIDFontProgram.DefaultCIDCount
  then
    FOperators.Add(TdxCompactFontFormatDictIndexCIDCountOperator.Create
      (AFontProgram.CIDCount));
  ...
  begin
    AFDArrayOperator := TdxCompactFontFormatDictIndexFDArrayOperator.Create
      (AFontProgram.GlyphGroupData, FStringIndex);
    ...
    try
      for I := 0 to AOffsetOperators.Count - 1 do
        FOffsetOperators.Add(AOffsetOperators[I]
          as IdxCompactFontFormatDictIndexOffsetOperator);
    finally
...
procedure TdxPDFCompactFontFormatTopDictIndexWriter.ReadCharsetOperator
...
procedure TdxPDFCompactFontFormatTopDictIndexWriter.ReadCharStringsOperator
...
begin
  ...
  begin
    AOperator := TdxCompactFontFormatDictIndexCharStringsOperator.Create
      (ACharStrings);
    FOperators.Add(AOperator);
    FOffsetOperators.Add(AOperator);
  end;
...
procedure TdxPDFCompactFontFormatTopDictIndexWriter.ReadEncodingOperator
...
begin
  ...
  begin
    AOperator := TdxCompactFontFormatDictIndexEncodingOperator.Create
      (AEncoding);
    FOperators.Add(AOperator);
...
procedure TdxPDFCompactFontFormatTopDictIndexWriter.ReadFontInfoOperators
  (AFontInfo: TdxType1FontInfo);
begin
  if AFontInfo.Version <> '' then
    FOperators.Add(TdxCompactFontFormatDictIndexVersionOperator.Create
      (AFontInfo.Version));
  if AFontInfo.Notice <> '' then
    FOperators.Add(TdxCompactFontFormatDictIndexNoticeOperator.Create
      (AFontInfo.Notice));
  if AFontInfo.Copyright <> '' then
    FOperators.Add(TdxCompactFontFormatDictIndexCopyrightOperator.Create
      (AFontInfo.Copyright));
  if AFontInfo.FullName <> '' then
    FOperators.Add(TdxCompactFontFormatDictIndexFullNameOperator.Create
      (AFontInfo.FullName));
  if AFontInfo.FamilyName <> '' then
    FOperators.Add(TdxCompactFontFormatDictIndexFamilyNameOperator.Create
      (AFontInfo.FamilyName));
  if AFontInfo.Weight <> '' then
    FOperators.Add(TdxCompactFontFormatDictIndexWeightOperator.Create
      (AFontInfo.Weight));
  ...
  if AFontInfo.ItalicAngle <> TdxType1FontInfo.DefaultItalicAngle then
    FOperators.Add(TdxCompactFontFormatDictIndexItalicAngleOperator.Create
      (AFontInfo.ItalicAngle));
  if AFontInfo.UnderlinePosition <> TdxType1FontInfo.DefaultUnderlinePosition
  then
    FOperators.Add(TdxCompactFontFormatDictIndexUnderlinePositionOperator.Create
      (AFontInfo.UnderlinePosition));
  if AFontInfo.UnderlineThickness <> TdxType1FontInfo.DefaultUnderlineThickness
  then
    FOperators.Add(TdxCompactFontFormatDictIndexUnderlineThicknessOperator.
      Create(AFontInfo.UnderlineThickness));
end;

procedure TdxPDFCompactFontFormatTopDictIndexWriter.ReadPrivateOperator
  (AData: TdxType1FontPrivateData);
var
...
begin
  FStandardFontDefaultWidthsMap :=
    TDictionary<string, TGetDefaultWidthsFunc>.Create;
...
function TdxPDFSimpleFontDefaultWidths.GetDefaultWidthsDictionary
  (const AFontName: string): TdxPDFWordDictionary;
var
...
function TdxPDFSimpleFontDefaultWidths.GetCourierBoldWidths
  : TdxPDFWordDictionary;
begin
...
function TdxPDFSimpleFontDefaultWidths.GetCourierBoldObliqueWidths
  : TdxPDFWordDictionary;
begin
...
function TdxPDFSimpleFontDefaultWidths.GetCourierObliqueWidths
  : TdxPDFWordDictionary;
begin
...
function TdxPDFSimpleFontDefaultWidths.GetHelveticaBoldWidths
  : TdxPDFWordDictionary;
begin
...
function TdxPDFSimpleFontDefaultWidths.GetHelveticaBoldObliqueWidths
  : TdxPDFWordDictionary;
begin
...
function TdxPDFSimpleFontDefaultWidths.GetHelveticaObliqueWidths
  : TdxPDFWordDictionary;
begin
...
function TdxPDFSimpleFontDefaultWidths.GetTimesBoldItalicWidths
  : TdxPDFWordDictionary;
begin
...
function TdxPDFSimpleFontDefaultWidths.GetTimesItalicWidths
  : TdxPDFWordDictionary;
begin
...
function TdxPDFSimpleFontDefaultWidths.GetStandardFontDefaultWidthsMap
  : TDictionary<string, TGetDefaultWidthsFunc>;
begin
  ...
  begin
    ...
    FStandardFontDefaultWidthsMap.Add('Arial,BoldItalic',
      GetHelveticaBoldObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('Arial,Italic',
      GetHelveticaObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('Arial-Bold', GetHelveticaBoldWidths);
    FStandardFontDefaultWidthsMap.Add('Arial-BoldItalic',
      GetHelveticaBoldObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('Arial-BoldItalicMT',
      GetHelveticaBoldObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('Arial-BoldMT', GetHelveticaBoldWidths);
    FStandardFontDefaultWidthsMap.Add('Arial-Italic',
      GetHelveticaObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('Arial-ItalicMT',
      GetHelveticaObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('Helvetica-Compressed',
      GetHelveticaWidths);
    ...
    FStandardFontDefaultWidthsMap.Add('CourierNew,BoldItalic',
      GetCourierBoldObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('CourierNew,Italic',
      GetCourierObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('CourierNew-Bold', GetCourierBoldWidths);
    FStandardFontDefaultWidthsMap.Add('CourierNew-BoldItalic',
      GetCourierBoldObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('CourierNew-Italic',
      GetCourierObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('CourierNewPS-BoldItalicMT',
      GetCourierBoldObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('CourierNewPS-BoldMT',
      GetCourierBoldWidths);
    FStandardFontDefaultWidthsMap.Add('CourierNewPS-ItalicMT',
      GetCourierObliqueWidths);
    ...
    FStandardFontDefaultWidthsMap.Add('Helvetica,BoldItalic',
      GetHelveticaBoldObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('Helvetica,Italic',
      GetHelveticaObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('Helvetica-BoldItalic',
      GetHelveticaBoldObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('Helvetica-Italic',
    ...
    FStandardFontDefaultWidthsMap.Add('TimesNewRoman,BoldItalic',
      GetTimesBoldItalicWidths);
    FStandardFontDefaultWidthsMap.Add('TimesNewRoman,Italic',
      GetTimesItalicWidths);
    FStandardFontDefaultWidthsMap.Add('TimesNewRoman-Bold', GetTimesBoldWidths);
    FStandardFontDefaultWidthsMap.Add('TimesNewRoman-BoldItalic',
      GetTimesBoldItalicWidths);
    FStandardFontDefaultWidthsMap.Add('TimesNewRoman-Italic',
    ...
    FStandardFontDefaultWidthsMap.Add('TimesNewRomanPS-Bold',
      GetTimesBoldWidths);
    FStandardFontDefaultWidthsMap.Add('TimesNewRomanPS-BoldItalic',
      GetTimesBoldItalicWidths);
    FStandardFontDefaultWidthsMap.Add('TimesNewRomanPS-BoldItalicMT',
      GetTimesBoldItalicWidths);
    FStandardFontDefaultWidthsMap.Add('TimesNewRomanPS-BoldMT',
      GetTimesBoldWidths);
    FStandardFontDefaultWidthsMap.Add('TimesNewRomanPS-Italic',
      GetTimesItalicWidths);
    FStandardFontDefaultWidthsMap.Add('TimesNewRomanPS-ItalicMT',
      GetTimesItalicWidths);
    FStandardFontDefaultWidthsMap.Add('TimesNewRomanPSMT', GetTimesRomanWidths);
    FStandardFontDefaultWidthsMap.Add('TimesNewRomanPSMT,Bold',
      GetTimesBoldWidths);
    FStandardFontDefaultWidthsMap.Add('TimesNewRomanPSMT,BoldItalic',
      GetTimesBoldItalicWidths);
    FStandardFontDefaultWidthsMap.Add('TimesNewRomanPSMT,Italic',
      GetTimesItalicWidths);
    FStandardFontDefaultWidthsMap.Add(TdxPDFKeywords.CourierObliqueFontName,
      GetCourierObliqueWidths);
    FStandardFontDefaultWidthsMap.Add(TdxPDFKeywords.CourierBoldObliqueFontName,
      GetCourierBoldObliqueWidths);
    FStandardFontDefaultWidthsMap.Add(TdxPDFKeywords.HelveticaBoldFontName,
      GetHelveticaBoldWidths);
    FStandardFontDefaultWidthsMap.Add
      (TdxPDFKeywords.HelveticaBoldObliqueFontName, GetHelveticaBoldWidths);
    FStandardFontDefaultWidthsMap.Add(TdxPDFKeywords.HelveticaObliqueFontName,
      GetHelveticaWidths);
    FStandardFontDefaultWidthsMap.Add(TdxPDFKeywords.SymbolFontName,
      GetSymbolWidths);
    FStandardFontDefaultWidthsMap.Add(TdxPDFKeywords.TimesRomanFontName,
      GetTimesRomanWidths);
    FStandardFontDefaultWidthsMap.Add(TdxPDFKeywords.TimesBoldFontName,
      GetTimesBoldWidths);
    FStandardFontDefaultWidthsMap.Add(TdxPDFKeywords.TimesBoldItalicFontName,
      GetTimesBoldItalicWidths);
    FStandardFontDefaultWidthsMap.Add(TdxPDFKeywords.TimesItalicFontName,
      GetTimesItalicWidths);
    FStandardFontDefaultWidthsMap.Add(TdxPDFKeywords.ZapfDingbatsFontName,
      GetZapfDingbatsWidths);
  end;
  Result := FStandardFontDefaultWidthsMap;
end;

function TdxPDFSimpleFontDefaultWidths.GetTimesRomanWidths
  : TdxPDFWordDictionary;
begin
...
function TdxPDFSimpleFontDefaultWidths.GetZapfDingbatsWidths
  : TdxPDFWordDictionary;
begin
...
class function TdxPDFType0Font.GetDictionary(ADictionary
  : TdxPDFReaderDictionary): TdxPDFReaderDictionary;
var
  AFont: TdxPDFType0Font;
begin
  AFont := TdxPDFType0Font.Create(nil);
  try
...
function TdxPDFType0Font.GetFontDescriptorDictionary
...
begin
  ...
  if ACIDFontDictionary <> nil then
    Result := ACIDFontDictionary.GetDictionary(TdxPDFKeywords.FontDescriptor)
...
begin
  ...
  SetEncoding(TdxPDFHorizontalIdentityEncoding.Create(Self));
  FSystemInfo := TdxPDFCIDSystemInfo.Create(Self);
end;
...
procedure TdxPDFType0Font.Read(ADictionary: TdxPDFReaderDictionary);
var
...
begin
  ...
  TdxPDFObjectAccess(FSystemInfo).
    Read(AFontDictionary.GetDictionary(TdxPDFKeywords.CIDSystemInfo));
...
procedure TdxPDFType0Font.DoReadWidths(ADictionary: TdxPDFReaderDictionary);
  ...
  procedure AddWidth(ADictionary: TdxPDFIntegerDoubleDictionary; AKey: Integer;
    AWidth: Double);
  begin
  ...
  procedure ReadWidthArray(ADictionary: TdxPDFIntegerDoubleDictionary;
    AElementList: TdxPDFBaseList; var AStartIndex: Integer);
  var
    AValue: TdxPDFBase;
  begin
    ...
    begin
      if AValue.ObjectType in [otInteger, otDouble] then
        AddWidth(ADictionary, AStartIndex, TdxPDFNumericObjectAccess(AValue)
          .InternalValue);
      Inc(AStartIndex);
    end;
    AStartIndex := -1;
...
begin
  ...
  AWidthArray := ADictionary.GetArray(TdxPDFKeywords.ShortWidths,
    TdxPDFKeywords.Widths);
      ...
      begin
        ...
        if AStartIndex < 0 then
          ...
          case AValue.ObjectType of
            ...
            otIndirectReference:
              begin
                AArrayObject := Repository.GetObject
                  (TdxPDFIndirectObject(AValue).Number);
                if AArrayObject is TdxPDFArray then
                  ReadWidthArray(AWidths, TdxPDFArray(AArrayObject).ElementList,
                    AStartIndex);
              end;
            otArray:
              ReadWidthArray(AWidths, TdxPDFArray(AValue).ElementList,
                AStartIndex);
          end
        else
        begin
          if TdxPDFUtils.IsReference(AValue) then
            AValue := Repository.GetNumericObject
              (TdxPDFReference(AValue).Number);
...
procedure TdxPDFType0Font.Write(AHelper: TdxPDFWriterHelper;
  ADictionary: TdxPDFWriterDictionary);
  ...
  begin
    ...
    ADescendantFontDictionary.AddName(TdxPDFKeywords.BaseFont,
      FCIDBaseFont, False);
    ADescendantFontDictionary.AddReference(TdxPDFKeywords.FontDescriptor,
      FontDescriptor);
    ADescendantFontDictionary.AddReference(TdxPDFKeywords.CIDSystemInfo,
      FSystemInfo);
    ADescendantFontDictionary.Add(TdxPDFKeywords.DefaultWidth, FDefaultWidth);
    ADescendantFontDictionary.Add(TdxPDFKeywords.ShortWidths,
      CreateWidthsArray);
...
procedure TdxPDFType0Font.WriteCIDToGIDMap(AHelper: TdxPDFWriterHelper;
  ADictionary: TdxPDFWriterDictionary);
var
  AData: TBytes;
...
function TdxPDFType0Font.GetFontDictionary(ADictionary: TdxPDFReaderDictionary)
...
begin
  ...
  begin
    if ADescendantFonts[0].ObjectType <> otIndirectReference then
      TdxPDFUtils.RaiseTestException('TdxPDFType0Font.Parse');
    Result := ADictionary.Repository.GetDictionary
      (TdxPDFReference(ADescendantFonts[0]).Number);
    if Result = nil then
      TdxPDFUtils.RaiseTestException('TdxPDFType0Font.Parse');
  end
  else
...
function TdxPDFType0Font.GetFontDescriptorClass
...
procedure TdxPDFCIDType0FontDescriptor.ReadProperties
...
procedure TdxPDFCIDType0FontDescriptor.WriteFontFile
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        ADictionary.AddReference(TdxPDFKeywords.FontFile3,
          AHelper.CreateStream(AFontFileDictionary, CompactFontFileData));
      end;
    end
    else
      ADictionary.AddReference(TdxPDFKeywords.FontFile3,
...
procedure TdxPDFCIDType0FontDescriptor.ReadFontFile
  (ADictionary: TdxPDFReaderDictionary);
var
  AStream: TdxPDFStream;
begin
  ...
  begin
    ...
    if FontFileData.IsNull and
      not(Font.Encoding is TdxPDFPredefinedCompositeFontEncoding) and
      not(Font.Encoding is TdxPDFCustomIdentityEncoding) then
      TdxPDFUtils.Abort;
  end
  else
  begin
    ...
    begin
      if AStream.Dictionary.GetString(TdxPDFKeywords.Subtype) <> TdxPDFKeywords.CIDFontType0C
      then
        TdxPDFUtils.Abort;
...
function TdxPDFCIDType0FontDescriptor.WriteFontFileData
  (AHelper: TdxPDFWriterHelper; AData: TdxPDFType1FontFileData): TdxPDFObject;
var
  AFontFileDictionary: TdxPDFWriterDictionary;
begin
  AFontFileDictionary := AHelper.CreateDictionary;
...
procedure TdxPDFCIDType2FontDescriptor.ReadProperties
  (ADictionary: TdxPDFReaderDictionary);
var
  AStream: TdxPDFStream;
begin
  ...
  begin
    if AStream.Dictionary.GetString(TdxPDFKeywords.Subtype) = TdxPDFKeywords.Type1C
    then
...
procedure TdxPDFCIDType2FontDescriptor.WriteFontFile
  (AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary);
begin
  if Length(FontFileData) = 0 then
  begin
    if (Length(OpenTypeFontFileData) = 0) and (Length(CompactFontFileData) > 0)
    then
    ...
    TdxPDFTrueTypeFontDescriptor.WriteFontData(AHelper, ADictionary,
      FontFileData);
end;
...
begin
  if FontDescriptor.CompactFontFileData <> nil then
    Result := TdxPDFCFFFontProgramFacade.CreateForType0Font(Self,
      FontDescriptor.CompactFontFileData)
  else if (FontDescriptor.FontFileData <> nil) or
    (FontDescriptor.OpenTypeFontFileData <> nil) then
  begin
...
function TdxPDFCIDType2Font.GetFontDescriptorClass
  : TdxPDFCustomFontDescriptorClass;
begin
  Result := TdxPDFCIDType2FontDescriptor;
end;

procedure TdxPDFCIDType2Font.WriteCIDToGIDMap(AHelper: TdxPDFWriterHelper;
  ADictionary: TdxPDFWriterDictionary);
begin
...
procedure TdxPDFSimpleFont.Write(AHelper: TdxPDFWriterHelper;
  ADictionary: TdxPDFWriterDictionary);
begin
  inherited Write(AHelper, ADictionary);
...
function TdxPDFSimpleFont.CreateEncoding(AObject: TdxPDFBase)
  ...
  begin
    ...
    else if BaseFont = TdxPDFKeywords.ZapfDingbatsFontName then
      Result := TdxPDFZapfDingbatsEncoding.Create(Self)
    else
      Result := TdxPDFStandardEncoding.Create(Self);
  end;
  ...
  begin
    if not dxPDFTryGetDocumentObjectClass(AName, AClass) then
        ...
        begin
          ...
          begin
            case ABaseEncoding.ObjectType of
              ...
              otDictionary:
                AEncodingName := TdxPDFDictionary(ABaseEncoding)
                  .GetString(TdxPDFKeywords.BaseEncoding);
            else
...
begin
  ...
  ADictionary.AddReference(TdxPDFKeywords.FontFile2,
    AHelper.CreateStream(AFontFileDictionary, AData));
end;
...
procedure TdxPDFTrueTypeFontDescriptor.ReadProperties
  (ADictionary: TdxPDFReaderDictionary);
    ...
    if AFontProgram <> nil then
      try
        if AFontProgram.Validate then
          Result := TdxPDFCompactFontFormatTopDictIndexWriter.
            Write(AFontProgram);
      finally
        AFontProgram.Free;
      end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if TdxPDFType1FontFileData.IsPfbData(AData) then
        Type1FontFileData := TdxPDFType1FontFileData.Create(AData,
          Length(AData), 0, 0);
    end;
  end
  else
  begin
    ...
    begin
      ...
      if AStream <> nil then
      begin
        if (AStream.Dictionary <> nil) and
          (AStream.Dictionary.GetString(TdxPDFKeywords.Subtype) <>
          TdxPDFKeywords.Type1C) then
          TdxPDFUtils.Abort;
        AData := AStream.UncompressedData;
        try
...
procedure TdxPDFTrueTypeFontDescriptor.WriteFontFile
  (AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary);
begin
  if Length(FontFileData) = 0 then
    WriteOpenTypeFontData(AHelper, ADictionary, OpenTypeFontFileData)
...
begin
  if FontDescriptor.CompactFontFileData <> nil then
    Result := TdxPDFCFFFontProgramFacade.CreateForSimpleFont(Self,
      FontDescriptor.CompactFontFileData)
  else if not FontDescriptor.Type1FontFileData.IsNull then
  begin
    if TdxFontFileHelper.IsTrueType(FontDescriptor.Type1FontFileData.Data) then
      try
        Exit(TdxPDFTrueTypeFontProgramFacade.CreateForSimpleFont(Self,
          FontDescriptor.Type1FontFileData.Data));
      except
      end;
    Result := TdxPDFType1FontProgramFacade.CreateForSimpleFont(Self,
      FontDescriptor.Type1FontFileData);
  end
  else if FontDescriptor.FontFileData <> nil then
    Result := TdxPDFTrueTypeFontProgramFacade.CreateForSimpleFont(Self,
      FontDescriptor.FontFileData)
  else
    Result := TdxPDFNonEmbeddedFontProgramFacade.CreateForSimpleFont(Self);
end;

function TdxPDFTrueTypeFont.GetFontDescriptorClass
  : TdxPDFCustomFontDescriptorClass;
begin
...
begin
  Result := (BaseFont = TdxPDFKeywords.CourierNewFontName) or
    (BaseFont = TdxPDFKeywords.CourierNewFontName + ',' + TdxPDFKeywords.Bold)
    or (BaseFont = TdxPDFKeywords.CourierNewFontName + ',' +
    TdxPDFKeywords.Italic) or (BaseFont = TdxPDFKeywords.CourierNewFontName +
    ',' + TdxPDFKeywords.Bold + TdxPDFKeywords.Italic);
end;
...
var
  ...
  AModifyTransformationMatrixCommand
    : TdxPDFModifyTransformationMatrixCommandAccess;
  I: Integer;
begin
  AAscent := 0;
  ADescent := 0;
  ...
  for ACharProc in CharProcs do
    ...
    begin
      ...
      if (ACommands.Count > 0) and (ACommands[0] is TdxPDFSetCacheDeviceCommand)
      then
      begin
      ...
      else if (AAscent = 0) and (ADescent = 0) then
        for I := 0 to ACommands.Count - 1 do
          if ACommands[I] is TdxPDFModifyTransformationMatrixCommand then
          begin
            AModifyTransformationMatrixCommand :=
              TdxPDFModifyTransformationMatrixCommandAccess(ACommands[I]);
            AAscent :=
              Max(AAscent, AModifyTransformationMatrixCommand.Matrix.D);
          end;
    end;
  Result := TdxPDFFontMetricsMetadata.Create(AAscent, ADescent,
    1 / WidthFactor);
end;
...
begin
  ...
  FCharProcs := TObjectDictionary<string, TdxPDFCommandList>.Create
    ([doOwnsValues]);
  FResources := nil;
end;
...
begin
  ...
  begin
    ...
    Resources := TdxPDFDocumentRepositoryAccess(Repository)
      .GetResources(ADictionary);
...
procedure TdxPDFType3Font.Write(AHelper: TdxPDFWriterHelper;
  ADictionary: TdxPDFWriterDictionary);
begin
  inherited Write(AHelper, ADictionary);
...
begin
  if ADictionary <> nil then
    ...
    begin
      ...
      if AStream <> nil then
        FCharProcs.Add(AKey, TdxPDFType3FontContentStreamParser.Parse
          (AStream.UncompressedData, Repository, Resources));
    end;
end;
...
begin
  if AArray <> nil then
  begin
    FMatrix.Assign(TdxPDFUtils.ConvertToDouble(AArray[0]),
      TdxPDFUtils.ConvertToDouble(AArray[1]),
      TdxPDFUtils.ConvertToDouble(AArray[2]),
      TdxPDFUtils.ConvertToDouble(AArray[3]),
      TdxPDFUtils.ConvertToDouble(AArray[4]),
      TdxPDFUtils.ConvertToDouble(AArray[5]));
  end;
end;

procedure TdxPDFType3Font.WriteCharProcs(AHelper: TdxPDFWriterHelper;
  ADictionary: TdxPDFWriterDictionary);
var
...
begin
  ...
  for APair in FCharProcs do
    ACharProcsDictionary.AddReference(APair.Key,
      APair.Value.ToByteArray, False);
  ADictionary.Add(TdxPDFKeywords.CharProcs, ACharProcsDictionary);
end;

{ TdxPDFDeferredCIDType2Font }

constructor TdxPDFDeferredCIDType2Font.Create(const ABaseFont: string;
...
dxPDFFontFactory.Register(TdxPDFTrueTypeFont.GetSubTypeName,
  TdxPDFTrueTypeFont);
...
dxPDFFontFactory.Register(TdxPDFCIDType0Font.GetSubTypeName,
  TdxPDFCIDType0Font);
dxPDFFontFactory.Register(TdxPDFCIDType2Font.GetSubTypeName,
  TdxPDFCIDType2Font);
