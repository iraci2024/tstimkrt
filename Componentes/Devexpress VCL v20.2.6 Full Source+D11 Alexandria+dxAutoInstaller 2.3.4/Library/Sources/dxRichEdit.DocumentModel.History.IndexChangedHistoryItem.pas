...
type
  ...
  public
    constructor Create(const ADocumentModelPart: TdxCustomPieceTable;
      const AObj: TdxIndexBasedObject); reintroduce;
...
constructor TdxIndexChangedHistoryItem.Create(const ADocumentModelPart
  : TdxCustomPieceTable; const AObj: TdxIndexBasedObject);
begin
