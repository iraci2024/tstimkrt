...
{$IFDEF DELPHIXE2}
  System.UITypes,
{$ENDIF}
  SysUtils, Types, Generics.Defaults, Generics.Collections, Controls, SyncObjs,
  Classes, Graphics, ActiveX,
  cxGraphics, dxCoreClasses, cxControls, dxCoreGraphics, dxSkinsCore,
  dxSkinInfo,
...
type
  ...
  IdxHeaderFooterDecoratorPainterOwner = interface
    ...
    property LeftHeaderFooterLineOffset: Integer
      read GetLeftHeaderFooterLineOffset;
    property RightHeaderFooterLineOffset: Integer
      read GetRightHeaderFooterLineOffset;
    property HeaderFooterLineColor: TdxAlphaColor read GetHeaderFooterLineColor;
    property HeaderFooterMarkBackColor: TdxAlphaColor
      read GetHeaderFooterMarkBackColor;
    property HeaderFooterMarkTextColor: TdxAlphaColor
      read GetHeaderFooterMarkTextColor;
  end;
  ...
  protected
    function ProcessSpecificPageArea(AArea: TdxPageArea;
      AAreaKind: TdxPageAreaHitTestManager.TPageAreaKind;
      ACollection: TdxPageAreaCollection): Boolean;
  public
    constructor Create(const ARequest: TdxRichEditHitTestRequest;
      AResult: TdxRichEditHitTestResult);
    procedure ProcessPageAreaCollection(ACollection
      : TdxPageAreaCollection); override;
  end;

  { TdxPrintLayoutViewDocumentFormattingController }

  TdxPrintLayoutViewDocumentFormattingController = class
  ...
  TdxHeaderFooterDocumentFormattingController = class
    (TdxDocumentFormattingController)
  protected
    function CreatePageController: TdxPageController; override;
    function CreatePageAreaController: TdxPageAreaController; override;
  ...
  public
    constructor Create(ADocumentLayout: TdxDocumentLayout;
      ...
      APieceTable: TdxPieceTable; AArea: TdxPageArea;
  ...
  public
    ...
    function Format(AMaxHeight: Integer;
      AController: TdxDocumentFormattingController): Integer;
  ...
  TShouldMoveBoxVertically = function(ABox: TdxFloatingObjectBox)
    : Boolean of object;

  { TdxPageHeaderFooterFormatterBase }

  TdxPageHeaderFooterFormatterBase<TModelObject: TdxContentTypeBase;
  TLayoutObject: TdxHeaderFooterPageAreaBase> = class abstract
  strict private
    ...
    FSection: TdxSection;
  strict protected
    function CalculateDeltaAfterAdjustPageClientBounds
      (const AOldPageClientBounds, ANewPageClientBounds, AColumnBounds: TRect)
      : Integer; virtual; abstract;
    function GetExistingArea(APage: TdxPage): TLayoutObject; virtual; abstract;
    procedure MoveParagraphFramesVertically(APieceTable: TdxPieceTable;
      ADeltaY: Integer); virtual;
    procedure MoveFloatingObjectsVertically(APieceTable: TdxPieceTable;
      ADeltaY: Integer; ACheckMoveFunc: TShouldMoveBoxVertically); virtual;
    function ShouldMoveFloatingObjectVertically(ABox: TdxFloatingObjectBox)
      : Boolean; virtual;
    function ShouldMoveFloatingObjectVerticallyAfterAdjustPageClientBounds
      (ABox: TdxFloatingObjectBox): Boolean; virtual; abstract;
    function FormatArea(AContentType: TModelObject; AArea: TLayoutObject;
      const AAvailableAreaBounds: TRect): Integer; virtual;
    function GetPageAreaBottom(AArea: TdxPageArea;
      AActualAreaBottom: Integer): Integer;
    function FindRow(AColumn: TdxColumn; Y: Integer): TdxRow; overload;
    function FindTable(ATables: TdxTableViewInfoCollection; Y: Integer)
      : TdxTableViewInfo;
    ...
    function GetActualModelObject(AFirstPageOfSection: Boolean): TModelObject;
      virtual; abstract;
    function CreatePageArea(APieceTable: TModelObject): TLayoutObject;
      virtual; abstract;
    ...
    function CalculateFinalAreaBounds(AArea: TLayoutObject;
      AActualAreaBottom: Integer): TRect; virtual; abstract;
    function CalculateFinalAdjustedPageClientBounds(AArea: TLayoutObject)
      : TRect; virtual; abstract;
    function AdjustNewAreaBounds(APieceTable: TdxPieceTable;
      const ANewAreaBounds: TRect): TRect; virtual; abstract;
    procedure MoveFloatingObjectsAfterAdjustPageClientBounds
      (APieceTable: TdxPieceTable; ADeltaY: Integer); virtual;
  ...
  public
    constructor Create(ADocumentLayout: TdxDocumentLayout;
      AFloatingObjectsLayout: TdxFloatingObjectsLayout;
      AParagraphFramesLayout: TdxParagraphFramesLayout; APage: TdxPage;
  ...
  TdxPageHeaderFormatter = class
    (TdxPageHeaderFooterFormatterBase<TdxSectionHeader, TdxHeaderPageArea>)
  strict protected
    function CalculateDeltaAfterAdjustPageClientBounds
      (const AOldPageClientBounds, ANewPageClientBounds, AColumnBounds: TRect)
      : Integer; override;
    function GetExistingArea(APage: TdxPage): TdxHeaderPageArea; override;
    function CreatePageArea(APieceTable: TdxSectionHeader)
      : TdxHeaderPageArea; override;
    procedure AppendPageAreaToPage(AArea: TdxHeaderPageArea); override;
    function CalculateAvailableAreaBounds: TRect; override;
    function CalculateFinalAreaBounds(AArea: TdxHeaderPageArea;
      AActualAreaBottom: Integer): TRect; override;
    function CalculateFinalAdjustedPageClientBounds(AArea: TdxHeaderPageArea)
      : TRect; override;
    function AdjustNewAreaBounds(APieceTable: TdxPieceTable;
      const ANewAreaBounds: TRect): TRect; override;
    function ShouldMoveFloatingObjectVerticallyAfterAdjustPageClientBounds
      (ABox: TdxFloatingObjectBox): Boolean; override;
  public
    function GetActualModelObject(AFirstPageOfSection: Boolean)
      : TdxSectionHeader; override;
  end;

  { TdxPageFooterFormatter }

  TdxPageFooterFormatter = class
    (TdxPageHeaderFooterFormatterBase<TdxSectionFooter, TdxFooterPageArea>)
  strict protected
    function CalculateDeltaAfterAdjustPageClientBounds
      (const AOldPageClientBounds, ANewPageClientBounds, AColumnBounds: TRect)
      : Integer; override;
    function GetExistingArea(APage: TdxPage): TdxFooterPageArea; override;
    function CreatePageArea(APieceTable: TdxSectionFooter)
      : TdxFooterPageArea; override;
    procedure AppendPageAreaToPage(AArea: TdxFooterPageArea); override;
    function CalculateAvailableAreaBounds: TRect; override;
    function CalculateFinalAreaBounds(AArea: TdxFooterPageArea;
      AActualAreaBottom: Integer): TRect; override;
    procedure MoveFloatingObjectsVertically(APieceTable: TdxPieceTable;
      ADeltaY: Integer; ACheckMoveFunc: TShouldMoveBoxVertically); override;
    function AdjustNewAreaBounds(APieceTable: TdxPieceTable;
      const ANewAreaBounds: TRect): TRect; override;
    function CalculateFloatingObjectsBottom(APieceTable: TdxPieceTable;
      AInitialBottom: Integer): Integer;
    function CalculateFloatingObjectsBottomWithDelta(APieceTable: TdxPieceTable;
      AInitialBottom: Integer; ADelta: Integer): Integer; overload;
    function CalculateFloatingObjectsBottomWithDelta(APieceTable: TdxPieceTable;
      ADelta: Integer): Integer; overload;
    function CalculateFinalAdjustedPageClientBounds(AArea: TdxFooterPageArea)
      : TRect; override;
    procedure MoveFloatingObjectsAfterAdjustPageClientBounds
      (APieceTable: TdxPieceTable; ADeltaY: Integer); override;
    function ShouldMoveFloatingObjectVerticallyAfterAdjustPageClientBounds
      (ABox: TdxFloatingObjectBox): Boolean; override;
  public
    function GetActualModelObject(AFirstPageOfSection: Boolean)
      : TdxSectionFooter; override;
  end;
  ...
  protected
    procedure FormatHeader(APage: TdxPage;
      AFirstPageOfSection: Boolean); override;
  ...
  protected
    ...
    function CreateDocumentFormattingController
      : TdxDocumentFormattingController; override;
  ...
  public
    ...
    function CreateDocumentLayoutExporter(APainter: TdxPainter;
      ...
      : TdxDocumentLayoutExporter; override;
  ...
  published
    ...
    property BackColor;
    property PageHorizontalAlignment: TAlignment read GetPageHorizontalAlignment
      write SetPageHorizontalAlignment default taCenter;
    property MaxHorizontalPageCount: Integer read GetMaxHorizontalPageCount
      write SetMaxHorizontalPageCount default 0;
    property ZoomFactor;
  end;
...
type
  ...
  public
    procedure PopulateColumnsBounds(const AResult: TdxRectList;
      const ABounds: TRect; const AColumnInfoCollection
      : TdxColumnInfoCollection); override;
  ...
  public
    ...
    function CreateDefaultState(ACurrentAreaIndex: Integer)
      : TdxPageAreaControllerState; override;
  ...
  TdxHeaderFooterDecoratorPainter = class(TInterfacedObject,
    IdxDecoratorPainter)
  public const
  ...
  protected
    ...
    procedure DrawHeaderFrame(APage: TdxPage; AArea: TdxPageArea;
      APainter: TdxPainter);
    procedure DrawFooterFrame(APage: TdxPage; AArea: TdxPageArea;
      APainter: TdxPainter);
    function DrawHeaderFooterLine(APainter: TdxPainter;
      const AInitialLineBounds: TRect): TRect;
    function GetCaption(AHeaderFooter: TdxSectionHeaderFooterBase;
      APage: TdxPage): string;
    function MeasureString(const ACaption: string;
      APainter: TdxGdiPlusPainter): TSize;
    function CalculateHeaderCaptionBaseBounds(const ACaption: string;
      const AHeaderLineBounds: TRect;
      AGdiPlusPainter: TdxGdiPlusPainter): TRect;
    function CalculateHeaderLinkCaptionBaseBounds(const ACaption: string;
      const AHeaderLineBounds: TRect;
      AGdiPlusPainter: TdxGdiPlusPainter): TRect;
    function CalculateFooterCaptionBaseBounds(const ACaption: string;
      const AHeaderLineBounds: TRect;
      AGdiPlusPainter: TdxGdiPlusPainter): TRect;
    function CalculateFooterLinkCaptionBaseBounds(const ACaption: string;
      const AFooterLineBounds: TRect;
      AGdiPlusPainter: TdxGdiPlusPainter): TRect;
    procedure DrawHeaderCaptionBackground(const ABounds: TRect;
      AGdiPlusPainter: TdxGdiPlusPainter);
    procedure DrawFooterCaptionBackground(const ABounds: TRect;
      AGdiPlusPainter: TdxGdiPlusPainter);
    ...
    procedure DrawHeaderFooterCaptionBackground(APath: TdxGPPath;
      AGdiPlusPainter: TdxGdiPlusPainter);
    procedure DrawCaptionText(const ACaption: string; ABounds: TRect;
      AGdiPlusPainter: TdxGdiPlusPainter; AOffset: Integer);
  ...
  public
    constructor Create(AView: TdxPrintLayoutView;
      const AOwner: IdxHeaderFooterDecoratorPainterOwner);
    destructor Destroy; override;
  ...
  TdxPrintLayoutViewPainter = class abstract(TdxRichEditViewPainter,
    IdxHeaderFooterDecoratorPainterOwner)
  strict private
  ...
  protected
    ...
    function GetHeaderFooterMarkBackColor: TdxAlphaColor;
    function GetHeaderFooterMarkTextColor: TdxAlphaColor;
    procedure DrawEmptyPage(AGraphics: TdxGraphics { ACache: TdxGraphicsCache };
      APage: TdxPageViewInfo); override;
    procedure DrawEmptyComment(AGraphics: TdxGraphics;
      AComment: TdxCommentViewInfo); override;
    procedure DrawEmptyExtensionComment(AGraphics: TdxGraphics;
      AComment: TdxCommentViewInfo); override;
    procedure DrawRoundedRectangle(AGraphics: TdxGraphics; const ARect: TRect;
      ARadius: Integer; AFillColor: TdxAlphaColor; ALineColor: TdxAlphaColor);
  ...
  protected
    ...
    procedure DrawEmptyPage(AGraphics: TdxGraphics;
      APage: TdxPageViewInfo); override;
    function GetActualPageBackColor: TdxAlphaColor; reintroduce;
    function CalculatePageViewInfoPixelBounds(APageViewInfo
      : TdxPageViewInfo): TRect;
  ...
  TdxPrintLayoutViewSkinBackgroundPainter = class
  ...
  TdxPrintLayoutViewDefaultPageAreaControllerState = class
    (TdxDefaultPageAreaControllerState);

  { TdxFinishContinuousSectionStartPageAreaControllerState }

  TdxFinishContinuousSectionStartPageAreaControllerState = class
  ...
  protected
    ...
    function CalculateFirstPageLeftOffset(ATotalPagesWidth: Integer)
      : Integer; override;
  public
    constructor Create(AView: TdxRichEditView; AViewInfo: TObject); reintroduce;
    function CanFitPageToPageRow(APage: TdxPage; ARow: TdxPageViewInfoRow)
      : Boolean; override;

    property PageHorizontalAlignment: TAlignment read FPageHorizontalAlignment
      write FPageHorizontalAlignment;
    property MaxHorizontalPageCount: Integer read FMaxHorizontalPageCount
      write FMaxHorizontalPageCount;
...
constructor TdxPrintLayoutViewPageViewInfoGenerator.Create
  (AView: TdxRichEditView; AViewInfo: TObject);
begin
...
function TdxPrintLayoutViewPageViewInfoGenerator.GetViewInfo
  : TdxRichEditViewInfo;
begin
  Result := TdxRichEditViewInfo(FViewInfo);
end;

function TdxPrintLayoutViewPageViewInfoGenerator.CreateEmptyClone
  : TdxPageGeneratorLayoutManager;
begin
  Result := TdxPrintLayoutViewPageViewInfoGenerator.Create(View, ViewInfo);
end;

function TdxPrintLayoutViewPageViewInfoGenerator.CalculateFirstPageLeftOffset
  (ATotalPagesWidth: Integer): Integer;
begin
...
function TdxPrintLayoutViewPageViewInfoGenerator.CanFitPageToPageRow
  (APage: TdxPage; ARow: TdxPageViewInfoRow): Boolean;
begin
...
constructor TdxPrintLayoutViewBoxHitTestCalculator.Create(const ARequest
  : TdxRichEditHitTestRequest; AResult: TdxRichEditHitTestResult);
begin
  inherited Create(ARequest, AResult);
end;

procedure TdxPrintLayoutViewBoxHitTestCalculator.ProcessPageAreaCollection
  (ACollection: TdxPageAreaCollection);
begin
  if HitTestRequest.SearchAnyPieceTable then
  begin
    if ProcessSpecificPageArea(HitTestResult.Page.Header,
      TdxPageAreaHitTestManager.TPageAreaKind.Header, ACollection) then
      Exit;
    if ProcessSpecificPageArea(HitTestResult.Page.Footer,
      TdxPageAreaHitTestManager.TPageAreaKind.Footer, ACollection) then
      Exit;
    inherited ProcessPageAreaCollection(ACollection);
  end
  else
  begin
    if (HitTestResult.Page.Header <> nil) and
      (HitTestRequest.PieceTable = HitTestResult.Page.Header.PieceTable) then
    begin
      ProcessSpecificPageArea(HitTestResult.Page.Header,
        TdxPageAreaHitTestManager.TPageAreaKind.Header, ACollection);
      Exit;
    end;
    if (HitTestResult.Page.Footer <> nil) and
      (HitTestRequest.PieceTable = HitTestResult.Page.Footer.PieceTable) then
    begin
      ProcessSpecificPageArea(HitTestResult.Page.Footer,
        TdxPageAreaHitTestManager.TPageAreaKind.Footer, ACollection);
      Exit;
    end;
    if HitTestRequest.PieceTable = HitTestRequest.PieceTable.DocumentModel.MainPieceTable
    then
    begin
      inherited ProcessPageAreaCollection(ACollection);
      Exit;
...
function TdxPrintLayoutViewBoxHitTestCalculator.ProcessSpecificPageArea
  (AArea: TdxPageArea; AAreaKind: TdxPageAreaHitTestManager.TPageAreaKind;
  ACollection: TdxPageAreaCollection): Boolean;
var
...
constructor TdxPrintLayoutViewDocumentFormattingController.Create
  (ADocumentLayout: TdxDocumentLayout; APieceTable: TdxPieceTable);
begin
  inherited Create(ADocumentLayout, APieceTable, nil, nil);
end;

function TdxPrintLayoutViewDocumentFormattingController.CreatePageController
  : TdxPageController;
begin
  Result := TdxPrintLayoutViewPageController.Create(DocumentLayout);
end;

function TdxPrintLayoutViewDocumentFormattingController.CreateColumnController
  : TdxColumnController;
begin
  Result := TdxPrintLayoutViewColumnController.Create(PageAreaController);
end;

function TdxPrintLayoutViewDocumentFormattingController.CreatePageAreaController
  : TdxPageAreaController;
begin
  Result := TdxPrintLayoutViewPageAreaController.Create(PageController);
end;

function TdxPrintLayoutViewDocumentFormattingController.CreateRowController
  : TdxRowsController;
begin
...
constructor TdxHeaderFooterPageController.Create(ADocumentLayout
  : TdxDocumentLayout; AFloatingObjectsLayout: TdxFloatingObjectsLayout;
  AParagraphFramesLayout: TdxParagraphFramesLayout; APieceTable: TdxPieceTable);
begin
  inherited Create(ADocumentLayout, AFloatingObjectsLayout,
    AParagraphFramesLayout);
  FSectionIndex := 0;
...
procedure TdxHeaderFooterPageController.SetCurrentSectionIndex
  (const AValue: TdxSectionIndex);
begin
end;
...
procedure TdxHeaderFooterPageController.SetPageNumberSource
  (const AValue: TdxPage);
begin
  FPageNumberSource := AValue;
end;

procedure TdxHeaderFooterPageController.SetFixedSectionIndex
  (ASectionIndex: TdxSectionIndex);
begin
...
function TdxHeaderFooterPageController.GetNextPage(AKeepFloatingObjects
  : Boolean): TdxPage;
begin
  Result := Pages[0];
end;

function TdxHeaderFooterPageController.CreatePageBoundsCalculator
  : TdxPageBoundsCalculator;
begin
  Result := TdxHeaderFooterPageBoundsCalculator.Create(Self);
end;

function TdxHeaderFooterPageController.CreateHitTestCalculator
...
constructor TdxHeaderFooterPageBoundsCalculator.Create
  (AController: TdxHeaderFooterPageController);
begin
  inherited Create(AController.DocumentLayout.DocumentModel.
...
procedure TdxHeaderFooterColumnsBoundsCalculator.PopulateColumnsBounds
  (const AResult: TdxRectList; const ABounds: TRect;
  const AColumnInfoCollection: TdxColumnInfoCollection);
begin
  AResult.Add(ABounds);
end;

procedure TdxHeaderFooterColumnsBoundsCalculator.PopulateEqualWidthColumnsBounds
  (const AResult: TdxRectList; const ABounds: TRect;
...
function TdxHeaderFooterColumnController.CalculateColumnBoundsCore
  (AColumnIndex: Integer): TRect;
begin
  Result := ColumnsBounds[0];
end;

function TdxHeaderFooterColumnController.CreateColumnBoundsCalculator
  : TdxColumnsBoundsCalculator;
begin
  Result := TdxHeaderFooterColumnsBoundsCalculator.Create
    (PageAreaController.PageController.DocumentLayout.DocumentModel.
    ToDocumentLayoutUnitConverter);
end;

{ TdxHeaderFooterPageAreaController }

constructor TdxHeaderFooterPageAreaController.Create(APageController
  : TdxPageController);
begin
  inherited Create(APageController);
  FAreas := TdxPageAreaCollection.Create;
  FAreas.Add(TdxPageArea.Create(PageController.PieceTable.ContentType,
    PageController.DocumentModel.Sections.First));
end;
...
function TdxHeaderFooterPageAreaController.CompleteCurrentAreaFormatting
  : TdxCompleteFormattingResult;
begin
  Result := TdxCompleteFormattingResult.Success;
end;

function TdxHeaderFooterPageAreaController.GetNextPageArea(AKeepFloatingObjects
  : Boolean): TdxPageArea;
begin
  Result := Areas[0];
end;
...
procedure TdxHeaderFooterPageAreaController.BeginSectionFormatting
  (ASection: TdxSection; ACurrentColumnsCount: Integer);
begin
end;

procedure TdxHeaderFooterPageAreaController.
...
procedure TdxHeaderFooterPageAreaController.ClearInvalidatedContent
  (const APos: TdxFormatterPosition);
begin
end;

function TdxHeaderFooterPageAreaController.CreateDefaultState(ACurrentAreaIndex
  : Integer): TdxPageAreaControllerState;
begin
  Result := nil;
end;

procedure TdxHeaderFooterPageAreaController.SwitchToState
...
constructor TdxHeaderFooterDocumentFormattingController.Create(ADocumentLayout
  : TdxDocumentLayout; AFloatingObjectsLayout: TdxFloatingObjectsLayout;
  AParagraphFramesLayout: TdxParagraphFramesLayout; APieceTable: TdxPieceTable;
  AArea: TdxPageArea; ASectionIndex: TdxSectionIndex;
  APageNumberSource: TdxPage);
var
  AController: TdxHeaderFooterPageController;
begin
  inherited Create(ADocumentLayout, APieceTable, AFloatingObjectsLayout,
    AParagraphFramesLayout);
  Assert(AArea <> nil);
...
function TdxHeaderFooterDocumentFormattingController.CreatePageController
  : TdxPageController;
begin
  Result := TdxHeaderFooterPageController.Create(DocumentLayout,
    FloatingObjectsLayout, ParagraphFramesLayout, PieceTable);
end;

function TdxHeaderFooterDocumentFormattingController.CreatePageAreaController
  : TdxPageAreaController;
begin
  Result := TdxHeaderFooterPageAreaController.Create(PageController);
end;

function TdxHeaderFooterDocumentFormattingController.CreateColumnController
  : TdxColumnController;
begin
  Result := TdxHeaderFooterColumnController.Create(PageAreaController);
end;

function TdxHeaderFooterDocumentFormattingController.CreateRowController
  : TdxRowsController;
begin
...
procedure TdxHeaderFooterDocumentFormattingController.
  NotifyDocumentFormattingComplete;
begin
end;

{ TdxSimplePieceTablePrimaryFormatter }

constructor TdxSimplePieceTablePrimaryFormatter.Create
  (APieceTable: TdxPieceTable; AMeasurer: TdxBoxMeasurer;
  ARowsController: TdxRowsController;
  const AVisibleTextFilter: TdxVisibleTextFilterBase; APage: TdxPage);
begin
  Assert(APieceTable <> nil);
...
function TdxSimplePieceTablePrimaryFormatter.Format(AMaxHeight: Integer;
  AController: TdxDocumentFormattingController): Integer;
var
...
begin
  ...
  try
    ...
    ADocumentFormatter.ParagraphFormatter.PageNumberSource :=
...
constructor TdxPageHeaderFooterFormatterBase<TModelObject, TLayoutObject>.Create
...
begin
  ...
  FPage := APage;
  FSectionIndex := ASectionIndex;
  FSection := TdxDocumentModel(ADocumentLayout.DocumentModel)
    .Sections[ASectionIndex];
end;

procedure TdxPageHeaderFooterFormatterBase<TModelObject, TLayoutObject>.Format
  (AFirstPageOfSection: Boolean);
var
  APieceTable: TModelObject;
  AArea: TLayoutObject;
  AAvailableAreaBounds, AInitialAreaBounds, ANewAreaBounds,
    AOldPageClientBounds, ANewPageClientBounds: TRect;
...
begin
  ...
  MoveFloatingObjectsVertically(TdxPieceTable(APieceTable.PieceTable), ADeltaY,
    ShouldMoveFloatingObjectVertically);

  AArea.ContentBounds := ANewAreaBounds;
  ANewAreaBounds := AdjustNewAreaBounds(TdxPieceTable(APieceTable.PieceTable),
    ANewAreaBounds);
  ...
  ADeltaY := CalculateDeltaAfterAdjustPageClientBounds(AOldPageClientBounds,
    ANewPageClientBounds, AArea.Columns.First.Bounds);
  if ADeltaY <> 0 then
    MoveFloatingObjectsAfterAdjustPageClientBounds
      (TdxPieceTable(APieceTable.PieceTable), ADeltaY);
end;

procedure TdxPageHeaderFooterFormatterBase<TModelObject, TLayoutObject>.
  MoveFloatingObjectsAfterAdjustPageClientBounds(APieceTable: TdxPieceTable;
  ADeltaY: Integer);
var
...
begin
  ...
  try
    ...
    begin
      ABox := AObjects[I];
      if ShouldMoveFloatingObjectVerticallyAfterAdjustPageClientBounds(ABox)
      then
      begin
        if ABox.GetFloatingObjectRun.FloatingObjectProperties.
...
procedure TdxPageHeaderFooterFormatterBase<TModelObject, TLayoutObject>.
  MoveParagraphFramesVertically(APieceTable: TdxPieceTable; ADeltaY: Integer);
var
  I: Integer;
...
procedure TdxPageHeaderFooterFormatterBase<TModelObject, TLayoutObject>.
  MoveFloatingObjectsVertically(APieceTable: TdxPieceTable; ADeltaY: Integer;
...
function TdxPageHeaderFooterFormatterBase<TModelObject, TLayoutObject>.
  ShouldMoveFloatingObjectVertically(ABox: TdxFloatingObjectBox): Boolean;
var
...
begin
  ...
  Result := AVerticalPositionType
    in [TdxFloatingObjectVerticalPositionType.Line,
    TdxFloatingObjectVerticalPositionType.Margin,
    TdxFloatingObjectVerticalPositionType.Paragraph];
end;

function TdxPageHeaderFooterFormatterBase<TModelObject, TLayoutObject>.
  FormatArea(AContentType: TModelObject; AArea: TLayoutObject;
  const AAvailableAreaBounds: TRect): Integer;
var
...
begin
  ...
  try
    ...
    AController := TdxHeaderFooterDocumentFormattingController.Create
      (DocumentLayout, FFloatingObjectsLayout, FParagraphFramesLayout,
      APieceTable, AArea, SectionIndex, FPage);
    try
      AFakePage := AController.PageController.Pages.Last;
      AFakePage.Bounds := FPage.Bounds;
      AFakePage.ClientBounds := FPage.ClientBounds;

      AFormatter := TdxSimplePieceTablePrimaryFormatter.Create(APieceTable,
        AMeasurer, AController.RowsController, nil, Page);
...
function TdxPageHeaderFooterFormatterBase<TModelObject, TLayoutObject>.
  GetPageAreaBottom(AArea: TdxPageArea; AActualAreaBottom: Integer): Integer;
var
...
function TdxPageHeaderFooterFormatterBase<TModelObject, TLayoutObject>.FindRow
  (AColumn: TdxColumn; Y: Integer): TdxRow;
var
...
function TdxPageHeaderFooterFormatterBase<TModelObject, TLayoutObject>.FindRow
  (ATable: TdxTableViewInfo; Y: Integer): TdxRow;
var
...
begin
  ...
  if not TdxAlgorithms1<TdxTableRowViewInfoBase>.BinarySearch(ATable.Rows,
    AComparable.CompareTo, ATableRowIndex) then
    Exit(nil);
...
function TdxPageHeaderFooterFormatterBase<TModelObject, TLayoutObject>.FindRow
  (ARows: TdxRowCollection; Y: Integer): TdxRow;
var
  ARowIndex: Integer;
  AComparable: TdxBoxAndPointYComparable;
begin
  AComparable := TdxBoxAndPointYComparable.Create(TPoint.Create(0, Y));
  if TdxAlgorithms1<TdxBoxBase>.BinarySearch(ARows, AComparable.CompareTo,
    ARowIndex) then
...
function TdxPageHeaderFormatter.GetActualModelObject(AFirstPageOfSection
  : Boolean): TdxSectionHeader;
begin
  Result := Section.Headers.CalculateActualObject(AFirstPageOfSection,
    Page.IsEven);
end;

function TdxPageHeaderFormatter.CalculateDeltaAfterAdjustPageClientBounds
  (const AOldPageClientBounds, ANewPageClientBounds, AColumnBounds
  : TRect): Integer;
begin
  Result := ANewPageClientBounds.Top - AColumnBounds.Top;
end;

function TdxPageHeaderFormatter.GetExistingArea(APage: TdxPage)
  : TdxHeaderPageArea;
begin
  Result := APage.Header;
end;

function TdxPageHeaderFormatter.CreatePageArea(APieceTable: TdxSectionHeader)
  : TdxHeaderPageArea;
begin
...
begin
  ...
  Result.Y := DocumentLayout.DocumentModel.ToDocumentLayoutUnitConverter.
    ToLayoutUnits(Section.Margins.HeaderOffset);
  Result.Height := Page.Bounds.Height div 2;
end;

function TdxPageHeaderFormatter.CalculateFinalAreaBounds
  (AArea: TdxHeaderPageArea; AActualAreaBottom: Integer): TRect;
var
  AAreaBottom: Integer;
begin
  Result := AArea.Bounds;
...
function TdxPageHeaderFormatter.CalculateFinalAdjustedPageClientBounds
  (AArea: TdxHeaderPageArea): TRect;
var
...
function TdxPageHeaderFormatter.AdjustNewAreaBounds(APieceTable: TdxPieceTable;
  const ANewAreaBounds: TRect): TRect;
begin
  Result := ANewAreaBounds;
end;

function TdxPageHeaderFormatter.
  ShouldMoveFloatingObjectVerticallyAfterAdjustPageClientBounds
...
begin
  ARun := ABox.GetFloatingObjectRun;
  AVerticalPositionType := ARun.FloatingObjectProperties.VerticalPositionType;
  AVerticalPositionAlignment := ARun.FloatingObjectProperties.
    VerticalPositionAlignment;
  Result := ((AVerticalPositionType = TdxFloatingObjectVerticalPositionType.
    Margin) and (AVerticalPositionAlignment <>
    TdxFloatingObjectVerticalPositionAlignment.Bottom) and
    (AVerticalPositionAlignment <> TdxFloatingObjectVerticalPositionAlignment.
    Outside)) or
    ((AVerticalPositionType = TdxFloatingObjectVerticalPositionType.TopMargin)
    and (AVerticalPositionAlignment <>
    TdxFloatingObjectVerticalPositionAlignment.Bottom) and
    (AVerticalPositionAlignment <> TdxFloatingObjectVerticalPositionAlignment.
    Inside)) or
    ((AVerticalPositionType = TdxFloatingObjectVerticalPositionType.
    InsideMargin) and (AVerticalPositionAlignment <>
    TdxFloatingObjectVerticalPositionAlignment.Bottom) and
...
function TdxPageFooterFormatter.GetActualModelObject(AFirstPageOfSection
  : Boolean): TdxSectionFooter;
begin
  Result := Section.Footers.CalculateActualObject(AFirstPageOfSection,
    Page.IsEven);
end;
...
procedure TdxPageFooterFormatter.MoveFloatingObjectsAfterAdjustPageClientBounds
  (APieceTable: TdxPieceTable; ADeltaY: Integer);
begin
  inherited MoveFloatingObjectsAfterAdjustPageClientBounds(APieceTable,
    ADeltaY);
  if Page.Header <> nil then
    inherited MoveFloatingObjectsAfterAdjustPageClientBounds
      (TdxPieceTable(Page.Header.Header.PieceTable), ADeltaY);
end;

function TdxPageFooterFormatter.
  ShouldMoveFloatingObjectVerticallyAfterAdjustPageClientBounds
  (ABox: TdxFloatingObjectBox): Boolean;
var
  ARun: TdxFloatingObjectAnchorRun;
...
begin
  ...
  Result := ((AVerticalPositionType = TdxFloatingObjectVerticalPositionType.
    ...
    Outside)) or
    ((AVerticalPositionType = TdxFloatingObjectVerticalPositionType.
    BottomMargin) and (AVerticalPositionAlignment <>
    TdxFloatingObjectVerticalPositionAlignment.Bottom) and
    (AVerticalPositionAlignment <> TdxFloatingObjectVerticalPositionAlignment.
    Outside)) or
    ((AVerticalPositionType = TdxFloatingObjectVerticalPositionType.
    OutsideMargin) and (AVerticalPositionAlignment <>
    TdxFloatingObjectVerticalPositionAlignment.Bottom) and
    (AVerticalPositionAlignment <>
    TdxFloatingObjectVerticalPositionAlignment.Outside));
end;

function TdxPageFooterFormatter.GetExistingArea(APage: TdxPage)
  : TdxFooterPageArea;
begin
  Result := APage.Footer;
end;

function TdxPageFooterFormatter.CreatePageArea(APieceTable: TdxSectionFooter)
  : TdxFooterPageArea;
begin
...
begin
  ...
  Result.Y := Page.Bounds.Height - AMaxHeight -
    DocumentLayout.DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits
    (Section.Margins.FooterOffset);
  Result.Height := AMaxHeight;
end;

function TdxPageFooterFormatter.CalculateFinalAreaBounds
  (AArea: TdxFooterPageArea; AActualAreaBottom: Integer): TRect;
var
...
procedure TdxPageFooterFormatter.MoveFloatingObjectsVertically
  (APieceTable: TdxPieceTable; ADeltaY: Integer;
  ACheckMoveFunc: TShouldMoveBoxVertically);
var
  AFloatingObjectsBottom, APageBottom: Integer;
begin
  AFloatingObjectsBottom := CalculateFloatingObjectsBottomWithDelta
    (APieceTable, ADeltaY);
...
function TdxPageFooterFormatter.AdjustNewAreaBounds(APieceTable: TdxPieceTable;
  const ANewAreaBounds: TRect): TRect;
var
  AFloatingObjectsBottom, ABottom: Integer;
begin
  AFloatingObjectsBottom := CalculateFloatingObjectsBottom(APieceTable,
    ANewAreaBounds.Top);
  ABottom := Math.Min(Page.Bounds.Bottom, Math.Max(ANewAreaBounds.Bottom,
    AFloatingObjectsBottom));
  ANewAreaBounds.Height := ABottom - ANewAreaBounds.Top;
  Result := ANewAreaBounds;
end;

function TdxPageFooterFormatter.CalculateFloatingObjectsBottom
  (APieceTable: TdxPieceTable; AInitialBottom: Integer): Integer;
begin
  Result := CalculateFloatingObjectsBottomWithDelta(APieceTable,
    AInitialBottom, 0);
end;

function TdxPageFooterFormatter.CalculateFloatingObjectsBottomWithDelta
  (APieceTable: TdxPieceTable; AInitialBottom: Integer;
...
function TdxPageFooterFormatter.CalculateFloatingObjectsBottomWithDelta
  (APieceTable: TdxPieceTable; ADelta: Integer): Integer;
begin
  Result := CalculateFloatingObjectsBottomWithDelta(APieceTable,
    MinInt, ADelta);
end;

function TdxPageFooterFormatter.CalculateFinalAdjustedPageClientBounds
  (AArea: TdxFooterPageArea): TRect;
begin
...
constructor TdxPrintLayoutViewPageController.Create(ADocumentLayout
  : TdxDocumentLayout);
begin
  inherited Create(ADocumentLayout, nil, nil);
end;

function TdxPrintLayoutViewPageController.CreatePageBoundsCalculator
  : TdxPageBoundsCalculator;
begin
  Result := TdxPageBoundsCalculator.Create
    (DocumentLayout.DocumentModel.ToDocumentLayoutUnitConverter);
end;

procedure TdxPrintLayoutViewPageController.FormatHeader(APage: TdxPage;
  AFirstPageOfSection: Boolean);
var
  AFormatter: TdxPageHeaderFormatter;
begin
  AFormatter := TdxPageHeaderFormatter.Create(DocumentLayout,
    FloatingObjectsLayout, ParagraphFramesLayout, APage, CurrentSectionIndex);
  try
...
procedure TdxPrintLayoutViewPageController.FormatFooter(APage: TdxPage;
  AFirstPageOfSection: Boolean);
var
  AFormatter: TdxPageFooterFormatter;
begin
  AFormatter := TdxPageFooterFormatter.Create(DocumentLayout,
    FloatingObjectsLayout, ParagraphFramesLayout, APage, CurrentSectionIndex);
  try
    AFormatter.Format(AFirstPageOfSection);
  finally
...
procedure TdxPrintLayoutViewPageController.ApplyExistingHeaderAreaBounds
  (APage: TdxPage);
var
  AFormatter: TdxPageHeaderFormatter;
begin
...
procedure TdxPrintLayoutViewPageController.ApplyExistingFooterAreaBounds
  (APage: TdxPage);
var
  AFormatter: TdxPageFooterFormatter;
begin
...
function TdxPrintLayoutViewPageController.CreateHitTestCalculator
  (const ARequest: TdxRichEditHitTestRequest; AResult: TdxRichEditHitTestResult)
  : TdxBoxHitTestCalculator;
begin
  Result := TdxPrintLayoutViewBoxHitTestCalculator.Create(ARequest, AResult);
...
function TdxPrintLayoutViewColumnController.CalculateColumnBoundsCore
  (AColumnIndex: Integer): TRect;
begin
...
procedure TdxPrintLayoutViewPageAreaController.
  RestartFormattingFromTheStartOfSection(ASection: TdxSection;
  ACurrentAreaIndex: Integer);
begin
  SwitchToDefaultState;
...
function TdxPrintLayoutViewPageAreaController.CreateDefaultState
  (ACurrentAreaIndex: Integer): TdxPageAreaControllerState;
begin
  Result := TdxPrintLayoutViewDefaultPageAreaControllerState.Create(Self,
    ACurrentAreaIndex);
end;

{ TdxFinishContinuousSectionStartPageAreaControllerState }

constructor TdxFinishContinuousSectionStartPageAreaControllerState.Create
  (AOwner: TdxPageAreaController; const AAreaBounds: TRect);
begin
...
function TdxFinishContinuousSectionStartPageAreaControllerState.
  CompleteCurrentAreaFormatting: TdxCompleteFormattingResult;
begin
...
function TdxFinishContinuousSectionStartPageAreaControllerState.GetNextPageArea
  (AKeepFloatingObjects: Boolean): TdxPageArea;
var
...
procedure TdxFinishContinuousSectionStartPageAreaControllerState.
  ApplySectionStart(ASection: TdxSection; ACurrentColumnsCount: Integer);
var
  ANextState: TdxPageAreaControllerState;
begin
...
function TdxFinishContinuousSectionStartPageAreaControllerState.
  CreateCurrentAreaBoundsCore: TRect;
begin
  Result := FAreaBounds;
end;
...
constructor TdxHeaderFooterDecoratorPainter.Create(AView: TdxPrintLayoutView;
  const AOwner: IdxHeaderFooterDecoratorPainterOwner);
begin
  inherited Create;
...
function TdxHeaderFooterDecoratorPainter.GetOwner
  : IdxHeaderFooterDecoratorPainterOwner;
begin
  Result := FOwner;
end;
...
procedure TdxHeaderFooterDecoratorPainter.DrawDecorators(APainter: TdxPainter;
  AViewInfos: TdxPageViewInfoCollection);
var
  ACount, I: Integer;
begin
...
procedure TdxHeaderFooterDecoratorPainter.DrawPageDecorators(APage: TdxPage;
  APainter: TdxPainter);
begin
...
procedure TdxHeaderFooterDecoratorPainter.DrawHeaderFrame(APage: TdxPage;
  AArea: TdxPageArea; APainter: TdxPainter);
var
...
begin
  ...
  ABaseBounds := CalculateHeaderCaptionBaseBounds(ACaption, ABounds,
    AGdiPlusPainter);
  DrawHeaderCaptionBackground(ABaseBounds, AGdiPlusPainter);
  DrawCaptionText(ACaption, ABaseBounds, AGdiPlusPainter,
    FRoundedRectangleRadius div 2);
  ...
  begin
    ...
    ABaseBounds := CalculateHeaderLinkCaptionBaseBounds(ACaption, ABounds,
      AGdiPlusPainter);
    DrawHeaderCaptionBackground(ABaseBounds, AGdiPlusPainter);
    DrawCaptionText(ACaption, ABaseBounds, AGdiPlusPainter,
      FRoundedRectangleRadius div 2);
...
procedure TdxHeaderFooterDecoratorPainter.DrawFooterFrame(APage: TdxPage;
  AArea: TdxPageArea; APainter: TdxPainter);
var
  ABounds, ABaseBounds: TRect;
  AGdiPlusPainter: TdxGdiPlusPainter;
...
begin
  ...
  ABaseBounds := CalculateFooterCaptionBaseBounds(ACaption, ABounds,
    AGdiPlusPainter);
  ...
  begin
    ACaption := cxGetResourceString(@sdxRichEditCaption_SameAsPrevious);
    ABaseBounds := CalculateFooterLinkCaptionBaseBounds(ACaption, ABounds,
      AGdiPlusPainter);
    DrawFooterCaptionBackground(ABaseBounds, AGdiPlusPainter);
    DrawCaptionText(ACaption, ABaseBounds, AGdiPlusPainter,
      -FRoundedRectangleRadius div 2);
...
function TdxHeaderFooterDecoratorPainter.DrawHeaderFooterLine
  (APainter: TdxPainter; const AInitialLineBounds: TRect): TRect;
begin
  Result := RichEditControl.GetPixelPhysicalBounds(CurrentPageInfo,
    AInitialLineBounds);
  Result.Height := 1;
  Result.X := Result.X + Owner.LeftHeaderFooterLineOffset;
  Result.Width := Result.Width - Owner.LeftHeaderFooterLineOffset +
    Owner.RightHeaderFooterLineOffset;
  APainter.DrawLine(FHeaderFooterLinePen, Result.Left, Result.Top, Result.Right,
    Result.Top);
end;

function TdxHeaderFooterDecoratorPainter.GetCaption(AHeaderFooter
  : TdxSectionHeaderFooterBase; APage: TdxPage): string;
var
  ASectionIndex: TdxSectionIndex;
begin
...
function TdxHeaderFooterDecoratorPainter.MeasureString(const ACaption: string;
  APainter: TdxGdiPlusPainter): TSize;
begin
  Result := cxTextSize(FHeaderFooterMarkFont, ACaption);
end;

function TdxHeaderFooterDecoratorPainter.CalculateHeaderCaptionBaseBounds
  (const ACaption: string; const AHeaderLineBounds: TRect;
  AGdiPlusPainter: TdxGdiPlusPainter): TRect;
begin
...
function TdxHeaderFooterDecoratorPainter.CalculateHeaderLinkCaptionBaseBounds
  (const ACaption: string; const AHeaderLineBounds: TRect;
  AGdiPlusPainter: TdxGdiPlusPainter): TRect;
var
  ASize: TSize;
...
function TdxHeaderFooterDecoratorPainter.CalculateFooterCaptionBaseBounds
  (const ACaption: string; const AHeaderLineBounds: TRect;
  AGdiPlusPainter: TdxGdiPlusPainter): TRect;
begin
  Result := AHeaderLineBounds;
...
function TdxHeaderFooterDecoratorPainter.CalculateFooterLinkCaptionBaseBounds
  (const ACaption: string; const AFooterLineBounds: TRect;
  AGdiPlusPainter: TdxGdiPlusPainter): TRect;
var
  ASize: TSize;
begin
...
procedure TdxHeaderFooterDecoratorPainter.DrawHeaderCaptionBackground
  (const ABounds: TRect; AGdiPlusPainter: TdxGdiPlusPainter);
var
  APath: TdxGPPath;
begin
...
procedure TdxHeaderFooterDecoratorPainter.DrawFooterCaptionBackground
  (const ABounds: TRect; AGdiPlusPainter: TdxGdiPlusPainter);
var
  APath: TdxGPPath;
begin
...
function TdxHeaderFooterDecoratorPainter.CreateHeaderCaptionBackgroundPath
  (const ABounds: TRect): TdxGPPath;
begin
  Result := TdxGPPath.Create;
  Result.AddLine(ABounds.X - FRoundedRectangleRadius, ABounds.Y,
    ABounds.X - FRoundedRectangleRadius, ABounds.Y + ABounds.Height);
  Result.AddArc(ABounds.X - FRoundedRectangleRadius, ABounds.Y + ABounds.Height
    - FRoundedRectangleRadius, 2 * FRoundedRectangleRadius,
    2 * FRoundedRectangleRadius, 180, -90);
  Result.AddLine(ABounds.X + FRoundedRectangleRadius, ABounds.Y + ABounds.Height
    + FRoundedRectangleRadius, ABounds.Right - FRoundedRectangleRadius,
    ABounds.Y + ABounds.Height + FRoundedRectangleRadius);
  Result.AddArc(ABounds.Right - FRoundedRectangleRadius,
    ABounds.Y + ABounds.Height - FRoundedRectangleRadius,
    2 * FRoundedRectangleRadius, 2 * FRoundedRectangleRadius, 90, -90);
  Result.AddLine(ABounds.Right + FRoundedRectangleRadius,
    ABounds.Y + ABounds.Height - FRoundedRectangleRadius,
    ABounds.Right + FRoundedRectangleRadius, ABounds.Y);
  Result.AddLine(ABounds.Right + FRoundedRectangleRadius, ABounds.Y,
    ABounds.X - FRoundedRectangleRadius, ABounds.Y);
end;

function TdxHeaderFooterDecoratorPainter.CreateFooterCaptionBackgroundPath
  (const ABounds: TRect): TdxGPPath;
begin
  Result := TdxGPPath.Create;
  Result.AddLine(ABounds.X - FRoundedRectangleRadius, ABounds.Y,
    ABounds.X - FRoundedRectangleRadius, ABounds.Bottom);
  Result.AddLine(ABounds.X - FRoundedRectangleRadius, ABounds.Bottom,
    ABounds.Right + FRoundedRectangleRadius, ABounds.Bottom);
  Result.AddLine(ABounds.Right + FRoundedRectangleRadius, ABounds.Bottom,
    ABounds.Right + FRoundedRectangleRadius, ABounds.Y);
  Result.AddArc(ABounds.Right - FRoundedRectangleRadius,
    ABounds.Y - FRoundedRectangleRadius, 2 * FRoundedRectangleRadius,
    2 * FRoundedRectangleRadius, 0, -90);
  Result.AddLine(ABounds.Right - FRoundedRectangleRadius,
    ABounds.Y - FRoundedRectangleRadius, ABounds.X + FRoundedRectangleRadius,
    ABounds.Y - FRoundedRectangleRadius);
  Result.AddArc(ABounds.X - FRoundedRectangleRadius,
    ABounds.Y - FRoundedRectangleRadius, 2 * FRoundedRectangleRadius,
    2 * FRoundedRectangleRadius, -90, -90);
end;

procedure TdxHeaderFooterDecoratorPainter.DrawHeaderFooterCaptionBackground
  (APath: TdxGPPath; AGdiPlusPainter: TdxGdiPlusPainter);
var
...
begin
  ...
  try
    ...
    AGraphics.Path(APath, Owner.HeaderFooterMarkTextColor,
      Owner.HeaderFooterMarkBackColor);
  finally
    AGraphics.SmoothingMode := AOldSmoothingMode;
  end;
end;

procedure TdxHeaderFooterDecoratorPainter.DrawCaptionText(const ACaption
  : string; ABounds: TRect; AGdiPlusPainter: TdxGdiPlusPainter;
  AOffset: Integer);
var
  AGraphics: TdxGraphics;
  AHdc: HDC;
...
begin
  ...
  try
    ...
    AOldColor := SetTextColor(AHdc,
      TdxAlphaColors.ToColor(Owner.HeaderFooterMarkTextColor));
    ExtTextOut(AHdc, ABounds.Left, ABounds.Top, 0, @ABounds, PChar(ACaption),
      Length(ACaption), nil);
...
function TdxPrintLayoutViewPainter.GetUnitConverter
...
begin
  Result := TdxAlphaColors.FromColor
    (LookAndFeel.Painter.RichEditControlHeaderFooterLineColor);
end;

function TdxPrintLayoutViewPainter.GetHeaderFooterMarkBackColor: TdxAlphaColor;
begin
  Result := TdxAlphaColors.FromColor
    (LookAndFeel.Painter.RichEditControlHeaderFooterMarkBackColor);
end;

function TdxPrintLayoutViewPainter.GetHeaderFooterMarkTextColor: TdxAlphaColor;
begin
  Result := TdxAlphaColors.FromColor
    (LookAndFeel.Painter.RichEditControlHeaderFooterMarkTextColor);
end;

procedure TdxPrintLayoutViewPainter.DrawEmptyPage
  (AGraphics: TdxGraphics { ACache: TdxGraphicsCache }; APage: TdxPageViewInfo);
begin
  AGraphics.FillRectangle(APage.ClientBounds, GetActualPageBackColor);
  AGraphics.Rectangle(APage.ClientBounds, TdxAlphaColors.Black,
    TdxAlphaColors.Empty);
end;

procedure TdxPrintLayoutViewPainter.DrawEmptyComment(AGraphics: TdxGraphics;
  AComment: TdxCommentViewInfo);
begin
  NotImplemented;
end;

procedure TdxPrintLayoutViewPainter.DrawEmptyExtensionComment
  (AGraphics: TdxGraphics; AComment: TdxCommentViewInfo);
begin
  NotImplemented;
end;

procedure TdxPrintLayoutViewPainter.DrawRoundedRectangle(AGraphics: TdxGraphics;
  const ARect: TRect; ARadius: Integer; AFillColor: TdxAlphaColor;
...
begin
  ...
  if ADocumentProperties.DisplayBackgroundShape and
    not TdxAlphaColors.IsEmpty(ACommentBackColor) then
...
procedure TdxPrintLayoutViewSkinPainter.DrawEmptyPage(AGraphics: TdxGraphics;
...
begin
  ...
  begin
    APageBounds.Inflate(AOffsets.Left, AOffsets.Top, AOffsets.Right,
      AOffsets.Bottom);
...
begin
  ...
  APageBackColor := ADocumentProperties.PageBackColor;
  if ADocumentProperties.DisplayBackgroundShape and
    (APageBackColor <> TdxAlphaColors.Empty) then
    Exit(APageBackColor);

  Result := View.ActualBackColor;
end;

function TdxPrintLayoutViewSkinPainter.CalculatePageViewInfoPixelBounds
...
begin
  ...
  Result.Offset(AControl.ViewBounds.X - View.HorizontalScrollController.
    GetPhysicalLeftInvisibleWidth, AControl.ViewBounds.Y);
...
begin
  Result := Control.InnerControl.Options.Layout.PrintLayoutView.
    MatchHorizontalTableIndentsToTextEdge;
end;
...
begin
  ...
  if (AVerticalRuler <> nil) and (not AVerticalRuler.IsVisible) then
    AOffset := AOffset * 2;
  ALogicalOffset := DocumentLayout.UnitConverter.PixelsToLayoutUnits(AOffset,
    DocumentModel.DpiY);
...
procedure TdxPrintLayoutView.SetPageHorizontalAlignment
...
function TdxPrintLayoutView.CreateDocumentFormattingController
  : TdxDocumentFormattingController;
begin
  Result := TdxPrintLayoutViewDocumentFormattingController.Create
    (DocumentLayout, DocumentModel.MainPieceTable);
end;

function TdxPrintLayoutView.CreatePageViewInfoGenerator
  : TdxPageViewInfoGenerator;
begin
  Result := TdxPrintLayoutViewPageViewInfoGenerator.Create(Self, ViewInfo);
end;

function TdxPrintLayoutView.CreateDocumentLayoutExporter(APainter: TdxPainter;
  AAdapter: TdxGraphicsDocumentLayoutExporterAdapter;
  APageViewInfo: TdxPageViewInfo; const ABounds: TRect)
  : TdxDocumentLayoutExporter;
begin
  if AllowDisplayLineNumbers then
    Result := TdxScreenOptimizedGraphicsDocumentLayoutExporter.Create
      (DocumentModel, APainter, AAdapter, ABounds, TextColors, ScaleFactor)
  else
    Result := TdxScreenOptimizedGraphicsDocumentLayoutExporterNoLineNumbers.
      Create(DocumentModel, APainter, AAdapter, ABounds, TextColors,
      ScaleFactor);
end;
...
function TdxPrintLayoutView.CreateBackgroundPainter
  ...
  begin
    ...
    if APreferredPageIndex < 0 then
      if FTextBoxPageIndex > 0 then
        ...
        APreferredPageIndex := FormattingController.PageController.
          Pages.Count - 1;
    Assert(APreferredPageIndex >= 0);
    SelectionLayout := TdxHeaderFooterSelectionLayout.Create(Self,
      APreferredPageIndex);
    CaretPosition := TdxHeaderFooterCaretPosition.Create(Self,
      APreferredPageIndex);
  end
  else
...
function TdxPrintLayoutView.ExpandClipBoundsToPaddings(const AClipBounds
  : TRect): TRect;
begin
  Result := AClipBounds;
end;
