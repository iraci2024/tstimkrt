...
uses
  Types, Windows, Messages, ShellAPI, TypInfo, SysUtils, Classes, Forms,
  Controls, IniFiles,
...
type
  ...
  IcxDesignHelper = interface
    ...
    function CanDeleteComponent(AOwner: TComponent;
      AComponent: TComponent): Boolean;
    procedure ChangeSelection(AOwner: TComponent; AObject: TPersistent);
    function IsObjectSelected(AOwner: TComponent; AObject: TPersistent)
      : Boolean;
    procedure Modified;
    procedure RemoveSelectionChangedListener(AObject: TPersistent);
    procedure SelectObject(AOwner: TComponent; AObject: TPersistent;
      AClearSelection: Boolean = True; AActivateOwner: Boolean = True);
  ...
  TcxCustomComponent = class(TComponent, IdxAdornerTargetElementCollection)
  private
  protected
    // IdxAdornerTargetElementCollection
  ...
  published
    property FakeComponentLink1: TComponent read FFakeComponentLink1
      write FFakeComponentLink1 stored False;
    property FakeComponentLink2: TComponent read FFakeComponentLink2
      write FFakeComponentLink2 stored False;
    property FakeComponentLink3: TComponent read FFakeComponentLink3
      write FFakeComponentLink3 stored False;
  end;
  ...
  public
    ...
    property OnAfterComponentChange: TNotifyEvent read FOnAfterComponentChange
      write FOnAfterComponentChange;
    property OnBeforeComponentChange: TNotifyEvent read FOnBeforeComponentChange
      write FOnBeforeComponentChange;
  end;

  { TcxTimer }

  TdxTimerProc = procedure(AWnd: HWnd; AMsg: UINT; ATimerID: UINT_PTR;
    ASysTime: DWORD); stdcall;
  ...
  TcxScalableComponent = class(TcxComponent, IdxScaleFactor,
    IcxScalableComponent)
  strict private
    FScalable: Boolean;
  ...
  TcxCollectionNotifyEvent = procedure(Sender: TObject; AItem: TCollectionItem)
    of Object;
  TcxCollectionCompareEvent = function(ASender: TObject;
    AItem1, AItem2: TCollectionItem): Integer of object;
  ...
  private
    ...
    function CompareItems(AList: TStringList;
  ...
  protected
    ...
    property IsDestroying: Boolean read GetIsDestroying;
    property OnCompare: TcxCollectionCompareEvent read FOnCompare
      write FOnCompare;
  public
    destructor Destroy; override;
  ...
  public
    ...
    property Count: Integer read GetCount;
    property Items[Index: Integer]: TcxRegisteredClassListItemData
  ...
  public
    ...
    property RegisterClasses: Boolean read FRegisterClasses
      write FRegisterClasses;
    property Sorted: Boolean read FSorted write SetSorted;
  end;
  ...
  published
    ...
    property Vert: TcxAlignmentVert read FVert write SetVert
      stored IsVertStored;
  end;
  ...
  protected
    ...
    function GetCollectionFromParent(AParent: TComponent)
      : TcxComponentCollection; virtual; abstract;
  ...
  public
    ...
    property Collection: TcxComponentCollection read FCollection
      write SetCollection;
  ...
  TcxComponentCollectionNotification = (ccnAdded, ccnChanged, ccnExtracting,
    ccnExtracted, ccnDeleting);
  TcxComponentCollectionChangeEvent = procedure(Sender: TObject;
    AItem: TcxComponentCollectionItem;
    AAction: TcxComponentCollectionNotification) of object;
  ...
  protected
    ...
    function AddItem(AItemClass: TcxComponentCollectionItemClass;
      AParentComponent, AOwner: TComponent)
      : TcxComponentCollectionItem; overload;
  ...
  public
    constructor Create(AParentComponent: TComponent;
      AItemClass: TcxComponentCollectionItemClass); virtual;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    function Add: TcxComponentCollectionItem; overload;
    function Add(AItemClass: TcxComponentCollectionItemClass)
      : TcxComponentCollectionItem; overload;
    ...
    property Items[AIndex: Integer]: TcxComponentCollectionItem read GetItem
      write SetItem; default;
    property OnChange: TcxComponentCollectionChangeEvent read FOnChange
      write FOnChange;
  end;
  ...
  public
    ...
    property DefaultPosition: TPosition read FDefaultPosition
      write FDefaultPosition default poMainFormCenter;
  end;
  ...
  TcxComponentListNotifyEvent = procedure(Sender: TObject;
    AComponent: TComponent; AAction: TListNotification) of object;
  TcxComponentListChangeEvent = procedure(Sender: TObject;
  ...
  protected
    ...
    procedure Update(AItem: TComponent = nil;
      AAction: TcxComponentCollectionNotification = ccnChanged);
  public
    ...
    procedure EndUpdate;
    property OnComponentListChanged: TcxComponentListChangeEvent
      read FOnComponentListChanged write FOnComponentListChanged;
    property OnNotify: TcxComponentListNotifyEvent read FOnNotify
      write FOnNotify;
  end;
  ...
  public
    constructor Create(AStageCount: Integer; AEventSender: TObject;
      AProgressEvent: TcxProgressEvent);
  end;

  { TdxLanguages }

  TcxNotifyProcedure = procedure(Sender: TObject);
  TcxNotifyEvent = procedure(Sender: TObject; ANotificationText: string)
    of object;
  ...
  const
    LangMap: array [0 .. 23] of TLangRec = ((ShortName: 'ar';
      LanguageID: TdxLanguageID.Arabic), (ShortName: 'az';
      LanguageID: TdxLanguageID.Azerbaijani), (ShortName: 'bg';
      LanguageID: TdxLanguageID.Bulgarian), (ShortName: 'ca';
      LanguageID: TdxLanguageID.Catalan), (ShortName: 'cs';
      LanguageID: TdxLanguageID.Czech), (ShortName: 'da';
      LanguageID: TdxLanguageID.Danish), (ShortName: 'de';
      LanguageID: TdxLanguageID.German), (ShortName: 'el';
      LanguageID: TdxLanguageID.Greek), (ShortName: 'en';
      LanguageID: TdxLanguageID.English), (ShortName: 'es';
      LanguageID: TdxLanguageID.Spanish), (ShortName: 'eu';
      LanguageID: TdxLanguageID.Basque), (ShortName: 'gl';
      LanguageID: TdxLanguageID.Galician), (ShortName: 'fr';
      LanguageID: TdxLanguageID.French), (ShortName: 'hr';
      LanguageID: TdxLanguageID.Croatian), (ShortName: 'hu';
      LanguageID: TdxLanguageID.Hungarian), (ShortName: 'it';
      LanguageID: TdxLanguageID.Italian), (ShortName: 'lv';
      LanguageID: TdxLanguageID.Latvian), (ShortName: 'nl';
      LanguageID: TdxLanguageID.Dutch), (ShortName: 'pl';
      LanguageID: TdxLanguageID.Polish), (ShortName: 'pt';
      LanguageID: TdxLanguageID.Portuguese), (ShortName: 'ru';
      LanguageID: TdxLanguageID.Russian), (ShortName: 'sv';
      LanguageID: TdxLanguageID.Swedish), (ShortName: 'tr';
      LanguageID: TdxLanguageID.Turkish), (ShortName: 'uk';
      LanguageID: TdxLanguageID.Ukrainian));
  public
...
function cxIsDestroying(AComponent: TComponent;
  ARecursive: Boolean = False): Boolean;
...
function ClassInheritsFrom(AClass: TClass;
  const AParentClassName: string): Boolean;
procedure FillStringsWithEnumTypeValues(AStrings: TStrings;
  ATypeInfo: PTypeInfo; AGetTypeItemCaption: TcxGetCaptionForIntegerItemFunc);
...
function cxSendStructMessage(AHandle: THandle; AMsg: UINT; WParam: WParam;
  const LParam): LRESULT; overload;
function cxSendStructMessage(AHandle: THandle; AMsg: UINT; const WParam;
  LParam: LParam): LRESULT; overload;

function cxCreateTimer(AOnTimer: TNotifyEvent; AInterval: Integer = 1000;
  AEnabled: Boolean = True): TcxTimer;
function dxSetTimer(AWindowHandle: THandle; ATimerID: TdxNativeUInt;
  AInterval: Cardinal): Boolean; overload;
function dxSetTimer(AInterval: Cardinal; ATimerProcedure: TdxTimerProc)
  : TdxNativeUInt; overload;
function dxSetTimer(AWindowHandle: THandle; ATimerID: TdxNativeUInt;
  AInterval: Cardinal; ATimerProcedure: TdxTimerProc): TdxNativeUInt; overload;
...
function cxIsDestroying(AComponent: TComponent;
  ARecursive: Boolean = False): Boolean;
begin
  Result := (AComponent <> nil) and ((csDestroying in AComponent.ComponentState)
    or ARecursive and (cxIsDestroying(AComponent.Owner) or
    (AComponent is TControl) and (TControl(AComponent).Parent <>
    AComponent.Owner) and cxIsDestroying(TControl(AComponent).Parent)));
end;
...
function cxStrCharLength(const AStr: string; AIndex: Integer = 1): Integer;
begin
  Result := TdxNativeUInt(CharNext(GetPChar(AStr, AIndex))) -
    TdxNativeUInt(GetPChar(AStr, AIndex));
end;

function cxNextCharPos(const AStr: string; AIndex: Integer): Integer;
begin
  Result := TdxNativeUInt(CharNext(GetPChar(AStr, AIndex))) -
    TdxNativeUInt(GetPChar(AStr, 1)) + 1;
end;

function cxPrevCharPos(const AStr: string; AIndex: Integer): Integer;
begin
  Result := TdxNativeUInt(CharPrev(GetPChar(AStr, 1), GetPChar(AStr, AIndex))) -
    TdxNativeUInt(GetPChar(AStr, 1)) + 1;
end;
...
var
  ...
  AList: TList;
begin
  if not IsDesigning or IsDestroying or (Owner = nil) then
    Exit;
  AList := TList.Create;
  try
...
begin
  case Index of
    0:
      FFakeComponentLink1 := Value;
    1:
      FFakeComponentLink2 := Value;
    2:
      FFakeComponentLink3 := Value;
  end;
end;
...
begin
  inherited;
  Filer.DefineProperty('PixelsPerInch', ReadPixelsPerInch,
    WritePixelsPerInch, True);
end;
...
begin
  if cisUpdating in FInternalState then
    Exit;
...
type
  TcxStringListCompareEvent = function(AList: TStringList;
    AIndex1, AIndex2: Integer): Integer of object;
  ...
  public
    ...
    property OnCompare: TcxStringListCompareEvent read FOnCompare
      write FOnCompare;
  end;

  { TcxStringList }

function cxStringListCompareStrings(AList: TStringList;
  AIndex1, AIndex2: Integer): Integer;
begin
...
function TcxOwnedInterfacedCollection.DoCompareItems(AItem1,
...
var
  ...
  I: Integer;
begin
  if (UpdateCount > 0) or (cisSorting in FInternalState) then
    Exit;
...
function TcxOwnedInterfacedCollection.QueryInterface(const IID: TGUID;
  out Obj): HResult;
begin
  if GetInterface(IID, Obj) then
    Result := S_OK
...
function TcxOwnedInterfacedCollection.CompareItems(AList: TStringList;
  AIndex1, AIndex2: Integer): Integer;
var
...
procedure TcxRegisteredClassList.Unregister(AItemClass,
...
begin
  ...
  begin
    AData := Items[I];
    if (AData.ItemClass = AItemClass) and
      (AData.RegisteredClass = ARegisteredClass) then
    begin
      AData.Free;
      FItems.Delete(I);
    end;
...
function TcxRegisteredClassList.Find(AItemClass: TClass;
...
begin
  ...
  begin
    ...
    else if AData.ItemClass.InheritsFrom(AItemClass) then
      AIndex := I;
  end;
end;
...
function TcxRegisteredClassList.GetItem(Index: Integer)
  : TcxRegisteredClassListItemData;
begin
...
begin
  Result := TcxRegisteredClassesStringList(List)
    .Owner.CompareItems(Index1, Index2);
end;
...
function TcxRegisteredClasses.FindByDescription(const ADescription
  : string): TClass;
var
  I: Integer;
begin
...
procedure TcxRegisteredClasses.Register(AClass: TClass;
...
{ procedure ProcessFixedColumns;
  ...
  procedure ProcessItem(AItem: TcxAutoWidthItem);
    ...
    begin
      Result := MulDiv(AOffset + AItem.Width, AAvailableWidth, AWidth) -
  ...
  begin
    ...
    else if AItemAutoWidth <= AItem.MinWidth then
    begin
...
constructor TcxAlignment.Create(AOwner: TPersistent;
  AUseAssignedValues: Boolean = False; ADefaultHorz: TAlignment = taLeftJustify;
  ADefaultVert: TcxAlignmentVert = vaTop);
begin
  inherited Create;
  FOwner := AOwner;
...
begin
  for Result := 0 to Count - 1 do
    if Items[Result].Equals(AItem) then
      Exit;
  Result := -1;
end;
...
procedure TcxComponentCollectionItem.SetCollection
...
procedure TcxComponentCollectionItem.AddToCollection
...
procedure TcxComponentCollectionItem.RemoveFromCollection
  (ACollection: TcxComponentCollection);
begin
  if ACollection <> nil then
...
constructor TcxComponentCollection.Create(AParentComponent: TComponent;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        Add(TcxComponentCollectionItemClass(AItem.ClassType))
          .Assign(TcxComponentCollection(Source).Items[I]);
      end;
    finally
      EndUpdate;
    end;
...
function TcxComponentCollection.Add(AItemClass: TcxComponentCollectionItemClass)
  : TcxComponentCollectionItem;
begin
...
function TcxComponentCollection.FindItemByID(ID: Integer)
  : TcxComponentCollectionItem;
var
  I: Integer;
begin
...
function TcxComponentCollection.IndexOf
  (AItem: TcxComponentCollectionItem): Integer;
begin
  Result := FItems.IndexOf(AItem);
end;

function TcxComponentCollection.Insert(AIndex: Integer)
  : TcxComponentCollectionItem;
begin
  Result := Add;
  Result.Index := AIndex;
...
function TcxComponentCollection.AddItem(AItemClass
  : TcxComponentCollectionItemClass; AParentComponent, AOwner: TComponent)
  : TcxComponentCollectionItem;
begin
...
procedure TcxComponentCollection.Changed
  (AItem: TcxComponentCollectionItem = nil;
  AAction: TcxComponentCollectionNotification = ccnChanged);
begin
...
function TcxComponentCollection.GetItem(AIndex: Integer)
  : TcxComponentCollectionItem;
begin
...
procedure TcxComponentCollection.SetItem(AIndex: Integer;
  Value: TcxComponentCollectionItem);
begin
...
begin
  ...
  AItem.Name := CreateUniqueName(AOwnerParent, ParentComponent, AItem,
    GetItemPrefixName, GetItemSuffixName, ABaseIndex);
end;
...
function TcxInterfacedComponentCollection.QueryInterface(const IID: TGUID;
  out Obj): HResult;
begin
  if GetInterface(IID, Obj) then
    Result := S_OK
...
begin
  ...
  if csAncestor in ACaller.ComponentState then
    Exit;
  for I := 0 to AComponentCount - 1 do
  begin
    AComponent := AGetComponent(ACaller, I);
    if (AComponent.Owner = AOwner)
    { and not (csAncestor in AComponent.ComponentState) } then
    begin
...
begin
  ...
  begin
    Result := cxGenerateComponentName(AOwnerComponent, AComponent.ClassName,
  ...
  begin
    ...
    while I <= Length(AName) do
      if dxCharInSet(AName[I], ['A' .. 'Z', 'a' .. 'z', '_', '0' .. '9']) then
        Inc(I)
      else if dxCharInSet(AName[I], LeadBytes) then
        Delete(AName, I, 2)
      else
        Delete(AName, I, 1);
  end;
...
begin
  ...
  begin
    if (APrefixName <> '') and
      (CompareText(APrefixName, Copy(AClassName, 1, Length(APrefixName))) = 0)
    then
...
function cxSendStructMessageEx(AHandle: THandle; AMsg: UINT; const AStructure;
  AParam: LParam; AStructureIsLParam: Boolean): LRESULT; overload;
begin
...
function cxCreateTimer(AOnTimer: TNotifyEvent; AInterval: Integer;
  AEnabled: Boolean): TcxTimer;
begin
...
function dxSetTimer(AWindowHandle: THandle; ATimerID: TdxNativeUInt;
  AInterval: Cardinal; ATimerProcedure: TdxTimerProc): TdxNativeUInt;
begin
  Result := Windows.SetTimer(AWindowHandle, ATimerID, AInterval,
    @ATimerProcedure);
end;
...
begin
  ...
  FreeCustomData;
  if Supports(AForm, IcxDialogMetricsInfoData, IData) and
    (IData.GetInfoDataSize > 0) then
  begin
...
constructor TcxThread.Create(ACreateSuspended: Boolean;
  ACreatePaused: Boolean = False);
begin
...
procedure TcxComponentList.DoNotify(AItem: TComponent;
  AAction: TListNotification);

  function ConvertNotification(ANotification: TListNotification)
...
begin
  if (FStageTaskCount > 0) and (FStageCount > 0) then
    SetProgress(Trunc(100 * ((Stage - 1) + FStageTaskNumber / FStageTaskCount) /
      FStageCount));
end;
...
constructor TcxProgressCalculationHelper.Create(AStageCount: Integer;
  AEventSender: TObject; AProgressEvent: TcxProgressEvent);
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      FLocaleName := Format('%s-%s',
        [dxGetLocaleInfo(AID, LOCALE_SISO639LANGNAME), dxGetLocaleInfo(AID,
...
function TcxDialogsMetricsStore.CreateMetrics(AForm: TForm)
  : TcxDialogMetricsInfo;
begin
...
procedure TcxComponentHolder.Notification(AComponent: TComponent;
