...
uses
  ...
  dxLayoutControlAdapters, dxLayoutContainer, ExtCtrls, StdCtrls, cxRadioGroup,
  cxLabel, cxCheckBox, dxLayoutControl,
  cxGridWizardCustomPage, cxGridWizardStrs, cxGridTableView,
  cxGridCustomTableView, dxLayoutLookAndFeels, cxTextEdit,
  cxMaskEdit, cxDropDownEdit;

type
  { TcxGridWizardTableViewOptionsFilteringSortingPageFrame }

  TcxGridWizardTableViewOptionsFilteringSortingPageFrame = class
...
procedure TcxGridWizardTableViewOptionsFilteringSortingPageFrame.
  ApplyLocalization;
begin
  chbColumnFiltering.Caption := cxGetResourceString
    (@scxgwFilteringSortingPageColumnFiltering);
  chbColumnFiltering.Hint := cxGetResourceString
    (@scxgwFilteringSortingPageColumnFilteringHint);

  lbHeaderFilterButtonShowMode.Caption :=
    cxGetResourceString(@scxgwFilteringSortingPageHeaderFilterButtonShowMode);
  lbHeaderFilterButtonShowMode.Hint :=
    cxGetResourceString
    (@scxgwFilteringSortingPageHeaderFilterButtonShowModeHint);

  rbShowModeButton.Caption := cxGetResourceString
    (@scxgwFilteringSortingPageHeaderFilterButtonShowModeButton);
  rbShowModeButton.Hint := cxGetResourceString
    (@scxgwFilteringSortingPageHeaderFilterButtonShowModeButtonHint);

  rbShowModeSmartTag.Caption := cxGetResourceString
    (@scxgwFilteringSortingPageHeaderFilterButtonShowModeSmartTag);
  rbShowModeSmartTag.Hint := cxGetResourceString
    (@scxgwFilteringSortingPageHeaderFilterButtonShowModeSmartTagHint);

  lbShowColumnFilterButtons.Caption :=
    cxGetResourceString(@scxgwFilteringSortingPageShowColumnFilterButton);

  rbShowAlways.Caption := cxGetResourceString
    (@scxgwFilteringSortingPageShowColumnFilterButtonAlways);
  rbShowAlways.Hint := cxGetResourceString
    (@scxgwFilteringSortingPageShowColumnFilterButtonAlwaysHint);

  rbShowWhenSelected.Caption := cxGetResourceString
    (@scxgwFilteringSortingPageShowColumnFilterButtonWhenSelected);
  rbShowWhenSelected.Hint := cxGetResourceString
  ...
  chbColumnSorting.Caption := cxGetResourceString
    (@scxgwFilteringSortingPageColumnSorting);
  chbColumnSorting.Hint := cxGetResourceString
  ...
  lbFilterBox.Caption := cxGetResourceString
    (@scxgwFilteringSortingPageFilterBoxVisible);
  lbFilterBox.Hint := cxGetResourceString
    (@scxgwFilteringSortingPageFilterBoxVisibleHint);

  rbAlways.Caption := cxGetResourceString
    (@scxgwFilteringSortingPageFilterBoxVisibleAlways);
  rbAlways.Hint := cxGetResourceString
    (@scxgwFilteringSortingPageFilterBoxVisibleAlwaysHint);

  rbNonEmpty.Caption := cxGetResourceString
    (@scxgwFilteringSortingPageFilterBoxVisibleNonEmpty);
  rbNonEmpty.Hint := cxGetResourceString
...
begin
  ...
  rbShowModeButton.Checked := AView.OptionsView.HeaderFilterButtonShowMode =
    fbmButton;
...
function TcxGridWizardTableViewOptionsFilteringSortingPageFrame.
