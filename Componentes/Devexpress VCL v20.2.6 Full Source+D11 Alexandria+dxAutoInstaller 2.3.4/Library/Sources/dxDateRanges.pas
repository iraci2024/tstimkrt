...
type
  ...
  TdxInitDateRangesEvent = procedure(Sender: TObject;
    ADateRanges: TdxDateRanges) of object;

  TdxDateTimeFilter = (dtfRelativeDays, dtfRelativeDayPeriods, dtfRelativeWeeks,
    dtfRelativeMonths, dtfRelativeYears, dtfPastFuture, dtfMonths, dtfYears);
  TdxDateTimeFilters = set of TdxDateTimeFilter;
  TdxDateTimeGrouping = (dtgDefault, dtgByDateAndTime, dtgRelativeToToday,
  ...
  public
    ...
    function GetRangeValue(const ADate: TDateTime; AIgnoreTime: Boolean)
      : Variant; virtual;
  ...
  public
    ...
    function GetRange(ARangeClass: TdxCustomDateRangeClass)
      : TdxCustomDateRange; overload;
  ...
  protected
    ...
    property IFilteringDateTimeHandling: IdxFilteringDateTimeHandling
      read GetIFilteringDateTimeHandling;
  public
  ...
  protected
    ...
    property IGroupingDateTimeHandling: IdxGroupingDateTimeHandling
      read GetIGroupingDateTimeHandling;
  public
    procedure Init(ADateTimeHandling: TObject); override;
  end;

function dxContainDateTimeAbsoluteFilters(AFilters: TdxDateTimeFilters)
  : Boolean;
function dxContainDateTimeRelativeFilters(AFilters: TdxDateTimeFilters)
  : Boolean;
...
function TdxCustomDateRange.GetRangeValue(const ADate: TDateTime;
  AIgnoreTime: Boolean): Variant;
begin
...
begin
  if Container.IDateTimeHandling.GetHourFormat = '' then
    ...
    Result := FormatDateTime(Container.IDateTimeHandling.GetHourFormat,
      GetValue(ADate));
end;
...
function TdxMonthRange.GetRangeValue(const ADate: TDateTime;
  AIgnoreTime: Boolean): Variant;
begin
  Result := VarBetweenArrayCreate(dxGetStartDateOfMonth(ADate),
    dxGetEndDateOfMonth(ADate, AIgnoreTime));
end;
...
function TdxYearRange.GetRangeValue(const ADate: TDateTime;
  AIgnoreTime: Boolean): Variant;
begin
  Result := VarBetweenArrayCreate(dxGetStartDateOfYear(ADate),
    dxGetEndDateOfYear(ADate, AIgnoreTime));
end;
...
procedure TdxDateRanges.SetItemIndex(AItem: TdxCustomDateRange;
  AValue: Integer);
begin
...
begin
  ...
  begin
    Result := Items[I];
    if Result.Contains(ADate) then
      Exit;
  end;
  Result := nil;
end;

function TdxDateRanges.GetRange(ARangeClass: TdxCustomDateRangeClass)
  : TdxCustomDateRange;
var
  I: Integer;
begin
...
function TdxFilteringDateRanges.GetIFilteringDateTimeHandling
  : IdxFilteringDateTimeHandling;
begin
...
function TdxGroupingDateRanges.GetIGroupingDateTimeHandling
  : IdxGroupingDateTimeHandling;
begin
