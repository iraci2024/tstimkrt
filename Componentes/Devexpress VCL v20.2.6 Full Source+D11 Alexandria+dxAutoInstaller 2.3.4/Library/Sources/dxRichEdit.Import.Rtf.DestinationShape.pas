...
uses
  Types, Classes, SysUtils, Graphics, Variants, Generics.Defaults,
...
type
  ...
  TdxRtfShapeProperties = class
    (TdxNamedObjectDictionary<TdxRtfShapePropertyValue>)
  public
  ...
  strict private
    ...
    class procedure ShapeTextKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ShapeLeftKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ShapeRightKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ShapeTopKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ShapeBottomKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ShapeZOrderKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ShapeHorizontalPositionTypePageKeywordHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); inline; static;
    class procedure ShapeHorizontalPositionTypeMarginKeywordHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); inline; static;
    class procedure ShapeHorizontalPositionTypeColumnKeywordHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); inline; static;
    class procedure ShapeVerticalPositionTypePageKeywordHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); inline; static;
    class procedure ShapeVerticalPositionTypeMarginKeywordHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); inline; static;
    class procedure ShapeVerticalPositionTypeParagraphKeywordHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); inline; static;
    class procedure ShapeWrapTextTypeKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ShapeWrapTextTypeZOrderKeywordHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); inline; static;
    class procedure ShapeWrapTextSideKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ShapeLockedKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure ShapePropertyKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
  private
    procedure ConvertToFloatingObject;

    class function ConvertFloatingObjectTextWrapSide(AParameterValue: Integer)
      : TdxFloatingObjectTextWrapSide; static;
    class function ConvertFloatingObjectTextWrapType(AParameterValue: Integer)
    ...
    procedure ImportFloatingObjectHorizontalPositionAlignment
      (APropertyValue: Integer);
    procedure ImportFloatingObjectHorizontalPositionType(APropertyValue
      : Integer);
    procedure ImportFloatingObjectVerticalPositionAlignment(APropertyValue
      : Integer);
    procedure ImportFloatingObjectVerticalPositionType(APropertyValue: Integer);
    function ImportFloatingObjectRelaitveSizeHorizontalRelation
      (APropertyValue: Integer): TdxFloatingObjectRelativeFromHorizontal;
    function ImportFloatingObjectRelaitveSizeVerticalRelation
  ...
  protected
    ...
    class function GetThis(AImporter: TdxRtfImporter)
      : TdxShapeInstanceDestination; static;
  ...
  public
    ...
    constructor Create(AImporter: TdxRtfImporter;
      AFloatingObjectImportInfo: TdxRtfFloatingObjectImportInfo;
    ...
    property FloatingObjectImportInfo: TdxRtfFloatingObjectImportInfo
  ...
  strict private
    ...
    class function CreateKeywordHT: TdxKeywordTranslatorTable; static;
  strict private
    class procedure ShapeInstanceKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
  protected
    function CreateClone: TdxRichEditRtfDestinationBase; override;
    class function GetKeywordHT: TdxKeywordTranslatorTable; override;
  ...
  private
    class procedure PropertyNameKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
    class procedure PropertyValueKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); inline; static;
  protected
    function CreateClone: TdxRichEditRtfDestinationBase; override;
    class function GetKeywordHT: TdxKeywordTranslatorTable; override;
  ...
  public
    constructor Create(AImporter: TdxRtfImporter;
      AProperties: TdxRtfShapeProperties); reintroduce;
    procedure NestedGroupFinished(ADestination
      : TdxRichEditRtfDestinationBase); override;
  end;
  ...
  public
    constructor Create(AImporter: TdxRtfImporter;
      ATextBoxContentType: TdxTextBoxContentType); reintroduce; virtual;
  end;
...
function TdxRtfShapeProperties.GetStringPropertyValue
...
function TdxRtfShapeProperties.GetColorPropertyValue(const AName: string)
  : TdxAlphaColor;
var
  AColorValue: Integer;
begin
  AColorValue := GetIntegerPropertyValue(AName);
  Result := TdxAlphaColors.FromArgb(255, AColorValue and $000000FF,
    (AColorValue and $0000FF00) shr 8, (AColorValue and $00FF0000) shr 16);
end;
...
begin
  ...
  FFloatingObjectImportInfo := TdxRtfFloatingObjectImportInfo.Create
...
begin
  if (AParameterValue < Ord(Low(TdxFloatingObjectTextWrapSide))) and
    (AParameterValue > Ord(Low(TdxFloatingObjectTextWrapSide))) then
    Result := TdxFloatingObjectTextWrapSide.Both
  else
    Result := TdxFloatingObjectTextWrapSide(AParameterValue);
end;

class function TdxShapeInstanceDestination.ConvertFloatingObjectTextWrapType
  (AParameterValue: Integer): TdxFloatingObjectTextWrapType;
var
  AKey: TdxFloatingObjectTextWrapType;
begin
  for AKey := Low(TdxRtfExportSR.FloatingObjectTextWrapTypeTable)
    to High(TdxRtfExportSR.FloatingObjectTextWrapTypeTable) do
    if AParameterValue = TdxRtfExportSR.FloatingObjectTextWrapTypeTable[AKey]
    then
      Exit(AKey);
...
begin
  Result := TdxShapeInstanceDestination.Create(Importer,
    FFloatingObjectImportInfo, FProperties);
end;

class function TdxShapeInstanceDestination.GetKeywordHT
...
class function TdxShapeInstanceDestination.CreateKeywordHT
  : TdxKeywordTranslatorTable;
begin
...
function TdxShapeInstanceDestination.GetFloatingObject
...
procedure TdxShapeInstanceDestination.DoShapeLeftKeyword(AParameterValue
  : Integer);
begin
...
procedure TdxShapeInstanceDestination.DoShapeTopKeyword(AParameterValue
  : Integer);
begin
...
begin
  TdxDefaultDestination.ResetParagraphPropertiesKeywordHandler(Importer,
    0, False);
  if not FloatingObjectImportInfo.IsFloatingObject then
    Importer.InsertParagraph;
end;

procedure TdxShapeInstanceDestination.DoShapeRightKeyword(AParameterValue
  : Integer);
begin
...
procedure TdxShapeInstanceDestination.DoShapeBottomKeyword(AParameterValue
  : Integer);
begin
...
function TdxShapeInstanceDestination.HasBoolProperty
  (const AName: string): Boolean;
begin
  Result := FProperties.HasBoolProperty(AName);
end;

function TdxShapeInstanceDestination.HasIntegerProperty
  (const AName: string): Boolean;
begin
  Result := FProperties.HasIntegerProperty(AName);
end;

function TdxShapeInstanceDestination.HasStringProperty
  (const AName: string): Boolean;
begin
  Result := FProperties.HasStringProperty(AName);
end;

function TdxShapeInstanceDestination.HasColorProperty
  (const AName: string): Boolean;
begin
  Result := FProperties.HasColorProperty(AName);
end;

function TdxShapeInstanceDestination.GetIntegerPropertyValue
  (const AName: string): Integer;
begin
  Result := FProperties.GetIntegerPropertyValue(AName);
end;

function TdxShapeInstanceDestination.GetStringPropertyValue
  (const AName: string): string;
begin
  Result := FProperties.GetStringPropertyValue(AName);
end;

function TdxShapeInstanceDestination.GetBoolPropertyValue
  (const AName: string): Boolean;
begin
  Result := FProperties.GetBoolPropertyValue(AName);
end;

function TdxShapeInstanceDestination.GetColorPropertyValue(const AName: string)
  : TdxAlphaColor;
begin
  Result := FProperties.GetColorPropertyValue(AName);
end;

class function TdxShapeInstanceDestination.GetThis(AImporter: TdxRtfImporter)
  : TdxShapeInstanceDestination;
begin
  Result := TdxShapeInstanceDestination(AImporter.Destination);
end;

procedure TdxShapeInstanceDestination.
  ImportFloatingObjectHorizontalPositionAlignment(APropertyValue: Integer);
begin
  if (APropertyValue >= Ord(Low(TdxFloatingObjectHorizontalPositionAlignment)))
    and (APropertyValue <=
    Ord(High(TdxFloatingObjectHorizontalPositionAlignment))) then
    FloatingObject.HorizontalPositionAlignment :=
      TdxFloatingObjectHorizontalPositionAlignment(APropertyValue);
end;
...
begin
  for AKey := Low(TdxFloatingObjectHorizontalPositionType)
    to High(TdxFloatingObjectHorizontalPositionType) do
    if APropertyValue = TdxRtfExportSR.FloatingObjectHorizontalPositionTypeTable
      [AKey] then
    begin
...
function TdxShapeInstanceDestination.
  ImportFloatingObjectRelaitveSizeHorizontalRelation(APropertyValue: Integer)
...
function TdxShapeInstanceDestination.
  ImportFloatingObjectRelaitveSizeVerticalRelation(APropertyValue: Integer)
...
procedure TdxShapeInstanceDestination.
  ImportFloatingObjectVerticalPositionAlignment(APropertyValue: Integer);
begin
  if (APropertyValue >= Ord(Low(TdxFloatingObjectVerticalPositionAlignment)))
    and (APropertyValue <= Ord(High(TdxFloatingObjectVerticalPositionAlignment)))
  then
    FloatingObject.VerticalPositionAlignment :=
      TdxFloatingObjectVerticalPositionAlignment(APropertyValue);
end;
...
begin
  for AKey := Low(TdxFloatingObjectVerticalPositionType)
    to High(TdxFloatingObjectVerticalPositionType) do
    if APropertyValue = TdxRtfExportSR.FloatingObjectVerticalPositionTypeTable
      [AKey] then
    begin
...
class function TdxShapeInstanceDestination.ShouldSwapSize
  (ARtfAngle: Integer): Boolean;
begin
  ARtfAngle := ARtfAngle mod (360 * 65536);
  if ARtfAngle < 0 then
    Inc(ARtfAngle, 360 * 65536);
  Result := ((ARtfAngle >= 45 * 65536) and (ARtfAngle < 135 * 65536)) or
    ((ARtfAngle >= 225 * 65536) and (ARtfAngle < 315 * 65536));
end;
...
var
  APercentageWidth, APercentageHeight, ARawRotation, ALeft, ATop, AWidth,
    AHeight: Integer;
...
begin
  ...
  if HasIntegerProperty('shapeType') then
    FloatingObjectImportInfo.ShapeType :=
      TdxShapeType(GetIntegerPropertyValue('shapeType'));
  if HasIntegerProperty('posh') then
    ImportFloatingObjectHorizontalPositionAlignment
      (GetIntegerPropertyValue('posh'));
  if HasIntegerProperty('posrelh') then
    ImportFloatingObjectHorizontalPositionType
      (GetIntegerPropertyValue('posrelh'));
  if HasIntegerProperty('pctHorizPos') then
    FloatingObject.PercentOffsetX := GetIntegerPropertyValue
      ('pctHorizPos') * 100;
  if HasIntegerProperty('pctVertPos') then
    FloatingObject.PercentOffsetY := GetIntegerPropertyValue
      ('pctVertPos') * 100;
  if HasIntegerProperty('posv') then
    ImportFloatingObjectVerticalPositionAlignment
      (GetIntegerPropertyValue('posv'));
  if HasIntegerProperty('posrelv') then
    ImportFloatingObjectVerticalPositionType
      (GetIntegerPropertyValue('posrelv'));
  ...
  if HasIntegerProperty('dxWrapDistLeft') then
    FloatingObject.LeftDistance := Importer.UnitConverter.EmuToModelUnits
      (GetIntegerPropertyValue('dxWrapDistLeft'))
  else
    FloatingObject.LeftDistance := Importer.UnitConverter.EmuToModelUnits
      (DistanceFromText);
  if HasIntegerProperty('dxWrapDistRight') then
    FloatingObject.RightDistance := Importer.UnitConverter.EmuToModelUnits
      (GetIntegerPropertyValue('dxWrapDistRight'))
  else
    FloatingObject.RightDistance := Importer.UnitConverter.EmuToModelUnits
      (DistanceFromText);
  if HasIntegerProperty('dyWrapDistTop') then
    FloatingObject.TopDistance := Importer.UnitConverter.EmuToModelUnits
      (GetIntegerPropertyValue('dyWrapDistTop'));
  if HasIntegerProperty('dyWrapDistBottom') then
    FloatingObject.BottomDistance := Importer.UnitConverter.EmuToModelUnits
      (GetIntegerPropertyValue('dyWrapDistBottom'));
  ...
  ALeft := Importer.UnitConverter.TwipsToModelUnits
    (FloatingObjectImportInfo.Left);
  ATop := Importer.UnitConverter.TwipsToModelUnits
    (FloatingObjectImportInfo.Top);
  AWidth := Math.Max(1, Importer.UnitConverter.TwipsToModelUnits
    (FloatingObjectImportInfo.Right - FloatingObjectImportInfo.Left));
  AHeight := Math.Max(1, Importer.UnitConverter.TwipsToModelUnits
    (FloatingObjectImportInfo.Bottom - FloatingObjectImportInfo.Top));
  ...
  if HasIntegerProperty('dxTextLeft') then
    TextBoxProperties.LeftMargin := Importer.UnitConverter.EmuToModelUnits
      (GetIntegerPropertyValue('dxTextLeft'));
  if HasIntegerProperty('dxTextRight') then
    TextBoxProperties.RightMargin := Importer.UnitConverter.EmuToModelUnits
      (GetIntegerPropertyValue('dxTextRight'));
  if HasIntegerProperty('dyTextTop') then
    TextBoxProperties.TopMargin := Importer.UnitConverter.EmuToModelUnits
      (GetIntegerPropertyValue('dyTextTop'));
  if HasIntegerProperty('dyTextBottom') then
    TextBoxProperties.BottomMargin := Importer.UnitConverter.EmuToModelUnits
      (GetIntegerPropertyValue('dyTextBottom'));
  if HasBoolProperty('fFitShapeToText') then
    TextBoxProperties.ResizeShapeToFitText :=
      GetBoolPropertyValue('fFitShapeToText');
  ...
  begin
    ...
    begin
      ARelativeFromHorizontal :=
        ImportFloatingObjectRelaitveSizeHorizontalRelation
        (GetIntegerPropertyValue('sizerelh'));
      FloatingObject.RelativeWidth := TdxFloatingObjectRelativeWidth.Create
        (ARelativeFromHorizontal, APercentageWidth);
    end
    else
      FloatingObject.RelativeWidth := TdxFloatingObjectRelativeWidth.Create
        (TdxFloatingObjectRelativeFromHorizontal.Page, APercentageWidth);
  end;
  ...
  begin
    ...
    begin
      ARelativeFromVertical := ImportFloatingObjectRelaitveSizeVerticalRelation
        (GetIntegerPropertyValue('sizerelv'));
      FloatingObject.RelativeHeight := TdxFloatingObjectRelativeHeight.Create
        (ARelativeFromVertical, APercentageHeight);
    end
    else
      FloatingObject.RelativeHeight := TdxFloatingObjectRelativeHeight.Create
        (TdxFloatingObjectRelativeFromVertical.Page, APercentageHeight);
  end;

  if not HasBoolProperty('fLine') or GetBoolPropertyValue('fLine') then
  begin
    if HasIntegerProperty('lineWidth') then
      Shape.OutlineWidth := Importer.UnitConverter.EmuToModelUnits
        (GetIntegerPropertyValue('lineWidth'))
    else if FloatingObjectImportInfo.ShapeType <> TdxShapeType.PictureFrame then
  ...
  if (not HasBoolProperty('fFilled') or GetBoolPropertyValue('fFilled')) and
    HasColorProperty('fillColor') then
  ...
  if FProperties.ContainsKey('pib') and FProperties['pib'].HasObjectValue and
    (FProperties['pib'].ObjectValue is TdxRtfImageInfo) then
  begin
    AImageInfo := TdxRtfImageInfo(FProperties['pib'].ObjectValue);
    try
      FloatingObjectImportInfo.Image := AImageInfo.RtfImage;
      if not FloatingObjectImportInfo.InsertFloatingObject(Importer.Position)
      then
  ...
  else if (FloatingObjectImportInfo.ShapeType = TdxShapeType.TextBox) and
    (TextBoxContent <> nil) then
  begin
...
class procedure TdxShapeInstanceDestination.
  ShapeHorizontalPositionTypeColumnKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FloatingObject.HorizontalPositionType :=
    TdxFloatingObjectHorizontalPositionType.Column;
end;

class procedure TdxShapeInstanceDestination.
  ShapeHorizontalPositionTypeMarginKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FloatingObject.HorizontalPositionType :=
...
class procedure TdxShapeInstanceDestination.
  ShapeHorizontalPositionTypePageKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FloatingObject.HorizontalPositionType :=
...
class procedure TdxShapeInstanceDestination.ShapePropertyKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  AImporter.Destination := TdxShapePropertyDestination.Create(AImporter,
    GetThis(AImporter).FProperties);
end;
...
begin
  ...
  ADestination.FProperties.AddOrSetValue('shapeType',
    TdxRtfShapePropertyValue.Create(Ord(TdxShapeType.TextBox)));
  ADestination.ConvertToFloatingObject;
  AImporter.Destination := TdxShapeTextDestination.Create(AImporter,
    ADestination.TextBoxContent);
end;

class procedure TdxShapeInstanceDestination.
  ShapeVerticalPositionTypeMarginKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FloatingObject.VerticalPositionType :=
    TdxFloatingObjectVerticalPositionType.Margin;
end;

class procedure TdxShapeInstanceDestination.
  ShapeVerticalPositionTypePageKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FloatingObject.VerticalPositionType :=
...
class procedure TdxShapeInstanceDestination.
  ShapeVerticalPositionTypeParagraphKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
  GetThis(AImporter).FloatingObject.VerticalPositionType :=
...
begin
  if AHasParameter then
    GetThis(AImporter).FloatingObject.TextWrapSide :=
      ConvertFloatingObjectTextWrapSide(AParameterValue);
end;
...
class procedure TdxShapeInstanceDestination.
  ShapeWrapTextTypeZOrderKeywordHandler(AImporter: TdxRtfImporter;
  AParameterValue: Integer; AHasParameter: Boolean);
begin
  if AHasParameter then
  begin
    if GetThis(AImporter).FloatingObject.TextWrapType =
...
begin
  Result := TdxShapeDestination.Create(Importer, FloatingObjectImportInfo,
    ShapeProperties);
end;
...
begin
  ...
  AImporter.Destination := TdxShapeInstanceDestination.Create(AImporter,
    ADestination.FloatingObjectImportInfo, ADestination.ShapeProperties);
end;
...
begin
  ...
  begin
    if FPropertyName <> '' then
      FProperties.AddOrSetValue(FPropertyName,
        TdxRtfShapePropertyValue.Create(TdxShapePropertyPIBDestination
        (ADestination).ImageInfo));
  end;
  ...
  begin
    if FPropertyName <> '' then
      FProperties.AddOrSetValue(FPropertyName,
        TdxRtfShapePropertyValue.Create(TdxShapePropertyIntegerValueDestination
        (ADestination).Value));
  end;
  ...
  begin
    if FPropertyName <> '' then
      FProperties.AddOrSetValue(FPropertyName,
        TdxRtfShapePropertyValue.Create(TdxShapePropertyStringValueDestination
        (ADestination).Value));
  end;
end;
...
begin
  ...
  else if FIntegerPropertyNames.Contains(AName) then
    AImporter.Destination := TdxShapePropertyIntegerValueDestination.Create
      (AImporter)
  else
    AImporter.Destination := TdxShapePropertyStringValueDestination.Create
      (AImporter);
end;
...
class function TdxShapePropertyDestination.GetKeywordHT
  : TdxKeywordTranslatorTable;
begin
  Result := FKeywordHT;
end;

class function TdxShapePropertyDestination.CreateKeywordHT
  : TdxKeywordTranslatorTable;
begin
  Result := TdxKeywordTranslatorTable.Create;
  Result.Add('bin', BinKeywordHandler);
...
begin
  Result := TdxShapeTextDestination.Create(Importer,
    TdxTextBoxContentType(PieceTable.ContentType));
end;
...
class function TdxShapeTextDestination.CreateKeywordHT
  : TdxKeywordTranslatorTable;
begin
  Result := TdxKeywordTranslatorTable.Create;
...
function TdxShapePropertyPIBDestination.CreateClone
...
function TdxShapePropertyPIBDestination.ProcessKeywordCore(const AKeyword
...
function TdxShapePropertyIntegerValueDestination.CreateClone
  : TdxRichEditRtfDestinationBase;
begin
...
function TdxShapePropertyStringValueDestination.CreateClone
  : TdxRichEditRtfDestinationBase;
begin
...
function TdxShapePropertyNameDestination.CreateEmptyClone
