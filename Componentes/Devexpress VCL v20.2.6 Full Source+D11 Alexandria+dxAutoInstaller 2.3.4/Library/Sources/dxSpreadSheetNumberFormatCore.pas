...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Windows, Types, SysUtils, Graphics, Math, StrUtils, Variants,
  Generics.Collections, Generics.Defaults, dxCore,
  dxSpreadSheetCoreStrs, dxSpreadSheetUtils, dxSpreadSheetTypes,
...
type
  ...
  public
    ...
    class function Create(const AValue: Extended; ADecimals: Integer)
      : TdxNumberFormatFloatRec; static;
  ...
  public
    function Format(const AValue: Variant;
      AValueType: TdxSpreadSheetCellDataType;
      const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
      var AColor: TColor): string; overload;
    procedure Format(const AValue: Variant;
      AValueType: TdxSpreadSheetCellDataType;
      const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
      AResult: TdxNumberFormatResult); overload; virtual; abstract;
    function FormatEmpty(const AFormatSettings
      : TdxSpreadSheetCustomFormatSettings; var AColor: TColor)
      : string; overload;
    procedure FormatEmpty(const AFormatSettings
      : TdxSpreadSheetCustomFormatSettings; AResult: TdxNumberFormatResult);
      overload; virtual;
  ...
  public
    ...
    procedure Format(const AValue: Variant;
      AValueType: TdxSpreadSheetCellDataType;
      const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
      AResult: TdxNumberFormatResult); override;
  end;
  ...
  strict private
    FCount: Integer;
  protected
    procedure AdjustDateTime(var AValue: TDateTime;
      ADateSystem: TdxSpreadSheetDateTimeSystem); virtual;
  ...
  TdxNumberFormatElementTimeBase = class abstract
    (TdxNumberFormatElementDateBase)
  strict private
    FElapsed: Boolean;
  protected
    function ExtractTimeValue(const ADateTime: TDateTime): Int64;
      virtual; abstract;
  public
  ...
  protected
    procedure AdjustDateTime(var AValue: TDateTime;
      ADateSystem: TdxSpreadSheetDateTimeSystem); override;
  public
    function Designator: Integer; override;
    procedure Format(const AValue: Variant;
      AValueType: TdxSpreadSheetCellDataType;
  ...
  public const
    ...
    SystemLongTime = $F400;
  protected
    procedure FormatDateTime(const AValue: Variant;
      AValueType: TdxSpreadSheetCellDataType;
      const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
      AResult: TdxNumberFormatResult); virtual;
  ...
  TdxDateTimeSystemDateTimeNumberFormat = class abstract
    (TdxDateTimeNumberFormatBase)
  strict private
  ...
  protected
    procedure FormatDateTime(const AValue: Variant;
      ...
      const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
      AResult: TdxNumberFormatResult); override;
    function GetFormatString(const AData: TFormatSettings): string;
      virtual; abstract;
    //
    property FormatTemplate: string read FFormatTemplate
  ...
  TdxDateTimeSystemLongDateNumberFormat = class
    (TdxDateTimeSystemDateTimeNumberFormat)
  protected
  ...
  TdxDateTimeSystemLongTimeNumberFormat = class
    (TdxDateTimeSystemDateTimeNumberFormat)
  protected
    function GetFormatString(const AData: TFormatSettings): string; override;
  end;
  ...
  TdxDateTimeSystemShortDateNumberFormat = class
    (TdxDateTimeSystemDateTimeNumberFormat)
  protected
    function GetFormatString(const AData: TFormatSettings): string; override;
  end;
  ...
  strict private
    ...
    function CalculateActualPart(const AValue: Variant;
      AValueType: TdxSpreadSheetCellDataType): TdxNumberFormat;
  protected
    function GetValueType: TdxNumberFormatType; override;
    //
  ...
  protected
    ...
    procedure InsertSign(ABuffer: TStringBuilder; AIsNegative: Boolean;
      AIndex: Integer = 0);
    procedure FormatDecimalPart(ABuffer: TdxNumberFormatResult;
      const AValue: TdxNumberFormatFloatRec;
      AStartIndex, AEndIndex, ADigits: Integer;
      const AFormatSettings: TdxSpreadSheetCustomFormatSettings);
    procedure FormatIntegerPart(ABuffer: TdxNumberFormatResult;
      const AValue: TdxNumberFormatFloatRec;
      AStartIndex, AEndIndex, ADigitCount: Integer;
      const AFormatSettings: TdxSpreadSheetCustomFormatSettings); overload;
    function FormatIntegerPart(const AValue: TdxNumberFormatFloatRec;
      AStartIndex, AEndIndex, ADigitCount: Integer;
      const AFormatSettings: TdxSpreadSheetCustomFormatSettings)
      : string; overload;
    procedure FormatSimple(const AValue: TdxNumberFormatFloatRec;
      AEndIndex: Integer;
      const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
      AResult: TdxNumberFormatResult);
  ...
  public
    constructor Create(AElements: TdxNumberFormatElementList;
      APercentCount, AIntegerCount, ADecimalCount, ADisplayFactor,
      ADecimalSeparatorIndex: Integer; AGrouping, AIsNegativePart: Boolean);
    procedure Format(const AValue: Variant;
      AValueType: TdxSpreadSheetCellDataType;
      const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
      AResult: TdxNumberFormatResult); override;
  ...
  public
    constructor Create(AElements: TdxNumberFormatElementList;
      AIntegerCount, ADecimalCount, ADecimalSeparatorIndex, AExpIndex,
      AExpCount: Integer; AExplicitSign, AGrouping, AIsNegativePart: Boolean);
    procedure Format(const AValue: Variant;
      AValueType: TdxSpreadSheetCellDataType;
      const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
      AResult: TdxNumberFormatResult); override;
  ...
  protected
    ...
    function CalculateRationalApproximation(AValue: Double)
      : TPair<Double, Integer>; virtual;
  ...
  public
    constructor Create(AElements: TdxNumberFormatElementList;
      APercentCount, AIntegerCount, APreFractionIndex, AFractionSeparatorIndex
      : Integer; ADivisorIndex, ADividendCount, ADivisorCount: Integer;
...
class function TdxNumberFormatFloatRec.Create(const AValue: Extended;
  ADecimals: Integer): TdxNumberFormatFloatRec;
begin
...
function TdxNumberFormatFloatRec.SetDigit(AIndex: Integer;
  AValue: Byte): Boolean;
begin
...
procedure TdxNumberFormatFloatRec.Initialize(const AValue: Extended;
  ADecimals: Integer);
begin
...
procedure TdxNumberFormat.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
var
...
begin
  case AValueType of
    ...
    cdtError:
      AResult.Append(dxSpreadSheetErrorCodeToString
        (TdxSpreadSheetFormulaErrorCode(AValue)));
    ...
    raise EdxSpreadSheetNumberFormatError.CreateFmt
      (cxGetResourceString(@sdxErrorInternal), ['cannot format variant']);
  end;
end;

{ TdxNumberFormatElement }

function TdxNumberFormatElement.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  var AColor: TColor): string;
var
  AResult: TdxNumberFormatResult;
begin
...
function TdxNumberFormatElement.FormatEmpty(const AFormatSettings
  : TdxSpreadSheetCustomFormatSettings; var AColor: TColor): string;
var
  AResult: TdxNumberFormatResult;
begin
  AResult := TdxNumberFormatResult.Create(4);
...
procedure TdxNumberFormatElement.FormatEmpty(const AFormatSettings
  : TdxSpreadSheetCustomFormatSettings; AResult: TdxNumberFormatResult);
begin
...
procedure TdxNumberFormatElementList.ExtractFrom
  (Source: TdxNumberFormatElementList);
begin
  AddRange(Source);
...
begin
  ...
  begin
    if (AItem.Designator = TdxNumberFormatDesignator.Day) or
      ...
      (AItem.Designator = TdxNumberFormatDesignator.ThaiYear) then
      Exit(False);
  end;
  Result := True;
end;
...
procedure TdxSimpleNumberFormatList.ExtractFrom
  (Source: TdxSimpleNumberFormatList);
begin
  AddRange(Source);
  if Source.OwnsObjects then
  begin
...
procedure TdxNumberFormatElementGeneral.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
  TdxGeneralNumberFormat.Default.Format(AValue, AValueType,
    AFormatSettings, AResult);
end;
...
procedure TdxNumberFormatElementColor.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
...
procedure TdxNumberFormatElementDigitZero.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
...
procedure TdxNumberFormatElementDigitZero.FormatEmpty(const AFormatSettings
  : TdxSpreadSheetCustomFormatSettings; AResult: TdxNumberFormatResult);
begin
  AResult.Append('0');
end;
...
procedure TdxNumberFormatElementDigitEmpty.FormatEmpty(const AFormatSettings
  : TdxSpreadSheetCustomFormatSettings; AResult: TdxNumberFormatResult);
begin
  // do nothing
end;
...
procedure TdxNumberFormatElementDigitSpace.FormatEmpty(const AFormatSettings
  : TdxSpreadSheetCustomFormatSettings; AResult: TdxNumberFormatResult);
begin
  AResult.Append(' ');
end;
...
procedure TdxNumberFormatElementTextContent.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
...
procedure TdxNumberFormatElementTextBase.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
...
constructor TdxNumberFormatElementDisplayLocale.Create(ALocaleId: Integer;
...
procedure TdxNumberFormatElementDisplayLocale.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
...
procedure TdxNumberFormatElementDateBase.AdjustDateTime(var AValue: TDateTime;
  ADateSystem: TdxSpreadSheetDateTimeSystem);
begin
  AValue := dxDateTimeToRealDateTime(AValue, ADateSystem);
end;

procedure TdxNumberFormatElementDateBase.FormatDateTime(const AMacro: string;
  AValue: TDateTime; const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
  try
    ...
    begin
      ...
      AResult.Append(SysUtils.FormatDateTime(DupeString(AMacro, Count), AValue,
        AFormatSettings.Data));
  except
    AResult.IsError := True;
  end;
end;
...
constructor TdxNumberFormatElementTimeBase.Create(ACount: Integer;
  AElapsed: Boolean);
begin
...
procedure TdxNumberFormatElementTimeBase.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
...
constructor TdxNumberFormatElementAmPm.CreateEx(AIsAMLower,
  AIsPMLower: Boolean);
begin
  inherited Create(1);
...
procedure TdxNumberFormatElementAmPm.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
...
constructor TdxNumberFormatElementHours.Create(ACount: Integer;
  AElapsed, AIs12HourTime: Boolean);
begin
...
function TdxNumberFormatElementHours.ExtractTimeValue(const ADateTime
  : TDateTime): Int64;
var
  H, X: Word;
begin
...
function TdxNumberFormatElementMinutes.ExtractTimeValue(const ADateTime
  : TDateTime): Int64;
var
  M, X: Word;
begin
...
function TdxNumberFormatElementSeconds.ExtractTimeValue(const ADateTime
  : TDateTime): Int64;
var
  AResult: Extended;
  S, X: Word;
...
function TdxNumberFormatElementMilliseconds.ExtractTimeValue(const ADateTime
  : TDateTime): Int64;
var
  M, X: Word;
begin
...
procedure TdxNumberFormatElementMilliseconds.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
...
constructor TdxNumberFormatElementExprCondition.Create
  (const AExpression: string);
begin
  FExpression := AExpression;
end;

procedure TdxNumberFormatElementExprCondition.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
...
procedure TdxNumberFormatElementDecimalSeparator.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
...
procedure TdxNumberFormatElementDateSeparator.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
...
procedure TdxNumberFormatElementTimeSeparator.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
...
procedure TdxNumberFormatElementDay.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
var
...
procedure TdxNumberFormatElementDayOfWeek.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
...
procedure TdxNumberFormatElementMonth.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
var
...
procedure TdxNumberFormatElementMonth.AdjustDateTime(var AValue: TDateTime;
  ADateSystem: TdxSpreadSheetDateTimeSystem);
begin
...
procedure TdxNumberFormatElementYear.AdjustDateTime(var AValue: TDateTime;
  ADateSystem: TdxSpreadSheetDateTimeSystem);
begin
  inherited AdjustDateTime(AValue, ADateSystem);
...
procedure TdxNumberFormatElementYear.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
...
procedure TdxNumberFormatElementThaiYear.AdjustDateTime(var AValue: TDateTime;
  ADateSystem: TdxSpreadSheetDateTimeSystem);
var
  Y, M, D, H, S, N, MS: Word;
begin
...
procedure TdxNumberFormatElementJapaneseEra.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
...
procedure TdxNumberFormatElementPercent.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
...
procedure TdxDateTimeNumberFormatBase.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
begin
  if not dxIsNumericType(AValueType) then
    inherited Format(AValue, AValueType, AFormatSettings, AResult)
  else if (AValue < 0) and (AFormatSettings.DateTimeSystem = dts1904) then
  begin
    AResult.Append('-');
    Format(Abs(AValue), AValueType, AFormatSettings, AResult);
  end
  else if (AValue < 0) or (AValue >= MaxDateTime) then
  begin
    AResult.IsError := True;
    AResult.Append('#');
  end
  ...
  begin
    if HasMilliseconds then
      ...
      FormatDateTime(AValue + EncodeTime(0, 0, 0, 499), AValueType,
        AFormatSettings, AResult);
...
procedure TdxDateTimeNumberFormatBase.FormatDateTime(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
var
...
procedure TdxDateTimeSystemDateTimeNumberFormat.SetFormatTemplate
  (const Value: string);
begin
  ...
  begin
    ...
    FFormatter := TdxNumberFormatParser.Parse
      (TdxSpreadSheetDisplayFormatConverter.ConvertDateTimeDisplayFormat
      (FormatTemplate, 0), -1);
  end;
end;
...
function TdxDateTimeSystemLongDateNumberFormat.GetFormatString
  (const AData: TFormatSettings): string;
begin
...
function TdxDateTimeSystemLongTimeNumberFormat.GetFormatString
  (const AData: TFormatSettings): string;
begin
...
function TdxDateTimeSystemShortDateNumberFormat.GetFormatString
  (const AData: TFormatSettings): string;
begin
...
constructor TdxDateTimeNumberFormat.Create
  (AElements: TdxNumberFormatElementList;
  ALocale: TdxNumberFormatElementDisplayLocale; AHasMilliseconds: Boolean);
begin
...
procedure TdxDateTimeNumberFormat.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
var
...
begin
  ...
  begin
    ...
    try
      ...
      dxGetLocaleFormatSettings(FLocale.LocaleId and $FFFF,
        ALocalizedFormatSettings.Data);
...
procedure TdxGeneralNumberFormat.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
var
...
procedure TdxTextNumberFormat.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
var
  I: Integer;
begin
  if AValueType in [cdtCurrency, cdtFloat, cdtDateTime, cdtInteger, cdtError]
  then
  begin
    TdxGeneralNumberFormat.Default.Format(AValue, AValueType,
      AFormatSettings, AResult);
...
constructor TdxConditionalNumberFormat.Create
  (AFormats: TdxSimpleNumberFormatList);
begin
  inherited Create;
...
procedure TdxConditionalNumberFormat.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
var
...
function TdxConditionalNumberFormat.CalculateActualPart(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType): TdxNumberFormat;
begin
  Result := nil;
...
constructor TdxSimpleNumericNumberFormat.Create
  (AElements: TdxNumberFormatElementList; APercentCount, AIntegerCount,
  ADecimalCount, ADisplayFactor, ADecimalSeparatorIndex: Integer;
  AGrouping, AIsNegativePart: Boolean);
begin
  inherited Create(AElements);
...
procedure TdxSimpleNumericNumberFormat.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
var
...
begin
  ...
  begin
    ...
    begin
      ...
      FormatSimple(TdxNumberFormatFloatRec.Create(AExtendedValue,
        FDecimalCount), FList.Count - 1, AFormatSettings, AResult);
    end;
    AResult.IsText := bFalse;
  end
  else
...
procedure TdxSimpleNumericNumberFormat.FormatSimple(const AValue
  : TdxNumberFormatFloatRec; AEndIndex: Integer;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
var
  AStartIndex: Integer;
begin
  ...
  if FDecimalSeparatorIndex < 0 then
    FormatIntegerPart(AResult, AValue, AEndIndex, 0, FIntegerCount,
      AFormatSettings)
  else
  begin
    FormatIntegerPart(AResult, AValue, FDecimalSeparatorIndex - 1, 0,
      FIntegerCount, AFormatSettings);
    AResult.Append(AFormatSettings.Data.DecimalSeparator);
    FormatDecimalPart(AResult, AValue, FDecimalSeparatorIndex + 1, AEndIndex,
      FDecimalCount, AFormatSettings);
  end;
  InsertSign(AResult, AValue.Data.Negative, AStartIndex);
end;

procedure TdxSimpleNumericNumberFormat.InsertSign(ABuffer: TStringBuilder;
  AIsNegative: Boolean; AIndex: Integer = 0);
begin
  if AIsNegative and not FIsNegativePart then
    ABuffer.Insert(AIndex, '-');
end;

procedure TdxSimpleNumericNumberFormat.FormatDecimalPart
  (ABuffer: TdxNumberFormatResult; const AValue: TdxNumberFormatFloatRec;
  AStartIndex, AEndIndex, ADigits: Integer;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings);
var
...
begin
  ...
  begin
    ...
    begin
      AElement.Format(AValue.GetDigit(AIndex), cdtInteger,
        AFormatSettings, ABuffer);
      Inc(AIndex);
    end
    else
...
procedure TdxSimpleNumericNumberFormat.FormatIntegerPart
  (ABuffer: TdxNumberFormatResult; const AValue: TdxNumberFormatFloatRec;
  AStartIndex, AEndIndex, ADigitCount: Integer;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings);
var
...
begin
    ...
    begin
      ...
      begin
        if FGrouping and (ANumIndex mod 3 = 0) and (ANumIndex > 0) then
          ABuffer.Insert(AInsertPosition,
            AFormatSettings.Data.ThousandSeparator);
        ABuffer.Insert(AInsertPosition, AElement.Format(AValue.GetDigit(AIndex),
          cdtInteger, AFormatSettings, ABuffer.Color));
        Dec(ADigitsCountInQueue);
        Dec(AIndex);
        Inc(ANumIndex);
      end
      else
        ABuffer.Insert(AInsertPosition, AElement.FormatEmpty(AFormatSettings,
          ABuffer.Color));
  ...
  while I >= AEndIndex do
  begin
    ABuffer.Insert(AInsertPosition, FList[I].FormatEmpty(AFormatSettings,
      ABuffer.Color));
    Dec(I);
  end;
end;
...
begin
  ...
  try
    FormatIntegerPart(ABuffer, AValue, AStartIndex, AEndIndex, ADigitCount,
      AFormatSettings);
...
constructor TdxNumericNumberFormatExponent.Create
  (AElements: TdxNumberFormatElementList; AIntegerCount, ADecimalCount,
  ADecimalSeparatorIndex, AExpIndex, AExpCount: Integer;
  AExplicitSign, AGrouping, AIsNegativePart: Boolean);
begin
  inherited Create(AElements, 0, AIntegerCount, ADecimalCount, 0,
    ADecimalSeparatorIndex, AGrouping, AIsNegativePart);
  FExpCount := AExpCount;
  FExpIndex := AExpIndex;
  FExplicitSign := AExplicitSign;
end;

procedure TdxNumericNumberFormatExponent.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
var
...
begin
  ...
  AResult.Append(FormatIntegerPart(TdxNumberFormatFloatRec.Create
    (Abs(AExponent), 0), FList.Count - 1, FExpIndex + 1, FIntegerCount,
    AFormatSettings));
...
function TdxNumericNumberFormatExponent.CalculateExponent
  (const AValue: TdxNumberFormatFloatRec): Integer;
...
constructor TdxNumericFractionNumberFormat.Create
  (AElements: TdxNumberFormatElementList; APercentCount, AIntegerCount,
  APreFractionIndex, AFractionSeparatorIndex, ADivisorIndex, ADividendCount,
  ADivisorCount: Integer; AGrouping, AIsNegativePart: Boolean);
begin
  inherited Create(AElements, APercentCount, AIntegerCount,
    AFractionSeparatorIndex, 0, APreFractionIndex, FGrouping, AIsNegativePart);
  FDividendCount := ADividendCount;
  FDivisorCount := ADivisorCount;
  FDivisorIndex := ADivisorIndex;
end;

function TdxNumericFractionNumberFormat.CalculateRationalApproximation
  (AValue: Double): TPair<Double, Integer>;
var
  AAbsDelta: Double;
...
begin
  ...
  Result := TPair<Double, Integer>.Create(ABestDividend + AIntegerPart *
    ABestDivisor, ABestDivisor);
end;

procedure TdxNumericFractionNumberFormat.Format(const AValue: Variant;
  AValueType: TdxSpreadSheetCellDataType;
  const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
var
...
begin
  ...
  begin
    ...
    begin
      ...
      FormatZeroIntegerPart(FDecimalSeparatorIndex, AIndex,
        AFormatSettings, AResult);
      ...
      AResult.Append(FormatIntegerPart(TdxNumberFormatFloatRec.Create
        (AIntegerPart, 0), FDecimalSeparatorIndex, AIndex, FIntegerCount,
        AFormatSettings));
  end
  else
  ...
  begin
    ATextIndex := AResult.Length;
    FormatZeroIntegerPart(FDecimalCount - 1, FDecimalSeparatorIndex + 1,
      AFormatSettings, AResult);
    AResult.Append('/');
  ...
  begin
    AResult.Append(FormatIntegerPart(TdxNumberFormatFloatRec.Create(ADividend,
      0), FDecimalCount - 1, FDecimalSeparatorIndex + 1, FDividendCount,
      AFormatSettings));
    AResult.Append('/');
    FormatDivisor(ADivisor, FDivisorIndex, AFormatSettings, AResult);
  end;
...
procedure TdxNumericFractionNumberFormat.FormatDivisor(ADivisor,
  AEndIndex: Integer; const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
var
...
begin
  ...
  begin
    ...
    begin
      ...
      AElement.Format((ADivisor - ADivisorTemp) / APower, cdtFloat,
        AFormatSettings, AResult);
...
procedure TdxNumericFractionNumberFormat.FormatZeroIntegerPart(AStartIndex,
  AEndIndex: Integer; const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
var
  AElement: TdxNumberFormatElement;
...
begin
  ...
  begin
    ...
    AResult.Insert(AInsertIndex, AElement.FormatEmpty(AFormatSettings,
      AResult.Color));
    Dec(AIndex);
  end;
  while AIndex >= AEndIndex do
  begin
    AResult.Insert(AInsertIndex, FList[AIndex].FormatEmpty(AFormatSettings,
      AResult.Color));
    Dec(AIndex);
  end;
end;
...
function TdxExplicitNumericFractionNumberFormat.CalculateRationalApproximation
  (AValue: Double): TPair<Double, Integer>;
var
...
begin
  ...
  Result := TPair<Double, Integer>.Create(ADividend + AIntegerPart *
    ExplicitDivisor, ExplicitDivisor);
end;

procedure TdxExplicitNumericFractionNumberFormat.FormatDivisor(ADivisor,
  AEndIndex: Integer; const AFormatSettings: TdxSpreadSheetCustomFormatSettings;
  AResult: TdxNumberFormatResult);
var
  I: Integer;
