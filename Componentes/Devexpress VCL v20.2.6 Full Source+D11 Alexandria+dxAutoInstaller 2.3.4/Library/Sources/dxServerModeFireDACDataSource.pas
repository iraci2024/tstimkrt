...
type
  ...
  TdxServerModeFireDACSQLQueryBuilder = class
  ...
  protected
    ...
    procedure DoExecuteCommand(AResultSet: PDataSet; const ACommand: string;
      AParams: TParams; AParamCheck: Boolean); override;
  ...
  TdxServerModeFireDACDataSourceHelper = class
    (TdxServerModeFireDACDataSourceCustomHelper)
  private
  ...
  TdxServerModeFireDACQueryDataSourceHelper = class
    (TdxServerModeFireDACDataSourceCustomHelper)
  protected
    function GetOptionsClass: TdxServerModeDataSourceOptionsClass; override;
  end;
  ...
  private
    ...
    {$IFDEF DELPHI19}TFDConnection{$ELSE}TADConnection{$ENDIF};
    function GetOptions: TdxServerModeFireDACDataSourceOptions;
    function GetHelper: TdxServerModeFireDACDataSourceHelper;
    procedure SetConnection(Value:
      {$IFDEF DELPHI19}TFDConnection{$ELSE}TADConnection{$ENDIF});
  ...
  published
    property Connection:
    {$IFDEF DELPHI19}TFDConnection{$ELSE}TADConnection{$ENDIF} read GetConnection write SetConnection;
    property Options: TdxServerModeFireDACDataSourceOptions read GetOptions
      write SetOptions;
  end;
  ...
  private
    ...
    procedure SetConnection(Value:
      {$IFDEF DELPHI19}TFDConnection{$ELSE}TADConnection{$ENDIF});
    procedure SetOptions(const Value
      : TdxServerModeFireDACQueryDataSourceOptions);
  protected
    function GetHelperClass: TdxServerModeDataSourceCustomHelperClass; override;
  published
    property Connection:
    {$IFDEF DELPHI19}TFDConnection{$ELSE}TADConnection{$ENDIF} read GetConnection write SetConnection;
    property Options: TdxServerModeFireDACQueryDataSourceOptions read GetOptions
      write SetOptions;
  end;
...
begin
  Connection.GetKeyFieldNames(Options.CatalogName, Options.SchemaName,
    TableName, '', AList);
end;

procedure TdxServerModeFireDACDataSource.DoPopulateTableNames(AList: TStrings);
begin
  Connection.GetTableNames(Options.CatalogName, Options.SchemaName, '', AList,
    [osMy], [tkTable, tkView]);
end;
...
function TdxServerModeFireDACDataSource.GetHelperClass
...
function TdxServerModeFireDACDataSource.GetOptions
  : TdxServerModeFireDACDataSourceOptions;
begin
  Result := inherited Options as TdxServerModeFireDACDataSourceOptions;
end;

function TdxServerModeFireDACDataSource.GetHelper
  : TdxServerModeFireDACDataSourceHelper;
begin
  Result := TdxServerModeFireDACDataSourceHelper(inherited Helper);
end;

function TdxServerModeFireDACDataSource.GetConnection:
{$IFDEF DELPHI19}TFDConnection{$ELSE}TADConnection{$ENDIF};
begin
{$IFDEF DELPHI19}
...
procedure TdxServerModeFireDACDataSource.SetConnection(Value:
  {$IFDEF DELPHI19}TFDConnection{$ELSE}TADConnection{$ENDIF});
begin
  inherited Connection := Value;
end;

procedure TdxServerModeFireDACDataSource.SetOptions
  (const Value: TdxServerModeFireDACDataSourceOptions);
begin
...
begin
  Connection.DecodeObjectName(TableName, ACatalogName, ASchemaName,
    ABaseObjectName, AObjectName);
  if ACatalogName = '' then
    ACatalogName := Options.CatalogName;
  if ASchemaName = '' then
    ASchemaName := Options.SchemaName;
  FFullTableName := Connection.EncodeObjectName(ACatalogName, ASchemaName,
    ABaseObjectName, AObjectName);
end;
...
procedure TdxServerModeFireDACDataSourceOptions.SetCatalogName
  (const Value: string);
begin
...
procedure TdxServerModeFireDACDataSourceOptions.SetSchemaName
  (const Value: string);
begin
...
function TdxServerModeFireDACDataSourceCustomHelper.GetDataSetClass
  : TdxDataSetClass;
begin
{$IFDEF DELPHI19}
...
function TdxServerModeFireDACDataSourceCustomHelper.GetQueryBuilderClass
...
procedure TdxServerModeFireDACDataSourceCustomHelper.CheckParamValue
...
procedure TdxServerModeFireDACDataSourceCustomHelper.DoInitializeDataSet
  (ADataSet: TDataSet);
begin
{$IFDEF DELPHI19}
...
procedure TdxServerModeFireDACDataSourceCustomHelper.
  DoSynchronizeDataSetConnection(ADataSet: TDataSet);
begin
{$IFDEF DELPHI19}
...
procedure TdxServerModeFireDACDataSourceHelper.PopulateCatalogNames
  (AList: TStrings);
begin
...
procedure TdxServerModeFireDACDataSourceHelper.PopulateSchemaNames
  (AList: TStrings);
begin
  if not IsConnected then
    Exit;
...
function TdxServerModeFireDACDataSourceHelper.GetOptionsClass
  : TdxServerModeDataSourceOptionsClass;
begin
  Result := TdxServerModeFireDACDataSourceOptions;
end;

function TdxServerModeFireDACDataSourceHelper.GetOptions
  : TdxServerModeFireDACDataSourceOptions;
begin
...
function TdxServerModeFireDACQueryDataSourceHelper.GetOptionsClass
  : TdxServerModeDataSourceOptionsClass;
begin
...
function TdxServerModeFireDACQueryDataSource.GetHelperClass
  : TdxServerModeDataSourceCustomHelperClass;
begin
  Result := TdxServerModeFireDACQueryDataSourceHelper;
end;

function TdxServerModeFireDACQueryDataSource.GetOptions
  : TdxServerModeFireDACQueryDataSourceOptions;
begin
  Result := TdxServerModeFireDACQueryDataSourceOptions(inherited Options);
end;

function TdxServerModeFireDACQueryDataSource.GetConnection:
{$IFDEF DELPHI19}TFDConnection{$ELSE}TADConnection{$ENDIF};
begin
{$IFDEF DELPHI19}
  Result := TFDConnection(inherited Connection);
...
procedure TdxServerModeFireDACQueryDataSource.SetConnection(Value:
  {$IFDEF DELPHI19}TFDConnection{$ELSE}TADConnection{$ENDIF});
begin
  inherited Connection := Value;
end;

procedure TdxServerModeFireDACQueryDataSource.SetOptions
  (const Value: TdxServerModeFireDACQueryDataSourceOptions);
begin
  inherited Options := Value;
end;
