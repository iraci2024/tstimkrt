...
dxPSRegisterReportLink(TdxDBListBoxReportLink, TDBListBox,
  TdxLBxReportLinkDesignWindow);
dxPSRegisterReportLink(TdxDBRichEditReportLink, TDBRichEdit, nil);
dxPSRegisterReportLink(TdxDBMemoReportLink, TDBMemo,
  TdxfmTextReportLinkDesignWindow);

finalization

dxPSUnregisterReportLink(TdxDBMemoReportLink, TDBMemo,
  TdxfmTextReportLinkDesignWindow);
dxPSUnregisterReportLink(TdxDBRichEditReportLink, TDBRichEdit, nil);
dxPSUnregisterReportLink(TdxDBListBoxReportLink, TDBListBox,
  TdxLBxReportLinkDesignWindow);
