...
{$IFDEF DELPHIXE2}
  System.UITypes,
{$ENDIF}
  Types, Classes, SysUtils, Contnrs, Graphics, Generics.Defaults,
...
type
  ...
  TdxCharacterFormatterState = (Start, Spaces, Tab, FirstDash, Dash, Separator,
    LineBreak, PageBreak, ColumnBreak, Text, InlineObject, LayoutDependentText,
    FloatingObject, Final);

  TdxParagraphBoxFormatterState = (ParagraphStart, ParagraphStartAfterBreak,
    ParagraphStartFromTheMiddle, ParagraphStartAfterFloatingObject,
    ParagraphStartFromTheMiddleAfterFloatingObject, RowEmpty,
    RowEmptyAfterFloatingObject, RowWithSpacesOnly, RowWithTextOnly,
    RowWithInlineObjectOnly, RowWithTextOnlyAfterFloatingObject,
    RowWithDashOnly, RowWithDashOnlyAfterFloatingObject,
    RowWithTextOnlyAfterFirstLeadingTab,
    RowWithTextOnlyAfterFirstLeadingTabAfterFloatingObject, RowSpaces, RowText,
    RowTextAfterFloatingObject, RowDashAfterText, RowDash,
    RowDashAfterFloatingObject, RowWithDashAfterTextOnly, RowTextSplit,
    RowTextSplitAfterFloatingObject, RowTextSplitFloatingObject,
    RowTextSplitAfterFirstLeadingTab,
    RowTextSplitAfterFirstLeadingTabAfterFloatingObject,

    RowDashSplit, RowDashSplitAfterFloatingObject,

    RowEmptyHyphenation, RowEmptyHyphenationAfterFloatingObject,
    ...
    RowTextHyphenation, RowTextHyphenationAfterFloatingObject,
    RowFirstLeadingTab, RowLeadingTab, RowLeadingTabAfterFloatingObject, RowTab,
    RowTabAfterFloatingObject, RowLineBreak, RowPageBreak,
    RowPageBreakAtParagraphStart, RowColumnBreak,
    RowColumnBreakAtParagraphStart,

    SectionBreakAfterParagraphMark, FloatingObject, ParagraphFrame,
  ...
  TdxFormattingProcess = (ContinueFromParagraph, Continue,
    RestartFromTheStartOfRow, Finish);

  TdxAddBoxResult = (Success, HorizontalIntersect, LeaveColumnPlain,
    LeaveColumnFirstCellRow, IntersectWithFloatObject,
    RestartDueFloatingObject);

  TdxSplitBoxResult = (Success, SuccessSuppressedHorizontalOverfull,
    FailedHorizontalOverfull);

  TdxAdjustEndPositionResult = (Success, Failure);

  TdxStateContinueFormatResult = (Success, RestartDueFloatingObject,
    RestartDueOrphanedObjects);

  TdxClearInvalidatedContentResult = (Restart, RestartFromTheStartOfSection,
    NoRestart, ClearOnlyTableCellRows);

  TdxCanFitFloatingObjectResult = (Always, Never, DependsOnTable);
  ...
  protected
    function GetCurrentPageBounds(ACurrentPage: TdxPage;
      ACurrentColumn: TdxColumn): TRect; virtual; abstract;
    function GetCurrentPageClientBounds(ACurrentPage: TdxPage;
      ACurrentColumn: TdxColumn): TRect; virtual; abstract;
  ...
  public
    ...
    procedure AddInnerTable(ATableViewInfo: TdxTableViewInfo); virtual;
      abstract;
    function CompleteCurrentColumnFormatting(AColumn: TdxColumn)
      : TdxCompleteFormattingResult; virtual; abstract;
    function CreateRow: TdxRow; virtual; abstract;
    function GetNextColumn(AColumn: TdxColumn; AKeepFloatingObjects: Boolean)
      : TdxColumn; virtual; abstract;
    function GetPreviousColumn(AColumn: TdxColumn): TdxColumn; virtual;
      abstract;
    ...
    property PageAreaController: TdxPageAreaController
      read GetPageAreaController;
    property PageLastRunIndex: TdxRunIndex read GetPageLastRunIndex;
    property ShouldZeroSpacingBeforeWhenMoveRowToNextColumn: Boolean
      read GetShouldZeroSpacingBeforeWhenMoveRowToNextColumn;
  ...
  IdxPageAreaController = interface
    ...
    procedure BeginSectionFormatting(ASection: TdxSection;
      ACurrentColumnsCount: Integer);
    procedure RestartFormattingFromTheStartOfSection(ASection: TdxSection;
      ACurrentAreaIndex: Integer);
    procedure RestartFormattingFromTheMiddleOfSection(ASection: TdxSection;
      ACurrentAreaIndex: Integer);
  ...
  strict private
    class var FStartComparer: TdxTextAreaStartComparer;
  ...
  public
    ...
    function IntersectsWithExcludingBounds(const AInterval
      : TdxTextArea): Boolean;
    class function Union(const AInterval1, AInterval2: TdxTextArea)
      : TdxTextArea; static;
  ...
  protected
    ...
    function GetCurrentPageBounds(ACurrentPage: TdxPage;
      ACurrentColumn: TdxColumn): TRect; override;
    function GetCurrentPageClientBounds(ACurrentPage: TdxPage;
      ACurrentColumn: TdxColumn): TRect; override;
    ...
    function GetShouldZeroSpacingBeforeWhenMoveRowToNextColumn
      : Boolean; override;
    ...
    property CurrentParentColumn: TdxColumn read FCurrentParentColumn
      write InternalSetCurrentParentColumn;
  public
    constructor Create(AParent: TdxCustomColumnController;
      ACurrentParentColumn: TdxColumn; ALeft, ATop, AWidth: Integer;
      ATableViewInfo: TdxTableViewInfo; ACurrentCell: TdxTableCell);
    destructor Destroy; override;

    function CompleteCurrentColumnFormatting(AColumn: TdxColumn)
      : TdxCompleteFormattingResult; override;
    procedure ResetToFirstColumn; override;
    procedure MoveToNextColumn;
    function GetStartColumn: TdxColumn;
    procedure StartNewCell(ACurrentParentColumn: TdxColumn;
      ALeft, ATop, AWidth: Integer; ACurrentCell: TdxTableCell);
    function GetMaxAnchor(AAnchor1, AAnchor2: TdxTableCellVerticalAnchor)
  ...
  TdxFormattingProcessResult = record
    ...
    procedure Init(const ARestartPosition: TdxDocumentModelPosition;
      AForceRestart: Boolean = False); overload;
  end;
  ...
  public
    constructor Create(AParagraph: TdxParagraph; APieceTable: TdxPieceTable;
    ...
    procedure SetPosition(ARunIndex: TdxRunIndex; AOffset: Integer);
      overload; virtual;
    ...
    property VisibleTextFilter: TdxVisibleTextFilterBase
      read FVisibleTextFilter;
  end;
  ...
  protected
    ...
    function AppendBox(var ABoxInfo: TdxBoxInfo): TdxStateContinueFormatResult;
      virtual; abstract;
    ...
    procedure FinishParagraphCore(AIterator: TdxParagraphIteratorBase);
      virtual; abstract;

    function ContinueFormatByCharacter(var ABoxInfo: TdxBoxInfo;
      ALayoutDependentTextBox: TdxLayoutDependentTextBox)
      : TdxStateContinueFormatResult; virtual;
  ...
  public
    ...
    procedure AddBox(AType: TdxBoxClass; var ABoxInfo: TdxBoxInfo;
      AMeasured: Boolean);
  ...
  protected
    ...
    function GetFormattingComplete: Boolean; override;
    function GetMeasurer: TdxBoxMeasurer; override;
    function GetStateAfterFloatingObject
      : TdxParagraphBoxFormatterState; virtual;
    function GetType: TdxParagraphBoxFormatterState; virtual; abstract;

    procedure AddSuccess(ABoxInfo: TdxBoxInfo); virtual; abstract;
    function HorizontalOverfull(ABoxInfo: TdxBoxInfo)
      : TdxCompleteFormattingResult; virtual; abstract;
    function ColumnOverfull(ACanFit: TdxCanFitCurrentRowToColumnResult;
      ABoxInfo: TdxBoxInfo): TdxCompleteFormattingResult; virtual; abstract;
    function CanAddBox(ABoxInfo: TdxBoxInfo): TdxAddBoxResult; virtual;
      abstract;
    function FinishParagraph: TdxCompleteFormattingResult; override;
    function FinishSection: TdxCompleteFormattingResult; override;
    function FinishLine(ABoxInfo: TdxBoxInfo)
      : TdxCompleteFormattingResult; virtual;
    function FinishPage(ABoxInfo: TdxBoxInfo)
      : TdxCompleteFormattingResult; virtual;
    function FinishColumn(ABoxInfo: TdxBoxInfo)
      : TdxCompleteFormattingResult; virtual;
    function CanAddBoxWithoutHyphen(ABoxInfo: TdxBoxInfo)
      : TdxAddBoxResult; virtual;
    ...
    function BinarySearchFittedBox(ABoxInfo: TdxBoxInfo): Integer;
      overload; virtual;
    function BinarySearchFittedBox(ABoxInfo: TdxBoxInfo; ALow, AHi: Integer)
      : Integer; overload; virtual;
    procedure SetCurrentRowHeightToLastBoxHeight;
    procedure EndRow;
    procedure CalculateAndMeasureLayoutDependentTextBox(ALayoutDependentTextBox
      : TdxLayoutDependentTextBox; ABoxInfo: TdxBoxInfo); virtual;
    ...
    function GetAddBoxResultColumnOverfull
      (ACanFit: TdxCanFitCurrentRowToColumnResult): TdxAddBoxResult; virtual;
    ...
    class function GetContinueFormatResult(AResult: TdxCompleteFormattingResult)
      : TdxStateContinueFormatResult; static; inline;
    function SplitBox(ABoxInfo: TdxBoxInfo): TdxSplitBoxResult;
    function AppendBox(var ABoxInfo: TdxBoxInfo)
      : TdxStateContinueFormatResult; override;
  public
    constructor Create(AFormatter: TdxParagraphBoxFormatter);

    function ContinueFormat: TdxStateContinueFormatResult; virtual;
    function AddExistedBox(ABoxInfo: TdxBoxInfo;
      AIterator: TdxParagraphBoxIterator): TdxStateContinueFormatResult;
    function ObtainAddBoxResult(ABoxInfo: TdxBoxInfo): TdxAddBoxResult;
    function DispatchAddBoxResult(ABoxInfo: TdxBoxInfo;
      AResult: TdxAddBoxResult): TdxStateContinueFormatResult;
    function GetCanFitCurrentRowToColumn(AAddBoxResult: TdxAddBoxResult)
    ...
    function AdjustEndPositionToFit(ABoxInfo: TdxBoxInfo)
      : TdxAdjustEndPositionResult;

    property Formatter: TdxParagraphBoxFormatter read FFormatter;
    property CurrentRow: TdxRow read GetCurrentRow;
    property ForceFormattingComplete: Boolean read GetForceFormattingComplete
      write SetForceFormattingComplete;
    property RowsController: TdxRowsController read GetRowsController;
    property StateAfterFloatingObject: TdxParagraphBoxFormatterState
      read GetStateAfterFloatingObject;
    property &Type: TdxParagraphBoxFormatterState read GetType;
    property Iterator: TdxParagraphBoxIterator read GetIterator_;
    property PreviousState: TdxBoxFormatterStateBase read FPreviousState
      write FPreviousState;
    property StateAfterFinalizePage: TdxParagraphBoxFormatterState
      read FStateAfterFinalizePage write FStateAfterFinalizePage;
    property StateAfterFinalizeColumn: TdxParagraphBoxFormatterState
      read FStateAfterFinalizeColumn write FStateAfterFinalizeColumn;
  end;
  ...
  protected
    ...
    function HorizontalOverfull(ABoxInfo: TdxBoxInfo)
      : TdxCompleteFormattingResult; override;
    function ColumnOverfull(ACanFit: TdxCanFitCurrentRowToColumnResult;
      ABoxInfo: TdxBoxInfo): TdxCompleteFormattingResult; override;
  ...
  public
    ...
    procedure BeginParagraph(ABeginFromParagraphStart, AParagraphFrameStarted
    ...
    procedure OnNewMeasurementAndDrawingStrategyChanged
      (AMeasurer: TdxBoxMeasurer); virtual;

    property Iterator: TdxParagraphIteratorBase read FIterator
      write SetIterator;
    property PieceTable: TdxPieceTable read FPieceTable;
  ...
  TdxParagraphBoxFormatter = class sealed
    (TdxParagraphFormatterBase<TdxBoxFormatterStateBase>)
  public const
    InvalidPosition: TdxFormatterPosition = (BoxIndex: - 1; Offset: - 1;
      RunIndex: - 1);
  private
    ...
    function GetActualParagraphFramePropertiesProperty
      : TdxMergedFrameProperties;
    function GetCurrentRow: TdxRow;
    function GetNewState(AStateType: TdxParagraphBoxFormatterState)
      : TdxBoxFormatterStateBase; inline;
  protected
  ...
  public
    ...
    procedure ChangeStateContinueFromParagraph(AParagraphIndex
      : TdxParagraphIndex);
    procedure ChangeState(AStateType: TdxParagraphBoxFormatterState);
    function HasActualParagraphFrameProperties(AParagraph: TdxSimpleParagraph)
      : Boolean; overload;
    function HasActualParagraphFrameProperties: Boolean; overload;
    function GetActualParagraphFrameProperties(AParagraph: TdxSimpleParagraph)
      : TdxMergedFrameProperties; overload;
    function IsParagraphFrame(AProperties: TdxMergedFrameProperties): Boolean;
    function GetInitialStateType(ABeginFromParagraphStart: Boolean)
    ...
    procedure BeginParagraphFormatting(AIterator: TdxParagraphBoxIterator;
    ...
    procedure RollbackToPositionAndClearLastRow
      (const APos: TdxFormatterPosition);
    function RollbackToParagraphStart(const APos: TdxFormatterPosition;
      AInitialRowCount: Integer): TdxCompleteFormattingResult;
    function RollbackToStartOfRowCore
      (ACanFit: TdxCanFitCurrentRowToColumnResult;
      ANextState: TdxParagraphBoxFormatterState): TdxCompleteFormattingResult;
    function RollbackToStartOfRowTable
      (ACanFit: TdxCanFitCurrentRowToColumnResult): TdxParagraphIndex;
    function RollbackToStartOfRow(ACanFit: TdxCanFitCurrentRowToColumnResult)
    ...
    property ActualParagraphFrameProperties: TdxMergedFrameProperties
      read GetActualParagraphFramePropertiesProperty;
    ...
    property ForceFormattingComplete: Boolean read FForceFormattingComplete
      write FForceFormattingComplete;
    property PageNumberSource: TdxPage read FPageNumberSource
      write FPageNumberSource;
    property HasDeferredNumberingListBox: Boolean
      read FHasDeferredNumberingListBox write FHasDeferredNumberingListBox;
  end;

  { TdxParagraphCharacterFormatter }

  TdxParagraphCharacterFormatter = class sealed
    (TdxParagraphFormatterBase<TdxCharacterFormatterStateBase>)
  private
    FStates: array [TdxCharacterFormatterState]
      of TdxCharacterFormatterStateBase;
  ...
  public
    ...
    function CreateNumberingListBox(ASeparatorChar: Char;
      const APosition: TdxFormatterPosition): TdxNumberingListBox;
    function CreateSeparatorBox(ASeparator: Char;
      const APosition: TdxFormatterPosition): TdxBox;
  ...
  protected
    ...
    function CanFitCurrentRowToColumn(ANewRowHeight: Integer)
      : TdxCanFitCurrentRowToColumnResult; virtual;
    function CanFitBoxToCurrentRow(const ABoxSize: TSize): Boolean; virtual;
    function CanFitNumberingListBoxToCurrentRow(const ABoxSize: TSize)
      : Boolean; virtual;
    ...
    function MoveCurrentRowDownToFitTable(ATableWidth, ATableTop: Integer)
      : Integer; virtual;
    function CalculateFloatingObjectColumnBounds(ACurrentColumn: TdxColumn)
      : TRect; virtual;

    property InnerCurrentHorizontalPosition: Integer
      read FCurrentHorizontalPosition write FCurrentHorizontalPosition;
  public
    constructor Create(ARowsController: TdxRowsController); overload;
    constructor Create(ARowsController: TdxRowsController;
      APosition: Integer); overload;
  ...
  private
    ...
    function IsDecimalSeparator(const ASource: string; AIndex: Integer)
      : Boolean;
    function IsGroupSeparator(const ASource: string; AIndex: Integer): Boolean;
    function IsSubstringStarts(const ASource: string; AIndex: Integer;
      const ASubstring: string): Boolean;
    function TryFindDecimalSeparator(ABoxes: TdxBoxCollection;
      AFrom, ATo: Integer; out ABoxIndex: Integer;
  ...
  public
    ...
    function CalcLastTabWidth(ARow: TdxRow;
      AFormatter: TdxParagraphBoxFormatter): Integer;

    class function CalculateLeaderCount(ABox: TdxTabSpaceBox;
      APieceTable: TdxPieceTable): Integer; static;
    class function GetTabLeaderCharacterWidth(ABox: TdxTabSpaceBox;
      APieceTable: TdxPieceTable): Integer; static;
    class procedure CacheLeader(ABox: TdxTabSpaceBox;
      AFormatter: TdxParagraphBoxFormatter); static;
    class function GetTabLeaderCharacter(ALeaderType: TdxTabLeaderType)
      : Char; static;
    ...
    function CalcLastRightTabWidth(const ATab: TdxTabInfo;
      AStartIndex: Integer): Integer;
    function CalcLastCenterTabWidth(const ATab: TdxTabInfo;
      AStartIndex: Integer): Integer;
    function CalcLastDecimalTabWidth(const ATab: TdxTabInfo;
      AStartIndex: Integer; AFormatter: TdxParagraphBoxFormatter;
      ARowLeft: Integer): Integer;
    function AdjustAlignedTabWidth(const ATab: TdxTabInfo;
      ATabWidth, ALastNonSpaceBoxRight: Integer): Integer;
    function IsTabPositionBehindParagraphRight(const ATab: TdxTabInfo): Boolean;
    function FindDecimalPointPosition(ABoxes: TdxBoxCollection;
      AFrom, ATo: Integer; AFormatter: TdxParagraphBoxFormatter;
      ARowLeft: Integer): Integer;
    ...
    property SingleDecimalTabInTable: Boolean read FSingleDecimalTabInTable
      write FSingleDecimalTabInTable;
  end;
  ...
  public
    ...
    function GetFloatingObject(AParagraph: TdxParagraphBase)
      : TdxParagraphFrameBox;
    procedure AddParagraphFrameBox(AParagraphFrameBox: TdxParagraphFrameBox);
    function GetObjectsInRectangle(const ABounds: TRect)
      : TdxParagraphFrameBoxList; overload;
    procedure GetObjectsInRectangle(AWhere: TdxParagraphFrameBoxList;
      ATo: TdxParagraphFrameBoxList; const ABounds: TRect); overload;
    procedure ProcessParagraphFrame(AParagraphFrame: TdxParagraphFrameBox;
      AProcessedObjects: TdxParagraphFrameBoxList;
      AResult: TdxTextAreaCollectionEx; const AInitialBounds: TRect);
    function FindLeftMostX(AProcessedObjects: TdxParagraphFrameBoxList;
      AInitialX: Integer; const ABounds: TRect): Integer;
    function FindRightMostX(AProcessedObjects: TdxParagraphFrameBoxList;
      AInitialX: Integer; const ABounds: TRect): Integer;
  ...
  strict private
    ...
    function GetColumnSize(AAnchorBox: TdxFloatingObjectAnchorBox;
      AContent: TdxTextBoxFloatingObjectContent; const ATextBoxContent: TRect;
      AGetFinalSize: Boolean): TSize;
    function GetTableCell(AHitTestResult: TdxRichEditHitTestResult)
      : TdxTableCell;
    function GetDocumentModel: TdxDocumentModel;
    function GetCurrentHorizontalPosition: Integer;
    function GetParagraphFrameColumnSize(AParagraphFrameBox
      : TdxParagraphFrameBox): TSize;
    ...
    function CanFitParagraphFrame(ANewBoxInfo: TdxBoxInfo;
      AEmptyColumn: Boolean): Boolean;
  ...
  protected
    ...
    function CanFitFloatingObject(AFloatingObjectAnchorBox
      : TdxFloatingObjectAnchorBox; ANewBoxInfo: TdxBoxInfo;
      AEmptyColumn: Boolean): TdxCanFitFloatingObjectResult;
    function CompleteCurrentColumnFormatting: TdxCompleteFormattingResult;
    function CreateCurrentHorizontalPosition
      : TdxCurrentHorizontalPositionController; overload; virtual;
    function CreateCurrentHorizontalPosition(APosition: Integer)
      : TdxCurrentHorizontalPositionController; overload; virtual;
    procedure EnsureFloatingObjectBoxActualBounds(AFloatingObjectAnchorBox
    ...
    class function GetBounds(const ALocation: TPoint; AWidth: Integer;
      AHeight: Integer): TRect; static;
    class procedure SetActualBoundsForEmptyHeightFrameBox(AParagraphFrameBox
      : TdxParagraphFrameBox; AElementBoundsHeight: Integer); static;
    class function GetBoundsLocation(const ABounds: TRect;
      APositionOffset: Integer): TPoint; static;
    class procedure SetActualBoundsForEmptyWidthFrameBox(AParagraphFrameBox
      : TdxParagraphFrameBox;
      AAlignment: TdxParagraphFrameHorizontalPositionAlignment;
      AElementBoundsWidth: Integer); static;
    function GetMaxBoxWidth: Integer;
    function SnapsToModelUnits(AValue: Integer): Integer;
    procedure CorrectFloatingObjectTextBoxVerticalPosition(AFloatingObjectBox
      : TdxFloatingObjectBox; AAnchorBox: TdxFloatingObjectAnchorBox);

    property CurrentHorizontalPosition: Integer
      read GetCurrentHorizontalPosition;
    property CurrentRowIndent: Integer read FCurrentRowIndent
      write FCurrentRowIndent;
    property RegularRowIndent: Integer read FRegularRowIndent
      write FRegularRowIndent;
    property DefaultRowHeight: Integer read FDefaultRowHeight;
    property ParagraphLeft: Integer read FParagraphLeft;
    property SuppressHorizontalOverfull: Boolean
      read FSuppressHorizontalOverfull write FSuppressHorizontalOverfull;
    property Paragraph: TdxParagraph read FParagraph;
    property InitialLineNumber: Integer read FInitialLineNumber
      write SetInitialLineNumber;
    property LastRestartDueToFloatingObjectModelPosition
      : TdxDocumentModelPosition
      read FLastRestartDueToFloatingObjectModelPosition
      write FLastRestartDueToFloatingObjectModelPosition;
    property LineNumber: Integer read FLineNumber write FLineNumber;
    property LineNumberStep: Integer read FLineNumberStep
      write SetLineNumberStep;
    property PieceTable: TdxPieceTable read FPieceTable;
    property DocumentModel: TdxDocumentModel read GetDocumentModel;
    property SupportsColumnAndPageBreaks: Boolean
      read FSupportsColumnAndPageBreaks write FSupportsColumnAndPageBreaks;
    property HorizontalPositionController
      : TdxCurrentHorizontalPositionController
      read FHorizontalPositionController write FHorizontalPositionController;

    property ForceFormattingComplete: Boolean read FForceFormattingComplete;
    property ParagraphFirstRowOnPage: TdxRow read FParagraphFirstRowOnPage
      write FParagraphFirstRowOnPage;
    property ParagraphFirstColumnOnPage: TdxColumn
      read FParagraphFirstColumnOnPage write FParagraphFirstColumnOnPage;
  public
    constructor Create(APieceTable: TdxPieceTable;
      const AColumnController: TdxCustomColumnController;
      AMatchHorizontalTableIndentsToTextEdge: Boolean);
    destructor Destroy; override;

    procedure RaiseBeginNextSectionFormatting(ASectionIndex
      : TdxSectionIndex); virtual;
    procedure RaiseTableStarted; virtual;
    procedure Reset(ASection: TdxSection;
      AKeepFloatingObjects: Boolean); virtual;
    procedure SetColumnController(ANewColumnController
      : TdxCustomColumnController);
    procedure ClearInvalidatedContentCore(AColumn: TdxColumn;
      const APos: TdxFormatterPosition; AParagraphIndex: TdxParagraphIndex);
    procedure ClearInvalidatedContentFromTheStartOfRowAtCurrentPage
      (AColumn: TdxColumn; const APos: TdxFormatterPosition;
      AParagraphIndex: TdxParagraphIndex); virtual;
    procedure ClearInvalidatedContent(AColumn: TdxColumn;
      const APos: TdxFormatterPosition;
      AParagraphIndex: TdxParagraphIndex); virtual;
    property FloatingObjectsLayout: TdxFloatingObjectsLayout
      read FFloatingObjectsLayout;
    ...
    procedure RestartFormattingFromTheStartOfSection(ASection: TdxSection;
      AColumn: TdxColumn); virtual;
    procedure RestartFormattingFromTheMiddleOfSection(ASection: TdxSection;
      AColumn: TdxColumn); virtual;
    procedure RestartFormattingFromTheStartOfRowAtCurrentPage
      (ASection: TdxSection; AColumn: TdxColumn); virtual;
    procedure CreateNewCurrentRowAfterRestart(ASection: TdxSection;
      AColumn: TdxColumn); virtual;
    ...
    function AddBox(ABoxType: TdxBoxClass; ABoxInfo: TdxBoxInfo)
      : TdxBox; virtual;
    procedure AddNumberingListBox(ABox: TdxNumberingListBox;
      AProperties: TdxListLevelProperties;
      AFormatter: TdxParagraphBoxFormatter); virtual;
    function CalculateNumberingListBoxBounds(ABox: TdxNumberingListBox;
      AProperties: TdxListLevelProperties;
      AFormatter: TdxParagraphBoxFormatter): TRect;
    function CalculateNumberingListBoxBoundsCore(ABox: TdxNumberingListBox;
      AProperties: TdxListLevelProperties;
      AFormatter: TdxParagraphBoxFormatter): TRect;
    function GetNumberingListBoxSeparatorWidth
      (ABox: TdxNumberingListBoxWithSeparator; const ABounds: TRect;
      AProperties: TdxListLevelProperties;
      AFormatter: TdxParagraphBoxFormatter): Integer;
    function GetLegacyNumberingListBoxSeparatorWidth
      (ABox: TdxNumberingListBoxWithSeparator; const ABounds: TRect;
      AProperties: TdxListLevelProperties;
      AFormatter: TdxParagraphBoxFormatter): Integer;
    function GetActualTabInfo(const ATabInfo: TdxTabInfo;
      AProperties: TdxListLevelProperties): TdxTabInfo;
    function CalculateNumberingListBoxLeft(ABoxWidth: Integer;
      AAlignment: TdxListNumberAlignment): Integer;
    procedure AddSectionBreakBoxToPrevRow(ABoxType: TdxBoxClass;
      ABoxInfo: TdxBoxInfo);
    function GetBox(ABoxType: TdxBoxClass; ABoxInfo: TdxBoxInfo): TdxBox;
    procedure UpdateCurrentRowHeight(ABoxInfo: TdxBoxInfo);
    procedure UpdateCurrentRowHeightFromInlineObjectRun(ARun: TdxTextRunBase;
      ABox: TdxBox; const AMeasurer: IdxObjectMeasurer);
    procedure UpdateCurrentRowHeightFromFloatingObject
      (ARun: TdxFloatingObjectAnchorRun; const AMeasurer: IdxObjectMeasurer);
    function CanFitCurrentRowToColumn
      : TdxCanFitCurrentRowToColumnResult; overload;
    function MoveCurrentRowDownToFitTable(ATableWidth,
      ATableTop: Integer): Integer;
    function GetTextAreaForTable: TdxTextArea;
    function CanFitCurrentRowToColumn(ANewBoxInfo: TdxBoxInfo)
      : TdxCanFitCurrentRowToColumnResult; overload;
    function CreateFloatingObjectSizeAndPositionController
      : TdxFloatingObjectSizeAndPositionController; virtual;
    function CanRestartDueFloatingObject: Boolean; virtual;
    procedure ApplyFloatingObjectBoxProperties(AFloatingObjectBox
      : TdxFloatingObjectBox;
      AFloatingObjectProperties: TdxFloatingObjectProperties); virtual;
    procedure ApplyFloatingObjectBoxBounds(AFloatingObjectBox
      : TdxFloatingObjectBox; AAnchorBox: TdxFloatingObjectAnchorBox); virtual;
    procedure UpdateCurrentTableCellBottom(AFloatingObjectBox
      : TdxFloatingObjectBox); virtual;
    procedure ApplyParagraphFrameBoxBounds(AParagraphFrameBox
      : TdxParagraphFrameBox; ANewParagraphFrameBox: TdxParagraphFrameBox);
    procedure FormatParagraphFrameTextBox(AParagraphFrameBox
      : TdxParagraphFrameBox);
    procedure AddParagraphFrameToLayoutCore(AParagraphFrameBox
      : TdxParagraphFrameBox; ABoxInfo: TdxBoxInfo);
    function AddParagraphFrameToLayout(AParagraphFrameBox: TdxParagraphFrameBox;
      ABoxInfo: TdxBoxInfo): Boolean;
    function ShouldChangeExistingFloatingObjectBounds(AFloatingObjectBox
      : TdxFloatingObjectBox; AAnchorBox: TdxFloatingObjectAnchorBox): Boolean;
    function AddFloatingObjectToLayout(AFloatingObjectAnchorBox
      : TdxFloatingObjectAnchorBox; ABoxInfo: TdxBoxInfo): Boolean;
    procedure FormatFloatingObjectTextBox(AFloatingObjectBox
      : TdxFloatingObjectBox; AContent: TdxTextBoxFloatingObjectContent;
      AAnchorBox: TdxFloatingObjectAnchorBox); virtual;
    procedure ResizeFloatingObjectBoxToFitText(AFloatingObjectBox
      : TdxFloatingObjectBox; AContent: TdxTextBoxFloatingObjectContent;
      AAnchorBox: TdxFloatingObjectAnchorBox; const ATextBoxContent: TRect;
      AActualSize: Integer);
    function CalculateRestartPositionDueFloatingObject(AFloatingObjectAnchorBox
      : TdxFloatingObjectAnchorBox): TdxDocumentModelPosition;
      overload; virtual;
    function CalculateRestartPositionDueParagraphFrame(AParagraphFrameBox
      : TdxParagraphFrameBox): TdxDocumentModelPosition; virtual;
    function CalculateRestartPositionDueFloatingObject(AFloatingObjectAnchorBox
      : TdxFloatingObjectAnchorBox; const ACurrentPosition: TPoint)
      : TdxDocumentModelPosition; overload; virtual;
    function CalculateRestartPositionDueFloatingObject
      (ABox: TdxSinglePositionBox; const ABounds: TRect; AIsContains: Boolean;
      const ACurrentPosition: TPoint): TdxDocumentModelPosition;
      overload; virtual;
    function CanFitCurrentRowToColumnCore(ANewRowHeight: Integer)
      : TdxCanFitCurrentRowToColumnResult; inline;
    function CanFitNumberingListBoxToCurrentRow(const ABoxSize: TSize)
      : Boolean; inline;
    function CanFitBoxToCurrentRow(const ABoxSize: TSize): Boolean;
    function CreateFloatingObjectBox(AAnchorBox: TdxFloatingObjectAnchorBox;
      AObjectAnchorRun: TdxFloatingObjectAnchorRun): TdxFloatingObjectBox;
    ...
    function GetFontAscentAndFree(ANewBoxInfo: TdxBoxInfo): Integer;
      overload; virtual;
    function GetFontDescent(ANewBoxInfo: TdxBoxInfo): Integer;
      overload; virtual;
    function GetFontAscentAndFree(ARun: TdxTextRunBase): Integer;
      overload; virtual;
    function GetFontDescent(ARun: TdxInlinePictureRun): Integer;
      overload; virtual;
    ...
    procedure PrepareCurrentRowBounds(AParagraph: TdxParagraph;
      ABeginFromParagraphStart: Boolean);
    procedure BeginParagraph(AParagraph: TdxParagraph;
      ABeginFromParagraphStart, AParagraphFrameStarted: Boolean);
    procedure EnsureSpacingAfterPrevParagraphValid(ACurrentParagraph
      : TdxParagraph);
    ...
    function GetEffectiveLineNumberingRestartType(ASection: TdxSection)
      : TdxLineNumberingRestart; virtual;
    procedure OnPageFormattingComplete(ASection: TdxSection;
      APage: TdxPage); virtual;
    procedure CreateLineNumberBoxes(ASection: TdxSection; APage: TdxPage);
      overload; virtual;
    procedure CreateLineNumberBoxes(ASection: TdxSection;
      APageArea: TdxPageArea); overload; virtual;
    procedure CreateLineNumberBoxes(ASection: TdxSection; AColumn: TdxColumn;
      ALineNumbers: TdxLineNumberBoxCollection); overload; virtual;
    procedure EndRow(AFormatter: TdxParagraphBoxFormatter);
    procedure EndRowCore(AParagraph: TdxParagraph;
      AFormatter: TdxParagraphBoxFormatter);
    function ShouldAddParagraphBackgroundFrameBox
      (AParagraph: TdxParagraph): Boolean;
    function ShouldUseMaxDescent: Boolean;
    procedure CreateNewCurrentRow(APrevCurrentRow: TdxRow;
      AAfterRestart: Boolean);
    function CalcPrevBottom(APrevRow: TdxRow; AAfterRestart: Boolean;
      ANewRow: TdxRow): Integer;
    ...
    procedure ApplySectionStart(ASection: TdxSection;
      ACurrentColumnsCount: Integer); virtual;
    procedure NewTableStarted;
    function CreateTableGridCalculator(ADocumentModel: TdxDocumentModel;
      AWidthsCalculator: TdxTableWidthsCalculator; AMaxTableWidth: Integer)
      : TdxTableGridCalculator; virtual;
    procedure AddPageBreakBeforeRow;
    procedure SaveCurrentInfo;
    function CanFitCurrentRowWithFrameToColumn(ANewBoxInfo: TdxBoxInfo)
      : TdxCanFitCurrentRowToColumnResult;
    procedure ResetSpacingBefore;

    property CurrentRowIndentAfterFloatingObject: Integer
      read FCurrentRowIndentAfterFloatingObject;
    property CurrentColumn: TdxColumn read FCurrentColumn
      write SetCurrentColumn;
    property CurrentRow: TdxRow read FCurrentRow write SetCurrentRow;
    property ParagraphFramesLayout: TdxParagraphFramesLayout
      read FParagraphFramesLayout;
    property TablesController: TdxTablesController read FTablesController;
    property BeginNextSectionFormatting: TdxEventHandler
      read FOnBeginNextSectionFormatting;
    property FrameParagraphIndex: TdxParagraphIndex read FFrameParagraphIndex
      write FFrameParagraphIndex;
    ...
    property MatchHorizontalTableIndentsToTextEdge: Boolean
      read FMatchHorizontalTableIndentsToTextEdge
      write FMatchHorizontalTableIndentsToTextEdge;
    property RestartModelPosition: TdxDocumentModelPosition
      read FRestartModelPosition write FRestartModelPosition;
  end;
  ...
  public
    ...
    property DocumentFormattingComplete: Boolean
      read FDocumentFormattingComplete;
  end;

  TdxPageFormattingCompleteEvent = procedure(ASender: TObject;
    E: TdxPageFormattingCompleteEventArgs) of object;
  TdxPageFormattingCompleteEventHandler =
    TdxMulticastMethod<TdxPageFormattingCompleteEvent>;
  ...
  TdxResetSecondaryFormattingForPageEvent = procedure(ASender: TObject;
    AArgs: TdxResetSecondaryFormattingForPageArgs) of object;

  TdxResetSecondaryFormattingForPageEventHandler =
    TdxMulticastMethod<TdxResetSecondaryFormattingForPageEvent>;
  ...
  protected
    procedure PopulateEqualWidthColumnsBoundsCore(const ARects: TdxRectList;
      const AColumnRects: TArray<TRect>;
      ASpaceBetweenColumns: Integer); virtual;
  public
    constructor Create(AUnitConverter
      : TdxDocumentModelUnitToLayoutUnitConverter);
    function Calculate(ASection: TdxSection; const ABounds: TRect)
      : TdxRectList; virtual;
    procedure PopulateColumnsBounds(const ARects: TdxRectList;
      const ABounds: TRect; const AColumnInfoCollection
      : TdxColumnInfoCollection); virtual;
    procedure PopulateEqualWidthColumnsBounds(const AColumnBounds: TdxRectList;
      const ABounds: TRect; AColumnCount, ASpaceBetweenColumns
      : Integer); virtual;

    property UnitConverter: TdxDocumentModelUnitToLayoutUnitConverter
      read FUnitConverter;
  end;
  ...
  public
    ...
    procedure ClearInvalidatedContent(const APos
      : TdxFormatterPosition); virtual;
    procedure ClearInvalidatedContentCore(const APos: TdxFormatterPosition;
      AColumns: TdxColumnCollection);
    procedure CleanupEmptyBoxes(ALastColumn: TdxColumn); virtual;
    procedure ResetToFirstColumn; override;
    procedure BeginSectionFormatting(ASection: TdxSection); virtual;
    procedure RestartFormattingFromTheStartOfSection(ASection: TdxSection;
      ACurrentColumnIndex: Integer); virtual;
    procedure RestartFormattingFromTheMiddleOfSection(ASection: TdxSection;
      ACurrentColumnIndex: Integer); virtual;
    ...
    function CalculateColumnBoundsCore(AColumnIndex: Integer): TRect;
      virtual; abstract;
  ...
  public
    ...
    function CalculatePageClientBoundsCore(APageWidth, APageHeight, AMarginLeft,
      AMarginTop, AMarginRight, AMarginBottom: Integer): TRect; virtual;
  ...
  strict private
    ...
    function ContainsOrphanedItems(AItems: TdxFloatingObjectBoxList;
      AMaxRunIndex: TdxRunIndex): Boolean; overload;
    function ContainsOrphanedItems(AItems: TdxParagraphFrameBoxList)
      : Boolean; overload;
    function GetPageCount: Integer;
  protected
    procedure FormatHeader(APage: TdxPage;
      AFirstPageOfSection: Boolean); virtual;
    procedure FormatFooter(APage: TdxPage;
      AFirstPageOfSection: Boolean); virtual;
    function GetActualFormattingSectionIndex(ASectionIndex: TdxSectionIndex)
      : TdxSectionIndex;
    ...
    procedure AppendFloatingObjects(AFrom, ATo: TdxFloatingObjectBoxList;
      AMaxRunIndex: TdxRunIndex); virtual;
    procedure AppendParagraphFrames(AFrom,
      ATo: TdxParagraphFrameBoxList); virtual;
  public
    ...
    function ClearInvalidatedContentFromTheStartOfRowAtCurrentPage
      (const APos: TdxFormatterPosition; AParagraphIndex: TdxParagraphIndex;
      AKeepFloatingObjects: Boolean; ATablesController: TdxTablesController;
      AEmptyCurrentRow: Boolean; out ALeaveTable: Boolean)
      : TdxClearInvalidatedContentResult; virtual;

    function ClearInvalidatedContent(const APos: TdxFormatterPosition;
      AParagraphIndex: TdxParagraphIndex;
      AKeepFloatingObjects, AEmptyCurrentRow: Boolean)
      : TdxClearInvalidatedContentResult; virtual;
    function CompleteCurrentPageFormatting
      : TdxCompleteFormattingResult; virtual;
    procedure CorrectLastPageOrdinal(AParagraphIndex: TdxParagraphIndex;
      APageIndex: Integer); virtual;
    procedure BeginNextSectionFormatting(ASectionIndex
      : TdxSectionIndex); virtual;
    procedure RestartFormattingFromTheStartOfSection; virtual;
    function CalculatePageBounds(ASection: TdxSection): TRect; virtual;
    procedure RestartFormattingFromTheMiddleOfSectionCore
      (ASection: TdxSection); virtual;
    procedure PopulateFloatingObjectsLayout(ALastPage: TdxPage);
    procedure PopulateFloatingObjects(AFloatingObjects
      : TdxFloatingObjectBoxList);
    procedure PopulateParagraphFramesLayout(ALastPage: TdxPage);
    procedure PopulateParagraphFrames(AParagraphFrames
    ...
    function CalculatePageOrdinal(AFirstPageOfSection: Boolean)
      : TdxCalculatePageOrdinalResult; virtual;
    function CalculatePageOrdinalCore(APreviousPageOrdinal, ANumSkippedPages
      : Integer; AFirstPageOfSection: Boolean)
      : TdxCalculatePageOrdinalResult; virtual;
    function GetNextPageCore: TdxPage; virtual;
    procedure ApplySectionStart(ASection: TdxSection); virtual;
    function CalculateNextPageOrdinalType(ASection: TdxSection)
      : TdxSectionStartType; virtual;
    procedure FinalizePagePrimaryFormatting(APage: TdxPage;
      ADocumentEnded: Boolean); virtual;
    ...
    function CreatePageBoundsCalculator: TdxPageBoundsCalculator;
      virtual; abstract;
    ...
    property PageFormattingStarted: TdxPageFormattingCompleteEventHandler
      read FOnPageFormattingStarted;
    property PageFormattingComplete: TdxPageFormattingCompleteEventHandler
      read FOnPageFormattingComplete;
    property ParagraphFramesLayoutChanged: TdxEventHandler
      read FOnParagraphFramesLayoutChanged;
    property FloatingObjectsLayoutChanged: TdxEventHandler
      read FOnFloatingObjectsLayoutChanged;
    ...
    property CurrentSectionIndex: TdxSectionIndex read GetCurrentSectionIndex
    ...
    property PageBoundsCalculator: TdxPageBoundsCalculator
      read FPageBoundsCalculator;
  ...
  public
    ...
    procedure BeginSectionFormatting(ASection: TdxSection;
      ACurrentColumnsCount: Integer); virtual;
    procedure RestartFormattingFromTheStartOfSection(ASection: TdxSection;
      ACurrentAreaIndex: Integer); virtual;
    procedure RestartFormattingFromTheMiddleOfSection(ASection: TdxSection;
      ACurrentAreaIndex: Integer); virtual;
    procedure RestartFormattingFromTheStartOfRowAtCurrentPage; virtual;
    procedure ClearInvalidatedContent(const APos: TdxFormatterPosition);
    ...
    procedure ApplySectionStart(ASection: TdxSection;
      ACurrentColumnsCount: Integer); virtual; abstract;
  ...
  public
    ...
    function CreateDefaultState(ACurrentAreaIndex: Integer)
      : TdxPageAreaControllerState; virtual;
    function GetNextPageArea(AKeepFloatingObjects: Boolean)
      : TdxPageArea; virtual;
    procedure Reset(ASection: TdxSection); virtual;
    procedure BeginSectionFormatting(ASection: TdxSection;
      ACurrentColumnsCount: Integer); virtual;
    ...
    procedure ClearInvalidatedContent(const APos
      : TdxFormatterPosition); virtual;
    function CompleteCurrentAreaFormatting
      : TdxCompleteFormattingResult; virtual;
  ...
  public
    ...
    function CompleteCurrentAreaFormatting
      : TdxCompleteFormattingResult; override;
    function GetNextPageArea(AKeepFloatingObjects: Boolean)
      : TdxPageArea; override;
    procedure RestartFormattingFromTheStartOfSection(ASection: TdxSection;
      ACurrentAreaIndex: Integer); override;
    procedure RestartFormattingFromTheMiddleOfSection(ASection: TdxSection;
      ACurrentAreaIndex: Integer); override;
    function CreateCurrentAreaBoundsCore: TRect; override;
    procedure ApplySectionStart(ASection: TdxSection;
      ACurrentColumnsCount: Integer); override;
  end;
  ...
  public
    function Push(AItem: TdxTablesControllerStateBase)
      : TdxTablesControllerStateBase;
    function Pop: TdxTablesControllerStateBase;
    function Peek: TdxTablesControllerStateBase;

    property Items[Index: Integer]: TdxTablesControllerStateBase
      read GetItem; default;
  end;

  TdxTableBreakType = (NoBreak, NextPage, InfinityHeight);
  ...
  private
    ...
    FTableBreaks: TObjectDictionary<TdxTable,
      TdxSortedList<TPair<Integer, Integer>>>;
  ...
  protected
    function CreateTableViewInfoManager(AParentTableViewInfoManager
      : TdxTableViewInfoManager; APageController: TdxPageController;
      ARowsController: TdxRowsController): TdxTableViewInfoManager; virtual;
  ...
  public
    ...
    function GetTableBreak(ATable: TdxTable; ATableViewInfoIndex: Integer;
      out ABottomBounds: Integer): TdxTableBreakType;
    function IsInfinityHeight(ATableViewInfoIndex: Integer;
      out ABottomAnchorIndex: Integer): Boolean;
    procedure AddTableBreak(ATable: TdxTable;
      ATableViewInfoIndex, ABottomBounds: Integer);
    procedure AddInfinityTableBreak(ATableViewInfoIndex, ABottomAnchorIndex
      : Integer);
    ...
    function CanFitRowToColumn(ALastTextRowBottom: TdxLayoutUnit;
      AColumn: TdxColumn): TdxCanFitCurrentRowToColumnResult; virtual;
    function CanFitFloatingObjectInTableRow(ABottom: Integer;
    ...
    function RollbackToStartOfRowTableOnFirstCellRowColumnOverfull
      : TdxParagraphIndex;
  ...
  TdxLayoutGridRectangle = record
    ...
    constructor Create(const ABounds: TRect;
      ARowIndex, AColumnIndex, AColumnSpan: Integer);
  end;
  ...
  strict private
    ...
    function CreateTableViewInfo(ATable: TdxTable; ATopRowIndex: Integer;
    ...
    function GetStartTableViewInfoByRowSeparatorIndex(ARowSeparatorIndex
      : Integer): TdxTableViewInfo;
    function GetStartTableViewInfoIndexByRowSeparatorIndex(ARowSeparatorIndex
      : Integer): Integer;
    function GetEndTableViewInfoIndexByRowSeparatorIndex(ARowSeparatorIndex
      : Integer): Integer;
    procedure SetRowSeparatorCore(ATableViewInfo: TdxTableViewInfo;
      ARowSeparatorIndex: Integer; AAnchor: TdxTableCellVerticalAnchor);
    function CreateTableRowViewInfo(ATableViewInfo: TdxTableViewInfo;
      ARow: TdxTableRow; ARowIndex: Integer): TdxTableRowViewInfoBase;
    function GetRowStartAnchorIndex(ATableViewInfo: TdxTableViewInfo;
      ARowIndex: Integer): Integer;
    function GetRowStartAnchor(ATableViewInfo: TdxTableViewInfo;
      ARowIndex: Integer): TdxTableCellVerticalAnchor; overload;
    function AddFirstCellViewInfo(ATableViewInfo: TdxTableViewInfo;
      ACell: TdxTableCell; const ABounds: TRect;
      const AGridBounds: TdxLayoutGridRectangle; const ATextBounds: TRect)
      : TdxTableCellViewInfo;
    procedure AddMiddleCellViewInfo(ATableViewInfo: TdxTableViewInfo;
      ACell: TdxTableCell; const ABounds: TRect;
      const AGridBounds: TdxLayoutGridRectangle; const ATextBounds: TRect);
    procedure AddLastCellViewInfo(ATableViewInfo: TdxTableViewInfo;
      ACell: TdxTableCell; const ABounds: TRect;
      const AGridBounds: TdxLayoutGridRectangle; const ATextBounds: TRect);
    function GetLastTableViewInfo: TdxTableViewInfo;
    procedure AddTableCellViewInfo(ATableViewInfo: TdxTableViewInfo;
      ACellViewInfo: TdxTableCellViewInfo;
      AStartRowViewInfoIndex, AEndRowViewInfoIndex: Integer);
    procedure MoveRowAndAnchors_(ASource, ATarget: TdxTableViewInfo;
      AStartAnchorIndex: Integer);
    function ShouldSplitCell(ASource, ATarget: TdxTableViewInfo;
      ACellViewInfo: TdxTableCellViewInfo;
      ASplitAnchorIndex, ASourceAnchorsCount, AInitialSourceBottomRowIndex,
      AInitialTargetTopRowIndex: Integer): TCellAction;
    procedure MoveRowAndAnchor(ASource, ATarget: TdxTableViewInfo;
      AStartAnchorIndex: Integer);
    procedure SplitCellsByAnchor(ACurrentTableViewInfo, ANextTableViewInfo
      : TdxTableViewInfo; AAnchorIndex: Integer);
    procedure SplitCellByAnchor(ACurrentTableViewInfo, ANextTableViewInfo
      : TdxTableViewInfo; AAnchorIndex: Integer;
      ATableCellViewInfo: TdxTableCellViewInfo);
    function ShouldRemoveColumn(ATableViewInfoIndex: Integer;
      ATableViewInfo: TdxTableViewInfo): Boolean;
    function GetTopLevelTableViewInfoManager: TdxTableViewInfoManager;
  protected
    procedure EnsureFloatingObjectsLayoutValid(ATableViewInfo
      : TdxTableViewInfo); virtual;
    function GetParentTableCellViewInfo: TdxTableCellViewInfo; virtual;
    procedure SetCurrentTableCellViewInfo(ATableCellViewInfo
      : TdxTableCellViewInfo); virtual;
    procedure ValidateTopLevelColumn; virtual;
    procedure SetCurrentParentColumn(ATableViewInfo: TdxTableViewInfo); virtual;
    function FindSuitableTableCellViewInfo
      (ACells: TdxTableCellViewInfoCollection; ACell: TdxTableCell)
      : TdxTableCellViewInfo;
    function GetSplitAnchorHorizontalCellBorders(ASplitAnchor
      : TdxTableCellVerticalAnchor): TdxHorizontalCellBordersInfoList; virtual;
  public
    constructor Create(AParentTableViewInfoManager: TdxTableViewInfoManager;
      APageController: TdxPageController; ARowsController: TdxRowsController);
    destructor Destroy; override;

    procedure BeforeStartNextCell(ACell: TdxTableCell;
      const AGridBounds: TdxLayoutGridRectangle);
    function StartNewTable(ATable: TdxTable;
      ACellBounds: TDictionary<TdxTableCell, TdxLayoutGridRectangle>;
      ALeftOffset, ARightCellMargin: TdxLayoutUnit;
      AFirstContentInParentCell: Boolean; const ATableTextArea: TdxTextArea;
      out AMaxRight: TdxLayoutUnit): TdxTableViewInfo;
    function GetTableGrid: TdxTableGrid;
    function GetTableViewInfos: TdxList<TdxTableViewInfo>;
    procedure SetRowSeparator(ARowSeparatorIndex: Integer;
      AAnchor: TdxTableCellVerticalAnchor);
    procedure SetRowSeparatorForCurrentTableViewInfo(ARowSeparatorIndex
      : Integer; AAnchor: TdxTableCellVerticalAnchor);
    procedure EnsureTableRowViewInfo(ATableViewInfo: TdxTableViewInfo;
      ARow: TdxTableRow; ARowIndex: Integer);
    function GetRowStartAnchor(ARowIndex: Integer)
      : TdxTableCellVerticalAnchor; overload;
    ...
    procedure StartNextCell(ACell: TdxTableCell; const ABounds: TRect;
      const AGridBounds: TdxLayoutGridRectangle; const ATextBounds: TRect);
    function GetLastTableBottom: Integer;
    function GetBottomCellAnchor(ACurrentCell: TdxTableCell)
      : TdxTableCellVerticalAnchor;
    function GetBottomCellRowSeparatorIndex(ACurrentCell: TdxTableCell;
      ARowSpan: Integer): Integer;
    ...
    procedure RemoveAllInvalidRowsOnColumnOverfull(AFirstInvalidRowIndex
      : Integer);
    ...
    property ColumnController: TdxTableCellColumnController
      read FColumnController write SetColumnController;
    property CurrentTableViewInfo: TdxTableViewInfo
      read GetCurrentTableViewInfo;
    property CurrentCellBottom: Integer read GetCurrentCellBottom
      write SetCurrentCellBottom;
    property CurrentTableCellViewInfo: TdxTableCellViewInfo
      read FCurrentTableCellViewInfo write InternalSetCurrentTableCellViewInfo;
    property RowsController: TdxRowsController read FRowsController;
    property TopLevelTableViewInfoManager: TdxTableViewInfoManager
      read GetTopLevelTableViewInfoManager;
  end;
  ...
  public
    ...
    procedure UpdateCurrentCellBottom(ABottom: TdxLayoutUnit); virtual;
      abstract;
    ...
    function CanFitRowToColumn(ALastTextRowBottom: TdxLayoutUnit;
      AColumn: TdxColumn): TdxCanFitCurrentRowToColumnResult; virtual; abstract;
    function CanFitFloatingObjectInTableRow(ABottom: Integer;
      AColumn: TdxColumn): TdxCanFitCurrentRowToColumnResult; virtual; abstract;
    procedure OnCurrentRowFinished; virtual; abstract;
    function RollbackToStartOfRowTableOnFirstCellRowColumnOverfull
      (AFirstTableRowViewInfoInColumn, AInnerMostTable: Boolean)
      : TdxParagraphIndex; virtual; abstract;
  ...
  public
    ...
    function CanFitRowToColumn(ALastTextRowBottom: Integer; AColumn: TdxColumn)
      : TdxCanFitCurrentRowToColumnResult; override;
    procedure OnCurrentRowFinished; override;
    function RollbackToStartOfRowTableOnFirstCellRowColumnOverfull
      (AFirstTableRowViewInfoInColumn, AInnerMostTable: Boolean)
      : TdxParagraphIndex; override;
    function CanFitFloatingObjectInTableRow(ABottom: Integer;
      AColumn: TdxColumn): TdxCanFitCurrentRowToColumnResult; override;
  end;
  ...
  public
    procedure SetStartColumnIndex(ANewStartColumnIndex: Integer);
      virtual; abstract;
  ...
  public
    ...
    property CurrentAboveInfo: TdxNullableHorizontalCellBordersInfo
      read GetCurrentAboveInfo;
    property CurrentMergedInfo: TdxHorizontalCellBordersInfo
      read GetCurrentMergedInfo;
    property CurrentBelowInfo: TdxNullableHorizontalCellBordersInfo
      read GetCurrentBelowInfo;
  end;
  ...
  private
    FTable: TdxTable;
    function GetAnchorBorders(AAnchorIndex: Integer)
      : TdxHorizontalCellBordersInfoList;
    function ResolveBorder(ATable: TdxTable;
      ABorder1, ABorder2: TdxNullableHorizontalCellBordersInfo)
      : TdxHorizontalCellBordersInfo;
  public
    constructor Create(ATable: TdxTable);
    function GetBottomBorders(ARow: TdxTableRow)
      : TdxHorizontalCellBordersInfoList;
    function GetTopBorders(ARow: TdxTableRow): TdxHorizontalCellBordersInfoList;
  end;

  TdxRestartFrom = (NoRestart, CellStart, TableStart);
  ...
  protected
    ...
    procedure StartNewTable(ATable: TdxTable; AFirstContentInParentCell,
      ASimpleView: Boolean);
    procedure EnsureCurrentTableRow(ARow: TdxTableRow);
    function CalculateTableActualLeftRelativeOffset(ATable: TdxTable)
      : TdxModelUnit;
    function GetTextBounds(ACell: TdxTableCell;
    ...
    function CalculateBottomTextIndent(ARowSeparatorIndex: Integer;
    ...
    function CalculateShiftedPositions(ASimpleView: Boolean)
      : TdxLayoutUnitSortedList;
    function CalculateInitialPositions(ALeftOffset: TdxLayoutUnit)
      : TdxLayoutUnitSortedList;
    function PrepareCellsBounds(ALeftOffset: TdxLayoutUnit;
      ASimpleView: Boolean): TdxVerticalBorderPositions;
    function GetWidth(AGrid: TdxTableGrid; AFirstColumn, ACount: Integer)
      : TdxLayoutUnit;
    procedure FinishCurrentTable;
    procedure ProcessPendingCells(ATableViewInfo: TdxTableViewInfo;
    ...
    procedure ShiftRow(APositions: TdxLayoutUnitSortedList; ARow: TdxTableRow;
      AOffset: Integer); virtual;
    procedure AddTopAnchor; virtual;
    function GetRowOffset(ARow: TdxTableRow; ASimpleView: Boolean)
      : Integer; virtual;
  public
    constructor Create(ATablesController: TdxTablesController;
      AStartCell: TdxTableCell; AFirstContentInParentCell,
      ASimpleView: Boolean);
    destructor Destroy; override;

    class function GetActualCellSpacing(ARow: TdxTableRow)
      : TdxModelUnit; static;
    ...
    property UnitConverter: TdxDocumentModelUnitToLayoutUnitConverter
      read FUnitConverter;
    property VerticalBordersCalculator: TdxTableCellVerticalBorderCalculator
      read FVerticalBordersCalculator;
    property TableViewInfoManager: TdxTableViewInfoManager
      read FTableViewInfoManager;
  ...
  strict private
    ...
    function GetDocumentModel: TdxDocumentModel;
  protected
    function ValidateRotatedShapeHorizontalPosition(const ARect: TRect;
      AProperties: TdxFloatingObjectProperties): TRect; virtual;
    function ValidateRotatedShapeVerticalPosition(const ARect: TRect;
      AProperties: TdxFloatingObjectProperties): TRect; virtual;
    function CreateFloatingObjectLocation(AProperties
      : TdxFloatingObjectProperties; AAutoHeight: Boolean)
      : IdxFloatingObjectLocation;
    function CreateRotatedFloatingObjectLocation(const AProperties
      : IdxFloatingObjectLocation; AAngle: Integer; AAutoHeight: Boolean)
      : IdxFloatingObjectLocation;
    function CalculateAbsoluteFloatingObjectShapeBounds(const ALocation
      : IdxFloatingObjectLocation; AShape: TdxShape; AIsTextBox: Boolean)
      : TRect; virtual;
    function CalculateAbsoluteParagraphFrameShapeBounds(const ALocation
      : IdxParagraphFrameLocation): TRect; virtual;
    function CenterRectangleHorizontally(const ARectangle: TRect;
      const AWhere: TRect): TRect;
    function CenterRectangleVertically(const ARectangle: TRect;
      const AWhere: TRect): TRect;
    function CalculateAbsoluteFloatingObjectContentBounds
      (const AFloatingObjectProperties: IdxFloatingObjectLocation;
      AShape: TdxShape; const AShapeBounds: TRect): TRect; virtual;
    function CalculateActualAbsoluteFloatingObjectBounds
      (AFloatingObjectProperties: TdxFloatingObjectProperties;
      const ABounds: TRect): TRect; virtual;
    function CalculateAbsoluteFloatingObjectBounds(const ALocation
      : IdxFloatingObjectLocation): TRect; virtual;
    function CalculateAbsoluteParagraphFrameBounds(const ALocation
      : IdxParagraphFrameLocation): TRect; virtual;
    class function GetActualBorderWidth(AUseBorder: Boolean;
      ABorder: TdxBorderInfo;
      AConverter: TdxDocumentModelUnitToLayoutUnitConverter): Integer; static;

    property DocumentModel: TdxDocumentModel read GetDocumentModel;
    property PieceTable: TdxPieceTable read FPieceTable;
  public
    constructor Create(APieceTable: TdxPieceTable);
    procedure UpdateFloatingObjectBox(AFloatingObjectAnchorBox
      : TdxFloatingObjectAnchorBox);
  ...
  public
    ...
    property OriginalColumnBounds: TRect read FOriginalColumnBounds
      write FOriginalColumnBounds;
    ...
    property PageClientBounds: TRect read FPageClientBounds
      write FPageClientBounds;
  ...
  private
    ...
    function GetHorizontalPositionController
      : TdxCurrentHorizontalPositionController;
    function GetCurrentRow: TdxRow;
    function GetCurrentHorizontalPosition: Integer;
  protected
    function CalculateAbsoluteFloatingObjectBounds(const ALocation
      : IdxFloatingObjectLocation): TRect; override;
    function CalculateAbsoluteParagraphFrameBounds(const ALocation
      : IdxParagraphFrameLocation): TRect; override;
    function CalculatePlacementInfo(const ALocation: IdxFloatingObjectLocation)
      : TdxFloatingObjectTargetPlacementInfo;
    function CalculateAbsoluteFloatingObjectX(const ALocation
      : IdxFloatingObjectLocation;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo;
      AActualWidth: Integer): Integer; virtual;
    function CalculateAbsoluteFloatingObjectY(const ALocation
      : IdxFloatingObjectLocation;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo;
      AActualHeight: Integer): Integer; virtual;
    function CalculateAbsoluteFloatingObjectWidth(const ALocation
      : IdxFloatingObjectLocation;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo)
      : Integer; virtual;
    function CalculateAbsoluteFloatingObjectHeight(const ALocation
      : IdxFloatingObjectLocation;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo)
      : Integer; virtual;

    function CalculateAbsoluteParagraphFrameX(const ALocation
      : IdxParagraphFrameLocation;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo;
      AActualWidth: Integer): Integer; virtual;
    function CalculateAbsoluteParagraphFrameY(const ALocation
      : IdxParagraphFrameLocation;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo;
      AActualHeight: Integer): Integer; virtual;

    function ValidateRotatedShapeHorizontalPosition(const AShapeBounds: TRect;
      AProperties: TdxFloatingObjectProperties): TRect; override;
    function ValidateRotatedShapeVerticalPosition(const AShapeBounds: TRect;
      AProperties: TdxFloatingObjectProperties): TRect; override;

    property RowsController: TdxRowsController read FRowsController;
    property CurrentColumn: TdxColumn read GetCurrentColumn;
    property ColumnController: TdxCustomColumnController
      read GetColumnController;
    property HorizontalPositionController
      : TdxCurrentHorizontalPositionController
      read GetHorizontalPositionController;
    property CurrentRow: TdxRow read GetCurrentRow;
    property CurrentHorizontalPosition: Integer
      read GetCurrentHorizontalPosition;
  public
  ...
  private
    FUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
    function CalculateAbsoluteFloatingObjectWidthCore(const ALocation
      : IdxFloatingObjectLocation;
    ...
    function GetPercentBaseWidth(AFrom: TdxFloatingObjectRelativeFromHorizontal;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
    function CalculateFloatingObjectOffsetPercentBase
      (AType: TdxFloatingObjectHorizontalPositionType;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
    function CalculateAbsoluteFloatingObjectXCore(AHorizontalPositionType
      : TdxFloatingObjectHorizontalPositionType; AOffsetX: Integer;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
    ...
    function CalculateAbsoluteFloatingObjectHorizontalAlignmentPosition
      (AAlignment: TdxFloatingObjectHorizontalPositionAlignment;
      AAlignBounds: TRect; AActualWidth, APageIndex: Integer): Integer;
  public
    constructor Create(AUnitConverter
      : TdxDocumentModelUnitToLayoutUnitConverter);
    function CalculateAbsoluteFloatingObjectWidth(const ALocation
    ...
    function CalculateFloatingObjectOffsetX(AHorizontalPositionType
      : TdxFloatingObjectHorizontalPositionType; X: Integer;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
  end;
  ...
  private
    FUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
    function CalculateAbsoluteFloatingObjectHeightCore(const ALocation
      : IdxFloatingObjectLocation;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
    function GetPercentBaseHeight(AFrom: TdxFloatingObjectRelativeFromVertical;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
    function CalculateFloatingObjectOffsetPercentBase
      (AType: TdxFloatingObjectVerticalPositionType;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
    function CalculateAbsoluteFloatingObjectYCore
    ...
    function CalculateAbsoluteFloatingObjectVerticalAlignmentPosition
      (AAlignment: TdxFloatingObjectVerticalPositionAlignment;
  ...
  public
    ...
    function CalculateFloatingObjectOffsetY(AVerticalPositionType
      : TdxFloatingObjectVerticalPositionType; Y: Integer;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
  end;
  ...
  strict private
    ...
    FObjectsTable: TDictionary<TdxFloatingObjectAnchorRun,
      TdxFloatingObjectBox>;
    FObjectToRunMapTable: TDictionary<TdxFloatingObjectBox,
      TdxFloatingObjectAnchorRun>;
    function FindLeftMostX(AProcessedObjects: TdxFloatingObjectBoxList;
      AInitialX: Integer; const ABounds: TRect): Integer;
    function FindRightMostX(AProcessedObjects: TdxFloatingObjectBoxList;
      AInitialX: Integer; const ABounds: TRect): Integer;
  strict private
  class var
    FHorizontalObjectComparer: TdxBoxBaseComparer;
  ...
  protected
    ...
    procedure ClearFloatingObjects(ARunIndex: TdxRunIndex;
  ...
  public
    ...
    function GetFloatingObject(AObjectAnchorRun: TdxFloatingObjectAnchorRun)
      : TdxFloatingObjectBox;
    procedure Add(AObjectAnchorRun: TdxFloatingObjectAnchorRun;
      AFloatingObject: TdxFloatingObjectBox); overload;
    function GetObjectsInRectangle(const ABounds: TRect)
      : TdxFloatingObjectBoxList; overload;
    function GetAllObjectsInRectangle(const ABounds: TRect)
      : TdxFloatingObjectBoxList;
    procedure GetObjectsInRectangle(AWhere: TdxFloatingObjectBoxList;
      ATo: TdxFloatingObjectBoxList; const ABounds: TRect); overload;
    procedure ProcessFloatingObject(AFloatingObject: TdxFloatingObjectBox;
      AProcessedObjects: TdxFloatingObjectBoxList;
      AResult: TdxTextAreaCollectionEx; const AInitialBounds: TRect);
    procedure Clear;
    procedure ClearFloatingObjects(ARunIndex: TdxRunIndex); overload;
    function GetFloatingObjects(APieceTable: TdxPieceTable)
      : TdxFloatingObjectBoxList; overload;
    procedure GetFloatingObjects(AWhere: TdxFloatingObjectBoxList;
      APieceTable: TdxPieceTable; AObjects: TdxFloatingObjectBoxList); overload;
    procedure MoveFloatingObjectsVertically(ADeltaY: Integer;
  ...
  public
    ...
    class function GetMaxWidth(AAreas: TdxPageAreaCollection): Integer;
      overload; static;
    class function GetMaxWidth(ARows: TdxRowCollection): Integer;
      overload; static;
  ...
  protected
    function CreateCommentHighlightAreaCore(ARow: TdxRow; AStart: TdxRunIndex;
      AEnd: TdxRunIndex; const ATightRowBounds: TRect; AComment: TdxComment)
      : TdxHighlightArea;
    procedure CalculateCommentHighlight(ARow: TdxRow;
      const ATightRowBounds: TRect);
  public
    constructor Create(ADocumentLayout: TdxDocumentLayout);
    destructor Destroy; override;
    ...
    function CalculateSubscriptOrSuperScriptOffset(ABox: TdxBox)
      : Integer; inline;
    procedure UpdateCurrentParagraph(AParagraph: TdxSimpleParagraph);
    function CalculateTightRowBounds(ARow: TdxRow): TRect;
    procedure CalculateRangePermissionHighlight(ARow: TdxRow;
      const ATightRowBounds: TRect);
    procedure CalculateFieldsHighlight(ARow: TdxRow;
      const ATightRowBounds: TRect);
    function LookupFirstFieldIndexByRunIndex(ARow: TdxRow;
      ARunIndex: TdxRunIndex): Integer;
    function CreateFieldHighlightAreaCore(ARow: TdxRow;
      AStart, AEnd: TdxRunIndex; const ATightRowBounds: TRect;
      AColor: TdxAlphaColor): TdxHighlightArea;
    function CreateRangePermissionHighlightAreaCore(ARow: TdxRow;
      AStart, AEnd: TdxRunIndex; const ATightRowBounds: TRect;
      ARangePermission: TdxRangePermission): TdxHighlightArea;
    function FindBoxIndex(ABoxes: TdxBoxCollection; AFrom: Integer;
      AIndexToSearch: TdxRunIndex): Integer;
    procedure CalculateBackgroundHighlight(ARow: TdxRow;
      const ATightRowBounds: TRect);
    procedure CalculateHiddenTextBoxes(ARow: TdxRow);
    procedure CalculateSpecialTextBoxes(ARow: TdxRow);
    procedure FormatParagraphFrames(AParagraphFrames
      : TdxParagraphFrameBoxCollection);
    procedure FormatParagraphFrame(AParagraphFrameBox: TdxParagraphFrameBox;
      ANextParagraphFrameBox: TdxParagraphFrameBox);
    function CalculateBottomRow(ARows: TdxRowCollection;
      AParagraphIndex: TdxParagraphIndex; ACellRow: TdxTableCellRow): TdxRow;
    function CalculateBottomPosition(AFrameBox, ANextFrameBox
      : TdxParagraphFrameBox; ARow: TdxRow; ACellRow: TdxTableCellRow): Integer;
    function ShouldMergeParagraphFrameBoxes(AParagraphFrameBox
      : TdxParagraphFrameBox; ANextParagraphFrameBox: TdxParagraphFrameBox;
      ACellRow: TdxTableCellRow): Boolean;
    function CalculateRowBoxesTop(ARow: TdxRow): Integer;
    function CalculateRowBoxesBottom(ARow: TdxRow): Integer;
    function FindRowByParagraphIndex(ARows: TdxRowCollection;
      AParagraphIndex: TdxParagraphIndex): Integer;
    procedure ApplyTableCellsVerticalContentAlignment
      (ATables: TdxTableViewInfoCollection); overload;
    procedure ApplyTableCellsVerticalContentAlignment(ATable: TdxTableViewInfo);
      overload;
    procedure ApplyTableCellVerticalContentAlignment
      (ACell: TdxTableCellViewInfo);
    procedure ApplyTableCellsVerticalContentAlignment
      (AInnerTables: TdxTableViewInfoCollection; AFirstRowIndex, ALastRowIndex,
      AOffset: Integer); overload;
    function CalculateContentOffset(ACell: TdxTableCellViewInfo;
      AContentHeight: Integer): Integer; overload;
    function CalculateContentOffset(AVerticalAlignment: TdxVerticalAlignment;
      AMaxContentHeight, AContentHeight: Integer): Integer; overload;
    function CalculateCellContentVerticalBounds(ACell: TdxTableCellViewInfo;
      AFirstRow, ALastRow: TdxRow): TRect;
    function CalculateCellRowsVerticalBounds(ACell: TdxTableCellViewInfo;
      AFirstRow, ALastRow: TdxRow): TRect;
    function CalculateCellInnerTablesVerticalBounds(ATableViewInfoCollection
      : TdxTableViewInfoCollection): TRect;

    property DocumentModel: TdxDocumentModel read GetDocumentModel;
    property PieceTable: TdxPieceTable read FPieceTable write SetPieceTable;
    property BookmarkCalculator: TdxBookmarkBoxCalculator
      read FBookmarkCalculator;
    property CustomMarkCalculator: TdxCustomMarkBoxCalculator
      read FCustomMarkCalculator;
    property RangePermissionCalculator: TdxRangePermissionBoxCalculator
      read FRangePermissionCalculator;
    property RangePermissionColorer: TdxRangePermissionColorer
      read FRangePermissionColorer;
  end;
  ...
  protected
    procedure AlignRowBoxesToBaseLine(AFormatter: TdxParagraphFinalFormatter;
      ARow: TdxRow; ACount: Integer; const AAscents: TArray<Integer>); virtual;
    function CalculateSpacingInlineObjectCase(ARowHeight, AMaxDescent,
      ARowTextHeight, ARowTextSpacing, AMaxPictureHeight: Integer): Integer;
      virtual; abstract;
    function CreateParametersCalculator(AFormatter: TdxParagraphFinalFormatter;
      AParameterCount: Integer): TdxRowSpacingParametersCalculatorBase; virtual;
    function GetDefaultRowHeight: Integer; virtual;
    function GetRowContentBoxes(ARow: TdxRow): TArray<TdxBox>;
  public
    class function GetLineSpacingCalculator(AParagraph: TdxSimpleParagraph)
      : TdxLineSpacingCalculatorBase; static;
    function CalculateSpacing(ARowHeight, AMaxAscentAndFree, AMaxDescent,
      AMaxPictureHeight: Integer): Integer; virtual;
    function CalculateSpacingCore(ARowHeight: Integer): Integer;
      virtual; abstract;
    function CalcRowHeight(AOldRowHeight, ANewBoxHeight: Integer)
      : Integer; virtual;
    function CalcRowHeightFromInlineObject(AOldRowHeight, AMaxPictureHeight,
      AMaxDescent: Integer): Integer; virtual;
    procedure FormatRow(AFormatter: TdxParagraphFinalFormatter;
      ARow: TdxRow); virtual;
  ...
  public
    constructor Create(AFormatter: TdxParagraphFinalFormatter;
      AParameterCount: Integer);

    procedure ProcessBox(ABox: TdxBox; ABoxIndex: Integer); virtual; abstract;
    function CalculateRowBaseLineOffset(ARow: TdxRow): Integer;
      virtual; abstract;

    property ParameterValues: TArray<Integer> read FParameterValues;
    property MaxParameterValue: Integer read FMaxParameterValue
      write FMaxParameterValue;
    property MaxSpaceParameterValue: Integer read FMaxSpaceParameterValue
      write FMaxSpaceParameterValue;
    property MaxMarkParameterValue: Integer read FMaxMarkParameterValue
      write FMaxMarkParameterValue;
  ...
  protected
    ...
    procedure EndCharacterLine(AEndAnchorIndex: Integer;
      ACurrentFontInfo: TdxFontInfo); virtual; abstract;
    function IsCharacterLineBreak(ACharacterLineTypeChanged: Boolean;
    ...
    procedure CalculateCharacterLineBoxesByType(ALastNonSpaceBoxIndex
      : Integer); virtual;
    function SetCurrentRunCharacterLineTypeFromNumberingListBox
      : Boolean; virtual;
    function SetCurrentRunCharacterLineTypeFromBox(ABox: TdxBox;
      APrevBoxIndex: TdxRunIndex): Boolean; virtual;
    function GetRunCharacterLineType(ARun: TdxTextRun; ARunIndex: TdxRunIndex)
      : T; virtual; abstract;
    function GetRunCharacterLineUseForWordsOnly(ARun: TdxTextRun;
      ARunIndex: TdxRunIndex): Boolean; virtual; abstract;
    function GetNumberingListBoxCharacterLineType(ANumberingListBox
      : TdxNumberingListBox): T; virtual; abstract;
    function GetNumberingListBoxCharacterLineUseForWordsOnly(ANumberingListBox
      : TdxNumberingListBox): Boolean; virtual; abstract;
    function GetBoxScript(ABoxIndex: Integer)
      : TdxCharacterFormattingScript; virtual;
    ...
    function CalculateActualScript(AScript: TdxCharacterFormattingScript)
      : TdxCharacterFormattingScript; virtual;
    function CalculateScriptOffset(AFontInfo: TdxFontInfo;
      AScript: TdxCharacterFormattingScript): Integer;
    ...
    property CurrentRunCharacterLineType: T read FCurrentRunCharacterLineType
      write FCurrentRunCharacterLineType;
    property CurrentScript: TdxCharacterFormattingScript read FCurrentScript
      write FCurrentScript;
    property DocumentModel: TdxDocumentModel read GetDocumentModel;
    property PieceTable: TdxPieceTable read FPieceTable write SetPieceTable;
    property Row: TdxRow read FRow write FRow;
    property UseForWordsOnly: Boolean read FUseForWordsOnly
      write FUseForWordsOnly;
  public
    constructor Create(APieceTable: TdxPieceTable);
    destructor Destroy; override;
  ...
  protected
    ...
    function CalculateActualScript(AScript: TdxCharacterFormattingScript)
      : TdxCharacterFormattingScript; override;
    function ShouldBreakCharacterLineByScript
      (AScript: TdxCharacterFormattingScript): Boolean;
    function IsCharacterLineBreak(ACharacterLineTypeChanged: Boolean;
      ARunChanged: Boolean; ABoxScript: TdxCharacterFormattingScript)
      : Boolean; override;
    procedure StartCharacterLine(AStartAnchorIndex: Integer); override;
    procedure EndCharacterLine(AEndAnchorIndex: Integer;
      ACurrentFontInfo: TdxFontInfo); override;
    ...
    function CalculateTabLeaderUnderlineInfo(ABox: TdxTabSpaceBox;
      const ABounds: TRect): TdxUnderlineInfo;
    function GetRunCharacterLineType(ARun: TdxTextRun; ARunIndex: TdxRunIndex)
      : TdxUnderlineType; override;
    function GetRunCharacterLineUseForWordsOnly(ARun: TdxTextRun;
      ARunIndex: TdxRunIndex): Boolean; override;
    function GetNumberingListBoxCharacterLineType(ANumberingListBox
      : TdxNumberingListBox): TdxUnderlineType; override;
    function GetNumberingListBoxCharacterLineUseForWordsOnly(ANumberingListBox
      : TdxNumberingListBox): Boolean; override;
    ...
    procedure AddNewUnderlineBoxToRow(ASourceUnderlineBox: TdxUnderlineBox;
      AStartIndex: Integer; AEndIndex: Integer);
    ...
    property StartAnchorIndex: Integer read FStartAnchorIndex
      write FStartAnchorIndex;
    property UnderlineBoxesByType: TdxUnderlineBoxCollection
      read FUnderlineBoxesByType write FUnderlineBoxesByType;
    property ActualScript: TdxCharacterFormattingScript read FActualScript;
  public
    constructor Create(APieceTable: TdxPieceTable);
    destructor Destroy; override;
    class function CalculateUnderlineThickness(AWeightedUnderlineThicknessSum
      : Integer; ATotalUnderlineWidth: Integer): Integer; static;
    class function CalculateUnderlinePosition(AWeightedUnderlinePositionSum
      : Integer; ATotalUnderlineWidth: Integer): Integer; static;
    function CreateTabLeaderUnderlineBox(ABox: TdxTabSpaceBox;
      const ABounds: TRect; ARow: TdxRow): TdxUnderlineBox;
    procedure CenterTabLeaderUnderlineBoxVertically(AUnderlineBox
      : TdxUnderlineBox; const ABounds: TRect);
  end;
  ...
  protected
    ...
    procedure EndCharacterLine(AEndAnchorIndex: Integer;
      AFontInfo: TdxFontInfo); override;
    function GetRunCharacterLineType(ARun: TdxTextRun; ARunIndex: TdxRunIndex)
      : TdxStrikeoutType; override;
    function GetRunCharacterLineUseForWordsOnly(ARun: TdxTextRun;
      ARunIndex: TdxRunIndex): Boolean; override;
    function GetNumberingListBoxCharacterLineType(ANumberingListBox
      : TdxNumberingListBox): TdxStrikeoutType; override;
    function GetNumberingListBoxCharacterLineUseForWordsOnly(ANumberingListBox
      : TdxNumberingListBox): Boolean; override;
...
type
  ...
  private
    ...
    procedure SetAssociatedFloatingObjectsLayout(const Value
      : TdxFloatingObjectsLayout);
  public
    property AssociatedFloatingObjectsLayout: TdxFloatingObjectsLayout
      read GetAssociatedFloatingObjectsLayout
      write SetAssociatedFloatingObjectsLayout;
  end;
  ...
  strict private
    ...
    function CalculateAlignBounds(const ALocation: IdxParagraphFrameLocation;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): TRect;
    function CalculateAbsoluteFloatingObjectXCore(AHorizontalPositionType
      : TdxParagraphFrameHorizontalPositionType; AOffsetX: Integer;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
    function CalculateAbsoluteFloatingObjectHorizontalAlignmentPosition
      (AAlignment: TdxParagraphFrameHorizontalPositionAlignment;
  ...
  public
    ...
    function CalculateAbsoluteFloatingObjectX(const ALocation
      ...
      AActualWidth: Integer): Integer;
    function CalculateFloatingObjectOffsetX(AHorizontalPositionType
      : TdxParagraphFrameHorizontalPositionType; X: Integer;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
  end;
  ...
  strict private
    ...
    function CalculateAlignBounds(const ALocation: IdxParagraphFrameLocation;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): TRect;
    function CalculateAbsoluteParagraphFrameVerticalAlignmentPosition
      (AAlignment: TdxParagraphFrameVerticalPositionAlignment;
      const AAlignBounds: TRect; AActualHeight: Integer): Integer;
  public
    constructor Create(AUnitConverter
      : TdxDocumentModelUnitToLayoutUnitConverter);
    function CalculateAbsoluteFloatingObjectY(const ALocation
      ...
      AActualHeight: Integer): Integer;
    function CalculateFloatingObjectOffsetY(AVerticalPositionType
      : TdxParagraphFrameVerticalPositionType; Y: Integer;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
    function CalculateAbsoluteFloatingObjectYCore
  ...
  TdxParagraphBoxFormatterTextState = class
    (TdxParagraphBoxFormatterTableStateBase)
  protected
  ...
  TdxParagraphBoxFormatterTableState = class
    (TdxParagraphBoxFormatterTableStateBase)
  protected
    procedure OnColumnOverfull; override;
  end;
  ...
  TdxCharacterFormatterSpacesState = class sealed
    (TdxCharacterFormatterStateBase)
  protected
    function GetType: TdxCharacterFormatterState; override;
    function IsTerminatorChar(ACh: Char): Boolean; override;
  ...
  TdxCharacterFormatterFirstDashState = class sealed
    (TdxCharacterFormatterDashState)
  protected
    function GetType: TdxCharacterFormatterState; override;
    function IsTerminatorChar(ACh: Char): Boolean; override;
  ...
  TdxCharacterFormatterLayoutDependentTextState = class sealed
    (TdxCharacterFormatterStateBase)
  protected
    function GetType: TdxCharacterFormatterState; override;
    function IsTerminatorChar(ACh: Char): Boolean; override;
  ...
  TdxCharacterFormatterInlineObjectState = class sealed
    (TdxCharacterFormatterStateBase)
  protected
    function GetType: TdxCharacterFormatterState; override;
    function IsTerminatorChar(ACh: Char): Boolean; override;
  ...
  TdxCharacterFormatterSeparatorState = class sealed
    (TdxCharacterFormatterStateBase)
  protected
    function GetType: TdxCharacterFormatterState; override;
    function IsTerminatorChar(ACh: Char): Boolean; override;
  ...
  TdxCharacterFormatterFloatingObjectState = class sealed
    (TdxCharacterFormatterStateBase)
  protected
    function GetType: TdxCharacterFormatterState; override;
    function IsTerminatorChar(ACh: Char): Boolean; override;
  ...
  TdxCharacterFormatterColumnBreak = class sealed
    (TdxCharacterFormatterStateBase)
  protected
    function GetType: TdxCharacterFormatterState; override;
    function IsTerminatorChar(ACh: Char): Boolean; override;
  ...
  IdxSupportsChangeStateManually = interface
    ...
    procedure ChangeStateManuallyIfNeeded(AIteratorResult
      : TdxParagraphIteratorResult);
  end;

  { TdxStateRowTextSplit }

  TdxStateRowTextSplit = class(TdxBoxFormatterStateBase,
    IdxSupportsChangeStateManually)
  protected
    function GetStateAfterFloatingObject
      : TdxParagraphBoxFormatterState; override;
    function GetType: TdxParagraphBoxFormatterState; override;
    function HorizontalOverfull(ABoxInfo: TdxBoxInfo)
      : TdxCompleteFormattingResult; override;
    ...
    function IsTerminatorChar(ACh: Char): Boolean; override;
    procedure AddSuccess(ABoxInfo: TdxBoxInfo); override;
    function ShouldChangeStateManually(AIteratorResult
      : TdxParagraphIteratorResult; ACurrentCharacter: Char): Boolean;
    function CalcNextState(ACurrentCharacter: Char)
      : TdxParagraphBoxFormatterState; virtual;
    function FinishParagraph: TdxCompleteFormattingResult; override;
    function FinishSection: TdxCompleteFormattingResult; override;
    function FinishLine(ABoxInfo: TdxBoxInfo)
  ...
  TdxStateRowEmptyHyphenationAfterFloatingObject = class sealed
    (TdxStateRowEmptyHyphenation)
  protected
    function GetType: TdxParagraphBoxFormatterState; override;
  end;
  ...
  protected
    function CalcNextState(ACurrentCharacter: Char)
      : TdxParagraphBoxFormatterState; virtual;
    function GetHyphenationState: TdxParagraphBoxFormatterState;
      virtual; abstract;
    function GetNoHyphenationNextState: TdxParagraphBoxFormatterState;
      virtual; abstract;
    function CanUseBox: Boolean; override;
  ...
  public
    ...
    property DashAfterTextState: TdxParagraphBoxFormatterState
      read GetDashAfterTextState;
    property HyphenationState: TdxParagraphBoxFormatterState
      read GetHyphenationState;
    property NoHyphenationNextState: TdxParagraphBoxFormatterState
      read GetNoHyphenationNextState;
  end;
  ...
  function InternalFinishParagraphCore(ABoxInfo: TdxBoxInfo;
  ...
  function InternalFinishParagraphCore(ABoxInfo: TdxBoxInfo;
    AFinalizeHandler: TFinalizeEvent): TdxCompleteFormattingResult;
  protected
    function CanFitCurrentRowToColumn(ABoxInfo: TdxBoxInfo)
      : TdxCanFitCurrentRowToColumnResult; virtual;
    procedure ApplyParagraphMarkSize(ABoxInfo: TdxBoxInfo); override;
    procedure ApplyLineBreakMarkSize(ABoxInfo: TdxBoxInfo); override;
    procedure ApplyPageBreakMarkSize(ABoxInfo: TdxBoxInfo); override;
  ...
  TdxStateParagraphStartAfterFloatingObject = class sealed
    (TdxStateParagraphStart)
  protected
    function GetType: TdxParagraphBoxFormatterState; override;
  end;
  ...
  TdxStateParagraphStartFromTheMiddleAfterFloatingObject = class sealed
    (TdxStateParagraphStartFromTheMiddle)
  protected
    function GetType: TdxParagraphBoxFormatterState; override;
    function GetStateAfterFloatingObject
  ...
  TdxStateRowWithTextOnlyAfterFirstLeadingTab = class sealed
    (TdxStateRowWithTextOnly)
  protected
    function GetHyphenationState: TdxParagraphBoxFormatterState; override;
    function GetNoHyphenationNextState: TdxParagraphBoxFormatterState; override;
  ...
  TdxStateRowTextHyphenationFirstSyllableAfterFirstLeadingTab = class sealed
    (TdxStateRowTextHyphenationFirstSyllable)
  private
    function CompleteRowProcessing: TdxCompleteFormattingResult;
  protected
  ...
  TdxStateContinueFormattingFromParagraph = class sealed
    (TdxFormatterStartEndState)
  private
  ...
  TdxStateSectionBreakAfterParagraphMark = class sealed
    (TdxFormatterStartEndState)
  protected
    function GetType: TdxParagraphBoxFormatterState; override;
    function FinishParagraph: TdxCompleteFormattingResult; override;
  ...
  public
    ...
    function CalculateSpacingInlineObjectCase(ARowHeight, AMaxDescent,
      ARowTextHeight, ARowTextSpacing, AMaxPictureHeight: Integer)
      : Integer; override;
  end;
  ...
  public
    ...
    function CalculateSpacing(ARowHeight, AMaxAscent, AMaxDescent,
      AMaxPictureHeight: Integer): Integer; override;
    function CalculateSpacingCore(ARowHeight: Integer): Integer; override;
    function CalcRowHeight(AOldRowHeight, ANewBoxHeight: Integer)
      : Integer; override;
    function CalcRowHeightFromInlineObject(AOldRowHeight, AMaxPictureHeight,
      AMaxDescent: Integer): Integer; override;
  ...
  public
    constructor Create(AIterator: TdxParagraphBoxIterator;
      const AHyphenationService: IdxHyphenationService);
    destructor Destroy; override;
    ...
    property HyphenPositions: TdxFormatterPositionCollection
      read FHyphenPositions;
    property HyphenChar: Char read GetHyphenChar;
  end;

  { TdxFloatingObjectsCurrentHorizontalPositionController }

  TdxFloatingObjectsCurrentHorizontalPositionController = class
    (TdxCurrentHorizontalPositionController)
  public type
  ...
  private
    ...
    FMinArea: Integer;
    function AreTextAreasChanged(APrevTextAreas,
      ATextAreas: TList<TdxTextArea>): Boolean;
    function CanFitBoxToTextArea(ATextAreaIndex: Integer;
      const ABoxSize: TSize): Boolean;
    function DoCurrentRowHeightChanged(AHeight: Integer;
      const ACurrentRowBounds: TRect; AKeepTextAreas, AIgnoreFloatingObjects
      : Boolean): Boolean;
    function GetAvailableTextAreaInitialPosition(APreferredTextAreaIndex
      : Integer): TPositionInfo;
    function GetTextOffset(ATextAreaIndex: Integer): Integer;
    function GetInitialPosition(ATextAreaIndex: Integer): Integer; overload;
    function GetInitialPosition(ATextAreaIndex, ATextOffset: Integer)
      : Integer; overload;
    function IsCurrentRowEmpty: Boolean;
    procedure RemoveShortAreas(AAreas: TList<TdxTextArea>; ALeft: Integer;
      ARight: Integer);
    procedure DoSetCurrentHorizontalPosition(const APosition: TPositionInfo);
    function UpdateCurrentTextAreaIndex: Boolean;
  protected
    procedure OnCurrentRowHeightChanged(AKeepTextAreas: Boolean);
      overload; override;
    ...
    procedure AppendRowBoxRange(ABoxRanges: TdxRowBoxRangeCollection;
  ...
  public
    ...
    function CalculateTextAreas(AParagraphFrameItems: TdxParagraphFrameBoxList;
      AFloatingObjectItems: TdxFloatingObjectBoxList; const ABounds: TRect)
      : TList<TdxTextArea>;
  ...
  TdxRowSpacingParametersCalculator = class
    (TdxRowSpacingParametersCalculatorBase)
  public
  ...
  TdxMultipleSpacingParametersCalculator = class
    (TdxRowSpacingParametersCalculator)
  strict private
  ...
  public
    constructor Create(AFormatter: TdxParagraphFinalFormatter;
      AParameterCount: Integer; AMultiplier: Single);
    destructor Destroy; override;
    procedure ProcessBox(ABox: TdxBox; ABoxIndex: Integer); override;
    function CalculateRowBaseLineOffset(ARow: TdxRow): Integer; override;
  end;
  ...
  TdxExactlyRowSpacingParametersCalculator = class
    (TdxRowSpacingParametersCalculatorBase)
  private
    FBaseLineOffset: Integer;
  public
    constructor Create(AFormatter: TdxParagraphFinalFormatter;
      AParameterCount, ABaseLineOffset: Integer);
    procedure ProcessBox(ABox: TdxBox; ABoxIndex: Integer); override;
    function CalculateRowBaseLineOffset(ARow: TdxRow): Integer; override;
  end;
  ...
  TdxAtLeastRowSpacingParametersCalculator = class
    (TdxRowSpacingParametersCalculatorBase)
  private
    FMaxPictureHeight: Integer;
...
function TdxTableViewInfoHelper.GetAssociatedFloatingObjectsLayout
  : TdxFloatingObjectsLayout;
begin
  Result := TdxFloatingObjectsLayout(FAssociatedFloatingObjectsLayout);
end;

procedure TdxTableViewInfoHelper.SetAssociatedFloatingObjectsLayout
  (const Value: TdxFloatingObjectsLayout);
begin
...
procedure TdxStateRowTabBase.ChangeStateManuallyIfNeeded(AIteratorResult
  : TdxParagraphIteratorResult);
begin
  SwitchToNextState;
end;

function TdxStateRowTabBase.ColumnOverfull
  (ACanFit: TdxCanFitCurrentRowToColumnResult; ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(False);
...
begin
  Result := CurrentTab.GetLayoutPosition
    (Formatter.DocumentModel.ToDocumentLayoutUnitConverter);
end;
...
begin
  ...
  else if not RowsController.SuppressHorizontalOverfull and
    RowsController.IsPositionOutsideRightParagraphBound
    (CurrentTabPosition + RowsController.CurrentColumn.Bounds.Left) then
    Result := TdxAddBoxResult.HorizontalIntersect
  else
    Result := TdxAddBoxResult.Success;
end;

function TdxStateRowTab.FinishColumn(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Result := FinalizeColumn(ABoxInfo);
end;

function TdxStateRowTab.FinishLine(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
...
function TdxStateRowTab.FinishPage(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
...
function TdxStateRowTab.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowTabAfterFloatingObject;
end;

function TdxStateRowTab.HorizontalOverfull(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
...
begin
  case Iterator.CurrentChar of
    TdxCharacters.Space, TdxCharacters.EmSpace, TdxCharacters.EnSpace:
    ...
    TdxCharacters.PageBreak:
      if RowsController.TablesController.IsInsideTable then
        ANextState := TdxParagraphBoxFormatterState.RowSpaces
      else if not RowsController.SupportsColumnAndPageBreaks then
        ANextState := TdxParagraphBoxFormatterState.RowLineBreak
      else
...
function TdxFormatterStateBase.ContinueFormatByCharacter
  (var ABoxInfo: TdxBoxInfo; ALayoutDependentTextBox: TdxLayoutDependentTextBox)
...
begin
  ...
  repeat
    ...
    Assert((ALayoutDependentTextBox = nil) or
      (ABoxInfo.IteratorResult <> TdxParagraphIteratorResult.Success));
...
function TdxCharacterFormatterFinalState.AppendBox(var ABoxInfo: TdxBoxInfo)
  : TdxStateContinueFormatResult;
begin
  Assert(False);
...
procedure TdxCharacterFormatterFinalState.MeasureBoxContent
  (ABoxInfo: TdxBoxInfo);
begin
  Assert(False);
end;
...
constructor TdxBoxFormatterStateBase.Create(AFormatter
  : TdxParagraphBoxFormatter);
begin
  inherited Create;
...
function TdxBoxFormatterStateBase.AddExistedBox(ABoxInfo: TdxBoxInfo;
  AIterator: TdxParagraphBoxIterator): TdxStateContinueFormatResult;
begin
...
begin
  ...
  ANumberingListBox := TdxParagraphBoxCollection
    (Iterator.Paragraph.BoxCollection).NumberingListBox;
  AIndex := Iterator.Paragraph.GetNumberingListIndex;
  AListLevelIndex := Iterator.Paragraph.GetListLevelIndex;
  AListLevel := Iterator.Paragraph.DocumentModel.NumberingLists[AIndex].Levels
    [AListLevelIndex];
  ...
  try
    ...
    RowsController.AddNumberingListBox(ANumberingListBox,
      AListLevel.ListLevelProperties, Formatter);
  finally
    FreeAndNil(ABoxInfo);
  end;
end;
...
begin
  ...
  begin
    ...
    RowsController.UpdateCurrentRowHeightFromInlineObjectRun(ARun, ABox,
      Formatter.Measurer);
  end
  else
  begin
    ...
    begin
      ...
      if ALayoutDependentTextRun is TdxFootNoteRun then
        RowsController.CurrentRow.ProcessingFlags :=
          RowsController.CurrentRow.ProcessingFlags +
          [TdxRowProcessingFlag.ContainsFootNotes];
      if ALayoutDependentTextRun is TdxEndNoteRun then
        RowsController.CurrentRow.ProcessingFlags :=
          RowsController.CurrentRow.ProcessingFlags +
          [TdxRowProcessingFlag.ContainsEndNotes];
    end;
    RowsController.UpdateCurrentRowHeight(ABoxInfo);
  end;
end;

function TdxBoxFormatterStateBase.AdjustEndPositionToFit(ABoxInfo: TdxBoxInfo)
  : TdxAdjustEndPositionResult;
const
...
begin
  ...
  AOffset := 0;
  if ABoxInfo.EndPos.Offset - ABoxInfo.StartPos.Offset >= SplitTextBinarySearchBounds
  then
  begin
  ...
  begin
    ABoxInfo.EndPos := TdxFormatterPosition.Create(ABoxInfo.EndPos.RunIndex,
      ABoxInfo.StartPos.Offset, ABoxInfo.EndPos.BoxIndex);
  ...
  begin
    ABoxInfo.EndPos := TdxFormatterPosition.Create(ABoxInfo.EndPos.RunIndex,
      AOffset, ABoxInfo.EndPos.BoxIndex);
...
function TdxBoxFormatterStateBase.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
  Result := &Type;
end;

function TdxBoxFormatterStateBase.AppendBox(var ABoxInfo: TdxBoxInfo)
  : TdxStateContinueFormatResult;
var
...
procedure TdxBoxFormatterStateBase.ApplyColumnBreakMarkSize
  (ABoxInfo: TdxBoxInfo);
begin
...
function TdxBoxFormatterStateBase.BinarySearchFittedBox
  (ABoxInfo: TdxBoxInfo): Integer;
begin
  Result := BinarySearchFittedBox(ABoxInfo, ABoxInfo.StartPos.Offset,
    ABoxInfo.EndPos.Offset);
end;

function TdxBoxFormatterStateBase.BinarySearchFittedBox(ABoxInfo: TdxBoxInfo;
  ALow, AHi: Integer): Integer;
var
...
function TdxBoxFormatterStateBase.CalcBoxSizeWithHyphen
  (ABoxInfo: TdxBoxInfo): TSize;
begin
  Result := ABoxInfo.Size;
  Result.cx := Result.cx + Formatter.Measurer.MeasureHyphen
    (ABoxInfo.EndPos, nil).cx;
end;
...
begin
  ARun := TdxLayoutDependentTextRun(Formatter.PieceTable.Runs
    [ALayoutDependentTextBox.StartPos.RunIndex]);
  ALayoutDependentTextBox.CalculatedText := ARun.FieldResultFormatting.GetValue
    (Formatter, Formatter.DocumentModel);
  MeasureBoxContent(ABoxInfo);
end;

function TdxBoxFormatterStateBase.CanAddBoxCore(ABoxInfo: TdxBoxInfo)
  : TdxAddBoxResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
  ...
  begin
    ...
    else if ACanFit = TdxCanFitCurrentRowToColumnResult.RestartDueFloatingObject
    then
...
function TdxBoxFormatterStateBase.CanAddBoxWithHyphenCore(ABoxInfo: TdxBoxInfo)
  : TdxAddBoxResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
  ABoxSize: TSize;
...
class function TdxBoxFormatterStateBase.GetContinueFormatResult
  (AResult: TdxCompleteFormattingResult): TdxStateContinueFormatResult;
begin
...
function TdxBoxFormatterStateBase.CanAddBoxWithoutHyphen(ABoxInfo: TdxBoxInfo)
  : TdxAddBoxResult;
begin
...
begin
  ...
  Result := (ACh <> TdxCharacters.PageBreak) and
    (ACh <> TdxCharacters.ColumnBreak);
end;

procedure TdxBoxFormatterStateBase.ChangeState
  (AStateType: TdxParagraphBoxFormatterState);
begin
    ...
    begin
      ...
      begin
        if AIterator.IsParagraphFrame and (Self is TdxStateFloatingObject) then
          Exit(TdxStateContinueFormatResult.Success);
        if (FFormatter.SyllableIterator = nil) or FFormatter.SyllableIterator.IsEnd
        then
          Exit(GetContinueFormatResult(FinishParagraphOrSection));
      end;
      Exit(TdxStateContinueFormatResult.Success);
    end;
    Result := ContinueFormatByCharacter(ABoxInfo,
      Safe<TdxLayoutDependentTextBox>.Cast(AIterator.CurrentBox))
  finally
    ABoxInfo.Free;
  end;
end;
...
function TdxBoxFormatterStateBase.DispatchAddBoxResult(ABoxInfo: TdxBoxInfo;
  AResult: TdxAddBoxResult): TdxStateContinueFormatResult;
begin
  case AResult of
    ...
    TdxAddBoxResult.LeaveColumnFirstCellRow, TdxAddBoxResult.LeaveColumnPlain:
      Exit(GetContinueFormatResult(ColumnOverfull(GetCanFitCurrentRowToColumn
        (AResult), ABoxInfo)));
    TdxAddBoxResult.IntersectWithFloatObject:
      Exit(GetContinueFormatResult(Formatter.RollbackToStartOfRow
        (TdxCanFitCurrentRowToColumnResult.TextAreasRecreated)));
...
begin
  ...
  if (ACurrentBottom >= Formatter.MaxHeight) and
    not Iterator.Paragraph.IsInCell and
    (Iterator.Paragraph.FrameProperties = nil) or Formatter.RowsController.ForceFormattingComplete
  then
    ForceFormattingComplete := True;
end;

function TdxBoxFormatterStateBase.FinalizeColumn(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  if not Formatter.Iterator.Paragraph.IsInCell and RowsController.SupportsColumnAndPageBreaks
  then
  begin
...
function TdxBoxFormatterStateBase.FinalizePage(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
...
function TdxBoxFormatterStateBase.FinishColumn(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Result := FinalizeColumn(ABoxInfo);
end;

function TdxBoxFormatterStateBase.FinishLine(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  FinalizeLine(ABoxInfo);
  Result := TdxCompleteFormattingResult.Success;
...
function TdxBoxFormatterStateBase.FinishPage(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Result := FinalizePage(ABoxInfo);
end;
...
procedure TdxBoxFormatterStateBase.FinishParagraphCore
  (AIterator: TdxParagraphIteratorBase);
begin
  if AIterator.IsEnd then
    if (FFormatter.SyllableIterator = nil) or FFormatter.SyllableIterator.IsEnd
...
function TdxBoxFormatterStateBase.FinishParagraphOrSection
  : TdxCompleteFormattingResult;
begin
...
begin
  ...
  else if ALayoutDependentTextBox <> nil then
    CalculateAndMeasureLayoutDependentTextBox(ALayoutDependentTextBox, ABoxInfo)
  else
    MeasureBoxContent(ABoxInfo);
end;

function TdxBoxFormatterStateBase.MaxTextLengthExceeded
  (ABox: TdxBoxInfo): Boolean;
begin
  Result := Iterator.Offset - ABox.StartPos.Offset > MaxTextLength;
end;

function TdxBoxFormatterStateBase.ObtainAddBoxResult(ABoxInfo: TdxBoxInfo)
  : TdxAddBoxResult;
begin
...
procedure TdxBoxFormatterStateBase.SetForceFormattingComplete
  (const Value: Boolean);
begin
  Formatter.ForceFormattingComplete := Value;
end;

function TdxBoxFormatterStateBase.SplitBox(ABoxInfo: TdxBoxInfo)
  : TdxSplitBoxResult;
var
...
constructor TdxParagraphBoxFormatterTableStateBase.Create
  (AFormatter: TdxParagraphBoxFormatter);
begin
  inherited Create;
  Assert(AFormatter <> nil);
...
constructor TdxParagraphIteratorBase.Create(AParagraph: TdxParagraph;
  APieceTable: TdxPieceTable; AVisibleTextFilter: TdxVisibleTextFilterBase);
begin
  inherited Create;
  ...
  FEndRunIndex := AVisibleTextFilter.FindVisibleParagraphRunForward
    (AParagraph.LastRunIndex);
  FPosition := CreatePosition;
  SetRunIndexCore(AVisibleTextFilter.FindVisibleRunForward
    (AParagraph.FirstRunIndex));
end;
...
function TdxParagraphIteratorBase.GetPreviousOffsetPosition
...
function TdxParagraphIteratorBase.GetPreviousVisibleRunPosition
  : TdxFormatterPosition;
var
...
var
  Var1: TdxMergedFrameProperties;
begin
  Var1 := PieceTable.Runs[RunIndex]
    .Paragraph.GetMergedFrameProperties;
  try
    Result := (Var1 <> nil) and
      Var1.IsParagraphFrame;
  finally
    Var1.Free;
  end;
end;
...
procedure TdxParagraphIteratorBase.SetPosition
  (const APos: TdxFormatterPosition);
begin
...
procedure TdxParagraphIteratorBase.SetPosition(ARunIndex: TdxRunIndex;
  AOffset: Integer);
begin
...
procedure TdxParagraphIteratorBase.SetPositionCore
  (const APos: TdxFormatterPosition);
begin
  SetRunIndexCore(APos.RunIndex);
  FPosition.Offset := APos.Offset;
...
constructor TdxParagraphCharacterFormatter.Create(APieceTable: TdxPieceTable;
...
function TdxParagraphCharacterFormatter.GetIterator
  : TdxParagraphCharacterIterator;
begin
...
const
  StateClasses: array [TdxCharacterFormatterState]
    of TdxCharacterFormatterStateBaseClass = (TdxCharacterFormatterStartState,
    TdxCharacterFormatterSpacesState, TdxCharacterFormatterTabState,
    TdxCharacterFormatterFirstDashState, TdxCharacterFormatterDashState,
    TdxCharacterFormatterSeparatorState, TdxCharacterFormatterLineBreak,
    TdxCharacterFormatterPageBreak, TdxCharacterFormatterColumnBreak,
    TdxCharacterFormatterTextState, TdxCharacterFormatterInlineObjectState,
    TdxCharacterFormatterLayoutDependentTextState,
    TdxCharacterFormatterFloatingObjectState, TdxCharacterFormatterFinalState);
var
  I: TdxCharacterFormatterState;
begin
  for I := Low(TdxCharacterFormatterState)
    to High(TdxCharacterFormatterState) do
...
procedure TdxParagraphCharacterFormatter.FormatParagraph
  (AIterator: TdxParagraphIteratorBase);
begin
  FIterator := AIterator;
...
procedure TdxParagraphCharacterFormatter.AddTextBoxToQueue(ABox: TdxBox;
  ABoxInfo: TdxBoxInfo);
begin
...
procedure TdxParagraphCharacterFormatter.BeginParagraph
  (ABeginFromParagraphStart, AParagraphFrameStarted: Boolean);
var
...
procedure TdxParagraphCharacterFormatter.ChangeState
  (AStateType: TdxCharacterFormatterState);
begin

  State := FStates[AStateType];
end;

function TdxParagraphCharacterFormatter.CreateNumberingListBox
  (ASeparatorChar: Char; const APosition: TdxFormatterPosition)
  : TdxNumberingListBox;
begin
  ...
  begin
    ...
    TdxNumberingListBoxWithSeparator(Result).SeparatorBox :=
      CreateSeparatorBox(ASeparatorChar, APosition);
  end;
end;

function TdxParagraphCharacterFormatter.CreateSeparatorBox(ASeparator: Char;
  const APosition: TdxFormatterPosition): TdxBox;
var
  ABoxInfo: TdxBoxInfo;
begin
...
procedure TdxParagraphCharacterFormatter.Format
  (AIterator: TdxParagraphCharacterIterator);
begin
...
begin
  ...
  ABoxInfo := TdxNumberingListBoxInfo.Create;
  try
    ANumberingList := DocumentModel.NumberingLists
      [AParagraph.GetNumberingListIndex];
    APosition.Init(AParagraph.FirstRunIndex, 0, 0);
    ABoxInfo.StartPos := APosition;
    ABoxInfo.EndPos := APosition;
    ANumberingListText := AParagraph.GetNumberingListText;
    Measurer.MeasureText(ABoxInfo, ANumberingListText,
      AParagraph.GetNumerationFontInfo);

    AListLevelIndex := AParagraph.GetListLevelIndex;
    AListLevel := ANumberingList.Levels[AListLevelIndex];

    ANumberingListBox := CreateNumberingListBox
      (AListLevel.ListLevelProperties.Separator, APosition);
    ...
    TdxParagraphBoxCollection(AParagraph.BoxCollection).NumberingListBox :=
      ANumberingListBox;
  finally
    FreeAndNil(ABoxInfo);
  end;
...
function TdxParagraphCharacterFormatter.GetInitialStateType
  (ABeginFromParagraphStart: Boolean): TdxCharacterFormatterState;
begin
...
constructor TdxCurrentHorizontalPositionController.Create(ARowsController
  : TdxRowsController; APosition: Integer);
begin
  inherited Create;
...
function TdxCurrentHorizontalPositionController.CalculateBoxBounds
  (ABoxInfo: TdxBoxInfo): TRect;
begin
  Result.InitSize(CurrentHorizontalPosition, 0, ABoxInfo.Size);
end;

function TdxCurrentHorizontalPositionController.
  CalculateFloatingObjectColumnBounds(ACurrentColumn: TdxColumn): TRect;
begin
  Result := ACurrentColumn.Bounds;
end;

function TdxCurrentHorizontalPositionController.CanFitBoxToCurrentRow
  (const ABoxSize: TSize): Boolean;
begin
  Result := (CurrentHorizontalPosition + ABoxSize.cx <=
    FRowsController.CurrentRow.Bounds.Right) or
...
begin
  Result := RowsController.TablesController.CanFitRowToColumn
    (RowsController.CurrentRow.Bounds.Top + ANewRowHeight,
    RowsController.CurrentColumn);
end;

function TdxCurrentHorizontalPositionController.
  CanFitNumberingListBoxToCurrentRow(const ABoxSize: TSize): Boolean;
begin
  Result := True;
end;
...
begin
  if FRowsController.SuppressHorizontalOverfull then
    ...
    Result := Max(1, FRowsController.CurrentRow.Bounds.Right -
      CurrentHorizontalPosition);
end;

function TdxCurrentHorizontalPositionController.GetTextAreaForTable
  : TdxTextArea;
var
  ABounds: TRect;
begin
...
procedure TdxCurrentHorizontalPositionController.
  IncrementCurrentHorizontalPosition(ADelta: Integer);
begin
  FCurrentHorizontalPosition := FCurrentHorizontalPosition + ADelta;
end;

function TdxCurrentHorizontalPositionController.MoveCurrentRowDownToFitTable
  (ATableWidth, ATableTop: Integer): Integer;
begin
  Result := ATableTop;
end;
...
procedure TdxCurrentHorizontalPositionController.OnCurrentRowHeightChanged
  (AKeepTextAreas: Boolean);
begin
end;

procedure TdxCurrentHorizontalPositionController.
  RollbackCurrentHorizontalPositionTo(AValue: Integer);
begin
  Assert(AValue <= FCurrentHorizontalPosition);
  FCurrentHorizontalPosition := AValue;
end;

procedure TdxCurrentHorizontalPositionController.SetCurrentHorizontalPosition
  (AValue: Integer);
begin
  FCurrentHorizontalPosition := AValue;
end;
...
procedure TdxCurrentHorizontalPositionController.
  SetCurrentRowInitialHorizontalPosition;
begin
  FCurrentHorizontalPosition := FRowsController.ParagraphLeft +
    FRowsController.CurrentRowIndent;
end;
...
procedure TdxCharacterFormatterSpacesState.MeasureBoxContent
  (ABoxInfo: TdxBoxInfo);
begin
...
constructor TdxRowsController.Create(APieceTable: TdxPieceTable;
  const AColumnController: TdxCustomColumnController;
  AMatchHorizontalTableIndentsToTextEdge: Boolean);
begin
  inherited Create;
  ...
  FFloatingObjectsLayout := AColumnController.PageAreaController.PageController.
    FloatingObjectsLayout;
  Assert(FFloatingObjectsLayout <> nil);
  FParagraphFramesLayout := AColumnController.PageAreaController.PageController.
    ParagraphFramesLayout;
  ...
  FMatchHorizontalTableIndentsToTextEdge :=
    AMatchHorizontalTableIndentsToTextEdge;
  FFrameParagraphIndex := -1;
  FLastRestartDueToFloatingObjectModelPosition :=
    TdxDocumentModelPosition.Create(APieceTable);
end;
...
function TdxRowsController.CanFitCurrentRowToColumnCore(ANewRowHeight: Integer)
  : TdxCanFitCurrentRowToColumnResult;
begin
  Result := HorizontalPositionController.CanFitCurrentRowToColumn
    (ANewRowHeight);
end;

function TdxRowsController.CanFitNumberingListBoxToCurrentRow
  (const ABoxSize: TSize): Boolean;
begin
  Result := HorizontalPositionController.CanFitNumberingListBoxToCurrentRow
    (ABoxSize);
end;

function TdxRowsController.AddBox(ABoxType: TdxBoxClass;
  ABoxInfo: TdxBoxInfo): TdxBox;
var
  ARunIndex: TdxRunIndex;
  ARun: TdxTextRunBase;
begin
  ...
  HorizontalPositionController.IncrementCurrentHorizontalPosition
    (ABoxInfo.Size.cx);
  ARunIndex := ABoxInfo.StartPos.RunIndex;
  ARun := PieceTable.Runs[ARunIndex];
  CurrentRow.ProcessingFlags := CurrentRow.ProcessingFlags +
    ARun.RowProcessingFlags;
end;

function TdxRowsController.AddFloatingObjectToLayout(AFloatingObjectAnchorBox
  : TdxFloatingObjectAnchorBox; ABoxInfo: TdxBoxInfo): Boolean;
var
...
begin
  ...
  if AObjectAnchorRun.ExcludeFromLayout then
    Exit(False);
  Assert((ABoxInfo.Box is TdxFloatingObjectAnchorBox) and
    (ABoxInfo.Box = AFloatingObjectAnchorBox));

  if FloatingObjectsLayout.ContainsRun(AObjectAnchorRun) then
  begin
    AFloatingObjectBox := FloatingObjectsLayout.GetFloatingObject
      (AObjectAnchorRun);
    if AObjectAnchorRun.FloatingObjectProperties.TextWrapType <>
      TdxFloatingObjectTextWrapType.None then
      AFloatingObjectBox.LockPosition := True;

    EnsureFloatingObjectBoxActualBounds(AFloatingObjectAnchorBox,
      AObjectAnchorRun, AFloatingObjectBox);
    Result := False;
  end
  else
  begin
    ...
    begin
      Assert(False);
      AFloatingObjectBox := CreateFloatingObjectBox(AFloatingObjectAnchorBox,
        AObjectAnchorRun);
    end
    else
      EnsureFloatingObjectBoxActualBounds(AFloatingObjectAnchorBox,
...
procedure TdxRowsController.EnsureFloatingObjectBoxActualBounds
  (AFloatingObjectAnchorBox: TdxFloatingObjectAnchorBox;
  AObjectAnchorRun: TdxFloatingObjectAnchorRun;
  AFloatingObjectBox: TdxFloatingObjectBox);
begin
  if ShouldChangeExistingFloatingObjectBounds(AFloatingObjectBox,
    AFloatingObjectAnchorBox) then
  begin
    ...
    if AObjectAnchorRun.Content is TdxTextBoxFloatingObjectContent then
      FormatFloatingObjectTextBox(AFloatingObjectBox,
        Safe<TdxTextBoxFloatingObjectContent>.Cast(AObjectAnchorRun.Content),
        AFloatingObjectAnchorBox);
  end;
end;

function TdxRowsController.CreateFloatingObjectBox
  (AAnchorBox: TdxFloatingObjectAnchorBox;
  AObjectAnchorRun: TdxFloatingObjectAnchorRun): TdxFloatingObjectBox;
begin
  Result := TdxFloatingObjectBox.Create;
  Result.StartPos := AAnchorBox.StartPos;
  ApplyFloatingObjectBoxProperties(Result,
    AObjectAnchorRun.FloatingObjectProperties);

  AAnchorBox.SetFloatingObjectRun(AObjectAnchorRun);
  ApplyFloatingObjectBoxBounds(Result, AAnchorBox);

  if AObjectAnchorRun.Content is TdxTextBoxFloatingObjectContent then
    FormatFloatingObjectTextBox(Result,
      Safe<TdxTextBoxFloatingObjectContent>.Cast(AObjectAnchorRun.Content),
      AAnchorBox);
end;

procedure TdxRowsController.AddNumberingListBox(ABox: TdxNumberingListBox;
  AProperties: TdxListLevelProperties; AFormatter: TdxParagraphBoxFormatter);
var
  ABounds: TRect;
begin
...
function TdxRowsController.CanFitCurrentRowWithFrameToColumn
  (ANewBoxInfo: TdxBoxInfo): TdxCanFitCurrentRowToColumnResult;
var
...
begin
  ...
  if (ANewBoxInfo.StartPos.RunIndex > ColumnController.PageLastRunIndex) and not AEmptyColumn
  then
...
begin
  ...
  Result := Max(FMaxAscentAndFree, AAscentAndFree) +
    Max(FMaxDescent, GetFontDescent(ABoxInfo));
end;
...
begin
  ASpacingBefore := DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits
    (FParagraph.ContextualSpacingBefore);
...
function TdxRowsController.CompleteCurrentColumnFormatting
  : TdxCompleteFormattingResult;
begin
  Result := ColumnController.CompleteCurrentColumnFormatting(CurrentColumn);
end;

function TdxRowsController.CreateCurrentHorizontalPosition
  : TdxCurrentHorizontalPositionController;
begin
  Result := TdxCurrentHorizontalPositionController.Create(Self);
end;

function TdxRowsController.CreateCurrentHorizontalPosition(APosition: Integer)
  : TdxCurrentHorizontalPositionController;
begin
  Result := TdxCurrentHorizontalPositionController.Create(Self, APosition);
end;

function TdxRowsController.GetContextualSpacingAfter
  (AParagraph: TdxParagraph): Integer;
begin
  Result := DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits
    (AParagraph.ContextualSpacingAfter);
end;

class function TdxRowsController.GetBounds(const ALocation: TPoint;
  AWidth: Integer; AHeight: Integer): TRect;
begin
  Result.InitSize(ALocation, AWidth, AHeight);
end;

class procedure TdxRowsController.SetActualBoundsForEmptyHeightFrameBox
  (AParagraphFrameBox: TdxParagraphFrameBox; AElementBoundsHeight: Integer);
begin
  AParagraphFrameBox.Bounds := GetBounds(AParagraphFrameBox.Bounds.Location,
    AParagraphFrameBox.Bounds.Width, AElementBoundsHeight);
  AParagraphFrameBox.ShapeBounds :=
    GetBounds(AParagraphFrameBox.ShapeBounds.Location,
    AParagraphFrameBox.ShapeBounds.Width, AElementBoundsHeight);
  AParagraphFrameBox.ContentBounds :=
    GetBounds(AParagraphFrameBox.ContentBounds.Location,
    AParagraphFrameBox.ContentBounds.Width, AElementBoundsHeight);
  AParagraphFrameBox.ExtendedBounds :=
    GetBounds(AParagraphFrameBox.ExtendedBounds.Location,
    AParagraphFrameBox.ExtendedBounds.Width, AElementBoundsHeight);
  AParagraphFrameBox.ActualBounds :=
    GetBounds(AParagraphFrameBox.ActualBounds.Location,
    AParagraphFrameBox.ActualBounds.Width, AElementBoundsHeight);
  AParagraphFrameBox.SetActualSizeBounds
    (GetBounds(AParagraphFrameBox.ActualSizeBounds.Location,
    AParagraphFrameBox.ActualSizeBounds.Width, AElementBoundsHeight));
end;

class function TdxRowsController.GetBoundsLocation(const ABounds: TRect;
  APositionOffset: Integer): TPoint;
begin
  Result.Init(ABounds.Location.X - APositionOffset, ABounds.Location.Y);
end;

class procedure TdxRowsController.SetActualBoundsForEmptyWidthFrameBox
  (AParagraphFrameBox: TdxParagraphFrameBox;
  AAlignment: TdxParagraphFrameHorizontalPositionAlignment;
  AElementBoundsWidth: Integer);
var
  APositionOffset, I: Integer;
  ABoundsLocation, AShapeLocation, AContentLocation, AExtendedLocation,
    AActualLocation, AActualSizeLocation, ACurrentBoxLocation: TPoint;
  ACurrentBox: TdxBox;
  ABoxCollection: TdxSimpleParagraphBoxCollection;
begin
  if AAlignment in [TdxParagraphFrameHorizontalPositionAlignment.Right,
    TdxParagraphFrameHorizontalPositionAlignment.Outside] then
    APositionOffset := AElementBoundsWidth
  else if AAlignment = TdxParagraphFrameHorizontalPositionAlignment.Center then
    APositionOffset := AElementBoundsWidth div 2
  else
    APositionOffset := 0;

  ABoundsLocation := GetBoundsLocation(AParagraphFrameBox.Bounds,
    APositionOffset);
  AShapeLocation := GetBoundsLocation(AParagraphFrameBox.ShapeBounds,
    APositionOffset);
  AContentLocation := GetBoundsLocation(AParagraphFrameBox.ContentBounds,
    APositionOffset);
  AExtendedLocation := GetBoundsLocation(AParagraphFrameBox.ExtendedBounds,
    APositionOffset);
  AActualLocation := GetBoundsLocation(AParagraphFrameBox.ActualBounds,
    APositionOffset);
  AActualSizeLocation := GetBoundsLocation(AParagraphFrameBox.ActualSizeBounds,
    APositionOffset);

  AParagraphFrameBox.Bounds := GetBounds(ABoundsLocation, AElementBoundsWidth,
    AParagraphFrameBox.Bounds.Height);
  AParagraphFrameBox.ShapeBounds := GetBounds(AShapeLocation,
    AElementBoundsWidth, AParagraphFrameBox.ShapeBounds.Height);
  AParagraphFrameBox.ContentBounds := GetBounds(AContentLocation,
    AElementBoundsWidth, AParagraphFrameBox.ContentBounds.Height);
  AParagraphFrameBox.ExtendedBounds := GetBounds(AExtendedLocation,
    AElementBoundsWidth, AParagraphFrameBox.ExtendedBounds.Height);
  AParagraphFrameBox.ActualBounds := GetBounds(AActualLocation,
    AElementBoundsWidth, AParagraphFrameBox.ActualBounds.Height);
  AParagraphFrameBox.SetActualSizeBounds(GetBounds(AActualSizeLocation,
    AElementBoundsWidth, AParagraphFrameBox.ActualSizeBounds.Height));
  ...
  begin
    ...
    ACurrentBoxLocation := GetBoundsLocation(ACurrentBox.Bounds,
      APositionOffset);
    ACurrentBox.Bounds := TRect.CreateSize(ACurrentBoxLocation,
      ACurrentBox.Bounds.Size);
  end;
end;

procedure TdxRowsController.AddSectionBreakBoxToPrevRow(ABoxType: TdxBoxClass;
  ABoxInfo: TdxBoxInfo);
var
  ABox: TdxBox;
  ALastRow: TdxRow;
begin
  ...
  ABox.Bounds := TRect.CreateSize
    (TPoint.Create(ALastRow.Boxes.Last.Bounds.Right, 0), ABoxInfo.Size);
...
procedure TdxRowsController.AddTabBox(const ATab: TdxTabInfo;
  ABoxInfo: TdxBoxInfo);
var
  ABox: TdxTabSpaceBox;
...
begin
  ...
  begin
    ATabPosition := ATab.GetLayoutPosition
      (DocumentModel.ToDocumentLayoutUnitConverter);
    ANewPosition := ATabPosition + CurrentColumn.Bounds.Left;
    ABoxInfo.Size := cxSize(ANewPosition - CurrentHorizontalPosition,
      ABoxInfo.Size.cy);
  end
  else
...
begin
  ...
  FParagraphLeft := ABounds.Left + AUnitConverter.ToLayoutUnits
    (FParagraph.LeftIndent);
  FParagraphRight := ABounds.Right - AUnitConverter.ToLayoutUnits
    (FParagraph.RightIndent);
...
procedure TdxRowsController.ApplyFloatingObjectBoxBounds(AFloatingObjectBox
  : TdxFloatingObjectBox; AAnchorBox: TdxFloatingObjectAnchorBox);
begin
...
procedure TdxRowsController.ApplyFloatingObjectBoxProperties(AFloatingObjectBox
  : TdxFloatingObjectBox; AFloatingObjectProperties
  : TdxFloatingObjectProperties);
begin
  AFloatingObjectBox.CanPutTextAtLeft :=
    AFloatingObjectProperties.CanPutTextAtLeft;
  AFloatingObjectBox.CanPutTextAtRight :=
    AFloatingObjectProperties.CanPutTextAtRight;
  AFloatingObjectBox.PutTextAtLargestSide :=
    AFloatingObjectProperties.PutTextAtLargestSide;
  AFloatingObjectBox.PieceTable :=
    TdxPieceTable(AFloatingObjectProperties.PieceTable);
end;
...
begin
  case ASection.GeneralSettings.StartType of
    ...
    TdxSectionStartType.EvenPage, TdxSectionStartType.OddPage,
  ...
  else if ARestart = TdxLineNumberingRestart.NewPage then
  begin
    InitialLineNumber := ASection.LineNumbering.StartingLineNumber;
    LineNumberStep := ASection.LineNumbering.Step;
  end;
...
begin
  if not FParagraph.SuppressLineNumbers and
    not TablesController.IsInsideTable and ((LineNumber mod LineNumberStep) = 0)
  then
...
procedure TdxRowsController.BeginParagraph(AParagraph: TdxParagraph;
  ABeginFromParagraphStart, AParagraphFrameStarted: Boolean);
var
  ASpacingBefore: Integer;
begin
  ...
  PrepareCurrentRowBounds(AParagraph, ABeginFromParagraphStart);
  // call before FloatingObjectsCurrentHorizontalPositionController. MoveCurrentRowDownToFitTable

  ASpacingBefore := CalculateSpacingBefore;
  FInvisibleEmptyParagraphInCellAfterNestedTable :=
    ShouldIgnoreParagraphHeight(AParagraph);
  if FInvisibleEmptyParagraphInCellAfterNestedTable then
  begin
    CurrentRow.ProcessingFlags := CurrentRow.ProcessingFlags +
      [TdxRowProcessingFlag.LastInvisibleEmptyCellRowAfterNestedTable];
    CurrentRow.Height := 0;
    ASpacingBefore := 0;
  end;

  CurrentRow.ProcessingFlags := CurrentRow.ProcessingFlags +
    [TdxRowProcessingFlag.FirstParagraphRow];
...
function TdxRowsController.ShouldApplySpacingBefore
  (AParagraph: TdxParagraph): Boolean;
begin
...
begin
  Result.Init(ParagraphLeft + FCurrentRowIndent, Y, FParagraphRight,
    Y + DefaultRowHeight);
end;

function TdxRowsController.CalcNewCurrentRowHeight
  (ANewBoxInfo: TdxBoxInfo): Integer;
begin
  Result := FLineSpacingCalculator.CalcRowHeight(CurrentRow.Height,
    CalcRowHeightWithBox(ANewBoxInfo));
end;

function TdxRowsController.CalcPrevBottom(APrevRow: TdxRow;
  AAfterRestart: Boolean; ANewRow: TdxRow): Integer;
var
...
begin
  ...
  begin
    ...
    if not(ANewRow is TdxTableCellRow) or
      (TdxTableCellRow(ANewRow).CellViewInfo.Cell.Table <>
      ATableCellRow.CellViewInfo.Cell.Table) then
      Result := ATableCellRow.CellViewInfo.TableViewInfo.GetTableBottom;
  end;
end;

function TdxRowsController.CalculateNumberingListBoxBounds
  (ABox: TdxNumberingListBox; AProperties: TdxListLevelProperties;
  AFormatter: TdxParagraphBoxFormatter): TRect;
var
...
begin
  ...
  AInitialControllerLeft := HorizontalPositionController.
    CurrentHorizontalPosition;
  AController := Safe<TdxFloatingObjectsCurrentHorizontalPositionController>.
    Cast(HorizontalPositionController);
  if (AController <> nil) and
    (ParagraphLeft + FCurrentRowIndent < AInitialControllerLeft) then
  begin
    ADelta := ParagraphLeft + FCurrentRowIndent - CurrentColumn.Bounds.Left;
    HorizontalPositionController.SetCurrentHorizontalPosition
      (AInitialControllerLeft + ADelta);
  end;
  ...
  begin
    ...
    Result := CalculateNumberingListBoxBoundsCore(ABox, AProperties,
      AFormatter);
    if CanFitNumberingListBoxToCurrentRow(Result.Size) then
      Break;
  end;
...
function TdxRowsController.CalculateNumberingListBoxBoundsCore
  (ABox: TdxNumberingListBox; AProperties: TdxListLevelProperties;
  AFormatter: TdxParagraphBoxFormatter): TRect;
var
...
begin
  ...
  ANumberingListBoxLeft := CalculateNumberingListBoxLeft(Result.Width,
    AAlignment);
  ...
  begin
    ...
    begin
      ...
      if AProperties.Legacy then
        ASeparatorWidth := GetLegacyNumberingListBoxSeparatorWidth
          (ABoxWithSeparator, Result, AProperties, AFormatter)
      else
        ASeparatorWidth := GetNumberingListBoxSeparatorWidth(ABoxWithSeparator,
          Result, AProperties, AFormatter);
...
begin
  ...
  if (ABounds.Left >= ACurrentPosition.X) and (ABounds.Top >= ACurrentPosition.Y)
  then
  ...
  begin
    if FloatingObjectsLayout.ContainsRun
      (AFloatingObjectAnchorBox.GetFloatingObjectRun(PieceTable)) then
      Exit(TdxDocumentModelPosition.Null);
    if CurrentRow.IsFirstParagraphRow then
      Exit(TdxDocumentModelPosition.FromParagraphStart(PieceTable,
        Paragraph.Index));
    if CurrentRow.Boxes.Count > 0 then
  ...
  AHitTestResult := TdxRichEditHitTestResult.Create
    (APageController.DocumentLayout, PieceTable);
  try
    AHitTestResult.Page := ACurrentPage;
    AHitTestResult.IncreaseDetailsLevel(TdxDocumentLayoutDetailsLevel.Page);
    ACalculator := APageController.CreateHitTestCalculator(AHitTestRequest,
      AHitTestResult);
    try
      ...
      begin
        AHitTestResult.PageArea := ColumnController.PageAreaController.
          Areas.Last;
        AHitTestResult.Column :=
          ATableCellColumnController.CurrentTopLevelColumn;
        AHitTestResult.IncreaseDetailsLevel
          (TdxDocumentLayoutDetailsLevel.Column);
    ...
    begin
      ...
      if (ABounds.Top > ARowBounds.Bottom) and not ARowBounds.IntersectsWith
        (ABounds) then
        Exit(TdxDocumentModelPosition.Null)
    end;
    ...
    begin
      ...
      begin
        ...
        Exit(TdxDocumentModelPosition.FromParagraphStart(PieceTable,
          ALastTableCell.EndParagraphIndex + 1));
      end;
    end;
...
begin
  ...
  AHitTestRequest := TdxRichEditHitTestRequest.Create(PieceTable);
  AHitTestRequest.LogicalPoint := TPoint.Create(Max(ABounds.Top, ParagraphLeft),
    ABounds.Top);
  AHitTestRequest.IgnoreInvalidAreas := True;
  AHitTestRequest.DetailsLevel := TdxDocumentLayoutDetailsLevel.Row;
  AHitTestRequest.Accuracy := NearestPageArea or NearestColumn or NearestRow or
    ExactTableRow or ExactTableCell;
  ...
  try
    ...
    ACalculator := APageController.CreateHitTestCalculator(AHitTestRequest,
      AHitTestResult);
    try
      ATableCellColumnController := Safe<TdxTableCellColumnController>.Cast
        (ColumnController);
      if ATableCellColumnController <> nil then
      begin
        AHitTestResult.PageArea := ColumnController.PageAreaController.
    ...
    begin
      ...
      begin
        ATable := ACell.Table;
        while (ATable.ParentCell <> nil) and
          (ATable.ParentCell.Table <> ACurrentTable) do
          ATable := ATable.ParentCell.Table;
        ALastTableCell := ATable.Rows.Last.Cells.Last;
        AParagraphIndex := FindVisibleParagraph
          (ALastTableCell.EndParagraphIndex + 1);
...
function TdxRowsController.FindVisibleParagraph(AStart: TdxParagraphIndex)
  : TdxParagraphIndex;
var
  AParagraph: TdxParagraph;
...
begin
  ...
  Result := CalculateRestartPositionDueFloatingObject(AFloatingObjectAnchorBox,
    AFloatingObjectAnchorBox.ActualBounds,
    FloatingObjectsLayout.ContainsRun
    (AFloatingObjectAnchorBox.GetFloatingObjectRun(PieceTable)), APoint);
end;

function TdxRowsController.CalculateRestartPositionDueParagraphFrame
  (AParagraphFrameBox: TdxParagraphFrameBox): TdxDocumentModelPosition;
var
  X, Y: Integer;
begin
  X := CurrentHorizontalPosition;
  Y := CurrentRow.Bounds.Top;
  Result := CalculateRestartPositionDueFloatingObject(AParagraphFrameBox,
    AParagraphFrameBox.ActualBounds, ParagraphFramesLayout.ContainsParagraph
    (AParagraphFrameBox.GetParagraph), TPoint.Create(X, Y));
end;

function TdxRowsController.CanFitBoxToCurrentRow(const ABoxSize: TSize)
  : Boolean;
begin
  Result := HorizontalPositionController.CanFitBoxToCurrentRow(ABoxSize);
end;

function TdxRowsController.CanFitCurrentRowToColumn(ANewBoxInfo: TdxBoxInfo)
  : TdxCanFitCurrentRowToColumnResult;
var
  ABox: TdxBox;
  AEmptyPage: Boolean;
  ...
  AFloatingObjectAnchorBox: TdxFloatingObjectAnchorBox;
begin
  AEmptyPage := ColumnController.PageAreaController.PageController.Pages.
    Last.IsEmpty;
  if (ANewBoxInfo.StartPos.RunIndex > ColumnController.PageLastRunIndex) and not AEmptyPage
  then
    Exit(TdxCanFitCurrentRowToColumnResult.PlainRowNotFitted);
  ...
  AFloatingObjectAnchorBox := Safe<TdxFloatingObjectAnchorBox>.Cast
    (ANewBoxInfo.Box);
  if AFloatingObjectAnchorBox <> nil then
  begin
    AResult := CanFitFloatingObject(AFloatingObjectAnchorBox, ANewBoxInfo,
      AEmptyPage);
    if TdxCanFitFloatingObjectResult.Always = AResult then
      Exit(TdxCanFitCurrentRowToColumnResult.RowFitted)
    else if TdxCanFitFloatingObjectResult.DependsOnTable = AResult then
      Exit(TablesController.CanFitFloatingObjectInTableRow
        (AFloatingObjectAnchorBox.ActualBounds.Bottom, CurrentColumn))
    else
      Exit(TdxCanFitCurrentRowToColumnResult.RestartDueFloatingObject);
  end;
  AParagraphFrameBox := Safe<TdxParagraphFrameBox>.Cast(ANewBoxInfo.Box);
  ...
  if (CurrentRow.Boxes.Count = 0) and (ANewBoxInfo.Box is TdxSectionMarkBox)
  then
    Exit(TdxCanFitCurrentRowToColumnResult.RowFitted);
...
function TdxRowsController.CanFitCurrentRowToColumn
  : TdxCanFitCurrentRowToColumnResult;
var
  ARowHeight: Integer;
begin
  ARowHeight := FLineSpacingCalculator.CalcRowHeight(CurrentRow.Height,
    CurrentRow.Height);
  Result := CanFitCurrentRowToColumnCore(ARowHeight);
end;

procedure TdxRowsController.ClearInvalidatedContent(AColumn: TdxColumn;
  const APos: TdxFormatterPosition; AParagraphIndex: TdxParagraphIndex);
begin
...
procedure TdxRowsController.ClearInvalidatedContentCore(AColumn: TdxColumn;
  const APos: TdxFormatterPosition; AParagraphIndex: TdxParagraphIndex);
var
  ARows: TdxRowCollection;
  ARowIndex: Integer;
...
procedure TdxRowsController.
  ClearInvalidatedContentFromTheStartOfRowAtCurrentPage(AColumn: TdxColumn;
  const APos: TdxFormatterPosition; AParagraphIndex: TdxParagraphIndex);
begin
  ClearInvalidatedContentCore(AColumn, APos, AParagraphIndex);
  RecreateHorizontalPositionController;
...
function TdxRowsController.CreateFloatingObjectSizeAndPositionController
  : TdxFloatingObjectSizeAndPositionController;
begin
  Result := TdxFloatingObjectSizeAndPositionController.Create(Self);
end;

procedure TdxRowsController.CreateLineNumberBoxes(ASection: TdxSection;
  APage: TdxPage);
var
  I: Integer;
...
procedure TdxRowsController.CreateLineNumberBoxes(ASection: TdxSection;
  AColumn: TdxColumn; ALineNumbers: TdxLineNumberBoxCollection);
var
  AMeasurer: TdxBoxMeasurer;
  I, ADistance: Integer;
  ABoxInfo: TdxBoxInfo;
...
begin
  ...
  if AMeasurer = nil then
    Exit;
  ADistance := DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits
    (ASection.LineNumbering.Distance);
  if ADistance <= 0 then
    ADistance := DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits
      (DocumentModel.UnitConverter.DocumentsToModelUnits(75));
  ABoxInfo := TdxBoxInfo.Create;
  try
    ABoxInfo.StartPos := TdxFormatterPosition.Create(0, 0, 0);
    ABoxInfo.EndPos := TdxFormatterPosition.Create(0, 0, 0);
    AFontInfo := DocumentModel.FontCache
      [DocumentModel.LineNumberRun.FontCacheIndex];
    ARows := AColumn.Rows;
    ...
    begin
      ...
      begin
        ...
        ABox := TdxLineNumberBox.Create(DocumentModel.LineNumberRun,
          ARow, AText);
        ABoxInfo.Box := ABox;
...
function TdxRowsController.CreateLineSpacingCalculator
  : TdxLineSpacingCalculatorBase;
begin
  Result := TdxLineSpacingCalculatorBase.GetLineSpacingCalculator(FParagraph);
end;

procedure TdxRowsController.CreateNewCurrentRow(APrevCurrentRow: TdxRow;
  AAfterRestart: Boolean);
var
  ANewRow: TdxRow;
  APrevBottom: Integer;
...
procedure TdxRowsController.CreateNewCurrentRowAfterRestart
  (ASection: TdxSection; AColumn: TdxColumn);
var
  ALastRow: TdxRow;
...
begin
  ...
  try
    ...
    begin
      ...
      if not APrevParagraph.SuppressLineNumbers and not APrevParagraph.IsInCell
      then
...
function TdxRowsController.CreateTableGridCalculator(ADocumentModel
  : TdxDocumentModel; AWidthsCalculator: TdxTableWidthsCalculator;
  AMaxTableWidth: Integer): TdxTableGridCalculator;
begin
  Result := TdxTableGridCalculator.Create(AWidthsCalculator, AMaxTableWidth,
    DocumentModel.LayoutOptions.PrintLayoutView.
    AllowTablesToExtendIntoMargins, False);
end;

function TdxRowsController.CreateTablesController: TdxTablesController;
begin
  Result := TdxTablesController.Create
    (ColumnController.PageAreaController.PageController, Self);
end;
...
begin
  ...
  ALastRow.ProcessingFlags := ALastRow.ProcessingFlags +
    [TdxRowProcessingFlag.LastParagraphRow];
...
procedure TdxRowsController.EndRowCore(AParagraph: TdxParagraph;
  AFormatter: TdxParagraphBoxFormatter);
var
  ADescent: Integer;
...
begin
  HorizontalPositionController.IncrementCurrentHorizontalPosition
    (FTabsController.CalcLastTabWidth(CurrentRow, AFormatter));
  ...
  if (CurrentColumn.Rows.Count > 0) and not AParagraph.HasParagraphFrame and
    not AParagraph.IsInCell then
  begin
    if PieceTable.IsHeader then
    begin
      AHeaderOffset := DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits
        (ColumnController.PageAreaController.PageController.CurrentSection.
        Margins.HeaderOffset);
      AMaxHeaderBottom :=
        (ColumnController.PageAreaController.PageController.PageBounds.Height
        div 2) + AHeaderOffset;
      FForceFormattingComplete := CurrentRow.Bounds.Bottom > AMaxHeaderBottom;
    end;
    if PieceTable.IsFooter then
    begin
      AFooterOffset := DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits
        (ColumnController.PageAreaController.PageController.CurrentSection.
        Margins.FooterOffset);
      AMaxFooterBottom := ColumnController.PageAreaController.PageController.
        PageBounds.Bottom - AFooterOffset;
  ...
  begin
    ...
    if not AParagraph.SuppressLineNumbers and not TablesController.IsInsideTable
    then
      Inc(FLineNumber);
    ...
    ALineSpacing := FLineSpacingCalculator.CalculateSpacing
      (CurrentRow.Bounds.Height, FMaxAscentAndFree, ADescent,
      FMaxPictureHeight);
    R := CurrentRow.Bounds;
...
begin
  ...
  if ANextParagraphIndex < PieceTable.Paragraphs.Count then
    RaiseBeginNextSectionFormatting
      (FPieceTable.LookupSectionIndexByParagraphIndex(ANextParagraphIndex));
...
procedure TdxRowsController.EnsureSpacingAfterPrevParagraphValid
...
procedure TdxRowsController.FormatFloatingObjectTextBox(AFloatingObjectBox
  : TdxFloatingObjectBox; AContent: TdxTextBoxFloatingObjectContent;
  AAnchorBox: TdxFloatingObjectAnchorBox);
var
  AActualSize: Integer;
...
begin
  APrinter := TdxTextBoxFloatingObjectContentPrinter.Create(AContent.TextBox,
    ColumnController.PageAreaController.PageController.Pages.Last.
    PageNumberSource, ColumnController.Measurer);
  try
    ATextBoxContent := AFloatingObjectBox.GetTextBoxContentBounds;
    APrinter.ColumnLocation := ATextBoxContent.Location;
    APrinter.ColumnSize := GetColumnSize(AAnchorBox, AContent,
      ATextBoxContent, False);
    AActualSize := APrinter.Format(APrinter.ColumnLocation.Y +
      APrinter.ColumnSize.Height);
    ...
    if AContent.TextBoxProperties.ResizeShapeToFitText then
      ResizeFloatingObjectBoxToFitText(AFloatingObjectBox, AContent, AAnchorBox,
        ATextBoxContent, AActualSize);
    ...
    AFinalColumnBounds.Size := GetColumnSize(AAnchorBox, AContent,
      ATextBoxContent, True);
...
function TdxRowsController.GetActualSpacingAfter(AParagraphIndex
...
function TdxRowsController.GetActualTabInfo(const ATabInfo: TdxTabInfo;
  AProperties: TdxListLevelProperties): TdxTabInfo;
var
...
begin
  ...
  begin
    ...
    AIndentTabPosition := Result.GetLayoutPosition
      (DocumentModel.ToDocumentLayoutUnitConverter);
    ATabPosition := ATabInfo.GetLayoutPosition
      (DocumentModel.ToDocumentLayoutUnitConverter);
...
function TdxRowsController.GetBox(ABoxType: TdxBoxClass;
  ABoxInfo: TdxBoxInfo): TdxBox;
begin
  if (ABoxInfo.Box <> nil) and not(ABoxInfo.Box is TdxFloatingObjectAnchorBox)
    and not(ABoxInfo.Box is TdxParagraphFrameBox) then
  begin
...
function TdxRowsController.GetParagraphFrameColumnSize(AParagraphFrameBox
  : TdxParagraphFrameBox): TSize;
var
  ABounds: TRect;
...
begin
  ...
  AMergedFrameProperties := AParagraphFrameBox.GetParagraph.
    GetMergedFrameProperties;
  try
...
procedure TdxRowsController.ObtainParagraphFirstRowPosition
  (AParagraph: TdxParagraph);
begin
end;

function TdxRowsController.CanFitFloatingObject(AFloatingObjectAnchorBox
  : TdxFloatingObjectAnchorBox; ANewBoxInfo: TdxBoxInfo; AEmptyColumn: Boolean)
...
begin
  ...
  if ARun.FloatingObjectProperties.TextWrapType = TdxFloatingObjectTextWrapType.None
  then
    Exit(TdxCanFitFloatingObjectResult.Always);

  ARestartPosition := CalculateRestartPositionDueFloatingObject
    (AFloatingObjectAnchorBox);
  if (ARestartPosition = TdxDocumentModelPosition.Null) or AEmptyColumn then
    Exit(TdxCanFitFloatingObjectResult.DependsOnTable);
  if (ARestartPosition.RunIndex = AFloatingObjectAnchorBox.StartPos.RunIndex)
    and (ARestartPosition.RunOffset = AFloatingObjectAnchorBox.StartPos.Offset)
  then
  begin
    LastRestartDueToFloatingObjectModelPosition := ARestartPosition;
    Exit(TdxCanFitFloatingObjectResult.DependsOnTable);
  end;
  AObjectAdded := AddFloatingObjectToLayout(AFloatingObjectAnchorBox,
    ANewBoxInfo);
...
function TdxRowsController.CanFitParagraphFrame(ANewBoxInfo: TdxBoxInfo;
  AEmptyColumn: Boolean): Boolean;
var
  ACurrentRun: TdxTextRunBase;
  AParagraphFrameBox: TdxParagraphFrameBox;
...
begin
  ...
  begin
    AParagraphFrameBox := ParagraphFramesLayout.GetFloatingObject
      (ACurrentParagraph);
  ...
  try
    if AFrameProperties.Info.TextWrapType = TdxParagraphFrameTextWrapType.None
    then
      Exit;
  finally
  ...
  ARestartPosition := CalculateRestartPositionDueParagraphFrame
    (AParagraphFrameBox);
  if ARestartPosition = TdxDocumentModelPosition.Null then
    Exit;

  if ARestartPosition.RunIndex = PieceTable.Paragraphs
    [AParagraphFrameBox.ParagraphIndex].FirstRunIndex then
  begin
    LastRestartDueToFloatingObjectModelPosition := ARestartPosition;
    Exit;
  end;
...
procedure TdxRowsController.InnerSetColumnController(const AValue
  : TdxCustomColumnController);
begin
...
function TdxRowsController.GetEffectiveLineNumberingRestartType
  (ASection: TdxSection): TdxLineNumberingRestart;
begin
  Result := ASection.LineNumbering.NumberingRestartType;
end;

function TdxRowsController.GetFontAscentAndFree(ANewBoxInfo
  : TdxBoxInfo): Integer;
begin
  Result := ANewBoxInfo.GetFontInfo(PieceTable).GetBaseAscentAndFree
    (DocumentModel);
end;

function TdxRowsController.GetFontAscentAndFree(ARun: TdxTextRunBase): Integer;
begin
  Result := DocumentModel.FontCache[ARun.FontCacheIndex].GetBaseAscentAndFree
    (DocumentModel);
end;

function TdxRowsController.GetFontDescent(ARun: TdxInlinePictureRun): Integer;
begin
  Result := DocumentModel.FontCache[ARun.FontCacheIndex].GetBaseDescent
    (DocumentModel);
end;
...
function TdxRowsController.GetLegacyNumberingListBoxSeparatorWidth
  (ABox: TdxNumberingListBoxWithSeparator; const ABounds: TRect;
  AProperties: TdxListLevelProperties;
  AFormatter: TdxParagraphBoxFormatter): Integer;
var
...
begin
  ...
  HorizontalPositionController.SetCurrentHorizontalPosition(ABounds.Right);
  ALegacySpace := DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits
    (AProperties.LegacySpace);
  ALegacyIndent := DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits
    (AProperties.LegacyIndent);
  ATextRight := Max(AStartHorizontalPosition + ALegacyIndent,
    ABounds.Right + ALegacySpace);
  if FParagraph.FirstLineIndentType = TdxParagraphFirstLineIndent.Hanging then
    ATextRight := Max(ATextRight,
      DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits
      (FParagraph.FirstLineIndent) + AStartHorizontalPosition);
  Result := Math.Max(ATextRight - CurrentHorizontalPosition, 0);
end;

function TdxRowsController.GetNextTab(AFormatter: TdxParagraphBoxFormatter)
  : TdxTabInfo;
var
...
begin
  ...
  APosition := DocumentModel.ToDocumentLayoutUnitConverter.ToModelUnits
    (CurrentHorizontalPosition - CurrentColumn.Bounds.Left);
  ARoundingFix := 0;
  repeat
    ATabInfo := FTabsController.GetNextTab(ARoundingFix + APosition);
    ALayoutTabPosition := DocumentModel.ToDocumentLayoutUnitConverter.
      ToLayoutUnits(ATabInfo.Position);
    if ALayoutTabPosition + CurrentColumn.Bounds.Left > CurrentHorizontalPosition
    then
      Exit(ATabInfo)
    else
      Inc(ARoundingFix);
...
function TdxRowsController.GetNumberingListBoxSeparatorWidth
  (ABox: TdxNumberingListBoxWithSeparator; const ABounds: TRect;
  AProperties: TdxListLevelProperties;
  AFormatter: TdxParagraphBoxFormatter): Integer;
var
...
begin
  ...
  ATabRight := AActualTabInfo.GetLayoutPosition
    (DocumentModel.ToDocumentLayoutUnitConverter);
  ATabLeft := ABounds.Right - CurrentColumn.Bounds.Left;
  Result := ATabRight - ATabLeft;
  if Result < 0 then
  begin
    ATabRight := ATabInfo.GetLayoutPosition
      (DocumentModel.ToDocumentLayoutUnitConverter);
    Result := ATabRight - ATabLeft;
  end;
end;
...
function TdxRowsController.GetTopLevelColumnController
  : TdxCustomColumnController;
var
...
begin
  ...
  FCurrentRunIndex := -1;
  CurrentRow.ProcessingFlags := CurrentRow.ProcessingFlags -
    [TdxRowProcessingFlag.ProcessCharacterLines,
...
function TdxRowsController.IsPositionOutsideRightParagraphBound
  (APos: Integer): Boolean;
begin
  Result := APos > FParagraphRight;
end;

function TdxRowsController.MoveCurrentRowDownToFitTable(ATableWidth,
  ATableTop: Integer): Integer;
begin
  Result := HorizontalPositionController.MoveCurrentRowDownToFitTable
    (ATableWidth, ATableTop);
end;
...
begin
  case Paragraph.FirstLineIndentType of
    ...
    TdxParagraphFirstLineIndent.Indented:
      begin
        FCurrentRowIndent := DocumentModel.ToDocumentLayoutUnitConverter.
          ToLayoutUnits(Paragraph.FirstLineIndent);
        FRegularRowIndent := 0;
        FCurrentRowIndentAfterFloatingObject := FCurrentRowIndent;
      end;
    TdxParagraphFirstLineIndent.Hanging:
      begin
        FCurrentRowIndent := -DocumentModel.ToDocumentLayoutUnitConverter.
          ToLayoutUnits(Paragraph.FirstLineIndent);
        FRegularRowIndent := 0;
        FCurrentRowIndentAfterFloatingObject :=
          Max(0, DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits
          (Paragraph.LeftIndent) + FCurrentRowIndent);;
      end;
  end;
end;
...
begin
  FFloatingObjectsLayout := FColumnController.PageAreaController.PageController.
    FloatingObjectsLayout;
  Assert(FFloatingObjectsLayout <> nil);
end;
...
begin
  FParagraphFramesLayout := FColumnController.PageAreaController.PageController.
    ParagraphFramesLayout;
  Assert(FParagraphFramesLayout <> nil);
end;
...
procedure TdxRowsController.OnPageFormattingComplete(ASection: TdxSection;
  APage: TdxPage);
var
...
begin
  ...
  begin
    ASectionIndex := PieceTable.LookupSectionIndexByParagraphIndex
      (FParagraph.Index);
    if ASectionIndex >= 0 then
      ASection := DocumentModel.Sections[ASectionIndex];
  end;
  if GetEffectiveLineNumberingRestartType(ASection) = TdxLineNumberingRestart.NewPage
  then
  begin
    InitialLineNumber := ASection.LineNumbering.StartingLineNumber;
    LineNumberStep := ASection.LineNumbering.Step;
...
procedure TdxRowsController.PrepareCurrentRowBounds(AParagraph: TdxParagraph;
  ABeginFromParagraphStart: Boolean);
begin
  FreeAndNil(FLineSpacingCalculator);
...
begin
  ABounds := CurrentRow.Bounds;
  CurrentRow.Bounds := TRect.CreateSize(ParagraphLeft + FCurrentRowIndent,
    ABounds.Top, FParagraphRight - ParagraphLeft - FCurrentRowIndent,
    ABounds.Height);
end;
...
begin
  ...
  if (FFloatingObjectsLayout.Items.Count > 0) or
    (ParagraphFramesLayout.Items.Count > 0) then
  begin
    if FHorizontalPositionController.ClassType <> TdxFloatingObjectsCurrentHorizontalPositionController
    then
    begin
      FHorizontalPositionController.Free;
      FHorizontalPositionController :=
        TdxFloatingObjectsCurrentHorizontalPositionController.Create(Self,
        APosition);
    end;
  end
  else if FHorizontalPositionController.ClassType <> TdxCurrentHorizontalPositionController
  then
  begin
    FHorizontalPositionController.Free;
...
begin
  ...
  ACount := ABoxes.Count;
  if ACount > 0 then
    HorizontalPositionController.RollbackCurrentHorizontalPositionTo
      (ABoxes[ACount - 1].Bounds.Right)
  else if CurrentRow.NumberingListBox = nil then
    HorizontalPositionController.SetCurrentRowInitialHorizontalPosition
  else
    HorizontalPositionController.RollbackCurrentHorizontalPositionTo
      (CurrentRow.NumberingListBox.Bounds.Right);
  FTabsController.UpdateLastTabPosition(ACount);
end;

procedure TdxRowsController.Reset(ASection: TdxSection;
  AKeepFloatingObjects: Boolean);
begin
  CurrentColumn := nil;
  FColumns.Clear;
  InnerSetColumnController(GetTopLevelColumnController);
...
procedure TdxRowsController.ResizeFloatingObjectBoxToFitText(AFloatingObjectBox
  : TdxFloatingObjectBox; AContent: TdxTextBoxFloatingObjectContent;
  AAnchorBox: TdxFloatingObjectAnchorBox; const ATextBoxContent: TRect;
  AActualSize: Integer);
var
...
begin
  AUnitConverter := DocumentModel.ToDocumentLayoutUnitConverter;
  AFloatingObjectProperties :=
    AContent.TextBox.AnchorRun.FloatingObjectProperties;
  ...
  ANewActualHeight := AFloatingObjectProperties.ActualHeight +
    AUnitConverter.ToModelUnits(ADeltaHeight);
  ...
  begin
    ...
    try
      ARectangularObject.ActualSize :=
        TSize.Create(ARectangularObject.ActualSize.Width, ANewActualHeight);
    finally
      AFloatingObjectProperties.DisableHistory := False;
    end;
  end;
  AVerticalPositionAlignment :=
    AFloatingObjectProperties.VerticalPositionAlignment;
  if AVerticalPositionAlignment
    in [TdxFloatingObjectVerticalPositionAlignment.Bottom,
    TdxFloatingObjectVerticalPositionAlignment.Center] then
    CorrectFloatingObjectTextBoxVerticalPosition(AFloatingObjectBox,
      AAnchorBox);
end;
...
procedure TdxRowsController.CorrectFloatingObjectTextBoxVerticalPosition
  (AFloatingObjectBox: TdxFloatingObjectBox;
  AAnchorBox: TdxFloatingObjectAnchorBox);
var
  AController: TdxFloatingObjectSizeAndPositionController;
...
begin
  ...
  ADeltaY := AAnchorBox.ContentBounds.Top -
    AFloatingObjectBox.ContentBounds.Top;
  if ADeltaY <> 0 then
    AFloatingObjectBox.MoveLayoutVertically(ADeltaY);
  ApplyFloatingObjectBoxBounds(AFloatingObjectBox, AAnchorBox);
end;

procedure TdxRowsController.RestartFormattingFromTheMiddleOfSection
  (ASection: TdxSection; AColumn: TdxColumn);
begin
...
procedure TdxRowsController.RestartFormattingFromTheStartOfRowAtCurrentPage
  (ASection: TdxSection; AColumn: TdxColumn);
begin
  FIsSpacingAfterPrevParagraphValid := False;
...
procedure TdxRowsController.RestartFormattingFromTheStartOfSection
  (ASection: TdxSection; AColumn: TdxColumn);
begin
  CurrentColumn := AColumn;
  CreateNewCurrentRowAfterRestart(ASection, AColumn);
...
procedure TdxRowsController.SetColumnController(ANewColumnController
  : TdxCustomColumnController);
var
  ANewRow: TdxRow;
begin
...
begin
  ...
  begin
    ...
    begin
      AObjectAnchorRun := TdxFloatingObjectAnchorRun
        (PieceTable.Runs[AAnchorBox.StartPos.RunIndex]);
      AAngle := dxFMod(DocumentModel.UnitConverter.ModelUnitsToDegreeF
        (AObjectAnchorRun.Shape.Rotation), 360);
      if AAngle < 0 then
        AAngle := AAngle + 360;
      if (AAngle < 45) or (AAngle >= 135) and (AAngle < 225) or (AAngle >= 315)
      then
        Result := ATextBoxContent.Size
      else
...
function TdxRowsController.GetTableCell(AHitTestResult
  : TdxRichEditHitTestResult): TdxTableCell;
begin
...
function TdxRowsController.ShouldAddParagraphBackgroundFrameBox
  (AParagraph: TdxParagraph): Boolean;
begin
...
procedure TdxRowsController.ApplyParagraphFrameBoxBounds(AParagraphFrameBox
  : TdxParagraphFrameBox; ANewParagraphFrameBox: TdxParagraphFrameBox);
begin
  ...
  AParagraphFrameBox.SetActualSizeBounds
    (ANewParagraphFrameBox.ActualSizeBounds);
end;

procedure TdxRowsController.FormatParagraphFrameTextBox(AParagraphFrameBox
  : TdxParagraphFrameBox);
var
    ...
    try
      ...
      try
        ...
        if (AHRule = TdxParagraphFrameHorizontalRule.Auto) or
          ((AHRule = TdxParagraphFrameHorizontalRule.AtLeast) and
          (AParagraphFrameBox.Bounds.Height < ARowsHeight)) then
          SetActualBoundsForEmptyHeightFrameBox(AParagraphFrameBox,
            ARowsHeight);

        if AFrameProperties.Info.Width = 0 then
        begin
          AElementBoundsWidth := Max(TdxMaxWidthCalculator.GetMaxRight(ARows),
            AColumn.Bounds.Left) - AColumn.Bounds.Left;
          SetActualBoundsForEmptyWidthFrameBox(AParagraphFrameBox,
            AFrameProperties.Info.HorizontalPositionAlignment,
            AElementBoundsWidth);
        end;
      finally
        AFrameProperties.Free;
      ...
      AActualPageAreaBounds.Height :=
        AParagraphFrameBox.ActualSizeBounds.Height;
...
procedure TdxRowsController.AddParagraphFrameToLayoutCore(AParagraphFrameBox
  : TdxParagraphFrameBox; ABoxInfo: TdxBoxInfo);
begin
  AParagraphFrameBox.StartPos := ABoxInfo.StartPos;
  ApplyParagraphFrameBoxBounds(AParagraphFrameBox,
    Safe<TdxParagraphFrameBox>.Cast(ABoxInfo.Box));
  FormatParagraphFrameTextBox(AParagraphFrameBox);
  ParagraphFramesLayout.AddParagraphFrameBox(AParagraphFrameBox);
  RecreateHorizontalPositionController;
end;

function TdxRowsController.AddParagraphFrameToLayout(AParagraphFrameBox
  : TdxParagraphFrameBox; ABoxInfo: TdxBoxInfo): Boolean;
var
  ACurrentRun: TdxTextRunBase;
...
begin
  ...
  begin
    ...
    try
      if AMergedFrameProperties.Info.TextWrapType <>
        TdxParagraphFrameTextWrapType.None then
...
function TdxRowsController.ShouldChangeExistingFloatingObjectBounds
  (AFloatingObjectBox: TdxFloatingObjectBox;
...
function TdxRowsController.ShouldIgnoreParagraphHeight
  (AParagraph: TdxParagraph): Boolean;
var
  ADocumentModel: TdxDocumentModel;
begin
  ADocumentModel := AParagraph.DocumentModel;
  Result := ADocumentModel.IsSpecialEmptyParagraphAfterInnerTable(AParagraph,
    TablesController.GetCurrentCell) and not ADocumentModel.IsCursorInParagraph
    (AParagraph);
end;
...
begin
  ARunIndex := ABoxInfo.StartPos.RunIndex;
  if (ARunIndex = FCurrentRunIndex) and not ABoxInfo.ForceUpdateCurrentRowHeight
  then
    Exit;
  ...
  CurrentRow.Height := FLineSpacingCalculator.CalcRowHeight(CurrentRow.Height,
    FMaxAscentAndFree + FMaxDescent);
  if APrevRowHeight <> CurrentRow.Height then
    HorizontalPositionController.OnCurrentRowHeightChanged(False);
  TablesController.UpdateCurrentCellHeight;
end;

procedure TdxRowsController.UpdateCurrentRowHeightFromFloatingObject
  (ARun: TdxFloatingObjectAnchorRun; const AMeasurer: IdxObjectMeasurer);
var
  APictureHeight: Integer;
begin
  FMaxAscentAndFree := Max(FMaxAscentAndFree, GetFontAscentAndFree(ARun));
  APictureHeight := Max(FMaxAscentAndFree,
    AMeasurer.MeasureRectangularObject(ARun).Height);
  CurrentRow.Height := FLineSpacingCalculator.CalcRowHeight(CurrentRow.Height,
    APictureHeight);
  TablesController.UpdateCurrentCellHeight;
end;

procedure TdxRowsController.UpdateCurrentRowHeightFromInlineObjectRun
  (ARun: TdxTextRunBase; ABox: TdxBox; const AMeasurer: IdxObjectMeasurer);
var
  ABoxInfo: TdxBoxInfo;
begin
  ABoxInfo := TdxBoxInfo.Create;
  try
    ...
    CurrentRow.Height := FLineSpacingCalculator.CalcRowHeightFromInlineObject
      (CurrentRow.Height, FMaxPictureHeight, FMaxDescent);
    TablesController.UpdateCurrentCellHeight;
  finally
    ABoxInfo.Free;
  end;
...
procedure TdxRowsController.UpdateCurrentTableCellBottom(AFloatingObjectBox
  : TdxFloatingObjectBox);
var
  AFloatingObjectProperties: TdxFloatingObjectProperties;
begin
  AFloatingObjectProperties := AFloatingObjectBox.GetFloatingObjectRun.
    FloatingObjectProperties;
  if AFloatingObjectProperties.TextWrapType <> TdxFloatingObjectTextWrapType.None
  then
    TablesController.UpdateCurrentCellBottom
      (AFloatingObjectBox.ExtendedBounds.Bottom);
end;
...
function TdxTextAreaCollectionEx.Contains(const AInterval: TdxTextArea)
  : Boolean;
var
  ACount, I: Integer;
begin
...
constructor TdxParagraphBoxFormatter.Create(APieceTable: TdxPieceTable;
  AMeasurer: TdxBoxMeasurer; ARowsController: TdxRowsController);
begin
  inherited Create(APieceTable, AMeasurer);
  FMaxHeight := MaxInt;
...
procedure TdxParagraphBoxFormatter.BeginParagraph(ABeginFromParagraphStart,
  AParagraphFrameStarted: Boolean);
var
  AParagraph: TdxParagraph;
...
begin
  ...
  if ABeginFromParagraphStart then
    ...
    FParagraphStartPos := TdxFormatterPosition.Create
      (PieceTable.VisibleTextFilter.FindVisibleRunForward
      (AParagraph.FirstRunIndex), 0, 0);
  FParagraphStartRowCount := RowsController.CurrentColumn.Rows.Count;
  AShouldAddPageBreak := ABeginFromParagraphStart and
    ShouldPageBreakBeforeParagraph(AParagraph) and (FParagraphStartRowCount > 0)
    and PieceTable.IsMain and CanBreakPageBefore(AParagraph);
  ...
  RowsController.BeginParagraph(AParagraph, ABeginFromParagraphStart,
    AParagraphFrameStarted);
  FSuppressHyphenation := (FHyphenationService = nil) or
    AParagraph.SuppressHyphenation or not DocumentModel.DocumentProperties.
    HyphenateDocument;
  if AShouldAddPageBreak then
    RowsController.OnPageBreakBeforeParagraph;
end;

procedure TdxParagraphBoxFormatter.BeginParagraphFormatting
  (AIterator: TdxParagraphBoxIterator; ABeginFromParagraphStart,
  AParagraphFrameStarted: Boolean);
begin
  Iterator := AIterator;
...
function TdxParagraphBoxFormatter.CanBreakPageBefore
  (AParagraph: TdxParagraph): Boolean;
var
  ACell: TdxTableCell;
begin
  ...
  Result := ACell.IsFirstCellInRow and
    (ACell.StartParagraphIndex = AParagraph.Index);
end;

function TdxParagraphBoxFormatter.GetNewState
  (AStateType: TdxParagraphBoxFormatterState): TdxBoxFormatterStateBase;
var
  APreviousState: TdxBoxFormatterStateBase;
begin
...
procedure TdxParagraphBoxFormatter.ChangeState
  (AStateType: TdxParagraphBoxFormatterState);
begin
  case AStateType of
...
function TdxParagraphBoxFormatter.GetActualParagraphFrameProperties
  (AParagraph: TdxSimpleParagraph): TdxMergedFrameProperties;
begin
...
function TdxParagraphBoxFormatter.IsParagraphFrame
  (AProperties: TdxMergedFrameProperties): Boolean;
begin
  Result := (AProperties.Width <> 0) or
    ((AProperties.Height <> 0) and (AProperties.Info.HorizontalRule <>
    TdxParagraphFrameHorizontalRule.Auto)) or (AProperties.X <> 0) or
    (AProperties.Y <> 0) or (AProperties.HorizontalPositionType <>
    TdxParagraphFrameHorizontalPositionType.Column) or
    (AProperties.VerticalPositionType = TdxParagraphFrameVerticalPositionType.
    Paragraph) or (AProperties.Options.UseHorizontalPositionAlignment and
    (AProperties.HorizontalPositionAlignment <>
    TdxParagraphFrameHorizontalPositionAlignment.Left)) or
    (AProperties.Options.UseVerticalPositionAlignment and
    (AProperties.VerticalPositionAlignment <>
    TdxParagraphFrameVerticalPositionAlignment.Inline)) or
    (AProperties.Info.TextWrapType <> TdxParagraphFrameTextWrapType.Auto);
end;

procedure TdxParagraphBoxFormatter.ChangeStateContinueFromParagraph
  (AParagraphIndex: TdxParagraphIndex);
begin
  TdxStateContinueFormattingFromParagraph
    (FStates[TdxParagraphBoxFormatterState.ContinueFromParagraph])
...
begin
  repeat
    ...
    begin
      if AContinueFormatResult = TdxStateContinueFormatResult.RestartDueFloatingObject
      then
      begin
      ...
      begin
        RowsController.ColumnController.PageAreaController.PageController.
          SetPageLastRunIndex(FLastRestartDueToFloatingObjectParagraphStartPos.
          RunIndex - 1);
        Assert(RowsController.
          LastRestartDueToFloatingObjectModelPosition.IsValid);
        RowsController.RestartModelPosition.Invalidate;
        Result.Init
          (RowsController.LastRestartDueToFloatingObjectModelPosition, True);
        Exit;
      end;
    end;
    case State.&Type of
      ...
      TdxParagraphBoxFormatterState.ContinueFromParagraph:
        begin
          Result.Init(TdxStateContinueFormattingFromParagraph(State)
            .ParagraphIndex);
          Break;
        end;
    end;
...
function TdxParagraphBoxFormatter.HasActualParagraphFrameProperties
  (AParagraph: TdxSimpleParagraph): Boolean;
var
  AFrameProperties: TdxMergedFrameProperties;
begin
...
function TdxParagraphBoxFormatter.GetActualParagraphFramePropertiesProperty
  : TdxMergedFrameProperties;
begin
...
function TdxParagraphBoxFormatter.GetInitialStateType(ABeginFromParagraphStart
  : Boolean): TdxParagraphBoxFormatterState;
var
  ARuns: TdxTextRunCollection;
...
begin
  ...
  if ARuns[Iterator.RunIndex] <> ARuns.First then
    ...
    begin
      ...
      if not APrevParagraph.IsInCell and not HasActualParagraphFrameProperties
        (APrevParagraph) then
        Result := TdxParagraphBoxFormatterState.SectionBreakAfterParagraphMark;
    end;
end;

procedure TdxParagraphBoxFormatter.Initialize(ARowsController
  : TdxRowsController);
begin
  if ARowsController = nil then
    TdxRichEditExceptions.ThrowArgumentException('rowsController',
      ARowsController);
...
procedure TdxParagraphBoxFormatter.OnTableStart(ASender: TObject;
  AE: TdxEventArgs);
begin
  FTableState.Free;
...
procedure TdxParagraphBoxFormatter.RollbackToLastTab
  (AIter: TdxParagraphBoxIterator);
begin
  if FLastTabStartPos <> InvalidPosition then
    AIter.SetPosition(FLastTabStartPos);
end;

function TdxParagraphBoxFormatter.RollbackToParagraphStart
  (const APos: TdxFormatterPosition; AInitialRowCount: Integer)
  : TdxCompleteFormattingResult;
var
  ARows: TdxRowCollection;
begin
...
procedure TdxParagraphBoxFormatter.RollbackToPositionAndClearLastRow
  (const APos: TdxFormatterPosition);
var
  AIterator: TdxParagraphBoxIterator;
begin
...
function TdxParagraphBoxFormatter.RollbackToStartOfRow
  (ACanFit: TdxCanFitCurrentRowToColumnResult): TdxCompleteFormattingResult;
var
  ARollbackToParagraphStart: Boolean;
  ANextState: TdxParagraphBoxFormatterState;
  AFirstVisibleRunIndex: TdxRunIndex;
begin
  AFirstVisibleRunIndex := Iterator.VisibleTextFilter.FindVisibleRunForward
    (Iterator.Paragraph.FirstRunIndex);
  ARollbackToParagraphStart := (RowStartPos.RunIndex = AFirstVisibleRunIndex)
    and (RowStartPos.Offset = 0);
...
function TdxParagraphBoxFormatter.RollbackToStartOfRowCore
  (ACanFit: TdxCanFitCurrentRowToColumnResult;
  ANextState: TdxParagraphBoxFormatterState): TdxCompleteFormattingResult;
var
...
begin
  ...
  else if ACanFit = TdxCanFitCurrentRowToColumnResult.TextAreasRecreated then
  begin
    RollbackToPositionAndClearLastRow(RowStartPos);
    ChangeState(ANextState);
  end
  ...
  begin
    if (FParagraphStartRowCount > 0) and
      RowsController.Paragraph.KeepLinesTogether and PieceTable.IsMain and
      not RowsController.TablesController.IsInsideTable then
    begin
      Result := RollbackToParagraphStart(ParagraphStartPos,
        FParagraphStartRowCount);
      if Result <> TdxCompleteFormattingResult.Success then
        Exit;
...
function TdxParagraphBoxFormatter.RollbackToStartOfRowTable
  (ACanFit: TdxCanFitCurrentRowToColumnResult): TdxParagraphIndex;
begin
  Result := RowsController.TablesController.
    RollbackToStartOfRowTableOnFirstCellRowColumnOverfull;
end;
...
const
  StateClasses: array [TdxParagraphBoxFormatterState]
    of TdxBoxFormatterStateBaseClass = (TdxStateParagraphStart,
    TdxStateParagraphStartAfterBreak, TdxStateParagraphStartFromTheMiddle,
    TdxStateParagraphStartAfterFloatingObject,
    TdxStateParagraphStartFromTheMiddleAfterFloatingObject, TdxStateRowEmpty,
    TdxStateRowEmptyAfterFloatingObject,

    TdxStateRowWithSpacesOnly, TdxStateRowWithTextOnly,
    TdxStateRowWithInlineObjectOnly, nil, TdxStateRowWithDashOnly, nil,
    TdxStateRowWithTextOnlyAfterFirstLeadingTab, nil,

    TdxStateRowSpaces, TdxStateRowText, nil, TdxStateRowDashAfterText,
    TdxStateRowDash, nil, TdxStateRowWithDashAfterTextOnly,
    TdxStateRowTextSplit, TdxStateRowTextSplitAfterFloatingObject, nil,
    TdxStateRowTextSplitAfterFirstLeadingTab, nil,

    TdxStateRowDashSplit, TdxStateRowDashSplitAfterFloatingObject,

    TdxStateRowEmptyHyphenation, TdxStateRowEmptyHyphenationAfterFloatingObject,
    TdxStateRowTextHyphenationFirstSyllable, nil,
    TdxStateRowTextHyphenationFirstSyllableAfterFirstLeadingTab, nil,
    TdxStateRowTextHyphenation, nil, TdxStateRowFirstLeadingTab,
    TdxStateRowLeadingTab, nil, TdxStateRowTab, nil, TdxStateRowLineBreak,
    TdxStateRowPageBreak, TdxStateRowPageBreakAtParagraphStart,
    TdxStateRowColumnBreak, TdxStateRowColumnBreakAtParagraphStart,

    TdxStateSectionBreakAfterParagraphMark, TdxStateFloatingObject,
    TdxStateParagraphFrame,
...
begin
  for I := Low(TdxParagraphBoxFormatterState)
    to High(TdxParagraphBoxFormatterState) do
...
function TdxParagraphBoxFormatter.ShouldPageBreakBeforeParagraph
  (AParagraph: TdxParagraph): Boolean;
var
...
begin
  if FSyllableIterator = nil then
    FSyllableIterator := TdxSyllableBoxIterator.Create
      (Iterator as TdxParagraphBoxIterator, FHyphenationService);
end;
...
begin
  Assert((CurrentRow.NumberingListBox <> nil) or
    (CurrentRow.NumberingListBox = nil) and
    (CurrentRow.Height = RowsController.DefaultRowHeight));
  RowsController.UpdateCurrentRowHeight(ABoxInfo);
end;
...
begin
  ...
  if not RowsController.CanFitBoxToCurrentRow(cxNullSize) then
    Result := TdxAddBoxResult.HorizontalIntersect
  else if not CurrentTab.IsDefault then
    Result := TdxAddBoxResult.Success
  else if RowsController.IsPositionOutsideRightParagraphBound
    (CurrentTabPosition + RowsController.CurrentColumn.Bounds.Left) then
    Result := TdxAddBoxResult.HorizontalIntersect
  else
    Result := TdxAddBoxResult.Success;
...
function TdxStateRowLeadingTab.FinishColumn(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
...
function TdxStateRowLeadingTab.FinishLine(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
...
function TdxStateRowLeadingTab.FinishPage(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
...
function TdxStateRowLeadingTab.InternalFinishParagraphCore(ABoxInfo: TdxBoxInfo;
  AFinalizeHandler: TFinalizeEvent): TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
...
function TdxStateRowLeadingTab.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowLeadingTabAfterFloatingObject;
end;

function TdxStateRowLeadingTab.HorizontalOverfull(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
  ...
  begin
    EndRow;
    if RowsController.CanFitCurrentRowToColumn <>
      TdxCanFitCurrentRowToColumnResult.RowFitted then
    begin
      Result := RowsController.CompleteCurrentColumnFormatting;
      if Result <> TdxCompleteFormattingResult.Success then
        Exit;
...
function TdxStateRowFirstLeadingTab.CanAddBox(ABoxInfo: TdxBoxInfo)
  : TdxAddBoxResult;
begin
  CurrentTab := RowsController.GetNextTab(Formatter);
  Result := TdxAddBoxResult.Success;
...
function TdxStateRowFirstLeadingTab.HorizontalOverfull(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(False);
  Result := TdxCompleteFormattingResult.Success;
...
begin
  case Iterator.CurrentChar of
    ...
    TdxCharacters.LineBreak:
      ANextState := TdxParagraphBoxFormatterState.RowLineBreak;
    TdxCharacters.Dash, TdxCharacters.EmDash, TdxCharacters.EnDash:
...
function TdxStateParagraphStart.CanFitCurrentRowToColumn(ABoxInfo: TdxBoxInfo)
  : TdxCanFitCurrentRowToColumnResult;
begin
  if TdxRowProcessingFlag.LastInvisibleEmptyCellRowAfterNestedTable
    in RowsController.CurrentRow.ProcessingFlags then
    Result := TdxCanFitCurrentRowToColumnResult.RowFitted
  else
...
begin
  ...
  begin
    if not RowsController.TablesController.IsInsideTable and RowsController.SupportsColumnAndPageBreaks
    then
    begin
      ...
      if ACh = TdxCharacters.PageBreak then
        ...
        ChangeState(TdxParagraphBoxFormatterState.
          RowColumnBreakAtParagraphStart);
      Exit(TdxStateContinueFormatResult.Success);
    end;
  end;
...
function TdxStateParagraphStart.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
...
function TdxStateParagraphStartAfterBreak.GetType
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.ParagraphStartAfterBreak;
end;

function TdxStateParagraphStartAfterBreak.ContinueFormat
  : TdxStateContinueFormatResult;
begin
...
function TdxStateParagraphStartAfterFloatingObject.GetType
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.ParagraphStartAfterFloatingObject;
end;
...
function TdxStateParagraphStartFromTheMiddle.GetType
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.ParagraphStartFromTheMiddle;
end;
...
function TdxStateParagraphStartFromTheMiddle.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
  Result := &Type;
end;
...
function TdxStateParagraphStartFromTheMiddleAfterFloatingObject.GetType
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.
    ParagraphStartFromTheMiddleAfterFloatingObject;
end;

function TdxStateParagraphStartFromTheMiddleAfterFloatingObject.
  GetStateAfterFloatingObject: TdxParagraphBoxFormatterState;
begin
  Result := &Type;
end;
...
function TdxStateRowWithTextOnlyAfterFirstLeadingTab.GetHyphenationState
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.
    RowTextHyphenationFirstSyllableAfterFirstLeadingTab;
...
function TdxStateRowWithTextOnlyAfterFirstLeadingTab.GetNoHyphenationNextState
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowTextSplitAfterFirstLeadingTab;
end;

function TdxStateRowWithTextOnlyAfterFirstLeadingTab.GetType
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowWithTextOnlyAfterFirstLeadingTab;
end;

function TdxStateRowWithTextOnlyAfterFirstLeadingTab.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.
    RowWithTextOnlyAfterFirstLeadingTabAfterFloatingObject;
...
function TdxCharacterFormatterSpacesState.AppendBox(var ABoxInfo: TdxBoxInfo)
  : TdxStateContinueFormatResult;
begin
...
function TdxCharacterFormatterColumnBreak.AppendBox(var ABoxInfo: TdxBoxInfo)
  : TdxStateContinueFormatResult;
begin
...
procedure TdxCharacterFormatterColumnBreak.MeasureBoxContent
  (ABoxInfo: TdxBoxInfo);
begin
...
function TdxCharacterFormatterDashState.AppendBox(var ABoxInfo: TdxBoxInfo)
  : TdxStateContinueFormatResult;
begin
...
procedure TdxCharacterFormatterDashState.MeasureBoxContent
  (ABoxInfo: TdxBoxInfo);
begin
...
function TdxCharacterFormatterPageBreak.AppendBox(var ABoxInfo: TdxBoxInfo)
  : TdxStateContinueFormatResult;
begin
...
procedure TdxCharacterFormatterPageBreak.MeasureBoxContent
  (ABoxInfo: TdxBoxInfo);
begin
...
procedure TdxFormattingProcessResult.Init(AFormattingProcess
...
procedure TdxFormattingProcessResult.Init(const ARestartPosition
  : TdxDocumentModelPosition; AForceRestart: Boolean = False);
begin
...
function TdxStateRowText.HorizontalOverfull(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
...
function TdxStateRowText.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
...
begin
  Formatter.RollbackToStartOfWord;
  if RowsController.HaveAvailableSpaceInRow then
  begin
...
function TdxStateRowDashAfterText.CalcNextState(ACurrentCharacter: Char)
  : TdxParagraphBoxFormatterState;
begin
...
function TdxStateRowWithDashAfterTextOnly.CalcNextState(ACurrentCharacter: Char)
  : TdxParagraphBoxFormatterState;
begin
  if TdxCharacters.IsCharDash(ACurrentCharacter) then
    Exit(TdxParagraphBoxFormatterState.RowDash);
...
function TdxStateRowWithDashAfterTextOnly.GetType
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowWithDashAfterTextOnly;
end;

function TdxStateRowWithDashAfterTextOnly.HorizontalOverfull
  (ABoxInfo: TdxBoxInfo): TdxCompleteFormattingResult;
begin
  Formatter.RollbackToStartOfWord;
...
function TdxStateRowDash.CalcNextState(ACurrentCharacter: Char)
  : TdxParagraphBoxFormatterState;
begin
  if inherited IsTerminatorChar(ACurrentCharacter) then
    Result := inherited CalcNextState(ACurrentCharacter)
...
function TdxStateRowDash.HorizontalOverfull(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Formatter.RollbackToStartOfWord;
  ChangeState(TdxParagraphBoxFormatterState.RowDashSplit);
...
begin
  Result := not TdxCharacters.IsCharDash(ACh) or
    (((ACh = TdxCharacters.PageBreak) or (ACh = TdxCharacters.ColumnBreak)) and
    RowsController.TablesController.IsInsideTable);
end;

function TdxStateRowDash.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
...
function TdxStateRowWithDashOnly.CalcNextState(ACurrentCharacter: Char)
  : TdxParagraphBoxFormatterState;
begin
  if inherited IsTerminatorChar(ACurrentCharacter) then
    Result := inherited CalcNextState(ACurrentCharacter)
...
function TdxStateRowWithDashOnly.HorizontalOverfull(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Formatter.RollbackToStartOfWord;
  ChangeState(TdxParagraphBoxFormatterState.RowDashSplit);
...
function TdxStateRowWithDashOnly.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
...
function TdxFormatterStartEndState.AppendBox(var ABoxInfo: TdxBoxInfo)
  : TdxStateContinueFormatResult;
begin
  Result := TdxStateContinueFormatResult.Success;
end;

function TdxFormatterStartEndState.CanAddBox(ABoxInfo: TdxBoxInfo)
  : TdxAddBoxResult;
begin
  Result := TdxAddBoxResult.Success;
end;

function TdxFormatterStartEndState.ColumnOverfull
  (ACanFit: TdxCanFitCurrentRowToColumnResult; ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(False);
...
function TdxFormatterStartEndState.HorizontalOverfull(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(False);
  Result := TdxCompleteFormattingResult.Success;
...
constructor TdxStateContinueFormattingFromParagraph.Create
  (AFormatter: TdxParagraphBoxFormatter; AParagraphIndex: TdxParagraphIndex);
begin
  inherited Create(AFormatter);
  FParagraphIndex := AParagraphIndex;
end;

function TdxStateContinueFormattingFromParagraph.GetType
  : TdxParagraphBoxFormatterState;
begin
...
function TdxStateSectionBreakAfterParagraphMark.ContinueFormat
  : TdxStateContinueFormatResult;
begin
...
function TdxStateSectionBreakAfterParagraphMark.CreateSectionMarkBoxInfo
  : TdxBoxInfo;
begin
  Result := TdxBoxInfo.Create;
  Result.Box := Iterator.CurrentBox;
...
function TdxStateSectionBreakAfterParagraphMark.FinishColumn
  (ABoxInfo: TdxBoxInfo): TdxCompleteFormattingResult;
begin
  Assert(False);
  Result := TdxCompleteFormattingResult.Success;
...
function TdxStateSectionBreakAfterParagraphMark.FinishLine(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(False);
  Result := TdxCompleteFormattingResult.Success;
...
function TdxStateSectionBreakAfterParagraphMark.FinishPage(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(False);
  Result := TdxCompleteFormattingResult.Success;
...
function TdxStateSectionBreakAfterParagraphMark.FinishParagraph
  : TdxCompleteFormattingResult;
begin
  Assert(False);
  Result := TdxCompleteFormattingResult.Success;
...
function TdxStateSectionBreakAfterParagraphMark.FinishSection
  : TdxCompleteFormattingResult;
var
  ABoxInfo: TdxBoxInfo;
begin
...
function TdxStateSectionBreakAfterParagraphMark.GetType
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.SectionBreakAfterParagraphMark
end;
...
function TdxCharacterFormatterFloatingObjectState.GetType
  : TdxCharacterFormatterState;
begin
  Result := TdxCharacterFormatterState.InlineObject;
end;

function TdxCharacterFormatterFloatingObjectState.IsTerminatorChar
  (ACh: Char): Boolean;
begin
  Result := TdxCharacters.IsCharSpace(ACh) or (ACh = TdxCharacters.TabMark) or
    (ACh = TdxCharacters.LineBreak) or (ACh = TdxCharacters.PageBreak) or
    (ACh = TdxCharacters.ColumnBreak) or TdxCharacters.IsCharDash(ACh);
end;

function TdxCharacterFormatterFloatingObjectState.AppendBox
  (var ABoxInfo: TdxBoxInfo): TdxStateContinueFormatResult;
begin
  AppendBoxCore(TdxFloatingObjectAnchorBox, ABoxInfo);
  Result := TdxStateContinueFormatResult.Success;
end;

procedure TdxCharacterFormatterFloatingObjectState.MeasureBoxContent
  (ABoxInfo: TdxBoxInfo);
begin
...
function TdxStateRowTextSplit.CalcNextState(ACurrentCharacter: Char)
  : TdxParagraphBoxFormatterState;
begin
...
procedure TdxStateRowTextSplit.ChangeStateManuallyIfNeeded(AIteratorResult
  : TdxParagraphIteratorResult);
var
  ACurrentChar: Char;
  ANextState: TdxParagraphBoxFormatterState;
...
function TdxStateRowTextSplit.ColumnOverfull
  (ACanFit: TdxCanFitCurrentRowToColumnResult; ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Result := Formatter.RollbackToStartOfRow(ACanFit);
...
function TdxStateRowTextSplit.FinishColumn(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(CurrentRow.Height > 0);
...
function TdxStateRowTextSplit.FinishLine(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(CurrentRow.Height > 0);
...
function TdxStateRowTextSplit.FinishPage(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(CurrentRow.Height > 0);
...
function TdxStateRowTextSplit.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowTextSplitAfterFloatingObject;
end;

function TdxStateRowTextSplit.HandleUnsuccessfulSplitting
  : TdxCompleteFormattingResult;
begin
  EndRow;
...
function TdxStateRowTextSplit.HorizontalOverfull(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
var
...
begin
  ...
  begin
    ...
    begin
      if (Iterator.CurrentChar = TdxCharacters.PageBreak) and
        not RowsController.TablesController.IsInsideTable then
      begin
      ...
      if (Iterator.CurrentChar = TdxCharacters.ColumnBreak) and
        not RowsController.TablesController.IsInsideTable then
      begin
        if not RowsController.SupportsColumnAndPageBreaks then
          ChangeState(TdxParagraphBoxFormatterState.RowLineBreak)
      ...
      if (Iterator.CurrentChar = TdxCharacters.LineBreak) and
        (ASplitBoxResult <>
        TdxSplitBoxResult.SuccessSuppressedHorizontalOverfull) then
        ChangeState(TdxParagraphBoxFormatterState.RowLineBreak)
      else
      begin
...
begin
  Result := TdxCharacters.IsCharSpace(ACh) or (ACh = TdxCharacters.TabMark) or
    (ACh = TdxCharacters.LineBreak) or (ACh = TdxCharacters.PageBreak) or
    (ACh = TdxCharacters.ColumnBreak) or
    (ACh = TdxCharacters.FloatingObjectMark) or TdxCharacters.IsCharDash(ACh);
end;

function TdxStateRowTextSplit.ShouldChangeStateManually(AIteratorResult
  : TdxParagraphIteratorResult; ACurrentCharacter: Char): Boolean;
begin
  Result := (AIteratorResult = TdxParagraphIteratorResult.Success) or
    ((not Iterator.IsEnd) and IsTerminatorChar(ACurrentCharacter));
end;

{ TdxStateRowTextSplitAfterFloatingObject }

function TdxStateRowTextSplitAfterFloatingObject.GetType
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowTextSplitAfterFloatingObject;
end;
...
function TdxStateRowDashSplit.CalcNextState(ACurrentCharacter: Char)
  : TdxParagraphBoxFormatterState;
begin
...
function TdxStateRowDashSplit.HandleUnsuccessfulSplitting
  : TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
...
function TdxStateRowDashSplit.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
...
function TdxStateRowDashSplitAfterFloatingObject.GetType
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowDashSplitAfterFloatingObject;
end;
...
begin
  Formatter.ApproveFloatingObjects;
  RowsController.AddBox(TdxParagraphBoxFormatter.GetSpaceBoxTemplate(ABoxInfo),
    ABoxInfo);
  ChangeStateManuallyIfNeeded(ABoxInfo.IteratorResult);
end;
...
function TdxStateRowSpaces.CalcNextState(ACurrentCharacter: Char)
  : TdxParagraphBoxFormatterState;
begin
  if ACurrentCharacter = TdxCharacters.TabMark then
    Exit(TdxParagraphBoxFormatterState.RowTab);
  ...
  else if (ACurrentCharacter = TdxCharacters.FloatingObjectMark) and Iterator.IsFloatingObjectAnchorRun
  then
    Result := TdxParagraphBoxFormatterState.FloatingObject
  else if TdxCharacters.IsCharDash(ACurrentCharacter) then
    Result := TdxParagraphBoxFormatterState.RowDash
  else
    Result := TdxParagraphBoxFormatterState.RowText;
end;
...
procedure TdxStateRowSpaces.ChangeStateManuallyIfNeeded(AIteratorResult
  : TdxParagraphIteratorResult);
var
  ACurrentChar: Char;
  ANextState: TdxParagraphBoxFormatterState;
...
function TdxStateRowSpaces.ColumnOverfull
  (ACanFit: TdxCanFitCurrentRowToColumnResult; ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(False);
...
function TdxStateRowSpaces.HorizontalOverfull(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(False);
  Result := TdxCompleteFormattingResult.Success;
...
function TdxStateRowSpaces.ShouldChangeStateManually(ACurrentCharacter
  : Char): Boolean;
begin
...
procedure TdxStateRowWithSpacesOnly.ApplyColumnBreakMarkSize
  (ABoxInfo: TdxBoxInfo);
begin
  RowsController.UpdateCurrentRowHeight(ABoxInfo);
end;

procedure TdxStateRowWithSpacesOnly.ApplyLineBreakMarkSize
  (ABoxInfo: TdxBoxInfo);
begin
  RowsController.UpdateCurrentRowHeight(ABoxInfo);
end;

procedure TdxStateRowWithSpacesOnly.ApplyPageBreakMarkSize
  (ABoxInfo: TdxBoxInfo);
begin
  RowsController.UpdateCurrentRowHeight(ABoxInfo);
end;

procedure TdxStateRowWithSpacesOnly.ApplyParagraphMarkSize
  (ABoxInfo: TdxBoxInfo);
begin
  RowsController.UpdateCurrentRowHeight(ABoxInfo);
end;

function TdxStateRowWithSpacesOnly.CalcNextState(ACurrentCharacter: Char)
  : TdxParagraphBoxFormatterState;
begin
  if ACurrentCharacter = TdxCharacters.TabMark then
  ...
  if TdxCharacters.IsCharDash(ACurrentCharacter) then
    Exit(TdxParagraphBoxFormatterState.RowDash);
  if (ACurrentCharacter = TdxCharacters.FloatingObjectMark) and Iterator.IsFloatingObjectAnchorRun
  then
    Exit(TdxParagraphBoxFormatterState.FloatingObject)
  else
    Exit(TdxParagraphBoxFormatterState.RowText);
...
function TdxStateRowWithSpacesOnly.FinishColumn(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
...
function TdxStateRowWithSpacesOnly.FinishLine(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
...
function TdxStateRowWithSpacesOnly.FinishPage(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
...
function TdxStateRowWithSpacesOnly.InternalFinishParagraphCore
  (ABoxInfo: TdxBoxInfo; AFinalizeHandler: TFinalizeEvent)
  : TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
...
constructor TdxParagraphFrameHorizontalPositionCalculator.Create
  (AUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter);
begin
  FUnitConverter := AUnitConverter;
end;

function TdxParagraphFrameHorizontalPositionCalculator.
  CalculateAbsoluteFloatingObjectX(const ALocation: IdxParagraphFrameLocation;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo;
  AActualWidth: Integer): Integer;
var
  AAlignBounds: TRect;
begin
  if ALocation.X <> 0 then
    Result := CalculateAbsoluteFloatingObjectXCore
      (ALocation.HorizontalPositionType, ALocation.X, APlacementInfo)
  else
  begin
    AAlignBounds := CalculateAlignBounds(ALocation, APlacementInfo);
    Result := CalculateAbsoluteFloatingObjectHorizontalAlignmentPosition
      (ALocation.HorizontalPositionAlignment, AAlignBounds, AActualWidth);
  end;
end;

function TdxParagraphFrameHorizontalPositionCalculator.
  CalculateFloatingObjectOffsetX(AHorizontalPositionType
  : TdxParagraphFrameHorizontalPositionType; X: Integer;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
begin
  case AHorizontalPositionType of
    ...
    TdxParagraphFrameHorizontalPositionType.Column:
      Result := FUnitConverter.ToModelUnits
        (X - APlacementInfo.ColumnBounds.Left);
    TdxParagraphFrameHorizontalPositionType.Margin:
      Result := FUnitConverter.ToModelUnits
        (X - APlacementInfo.PageClientBounds.Left);
  else
    TdxRichEditExceptions.ThrowInternalException;
    Result := 0;
  end;
...
function TdxParagraphFrameHorizontalPositionCalculator.CalculateAlignBounds
  (const ALocation: IdxParagraphFrameLocation;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): TRect;
begin
...
function TdxParagraphFrameHorizontalPositionCalculator.
  CalculateAbsoluteFloatingObjectXCore(AHorizontalPositionType
  : TdxParagraphFrameHorizontalPositionType; AOffsetX: Integer;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
begin
  case AHorizontalPositionType of
    TdxParagraphFrameHorizontalPositionType.Page:
      Result := FUnitConverter.ToLayoutUnits(AOffsetX) +
        APlacementInfo.PageBounds.Left;
    TdxParagraphFrameHorizontalPositionType.Column:
      Result := FUnitConverter.ToLayoutUnits(AOffsetX) +
        APlacementInfo.ColumnBounds.Left;
    TdxParagraphFrameHorizontalPositionType.Margin:
      Result := FUnitConverter.ToLayoutUnits(AOffsetX) +
        APlacementInfo.PageClientBounds.Left;
  else
    TdxRichEditExceptions.ThrowInternalException;
    Result := 0;
  end;
...
function TdxParagraphFrameHorizontalPositionCalculator.
  CalculateAbsoluteFloatingObjectHorizontalAlignmentPosition
  (AAlignment: TdxParagraphFrameHorizontalPositionAlignment;
  const AAlignBounds: TRect; AActualWidth: Integer): Integer;
begin
  case AAlignment of
    ...
    TdxParagraphFrameHorizontalPositionAlignment.Center:
      Result := (AAlignBounds.Right + AAlignBounds.Left) div 2 -
        FUnitConverter.ToLayoutUnits(AActualWidth) div 2;
  else
    TdxRichEditExceptions.ThrowInternalException;
    Result := 0;
  end;
...
constructor TdxParagraphFrameVerticalPositionCalculator.Create
  (AUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter);
begin
  FUnitConverter := AUnitConverter;
end;

function TdxParagraphFrameVerticalPositionCalculator.
  CalculateAbsoluteFloatingObjectY(const ALocation: IdxParagraphFrameLocation;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo;
  AActualHeight: Integer): Integer;
var
  AAlignBounds: TRect;
begin
  if ALocation.Y <> 0 then
    Result := CalculateAbsoluteFloatingObjectYCore
      (ALocation.VerticalPositionType, ALocation.Y, APlacementInfo)
  else
  begin
    AAlignBounds := CalculateAlignBounds(ALocation, APlacementInfo);
    Result := CalculateAbsoluteParagraphFrameVerticalAlignmentPosition
      (ALocation.VerticalPositionAlignment, AAlignBounds, AActualHeight);
  end;
end;

function TdxParagraphFrameVerticalPositionCalculator.
  CalculateFloatingObjectOffsetY(AVerticalPositionType
  : TdxParagraphFrameVerticalPositionType; Y: Integer;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
begin
...
function TdxParagraphFrameVerticalPositionCalculator.
  CalculateAbsoluteFloatingObjectYCore
  (AType: TdxParagraphFrameVerticalPositionType; AOffsetY: Integer;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
begin
  case AType of
    ...
    TdxParagraphFrameVerticalPositionType.Page:
      Result := APlacementInfo.PageBounds.Y + FUnitConverter.ToLayoutUnits
        (AOffsetY);
    TdxParagraphFrameVerticalPositionType.Margin:
      Result := APlacementInfo.PageClientBounds.Y + FUnitConverter.ToLayoutUnits
        (AOffsetY);
  else
    TdxRichEditExceptions.ThrowInternalException;
    Result := 0;
...
function TdxParagraphFrameVerticalPositionCalculator.CalculateAlignBounds
  (const ALocation: IdxParagraphFrameLocation;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): TRect;
begin
...
function TdxParagraphFrameVerticalPositionCalculator.
  CalculateAbsoluteParagraphFrameVerticalAlignmentPosition
  (AAlignment: TdxParagraphFrameVerticalPositionAlignment;
  const AAlignBounds: TRect; AActualHeight: Integer): Integer;
begin
  case AAlignment of
    ...
    TdxParagraphFrameVerticalPositionAlignment.Outside,
      ...
      Result := AAlignBounds.Bottom - FUnitConverter.ToLayoutUnits
        (AActualHeight);
    TdxParagraphFrameVerticalPositionAlignment.Center:
      Result := (AAlignBounds.Bottom + AAlignBounds.Top) div 2 -
        FUnitConverter.ToLayoutUnits(AActualHeight) div 2;
  else
    TdxRichEditExceptions.ThrowInternalException;
    Result := 0;
  end;
...
function TdxFloatingObjectHorizontalPositionCalculator.
  CalculateAbsoluteFloatingObjectHorizontalAlignmentPosition
  (AAlignment: TdxFloatingObjectHorizontalPositionAlignment;
  AAlignBounds: TRect; AActualWidth, APageIndex: Integer): Integer;
begin
  case AAlignment of
    ...
    TdxFloatingObjectHorizontalPositionAlignment.Center:
      Result := Trunc((AAlignBounds.Right + AAlignBounds.Left) / 2 -
        FUnitConverter.ToLayoutUnits(AActualWidth) / 2);
  else
    TdxRichEditExceptions.ThrowInternalException;
    Exit(0);
  end;
...
function TdxFloatingObjectHorizontalPositionCalculator.
  CalculateAbsoluteFloatingObjectWidth(const ALocation
  : IdxFloatingObjectLocation;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
begin
  if not ALocation.UseRelativeWidth or (ALocation.RelativeWidth.Width = 0) then
    ...
    Result := CalculateAbsoluteFloatingObjectWidthCore(ALocation,
      APlacementInfo);
end;

function TdxFloatingObjectHorizontalPositionCalculator.
  CalculateAbsoluteFloatingObjectWidthCore(const ALocation
  : IdxFloatingObjectLocation;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
var
...
begin
  ...
  Result := Trunc(ARelativeWidth.Width / 100000 * GetPercentBaseWidth
    (ARelativeWidth.From, APlacementInfo));
end;

function TdxFloatingObjectHorizontalPositionCalculator.
  CalculateAbsoluteFloatingObjectX(const ALocation: IdxFloatingObjectLocation;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo;
  AActualWidth: Integer): Integer;
var
  AAlignBounds: TRect;
...
begin
  if ALocation.HorizontalPositionAlignment =
    TdxFloatingObjectHorizontalPositionAlignment.None then
  begin
    AOffsetX := ALocation.OffsetX;
    if ALocation.PercentOffsetX <> 0 then
    begin
      APercentBaseWidth := CalculateFloatingObjectOffsetPercentBase
        (ALocation.HorizontalPositionType, APlacementInfo);
      AOffsetX := Trunc(ALocation.PercentOffsetX / 100000 * APercentBaseWidth);
    end;
    Result := CalculateAbsoluteFloatingObjectXCore
      (ALocation.HorizontalPositionType, AOffsetX, APlacementInfo);
  end
  else
  begin
    AAlignBounds := CalculateAlignBounds(ALocation, APlacementInfo);
...
begin
  case AHorizontalPositionType of
    ...
    TdxFloatingObjectHorizontalPositionType.OutsideMargin,
      ...
      Result := FUnitConverter.ToLayoutUnits(AOffsetX) +
        APlacementInfo.PageClientBounds.Right;
...
function TdxFloatingObjectHorizontalPositionCalculator.CalculateAlignBounds
  (const ALocation: IdxFloatingObjectLocation;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): TRect;
var
  ...
  case ALocation.HorizontalPositionType of
    TdxFloatingObjectHorizontalPositionType.LeftMargin,
      ...
      begin
        ...
        Result.InitSize(APageBounds.Left, APageBounds.Top,
          APlacementInfo.PageClientBounds.Left - APageBounds.Left,
          APageBounds.Height);
      end;
    TdxFloatingObjectHorizontalPositionType.Page:
      Result := APlacementInfo.PageBounds;
    ...
    TdxFloatingObjectHorizontalPositionType.OutsideMargin,
      ...
      begin
        ...
        Result.InitSize(APageClientBounds.Right, APageBounds.Top,
          APageBounds.Right - APageClientBounds.Right, APageBounds.Height);
      end;
    TdxFloatingObjectHorizontalPositionType.Margin:
      Result := APlacementInfo.PageClientBounds;
    TdxFloatingObjectHorizontalPositionType.Character:
...
function TdxFloatingObjectHorizontalPositionCalculator.
  CalculateFloatingObjectOffsetPercentBase
  (AType: TdxFloatingObjectHorizontalPositionType;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
begin
  case AType of
    ...
    TdxFloatingObjectHorizontalPositionType.Margin:
      Result := FUnitConverter.ToModelUnits
        (APlacementInfo.PageClientBounds.Width);
    TdxFloatingObjectHorizontalPositionType.OutsideMargin,
      TdxFloatingObjectHorizontalPositionType.LeftMargin:
      Result := FUnitConverter.ToModelUnits(APlacementInfo.PageClientBounds.Left
        - APlacementInfo.PageBounds.Left);
    TdxFloatingObjectHorizontalPositionType.InsideMargin,
      TdxFloatingObjectHorizontalPositionType.RightMargin:
      Result := FUnitConverter.ToModelUnits
        (APlacementInfo.PageClientBounds.Right -
        APlacementInfo.PageBounds.Right);
  else
    Result := FUnitConverter.ToModelUnits
      (APlacementInfo.PageClientBounds.Width);
  end;
...
begin
  case AHorizontalPositionType of
    ...
    TdxFloatingObjectHorizontalPositionType.OutsideMargin,
      TdxFloatingObjectHorizontalPositionType.RightMargin:
      Result := FUnitConverter.ToModelUnits
        (X - APlacementInfo.PageClientBounds.Right);
  else
...
begin
  ...
  case AFrom of
    ...
    TdxFloatingObjectRelativeFromHorizontal.Margin:
      Result := FUnitConverter.ToModelUnits
        (APlacementInfo.PageClientBounds.Width);
    TdxFloatingObjectRelativeFromHorizontal.OutsideMargin,
      TdxFloatingObjectRelativeFromHorizontal.LeftMargin:
      Result := FUnitConverter.ToModelUnits(APlacementInfo.PageClientBounds.Left
        - APlacementInfo.PageBounds.Left);
    TdxFloatingObjectRelativeFromHorizontal.InsideMargin,
      TdxFloatingObjectRelativeFromHorizontal.RightMargin:
      Result := FUnitConverter.ToModelUnits(APlacementInfo.PageBounds.Right -
        APlacementInfo.PageClientBounds.Right);
  else
    TdxRichEditExceptions.ThrowInternalException;
  end;
...
function TdxFloatingObjectVerticalPositionCalculator.
  CalculateAbsoluteFloatingObjectHeight(const ALocation
  : IdxFloatingObjectLocation;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
begin
  if not ALocation.UseRelativeHeight or (ALocation.RelativeHeight.Height = 0)
  then
    Result := ALocation.ActualHeight
  else
    Result := CalculateAbsoluteFloatingObjectHeightCore(ALocation,
      APlacementInfo);
end;

function TdxFloatingObjectVerticalPositionCalculator.
  CalculateAbsoluteFloatingObjectHeightCore(const ALocation
  : IdxFloatingObjectLocation;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
var
...
begin
  ...
  Result := Trunc(ARelativeHeight.Height / 100000.0 *
    GetPercentBaseHeight(ARelativeHeight.From, APlacementInfo));
end;

function TdxFloatingObjectVerticalPositionCalculator.
  CalculateAbsoluteFloatingObjectVerticalAlignmentPosition
  (AAlignment: TdxFloatingObjectVerticalPositionAlignment;
  const AAlignBounds: TRect; AActualHeight: Integer): Integer;
begin
  case AAlignment of
    ...
    TdxFloatingObjectVerticalPositionAlignment.Center:
      Result := Trunc((AAlignBounds.Bottom + AAlignBounds.Top) / 2 -
        FUnitConverter.ToLayoutUnits(AActualHeight) / 2);
  else
    TdxRichEditExceptions.ThrowInternalException;
    Exit(0);
  end;
...
function TdxFloatingObjectVerticalPositionCalculator.
  CalculateAbsoluteFloatingObjectY(const ALocation: IdxFloatingObjectLocation;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo;
  AActualHeight: Integer): Integer;
var
  AAlignBounds: TRect;
...
begin
  if ALocation.VerticalPositionAlignment =
    TdxFloatingObjectVerticalPositionAlignment.None then
  begin
    AOffsetY := ALocation.OffsetY;
    if ALocation.PercentOffsetY <> 0 then
    begin
      APercentBaseWidth := CalculateFloatingObjectOffsetPercentBase
        (ALocation.VerticalPositionType, APlacementInfo);
      AOffsetY := Trunc(ALocation.PercentOffsetY / 100000 * APercentBaseWidth);
    end;
    Result := CalculateAbsoluteFloatingObjectYCore
      (ALocation.VerticalPositionType, AOffsetY, APlacementInfo);
  end
  ...
  begin
    AAlignBounds := CalculateAlignBounds(ALocation, APlacementInfo);
    Result := CalculateAbsoluteFloatingObjectVerticalAlignmentPosition
      (ALocation.VerticalPositionAlignment, AAlignBounds, AActualHeight);
  end;
end;
...
begin
  case AType of
    ...
    TdxFloatingObjectVerticalPositionType.Page,
      ...
      Result := APlacementInfo.PageBounds.Top + FUnitConverter.ToLayoutUnits
        (AOffsetY);
    TdxFloatingObjectVerticalPositionType.OutsideMargin,
      TdxFloatingObjectVerticalPositionType.BottomMargin:
      Result := APlacementInfo.PageBounds.Bottom + FUnitConverter.ToLayoutUnits
        (AOffsetY);
    TdxFloatingObjectVerticalPositionType.Margin:
      Result := APlacementInfo.ColumnBounds.Top + FUnitConverter.ToLayoutUnits
        (AOffsetY);
  else
    TdxRichEditExceptions.ThrowInternalException;
    Exit(0);
...
function TdxFloatingObjectVerticalPositionCalculator.CalculateAlignBounds
  (const ALocation: IdxFloatingObjectLocation;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): TRect;
var
  APageBounds, APageClientBounds: TRect;
  ...
  case ALocation.VerticalPositionType of
    TdxFloatingObjectVerticalPositionType.TopMargin,
      ...
      begin
        APageBounds := APlacementInfo.PageBounds;
        APageClientBounds := APlacementInfo.PageClientBounds;
        Result := TRect.CreateSize(APageBounds.Left, APageBounds.Top,
          APageBounds.Width, APageClientBounds.Top - APageBounds.Top);
      end;
    TdxFloatingObjectVerticalPositionType.Page:
      Result := APlacementInfo.PageBounds;
    TdxFloatingObjectVerticalPositionType.OutsideMargin,
      ...
      begin
        APageBounds := APlacementInfo.PageBounds;
        APageClientBounds := APlacementInfo.PageClientBounds;
        Result := TRect.CreateSize(APageBounds.Left, APageClientBounds.Bottom,
          APageBounds.Width, APageBounds.Bottom - APageClientBounds.Bottom);
      end;
    TdxFloatingObjectVerticalPositionType.Margin:
      Result := APlacementInfo.PageClientBounds;
    TdxFloatingObjectVerticalPositionType.Line,
...
begin
  case AType of
    ...
    TdxFloatingObjectVerticalPositionType.Margin:
      Result := FUnitConverter.ToModelUnits
        (APlacementInfo.PageClientBounds.Height);
    TdxFloatingObjectVerticalPositionType.OutsideMargin,
      TdxFloatingObjectVerticalPositionType.InsideMargin,
      TdxFloatingObjectVerticalPositionType.TopMargin:
      Result := FUnitConverter.ToModelUnits(APlacementInfo.PageClientBounds.Top
        - APlacementInfo.PageBounds.Top);
    TdxFloatingObjectVerticalPositionType.BottomMargin:
      Result := FUnitConverter.ToModelUnits
        (APlacementInfo.PageClientBounds.Bottom -
        APlacementInfo.PageBounds.Bottom);
  else
    Result := FUnitConverter.ToModelUnits
      (APlacementInfo.PageClientBounds.Height);
  end;
...
begin
  case AVerticalPositionType of
    ...
    TdxFloatingObjectVerticalPositionType.BottomMargin:
      Result := FUnitConverter.ToModelUnits
        (Y - APlacementInfo.PageBounds.Bottom);
    TdxFloatingObjectVerticalPositionType.Margin:
      Result := FUnitConverter.ToModelUnits
        (Y - APlacementInfo.ColumnBounds.Top);
  else
    TdxRichEditExceptions.ThrowInternalException;
    Exit(0);
  end;
...
function TdxFloatingObjectVerticalPositionCalculator.GetPercentBaseHeight
  (AFrom: TdxFloatingObjectRelativeFromVertical;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
begin
  Result := 0;
  case AFrom of
    ...
    TdxFloatingObjectRelativeFromVertical.BottomMargin:
      Result := FUnitConverter.ToModelUnits(APlacementInfo.PageBounds.Bottom -
        APlacementInfo.PageClientBounds.Bottom);
  else
    TdxRichEditExceptions.ThrowInternalException;
  end;
...
constructor TdxFloatingObjectsCurrentHorizontalPositionController.TPositionInfo.
  Create(APosition, ATextAreaIndex: Integer);
begin
  Position := APosition;
...
constructor TdxFloatingObjectsCurrentHorizontalPositionController.Create
  (ARowsController: TdxRowsController; APosition: Integer);
begin
  inherited Create(ARowsController, APosition);
  FMaxRowHeight := -1;
  FMinLeftArea := ARowsController.DocumentModel.LayoutUnitConverter.
    TwipsToLayoutUnits(180);
  FMinArea := ARowsController.DocumentModel.LayoutUnitConverter.
    TwipsToLayoutUnits(144);
end;
...
function TdxFloatingObjectsCurrentHorizontalPositionController.
  AdvanceHorizontalPositionToNextTextArea: Boolean;
begin
...
procedure TdxFloatingObjectsCurrentHorizontalPositionController.
  AppendRowBoxRange(ABoxRanges: TdxRowBoxRangeCollection;
  AFirstBoxIndex, ALastBoxIndex, ATextAreaIndex: Integer);
var
  ACurrentRow: TdxRow;
...
begin
  ...
  ALeft := Max(FTextAreas[ATextAreaIndex].Start,
    ACurrentRow.Boxes[AFirstBoxIndex].Bounds.Left);
  ARight := FTextAreas[ATextAreaIndex].&End;
  ACurrentRowBounds := ACurrentRow.Bounds;
  ABounds := TRect.CreateSize(ALeft, ACurrentRowBounds.Top,
    Max(ARight - ALeft, 0), ACurrentRowBounds.Height);
  ABoxRanges.Add(TdxRowBoxRange.Create(AFirstBoxIndex, ALastBoxIndex, ABounds));
end;

function TdxFloatingObjectsCurrentHorizontalPositionController.
  AreTextAreasChanged(APrevTextAreas, ATextAreas: TList<TdxTextArea>): Boolean;
var
  I, ACount: Integer;
begin
  ...
  if ACount <> APrevTextAreas.Count then
    Exit(True);
  for I := 0 to ACount - 1 do
    if (APrevTextAreas[I].Start <> ATextAreas[I].Start) or
      (APrevTextAreas[I].&End <> ATextAreas[I].&End) then
      Exit(True);
...
function TdxFloatingObjectsCurrentHorizontalPositionController.
  CalculateBoxBounds(ABoxInfo: TdxBoxInfo): TRect;
var
...
begin
  ...
  begin
    ...
    if not(ABoxInfo.Box is TdxSpaceBoxa) and
      not(ABoxInfo.Box is TdxSingleSpaceBox) then
      RowsController.UpdateCurrentRowHeight(ABoxInfo);
    if FTextAreas.Count <= 0 then
      Exit(inherited CalculateBoxBounds(ABoxInfo));
    Assert(FTextAreas.Count > 0);
  end;
  if (CurrentHorizontalPosition + ABoxInfo.Size.Width > FTextAreas
    [FCurrentTextAreaIndex].&End) and ShouldBeMovedToNextTextArea
    (TdxBox(ABoxInfo.Box)) then
...
function TdxFloatingObjectsCurrentHorizontalPositionController.
  CalculateTextAreas(AParagraphFrameItems: TdxParagraphFrameBoxList;
  AFloatingObjectItems: TdxFloatingObjectBoxList; const ABounds: TRect)
  : TList<TdxTextArea>;
var
...
begin
  ...
  try
    ...
    try
      ...
      try
        ...
        for I := 0 to AParagraphFrameItems.Count - 1 do
          RowsController.ParagraphFramesLayout.ProcessParagraphFrame
            (AParagraphFrameItems[I], AProcessedParagraphFrames,
            ATextAreas, ABounds);
        for I := 0 to AFloatingObjectItems.Count - 1 do
          RowsController.FloatingObjectsLayout.ProcessFloatingObject
            (AFloatingObjectItems[I], AProcessedFloatingObjects,
            ATextAreas, ABounds);
      finally
    ...
    ATextAreas.Sort;
    AKeepInitialArea := ((Result.Count = 1) and (Result[0].Start = ALeft)) and
      (Result[0].&End = ARight);
...
procedure TdxFloatingObjectsCurrentHorizontalPositionController.RemoveShortAreas
  (AAreas: TList<TdxTextArea>; ALeft: Integer; ARight: Integer);
var
...
begin
  ...
  begin
    ...
    if (((AArea.Start = ALeft) and (ALength < FMinLeftArea))) or
      (((AArea.Start <> ALeft) and (ALength < FMinArea))) then
      AAreas.Delete(I);
  end;
end;

function TdxFloatingObjectsCurrentHorizontalPositionController.
  CanFitBoxToCurrentRow(const ABoxSize: TSize): Boolean;
var
  I: Integer;
begin
  if RowsController.SuppressHorizontalOverfull then
  ...
  if CurrentHorizontalPosition + ABoxSize.Width <= FTextAreas
    [FCurrentTextAreaIndex].&End then
    Exit(True);
...
function TdxFloatingObjectsCurrentHorizontalPositionController.
  CanFitBoxToTextArea(ATextAreaIndex: Integer; const ABoxSize: TSize): Boolean;
begin
  Result := GetInitialPosition(ATextAreaIndex) + ABoxSize.Width <= FTextAreas
    [ATextAreaIndex].&End;
end;

function TdxFloatingObjectsCurrentHorizontalPositionController.
  CanFitCurrentRowToColumn(ANewRowHeight: Integer)
  : TdxCanFitCurrentRowToColumnResult;
var
...
begin
  ...
  ATextAreasRecreated := DoCurrentRowHeightChanged(ANewRowHeight,
    ACurrentRowBounds, False, False);
  ...
  begin
    ...
    if ACurrentRowBounds.Bottom > RowsController.CurrentColumn.Bounds.Bottom
    then
    begin
      if RowsController.CurrentColumn.Rows.Count = 0 then
        ATextAreasRecreated := DoCurrentRowHeightChanged(ANewRowHeight,
          ACurrentRowBounds, False, True);
      RowsController.CurrentRow.Bounds := ACurrentRowBounds;
      if ATextAreasRecreated then
        Result := TdxCanFitCurrentRowToColumnResult.TextAreasRecreated;
      Exit;
    ...
    ARecreated := DoCurrentRowHeightChanged(ANewRowHeight, ACurrentRowBounds,
      False, False);
...
begin
  ...
  Result := CurrentHorizontalPosition + ABoxSize.Width <= FTextAreas
    [FCurrentTextAreaIndex].&End;
end;

function TdxFloatingObjectsCurrentHorizontalPositionController.
  GetTextAreaForTable: TdxTextArea;
begin
...
begin
  ...
  begin
    ...
    InnerCurrentHorizontalPosition :=
      GetInitialPosition(FCurrentTextAreaIndex, 0);
  end;
end;

function TdxFloatingObjectsCurrentHorizontalPositionController.
  MoveCurrentRowDownToFitTable(ATableWidth, ATableTop: Integer): Integer;
var
  Y, AMaxY: Integer;
...
begin
  ...
  begin
    ATextAreasRecreated := DoCurrentRowHeightChanged(0, ATopTableRowBounds,
      False, False);
    if ATextAreasRecreated or (Y = ATableTop) then
    begin
      ATableFit := (FTextAreas.Count = 1) and
        (FTextAreas[0].Width >= ATableWidth);
      if ATableFit then
...
begin
  ...
  AFirstBoxIndex := 0;
  AComparable := TdxTextAreaAndXComparable.Create
    (ABoxes[AFirstBoxIndex].Bounds.Left);
  TdxAlgorithms<TdxTextArea>.BinarySearch(FTextAreas, AComparable.CompareTo,
    ATextAreaIndex);
  Assert(ATextAreaIndex >= 0);
  for I := 1 to ACount - 1 do
    if ABoxes[I - 1].Bounds.Right <> ABoxes[I].Bounds.Left then
    begin
      AppendRowBoxRange(ACurrentRow.BoxRanges, AFirstBoxIndex, I - 1,
        ATextAreaIndex);
      AFirstBoxIndex := I;
  ...
  AppendRowBoxRange(ACurrentRow.BoxRanges, AFirstBoxIndex, ACount - 1,
    ATextAreaIndex);
end;

procedure TdxFloatingObjectsCurrentHorizontalPositionController.
  OnCurrentRowHeightChanged(AKeepTextAreas: Boolean);
var
  ACurrentRowBounds: TRect;
begin
  ACurrentRowBounds := RowsController.CurrentRow.Bounds;
  DoCurrentRowHeightChanged(ACurrentRowBounds.Height, ACurrentRowBounds,
    AKeepTextAreas, False);
end;
...
procedure TdxFloatingObjectsCurrentHorizontalPositionController.
  SetCurrentHorizontalPosition(AValue: Integer);
begin
...
procedure TdxFloatingObjectsCurrentHorizontalPositionController.
  DoSetCurrentHorizontalPosition(const APosition: TPositionInfo);
begin
...
function TdxFloatingObjectsCurrentHorizontalPositionController.
  GetAvailableTextAreaInitialPosition(APreferredTextAreaIndex: Integer)
  : TPositionInfo;
var
...
function TdxFloatingObjectsCurrentHorizontalPositionController.
  ShouldBeMovedToNextTextArea(ABox: TdxBox): Boolean;
begin
  Result := (ABox <> nil) and
    not(ABox.HasSpaceBox or (ABox is TdxParagraphMarkBox) or
    (ABox is TdxLineBreakBox) or (ABox is TdxSectionMarkBox) or
    (ABox is TdxPageBreakBox) or (ABox is TdxColumnBreakBox));
end;

procedure TdxFloatingObjectsCurrentHorizontalPositionController.
  TryCreateDefaultBoxRange(ACurrentRow: TdxRow);
begin
  if (FTextAreas.Count = 1) and (FTextAreas[0].Start = ACurrentRow.Bounds.Left)
    and (FTextAreas[0].&End = ACurrentRow.Bounds.Right) then
    Exit;
...
function TdxFloatingObjectsCurrentHorizontalPositionController.
  UpdateCurrentTextAreaIndex: Boolean;
var
...
begin
  AComparable := TdxTextAreaAndXComparable.Create
    (InnerCurrentHorizontalPosition);
  if not TdxAlgorithms<TdxTextArea>.BinarySearch(FTextAreas,
    AComparable.CompareTo, ANewTextAreaIndex) then
  begin
...
function TdxFloatingObjectsCurrentHorizontalPositionController.GetTextOffset
  (ATextAreaIndex: Integer): Integer;
begin
  if IsCurrentRowEmpty then
  begin
    if FTextAreas[ATextAreaIndex].Start = RowsController.CurrentRow.Bounds.Left
    then
      Result := 0
    else
...
function TdxFloatingObjectsCurrentHorizontalPositionController.
  GetInitialPosition(ATextAreaIndex: Integer): Integer;
begin
  Result := GetInitialPosition(ATextAreaIndex, GetTextOffset(ATextAreaIndex));
end;

function TdxFloatingObjectsCurrentHorizontalPositionController.
  GetInitialPosition(ATextAreaIndex, ATextOffset: Integer): Integer;
begin
  Result := FTextAreas[ATextAreaIndex].Start + ATextOffset;
end;

function TdxFloatingObjectsCurrentHorizontalPositionController.
  DoCurrentRowHeightChanged(AHeight: Integer; const ACurrentRowBounds: TRect;
  AKeepTextAreas, AIgnoreFloatingObjects: Boolean): Boolean;
var
    ...
    try
      ...
      try
        if (APrevTextAreas = nil) or not AKeepTextAreas then
          FTextAreas := CalculateTextAreas(AParagraphFrames,
            AFloatingObjects, ABounds);

        if FTextAreas.Count > 0 then
        begin
          AInitialPosition := GetAvailableTextAreaInitialPosition(0);
          InnerCurrentHorizontalPosition := Max(InnerCurrentHorizontalPosition,
            AInitialPosition.Position);
          UpdateCurrentTextAreaIndex;
        end;
...
constructor TdxSyllableBoxIterator.Create(AIterator: TdxParagraphBoxIterator;
  const AHyphenationService: IdxHyphenationService);
begin
  inherited Create(AIterator.Paragraph, AIterator.PieceTable,
    AIterator.VisibleTextFilter);
...
begin
  Result := ((RunIndex = FEndPos.RunIndex) and (Offset >= FEndPos.Offset)) or
    (RunIndex > FEndPos.RunIndex);
end;
...
begin
  Result := (ACh = TdxCharacters.LineBreak) or (ACh = TdxCharacters.PageBreak)
    or (ACh = TdxCharacters.ColumnBreak);
end;
...
procedure TdxSyllableBoxIterator.SetPosition(ARunIndex: TdxRunIndex;
  AOffset: Integer);
var
  I, ACount: Integer;
...
begin
  ...
  begin
    ...
    if (APos.RunIndex > ARunIndex) or
      ((APos.RunIndex = ARunIndex) and (APos.Offset > AOffset)) then
    begin
      FHyphenPosIndex := I;
      FHyphenPos := FHyphenPositions[FHyphenPosIndex];
      Break;
...
procedure TdxFloatingObjectSizeController.UpdateFloatingObjectBox
  (AFloatingObjectAnchorBox: TdxFloatingObjectAnchorBox);
var
  AObjectAnchorRun: TdxFloatingObjectAnchorRun;
  ...
  ARotatedShapeBounds, AShapeBounds, ARect { INDENTIFIER REDECLARED } ,
    AActualSizeBounds: TRect;
...
begin
  ...
  ATextBoxContent := Safe<TdxTextBoxFloatingObjectContent>.Cast
    (AObjectAnchorRun.Content);
  ...
  ARotatedLocation := CreateRotatedFloatingObjectLocation
    (AFloatingObjectProperties, AObjectAnchorRun.Shape.Rotation, AAutoHeight);
  ARotatedShapeBounds := CalculateAbsoluteFloatingObjectShapeBounds
    (ARotatedLocation, AObjectAnchorRun.Shape, AIsTextBox);
  ALocation := CreateFloatingObjectLocation(AFloatingObjectProperties,
    AAutoHeight);
  AShapeBounds := CalculateAbsoluteFloatingObjectShapeBounds(ALocation,
    AObjectAnchorRun.Shape, AIsTextBox);

  if AFloatingObjectProperties.HorizontalPositionAlignment <>
    TdxFloatingObjectHorizontalPositionAlignment.None then
    AShapeBounds := CenterRectangleHorizontally(AShapeBounds,
      ARotatedShapeBounds)
  else
  begin
    ARect := CenterRectangleHorizontally(ARotatedShapeBounds, AShapeBounds);
    ARotatedShapeBounds := ValidateRotatedShapeHorizontalPosition(ARect,
      AFloatingObjectProperties);
    AShapeBounds := CenterRectangleHorizontally(AShapeBounds,
      ARotatedShapeBounds);
  end;

  if AFloatingObjectProperties.VerticalPositionAlignment <>
    TdxFloatingObjectVerticalPositionAlignment.None then
  ...
  begin
    ...
    ARotatedShapeBounds := ValidateRotatedShapeVerticalPosition(ARect,
      AFloatingObjectProperties);
    AShapeBounds := CenterRectangleVertically(AShapeBounds,
      ARotatedShapeBounds);
  end;

  AFloatingObjectAnchorBox.ShapeBounds := AShapeBounds;
  AFloatingObjectAnchorBox.ContentBounds :=
    CalculateAbsoluteFloatingObjectContentBounds(AFloatingObjectProperties,
    AObjectAnchorRun.Shape, AFloatingObjectAnchorBox.ShapeBounds);
  AFloatingObjectAnchorBox.ActualBounds :=
    CalculateActualAbsoluteFloatingObjectBounds(AFloatingObjectProperties,
    ARotatedShapeBounds);
  ...
  begin
    ...
    AOutlineWidth := AConverter.ToLayoutUnits
      (AObjectAnchorRun.Shape.OutlineWidth);
    ...
    AFloatingObjectAnchorBox.SetActualSizeBounds
      (AFloatingObjectAnchorBox.ContentBounds);
end;

procedure TdxFloatingObjectSizeController.UpdateParagraphFrameBox
  (AParagraphFrameBox: TdxParagraphFrameBox);
var
  ...
  AConverter: TdxDocumentModelUnitToLayoutUnitConverter;
  ALeftBorderWidthWithOffset, ARightBorderWidthWithOffset,
    ATopBorderWidthWithOffset, ABottomBorderWidthWithOffset, APadding,
    AHorizontalPadding, ABorderOffset, ALeftPosition, ARightPosition: Integer;
begin
  AParagraphProperties := AParagraphFrameBox.GetParagraph.ParagraphProperties;
  AFrameProperties := AParagraphFrameBox.GetFrameProperties;
  try
    AShapeBounds := CalculateAbsoluteParagraphFrameShapeBounds
      (AFrameProperties);
    ...
    ALeftBorderWidthWithOffset := GetActualBorderWidth
      (AParagraphProperties.UseLeftBorder, AParagraphProperties.LeftBorder,
      AConverter);
    ARightBorderWidthWithOffset := GetActualBorderWidth
      (AParagraphProperties.UseRightBorder, AParagraphProperties.RightBorder,
      AConverter);
    ATopBorderWidthWithOffset := GetActualBorderWidth
      (AParagraphProperties.UseTopBorder, AParagraphProperties.TopBorder,
      AConverter);
    ABottomBorderWidthWithOffset := GetActualBorderWidth
      (AParagraphProperties.UseBottomBorder, AParagraphProperties.BottomBorder,
      AConverter);
    ...
    if ALeftBorderWidthWithOffset <> 0 then
      ALeftPosition := AHorizontalPadding + ALeftBorderWidthWithOffset +
        AConverter.ToLayoutUnits(ABorderOffset)
    else
      ALeftPosition := 0;
    if ARightBorderWidthWithOffset <> 0 then
      ARightPosition := AHorizontalPadding + ARightBorderWidthWithOffset +
        AConverter.ToLayoutUnits(ABorderOffset)
    else
      ARightPosition := 0;
    ...
    AParagraphFrameBox.ShapeBounds :=
      TRect.CreateSize(ANewShapeBounds.X - ALeftPosition, ANewShapeBounds.Y,
      ANewShapeBounds.Width + ALeftPosition + ARightPosition,
      ANewShapeBounds.Height);

    AParagraphFrameBox.ContentBounds := TRect.CreateSize(ANewShapeBounds.X,
      ANewShapeBounds.Y + ATopBorderWidthWithOffset, ANewShapeBounds.Width,
      ANewShapeBounds.Height - ATopBorderWidthWithOffset -
      ABottomBorderWidthWithOffset);
...
function TdxFloatingObjectSizeController.ValidateRotatedShapeHorizontalPosition
  (const ARect: TRect; AProperties: TdxFloatingObjectProperties): TRect;
begin
  Result := ARect;
end;

function TdxFloatingObjectSizeController.ValidateRotatedShapeVerticalPosition
  (const ARect: TRect; AProperties: TdxFloatingObjectProperties): TRect;
begin
  Result := ARect;
end;

function TdxFloatingObjectSizeController.CreateRotatedFloatingObjectLocation
  (const AProperties: IdxFloatingObjectLocation; AAngle: Integer;
  AAutoHeight: Boolean): IdxFloatingObjectLocation;
var
  AActualSize: TSize;
...
begin
  ...
  try
    ...
    begin
      ...
      AActualSize := TSize.Create(AFrameProperties.Width,
        AFrameProperties.Height);
    end;
    ABoundingRectangle := TdxRectangleUtils.BoundingRectangle
      (TRect.CreateSize(AActualSize), AMatrix);
    ARelativeBoundingRectangle := TdxRectangleUtils.BoundingRectangle
      (TRect.CreateSize(cxSize(AProperties.RelativeWidth.Width,
      AProperties.RelativeHeight.Height)), AMatrix);
  finally
    AMatrix.Free;
  end;
  ...
  AObjectLocation.HorizontalPositionAlignment :=
    AProperties.HorizontalPositionAlignment;
  AObjectLocation.VerticalPositionAlignment :=
    AProperties.VerticalPositionAlignment;
  ...
  begin
    ...
    AObjectLocation.RelativeWidth := TdxFloatingObjectRelativeWidth.Create
      (AProperties.RelativeWidth.From, ARelativeBoundingRectangle.Width);
  end;
  if AProperties.UseRelativeHeight and not AAutoHeight then
  begin
    AObjectLocation.UseRelativeHeight := True;
    AObjectLocation.RelativeHeight := TdxFloatingObjectRelativeHeight.Create
      (AProperties.RelativeHeight.From, ARelativeBoundingRectangle.Height);
  end;
  if (AFloatingObjectProperties <> nil) and AFloatingObjectProperties.UsePercentOffset
  then
  begin
...
function TdxFloatingObjectSizeController.CreateFloatingObjectLocation
  (AProperties: TdxFloatingObjectProperties; AAutoHeight: Boolean)
  : IdxFloatingObjectLocation;
var
...
begin
  ...
  ALocation.HorizontalPositionAlignment :=
    AProperties.HorizontalPositionAlignment;
...
function TdxFloatingObjectSizeController.
  CalculateAbsoluteFloatingObjectShapeBounds(const ALocation
  : IdxFloatingObjectLocation; AShape: TdxShape; AIsTextBox: Boolean): TRect;
var
  AUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
  ABounds: TRect;
  APosition: TPoint;
...
function TdxFloatingObjectSizeController.
  CalculateAbsoluteParagraphFrameShapeBounds(const ALocation
  : IdxParagraphFrameLocation): TRect;
var
  AUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
  ABounds: TRect;
...
function TdxFloatingObjectSizeController.CenterRectangleHorizontally
  (const ARectangle: TRect; const AWhere: TRect): TRect;
begin
  Result := ARectangle;
  Result.X := AWhere.Left + (AWhere.Width - ARectangle.Width) div 2;
end;

function TdxFloatingObjectSizeController.CenterRectangleVertically
  (const ARectangle: TRect; const AWhere: TRect): TRect;
begin
  Result := ARectangle;
...
function TdxFloatingObjectSizeController.
  CalculateAbsoluteFloatingObjectContentBounds(const AFloatingObjectProperties
  : IdxFloatingObjectLocation; AShape: TdxShape;
  const AShapeBounds: TRect): TRect;
var
  AUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
  AWidth: Integer;
begin
...
function TdxFloatingObjectSizeController.
  CalculateActualAbsoluteFloatingObjectBounds(AFloatingObjectProperties
  : TdxFloatingObjectProperties; const ABounds: TRect): TRect;
var
  AUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
begin
  AUnitConverter := DocumentModel.ToDocumentLayoutUnitConverter;
  Result := ABounds;
  Result.X := Result.Left - AUnitConverter.ToLayoutUnits
    (AFloatingObjectProperties.LeftDistance);
  Result.Y := Result.Top - AUnitConverter.ToLayoutUnits
    (AFloatingObjectProperties.TopDistance);
  Result.Width := Result.Width + AUnitConverter.ToLayoutUnits
    (AFloatingObjectProperties.LeftDistance +
    AFloatingObjectProperties.RightDistance);
  Result.Height := Result.Height + AUnitConverter.ToLayoutUnits
    (AFloatingObjectProperties.TopDistance +
    AFloatingObjectProperties.BottomDistance);
end;

function TdxFloatingObjectSizeController.CalculateAbsoluteFloatingObjectBounds
  (const ALocation: IdxFloatingObjectLocation): TRect;
begin
  Result.InitSize(TSize.Create(ALocation.ActualWidth, ALocation.ActualHeight));
end;

function TdxFloatingObjectSizeController.CalculateAbsoluteParagraphFrameBounds
  (const ALocation: IdxParagraphFrameLocation): TRect;
begin
  Result.InitSize(0, 0, ALocation.Width, ALocation.Height);
end;

class function TdxFloatingObjectSizeController.GetActualBorderWidth
  (AUseBorder: Boolean; ABorder: TdxBorderInfo;
...
constructor TdxFloatingObjectSizeAndPositionController.Create(ARowsController
  : TdxRowsController);
begin
...
function TdxFloatingObjectSizeAndPositionController.GetColumnController
  : TdxCustomColumnController;
begin
...
function TdxFloatingObjectSizeAndPositionController.
  GetCurrentHorizontalPosition: Integer;
begin
...
function TdxFloatingObjectSizeAndPositionController.
  GetHorizontalPositionController: TdxCurrentHorizontalPositionController;
begin
  Result := RowsController.HorizontalPositionController;
end;

function TdxFloatingObjectSizeAndPositionController.
  CalculateAbsoluteFloatingObjectBounds(const ALocation
  : IdxFloatingObjectLocation): TRect;
var
  ASize: TSize;
  ALeft, ATop: Integer;
...
begin
  ...
  ASize := cxSize(CalculateAbsoluteFloatingObjectWidth(ALocation,
    APlacementInfo), CalculateAbsoluteFloatingObjectHeight(ALocation,
    APlacementInfo));
  ALeft := CalculateAbsoluteFloatingObjectX(ALocation, APlacementInfo,
    ASize.cx);
...
function TdxFloatingObjectSizeAndPositionController.
  CalculateAbsoluteParagraphFrameBounds(const ALocation
  : IdxParagraphFrameLocation): TRect;
var
  APlacementInfo: TdxFloatingObjectTargetPlacementInfo;
  ASize: TSize;
...
begin
  ...
  APoint.X := CalculateAbsoluteParagraphFrameX(ALocation, APlacementInfo,
    ASize.cx);
  APoint.Y := CalculateAbsoluteParagraphFrameY(ALocation, APlacementInfo,
    ASize.cy);
...
begin
  ACalculator := TdxFloatingObjectHorizontalPositionCalculator.Create
    (DocumentModel.ToDocumentLayoutUnitConverter);
  Result := ACalculator.CalculateAbsoluteFloatingObjectWidth(ALocation,
    APlacementInfo);
end;
...
begin
  ACalculator := TdxFloatingObjectVerticalPositionCalculator.Create
    (DocumentModel.ToDocumentLayoutUnitConverter);
  Result := ACalculator.CalculateAbsoluteFloatingObjectHeight(ALocation,
    APlacementInfo);
end;

function TdxFloatingObjectSizeAndPositionController.
  CalculateAbsoluteParagraphFrameX(const ALocation: IdxParagraphFrameLocation;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo;
  AActualWidth: Integer): Integer;
var
  ACalculator: TdxParagraphFrameHorizontalPositionCalculator;
begin
  ACalculator := TdxParagraphFrameHorizontalPositionCalculator.Create
    (DocumentModel.ToDocumentLayoutUnitConverter);
  Result := ACalculator.CalculateAbsoluteFloatingObjectX(ALocation,
    APlacementInfo, AActualWidth);
end;

function TdxFloatingObjectSizeAndPositionController.
  CalculateAbsoluteParagraphFrameY(const ALocation: IdxParagraphFrameLocation;
  const APlacementInfo: TdxFloatingObjectTargetPlacementInfo;
  AActualHeight: Integer): Integer;
var
  ACalculator: TdxParagraphFrameVerticalPositionCalculator;
begin
  ACalculator := TdxParagraphFrameVerticalPositionCalculator.Create
    (DocumentModel.ToDocumentLayoutUnitConverter);
  Result := ACalculator.CalculateAbsoluteFloatingObjectY(ALocation,
    APlacementInfo, AActualHeight);
end;

function TdxFloatingObjectSizeAndPositionController.
  ValidateRotatedShapeHorizontalPosition(const AShapeBounds: TRect;
...
begin
  ...
  AShapeBounds.SetLocation(Math.Max(APageBounds.Left, AShapeBounds.Left),
    AShapeBounds.Top);
  Result := AShapeBounds;
end;

function TdxFloatingObjectSizeAndPositionController.
  ValidateRotatedShapeVerticalPosition(const AShapeBounds: TRect;
  AProperties: TdxFloatingObjectProperties): TRect;
var
  APageBounds: TRect;
  ABottom: Integer;
...
begin
  ...
  if ABottom >= APageBounds.Bottom then
    AShapeBounds.SetLocation(AShapeBounds.Left, AShapeBounds.Top - ABottom +
      APageBounds.Bottom);
...
function TdxFloatingObjectSizeAndPositionController.CalculatePlacementInfo
  (const ALocation: IdxFloatingObjectLocation)
  : TdxFloatingObjectTargetPlacementInfo;
var
  APage: TdxPage;
...
begin
  ...
  begin
    Result.PageBounds := ColumnController.GetCurrentPageBounds(APage,
      CurrentColumn);
    Result.PageClientBounds := ColumnController.GetCurrentPageClientBounds
      (APage, CurrentColumn);
    Result.ColumnBounds := HorizontalPositionController.
      CalculateFloatingObjectColumnBounds(CurrentColumn);
  end
  else
  begin
    ...
    Result.ColumnBounds := HorizontalPositionController.
      CalculateFloatingObjectColumnBounds(CurrentColumn.TopLevelColumn);
  end;
...
procedure TdxFloatingObjectTargetPlacementInfo.SetColumnBounds
  (const Value: TRect);
begin
  FColumnBounds := Value;
...
class function TdxMaxWidthCalculator.GetMaxWidth
  (AAreas: TdxPageAreaCollection): Integer;
var
  ARows: TdxRowCollection;
  I: Integer;
begin
...
class function TdxMaxWidthCalculator.GetMaxWidth
  (ARows: TdxRowCollection): Integer;
var
  ALastBox: TdxBox;
  I: Integer;
begin
...
class function TdxMaxWidthCalculator.GetMaxRight
  (ARows: TdxRowCollection): Integer;
var
  I: Integer;
  ALastBox: TdxBox;
...
class function TdxMaxWidthCalculator.GetLastNonLineBreakBox
  (ARow: TdxRow): TdxBox;
var
  I: Integer;
begin
...
class function TdxMaxWidthCalculator.GetLastNonLineBreakOrSpaceBox
  (ARow: TdxRow): TdxBox;
var
  I: Integer;
  ABox: TdxBox;
...
constructor TdxParagraphFinalFormatter.Create(ADocumentLayout
  : TdxDocumentLayout);
begin
  inherited Create;
  ...
  FBookmarkCalculator := TdxBookmarkBoxCalculator.Create(PieceTable,
    ADocumentLayout.MeasurerProvider);
  FRangePermissionCalculator := TdxRangePermissionBoxCalculator.Create
    (PieceTable, ADocumentLayout.MeasurerProvider);
...
procedure TdxParagraphFinalFormatter.AlignLineNumberToBaseLine
  (ABox: TdxLineNumberBox);
var
  ARow: TdxRow;
  ARect: TRect;
begin
  ARow := ABox.Row;
  ARect := ABox.Bounds;
  ARect.Y := ARow.Bounds.Top + ARow.BaseLineOffset - ABox.CalcAscentAndFree
    (PieceTable);
  ABox.Bounds := ARect;
end;

procedure TdxParagraphFinalFormatter.ApplyTableCellsVerticalContentAlignment
...
procedure TdxParagraphFinalFormatter.ApplyTableCellVerticalContentAlignment
  (ACell: TdxTableCellViewInfo);
var
...
begin
  ...
  if ALastRowIndex < 0 then
    Exit;
  AActualContentVerticalBounds := CalculateCellContentVerticalBounds(ACell,
    FCurrentColumn.Rows[AFirstRowIndex], FCurrentColumn.Rows[ALastRowIndex]);
  ...
  AOffset := CalculateContentOffset(ACell, AActualContentVerticalBounds.Bottom -
    AActualContentVerticalBounds.Top);
  AInitialOffset := AActualContentVerticalBounds.Top - ACell.InitialContentTop;
  Dec(AOffset, AInitialOffset);
  ApplyTableCellsVerticalContentAlignment(ACell.InnerTables, AFirstRowIndex,
    ALastRowIndex, AOffset);
end;

function TdxParagraphFinalFormatter.CalcBaseBoxAscentAndFree
  (ABox: TdxBox): Integer;
begin
...
procedure TdxParagraphFinalFormatter.CalculateBackgroundHighlight(ARow: TdxRow;
  const ATightRowBounds: TRect);
var
  ABoxes: TdxBoxCollection;
  ACount: Integer;
  APrevStartRunIndex, AStartRunIndex, ACurrentRunIndex, ALastBoxRunIndex
    : TdxRunIndex;
  APrevStartBox, AStartBox, ACurrentBox, APrevBox, ALastProcessedBox,
    ALastBox: TdxBox;
  I: Integer;
...
begin
  ...
  begin
    ...
    if not Supports(PieceTable.Runs[APrevStartRunIndex],
      IdxHighlightableTextRun, ARun) then
      Continue;
  ...
  begin
    ...
    if not Supports(PieceTable.Runs[ALastBoxRunIndex], IdxHighlightableTextRun,
      ARun) then
      ARun := nil;
...
function TdxParagraphFinalFormatter.CalculateBottomPosition(AFrameBox,
  ANextFrameBox: TdxParagraphFrameBox; ARow: TdxRow;
  ACellRow: TdxTableCellRow): Integer;
begin
...
function TdxParagraphFinalFormatter.CalculateBottomRow(ARows: TdxRowCollection;
  AParagraphIndex: TdxParagraphIndex; ACellRow: TdxTableCellRow): TdxRow;
var
...
function TdxParagraphFinalFormatter.CalculateContentOffset
  (ACell: TdxTableCellViewInfo; AContentHeight: Integer): Integer;
var
...
begin
  ...
  Result := CalculateContentOffset(ACell.Cell.VerticalAlignment,
    ACellMaxContentHeight, AContentHeight);
end;

function TdxParagraphFinalFormatter.CalculateCellContentVerticalBounds
  (ACell: TdxTableCellViewInfo; AFirstRow, ALastRow: TdxRow): TRect;
var
  ARowsBounds, AInnerTablesBounds: TRect;
begin
  ARowsBounds := CalculateCellRowsVerticalBounds(ACell, AFirstRow, ALastRow);
  AInnerTablesBounds := CalculateCellInnerTablesVerticalBounds
    (ACell.InnerTables);
  if ARowsBounds.IsEqual(TRect.Null) then
    Exit(AInnerTablesBounds);
  if AInnerTablesBounds.IsEqual(TRect.Null) then
    Exit(ARowsBounds);
  Result.Init(0, Math.Min(ARowsBounds.Top, AInnerTablesBounds.Top), 0,
    Math.Max(ARowsBounds.Bottom, AInnerTablesBounds.Bottom));
end;
...
begin
  ...
  Result.Init(0, ATopAnchor.VerticalPosition, 0, ABottomAnchor.VerticalPosition
    + ABottomAnchor.BottomTextIndent);
end;

function TdxParagraphFinalFormatter.CalculateCellRowsVerticalBounds
  (ACell: TdxTableCellViewInfo; AFirstRow, ALastRow: TdxRow): TRect;
begin
  Result.Init(0, AFirstRow.Bounds.Top, 0, ALastRow.Bounds.Bottom);
end;

function TdxParagraphFinalFormatter.CalculateContentOffset(AVerticalAlignment
  : TdxVerticalAlignment; AMaxContentHeight, AContentHeight: Integer): Integer;
begin
...
procedure TdxParagraphFinalFormatter.CalculateFieldsHighlight(ARow: TdxRow;
  const ATightRowBounds: TRect);
var
...
begin
  ...
  if DocumentModel.FieldOptions.HighlightMode <> TdxFieldsHighlightMode.Always
  then
    Exit;
  AIndex := LookupFirstFieldIndexByRunIndex(ARow,
    ARow.Boxes.First.StartPos.RunIndex);
  if AIndex < 0 then
    Exit;
  ...
  begin
    ...
    if AField.FirstRunIndex > AEndRunIndex then
      Break;
    if (AField.LastRunIndex >= AStartRunIndex) and
      (AField.FirstRunIndex <= AEndRunIndex) then
    begin
      ...
      AArea := CreateFieldHighlightAreaCore(ARow, AStart, AEnd,
        ATightRowBounds, AColor);
...
procedure TdxParagraphFinalFormatter.CalculateRangePermissionHighlight
  (ARow: TdxRow; const ATightRowBounds: TRect);
var
...
begin
  ...
  if DocumentModel.RangePermissionOptions.Visibility =
    TdxRichEditRangePermissionVisibility.Hidden then
    Exit;
  ...
  begin
    ...
    if DocumentModel.ProtectionProperties.EnforceProtection and
      not PieceTable.IsPermissionGranted(ARangePermission) then
      Continue;

    AStartPosition := TdxFormatterPosition.Create
      (ARangePermission.Interval.Start.RunIndex,
      ARangePermission.Interval.Start.RunOffset, 0);
    AEndPosition := TdxFormatterPosition.Create
      (ARangePermission.Interval.&End.RunIndex,
      ARangePermission.Interval.&End.RunOffset, 0);
    if (AEndPosition >= ARow.Boxes.First.StartPos) and
      (AStartPosition <= ARow.Boxes.Last.EndPos) then
    begin
      AStart := Max(AStartRunIndex,
        ARangePermission.Interval.NormalizedStart.RunIndex);
      AEnd := Min(AEndRunIndex,
        ARangePermission.Interval.NormalizedEnd.RunIndex);
      ARow.RangePermissionHighlightAreas.Add
        (CreateRangePermissionHighlightAreaCore(ARow, AStart, AEnd,
        ATightRowBounds, ARangePermission));
    end;
  end;
end;

function TdxParagraphFinalFormatter.CalculateRowBoxesBottom
  (ARow: TdxRow): Integer;
var
  I: Integer;
  ABoxes: TdxBoxCollection;
...
function TdxParagraphFinalFormatter.CalculateSubscriptOrSuperScriptOffset
  (ABox: TdxBox): Integer;
begin
...
function TdxParagraphFinalFormatter.CalculateTightRowBounds
  (ARow: TdxRow): TRect;
var
  ABox: TdxBox;
  ABoxes: TdxBoxCollection;
...
function TdxParagraphFinalFormatter.CreateFieldHighlightAreaCore(ARow: TdxRow;
  AStart, AEnd: TdxRunIndex; const ATightRowBounds: TRect;
  AColor: TdxAlphaColor): TdxHighlightArea;
var
  ABoxes: TdxBoxCollection;
...
begin
  ...
  Result := TdxHighlightArea.Create(AColor, TRect.CreateSize(ALeft,
    ATightRowBounds.Top, ARight - ALeft, ATightRowBounds.Height));
end;

function TdxParagraphFinalFormatter.CreateRangePermissionHighlightAreaCore
  (ARow: TdxRow; AStart, AEnd: TdxRunIndex; const ATightRowBounds: TRect;
  ARangePermission: TdxRangePermission): TdxHighlightArea;
var
  ARangePermissionBoxes: TdxVisitableDocumentIntervalBoxCollection;
  ABoxes: TdxBoxCollection;
  AFirstBoxIndex, ALastBoxIndex, ALeft, ARight, ARangePermissionBoxesCount,
    I: Integer;
...
function TdxParagraphFinalFormatter.FindBoxIndex(ABoxes: TdxBoxCollection;
  AFrom: Integer; AIndexToSearch: TdxRunIndex): Integer;
var
  I, ACount: Integer;
begin
  ACount := ABoxes.Count;
...
function TdxParagraphFinalFormatter.FindRowByParagraphIndex
  (ARows: TdxRowCollection; AParagraphIndex: TdxParagraphIndex): Integer;
var
  I: Integer;
  AComparer: TdxRowParagraphComparer;
begin
  AComparer := TdxRowParagraphComparer.Create(AParagraphIndex);
  if not TdxAlgorithms1<TdxBoxBase>.BinarySearch(FCurrentColumn.Rows,
    AComparer.CompareTo, Result) then
    Exit(-Result);
...
begin
  ...
  ABottom := CalculateBottomPosition(AParagraphFrameBox, ANextParagraphFrameBox,
    ARow, ATableCellRow);
  ...
  ALeftIndent := DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits
    (AParagraph.LeftIndent);
  if (AParagraph.FirstLineIndentType = TdxParagraphFirstLineIndent.Hanging) and
    (AParagraph.FirstLineIndent > 0) then
    ALeftIndent := ALeftIndent - DocumentModel.ToDocumentLayoutUnitConverter.
      ToLayoutUnits(AParagraph.FirstLineIndent);
  ...
  ACurrentColumnBounds.Width := ACurrentColumnBounds.Width -
    DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits
    (AParagraph.RightIndent);
...
procedure TdxParagraphFinalFormatter.FormatParagraphFrames(AParagraphFrames
  : TdxParagraphFrameBoxCollection);
var
...
function TdxParagraphFinalFormatter.LookupFirstFieldIndexByRunIndex
  (ARow: TdxRow; ARunIndex: TdxRunIndex): Integer;
var
  AFields: TdxFieldCollection;
begin
  AFields := PieceTable.Fields;
...
function TdxParagraphFinalFormatter.CreateCommentHighlightAreaCore(ARow: TdxRow;
AStart: TdxRunIndex; AEnd: TdxRunIndex; const ATightRowBounds: TRect;
AComment: TdxComment): TdxHighlightArea;
begin
  NotImplemented;
  Result := TdxHighlightArea.Null;
end;

procedure TdxParagraphFinalFormatter.CalculateCommentHighlight(ARow: TdxRow;
const ATightRowBounds: TRect);
begin
  NotImplemented;
end;

procedure TdxParagraphFinalFormatter.FormateTextBoxes
...
procedure TdxParagraphFinalFormatter.SubstituteFont
...
begin
  ...
  begin
    ASubstituteFontName := AFontCache.FindSubstituteFont(ASourceFontName, ACh,
      AFontCharacterSet);
...
function TdxParagraphFinalFormatter.ShouldMergeParagraphFrameBoxes
  (AParagraphFrameBox, ANextParagraphFrameBox: TdxParagraphFrameBox;
ACellRow: TdxTableCellRow): Boolean;
var
  AParagraphIndex: TdxParagraphIndex;
...
begin
  ...
  if ANextParagraphFrameBox.ParagraphIndex - 1 <> AParagraphIndex then
    Exit;
  if (ACellRow <> nil) and
    (ACellRow.CellViewInfo.Cell.EndParagraphIndex = AParagraphIndex) then
    Exit;
...
procedure TdxParagraphFinalFormatter.UpdateCurrentParagraph
  (AParagraph: TdxSimpleParagraph);
begin
  FreeAndNil(FLineSpacingCalculator);
  FCurrentParagraph := AParagraph;
  FLineSpacingCalculator := TdxLineSpacingCalculatorBase.
    GetLineSpacingCalculator(FCurrentParagraph);
  FAlignmentCalculator := TdxParagraphAlignmentCalculatorBase.
    GetAlignmentCalculator(AParagraph.Alignment);
end;
...
begin
  ...
  begin
    ...
    try
      ...
      ABox.CalculatedText := ARun.FieldResultFormatting.GetValue(nil,
        DocumentModel);
      SubstituteFont(ABox);
      ABoxInfo := TdxBoxInfo.Create;
      try
...
function TdxStateRowBreakBase.FinishLine(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(False);
  Result := TdxCompleteFormattingResult.Success;
...
function TdxStateRowBreakBase.FinishPage(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(False);
  Result := TdxCompleteFormattingResult.Success;
...
function TdxStateRowBreakBase.FinishColumn(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(False);
  Result := TdxCompleteFormattingResult.Success;
...
function TdxStateRowPageBreakAtParagraphStart.GetType
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowPageBreakAtParagraphStart;
end;

function TdxStateRowPageBreakAtParagraphStart.ContinueFormat
  : TdxStateContinueFormatResult;
begin
  PreviousState.StateAfterFinalizePage :=
    TdxParagraphBoxFormatterState.ParagraphStartAfterBreak;
  Result := inherited ContinueFormat;
end;
...
function TdxStateRowColumnBreakAtParagraphStart.GetType
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowColumnBreakAtParagraphStart;
end;

function TdxStateRowColumnBreakAtParagraphStart.ContinueFormat
  : TdxStateContinueFormatResult;
begin
  PreviousState.StateAfterFinalizeColumn :=
    TdxParagraphBoxFormatterState.ParagraphStartAfterBreak;
  Result := inherited ContinueFormat;
end;
...
function TdxStateFinal.FinishColumn(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(False);
  Result := TdxCompleteFormattingResult.Success;
...
function TdxStateFinal.FinishLine(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(False);
  Result := TdxCompleteFormattingResult.Success;
...
function TdxStateFinal.FinishPage(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(False);
  Result := TdxCompleteFormattingResult.Success;
...
begin
  ...
  if FCurrentCellIndex < Row.Cells.Count then
    FCurrentEndColumnIndex := CurrentStartColumnIndex +
      CurrentCell.LayoutProperties.ColumnSpan - 1
  else
    FCurrentEndColumnIndex := FCurrentStartColumnIndex;
  Result := True;
end;

procedure TdxTableCellIterator.SetStartColumnIndex(ANewStartColumnIndex
  : Integer);
begin
...
procedure TdxTableCellEmptyIterator.SetStartColumnIndex(ANewStartColumnIndex
  : Integer);
begin
  TdxRichEditExceptions.ThrowInternalException;
end;
...
constructor TdxTablesControllerTableState.Create(ATablesController
  : TdxTablesController; AStartCell: TdxTableCell;
...
begin
  ...
  ATableControllerParentState := Safe<TdxTablesControllerTableState>.Cast
    (ATablesController.State);
  if ATableControllerParentState is TdxTablesControllerTableState then
    FTableViewInfoManager := ATablesController.CreateTableViewInfoManager
      (ATableControllerParentState.TableViewInfoManager,
...
begin
  ...
  ABottomTextIndent := CalculateBottomTextIndent(ARowSeparatorIndex,
    ACellBordersInfo);
  ATopAnchor := TdxTableCellVerticalAnchor.Create
    (TableViewInfoManager.CurrentCellBottom, ABottomTextIndent,
    ACellBordersInfo);
  ATopAnchor.TopTextIndent := UnitConverter.ToLayoutUnits
    (GetActualCellTopMargin(CurrentCell));

  TableViewInfoManager.SetRowSeparator(ARowSeparatorIndex, ATopAnchor);
  TableViewInfoManager.SetRowSeparatorForCurrentTableViewInfo
    (ARowSeparatorIndex, ATopAnchor);
end;
...
function TdxTablesControllerTableState.CalcFirstInvalidRowIndexCore
  (AStartRowIndex: Integer): Integer;
var
  I: Integer;
...
function TdxTablesControllerTableState.CalculateBottomTextIndent
  (ARowSeparatorIndex: Integer;
out ACellBordersInfo: TdxHorizontalCellBordersInfoList): TdxLayoutUnit;
var
  AIndentCalculator: TdxBottomTextIndentCalculatorBase;
begin
  AIndentCalculator := TdxBottomTextIndentCalculatorBase.CreateCalculator(Self,
    CurrentTable, ARowSeparatorIndex);
  try
...
function TdxTablesControllerTableState.CalculateTableActualLeftRelativeOffset
  (ATable: TdxTable): TdxModelUnit;
var
...
begin
  ...
  ALeftBorderWidth := VerticalBordersCalculator.GetLeftBorderWidth
    (FBorderCalculator, AFirstCell, False);
  if (ATable.NestedLevel > 0) or RowsController.MatchHorizontalTableIndentsToTextEdge
  then
...
function TdxTablesControllerTableState.CanFitRowToColumn(ALastTextRowBottom
  : Integer; AColumn: TdxColumn): TdxCanFitCurrentRowToColumnResult;
var
  ...
  ATable: TdxTable;
begin
  AInfinityHeight := TablesController.IsInfinityHeight
    (TableViewInfoManager.GetCurrentTopLevelTableViewInfoIndex,
    ASpecialBottomAnchorIndex);
  if AInfinityHeight then
  begin
    if CurrentTable.NestedLevel > 0 then
      Exit(TdxCanFitCurrentRowToColumnResult.RowFitted);
    if TableViewInfoManager.GetCurrentCellTopAnchorIndex >= ASpecialBottomAnchorIndex
    then
    begin
  ...
  begin
    ...
    begin
      ...
      begin
        ATable := ACell.Table;
        ABreakType := TablesController.GetTableBreak(ATable,
          FTableViewInfoManager.GetCurrentTableViewInfoIndex, ABottomBounds);
        ...
        begin
          ...
          try
            if ACells.Count > 1 then
              if (ABreakType = TdxTableBreakType.NoBreak) or
                (FTableViewInfoManager.GetCurrentCellTop <> ABottomBounds) then
                Exit(TdxCanFitCurrentRowToColumnResult.RowFitted);
          finally
            ACells.Free;
          end;
        ...
        if not ACurrentTableViewInfoManager.IsFirstContentInParentCell then
          Break;
        ACurrentTableViewInfoManager :=
          FTableViewInfoManager.GetParentTableViewInfoManager;
        ACell := ACell.Table.ParentCell;
      end;
    end
    else
  ...
  begin
    ABottomBounds := AColumn.Bounds.Bottom;
    ABreakType := TablesController.GetTableBreak(CurrentTable,
      FTableViewInfoManager.GetCurrentTableViewInfoIndex, ABottomBounds);
    if ABreakType = TdxTableBreakType.NoBreak then
      ABottomBounds := AColumn.Bounds.Bottom;
    if ALastTextRowBottom > ABottomBounds then
...
function TdxTablesControllerTableState.CanFitFloatingObjectInTableRow
  (ABottom: Integer; AColumn: TdxColumn): TdxCanFitCurrentRowToColumnResult;
begin
  Result := CanFitRowToColumn(ABottom, AColumn);
end;

procedure TdxTablesControllerTableState.ChangeCurrentCellInTheSameTable
...
begin
  ...
  TableViewInfoManager.BeforeStartNextCell(CurrentCell,
    FCellsBounds[CurrentCell]);
  AColumnController := TdxTableCellColumnController
    (RowsController.ColumnController);

  ACellBounds := ABounds;
  ACellBounds.Offset(AColumnController.ParentColumn.Bounds.Left, 0);
  ATextBounds := GetTextBounds(CurrentCell, ABounds);

  TableViewInfoManager.StartNextCell(CurrentCell, ACellBounds,
    FCellsBounds[CurrentCell], ATextBounds);

  AColumnController.StartNewCell(TableViewInfoManager.GetRowStartColumn
    (ARowIndex), ATextBounds.Left, ATextBounds.Top, ATextBounds.Width,
    CurrentCell);
  ...
  TableViewInfoManager.CurrentCellBottom := ATopAnchor.VerticalPosition +
    ATopAnchor.BottomTextIndent;
  FTableViewInfoManager.ValidateTopLevelColumn;
end;
...
procedure TdxTablesControllerTableState.EnsureCurrentTableRow
  (ARow: TdxTableRow);
begin
...
var
  ABottomMargin, ARowTop, ACurrentRowHeight, ARowHeight, ABottomTextIndent
    : TdxLayoutUnit;
...
begin
  ABottomMargin := UnitConverter.ToLayoutUnits
    (GetActualCellBottomMargin(CurrentCell));
  ACurrentCellBottom := TableViewInfoManager.CurrentCellBottom;
  Inc(ACurrentCellBottom, ABottomMargin);
  AFixedRowHeight := False;
  if (FCellsBounds[CurrentCell].RowSpan = 1) and
    (CurrentCell.Row.Height.&Type <> TdxHeightUnitType.Auto) then
  begin
    ARowTop := TableViewInfoManager.GetCurrentCellTop;
    ACurrentRowHeight := ACurrentCellBottom -
      TableViewInfoManager.GetCurrentCellTop;
    ARowHeight := CurrentCell.DocumentModel.ToDocumentLayoutUnitConverter.
      ToLayoutUnits(FCurrentCell.Row.Height.Value);
    if (FCurrentCell.Row.Height.&Type = TdxHeightUnitType.Minimum) and
      (ACurrentRowHeight < ARowHeight) then
      ACurrentCellBottom := ACurrentCellBottom +
        (ARowHeight - ACurrentRowHeight)
    else if FCurrentCell.Row.Height.&Type = TdxHeightUnitType.Exact then
    begin
  ...
  ARowSeparatorIndex := FTableViewInfoManager.GetBottomCellRowSeparatorIndex
    (CurrentCell, FCellsBounds[CurrentCell].RowSpan);
  AColumnController := TdxTableCellColumnController
    (RowsController.ColumnController);
  ...
  begin
    ABottomTextIndent := CalculateBottomTextIndent(ARowSeparatorIndex,
      ACellBordersInfo);
    ABottomAnchor := TdxTableCellVerticalAnchor.Create(ACurrentCellBottom,
      ABottomTextIndent, ACellBordersInfo);
  ...
  begin
    ...
    begin
      ANewBottom := ABottomAnchor.VerticalPosition - ABottomAnchor.TopTextIndent
        + ABottomMargin;
    ...
    AAnchor := TdxTableCellVerticalAnchor.Create(ACurrentCellBottom,
      ABottomAnchor.BottomTextIndent, ACellBordersInfo);
    try
      ABottomAnchor := AColumnController.GetMaxAnchor(ABottomAnchor, AAnchor);
      ABottomAnchor.TopTextIndent := Math.Max(ABottomMargin,
        ABottomAnchor.TopTextIndent);
    finally
      AAnchor.Free;
    end;
  end;
  TableViewInfoManager.SetRowSeparatorForCurrentTableViewInfo
    (ARowSeparatorIndex, ABottomAnchor);
  FCurrentCellRowCount := 0;
...
begin
  ...
  begin
    ...
    ATableViewInfos[0].TopLevelColumn.RemoveTableViewInfoWithContent
      (ATableViewInfos[0]);
  end;
  if CurrentTable.NestedLevel = 0 then
...
function TdxTablesControllerTableState.GetActualCellBottomMargin
...
function TdxTablesControllerTableState.GetActualCellLeftMargin
  (ACell: TdxTableCell): TdxModelUnit;
var
  AMargin: TdxWidthUnit;
begin
...
function TdxTablesControllerTableState.GetActualCellRightMargin
  (ACell: TdxTableCell): TdxModelUnit;
var
  AMargin: TdxWidthUnit;
begin
...
class function TdxTablesControllerTableState.GetActualCellSpacing
  (ARow: TdxTableRow): TdxModelUnit;
var
...
function TdxTablesControllerTableState.GetActualCellTopMargin
  (ACell: TdxTableCell): TdxModelUnit;
var
  AMargin: TdxWidthUnit;
begin
...
function TdxTablesControllerTableState.GetCellBounds
  (ANewCell: TdxTableCell): TRect;
var
  ...
  AConverter: TdxDocumentModelUnitToLayoutUnitConverter;
  ACellTopMargin, ATopBorderHeight, ACellSpacingValue, AGridColumnCount,
    ALeftShift, ARightShift: Integer;
begin
  ...
  if ATopMargin.&Type = TdxWidthUnitType.ModelUnits then
    ...
    ACellTopMargin := 0;
  ACellTopMargin := ANewCell.DocumentModel.ToDocumentLayoutUnitConverter.
    ToLayoutUnits(ACellTopMargin);
  ATopBorderHeight := FBorderCalculator.GetActualWidth
    (ANewCell.GetActualTopCellBorder);
  ATopBorderHeight := ANewCell.DocumentModel.ToDocumentLayoutUnitConverter.
    ToLayoutUnits(ATopBorderHeight);
  ATopAnchor := TableViewInfoManager.GetRowStartAnchor(AGridPosition.RowIndex);
  Result.MoveToTop(ATopAnchor.VerticalPosition + ATopAnchor.BottomTextIndent -
    ACellTopMargin - ATopBorderHeight);

  ACellSpacing := ANewCell.Row.CellSpacing;
  ACellSpacingValue := ACellSpacing.Value * 2;
  if (ACellSpacing.&Type = TdxWidthUnitType.ModelUnits) and
    (ACellSpacingValue > 0) then
  begin
    AConverter := ANewCell.DocumentModel.ToDocumentLayoutUnitConverter;
    AIsFirstCellInRow := AGridPosition.ColumnIndex = 0;
    AGridColumnCount := ANewCell.Row.Cells.Last.
      GetEndColumnIndexConsiderRowGrid + 1;
    AIsLastCellInRow := (AGridPosition.ColumnIndex + AGridPosition.ColumnSpan)
      = AGridColumnCount;
    ...
    ALeftBorderWidth := VerticalBordersCalculator.GetLeftBorderWidth
      (FBorderCalculator, ANewCell, True);
    ARightBorderWidth := VerticalBordersCalculator.GetRightBorderWidth
      (FBorderCalculator, ANewCell);
...
function TdxTablesControllerTableState.GetRowOffset(ARow: TdxTableRow;
ASimpleView: Boolean): Integer;
var
...
begin
  ...
  if (AAlignment <> TdxTableRowAlignment.Center) and
    (AAlignment <> TdxTableRowAlignment.Right) then
    Exit(0);
  case AAlignment of
    ...
    TdxTableRowAlignment.Right:
      begin
        ...
        begin
          ALeftCellMargin := GetActualCellLeftMargin
            (ATable.Rows.First.Cells.First);
...
function TdxTablesControllerTableState.GetRowSpan(const AGridPosition
  : TdxLayoutGridRectangle): Integer;
var
  I, J: Integer;
  ARow: TdxTableRow;
  ACellFound: Boolean;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if (ANextGridPosition.ColumnIndex = AGridPosition.ColumnIndex) and
          (ANextGridPosition.ColumnSpan = AGridPosition.ColumnSpan) then
        begin
          ACellFound := True;
          Break;
        end;
...
const ACellBounds: TRect): TRect;
var
  ATopBorderHeight, ATopMargin, ALeftBorderWidth, ARightBorderWidth,
    ALeftMargin, ARightMargin, ALeftOffsetInModelUnit, ARightOffsetInModelUnit
    : TdxModelUnit;
  ALeftOffset, AMarginsWidth, ATopOffset: TdxLayoutUnit;
begin
  ATopBorderHeight := FBorderCalculator.GetActualWidth
    (ACell.GetActualTopCellBorder);
  ATopMargin := GetActualCellTopMargin(ACell);

  ALeftBorderWidth := VerticalBordersCalculator.GetLeftBorderWidth
    (FBorderCalculator, ACell, True);
  ARightBorderWidth := VerticalBordersCalculator.GetRightBorderWidth
    (FBorderCalculator, ACell);
  ...
  AMarginsWidth := UnitConverter.ToLayoutUnits(ALeftOffsetInModelUnit +
    ARightOffsetInModelUnit);
  ATopOffset := UnitConverter.ToLayoutUnits(ATopBorderHeight + ATopMargin);
  Result := TRect.CreateSize(ACellBounds.Left + ALeftOffset,
    ACellBounds.Top + ATopOffset,
    Math.Max(0, ACellBounds.Width - AMarginsWidth), ACellBounds.Height);
end;

function TdxTablesControllerTableState.GetWidth(AGrid: TdxTableGrid;
AFirstColumn, ACount: Integer): TdxLayoutUnit;
var
  I: Integer;
begin
  Result := 0;
...
procedure TdxTablesControllerTableState.LeaveCurrentTable(ABeforeRestart,
  ARollbackParent: Boolean);
var
  AColumnController: TdxTableCellColumnController;
  ANewRowBounds: TRect;
begin
...
function TdxTablesControllerTableState.CalculateShiftedPositions
  (ASimpleView: Boolean): TdxLayoutUnitSortedList;
var
  ARows: TdxTableRowCollection;
...
begin
  ...
  begin
    ARow := ARows[I];
    ARow.LayoutProperties.GridBefore :=
      Result.BinarySearch(FCellsBounds[ARow.Cells.First].Bounds.Left);
    ARow.LayoutProperties.GridAfter := Result.Count -
      Result.BinarySearch(FCellsBounds[ARow.Cells.Last].Bounds.Right) - 1;
    ACells := ARow.Cells;
    ...
    begin
      ...
      AColumnSpan := Result.BinarySearch(ABounds.Right) -
        Result.BinarySearch(ABounds.Left);
...
function TdxTablesControllerTableState.CalculateInitialPositions
  (ALeftOffset: TdxLayoutUnit): TdxLayoutUnitSortedList;
var
  AGrid: TdxTableGrid;
  ARows: TdxTableRowCollection;
...
function TdxTablesControllerTableState.PrepareCellsBounds
  (ALeftOffset: TdxLayoutUnit; ASimpleView: Boolean)
...
begin
  ...
  Result := TdxVerticalBorderPositions.Create(AInitialPositions,
    AShiftedPositions);
end;
...
begin
  ...
  begin
    ...
    begin
      ACell := ACells[J];
      FCellsBounds.Add(ACell, TdxLayoutGridRectangle.Create(cxNullRect, I,
        AColumnIndex, ACell.ColumnSpan));
      Inc(AColumnIndex, ACell.ColumnSpan);
    end;
  end;
  for I := 0 to ARowCount - 1 do
...
procedure TdxTablesControllerTableState.ProcessPendingCells(ATableViewInfo
  : TdxTableViewInfo; APendingCells: TdxList<TdxTableCellViewInfo>);
var
  I: Integer;
begin
...
function TdxTablesControllerTableState.
  RollbackToStartOfRowTableOnFirstCellRowColumnOverfull
  (AFirstTableRowViewInfoInColumn, AInnerMostTable: Boolean): TdxParagraphIndex;
var
  ACells: TdxTableCellCollection;
  AParagraphIndex: TdxParagraphIndex;
  I, ANewColumnBottom, ABottomAnchorIndex, AFirstInvalidRowIndex,
...
begin
  ...
  begin
    ...
    begin
      TablesController.AddInfinityTableBreak
        (FTableViewInfoManager.GetCurrentTableViewInfoIndex,
        ABottomAnchorIndex);
  ...
  begin
    ...
    if AInnerMostTable then
      TablesController.AddTableBreak(CurrentTable,
        FTableViewInfoManager.GetCurrentTableViewInfoIndex, ANewColumnBottom);
    AFirstInvalidRowIndex := CalcFirstInvalidRowIndex;
  end;

  TableViewInfoManager.RemoveAllInvalidRowsOnColumnOverfull
    (AFirstInvalidRowIndex);
...
procedure TdxTablesControllerTableState.ShiftRow
  (APositions: TdxLayoutUnitSortedList; ARow: TdxTableRow; AOffset: Integer);
var
  I: Integer;
  ABounds: TRect;
  ACell: TdxTableCell;
...
procedure TdxTablesControllerTableState.StartNewTable(ATable: TdxTable;
AFirstContentInParentCell, ASimpleView: Boolean);
var
  ATableTop: Integer;
  AColumnBounds: TRect;
  ...
  AModelRelativeIndent, AActualTableIndent, AModelLeftOffset, ARightCellMargin
    : TdxModelUnit;
  ALayoutLeftOffset, ALayoutRightTableBorder, ARightTableBorder,
    ALayoutRightCellMargin, AMinTableWidth, ABottomTextIndent: TdxLayoutUnit;
  APreferredWidth: TdxWidthUnitInfo;
begin
  AModelRelativeIndent := CalculateTableActualLeftRelativeOffset(ATable);
  if (ATable.TableIndent.&Type = TdxWidthUnitType.ModelUnits) and
    (ATable.TableAlignment = TdxTableRowAlignment.Left) then
  ...
  begin
    ARightTableBorder := VerticalBordersCalculator.GetRightBorderWidth
      (FBorderCalculator, ATable.FirstRow.LastCell);
  ...
  if (ATable.TableLayout = TdxTableLayoutType.Autofit) and
    (APreferredWidth.&Type in [TdxWidthUnitType.Auto, TdxWidthUnitType.&Nil])
  then
  begin
    AMinTableWidth := 1;
    ATableTop := RowsController.MoveCurrentRowDownToFitTable(AMinTableWidth,
      ATableTop);
    ATableTextArea := RowsController.GetTextAreaForTable;
    ATableViewInfo := TableViewInfoManager.StartNewTable(ATable, FCellsBounds,
      ALayoutLeftOffset, ALayoutRightCellMargin, AFirstContentInParentCell,
      ATableTextArea, FMaxTableWidth);
    ATableViewInfo.TextAreaOffset := ATableTextArea.Start -
      RowsController.CurrentColumn.Bounds.Left;
    Inc(ALayoutLeftOffset, ATableViewInfo.TextAreaOffset);
  end
  else
  begin
    AColumnBounds := RowsController.CurrentColumn.Bounds;
    ATableTextArea := TdxTextArea.Create(AColumnBounds.Left,
      AColumnBounds.Right - ALayoutRightTableBorder);
    ATableViewInfo := TableViewInfoManager.StartNewTable(ATable, FCellsBounds,
      ALayoutLeftOffset, ALayoutRightCellMargin, AFirstContentInParentCell,
      ATableTextArea, FMaxTableWidth);
    ATableTop := RowsController.MoveCurrentRowDownToFitTable
      (AColumnBounds.Width, ATableTop);
    ATableTextArea := RowsController.GetTextAreaForTable;
    ATableViewInfo.TextAreaOffset := ATableTextArea.Start -
      RowsController.CurrentColumn.Bounds.Left;
    Inc(ALayoutLeftOffset, ATableViewInfo.TextAreaOffset);
  ...
  ATableViewInfo.VerticalBorderPositions :=
    PrepareCellsBounds(ALayoutLeftOffset, ASimpleView);
  ...
  TableViewInfoManager.SetRowSeparator(0,
    TdxTableCellVerticalAnchor.Create(ATableTop, ABottomTextIndent,
    ACellBordersInfo));
  ...
  ATableCellController := TdxTableCellColumnController.Create
    (RowsController.ColumnController, RowsController.CurrentColumn,
    ATextBounds.Left, ATextBounds.Top, ATextBounds.Width, ATableViewInfo,
    CurrentCell);
  ...
  TableViewInfoManager.CurrentCellBottom :=
    ATableViewInfo.TopAnchor.VerticalPosition +
...
procedure TdxTablesControllerTableState.UpdateCurrentCellBottom
  (ABottom: TdxLayoutUnit);
begin
  if CurrentCell = nil then
    Exit;
  TableViewInfoManager.CurrentCellBottom :=
    Math.Max(ABottom, TableViewInfoManager.CurrentCellBottom);
end;
...
begin
  if CurrentCell = nil then
    Exit;
  TableViewInfoManager.CurrentCellBottom := Math.Max(ARow.Bounds.Bottom,
    TableViewInfoManager.CurrentCellBottom);
end;

{ TdxTableCellBorderIterator }

constructor TdxTableCellBorderIterator.Create(AAboveRow,
  ABelowRow: TdxTableRow);
begin
  inherited Create;
...
function TdxTableCellBorderIterator.GetCurrentAboveInfo
  : TdxNullableHorizontalCellBordersInfo;
var
...
begin
  ...
  Result := TdxHorizontalCellBordersInfo.Create(FCurrentCellAbove,
    FCurrentCellBelow, ABorder, FCurrentStartColumnIndex,
    FCurrentEndColumnIndex);
end;

function TdxTableCellBorderIterator.GetCurrentBelowInfo
  : TdxNullableHorizontalCellBordersInfo;
var
  ABorder: TdxBorderBase;
begin
...
function TdxTableCellBorderIterator.GetCurrentMergedInfo
  : TdxHorizontalCellBordersInfo;
begin
  Assert((FCurrentCellAbove <> nil) and (FCurrentCellBelow <> nil));
  Result := TdxHorizontalCellBordersInfo.Create(FCurrentCellAbove,
    FCurrentCellBelow, nil, FCurrentStartColumnIndex, FCurrentEndColumnIndex);
end;
...
begin
  if (FCurrentCellAbove = nil) or (FCurrentCellBelow = nil) then
    Exit(False);
  Result := ((FCurrentCellAbove.VerticalMerging = TdxMergingState.Restart) or
    (FCurrentCellAbove.VerticalMerging = TdxMergingState.Continue)) and
...
begin
  ...
  begin
    ...
    FCurrentEndColumnIndex := Math.Min(ABelowStartColumnIndex - 1,
      FAboveRowIterator.CurrentEndColumnIndex);
    FCurrentCellAbove := FAboveRowIterator.CurrentCell;
    FAboveRowIterator.SetStartColumnIndex(FCurrentEndColumnIndex + 1);
    Result := True;
  end
  else if ABelowStartColumnIndex < AAboveStartColumnIndex then
  begin
    FCurrentStartColumnIndex := ABelowStartColumnIndex;
    FCurrentEndColumnIndex := Math.Min(AAboveStartColumnIndex - 1,
      FBelowRowIterator.CurrentEndColumnIndex);
    FCurrentCellBelow := FBelowRowIterator.CurrentCell;
    FBelowRowIterator.SetStartColumnIndex(FCurrentEndColumnIndex + 1);
    Result := True;
  end
  ...
  begin
    FCurrentStartColumnIndex := AAboveStartColumnIndex;
    FCurrentEndColumnIndex := Math.Min(FAboveRowIterator.CurrentEndColumnIndex,
      FBelowRowIterator.CurrentEndColumnIndex);
    FCurrentCellAbove := FAboveRowIterator.CurrentCell;
    FCurrentCellBelow := FBelowRowIterator.CurrentCell;
    FAboveRowIterator.SetStartColumnIndex(FCurrentEndColumnIndex + 1);
...
function TdxTableCellHorizontalBorderCalculator.GetTopBorders(ARow: TdxTableRow)
  : TdxHorizontalCellBordersInfoList;
var
  ARowIndex, AAnchorIndex: Integer;
begin
...
function TdxTableCellHorizontalBorderCalculator.ResolveBorder(ATable: TdxTable;
ABorder1, ABorder2: TdxNullableHorizontalCellBordersInfo)
  : TdxHorizontalCellBordersInfo;
var
...
begin
  ...
  try
    ABorderInfo := ABorderCalculator.GetVerticalBorderSource(ATable,
      ABorder1.Value.Border.Info, ABorder2.Value.Border.Info);
  finally
...
procedure TdxUnderlineCalculator.CenterTabLeaderUnderlineBoxVertically
  (AUnderlineBox: TdxUnderlineBox; const ABounds: TRect);
var
  AOffset: Integer;
  R: TRect;
begin
  AOffset := (AUnderlineBox.UnderlineBounds.Top - ABounds.Top) div 2 -
    AUnderlineBox.UnderlineThickness;
...
function TdxUnderlineCalculator.CreateTabLeaderUnderlineBox
  (ABox: TdxTabSpaceBox; const ABounds: TRect; ARow: TdxRow): TdxUnderlineBox;
var
...
begin
  ...
  Result.UnderlinePosition := CalculateUnderlinePosition
    (AInfo.WeightedUnderlinePositionSum, AInfo.TotalUnderlineWidth);
  Result.UnderlineThickness := CalculateUnderlineThickness
    (AInfo.WeightedUnderlineThicknessSum, AInfo.TotalUnderlineWidth);
  Result.UnderlineBounds := TRect.CreateSize(0, AInfo.TopOffset, 0, 0);
  ABaselinePosition := ARow.Bounds.Top + ARow.BaseLineOffset +
    Result.UnderlineBounds.Height;
  ...
  Result.UnderlineBounds := TRect.Create(Row.Bounds.Left, AUnderlineTop,
    Row.Bounds.Right, AUnderlineBottom);
  Result.ClipBounds := TRect.Create(ABounds.Left, AUnderlineTop, ABounds.Right,
    AUnderlineBottom);
...
function TdxUnderlineCalculator.CalculateActualScript
  (AScript: TdxCharacterFormattingScript): TdxCharacterFormattingScript;
begin
  if AScript in [TdxCharacterFormattingScript.Subscript,
    TdxCharacterFormattingScript.Normal] then
    Exit(AScript);

  if (CurrentScript = TdxCharacterFormattingScript.Superscript) or
    (CurrentScript = UnknownScript) then
    Result := TdxCharacterFormattingScript.Superscript
  else
    Result := TdxCharacterFormattingScript.Normal;
end;

procedure TdxUnderlineCalculator.EndCharacterLine(AEndAnchorIndex: Integer;
...
begin
  ...
  AUnderlineBox := TdxUnderlineBox.Create(FStartAnchorIndex,
    AEndAnchorIndex - FStartAnchorIndex);
  AUnderlineBox.UnderlinePosition := CalculateUnderlinePosition
    (AInfo.WeightedUnderlinePositionSum, AInfo.TotalUnderlineWidth);
  AUnderlineBox.UnderlineThickness := CalculateUnderlineThickness
    (AInfo.WeightedUnderlineThicknessSum, AInfo.TotalUnderlineWidth);
...
function TdxUnderlineCalculator.GetRunCharacterLineType(ARun: TdxTextRun;
ARunIndex: TdxRunIndex): TdxUnderlineType;
begin
  Result := ARun.FontUnderlineType;
end;

function TdxUnderlineCalculator.GetRunCharacterLineUseForWordsOnly
  (ARun: TdxTextRun; ARunIndex: TdxRunIndex): Boolean;
begin
  Result := ARun.UnderlineWordsOnly;
end;

function TdxUnderlineCalculator.GetNumberingListBoxCharacterLineType
  (ANumberingListBox: TdxNumberingListBox): TdxUnderlineType;
begin
  Result := ANumberingListBox.GetFontUnderlineType(PieceTable);
end;

function TdxUnderlineCalculator.GetNumberingListBoxCharacterLineUseForWordsOnly
  (ANumberingListBox: TdxNumberingListBox): Boolean;
var
  ANumerationCharacterProperties: TdxMergedCharacterProperties;
begin
  ANumerationCharacterProperties :=
    ANumberingListBox.GetNumerationCharacterProperties(PieceTable);
  try
...
begin
  AShouldBreakCharacterLineByScript := ShouldBreakCharacterLineByScript
    (ABoxScript);
...
function TdxUnderlineCalculator.ShouldBreakCharacterLineByScript
  (AScript: TdxCharacterFormattingScript): Boolean;
begin
  if CurrentScript = UnknownScript then
    Exit(True);
  if (CurrentScript = TdxCharacterFormattingScript.Subscript) and
    (AScript = TdxCharacterFormattingScript.Subscript) then
    Exit(False);
  Result := (CurrentScript = TdxCharacterFormattingScript.Subscript) or
...
procedure TdxUnderlineCalculator.AddNewUnderlineBoxToRow(ASourceUnderlineBox
  : TdxUnderlineBox; AStartIndex: Integer; AEndIndex: Integer);
var
  ANewUnderlineBox: TdxUnderlineBox;
begin
  ANewUnderlineBox := TdxUnderlineBox.Create(AStartIndex,
...
function TdxUnderlineCalculator.CalculateTabLeaderUnderlineInfo
  (ABox: TdxTabSpaceBox; const ABounds: TRect): TdxUnderlineInfo;
var
  AFontInfo: TdxFontInfo;
  ABoxWidth: Integer;
begin
...
function TdxUnderlineCalculator.CalculateUnderlineInfo(AEndAnchorIndex: Integer)
  : TdxUnderlineInfo;
var
  I, ABoxWidth, AMaxTopOffset, AMinTopOffset, AUnderlinePositionForMaxTopOffset,
    ATopOffset: Integer;
  AFontInfo: TdxFontInfo;
begin
  Result.Init;
  ...
  begin
    if (FActualScript = TdxCharacterFormattingScript.Normal) and
      (GetBoxScript(I) = TdxCharacterFormattingScript.Superscript) then
      Continue;
  ...
  begin
    ...
    if AMinTopOffset <> AMaxTopOffset then
      Result.WeightedUnderlinePositionSum := AUnderlinePositionForMaxTopOffset *
        Result.TotalUnderlineWidth;
  end;
end;

class function TdxUnderlineCalculator.CalculateUnderlinePosition
  (AWeightedUnderlinePositionSum, ATotalUnderlineWidth: Integer): Integer;
begin
...
class function TdxUnderlineCalculator.CalculateUnderlineThickness
  (AWeightedUnderlineThicknessSum, ATotalUnderlineWidth: Integer): Integer;
begin
  if ATotalUnderlineWidth <> 0 then
    Result := Max(Round(AWeightedUnderlineThicknessSum /
      ATotalUnderlineWidth), 1)
  else
    Result := 1;
end;

function TdxUnderlineCalculator.GetUnderlineLeft(AUnderlineBox
  : TdxUnderlineBox): Integer;
begin
  Result := Boxes[AUnderlineBox.StartAnchorIndex].Bounds.Left;
end;

function TdxUnderlineCalculator.GetUnderlineRight(AUnderlineBox
  : TdxUnderlineBox): Integer;
var
...
procedure TdxUnderlineCalculator.SetUnderlineBoxBounds(AUnderlineBox
  : TdxUnderlineBox);
var
  AUnderlineLeft, AUnderlineRight, ABaselinePosition, AUnderlineTop,
    AUnderlineBottom, ABottomDistance: Integer;
begin
  AUnderlineLeft := GetUnderlineLeft(AUnderlineBox);
  AUnderlineRight := GetUnderlineRight(AUnderlineBox);

  ABaselinePosition := Row.Bounds.Top + Row.BaseLineOffset +
    AUnderlineBox.UnderlineBounds.Top;
  AUnderlineTop := ABaselinePosition + AUnderlineBox.UnderlinePosition div 2;
  AUnderlineBottom := ABaselinePosition + AUnderlineBox.UnderlinePosition +
    AUnderlineBox.UnderlineThickness;
  ...
  AUnderlineBox.UnderlineBounds := TRect.Create(Row.Bounds.Left, AUnderlineTop,
    Row.Bounds.Right, AUnderlineBottom);
  AUnderlineBox.ClipBounds := TRect.Create(AUnderlineLeft, AUnderlineTop,
    AUnderlineRight, AUnderlineBottom);
  AUnderlineBox.UnderlinePosition := AUnderlineBox.UnderlinePosition -
    AUnderlineBox.UnderlinePosition div 2;
end;
...
procedure TdxUnderlineCalculator.SplitUnderlineBoxByColor
  (AUnderlineBox: TdxUnderlineBox);
var
...
begin
  ...
  ACurrentUnderlineColor := ABox.GetActualUnderlineColor(PieceTable,
    TdxTextColors.Defaults, TdxAlphaColors.Empty);
  ...
  begin
    ...
    ABoxUnderlineColor := ABox.GetActualUnderlineColor(PieceTable,
      TdxTextColors.Defaults, TdxAlphaColors.Empty);
...
procedure TdxUnderlineCalculator.SplitUnderlinesByColor
  (AUnderlines: TdxUnderlineBoxCollection);
var
  I: Integer;
begin
...
function TdxTextAreaAndXComparable.CompareTo(const AOther: TdxTextArea)
  : Integer;
begin
  if FX < AOther.Start then
    Result := 1
  else if FX > AOther.Start then
  begin
...
function THorizontalObjectComparer.Compare(const ALeft,
  ARight: TdxBoxBase): Integer;
begin
  Result := CompareInteger(TdxFloatingObjectBox(ALeft).X,
    TdxFloatingObjectBox(ARight).X);
end;

{ TdxFloatingObjectsLayout.TVerticalObjectComparer }

function TVerticalObjectComparer.Compare(const ALeft,
  ARight: TdxBoxBase): Integer;
begin
  Result := CompareInteger(TdxFloatingObjectBox(ALeft).Y,
    TdxFloatingObjectBox(ARight).Y);
end;
...
begin
  ...
  FObjectsTable := TDictionary<TdxFloatingObjectAnchorRun,
    TdxFloatingObjectBox>.Create;
  FObjectToRunMapTable :=
    TDictionary<TdxFloatingObjectBox, TdxFloatingObjectAnchorRun>.Create;
end;
...
function TdxFloatingObjectsLayout.FindLeftMostX(AProcessedObjects
  : TdxFloatingObjectBoxList; AInitialX: Integer; const ABounds: TRect)
  : Integer;
var
...
function TdxFloatingObjectsLayout.FindRightMostX(AProcessedObjects
  : TdxFloatingObjectBoxList; AInitialX: Integer; const ABounds: TRect)
  : Integer;
var
...
function TdxFloatingObjectsLayout.GetAllObjectsInRectangle(const ABounds: TRect)
  : TdxFloatingObjectBoxList;
begin
...
function TdxFloatingObjectsLayout.GetFloatingObject(AObjectAnchorRun
  : TdxFloatingObjectAnchorRun): TdxFloatingObjectBox;
begin
  if not FObjectsTable.TryGetValue(AObjectAnchorRun, Result) then
    Result := nil;
end;

procedure TdxFloatingObjectsLayout.GetFloatingObjects
  (AWhere: TdxFloatingObjectBoxList; APieceTable: TdxPieceTable;
...
function TdxFloatingObjectsLayout.GetFloatingObjects(APieceTable: TdxPieceTable)
  : TdxFloatingObjectBoxList;
begin
  Result := TdxFloatingObjectBoxList.Create;
...
procedure TdxFloatingObjectsLayout.GetObjectsInRectangle(AWhere,
  ATo: TdxFloatingObjectBoxList; const ABounds: TRect);
var
  I: Integer;
begin
...
procedure TdxFloatingObjectsLayout.MoveFloatingObjectsVertically
  (ADeltaY: Integer; APieceTable: TdxPieceTable);
var
  I: Integer;
  AObjects: TdxFloatingObjectBoxList;
begin
...
procedure TdxFloatingObjectsLayout.ProcessFloatingObject(AFloatingObject
  : TdxFloatingObjectBox; AProcessedObjects: TdxFloatingObjectBoxList;
AResult: TdxTextAreaCollectionEx; const AInitialBounds: TRect);
var
  ABounds: TRect;
...
begin
  ...
  ARightMostX := FindRightMostX(AProcessedObjects, ABounds.Right,
    AInitialBounds);
  ...
  if not AFloatingObject.CanPutTextAtLeft or
    (AFloatingObject.PutTextAtLargestSide and
    (ALeftSideWidth <= ARightSideWidth)) then
    AResult.Remove(TdxTextArea.Create(ALeftMostX, ABounds.Left));

  if not AFloatingObject.CanPutTextAtRight or
    (AFloatingObject.PutTextAtLargestSide and (ARightSideWidth < ALeftSideWidth))
  then
    AResult.Remove(TdxTextArea.Create(ABounds.Right, ARightMostX));
end;

function TdxFloatingObjectsLayout.GetObjectsInRectangle(const ABounds: TRect)
  : TdxFloatingObjectBoxList;
var
  R: TRect;
begin
...
procedure TdxFloatingObjectsLayout.Add(AObjectAnchorRun
  : TdxFloatingObjectAnchorRun; AFloatingObject: TdxFloatingObjectBox);
begin
...
function TdxFloatingObjectsLayout.ContainsRun(AObjectAnchorRun
  : TdxFloatingObjectAnchorRun): Boolean;
begin
...
function TdxCharacterLineCalculator<T>.FindLastNonSpaceBoxIndex
...
function TdxCharacterLineCalculator<T>.CalculateActualCharacterLineType
  (ABox: TdxBox): T;
begin
...
function TdxCharacterLineCalculator<T>.CalculateActualScript
  (AScript: TdxCharacterFormattingScript): TdxCharacterFormattingScript;
begin
  Result := AScript;
end;

procedure TdxCharacterLineCalculator<T>.CalculateCharacterLineBoxesByType
  (ALastNonSpaceBoxIndex: Integer);
var
  ACurrentFontInfo: TdxFontInfo;
...
begin
  ...
  begin
    ...
    ACharacterLineTypeChanged := not Comparer.Equals(ACurrentCharacterLineType,
      ABoxCharacterLineType);
    if ARunChanged then
      ABoxScript := GetBoxScript(I);

    AActualScript := CalculateActualScript(ABoxScript);
    if IsCharacterLineBreak(ACharacterLineTypeChanged, ARunChanged, ABoxScript)
    then
    begin
      if not Comparer.Equals(ACurrentCharacterLineType, CharacterLineTypeNone)
      then
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          ACurrentFontInfo := DocumentModel.FontCache
            [ACurrentTextRun.FontCacheIndex];
        end
        else
...
function TdxCharacterLineCalculator<T>.
  SetCurrentRunCharacterLineTypeFromNumberingListBox: Boolean;
begin
  FCurrentRunCharacterLineType := GetNumberingListBoxCharacterLineType
    (FNumberingListBox);
  FUseForWordsOnly := GetNumberingListBoxCharacterLineUseForWordsOnly
    (FNumberingListBox);
  Result := True;
end;
...
function TdxCharacterLineCalculator<T>.SetCurrentRunCharacterLineTypeFromBox
  (ABox: TdxBox; APrevBoxIndex: TdxRunIndex): Boolean;
var
...
begin
  ...
  begin
    FCurrentRunCharacterLineType := GetRunCharacterLineType(ACurrentTextRun,
      ACurrentRunIndex);
    FUseForWordsOnly := GetRunCharacterLineUseForWordsOnly(ACurrentTextRun,
      ACurrentRunIndex);
  end
  else
  begin
...
function TdxCharacterLineCalculator<T>.CalculateScriptOffset
  (AFontInfo: TdxFontInfo; AScript: TdxCharacterFormattingScript): Integer;
begin
  case AScript of
    TdxCharacterFormattingScript.Subscript:
...
function TdxCharacterLineCalculator<T>.GetBoxFontInfo(ABoxIndex: Integer)
  : TdxFontInfo;
var
  ANumberingListBox: TdxNumberingListBox;
  AIndex: Integer;
...
function TdxCharacterLineCalculator<T>.GetBoxScript(ABoxIndex: Integer)
  : TdxCharacterFormattingScript;
var
  ANumberingListBox: TdxNumberingListBox;
  ANumerationCharacterProperties: TdxMergedCharacterProperties;
begin
...
procedure TdxCharacterLineCalculator<T>.SetPieceTable
  (const AValue: TdxPieceTable);
begin
  Assert(AValue <> nil);
  FPieceTable := AValue;
end;
...
constructor TdxDefaultPageAreaControllerState.Create
  (AOwner: TdxPageAreaController; ANextAreaIndex: Integer);
begin
  inherited Create(AOwner);
  FNextAreaIndex := ANextAreaIndex;
end;

procedure TdxDefaultPageAreaControllerState.ApplyContinuousSectionStart
  (ASection: TdxSection);
begin
  FNextAreaIndex := 0;
end;

procedure TdxDefaultPageAreaControllerState.ApplySectionStart
  (ASection: TdxSection; ACurrentColumnsCount: Integer);
begin
  case ASection.GeneralSettings.StartType of
...
function TdxDefaultPageAreaControllerState.CompleteCurrentAreaFormatting
  : TdxCompleteFormattingResult;
var
  ABounds: TRect;
...
function TdxDefaultPageAreaControllerState.GetNextPageArea(AKeepFloatingObjects
  : Boolean): TdxPageArea;
begin
  if FNextAreaIndex = 0 then
  begin
...
procedure TdxDefaultPageAreaControllerState.
  RestartFormattingFromTheMiddleOfSection(ASection: TdxSection;
ACurrentAreaIndex: Integer);
begin
  Assert(ACurrentAreaIndex >= 0);
  FNextAreaIndex := ACurrentAreaIndex;
  inherited RestartFormattingFromTheMiddleOfSection(ASection,
    ACurrentAreaIndex);
end;

procedure TdxDefaultPageAreaControllerState.
  RestartFormattingFromTheStartOfSection(ASection: TdxSection;
ACurrentAreaIndex: Integer);
begin
  Assert(ACurrentAreaIndex >= 0);
  FNextAreaIndex := ACurrentAreaIndex;
...
constructor TdxResetSecondaryFormattingForPageArgs.Create(APage: TdxPage;
APageIndex: Integer);
begin
  inherited Create;
  FPage := APage;
...
constructor TdxPageFormattingCompleteEventArgs.Create(APage: TdxPage;
...
constructor TdxColumnsBoundsCalculator.Create(AUnitConverter
  : TdxDocumentModelUnitToLayoutUnitConverter);
begin
  inherited Create;
...
function TdxColumnsBoundsCalculator.Calculate(ASection: TdxSection;
const ABounds: TRect): TdxRectList;
var
...
begin
  ...
  if AColumnsSettings.EqualWidthColumns then
    PopulateEqualWidthColumnsBounds(Result, ABounds,
      AColumnsSettings.ColumnCount,
      FUnitConverter.ToLayoutUnits(AColumnsSettings.Space))
  else
  begin
...
procedure TdxColumnsBoundsCalculator.PopulateColumnsBounds
  (const ARects: TdxRectList; const ABounds: TRect;
const AColumnInfoCollection: TdxColumnInfoCollection);
var
  I, X, ACount: Integer;
  AColumnBounds: TRect;
begin
  ...
  begin
    ...
    AColumnBounds.Width := UnitConverter.ToLayoutUnits
      (AColumnInfoCollection[I].Width);
    Inc(X, AColumnBounds.Width + UnitConverter.ToLayoutUnits
      (AColumnInfoCollection[I].Space));
    ARects.Add(AColumnBounds);
  end;
end;

procedure TdxColumnsBoundsCalculator.PopulateEqualWidthColumnsBounds
  (const AColumnBounds: TdxRectList; const ABounds: TRect;
AColumnCount, ASpaceBetweenColumns: Integer);
var
  R: TRect;
  ARects: TArray<TRect>;
begin
  ...
  PopulateEqualWidthColumnsBoundsCore(AColumnBounds, ARects,
    ASpaceBetweenColumns);
end;

procedure TdxColumnsBoundsCalculator.PopulateEqualWidthColumnsBoundsCore
  (const ARects: TdxRectList; const AColumnRects: TArray<TRect>;
ASpaceBetweenColumns: Integer);
var
  I: Integer;
  AColumnBounds: TRect;
begin
...
constructor TdxPageBoundsCalculator.Create(AUnitConverter
  : TdxDocumentModelUnitToLayoutUnitConverter);
begin
  inherited Create;
  Assert(AUnitConverter <> nil);
...
function TdxPageBoundsCalculator.CalculatePageBounds
  (ASection: TdxSection): TRect;
var
...
function TdxPageBoundsCalculator.CalculatePageClientBounds
  (ASection: TdxSection): TRect;
var
...
begin
  ...
  Result := CalculatePageClientBoundsCore(APage.Width, APage.Height,
    AMargins.Left, Abs(AMargins.Top), AMargins.Right, Abs(AMargins.Bottom));
end;

function TdxPageBoundsCalculator.CalculatePageClientBoundsCore(APageWidth,
  APageHeight, AMarginLeft, AMarginTop, AMarginRight, AMarginBottom
  : Integer): TRect;
var
...
constructor TdxCalculatePageOrdinalResult.Create(APageOrdinal, ASkippedPageCount
  : Integer);
begin
...
procedure TdxLineSpacingCalculatorBase.AlignRowBoxesToBaseLine
  (AFormatter: TdxParagraphFinalFormatter; ARow: TdxRow; ACount: Integer;
const AAscents: TArray<Integer>);
var
...
begin
  ...
  begin
    ABox := ABoxes[I];
    R := ABox.Bounds;
    R.Y := ARowTop + ABaseLine - AAscents[I] +
      AFormatter.CalculateSubscriptOrSuperScriptOffset(ABox);
    ABox.Bounds := R;
  end;
end;

function TdxLineSpacingCalculatorBase.CalcRowHeight(AOldRowHeight,
  ANewBoxHeight: Integer): Integer;
begin
  Result := Max(AOldRowHeight, ANewBoxHeight);
end;

function TdxLineSpacingCalculatorBase.CalcRowHeightFromInlineObject
  (AOldRowHeight, AMaxPictureHeight, AMaxDescent: Integer): Integer;
begin
  Result := Math.Max(AOldRowHeight, AMaxPictureHeight + AMaxDescent);
end;

function TdxLineSpacingCalculatorBase.CalculateSpacing(ARowHeight,
  AMaxAscentAndFree, AMaxDescent, AMaxPictureHeight: Integer): Integer;
var
...
begin
  ...
  if AMaxAscentAndFree >= AMaxPictureHeight then
    ...
    Result := CalculateSpacingInlineObjectCase(ARowHeight, AMaxDescent,
      ARowTextHeight, ARowTextSpacing, AMaxPictureHeight);
end;

function TdxLineSpacingCalculatorBase.CreateParametersCalculator
  (AFormatter: TdxParagraphFinalFormatter; AParameterCount: Integer)
  : TdxRowSpacingParametersCalculatorBase;
begin
  Result := TdxRowSpacingParametersCalculator.Create(AFormatter,
    AParameterCount);
end;

procedure TdxLineSpacingCalculatorBase.FormatRow
  (AFormatter: TdxParagraphFinalFormatter; ARow: TdxRow);
var
  I, ACount: Integer;
  ABoxes: TArray<TdxBox>;
...
begin
  ...
  try
    ...
    ARow.BaseLineOffset := ACalculator.CalculateRowBaseLineOffset(ARow) +
      ARow.SpacingBefore;
    AlignRowBoxesToBaseLine(AFormatter, ARow, ACount,
      ACalculator.ParameterValues);
  finally
    ACalculator.Free;
  end;
end;

class function TdxLineSpacingCalculatorBase.GetLineSpacingCalculator
  (AParagraph: TdxSimpleParagraph): TdxLineSpacingCalculatorBase;
var
  ALineSpacing: Integer;
  AMultiplier: Single;
begin
  case AParagraph.LineSpacingType of
    ...
    TdxParagraphLineSpacing.AtLeast:
      begin
        ...
        Result := TdxAtLeastSpacingCalculator.Create
          (Math.Max(1, AParagraph.DocumentModel.ToDocumentLayoutUnitConverter.
          ToLayoutUnits(ALineSpacing)));
      end;
    TdxParagraphLineSpacing.Exactly:
      begin
        ALineSpacing := Trunc(AParagraph.LineSpacing);
        Result := TdxExactlySpacingCalculator.Create
          (Math.Max(1, AParagraph.DocumentModel.ToDocumentLayoutUnitConverter.
          ToLayoutUnits(ALineSpacing)));
      end;
  else
...
function TdxLineSpacingCalculatorBase.GetRowContentBoxes(ARow: TdxRow)
  : TArray<TdxBox>;
var
  I, ACount: Integer;
begin
...
function TdxSingleSpacingCalculator.CalculateSpacingCore
  (ARowHeight: Integer): Integer;
begin
  Result := ARowHeight;
end;

function TdxSingleSpacingCalculator.CalculateSpacingInlineObjectCase(ARowHeight,
  AMaxDescent, ARowTextHeight, ARowTextSpacing, AMaxPictureHeight
  : Integer): Integer;
begin
...
begin
  inherited Create;
  if AMultiplier <= 0 then
    TdxRichEditExceptions.ThrowArgumentException('multiplier',
      FloatToStr(AMultiplier));
  FMultiplier := AMultiplier;
end;

function TdxMultipleSpacingCalculator.CalculateSpacingCore
  (ARowHeight: Integer): Integer;
begin
  Result := Trunc(ARowHeight * FMultiplier);
end;

function TdxMultipleSpacingCalculator.CalculateSpacingInlineObjectCase
  (ARowHeight, AMaxDescent, ARowTextHeight, ARowTextSpacing, AMaxPictureHeight
  : Integer): Integer;
begin
  Result := ARowHeight + (ARowTextSpacing - ARowTextHeight);
end;

function TdxMultipleSpacingCalculator.CreateParametersCalculator
  (AFormatter: TdxParagraphFinalFormatter; AParameterCount: Integer)
  : TdxRowSpacingParametersCalculatorBase;
begin
  Result := TdxMultipleSpacingParametersCalculator.Create(AFormatter,
    AParameterCount, FMultiplier);
end;

{ TdxSesquialteralSpacingCalculator }

function TdxSesquialteralSpacingCalculator.CalculateSpacingCore
  (ARowHeight: Integer): Integer;
begin
  Result := Trunc(3 * ARowHeight / 2);
end;

function TdxSesquialteralSpacingCalculator.CalculateSpacingInlineObjectCase
  (ARowHeight, AMaxDescent, ARowTextHeight, ARowTextSpacing, AMaxPictureHeight
  : Integer): Integer;
begin
  Result := ARowHeight + (ARowTextSpacing - ARowTextHeight);
...
function TdxDoubleSpacingCalculator.CalculateSpacingCore
  (ARowHeight: Integer): Integer;
begin
  Result := 2 * ARowHeight;
end;

function TdxDoubleSpacingCalculator.CalculateSpacingInlineObjectCase(ARowHeight,
  AMaxDescent, ARowTextHeight, ARowTextSpacing, AMaxPictureHeight
  : Integer): Integer;
begin
  Result := ARowHeight + (ARowTextSpacing - ARowTextHeight);
...
function TdxExactlySpacingCalculator.CalcRowHeight(AOldRowHeight,
  ANewBoxHeight: Integer): Integer;
begin
  Result := FSpacing;
end;

function TdxExactlySpacingCalculator.CalcRowHeightFromInlineObject
  (AOldRowHeight, AMaxPictureHeight, AMaxDescent: Integer): Integer;
begin
  Result := FSpacing;
end;

function TdxExactlySpacingCalculator.CalculateSpacing(ARowHeight, AMaxAscent,
  AMaxDescent, AMaxPictureHeight: Integer): Integer;
begin
  Result := FSpacing;
end;

function TdxExactlySpacingCalculator.CalculateSpacingCore
  (ARowHeight: Integer): Integer;
begin
  Result := FSpacing;
end;

function TdxExactlySpacingCalculator.CalculateSpacingInlineObjectCase
  (ARowHeight, AMaxDescent, ARowTextHeight, ARowTextSpacing, AMaxPictureHeight
  : Integer): Integer;
begin
  Result := 0;
...
function TdxExactlySpacingCalculator.CreateParametersCalculator
  (AFormatter: TdxParagraphFinalFormatter; AParameterCount: Integer)
  : TdxRowSpacingParametersCalculatorBase;
begin
  Result := TdxExactlyRowSpacingParametersCalculator.Create(AFormatter,
    AParameterCount, FBaseLineOffset);
end;
...
function TdxAtLeastSpacingCalculator.CalculateSpacing(ARowHeight,
  AMaxAscentAndFree, AMaxDescent, AMaxPictureHeight: Integer): Integer;
begin
  Result := Math.Max(FSpacing, ARowHeight);
end;

function TdxAtLeastSpacingCalculator.CalculateSpacingCore
  (ARowHeight: Integer): Integer;
begin
  Result := Math.Max(FSpacing, ARowHeight);
end;

function TdxAtLeastSpacingCalculator.CalculateSpacingInlineObjectCase
  (ARowHeight, AMaxDescent, ARowTextHeight, ARowTextSpacing, AMaxPictureHeight
  : Integer): Integer;
begin
  Result := 0;
...
function TdxAtLeastSpacingCalculator.CreateParametersCalculator
  (AFormatter: TdxParagraphFinalFormatter; AParameterCount: Integer)
  : TdxRowSpacingParametersCalculatorBase;
begin
  Result := TdxAtLeastRowSpacingParametersCalculator.Create(AFormatter,
    AParameterCount);
end;
...
constructor TdxRowSpacingParametersCalculatorBase.Create
  (AFormatter: TdxParagraphFinalFormatter; AParameterCount: Integer);
begin
  inherited Create;
  FFormatter := AFormatter;
...
function TdxRowSpacingParametersCalculatorBase.
  CalculateActualMaxParameterValue: Integer;
begin
  if MaxParameterValue > 0 then
    Result := MaxParameterValue
  else if MaxMarkParameterValue > 0 then
...
function TdxRowSpacingParametersCalculatorBase.IsSpaceBox(ABox: TdxBox)
  : Boolean;
begin
  Result := not ABox.IsNotWhiteSpaceBox;
end;

procedure TdxRowSpacingParametersCalculatorBase.ProcessParameterValue
  (ABox: TdxBox; AValue: Integer);
begin
  if IsMarkBox(ABox) then
    MaxMarkParameterValue := Max(MaxMarkParameterValue, AValue)
  else if IsSpaceBox(ABox) then
...
function TdxRowSpacingParametersCalculator.CalculateRowBaseLineOffset
  (ARow: TdxRow): Integer;
begin
  Result := CalculateActualMaxParameterValue;
end;

procedure TdxRowSpacingParametersCalculator.ProcessBox(ABox: TdxBox;
ABoxIndex: Integer);
var
  AAscent: Integer;
begin
...
procedure TdxDescentParametersCalculator.ProcessBox(ABox: TdxBox;
ABoxIndex: Integer);
var
  ADescent: Integer;
begin
...
function TdxDescentParametersCalculator.CalculateRowBaseLineOffset
  (ARow: TdxRow): Integer;
begin
...
constructor TdxMultipleSpacingParametersCalculator.Create
  (AFormatter: TdxParagraphFinalFormatter; AParameterCount: Integer;
AMultiplier: Single);
begin
  ...
  if AMultiplier < 1 then
    FDescentParametersCalculator := TdxDescentParametersCalculator.Create
      (AFormatter, AParameterCount);
end;
...
procedure TdxMultipleSpacingParametersCalculator.ProcessBox(ABox: TdxBox;
ABoxIndex: Integer);
begin
...
function TdxMultipleSpacingParametersCalculator.CalculateRowBaseLineOffset
  (ARow: TdxRow): Integer;
var
...
begin
  if FDescentParametersCalculator <> nil then
  begin
    AMaxDescent := FDescentParametersCalculator.
      CalculateActualMaxParameterValue;
...
function TdxExactlyRowSpacingParametersCalculator.CalculateRowBaseLineOffset
  (ARow: TdxRow): Integer;
begin
  Result := FBaseLineOffset;
end;

constructor TdxExactlyRowSpacingParametersCalculator.Create
  (AFormatter: TdxParagraphFinalFormatter;
AParameterCount, ABaseLineOffset: Integer);
begin
  inherited Create(AFormatter, AParameterCount);
...
procedure TdxExactlyRowSpacingParametersCalculator.ProcessBox(ABox: TdxBox;
ABoxIndex: Integer);
begin
  ParameterValues[ABoxIndex] := Formatter.CalcBoxAscentAndFree(ABox);
end;
...
function TdxAtLeastRowSpacingParametersCalculator.CalculateRowBaseLineOffset
  (ARow: TdxRow): Integer;
begin
  Result := Math.Max(FMaxPictureHeight, CalculateRowBaseLineOffsetCore(ARow));
end;

function TdxAtLeastRowSpacingParametersCalculator.CalculateRowBaseLineOffsetCore
  (ARow: TdxRow): Integer;
begin
  if ARow.LastParagraphRow then
    Result := ARow.LastParagraphRowOriginalHeight -
      CalculateActualMaxParameterValue - ARow.SpacingBefore
  else
    Result := ARow.Height - CalculateActualMaxParameterValue -
      ARow.SpacingBefore;
end;

procedure TdxAtLeastRowSpacingParametersCalculator.ProcessBox(ABox: TdxBox;
ABoxIndex: Integer);
var
  ADescent: Integer;
begin
...
begin
  Result := CompareInteger(TdxParagraphFrameBox(X).X,
    TdxParagraphFrameBox(Y).X);
end;
...
begin
  Result := CompareInteger(TdxParagraphFrameBox(X).Y,
    TdxParagraphFrameBox(Y).Y);
end;
...
function TdxParagraphFramesLayout.ContainsParagraph
  (AParagraph: TdxParagraphBase): Boolean;
var
  I: Integer;
begin
  Result := False;
...
function TdxParagraphFramesLayout.GetFloatingObject
  (AParagraph: TdxParagraphBase): TdxParagraphFrameBox;
var
...
procedure TdxParagraphFramesLayout.AddParagraphFrameBox(AParagraphFrameBox
  : TdxParagraphFrameBox);
begin
...
function TdxParagraphFramesLayout.GetObjectsInRectangle(const ABounds: TRect)
  : TdxParagraphFrameBoxList;
var
  R: TRect;
begin
...
procedure TdxParagraphFramesLayout.GetObjectsInRectangle
  (AWhere: TdxParagraphFrameBoxList; ATo: TdxParagraphFrameBoxList;
const ABounds: TRect);
var
  I: Integer;
begin
...
procedure TdxParagraphFramesLayout.ProcessParagraphFrame(AParagraphFrame
  : TdxParagraphFrameBox; AProcessedObjects: TdxParagraphFrameBoxList;
AResult: TdxTextAreaCollectionEx; const AInitialBounds: TRect);
var
  ABounds: TRect;
...
begin
  ...
  try
    ...
    then
      AResult.Remove(TdxTextArea.Create(ABounds.Left, ABounds.Right));
    if AFrameProperties.Info.TextWrapType = TdxParagraphFrameTextWrapType.NotBeside
    then
...
function TdxParagraphFramesLayout.FindLeftMostX(AProcessedObjects
  : TdxParagraphFrameBoxList; AInitialX: Integer; const ABounds: TRect)
  : Integer;
var
  I, AObjectBoundsRight: Integer;
begin
...
function TdxParagraphFramesLayout.FindRightMostX(AProcessedObjects
  : TdxParagraphFrameBoxList; AInitialX: Integer; const ABounds: TRect)
  : Integer;
var
  I, AObjectBoundsLeft: Integer;
...
function TdxTabsController.AdjustAlignedTabWidth(const ATab: TdxTabInfo;
ATabWidth, ALastNonSpaceBoxRight: Integer): Integer;
begin
  if IsTabPositionBehindParagraphRight(ATab) and
    (ALastNonSpaceBoxRight + ATabWidth > FParagraphRight) then
...
function TdxTabsController.CalcLastCenterTabWidth(const ATab: TdxTabInfo;
AStartIndex: Integer): Integer;
var
  ALastNonSpaceBoxIndex, ATabbedContentWidth, ALastNonSpaceBoxRight,
    ATabPosition, ATabWidth: Integer;
begin
  ALastNonSpaceBoxIndex := TdxRow.FindLastNonSpaceBoxIndex(FBoxes, AStartIndex);
  ATabbedContentWidth := FBoxes[ALastNonSpaceBoxIndex].Bounds.Right -
    FBoxes[AStartIndex].Bounds.Left;
  ALastNonSpaceBoxRight := FBoxes[ALastNonSpaceBoxIndex].Bounds.Right;
  ATabPosition := ATab.GetLayoutPosition
    (DocumentModel.ToDocumentLayoutUnitConverter);
  ATabWidth := Trunc(ATabbedContentWidth / 2 + (FColumnLeft + ATabPosition) -
    ALastNonSpaceBoxRight);
  ATabWidth := AdjustAlignedTabWidth(ATab, ATabWidth, ALastNonSpaceBoxRight);
  Result := Math.Max(0, ATabWidth);
end;

function TdxTabsController.CalcLastDecimalTabWidth(const ATab: TdxTabInfo;
AStartIndex: Integer; AFormatter: TdxParagraphBoxFormatter;
ARowLeft: Integer): Integer;
var
  ALastNonSpaceBoxIndex, ADecimalPointPosition, ALastNonSpaceBoxRight,
    ATabPosition, ATabWidth: Integer;
begin
  ALastNonSpaceBoxIndex := TdxRow.FindLastNonSpaceBoxIndex(FBoxes, AStartIndex);
  ADecimalPointPosition := FindDecimalPointPosition(FBoxes, AStartIndex + 1,
    ALastNonSpaceBoxIndex, AFormatter, ARowLeft);
  if ALastNonSpaceBoxIndex >= 0 then
    ALastNonSpaceBoxRight := FBoxes[ALastNonSpaceBoxIndex].Bounds.Right
  else
    ALastNonSpaceBoxRight := ARowLeft;
  ATabPosition := ATab.GetLayoutPosition
    (FDocumentModel.ToDocumentLayoutUnitConverter);
  ATabWidth := (FColumnLeft + ATabPosition) - ADecimalPointPosition;
  ATabWidth := AdjustAlignedTabWidth(ATab, ATabWidth, ALastNonSpaceBoxRight);
  Result := Max(0, ATabWidth);
end;

function TdxTabsController.CalcLastRightTabWidth(const ATab: TdxTabInfo;
AStartIndex: Integer): Integer;
var
...
begin
  ...
  ATabPosition := ATab.GetLayoutPosition
    (FDocumentModel.ToDocumentLayoutUnitConverter);
  Result := Max(0, (FColumnLeft + ATabPosition) - FBoxes[ALastNonSpaceBoxIndex]
    .Bounds.Right);
end;

function TdxTabsController.CalcLastTabWidth(ARow: TdxRow;
AFormatter: TdxParagraphBoxFormatter): Integer;
var
...
begin
  ...
  case ATab.Alignment of
    ...
    TdxTabAlignmentType.Decimal:
      ATabWidth := CalcLastDecimalTabWidth(ATab, AIndex, AFormatter,
        ARow.Bounds.Left);
  else
    Exit(0);
  end;
...
class function TdxTabsController.CalculateLeaderCount(ABox: TdxTabSpaceBox;
APieceTable: TdxPieceTable): Integer;
begin
  if ABox.TabInfo.Leader = TdxTabLeaderType.None then
    Result := -1
  else
    Result := ABox.Bounds.Width div Max(1, GetTabLeaderCharacterWidth(ABox,
      APieceTable));
end;

class function TdxTabsController.GetTabLeaderCharacterWidth
  (ABox: TdxTabSpaceBox; APieceTable: TdxPieceTable): Integer;
var
  AFontInfo: TdxFontInfo;
begin
...
class procedure TdxTabsController.CacheLeader(ABox: TdxTabSpaceBox;
AFormatter: TdxParagraphBoxFormatter);
var
  AText: string;
  AFontInfo: TdxFontInfo;
...
begin
  try
    ...
    begin
      AText := StringOfChar(GetTabLeaderCharacter(ABox.TabInfo.Leader),
        ABox.LeaderCount);
      AFontInfo := ABox.GetFontInfo(AFormatter.PieceTable);
      AMeasurer := AFormatter.Measurer;
      if AMeasurer.TextViewInfoCache.TryGetTextViewInfo(AText, AFontInfo) = nil
      then
      begin
        ATextInfo := AMeasurer.CreateTextViewInfo(AText, AFontInfo);
        AMeasurer.TextViewInfoCache.AddTextViewInfo(AText, AFontInfo,
          ATextInfo);
      end;
    end;
  except
...
class function TdxTabsController.GetTabLeaderCharacter
  (ALeaderType: TdxTabLeaderType): Char;
begin
  case ALeaderType of
    TdxTabLeaderType.MiddleDots:
...
function TdxTabsController.FindDecimalPointPosition(ABoxes: TdxBoxCollection;
AFrom, ATo: Integer; AFormatter: TdxParagraphBoxFormatter;
ARowLeft: Integer): Integer;
var
...
begin
  ...
  try
    ABoxInfo.StartPos := ABox.StartPos;
    AEndPos := TdxFormatterPosition.Create(ABox.EndPos.RunIndex,
      ABox.StartPos.Offset + AOffset - 1, 0);
...
function TdxTabsController.IsTabPositionBehindParagraphRight
  (const ATab: TdxTabInfo): Boolean;
var
...
begin
  FreeAndNil(FTabs);
  if (FParagraph.FirstLineIndentType = TdxParagraphFirstLineIndent.Hanging) and
    not FParagraph.IsInList then
  begin
    AAutomaticTabAtHangingIndent := TdxTabFormattingInfo.Create;
    try
      AAutomaticTabAtHangingIndent.Add
        (TdxTabInfo.CreateDefault(FParagraph.LeftIndent));
      ATempTabs := FParagraph.GetTabs;
      try
        FTabs := TdxTabFormattingInfo.Merge(ATempTabs,
          AAutomaticTabAtHangingIndent);
      finally
  ...
  SingleDecimalTabInTable := (FTabs.Count = 1) and
    (FTabs[0].Alignment = TdxTabAlignmentType.Decimal) and FParagraph.IsInCell;
end;
...
function TdxTabsController.IsDecimalSeparator(const ASource: string;
AIndex: Integer): Boolean;
begin
  Result := IsSubstringStarts(ASource, AIndex,
    DocumentModel.NumberDecimalSeparator);
end;

function TdxTabsController.IsGroupSeparator(const ASource: string;
AIndex: Integer): Boolean;
begin
  Result := IsSubstringStarts(ASource, AIndex,
    DocumentModel.NumberGroupSeparator);
end;

function TdxTabsController.IsSubstringStarts(const ASource: string;
AIndex: Integer; const ASubstring: string): Boolean;
var
  S: string;
begin
...
function TdxTabsController.TryFindDecimalSeparator(ABoxes: TdxBoxCollection;
AFrom, ATo: Integer; out ABoxIndex: Integer; out AOffset: Integer): Boolean;
var
  ...
  begin
    ...
    begin
      ...
      if dxWideIsNumeric(AText[AOffset + 1]) then
        ANumberStarted := True
      else if ANumberStarted and not IsGroupSeparator(AText, AOffset + 1) then
        Exit(True);
      Inc(AOffset);
    end;
    Inc(ABoxIndex);
...
constructor TdxTableCellColumnController.Create
  (AParent: TdxCustomColumnController; ACurrentParentColumn: TdxColumn;
ALeft, ATop, AWidth: Integer; ATableViewInfo: TdxTableViewInfo;
...
procedure TdxTableCellColumnController.AddInnerTable(ATableViewInfo
  : TdxTableViewInfo);
begin
  CurrentCell.AddInnerTable(ATableViewInfo);
end;

procedure TdxTableCellColumnController.RemoveGeneratedColumn
  (AColumn: TdxColumn);
var
...
function TdxTableCellColumnController.GetPreviousColumn(AColumn: TdxColumn)
  : TdxColumn;
begin
  Result := nil;
end;

function TdxTableCellColumnController.CompleteCurrentColumnFormatting
  (AColumn: TdxColumn): TdxCompleteFormattingResult;
begin
...
function TdxTableCellColumnController.GetNextColumn(AColumn: TdxColumn;
AKeepFloatingObjects: Boolean): TdxColumn;
var
...
begin
  ...
  if (FCurrentColumnIndex >= FGeneratedColumns.Count) then
  begin
    ANewColumn := FParent.GetNextColumn(FCurrentParentColumn,
      AKeepFloatingObjects);
    FGeneratedColumns.Add(ANewColumn);
  end
  else if FParent is TdxTableCellColumnController then
  ...
  Result.Bounds := TRect.CreateSize(ABounds.Left + FLeft, ABounds.Top, FWidth,
    ABounds.Height);
end;

function TdxTableCellColumnController.GetPageAreaController
  : TdxPageAreaController;
begin
...
begin
  ...
  Result := TdxTableCellColumn.Create(FGeneratedColumns[FCurrentColumnIndex],
    FCurrentCell);
  Result.Bounds := TRect.CreateSize(ABounds.Left + FLeft, FTop, FWidth,
    ABounds.Bottom - FTop);
end;

procedure TdxTableCellColumnController.SetCurrentParentColumn
  (AColumn: TdxColumn);
begin
  ...
  if Parent is TdxTableCellColumnController then
    TdxTableCellColumnController(Parent).SetCurrentParentColumn
      (TdxTableCellColumn(AColumn).Parent);
end;

procedure TdxTableCellColumnController.StartNewCell(ACurrentParentColumn
  : TdxColumn; ALeft, ATop, AWidth: Integer; ACurrentCell: TdxTableCell);
begin
  FLeft := ALeft;
  FTop := ATop;
  FWidth := AWidth;
...
function TdxTableCellColumnController.GetMaxAnchor(AAnchor1,
  AAnchor2: TdxTableCellVerticalAnchor): TdxTableCellVerticalAnchor;
var
  ACellBordersInfo: TdxHorizontalCellBordersInfoList;
begin
  ACellBordersInfo := AAnchor1.CellBorders.Clone;
  if AAnchor1.VerticalPosition > AAnchor2.VerticalPosition then
    Result := TdxTableCellVerticalAnchor.Create(AAnchor1.VerticalPosition,
      AAnchor1.BottomTextIndent, ACellBordersInfo)
  else
    Result := TdxTableCellVerticalAnchor.Create(AAnchor2.VerticalPosition,
      AAnchor2.BottomTextIndent, ACellBordersInfo);
end;

procedure TdxTableCellColumnController.AddTableViewInfo(ACurrentTableViewInfo
  : TdxTableViewInfo);
begin
  FGeneratedTableViewInfo.Add(ACurrentTableViewInfo);
end;

procedure TdxTableCellColumnController.RemoveTableViewInfo(ATableViewInfo
  : TdxTableViewInfo);
begin
  FGeneratedTableViewInfo.Remove(ATableViewInfo);
end;

function TdxTableCellColumnController.GetCurrentPageBounds
  (ACurrentPage: TdxPage; ACurrentColumn: TdxColumn): TRect;
begin
  Result := ACurrentColumn.Bounds;
end;

function TdxTableCellColumnController.GetCurrentPageClientBounds
  (ACurrentPage: TdxPage; ACurrentColumn: TdxColumn): TRect;
begin
  Result := ACurrentColumn.Bounds;
end;
...
function TdxTableCellColumnController.
  GetShouldZeroSpacingBeforeWhenMoveRowToNextColumn: Boolean;
begin
  Result := False;
end;
...
procedure TdxTableCellColumnController.SetCurrentTableCellViewInfo
  (AValue: TdxTableCellViewInfo);
begin
...
procedure TdxTableCellColumnController.InternalSetCurrentParentColumn
  (const Value: TdxColumn);
begin
...
procedure TdxTableCellColumnController.SetParent
  (AValue: TdxCustomColumnController);
begin
...
procedure TdxCharacterFormatterStateBase.AddBox(AType: TdxBoxClass;
var ABoxInfo: TdxBoxInfo; AMeasured: Boolean);
var
  ABox: TdxBox;
begin
...
procedure TdxCharacterFormatterStateBase.AppendBoxCore(AType: TdxBoxClass;
var ABoxInfo: TdxBoxInfo);
var
  AMeasured: Boolean;
begin
  AMeasured := False;
...
procedure TdxCharacterFormatterStateBase.ChangeState
  (AStateType: TdxCharacterFormatterState);
begin
  Formatter.ChangeState(AStateType);
end;
...
begin
  ...
  try
    ...
    Result := ContinueFormatByCharacter(ABoxInfo, nil)
      = TdxStateContinueFormatResult.Success;
  finally
    FreeAndNil(ABoxInfo);
  end;
end;
...
function TdxCharacterFormatterStateBase.FinishParagraph
  : TdxCompleteFormattingResult;
var
  ABoxInfo: TdxBoxInfo;
begin
...
procedure TdxCharacterFormatterStateBase.FinishParagraphCore
  (AIterator: TdxParagraphIteratorBase);
begin
end;

function TdxCharacterFormatterStateBase.FinishSection
  : TdxCompleteFormattingResult;
var
  ABoxInfo: TdxBoxInfo;
begin
...
function TdxCharacterFormatterStateBase.GetCharacterFormatterState
  : TdxCharacterFormatterState;
begin
  Result := &Type;
end;
...
function TdxCharacterFormatterStateBase.GetDashState
  : TdxCharacterFormatterState;
begin
...
function TdxCharacterFormatterStateBase.GetNextState
  : TdxCharacterFormatterState;
var
  ACurrentRun: TdxTextRunBase;
begin
  ...
  if IsInlineObjectRun(ACurrentRun) then
    Result := TdxCharacterFormatterState.InlineObject
  else if IsSeparatorRun(ACurrentRun) then
    Result := TdxCharacterFormatterState.Separator
  else if IsFloatingObjectRun(ACurrentRun) then
    Result := TdxCharacterFormatterState.FloatingObject
  else if IsLayoutDependentTextRun(ACurrentRun) then
...
function TdxCharacterFormatterStateBase.IsFloatingObjectRun
  (ARun: TdxTextRunBase): Boolean;
begin
  Result := ARun is TdxFloatingObjectAnchorRun;
end;

function TdxCharacterFormatterStateBase.IsInlineObjectRun
  (ARun: TdxTextRunBase): Boolean;
begin
  Result := Supports(ARun, IdxInlineObjectRun);
end;

function TdxCharacterFormatterStateBase.IsLayoutDependentTextRun
  (ARun: TdxTextRunBase): Boolean;
begin
  Result := ARun is TdxLayoutDependentTextRun;
end;

function TdxCharacterFormatterStateBase.IsParagraphMarkRun
  (ARun: TdxTextRunBase): Boolean;
begin
  Result := ARun is TdxParagraphRun;
end;

function TdxCharacterFormatterStateBase.IsSeparatorRun
  (ARun: TdxTextRunBase): Boolean;
begin
...
constructor TdxParagraphFormatterBase<TState>.Create(APieceTable: TdxPieceTable;
AMeasurer: TdxBoxMeasurer);
begin
  inherited Create;
...
class function TdxParagraphFormatterBase<TState>.GetSpaceBoxTemplate
  (ABoxInfo: TdxBoxInfo): TdxBoxClass;
begin
...
procedure TdxParagraphFormatterBase<TState>.
  OnNewMeasurementAndDrawingStrategyChanged(AMeasurer: TdxBoxMeasurer);
begin
  Assert(AMeasurer <> nil);
  FMeasurer := AMeasurer;
end;

procedure TdxParagraphFormatterBase<TState>.SetIterator
  (const Value: TdxParagraphIteratorBase);
begin
  FreeAndNil(FIterator);
  FIterator := Value;
end;
...
function TdxCharacterFormatterFirstDashState.GetDashState
  : TdxCharacterFormatterState;
begin
  Result := TdxCharacterFormatterState.Dash;
end;

function TdxCharacterFormatterFirstDashState.GetType
  : TdxCharacterFormatterState;
begin
  Result := TdxCharacterFormatterState.FirstDash;
end;

function TdxCharacterFormatterFirstDashState.IsTerminatorChar
  (ACh: Char): Boolean;
begin
  Result := True;
end;
...
function TdxTextArea.TdxTextAreaStartComparer.Compare(const X,
  Y: TdxTextArea): Integer;
begin
...
function TdxTextArea.IntersectsWithExcludingBounds(const AInterval
  : TdxTextArea): Boolean;
begin
  Result := (AInterval.&End > Start) and (AInterval.Start < &End);
end;

class function TdxTextArea.Union(const AInterval1, AInterval2: TdxTextArea)
  : TdxTextArea;
begin
  Result := TdxTextArea.Create(Min(AInterval1.Start, AInterval2.Start),
    Max(AInterval1.&End, AInterval2.&End));
end;
...
function TdxParagraphBoxIterator.GetPreviousOffsetPosition
  : TdxFormatterPosition;
var
  APos: TdxFormatterPosition;
begin
...
function TdxParagraphBoxIterator.GetPreviousVisibleRunPosition
  : TdxFormatterPosition;
var
  APos: TdxFormatterPosition;
begin
...
begin
  Result := inherited Next;
  if (Offset > CurrentBox.EndPos.Offset) or
    (Result <> TdxParagraphIteratorResult.Success) then
    NextBoxCore;
end;
...
procedure TdxParagraphBoxIterator.SetNextPosition(const APrevPosition
  : TdxFormatterPosition);
begin
...
function TdxCharacterFormatterSeparatorState.GetType
  : TdxCharacterFormatterState;
begin
  Result := TdxCharacterFormatterState.Separator;
end;

function TdxCharacterFormatterSeparatorState.IsTerminatorChar
  (ACh: Char): Boolean;
begin
  Result := TdxCharacters.IsCharSpace(ACh) or (ACh = TdxCharacters.TabMark) or
    (ACh = TdxCharacters.LineBreak) or (ACh = TdxCharacters.PageBreak) or
...
function TdxCharacterFormatterSeparatorState.AppendBox(var ABoxInfo: TdxBoxInfo)
  : TdxStateContinueFormatResult;
begin
...
procedure TdxCharacterFormatterSeparatorState.MeasureBoxContent
  (ABoxInfo: TdxBoxInfo);
var
  ARun: TdxTextRunBase;
begin
...
function TdxCharacterFormatterTextState.AppendBox(var ABoxInfo: TdxBoxInfo)
  : TdxStateContinueFormatResult;
begin
  if Paragraph.PieceTable.Runs[ABoxInfo.StartPos.RunIndex] is TdxSpecialTextRun
  then
...
procedure TdxCharacterFormatterTextState.MeasureBoxContent
  (ABoxInfo: TdxBoxInfo);
begin
  Measurer.MeasureText(ABoxInfo);
end;

function TdxCharacterFormatterTextState.MaxTextLengthExceeded
  (ABox: TdxBoxInfo): Boolean;
begin
  Result := Iterator.Offset - ABox.StartPos.Offset > MaxTextLength;
end;
...
function TdxStateRowTextSplitAfterFirstLeadingTab.CompleteRowProcessing
  : TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
...
function TdxStateRowTextSplitAfterFirstLeadingTab.GetType
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowTextSplitAfterFirstLeadingTab;
end;

function TdxStateRowTextSplitAfterFirstLeadingTab.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.
    RowTextSplitAfterFirstLeadingTabAfterFloatingObject
...
function TdxStateRowTextSplitAfterFirstLeadingTab.HandleUnsuccessfulSplitting
  : TdxCompleteFormattingResult;
begin
  Formatter.RollbackToStartOfWord;
  SetCurrentRowHeightToLastBoxHeight;
...
function TdxStateRowTextHyphenationFirstSyllable.GetNextState
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowTextHyphenation;
end;

function TdxStateRowTextHyphenationFirstSyllable.GetType
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowTextHyphenationFirstSyllable;
end;

function TdxStateRowTextHyphenationFirstSyllable.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.
    RowTextHyphenationFirstSyllableAfterFloatingObject;
...
function TdxStateRowTextHyphenationFirstSyllable.HorizontalOverfull
  (ABoxInfo: TdxBoxInfo): TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
...
function TdxStateRowTextHyphenationFirstSyllableAfterFirstLeadingTab.
  CompleteRowProcessing: TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
  ACanFit := RowsController.CanFitCurrentRowToColumn;
...
function TdxStateRowTextHyphenationFirstSyllableAfterFirstLeadingTab.GetType
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.
    RowTextHyphenationFirstSyllableAfterFirstLeadingTab;
...
function TdxStateRowTextHyphenationFirstSyllableAfterFirstLeadingTab.
  HorizontalOverfull(ABoxInfo: TdxBoxInfo): TdxCompleteFormattingResult;
var
  ASplitBoxResult: TdxSplitBoxResult;
begin
  ASplitBoxResult := SplitBox(ABoxInfo);
...
constructor TdxStateFloatingObject.Create(AFormatter: TdxParagraphBoxFormatter;
APreviousState: TdxBoxFormatterStateBase);
begin
  inherited Create(AFormatter);
...
begin
  ...
  begin
    ...
    begin
      ...
      RowsController.AddParagraphFrameToLayout
        (TdxParagraphFrameBox.Create(ARun.Paragraph), ABoxInfo);
    end;
  end;
end;

function TdxStateFloatingObject.CanAddBox(ABoxInfo: TdxBoxInfo)
  : TdxAddBoxResult;
begin
  Result := CanAddBoxCore(ABoxInfo);
end;
...
function TdxStateFloatingObject.ColumnOverfull
  (ACanFit: TdxCanFitCurrentRowToColumnResult; ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Result := Formatter.RollbackToStartOfRow(ACanFit);
...
function TdxStateFloatingObject.HorizontalOverfull(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Result := TdxCompleteFormattingResult.Success;
end;
...
begin
  ...
  if Supports(Formatter.State, IdxSupportsChangeStateManually, ANewState) then
    ANewState.ChangeStateManuallyIfNeeded
      (TdxParagraphIteratorResult.RunFinished);
end;

{ TdxCharacterFormatterStartState }

function TdxCharacterFormatterStartState.AppendBox(var ABoxInfo: TdxBoxInfo)
  : TdxStateContinueFormatResult;
begin
  Assert(False);
  Result := TdxStateContinueFormatResult.Success;
...
procedure TdxCharacterFormatterStartState.MeasureBoxContent
  (ABoxInfo: TdxBoxInfo);
begin
  Assert(False);
end;
...
function TdxStateRowEmpty.AppendBox(var ABoxInfo: TdxBoxInfo)
  : TdxStateContinueFormatResult;
begin
  Result := TdxStateContinueFormatResult.Success;
end;
...
function TdxStateRowEmpty.ColumnOverfull
  (ACanFit: TdxCanFitCurrentRowToColumnResult; ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(False);
...
function TdxStateRowEmpty.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowEmptyAfterFloatingObject;
end;

function TdxStateRowEmpty.HorizontalOverfull(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert(False);
  Result := TdxCompleteFormattingResult.Success;
...
begin
  if not(TdxRowProcessingFlag.LastInvisibleEmptyCellRowAfterNestedTable
    in CurrentRow.ProcessingFlags) then
    RowsController.UpdateCurrentRowHeight(ABoxInfo);
end;

function TdxStateRowEmptyBase.CanFitCurrentRowToColumn(ABoxInfo: TdxBoxInfo)
  : TdxCanFitCurrentRowToColumnResult;
begin
...
begin
  ...
  else if ACh = TdxCharacters.SectionMark then
  begin
    if Iterator.IsParagraphMarkRun then
  ...
  else if TdxCharacters.IsCharSpace(ACh) then
    ChangeState(TdxParagraphBoxFormatterState.RowWithSpacesOnly)
  else if TdxCharacters.IsCharDash(ACh) then
    ChangeState(TdxParagraphBoxFormatterState.RowWithDashOnly)
  else if ACh = TdxCharacters.TabMark then
    ChangeState(TdxParagraphBoxFormatterState.RowFirstLeadingTab)
  else if ACh = TdxCharacters.LineBreak then
    ChangeState(TdxParagraphBoxFormatterState.RowLineBreak)
  else if ACh = TdxCharacters.PageBreak then
  begin
    if RowsController.TablesController.IsInsideTable then
      ChangeState(TdxParagraphBoxFormatterState.RowWithSpacesOnly)
    else if not RowsController.SupportsColumnAndPageBreaks then
  ...
  else if ACh = TdxCharacters.ColumnBreak then
  begin
    if RowsController.TablesController.IsInsideTable then
      ChangeState(TdxParagraphBoxFormatterState.RowWithSpacesOnly)
    else if not RowsController.SupportsColumnAndPageBreaks then
  ...
  else if ACh = TdxCharacters.FloatingObjectMark then
  begin
    if Iterator.IsFloatingObjectAnchorRun then
  ...
  else if ACh = TdxCharacters.ObjectMark then
  begin
...
function TdxStateRowEmptyBase.FinishColumn(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
...
function TdxStateRowEmptyBase.FinishLine(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
...
function TdxStateRowEmptyBase.FinishPage(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
...
function TdxStateRowEmptyBase.InternalFinishParagraphCore(ABoxInfo: TdxBoxInfo;
AFinalizeHandler: TFinalizeEvent): TdxCompleteFormattingResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
begin
...
procedure TdxStateRowWithTextOnlyBase.ApplyColumnBreakMarkSize
  (ABoxInfo: TdxBoxInfo);
begin
  if CurrentRow.Boxes.Count <= 0 then
    RowsController.UpdateCurrentRowHeight(ABoxInfo)
...
procedure TdxStateRowWithTextOnlyBase.ApplyLineBreakMarkSize
  (ABoxInfo: TdxBoxInfo);
begin
  if CurrentRow.Boxes.Count <= 0 then
    RowsController.UpdateCurrentRowHeight(ABoxInfo)
...
procedure TdxStateRowWithTextOnlyBase.ApplyPageBreakMarkSize
  (ABoxInfo: TdxBoxInfo);
begin
  if CurrentRow.Boxes.Count <= 0 then
    RowsController.UpdateCurrentRowHeight(ABoxInfo)
...
procedure TdxStateRowWithTextOnlyBase.ApplyParagraphMarkSize
  (ABoxInfo: TdxBoxInfo);
begin
  if CurrentRow.Boxes.Count <= 0 then
    RowsController.UpdateCurrentRowHeight(ABoxInfo)
...
procedure TdxStateRowWithTextOnlyBase.ChangeStateManuallyIfNeeded
  (AIteratorResult: TdxParagraphIteratorResult);
var
  ACurrentChar: Char;
  ANextState: TdxParagraphBoxFormatterState;
begin
...
function TdxStateRowWithTextOnlyBase.FinishColumn(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
...
function TdxStateRowWithTextOnlyBase.FinishLine(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert((CurrentRow.Boxes.Count <= 0) or (CurrentRow.Height > 0));
...
function TdxStateRowWithTextOnlyBase.FinishPage(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Assert((CurrentRow.Boxes.Count <= 0) or (CurrentRow.Height > 0));
...
function TdxStateRowWithTextOnlyBase.FinishParagraph
  : TdxCompleteFormattingResult;
var
  ABoxInfo: TdxBoxInfo;
begin
...
function TdxStateRowWithTextOnlyBase.CalcNextState(ACurrentCharacter: Char)
  : TdxParagraphBoxFormatterState;
begin
  if TdxCharacters.IsCharSpace(ACurrentCharacter) then
    Exit(TdxParagraphBoxFormatterState.RowSpaces);
...
function TdxStateRowWithTextOnlyBase.GetDashAfterTextState
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowDashAfterText;
end;
...
function TdxStateRowWithTextOnlyBase.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowWithTextOnlyAfterFloatingObject;
end;

function TdxStateRowWithTextOnlyBase.HorizontalOverfull(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Formatter.RollbackToStartOfWord;
  if Formatter.SuppressHyphenation then
...
function TdxStateRowWithTextOnlyBase.ShouldChangeStateManually(ACurrentCharacter
  : Char): Boolean;
begin
  Result := not Iterator.IsEnd and IsTerminatorChar(ACurrentCharacter);
end;
...
function TdxStateRowWithTextOnly.CanAddBox(ABoxInfo: TdxBoxInfo)
  : TdxAddBoxResult;
begin
  Result := CanAddBoxCore(ABoxInfo);
end;

function TdxStateRowWithTextOnly.GetDashAfterTextState
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowWithDashAfterTextOnly;
end;

function TdxStateRowWithTextOnly.ColumnOverfull
  (ACanFit: TdxCanFitCurrentRowToColumnResult; ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Result := Formatter.RollbackToStartOfRow(ACanFit);
...
function TdxStateRowWithTextOnly.GetHyphenationState
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowEmptyHyphenation;
end;

function TdxStateRowWithTextOnly.GetNoHyphenationNextState
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowTextSplit;
end;
...
function TdxStateRowWithTextOnly.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowWithTextOnlyAfterFloatingObject;
end;
...
function TdxStateRowWithInlineObjectOnly.CalcNextState(ACurrentCharacter: Char)
  : TdxParagraphBoxFormatterState;
begin
  if inherited IsTerminatorChar(ACurrentCharacter) then
    Result := inherited CalcNextState(ACurrentCharacter)
...
function TdxStateRowWithInlineObjectOnly.HorizontalOverfull
  (ABoxInfo: TdxBoxInfo): TdxCompleteFormattingResult;
begin
  AddTextBox(ABoxInfo);
  Formatter.ApproveFloatingObjects;
...
function TdxCharacterFormatterInlineObjectState.GetType
  : TdxCharacterFormatterState;
begin
  Result := TdxCharacterFormatterState.InlineObject;
end;

function TdxCharacterFormatterInlineObjectState.IsTerminatorChar
  (ACh: Char): Boolean;
begin
  Result := TdxCharacters.IsCharSpace(ACh) or (ACh = TdxCharacters.TabMark) or
    (ACh = TdxCharacters.LineBreak) or (ACh = TdxCharacters.PageBreak) or
...
function TdxCharacterFormatterInlineObjectState.AppendBox
  (var ABoxInfo: TdxBoxInfo): TdxStateContinueFormatResult;
var
  AInlineObjectRun: IdxInlineObjectRun;
begin
  if not Supports(Formatter.PieceTable.Runs[ABoxInfo.StartPos.RunIndex],
    IdxInlineObjectRun, AInlineObjectRun) then
    Assert(False);
  AppendBoxCore(AInlineObjectRun.GetBoxClassType, ABoxInfo);
  Result := TdxStateContinueFormatResult.Success;
end;

procedure TdxCharacterFormatterInlineObjectState.MeasureBoxContent
  (ABoxInfo: TdxBoxInfo);
var
  ARun: TdxTextRunBase;
begin
...
procedure TdxPageAreaController.ClearInvalidatedContent
  (const APos: TdxFormatterPosition);
begin
  State.ClearInvalidatedContent(APos);
end;

function TdxPageAreaController.CompleteCurrentAreaFormatting
  : TdxCompleteFormattingResult;
begin
...
function TdxPageAreaController.CreateDefaultState(ACurrentAreaIndex: Integer)
  : TdxPageAreaControllerState;
begin
...
function TdxPageAreaController.GetNextPageArea(AKeepFloatingObjects: Boolean)
  : TdxPageArea;
begin
...
procedure TdxPageAreaController.RestartFormattingFromTheMiddleOfSection
  (ASection: TdxSection; ACurrentAreaIndex: Integer);
begin
...
procedure TdxPageAreaController.RestartFormattingFromTheStartOfSection
  (ASection: TdxSection; ACurrentAreaIndex: Integer);
begin
  State.RestartFormattingFromTheStartOfSection(ASection, ACurrentAreaIndex);
end;

procedure TdxPageAreaController.SwitchToState
  (AState: TdxPageAreaControllerState);
begin
  FreeAndNil(FState);
  FState := AState;
end;
...
procedure TdxPageAreaControllerState.BeginSectionFormatting
  (ASection: TdxSection; ACurrentColumnsCount: Integer);
begin
...
procedure TdxPageAreaControllerState.ClearInvalidatedContent
  (const APos: TdxFormatterPosition);
var
  AAreas: TdxPageAreaCollection;
  AAreaIndex: Integer;
...
procedure TdxPageAreaControllerState.RestoreCurrentAreaBounds
...
begin
  Result := TdxPageArea.Create(PageController.PieceTable.ContentType,
    PageController.CurrentSection);
...
procedure TdxPageAreaControllerState.RestartFormattingFromTheMiddleOfSection
  (ASection: TdxSection; ACurrentAreaIndex: Integer);
begin
  Assert(ACurrentAreaIndex >= 0);
  CreateCurrentAreaBounds;
...
procedure TdxPageAreaControllerState.
  RestartFormattingFromTheStartOfRowAtCurrentPage;
begin
end;

procedure TdxPageAreaControllerState.RestartFormattingFromTheStartOfSection
  (ASection: TdxSection; ACurrentAreaIndex: Integer);
begin
  Assert(ACurrentAreaIndex >= 0);
  CreateCurrentAreaBounds;
...
procedure TdxPageController.SetFloatingObjectsLayout
  (ALayout: TdxFloatingObjectsLayout);
begin
...
procedure TdxPageController.FinalizePagePrimaryFormatting(APage: TdxPage;
ADocumentEnded: Boolean);
begin
...
begin
  ...
  if not APageContainsFloatingObjects and
    not(ParagraphFramesLayout.Items.Count > 0) then
  begin
  ...
  if ContainsOrphanedItems(FloatingObjectsLayout.Items, AMaxRunIndex) then
    Exit(False);
  if ContainsOrphanedItems(FloatingObjectsLayout.ForegroundItems, AMaxRunIndex)
  then
    Exit(False);
  if ContainsOrphanedItems(FloatingObjectsLayout.BackgroundItems, AMaxRunIndex)
  then
    Exit(False);
  if ContainsOrphanedItems(ParagraphFramesLayout.Items) then
    Exit(False);

  AppendFloatingObjects(FloatingObjectsLayout.Items, APage.FloatingObjects,
    AMaxRunIndex);
  AppendFloatingObjects(FloatingObjectsLayout.ForegroundItems,
    APage.ForegroundFloatingObjects, AMaxRunIndex);
  AppendFloatingObjects(FloatingObjectsLayout.BackgroundItems,
    APage.BackgroundFloatingObjects, AMaxRunIndex);
  ClearFloatingObjectsLayout;
...
begin
  ...
  if ASection.FootNote.NumberingRestartType = TdxLineNumberingRestart.NewSection
  then
    DocumentLayout.Counters.GetCounter(TdxFootNote.FootNoteCounterId).LastValue
      := ASection.FootNote.StartingNumber;
  if ASection.EndNote.NumberingRestartType = TdxLineNumberingRestart.NewSection
  then
    DocumentLayout.Counters.GetCounter(TdxEndNote.EndNoteCounterId).LastValue :=
      ASection.EndNote.StartingNumber;
end;

procedure TdxPageController.BeginNextSectionFormatting(ASectionIndex
  : TdxSectionIndex);
var
  ASection: TdxSection;
begin
  CurrentSectionIndex := ASectionIndex;
  ASection := TdxDocumentModel(DocumentLayout.DocumentModel)
...
function TdxPageController.CalculateNextPageOrdinalType(ASection: TdxSection)
  : TdxSectionStartType;
begin
...
function TdxPageController.CalculatePageOrdinal(AFirstPageOfSection: Boolean)
  : TdxCalculatePageOrdinalResult;
var
...
begin
  ...
  Result := CalculatePageOrdinalCore(APageOrdinal, ANumSkippedPages,
    AFirstPageOfSection);
end;

function TdxPageController.CalculatePageOrdinalCore(APreviousPageOrdinal,
  ANumSkippedPages: Integer; AFirstPageOfSection: Boolean)
  : TdxCalculatePageOrdinalResult;
var
  APageOrdinal: Integer;
  AIsPageOrdinalOdd: Boolean;
begin
  if AFirstPageOfSection and (not CurrentSection.PageNumbering.ContinueNumbering)
  then
    ...
    TdxSectionStartType.OddPage:
      begin
        if AIsPageOrdinalOdd then
          Result := TdxCalculatePageOrdinalResult.Create(APageOrdinal,
            ANumSkippedPages)
        else
          Result := TdxCalculatePageOrdinalResult.Create(APageOrdinal + 1,
            ANumSkippedPages + 1);
      end;
    TdxSectionStartType.EvenPage:
      begin
...
procedure TdxPageController.FormatHeader(APage: TdxPage;
AFirstPageOfSection: Boolean);
begin
end;

procedure TdxPageController.FormatFooter(APage: TdxPage;
AFirstPageOfSection: Boolean);
begin
end;

function TdxPageController.ClearInvalidatedContent
  (const APos: TdxFormatterPosition; AParagraphIndex: TdxParagraphIndex;
AKeepFloatingObjects, AEmptyCurrentRow: Boolean)
...
begin
  ...
  ANewSectionIndex := APieceTable.LookupSectionIndexByParagraphIndex
    (AParagraphIndex);
  if (ANewSectionIndex > CurrentSectionIndex) and
    (GetActualFormattingSectionIndex(ANewSectionIndex) > CurrentSectionIndex)
  then
    Exit(TdxClearInvalidatedContentResult.NoRestart);
  CurrentSectionIndex := ANewSectionIndex;

  ASection := DocumentModel.Sections[CurrentSectionIndex];
  if (ASection.FirstParagraphIndex = AParagraphIndex) and (APos.Offset = 0) and
    (APos.RunIndex = APieceTable.Paragraphs[AParagraphIndex].FirstRunIndex) then
  begin
...
function TdxPageController.GetActualFormattingSectionIndex
  (ASectionIndex: TdxSectionIndex): TdxSectionIndex;
var
...
begin
  ...
  begin
    ...
    APrevSectionLastParagraphIndex := DocumentModel.Sections[APrevSectionIndex]
      .LastParagraphIndex;
    ARunIndex := PieceTable.Paragraphs[APrevSectionLastParagraphIndex]
      .LastRunIndex;
    if PieceTable.VisibleTextFilter.IsRunVisible(ARunIndex) then
      Exit(ASectionIndex);
...
function TdxPageController.CompleteCurrentPageFormatting
  : TdxCompleteFormattingResult;
begin
...
function TdxPageController.ClearInvalidatedContentFromTheStartOfRowAtCurrentPage
  (const APos: TdxFormatterPosition; AParagraphIndex: TdxParagraphIndex;
AKeepFloatingObjects: Boolean; ATablesController: TdxTablesController;
AEmptyCurrentRow: Boolean; out ALeaveTable: Boolean)
  : TdxClearInvalidatedContentResult;
...
begin
  ...
  begin
    ...
    if (ACurrentCell <> nil) and
      (AParagraphIndex >= ACurrentCell.Table.StartParagraphIndex) or
...
procedure TdxPageController.CorrectLastPageOrdinal(AParagraphIndex
  : TdxParagraphIndex; APageIndex: Integer);
var
  APieceTable: TdxPieceTable;
...
begin
  ...
  AEmptyPageStartLogPosition := ALastNonEmptyPage.GetLastPosition(APieceTable)
    .LogPosition + 1;
  ASectionIndex := APieceTable.LookupSectionIndexByParagraphIndex
    (AParagraphIndex);
  ASection := DocumentModel.Sections[ASectionIndex];
  if (APieceTable.Paragraphs[ASection.FirstParagraphIndex]
    .LogPosition = AEmptyPageStartLogPosition) then
  begin
    FNextPageOrdinalType := CalculateNextPageOrdinalType(ASection);
...
begin
  ...
  if CurrentSection.FootNote.NumberingRestartType = TdxLineNumberingRestart.NewPage
  then
    DocumentLayout.Counters.GetCounter(TdxFootNote.FootNoteCounterId).LastValue
      := CurrentSection.FootNote.StartingNumber;
  if CurrentSection.EndNote.NumberingRestartType = TdxLineNumberingRestart.NewPage
  then
    DocumentLayout.Counters.GetCounter(TdxEndNote.EndNoteCounterId).LastValue :=
      CurrentSection.EndNote.StartingNumber;
end;
...
procedure TdxPageController.PopulateFloatingObjects(AFloatingObjects
  : TdxFloatingObjectBoxList);
var
  I: Integer;
  AFloatingObject: TdxFloatingObjectBox;
...
begin
  ...
  begin
    ...
    ARun := TdxFloatingObjectAnchorRun(AFloatingObject.PieceTable.Runs
      [AFloatingObject.StartPos.RunIndex]);
...
procedure TdxPageController.PopulateParagraphFrames(AParagraphFrames
  : TdxParagraphFrameBoxList);
var
  I: Integer;
begin
...
procedure TdxPageController.SetCurrentSectionIndex
  (const Value: TdxSectionIndex);
begin
...
procedure TdxPageController.AppendFloatingObjects(AFrom,
  ATo: TdxFloatingObjectBoxList; AMaxRunIndex: TdxRunIndex);
var
  I: Integer;
  AFloatingObject: TdxFloatingObjectBox;
begin
  ...
  begin
    ...
    if (AFloatingObject.PieceTable <> PieceTable) or
      (AFloatingObject.StartPos.RunIndex <= AMaxRunIndex) then
      ATo.Add(AFloatingObject);
  end;
  ATo.Sort(TdxFloatingObjectBox.ZOrderComparer);
end;

procedure TdxPageController.AppendParagraphFrames(AFrom,
  ATo: TdxParagraphFrameBoxList);
var
  ACount, I: Integer;
...
begin
  ...
  begin
    ABox := AFrom[I];
    if (ABox.PieceTable <> PieceTable) or
      (ABox.StartPos.RunIndex <= PageLastRunIndex) then
      ATo.Add(ABox);
  end;
...
procedure TdxPageController.RestartFormattingFromTheMiddleOfSection
  (ASection: TdxSection);
var
  ALastPage: TdxPage;
begin
...
procedure TdxPageController.RestartFormattingFromTheMiddleOfSectionCore
  (ASection: TdxSection);
var
  ALastPage: TdxPage;
begin
  ...
  FPageClientBounds := PageBoundsCalculator.CalculatePageClientBounds
    (CurrentSection);
...
begin
  CurrentSectionIndex := CurrentSectionIndex + 1;
  Var1 :=
    TdxDocumentModel(DocumentLayout.DocumentModel).Sections
    [CurrentSectionIndex];

  ApplySectionStart(Var1);
  RestartFormattingFromTheMiddleOfSectionCore
    (Var1);
  FFirstPageOfSection := True;
end;

function TdxPageController.ContainsOrphanedItems
  (AItems: TdxFloatingObjectBoxList; AMaxRunIndex: TdxRunIndex): Boolean;
var
  I: Integer;
  AFloatingObject: TdxFloatingObjectBox;
begin
  ...
  begin
    ...
    if (AFloatingObject.PieceTable = PieceTable) and
      (AFloatingObject.StartPos.RunIndex > AMaxRunIndex) and AFloatingObject.WasRestart
    then
      Exit(True);
  end;
end;
...
function TdxPageController.ContainsOrphanedItems
  (AItems: TdxParagraphFrameBoxList): Boolean;
var
  ACount, I: Integer;
  AParagraphFrame: TdxParagraphFrameBox;
begin
  ...
  begin
    ...
    if (AParagraphFrame.PieceTable = PieceTable) and
      AParagraphFrame.WasRestart and
      (AParagraphFrame.StartPos.RunIndex > PageLastRunIndex) and
...
constructor TdxColumnController.Create(APageAreaController
  : TdxPageAreaController);
begin
...
begin
  case ASection.GeneralSettings.StartType of
    TdxSectionStartType.Continuous, TdxSectionStartType.EvenPage,
      TdxSectionStartType.OddPage, TdxSectionStartType.NextPage:
      FNextColumnIndex := 0;
    TdxSectionStartType.Column:
...
function TdxColumnController.CalculateColumnBounds(AColumnIndex
  : Integer): TRect;
var
  AAreaBounds: TRect;
begin
...
procedure TdxColumnController.ClearInvalidatedContent
  (const APos: TdxFormatterPosition);
begin
  ClearInvalidatedContentCore(APos, Columns);
end;

procedure TdxColumnController.ClearInvalidatedContentCore
  (const APos: TdxFormatterPosition; AColumns: TdxColumnCollection);
var
  AColumn: TdxColumn;
...
begin
  ...
  try
    FreeAndNil(FColumnsBounds);
    FColumnsBounds := ACalculator.Calculate
      (FPageAreaController.PageController.CurrentSection,
      FPageAreaController.CurrentAreaBounds);
  finally
    ACalculator.Free;
  end;
end;

function TdxColumnController.CreateColumnBoundsCalculator
  : TdxColumnsBoundsCalculator;
begin
  Result := TdxColumnsBoundsCalculator.Create
    (FPageAreaController.PageController.DocumentLayout.DocumentModel.
    ToDocumentLayoutUnitConverter);
end;
...
function TdxColumnController.CompleteCurrentColumnFormatting(AColumn: TdxColumn)
  : TdxCompleteFormattingResult;
begin
...
function TdxColumnController.GetCurrentPageBounds(ACurrentPage: TdxPage;
ACurrentColumn: TdxColumn): TRect;
begin
  Result := ACurrentPage.Bounds;
end;

function TdxColumnController.GetCurrentPageClientBounds(ACurrentPage: TdxPage;
ACurrentColumn: TdxColumn): TRect;
begin
...
function TdxColumnController.GetNextColumn(AColumn: TdxColumn;
AKeepFloatingObjects: Boolean): TdxColumn;
begin
...
procedure TdxColumnController.RestartFormattingFromTheMiddleOfSection
  (ASection: TdxSection; ACurrentColumnIndex: Integer);
begin
  CreateColumnBounds;
...
procedure TdxColumnController.RestartFormattingFromTheStartOfSection
  (ASection: TdxSection; ACurrentColumnIndex: Integer);
begin
  CreateColumnBounds;
  FNextColumnIndex := (ACurrentColumnIndex + 1) mod ColumnsBounds.Count;
...
function TdxCharacterFormatterLineBreak.AppendBox(var ABoxInfo: TdxBoxInfo)
  : TdxStateContinueFormatResult;
begin
...
procedure TdxCharacterFormatterLineBreak.MeasureBoxContent
  (ABoxInfo: TdxBoxInfo);
begin
...
constructor TdxTablesController.Create(APageController: TdxPageController;
ARowsController: TdxRowsController);
begin
  inherited Create;
  FRowsController := ARowsController;
  ...
  FTableBreaks := TObjectDictionary < TdxTable,
    TdxSortedList < TPair<Integer, Integer> >>.Create([doOwnsValues]);
...
function TdxBreakComparer.CompareTo(const AOther
  : TPair<Integer, Integer>): Integer;
begin
  Result := AOther.Key - FKey;
end;

function TdxTablesController.GetTableBreak(ATable: TdxTable;
ATableViewInfoIndex: Integer; out ABottomBounds: Integer): TdxTableBreakType;
var
  AIndex: Integer;
...
function TdxTablesController.IsInfinityHeight(ATableViewInfoIndex: Integer;
out ABottomAnchorIndex: Integer): Boolean;
begin
  Result := FInfinityHeights.TryGetValue(ATableViewInfoIndex,
    ABottomAnchorIndex);
end;
...
function TdxBreakPairComparer.Compare(const X,
  Y: TPair<Integer, Integer>): Integer;
begin
  Result := X.Key - Y.Key;
end;

procedure TdxTablesController.AddTableBreak(ATable: TdxTable;
ATableViewInfoIndex, ABottomBounds: Integer);
var
  ABreaks: TdxSortedList<TPair<Integer, Integer>>;
  AKeyIndex: Integer;
begin
  if not FTableBreaks.TryGetValue(ATable, ABreaks) then
  begin
    ABreaks := TdxSortedList < TPair < Integer,
      Integer >>.Create(TdxBreakPairComparer.Create);
  ...
  ABreaks.Add(TPair<Integer, Integer>.Create(ATableViewInfoIndex,
    ABottomBounds));
end;

procedure TdxTablesController.AddInfinityTableBreak(ATableViewInfoIndex,
...
begin
  ...
  States.Push(TdxTablesControllerTableState.Create(Self, ANewCell,
    RowsController.CurrentColumn.Rows.Count = 0, SimpleView));
end;

function TdxTablesController.CanFitRowToColumn(ALastTextRowBottom
  : TdxLayoutUnit; AColumn: TdxColumn): TdxCanFitCurrentRowToColumnResult;
begin
  Result := State.CanFitRowToColumn(ALastTextRowBottom, AColumn);
end;

function TdxTablesController.CanFitFloatingObjectInTableRow(ABottom: Integer;
AColumn: TdxColumn): TdxCanFitCurrentRowToColumnResult;
begin
...
begin
  ...
  FStates.Push(TdxTablesControllerTableState.Create(Self, ACell,
    TdxTablesControllerTableState(State).CurrentCellViewInfoEmpty, SimpleView));
end;
...
function TdxTablesController.
  RollbackToStartOfRowTableOnFirstCellRowColumnOverfull: TdxParagraphIndex;
var
  I, ACount: Integer;
...
begin
  ...
  if ACount > 1 then
    AFirstTableRowViewInfoInColumn := TdxTablesControllerTableState(State)
      .IsFirstTableRowViewInfoInColumn;
  for I := ACount - 1 downto 0 do
  begin
    AParagraphIndex := States.Items[I]
      .RollbackToStartOfRowTableOnFirstCellRowColumnOverfull
...
function TdxTablesController.CreateTableViewInfoManager
  (AParentTableViewInfoManager: TdxTableViewInfoManager;
APageController: TdxPageController; ARowsController: TdxRowsController)
  : TdxTableViewInfoManager;
begin
  Result := TdxTableViewInfoManager.Create(AParentTableViewInfoManager,
    APageController, ARowsController);
end;
...
function TdxTablesControllerStateBaseStack.GetItem(Index: Integer)
  : TdxTablesControllerStateBase;
begin
  Result := List[Index]
end;
...
function TdxTablesControllerStateBaseStack.Push
  (AItem: TdxTablesControllerStateBase): TdxTablesControllerStateBase;
begin
...
constructor TdxTablesControllerStateBase.Create(ATablesController
  : TdxTablesController);
begin
  inherited Create;
...
function TdxTablesControllerNoTableState.CanFitRowToColumn(ALastTextRowBottom
  : Integer; AColumn: TdxColumn): TdxCanFitCurrentRowToColumnResult;
var
...
procedure TdxTablesControllerNoTableState.EnsureCurrentCell
  (ACell: TdxTableCell);
begin
  if ACell <> nil then
  begin
    TablesController.RowsController.ColumnController.PageAreaController.
      PageController.BeginTableFormatting;
    TablesController.StartNewTable(ACell);
  end;
end;
...
function TdxTablesControllerNoTableState.
  RollbackToStartOfRowTableOnFirstCellRowColumnOverfull
  (AFirstTableRowViewInfoInColumn, AInnerMostTable: Boolean): TdxParagraphIndex;
begin
  Result := 0;
...
function TdxTablesControllerNoTableState.CanFitFloatingObjectInTableRow
  (ABottom: Integer; AColumn: TdxColumn): TdxCanFitCurrentRowToColumnResult;
begin
  Result := TdxCanFitCurrentRowToColumnResult.RowFitted;
end;

procedure TdxTablesControllerNoTableState.UpdateCurrentCellBottom
  (ABottom: TdxLayoutUnit);
begin
end;
...
constructor TdxLayoutGridRectangle.Create(const ABounds: TRect;
ARowIndex, AColumnIndex, AColumnSpan: Integer);
begin
...
constructor TTableViewInfoAndStartRowSeparatorIndexComparer.Create
  (ARowSeparatorIndex: Integer);
begin
  FRowSeparatorIndex := ARowSeparatorIndex;
end;

function TTableViewInfoAndStartRowSeparatorIndexComparer.CompareTo
  (const Value: TdxTableViewInfo): Integer;
var
  ADiff: Integer;
begin
...
constructor TTableViewInfoAndEndRowSeparatorIndexComparer.Create
  (ARowSeparatorIndex: Integer);
begin
  FRowSeparatorIndex := ARowSeparatorIndex;
end;

function TTableViewInfoAndEndRowSeparatorIndexComparer.CompareTo
  (const Value: TdxTableViewInfo): Integer;
var
...
begin
  ...
  if ABottomSeparatorIndex = FRowSeparatorIndex then
  begin
    if (Value.NextTableViewInfo <> nil) and
      (Value.NextTableViewInfo.TopRowIndex = Value.BottomRowIndex) then
      Result := -1
    else
      Result := 0;
  end
...
function TdxTableCellLeftComparable.CompareTo(const ACell
  : TdxTableCellViewInfo): Integer;
begin
...
constructor TdxTableViewInfoManager.Create(AParentTableViewInfoManager
  : TdxTableViewInfoManager; APageController: TdxPageController;
ARowsController: TdxRowsController);
begin
  inherited Create;
...
procedure TdxTableViewInfoManager.BeforeStartNextCell(ACell: TdxTableCell;
const AGridBounds: TdxLayoutGridRectangle);
var
  AStartTableViewInfoIndex: Integer;
begin
  AStartTableViewInfoIndex := GetStartTableViewInfoIndexByRowSeparatorIndex
    (AGridBounds.RowIndex);
  ...
  begin
    ...
    begin
      ...
      FParentTableViewInfoManager.SetCurrentTableCellViewInfo
        (CurrentTableViewInfo.ParentTableCellViewInfo);
    end;
    SetCurrentParentColumn(CurrentTableViewInfo);
  end;
end;

function TdxTableViewInfoManager.StartNewTable(ATable: TdxTable;
ACellBounds: TDictionary<TdxTableCell, TdxLayoutGridRectangle>;
ALeftOffset, ARightCellMargin: TdxLayoutUnit;
AFirstContentInParentCell: Boolean; const ATableTextArea: TdxTextArea;
out AMaxRight: TdxLayoutUnit): TdxTableViewInfo;
...
begin
  ...
  if (ATable.NestedLevel = 0) and not RowsController.MatchHorizontalTableIndentsToTextEdge
  then
  begin
  ...
  AMaxRight := APercentBaseWidth;
  AWidthsCalculator := TdxTableWidthsCalculator.Create
    (TdxPieceTable(ATable.PieceTable), RowsController.ColumnController.Measurer,
    AMaxTableWidth);
  try
    ACalculator := RowsController.CreateTableGridCalculator
      (TdxDocumentModel(ATable.DocumentModel), AWidthsCalculator,
      AMaxTableWidth);
    try
  ...
  ATableViewInfo := CreateTableViewInfo(ATable, 0,
    AFirstContentInParentCell, nil);
...
procedure TdxTableViewInfoManager.SetRowSeparator(ARowSeparatorIndex: Integer;
AAnchor: TdxTableCellVerticalAnchor);
var
  ATableViewInfo: TdxTableViewInfo;
begin
  ATableViewInfo := GetStartTableViewInfoByRowSeparatorIndex
    (ARowSeparatorIndex);
  SetRowSeparatorCore(ATableViewInfo, ARowSeparatorIndex, AAnchor);
end;

procedure TdxTableViewInfoManager.SetRowSeparatorForCurrentTableViewInfo
  (ARowSeparatorIndex: Integer; AAnchor: TdxTableCellVerticalAnchor);
var
  AActualRowSeparatorIndex: Integer;
begin
  AActualRowSeparatorIndex := Min(CurrentTableViewInfo.TopRowIndex +
    CurrentTableViewInfo.Anchors.Count, ARowSeparatorIndex);
  if AActualRowSeparatorIndex - CurrentTableViewInfo.TopRowIndex >
    CurrentTableViewInfo.Rows.Count then
  begin
    AAnchor.Free;
    Exit;
  end;
...
procedure TdxTableViewInfoManager.EnsureTableRowViewInfo(ATableViewInfo
  : TdxTableViewInfo; ARow: TdxTableRow; ARowIndex: Integer);
begin
  ...
  ATableViewInfo.Rows.Add(CreateTableRowViewInfo(ATableViewInfo, ARow,
    ARowIndex));
end;
...
begin
  ...
  begin
    ...
    begin
      FParentTableViewInfoManager.SetCurrentTableCellViewInfo
        (ALastTableViewInfo.ParentTableCellViewInfo);
      FParentTableViewInfoManager.SetCurrentParentColumn
        (ALastTableViewInfo.ParentTableCellViewInfo.TableViewInfo);
      FParentTableViewInfoManager.ValidateTopLevelColumn;
    end;
  end;
end;

procedure TdxTableViewInfoManager.RemoveAllInvalidRowsOnColumnOverfull
  (AFirstInvalidRowIndex: Integer);
var
...
begin
  ALastValidTableViewInfoIndex := GetStartTableViewInfoIndexByRowSeparatorIndex
    (AFirstInvalidRowIndex);
  ALastValidTableViewInfo := FTableViewInfos[ALastValidTableViewInfoIndex];
  AFirstInvalidRowViewInfoIndex := AFirstInvalidRowIndex -
    ALastValidTableViewInfo.TopRowIndex;
  ...
  begin
    ...
    ATableViewInfo.Column.TopLevelColumn.RemoveTableViewInfoWithContent
      (ATableViewInfo);
...
function TdxTableViewInfoManager.GetParentTableViewInfoManager
  : TdxTableViewInfoManager;
begin
  Result := FParentTableViewInfoManager;
end;

function TdxTableViewInfoManager.GetRowStartAnchor(ARowIndex: Integer)
  : TdxTableCellVerticalAnchor;
var
  ATableViewInfo: TdxTableViewInfo;
begin
...
function TdxTableViewInfoManager.GetRowStartColumn(ARowIndex: Integer)
  : TdxColumn;
var
  ATableViewInfo: TdxTableViewInfo;
begin
...
function TdxTableViewInfoManager.GetRowStartTableViewInfo
  (ATableRow: TdxTableRow): TdxTableViewInfo;
var
  ARowIndex: Integer;
begin
...
procedure TdxTableViewInfoManager.StartNextCell(ACell: TdxTableCell;
const ABounds: TRect; const AGridBounds: TdxLayoutGridRectangle;
const ATextBounds: TRect);
var
  AStartTableViewInfoIndex, ALastTableViewInfoIndex,
    ATableViewInfoIndex: Integer;
begin
  AStartTableViewInfoIndex := GetStartTableViewInfoIndexByRowSeparatorIndex
    (AGridBounds.RowIndex);
  ALastTableViewInfoIndex := GetEndTableViewInfoIndexByRowSeparatorIndex
    (AGridBounds.RowIndex + AGridBounds.RowSpan);
  CurrentTableCellViewInfo := AddFirstCellViewInfo
    (FTableViewInfos[AStartTableViewInfoIndex], ACell, ABounds, AGridBounds,
    ATextBounds);
  for ATableViewInfoIndex := AStartTableViewInfoIndex +
    1 to ALastTableViewInfoIndex - 1 do
    AddMiddleCellViewInfo(FTableViewInfos[ATableViewInfoIndex], ACell, ABounds,
      AGridBounds, ATextBounds);
  if ALastTableViewInfoIndex > AStartTableViewInfoIndex then
    AddLastCellViewInfo(FTableViewInfos[ALastTableViewInfoIndex], ACell,
      ABounds, AGridBounds, ATextBounds);
...
function TdxTableViewInfoManager.GetBottomCellAnchor(ACurrentCell: TdxTableCell)
  : TdxTableCellVerticalAnchor;
var
  ABottomAnchorIndex: Integer;
begin
...
function TdxTableViewInfoManager.GetBottomCellRowSeparatorIndex
  (ACurrentCell: TdxTableCell; ARowSpan: Integer): Integer;
begin
  Result := ACurrentCell.Table.Rows.IndexOf(ACurrentCell.Row) + ARowSpan;
end;

procedure TdxTableViewInfoManager.BeforeMoveRowToNextColumn(ACurrentCellBottom
  : TdxLayoutUnit);
begin
end;
...
var
  ...
  ACount, ABottomAnchorIndex, ACurrentCellViewInfoIndex, ARowViewInfoIndex,
    ANewTableViewInfoIndex, ASplitAnchorIndex: Integer;
...
begin
  ...
  begin
    ...
    FCurrentTableViewInfoIndex := FTableViewInfos.IndexOf
      (AColumnController.ViewInfo);
    ASuitableTableCellViewInfo := FindSuitableTableCellViewInfo
      (CurrentTableViewInfo.Cells, CurrentTableCellViewInfo.Cell);
    if FParentTableViewInfoManager = nil then
      EnsureFloatingObjectsLayoutValid
        (FTableViewInfos[FCurrentTableViewInfoIndex]);
    ...
    begin
      ...
      APrevTableViewInfo.Anchors[ACount - 1].VerticalPosition :=
        (Max(APrevTableViewInfo.BottomAnchor.VerticalPosition,
        ACurrentCellBottom));
    end
    else
    begin
      ...
      MoveRowAndAnchors_(APrevTableViewInfo, CurrentTableViewInfo,
        ABottomAnchorIndex);
      ACells := APrevTableViewInfo.Rows.Last.Cells;
      AComparable := TdxTableCellLeftComparable.Create
        (CurrentTableCellViewInfo.Left);
      TdxAlgorithms1<TdxTableCellViewInfo>.BinarySearch(ACells,
        AComparable.CompareTo, ACurrentCellViewInfoIndex);
      Assert(ACurrentCellViewInfoIndex >= 0);

      CurrentTableCellViewInfo := CurrentTableViewInfo.Rows.First.Cells
        [ACurrentCellViewInfoIndex];
    end;
  end
  else
  begin
    ARowViewInfoIndex := CurrentTableCellViewInfo.BottomAnchorIndex - 1;
    ACells := CurrentTableViewInfo.Rows
      [CurrentTableCellViewInfo.BottomAnchorIndex - 1].Cells;
    AComparable := TdxTableCellLeftComparable.Create
      (CurrentTableCellViewInfo.Left);
    TdxAlgorithms1<TdxTableCellViewInfo>.BinarySearch(ACells,
      AComparable.CompareTo, ACurrentCellViewInfoIndex);
    ...
    AVerticalBorderPositions := TdxVerticalBorderPositions.Create
      (TdxLayoutUnitSortedList(CurrentTableViewInfo.VerticalBorderPositions.
      InitialPositions.Clone),
      TdxLayoutUnitSortedList(CurrentTableViewInfo.VerticalBorderPositions.
      AlignedPosition.Clone));
    ...
    ANewTableViewInfo := TdxTableViewInfo.Create(FTable, ACurrentTopLevelColumn,
      AParentColumn, AVerticalBorderPositions, CurrentTableViewInfo.TopRowIndex
      + CurrentTableCellViewInfo.BottomAnchorIndex - 1,
      AParentTableCellViewInfo, True);
    if FParentTableViewInfoManager = nil then
      ANewTableViewInfo.AssociatedFloatingObjectsLayout :=
        FPageController.FloatingObjectsLayout;
    ...
    ANewTableViewInfo.ModelRelativeIndent :=
      CurrentTableViewInfo.ModelRelativeIndent;
    ...
    MoveRowAndAnchor(CurrentTableViewInfo, ANewTableViewInfo,
      ARowViewInfoIndex + 1);
    ...
    CurrentTableViewInfo.Anchors[ASplitAnchorIndex] :=
      TdxTableCellVerticalAnchor.Create(ACurrentCellBottom, 0, ABorders);
    if ASplitAnchor <> nil then
      ABottomTextIndent := ASplitAnchor.BottomTextIndent
    else
      ABottomTextIndent := 0;
    ANewTableViewInfo.Anchors[0] := TdxTableCellVerticalAnchor.Create
      (ANewTableViewInfo.Column.Bounds.Top, ABottomTextIndent, ABorders.Clone);
    SplitCellsByAnchor(CurrentTableViewInfo, ANewTableViewInfo,
      ASplitAnchorIndex);
    Assert(CurrentTableCellViewInfo.BottomAnchorIndex -
      ASplitAnchorIndex + 1 = 1);

    Assert(ANewTableViewInfo.Rows.First.Cells[ACurrentCellViewInfoIndex]
      .Cell = CurrentTableCellViewInfo.Cell);
    CurrentTableCellViewInfo := ANewTableViewInfo.Rows.First.Cells
      [ACurrentCellViewInfoIndex];
    FCurrentTableViewInfoIndex := ANewTableViewInfoIndex;
  end;
  ACurrentRow := RowsController.CurrentRow;
  ARowBounds := ACurrentRow.Bounds;
  ARowBounds.MoveToTop(CurrentTableViewInfo.TopAnchor.VerticalPosition +
    CurrentTableViewInfo.TopAnchor.BottomTextIndent +
    ACurrentRow.SpacingBefore);
  RowsController.CurrentRow.Bounds := ARowBounds;
  RowsController.HorizontalPositionController.SetCurrentHorizontalPosition
    (ARowBounds.Left);
...
begin
  Result := CurrentTableViewInfo.Anchors
    [CurrentTableCellViewInfo.TopAnchorIndex].VerticalPosition;
end;
...
procedure TdxTableViewInfoManager.SetColumnController
  (Value: TdxTableCellColumnController);
begin
...
procedure TdxTableViewInfoManager.InternalSetCurrentTableCellViewInfo
  (Value: TdxTableCellViewInfo);
begin
  FCurrentTableCellViewInfo := Value;
  ColumnController.SetCurrentTableCellViewInfo(Value);
end;

function TdxTableViewInfoManager.CreateTableViewInfo(ATable: TdxTable;
ATopRowIndex: Integer; AFirstContentInParentCell: Boolean;
AVerticalBorderPositions: TdxVerticalBorderPositions): TdxTableViewInfo;
var
  ACurrentController: TdxTableCellColumnController;
  ACurrentTopLevelColumn: TdxColumn;
begin
  ACurrentController := Safe<TdxTableCellColumnController>.Cast
    (RowsController.ColumnController);
  ...
  Result := TdxTableViewInfo.Create(ATable, ACurrentTopLevelColumn,
    RowsController.CurrentColumn, AVerticalBorderPositions, ATopRowIndex,
    GetParentTableCellViewInfo, AFirstContentInParentCell);
  if FParentTableViewInfoManager = nil then
    Result.AssociatedFloatingObjectsLayout :=
      FPageController.FloatingObjectsLayout;
...
function TdxTableViewInfoManager.AddTableViewInfo(ATableViewInfo
  : TdxTableViewInfo): Integer;
var
  ALastTableViewInfo: TdxTableViewInfo;
begin
...
function TdxTableViewInfoManager.GetStartTableViewInfoByRowSeparatorIndex
  (ARowSeparatorIndex: Integer): TdxTableViewInfo;
var
  ATableViewInfoIndex: Integer;
begin
  ATableViewInfoIndex := GetStartTableViewInfoIndexByRowSeparatorIndex
    (ARowSeparatorIndex);
  Result := FTableViewInfos[ATableViewInfoIndex];
end;

function TdxTableViewInfoManager.GetStartTableViewInfoIndexByRowSeparatorIndex
  (ARowSeparatorIndex: Integer): Integer;
var
  ATableViewInfoIndex: Integer;
  AComparer: TTableViewInfoAndStartRowSeparatorIndexComparer;
begin
  AComparer := TTableViewInfoAndStartRowSeparatorIndexComparer.Create
    (ARowSeparatorIndex);
  if not TdxAlgorithms1<TdxTableViewInfo>.BinarySearch(FTableViewInfos,
    AComparer.CompareTo, ATableViewInfoIndex) then
    Dec(ATableViewInfoIndex);

  Result := ATableViewInfoIndex;
end;

function TdxTableViewInfoManager.GetEndTableViewInfoIndexByRowSeparatorIndex
  (ARowSeparatorIndex: Integer): Integer;
var
  ATableViewInfoIndex: Integer;
...
begin
  ...
  AComparer := TTableViewInfoAndEndRowSeparatorIndexComparer.Create
    (ARowSeparatorIndex);
  if not TdxAlgorithms1<TdxTableViewInfo>.BinarySearch(FTableViewInfos,
    AComparer.CompareTo, ATableViewInfoIndex) then
  begin
...
procedure TdxTableViewInfoManager.SetRowSeparatorCore(ATableViewInfo
  : TdxTableViewInfo; ARowSeparatorIndex: Integer;
AAnchor: TdxTableCellVerticalAnchor);
var
...
function TdxTableViewInfoManager.CreateTableRowViewInfo(ATableViewInfo
  : TdxTableViewInfo; ARow: TdxTableRow; ARowIndex: Integer)
...
begin
  ...
  if ACellSpacing <> 0 then
    Result := TdxTableRowViewInfoWithCellSpacing.Create(ATableViewInfo,
      ARowIndex, ACellSpacing)
  else
    Result := TdxTableRowViewInfoNoCellSpacing.Create(ATableViewInfo,
      ARowIndex);
end;

function TdxTableViewInfoManager.GetRowStartAnchorIndex(ATableViewInfo
  : TdxTableViewInfo; ARowIndex: Integer): Integer;
begin
  Result := ARowIndex - ATableViewInfo.TopRowIndex;
end;

function TdxTableViewInfoManager.GetRowStartAnchor(ATableViewInfo
  : TdxTableViewInfo; ARowIndex: Integer): TdxTableCellVerticalAnchor;
var
  AAnchorIndex: Integer;
begin
...
function TdxTableViewInfoManager.AddFirstCellViewInfo(ATableViewInfo
  : TdxTableViewInfo; ACell: TdxTableCell; const ABounds: TRect;
const AGridBounds: TdxLayoutGridRectangle; const ATextBounds: TRect)
  : TdxTableCellViewInfo;
var
...
begin
  ATopAnchorIndex := GetRowStartAnchorIndex(ATableViewInfo,
    AGridBounds.RowIndex);
  ABottomAnchorIndex := ATopAnchorIndex + AGridBounds.RowSpan;
  if (ABottomAnchorIndex >= ATableViewInfo.Anchors.Count) and
    (ATableViewInfo.NextTableViewInfo <> nil) then
    ABottomAnchorIndex := ATableViewInfo.Anchors.Count - 1;
  ATextOffset := ABounds.Left - AGridBounds.Bounds.Left;
  ACellViewInfo := TdxTableCellViewInfo.Create(ATableViewInfo, ACell,
    ABounds.Left, ABounds.Width, ATextBounds.Left + ATextOffset,
    ATextBounds.Width, ATextOffset, ATopAnchorIndex, ABottomAnchorIndex,
    AGridBounds.RowIndex, AGridBounds.RowSpan);
  ATableViewInfo.Cells.Add(ACellViewInfo);
  AddTableCellViewInfo(ATableViewInfo, ACellViewInfo, ATopAnchorIndex,
    ABottomAnchorIndex - 1);
  Result := ACellViewInfo;
end;

procedure TdxTableViewInfoManager.AddMiddleCellViewInfo(ATableViewInfo
  : TdxTableViewInfo; ACell: TdxTableCell; const ABounds: TRect;
const AGridBounds: TdxLayoutGridRectangle; const ATextBounds: TRect);
var
  ATopAnchorIndex, ABottomAnchorIndex: Integer;
...
procedure TdxTableViewInfoManager.AddLastCellViewInfo(ATableViewInfo
  : TdxTableViewInfo; ACell: TdxTableCell; const ABounds: TRect;
const AGridBounds: TdxLayoutGridRectangle; const ATextBounds: TRect);
var
  ATopAnchorIndex, ABottomAnchorIndex: Integer;
...
begin
  ATopAnchorIndex := 0;
  ABottomAnchorIndex := GetRowStartAnchorIndex(ATableViewInfo,
    AGridBounds.RowIndex + AGridBounds.RowSpan);
  ATextOffset := ABounds.Left - AGridBounds.Bounds.Left;
  ACellViewInfo := TdxTableCellViewInfo.Create(ATableViewInfo, ACell,
    ABounds.Left, ABounds.Width, ATextBounds.Left + ATextOffset,
...
procedure TdxTableViewInfoManager.AddTableCellViewInfo(ATableViewInfo
  : TdxTableViewInfo; ACellViewInfo: TdxTableCellViewInfo;
AStartRowViewInfoIndex, AEndRowViewInfoIndex: Integer);
var
  AComparable: TdxTableCellLeftComparable;
...
begin
  ...
  begin
    ...
    EnsureTableRowViewInfo(ATableViewInfo, ATableViewInfo.Table.Rows[ARowIndex],
      ARowIndex);
    AComparable := TdxTableCellLeftComparable.Create(ACellViewInfo.Left);
    if TdxAlgorithms1<TdxTableCellViewInfo>.BinarySearch
      (ATableViewInfo.Rows[ARowViewInfoIndex].Cells, AComparable.CompareTo,
      ACellIndex) then
      Assert(False);
    ATableViewInfo.Rows[ARowViewInfoIndex].Cells.Insert(ACellIndex,
      ACellViewInfo);
  end;
end;

procedure TdxTableViewInfoManager.MoveRowAndAnchors_(ASource,
  ATarget: TdxTableViewInfo; AStartAnchorIndex: Integer);
var
  I, AInitialTargetTopRowIndex, AInitialSourceBottomRowIndex, ASourceRowCount,
    AMovedRowCount, ARowViewInfoIndex, ARowIndex, ASourceAnchorsCount,
    ALastMovedAnchorIndex, AMovedAnchorCount, AAnchorIndex, ASourceCellCount,
    ATargetCellCount: Integer;
  ARow: TdxTableRow;
...
begin
  ...
  ATarget.Rows[0] := CreateTableRowViewInfo(ATarget,
    ASource.Rows[AStartAnchorIndex - 1].Row, ASource.TopRowIndex +
    AStartAnchorIndex - 1);
  ASource.Rows.RemoveRows(AStartAnchorIndex,
    ASourceRowCount - AStartAnchorIndex);
  ...
  AKeepFirstAnchorInTarget := AInitialSourceBottomRowIndex =
    AInitialTargetTopRowIndex;
  ...
  begin
    ...
    begin
      ...
      ATarget.Anchors[AAnchorIndex - AStartAnchorIndex + 1] :=
        ASourceAnchor.CloneWithNewVerticalPosition(0);;
    end;
  end;
  ...
  begin
    ...
    AAction := ShouldSplitCell(ASource, ATarget, ACellViewInfo,
      AStartAnchorIndex, ASourceAnchorsCount, AInitialSourceBottomRowIndex,
      AInitialTargetTopRowIndex);
    case AAction of
      TCellAction.Split:
...
function TdxTableViewInfoManager.ShouldSplitCell(ASource,
  ATarget: TdxTableViewInfo; ACellViewInfo: TdxTableCellViewInfo;
ASplitAnchorIndex, ASourceAnchorsCount, AInitialSourceBottomRowIndex,
  AInitialTargetTopRowIndex: Integer): TCellAction;
var
  ABottomAnchorIndex: Integer;
...
procedure TdxTableViewInfoManager.MoveRowAndAnchor(ASource,
  ATarget: TdxTableViewInfo; AStartAnchorIndex: Integer);
var
...
begin
  ...
  ASource.Anchors.RemoveAnchors(AStartAnchorIndex,
    AAnchorCount - AStartAnchorIndex);
end;

procedure TdxTableViewInfoManager.SplitCellsByAnchor(ACurrentTableViewInfo,
  ANextTableViewInfo: TdxTableViewInfo; AAnchorIndex: Integer);
var
...
begin
  ...
  for I := 0 to ACellCount - 1 do
    SplitCellByAnchor(ACurrentTableViewInfo, ANextTableViewInfo, AAnchorIndex,
      ARowViewInfo.Cells[I]);
end;

procedure TdxTableViewInfoManager.SplitCellByAnchor(ACurrentTableViewInfo,
  ANextTableViewInfo: TdxTableViewInfo; AAnchorIndex: Integer;
ATableCellViewInfo: TdxTableCellViewInfo);
var
  ACell: TdxTableCell;
...
begin
  ANewBottomAnchorIndex := ATableCellViewInfo.BottomAnchorIndex -
    AAnchorIndex + 1;
  ARelativeLeft := ATableCellViewInfo.Left -
    ACurrentTableViewInfo.Column.Bounds.Left;
  ACell := ATableCellViewInfo.Cell;
  ANextCellViewInfo := TdxTableCellViewInfo.Create(ANextTableViewInfo, ACell,
    ARelativeLeft + ANextTableViewInfo.Column.Bounds.Left,
    ATableCellViewInfo.Width, ATableCellViewInfo.TextLeft,
    ATableCellViewInfo.TextWidth, ATableCellViewInfo.TextOffset, 0,
    ANewBottomAnchorIndex, ATableCellViewInfo.StartRowIndex,
  ...
  AddTableCellViewInfo(ANextTableViewInfo, ANextCellViewInfo, 0,
    ANewBottomAnchorIndex - 1);
end;

function TdxTableViewInfoManager.ShouldRemoveColumn(ATableViewInfoIndex
  : Integer; ATableViewInfo: TdxTableViewInfo): Boolean;
begin
...
function TdxTableViewInfoManager.GetTopLevelTableViewInfoManager
  : TdxTableViewInfoManager;
begin
  if FParentTableViewInfoManager <> nil then
...
function TdxTableViewInfoManager.GetParentTableCellViewInfo
  : TdxTableCellViewInfo;
begin
  if FParentTableViewInfoManager = nil then
    Result := nil
...
procedure TdxTableViewInfoManager.SetCurrentTableCellViewInfo(ATableCellViewInfo
  : TdxTableCellViewInfo);
begin
  Assert(ATableCellViewInfo <> nil);
  FCurrentTableCellViewInfo := ATableCellViewInfo;
  FCurrentTableViewInfoIndex := FTableViewInfos.IndexOf
    (FCurrentTableCellViewInfo.TableViewInfo);
  if FParentTableViewInfoManager <> nil then
    FParentTableViewInfoManager.SetCurrentTableCellViewInfo
      (ATableCellViewInfo.TableViewInfo.ParentTableCellViewInfo)
  else
...
procedure TdxTableViewInfoManager.SetCurrentParentColumn(ATableViewInfo
  : TdxTableViewInfo);
begin
  ColumnController.SetCurrentParentColumn(ATableViewInfo.Column);
  if FParentTableViewInfoManager <> nil then
    FParentTableViewInfoManager.SetCurrentParentColumn
      (ATableViewInfo.ParentTableCellViewInfo.TableViewInfo)
  else
    EnsureFloatingObjectsLayoutValid(ATableViewInfo);
end;

procedure TdxTableViewInfoManager.EnsureFloatingObjectsLayoutValid
  (ATableViewInfo: TdxTableViewInfo);
begin
  Assert(FParentTableViewInfoManager = nil);
  if ATableViewInfo.AssociatedFloatingObjectsLayout <> nil then
    FPageController.SetFloatingObjectsLayout
      (ATableViewInfo.AssociatedFloatingObjectsLayout);
end;

function TdxTableViewInfoManager.FindSuitableTableCellViewInfo
  (ACells: TdxTableCellViewInfoCollection; ACell: TdxTableCell)
  : TdxTableCellViewInfo;
var
  I: Integer;
...
function TdxTableViewInfoManager.GetSplitAnchorHorizontalCellBorders
  (ASplitAnchor: TdxTableCellVerticalAnchor): TdxHorizontalCellBordersInfoList;
begin
  if ASplitAnchor <> nil then
...
constructor TdxStateParagraphFrame.Create(AFormatter: TdxParagraphBoxFormatter;
APreviousState: TdxBoxFormatterStateBase);
begin
  inherited Create(AFormatter);
  Assert(APreviousState <> nil);
...
function TdxStateParagraphFrame.CanAddBox(ABoxInfo: TdxBoxInfo)
  : TdxAddBoxResult;
begin
  Result := CanAddBoxCore(ABoxInfo);
end;
...
function TdxStateParagraphFrame.FormatParagraphFrame
  : TdxStateContinueFormatResult;
var
  ABoxInfo: TdxBoxInfo;
      ...
      begin
        ...
        begin
          if Iterator.IsParagraphFrame and (Self is TdxStateParagraphFrame) then
            Exit(TdxStateContinueFormatResult.Success);
          if (Formatter.SyllableIterator = nil) or
            (Formatter.SyllableIterator.IsEnd) then
            Exit(GetContinueFormatResult(FinishParagraphOrSection));
        end;
        Exit(TdxStateContinueFormatResult.Success);
      end;
      Result := ContinueFormatByCharacter(ABoxInfo,
        Safe<TdxLayoutDependentTextBox>.Cast(Iterator.CurrentBox));
    finally
...
function TdxStateParagraphFrame.HorizontalOverfull(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Result := TdxCompleteFormattingResult.Success;
end;

function TdxStateParagraphFrame.ColumnOverfull
  (ACanFit: TdxCanFitCurrentRowToColumnResult; ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Result := TdxCompleteFormattingResult.Success;
...
function TdxStateParagraphFrame.FinishParagraphOrSection
  : TdxCompleteFormattingResult;
begin
  Result := FPreviousState.FinishParagraphOrSection;
end;

function TdxStateParagraphFrame.CanAddBoxCore(ABoxInfo: TdxBoxInfo)
  : TdxAddBoxResult;
var
  ACanFit: TdxCanFitCurrentRowToColumnResult;
...
begin
  ...
  begin
    ...
    try
      ...
      begin
        if ACanFit = TdxCanFitCurrentRowToColumnResult.RestartDueFloatingObject
        then
          Exit(TdxAddBoxResult.RestartDueFloatingObject);
        if not AActualParagraphFrameProperties.IsParagraphFrame and
          not RowsController.CanFitBoxToCurrentRow(ABoxInfo.Size) then
          Exit(TdxAddBoxResult.HorizontalIntersect);
...
function TdxCharacterFormatterLayoutDependentTextState.GetType
  : TdxCharacterFormatterState;
begin
  Result := TdxCharacterFormatterState.LayoutDependentText;
end;

function TdxCharacterFormatterLayoutDependentTextState.IsTerminatorChar
  (ACh: Char): Boolean;
begin
  Result := TdxCharacters.IsCharSpace(ACh) or (ACh = TdxCharacters.TabMark) or
    (ACh = TdxCharacters.LineBreak) or (ACh = TdxCharacters.PageBreak) or
...
function TdxCharacterFormatterLayoutDependentTextState.AppendBox
  (var ABoxInfo: TdxBoxInfo): TdxStateContinueFormatResult;
begin
...
procedure TdxCharacterFormatterLayoutDependentTextState.MeasureBoxContent
  (ABoxInfo: TdxBoxInfo);
begin
  Measurer.MeasureText(ABoxInfo);
end;
...
function TdxCharacterFormatterTabState.AppendBox(var ABoxInfo: TdxBoxInfo)
  : TdxStateContinueFormatResult;
begin
...
function TdxStateRowEmptyHyphenation.CalcFinalState(ACurrentChar: Char)
  : TdxParagraphBoxFormatterState;
begin
...
function TdxStateRowEmptyHyphenation.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.
    RowEmptyHyphenationAfterFloatingObject;
...
function TdxStateRowEmptyHyphenation.CanAddBox(ABoxInfo: TdxBoxInfo)
  : TdxAddBoxResult;
begin
  Result := CanAddBoxWithHyphenCore(ABoxInfo);
end;

function TdxStateRowEmptyHyphenation.CanAddBoxWithoutHyphen
  (ABoxInfo: TdxBoxInfo): TdxAddBoxResult;
begin
  Result := CanAddBoxCore(ABoxInfo);
end;

function TdxStateRowEmptyHyphenation.ColumnOverfull
  (ACanFit: TdxCanFitCurrentRowToColumnResult; ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Result := Formatter.RollbackToStartOfRowCore(ACanFit,
    TdxParagraphBoxFormatterState.RowEmptyHyphenation);
end;

function TdxStateRowEmptyHyphenation.FinishParagraph
  : TdxCompleteFormattingResult;
var
  ACurrentChar: Char;
begin
...
function TdxStateRowEmptyHyphenation.GetNextState
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowTextHyphenation;
end;
...
function TdxStateRowEmptyHyphenation.HorizontalOverfull(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
var
  ASplitBoxResult: TdxSplitBoxResult;
begin
  ...
  if Iterator.CurrentChar = TdxCharacters.ColumnBreak then
    Exit;
  if (Iterator.CurrentChar <> TdxCharacters.LineBreak) or
    (ASplitBoxResult = TdxSplitBoxResult.SuccessSuppressedHorizontalOverfull)
  then
  begin
    EndRow;
...
function TdxStateRowEmptyHyphenationAfterFloatingObject.GetType
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.
    RowEmptyHyphenationAfterFloatingObject;
...
function TdxStateRowEmptyAfterFloatingObject.GetType
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowEmptyAfterFloatingObject;
end;
...
function TdxStateRowTextHyphenation.GetStateAfterFloatingObject
  : TdxParagraphBoxFormatterState;
begin
  Result := TdxParagraphBoxFormatterState.RowTextHyphenationAfterFloatingObject;
end;

function TdxStateRowTextHyphenation.HorizontalOverfull(ABoxInfo: TdxBoxInfo)
  : TdxCompleteFormattingResult;
begin
  Formatter.RollbackToStartOfWord;
  InsertHyphenBox;
...
function TdxStateRowTextHyphenation.CanAddBox(ABoxInfo: TdxBoxInfo)
  : TdxAddBoxResult;
begin
  Result := CanAddBoxWithHyphenCore(ABoxInfo);
end;

function TdxStateRowTextHyphenation.CanAddBoxWithoutHyphen(ABoxInfo: TdxBoxInfo)
  : TdxAddBoxResult;
begin
  Result := CanAddBoxCore(ABoxInfo);
end;
...
function TdxStrikeoutCalculator.GetRunCharacterLineType(ARun: TdxTextRun;
ARunIndex: TdxRunIndex): TdxStrikeoutType;
begin
  Result := ARun.FontStrikeoutType;
end;

function TdxStrikeoutCalculator.GetRunCharacterLineUseForWordsOnly
  (ARun: TdxTextRun; ARunIndex: TdxRunIndex): Boolean;
begin
  Result := ARun.StrikeoutWordsOnly;
end;

procedure TdxStrikeoutCalculator.EndCharacterLine(AEndAnchorIndex: Integer;
AFontInfo: TdxFontInfo);
var
...
begin
  AStrikeoutBox := TdxUnderlineBox.Create(FStartAnchorIndex,
    AEndAnchorIndex - FStartAnchorIndex);
  ...
  AClipBounds := TRect.Create(Boxes[FStartAnchorIndex].Bounds.Left, ATop,
    ARight, ATop);
...
function TdxStrikeoutCalculator.CalculateStrikeoutBoxTop
  (AFontInfo: TdxFontInfo): Integer;
begin
  Result := Row.Bounds.Top + Row.BaseLineOffset - AFontInfo.StrikeoutPosition;
  Inc(Result, CalculateScriptOffset(AFontInfo,
    GetBoxScript(FStartAnchorIndex)));
end;

function TdxStrikeoutCalculator.GetNumberingListBoxCharacterLineType
  (ANumberingListBox: TdxNumberingListBox): TdxStrikeoutType;
var
  ANumerationCharacterProperties: TdxMergedCharacterProperties;
begin
  ANumerationCharacterProperties :=
...
function TdxStrikeoutCalculator.GetNumberingListBoxCharacterLineUseForWordsOnly
  (ANumberingListBox: TdxNumberingListBox): Boolean;
var
  ANumerationCharacterProperties: TdxMergedCharacterProperties;
begin
