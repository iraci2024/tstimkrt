...
type
  ...
  protected
    ...
    function UpdateCheckSum(AValue: Cardinal; const ABuffer; ACount: Integer)
      : Cardinal;
...
type
  ...
  public
    class function Update(ACheckSum: Cardinal; const ABuffer; ACount: Integer)
      : Cardinal;
  end;
...
begin
  ...
  FReadCheckSum := FCheckSumCalculator.UpdateCheckSum(FReadCheckSum,
    Buffer, ACount);
end;
...
begin
  ...
  FWriteCheckSum := FCheckSumCalculator.UpdateCheckSum(FWriteCheckSum,
    Buffer, Result);
end;
...
function TdxCrc32CheckSumCalculator.GetFinalCheckSum(AValue: Cardinal)
  : Cardinal;
begin
...
class function TdxCrc32CheckSum.Update(ACheckSum: Cardinal; const ABuffer;
  ACount: Integer): Cardinal;
var
  B: PByte;
begin
  Result := ACheckSum;
