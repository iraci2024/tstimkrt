...
uses
  Windows, cxGraphics, SysUtils, Classes, cxClasses, cxControls, dxNavBar,
...
type
  ...
  protected
    ...
    // Scrollbar
    function GetcxScrollBarHelperClass: TcxControlScrollBarHelperClass;
      override;
  ...
  TdxNavBarOffice12ExplorerBarPainter = class
  ...
  protected
    ...
    function IsGroupCaptionButtonCompositeDraw(AGroupViewInfo
      : TdxNavBarGroupViewInfo): Boolean; override;
    function GetDefaultColorSchemeName: TdxSkinName; override;
  public
    procedure Assign(Source: TPersistent); override;
...
const
  ColorSchemeCount = 3;
  ColorSchemeNames: array [0 .. ColorSchemeCount - 1] of TdxSkinName = ('Blue',
    'Black', 'Silver');
...
begin
  ANavBarPainter := (ScrollBar as TdxNavBarcxOffice12NavPaneScrollBarHelper)
    .GetNavBarPainter;
...
function TdxNavBarcxOffice12NavPaneScrollBarPainter.GetMinThumbnailSize
  : Integer;
var
  ANavBarPainter: TdxNavBarOffice12NavPanePainter;
begin
...
function TdxNavBarcxOffice12NavPaneScrollBarHelper.GetNavBarPainter
  : TdxNavBarOffice12NavPanePainter;
var
...
function TdxNavBarcxOffice12NavPaneScrollBarHelper.GetPainterClass
...
class function TdxNavBarOffice12NavPanePainter.GetSkinPainterHelperClass
...
begin
  ...
  if (AInfo <> nil) and (AInfo.Element <> nil) then
    AInfo.Element.Draw(ACanvas.Handle, R, ScaleFactor, AInfo.ImageIndex,
      ButtonState2SkinState[AState]);
end;

function TdxNavBarOffice12NavPanePainter.GetcxScrollBarHelperClass
...
begin
  ANavBarPainter := (ScrollBar as TdxNavBarcxOffice12ScrollBarHelper)
    .GetNavBarPainter;
  if ANavBarPainter <> nil then
    ANavBarPainter.DrawScrollBarPart(ACanvas, R, APart, AState)
  else
...
function TdxNavBarcxOffice12ScrollBarHelper.GetNavBarPainter
  : TdxNavBarOffice12ExplorerBarPainter;
var
  ANavBar: TdxCustomNavBar;
begin
...
function TdxNavBarcxOffice12ScrollBarHelper.GetPainterClass
  : TcxScrollBarPainterClass;
begin
...
begin
  if Source is TdxNavBarOffice12ExplorerBarPainter then
    ColorSchemeName := TdxNavBarOffice12ExplorerBarPainter(Source)
      .ColorSchemeName
  else
    inherited;
end;

procedure TdxNavBarOffice12ExplorerBarPainter.DrawItemSelection
  (ALinkViewInfo: TdxNavBarLinkViewInfo);
begin
end;

class function TdxNavBarOffice12ExplorerBarPainter.GetSkinPainterHelperClass
  : TdxNavBarSkinBasedPainterHelperClass;
begin
  Result := TdxNavBarOffice12PainterHelper;
end;

function TdxNavBarOffice12ExplorerBarPainter.GetcxScrollBarHelperClass
  : TcxControlScrollBarHelperClass;
begin
...
function TdxNavBarOffice12ExplorerBarPainter.GetDefaultColorSchemeName
  : TdxSkinName;
begin
  Result := DefaultColorSchemeName;
end;
...
RegisterView(dxNavBarOffice12NavigatorPaneView, 'Office12NavigationPaneView',
  TdxNavBarOffice12NavPanePainter);
RegisterView(dxNavBarOffice12ExplorerBarView, 'Office12ExplorerBarView',
  TdxNavBarOffice12ExplorerBarPainter);
