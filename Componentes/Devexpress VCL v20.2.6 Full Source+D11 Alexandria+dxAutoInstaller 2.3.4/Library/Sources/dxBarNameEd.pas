...
uses
  ...
  StdCtrls, ExtCtrls, dxCore, dxBar, dxForms,
  cxGraphics, cxControls, cxLookAndFeels, cxLookAndFeelPainters,
  dxLayoutContainer, dxLayoutControlAdapters, cxClasses,
  dxLayoutControl, Menus, cxButtons, dxLayoutcxEditAdapters, cxContainer,
  cxEdit, cxTextEdit, dxLayoutLookAndFeels;
...
begin
  ...
  try
    ...
    begin
      case Kind2 of
        0:
          AForm.Caption := cxGetResourceString(@dxSBAR_TOOLBARADD);
        1:
          AForm.Caption := cxGetResourceString(@dxSBAR_TOOLBARRENAME);
      end;
    ...
    begin
      case Kind2 of
        0:
          AForm.Caption := cxGetResourceString(@dxSBAR_CATEGORYADD);
        1:
          AForm.Caption := cxGetResourceString(@dxSBAR_CATEGORYINSERT);
        2:
          AForm.Caption := cxGetResourceString(@dxSBAR_CATEGORYRENAME);
      end;
...
begin
  ...
  begin
    ...
    if not CanClose then
      dxBarMessageBox(Format(cxGetResourceString(@dxSBAR_TOOLBAREXISTS),
        [EName.Text]), MB_ICONSTOP or MB_OK);
  end;
end;
