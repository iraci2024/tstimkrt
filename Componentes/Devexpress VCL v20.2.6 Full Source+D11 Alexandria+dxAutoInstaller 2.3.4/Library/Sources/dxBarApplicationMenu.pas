...
{$ENDIF}
  ...
  dxCore, cxClasses, cxGraphics, cxGeometry, cxControls, cxContainer,
...
type
  ...
  TdxBarExtraPaneNotifyEvent = procedure(Sender: TObject; AIndex: Integer)
    of object;
  TdxBarExtraPaneGetDisplayTextEvent = procedure(Sender: TObject;
    AIndex: Integer; var ADisplayText: string) of object;
  ...
  public
    ...
    property Items[Index: Integer]: TdxBarExtraPaneItem read GetItem
      write SetItem; default;
  end;

  { TdxBarApplicationMenuExtraPane }

  TdxBarApplicationMenuExtraPane = class(TInterfacedPersistent,
  ...
  private
    ...
    procedure DoGetItemDisplayText(Sender: TObject; AIndex: Integer;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property AllowPinItems: Boolean read GetAllowPinItems write SetAllowPinItems
      default True;
    ...
    property WidthRatio: Double read FWidthRatio write SetWidthRatio
      stored IsWidthRatioStored;

    property OnItemClick: TdxBarExtraPaneNotifyEvent read FOnItemClick
      write FOnItemClick;
    property OnGetItemDisplayText: TdxBarExtraPaneGetDisplayTextEvent
      read FOnGetItemDisplayText write FOnGetItemDisplayText;
  end;
  ...
  public
    ...
    property ExternalItem: TdxBarButton read FExternalItem
      write SetExternalItem;
  end;
  ...
  public
    ...
    //
    property Items[Index: Integer]: TdxBarApplicationMenuButton read GetItem
      write SetItem; default;
  end;
  ...
  public
    ...
    property Buttons: TdxBarApplicationMenuButtons read FButtons
      write SetButtons;
    property ExtraPane: TdxBarApplicationMenuExtraPane read FExtraPane
      write SetExtraPane;
    property ExtraPaneEvents: TNotifyEvent read FExtraPaneEvents
      write FExtraPaneEvents;

    // obsolete
    property ExtraPaneWidthRatio: Double read GetExtraPaneWidthRatio
      write SetExtraPaneWidthRatio;
    property ExtraPaneSize: Integer read GetExtraPaneSize
      write SetExtraPaneSize;
    property ExtraPaneItems: TdxBarExtraPaneItems read GetExtraPaneItems
      write SetExtraPaneItems;
    property ExtraPaneHeader: string read GetExtraPaneHeader
      write SetExtraPaneHeader;
    property OnExtraPaneItemClick: TdxBarExtraPaneNotifyEvent
      read GetOnExtraPaneItemClick write SetOnExtraPaneItemClick;
  end;
  ...
  protected
    ...
    function CanSetMouseSelectedItem(const P: TPoint;
      AItemControl: TdxBarItemControl): Boolean; override;
    function CanShowHint: Boolean; override;
    function CanShowPopupMenuOnMouseClick(AMousePressed: Boolean)
      : Boolean; override;
    ...
    procedure DoDrawBeginGroup(const ASeparatorRect: TRect;
      AHorz: Boolean); override;
    ...
    function FindLinkWithAccel(AKey: Word; AShift: TShiftState;
      ACurrentLink: TdxBarItemLink; out ADuplicate: Boolean)
      : TdxBarItemLink; override;
    ...
    procedure SetAccelSelectedItem(AItemLink: TdxBarItemLink;
      ADuplicate: Boolean); override;
    ...
    //
    property ActuallyVisibleItemsCount: Integer
      read GetActuallyVisibleItemsCount;
  ...
  protected
    ...
    //
    property ExtraPaneItem: TdxBarExtraPaneItem read FExtraPaneItem
      write SetExtraPaneItem;
  ...
  public
    property DrawParams: TdxBarExtraMenuButtonControlDrawParams
      read GetDrawParams;
  ...
  protected
    ...
    property ActuallyVisibleItemsCount: Integer read FActuallyVisibleItemsCount
      write SetActuallyVisibleItemsCount;
    property AllowPinItems: Boolean read FAllowPinItems write FAllowPinItems;
    property ExtraPaneItem[AIndex: Integer]: TdxBarExtraPaneItem
      read GetExtraPaneItem;
    property ExtraPaneItemIndex: Integer read GetExtraPaneItemIndex;
    property OnGetDisplayText: TdxBarExtraPaneGetDisplayTextEvent
  ...
  protected
    ...
    function CanProcessMouseMessage: Boolean; override;
    procedure CalcItemRects(APaintStyle: TdxBarPaintType;
      ATopIndex: Integer); override;
    procedure CalcItemsRect; override;
    ...
    property ApplicationMenu: TdxBarCustomApplicationMenu
      read GetApplicationMenu;
    property ButtonLinks: TdxBarApplicationMenuButtonItemLinks
      read FButtonLinks;
...
type
  ...
  TdxBarExtraPaneDockControlAccessibilityHelper = class
  ...
  TdxBarExtraPaneControlAccessibilityHelper = class
  ...
  TdxBarApplicationMenuControlAccessibilityHelper = class
  ...
  protected
    ...
    function GetNextAccessibleObject(AItemLinkHelper
      ...
      ADirection: TcxAccessibilityNavigationDirection)
      : IdxBarAccessibilityHelper; override;
    function GetNextItemLink(AItemLink: TdxBarItemLink; AGoForward: Boolean)
      : TdxBarItemLink; override;
    function GetParentForKeyTip: TdxBarAccessibilityHelper; override;

    property BarControl: TdxBarApplicationMenuControl read GetBarControl;
    property ExtraPaneAccessibilityHelper: TcxAccessibilityHelper
      read GetExtraPaneAccessibilityHelper;
    property HasExtraPane: Boolean read GetHasExtraPane;
    property HasExtraPaneItemLinksItems: Boolean
      read GetHasExtraPaneItemLinksItems;
  end;

  TdxBarApplicationMenuControlDesignHelper = class
    (TCustomdxBarControlDesignHelper);

  { TdxBarExtraPanePinnedButtonControlAccessibilityHelper }

  TdxBarExtraPanePinnedButtonControlAccessibilityHelper = class
  ...
  protected
    ...
    procedure Unselect(ANextSelectedObject: IdxBarAccessibilityHelper);
      override;
  public
    property PinnedButtonControl: TdxBarExtraPanePinnedButtonControl
      read GetPinnedButtonControl;
  end;
  ...
  private
    function GetInternalDefaultValue(AOption: TdxBarItemOptionValue;
      AItemLinks: TdxBarItemLinks): Integer;
    function GetIsExtraPaneVisible: Boolean;
  protected
    function GetDefaultValue(AOption: TdxBarItemOptionValue): Integer; override;
    function GetOptionsValue(AOption: TdxBarItemOptionValue;
      AItemLinks: TdxBarItemLinks): Integer; override;
  end;
...
constructor TdxBarExtraPaneItems.Create(AApplicationMenu
  : TdxBarCustomApplicationMenu);
begin
...
procedure TdxBarExtraPaneItems.SetItem(Index: Integer;
  Value: TdxBarExtraPaneItem);
begin
...
constructor TdxBarApplicationMenuExtraPane.Create(AApplicationMenu
  : TdxBarCustomApplicationMenu);
begin
  inherited Create;
  FApplicationMenu := AApplicationMenu;
  ...
  FListItem := BarDesignController.AddInternalItem(TdxBarExtraPaneListItem,
    FApplicationMenu.BarManager, nil, FApplicationMenu.FInternalItems)
    as TdxBarExtraPaneListItem;
...
procedure TdxBarApplicationMenuExtraPane.DoGetItemDisplayText(Sender: TObject;
  AIndex: Integer; var ADisplayText: string);
begin
...
begin
  ...
  FInternalItem := BarDesignController.AddInternalItem
    (TdxBarApplicationMenuButtonItem, Collection.FApplicationMenu.BarManager,
    nil, Collection.FApplicationMenu.FInternalItems)
    as TdxBarApplicationMenuButtonItem;
end;
...
function TdxBarApplicationMenuButton.GetCollection
  : TdxBarApplicationMenuButtons;
begin
...
constructor TdxBarApplicationMenuButtons.Create(AApplicationMenu
  : TdxBarCustomApplicationMenu);
begin
...
function TdxBarApplicationMenuButtons.Insert(AIndex: Integer)
  : TdxBarApplicationMenuButton;
begin
...
function TdxBarApplicationMenuButtons.GetItem(Index: Integer)
  : TdxBarApplicationMenuButton;
begin
  Result := TdxBarApplicationMenuButton(inherited GetItem(Index));
end;

procedure TdxBarApplicationMenuButtons.SetItem(Index: Integer;
  Value: TdxBarApplicationMenuButton);
begin
  inherited SetItem(Index, Value);
end;

procedure TdxBarApplicationMenuButtons.PopulateItemLinks
...
function TdxBarApplicationMenuItemLinks.GetDefaultValue
  (AOption: TdxBarItemOptionValue): Integer;
begin
...
begin
  if (ParentLinks <> nil) or TdxBarItemOptionsAccess(ItemOptions)
    .IsValueStored(AOption) then
...
begin
  ...
  begin
    ...
    AItemRect.Right := AItemRect.Left + TdxBarItemControlAccess
      (AItemLink.Control).Width;
  ...
  if RealVisibleItemCount > 0 then
    AOffsetItemBounds := ARect.Right - VisibleItems[RealVisibleItemCount - 1]
      .ItemRect.Right
  else
    AOffsetItemBounds := 0;
  ...
  begin
    AItemLink := VisibleItems[I];
    AItemLink.ItemRect := cxRectOffsetHorz(AItemLink.ItemRect,
      AOffsetItemBounds);
  end;
  ...
  if BarControl.UseRightToLeftAlignment then
    ...
    begin
      AItemLink := VisibleItems[I];
      AItemLink.ItemRect := TdxRightToLeftLayoutConverter.ConvertRect
        (AItemLink.ItemRect, ARect);
    end;
end;
...
procedure TdxBarCustomApplicationMenu.Notification(AComponent: TComponent;
...
function TdxBarCustomApplicationMenu.GetOnExtraPaneItemClick
  : TdxBarExtraPaneNotifyEvent;
begin
  Result := FExtraPane.OnItemClick;
end;

procedure TdxBarCustomApplicationMenu.SetButtons
  (AValue: TdxBarApplicationMenuButtons);
begin
  FButtons.Assign(AValue);
end;

procedure TdxBarCustomApplicationMenu.SetExtraPane
  (AValue: TdxBarApplicationMenuExtraPane);
begin
...
procedure TdxBarCustomApplicationMenu.SetExtraPaneItems
  (AValue: TdxBarExtraPaneItems);
begin
...
procedure TdxBarCustomApplicationMenu.SetOnExtraPaneItemClick
  (AValue: TdxBarExtraPaneNotifyEvent);
begin
...
procedure TdxBarExtraPaneDockControl.CalcRowToolbarPositions(ARowIndex: Integer;
  AClientSize: Integer);
var
...
begin
  ...
  if (AToolbar.Left <> R.Left) or (AToolbar.Top <> R.Top) or
    (AToolbar.Width <> cxRectWidth(R)) or (AToolbar.Height <> cxRectHeight(R))
  then
  begin
    if AToolbar.HandleAllocated then
    begin
      SetWindowPos(AToolbar.Handle, 0, R.Left, R.Top, cxRectWidth(R),
        cxRectHeight(R), SWP_NOZORDER or SWP_NOACTIVATE);
...
function TdxBarExtraPaneDockControl.GetAccessibilityHelperClass
  : TdxBarAccessibilityHelperClass;
begin
  Result := TdxBarExtraPaneDockControlAccessibilityHelper;
end;

function TdxBarExtraPaneDockControl.GetDockedBarControlClass
  : TdxBarControlClass;
begin
...
function TdxBarExtraPaneDockControlAccessibilityHelper.GetParent
  : TcxAccessibilityHelper;
begin
  Result := TdxBarApplicationMenuControl(DockControl.Parent)
    .IAccessibilityHelper.GetBarHelper;
end;
...
begin
  ...
  begin
    FItemsRect := TdxRightToLeftLayoutConverter.ConvertRect(FItemsRect,
      ClientRect);
...
begin
  Result := inherited CanProcessMouseMessage or
    BasicControl.CanProcessMouseMessage;
end;
...
procedure TdxBarExtraPaneControl.DoDrawBeginGroup(const ASeparatorRect: TRect;
  AHorz: Boolean);
begin
  Painter.ExtraMenuControlDrawBeginGroup(Self, Canvas, ASeparatorRect,
    ToolbarBrush, AHorz);
end;
...
begin
  ...
  try
    ...
    ACanvas.DrawTexT(Caption, HeaderTextRect, AAlignment, vaCenter,
      False, False);
  finally
...
procedure TdxBarExtraPaneControl.FillBackground(ADC: HDC; const ARect: TRect;
...
function TdxBarExtraPaneControl.FindLinkWithAccel(AKey: Word;
  AShift: TShiftState; ACurrentLink: TdxBarItemLink; out ADuplicate: Boolean)
  : TdxBarItemLink;
begin
  Result := BasicControl.FindLinkWithAccel(AKey, AShift, ACurrentLink,
    ADuplicate);
end;

function TdxBarExtraPaneControl.GetAccessibilityHelperClass
  : TdxBarAccessibilityHelperClass;
begin
...
function TdxBarExtraPaneControl.GetViewInfoClass
...
procedure TdxBarExtraPaneControl.SetAccelSelectedItem(AItemLink: TdxBarItemLink;
  ADuplicate: Boolean);
begin
...
function TdxBarExtraPaneControl.CanSetMouseSelectedItem(const P: TPoint;
...
function TdxBarExtraPaneControl.CanShowPopupMenuOnMouseClick
...
procedure TdxBarExtraPaneControl.DrawBackground(ACanvas: TcxCanvas;
  const ARect: TRect; ABrush: HBRUSH; AColor: TColor);
begin
  Painter.ExtraMenuControlDrawBackground(Self, ACanvas, ARect, ABrush, AColor);
end;

procedure TdxBarExtraPaneControl.InitCustomizationPopup
  (AItemLinks: TdxBarItemLinks);
begin
...
begin
  Result := cxRectHeight(ItemsRect) div Painter.GetButtonHeight
    (Painter.GetSmallIconSize(ScaleFactor), GetTextSize, ScaleFactor);
end;
...
begin
  Result := cxRectSetBottom(HeaderRect, HeaderRect.Bottom,
    Painter.ExtraMenuSeparatorSize);
end;
...
begin
  ...
  InflateRect(Result, -dxBarExtraPaneHeaderTextIndent,
    -dxBarExtraPaneHeaderTextIndent);
end;
...
begin
  AddSeparatorInfo(cxRectSetBottom(AItemRect, AItemRect.Top,
    TCustomdxBarControlAccess(BarControl).BeginGroupSize), skHorizontal,
    AItemLink.Control);
end;
...
begin
  Result := BasicControlObject.GetNextAccessibleObject(AItemLinkHelper,
    ADirection);
end;

function TdxBarExtraPaneControlAccessibilityHelper.HandleNavigationKey
  (var AKey: Word): Boolean;
begin
  Result := False;
  if AKey <> VK_TAB then
    Result := inherited HandleNavigationKey(AKey)
  else if KeyboardStateToShiftState = [] then
    AKey := VK_DOWN
  else
    AKey := VK_UP;
end;

function TdxBarExtraPaneControlAccessibilityHelper.GetBarControl
  : TdxBarExtraPaneControl;
begin
...
begin
  ...
  FButtonsRect := cxRectContent(FButtonsRect,
    Painter.ApplicationMenuContentButtonOffsets);
  ...
  begin
    FItemsRect := TdxRightToLeftLayoutConverter.ConvertRect(FItemsRect,
      ClientRect);
    FExtraPaneRect := TdxRightToLeftLayoutConverter.ConvertRect(FExtraPaneRect,
      ClientRect);
    FButtonsRect := TdxRightToLeftLayoutConverter.ConvertRect(FButtonsRect,
      ClientRect);
  end;
end;

function TdxBarApplicationMenuControl.CalcChildBarBounds
...
function TdxBarApplicationMenuControl.CalcExtraPaneWidth(const AMenuBarSize
  : TSize): Integer;
begin
  if not HasExtraPane then
    Result := 0
  else if ExtraPane.Size <> 0 then
    Result := MulDiv(ExtraPane.Size, TextSize,
      Painter.SubMenuControlNormalItemHeight(ScaleFactor))
  else
...
function TdxBarApplicationMenuControl.GetViewInfoClass
  : TCustomdxBarControlViewInfoClass;
begin
  Result := TdxBarApplicationMenuControlViewInfo;
end;

function TdxBarApplicationMenuControl.GetExtraPaneDockControlClass
  : TdxBarDockControlClass;
begin
...
begin
  ...
  try
    ...
    Painter.ApplicationMenuDrawBackground(Self, ACanvas, ContentRect,
      AItemsArea);
  finally
...
function TdxBarApplicationMenuControl.DoFindLinkWithAccel(AKey: Word;
  AShift: TShiftState; ACurrentLink: TdxBarItemLink): TdxBarItemLink;
begin
  Result := TdxBarItemLinksAccess(TotalItemLinks).FindItemWithAccel(AKey,
    AShift, ACurrentLink);
end;

procedure TdxBarApplicationMenuControl.DoGetExtraPaneListItemData
  (Sender: TObject);
begin
  ExtraPane.ListItem.ActuallyVisibleItemsCount :=
    ExtraPaneControl.ActuallyVisibleItemsCount;
end;

function TdxBarApplicationMenuControl.FindLinkWithAccel(AKey: Word;
  AShift: TShiftState; ACurrentLink: TdxBarItemLink; out ADuplicate: Boolean)
  : TdxBarItemLink;
...
begin
  ...
  Result := ExportCurrentLink(inherited FindLinkWithAccel(AKey, AShift,
    ImportCurrentLink(ACurrentLink), ADuplicate));
end;

function TdxBarApplicationMenuControl.GetAccessibilityHelperClass
  : TdxBarAccessibilityHelperClass;
begin
  Result := TdxBarApplicationMenuControlAccessibilityHelper;
end;
...
function TdxBarApplicationMenuControl.GetClientOffset(AIncludeDetachCaption
  : Boolean = True): TRect;
begin
  Result := cxNullRect;
end;
...
function TdxBarApplicationMenuControl.IsControlExists(ABarItemControl
  : TdxBarItemControl): Boolean;
begin
  Result := inherited IsControlExists(ABarItemControl) or
    (ButtonLinks.IsControlExists(ABarItemControl));
end;

procedure TdxBarApplicationMenuControl.SetAccelSelectedItem
  (AItemLink: TdxBarItemLink; ADuplicate: Boolean);
begin
  if BarNavigationController.SelectedObject <> nil then
    BarNavigationController.SelectedObject.Unselect
      (AItemLink.Control.IAccessibilityHelper);
...
procedure TdxBarApplicationMenuControl.SetControlVisible
...
procedure TdxBarApplicationMenuControl.SetMouseSelectedItem
  (Value: TdxBarItemControl);
begin
...
begin
  ...
  SetWindowPos(FDockControl.Handle, 0, FExtraPaneRect.Left, FExtraPaneRect.Top,
    cxRectWidth(FExtraPaneRect), cxRectHeight(FExtraPaneRect), SWP_NOZORDER or
    SWP_NOACTIVATE or SWP_SHOWWINDOW);
end;

function TdxBarApplicationMenuControl.GetApplicationMenu
  : TdxBarCustomApplicationMenu;
begin
  Result := TdxBarCustomApplicationMenu(ItemLinks.Owner);
end;

function TdxBarApplicationMenuControl.GetExtraPane
  : TdxBarApplicationMenuExtraPane;
begin
  Result := ApplicationMenu.ExtraPane;
end;

function TdxBarApplicationMenuControl.GetExtraPaneControl
  : TdxBarExtraPaneControl;
begin
...
begin
  if FTotalItemLinks = nil then
    FTotalItemLinks := TdxBarSubMenuControlItemLinks.Create(BarManager,
      ApplicationMenu);
...
function TdxBarApplicationMenuControlViewInfo.GetBarControl
  : TdxBarApplicationMenuControl;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        IdxBarItemControlViewInfo(AControl.ViewInfo)
          .SetBounds(AVisibleItemRect);
      end;
    end;
  end;
end;
...
procedure TdxBarApplicationMenuControlAccessibilityHelper.
...
function TdxBarApplicationMenuControlAccessibilityHelper.GetNextAccessibleObject
  ...
  begin
    ...
    begin
      ...
      Result := AItemControl.IAccessibilityHelper.GetBarHelper.GetScreenBounds
        (cxAccessibleObjectSelfID);
  end;
...
begin
  ...
  begin
    if HasExtraPane and
      ...
      AItemLink := InternalGetNextItemLink(BarControl.ExtraPaneItemLinks,
        TCustomdxBarControlAccess(BarControl.FExtraPaneBar.Control)
        .SelectedLink, ADirection = andUp)
    else
  ...
  begin
    ...
    try
      ...
      GetChildrenForNavigation(AItemLinkHelper, Self,
        GetScreenBoundsForNavigation(AItemControl), ADirection, True, AObjects);
...
begin
  ...
  else if ItemLinks.RealVisibleItemCount > 0 then
    Result := ItemLinks.First
  else
    Result := nil;
end;

function TdxBarApplicationMenuControlAccessibilityHelper.GetParentForKeyTip
  : TdxBarAccessibilityHelper;
var
  AIAccessibleObject: IdxBarAccessibleObject;
begin
  if Supports(BarControl.RealOwnerControl, IdxBarAccessibleObject,
    AIAccessibleObject) then
    Result := AIAccessibleObject.GetAccessibilityHelper.GetBarHelper
  else
    Result := nil;
end;

function TdxBarApplicationMenuControlAccessibilityHelper.GetBarControl
  : TdxBarApplicationMenuControl;
begin
  Result := TdxBarApplicationMenuControl(FOwnerObject);
end;

function TdxBarApplicationMenuControlAccessibilityHelper.
  GetHasExtraPane: Boolean;
begin
  Result := BarControl.HasExtraPane;
end;

function TdxBarApplicationMenuControlAccessibilityHelper.
  GetHasExtraPaneItemLinksItems: Boolean;
begin
  Result := HasExtraPane and
    (BarControl.ExtraPaneItemLinks.RealVisibleItemCount > 0);
end;

function TdxBarApplicationMenuControlAccessibilityHelper.
  GetExtraPaneAccessibilityHelper: TcxAccessibilityHelper;
begin
  Result := BarControl.ExtraPaneControlDockControl.
...
begin
  ...
  else if ASelectedLink.VisibleIndex = ACurrentLinks.RealVisibleItemCount - 1
  then
...
procedure TdxBarApplicationMenuControlAccessibilityHelper.PopulateNavigationList
  (AList: TList);
begin
...
function TdxBarExtraPaneListItem.CreateItem(AIndex, ACurIndex: Integer)
  : TdxBarButton;
begin
...
procedure TdxBarExtraPaneListItem.PopulateListedItemLinks
  ...
  begin
    ...
    for I := 0 to ItemList.Count - 1 do
      AddListedItemLink(AItemLinks, ALinkData, AIndex + I,
        TdxBarItem(ItemList[I]));
  end;
...
begin
  ...
  if Result = '' then
    Result := ChangeFileExt(ExtractFileName(ExtraPaneItem[AItemIndex]
      .Text), '');
end;

function TdxBarExtraPaneListItem.GetExtraPaneItem(AIndex: Integer)
  : TdxBarExtraPaneItem;
begin
...
function TdxBarExtraPaneButton.GetControlClass(AIsVertical: Boolean)
...
function TdxBarExtraPanePinnedButton.GetControlClass(AIsVertical: Boolean)
  : TdxBarItemControlClass;
begin
...
procedure TdxBarExtraPaneButtonControl.DoPaint(ARect: TRect;
  PaintType: TdxBarPaintType);
begin
  Painter.ExtraMenuDrawButton(DrawParams, ARect);
end;

function TdxBarExtraPaneButtonControl.GetDrawParams
  : TdxBarExtraMenuButtonControlDrawParams;
begin
  Result := TdxBarExtraMenuButtonControlDrawParams(inherited DrawParams);
end;

function TdxBarExtraPaneButtonControl.GetDrawParamsClass
  : TdxBarItemControlDrawParamsClass;
begin
...
procedure TdxBarExtraPaneButtonControl.GetTextColors(AEnabled, ASelected,
...
procedure TdxBarExtraPanePinnedButtonControl.CalcDrawParams
  (AFull: Boolean = True);
begin
...
function TdxBarExtraPanePinnedButtonControl.GetAccessibilityHelperClass
  : TdxBarAccessibilityHelperClass;
begin
...
function TdxBarExtraPanePinnedButtonControlAccessibilityHelper.
  ...
  begin
    Result := (PinnedButtonControl.HotPartIndex <> icpNone) and
      ...
      (PinnedButtonControl.HotPartIndex + ADirection <
      PinnedButtonControl.GetPartCount);
    if Result then
      PinnedButtonControl.HotPartIndex := PinnedButtonControl.HotPartIndex +
        ADirection;
  end;
...
procedure TdxBarExtraPanePinnedButtonControlAccessibilityHelper.Select
  (ASetFocus: Boolean);
begin
...
begin
  ...
  begin
    if ANextSelectedObject.GetBarHelper is TdxBarExtraPanePinnedButtonControlAccessibilityHelper
    then
    begin
      ABarHelper := TdxBarExtraPanePinnedButtonControlAccessibilityHelper
        (ANextSelectedObject.GetBarHelper);
      ABarHelper.PinnedButtonControl.HotPartIndex :=
        PinnedButtonControl.HotPartIndex;
    end;
  end;
...
function TdxBarExtraPanePinnedButtonControlAccessibilityHelper.
  GetPinnedButtonControl: TdxBarExtraPanePinnedButtonControl;
begin
...
procedure TdxBarApplicationMenuButtonItem.Notification(AComponent: TComponent;
  Operation: TOperation);
begin
...
dxBarRegisterItem(TdxBarApplicationMenuButtonItem,
  TdxBarApplicationMenuButtonControl, False);
BarDesignController.RegisterBarControlDesignHelper(TdxBarApplicationMenuControl,
  TdxBarApplicationMenuControlDesignHelper);
