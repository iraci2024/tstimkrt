...
uses
  ...
  cxControls,
  cxLookAndFeels, cxLookAndFeelPainters, ComCtrls, cxClasses, cxTextEdit,
  cxMaskEdit,
  ...
  dxRichEdit.Dialogs.Core, dxRichEdit.Dialogs.SymbolFormController,
...
function TdxRichEditSymbolDialogForm.GetController
  : TdxRichEditInsertSymbolController;
begin
  Result := TdxRichEditInsertSymbolController(inherited Controller);
end;

function TdxRichEditSymbolDialogForm.CreateController(AControllerParameters
  : TdxFormControllerParameters): TdxFormController;
begin
  Result := TdxRichEditInsertSymbolController.Create
    (AControllerParameters as TdxRichEditInsertSymbolControllerParameters);
end;

procedure TdxRichEditSymbolDialogForm.edtCharacterCodeKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TdxRichEditSymbolDialogForm.edtCharacterCodePropertiesChange
  (Sender: TObject);
var
  ANewValue: Integer;
begin
...
begin
  ...
  lciFont.CaptionOptions.Text := cxGetResourceString
    (@sdxRichEditSymbolDialogFont);
  lciCharacterCode.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditSymbolDialogCharacterCode);
end;
...
procedure TdxRichEditSymbolDialogForm.SelectedIndexSymbolChanged
  (Sender: TObject);
begin
  UnsubscribeControlsEvents;
  try
