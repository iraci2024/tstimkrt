...
Var
  ...
  St: String;
begin
  if (Edit1.Text <> ListBox.Items[ListBox.ItemIndex]) then
  begin
    St := Edit1.Text;
...
procedure TfrmSpinImagePropEditor.ListBoxDragOver(Sender, Source: TObject;
...
procedure TfrmSpinImagePropEditor.ListBoxDragDrop(Sender, Source: TObject;
  X, Y: Integer);
Var
  p: TPoint;
  Item, Item1: Integer;
