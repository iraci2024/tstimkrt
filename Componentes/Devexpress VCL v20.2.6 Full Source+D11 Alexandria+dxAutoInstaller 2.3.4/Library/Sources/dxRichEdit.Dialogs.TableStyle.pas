...
type
  ...
  TdxToggleConditionalTableCellsBordersCommandBaseClass = class of
    TdxToggleConditionalTableCellsBordersCommandBase;

  TdxToggleConditionalTableCellsBordersCommandBase = class
  ...
  protected
    ...
    property TableStyleController: TdxTableStyleFormController
      read FTableStyleController write FTableStyleController;
  end;
  ...
  TdxRichEditTableStyleDialogForm = class(TdxRichEditCustomDialogForm)
    ...
    procedure cmbTableBorderLineStylePropertiesDrawItem
  ...
  private type
    TAlignment = record
      ...
      constructor Create(AVertical: TdxVerticalAlignment;
  ...
  private
    ...
    procedure AddApplyToComboItem(AItems: TStrings;
    ...
    procedure PopulateCurrentStyleCombo(AComboBox: TcxCustomComboBox;
      AStyles: TdxStyleCollectionBase);
    procedure PopulateParentStyleCombo; overload;
    procedure PopulateParentStyleCombo(AComboBox: TcxCustomComboBox;
      AStyles: TdxStyleCollectionBase); overload;
    procedure InitializeAlignmentDictionary;
    procedure InitializeBorderInfo;
    procedure InitializeConditionalStyleType;

    procedure ApplyCharacterProperties(AProperties
      : TdxMergedCharacterProperties; AData: TObject);
    procedure ApplyParagraphProperties(AProperties
      : TdxMergedParagraphProperties; AData: TObject);
    procedure ApplyTabsProperties(ATabInfo: TdxTabFormattingInfo;
      ADefaultTabWidth: Integer; AData: TObject);
    ...
    function GetConditionalStyleType
      : TdxConditionalTableStyleFormattingType; inline;
  ...
  protected
    ...
    procedure ChangesTableCellsBorder(ACommandClass
      : TdxToggleConditionalTableCellsBordersCommandBaseClass);
    ...
    procedure UpdateCharacterBars(AMergedCharacterProperties
    ...
    property ConditionalStyleType: TdxConditionalTableStyleFormattingType
      read GetConditionalStyleType;
    property CurrentConditionalStyle: TdxTableConditionalStyle
      read GetCurrentConditionalStyle;
    property SourceStyle: TdxTableStyle read GetSourceStyle;
    property IntermediateTableStyle: TdxTableStyle
      read GetIntermediateTableStyle;
  public
...
type
  ...
  TdxToggleConditionalTableCellsTopBorderCommand = class
    (TdxToggleConditionalTableCellsBordersCommandBase)
  protected
  ...
  TdxToggleConditionalTableCellsBottomBorderCommand = class
    (TdxToggleConditionalTableCellsBordersCommandBase)
  protected
    procedure ResetBorder(ABorder: TdxBorderBase); override;
    procedure ModifyBorder(ABorder: TdxBorderBase); override;
  ...
  TdxToggleConditionalTableCellsLeftBorderCommand = class
    (TdxToggleConditionalTableCellsBordersCommandBase)
  protected
    procedure ResetBorder(ABorder: TdxBorderBase); override;
    procedure ModifyBorder(ABorder: TdxBorderBase); override;
  ...
  TdxToggleConditionalTableCellsRightBorderCommand = class
    (TdxToggleConditionalTableCellsBordersCommandBase)
  protected
    procedure ResetBorder(ABorder: TdxBorderBase); override;
    procedure ModifyBorder(ABorder: TdxBorderBase); override;
  ...
  TdxResetConditionalTableCellsBordersCommand = class
    (TdxToggleConditionalTableCellsBordersCommandBase)
  protected
    procedure ResetBorder(ABorder: TdxBorderBase); override;
  end;
  ...
  TdxToggleConditionalTableCellsAllBordersBorderCommand = class
    (TdxToggleConditionalTableCellsBordersCommandBase)
  protected
    procedure ResetBorder(ABorder: TdxBorderBase); override;
    procedure ModifyBorder(ABorder: TdxBorderBase); override;
  ...
  TdxToggleConditionalTableCellsOutsideBorderCommand = class
    (TdxToggleConditionalTableCellsBordersCommandBase)
  protected
    procedure ResetBorder(ABorder: TdxBorderBase); override;
    procedure ModifyBorder(ABorder: TdxBorderBase); override;
  ...
  TdxToggleConditionalTableCellsInsideBorderCommand = class
    (TdxToggleConditionalTableCellsBordersCommandBase)
  protected
    procedure ResetBorder(ABorder: TdxBorderBase); override;
    procedure ModifyBorder(ABorder: TdxBorderBase); override;
  ...
  TdxToggleConditionalTableCellsInsideHorizontalBorderCommand = class
    (TdxToggleConditionalTableCellsBordersCommandBase)
  protected
    procedure ResetBorder(ABorder: TdxBorderBase); override;
    procedure ModifyBorder(ABorder: TdxBorderBase); override;
  ...
  TdxToggleConditionalTableCellsInsideVerticalBorderCommand = class
    (TdxToggleConditionalTableCellsBordersCommandBase)
  protected
    procedure ResetBorder(ABorder: TdxBorderBase); override;
    procedure ModifyBorder(ABorder: TdxBorderBase); override;
...
function TdxToggleConditionalTableCellsBordersCommandBase.GetCurrentBorders
  : TdxBordersBase;
begin
  Result := TableStyleController.CurrentBorders as TdxBordersBase;
end;

procedure TdxToggleConditionalTableCellsBordersCommandBase.CollectBorders
...
procedure TdxToggleConditionalTableCellsBordersCommandBase.CollectTableBorders
...
procedure TdxToggleConditionalTableCellsTopBorderCommand.ResetBorder
...
procedure TdxToggleConditionalTableCellsTopBorderCommand.ModifyBorder
  (ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
...
function TdxToggleConditionalTableCellsTopBorderCommand.CalculateIsChecked
...
procedure TdxToggleConditionalTableCellsBottomBorderCommand.ResetBorder
  (ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
...
procedure TdxToggleConditionalTableCellsBottomBorderCommand.ModifyBorder
  (ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
...
function TdxToggleConditionalTableCellsBottomBorderCommand.CalculateIsChecked
  (ABorders: TdxBorderBaseList): Boolean;
var
  ALocalBorders: TdxBorderBaseList;
begin
...
procedure TdxToggleConditionalTableCellsLeftBorderCommand.ResetBorder
  (ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
...
procedure TdxToggleConditionalTableCellsLeftBorderCommand.ModifyBorder
  (ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
...
function TdxToggleConditionalTableCellsLeftBorderCommand.CalculateIsChecked
  (ABorders: TdxBorderBaseList): Boolean;
var
  ALocalBorders: TdxBorderBaseList;
begin
...
procedure TdxToggleConditionalTableCellsRightBorderCommand.ResetBorder
  (ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
...
procedure TdxToggleConditionalTableCellsRightBorderCommand.ModifyBorder
  (ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
...
function TdxToggleConditionalTableCellsRightBorderCommand.CalculateIsChecked
  (ABorders: TdxBorderBaseList): Boolean;
var
  ALocalBorders: TdxBorderBaseList;
begin
...
procedure TdxResetConditionalTableCellsBordersCommand.ResetBorder
  (ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
...
procedure TdxToggleConditionalTableCellsAllBordersBorderCommand.ResetBorder
  (ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
...
procedure TdxToggleConditionalTableCellsAllBordersBorderCommand.ModifyBorder
  (ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
...
function TdxToggleConditionalTableCellsAllBordersBorderCommand.
  CalculateIsChecked(ABorders: TdxBorderBaseList): Boolean;
var
  ALocalBorders: TdxBorderBaseList;
begin
  ALocalBorders := TdxBorderBaseList.Create;
...
procedure TdxToggleConditionalTableCellsOutsideBorderCommand.ResetBorder
  (ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
...
procedure TdxToggleConditionalTableCellsOutsideBorderCommand.ModifyBorder
  (ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
...
function TdxToggleConditionalTableCellsOutsideBorderCommand.CalculateIsChecked
  (ABorders: TdxBorderBaseList): Boolean;
var
  ALocalBorders: TdxBorderBaseList;
begin
...
procedure TdxToggleConditionalTableCellsInsideBorderCommand.ResetBorder
  (ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
...
procedure TdxToggleConditionalTableCellsInsideBorderCommand.ModifyBorder
  (ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
...
function TdxToggleConditionalTableCellsInsideBorderCommand.CalculateIsChecked
  (ABorders: TdxBorderBaseList): Boolean;
var
  ALocalBorders: TdxBorderBaseList;
begin
...
procedure TdxToggleConditionalTableCellsInsideHorizontalBorderCommand.
  ResetBorder(ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
  ALocalBorder := CurrentBorders.InsideHorizontalBorder;
...
procedure TdxToggleConditionalTableCellsInsideHorizontalBorderCommand.
  ModifyBorder(ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
  ALocalBorder := CurrentBorders.InsideHorizontalBorder;
...
function TdxToggleConditionalTableCellsInsideHorizontalBorderCommand.
  CalculateIsChecked(ABorders: TdxBorderBaseList): Boolean;
var
  ALocalBorders: TdxBorderBaseList;
begin
...
procedure TdxToggleConditionalTableCellsInsideVerticalBorderCommand.ResetBorder
  (ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
...
procedure TdxToggleConditionalTableCellsInsideVerticalBorderCommand.ModifyBorder
  (ABorder: TdxBorderBase);
var
  ALocalBorder: TdxBorderBase;
begin
...
function TdxToggleConditionalTableCellsInsideVerticalBorderCommand.
  CalculateIsChecked(ABorders: TdxBorderBaseList): Boolean;
var
  ALocalBorders: TdxBorderBaseList;
begin
...
function TdxRichEditTableStyleDialogForm.GetCharacterProperties
  : TdxCharacterProperties;
begin
  Result := Controller.CharacterProperties;
end;

function TdxRichEditTableStyleDialogForm.GetConditionalStyleType
  : TdxConditionalTableStyleFormattingType;
begin
  Result := Controller.ConditionalStyleType;
end;

function TdxRichEditTableStyleDialogForm.GetController
  : TdxTableStyleFormController;
begin
  Result := TdxTableStyleFormController(inherited Controller);
end;

function TdxRichEditTableStyleDialogForm.GetCurrentConditionalStyle
...
function TdxRichEditTableStyleDialogForm.GetIntermediateTableStyle
  : TdxTableStyle;
begin
...
var
  AText: string;
begin
  AText := cxGetResourceString
    (dxConditionalTableStyleFormattingTypeNames[AItem]);
...
procedure TdxRichEditTableStyleDialogForm.aParagraphDialogExecute
  (Sender: TObject);
var
...
begin
  ...
  AControl := Controller.Control;
  try
    AControl.ShowParagraphForm(AMergedProperties,
      ApplyParagraphProperties, nil);
  finally
    AMergedProperties.Free;
  end;
end;
...
begin
  ...
  btnFormat.Caption := cxGetResourceString
    (@sdxRichEditTableStyleDialogButtonFormat);
  lblSelectedStyle.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditTableStyleDialogSelectedStyle);
  lblProperties.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditTableStyleDialogProperties);
  lcilName.CaptionOptions.Text := cxGetResourceString
    (@sdxRichEditTableStyleDialogName);
  lcilStyleBasedOn.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditTableStyleDialogStyleBasedOn);
  lblFormatting.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditTableStyleDialogFormatting);
  lciCurrentStyle.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditTableStyleDialogCurrentStyle);
  lciApplyFormattingTo.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditTableStyleDialogApplyFormattingTo);
  aFontDialog.Caption := cxGetResourceString
    (@sdxRichEditTableStyleDialogFontDialog);
  aParagraphDialog.Caption := cxGetResourceString
    (@sdxRichEditTableStyleDialogParagraphDialog);
  aTabsDialog.Caption := cxGetResourceString
    (@sdxRichEditTableStyleDialogTabsDialog);
  aToggleTableCellsAllBorders.Caption :=
    cxGetResourceString(@sdxRichEditTableStyleDialogToggleTableCellsAllBorders);
  aResetTableCellsBorders.Caption :=
    cxGetResourceString(@sdxRichEditTableStyleDialogResetTableCellsBorders);
  aToggleFontBold.Hint := cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleFontBoldHint);
  aToggleFontItalic.Hint := cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleFontItalicHint);
  aToggleFontUnderline.Hint := cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleFontUnderlineHint);
  aToggleTableCellsOutsideBorder.Caption :=
    cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleTableCellsOutsideBorder);
  aToggleTableCellsInsideBorder.Caption :=
    cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleTableCellsInsideBorder);
  aToggleTableCellsTopBorder.Caption :=
    cxGetResourceString(@sdxRichEditTableStyleDialogToggleTableCellsTopBorder);
  aToggleTableCellsBottomBorder.Caption :=
    cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleTableCellsBottomBorder);
  aToggleTableCellsLeftBorder.Caption :=
    cxGetResourceString(@sdxRichEditTableStyleDialogToggleTableCellsLeftBorder);
  aToggleTableCellsRightBorder.Caption :=
    cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleTableCellsRightBorder);
  aToggleTableCellsInsideHorizontalBorder.Caption :=
    cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleTableCellsInsideHorizontalBorder);
  aToggleTableCellsInsideVerticalBorder.Caption :=
    cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleTableCellsInsideVerticalBorder);
  aToggleTableCellsTopLeftAlignment.Caption :=
    cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleTableCellsTopLeftAlignment);
  aToggleTableCellsMiddleLeftAlignment.Caption :=
    cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleTableCellsMiddleLeftAlignment);
  aToggleTableCellsBottomLeftAlignment.Caption :=
    cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleTableCellsBottomLeftAlignment);
  aToggleTableCellsTopCenterAlignment.Caption :=
    cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleTableCellsTopCenterAlignment);
  aToggleTableCellsMiddleCenterAlignment.Caption :=
    cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleTableCellsMiddleCenterAlignment);
  aToggleTableCellsBottomCenterAlignment.Caption :=
    cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleTableCellsBottomCenterAlignment);
  aToggleTableCellsTopRightAlignment.Caption :=
    cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleTableCellsTopRightAlignment);
  aToggleTableCellsMiddleRightAlignment.Caption :=
    cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleTableCellsMiddleRightAlignment);
  aToggleTableCellsBottomRightAlignment.Caption :=
    cxGetResourceString
    (@sdxRichEditTableStyleDialogToggleTableCellsBottomRightAlignment);
end;

procedure TdxRichEditTableStyleDialogForm.ApplyCharacterProperties
...
procedure TdxRichEditTableStyleDialogForm.ApplyParagraphProperties
...
procedure TdxRichEditTableStyleDialogForm.ApplyTabsProperties
...
procedure TdxRichEditTableStyleDialogForm.aResetTableCellsBordersExecute
  (Sender: TObject);
begin
...
procedure TdxRichEditTableStyleDialogForm.aToggleFontBoldExecute
  (Sender: TObject);
begin
  Controller.ChangeConditionalCurrentFontBoldValue(TAction(Sender).Checked);
end;

procedure TdxRichEditTableStyleDialogForm.aToggleFontItalicExecute
  (Sender: TObject);
begin
  Controller.ChangeConditionalCurrentFontItalicValue(TAction(Sender).Checked);
end;

procedure TdxRichEditTableStyleDialogForm.aToggleFontUnderlineExecute
  (Sender: TObject);
begin
  if TAction(Sender).Checked then
    Controller.ChangeConditionalCurrentFontUnderlineTypeValue
...
procedure TdxRichEditTableStyleDialogForm.aToggleTableCellsAllBordersExecute
  (Sender: TObject);
begin
  ChangesTableCellsBorder
    (TdxToggleConditionalTableCellsAllBordersBorderCommand);
  btnTableBorders.Action := TAction(Sender);
end;

procedure TdxRichEditTableStyleDialogForm.aToggleTableCellsBottomBorderExecute
  (Sender: TObject);
begin
...
procedure TdxRichEditTableStyleDialogForm.aToggleTableCellsInsideBorderExecute
  (Sender: TObject);
begin
...
procedure TdxRichEditTableStyleDialogForm.
  aToggleTableCellsInsideHorizontalBorderExecute(Sender: TObject);
begin
  ChangesTableCellsBorder
    (TdxToggleConditionalTableCellsInsideHorizontalBorderCommand);
  btnTableBorders.Action := TAction(Sender);
...
procedure TdxRichEditTableStyleDialogForm.
  aToggleTableCellsInsideVerticalBorderExecute(Sender: TObject);
begin
  ChangesTableCellsBorder
    (TdxToggleConditionalTableCellsInsideVerticalBorderCommand);
  btnTableBorders.Action := TAction(Sender);
...
procedure TdxRichEditTableStyleDialogForm.aToggleTableCellsLeftBorderExecute
  (Sender: TObject);
begin
...
procedure TdxRichEditTableStyleDialogForm.aToggleTableCellsOutsideBorderExecute
  (Sender: TObject);
begin
...
procedure TdxRichEditTableStyleDialogForm.aToggleTableCellsRightBorderExecute
  (Sender: TObject);
begin
...
procedure TdxRichEditTableStyleDialogForm.aToggleTableCellsTopBorderExecute
  (Sender: TObject);
begin
...
procedure TdxRichEditTableStyleDialogForm.ChangeConditionalCurrentAlignment
  (Sender: TObject);
var
...
begin
  ...
  Controller.ChangeConditionalCurrentAlignmentValue(AAlignment.Vertical,
    AAlignment.Paragraph);
end;
...
begin
  ACurrentTable := PreviewRichEditControl.DocumentModel.
    ActivePieceTable.Tables[0];
  TdxEditStyleHelper.ChangeConditionalType(ACurrentTable,
    [ConditionalStyleType]);
end;

procedure TdxRichEditTableStyleDialogForm.ChangesTableCellsBorder
  (ACommandClass: TdxToggleConditionalTableCellsBordersCommandBaseClass);
var
...
procedure TdxRichEditTableStyleDialogForm.cmbApplyToPropertiesChange
  (Sender: TObject);
var
  AApplyType: Integer;
begin
  ...
  if TryGetItemValue(cmbApplyTo, AApplyType) then
    Controller.ConditionalStyleType := TdxConditionalTableStyleFormattingType
      (AApplyType);
  ChangeConditionalType;
  Controller.SubscribeConditionalStyleEvents;
  UpdateRichEditBars;
...
procedure TdxRichEditTableStyleDialogForm.cmbCurrentStylePropertiesChange
  (Sender: TObject);
var
  AStyle: IdxStyle;
  AStyleName: string;
...
procedure TdxRichEditTableStyleDialogForm.cmbFontColorPropertiesChange
  (Sender: TObject);
begin
  Controller.ChangeConditionalCurrentForeColorValue
    (TdxAlphaColors.FromColor(cmbFontColor.ColorValue));
end;

procedure TdxRichEditTableStyleDialogForm.cmbFontEditPropertiesChange
  (Sender: TObject);
begin
  Controller.ChangeConditionalCurrentFontNameValue(cmbFontEdit.FontName);
end;

procedure TdxRichEditTableStyleDialogForm.cmbFontSizePropertiesChange
  (Sender: TObject);
var
  AText: string;
  AValue: Integer;
begin
  if TdxEditStyleHelper.IsFontSizeValid(cmbFontSize.EditValue, AText, AValue)
  then
    Controller.ChangeConditionalCurrentDoubleFontSizeValue(AValue)
  else
  begin
    Application.MessageBox(PChar(AText), PChar(Application.Title),
      MB_OK + MB_ICONWARNING);
    cmbFontSize.EditValue := CharacterProperties.DoubleFontSize / 2;
  end;
end;

procedure TdxRichEditTableStyleDialogForm.cmbParentPropertiesChange
  (Sender: TObject);
begin
  ChangeConditionalType;
  SetParentStyle;
...
procedure TdxRichEditTableStyleDialogForm.
  cmbTableBorderLineColorPropertiesChange(Sender: TObject);
var
...
begin
  ...
  FBorderShadingDialogHelper.PopulateBorderLineStyle(ilBorderLineStyle,
    cmbTableBorderLineStyle.Properties.Items);
  TdxBorderLineWeightPainter.PopulateBorderLineWeight
    (cmbTableBorderLineWeight.Properties, FBorderInfo.Style,
    FBorderShadingDialogHelper.Color, UnitConverter,
    TdxRichEditBorderShadingDialogHelper.BordersLineWeights);
end;

procedure TdxRichEditTableStyleDialogForm.
  cmbTableBorderLineStylePropertiesChange(Sender: TObject);
begin
  //
...
procedure TdxRichEditTableStyleDialogForm.
  cmbTableBorderLineStylePropertiesDrawItem(AControl: TcxCustomComboBox;
...
begin
  ...
  TdxBorderLineWeightPainter.DrawBorderLineItem(ABorderInfo, ACanvas, ARect,
    UnitConverter, False);
...
procedure TdxRichEditTableStyleDialogForm.
  cmbTableBorderLineWeightPropertiesChange(Sender: TObject);
var
  AItem: TcxImageComboBoxItem;
begin
  AItem := cmbTableBorderLineWeight.Properties.Items
    [cmbTableBorderLineWeight.ItemIndex];
...
procedure TdxRichEditTableStyleDialogForm.cmbTableCellsShadingPropertiesChange
  (Sender: TObject);
begin
  Controller.ChangeConditionalCurrentBackgroundColorValue
    (TdxAlphaColors.FromColor(cmbTableCellsShading.ColorValue));
end;

function TdxRichEditTableStyleDialogForm.CreateController(AControllerParameters
  : TdxFormControllerParameters): TdxFormController;
begin
  Result := TdxTableStyleFormController.Create(PreviewRichEditControl,
    AControllerParameters as TdxFormControllerParameters);
end;
...
procedure TdxRichEditTableStyleDialogForm.edtNamePropertiesChange
  (Sender: TObject);
begin
  Controller.StyleName := edtName.Text;
end;

procedure TdxRichEditTableStyleDialogForm.FormCloseQuery(Sender: TObject;
...
begin
  ...
  FAlignments.Add(aToggleTableCellsTopLeftAlignment,
    TAlignment.Create(TdxVerticalAlignment.Top, TdxParagraphAlignment.Left));
  FAlignments.Add(aToggleTableCellsMiddleLeftAlignment,
    TAlignment.Create(TdxVerticalAlignment.Center, TdxParagraphAlignment.Left));
  FAlignments.Add(aToggleTableCellsBottomLeftAlignment,
    TAlignment.Create(TdxVerticalAlignment.Bottom, TdxParagraphAlignment.Left));
  FAlignments.Add(aToggleTableCellsTopCenterAlignment,
    TAlignment.Create(TdxVerticalAlignment.Top, TdxParagraphAlignment.Center));
  FAlignments.Add(aToggleTableCellsMiddleCenterAlignment,
    TAlignment.Create(TdxVerticalAlignment.Center,
    TdxParagraphAlignment.Center));
  FAlignments.Add(aToggleTableCellsBottomCenterAlignment,
    TAlignment.Create(TdxVerticalAlignment.Bottom,
    TdxParagraphAlignment.Center));
  FAlignments.Add(aToggleTableCellsTopRightAlignment,
    TAlignment.Create(TdxVerticalAlignment.Top, TdxParagraphAlignment.Right));
  FAlignments.Add(aToggleTableCellsMiddleRightAlignment,
    TAlignment.Create(TdxVerticalAlignment.Center,
    TdxParagraphAlignment.Right));
  FAlignments.Add(aToggleTableCellsBottomRightAlignment,
    TAlignment.Create(TdxVerticalAlignment.Bottom,
    TdxParagraphAlignment.Right));
end;
...
begin
  ...
  if Controller.Parameters.Control.InnerControl <> nil then
    PreviewRichEditControl.MeasurementUnit :=
      Controller.Parameters.Control.InnerControl.UIUnit;
  PopulateApplyTo;
  PopulateFontSize;
  InitializeConditionalStyleType;
  edtName.Text := Controller.StyleName;
  Populate(cmbCurrentStyle, PopulateCurrentStyleComboCore);
  cmbParent.Properties.Items.Add
    (cxGetResourceString(@sdxRichEditEditStyleDialogEmptyParentStyle));
  PopulateParentStyleCombo;
  UpdateSelectedIndex(cmbApplyTo,
    Ord(TdxConditionalTableStyleFormattingType.WholeTable));
  TdxBorderLineWeightPainter.PopulateBorderLineWeight
    (cmbTableBorderLineWeight.Properties, TdxBorderLineStyle.Single,
    TdxAlphaColors.Black, UnitConverter,
    TdxRichEditBorderShadingDialogHelper.BordersLineWeights);
  UpdateRichEditBars;
end;
...
begin
  Populate(cmbApplyTo, procedure(AComboBox: TcxCustomComboBox)
    ...
    begin
      ...
      AddApplyToComboItem(AItems,
        TdxConditionalTableStyleFormattingType.WholeTable);
      AddApplyToComboItem(AItems,
        TdxConditionalTableStyleFormattingType.FirstRow);
      AddApplyToComboItem(AItems,
        TdxConditionalTableStyleFormattingType.LastRow);
      AddApplyToComboItem(AItems,
        TdxConditionalTableStyleFormattingType.FirstColumn);
      AddApplyToComboItem(AItems,
        TdxConditionalTableStyleFormattingType.LastColumn);
      AddApplyToComboItem(AItems,
      ...
      AddApplyToComboItem(AItems,
        TdxConditionalTableStyleFormattingType.TopLeftCell);
      AddApplyToComboItem(AItems,
...
procedure TdxRichEditTableStyleDialogForm.PopulateCurrentStyleCombo
  (AComboBox: TcxCustomComboBox; AStyles: TdxStyleCollectionBase);
var
  I: Integer;
  AStyle: TdxStyleBase;
begin
...
procedure TdxRichEditTableStyleDialogForm.PopulateCurrentStyleComboCore
  (AComboBoxEdit: TcxCustomComboBox);
begin
  PopulateCurrentStyleCombo(AComboBoxEdit,
    TdxDocumentModel(SourceStyle.DocumentModel).TableStyles);
end;
...
procedure TdxRichEditTableStyleDialogForm.SetBorderLineStyleIndex
...
procedure TdxRichEditTableStyleDialogForm.SetNewStyleToController
...
begin
  ...
  ADocumentModel := TdxDocumentModel
    (AParameters.TableSourceStyle.DocumentModel);
  AParameters.TableSourceStyle :=
    TdxTableStyle(ADocumentModel.TableStyles.GetStyleByName(AStyleName));
end;
...
begin
  ...
  cmbTableCellsShading.Properties.OnChange :=
    cmbTableCellsShadingPropertiesChange;
  cmbTableBorderLineStyle.Properties.OnChange :=
    cmbTableBorderLineStylePropertiesChange;
  cmbTableBorderLineWeight.Properties.OnChange :=
    cmbTableBorderLineWeightPropertiesChange;
  cmbTableBorderLineStyle.Properties.OnDrawItem :=
    cmbTableBorderLineStylePropertiesDrawItem;
...
procedure TdxRichEditTableStyleDialogForm.UpdateCharacterBars
...
begin
  ...
  aToggleFontUnderline.Checked :=
    (AMergedCharacterProperties.FontUnderlineType = TdxUnderlineType.Single);
  ...
  cmbFontColor.ColorValue := TdxAlphaColors.ToColor
    (AMergedCharacterProperties.ForeColor);
  cmbFontSize.EditValue :=
    FloatToStr(AMergedCharacterProperties.DoubleFontSize / 2);
...
procedure TdxRichEditTableStyleDialogForm.UpdateTableBars(AMergedProperties
...
begin
  ...
  cmbTableBorderLineColor.ColorValue :=
    TdxAlphaColors.ToColor(FBorderInfo.Color);
end;

procedure TdxRichEditTableStyleDialogForm.PopulateParentStyleCombo;
begin
  PopulateParentStyleCombo(cmbParent,
    TdxDocumentModel(SourceStyle.DocumentModel).TableStyles);
end;

{ TdxRichEditTableStyleDialogForm.TAlignment }

constructor TdxRichEditTableStyleDialogForm.TAlignment.Create
  (AVertical: TdxVerticalAlignment; AParagraph: TdxParagraphAlignment);
begin
  Vertical := AVertical;
