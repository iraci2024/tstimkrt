...
uses
  Types, Classes, Graphics, SysUtils, IniFiles, cxControls, cxLookAndFeels,
  dxPSESys,
...
type
  ...
  published
    ...
    property SaveFormsPosition: Boolean read FSaveFormsPosition
      write SetSaveFormsPosition default True;
    property StorageType: TdxPSStorageType read FStorageType
      write SetStorageType default dxstNone;
  end;
  ...
  public
    ...
    property PreviewDialogStyle: TdxPSPreviewDialogStyle
      read GetPreviewDialogStyle write SetPreviewDialogStyle;
    ...
    property SaveFormsPosition: Boolean read GetSaveFormsPosition
      write SetSaveFormsPosition;
  ...
  published
    ...
    property OptionsStoring: TdxPSOptionsStoring read FOptionsStoring
      write SetOptionsStoring;
    property PreviewDialogStyle: TdxPSPreviewDialogStyle
      read GetPreviewDialogStyle write SetPreviewDialogStyle
      stored IsPreviewDialogStyleStored;
  end;
...
type
  ...
  public
    ...
    property ActiveController: TdxPSEngineController read GetActiveController
      write SetActiveController;
...
procedure TdxPSEngine.SetPreviewDialogStyle(const AValue
...
function TdxPSEngineControllerList.IndexOf
  (Value: TdxPSEngineController): Integer;
begin
  if FItems = nil then
    Result := -1
  else
...
function TdxPSEngineControllerList.GetItem(Index: Integer)
  : TdxPSEngineController;
begin
  Result := TdxPSEngineController(FItems.Items[Index]);
end;

procedure TdxPSEngineControllerList.SetActiveController
  (Value: TdxPSEngineController);
begin
...
begin
  ...
  Filer.DefineProperty('UseNativeLookAndFeel', ReadUseNativeLookAndFeelProperty,
    nil, False);
end;
...
procedure TdxPSEngineController.LookAndFeelChanged(Sender: TcxLookAndFeel;
  AChangedValues: TcxLookAndFeelValues);
begin
  UpdateEngineParams;
end;
...
procedure TdxPSEngineController.ReadUseNativeLookAndFeelProperty
  (Reader: TReader);
begin
  Reader.ReadBoolean;
end;
...
procedure TdxPSEngineController.SetPreviewDialogStyle
...
function TdxPSStoringManager.BeginStoring(var AIniFile: TCustomIniFile)
  : Boolean;
begin
...
begin
  ...
  else if OptionsStoring.CanStoreToIniFile then
