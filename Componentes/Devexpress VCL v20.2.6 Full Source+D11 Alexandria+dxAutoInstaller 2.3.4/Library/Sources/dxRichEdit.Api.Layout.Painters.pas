...
{$IFDEF DELPHIXE2}
  System.UITypes,
{$ENDIF}
  Windows, SysUtils, Types, Generics.Defaults, Generics.Collections, Controls,
  Contnrs,
  Graphics, Classes, SyncObjs,
  cxGeometry, cxGraphics, dxCore, dxCoreClasses, cxControls, dxCoreGraphics,
...
type
  ...
  TdxRichEditLayoutType = (Page, PageArea, Column, Comment, Header, Footer,
    // FootNote,
    // EndNote,
    TextBox, FloatingPicture, Table, TableRow, TableCell, Row, PlainTextBox,
    SpecialTextBox, InlinePictureBox, FloatingObjectAnchorBox, SpaceBox,
    ParagraphMarkBox, SectionBreakBox, LineBreakBox, PageBreakBox,
    ColumnBreakBox, HyphenBox, TabSpaceBox, NumberingListMarkBox,
    NumberingListWithSeparatorBox, UnderlineBox, StrikeoutBox, ErrorBox,
    HighlightAreaBox, FieldHighlightAreaBox, RangePermissionHighlightAreaBox,
    BookmarkStartBox, BookmarkEndBox, RangePermissionStartBox,
    RangePermissionEndBox, CommentHighlightAreaBox, CommentStartBox,
    CommentEndBox, HiddenTextUnderlineBox, LineNumberBox, PageNumberBox,
    // SeparatorBox,
    // DataContainerRunBox,
    CharacterBox, Frame, ParagraphFrameBox);
  ...
  private
    ...
    FThickness: Integer;
  public
    constructor Create(AColor: TdxAlphaColor;
      AStyle: TdxRichEditTableBorderLineStyle; AThickness: Integer);
  ...
  public
    constructor Create(const ALeft, ARight, ATop,
      ABottom: TdxRichEditLayoutBorder);
  ...
  TdxRichEditLayoutElementCollection = class abstract(TObjectList);
    ...
    TdxRichEditObjectLayoutElementCollection<T: class> = class
      (TdxRichEditLayoutElementCollection)strict private
  ...
  IdxRichEditDocumentLayoutProvider = interface
    ...
    procedure AddDocumentLayoutInvalidated(const AHandler
      : TdxDocumentLayoutInvalidatedEvent);
    procedure AddPageFormatted(const AHandler
      : TdxDocumentLayoutInvalidatedEvent);
    procedure AddDocumentFormatted(const AHandler: TdxEvent);
    procedure RemoveDocumentLayoutInvalidated(const AHandler
      : TdxDocumentLayoutInvalidatedEvent);
    procedure RemovePageFormatted(const AHandler
      : TdxDocumentLayoutInvalidatedEvent);
    ...
    property LayoutCalculationMode: TdxCalculationModeType
      read GetLayoutCalculationMode;
  end;
  ...
  TdxRichEditLayoutElementBase = class abstract(TcxIUnknownObject,
    IdxRichEditLayoutElement)
  strict private
  ...
  public
    ...
    function GetParentByTypeCore(AClass: TClass;
      const AParent: IdxRichEditLayoutElement): TObject;
    function GetParentByIntfCore(const IID: TGUID;
      const AParent: IdxRichEditLayoutElement): IUnknown;
    function GetRelativeBounds(const AElement: IdxRichEditLayoutElement): TRect;
  ...
  public
    constructor Create(AModelBox: TdxParagraphFrameBox;
  ...
  TdxRichEditParagraphFrameBoxCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditParagraphFrameBox>);

  { TdxRichEditRangedLayoutElementBase }

  TdxRichEditRangedLayoutElementBase = class abstract
    (TdxRichEditLayoutElementBase, IdxRichEditLayoutElement,
    IdxRichEditRangedLayoutElement)
  strict private
  ...
  protected
    ...
    function IdxRichEditRangedLayoutElement.GetParentByType =
      InnerGetParentByType;
  public
  ...
  public
    constructor Create(ABox: TdxModelBox; AType: TdxRichEditLayoutType;
      const AParent: IdxRichEditLayoutElement);
    destructor Destroy; override;
  end;

  TdxRichEditBoxCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditBox>);
  ...
  public
    constructor Create(ABox: TdxModelInlinePictureBox;
      const AParent: IdxRichEditLayoutElement);
    procedure Accept(AVisitor: TdxRichEditLayoutVisitor); override;
  ...
  public
    constructor Create(ABox: TdxNumberingListBox;
      const AParent: IdxRichEditLayoutElement);
    procedure Accept(AVisitor: TdxRichEditLayoutVisitor); override;
  ...
  TdxRichEditNumberingListWithSeparatorBox = class
    (TdxRichEditNumberingListMarkBox)
  strict private
  ...
  protected
    function GetType: TdxRichEditLayoutType; override;
  public
    constructor Create(ABox: TdxNumberingListBoxWithSeparator;
      const AParent: IdxRichEditLayoutElement);
    destructor Destroy; override;
    procedure Accept(AVisitor: TdxRichEditLayoutVisitor); override;
  ...
  public
    ...
    property NumberingListBox: TdxRichEditNumberingListMarkBox
      read FNumberingListBox;
    property ExtendedBoxes: TdxRichEditRowExtendedBoxes read FExtendedBoxes;
    property ModelRow: TdxRow read FRow;
  end;

  TdxRichEditLayoutRowCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditLayoutRow>);
  ...
  protected
    ...
    function GetBounds: TRect; override;
  public
    constructor Create(ATableCell: TdxTableCellViewInfo;
      const AParent: IdxRichEditLayoutElement);
    destructor Destroy; override;
    procedure Accept(AVisitor: TdxRichEditLayoutVisitor); override;
    function CreateRange: TdxRichEditFixedRange; override;
    ...
    property NestedTables: TdxRichEditLayoutTableCollection
      read GetNestedTables;
    property Borders: TdxRichEditBorders read FBorders;
    property ModelTableCell: TdxTableCellViewInfo read FTableCell;
  end;

  TdxRichEditLayoutTableCellCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditLayoutTableCell>);
  ...
  public
    constructor Create(ATableRow: TdxTableRowViewInfoBase;
      const AParent: IdxRichEditLayoutElement);
    destructor Destroy; override;
    procedure Accept(AVisitor: TdxRichEditLayoutVisitor); override;
    function CreateRange: TdxRichEditFixedRange; override;

    property TableCells: TdxRichEditLayoutTableCellCollection
      read GetTableCells;
  end;

  TdxRichEditLayoutTableRowCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditLayoutTableRow>);
  ...
  protected
    ...
    function GetBounds: TRect; override;
  public
    constructor Create(ATable: TdxTableViewInfo;
      const AParent: IdxRichEditLayoutElement);
    destructor Destroy; override;
    procedure Accept(AVisitor: TdxRichEditLayoutVisitor); override;
    function CreateRange: TdxRichEditFixedRange; override;
  ...
  TdxRichEditLayoutTableCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditLayoutTable>);
  ...
  public
    constructor Create(AModelBox: TdxModelLineNumberBox;
      const AParent: IdxRichEditLayoutElement);
    procedure Accept(AVisitor: TdxRichEditLayoutVisitor); override;
  ...
  TdxRichEditLineNumberBoxCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditLineNumberBox>);
  ...
  IdxRichEditParagraphFrameContainer = interface
    ...
    property ParagraphFrames: TdxRichEditParagraphFrameBoxCollection
      read GetParagraphFrames;
  end;

  { TdxRichEditLayoutColumn }

  TdxRichEditLayoutColumn = class(TdxRichEditRangedLayoutElementBase,
  ...
  protected
    ...
    function GetParagraphFrames: TdxRichEditParagraphFrameBoxCollection;
  public
    constructor Create(AColumn: TdxColumn;
      const AParent: IdxRichEditLayoutElement);
    destructor Destroy; override;
    procedure Accept(AVisitor: TdxRichEditLayoutVisitor); override;
    function CreateRange: TdxRichEditFixedRange; override;
    ...
    property Rows: TdxRichEditLayoutRowCollection read GetRows;
    property LineNumbers: TdxRichEditLineNumberBoxCollection
      read GetLineNumbers;
  ...
  TdxRichEditLayoutColumnCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditLayoutColumn>);
  ...
  protected
    function GetBounds: TRect; override;
  public
    constructor Create(AFloatingObject: TdxFloatingObjectBox;
      const AParent: IdxRichEditLayoutElement);
    destructor Destroy; override;
  ...
  TdxRichEditLayoutFloatingObjectCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditLayoutFloatingObject>);
  ...
  protected
    ...
    function GetFloatingObjectBoxCore(ACollection
      : TdxRichEditLayoutFloatingObjectCollection;
      AAnchorRun: TdxFloatingObjectAnchorRun): TdxRichEditLayoutFloatingObject;
  public
    constructor Create(AAnchorBox: TdxModelFloatingObjectAnchorBox;
      const ABounds: TRect; const AParent: IdxRichEditLayoutElement);
    procedure Accept(AVisitor: TdxRichEditLayoutVisitor); override;

    property FloatingObjectBox: TdxRichEditLayoutFloatingObject
      read InternalGetFloatingObjectBox;
  end;

  { TdxRichEditLayoutTextBox }

  TdxRichEditLayoutTextBox = class(TdxRichEditLayoutFloatingObject,
    IdxRichEditLayoutElement, IdxRichEditRangedLayoutElement,
    IdxPieceTableContainer, IdxRichEditParagraphFrameContainer)
  strict private
  ...
  TdxRichEditLayoutPageAreaBase = class abstract
    (TdxRichEditRangedLayoutElementBase, IdxPieceTableContainer)
  strict private
  ...
  public
    constructor Create(AComment: TdxCommentViewInfo;
      const AParent: IdxRichEditLayoutElement);
  ...
  TdxRichEditLayoutCommentCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditLayoutComment>);
  ...
  public
    constructor Create(AModelBox: TdxModelUnderlineBox;
      const AParent: IdxRichEditLayoutElement);
    destructor Destroy; override;
    procedure Accept(AVisitor: TdxRichEditLayoutVisitor); override;
  ...
  TdxRichEditUnderlineBoxCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditUnderlineBox>);
  ...
  TdxRichEditStrikeoutBoxCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditStrikeoutBox>);
  ...
  TdxRichEditErrorBoxCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditErrorBox>);
  ...
  public
    constructor Create(const AModelBox: TdxHighlightArea;
      const AParent: IdxRichEditLayoutElement);
    procedure Accept(AVisitor: TdxRichEditLayoutVisitor); override;
  end;

  TdxRichEditHighlightAreaCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditHighlightAreaBox>);
  ...
  TdxRichEditFieldHighlightAreaCollection = class
    (TdxRichEditObjectLayoutElementCollection<
    TdxRichEditFieldHighlightAreaBox>);
  ...
  TdxRichEditRangePermissionHighlightAreaCollection = class
    (TdxRichEditObjectLayoutElementCollection<
    TdxRichEditRangePermissionHighlightAreaBox>);
  ...
  TdxRichEditCommentHighlightAreaCollection = class
    (TdxRichEditObjectLayoutElementCollection<
    TdxRichEditCommentHighlightAreaBox>);
  ...
  public
    constructor Create(AModelBox: TdxVisitableDocumentIntervalBox;
      AType: TdxRichEditLayoutType; const AParent: IdxRichEditLayoutElement);
    procedure Accept(AVisitor: TdxRichEditLayoutVisitor); override;
  end;

  TdxRichEditBookmarkBoxCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditBookmarkBox>);
  ...
  TdxRichEditRangePermissionBoxCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditRangePermissionBox>);
  ...
  TdxRichEditCommentBoxCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditCommentBox>);
  ...
  public
    constructor Create(AModelBox: TdxModelHiddenTextUnderlineBox;
      const AParent: IdxRichEditLayoutElement);
    procedure Accept(AVisitor: TdxRichEditLayoutVisitor); override;
  end;

  TdxRichEditHiddenTextUnderlineBoxCollection = class
    (TdxRichEditObjectLayoutElementCollection<
    TdxRichEditHiddenTextUnderlineBox>);
  ...
  TdxRichEditLayoutFrame = class(TdxRichEditRangedLayoutElementBase,
    IdxRichEditParagraphFrameContainer, IdxPieceTableContainer)
  strict private
    FTables: TdxRichEditLayoutTableCollection;
    FRows: TdxRichEditLayoutRowCollection;
    FParagraphFrames: TdxRichEditParagraphFrameBoxCollection;
  ...
  strict private
    ...
    FRangePermissionHighlightAreas
      : TdxRichEditRangePermissionHighlightAreaCollection;
    ...
    function GetRangePermissionHighlightAreas
      : TdxRichEditRangePermissionHighlightAreaCollection;
    function GetCommentHighlightAreas
      : TdxRichEditCommentHighlightAreaCollection;
    ...
    function GetHiddenTextUnderlineBoxes
      : TdxRichEditHiddenTextUnderlineBoxCollection;
  public
    constructor Create(ABoxes: TdxModelRowExtendedBoxes;
      AParent: TdxRichEditLayoutRow);
    destructor Destroy; override;
    ...
    property HighlightAreas: TdxRichEditHighlightAreaCollection
      read GetHighlightAreas;
    property FieldHighlightAreas: TdxRichEditFieldHighlightAreaCollection
      read GetFieldHighlightAreas;
    property RangePermissionHighlightAreas
      : TdxRichEditRangePermissionHighlightAreaCollection
      read GetRangePermissionHighlightAreas;
    property CommentHighlightAreas: TdxRichEditCommentHighlightAreaCollection
      read GetCommentHighlightAreas;
    property BookmarkBoxes: TdxRichEditBookmarkBoxCollection
      read GetBookmarkBoxes;
    property RangePermissionBoxes: TdxRichEditRangePermissionBoxCollection
      read GetRangePermissionBoxes;
    property CommentBoxes: TdxRichEditCommentBoxCollection read GetCommentBoxes;
    property HiddenTextUnderlineBoxes
      : TdxRichEditHiddenTextUnderlineBoxCollection
      read GetHiddenTextUnderlineBoxes;
  end;
  ...
  protected
    ...
    function GetPieceTable: TdxPieceTable; override;
  public
    constructor Create(APageArea: TdxPageArea;
      const AParent: IdxRichEditLayoutElement);
    destructor Destroy; override;
    procedure Accept(AVisitor: TdxRichEditLayoutVisitor); override;
    ...
    property ModelLineNumberBoxes: TdxModelLineNumberBoxCollection
      read GetModelLineNumberBoxes;
  end;

  TdxRichEditLayoutPageAreaCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditLayoutPageArea>);

  TdxRichEditLayoutFrameCollection =
    TdxRichEditObjectLayoutElementCollection<TdxRichEditLayoutFrame>;
  ...
  strict private
    ...
    function GetBackgroundFloatingObjects
      : TdxRichEditLayoutFloatingObjectCollection;
    function GetFloatingObjects: TdxRichEditLayoutFloatingObjectCollection;
    function GetForegroundFloatingObjects
      : TdxRichEditLayoutFloatingObjectCollection;
    function GetIndex: Integer;
    function GetMainContentRange: TdxRichEditFixedRange;
    function CreateParagraphFrames(AModelParagraphFrames
      : TdxParagraphFrameBoxList): TdxRichEditLayoutFrameCollection;
    function GetFrames: TdxRichEditLayoutFrameCollection;
  protected
    function GetType: TdxRichEditLayoutType; override;
    function GetBounds: TRect; override;
    function CreateFloatingObjects(AModelFloatingObjects
      : TdxFloatingObjectBoxList): TdxRichEditLayoutFloatingObjectCollection;
  ...
  public
    ...
    property BackgroundFloatingObjects
      : TdxRichEditLayoutFloatingObjectCollection
      read GetBackgroundFloatingObjects;
    property FloatingObjects: TdxRichEditLayoutFloatingObjectCollection
      read GetFloatingObjects;
    property ForegroundFloatingObjects
      : TdxRichEditLayoutFloatingObjectCollection
      read GetForegroundFloatingObjects;
  ...
  TdxRichEditLayoutPageCollection = class
    (TdxRichEditObjectLayoutElementCollection<TdxRichEditLayoutPage>);

  { TdxRichEditLayoutHeaderFooterBase }

  TdxRichEditLayoutHeaderFooterBase = class abstract
    (TdxRichEditLayoutPageAreaBase)
  strict private
  ...
  protected
    ...
    property ModelHeaderFooter: TdxHeaderFooterPageAreaBase
      read FModelHeaderFooter;
  public
    constructor Create(AModelHeaderFooter: TdxHeaderFooterPageAreaBase;
      const AParent: IdxRichEditLayoutElement);
  end;
  ...
  protected
    function GetType: TdxRichEditLayoutType; override;
  public
    constructor Create(AHeader: TdxHeaderPageArea;
      const AParent: IdxRichEditLayoutElement);
    procedure Accept(AVisitor: TdxRichEditLayoutVisitor); override;
  end;
  ...
  protected
    function GetType: TdxRichEditLayoutType; override;
  public
    constructor Create(AFooter: TdxFooterPageArea;
      const AParent: IdxRichEditLayoutElement);
  ...
  public
    ...
    procedure DrawFloatingPicture(AFloatingPicture
      : TdxRichEditLayoutFloatingPicture);
    ...
    function ShouldExportRowBackground(ARowExtendedBoxes
      : TdxRichEditRowExtendedBoxes): Boolean;
    ...
    procedure DrawInlinePictureBox(AInlinePictureBox
      : TdxRichEditInlinePictureBox);
    procedure DrawFloatingObjectAnchorBox(AFloatingObjectAnchorBox
      : TdxRichEditFloatingObjectAnchorBox);
    ...
    procedure DrawNumberingListMarkBox(ANumberingListMarkBox
      : TdxRichEditNumberingListMarkBox);
    procedure DrawNumberingListWithSeparatorBox(ANumberingListWithSeparatorBox
      : TdxRichEditNumberingListWithSeparatorBox);
    procedure DrawUnderlineBoxes(AUnderlineBoxes
      : TdxRichEditUnderlineBoxCollection);
    procedure DrawStrikeoutBoxes(AStrikeoutBoxes
      : TdxRichEditStrikeoutBoxCollection);
    procedure DrawBookmarkBoxes(ABookmarkBoxes
      : TdxRichEditBookmarkBoxCollection);
    ...
    procedure DrawHighlightAreaBox(AHighlightAreaBox
      : TdxRichEditHighlightAreaBox);
    ...
    procedure DrawHiddenTextUnderlineBox(AHiddenTextUnderlineBox
      : TdxRichEditHiddenTextUnderlineBox);
    procedure DrawLineNumberBox(ALineNumberBox: TdxRichEditLineNumberBox);
    procedure DrawFieldHighlightAreaBox(AFieldHighlightAreaBox
      : TdxRichEditFieldHighlightAreaBox);
    procedure DrawRangePermissionHighlightAreaBox
      (ARangePermissionHighlightAreaBox
      : TdxRichEditRangePermissionHighlightAreaBox);
    procedure DrawRangePermissionStartBox(ARangePermissionStartBox
      : TdxRichEditRangePermissionBox);
    procedure DrawRangePermissionEndBox(ARangePermissionEndBox
      : TdxRichEditRangePermissionBox);
    procedure DrawCommentHighlightAreaBox(ACommentHighlightAreaBox
      : TdxRichEditCommentHighlightAreaBox);
  ...
  protected
    ...
    procedure VisitFloatingPicture(AFloatingPicture
      : TdxRichEditLayoutFloatingPicture); virtual;
    ...
    procedure VisitRowBackground(ARowExtendedBoxes
      : TdxRichEditRowExtendedBoxes); virtual;
    procedure VisitRow(ARow: TdxRichEditLayoutRow); virtual;
    procedure VisitUnderlineBoxes(AUnderlineBoxes
      : TdxRichEditUnderlineBoxCollection); virtual;
    procedure VisitStrikeoutBoxes(AStrikeoutBoxes
      : TdxRichEditStrikeoutBoxCollection); virtual;
    procedure VisitErrorBoxes(AErrorBoxes
      : TdxRichEditErrorBoxCollection); virtual;
    procedure VisitBookmarkBoxes(ABookmarkBoxes
      : TdxRichEditBookmarkBoxCollection); virtual;
    procedure VisitPlainTextBox(APlainTextBox
      : TdxRichEditPlainTextBox); virtual;
    procedure VisitSpecialTextBox(ASpecialTextBox
      : TdxRichEditPlainTextBox); virtual;
    procedure VisitInlinePictureBox(AInlinePictureBox
      : TdxRichEditInlinePictureBox); virtual;
    procedure VisitFloatingObjectAnchorBox(AFloatingObjectAnchorBox
      : TdxRichEditFloatingObjectAnchorBox); virtual;
    procedure VisitSpaceBox(ASpaceBox: TdxRichEditPlainTextBox); virtual;
    procedure VisitParagraphMarkBox(AParagraphMarkBox
      : TdxRichEditPlainTextBox); virtual;
    procedure VisitSectionBreakBox(ASectionBreakBox
      : TdxRichEditPlainTextBox); virtual;
    procedure VisitLineBreakBox(ALineBreakBox
      : TdxRichEditPlainTextBox); virtual;
    procedure VisitPageBreakBox(APageBreakBox
      : TdxRichEditPlainTextBox); virtual;
    procedure VisitColumnBreakBox(AColumnBreakBox
      : TdxRichEditPlainTextBox); virtual;
    ...
    procedure VisitPageNumberBox(APageNumberBox
      : TdxRichEditPlainTextBox); virtual;
    procedure VisitNumberingListMarkBox(ANumberingListMarkBox
      : TdxRichEditNumberingListMarkBox); virtual;
    procedure VisitNumberingListWithSeparatorBox(ANumberingListWithSeparatorBox
      : TdxRichEditNumberingListWithSeparatorBox); virtual;
    procedure VisitUnderlineBox(AUnderlineBox
      : TdxRichEditUnderlineBox); virtual;
    procedure VisitStrikeoutBox(AStrikeoutBox
      : TdxRichEditStrikeoutBox); virtual;
    procedure VisitErrorBox(AErrorBox: TdxRichEditErrorBox); virtual;
    procedure VisitHighlightAreaBox(AHighlightAreaBox
      : TdxRichEditHighlightAreaBox); virtual;
    procedure VisitBookmarkStartBox(ABookmarkStartBox
      : TdxRichEditBookmarkBox); virtual;
    procedure VisitBookmarkEndBox(ABookmarkEndBox
      : TdxRichEditBookmarkBox); virtual;
    procedure VisitHiddenTextUnderlineBox(AHiddenTextUnderlineBox
      : TdxRichEditHiddenTextUnderlineBox); virtual;
    procedure VisitLineNumberBox(ALineNumberBox
      : TdxRichEditLineNumberBox); virtual;
    procedure VisitFieldHighlightAreaBox(AFieldHighlightAreaBox
      : TdxRichEditFieldHighlightAreaBox); virtual;
    procedure VisitRangePermissionHighlightAreaBox
      (ARangePermissionHighlightAreaBox
      : TdxRichEditRangePermissionHighlightAreaBox); virtual;
    procedure VisitRangePermissionStartBox(ARangePermissionStartBox
      : TdxRichEditRangePermissionBox); virtual;
    procedure VisitRangePermissionEndBox(ARangePermissionEndBox
      : TdxRichEditRangePermissionBox); virtual;
    procedure VisitCommentHighlightAreaBox(ACommentHighlightAreaBox
      : TdxRichEditCommentHighlightAreaBox); virtual;
    procedure VisitCommentStartBox(ACommentStartBox
      : TdxRichEditCommentBox); virtual;
    procedure VisitCommentEndBox(ACommentEndBox
      : TdxRichEditCommentBox); virtual;
    procedure VisitFrame(AFrame: TdxRichEditLayoutFrame); virtual;
    procedure VisitParagraphFrameBox(AParagraphFrameBox
      : TdxRichEditParagraphFrameBox); virtual;
    procedure VisitLayoutElementsCollection(ACollection
      : TdxRichEditLayoutElementCollection);
    procedure VisitLayoutRowCollection(ACollection
      : TdxRichEditLayoutRowCollection);
    procedure VisitParagraphFrameBoxes(const AParagraphFrameContainer
      : IdxRichEditParagraphFrameContainer;
      const ARowParent: IdxRichEditLayoutElement); virtual;
    procedure VisitArea(AArea: TdxRichEditLayoutPageAreaBase);
    procedure VisitFloatingObjects(ACollection
      : TdxRichEditLayoutFloatingObjectCollection; APieceTable: TdxPieceTable);
    procedure VisitFrames(ACollection: TdxRichEditLayoutFrameCollection;
  ...
  protected
    ...
    procedure InitializePages(ADocumentLayout: TdxModelDocumentLayout;
      APageIndex: Integer);

    property Pages: TdxRichEditLayoutPageCollection read FPages;
    property DocumentFormattedResetEvent: TSimpleEvent
      read GetDocumentFormattedResetEvent;
  public
    constructor Create(const AProvider: IdxRichEditDocumentLayoutProvider);
    destructor Destroy; override;
    procedure RaiseDocumentLayoutInvalidated
    ...
    procedure OnDocumentLayoutInvalidated(ASender: TObject;
      E: TdxDocumentLayoutInvalidatedEventArgs);
    ...
    function GetPageCore(APageIndex: Integer;
      ADocumentLayout: TdxModelDocumentLayout): TdxRichEditLayoutPage;
    procedure ThrowNullCallbackException; virtual;
    procedure ThrowInvalidAsyncOperationException; virtual;
    function TryGetPageAsyncSynchronously(APageIndex: Integer)
      : TdxRichEditLayoutPage;
    ...
    class function GetElementFromPage(APosition: Integer; AClass: TClass;
      APieceTable: TdxPieceTable; APage: TdxRichEditLayoutPage)
      : TObject; static;

    property DocumentLayoutInvalidated: TdxDocumentLayoutInvalidatedEventHandler
      read FDocumentLayoutInvalidated;
    ...
    property IsDocumentFormattingCompleted: Boolean
      read FIsDocumentFormattingCompleted write FIsDocumentFormattingCompleted;
    property Document: IdxRichEditDocument read GetDocument;
  end;
...
type
  ...
  TdxRichEditLayoutRowExporter = class(TcxIUnknownObject,
    IdxSimpleDocumentLayoutExporter, IdxDocumentLayoutExporter)
  strict private
    FRow: TdxRichEditLayoutRow;
    FBoxes: TdxRichEditBoxCollection;
  public
    constructor Create(ARow: TdxRichEditLayoutRow);
    procedure AddAnchorBox(ABox: TdxModelBox;
      ACollection: TdxSimpleParagraphBoxCollection);
    function GetBoxIndex(ABox: TdxModelBox;
      ACollection: TdxSimpleParagraphBoxCollection): Integer;
    ...
    procedure ExportParagraphFramePage(APage: TdxPage;
      const APageClipBounds: TdxRectF; AExportContent: Boolean);
    ...
    procedure ExportUnderlineBox(ARow: TdxSimpleRow;
      AUnderlineBox: TdxModelUnderlineBox);
    procedure ExportStrikeoutBox(ARow: TdxSimpleRow;
      AStrikeoutBox: TdxModelUnderlineBox);
    ...
    procedure ExportTableBorder(ABorder: TdxTableBorderViewInfoBase;
      const ACellBounds: TRect);
    procedure ExportTableBorderCorner(ACorner: TdxCornerViewInfoBase;
      X: Integer; Y: Integer);
    ...
    function IsAnchorVisible(const AAnchor: TdxTableCellVerticalAnchor)
      : Boolean;
  ...
  protected
    ...
    procedure VisitRowBackground(ARowExtendedBoxes
      : TdxRichEditRowExtendedBoxes); override;
    procedure VisitRow(ARow: TdxRichEditLayoutRow); override;
    procedure VisitUnderlineBoxes(AUnderlineBoxes
      : TdxRichEditUnderlineBoxCollection); override;
    procedure VisitStrikeoutBoxes(AStrikeoutBoxes
      : TdxRichEditStrikeoutBoxCollection); override;
    procedure VisitBookmarkBoxes(ABookmarkBoxes
      : TdxRichEditBookmarkBoxCollection); override;
    ...
    procedure VisitFloatingPicture(AFloatingPicture
      : TdxRichEditLayoutFloatingPicture); override;
    procedure VisitPlainTextBox(APlainTextBox
      : TdxRichEditPlainTextBox); override;
    procedure VisitSpecialTextBox(ASpecialTextBox
      : TdxRichEditPlainTextBox); override;
    procedure VisitInlinePictureBox(AInlinePictureBox
      : TdxRichEditInlinePictureBox); override;
    procedure VisitFloatingObjectAnchorBox(AFloatingObjectAnchorBox
      : TdxRichEditFloatingObjectAnchorBox); override;
    ...
    procedure VisitPageNumberBox(APageNumberBox
      : TdxRichEditPlainTextBox); override;
    procedure VisitNumberingListMarkBox(ANumberingListMarkBox
      : TdxRichEditNumberingListMarkBox); override;
    procedure VisitNumberingListWithSeparatorBox(ANumberingListWithSeparatorBox
      : TdxRichEditNumberingListWithSeparatorBox); override;
    procedure VisitUnderlineBox(AUnderlineBox
      : TdxRichEditUnderlineBox); override;
    procedure VisitStrikeoutBox(AStrikeoutBox
      : TdxRichEditStrikeoutBox); override;
    procedure VisitErrorBox(AErrorBox: TdxRichEditErrorBox); override;
    procedure VisitHighlightAreaBox(AHighlightAreaBox
      : TdxRichEditHighlightAreaBox); override;
    procedure VisitBookmarkStartBox(ABookmarkStartBox
      : TdxRichEditBookmarkBox); override;
    procedure VisitBookmarkEndBox(ABookmarkEndBox
      : TdxRichEditBookmarkBox); override;
    procedure VisitHiddenTextUnderlineBox(AHiddenTextUnderlineBox
      : TdxRichEditHiddenTextUnderlineBox); override;
    procedure VisitLineNumberBox(ALineNumberBox
      : TdxRichEditLineNumberBox); override;
    procedure VisitFieldHighlightAreaBox(AFieldHighlightAreaBox
      : TdxRichEditFieldHighlightAreaBox); override;
    procedure VisitRangePermissionHighlightAreaBox
      (ARangePermissionHighlightAreaBox
      : TdxRichEditRangePermissionHighlightAreaBox); override;
    procedure VisitRangePermissionStartBox(ARangePermissionStartBox
      : TdxRichEditRangePermissionBox); override;
    procedure VisitRangePermissionEndBox(ARangePermissionEndBox
      : TdxRichEditRangePermissionBox); override;
    procedure VisitCommentHighlightAreaBox(ACommentHighlightAreaBox
      : TdxRichEditCommentHighlightAreaBox); override;
    procedure VisitCommentStartBox(ACommentStartBox
      : TdxRichEditCommentBox); override;
    procedure VisitCommentEndBox(ACommentEndBox
      : TdxRichEditCommentBox); override;
    procedure VisitFrame(AFrame: TdxRichEditLayoutFrame); override;
    procedure VisitParagraphFrameBox(AParagraphFrameBox
      : TdxRichEditParagraphFrameBox); override;
    ...
    procedure DefaultVisitRowBackground(ARowExtendedBoxes
      : TdxRichEditRowExtendedBoxes);
    procedure DefaultVisitRow(ARow: TdxRichEditLayoutRow);
    procedure DefaultVisitUnderlineBoxes(AUnderlineBoxes
      : TdxRichEditUnderlineBoxCollection);
    procedure DefaultVisitStrikeoutBoxes(AStrikeoutBoxes
      : TdxRichEditStrikeoutBoxCollection);
    procedure DefaultVisitBookmarkBoxes(ABookmarkBoxes
      : TdxRichEditBookmarkBoxCollection);
  public
  ...
  strict private
    ...
    procedure OffsetBounds(ABox: TdxRichEditLayoutElementBase;
      AXOffset: Integer; AYOffset: Integer); overload;
  ...
  protected type
    ...
    protected
      ...
      procedure VisitTable(ATable: TdxRichEditLayoutTable); override;
      procedure VisitTableRow(ATableRow: TdxRichEditLayoutTableRow); override;
      procedure VisitTableCell(ATableCell: TdxRichEditLayoutTableCell);
        override;
      procedure VisitParagraphFrameBoxes(const AParagraphFrameContainer
        : IdxRichEditParagraphFrameContainer;
  ...
  protected
    class function CalculateLayoutBorderThickness(ABorderWidth: Integer;
      AConverter: TdxDocumentModelUnitToLayoutUnitConverter): Integer; static;
  public
    class function CreateLayoutRowCollection(AModelRows: TdxRowCollection;
      const AParent: IdxRichEditLayoutElement; AIsTableCellRow: Boolean)
      : TdxRichEditLayoutRowCollection; static;
    class procedure InitializeRowCollection(AModelRows: TdxRowCollection;
      ALayoutRows: TdxRichEditLayoutRowCollection;
      const AParent: IdxRichEditLayoutElement); static;
    class procedure InitializeTableCellRowCollection
      (AModelRows: TdxRowCollection;
      ALayoutRows: TdxRichEditLayoutRowCollection;
      const AParent: IdxRichEditLayoutElement); static;
    class function CreateLayoutTableCollection(AModelTables
      : TdxTableViewInfoCollection; const AParent: IdxRichEditLayoutElement)
      : TdxRichEditLayoutTableCollection; static;
    class function CreateBorders(const AElement: IdxRichEditLayoutElement;
      ALeftBorder, ARightBorder, ATopBorder, ABottomBorder: TdxBorderInfo)
      : TdxRichEditBorders; static;
    class function GetRangeForTablesAndRowsContainer
      (ARows: TdxRichEditLayoutRowCollection;
      ATables: TdxRichEditLayoutTableCollection): TdxRichEditFixedRange; static;
    class function GetRangeFromRowByCoordinates(ARow: TdxRichEditLayoutRow;
      AX1: Integer; AX2: Integer): TdxRichEditFixedRange; static;
    class function CreateParagraphFrameBoxCollection(AModelColumn: TdxColumn;
      const AElement: IdxRichEditLayoutElement)
      : TdxRichEditParagraphFrameBoxCollection; static;
  end;
  ...
  protected
    ...
    function IsInSearchingDocument(const AContainer
      : IdxPieceTableContainer): Boolean;
  public
    ...
    property Comparison: TdxFunc<IdxRichEditRangedLayoutElement, Boolean>
      read FComparison;
    property FoundElement: IdxRichEditRangedLayoutElement read FFoundElement;
  end;

function TdxRichEditPagePainterHelper.GetExporter
  : TdxDocumentLayoutExporterAccess;
begin
...
constructor TdxRichEditLayoutBorder.Create(AColor: TdxAlphaColor;
  AStyle: TdxRichEditTableBorderLineStyle; AThickness: Integer);
begin
  FColor := AColor;
  FStyle := AStyle;
...
constructor TdxRichEditBorders.Create(const ALeft, ARight, ATop,
  ABottom: TdxRichEditLayoutBorder);
begin
  FLeft := ALeft;
  FRight := ARight;
...
constructor TdxRichEditBeforePagePaintEventArgs.Create
  (APainter: TdxRichEditPagePainter; APageIndex: Integer);
begin
  inherited Create;
  FPainter := APainter;
...
constructor TdxRichEditLayoutElementBase.Create(const AParent
  : IdxRichEditLayoutElement);
begin
  inherited Create;
  FParent := AParent;
...
function TdxRichEditLayoutElementBase.GetParentByIntf(const IID: TGUID)
  : IUnknown;
begin
...
function TdxRichEditLayoutElementBase.GetParentByIntfCore(const IID: TGUID;
  const AParent: IdxRichEditLayoutElement): IUnknown;
begin
  if AParent = nil then
    Exit(nil);
...
function TdxRichEditLayoutElementBase.GetRelativeBounds(const AElement
  : IdxRichEditLayoutElement): TRect;
begin
  Result.Empty;
...
begin
  ...
  FBorders := TdxRichEditDocumentLayoutHelper.CreateBorders(Self,
    AParagraph.LeftBorder, AParagraph.RightBorder, AParagraph.TopBorder,
    AParagraph.BottomBorder);
end;
...
procedure TdxRichEditParagraphFrameBox.Accept
  (AVisitor: TdxRichEditLayoutVisitor);
begin
...
constructor TdxRichEditBox.Create(ABox: TdxModelBox;
  AType: TdxRichEditLayoutType; const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
  FBox := ABox;
...
var
  ...
  AStart, AEnd: Integer;
begin
  AContainer := GetParentByIntf(IdxPieceTableContainer)
    as IdxPieceTableContainer;
  AStartPosition := TdxDocumentModelPosition.FromRunStart(AContainer.PieceTable,
    FBox.StartPos.RunIndex);
  AEndPosition := TdxDocumentModelPosition.FromRunStart(AContainer.PieceTable,
    FBox.EndPos.RunIndex);
...
constructor TdxRichEditLayoutPage.Create(APage: TdxPage;
  const ADocument: IdxRichEditDocument);
begin
...
function TdxRichEditLayoutPage.GetPageAreas
  : TdxRichEditLayoutPageAreaCollection;
var
  I: Integer;
begin
...
function TdxRichEditLayoutPage.GetBackgroundFloatingObjects
  : TdxRichEditLayoutFloatingObjectCollection;
begin
  if FBackgroundFloatingObjects = nil then
    FBackgroundFloatingObjects := CreateFloatingObjects
      (FPage.BackgroundFloatingObjects);
  Result := FBackgroundFloatingObjects;
end;

function TdxRichEditLayoutPage.GetFloatingObjects
  : TdxRichEditLayoutFloatingObjectCollection;
begin
...
function TdxRichEditLayoutPage.GetForegroundFloatingObjects
  : TdxRichEditLayoutFloatingObjectCollection;
begin
  if FForegroundFloatingObjects = nil then
    FForegroundFloatingObjects := CreateFloatingObjects
      (FPage.ForegroundFloatingObjects);
...
function TdxRichEditLayoutPage.CreateParagraphFrames(AModelParagraphFrames
  : TdxParagraphFrameBoxList): TdxRichEditLayoutFrameCollection;
var
  I: Integer;
begin
...
function TdxRichEditLayoutPage.CreateFloatingObjects(AModelFloatingObjects
  : TdxFloatingObjectBoxList): TdxRichEditLayoutFloatingObjectCollection;
var
  I: Integer;
...
begin
  ...
  begin
    ...
    if ACurrentFloatingObject.DocumentLayout <> nil then
      ...
      Result.Add(TdxRichEditLayoutFloatingPicture.Create
        (ACurrentFloatingObject, Self));
  end;
end;
...
constructor TdxRichEditLayoutColumn.Create(AColumn: TdxColumn;
  const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
  FColumn := AColumn;
...
begin
  if FTables = nil then
    FTables := TdxRichEditDocumentLayoutHelper.CreateLayoutTableCollection
      (ModelTables, Self);
  Result := FTables;
end;
...
begin
  if FRows = nil then
    FRows := TdxRichEditDocumentLayoutHelper.CreateLayoutRowCollection
      (ModelRows, Self, False);
  Result := FRows;
end;

function TdxRichEditLayoutColumn.GetLineNumbers
  : TdxRichEditLineNumberBoxCollection;
var
  I: Integer;
...
function TdxRichEditLayoutColumn.GetParagraphFrames
  : TdxRichEditParagraphFrameBoxCollection;
begin
  if FParagraphFrames = nil then
    FParagraphFrames := TdxRichEditDocumentLayoutHelper.
      CreateParagraphFrameBoxCollection(ModelColumn, Self);
...
begin
  Result := TdxRichEditDocumentLayoutHelper.GetRangeForTablesAndRowsContainer
    (Rows, Tables);
end;
...
function TdxRichEditFixedRange.Intersect(ARange: TdxRichEditFixedRange)
  : Boolean;
begin
...
begin
  if FText = '' then
  begin
    AParent := GetParentByIntf(IdxPieceTableContainer)
      as IdxPieceTableContainer;
...
constructor TdxRichEditInlinePictureBox.Create(ABox: TdxModelInlinePictureBox;
  const AParent: IdxRichEditLayoutElement);
begin
...
begin
  ...
  begin
    AParent := GetParentByIntf(IdxPieceTableContainer)
      as IdxPieceTableContainer;
    FImage := (TdxModelInlinePictureBox(ModelBox))
      .GetImage(AParent.PieceTable, True);
  end;
  Result := FImage;
end;

procedure TdxRichEditInlinePictureBox.Accept
  (AVisitor: TdxRichEditLayoutVisitor);
begin
...
constructor TdxRichEditFloatingObjectAnchorBox.Create
  (AAnchorBox: TdxModelFloatingObjectAnchorBox; const ABounds: TRect;
  const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AAnchorBox,
    TdxRichEditLayoutType.FloatingObjectAnchorBox, AParent);
  FBounds := ABounds;
end;

function TdxRichEditFloatingObjectAnchorBox.InternalGetFloatingObjectBox
  : TdxRichEditLayoutFloatingObject;
begin
...
function TdxRichEditFloatingObjectAnchorBox.GetFloatingObjectBox
  : TdxRichEditLayoutFloatingObject;
var
...
begin
  ...
  APieceTableContainer := GetParentByIntf(IdxPieceTableContainer)
    as IdxPieceTableContainer;
  AAnchorRun := TdxFloatingObjectAnchorRun
    (ModelBox.GetRun(APieceTableContainer.PieceTable));

  if AAnchorRun.FloatingObjectProperties.TextWrapType <>
...
function TdxRichEditFloatingObjectAnchorBox.GetFloatingObjectBoxCore
  (ACollection: TdxRichEditLayoutFloatingObjectCollection;
  AAnchorRun: TdxFloatingObjectAnchorRun): TdxRichEditLayoutFloatingObject;
var
  I: Integer;
begin
...
procedure TdxRichEditFloatingObjectAnchorBox.Accept
  (AVisitor: TdxRichEditLayoutVisitor);
begin
...
constructor TdxRichEditNumberingListMarkBox.Create(ABox: TdxNumberingListBox;
  const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
  FListIndex := -1;
...
procedure TdxRichEditNumberingListMarkBox.Accept
  (AVisitor: TdxRichEditLayoutVisitor);
begin
...
constructor TdxRichEditNumberingListWithSeparatorBox.Create
  (ABox: TdxNumberingListBoxWithSeparator;
  const AParent: IdxRichEditLayoutElement);
var
...
begin
  ...
  ASeparatorBounds := TRect.CreateSize(FSeparator.Bounds.X, ABox.Bounds.Y,
    FSeparator.Bounds.Width, ABox.Bounds.Height);
...
function TdxRichEditNumberingListWithSeparatorBox.GetType
  : TdxRichEditLayoutType;
begin
  Result := TdxRichEditLayoutType.NumberingListWithSeparatorBox;
end;

procedure TdxRichEditNumberingListWithSeparatorBox.Accept
  (AVisitor: TdxRichEditLayoutVisitor);
begin
...
constructor TdxRichEditRowExtendedBoxes.Create(ABoxes: TdxModelRowExtendedBoxes;
  AParent: TdxRichEditLayoutRow);
begin
  inherited Create;
  FBoxes := ABoxes;
...
function TdxRichEditRowExtendedBoxes.GetUnderlines
  : TdxRichEditUnderlineBoxCollection;
var
  I: Integer;
begin
  ...
  begin
    ...
    for I := 0 to FBoxes.Underlines.Count - 1 do
      FUnderlines.Add(TdxRichEditUnderlineBox.Create(FBoxes.Underlines[I],
        FParent));
  end;
  Result := FUnderlines;
end;
...
function TdxRichEditRowExtendedBoxes.GetStrikeouts
  : TdxRichEditStrikeoutBoxCollection;
var
  I: Integer;
begin
  ...
  begin
    ...
    for I := 0 to FBoxes.Strikeouts.Count - 1 do
      FStrikeouts.Add(TdxRichEditStrikeoutBox.Create(FBoxes.Strikeouts[I],
        FParent));
  end;
  Result := FStrikeouts;
end;

function TdxRichEditRowExtendedBoxes.GetHighlightAreas
  : TdxRichEditHighlightAreaCollection;
var
  I: Integer;
begin
  ...
  begin
    ...
    for I := 0 to FBoxes.HighlightAreas.Count - 1 do
      FHighlightAreas.Add(TdxRichEditHighlightAreaBox.Create
        (FBoxes.HighlightAreas[I], FParent));
  end;
  Result := FHighlightAreas;
end;

function TdxRichEditRowExtendedBoxes.GetFieldHighlightAreas
  : TdxRichEditFieldHighlightAreaCollection;
var
  I: Integer;
begin
  ...
  begin
    ...
    for I := 0 to FBoxes.FieldHighlightAreas.Count - 1 do
      FFieldHighlightAreas.Add(TdxRichEditFieldHighlightAreaBox.Create
        (FBoxes.FieldHighlightAreas[I], FParent));
  end;
  Result := FFieldHighlightAreas;
end;

function TdxRichEditRowExtendedBoxes.GetRangePermissionHighlightAreas
  : TdxRichEditRangePermissionHighlightAreaCollection;
var
  I: Integer;
begin
  ...
  begin
    FRangePermissionHighlightAreas :=
      TdxRichEditRangePermissionHighlightAreaCollection.Create;
    for I := 0 to FBoxes.RangePermissionHighlightAreas.Count - 1 do
      FRangePermissionHighlightAreas.Add
        (TdxRichEditRangePermissionHighlightAreaBox.Create
        (FBoxes.RangePermissionHighlightAreas[I], FParent));
  end;
  Result := FRangePermissionHighlightAreas;
end;

function TdxRichEditRowExtendedBoxes.GetCommentHighlightAreas
  : TdxRichEditCommentHighlightAreaCollection;
var
  I: Integer;
begin
  ...
  begin
    ...
    for I := 0 to FBoxes.CommentHighlightAreas.Count - 1 do
      FCommentHighlightAreas.Add(TdxRichEditCommentHighlightAreaBox.Create
        (FBoxes.CommentHighlightAreas[I], FParent));
  end;
  Result := FCommentHighlightAreas;
end;

function TdxRichEditRowExtendedBoxes.GetBookmarkBoxes
  : TdxRichEditBookmarkBoxCollection;
var
  I: Integer;
begin
  ...
  begin
    ...
    begin
      if FBoxes.BookmarkBoxes[I] is TdxBookmarkStartBox then
        FBookmarkBoxes.Add(TdxRichEditBookmarkBox.Create(FBoxes.BookmarkBoxes
          [I], TdxRichEditLayoutType.BookmarkStartBox, FParent))
      else
        FBookmarkBoxes.Add(TdxRichEditBookmarkBox.Create(FBoxes.BookmarkBoxes
          [I], TdxRichEditLayoutType.BookmarkEndBox, FParent));
    end;
  end;
  Result := FBookmarkBoxes;
end;

function TdxRichEditRowExtendedBoxes.GetRangePermissionBoxes
  : TdxRichEditRangePermissionBoxCollection;
var
  I: Integer;
begin
  ...
  begin
    ...
    begin
      if FBoxes.RangePermissionBoxes[I] is TdxBookmarkStartBox then
        FRangePermissionBoxes.Add(TdxRichEditRangePermissionBox.Create
          (FBoxes.RangePermissionBoxes[I],
...
function TdxRichEditRowExtendedBoxes.GetCommentBoxes
  : TdxRichEditCommentBoxCollection;
begin
...
function TdxRichEditRowExtendedBoxes.GetHiddenTextUnderlineBoxes
  : TdxRichEditHiddenTextUnderlineBoxCollection;
var
  I: Integer;
begin
  ...
  begin
    FHiddenTextUnderlineBoxes :=
      TdxRichEditHiddenTextUnderlineBoxCollection.Create;
    for I := 0 to FBoxes.HiddenTextBoxes.Count - 1 do
      FHiddenTextUnderlineBoxes.Add(TdxRichEditHiddenTextUnderlineBox.Create
        (FBoxes.HiddenTextBoxes[I], FParent));
  end;
...
constructor TdxRichEditLayoutRow.Create(ARow: TdxRow;
  const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
  FRow := ARow;
  ...
  FExtendedBoxes := TdxRichEditRowExtendedBoxes.Create
    (ARow.ExtendedBoxes, Self);
end;
...
begin
  ...
  begin
    ABoxWithSeparator := Safe<TdxNumberingListBoxWithSeparator>.Cast
      (FRow.NumberingListBox);
    if ABoxWithSeparator <> nil then
      FNumberingListBox := TdxRichEditNumberingListWithSeparatorBox.Create
        (ABoxWithSeparator, Self)
    else
      FNumberingListBox := TdxRichEditNumberingListMarkBox.Create
        (FRow.NumberingListBox, Self);
  end;
end;
...
begin
  ...
  Result := TdxRichEditFixedRange.Create(AFirstBoxRangeStart,
    ALastBoxRangeEnd - AFirstBoxRangeStart);
end;

{ TdxRichEditLayoutTableCell }

constructor TdxRichEditLayoutTableCell.Create(ATableCell: TdxTableCellViewInfo;
  const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
  FTableCell := ATableCell;
  FBorders := TdxRichEditDocumentLayoutHelper.CreateBorders(Self,
    ATableCell.LeftBorder.Info, ATableCell.RightBorder.Info,
...
function TdxRichEditLayoutTableCell.GetNestedTables
  : TdxRichEditLayoutTableCollection;
var
  I: Integer;
begin
  ...
  begin
    ...
    for I := 0 to FTableCell.InnerTables.Count - 1 do
      FNestedTables.Add(TdxRichEditLayoutTable.Create(FTableCell.InnerTables
        [I], Self));
  end;
...
begin
  ...
  AStartPosition := TdxDocumentModelPosition.FromRunStart(AContainer.PieceTable,
    AFistParagraph.FirstRunIndex);
  AEndPosition := TdxDocumentModelPosition.FromRunStart(AContainer.PieceTable,
    ALastParagraph.LastRunIndex);
...
constructor TdxRichEditLayoutTableRow.Create(ATableRow: TdxTableRowViewInfoBase;
  const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
...
function TdxRichEditLayoutTableRow.GetTableCells
  : TdxRichEditLayoutTableCellCollection;
var
  I: Integer;
...
begin
  ...
  ALastTableCellRangeEnd := ALastTableCellRange.Start +
    ALastTableCellRange.Length;
  Result := TdxRichEditFixedRange.Create(AFirstTableCellRangeStart,
    ALastTableCellRangeEnd - AFirstTableCellRangeStart);
end;

{ TdxRichEditLayoutTable }

constructor TdxRichEditLayoutTable.Create(ATable: TdxTableViewInfo;
  const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
  FTable := ATable;
  FBorders := TdxRichEditDocumentLayoutHelper.CreateBorders(Self,
    ATable.GetActualLeftBorder.Info, ATable.GetActualRightBorder.Info,
    ATable.GetActualTopBorder.Info, ATable.GetActualBottomBorder.Info);
end;
...
function TdxRichEditLayoutTable.GetTableRows
  : TdxRichEditLayoutTableRowCollection;
var
  I: Integer;
begin
...
begin
  ...
  Result := TRect.CreateSize(AFirstCellBounds.X, AFirstCellBounds.Y,
    AWidth, AHeight);
end;
...
begin
  ...
  Result := TdxRichEditFixedRange.Create(AFirstTableRowRangeStart,
    ALastTableRowRangeEnd - AFirstTableRowRangeStart);
end;

{ TdxRichEditLayoutFloatingObject }

constructor TdxRichEditLayoutFloatingObject.Create(AFloatingObject
  : TdxFloatingObjectBox; const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
...
function TdxRichEditLayoutFloatingObject.GetAnchorBox
  : TdxRichEditFloatingObjectAnchorBox;
var
...
begin
  ...
  begin
    AModelPosition := TdxDocumentModelPosition.FromRunStart
      (ModelFloatingObject.PieceTable, AnchorRun.GetRunIndex);
    APosition := AModelPosition.LogPosition;
    APage := GetParentByType<TdxRichEditLayoutPage>;
    FAnchorBox := TdxRichEditDocumentLayout.GetElementFromPage(APosition,
      TdxRichEditFloatingObjectAnchorBox,
      TdxNativeSubDocumentBase(APage.Document).PieceTable, APage)
      as TdxRichEditFloatingObjectAnchorBox;
  end;
  Result := FAnchorBox;
end;

function TdxRichEditLayoutFloatingObject.GetAnchorRun
...
function TdxRichEditLayoutFloatingObject.GetCoordinatesCore
  (const ABounds: TRect): TArray<TPoint>;
var
  AMatrix: TdxTransformMatrix;
begin
  AMatrix := TdxTransformMatrix.Create;
  try
    AMatrix.Rotate(ModelFloatingObject.PieceTable.DocumentModel.UnitConverter.
      ModelUnitsToDegreeF(AnchorRun.Shape.Rotation));
    Result := TArray<TPoint>.Create(AMatrix.TransformPoint(ABounds.Location),
...
constructor TdxRichEditLayoutTextBox.Create(AFloatingObject
  : TdxFloatingObjectBox; const AParent: IdxRichEditLayoutElement);
begin
...
function TdxRichEditLayoutTextBox.GetParagraphFrames
  : TdxRichEditParagraphFrameBoxCollection;
begin
  if FParagraphFrames = nil then
  begin
    FParagraphFrames := TdxRichEditDocumentLayoutHelper.
      CreateParagraphFrameBoxCollection(ModelFloatingObject.DocumentLayout.Pages
      [0].Areas[0].Columns[0], Self);
  end;
  Result := FParagraphFrames;
end;
...
begin
  if FTables = nil then
  begin
    AModelCollection := ModelFloatingObject.DocumentLayout.Pages[0].Areas[0]
      .Columns[0].Tables;
    FTables := TdxRichEditDocumentLayoutHelper.CreateLayoutTableCollection
      (AModelCollection, Self);
  end;
  Result := FTables;
end;
...
begin
  ...
  begin
    APage := GetParentByType<TdxRichEditLayoutPage>;
    AStartPos := ModelFloatingObject.GetFirstPosition
      (ModelFloatingObject.PieceTable);
...
begin
  if FRange = nil then
    FRange := TdxRichEditDocumentLayoutHelper.GetRangeForTablesAndRowsContainer
      (Rows, Tables);
  Result := FRange;
end;
...
begin
  Result := TdxPieceTable(TdxTextBoxFloatingObjectContent(AnchorRun.Content)
    .TextBox.PieceTable);
end;
...
procedure TdxRichEditLayoutFloatingPicture.Accept
  (AVisitor: TdxRichEditLayoutVisitor);
begin
...
constructor TdxRichEditCommentVisitor.Create
  (AComment: TdxRichEditLayoutComment);
begin
  FComment := AComment;
end;

procedure TdxRichEditCommentVisitor.OffsetBounds
  (ABox: TdxRichEditLayoutElementBase; AXOffset: Integer; AYOffset: Integer);
var
...
procedure TdxRichEditCommentVisitor.OffsetBounds
  (ABox: TdxRichEditLayoutElementBase);
begin
  OffsetBounds(ABox, FComment.ContentBounds.X, FComment.ContentBounds.Y);
end;

procedure TdxRichEditCommentVisitor.VisitColumn
...
procedure TdxRichEditCommentVisitor.VisitBookmarkEndBox(ABookmarkEndBox
  : TdxRichEditBookmarkBox);
begin
...
procedure TdxRichEditCommentVisitor.VisitBookmarkStartBox(ABookmarkStartBox
  : TdxRichEditBookmarkBox);
begin
...
procedure TdxRichEditCommentVisitor.VisitRangePermissionHighlightAreaBox
  (ARangePermissionHighlightAreaBox
  : TdxRichEditRangePermissionHighlightAreaBox);
begin
  OffsetBounds(ARangePermissionHighlightAreaBox);
  inherited VisitRangePermissionHighlightAreaBox
    (ARangePermissionHighlightAreaBox);
end;

procedure TdxRichEditCommentVisitor.VisitRangePermissionStartBox
  (ARangePermissionStartBox: TdxRichEditRangePermissionBox);
begin
...
procedure TdxRichEditCommentVisitor.VisitRangePermissionEndBox
  (ARangePermissionEndBox: TdxRichEditRangePermissionBox);
begin
...
procedure TdxRichEditCommentVisitor.VisitFieldHighlightAreaBox
  (AFieldHighlightAreaBox: TdxRichEditFieldHighlightAreaBox);
begin
  OffsetBounds(AFieldHighlightAreaBox);
  inherited VisitFieldHighlightAreaBox(AFieldHighlightAreaBox);
end;

procedure TdxRichEditCommentVisitor.VisitHiddenTextUnderlineBox
  (AHiddenTextUnderlineBox: TdxRichEditHiddenTextUnderlineBox);
begin
  OffsetBounds(AHiddenTextUnderlineBox);
  inherited VisitHiddenTextUnderlineBox(AHiddenTextUnderlineBox);
end;

procedure TdxRichEditCommentVisitor.VisitHighlightAreaBox(AHighlightAreaBox
  : TdxRichEditHighlightAreaBox);
begin
...
procedure TdxRichEditCommentVisitor.VisitHyphenBox
  (AHyphen: TdxRichEditPlainTextBox);
begin
  OffsetBounds(AHyphen);
  inherited VisitHyphenBox(AHyphen);
end;

procedure TdxRichEditCommentVisitor.VisitInlinePictureBox(AInlinePictureBox
  : TdxRichEditInlinePictureBox);
begin
...
procedure TdxRichEditCommentVisitor.VisitLineBreakBox(ALineBreakBox
  : TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditCommentVisitor.VisitNumberingListMarkBox
  (ANumberingListMarkBox: TdxRichEditNumberingListMarkBox);
begin
  OffsetBounds(ANumberingListMarkBox);
  inherited VisitNumberingListMarkBox(ANumberingListMarkBox);
end;

procedure TdxRichEditCommentVisitor.VisitNumberingListWithSeparatorBox
...
procedure TdxRichEditCommentVisitor.VisitParagraphMarkBox(AParagraphMarkBox
  : TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditCommentVisitor.VisitPlainTextBox(APlainTextBox
  : TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditCommentVisitor.VisitSpaceBox
  (ASpaceBox: TdxRichEditPlainTextBox);
begin
  OffsetBounds(ASpaceBox);
  inherited VisitSpaceBox(ASpaceBox);
end;

procedure TdxRichEditCommentVisitor.VisitSpecialTextBox(ASpecialTextBox
  : TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditCommentVisitor.VisitStrikeoutBox(AStrikeoutBox
  : TdxRichEditStrikeoutBox);
begin
...
procedure TdxRichEditCommentVisitor.VisitTabSpaceBox(ATabSpaceBox
  : TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditCommentVisitor.VisitUnderlineBox(AUnderlineBox
  : TdxRichEditUnderlineBox);
begin
...
procedure TdxRichEditCommentVisitor.VisitErrorBox
  (AErrorBox: TdxRichEditErrorBox);
begin
...
constructor TdxRichEditLayoutComment.Create(AComment: TdxCommentViewInfo;
  const AParent: IdxRichEditLayoutElement);
var
...
constructor TdxRichEditLineNumberBox.Create(AModelBox: TdxModelLineNumberBox;
  const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
  FModelBox := AModelBox;
...
constructor TdxRichEditUnderlineBox.Create(AModelBox: TdxModelUnderlineBox;
  const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
  FModelBox := AModelBox;
...
constructor TdxRichEditHighlightAreaBox.Create(const AModelBox
  : TdxHighlightArea; const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
  FModelBox := AModelBox;
end;
...
begin
  Result := TdxRichEditDocumentLayoutHelper.GetRangeFromRowByCoordinates
    (TdxRichEditLayoutRow(Parent), Bounds.X, Bounds.X + Bounds.Width);
end;

procedure TdxRichEditHighlightAreaBox.Accept
  (AVisitor: TdxRichEditLayoutVisitor);
begin
...
procedure TdxRichEditFieldHighlightAreaBox.Accept
  (AVisitor: TdxRichEditLayoutVisitor);
begin
...
function TdxRichEditRangePermissionHighlightAreaBox.GetType
  : TdxRichEditLayoutType;
begin
  Result := TdxRichEditLayoutType.RangePermissionHighlightAreaBox;
end;

procedure TdxRichEditRangePermissionHighlightAreaBox.Accept
  (AVisitor: TdxRichEditLayoutVisitor);
begin
...
procedure TdxRichEditCommentHighlightAreaBox.Accept
  (AVisitor: TdxRichEditLayoutVisitor);
begin
...
constructor TdxRichEditBookmarkBox.Create
  (AModelBox: TdxVisitableDocumentIntervalBox; AType: TdxRichEditLayoutType;
  const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
  FModelBox := AModelBox;
...
begin
  Result := TRect.CreateSize(TPoint.Create(ModelBox.HorizontalPosition,
    Parent.Bounds.Top), TSize.Empty);
end;
...
procedure TdxRichEditRangePermissionBox.Accept
  (AVisitor: TdxRichEditLayoutVisitor);
begin
...
constructor TdxRichEditHiddenTextUnderlineBox.Create
  (AModelBox: TdxModelHiddenTextUnderlineBox;
  const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
  FModelBox := AModelBox;
...
procedure TdxRichEditHiddenTextUnderlineBox.Accept
  (AVisitor: TdxRichEditLayoutVisitor);
begin
...
constructor TdxRichEditLayoutFrame.Create(AModelBox: TdxParagraphFrameBox;
  const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
  FModelBox := AModelBox;
...
begin
  if FTables = nil then
  begin
    AModelCollection := ModelBox.DocumentLayout.Pages[0].Areas[0].Columns
      [0].Tables;
    FTables := TdxRichEditDocumentLayoutHelper.CreateLayoutTableCollection
      (AModelCollection, Self);
  end;
...
begin
  if FRows = nil then
  begin
    AModelCollection := ModelBox.DocumentLayout.Pages[0].Areas[0]
      .Columns[0].Rows;
    FRows := TdxRichEditDocumentLayoutHelper.CreateLayoutRowCollection
      (AModelCollection, Self, False);
  end;
...
function TdxRichEditLayoutFrame.GetParagraphFrames
  : TdxRichEditParagraphFrameBoxCollection;
begin
  if FParagraphFrames = nil then
  begin
    FParagraphFrames := TdxRichEditDocumentLayoutHelper.
      CreateParagraphFrameBoxCollection(ModelBox.DocumentLayout.Pages[0].Areas
      [0].Columns[0], Self);
  end;
  Result := FParagraphFrames;
end;
...
procedure TdxRichEditLayoutRowExporter.AddAnchorBox(ABox: TdxModelBox;
  ACollection: TdxSimpleParagraphBoxCollection);
var
  ABoxIndex, I: Integer;
  ...
  try
    ...
    begin
      ...
      AInverseList.Add(TdxRichEditFloatingObjectAnchorBox.Create(AModelBox,
        TRect.CreateSize(ACollection[ABoxIndex].Bounds.Location,
        AModelBox.Bounds.Size), FRow));
    end;
...
function TdxRichEditLayoutRowExporter.GetBoxIndex(ABox: TdxModelBox;
  ACollection: TdxSimpleParagraphBoxCollection): Integer;
var
  I: Integer;
begin
  Result := -1;
  for I := 0 to ACollection.Count - 1 do
    if (ABox = ACollection[I]) or (ABox.StartPos = ACollection[I].StartPos) and
      (ABox.EndPos = ACollection[I].EndPos) then
      Exit(I);
end;

procedure TdxRichEditLayoutRowExporter.ExportTextBox(ABox: TdxTextBox);
begin
  Boxes.Add(TdxRichEditPlainTextBox.Create(ABox,
    TdxRichEditLayoutType.PlainTextBox, FRow));
end;

procedure TdxRichEditLayoutRowExporter.ExportSpecialTextBox
  (ABox: TdxSpecialTextBox);
begin
  Boxes.Add(TdxRichEditPlainTextBox.Create(ABox,
    TdxRichEditLayoutType.SpecialTextBox, FRow));
end;

procedure TdxRichEditLayoutRowExporter.ExportLayoutDependentTextBox
  (ABox: TdxLayoutDependentTextBox);
begin
  Boxes.Add(TdxRichEditPlainTextBox.Create(ABox,
    TdxRichEditLayoutType.PageNumberBox, FRow));
end;

procedure TdxRichEditLayoutRowExporter.ExportHyphenBox(ABox: TdxHyphenBox);
begin
  Boxes.Add(TdxRichEditPlainTextBox.Create(ABox,
    TdxRichEditLayoutType.HyphenBox, FRow));
end;

procedure TdxRichEditLayoutRowExporter.ExportInlinePictureBox
  (ABox: TdxModelInlinePictureBox);
begin
...
begin
  Boxes.Add(TdxRichEditPlainTextBox.Create(ABox,
    TdxRichEditLayoutType.SpaceBox, FRow));
end;

procedure TdxRichEditLayoutRowExporter.ExportTabSpaceBox(ABox: TdxTabSpaceBox);
begin
  Boxes.Add(TdxRichEditPlainTextBox.Create(ABox,
    TdxRichEditLayoutType.TabSpaceBox, FRow));
end;

procedure TdxRichEditLayoutRowExporter.ExportNumberingListBox
  (ABox: TdxNumberingListBox);
begin
  Boxes.Add(TdxRichEditPlainTextBox.Create(ABox,
    TdxRichEditLayoutType.NumberingListMarkBox, FRow));
end;

procedure TdxRichEditLayoutRowExporter.ExportLineBreakBox
  (ABox: TdxLineBreakBox);
begin
  Boxes.Add(TdxRichEditPlainTextBox.Create(ABox,
    TdxRichEditLayoutType.LineBreakBox, FRow));
end;

procedure TdxRichEditLayoutRowExporter.ExportPageBreakBox
  (ABox: TdxPageBreakBox);
begin
  Boxes.Add(TdxRichEditPlainTextBox.Create(ABox,
    TdxRichEditLayoutType.PageBreakBox, FRow));
end;

procedure TdxRichEditLayoutRowExporter.ExportColumnBreakBox
  (ABox: TdxColumnBreakBox);
begin
  Boxes.Add(TdxRichEditPlainTextBox.Create(ABox,
    TdxRichEditLayoutType.ColumnBreakBox, FRow));
end;

procedure TdxRichEditLayoutRowExporter.ExportParagraphMarkBox
  (ABox: TdxParagraphMarkBox);
begin
  Boxes.Add(TdxRichEditPlainTextBox.Create(ABox,
    TdxRichEditLayoutType.ParagraphMarkBox, FRow));
end;

procedure TdxRichEditLayoutRowExporter.ExportSectionMarkBox
  (ABox: TdxSectionMarkBox);
begin
  Boxes.Add(TdxRichEditPlainTextBox.Create(ABox,
    TdxRichEditLayoutType.SectionBreakBox, FRow));
end;

procedure TdxRichEditLayoutRowExporter.ExportSeparatorBox
  (ABox: TdxSeparatorBox);
begin
end;

procedure TdxRichEditLayoutRowExporter.ExportLineNumberBox
  (ABox: TdxModelLineNumberBox);
begin
end;
...
procedure TdxRichEditLayoutRowExporter.ExportParagraphFramePage(APage: TdxPage;
  const APageClipBounds: TdxRectF; AExportContent: Boolean);
begin
end;
...
procedure TdxRichEditLayoutRowExporter.ExportFloatingObjectBox
  (ABox: TdxFloatingObjectBox);
begin
end;

procedure TdxRichEditLayoutRowExporter.ExportParagraphFrameBox
  (ABox: TdxParagraphFrameBox);
begin
end;

procedure TdxRichEditLayoutRowExporter.ExportUnderlineBox(ARow: TdxSimpleRow;
  AUnderlineBox: TdxModelUnderlineBox);
begin
end;

procedure TdxRichEditLayoutRowExporter.ExportStrikeoutBox(ARow: TdxSimpleRow;
  AStrikeoutBox: TdxModelUnderlineBox);
begin
end;
...
procedure TdxRichEditLayoutRowExporter.ExportBookmarkStartBox
  (ABox: TdxVisitableDocumentIntervalBox);
begin
end;

procedure TdxRichEditLayoutRowExporter.ExportBookmarkEndBox
  (ABox: TdxVisitableDocumentIntervalBox);
begin
end;

procedure TdxRichEditLayoutRowExporter.ExportCommentStartBox
  (ABox: TdxVisitableDocumentIntervalBox);
begin
end;

procedure TdxRichEditLayoutRowExporter.ExportCommentEndBox
  (ABox: TdxVisitableDocumentIntervalBox);
begin
end;

procedure TdxRichEditLayoutRowExporter.ExportTableBorder
  (ABorder: TdxTableBorderViewInfoBase; const ACellBounds: TRect);
begin
end;

procedure TdxRichEditLayoutRowExporter.ExportTableBorderCorner
  (ACorner: TdxCornerViewInfoBase; X: Integer; Y: Integer);
begin
end;

procedure TdxRichEditLayoutRowExporter.ExportTableCell
  (ACell: TdxTableCellViewInfo);
begin
end;

procedure TdxRichEditLayoutRowExporter.ExportTableRow
  (ARow: TdxTableRowViewInfoBase);
begin
end;

procedure TdxRichEditLayoutRowExporter.ExportCustomMarkBox
  (ABox: TdxCustomMarkBox);
begin
end;

function TdxRichEditLayoutRowExporter.IsAnchorVisible(const AAnchor
  : TdxTableCellVerticalAnchor): Boolean;
begin
  raise TdxNotImplementedException.Create;
end;

function TdxRichEditLayoutRowExporter.IsTableRowVisible
  (ARow: TdxTableRowViewInfoBase): Boolean;
begin
  raise TdxNotImplementedException.Create;
end;
...
constructor TdxRichEditLayoutPageAreaBase.Create(const AParent
  : IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
end;
...
function TdxRichEditLayoutPageAreaBase.GetColumns
  : TdxRichEditLayoutColumnCollection;
var
  I: Integer;
begin
...
constructor TdxRichEditLayoutPageArea.Create(APageArea: TdxPageArea;
  const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
...
function TdxRichEditLayoutPageArea.GetModelLineNumberBoxes
  : TdxModelLineNumberBoxCollection;
begin
...
constructor TdxRichEditLayoutHeaderFooterBase.Create(AModelHeaderFooter
  : TdxHeaderFooterPageAreaBase; const AParent: IdxRichEditLayoutElement);
begin
  inherited Create(AParent);
...
function TdxRichEditLayoutHeaderFooterBase.DoGetSection
  : TdxRichEditNativeSection;
begin
  Result := nil;
end;
...
constructor TdxRichEditLayoutHeader.Create(AHeader: TdxHeaderPageArea;
  const AParent: IdxRichEditLayoutElement);
begin
...
constructor TdxRichEditLayoutFooter.Create(AFooter: TdxFooterPageArea;
  const AParent: IdxRichEditLayoutElement);
begin
...
function TdxRichEditPagePainter.ShouldOptimizeBox
  (ABox: IdxRichEditLayoutElement): Boolean;
begin
...
begin
  Exporter.ExportPage(APage.ModelPage, procedure
    begin
      TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitPage(APage);
    end);
end;

procedure TdxRichEditPagePainter.DrawPageArea
  (APageArea: TdxRichEditLayoutPageArea);
begin
  TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitPageArea
    (APageArea);
...
begin
  AHeaderFooter := Safe<TdxRichEditLayoutHeaderFooterBase>.Cast
    (AColumn.Parent.AsObject);

  AOldClipBounds.Empty;
  if AHeaderFooter <> nil then
  begin
    AClipBounds := Exporter.CalculateHeaderFooterClipBounds
      (AHeaderFooter.ModelHeaderFooter.ContentBounds.ToRectF);
...
procedure TdxRichEditPagePainter.DrawComment
  (AComment: TdxRichEditLayoutComment);
var
...
begin
  ...
  AClipRect.Empty;
  AOldPieceTable := nil;
  if not Exporter.BeginExportCompositeObject
    (GetDrawingBounds(AComment.ContentBounds), AComment.PieceTable,
  ...
  if Exporter.ShouldExportComment(AComment.ModelComment) then
    TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitComment
      (AComment);
...
begin
  AClipBounds := Exporter.CalculateHeaderFooterClipBounds
    (AHeader.ModelHeaderFooter.ContentBounds.ToRectF);
...
begin
  AClipBounds := Exporter.CalculateHeaderFooterClipBounds
    (AFooter.ModelHeaderFooter.ContentBounds.ToRectF);
  if AClipBounds.IsZero then
    Exit;
...
procedure TdxRichEditPagePainter.DrawParagraphFrame(AParagraphFrame
  : TdxRichEditParagraphFrameBox);
begin
  Exporter.ExportParagraphFrame(AParagraphFrame.ModelBox);
end;

procedure TdxRichEditPagePainter.DrawTextBox
  (ATextBox: TdxRichEditLayoutTextBox);
var
  AOldClipRect, AClipRect: TdxRectF;
  AOldPieceTable: TdxPieceTable;
...
begin
  ...
  ATransformApplied := Exporter.BeforeExportRotatedContent
    (AModelFloatingObject);
  try
    Exporter.ExportFloatingObjectShape(AModelFloatingObject,
      ATextBox.AnchorRun.Shape);
    ABounds := GetDrawingBounds(ATextBox.ContentBounds);

    AContent := Safe<TdxTextBoxFloatingObjectContent>.Cast
      (ATextBox.AnchorRun.Content);
    if AContent <> nil then
    begin
      AUnitConverter := AModelFloatingObject.PieceTable.DocumentModel.
        ToDocumentLayoutUnitConverter;
      Dec(ABounds.Bottom, AUnitConverter.ToLayoutUnits
        (AContent.TextBoxProperties.BottomMargin));
    end;

    if not Exporter.BeginExportCompositeObject(ABounds,
      (IdxPieceTableContainer(ATextBox)).PieceTable, AOldClipRect, AClipRect,
      AOldPieceTable) then
      Exit;
    Exporter.PushBackgroundLayer;

    Exporter.SetBackColor(ATextBox.AnchorRun.Shape.FillColor, ABounds);
    TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitTextBox
      (ATextBox);
    Exporter.PopBackgroundLayer;
    Exporter.EndExportCompositeObject(AOldClipRect, AOldPieceTable);
  finally
...
procedure TdxRichEditPagePainter.DrawFloatingPicture(AFloatingPicture
  : TdxRichEditLayoutFloatingPicture);
begin
...
procedure TdxRichEditPagePainter.DrawTableRow
  (ATableRow: TdxRichEditLayoutTableRow);
begin
  TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitTableRow
    (ATableRow);
end;

procedure TdxRichEditPagePainter.DrawTableCell
  (ATableCell: TdxRichEditLayoutTableCell);
var
  AOldClipBounds: TdxRectF;
begin
  AOldClipBounds := Exporter.BeginExportTableCell(ATableCell.ModelTableCell);
  TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitTableCell
    (ATableCell);
  Exporter.EndExportTableCell(AOldClipBounds);
end;

function TdxRichEditPagePainter.ShouldExportRowBackground(ARowExtendedBoxes
  : TdxRichEditRowExtendedBoxes): Boolean;
begin
  if (ARowExtendedBoxes.HighlightAreas <> nil) and
    (ARowExtendedBoxes.HighlightAreas.Count > 0) then
    Exit(True);
  if (ARowExtendedBoxes.FieldHighlightAreas <> nil) and
    (ARowExtendedBoxes.FieldHighlightAreas.Count > 0) then
    Exit(True);
  if (ARowExtendedBoxes.RangePermissionHighlightAreas <> nil) and
    (ARowExtendedBoxes.RangePermissionHighlightAreas.Count > 0) then
    Exit(True);
  if (ARowExtendedBoxes.CommentHighlightAreas <> nil) and
    (ARowExtendedBoxes.CommentHighlightAreas.Count > 0) then
    Exit(True);
  Result := False;
end;

procedure TdxRichEditPagePainter.DrawRowBackground(ARowExtendedBoxes
  : TdxRichEditRowExtendedBoxes);
begin
  if ShouldExportRowBackground(ARowExtendedBoxes) then
    TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitRowBackground
      (ARowExtendedBoxes);
end;

function TdxRichEditPagePainter.ShouldDrawRow
  (ARow: TdxRichEditLayoutRow): Boolean;
begin
...
procedure TdxRichEditPagePainter.DrawPlainTextBox(APlainTextBox
  : TdxRichEditPlainTextBox);
begin
  Exporter.ExportTextBox(TdxTextBox(APlainTextBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawSpecialTextBox(ASpecialTextBox
  : TdxRichEditPlainTextBox);
begin
  Exporter.ExportTextBox(TdxTextBox(ASpecialTextBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawInlinePictureBox(AInlinePictureBox
  : TdxRichEditInlinePictureBox);
begin
  Exporter.ExportInlinePictureBox
    (TdxInlinePictureBox(AInlinePictureBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawFloatingObjectAnchorBox
  (AFloatingObjectAnchorBox: TdxRichEditFloatingObjectAnchorBox);
begin
end;

procedure TdxRichEditPagePainter.DrawSpaceBox
  (ASpaceBox: TdxRichEditPlainTextBox);
begin
  Exporter.ExportSpaceBox(ASpaceBox.ModelBox);
end;

procedure TdxRichEditPagePainter.DrawParagraphMarkBox(AParagraphMarkBox
  : TdxRichEditPlainTextBox);
begin
  Exporter.ExportParagraphMarkBox
    (TdxParagraphMarkBox(AParagraphMarkBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawSectionBreakBox(ASectionBreakBox
  : TdxRichEditPlainTextBox);
begin
  Exporter.ExportSectionMarkBox(TdxSectionMarkBox(ASectionBreakBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawLineBreakBox(ALineBreakBox
  : TdxRichEditPlainTextBox);
begin
  Exporter.ExportLineBreakBox(TdxLineBreakBox(ALineBreakBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawPageBreakBox(APageBreakBox
  : TdxRichEditPlainTextBox);
begin
  Exporter.ExportPageBreakBox(TdxPageBreakBox(APageBreakBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawColumnBreakBox(AColumnBreakBox
  : TdxRichEditPlainTextBox);
begin
  Exporter.ExportColumnBreakBox(TdxColumnBreakBox(AColumnBreakBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawHyphenBox
  (AHyphen: TdxRichEditPlainTextBox);
begin
  Exporter.ExportHyphenBox(TdxHyphenBox(AHyphen.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawTabSpaceBox(ATabSpaceBox
  : TdxRichEditPlainTextBox);
begin
  Exporter.ExportTabSpaceBox(TdxTabSpaceBox(ATabSpaceBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawPageNumberBox(APageNumberBox
  : TdxRichEditPlainTextBox);
begin
  Exporter.ExportLayoutDependentTextBox
    (TdxLayoutDependentTextBox(APageNumberBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawNumberingListMarkBox(ANumberingListMarkBox
  : TdxRichEditNumberingListMarkBox);
begin
  Exporter.ExportNumberingListBox
    (TdxNumberingListBox(ANumberingListMarkBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawNumberingListWithSeparatorBox
  (ANumberingListWithSeparatorBox: TdxRichEditNumberingListWithSeparatorBox);
begin
  Exporter.ExportNumberingListBox
    (TdxNumberingListBox(ANumberingListWithSeparatorBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawUnderlineBoxes(AUnderlineBoxes
  : TdxRichEditUnderlineBoxCollection);
var
...
begin
  ...
  if not ShouldOptimizeBox(ACurrentRow) then
    TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitUnderlineBoxes
      (AUnderlineBoxes);
end;

procedure TdxRichEditPagePainter.DrawStrikeoutBoxes(AStrikeoutBoxes
  : TdxRichEditStrikeoutBoxCollection);
var
  ACurrentRow: TdxRichEditLayoutRow;
begin
  ...
  if not ShouldOptimizeBox(ACurrentRow) then
    TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitStrikeoutBoxes
      (AStrikeoutBoxes);
end;

procedure TdxRichEditPagePainter.DrawBookmarkBoxes(ABookmarkBoxes
  : TdxRichEditBookmarkBoxCollection);
begin
  if ABookmarkBoxes.Count > 0 then
    TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitBookmarkBoxes
      (ABookmarkBoxes);
end;

procedure TdxRichEditPagePainter.DrawUnderlineBox(AUnderlineBox
  : TdxRichEditUnderlineBox);
var
  ACurrentRow: TdxRichEditLayoutRow;
begin
  ACurrentRow := AUnderlineBox.GetParentByType<TdxRichEditLayoutRow>;
  Exporter.ExportUnderlineBox(ACurrentRow.ModelRow,
    TdxUnderlineBox(AUnderlineBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawStrikeoutBox(AStrikeoutBox
  : TdxRichEditStrikeoutBox);
var
  ACurrentRow: TdxRichEditLayoutRow;
begin
  ACurrentRow := AStrikeoutBox.GetParentByType<TdxRichEditLayoutRow>;
  Exporter.ExportStrikeoutBox(ACurrentRow.ModelRow,
    TdxUnderlineBox(AStrikeoutBox.ModelBox));
end;
...
procedure TdxRichEditPagePainter.DrawHighlightAreaBox(AHighlightAreaBox
  : TdxRichEditHighlightAreaBox);
begin
  Exporter.ExportHighlightArea(AHighlightAreaBox.ModelBox);
end;

procedure TdxRichEditPagePainter.DrawBookmarkStartBox(ABookmarkStartBox
  : TdxRichEditBookmarkBox);
begin
  Exporter.ExportBookmarkStartBox
    (TdxVisitableDocumentIntervalBox(ABookmarkStartBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawBookmarkEndBox(ABookmarkEndBox
  : TdxRichEditBookmarkBox);
begin
  Exporter.ExportBookmarkEndBox(TdxVisitableDocumentIntervalBox
    (ABookmarkEndBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawHiddenTextUnderlineBox
  (AHiddenTextUnderlineBox: TdxRichEditHiddenTextUnderlineBox);
begin
end;

procedure TdxRichEditPagePainter.DrawLineNumberBox(ALineNumberBox
  : TdxRichEditLineNumberBox);
begin
  Exporter.ExportLineNumberBox(TdxLineNumberBox(ALineNumberBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawFieldHighlightAreaBox
  (AFieldHighlightAreaBox: TdxRichEditFieldHighlightAreaBox);
begin
  Exporter.ExportHighlightArea(AFieldHighlightAreaBox.ModelBox);
end;

procedure TdxRichEditPagePainter.DrawRangePermissionHighlightAreaBox
  (ARangePermissionHighlightAreaBox
  : TdxRichEditRangePermissionHighlightAreaBox);
begin
...
procedure TdxRichEditPagePainter.DrawRangePermissionStartBox
  (ARangePermissionStartBox: TdxRichEditRangePermissionBox);
begin
end;

procedure TdxRichEditPagePainter.DrawRangePermissionEndBox
  (ARangePermissionEndBox: TdxRichEditRangePermissionBox);
begin
end;

procedure TdxRichEditPagePainter.DrawCommentHighlightAreaBox
  (ACommentHighlightAreaBox: TdxRichEditCommentHighlightAreaBox);
begin
  Exporter.ExportHighlightArea(ACommentHighlightAreaBox.ModelBox);
end;

procedure TdxRichEditPagePainter.DrawCommentStartBox(ACommentStartBox
  : TdxRichEditCommentBox);
begin
  Exporter.ExportCommentStartBox(TdxVisitableDocumentIntervalBox
    (ACommentStartBox.ModelBox));
end;

procedure TdxRichEditPagePainter.DrawCommentEndBox(ACommentEndBox
  : TdxRichEditCommentBox);
begin
  Exporter.ExportCommentEndBox(TdxVisitableDocumentIntervalBox
    (ACommentEndBox.ModelBox));
end;

{ TdxRichEditLayoutVisitor }

procedure TdxRichEditLayoutVisitor.Visit(const AElement
  : IdxRichEditLayoutElement);
begin
...
procedure TdxRichEditLayoutVisitor.VisitPageArea
  (APageArea: TdxRichEditLayoutPageArea);
begin
  VisitArea(APageArea);
end;

procedure TdxRichEditLayoutVisitor.VisitColumn
  (AColumn: TdxRichEditLayoutColumn);
begin
...
procedure TdxRichEditLayoutVisitor.VisitComment
  (AComment: TdxRichEditLayoutComment);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitHeader
  (AHeader: TdxRichEditLayoutHeader);
begin
  VisitArea(AHeader);
end;

procedure TdxRichEditLayoutVisitor.VisitFooter
  (AFooter: TdxRichEditLayoutFooter);
begin
  VisitArea(AFooter);
end;

procedure TdxRichEditLayoutVisitor.VisitTextBox
  (ATextBox: TdxRichEditLayoutTextBox);
begin
...
procedure TdxRichEditLayoutVisitor.VisitFloatingPicture(AFloatingPicture
  : TdxRichEditLayoutFloatingPicture);
begin
end;
...
procedure TdxRichEditLayoutVisitor.VisitTableRow
  (ATableRow: TdxRichEditLayoutTableRow);
begin
  VisitLayoutElementsCollection(ATableRow.TableCells);
end;

procedure TdxRichEditLayoutVisitor.VisitTableCell
  (ATableCell: TdxRichEditLayoutTableCell);
begin
...
procedure TdxRichEditLayoutVisitor.VisitRowBackground(ARowExtendedBoxes
  : TdxRichEditRowExtendedBoxes);
begin
  VisitLayoutElementsCollection(ARowExtendedBoxes.FieldHighlightAreas);
  VisitLayoutElementsCollection
    (ARowExtendedBoxes.RangePermissionHighlightAreas);
...
procedure TdxRichEditLayoutVisitor.VisitUnderlineBoxes(AUnderlineBoxes
  : TdxRichEditUnderlineBoxCollection);
begin
  VisitLayoutElementsCollection(AUnderlineBoxes);
end;

procedure TdxRichEditLayoutVisitor.VisitStrikeoutBoxes(AStrikeoutBoxes
  : TdxRichEditStrikeoutBoxCollection);
begin
  VisitLayoutElementsCollection(AStrikeoutBoxes);
end;

procedure TdxRichEditLayoutVisitor.VisitErrorBoxes
  (AErrorBoxes: TdxRichEditErrorBoxCollection);
begin
  VisitLayoutElementsCollection(AErrorBoxes);
end;

procedure TdxRichEditLayoutVisitor.VisitBookmarkBoxes(ABookmarkBoxes
  : TdxRichEditBookmarkBoxCollection);
begin
  VisitLayoutElementsCollection(ABookmarkBoxes);
end;

procedure TdxRichEditLayoutVisitor.VisitPlainTextBox(APlainTextBox
  : TdxRichEditPlainTextBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitSpecialTextBox(ASpecialTextBox
  : TdxRichEditPlainTextBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitInlinePictureBox(AInlinePictureBox
  : TdxRichEditInlinePictureBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitFloatingObjectAnchorBox
  (AFloatingObjectAnchorBox: TdxRichEditFloatingObjectAnchorBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitSpaceBox
  (ASpaceBox: TdxRichEditPlainTextBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitParagraphMarkBox(AParagraphMarkBox
  : TdxRichEditPlainTextBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitSectionBreakBox(ASectionBreakBox
  : TdxRichEditPlainTextBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitLineBreakBox(ALineBreakBox
  : TdxRichEditPlainTextBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitPageBreakBox(APageBreakBox
  : TdxRichEditPlainTextBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitColumnBreakBox(AColumnBreakBox
  : TdxRichEditPlainTextBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitHyphenBox
  (AHyphen: TdxRichEditPlainTextBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitTabSpaceBox(ATabSpaceBox
  : TdxRichEditPlainTextBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitPageNumberBox(APageNumberBox
  : TdxRichEditPlainTextBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitNumberingListMarkBox
  (ANumberingListMarkBox: TdxRichEditNumberingListMarkBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitNumberingListWithSeparatorBox
  (ANumberingListWithSeparatorBox: TdxRichEditNumberingListWithSeparatorBox);
begin
  ANumberingListWithSeparatorBox.Separator.Accept(Self);
end;

procedure TdxRichEditLayoutVisitor.VisitUnderlineBox(AUnderlineBox
  : TdxRichEditUnderlineBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitStrikeoutBox(AStrikeoutBox
  : TdxRichEditStrikeoutBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitErrorBox
  (AErrorBox: TdxRichEditErrorBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitHighlightAreaBox(AHighlightAreaBox
  : TdxRichEditHighlightAreaBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitBookmarkStartBox(ABookmarkStartBox
  : TdxRichEditBookmarkBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitBookmarkEndBox(ABookmarkEndBox
  : TdxRichEditBookmarkBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitHiddenTextUnderlineBox
  (AHiddenTextUnderlineBox: TdxRichEditHiddenTextUnderlineBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitLineNumberBox(ALineNumberBox
  : TdxRichEditLineNumberBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitFieldHighlightAreaBox
  (AFieldHighlightAreaBox: TdxRichEditFieldHighlightAreaBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitRangePermissionHighlightAreaBox
  (ARangePermissionHighlightAreaBox
  : TdxRichEditRangePermissionHighlightAreaBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitRangePermissionStartBox
  (ARangePermissionStartBox: TdxRichEditRangePermissionBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitRangePermissionEndBox
  (ARangePermissionEndBox: TdxRichEditRangePermissionBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitCommentHighlightAreaBox
  (ACommentHighlightAreaBox: TdxRichEditCommentHighlightAreaBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitCommentStartBox(ACommentStartBox
  : TdxRichEditCommentBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitCommentEndBox(ACommentEndBox
  : TdxRichEditCommentBox);
begin
end;
...
procedure TdxRichEditLayoutVisitor.VisitParagraphFrameBox(AParagraphFrameBox
  : TdxRichEditParagraphFrameBox);
begin
end;

procedure TdxRichEditLayoutVisitor.VisitLayoutElementsCollection
  (ACollection: TdxRichEditLayoutElementCollection);
var
  ACount, I: Integer;
...
procedure TdxRichEditLayoutVisitor.VisitLayoutRowCollection
  (ACollection: TdxRichEditLayoutRowCollection);
var
  ARow: TdxRichEditLayoutRow;
...
begin
  ...
  AIntf := ARow.GetParentByIntf(IdxRichEditParagraphFrameContainer)
    as IdxRichEditParagraphFrameContainer;
  VisitParagraphFrameBoxes(AIntf, ARow.Parent);
  VisitLayoutElementsCollection(ACollection);
end;

procedure TdxRichEditLayoutVisitor.VisitParagraphFrameBoxes
  (const AParagraphFrameContainer: IdxRichEditParagraphFrameContainer;
...
procedure TdxRichEditLayoutVisitor.VisitArea
  (AArea: TdxRichEditLayoutPageAreaBase);
var
  APieceTable: TdxPieceTable;
  APage: TdxRichEditLayoutPage;
begin
...
procedure TdxRichEditLayoutVisitor.VisitFloatingObjects
  (ACollection: TdxRichEditLayoutFloatingObjectCollection;
APieceTable: TdxPieceTable);
var
  ACount, I: Integer;
...
procedure TdxRichEditLayoutVisitor.VisitFrames(ACollection
  : TdxRichEditLayoutFrameCollection; APieceTable: TdxPieceTable);
var
  ACount, I: Integer;
...
constructor TdxRichEditPagePainterVisitor.Create
  (APainter: TdxRichEditPagePainter);
begin
  inherited Create;
  FPainter := APainter;
end;
...
procedure TdxRichEditPagePainterVisitor.VisitRowBackground(ARowExtendedBoxes
  : TdxRichEditRowExtendedBoxes);
begin
...
procedure TdxRichEditPagePainterVisitor.VisitUnderlineBoxes(AUnderlineBoxes
  : TdxRichEditUnderlineBoxCollection);
begin
  FPainter.DrawUnderlineBoxes(AUnderlineBoxes);
end;

procedure TdxRichEditPagePainterVisitor.VisitStrikeoutBoxes(AStrikeoutBoxes
  : TdxRichEditStrikeoutBoxCollection);
begin
  FPainter.DrawStrikeoutBoxes(AStrikeoutBoxes);
end;

procedure TdxRichEditPagePainterVisitor.VisitBookmarkBoxes(ABookmarkBoxes
  : TdxRichEditBookmarkBoxCollection);
begin
  FPainter.DrawBookmarkBoxes(ABookmarkBoxes);
end;

procedure TdxRichEditPagePainterVisitor.VisitTable
  (ATable: TdxRichEditLayoutTable);
begin
  FPainter.DrawTable(ATable);
end;

procedure TdxRichEditPagePainterVisitor.VisitTableRow
  (ATableRow: TdxRichEditLayoutTableRow);
begin
  FPainter.DrawTableRow(ATableRow);
end;

procedure TdxRichEditPagePainterVisitor.VisitTableCell
  (ATableCell: TdxRichEditLayoutTableCell);
begin
  FPainter.DrawTableCell(ATableCell);
end;

procedure TdxRichEditPagePainterVisitor.VisitPageArea
  (APageArea: TdxRichEditLayoutPageArea);
begin
  FPainter.DrawPageArea(APageArea);
end;

procedure TdxRichEditPagePainterVisitor.VisitColumn
  (AColumn: TdxRichEditLayoutColumn);
begin
  FPainter.DrawColumn(AColumn);
end;

procedure TdxRichEditPagePainterVisitor.VisitComments
  (APage: TdxRichEditLayoutPage);
begin
  FPainter.DrawComments(APage);
end;

procedure TdxRichEditPagePainterVisitor.VisitComment
  (AComment: TdxRichEditLayoutComment);
begin
  FPainter.DrawComment(AComment);
end;

procedure TdxRichEditPagePainterVisitor.VisitHeader
  (AHeader: TdxRichEditLayoutHeader);
begin
  FPainter.DrawHeader(AHeader);
end;

procedure TdxRichEditPagePainterVisitor.VisitFooter
  (AFooter: TdxRichEditLayoutFooter);
begin
  FPainter.DrawFooter(AFooter);
end;

procedure TdxRichEditPagePainterVisitor.VisitTextBox
  (ATextBox: TdxRichEditLayoutTextBox);
begin
  FPainter.DrawTextBox(ATextBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitFloatingPicture(AFloatingPicture
  : TdxRichEditLayoutFloatingPicture);
begin
  FPainter.DrawFloatingPicture(AFloatingPicture);
end;

procedure TdxRichEditPagePainterVisitor.VisitPlainTextBox
  (APlainTextBox: TdxRichEditPlainTextBox);
begin
  FPainter.DrawPlainTextBox(APlainTextBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitSpecialTextBox(ASpecialTextBox
  : TdxRichEditPlainTextBox);
begin
  FPainter.DrawSpecialTextBox(ASpecialTextBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitInlinePictureBox(AInlinePictureBox
  : TdxRichEditInlinePictureBox);
begin
  FPainter.DrawInlinePictureBox(AInlinePictureBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitFloatingObjectAnchorBox
  (AFloatingObjectAnchorBox: TdxRichEditFloatingObjectAnchorBox);
begin
  FPainter.DrawFloatingObjectAnchorBox(AFloatingObjectAnchorBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitSpaceBox
  (ASpaceBox: TdxRichEditPlainTextBox);
begin
  FPainter.DrawSpaceBox(ASpaceBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitParagraphMarkBox(AParagraphMarkBox
  : TdxRichEditPlainTextBox);
begin
  FPainter.DrawParagraphMarkBox(AParagraphMarkBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitSectionBreakBox(ASectionBreakBox
  : TdxRichEditPlainTextBox);
begin
  FPainter.DrawSectionBreakBox(ASectionBreakBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitLineBreakBox
  (ALineBreakBox: TdxRichEditPlainTextBox);
begin
  FPainter.DrawLineBreakBox(ALineBreakBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitPageBreakBox
  (APageBreakBox: TdxRichEditPlainTextBox);
begin
  FPainter.DrawPageBreakBox(APageBreakBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitColumnBreakBox(AColumnBreakBox
  : TdxRichEditPlainTextBox);
begin
  FPainter.DrawColumnBreakBox(AColumnBreakBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitHyphenBox
  (AHyphenBox: TdxRichEditPlainTextBox);
begin
  FPainter.DrawHyphenBox(AHyphenBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitTabSpaceBox
  (ATabSpaceBox: TdxRichEditPlainTextBox);
begin
  FPainter.DrawTabSpaceBox(ATabSpaceBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitPageNumberBox(APageNumberBox
  : TdxRichEditPlainTextBox);
begin
  FPainter.DrawPageNumberBox(APageNumberBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitNumberingListMarkBox
  (ANumberingListMarkBox: TdxRichEditNumberingListMarkBox);
begin
  FPainter.DrawNumberingListMarkBox(ANumberingListMarkBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitNumberingListWithSeparatorBox
  (ANumberingListWithSeparatorBox: TdxRichEditNumberingListWithSeparatorBox);
begin
  FPainter.DrawNumberingListWithSeparatorBox(ANumberingListWithSeparatorBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitUnderlineBox
  (AUnderlineBox: TdxRichEditUnderlineBox);
begin
  FPainter.DrawUnderlineBox(AUnderlineBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitStrikeoutBox
  (AStrikeoutBox: TdxRichEditStrikeoutBox);
begin
  FPainter.DrawStrikeoutBox(AStrikeoutBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitErrorBox
  (AErrorBox: TdxRichEditErrorBox);
begin
  FPainter.DrawErrorBox(AErrorBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitHighlightAreaBox(AHighlightAreaBox
  : TdxRichEditHighlightAreaBox);
begin
  FPainter.DrawHighlightAreaBox(AHighlightAreaBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitBookmarkStartBox(ABookmarkStartBox
  : TdxRichEditBookmarkBox);
begin
  FPainter.DrawBookmarkStartBox(ABookmarkStartBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitBookmarkEndBox(ABookmarkEndBox
  : TdxRichEditBookmarkBox);
begin
  FPainter.DrawBookmarkEndBox(ABookmarkEndBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitHiddenTextUnderlineBox
  (AHiddenTextUnderlineBox: TdxRichEditHiddenTextUnderlineBox);
begin
  FPainter.DrawHiddenTextUnderlineBox(AHiddenTextUnderlineBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitLineNumberBox(ALineNumberBox
  : TdxRichEditLineNumberBox);
begin
  FPainter.DrawLineNumberBox(ALineNumberBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitFieldHighlightAreaBox
  (AFieldHighlightAreaBox: TdxRichEditFieldHighlightAreaBox);
begin
  FPainter.DrawFieldHighlightAreaBox(AFieldHighlightAreaBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitRangePermissionHighlightAreaBox
  (ARangePermissionHighlightAreaBox
  : TdxRichEditRangePermissionHighlightAreaBox);
begin
  FPainter.DrawRangePermissionHighlightAreaBox
    (ARangePermissionHighlightAreaBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitRangePermissionStartBox
  (ARangePermissionStartBox: TdxRichEditRangePermissionBox);
begin
  FPainter.DrawRangePermissionStartBox(ARangePermissionStartBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitRangePermissionEndBox
  (ARangePermissionEndBox: TdxRichEditRangePermissionBox);
begin
  FPainter.DrawRangePermissionEndBox(ARangePermissionEndBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitCommentHighlightAreaBox
  (ACommentHighlightAreaBox: TdxRichEditCommentHighlightAreaBox);
begin
  FPainter.DrawCommentHighlightAreaBox(ACommentHighlightAreaBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitCommentStartBox(ACommentStartBox
  : TdxRichEditCommentBox);
begin
  FPainter.DrawCommentStartBox(ACommentStartBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitCommentEndBox(ACommentEndBox
  : TdxRichEditCommentBox);
begin
  FPainter.DrawCommentEndBox(ACommentEndBox);
end;

procedure TdxRichEditPagePainterVisitor.VisitFrame
  (AFrame: TdxRichEditLayoutFrame);
begin
  FPainter.DrawFrame(AFrame);
end;

procedure TdxRichEditPagePainterVisitor.VisitParagraphFrameBox
  (AParagraphFrameBox: TdxRichEditParagraphFrameBox);
begin
  FPainter.DrawParagraphFrame(AParagraphFrameBox);
end;

procedure TdxRichEditPagePainterVisitor.DefaultVisitPage
  (APage: TdxRichEditLayoutPage);
begin
  inherited VisitPage(APage);
end;

procedure TdxRichEditPagePainterVisitor.DefaultVisitPageArea
  (APageArea: TdxRichEditLayoutPageArea);
begin
  inherited VisitPageArea(APageArea);
end;

procedure TdxRichEditPagePainterVisitor.DefaultVisitColumn
  (AColumn: TdxRichEditLayoutColumn);
begin
  inherited VisitColumn(AColumn);
end;

procedure TdxRichEditPagePainterVisitor.DefaultVisitComments
  (APage: TdxRichEditLayoutPage);
begin
  inherited VisitComments(APage);
end;

procedure TdxRichEditPagePainterVisitor.DefaultVisitComment
  (AComment: TdxRichEditLayoutComment);
begin
  inherited VisitComment(AComment);
end;

procedure TdxRichEditPagePainterVisitor.DefaultVisitHeader
  (AHeader: TdxRichEditLayoutHeader);
begin
  inherited VisitHeader(AHeader);
end;

procedure TdxRichEditPagePainterVisitor.DefaultVisitFooter
  (AFooter: TdxRichEditLayoutFooter);
begin
  inherited VisitFooter(AFooter);
end;

procedure TdxRichEditPagePainterVisitor.DefaultVisitTextBox
  (ATextBox: TdxRichEditLayoutTextBox);
begin
  inherited VisitTextBox(ATextBox);
end;

procedure TdxRichEditPagePainterVisitor.DefaultVisitTable
  (ATable: TdxRichEditLayoutTable);
begin
  inherited VisitTable(ATable);
end;

procedure TdxRichEditPagePainterVisitor.DefaultVisitTableRow
  (ATableRow: TdxRichEditLayoutTableRow);
begin
  inherited VisitTableRow(ATableRow);
end;

procedure TdxRichEditPagePainterVisitor.DefaultVisitTableCell
  (ATableCell: TdxRichEditLayoutTableCell);
begin
  inherited VisitTableCell(ATableCell);
end;

procedure TdxRichEditPagePainterVisitor.DefaultVisitRowBackground
  (ARowExtendedBoxes: TdxRichEditRowExtendedBoxes);
begin
  inherited VisitRowBackground(ARowExtendedBoxes);
end;

procedure TdxRichEditPagePainterVisitor.DefaultVisitRow
  (ARow: TdxRichEditLayoutRow);
begin
  inherited VisitRow(ARow);
end;

procedure TdxRichEditPagePainterVisitor.DefaultVisitUnderlineBoxes
  (AUnderlineBoxes: TdxRichEditUnderlineBoxCollection);
begin
  inherited VisitUnderlineBoxes(AUnderlineBoxes);
end;

procedure TdxRichEditPagePainterVisitor.DefaultVisitStrikeoutBoxes
  (AStrikeoutBoxes: TdxRichEditStrikeoutBoxCollection);
begin
  inherited VisitStrikeoutBoxes(AStrikeoutBoxes);
end;

procedure TdxRichEditPagePainterVisitor.DefaultVisitBookmarkBoxes
  (ABookmarkBoxes: TdxRichEditBookmarkBoxCollection);
begin
...
constructor TdxRichEditLayoutElementSearcher.Create(APosition: Integer;
APieceTable: TdxPieceTable;
const AComparison: TdxFunc<IdxRichEditRangedLayoutElement, Boolean>);
begin
  inherited Create;
...
procedure TdxRichEditLayoutElementSearcher.VisitColumn
  (AColumn: TdxRichEditLayoutColumn);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitColumnBreakBox(AColumnBreakBox
  : TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitComment
  (AComment: TdxRichEditLayoutComment);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitCommentHighlightAreaBox
  (ACommentHighlightAreaBox: TdxRichEditCommentHighlightAreaBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitFieldHighlightAreaBox
  (AFieldHighlightAreaBox: TdxRichEditFieldHighlightAreaBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitFloatingObjectAnchorBox
  (AFloatingObjectAnchorBox: TdxRichEditFloatingObjectAnchorBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitFooter
  (AFooter: TdxRichEditLayoutFooter);
begin
  if Comparison(AFooter) and IsInSearchingDocument
    (IdxPieceTableContainer(AFooter)) then
    FindElement(AFooter)
  else
    inherited VisitFooter(AFooter);
end;

procedure TdxRichEditLayoutElementSearcher.VisitHeader
  (AHeader: TdxRichEditLayoutHeader);
begin
  if Comparison(AHeader) and IsInSearchingDocument
    (IdxPieceTableContainer(AHeader)) then
    FindElement(AHeader)
  else
    inherited VisitHeader(AHeader);
end;

procedure TdxRichEditLayoutElementSearcher.VisitHiddenTextUnderlineBox
  (AHiddenTextUnderlineBox: TdxRichEditHiddenTextUnderlineBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitHighlightAreaBox
  (AHighlightAreaBox: TdxRichEditHighlightAreaBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitHyphenBox
  (AHyphen: TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitInlinePictureBox
  (AInlinePictureBox: TdxRichEditInlinePictureBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitLineBreakBox
  (ALineBreakBox: TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitPageArea
  (APageArea: TdxRichEditLayoutPageArea);
begin
  if Comparison(APageArea) and IsInSearchingDocument
    (IdxPieceTableContainer(APageArea)) then
    FindElement(APageArea)
  else
    inherited VisitPageArea(APageArea);
end;

procedure TdxRichEditLayoutElementSearcher.VisitPageBreakBox
  (APageBreakBox: TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitPageNumberBox
  (APageNumberBox: TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitParagraphMarkBox
  (AParagraphMarkBox: TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitPlainTextBox
  (APlainTextBox: TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitRangePermissionHighlightAreaBox
  (ARangePermissionHighlightAreaBox
  : TdxRichEditRangePermissionHighlightAreaBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitSectionBreakBox(ASectionBreakBox
  : TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitSpaceBox
  (ASpaceBox: TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitSpecialTextBox(ASpecialTextBox
  : TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitStrikeoutBox
  (AStrikeoutBox: TdxRichEditStrikeoutBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitTable
  (ATable: TdxRichEditLayoutTable);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitTableCell
  (ATableCell: TdxRichEditLayoutTableCell);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitTableRow
  (ATableRow: TdxRichEditLayoutTableRow);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitTabSpaceBox
  (ATabSpaceBox: TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitTextBox
  (ATextBox: TdxRichEditLayoutTextBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.VisitUnderlineBox
  (AUnderlineBox: TdxRichEditUnderlineBox);
begin
...
procedure TdxRichEditLayoutElementSearcher.FindElement
  (AElement: IdxRichEditRangedLayoutElement);
var
  APieceTableContainer: IdxPieceTableContainer;
begin
  ...
  begin
    if not Supports(AElement, IdxPieceTableContainer, APieceTableContainer) then
      APieceTableContainer := AElement.GetParentByIntf(IdxPieceTableContainer)
        as IdxPieceTableContainer;
...
function TdxRichEditLayoutElementSearcher.IsInSearchingDocument(const AContainer
  : IdxPieceTableContainer): Boolean;
begin
...
constructor TdxRichEditDocumentLayout.Create(const AProvider
  : IdxRichEditDocumentLayoutProvider);
begin
  inherited Create;
  FProvider := AProvider;
...
procedure TdxRichEditDocumentLayout.RaiseDocumentLayoutInvalidated
  (AArgs: TdxDocumentLayoutInvalidatedEventArgs);
begin
...
procedure TdxRichEditDocumentLayout.RaisePageFormatted
...
procedure TdxRichEditDocumentLayout.OnDocumentLayoutInvalidated
  (ASender: TObject; E: TdxDocumentLayoutInvalidatedEventArgs);
var
  I: Integer;
begin
...
procedure TdxRichEditDocumentLayout.OnDocumentFormatted(ASender: TObject;
E: TdxEventArgs);
begin
...
procedure TdxRichEditDocumentLayout.OnPageFormatted(ASender: TObject;
E: TdxPageFormattedEventArgs);
begin
...
procedure TdxRichEditDocumentLayout.InitializePages(ADocumentLayout
  : TdxModelDocumentLayout; APageIndex: Integer);
var
  I: Integer;
begin
...
function TdxRichEditDocumentLayout.GetPage(APageIndex: Integer)
  : TdxRichEditLayoutPage;
var
...
function TdxRichEditDocumentLayout.GetPageCore(APageIndex: Integer;
ADocumentLayout: TdxModelDocumentLayout): TdxRichEditLayoutPage;
begin
...
function TdxRichEditDocumentLayout.TryGetPageAsyncSynchronously
  (APageIndex: Integer): TdxRichEditLayoutPage;
var
...
begin
  ...
  if (AModelDocumentLayout = nil) or
    (APageIndex >= AModelDocumentLayout.Pages.Count) or
  ...
  if not AModelDocumentLayout.Pages[APageIndex].SecondaryFormattingComplete then
    Provider.PerformPageSecondaryFormatting
      (AModelDocumentLayout.Pages[APageIndex]);
  Result := GetPageCore(APageIndex, AModelDocumentLayout);
end;

function TdxRichEditDocumentLayout.GetPageIndex
  (AElement: IdxRichEditLayoutElement): Integer;
var
  APage: TdxRichEditLayoutPage;
begin
  ...
  if APage = nil then
    APage := TdxRichEditLayoutPage
      (AElement.GetParentByType(TdxRichEditLayoutPage));
  Result := APage.Index;
end;
...
class function TdxRichEditDocumentLayout.GetText
  (AElement: IdxRichEditLayoutElement): string;
var
...
function TdxRichEditDocumentLayout.IsRangeSupported
  (AType: TdxRichEditLayoutType): Boolean;
begin
  case AType of
    TdxRichEditLayoutType.Page, TdxRichEditLayoutType.FloatingPicture,
      ...
      TdxRichEditLayoutType.CommentEndBox, TdxRichEditLayoutType.LineNumberBox,
...
class function TdxRichEditDocumentLayout.GetElementFromPage(APosition: Integer;
AClass: TClass; APieceTable: TdxPieceTable;
APage: TdxRichEditLayoutPage): TObject;
var
  AComparison: TdxFunc<IdxRichEditRangedLayoutElement, Boolean>;
  ASearcher: TdxRichEditLayoutElementSearcher;
begin
  AComparison :=
      function(const AElement: IdxRichEditRangedLayoutElement): Boolean
    var
      AObject: TObject;
    begin
  ...
  ASearcher := TdxRichEditLayoutElementSearcher.Create(APosition, APieceTable,
    AComparison);
  try
...
constructor TdxRichEditDocumentLayoutHelper.
  TdxParagraphFrameDrawingParentSearcher.Create(AParagraphFrame
  : TdxParagraphFrameBox);
begin
  FParagraphFrame := AParagraphFrame;
end;

procedure TdxRichEditDocumentLayoutHelper.
  TdxParagraphFrameDrawingParentSearcher.VisitColumn
  (AColumn: TdxRichEditLayoutColumn);
begin
  if FResult = nil then
    inherited VisitColumn(AColumn);
...
procedure TdxRichEditDocumentLayoutHelper.
  TdxParagraphFrameDrawingParentSearcher.VisitParagraphFrameBoxes
  (const AParagraphFrameContainer: IdxRichEditParagraphFrameContainer;
const ARowParent: IdxRichEditLayoutElement);
begin
end;
...
procedure TdxRichEditDocumentLayoutHelper.
  TdxParagraphFrameDrawingParentSearcher.VisitRow(ARow: TdxRichEditLayoutRow);
begin
...
procedure TdxRichEditDocumentLayoutHelper.
  TdxParagraphFrameDrawingParentSearcher.VisitTable
  (ATable: TdxRichEditLayoutTable);
begin
  if FResult = nil then
    inherited VisitTable(ATable);
...
procedure TdxRichEditDocumentLayoutHelper.
  TdxParagraphFrameDrawingParentSearcher.VisitTableCell
  (ATableCell: TdxRichEditLayoutTableCell);
begin
  if FResult = nil then
    inherited VisitTableCell(ATableCell);
...
procedure TdxRichEditDocumentLayoutHelper.
  TdxParagraphFrameDrawingParentSearcher.VisitTableRow
  (ATableRow: TdxRichEditLayoutTableRow);
begin
  if FResult = nil then
    inherited VisitTableRow(ATableRow);
...
procedure TdxRichEditDocumentLayoutHelper.
  TdxParagraphFrameDrawingParentSearcher.VisitTextBox
  (ATextBox: TdxRichEditLayoutTextBox);
begin
  if FResult = nil then
    inherited VisitTextBox(ATextBox);
...
class function TdxRichEditDocumentLayoutHelper.CreateLayoutRowCollection
  (AModelRows: TdxRowCollection; const AParent: IdxRichEditLayoutElement;
AIsTableCellRow: Boolean): TdxRichEditLayoutRowCollection;
begin
...
class procedure TdxRichEditDocumentLayoutHelper.InitializeRowCollection
  (AModelRows: TdxRowCollection; ALayoutRows: TdxRichEditLayoutRowCollection;
const AParent: IdxRichEditLayoutElement);
var
  I: Integer;
begin
...
class procedure TdxRichEditDocumentLayoutHelper.InitializeTableCellRowCollection
  (AModelRows: TdxRowCollection; ALayoutRows: TdxRichEditLayoutRowCollection;
const AParent: IdxRichEditLayoutElement);
var
  ATable: TdxRichEditLayoutTable;
...
begin
  ATable := AParent.GetParentByType(TdxRichEditLayoutTable)
    as TdxRichEditLayoutTable;
  for I := 0 to AModelRows.Count - 1 do
  begin
    ARow := TdxTableCellRow(AModelRows.List[I]);
    if ARow.IsTableCellRow and
      (ATable.ModelTable = ARow.CellViewInfo.TableViewInfo) then
...
class function TdxRichEditDocumentLayoutHelper.CreateLayoutTableCollection
  (AModelTables: TdxTableViewInfoCollection;
const AParent: IdxRichEditLayoutElement): TdxRichEditLayoutTableCollection;
var
...
begin
  ...
  begin
    if AModelTables[I].ParentTableCellViewInfo = nil then
      ALayoutTables.Add(TdxRichEditLayoutTable.Create(AModelTables[I],
        AParent));
  end;
  Result := ALayoutTables;
end;

class function TdxRichEditDocumentLayoutHelper.CreateBorders(const AElement
  : IdxRichEditLayoutElement; ALeftBorder, ARightBorder, ATopBorder,
  ABottomBorder: TdxBorderInfo): TdxRichEditBorders;
var
  AContainer: IdxPieceTableContainer;
  ALeftBorderThickness, ARightBorderThickness, ATopBorderThickness,
    ABottomBorderThickness: Integer;
  ALeft, ARight, ATop, ABottom: TdxRichEditLayoutBorder;
  AConverter: TdxDocumentModelUnitToLayoutUnitConverter;
begin
  AContainer := AElement.GetParentByIntf(IdxPieceTableContainer)
    as IdxPieceTableContainer;

  AConverter := AContainer.PieceTable.DocumentModel.
    ToDocumentLayoutUnitConverter;
  ALeftBorderThickness := CalculateLayoutBorderThickness(ALeftBorder.Width,
    AConverter);
  ARightBorderThickness := CalculateLayoutBorderThickness(ARightBorder.Width,
    AConverter);
  ATopBorderThickness := CalculateLayoutBorderThickness(ATopBorder.Width,
    AConverter);
  ABottomBorderThickness := CalculateLayoutBorderThickness(ABottomBorder.Width,
    AConverter);
  ...
  ABottom := TdxRichEditLayoutBorder.Create(ABottomBorder.Color,
    TdxRichEditTableBorderLineStyle(ABottomBorder.Style),
    ABottomBorderThickness);

  Result := TdxRichEditBorders.Create(ALeft, ARight, ATop, ABottom);
end;

class function TdxRichEditDocumentLayoutHelper.CalculateLayoutBorderThickness
...
class function TdxRichEditDocumentLayoutHelper.GetRangeForTablesAndRowsContainer
  (ARows: TdxRichEditLayoutRowCollection;
ATables: TdxRichEditLayoutTableCollection): TdxRichEditFixedRange;
var
  AFistRowRangeStart, ALastRowRangeEnd, AStart, AEnd: Integer;
  ALastRowRange: TdxRichEditFixedRange;
begin
  if ARows.Count <= 0 then
    Exit(TdxRichEditFixedRange.Create(ATables[0].Range.Start,
      ATables[0].Range.Length));
  ...
  if ATables.Count > 0 then
    AEnd := Max(ALastRowRangeEnd, ATables.Last.Range.Start +
      ATables.Last.Range.Length)
  else
    AEnd := ALastRowRangeEnd;
  Result := TdxRichEditFixedRange.Create(AStart, AEnd - AStart);
end;

class function TdxRichEditDocumentLayoutHelper.GetRangeFromRowByCoordinates
  (ARow: TdxRichEditLayoutRow; AX1, AX2: Integer): TdxRichEditFixedRange;
var
...
class function TdxRichEditDocumentLayoutHelper.CreateParagraphFrameBoxCollection
  (AModelColumn: TdxColumn; const AElement: IdxRichEditLayoutElement)
  : TdxRichEditParagraphFrameBoxCollection;
var
  I: Integer;
...
begin
  ...
  begin
    ...
    if not AParagraphFrame.GetParagraph.IsInCell then
      Result.Add(TdxRichEditParagraphFrameBox.Create(AParagraphFrame, AElement,
        AElement))
    else
    begin
      ASearcher := TdxParagraphFrameDrawingParentSearcher.Create
        (AParagraphFrame);
      try
        ASearcher.Visit(AElement);
        if ASearcher.Result <> nil then
          Result.Add(TdxRichEditParagraphFrameBox.Create(AParagraphFrame,
            ASearcher.Result, AElement));
      finally
        ASearcher.Free;
      end;
    end;
...
procedure TdxRichEditTextCollectorVisitor.VisitColumnBreakBox(AColumnBreakBox
  : TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditTextCollectorVisitor.VisitHyphenBox
  (AHyphen: TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditTextCollectorVisitor.VisitLineBreakBox
  (ALineBreakBox: TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditTextCollectorVisitor.VisitLineNumberBox(ALineNumberBox
  : TdxRichEditLineNumberBox);
begin
...
procedure TdxRichEditTextCollectorVisitor.VisitNumberingListMarkBox
  (ANumberingListMarkBox: TdxRichEditNumberingListMarkBox);
begin
...
procedure TdxRichEditTextCollectorVisitor.VisitPageBreakBox
  (APageBreakBox: TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditTextCollectorVisitor.VisitParagraphMarkBox
  (AParagraphMarkBox: TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditTextCollectorVisitor.VisitPlainTextBox
  (APlainTextBox: TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditTextCollectorVisitor.VisitSectionBreakBox(ASectionBreakBox
  : TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditTextCollectorVisitor.VisitSpaceBox
  (ASpaceBox: TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditTextCollectorVisitor.VisitSpecialTextBox(ASpecialTextBox
  : TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditTextCollectorVisitor.VisitTabSpaceBox
  (ATabSpaceBox: TdxRichEditPlainTextBox);
begin
...
procedure TdxRichEditTextCollectorVisitor.VisitPageNumberBox(APageNumberBox
  : TdxRichEditPlainTextBox);
begin
