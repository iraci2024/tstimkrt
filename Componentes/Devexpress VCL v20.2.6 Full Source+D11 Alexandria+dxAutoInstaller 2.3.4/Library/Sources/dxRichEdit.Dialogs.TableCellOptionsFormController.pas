...
type
  ...
  TdxTableCellOptionsFormControllerParameters = class
  ...
  protected
    ...
    class function EqualsWidthUnit(AValue1: TdxWidthUnit; AValue2: TdxWidthUnit)
      : Boolean; overload;
    class function EqualsWidthUnit(AValue1: TdxWidthUnitInfo;
      AValue2: TdxWidthUnit): Boolean; overload;
    function IsIdenticalCellMarginsAsTableMargins: Boolean;
    function GetUseCellInnerMargin(AAccessor
    ...
    procedure ResetCellMargins(ADefaultCellMargins: TdxCellMargins;
      ACellMargins: TdxCellMargins; ACellProperties: TdxTableCellProperties);
    procedure ApplyCellMargins(ACell: TdxTableCell;
  ...
  public
    ...
    property CellMarginsSameAsTable: Boolean read FCellMarginsSameAsTable
      write FCellMarginsSameAsTable;
...
constructor TdxTableCellOptionsFormControllerParameters.Create
  (const AControl: IdxRichEditControl; ASelectedCells: TdxTableCellList);
begin
...
constructor TdxTableCellOptionsFormController.Create(const AControllerParameters
  : TdxTableCellOptionsFormControllerParameters);
begin
  inherited Create;
...
var
  ...
  AFirstCellLeftMargin, AFirstCellRightMargin, AFirstCellTopMargin,
    AFirstCellBottomMargin: TdxMarginUnitBase;
  AIdenticalLeftMargins, AIdenticalRightMargins, AIdenticalTopMargins,
    AIdenticalBottomMargins: Boolean;
...
begin
  ...
  begin
    ...
    AIdenticalLeftMargins := AIdenticalLeftMargins and
      EqualsWidthUnit(AFirstCellLeftMargin, ACurrentCell.GetActualLeftMargin);
    AIdenticalRightMargins := AIdenticalRightMargins and
      EqualsWidthUnit(AFirstCellRightMargin, ACurrentCell.GetActualRightMargin);
    AIdenticalTopMargins := AIdenticalTopMargins and
      EqualsWidthUnit(AFirstCellTopMargin, ACurrentCell.GetActualTopMargin);
    AIdenticalBottomMargins := AIdenticalBottomMargins and
      EqualsWidthUnit(AFirstCellBottomMargin,
      ACurrentCell.GetActualBottomMargin);
  end;

  LeftMargin := TdxNullableInteger.IfThen(AIdenticalLeftMargins,
    AFirstCellLeftMargin.Value);
  RightMargin := TdxNullableInteger.IfThen(AIdenticalRightMargins,
    AFirstCellRightMargin.Value);
  TopMargin := TdxNullableInteger.IfThen(AIdenticalTopMargins,
    AFirstCellTopMargin.Value);
  BottomMargin := TdxNullableInteger.IfThen(AIdenticalBottomMargins,
    AFirstCellBottomMargin.Value);
end;

class function TdxTableCellOptionsFormController.EqualsWidthUnit
  (AValue1: TdxWidthUnit; AValue2: TdxWidthUnit): Boolean;
begin
  ...
  if (AValue1 = nil) or (AValue2 = nil) then
    ...
    Result := (AValue1.&Type = AValue2.&Type) and
      (AValue1.Value = AValue2.Value);
end;

function TdxTableCellOptionsFormController.
  IsIdenticalCellMarginsAsTableMargins: Boolean;
var
  ACellsCount, I: Integer;
  ACurrentCell: TdxTableCell;
  AUseLeftInnerMargin, AUseRightInnerMargin, AUseTopInnerMargin,
    AUseBottomInnerMargin: Boolean;
begin
  ACellsCount := FSourceCells.Count;
  for I := 0 to ACellsCount - 1 do
  begin
    ACurrentCell := FSourceCells[I];
    AUseLeftInnerMargin := GetUseCellInnerMargin
      (TdxLeftMarginUnit.PropertyAccessor, ACurrentCell);
    AUseRightInnerMargin := GetUseCellInnerMargin
      (TdxRightMarginUnit.PropertyAccessor, ACurrentCell);
    AUseTopInnerMargin := GetUseCellInnerMargin
      (TdxTopMarginUnit.PropertyAccessor, ACurrentCell);
    AUseBottomInnerMargin := GetUseCellInnerMargin
      (TdxBottomMarginUnit.PropertyAccessor, ACurrentCell);

    if AUseLeftInnerMargin or AUseRightInnerMargin or AUseTopInnerMargin or AUseBottomInnerMargin
    then
      Exit(False);
  end;
  Result := True;
...
function TdxTableCellOptionsFormController.GetUseCellInnerMargin
...
procedure TdxTableCellOptionsFormController.ApplyChangesCore(ADocumentModel
  : TdxDocumentModel);
var
...
begin
  ...
  begin
    ...
    if not NoWrap.IsNull and (ACurrentCellProperties.NoWrap <> NoWrap.Value)
    then
      ACurrentCellProperties.NoWrap := NoWrap.Value;
    if not FitText.IsNull and (ACurrentCellProperties.FitText <> FitText.Value)
    then
    ...
    if CellMarginsSameAsTable then
      ResetCellMargins(ADefaultCellMargins, ACurrentCellMargins,
        ACurrentCellProperties)
    else
      ApplyCellMargins(ACurrentCell, ACurrentCellMargins);
  end;
end;

procedure TdxTableCellOptionsFormController.ResetCellMargins(ADefaultCellMargins
  : TdxCellMargins; ACellMargins: TdxCellMargins;
...
procedure TdxTableCellOptionsFormController.ApplyCellMargins
  (ACell: TdxTableCell; ACellMargins: TdxCellMargins);
var
  ANewLeftMargin, ANewRightMargin, ANewTopMargin, ANewBottomMargin
    : TdxWidthUnitInfo;
begin
  if not LeftMargin.IsNull then
  begin
    ANewLeftMargin := TdxWidthUnitInfo.Create(TdxWidthUnitType.ModelUnits,
      LeftMargin.Value);
    try
  ...
  begin
    ANewRightMargin := TdxWidthUnitInfo.Create(TdxWidthUnitType.ModelUnits,
      RightMargin.Value);
    try
  ...
  begin
    ANewTopMargin := TdxWidthUnitInfo.Create(TdxWidthUnitType.ModelUnits,
      TopMargin.Value);
    try
  ...
  begin
    ANewBottomMargin := TdxWidthUnitInfo.Create(TdxWidthUnitType.ModelUnits,
      BottomMargin.Value);
    try
...
class function TdxTableCellOptionsFormController.EqualsWidthUnit
  (AValue1: TdxWidthUnitInfo; AValue2: TdxWidthUnit): Boolean;
begin
  if (AValue1 = nil) or (AValue2 = nil) then
    Result := False
  else
