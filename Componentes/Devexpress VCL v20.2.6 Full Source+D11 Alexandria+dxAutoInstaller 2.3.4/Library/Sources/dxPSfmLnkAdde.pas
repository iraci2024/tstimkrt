...
uses
  ...
  Menus, Forms, ComCtrls, ExtCtrls,
  ImgList, dxPSCore, dxPSForm, IniFiles, cxLookAndFeelPainters, cxButtons,
  cxControls, cxContainer, cxEdit, cxTextEdit,
  cxLabel, cxGroupBox, cxPC, cxListView, cxGraphics, cxLookAndFeels,
...
type
  ...
  public
    ...
    property SelectedReportLinkClass: TdxReportLinkClass
      read GetSelectedReportLinkClass;
  end;
...
function dxShowAddReportLinkClassDlg(var AData
  : TdxAddReportLinkClassDlgData): Boolean;
...
procedure TdxfmAddReportLinkClass.LoadFromIniFile(AIniFile: TCustomIniFile;
...
procedure TdxfmAddReportLinkClass.SaveToIniFile(AIniFile: TCustomIniFile;
  const ASectionName: string);
begin
...
procedure TdxfmAddReportLinkClass.LoadSorting(AIniFile: TCustomIniFile;
  const ASectionName: string);
begin
...
procedure TdxfmAddReportLinkClass.SaveSorting(AIniFile: TCustomIniFile;
  const ASectionName: string);
begin
...
procedure TdxfmAddReportLinkClass.lvItemsColumnClick(Sender: TObject;
  Column: TListColumn);
const
...
begin
  ...
  else if FSortedColumnIndex <> -1 then
  begin
    RefreshList;
...
procedure TdxfmAddReportLinkClass.lvItemsCompare(Sender: TObject;
        ...
        try
          ...
          begin
            ...
            begin
              ...
              if J = 0 then
                AItem.ImageIndex := dxPSDsgProxies.dxIdeImagesProvider.
                  ImageIndexes[AComponentClass];
...
procedure TdxfmAddReportLinkClass.SetColumnSortMark(AIndex: Integer;
...
procedure TdxfmAddReportLinkClass.SortColumn(Column: TListColumn;
  ASortOrder: TSortOrder);
var
  AItem: TListItem;
begin
