...
uses
  SysUtils, Classes, dxSpreadSheetCore, dxSpreadSheetClasses,
  dxSpreadSheetPackedFileFormatCore, dxXMLDoc, dxCustomTree;
...
class function TdxSpreadSheetODSFormat.CanReadFromStream
...
class function TdxSpreadSheetODSFormat.CreateFormatSettings
...
class function TdxSpreadSheetODSFormat.GetReader
  : TdxSpreadSheetCustomReaderClass;
begin
  Result := TdxSpreadSheetODSReader;
end;

class function TdxSpreadSheetODSFormat.GetWriter
