...
function TContextDesignerController.IsEntitiesPackages
  (ARttiPackage: TRttiPackage): Boolean;
var
...
function TContextDesignerController.LoadPackage(const AFileName: string)
  : TRttiPackage;
var
  AModule: HMODULE;
  APackages: TArray<TRttiPackage>;
...
procedure TdxEMFCustomConnectionSelectionEditor.RequiresUnits
  (Proc: TGetStrProc);
var
  I: Integer;
...
begin
  ...
  begin
    ...
    begin
      ...
      AProviderSQLClass := TdxEMFDataProviderOptionsAccess(AItem.Options)
        .ProviderSQLClass;
...
begin
  ...
  if TdxEMFCustomDataSetAccess(ADataSet).DataContext <> nil then
    AEntityClasses := TdxEMFCustomDataContextAccess
      (TdxEMFCustomDataSetAccess(ADataSet).DataContext).GetEntityClasses()
  else if TdxEMFCustomDataSetAccess(ADataSet).PackageName <> '' then
    AEntityClasses := TdxEMFCustomDataContextAccess.GetEntityClasses
      (TdxEMFCustomDataSetAccess(ADataSet).PackageName)
  else
    Exit;
...
begin
  if (TdxEMFCustomDataSetAccess(ADataSet).EntityName = '') and
    (TdxEMFCustomDataSetAccess(ADataSet).EntityInfo = nil) then
    Exit;
...
var
  ...
  I: Integer;
begin
  AEMFDataSource := ((GetComponent(0) as TCollectionItem)
    .Collection as TdxExpressionDefinitions).EMFDataSource;
  for I := 0 to TdxCustomEMFQueryDataSourceAccess(AEMFDataSource)
    .QueryProperties.FieldExpressions.Count - 1 do
  begin
    AFieldExpression := TdxCustomEMFQueryDataSourceAccess(AEMFDataSource)
      .QueryProperties.FieldExpressions[I];
...
begin
  ...
  RegisterPropertyEditor(TypeInfo(TdxDBEngine), TdxEMFDataProviderOptions,
    'DBEngine', TdxEMFDBEngineProperty);

  RegisterPropertyEditor(TypeInfo(string), TdxEMFDataContext, 'PackageName',
    TdxEMFPackageNameProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxEMFDataContext, 'PackageFileName',
    TdxEMFPackageFileNameProperty);

  RegisterPropertyEditor(TypeInfo(string), TdxEMFCustomDataSet, 'PackageName',
    TdxEMFPackageNameProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxEMFCustomDataSet, 'EntityName',
    TdxEMFEntityNameProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxEMFTable, 'DetailFields',
    TdxEMFFieldNamesProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxEMFTable, 'IndexName',
    TdxEMFIndexNameProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxEMFTable, 'IndexFieldNames',
    TdxEMFFieldNamesProperty);

  RegisterPropertyEditor(TypeInfo(string), TdxCustomEMFQueryProperties,
    'CriteriaText', TdxEMFCriteriaOperatorTextProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxCustomEMFQueryProperties,
    'GroupCriteriaText', TdxEMFCriteriaOperatorTextProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxEMFCustomQueryDataSet,
    'CriteriaText', TdxEMFCriteriaOperatorTextProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxEMFCustomQueryDataSet,
    'GroupCriteriaText', TdxEMFCriteriaOperatorTextProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxFieldExpression, 'ExpressionText',
    TdxEMFCriteriaOperatorTextProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxSortByExpressionDefinition,
    'ExpressionText', TdxEMFSelectExpressionTextProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxGroupByExpressionDefinition,
    'ExpressionText', TdxEMFSelectExpressionTextProperty);

  RegisterSelectionEditor(TdxEMFCustomDataProvider,
    TdxEMFCustomConnectionSelectionEditor);

  RegisterPropertiesInCategory(sDatabaseCategoryName, TdxEMFCustomDataSet,
    ['EntityName', 'DataContext', '*CriteriaText', 'FieldExpressions',
    'PackageName']);

  RegisterPropertiesInCategory(sDatabaseCategoryName, TdxEMFCustomQueryDataSet,
    [ { 'SkipSelectedRecords', 'TopSelectedRecords', }
    'GroupByExpressionDefinitions', 'SortByExpressionDefinitions']);
