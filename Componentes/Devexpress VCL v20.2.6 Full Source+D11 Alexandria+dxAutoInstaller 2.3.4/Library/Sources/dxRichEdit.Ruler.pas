...
{$IFDEF DELPHIXE2}
  System.UITypes,
{$ENDIF}
  Types, SysUtils, ActiveX, Windows, Messages, Generics.Defaults,
  Generics.Collections,
  Controls, SyncObjs, Classes, Graphics, dxCore, dxGDIPlusClasses,
  cxGraphics, dxCoreClasses, dxCoreGraphics, cxControls, cxGeometry,
  cxLookAndFeels,
...
type
  ...
  TdxGenerateImageDelegate = reference to procedure(AGpCanvas: TdxGPCanvas;
    const ABounds: TRect; AColor: TdxAlphaColor);

  TdxRulerFont = TFont;

  TdxRulerTickmarkType = (Tick, HalfTick, QuarterTick);
  ...
  public
    ...
    function GetNearPrimaryCoordinate(const ABounds: TRect): Integer; overload;
      virtual; abstract;
    function GetNearPrimaryCoordinate(const ABounds: TdxRectF): Single;
    ...
    function GetSecondaryCoordinate(const APoint: TPoint): Integer;
      virtual; abstract;
    function SetNearPrimaryCoordinate(const ABounds: TdxRectF; AValue: Single)
      : TdxRectF; virtual; abstract;
  end;
  ...
  public
    ...
    function CreatePoint(APrimary: Integer; ASecondary: Integer)
      : TPoint; override;
    function GetNearPrimaryCoordinate(const ABounds: TdxRectF): Single;
      override;
    function GetFarPrimaryCoordinate(const ABounds: TdxRectF): Single; override;
    function GetPrimaryCoordinateExtent(const ABounds: TdxRectF)
      : Single; override;
  ...
  protected
    ...
    procedure DrawControlBackground(AGraphics: TdxGraphics;
      const ABounds: TRect); virtual; abstract;
    ...
    procedure DrawTickmarkNumber(ATickMark: TdxRulerTickmarkNumber);
      virtual; abstract;
    ...
    property VerticalTextPaddingBottom: Integer
      read GetVerticalTextPaddingBottom;
  ...
  public
    ...
    function CalculateTotalRulerSize(ATextSize: Integer): Integer;
      virtual; abstract;
    procedure Draw(AGraphics: TdxGraphics);
    class procedure DrawImage(AGraphics: TdxGraphics; AImage: TdxGPImage;
      X, Y: Integer); overload; static;
    class procedure DrawImage(AGraphics: TdxGraphics; AImage: TdxGPImage;
      const ABounds: TRect); overload; static;
    class function GenerateImage(const ABounds: TRect; AColor: TdxAlphaColor;
  ...
  protected
    ...
    function GetNearestIndex(APos: Integer;
      ATickmarks: TdxList<TdxRulerTickmark>; AIndex: Integer): Integer;
  ...
  public
    ...
    function CreateLineVisualFeedback(const AValueProvider
      : TdxRichEditMouseCustomVisualFeedbackState): IdxVisualFeedback;
      virtual; abstract;
  ...
  public
    ...
    procedure Activate(AHandler: TdxRulerMouseController;
      const AMousePosition: TPoint); virtual;
  ...
  public
    ...
    procedure Draw(APainter: TdxHorizontalRulerPainter); overload;
      virtual; abstract;
    procedure Draw(APainter: TdxVerticalRulerPainter); overload;
      virtual; abstract;
  ...
  public
    constructor Create(const AControl: TdxRulerControlBase;
      const ABounds: TdxRectF; const ANumber: string);
  ...
  protected
    ...
    function GetDocumentLayoutDistanceToCurrentAreaStart(AMouseX: Integer)
      : Integer; virtual;
    function GetDocumentLayoutDistanceToCellLeft(AMouseX: Integer)
      : Integer; virtual;
    function GetDocumentLayoutDistanceToCurrentAreaEnd(AMouseX: Integer)
      : Integer; virtual;
    function CalculateSize: TSize;

    property HorizontalRulerViewInfo: TdxHorizontalRulerViewInfo
      read GetHorizontalRulerViewInfo;
  public
    constructor Create(const AControl: TdxHorizontalRulerControl);
    function GetVisualFeedbackValue(const AMousePosition: TPoint;
      APageViewInfo: TdxPageViewInfo): Integer; override;

    property HorizontalRulerControl: TdxHorizontalRulerControl
      read GetHorizontalRulerControl;
  end;
  ...
  public
    ...
    procedure Activate(AHandler: TdxRulerMouseController;
      const AMousePosition: TPoint); override;
  ...
  public
    constructor Create(const AControl: TdxHorizontalRulerControl;
      const ABounds: TRect; const ATabInfo: TdxTabInfo);
  ...
  public
    constructor Create(const AControl: TdxHorizontalRulerControl;
      const ABounds: TRect; ABorderIndex: Integer;
      ATableViewInfo: TdxTableViewInfo; ATableCell: TdxTableCell);
    destructor Destroy; override;
    procedure OnMove(const AMousePosition: TPoint); override;
  ...
  public
    constructor Create(const AControl: TdxHorizontalRulerControl;
      const ABounds: TRect; AIndent: Integer);
    procedure OnMove(const AMousePosition: TPoint); override;
    procedure OnMouseDoubleClick; override;
  ...
  public
    constructor Create(const AControl: TdxHorizontalRulerControl;
      const ABounds: TRect; AIndent: Integer;
      ALeftBottomHotZone: TdxLeftBottomHotZone; AFirstLineIndent: Integer);
  ...
  public
    constructor Create(const AControl: TdxHorizontalRulerControl;
      const ABounds: TRect; AIndent: Integer; ALeftIndent: Integer);
    procedure Commit(const AMousePosition: TPoint); override;
    function CreateEmptyClone: TdxRulerHotZone; override;
  end;
  ...
  public
    constructor Create(const AControl: TdxHorizontalRulerControl;
      const ABounds: TRect; AIndent: Integer; ARightBorder: Integer;
      AFirstLineIndentHotZone: TdxFirstLineIndentHotZone);
  ...
  protected
    ...
    function CalculateNewValue(const AMousePosition: TPoint): Integer;
      virtual; abstract;
  public
    constructor Create(const AControl: TdxHorizontalRulerControl;
      const ABounds: TRect; AColumnIndex: Integer);
    procedure AddFakeHotZone; override;
    procedure OnMouseDoubleClick; override;
    procedure OnMove(const AMousePosition: TPoint); override;
    procedure Commit(const AMousePosition: TPoint); override;
  ...
  public
    constructor Create(const AControl: TdxHorizontalRulerControl;
      const ABounds: TRect; AColumnIndex: Integer);
    procedure Commit(const AMousePosition: TPoint); override;
    function CreateCommand(const AMousePosition: TPoint)
  ...
  public
    ...
    property VerticalRulerControl: TdxVerticalRulerControl
      read GetVerticalRulerControl;
  end;
  ...
  public
    constructor Create(const AControl: TdxVerticalRulerControl;
      const ABounds: TRect; ATableViewInfo: TdxTableViewInfo;
  ...
  strict private
    class var FMeasureGraphics: TdxGraphics;
  ...
  strict private
    ...
    FIsReady: Boolean;
    function GetToDocumentLayoutUnitConverter
  ...
  protected
    ...
    function CalculatePageClientBounds(APageCalculator: TdxPageBoundsCalculator;
      AProperties: TdxSectionProperties): TRect;
    ...
    function CalculateClientBounds(const AControl: TdxRulerControlBase): TRect;
      virtual; abstract;
    function GetRulerLayoutPosition(AModelPosition: Integer): Integer;
      virtual; abstract;

    property IsMainPieceTable: Boolean read FIsMainPieceTable;
    property ToDocumentLayoutUnitConverter
      : TdxDocumentModelUnitToLayoutUnitConverter
      read GetToDocumentLayoutUnitConverter;
    property DocumentModel: TdxDocumentModel read GetDocumentModel;
    property Orientation: TdxOrientation read GetOrientation;
    property MaxRulerDimensionInModelUnits: Integer
      read GetMaxRulerDimensionInModelUnits;
    property IsReady: Boolean read FIsReady write FIsReady;
  public
    constructor Create(const AControl: TdxRulerControlBase;
      ASectionProperties: TdxSectionProperties; AIsMainPieceTable: Boolean);
    destructor Destroy; override;
    function GetRulerModelPosition(ALayoutPosition: Integer): Integer;
      virtual; abstract;

    property Control: TdxRulerControlBase read FControl;
    property SectionProperties: TdxSectionProperties read FSectionProperties;
    property Bounds: TRect read FBounds write FBounds;
    property RulerTickmarks: TdxObjectList<TdxRulerTickmark>
      read FRulerTickmarks;
    ...
    property DisplaySpaceAreaCollection: TList<TdxRectF>
      read FDisplaySpaceAreaCollection;
    property DisplayActiveAreaCollection: TList<TdxRectF>
      read FDisplayActiveAreaCollection;
...
{$ENDREGION}
  strict private
    ...
    function GetCellTextRight(ACellViewInfo: TdxTableCellViewInfo;
      AApplyZoomFactor: Boolean): Integer;
  ...
  protected
    ...
    function CalculateClientBounds(const AControl: TdxRulerControlBase)
      : TRect; override;
    ...
    function GetRulerAreaCollection(ASectionProperties: TdxSectionProperties;
    ...
    function GetTableHotZoneLeft(ATableAlignedPositionsIndex: Integer)
      : Integer; virtual;
    ...
    procedure CalculateTabsBoundsCore(ATabsController
      : TdxTabsController); virtual;
    procedure AddTabHotZone(const ATabInfo: TdxTabInfo; APos: Integer);
    function AddTabHotZoneCore(const ATabInfo: TdxTabInfo; APos: Integer)
      : TdxTabHotZone;
    function CreateTabHotZone(const ATabInfo: TdxTabInfo; const ABounds: TRect)
      : TdxTabHotZone;
    ...
    function GetRulerModelPositionRelativeToTableCellViewInfo(ALayoutPosition
      : Integer): Integer;
    ...
    procedure AddLeftIndentHotZone(AParagraph: TdxParagraph;
      ALeftIndent: Integer; ARightBorder: Integer; AFirstIndent: Integer);
    function AddFirstLineHotZone(AParagraph: TdxParagraph;
      ARightBorder: Integer; AFirstIndent: Integer; AHeight: Integer)
      : TdxFirstLineIndentHotZone;
    procedure AddRightIndentHotZone(AParagraph: TdxParagraph;
      ARightIndent: Integer; ALeftBorder: Integer);
  ...
  public
    constructor Create(const AControl: TdxHorizontalRulerControl;
      ...
      ACurrentActiveAreaIndex: Integer; AIsMainPieceTable: Boolean;
      ATableCellViewInfo: TdxTableCellViewInfo;
      ATableAlignedPositions: TdxSortedList<Integer>);
    destructor Destroy; override;

    function GetAdditionalCellIndent(ACellViewInfo: TdxTableCellViewInfo;
      AApplyZoomFactor: Boolean): Integer; overload;
    function GetAdditionalCellIndent(AApplyZoomFactor: Boolean)
      : Integer; overload;
    ...
    property TabTypeToggleBackground: TdxTabTypeToggleBackgroundHotZone
      read FTabTypeToggleBackground;
    ...
    property DisplayDefaultTabsCollection: TdxRectList
      read FDisplayDefaultTabsCollection;
    property TableCellViewInfo: TdxTableCellViewInfo read FTableCellViewInfo;
  end;

  { TdxRulerHotZonesComparer }

  TdxRulerHotZonesComparer = class(TcxIUnknownObject,
    IComparer<TdxRulerHotZone>)
  public
  ...
  protected
    ...
    property TableVerticalPositions: TdxSortedList<Integer>
      read FTableVerticalPositions;
    property TableCellViewInfo: TdxTableCellViewInfo read FTableCellViewInfo;
  public
    constructor Create(const AControl: TdxVerticalRulerControl;
      ASectionProperties: TdxSectionProperties; AIsMainPieceTable: Boolean;
  ...
  strict private
    ...
    function CanDrawHotZone(AHotZone: TdxRulerHotZone;
      out AImage: TdxGPImage): Boolean;
  ...
  protected
    ...
    procedure DrawHotZone(AHotZone: TdxRulerHotZone; AGraphics: TdxGraphics;
      const ALocation: TPoint); overload;
    procedure DrawHotZone(AHotZone: TdxRulerHotZone; AGraphics: TdxGraphics;
      const ABounds: TRect); overload;
    function CalculateHotZoneSize(AHotZone: TdxHorizontalRulerHotZone)
      : TSize; virtual;
  ...
  protected
    ...
    function GenerateTabImage(const AGenerateImage: TdxGenerateImageDelegate;
      AColor: TdxAlphaColor): TdxGPImage; virtual;
    procedure DrawTabImageBottom(AGpCanvas: TdxGPCanvas; const ABounds: TRect;
      AColor: TdxAlphaColor);
    procedure DrawLeftTabImage(AGpCanvas: TdxGPCanvas; const ABounds: TRect;
      AColor: TdxAlphaColor);
    procedure DrawRightTabImage(AGpCanvas: TdxGPCanvas; const ABounds: TRect;
      AColor: TdxAlphaColor);
    procedure DrawCenterTabImage(AGpCanvas: TdxGPCanvas; const ABounds: TRect;
      AColor: TdxAlphaColor);
    procedure DrawDecimalTabImage(AGpCanvas: TdxGPCanvas; const ABounds: TRect;
      AColor: TdxAlphaColor);
  ...
  protected
    ...
    procedure DrawTickmarkImage(AGpCanvas: TdxGPCanvas; const ABounds: TRect;
      AColor: TdxAlphaColor);
    ...
    procedure DrawTabTypeToggleBackground(AGraphics: TdxGraphics;
      const ABounds: TRect); virtual; abstract;
    procedure DrawTabTypeToggleActiveArea(AGraphics: TdxGraphics;
      const ABounds: TRect); virtual; abstract;
  ...
  protected
    ...
    property ControlBackgroundColor: TdxAlphaColor
      read GetControlBackgroundColor;
    property RulerAreaBackgroundColor: TdxAlphaColor
      read GetRulerAreaBackgroundColor;
    property ActiveAreaColor: TdxAlphaColor read GetActiveAreaColor;
    property TabTypeToggleBorderColor: TdxAlphaColor
      read GetTabTypeToggleBorderColor;
  end;
  ...
  protected
    function CreateImage(AHotZone: TdxRulerHotZone): TdxGPImage; override;
    function GetSkinElementImage(AElement: TdxSkinElement; AImageIndex: Integer;
      AState: TdxSkinElementState): TdxGPImage; virtual;
  ...
  protected
    ...
    function GetTableAlignedPositions(ATableViewInfo: TdxTableViewInfo)
      : TdxSortedList<Integer>;
    function GetTableCellViewInfo(AIsMainPieceTable: Boolean)
      : TdxTableCellViewInfo;
    function GetTableVerticalPositions(AIsMainPieceTable: Boolean)
      : TdxSortedList<Integer>;

    property SkinInfo: TdxSkinInfo read FSkinInfo;
  public
    constructor Create(ARichEditControl: TdxCustomRichEditControl);
      reintroduce; virtual;
    destructor Destroy; override;
...
function CreateRotatedFont(AFont: TFont;
  ADirection: TcxVerticalTextOutDirection): HFONT;
const
...
function TdxHorizontalOrientation.GetPrimaryCoordinate
  (const APoint: TPoint): Integer;
begin
  Result := APoint.X;
end;

function TdxHorizontalOrientation.GetSecondaryCoordinate
  (const APoint: TPoint): Integer;
begin
  Result := APoint.Y;
end;

function TdxHorizontalOrientation.CreatePoint(APrimary: Integer;
  ASecondary: Integer): TPoint;
begin
  Result.Init(APrimary, ASecondary);
end;

function TdxHorizontalOrientation.GetNearPrimaryCoordinate
  (const ABounds: TdxRectF): Single;
begin
  Result := ABounds.Left;
end;

function TdxHorizontalOrientation.GetFarPrimaryCoordinate
  (const ABounds: TdxRectF): Single;
begin
  Result := ABounds.Right;
end;

function TdxHorizontalOrientation.GetPrimaryCoordinateExtent
  (const ABounds: TdxRectF): Single;
begin
...
function TdxHorizontalOrientation.SetNearPrimaryCoordinate
  (const ABounds: TdxRectF; AValue: Single): TdxRectF;
begin
  Result.Init(AValue, ABounds.Top, AValue + (ABounds.Right - ABounds.Left),
    ABounds.Bottom);
end;

{ TdxVerticalOrientation }

function TdxVerticalOrientation.GetPrimaryCoordinate(const APoint
  : TPoint): Integer;
begin
  Result := APoint.Y;
end;

function TdxVerticalOrientation.GetSecondaryCoordinate
  (const APoint: TPoint): Integer;
begin
  Result := APoint.X;
end;

function TdxVerticalOrientation.CreatePoint(APrimary: Integer;
  ASecondary: Integer): TPoint;
begin
  Result.Init(ASecondary, APrimary);
end;

function TdxVerticalOrientation.GetNearPrimaryCoordinate(const ABounds
  : TdxRectF): Single;
begin
  Result := ABounds.Top;
end;

function TdxVerticalOrientation.GetFarPrimaryCoordinate(const ABounds
  : TdxRectF): Single;
begin
  Result := ABounds.Bottom;
end;

function TdxVerticalOrientation.GetPrimaryCoordinateExtent
  (const ABounds: TdxRectF): Single;
begin
...
function TdxVerticalOrientation.SetNearPrimaryCoordinate(const ABounds
  : TdxRectF; AValue: Single): TdxRectF;
begin
  Result.Init(ABounds.Left, AValue, ABounds.Right,
    AValue + (ABounds.Bottom - ABounds.Top));
end;
...
class procedure TdxRulerPainterBase.DrawImage(AGraphics: TdxGraphics;
  AImage: TdxGPImage; X, Y: Integer);
begin
  AGraphics.Draw(AImage, TRect.CreateSize(X, Y, AImage.Width, AImage.Height));
end;

class procedure TdxRulerPainterBase.DrawImage(AGraphics: TdxGraphics;
  AImage: TdxGPImage; const ABounds: TRect);
begin
  AGraphics.Draw(AImage, ABounds);
end;

class function TdxRulerPainterBase.GenerateImage(const ABounds: TRect;
  AColor: TdxAlphaColor; const AGenerateImage: TdxGenerateImageDelegate)
  : TdxGPImage;
var
  ASize: TSize;
...
constructor TdxTickMarkPositionComparable.Create(const AOrientation
  : TdxOrientation; APos: Integer);
begin
  FOrientation := AOrientation;
  FPos := APos;
end;

function TdxTickMarkPositionComparable.CompareTo(const ATickMark
  : TdxRulerTickmark): Integer;
begin
  if FPos < FOrientation.GetNearPrimaryCoordinate(ATickMark.Bounds) then
    Result := 1
  else if FPos > FOrientation.GetFarPrimaryCoordinate(ATickMark.Bounds) then
    Result := -1
  else
    Result := 0;
end;
...
procedure TdxRulerMouseController.CalculateAndSaveHitInfo
  (const E: TdxMouseEventArgs);
begin
end;
...
function TdxRulerMouseController.GetHotZoneBounds
  (AHotZone: TdxRulerHotZone): TRect;
begin
...
begin
  ...
  if not TdxAlgorithms1<TdxRulerTickmark>.BinarySearch(ATickmarks,
    AComparer.CompareTo, AIndex) then
  begin
...
function TdxRulerMouseController.GetNearestIndex(APos: Integer;
  ATickmarks: TdxList<TdxRulerTickmark>; AIndex: Integer): Integer;
var
...
begin
  if AIndex > 0 then
  begin
    ANearInterval := APos - GetFarPrimaryCoordinate
      (ATickmarks[AIndex - 1].Bounds);
...
function TdxRulerMouseController.GetTickMiddlePoint(const ATickmarkBounds
  : TdxRectF): Single;
begin
  Result := GetNearPrimaryCoordinate(ATickmarkBounds) +
    ATickmarkBounds.Width / 2;
end;

function TdxRulerMouseController.GetPrimaryCoordinate
  (const APoint: TPoint): Integer;
begin
  Result := Orientation.GetPrimaryCoordinate(APoint);
end;

function TdxRulerMouseController.GetSecondaryCoordinate
  (const APoint: TPoint): Integer;
begin
  Result := Orientation.GetSecondaryCoordinate(APoint);
end;

function TdxRulerMouseController.CreatePoint(APrimary: Integer;
  ASecondary: Integer): TPoint;
begin
  Result := Orientation.CreatePoint(APrimary, ASecondary);
end;

function TdxRulerMouseController.GetNearPrimaryCoordinate
  (const ABounds: TdxRectF): Single;
begin
  Result := Orientation.GetNearPrimaryCoordinate(ABounds);
end;

function TdxRulerMouseController.GetFarPrimaryCoordinate(const ABounds
  : TdxRectF): Single;
begin
  Result := Orientation.GetFarPrimaryCoordinate(ABounds);
end;

function TdxRulerMouseController.GetPrimaryCoordinateExtent
  (const ABounds: TdxRectF): Single;
begin
...
function TdxRulerMouseController.SetNearPrimaryCoordinate
  (const ABounds: TdxRectF; AValue: Single): TdxRectF;
begin
...
function TdxRulerElementPainter.CanDrawHotZone(AHotZone: TdxRulerHotZone;
  out AImage: TdxGPImage): Boolean;
begin
  AImage := nil;
...
function TdxRulerElementPainter.CreateImage(AHotZone: TdxRulerHotZone)
  : TdxGPImage;
begin
  Result := nil;
end;
...
begin
  if not CanDrawHotZone(AHotZone, AImage) then
    Exit;
  TdxHorizontalRulerPainter.DrawImage(AGraphics, AImage, ALocation.X,
    ALocation.Y);
end;
...
function TdxRulerElementPainter.CalculateHotZoneSize
  (AHotZone: TdxHorizontalRulerHotZone): TSize;
var
  AImage: TdxGPImage;
begin
  AImage := GetImage(AHotZone);
  if AImage <> nil then
    Result := Ruler.PixelsToLayoutUnits(TSize.Create(AImage.Width,
      AImage.Height))
  else
    Result := Ruler.PixelsToLayoutUnits
      (ScaleFactor.Apply(TSize.Create(16, 16)));
end;

{ TdxColorBasedRulerElementPainter }

constructor TdxColorBasedRulerElementPainter.Create
  (ARuler: TdxHorizontalRulerControl; AElementColor: TdxAlphaColor);
begin
  inherited Create(ARuler);
  FEnabledElementColor := AElementColor;
  FDisabledElementColor := TdxAlphaColors.FromColor
    (dxGetLighterColor(TdxAlphaColors.ToColor(AElementColor), 33));
end;

function TdxColorBasedRulerElementPainter.CreateImage(AHotZone: TdxRulerHotZone)
  : TdxGPImage;
...
function TdxColorBasedRulerElementPainter.GenerateTabImage(const AGenerateImage
  : TdxGenerateImageDelegate; AColor: TdxAlphaColor): TdxGPImage;
var
  AHeight: Integer;
begin
  AHeight := Max(ScaleFactor.Apply(6),
    Ruler.LayoutUnitsToPixelsH
    (Round(2 * Ruler.ViewInfo.ClientBounds.Height / 5)));
  Result := TdxRulerPainterBase.GenerateImage
    (TRect.CreateSize(0, 0, 2 * AHeight, AHeight), AColor, AGenerateImage);
end;

procedure TdxColorBasedRulerElementPainter.DrawTabImageBottom
  (AGpCanvas: TdxGPCanvas; const ABounds: TRect; AColor: TdxAlphaColor);
var
  ARect: TRect;
begin
  ARect := ABounds;
...
procedure TdxColorBasedRulerElementPainter.DrawLeftTabImage
  (AGpCanvas: TdxGPCanvas; const ABounds: TRect; AColor: TdxAlphaColor);
var
  ARect: TRect;
begin
...
procedure TdxColorBasedRulerElementPainter.DrawRightTabImage
  (AGpCanvas: TdxGPCanvas; const ABounds: TRect; AColor: TdxAlphaColor);
var
  ARect: TRect;
begin
...
procedure TdxColorBasedRulerElementPainter.DrawCenterTabImage
  (AGpCanvas: TdxGPCanvas; const ABounds: TRect; AColor: TdxAlphaColor);
var
  ARect: TRect;
  AWidth: Integer;
...
procedure TdxColorBasedRulerElementPainter.DrawDecimalTabImage
  (AGpCanvas: TdxGPCanvas; const ABounds: TRect; AColor: TdxAlphaColor);
var
  ARect: TRect;
begin
...
function TdxHorizontalRulerPainter.CalculateTotalRulerSize
  (ATextSize: Integer): Integer;
begin
  Result := ATextSize + PaddingTop + PaddingBottom + VerticalTextPaddingBottom +
    VerticalTextPaddingTop;
end;
...
begin
  Result := TdxRulerPainterBase.GenerateImage
    (Ruler.ViewInfo.DisplayDefaultTabBounds, DefaultTabColor,
    DrawTickmarkImage);
end;

function TdxHorizontalRulerPainter.GenerateTickImageCore(const ABounds: TRect)
  : TdxGPImage;
begin
  Result := TdxRulerPainterBase.GenerateImage(ABounds, ForeColor,
    DrawTickmarkImage);
end;

function TdxHorizontalRulerPainter.GetDefaultTabColor: TdxAlphaColor;
begin
  Result := TdxAlphaColors.FromColor
    (LookAndFeelPainter.RichEditRulerDefaultTabColor);
end;
...
procedure TdxHorizontalRulerPainter.DrawTickmarkImage(AGpCanvas: TdxGPCanvas;
  const ABounds: TRect; AColor: TdxAlphaColor);
begin
...
begin
  DrawTabTypeToggleBackground(AGraphics,
    Ruler.ViewInfo.TabTypeToggleBackground.Bounds);
  DrawTabTypeToggleActiveArea(AGraphics,
    Ruler.ViewInfo.TabTypeToggleHotZone.DisplayBounds);
  Ruler.Painter.ElementPainter.DrawHotZone
    (Ruler.ViewInfo.TabTypeToggleHotZone.HotZone, AGraphics,
    Ruler.ViewInfo.TabTypeToggleHotZone.HotZoneBounds.Location);
end;
...
begin
  ...
  if ACaretPosition.PageViewInfo = nil then
    Exit;
  try
    APhysicalLeftInvisibleWidth :=
      View.HorizontalScrollController.GetPhysicalLeftInvisibleWidth;
    AViewBoundsLeft := Ruler.LayoutUnitsToPixelsH(AControl.ViewBounds.Left -
      APhysicalLeftInvisibleWidth);
...
procedure TdxHorizontalRulerPainter.DrawTickmarkNumber
  (ATickMark: TdxRulerTickmarkNumber);
begin
  Graphics.DrawString(ATickMark.Number, Ruler.TickMarkFont, ForeColorBrush,
    ATickMark.DisplayBounds.Location, TdxGPStringFormat.GenericTypographic);
end;

procedure TdxHorizontalRulerPainter.DrawTickmarkHalf
  (ATickMark: TdxRulerTickmarkHalf);
var
  ABounds: TdxRectF;
begin
...
procedure TdxHorizontalRulerPainter.DrawTickmarkQuarter
  (ATickMark: TdxRulerTickmarkQuarter);
var
  ABounds: TdxRectF;
begin
  ABounds := ATickMark.DisplayBounds;
  DrawImage(Graphics, FQuarterTickImage, Trunc(ABounds.Left),
    Trunc(ABounds.Top));
end;

procedure TdxHorizontalRulerPainter.DrawDefaultTabMark(const ABounds: TRect);
begin
  DrawImage(Graphics, FDefaultTabImage, Trunc(ABounds.Left),
    Trunc(ABounds.Top));
end;

{ TdxHorizontalRulerColorBasedPainter }

procedure TdxHorizontalRulerColorBasedPainter.DrawControlBackground
  (AGraphics: TdxGraphics; const ABounds: TRect);
begin
  AGraphics.FillRectangle(ABounds, ControlBackgroundColor);
end;

procedure TdxHorizontalRulerColorBasedPainter.DrawTabTypeToggleBackground
  (AGraphics: TdxGraphics; const ABounds: TRect);
begin
  AGraphics.FillRectangle(ABounds, ControlBackgroundColor);
end;

procedure TdxHorizontalRulerColorBasedPainter.DrawTabTypeToggleActiveArea
  (AGraphics: TdxGraphics; const ABounds: TRect);
var
  R: TRect;
begin
...
procedure TdxHorizontalRulerColorBasedPainter.DrawRulerAreaBackground
  (const ABounds: TRect);
begin
  Graphics.FillRectangle(ABounds, RulerAreaBackgroundColor);
end;

procedure TdxHorizontalRulerColorBasedPainter.DrawActiveArea
  (const ABounds: TdxRectF);
begin
  Graphics.FillRectangle(TRect.Round(ABounds), ActiveAreaColor);
end;

procedure TdxHorizontalRulerColorBasedPainter.DrawSpaceArea
  (const ABounds: TdxRectF);
begin
  Graphics.FillRectangle(TRect.Round(ABounds), ControlBackgroundColor);
end;

function TdxHorizontalRulerColorBasedPainter.CreateElementPainter
  : TdxRulerElementPainter;
begin
...
begin
  Result := TdxAlphaColors.FromColor
    (LookAndFeelPainter.RichEditRulerActiveAreaColor);
end;

function TdxHorizontalRulerColorBasedPainter.GetControlBackgroundColor
  : TdxAlphaColor;
begin
  Result := TdxAlphaColors.FromColor
    (LookAndFeelPainter.RichEditRulerControlColor);
end;

function TdxHorizontalRulerColorBasedPainter.GetRulerAreaBackgroundColor
  : TdxAlphaColor;
begin
  Result := TdxAlphaColors.FromColor
    (LookAndFeelPainter.RichEditRulerInactiveAreaColor);
end;

function TdxHorizontalRulerColorBasedPainter.GetTabTypeToggleBorderColor
  : TdxAlphaColor;
begin
  Result := TdxAlphaColors.FromColor
    (LookAndFeelPainter.RichEditRulerTabTypeToggleBorderColor);
end;
...
function TdxRulerElementSkinPainter.GetSkinElementImage
  (AElement: TdxSkinElement; AImageIndex: Integer; AState: TdxSkinElementState)
  : TdxGPImage;
begin
...
function TdxRulerElementSkinPainter.CreateImage(AHotZone: TdxRulerHotZone)
  : TdxGPImage;
const
  ASkinElementStateMap: array [Boolean] of TdxSkinElementState = (esDisabled,
    esNormal);
...
begin
  Result := GetSkinElementImage(GetSkinElement, GetImageIndex,
    ASkinElementStateMap[AHotZone.Enabled]);
end;
...
begin
  Result := Ruler.ScaleFactor.Apply
    (SkinInfo.RichEditRulerBackgroundHorz.ContentOffset.Top);
...
begin
  Result := Ruler.ScaleFactor.Apply
    (SkinInfo.RichEditRulerBackgroundHorz.ContentOffset.Bottom);
  Result := Ruler.PixelsToLayoutUnitsV(Result);
end;
...
begin
  Result := Ruler.ScaleFactor.Apply
    (SkinInfo.RichEditRulerSection.ContentOffset.Bottom);
...
begin
  Result := Ruler.ScaleFactor.Apply
    (SkinInfo.RichEditRulerSection.ContentOffset.Top);
  Result := Ruler.PixelsToLayoutUnitsV(Result + 1);
end;

function TdxHorizontalRulerSkinPainter.CalculateTotalRulerSize
  (ATextSize: Integer): Integer;
var
...
begin
  ...
  ATextAreaHeight := Max(ATextSize,
    Ruler.PixelsToLayoutUnitsV(Max(AAreaSize.Height, AActiveAreaSize.Height)));
  Result := ATextAreaHeight + PaddingTop + PaddingBottom +
    VerticalTextPaddingBottom + VerticalTextPaddingTop;
end;

procedure TdxHorizontalRulerSkinPainter.DrawControlBackground
  (AGraphics: TdxGraphics; const ABounds: TRect);
begin
  SkinInfo.RichEditRulerBackgroundHorz.DrawEx(AGraphics, ABounds);
end;

procedure TdxHorizontalRulerSkinPainter.DrawTabTypeToggleBackground
  (AGraphics: TdxGraphics; const ABounds: TRect);
begin
  SkinInfo.RichEditCornerPanel.DrawEx(AGraphics, ABounds);
end;

procedure TdxHorizontalRulerSkinPainter.DrawTabTypeToggleActiveArea
  (AGraphics: TdxGraphics; const ABounds: TRect);
begin
  SkinInfo.RichEditRulerTabTypeBackground.DrawEx(AGraphics, ABounds);
end;

procedure TdxHorizontalRulerSkinPainter.DrawRulerAreaBackground
  (const ABounds: TRect);
begin
...
function TdxHorizontalRulerSkinPainter.CreateElementPainter
  : TdxRulerElementPainter;
begin
...
function TdxVerticalRulerPainter.CalculateTotalRulerSize
  (ATextSize: Integer): Integer;
begin
  Result := ATextSize + PaddingTop + PaddingBottom + VerticalTextPaddingBottom +
    VerticalTextPaddingTop;
...
function TdxVerticalRulerPainter.GenerateTickImageCore(const ABounds: TRect)
  : TdxGPImage;
begin
  Result := GenerateImage(ABounds, ForeColor, DrawTickmarkImage);
end;

procedure TdxVerticalRulerPainter.DrawTickmarkImage(AGpCanvas: TdxGPCanvas;
  const ABounds: TRect; AColor: TdxAlphaColor);
begin
  AGpCanvas.FillRectangle(ABounds, AColor);
end;
...
begin
  ...
  if ACaretPosition.PageViewInfo = nil then
    Exit;
  AViewBoundsTop := FRuler.LayoutUnitsToPixelsV(AControl.ViewBounds.Top +
    ACaretPosition.PageViewInfo.ClientBounds.Top);
...
procedure TdxVerticalRulerPainter.DrawTickmarkNumber
  (ATickMark: TdxRulerTickmarkNumber);
begin
  Graphics.DrawVString(ATickMark.Number, Ruler.TickMarkFont, ForeColorBrush,
    TRect.Round(ATickMark.DisplayBounds),
    TdxGPStringFormat.GenericTypographic, 270);
end;

procedure TdxVerticalRulerPainter.DrawTickmarkHalf
  (ATickMark: TdxRulerTickmarkHalf);
var
  ABounds: TdxRectF;
begin
...
procedure TdxVerticalRulerPainter.DrawTickmarkQuarter
  (ATickMark: TdxRulerTickmarkQuarter);
var
  ABounds: TdxRectF;
begin
...
function TdxVerticalRulerColorBasedPainter.GetControlBackgroundColor
  : TdxAlphaColor;
begin
  Result := TdxAlphaColors.FromColor
    (LookAndFeelPainter.RichEditRulerControlColor);
...
function TdxVerticalRulerColorBasedPainter.GetRulerAreaBackgroundColor
  : TdxAlphaColor;
begin
  Result := TdxAlphaColors.FromColor
    (LookAndFeelPainter.RichEditRulerInactiveAreaColor);
...
procedure TdxVerticalRulerColorBasedPainter.DrawControlBackground
  (AGraphics: TdxGraphics; const ABounds: TRect);
begin
  AGraphics.FillRectangle(ABounds, ControlBackgroundColor);
end;

procedure TdxVerticalRulerColorBasedPainter.DrawRulerAreaBackground
  (const ABounds: TRect);
begin
  Graphics.FillRectangle(ABounds, RulerAreaBackgroundColor);
end;

procedure TdxVerticalRulerColorBasedPainter.DrawActiveArea
  (const ABounds: TdxRectF);
begin
  Graphics.FillRectangle(TRect.Round(ABounds), ActiveAreaColor);
end;

procedure TdxVerticalRulerColorBasedPainter.DrawSpaceArea
  (const ABounds: TdxRectF);
begin
  Graphics.FillRectangle(TRect.Round(ABounds), ControlBackgroundColor);
end;

procedure TdxVerticalRulerColorBasedPainter.DrawHotZone
...
begin
  Result := Ruler.ScaleFactor.Apply
    (SkinInfo.RichEditRulerBackgroundVert.ContentOffset.Top);
  Result := Ruler.PixelsToLayoutUnitsV(Result);
end;
...
begin
  Result := Ruler.ScaleFactor.Apply
    (SkinInfo.RichEditRulerBackgroundVert.ContentOffset.Bottom);
  Result := Ruler.PixelsToLayoutUnitsV(Result);
end;
...
function TdxVerticalRulerSkinPainter.CalculateTotalRulerSize
  (ATextSize: Integer): Integer;
var
  AAreaSize, AActiveAreaSize: TSize;
  ATextAreaHeight: Integer;
begin
  ...
  AActiveAreaSize := SkinInfo.RichEditRulerSection.CalculateMinSize;
  ATextAreaHeight := Max(ATextSize,
    Ruler.PixelsToLayoutUnitsV(Math.Max(AAreaSize.Height,
    AActiveAreaSize.Height)));
  Result := ATextAreaHeight + PaddingTop + PaddingBottom +
    VerticalTextPaddingBottom + VerticalTextPaddingTop;
end;

procedure TdxVerticalRulerSkinPainter.DrawControlBackground
  (AGraphics: TdxGraphics; const ABounds: TRect);
begin
  SkinInfo.RichEditRulerBackgroundVert.DrawEx(AGraphics, ABounds);
end;

procedure TdxVerticalRulerSkinPainter.DrawRulerAreaBackground
  (const ABounds: TRect);
begin
  SkinInfo.RichEditRulerRightMargin.DrawEx(Graphics, ABounds);
end;
...
begin
  ...
  begin
    if (AHotZone.ClassType = AHotZones[I].ClassType) and not AHotZones[I].Enabled
    then
      AHotZones.Delete(I);
  end;
...
procedure TdxRulerHotZone.Activate(AHandler: TdxRulerMouseController;
  const AMousePosition: TPoint);
var
  AState: TdxDragAndDropMouseHandlerState;
  AHelperState: TdxBeginDragHotZoneMouseDragHelperState;
begin
  AState := TdxDragAndDropMouseHandlerState.Create(AHandler, Self,
    AMousePosition);
  AHelperState := TdxBeginDragHotZoneMouseDragHelperState.Create(AHandler,
    AState, AMousePosition, Self);
  AHandler.SwitchStateCore(AHelperState, AMousePosition);
end;

{ TdxRulerTickmark }

constructor TdxRulerTickmark.Create(const AControl: TdxRulerControlBase;
  const ABounds: TdxRectF);
begin
  inherited Create;
  FBounds := ABounds;
...
constructor TdxRulerTickmarkNumber.Create(const AControl: TdxRulerControlBase;
  const ABounds: TdxRectF; const ANumber: string);
begin
...
constructor TdxHorizontalRulerHotZone.Create(const AControl
  : TdxHorizontalRulerControl);
begin
  inherited Create(AControl);
end;

function TdxHorizontalRulerHotZone.GetHorizontalRulerControl
  : TdxHorizontalRulerControl;
begin
  Result := TdxHorizontalRulerControl(RulerControl);
end;

function TdxHorizontalRulerHotZone.GetHorizontalRulerViewInfo
  : TdxHorizontalRulerViewInfo;
begin
  Result := HorizontalRulerControl.ViewInfo;
end;

function TdxHorizontalRulerHotZone.GetDocumentLayoutDistanceToCurrentAreaStart
  (AMouseX: Integer): Integer;
begin
  Result := Trunc((AMouseX - RulerViewInfo.ActiveAreaCollection
    [RulerViewInfo.CurrentActiveAreaIndex].Left) / ZoomFactor);
end;

function TdxHorizontalRulerHotZone.GetDocumentLayoutDistanceToCellLeft
  (AMouseX: Integer): Integer;
var
...
begin
  ...
  if (AHorizontalRulerViewInfo <> nil) and
    (AHorizontalRulerViewInfo.TableCellViewInfo <> nil) then
    Result := Trunc((AMouseX - AHorizontalRulerViewInfo.TableCellViewInfo.
      TextLeft) / ZoomFactor)
  else
    Result := GetDocumentLayoutDistanceToCurrentAreaStart(AMouseX);
end;

function TdxHorizontalRulerHotZone.GetDocumentLayoutDistanceToCurrentAreaEnd
  (AMouseX: Integer): Integer;
begin
  Result := Trunc((RulerViewInfo.ActiveAreaCollection
    [RulerViewInfo.CurrentActiveAreaIndex].Right - AMouseX) / ZoomFactor);
end;
...
function TdxHorizontalRulerHotZone.GetVisualFeedbackValue(const AMousePosition
  : TPoint; APageViewInfo: TdxPageViewInfo): Integer;
var
  X: Integer;
begin
  if APageViewInfo = nil then
    Exit(0);
  X := Trunc((AMousePosition.X - RulerViewInfo.ActiveAreaCollection[0].Left) /
    RulerControl.ZoomFactor);
  Result := APageViewInfo.Page.ClientBounds.Left + X;
end;

{ TdxEmptyHorizontalRulerHotZone }

constructor TdxEmptyHorizontalRulerHotZone.Create(const AControl
  : TdxHorizontalRulerControl; const ABounds: TRect);
begin
  inherited Create(AControl);
...
function TdxEmptyHorizontalRulerHotZone.CalculateBounds(const ABounds
  : TRect): TRect;
var
  ASize: TSize;
begin
  ASize := CalculateSize;
  Result := TRect.CreateSize(ABounds.Left, RulerClientBounds.Bottom - ASize.cy,
    ASize.cx, ASize.cy);
end;
...
begin
  Result := TdxEmptyHorizontalRulerHotZone.Create
    (HorizontalRulerControl, Bounds);
end;

function TdxEmptyHorizontalRulerHotZone.GetVisualFeedbackValue
  (const AMousePosition: TPoint; APageViewInfo: TdxPageViewInfo): Integer;
begin
  Result := 0;
end;

procedure TdxEmptyHorizontalRulerHotZone.Activate
  (AHandler: TdxRulerMouseController; const AMousePosition: TPoint);
begin
end;

{ TdxTabHotZone }

constructor TdxTabHotZone.Create(const AControl: TdxHorizontalRulerControl;
  const ABounds: TRect; const ATabInfo: TdxTabInfo);
begin
  inherited Create(AControl);
  FTabInfo := ATabInfo;
...
begin
  ANewTabPosition := HorizontalRulerViewInfo.
    GetRulerModelPositionRelativeToTableCellViewInfo(AMousePosition.X);
...
begin
  FTabInfo := TdxTabInfo.Create(ANewValue, FTabInfo.Alignment, FTabInfo.Leader,
    FTabInfo.Deleted, False);

  Bounds := TRect.CreateSize(RulerViewInfo.GetRulerLayoutPosition(ANewValue) +
    HorizontalRulerViewInfo.GetAdditionalCellIndent(True), Bounds.Top,
...
begin
  ...
  try
    ...
    ACommands.Add(TdxDeleteTabAtParagraphCommand.Create(RichEditControl,
      FOldTabInfo));
    if CanDropTab(AMousePosition) then
      ACommands.Add(TdxInsertTabToParagraphCommand.Create(RichEditControl,
        FTabInfo));

    ACommand := TdxCustomTransactedMultiCommand.Create(RichEditControl,
      ACommands, TdxMultiCommandExecutionMode.ExecuteAllAvailable,
      TdxMultiCommandUpdateUIStateMode.EnableIfAllAvailable);
    try
      ACommand.Execute;
    finally
      ACommand.Free;
...
begin
  ASize := CalculateSize;
  Result := TRect.CreateSize(ABounds.Left - ASize.Width,
    RulerClientBounds.Bottom - ASize.cy, ASize.cx, ASize.cy);
end;
...
begin
  ASize := CalculateSize;
  Result := TRect.CreateSize(ABounds.Left - ASize.cx div 2,
    RulerClientBounds.Bottom - ASize.cy, ASize.cx, ASize.cy);
end;
...
begin
  Result := TdxDecimalTabHotZone.Create(HorizontalRulerControl, Bounds,
    TabInfo);
end;

{ TdxTableLeftBorderHotZone }

constructor TdxTableLeftBorderHotZone.Create(const AControl
  : TdxHorizontalRulerControl; const ABounds: TRect; ABorderIndex: Integer;
  ATableViewInfo: TdxTableViewInfo; ATableCell: TdxTableCell);
begin
  inherited Create(AControl);
  Bounds := CalculateBounds(ABounds);
...
begin
  ...
  AMinCellWidth := RulerViewInfo.ToDocumentLayoutUnitConverter.ToLayoutUnits
    (FTableCell.GetMinCellWidth);
  AAdditionalIndent := HorizontalRulerViewInfo.
    GetAdditionalParentCellIndent(False);
  FLeftBorder :=
    Trunc(((FColumn.MaxLeftBorder + AMinCellWidth -
    TableViewInfo.Column.Bounds.Left + AAdditionalIndent) * ZoomFactor) +
    RulerViewInfo.ActiveAreaCollection[ACurrentColumnIndex].Left);
  FRightBorder := ((FColumn.MaxRightBorder - AMinCellWidth -
    TableViewInfo.Column.Bounds.Left + AAdditionalIndent) * ZoomFactor) +
    RulerViewInfo.ActiveAreaCollection[ACurrentColumnIndex].Left;
end;
...
begin
  ...
  AEnhancedSelectionManager := TdxEnhancedSelectionManager.Create
    (DocumentModel.ActivePieceTable);
  try
    Result := AEnhancedSelectionManager.
      CalculateTableCellsToResizeHorizontallyCore(TableViewInfo, FTableCell.Row,
...
function TdxTableLeftBorderHotZone.GetElementAccessor
...
begin
  ASize := CalculateSize;
  Result := TRect.CreateSize(ABounds.Left - ASize.cx div 2, ABounds.Top,
    ASize.cx, ASize.cy);
end;
...
var
  ANewBounds: TRect;
begin
  if (AMousePosition.X <= FLeftBorder) or (AMousePosition.X >= FRightBorder)
  then
    Exit;
  FNewValue := AMousePosition.X;
  ANewBounds := TRect.CreateSize(FNewValue, Bounds.Top, Bounds.Width,
    Bounds.Height);
...
begin
  ...
  ACommand := TdxChangeTableVirtualColumnRightCommand.Create(RichEditControl,
    Column, 100);
  try
...
begin
  ATableIndentValue := RulerViewInfo.ToDocumentLayoutUnitConverter.ToModelUnits
    ...
    TableViewInfo.TextAreaOffset) + TableCell.GetActualLeftMargin.Value;
...
begin
  Result := TdxTableLeftBorderHotZone.Create(HorizontalRulerControl, Bounds,
    FBorderIndex, FTableViewInfo, TableCell);
end;
...
constructor TdxTableHotZone.Create(const AControl: TdxHorizontalRulerControl;
  const ABounds: TRect; ABorderIndex: Integer; ATableViewInfo: TdxTableViewInfo;
...
begin
  if Column = nil then
    Exit;
  ACommand := TdxChangeTableVirtualColumnRightCommand.Create(RichEditControl,
    Column, GetDocumentLayoutDistanceToCurrentAreaStart(NewValue) +
    TableViewInfo.Column.Bounds.Left -
    HorizontalRulerViewInfo.GetAdditionalParentCellIndent(False));
  try
    ACommand.Execute;
  finally
...
begin
  Result := TdxTableHotZone.Create(HorizontalRulerControl, Bounds, BorderIndex,
    TableViewInfo, TableCell);
end;

{ TdxIndentHotZone }

constructor TdxIndentHotZone.Create(const AControl: TdxHorizontalRulerControl;
  const ABounds: TRect; AIndent: Integer);
begin
  inherited Create(AControl);
  FIndent := AIndent;
...
begin
  ...
  begin
    ANewIndent := HorizontalRulerViewInfo.
      GetRulerModelPositionRelativeToTableCellViewInfo(AMousePosition.X);
...
begin
  ...
  Bounds := TRect.CreateSize(RulerViewInfo.GetRulerLayoutPosition(ANewIndent) +
    HorizontalRulerViewInfo.GetAdditionalCellIndent(True), Bounds.Top,
    Bounds.Width, Bounds.Height);
  Bounds := CalculateBounds(Bounds);
end;
...
constructor TdxLeftIndentHotZone.Create(const AControl
  : TdxHorizontalRulerControl; const ABounds: TRect; AIndent: Integer;
  ALeftBottomHotZone: TdxLeftBottomHotZone; AFirstLineIndent: Integer);
begin
...
procedure TdxLeftIndentHotZone.Activate(AHandler: TdxRulerMouseController;
  const AMousePosition: TPoint);
begin
...
begin
  ...
  try
    AFirstLineCommand := TdxChangeParagraphFirstLineIndentCommand.Create
      (RichEditControl, FFirstLineIndent - (NewIndent - Indent));
    try
      AFirstLineCommand.Execute;
    finally
      AFirstLineCommand.Free;
    end;
    ACommand := TdxChangeParagraphLeftIndentCommand.Create(RichEditControl,
      NewIndent);
    try
      ACommand.Execute;
    finally
...
begin
  Result := TdxLeftIndentHotZone.Create(HorizontalRulerControl, Bounds, Indent,
    FLeftBottomHotZone, FFirstLineIndent);
end;
...
begin
  ...
  Y := RulerClientBounds.Bottom + HorizontalRulerControl.Painter.PaddingBottom -
    ASizeBottom.cy - ASize.cy;
  Result := TRect.CreateSize(ABounds.Left - ASize.Width div 2, Y, ASize.cx,
    ASize.cy);
end;
...
constructor TdxRightIndentHotZone.Create(const AControl
  : TdxHorizontalRulerControl; const ABounds: TRect; AIndent: Integer);
begin
  inherited Create(AControl, ABounds, AIndent);
  Bounds := CalculateBounds(ABounds);
...
begin
  ACommand := TdxChangeParagraphRightIndentCommand.Create(RichEditControl,
    NewIndent);
  try
    ACommand.Execute;
  finally
...
begin
  ...
  Result := TRect.CreateSize(ABounds.Left - ASize.cx div 2, Y, ASize.cx,
    ASize.cy);
end;

function TdxRightIndentHotZone.CreateEmptyClone: TdxRulerHotZone;
begin
  Result := TdxRightIndentHotZone.Create(HorizontalRulerControl,
    Bounds, Indent);
end;
...
begin
  if (AMousePosition.X >= LeftBorder) and (AMousePosition.X <= RightBorder) then
  begin
    NewIndent := HorizontalRulerControl.ViewInfo.GetRightIndentModelPosition
      (AMousePosition.X);
    Bounds := TRect.CreateSize
      (HorizontalRulerControl.ViewInfo.GetRightIndentLayoutPosition(NewIndent),
...
begin
  ...
  Bounds := TRect.CreateSize
    (HorizontalRulerControl.ViewInfo.GetRightIndentLayoutPosition(ANewIndent),
    Bounds.Top, Bounds.Width, Bounds.Height);
  Bounds := CalculateBounds(Bounds);
end;
...
constructor TdxFirstLineIndentHotZone.Create(const AControl
  : TdxHorizontalRulerControl; const ABounds: TRect; AIndent: Integer;
  ALeftIndent: Integer);
begin
  inherited Create(AControl, ABounds, AIndent);
...
begin
  ACommand := TdxChangeParagraphFirstLineIndentCommand.Create(RichEditControl,
    NewIndent - FLeftIndent);
  try
    ACommand.Execute;
  finally
    ACommand.Free;
...
begin
  ...
  Result := TRect.CreateSize(ABounds.Left - ASize.Width div 2, Y, ASize.Width,
    ASize.Height);
end;

function TdxFirstLineIndentHotZone.CreateEmptyClone: TdxRulerHotZone;
begin
  Result := TdxFirstLineIndentHotZone.Create(HorizontalRulerControl, Bounds,
    Indent, FLeftIndent);
end;

{ TdxLeftBottomHotZone }

constructor TdxLeftBottomHotZone.Create(const AControl
  : TdxHorizontalRulerControl; const ABounds: TRect; AIndent: Integer;
  ARightBorder: Integer; AFirstLineIndentHotZone: TdxFirstLineIndentHotZone);
begin
  inherited Create(AControl, ABounds, AIndent);
  SetNewValue(AIndent);
...
begin
  FLeftIndentHotZone := TdxLeftIndentHotZone.Create(HorizontalRulerControl,
    ABounds, Indent, Self, FFirstLineHotZone.Indent - Indent);
...
begin
  Result := TdxLeftBottomHotZone.Create(HorizontalRulerControl, Bounds, Indent,
    RightBorder, FFirstLineHotZone);
end;
...
begin
  ...
  FFirstLineHotZone.SetNewValue(FFirstLineHotZone.Indent +
    (NewIndent - Indent));
end;

{ TdxColumnResizerHotZone }

constructor TdxColumnResizerHotZone.Create(const AControl
  : TdxHorizontalRulerControl; const ABounds: TRect; AColumnIndex: Integer);
begin
  inherited Create(AControl);
...
begin
  ...
  HorizontalRulerControl.SetViewInfo(HorizontalRulerControl.CreateViewInfoCore
    (ASectionProperties, RulerViewInfo.IsMainPieceTable));
end;

procedure TdxColumnResizerHotZone.Commit(const AMousePosition: TPoint);
begin
  if not RichEditControl.InnerControl.ActiveView.CaretPosition.Update
    (TdxDocumentLayoutDetailsLevel.Column) then
    Exit;
  RulerControl.Reset;
end;
...
constructor TdxMiddleColumnResizerHotZone.Create(const AControl
  : TdxHorizontalRulerControl; const ABounds: TRect; AColumnIndex: Integer);
begin
  inherited Create(AControl, ABounds, AColumnIndex);
end;

procedure TdxMiddleColumnResizerHotZone.OnMoveCore(const AMousePosition
  : TPoint);
var
  AOffset: Integer;
...
begin
  ...
  ACommand := TdxMoveColumnCommand.Create(RichEditControl, SectionProperties,
    ColumnIndex, AOffset);
  try
...
function TdxMiddleColumnResizerHotZone.CalculateBounds(const ABounds
  : TRect): TRect;
var
  ASize: TSize;
  Y: Integer;
begin
  ASize := CalculateSize;
  Y := RulerClientBounds.Top + RulerClientBounds.Height div 2 -
    ASize.Height div 2;
  Result := TRect.CreateSize(ABounds.Left - ASize.Width div 2, Y, ASize.Width,
    ASize.Height);
end;
...
begin
  Result := TdxMiddleColumnResizerHotZone.Create(HorizontalRulerControl, Bounds,
    ColumnIndex);
end;

function TdxMiddleColumnResizerHotZone.CalculateNewValue(const AMousePosition
  : TPoint): Integer;
var
...
begin
  ...
  APos := AMousePosition.X - (AAreaCollection[ColumnIndex].Right +
    (AAreaCollection[ColumnIndex + 1].Left - AAreaCollection[ColumnIndex]
    .Right) / 2);
  Result := Trunc((APos / ZoomFactor));
end;

function TdxMiddleColumnResizerHotZone.GetVisualFeedbackValue
  (const AMousePosition: TPoint; APageViewInfo: TdxPageViewInfo): Integer;
var
  AMiddle: Single;
begin
  if APageViewInfo <> nil then
  begin
    AMiddle := (RulerViewInfo.ActiveAreaCollection[ColumnIndex].Right +
      RulerViewInfo.ActiveAreaCollection[ColumnIndex + 1].Left) / 2.0;
    Result := Trunc(((AMiddle - RulerViewInfo.ActiveAreaCollection[0].Left) /
      ZoomFactor)) + APageViewInfo.Page.ClientBounds.Left;
  end
  else
...
constructor TdxLeftColumnResizerHotZone.Create(const AControl
  : TdxHorizontalRulerControl; const ABounds: TRect; AColumnIndex: Integer);
begin
  inherited Create(AControl, ABounds, AColumnIndex);
end;
...
function TdxLeftColumnResizerHotZone.CreateCommand(const AMousePosition: TPoint)
  : TdxChangeColumnSizeCommand;
var
  AOffset: Integer;
begin
  ...
  if SectionProperties.EqualWidthColumns then
    Result := TdxChangeWidthEqualWidthColumnsByLeftCommand.Create
      (RichEditControl, SectionProperties, ColumnIndex, AOffset)
  else
    Result := TdxChangeColumnSizeByLeftCommand.Create(RichEditControl,
      SectionProperties, ColumnIndex, AOffset);
end;

function TdxLeftColumnResizerHotZone.CreateEmptyClone: TdxRulerHotZone;
begin
  Result := TdxLeftColumnResizerHotZone.Create(HorizontalRulerControl, Bounds,
    ColumnIndex);
end;

function TdxLeftColumnResizerHotZone.CalculateBounds(const ABounds
  : TRect): TRect;
var
  ASize: TSize;
  Y: Integer;
begin
  ...
  Y := RulerClientBounds.Top + RulerClientBounds.Height div 2 -
    ASize.Height div 2;
  Result := TRect.CreateSize(ABounds.Left - ASize.Width, Y, ASize.Width,
    ASize.Height);
end;

function TdxLeftColumnResizerHotZone.CalculateNewValue(const AMousePosition
  : TPoint): Integer;
var
  AOffset: Integer;
begin
  AOffset := Trunc((RulerViewInfo.ActiveAreaCollection[ColumnIndex].Left -
    AMousePosition.X) / ZoomFactor);
  Result := RulerViewInfo.ToDocumentLayoutUnitConverter.ToModelUnits(AOffset);
end;

function TdxLeftColumnResizerHotZone.GetVisualFeedbackValue(const AMousePosition
  : TPoint; APageViewInfo: TdxPageViewInfo): Integer;
begin
  if ColumnIndex = 0 then
    Result := RulerViewInfo.ToDocumentLayoutUnitConverter.ToLayoutUnits
      (SectionProperties.LeftMargin)
  else
  begin
    if APageViewInfo <> nil then
      Result := Trunc((RulerViewInfo.ActiveAreaCollection[ColumnIndex].Left -
        RulerViewInfo.ActiveAreaCollection[0].Left) / ZoomFactor) +
        APageViewInfo.Page.ClientBounds.Left
    else
      Result := inherited GetVisualFeedbackValue(AMousePosition, APageViewInfo);
  end;
end;
...
constructor TdxRightColumnResizerHotZone.Create(const AControl
  : TdxHorizontalRulerControl; const ABounds: TRect; AColumnIndex: Integer);
begin
  inherited Create(AControl, ABounds, AColumnIndex);
end;
...
begin
  ...
  if SectionProperties.EqualWidthColumns then
    ACommand := TdxChangeWidthEqualWidthColumnsByRightCommand.Create
      (RichEditControl, SectionProperties, AIndex, AOffset)
  else
    ACommand := TdxChangeColumnWidthCommand.Create(RichEditControl,
      SectionProperties, AIndex, AOffset);
  try
    ACommand.GetNewSection(SectionProperties);
  finally
    ACommand.Free;
...
begin
  Result := TdxRightColumnResizerHotZone.Create(HorizontalRulerControl, Bounds,
    ColumnIndex);
end;

function TdxRightColumnResizerHotZone.CalculateBounds(const ABounds
  : TRect): TRect;
var
  ASize: TSize;
  Y: Integer;
...
function TdxRightColumnResizerHotZone.CalculateNewValue(const AMousePosition
  : TPoint): Integer;
begin
  Result := Trunc((RulerViewInfo.ActiveAreaCollection[ColumnIndex].Right -
    AMousePosition.X) / ZoomFactor);
end;

function TdxRightColumnResizerHotZone.GetVisualFeedbackValue
  (const AMousePosition: TPoint; APageViewInfo: TdxPageViewInfo): Integer;
begin
  if APageViewInfo <> nil then
    Result := Trunc((RulerViewInfo.ActiveAreaCollection[ColumnIndex].Right -
...
constructor TdxTabTypeToggleBackgroundHotZone.Create(const AControl
  : TdxHorizontalRulerControl; const ABounds: TRect);
begin
  inherited Create(AControl);
  Bounds := CalculateBounds(ABounds);
...
function TdxTabTypeToggleBackgroundHotZone.CalculateBounds
  (const ABounds: TRect): TRect;
begin
  Result := ABounds;
end;

procedure TdxTabTypeToggleBackgroundHotZone.OnMove(const AMousePosition
  : TPoint);
begin
  // do nothing
end;

procedure TdxTabTypeToggleBackgroundHotZone.Commit(const AMousePosition
  : TPoint);
begin
  // do nothing
end;
...
begin
  Result := TdxTabTypeToggleBackgroundHotZone.Create
    (HorizontalRulerControl, Bounds);
end;
...
constructor TdxTabTypeToggleHotZone.Create(const AControl
  : TdxHorizontalRulerControl; const ABounds: TRect);
begin
  inherited Create(AControl);
  Bounds := CalculateBounds(ABounds);
...
function TdxTabTypeToggleHotZone.CreateHotZones
  : TdxReferencedObjectList<TdxHorizontalRulerHotZone>;
begin
  Result := TdxReferencedObjectList<TdxHorizontalRulerHotZone>.Create;
  if DocumentModel.DocumentCapabilities.ParagraphTabsAllowed and
    RichEditControl.InnerControl.Options.HorizontalRuler.ShowTabs then
  begin
    Result.Add(TdxLeftTabHotZone.Create(HorizontalRulerControl, Bounds,
      TdxTabInfo.Create(-1, TdxTabAlignmentType.Left)));
    Result.Add(TdxRightTabHotZone.Create(HorizontalRulerControl, Bounds,
      TdxTabInfo.Create(-1, TdxTabAlignmentType.Right)));
    Result.Add(TdxCenterTabHotZone.Create(HorizontalRulerControl, Bounds,
      TdxTabInfo.Create(-1, TdxTabAlignmentType.Center)));
    Result.Add(TdxDecimalTabHotZone.Create(HorizontalRulerControl, Bounds,
      TdxTabInfo.Create(-1, TdxTabAlignmentType.Decimal)));
  end;
  if DocumentModel.DocumentCapabilities.ParagraphFormattingAllowed and
    RichEditControl.InnerControl.Options.HorizontalRuler.ShowLeftIndent then
    Result.Add(TdxFirstLineIndentHotZone.Create(HorizontalRulerControl,
      Bounds, 0, 0));
  if Result.Count <= 0 then
    Result.Add(TdxEmptyHorizontalRulerHotZone.Create
      (HorizontalRulerControl, Bounds));
end;
...
begin
  ...
  ABounds := TRect.CreateSize(Bounds.Left + (Bounds.Width - ASize.Width) div 2,
    Bounds.Top + (Bounds.Height - ASize.Height) div 2, ASize.Width,
    ASize.Height);
...
begin
  HorizontalRulerControl.TabTypeIndex :=
    HorizontalRulerControl.TabTypeIndex + 1;
...
constructor TdxVerticalRulerHotZone.Create(const AControl
  : TdxVerticalRulerControl);
begin
  inherited Create(AControl);
end;

function TdxVerticalRulerHotZone.GetVerticalRulerControl
  : TdxVerticalRulerControl;
begin
...
function TdxVerticalRulerHotZone.GetVisualFeedbackValue(const AMousePosition
  : TPoint; APageViewInfo: TdxPageViewInfo): Integer;
var
  Y: Integer;
begin
  ...
  Y := Trunc((AMousePosition.Y - RulerViewInfo.ActiveAreaCollection[0].Top) /
    RulerControl.ZoomFactor);
...
constructor TdxSectionResizerHotZone.Create(const AControl
  : TdxVerticalRulerControl; const ABounds: TRect; AColumnIndex: Integer);
begin
  inherited Create(AControl);
  FColumnIndex := AColumnIndex;
  Bounds := ABounds;
...
begin
  ...
  ATableVerticalPositions.CopyCore
    (VerticalRulerControl.ViewInfo.TableVerticalPositions);

  VerticalRulerControl.SetViewInfo
    (TdxVerticalRulerViewInfo.Create(VerticalRulerControl, ASectionProperties,
    RulerViewInfo.IsMainPieceTable, ATableVerticalPositions,
    VerticalRulerControl.ViewInfo.TableCellViewInfo));
end;
...
begin
  AOffset := CalculateNewValue(AMousePosition);
  ACommand := TdxChangeSectionHeightByTopCommand.Create(RichEditControl,
    SectionProperties, 0, AOffset);
  try
    ACommand.GetNewSection(SectionProperties);
  finally
    ACommand.Free;
...
function TdxSectionTopResizerHotZone.CalculateNewValue(const AMousePosition
  : TPoint): Integer;
var
  AOffset: Integer;
begin
  AOffset := Trunc((RulerViewInfo.ActiveAreaCollection[0].Top -
    AMousePosition.Y) / ZoomFactor);
  Result := RulerViewInfo.ToDocumentLayoutUnitConverter.ToModelUnits(AOffset);
end;

function TdxSectionTopResizerHotZone.CreateEmptyClone: TdxRulerHotZone;
begin
  Result := TdxSectionTopResizerHotZone.Create(VerticalRulerControl, Bounds,
    ColumnIndex);
end;

function TdxSectionTopResizerHotZone.GetVisualFeedbackValue(const AMousePosition
  : TPoint; APageViewInfo: TdxPageViewInfo): Integer;
begin
  if ColumnIndex = 0 then
    Result := RulerViewInfo.ToDocumentLayoutUnitConverter.ToLayoutUnits
      (SectionProperties.TopMargin)
  else
    Result := inherited GetVisualFeedbackValue(AMousePosition, APageViewInfo);
end;
...
procedure TdxSectionBottomResizerHotZone.OnMoveCore
  (const AMousePosition: TPoint);
var
  AOffset: Integer;
...
begin
  AOffset := CalculateNewValue(AMousePosition);
  ACommand := TdxChangeSectionHeightByBottomCommand.Create(RichEditControl,
    SectionProperties, 0, AOffset);
  try
    ACommand.GetNewSection(SectionProperties);
  finally
...
function TdxSectionBottomResizerHotZone.CalculateNewValue(const AMousePosition
  : TPoint): Integer;
var
  AOffset: Integer;
begin
  AOffset := Trunc((RulerViewInfo.ActiveAreaCollection[0].Bottom -
    AMousePosition.Y) / ZoomFactor);
  Result := RulerViewInfo.ToDocumentLayoutUnitConverter.ToModelUnits(AOffset);
end;
...
begin
  Result := TdxSectionBottomResizerHotZone.Create(VerticalRulerControl, Bounds,
    ColumnIndex);
end;
...
constructor TdxVerticalTableHotZone.Create(const AControl
  : TdxVerticalRulerControl; const ABounds: TRect;
...
function TdxVerticalTableHotZone.GetVisualFeedbackValue(const AMousePosition
  : TPoint; APageViewInfo: TdxPageViewInfo): Integer;
begin
  if APageViewInfo = nil then
    Exit(0);
...
function TdxVerticalTableHotZone.CalculateNewValue(const AMousePosition
  : TPoint): Integer;
begin
  Result := Trunc((AMousePosition.Y - RulerViewInfo.ActiveAreaCollection[0].Top)
    / ZoomFactor);
end;
...
begin
  ...
  ANewBounds := TRect.CreateSize(Bounds.Left, ANewValue, Bounds.Width,
    Bounds.Height);
  Bounds := CalculateBounds(ANewBounds);
end;
...
begin
  ...
  AHeightIndex := RulerViewInfo.ToDocumentLayoutUnitConverter.ToModelUnits
    (Math.Max(AValue, AMinValue));
...
begin
  Result := TdxVerticalTableHotZone.Create(VerticalRulerControl, Bounds,
    TableViewInfo, FAnchorIndex);
end;

{ TdxRulerViewInfoBase }

constructor TdxRulerViewInfoBase.Create(const AControl: TdxRulerControlBase;
  ASectionProperties: TdxSectionProperties; AIsMainPieceTable: Boolean);
var
...
begin
  ...
  FBounds := AUnitConverter.PixelsToLayoutUnits(AControl.Bounds, Control.DpiX,
    Control.DpiY);
...
procedure TdxRulerViewInfoBase.CalculateBounds(AUnitConverter
  : TdxDocumentLayoutUnitConverter);
begin
  FDisplayClientBounds := AUnitConverter.LayoutUnitsToPixels(FClientBounds,
    Control.DpiX, Control.DpiY);
  FHalfTickBounds := CalculateHalfTickBounds;
  FDisplayHalfTickBounds := AUnitConverter.LayoutUnitsToPixels
    (TRect.Round(FHalfTickBounds), Control.DpiX, Control.DpiY);
  FQuarterTickBounds := CalculateQuarterTickBounds;
  FDisplayQuarterTickBounds := AUnitConverter.LayoutUnitsToPixels
    (TRect.Round(FQuarterTickBounds), Control.DpiX, Control.DpiY);
end;
...
function TdxRulerViewInfoBase.GetToDocumentLayoutUnitConverter
  : TdxDocumentModelUnitToLayoutUnitConverter;
begin
...
begin
  ...
  try
    AModifier := TdxGraphicsToLayoutUnitsModifier.Create(MeasureGraphics,
      Control.DocumentModel.LayoutUnitConverter);
    try
      ASize := MeasureGraphics.MeasureString(AValue, Control.TickMarkFont,
        MaxInt, TdxGPStringFormat.GenericTypographic);
...
function TdxRulerViewInfoBase.CalculateTickStep
  (AConverter: TdxUnitConverter): Single;
var
...
begin
  ...
  if AUnit = TdxMeasurementUnit.Millimeter then
    AValue := 20
  else if AUnit = TdxMeasurementUnit.Point then
    AValue := 72
  else
    AValue := 1;
  Result := ToDocumentLayoutUnitConverter.ToLayoutUnits
    (Trunc(AConverter.ToUnits(AValue))) * Control.ZoomFactor;
end;
...
begin
  ...
  begin
    if RulerTickmarks[I].RulerTickmarkType = TdxRulerTickmarkType.Tick then
      ATotalTickExtent := ATotalTickExtent +
        Orientation.GetPrimaryCoordinateExtent(RulerTickmarks[I].Bounds);
  end;
  if ATotalTickExtent <= 0 then
    Result := False
  else
    Result := Orientation.GetPrimaryCoordinateExtent(ClientBounds.ToRectF) /
      ATotalTickExtent < 1.65;
end;
...
begin
  for I := 1 to RulerTickmarks.Count - 1 do
    if Orientation.GetFarPrimaryCoordinate(RulerTickmarks[I - 1].Bounds) >=
      Orientation.GetNearPrimaryCoordinate(RulerTickmarks[I].Bounds) then
      Exit(True);
  Result := False;
end;

procedure TdxRulerViewInfoBase.DeleteRulerTickmarks
  (AType: TdxRulerTickmarkType);
var
  I: Integer;
begin
  for I := RulerTickmarks.Count - 1 downto 0 do
...
var
  ...
  AStep, AActiveAreaCollectionNear, ADistanceToZero, AOffset, AStartPos, U,
    AValueInLayoutUnits, AValueInModelUnits: Single;
  AClientBoundsNear, AClientBoundsFar, ADistanceToZeroInSteps, AValue: Integer;
begin
  AUnitConverter := Control.DocumentModel.InternalAPI.UnitConverters
    [Control.RichEditControl.InnerControl.UIUnit];
  AToLayoutUnitConverter := Control.DocumentModel.ToDocumentLayoutUnitConverter;
  AStep := CalculateTickStep(AUnitConverter);
  AActiveAreaCollectionNear := Orientation.GetNearPrimaryCoordinate
    (ActiveAreaCollection[CurrentActiveAreaIndex]);
  ...
  begin
    ...
    AValueInModelUnits := AToLayoutUnitConverter.ToModelUnits
      (AValueInLayoutUnits);
...
begin
  if Control.RichEditControl.InnerControl.UIUnit = TdxMeasurementUnit.Centimeter
  then
  begin
...
var
  ABounds: TdxRectF;
begin
  if (U < Orientation.GetFarPrimaryCoordinate(ClientBounds)) and
    (U > Orientation.GetNearPrimaryCoordinate(ClientBounds)) then
  begin
...
function TdxRulerViewInfoBase.CalculatePageClientBounds(APageCalculator
  : TdxPageBoundsCalculator; AProperties: TdxSectionProperties): TRect;
begin
  Result := APageCalculator.CalculatePageClientBoundsCore(AProperties.PageWidth,
    AProperties.PageHeight, AProperties.LeftMargin, AProperties.TopMargin,
    AProperties.RightMargin, AProperties.BottomMargin);
end;

{ TdxHorizontalRulerViewInfo }

constructor TdxHorizontalRulerViewInfo.Create(const AControl
  : TdxHorizontalRulerControl; ASectionProperties: TdxSectionProperties;
  ACurrentParagraph: TdxParagraph; ACurrentActiveAreaIndex: Integer;
  AIsMainPieceTable: Boolean; ATableCellViewInfo: TdxTableCellViewInfo;
  ATableAlignedPositions: TdxSortedList<Integer>);
var
  AUnitConverter: TdxDocumentLayoutUnitConverter;
begin
  ...
  AUnitConverter := AControl.DocumentModel.LayoutUnitConverter;
  FDisplayDefaultTabBounds := AUnitConverter.LayoutUnitsToPixels
    (FDefaultTabBounds, Control.DpiX, Control.DpiY);
...
begin
  ...
  AHeight := DisplayClientBounds.Height + AUnitConverter.LayoutUnitsToPixels
    (FControl.Painter.PaddingTop + FControl.Painter.PaddingBottom,
    FControl.DpiY);
...
function TdxHorizontalRulerViewInfo.CalculateClientBounds(const AControl
  : TdxRulerControlBase): TRect;
var
...
begin
  IsReady := False;
  ACaretPosition := AControl.RichEditControl.InnerControl.ActiveView.
    CaretPosition;
  ...
  if AControl.RichEditControl.InnerControl.ActiveViewType = TdxRichEditViewType.PrintLayout
  then
    APageClientBounds.Width :=
      Round(ToDocumentLayoutUnitConverter.ToLayoutUnits
      (Math.Min(MaxRulerDimensionInModelUnits, SectionProperties.PageWidth)) *
      AControl.ZoomFactor)
  else if AControl.RichEditControl.InnerControl.ActiveViewType =
    TdxRichEditViewType.Draft then
    APageClientBounds.Width :=
      Round(ToDocumentLayoutUnitConverter.ToLayoutUnits
      (Math.Min(MaxRulerDimensionInModelUnits, SectionProperties.PageWidth -
      SectionProperties.LeftMargin)) * AControl.ZoomFactor);
  AClientHeight := TextSize.Height + 2 *
    AControl.Painter.VerticalTextPaddingBottom;
  Y := AControl.Painter.PaddingTop;
  Result := TRect.CreateSize(APageClientBounds.Left, Y, APageClientBounds.Width,
    AClientHeight);
end;
...
begin
  ...
  DisplayActiveAreaCollection.Add(ALayoutUnitConverter.LayoutUnitsToPixels
    (ARulerArea, Control.DpiX, Control.DpiY).ToRectF);
end;
...
begin
  ...
  APageCalculator := TdxPageBoundsCalculator.Create
    (ADocumentModel.ToDocumentLayoutUnitConverter);
  try
    APrintLayoutViewPageClientBounds.Empty;
    if AControl.InnerControl.ActiveViewType = TdxRichEditViewType.Simple then
      APrintLayoutViewPageClientBounds :=
        AControl.InnerControl.ActiveView.PageViewInfos.First.ClientBounds
    else
      APrintLayoutViewPageClientBounds := CalculatePageClientBounds
        (APageCalculator, SectionProperties);
  finally
    APageCalculator.Free;
  end;
  AActiveViewPageCalculator := AControl.InnerControl.Formatter.
    DocumentFormatter.Controller.PageController.PageBoundsCalculator;
  AActiveViewPageClientBounds := CalculatePageClientBounds
    (AActiveViewPageCalculator, SectionProperties);
  ADeltaX := AActiveViewPageClientBounds.Left -
    APrintLayoutViewPageClientBounds.Left;
  Result := TRect.CreateSize(APrintLayoutViewPageClientBounds.Left + ADeltaX,
    ClientBounds.Top, APrintLayoutViewPageClientBounds.Width,
    ClientBounds.Height);
end;

function TdxHorizontalRulerViewInfo.GetRulerAreaCollection(ASectionProperties
  : TdxSectionProperties; const ABounds: TRect): TdxRectList;
var
  ACalculator: TdxColumnsBoundsCalculator;
begin
  ACalculator := TdxColumnsBoundsCalculator.Create
    (FControl.DocumentModel.ToDocumentLayoutUnitConverter);
  try
    Result := TdxRectList.Create;
    if ASectionProperties.EqualWidthColumns then
      ACalculator.PopulateEqualWidthColumnsBounds(Result, ABounds,
        ASectionProperties.ColumnCount, ACalculator.UnitConverter.ToLayoutUnits
        (ASectionProperties.Space))
    else
      ACalculator.PopulateColumnsBounds(Result, ABounds,
        ASectionProperties.ColumnInfoCollection);
  finally
    ACalculator.Free;
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ABounds.InitSize(ActiveAreaCollection[I - 1].Right,
        ActiveAreaCollection[I].Top, ActiveAreaCollection[I].Left -
        ActiveAreaCollection[I - 1].Right, ActiveAreaCollection[I].Height);
      SpaceAreaCollection.Add(ABounds);
      DisplaySpaceAreaCollection.Add(ALayoutUnitConverter.LayoutUnitsToPixels
        (TRect.Round(ABounds), Control.DpiX, Control.DpiY).ToRectF);
    end;
  end;
end;
...
begin
  ...
  begin
    ACell := ACells[I];
    AStartColumnIndex := TdxTableCellVerticalBorderCalculator.
      GetStartColumnIndex(ACell, True);
    ABorderLayoutHorizontalPositionIndex := AStartColumnIndex +
      ACell.LayoutProperties.ColumnSpan;
    ABounds := TRect.CreateSize
      (GetTableHotZoneLeft(ABorderLayoutHorizontalPositionIndex),
      Trunc(ActiveAreaCollection[CurrentActiveAreaIndex].Top), 0,
      Trunc(ActiveAreaCollection[CurrentActiveAreaIndex].Height));
    ATableHotZone := TdxTableHotZone.Create(Control, ABounds,
      ABorderLayoutHorizontalPositionIndex, ATableViewInfo, ACell);
...
begin
  ATableViewInfo := TableCellViewInfo.TableViewInfo;
  ABounds := TRect.CreateSize(GetTableHotZoneLeft(0),
    Trunc(ActiveAreaCollection[CurrentActiveAreaIndex].Top), 0,
    Trunc(ActiveAreaCollection[CurrentActiveAreaIndex].Height));
  ATableLeftBorderHotZone := TdxTableLeftBorderHotZone.Create(Control, ABounds,
    0, ATableViewInfo, TableCellViewInfo.Cell.Row.Cells[0]);
  HotZones.Add(ATableLeftBorderHotZone);
end;

function TdxHorizontalRulerViewInfo.GetTableHotZoneLeft
  (ATableAlignedPositionsIndex: Integer): Integer;
begin
  Result := Trunc((FTableAlignedPositions[ATableAlignedPositionsIndex] +
    GetAdditionalParentCellIndent(False)) * Control.ZoomFactor +
    ActiveAreaCollection[CurrentActiveAreaIndex].Left);
end;
...
procedure TdxHorizontalRulerViewInfo.CalculateTabsBoundsCore(ATabsController
  : TdxTabsController);
var
...
begin
  ...
  ALayoutPosition := Round(ClientBounds.Left -
    (ActiveAreaCollection[CurrentActiveAreaIndex].Left / Control.ZoomFactor));
  AModelPosition := Control.DocumentModel.ToDocumentLayoutUnitConverter.
    ToModelUnits(ALayoutPosition);
...
function TdxHorizontalRulerViewInfo.GetAdditionalCellIndent
  (ACellViewInfo: TdxTableCellViewInfo; AApplyZoomFactor: Boolean): Integer;
begin
  Result := 0;
...
function TdxHorizontalRulerViewInfo.GetAdditionalCellIndent(AApplyZoomFactor
  : Boolean): Integer;
begin
  Result := GetAdditionalCellIndent(TableCellViewInfo, AApplyZoomFactor);
end;

function TdxHorizontalRulerViewInfo.GetAdditionalParentCellIndent
  (AApplyZoomFactor: Boolean): Integer;
begin
  if TableCellViewInfo = nil then
    Exit(0);
  Result := GetAdditionalCellIndent
    (TableCellViewInfo.TableViewInfo.ParentTableCellViewInfo, AApplyZoomFactor);
end;
...
begin
  if TableCellViewInfo = nil then
    ...
    Result := ActiveAreaCollection[CurrentActiveAreaIndex].Left +
      GetCellTextRight(TableCellViewInfo, True);
end;

function TdxHorizontalRulerViewInfo.GetCellTextRight(ACellViewInfo
  : TdxTableCellViewInfo; AApplyZoomFactor: Boolean): Integer;
begin
  Result := GetAdditionalCellIndent(ACellViewInfo, False) +
    ACellViewInfo.TextWidth;
  if AApplyZoomFactor then
    Result := Trunc(Result * Control.ZoomFactor);
end;

procedure TdxHorizontalRulerViewInfo.AddTabHotZone(const ATabInfo: TdxTabInfo;
  APos: Integer);
begin
  FDefaultTabsCollection.Clear;
  FDisplayDefaultTabsCollection.Clear;
  if DocumentModel.DocumentCapabilities.ParagraphTabsAllowed and
    Control.RichEditControl.InnerControl.Options.HorizontalRuler.ShowTabs then
    AddTabHotZoneCore(ATabInfo, APos);
end;

function TdxHorizontalRulerViewInfo.AddTabHotZoneCore(const ATabInfo
  : TdxTabInfo; APos: Integer): TdxTabHotZone;
begin
  Result := CreateTabHotZone(ATabInfo, GetTabBounds(APos));
  HotZones.Add(Result);
end;

function TdxHorizontalRulerViewInfo.CreateTabHotZone(const ATabInfo: TdxTabInfo;
  const ABounds: TRect): TdxTabHotZone;
begin
...
begin
  Result := TRect.CreateSize(APosition, ClientBounds.Top +
    ClientBounds.Height div 2, 10, ClientBounds.Height div 2);
end;
...
begin
  ...
  begin
    ...
    FDisplayDefaultTabsCollection.Add
      (Control.DocumentModel.LayoutUnitConverter.LayoutUnitsToPixels(ABounds,
      Control.DpiX, Control.DpiY));
  end;
end;

function TdxHorizontalRulerViewInfo.GetRulerLayoutPosition(AModelPosition
  : Integer): Integer;
var
  ALayoutPosition: Integer;
begin
  ALayoutPosition := Control.DocumentModel.ToDocumentLayoutUnitConverter.
    ToLayoutUnits(AModelPosition);
  Result := Round(ALayoutPosition * Control.ZoomFactor + ActiveAreaCollection
    [CurrentActiveAreaIndex].Left);
end;

function TdxHorizontalRulerViewInfo.GetRulerModelPosition(ALayoutPosition
  : Integer): Integer;
var
  K: Integer;
begin
  K := Trunc((ALayoutPosition - ActiveAreaCollection[CurrentActiveAreaIndex]
    .Left) / Control.ZoomFactor);
  Result := Control.DocumentModel.ToDocumentLayoutUnitConverter.ToModelUnits(K);
end;

function TdxHorizontalRulerViewInfo.
  GetRulerModelPositionRelativeToTableCellViewInfo(ALayoutPosition
  : Integer): Integer;
var
...
begin
  ...
  K := Trunc((ALayoutPosition - ActiveAreaCollection[CurrentActiveAreaIndex]
    .Left) / Control.ZoomFactor) - AAdditionalIndent;
  Result := Control.DocumentModel.ToDocumentLayoutUnitConverter.ToModelUnits(K);
end;

procedure TdxHorizontalRulerViewInfo.CalculateIndentElementsBounds;
var
  AAdditionalIndent, AFirstIndentPosition, ALeftIndentPosition,
    ARightIndentPosition, ATabWidth, ARightBorder, ALeftBorder: Integer;
begin
  if not DocumentModel.DocumentCapabilities.ParagraphFormattingAllowed then
    Exit;
  AAdditionalIndent := GetAdditionalCellIndent(True);
  AFirstIndentPosition := GetRulerLayoutPosition
    (GetIndentInModelUnits(Paragraph)) + AAdditionalIndent;
  ALeftIndentPosition := GetRulerLayoutPosition(Paragraph.LeftIndent) +
    AAdditionalIndent;
  ARightIndentPosition := GetRightIndentLayoutPosition(Paragraph.RightIndent);
  ATabWidth := Control.DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits
    (FDefaultTabWidth);
  if ARightIndentPosition < ALeftIndentPosition then
    ARightIndentPosition := ALeftIndentPosition +
      Control.DocumentModel.LayoutUnitConverter.PixelsToLayoutUnits
      (MinDistanceBetweenIndents);
  ARightBorder := ARightIndentPosition - ATabWidth;
  ALeftBorder := Math.Max(ALeftIndentPosition, AFirstIndentPosition) +
    ATabWidth;
  ...
  then
    AddLeftIndentHotZone(Paragraph, ALeftIndentPosition, ARightBorder,
      AFirstIndentPosition);
...
function TdxHorizontalRulerViewInfo.GetRightIndentLayoutPosition
  (AModelPosition: Integer): Integer;
var
  ALayoutPosition: Integer;
...
function TdxHorizontalRulerViewInfo.GetRightIndentModelPosition(ALayoutPosition
  : Integer): Integer;
var
...
begin
  ARightPosition := GetRightIndentBasePosition;
  ALayoutRightIndent := Trunc((ARightPosition - ALayoutPosition) /
    Control.ZoomFactor);
  Result := Control.DocumentModel.ToDocumentLayoutUnitConverter.ToModelUnits
    (ALayoutRightIndent);
end;

function TdxHorizontalRulerViewInfo.GetIndentInModelUnits
...
procedure TdxHorizontalRulerViewInfo.AddLeftIndentHotZone
  (AParagraph: TdxParagraph; ALeftIndent: Integer; ARightBorder: Integer;
...
begin
  ...
  AFirstLineHotZone := AddFirstLineHotZone(AParagraph, ARightBorder,
    AFirstIndent, AHeight);
  ABounds := TRect.CreateSize(ALeftIndent, ClientBounds.Top + AHeight,
    0, AHeight);
  ABottomHotZone := TdxLeftBottomHotZone.Create(Control, ABounds,
    AParagraph.LeftIndent, ARightBorder, AFirstLineHotZone);
  ABottomHotZone.AddLeftHotZone(ABounds);
  HotZones.Add(ABottomHotZone);
end;

function TdxHorizontalRulerViewInfo.AddFirstLineHotZone
  (AParagraph: TdxParagraph; ARightBorder: Integer; AFirstIndent: Integer;
...
begin
  ...
  AFirstLineHotZone := TdxFirstLineIndentHotZone.Create(Control, ABounds,
    GetIndentInModelUnits(AParagraph), AParagraph.LeftIndent);
  AFirstLineHotZone.RightBorder := ARightBorder;
  HotZones.Add(AFirstLineHotZone);
  Result := AFirstLineHotZone;
end;

procedure TdxHorizontalRulerViewInfo.AddRightIndentHotZone
  (AParagraph: TdxParagraph; ARightIndent: Integer; ALeftBorder: Integer);
var
  AHeight: Integer;
  ABounds: TRect;
...
begin
  AHeight := ClientBounds.Height div 2;
  ABounds := TRect.CreateSize(ARightIndent, ClientBounds.Top + AHeight,
    0, AHeight);
  AHotZone := TdxRightIndentHotZone.Create(Control, ABounds,
...
begin
  ...
  begin
    if Control.RichEditControl.InnerControl.ActiveViewType <>
      TdxRichEditViewType.Draft then
    begin
...
begin
  X := Trunc(ActiveAreaCollection[AIndex].Right +
    (ActiveAreaCollection[AIndex + 1].Left - ActiveAreaCollection[AIndex]
    .Right) / 2);
  AHotZone := TdxMiddleColumnResizerHotZone.Create(Control,
    TRect.CreateSize(X, ClientBounds.Top, 0, 0), AIndex);
  HotZones.Add(AHotZone);
end;
...
begin
  ABounds := TRect.CreateSize(Trunc(ActiveAreaCollection[AIndex].Left),
    ClientBounds.Top, 0, 0);
...
begin
  ABounds := TRect.CreateSize(Trunc(ActiveAreaCollection[AIndex].Right),
    ClientBounds.Top, 0, 0);
...
begin
  Result := Trunc(Control.DocumentModel.DocumentProperties.DefaultTabWidth *
    Control.ZoomFactor);
end;
...
begin
  ...
  FTabTypeToggleBackground := TdxTabTypeToggleBackgroundHotZone.Create
    (FControl, ABounds);
  ASize := FControl.GetTabTypeToggleActiveAreaSize;
  ABounds.InitSize(ABounds.Left + (ABounds.Width - ASize.Width) div 2,
    ABounds.Top + (ABounds.Height - ASize.Height) div 2, ASize.Width,
    ASize.Height);
...
begin
  ...
  AHalfTickWidth := 1;
  Y := (ClientBounds.Top + inherited Control.Painter.VerticalTextPaddingTop +
    ASize.Height / 2.0);
...
begin
  AQuarterTickWidth := 1;
  Result.InitSize(0, HalfTickBounds.Top + HalfTickBounds.Height / 4.0,
    AQuarterTickWidth, HalfTickBounds.Height / 2.0);
end;
...
function TdxRulerHotZonesComparer.Compare(const AHotZone,
  ANextHotZone: TdxRulerHotZone): Integer;
begin
  if AHotZone.Weight > ANextHotZone.Weight then
    Result := -1
  else if AHotZone.Weight < ANextHotZone.Weight then
    Result := 1
  else
    Result := 0;
end;
...
constructor TdxVerticalRulerViewInfo.Create(const AControl
  : TdxVerticalRulerControl; ASectionProperties: TdxSectionProperties;
  AIsMainPieceTable: Boolean; ATableVerticalPositions: TdxSortedList<Integer>;
  ATableCellViewInfo: TdxTableCellViewInfo);
begin
  inherited Create(AControl, ASectionProperties, AIsMainPieceTable);
  FControl := AControl;
...
function TdxVerticalRulerViewInfo.CalculateClientBounds(const AControl
  : TdxRulerControlBase): TRect;
var
  APageClientBounds: TRect;
  ACaretPosition: TdxCaretPosition;
...
begin
  ...
  if AControl.RichEditControl.InnerControl.ActiveViewType = TdxRichEditViewType.PrintLayout
  then
    APageClientBounds.Height :=
      Round(ToDocumentLayoutUnitConverter.ToLayoutUnits
      (Min(MaxRulerDimensionInModelUnits, SectionProperties.PageHeight)) *
      AControl.ZoomFactor)
  else
    APageClientBounds.Height :=
      Round(ToDocumentLayoutUnitConverter.ToLayoutUnits
      (Min(MaxRulerDimensionInModelUnits, SectionProperties.PageHeight -
      SectionProperties.TopMargin)) * AControl.ZoomFactor);
  AClientWidth := TextSize.Height + 2 *
    AControl.Painter.VerticalTextPaddingBottom;
  X := AControl.Painter.PaddingTop;
  Result.InitSize(X, APageClientBounds.Top, AClientWidth,
    APageClientBounds.Height);
end;
...
begin
  AUnitConverter := FControl.DocumentModel.LayoutUnitConverter;
  AWidth := DisplayClientBounds.Width + AUnitConverter.LayoutUnitsToPixels
    (FControl.Painter.PaddingTop + FControl.Painter.PaddingBottom,
    Control.DpiX);
...
begin
  ...
  Result.InitSize(HalfTickBounds.Left + HalfTickBounds.Width / 4.0, 0,
    HalfTickBounds.Width / 2.0, AQuarterTickHeight);
end;
...
begin
  ...
  AActiveBounds := TRect.CreateSize(ClientBounds.Left, AActiveBounds.Top,
    ClientBounds.Width, AActiveBounds.Height);
  ...
  ALayoutUnitConverter := FControl.DocumentModel.LayoutUnitConverter;
  DisplayActiveAreaCollection.Add(ALayoutUnitConverter.LayoutUnitsToPixels
    (AActiveBounds, Control.DpiX, Control.DpiY).ToRectF);
end;
...
var
  APage: TdxPage;
begin
  if not IsMainPieceTable and
    (Control.RichEditControl.InnerControl.ActiveView.CaretPosition.Update
    (TdxDocumentLayoutDetailsLevel.PageArea)) then
  begin
    APage := Control.RichEditControl.InnerControl.ActiveView.CaretPosition.
      LayoutPosition.Page;
    if (APage.Header <> nil) and
      (APage.Header.PieceTable = Control.DocumentModel.Selection.PieceTable)
    then
      Exit(APage.Header.Bounds)
    else if (APage.Footer <> nil) and
      (APage.Footer.PieceTable = Control.DocumentModel.Selection.PieceTable)
    then
...
begin
  AControl := Control.RichEditControl;
  APageCalculator := TdxPageBoundsCalculator.Create
    (Control.DocumentModel.ToDocumentLayoutUnitConverter);
  try
    APrintLayoutViewPageClientBounds := CalculatePageClientBounds
      (APageCalculator, SectionProperties);
  finally
  ...
  AActiveViewPageClientBounds := CalculatePageClientBounds
    (AActiveViewPageCalculator, SectionProperties);
  ADeltaY := AActiveViewPageClientBounds.Top -
    APrintLayoutViewPageClientBounds.Top -
    Ceil(Control.Painter.PaddingTop / Control.ZoomFactor);
  ADeltaHeight := AActiveViewPageClientBounds.Height -
    APrintLayoutViewPageClientBounds.Height;
  APrintLayoutViewPageClientBounds.MoveToTop
    (APrintLayoutViewPageClientBounds.Top + ADeltaY);
  APrintLayoutViewPageClientBounds.Height :=
    APrintLayoutViewPageClientBounds.Height + ADeltaHeight;
...
begin
  ...
  begin
    ABounds := TRect.CreateSize(Trunc(ActiveAreaCollection[0].Left),
      Trunc(FTableVerticalPositions[I] * Control.ZoomFactor),
      Trunc(ActiveAreaCollection[0].Width),
      Trunc(ActiveAreaCollection[0].Width * Control.ZoomFactor));
    AHotZone := TdxVerticalTableHotZone.Create(Control, ABounds,
      FTableCellViewInfo.TableViewInfo, I);
    HotZones.Add(AHotZone);
  end;
end;
...
begin
  ABounds := TRect.CreateSize(ClientBounds.Left,
    Trunc(ActiveAreaCollection[AIndex].Bottom), ClientBounds.Width,
    ClientBounds.Width);
...
begin
  ABounds := TRect.CreateSize(ClientBounds.Left,
    Trunc(ActiveAreaCollection[AIndex].Top), ClientBounds.Width,
    ClientBounds.Width);
  AHotZone := TdxSectionTopResizerHotZone.Create(Control, ABounds, AIndex);
  HotZones.Add(AHotZone);
end;

function TdxVerticalRulerViewInfo.GetRulerLayoutPosition(AModelPosition
  : Integer): Integer;
var
  ALayoutPosition: Integer;
begin
  ALayoutPosition := Control.DocumentModel.ToDocumentLayoutUnitConverter.
    ToLayoutUnits(AModelPosition);
  Result := Trunc(ALayoutPosition * Control.ZoomFactor + ActiveAreaCollection
    [CurrentActiveAreaIndex].Top);
end;

function TdxVerticalRulerViewInfo.GetRulerModelPosition(ALayoutPosition
  : Integer): Integer;
var
  K: Integer;
begin
  K := Trunc((ALayoutPosition - ActiveAreaCollection[CurrentActiveAreaIndex]
    .Top) / Control.ZoomFactor);
  Result := Control.DocumentModel.ToDocumentLayoutUnitConverter.ToModelUnits(K);
end;

{ TdxRulerControlBase }

constructor TdxRulerControlBase.Create(ARichEditControl
...
begin
  Result := TdxGPFont.Create('Arial', TickMarkFontSize *
    InternalScaleFactor.Numerator / InternalScaleFactor.Denominator,
    FontStyleRegular);
end;
...
procedure TdxRulerControlBase.DoContextPopup(MousePos: TPoint;
  var Handled: Boolean);
begin
  Handled := True;
end;
...
begin
  Result := RichEditControl.ActiveView.ZoomFactor *
    InternalScaleFactor.Numerator / InternalScaleFactor.Denominator;
end;
...
begin
  if not RichEditControl.ActiveView.CaretPosition.Update
    (TdxDocumentLayoutDetailsLevel.Column) then
    Exit;
  if IsVisible then
  begin
...
begin
  ...
  AParagraphIndex := DocumentModel.ActivePieceTable.FindParagraphIndex
    (ALogPosition);
  if ALogPosition > ASelection.Start then
  begin
    if ALogPosition = DocumentModel.ActivePieceTable.Paragraphs[AParagraphIndex]
      .LogPosition then
...
begin
  ...
  begin
    ASectionIndex := DocumentModel.MainPieceTable.
      LookupSectionIndexByParagraphIndex(AParagraphIndex);
    Exit(DocumentModel.Sections[ASectionIndex]);
  end
  else if APieceTable.IsTextBox then
  begin
    ATextBoxContent := TdxTextBoxContentType(APieceTable.ContentType);
    if ATextBoxContent.AnchorRun.PieceTable.IsMain then
    begin
      ASectionIndex := DocumentModel.MainPieceTable.
        LookupSectionIndexByParagraphIndex
        (ATextBoxContent.AnchorRun.Paragraph.Index);
      Exit(DocumentModel.Sections[ASectionIndex]);
    end
    else
    begin
...
begin
  Result := DocumentModel.LayoutUnitConverter.LayoutUnitsToPixels(AValue,
    RichEditControl.DpiX);
end;

function TdxRulerControlBase.LayoutUnitsToPixelsV(AValue: Integer): Integer;
begin
  Result := DocumentModel.LayoutUnitConverter.LayoutUnitsToPixels(AValue,
    RichEditControl.DpiY);
end;
...
begin
  Result := DocumentModel.LayoutUnitConverter.PixelsToLayoutUnits(AValue,
    RichEditControl.DpiX);
end;
...
procedure TdxRulerControlBase.AddKeyboardService(const AService
  : IdxKeyboardHandlerService);
begin
  FRichEditControl.AddKeyboardService(AService);
end;

procedure TdxRulerControlBase.RemoveKeyboardService(const AService
  : IdxKeyboardHandlerService);
begin
...
begin
  Result := not(RichEditControl.IsDesigning or
    not RichEditControl.ActiveView.CaretPosition.Update
    (TdxDocumentLayoutDetailsLevel.Column));
end;

procedure TdxRulerControlBase.MouseDown(Button: TMouseButton;
...
procedure TdxRulerControlBase.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X: Integer; Y: Integer);
begin
  try
...
procedure TdxRulerControlBase.MouseMove(Shift: TShiftState; X: Integer;
  Y: Integer);
begin
  if not CanHandleMouseEvent then
    Exit;
...
var
  AIndex: Integer;
begin
  AIndex := FRichEditControl.ActiveView.CaretPosition.LayoutPosition.
    Page.PageIndex;
...
var
  AIndex: Integer;
begin
  AIndex := FRichEditControl.ActiveView.CaretPosition.LayoutPosition.PageArea.
    Columns.IndexOf(FRichEditControl.ActiveView.CaretPosition.
    LayoutPosition.Column);
...
begin
  ...
  if (ASelection.Length > 0) and
    (ASelection.&End = AActivePieceTable.Paragraphs[Result].LogPosition) then
    Dec(Result);
end;

function TdxRulerControlBase.GetTableAlignedPositions(ATableViewInfo
  : TdxTableViewInfo): TdxSortedList<Integer>;
var
  I: Integer;
begin
  Result := TdxSortedList<Integer>.Create;
  for I := 0 to ATableViewInfo.VerticalBorderPositions.AlignedPosition.
    Count - 1 do
    Result.Add(ATableViewInfo.VerticalBorderPositions.AlignedPosition[I]);
end;

function TdxRulerControlBase.GetTableCellViewInfo(AIsMainPieceTable: Boolean)
  : TdxTableCellViewInfo;
var
  ASelection: TdxSelection;
  ACaretPosition: TdxCaretPosition;
...
begin
  ...
  begin
    if ACaretPosition.Update(TdxDocumentLayoutDetailsLevel.TableCell) and
  ...
  begin
    ...
    if AIsMainPieceTable then
      ALayoutPosition := TdxDocumentLayoutPosition.Create(ADocumentLayout,
        ACaretPosition.LayoutPosition.PieceTable, ALogPosition)
    else
    begin
    ...
    try
      if ALayoutPosition.Update(ADocumentLayout.Pages,
        TdxDocumentLayoutDetailsLevel.TableCell) then
...
function TdxRulerControlBase.GetTableVerticalPositions(AIsMainPieceTable
  : Boolean): TdxSortedList<Integer>;
var
  ACaretPosition: TdxCaretPosition;
  ATableViewInfo: TdxTableViewInfo;
  I: Integer;
begin
  ACaretPosition := RichEditControl.ActiveView.CaretPosition;
  Result := TdxSortedList<Integer>.Create;
  if AIsMainPieceTable and ACaretPosition.Update
    (TdxDocumentLayoutDetailsLevel.TableCell) and
    (ACaretPosition.LayoutPosition.TableCell <> nil) then
  begin
...
constructor TdxHorizontalRulerControl.Create(ARichEditControl
  : TdxCustomRichEditControl);
begin
  inherited Create(ARichEditControl);
  FTabTypeIndex := 0;
  Painter.Initialize;
  ViewInfo.Initialize;
  inherited SetBounds(ARichEditControl.ClientBounds.Left,
    ARichEditControl.ClientBounds.Top, ARichEditControl.ClientBounds.Width,
    GetRulerHeightInPixels);
end;
...
procedure TdxHorizontalRulerControl.SetViewInfo(ANewViewInfo
  : TdxHorizontalRulerViewInfo);
begin
...
function TdxHorizontalRulerControl.GetColumnIndex(AIsMainPieceTable
  : Boolean): Integer;
var
  ACaretPosition: TdxCaretPosition;
begin
  ACaretPosition := RichEditControl.ActiveView.CaretPosition;
  if ACaretPosition.Update(TdxDocumentLayoutDetailsLevel.Column) and AIsMainPieceTable
  then
    Exit(ACaretPosition.LayoutPosition.PageArea.Columns.IndexOf
      (ACaretPosition.LayoutPosition.Column));
  Result := 0;
end;

function TdxHorizontalRulerControl.CreateMouseController
  : TdxRulerMouseController;
begin
...
function TdxHorizontalRulerControl.CreateViewInfoCore(ASectionProperties
  : TdxSectionProperties; AIsMainPieceTable: Boolean)
  : TdxHorizontalRulerViewInfo;
var
...
begin
  ...
  if ATableCellViewInfo <> nil then
    ATableAlignedPositions := GetTableAlignedPositions
      (ATableCellViewInfo.TableViewInfo)
  else
    ATableAlignedPositions := TdxSortedList<Integer>.Create;
  Result := TdxHorizontalRulerViewInfo.Create(Self, ASectionProperties,
    AParagraph, AColumnIndex, AIsMainPieceTable, ATableCellViewInfo,
    ATableAlignedPositions);
end;
...
begin
  Result := ViewInfo.DisplayClientBounds.Height + LayoutUnitsToPixelsV
    (Painter.PaddingTop + Painter.PaddingBottom);
end;
...
function TdxHorizontalRulerControl.GetPhysicalPoint(const APoint
  : TPoint): TPoint;
var
  X, Y: Integer;
begin
...
function TdxHorizontalRulerControl.CalculateHotZoneSize
  (AHotZone: TdxHorizontalRulerHotZone): TSize;
begin
...
function TdxHorizontalRulerControl.
  CalculateTabTypeToggleBackgroundBounds: TRect;
begin
...
constructor TdxVerticalRulerControl.Create(ARichEditControl
  : TdxCustomRichEditControl);
begin
  inherited Create(ARichEditControl);
...
begin
  ...
  ASection := GetSection(DocumentModel.Selection.PieceTable);
  Result := TdxVerticalRulerViewInfo.Create(Self,
    TdxSectionProperties.Create(ASection), AIsMainPieceTable,
    AVerticalPositions, ATableCellViewInfo);
end;

procedure TdxVerticalRulerControl.SetViewInfo(ANewViewInfo
  : TdxVerticalRulerViewInfo);
begin
  inherited SetViewInfo(ANewViewInfo);
  ViewInfo.Initialize;
