...
type
  ...
  protected
    ...
    function GetBookmarkCollection: TdxBookmarkBaseCollection; virtual;
      abstract;

    property DeletedBookmark: TdxBookmarkBase read FDeletedBookmark
      write FDeletedBookmark;
  public
    constructor Create(APieceTable: TdxCustomPieceTable); override;
    destructor Destroy; override;

    property DeletedBookmarkIndex: Integer read FDeletedBookmarkIndex
      write FDeletedBookmarkIndex;
  end;
  ...
  TdxInsertDocumentIntervalHistoryItem = class abstract
    (TdxBookmarkBaseHistoryItem)
  strict private
    FLength: Integer;
  ...
  TdxInsertBookmarkBaseHistoryItem = class abstract
    (TdxInsertDocumentIntervalHistoryItem)
  strict private
  ...
  protected
    ...
    procedure RedoCore; override;
    procedure UndoCore; override;
    function CreateBookmark(AStart: TdxDocumentLogPosition;
      AEnd: TdxDocumentLogPosition): TdxBookmarkBase; virtual; abstract;
    function GetBookmarkCollection: TdxBookmarkBaseCollection; virtual;
      abstract;
  ...
  protected
    function CreateBookmark(AStart: TdxDocumentLogPosition;
      AEnd: TdxDocumentLogPosition): TdxBookmarkBase; override;
    function GetBookmarkCollection: TdxBookmarkBaseCollection; override;
  public
    constructor Create(APieceTable: TdxCustomPieceTable); override;
...
constructor TdxDeleteBookmarkBaseHistoryItem.Create
...
function TdxDeleteBookmarkHistoryItem.GetBookmarkCollection
...
constructor TdxInsertDocumentIntervalHistoryItem.Create
  (APieceTable: TdxCustomPieceTable);
begin
  inherited Create(APieceTable);
  FIndexToInsert := -1;
...
begin
  FOwnsBookmark := True;
  FBookmark := CreateBookmark(Min(Position, PieceTable.DocumentEndLogPosition),
    Min(Position + Length, PieceTable.DocumentEndLogPosition));
  if Length = 0 then
...
constructor TdxInsertBookmarkHistoryItem.Create(APieceTable
  : TdxCustomPieceTable);
begin
  inherited Create(APieceTable);
  FBookmarkName := '';
...
function TdxInsertBookmarkHistoryItem.CreateBookmark
...
function TdxInsertBookmarkHistoryItem.GetBookmarkCollection
  : TdxBookmarkBaseCollection;
begin
  Result := PieceTable.Bookmarks;
end;
