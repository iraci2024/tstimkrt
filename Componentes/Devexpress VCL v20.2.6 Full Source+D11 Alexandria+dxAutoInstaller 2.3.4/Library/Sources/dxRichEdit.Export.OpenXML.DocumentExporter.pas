...
function TdxOpenXmlDocumentExporter.FormatEquals(const AValue
...
function TdxOpenXmlDocumentExporter.SaveDocument(const ADocumentModel
...
begin
  AModel.InternalAPI.SaveDocumentOpenXmlContent(AStream,
    TdxOpenXmlDocumentExporterOptions(AOptions));
  Result := True;
end;
