...
{$ENDIF}
  ...
  dxLayoutContainer, cxLabel, dxLayoutControl, dxLayoutControlAdapters,
  dxLayoutLookAndFeels, cxClasses,
  StdCtrls, cxButtons, cxFontNameComboBox, dxColorEdit, dxCoreGraphics,
  ActnList, ImgList, ExtCtrls, dxCore, dxCoreClasses, dxGDIPlusAPI,
  dxGDIPlusClasses,
...
type
  ...
  protected
    ...
    procedure FillStyleCombo(AComboBox: TcxComboBox;
      AStyleCollection: TdxStyleCollectionBase;
      AMatch: TFunc<TdxStyleBase, Boolean>); overload;
    procedure FillCurrentStyleCombo(AComboBox: TcxCustomComboBox;
    ...
    procedure UpdateCharacterBars(const AMergedCharacterProperties
    ...
    property IntermediateCharacterStyle: TdxCharacterStyle
      read GetIntermediateCharacterStyle;
    property IntermediateParagraphStyle: TdxParagraphStyle
      read GetIntermediateParagraphStyle;
    property CharacterStyleParent: TdxCharacterStyle
      read GetCharacterStyleParent;
...
function TdxRichEditEditStyleDialogForm.GetController
  : TdxEditStyleFormController;
begin
  Result := TdxEditStyleFormController(inherited Controller);
end;

procedure TdxRichEditEditStyleDialogForm.ApplyCharacterProperties
...
begin
  ...
  lblSelectedStyle.Caption := cxGetResourceString
    (@sdxRichEditEditStyleDialogSelectedStyle);
  lblProperties.Caption := cxGetResourceString
    (@sdxRichEditEditStyleDialogProperties);
  lblFormatting.Caption := cxGetResourceString
  ...
  lcilStyleBasedOn.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditEditStyleDialogStyleBasedOn);
  lciStyleForFollowingParagraph.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditEditStyleDialogStyleForFollowingParagraph);
  lciCurrentStyle.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditEditStyleDialogCurrentStyle);
  aToggleFontBold.Caption := cxGetResourceString
  ...
  aToggleFontItalic.Caption := cxGetResourceString
  ...
  aToggleFontUnderline.Caption := cxGetResourceString
...
procedure TdxRichEditEditStyleDialogForm.ApplyParagraphProperties
...
procedure TdxRichEditEditStyleDialogForm.ApplyTabsProperties
...
procedure TdxRichEditEditStyleDialogForm.aDecrementIndentExecute
  (Sender: TObject);
begin
...
begin
  ...
  if IsParagraphStyle then
    AMergedProperties := Controller.IntermediateParagraphStyle.
      GetMergedWithDefaultCharacterProperties
  else
    AMergedProperties := Controller.IntermediateCharacterStyle.
      GetMergedWithDefaultCharacterProperties;
  try
...
procedure TdxRichEditEditStyleDialogForm.aIncrementIndentExecute
  (Sender: TObject);
begin
  Controller.IncreaseIndent;
end;

procedure TdxRichEditEditStyleDialogForm.aParagraphDialogExecute
  (Sender: TObject);
var
  AControl: IdxRichEditControl;
...
procedure TdxRichEditEditStyleDialogForm.aSpacingDecreaseExecute
  (Sender: TObject);
begin
  Controller.DecreaseSpacing;
end;

procedure TdxRichEditEditStyleDialogForm.aSpacingIncreaseExecute
  (Sender: TObject);
begin
...
procedure TdxRichEditEditStyleDialogForm.FontColorPropertiesChange
  (Sender: TObject);
var
...
procedure TdxRichEditEditStyleDialogForm.FontSizePropertiesChange
  (Sender: TObject);
var
  AText: string;
  AValue: Integer;
...
procedure TdxRichEditEditStyleDialogForm.FormCloseQuery(Sender: TObject;
...
procedure TdxRichEditEditStyleDialogForm.FontEditPropertiesChange
  (Sender: TObject);
var
  AText: string;
  AAccessor: TdxCharacterPropertyAccessor;
...
function TdxRichEditEditStyleDialogForm.CreateController(AControllerParameters
  : TdxFormControllerParameters): TdxFormController;
begin
  Result := TdxEditStyleFormController.Create(PreviewRichEditControl,
    AControllerParameters as TdxEditStyleFormControllerParameters);
end;

procedure TdxRichEditEditStyleDialogForm.CurrentStylePropertiesChange
  (Sender: TObject);
var
  AStyle: IdxStyle;
  AStyleName: string;
begin
  ...
  if cmbCurrentStyle.ItemObject is TdxParagraphStyle then
    Controller.Parameters.ParagraphSourceStyle :=
      Controller.Model.ParagraphStyles.GetStyleByName(AStyleName)
      as TdxParagraphStyle
  else
    Controller.Parameters.CharacterSourceStyle :=
      Controller.Model.CharacterStyles.GetStyleByName(AStyleName)
      as TdxCharacterStyle;
...
procedure TdxRichEditEditStyleDialogForm.FillCurrentStyleCombo
...
procedure TdxRichEditEditStyleDialogForm.FillStyleCombo(AComboBox: TcxComboBox;
  AStyleCollection: TdxStyleCollectionBase;
  AMatch: TFunc<TdxStyleBase, Boolean>);
var
...
procedure TdxRichEditEditStyleDialogForm.FillStyleCombo
...
function TdxRichEditEditStyleDialogForm.GetCharacterProperties
  : TdxCharacterProperties;
begin
  Result := Controller.CharacterProperties;
end;

function TdxRichEditEditStyleDialogForm.GetCharacterStyleParent
  : TdxCharacterStyle;
begin
...
function TdxRichEditEditStyleDialogForm.GetIntermediateCharacterStyle
  : TdxCharacterStyle;
begin
  Result := Controller.IntermediateCharacterStyle;
end;

function TdxRichEditEditStyleDialogForm.GetIntermediateParagraphStyle
  : TdxParagraphStyle;
begin
...
function TdxRichEditEditStyleDialogForm.GetParagraphProperties
...
begin
  ...
  begin
    ButtonsEnabled(True);
    AStyleCollection :=
      (Controller.ParagraphSourceStyle.DocumentModel as TdxDocumentModel)
      .ParagraphStyles;
  ...
  begin
    ...
    FillStyleCombo(cmbParent,
      (Controller.CharacterSourceStyle.DocumentModel as TdxDocumentModel)
      .CharacterStyles, IsCharacterParentValid);
    ButtonsEnabled(False);
  end;
  UpdateRichEditBars;
end;

function TdxRichEditEditStyleDialogForm.IsCharacterParentValid
  (AStyle: TdxStyleBase): Boolean;
begin
  Result := Controller.CharacterSourceStyle.IsParentValid(AStyle);
end;

function TdxRichEditEditStyleDialogForm.IsNextValid
  (AStyle: TdxStyleBase): Boolean;
begin
  Result := True;
end;

function TdxRichEditEditStyleDialogForm.IsParagraphParentValid
  (AStyle: TdxStyleBase): Boolean;
begin
  Result := Controller.ParagraphSourceStyle.IsParentValid(AStyle);
end;

procedure TdxRichEditEditStyleDialogForm.NameStylePropertiesChange
  (Sender: TObject);
begin
  Controller.StyleName := edtName.Text;
end;

procedure TdxRichEditEditStyleDialogForm.NextStylePropertiesChange
  (Sender: TObject);
begin
  if IsParagraphStyle then
    Controller.IntermediateParagraphStyle.NextParagraphStyle :=
      TdxParagraphStyle(cmbNextStyle.ItemObject);
end;

procedure TdxRichEditEditStyleDialogForm.ParentStylePropertiesChange
  (Sender: TObject);
begin
  if IsParagraphStyle then
    Controller.IntermediateParagraphStyle.Parent :=
      TdxParagraphStyle(cmbParent.ItemObject)
  else
...
procedure TdxRichEditEditStyleDialogForm.SetParagraphSpacingExecute
  (Sender: TObject);
var
  AAction: TAction;
begin
...
procedure TdxRichEditEditStyleDialogForm.ToggleFontItalicExecute
  (Sender: TObject);
var
  AAccessor: TdxCharacterPropertyAccessor;
begin
...
procedure TdxRichEditEditStyleDialogForm.ToggleFontUnderlineExecute
  (Sender: TObject);
var
  AAccessor: TdxCharacterPropertyAccessor;
begin
...
procedure TdxRichEditEditStyleDialogForm.ToggleParagraphAlignmentExecute
  (Sender: TObject);
var
  AAction: TAction;
begin
...
procedure TdxRichEditEditStyleDialogForm.UpdateCharacterBars
  (const AMergedCharacterProperties: TdxCharacterFormattingInfo);
begin
  ...
  aToggleFontUnderline.Checked := AMergedCharacterProperties.FontUnderlineType =
...
begin
  ...
  begin
    ...
    cmbNextStyle.ItemObject := Controller.ParagraphSourceStyle.
      NextParagraphStyle;
  end
  else
  begin
...
begin
  ...
  begin
    ...
    AMergedCharacterProperties :=
      Controller.GetIntermediateMergedCharacterProperties
    ...
    AParagraphProperties := Controller.GetIntermediateMergedParagraphProperties
      (IntermediateParagraphStyle);
    try
    ...
    UnsubscribeParagraphLineSpacingEvents;
    aSetSingleParagraphSpacing.Checked :=
      ASpacing = TdxParagraphLineSpacing.Single;
    aSetSesquialteralParagraphSpacing.Checked :=
      ASpacing = TdxParagraphLineSpacing.Sesquialteral;
    aSetDoubleParagraphSpacing.Checked :=
      ASpacing = TdxParagraphLineSpacing.Double;
    SubscribeParagraphLineSpacingEvents;
  end
  else
  begin
