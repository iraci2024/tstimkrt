...
uses
  Classes, Graphics, Windows, dxCore, cxGeometry, cxGraphics, dxXMLDoc,
  dxGDIPlusClasses, dxCompositeShape,
...
type
  ...
  TdxGaugeLinearScaleDefaultParameters = class
  ...
  private
    ...
    procedure SetLabelOrientation(const AValue
      : TdxGaugeLinearScaleLabelOrientation);
  ...
  published
    ...
    property AlignElements: TdxGaugeLinearScaleAlignElements
      read GetAlignElements write SetAlignElements default taLeftJustify;
    property LabelOrientation: TdxGaugeLinearScaleLabelOrientation
      read GetLabelOrientation write SetLabelOrientation default toLeftToRight;
    property ShowLevelBar: Boolean read GetShowValueIndicator
      write SetShowValueIndicator default True;
    property RotationAngle: TcxRotationAngle read GetRotationAngle
      write SetRotationAngle default raMinus90;
  end;
  ...
  private
    ...
    procedure RotateContent(AGPGraphics: TdxGPGraphics; AAngle: Single;
  ...
  protected
    ...
    function GetLabelTextRect(APosition: Single; const AText: string)
      : TdxRectF; override;
  ...
  protected
    ...
    property OptionsView: TdxGaugeLinearScaleOptionsView read GetOptionsView
  ...
  TdxGaugeCustomLinearScaleStyleReader = class
  ...
  published
    property CenterPositionFactor: Single read GetCenterPositionFactor
      write SetCenterPositionFactor stored IsCenterPositionFactorStored;
    property Color;
...
function dxGaugeLinearScaleValueToPoint(AValue, AMinValue: Single;
  const ALevelBarLine: TdxRectF; AValueRange: Single): TdxPointF;
begin
  Result.X := ALevelBarLine.Left;
  Result.Y := ALevelBarLine.Bottom - (AValue - AMinValue) * ALevelBarLine.Height
    / AValueRange;
end;
...
function TdxGaugeLinearScaleOptionsView.GetAlignElements
  : TdxGaugeLinearScaleAlignElements;
begin
  Result := GetScale.GetAlignElements;
end;

function TdxGaugeLinearScaleOptionsView.GetLabelOrientation
  : TdxGaugeLinearScaleLabelOrientation;
begin
...
procedure TdxGaugeLinearScaleOptionsView.SetAlignElements
  (const AValue: TdxGaugeLinearScaleAlignElements);
begin
  GetScale.SetAlignElements(AValue);
end;

procedure TdxGaugeLinearScaleOptionsView.SetLabelOrientation
  (const AValue: TdxGaugeLinearScaleLabelOrientation);
begin
  GetScale.SetLabelOrientation(AValue);
end;

procedure TdxGaugeLinearScaleOptionsView.SetRotationAngle
  (const AValue: TcxRotationAngle);
begin
...
function TdxGaugeCustomLinearScaleViewInfo.GetScaleInfoClass
  : TdxGaugeCustomScaleInfoClass;
begin
  Result := TdxGaugeLinearScaleInfo;
end;

function TdxGaugeCustomLinearScaleViewInfo.GetParametersClass
...
begin
  Result := CanDrawImage(FEndBar) or CanDrawImage(FEmptyBar) or
    CanDrawImage(FStartBar) or CanDrawImage(FPackedBar);
end;
...
function TdxGaugeCustomLinearScaleViewInfo.GetLabelTextRect(APosition: Single;
  const AText: string): TdxRectF;
const
  ElementOffsetSing: array [TdxGaugeLinearScaleAlignElements]
    of Integer = (-1, 1);
var
  P: TdxPointF;
  ASize: TdxSizeF;
...
begin
  ...
  if AScaleParameters.AlignElements = taRightJustify then
    AOffset := AOffset + 1;
  P := dxPointF(FLevelBarLine.Left + ElementOffsetSing
    [AScaleParameters.AlignElements] * AOffset, APosition);
...
begin
  ...
  if NeedRotateBounds then
    ScaleInfo.ContentBounds :=
      GetScaledRect(dxSizeF(ScaleInfo.ContentBounds.Height,
      ScaleInfo.ContentBounds.Width));
end;
...
procedure TdxGaugeCustomLinearScaleViewInfo.DoDrawBackground
  (AGPGraphics: TdxGPGraphics);
begin
  dxGaugeDrawImage(AGPGraphics, FBackground, FBackgroundBounds);
end;

procedure TdxGaugeCustomLinearScaleViewInfo.DoDrawTickmarkLabel
  (AGPGraphics: TdxGPGraphics; APosition: Single;
  const ADrawInfo: TdxGaugeQuantitativeScaleTickmarkLabelDrawInfo);
begin
  dxGaugeDrawText(AGPGraphics, ADrawInfo.Text, ADrawInfo.Rect, Font,
    ADrawInfo.Color, GetLabelTextRotationAngle, GetLabelTextAlignment);
end;

procedure TdxGaugeCustomLinearScaleViewInfo.DoDrawTickmarkTick
  (AGPGraphics: TdxGPGraphics; APosition: Single;
...
const
  TickRotationAngleMap: array [TdxGaugeLinearScaleAlignElements]
    of Single = (180, 0);
var
  R: TdxRectF;
begin
  ...
  try
    ...
    if GetDefaultParameters.RotateTicks then
      AGPGraphics.RotateWorldTransform
        (-TickRotationAngleMap[GetParameters.AlignElements], cxRectCenter(R));
...
procedure TdxGaugeCustomLinearScaleViewInfo.DoDrawValueIndicator
  (AGPGraphics: TdxGPGraphics);
begin
...
procedure TdxGaugeCustomLinearScaleViewInfo.DrawElements
  (AGPGraphics: TdxGPGraphics);
begin
...
procedure TdxGaugeCustomLinearScaleViewInfo.BeginDraw
  (AGPGraphics: TdxGPGraphics);
begin
  AGPGraphics.SaveWorldTransform;
...
function TdxGaugeCustomLinearScaleViewInfo.GetDefaultParameters
  : TdxGaugeLinearScaleDefaultParameters;
begin
...
type
  ...
  function GetTextAlignment(AValidAngles: TdxRotationAngleSet;
    ARotationAngle: TcxRotationAngle): TAlignment;
  begin
    Result := taCenter;
    if GetParameters.RotationAngle in AValidAngles then
      ...
      else if GetParameters.AlignElements = taLeftJustify then
...
function TdxGaugeCustomLinearScaleViewInfo.GetLabelTextOffset
  (ASize: TdxSizeF): Single;
begin
...
function TdxGaugeCustomLinearScaleViewInfo.GetParameters
  : TdxGaugeLinearScaleParameters;
begin
...
function TdxGaugeCustomLinearScaleViewInfo.GetScaledImageRect(AImage: TGraphic)
  : TdxRectF;
begin
...
begin
  FLevelBarLine := GetScaledRect
    (dxSizeF(0, GetDefaultParameters.LevelBarStartPosition.Y -
...
procedure TdxGaugeCustomLinearScaleViewInfo.RotateContent
  (AGPGraphics: TdxGPGraphics; AAngle: Single; const APivotPoint: TdxPointF);
begin
  AGPGraphics.RotateWorldTransform(AAngle, APivotPoint);
end;

procedure TdxGaugeCustomLinearScaleViewInfo.DrawLevelBarBackground
  (AGPGraphics: TdxGPGraphics);
begin
...
procedure TdxGaugeCustomLinearScaleViewInfo.DrawLevelBarValue
  (AGPGraphics: TdxGPGraphics);
begin
...
function TdxGaugeCustomLinearScale.GetViewInfoClass
...
begin
  AGPGraphics.SaveWorldTransform;
  try
    AGPGraphics.RotateWorldTransform(GetViewInfo.GetRotationAngle,
      cxRectCenter(GetViewInfo.GetContentBounds));
...
procedure TdxGaugeCustomLinearScale.DrawLayer(AGPGraphics: TdxGPGraphics;
  ALayerIndex: Integer);
begin
...
function TdxGaugeCustomLinearScale.GetAlignElements
  : TdxGaugeLinearScaleAlignElements;
begin
  Result := GetScaleParameters.AlignElements;
end;

function TdxGaugeCustomLinearScale.GetLabelOrientation
  : TdxGaugeLinearScaleLabelOrientation;
begin
  Result := GetScaleParameters.LabelOrientation;
end;

function TdxGaugeCustomLinearScale.GetOptionsLayout
  : TdxGaugeScaleOptionsRectangularLayout;
begin
  Result := inherited OptionsLayout as TdxGaugeScaleOptionsRectangularLayout;
end;

function TdxGaugeCustomLinearScale.GetOptionsView
  : TdxGaugeLinearScaleOptionsView;
begin
...
procedure TdxGaugeCustomLinearScale.SetAlignElements(const AValue
  : TdxGaugeLinearScaleAlignElements);
var
  AScaleParameters: TdxGaugeLinearScaleParameters;
begin
...
procedure TdxGaugeCustomLinearScale.SetLabelOrientation
  (const AValue: TdxGaugeLinearScaleLabelOrientation);
var
  AScaleParameters: TdxGaugeLinearScaleParameters;
begin
...
procedure TdxGaugeCustomLinearScale.SetOptionsLayout(const AValue
  : TdxGaugeScaleOptionsRectangularLayout);
begin
  inherited OptionsLayout := AValue;
end;

procedure TdxGaugeCustomLinearScale.SetOptionsView(const AValue
  : TdxGaugeLinearScaleOptionsView);
begin
  inherited OptionsView := AValue;
end;

procedure TdxGaugeCustomLinearScale.SetRotationAngle(const AValue
  : TcxRotationAngle);
var
  AScaleParameters: TdxGaugeLinearScaleParameters;
begin
...
function TdxGaugeCustomLinearScale.GetScaleParameters
  : TdxGaugeLinearScaleParameters;
begin
  Result := Parameters as TdxGaugeLinearScaleParameters;
end;

function TdxGaugeCustomLinearScale.GetViewInfo
  : TdxGaugeCustomLinearScaleViewInfo;
begin
...
class function TdxGaugeCustomLinearScaleStyleReader.
  GetResourceNamePrefix: string;
begin
  Result := 'Linear';
end;

function TdxGaugeCustomLinearScaleStyleReader.GetDefaultParametersClass
  : TdxGaugeCustomScaleDefaultParametersClass;
begin
  Result := TdxGaugeLinearScaleDefaultParameters;
end;

procedure TdxGaugeCustomLinearScaleStyleReader.ReadCommonScaleParameters
...
begin
  ...
  ALinearParameters.LevelBarStartPosition :=
    GetAttributeValueAsPointF(GetChildNode(ANode,
    'LevelBarStartPosition'), 'Value');
  ALinearParameters.LevelBarEndPosition := GetAttributeValueAsPointF
    (GetChildNode(ANode, 'LevelBarEndPosition'), 'Value');
  ALinearParameters.LevelBarsScaleFactor := GetAttributeValueAsPointF
    (GetChildNode(ANode, 'LevelBarsScaleFactor'), 'Value');
end;

{ TdxGaugeLinearScaleRangeViewInfo }

function TdxGaugeLinearScaleRangeViewInfo.GetParametersClass
...
begin
  ...
  FBounds.Left := ScaleInfo.ContentBounds.Left + ScaleInfo.ContentBounds.Width *
    AParameters.CenterPositionFactor - AWidth / 2;
...
function TdxGaugeLinearScaleRangeViewInfo.GetParameters
  : TdxGaugeLinearRangeParameters;
begin
...
function TdxGaugeLinearScaleRange.GetParametersClass
  : TdxGaugeCustomRangeParametersClass;
begin
  Result := TdxGaugeLinearRangeParameters;
end;

function TdxGaugeLinearScaleRange.GetViewInfoClass
...
begin
  ...
  AFiler.DefineProperty('CenterPositionFactor', ReadCenterPositionFactor,
    WriteCenterPositionFactor, IsCenterPositionFactorStored);
end;
...
procedure TdxGaugeLinearScaleRange.SetCenterPositionFactor
  (const AValue: Single);
begin
...
begin
  Result := not SameValue(GetParameters.CenterPositionFactor,
    dxGaugeLinearRangeCenterPositionFactor);
end;
