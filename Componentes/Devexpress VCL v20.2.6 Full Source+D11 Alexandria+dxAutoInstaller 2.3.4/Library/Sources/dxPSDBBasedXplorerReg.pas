...
begin
  Result := TdxPSDBBasedExplorerFoldersFieldNamesMap(GetComponent(0))
    .Explorer.Folders;
end;
...
begin
  Result := (AField is TIntegerField) or (AField is TSmallintField) or
    (AField is TLargeintField) or (AField is TWordField) or
    (AField is TAutoIncField);
end;
...
begin
  Result := TdxPSDBBasedExplorerItemsFieldNamesMap(GetComponent(0))
    .Explorer.Items;
end;
...
begin
  ...
  RegisterPropertyEditor(TypeInfo(string),
    TdxPSDBBasedExplorerFoldersFieldNamesMap, 'ID',
    TdxDBFolderIDFieldNameProperty);
  RegisterPropertyEditor(TypeInfo(string),
    TdxPSDBBasedExplorerFoldersFieldNamesMap, 'Name',
    TdxDBFolderFieldNameProperty);
  RegisterPropertyEditor(TypeInfo(string),
    TdxPSDBBasedExplorerFoldersFieldNamesMap, 'ParentID',
    TdxDBFolderIDFieldNameProperty);

  RegisterPropertyEditor(TypeInfo(string),
    TdxPSDBBasedExplorerItemsFieldNamesMap, 'ID', TdxDBItemIDFieldNameProperty);
  RegisterPropertyEditor(TypeInfo(string),
    TdxPSDBBasedExplorerItemsFieldNamesMap, 'Name', TdxDBItemFieldNameProperty);
  RegisterPropertyEditor(TypeInfo(string),
    TdxPSDBBasedExplorerItemsFieldNamesMap, 'ParentID',
    TdxDBItemIDFieldNameProperty);
  RegisterPropertyEditor(TypeInfo(string),
    TdxPSDBBasedExplorerItemsFieldNamesMap, 'Data',
    TdxDBItemDataFieldNameProperty);
end;
