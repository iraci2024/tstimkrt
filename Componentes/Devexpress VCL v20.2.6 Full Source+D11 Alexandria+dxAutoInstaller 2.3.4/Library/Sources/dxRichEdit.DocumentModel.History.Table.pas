...
type
  ...
  public
    constructor Create(APieceTable: TdxSimplePieceTable;
      ASourceCell: TdxTableCell); reintroduce;
  ...
  private
    ...
    class procedure ResetTablesCachedProperties(APieceTable: TdxPieceTable);
      overload; static;
    class procedure ResetTableCachedProperties(ATable: TdxTable); static;
    function GetPieceTable: TdxPieceTable;
  public
    procedure Init(ATable: TdxTable);
    class procedure ResetTablesCachedProperties(ADocumentModel
      : TdxCustomDocumentModel); overload; static;
  ...
  protected
    ...
    procedure UndoCore; override;
  public
    constructor Create(APieceTable: TdxCustomPieceTable; ATable: TdxTable;
      ARowIndex: Integer); reintroduce;
    destructor Destroy; override;
    procedure Execute; override;
  ...
  protected
    ...
    procedure UndoCore; override;
  public
    constructor Create(APieceTable: TdxCustomPieceTable; ARow: TdxTableRow;
  ...
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      ATableIndex, AOldStyleIndex, ANewStyleIndex: Integer); reintroduce;
  ...
  TdxChangeTableCellStyleIndexHistoryItem = class
    (TdxChangeTableStyleIndexHistoryItem)
  private
    FRowIndex: Integer;
  ...
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      ATableIndex, ARowIndex, AColumnIndex, AOldStyleIndex, ANewStyleIndex
      : Integer); reintroduce;
  ...
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      ATableIndex, ARowIndex: Integer); reintroduce;
  ...
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      ADeletedTable: TdxTable); reintroduce;
    destructor Destroy; override;
  ...
  TdxDeleteEmptyTableCellHistoryItem = class
    (TdxTableRowCollectionHistoryItemBase)
  private
    FCell: TdxTableCell;
    FExtractedCell: TdxTableCell;
  ...
  protected
    ...
    procedure NormalizeSelectedCellsInSelectionCore
  ...
  protected
    property PreviousParagraphIndex: TdxParagraphIndex
      read FPreviousParagraphIndex write FPreviousParagraphIndex;
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      ATableCell: TdxTableCell; AParagraphIndex: TdxParagraphIndex);
      reintroduce;
  ...
  TdxChangeCellEndParagraphIndexHistoryItem = class
    (TdxChangeCellParagraphIndexCoreHistoryItem)
  protected
    procedure RedoCore; override;
    procedure UndoCore; override;
  ...
  TdxChangeCellStartParagraphIndexHistoryItem = class
    (TdxChangeCellParagraphIndexCoreHistoryItem)
  protected
    procedure RedoCore; override;
    procedure UndoCore; override;
  ...
  protected
    ...
    procedure UndoCore; override;
  public
    constructor Create(APieceTable: TdxCustomPieceTable; ATargetTable: TdxTable;
      ARow: TdxTableRow); reintroduce;
  end;

  { TdxDeleteTableFromTableCollectionHistoryItem }

  TdxDeleteTableFromTableCollectionHistoryItem = class
    (TdxCustomTableHistoryItem)
  private
    FDeletedTable: TdxTable;
    FOwnDeletedTable: Boolean;
  ...
  TdxTableCellPropertiesChangedHistoryItem = class
  ...
  public
    ...
    property FirstCellParagraphIndex: TdxParagraphIndex
      read FFirstCellParagraphIndex;
    property PieceTable: TdxPieceTable read GetPieceTable;
  end;
...
constructor TdxCreateEmptyTableHistoryItem.Create
  (APieceTable: TdxSimplePieceTable; ASourceCell: TdxTableCell);
begin
...
begin
  FTable := PieceTable.TableCellsManager.CreateTableCore(FirstParagraphIndex,
    RowCount, CellCount);
  FOwnTable := False;
end;
...
class procedure TdxTableConditionalFormattingController.
  ResetTablesCachedProperties(ADocumentModel: TdxCustomDocumentModel);
var
  I: Integer;
...
procedure TdxTableConditionalFormattingController.ResetCachedProperties
...
procedure TdxTableConditionalFormattingController.ResetParagraphsInCell
  (ACell: TdxTableCell);
var
...
procedure TdxTableConditionalFormattingController.ResetRowCachedProperties
  (ARow: TdxTableRow);
var
  I: Integer;
  ACell: TdxTableCell;
...
class procedure TdxTableConditionalFormattingController.
  ResetTableCachedProperties(ATable: TdxTable);
var
...
class procedure TdxTableConditionalFormattingController.
  ResetTablesCachedProperties(APieceTable: TdxPieceTable);
var
  ATable: TdxTable;
  I: Integer;
begin
...
function TdxTableConditionalFormattingController.ShouldResetCellCachedIndexes
...
constructor TdxInsertEmptyTableRowHistoryItem.Create
  (APieceTable: TdxCustomPieceTable; ATable: TdxTable; ARowIndex: Integer);
begin
  inherited Create(APieceTable);
  Assert(ATable <> nil);
  Assert(ARowIndex >= 0);
...
constructor TdxInsertEmptyTableCellHistoryItem.Create
  (APieceTable: TdxCustomPieceTable; ARow: TdxTableRow; AInsertedIndex: Integer;
...
begin
  ...
  PieceTable.TableCellsManager.InitializeTableCell(FInsertedCell,
    FStartParagraphIndex, FEndParagraphIndex);
  AController.Init(Table);
...
constructor TdxChangeTableStyleIndexHistoryItem.Create
  (APieceTable: TdxCustomPieceTable; ATableIndex, AOldStyleIndex,
...
constructor TdxChangeTableCellStyleIndexHistoryItem.Create
  (APieceTable: TdxCustomPieceTable; ATableIndex, ARowIndex, AColumnIndex,
...
begin
  PieceTable.Tables[TableIndex].Rows[RowIndex].Cells[ColumnIndex]
    .SetTableCellStyleIndexCore(NewIndex);
end;

procedure TdxChangeTableCellStyleIndexHistoryItem.UndoCore;
begin
  PieceTable.Tables[TableIndex].Rows[RowIndex].Cells[ColumnIndex]
    .SetTableCellStyleIndexCore(OldIndex);
end;

{ TdxTableRowCollectionHistoryItemBase }

constructor TdxTableRowCollectionHistoryItemBase.Create
  (APieceTable: TdxCustomPieceTable; ATableIndex, ARowIndex: Integer);
begin
  inherited Create(APieceTable);
...
constructor TdxDeleteTableHistoryItem.Create(APieceTable: TdxCustomPieceTable;
...
begin
  ...
  APosition := PieceTable.Paragraphs
    [Min(AStartParagraph, PieceTable.Paragraphs.Count - 1)].LogPosition;
...
constructor TdxDeleteTableRowHistoryItem.Create(APieceTable
  : TdxCustomPieceTable; ATableIndex, ARowIndex: Integer);
var
  ARows: TdxTableRowCollection;
begin
...
constructor TdxDeleteEmptyTableCellHistoryItem.Create
  (APieceTable: TdxCustomPieceTable; ATableIndex, ARowIndex,
  ACellIndex: Integer);
begin
  inherited Create(APieceTable, ATableIndex, ARowIndex);
...
begin
  ...
  if (ASelectedRowsCount = 1) and ASelectedCells.IsNotEmpty and
    ASelectedCells.First.IsContainsOnlyOneCell then
  begin
    DocumentModel.Selection.SetStartCell
      (PieceTable.Paragraphs[FStartParagraphIndex].LogPosition);
    Exit;
  end;
...
procedure TdxDeleteEmptyTableCellHistoryItem.
  NormalizeSelectedCellsInSelectionCore(ACellsInRow
  : TdxSelectedCellsIntervalInRow; ASelectedCells: TdxSelectedCellsCollection);
begin
...
var
  ...
  AController: TdxTableConditionalFormattingController;
begin
  ARunIndex := PieceTable.Paragraphs
    [Table.Rows.First.Cells.First.StartParagraphIndex].FirstRunIndex;
  PieceTable.ApplyChanges(TdxDocumentModelChangeType.DeleteContent,
    ARunIndex, MaxInt);
...
var
  AController: TdxTableConditionalFormattingController;
begin
  PieceTable.TableCellsManager.InitializeTableCell(FCell, FStartParagraphIndex,
    FEndParagraphIndex);
...
constructor TdxConvertParagraphsIntoTableRowHistoryItem.Create
  (APieceTable: TdxCustomPieceTable; ARow: TdxTableRow;
  AParagraphIndex: TdxParagraphIndex; AParagraphCount: Integer);
begin
  inherited Create(APieceTable);
  Assert(ARow <> nil);
...
constructor TdxChangeCellParagraphIndexCoreHistoryItem.Create
  (APieceTable: TdxCustomPieceTable; ATableCell: TdxTableCell;
...
procedure TdxChangeCellParagraphIndexCoreHistoryItem.SetTableCell
  (ACell: TdxTableCell);
var
  ATable: TdxTable;
  ARow: TdxTableRow;
...
constructor TdxChangeCellEndParagraphIndexHistoryItem.Create
  (APieceTable: TdxCustomPieceTable; ATableCell: TdxTableCell;
  AParagraphIndex: TdxParagraphIndex);
begin
...
constructor TdxChangeCellStartParagraphIndexHistoryItem.Create
  (APieceTable: TdxCustomPieceTable; ATableCell: TdxTableCell;
  AParagraphIndex: TdxParagraphIndex);
begin
  inherited Create(APieceTable, ATableCell, AParagraphIndex);
...
begin
  ...
  try
    ...
    TdxSelectTableColumnsCommandAccess(ACommand)
      .ChangeSelection(DocumentModel.Selection);
  finally
    ACommand.Free;
  end;
end;
...
constructor TdxMoveTableRowToOtherTableHistoryItem.Create
  (APieceTable: TdxCustomPieceTable; ATargetTable: TdxTable; ARow: TdxTableRow);
begin
  inherited Create(APieceTable);
...
constructor TdxDeleteTableFromTableCollectionHistoryItem.Create
  (APieceTable: TdxCustomPieceTable; ADeletedTable: TdxTable);
begin
  inherited Create(APieceTable);
  Assert(ADeletedTable <> nil);
  FDeletedTable := ADeletedTable;
...
constructor TdxTableCellPropertiesChangedHistoryItem.Create
  (APieceTable: TdxCustomPieceTable;
  AFirstCellParagraphIndex: TdxParagraphIndex; ANestedLevel: Integer);
begin
  inherited Create(APieceTable);
  if AFirstCellParagraphIndex < 0 then
    TdxRichEditExceptions.ThrowArgumentException('firstCellParagraphIndex',
      AFirstCellParagraphIndex);
  FFirstCellParagraphIndex := AFirstCellParagraphIndex;
  FNestedLevel := ANestedLevel;
end;

function TdxTableCellPropertiesChangedHistoryItem.GetObject
  : TdxIndexBasedObject;
var
  ACell: TdxTableCell;
begin
