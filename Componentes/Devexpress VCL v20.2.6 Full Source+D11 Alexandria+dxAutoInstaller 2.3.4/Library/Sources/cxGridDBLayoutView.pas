...
procedure TcxGridDBLayoutViewItem.SetDataBinding
...
procedure TcxGridDBLayoutView.SetItem(Index: Integer;
  Value: TcxGridDBLayoutViewItem);
begin
  inherited Items[Index] := Value;
end;

function TcxGridDBLayoutView.GetDataControllerClass
...
function TcxGridDBLayoutView.GetItemByFieldName(const AFieldName: string)
  : TcxGridDBLayoutViewItem;
begin
  Result := TcxGridDBLayoutViewItem
