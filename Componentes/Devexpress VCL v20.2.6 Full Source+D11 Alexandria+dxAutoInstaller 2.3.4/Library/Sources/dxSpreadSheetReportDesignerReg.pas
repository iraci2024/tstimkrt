...
uses
  cxLibraryReg, dxCoreReg, dxBuiltInPopupMenu, cxClasses,
  dxUIGeneratorDesignHelpers, dxSpreadSheetReportDesignerUIGeneratorScheme;
...
function TdxSpreadSheetReportMasterKeyFieldNameProperty.GetDataSource
  : TDataSource;
begin
  Result := TReportDataControllerAccess
    (TdxSpreadSheetReportDetail(GetComponent(0)).DataController)
    .MasterDataController.DataSource;
end;

{ TdxSpreadSheetReportDetailKeyFieldNameProperty }

function TdxSpreadSheetReportDetailKeyFieldNameProperty.GetDataSource
  : TDataSource;
begin
  Result := TdxSpreadSheetReportDetail(GetComponent(0))
...
begin
  Result := TdxSpreadSheetReportSortedFields
    (TdxSpreadSheetReportSortedField(GetComponent(0)).Collection)
    .DataController.DataSource;
end;
...
begin
  ...
  RegisterComponentEditor(TdxSpreadSheetReportDesigner,
    TdxSpreadSheetReportComponentEditor);
