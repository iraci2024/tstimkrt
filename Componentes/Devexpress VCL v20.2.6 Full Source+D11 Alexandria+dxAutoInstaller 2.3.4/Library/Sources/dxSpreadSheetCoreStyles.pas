...
type
  ...
  public
    ...
    procedure Assign(ASource: TdxSpreadSheetBordersHandle);
      reintroduce; overload;
    procedure Assign(ASource: TdxSpreadSheetBordersHandle; ABorder: TcxBorder);
      reintroduce; overload;
    function Clone: TdxSpreadSheetBordersHandle;
    function IsEqual(ASource: TdxSpreadSheetBordersHandle; ABorder: TcxBorder)
      : Boolean; overload; inline;
    function IsEqual(ASource: TdxSpreadSheetBordersHandle;
      ABorder, ASourceBorder: TcxBorder): Boolean; overload; inline;
  ...
  public
    constructor Create(AStyles: TdxSpreadSheetCellStyles); reintroduce;
      overload;
    destructor Destroy; override;
    function AddBorders(const ABorders: TdxSpreadSheetBordersHandle)
      : TdxSpreadSheetBordersHandle;
    function AddClone(const ABorders: TdxSpreadSheetBordersHandle)
      : TdxSpreadSheetBordersHandle;
  ...
  protected
    procedure ChangeBrush(AStyle: TdxSpreadSheetCellFillStyle;
      ABackgroundColor, AForegroundColor: TColor);
  ...
  public
    constructor Create(AStyles: TdxSpreadSheetCellStyles); reintroduce;
      overload;
    destructor Destroy; override;
    function AddBrush(const ABrush: TdxSpreadSheetBrushHandle)
      : TdxSpreadSheetBrushHandle;
    function AddClone(const ABrush: TdxSpreadSheetBrushHandle)
      : TdxSpreadSheetBrushHandle;
  ...
  strict private
    ...
    function InternalAddFont(const AName: TFontName; ASize: Integer)
      : TdxSpreadSheetFontHandle;
  public
    constructor Create(AStyles: TdxSpreadSheetCellStyles); reintroduce;
      overload;
    destructor Destroy; override;
    function AddClone(const AFont: TdxSpreadSheetFontHandle)
      : TdxSpreadSheetFontHandle;
    function AddFont(const AFont: TdxSpreadSheetFontHandle)
      : TdxSpreadSheetFontHandle;
  ...
  public
    constructor Create(const AFormatCode: string;
      const AFormatCodeID: Integer = -1); reintroduce; overload;
    destructor Destroy; override;
    procedure Format(const AValue: Variant;
      AValueType: TdxSpreadSheetCellDataType; const AFormatSettings: TObject;
      var AResult);
  ...
  protected
    procedure Notify(const Item: TdxSpreadSheetFormatHandle;
  ...
  public
    constructor Create(AStyles: TdxSpreadSheetCellStyles); reintroduce;
      overload;
    destructor Destroy; override;
    function AddClone(const AFormat: TdxSpreadSheetFormatHandle)
      : TdxSpreadSheetFormatHandle;
    function AddFormat(const AFormatCode: string; AFormatCodeID: Integer = -1)
      : TdxSpreadSheetFormatHandle;
    ...
    property PredefinedFormats: TdxSpreadSheetPredefinedFormats
      read FPredefinedFormats;
    property Styles: TdxSpreadSheetCellStyles read FStyles;
  end;
  ...
  public
    function Add(AImage: TdxSmartImage)
      : TdxSpreadSheetSharedImageHandle; overload;
    function Add(AStream: TStream): TdxSpreadSheetSharedImageHandle; overload;
    function Add(const AFileName: string)
      : TdxSpreadSheetSharedImageHandle; overload;
  end;
  ...
  public
    ...
    //
    property FontHandle: TdxSpreadSheetFontHandle read FFontHandle
      write SetFontHandle;
  ...
  strict private
    function GetItem(Index: Integer)
      : TdxSpreadSheetFormattedSharedStringRun; inline;
  public
    function Add: TdxSpreadSheetFormattedSharedStringRun; overload;
    function Add(AStartIndex: Integer; AFontHandle: TdxSpreadSheetFontHandle;
      ATag: TdxNativeUInt = 0): TdxSpreadSheetFormattedSharedStringRun;
      overload;
    ...
    //
    property Items[Index: Integer]: TdxSpreadSheetFormattedSharedStringRun
  ...
  public
    constructor Create(AOwner: TdxDynamicItemList; AIndex: Integer); override;
    destructor Destroy; override;
    procedure Assign(ASource: TdxSpreadSheetCellStyleHandle);
      reintroduce; overload;
    function Clone: TdxSpreadSheetCellStyleHandle;
    procedure LoadFromStream(AReader: TcxReader);
    procedure SaveToStream(AWriter: TcxWriter);

    property AlignHorz: TdxSpreadSheetDataAlignHorz read FAlignHorz
      write FAlignHorz;
    property AlignHorzIndent: Integer read FAlignHorzIndent
      write SetAlignHorzIndent;
    property AlignVert: TdxSpreadSheetDataAlignVert read FAlignVert
      write FAlignVert;
    property Borders: TdxSpreadSheetBordersHandle read FBorders
      write SetBorders;
    property Brush: TdxSpreadSheetBrushHandle read FBrush write SetBrush;
    property DataFormat: TdxSpreadSheetFormatHandle read FDataFormat
      write SetDataFormat;
  ...
  public
    ...
    destructor Destroy; override;
    function AddClone(AStyle: TdxSpreadSheetCellStyleHandle)
      : TdxSpreadSheetCellStyleHandle;
    function AddStyle(AStyle: TdxSpreadSheetCellStyleHandle)
      : TdxSpreadSheetCellStyleHandle;
    function CreateStyle(AFont: TdxSpreadSheetFontHandle = nil;
      AFormat: TdxSpreadSheetFormatHandle = nil;
      ABrush: TdxSpreadSheetBrushHandle = nil;
      ABorders: TdxSpreadSheetBordersHandle = nil)
      : TdxSpreadSheetCellStyleHandle;
    function CreateStyleFromStream(AReader: TcxReader)
      : TdxSpreadSheetCellStyleHandle;
...
{$REGION 'Private Types'}
    ...
    public
      constructor Create(AString: TdxSpreadSheetSharedString;
...
{$ENDREGION}
  ...
  public
    ...
    function TryGetRender(AString: TdxSpreadSheetSharedString;
      ADefaultFontHandle: TdxSpreadSheetFontHandle;
      out ARender: TObject): Boolean;
    procedure Clear;
    procedure RemoveItems(ADefaultFontHandle
      : TdxSpreadSheetFontHandle); overload;
    procedure RemoveItems(AString: TdxSpreadSheetSharedString); overload;
  end;

function dxChangeHandle(var ACurrentValue: TdxHashTableItem;
  ANewValue: TdxHashTableItem): Boolean;
...
constructor TdxSpreadSheetBordersHandle.Create(AOwner: TdxDynamicItemList;
  AIndex: Integer);
var
  ABorder: TcxBorder;
begin
...
procedure TdxSpreadSheetBordersHandle.Assign
  (ASource: TdxSpreadSheetBordersHandle);
begin
...
function TdxSpreadSheetBordersHandle.IsEqual
  (ASource: TdxSpreadSheetBordersHandle; ABorder: TcxBorder): Boolean;
begin
...
function TdxSpreadSheetBordersHandle.IsEqual
  (ASource: TdxSpreadSheetBordersHandle;
  ABorder, ASourceBorder: TcxBorder): Boolean;
begin
  Result := (BorderColor[ABorder] = ASource.BorderColor[ASourceBorder]) and
...
begin
  ...
  begin
    ...
    AddToHash(AHash, BorderStyle[ABorder],
      SizeOf(TdxSpreadSheetCellBorderStyle));
  end;
  Key := AHash;
end;

function TdxSpreadSheetBordersHandle.DoIsEqual(const AItem
  : TdxHashTableItem): Boolean;
var
  ABorder: TcxBorder;
begin
  for ABorder := Low(TcxBorder) to High(TcxBorder) do
  begin
    Result := (BorderIsAuto[ABorder] = TdxSpreadSheetBordersHandle(AItem)
      .BorderIsAuto[ABorder]) and
      (BorderColor[ABorder] = TdxSpreadSheetBordersHandle(AItem).BorderColor
      [ABorder]) and (BorderStyle[ABorder] = TdxSpreadSheetBordersHandle(AItem)
      .BorderStyle[ABorder]);
    if not Result then
      Break;
  end;
...
function TdxSpreadSheetBorders.AddBorders(const ABorders
...
function TdxSpreadSheetBorders.AddClone(const ABorders
  : TdxSpreadSheetBordersHandle): TdxSpreadSheetBordersHandle;
begin
  Result := ABorders;
  if Result = nil then
...
function TdxSpreadSheetBorders.CreateFromStream(AReader: TcxReader)
  : TdxSpreadSheetBordersHandle;
begin
  Result := CreateBorders;
...
constructor TdxSpreadSheetBrushHandle.Create(AOwner: TdxDynamicItemList;
  AIndex: Integer);
begin
  inherited Create(AOwner, AIndex);
...
function TdxSpreadSheetBrushHandle.DoIsEqual(const AItem
  : TdxHashTableItem): Boolean;
begin
  Result := (ForegroundColor = TdxSpreadSheetBrushHandle(AItem).ForegroundColor)
    and (BackgroundColor = TdxSpreadSheetBrushHandle(AItem).BackgroundColor) and
...
procedure TdxSpreadSheetCustomBrush.ChangeBrush
  (AStyle: TdxSpreadSheetCellFillStyle;
  ABackgroundColor, AForegroundColor: TColor);
var
  ABrushHandle: TdxSpreadSheetBrushHandle;
begin
  if (Style <> AStyle) or (BackgroundColor <> ABackgroundColor) or
    (ForegroundColor <> AForegroundColor) then
  begin
...
procedure TdxSpreadSheetCustomBrush.SetStyle(const Value
...
function TdxSpreadSheetBrushes.AddBrush(const ABrush: TdxSpreadSheetBrushHandle)
  : TdxSpreadSheetBrushHandle;
begin
  Result := ABrush;
  Result.CalculateHash;
...
function TdxSpreadSheetBrushes.AddClone(const ABrush: TdxSpreadSheetBrushHandle)
  : TdxSpreadSheetBrushHandle;
begin
  Result := ABrush;
  if Result = nil then
...
function TdxSpreadSheetBrushes.CreateFromStream(AReader: TcxReader)
  : TdxSpreadSheetBrushHandle;
begin
  Result := CreateBrush;
  Result.LoadFromStream(AReader);
...
function TdxSpreadSheetFontHandle.DoIsEqual(const AItem
  : TdxHashTableItem): Boolean;
begin
  Result := (Charset = TdxSpreadSheetFontHandle(AItem).Charset) and
...
begin
  ChangeFont(AFont.Name, AFont.Charset, AFont.Color, AFont.Size, AFont.Pitch,
    AFont.Style);
end;
...
procedure TdxSpreadSheetCustomFont.ChangeFont(const AName: TFontName;
  ACharset: TFontCharset; AColor: TColor; ASize: Integer; APitch: TFontPitch;
  AStyle: TFontStyles);
var
  AFontHandle: TdxSpreadSheetFontHandle;
begin
  if (Charset <> ACharset) or (Color <> AColor) or (Size <> ASize) or
    (Pitch <> APitch) or (Style <> AStyle) or (Name <> AName) then
  begin
...
function TdxSpreadSheetFonts.AddClone(const AFont: TdxSpreadSheetFontHandle)
  : TdxSpreadSheetFontHandle;
begin
  Result := AFont;
  if Result = nil then
...
function TdxSpreadSheetFonts.AddFont(const AFont: TdxSpreadSheetFontHandle)
  : TdxSpreadSheetFontHandle;
begin
  Result := AFont;
  Result.CalculateHash;
...
function TdxSpreadSheetFonts.CreateFromStream(AReader: TcxReader)
  : TdxSpreadSheetFontHandle;
begin
  Result := CreateFont;
  Result.LoadFromStream(AReader);
...
function TdxSpreadSheetFonts.InternalAddFont(const AName: TFontName;
  ASize: Integer): TdxSpreadSheetFontHandle;
begin
  Result := TdxSpreadSheetFontHandle.Create(nil, 0);
  Result.Name := AName;
  Result.Charset := DEFAULT_CHARSET;
...
constructor TdxSpreadSheetFormatHandle.Create(const AFormatCode: string;
  const AFormatCodeID: Integer = -1);
begin
...
function TdxSpreadSheetFormatHandle.DoIsEqual(const AItem
  : TdxHashTableItem): Boolean;
begin
  Result := (FormatCodeID = TdxSpreadSheetFormatHandle(AItem).FormatCodeID) and
...
function TdxSpreadSheetPredefinedFormats.GetFormatHandleByID(ID: Integer)
  : TdxSpreadSheetFormatHandle;
var
  I: Integer;
begin
...
function TdxSpreadSheetPredefinedFormats.GetIDByFormatCode(const AFormatCode
  : string): Integer;
var
  I: Integer;
begin
...
constructor TdxSpreadSheetCustomDataFormat.Create
  (AFormats: TdxSpreadSheetFormats);
begin
  inherited Create;
  FFormats := AFormats;
end;

procedure TdxSpreadSheetCustomDataFormat.Assign(ADataFormat
  : TdxSpreadSheetCustomDataFormat);
begin
  ...
  begin
    ...
    if AHandle = nil then
      raise EdxSpreadSheetError.CreateFmt
        (cxGetResourceString(@sdxErrorInvalidFormatCodeID), [AValue]);
    Handle := AHandle;
  end;
end;
...
function TdxSpreadSheetFormats.AddClone(const AFormat
  : TdxSpreadSheetFormatHandle): TdxSpreadSheetFormatHandle;
begin
  Result := AFormat;
  if Result = nil then
    Exit;
  Result := TdxSpreadSheetFormatHandle.Create(AFormat.FormatCode,
    AFormat.FormatCodeID);
  Result.CalculateHash;
  CheckAndAddItem(Result);
end;

function TdxSpreadSheetFormats.AddFormat(const AFormatCode: string;
  AFormatCodeID: Integer = -1): TdxSpreadSheetFormatHandle;
begin
...
function TdxSpreadSheetFormats.CreateFromStream(AReader: TcxReader)
  : TdxSpreadSheetFormatHandle;
var
  AValue: string;
  ACode: Integer;
...
function TdxSpreadSheetFormats.IsCustom
  (AFormat: TdxSpreadSheetFormatHandle): Boolean;
begin
  Result := (AFormat.FormatCodeID < 0) or AFormat.IsLocalized or
    (PredefinedFormats.IndexOf(AFormat) < 0);
end;

function TdxSpreadSheetFormats.CreatePredefinedFormats
  : TdxSpreadSheetPredefinedFormats;

  procedure InternalAdd(AList: TdxSpreadSheetPredefinedFormats;
    AFormatCodeID: Integer; const AFormatCode: string);
  begin
    AList.Add(AddFormat(AFormatCode, AFormatCodeID));
  end;

  function GenerateCurrencyFormat(const AFormatString, APattern,
    APatternZero: string; ABlindCurrencySymbol: Boolean = False): string;
  var
  ...
  begin
    ...
    begin
      if (Length(ACurrencySymbol) = 1) and
        TdxSpreadSheetCurrencyFormatHelper.IsCurrencySymbolFollowsValue
        (dxFormatSettings.NegCurrFormat) then
        ACurrencySymbol := '_' + ACurrencySymbol
      else
        ACurrencySymbol := '';
    end;
    Result := Format(AFormatString,
      [TdxSpreadSheetCurrencyFormatHelper.GetPositiveFormat(ACurrencySymbol,
      APattern, dxFormatSettings.CurrencyFormat, not ABlindCurrencySymbol),
      TdxSpreadSheetCurrencyFormatHelper.GetNegativeFormat(ACurrencySymbol,
      APattern, dxFormatSettings.NegCurrFormat, not ABlindCurrencySymbol),
      TdxSpreadSheetCurrencyFormatHelper.GetPositiveFormat(ACurrencySymbol,
      APatternZero, dxFormatSettings.CurrencyFormat,
      not ABlindCurrencySymbol)]);
  end;
...
begin
  ...
  InternalAdd(Result, $06, GenerateCurrencyFormat('%0:s_);[Red]%1:s',
    '#,##0', ''));
  InternalAdd(Result, $07, GenerateCurrencyFormat('%0:s_);%1:s',
    '#,##0.00', ''));
  InternalAdd(Result, $08, GenerateCurrencyFormat('%0:s_);[Red]%1:s',
    '#,##0.00', ''));
  InternalAdd(Result, $29,
    GenerateCurrencyFormat('_(%0:s_);_(%1:s;_(%2:s_);_(@_)', '* #,##0',
    '* "-"', True));
  InternalAdd(Result, $2A,
    GenerateCurrencyFormat('_(%0:s_);_(%1:s;_(%2:s_);_(@_)', '* #,##0',
    '* "-"'));
  InternalAdd(Result, $2B,
    GenerateCurrencyFormat('_(%0:s_);_(%1:s;_(%2:s_);_(@_)', '* #,##0.00',
    '* "-"??', True));
  InternalAdd(Result, $2C,
    GenerateCurrencyFormat('_(%0:s_);_(%1:s;_(%2:s_);_(@_)', '* #,##0.00',
    '* "-"??'));
...
function TdxSpreadSheetSharedImageHandle.DoIsEqual
  (const AItem: TdxHashTableItem): Boolean;
begin
...
function TdxSpreadSheetSharedImages.Add(AStream: TStream)
  : TdxSpreadSheetSharedImageHandle;
begin
...
function TdxSpreadSheetSharedImages.Add(const AFileName: string)
  : TdxSpreadSheetSharedImageHandle;
var
  AStream: TStream;
begin
...
function TdxSpreadSheetSharedImages.Add(AImage: TdxSmartImage)
  : TdxSpreadSheetSharedImageHandle;
begin
...
function TdxSpreadSheetSharedString.DoIsEqual(const AItem
  : TdxHashTableItem): Boolean;
begin
  Result := (ClassType = AItem.ClassType) and
    dxSameText(Value, TdxSpreadSheetSharedString(AItem).Value);
end;
...
constructor TdxSpreadSheetSharedStringTable.Create
...
function TdxSpreadSheetSharedStringTable.Add(const AValue: string)
  : TdxSpreadSheetSharedString;
begin
  Result := Add(TdxSpreadSheetSharedString.CreateObject(AValue));
end;

function TdxSpreadSheetSharedStringTable.Add
  (AString: TdxSpreadSheetSharedString): TdxSpreadSheetSharedString;
begin
  Result := AString;
  Result.CalculateHash;
  CheckAndAddItem(Result);
...
function TdxSpreadSheetSharedStringTable.LoadItemFromStream(AReader: TcxReader)
  : TdxSpreadSheetSharedString;
begin
...
function TdxSpreadSheetSharedStringTable.CreateStringClassByID
  (const ID: Integer): TdxSpreadSheetSharedString;
begin
  if ID = 0 then
...
procedure TdxSpreadSheetFormattedSharedStringRun.Assign
  (ASource: TdxSpreadSheetFormattedSharedStringRun);
begin
...
procedure TdxSpreadSheetFormattedSharedStringRun.SetFontHandle
  (AValue: TdxSpreadSheetFontHandle);
begin
...
AFontHandle: TdxSpreadSheetFontHandle; ATag: TdxNativeUInt = 0)
  : TdxSpreadSheetFormattedSharedStringRun;
begin
  Result := Add;
...
procedure TdxSpreadSheetFormattedSharedStringRuns.Append
  (ASource: TdxSpreadSheetFormattedSharedStringRuns);
var
  I: Integer;
begin
...
procedure TdxSpreadSheetFormattedSharedStringRuns.Assign
  (ASource: TdxSpreadSheetFormattedSharedStringRuns);
begin
  Clear;
  Append(ASource);
...
function TdxSpreadSheetFormattedSharedStringRuns.GetItem(Index: Integer)
  : TdxSpreadSheetFormattedSharedStringRun;
begin
...
constructor TdxSpreadSheetFormattedSharedString.CreateObject
  (const AValue: string);
begin
...
procedure TdxSpreadSheetFormattedSharedString.LoadFromStream
  (AReader: TcxReader);
var
  AIndex, I: Integer;
...
begin
  ...
  begin
    ...
    AFont := TdxSpreadSheetSharedStringTable(HashTable)
      .FontTable.CreateFromStream(AReader);
...
function TdxSpreadSheetFormattedSharedString.DoIsEqual
  (const AItem: TdxHashTableItem): Boolean;
var
  I: Integer;
begin
  Result := inherited DoIsEqual(AItem) and
    (Runs.Count = TdxSpreadSheetFormattedSharedString(AItem).Runs.Count);
  if Result then
    for I := 0 to Runs.Count - 1 do
    begin
      Result := Result and
        (Runs[I].StartIndex = TdxSpreadSheetFormattedSharedString(AItem)
        .Runs[I].StartIndex);
      Result := Result and
        (Runs[I].FontHandle = TdxSpreadSheetFormattedSharedString(AItem)
        .Runs[I].FontHandle);
      if not Result then
        Break;
    end;
...
procedure TdxSpreadSheetFormattedSharedString.FontChanged(APrevFont,
  ANewFont: TdxSpreadSheetFontHandle);
var
  I: Integer;
...
constructor TdxSpreadSheetCellStyleHandle.Create(AOwner: TdxDynamicItemList;
AIndex: Integer);
begin
  inherited Create(AOwner, AIndex);
...
procedure TdxSpreadSheetCellStyleHandle.Assign
  (ASource: TdxSpreadSheetCellStyleHandle);
begin
...
procedure TdxSpreadSheetCellStyleHandle.AssignFields
  (ASource: TdxSpreadSheetCellStyleHandle);
begin
...
function TdxSpreadSheetCellStyleHandle.DoIsEqual(const AItem
  : TdxHashTableItem): Boolean;
var
  I: TdxSpreadSheetCellState;
begin
  Result := (AlignHorz = TdxSpreadSheetCellStyleHandle(AItem).AlignHorz) and
  ...
  if Result then
    ...
    begin
      Result := (I in States)
        = (I in TdxSpreadSheetCellStyleHandle(AItem).States);
      if not Result then
        Break;
    end;
end;
...
procedure TdxSpreadSheetCellStyleHandle.SetBorders
  (AValue: TdxSpreadSheetBordersHandle);
begin
  dxChangeHandle(TdxHashTableItem(FBorders), AValue);
end;

procedure TdxSpreadSheetCellStyleHandle.SetBrush
  (AValue: TdxSpreadSheetBrushHandle);
begin
  dxChangeHandle(TdxHashTableItem(FBrush), AValue);
end;

procedure TdxSpreadSheetCellStyleHandle.SetDataFormat
  (AValue: TdxSpreadSheetFormatHandle);
begin
  dxChangeHandle(TdxHashTableItem(FDataFormat), AValue);
end;

procedure TdxSpreadSheetCellStyleHandle.SetFont
  (AValue: TdxSpreadSheetFontHandle);
begin
...
function TdxSpreadSheetCellStyles.AddClone
  (AStyle: TdxSpreadSheetCellStyleHandle): TdxSpreadSheetCellStyleHandle;
var
  AFont: TdxSpreadSheetFontHandle;
...
function TdxSpreadSheetCellStyles.AddStyle
  (AStyle: TdxSpreadSheetCellStyleHandle): TdxSpreadSheetCellStyleHandle;
begin
  Result := AStyle;
  Result.CalculateHash;
...
AFormat: TdxSpreadSheetFormatHandle = nil;
ABrush: TdxSpreadSheetBrushHandle = nil;
ABorders: TdxSpreadSheetBordersHandle = nil): TdxSpreadSheetCellStyleHandle;
begin
  if AFont = nil then
...
function TdxSpreadSheetCellStyles.CreateStyleFromStream(AReader: TcxReader)
  : TdxSpreadSheetCellStyleHandle;
var
  AFont: TdxSpreadSheetFontHandle;
  ABrush: TdxSpreadSheetBrushHandle;
...
function TdxSpreadSheetCellStyles.CreateDefaultStyle
  : TdxSpreadSheetCellStyleHandle;
begin
  Result := TdxSpreadSheetCellStyleHandle.Create(nil, 0);
  Result.FHashTable := Self;
...
procedure TdxSpreadSheetFormattedSharedStringCache.RemoveItems
  (ADefaultFontHandle: TdxSpreadSheetFontHandle);
var
  AKey: TKey;
  I: Integer;
...
ADefaultFontHandle: TdxSpreadSheetFontHandle);
begin
  dxChangeHandle(TdxHashTableItem(FString), AString);
  dxChangeHandle(TdxHashTableItem(FDefaultFontHandle), ADefaultFontHandle);
end;

destructor TdxSpreadSheetFormattedSharedStringCache.TKey.Destroy;
begin
  dxChangeHandle(TdxHashTableItem(FDefaultFontHandle), nil);
  dxChangeHandle(TdxHashTableItem(FString), nil);
  inherited;
end;

function TdxSpreadSheetFormattedSharedStringCache.TKey.Equals
  (Obj: TObject): Boolean;
begin
  Result := (Obj is TKey) and (TKey(Obj).FString = FString) and
    (TKey(Obj).FDefaultFontHandle = FDefaultFontHandle);
end;
