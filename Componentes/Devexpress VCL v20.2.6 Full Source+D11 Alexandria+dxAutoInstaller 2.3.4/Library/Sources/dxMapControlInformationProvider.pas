...
type
  ...
  TdxMapControlInformationProviderClass = class of
  ...
  public
    ...
    function Add(AItemClass: TdxMapControlInformationProviderClass)
      : TdxMapControlInformationProvider;
    procedure Assign(Source: TPersistent); override;
    property Items[Index: Integer]: TdxMapControlInformationProvider
...
constructor TdxMapControlInformationProviders.Create(AParentComponent
  : TComponent; AItemClass: TcxComponentCollectionItemClass);
begin
  ...
  begin
    ...
    try
      ...
      begin
        ...
        Add(TdxMapControlInformationProviderClass(AItem.ClassType))
          .Assign(AItem);
      end;
    finally
      EndUpdate;
...
function TdxMapControlInformationProviders.GetItem(Index: Integer)
  : TdxMapControlInformationProvider;
begin
