...
begin
  ...
  RegisterNoIcon([TcxGridLayoutItem, TcxGridLayoutViewItem, TcxGridLayoutView
{$IFNDEF NONDB}, TcxGridDBLayoutView, TcxGridDBLayoutViewItem
{$ENDIF}
    ]);

  RegisterPropertyEditor(TypeInfo(TcxGridLayoutItem), TcxGridLayoutViewItem,
    'LayoutItem', TClassProperty);
  RegisterSelectionEditor(TcxGridLayoutView, TcxGridLayoutViewSelectionEditor);
{$IFNDEF NONDB}
  RegisterSelectionEditor(TcxGridDBLayoutView,
    TcxGridDBLayoutViewSelectionEditor);
{$ENDIF}
