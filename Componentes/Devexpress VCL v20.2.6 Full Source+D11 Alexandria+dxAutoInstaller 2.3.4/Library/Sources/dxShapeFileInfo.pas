...
uses
  Classes, SysUtils, RTLConsts, StrUtils, Windows, Math, Generics.Defaults,
  Generics.Collections,
  dxCore;

type
  TdxShapeFileRecordType = (sfrtNullShape = 0, sfrtPoint = 1, sfrtPolyLine = 3,
    sfrtPolygon = 5, sfrtMultiPoint = 8, sfrtPointZ = 11, sfrtPolyLineZ = 13,
    sfrtPolygonZ = 15, sfrtMultiPointZ = 18, sfrtPointM = 21,
    sfrtPolyLineM = 23, sfrtPolygonM = 25, sfrtMultiPointM = 28,
    sfrtMultiPatch = 31);
  ...
  TdxShapeFileMultiPatchRecordPartType = (sfptTriangleStrip, sfptTriangleFan,
    sfptOuterRing, sfptInnerRing, sfptFirstRing, sfptRing);
  ...
  public
    ...
    class procedure ReadPoints(AStream: TStream;
      const APoints: TdxShapeFilePoints);
    class procedure ReadPointsM(AStream: TStream;
      const APointsM: TdxShapeFilePointsM);
    class procedure ReadPointsZ(AStream: TStream;
      const APointsZ: TdxShapeFilePointsZ);
    ...
    class procedure ReadZPointsZ(AStream: TStream;
      const APointsZ: TdxShapeFilePointsZ);
  end;
  ...
  private
    ...
    function CreateRecord(ARecordType: TdxShapeFileRecordType;
      ARecordNumber: Integer): TdxShapeFileRecord;
...
type
  ...
  protected
    function GetRecordClassByType(AType: TdxShapeFileRecordType)
      : TdxShapeFileRecordClass;
  public
    constructor Create;
    destructor Destroy; override;
    function CreateRecord(ARecordNumber: Integer; AType: TdxShapeFileRecordType)
      : TdxShapeFileRecord;
    procedure RegisterRecord(AType: TdxShapeFileRecordType;
...
function TdxShapeFileInfo.CreateRecord(ARecordType: TdxShapeFileRecordType;
  ARecordNumber: Integer): TdxShapeFileRecord;
begin
...
begin
  ...
  { and not(AStream.Position > 100000) } do
    LoadRecord(AStream);
end;
...
class function TdxShapeFileReader.ReadBoundingBox(AStream: TStream)
  : TdxShapeFileBoundingBox;
begin
...
class procedure TdxShapeFileReader.ReadPoint(AStream: TStream;
  var APoint: TdxShapeFilePoint);
begin
...
class function TdxShapeFileReader.ReadRange(AStream: TStream)
  : TdxShapeFilePointRange;
begin
...
class function TdxShapeFileMultiPointRecord.GetRecordType
  : TdxShapeFileRecordType;
begin
...
class function TdxShapeFileMultiPointMRecord.GetRecordType
  : TdxShapeFileRecordType;
begin
...
function TdxShapeFileCustomMultiPointMRecord.GetPointsM(Index: Integer)
  : TdxShapeFilePointM;
begin
...
procedure TdxShapeFileRecordsFactory.RegisterRecords(ARecordClasses
  : array of TdxShapeFileRecordClass);
var
  I: Integer;
begin
...
class function TdxShapeFilePolylineMRecord.GetRecordType
  : TdxShapeFileRecordType;
begin
...
function TdxShapeFileCustomMultiPointRecord.GetPoints(Index: Integer)
  : TdxShapeFilePoint;
begin
...
class function TdxShapeFileMultiPointZRecord.GetRecordType
  : TdxShapeFileRecordType;
begin
...
class function TdxShapeFilePolylineZRecord.GetRecordType
  : TdxShapeFileRecordType;
begin
...
function TdxShapeFileCustomMultiPointZRecord.GetPointsZ(Index: Integer)
  : TdxShapeFilePointZ;
begin
...
class function TdxShapeFileMultiPatchRecord.GetRecordType
  : TdxShapeFileRecordType;
begin
...
dxShapeFileRecordsFactory.RegisterRecords
  ([TdxShapeFileRecord, TdxShapeFilePointRecord, TdxShapeFileMultiPointRecord,
  TdxShapeFilePolylineRecord, TdxShapeFilePolygonRecord,
  TdxShapeFilePointMRecord, TdxShapeFileMultiPointMRecord,
  TdxShapeFilePolylineMRecord, TdxShapeFilePolygonMRecord,
  TdxShapeFilePointZRecord, TdxShapeFileMultiPointZRecord,
  TdxShapeFilePolylineZRecord, TdxShapeFilePolygonZRecord,
  TdxShapeFileMultiPatchRecord]);
