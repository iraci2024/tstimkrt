...
const
  ...
  sdxODSMimeTypeSpreadSheetTemplate =
  ...
  sdxODSNodeCalcExtConditionalFormats = AnsiString
  ...
  sdxODSNodeConfigConfigItemMapIndexed = AnsiString
    ('config:config-item-map-indexed');
  sdxODSNodeConfigConfigItemMapNamed = AnsiString
  ...
  sdxODSNodeStylePageLayoutProperties = AnsiString
  ...
  sdxODSNodeStyleTableCellProperties = AnsiString
    ('style:table-cell-properties');
  sdxODSNodeStyleTableColumnProperties = AnsiString
  ...
  sdxODSAttrCalcExtTargetRangeAddress = AnsiString
  ...
  sdxODSAttrDrawTextAreaHorizontalAlign = AnsiString
    ('draw:textarea-horizontal-align');
  sdxODSAttrDrawTextAreaVerticalAlign = AnsiString
  ...
  sdxODSAttrStyleTextLineThroughStyle = AnsiString
  ...
  sdxODSAttrTableDefaultCellStyleName = AnsiString
  ...
  sdxODSAttrTableNumberColumnsRepeated = AnsiString
    ('table:number-columns-repeated');
  sdxODSAttrTableNumberColumnsSpanned = AnsiString
    ('table:number-columns-spanned');
  sdxODSAttrTableNumberMatrixColumnsSpanned = AnsiString
    ('table:number-matrix-columns-spanned');
  sdxODSAttrTableNumberMatrixRowsSpanned = AnsiString
  ...
  sdxODSValueCellProtectionHiddenAndProtected = AnsiString
  ...
  sdxODSValueConfigHorizontalSplitPosition = AnsiString
