...
type
  ...
  private
    ...
    function GetInternalItem(Index: Integer; IsPrinting: Boolean)
      : TdxPSFillPatternItem;
    function GetItem(Pattern: TdxPSFillPatternClass; IsPrinting: Boolean)
      : TdxPSFillPatternItem;
  ...
  protected
    ...
    property InternalItems[Index: Integer; IsPrinting: Boolean]
      : TdxPSFillPatternItem read GetInternalItem write SetInternalItem;
  public
    ...
    property Items[Pattern: TdxPSFillPatternClass; IsPrinting: Boolean]
      : TdxPSFillPatternItem read GetItem; default;
...
const
  Bits: TdxPSPatternBitRows = ($0000, $0000, $0000, $0000, $0000, $0000,
    $0000, $0000);
begin
  APattern := Bits;
end;
...
const
  Bits: TdxPSPatternBitRows = ($5555, $AAAA, $5555, $AAAA, $5555, $AAAA,
    $5555, $AAAA);
begin
  APattern := Bits;
end;
...
constructor TdxPSFillPatternItem.Create(APattern: TdxPSFillPatternClass;
  AIsPrinting: Boolean);
begin
  inherited Create;
  FPattern := APattern;
...
function TdxPSFillPatternFactory.IndexOf
...
function TdxPSFillPatternFactory.GetInternalItem(Index: Integer;
  IsPrinting: Boolean): TdxPSFillPatternItem;
begin
  if IsPrinting then
...
function TdxPSFillPatternFactory.GetItem(Pattern: TdxPSFillPatternClass;
  IsPrinting: Boolean): TdxPSFillPatternItem;
var
  Index: Integer;
begin
  ...
  begin
    ...
    if InternalItems[Index, IsPrinting] = nil then
      InternalItems[Index, IsPrinting] := TdxPSFillPatternItem.Create(Pattern,
        IsPrinting);
...
function TdxPSFillPatternFactory.GetPattern(Index: Integer)
  : TdxPSFillPatternClass;
begin
  Result := TdxPSFillPatternClass(FPatterns[Index]);
end;

procedure TdxPSFillPatternFactory.SetInternalItem(Index: Integer;
  IsPrinting: Boolean; Value: TdxPSFillPatternItem);
begin
  if IsPrinting then
...
procedure TdxPSFillPatternFactory.RemovePattern
...
function TdxPSFillPatternFactory.HasItem
  (APattern: TdxPSFillPatternClass): Boolean;
begin
  Result := InternalItems[IndexOf(APattern), False] <> nil;
end;

function TdxPSFillPatternFactory.HasPrintItem
  (APattern: TdxPSFillPatternClass): Boolean;
begin
  Result := InternalItems[IndexOf(APattern), True] <> nil;
end;

procedure TdxPSFillPatternFactory.RemovePatternItem
  (APattern: TdxPSFillPatternClass);
var
...
procedure TdxPSFillPatternFactory.RemovePatternPrintItem
  (APattern: TdxPSFillPatternClass);
var
  Item: TdxPSFillPatternItem;
begin
