...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Classes, Windows, Controls, ComCtrls, cxContainer, cxControls, cxListBox,
  cxLookAndFeelPainters, dxCore, dxCoreClasses,
  cxCurrencyEdit, dxIncrementalFiltering, cxFilter, cxButtons, cxClasses,
  cxTextEdit, dxLayoutControl, dxLayoutContainer,
  dxLayoutLookAndFeels, dxRangeTrackBar, cxDropDownEdit, cxSpinEdit,
  cxRadioGroup, cxButtonEdit, cxCheckBox, cxDataStorage,
  cxCalendar, cxEdit, dxUIElementPopupWindow, cxGraphics, dxTreeView,
  Generics.Collections, cxFilterControlUtils, dxCustomTree;

type
  TdxExcelFilterValueContainerApplyChangesMode = (efacDefault, efacImmediately,
    efacOnTabOrOKButtonClick);
  TdxExcelFilterValueContainerNumericValuesPageType = (nvptDefault, nvptRange,
    nvptList);
  TdxExcelFilterValueContainerDateTimeValuesPageType = (dvptDefault, dvptTree,
    dvptList);
  TdxExcelFilterValueContainerDefaultPage = (dpDefault, dpValues, dpFilters);

const
  dxDefaultExcelFilterValueContainerApplyChanges
    : TdxExcelFilterValueContainerApplyChangesMode = efacImmediately;
  dxDefaultExcelFilterValueContainerNumericValuesPageType
    : TdxExcelFilterValueContainerNumericValuesPageType = nvptRange;
  dxDefaultExcelFilterValueContainerDateTimeValuesPageType
    : TdxExcelFilterValueContainerDateTimeValuesPageType = dvptTree;
  dxDefaultExcelFilterValueContainerDefaultPage
    : TdxExcelFilterValueContainerDefaultPage = dpValues;
...
type
  ...
  TdxExcelFilterValueContainerType = (ctListBox, ctRange, ctDateTreeView,
    ctTimeTreeView, ctLookup, ctCheck);

  TdxExcelFilterValueContainerConditionType = (ctSpecificDatePeriods, ctEquals,
    ctDoesNotEqual, ctBeginsWith, ctEndsWith, ctContains, ctDoesNotContain,
    ctIsBlank, ctIsNotBlank, ctBetween, ctGreaterThan, ctGreaterThanOrEqualTo,
    ctLessThan, ctLessEqualThanOrEqualTo, ctTopN, ctBottomN, ctAboveAverage,
    ctBelowAverage, ctBefore, ctAfter, ctYesterday, ctToday, ctTomorrow,
    ctLastWeek, ctThisWeek, ctNextWeek, ctLastMonth, ctThisMonth, ctNextMonth,
    ctLastYear, ctThisYear, ctNextYear, ctCustomFilter);
  TdxExcelFilterValueContainerConditionTypes = set of
    TdxExcelFilterValueContainerConditionType;
  ...
  IdxFilterableComponent = interface
    ...
    procedure SetFilterActiveValueIndex(AValueList: TcxFilterValueList;
  ...
  TdxFilterValueContainerIncrementalFilteringHelper = class
  ...
  protected
    ...
    procedure DrawItem(const R: TRect; AItem: TdxCustomListBoxItem;
      AState: TcxButtonState); override;
    procedure DrawItemText(const ARect: TRect; AItem: TdxCustomListBoxItem;
      AState: TcxButtonState); override;
    ...
    function GetFilterValueIndexByItemIndex(AItemIndex: Integer)
      : Integer; virtual;
    ...
    function IsFilterValueVisible(AFilterValue: TcxFilterValueItem;
      ACaption: string): Boolean; virtual;
    ...
    property IncrementalFilteringText: string read FIncrementalFilteringText
      write FIncrementalFilteringText;
  public
    constructor Create(AFilterValueContainer: TdxCustomFilterValueContainer);
      reintroduce; virtual;

    property FilterValueContainer: TdxCustomFilterValueContainer
      read FFilterValueContainer;
  end;
  ...
  protected
    ...
    function IsFilterValueVisible(AFilterValue: TcxFilterValueItem;
      ACaption: string): Boolean; override;
    function NeedHighlightIncrementalFilteringText: Boolean; override;
    function NeedHotTrack: Boolean; override;
    function NeedUseSelectionColor(AItem: TdxCustomListBoxItem;
      AState: TcxButtonState): Boolean; override;
    procedure UpdateItemStates; override;
    function UseContainsIncrementalFiltering: Boolean; override;
  public
    function CanFocus: Boolean; override;

    property FilterValueContainer: TdxFilterValueContainer
      read GetFilterValueContainer;
  end;

  { TdxExcelFilterValueContainerListBox }

  TdxExcelFilterValueContainerListBox = class
    (TdxCustomFilterValueContainerListBox)
  strict private
  const
    dxAllItemIndex = 0;
  protected
    ...
    procedure UpdateItemStates; override;
  public
    constructor Create(AFilterValueContainer
      : TdxCustomFilterValueContainer); override;
  end;

  TdxExcelFilterValueContainerListBoxClass = class of
    TdxExcelFilterValueContainerListBox;

  { TdxFilterValueContainerViewInfo }

  TdxFilterValueContainerViewInfo = class
  ...
  protected
    ...
    property FilterableComponent: IdxFilterableComponent
      read FFilterableComponent;
  ...
  public
    ...
    property LinkComponent: TComponent read FLinkComponent
      write SetLinkComponent;
    property Style;

    property OnAfterFilterChange: TNotifyEvent read FOnAfterFilterChange
      write FOnAfterFilterChange;
    property OnBeforeFilterChange: TNotifyEvent read FOnBeforeFilterChange
      write FOnBeforeFilterChange;
  end;
  ...
  strict private
    ...
    procedure SetIncrementalFilteringOptions(const AValue
  ...
  protected
    ...
    function CreateIncHelper
      : TdxFilterValueContainerIncrementalFilteringHelper; virtual;
    ...
    property IncHelper: TdxFilterValueContainerIncrementalFilteringHelper
      read FIncHelper;
  ...
  public
    ...
    property ApplyMode: TdxFilterApplyChangesMode read FApplyMode
      write SetApplyMode default fpacImmediately;
    property ButtonCaption: string read GetButtonCaption write SetButtonCaption
      stored IsButtonCaptionStored;
    property IncrementalFiltering: Boolean read FIncrementalFiltering
      write SetIncrementalFiltering default False;
    property IncrementalFilteringOptions: TcxTextEditIncrementalFilteringOptions
      read FIncrementalFilteringOptions write SetIncrementalFilteringOptions
  ...
  public
    ...
    property TreeView: TdxExcelFilterValueContainerCustomDateTimeTreeView
      read GetTreeView;
  end;
  ...
  strict private
    ...
    function LoadNodeStateProc(ANode: TdxTreeCustomNode;
  ...
  protected
    ...
    procedure FilterValuesChanged; virtual;
    function GetFilterValueIndexByNode(ANode: TdxTreeViewNode)
      : Integer; virtual;
    function GetValueTextByLvl(AFilterValue: TcxFilterValueItem; ALvl: Integer)
      : string; virtual;
    function GetLevelCount: Integer; virtual;
    function GetNodeClass: TdxTreeViewNodeClass; override;
    function HasIncrementalFiltering: Boolean; virtual;
    function IsFilterValueVisible(AFilterValue: TcxFilterValueItem;
      AText: string): Boolean; virtual;
    ...
    procedure UpdateNodeStateByChildState(ANode: TdxDateTimeTreeViewNode;
      AChildState: TcxCheckBoxState); virtual;
    ...
    property FilterValueContainer: TdxExcelFilterValueContainer
      read FFilterValueContainer;
    property IncrementalFilteringText: string read FIncrementalFilteringText
      write SetIncrementalFilteringText;
  ...
  TdxExcelFilterValueContainerTimeTreeView = class
    (TdxExcelFilterValueContainerCustomDateTimeTreeView)
  strict private
    FHourFormat: string;
  protected
  ...
  public
    constructor Create(AFilterValueContainer
      : TdxExcelFilterValueContainer); override;
  end;

  { TdxExcelFilterValueContainerDateTimeTreeView }

  TdxExcelFilterValueContainerDateTimeTreeView = class
    (TdxExcelFilterValueContainerCustomDateTimeTreeView)
  strict private
    FHasTime: Boolean;
  ...
  TdxExcelFilterValueContainerValuesComboBoxProperties = class
  ...
  TdxExcelFilterValueContainerValuesComboBox = class
    (TdxExcelFilterValueContainerComboBox)
  strict private
    function GetProperties
      : TdxExcelFilterValueContainerValuesComboBoxProperties;
    procedure SetProperties
      (Value: TdxExcelFilterValueContainerValuesComboBoxProperties);
    procedure ValidateHandler(ASender: TObject; var ADisplayValue: TcxEditValue;
  ...
  public
    ...
    property Properties: TdxExcelFilterValueContainerValuesComboBoxProperties
      read GetProperties write SetProperties;
  end;

  { TdxExcelFilterValueContainerDateValuesComboBox }

  TdxExcelFilterValueContainerDateValuesComboBox = class
    (TdxExcelFilterValueContainerValuesComboBox)
  strict private
  const
  ...
  public
    constructor Create(AFilterValueContainer
      : TdxExcelFilterValueContainer); virtual;
    destructor Destroy; override;
  end;

  { TdxExcelFilterValueContainerValuesComboBoxProvider }

  TdxExcelFilterValueContainerValuesComboBoxProvider = class
    (TdxExcelFilterValueContainerCustomValuesComboBoxProvider)
  strict private
  ...
  protected
    ...
    property ComboBox: TdxExcelFilterValueContainerValuesComboBox
      read GetComboBox;
  end;

  { TdxExcelFilterValueContainerDateValuesComboBoxProvider }

  TdxExcelFilterValueContainerDateValuesComboBoxProvider = class
    (TdxExcelFilterValueContainerValuesComboBoxProvider)
  protected
    function CreateComboBox: TcxCustomComboBox; override;
  end;
  ...
  TdxExcelFilterValueContainerImageValuesComboBoxProvider = class
    (TdxExcelFilterValueContainerCustomValuesComboBoxProvider)
  protected
    function CreateComboBox: TcxCustomComboBox; override;
  end;
  ...
  TdxExcelFilterValueContainerConditionTypesComboBox = class
    (TdxExcelFilterValueContainerComboBox)
  strict private
  ...
  protected
    ...
    property SupportedConditionTypes: TdxExcelFilterValueContainerConditionTypes
      read FSupportedConditionTypes write FSupportedConditionTypes;
  public
    constructor Create(AFilterValueContainer
      : TdxExcelFilterValueContainer); override;
  end;
  ...
  TdxExcelFilterValueContainerCondition = class
    (TdxExcelFilterValueContainerCustomItem)
  strict private
  ...
  protected
    ...
    property ConditionContainer: TdxExcelFilterValueContainerConditionContainer
      read FConditionContainer;
  public
    constructor Create(AFilterValueContainer: TdxExcelFilterValueContainer;
  ...
  TdxExcelFilterValueContainerConditionClass = class of
    TdxExcelFilterValueContainerCondition;

  { TdxExcelFilterValueContainerAverageCondition }

  TdxExcelFilterValueContainerAverageCondition = class
    (TdxExcelFilterValueContainerCondition)
  private
  ...
  TdxExcelFilterValueContainerEditableCondition = class
    (TdxExcelFilterValueContainerCondition)
  protected
  ...
  TdxExcelFilterValueContainerTextEditCondition = class
    (TdxExcelFilterValueContainerEditableCondition)
  strict private
  ...
  TdxExcelFilterValueContainerComboBoxCondition = class
    (TdxExcelFilterValueContainerEditableCondition)
  strict private
  ...
  protected
    ...
    property ComboBoxProvider
      : TdxExcelFilterValueContainerCustomValuesComboBoxProvider
      read FComboBoxProvider;
  ...
  TdxExcelFilterValueContainerBetweenCondition = class
    (TdxExcelFilterValueContainerEditableCondition)
  strict private
    FFromComboBoxProvider
      : TdxExcelFilterValueContainerCustomValuesComboBoxProvider;
  ...
  protected
    ...
    property FromComboBoxProvider
      : TdxExcelFilterValueContainerCustomValuesComboBoxProvider
      read FFromComboBoxProvider;
    property FromLayoutItem: TdxLayoutItem read FFromLayoutItem;
    property ToComboBoxProvider
      : TdxExcelFilterValueContainerCustomValuesComboBoxProvider
      read FToComboBoxProvider;
  ...
  TdxExcelFilterValueContainerCounterCondition = class
    (TdxExcelFilterValueContainerEditableCondition)
  strict private
    FDisplayText: string;
  ...
  TdxExcelFilterValueContainerSpecificDatePeriodsConditionPeriod = class
    (TdxExcelFilterValueContainerCustomItem)
  strict private
  ...
  protected
    function AddCheckBox(AOperator: TcxFilterOperatorKind)
      : TcxCheckBox; virtual;
    procedure DoGenerate(AParentGroup: TdxLayoutGroup); override;
  ...
  TdxExcelFilterValueContainerSpecificDatePeriodsCondition = class
    (TdxExcelFilterValueContainerEditableCondition)
  strict private
    ...
    function GetPeriod(AIndex: Integer)
      : TdxExcelFilterValueContainerSpecificDatePeriodsConditionPeriod;
    function GetPeriodCount: Integer;
  protected
    function AddPeriod
      : TdxExcelFilterValueContainerSpecificDatePeriodsConditionPeriod; virtual;
    procedure AddPeriodCheckBox(APeriod
      : TdxExcelFilterValueContainerSpecificDatePeriodsConditionPeriod;
    ...
    procedure UpdatePeriodCheckBoxStates(AOperators
      : TcxFilterOperatorKinds); virtual;
    procedure UpdateValues; override;
    ...
    property Periods[AIndex: Integer]
      : TdxExcelFilterValueContainerSpecificDatePeriodsConditionPeriod
      read GetPeriod;
  ...
  TdxExcelFilterValueContainerCustomFilterConditionAndOr = class
    (TdxExcelFilterValueContainerCustomItem)
  strict private
  ...
  protected
    ...
    function GetSupportedConditionTypes
      : TdxExcelFilterValueContainerConditionTypes; virtual;
    function GetValue: Variant; override;
    function IsComplex: Boolean; override;
    function IsEmpty: Boolean; override;
    procedure PopulateActiveCriteriaItems(AContainer
      : TdxExcelFilterValueContainerCustomFilterConditionContainer); virtual;
    procedure PopulateValueInfos(AList: TdxFastObjectList); override;
    ...
    property AndOr: TdxExcelFilterValueContainerCustomFilterConditionAndOr
      read FAndOr;
    property AndOrGroup: TdxLayoutGroup read FAndOrGroup;
    property ChildConditionContainer1
      : TdxExcelFilterValueContainerCustomFilterConditionContainer
      read FChildConditionContainer1;
    property ChildConditionContainer2
      : TdxExcelFilterValueContainerCustomFilterConditionContainer
      read FChildConditionContainer2;
  public
    destructor Destroy; override;
  end;
  ...
  strict private
    ...
    function PopulateActiveCriteriaItemsByAndItemList
      (AItemList: TcxFilterCriteriaItemList): Boolean;
    function PopulateActiveCriteriaItemsByOrItemList
      (AItemList: TcxFilterCriteriaItemList): Boolean;
    procedure SetSupportedConditionTypes(const AValue
  ...
  protected
    ...
    function GetActiveConditionType(out AHasActiveCondition: Boolean)
      : TdxExcelFilterValueContainerConditionType; virtual;
    function GetConditionType
      : TdxExcelFilterValueContainerConditionType; virtual;
    function GetConditionTypeItemIndex(AConditionType
      : TdxExcelFilterValueContainerConditionType): Integer; virtual;
    ...
    procedure KeyDownHandler(Sender: TObject; var Key: Word;
      Shift: TShiftState); override;
    function PopulateActiveCriteriaItems(AItemList: TcxFilterCriteriaItemList)
      : Boolean; virtual;
    ...
    property ActiveBoolOperator: TcxFilterBoolOperatorKind
      read FActiveBoolOperator;
    property ActiveCriteriaItems: TList<TcxFilterCriteriaItem>
      read FActiveCriteriaItems;
    property Condition: TdxExcelFilterValueContainerCondition read FCondition;
    property ConditionTypeComboBox
      : TdxExcelFilterValueContainerConditionTypesComboBox
      read FConditionTypeComboBox;
    property ConditionTypeLayoutItem: TdxLayoutItem
      read FConditionTypeLayoutItem;
    property CustomFilterConditionClass
      : TdxExcelFilterValueContainerConditionClass
      read FCustomFilterConditionClass write FCustomFilterConditionClass;
    property LayoutGroup: TdxLayoutGroup read FLayoutGroup;
    property NeedUpdateConditionDataOnConditionTypeChanged: Boolean
      read FNeedUpdateConditionDataOnConditionTypeChanged;
    property NeedUpdateConditionTypeItems: Boolean
      read FNeedUpdateConditionTypeItems;
    property SupportedConditionTypes: TdxExcelFilterValueContainerConditionTypes
      read FSupportedConditionTypes write SetSupportedConditionTypes;
  public
    constructor Create(AFilterValueContainer
      : TdxExcelFilterValueContainer); override;
    destructor Destroy; override;
  ...
  protected
    ...
    property CustomFilterCondition
      : TdxExcelFilterValueContainerCustomFilterCondition
      read FCustomFilterCondition;
  public
    constructor Create(AFilterValueContainer: TdxExcelFilterValueContainer;
      ACustomFilterCondition
      : TdxExcelFilterValueContainerCustomFilterCondition);
      reintroduce; virtual;
  end;
  ...
  TdxExcelFilterValueContainerRangeModeValuesPageBetween = class
    (TdxExcelFilterValueContainerCustomItem)
  strict private
  ...
  public
    constructor Create(AFilterValueContainer: TdxExcelFilterValueContainer;
      AOwner: TdxExcelFilterValueContainerRangeModeValuesPage);
      reintroduce; virtual;
    destructor Destroy; override;
  end;
  ...
  TdxExcelFilterValueContainerCustomPage = class
    (TdxExcelFilterValueContainerCustomItem)
  protected
    procedure ApplyFilter; virtual;
    procedure FocusMainItem; virtual;
  ...
  TdxExcelFilterValueContainerCustomValuesPage = class
    (TdxExcelFilterValueContainerCustomPage);

  { TdxExcelFilterValueContainerSearchableValuesPage }

  TdxExcelFilterValueContainerSearchableValuesPage = class
    (TdxExcelFilterValueContainerCustomValuesPage)
  strict private
  ...
  protected
    ...
    property SearchEdit: TdxExcelFilterValueContainerSearchEdit
      read FSearchEdit;
  ...
  TdxExcelFilterValueContainerListBoxModeValuesPage = class
    (TdxExcelFilterValueContainerSearchableValuesPage)
  strict private
  ...
  TdxExcelFilterValueContainerCustomDateTimeTreeViewModeValuesPage = class
    (TdxExcelFilterValueContainerSearchableValuesPage)
  strict private
  ...
  protected
    ...
    function CreateTreeView
      : TdxExcelFilterValueContainerCustomDateTimeTreeView; virtual;
    procedure DoGenerate(AParentGroup: TdxLayoutGroup); override;
    procedure FocusMainItem; override;
  ...
  TdxExcelFilterValueContainerDateTreeViewModeValuesPage = class
    (TdxExcelFilterValueContainerCustomDateTimeTreeViewModeValuesPage)
  protected
    function CreateTreeView
      : TdxExcelFilterValueContainerCustomDateTimeTreeView; override;
  end;

  { TdxExcelFilterValueContainerTimeTreeViewModeValuesPage }

  TdxExcelFilterValueContainerTimeTreeViewModeValuesPage = class
    (TdxExcelFilterValueContainerCustomDateTimeTreeViewModeValuesPage)
  protected
    function CreateTreeView
      : TdxExcelFilterValueContainerCustomDateTimeTreeView; override;
  ...
  strict private
    ...
    // handlers
    procedure RangeTrackBarGetPositionHintHandler(Sender: TObject;
      const AMinPosition, AMaxPosition: Integer; var AHintText: string;
      var ACanShow, AIsHintMultiLine: Boolean);
    procedure RangeTrackBarMouseDownHandler(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure RangeTrackBarMouseUpHandler(Sender: TObject; Button: TMouseButton;
  ...
  TdxExcelFilterValueContainerFiltersPage = class
    (TdxExcelFilterValueContainerCustomPage)
  strict private
    FConditionContainer: TdxExcelFilterValueContainerConditionContainer;
  protected
  ...
  TdxExcelFilterValueContainerLayout = class
    (TdxExcelFilterValueContainerCustomItem)
  strict private
  ...
  TdxExcelFilterValueContainerCustomValuesLayout = class
    (TdxExcelFilterValueContainerLayout)
  strict private
    FValuesPage: TdxExcelFilterValueContainerCustomValuesPage;
    FValuesPageGroup: TdxLayoutGroup;
  protected
    function CreateValuesPage: TdxExcelFilterValueContainerCustomValuesPage;
      virtual; abstract;
    ...
    property ValuesPage: TdxExcelFilterValueContainerCustomValuesPage
      read FValuesPage;
  ...
  TdxExcelFilterValueContainerCustomValuesAndFiltersLayout = class
    (TdxExcelFilterValueContainerCustomValuesLayout)
  strict private
    FFiltersPage: TdxExcelFilterValueContainerFiltersPage;
    FFiltersPageGroup: TdxLayoutGroup;
  protected
    function CreateFiltersPage
      : TdxExcelFilterValueContainerFiltersPage; virtual;
    procedure DestroyPageGroups; override;
    procedure DestroyPages; override;
    ...
    property FiltersPage: TdxExcelFilterValueContainerFiltersPage
      read FFiltersPage;
  ...
  TdxExcelFilterValueContainerCheckModeLayout = class
    (TdxExcelFilterValueContainerCustomValuesLayout)
  protected
    function CreateValuesPage
      : TdxExcelFilterValueContainerCustomValuesPage; override;
  end;

  { TdxExcelFilterValueContainerLookupModeLayout }

  TdxExcelFilterValueContainerLookupModeLayout = class
    (TdxExcelFilterValueContainerCustomValuesLayout)
  protected
    function CreateValuesPage
      : TdxExcelFilterValueContainerCustomValuesPage; override;
  ...
  TdxExcelFilterValueContainerDateTreeViewModeLayout = class
    (TdxExcelFilterValueContainerCustomValuesAndFiltersLayout)
  protected
    function CreateValuesPage
      : TdxExcelFilterValueContainerCustomValuesPage; override;
  ...
  TdxExcelFilterValueContainerTimeTreeViewModeLayout = class
    (TdxExcelFilterValueContainerCustomValuesAndFiltersLayout)
  protected
    function CreateValuesPage
      : TdxExcelFilterValueContainerCustomValuesPage; override;
  ...
  TdxExcelFilterValueContainerListBoxModeLayout = class
    (TdxExcelFilterValueContainerCustomValuesAndFiltersLayout)
  protected
    function CreateValuesPage
      : TdxExcelFilterValueContainerCustomValuesPage; override;
  ...
  TdxExcelFilterValueContainerRangeModeLayout = class
    (TdxExcelFilterValueContainerCustomValuesAndFiltersLayout)
  protected
    function CreateValuesPage
      : TdxExcelFilterValueContainerCustomValuesPage; override;
  ...
  strict private
    ...
    // handlers
    procedure LayoutControlKeyDownHandler(Sender: TObject; var Key: Word;
      Shift: TShiftState);
  protected
    ...
    function GetDateTimeValuesPageType
      : TdxExcelFilterValueContainerDateTimeValuesPageType; virtual;
    function GetDefaultBounds: TRect; override;
    function GetDisplayTextByValue(AValue: Variant): string; virtual;
    function GetListBoxClass: TdxExcelFilterValueContainerListBoxClass; virtual;
    function GetNumericValuesPageType
      : TdxExcelFilterValueContainerNumericValuesPageType; virtual;
    ...
    procedure KeyDown(var Key: Word; Shift: TShiftState); override;
    procedure LayoutKeyDown(ASender: TObject; var Key: Word;
      Shift: TShiftState); virtual;
    function NeedImmediateApply: Boolean; override;
    ...
    procedure SetFilterActiveValues(AValueInfos: TdxFastObjectList;
      ABoolOperator: TcxFilterBoolOperatorKind); virtual;
    procedure UpdateLayoutControlPosition; virtual;
    procedure UpdateValues; override;

    function CreateFilterEdit: TcxCustomEdit; virtual;
    function CreateFilterValuesComboBoxProvider
      : TdxExcelFilterValueContainerCustomValuesComboBoxProvider; virtual;
    function CreateLayout
      : TdxExcelFilterValueContainerCustomValuesLayout; virtual;
    function CreateLayoutControl: TdxLayoutControl; virtual;
    function CreateLayoutLookAndFeel: TdxLayoutCxLookAndFeel; virtual;

    property FilterableComponent: IdxExcelFilterableComponent
      read GetFilterableComponent;
...
uses
  Types, SysUtils, Graphics, Math, Variants, DateUtils, Menus, dxGDIPlusClasses,
  cxGeometry, cxDrawTextUtils, cxEditConsts,
  cxTrackBar, cxFormats, cxFilterConsts, cxVariants, RTLConsts, dxMessages,
  cxMaskEdit, cxTimeEdit, cxImageComboBox,
  cxLookAndFeels;

const
  dxDatePeriodOperators = [foYesterday .. foTomorrow, foLastWeek, foLastMonth,
    foLastYear, foThisWeek .. foThisYear, foNextWeek, foNextMonth, foNextYear];

  dxGetConditionTypeCaption: array [TdxExcelFilterValueContainerConditionType]
    of TcxResourceStringID = (@sdxExcelFilterSpecificDatePeriodsConditionText,
    @sdxExcelFilterEqualsConditionText,
    @sdxExcelFilterDoesNotEqualConditionText,
    @sdxExcelFilterBeginsWithConditionText,
    @sdxExcelFilterEndsWithConditionText, @sdxExcelFilterContainsConditionText,
    @sdxExcelFilterDoesNotContainConditionText,
    @sdxExcelFilterIsBlankConditionText, @sdxExcelFilterIsNotBlankConditionText,
    @sdxExcelFilterBetweenConditionText,
    @sdxExcelFilterGreaterThanConditionText,
    @sdxExcelFilterGreaterThanOrEqualToConditionText,
    @sdxExcelFilterLessThanConditionText,
    @sdxExcelFilterLessEqualThanOrEqualToConditionText,
    @sdxExcelFilterTopNConditionText, @sdxExcelFilterBottomNConditionText,
    @sdxExcelFilterAboveAverageConditionText,
    @sdxExcelFilterBelowAverageConditionText,
    @sdxExcelFilterBeforeConditionText, @sdxExcelFilterAfterConditionText,
    @sdxExcelFilterYesterdayConditionText,
    @sdxExcelFilterTodayConditionTypeText, @sdxExcelFilterTomorrowConditionText,
    @sdxExcelFilterLastWeekConditionText, @sdxExcelFilterThisWeekConditionText,
    @sdxExcelFilterNextWeekConditionText, @sdxExcelFilterLastMonthConditionText,
    @sdxExcelFilterThisMonthConditionText,
    @sdxExcelFilterNextMonthConditionText, @sdxExcelFilterLastYearConditionText,
    @sdxExcelFilterThisYearConditionText, @sdxExcelFilterNextYearConditionText,
    @sdxExcelFilterCustomFilterConditionText);

  dxOperatorByConditionTypeMap
    : array [TdxExcelFilterValueContainerConditionType]
    of TcxFilterOperatorKind = (foEqual, foEqual, foNotEqual, foBeginsWith,
    foEndsWith, foContains, foNotContains, foEqual, foNotEqual, foBetween,
    foGreater, foGreaterEqual, foLess, foLessEqual, foInList, foInList,
    foGreater, foLess, foLess, foGreater, foYesterday, foToday, foTomorrow,
    foLastWeek, foThisWeek, foNextWeek, foLastMonth, foThisMonth, foNextMonth,
    foLastYear, foThisYear, foNextYear, foEqual);

  dxConditionTypeByOperatorMap: array [TcxFilterOperatorKind]
    of TdxExcelFilterValueContainerConditionType = (ctEquals, ctDoesNotEqual,
    ctLessThan, ctLessEqualThanOrEqualTo, ctGreaterThan, ctGreaterThanOrEqualTo,
    ctEquals, ctEquals, ctBetween, ctEquals, ctEquals, ctEquals, ctYesterday,
    ctToday, ctTomorrow, ctEquals, ctLastWeek, ctEquals, ctEquals, ctEquals,
    ctLastMonth, ctLastYear, ctEquals, ctThisWeek, ctThisMonth, ctThisYear,
    ctEquals, ctNextWeek, ctEquals, ctEquals, ctEquals, ctNextMonth, ctNextYear,
    ctEquals, ctContains, ctDoesNotContain, ctBeginsWith, ctEndsWith);
...
type
  ...
  TcxCustomLookAndFeelPainterHelper = class helper for
    TcxCustomLookAndFeelPainter
  public
    function GetCalendarButtonGlyph: TdxSmartImage;
  end;

function dxGetConditionTypeResourceCaption
  (AType: TdxExcelFilterValueContainerConditionType): string;
begin
  Result := cxGetResourceString(dxGetConditionTypeCaption[AType]);
end;

function dxGetConditionTypeByOperator(AOperator: TcxFilterOperatorKind;
  AValue: Variant): TdxExcelFilterValueContainerConditionType;
begin
  Result := dxConditionTypeByOperatorMap[AOperator];
  if VarIsNull(AValue) then
    if Result = ctEquals then
      Result := ctIsBlank
    else if Result = ctDoesNotEqual then
      Result := ctIsNotBlank;
end;
...
function TcxCustomLookAndFeelPainterHelper.GetCalendarButtonGlyph
  : TdxSmartImage;
begin
...
constructor TdxExcelFilterValueContainerValueInfo.Create(AValue: Variant;
  ADisplayText: string; AOperatorKind: TcxFilterOperatorKind);
begin
  inherited Create;
  FValue := AValue;
...
constructor TdxFilterValueContainerIncrementalFilteringHelper.Create
  (AOwner: TdxFilterValueContainer);
begin
  inherited Create;
  FOwner := AOwner;
end;

function TdxFilterValueContainerIncrementalFilteringHelper.GetItemCount
  : Integer;
begin
  Result := ListBox.Count;
end;

function TdxFilterValueContainerIncrementalFilteringHelper.GetItemIndex
  : Integer;
begin
  Result := ListBox.ItemIndex;
end;

function TdxFilterValueContainerIncrementalFilteringHelper.GetLookAndFeelPainter
  : TcxCustomLookAndFeelPainter;
begin
  Result := Owner.LookAndFeel.Painter;
end;

function TdxFilterValueContainerIncrementalFilteringHelper.
  GetVisibleItemCount: Integer;
begin
  Result := ListBox.GetVisibleItemCount;
end;

procedure TdxFilterValueContainerIncrementalFilteringHelper.SearchEditKeyDown
...
procedure TdxFilterValueContainerIncrementalFilteringHelper.SearchEditMouseWheel
...
procedure TdxFilterValueContainerIncrementalFilteringHelper.
  SearchEditValueChanged(Sender: TObject);
begin
  Owner.DataChanged;
end;

procedure TdxFilterValueContainerIncrementalFilteringHelper.SetItemIndex
  (const Value: Integer);
begin
  ListBox.ItemIndex := Max(Value, -1);
end;

function TdxFilterValueContainerIncrementalFilteringHelper.GetListBox
  : TdxFilterValueContainerListBox;
begin
...
constructor TdxCustomFilterValueContainerListBox.Create(AFilterValueContainer
  : TdxCustomFilterValueContainer);
begin
...
procedure TdxCustomFilterValueContainerListBox.ApplyCheckAction
  (AItemIndex: Integer);
begin
...
procedure TdxCustomFilterValueContainerListBox.ApplyClickAction
  (AItemIndex: Integer);
begin
  FilterValueContainer.SetActiveValueIndex
    (GetFilterValueIndexByItemIndex(AItemIndex));
end;
...
function TdxCustomFilterValueContainerListBox.CanFocusIndex
...
procedure TdxCustomFilterValueContainerListBox.DrawItem(const R: TRect;
...
procedure TdxCustomFilterValueContainerListBox.DrawItemText(const ARect: TRect;
  AItem: TdxCustomListBoxItem; AState: TcxButtonState);
var
  ASelStart: Integer;
  AText: string;
...
begin
  ...
  begin
    R := ARect;
    AText := AItem.Caption;
    ASelStart := Pos(AnsiUpperCase(IncrementalFilteringText),
      AnsiUpperCase(AText)) - 1;
    cxTextOut(Canvas.Canvas, AText, R, CXTO_LEFT or CXTO_CENTER_VERTICALLY or
      CXTO_SINGLELINE or CXTO_END_ELLIPSIS, ASelStart,
      Length(IncrementalFilteringText), Canvas.Font, clHighlight,
      clHighlightText, 0, 0, 0, GetTextColor(AItem, AState));
  end
  else
    inherited;
end;
...
function TdxCustomFilterValueContainerListBox.GetCheckedItemIndexes
  : TdxIntegerIndexes;
var
  I: Integer;
  AItemIndex: Integer;
begin
  ...
  begin
    AItemIndex := GetItemIndexByFilterValueIndex
      (FilterValueContainer.CheckedValueIndexes[I]);
...
function TdxCustomFilterValueContainerListBox.GetItemIndexByFilterValueIndex
...
function TdxCustomFilterValueContainerListBox.GetFilterValue
  (AItemIndex: Integer): TcxFilterValueItem;
begin
  Result := TcxFilterValueItem(Items[AItemIndex].Data);
end;

function TdxCustomFilterValueContainerListBox.GetFilterValueIndexByItemIndex
...
function TdxCustomFilterValueContainerListBox.HasCheckBox
  (AItemIndex: Integer): Boolean;
begin
...
function TdxCustomFilterValueContainerListBox.IsCheck
  (AItemIndex: Integer): Boolean;
begin
  Result := IsFilterValueCheck(GetFilterValue(AItemIndex));
end;

function TdxCustomFilterValueContainerListBox.IsFilterValueVisible
  (AFilterValue: TcxFilterValueItem; ACaption: string): Boolean;
var
  APos: Integer;
begin
  if HasIncrementalFiltering then
  begin
    APos := AnsiPos(AnsiUpperCase(IncrementalFilteringText),
      AnsiUpperCase(ACaption));
...
function TdxCustomFilterValueContainerListBox.IsMRUSeparatorItem
  (AItemIndex: Integer): Boolean;
begin
  Result := GetFilterValue(AItemIndex).Kind = fviMRUSeparator;
end;

function TdxCustomFilterValueContainerListBox.IsFilterValueCheck
  (AValue: TcxFilterValueItem): Boolean;
begin
  Result := FilterValueContainer.IsValueCheck(AValue);
end;

procedure TdxCustomFilterValueContainerListBox.DoItemAction
  (AItemIndex: Integer);
begin
...
function TdxCustomFilterValueContainerListBox.
  NeedHighlightIncrementalFilteringText: Boolean;
begin
  Result := HasIncrementalFiltering;
end;

procedure TdxCustomFilterValueContainerListBox.UpdateCheckedFilterValueIndexes
  (AItemIndex: Integer);
var
...
function TdxCustomFilterValueContainerListBox.
  UseContainsIncrementalFiltering: Boolean;
begin
  Result := True;
end;
...
begin
  Result := inherited CanFocus and
    not FilterValueContainer.IncrementalFiltering;
end;

procedure TdxFilterValueContainerListBox.ApplyClickAction(AItemIndex: Integer);
begin
  inherited ApplyClickAction(AItemIndex);
  if not(FilterValueContainer.Values[AItemIndex].Kind in [fviCustom, fviUser])
  then
...
function TdxFilterValueContainerListBox.IsFilterValueVisible
  (AFilterValue: TcxFilterValueItem; ACaption: string): Boolean;
begin
...
function TdxFilterValueContainerListBox.
  NeedHighlightIncrementalFilteringText: Boolean;
begin
  Result := inherited NeedHighlightIncrementalFilteringText and
    (ifoHighlightSearchText
    in FilterValueContainer.IncrementalFilteringOptions);
end;
...
function TdxFilterValueContainerListBox.NeedUseSelectionColor
  (AItem: TdxCustomListBoxItem; AState: TcxButtonState): Boolean;
begin
  Result := inherited NeedUseSelectionColor(AItem, AState) or
    Checked[AItem.Index];
end;
...
begin
  ...
  if CheckedIndexes = nil then
    ItemIndex := GetItemIndexByFilterValueIndex
      (FilterValueContainer.SelectedValueIndex)
  else
    ItemIndex := -1;
end;

function TdxFilterValueContainerListBox.UseContainsIncrementalFiltering
  : Boolean;
begin
  Result := ifoUseContainsOperator
    in FilterValueContainer.IncrementalFilteringOptions
end;

function TdxFilterValueContainerListBox.GetFilterValueContainer
  : TdxFilterValueContainer;
begin
...
constructor TdxExcelFilterValueContainerListBox.Create(AFilterValueContainer
  : TdxCustomFilterValueContainer);
begin
  inherited Create(AFilterValueContainer);
...
procedure TdxExcelFilterValueContainerListBox.ApplyAllItemAction
  (AChecked: Boolean);
var
  I: Integer;
begin
...
procedure TdxExcelFilterValueContainerListBox.ApplyCheckAction
  (AItemIndex: Integer);
begin
...
function TdxExcelFilterValueContainerListBox.GetAllItem
...
begin
  Result := cxRectSetSize(cxEmptyRect,
    dxFilterValueContainerListBoxDefaultWidth,
    dxFilterValueContainerListBoxDefaultHeight);
end;

function TdxExcelFilterValueContainerListBox.IsFilterValueCheck
  (AValue: TcxFilterValueItem): Boolean;
begin
...
procedure TdxExcelFilterValueContainerListBox.UpdateCheckedFilterValueIndexes
  (AItemIndex: Integer);
begin
  if GetFilterValue(AItemIndex).Kind <> fviAll then
...
function TdxFilterValueContainerViewInfo.GetFilterValueContainer
  : TdxFilterValueContainer;
begin
...
function TdxCustomFilterValueContainer.DoRefreshContainer(const P: TPoint;
...
begin
  Result := cxRectSetSize(cxEmptyRect, dxFilterValueContainerDefaultWidth,
    dxFilterValueContainerDefaultHeight);
end;
...
function TdxCustomFilterValueContainer.IsLinkComponentSupported
  (AValue: TComponent): Boolean;
begin
  Result := Supports(AValue, IdxFilterableComponent);
end;

function TdxCustomFilterValueContainer.IsValueCheck
  (AValue: TcxFilterValueItem): Boolean;
begin
...
procedure TdxCustomFilterValueContainer.Notification(AComponent: TComponent;
...
procedure TdxCustomFilterValueContainer.SetActiveValueIndex(AFilterValueIndex
  : Integer);
begin
  BeforeFilterChange;
  try
    FilterableComponent.SetFilterActiveValueIndex(Values, AFilterValueIndex,
      nil, True, True);
  finally
    AfterFilterChange;
  end;
...
begin
  BeforeFilterChange;
  try
    FilterableComponent.SetFilterActiveValueIndexes(Values,
      CheckedValueIndexes);
  finally
    AfterFilterChange;
  end;
...
begin
  ...
  FIncrementalFilteringOptions := [ifoHighlightSearchText,
...
function TdxFilterValueContainer.CreateIncHelper
  : TdxFilterValueContainerIncrementalFilteringHelper;
begin
...
begin
  Result := inherited IsChildFocused or ListBox.Focused or Button.Focused or
    SearchEdit.Focused;
end;
...
begin
  ...
  if SearchEdit.CanFocus then
    FocusSearchEdit
  else if ListBox.CanFocus then
    ListBox.SetFocus
  else if Button.CanFocus then
    Button.SetFocus;
end;
...
procedure TdxFilterValueContainer.SetApplyMode(const AValue
...
procedure TdxFilterValueContainer.SetIncrementalFiltering
...
procedure TdxFilterValueContainer.SetIncrementalFilteringOptions
  (const AValue: TcxTextEditIncrementalFilteringOptions);
begin
...
procedure TdxExcelFilterValueContainerSearchEditViewInfo.DrawEditButton
...
begin
  ...
  if SearchButtonInfo <> ButtonsInfo[AButtonVisibleIndex] then
    Exit;
  Painter.DrawScaledSearchEditButtonGlyph(ACanvas, SearchButtonInfo.Bounds,
    cxbsNormal, ScaleFactor);
end;

function TdxExcelFilterValueContainerSearchEditViewInfo.GetSearchButtonInfo
...
function TdxExcelFilterValueContainerSearchEdit.GetViewInfoClass
...
begin
  Result := (Level < TreeView.LastLevel) and not IsRoot and not IsAll and
    not IsBlank;
end;
...
function TdxDateTimeTreeViewNode.GetTreeView
  : TdxExcelFilterValueContainerCustomDateTimeTreeView;
begin
  Result := TdxExcelFilterValueContainerCustomDateTimeTreeView
    (inherited TreeView);
end;

{ TdxExcelFilterValueContainerCustomDateTimeTreeView }

constructor TdxExcelFilterValueContainerCustomDateTimeTreeView.Create
...
procedure TdxExcelFilterValueContainerCustomDateTimeTreeView.
  CorrectCheckedIndexes(ANode: TdxDateTimeTreeViewNode);
begin
...
begin
  ...
  try
    ...
    begin
      ...
      if not IsFilterValueVisible(AFilterValue,
        FilterValueContainer.DisplayValues[I]) then
        Continue;
      if AFilterValue.Kind <> fviValue then
        GetActualNode(-1, AInfo).AddChild(FilterValueContainer.DisplayValues[I],
          AFilterValue)
      else
        ...
        begin
          ...
          else if AInfo[ALevel] <> AText then
          begin
            AInfo[ALevel] := AText;
            AInfo.Objects[ALevel] := GetActualNode(ALevel - 1, AInfo)
              .AddChild(AInfo[ALevel]);
...
function TdxExcelFilterValueContainerCustomDateTimeTreeView.
  GetFilterValueIndexByNode(ANode: TdxTreeViewNode): Integer;
begin
  Result := FilterValueContainer.Values.IndexOf(TcxFilterValueItem(ANode.Data))
end;

function TdxExcelFilterValueContainerCustomDateTimeTreeView.GetValueTextByLvl
  (AFilterValue: TcxFilterValueItem; ALvl: Integer): string;
begin
...
function TdxExcelFilterValueContainerCustomDateTimeTreeView.GetNodeClass
  : TdxTreeViewNodeClass;
begin
  Result := TdxDateTimeTreeViewNode;
end;

function TdxExcelFilterValueContainerCustomDateTimeTreeView.
  HasIncrementalFiltering: Boolean;
begin
  Result := IncrementalFilteringText <> '';
end;

function TdxExcelFilterValueContainerCustomDateTimeTreeView.IsFilterValueVisible
  (AFilterValue: TcxFilterValueItem; AText: string): Boolean;
var
  ALevel: Integer;
  ADisplayText: string;
begin
...
function TdxExcelFilterValueContainerCustomDateTimeTreeView.IsTextVisible
  (AText: string): Boolean;
begin
  Result := AnsiPos(AnsiUpperCase(IncrementalFilteringText),
    AnsiUpperCase(AText)) > 0;
end;

procedure TdxExcelFilterValueContainerCustomDateTimeTreeView.LoadNodeStates;
begin
  if (Root.Count = 0) or (Length(FilterValueContainer.CheckedValueIndexes) = 0)
  then
    Exit;
  BeginUpdate;
...
procedure TdxExcelFilterValueContainerCustomDateTimeTreeView.NodeStateChanged
  (ANode: TdxTreeViewNode);

  procedure SetChildStates(AParent: TdxDateTimeTreeViewNode;
    AState: TcxCheckBoxState);
  var
...
procedure TdxExcelFilterValueContainerCustomDateTimeTreeView.
  UpdateNodeStateByChildState(ANode: TdxDateTimeTreeViewNode;
...
begin
  ...
  else if ANode.CheckState <> AChildState then
    ANode.CheckState := cbsGrayed;
end;

function TdxExcelFilterValueContainerCustomDateTimeTreeView.
  IsNodeStatesUpdating: Boolean;
begin
...
function TdxExcelFilterValueContainerCustomDateTimeTreeView.
  GetLastLevel: Integer;
begin
  Result := LevelCount - 1;
end;

function TdxExcelFilterValueContainerCustomDateTimeTreeView.GetRoot
  : TdxDateTimeTreeViewNode;
begin
...
procedure TdxExcelFilterValueContainerCustomDateTimeTreeView.
  SetIncrementalFilteringText(const AValue: string);
begin
...
function TdxExcelFilterValueContainerCustomDateTimeTreeView.LoadNodeStateProc
  ...
  begin
    ...
    begin
      ...
      ANode.Checked := ANode.Data = FilterValueContainer.Values
        [AFilterValueIndex];
      if ANode.Checked then
        Break;
    end;
...
constructor TdxExcelFilterValueContainerTimeTreeView.Create
  (AFilterValueContainer: TdxExcelFilterValueContainer);
begin
  inherited Create(AFilterValueContainer);
...
begin
  ATimeEditProperties := Safe<TcxCustomTimeEditProperties>.Cast
    (FilterValueContainer.FilterProperties);
...
function TdxExcelFilterValueContainerTimeTreeView.GetValueTextByLvl
  (AFilterValue: TcxFilterValueItem; ALvl: Integer): string;
begin
  case ALvl of
    0:
...
function TdxExcelFilterValueContainerDateTimeTreeView.GetValueTextByLvl
  (AFilterValue: TcxFilterValueItem; ALvl: Integer): string;
var
  AFormat: string;
begin
...
begin
  Result := Pos(dxFormatSettings.TimeAMString,
    dxFormatSettings.ShortTimeFormat) = 0;
end;
...
begin
  ...
  begin
    ...
    begin
      AFilterValue := FilterValueContainer.Values[I];
      FHasTime := (AFilterValue.Kind = fviValue) and
        (AFilterValue.Value <> DateOf(AFilterValue.Value));
      if FHasTime then
        Break;
    end;
...
constructor TdxExcelFilterValueContainerComboBox.Create(AFilterValueContainer
  : TdxExcelFilterValueContainer);
begin
  FFilterValueContainer := AFilterValueContainer;
  inherited Create(nil);
...
function TdxExcelFilterValueContainerValuesComboBoxProperties.
  IsEditValueNumeric: Boolean;
begin
  Result := FIsEditValueNumeric;
end;

procedure TdxExcelFilterValueContainerValuesComboBoxProperties.
  SetEditValueNumeric(AValue: Boolean);
begin
...
class function TdxExcelFilterValueContainerValuesComboBox.GetPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TdxExcelFilterValueContainerValuesComboBoxProperties;
end;

function TdxExcelFilterValueContainerValuesComboBox.
...
begin
  ...
  begin
    ...
    if FilterValueContainer.FilterValueTypeClass <> nil then
      VarCast(Result, Result,
        FilterValueContainer.FilterValueTypeClass.GetVarType);
  end;
end;
...
begin
  ...
  Properties.IDefaultValuesProvider := FilterValueContainer.FilterProperties.
...
begin
  ...
  begin
    AMaskEditProperties := TcxCustomMaskEditProperties
      (FilterValueContainer.FilterProperties);
    Properties.AlwaysShowBlanksAndLiterals :=
      AMaskEditProperties.AlwaysShowBlanksAndLiterals;
...
begin
  ...
  try
    for I := AIndex to FilterValueContainer.DisplayValues.Count - 1 do
      Properties.Items.AddObject(FilterValueContainer.Values[I].Value,
        FilterValueContainer.Values[I]);
  finally
    Properties.Items.EndUpdate;
  end;
end;

function TdxExcelFilterValueContainerValuesComboBox.GetProperties
  : TdxExcelFilterValueContainerValuesComboBoxProperties;
begin
  Result := TdxExcelFilterValueContainerValuesComboBoxProperties
...
procedure TdxExcelFilterValueContainerValuesComboBox.SetProperties
  (Value: TdxExcelFilterValueContainerValuesComboBoxProperties);
begin
  inherited Properties := Value;
end;

procedure TdxExcelFilterValueContainerValuesComboBox.ValidateHandler
  (ASender: TObject; var ADisplayValue: TcxEditValue; var AErrorText: TCaption;
var AError: Boolean);
var
  AValue: Variant;
...
constructor TdxExcelFilterValueContainerDateValuesComboBox.Create
  (AFilterValueContainer: TdxExcelFilterValueContainer);
begin
  inherited Create(AFilterValueContainer);
  AddCalendarButton;
...
begin
  ...
  CalendarPopup.OwnerBounds := ViewInfo.ButtonsInfo
    [CalendarButton.Index].Bounds;
  PostMessage(CalendarPopup.Handle, DXM_SHOWPOPUPWINDOW, 0, 0);
end;

function TdxExcelFilterValueContainerDateValuesComboBox.CreateCalendar
  : TcxCustomCalendar;
begin
  Result := TcxCustomCalendar.Create(nil);
end;

function TdxExcelFilterValueContainerDateValuesComboBox.CreateCalendarPopup
...
function TdxExcelFilterValueContainerDateValuesComboBox.
  IsEditValueNumeric: Boolean;
begin
  Result := True;
end;

procedure TdxExcelFilterValueContainerDateValuesComboBox.ButtonClickHandler
...
procedure TdxExcelFilterValueContainerDateValuesComboBox.DateTimeChangedHandler
  (Sender: TObject);
begin
...
constructor TdxExcelFilterValueContainerCustomValuesComboBoxProvider.Create
  (AFilterValueContainer: TdxExcelFilterValueContainer);
begin
  inherited Create;
  FFilterValueContainer := AFilterValueContainer;
...
function TdxExcelFilterValueContainerCustomValuesComboBoxProvider.
  GetComboBoxFilterDisplayText: string;
begin
  Result := ComboBox.Text;
end;

function TdxExcelFilterValueContainerCustomValuesComboBoxProvider.
  GetComboBoxFilterValue: Variant;
begin
  Result := ComboBox.EditingValue;
end;

function TdxExcelFilterValueContainerCustomValuesComboBoxProvider.
  IsComboBoxEmpty: Boolean;
begin
  Result := VarIsSoftNull(ComboBox.EditingValue) and (ComboBox.ItemIndex = -1);
end;

procedure TdxExcelFilterValueContainerCustomValuesComboBoxProvider.
  UpdateComboBoxItems;
begin
  // do nothing
end;
...
function TdxExcelFilterValueContainerValuesComboBoxProvider.CreateComboBox
  : TcxCustomComboBox;
begin
  Result := TdxExcelFilterValueContainerValuesComboBox.Create
    (FilterValueContainer);
end;

function TdxExcelFilterValueContainerValuesComboBoxProvider.
  GetComboBoxFilterDisplayText: string;
begin
...
procedure TdxExcelFilterValueContainerValuesComboBoxProvider.
  UpdateComboBoxItems;
begin
  ComboBox.UpdateItems;
end;

function TdxExcelFilterValueContainerValuesComboBoxProvider.GetComboBox
  : TdxExcelFilterValueContainerValuesComboBox;
begin
...
function TdxExcelFilterValueContainerDateValuesComboBoxProvider.CreateComboBox
  : TcxCustomComboBox;
begin
  Result := TdxExcelFilterValueContainerDateValuesComboBox.Create
    (FilterValueContainer);
end;

{ TdxExcelFilterValueContainerImageValuesComboBoxProvider }

function TdxExcelFilterValueContainerImageValuesComboBoxProvider.CreateComboBox
  : TcxCustomComboBox;
begin
...
begin
  Properties.Items.BeginUpdate;
  try
    for AType := Low(TdxExcelFilterValueContainerConditionType)
      to High(TdxExcelFilterValueContainerConditionType) do
      if AType in SupportedConditionTypes then
        Properties.Items.AddObject(dxGetConditionTypeResourceCaption(AType),
          TObject(AType));
  finally
    Properties.Items.EndUpdate;
  end;
...
constructor TdxExcelFilterValueContainerCustomItem.Create(AFilterValueContainer
  : TdxExcelFilterValueContainer);
begin
  inherited Create;
  FFilterValueContainer := AFilterValueContainer;
...
procedure TdxExcelFilterValueContainerCustomItem.Generate
...
procedure TdxExcelFilterValueContainerCustomItem.DoGenerate
  (AParentGroup: TdxLayoutGroup);
begin
  FParentGroup := AParentGroup;
end;

procedure TdxExcelFilterValueContainerCustomItem.KeyDownHandler(Sender: TObject;
...
function TdxExcelFilterValueContainerCondition.GetBoolOperator
...
function TdxExcelFilterValueContainerCondition.GetOperator
...
procedure TdxExcelFilterValueContainerCondition.PopulateValueInfos
...
constructor TdxExcelFilterValueContainerCondition.Create(AFilterValueContainer
  : TdxExcelFilterValueContainer;
AConditionContainer: TdxExcelFilterValueContainerConditionContainer);
begin
  inherited Create(AFilterValueContainer);
...
procedure TdxExcelFilterValueContainerEditableCondition.EditChangeHandler
  (ASender: TObject);
var
  AEdit: TcxCustomEdit absolute ASender;
begin
...
procedure TdxExcelFilterValueContainerTextEditCondition.DoGenerate
  (AParentGroup: TdxLayoutGroup);
begin
...
procedure TdxExcelFilterValueContainerTextEditCondition.SetCaption
  (AValue: string);
begin
...
procedure TdxExcelFilterValueContainerComboBoxCondition.DoGenerate
  (AParentGroup: TdxLayoutGroup);
begin
  inherited DoGenerate(AParentGroup);
  GenerateComboBox;
...
begin
  ...
  FComboBoxLayoutItem := ParentGroup.CreateItemForControl
...
procedure TdxExcelFilterValueContainerComboBoxCondition.SetCaption
  (AValue: string);
begin
...
begin
  ...
  try
    ComboBoxProvider.ComboBox.EditValue :=
      ConditionContainer.ActiveCriteriaItems[0].Value;
  finally
...
procedure TdxExcelFilterValueContainerBetweenCondition.DoGenerate
  (AParentGroup: TdxLayoutGroup);
begin
  inherited DoGenerate(AParentGroup);
...
begin
  FFromComboBoxProvider :=
    FilterValueContainer.CreateFilterValuesComboBoxProvider;
  ...
  FFromLayoutItem := ParentGroup.CreateItemForControl
    (FromComboBoxProvider.ComboBox);
  FromLayoutItem.CaptionOptions.Text :=
    cxGetResourceString(@sdxExcelFilterFromValueText);
...
begin
  ...
  FToLayoutItem := ParentGroup.CreateItemForControl
    (ToComboBoxProvider.ComboBox);
  ToLayoutItem.CaptionOptions.Text :=
    cxGetResourceString(@sdxExcelFilterToValueText);
...
begin
  ...
  else if ToComboBoxProvider.IsComboBoxEmpty then
    Result := FromComboBoxProvider.GetComboBoxFilterDisplayText
  else if VarCompare(GetValueFrom, GetValueTo) < 0 then
    Result := FromComboBoxProvider.GetComboBoxFilterDisplayText + ';' +
      ToComboBoxProvider.GetComboBoxFilterDisplayText
  else
    Result := ToComboBoxProvider.GetComboBoxFilterDisplayText + ';' +
      FromComboBoxProvider.GetComboBoxFilterDisplayText;
end;

function TdxExcelFilterValueContainerBetweenCondition.GetOperator
  : TcxFilterOperatorKind;
begin
  if FromComboBoxProvider.IsComboBoxEmpty then
    Result := foLessEqual
...
begin
  Result := FromComboBoxProvider.IsComboBoxEmpty and
    ToComboBoxProvider.IsComboBoxEmpty;
end;

procedure TdxExcelFilterValueContainerBetweenCondition.UpdateData;
begin
  FromComboBoxProvider.UpdateComboBoxItems;
  ToComboBoxProvider.ComboBox.Properties.Items :=
    FromComboBoxProvider.ComboBox.Properties.Items;
  inherited UpdateData;
end;
...
procedure TdxExcelFilterValueContainerCounterCondition.
  CalculateFilterValueItemCount;
begin
  FFilterValueItemCount := FilterValueContainer.NonUniqueValues.Count;
end;

function TdxExcelFilterValueContainerCounterCondition.
  IsAppliedOnChoosing: Boolean;
begin
  Result := True;
end;
...
procedure TdxExcelFilterValueContainerCounterCondition.CalculateValues;
  ...
  begin
    if ValueTypeComboBox.ItemIndex = 0 then
      ...
      Result := (AIndex + 1) / FilterValueItemCount * 100 <=
        ValueSpinEdit.Value;
  end;
...
begin
  ...
  for I := 0 to FilterValueItemCount - 1 do
    ...
    begin
      ...
      AFilterValueItem := FilterValueContainer.NonUniqueValues
        [AFilterValueIndex];
      AFilterDisplayValue := FilterValueContainer.NonUniqueDisplayValues
        [AFilterValueIndex];
      if I = 0 then
      begin
...
procedure TdxExcelFilterValueContainerCounterCondition.DoGenerate
  (AParentGroup: TdxLayoutGroup);
begin
  inherited DoGenerate(AParentGroup);
...
begin
  ...
  ValueLayoutItem.CaptionOptions.Text :=
    cxGetResourceString(@sdxExcelFilterTopNBottomNValueLabel);
...
begin
  ...
  ValueTypeComboBox.Properties.Items.Add
    (cxGetResourceString(@sdxExcelFilterTopNBottomNItemsText));
  ValueTypeComboBox.Properties.Items.Add
    (cxGetResourceString(@sdxExcelFilterTopNBottomNPercentText));
  ...
  ValueTypeLayoutItem.CaptionOptions.Text :=
    cxGetResourceString(@sdxExcelFilterTopNBottomNTypeLabel);
...
function TdxExcelFilterValueContainerCounterCondition.GetOperator
  : TcxFilterOperatorKind;
begin
  Result := foInList;
end;
...
function TdxExcelFilterValueContainerCounterCondition.
  GetValueSpinEditMaxCount: Integer;
begin
  if ValueTypeComboBox.ItemIndex = 0 then
...
procedure TdxExcelFilterValueContainerCounterCondition.ValueTypeChangedHandler
  (ASender: TObject);
begin
  UpdateValueSpinEditMinMax;
  ValueChanged;
...
constructor TdxExcelFilterValueContainerSpecificDatePeriodsConditionPeriod.
  Create(AFilterValueContainer: TdxExcelFilterValueContainer);
begin
  inherited Create(AFilterValueContainer);
...
destructor
  TdxExcelFilterValueContainerSpecificDatePeriodsConditionPeriod.Destroy;
begin
...
function TdxExcelFilterValueContainerSpecificDatePeriodsConditionPeriod.
  AddCheckBox(AOperator: TcxFilterOperatorKind): TcxCheckBox;
begin
  Result := TcxCheckBox.Create(nil);
  Result.Tag := NativeInt(AOperator);
  Result.Caption := dxGetConditionTypeResourceCaption
    (dxConditionTypeByOperatorMap[AOperator]);
  Result.Transparent := True;
  CheckBoxList.Add(Result);
end;

procedure TdxExcelFilterValueContainerSpecificDatePeriodsConditionPeriod.
  DoGenerate(AParentGroup: TdxLayoutGroup);
begin
  inherited DoGenerate(AParentGroup);
  GenerateGroup;
  GenerateLayoutItems;
...
procedure TdxExcelFilterValueContainerSpecificDatePeriodsConditionPeriod.
  UpdateCheckBoxStates(AOperators: TcxFilterOperatorKinds);
var
  I: Integer;
begin
  for I := 0 to CheckBoxCount - 1 do
  begin
    ...
    try
      CheckBoxes[I].Checked := TcxFilterOperatorKind(CheckBoxes[I].Tag)
        in AOperators;
    finally
...
function TdxExcelFilterValueContainerSpecificDatePeriodsConditionPeriod.
  GetCheckBox(AIndex: Integer): TcxCheckBox;
begin
  Result := TcxCheckBox(CheckBoxList[AIndex]);
end;

function TdxExcelFilterValueContainerSpecificDatePeriodsConditionPeriod.
  GetCheckBoxCount: Integer;
begin
...
procedure TdxExcelFilterValueContainerSpecificDatePeriodsCondition.
  AddPeriodCheckBox(APeriod
  : TdxExcelFilterValueContainerSpecificDatePeriodsConditionPeriod;
...
function TdxExcelFilterValueContainerSpecificDatePeriodsCondition.CreatePeriod
  : TdxExcelFilterValueContainerSpecificDatePeriodsConditionPeriod;
begin
  Result := TdxExcelFilterValueContainerSpecificDatePeriodsConditionPeriod.
    Create(FilterValueContainer);
end;

procedure TdxExcelFilterValueContainerSpecificDatePeriodsCondition.DoGenerate
  (AParentGroup: TdxLayoutGroup);
begin
  inherited DoGenerate(AParentGroup);
  GenerateGroups;
...
function TdxExcelFilterValueContainerSpecificDatePeriodsCondition.
  GetBoolOperator: TcxFilterBoolOperatorKind;
begin
  Result := fboOr;
end;
...
function TdxExcelFilterValueContainerSpecificDatePeriodsCondition.GetOperator
  : TcxFilterOperatorKind;
var
  ACheckBox: TcxCheckBox;
...
procedure TdxExcelFilterValueContainerSpecificDatePeriodsCondition.
  PopulateValueInfos(AList: TdxFastObjectList);
var
  ACheckBox: TcxCheckBox;
  APeriodIndex, ACheckBoxIndex: Integer;
...
begin
  ...
  begin
    ...
    begin
      ...
      if ACheckBox.Checked then
      begin
        AInfo := TdxExcelFilterValueContainerValueInfo.Create(GetValue,
          GetDisplayText, TcxFilterOperatorKind(ACheckBox.Tag));
        AList.Add(AInfo);
      end;
    end;
  end;
...
procedure TdxExcelFilterValueContainerSpecificDatePeriodsCondition.
  UpdatePeriodCheckBoxStates(AOperators: TcxFilterOperatorKinds);
var
  I: Integer;
begin
  for I := 0 to PeriodCount - 1 do
...
procedure TdxExcelFilterValueContainerCustomFilterConditionAndOr.DoGenerate
  (AParentGroup: TdxLayoutGroup);
begin
  inherited DoGenerate(AParentGroup);
...
procedure TdxExcelFilterValueContainerCustomFilterConditionAndOr.
  GenerateAndRadioButton;
begin
  FAndRadioButton := TcxRadioButton.Create(nil);
  AndRadioButton.GroupIndex := 1;
  AndRadioButton.Caption := cxGetResourceString
...
begin
  ...
  OrRadioButton.Caption := cxGetResourceString
...
procedure TdxExcelFilterValueContainerCustomFilterCondition.DoGenerate
  (AParentGroup: TdxLayoutGroup);
begin
  inherited DoGenerate(AParentGroup);
...
procedure TdxExcelFilterValueContainerCustomFilterCondition.AndOrClickHandler
  (ASender: TObject);
begin
  ValueChanged;
end;

function TdxExcelFilterValueContainerCustomFilterCondition.
  CreateConditionContainer
  : TdxExcelFilterValueContainerCustomFilterConditionContainer;
begin
  Result := TdxExcelFilterValueContainerCustomFilterConditionContainer.Create
    (FilterValueContainer, Self);
end;
...
begin
  ...
  FAndOr := TdxExcelFilterValueContainerCustomFilterConditionAndOr.Create
    (FilterValueContainer);
...
procedure TdxExcelFilterValueContainerCustomFilterCondition.
  GenerateChildConditionContainer1;
begin
...
function TdxExcelFilterValueContainerCustomFilterCondition.GetBoolOperator
  : TcxFilterBoolOperatorKind;
begin
...
begin
  ...
  else if not ChildConditionContainer2.IsConditionEmpty then
    Result := ChildConditionContainer2.Condition.GetDisplayText
  else
    Result := inherited GetDisplayText;
end;

function TdxExcelFilterValueContainerCustomFilterCondition.GetOperator
  : TcxFilterOperatorKind;
begin
  if not ChildConditionContainer1.IsConditionEmpty then
...
function TdxExcelFilterValueContainerCustomFilterCondition.
  GetSupportedConditionTypes: TdxExcelFilterValueContainerConditionTypes;
begin
  case FilterValueContainer.GetDataType of
    fdtText:
      Result := [ctEquals .. ctIsNotBlank];
    fdtNumeric:
      Result := [ctEquals, ctDoesNotEqual,
        ctGreaterThan .. ctLessEqualThanOrEqualTo];
    fdtDate:
...
begin
  Result := not ChildConditionContainer1.IsConditionEmpty and
    not ChildConditionContainer2.IsConditionEmpty;
end;

function TdxExcelFilterValueContainerCustomFilterCondition.IsEmpty: Boolean;
begin
  Result := ChildConditionContainer1.IsConditionEmpty and
    ChildConditionContainer2.IsConditionEmpty;
end;

procedure TdxExcelFilterValueContainerCustomFilterCondition.
  PopulateActiveCriteriaItems(AContainer
  : TdxExcelFilterValueContainerCustomFilterConditionContainer);
var
...
begin
  ...
  else if AContainer = ChildConditionContainer1 then
    ACriteriaItem := ConditionContainer.ActiveCriteriaItems[0]
  else
    ACriteriaItem := nil;
...
procedure TdxExcelFilterValueContainerCustomFilterCondition.PopulateValueInfos
  (AList: TdxFastObjectList);
var
  AInfo: TdxExcelFilterValueContainerValueInfo;
begin
  AInfo := TdxExcelFilterValueContainerValueInfo.Create
    (ChildConditionContainer1.Condition.GetValue,
    ChildConditionContainer1.Condition.GetDisplayText,
    ChildConditionContainer1.Condition.GetOperator);
  AList.Add(AInfo);
  AInfo := TdxExcelFilterValueContainerValueInfo.Create
    (ChildConditionContainer2.Condition.GetValue,
    ChildConditionContainer2.Condition.GetDisplayText,
    ChildConditionContainer2.Condition.GetOperator);
  AList.Add(AInfo);
end;

procedure TdxExcelFilterValueContainerCustomFilterCondition.SetAndOrClickHandler
  (AEvent: TNotifyEvent);
begin
...
procedure TdxExcelFilterValueContainerCustomFilterCondition.
  SetAndOrKeyDownHandler(AEvent: TKeyEvent);
begin
...
begin
  inherited UpdateData;
  ChildConditionContainer1.SupportedConditionTypes :=
    GetSupportedConditionTypes;
  ChildConditionContainer2.SupportedConditionTypes :=
    GetSupportedConditionTypes;
  ChildConditionContainer1.UpdateData;
  ChildConditionContainer2.UpdateData;
  ChildConditionContainer1.SetCaption
    (cxGetResourceString(@sdxExcelFilterCustomFilterFirstConditionLabel));
  ChildConditionContainer2.SetCaption
    (cxGetResourceString(@sdxExcelFilterCustomFilterSecondConditionLabel));
end;
...
begin
  ...
  try
    AndOr.OrRadioButton.Checked :=
      ConditionContainer.ActiveBoolOperator = fboOr;
    AndOr.AndRadioButton.Checked :=
      ConditionContainer.ActiveBoolOperator = fboAnd;
  finally
    SetAndOrClickHandler(AndOrClickHandler);
  end;
end;
...
constructor TdxExcelFilterValueContainerConditionContainer.Create
  (AFilterValueContainer: TdxExcelFilterValueContainer);
begin
  inherited Create(AFilterValueContainer);
  FActiveCriteriaItems := TList<TcxFilterCriteriaItem>.Create;
  FCustomFilterConditionClass :=
    TdxExcelFilterValueContainerCustomFilterCondition;
...
begin
  ...
  else if Condition.IsComplex then
  begin
    AValueInfos := TdxFastObjectList.Create;
    try
      Condition.PopulateValueInfos(AValueInfos);
      FilterValueContainer.SetFilterActiveValues(AValueInfos,
        Condition.GetBoolOperator);
    finally
      AValueInfos.Free;
    end;
  end
  else
    FilterValueContainer.SetFilterActiveValue(Condition.GetOperator,
      Condition.GetValue, Condition.GetDisplayText);
...
procedure TdxExcelFilterValueContainerConditionContainer.DoGenerate
  (AParentGroup: TdxLayoutGroup);
begin
  inherited DoGenerate(AParentGroup);
  GenerateLayoutGroup;
...
begin
  case GetConditionType of
    ctEquals, ctDoesNotEqual, ctGreaterThan .. ctLessEqualThanOrEqualTo,
      ctBefore, ctAfter:
...
procedure TdxExcelFilterValueContainerConditionContainer.
  GenerateConditionTypeComboBox;
begin
  FConditionTypeComboBox := TdxExcelFilterValueContainerConditionTypesComboBox.
    Create(nil);
  ...
  FConditionTypeLayoutItem := LayoutGroup.CreateItemForControl
...
begin
  ...
  if not AHasActiveCondition then
    Exit;
  if (FilterValueContainer.GetDataType = fdtDate) and
    (ActiveCriteriaItems.First.OperatorKind in dxDatePeriodOperators) then
    Result := ctSpecificDatePeriods
  else if ActiveCriteriaItems.Count = 2 then
    if IsActiveCriteriaItemsContainBetweenCondition then
      Result := ctBetween
    else
      Result := ctCustomFilter
  else if ActiveCriteriaItems.Count = 1 then
    Result := dxGetConditionTypeByOperator(ActiveCriteriaItems[0].OperatorKind,
      ActiveCriteriaItems[0].Value);
end;

function TdxExcelFilterValueContainerConditionContainer.GetConditionType
  : TdxExcelFilterValueContainerConditionType;
begin
  Result := TdxExcelFilterValueContainerConditionType
    (ConditionTypeComboBox.ItemObject);
end;

function TdxExcelFilterValueContainerConditionContainer.
  GetConditionTypeItemIndex(AConditionType
  : TdxExcelFilterValueContainerConditionType): Integer;
begin
  Result := ConditionTypeComboBox.Properties.Items.IndexOfObject
    (TObject(AConditionType));
end;

function TdxExcelFilterValueContainerConditionContainer.
  GetDefaultConditionTypeIndex: Integer;
begin
  Result := 0;
end;

function TdxExcelFilterValueContainerConditionContainer.
  HasSelectedConditionType: Boolean;
begin
  Result := ConditionTypeComboBox.ItemIndex <> -1;
end;

function TdxExcelFilterValueContainerConditionContainer.
  IsActiveCriteriaItemsContainBetweenCondition: Boolean;
begin
  Result := (ActiveCriteriaItems.Count > 0) and
    ((ActiveCriteriaItems[0].OperatorKind = foBetween) or
    (FilterValueContainer.GetDataType in [fdtNumeric, fdtTime]) and
    (ActiveBoolOperator = fboAnd) and
    ((ActiveCriteriaItems[0].OperatorKind = foLessEqual) and
    (ActiveCriteriaItems[1].OperatorKind = foGreaterEqual) or
    (ActiveCriteriaItems[0].OperatorKind = foGreaterEqual) and
    (ActiveCriteriaItems[1].OperatorKind = foLessEqual)));
end;

function TdxExcelFilterValueContainerConditionContainer.
  IsConditionPresentInFilter: Boolean;
var
...
begin
  ...
  ASelectedType := TdxExcelFilterValueContainerConditionType
    (ConditionTypeComboBox.ItemObject);
  Result := AHasActiveCondition and
    ((ASelectedType = AActiveType) or (ASelectedType = ctCustomFilter) and
    (AActiveType in [ctEquals .. ctIsNotBlank,
    ctGreaterThan .. ctLessEqualThanOrEqualTo]));
end;
...
procedure TdxExcelFilterValueContainerConditionContainer.KeyDownHandler
  (Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
function TdxExcelFilterValueContainerConditionContainer.
  PopulateActiveCriteriaItems(AItemList: TcxFilterCriteriaItemList): Boolean;
begin
...
procedure TdxExcelFilterValueContainerConditionContainer.SetCaption
  (AValue: string);
begin
...
begin
  ...
  else if not HasSelectedConditionType then
...
procedure TdxExcelFilterValueContainerConditionContainer.
  ConditionTypeChangedHandler(Sender: TObject);
begin
  RegenerateCondition;
  UpdateConditionCaption;
...
function TdxExcelFilterValueContainerConditionContainer.
  PopulateActiveCriteriaItemsByAndItemList
  (AItemList: TcxFilterCriteriaItemList): Boolean;
var
  I, ACount: Integer;
  ...
  begin
    ...
    begin
      ...
      begin
        Inc(ACount);
        Result := True;
        AConditionType := dxGetConditionTypeByOperator(AFilterItem.OperatorKind,
          AFilterItem.Value);
        if (AFilterItem.OperatorKind = dxOperatorByConditionTypeMap
          [AConditionType]) and (AConditionType in SupportedConditionTypes) then
          if ACount > 2 then
          begin
            ActiveCriteriaItems.Clear;
...
function TdxExcelFilterValueContainerConditionContainer.
  PopulateActiveCriteriaItemsByOrItemList
  (AItemList: TcxFilterCriteriaItemList): Boolean;
var
  I: Integer;
...
begin
  Result := False;
  if (AItemList.Count > 2) and (FilterValueContainer.GetDataType <> fdtDate)
  then
    Exit;
  ...
  begin
    ...
    begin
      ...
      begin
        AConditionType := dxGetConditionTypeByOperator(AFilterItem.OperatorKind,
          AFilterItem.Value);
        ABreak := (AFilterItem.OperatorKind <> dxOperatorByConditionTypeMap
          [AConditionType]) or not(AConditionType in SupportedConditionTypes);
        if not ABreak then
        begin
          AHasNonPeriodItem := AHasNonPeriodItem or
            (FilterValueContainer.GetDataType <> fdtDate) or
...
procedure TdxExcelFilterValueContainerConditionContainer.
  SetSupportedConditionTypes(const AValue
  : TdxExcelFilterValueContainerConditionTypes);
begin
...
constructor TdxExcelFilterValueContainerCustomFilterConditionContainer.Create
  (AFilterValueContainer: TdxExcelFilterValueContainer;
ACustomFilterCondition: TdxExcelFilterValueContainerCustomFilterCondition);
begin
  inherited Create(AFilterValueContainer);
  FCustomFilterCondition := ACustomFilterCondition;
end;

procedure TdxExcelFilterValueContainerCustomFilterConditionContainer.
  ApplyFilter;
begin
  CustomFilterCondition.ConditionContainer.ApplyFilter;
end;

function TdxExcelFilterValueContainerCustomFilterConditionContainer.
  PopulateActiveCriteriaItems(AItemList: TcxFilterCriteriaItemList): Boolean;
begin
...
function TdxExcelFilterValueContainerRangeModeValuesPageBetween.CreateEdit
  : TcxCustomEdit;
begin
  Result := FilterValueContainer.CreateFilterEdit;
end;

procedure TdxExcelFilterValueContainerRangeModeValuesPageBetween.DoGenerate
  (AParentGroup: TdxLayoutGroup);
begin
  inherited DoGenerate(AParentGroup);
  GenerateFromEdit;
...
procedure TdxExcelFilterValueContainerRangeModeValuesPageBetween.
  GenerateFromEdit;
begin
...
procedure TdxExcelFilterValueContainerRangeModeValuesPageBetween.UpdateEditValue
  (AEdit: TcxCustomEdit; AValue: Variant);
begin
...
procedure TdxExcelFilterValueContainerRangeModeValuesPageBetween.
  FromEditChangeHandler(ASender: TObject);
var
  AError: Boolean;
  AErrorText: TCaption;
...
begin
  ...
  FromEdit.GetProperties.ValidateDisplayValue(ADisplayValue, AErrorText, AError,
    FromEdit);
  if not AError then
  begin
    if FilterValueContainer.FilterValueTypeClass <> nil then
      VarCast(FFromValue, FromEdit.EditingValue,
        FilterValueContainer.FilterValueTypeClass.GetVarType)
    else
...
procedure TdxExcelFilterValueContainerRangeModeValuesPageBetween.
  FromEditValidateHandler(ASender: TObject; var ADisplayValue: TcxEditValue;
var AErrorText: TCaption; var AError: Boolean);
var
  AValue: Variant;
begin
  ...
  else if VarCompare(AValue, Owner.ToValue) > 0 then
  begin
...
procedure TdxExcelFilterValueContainerRangeModeValuesPageBetween.
  ToEditChangeHandler(ASender: TObject);
var
  AError: Boolean;
  AErrorText: TCaption;
  ADisplayValue: Variant;
begin
  ...
  ToEdit.GetProperties.ValidateDisplayValue(ADisplayValue, AErrorText,
    AError, ToEdit);
  if not AError then
  begin
    if FilterValueContainer.FilterValueTypeClass <> nil then
      VarCast(FToValue, ToEdit.EditingValue,
        FilterValueContainer.FilterValueTypeClass.GetVarType)
    else
...
procedure TdxExcelFilterValueContainerRangeModeValuesPageBetween.
  ToEditValidateHandler(ASender: TObject; var ADisplayValue: TcxEditValue;
var AErrorText: TCaption; var AError: Boolean);
var
  AValue: Variant;
begin
  ToEdit.PrepareEditValue(ADisplayValue, AValue, True);
  AError := AError or not FilterValueContainer.IsEditValueValid(AValue) or
    (VarCompare(AValue, Owner.FromValue) < 0);
  if AError then
...
procedure TdxExcelFilterValueContainerSearchableValuesPage.DoGenerate
  (AParentGroup: TdxLayoutGroup);
begin
  inherited DoGenerate(AParentGroup);
  GenerateSearchEdit;
...
procedure TdxExcelFilterValueContainerSearchableValuesPage.KeyDownHandler
  (Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited KeyDownHandler(Sender, Key, Shift);
...
procedure TdxExcelFilterValueContainerSearchableValuesPage.SearchEditKeyDown
  (var Key: Word; Shift: TShiftState);
begin
...
procedure TdxExcelFilterValueContainerSearchableValuesPage.
  SearchEditValueChanged(ASender: TObject);
begin
...
procedure TdxExcelFilterValueContainerSearchableValuesPage.OnDelayedSearchTimer
  (Sender: TObject);
begin
  SearchTextChanged;
end;
...
procedure TdxExcelFilterValueContainerListBoxModeValuesPage.DoGenerate
  (AParentGroup: TdxLayoutGroup);
begin
  inherited DoGenerate(AParentGroup);
  GenerateListBox;
...
destructor
  TdxExcelFilterValueContainerCustomDateTimeTreeViewModeValuesPage.Destroy;
begin
  FreeAndNil(FTreeView);
  inherited Destroy;
end;

procedure TdxExcelFilterValueContainerCustomDateTimeTreeViewModeValuesPage.
  ApplyFilter;
begin
  inherited ApplyFilter;
...
function TdxExcelFilterValueContainerCustomDateTimeTreeViewModeValuesPage.
  CreateTreeView: TdxExcelFilterValueContainerCustomDateTimeTreeView;
begin
  Result := TdxExcelFilterValueContainerCustomDateTimeTreeView.Create
    (FilterValueContainer);
end;
...
function TdxExcelFilterValueContainerDateTreeViewModeValuesPage.CreateTreeView
  : TdxExcelFilterValueContainerCustomDateTimeTreeView;
begin
  Result := TdxExcelFilterValueContainerDateTimeTreeView.Create
    (FilterValueContainer);
end;

{ TdxExcelFilterValueContainerTimeTreeViewModeValuesPage }

function TdxExcelFilterValueContainerTimeTreeViewModeValuesPage.CreateTreeView
  : TdxExcelFilterValueContainerCustomDateTimeTreeView;
begin
  Result := TdxExcelFilterValueContainerTimeTreeView.Create
    (FilterValueContainer);
end;
...
begin
  ...
  AValueInfos := TdxFastObjectList.Create;
  try
    AInfo := TdxExcelFilterValueContainerValueInfo.Create(FromValue,
      GetDisplayTextByValue(FromValue), foGreaterEqual);
    AValueInfos.Add(AInfo);
    AInfo := TdxExcelFilterValueContainerValueInfo.Create(ToValue,
      GetDisplayTextByValue(ToValue), foLessEqual);
    AValueInfos.Add(AInfo);
...
procedure TdxExcelFilterValueContainerRangeModeValuesPage.DoGenerate
  (AParentGroup: TdxLayoutGroup);
begin
  inherited DoGenerate(AParentGroup);
  GenerateFromToGroup;
...
begin
  FBetweenValues := TdxExcelFilterValueContainerRangeModeValuesPageBetween.
    Create(FilterValueContainer, Self);
...
begin
  ...
  RangeTrackBar.GetViewInfo.PositionHintHelper.SetDelay
    (dxRangeTrackBarHintDelay);
  ...
  RangeTrackBar.Properties.OnGetPositionHint :=
    RangeTrackBarGetPositionHintHandler;
  FRangeLayoutItem := ParentGroup.CreateItemForControl(RangeTrackBar);
  RangeLayoutItem.AlignHorz := ahClient;
end;

function TdxExcelFilterValueContainerRangeModeValuesPage.GetDisplayTextByValue
  (AValue: Variant): string;
begin
  Result := FilterValueContainer.GetDisplayTextByValue(AValue);
end;

function TdxExcelFilterValueContainerRangeModeValuesPage.
  GetRangeTrackBarFrequency: Integer;
var
  ARange: Integer;
begin
...
function TdxExcelFilterValueContainerRangeModeValuesPage.
  GetRangeTrackBarRangeMax: Integer;
begin
  Result := MapValueToRangeTrackBarValue(ToValue);
end;

function TdxExcelFilterValueContainerRangeModeValuesPage.
  GetRangeTrackBarRangeMin: Integer;
begin
  Result := MapValueToRangeTrackBarValue(FromValue);
end;

function TdxExcelFilterValueContainerRangeModeValuesPage.
  IsLargeIntNumeric: Boolean;
begin
...
function TdxExcelFilterValueContainerRangeModeValuesPage.
  IsSimpleNumeric: Boolean;
begin
  Result := (FilterValueContainer.FilterValueTypeClass <> nil) and
    (FilterValueContainer.FilterValueTypeClass.GetVarType in [varSmallint,
    varInteger, varByte, varShortInt, varWord, varLongWord]);
end;

procedure TdxExcelFilterValueContainerRangeModeValuesPage.KeyDownHandler
  (Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
function TdxExcelFilterValueContainerRangeModeValuesPage.
  MapRangeTrackBarValueToValue(AValue: Integer): Variant;
var
  ADigit: Integer;
  AMapValue: Variant;
begin
  if IsSimpleNumeric then
    Result := AValue
  else if (AValue = GetRangeTrackBarMax) or
    (GetRangeTrackBarMax = GetRangeTrackBarMin) then
    Result := MaxValue
  else if AValue = GetRangeTrackBarMin then
    Result := MinValue
  else
  begin
    AMapValue := (AValue - GetRangeTrackBarMin) * (MaxValue - MinValue) /
      (GetRangeTrackBarMax - GetRangeTrackBarMin) + MinValue;
...
function TdxExcelFilterValueContainerRangeModeValuesPage.
  MapValueToRangeTrackBarValue(AValue: Variant): Integer;
var
  AMapValue: Variant;
begin
  if IsSimpleNumeric then
    Result := AValue
  else if (CompareValue(AValue, MaxValue) = 0) or
    (CompareValue(MaxValue, MinValue) = 0) then
    Result := GetRangeTrackBarMax
  else if (CompareValue(AValue, MinValue) = 0) then
    Result := GetRangeTrackBarMin
  else
  begin
    AMapValue := (AValue - MinValue) *
      (GetRangeTrackBarMax - GetRangeTrackBarMin) / (MaxValue - MinValue) +
      GetRangeTrackBarMin;
    Result := Round(AMapValue);
  end;
end;

procedure TdxExcelFilterValueContainerRangeModeValuesPage.SetValues(AFromValue,
  AToValue: Variant);
begin
...
procedure TdxExcelFilterValueContainerRangeModeValuesPage.UpdateFromToValues;
  ...
  begin
    ...
    for I := 0 to AParent.Count - 1 do
      if not AParent.Items[I].IsItemList and (AParent.Items[I] <> AItem) and
        (TcxFilterCriteriaItem(AParent.Items[I])
        .ItemLink = FilterValueContainer.FilterItemLink) then
      begin
        Result := False;
        Break;
      end;
  ...
  function IsBetweenCondition(AItem: TcxFilterCriteriaItem;
  out AValue1, AValue2: Variant): Boolean;
  var
    I: Integer;
  ...
  begin
    ...
    begin
      ...
      if (AValueItem = AItem) or
        (AValueItem.ItemLink <> FilterValueContainer.FilterItemLink) then
        Continue;
      Result := not Result and
        (AItem.OperatorKind in [foGreater, foGreaterEqual]) and
        (AValueItem.OperatorKind in [foLess, foLessEqual]) or
        (AItem.OperatorKind in [foLess, foLessEqual]) and
        (AValueItem.OperatorKind in [foGreater, foGreaterEqual]);
      if Result then
...
begin
  FFromValue := MinValue;
  FToValue := MaxValue;
  AItem := FilterValueContainer.Filter.FindItemByItemLink
    (FilterValueContainer.FilterItemLink);
  if AItem = nil then
    Exit;
...
procedure TdxExcelFilterValueContainerRangeModeValuesPage.
  RangeTrackBarGetPositionHintHandler(Sender: TObject;
const AMinPosition, AMaxPosition: Integer; var AHintText: string;
var ACanShow, AIsHintMultiLine: Boolean);
var
  AFromValue, AToValue: Variant;
begin
  ...
  AHintText := cxGetResourceString(@sdxExcelFilterFromValueText) + ' ' +
    GetDisplayTextByValue(AFromValue) + ' ' + cxGetResourceString
    (@sdxExcelFilterToValueText) + ' ' + GetDisplayTextByValue(AToValue);
end;

procedure TdxExcelFilterValueContainerRangeModeValuesPage.
  RangeTrackBarMouseDownHandler(Sender: TObject; Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
begin
  BeginTracking;
end;
...
procedure TdxExcelFilterValueContainerRangeModeValuesPage.
  RangeTrackBarMouseUpHandler(Sender: TObject; Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
begin
  EndTracking;
end;
...
procedure TdxExcelFilterValueContainerRangeModeValuesPage.
  RangeTrackBarValueChangedHandler(AValue: TObject);
begin
  TrackValuesChanged;
end;
...
procedure TdxExcelFilterValueContainerFiltersPage.DoGenerate
  (AParentGroup: TdxLayoutGroup);
begin
  inherited DoGenerate(AParentGroup);
...
begin
  FConditionContainer := TdxExcelFilterValueContainerConditionContainer.Create
    (FilterValueContainer);
  ConditionContainer.Generate(ParentGroup);
end;

function TdxExcelFilterValueContainerFiltersPage.GetSupportedConditionTypes
  : TdxExcelFilterValueContainerConditionTypes;
begin
  case FilterValueContainer.GetDataType of
    fdtText:
    ...
    fdtNumeric:
      Result := [ctEquals, ctDoesNotEqual, ctBetween .. ctBelowAverage,
        ctCustomFilter];
    fdtDate:
      Result := [ctSpecificDatePeriods .. ctDoesNotEqual, ctBetween,
        ctBefore .. ctCustomFilter];
    fdtTime:
      Result := [ctEquals, ctDoesNotEqual,
        ctBetween .. ctLessEqualThanOrEqualTo, ctCustomFilter];
  else
    Result := [];
  end;
end;
...
procedure TdxExcelFilterValueContainerLayout.DoGenerate
  (AParentGroup: TdxLayoutGroup);
begin
  inherited DoGenerate(AParentGroup);
  GeneratePageGroups;
...
function TdxExcelFilterValueContainerLayout.GetActivePage
  : TdxExcelFilterValueContainerCustomPage;
begin
  Result := nil;
end;
...
procedure TdxExcelFilterValueContainerLayout.TabChangedHandler
  (ASender: TObject);
begin
  TabChanged;
end;
...
procedure TdxExcelFilterValueContainerCustomValuesLayout.
  GenerateValuesPageGroup;
begin
...
function TdxExcelFilterValueContainerCustomValuesLayout.GetActivePage
  : TdxExcelFilterValueContainerCustomPage;
begin
...
function TdxExcelFilterValueContainerCustomValuesLayout.
  GetDefaultPageIndex: Integer;
begin
  Result := ValuesPageGroup.Index;
end;

function TdxExcelFilterValueContainerCustomValuesLayout.
  GetValuesPageCaption: string;
begin
...
function TdxExcelFilterValueContainerCustomValuesAndFiltersLayout.
  CreateFiltersPage: TdxExcelFilterValueContainerFiltersPage;
begin
  Result := TdxExcelFilterValueContainerFiltersPage.Create
    (FilterValueContainer);
end;

procedure TdxExcelFilterValueContainerCustomValuesAndFiltersLayout.
  DestroyPageGroups;
begin
...
function TdxExcelFilterValueContainerCustomValuesAndFiltersLayout.GetActivePage
  : TdxExcelFilterValueContainerCustomPage;
begin
...
function TdxExcelFilterValueContainerCustomValuesAndFiltersLayout.
  GetDefaultPageIndex: Integer;
begin
  if (FilterValueContainer.DefaultPage = dpFilters) or
    (FilterValueContainer.DefaultPage = dpDefault) and
...
function TdxExcelFilterValueContainerCheckModeLayout.CreateValuesPage
  : TdxExcelFilterValueContainerCustomValuesPage;
begin
  Result := TdxExcelFilterValueContainerListBoxModeValuesPage.Create
    (FilterValueContainer);
end;

{ TdxExcelFilterValueContainerLookupModeLayout }

function TdxExcelFilterValueContainerLookupModeLayout.CreateValuesPage
  : TdxExcelFilterValueContainerCustomValuesPage;
begin
  Result := TdxExcelFilterValueContainerListBoxModeValuesPage.Create
    (FilterValueContainer);
...
function TdxExcelFilterValueContainerDateTreeViewModeLayout.CreateValuesPage
  : TdxExcelFilterValueContainerCustomValuesPage;
begin
  Result := TdxExcelFilterValueContainerDateTreeViewModeValuesPage.Create
    (FilterValueContainer);
end;

function TdxExcelFilterValueContainerDateTreeViewModeLayout.
  GetFiltersPageCaption: string;
begin
...
function TdxExcelFilterValueContainerTimeTreeViewModeLayout.CreateValuesPage
  : TdxExcelFilterValueContainerCustomValuesPage;
begin
  Result := TdxExcelFilterValueContainerTimeTreeViewModeValuesPage.Create
    (FilterValueContainer);
end;

function TdxExcelFilterValueContainerTimeTreeViewModeLayout.
  GetFiltersPageCaption: string;
begin
...
function TdxExcelFilterValueContainerListBoxModeLayout.CreateValuesPage
  : TdxExcelFilterValueContainerCustomValuesPage;
begin
  Result := TdxExcelFilterValueContainerListBoxModeValuesPage.Create
    (FilterValueContainer);
...
function TdxExcelFilterValueContainerListBoxModeLayout.
  GetFiltersPageCaption: string;
begin
  case FilterValueContainer.GetDataType of
    fdtDate:
...
function TdxExcelFilterValueContainerRangeModeLayout.CreateValuesPage
  : TdxExcelFilterValueContainerCustomValuesPage;
begin
  Result := TdxExcelFilterValueContainerRangeModeValuesPage.Create
    (FilterValueContainer);
end;

function TdxExcelFilterValueContainerRangeModeLayout.
  GetFiltersPageCaption: string;
begin
  Result := cxGetResourceString(@sdxExcelFilterNumericFiltersTabCaption);
end;
...
begin
  ...
  begin
    ...
    FFilterHelper := FilterEditsController.FindHelper
      (FilterProperties.ClassType);
...
function TdxExcelFilterValueContainer.GetDateTimeValuesPageType
  : TdxExcelFilterValueContainerDateTimeValuesPageType;
begin
  if (DateTimeValuesPageType = dvptList) or
    (DateTimeValuesPageType = dvptDefault) and
...
function TdxExcelFilterValueContainer.GetDisplayTextByValue
  (AValue: Variant): string;
begin
  Result := FilterProperties.GetDisplayText(AValue);
end;

function TdxExcelFilterValueContainer.GetListBoxClass
  : TdxExcelFilterValueContainerListBoxClass;
begin
  Result := TdxExcelFilterValueContainerListBox;
end;

function TdxExcelFilterValueContainer.GetNumericValuesPageType
  : TdxExcelFilterValueContainerNumericValuesPageType;
begin
  if (NumericValuesPageType = nvptList) or (NumericValuesPageType = nvptDefault)
    and (dxDefaultExcelFilterValueContainerNumericValuesPageType = nvptList)
  then
    Result := nvptList
  else
    Result := nvptRange;
...
function TdxExcelFilterValueContainer.IsEditValueValid
  (var AValue: Variant): Boolean;
begin
  Result := not VarIsNull(AValue) and
    ((FilterValueTypeClass = nil) or FilterHelper.IsValueValid
    (FilterValueTypeClass, AValue));
end;

function TdxExcelFilterValueContainer.IsLinkComponentSupported
  (AValue: TComponent): Boolean;
begin
  Result := inherited IsLinkComponentSupported(AValue) and
    Supports(AValue, IdxExcelFilterableComponent);
end;

procedure TdxExcelFilterValueContainer.KeyDown(var Key: Word;
Shift: TShiftState);
begin
...
procedure TdxExcelFilterValueContainer.LayoutKeyDown(ASender: TObject;
var Key: Word; Shift: TShiftState);
begin
  // do nothing
end;
...
begin
  Result := (ApplyChanges = efacImmediately) or (ApplyChanges = efacDefault) and
    (dxDefaultExcelFilterValueContainerApplyChanges in [efacDefault,
    efacImmediately]);
end;
...
begin
  FilterableComponent.PopulateFilterValues(FNonUniqueValues,
    FNonUniqueDisplayValues, True, False);
end;
...
procedure TdxExcelFilterValueContainer.SetFilterActiveValue
  (AOperatorKind: TcxFilterOperatorKind; const AValue: Variant;
const ADisplayText: string);
begin
  BeforeFilterChange;
  try
    FilterableComponent.SetFilterActiveValue(AOperatorKind, AValue,
      ADisplayText);
  finally
    AfterFilterChange;
  end;
...
procedure TdxExcelFilterValueContainer.SetFilterActiveValues
...
function TdxExcelFilterValueContainer.CreateFilterValuesComboBoxProvider
  : TdxExcelFilterValueContainerCustomValuesComboBoxProvider;
begin
  if GetDataType = fdtDate then
    Result := TdxExcelFilterValueContainerDateValuesComboBoxProvider.
      Create(Self)
  else if FilterProperties is TcxCustomImageComboBoxProperties then
    Result := TdxExcelFilterValueContainerImageValuesComboBoxProvider.
      Create(Self)
  else
    Result := TdxExcelFilterValueContainerValuesComboBoxProvider.Create(Self);
end;

function TdxExcelFilterValueContainer.CreateLayout
  : TdxExcelFilterValueContainerCustomValuesLayout;
begin
  case GetType of
    ctRange:
...
function TdxExcelFilterValueContainer.CreateLayoutLookAndFeel
  : TdxLayoutCxLookAndFeel;
begin
  Result := TdxLayoutCxLookAndFeel.Create(nil);
end;

procedure TdxExcelFilterValueContainer.SetApplyChanges
  (AValue: TdxExcelFilterValueContainerApplyChangesMode);
begin
...
function TdxExcelFilterValueContainer.GetFilterHelper
  : TcxCustomFilterEditHelperClass;
begin
...
function TdxExcelFilterValueContainer.GetFilterableComponent
  : IdxExcelFilterableComponent;
begin
...
procedure TdxExcelFilterValueContainer.SetDateTimeValuesPageType
...
procedure TdxExcelFilterValueContainer.SetDefaultPage
  (AValue: TdxExcelFilterValueContainerDefaultPage);
begin
...
procedure TdxExcelFilterValueContainer.SetNumericValuesPageType
...
procedure TdxExcelFilterValueContainer.LayoutControlKeyDownHandler
  (Sender: TObject; var Key: Word; Shift: TShiftState);
begin
