...
uses
  ...
  dxLayoutControlAdapters, dxLayoutContainer, cxCheckBox, dxLayoutControl,
...
type
  ...
  TcxGridWizardCardViewOptionsBehaviorPageFrame = class
...
begin
  ...
  lbRowOptions.Caption := cxGetResourceString
    (@scxgwBehaviorPageCardViewRowOptions);
  ...
  chbCardExpanding.Caption := cxGetResourceString
    (@scxgwBehaviorPageCardViewCardExpanding);
  chbCardExpanding.Hint := cxGetResourceString
    (@scxgwBehaviorPageCardViewCardExpandingHint);

  chbRowExpanding.Caption := cxGetResourceString
    (@scxgwBehaviorPageCardViewRowExpanding);
  chbRowExpanding.Hint := cxGetResourceString
    (@scxgwBehaviorPageCardViewRowExpandingHint);

  chbExpandRowOnDblClick.Caption :=
    cxGetResourceString(@scxgwBehaviorPageCardViewExpandRowOnDblClick);
  chbExpandRowOnDblClick.Hint := cxGetResourceString
  ...
  chbRowHiding.Caption := cxGetResourceString
    (@scxgwBehaviorPageCardViewRowHiding);
  chbRowHiding.Hint := cxGetResourceString
    (@scxgwBehaviorPageCardViewRowHidingHint);

  chbRowMoving.Caption := cxGetResourceString
    (@scxgwBehaviorPageCardViewRowMoving);
  chbRowMoving.Hint := cxGetResourceString
    (@scxgwBehaviorPageCardViewRowMovingHint);

  cbIncSearch.Caption := cxGetResourceString
    (@scxgwFilteringSortingPageIncSearch);
  cbIncSearch.Hint := cxGetResourceString
...
function TcxGridWizardCardViewOptionsBehaviorPageFrame.
...
procedure TcxGridWizardCardViewOptionsBehaviorPageFrame.RefreshPreviewGrid
  (Sender: TObject);
begin
