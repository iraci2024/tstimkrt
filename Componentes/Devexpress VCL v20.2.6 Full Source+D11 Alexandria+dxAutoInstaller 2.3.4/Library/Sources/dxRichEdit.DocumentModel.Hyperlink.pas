...
uses
  SysUtils, Generics.Defaults, Generics.Collections, Classes, Contnrs,
  dxCoreClasses,
...
type
  ...
  TdxTextToDisplaySource = (ExistingText, NewText);

  { TdxHyperlinkInfo }

  TdxHyperlinkInfo = class(TdxCloneable)
  strict private
    class var FEmpty: TdxHyperlinkInfo;
  strict private
    FAnchor: string;
    FNavigateUri: string;
    FTarget: string;
  ...
  public
    ...
    function TryGetHyperlinkInfo(AFieldIndex: Integer;
      var AInfo: TdxHyperlinkInfo): Boolean;
    // for internal use
    procedure RecalcKeys(AFrom: Integer; ADeltaIndex: Integer); virtual;

    property Count: Integer read GetCount;
    property Items[AFieldIndex: Integer]: TdxHyperlinkInfo read GetItem
  ...
  strict protected
  type
    TGetSwitchValue = reference to function
      (ABuilder: TdxHyperlinkInstructionBuilder): string;
  ...
  strict private
    ...
    class function GetAnchor(ABuilder: TdxHyperlinkInstructionBuilder)
      : string; static;
    class function GetTarget(ABuilder: TdxHyperlinkInstructionBuilder)
      : string; static;
    class function GetToolTip(ABuilder: TdxHyperlinkInstructionBuilder)
      : string; static;
  protected
  ...
  const
    FileNamePattern =
      '^file:[\\/]*(?<path>(?<root>[A-Za-z]:[\\/]+)?[^:\*\?<>\|]+)$';
    UrlPattern =
      '^((?<prefix>http|https|ftp|news)\:[\\/]*)(?<url>[a-zA-Z0-9\-\.]+(\.[a-zA-Z]{2,3})?(\:\d{1,5})?([\\/]\S*)?)$';
    ...
    SlashPattern = '[\\/]+';
  public
    class function EscapeHyperlinkFieldParameterString(const AValue: string)
      : string; static;
    class function ConvertToHyperlinkUri(const AUri: string): string; static;
    class function PrepareHyperlinkTooltipQuotes(const AValue: string)
      : string; static;
    ...
    class function EnsureRelativePathIsValid(const AUri: string)
      : string; static;
    class function ConvertRelativePathToAbsolute(const AUri: string;
      const ABaseUri: string): string; static;
    ...
    class function IsMatch(const AUri: string; const APattern: string)
      : Boolean; static;
    class function Replace(const AUri: string; const APattern: string;
      const AReplacement: string): string; static;
    class function Split(const AUri: string; const APattern: string)
  ...
  type
    TdxRecord = record
      ...
      Url: string;
      Anchor: string;
      constructor Create(AStart, AEnd: TdxRunIndex;
        const AUrl, AAnchor: string);
    end;
  strict private
...
function TdxHyperlinkInfoCollection.GetItem(AFieldIndex: Integer)
  : TdxHyperlinkInfo;
var
  AIndex: Integer;
begin
...
procedure TdxHyperlinkInfoCollection.Add(AFieldIndex: Integer;
...
function TdxHyperlinkInfoCollection.TryGetHyperlinkInfo(AFieldIndex: Integer;
  var AInfo: TdxHyperlinkInfo): Boolean;
var
  AIndex: Integer;
begin
...
procedure TdxHyperlinkInfoCollection.RecalcKeys(AFrom: Integer;
  ADeltaIndex: Integer);
var
...
class function TdxHyperlinkInstructionBuilder.GetAnchor
  (ABuilder: TdxHyperlinkInstructionBuilder): string;
begin
  Result := ABuilder.HyperlinkInfo.Anchor;
end;

class function TdxHyperlinkInstructionBuilder.GetTarget
  (ABuilder: TdxHyperlinkInstructionBuilder): string;
begin
  Result := ABuilder.HyperlinkInfo.Target;
end;

class function TdxHyperlinkInstructionBuilder.GetToolTip
  (ABuilder: TdxHyperlinkInstructionBuilder): string;
begin
...
begin
  ...
  Result := TdxHyperlinkUriHelper.ConvertToHyperlinkUri
    (HyperlinkInfo.NavigateUri);
end;

{ TdxHyperlinkUriHelper }

class function TdxHyperlinkUriHelper.EscapeHyperlinkFieldParameterString
  (const AValue: string): string;
begin
  Result := Replace(AValue, '\\', '\\');
end;

class function TdxHyperlinkUriHelper.ConvertToHyperlinkUri
  (const AUri: string): string;
begin
  Result := Replace(AUri, '\\', '\\\\');
end;

class function TdxHyperlinkUriHelper.PrepareHyperlinkTooltipQuotes
  (const AValue: string): string;
begin
  Result := Replace(AValue, '\"', '\\\"');
end;

class function TdxHyperlinkUriHelper.ConvertFromHyperlinkUri
  (const AUri: string): string;
begin
  Result := Replace(AUri, '\\\\', '\\');
end;
...
class function TdxHyperlinkUriHelper.EnsureUriIsValid
  (const AUri: string): string;
begin
...
class function TdxHyperlinkUriHelper.EnsureFileUriIsValid
  (const AUri: string): string;
var
  ARegex: TRegEx;
  AMatch: TMatch;
...
class function TdxHyperlinkUriHelper.EnsureUrlIsValid
  (const AUri: string): string;
var
  ARegex: TRegEx;
  AMatch: TMatch;
...
class function TdxHyperlinkUriHelper.EnsureLocalPathIsValid
  (const AUri: string): string;
var
  AEntries: TArray<string>;
begin
...
class function TdxHyperlinkUriHelper.EnsureRemotePathIsValid
  (const AUri: string): string;
var
  ARegex: TRegEx;
  AMatch: TMatch;
...
class function TdxHyperlinkUriHelper.EnsureMailAddressIsValid
  (const AUri: string): string;
var
  ARegex: TRegEx;
  AMatch: TMatch;
...
class function TdxHyperlinkUriHelper.EnsureRelativePathIsValid
  (const AUri: string): string;
var
...
class function TdxHyperlinkUriHelper.ConvertRelativePathToAbsolute
  (const AUri: string; const ABaseUri: string): string;
var
  AParts: TdxStringList;
  I: Integer;
begin
...
class function TdxHyperlinkUriHelper.IsRelativePath(const AUri: string)
  : Boolean;
begin
  Result := IsMatch(AUri, RelativePathPattern);
end;

class function TdxHyperlinkUriHelper.IsMatch(const AUri: string;
...
class function TdxHyperlinkUriHelper.Replace(const AUri: string;
  const APattern: string; const AReplacement: string): string;
var
  ARegex: TRegEx;
begin
  ARegex := TRegEx.Create(APattern);
...
class function TdxHyperlinkUriHelper.Split(const AUri: string;
...
constructor TdxHyperlinkCalculator.TdxRecord.Create(AStart, AEnd: TdxRunIndex;
  const AUrl, AAnchor: string);
begin
  Start := AStart;
  &End := AEnd;
...
constructor TdxHyperlinkCalculator.Create(PieceTable
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        FUrls.Add(TdxRecord.Create(AField.FirstRunIndex, AField.LastRunIndex,
          AUrl, AInfo.Anchor));
      end;
    end;
  end;
