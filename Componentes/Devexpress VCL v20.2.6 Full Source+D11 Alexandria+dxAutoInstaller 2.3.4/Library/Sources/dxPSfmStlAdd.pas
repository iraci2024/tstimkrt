...
uses
  ...
  StdCtrls, dxPSForm, dxPgsDlg, Menus,
  cxLookAndFeelPainters, cxButtons, cxControls, cxContainer, cxEdit, cxGroupBox,
  cxGraphics, cxTextEdit, cxMaskEdit,
  cxDropDownEdit, cxLabel, cxLookAndFeels, dxLayoutcxEditAdapters,
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        cbxStyleTypes.ItemIndex :=
          Items.IndexOfObject(TObject(dxPgsDlg.dxDefaultPrintStyleClass));
