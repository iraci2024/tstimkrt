...
type
  ...
  TcxDBVerticalGridDefaultValuesProvider = class
  ...
  published
    ...
    property GridModeBufferCount: Integer read GetGridModeBufferCount
  ...
  public
    procedure Assign(Source: TPersistent); override;
  published
    property DataBinding: TcxDBVerticalGridItemDataBinding read GetDataBinding
  ...
  public
    ...
    property Items[Index: Integer]: TcxDBEditorRowItemProperties
  ...
  published
    property Editors: TcxDBEditorPropertiesCollection read GetEditors
      write SetEditors;
  end;
...
uses
  SysUtils, cxGraphics, cxControls, cxLookAndFeelPainters,
  cxEditDataRegisteredRepositoryItems, cxEditDBRegisteredRepositoryItems,
  Types, cxGeometry, cxVGridViewInfo, cxClasses;
...
function TcxDBVerticalGridDefaultValuesProvider.IsDisplayFormatDefined
  (AIsCurrencyValueAccepted: Boolean): Boolean;
begin
  Result := TcxDBVerticalGridItemDataBinding(Owner).IsDisplayFormatDefined
  ...
  try
    ...
    try
      with DataSet do
        ...
        begin
          AItem := TcxDBEditorRow
            (VerticalGrid.Add(VerticalGrid.GetEditorRowClass));
          AItem.Name := CreateUniqueName(VerticalGrid.Owner, VerticalGrid,
            AItem, 'Tcx', Fields[I].FieldName);
...
function TcxDBVerticalGridDataController.GetFilterItemFieldCaption
...
function TcxDBVerticalGridDataController.GetItemValueSource(AItemIndex: Integer)
  : TcxDataEditValueSource;
begin
  Result := TcxDBCellEdit(GetItem(AItemIndex))
...
function TcxDBVerticalGridDataController.
  IsRecordPixelScrollingSupported: Boolean;
begin
  Result := not SupportsScrollBarParams;
end;

function TcxDBVerticalGridDataController.SetScrollBarPos(APos: Integer)
  : Boolean;
begin
  Result := SupportsScrollBarParams;
  if Result then
...
function TcxDBVerticalGridDataController.CreateExpressionProvider
...
procedure TcxDBVerticalGridDataController.SetGridModeBufferCount
  (Value: Integer);
begin
...
function TcxDBVerticalGridItemDataBinding.DefaultRepositoryItem
...
function TcxDBVerticalGridItemDataBinding.GetDefaultValuesProviderClass
  : TcxCustomEditDefaultValuesProviderClass;
begin
  Result := TcxDBVerticalGridDefaultValuesProvider;
end;

function TcxDBVerticalGridItemDataBinding.GetDefaultValueTypeClass
  : TcxValueTypeClass;
begin
  Result := nil;
end;
...
begin
  inherited Init;
  TcxDBVerticalGridDefaultValuesProvider(DefaultValuesProvider).DataSource :=
...
function TcxDBVerticalGridItemDataBinding.GetDataController
  : TcxDBVerticalGridDataController;
begin
...
function TcxDBEditorRowItemProperties.GetInplaceEditContainerClass
  : TcxCellEditClass;
begin
  Result := TcxDBCellEdit;
end;

function TcxDBEditorRowItemProperties.GetDataBinding
  : TcxDBVerticalGridItemDataBinding;
begin
...
function TcxDBEditorPropertiesCollection.GetCollectionItemClass
  : TCollectionItemClass;
begin
  Result := TcxDBEditorRowItemProperties;
end;

function TcxDBEditorPropertiesCollection.GetItem(Index: Integer)
  : TcxDBEditorRowItemProperties;
begin
...
function TcxDBEditorRowProperties.GetInplaceEditContainerClass
  : TcxCellEditClass;
begin
  Result := TcxDBCellEdit;
end;

function TcxDBEditorRowProperties.GetDataBinding
  : TcxDBVerticalGridItemDataBinding;
begin
  Result := TcxDBVerticalGridItemDataBinding(inherited DataBinding);
end;
...
function TcxDBMultiEditorRowProperties.GetCollectionClass
  : TcxEditorPropertiesCollectionClass;
begin
  Result := TcxDBEditorPropertiesCollection;
end;

function TcxDBMultiEditorRowProperties.GetEditors
  : TcxDBEditorPropertiesCollection;
begin
