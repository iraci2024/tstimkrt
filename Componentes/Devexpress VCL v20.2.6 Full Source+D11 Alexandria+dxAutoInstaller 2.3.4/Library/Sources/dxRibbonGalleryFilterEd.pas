...
uses
  ...
  Dialogs, StdCtrls, Menus, cxEdit, CheckLst,
  dxRibbonGallery, cxGraphics, cxControls, cxLookAndFeels,
  cxLookAndFeelPainters, cxContainer, cxCheckListBox,
  cxButtons, dxLayoutContainer, dxLayoutControlAdapters, dxLayoutLookAndFeels,
...
procedure TfmGalleryFilterGroups.Apply(AFilterCategory
...
begin
  ...
  begin
    if clbGroups.Items[I].Checked then
      AFilterCategory.Groups.Add
        (TdxRibbonGalleryGroup(clbGroups.Items[I].ItemObject));
  end;
end;

procedure TfmGalleryFilterGroups.Init(AFilterCategory
  : TdxRibbonGalleryFilterCategory);
var
  ...
  I: Integer;
begin
  Caption := Format('Editing %s.GalleryFilter.Categories[%d].Groups',
    [AFilterCategory.GalleryItem.Name, AFilterCategory.Index]);
  clbGroups.Clear;
