...
type
  ...
  TdxTextRunStartReason = (TextRunMark, ParagraphMark, SectionMark, ColumnBreak,
    TableUnitMark);
  ...
  IdxDocShadingDescriptor = interface
    ...
    property ShadingPattern: SmallInt read GetShadingPattern
      write SetShadingPattern;
  end;
  ...
  public const
    ...
    DefaultMSWordColor: array [0 .. 16] of TdxAlphaColor =
      (TdxAlphaColors.Empty, TdxAlphaColors.Black, TdxAlphaColors.Blue,
      TdxAlphaColors.Cyan, TdxAlphaColors.Lime, TdxAlphaColors.Magenta,
      TdxAlphaColors.Red, TdxAlphaColors.Yellow, TdxAlphaColors.White,
      TdxAlphaColors.Navy, TdxAlphaColors.Teal, TdxAlphaColors.Green,
      TdxAlphaColors.Purple, TdxAlphaColors.Maroon, TdxAlphaColors.Olive,
      TdxAlphaColors.Gray, TdxAlphaColors.Silver);
  public
  ...
  public
    class function GetMergedCharacterFormattingInfo
      (AInfo: TdxDocCharacterFormattingInfo;
      AParentInfo: TdxCharacterFormattingInfo; ADocumentModel: TdxDocumentModel)
      : TdxCharacterFormattingInfo; static;
    class function ConvertFromDocBoolWrapper(AValue: Boolean;
      ABoolWrapper: TdxDocBoolWrapper): Boolean; static;
    class function CalcStriceoutType(AStrike: TdxDocBoolWrapper;
      ADoubleStrike: TdxDocBoolWrapper; ABaseStrikeout: TdxStrikeoutType)
      : TdxStrikeoutType; static;
  end;
  ...
  public
    class function CalcParagraphAlignment(AAlignmentCode: Byte)
      : TdxParagraphAlignment; static;
    class function CalcParagraphAlignmentCode(AAlignment: TdxParagraphAlignment)
      : Byte; static;
    class function CalcListNumberAlignment(AAlignmentCode: Byte)
      : TdxListNumberAlignment; static;
    class function CalcListNumberAlignmentCode
      (AAlignment: TdxListNumberAlignment): Byte; static;
    class function CalcVerticalAlignment(AAlignmentTypeCode: Byte)
      : TdxVerticalAlignment; static;
    class function CalcVerticalAlignmentTypeCode
      (AAlignment: TdxVerticalAlignment): Byte; static;
  end;
  ...
  strict private
    class var NumberingFormatCodes: array [TdxNumberingFormat] of Byte;
  strict private
    class constructor Initialize;
  public
    class function CalcNumberingFormat(ANumberingFormatCode: Integer)
      : TdxNumberingFormat; static;
    class function CalcNumberingFormatCode(ANumberingFormat: TdxNumberingFormat)
      : Byte; static;
  end;
  ...
  public
    ...
    class function CalcWidthUnitTypeCode(AUnitType: TdxWidthUnitType)
      : Byte; static;
  end;
  ...
  public
    class function CalcHorizontalMergingState(ATypeCode: Byte)
      : TdxMergingState; static;
    class function CalcHorizontalMergingTypeCode(AMergingState: TdxMergingState)
      : Byte; static;
    class function CalcVerticalMergingState(ATypeCode: Byte)
      : TdxMergingState; static;
    class function CalcVerticalMergingTypeCode(AMergingState: TdxMergingState)
      : Byte; static;
  end;
  ...
  public
    class function CalcFootNotePosition(ATypeCode: Integer)
      : TdxFootNotePosition; static;
    class function CalcFootNotePositionTypeCode(APosition: TdxFootNotePosition)
      : Byte; static;
    class function CalcFootNotePositionTypeCodeForDocumentProperties
      (APosition: TdxFootNotePosition): Byte; static;
  end;
  ...
  public
    class function CalcFootNoteNumberingRestart(ATypeCode: Integer)
      : TdxLineNumberingRestart; static;
    class function CalcFootNoteNumberingRestartTypeCode(ANumberingRestart
      : TdxLineNumberingRestart): Byte; static;
  end;
  ...
  public
    class function CalcHorizontalPositionType97(ATypeCode: Integer)
      : TdxFloatingObjectHorizontalPositionType; static;
    class function CalcHorizontalPositionTypeCode97
      (AType: TdxFloatingObjectHorizontalPositionType): Byte; static;
  end;
  ...
  public
    class function CalcVerticalPositionType97(ATypeCode: Integer)
      : TdxFloatingObjectVerticalPositionType; static;
    class function CalcVerticalPositionTypeCode97
      (AType: TdxFloatingObjectVerticalPositionType): Byte; static;
  end;
  ...
  public
    class function CalcTextWrapType(ATypeCode: Integer)
      : TdxFloatingObjectTextWrapType; static;
    class function CalcTextWrapTypeCode(AType: TdxFloatingObjectTextWrapType)
      : Byte; static;
  end;
  ...
  public
    class function CalcTextWrapSide(ATypeCode: Integer)
      : TdxFloatingObjectTextWrapSide; static;
    class function CalcTextWrapSideTypeCode
      (AWrapSide: TdxFloatingObjectTextWrapSide): Byte; static;
  end;
  ...
  public
    class function FromByteArray(const AData: TBytes; AStartIndex: Integer)
      : TdxDocTableBorderColorReference; static;
    function GetBytes: TBytes;

    property Color: TdxAlphaColor read FColor write FColor;
  end;

  TdxDocTableBorderColorReferenceList = class
    (TdxObjectList<TdxDocTableBorderColorReference>);
  ...
  public
    constructor Create;
    class function FromByteArray(const AData: TBytes; AStartIndex: Integer)
      : TdxDocShadingDescriptor; static;
  ...
  public
    ...
    class function FromByteArray(const AData: TBytes)
      : TdxDocShadingDescriptor80; overload; static;
    class function FromByteArray(const AData: TBytes; AStartIndex: Integer)
      : TdxDocShadingDescriptor80; overload; static;
    procedure Write(AWriter: TBinaryWriter);
  ...
  public
    class function CalcDocumentProtectionType(AProtectionTypeCode: SmallInt)
      : TdxDocumentProtectionType; static;
    class function CalcDocumentProtectionTypeCode
      (AType: TdxDocumentProtectionType): SmallInt; static;
    class function CalcRangePermissionProtectionType(AProtectionTypeCode
      : SmallInt): TdxDocumentProtectionType; static;
    class function CalcRangePermissionProtectionTypeCode
      (AType: TdxDocumentProtectionType): SmallInt; static;
  end;
  ...
  public
    class function GetBorders(AReader: TBinaryReader; AOffset: Integer)
...
class function TdxDocColorReference.FromByteArray(const AData: TBytes;
  AStartIndex: Integer): TdxDocColorReference;
begin
...
begin
  if TdxAlphaColors.IsTransparentOrEmpty(Color) then
    ...
    AAuto := $00;
  Result := TBytes.Create(TdxAlphaColors.R(Color), TdxAlphaColors.G(Color),
    TdxAlphaColors.B(Color), AAuto);
end;

{ TdxTextRunBorder }

constructor TdxTextRunBorder.Create(AOffset: Integer;
  const AReason: TdxTextRunStartReasons);
begin
  FOffset := AOffset;
  FReason := AReason;
end;
...
function TdxTextRunBorderComparable.CompareTo(const ATextRunBorder
  : TdxTextRunBorder): Integer;
begin
...
class function TdxDocCharacterFormattingHelper.GetMergedCharacterFormattingInfo
  (AInfo: TdxDocCharacterFormattingInfo;
  AParentInfo: TdxCharacterFormattingInfo; ADocumentModel: TdxDocumentModel)
...
begin
  ...
  Result.FontItalic := ConvertFromDocBoolWrapper(Result.FontItalic,
    AInfo.FontItalic);
  Result.FontName := AInfo.FontName;
  Result.DoubleFontSize := AInfo.DoubleFontSize;
  Result.FontStrikeoutType := CalcStriceoutType(AInfo.Strike,
    AInfo.DoubleStrike, Result.FontStrikeoutType);
...
class function TdxDocCharacterFormattingHelper.ConvertFromDocBoolWrapper
  (AValue: Boolean; ABoolWrapper: TdxDocBoolWrapper): Boolean;
begin
...
class function TdxDocCharacterFormattingHelper.CalcStriceoutType
  (AStrike: TdxDocBoolWrapper; ADoubleStrike: TdxDocBoolWrapper;
  ABaseStrikeout: TdxStrikeoutType): TdxStrikeoutType;
begin
  ...
  if (AStrike = TdxDocBoolWrapper.Leave) or
    (ADoubleStrike = TdxDocBoolWrapper.Leave) then
    Exit(ABaseStrikeout);
  if (ADoubleStrike = TdxDocBoolWrapper.Inverse) and
    (ABaseStrikeout = TdxStrikeoutType.None) then
    Exit(TdxStrikeoutType.Double);
  if (AStrike = TdxDocBoolWrapper.Inverse) and
    (ABaseStrikeout = TdxStrikeoutType.None) then
    Exit(TdxStrikeoutType.Single);
...
class function TdxAlignmentCalculator.CalcParagraphAlignment(AAlignmentCode
  : Byte): TdxParagraphAlignment;
begin
...
class function TdxAlignmentCalculator.CalcParagraphAlignmentCode
  (AAlignment: TdxParagraphAlignment): Byte;
begin
  case AAlignment of
...
class function TdxAlignmentCalculator.CalcListNumberAlignment
  (AAlignmentCode: Byte): TdxListNumberAlignment;
begin
  case AAlignmentCode of
    0:
      Result := TdxListNumberAlignment.Left;
    1:
      Result := TdxListNumberAlignment.Center;
    2:
      Result := TdxListNumberAlignment.Right;
  else
    Result := TdxListNumberAlignment.Left;
  end;
end;

class function TdxAlignmentCalculator.CalcListNumberAlignmentCode
  (AAlignment: TdxListNumberAlignment): Byte;
begin
  case AAlignment of
...
class function TdxAlignmentCalculator.CalcVerticalAlignment(AAlignmentTypeCode
  : Byte): TdxVerticalAlignment;
begin
...
class function TdxAlignmentCalculator.CalcVerticalAlignmentTypeCode
  (AAlignment: TdxVerticalAlignment): Byte;
begin
  case AAlignment of
...
class function TdxNumberingFormatCalculator.CalcNumberingFormat
  (ANumberingFormatCode: Integer): TdxNumberingFormat;
begin
  case ANumberingFormatCode of
    ...
    $05:
      Result := TdxNumberingFormat.Ordinal;
    $06:
      Result := TdxNumberingFormat.CardinalText;
    $07:
      Result := TdxNumberingFormat.OrdinalText;
    $08:
      Result := TdxNumberingFormat.Hex;
    $09:
      Result := TdxNumberingFormat.Chicago;
    $0A:
      Result := TdxNumberingFormat.IdeographDigital;
    $0B:
      Result := TdxNumberingFormat.JapaneseCounting;
    $0C:
      Result := TdxNumberingFormat.AIUEOHiragana;
    $0D:
      Result := TdxNumberingFormat.Iroha;
    $0E:
      Result := TdxNumberingFormat.DecimalFullWidth;
    $0F:
      Result := TdxNumberingFormat.DecimalHalfWidth;
    $10:
      Result := TdxNumberingFormat.JapaneseLegal;
    $11:
      Result := TdxNumberingFormat.JapaneseDigitalTenThousand;
    $12:
      Result := TdxNumberingFormat.DecimalEnclosedCircle;
    $13:
      Result := TdxNumberingFormat.DecimalFullWidth2;
    $14:
      Result := TdxNumberingFormat.AIUEOFullWidthHiragana;
    $15:
      Result := TdxNumberingFormat.IrohaFullWidth;
    $16:
      Result := TdxNumberingFormat.DecimalZero;
    $17:
      Result := TdxNumberingFormat.Bullet;
    $18:
      Result := TdxNumberingFormat.Ganada;
    $19:
      Result := TdxNumberingFormat.Chosung;
    $1A:
      Result := TdxNumberingFormat.DecimalEnclosedFullstop;
    $1B:
      Result := TdxNumberingFormat.DecimalEnclosedParentheses;
    $1C:
      Result := TdxNumberingFormat.DecimalEnclosedCircleChinese;
    $1D:
      Result := TdxNumberingFormat.IdeographEnclosedCircle;
    $1E:
      Result := TdxNumberingFormat.IdeographTraditional;
    $1F:
      Result := TdxNumberingFormat.IdeographZodiac;
    $20:
      Result := TdxNumberingFormat.IdeographZodiacTraditional;
    $21:
      Result := TdxNumberingFormat.TaiwaneseCounting;
    $22:
      Result := TdxNumberingFormat.IdeographLegalTraditional;
    $23:
      Result := TdxNumberingFormat.TaiwaneseCountingThousand;
    $24:
      Result := TdxNumberingFormat.TaiwaneseDigital;
    $25:
      Result := TdxNumberingFormat.ChineseCounting;
    $26:
      Result := TdxNumberingFormat.ChineseLegalSimplified;
    $27:
      Result := TdxNumberingFormat.ChineseCountingThousand;
    $28:
      Result := TdxNumberingFormat.Decimal;
    $29:
      Result := TdxNumberingFormat.KoreanDigital;
    $2A:
      Result := TdxNumberingFormat.KoreanCounting;
    $2B:
      Result := TdxNumberingFormat.KoreanLegal;
    $2C:
      Result := TdxNumberingFormat.KoreanDigital2;
    $2D:
      Result := TdxNumberingFormat.Hebrew1;
    $2E:
      Result := TdxNumberingFormat.ArabicAlpha;
    $2F:
      Result := TdxNumberingFormat.Hebrew2;
    $30:
      Result := TdxNumberingFormat.ArabicAbjad;
    $31:
      Result := TdxNumberingFormat.HindiVowels;
    $32:
      Result := TdxNumberingFormat.HindiConsonants;
    $33:
      Result := TdxNumberingFormat.HindiNumbers;
    $34:
      Result := TdxNumberingFormat.HindiDescriptive;
    $35:
      Result := TdxNumberingFormat.ThaiLetters;
    $36:
      Result := TdxNumberingFormat.ThaiNumbers;
    $37:
      Result := TdxNumberingFormat.ThaiDescriptive;
    $38:
      Result := TdxNumberingFormat.VietnameseDescriptive;
    $39:
    ...
    $FF:
      Result := TdxNumberingFormat.None;
  else
    Result := TdxNumberingFormat.Decimal;
  end;
end;

class function TdxNumberingFormatCalculator.CalcNumberingFormatCode
  (ANumberingFormat: TdxNumberingFormat): Byte;
begin
...
class function TdxWidthUnitCalculator.CalcWidthUnitType(ATypeCode: Byte)
  : TdxWidthUnitType;
begin
  case ATypeCode of
    $00:
...
class function TdxWidthUnitCalculator.CalcWidthUnitTypeCode
  (AUnitType: TdxWidthUnitType): Byte;
begin
  case AUnitType of
...
class function TdxMergingStateCalculator.CalcHorizontalMergingState
  (ATypeCode: Byte): TdxMergingState;
begin
  case ATypeCode of
    1:
      Result := TdxMergingState.Restart;
    2, 3:
      Result := TdxMergingState.Continue;
  else
    Result := TdxMergingState.None;
  end;
end;

class function TdxMergingStateCalculator.CalcHorizontalMergingTypeCode
  (AMergingState: TdxMergingState): Byte;
begin
...
class function TdxMergingStateCalculator.CalcVerticalMergingState
  (ATypeCode: Byte): TdxMergingState;
begin
  case ATypeCode of
    1:
...
class function TdxMergingStateCalculator.CalcVerticalMergingTypeCode
  (AMergingState: TdxMergingState): Byte;
begin
  case AMergingState of
    TdxMergingState.None:
...
class function TdxTextDirectionCalculator.CalcTextDirection(ATypeCode: Byte)
  : TdxTextDirection;
begin
  case ATypeCode of
    1:
      Result := TdxTextDirection.TopToBottomRightToLeftRotated;
    3 .. 5:
      Result := TdxTextDirection.LeftToRightTopToBottomRotated;
  else
...
class function TdxFootNotePositionCalculator.CalcFootNotePosition
  (ATypeCode: Integer): TdxFootNotePosition;
begin
  case ATypeCode of
    0:
      Result := TdxFootNotePosition.EndOfSection;
    1:
      Result := TdxFootNotePosition.BottomOfPage;
    2:
      Result := TdxFootNotePosition.BelowText;
    3:
      Result := TdxFootNotePosition.EndOfDocument;
  else
    Result := TdxFootNotePosition.BottomOfPage;
  end;
end;

class function TdxFootNotePositionCalculator.CalcFootNotePositionTypeCode
  (APosition: TdxFootNotePosition): Byte;
begin
  case APosition of
...
class function TdxFootNotePositionCalculator.
  CalcFootNotePositionTypeCodeForDocumentProperties
  (APosition: TdxFootNotePosition): Byte;
begin
  case APosition of
    TdxFootNotePosition.EndOfSection:
...
class function TdxFootNoteNumberingRestartCalculator.
  CalcFootNoteNumberingRestart(ATypeCode: Integer): TdxLineNumberingRestart;
begin
  case ATypeCode of
    0:
...
class function TdxFootNoteNumberingRestartCalculator.
  CalcFootNoteNumberingRestartTypeCode(ANumberingRestart
  : TdxLineNumberingRestart): Byte;
begin
...
class function TdxDocFloatingObjectHorizontalPositionTypeCalculator.
  CalcHorizontalPositionType97(ATypeCode: Integer)
...
class function TdxDocFloatingObjectHorizontalPositionTypeCalculator.
  CalcHorizontalPositionTypeCode97
  (AType: TdxFloatingObjectHorizontalPositionType): Byte;
begin
  case AType of
...
class function TdxDocFloatingObjectVerticalPositionTypeCalculator.
  CalcVerticalPositionType97(ATypeCode: Integer)
...
class function TdxDocFloatingObjectVerticalPositionTypeCalculator.
  CalcVerticalPositionTypeCode97
  (AType: TdxFloatingObjectVerticalPositionType): Byte;
begin
  case AType of
...
class function TdxDocFloatingObjectTextWrapTypeCalculator.CalcTextWrapType
  (ATypeCode: Integer): TdxFloatingObjectTextWrapType;
begin
  case ATypeCode of
    1:
...
class function TdxDocFloatingObjectTextWrapTypeCalculator.CalcTextWrapTypeCode
  (AType: TdxFloatingObjectTextWrapType): Byte;
begin
  case AType of
...
class function TdxDocFloatingObjectTextWrapSideCalculator.CalcTextWrapSide
  (ATypeCode: Integer): TdxFloatingObjectTextWrapSide;
begin
  case ATypeCode of
    1:
...
class function TdxDocFloatingObjectTextWrapSideCalculator.
  CalcTextWrapSideTypeCode(AWrapSide: TdxFloatingObjectTextWrapSide): Byte;
begin
  case AWrapSide of
...
class function TdxDocTableBorderColorReference.FromByteArray
  (const AData: TBytes; AStartIndex: Integer): TdxDocTableBorderColorReference;
begin
  Result := TdxDocTableBorderColorReference.Create;
  Result.Read(AData, AStartIndex);
end;

procedure TdxDocTableBorderColorReference.Read(const AData: TBytes;
  AStartIndex: Integer);
var
  ARed, AGreen, ABlue, AAuto: Integer;
begin
...
class function TdxDocShadingDescriptor.FromByteArray(const AData: TBytes;
  AStartIndex: Integer): TdxDocShadingDescriptor;
begin
...
procedure TdxDocShadingDescriptor.Read(const AData: TBytes;
  AStartIndex: Integer);
var
  ARed, AGreen, ABlue, AAuto: Integer;
begin
...
procedure TdxDocShadingDescriptor.SetBackgroundColor
...
begin
  ...
  if TdxAlphaColors.IsTransparentOrEmpty(ForeColor) then
    ...
    AAuto := $00;
  AWriter.Write(TBytes.Create(TdxAlphaColors.R(ForeColor),
    TdxAlphaColors.G(ForeColor), TdxAlphaColors.B(ForeColor), AAuto));

  if TdxAlphaColors.IsTransparentOrEmpty(BackgroundColor) then
    AAuto := $FF
  else
    AAuto := $00;
  AWriter.Write(TBytes.Create(TdxAlphaColors.R(BackgroundColor),
    TdxAlphaColors.G(BackgroundColor),
    TdxAlphaColors.B(BackgroundColor), AAuto));
...
class function TdxDocShadingDescriptor80.FromByteArray(const AData: TBytes)
  : TdxDocShadingDescriptor80;
begin
...
class function TdxDocShadingDescriptor80.FromByteArray(const AData: TBytes;
  AStartIndex: Integer): TdxDocShadingDescriptor80;
begin
...
procedure TdxDocShadingDescriptor80.SetBackgroundColor
  (const Value: TdxAlphaColor);
begin
  FBackgroundColor := Value;
end;
...
procedure TdxDocShadingDescriptor80.Read(const AData: TBytes;
  AStartIndex: Integer);
var
  AInfo: SmallInt;
  AColorIndex: Byte;
...
class function TdxDocumentProtectionTypeCalculator.CalcDocumentProtectionType
  (AProtectionTypeCode: SmallInt): TdxDocumentProtectionType;
begin
  case AProtectionTypeCode of
    $3:
      Result := TdxDocumentProtectionType.ReadOnly;
  else
    Result := TdxDocumentProtectionType.None;
  end;
end;

class function TdxDocumentProtectionTypeCalculator.
  CalcDocumentProtectionTypeCode(AType: TdxDocumentProtectionType): SmallInt;
begin
  case AType of
    TdxDocumentProtectionType.None:
      Result := $7;
  else
    Result := $3;
  end;
...
class function TdxDocumentProtectionTypeCalculator.
  CalcRangePermissionProtectionType(AProtectionTypeCode: SmallInt)
...
class function TdxDocumentProtectionTypeCalculator.
  CalcRangePermissionProtectionTypeCode(AType: TdxDocumentProtectionType)
  : SmallInt;
begin
  case AType of
    TdxDocumentProtectionType.None:
      Result := $0001;
    TdxDocumentProtectionType.ReadOnly:
      Result := $0004;
  else
    Result := $0000;
  end;
...
class function TdxSectorHelper.GetBorders(AReader: TBinaryReader;
  AOffset: Integer): TArray<Integer>;
var
  I: Integer;
begin
  if AOffset + TdxDocConstants.LastByteOffsetInSector >= AReader.BaseStream.Size
  then
    Exit(TArray<Integer>.Create(0));
  AReader.BaseStream.Seek(AOffset + TdxDocConstants.LastByteOffsetInSector,
