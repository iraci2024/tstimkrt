...
type
  ...
  TdxRichEditInsertSymbolControllerParameters = class
    (TdxInsertSymbolControllerParameters)
  public
...
constructor TdxRichEditInsertSymbolController.Create(const AControllerParameters
  : TdxRichEditInsertSymbolControllerParameters);
begin
  inherited Create;
...
begin
  ...
  begin
    FOnApplyChanges(TdxSymbolProperties.Create(UnicodeChar, FontName),
      FCallbackData);
    Exit;
  end;
  ...
  try
    ...
    begin
      AState := ACommand.CreateDefaultCommandUIState as
...
constructor TdxRichEditInsertSymbolControllerParameters.Create
