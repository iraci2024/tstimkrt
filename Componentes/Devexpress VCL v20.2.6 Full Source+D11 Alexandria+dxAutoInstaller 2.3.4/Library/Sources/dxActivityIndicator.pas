...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Windows, Types, Classes, Graphics, cxControls, dxCoreGraphics, cxGraphics,
  cxGeometry, cxClasses, dxGDIPlusClasses,
...
type
  ...
  public
    class function CalculateGapBetweenElements(const ABounds: TdxRectF;
      const AElementSize: Double): Double; virtual;
  end;

  { TdxActivityIndicatorArcBasedRule }

  TdxActivityIndicatorArcBasedRuleClass = class of
    TdxActivityIndicatorArcBasedRule;

  TdxActivityIndicatorArcBasedRule = class(TdxActivityIndicatorCustomRule)
  public
    class procedure CalculateAngles(const AProgress: Double;
      out AAngle1, AAngle2: Double); virtual;
  end;

  { TdxActivityIndicatorDotBasedRule }

  TdxActivityIndicatorDotBasedRuleClass = class of
    TdxActivityIndicatorDotBasedRule;

  TdxActivityIndicatorDotBasedRule = class abstract
    (TdxActivityIndicatorCustomRule)
  public
    class function AllowHideDots: Boolean; virtual;
    class function CalculateDotSize(const ADotSize, AProgress: Double)
      : Double; virtual;
    class function CalculatePosition(const ABounds: TdxRectF;
      const ADotSize, AProgress: Double): TdxPointF; virtual;
  end;

  { TdxActivityIndicatorElasticCircleRule }

  TdxActivityIndicatorElasticCircleRule = class
    (TdxActivityIndicatorArcBasedRule)
  public
    class procedure CalculateAngles(const AProgress: Double;
      out AAngle1, AAngle2: Double); override;
  end;

  { TdxActivityIndicatorHorizontalDotsRule }

  TdxActivityIndicatorHorizontalDotsRule = class
    (TdxActivityIndicatorDotBasedRule)
  protected
    class function ProgressTransform(const AProgress: Double): Double; virtual;
  public
    class function CalculateGapBetweenElements(const ABounds: TdxRectF;
      const AElementSize: Double): Double; override;
    class function CalculatePosition(const ABounds: TdxRectF;
      const ADotSize, AProgress: Double): TdxPointF; override;
  end;
  ...
  TdxActivityIndicatorGravityDotsRule = class
    (TdxActivityIndicatorCircularDotsRule)
  protected
  ...
  protected
    ...
    property AnimationRestartDelay: Cardinal read FAnimationRestartDelay
      write SetAnimationRestartDelay default 0;
  ...
  published
    property AnimationTime: Cardinal read FAnimationTime write SetAnimationTime
      default 2000;
    property OverlayColor: TdxAlphaColor read FOverlayColor
      write SetOverlayColor stored IsOverlayColorStored;
  end;
  ...
  published
    ...
    property DotColor: TdxAlphaColor read FDotColor write SetDotColor
      stored IsDotColorStored;
    property DotCount: TdxActivityIndicatorDotCount read FDotCount
      write SetDotCount default 5;
    property DotSize: TdxActivityIndicatorDotSize read FDotSize write SetDotSize
      default 6;
  end;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property ArcColor: TdxAlphaColor read FArcColor write SetArcColor
      stored IsArcColorStored;
    property ArcThickness: Integer read FArcThickness write SetArcThickness
      default 3;
  end;
  ...
  TdxActivityIndicatorAnimationController = class
    (TdxActivityIndicatorPersistent)
  strict private
  ...
  public
    ...
    property Properties: TdxActivityIndicatorArcBasedProperties
      read GetProperties;
  ...
  public
    ...
    property Properties: TdxActivityIndicatorDotBasedProperties
      read GetProperties;
  ...
  protected
    ...
    function CreateAnimationController
      : TdxActivityIndicatorAnimationController; virtual;
    ...
    property AnimationController: TdxActivityIndicatorAnimationController
      read FAnimationController;
    property Antialiasing: Boolean read FAntialiasing write SetAntialiasing
      default True;
    property Properties: TdxActivityIndicatorProperties read FProperties
      write SetProperties;
    property PropertiesClass: TdxActivityIndicatorPropertiesClass
...
begin
  ...
  begin
    ...
    FRegisteredProperties.Register(TdxActivityIndicatorHorizontalDotsProperties,
      'Horizontal Dots');
    FRegisteredProperties.Register(TdxActivityIndicatorCircularDotsProperties,
      'Circular Dots');
    FRegisteredProperties.Register(TdxActivityIndicatorGravityDotsProperties,
      'Gravity Dots');
    FRegisteredProperties.Register(TdxActivityIndicatorElasticCircleProperties,
      'Elastic Circle');
  end;
...
class procedure TdxActivityIndicatorArcBasedRule.CalculateAngles(const AProgress
  : Double; out AAngle1, AAngle2: Double);
begin
  AAngle1 := 0;
  AAngle2 := 0;
end;
...
class function TdxActivityIndicatorDotBasedRule.CalculateDotSize(const ADotSize,
  AProgress: Double): Double;
begin
  Result := ADotSize;
end;
...
class procedure TdxActivityIndicatorElasticCircleRule.CalculateAngles
  (const AProgress: Double; out AAngle1, AAngle2: Double);
  ...
  begin
    if X < S1 then
      ...
      Result := PointAtLine((X - S2) / (1.0 - S2),
        1.0 - (1.0 - S2) * NormalSpeedFactor, 1.0)
    else
      Result := PointAtLine(Power((X - S1) / (S2 - S1), 1.5),
        S1 * NormalSpeedFactor, 1.0 - (1.0 - S2) * NormalSpeedFactor);
  end;
...
class function TdxActivityIndicatorHorizontalDotsRule.
  CalculateGapBetweenElements(const ABounds: TdxRectF;
  const AElementSize: Double): Double;
begin
...
class function TdxActivityIndicatorHorizontalDotsRule.ProgressTransform
  (const AProgress: Double): Double;
const
  Section1: Double = 0.2;
  Section2: Double = 0.8;
const
...
begin
  ...
  begin
    ...
    Result := ProgressTransform(Section1) * (1 - Result) +
      ProgressTransform(Section2) * Result;
  end
  else
    Result := 1 / (2 * SinH(Exactitude)) *
      (SinH(AProgress * (2 * Exactitude) - Exactitude) - SinH(-Exactitude));
end;
...
class function TdxActivityIndicatorCircularDotsRule.ProgressTransform
  (const AProgress: Double): Double;
const
  Exactitude = 3;
begin
...
class function TdxActivityIndicatorGravityDotsRule.CalculateDotSize
  (const ADotSize, AProgress: Double): Double;
begin
...
class function TdxActivityIndicatorGravityDotsRule.ProgressTransform
  (const AProgress: Double): Double;
const
  Exponent = 3;
begin
...
constructor TdxActivityIndicatorPersistent.Create
...
constructor TdxActivityIndicatorProperties.Create
  (AOwner: TdxCustomActivityIndicator);
begin
...
begin
  ...
  begin
    ...
    FAnimationRestartDelay := TdxActivityIndicatorProperties(Source)
      .AnimationRestartDelay;
    Changed;
  end;
end;

procedure TdxActivityIndicatorProperties.Changed(AChangeType
  : TdxChangeType = ctHard);
begin
...
procedure TdxActivityIndicatorProperties.SetAnimationRestartDelay
  (AValue: Cardinal);
begin
...
constructor TdxActivityIndicatorDotBasedProperties.Create
  (AOwner: TdxCustomActivityIndicator);
begin
  inherited Create(AOwner);
...
function TdxActivityIndicatorDotBasedProperties.CreateViewInfo
  : TdxActivityIndicatorViewInfo;
begin
...
procedure TdxActivityIndicatorDotBasedProperties.SetDotColor
...
procedure TdxActivityIndicatorDotBasedProperties.SetDotCount
  (AValue: TdxActivityIndicatorDotCount);
begin
...
procedure TdxActivityIndicatorDotBasedProperties.SetDotSize
  (AValue: TdxActivityIndicatorDotSize);
begin
  AValue := Max(Min(AValue, High(TdxActivityIndicatorDotSize)),
    Low(TdxActivityIndicatorDotSize));
...
constructor TdxActivityIndicatorCircularDotsProperties.Create
  (AOwner: TdxCustomActivityIndicator);
begin
  inherited Create(AOwner);
  FAnimationTime := 4000;
...
constructor TdxActivityIndicatorHorizontalDotsProperties.Create
  (AOwner: TdxCustomActivityIndicator);
begin
  inherited Create(AOwner);
...
constructor TdxActivityIndicatorGravityDotsProperties.Create
  (AOwner: TdxCustomActivityIndicator);
begin
  inherited Create(AOwner);
...
constructor TdxActivityIndicatorArcBasedProperties.Create
  (AOwner: TdxCustomActivityIndicator);
begin
  inherited Create(AOwner);
...
function TdxActivityIndicatorArcBasedProperties.CreateViewInfo
  : TdxActivityIndicatorViewInfo;
begin
...
procedure TdxActivityIndicatorArcBasedProperties.SetArcColor
  (AValue: TdxAlphaColor);
begin
...
procedure TdxActivityIndicatorArcBasedProperties.SetArcThickness
  (AValue: Integer);
begin
  AValue := Max(AValue, 1);
...
constructor TdxActivityIndicatorElasticCircleProperties.Create
  (AOwner: TdxCustomActivityIndicator);
begin
  inherited Create(AOwner);
...
constructor TdxActivityIndicatorAnimationController.Create
  (AOwner: TdxCustomActivityIndicator);
begin
  inherited Create(AOwner);
...
function TdxActivityIndicatorAnimationController.CalculateProgress
  (AElementIndex: Integer): Double;
begin
...
begin
  ...
  begin
    ...
    FTimeFinish := FTimeStart + dxTimeToTickCount(Properties.AnimationTime +
      Properties.AnimationRestartDelay);
    UpdateParams;
    UpdateProgress;
  end;
end;
...
begin
  if Active then
  begin
    FGapBetweenElements := Properties.Rule.CalculateGapBetweenElements
      (ViewInfo.Bounds, ViewInfo.ElementSize);
    FTimeFinishOfFirstElement := FTimeStart +
      Trunc(dxTimeToTickCount(Properties.AnimationTime) /
      (1 + (ViewInfo.ElementCount - 1) * FGapBetweenElements));
  end;
end;
...
function TdxActivityIndicatorAnimationController.GetProperties
  : TdxActivityIndicatorProperties;
begin
  Result := ViewInfo.Properties;
end;

function TdxActivityIndicatorAnimationController.GetViewInfo
  : TdxActivityIndicatorViewInfo;
begin
...
begin
  ...
  FProgress := (APosition - FTimeStart) /
    (FTimeFinishOfFirstElement - FTimeStart);
...
constructor TdxActivityIndicatorViewInfo.Create
  (AOwner: TdxCustomActivityIndicator);
begin
  inherited Create(AOwner);
...
begin
  if cxColorIsValid(Owner.LookAndFeelPainter.PanelTextColor) then
    ...
    Result := dxColorToAlphaColor
      (Owner.LookAndFeelPainter.DefaultContentTextColor);
end;

function TdxActivityIndicatorViewInfo.GetProperties
  : TdxActivityIndicatorProperties;
begin
...
procedure TdxActivityIndicatorArcBasedViewInfo.Calculate(const ABounds
  : TdxRectF);
const
  Indent = 3;
var
...
begin
  ...
  ARadius := (Min(Bounds.Width, Bounds.Height) - Properties.ArcThickness -
    Indent) / 2;
...
procedure TdxActivityIndicatorArcBasedViewInfo.DrawContent
  (ACanvas: TdxGPCanvas);
var
  AAngle1, AAngle2: Double;
begin
  if (cxRectWidth(ArcArea) > 2 * ArcThickness) and
    (cxRectHeight(ArcArea) > 2 * ArcThickness) then
  begin
    Rule.CalculateAngles(Owner.AnimationController.CalculateProgress(0),
      AAngle1, AAngle2);
    ACanvas.Arc(ArcArea, AAngle1, AAngle2 - AAngle1, ArcColor, ArcThickness);
  end;
end;

function TdxActivityIndicatorArcBasedViewInfo.GetProperties
  : TdxActivityIndicatorArcBasedProperties;
begin
  Result := TdxActivityIndicatorArcBasedProperties(inherited Properties);
end;

function TdxActivityIndicatorArcBasedViewInfo.GetRule
  : TdxActivityIndicatorArcBasedRuleClass;
begin
...
constructor TdxActivityIndicatorDotBasedViewInfo.Create
  (AOwner: TdxCustomActivityIndicator);
begin
  inherited Create(AOwner);
...
procedure TdxActivityIndicatorDotBasedViewInfo.Calculate(const ABounds
  : TdxRectF);
begin
  inherited Calculate(ABounds);
...
procedure TdxActivityIndicatorDotBasedViewInfo.DrawContent
  (ACanvas: TdxGPCanvas);
var
  ADotSize: Double;
  APoint: TdxPointF;
...
begin
  ...
  begin
    ...
    begin
      ...
      ACanvas.Ellipse(cxRectCenter(cxRectF(APoint, APoint), ADotSize, ADotSize),
        nil, DotBrush);
    end;
  end;
end;

function TdxActivityIndicatorDotBasedViewInfo.GetProperties
  : TdxActivityIndicatorDotBasedProperties;
begin
  Result := TdxActivityIndicatorDotBasedProperties(inherited Properties);
end;

function TdxActivityIndicatorDotBasedViewInfo.GetRule
  : TdxActivityIndicatorDotBasedRuleClass;
begin
...
begin
  ...
  if GetRegisteredActivityIndicatorProperties.Count > 0 then
    PropertiesClassName := GetRegisteredActivityIndicatorProperties.Items[0]
      .ClassName;
end;
...
procedure TdxCustomActivityIndicator.ChangeScaleEx(M, D: Integer;
  isDpiChange: Boolean);
begin
  inherited;
...
function TdxCustomActivityIndicator.CreateAnimationController
  : TdxActivityIndicatorAnimationController;
begin
...
procedure TdxCustomActivityIndicator.DrawOpaqueBackground(ACanvas: TcxCanvas;
  const ARect: TRect);
begin
...
const
  SmoothingModeMap: array [Boolean] of TdxGPSmoothingMode = (smHighSpeed,
    smAntiAlias);
begin
  inherited DoPaint;
...
procedure TdxCustomActivityIndicator.LookAndFeelChanged(Sender: TcxLookAndFeel;
...
function TdxCustomActivityIndicator.GetPropertiesClass
...
procedure TdxCustomActivityIndicator.SetProperties
  (AValue: TdxActivityIndicatorProperties);
begin
  if AValue <> nil then
  begin
...
procedure TdxCustomActivityIndicator.SetPropertiesClass
  (AValue: TdxActivityIndicatorPropertiesClass);
var
  APrevActive: Boolean;
begin
...
procedure TdxCustomActivityIndicator.SetPropertiesClassName
  (const AValue: string);
begin
  if (AValue <> '') and
    (GetRegisteredActivityIndicatorProperties.FindByClassName(AValue) = nil)
  then
    Exit;
  PropertiesClass := TdxActivityIndicatorPropertiesClass
    (GetRegisteredActivityIndicatorProperties.FindByClassName(AValue));
end;
