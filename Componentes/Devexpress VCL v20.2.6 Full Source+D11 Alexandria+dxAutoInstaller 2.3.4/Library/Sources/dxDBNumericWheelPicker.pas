...
class function TdxDBNumericWheelPicker.GetPropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TdxNumericWheelPickerProperties;
end;

class function TdxDBNumericWheelPicker.GetDataBindingClass
  : TcxEditDataBindingClass;
begin
  Result := TcxDBEditDataBinding;
end;

function TdxDBNumericWheelPicker.GetActiveProperties
...
procedure TdxDBNumericWheelPicker.SetProperties
