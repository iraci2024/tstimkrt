...
const
  ...
  sdxWizardControlApplicationWizardName =
    'DevExpress VCL %version% Wizard Application';
...
type
  ...
  TdxOTACustomWizardControlWizard = class(TdxOTACustomRepositoryWizard,
    IOTAFormWizard)
  private
  ...
  TdxOTAWizardControlApplicationWizard = class(TdxOTACustomWizardControlWizard,
    IOTAProjectWizard)
  protected
...
constructor TdxOTACustomWizardControlWizard.Create(APersonality
  : TdxOTAPersonality);
begin
  inherited Create;
...
function TdxOTACustomWizardControlWizard.ExpandWizardControlName
  (const AFormat: string): string;
begin
  Result := StringReplace(AFormat, '%version%', dxGetShortBuildNumberAsString,
    [rfReplaceAll]);
end;
...
constructor TdxOTAWizardControlApplicationCreator.Create
...
function TdxOTAWizardControlApplicationCreator.GetPersonality
  : TdxOTAPersonality;
begin
  Result := FPersonality;
end;
...
begin
  ...
  begin
    AModuleServices.CreateModule(TdxOTAWizardControlApplicationCreator.Create
      (Personality));
    AModuleServices.CreateModule(TdxOTAWizardControlFormCreator.Create
      (Personality));
  end;
end;

function TdxOTAWizardControlApplicationWizard.GetCategory
...
constructor TdxOTAWizardControlFormCreator.Create(APersonality
  : TdxOTAPersonality);
var
...
function TdxOTAWizardControlFormCreator.LoadTemplate
...
procedure TdxOTAWizardControlFormCreator.LoadTemplates
  (APersonality: TdxOTAPersonality; out AFormTemplate, AImplTemplate,
