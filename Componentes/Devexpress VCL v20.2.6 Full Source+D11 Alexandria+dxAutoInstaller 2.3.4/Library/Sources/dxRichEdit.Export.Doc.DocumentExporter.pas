...
function TdxDocDocumentExporter.FormatEquals(const AValue
...
function TdxDocDocumentExporter.SaveDocument(const ADocumentModel
...
begin
  AModel.InternalAPI.SaveDocumentDocContent(AStream,
    TdxDocDocumentExporterOptions(AOptions));
  Result := True;
end;
