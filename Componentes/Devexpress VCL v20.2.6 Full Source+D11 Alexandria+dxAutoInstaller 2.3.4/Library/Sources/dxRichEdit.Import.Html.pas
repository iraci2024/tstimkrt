...
type
  ...
  public
    ...
    property CaptionColSpan: Integer read FCaptionColSpan
      write SetCaptionColSpan;
  end;
  ...
  protected
    function CreateTableInfo(ANewTable: TdxTable)
      : TdxImportedTableInfo; override;
    function CreateCoveredCellWithEmptyParagraph(ARow: TdxTableRow)
  ...
  TdxHtmlTranslateKeywordHandler = function(AImporter: TdxHtmlImporter)
    : TdxTagBase;

  TdxHtmlKeywordTranslatorTable = class
    (TdxEnumeratedDictionary<TdxHtmlTagNameID, TdxHtmlTranslateKeywordHandler>);
  ...
  protected
    ...
    class function CreateHtmlKeywordTable
      : TdxHtmlKeywordTranslatorTable; static;
    class function AbbrKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function AcronymKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function AddressKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function AreaKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function BaseFontKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function BdoKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function BgsoundKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function ButtonKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function CiteKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function DdKeywordTag(AImporter: TdxHtmlImporter): TdxTagBase; static;
    class function DelKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function DfnKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    ...
    class function EmbedKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function FieldsetKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function FormKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function FrameKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function FrameSetKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function HrKeywordTag(AImporter: TdxHtmlImporter): TdxTagBase; static;
    class function IframeKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function InputKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function InsKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function KbdKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function LabelKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function LegendKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function MapKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function MarqueeKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function NobrKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function NoembedKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function NoFramesKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function NoScriptKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function ObjectKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function OptGroupKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function OptionKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function ParamKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function QKeywordTag(AImporter: TdxHtmlImporter): TdxTagBase; static;
    class function SampKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function SelectKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function TableKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function TdKeywordTag(AImporter: TdxHtmlImporter): TdxTagBase; static;
    class function TextAreaKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function ThKeywordTag(AImporter: TdxHtmlImporter): TdxTagBase; static;
    class function TFootKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function CaptionKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function TBodyKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function THeadKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    ...
    class function VarKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function WbrKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function XmpKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function HtmlKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function HeadKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function BaseKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function MetaKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function BodyKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function TitleKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function LinkKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function AnchorKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function BoldKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function ItalicKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function UnderlineKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function ParagraphKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function StrongKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function BigKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function SmallKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function PreformattedKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function FontKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function LineBreakKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function EmphasizedKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function ImageKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function SubScriptKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function SuperScriptKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function CenterKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function StrikeoutKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function Heading1KeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function Heading2KeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function Heading3KeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function Heading4KeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function Heading5KeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function Heading6KeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function NumberingListKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function BulletListKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function LevelKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function CodeKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function SpanKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function DivisionKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function ScriptKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function BlockquoteKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    class function NamespaceKeywordTag(AImporter: TdxHtmlImporter)
      : TdxTagBase; static;
    ...
    procedure ParseHtmlContent(AHtmlElements: TdxHtmlElementList;
      AStreamReader: TStreamReader); virtual;
    procedure FixBordersAndParagraphBetweenTables
      (APieceTable: TdxPieceTable); virtual;
    procedure FixBordersAndParagraphBetweenTablesCore
      (ATables: TdxList<TdxTable>); virtual;
    procedure ResolveBorderConflicts(ATable: TdxTable); virtual;
    function ShouldResetTableCellBorder(AUseTableBorder: Boolean;
      AUseCellBorder: Boolean; ATableBorder: TdxBorderBase;
      ACellBorder: TdxBorderBase): Boolean; virtual;
    procedure InsertParagraphBeforeTable(ATable: TdxTable);
    procedure ShiftBookmarks(ALogPosition: TdxDocumentLogPosition);
    class function TableComparer(const ALeft, ARight: TdxTable)
      : Integer; static;
    function GetTablesByLevel(APieceTable: TdxPieceTable; ANestedLevel: Integer)
      : TdxList<TdxTable>; virtual;
    ...
    procedure StyleTagIsNotOpen(AStreamReader: TStreamReader;
    ...
    function GetSpecialValue(const ASpecialSymbol: string; AIsNumeric: Boolean)
      : Char; virtual;
    function GetUnicodeSymbol(const ASpecialSymbol: string): Char;
    function TryParseSymbol(const ASpecialSymbol: string;
    ...
    function CreateUriBasedRichEditImageCore(const AUri: string;
      APixelTargetWidth: Integer; APixelTargetHeight: Integer)
      : TdxUriOfficeImage;
    function ApplyPositionScriptFontSize: TdxFontSizeInfo; virtual;
    procedure RestorePositionScriptFontSize(const AFontSizeInfo
      : TdxFontSizeInfo); virtual;
  ...
  public
    constructor Create(ADocumentModel: TdxDocumentModel;
      AOptions: TdxHtmlDocumentImporterOptions); reintroduce;
    destructor Destroy; override;

    class function CreateHtmlSpecialSymbolTable
      : TdxHtmlSpecialSymbolTable; static;
    class function GetDefaultEncoding(AStream: TStream): TEncoding; static;
    procedure AppendInlineImage(AImage: TdxOfficeImageReference;
      AScaleX, AScaleY: Single; const ADesiredSize: TSize); overload; virtual;
    ...
    procedure AppendText(APieceTable: TdxPieceTable; const AText: string);
      overload; virtual;
    function ApplyEncoding(const AContentText: string): string;
    function CreateUriBasedRichEditImage(const AUri: string;
      APixelTargetWidth: Integer; APixelTargetHeight: Integer)
      : TdxUriOfficeImage;
    ...
    procedure ImportCore(AStream: TStream; APos: TdxHtmlInputPosition);
      reintroduce;
    ...
    procedure ParseCssElementCollection(const ARawText: string);
      overload; virtual;
    procedure ParseCssElementCollection(AReader: TTextReader); overload;
    procedure RemoveEmptyHyperlinks;
    procedure RegisterCommentMarksToCollectPositions(const AMarks
      : array of string);
    ...
    property HtmlKeywordTable: TdxHtmlKeywordTranslatorTable
      read GetHtmlKeywordTable;
    property HtmlNamespaces: TdxStringsDictionary read FHtmlNamespaces;
    property SpecialSymbolTable: TdxHtmlSpecialSymbolTable
      read GetSpecialSymbolTable;
    ...
    property IsEmptyParagraph: Boolean read FIsEmptyParagraph
      write SetIsEmptyParagraph;
    property IsEmptyLine: Boolean read FIsEmptyLine write FIsEmptyLine;
    property IsEmptyListItem: Boolean read FIsEmptyListItem
      write FIsEmptyListItem;
    property StyleTagCollection: TdxCssElementCollection
      read FStyleTagCollection;
    property HtmlFontSize: TdxHtmlFontSize read FHtmlFontSize;
    property RootDoubleFontSize: Integer read FRootDoubleFontSize
      write FRootDoubleFontSize;
    ...
    property LastOpenParagraphTagIndex: Integer read FLastOpenParagraphTagIndex
      write FLastOpenParagraphTagIndex;
    property LastOpenAnchorTagIndex: Integer read FLastOpenAnchorTagIndex
      write FLastOpenAnchorTagIndex;
    property ProcessHyperlink: TdxImportFieldInfo read FProcessHyperlink
      write SetProcessHyperlink;
    property ProcessBookmarks: TdxObjectStack<TdxHtmlBookmarkInfo>
      read FProcessBookmarks;
    property TablesImportHelper: TdxHtmlTablesImportHelper
      read FTablesImportHelper;
    property UsedNumberingLists: TdxSortedList<TdxNumberingListIndex>
      read FUsedNumberingLists;
    property Parser: TdxHtmlParser read FParser;
    property AbsoluteBaseUri: string read FAbsoluteBaseUri
      write FAbsoluteBaseUri;
  end;
  ...
  TdxPieceTablePasteHtmlTextCommand = class
  ...
  public
    constructor Create(const ASourseUri, AContent: string;
      AFragmentStart, AFragmentEnd: Integer);
  ...
  protected
    ...
    function CalculateFragmentStart(ADescription: TdxStringsDictionary)
      : Integer;
    function CalculateFragmentEnd(ADescription: TdxStringsDictionary): Integer;
    function CreateContentDescription(const AContent: TArray<Byte>)
      : TdxStringsDictionary;
    function CalculateHtmlContentOffset(ADescription: TdxStringsDictionary)
      : Integer; virtual;
    function GetIntegerValue(ADescription: TdxStringsDictionary;
      const AKey: string): Integer;
    function CalculateSourceUri(ADescription: TdxStringsDictionary)
      : string; virtual;
  public
  ...
  TdxPieceTablePasteHtmlClipboardDataCommand = class
    (TdxPieceTablePasteHtmlTextCommand)
  strict protected
  const
  ...
  protected
    ...
    procedure PopulateDocumentModelFromContentStringCore(ADocumentModel
      : TdxDocumentModel; AContent: TdxClipboardStringContent;
      const ASizeCollection: string); override;
    procedure CopyFragment(ASourceModel, ATargetModel: TdxDocumentModel;
      AStartFragmentPos, AEndFragmentPos: TdxDocumentLogPosition);
    function ClearHTMLContent(const AHtmlContent: string;
      AStartFragent, AEndFragment: Integer): string;
  ...
  TdxPasteHtmlTextCommand = class
    (TdxPasteContentConvertedToDocumentModelCommandBase)
  protected
    function CreateInnerCommandCore
      : TdxPieceTablePasteContentConvertedToDocumentModelCommandBase; override;
  public
...
type
  ...
  public
    class function ApplyEncoding(const AContent: string; AEncoding: TEncoding)
      : string; static;
  end;
  ...
  protected
    ...
    procedure ProcessTableRowOpenTag(AElement: TdxHtmlElement);
      virtual; abstract;
    procedure ProcessTableRowCloseTag(AElement: TdxHtmlElement);
      virtual; abstract;
    procedure ProcessTableCellOpenTag(AElement: TdxHtmlElement);
      virtual; abstract;
    procedure ProcessTableCellCloseTag(AElement: TdxHtmlElement);
      virtual; abstract;
    procedure ProcessNonTableElement(AElement: TdxHtmlElement);
      virtual; abstract;
    procedure ProcessCaptionOpenTag(AElement: TdxHtmlElement); virtual;
      abstract;
    procedure ProcessCaptionCloseTag(AElement: TdxHtmlElement);
      virtual; abstract;
  ...
  public
    constructor Create(ACorrector: TdxHtmlCorrector;
      AOutput: TdxHtmlElementList);
    destructor Destroy; override;

    procedure ProcessEnd; virtual; abstract;
    procedure Process(AHtmlElement: TdxHtmlElement); virtual;
    class function IsWhiteSpaceElement(AElement: TdxHtmlElement)
      : Boolean; static;
  ...
  public
    constructor Create(ACorrector: TdxHtmlCorrector;
      AOutput: TdxHtmlElementList; AFirstRow: Boolean);
    destructor Destroy; override;
    procedure ProcessEnd; override;
  end;
  ...
  TdxHtmlCorrector = class
  strict private
    FStates: TdxList<TdxHtmlCorrectorStateBase>;
    // TdxObjectList<TdxHtmlCorrectorStateBase>;
  ...
  public
    ...
    function GetCorrectedHtmlElements(AHtmlElements: TdxHtmlElementList;
      out AHtmlTagPresent: Boolean): TdxHtmlElementList;
    function CalculateHtmlElementBeforeComment(AComment: TdxComment;
      AList: TdxHtmlElementList; AIndex: Integer): TdxHtmlElement;
    function CalculateHtmlElementAfterComment(AComment: TdxComment;
      AList: TdxHtmlElementList; AIndex: Integer): TdxHtmlElement;
    procedure InsertStartComment(ANewComment: TdxComment;
      AOutput: TdxHtmlElementList; ABeforeComment: TdxHtmlElement);
    procedure InsertEndComment(ANewComment: TdxComment;
      AOutput: TdxHtmlElementList; AAfterComment: TdxHtmlElement);
...
class function TdxHtmlCodePageDecoder.ApplyEncoding(const AContent: string;
...
begin
  ...
  begin
    ...
    if (AEncoding <> nil) and (AEncoding.GetCharCount(ABytes, 0, ACount) > 0)
    then
      Result := AEncoding.GetString(ABytes, 0, ACount)
    else
      Result := AContent;
...
constructor TdxHtmlCorrectorStateBase.Create(ACorrector: TdxHtmlCorrector;
  AOutput: TdxHtmlElementList);
begin
...
procedure TdxHtmlCorrectorStateBase.ProcessTableHeaderCellOpenTag
  (AElement: TdxHtmlElement);
begin
  ProcessTableCellOpenTag(AElement);
end;

procedure TdxHtmlCorrectorStateBase.ProcessTableHeaderCellCloseTag
  (AElement: TdxHtmlElement);
begin
  ProcessTableCellCloseTag(AElement);
end;

procedure TdxHtmlCorrectorStateBase.ProcessTheadOpenTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorStateBase.ProcessTheadCloseTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorStateBase.ProcessTfootOpenTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorStateBase.ProcessTfootCloseTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorStateBase.ProcessTbodyOpenTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorStateBase.ProcessTbodyCloseTag
  (AElement: TdxHtmlElement);
begin
end;
...
procedure TdxHtmlCorrectorStateBase.ProcessColCloseTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorStateBase.ProcessColgroupOpenTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorStateBase.ProcessColgroupCloseTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorStateBase.ProcessWhiteSpaceElement
  (AElement: TdxHtmlElement);
begin
...
begin
  ...
  if (ATag <> nil) and ProcessTableTag(ATag) then
    Exit
  else if IsWhiteSpaceElement(AHtmlElement) then
...
class function TdxHtmlCorrectorStateBase.IsWhiteSpaceElement
  (AElement: TdxHtmlElement): Boolean;
var
  ARawText: string;
  I: Integer;
begin
  ...
  for I := 1 to Length(ARawText) do
    if {$IFDEF DELPHIXE4}not ARawText[I].IsWhiteSpace{$ELSE}not TCharacter.
      IsWhiteSpace(ARawText, I){$ENDIF} then
      Exit(False);
  Result := True;
end;
...
procedure TdxHtmlCorrectorDefaultState.ProcessTableOpenTag
  (AElement: TdxHtmlElement);
begin
  CurrentOutput.Add(AElement);
...
procedure TdxHtmlCorrectorDefaultState.ProcessTableCloseTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorDefaultState.ProcessNonTableElement
  (AElement: TdxHtmlElement);
begin
  CurrentOutput.Add(AElement);
end;

procedure TdxHtmlCorrectorDefaultState.ProcessTableRowOpenTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorDefaultState.ProcessTableRowCloseTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorDefaultState.ProcessTableCellOpenTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorDefaultState.ProcessTableCellCloseTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorDefaultState.ProcessCaptionOpenTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorDefaultState.ProcessCaptionCloseTag
  (AElement: TdxHtmlElement);
begin
end;
...
constructor TdxHtmlCorrectorTableStateBase.Create(ACorrector: TdxHtmlCorrector;
  AOutput: TdxHtmlElementList);
begin
...
procedure TdxHtmlCorrectorTableStateBase.ProcessTableOpenTag
  (AElement: TdxHtmlElement);
begin
...
procedure TdxHtmlCorrectorTableStateBase.ProcessNonTableElement
  (AElement: TdxHtmlElement);
begin
...
procedure TdxHtmlCorrectorTableStateBase.ProcessTableRowOpenTag
  (AElement: TdxHtmlElement);
begin
...
procedure TdxHtmlCorrectorTableStateBase.ProcessTableRowCloseTag
  (AElement: TdxHtmlElement);
begin
  if HasRows then
    Exit;
...
procedure TdxHtmlCorrectorTableStateBase.ProcessTableCellOpenTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceOpenTableRow;
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableStateBase.ProcessTableCellCloseTag
  (AElement: TdxHtmlElement);
begin
  if HasRows then
    Exit;
...
procedure TdxHtmlCorrectorTableStateBase.AddMisplacedCellContent
  (AElement: TdxHtmlElement);
begin
...
procedure TdxHtmlCorrectorTableStateBase.OnStartCell
  (AElements: TdxHtmlElementList);
var
...
constructor TdxHtmlCorrectorTableState.Create(ACorrector: TdxHtmlCorrector;
  AOutput: TdxHtmlElementList);
begin
  inherited Create(ACorrector, AOutput);
...
procedure TdxHtmlCorrectorTableState.ProcessTableCloseTag
  (AElement: TdxHtmlElement);
begin
  EnsureTableHasRows;
...
procedure TdxHtmlCorrectorTableState.ProcessCaptionOpenTag
  (AElement: TdxHtmlElement);
begin
...
procedure TdxHtmlCorrectorTableState.ProcessCaptionCloseTag
  (AElement: TdxHtmlElement);
begin
...
procedure TdxHtmlCorrectorTableState.ProcessTbodyOpenTag
  (AElement: TdxHtmlElement);
begin
...
procedure TdxHtmlCorrectorTableState.ProcessTheadOpenTag
  (AElement: TdxHtmlElement);
begin
...
procedure TdxHtmlCorrectorTableState.ProcessTfootOpenTag
  (AElement: TdxHtmlElement);
begin
...
constructor TdxHtmlCorrectorTableRowState.Create(ACorrector: TdxHtmlCorrector;
  AOutput: TdxHtmlElementList; AFirstRow: Boolean);
begin
  inherited Create(ACorrector, AOutput);
  FFirstRow := AFirstRow;
...
procedure TdxHtmlCorrectorTableRowState.ProcessTableOpenTag
  (AElement: TdxHtmlElement);
begin
  Assert(FOutput = nil);
...
procedure TdxHtmlCorrectorTableRowState.ProcessNonTableElement
  (AElement: TdxHtmlElement);
begin
  Corrector.AddMisplacedCellContent(AElement);
end;

procedure TdxHtmlCorrectorTableRowState.ProcessTableCloseTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTableRow;
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableRowState.ProcessTableRowOpenTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTableRow;
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableRowState.ProcessTableRowCloseTag
  (AElement: TdxHtmlElement);
begin
...
procedure TdxHtmlCorrectorTableRowState.ProcessTableCellOpenTag
  (AElement: TdxHtmlElement);
begin
  FHasCells := True;
  CurrentOutput.Add(AElement);
...
procedure TdxHtmlCorrectorTableRowState.ProcessTableCellCloseTag
  (AElement: TdxHtmlElement);
begin
  if FHasCells then
    Exit;
...
procedure TdxHtmlCorrectorTableRowState.ProcessCaptionOpenTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTableRow;
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableRowState.ProcessCaptionCloseTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTableRow;
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableCellState.ProcessNonTableElement
  (AElement: TdxHtmlElement);
begin
  CurrentOutput.Add(AElement);
end;

procedure TdxHtmlCorrectorTableCellState.ProcessTableOpenTag
  (AElement: TdxHtmlElement);
begin
  CurrentOutput.Add(AElement);
  Corrector.StartNewTable(CurrentOutput);
...
procedure TdxHtmlCorrectorTableCellState.ProcessTableCloseTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTableCell;
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableCellState.ProcessTableRowOpenTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTableCell;
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableCellState.ProcessTableRowCloseTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTableCell;
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableCellState.ProcessTableCellOpenTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTableCell;
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableCellState.ProcessTableCellCloseTag
  (AElement: TdxHtmlElement);
begin
...
procedure TdxHtmlCorrectorTableCellState.ProcessCaptionOpenTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTableCell;
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableCellState.ProcessCaptionCloseTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTableCell;
  Corrector.Process(AElement);
...
constructor TdxHtmlCorrectorTableCaptionState.Create
  (ACorrector: TdxHtmlCorrector; AOutput: TdxHtmlElementList);
begin
...
procedure TdxHtmlCorrectorTableCaptionState.ProcessNonTableElement
  (AElement: TdxHtmlElement);
begin
  CurrentOutput.Add(AElement);
  FEmpty := False;
...
procedure TdxHtmlCorrectorTableCaptionState.ProcessTableOpenTag
  (AElement: TdxHtmlElement);
begin
  CurrentOutput.Add(AElement);
  Corrector.StartNewTable(CurrentOutput);
...
procedure TdxHtmlCorrectorTableCaptionState.ProcessTableCloseTag
  (AElement: TdxHtmlElement);
begin
...
procedure TdxHtmlCorrectorTableCaptionState.ProcessTableRowOpenTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseCaption;
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableCaptionState.ProcessTableRowCloseTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseCaption;
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableCaptionState.ProcessTableCellOpenTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseCaption;
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableCaptionState.ProcessTableCellCloseTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseCaption;
  CurrentOutput.Add(AElement);
...
procedure TdxHtmlCorrectorTableCaptionState.ProcessCaptionOpenTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorTableCaptionState.ProcessCaptionCloseTag
  (AElement: TdxHtmlElement);
begin
  if not FEmpty then
  begin
...
procedure TdxHtmlCorrectorTableBodyState.ProcessTbodyCloseTag
  (AElement: TdxHtmlElement);
begin
  EnsureTableHasRows;
  CurrentOutput.AddRange(InnerOutput);
...
procedure TdxHtmlCorrectorTableBodyState.ProcessTbodyOpenTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorTableBodyState.ProcessTableCloseTag
  (AElement: TdxHtmlElement);
begin
...
procedure TdxHtmlCorrectorTableBodyState.ProcessTfootOpenTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTag(TdxHtmlTagNameID.Tbody);
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableBodyState.ProcessTheadOpenTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTag(TdxHtmlTagNameID.Tbody);
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableBodyState.ProcessCaptionOpenTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTag(TdxHtmlTagNameID.Tbody);
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableBodyState.ProcessCaptionCloseTag
  (AElement: TdxHtmlElement);
begin
end;
...
procedure TdxHtmlCorrectorTableHeaderState.ProcessTheadOpenTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorTableHeaderState.ProcessTheadCloseTag
  (AElement: TdxHtmlElement);
begin
  EnsureTableHasRows;
  CurrentOutput.AddRange(InnerOutput);
...
procedure TdxHtmlCorrectorTableHeaderState.ProcessTbodyOpenTag
  (AElement: TdxHtmlElement);
begin
...
procedure TdxHtmlCorrectorTableHeaderState.ProcessTableCloseTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTag(TdxHtmlTagNameID.Thead);
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableHeaderState.ProcessCaptionOpenTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTag(TdxHtmlTagNameID.Thead);
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableHeaderState.ProcessCaptionCloseTag
  (AElement: TdxHtmlElement);
begin
end;
...
procedure TdxHtmlCorrectorTableFooterState.ProcessTbodyOpenTag
  (AElement: TdxHtmlElement);
begin
...
procedure TdxHtmlCorrectorTableFooterState.ProcessTfootOpenTag
  (AElement: TdxHtmlElement);
begin
end;

procedure TdxHtmlCorrectorTableFooterState.ProcessTfootCloseTag
  (AElement: TdxHtmlElement);
begin
  EnsureTableHasRows;
  CurrentOutput.AddRange(InnerOutput);
...
procedure TdxHtmlCorrectorTableFooterState.ProcessTableCloseTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTag(TdxHtmlTagNameID.Tfoot);
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableFooterState.ProcessCaptionOpenTag
  (AElement: TdxHtmlElement);
begin
  Corrector.ForceCloseTag(TdxHtmlTagNameID.Tfoot);
  Corrector.Process(AElement);
...
procedure TdxHtmlCorrectorTableFooterState.ProcessCaptionCloseTag
  (AElement: TdxHtmlElement);
begin
end;
...
function TdxHtmlCorrector.GetCorrectedHtmlElements(AHtmlElements
  : TdxHtmlElementList; out AHtmlTagPresent: Boolean): TdxHtmlElementList;
var
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        ABeforeStartComment := CalculateHtmlElementBeforeComment(AComment,
          AHtmlElements, I);
      end;
      if AComment.CommentText = 'EndFragment' then
      begin
        AEndComment := AComment;
        AAfterEndComment := CalculateHtmlElementAfterComment(AComment,
          AHtmlElements, I);
      end;
    end
    else
    begin
      if not AHtmlTagPresent and
        (AElement.ElementType = TdxHtmlElementType.OpenTag) then
      begin
...
function TdxHtmlCorrector.CalculateHtmlElementBeforeComment
  (AComment: TdxComment; AList: TdxHtmlElementList; AIndex: Integer)
  : TdxHtmlElement;
var
  I: Integer;
begin
...
function TdxHtmlCorrector.CalculateHtmlElementAfterComment(AComment: TdxComment;
  AList: TdxHtmlElementList; AIndex: Integer): TdxHtmlElement;
var
  ACount, I: Integer;
begin
...
procedure TdxHtmlCorrector.InsertStartComment(ANewComment: TdxComment;
  AOutput: TdxHtmlElementList; ABeforeComment: TdxHtmlElement);
begin
...
procedure TdxHtmlCorrector.InsertEndComment(ANewComment: TdxComment;
  AOutput: TdxHtmlElementList; AAfterComment: TdxHtmlElement);
begin
...
procedure TdxHtmlCorrector.StartNewRow(AOutput: TdxHtmlElementList;
  AFirstRow: Boolean);
var
...
procedure TdxHtmlCorrector.AddMisplacedCellContent
  (AElements: TdxHtmlElementList);
begin
...
procedure TdxHtmlCorrector.ReturnToPrevStateFromCellState(ALastCellPosition
  : Integer);
begin
...
begin
  ...
  else if State is TdxHtmlCorrectorTableCellState then
  begin
    Assert((FStates.Count > 3) and
      (FStates[FStates.Count - 3] is TdxHtmlCorrectorTableStateBase));
    FLastOpenedTableState := TdxHtmlCorrectorTableStateBase
      (FStates[FStates.Count - 3]);
  end
  else if State is TdxHtmlCorrectorTableRowState then
  begin
    Assert((FStates.Count > 2) and
      (FStates[FStates.Count - 2] is TdxHtmlCorrectorTableStateBase));
    FLastOpenedTableState := TdxHtmlCorrectorTableStateBase
      (FStates[FStates.Count - 2]);
  end
  else if State is TdxHtmlCorrectorTableState then
  begin
    Assert((FStates.Count > 1) and
      (FStates[FStates.Count - 1] is TdxHtmlCorrectorTableStateBase));
    FLastOpenedTableState := TdxHtmlCorrectorTableStateBase
      (FStates[FStates.Count - 1]);
  end;
end;

{ TdxFontSizeInfo }

constructor TdxFontSizeInfo.Create(ADoubleFontSize: Integer;
...
constructor TdxHtmlTablesImportHelper.Create(APieceTable: TdxPieceTable;
...
function TdxHtmlTablesImportHelper.CreateTableInfo(ANewTable: TdxTable)
  : TdxImportedTableInfo;
begin
  Result := TdxHtmlImportedTableInfo.Create(ANewTable);
end;

function TdxHtmlTablesImportHelper.CreateCoveredCellWithEmptyParagraph
...
var
  ...
  AOldParagraphsCount, ACurrentParagraphsCount, ADiffLogPosition,
    ADiffParagraphIndex: Integer;
begin
  ...
  Importer.Position.LogPosition := Importer.Position.LogPosition -
    ADiffLogPosition;
  Importer.Position.ParagraphIndex := Importer.Position.ParagraphIndex -
    ADiffParagraphIndex;
end;

{ TdxHtmlImporter }

constructor TdxHtmlImporter.Create(ADocumentModel: TdxDocumentModel;
...
class function TdxHtmlImporter.CreateHtmlSpecialSymbolTable
  : TdxHtmlSpecialSymbolTable;
begin
...
class function TdxHtmlImporter.CreateHtmlKeywordTable
  : TdxHtmlKeywordTranslatorTable;
begin
...
class function TdxHtmlImporter.AbbrKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxAbberTag.Create(AImporter);
end;

class function TdxHtmlImporter.AcronymKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxAcronymTag.Create(AImporter);
end;

class function TdxHtmlImporter.AddressKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxAddressTag.Create(AImporter);
end;

class function TdxHtmlImporter.AreaKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxAreaTag.Create(AImporter);
end;

class function TdxHtmlImporter.BaseFontKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxBaseFontTag.Create(AImporter);
end;

class function TdxHtmlImporter.BdoKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxBdoTag.Create(AImporter);
end;

class function TdxHtmlImporter.BgsoundKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxBgsoundTag.Create(AImporter);
end;

class function TdxHtmlImporter.ButtonKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxButtonTag.Create(AImporter);
end;

class function TdxHtmlImporter.CiteKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxCiteTag.Create(AImporter);
end;

class function TdxHtmlImporter.DdKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxDdTag.Create(AImporter);
end;

class function TdxHtmlImporter.DelKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxDelTag.Create(AImporter);
end;

class function TdxHtmlImporter.DfnKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxDfnTag.Create(AImporter);
end;

class function TdxHtmlImporter.DlKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxDlTag.Create(AImporter);
end;

class function TdxHtmlImporter.DtKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxDtTag.Create(AImporter);
end;

class function TdxHtmlImporter.EmbedKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxEmbedTag.Create(AImporter);
end;

class function TdxHtmlImporter.FieldsetKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxFieldsetTag.Create(AImporter);
end;

class function TdxHtmlImporter.FormKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxFormTag.Create(AImporter);
end;

class function TdxHtmlImporter.FrameKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxFrameTag.Create(AImporter);
end;

class function TdxHtmlImporter.FrameSetKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxFrameSetTag.Create(AImporter);
end;

class function TdxHtmlImporter.HrKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxHrTag.Create(AImporter);
end;

class function TdxHtmlImporter.IframeKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxIframeTag.Create(AImporter);
end;

class function TdxHtmlImporter.InputKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxInputTag.Create(AImporter);
end;

class function TdxHtmlImporter.InsKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxInsTag.Create(AImporter);
end;

class function TdxHtmlImporter.KbdKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxKbdTag.Create(AImporter);
end;

class function TdxHtmlImporter.LabelKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxLabelTag.Create(AImporter);
end;

class function TdxHtmlImporter.LegendKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxLegendTag.Create(AImporter);
end;

class function TdxHtmlImporter.MapKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxMapTag.Create(AImporter);
end;

class function TdxHtmlImporter.MarqueeKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxMarqueeTag.Create(AImporter);
end;

class function TdxHtmlImporter.NamespaceKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxNamespaceTag.Create(AImporter);
end;

class function TdxHtmlImporter.NobrKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxNobrTag.Create(AImporter);
end;

class function TdxHtmlImporter.NoembedKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxNoembedTag.Create(AImporter);
end;

class function TdxHtmlImporter.NoFramesKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxNoFramesTag.Create(AImporter);
end;

class function TdxHtmlImporter.NoScriptKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxNoScriptTag.Create(AImporter);
end;

class function TdxHtmlImporter.ObjectKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxObjectTag.Create(AImporter);
end;

class function TdxHtmlImporter.OptGroupKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxOptGroupTag.Create(AImporter);
end;

class function TdxHtmlImporter.OptionKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxOptionTag.Create(AImporter);
end;

class function TdxHtmlImporter.ParamKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxParamTag.Create(AImporter);
end;

class function TdxHtmlImporter.QKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxQTag.Create(AImporter);
end;

class function TdxHtmlImporter.SampKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxSampTag.Create(AImporter);
end;

class function TdxHtmlImporter.SelectKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxSelectTag.Create(AImporter);
end;

class function TdxHtmlImporter.TableKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxTableTag.Create(AImporter);
end;

class function TdxHtmlImporter.TdKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxTdTag.Create(AImporter);
end;

class function TdxHtmlImporter.TextAreaKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxTextAreaTag.Create(AImporter);
end;

class function TdxHtmlImporter.ThKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxThTag.Create(AImporter);
end;

class function TdxHtmlImporter.TFootKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TFootTag.Create(AImporter);
end;

class function TdxHtmlImporter.CaptionKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxCaptionTag.Create(AImporter);
end;

class function TdxHtmlImporter.TBodyKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TBodyTag.Create(AImporter);
end;

class function TdxHtmlImporter.THeadKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := THeadTag.Create(AImporter);
end;

class function TdxHtmlImporter.TrKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxTrTag.Create(AImporter);
end;

class function TdxHtmlImporter.TtKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxTtTag.Create(AImporter);
end;

class function TdxHtmlImporter.VarKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxVarTag.Create(AImporter);
end;

class function TdxHtmlImporter.WbrKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxWbrTag.Create(AImporter);
end;

class function TdxHtmlImporter.XmpKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxXmpTag.Create(AImporter);
end;

class function TdxHtmlImporter.HtmlKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxHtmlTag.Create(AImporter);
end;

class function TdxHtmlImporter.HeadKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxHeadTag.Create(AImporter);
end;

class function TdxHtmlImporter.BaseKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxBaseTag.Create(AImporter);
end;

class function TdxHtmlImporter.MetaKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxMetaTag.Create(AImporter);
end;

class function TdxHtmlImporter.BodyKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxBodyTag.Create(AImporter);
end;

class function TdxHtmlImporter.TitleKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxTitleTag.Create(AImporter);
end;

class function TdxHtmlImporter.LinkKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxLinkTag.Create(AImporter);
end;

class function TdxHtmlImporter.AnchorKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxAnchorTag.Create(AImporter);
end;

class function TdxHtmlImporter.BoldKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxBoldTag.Create(AImporter);
end;

class function TdxHtmlImporter.ItalicKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxItalicTag.Create(AImporter);
end;

class function TdxHtmlImporter.UnderlineKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxUnderlineTag.Create(AImporter);
end;

class function TdxHtmlImporter.ParagraphKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxParagraphTag.Create(AImporter);
end;

class function TdxHtmlImporter.StrongKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxStrongTag.Create(AImporter);
end;

class function TdxHtmlImporter.BigKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxBigTag.Create(AImporter);
end;

class function TdxHtmlImporter.SmallKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxSmallTag.Create(AImporter);
end;

class function TdxHtmlImporter.PreformattedKeywordTag
  (AImporter: TdxHtmlImporter): TdxTagBase;
begin
  Result := TdxPreformattedTag.Create(AImporter);
end;

class function TdxHtmlImporter.FontKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxFontTag.Create(AImporter);
end;

class function TdxHtmlImporter.LineBreakKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxLineBreakTag.Create(AImporter);
end;

class function TdxHtmlImporter.EmphasizedKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxEmphasizedTag.Create(AImporter);
end;

class function TdxHtmlImporter.ImageKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxImageTag.Create(AImporter);
end;

class function TdxHtmlImporter.SubScriptKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxSubScriptTag.Create(AImporter);
end;

class function TdxHtmlImporter.SuperScriptKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxSuperScriptTag.Create(AImporter);
end;

class function TdxHtmlImporter.CenterKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxCenterTag.Create(AImporter);
end;

class function TdxHtmlImporter.StrikeoutKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxStrikeoutTag.Create(AImporter);
end;

class function TdxHtmlImporter.Heading1KeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxHeadingTag.Create(AImporter, 6, 1);
end;

class function TdxHtmlImporter.Heading2KeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxHeadingTag.Create(AImporter, 5, 2);
end;

class function TdxHtmlImporter.Heading3KeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxHeadingTag.Create(AImporter, 4, 3);
end;

class function TdxHtmlImporter.Heading4KeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxHeadingTag.Create(AImporter, 3, 4);
end;

class function TdxHtmlImporter.Heading5KeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxHeadingTag.Create(AImporter, 2, 5);
end;

class function TdxHtmlImporter.Heading6KeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxHeadingTag.Create(AImporter, 1, 6);
end;

class function TdxHtmlImporter.NumberingListKeywordTag
  (AImporter: TdxHtmlImporter): TdxTagBase;
begin
  Result := TdxNumberingListTag.Create(AImporter);
end;

class function TdxHtmlImporter.BulletListKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxBulletListTag.Create(AImporter);
end;

class function TdxHtmlImporter.LevelKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxLevelTag.Create(AImporter);
end;

class function TdxHtmlImporter.CodeKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxCodeTag.Create(AImporter);
end;

class function TdxHtmlImporter.SpanKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxSpanTag.Create(AImporter);
end;

class function TdxHtmlImporter.DivisionKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxDivisionTag.Create(AImporter);
end;

class function TdxHtmlImporter.ScriptKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
  Result := TdxScriptTag.Create(AImporter);
end;

class function TdxHtmlImporter.BlockquoteKeywordTag(AImporter: TdxHtmlImporter)
  : TdxTagBase;
begin
...
begin
  Result := (TagsStack.Count > 0) and TagsStack[TagsStack.Count - 1]
    .Tag.ShouldBeIgnored;
end;
...
procedure TdxHtmlImporter.ImportCore(AStream: TStream;
  APos: TdxHtmlInputPosition);
var
  AHtmlElements: TdxHtmlElementList;
...
begin
  ...
  try
    ...
    AStreamReader := TStreamReader.Create(AStream, GetDefaultEncoding(AStream),
      False, 256);
    try
      AStreamReader.Peek;
...
begin
  ...
  FStyleTagCollection.Sort(TComparer<TdxCssElement>.Construct
    (ACssElementComparsion));
end;

procedure TdxHtmlImporter.ParseHtmlContent(AHtmlElements: TdxHtmlElementList;
  AStreamReader: TStreamReader);
var
  ARawText: string;
...
procedure TdxHtmlImporter.FixBordersAndParagraphBetweenTables
  (APieceTable: TdxPieceTable);
var
...
procedure TdxHtmlImporter.FixBordersAndParagraphBetweenTablesCore
  (ATables: TdxList<TdxTable>);
var
  ACount, I: Integer;
begin
  ...
  begin
    if ATables[I].EndParagraphIndex + 1 = ATables[I + 1].StartParagraphIndex
    then
...
begin
  ...
  begin
    ...
    if ShouldResetTableCellBorder(ATableBorders.UseLeftBorder,
      ACellBorders.UseLeftBorder, ATableBorders.LeftBorder,
    ...
    if ShouldResetTableCellBorder(ATableBorders.UseRightBorder,
      ACellBorders.UseRightBorder, ATableBorders.RightBorder,
    ...
    begin
      ...
      begin
        ...
        if ShouldResetTableCellBorder(ATableBorders.UseTopBorder,
          ACellBorders.UseTopBorder, ATableBorders.TopBorder,
    ...
    begin
      ...
      begin
        ACellBorders := ACells[J].Properties.Borders;
        if ShouldResetTableCellBorder(ATableBorders.UseBottomBorder,
          ACellBorders.UseBottomBorder, ATableBorders.BottomBorder,
          ACellBorders.BottomBorder) then
        begin
...
function TdxHtmlImporter.ShouldResetTableCellBorder(AUseTableBorder: Boolean;
AUseCellBorder: Boolean; ATableBorder: TdxBorderBase;
ACellBorder: TdxBorderBase): Boolean;
var
  AHasTableBorder, AHasCellBorder: Boolean;
begin
  if not AUseTableBorder or not AUseCellBorder then
    Exit(False);
  AHasTableBorder := (ATableBorder.Style <> TdxBorderLineStyle.None) and
    (ATableBorder.Style <> TdxBorderLineStyle.Nil);
  AHasCellBorder := (ACellBorder.Style <> TdxBorderLineStyle.None) and
    (ACellBorder.Style <> TdxBorderLineStyle.Nil);
...
begin
  ...
  while (AParagraphCell <> nil) and
    (AParagraphCell.Table.NestedLevel >= ATable.NestedLevel) do
  begin
    APieceTable.ChangeCellStartParagraphIndex(AParagraphCell,
      ANewParagraph.Index + 1);
  ...
  AParagraphMarkPos := TdxDocumentModelPosition.FromParagraphStart(PieceTable,
    ANewParagraph.Index);
...
begin
  ...
  begin
    ...
    if ALogPosition <= ABookmark.Start then
      ABookmark.Interval.Start.LogPosition :=
        ABookmark.Interval.Start.LogPosition + 1;
    if ALogPosition <= ABookmark.&End then
      ABookmark.Interval.&End.LogPosition :=
        ABookmark.Interval.&End.LogPosition + 1;
  end;
end;

class function TdxHtmlImporter.TableComparer(const ALeft,
  ARight: TdxTable): Integer;
begin
  Result := ALeft.StartParagraphIndex - ARight.StartParagraphIndex;
end;

function TdxHtmlImporter.GetTablesByLevel(APieceTable: TdxPieceTable;
ANestedLevel: Integer): TdxList<TdxTable>;
var
...
begin
  ...
  else if ATag is TdxTableTag then
  begin
    ATag.BeforeDeleteTagFromStack(AIndex);
...
begin
  ...
  else if ATag.Tag is TdxTableTag then
...
var
  ARecalculateHasPreformattedTagInStack,
    AHasTableTagBeforePreformattedTag: Boolean;
  I: Integer;
begin
  ARecalculateHasPreformattedTagInStack := FHasPreformattedTagInStack and
    ((TagsStack[AIndex].Tag is TdxPreformattedTag) or
    (TagsStack[AIndex].Tag is TdxTableTag));
  ...
  begin
    ...
    begin
      if (TagsStack[I].Tag is TdxTableTag) and not AHasTableTagBeforePreformattedTag
      then
        AHasTableTagBeforePreformattedTag := True
      else if TagsStack[I].Tag is TdxPreformattedTag then
      begin
        FHasPreformattedTagInStack := True;
        Break;
      end;
    end;
    FUseRawContent := FHasPreformattedTagInStack and
      not AHasTableTagBeforePreformattedTag;
  end;
end;

procedure TdxHtmlImporter.StyleTagIsNotOpen(AStreamReader: TStreamReader;
AHtmlElements: TdxHtmlElementList);
var
  AHtmlTag: TdxTag;
  AScriptContent, ACloseScriptTag: TdxHtmlElement;
begin
  if (Element.ElementType in [TdxHtmlElementType.OpenTag,
    TdxHtmlElementType.EmptyTag]) then
  begin
    ...
    else if (Element.ElementType = TdxHtmlElementType.OpenTag) and
      (AHtmlTag.NameID = TdxHtmlTagNameID.Script) then
    begin
...
begin
  ...
  try
    AHtmlElements := AHtmlCorrector.GetCorrectedHtmlElements(AHtmlElements,
      AHtmlTagPresent);
    try
      ACount := AHtmlElements.Count;

      ProgressIndication.&Begin(cxGetResourceString(@sdxRichEditMsg_Loading), 0,
        ACount, 0);
      try
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if (APrevParIndex >= 0) and
              (PieceTable.Paragraphs[APrevParIndex].GetCell = nil) then
              Dec(ALogPosition);
          end;

          ABm := TdxBookmark.Create(Position.PieceTable, ALogPosition,
            ALogPosition);
...
begin
  ...
  begin
    ...
    if (ALastParagraph.IsEmpty and (ALastParagraph.Index > 0)) and
      (AParagraphs[ALastParagraph.Index - 1].GetCell = nil) then
    begin
  ...
  ALastPosition := TdxPositionConverter.ToDocumentModelPosition(PieceTable,
    AEndLogPosition);
  for I := 0 to ACount - 1 do
  begin
...
function TdxHtmlImporter.DecodeStringContent(const AContentText
  : string): string;
begin
  if AContentText = '' then
    Exit('');
  ...
  begin
    if not((FTag <> nil) and FTag.DecodeStringContent(AContentText, Result))
    then
...
function TdxHtmlImporter.ReplaceSpecialSymbols(const AContentText
  : string): string;
var
  I: Integer;
...
begin
  ...
  try
    ...
    Result := StringReplace(AResult.ToString, TdxCharacters.OptionalHyphen, '',
      [rfReplaceAll]);
  finally
    AResult.Free;
  end;
...
function TdxHtmlImporter.ReplaceSpecialSymbolCore(const ARawText
  : string): string;
var
...
function TdxHtmlImporter.GetSpecialValue(const ASpecialSymbol: string;
AIsNumeric: Boolean): Char;
var
  ASpecialValue: Char;
begin
  ASpecialValue := #$0000;
...
function TdxHtmlImporter.TryParseSymbol(const ASpecialSymbol: string;
out ACode: Integer): Boolean;
begin
  ...
  if CharInSet(ASpecialSymbol[1], ['x', 'X']) then
    Result := TdxNumber.TryParse(Copy(ASpecialSymbol, 2,
      Length(ASpecialSymbol) - 1), TdxNumberStyles.HexNumber, ACode)
  else
...
{$ELSE}
  Result := TCharacter.IsWhiteSpace(ACh) or TCharacter.IsPunctuation(ACh) or
    TCharacter.IsSymbol(ACh);
{$ENDIF}
end;

function TdxHtmlImporter.WhiteSpaceAtStartCanRemove(const AContentText
  : string): Boolean;
begin
{$IFDEF DELPHIXE4}
  Result := AContentText[1].IsWhiteSpace and
    (IsEmptyParagraph or IsEmptyLine or not FCanInsertSpace);
{$ELSE}
  Result := TCharacter.IsWhiteSpace(AContentText[1]) and
    (IsEmptyParagraph or IsEmptyLine or not FCanInsertSpace);
{$ENDIF}
end;
...
begin
  ...
  else if (ATag is TdxAnchorTag) and (LastOpenAnchorTagIndex >= 0) then
  begin
...
begin
  ...
  if ACount > 0 then
    ARun.CharacterProperties.CopyFrom
      (TagsStack[ACount - 1].OldPosition.CharacterFormatting);
end;

function TdxHtmlImporter.CreateUriBasedRichEditImage(const AUri: string;
...
begin
  if FUniqueUriBasedImages.TryGetValue(AUri, AResult) then
    Result := TdxUriOfficeImage.Create(AResult, APixelTargetWidth,
      APixelTargetHeight)
  else
    Result := TdxUriOfficeImage(CreateUriBasedRichEditImageCore(AUri,
      APixelTargetWidth, APixelTargetHeight).Clone);
end;

function TdxHtmlImporter.CreateUriBasedRichEditImageCore(const AUri: string;
APixelTargetWidth: Integer; APixelTargetHeight: Integer): TdxUriOfficeImage;
var
  AUriList: TArray<string>;
begin
  AUriList := TArray<string>.Create(AUri);
  Result := TdxUriOfficeImage.Create(DocumentModel.ImageCache, DocumentModel,
    AUriList, APixelTargetWidth, APixelTargetHeight, Options.AsyncImageLoading);
...
procedure TdxHtmlImporter.AppendText(APieceTable: TdxPieceTable;
const AText: string);
var
...
begin
  if Options.ReplaceSpaceWithNonBreakingSpaceInsidePre then
    AInsertedText := TdxStringHelper.Replace(AText, TdxCharacters.Space,
...
begin
  ...
  Result := TdxFontSizeInfo.Create(AFormatting.DoubleFontSize,
    AFormatting.Options.UseDoubleFontSize);
end;

procedure TdxHtmlImporter.RestorePositionScriptFontSize(const AFontSizeInfo
  : TdxFontSizeInfo);
var
  AFormatting: TdxCharacterFormattingBase;
begin
...
procedure TdxHtmlImporter.ValidateHyperlinkInfo(AHyperlinkInfo
  : TdxHyperlinkInfo);
begin
end;

procedure TdxHtmlImporter.ProcessHyperlinkStart(AHyperlinkInfo
  : TdxHyperlinkInfo);
var
...
function TdxHtmlImporter.ValidateBookmarkName(const AAnchorName
  : string): string;
begin
  Result := AAnchorName;
end;
...
begin
  ...
  begin
    ...
    PieceTable.CreateBookmarkCore(ABookmarkInfo.Start, ALength,
      ABookmarkInfo.Name);
  end;
end;
...
procedure TdxHtmlImporter.RegisterCommentMarksToCollectPositions
  (const AMarks: array of string);
var
  AMark: string;
begin
...
function TdxHtmlImporter.GetMarkPosition(const AMark: string)
...
function TdxImportHtmlFormat.GetDocumentImporter
...
begin
  Result := TdxHtmlImporter.Create(TdxDocumentModel(ADocumentModel),
    AOptions as TdxHtmlDocumentImporterOptions);
end;
...
function TdxPieceTablePasteHtmlTextCommand.GetContent
  : TdxClipboardStringContent;
begin
  Result := TdxClipboardStringContent.Create('');
end;

procedure TdxPieceTablePasteHtmlTextCommand.
...
begin
  ...
  try
    ...
    AImporter := ADocumentModel.InternalAPI.ImporterFactory.CreateHtmlImporter
      (ADocumentModel, AOptions) as TdxHtmlImporter;
...
function TdxPieceTablePasteHtmlTextCommand.PrepareInputStream
...
constructor TdxHtmlClipboardStringContent.Create(const ASourseUri,
  AContent: string; AFragmentStart, AFragmentEnd: Integer);
begin
...
begin
  ...
  try
    ...
    FHtmlContent := TdxEncoding.UTF8.GetString(AContent, AOffset,
      Length(AContent) - AOffset);
    FStartFragment := TdxEncoding.UTF8.GetCharCount(AContent, AOffset,
      AFragmentStart - AOffset);
    FEndFragment := TdxEncoding.UTF8.GetCharCount(AContent, AOffset,
      AFragmentEnd - AOffset);
...
function TdxHtmlClipboardData.CalculateFragmentStart(ADescription
  : TdxStringsDictionary): Integer;
begin
  Result := GetIntegerValue(ADescription, 'StartFragment');
end;

function TdxHtmlClipboardData.CalculateFragmentEnd(ADescription
  : TdxStringsDictionary): Integer;
begin
  Result := GetIntegerValue(ADescription, 'EndFragment');
end;

function TdxHtmlClipboardData.CreateContentDescription(const AContent
  : TArray<Byte>): TdxStringsDictionary;
var
  ...
  try
    ...
    try
      ...
      begin
        ...
        Result.AddOrSetValue(APair[0], TdxStringHelper.Substring(ALine,
          Length(APair[0]) + 1));
      end;
    finally
      AReader.Free;
...
function TdxHtmlClipboardData.CalculateHtmlContentOffset
  (ADescription: TdxStringsDictionary): Integer;
begin
  Result := GetIntegerValue(ADescription, 'StartHTML');
end;

function TdxHtmlClipboardData.GetIntegerValue(ADescription
  : TdxStringsDictionary; const AKey: string): Integer;
var
  AValue: string;
begin
...
function TdxHtmlClipboardData.CalculateSourceUri(ADescription
  : TdxStringsDictionary): string;
begin
...
function TdxPieceTablePasteHtmlClipboardDataCommand.GetContent
  : TdxClipboardStringContent;
var
...
begin
  ...
  try
    ...
    try
      Result := TdxHtmlClipboardStringContent.Create(AHtmlData.SourceUri,
        AHtmlData.HtmlContent, AHtmlData.StartFragment, AHtmlData.EndFragment);
    finally
      AHtmlData.Free;
    end;
  finally
...
procedure TdxPieceTablePasteHtmlClipboardDataCommand.
  PopulateDocumentModelFromContentStringCore(ADocumentModel: TdxDocumentModel;
AContent: TdxClipboardStringContent; const ASizeCollection: string);
var
...
begin
  ...
  try
    ...
    try
      AImporter := DocumentModel.InternalAPI.ImporterFactory.CreateHtmlImporter
        (ATempModel, AOptions) as TdxHtmlImporter;
      try
        AImporter.RegisterCommentMarksToCollectPositions
          ([StartFragmentCommentText, EndFragmentCommentText]);
        AStringContent := ClearHTMLContent(AHtmlContent.StringContent,
          AHtmlContent.StartFragment, AHtmlContent.EndFragment);
        ...
        AStartFragmentPos := AImporter.GetMarkPosition
          (StartFragmentCommentText);
        AEndFragmentPos := AImporter.GetMarkPosition(EndFragmentCommentText);
        CopyFragment(ATempModel, ADocumentModel, AStartFragmentPos,
          AEndFragmentPos);
      finally
        AImporter.Free;
      end;
...
procedure TdxPieceTablePasteHtmlClipboardDataCommand.CopyFragment(ASourceModel,
  ATargetModel: TdxDocumentModel; AStartFragmentPos, AEndFragmentPos
  : TdxDocumentLogPosition);
var
  ACopyManager: TdxDocumentModelCopyManager;
  AOperation: TdxCopySectionOperation;
begin
  ACopyManager := TdxDocumentModelCopyManager.Create
    (ASourceModel.MainPieceTable, ATargetModel.MainPieceTable,
    TdxParagraphNumerationCopyOptions.CopyAlways);
  try
    AOperation := ASourceModel.CreateCopySectionOperation(ACopyManager)
      as TdxCopySectionOperation;
    try
      AOperation.Execute(AStartFragmentPos,
        AEndFragmentPos - AStartFragmentPos, False);
    finally
      AOperation.Free;
    end;
  finally
...
function TdxPieceTablePasteHtmlClipboardDataCommand.ClearHTMLContent
  (const AHtmlContent: string; AStartFragent, AEndFragment: Integer): string;
var
  APartBefore, AMiddlePart, APartAfter: string;
begin
  APartBefore := RemoveFragmentMarks(TdxStringHelper.Substring(AHtmlContent, 0,
    AStartFragent));
  AMiddlePart := RemoveFragmentMarks(TdxStringHelper.Substring(AHtmlContent,
    AStartFragent, AEndFragment - AStartFragent));
  APartAfter := RemoveFragmentMarks(TdxStringHelper.Substring(AHtmlContent,
    AEndFragment));
  Result := APartBefore + StartFragmentComment + AMiddlePart +
    EndFragmentComment + APartAfter;
end;

function TdxPieceTablePasteHtmlClipboardDataCommand.RemoveFragmentMarks
...
function TdxPieceTablePasteHtmlClipboardDataCommand.
...
function TdxPasteHtmlTextCommand.CreateInnerCommandCore
