...
type
  ...
  strict private
    ...
    class function IsInlinePictureInsideFloatingObject(AHitTestResult
      : TdxRichEditHitTestResult): Boolean; static;
  protected
  ...
  public
    function CreateRectangularObjectResizeState(const AHotZone: IdxHotZone;
      AResult: TdxRichEditHitTestResult): IdxCustomMouseState; virtual;
      abstract;
...
function TdxRichEditCustomMouseController.DeactivateTextBoxPieceTableIfNeed
...
begin
  ...
  begin
    ...
    ControlBeginUpdate;
    try
      ChangeActivePieceTable
        (TdxPieceTable(ATextBoxPieceTable.AnchorRun.PieceTable),
        AHitTestResult);
...
class function TdxRichEditCustomMouseController.IsInlinePictureBoxHit
  (AHitTestResult: TdxRichEditHitTestResult): Boolean;
var
...
procedure TdxRichEditCustomMouseController.SetTableViewInfo
  (const Value: TdxTableViewInfo);
begin
...
class function TdxRichEditCustomMouseController.
  IsInlinePictureInsideFloatingObject(AHitTestResult
