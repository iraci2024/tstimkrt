...
type
  ...
  TdxListNumberAlignment = (Left, Center, Right);

  TdxListLevelChangeType = (None, Start, Format, Alignment,
    ConvertPreviousLevelNumberingToDecimal, Separator, SuppressRestart,
    SuppressBulletResize, DisplayFormatString, RelativeRestartLevel,
    TemplateCode, Legacy, LegacySpace, LegacyIndent, BatchUpdate);
  ...
  TdxListLevelInfo = class(TdxCloneableIUnknownObject, IdxListLevelProperties,
  ...
  public
    ...
    property ConvertPreviousLevelNumberingToDecimal: Boolean
      read FConvertPreviousLevelNumberingToDecimal
      write FConvertPreviousLevelNumberingToDecimal;
    property Separator: Char read FSeparator write FSeparator;
    property SuppressRestart: Boolean read FSuppressRestart
      write FSuppressRestart;
    property SuppressBulletResize: Boolean read FSuppressBulletResize
      write FSuppressBulletResize;
    property DisplayFormatString: string read FDisplayFormatString
      write FDisplayFormatString;
    property RelativeRestartLevel: Integer read FRelativeRestartLevel
      write FRelativeRestartLevel;
    property TemplateCode: Integer read FTemplateCode write FTemplateCode;
    property OriginalLeftIndent: Integer read FOriginalLeftIndent
      write FOriginalLeftIndent;
  ...
  public
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxListLevelInfo; override;
  end;
  ...
  public
    class function CalculateChangeActions(AChange: TdxListLevelChangeType)
  ...
  TdxListLevelProperties = class(TdxRichEditIndexBasedObject<TdxListLevelInfo>,
    IdxListLevelProperties, IdxReadOnlyListLevelProperties)
  private
    function GetAlignment: TdxListNumberAlignment;
    function GetConvertPreviousLevelNumberingToDecimal: Boolean;
    function GetDisplayFormatString: string;
  ...
  strict protected
    ...
    function SetConvertPreviousLevelNumberingToDecimalCore(const AListLevel
      : TdxListLevelInfo; const AValue: Boolean): TdxDocumentModelChangeActions;
    ...
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxListLevelInfo>; override;
  ...
  public
    ...
    property DisplayFormatString: string read GetDisplayFormatString
      write SetDisplayFormatString;
    property OriginalLeftIndent: Integer read GetOriginalLeftIndent
      write InternalSetOriginalLeftIndent;
    property RelativeRestartLevel: Integer read GetRelativeRestartLevel
      write SetRelativeRestartLevel;
    property TemplateCode: Integer read GetTemplateCode
      write SetTemplateCodeIntf;
    property Legacy: Boolean read GetLegacy write SetLegacy;
    property LegacySpace: Integer read GetLegacySpace write SetLegacySpace;
    property LegacyIndent: Integer read GetLegacyIndent write SetLegacyIndent;
  end;
  ...
  public
    ...
    class function GetOrdinalNumberConverterByLanguage(ALanguageId: Integer)
      : TdxOrdinalBasedNumberConverter;
    class function GetDescriptiveCardinalNumberConverterByLanguage
      (ALanguageId: Integer): TdxOrdinalBasedNumberConverter;
    class function GetDescriptiveOrdinalNumberConverterByLanguage
      (ALanguageId: Integer): TdxOrdinalBasedNumberConverter;
    class function CreateConverter(AFormat: TdxNumberingFormat;
      ALanguageId: Integer): TdxOrdinalBasedNumberConverter;
    class function GetSupportNumberingFormat: TArray<TdxNumberingFormat>;
    class function GetUpperLatinLetterNumberConverter
      : TdxOrdinalBasedNumberConverter;
    class function GetUpperRomanNumberConverterClassic
      : TdxOrdinalBasedNumberConverter;
    class function GetLowerRomanNumberConverterClassic
      : TdxOrdinalBasedNumberConverter;
    class function GetLowerLatinLetterNumberConverter
      : TdxOrdinalBasedNumberConverter;
...
type
  ...
  TdxAlphabetBasedNumberConverter = class abstract
    (TdxOrdinalBasedNumberConverter)
  strict protected
    function ConvertNumberCore(AValue: Int64): string; override;
  ...
  TdxDecimalEnclosedParenthesesNumberConverter = class
    (TdxOrdinalBasedNumberConverter)
  strict protected
    function ConvertNumberCore(AValue: Int64): string; override;
    function GetType: TdxNumberingFormat; override;
...
begin
  ...
  ConvertPreviousLevelNumberingToDecimal :=
    AInfo.ConvertPreviousLevelNumberingToDecimal;
...
procedure TdxListLevelInfo.SetConvertPreviousLevelNumberingToDecimal
  (const Value: Boolean);
begin
...
begin
  ...
  Result := (Start = AInfo.Start) and (Format = AInfo.Format) and
    (Alignment = AInfo.Alignment) and
    (ConvertPreviousLevelNumberingToDecimal = AInfo.
    ConvertPreviousLevelNumberingToDecimal) and (Separator = AInfo.Separator)
    and (SuppressRestart = AInfo.SuppressRestart) and
    ...
    (OriginalLeftIndent = AInfo.OriginalLeftIndent) and (Legacy = AInfo.Legacy)
    and (LegacyIndent = AInfo.LegacyIndent) and
    (LegacySpace = AInfo.LegacySpace) and (TemplateCode = AInfo.TemplateCode);
end;
...
function TdxListLevelInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxListLevelInfo;
var
...
const
  ListLevelChangeActionsMap: array [TdxListLevelChangeType]
...
constructor TdxListLevelProperties.Create(ADocumentModel
  : TdxCustomDocumentModel);

  function GetMainPieceTable(ADocumentModel: TdxCustomDocumentModel)
    : TdxCustomPieceTable;
  begin
...
function TdxListLevelProperties.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxListLevelChangeActionsCalculator.CalculateChangeActions
    (TdxListLevelChangeType.BatchUpdate);
end;

function TdxListLevelProperties.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxListLevelInfo>;
begin
  Result := TdxDocumentCache(ADocumentModel.Cache).ListLevelInfoCache;
end;

function TdxListLevelProperties.
  GetConvertPreviousLevelNumberingToDecimal: Boolean;
begin
...
procedure TdxListLevelProperties.InternalSetOriginalLeftIndent
  (const Value: Integer);
begin
...
procedure TdxListLevelProperties.SetAlignment(const Value
...
function TdxListLevelProperties.SetAlignmentCore(const AListLevel
  : TdxListLevelInfo; const AValue: TdxListNumberAlignment)
  : TdxDocumentModelChangeActions;
begin
  AListLevel.Alignment := AValue;
  Result := TdxListLevelChangeActionsCalculator.CalculateChangeActions
    (TdxListLevelChangeType.Alignment);
end;

procedure TdxListLevelProperties.SetConvertPreviousLevelNumberingToDecimal
  (const Value: Boolean);
begin
  if ConvertPreviousLevelNumberingToDecimal = Value then
    Exit;
  SetPropertyValue<Boolean>
    (SetConvertPreviousLevelNumberingToDecimalCore, Value);
end;

function TdxListLevelProperties.SetConvertPreviousLevelNumberingToDecimalCore
  (const AListLevel: TdxListLevelInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AListLevel.ConvertPreviousLevelNumberingToDecimal := AValue;
  Result := TdxListLevelChangeActionsCalculator.CalculateChangeActions
    (TdxListLevelChangeType.RelativeRestartLevel);
end;
...
function TdxListLevelProperties.SetDisplayFormatStringCore(const AListLevel
  : TdxListLevelInfo; const AValue: string): TdxDocumentModelChangeActions;
begin
  AListLevel.DisplayFormatString := AValue;
  Result := TdxListLevelChangeActionsCalculator.CalculateChangeActions
    (TdxListLevelChangeType.DisplayFormatString);
end;
...
function TdxListLevelProperties.SetFormatCore(const AListLevel
  : TdxListLevelInfo; const AValue: TdxNumberingFormat)
  : TdxDocumentModelChangeActions;
begin
  AListLevel.Format := AValue;
  Result := TdxListLevelChangeActionsCalculator.CalculateChangeActions
    (TdxListLevelChangeType.Format);
end;
...
function TdxListLevelProperties.SetLegacyCore(const AListLevel
  : TdxListLevelInfo; const AValue: Boolean): TdxDocumentModelChangeActions;
begin
  AListLevel.Legacy := AValue;
  Result := TdxListLevelChangeActionsCalculator.CalculateChangeActions
    (TdxListLevelChangeType.Legacy);
end;
...
function TdxListLevelProperties.SetLegacyIndentCore(const AListLevel
  : TdxListLevelInfo; const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AListLevel.LegacyIndent := AValue;
  Result := TdxListLevelChangeActionsCalculator.CalculateChangeActions
    (TdxListLevelChangeType.LegacyIndent);
end;
...
function TdxListLevelProperties.SetLegacySpaceCore(const AListLevel
  : TdxListLevelInfo; const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AListLevel.LegacySpace := AValue;
  Result := TdxListLevelChangeActionsCalculator.CalculateChangeActions
    (TdxListLevelChangeType.LegacySpace);
end;

function TdxListLevelProperties.SetOriginalLeftIndent(const AListLevel
  : TdxListLevelInfo; const AValue: Integer): TdxDocumentModelChangeActions;
begin
...
function TdxListLevelProperties.SetRestartLevelCore(const AListLevel
  : TdxListLevelInfo; const AValue: Integer): TdxDocumentModelChangeActions;
begin
...
function TdxListLevelProperties.SetSeparatorCore(const AListLevel
  : TdxListLevelInfo; const AValue: Char): TdxDocumentModelChangeActions;
begin
  AListLevel.Separator := AValue;
  Result := TdxListLevelChangeActionsCalculator.CalculateChangeActions
    (TdxListLevelChangeType.Separator);
end;
...
function TdxListLevelProperties.SetSuppressBulletResizeCore(const AListLevel
  : TdxListLevelInfo; const AValue: Boolean): TdxDocumentModelChangeActions;
begin
  AListLevel.SuppressBulletResize := AValue;
  Result := TdxListLevelChangeActionsCalculator.CalculateChangeActions
    (TdxListLevelChangeType.SuppressBulletResize);
end;
...
function TdxListLevelProperties.SetSuppressRestartCore(const AListLevel
  : TdxListLevelInfo; const AValue: Boolean): TdxDocumentModelChangeActions;
begin
  AListLevel.SuppressRestart := AValue;
  Result := TdxListLevelChangeActionsCalculator.CalculateChangeActions
    (TdxListLevelChangeType.SuppressRestart);
end;

function TdxListLevelProperties.SetTemplateCode(const AListLevel
  : TdxListLevelInfo; const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AListLevel.TemplateCode := AValue;
  Result := TdxListLevelChangeActionsCalculator.CalculateChangeActions
    (TdxListLevelChangeType.TemplateCode);
end;

{ TdxOrdinalBasedNumberConverter }

class function TdxOrdinalBasedNumberConverter.CreateConverter
  (AFormat: TdxNumberingFormat; ALanguageId: Integer)
  : TdxOrdinalBasedNumberConverter;
begin
  case AFormat of
...
class function TdxOrdinalBasedNumberConverter.
  GetDescriptiveCardinalNumberConverterByLanguage(ALanguageId: Integer)
  : TdxOrdinalBasedNumberConverter;
begin
  Result := TdxDecimalNumberConverter.Create;
end;
...
class function TdxOrdinalBasedNumberConverter.
  GetOrdinalNumberConverterByLanguage(ALanguageId: Integer)
  : TdxOrdinalBasedNumberConverter;
begin
  Result := TdxDecimalNumberConverter.Create;
end;

class function TdxOrdinalBasedNumberConverter.GetSupportNumberingFormat
  : TArray<TdxNumberingFormat>;
begin
  Result := TArray<TdxNumberingFormat>.Create(TdxNumberingFormat.Decimal,
    TdxNumberingFormat.UpperRoman, TdxNumberingFormat.LowerRoman,
    TdxNumberingFormat.UpperLetter, TdxNumberingFormat.LowerLetter,
    TdxNumberingFormat.Ordinal, TdxNumberingFormat.CardinalText,
    TdxNumberingFormat.OrdinalText, TdxNumberingFormat.DecimalZero,
    TdxNumberingFormat.RussianUpper, TdxNumberingFormat.RussianLower,
    TdxNumberingFormat.DecimalEnclosedParentheses,
    TdxNumberingFormat.NumberInDash, TdxNumberingFormat.Chicago);
end;

class function TdxOrdinalBasedNumberConverter.GetUpperLatinLetterNumberConverter
  : TdxOrdinalBasedNumberConverter;
begin
  Result := TdxUpperLatinLetterNumberConverter.Create;
end;
...
class function TdxOrdinalBasedNumberConverter.
  GetUpperRomanNumberConverterClassic: TdxOrdinalBasedNumberConverter;
begin
  Result := TdxUpperRomanNumberConverterClassic.Create;
end;

class function TdxOrdinalBasedNumberConverter.
  GetDescriptiveOrdinalNumberConverterByLanguage(ALanguageId: Integer)
  : TdxOrdinalBasedNumberConverter;
begin
  Result := TdxDecimalNumberConverter.Create;
end;

class function TdxOrdinalBasedNumberConverter.GetLowerLatinLetterNumberConverter
  : TdxOrdinalBasedNumberConverter;
begin
  Result := TdxLowerLatinLetterNumberConverter.Create;
end;
...
class function TdxOrdinalBasedNumberConverter.
  GetLowerRomanNumberConverterClassic: TdxOrdinalBasedNumberConverter;
begin
  Result := TdxLowerRomanNumberConverterClassic.Create;
end;
...
function TdxAlphabetBasedNumberConverter.ConvertNumberCore
  (AValue: Int64): string;
var
  ACount: Integer;
  ASymbol: Char;
...
begin
  FUpperLetter := TArray<Char>.Create('A', 'B', 'C', 'D', 'E', 'F', 'G', 'H',
...
begin
  FLowerLetter := TArray<Char>.Create('a', 'b', 'c', 'd', 'e', 'f', 'g', 'h',
    'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w',
    'x', 'y', 'z');
end;
...
begin
  FRoman := TArray<string>.Create('I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC',
    'C', 'CD', 'D', 'CM', 'M');
  FArabic := TArray<Integer>.Create(1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500,
    900, 1000);
end;
...
function TdxNumberInDashNumberConverter.ConvertNumberCore
  (AValue: Int64): string;
begin
...
begin
  FRussianUpper := TArray<Char>.Create(#1040, #1041, #1042, #1043, #1044, #1045,
    #1046, #1047, #1048, #1050, #1051, #1052, #1053, #1054, #1055, #1056, #1057,
...
begin
  FRussianLower := TArray<Char>.Create(#1072, #1073, #1074, #1075, #1076, #1077,
    #1078, #1079, #1080, #1082, #1083, #1084, #1085, #1086, #1087, #1088, #1089,
...
function TdxDecimalEnclosedParenthesesNumberConverter.ConvertNumberCore
  (AValue: Int64): string;
begin
  Result := Format('(%d)', [AValue]);
end;

function TdxDecimalEnclosedParenthesesNumberConverter.GetType
  : TdxNumberingFormat;
begin
