...
type
  ...
  protected
    procedure DoShowLinkHint(var AHintInfo: THintInfo;
      ALinkViewInfo: TdxNavBarLinkViewInfo); override;
  ...
  public
    procedure DrawLinkHintWindow(ACanvas: TCanvas; const ARect: TRect);
      override;
  end;
...
uses
  Types, cxGraphics, dxNavBarViewsFact, dxNavBarGraphics, dxNavBarConsts;
...
begin
  ...
  begin
    ...
    Result.Left := Result.Right - (ActiveGroupViewInfo.CaptionRect.Bottom -
      ActiveGroupViewInfo.CaptionRect.Top);
...
begin
  ...
  begin
    ...
    begin
      ...
      Result.Left := Result.Right - (AGroupViewInfo.CaptionRect.Bottom -
        AGroupViewInfo.CaptionRect.Top);
      OffsetRect(Result, (Result.Right - Result.Left) + 2, 0);
    end
    else
    begin
...
procedure TdxNavBarVSToolBoxController.DoShowLinkHint(var AHintInfo: THintInfo;
  ALinkViewInfo: TdxNavBarLinkViewInfo);
begin
  inherited;
  AHintInfo.HintPos := NavBar.ClientToScreen
    (NavBar.ViewInfo.ClientRect.TopLeft);
end;

function TdxNavBarVSToolBoxController.GetLinkHintRect
  (ALink: TdxNavBarItemLink): TRect;
var
  R: TRect;
  ALinkViewInfo: TdxNavBarLinkViewInfo;
begin
  ...
  begin
    ...
    cxDrawText(cxScreenCanvas.Handle, ViewInfo.HintText, R, DT_CALCRECT or
...
function TdxNavBarVSToolBoxController.GetLinkHintText
  (ALink: TdxNavBarItemLink): string;
begin
...
procedure TdxNavBarVSToolBoxPainter.DrawLinkHintWindow(ACanvas: TCanvas;
  const ARect: TRect);
var
  R: TRect;
  AWidth: Integer;
  ...
  if ALinkViewInfo <> nil then
    ...
    begin
      ...
      with ALinkViewInfo.GroupViewInfo do
        BackgroundPainterClass.DrawBackground(ACanvas, R, BgImage, False,
          clBtnFace, BgBackColor, BgBackColor2, BgAlphaBlend, BgAlphaBlend2,
          BgGradientMode, ScaleFactor);
      SelectionPainterClass.DrawSelection(ACanvas, R, GroupViewInfo.BgBackColor,
        [sHotTracked], ScaleFactor);
...
class function TdxNavBarVSToolBoxPainter.GetViewInfoClass
  : TdxNavBarViewInfoClass;
begin
  Result := TdxNavBarVSToolBoxViewInfo;
end;

class function TdxNavBarVSToolBoxPainter.GetLinkViewInfoClass
  : TdxNavBarLinkViewInfoClass;
begin
  Result := TdxNavBarVSToolBoxLinkViewInfo;
end;

class function TdxNavBarVSToolBoxPainter.GetChildGroupViewInfoClass
...
class function TdxNavBarVSToolBoxPainter.ButtonPainterClass
  : TdxNavBarCustomButtonPainterClass;
begin
  Result := TdxNavBarVSToolBoxButtonPainter;
end;

class function TdxNavBarVSToolBoxPainter.SelectionPainterClass
...
class procedure TdxNavBarVSToolBoxSelectionPainter.GetColors
...
class procedure TdxNavBarVSToolBoxButtonPainter.InternalDrawButton
...
begin
  ...
  if sPressed in AState then
    ...
    dxNavBarDrawSelectedFrame(ACanvas, ARect, LightLightBorderColor(AColor1),
      DarkDarkBorderColor(AColor1), LightBorderColor(AColor1), clNone);
end;
