...
uses
  Windows, Classes, Graphics, Controls, ComCtrls, ImgList, cxListView,
  cxTreeView,
...
dxPSRegisterReportLink(TcxTreeViewReportLink, TcxTreeView,
  TdxfmTVReportLinkDesignWindow);
{$IFDEF REGISTERCXSHELLCTRLS}
dxPSRegisterReportLink(TcxShellTreeViewReportLink, TcxShellTreeView,
  TdxfmTVReportLinkDesignWindow);
{$ENDIF}
dxPSRegisterReportLink(TcxListViewReportLink, TcxListView,
  TdxfmLVReportLinkDesignWindow);
{$IFDEF REGISTERCXSHELLCTRLS}
dxPSRegisterReportLink(TcxShellListViewReportLink, TcxShellListView,
  TdxfmLVReportLinkDesignWindow);
{$ENDIF}
...
{$IFDEF REGISTERCXSHELLCTRLS}
dxPSUnregisterReportLink(TcxShellListViewReportLink, TcxShellListView,
  TdxfmTVReportLinkDesignWindow);
{$ENDIF}
dxPSUnregisterReportLink(TcxListViewReportLink, TcxListView,
  TdxfmTVReportLinkDesignWindow);

{$IFDEF REGISTERCXSHELLCTRLS}
dxPSUnregisterReportLink(TcxShellTreeViewReportLink, TcxShellTreeView,
  TdxfmLVReportLinkDesignWindow);
{$ENDIF}
dxPSUnregisterReportLink(TcxTreeViewReportLink, TcxTreeView,
  TdxfmLVReportLinkDesignWindow);
