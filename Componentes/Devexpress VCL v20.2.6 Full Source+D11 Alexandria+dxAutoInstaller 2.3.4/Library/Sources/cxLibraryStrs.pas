...
procedure AddExpressLibraryResourceStringNames
...
begin
  ...
  InternalAdd('scxConverterCantCreateStyleRepository',
  ...
  InternalAdd('scxQuickCustomizationAllCommandCaption',
    @scxQuickCustomizationAllCommandCaption);
  InternalAdd('scxQuickCustomizationSortedCommandCaption',
    @scxQuickCustomizationSortedCommandCaption);
end;

initialization

dxResourceStringsRepository.RegisterProduct('ExpressLibrary',
  @AddExpressLibraryResourceStringNames);
