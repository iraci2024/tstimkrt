...
function cxGetFilterOperatorAdapter(ADataSet: TDataSet)
  : TcxDBFilterOperatorAdapter;
...
var
  AIndex: Integer;
begin
  if Assigned(ADataSet) and cxFilterOperatorAdapters.FindAdapter
    (TDataSetClass(ADataSet.ClassType), AIndex) then
