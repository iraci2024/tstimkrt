...
type
  ...
  private
    ...
    function TestProperty(AObject: TObject; const AName: string;
  ...
  protected
    ...
    procedure GetSetProperty(AObject: TObject; const AName: string;
      AValues: TStrings);
...
function TcxCustomConverter.GetBooleanProperty(AObject: TObject;
  const AName: string; const ADefaultValue: Boolean): Boolean;
begin
...
function TcxCustomConverter.GetCharProperty(AObject: TObject;
  const AName: string; const ADefaultValue: Char): Char;
begin
...
function TcxCustomConverter.GetClassProperty(AObject: TObject;
  const AName: string; const ADefaultValue: TObject = nil): TObject;
begin
...
function TcxCustomConverter.GetEnumProperty(AObject: TObject;
  const AName: string; const ADefaultValue: string): string;
begin
  if TestProperty(AObject, AName, tkEnumeration) then
...
function TcxCustomConverter.GetFloatProperty(AObject: TObject;
  const AName: string; const ADefaultValue: Extended): Extended;
begin
...
function TcxCustomConverter.GetIntegerProperty(AObject: TObject;
  const AName: string; const ADefaultValue: Integer): Integer;
begin
...
function TcxCustomConverter.GetInterfaceProperty(AObject: TObject;
  const AName: string; const ADefaultValue: IUnknown): IUnknown;
begin
...
function TcxCustomConverter.GetMethodProperty(AObject: TObject;
  const AName: string; const ADefaultValue: TMethod): TMethod;
begin
...
procedure TcxCustomConverter.GetSetProperty(AObject: TObject;
  const AName: string; AValues: TStrings);
var
  AString: string;
  I: Integer;
begin
      ...
      begin
        ...
        begin
          if AString[I] = ',' then
            ...
            AValues[AValues.Count - 1] := AValues[AValues.Count - 1] +
              AString[I];
        end;
      end;
    end;
...
function TcxCustomConverter.GetStringProperty(AObject: TObject;
  const AName: string; const ADefaultValue: string): string;
begin
  try
...
function TcxCustomConverter.GetVariantProperty(AObject: TObject;
  const AName: string; const ADefaultValue: Variant): Variant;
begin
...
function TcxCustomConverter.GetWideCharProperty(AObject: TObject;
  const AName: string; const ADefaultValue: WideChar): WideChar;
begin
...
function TcxCustomConverter.GetWideStringProperty(AObject: TObject;
  const AName: string; const ADefaultValue: WideString): WideString;
begin
  if TestProperty(AObject, AName,
    {$IFDEF DELPHI16}tkUString{$ELSE}tkWString{$ENDIF}) then
    Result := GetStrProp(GetObject(AObject), AName)
  else
    Result := ADefaultValue;
end;
...
function TcxCustomConverter.GetPropInfo_(AObject: TObject; const AName: string)
  : PPropInfo;
begin
