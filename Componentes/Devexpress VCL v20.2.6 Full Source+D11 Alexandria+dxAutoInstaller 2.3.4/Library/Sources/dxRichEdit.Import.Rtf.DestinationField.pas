...
type
  ...
  strict private
    class function CreateFieldCodeDestination(AImporter: TdxRtfImporter)
      : TdxRichEditRtfDestinationBase; static;
    class function CreateFieldResultDestination(AImporter: TdxRtfImporter)
      : TdxRichEditRtfDestinationBase; static;

    class procedure FieldInstructionStartKeywordHandler
      (AImporter: TdxRtfImporter; AParameterValue: Integer;
      AHasParameter: Boolean); static;
    class procedure FieldResultStartKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure FieldLockKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure FieldCodeViewKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure FieldEditKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure FieldDirtyKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
    class procedure FieldPrivateKeywordHandler(AImporter: TdxRtfImporter;
      AParameterValue: Integer; AHasParameter: Boolean); static;
  protected
...
procedure TdxFieldSubDestination.EnsureFieldCreated
...
class function TdxFieldDestination.CreateFieldKeywords
...
class procedure TdxFieldDestination.FieldInstructionStartKeywordHandler
...
class function TdxFieldDestination.CreateFieldCodeDestination
  (AImporter: TdxRtfImporter): TdxRichEditRtfDestinationBase;
begin
...
class procedure TdxFieldDestination.FieldResultStartKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
var
  ADestination: TdxFieldDestination;
begin
...
class function TdxFieldDestination.CreateFieldResultDestination
  (AImporter: TdxRtfImporter): TdxRichEditRtfDestinationBase;
var
  AFieldInfo: TdxRtfFieldInfo;
begin
  AFieldInfo := AImporter.Fields.Peek;
  if not AImporter.DocumentModel.DocumentCapabilities.HyperlinksAllowed and
    AFieldInfo.IsHyperlink then
...
class procedure TdxFieldDestination.FieldLockKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
  AImporter.Fields.Peek.IsLock := True;
end;

class procedure TdxFieldDestination.FieldCodeViewKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
...
class procedure TdxFieldDestination.FieldEditKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
end;

class procedure TdxFieldDestination.FieldDirtyKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
end;

class procedure TdxFieldDestination.FieldPrivateKeywordHandler
  (AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean);
begin
end;
...
class function TdxFieldDestination.GetControlCharHT
...
function TdxCodeFieldHyperlinksDisabledDestination.CreateInstance
  : TdxFieldSubDestination;
begin
...
procedure TdxCodeFieldHyperlinksDisabledDestination.ProcessTextCore
  (const AText: string);
var
  AFieldInfo: TdxRtfFieldInfo;
begin
...
function TdxCodeFieldHyperlinksDisabledDestination.DetectHyperlink
