...
type
  ...
  published
    ...
    property Options: TdxServerModeADODataSourceOptions read GetOptions
      write SetOptions;
  end;
...
function TdxServerModeADOSQLQueryBuilder.CanUseParam
...
function TdxServerModeADODataSourceOptions.GetDataSource
  : TdxServerModeADODataSource;
begin
...
function TdxServerModeADODataSourceHelper.GetOptionsClass
  : TdxServerModeDataSourceOptionsClass;
begin
  Result := TdxServerModeADODataSourceOptions;
end;

function TdxServerModeADODataSourceHelper.GetQueryBuilderClass
  : TdxServerModeCustomSQLQueryBuilderClass;
begin
  Result := TdxServerModeADOSQLQueryBuilder;
end;

procedure TdxServerModeADODataSourceHelper.DoExecuteCommand
  ...
  try
    ...
    if (AParams <> nil) and (AParams.Count > 0) then
      ...
      begin
        ...
        if (AParams[I].DataType = ftWideMemo) or
          (paLong in AParameter.Attributes) then
        begin
          AMaxStringSize := TdxServerModeCustomSQLAdapterAccess
            (DataSource.SQLAdapter).GetMaximumStringSize;
          if (AParameter.Size > AMaxStringSize) or
            (Length(VarToStr(AParams[I].Value)) > AMaxStringSize) then
          begin
          ...
          AParameter.ParameterObject.Type_ :=
            FieldTypeToADOType(AParams[I].DataType);
    ...
    begin
      ADOCommand.ExecuteOptions := ADOCommand.ExecuteOptions +
        [eoExecuteNoRecords];
      ADOCommand.Execute;
    end;
  finally
...
procedure TdxServerModeADODataSourceHelper.DoInitializeDataSet
  (ADataSet: TDataSet);
begin
  TADODataSet(ADataSet).CommandText := GetFieldsRetrieveQuery;
end;

procedure TdxServerModeADODataSourceHelper.DoSynchronizeDataSetConnection
  (ADataSet: TDataSet);
begin
  TADODataSet(ADataSet).Connection := TADOConnection(Connection);
end;

procedure TdxServerModeADODataSourceHelper.PrepareDatasetForIterate
  (ADataSet: TDataSet);
begin
...
begin
  ...
  AFields := Connection.ConnectionObject.OpenSchema(adSchemaPrimaryKeys,
    VarArrayOf([Null, Null, TableName]), EmptyParam);
...
function TdxServerModeADODataSource.GetHelperClass
  : TdxServerModeDataSourceCustomHelperClass;
begin
  Result := TdxServerModeADODataSourceHelper;
end;

function TdxServerModeADODataSource.GetOptions
  : TdxServerModeADODataSourceOptions;
begin
...
procedure TdxServerModeADODataSource.SetOptions(const Value
  : TdxServerModeADODataSourceOptions);
begin
...
function TdxServerModeADOQueryDataSource.GetHelperClass
  : TdxServerModeDataSourceCustomHelperClass;
begin
  Result := TdxServerModeADODataSourceHelper;
end;

function TdxServerModeADOQueryDataSource.GetOptions
  : TdxServerModeADODataSourceOptions;
begin
  Result := TdxServerModeADODataSourceOptions(inherited Options);
end;
...
procedure TdxServerModeADOQueryDataSource.SetOptions
  (const Value: TdxServerModeADODataSourceOptions);
begin
  inherited Options := Value;
end;
