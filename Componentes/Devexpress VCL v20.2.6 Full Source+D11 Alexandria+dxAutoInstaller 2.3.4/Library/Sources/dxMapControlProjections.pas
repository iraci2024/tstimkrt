...
type
  ...
  protected
    ...
    function GetGeoPointLatitude(AMapUnitY, AOffsetY, AScaleY: Double)
      : Double; virtual;
    function GetGeoPointLongitude(AMapUnitX, AOffsetX, AScaleX: Double)
      : Double; virtual;
    function GetMapUnitX(ALongitude, AOffsetX, AScaleX: Double)
      : Double; virtual;
    function GetMapUnitY(ALatitude, AOffsetY, AScaleY: Double): Double; virtual;

    function GetGeoPoint(AMapUnit: TdxPointDouble;
      AOffset, AScale: TdxPointDouble): TdxMapControlGeoPoint; virtual;
    function GetMapUnit(AGeoPoint: TdxMapControlGeoPoint;
      AOffset, AScale: TdxPointDouble): TdxPointDouble; virtual;
  end;
  ...
  protected
    ...
    procedure Changed;
    function CreateProjectionCalculator
      : TdxMapControlProjectionCalculator; virtual;
    procedure EndUpdate;
    ...
    function InternalGeoPointToMapUnit(AGeoPoint: TdxMapControlGeoPoint)
      : TdxPointDouble; virtual;
    function InternalMapUnitToGeoPoint(AMapUnit: TdxPointDouble)
      : TdxMapControlGeoPoint; virtual;

    property OffsetX: Double read FOffsetX write SetOffsetX
      stored IsOffsetXStored;
    property OffsetY: Double read FOffsetY write SetOffsetY
      stored IsOffsetYStored;
  ...
  public
    ...
    function MapUnitToGeoPoint(AMapUnit: TdxPointDouble)
      : TdxMapControlGeoPoint; virtual;
    function GeoPointToMapUnit(AGeoPoint: TdxMapControlGeoPoint)
      : TdxPointDouble; virtual;
    function GeoToKilometersSize(AAnchorPoint: TdxMapControlGeoPoint;
      ASize: TdxSizeDouble): TdxSizeDouble; virtual;
    function KilometersToGeoSize(AAnchorPoint: TdxMapControlGeoPoint;
      ASize: TdxSizeDouble): TdxSizeDouble; virtual;
  ...
  TdxMapControlSphericalMercatorProjectionCalculator = class
  ...
  protected
    ...
    function GetMapUnitX(ALongitude, AOffsetX, AScaleX: Double)
      : Double; override;
    function GetMapUnitY(ALatitude, AOffsetY, AScaleY: Double): Double;
      override;
  end;
  ...
  protected
    function CreateProjectionCalculator
      : TdxMapControlProjectionCalculator; override;
  end;

  TdxMapControlEllipticalMercatorProjectionCalculator = class
    (TdxMapControlProjectionCalculator)
  private
    FPiHalf: Double;
    FRadiusMajor: Double;
  ...
  TdxMapControlEllipticalMercatorProjection = class
    (TdxMapControlCustomProjection)
  protected
    function CreateProjectionCalculator
      : TdxMapControlProjectionCalculator; override;
  ...
  TdxMapControlMillerProjectionCalculator = class
    (TdxMapControlProjectionCalculator)
  private
    FScaleFactor: Double;
  protected
  ...
  TdxMapControlEquirectangularProjectionCalculator = class
    (TdxMapControlProjectionCalculator)
  protected
    function MaxLatitudeInternal: Double; override;
    function MaxLongitudeInternal: Double; override;
  ...
  TdxMapControlEqualAreaProjectionCalculator = class
    (TdxMapControlProjectionCalculator)
  protected
    function MaxLatitudeInternal: Double; override;
    function MaxLongitudeInternal: Double; override;
  ...
  TdxMapControlLambertCylindricalEqualAreaProjectionCalculator = class
    (TdxMapControlProjectionCalculator)
  private const
    MeridianOffset = 0;
  protected
  ...
  TdxMapControlLambertCylindricalEqualAreaProjection = class
    (TdxMapControlCustomProjection)
  protected
    function CreateProjectionCalculator
      : TdxMapControlProjectionCalculator; override;
  ...
  TdxMapControlBraunStereographicProjectionCalculator = class
    (TdxMapControlProjectionCalculator)
  private const
    Radius = 1;
  protected
  ...
  TdxMapControlBraunStereographicProjection = class
    (TdxMapControlCustomProjection)
  protected
    function CreateProjectionCalculator
      : TdxMapControlProjectionCalculator; override;
  ...
  TdxMapControlKavrayskiyProjectionCalculator = class
    (TdxMapControlProjectionCalculator)
  private const
    MeridianOffset = 0;
  protected
    ...
    function GetGeoPoint(AMapUnit: TdxPointDouble;
      AOffset, AScale: TdxPointDouble): TdxMapControlGeoPoint; override;
    function GetMapUnit(AGeoPoint: TdxMapControlGeoPoint;
      AOffset, AScale: TdxPointDouble): TdxPointDouble; override;
  end;
  ...
  TdxMapControlSinusoidalProjectionCalculator = class
    (TdxMapControlProjectionCalculator)
  private const
    MeridianOffset = 0;
    k = 1;
  ...
  TdxMapControlEPSG4326ProjectionCalculator = class
    (TdxMapControlProjectionCalculator)
  protected
    function MaxLatitudeInternal: Double; override;
    function MaxLongitudeInternal: Double; override;
...
function TdxMapControlProjectionCalculator.GetGeoPointLatitude(AMapUnitY,
...
function TdxMapControlProjectionCalculator.GetGeoPointLongitude(AMapUnitX,
...
function TdxMapControlProjectionCalculator.GetMapUnit
  (AGeoPoint: TdxMapControlGeoPoint; AOffset, AScale: TdxPointDouble)
  : TdxPointDouble;
var
...
function TdxMapControlProjectionCalculator.GetMapUnitX(ALongitude, AOffsetX,
...
function TdxMapControlProjectionCalculator.GetMapUnitY(ALatitude, AOffsetY,
...
function TdxMapControlCustomProjection.GeoToKilometersSize
  (AAnchorPoint: TdxMapControlGeoPoint; ASize: TdxSizeDouble): TdxSizeDouble;
begin
  Result := dxSizeDouble(ASize.Width * Ratio *
    Cos(DegToRad(AAnchorPoint.Latitude)), ASize.Height * Ratio);
end;
...
function TdxMapControlCustomProjection.CreateProjectionCalculator
  : TdxMapControlProjectionCalculator;
begin
  Result := nil;
end;
...
begin
  if FProjectionCalculator <> nil then
    Result := FProjectionCalculator.GetMapUnit(AGeoPoint,
      dxPointDouble(OffsetX, OffsetY), dxPointDouble(ScaleX, ScaleY))
  else
...
begin
  if FProjectionCalculator <> nil then
    Result := FProjectionCalculator.GetGeoPoint(AMapUnit,
      dxPointDouble(OffsetX, OffsetY), dxPointDouble(ScaleX, ScaleY))
  else
...
function TdxMapControlSphericalMercatorProjection.CreateProjectionCalculator
  : TdxMapControlProjectionCalculator;
begin
...
begin
  ALatInRadian := DegToRad(Min(MaxLatitudeInternal, Max(MinLatitudeInternal,
    ALatitude)));
  ASinLat := Sin(ALatInRadian);
  Result := 0.5 * Ln((1.0 + ASinLat) / (1.0 - ASinLat)) * AScaleY + AOffsetY;
end;

function TdxMapControlSphericalMercatorProjectionCalculator.
  MaxLatitudeInternal: Double;
begin
  Result := 85.05112878;
end;

function TdxMapControlSphericalMercatorProjectionCalculator.
  MaxLongitudeInternal: Double;
begin
  Result := 180.0;
end;

function TdxMapControlSphericalMercatorProjectionCalculator.
  MinLatitudeInternal: Double;
begin
  Result := -85.05112878;
end;

function TdxMapControlSphericalMercatorProjectionCalculator.
  MinLongitudeInternal: Double;
begin
  Result := -180.0;
end;
...
function TdxMapControlEllipticalMercatorProjection.CreateProjectionCalculator
  : TdxMapControlProjectionCalculator;
begin
...
begin
  ...
  begin
    ...
    ADphi := FPiHalf - 2 * ArcTan(ATs * Power((1.0 - ACon) / (1.0 + ACon),
      FEccentricityHalf)) - APhi;
    APhi := APhi + ADphi;
    if Abs(ADphi) < 0.000000001 then
      Break;
  end;
  Result := RadToDeg(APhi);
end;

function TdxMapControlEllipticalMercatorProjectionCalculator.
  GetGeoPointLongitude(AMapUnitX, AOffsetX, AScaleX: Double): Double;
begin
  Result := RadToDeg((AMapUnitX - AOffsetX) / AScaleX);
end;
...
function TdxMapControlMillerProjection.CreateProjectionCalculator
  : TdxMapControlProjectionCalculator;
begin
...
begin
  ALatInRadian := DegToRad(Math.Min(MaxLatitudeInternal,
    Max(ALatitude, MinLatitudeInternal)));
...
function TdxMapControlEquirectangularProjection.CreateProjectionCalculator
  : TdxMapControlProjectionCalculator;
begin
...
function TdxMapControlEquirectangularProjectionCalculator.
  MaxLatitudeInternal: Double;
begin
  Result := 90.0;
end;
...
function TdxMapControlEqualAreaProjection.CreateProjectionCalculator
  : TdxMapControlProjectionCalculator;
begin
...
function TdxMapControlEqualAreaProjectionCalculator.GetMapUnitY(ALatitude,
  AOffsetY, AScaleY: Double): Double;
begin
  Result := Sin(DegToRad(EnsureRange(ALatitude, MinLatitudeInternal,
    MaxLatitudeInternal))) * Pi * AScaleY + AOffsetY;
end;
...
function TdxMapControlEqualAreaProjectionCalculator.
  MaxLongitudeInternal: Double;
begin
  Result := 180.0;
end;
...
function TdxMapControlLambertCylindricalEqualAreaProjectionCalculator.
  GetGeoPointLatitude(AMapUnitY, AOffsetY, AScaleY: Double): Double;
begin
  Result := RadToDeg(ArcSin(EnsureRange((AMapUnitY - AOffsetY) / AScaleY /
    Pi, -1, 1)));
end;
...
function TdxMapControlLambertCylindricalEqualAreaProjectionCalculator.
  GetMapUnitX(ALongitude, AOffsetX, AScaleX: Double): Double;
begin
  Result := DegToRad(ALongitude) * AScaleX + AOffsetX;
end;

function TdxMapControlLambertCylindricalEqualAreaProjectionCalculator.
  GetMapUnitY(ALatitude, AOffsetY, AScaleY: Double): Double;
begin
  Result := Sin(DegToRad(EnsureRange(ALatitude, MinLatitudeInternal,
    MaxLatitudeInternal))) * AScaleY * Pi + AOffsetY;
end;
...
function TdxMapControlLambertCylindricalEqualAreaProjection.
  CreateProjectionCalculator: TdxMapControlProjectionCalculator;
begin
  Result := TdxMapControlLambertCylindricalEqualAreaProjectionCalculator.Create;
end;

function TdxMapControlLambertCylindricalEqualAreaProjection.
  GetDefaultScaleY: Double;
begin
...
function TdxMapControlBraunStereographicProjection.CreateProjectionCalculator
  : TdxMapControlProjectionCalculator;
begin
...
function TdxMapControlKavrayskiyProjectionCalculator.GetGeoPoint(AMapUnit,
  AOffset, AScale: TdxPointDouble): TdxMapControlGeoPoint;
var
  ALatitude, ALongitude: Double;
  ADenom: Double;
  X, Y: Double;
begin
  ...
  ADenom := Pi * Pi / 3 - Y * Y;
  ALatitude := EnsureRange(RadToDeg(Y), MinLatitudeInternal,
    MaxLatitudeInternal);
  if ADenom <= 0 then
    X := Pi * Sign(X)
  else
    X := X / Sqrt(ADenom);
  ALongitude := EnsureRange(RadToDeg(X), MinLongitudeInternal,
    MaxLongitudeInternal);
  Result := dxMapControlGeoPoint(ALatitude, ALongitude);
end;

function TdxMapControlKavrayskiyProjectionCalculator.GetMapUnit
  (AGeoPoint: TdxMapControlGeoPoint; AOffset, AScale: TdxPointDouble)
  : TdxPointDouble;
var
  ALatitude, ALongitude: Double;
...
begin
  ...
  ALatitude := DegToRad(EnsureRange(AGeoPoint.Latitude, MinLatitudeInternal,
    MaxLatitudeInternal));

  AMapUnitX := ALongitude * Sqrt((Pi * Pi) / 3 - ALatitude * ALatitude) *
    AScale.X * Sqrt(3) / Pi + AOffset.X;
  AMapUnitY := ALatitude * AScale.Y * 2 + AOffset.Y;

  Result := dxPointDouble(AMapUnitX, AMapUnitY);
end;

function TdxMapControlKavrayskiyProjectionCalculator.
  MaxLatitudeInternal: Double;
begin
  Result := 90;
end;
...
function TdxMapControlKavrayskiyProjection.CreateProjectionCalculator
  : TdxMapControlProjectionCalculator;
begin
...
function TdxMapControlSinusoidalProjection.CreateProjectionCalculator
  : TdxMapControlProjectionCalculator;
begin
...
function TdxMapControlEPSG4326Projection.CreateProjectionCalculator
  : TdxMapControlProjectionCalculator;
begin
...
function TdxMapControlSinusoidalProjectionCalculator.
  MaxLatitudeInternal: Double;
begin
  Result := 90;
end;
...
function TdxMapControlSinusoidalProjectionCalculator.GetGeoPoint(AMapUnit,
  AOffset, AScale: TdxPointDouble): TdxMapControlGeoPoint;
var
  ALatitude, ALongitude: Double;
  ANormY: Double;
...
begin
  ...
  ALatitude := EnsureRange(RadToDeg(Y / k), MinLatitudeInternal,
    MaxLatitudeInternal);
  X := (AMapUnit.X - AOffset.X) / AScale.X;
  cosy := Cos(Y);
  if Abs(X - cosy) > Math.MinDouble then
    ALongitude := EnsureRange(RadToDeg(X / cosy / k), MinLongitudeInternal,
      MaxLongitudeInternal)
  else
...
function TdxMapControlSinusoidalProjectionCalculator.GetMapUnit
  (AGeoPoint: TdxMapControlGeoPoint; AOffset, AScale: TdxPointDouble)
  : TdxPointDouble;
var
  ALatitude, ALongitude: Double;
...
function TdxMapControlBraunStereographicProjectionCalculator.GetGeoPointLatitude
  (AMapUnitY, AOffsetY, AScaleY: Double): Double;
begin
  Result := EnsureRange(RadToDeg(ArcTan((AMapUnitY - AOffsetY) / AScaleY /
    Radius / Pi) * 2), MinLatitudeInternal, MaxLatitudeInternal);
end;

function TdxMapControlBraunStereographicProjectionCalculator.
  GetGeoPointLongitude(AMapUnitX, AOffsetX, AScaleX: Double): Double;
begin
  Result := RadToDeg((AMapUnitX - AOffsetX) / AScaleX / Radius);
end;

function TdxMapControlBraunStereographicProjectionCalculator.GetMapUnitX
  (ALongitude, AOffsetX, AScaleX: Double): Double;
begin
  Result := Radius * DegToRad(ALongitude) * AScaleX + AOffsetX;
end;

function TdxMapControlBraunStereographicProjectionCalculator.GetMapUnitY
  (ALatitude, AOffsetY, AScaleY: Double): Double;
begin
  Result := Radius * Tan(DegToRad(EnsureRange(ALatitude, MinLatitudeInternal,
    MaxLatitudeInternal)) / 2) * AScaleY * Pi + AOffsetY;
end;
...
function TdxMapControlEPSG4326ProjectionCalculator.GetGeoPoint(AMapUnit,
  AOffset, AScale: TdxPointDouble): TdxMapControlGeoPoint;
begin
  Result := dxMapControlGeoPoint(EnsureRange((1 - AMapUnit.Y) * 180 - 90, -90,
    90), EnsureRange(AMapUnit.X * 360 - 180, -180, 180));
end;

function TdxMapControlEPSG4326ProjectionCalculator.GetMapUnit
  (AGeoPoint: TdxMapControlGeoPoint; AOffset, AScale: TdxPointDouble)
  : TdxPointDouble;
begin
  Result := dxPointDouble((AGeoPoint.Longitude + 180) / 360,
    1 - (EnsureRange(AGeoPoint.Latitude, MinLatitudeInternal,
    MaxLatitudeInternal) + 90) / 180);
end;
...
dxRegisteredMapProjections.Register(TdxMapControlSphericalMercatorProjection,
  'SphericalMercatorProjection|Spherical Mercator');
dxRegisteredMapProjections.Register(TdxMapControlEllipticalMercatorProjection,
  'EllipticalMercatorProjection|Elliptical Mercator');
dxRegisteredMapProjections.Register(TdxMapControlMillerProjection,
  'MillerProjection|Miller Cylindrical');
dxRegisteredMapProjections.Register(TdxMapControlEquirectangularProjection,
  'EquirectangularProjection|Equirectangular');
dxRegisteredMapProjections.Register(TdxMapControlEqualAreaProjection,
  'EqualAreaProjection|Equal Area');
dxRegisteredMapProjections.Register
  (TdxMapControlLambertCylindricalEqualAreaProjection,
  'LambertCylindricalEqualAreaProjection|Lambert Cylindrical Equal Area');
dxRegisteredMapProjections.Register(TdxMapControlBraunStereographicProjection,
  'BraunStereographicProjection|Braun Stereographic');
dxRegisteredMapProjections.Register(TdxMapControlKavrayskiyProjection,
  'KavrayskiyProjection|Kavrayskiy VII');
dxRegisteredMapProjections.Register(TdxMapControlSinusoidalProjection,
  'SinusoidalProjection|Sinusoidal');
dxRegisteredMapProjections.Register(TdxMapControlEPSG4326Projection,
  'EPSG4326Projection|EPSG:4326');
