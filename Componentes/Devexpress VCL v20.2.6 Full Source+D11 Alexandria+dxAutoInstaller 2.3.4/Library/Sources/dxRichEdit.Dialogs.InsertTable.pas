...
{$ENDIF}
  ...
  Dialogs, dxCore, dxRichEdit.Dialogs.CustomDialog, cxGraphics, cxControls,
  cxLookAndFeels, cxLookAndFeelPainters,
  dxLayoutLookAndFeels, cxClasses, dxLayoutContainer, dxLayoutControl,
  cxContainer, cxEdit, dxLayoutcxEditAdapters,
  dxLayoutControlAdapters, Menus, StdCtrls, cxButtons, cxTextEdit, cxMaskEdit,
  cxSpinEdit, cxLabel,
...
type
  TdxRichEditInsertTableForm = class(TdxRichEditCustomDialogForm)
    ...
    procedure edtPropertiesValidate(Sender: TObject; var DisplayValue: Variant;
...
procedure TdxRichEditInsertTableForm.EditKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TdxRichEditInsertTableForm.edtPropertiesValidate(Sender: TObject;
...
procedure TdxRichEditInsertTableForm.edtColumnsPropertiesChange
  (Sender: TObject);
begin
...
begin
  ...
  liColumns.CaptionOptions.Text :=
    cxGetResourceString(@sdxRichEditInsertTableColumns);
  liRows.CaptionOptions.Text := cxGetResourceString
    (@sdxRichEditInsertTableRows);
end;

function TdxRichEditInsertTableForm.CreateController(AControllerParameters
  : TdxFormControllerParameters): TdxFormController;
begin
  Result := TdxInsertTableFormController.Create
    (AControllerParameters as TdxInsertTableFormControllerParameters);
end;
