...
uses
  ...
  cxLabel, cxDateUtils, dxLayoutcxEditAdapters, dxLayoutControlAdapters,
...
type
  ...
  public
    constructor CreateEx(AScheduler: TcxCustomScheduler;
...
constructor TfmGoToDateForm.CreateEx(AScheduler: TcxCustomScheduler;
  ADate: TDateTime);
begin
  Create(Application);
