...
uses
  Windows, Types, Classes, SysUtils, Graphics, Generics.Defaults,
  Generics.Collections, dxCore, dxCoreClasses, dxGDIPlusClasses,
...
type
  ...
  strict private
    ...
    FReadOnly: Boolean;
    FHyperlinkCalculators
      : TObjectDictionary<TdxPieceTable, TdxHyperlinkCalculator>;
  ...
  protected
    ...
    function IntersectClipBounds(const AOldClipBounds, ABounds: TdxRectF)
      : TdxRectF; virtual;
    ...
    function BeforeExportRotatedContent(ABox: TdxFloatingObjectBox)
      : Boolean; virtual;
    ...
    procedure ExportParagraphFrames(AColumn: TdxColumn;
      ...
      overload; virtual;
    procedure ExportParagraphFrames(AParagraphFrames: TdxParagraphFrameBoxList;
      APieceTable: TdxCustomPieceTable); overload; virtual;
    procedure ExportParagraphBackgroundFrame(AParagraphFrameBox
      : TdxParagraphFrameBox); virtual;
    procedure ExportParagraphFrame(AParagraphFrameBox
      : TdxParagraphFrameBox); virtual;
    ...
    function BeginHeaderFooterExport(const AClipBounds: TdxRectF)
      : TdxRectF; virtual;
    procedure EndHeaderFooterExport(const AOldClipBounds: TdxRectF); virtual;
    procedure ExportPageHeaderFooter
      (AArea: TdxHeaderFooterPageAreaBase); virtual;
    function CalculateHeaderFooterClipBounds(const AContentBounds: TdxRectF)
      : TdxRectF;
    procedure ExportTables(AColumn: TdxColumn); virtual;
    procedure ExportTablesBackground(AColumn: TdxColumn); virtual;
    procedure ExportNotRotatedContent(ABox: TdxFloatingObjectBox);
      overload; virtual;
    function ExportNotRotatedContent(ABox: TdxParagraphFrameBox): Boolean;
      overload; virtual;
    function ShouldExportComments(APage: TdxPage): Boolean; virtual;
    procedure BeforeExportComments(APage: TdxPage); virtual;
    procedure BeforeExportComment(ACommentViewInfo
      : TdxCommentViewInfo); virtual;
    function ShouldExportComment(ACommentViewInfo: TdxCommentViewInfo)
      : Boolean; virtual;
    procedure AfterExportComment(ACommentViewInfo: TdxCommentViewInfo;
      const APageCommentBounds: TRect); virtual;
    function GetHyperlinkCalculator(APieceTable: TdxPieceTable)
  ...
  public
    ...
    procedure ExportParagraphFrameShape(ABox: TdxParagraphFrameBox;
      AShape: TdxShape); virtual;
    procedure ExportParagraphFramePicture(ABox: TdxParagraphFrameBox;
      APictureContent: TdxPictureFloatingObjectContent); virtual;
    procedure ExportParagraphFrameTextBox(ABox: TdxParagraphFrameBox;
      ATextBoxDocumentLayout: TdxDocumentLayout); virtual;
    procedure ExportComment(ACommentViewInfo: TdxCommentViewInfo); virtual;
    procedure ExportCommentStartBox
      (ABox: TdxVisitableDocumentIntervalBox); virtual;
    procedure ExportCommentEndBox
      (ABox: TdxVisitableDocumentIntervalBox); virtual;
    procedure ExportPageAreaCore(APage: TdxPage;
      APieceTable: TdxCustomPieceTable; AAction: TdxExportPageAction);
    procedure ApplyActivePieceTable(APageArea: TdxPageArea);
    procedure RestorePieceTable;
    procedure ExportPageHeaderFooterBase(APageArea
    ...
    procedure ExportFloatingObjects(AFloatingObjects: TdxFloatingObjectBoxList;
      APieceTable: TdxCustomPieceTable);
    procedure ExportPage(APage: TdxPage); overload; virtual;
    procedure ExportPage(APage: TdxPage; const AAction: TdxAction);
      overload; virtual;
    procedure ExportParagraphFramePage(APage: TdxPage;
      const APageClipBounds: TdxRectF; AExportContent: Boolean); virtual;
    ...
    procedure ExportLayoutDependentTextBox
      (ABox: TdxLayoutDependentTextBox); virtual;
    procedure ExportHyphenBox(ABox: TdxHyphenBox); virtual;
    procedure ExportInlinePictureBox(ABox: TdxInlinePictureBox); virtual;
    function BeginExportCompositeObject(const ABounds: TRect;
      APieceTable: TdxPieceTable; var AOldClipRect, AClipRect: TdxRectF;
      var AOldPieceTable: TdxPieceTable): Boolean; virtual;
    procedure EndExportCompositeObject(const AOldClipRect: TdxRectF;
      AOldPieceTable: TdxPieceTable); virtual;
    procedure ExportFloatingObjectBox(ABox: TdxFloatingObjectBox); virtual;
    procedure ExportFloatingObjectShape(TdxBox: TdxFloatingObjectBox;
      AShape: TdxShape); virtual;
    procedure ExportFloatingObjectPicture(ABox: TdxFloatingObjectBox;
      AImage: TdxOfficeImage); virtual;
    procedure ExportFloatingObjectTextBox(ABox: TdxFloatingObjectBox;
      ATextBoxContent: TdxTextBoxFloatingObjectContent;
      ATextBoxDocumentLayout: TdxDocumentLayout); virtual;
    function ExportRotatedContent(ABox: TdxFloatingObjectBox): Boolean;
      overload; virtual;
    function ExportRotatedContent(ABox: TdxParagraphFrameBox): Boolean;
      overload; virtual;
    ...
    procedure ExportUnderlineBox(ARow: TdxSimpleRow;
      AUnderlineBox: TdxUnderlineBox); virtual;
    procedure ExportStrikeoutBox(ARow: TdxSimpleRow;
      AStrikeoutBox: TdxUnderlineBox); virtual;
    procedure ExportErrorBox(AErrorBox: TdxErrorBox); virtual;
    procedure ExportBookmarkStartBox
      (ABox: TdxVisitableDocumentIntervalBox); virtual;
    procedure ExportBookmarkEndBox
      (ABox: TdxVisitableDocumentIntervalBox); virtual;
    ...
    procedure ExportTableBorder(ABorder: TdxTableBorderViewInfoBase;
      const ACellBounds: TRect); virtual;
    ...
    property ShowWhitespace: Boolean read GetShowWhitespace
      write SetShowWhitespace;
    property MinReadableTextHeight: Integer read FMinReadableTextHeight
      write FMinReadableTextHeight;
    property CurrentBackColor: TdxAlphaColor read FCurrentBackColor
      write FCurrentBackColor;
    property CurrentCellBackColor: TdxAlphaColor read FCurrentCellBackColor
      write FCurrentCellBackColor;
    ...
    property ColumnClipBounds: TdxRectF read FColumnClipBounds
      write FColumnClipBounds;
  end;

  { TdxBoundedDocumentLayoutExporter }

  TdxBoundedDocumentLayoutExporter = class abstract(TdxDocumentLayoutExporter,
    IdxPatternLinePainter, IdxUnderlinePainter, IdxStrikeoutPainter,
  ...
  protected
    function CreateHorizontalLinePainter(const ALinePaintingSupport
      : IdxPatternLinePaintingSupport): TdxRichEditPatternLinePainter;
      virtual; abstract;
    function CreateVerticalLinePainter(const ALinePaintingSupport
      : IdxPatternLinePaintingSupport): TdxRichEditPatternLinePainter;
      virtual; abstract;

    function GetCharacterLineBoxByIndex(ARow: TdxSimpleRow;
      AIndex: Integer): TdxBox;
    function GetOffset: TPoint; virtual;
    function IsValidBounds(const ABoxBounds: TRect): Boolean; override;
    function GetTabLeaderCharacter(ALeaderType: TdxTabLeaderType)
      : Char; virtual;
    function GetTabLeaderCharacterWidth(ABox: TdxTabSpaceBox): Integer; virtual;
    function ShouldCenterTabLeaderLineVertically(ABox: TdxTabSpaceBox)
      : Boolean; virtual;
    function GetTabLeaderUnderlineType(ABox: TdxTabSpaceBox)
      : TdxUnderlineType; virtual;
    ...
    function GetTabLeaderText(ABox: TdxTabSpaceBox; const ATextBounds: TRect)
      : string; virtual;
    ...
    procedure DrawDoubleSolidLine(const ABounds: TdxRectF;
      AColor: TdxAlphaColor);
    procedure DrawPatternLine(const ABounds: TdxRectF; AColor: TdxAlphaColor;
      const APattern: TArray<Single>);
  public
    constructor Create(ADocumentModel: TdxDocumentModel; const ABounds: TRect;
      const ALinePaintingSupport: IdxPatternLinePaintingSupport;
      ATextColors: TdxTextColors);
    destructor Destroy; override;

    procedure DrawUnderline(AUnderline: TdxUnderlineSingle;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawUnderline(AUnderline: TdxUnderlineDotted;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawUnderline(AUnderline: TdxUnderlineDashed;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawUnderline(AUnderline: TdxUnderlineDashSmallGap;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawUnderline(AUnderline: TdxUnderlineDashDotted;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawUnderline(AUnderline: TdxUnderlineDashDotDotted;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawUnderline(AUnderline: TdxUnderlineDouble;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawUnderline(AUnderline: TdxUnderlineHeavyWave;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawUnderline(AUnderline: TdxUnderlineLongDashed;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawUnderline(AUnderline: TdxUnderlineThickSingle;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawUnderline(AUnderline: TdxUnderlineThickDotted;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawUnderline(AUnderline: TdxUnderlineThickDashed;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawUnderline(AUnderline: TdxUnderlineThickDashDotted;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawUnderline(AUnderline: TdxUnderlineThickDashDotDotted;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawUnderline(AUnderline: TdxUnderlineThickLongDashed;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawUnderline(AUnderline: TdxUnderlineDoubleWave;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawUnderline(AUnderline: TdxUnderlineWave;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawStrikeout(AStrikeout: TdxStrikeoutSingle;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;
    procedure DrawStrikeout(AStrikeout: TdxStrikeoutDouble;
      const ABounds: TdxRectF; AColor: TdxAlphaColor); overload;

    function GetDrawingBounds(const ABounds: TRect): TRect; override;
    function GetTableBorderLine(ABorderLineStyle: TdxBorderLineStyle)
      : TdxUnderline; virtual;
    function GetShapeOutlinePenWidth(ARun: TdxFloatingObjectAnchorRun;
    ...
    property HorizontalLinePainter: TdxRichEditPatternLinePainter
      read FHorizontalLinePainter;
    property VerticalLinePainter: TdxRichEditPatternLinePainter
      read FVerticalLinePainter;
  ...
  public
    ...
    procedure ExportNumberingListBoxSeparator(ANumberingListBoxWithSeparator
      : TdxNumberingListBoxWithSeparator); virtual; abstract;
  ...
  public
    procedure ExportInlinePictureBox(AExporter
      : TdxGraphicsDocumentLayoutExporter; ABox: TdxInlinePictureBox);
      virtual; abstract;
    procedure ExportTabSpaceBoxCore(AExporter
      : TdxGraphicsDocumentLayoutExporter; ABox: TdxTabSpaceBox);
      virtual; abstract;
    procedure ExportSeparatorBoxCore(AExporter
      : TdxGraphicsDocumentLayoutExporter; ABox: TdxSeparatorBox);
      virtual; abstract;
    procedure ExportLineBreakBoxCore(AExporter
      : TdxGraphicsDocumentLayoutExporter; ABox: TdxLineBreakBox);
      virtual; abstract;
    procedure ExportTabLeader(AExporter: TdxGraphicsDocumentLayoutExporter;
      ABox: TdxTabSpaceBox); virtual; abstract;
    procedure ExportFloatingObjectPicture
  ...
  protected
    ...
    procedure DrawLine(const ALineBounds: TRect; AForeColor: TdxAlphaColor);
      virtual; abstract;
  public
    constructor Create(AExporter: TdxGraphicsDocumentLayoutExporter);
  ...
  protected
    ...
    function CreateHorizontalLinePainter(const ALinePaintingSupport
      : IdxPatternLinePaintingSupport): TdxRichEditPatternLinePainter; override;
    function CreateVerticalLinePainter(const ALinePaintingSupport
      : IdxPatternLinePaintingSupport): TdxRichEditPatternLinePainter; override;
    ...
    procedure ExportCompositeObject(const ABounds: TRect;
    ...
    procedure ExportTextBoxCore(ABox: TdxBox; const ATextBounds: TRect;
      const AText: string); overload;
    procedure ExportSpaceBoxCore(ABox: TdxBox; const ATextBounds: TRect;
      const AText: string);
    ...
    procedure ExportMarkBoxCore(ABox: TdxBox;
      AExporter: TdxMarkBoxExporterBase);
    function GetBorderPainter(ACorner: TdxCornerViewInfoBase)
    ...
    procedure BeginExportTableCellContent(const AClipBounds: TdxRectF);
      override;
  ...
  public
    constructor Create(ADocumentModel: TdxDocumentModel; APainter: TdxPainter;
      AAdapter: TdxGraphicsDocumentLayoutExporterAdapter; const ABounds: TRect;
      ATextColors: TdxTextColors); overload;
    constructor Create(ADocumentModel: TdxDocumentModel; APainter: TdxPainter;
      AAdapter: TdxGraphicsDocumentLayoutExporterAdapter; const ABounds: TRect;
      AHidePartiallyVisibleRow: Boolean; ATextColors: TdxTextColors); overload;
    destructor Destroy; override;
    procedure ExportRow(ARow: TdxRow); override;
    function GetActualForeColor(ABox: TdxBox; const ABounds: TRect)
      : TdxAlphaColor;
    ...
    procedure ExportLayoutDependentTextBox
      (ABox: TdxLayoutDependentTextBox); override;
    ...
    procedure ExportFloatingObjectShape(ABox: TdxFloatingObjectBox;
      AShape: TdxShape); override;
    procedure ExportParagraphFrameShape(ABox: TdxParagraphFrameBox;
      AShape: TdxShape); override;
    procedure FillRectangle(AFillColor: TdxAlphaColor;
      const AActualContentBounds: TRect);
    procedure DrawParagraphBordersWithCorners(const AActualContentBounds: TRect;
      ABoxParagraphProperties: TdxParagraphProperties);
    class function GetActualBoxHeight(const AActualBounds: TRect;
      ARows: TdxRowCollection; ACurrentRow: TdxRow; const ARowBounds: TRect)
      : Integer; static;
    procedure DrawParagraphBackground(const AActualBounds: TRect;
      ARows: TdxRowCollection);
    procedure DrawParagraphBordersWithoutTableBounds(const AActualBounds: TRect;
      ABoxParagraphProperties: TdxParagraphProperties; ARows: TdxRowCollection);
    procedure DrawParagraphBorders(const AContentBounds: TRect;
      AParagraphProperties: TdxParagraphProperties);
    procedure DrawParagraphBordersCorners(const AContentBounds: TRect;
      AParagraphProperties: TdxParagraphProperties);
    procedure ExportFloatingObjectPicture(ABox: TdxFloatingObjectBox;
      AImage: TdxOfficeImage); override;
    procedure ExportFloatingObjectTextBox(ABox: TdxFloatingObjectBox;
      ATextBoxContent: TdxTextBoxFloatingObjectContent;
      ATextBoxDocumentLayout: TdxDocumentLayout); override;
    procedure ExportParagraphFrameTextBox(ABox: TdxParagraphFrameBox;
      ATextBoxDocumentLayout: TdxDocumentLayout); override;
    function BeginExportCompositeObject(const ABounds: TRect;
      APieceTable: TdxPieceTable; var AOldClipRect, AClipRect: TdxRectF;
    ...
    procedure EndExportCompositeObject(const AOldClipRect: TdxRectF;
      AOldPieceTable: TdxPieceTable); override;
    ...
    procedure ExportTableBorder(ABorder: TdxTableBorderViewInfoBase;
      const ACellBounds: TRect); override;
    procedure ExportTableBorderCorner(ACorner: TdxCornerViewInfoBase;
    ...
    procedure ExcludeCellBounds(ACells: TdxTableCellViewInfoCollection;
      const ARowBounds: TRect);
    function GetActualBackgroundColor(ARow: TdxTableRowViewInfoBase)
      : TdxAlphaColor;
    procedure ExportUnderlineBox(ARow: TdxSimpleRow;
      AUnderlineBox: TdxUnderlineBox); override;
    procedure ExportStrikeoutBox(ARow: TdxSimpleRow;
      AStrikeoutBox: TdxUnderlineBox); override;

    property Adapter: TdxGraphicsDocumentLayoutExporterAdapter read FAdapter;
    property DrawInactivePieceTableWithDifferentColor: Boolean
      read FDrawInactivePieceTableWithDifferentColor
      write FDrawInactivePieceTableWithDifferentColor;
    property HidePartiallyVisibleRow: Boolean read FHidePartiallyVisibleRow
      write FHidePartiallyVisibleRow;
  end;

  { TdxScreenOptimizedGraphicsDocumentLayoutExporter }

  TdxScreenOptimizedGraphicsDocumentLayoutExporter = class
    (TdxGraphicsDocumentLayoutExporter) // for internal use
  strict private
    FPixel: Integer;
  ...
  TdxScreenOptimizedGraphicsDocumentLayoutExporterNoLineNumbers = class
    (TdxScreenOptimizedGraphicsDocumentLayoutExporter) // for internal use
  public
    procedure ExportLineNumberBox(ABox: TdxLineNumberBox); override;
  end;
  ...
  TdxWinFormsGraphicsDocumentLayoutExporterAdapter = class
    (TdxGraphicsDocumentLayoutExporterAdapter)
  strict private
    procedure ExportInlinePictureBoxCore(AExporter
      : TdxGraphicsDocumentLayoutExporter; ABox: TdxInlinePictureBox;
      AImg: TdxOfficeImage; const AImgBounds: TRect; const ASize: TSize;
      ASizing: TdxImageSizeMode);
  public
    destructor Destroy; override;
    procedure ExportLineBoxCore<T>(AExporter: TdxGraphicsDocumentLayoutExporter;
      const ALinePainter: IdxPatternLinePainter; ALineBox: TdxUnderlineBox;
      ALine: TdxPatternLine<T>; ALineColor: TdxAlphaColor);
    procedure ExportInlinePictureBox(AExporter
      : TdxGraphicsDocumentLayoutExporter; ABox: TdxInlinePictureBox); override;
    procedure ExportFloatingObjectPicture
      (AExporter: TdxGraphicsDocumentLayoutExporter; ABox: TdxFloatingObjectBox;
      AImage: TdxOfficeImage); override;
    procedure ExportTabSpaceBoxCore(AExporter
      : TdxGraphicsDocumentLayoutExporter; ABox: TdxTabSpaceBox); override;
    procedure ExportSeparatorBoxCore(AExporter
      : TdxGraphicsDocumentLayoutExporter; ABox: TdxSeparatorBox); override;
    procedure ExportSingleCharacterMarkBoxCore
      (AExporter: TdxGraphicsDocumentLayoutExporter;
      ABox: TdxSingleCharacterMarkBox);
    procedure ExportLineBreakBoxCore(AExporter
      : TdxGraphicsDocumentLayoutExporter; ABox: TdxLineBreakBox); override;
    procedure DrawLineBreakArrow(AExporter: TdxGraphicsDocumentLayoutExporter;
      const AGlyphBounds: TRect; AForeColor: TdxAlphaColor);
    procedure ExportTabLeader(AExporter: TdxGraphicsDocumentLayoutExporter;
      ABox: TdxTabSpaceBox); override;
  end;
  ...
  private
    ...
    procedure ExportMultiCharacterBox(ABox: TdxBox;
  ...
  public
    constructor Create(APainter: TdxPainter; const AHorizontalLinePainter,
    ...
    property HorizontalLinePainter: IdxCharacterLinePainter
      read GetHorizontalLinePainter;
    property VerticalLinePainter: IdxCharacterLinePainter
      read GetVerticalLinePainter;
  end;
  ...
  private
    ...
    function GetBorderPainter(ABorder: TdxBorderInfo;
      AConverter: TdxDocumentModelUnitToLayoutUnitConverter;
      APainterWrapper: TdxGraphicsPainterWrapper): TdxTableBorderPainter;
      overload;
    function GetTableBorderLine(ABorderLineStyle: TdxBorderLineStyle;
      ADocumentModel: TdxDocumentModel): TdxUnderline; overload;
    function GetBorderPainter(ACorner: TdxCornerViewInfoBase)
      : TdxTableCornerPainter; overload;
  ...
  public
    constructor Create(ADocumentModel: TdxDocumentModel; APainter: TdxPainter;
      AHorizontalLinePainter: TdxRichEditPatternLinePainter;
      AVerticalLinePainter: TdxRichEditPatternLinePainter;
      const ABounds: TRect); overload;
    constructor Create(ADocumentModel: TdxDocumentModel; APainter: TdxPainter;
      AHorizontalLinePainter: TdxRichEditPatternLinePainter;
      AVerticalLinePainter: TdxRichEditPatternLinePainter); overload;
    procedure ExportTableBorder(ABorder: TdxBorderInfo;
      const ADrawingBounds: TRect;
      AConverter: TdxDocumentModelUnitToLayoutUnitConverter;
...
type
  ...
  public
    ...
    function GetBackColor(const ABounds: TRect)
      : TdxNullableValue<TdxAlphaColor>;
  end;

  { TdxGraphicsDocumentLayoutExporterShowWhitespaceStrategy }

  TdxGraphicsDocumentLayoutExporterShowWhitespaceStrategy = class
    (TdxGraphicsDocumentLayoutExporterWhitespaceStrategy)
  public
    ...
    procedure ExportSeparatorBox(ABox: TdxSeparatorBox); override;
    procedure ExportNumberingListBoxSeparator(ANumberingListBoxWithSeparator
      : TdxNumberingListBoxWithSeparator); override;
  end;

  { TdxGraphicsDocumentLayoutExporterHideWhitespaceStrategy }

  TdxGraphicsDocumentLayoutExporterHideWhitespaceStrategy = class
    (TdxGraphicsDocumentLayoutExporterShowWhitespaceStrategy)
  private
  ...
  public
    ...
    property FormattingMarkVisibility: TdxFormattingMarkVisibilityOptions
      read GetFormattingMarkVisibility;
  end;
  ...
  protected
    ...
    procedure DrawLine(const ALineBounds: TRect;
      AForeColor: TdxAlphaColor); override;
  end;
...
constructor TdxBackgroundItem.Create(AColor: TdxAlphaColor;
  const ABounds: TRect);
begin
  Color := AColor;
  Bounds := ABounds;
...
procedure TdxBackgroundLayer.SetBackColor(AColor: TdxAlphaColor;
  const ABounds: TRect);
begin
...
function TdxBackgroundLayer.GetBackColor(const ABounds: TRect)
  : TdxNullableValue<TdxAlphaColor>;
var
  I: Integer;
...
begin
  ...
  FHyperlinkCalculators :=
    TObjectDictionary<TdxPieceTable, TdxHyperlinkCalculator>.Create
    ([doOwnsValues]);
...
procedure TdxDocumentLayoutExporter.ExportParagraphFrameShape
  (ABox: TdxParagraphFrameBox; AShape: TdxShape);
begin
end;

procedure TdxDocumentLayoutExporter.ExportParagraphFramePicture
  (ABox: TdxParagraphFrameBox;
  APictureContent: TdxPictureFloatingObjectContent);
begin
end;

procedure TdxDocumentLayoutExporter.ExportParagraphFrameTextBox
  (ABox: TdxParagraphFrameBox; ATextBoxDocumentLayout: TdxDocumentLayout);
begin
end;

procedure TdxDocumentLayoutExporter.ExportComment(ACommentViewInfo
  : TdxCommentViewInfo);
begin
end;

procedure TdxDocumentLayoutExporter.ExportCommentStartBox
  (ABox: TdxVisitableDocumentIntervalBox);
begin
end;

procedure TdxDocumentLayoutExporter.ExportCommentEndBox
  (ABox: TdxVisitableDocumentIntervalBox);
begin
end;

function TdxDocumentLayoutExporter.ApplyClipBounds(const AClipBounds: TdxRectF)
  : TdxRectF;
var
...
begin
  ...
  if (AActualClipBounds.Left = NegInfinity) and
    (AActualClipBounds.Top = NegInfinity) and
    (AActualClipBounds.Width = Infinity) and
    (AActualClipBounds.Height = Infinity) then
...
procedure TdxDocumentLayoutExporter.ApplyCurrentRowTableCellClipping
  (ARow: TdxRow);
var
...
begin
  ...
  begin
    ...
    begin
      AClipBounds := GetDrawingBounds
        (ACell.TableViewInfo.GetCellBounds(ACell)).ToRectF;
...
function TdxDocumentLayoutExporter.BeginExportCompositeObject
  (const ABounds: TRect; APieceTable: TdxPieceTable;
var AOldClipRect, AClipRect: TdxRectF;
var AOldPieceTable: TdxPieceTable): Boolean;
begin
  Result := True;
end;

procedure TdxDocumentLayoutExporter.EndExportCompositeObject(const AOldClipRect
  : TdxRectF; AOldPieceTable: TdxPieceTable);
begin
end;

procedure TdxDocumentLayoutExporter.ExportFloatingObjectBox
...
procedure TdxDocumentLayoutExporter.ExportInlinePictureBox
  (ABox: TdxInlinePictureBox);
begin
end;

procedure TdxDocumentLayoutExporter.ExportLayoutDependentTextBox
  (ABox: TdxLayoutDependentTextBox);
begin
end;

procedure TdxDocumentLayoutExporter.ExportFloatingObjectShape
  (TdxBox: TdxFloatingObjectBox; AShape: TdxShape);
begin
end;

procedure TdxDocumentLayoutExporter.ExportFloatingObjectPicture
  (ABox: TdxFloatingObjectBox; AImage: TdxOfficeImage);
begin
end;

procedure TdxDocumentLayoutExporter.ExportFloatingObjects(AFloatingObjects
  : TdxFloatingObjectBoxList; APieceTable: TdxCustomPieceTable);
var
  ACount, I: Integer;
...
procedure TdxDocumentLayoutExporter.ExportFloatingObjectTextBox
  (ABox: TdxFloatingObjectBox; ATextBoxContent: TdxTextBoxFloatingObjectContent;
...
procedure TdxDocumentLayoutExporter.ExportParagraphMarkBox
  (ABox: TdxParagraphMarkBox);
begin
end;

procedure TdxDocumentLayoutExporter.ExportSectionMarkBox
  (ABox: TdxSectionMarkBox);
begin
end;

procedure TdxDocumentLayoutExporter.ExportUnderlineBox(ARow: TdxSimpleRow;
AUnderlineBox: TdxUnderlineBox);
begin
end;

procedure TdxDocumentLayoutExporter.ExportStrikeoutBox(ARow: TdxSimpleRow;
...
procedure TdxDocumentLayoutExporter.ExportBookmarkStartBox
  (ABox: TdxVisitableDocumentIntervalBox);
begin
end;

procedure TdxDocumentLayoutExporter.ExportBookmarkEndBox
  (ABox: TdxVisitableDocumentIntervalBox);
begin
end;
...
procedure TdxDocumentLayoutExporter.ExportColumnBreakBox
  (ABox: TdxColumnBreakBox);
begin
end;

procedure TdxDocumentLayoutExporter.ExportNumberingListBox
...
procedure TdxDocumentLayoutExporter.ExportTableBorder
  (ABorder: TdxTableBorderViewInfoBase; const ACellBounds: TRect);
begin
end;

procedure TdxDocumentLayoutExporter.ExportTableBorderCorner
  (ACorner: TdxCornerViewInfoBase; X, Y: Integer);
begin
end;

procedure TdxDocumentLayoutExporter.ExportTableCell
  (ACell: TdxTableCellViewInfo);
begin
end;

procedure TdxDocumentLayoutExporter.ExportTableRow
  (ARow: TdxTableRowViewInfoBase);
begin
end;

procedure TdxDocumentLayoutExporter.ExportParagraphFrameBox
  (ABox: TdxParagraphFrameBox);
begin
  if not ExportRotatedContent(ABox) then
    ExportNotRotatedContent(ABox);
...
procedure TdxDocumentLayoutExporter.ExportHighlightArea
  (const AArea: TdxHighlightArea);
begin
end;
...
procedure TdxDocumentLayoutExporter.ExportPage(APage: TdxPage;
const AAction: TdxAction);
begin
  AAction;
end;

procedure TdxDocumentLayoutExporter.ExportParagraphFramePage(APage: TdxPage;
...
procedure TdxDocumentLayoutExporter.ExportPageAreaCore(APage: TdxPage;
APieceTable: TdxCustomPieceTable; AAction: TdxExportPageAction);
var
  AFloatingObjects: TdxFloatingObjectBoxList;
  AParagraphFrames: TdxParagraphFrameBoxList;
...
procedure TdxDocumentLayoutExporter.ApplyActivePieceTable
...
procedure TdxDocumentLayoutExporter.ExportPageHeaderFooterBase
  (APageArea: TdxHeaderFooterPageAreaBase);
var
...
begin
  ...
  AClipBounds := CalculateHeaderFooterClipBounds
    (APageArea.ContentBounds.ToRectF);
...
procedure TdxDocumentLayoutExporter.ExportParagraphBackgroundFrame
...
procedure TdxDocumentLayoutExporter.ExportParagraphFrame(AParagraphFrameBox
...
procedure TdxDocumentLayoutExporter.ExportParagraphFrames(AParagraphFrames
  : TdxParagraphFrameBoxList; APieceTable: TdxCustomPieceTable);
var
  ACount, I: Integer;
...
function TdxDocumentLayoutExporter.CalculateHeaderFooterClipBounds
  (const AContentBounds: TdxRectF): TdxRectF;
begin
  Result := GetClipBounds;
  Result.Height := Math.Max(0, AContentBounds.Bottom - Result.Top);
end;

function TdxDocumentLayoutExporter.BeginHeaderFooterExport(const AClipBounds
  : TdxRectF): TdxRectF;
begin
  Result := ApplyClipBounds(AClipBounds);
end;

procedure TdxDocumentLayoutExporter.EndHeaderFooterExport(const AOldClipBounds
  : TdxRectF);
begin
  RestoreClipBounds(AOldClipBounds);
end;

procedure TdxDocumentLayoutExporter.ExportPageHeaderFooter
  (AArea: TdxHeaderFooterPageAreaBase);
begin
  AArea.ExportTo(Self);
end;
...
function TdxDocumentLayoutExporter.ExportRotatedContent
  (ABox: TdxFloatingObjectBox): Boolean;
var
...
procedure TdxDocumentLayoutExporter.ExportNotRotatedContent
  (ABox: TdxFloatingObjectBox);
var
  ARun: TdxFloatingObjectAnchorRun;
  ATextBoxContent: TdxTextBoxFloatingObjectContent;
...
function TdxDocumentLayoutExporter.ExportRotatedContent
  (ABox: TdxParagraphFrameBox): Boolean;
var
  APreviousPieceTable: TdxPieceTable;
begin
  APreviousPieceTable := PieceTable;
...
function TdxDocumentLayoutExporter.ExportNotRotatedContent
  (ABox: TdxParagraphFrameBox): Boolean;
begin
...
function TdxDocumentLayoutExporter.ShouldExportComments(APage: TdxPage)
  : Boolean;
begin
  Result := True;
end;
...
procedure TdxDocumentLayoutExporter.BeforeExportComment(ACommentViewInfo
  : TdxCommentViewInfo);
begin
end;

function TdxDocumentLayoutExporter.ShouldExportComment(ACommentViewInfo
  : TdxCommentViewInfo): Boolean;
begin
  Result := True;
end;

procedure TdxDocumentLayoutExporter.AfterExportComment(ACommentViewInfo
  : TdxCommentViewInfo; const APageCommentBounds: TRect);
begin
end;

function TdxDocumentLayoutExporter.GetHyperlinkCalculator
  (APieceTable: TdxPieceTable): TdxHyperlinkCalculator;
begin
...
begin
  Result := GetHyperlinkCalculator(PieceTable)
    .GetUrl(ABox.GetFirstPosition(PieceTable).RunIndex);
end;

function TdxDocumentLayoutExporter.GetAnchor(ABox: TdxBox): string;
begin
  Result := GetHyperlinkCalculator(PieceTable)
    .GetAnchor(ABox.GetFirstPosition(PieceTable).RunIndex);
end;
...
function TdxDocumentLayoutExporter.BeforeExportRotatedContent
  (ABox: TdxFloatingObjectBox): Boolean;
begin
  Result := True;
end;

procedure TdxDocumentLayoutExporter.AfterExportRotatedContent(ATransformApplied
  : Boolean);
begin
end;
...
procedure TdxDocumentLayoutExporter.ExportSpecialTextBox
...
function TdxDocumentLayoutExporter.GetDrawingBounds(const ABounds
  : TRect): TRect;
begin
  Result := ABounds;
end;

function TdxDocumentLayoutExporter.GetLastExportBoxInRowIndex
  (ARow: TdxRow): Integer;
begin
...
function TdxDocumentLayoutExporter.IntersectClipBounds(const AOldClipBounds,
  ABounds: TdxRectF): TdxRectF;
begin
...
function TdxDocumentLayoutExporter.IsAnchorVisible(const AAnchor
  : TdxTableCellVerticalAnchor): Boolean;
begin
  Result := True;
end;

function TdxDocumentLayoutExporter.IsTableRowVisible
  (ARow: TdxTableRowViewInfoBase): Boolean;
begin
  Result := True;
end;

function TdxDocumentLayoutExporter.IsValidBounds(const ABoxBounds
  : TRect): Boolean;
begin
  Result := True;
end;

procedure TdxDocumentLayoutExporter.RestoreClipBounds(const AClipBounds
  : TdxRectF);
begin
  RestoreClipBoundsCore(AClipBounds);
end;

procedure TdxDocumentLayoutExporter.ApplyClipBoundsCore(const ABounds
  : TdxRectF);
begin
  SetClipBounds(ABounds);
end;

procedure TdxDocumentLayoutExporter.RestoreClipBoundsCore
...
procedure TdxDocumentLayoutExporter.BeginExportTableCellContent
  (const AClipBounds: TdxRectF);
begin
  SetClipBounds(AClipBounds);
end;

procedure TdxDocumentLayoutExporter.EndExportTableContent(const AOldClipBounds
  : TdxRectF);
begin
  RestoreClipBounds(AOldClipBounds);
end;

function TdxDocumentLayoutExporter.BeginExportTableCell
  (ACell: TdxTableCellViewInfo): TdxRectF;
var
  AOldClipBounds: TdxRectF;
begin
  AOldClipBounds := GetClipBounds;
  ApplyClipBounds(GetDrawingBounds(ACell.TableViewInfo.GetCellBounds(ACell)
    ).ToRectF);
  FCurrentCell := ACell;
  FCurrentCellBackColor := ACell.Cell.Properties.BackgroundColor;
  Result := AOldClipBounds;
...
procedure TdxDocumentLayoutExporter.EndExportTableCell(const AOldClipBounds
  : TdxRectF);
begin
  RestoreClipBounds(AOldClipBounds);
  FCurrentCell := nil;
...
function TdxDocumentLayoutExporter.GetActualBackColor(const ABounds: TRect)
  : TdxAlphaColor;
begin
...
function TdxDocumentLayoutExporter.GetBackColor(const ABounds: TRect)
  : TdxAlphaColor;
var
  ALayerIndex: Integer;
...
begin
  ...
  begin
    AColor := TdxBackgroundLayer(FBackgroundLayers[ALayerIndex])
      .GetBackColor(ABounds);
    Dec(ALayerIndex);
  end;
...
procedure TdxDocumentLayoutExporter.SetBackColor(AColor: TdxAlphaColor;
const ABounds: TRect);
begin
  TdxBackgroundLayer(FBackgroundLayers[FBackgroundLayers.Count - 1])
    .SetBackColor(AColor, ABounds);
end;

{ TdxBoundedDocumentLayoutExporter }

constructor TdxBoundedDocumentLayoutExporter.Create(ADocumentModel
  : TdxDocumentModel; const ABounds: TRect;
const ALinePaintingSupport: IdxPatternLinePaintingSupport;
ATextColors: TdxTextColors);
begin
...
procedure TdxBoundedDocumentLayoutExporter.DrawDoubleSolidLine
  (const ABounds: TdxRectF; AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawDoubleSolidLine(ABounds, AColor);
end;

procedure TdxBoundedDocumentLayoutExporter.DrawPatternLine
  (const ABounds: TdxRectF; AColor: TdxAlphaColor;
const APattern: TArray<Single>);
begin
...
procedure TdxBoundedDocumentLayoutExporter.DrawStrikeout
  (AStrikeout: TdxStrikeoutDouble; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawStrikeout(AStrikeout, ABounds, AColor);
end;

procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineDashed; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
...
procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineDotted; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawUnderline(AUnderline, ABounds, AColor);
end;
...
procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineSingle; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawUnderline(AUnderline, ABounds, AColor);
end;
...
procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineDouble; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawUnderline(AUnderline, ABounds, AColor);
end;
...
procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineThickDashDotted; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawUnderline(AUnderline, ABounds, AColor);
end;
...
procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineThickDashed; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawUnderline(AUnderline, ABounds, AColor);
end;
...
procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineThickDotted; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawUnderline(AUnderline, ABounds, AColor);
end;
...
procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineThickSingle; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawUnderline(AUnderline, ABounds, AColor);
end;
...
procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineLongDashed; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawUnderline(AUnderline, ABounds, AColor);
end;
...
procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineHeavyWave; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawUnderline(AUnderline, ABounds, AColor);
end;
...
procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineDashDotDotted; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawUnderline(AUnderline, ABounds, AColor);
end;
...
procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineDashDotted; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawUnderline(AUnderline, ABounds, AColor);
end;
...
procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineDashSmallGap; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawUnderline(AUnderline, ABounds, AColor);
end;
...
procedure TdxBoundedDocumentLayoutExporter.DrawStrikeout
  (AStrikeout: TdxStrikeoutSingle; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawStrikeout(AStrikeout, ABounds, AColor);
end;
...
procedure TdxBoundedDocumentLayoutExporter.ExportHighlighting(AHighlightAreas
...
function TdxBoundedDocumentLayoutExporter.GetDrawingBounds
...
function TdxBoundedDocumentLayoutExporter.GetShapeOutlinePenWidth
  (ARun: TdxFloatingObjectAnchorRun; ABox: TdxFloatingObjectBox): Integer;
begin
  if not cxRectIsEqual(ABox.Bounds, ABox.ContentBounds) then
    Result := Math.Max(1, DocumentModel.ToDocumentLayoutUnitConverter.
      ToLayoutUnits(ARun.Shape.OutlineWidth))
  else if ARun.Shape.UseOutlineColor and not TdxAlphaColors.IsTransparentOrEmpty
    (ARun.Shape.OutlineColor) and ARun.Shape.UseOutlineWidth and
    (ARun.Shape.OutlineWidth = 0) then
    Result := 0
  else
    Result := -1;
end;

function TdxBoundedDocumentLayoutExporter.GetTabLeaderCharacter
  (ALeaderType: TdxTabLeaderType): Char;
begin
  Result := TdxTabsController.GetTabLeaderCharacter(ALeaderType);
end;

function TdxBoundedDocumentLayoutExporter.GetTabLeaderCharacterWidth
  (ABox: TdxTabSpaceBox): Integer;
begin
  Result := TdxTabsController.GetTabLeaderCharacterWidth(ABox, PieceTable);
end;

function TdxBoundedDocumentLayoutExporter.GetTabLeaderText(ABox: TdxTabSpaceBox;
const ATextBounds: TRect): string;
var
  ACharacter: Char;
  ACount: Integer;
begin
...
function TdxBoundedDocumentLayoutExporter.GetTabLeaderUnderlineType
  (ABox: TdxTabSpaceBox): TdxUnderlineType;
begin
...
function TdxBoundedDocumentLayoutExporter.GetTableBorderLine(ABorderLineStyle
  : TdxBorderLineStyle): TdxUnderline;
var
...
function TdxBoundedDocumentLayoutExporter.GetCharacterLineBoxByIndex
  (ARow: TdxSimpleRow; AIndex: Integer): TdxBox;
begin
...
function TdxBoundedDocumentLayoutExporter.IsValidBounds(const ABoxBounds
  : TRect): Boolean;
begin
  Result := not cxRectIsEmpty(ABoxBounds) and
    (Painter.HasTransform or cxRectIntersect(FBounds, ABoxBounds));
end;

function TdxBoundedDocumentLayoutExporter.ShouldCenterTabLeaderLineVertically
  (ABox: TdxTabSpaceBox): Boolean;
begin
  case ABox.TabInfo.Leader of
    TdxTabLeaderType.MiddleDots:
      Result := True;
...
function TdxBoundedDocumentLayoutExporter.ShouldExportRowBackground
  (ARow: TdxRow): Boolean;
begin
  Result := (ARow.InnerHighlightAreas <> nil) and
    (ARow.InnerHighlightAreas.Count > 0) or
    (ARow.InnerCommentHighlightAreas <> nil) and
    (ARow.InnerCommentHighlightAreas.Count > 0);
end;

procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineThickDashDotDotted; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawUnderline(AUnderline, ABounds, AColor);
end;
...
procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineThickLongDashed; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawUnderline(AUnderline, ABounds, AColor);
end;
...
procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineDoubleWave; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawUnderline(AUnderline, ABounds, AColor);
end;
...
procedure TdxBoundedDocumentLayoutExporter.DrawUnderline
  (AUnderline: TdxUnderlineWave; const ABounds: TdxRectF;
AColor: TdxAlphaColor);
begin
  HorizontalLinePainter.DrawUnderline(AUnderline, ABounds, AColor);
end;
...
constructor TdxMarkBoxExporterBase.Create
  (AExporter: TdxGraphicsDocumentLayoutExporter);
begin
  inherited Create;
...
begin
  AFontIndex := DocumentModel.FontCache.CalcFontIndex('Arial', 16, [],
  ...
  ATextBounds.X :=
    Trunc(ATextBounds.X + (ATextBounds.Width - ATextSize.Width) / 2);
  ATextBounds.Width := ATextSize.Width;
  ATextBounds.Y :=
    Trunc(ATextBounds.Y + (ATextBounds.Height - ATextSize.Height) / 2);
  AForeColor := Exporter.GetActualColor(ABox.GetActualForeColor(PieceTable,
    Exporter.TextColors, FExporter.GetBackColor(ATextBounds)));
...
constructor TdxGraphicsDocumentLayoutExporter.Create(ADocumentModel
  : TdxDocumentModel; APainter: TdxPainter;
AAdapter: TdxGraphicsDocumentLayoutExporterAdapter; const ABounds: TRect;
AHidePartiallyVisibleRow: Boolean; ATextColors: TdxTextColors);
begin
...
procedure TdxGraphicsDocumentLayoutExporter.SetShowWhitespace
...
begin
  ...
  if AValue then
    FWhitespaceStrategy :=
      TdxGraphicsDocumentLayoutExporterShowWhitespaceStrategy.Create(Self)
  else
    FWhitespaceStrategy :=
      TdxGraphicsDocumentLayoutExporterHideWhitespaceStrategy.Create(Self);
end;
...
begin
  Result := TdxRichEditHorizontalPatternLinePainter.Create(ALinePaintingSupport,
    DocumentModel.LayoutUnitConverter);
end;
...
function TdxGraphicsDocumentLayoutExporter.CreateVerticalLinePainter
  ...
  : TdxRichEditPatternLinePainter;
begin
  Result := TdxRichEditVerticalPatternLinePainter.Create(ALinePaintingSupport,
    DocumentModel.LayoutUnitConverter);
end;

function TdxGraphicsDocumentLayoutExporter.GetActualColor(AColor: TdxAlphaColor)
  : TdxAlphaColor;
begin
  if not ShouldGrayContent then
    Result := AColor
  else
    Result := TdxAlphaColors.Blend(TdxAlphaColors.FromArgb(128, AColor),
...
begin
  ...
  Result := (APieceTable <> AActivePieceTable) and
    DrawInactivePieceTableWithDifferentColor;
end;
...
function TdxGraphicsDocumentLayoutExporter.ShouldExportRowBackground
  (ARow: TdxRow): Boolean;
begin
  if (ARow.InnerHighlightAreas <> nil) and (ARow.InnerHighlightAreas.Count > 0)
  then
    Exit(True);
  if (ARow.InnerFieldHighlightAreas <> nil) and
    (ARow.InnerFieldHighlightAreas.Count > 0) then
    Exit(True);
  if (ARow.InnerRangePermissionHighlightAreas <> nil) and
    (ARow.InnerRangePermissionHighlightAreas.Count > 0) then
    Exit(True);
  if (ARow.InnerCommentHighlightAreas <> nil) and
    (ARow.InnerCommentHighlightAreas.Count > 0) then
    Exit(True);
  Result := False;
end;

function TdxGraphicsDocumentLayoutExporter.ShouldExportRow
  (ARow: TdxRow): Boolean;
var
...
begin
  ...
  begin
    ...
    if (ADrawingBounds.Bottom < VisibleBounds.Top) or
      (ADrawingBounds.Top > VisibleBounds.Bottom) then
      Exit(False);
  end;
  Result := True;
end;

function TdxGraphicsDocumentLayoutExporter.IsTableRowVisible
  (ARow: TdxTableRowViewInfoBase): Boolean;
var
...
begin
  ...
  AMinBottom := Math.Min(ABottomAnchor.VerticalPosition +
    ABottomAnchor.BottomTextIndent, VisibleBounds.Bottom);

  Result := AMaxTop <= AMinBottom;
end;

function TdxGraphicsDocumentLayoutExporter.IsRowContainsVerticalMergingCell
  (ARow: TdxTableRow): Boolean;
var
...
function TdxGraphicsDocumentLayoutExporter.IsAnchorVisible
  (const AAnchor: TdxTableCellVerticalAnchor): Boolean;
begin
  if VisibleBounds.IsEmpty then
    Exit(True);

  if AAnchor.VerticalPosition + AAnchor.BottomTextIndent < VisibleBounds.Top
  then
    Exit(False);
...
procedure TdxGraphicsDocumentLayoutExporter.ExportHighlightArea
  (const AArea: TdxHighlightArea);
begin
  Painter.FillRectangle(GetActualColor(AArea.Color),
    GetDrawingBounds(AArea.Bounds));
end;
...
procedure TdxGraphicsDocumentLayoutExporter.ExportLayoutDependentTextBox
  (ABox: TdxLayoutDependentTextBox);
begin
  ExportTextBoxCore(ABox);
end;

procedure TdxGraphicsDocumentLayoutExporter.ExportNumberingListBox
  (ABox: TdxNumberingListBox);
begin
  ExportNumberingListBoxCore(ABox);
end;

procedure TdxGraphicsDocumentLayoutExporter.ExportLineNumberBox
...
procedure TdxGraphicsDocumentLayoutExporter.ExportSeparatorBox
  (ABox: TdxSeparatorBox);
begin
  FWhitespaceStrategy.ExportSeparatorBox(ABox);
end;

procedure TdxGraphicsDocumentLayoutExporter.ExportInlinePictureBox
  (ABox: TdxInlinePictureBox);
begin
  FAdapter.ExportInlinePictureBox(Self, ABox);
end;

function TdxGraphicsDocumentLayoutExporter.BeforeExportRotatedContent
  (ABox: TdxFloatingObjectBox): Boolean;
var
  ABounds: TRect;
  ACenter: TPoint;
...
begin
  ...
  ATransformApplied := Painter.TryPushRotationTransform(ACenter,
    DocumentModel.GetBoxEffectiveRotationAngleInDegrees(ABox));
  Painter.PushSmoothingMode(ATransformApplied);
  Result := ATransformApplied;
end;

procedure TdxGraphicsDocumentLayoutExporter.AfterExportRotatedContent
  (ATransformApplied: Boolean);
begin
...
function TdxGraphicsDocumentLayoutExporter.ExportRotatedContent
  (ABox: TdxFloatingObjectBox): Boolean;
var
  ATransformApplied: Boolean;
begin
...
procedure TdxGraphicsDocumentLayoutExporter.ExportFloatingObjectShape
  (ABox: TdxFloatingObjectBox; AShape: TdxShape);
var
...
procedure TdxGraphicsDocumentLayoutExporter.ExportParagraphFrameShape
  (ABox: TdxParagraphFrameBox; AShape: TdxShape);
var
...
begin
  ...
  AIsContainsTable := ABox.DocumentLayout.Pages.Last.Areas.Last.Columns.Last.
    Tables.Count > 0;

  DrawParagraphBackground(AActualBounds, ARows);

  if AIsContainsTable then
    DrawParagraphBordersWithoutTableBounds(AActualBounds,
      ABoxParagraphProperties, ARows)
  else
    DrawParagraphBordersWithCorners(AActualBounds, ABoxParagraphProperties);
end;

procedure TdxGraphicsDocumentLayoutExporter.FillRectangle
  (AFillColor: TdxAlphaColor; const AActualContentBounds: TRect);
begin
  if not TdxAlphaColors.IsTransparentOrEmpty(AFillColor) then
    Painter.FillRectangle(GetActualColor(AFillColor), AActualContentBounds);
end;

procedure TdxGraphicsDocumentLayoutExporter.DrawParagraphBordersWithCorners
  (const AActualContentBounds: TRect;
ABoxParagraphProperties: TdxParagraphProperties);
begin
...
class function TdxGraphicsDocumentLayoutExporter.GetActualBoxHeight
  (const AActualBounds: TRect; ARows: TdxRowCollection; ACurrentRow: TdxRow;
...
procedure TdxGraphicsDocumentLayoutExporter.DrawParagraphBackground
  (const AActualBounds: TRect; ARows: TdxRowCollection);
var
...
begin
  ...
  begin
    ...
    begin
      ...
      AHeight := GetActualBoxHeight(AActualBounds, ARows, ACurrentRow,
        ARowBounds);

      AActualParagraphBounds.InitSize(AActualBounds.X, Y,
        AActualBounds.Width, AHeight);
      FillRectangle(AParagraph.BackColor, AActualParagraphBounds);
    end;
  end;
end;

procedure TdxGraphicsDocumentLayoutExporter.
  DrawParagraphBordersWithoutTableBounds(const AActualBounds: TRect;
ABoxParagraphProperties: TdxParagraphProperties; ARows: TdxRowCollection);
var
...
begin
  ...
  begin
    ...
    begin
      ...
      AHeight := 0;
      repeat
        Inc(AHeight, GetActualBoxHeight(AActualBounds, ARows, ARows[AIndex],
          ARows[AIndex].Bounds));
        if AIndex < ARows.Count - 1 then
          Inc(AIndex);
      until not((AIndex < ARows.Count - 1) and not ARows[AIndex]
        .Paragraph.IsInCell);

      AActualParagraphBounds.InitSize(AActualBounds.X, ATop,
        AActualBounds.Width, AHeight);
      DrawParagraphBordersWithCorners(AActualParagraphBounds,
        ABoxParagraphProperties);
    end;
    Inc(AIndex);
  end;
end;

procedure TdxGraphicsDocumentLayoutExporter.DrawParagraphBorders
  (const AContentBounds: TRect; AParagraphProperties: TdxParagraphProperties);
var
  AConverter: TdxDocumentModelUnitToLayoutUnitConverter;
  ALeftBorder, ARightBorder, ATopBorder, ABottomBorder: TdxBorderInfo;
  ABorderViewInfo: TdxTableCellVerticalBorderViewInfo;
  ARightBorderBounds, ALeftBorderBounds, ATopBorderBounds,
    ABottomBorderBounds: TRect;
...
begin
  ...
  ABorderViewInfo := TdxTableCellVerticalBorderViewInfo.Create(nil,
    ARightBorder, 0, 0, AConverter);
  try
    ARightBorderBounds.InitSize(AContentBounds.Right, AContentBounds.Y, 0,
      AContentBounds.Height);
    ExportTableBorder(ABorderViewInfo, ARightBorderBounds);
  finally
    ABorderViewInfo.Free;
  end;

  ABorderViewInfo := TdxTableCellVerticalBorderViewInfo.Create(nil, ALeftBorder,
    0, 0, AConverter);
  try
    ALeftBorderBounds.InitSize(AContentBounds.Left, AContentBounds.Y, 0,
      AContentBounds.Height);
  ...
  ALeftCorner := TdxSingleLineCornerViewInfo.Create(ALeftBorder, ARightBorder,
    ATopBorder, ABottomBorder, 0.0, 0.0,
    TdxCornerViewInfoType.OuterVerticalStart);
  try
    ARightCorner := TdxSingleLineCornerViewInfo.Create(ALeftBorder,
      ARightBorder, ATopBorder, ABottomBorder, 0.0, 0.0,
      TdxCornerViewInfoType.OuterVerticalEnd);
    try
      AHorizontalBorderViewInfo := TdxParagraphHorizontalBorderViewInfo.Create
        (ATopBorder, AConverter, ALeftCorner, ARightCorner);
      try
        ATopBorderBounds.InitSize(AContentBounds.X, AContentBounds.Top,
          AContentBounds.Width, 0);
      ...
      AHorizontalBorderViewInfo := TdxParagraphHorizontalBorderViewInfo.Create
        (ABottomBorder, AConverter, ALeftCorner, ARightCorner);
      try
        ABottomBorderBounds.InitSize(AContentBounds.X, AContentBounds.Bottom,
          AContentBounds.Width, 0);
...
procedure TdxGraphicsDocumentLayoutExporter.DrawParagraphBordersCorners
  (const AContentBounds: TRect; AParagraphProperties: TdxParagraphProperties);
var
  AConverter: TdxDocumentModelUnitToLayoutUnitConverter;
  ALeftBorder, ARightBorder, ATopBorder, ABottomBorder: TdxBorderInfo;
...
begin
  ...
  ATopLeftCorner := TdxCornerViewInfoBase.CreateCorner
    (TdxCornerViewInfoType.OuterHorizontalEnd, AConverter, nil, nil, ATopBorder,
    ALeftBorder, 0);
  try
    ExportTableBorderCorner(ATopLeftCorner, AContentBounds.Left,
      AContentBounds.Top);
  finally
    ATopLeftCorner.Free;
  end;

  ATopRightCorner := TdxCornerViewInfoBase.CreateCorner
    (TdxCornerViewInfoType.OuterHorizontalEnd, AConverter, ATopBorder, nil, nil,
    ARightBorder, 0);
  try
    ExportTableBorderCorner(ATopRightCorner, AContentBounds.Right,
      AContentBounds.Top);
  finally
    ATopRightCorner.Free;
  end;

  ABottomLeftCorner := TdxCornerViewInfoBase.CreateCorner
    (TdxCornerViewInfoType.OuterHorizontalEnd, AConverter, nil, ALeftBorder,
    ABottomBorder, nil, 0);
  try
    ExportTableBorderCorner(ABottomLeftCorner, AContentBounds.Left,
      AContentBounds.Bottom);
  finally
    ABottomLeftCorner.Free;
  end;

  ABottomRightCorner := TdxCornerViewInfoBase.CreateCorner
    (TdxCornerViewInfoType.OuterHorizontalEnd, AConverter, ABottomBorder,
    ARightBorder, nil, nil, 0);
  try
    ExportTableBorderCorner(ABottomRightCorner, AContentBounds.Right,
      AContentBounds.Bottom);
  finally
...
procedure TdxGraphicsDocumentLayoutExporter.ExportFloatingObjectPicture
  (ABox: TdxFloatingObjectBox; AImage: TdxOfficeImage);
begin
  FAdapter.ExportFloatingObjectPicture(Self, ABox, AImage);
end;

procedure TdxGraphicsDocumentLayoutExporter.ExportFloatingObjectTextBox
  (ABox: TdxFloatingObjectBox; ATextBoxContent: TdxTextBoxFloatingObjectContent;
ATextBoxDocumentLayout: TdxDocumentLayout);
var
...
begin
  ...
  ExportCompositeObject(AContentBounds,
    TdxPieceTable(ATextBoxContent.TextBox.PieceTable),
...
procedure TdxGraphicsDocumentLayoutExporter.ExportParagraphFrameTextBox
  (ABox: TdxParagraphFrameBox; ATextBoxDocumentLayout: TdxDocumentLayout);
begin
  ExportCompositeObject(GetDrawingBounds(ABox.ContentBounds), PieceTable,
    procedure(const AOldClipRect, AClipRect: TdxRectF)
    begin
      ExportParagraphFramePage(ATextBoxDocumentLayout.Pages.First, AOldClipRect,
        AClipRect <> TdxRectF.Null);
    end);
end;

function TdxGraphicsDocumentLayoutExporter.BeginExportCompositeObject
  (const ABounds: TRect; APieceTable: TdxPieceTable;
var AOldClipRect, AClipRect: TdxRectF;
var AOldPieceTable: TdxPieceTable): Boolean;
begin
...
procedure TdxGraphicsDocumentLayoutExporter.EndExportCompositeObject
  (const AOldClipRect: TdxRectF; AOldPieceTable: TdxPieceTable);
begin
  PieceTable := AOldPieceTable;
  RestoreClipBounds(AOldClipRect);
end;

procedure TdxGraphicsDocumentLayoutExporter.ApplyClipBoundsCore
  (const ABounds: TdxRectF);
begin
  Painter.ApplyClipBounds(ABounds);
end;

procedure TdxGraphicsDocumentLayoutExporter.RestoreClipBoundsCore
  (const ABounds: TdxRectF);
begin
  Painter.RestoreClipBounds(ABounds);
end;

procedure TdxGraphicsDocumentLayoutExporter.ExportCompositeObject
  (const ABounds: TRect; APieceTable: TdxPieceTable;
const AAction: TdxGraphicsDocumentLayoutExporter.TAction);
var
...
begin
  ...
  AClipRect.Empty;
  AOldPieceTable := nil;
  if not BeginExportCompositeObject(ABounds, APieceTable, AOldClipRect,
    AClipRect, AOldPieceTable) then
    Exit;
  try
...
procedure TdxGraphicsDocumentLayoutExporter.ExportComment(ACommentViewInfo
  : TdxCommentViewInfo);
begin
  NotImplemented;
end;
...
procedure TdxGraphicsDocumentLayoutExporter.
  ExportTextBoxCoreNoCheckBoundsValidity(ABox: TdxBox);
var
  ATextBounds: TRect;
  AText: string;
begin
...
procedure TdxGraphicsDocumentLayoutExporter.ExportNumberingListBoxCore
  (ABox: TdxBox);
var
  ATextBounds: TRect;
  AText: string;
...
begin
  ...
  begin
    AText := GetBoxText(ABox);
    ExportTextBoxCore(ABox, ATextBounds, AText);
    ANumberingListBoxWithSeparator := Safe<TdxNumberingListBoxWithSeparator>.
      Cast(ABox);
    if ANumberingListBoxWithSeparator <> nil then
      FWhitespaceStrategy.ExportNumberingListBoxSeparator
        (ANumberingListBoxWithSeparator);
  end;
end;

procedure TdxGraphicsDocumentLayoutExporter.ExportTextBoxCore(ABox: TdxBox;
const ATextBounds: TRect; const AText: string);
var
  AFontInfo: TdxFontInfo;
  AForeColor: TdxAlphaColor;
begin
...
function TdxGraphicsDocumentLayoutExporter.GetActualForeColor(ABox: TdxBox;
const ABounds: TRect): TdxAlphaColor;
var
  ABackColor: TdxAlphaColor;
begin
  ABackColor := GetActualBackColor(ABounds);
  Result := GetActualColor(ABox.GetActualForeColor(PieceTable, TextColors,
    ABackColor));
end;

procedure TdxGraphicsDocumentLayoutExporter.ExportSpaceBoxCore(ABox: TdxBox;
const ATextBounds: TRect; const AText: string);
var
  AFontInfo: TdxFontInfo;
  AForeColor: TdxAlphaColor;
begin
  AFontInfo := ABox.GetFontInfo(PieceTable);
  AForeColor := GetActualColor(ABox.GetActualForeColor(PieceTable, TextColors,
    GetBackColor(ATextBounds)));
...
procedure TdxGraphicsDocumentLayoutExporter.ExportTabSpaceBox
  (ABox: TdxTabSpaceBox);
var
...
procedure TdxGraphicsDocumentLayoutExporter.ExportTabLeaderAsCharacterSequence
  (ABox: TdxTabSpaceBox);
var
  ATextBounds: TRect;
begin
...
procedure TdxGraphicsDocumentLayoutExporter.ExportTabLeaderAsUnderline
  (ABox: TdxTabSpaceBox);
var
  ATextBounds: TRect;
...
begin
  ...
  AUnderline := DocumentModel.UnderlineRepository.GetPatternLineByType
    (GetTabLeaderUnderlineType(ABox));
  AUnderlineCalculator := TdxUnderlineCalculator.Create(PieceTable);
  try
    AUnderlineBox := AUnderlineCalculator.CreateTabLeaderUnderlineBox(ABox,
      ATextBounds, CurrentRow);
    try
      if ShouldCenterTabLeaderLineVertically(ABox) then
        AUnderlineCalculator.CenterTabLeaderUnderlineBoxVertically
          (AUnderlineBox, ATextBounds);
      AColor := GetActualColor(ABox.GetActualUnderlineColor(PieceTable,
        TextColors, CurrentBackColor));
      TdxWinFormsGraphicsDocumentLayoutExporterAdapter(FAdapter)
        .ExportLineBoxCore<TdxUnderlineType>(Self, Self, AUnderlineBox,
        AUnderline, AColor);
    finally
      AUnderlineBox.Free;
    end;
...
procedure TdxGraphicsDocumentLayoutExporter.ExportLineBreakBox
  (ABox: TdxLineBreakBox);
begin
  FWhitespaceStrategy.ExportLineBreakBox(ABox);
end;

procedure TdxGraphicsDocumentLayoutExporter.ExportParagraphMarkBox
  (ABox: TdxParagraphMarkBox);
begin
  FWhitespaceStrategy.ExportParagraphMarkBox(ABox);
end;

procedure TdxGraphicsDocumentLayoutExporter.ExportParagraphMarkBoxCore
  (ABox: TdxParagraphMarkBox);
var
  ATextBounds: TRect;
  AText: string;
...
begin
  ...
  begin
    ...
    if (ACell <> nil) and (ARun.Paragraph.Index = ACell.GetEndParagraphIndexCore)
    then
...
procedure TdxGraphicsDocumentLayoutExporter.ExportSectionMarkBox
  (ABox: TdxSectionMarkBox);
begin
  FWhitespaceStrategy.ExportSectionMarkBox(ABox);
end;

procedure TdxGraphicsDocumentLayoutExporter.ExportSectionMarkBoxCore
  (ABox: TdxSectionMarkBox);
var
...
procedure TdxGraphicsDocumentLayoutExporter.ExportColumnBreakBox
  (ABox: TdxColumnBreakBox);
begin
  FWhitespaceStrategy.ExportColumnBreakBox(ABox);
end;

procedure TdxGraphicsDocumentLayoutExporter.ExportColumnBreakBoxCore
  (ABox: TdxColumnBreakBox);
var
...
procedure TdxGraphicsDocumentLayoutExporter.ExportPageBreakBox
  (ABox: TdxPageBreakBox);
begin
  FWhitespaceStrategy.ExportPageBreakBox(ABox);
end;

procedure TdxGraphicsDocumentLayoutExporter.ExportPageBreakBoxCore
  (ABox: TdxPageBreakBox);
var
...
procedure TdxGraphicsDocumentLayoutExporter.ExportMarkBoxCore(ABox: TdxBox;
AExporter: TdxMarkBoxExporterBase);
var
...
begin
  ...
  ABoxBounds.InitSize(ABounds.Left, CurrentRow.Bounds.Top, ABounds.Width,
    CurrentRow.Height);
  AExporter.Export(ABox, ABoxBounds);
end;

procedure TdxGraphicsDocumentLayoutExporter.ExportTableBorder
  (ABorder: TdxTableBorderViewInfoBase; const ACellBounds: TRect);
var
  ...
  AConverter: TdxDocumentModelUnitToLayoutUnitConverter;
begin
  ATableBorderExporter := TdxGraphicsDocumentLayoutExporterTableBorder.Create
    (DocumentModel, Painter, HorizontalLinePainter, VerticalLinePainter,
    ACellBounds);
  ABorderBase := ABorder.Border;
  AConverter := ABorder.Converter;
  ATableBorderExporter.ExportTableBorder(ABorderBase,
    GetDrawingBounds(ACellBounds), AConverter,
    TdxTableBorderViewInfoBase(ABorder));
end;

procedure TdxGraphicsDocumentLayoutExporter.ExportTableBorderCorner
...
procedure TdxGraphicsDocumentLayoutExporter.ExportTableCell
  (ACell: TdxTableCellViewInfo);
var
  ARect: TRect;
  AColor: TdxAlphaColor;
...
procedure TdxGraphicsDocumentLayoutExporter.ExportTableRow
  (ARow: TdxTableRowViewInfoBase);
var
  AOldClip: TdxRectF;
...
procedure TdxGraphicsDocumentLayoutExporter.ExcludeCellBounds
  (ACells: TdxTableCellViewInfoCollection; const ARowBounds: TRect);
var
...
function TdxGraphicsDocumentLayoutExporter.GetActualBackgroundColor
  (ARow: TdxTableRowViewInfoBase): TdxAlphaColor;
var
  ATablePropertiesException: TdxTableProperties;
begin
  ATablePropertiesException := ARow.Row.TablePropertiesException;
  if ATablePropertiesException.GetUse
    (TdxTablePropertiesOptions.MaskUseBackgroundColor) then
...
procedure TdxGraphicsDocumentLayoutExporter.ExportUnderlineBox
  (ARow: TdxSimpleRow; AUnderlineBox: TdxUnderlineBox);
var
  ABox: TdxBox;
  AColor: TdxAlphaColor;
  AUnderline: TdxUnderline;
begin
  ...
  AColor := GetActualColor(ABox.GetActualUnderlineColor(PieceTable, TextColors,
    GetBackColor(GetDrawingBounds(AUnderlineBox.UnderlineBounds))));
  AUnderline := DocumentModel.UnderlineRepository.GetPatternLineByType
    (ABox.GetFontUnderlineType(PieceTable));
  TdxWinFormsGraphicsDocumentLayoutExporterAdapter(FAdapter)
    .ExportLineBoxCore<TdxUnderlineType>(Self, Self as IdxPatternLinePainter,
    AUnderlineBox, AUnderline, AColor);
end;

procedure TdxGraphicsDocumentLayoutExporter.ExportStrikeoutBox
  (ARow: TdxSimpleRow; AStrikeoutBox: TdxUnderlineBox);
var
  ABox: TdxBox;
  AColor: TdxAlphaColor;
...
begin
  ...
  AColor := GetActualColor(ABox.GetActualStrikeoutColor(PieceTable, TextColors,
    GetBackColor(GetDrawingBounds(AStrikeoutBox.UnderlineBounds))));
  AStrikeout := DocumentModel.StrikeoutRepository.GetPatternLineByType
    (ABox.GetFontStrikeoutType(PieceTable));
  TdxWinFormsGraphicsDocumentLayoutExporterAdapter(FAdapter)
    .ExportLineBoxCore<TdxStrikeoutType>(Self, Self as IdxPatternLinePainter,
    AStrikeoutBox, AStrikeout, AColor);
end;
...
procedure TdxGraphicsDocumentLayoutExporter.SetClipBounds(const AClipBounds
  : TdxRectF);
begin
  Painter.ClipBounds := AClipBounds;
end;

function TdxGraphicsDocumentLayoutExporter.BeginHeaderFooterExport
  (const AClipBounds: TdxRectF): TdxRectF;
begin
  Result := Painter.ApplyClipBounds(AClipBounds);
end;

procedure TdxGraphicsDocumentLayoutExporter.EndHeaderFooterExport
  (const AOldClipBounds: TdxRectF);
begin
  Painter.RestoreClipBounds(AOldClipBounds);
end;

procedure TdxGraphicsDocumentLayoutExporter.BeginExportTableCellContent
  (const AClipBounds: TdxRectF);
begin
...
procedure TdxGraphicsDocumentLayoutExporter.EndExportTableContent
  (const AOldClipBounds: TdxRectF);
begin
  Painter.RestoreClipBounds(AOldClipBounds);
end;
...
constructor TdxScreenOptimizedGraphicsDocumentLayoutExporter.Create
  (ADocumentModel: TdxDocumentModel; APainter: TdxPainter;
AAdapter: TdxGraphicsDocumentLayoutExporterAdapter; const ABounds: TRect;
ATextColors: TdxTextColors; AScaleFactor: Single);
begin
  inherited Create(ADocumentModel, APainter, AAdapter, ABounds, False,
    ATextColors);
  FPixel := Math.Ceil(ADocumentModel.LayoutUnitConverter.PixelsToLayoutUnits(2,
    APainter.DpiY));
...
function TdxScreenOptimizedGraphicsDocumentLayoutExporter.CreatePlaceholderBrush
  (AForeColor: TdxAlphaColor): TdxGPHatchBrush;
begin
...
procedure TdxScreenOptimizedGraphicsDocumentLayoutExporter.ExportBoxOptimized
  (ABox: TdxBox);
var
  AActualBounds: TRect;
...
begin
  ...
  ABrush := CreatePlaceholderBrush
    (GetActualColor(ABox.GetActualForeColor(PieceTable, TextColors,
    CurrentBackColor)));
  try
...
function TdxScreenOptimizedGraphicsDocumentLayoutExporter.GetActualBounds
  (const ABounds: TRect): TdxRectF;
begin

  Result := ABounds.ToRectF;
end;

procedure TdxScreenOptimizedGraphicsDocumentLayoutExporter.ExportErrorBox
...
begin
  ...
  if (TdxSpellCheckerInstance.ISpellChecker3 = nil) or
    (TdxSpellCheckerInstance.ISpellChecker3.CheckAsYouTypeOptions.UnderlineStyle
    <> usLine) then
    HorizontalLinePainter.DrawWaveUnderline(ABounds, FErrorWavyLinePen,
      ABounds.Height)
  else
    HorizontalLinePainter.DrawLine(FErrorWavyLinePen, ABounds);
end;

function TdxScreenOptimizedGraphicsDocumentLayoutExporter.CreateErrorWavyLinePen
  : TdxGPPen;
var
  AColor: TdxAlphaColor;
begin
  if TdxSpellCheckerInstance.ISpellChecker3 = nil then
    ...
    AColor := TdxAlphaColors.FromColor
      (TdxSpellCheckerInstance.ISpellChecker3.CheckAsYouTypeOptions.
      UnderlineColor);
  Result := Painter.GetPen(AColor);
end;

procedure TdxScreenOptimizedGraphicsDocumentLayoutExporter.ExportHyphenBox
  (ABox: TdxHyphenBox);
begin
...
procedure TdxScreenOptimizedGraphicsDocumentLayoutExporter.
  ExportLayoutDependentTextBox(ABox: TdxLayoutDependentTextBox);
begin
  if ShouldOptimizeBox(ABox) then
    ExportBoxOptimized(ABox)
  else
...
procedure TdxScreenOptimizedGraphicsDocumentLayoutExporter.ExportLineNumberBox
  (ABox: TdxLineNumberBox);
begin
  if ShouldOptimizeBox(ABox) then
    ExportBoxOptimized(ABox)
...
procedure TdxScreenOptimizedGraphicsDocumentLayoutExporter.
  ExportNumberingListBox(ABox: TdxNumberingListBox);
begin
  if ShouldOptimizeBox(ABox) then
    ExportBoxOptimized(ABox)
  else
...
procedure TdxScreenOptimizedGraphicsDocumentLayoutExporter.
  ExportParagraphMarkBox(ABox: TdxParagraphMarkBox);
begin
...
procedure TdxScreenOptimizedGraphicsDocumentLayoutExporter.ExportSeparatorBox
  (ABox: TdxSeparatorBox);
begin
  if ShouldOptimizeBox(ABox) then
    ExportBoxOptimized(ABox)
...
procedure TdxScreenOptimizedGraphicsDocumentLayoutExporter.ExportSpaceBox
  (ABox: TdxBox);
begin
  if not ShouldOptimizeBox(ABox) then
...
procedure TdxScreenOptimizedGraphicsDocumentLayoutExporter.ExportTextBox
  (ABox: TdxTextBox);
begin
  if ShouldOptimizeBox(ABox) then
    ExportBoxOptimized(ABox)
...
function TdxScreenOptimizedGraphicsDocumentLayoutExporter.ShouldOptimizeBox
  (ABox: TdxBox): Boolean;
begin
  Result := not IsWin10FallCreatorsUpdate and
    (ABox.Bounds.Height < MinReadableTextHeight);
end;

{ TdxScreenOptimizedGraphicsDocumentLayoutExporterNoLineNumbers }

procedure TdxScreenOptimizedGraphicsDocumentLayoutExporterNoLineNumbers.
  ExportLineNumberBox(ABox: TdxLineNumberBox);
begin
end;

{ TdxWinFormsGraphicsDocumentLayoutExporterAdapter }

procedure TdxWinFormsGraphicsDocumentLayoutExporterAdapter.
  ExportLineBreakBoxCore(AExporter: TdxGraphicsDocumentLayoutExporter;
ABox: TdxLineBreakBox);
var
  AForeColor: TdxAlphaColor;
...
begin
  ...
  AForeColor := AExporter.GetActualColor
    (ABox.GetActualForeColor(AExporter.PieceTable, AExporter.TextColors,
    AExporter.GetBackColor(AGlyphBounds)));
  DrawLineBreakArrow(AExporter, AGlyphBounds, AForeColor);
end;

procedure TdxWinFormsGraphicsDocumentLayoutExporterAdapter.
  ExportSeparatorBoxCore(AExporter: TdxGraphicsDocumentLayoutExporter;
ABox: TdxSeparatorBox);
begin
...
procedure TdxWinFormsGraphicsDocumentLayoutExporterAdapter.
  ExportSingleCharacterMarkBoxCore(AExporter: TdxGraphicsDocumentLayoutExporter;
ABox: TdxSingleCharacterMarkBox);
var
...
begin
  ...
  AForeColor := AExporter.GetActualColor
    (ABox.GetActualForeColor(AExporter.PieceTable, AExporter.TextColors,
    AExporter.GetBackColor(ABoxBounds)));
  AFontInfo := ABox.GetFontInfo(AExporter.PieceTable);
  AText := ABox.MarkCharacter;
  ATextSize := AExporter.DocumentModel.FontCache.Measurer.MeasureString(AText,
    AFontInfo);
  ATextBounds := ABoxBounds;
  ATextBounds := cxRectSetLeft(ATextBounds, ATextBounds.Left +
    (ATextBounds.Width - ATextSize.cx) div 2);
  ATextBounds.Width := ATextSize.cx;
  ATextBounds := cxRectSetTop(ATextBounds, ATextBounds.Top +
    (ATextBounds.Height - ATextSize.cy) div 2);
  AExporter.Painter.DrawString(AText, AFontInfo, AForeColor, ATextBounds);
end;

procedure TdxWinFormsGraphicsDocumentLayoutExporterAdapter.ExportTabLeader
...
procedure TdxWinFormsGraphicsDocumentLayoutExporterAdapter.DrawLineBreakArrow
  (AExporter: TdxGraphicsDocumentLayoutExporter; const AGlyphBounds: TRect;
AForeColor: TdxAlphaColor);
const
  ArrowPointsTemplate: array [0 .. 8] of TdxPointF = ((X: 0.00; Y: 0.60),
    (X: 0.35; Y: 0.35), (X: 0.30; Y: 0.55), (X: 0.80; Y: 0.55), (X: 0.80;
    Y: 0.10), (X: 0.90; Y: 0.10), (X: 0.90; Y: 0.65), (X: 0.30; Y: 0.65),
    (X: 0.35; Y: 0.85));
var
  APoint: TdxPointF;
  ABrush: TdxGPBrush;
...
begin
  ...
  begin
    ...
    AArrowPoints[I] := dxPointF(AGlyphBounds.Left + AGlyphBounds.Width *
      APoint.X, AGlyphBounds.Top + AGlyphBounds.Height * APoint.Y);
  end;
...
procedure TdxWinFormsGraphicsDocumentLayoutExporterAdapter.
  ExportFloatingObjectPicture(AExporter: TdxGraphicsDocumentLayoutExporter;
ABox: TdxFloatingObjectBox; AImage: TdxOfficeImage);
var
  AImgBounds: TRect;
begin
  ...
  begin
    ...
    if AExporter.ShouldGrayContent then
      AExporter.Painter.FillRectangle(TdxAlphaColors.FromArgb($80, $FF, $FF,
        $FF), AImgBounds);
  end;
end;

procedure TdxWinFormsGraphicsDocumentLayoutExporterAdapter.
  ExportInlinePictureBox(AExporter: TdxGraphicsDocumentLayoutExporter;
ABox: TdxInlinePictureBox);
var
  AImg: TdxOfficeImage;
  APainter: TdxPainter;
  ...
  begin
    ...
    begin
      ...
      try
        ...
        ExportInlinePictureBoxCore(AExporter, ABox, AImg, AImgBounds,
          ASize, ASizing);
      finally
...
procedure TdxWinFormsGraphicsDocumentLayoutExporterAdapter.
  ExportInlinePictureBoxCore(AExporter: TdxGraphicsDocumentLayoutExporter;
ABox: TdxInlinePictureBox; AImg: TdxOfficeImage; const AImgBounds: TRect;
...
begin
  ...
  if AExporter.ShouldGrayContent then
    APainter.FillRectangle(TdxAlphaColors.FromArgb($80, $FF, $FF, $FF),
      AImgBounds);
end;
...
var
  ...
  AOldClip, AClipRect: TdxRectF;
begin
  AUnderlineClipBounds := ALine.CalcLineBounds(ALineBox.ClipBounds,
    ALineBox.UnderlineThickness);
  AUnderlineClipBounds := AExporter.GetDrawingBounds(AUnderlineClipBounds);

  APainter := AExporter.Painter;
  AOldClip := APainter.ClipBounds;
  AClipRect.InitSize(AUnderlineClipBounds.Left, AOldClip.Top,
    AUnderlineClipBounds.Width, AOldClip.Height);
  try
    AClipRect.Intersect(AOldClip);
    APainter.ClipBounds := AClipRect;

    AActualUnderlineBounds := ALine.CalcLineBounds(ALineBox.UnderlineBounds,
      ALineBox.UnderlineThickness);
    AActualUnderlineBounds.Y := AActualUnderlineBounds.Top +
      Trunc(ALine.CalcLinePenVerticalOffset(AActualUnderlineBounds.ToRectF));
    AActualUnderlineBounds := AExporter.GetDrawingBounds
      (AActualUnderlineBounds);
...
constructor TdxGraphicsDocumentLayoutExporterWhitespaceStrategy.Create
  (AExporter: TdxGraphicsDocumentLayoutExporter);
begin
  inherited Create;
  Assert(AExporter <> nil);
...
procedure TdxGraphicsDocumentLayoutExporterHideWhitespaceStrategy.
  ExportColumnBreakBox(ABox: TdxColumnBreakBox);
begin
end;

procedure TdxGraphicsDocumentLayoutExporterHideWhitespaceStrategy.
  ExportLineBreakBox(ABox: TdxLineBreakBox);
begin
end;

procedure TdxGraphicsDocumentLayoutExporterHideWhitespaceStrategy.
  ExportPageBreakBox(ABox: TdxPageBreakBox);
begin
end;
...
procedure TdxGraphicsDocumentLayoutExporterHideWhitespaceStrategy.
  ExportParagraphMarkBox(ABox: TdxParagraphMarkBox);
begin
  if FormattingMarkVisibility.ParagraphMark =
    TdxRichEditFormattingMarkVisibility.Visible then
    inherited ExportParagraphMarkBox(ABox);
end;

procedure TdxGraphicsDocumentLayoutExporterHideWhitespaceStrategy.
  ExportSectionMarkBox(ABox: TdxSectionMarkBox);
begin
end;

procedure TdxGraphicsDocumentLayoutExporterHideWhitespaceStrategy.
  ExportSeparatorBox(ABox: TdxSeparatorBox);
begin
  if FormattingMarkVisibility.Separator = TdxRichEditFormattingMarkVisibility.Visible
  then
    inherited ExportSeparatorBox(ABox);
end;

procedure TdxGraphicsDocumentLayoutExporterHideWhitespaceStrategy.ExportSpaceBox
  (ABox: TdxBox);
begin
  if not(FormattingMarkVisibility.Space <> TdxRichEditFormattingMarkVisibility.
    Visible) then
    inherited ExportSpaceBox(ABox);
end;

procedure TdxGraphicsDocumentLayoutExporterHideWhitespaceStrategy.
  ExportTabSpaceBox(ABox: TdxTabSpaceBox);
begin
  if FormattingMarkVisibility.TabCharacter =
    TdxRichEditFormattingMarkVisibility.Visible then
    inherited ExportTabSpaceBox(ABox);
end;

function TdxGraphicsDocumentLayoutExporterHideWhitespaceStrategy.
  GetFormattingMarkVisibility: TdxFormattingMarkVisibilityOptions;
begin
...
procedure TdxGraphicsDocumentLayoutExporterShowWhitespaceStrategy.
  ExportColumnBreakBox(ABox: TdxColumnBreakBox);
begin
...
procedure TdxGraphicsDocumentLayoutExporterShowWhitespaceStrategy.
  ExportNumberingListBoxSeparator(ANumberingListBoxWithSeparator
  : TdxNumberingListBoxWithSeparator);
var
  ATabSpaceBox: TdxTabSpaceBox;
begin
  ATabSpaceBox := Safe<TdxTabSpaceBox>.Cast
    (ANumberingListBoxWithSeparator.SeparatorBox);
...
procedure TdxGraphicsDocumentLayoutExporterShowWhitespaceStrategy.ExportSpaceBox
  (ASpaceBox: TdxBox);
var
  ATextBounds: TRect;
  AText: string;
...
procedure TdxCharacterBoxLevelDocumentLayoutExporter.
  ExportLayoutDependentTextBox(ABox: TdxLayoutDependentTextBox);
begin
  ExportSingleCharacterBox(ABox);
end;
...
procedure TdxCharacterBoxLevelDocumentLayoutExporter.ExportRowBox(ARow: TdxRow;
ABox: TdxBox);
var
  APreviousPieceTable: TdxPieceTable;
begin
...
procedure TdxCharacterBoxLevelDocumentLayoutExporter.ExportSingleCharacterBox
  (ABox: TdxBox);
begin
  AppendCharacterBox(ABox.StartPos, 0, GetActualCharacterBounds(ABox.Bounds),
    ABox.Bounds);
end;
...
procedure TdxCharacterBoxLevelDocumentLayoutExporter.AppendCharacterBox
  (const AStartPos: TdxFormatterPosition; AOffset: Integer;
const ABounds, ATightBounds: TRect);
var
...
begin
  ...
  ANewStartPos := TdxFormatterPosition.Create(AStartPos.RunIndex,
    AStartPos.Offset + AOffset, AStartPos.BoxIndex);
  ACharacterBox.StartPos := ANewStartPos;
  ACharacterBox.EndPos := ANewStartPos;
  Chars.Add(ACharacterBox);
end;

function TdxCharacterBoxLevelDocumentLayoutExporter.CalculateCharacterBounds
  (ABox: TdxTextBox): TArray<TRect>;
begin
  Result := Measurer.MeasureCharactersBounds(GetBoxText(ABox),
    ABox.GetFontInfo(PieceTable), ABox.Bounds);
end;

function TdxCharacterBoxLevelDocumentLayoutExporter.GetActualCharacterBounds
  (const ABounds: TRect): TRect;
begin
  Result.Init(ABounds.Left, FRowBounds.Top, ABounds.Right, FRowBounds.Bottom);
end;

procedure TdxCharacterBoxLevelDocumentLayoutExporter.ExportMultiCharacterBox
  (ABox: TdxBox; ACharacterBounds: TArray<TRect>);
var
...
begin
  ...
  for I := 0 to ACount - 1 do
    AppendCharacterBox(AStartPos, I,
      GetActualCharacterBounds(ACharacterBounds[I]), ACharacterBounds[I]);
end;

{ TdxGraphicsPainterWrapper }

constructor TdxGraphicsPainterWrapper.Create(APainter: TdxPainter;
const AHorizontalLinePainter, AVerticalLinePainter: IdxCharacterLinePainter);
begin
  inherited Create;
  FPainter := APainter;
...
procedure TdxGraphicsPainterWrapper.FillRectangle(AColor: TdxAlphaColor;
const ABounds: TdxRectF);
begin
  FPainter.FillRectangle(AColor, ABounds);
end;

function TdxGraphicsPainterWrapper.GetHorizontalLinePainter
  : IdxCharacterLinePainter;
begin
  Result := FHorizontalLinePainter;
end;

function TdxGraphicsPainterWrapper.GetSnappedPoint(const APoint: TdxPointF)
  : TdxPointF;
begin
  Result := FPainter.GetSnappedPoint(APoint);
end;

function TdxGraphicsPainterWrapper.GetVerticalLinePainter
  : IdxCharacterLinePainter;
begin
...
constructor TdxGraphicsDocumentLayoutExporterTableBorder.Create
  (ADocumentModel: TdxDocumentModel; APainter: TdxPainter;
...
procedure TdxGraphicsDocumentLayoutExporterTableBorder.ExportTableBorder
  (ABorder: TdxBorderInfo; const ADrawingBounds: TRect;
AConverter: TdxDocumentModelUnitToLayoutUnitConverter;
const AViewInfo: TdxTableBorderViewInfoBase);
var
...
begin
  APainterWrapper := TdxGraphicsPainterWrapper.Create(Painter,
    HorizontalLinePainter, VerticalLinePainter);
  try
...
procedure TdxGraphicsDocumentLayoutExporterTableBorder.ExportTableBorderCorner
  (ACorner: TdxCornerViewInfoBase; X, Y: Integer);
var
  ALocation: TPoint;
  ...
  if ABorderPainter <> nil then
    try
      ...
      APainterWrapper := TdxGraphicsPainterWrapper.Create(Painter,
        HorizontalLinePainter, VerticalLinePainter);
      try
        ABorderPainter.DrawCorner(APainterWrapper, ALocation.X,
          ALocation.Y, ACorner);
      finally
        APainterWrapper.Free;
      end;
...
begin
  ...
  if (ABorderStyle = TdxBorderLineStyle.None) or
    (ABorderStyle = TdxBorderLineStyle.Nil) or
  ...
  if Length(ACompoundArray) = 4 then
    Result := TdxDoubleBorderPainter.Create(APainterWrapper,
      ACompoundArray, AWidth)
  else if Length(ACompoundArray) = 6 then
    Result := TdxTripleBorderPainter.Create(APainterWrapper,
      ACompoundArray, AWidth)
  else
    Result := TdxSingleBorderPainter.Create(APainterWrapper, AWidth,
      GetTableBorderLine(ABorder.Style, FDocumentModel));
end;

function TdxGraphicsDocumentLayoutExporterTableBorder.GetTableBorderLine
  (ABorderLineStyle: TdxBorderLineStyle; ADocumentModel: TdxDocumentModel)
  : TdxUnderline;
var
  ARepository: TdxBorderLineRepository;
begin
...
procedure TdxColumnBreakMarkBoxExporter.DrawLine(const ALineBounds: TRect;
AForeColor: TdxAlphaColor);
begin
  Exporter.DrawPatternLine(ALineBounds.ToRectF, AForeColor,
    Exporter.HorizontalLinePainter.ColumnBreakPattern);
end;
...
procedure TdxPageBreakMarkBoxExporter.DrawLine(const ALineBounds: TRect;
AForeColor: TdxAlphaColor);
begin
  Exporter.DrawPatternLine(ALineBounds.ToRectF, AForeColor,
    Exporter.HorizontalLinePainter.PageBreakPattern);
end;
...
procedure TdxSectionBreakMarkBoxExporter.DrawLine(const ALineBounds: TRect;
AForeColor: TdxAlphaColor);
var
  ABounds: TRect;
begin
  ABounds := ALineBounds;
  ABounds.Offset(0, -3);
  Exporter.DrawPatternLine(ABounds.ToRectF, AForeColor,
    Exporter.HorizontalLinePainter.SectionStartPattern);
  ABounds.Offset(0, 6);
  Exporter.DrawPatternLine(ABounds.ToRectF, AForeColor,
    Exporter.HorizontalLinePainter.SectionStartPattern);
end;
