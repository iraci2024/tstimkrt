...
type
  ...
  strict private
    FVerticalMergedCells
      : TObjectDictionary<TdxTableRow, TdxVerticalMergeInfoList>;
  protected
    property VerticalMergedCells
      : TObjectDictionary<TdxTableRow, TdxVerticalMergeInfoList>
      read FVerticalMergedCells;
  public
    constructor Create;
    destructor Destroy; override;

    procedure UpdateCellsVerticalMergeState(ARow: TdxTableRow;
      APropertyContainer: TdxDocPropertyContainer);
    procedure ApplyVerticalMerging(ATable: TdxTable);
    procedure AddVerticalMergedCells(ARow: TdxTableRow;
      APropertyContainer: TdxDocPropertyContainer);
    procedure ApplyCellVerticalAlignmentActions(ARow: TdxTableRow;
      APropertyContainer: TdxDocPropertyContainer);
    function GetVerticalMergingInfo(ARow: TdxTableRow)
  ...
  strict private
    ...
    FPreferredCellWidths
      : TDictionary<TdxTableRow, TdxTableCellWidthOperandList>;
    FImporter: TObject { TdxDocImporter };
  protected
    property UnitConverter: TdxDocumentModelUnitConverter read FUnitConverter;
    property VerticalMergingUpdater: TdxVerticalMergingStateUpdater
      read FVerticalMergingUpdater;
    property TableCellPositions: TDictionary<TdxTable, TdxIntegerList>
      read FTableCellPositions;
    property RowCellWidths: TDictionary<TdxTableRow, TdxRowLeftAndCellWidths>
      read FRowCellWidths;
    property PreferredCellWidths
      : TDictionary<TdxTableRow, TdxTableCellWidthOperandList>
      read FPreferredCellWidths;
  public
    constructor Create(AImporter: TObject { TdxDocImporter };
      AUnitConverter: TdxDocumentModelUnitConverter);
    destructor Destroy; override;

    procedure PerformRowActions(ARow: TdxTableRow;
      APropertyContainer: TdxDocPropertyContainer);
    procedure AddPreferredCellWidths(ARow: TdxTableRow;
      APropertyContainer: TdxDocPropertyContainer);
    procedure AddRowCellPositions(ARow: TdxTableRow;
      APropertyContainer: TdxDocPropertyContainer);
    function GetTableCellPositions(ATable: TdxTable): TdxIntegerList;
    procedure ProcessTableDefinition(ARow: TdxTableRow;
      APropertyContainer: TdxDocPropertyContainer;
      ARowCellSizeAndPosition: TdxRowLeftAndCellWidths);
    procedure ApplyInsertActions(APropertyContainer: TdxDocPropertyContainer;
      ARowCellWidths: TdxIntegerList);
    procedure ApplyColumnWidthsActions(APropertyContainer
      : TdxDocPropertyContainer; ARowCellWidths: TdxIntegerList);
    procedure AddTableCellPositions(ARow: TdxTableRow;
      ARowLeftAndCellsWidth: TdxRowLeftAndCellWidths;
      ATableCellPositions: TdxIntegerList;
      APropertyContainer: TdxDocPropertyContainer);
    function GetRowLeft(ARow: TdxTableRow;
      APropertyContainer: TdxDocPropertyContainer): Integer;
    procedure TryToAddCellPosition(ADestination: TdxIntegerList;
      APosition: Integer);
    procedure UpdateLayout(ATable: TdxTable);
    procedure ApplySpans(ATable: TdxTable);
    function CalcMinRowLeft(ATable: TdxTable;
      ARowLeftAndCellsWidthCollection
      : TdxObjectList<TdxRowLeftAndCellWidths>): Integer;
    procedure CorrectCellWidthsAndSpans(ARow: TdxTableRow;
      ACellPositions: TdxIntegerList;
      ARowLeftAndCellsWidth: TdxRowLeftAndCellWidths; AMinRowLeft: Integer);
    function ProcessRowCells(ARow: TdxTableRow; ACellPositions: TdxIntegerList;
      ACellWidths: TdxIntegerList; ACurrentPosition: Integer): Integer;
    function ApplyActualColumnSpans(ARow: TdxTableRow;
      ACellPositions: TdxIntegerList; ACellWidths: TdxIntegerList;
      ACurrentPosition: Integer): Integer;
    function ApplyDefaultColumnSpans(ARow: TdxTableRow;
      ACellPositions: TdxIntegerList; ACellWidths: TdxIntegerList;
      ACurrentPosition: Integer): Integer;
    function CalcColumnSpan(ACellPositions: TdxIntegerList;
      ACurrentPosition: Integer; ACurrentWidth: Integer): Integer;
    procedure ApplyPreferredWidths(ARow: TdxTableRow;
      APreferredCellWidths: TdxTableCellWidthOperandList);
    procedure ApplyPreferredWidthsCore(ARow: TdxTableRow;
      AOperand: TdxTableCellWidthOperand);
    procedure ApplyTablePropertiesException(ARow: TdxTableRow;
      AInfo: TdxTableRowInfo);
  end;
  ...
  protected
    ...
    property TableLayoutUpdater: TdxDocTableLayoutUpdater
      read FTableLayoutUpdater;
    property CurrentCell: TdxTableCell read GetCurrentCell;
    property LastAddedParagraphIndex: TdxParagraphIndex
      read FLastAddedParagraphIndex write SetLastAddedParagraphIndex;
  public
    constructor Create(AImporter: TObject { TdxDocImporter };
      APieceTable: TdxPieceTable);
    destructor Destroy; override;

    procedure ParagraphAdded(AParagraph: TdxParagraph;
      APropertyContainer: TdxDocPropertyContainer);
    function Finish: Boolean;
    procedure BeforeSectionAdded;
    procedure CellEndReached(APropertyContainer: TdxDocPropertyContainer);
    procedure ApplyCellProperties(APropertyContainer: TdxDocPropertyContainer;
      ACell: TdxTableCell);
    procedure ApplyCellPropertiesCore(ACell: TdxTableCell;
    ...
    function TryToUpdateCurrentTable(ACell: TdxTableCell;
      APropertyContainer: TdxDocPropertyContainer): TdxTableCell;
    procedure ApplyRowProperties(ARow: TdxTableRow;
      APropertyContainer: TdxDocPropertyContainer);
    procedure ApplyRowPropertiesCore(ARow: TdxTableRow;
      AProperties: TdxTableRowProperties);
    procedure ApplyTableInfo(ATable: TdxTable; ARow: TdxTableRow;
      AInfo: TdxDocTableInfo);
    procedure UpdateTableProperties(ATable: TdxTable; ARow: TdxTableRow;
    ...
    function ShouldFinishTable(ATable: TdxTable;
      APropertyContainer: TdxDocPropertyContainer): Boolean;
...
type
  ...
  public
    class procedure UpdateTableRow(ARow: TdxTableRow;
      APropertyContainer: TdxDocPropertyContainer); static;
    class procedure ApplyCellBorders(ARow: TdxTableRow;
      APropertyContainer: TdxDocPropertyContainer); static;
    class procedure ApplyBorderColors(ARow: TdxTableRow;
      AColors: TdxDocTableBorderColorReferenceList;
      AType: TdxDocTableCellBorder; ATableInfo: TdxDocTableInfo;
      AUnitConverter: TdxDocumentModelUnitConverter); static;
    class procedure ApplyTableCellDescriptors(ARow: TdxTableRow;
      AType: TdxDocTableCellBorder; ATableInfo: TdxDocTableInfo;
      AUnitConverter: TdxDocumentModelUnitConverter); static;
    class function GetModelBorder(ABorders: TdxTableCellBorders;
      AType: TdxDocTableCellBorder): TdxBorderBase; static;
    class function GetBorderDescriptor(ACell: TdxTableCellDescriptor;
      AType: TdxDocTableCellBorder): TdxBorderDescriptor97; static;
    class procedure ApplyCellMargins(ARow: TdxTableRow;
      APropertyContainer: TdxDocPropertyContainer); static;
    class procedure ApplyOldCellBackgroundColors(ARow: TdxTableRow;
      APropertyContainer: TdxDocPropertyContainer); static;
    class procedure ApplyOldCellBackgroundColorsCore(ARow: TdxTableRow;
      AList: TdxAlphaColorList; AFirstCellIndex: Integer); static;
    class procedure ApplyCellBackgroundColors(ARow: TdxTableRow;
      APropertyContainer: TdxDocPropertyContainer); static;
  end;

  { TdxDocTablesImporter }

constructor TdxDocTablesImporter.Create(AImporter: TObject { TdxDocImporter };
  APieceTable: TdxPieceTable);
begin
  inherited Create;
  FImporter := AImporter;
  ...
  FTableLayoutUpdater := TdxDocTableLayoutUpdater.Create(AImporter,
    APieceTable.DocumentModel.UnitConverter);
...
procedure TdxDocTablesImporter.SetLastAddedParagraphIndex
  (const AValue: TdxParagraphIndex);
begin
  FLastAddedParagraphIndex := AValue;
end;

procedure TdxDocTablesImporter.ParagraphAdded(AParagraph: TdxParagraph;
  APropertyContainer: TdxDocPropertyContainer);
var
  ACell: TdxTableCell;
begin
...
procedure TdxDocTablesImporter.CellEndReached(APropertyContainer
...
begin
  ...
  PieceTable.TableCellsManager.InitializeTableCell(ACell,
    ACell.StartParagraphIndex, ACell.EndParagraphIndex);
...
procedure TdxDocTablesImporter.ApplyCellProperties(APropertyContainer
  : TdxDocPropertyContainer; ACell: TdxTableCell);
begin
  if APropertyContainer.TableCellInfo <> nil then
    ApplyCellPropertiesCore(ACell,
      APropertyContainer.TableCellInfo.TableCellProperties);
  ACell.EndParagraphIndex := LastAddedParagraphIndex;
  if APropertyContainer.TableInfo <> nil then
    ApplyTableFloatingPosition(APropertyContainer.TableInfo.TableProperties.
      FloatingPosition);
end;

procedure TdxDocTablesImporter.ApplyCellPropertiesCore(ACell: TdxTableCell;
  AProperties: TdxTableCellProperties);
begin
...
procedure TdxDocTablesImporter.ApplyTableFloatingPosition
  (APos: TdxTableFloatingPosition);
begin
  FHorizontalAnchor := APos.HorizontalAnchor;
  FVerticalAnchor := APos.VerticalAnchor;
end;

procedure TdxDocTablesImporter.RowEndReached(APropertyContainer
  : TdxDocPropertyContainer);
var
  ACell, ANextCell: TdxTableCell;
...
function TdxDocTablesImporter.TryToUpdateCurrentTable(ACell: TdxTableCell;
  APropertyContainer: TdxDocPropertyContainer): TdxTableCell;
var
  ARow: TdxTableRow;
begin
...
procedure TdxDocTablesImporter.ApplyRowProperties(ARow: TdxTableRow;
  APropertyContainer: TdxDocPropertyContainer);
var
  ATable: TdxTable;
begin
  ...
  if APropertyContainer.TableRowInfo <> nil then
    ApplyRowPropertiesCore(ARow,
      APropertyContainer.TableRowInfo.TableRowProperties);
  if APropertyContainer.TableInfo <> nil then
    ApplyTableInfo(ATable, ARow, APropertyContainer.TableInfo);
end;

procedure TdxDocTablesImporter.ApplyRowPropertiesCore(ARow: TdxTableRow;
  AProperties: TdxTableRowProperties);
begin
...
procedure TdxDocTablesImporter.ApplyTableInfo(ATable: TdxTable;
  ARow: TdxTableRow; AInfo: TdxDocTableInfo);
begin
...
procedure TdxDocTablesImporter.UpdateTableProperties(ATable: TdxTable;
  ARow: TdxTableRow; AProperties: TdxTableProperties);
begin
  ...
  else if not ATable.TableProperties.AreSame(AProperties) then
  begin
...
procedure TdxDocTablesImporter.ResetTableProperties
  (AProperties: TdxTableProperties);
begin
...
procedure TdxDocTablesImporter.CreateNestedTable(APropertyContainer
  : TdxDocPropertyContainer);
var
  ACount, I: Integer;
begin
...
function TdxDocTablesImporter.ShouldFinishTable(ATable: TdxTable;
  APropertyContainer: TdxDocPropertyContainer): Boolean;
var
...
begin
  ...
  ANextPosition := APropertyContainer.TableInfo.TableProperties.
    FloatingPosition;
  Result := ((ATable.StyleIndex <> APropertyContainer.TableInfo.TableStyleIndex)
    and (APropertyContainer.TableInfo.TableStyleIndex <> -1)) or
...
constructor TdxDocTableLayoutUpdater.Create
  (AImporter: TObject { TdxDocImporter };
  AUnitConverter: TdxDocumentModelUnitConverter);
begin
  inherited Create;
  FUnitConverter := AUnitConverter;
  FVerticalMergingUpdater := TdxVerticalMergingStateUpdater.Create;
  FTableCellPositions := TObjectDictionary<TdxTable, TdxIntegerList>.Create
    ([doOwnsValues]);
  FRowCellWidths := TObjectDictionary<TdxTableRow, TdxRowLeftAndCellWidths>.
    Create([ { doOwnsValues } ]);
  FPreferredCellWidths :=
    TObjectDictionary<TdxTableRow, TdxTableCellWidthOperandList>.Create
    ([ { doOwnsValues } ]);
  FImporter := AImporter;
end;
...
procedure TdxDocTableLayoutUpdater.PerformRowActions(ARow: TdxTableRow;
  APropertyContainer: TdxDocPropertyContainer);
begin
  ...
  VerticalMergingUpdater.UpdateCellsVerticalMergeState(ARow,
    APropertyContainer);
  ApplyTablePropertiesException(ARow, APropertyContainer.TableRowInfo);
end;

procedure TdxDocTableLayoutUpdater.AddPreferredCellWidths(ARow: TdxTableRow;
  APropertyContainer: TdxDocPropertyContainer);
var
...
procedure TdxDocTableLayoutUpdater.AddRowCellPositions(ARow: TdxTableRow;
  APropertyContainer: TdxDocPropertyContainer);
var
  ARowCellSizeAndPosition: TdxRowLeftAndCellWidths;
  ATableCellPositions: TdxIntegerList;
begin
  ...
  ApplyColumnWidthsActions(APropertyContainer,
    ARowCellSizeAndPosition.CellWidths);
  RowCellWidths.Add(ARow, ARowCellSizeAndPosition);
  AddTableCellPositions(ARow, ARowCellSizeAndPosition, ATableCellPositions,
    APropertyContainer);
end;

function TdxDocTableLayoutUpdater.GetTableCellPositions(ATable: TdxTable)
  : TdxIntegerList;
begin
...
procedure TdxDocTableLayoutUpdater.ProcessTableDefinition(ARow: TdxTableRow;
  APropertyContainer: TdxDocPropertyContainer;
  ARowCellSizeAndPosition: TdxRowLeftAndCellWidths);
var
...
begin
  ...
  begin
    ...
    begin
      ...
      if ASpan > 1 then
        TdxDocImporter(FImporter).AddCellsHorizontalMerging(ARow,
          AFirstMergedCell, ASpan);
      AFirstMergedCell := I;
    end;
  end;
...
procedure TdxDocTableLayoutUpdater.ApplyInsertActions(APropertyContainer
  : TdxDocPropertyContainer; ARowCellWidths: TdxIntegerList);
var
...
begin
  ...
  begin
    ACurrentInsertion := APropertyContainer.TableRowInfo.InsertActions
      [AInsertionIndex];
    ACount := ACurrentInsertion.Count;
    for AColumnIndex := 0 to ACount - 1 do
      ARowCellWidths.Insert(ACurrentInsertion.StartIndex + AColumnIndex,
        ACurrentInsertion.WidthInTwips);
  end;
end;

procedure TdxDocTableLayoutUpdater.ApplyColumnWidthsActions(APropertyContainer
  : TdxDocPropertyContainer; ARowCellWidths: TdxIntegerList);
var
...
begin
  ...
  begin
    ACurrentWidthAction := APropertyContainer.TableRowInfo.ColumnWidthActions
      [AWidthActionIndex];
    for AColumnIndex := ACurrentWidthAction.StartIndex to ACurrentWidthAction.
      EndIndex do
      ARowCellWidths[AColumnIndex] := ACurrentWidthAction.WidthInTwips;
  end;
end;

procedure TdxDocTableLayoutUpdater.AddTableCellPositions(ARow: TdxTableRow;
  ARowLeftAndCellsWidth: TdxRowLeftAndCellWidths;
  ATableCellPositions: TdxIntegerList;
  APropertyContainer: TdxDocPropertyContainer);
var
...
function TdxDocTableLayoutUpdater.GetRowLeft(ARow: TdxTableRow;
  APropertyContainer: TdxDocPropertyContainer): Integer;
var
...
begin
  ...
  if (ARowInfo <> nil) and (ARowInfo.RowLeftAssigned or
    ARowInfo.RowLeftOffsetAssigned) then
  begin
    ARowLeft := 0;
...
procedure TdxDocTableLayoutUpdater.TryToAddCellPosition
  (ADestination: TdxIntegerList; APosition: Integer);
var
...
begin
  ...
  try
    ...
    ARowLeftAndCellsWidthCollection :=
      TdxObjectList<TdxRowLeftAndCellWidths>.Create;
    try
      ...
      begin
        ...
        CorrectCellWidthsAndSpans(ACurrentRow, ACellPositions,
          ARowLeftAndCellsWidthCollection[ARowIndex], AMinRowLeft);
        if PreferredCellWidths.TryGetValue(ACurrentRow, APreferredCellWidths)
        then
...
procedure TdxDocTableLayoutUpdater.CorrectCellWidthsAndSpans(ARow: TdxTableRow;
  ACellPositions: TdxIntegerList;
  ARowLeftAndCellsWidth: TdxRowLeftAndCellWidths; AMinRowLeft: Integer);
var
...
begin
  ...
  try
    ASpan := CalcColumnSpan(ACellPositions, AMinRowLeft,
      ARowLeftAndCellsWidth.RowLeft - AMinRowLeft);
    if ASpan <> ARow.GridBefore then
      ARow.GridBefore := ASpan;
    ACurrentPosition := ARowLeftAndCellsWidth.RowLeft;
    ACurrentPosition := ProcessRowCells(ARow, ACellPositions,
      ARowLeftAndCellsWidth.CellWidths, ACurrentPosition);

    ASpan := CalcColumnSpan(ACellPositions, ACurrentPosition,
      ACellPositions[ACellPositions.Count - 1] - ACurrentPosition);
...
function TdxDocTableLayoutUpdater.ProcessRowCells(ARow: TdxTableRow;
  ACellPositions: TdxIntegerList; ACellWidths: TdxIntegerList;
  ACurrentPosition: Integer): Integer;
var
  ACount: Integer;
begin
  ...
  if ACount = ACellWidths.Count then
    Result := ApplyActualColumnSpans(ARow, ACellPositions, ACellWidths,
      ACurrentPosition)
  else
    Result := ApplyDefaultColumnSpans(ARow, ACellPositions, ACellWidths,
      ACurrentPosition);
end;

function TdxDocTableLayoutUpdater.ApplyActualColumnSpans(ARow: TdxTableRow;
  ACellPositions: TdxIntegerList; ACellWidths: TdxIntegerList;
  ACurrentPosition: Integer): Integer;
var
...
begin
  ...
  begin
    ...
    try
      ACurrentCell.ColumnSpan :=
        Math.Max(1, CalcColumnSpan(ACellPositions, ACurrentPosition,
        ACurrentWidth));
      ACurrentCell.Properties.PreferredWidth.Value :=
        UnitConverter.TwipsToModelUnits(ACurrentWidth);
      ACurrentCell.Properties.PreferredWidth.&Type :=
...
function TdxDocTableLayoutUpdater.ApplyDefaultColumnSpans(ARow: TdxTableRow;
  ACellPositions: TdxIntegerList; ACellWidths: TdxIntegerList;
  ACurrentPosition: Integer): Integer;
var
...
function TdxDocTableLayoutUpdater.CalcColumnSpan(ACellPositions: TdxIntegerList;
  ACurrentPosition: Integer; ACurrentWidth: Integer): Integer;
var
...
begin
  ...
  if not ACellPositions.BinarySearch(ACurrentPosition + ACurrentWidth,
    AEndPositionIndex) then
    AEndPositionIndex := not AEndPositionIndex;
  Result := AEndPositionIndex - AStartPositionIndex;
end;

procedure TdxDocTableLayoutUpdater.ApplyPreferredWidths(ARow: TdxTableRow;
  APreferredCellWidths: TdxTableCellWidthOperandList);
var
  ACount, I: Integer;
begin
...
procedure TdxDocTableLayoutUpdater.ApplyPreferredWidthsCore(ARow: TdxTableRow;
  AOperand: TdxTableCellWidthOperand);
var
...
procedure TdxDocTableLayoutUpdater.ApplyTablePropertiesException
  (ARow: TdxTableRow; AInfo: TdxTableRowInfo);
begin
  if (AInfo = nil) or (AInfo.TableAutoformatLookSpecifier = nil) then
    Exit;
  AInfo.TableAutoformatLookSpecifier.ApplyProperties
    (ARow.TablePropertiesException);
end;
...
begin
  inherited Create;
  FVerticalMergedCells :=
    TObjectDictionary<TdxTableRow, TdxVerticalMergeInfoList>.Create
    ([doOwnsValues]);
end;
...
procedure TdxVerticalMergingStateUpdater.UpdateCellsVerticalMergeState
  (ARow: TdxTableRow; APropertyContainer: TdxDocPropertyContainer);
begin
  ...
  begin
    ...
    begin
      ...
      if ACurrentInfo.CellIndex >= ACurrentRow.Cells.Count then
        Continue;
      ACurrentRow.Cells[ACurrentInfo.CellIndex].VerticalMerging :=
        ACurrentInfo.MergingState;
    end;
  end;
end;

procedure TdxVerticalMergingStateUpdater.AddVerticalMergedCells
  (ARow: TdxTableRow; APropertyContainer: TdxDocPropertyContainer);
var
...
procedure TdxVerticalMergingStateUpdater.ApplyCellVerticalAlignmentActions
  (ARow: TdxTableRow; APropertyContainer: TdxDocPropertyContainer);
var
...
begin
  if APropertyContainer.TableRowInfo = nil then
    Exit;
  ACount := APropertyContainer.TableRowInfo.
    CellRangeVerticalAlignmentActions.Count;
  for I := 0 to ACount - 1 do
  begin
    ACurrentVerticalAlignmentAction :=
      APropertyContainer.TableRowInfo.CellRangeVerticalAlignmentActions[I];
    for ACellIndex := ACurrentVerticalAlignmentAction.StartIndex to
      ACurrentVerticalAlignmentAction.EndIndex do
      ARow.Cells[ACellIndex].Properties.VerticalAlignment :=
        ACurrentVerticalAlignmentAction.VerticalAlignment;
  end;
end;

function TdxVerticalMergingStateUpdater.GetVerticalMergingInfo
  (ARow: TdxTableRow): TdxVerticalMergeInfoList;
begin
...
class procedure TdxTableCellPropertiesUpdater.UpdateTableRow(ARow: TdxTableRow;
  APropertyContainer: TdxDocPropertyContainer);
begin
...
class procedure TdxTableCellPropertiesUpdater.ApplyCellBorders
  (ARow: TdxTableRow; APropertyContainer: TdxDocPropertyContainer);
var
  ARowInfo: TdxTableRowInfo;
...
begin
  ...
  begin
    ...
    for ACellIndex := AStart to AEnd do
      AOperand.ApplyProperties(ARow.Cells[ACellIndex].Properties.Borders,
        APropertyContainer.UnitConverter);
  end;
  if ACount > 0 then
    Exit;
  ApplyBorderColors(ARow, ARowInfo.TopBorders, TdxDocTableCellBorder.Top,
    ATableInfo, APropertyContainer.UnitConverter);
  ApplyBorderColors(ARow, ARowInfo.LeftBorders, TdxDocTableCellBorder.Left,
    ATableInfo, APropertyContainer.UnitConverter);
  ApplyBorderColors(ARow, ARowInfo.RightBorders, TdxDocTableCellBorder.Right,
    ATableInfo, APropertyContainer.UnitConverter);
  ApplyBorderColors(ARow, ARowInfo.BottomBorders, TdxDocTableCellBorder.Bottom,
    ATableInfo, APropertyContainer.UnitConverter);

  ApplyTableCellDescriptors(ARow, TdxDocTableCellBorder.Top, ATableInfo,
    APropertyContainer.UnitConverter);
  ApplyTableCellDescriptors(ARow, TdxDocTableCellBorder.Left, ATableInfo,
    APropertyContainer.UnitConverter);
  ApplyTableCellDescriptors(ARow, TdxDocTableCellBorder.Right, ATableInfo,
    APropertyContainer.UnitConverter);
  ApplyTableCellDescriptors(ARow, TdxDocTableCellBorder.Bottom, ATableInfo,
    APropertyContainer.UnitConverter);
end;

class procedure TdxTableCellPropertiesUpdater.ApplyBorderColors
  (ARow: TdxTableRow; AColors: TdxDocTableBorderColorReferenceList;
  AType: TdxDocTableCellBorder; ATableInfo: TdxDocTableInfo;
  AUnitConverter: TdxDocumentModelUnitConverter);
var
  ACount, I: Integer;
...
class procedure TdxTableCellPropertiesUpdater.ApplyTableCellDescriptors
  (ARow: TdxTableRow; AType: TdxDocTableCellBorder; ATableInfo: TdxDocTableInfo;
  AUnitConverter: TdxDocumentModelUnitConverter);
var
  ACells: TdxTableCellDescriptorList;
  I: Integer;
...
class function TdxTableCellPropertiesUpdater.GetModelBorder
  (ABorders: TdxTableCellBorders; AType: TdxDocTableCellBorder): TdxBorderBase;
begin
  case AType of
...
class function TdxTableCellPropertiesUpdater.GetBorderDescriptor
  (ACell: TdxTableCellDescriptor; AType: TdxDocTableCellBorder)
...
class procedure TdxTableCellPropertiesUpdater.ApplyCellMargins
  (ARow: TdxTableRow; APropertyContainer: TdxDocPropertyContainer);
var
  ACount, I, AStart, AEnd, ACellIndex: Integer;
...
begin
  ...
  begin
    ...
    AEnd := Math.Min(AOperand.EndIndex, ARow.Cells.Count - 1);
    for ACellIndex := AStart to AEnd do
      AOperand.ApplyProperties(ARow.Cells[ACellIndex].Properties.CellMargins,
        APropertyContainer.UnitConverter);
  end;
end;

class procedure TdxTableCellPropertiesUpdater.ApplyOldCellBackgroundColors
  (ARow: TdxTableRow; APropertyContainer: TdxDocPropertyContainer);
begin
  if APropertyContainer.TableRowInfo = nil then
    Exit;
  ApplyOldCellBackgroundColorsCore(ARow,
    APropertyContainer.TableRowInfo.DefaultCellsShading, 0);
  ApplyOldCellBackgroundColorsCore(ARow,
    APropertyContainer.TableRowInfo.CellShading1, 0);
  ApplyOldCellBackgroundColorsCore(ARow,
    APropertyContainer.TableRowInfo.CellShading2, 22);
  ApplyOldCellBackgroundColorsCore(ARow,
    APropertyContainer.TableRowInfo.CellShading3, 44);
end;

class procedure TdxTableCellPropertiesUpdater.ApplyOldCellBackgroundColorsCore
  (ARow: TdxTableRow; AList: TdxAlphaColorList; AFirstCellIndex: Integer);
var
  ACells: TdxTableCellCollection;
  I: Integer;
begin
...
class procedure TdxTableCellPropertiesUpdater.ApplyCellBackgroundColors
  (ARow: TdxTableRow; APropertyContainer: TdxDocPropertyContainer);
var
  ACount, I: Integer;
begin
  ...
  for I := 0 to ACount - 1 do
    if APropertyContainer.TableCellInfo.CellColors[I] <> TdxAlphaColors.Empty
    then
      ARow.Cells[I].BackgroundColor :=
        APropertyContainer.TableCellInfo.CellColors[I];
end;
