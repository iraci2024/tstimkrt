...
{$ENDIF}
  ...
  dxSpreadSheetContainers, dxSpreadSheetTypes,
...
type
  ...
  TdxSpreadSheetXMLSSReaderStylesMap = class
  ...
  strict private
    ...
    FXMLIsOwn: Boolean;
  protected
    function ConvertBorderStyle(const ALineStyle: string; AWeight: Integer)
    ...
    function ReadStyleBorders(ANode: TdxXMLNode;
      AParentStyle: TdxSpreadSheetBordersHandle)
      : TdxSpreadSheetBordersHandle; virtual;
    function ReadStyleBrush(ANode: TdxXMLNode;
      AParentStyle: TdxSpreadSheetBrushHandle)
      : TdxSpreadSheetBrushHandle; virtual;
    function ReadStyleFont(ANode: TdxXMLNode;
      AParentStyle: TdxSpreadSheetFontHandle)
      : TdxSpreadSheetFontHandle; virtual;
    function ReadStyleFormat(ANode: TdxXMLNode;
      AParentStyle: TdxSpreadSheetFormatHandle)
      : TdxSpreadSheetFormatHandle; virtual;
    procedure ReadStyle(ANode: TdxXMLNode); virtual;
  public
    constructor Create(AOwner: TdxCustomSpreadSheet; ADocument: TdxXMLDocument);
    ...
    //
    property FormulasRefs: TdxSpreadSheetFormulaAsTextInfoList
      read FFormulasRefs;
    property NumberFormatMap: TDictionary<string, Variant>
      read FNumberFormatMap;
  ...
  TdxSpreadSheetXMLSSDefinedNamesReader = class
  ...
  public
    constructor Create(AOwner: TdxSpreadSheetXMLSSReader;
      AView: TdxSpreadSheetTableView; ANode: TdxXMLNode); overload;
  ...
  protected
    procedure ReadCell(ANode: TdxXMLNode;
      ARowIndex, AColumnIndex: Integer); virtual;
    procedure ReadCellComment(ANode: TdxXMLNode;
      ACell: TdxSpreadSheetCell); virtual;
    procedure ReadCellData(ANode: TdxXMLNode;
      ACell: TdxSpreadSheetCell); virtual;
    procedure ReadColumn(ANode: TdxXMLNode; AColumnIndex: Integer); virtual;
    function ReadFormattedSharedString(ANode: TdxXMLNode;
      ADefaultFontHandle: TdxSpreadSheetFontHandle = nil)
      : TdxSpreadSheetFormattedSharedString; virtual;
    ...
    function ReadSharedString(ANode: TdxXMLNode;
      ADefaultFontHandle: TdxSpreadSheetFontHandle = nil)
      : TdxSpreadSheetSharedString; virtual;
  public
    constructor Create(AOwner: TdxSpreadSheetXMLSSReader;
      AView: TdxSpreadSheetTableView; ANode: TdxXMLNode); overload;
    constructor Create(AOwner: TdxSpreadSheetXMLSSReader;
      AView: TdxSpreadSheetTableView; ANode: TdxXMLNode; const AAnchor: TPoint;
      AOptions: TdxSpreadSheetClipboardPasteOptions); overload;
    procedure Execute; override;
  ...
  protected
    ...
    function CreateMergedCellStyle(AView: TdxSpreadSheetTableView;
      const AArea: TRect): TdxSpreadSheetCellStyleHandle;
    function CreateProgressHelper
      : TdxSpreadSheetCustomFilerProgressHelper; override;
    procedure Initialize(ADoc: TdxXMLDocument; AIsOwnDoc: Boolean); virtual;
    procedure WriteCell(ANode: TdxXMLNode; ACell: TdxSpreadSheetCell;
      AStyleID: Integer; const AArea, AMergedArea: TRect);
    procedure WriteCellData(ACellNode: TdxXMLNode; ACell: TdxSpreadSheetCell);
    procedure WriteColumns(AParentNode: TdxXMLNode;
      AView: TdxSpreadSheetTableView; AArea: TRect);
    procedure WriteComment(ANode: TdxXMLNode;
      AComment: TdxSpreadSheetCommentContainer);
    procedure WriteNames(AParentNode: TdxXMLNode); virtual;
    procedure WriteRows(AParentNode: TdxXMLNode; AView: TdxSpreadSheetTableView;
      AArea: TRect);
    procedure WriteString(ACellNode: TdxXMLNode;
      AString: TdxSpreadSheetSharedString);
    procedure WriteStyle(ANode: TdxXMLNode;
      AStyle: TdxSpreadSheetCellStyleHandle; AStyleID: Integer);
    procedure WriteStyleAlignment(ANode: TdxXMLNode;
      AStyle: TdxSpreadSheetCellStyleHandle);
    procedure WriteStyleBorders(ANode: TdxXMLNode;
      AStyle: TdxSpreadSheetBordersHandle);
    procedure WriteStyleBrush(ANode: TdxXMLNode;
      AStyle: TdxSpreadSheetBrushHandle);
    procedure WriteStyleFont(ANode: TdxXMLNode;
      AStyle: TdxSpreadSheetFontHandle);
    procedure WriteStyleNumberFormat(ANode: TdxXMLNode;
      AStyle: TdxSpreadSheetFormatHandle);
    procedure WriteView(AParentNode: TdxXMLNode; AView: TdxSpreadSheetTableView;
      const AArea: TRect);
...
uses
  dxSpreadSheetHyperlinks, dxSpreadSheetNumberFormat, Variants,
  dxSpreadSheetStyles, dxStringHelper,
...
const
  ...
  BordersNames: array [TcxBorder] of string = ('Left', 'Top', 'Right',
    'Bottom');
  CellDataTypeMap: array [TdxSpreadSheetCellDataType] of string = ('',
    sXMLSSDataTypeBoolean, sXMLSSDataTypeError, sXMLSSDataTypeNumber,
    sXMLSSDataTypeNumber, sXMLSSDataTypeDateTime, sXMLSSDataTypeNumber,
    sXMLSSDataTypeString, sXMLSSDataTypeString);
  CellFillStyleNames: array [TdxSpreadSheetCellFillStyle] of string = ('Solid',
    'Gray75', 'Gray50', 'Gray25', 'Gray125', 'Gray0625', 'HorzStripe',
    'VertStripe', 'ReverseDiagStripe', 'DiagStripe', 'DiagCross',
    'ThickDiagCross', 'ThinHorzStripe', 'ThinVertStripe',
    'ThinReverseDiagStripe', 'ThinDiagStripe', 'ThinHorzCross',
    'ThinDiagCross');
  HorzAttrValuesMap: array [TdxSpreadSheetDataAlignHorz] of string =
    ('Automatic', 'Left', 'Center', 'Right', 'Fill', 'Justify', 'Distributed');
  VertAttrValuesMap: array [TdxSpreadSheetDataAlignVert] of string = ('Top',
    'Center', 'Bottom', 'Justify', 'Distributed');
  LineStyleMap: array [TdxSpreadSheetCellBorderStyle] of TdxXMLSSLineStyleInfo =
    ((Name: ''; Weight: 1), (Name: 'Continuous'; Weight: 0), (Name: 'Dot';
    Weight: 1), (Name: 'DashDotDot'; Weight: 1), (Name: 'DashDot'; Weight: 1),
    (Name: 'Dash'; Weight: 1), (Name: 'Continuous'; Weight: 1),
    (Name: 'DashDotDot'; Weight: 2), (Name: 'SlantDashDot'; Weight: 2),
    (Name: 'DashDot'; Weight: 2), (Name: 'Dash'; Weight: 2),
    (Name: 'Continuous'; Weight: 2), (Name: 'Continuous'; Weight: 3),
    (Name: 'Double'; Weight: 3), (Name: 'None'; Weight: 0));

function StringToAlignHorz(const S: string): TdxSpreadSheetDataAlignHorz;
var
  I: TdxSpreadSheetDataAlignHorz;
begin
  for I := Low(TdxSpreadSheetDataAlignHorz)
    to High(TdxSpreadSheetDataAlignHorz) do
  begin
...
begin
  for I := Low(TdxSpreadSheetDataAlignVert)
    to High(TdxSpreadSheetDataAlignVert) do
  begin
...
begin
  for I := Low(TdxSpreadSheetCellDataType)
    to High(TdxSpreadSheetCellDataType) do
  begin
...
begin
  for I := Low(TdxSpreadSheetCellFillStyle)
    to High(TdxSpreadSheetCellFillStyle) do
...
constructor TdxSpreadSheetXMLSSReader.Create(AOwner: TdxCustomSpreadSheet;
...
function TdxSpreadSheetXMLSSReader.ConvertBorderStyle(const ALineStyle: string;
  AWeight: Integer): TdxSpreadSheetCellBorderStyle;
var
  AStyle: TdxSpreadSheetCellBorderStyle;
begin
  for AStyle := Low(TdxSpreadSheetCellBorderStyle)
    to High(TdxSpreadSheetCellBorderStyle) do
  begin
    if (LineStyleMap[AStyle].Name = ALineStyle) and
      (LineStyleMap[AStyle].Weight = AWeight) then
      Exit(AStyle);
  end;
  Result := sscbsDefault;
end;
...
function TdxSpreadSheetXMLSSReader.CreateProgressHelper
  : TdxSpreadSheetCustomFilerProgressHelper;
begin
  Result := TdxSpreadSheetCustomFilerProgressHelper.Create(Self, 1);
end;

procedure TdxSpreadSheetXMLSSReader.Initialize(ADoc: TdxXMLDocument;
  AIsOwnDoc: Boolean);
begin
  FXML := ADoc;
  FXMLIsOwn := AIsOwnDoc;
  ...
  FNumberFormatMap.Add('Euro Currency',
    '[$€-2]\ ###,000_);[Red]\([$€-2]\ ###,000\)');
...
begin
  ...
  try
    ...
    dxGetLocaleFormatSettings(dxGetInvariantLocaleID,
      SpreadSheet.FormulaController.FormatSettings.Data);

    if XML.FindChild([sXMLSSNodeWorkbook], ANode) then
    begin
      ProgressHelper.BeginStage(ANode.Count);
      try
        ANode.ForEach(procedure(ANode: TdxXMLNode; AData: Pointer)
          begin
...
begin
  ExecuteSubTask(TdxSpreadSheetXMLSSDefinedNamesReader.Create(Self,
    nil, ANode));
end;
...
begin
  ...
  begin
    ExecuteSubTask(TdxSpreadSheetXMLSSTableViewReader.Create(Self,
      AddTableView(ANode.Attributes.GetValueAsString(sXMLSSAttrName)),
      ATableNode));
  end;
end;

function TdxSpreadSheetXMLSSReader.ReadStyleBorders(ANode: TdxXMLNode;
AParentStyle: TdxSpreadSheetBordersHandle): TdxSpreadSheetBordersHandle;
var
  AStyle: TdxSpreadSheetBordersHandle;
begin
  ...
  ANode.ForEach(procedure(ANode: TdxXMLNode; AData: Pointer)
    ...
    begin
      for ASide := Low(TcxBorder) to High(TcxBorder) do
        if ANode.Attributes.GetValueAsString(sXMLSSAttrPosition) = BordersNames
          [ASide] then
        begin
          AStyle.BorderStyle[ASide] :=
            ConvertBorderStyle(ANode.Attributes.GetValueAsString
            (sXMLSSAttrLineStyle), ANode.Attributes.GetValueAsInteger
            (sXMLSSAttrWeight));
          if ANode.Attributes.Exists(sXMLSSAttrColor) then
            AStyle.BorderColor[ASide] :=
              ConvertColor(ANode.Attributes.GetValueAsString(sXMLSSAttrColor));
          Break;
        end;
    end);
...
function TdxSpreadSheetXMLSSReader.ReadStyleBrush(ANode: TdxXMLNode;
AParentStyle: TdxSpreadSheetBrushHandle): TdxSpreadSheetBrushHandle;
begin
  if ANode = nil then
    Exit(AParentStyle);
  ...
  if ANode.Attributes.Exists(sXMLSSAttrPatternColor) then
    Result.ForegroundColor :=
      ConvertColor(ANode.Attributes.GetValueAsString(sXMLSSAttrPatternColor));
  Result.Style := StringToCellFillStyle
    (ANode.Attributes.GetValueAsString(sXMLSSAttrPattern));
  Result := AddBrush(Result);
end;

function TdxSpreadSheetXMLSSReader.ReadStyleFont(ANode: TdxXMLNode;
AParentStyle: TdxSpreadSheetFontHandle): TdxSpreadSheetFontHandle;
begin
  if ANode = nil then
    Exit(AParentStyle);
  ...
  Result.Color := ConvertColor(ANode.Attributes.GetValueAsString
    (sXMLSSAttrColor));
  ...
  if ANode.HasAttribute(sXMLSSAttrUnderline) and
    (ANode.Attributes.GetValueAsString(sXMLSSAttrUnderline) <> 'None') then
    Include(Result.Style, fsUnderline);

  Result := AddFont(Result);
end;

function TdxSpreadSheetXMLSSReader.ReadStyleFormat(ANode: TdxXMLNode;
AParentStyle: TdxSpreadSheetFormatHandle): TdxSpreadSheetFormatHandle;
var
  AFormat: string;
  AValue: Variant;
begin
...
procedure TdxSpreadSheetXMLSSReader.ReadStyle(ANode: TdxXMLNode);
  ...
  procedure ModifyState(AStyleHandle: TdxSpreadSheetCellStyleHandle;
  AStateIndex: TdxSpreadSheetCellState; AValue: Boolean);
  begin
    if AValue then
...
var
  ...
  ASubNode: TdxXMLNode;
begin
  if not Styles.TryGetValue(ANode.Attributes.GetValueAsString(sXMLSSAttrParent,
    sXMLSSDefaultStyleID), AParentStyleHandle) then
    AParentStyleHandle := SpreadSheet.DefaultCellStyle.Handle;

  AStyleHandle := CellStyles.CreateStyle;
  AStyleHandle.Borders := ReadStyleBorders(ANode.FindChild(sXMLSSNodeBorders),
    AParentStyleHandle.Borders);
  AStyleHandle.Font := ReadStyleFont(ANode.FindChild(sXMLSSNodeFont),
    AParentStyleHandle.Font);
  AStyleHandle.DataFormat :=
    ReadStyleFormat(ANode.FindChild(sXMLSSNodeNumberFormat),
    AParentStyleHandle.DataFormat);
  AStyleHandle.Brush := ReadStyleBrush(ANode.FindChild(sXMLSSNodeInterior),
    AParentStyleHandle.Brush);

  if ANode.FindChild(sXMLSSNodeAlignment, ASubNode) then
  begin
    AStyleHandle.AlignHorz := StringToAlignHorz
      (ASubNode.Attributes.GetValueAsString(sXMLSSAttrHorizontal));
    AStyleHandle.AlignVert := StringToAlignVert
      (ASubNode.Attributes.GetValueAsString(sXMLSSAttrVertical));
    AStyleHandle.AlignHorzIndent := ASubNode.Attributes.GetValueAsInteger
      (sXMLSSAttrIndent);

    ModifyState(AStyleHandle, csShrinkToFit,
      ASubNode.Attributes.GetValueAsBoolean(sXMLSSAttrShrinkToFit));
    ModifyState(AStyleHandle, csWordWrap,
      ASubNode.Attributes.GetValueAsBoolean(sXMLSSAttrWrapText));
  end;

  if ANode.FindChild(sXMLSSNodeProtection, ASubNode) then
  begin
    if ASubNode.Attributes.Exists(sXMLSSAttrProtected) then
      ModifyState(AStyleHandle, csLocked,
        ASubNode.Attributes.GetValueAsBoolean(sXMLSSAttrProtected, True));
  end;

  Styles.AddOrSetValue(ANode.Attributes.GetValueAsString(sXMLSSAttrID),
    AddCellStyle(AStyleHandle));
end;

{ TdxSpreadSheetXMLSSDefinedNamesReader }

constructor TdxSpreadSheetXMLSSDefinedNamesReader.Create
  (AOwner: TdxSpreadSheetXMLSSReader; AView: TdxSpreadSheetTableView;
ANode: TdxXMLNode);
begin
...
begin
  Node.ForEach(procedure(ANode: TdxXMLNode; AUserData: Pointer)
    begin
...
procedure TdxSpreadSheetXMLSSDefinedNamesReader.ReadNamedRange
  (ANode: TdxXMLNode);
begin
  try
    SpreadSheet.DefinedNames.Add(ANode.Attributes.GetValueAsString
      (sXMLSSAttrName), ANode.Attributes.GetValueAsString
      (sXMLSSAttrReferTo), View);
  except
    // do nothing
  end;
end;
...
constructor TdxSpreadSheetXMLSSTableViewReader.Create
  (AOwner: TdxSpreadSheetXMLSSReader; AView: TdxSpreadSheetTableView;
ANode: TdxXMLNode; const AAnchor: TPoint;
...
procedure TdxSpreadSheetXMLSSTableViewReader.ReadCell(ANode: TdxXMLNode;
...
begin
  ...
  begin
    if Owner.Styles.TryGetValue(ANode.Attributes.GetValueAsString
      (sXMLSSAttrStyleID), AHandle) then
    begin
      if ACell = nil then
      ...
      begin
        ...
        TdxSpreadSheetCellDataFormatAccess(ACell.Style.DataFormat).Handle :=
          AHandle.DataFormat;
    end;
  end;
...
procedure TdxSpreadSheetXMLSSTableViewReader.ReadCellComment(ANode: TdxXMLNode;
ACell: TdxSpreadSheetCell);
var
  AComment: TdxSpreadSheetCommentContainerAccess;
  ASharedString: TdxSpreadSheetFormattedSharedString;
begin
  ASharedString := ReadFormattedSharedString
    (ANode.FindChild(sXMLSSNodeCommentData));
  try
    ...
    try
      ...
      AComment.Calculator.UpdateAnchors
        (TdxSpreadSheetCommentContainer.GetDefaultPosition(AComment.Cell));
      AComment.Visible := ANode.Attributes.GetValueAsBoolean
        (sXMLSSAttrShowAlways);
...
procedure TdxSpreadSheetXMLSSTableViewReader.ReadCellData(ANode: TdxXMLNode;
ACell: TdxSpreadSheetCell);
var
...
begin
  ...
  begin
    ...
    AHyperlink.ScreenTip := ANode.Attributes.GetValueAsString
      (sXMLSSAttrHRefScreenTip);
  ...
  begin
    Owner.FormulasRefs.Add(ACell, ANode.Attributes.GetValueAsString
      (sXMLSSAttrFormula), ANode.HasAttribute(sXMLSSAttrArrayRange), False,
      dxStringToReferenceArea(ANode.Attributes.GetValueAsString
      (sXMLSSAttrArrayRange)));
  end
  else if ANode.FindChild(sXMLSSNodeData, ADataNode) or
    ANode.FindChild(sXMLSSNodeData2, ADataNode) then
    case StringToCellDataType(ADataNode.Attributes.GetValueAsString
      (sXMLSSAttrType)) of
      cdtBoolean:
      ...
      cdtString:
        ACell.AsSharedString := Owner.StringTable.Add
          (ReadSharedString(ADataNode, ACell.StyleHandle.Font));
    end;
end;

procedure TdxSpreadSheetXMLSSTableViewReader.ReadColumn(ANode: TdxXMLNode;
AColumnIndex: Integer);
begin
  if cpoColumnWidths in Options then
  begin
    if ANode.HasAttribute(sXMLSSAttrWidth) then
      View.Columns.CreateItem(AColumnIndex).Size :=
        ConvertSize(ANode.Attributes.GetValueAsFloat(sXMLSSAttrWidth));
  end;
end;

function TdxSpreadSheetXMLSSTableViewReader.ReadFormattedSharedString
  (ANode: TdxXMLNode; ADefaultFontHandle: TdxSpreadSheetFontHandle = nil)
  ...
  begin
    ...
    begin
      ...
      begin
        Result.Charset := ANode.Attributes.GetValueAsInteger(sXMLSSAttrCharset,
          ADefaultFontHandle.Charset);
        Result.Color := Owner.ConvertColor
          (ANode.Attributes.GetValueAsString(sHTMLAttrColor));
        Result.Name := ANode.Attributes.GetValueAsString(sHTMLAttrFace,
          ADefaultFontHandle.Name);
        Result.Size := ANode.Attributes.GetValueAsInteger(sHTMLAttrSize,
          ADefaultFontHandle.Size);
      end;
  ...
  procedure Process(ARuns: TdxSpreadSheetFormattedSharedStringRuns;
  ABuffer: TStringBuilder; ANode, AParentNode: TdxXMLNode);
  begin
    if ANode.Text <> '' then
    begin
...
procedure TdxSpreadSheetXMLSSTableViewReader.ReadRow(ANode: TdxXMLNode;
ARowIndex: Integer);
var
...
begin
  ...
  if ANode.HasAttribute(sXMLSSAttrHeight) then
    ARow.Size := ConvertSize(ANode.Attributes.GetValueAsFloat
      (sXMLSSAttrHeight));
  ARow.IsCustomSize := not ANode.Attributes.GetValueAsBoolean
    (sXMLSSAttrAutoFitHeight, True);
  ReadRowCells(ANode.First, ARowIndex);
end;

procedure TdxSpreadSheetXMLSSTableViewReader.ReadRowCells(ANode: TdxXMLNode;
ARowIndex: Integer);
var
  AExpandAreaSize: TSize;
  AColumnIndex: Integer;
begin
  AColumnIndex := 0;
  ...
  begin
    ...
    AExpandAreaSize :=
      cxSize(ANode.Attributes.GetValueAsInteger(sXMLSSAttrMergedAcross),
      ANode.Attributes.GetValueAsInteger(sXMLSSAttrMergedDown));
    ReadCell(ANode, ARowIndex, Anchor.X + AColumnIndex);
    if (AExpandAreaSize.cx > 0) or (AExpandAreaSize.cy > 0) then
    begin
      if cpoStyles in Options then
      begin
        View.MergedCells.Add(cxRectBounds(Anchor.X + AColumnIndex, ARowIndex,
          AExpandAreaSize.cx, AExpandAreaSize.cy));
        TdxSpreadSheetTableViewMergedCellStyleHelper.Calculate
          (View.MergedCells.FindCell(ARowIndex, Anchor.X + AColumnIndex), True);
      end;
      Inc(AColumnIndex, AExpandAreaSize.cx);
    end;
    Inc(AColumnIndex);
    ANode := ANode.Next;
  end;
...
function TdxSpreadSheetXMLSSTableViewReader.ReadSharedString(ANode: TdxXMLNode;
ADefaultFontHandle: TdxSpreadSheetFontHandle = nil): TdxSpreadSheetSharedString;
begin
...
begin
  if ANode.HasAttribute(sXMLSSAttrDefaultColumnWidth) then
    View.Columns.DefaultSize :=
      ConvertSize(ANode.Attributes.GetValueAsFloat
      (sXMLSSAttrDefaultColumnWidth));
  if ANode.HasAttribute(sXMLSSAttrDefaultRowHeight) then
    View.Rows.DefaultSize :=
      ConvertSize(ANode.Attributes.GetValueAsFloat(sXMLSSAttrDefaultRowHeight));
end;

function TdxSpreadSheetXMLSSTableViewReader.ConvertSize
...
constructor TdxSpreadSheetXMLSSWriter.Create(AOwner: TdxCustomSpreadSheet;
ADocument: TdxXMLDocument);
begin
  inherited Create(AOwner, nil);
  Initialize(ADocument, False);
...
begin
  ...
  try
    ...
    SpreadSheet.FormulaController.FormatSettings.Data := ASavedFormatSettings;
    SpreadSheet.OptionsView.R1C1Reference := ASavedR1C1Reference;
    TdxSpreadSheetAccess(SpreadSheet).Changes :=
      TdxSpreadSheetAccess(SpreadSheet).Changes - [sscData];
    SpreadSheet.EndUpdate;
  end;
...
function TdxSpreadSheetXMLSSWriter.CanWriteFormula
  (AFormula: TdxSpreadSheetFormula): Boolean;
begin
  Result := True;
end;

function TdxSpreadSheetXMLSSWriter.CreateMergedCellStyle
...
var
  ...
  ATopLeftCellStyle: TdxSpreadSheetCellStyleHandle;
begin
  ATopLeftCellStyle := AView.CreateCell(AArea.Top, AArea.Left).StyleHandle;
  ABottomRightCellStyle := AView.CreateCell(AArea.Bottom, AArea.Right)
    .StyleHandle;
  if ATopLeftCellStyle <> ABottomRightCellStyle then
  begin
    ABorders := AView.CellStyles.Borders.CreateBorders;
    ABorders.BorderColor[bLeft] := ATopLeftCellStyle.Borders.BorderColor[bLeft];
    ABorders.BorderStyle[bLeft] := ATopLeftCellStyle.Borders.BorderStyle[bLeft];
    ABorders.BorderColor[bTop] := ATopLeftCellStyle.Borders.BorderColor[bTop];
    ABorders.BorderStyle[bTop] := ATopLeftCellStyle.Borders.BorderStyle[bTop];
    ABorders.BorderColor[bRight] :=
      ABottomRightCellStyle.Borders.BorderColor[bRight];
    ABorders.BorderStyle[bRight] :=
      ABottomRightCellStyle.Borders.BorderStyle[bRight];
    ABorders.BorderColor[bBottom] :=
      ABottomRightCellStyle.Borders.BorderColor[bBottom];
    ABorders.BorderStyle[bBottom] :=
      ABottomRightCellStyle.Borders.BorderStyle[bBottom];

    Result := ATopLeftCellStyle.Clone;
    Result.Borders := ABorders;
  end
  else
    Result := ATopLeftCellStyle;
end;

function TdxSpreadSheetXMLSSWriter.CreateProgressHelper
  : TdxSpreadSheetCustomFilerProgressHelper;
begin
  Result := TdxSpreadSheetCustomFilerProgressHelper.Create(Self, 1);
end;

procedure TdxSpreadSheetXMLSSWriter.Initialize(ADoc: TdxXMLDocument;
AIsOwnDoc: Boolean);
begin
...
var
  ...
  AHyperlink: TdxSpreadSheetHyperlink;
begin
  ANode.Attributes.Add(sXMLSSAttrStyleID, Format(sXMLSSStyleNameTemplate,
    [AStyleID]));
    ...
    begin
      ...
      begin
        ANode.Attributes.Add(sXMLSSAttrArrayRange,
          dxReferenceToString(cxRect(0, 0, AFormula.ArrayFormulaSize.cx - 1,
          AFormula.ArrayFormulaSize.cy - 1), True));
      end;
      ANode.Attributes.Add(sXMLSSAttrFormula, AFormula.AsText);
    end;
  end;

  AHyperlink := ACell.View.Hyperlinks.FindItem(ACell.RowIndex,
    ACell.ColumnIndex);
...
procedure TdxSpreadSheetXMLSSWriter.WriteCellData(ACellNode: TdxXMLNode;
ACell: TdxSpreadSheetCell);
var
...
begin
  ...
  begin
    if TdxSpreadSheetFormulaAccess(ACell.AsFormula).ActualErrorCode <> ecNone
    then
  ...
  case AActualDataType of
    ...
    cdtFloat, cdtCurrency:
      ANode.TextAsString := dxFloatToStr(ACell.AsVariant,
...
procedure TdxSpreadSheetXMLSSWriter.WriteColumns(AParentNode: TdxXMLNode;
AView: TdxSpreadSheetTableView; AArea: TRect);
begin
  TdxSpreadSheetTableColumnsAccess(AView.Columns).ForEach(
    ...
    begin
      ...
      if not TdxSpreadSheetTableColumn(AItem).DefaultSize then
        ANode.Attributes.Add(sXMLSSAttrWidth,
          ConvertSize(TdxSpreadSheetTableColumn(AItem).Size));
    end, AArea.Left, AArea.Right);
end;

procedure TdxSpreadSheetXMLSSWriter.WriteComment(ANode: TdxXMLNode;
AComment: TdxSpreadSheetCommentContainer);
var
  AStyle: TFontStyle;
begin
  ...
  ANode.Attributes.Add(sHTMLAttrColor,
    ConvertColor(AComment.TextBox.Font.Color));
...
begin
  ...
  begin
    ...
    begin
      ...
      ANode.Attributes.Add(sXMLSSAttrReferTo,
        SpreadSheet.DefinedNames[I].Reference);
    end;
  end;
end;

procedure TdxSpreadSheetXMLSSWriter.WriteRows(AParentNode: TdxXMLNode;
AView: TdxSpreadSheetTableView; AArea: TRect);
begin
      ...
      begin
        ...
        TdxSpreadSheetTableRowCellsAccess(ARow.RowCells).ForEach(
          ...
          begin
            ...
            AMergedArea := AView.MergedCells.ExpandArea(ACell.ColumnIndex,
              ACell.RowIndex);
            if (AMergedArea.Left = ACell.ColumnIndex) and
              (AMergedArea.Top = ACell.RowIndex) then
            begin
              if dxSpreadSheetIsSingleCellArea(AMergedArea) then
              begin
                AStyleIndex := Styles.IndexOf(ACell.StyleHandle);
                if AStyleIndex < 0 then
                  AStyleIndex := Styles.Add(ACell.StyleHandle);
              end
              else
                AStyleIndex := Styles.Add(CreateMergedCellStyle(AView,
                  AMergedArea));

              WriteCell(ANode.AddChild(sXMLSSNodeCell), ACell, AStyleIndex,
                AArea, AMergedArea);
            end;
          end, AArea.Left, AArea.Right);
      end, AArea.Top, AArea.Bottom);
  finally
    ProgressHelper.EndStage;
  end;
end;

procedure TdxSpreadSheetXMLSSWriter.WriteString(ACellNode: TdxXMLNode;
AString: TdxSpreadSheetSharedString);

  function IsFormattedString(AString: TdxSpreadSheetSharedString): Boolean;
  begin
    Result := (AString is TdxSpreadSheetFormattedSharedString) and
      (TdxSpreadSheetFormattedSharedString(AString).Runs.Count > 0);
  end;

  procedure WriteStringRun(ANode: TdxXMLNode;
  AStartIndex, ANextRunIndex: Integer;
  AFontHandle: TdxSpreadSheetFontHandle = nil);
  var
    AStyle: TFontStyle;
  begin
    ...
    ANode.TextAsString := Copy(AString.Value, AStartIndex,
      ANextRunIndex - AStartIndex);
  end;
...
begin
  ...
  begin
    ...
    begin
      ARun := ARuns[I - 1];
      WriteStringRun(ANode, ARun.StartIndex, ARuns[I].StartIndex,
        ARun.FontHandle);
    end;

    ARun := ARuns[ARuns.Count - 1];
    WriteStringRun(ANode, ARun.StartIndex, Length(AString.Value) + 1,
      ARun.FontHandle);
  end
  else
  begin
...
procedure TdxSpreadSheetXMLSSWriter.WriteStyle(ANode: TdxXMLNode;
AStyle: TdxSpreadSheetCellStyleHandle; AStyleID: Integer);
var
  ASubNode: TdxXMLNode;
begin
  ANode.Attributes.Add(sXMLSSAttrID, Format(sXMLSSStyleNameTemplate,
    [AStyleID]));
  ...
  WriteStyleNumberFormat(ANode.AddChild(sXMLSSNodeNumberFormat),
    AStyle.DataFormat);
...
procedure TdxSpreadSheetXMLSSWriter.WriteStyleAlignment(ANode: TdxXMLNode;
AStyle: TdxSpreadSheetCellStyleHandle);
begin
  ANode.Attributes.Add(sXMLSSAttrHorizontal,
    HorzAttrValuesMap[AStyle.AlignHorz]);
...
procedure TdxSpreadSheetXMLSSWriter.WriteStyleBorders(ANode: TdxXMLNode;
AStyle: TdxSpreadSheetBordersHandle);
var
  ASide: TcxBorder;
...
begin
  ...
  begin
    ...
    if cxColorIsValid(AStyle.BorderColor[ASide]) then
      ASubNode.Attributes.Add(sXMLSSAttrColor,
        ConvertColor(AStyle.BorderColor[ASide]));
...
procedure TdxSpreadSheetXMLSSWriter.WriteStyleBrush(ANode: TdxXMLNode;
AStyle: TdxSpreadSheetBrushHandle);
begin
  ...
  begin
    ...
    if AStyle.Style <> sscfsSolid then
      ANode.Attributes.Add(sXMLSSAttrPatternColor,
        ConvertColor(AStyle.ForegroundColor));
  end;
end;

procedure TdxSpreadSheetXMLSSWriter.WriteStyleFont(ANode: TdxXMLNode;
AStyle: TdxSpreadSheetFontHandle);
begin
...
procedure TdxSpreadSheetXMLSSWriter.WriteStyleNumberFormat(ANode: TdxXMLNode;
AStyle: TdxSpreadSheetFormatHandle);
var
  APredefinedFormat: TdxSpreadSheetFormatHandle;
begin
  APredefinedFormat := SpreadSheet.CellStyles.Formats.PredefinedFormats.
    GetFormatHandleByID(AStyle.FormatCodeID);
...
procedure TdxSpreadSheetXMLSSWriter.WriteView(AParentNode: TdxXMLNode;
AView: TdxSpreadSheetTableView; const AArea: TRect);
var
  ANode: TdxXMLNode;
begin
  ...
  ANode.Attributes.Add(sXMLSSAttrDefaultColumnWidth,
    ConvertSize(AView.Columns.DefaultSize));
  ANode.Attributes.Add(sXMLSSAttrDefaultRowHeight,
    ConvertSize(AView.Rows.DefaultSize));
...
begin
  ...
  begin
    ...
    if AView is TdxSpreadSheetTableView then
      WriteView(AParentNode, TdxSpreadSheetTableView(AView),
        TdxSpreadSheetTableView(AView).Dimensions);
  end;
end;
...
begin
  Result := '#' + TdxColorHelper.AlphaColorToHexCode
    (dxColorToAlphaColor(AValue), False, False);
end;
