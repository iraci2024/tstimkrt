...
{$IFDEF DELPHI16}
  UITypes,
{$ENDIF}
  Types, Windows, Graphics, dxRibbonSkins, dxRibbonSkins2013, dxRibbonSkins2016,
  cxLookAndFeelPainters, dxCoreGraphics,
  dxGDIPlusClasses;
...
type
  ...
  protected
    ...
    function DoGetPartColor(APart: Integer; AState: Integer = 0)
      : TColor; override;
    function GetFormBorderIconBackgroundColor(AIcon: TdxRibbonBorderDrawIcon;
  ...
  public
    ...
    procedure DrawTabAreaButtonCore(DC: HDC; const R: TRect;
      AFrameColor, AContentColor: TdxAlphaColor);
  ...
  public
    ...
    function GetTabAreaBackgroundColor(AApplicationMenuState
      : TdxRibbonApplicationMenuState): TColor; override;
  ...
  public
    ...
    function GetGroupScrollButtonContentColor(AState: Integer): TColor;
      override;
...
uses
  dxCore, dxGDIPlusAPI, cxGraphics, dxBarSkinConsts, cxGeometry, Math, SysUtils,
  cxControls;
...
procedure TdxCustomRibbon2019Skin.AdjustApplicationButtonFont(AFont: TFont;
...
procedure TdxCustomRibbon2019Skin.DrawFormBorderIconBackground(DC: HDC;
...
procedure TdxCustomRibbon2019Skin.DrawBackstageViewBackButton(DC: HDC;
...
begin
  ...
  AGlyphRect := cxRectCenterVertically(R,
    ScaleFactor.Apply(BackstageViewBackButtonSize));
  AGlyphRect := cxRectSetWidth(AGlyphRect,
    ScaleFactor.Apply(BackstageViewBackButtonSize));
  ...
  cxRightToLeftDependentDraw(DC, AGlyphRect, UseRightToLeftAlignment, procedure
    begin
      FBackButton.StretchDraw(DC, AGlyphRect, MaxByte,
        TdxSimpleColorPalette.Create(dxColorToAlphaColor
        (GetBackstageViewBackButtonGlyphColor(AState)), TdxAlphaColors.Empty));
    end);
end;

procedure TdxCustomRibbon2019Skin.DrawBackstageViewGalleryItem(DC: HDC;
const R: TRect; AState: Integer);
begin
...
procedure TdxCustomRibbon2019Skin.DrawBackstageViewGallerySeparator(DC: HDC;
const R: TRect);
begin
  inherited DrawBackstageViewGallerySeparator(DC,
    cxRectInflate(R, 0, -BackstageViewGalleryItemIndent));
end;

function TdxCustomRibbon2019Skin.GetBackstageViewBackButtonGlyphColor
  (AState: Integer): TColor;
begin
  Result := clWhite;
end;

function TdxCustomRibbon2019Skin.CreateTabsAreaColorPalette
...
begin
  ...
  APalette.Add(DXBAR_DISABLED,
    TdxSimpleColorPalette.Create(dxColorToAlphaColor(AColor),
...
function TdxCustomRibbon2019Skin.GetFormCaptionAreaColor(AApplicationMenuState
...
procedure TdxCustomRibbon2019Skin.DrawMenuCheckMark(DC: HDC; const R: TRect;
AState: Integer);
begin
  InternalDrawGlyph(DC, R, FMenuCheckMark[AState],
    GetPartColor(DXBAR_MENUITEMTEXT), False);
end;

procedure TdxCustomRibbon2019Skin.DrawMinimizeRibbonButton(DC: HDC;
...
procedure TdxCustomRibbon2019Skin.DrawTab(DC: HDC; const R: TRect;
...
procedure TdxCustomRibbon2019Skin.DrawTabAreaButtonCore(DC: HDC; const R: TRect;
AFrameColor, AContentColor: TdxAlphaColor);
begin
  ...
  try
    ...
    try
      dxGPPaintCanvas.RoundRect(cxRectInflate(R, -1), AFrameColor,
        AContentColor, 1, 1);
    finally
...
procedure TdxCustomRibbon2019Skin.DrawTabAreaButtonDropButtonArrowPart(DC: HDC;
const R: TRect; AState: Integer);
var
  ASaveIndex: Integer;
begin
  ...
  try
    ...
    DrawTabAreaButton(DC, cxRectInflate(R, 1, 0, 0, 0),
...
procedure TdxCustomRibbon2019Skin.DrawTabAreaButtonDropButtonMainPart(DC: HDC;
const R: TRect; AState: Integer);
var
  ASaveIndex: Integer;
begin
  ...
  try
    IntersectClipRect(DC, R.Left, R.Top, R.Right, R.Bottom);
    DrawTabAreaButton(DC, cxRectInflate(R, 0, 0, 2, 0),
      RibbonStateToButtonState(AState));
  finally
    RestoreDC(DC, ASaveIndex);
  end;
...
procedure TdxCustomRibbon2019Skin.DrawTabSeparator(DC: HDC; const R: TRect;
Alpha: Byte);
begin
...
procedure TdxCustomRibbon2019Skin.AdjustContextTabFont(AFont: TFont;
...
procedure TdxCustomRibbon2019Skin.DrawContextTabBackground(DC: HDC;
const R: TRect; AState: TdxRibbonTabState; AContextColor: TColor);
begin
  DrawTab(DC, R, AState);
end;

procedure TdxCustomRibbon2019Skin.DrawGroupScrollButton(DC: HDC; const R: TRect;
...
procedure TdxCustomRibbon2019Skin.DrawTabGroupsArea(DC: HDC; const R: TRect;
...
procedure TdxCustomRibbon2019Skin.DrawTabGroupsAreaShadow(DC: HDC;
const R: TRect);
begin
...
procedure TdxCustomRibbon2019Skin.DrawSmallButton(DC: HDC; const R: TRect;
AState: Integer);
begin
  case AState of
...
procedure TdxCustomRibbon2019Skin.DrawQuickAccessToolbar(DC: HDC;
...
procedure TdxCustomRibbon2019Skin.DrawRibbonTopFrameAreaSeparator(DC: HDC;
const R: TRect);
var
  R1: TRect;
begin
...
begin
  case APart of
    ...
    DXBAR_GALLERYGROUPHEADERBACKGROUND,
      ...
      Result := TdxColorHelper.MultiplyLightness
        (GetPartColor(DXBAR_EDIT_BACKGROUND), 0.9);
  else
    Result := inherited;
  end;
end;
...
procedure TdxCustomColorfulRibbon2019Skin.DrawApplicationButton(DC: HDC;
const R: TRect; AState: TdxRibbonApplicationButtonState);
const
  StateMap: array [TdxRibbonApplicationButtonState] of TdxRibbonTabState =
    (rtsNormal, rtsActiveHot, rtsActiveHot);
begin
...
procedure TdxCustomColorfulRibbon2019Skin.DrawApplicationMenuBackground(DC: HDC;
...
begin
  ...
  FillRectByColor(DC, cxRectSetBottom(R, AContentRect.Top,
    AContentRect.Top - R.Top), GetFormCaptionAreaColor);
  DrawFrame(DC, R, clNone, GetFormBorderColor(True));
end;

procedure TdxCustomColorfulRibbon2019Skin.DrawSmallButtonDropButtonArrowPart
...
procedure TdxCustomColorfulRibbon2019Skin.DrawSmallButtonDropButtonMainPart
  (DC: HDC; const R: TRect; AState: Integer);
begin
  case AState of
    DXBAR_ACTIVE, DXBAR_ACTIVEDISABLED:
...
procedure TdxCustomColorfulRibbon2019Skin.AdjustContextFont(AFont: TFont;
AUseGlass: Boolean; AContextColor: TColor);
begin
  AFont.Color := GetPartColor(rspFormCaptionText, DXBAR_NORMAL);
end;

procedure TdxCustomColorfulRibbon2019Skin.AdjustContextTabFont(AFont: TFont;
AState: Integer; AContextColor: TColor);
begin
  AdjustTabFont(AFont, AState);
...
procedure TdxCustomColorfulRibbon2019Skin.DrawBackstageViewGalleryBackground
  (DC: HDC; const R: TRect);
begin
  FillRectByColor(DC, R, GetPartColor(DXBAR_BACKSTAGEVIEW_GALLERYCONTROL));
end;

procedure TdxCustomColorfulRibbon2019Skin.DrawBackstageViewGalleryItemPinButton
  (DC: HDC; const R: TRect; AState: Integer);
begin
  case AState of
    DXBAR_CHECKED:
...
procedure TdxCustomColorfulRibbon2019Skin.DrawQuickAccessToolbarMark(DC: HDC;
const R: TRect; AState: Integer; AStatesArray: TStatesArray);
begin
  InternalDrawGlyph(DC, R, AStatesArray[AState],
    GetQuickAccessToolbarMarkColor(AState));
end;
...
procedure TdxCustomColorfulRibbon2019Skin.DrawQuickAccessToolbarPopup(DC: HDC;
const R: TRect);
begin
  DrawFrame(DC, R, GetTabGroupsAreaContentColor, $777777);
end;

procedure TdxCustomColorfulRibbon2019Skin.DrawQuickAccessToolbarSmallButton
  (DC: HDC; const R: TRect; AState: Integer);
begin
...
procedure TdxCustomColorfulRibbon2019Skin.
...
procedure TdxCustomColorfulRibbon2019Skin.DrawStatusBar(DC: HDC;
const R: TRect);
begin
  FillRectByColor(DC, R, GetTabGroupsAreaContentColor);
end;

function TdxCustomColorfulRibbon2019Skin.GetQuickAccessToolbarMarkColor
  (AState: Integer): Integer;
begin
  case AState of
    DXBAR_HOT, DXBAR_ACTIVE, DXBAR_PRESSED, DXBAR_DROPPEDDOWN, DXBAR_CHECKED,
      DXBAR_HOTCHECK:
      Result := $FFFFFF;
  else
    Result := $EFEFEF;
...
function TdxCustomColorfulRibbon2019Skin.DoGetPartColor(APart,
  AState: Integer): TColor;
const
  StateMap: array [Boolean] of TdxRibbonBorderIconState = (rbisInactive,
    rbisNormal);
begin
  case APart of
    DXBAR_MENUEXTRAPANE:
    ...
    DXBAR_BACKSTAGEVIEW, DXBAR_BACKSTAGEVIEW_GALLERYCONTROL:
      Result := GetTabGroupsAreaContentColor;
    DXBAR_GALLERYFILTERBANDTEXT, DXBAR_GALLERYGROUPHEADERTEXT,
    ...
    rspDocumentNameText, rspFormCaptionText:
      Result := GetFormBorderIconGlyphColor(rbdiHelp,
        StateMap[AState = DXBAR_NORMAL]);
...
function TdxCustomColorfulRibbon2019Skin.GetTabAreaBackgroundColor
  (AApplicationMenuState: TdxRibbonApplicationMenuState): TColor;
begin
  Result := GetTabGroupsAreaContentColor;
end;

function TdxCustomColorfulRibbon2019Skin.GetColorfulButtonColor
  (AState: Integer): TColor;
begin
  case AState of
...
function TdxCustomColorfulRibbon2019Skin.GetFormBorderColor
  (AActive: Boolean): TColor;
begin
  if AActive then
    Result := GetMasterDarkColor
  else
...
begin
  ...
  FHighlightContentColor := TdxColorSpaceConverter.HSLToColor(AValue.H,
    AValue.S, Max(AValue.L - 0.14, 0));
  FHighlightBorderColor := TdxColorSpaceConverter.HSLToColor(AValue.H, AValue.S,
    Max(AValue.L - 0.25, 0));
end;

{ TdxCustomGrayScaleRibbon2019Skin }

procedure TdxCustomGrayScaleRibbon2019Skin.DrawBackstageViewTabButton(DC: HDC;
const R: TRect; AState: Integer);
begin
  case AState of
...
procedure TdxCustomGrayScaleRibbon2019Skin.DrawContextBackground(DC: HDC;
...
procedure TdxCustomGrayScaleRibbon2019Skin.DrawTab(DC: HDC; const R: TRect;
AState: TdxRibbonTabState);
begin
  case AState of
    rtsActiveHot, rtsFocused, rtsHot:
      FillRectByColor(DC, R, TdxColorHelper.ChangeLightness
        (GetTabGroupsAreaContentColor, 0.05));
  end;
end;

procedure TdxCustomGrayScaleRibbon2019Skin.DrawTabAreaButton(DC: HDC;
...
begin
  ...
  DrawTabAreaButtonCore(DC, R,
    ...
    ), dxColorToAlphaColor(TdxColorHelper.ChangeLightness(AColor,
    Map[AState])));
end;
...
function TdxCustomGrayScaleRibbon2019Skin.GetScrollBarPartBorderColor
  (APart: TcxScrollBarPart; AState: Integer): TColor;
begin
  Result := GetMasterDarkColor;
end;

function TdxCustomGrayScaleRibbon2019Skin.GetScrollBarPartContentColor
  (APart: TcxScrollBarPart; AState: Integer): TColor;
var
  ADelta: Single;
begin
...
function TdxCustomGrayScaleRibbon2019Skin.CreateTabsAreaColorPalette
  : IdxRibbonSkinColorPaletteSet;
var
  APalette: TdxRibbonSkinColorPaletteSet;
begin
  APalette := TdxRibbonSkinColorPaletteSet.Create;
  APalette.Add(DXBAR_NORMAL, TdxSimpleColorPalette.Create
    (dxColorToAlphaColor(GetPartColor(rtatpEditText, DXBAR_NORMAL)),
    TdxAlphaColors.Empty));
  APalette.Add(DXBAR_DISABLED,
    TdxSimpleColorPalette.Create(dxColorToAlphaColor(GetPartColor(rtatpEditText,
    DXBAR_DISABLED)), TdxAlphaColors.Empty));
  Result := APalette;
end;

function TdxCustomGrayScaleRibbon2019Skin.DoGetPartColor(APart,
  AState: Integer): TColor;
begin
  case APart of
    DXBAR_BACKSTAGEVIEW_GALLERYCONTROL_GROUPHEADER:
...
begin
  if AState = rbisInactive then
    Result := TdxColorSpaceConverter.HSLToColor
      (TdxColorSpaceConverter.ColorToHSL(GetFormCaptionAreaColor).H, 0, 0.8)
  else
    Result := clWhite;
end;
...
function TdxColorfulRibbon2019Skin.GetFormBorderIconGlyphColor
  (AIcon: TdxRibbonBorderDrawIcon; AState: TdxRibbonBorderIconState): TColor;
begin
  if (PaintData.GetApplicationMenuState = ramsShownAsFullScreenFrame) and
    (AState in [rbisNormal, rbisInactive]) then
    Result := inherited
  else if AState = rbisInactive then
    Result := TdxColorSpaceConverter.HSLToColor
      (TdxColorSpaceConverter.ColorToHSL(GetFormCaptionAreaColor).H, 0, 0.8)
  else
    Result := clWhite;
...
function TdxColorfulRibbon2019Skin.GetFormCaptionAreaColor(AApplicationMenuState
  : TdxRibbonApplicationMenuState; AActive: Boolean): TColor;
begin
  if AApplicationMenuState = ramsShownAsFullScreenFrame then
    Result := GetPartColor(DXBAR_BACKSTAGEVIEW)
...
function TdxColorfulRibbon2019Skin.DoGetPartColor(APart,
  AState: Integer): TColor;
begin
  case APart of
    DXBAR_BACKSTAGEVIEW_GALLERYCONTROL_SEPARATOR:
...
procedure TdxColorfulRibbon2019Skin.DrawBackstageViewTabButton(DC: HDC;
const R: TRect; AState: Integer);
begin
  case AState of
    DXBAR_PRESSED, DXBAR_HOT, DXBAR_HOTCHECK, DXBAR_ACTIVE,
...
procedure TdxColorfulRibbon2019Skin.DrawContextBackground(DC: HDC;
const R: TRect; AContextColor: TColor);
var
  R1: TRect;
begin
...
procedure TdxColorfulRibbon2019Skin.DrawTabAreaButton(DC: HDC; const R: TRect;
...
begin
  ...
  DrawTabAreaButtonCore(DC, R, dxColorToAlphaColor(GetTabSeparatorColor),
    dxColorToAlphaColor(AContentColor));
end;
...
function TdxColorfulRibbon2019Skin.GetGroupScrollButtonBorderColor
  (AState: Integer): TColor;
begin
  case AState of
...
function TdxColorfulRibbon2019Skin.GetGroupScrollButtonContentColor
  (AState: Integer): TColor;
begin
  if AState = DXBAR_PRESSED then
    Result := $F3F3F3
...
procedure TdxBlackRibbon2019Skin.DrawCollapsedToolbarBackground(DC: HDC;
const R: TRect; AState: Integer);
begin
  case AState of
    DXBAR_PRESSED, DXBAR_HOT:
...
procedure TdxBlackRibbon2019Skin.DrawCollapsedToolbarGlyphBackground(DC: HDC;
const R: TRect; AState: Integer);
begin
  DrawFrame(DC, R, $1E1E1E, $686868);
end;

procedure TdxBlackRibbon2019Skin.DrawTabGroupBackground(DC: HDC; const R: TRect;
...
procedure TdxBlackRibbon2019Skin.DrawTabGroupHeaderBackground(DC: HDC;
...
procedure TdxBlackRibbon2019Skin.DrawSeparatorBackground(DC: HDC;
const R: TRect);
begin
...
function TdxBlackRibbon2019Skin.GetLaunchButtonDefaultGlyphColor
  (AState: Integer): TColor;
begin
  Result := clWhite;
end;
...
function TdxBlackRibbon2019Skin.GetMinimizeRibbonButtonGlyphColor
  (AState: Integer): TColor;
begin
  Result := clWhite;
end;
...
procedure TdxDarkGrayRibbon2019Skin.DrawCollapsedToolbarBackground(DC: HDC;
const R: TRect; AState: Integer);
begin
  case AState of
    DXBAR_PRESSED, DXBAR_HOT:
...
procedure TdxDarkGrayRibbon2019Skin.DrawQuickAccessToolbarPopup(DC: HDC;
const R: TRect);
begin
  DrawFrame(DC, R, clWhite, $777777);
end;

function TdxDarkGrayRibbon2019Skin.DoGetPartColor(APart,
  AState: Integer): TColor;
begin
  case APart of
    DXBAR_BACKSTAGEVIEW_GALLERYCONTROL_SEPARATOR:
...
function TdxWhiteRibbon2019Skin.GetScrollBarPartBorderColor
  (APart: TcxScrollBarPart; AState: Integer): TColor;
begin
...
function TdxWhiteRibbon2019Skin.GetScrollBarPartContentColor
  (APart: TcxScrollBarPart; AState: Integer): TColor;
begin
  Result := clWhite;
  case AState of
...
procedure TdxWhiteRibbon2019Skin.DrawTabAreaButton(DC: HDC; const R: TRect;
AState: TcxButtonState);
var
  AAccentColor: TColor;
...
begin
  ...
  DrawTabAreaButtonCore(DC, R, dxColorToAlphaColor(ABorderColor, 96),
    AContentColor);
end;
