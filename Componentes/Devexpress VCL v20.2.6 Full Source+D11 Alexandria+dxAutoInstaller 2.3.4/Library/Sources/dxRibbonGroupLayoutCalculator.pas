...
type
  ...
  strict private
    ...
    procedure AlignOneRowHeightItemControl(AItemControlViewInfo
      : IdxBarItemControlViewInfo; AColumnWidth: Integer);
    procedure AlignOneRowHeightItemControls(AGroupViewInfo
      : IdxRibbonGroupViewInfo; AFirstIndex, AColumnWidth: Integer);
    procedure CheckDistanceBetweenTwoLastColumns(AGroupViewInfo
      : IdxRibbonGroupViewInfo; ALastItemControlIndex: Integer);
    ...
    procedure PlaceOneRowHeightItemControls(AGroupViewInfo
      : IdxRibbonGroupViewInfo; AFirstIndex, ALastIndex: Integer;
      ADistributeOnGroupHeight: Boolean);
    procedure PlaceSeparator(AGroupViewInfo: IdxRibbonGroupViewInfo;
      AItemControlIndex: Integer);
    procedure PlaceWholeGroupHeightItemControl(AGroupViewInfo
      : IdxRibbonGroupViewInfo; AIndex: Integer);
    function ReduceOneRowHeightItemControlsWithText(AGroupViewInfo
      : IdxRibbonGroupViewInfo;
      AUpToViewLevel: TdxBarItemRealViewLevel): Boolean;
    function TryReduceToSmallIconWithText
      (ASequence: TSequenceForWholeGroupHeightReducing): Boolean;
    function ReduceToSmallIconWithText(AGroupViewInfo
      : IdxRibbonGroupViewInfo): Boolean;
    function ReduceToLargeControlOnly(AGroupViewInfo
      : IdxRibbonGroupViewInfo): Boolean;
  protected
...
function GetItemControlCurrentWidth(AItemControlViewInfo
  : IdxBarItemControlViewInfo): Integer; forward;
function IsNewColumnItemControl(AItemControlViewInfo: IdxBarItemControlViewInfo)
...
function IsPartOfHorizontalBox(AGroupViewInfo: IdxRibbonGroupViewInfo;
  AItemControlIndex: Integer; ACanBeginHorizontalBox: Boolean)
  : Boolean; forward;
function IsWholeGroupHeightItemControl(AItemControlViewInfo
  : IdxBarItemControlViewInfo): Boolean; overload; forward;
function IsWholeGroupHeightItemControl(AGroupViewInfo: IdxRibbonGroupViewInfo;
  AItemControlIndex: Integer): Boolean; overload; forward;
function IsWholeGroupHeightOnlyItemControl(AItemControlViewInfo
  : IdxBarItemControlViewInfo): Boolean; overload; forward;
function IsWholeGroupHeightOnlyItemControl(AGroupViewInfo
  : IdxRibbonGroupViewInfo; AItemControlIndex: Integer): Boolean;
  overload; forward;
...
procedure CalcItemControlsRealPositionInButtonGroup
  ...
  function GetItemControlViewInfo(AItemControlIndex: Integer)
    : IdxBarItemControlViewInfo;
  begin
    Result := IdxBarItemControlViewInfo
      (AItemControlViewInfos[AItemControlIndex]);
  end;

  function GetItemControlPositionInButtonGroup(AItemControlViewInfo
    : IdxBarItemControlViewInfo): TdxBarButtonGroupPosition;
  begin
  ...
  function NextItemControlIsMemberOfButtonGroup(AItemControlIndex
    : Integer): Boolean;
  var
  ...
  begin
    ...
    begin
      ...
      Result := (GetItemControlPositionInButtonGroup(AItemControlViewInfo)
        = bgpMember) and not AItemControlViewInfo.HasSeparator;
    end;
  end;

  function GetItemControlRealPositionInButtonGroup(AItemControlIndex: Integer)
    : TdxBarButtonGroupRealPosition;
  var
    AItemControlViewInfo: IdxBarItemControlViewInfo;
  begin
    case GetItemControlPositionInButtonGroup
      (GetItemControlViewInfo(AItemControlIndex)) of
      bgpStart:
      ...
      bgpMember:
        begin
          ...
          begin
            AItemControlViewInfo := GetItemControlViewInfo
              (AItemControlIndex - 1);
            if AItemControlViewInfo.GetRealPositionInButtonGroup
              in [bgrpStart, bgrpMember] then
            begin
              if NextItemControlIsMemberOfButtonGroup(AItemControlIndex) then
                Result := bgrpMember
              else
...
function GetItemControlCurrentWidth(AItemControlViewInfo
  : IdxBarItemControlViewInfo): Integer;
begin
...
begin
  Result := AItemControlViewInfo.HasSeparator or
    ...
    (AItemControlViewInfo.GetRealPositionInButtonGroup in [bgrpNone, bgrpStart,
    bgrpSingle]);
end;
...
begin
  Result := IsNewColumnItemControl(AGroupViewInfo.GetItemControlViewInfo
    (AItemControlIndex));
end;
...
begin
  ARealPositionInButtonGroup := AGroupViewInfo.GetItemControlViewInfo
  ...
  Result := False;
  if ACanBeginHorizontalBox and
    (AItemControlIndex + 1 < AGroupViewInfo.GetItemControlCount) then
  begin
    AItemControlViewInfo := AGroupViewInfo.GetItemControlViewInfo
      (AItemControlIndex + 1);
  ...
  begin
    ...
    Result := (AItemControlViewInfo.GetPosition = ipContinuesRow) and
      ...
      (AItemControlViewInfo);
  end;
end;

function IsWholeGroupHeightItemControl(AItemControlViewInfo
  : IdxBarItemControlViewInfo): Boolean; overload;
var
  AMultiColumnItemControlViewInfo: IdxBarMultiColumnItemControlViewInfo;
begin
  Result := AItemControlViewInfo.IsMultiColumnItemControl(True,
    AMultiColumnItemControlViewInfo) or
    (AItemControlViewInfo.GetViewLevel in [ivlLargeIconWithText,
    ivlLargeControlOnly]);
end;
...
function IsWholeGroupHeightOnlyItemControl(AGroupViewInfo
  : IdxRibbonGroupViewInfo; AItemControlIndex: Integer): Boolean; overload;
begin
  Result := IsWholeGroupHeightOnlyItemControl
    (AGroupViewInfo.GetItemControlViewInfo(AItemControlIndex));
end;

{ TSequenceForWholeGroupHeightReducing }

function TSequenceForWholeGroupHeightReducing.GetItem(Index: Integer)
  : TRLCItemControlInfo;
begin
...
constructor TdxRibbonGroupLayoutCalculator.Create(AGroupRowHeight,
  AGroupRowCount: Integer; AScaleFactor: TdxScaleFactor);
begin
  inherited Create;
...
// IdxRibbonGroupLayoutCalculator
procedure TdxRibbonGroupLayoutCalculator.CalcInit(AGroupViewInfo
  : IdxRibbonGroupViewInfo);
var
  AItemControlViewInfo: IdxBarItemControlViewInfo;
  AItemControlViewInfos: TList;
  ...
  try
    for I := 0 to AGroupViewInfo.GetItemControlCount - 1 do
      AItemControlViewInfos.Add
        (Pointer(AGroupViewInfo.GetItemControlViewInfo(I)));
  ...
  begin
    ...
    if AItemControlViewInfo.GetRealPositionInButtonGroup = bgrpNone then
      AItemControlViewInfo.SetViewLevel
        (GetMaxViewLevel(AItemControlViewInfo.GetAllowedViewLevels))
    else
      AItemControlViewInfo.SetViewLevel
        (AItemControlViewInfo.GetViewLevelForButtonGroup);
    if AItemControlViewInfo.IsMultiColumnItemControl(False,
      AMultiColumnItemControlViewInfo) then
    begin
      AMultiColumnItemControlViewInfo.SetCollapsed(False);
      AMultiColumnItemControlViewInfo.SetColumnCount
        (AMultiColumnItemControlViewInfo.GetMaxColumnCount);
    end;
  end;
end;

procedure TdxRibbonGroupLayoutCalculator.CalcLayout(AGroupViewInfo
  : IdxRibbonGroupViewInfo);
...
begin
  ...
  begin
    ...
    begin
      ...
      if IsWholeGroupHeightItemControl(AItemControlViewInfo) or (J > I) and
        IsNewColumnItemControl(AItemControlViewInfo) then
        Break;
      Inc(J);
    end;
    if I < J then
  ...
  CheckDistanceBetweenTwoLastColumns(AGroupViewInfo,
    AGroupViewInfo.GetItemControlCount - 1);
...
begin
  ...
  begin
    AItemControlViewInfo := AGroupViewInfo.GetItemControlViewInfo(I);
    if AItemControlViewInfo.IsMultiColumnItemControl(True,
      AMultiColumnItemControlViewInfo) and AMultiColumnItemControlViewInfo.CanCollapse
    then
    begin
      Result := True;
...
function TdxRibbonGroupLayoutCalculator.
  DecreaseMultiColumnItemControlsColumnCount(AGroupViewInfo
  : IdxRibbonGroupViewInfo): Boolean;
var
  AItemControlViewInfo: IdxBarItemControlViewInfo;
  AMultiColumnItemControlViewInfo: IdxBarMultiColumnItemControlViewInfo;
...
begin
  ...
  begin
    AItemControlViewInfo := AGroupViewInfo.GetItemControlViewInfo(I);
    if AItemControlViewInfo.IsMultiColumnItemControl(True,
      AMultiColumnItemControlViewInfo) and
      (AMultiColumnItemControlViewInfo.GetColumnCount >
      AMultiColumnItemControlViewInfo.GetMinColumnCount) then
    begin
      Result := True;
      AMultiColumnItemControlViewInfo.SetColumnCount
        (AMultiColumnItemControlViewInfo.GetColumnCount - 1);
      Break;
    end;
  end;
  if Result then
...
function TdxRibbonGroupLayoutCalculator.Reduce(AGroupViewInfo
  : IdxRibbonGroupViewInfo; AUpToViewLevel: TdxBarItemRealViewLevel): Boolean;
begin
  if AGroupViewInfo.GetItemControlCount = 0 then
    Result := False
  else
  begin
    ...
    else if AUpToViewLevel = ivlSmallIconWithText then
      Result := ReduceToSmallIconWithText(AGroupViewInfo)
    else
    begin
      Result := ReduceOneRowHeightItemControlsWithText(AGroupViewInfo,
        AUpToViewLevel);
      if not Result then
        FItemControlIndexForOneRowHeightReducing :=
          AGroupViewInfo.GetItemControlCount - 1;
    end;
  end;
end;

procedure TdxRibbonGroupLayoutCalculator.ReduceInit(AGroupViewInfo
  : IdxRibbonGroupViewInfo);

  procedure AddElementToSequence(ASequence
    : TSequenceForWholeGroupHeightReducing; AIndex, AOneRowItemCount: Integer);
  var
  ...
  begin
    Result := IsWholeGroupHeightOnlyItemControl(AGroupViewInfo, AIndex) or
      IsNewColumnItemControl(AGroupViewInfo, AIndex) or
      (IsPartOfHorizontalBox(AGroupViewInfo, AIndex, True) or
      IsPartOfHorizontalBox(AGroupViewInfo, AIndex, False)) and
      IsWholeGroupHeightItemControl(AGroupViewInfo, AIndex);
  end;
...
begin
  ...
  begin
    if SkipRowWithSeveralItemControls then // TODO by first ItemControl
      Continue;
    AlignOneRowHeightItemControl(AGroupViewInfo.GetItemControlViewInfo
      (AFirstIndex), AColumnWidth);
    Inc(AFirstIndex);
  end;
end;
...
procedure TdxRibbonGroupLayoutCalculator.CheckDistanceBetweenTwoLastColumns
  ...
  function GetColumnFirstItemControlIndex(AColumnLastItemControlIndex
    : Integer): Integer;
  var
    AColumn: Integer;
  begin
  ...
  procedure GetMaxBoundInfoForItemControls(AFirstItemControlIndex,
    ALastItemControlIndex: Integer;
  ...
  begin
    ...
    begin
      ...
      if AItemControlViewInfo.GetRealPositionInButtonGroup
        in [bgrpFinish, bgrpSingle] then
        AMaxButtonGroupRightBound := Max(AMaxButtonGroupRightBound, R.Right);
    end;
  end;

  procedure GetMinBoundInfoForItemControls(AFirstItemControlIndex,
    ALastItemControlIndex: Integer; out AMinLeftBound, AMinButtonGroupLeftBound
    : Integer);
  var
    AItemControlViewInfo: IdxBarItemControlViewInfo;
    I: Integer;
  begin
    AMinLeftBound := AGroupViewInfo.GetItemControlViewInfo
      (AFirstItemControlIndex).GetBounds.Left;
    AMinButtonGroupLeftBound := cxMaxRectSize;
    for I := AFirstItemControlIndex to ALastItemControlIndex do
    begin
      AItemControlViewInfo := AGroupViewInfo.GetItemControlViewInfo(I);
      if AItemControlViewInfo.GetRealPositionInButtonGroup
        in [bgrpStart, bgrpSingle] then
...
var
  ...
  ASecondColumnFirstItemControlIndex, ASecondColumnLastItemControlIndex
    : Integer;
  AFirstColumnMaxItemControlRightBound,
    AFirstColumnMaxButtonGroupRightBound: Integer;
  ASecondColumnMinItemControlLeftBound,
    ASecondColumnMinButtonGroupLeftBound: Integer;
...
begin
  ...
  if AGroupViewInfo.GetItemControlViewInfo(ASecondColumnFirstItemControlIndex).HasSeparator
  then
    Exit;
  ...
  GetMaxBoundInfoForItemControls(AFirstColumnFirstItemControlIndex,
    AFirstColumnLastItemControlIndex, AFirstColumnMaxItemControlRightBound,
    AFirstColumnMaxButtonGroupRightBound);
  GetMinBoundInfoForItemControls(ASecondColumnFirstItemControlIndex,
    ASecondColumnLastItemControlIndex, ASecondColumnMinItemControlLeftBound,
  ...
  if (AFirstColumnMaxButtonGroupRightBound <> -1) and
    (ASecondColumnMinItemControlLeftBound - AFirstColumnMaxButtonGroupRightBound
    < AButtonGroupOffset) then
    AOffset1 := AButtonGroupOffset - (ASecondColumnMinItemControlLeftBound -
      AFirstColumnMaxButtonGroupRightBound);
  AOffset2 := 0;
  if (ASecondColumnMinButtonGroupLeftBound <> cxMaxRectSize) and
    (ASecondColumnMinButtonGroupLeftBound - AFirstColumnMaxItemControlRightBound
    < AButtonGroupOffset) then
    AOffset2 := AButtonGroupOffset - (ASecondColumnMinButtonGroupLeftBound -
      AFirstColumnMaxItemControlRightBound);
  AOffset := Max(AOffset1, AOffset2);
  if AOffset <> 0 then
  begin
    OffsetContent(AGroupViewInfo, ASecondColumnFirstItemControlIndex,
      ASecondColumnLastItemControlIndex, AOffset);
    Inc(X, AOffset);
  end;
end;

procedure TdxRibbonGroupLayoutCalculator.
  DistributeOneRowHeightItemControlsOnGroupHeight(AGroupViewInfo
  : IdxRibbonGroupViewInfo; AFirstIndex, ALastIndex: Integer);
var
...
begin
  ...
  if ARowCount < GroupRowCount then
    ...
    begin
      AItemControlViewInfo := AGroupViewInfo.GetItemControlViewInfo(I);
      R := AItemControlViewInfo.GetBounds;
      R.Top := GetGroupHeight - ((GetGroupHeight - GroupRowHeight * ARowCount)
        div (ARowCount + 1) + GroupRowHeight) *
        (ARowCount - AGroupViewInfo.GetItemControlViewInfo(I).GetRow);
  ...
  if AIndex <= ALastIndex then
    DistributeOneRowHeightItemControlsOnGroupHeight(AGroupViewInfo, AIndex,
      ALastIndex);
end;
...
procedure TdxRibbonGroupLayoutCalculator.OffsetContent(AGroupViewInfo
  : IdxRibbonGroupViewInfo; AFirstItemControlIndex, ALastItemControlIndex,
  AOffset: Integer);
var
  AItemControlViewInfo: IdxBarItemControlViewInfo;
...
begin
  ...
  begin
    ...
    begin
      ASeparatorInfo := AGroupViewInfo.GetSeparatorInfo
        (FItemControlSeparators[I]);
      OffsetRect(ASeparatorInfo.Bounds, AOffset, 0);
      AGroupViewInfo.SetSeparatorInfo(FItemControlSeparators[I],
        ASeparatorInfo);
    end;
  end;
end;
...
var
  AItemControlViewInfo: IdxBarItemControlViewInfo;
  AColumnFirstItemControlIndex, AItemControlWidth, AMaxRowX, ARow, ARowX,
    I: Integer;
...
begin
  ...
  begin
    ...
    if I > AFirstIndex then
      if (AItemControlViewInfo.GetPosition = ipBeginsNewRow) and
        (AItemControlViewInfo.GetRealPositionInButtonGroup in [bgrpNone,
        bgrpStart, bgrpSingle]) then
      begin
        Inc(ARow);
        ...
        begin
          AlignOneRowHeightItemControls(AGroupViewInfo,
            AColumnFirstItemControlIndex, AMaxRowX - X);
    ...
    if not(AItemControlViewInfo.GetRealPositionInButtonGroup in [bgrpMember,
      bgrpFinish]) and (I > AFirstIndex) and
      (FItemControlColumns[I - 1] = FItemControlColumns[I]) and
      (AGroupViewInfo.GetItemControlViewInfo(I - 1).GetRow = ARow) then
    begin
      if (AItemControlViewInfo.GetRealPositionInButtonGroup in [bgrpStart,
        bgrpSingle]) or
        (AItemControlViewInfo.GetRealPositionInButtonGroup = bgrpNone) and
        (AGroupViewInfo.GetItemControlViewInfo(I - 1)
        .GetRealPositionInButtonGroup in [bgrpFinish, bgrpSingle]) then
        Inc(ARowX, AGroupViewInfo.GetOffsetsInfo.ButtonGroupOffset);
    end;
    AItemControlViewInfo.SetBounds(Rect(ARowX, ARow * GroupRowHeight,
      ARowX + AItemControlWidth, (ARow + 1) * GroupRowHeight));
    Inc(ARowX, AItemControlWidth);
    if ARowX > AMaxRowX then
      AMaxRowX := ARowX;
  end;
  AlignOneRowHeightItemControls(AGroupViewInfo, AColumnFirstItemControlIndex,
    AMaxRowX - X);
  X := AMaxRowX;
  ...
  ADistributeOnGroupHeight := AGroupViewInfo.GetItemControlViewInfo
    (ADistributedControlIndex).GetDistributed;
  for I := AFirstIndex to ALastIndex do
    AGroupViewInfo.GetItemControlViewInfo(I)
      .SetDistributed(ADistributeOnGroupHeight);
  if ADistributeOnGroupHeight then
    DistributeOneRowHeightItemControlsOnGroupHeight(AGroupViewInfo, AFirstIndex,
      ALastIndex);
end;

procedure TdxRibbonGroupLayoutCalculator.PlaceSeparator(AGroupViewInfo
  : IdxRibbonGroupViewInfo; AItemControlIndex: Integer);
var
  ASeparatorInfo: TdxBarItemSeparatorInfo;
begin
  ASeparatorInfo.Bounds := Rect(X, dxRibbonItemSeparatorTopOffset,
    X + dxRibbonItemSeparatorAreaWidth, GetGroupHeight -
    dxRibbonItemSeparatorBottomOffset);
  ASeparatorInfo.Kind := skVertical;
  AGroupViewInfo.AddSeparator(ASeparatorInfo);
  Inc(X, dxRibbonItemSeparatorAreaWidth);
  FItemControlSeparators[AItemControlIndex] :=
    AGroupViewInfo.GetSeparatorCount - 1;
end;
...
begin
  ...
  AItemControlWidth := GetItemControlCurrentWidth(AItemControlViewInfo);
  AItemControlViewInfo.SetBounds(Rect(X, 0, X + AItemControlWidth,
    GetGroupHeight));
...
var
  ...
  AColumnWidthAfterReducing, AColumnWidthBeforeReducing, ARowWidthAfterReducing,
    ARowWidthBeforeReducing: Integer;
  AItemControlsToBeReduced: TInterfaceList;
  AItemControlViewInfo: IdxBarItemControlViewInfo;
begin
  Result := False;
  AIndex := FItemControlIndexForOneRowHeightReducing;
  while (AIndex >= 0) and IsWholeGroupHeightItemControl(AGroupViewInfo,
    AIndex) do
    Dec(AIndex);
  ...
  try
    ...
    begin
      ...
      begin
        AItemControlViewInfo := AGroupViewInfo.GetItemControlViewInfo(AIndex);
        ARowWidthBeforeReducing := GetItemControlCurrentWidth
          (AItemControlViewInfo);
        ...
        begin
          AItemControlViewInfo := AGroupViewInfo.GetItemControlViewInfo(AIndex);
          Inc(ARowWidthBeforeReducing,
            GetItemControlCurrentWidth(AItemControlViewInfo));
          Dec(AIndex);
        end;
      ...
      begin
        ...
        begin
          ARowWidthAfterReducing := AItemControlViewInfo.GetWidth
            (AUpToViewLevel);
    ...
    begin
      AItemControlViewInfo := IdxBarItemControlViewInfo
        (AItemControlsToBeReduced[I]);
      if (AItemControlViewInfo.GetWidth(AUpToViewLevel) <
        AColumnWidthBeforeReducing) and
        (GetItemControlCurrentWidth(AItemControlViewInfo) >
        AColumnWidthAfterReducing) then
      begin
...
function TdxRibbonGroupLayoutCalculator.TryReduceToSmallIconWithText
  ...
  begin
    Result := (GroupRowCount - AOneRowItemCount mod GroupRowCount)
      mod GroupRowCount;
  end;
  ...
  begin
    if (AItem.OneRowItemsBefore = 0) and
      (ASequence[ASequence.Count - 1].ViewInfo = AItem.ViewInfo) and
      (ASequence.Count > 1) then
      Result := True
    else
    begin
      AFreeCellCountBeforeReducing := GetFreeCellCount(AItem.OneRowItemsBefore)
        + GetFreeCellCount(AItem.OneRowItemsAfter);
      AFreeCellCountAfterReducing :=
        GetFreeCellCount(AItem.OneRowItemsBefore + 1 + AItem.OneRowItemsAfter);
      Result := AFreeCellCountAfterReducing <= AFreeCellCountBeforeReducing;
    end;
  end;

  procedure SetNextViewLevel(AItemControlViewInfo: IdxBarItemControlViewInfo;
    ALevel: TdxBarItemRealViewLevel);
  begin
    AItemControlViewInfo.SetViewLevel
      (GetNextViewLevel(AItemControlViewInfo.GetAllowedViewLevels, ALevel));
  end;
...
begin
  ...
  begin
    ...
    while (AIndex >= 0) and (APrevOneRowItemsAfter = 0) and
      CanCollapse(ASequence[AIndex]) do
    begin
      Result := True;
      ...
      begin
        ...
        Inc(ASequence[AIndex - 1].OneRowItemsAfter,
          ASequence[AIndex].OneRowItemsAfter + 1);
      end;
      Dec(AIndex);
    end;
...
begin
  ...
  begin
    Result := TryReduceToSmallIconWithText
      (FReducingSequences[AIndex] as TSequenceForWholeGroupHeightReducing);
    if not Result then
    begin
...
begin
  ...
  begin
    ...
    Result := (AViewInfo.GetViewLevel = ivlLargeIconWithText) and
      (ivlLargeControlOnly in AViewInfo.GetAllowedViewLevels);
    if Result then
    begin
