...
procedure TdxOfficeSearchBoxSearchSourceProperty.CheckComponent
  (const Value: string);
var
...
begin
  ...
  RegisterPropertyEditor(TypeInfo(TComponent), TdxOfficeSearchBoxProperties,
    'SearchSource', TdxOfficeSearchBoxSearchSourceProperty);
end;
