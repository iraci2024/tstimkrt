...
uses
  ...
  cxLookAndFeels, cxLookAndFeelPainters, cxStyles, dxLayoutControlAdapters,
  dxLayoutContainer, cxSplitter, cxGridLevel,
  cxGrid, ExtCtrls, dxLayoutControl, cxGridCustomView, cxGridCardView,
  cxGridDBCardView, cxGridChartView,
  cxGridDBChartView, cxGridTableView, cxGridDBTableView, cxGridBandedTableView,
  cxGridDBBandedTableView,
  cxGridWizardCustomPage, cxGridWizardStrs, dxCustomWizardControl,
  cxGridWizardCustomHelper, dxLayoutLookAndFeels;
...
type
  ...
  TcxGridWizardCommonCustomizeItemsPageFrame = class
...
begin
  ...
  TcxCustomGridCustomizationControllerAccess
    (GridViewController.CustomizationController).DoCreateForm;
...
function TcxGridWizardCommonCustomizeItemsPageFrame.GetGridViewController
  : TcxCustomGridControllerAccess;
begin
...
procedure TcxGridWizardCommonCustomizeItemsPageFrame.
  SplitterCustomizeItemsPageMoved(Sender: TObject);
begin
  ApplySettings;
  LoadSettings;
  ShowCustomizationForm;
