...
{$ENDIF}
  ...
  dxBarPopupMenuEd, dxBarExtItems, cxClasses, dxRibbonForm, cxGeometry,
  dxRibbon,
  cxControls, cxLookAndFeels, cxGraphics, dxRibbonGallery, dxBkGnd,
  dxBarApplicationMenu, cxLookAndFeelPainters, dxRibbonSkins, dxGallery,
  cxImageList,
  cxDropDownEdit, cxSpinEdit, cxBarEditItem, cxEdit, cxEditRepositoryItems,
  dxPrnPg;
...
type
  ...
  TdxRibbonPrintPreviewForm = class(TdxRibbonForm, IdxPSPreviewWindowDialog)
    ...
    procedure PreviewAddExplorerCommand(Sender: TObject;
    ...
    procedure PreviewLoadProperties(Sender: TObject; AIniFile: TCustomIniFile;
      const ASectionName: string);
    procedure PreviewPreviewDblClick(Sender: TObject);
    procedure PreviewSaveProperties(Sender: TObject; AIniFile: TCustomIniFile;
      const ASectionName: string);
  ...
  private
    ...
    function GetExplorerContextCommand(Index: Integer)
    ...
    function EncodeFitToPageValue(AValue: Integer; AScaleMode: TdxScaleMode)
      : TcxEditValue;
  ...
  protected
    ...
    procedure AddExplorerContextCommand
      (ACommand: TCustomdxPSExplorerContextCommand); virtual;
    ...
    procedure LoadBarManager(AIniFile: TCustomIniFile;
      const ASectionName: string);
    procedure SaveBarManager(AIniFile: TCustomIniFile;
      const ASectionName: string);

    // IdxPSPreviewWindowDialog
    procedure Initialize;

    property ExplorerContextCommandCount: Integer
      read GetExplorerContextCommandCount;
    property ExplorerContextCommands[Index: Integer]
      : TCustomdxPSExplorerContextCommand read GetExplorerContextCommand;
    property ExplorerTree: TCustomdxPSExplorerTreeContainer
      read GetExplorerTree;
    property HeaderAndFooterContextVisible: Boolean
      read FHeaderAndFooterContextVisible;
...
uses
  Types, Registry, CommCtrl, Math, dxCustomPreview, dxPSRes, dxPSGlbl,
  dxPSPopupMan, dxPSImgs,
  dxPSUtl, dxPSPgsMnuBld, dxPSEngn, dxPgsDlg, dxPSEvnt, dxPSAutoHFTextMnuBld,
  dxPSfmAutoHFTextFmt, dxPrnDev, dxPSPDFExport, dxPSForm, dxDPIAwareUtils,
  dxPSPrVwRibbonStrs;
...
const
  ...
  dxPaletteColCount = 8;
  dxPaletteRowCount = 5;
  dxPaletteColors: array [0 .. dxPaletteColCount - 1, 0 .. dxPaletteRowCount -
    1] of TColor = (($00000000, $00000484, $000004FF, $00FF04FF, $00CE9EFF),
  ...
  dxPaletteColorHints: array [0 .. dxPaletteColCount - 1,
    0 .. dxPaletteRowCount - 1] of Pointer = ((@sdxColorBlack, @sdxColorDarkRed,
    @sdxColorRed, @sdxColorPink, @sdxColorRose),
    (@sdxColorBrown, @sdxColorOrange, @sdxColorLightOrange, @sdxColorGold,
    @sdxColorTan), (@sdxColorOliveGreen, @sdxColorDrakYellow, @sdxColorLime,
    @sdxColorYellow, @sdxColorLightYellow), (@sdxColorDarkGreen, @sdxColorGreen,
    @sdxColorSeaGreen, @sdxColorBrighthGreen, @sdxColorLightGreen),
    (@sdxColorDarkTeal, @sdxColorTeal, @sdxColorAqua, @sdxColorTurquoise,
    @sdxColorLightTurquoise), (@sdxColorDarkBlue, @sdxColorBlue,
    @sdxColorLightBlue, @sdxColorSkyBlue, @sdxColorPaleBlue),
    (@sdxColorIndigo, @sdxColorBlueGray, @sdxColorViolet, @sdxColorPlum,
    @sdxColorLavender), (@sdxColorGray80, @sdxColorGray50, @sdxColorGray40,
    @sdxColorGray25, @sdxColorWhite));
...
type
  ...
  protected
    function BuildPopup(const AControl: TControl; const APopupMenu: TPopupMenu)
      : TComponent; override;
    class function CanShowPopup(const APopupMenu: TPopupMenu): Boolean;
      override;
    procedure FreePopup(var APopupMenu: TComponent); override;
    procedure InvokePopup(X, Y: Integer; AControl: TControl;
      APopupMenu: TComponent); override;
  ...
  public
    procedure BuildPageSetupMenu(ARootItem: TObject; AData: Pointer;
      AIncludeDefineItem: Boolean; AStyles: TStringList;
      ACurrentStyle: TBasedxPrintStyle;
      AOnStyleClick, AOnDefineStylesClick: TNotifyEvent); override;
    class function ExtractPrintStyleFromObj(Obj: TObject)
      : TBasedxPrintStyle; override;
  end;
  ...
  public
    procedure BuildAutoHFTextEntriesMenu(ARootItem: TObject; AData: Pointer;
      ...
      AOnHFTextEntriesClick, AOnSetupHFTextEntriesClick: TNotifyEvent);
      override;
    class function ExtractAutoHFTextEntryIndexFromObj(Obj: TObject)
      : Integer; override;
  end;
  ...
  TdxPSRibbon2010PreviewDialogStyleInfo = class
    (TdxPSRibbonPreviewDialogStyleInfo)
  public
  ...
  TdxPSRibbon2013PreviewDialogStyleInfo = class
    (TdxPSRibbonPreviewDialogStyleInfo)
  public
    class function CreatePreviewForm: TdxRibbonPrintPreviewForm; override;
    class function GetName: string; override;
  ...
  TdxPSRibbon2016PreviewDialogStyleInfo = class
    (TdxPSRibbonPreviewDialogStyleInfo)
  public
    class function CreatePreviewForm: TdxRibbonPrintPreviewForm; override;
    class function GetName: string; override;
  ...
  TdxPSRibbon2016TabletPreviewDialogStyleInfo = class
    (TdxPSRibbonPreviewDialogStyleInfo)
  public
    class function CreatePreviewForm: TdxRibbonPrintPreviewForm; override;
    class function GetName: string; override;
  ...
  TdxPSRibbon2019PreviewDialogStyleInfo = class
    (TdxPSRibbonPreviewDialogStyleInfo)
  public
    class function CreatePreviewForm: TdxRibbonPrintPreviewForm; override;
    class function GetName: string; override;
...
class function TdxRibbonPSPopupMenuBuilder.CanShowPopup(const APopupMenu
  : TPopupMenu): Boolean;
begin
...
function TdxRibbonPSPopupMenuBuilder.BuildPopup(const AControl: TControl;
  ...
  const
    BarItemClasses: array [Boolean] of TdxBarItemClass = (TdxBarButton,
      TdxBarSubItem);
  var
...
procedure TdxRibbonPSPopupMenuBuilder.InvokePopup(X, Y: Integer;
  AControl: TControl; APopupMenu: TComponent);
var
  R: TRect;
begin
  ...
  begin
    ...
    begin
      R := cxRectOffset(AControl.ClientRect,
        AControl.ClientToScreen(cxNullPoint));
      TdxBarPopupMenu(APopupMenu).PopupEx(X, Y, AControl.Width, AControl.Height,
        True, @R);
    end;
  end;
end;
...
class function TdxRibbonPSPageSetupMenuBuilder.ExtractPrintStyleFromObj
  (Obj: TObject): TBasedxPrintStyle;
begin
...
procedure TdxRibbonPSPageSetupMenuBuilder.BuildPageSetupMenu(ARootItem: TObject;
  ...
  ACurrentStyle: TBasedxPrintStyle; AOnStyleClick, AOnDefineStylesClick
  : TNotifyEvent);
begin
  if not(ARootItem is TdxBarListItem) then
  begin
    inherited BuildPageSetupMenu(ARootItem, AData, AIncludeDefineItem, AStyles,
      ACurrentStyle, AOnStyleClick, AOnDefineStylesClick);
    Exit;
  end;
...
procedure TdxRibbonPSAutoHFTextMenuBuilder.BuildAutoHFTextEntriesMenu
  (ARootItem: TObject; AData: Pointer;
  AIncludeSetupAutoHFTextEntriesItem: Boolean; AAutoHFTextEntries: TStrings;
  AOnHFTextEntriesClick, AOnSetupHFTextEntriesClick: TNotifyEvent);
begin
  if not(ARootItem is TdxBarListItem) then
  ...
  if AIncludeSetupAutoHFTextEntriesItem and (TObject(AData) is TdxBarButton)
  then
    with TdxBarButton(AData) do
    begin
...
class function TdxRibbonPSAutoHFTextMenuBuilder.
  ExtractAutoHFTextEntryIndexFromObj(Obj: TObject): Integer;
begin
...
begin
  ...
  try
    ...
    dxLoadImageListFromResources(ilSmallImages,
      IDB_DXPSPREVIEW_TOOLBARS_SMALLIMAGELIST);
    dxLoadImageListFromResources(ilLargeImages,
      IDB_DXPSPREVIEW_RIBBON_IMAGELIST, HInstance);
...
procedure TdxRibbonPrintPreviewForm.LoadBarManager(AIniFile: TCustomIniFile;
  const ASectionName: string);
const
...
begin
  AIsSameVersion := (AIniFile.ReadInteger(dxValidatePath(ASectionName) +
    'Version', 'Major', 0) = dxPSVerMajor) and
    (AIniFile.ReadInteger(dxValidatePath(ASectionName) + 'Version', 'Minor', 0)
    = dxPSVerMinor);

  if AIsSameVersion then
  begin
    TdxBarManagerAccess(dxBarManager).LoadBarManager(AIniFile,
      dxValidatePath(ASectionName) + sdxToolBars,
      StorageType[AIniFile is TRegistryIniFile]);
  end;
end;

procedure TdxRibbonPrintPreviewForm.SaveBarManager(AIniFile: TCustomIniFile;
  const ASectionName: string);
const
  StorageType: array [Boolean] of TdxBarStoringKind = (skIni, skReg);
begin
  AIniFile.WriteInteger(dxValidatePath(ASectionName) + 'Version', 'Major',
    dxPSVerMajor);
  AIniFile.WriteInteger(dxValidatePath(ASectionName) + 'Version', 'Minor',
    dxPSVerMinor);
  TdxBarManagerAccess(dxBarManager).SaveBarManager(AIniFile,
    dxValidatePath(ASectionName) + sdxToolBars,
    StorageType[AIniFile is TRegistryIniFile]);
end;
...
begin
  ...
  if IsExplorerAvailable then
    TWinControlAccess(Preview.ExplorerTree.Control).OnMouseUp :=
      DoShowExplorerPopup
  else
  begin
...
begin
  ...
  try
    ...
    bbExplorerCreateNewFolder.Enabled := IsExplorerAvailable and
      ExplorerTree.CanCreateFolder;
    bbExplorerDelete.Enabled := IsExplorerAvailable and
      ExplorerTree.CanDeleteSelection;
    bbExplorerRename.Enabled := IsExplorerAvailable and
      ExplorerTree.CanRenameSelectedItem;
    bbReportProperties.Enabled := IsExplorerAvailable and
      ExplorerTree.CanShowPropertySheetsForSelectedItem;

    bbFormatTitle.Enabled := Assigned(ReportLink) and ReportLink.CanChangeTitle;
    bbFormatFootnotes.Enabled := Assigned(ReportLink) and
      ReportLink.CanChangeFootnotes;
    rgiBackgroundColor.Enabled := Preview.IsEnabled(peoPageBackground) and
      not IsPrinting;
    bbFormatShrinkToPageWidth.Enabled := APagesExists and not IsPrinting;
    SetBarItemVisibility(bbFormatFootnotes, (ReportLink <> nil) and
      (rlcFootnotes in ReportLink.Capabilities));
    SetBarItemVisibility(bbFormatTitle, (ReportLink <> nil) and
      (rlcTitle in ReportLink.Capabilities));
    if ReportLink <> nil then
    begin
      APage := ReportLink.RealPrinterPage;
      bbFormatShrinkToPageWidth.Down := ReportLink.ShrinkToPageWidth;
      edFitToPagesHorz.EditValue := EncodeFitToPageValue
        (APage.FitToPagesHorizontally, APage.ScaleMode);
      edFitToPagesVert.EditValue := EncodeFitToPageValue
        (APage.FitToPagesVertically, APage.ScaleMode);
    ...
    SetBarItemVisibility(bbFormatSubItem, (ReportLink <> nil) and
      ([rlcHeaderFooter, rlcTitle, rlcFootnotes] *
      ReportLink.Capabilities <> []));
    edAdjustToScale.Enabled := APagesExists and not IsPrinting and
      (ReportLink <> nil) and (ReportLink.RealPrinterPage.ScaleMode = smAdjust);
    edFitToPagesHorz.Enabled := APagesExists and not IsPrinting and
      (ReportLink <> nil);
    edFitToPagesVert.Enabled := APagesExists and not IsPrinting and
      (ReportLink <> nil);
    ...
    bbGoToFirstPage.Enabled := APagesExists and
      (TdxPreviewAccess(Preview.Preview).SelPageIndex <> 0);
    bbGoToPrevPage.Enabled := APagesExists and
      (TdxPreviewAccess(Preview.Preview).SelPageIndex <> 0);
    bbGoToNextPage.Enabled := APagesExists and
      (TdxPreviewAccess(Preview.Preview).SelPageIndex <> Preview.PageCount - 1);
    bbGoToLastPage.Enabled := APagesExists and
      (TdxPreviewAccess(Preview.Preview).SelPageIndex <> Preview.PageCount - 1);
    ...
    SetBarItemVisibility(bbFilePrintDialog, Preview.IsVisible(pvoPrint) and
      Preview.IsVisible(pvoPrintDialog));
    ...
    SetBarItemVisibility(bbLargePrintDialog, Preview.IsVisible(pvoPrint) and
      Preview.IsVisible(pvoPrintDialog));
    ...
    AStyleManagerAssigned := (ReportLink <> nil) and
      (ReportLink.StyleManager <> nil) and
      (rlcHeaderFooter in ReportLink.Capabilities);
    ...
    SetBarItemVisibility(rgiBackgroundColor,
      Preview.IsVisible(pvoPageBackground));

    ABoolValue := (ReportLink <> nil) and
      (rlcHeaderFooter in ReportLink.Capabilities);
    ...
    begin
      ...
      begin
        seActivePage.MaxValue := ReportLink.PageCount;
        seActivePage.Value := TdxPreviewAccess(Preview.Preview)
          .SelPageIndex + 1;
      end
    end
    else
    ...
    bbFilePrint.Hint := cxGetResourceString(@sdxHintFilePrint) +
      GetCurrentPrinterAsHint;
...
begin
  Preview.Options.ThumbnailsOptions.Size :=
    TdxPSThumbnailsSize(TTagToInt(TComponent(Sender).Tag));
end;
...
procedure TdxRibbonPrintPreviewForm.ExplorerCreateNewFolderClick
  (Sender: TObject);
begin
...
procedure TdxRibbonPrintPreviewForm.InitializeBackgroundColorsGallery;
  ...
  begin
    Result := TcxAlphaBitmap.CreateSize(ScaleFactor.Apply(12),
      ScaleFactor.Apply(12));
...
var
  ...
  I: Integer;
begin
  TcxSpinEditProperties(edAdjustToScale.Properties).MinValue :=
    TdxPrinterPage.MinScaleFactor;
  TcxSpinEditProperties(edAdjustToScale.Properties).MaxValue :=
    TdxPrinterPage.MaxScaleFactor;
...
procedure TdxRibbonPrintPreviewForm.bbFormatShrinkToPageWidthClick
  (Sender: TObject);
begin
  if ReportLink <> nil then
...
begin
  ...
  Preview.DoShowMultiplySelectPagesDlg(ilSmallImages, PageSelectorImageIndex,
    R.TopLeft, YShift);
end;
...
procedure TdxRibbonPrintPreviewForm.AddExplorerContextCommand
  ...
  procedure AddBarControl(AItemLinks: TdxBarItemLinks;
...
procedure TdxRibbonPrintPreviewForm.ExplorerContextCommandClick
  (Sender: TObject);
var
...
begin
  Command := TCustomdxPSExplorerContextCommand
    (TTagToObj(TdxBarButton(Sender).Tag));
...
begin
  ...
  begin
    ASolidFillingMode := (Preview.Background.Mode = bmBrush) and
    ...
    try
      ...
      begin
        ...
        AItem.Selected := ASolidFillingMode and
          (AItem.Tag = Preview.Background.Brush.Color);
      end;
    finally
...
begin
  ...
  dxBarScaleToFit.Caption := cxGetResourceString
    (@sdxRibbonPrintPreviewGroupScaleToFit);
  dxBarFormat.Caption := cxGetResourceString(@sdxRibbonPrintPreviewGroupFormat);
  dxBarNavigation.Caption := cxGetResourceString
    (@sdxRibbonPrintPreviewGroupNavigation);
  dxBarMorePages.Caption := cxGetResourceString
    (@sdxRibbonPrintPreviewPagesSubItem);
  dxBarView.Caption := cxGetResourceString(@sdxMenuShortcutPreview);
  dxBarExplorerReport.Caption := cxGetResourceString
  ...
  dxBarInsertName.Caption := cxGetResourceString
    (@sdxRibbonPrintPreviewGroupInsertName);
  dxBarInsertPageNumber.Caption :=
    cxGetResourceString(@sdxRibbonPrintPreviewGroupInsertPageNumber);
  dxBarHeaderAndFooterParts.Caption :=
    cxGetResourceString(@sdxRibbonPrintPreviewGroupParts);
  ...
  bbFormatSubItem.Caption := cxGetResourceString
    (@sdxRibbonPrintPreviewGroupFormat);
  bbFormatSubItem.Hint := cxGetResourceString
    (@sdxRibbonPrintPreviewGroupFormat);
  bbNavigation.Caption := cxGetResourceString
    (@sdxRibbonPrintPreviewGroupNavigation);
  bbExplorer.Caption := cxGetResourceString(@sdxMenuExplorer);
  bbThumbnails.Caption := cxGetResourceString(@sdxMenuViewThumbnails);
  bbHeaderAndFooter.Caption := cxGetResourceString
    (@sdxMenuFormatHeaderAndFooter);
  bbClosePreview.Caption := cxGetResourceString
    (@sdxRibbonPrintPreviewClosePrintPreview);
  ...
  dxBarPageSetup.Caption :=
    DropAmpersand(cxGetResourceString(@sdxMenuFilePageSetup));

  dxRibbon.Contexts.Items[0].Caption := rtExplorer.Caption;
  dxRibbon.Contexts.Items[1].Caption :=
    DropAmpersand(cxGetResourceString(@sdxHeaderFooterBar));
  ...
  bbFilePrint.Caption := DropEndEllipsis
    (cxGetResourceString(@sdxMenuFilePrint));
  ...
  bbLargePrint.Caption := DropEndEllipsis
    (cxGetResourceString(@sdxMenuFilePrint));
  ...
  bbExplorerCreateNewFolder.Caption :=
    cxGetResourceString(@sdxMenuExplorerCreateFolder);
  ...
  bbInsertEditAutoText.Caption := cxGetResourceString
    (@sdxMenuInsertEditAutoTextEntries);
  bsiInsertAutoText.Caption := cxGetResourceString
    (@sdxMenuInsertAutoTextEntriesSubItem);
  bliInsertAutoTextEntries.Caption :=
  ...
  bbInsertHFPageOfPages.Caption :=
    cxGetResourceString(@sdxMenuInsertPageOfPages);
  ...
  bbInsertHFMachineName.Caption :=
    cxGetResourceString(@sdxMenuInsertMachineName);
  ...
  bbZoomWidenToSourceWidth.Caption :=
    cxGetResourceString(@sdxMenuZoomWidenToSourceWidth);
  ...
  bbViewSwitchToLeftPart.Caption :=
    cxGetResourceString(@sdxMenuViewSwitchToLeftPart);
  bbViewSwitchToRightPart.Caption :=
    cxGetResourceString(@sdxMenuViewSwitchToRightPart);
  bbViewSwitchToCenterPart.Caption :=
    cxGetResourceString(@sdxMenuViewSwitchToCenterPart);
  ...
  bbFormatPageNumbering.Caption :=
    cxGetResourceString(@sdxMenuFormatPageNumbering);
  bbFormatShrinkToPageWidth.Caption :=
    cxGetResourceString(@sdxMenuFormatShrinkToPage);
  bbFormatHFBackground.Caption := cxGetResourceString
    (@sdxMenuFormatHFBackground);
  bbFormatHFClear.Caption := cxGetResourceString(@sdxMenuFormatHFClear);

  rgiBackgroundColor.Caption := cxGetResourceString
    (@sdxHintFormatPageBackground);
  rgiBackgroundColor.GalleryGroups[0].Header.Caption :=
    rgiBackgroundColor.Caption;
  ...
  bbFilePrint.Hint := cxGetResourceString(@sdxHintFilePrint) +
    dxPSPrvw.GetCurrentPrinterAsHint;
  ...
  bbLargePrint.Hint := cxGetResourceString(@sdxHintFilePrint) +
    dxPSPrvw.GetCurrentPrinterAsHint;
  ...
  bbExplorerCreateNewFolder.Hint :=
    cxGetResourceString(@sdxHintExplorerCreateFolder);
  ...
  bbInsertEditAutoText.Hint := cxGetResourceString
    (@sdxHintInsertEditAutoTextEntries);
  ...
  bbZoomWidenToSourceWidth.Hint :=
    cxGetResourceString(@sdxHintZoomWidenToSourceWidth);
  ...
  bbViewSwitchToLeftPart.Hint := cxGetResourceString
    (@sdxHintViewSwitchToLeftPart);
  bbViewSwitchToRightPart.Hint := cxGetResourceString
    (@sdxHintViewSwitchToRightPart);
  bbViewSwitchToCenterPart.Hint :=
    cxGetResourceString(@sdxHintViewSwitchToCenterPart);
  ...
  bbFormatPageNumbering.Hint := cxGetResourceString
    (@sdxHintFormatPageNumbering);
  bbFormatShrinkToPageWidth.Hint :=
    cxGetResourceString(@sdxHintFormatShrinkToPage);
...
procedure TdxRibbonPrintPreviewForm.SetBarItemVisibility(Item: TdxBarItem;
  Value: Boolean);
begin
...
begin
  if not Locked and (ReportLink <> nil) and
    (rlcHeaderFooter in ReportLink.Capabilities) then
  begin
    Preview.BeginUpdate;
    try
...
procedure TdxRibbonPrintPreviewForm.bbFormatHeaderAndFooterClick
  (Sender: TObject);
begin
...
function TdxRibbonPrintPreviewForm.GetExplorerContextCommand(Index: Integer)
  : TCustomdxPSExplorerContextCommand;
begin
  Result := TCustomdxPSExplorerContextCommand
    (FExplorerContextCommands.Items[Index]);
end;
...
function TdxRibbonPrintPreviewForm.GetExplorerTree
...
function TdxRibbonPrintPreviewForm.EncodeFitToPageValue(AValue: Integer;
  AScaleMode: TdxScaleMode): TcxEditValue;
begin
...
function TdxRibbonPrintPreviewForm.DecodeFitToPageValue
...
const
  StateMap: array [Boolean] of TdxPSPreviewState = (prsEditHeaders,
    prsEditFooters);
begin
...
procedure TdxRibbonPrintPreviewForm.dxBarScaleToFitCaptionButtons0Click
  (Sender: TObject);
begin
  DoPageSetupReport(3);
end;

procedure TdxRibbonPrintPreviewForm.dxRibbonHelpButtonClick
...
procedure TdxRibbonPrintPreviewForm.PreviewLoadProperties(Sender: TObject;
  AIniFile: TCustomIniFile; const ASectionName: string);
begin
  LoadBarManager(AIniFile, ASectionName);
end;

procedure TdxRibbonPrintPreviewForm.PreviewCanShowMarginHint(Sender: TObject;
  var AAllow: Boolean);
begin
  AAllow := ActiveBarControl = nil;
end;

procedure TdxRibbonPrintPreviewForm.PreviewAddExplorerCommand(Sender: TObject;
  ACommand: TCustomdxPSExplorerContextCommand);
begin
...
procedure TdxRibbonPrintPreviewForm.PreviewSaveProperties(Sender: TObject;
  AIniFile: TCustomIniFile; const ASectionName: string);
begin
...
procedure TdxRibbonPrintPreviewForm.PreviewHFTextEntriesChanged
  (Sender: TObject);
begin
  if Preview.IsAutoHFTextEntriesAvailable then
    ReportLink.StyleManager.BuildAutoHFTextEntriesMenu(bliInsertAutoTextEntries,
      bbInsertEditAutoText, True);
end;

procedure TdxRibbonPrintPreviewForm.PreviewUpdateExplorerCommands
  (Sender: TObject);
begin
  UpdateExplorerContextCommands;
end;

procedure TdxRibbonPrintPreviewForm.FormCloseQuery(Sender: TObject;
...
procedure TdxRibbonPrintPreviewForm.bbCloseHeaderAndFooterClick
  (Sender: TObject);
begin
  DoShowHFToolBar(False);
end;
...
procedure TdxRibbonPrintPreviewForm.edriFitToPagesPropertiesChange
  (Sender: TObject);

  function HasChanges(APage: TdxPrinterPage;
    AFitToPagesHorizontally, AFitToPagesVertically: Integer): Boolean;
  begin
    Result := (APage.FitToPagesVertically <> AFitToPagesVertically) or
      (APage.FitToPagesHorizontally <> AFitToPagesHorizontally) or
      (APage.ScaleMode <> smFit) and
      (AFitToPagesVertically + AFitToPagesHorizontally > 0);
  end;
  ...
  begin
    ...
    begin
      ...
      try
        ...
        if (APage.FitToPagesHorizontally = 0) and
          (APage.FitToPagesVertically = 0) then
...
procedure TdxRibbonPrintPreviewForm.bbBackgroundMoreColorsClick
  (Sender: TObject);
begin
...
procedure TdxRibbonPrintPreviewForm.bbBackgroundFillEffectsClick
  (Sender: TObject);
begin
...
class function TdxPSRibbonPreviewDialogStyleInfo.CreatePreviewForm
  : TdxRibbonPrintPreviewForm;
begin
  Result := TdxRibbonPrintPreviewForm.Create(nil);
end;

class function TdxPSRibbonPreviewDialogStyleInfo.CreatePreviewWindow
...
class function TdxPSRibbon2010PreviewDialogStyleInfo.CreatePreviewForm
  : TdxRibbonPrintPreviewForm;
begin
...
class function TdxPSRibbon2013PreviewDialogStyleInfo.CreatePreviewForm
  : TdxRibbonPrintPreviewForm;
begin
  Result := inherited CreatePreviewForm;
...
class function TdxPSRibbon2016PreviewDialogStyleInfo.CreatePreviewForm
  : TdxRibbonPrintPreviewForm;
begin
  Result := inherited CreatePreviewForm;
  Result.DisableAero := True;
...
class function TdxPSRibbon2016TabletPreviewDialogStyleInfo.CreatePreviewForm
  : TdxRibbonPrintPreviewForm;
begin
  Result := inherited CreatePreviewForm;
  Result.DisableAero := True;
...
class function TdxPSRibbon2019PreviewDialogStyleInfo.CreatePreviewForm
  : TdxRibbonPrintPreviewForm;
begin
  Result := inherited CreatePreviewForm;
  Result.DisableAero := True;
...
dxPSAutoHFTextMenuBuilderFactory.RegisterBuilder
  (TdxRibbonPSAutoHFTextMenuBuilder);
dxPSPageSetupMenuBuilderFactory.RegisterBuilder
  (TdxRibbonPSPageSetupMenuBuilder);
dxPSPreviewDialogManager.RegisterPreviewDialog
  (TdxPSRibbonPreviewDialogStyleInfo);
dxPSPreviewDialogManager.RegisterPreviewDialog
  (TdxPSRibbon2010PreviewDialogStyleInfo);
dxPSPreviewDialogManager.RegisterPreviewDialog
...
dxPSPreviewDialogManager.UnregisterPreviewDialog
  (TdxPSRibbon2019PreviewDialogStyleInfo);
dxPSPreviewDialogManager.UnregisterPreviewDialog
  (TdxPSRibbon2016TabletPreviewDialogStyleInfo);
dxPSPreviewDialogManager.UnregisterPreviewDialog
...
dxPSPreviewDialogManager.UnregisterPreviewDialog
  (TdxPSRibbonPreviewDialogStyleInfo);
dxPSPageSetupMenuBuilderFactory.UnregisterBuilder
  (TdxRibbonPSPageSetupMenuBuilder);
dxPSAutoHFTextMenuBuilderFactory.UnregisterBuilder
  (TdxRibbonPSAutoHFTextMenuBuilder);
