...
type
  ...
  IdxDocumentModelUnitConverter = interface
    ...
    function PixelsToModelUnits(const AValue: TSize; const ADpiX, ADpiY: Single)
      : TSize; overload;
    function HundredthsOfInchToModelUnits(const AValue: Integer)
      : Integer; overload;
    function HundredthsOfInchToModelUnits(const AValue: TSize): TSize; overload;
    function HundredthsOfMillimeterToModelUnits(const AValue: Integer)
      : Integer; overload;
    function HundredthsOfMillimeterToModelUnits(const AValue: TSize)
      : TSize; overload;
    function HundredthsOfMillimeterToModelUnitsRound(const AValue
      : Integer): Integer;
    ...
    function ModelUnitsToPixels(const AValue: Integer;
      const ADpi: Single): Integer;
    function ModelUnitsToPixelsF(const AValue: Single;
    ...
    function ModelUnitsToHundredthsOfInch(const AValue: Integer)
      : Integer; overload;
