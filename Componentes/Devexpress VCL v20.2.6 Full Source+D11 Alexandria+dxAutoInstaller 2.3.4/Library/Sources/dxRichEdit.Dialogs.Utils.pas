...
const
  dxParagraphAlignmentNames: array [TdxParagraphAlignment] of Pointer =
    (@sdxParagraphAlignmentLeft, @sdxParagraphAlignmentRight,
    @sdxParagraphAlignmentCenter, @sdxParagraphAlignmentJustify);

  dxParagraphLineSpacingNames: array [TdxParagraphLineSpacing] of Pointer =
    (@sdxParagraphLineSpacingSingle, @sdxParagraphLineSpacingSesquialteral,
    @sdxParagraphLineSpacingDouble, @sdxParagraphLineSpacingMultiple,
    @sdxParagraphLineSpacingExactly, @sdxParagraphLineSpacingAtLeast);

  dxParagraphFirstLineIndentNames: array [TdxParagraphFirstLineIndent]
    of Pointer = (@sdxParagraphFirstLineIndentNone,
    @sdxParagraphFirstLineIndentIndented, @sdxParagraphFirstLineIndentHanging);

  dxParagraphOutlineLevelNames: array [MinOutlineLevel .. MaxOutlineLevel]
    of Pointer = (@sdxParagraphOutlineLeve0, @sdxParagraphOutlineLeve1,
    @sdxParagraphOutlineLeve2, @sdxParagraphOutlineLeve3,
    @sdxParagraphOutlineLeve4, @sdxParagraphOutlineLeve5,
    @sdxParagraphOutlineLeve6, @sdxParagraphOutlineLeve7,
    @sdxParagraphOutlineLeve8, @sdxParagraphOutlineLeve9);

  dxListNumberAlignmentNames: array [TdxListNumberAlignment] of Pointer =
    (@sdxParagraphAlignmentLeft, @sdxParagraphAlignmentCenter,
    @sdxParagraphAlignmentRight);

  dxListFollowNumberNames: array [MinFollowNumber .. MaxFollowNumber]
    of Pointer = (@sdxRichEditMultiLevelNumberingListFollowNumberTabCharacter,
  ...
  dxSectionPropertiesApplyToNames: array [TdxSectionPropertiesApplyType]
    of Pointer = (@sdxSectionPropertiesApplyToWholeDocument,
  ...
  dxPaperKindNames: array [TdxPaperKind] of Pointer =
    (@sdxRichEditPaperKindCustom, @sdxRichEditPaperKindLetter,
    @sdxRichEditPaperKindLetterSmall, @sdxRichEditPaperKindTabloid,
    @sdxRichEditPaperKindLedger, @sdxRichEditPaperKindLegal,
    @sdxRichEditPaperKindStatement, @sdxRichEditPaperKindExecutive,
    @sdxRichEditPaperKindA3, @sdxRichEditPaperKindA4,
    @sdxRichEditPaperKindA4Small, @sdxRichEditPaperKindA5,
    @sdxRichEditPaperKindB4, @sdxRichEditPaperKindB5,
    @sdxRichEditPaperKindFolio, @sdxRichEditPaperKindQuarto,
    @sdxRichEditPaperKindStandard10x14, @sdxRichEditPaperKindStandard11x17,
    @sdxRichEditPaperKindNote, @sdxRichEditPaperKindNumber9Envelope,
    @sdxRichEditPaperKindNumber10Envelope,
    @sdxRichEditPaperKindNumber11Envelope,
    @sdxRichEditPaperKindNumber12Envelope,
    @sdxRichEditPaperKindNumber14Envelope, @sdxRichEditPaperKindCSheet,
    @sdxRichEditPaperKindDSheet, @sdxRichEditPaperKindESheet,
    @sdxRichEditPaperKindDLEnvelope, @sdxRichEditPaperKindC5Envelope,
    @sdxRichEditPaperKindC3Envelope, @sdxRichEditPaperKindC4Envelope,
    @sdxRichEditPaperKindC6Envelope, @sdxRichEditPaperKindC65Envelope,
    @sdxRichEditPaperKindB4Envelope, @sdxRichEditPaperKindB5Envelope,
    @sdxRichEditPaperKindB6Envelope, @sdxRichEditPaperKindItalyEnvelope,
    @sdxRichEditPaperKindMonarchEnvelope, @sdxRichEditPaperKindPersonalEnvelope,
    @sdxRichEditPaperKindUSStandardFanfold,
    @sdxRichEditPaperKindGermanStandardFanfold,
    @sdxRichEditPaperKindGermanLegalFanfold, @sdxRichEditPaperKindIsoB4,
    @sdxRichEditPaperKindJapanesePostcard, @sdxRichEditPaperKindStandard9x11,
    @sdxRichEditPaperKindStandard10x11, @sdxRichEditPaperKindStandard15x11,
    @sdxRichEditPaperKindInviteEnvelope, nil, nil,
    @sdxRichEditPaperKindLetterExtra, @sdxRichEditPaperKindLegalExtra,
    @sdxRichEditPaperKindTabloidExtra, @sdxRichEditPaperKindA4Extra,
    @sdxRichEditPaperKindLetterTransverse, @sdxRichEditPaperKindA4Transverse,
    @sdxRichEditPaperKindLetterExtraTransverse, @sdxRichEditPaperKindAPlus,
    @sdxRichEditPaperKindBPlus, @sdxRichEditPaperKindLetterPlus,
    @sdxRichEditPaperKindA4Plus, @sdxRichEditPaperKindA5Transverse,
    @sdxRichEditPaperKindB5Transverse, @sdxRichEditPaperKindA3Extra,
    @sdxRichEditPaperKindA5Extra, @sdxRichEditPaperKindB5Extra,
    @sdxRichEditPaperKindA2, @sdxRichEditPaperKindA3Transverse,
    @sdxRichEditPaperKindA3ExtraTransverse,
    @sdxRichEditPaperKindJapaneseDoublePostcard, @sdxRichEditPaperKindA6,
    ...
    @sdxRichEditPaperKindLetterRotated, @sdxRichEditPaperKindA3Rotated,
    @sdxRichEditPaperKindA4Rotated, @sdxRichEditPaperKindA5Rotated,
    @sdxRichEditPaperKindB4JisRotated, @sdxRichEditPaperKindB5JisRotated,
    ...
    @sdxRichEditPaperKindB6Jis, @sdxRichEditPaperKindB6JisRotated,
    ...
    @sdxRichEditPaperKindPrc16K, @sdxRichEditPaperKindPrc32K,
    @sdxRichEditPaperKindPrc32KBig, @sdxRichEditPaperKindPrcEnvelopeNumber1,
    ...
    @sdxRichEditPaperKindPrc16KRotated, @sdxRichEditPaperKindPrc32KRotated,
  ...
  dxConditionalTableStyleFormattingTypeNames
    : array [TdxConditionalTableStyleFormattingType] of Pointer =
