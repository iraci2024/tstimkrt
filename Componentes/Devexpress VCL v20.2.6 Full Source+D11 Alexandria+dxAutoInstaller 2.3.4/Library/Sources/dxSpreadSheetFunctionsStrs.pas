...
resourcestring
  ...
  sfnCell = 'CELL';
  sfnCellDescription =
    'Returns information about the cell’s formatting, location, or content.';
  sfnError_Type = 'ERROR.TYPE';
  sfnError_TypeDescription =
    'Returns a number corresponding to the specified error code.';
  sfnInfo = 'INFO';
  sfnInfoDescription =
  ...
  sfnIsErr = 'ISERR';
  sfnIsErrDescription =
    'Returns TRUE if the cell contains any error code except #N/A.';
  sfnIsError = 'ISERROR';
  sfnIsErrorDescription =
    'Returns TRUE if the cell contains any error code (#N/A, #VALUE!, #REF!, #DIV/0!, #NUM!, #NAME?, or #NULL!).';
  sfnIsEven = 'ISEVEN';
  sfnIsEvenDescription = 'Returns TRUE if the number is even.';
  sfnIsFormula = 'ISFORMULA';
  sfnIsFormulaDescription =
    'Returns TRUE if the cell contains a formula expression.';
  sfnIsLogical = 'ISLOGICAL';
  sfnIsLogicalDescription =
    'Returns TRUE if the specified value refers to a logical value.';
  sfnIsNA = 'ISNA';
  sfnIsNADescription =
    'Returns TRUE if the cell contains the #N/A (a value is not available) error code.';
  sfnIsNonText = 'ISNONTEXT';
  sfnIsNonTextDescription =
  ...
  sfnAggregateDescription =
    'Returns an aggregate in the specified list with an option to ignore hidden rows and errors.';
  sfnArabic = 'ARABIC';
  ...
  sfnAtan2 = 'ATAN2';
  sfnAtan2Description =
    'Returns the arctangent using the specified X and Y coordinates.';
  sfnAtanh = 'ATANH';
  sfnAtanhDescription = 'Returns the inverse hyperbolic tangent.';
  sfnBase = 'BASE';
  sfnBaseDescription =
    'Converts a number into a text representation with the specified base (radix).';
  sfnCeiling = 'CEILING';
  sfnCeilingDescription =
    'Rounds the value up to the nearest multiple based on the specified significance.';
  sfnCeiling_Math = 'CEILING.MATH';
  sfnCeiling_MathDescription =
    'Rounds a number up to the nearest integer or to the nearest multiple of significance.';
  sfnCeiling_Precise = 'CEILING.PRECISE';
  sfnCeiling_PreciseDescription =
    'Returns a number that is rounded up to the nearest integer or to the nearest multiple of significance.';
  sfnCombin = 'COMBIN';
  sfnCombinDescription =
    'Returns the number of combinations for the specified number of items.';
  sfnCombinA = 'COMBINA';
  sfnCombinADescription =
    'Returns the number of combinations for the specified number of items (including repetitions).';
  sfnCos = 'COS';
  ...
  sfnDecimal = 'DECIMAL';
  sfnDecimalDescription =
    'Converts a text representation of a number into a number using the specified base (radix).';
  sfnDegrees = 'DEGREES';
  ...
  sfnFloor = 'FLOOR';
  sfnFloorDescription =
    'Rounds the value down to the nearest multiple of the specified significance.';
  sfnFloor_Math = 'FLOOR.MATH';
  sfnFloor_MathDescription =
    'Rounds the number down to the nearest integer or to the nearest multiple of significance.';
  sfnFloor_Precise = 'FLOOR.PRECISE';
  sfnFloor_PreciseDescription =
    'Returns a number that is rounded up to the nearest integer or to the nearest multiple of significance.';
  sfnGCD = 'GCD';
  sfnGCDDescription =
    'Returns the greatest common divisor of two or more integer values.';
  sfnInt = 'INT';
  ...
  sfnMDeterm = 'MDETERM';
  sfnMDetermDescription =
    'Calculates the determinant for the specified matrix.';
  sfnMInverse = 'MINVERSE';
  sfnMInverseDescription =
    'Returns the inverse matrix for the matrix stored in the specified array.';
  sfnMMult = 'MMULT';
  sfnMMultDescription = 'Returns the matrix product of two arrays.';
  sfnMod = 'MOD';
  sfnModDescription =
    'Returns the remainder after one specified number is divided by the other.';
  sfnMRound = 'MROUND';
  ...
  sfnProduct = 'PRODUCT';
  sfnProductDescription =
    'Multiplies all the parameter values and returns the product.';
  sfnQuotient = 'QUOTIENT';
  sfnQuotientDescription =
    'Discards the remainder of a division and returns its integer portion.';
  sfnRadians = 'RADIANS';
  sfnRadiansDescription = 'Converts degrees to radians.';
  sfnRand = 'RAND';
  sfnRandDescription =
    'Returns a random number within the range between 0 and 1, inclusive.';
  sfnRandBetween = 'RANDBETWEEN';
  sfnRandBetweenDescription =
    'Returns a random integer within the specified range.';
  sfnRoman = 'ROMAN';
  sfnRomanDescription =
    'Converts an Arabic numeral to a Roman numeral (as a text string).';
  sfnRound = 'ROUND';
  sfnRoundDescription =
    'Rounds a numeric value to the specified number of digits.';
  ...
  sfnSeriesSumDescription =
    'Returns the sum of a power series based on the specified set of coefficients.';
  sfnSign = 'SIGN';
  ...
  sfnSqrtPi = 'SQRTPI';
  sfnSqrtPiDescription =
    'Returns the square root of Pi multiplied by the specified value.';
  ...
  sfnSumIF = 'SUMIF';
  sfnSumIFDescription =
    'Sums the numeric values within an array that meet a specific criterion.';
  sfnSumIFS = 'SUMIFS';
  sfnSumIFSDescription =
    'Sums the numeric values within an array that meet multiple criteria.';
  sfnSumProduct = 'SUMPRODUCT';
  sfnSumProductDescription =
    'Multiplies the corresponding numeric values in all specified arrays and sums the products.';
  sfnSumSQ = 'SUMSQ';
  sfnSumSQDescription = 'Sums the squares of values in a series of numbers.';
  sfnSumX2MY2 = 'SUMX2MY2';
  sfnSumX2MY2Description =
    'Sums the differences of the corresponding squared values in two specified arrays.';
  sfnSumX2PY2 = 'SUMX2PY2';
  sfnSumX2PY2Description =
    'Sums the sums of the corresponding squared values in two specified arrays.';
  sfnSumXMY2 = 'SUMXMY2';
  sfnSumXMY2Description =
    'Sums the squares of differences of the corresponding values in two specified arrays.';
  sfnTan = 'TAN';
  ...
  sfnTrunc = 'TRUNC';
  sfnTruncDescription =
    'Truncates a fractional part of the specified numeric value.';
  ...
  sfnLen = 'LEN';
  sfnLenDescription =
    'Returns the specified text string’s length, in characters. The single-byte version.';
  sfnLenB = 'LENB';
  sfnLenBDescription =
    'Returns the specified text string’s length, in characters. The double-byte version.';
  sfnLower = 'LOWER';
  sfnLowerDescription = 'Converts a text string to lowercase.';
  sfnMid = 'MID';
  sfnMidDescription =
    'Returns the substring of the specified text string. The single-byte version.';
  sfnMidB = 'MIDB';
  sfnMidBDescription =
    'Returns the substring of the specified text string. The double-byte version.';
  sfnNumberValue = 'NUMBERVALUE';
  sfnNumberValueDescription =
    'Converts text to a number using a locale-independent algorithm.';
  sfnPhonetic = 'PHONETIC';
  sfnPhoneticDescription =
  ...
  sfnRight = 'RIGHT';
  sfnRightDescription =
    'Returns one or more last characters in a text string. The single-byte version.';
  sfnRightB = 'RIGHTB';
  sfnRightBDescription =
    'Returns one or more last characters in a text string. The double-byte version.';
  sfnSearch = 'SEARCH';
  sfnSearchDescription =
    'Searches one text string within another. The single-byte version.';
  sfnSearchB = 'SEARCHB';
  sfnSearchBDescription =
    'Searches one text string within another. The double-byte version.';
  sfnSubstitute = 'SUBSTITUTE';
  sfnSubstituteDescription =
    'Substitutes a specific text with another text in a string.';
  sfnT = 'T';
  ...
  sfnTrim = 'TRIM';
  sfnTrimDescription =
    'Removes all spaces from text, except for single spaces between individual words.';
  sfnUniChar = 'UNICHAR';
  sfnUniCharDescription =
    'Returns the character corresponding to the specified number in the Unicode table.';
  sfnUniCode = 'UNICODE';
  sfnUniCodeDescription =
    'Returns the code corresponding to the first character in the specified text string.';
  sfnUpper = 'UPPER';
  ...
  sfnAverage = 'AVERAGE';
  sfnAverageDescription =
    'Calculates the average value of a numeric value series.';
  sfnAverageA = 'AVERAGEA';
  sfnAverageADescription =
    'Calculates the average value of numeric values in all non-empty cells.';
  sfnAverageIF = 'AVERAGEIF';
  sfnAverageIFDescription =
    'Returns the average (that is, the arithmetic mean) of all cells within the cell range that meet a specific criterion.';
  sfnAverageIFS = 'AVERAGEIFS';
  sfnAverageIFSDescription =
    'Returns the average (that is, the arithmetic mean) of all cells that meet multiple criteria.';
  ...
  sfnBinom_Dist_RangeDescription =
    'Returns the probability of a trial’s result by using a binomial distribution.';
  sfnBinom_Inv = 'BINOM.INV';
  sfnBinom_InvDescription =
    'Returns the smallest value for which the cumulative binomial distribution is greater than or equals a criterion value.';
  ...
  sfnChiSQ_InvDescription =
    'Returns the inverse of the left-tailed probability of the chi-squared distribution.';
  sfnChiSQ_Inv_RT = 'CHISQ.INV.RT';
  sfnChiSQ_Inv_RTDescription =
  ...
  sfnConfidence_NormDescription =
    'Returns the confidence interval for a population mean using a normal distribution.';
  sfnConfidence_T = 'CONFIDENCE.T';
  sfnConfidence_TDescription =
  ...
  sfnCount = 'COUNT';
  sfnCountDescription =
    'Returns the number of cells that contain numbers or the total number of numeric values within the specified array.';
  sfnCountA = 'COUNTA';
  sfnCountADescription =
    'Returns the total number of non-empty cells within the specified cell range.';
  sfnCountBlank = 'COUNTBLANK';
  sfnCountBlankDescription =
    'Returns the total number of blank cells within the specified cell range.';
  sfnCountIF = 'COUNTIF';
  sfnCountIFDescription =
    'Returns the number of cells within the specified range that meet a specific criterion.';
  sfnCountIFS = 'COUNTIFS';
  sfnCountIFSDescription =
    'Returns the number of cells within the specified range that meet multiple criteria.';
  ...
  sfnDevSQ = 'DEVSQ';
  sfnDevSQDescription =
    'Returns the sum of squares of deviations of a numbers in an array from their sample mean.';
  sfnExpon_Dist = 'EXPON.DIST';
  sfnExpon_DistDescription =
  ...
  sfnForecastDescription =
    'Forecasts a future value in a linear trend by using existing pairs of X and Y values.';
  ...
  sfnGammaLn = 'GAMMALN';
  sfnGammaLnDescription =
    'Returns the natural logarithm of the Gamma function.';
  sfnGammaLn_Precise = 'GAMMALN.PRECISE';
  sfnGammaLn_PreciseDescription =
    'Returns the natural logarithm of the Gamma function (a high precision version).';
  sfnGauss = 'GAUSS';
  sfnGaussDescription =
    ...
    + 'mean.';
  sfnGeomean = 'GEOMEAN';
  sfnGeomeanDescription =
    'Returns the geometric mean of an array of positive numeric values.';
  sfnGrowth = 'GROWTH';
  sfnGrowthDescription =
    'Calculates the predicted exponential growth by using the known numeric values.';
  sfnHarmean = 'HARMEAN';
  ...
  sfnLarge = 'LARGE';
  sfnLargeDescription =
    'Returns the K-th largest value in a series of numeric values.';
  sfnLinest = 'LINEST';
  ...
  sfnLogNorm_InvDescription =
    'Calculates the inverse of the lognormal cumulative distribution.';
  sfnMax = 'MAX';
  sfnMaxDescription =
    'Returns the maximum value in an array of numeric values.';
  sfnMaxA = 'MAXA';
  sfnMaxADescription =
    'Returns the maximum value in an array, including numeric values, text, and logical values.';
  sfnMedian = 'MEDIAN';
  sfnMedianDescription = 'Returns the median of a series of numeric values.';
  sfnMin = 'MIN';
  sfnMinDescription =
    'Returns the minimum value in an array of numeric values.';
  sfnMinA = 'MINA';
  sfnMinADescription =
    'Returns the minimum value in an array, including numeric values, text, and logical values.';
  sfnMode_Mult = 'MODE.MULT';
  sfnMode_MultDescription =
    'Returns a vertical array populated with the most frequently occurring (repetitive) values in an array of numeric values.';
  ...
  sfnPercentile_ExcDescription =
    'Returns the K-th percentile of values in an array of numbers, where K is the range between 0 and 1, exclusive.';
  sfnPercentile_Inc = 'PERCENTILE.INC';
  sfnPercentile_IncDescription =
    'Returns the K-th percentile of values in an array of numbers.';
  sfnPercentRank_Exc = 'PERCENTRANK.EXC';
  sfnPercentRank_ExcDescription =
    'Returns the rank of a value in a data set as a percentage (0..1, exclusive) of a data set.';
  sfnPercentRank_Inc = 'PERCENTRANK.INC';
  sfnPercentRank_IncDescription =
    'Returns the percentage rank of the specified value in an array of numbers.';
  sfnPermut = 'PERMUT';
  sfnPermutDescription =
  ...
  sfnQuartile_ExcDescription =
    'Returns the quartile of a series of numeric values, based on percentile values from the range between 0 and 1, exclusive.';
  sfnQuartile_Inc = 'QUARTILE.INC';
  sfnQuartile_IncDescription =
  ...
  sfnSmall = 'SMALL';
  sfnSmallDescription =
    'Returns the K-th smallest value in a series of numeric values.';
  sfnStandardize = 'STANDARDIZE';
  sfnStandardizeDescription =
    'Returns a normalized value from a distribution characterized by the mean and standard deviation values.';
  sfnStDev_P = 'STDEV.P';
  ...
  sfnVar_P = 'VAR.P';
  sfnVar_PDescription =
    'Calculates the variance based on the entire population specified as an array of numeric values.';
  sfnVar_S = 'VAR.S';
  sfnVar_SDescription =
  ...
  sfnNormDistDescription =
    ...
    + 'including hypothesis testing.';
  sfnNormInv = 'NORMINV';
  sfnNormInvDescription =
    'Iteratively calculates the inverse of the normal distribution of the specified mean and standard deviation.';
  ...
  sfnPercentileDescription =
    'Returns the K-th percentile of values in an array of numbers.';
  sfnPercentRank = 'PERCENTRANK';
  sfnPercentRankDescription =
    'Returns the percentage rank of the specified value in an array of numbers.';
  sfnPoisson = 'POISSON';
  sfnPoissonDescription =
    'Returns the Poisson distribution that is often used to predict the number of events occurring over a specific time.';
  sfnQuartile = 'QUARTILE';
  sfnQuartileDescription =
    'Returns the quartile of a series of numeric values.';
  sfnRank = 'RANK';
  sfnRankDescription =
  ...
  sfnDateValueDescription =
    'Converts a date specified as a text string to the corresponding serial number.';
  sfnDay = 'DAY';
  sfnDayDescription =
    'Converts a serial number to the corresponding date (day).';
  sfnDays = 'DAYS';
  sfnDaysDescription =
  ...
  sfnEOMonth = 'EOMONTH';
  sfnEOMonthDescription =
    'Returns the serial number of the last day of the month before or after a specified number of months.';
  sfnHour = 'HOUR';
  sfnHourDescription = 'Converts a serial number to the corresponding hour.';
  sfnIsoWeekNum = 'ISOWEEKNUM';
  sfnIsoWeekNumDescription =
    'Returns the ISO number of the week to which the specified date belongs.';
  sfnMinute = 'MINUTE';
  sfnMinuteDescription =
    'Converts a serial number to the corresponding minute.';
  sfnMonth = 'MONTH';
  sfnMonthDescription = 'Converts a serial number to the corresponding month.';
  sfnNetworkDays = 'NETWORKDAYS';
  sfnNetworkDaysDescription =
  ...
  sfnNetworkDays_IntlDescription =
  ...
  sfnSecond = 'SECOND';
  sfnSecondDescription =
    'Converts a serial number to the corresponding second.';
  sfnTime = 'TIME';
  sfnTimeDescription =
    'Converts the specified time to the corresponding serial number.';
  sfnTimeValue = 'TIMEVALUE';
  sfnTimeValueDescription =
    'Converts a text time representation into a date/time value.';
  sfnToday = 'TODAY';
  sfnTodayDescription =
    'Returns the serial number corresponding to the current date.';
  sfnWeekDay = 'WEEKDAY';
  sfnWeekDayDescription =
    'Returns the day of the week corresponding to the specified date value.';
  sfnWeekNum = 'WEEKNUM';
  sfnWeekNumDescription =
  ...
  sfnYear = 'YEAR';
  sfnYearDescription =
    'Returns the serial number corresponding to the specified year.';
  sfnYearFrac = 'YEARFRAC';
  sfnYearFracDescription =
    'Calculates the fraction of the year within the range between two specified dates.';

  // Financial function names
  sfnAccrInt = 'ACCRINT';
  sfnAccrIntDescription =
    'Returns the accrued interest for a security that pays a periodic interest.';
  sfnAccrIntM = 'ACCRINTM';
  sfnAccrIntMDescription =
    'Returns the accrued interest for a security that pays at maturity.';
  sfnAmorDegr = 'AMORDEGRC';
  sfnAmorDegrDescription =
    'Returns the depreciation of an asset for each accounting period. This function is provided for the French accounting system.';
  sfnAmorLinc = 'AMORLINC';
  sfnAmorLincDescription =
    'Returns the depreciation for each accounting period.';
  sfnCoupDayBS = 'COUPDAYBS';
  sfnCoupDayBSDescription =
    'Returns the number of days from the beginning of the coupon period to the settlement date.';
  sfnCoupDays = 'COUPDAYS';
  sfnCoupDaysDescription =
    'Returns the number of days in the coupon period that contains the settlement date.';
  sfnCoupDaysNC = 'COUPDAYSNC';
  sfnCoupDaysNCDescription =
    'Returns the number of days from the settlement date to the next coupon date.';
  sfnCoupNCD = 'COUPNCD';
  sfnCoupNCDDescription =
    'Returns the next coupon date after the settlement date.';
  sfnCoupNum = 'COUPNUM';
  sfnCoupNumDescription =
    'Returns the number of coupons payable between the settlement date and maturity date.';
  sfnCoupPCD = 'COUPPCD';
  sfnCoupPCDDescription =
    'Returns the previous coupon date before the settlement date.';
  sfnCoupIPMT = 'CUMIPMT';
  sfnCoupIPMTDescription =
    'Calculates the cumulative interest paid between two specified periods.';
  sfnCoupRINC = 'CUMPRINC';
  sfnCoupRINCDescription =
  ...
  sfnFVScheduleDescription =
    'Returns the future value of an initial principal after applying a series of compound interest rates.';
  sfnIntRate = 'INTRATE';
  sfnIntRateDescription =
  ...
  sfnPrice = 'PRICE';
  sfnPriceDescription =
    'Returns the price per $100 face value of a security that pays a periodic interest.';
  sfnPriceDisc = 'PRICEDISC';
  sfnPriceDiscDescription =
    'Returns the price per $100 face value of a discounted security.';
  sfnPriceMat = 'PRICEMAT';
  sfnPriceMatDescription =
  ...
  sfnTBillEq = 'TBILLEQ';
  sfnTBillEqDescription =
    'Returns the bond-equivalent yield for a Treasury bill.';
  sfnTBillPrice = 'TBILLPRICE';
  sfnTBillPriceDescription =
  ...
  sfnYield = 'YIELD';
  sfnYieldDescription =
    'Returns the yield on a security that pays a periodic interest.';
  sfnYieldDisc = 'YIELDDISC';
  sfnYieldDiscDescription =
    'Returns the annual yield for a discounted security; for example, a Treasury bill.';
  sfnYieldMat = 'YIELDMAT';
  sfnYieldMatDescription =
  ...
  sfnFormulaTextDescription =
    'Returns a text representation of the specified formula expression.';
  sfnGetPivotData = 'GETPIVOTDATA';
  sfnGetPivotDataDescription = 'Returns data stored in a Pivot Table report.';
  sfnHLookup = 'HLOOKUP';
  sfnHLookupDescription =
  ...
  sfnOffset = 'OFFSET';
  sfnOffsetDescription =
    'Returns a reference to a range that is located a specified number of rows and columns away from a cell or cell range.';
  sfnRow = 'ROW';
...
begin
  ...
  AProduct.Add('sfnBinom_Dist_RangeDescription',
    @sfnBinom_Dist_RangeDescription);
  ...
  AProduct.Add('sfnNetworkDays_IntlDescription',
    @sfnNetworkDays_IntlDescription);
...
dxResourceStringsRepository.RegisterProduct('ExpressSpreadSheet 2',
  @AddSpreadSheetResourceStringNames);
