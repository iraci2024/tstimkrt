...
type
  ...
  public
    ...
    property ContainerWidthsInfo: TdxWidthsContentInfo read FContainerWidthsInfo
      write SetContainerWidthsInfo;
    property ContentWidthsInfo: TdxWidthsContentInfo read FContentWidthsInfo
      write SetContentWidthsInfo;
  end;
  ...
  public
    ...
    function GetBorder(ABorders: TdxTableCellBorders): TdxBorderBase; overload;
      virtual; abstract;
    function GetBorder(ABorders: TdxTableBorders): TdxBorderBase; overload;
      virtual; abstract;
    function GetInsideBorder(ABorders: TdxTableCellBorders): TdxBorderBase;
      overload; virtual; abstract;
    function GetInsideBorder(ABorders: TdxTableBorders): TdxBorderBase;
      overload; virtual; abstract;

    function GetTableBorder(ABorders: TdxTableBorders; AIsInside: Boolean)
      : TdxBorderBase;
  end;
  ...
  strict private
    ...
    function GetCellConditionalFormattingMasks
      : TdxConditionalTableStyleFormattingTypes;
  ...
  protected
    function GetTableCellPropertiesSource(AMask: Integer)
      : TdxTableCellProperties;
    function GetActualCellMarginBase(AAccessor
      : TdxMarginUnitBase.TdxMarginPropertyAccessorBase)
      : TdxMarginUnitBase; virtual;
    function GetActualCellBorder(ABorderAccessor: TdxTableBorderAccessor;
    ...
    procedure OnCellPropertiesObtainAffectedRange(ASender: TObject;
      E: TdxObtainAffectedRangeEventArgs); virtual;
  public
    ...
    function GetEndColumnIndexConsiderRowGrid(AStartColumnIndex: Integer)
      : Integer; overload;

    function GetParentMergedTableCellProperties
      : TdxMergedTableCellProperties; virtual;
    ...
    property ConditionalType: TdxConditionalColumnType read FConditionalType
      write FConditionalType;
    ...
    property CellConditionalFormattingMasks
      : TdxConditionalTableStyleFormattingTypes
      read GetCellConditionalFormattingMasks;
    ...
    property LayoutProperties: TdxTableCellLayoutProperties
      read FLayoutProperties;
  end;
  ...
  protected
    ...
    procedure OnRowPropertiesObtainAffectedRange(ASender: TObject;
  ...
  public
    ...
    property DocumentModel: TdxSimpleDocumentModel read GetDocumentModel;
    property PieceTable: TdxSimplePieceTable read GetPieceTable;
    property LayoutProperties: TdxTableRowLayoutProperties
      read FLayoutProperties;
    property TablePropertiesException: TdxTableProperties
      read FTablePropertiesException;
    property ConditionalType: TdxConditionalRowType read FConditionalType
      write FConditionalType;
  ...
  public
    ...
    property TotalHorizontalMargins: TdxLayoutUnit read FTotalHorizontalMargins
      write SetTotalHorizontalMargins;
    property MaxWidth: TdxLayoutUnit read FMaxWidth write SetMaxWidth;
    property PreferredWidth: TdxLayoutUnit read FPreferredWidth
  ...
  strict private
    ...
    FWidth: TdxLayoutUnit;
  public
    constructor Create(AWidth: TdxLayoutUnit; AColSpan: Integer;
    ...
    property IntervalType: TdxTableGridIntervalType read FIntervalType
      write FIntervalType;
  end;
  ...
  public
    constructor Create(AIntervals: TdxTableGridIntervalList;
      APercentBaseWidth: Integer);
    destructor Destroy; override;
    procedure Reset;
    function Advance(const AInterval: TdxTableGridInterval): Boolean;
    class function SubstructIntervals(const AInterval1,
      AInterval2: TdxTableGridInterval; ABaseWidth1, ABaseWidth2: Integer)
      : TdxTableGridInterval; static;
    ...
    property CurrentInterval: TdxNullableValue<TdxTableGridInterval>
      read FCurrentInterval;
  end;
  ...
  strict private
    ...
    FPercentBaseWidth: Integer;
  public
    constructor Create(ATableGrid: TdxTableGrid; AMaxTableWidth: Integer;
      AAllowTablesToExtendIntoMargins, ASimpleView: Boolean;
      APercentBaseWidth: Integer);
    destructor Destroy; override;
    function CanUseTableGrid(AMaxTableWidth: Integer;
      AAllowTablesToExtendIntoMargins, ASimpleView: Boolean;
  ...
  public
    constructor Create(APieceTable: TdxSimplePieceTable;
      AParentCell: TdxTableCell = nil; ARowCount: Integer = 1;
      ACellCount: Integer = 1); overload;
    destructor Destroy; override;

    function GetCellCore(ARowIndex, AColumnIndex: Integer)
      : TdxCustomTableCell; override;
    function GetIndexCore: Integer; override;
    ...
    function GetTablePropertiesSource(AMask: Integer)
      : TdxTableProperties; overload;
    function GetTablePropertiesSourceForCell(AMask: Integer;
      ATableCell: TdxTableCell): TdxTableProperties; overload;
    function GetTablePropertiesSourceForCell(AMask: Integer;
      ATableCell: TdxTableCell; AIsBorderCell: Boolean;
      out AInsideBorder: Boolean): TdxTableProperties; overload;
    function GetTablePropertiesSource(AMask: Integer;
      ARowIndex, AColumnIndex: Integer): TdxTableProperties; overload;
    function GetTablePropertiesSource(AMask: Integer;
      ARowIndex, AColumnIndex: Integer; AIsBorderCell: Boolean;
      out AInsideBorder: Boolean): TdxTableProperties; overload;
    function GetTablePropertiesSource(AMask: Integer;
    ...
    function GetTablePropertiesSource(AMask: Integer;
      ARowType: TdxConditionalRowType; AColumnType: TdxConditionalColumnType;
      AIsBorderCell: Boolean; out AInsideBorder: Boolean): TdxTableProperties;
      overload; virtual;
    function GetColumnTypeByIndex(ARowIndex, AColumnIndex: Integer)
      : TdxConditionalColumnType;
    function HasColumnStyle(AStyle: TdxTableStyle;
      AType: TdxConditionalColumnType): Boolean;
    function GetColumnTypeByIndexCore(ARowIndex, AColumnIndex: Integer)
      : TdxConditionalColumnType;
    function GetRowTypeByIndex(ARowIndex: Integer): TdxConditionalRowType;
    function HasRowStyle(AStyle: TdxTableStyle;
      AType: TdxConditionalRowType): Boolean;
    ...
    function GetMergedWithStyleTableProperties
      : TdxMergedTableProperties; virtual;
    function GetMergedCharacterProperties(ACell: TdxTableCell)
      : TdxMergedCharacterProperties; overload;
    procedure SetTableStyleIndexCore(ANewStyleIndex: Integer);
    function GetCell(ARow: TdxTableRow; AColumnIndex: Integer)
      : TdxTableCell; overload;
    function GetCell(ARowIndex, AColumnIndex: Integer): TdxTableCell; overload;
    function GetAbsoluteCellIndexInRow(ARow: TdxTableRow; AColumnIndex: Integer;
    ...
    function GetLastCellColumnIndexConsiderRowGrid(ARow: TdxTableRow;
      ALayoutIndex: Boolean): Integer;
    ...
    procedure NormalizeCellColumnSpans(ACanNormalizeWidthBeforeAndWidthAfter
      : Boolean); overload;
    procedure NormalizeRowsGridBefore(ARows: TdxTableRowCollection;
      ACanNormalizeWidthBeforeAndWidthAfter: Boolean);
    procedure NormalizeRowGridBefore(ARow: TdxTableRow;
      ACanNormalizeWidthBeforeAndWidthAfter: Boolean;
      AMinGridBefore, AMinGridAfter: Integer);
    procedure NormalizeRowGridBeforeCore(ARow: TdxTableRow;
      ACanNormalizeWidthBeforeAndWidthAfter: Boolean;
      AMinGridBefore, AMinGridAfter: Integer);
    procedure NormalizeTableRow(ARow: TdxTableRow;
      AGridIntervals: TdxTableGridIntervalList; ARowIndex: Integer);
    procedure NormalizeTableRowCore(ARow: TdxTableRow;
      AGridIntervals: TdxTableGridIntervalList; ARowIndex: Integer);
    function CalculateNewSpan(AOldSpan: Integer;
      AIntervalIterator: TdxTableGridIntervalIterator): Integer;
    procedure NormalizeTableCellVerticalMerging; virtual;
    procedure SubscribeTablePropertiesEvents; virtual;
    procedure OnPropertiesObtainAffectedRangeCore
      (E: TdxObtainAffectedRangeEventArgs); overload; virtual;
    procedure OnPropertiesObtainAffectedRangeCore
      (E: TdxObtainAffectedRangeEventArgs; AFirstRowIndex: Integer);
      overload; virtual;
    procedure OnTablePropertiesObtainAffectedRange(ASender: TObject;
      E: TdxObtainAffectedRangeEventArgs); virtual;
    ...
    function GetFirstCellInVerticalMergingGroup(ATableCell: TdxTableCell)
      : TdxTableCell; virtual;
    procedure RemoveInvalidVerticalSpans(AFixLastRow: Boolean); virtual;
    procedure RemoveInvalidVerticalSpansFromTableWithOneRow
    ...
    procedure InitializeColumnWidths(AAutoFitBehavior
      : TdxTableAutoFitBehaviorType; AFixedColumnWidths, AOuterColumnWidth
      : Integer; AMatchHorizontalTableIndentsToTextEdge: Boolean);
    function DistributeWidthsToAllColumns(AWidth, ACount: Integer)
      : TArray<Integer>;
    function IsCellWidthDefined(AFixedColumnWidths: Integer): Boolean;
    procedure SetAllColumnsWidthsToFixedColumnWidths(AFixedColumnWidths
      : Integer); virtual;
    procedure DistributeHundredPercentToAllColumns; virtual;
    procedure ApplyWidthPercentBased(ACell: TdxTableCell;
      AColumnWidthInFiftiethsOfPercent, ALastColumnCorrection: Integer);
    procedure ApplyWidthModelUnits(ACell: TdxTableCell;
      AFixedColumnWidths: Integer);
    function GetTableWidth(ATable: TdxTable; AColumnWidth: Integer;
    ...
    function GetTableCellConditionalTypes(ATableCell: TdxTableCell)
      : TdxConditionalTableStyleFormattingTypes;
    function GetTableCellProperties(AMask: Integer; ATableCell: TdxTableCell)
      : TdxTableCellProperties;
    function GetCharacterProperties(AMask: TdxUsedCharacterFormattingOption;
      ATableCell: TdxTableCell): TdxCharacterProperties;
    function GetParagraphProperties(AMask: TdxUsedParagraphFormattingOption;
      ATableCell: TdxTableCell): TdxParagraphProperties;
    function GetMergedCharacterProperties(ACell: TdxTableCell;
      ATableStyle: TdxTableStyle): TdxMergedCharacterProperties; overload;
    function GetMergedParagraphProperties(ATableCell: TdxTableCell)
      : TdxMergedParagraphProperties; overload;
    function GetMergedParagraphProperties(ATableStyle: TdxTableStyle;
      ATableCell: TdxTableCell): TdxMergedParagraphProperties; overload;
    function GetTableRowProperties(AMask: Integer; ATableRow: TdxTableRow)
    ...
    property CachedTableLayoutInfo: TdxTableLayoutInfo
      read FCachedTableLayoutInfo write FCachedTableLayoutInfo;
  ...
  public
    constructor Create(AAboveCell, ABelowCell: TdxTableCell;
      ABorder: TdxBorderBase; AStartColumnIndex, AEndColumnIndex: Integer);
  ...
  TdxNullableHorizontalCellBordersInfo =
    TdxNullableValue<TdxHorizontalCellBordersInfo>;

  { TdxHorizontalCellBordersInfoList }

  TdxHorizontalCellBordersInfoList = class sealed
    (TList<TdxHorizontalCellBordersInfo>)
  public
  ...
  public
    constructor Create(AInitialPositions, AAlignedPositions
  ...
  public
    ...
    procedure SetFirstSelectedCell(AStartCell: TdxTableCell;
      APos: TdxDocumentLogPosition); virtual; abstract;
    ...
    property OriginalStartLogPosition: TdxDocumentLogPosition
      read FOriginalStartLogPosition write FOriginalStartLogPosition;
  ...
  public
    ...
    procedure AddCollectionChangedHandler(const AHandler
      : TdxNotificationCollectionChangedEvent);
    procedure RemoveCollectionChangedHandler(const AHandler
      : TdxNotificationCollectionChangedEvent);
  ...
  public
    class function CalculateChangeActions(AChange: TdxTableChangeType)
...
type
  ...
  public
    ...
    function GetInsideBorder(ABorders: TdxTableCellBorders)
      : TdxBorderBase; override;
    function GetInsideBorder(ABorders: TdxTableBorders): TdxBorderBase;
      override;
  end;
...
function TdxTableLeftBorderAccessor.GetBorder(ABorders: TdxTableCellBorders)
  : TdxBorderBase;
begin
  Result := ABorders.LeftBorder;
end;

function TdxTableLeftBorderAccessor.GetBorder(ABorders: TdxTableBorders)
  : TdxBorderBase;
begin
  Result := ABorders.LeftBorder;
end;

function TdxTableLeftBorderAccessor.GetInsideBorder
  (ABorders: TdxTableCellBorders): TdxBorderBase;
begin
  Result := ABorders.InsideVerticalBorder;
end;

function TdxTableLeftBorderAccessor.GetInsideBorder(ABorders: TdxTableBorders)
  : TdxBorderBase;
begin
  Result := ABorders.InsideVerticalBorder;
end;
...
function TdxTableRightBorderAccessor.GetBorder(ABorders: TdxTableCellBorders)
  : TdxBorderBase;
begin
  Result := ABorders.RightBorder;
end;

function TdxTableRightBorderAccessor.GetBorder(ABorders: TdxTableBorders)
  : TdxBorderBase;
begin
  Result := ABorders.RightBorder;
end;

function TdxTableRightBorderAccessor.GetInsideBorder
  (ABorders: TdxTableCellBorders): TdxBorderBase;
begin
  Result := ABorders.InsideVerticalBorder;
end;

function TdxTableRightBorderAccessor.GetInsideBorder(ABorders: TdxTableBorders)
  : TdxBorderBase;
begin
  Result := ABorders.InsideVerticalBorder;
end;
...
function TdxTableTopBorderAccessor.GetBorder(ABorders: TdxTableCellBorders)
  : TdxBorderBase;
begin
  Result := ABorders.TopBorder;
end;

function TdxTableTopBorderAccessor.GetBorder(ABorders: TdxTableBorders)
  : TdxBorderBase;
begin
  Result := ABorders.TopBorder;
end;

function TdxTableTopBorderAccessor.GetInsideBorder
  (ABorders: TdxTableCellBorders): TdxBorderBase;
begin
  Result := ABorders.InsideHorizontalBorder;
end;

function TdxTableTopBorderAccessor.GetInsideBorder(ABorders: TdxTableBorders)
  : TdxBorderBase;
begin
  Result := ABorders.InsideHorizontalBorder;
end;
...
function TdxTableBottomBorderAccessor.GetBorder(ABorders: TdxTableCellBorders)
  : TdxBorderBase;
begin
  Result := ABorders.BottomBorder;
end;

function TdxTableBottomBorderAccessor.GetBorder(ABorders: TdxTableBorders)
  : TdxBorderBase;
begin
  Result := ABorders.BottomBorder;
end;

function TdxTableBottomBorderAccessor.GetInsideBorder
  (ABorders: TdxTableCellBorders): TdxBorderBase;
begin
  Result := ABorders.InsideHorizontalBorder;
end;

function TdxTableBottomBorderAccessor.GetInsideBorder(ABorders: TdxTableBorders)
  : TdxBorderBase;
begin
  Result := ABorders.InsideHorizontalBorder;
end;
...
function TdxTableBorderAccessor.GetTableBorder(ABorders: TdxTableBorders;
  AIsInside: Boolean): TdxBorderBase;
begin
  if AIsInside then
...
procedure TdxTableCollection.AddCollectionChangedHandler(const AHandler
  : TdxNotificationCollectionChangedEvent);
begin
  FTables.AddChangedHandler(AHandler);
end;

procedure TdxTableCollection.RemoveCollectionChangedHandler(const AHandler
  : TdxNotificationCollectionChangedEvent);
begin
...
function TdxTableCell.GetActualCellBorder(ABorderAccessor
  : TdxTableBorderAccessor; AIsBorderCell: Boolean): TdxBorderBase;
var
  ACellSpacing: Integer;
  AInsideBorder: Boolean;
  AProperties: TdxTableProperties;
  ATableStyleCellProperties, ATableCellStyleCellProperties
    : TdxTableCellProperties;
begin
  if Properties.GetUse(ABorderAccessor.CellUseMask) then
    Exit(ABorderAccessor.GetBorder(Properties.Borders));
  ATableCellStyleCellProperties := TableCellStyle.GetTableCellProperties
    (ABorderAccessor.CellUseMask);
  if ATableCellStyleCellProperties <> nil then
    Exit(ABorderAccessor.GetBorder(ATableCellStyleCellProperties.Borders));

  ATableStyleCellProperties := Table.GetTableCellProperties
    (ABorderAccessor.CellUseMask, Self);
  ...
  begin
    ...
    AProperties := Table.GetTablePropertiesSourceForCell
      (ABorderAccessor.UseMask, Self, True, AInsideBorder);
    if AProperties <> nil then
      Exit(ABorderAccessor.GetBorder(AProperties.Borders));
  end
  else
  begin
    if Row.TablePropertiesException.GetUse(ABorderAccessor.UseInsideBorderMask)
    then
      Exit(ABorderAccessor.GetInsideBorder
        (Row.TablePropertiesException.Borders));
    AProperties := Table.GetTablePropertiesSourceForCell
      (ABorderAccessor.UseMask, Self, False, AInsideBorder);
    if AProperties <> nil then
      Exit(ABorderAccessor.GetTableBorder(AProperties.Borders, AInsideBorder));
  end;
  Assert(False);
  Result := ABorderAccessor.GetBorder
    ((DocumentModel as IdxDefaultTablePropertiesContainer)
    .DefaultTableCellProperties.Borders);
end;
...
begin
  Result := GetTableCellPropertiesSource
    (TdxTableCellPropertiesOptions.MaskUseBackgroundColor).BackgroundColor;
end;

function TdxTableCell.GetForegroundColor: TdxAlphaColor;
begin
  Result := GetTableCellPropertiesSource
    (TdxTableCellPropertiesOptions.MaskUseForegroundColor).ForegroundColor;
end;

function TdxTableCell.GetCellConditionalFormatting
  : TdxConditionalTableStyleFormattingTypes;
begin
  Result := GetTableCellPropertiesSource
    (TdxTableCellPropertiesOptions.MaskUseCellConditionalFormatting)
    .CellConditionalFormatting;
end;

function TdxTableCell.GetCellConditionalFormattingMasks
  : TdxConditionalTableStyleFormattingTypes;
begin
...
function TdxTableCell.GetEndColumnIndexConsiderRowGrid(AStartColumnIndex
  : Integer): Integer;
begin
...
begin
  Result := GetEndColumnIndexConsiderRowGrid
...
begin
  Result := GetTableCellPropertiesSource
    (TdxTableCellPropertiesOptions.MaskUseFitText).FitText;
end;

function TdxTableCell.GetHideCellMark: Boolean;
begin
  Result := GetTableCellPropertiesSource
    (TdxTableCellPropertiesOptions.MaskUseHideCellMark).HideCellMark;
end;
...
function TdxTableCell.GetMergedCharacterProperties
  : TdxMergedCharacterProperties;
begin
  Result := TableCellStyle.GetMergedCharacterProperties
    (Table.GetRowTypeByIndex(RowIndex), Table.GetColumnTypeByIndex(RowIndex,
    IndexInRow));
end;

function TdxTableCell.GetMergedParagraphProperties
  : TdxMergedParagraphProperties;
begin
  Result := TableCellStyle.GetMergedParagraphProperties
    (Table.GetRowTypeByIndex(RowIndex), Table.GetColumnTypeByIndex(RowIndex,
    IndexInRow));
end;
...
begin
  Result := GetActualLeftMargin.Value + GetActualRightMargin.Value +
    GetActualRightCellBorder.Width + GetActualLeftCellBorder.Width;
end;
...
begin
  Result := GetTableCellPropertiesSource
    (TdxTableCellPropertiesOptions.MaskUseNoWrap).NoWrap;
end;

function TdxTableCell.GetParentMergedTableCellProperties
...
begin
  ...
  try
    ...
    ATableCellProperties := Table.TableStyle.GetMergedTableCellProperties
      (Table.GetRowTypeByIndex(RowIndex), Table.GetColumnTypeByIndex(RowIndex,
      IndexInRow));
    try
    ...
    Result.Merge((DocumentModel as IdxDefaultTablePropertiesContainer)
...
function TdxTableCell.GetActualCellMarginBase
  (AAccessor: TdxMarginUnitBase.TdxMarginPropertyAccessorBase)
  : TdxMarginUnitBase;
var
...
begin
  ...
  begin
    if ACurrentCellStyle.TableCellProperties.GetUse(AAccessor.CellPropertiesMask)
    then
      Exit(AAccessor.GetValue(ACurrentCellStyle.TableCellProperties.
        CellMargins));
  ...
  begin
    if ACurrentTableStyle.TableCellProperties.GetUse
      (AAccessor.CellPropertiesMask) then
      Exit(AAccessor.GetValue(ACurrentTableStyle.TableCellProperties.
        CellMargins));
  ...
  while ACurrentTableStyle <> nil do
  begin
    if ACurrentTableStyle.TableProperties.GetUse(AAccessor.TablePropertiesMask)
    then
      Exit(AAccessor.GetValue(ACurrentTableStyle.TableProperties.CellMargins));
    ACurrentTableStyle := ACurrentTableStyle.Parent;
  end;
  Result := AAccessor.GetValue
    ((DocumentModel as IdxDefaultTablePropertiesContainer)
    .DefaultTableCellProperties.CellMargins);
end;
...
begin
  Result := GetTableCellPropertiesSource
    (TdxTableCellPropertiesOptions.MaskUsePreferredWidth).PreferredWidth;
end;
...
begin
  Result := GetTableCellPropertiesSource
    (TdxTableCellPropertiesOptions.MaskUseShading).Shading;
end;
...
function TdxTableCell.GetTableCellPropertiesSource(AMask: Integer)
  : TdxTableCellProperties;
var
...
begin
  ...
  Result := (DocumentModel as IdxDefaultTablePropertiesContainer)
    .DefaultTableCellProperties;
end;

function TdxTableCell.GetTableCellStyle: TdxTableCellStyle;
begin
  Result := (DocumentModel as IdxTableStylesContainer).TableCellStyles
    [StyleIndex];
end;
...
begin
  Result := GetTableCellPropertiesSource
    (TdxTableCellPropertiesOptions.MaskUseTextDirection).TextDirection;
end;

function TdxTableCell.GetVerticalAlignment: TdxVerticalAlignment;
begin
  Result := GetTableCellPropertiesSource
    (TdxTableCellPropertiesOptions.MaskUseVerticalAlignment).VerticalAlignment;
end;
...
begin
  Result := TdxTableCellVerticalBorderCalculator.GetVerticalSpanCells
    (Self, False);
end;

procedure TdxTableCell.OnCellPropertiesObtainAffectedRange(ASender: TObject;
  E: TdxObtainAffectedRangeEventArgs);
var
...
procedure TdxTableCell.SetCellConditionalFormatting
...
begin
  ...
  try
    AItem := TdxChangeTableCellStyleIndexHistoryItem.Create(PieceTable,
      Table.Index, RowIndex, IndexInRow, FStyleIndex, Value);
...
begin
  ...
  for I := StartParagraphIndex to EndParagraphIndex do
    PieceTable.Paragraphs[I].ResetCachedIndices
      (TdxResetFormattingCacheType.All);
  ...
  begin
    ...
    PieceTable.ApplyChangesCore
      (TdxTableChangeActionCalculator.CalculateChangeActions
...
begin
  ...
  AParentCellEndParagraph := PieceTable.Paragraphs
    [AParentCellEndParagraphIndex];
  Result := PieceTable.VisibleTextFilter.GetNextVisibleRunIndex
    (ALastCellEndParagraph.LastRunIndex) >=
    AParentCellEndParagraph.LastRunIndex;
end;

function TdxTableCell.CreateCellPropertiesChangedHistoryItem
  (AProperties: TdxTableCellProperties): TdxIndexChangedHistoryItemCore;
begin
  Assert(AProperties = Properties);
  Result := TdxTableCellPropertiesChangedHistoryItem.Create(PieceTable,
    StartParagraphIndex, Table.NestedLevel);
end;
...
begin
  if not IsFirstRow or (Table.ParentCell = nil) then
    ...
    Result := Row.FirstCell.StartParagraphIndex = Table.ParentCell.
      StartParagraphIndex;
end;
...
constructor TdxTableCellCollection.Create(ARow: TdxTableRow;
  ACellCount: Integer);
var
  I: Integer;
begin
...
function TdxTableCellCollection.ExtractInternal(ACell: TdxTableCell)
  : TdxTableCell;
begin
...
begin
  if TablePropertiesException.GetUse
    (TdxTablePropertiesOptions.MaskUseBottomMargin) then
...
begin
  Result := GetTableRowPropertiesSource
    (TdxTableRowPropertiesOptions.MaskUseCantSplit).CantSplit;
end;
...
begin
  ...
  if TablePropertiesException.GetUse
    (TdxTablePropertiesOptions.MaskUseCellSpacing) then
    Exit(TablePropertiesException.CellSpacing);

  ATableCellsSpacing := Table.CellSpacing;
  if ATableCellsSpacing <> (DocumentModel as IdxDefaultTablePropertiesContainer)
    .DefaultTableProperties.CellSpacing then
    Exit(ATableCellsSpacing);

  AResult := Table.GetTableRowProperties
    (TdxTableRowPropertiesOptions.MaskUseCellSpacing, Self);
  if AResult <> nil then
    Exit(AResult.CellSpacing);

  Result := (DocumentModel as IdxDefaultTablePropertiesContainer)
    .DefaultTableRowProperties.CellSpacing;
end;

function TdxTableRow.GetGridAfter: Integer;
begin
  Result := GetTableRowPropertiesSource
    (TdxTableRowPropertiesOptions.MaskUseGridAfter).GridAfter;
end;

function TdxTableRow.GetGridBefore: Integer;
begin
  Result := GetTableRowPropertiesSource
    (TdxTableRowPropertiesOptions.MaskUseGridBefore).GridBefore;
end;

function TdxTableRow.GetHeader: Boolean;
begin
  Result := GetTableRowPropertiesSource
    (TdxTableRowPropertiesOptions.MaskUseHeader).Header;
end;

function TdxTableRow.GetHeight: TdxHeightUnit;
begin
  Result := GetTableRowPropertiesSource
    (TdxTableRowPropertiesOptions.MaskUseHeight).Height;
end;

function TdxTableRow.GetHideCellMark: Boolean;
begin
  Result := GetTableRowPropertiesSource
    (TdxTableRowPropertiesOptions.MaskUseHideCellMark).HideCellMark;
end;
...
begin
  if TablePropertiesException.GetUse(TdxTablePropertiesOptions.MaskUseLeftMargin)
  then
...
function TdxTableRow.GetParentMergedTableRowProperties
  : TdxMergedTableRowProperties;
var
  ATableRowProperties: TdxMergedTableRowProperties;
begin
  ATableRowProperties := Table.TableStyle.GetMergedTableRowProperties
    (FTable.GetRowTypeByIndex(IndexInTable));
  try
...
begin
  if TablePropertiesException.GetUse
    (TdxTablePropertiesOptions.MaskUseRightMargin) then
...
begin
  if Properties.GetUse(TdxTableRowPropertiesOptions.MaskUseTableRowAlignment)
  then
    Exit(Properties.TableRowAlignment);

  if TablePropertiesException.GetUse
    (TdxTablePropertiesOptions.MaskUseTableAlignment) then
    Exit(TablePropertiesException.TableAlignment);

  Result := Table.TableAlignment;
end;

function TdxTableRow.GetTableRowPropertiesSource(AMask: Integer)
  : TdxTableRowProperties;
begin
  if Properties.GetUse(AMask) then
    Exit(Properties);
...
begin
  if TablePropertiesException.GetUse(TdxTablePropertiesOptions.MaskUseTopMargin)
  then
...
begin
  Result := GetTableRowPropertiesSource
    (TdxTableRowPropertiesOptions.MaskUseWidthAfter).WidthAfter;
end;

function TdxTableRow.GetWidthBefore: TdxWidthUnit;
begin
  Result := GetTableRowPropertiesSource
    (TdxTableRowPropertiesOptions.MaskUseWidthBefore).WidthBefore;
end;

procedure TdxTableRow.OnRowPropertiesObtainAffectedRange(ASender: TObject;
  E: TdxObtainAffectedRangeEventArgs);
begin
...
constructor TdxTableRowCollection.Create(AOwner: TdxTable;
...
constructor TdxTableGridColumn.Create(AWidth: TdxLayoutUnit;
APercentBased: Boolean);
begin
  inherited Create;
  Assert(AWidth >= 0);
  FWidth := AWidth;
...
procedure TdxTableGridColumn.SetTotalHorizontalMargins
  (const Value: TdxLayoutUnit);
begin
  Assert(Value >= 0);
...
constructor TdxTableGridInterval.Create(AWidth: TdxLayoutUnit;
AColSpan: Integer; AIntervalType: TdxTableGridIntervalType);
begin
  FWidth := AWidth;
  FColSpan := AColSpan;
...
class operator TdxTableGridInterval.Equal(const A,
  B: TdxTableGridInterval): Boolean;
begin
...
begin
  ...
  for I := 0 to AIntervals.Count - 1 do
    FColumnsCollection.Add(TdxTableGridColumn.Create(AIntervals[I].Width,
      AIntervals[I].IntervalType = TdxTableGridIntervalType.PercentBased));
end;
...
constructor TdxTableGridIntervalIterator.Create
  (AIntervals: TdxTableGridIntervalList; APercentBaseWidth: Integer);
begin
  inherited Create;
...
function TdxTableGridIntervalIterator.Advance(const AInterval
  : TdxTableGridInterval): Boolean;
begin
  ...
  begin
    FCurrentInterval := SubstructIntervals(CurrentInterval.Value, AInterval,
      PercentBaseWidth, PercentBaseWidth);
    Result := True;
  end;
end;
...
begin
  ...
  if AInterval1.IntervalType = TdxTableGridIntervalType.NotSet then
    Result := TdxTableGridInterval.Create(0, AColumnSpan,
      AInterval1.IntervalType)
  else
  begin
    if AInterval2.IntervalType = TdxTableGridIntervalType.NotSet then
      Result := TdxTableGridInterval.Create(AInterval1.Width, AColumnSpan,
        AInterval1.IntervalType)
    else
    begin
      if AInterval1.IntervalType = AInterval2.IntervalType then
        Result := TdxTableGridInterval.Create
          (Max(AInterval1.Width - AInterval2.Width, 0), AColumnSpan,
          AInterval1.IntervalType)
      else if AInterval2.IntervalType = TdxTableGridIntervalType.PercentBased
      then
        Result := TdxTableGridInterval.Create
          (Max(0, AInterval1.Width - MulDiv(ABaseWidth1, AInterval2.Width, 5000)
          ), AColumnSpan, AInterval1.IntervalType)
      else
        Result := TdxTableGridInterval.Create
          (Max(0, AInterval2.Width - MulDiv(ABaseWidth2, AInterval1.Width, 5000)
          ), AColumnSpan, AInterval2.IntervalType)
    end;
  end;
end;
...
constructor TdxTableLayoutInfo.Create(ATableGrid: TdxTableGrid;
AMaxTableWidth: Integer; AAllowTablesToExtendIntoMargins, ASimpleView: Boolean;
APercentBaseWidth: Integer);
begin
  inherited Create;
...
function TdxTableLayoutInfo.CanUseTableGrid(AMaxTableWidth: Integer;
AAllowTablesToExtendIntoMargins, ASimpleView: Boolean;
APercentBaseWidth: Integer): Boolean;
begin
...
constructor TdxTable.Create(APieceTable: TdxSimplePieceTable;
AParentCell: TdxTableCell = nil; ARowCount: Integer = 1;
...
procedure TdxTable.ApplyWidthModelUnits(ACell: TdxTableCell;
AFixedColumnWidths: Integer);
begin
...
procedure TdxTable.ApplyWidthPercentBased(ACell: TdxTableCell;
AColumnWidthInFiftiethsOfPercent, ALastColumnCorrection: Integer);
begin
  ...
  if ACell.IsLastCellInRow then
    ACell.Properties.PreferredWidth.Value :=
      ACell.Properties.PreferredWidth.Value + ALastColumnCorrection;
end;

function TdxTable.CalculateNewSpan(AOldSpan: Integer;
AIntervalIterator: TdxTableGridIntervalIterator): Integer;
var
  ATotalSum: Integer;
begin
...
var
  ...
  AColumnsCount, AColumnWidthInFiftiethsOfPercent,
...
begin
  ...
  AApplyWidthPercentBased := procedure(ACell: TdxTableCell)
    begin
      ApplyWidthPercentBased(ACell, AColumnWidthInFiftiethsOfPercent,
        ALastColumnCorrection);
    end;
  ForEachCell(AApplyWidthPercentBased);
end;

function TdxTable.DistributeWidthsToAllColumns(AWidth, ACount: Integer)
  : TArray<Integer>;
var
...
procedure TdxTable.ForEachCell(const ACellProcessor
  : TdxTableCellProcessorDelegate);
var
  I, J: Integer;
  ARows: TdxTableRowCollection;
  ACells: TdxTableCellCollection;
...
procedure TdxTable.ForEachRow(const ARowProcessor
...
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUseInsideVerticalBorder)
...
function TdxTable.GetAbsoluteCellIndexInRow(ARow: TdxTableRow;
AColumnIndex: Integer; ALayoutIndex: Boolean): Integer;
var
...
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUseBottomBorder).Borders.BottomBorder;
end;

function TdxTable.GetActualInsideHorizontalBorder: TdxInsideHorizontalBorder;
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUseInsideHorizontalBorder)
...
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUseLeftBorder).Borders.LeftBorder;
end;

function TdxTable.GetActualRightBorder: TdxRightBorder;
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUseRightBorder).Borders.RightBorder;
end;

function TdxTable.GetActualTopBorder: TdxTopBorder;
begin
  Result := GetTablePropertiesSource(TdxTablePropertiesOptions.MaskUseTopBorder)
    .Borders.TopBorder;
end;
...
begin
  ...
  AFrameProperties := PieceTable.Paragraphs[AStartParagraphIndex]
    .GetActualFrameProperties(False);
  try
    for AParagraphIndex := AStartParagraphIndex + 1 to EndParagraphIndex - 1 do
    begin
      ANextFrameProperties := PieceTable.Paragraphs[AParagraphIndex]
        .GetMergedFrameProperties;
      try
        if (AFrameProperties <> nil) and not AFrameProperties.Equals
          (ANextFrameProperties) then
          Exit(True);
...
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUseBackgroundColor).BackgroundColor;
end;

function TdxTable.GetBottomMargin: TdxMarginUnitBase;
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUseBottomMargin).CellMargins.Bottom;
end;

function TdxTable.GetCell(ARow: TdxTableRow; AColumnIndex: Integer)
  : TdxTableCell;
var
  AIndex: Integer;
begin
...
function TdxTable.GetCellCore(ARowIndex, AColumnIndex: Integer)
  : TdxCustomTableCell;
begin
  Result := nil;
...
begin
  Result := TableProperties.UseFloatingPosition and
    (TableProperties.FloatingPosition.TextWrapping = TdxTextWrapping.Around);
end;
...
function TdxTable.GetCellColumnIndexConsiderRowGrid
...
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUseCellSpacing).CellSpacing;
end;

function TdxTable.GetCharacterProperties
  (AMask: TdxUsedCharacterFormattingOption; ATableCell: TdxTableCell)
...
begin
  ...
  Result := TableStyle.GetCharacterProperties(AMask,
    GetRowTypeByIndex(ARowIndex), GetColumnTypeByIndex(ARowIndex, ACellIndex));
end;

function TdxTable.GetColumnTypeByIndex(ARowIndex, AColumnIndex: Integer)
  : TdxConditionalColumnType;
var
  ACell: TdxTableCell;
begin
...
function TdxTable.GetColumnTypeByIndexCore(ARowIndex, AColumnIndex: Integer)
  : TdxConditionalColumnType;
var
...
begin
  ...
  if TdxTableLookType.ApplyLastColumn in TableLook then
    if (AColumnIndex = Rows[ARowIndex].Cells.Count - 1) and
      (HasColumnStyle(TableStyle, TdxConditionalColumnType.LastColumn)) then
...
begin
  ...
  begin
    ...
    begin
      ...
      if (ACellIndex < ACellCount - 1) and not Result.Contains(AColumnIndex)
      then
        Result.Add(AColumnIndex);
    end;
  end;
...
function TdxTable.GetFirstCellInVerticalMergingGroup(ATableCell: TdxTableCell)
  : TdxTableCell;
var
  ARow: TdxTableRow;
  ACell: TdxTableCell;
...
begin
  if (ATableCell.VerticalMerging = TdxMergingState.None) or
    (ATableCell.VerticalMerging = TdxMergingState.Restart) then
    Exit(ATableCell);

  ARows := ATableCell.Table.Rows;
  Assert(ARows.Count > 1,
    'cell.VerticalMerging == MergingState.Continue & cell.Table.Rows.Count is 1');
  ...
  begin
    ...
    begin
      ...
      begin
        if (ACell.VerticalMerging <> TdxMergingState.Continue) or (ARowIndex = 0)
        then
          Exit(ACell)
        else
          Break;
...
begin
  AWidthsCalculator := TdxRtfTableWidthsCalculator.Create
...
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUseIsTableOverlap).IsTableOverlap;
end;

function TdxTable.GetLastCellColumnIndexConsiderRowGrid(ARow: TdxTableRow;
ALayoutIndex: Boolean): Integer;
var
  I: Integer;
  ACell: TdxTableCell;
...
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUseLeftMargin).CellMargins.Left;
end;

function TdxTable.GetMergedCharacterProperties(ACell: TdxTableCell)
  : TdxMergedCharacterProperties;
var
  ARowIndex, ACellIndex: Integer;
begin
  ...
  Result := TableStyle.GetMergedCharacterProperties
    (GetRowTypeByIndex(ARowIndex), GetColumnTypeByIndex(ARowIndex, ACellIndex));
end;

function TdxTable.GetMergedParagraphProperties(ATableCell: TdxTableCell)
  : TdxMergedParagraphProperties;
var
  ARowIndex, ACellIndex: Integer;
begin
  ARowIndex := ATableCell.RowIndex;
  ACellIndex := ATableCell.IndexInRow;
  Result := TableStyle.GetMergedParagraphProperties
    (GetRowTypeByIndex(ARowIndex), GetColumnTypeByIndex(ARowIndex, ACellIndex));
end;

function TdxTable.GetMergedParagraphProperties(ATableStyle: TdxTableStyle;
ATableCell: TdxTableCell): TdxMergedParagraphProperties;
begin
  Result := ATableStyle.GetMergedParagraphProperties
...
function TdxTable.GetParagraphProperties
  (AMask: TdxUsedParagraphFormattingOption; ATableCell: TdxTableCell)
...
begin
  ARowIndex := ATableCell.RowIndex;
  ACellIndex := ATableCell.IndexInRow;
  Result := TableStyle.GetParagraphProperties(AMask,
    GetRowTypeByIndex(ARowIndex), GetColumnTypeByIndex(ARowIndex, ACellIndex));
end;

function TdxTable.GetMergedCharacterProperties(ACell: TdxTableCell;
ATableStyle: TdxTableStyle): TdxMergedCharacterProperties;
begin
  Result := ATableStyle.GetMergedCharacterProperties
    (TdxConditionalRowType.Normal, TdxConditionalColumnType.Normal);
end;
...
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUsePreferredWidth).PreferredWidth;
end;

function TdxTable.GetRightMargin: TdxMarginUnitBase;
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUseRightMargin).CellMargins.Right;
end;
...
function TdxTable.GetRowTypeByIndexCore(ARowIndex: Integer)
...
begin
  ...
  begin
    if (ARowIndex = Rows.Count - 1) and HasRowStyle(TableStyle,
      TdxConditionalRowType.LastRow) then
...
function TdxTable.GetStartCellColumnIndexConsiderRowGrid
...
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUseTableAlignment).TableAlignment;
end;

function TdxTable.GetTableCellConditionalTypes(ATableCell: TdxTableCell)
  : TdxConditionalTableStyleFormattingTypes;
var
  ARowIndex, ACellIndex: Integer;
begin
  ARowIndex := ATableCell.RowIndex;
  ACellIndex := ATableCell.IndexInRow;
  Result := TableStyle.GetConditionalPropertiesMask
    (GetRowTypeByIndex(ARowIndex), GetColumnTypeByIndex(ARowIndex, ACellIndex));
end;

function TdxTable.GetTableCellProperties(AMask: Integer;
ATableCell: TdxTableCell): TdxTableCellProperties;
var
  ARowIndex, ACellIndex: Integer;
begin
  ARowIndex := ATableCell.RowIndex;
  ACellIndex := ATableCell.IndexInRow;
  Result := TableStyle.GetTableCellProperties(AMask,
    GetRowTypeByIndex(ARowIndex), GetColumnTypeByIndex(ARowIndex, ACellIndex));
end;

function TdxTable.GetTableRowProperties(AMask: Integer; ATableRow: TdxTableRow)
  : TdxTableRowProperties;
var
  ARowIndex: Integer;
begin
  ARowIndex := ATableRow.IndexInTable;
  Result := TableStyle.GetTableRowProperties(AMask,
    GetRowTypeByIndex(ARowIndex));
end;

function TdxTable.GetTableIndent: TdxTableIndent;
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUseTableIndent).TableIndent;
end;

function TdxTable.GetTableLayout: TdxTableLayoutType;
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUseTableLayout).TableLayout;
end;

function TdxTable.GetTableLook: TdxTableLookTypes;
begin
  Result := GetTablePropertiesSource(TdxTablePropertiesOptions.MaskUseTableLook)
    .TableLook;
end;

function TdxTable.GetTablePropertiesSource(AMask: Integer): TdxTableProperties;
begin
  Result := GetTablePropertiesSource(AMask, TdxConditionalRowType.Normal,
    TdxConditionalColumnType.Normal);
end;

function TdxTable.GetTablePropertiesSource(AMask, ARowIndex,
  AColumnIndex: Integer): TdxTableProperties;
var
  AInsideBorder: Boolean;
begin
  Result := GetTablePropertiesSource(AMask, ARowIndex, AColumnIndex, True,
    AInsideBorder);
end;

function TdxTable.GetTablePropertiesSourceForCell(AMask: Integer;
ATableCell: TdxTableCell; AIsBorderCell: Boolean; out AInsideBorder: Boolean)
  : TdxTableProperties;
var
  ARowIndex, ACellIndex: Integer;
begin
  ARowIndex := ATableCell.RowIndex;
  ACellIndex := ATableCell.IndexInRow;
  Result := GetTablePropertiesSource(AMask, ARowIndex, ACellIndex,
    AIsBorderCell, AInsideBorder);
end;

function TdxTable.GetTablePropertiesSourceForCell(AMask: Integer;
ATableCell: TdxTableCell): TdxTableProperties;
var
  AInsideBorder: Boolean;
begin
  Result := GetTablePropertiesSourceForCell(AMask, ATableCell, True,
    AInsideBorder);
end;
...
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUseTableStyleColBandSize)
...
begin
  Result := GetTablePropertiesSource
    (TdxTablePropertiesOptions.MaskUseTableStyleRowBandSize)
...
begin
  Result := GetTablePropertiesSource(TdxTablePropertiesOptions.MaskUseTopMargin)
    .CellMargins.Top;
end;
...
function TdxTable.HasColumnStyle(AStyle: TdxTableStyle;
AType: TdxConditionalColumnType): Boolean;
var
...
function TdxTable.HasRowStyle(AStyle: TdxTableStyle;
AType: TdxConditionalRowType): Boolean;
var
...
procedure TdxTable.InitializeColumnWidths(AAutoFitBehavior
  : TdxTableAutoFitBehaviorType; AFixedColumnWidths, AOuterColumnWidth: Integer;
...
begin
  ...
  begin
    ...
    begin
      ATableWidth := GetTableWidth(Self, AOuterColumnWidth,
        AMatchHorizontalTableIndentsToTextEdge);
      if AMatchHorizontalTableIndentsToTextEdge then
        ATableWidth := DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits
          (ATableWidth);
      ATotalColumnsInTable := FindTotalColumnsCountInTable;
      AWidths := DistributeWidthsToAllColumns(ATableWidth,
        ATotalColumnsInTable);
      ...
      begin
        ...
        begin
          ...
          if AMatchHorizontalTableIndentsToTextEdge then
            ACellWidth := DocumentModel.ToDocumentLayoutUnitConverter.
              ToModelUnits(ACellWidth);
...
begin
  Result := (AFixedColumnWidths <> MinInt) and (AFixedColumnWidths <> MaxInt)
    and (AFixedColumnWidths <> 0);
end;
...
procedure TdxTable.NormalizeRowGridBefore(ARow: TdxTableRow;
ACanNormalizeWidthBeforeAndWidthAfter: Boolean;
AMinGridBefore, AMinGridAfter: Integer);
begin
  if (DocumentModel.IsUpdateLocked) and DocumentModel.DeferredChanges.IsSetContentMode
  then
  begin
    ARow.UnsubscribeRowPropertiesEvents;
    try
      NormalizeRowGridBeforeCore(ARow, ACanNormalizeWidthBeforeAndWidthAfter,
        AMinGridBefore, AMinGridAfter);
    finally
...
procedure TdxTable.NormalizeRowGridBeforeCore(ARow: TdxTableRow;
ACanNormalizeWidthBeforeAndWidthAfter: Boolean;
AMinGridBefore, AMinGridAfter: Integer);
begin
  if AMinGridBefore <> 0 then
    ARow.GridBefore := ARow.GridBefore - AMinGridBefore;
  if (ARow.GridBefore = 0) and ((ARow.WidthBefore.&Type <> TdxWidthUnitType.Nil)
    or (ARow.WidthBefore.Value <> 0)) and ACanNormalizeWidthBeforeAndWidthAfter
  then
  begin
  ...
  if (ARow.GridAfter = 0) and ((ARow.WidthAfter.&Type <> TdxWidthUnitType.Nil)
    or (ARow.WidthAfter.Value <> 0)) and ACanNormalizeWidthBeforeAndWidthAfter
  then
  begin
  ...
  begin
    ...
    begin
      if (FRows[I].Height.&Type <> TdxHeightUnitType.Auto) and (I > 0) then
        FRows[I - 1].Height.Value := FRows[I - 1].Height.Value +
          FRows[I].Height.Value;
...
begin
  ...
  if (AMinGridBefore = 0) and (AMinGridAfter = 0) then
    Exit;
  for I := 0 to ACount - 1 do
    NormalizeRowGridBefore(ARows[I], ACanNormalizeWidthBeforeAndWidthAfter,
      AMinGridBefore, AMinGridAfter);
end;
...
begin
  ...
  begin
    ...
    else if ACurrentCell.VerticalMerging = TdxMergingState.Restart then
      if ARowCount = 1 then
        ACurrentCell.Properties.VerticalMerging := TdxMergingState.None;
  end;
  if ARowCount = 1 then
...
var
  ...
  I, AGridAfterDelta, ACurrentEndColumnIndex, AMaxEndColumnIndex,
    ARowsCount: Integer;
begin
  ...
  begin
    ACurrentRow := Rows[I];
    ACurrentEndColumnIndex := GetEndColumnIndex(ACurrentRow.LastCell) +
...
procedure TdxTable.NormalizeTableRow(ARow: TdxTableRow;
AGridIntervals: TdxTableGridIntervalList; ARowIndex: Integer);
begin
  if DocumentModel.IsUpdateLocked and DocumentModel.DeferredChanges.IsSetContentMode
  then
...
procedure TdxTable.NormalizeTableRowCore(ARow: TdxTableRow;
AGridIntervals: TdxTableGridIntervalList; ARowIndex: Integer);
var
  ACells: TdxTableCellCollection;
...
begin
  ACells := ARow.Cells;
  AIntervalIterator := TdxTableGridIntervalIterator.Create
    (TdxTableGridIntervalList.Create(AGridIntervals), MaxInt);
  try
    ...
    begin
      ...
      AShouldDeleteRow := AShouldDeleteRow and
        (ACell.VerticalMerging = TdxMergingState.Continue);
    end;
...
procedure TdxTable.OnPropertiesObtainAffectedRangeCore
  (E: TdxObtainAffectedRangeEventArgs; AFirstRowIndex: Integer);
var
...
procedure TdxTable.OnTablePropertiesObtainAffectedRange(ASender: TObject;
E: TdxObtainAffectedRangeEventArgs);
begin
...
procedure TdxTable.RemoveInvalidVerticalSpansFromTableWithOneRow
  (ARows: TdxTableRowCollection);
var
  ACell: TdxTableCell;
  ACellIndex: Integer;
...
begin
  ...
  begin
    ...
    begin
      ...
      else if ACell.VerticalMerging = TdxMergingState.Continue then
      begin
        if ARowIndex = 0 then
        begin
          ACell.VerticalMerging := TdxMergingState.None;
        ...
        if (AUpperCell = nil) or
          (AUpperCell.VerticalMerging = TdxMergingState.None) then
        begin
          if ARowIndex = ARowCount - 1 then
            ACell.VerticalMerging := TdxMergingState.None
          else
...
procedure TdxTable.SetAllColumnsWidthsToFixedColumnWidths(AFixedColumnWidths
  : Integer);
var
  AApplyWidthPercentBased: TdxTableCellProcessorDelegate;
begin
...
begin
  ...
  DocumentModel.BeginUpdate;
  try
    AItem := TdxChangeTableStyleIndexHistoryItem.Create(PieceTable, &Index,
      FStyleIndex, Value);
    DocumentModel.History.Add(AItem);
    AItem.Execute;
  finally
...
begin
  FStyleIndex := ANewStyleIndex;
  if (FirstRow = nil) or (FirstRow.FirstCell = nil) or (LastRow = nil) or
    (LastRow.LastCell = nil) or (FirstRow.FirstCell.StartParagraphIndex < 0)
  then
    Exit;
  for I := FirstRow.FirstCell.StartParagraphIndex to LastRow.LastCell.
    EndParagraphIndex do
    FPieceTable.Paragraphs[I].ResetCachedIndices
      (TdxResetFormattingCacheType.All);
  ...
  if StartParagraphIndex >= 0 then
  begin
    AStart := PieceTable.Paragraphs[FirstRow.FirstCell.StartParagraphIndex]
      .FirstRunIndex;
    AEnd := PieceTable.Paragraphs[LastRow.LastCell.EndParagraphIndex]
      .LastRunIndex;
    PieceTable.ApplyChangesCore
      (TdxTableChangeActionCalculator.CalculateChangeActions
      (TdxTableChangeType.TableStyle), AStart, AEnd);
...
begin
  TableProperties.OnObtainAffectedRange.Add
    (OnTablePropertiesObtainAffectedRange);
end;

function TdxTable.GetTablePropertiesSource(AMask, ARowIndex,
  AColumnIndex: Integer; AIsBorderCell: Boolean; out AInsideBorder: Boolean)
  : TdxTableProperties;
begin
  Result := GetTablePropertiesSource(AMask, GetRowTypeByIndex(ARowIndex),
    GetColumnTypeByIndex(ARowIndex, AColumnIndex), AIsBorderCell,
    AInsideBorder);
end;

function TdxTable.GetTablePropertiesSource(AMask: Integer;
ARowType: TdxConditionalRowType; AColumnType: TdxConditionalColumnType)
  : TdxTableProperties;
var
  AInsideBorder: Boolean;
begin
  Result := GetTablePropertiesSource(AMask, ARowType, AColumnType, True,
    AInsideBorder);
end;
...
begin
  if TableProperties.GetUse(TdxTablePropertiesOptions.OuterOrInside(AMask,
    AIsBorderCell)) then
  begin
    AInsideBorder := not AIsBorderCell;
    Exit(TableProperties);
  end;
  ASource := TableStyle.GetTableProperties(AMask, ARowType, AColumnType,
    AIsBorderCell, AInsideBorder);
  if ASource <> nil then
    Exit(ASource);
  AInsideBorder := not AIsBorderCell;
...
constructor TdxHorizontalCellBordersInfo.Create(AAboveCell,
  ABelowCell: TdxTableCell; ABorder: TdxBorderBase;
AStartColumnIndex, AEndColumnIndex: Integer);
begin
  if AEndColumnIndex < AStartColumnIndex then
    TdxRichEditExceptions.ThrowArgumentException('endColumnIndex',
      AEndColumnIndex);
  FBorder := ABorder;
...
function TdxHorizontalCellBordersInfoList.Clone
  : TdxHorizontalCellBordersInfoList;
var
  I: Integer;
begin
...
constructor TdxVerticalBorderPositions.Create(AInitialPositions,
  AAlignedPositions: TdxLayoutUnitSortedList);
begin
  inherited Create;
...
constructor TdxSelectedTableStructureBase.Create(AOriginalStartLogPosition
...
const
  TableChangeActionsMap: array [TdxTableChangeType]
...
procedure TdxTableCellLayoutProperties.SetContainerWidthsInfo
  (const Value: TdxWidthsContentInfo);
begin
  FContainerWidthsInfo := Value;
end;

procedure TdxTableCellLayoutProperties.SetContentWidthsInfo
  (const Value: TdxWidthsContentInfo);
begin
