...
type
  ...
  protected
    class function OnComment(AImporter
...
class function TdxCommentsDestination.CreateElementHandlerTable
...
class function TdxCommentsDestination.OnComment
...
class function TdxCommentDestination.CreateElementHandlerTable
  : TdxElementHandlerTable;
begin
  Result := TdxElementHandlerTable.Create;
...
class function TdxCommentDestination.OnTable
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxCommentDestination.OnParagraph
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxCommentDestination.OnAltChunk
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
