...
type
  ...
  public
    ...
    procedure ModifyInputPositionCore(APos: TdxInputPosition); virtual;
      abstract;
    function GetInputPositionPropertyValue(APos: TdxInputPosition): T;
      virtual; abstract;
    function IsValueEquals(const AValue1, AValue2: T): Boolean; virtual;

    function ObtainRunsPropertyValue(APieceTable: TdxSimplePieceTable;
      const ALogPositionStart: TdxDocumentLogPosition; ALength: Integer;
  ...
  protected
    ...
    function CreateRunInsertedHistoryItem
      : TdxTextRunInsertedHistoryItem; virtual;
  public
  ...
  strict private
    procedure InsertParagraphRun(AParagraph: TdxParagraphBase;
      AWhere: TdxRunIndex; AStartIndex: Integer; AForceVisible: Boolean);
    procedure InsertParagraphIntoParagraphTable(AParagraph: TdxSimpleParagraph;
      AParagraphMarkRunIndex: TdxRunIndex;
  ...
  public
    ...
    function CreateInsertParagraphRangeHistoryItem
      : TdxParagraphRunInsertedHistoryItem; virtual;
    function CanMerge(ALogPosition: TdxDocumentLogPosition): Boolean; override;
    procedure Merge(ALogPosition: TdxDocumentLogPosition;
      AParagraphIndex: TdxParagraphIndex); override;
    procedure PerformInsert(AParagraph: TdxParagraphBase;
  ...
  strict private
    ...
    procedure InsertInlineCustomObjectRun(AParagraph: TdxParagraphBase;
      AWhere: TdxRunIndex; AStartIndex: Integer; AForceVisible: Boolean);
  public
    constructor Create(APieceTable: TdxCustomPieceTable;
      const ACustomObject: IdxInlineCustomObject;
      const AScaleX, AScaleY: Single); reintroduce;
    function CanMerge(ALogPosition: TdxDocumentLogPosition): Boolean; override;
    procedure Merge(ALogPosition: TdxDocumentLogPosition;
      AParagraphIndex: TdxParagraphIndex); override;
    procedure PerformInsert(AParagraph: TdxParagraphBase;
  ...
  strict private
    ...
    procedure InsertInlinePictureRun(AParagraph: TdxParagraphBase;
      AWhere: TdxRunIndex; AStartIndex: Integer; AForceVisible: Boolean);
  protected
    function CreateRunInsertedHistoryItem(APieceTable: TdxSimplePieceTable)
      : TdxInlinePictureRunInsertedHistoryItem; inline;
  public
  ...
  protected
    constructor Create(APieceTable: TdxCustomPieceTable;
      AHistoryItemClass: TdxRichEditHistoryItemClass); reintroduce;
  public
    class function CreateFieldResultEndRunInserter
      (APieceTable: TdxCustomPieceTable): TdxFieldRunInserterBase; static;
    class function CreateFieldCodeStartRunInserter
      (APieceTable: TdxCustomPieceTable): TdxFieldRunInserterBase; static;
    class function CreateFieldCodeEndRunInserter(APieceTable
      : TdxCustomPieceTable): TdxFieldRunInserterBase; static;
  ...
  public
    constructor Create(AStyleIndex: Integer;
      AResetProperties: Boolean = True); overload;
    class function CreateReplaceRunCharacterStyleProperties
      (AStyleIndex: Integer;
      const ASourceProperties: TdxMergedCharacterProperties)
      : TdxRunCharacterStyleModifier; static;
    class function CreateRunCharacterStyleKeepOldStyleProperties
      (AStyleIndex: Integer; AApplyDefaultHyperlinkStyle: Boolean;
      const AIgnoredOptions: TdxUsedCharacterFormattingOptions = [])
      : TdxRunCharacterStyleModifier; static;
...
function CreateSeparatorTextRunInserter(APieceTable: TdxCustomPieceTable)
  : TdxSimplePieceTableObjectInserter;
...
type
  ...
  TdxRunCharacterStyleKeepOldStylePropertiesModifier = class
    (TdxRunCharacterStyleModifier)
  private
  ...
  public
    constructor Create(AStyleIndex: Integer;
      ...
      const AIgnoredOptions: TdxUsedCharacterFormattingOptions); overload;
    constructor Create(AStyleIndex: Integer;
...
function TdxRunPropertyModifier<T>.IsValueEquals(const AValue1,
  AValue2: T): Boolean;
begin
  Result := TdxFastComparer<T>.IsValueEquals(FComparerType, AValue1, AValue2);
end;

function TdxRunPropertyModifier<T>.ObtainRunsPropertyValue
...
function TdxRunPropertyModifier<T>.ObtainMergedRunsPropertyValue
  (APieceTable: TdxSimplePieceTable; ALogPositionStart: TdxDocumentLogPosition;
  ALength: Integer): T;
begin
  Result := Default (T);
  dxAbstractError;
...
function TdxMergedRunPropertyModifier<T>.CanModifyRun
  (ARun: TdxTextRunBase): Boolean;
begin
  Result := True;
end;

function TdxMergedRunPropertyModifier<T>.ObtainMergedRunsPropertyValue
  (APieceTable: TdxSimplePieceTable; ALogPositionStart: TdxDocumentLogPosition;
  ALength: Integer): T;
var
  ARunInfo: TdxRunInfo;
...
function TdxSimpleTextInserter.CanMerge(ALogPosition
...
function TdxSimpleTextInserter.CreateRunInsertedHistoryItem
  : TdxTextRunInsertedHistoryItem;
begin
  Result := TdxTextRunInsertedHistoryItem.Create(PieceTable);
end;

procedure TdxSimpleTextInserter.InsertTextRun(AParagraph: TdxSimpleParagraph;
  AWhere: TdxRunIndex; AStartIndex, ALength: Integer; AForceVisible: Boolean);
var
...
begin
  ...
  if DocumentModel.History is TdxRichEditDocumentHistory then
    TdxRichEditDocumentHistory(DocumentModel.History)
      .AddRangeTextAppendedHistoryItem(AItem)
  else
    DocumentModel.History.Add(AItem);
  AItem.Execute;
end;
...
begin
  ...
  InsertTextRun(TdxSimpleParagraph(AParagraph), ARunIndex, AOldGrowBufferLength,
...
function TdxParagraphInserter.CreateInsertParagraphRangeHistoryItem
  : TdxParagraphRunInsertedHistoryItem;
begin
  Result := TdxParagraphRunInsertedHistoryItem.Create(PieceTable);
end;

function TdxParagraphInserter.CanMerge(ALogPosition
  : TdxDocumentLogPosition): Boolean;
begin
  Result := False;
end;

procedure TdxParagraphInserter.Merge(ALogPosition: TdxDocumentLogPosition;
  AParagraphIndex: TdxParagraphIndex);
begin
...
begin
  ...
  InsertParagraphRun(AParagraph, ARunIndex, AOldGrowBufferLength,
    AForceVisible);
  InsertParagraphIntoParagraphTable(TdxSimpleParagraph(AParagraph), ARunIndex,
    ALogPosition);
end;

procedure TdxParagraphInserter.InsertParagraphRun(AParagraph: TdxParagraphBase;
  AWhere: TdxRunIndex; AStartIndex: Integer; AForceVisible: Boolean);
var
...
procedure TdxParagraphInserter.InsertParagraphIntoParagraphTable
  (AParagraph: TdxSimpleParagraph; AParagraphMarkRunIndex: TdxRunIndex;
  ALogPosition: TdxDocumentLogPosition);
var
...
constructor TdxInlineCustomObjectInserter.Create(APieceTable
  : TdxCustomPieceTable; const ACustomObject: IdxInlineCustomObject;
...
function TdxInlineCustomObjectInserter.CanMerge(ALogPosition
  : TdxDocumentLogPosition): Boolean;
begin
  Result := False;
end;

procedure TdxInlineCustomObjectInserter.Merge(ALogPosition
  : TdxDocumentLogPosition; AParagraphIndex: TdxParagraphIndex);
begin
  TdxRichEditExceptions.ThrowInternalException;
end;

procedure TdxInlineCustomObjectInserter.PerformInsert
...
begin
  ...
  InsertInlineCustomObjectRun(AParagraph, ARunIndex, AOldGrowBufferLength,
    AForceVisible);
end;

procedure TdxInlineCustomObjectInserter.InsertInlineCustomObjectRun
...
constructor TdxInlinePictureInserter.Create(APieceTable: TdxSimplePieceTable;
  AImage: TdxOfficeImageReference; AScaleX, AScaleY: Single;
...
function TdxInlinePictureInserter.CanMerge(ALogPosition
  : TdxDocumentLogPosition): Boolean;
begin
  Result := False;
end;
...
procedure TdxInlinePictureInserter.InsertInlinePictureRun
  (AParagraph: TdxParagraphBase; AWhere: TdxRunIndex; AStartIndex: Integer;
  AForceVisible: Boolean);
var
...
procedure TdxInlinePictureInserter.Merge(ALogPosition: TdxDocumentLogPosition;
  AParagraphIndex: TdxParagraphIndex);
begin
  TdxRichEditExceptions.ThrowInternalException;
end;

procedure TdxInlinePictureInserter.PerformInsert(AParagraph: TdxParagraphBase;
  ARunIndex: TdxRunIndex; ALogPosition: TdxDocumentLogPosition;
  AForceVisible: Boolean);
var
  AOldGrowBufferLength: Integer;
begin
  AOldGrowBufferLength := PieceTable.TextBuffer.Length - 1;
  InsertInlinePictureRun(AParagraph, ARunIndex, AOldGrowBufferLength,
    AForceVisible);
end;

{ TdxFieldRunInserterBase }

function TdxFieldRunInserterBase.CanMerge(ALogPosition
  : TdxDocumentLogPosition): Boolean;
begin
  Result := False;
end;

constructor TdxFieldRunInserterBase.Create(APieceTable: TdxCustomPieceTable;
  AHistoryItemClass: TdxRichEditHistoryItemClass);
begin
  inherited Create(APieceTable);
  FHistoryItemClass := AHistoryItemClass;
end;

class function TdxFieldRunInserterBase.CreateFieldCodeEndRunInserter
  (APieceTable: TdxCustomPieceTable): TdxFieldRunInserterBase;
begin
  Result := TdxFieldRunInserterBase.Create(APieceTable,
    TdxFieldCodeEndRunInsertedHistoryItem);
end;

class function TdxFieldRunInserterBase.CreateFieldCodeStartRunInserter
  (APieceTable: TdxCustomPieceTable): TdxFieldRunInserterBase;
begin
  Result := TdxFieldRunInserterBase.Create(APieceTable,
...
class function TdxFieldRunInserterBase.CreateFieldResultEndRunInserter
  (APieceTable: TdxCustomPieceTable): TdxFieldRunInserterBase;
begin
  Result := TdxFieldRunInserterBase.Create(APieceTable,
...
function TdxFieldRunInserterBase.CreateHistoryItem
  : TdxMarkRunInsertedHistoryItemBase;
begin
  Result := TdxMarkRunInsertedHistoryItemBase
    (FHistoryItemClass.Create(PieceTable));
end;

procedure TdxFieldRunInserterBase.Merge(ALogPosition: TdxDocumentLogPosition;
  AParagraphIndex: TdxParagraphIndex);
begin
  TdxRichEditExceptions.ThrowInternalException;
end;

procedure TdxFieldRunInserterBase.PerformInsert(AParagraph: TdxParagraphBase;
  ARunIndex: TdxRunIndex; ALogPosition: TdxDocumentLogPosition;
  AForceVisible: Boolean);
var
...
constructor TdxRunCharacterStyleModifier.Create(AStyleIndex: Integer;
  AResetProperties: Boolean = True);
begin
  inherited Create(AStyleIndex);
  FResetProperties := AResetProperties;
end;

class function TdxRunCharacterStyleModifier.
  CreateReplaceRunCharacterStyleProperties(AStyleIndex: Integer;
  const ASourceProperties: TdxMergedCharacterProperties)
  : TdxRunCharacterStyleModifier;
begin
  Result := TdxReplaceRunCharacterStylePropertiesModifier.Create(AStyleIndex,
    ASourceProperties);
end;

class function TdxRunCharacterStyleModifier.
  CreateRunCharacterStyleKeepOldStyleProperties(AStyleIndex: Integer;
  AApplyDefaultHyperlinkStyle: Boolean;
  const AIgnoredOptions: TdxUsedCharacterFormattingOptions)
  : TdxRunCharacterStyleModifier;
begin
  Result := TdxRunCharacterStyleKeepOldStylePropertiesModifier.Create
    (AStyleIndex, AApplyDefaultHyperlinkStyle, AIgnoredOptions);
end;

function TdxRunCharacterStyleModifier.GetInputPositionPropertyValue
  (APos: TdxInputPosition): Integer;
begin
  Result := APos.CharacterStyleIndex;
end;

function TdxRunCharacterStyleModifier.GetRunPropertyValue
  (ARun: TdxTextRunBase): Integer;
begin
  Result := ARun.CharacterStyleIndex;
end;

procedure TdxRunCharacterStyleModifier.ModifyInputPositionCore
  (APos: TdxInputPosition);
begin
end;

procedure TdxRunCharacterStyleModifier.ModifyTextRun(ARun: TdxTextRunBase;
...
constructor TdxReplaceRunCharacterStylePropertiesModifier.Create
  (AStyleIndex: Integer; const ASourceProperties: TdxMergedCharacterProperties);
begin
...
function TdxReplaceRunCharacterStylePropertiesModifier.LeaveUseInStyleProperties
  (AStyle: TdxCharacterStyle; const AProperties: TdxMergedCharacterProperties)
  : TdxMergedCharacterProperties;
var
  AStyleProperties: TdxMergedCharacterProperties;
begin
  Result := TdxMergedCharacterProperties.Create(AProperties.Info,
    AProperties.Options);
...
procedure TdxReplaceRunCharacterStylePropertiesModifier.ModifyTextRun
...
begin
  ...
  try
    ...
    ARun.CharacterStyleIndex :=
      TdxCharacterStyleCollection.EmptyCharacterStyleIndex;
  finally
    ADocumentModel.History.EndTransaction;
  end;
end;
...
constructor TdxRunCharacterStyleKeepOldStylePropertiesModifier.Create
  (AStyleIndex: Integer; AApplyDefaultHyperlinkStyle: Boolean;
  const AIgnoredOptions: TdxUsedCharacterFormattingOptions);
begin
  inherited Create(AStyleIndex, False);
...
procedure TdxRunCharacterStyleKeepOldStylePropertiesModifier.ModifyTextRun
  (ARun: TdxTextRunBase; ARunIndex: TdxRunIndex);
begin
  if ARun.CharacterStyleIndex <> NewValue then
...
procedure TdxRunCharacterStyleKeepOldStylePropertiesModifier.ModifyTextRunCore
  (ARun: TdxTextRunBase);
var
  ADocumentModel: TdxSimpleDocumentModel;
...
begin
  ...
  try
    ...
    try
      ...
      begin
        AStyleProperties := ADocumentModel.CharacterStyles[NewValue]
        ...
        ACharacterProperties.Options.Value := ACharacterProperties.Options.Value
          - AStyleOptions;
...
function TdxSeparatorTextRunInserter.CanMerge(ALogPosition
  : TdxDocumentLogPosition): Boolean;
begin
  Result := False;
end;

function TdxSeparatorTextRunInserter.CreateHistoryItem
  : TdxSeparatorRunInsertedHistoryItem;
begin
  Result := TdxSeparatorRunInsertedHistoryItem.Create(PieceTable);
end;

procedure TdxSeparatorTextRunInserter.Merge(ALogPosition
  : TdxDocumentLogPosition; AParagraphIndex: TdxParagraphIndex);
begin
  TdxRichEditExceptions.ThrowInternalException;
end;

procedure TdxSeparatorTextRunInserter.PerformInsert
  (AParagraph: TdxParagraphBase; ARunIndex: TdxRunIndex;
  ALogPosition: TdxDocumentLogPosition; AForceVisible: Boolean);
var
