...
type
  ...
  TdxRangeEditingPermissionsFormControllerParameters = class
  ...
  protected
    ...
    function ObtainCheckedUsers(ARangePermissions: TdxRangePermissionCollection)
      : TStrings; virtual;
    function ObtainCheckedGroups(ARangePermissions
      : TdxRangePermissionCollection): TStrings; virtual;
    procedure MergeStringLists(const ATarget, AListToAppend: TStrings);
    function ObtainRangePermissionsMatchSelection
      : TdxRangePermissionCollection; virtual;
    ...
    procedure ApplyNewRangePermissions(ASelectionItems: TdxSelectionItemList;
      APermissions: TdxRangePermissionInfoList); overload;
    procedure ApplyNewRangePermissions(AItem: TdxSelectionItem;
      APermissions: TdxRangePermissionInfoList); overload;
    procedure RemoveRangePermissions(ASelectionItems
      : TdxSelectionItemList); overload;
    procedure RemoveRangePermissions(AItem: TdxSelectionItem); overload;
    procedure AppendUserGroupNamePermissions(APermissions
      : TdxRangePermissionInfoList);
    procedure AppendUserNamePermissions(APermissions
      : TdxRangePermissionInfoList);
...
constructor TdxRangeEditingPermissionsFormController.Create
...
begin
  AService := FControl.InnerControl.DocumentModel.
    GetService<IdxUserListService>;
  Result := AService <> nil;
end;
...
procedure TdxRangeEditingPermissionsFormController.CheckUser
...
procedure TdxRangeEditingPermissionsFormController.UncheckUser
  (const AUserName: string);
begin
  if AUserName = '' then
    Exit;
...
procedure TdxRangeEditingPermissionsFormController.CheckUserGroup
  (const AUserGroupName: string);
begin
  if not CheckedUserGroups.Contains(AUserGroupName) then
    CheckedUserGroups.Add(AUserGroupName);
end;

procedure TdxRangeEditingPermissionsFormController.UncheckUserGroup
  (const AUserGroupName: string);
begin
  CheckedUserGroups.Remove(AUserGroupName);
end;

function TdxRangeEditingPermissionsFormController.IsValidUserName
...
function TdxRangeEditingPermissionsFormController.ObtainAvailableUsers
  : TStrings;
var
  AService: IdxUserListService;
  I: Integer;
...
begin
  ...
  begin
    ...
    begin
      ...
      for I := 0 to Control.DocumentModel.Cache.RangePermissionInfoCache.
        Count - 1 do
      begin
        ARangePermissionInfo :=
          Control.DocumentModel.Cache.RangePermissionInfoCache.Items[I];
...
function TdxRangeEditingPermissionsFormController.ObtainAvailableUserGroups
  : TStrings;
var
...
begin
  AService := FControl.InnerControl.DocumentModel.
    GetService<IdxUserGroupListService>;
  if AService <> nil then
  ...
  begin
    ...
    begin
      ...
      begin
        ARangePermissionInfo :=
          Control.DocumentModel.Cache.RangePermissionInfoCache.Items[I];
        if (ARangePermissionInfo.Group <> '') and
          not FInternalUserGroups.Contains(ARangePermissionInfo.Group) then
...
function TdxRangeEditingPermissionsFormController.ObtainCheckedUsers
  (ARangePermissions: TdxRangePermissionCollection): TStrings;
var
  ACount, I: Integer;
  AValue: string;
begin
...
function TdxRangeEditingPermissionsFormController.ObtainCheckedGroups
  (ARangePermissions: TdxRangePermissionCollection): TStrings;
var
  ACount, I: Integer;
  AValue: string;
...
procedure TdxRangeEditingPermissionsFormController.MergeStringLists
  (const ATarget, AListToAppend: TStrings);
var
  ACount, I: Integer;
  AValue: string;
begin
...
function TdxRangeEditingPermissionsFormController.
  ObtainRangePermissionsMatchSelection: TdxRangePermissionCollection;
var
...
function TdxRangeEditingPermissionsFormController.
  ObtainRangePermissionsWithSelectionInside: TdxRangePermissionCollection;
var
  AInnerControl: IdxInnerControl;
  ASelection: TdxSelection;
  APermissions: TdxRangePermissionCollection;
...
begin
  AInnerControl := FControl.InnerControl;
  ASelection := AInnerControl.DocumentModel.Selection;
  APermissions := ASelection.PieceTable.
    ObtainRangePermissionsWithSelectionInside;
...
procedure TdxRangeEditingPermissionsFormController.RemoveOldRangePermissions
  (APieceTable: TdxPieceTable);
var
  ACount, I: Integer;
begin
...
procedure TdxRangeEditingPermissionsFormController.ApplyNewRangePermissions
  (APieceTable: TdxPieceTable);
var
...
begin
  ...
  try
    ...
    if APermissions.Count > 0 then
      ApplyNewRangePermissions(APieceTable.DocumentModel.Selection.Items,
        APermissions)
    else
...
procedure TdxRangeEditingPermissionsFormController.ApplyNewRangePermissions
  (AItem: TdxSelectionItem; APermissions: TdxRangePermissionInfoList);
var
  ACount, I: Integer;
begin
  ACount := APermissions.Count;
  for I := 0 to ACount - 1 do
    TdxPieceTable(AItem.PieceTable).ApplyDocumentPermission
      (AItem.NormalizedStart, AItem.NormalizedEnd, APermissions[I]);
end;

procedure TdxRangeEditingPermissionsFormController.RemoveRangePermissions
  (ASelectionItems: TdxSelectionItemList);
var
  ACount, I: Integer;
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      TdxPieceTable(AItem.PieceTable).RemoveDocumentPermission(AStart, AEnd,
        APermission.Properties.Info);
      I := 0;
      Continue;
    end;
    Inc(I);
...
function TdxRangeEditingPermissionsFormController.AddUser(const AUserName
  : string): Boolean;
begin
  Result := False;
  if AUserName = '' then
...
procedure TdxRangeEditingPermissionsFormController.
  AppendUserGroupNamePermissions(APermissions: TdxRangePermissionInfoList);
var
  ACount, I: Integer;
...
procedure TdxRangeEditingPermissionsFormController.AppendUserNamePermissions
  (APermissions: TdxRangePermissionInfoList);
var
  ACount, I: Integer;
  AInfo: TdxRangePermissionInfo;
