...
uses
  Windows, Classes, ActnList, Generics.Defaults, Generics.Collections,
  cxClasses, dxActions, dxUIGenerator, dxBar,
...
type
  ...
  public
    ...
    class procedure Initialize(AItem: TdxBarItem;
      ACommandInfo: TdxUIGeneratorCommandInfo;
      AAdapter: TdxUIGeneratorAdapter); virtual;
    class function IsBuiltInCommand(AAction: TAction;
      ACommandInfo: TdxUIGeneratorCommandInfo): Boolean; virtual;
    class function IsBuiltInItem(AItem: TdxBarItem;
      AParentLinks: TdxBarItemLinks): Boolean; virtual;
  end;
  ...
  public
    function GetInfo(AAction: TAction; ACommandInfo: TdxUIGeneratorCommandInfo)
      : TdxUIGeneratorBarItemInfoClass;
  end;
  ...
  public
    class function GetBarItemClass: TdxBarItemClass; override;
    class function IsBuiltInCommand(AAction: TAction;
      ACommandInfo: TdxUIGeneratorCommandInfo): Boolean; override;
  end;
  ...
  public
    ...
    class function IsBuiltInCommand(AAction: TAction;
      ACommandInfo: TdxUIGeneratorCommandInfo): Boolean; override;
    class function IsBuiltInItem(AItem: TdxBarItem;
      AParentLinks: TdxBarItemLinks): Boolean; override;
  end;
  ...
  public
    ...
    class procedure Initialize(AItem: TdxBarItem;
      ACommandInfo: TdxUIGeneratorCommandInfo;
      AAdapter: TdxUIGeneratorAdapter); override;
    class function IsBuiltInCommand(AAction: TAction;
      ACommandInfo: TdxUIGeneratorCommandInfo): Boolean; override;
    class function IsBuiltInItem(AItem: TdxBarItem;
      AParentLinks: TdxBarItemLinks): Boolean; override;
  ...
  strict private
    ...
    function ConvertViewLevels(AViewLevels: TdxUIGeneratorItemViewLevels;
      ABarItem: TdxBarItem): TdxBarItemViewLevels;
    function GetBarItem(AAction: TAction;
      ACommandInfo: TdxUIGeneratorCommandInfo;
      AParentItemLinks: TdxBarItemLinks;
      ABarItemInfo: TdxUIGeneratorBarItemInfoClass): TdxBarItem;
  protected
    FBarItems: TdxUIGeneratorBarItemInfoList;

    function FindBarItem(AAction: TAction;
      ACommandInfo: TdxUIGeneratorCommandInfo;
      AParentItemLinks: TdxBarItemLinks;
      ABarItemInfo: TdxUIGeneratorBarItemInfoClass): TdxBarItem;
    function FindSubItem(const ACaption: string; AItemLinks: TdxBarItemLinks)
      : TdxBarItem;
    function GetBarManager: TdxBarManager; virtual;
    function GetBarPopupMenuClass: TdxBarCustomPopupMenuClass; virtual;
    function GetCategoryIndex(ACommandInfo: TdxUIGeneratorCommandInfo)
      : Integer; virtual;
    procedure Initialize; override;
    procedure InitializeBarItems; virtual;
    procedure PlaceCommand(AAction: TAction;
      ACommandInfo: TdxUIGeneratorCommandInfo); overload; override;
    procedure PlaceCommand(AItemLinks: TdxBarItemLinks; AAction: TAction;
      ACommandInfo: TdxUIGeneratorCommandInfo); reintroduce; overload;
  public
...
class procedure TdxUIGeneratorBarItemInfo.Initialize(AItem: TdxBarItem;
  ACommandInfo: TdxUIGeneratorCommandInfo; AAdapter: TdxUIGeneratorAdapter);
begin
  // do nothing
end;

class function TdxUIGeneratorBarItemInfo.IsBuiltInCommand(AAction: TAction;
  ACommandInfo: TdxUIGeneratorCommandInfo): Boolean;
begin
  Result := AAction <> nil;
end;

class function TdxUIGeneratorBarItemInfo.IsBuiltInItem(AItem: TdxBarItem;
  AParentLinks: TdxBarItemLinks): Boolean;
begin
...
function TdxUIGeneratorBarItemInfoList.GetInfo(AAction: TAction;
  ACommandInfo: TdxUIGeneratorCommandInfo): TdxUIGeneratorBarItemInfoClass;
var
  I: Integer;
begin
...
class function TdxUIGeneratorBarLargeButtonInfo.GetBarItemClass
  : TdxBarItemClass;
begin
...
begin
  Result := inherited IsBuiltInCommand(AAction, ACommandInfo) and
    (ugivlLargeIcon in ACommandInfo.ViewLevels);
end;
...
class function TdxUIGeneratorBarSubItemInfo.IsBuiltInCommand(AAction: TAction;
  ACommandInfo: TdxUIGeneratorCommandInfo): Boolean;
begin
  Result := (AAction = nil) and (ACommandInfo.Commands.Count > 0);
end;

class function TdxUIGeneratorBarSubItemInfo.IsBuiltInItem(AItem: TdxBarItem;
  AParentLinks: TdxBarItemLinks): Boolean;
begin
  Result := inherited IsBuiltInItem(AItem, AParentLinks) and
    (AParentLinks.FindByItem(AItem) <> nil);
end;
...
class function TdxUIGeneratorBarEditItemInfo.GetEditProperties
  : TcxCustomEditPropertiesClass;
begin
  Result := nil;
end;

class procedure TdxUIGeneratorBarEditItemInfo.Initialize(AItem: TdxBarItem;
  ACommandInfo: TdxUIGeneratorCommandInfo; AAdapter: TdxUIGeneratorAdapter);
begin
  inherited;
...
class function TdxUIGeneratorBarEditItemInfo.IsBuiltInCommand(AAction: TAction;
  ACommandInfo: TdxUIGeneratorCommandInfo): Boolean;
begin
  Result := (AAction <> nil) and (ACommandInfo.Commands.Count = 0) and
    Supports(AAction, IdxActionValue);
end;

class function TdxUIGeneratorBarEditItemInfo.IsBuiltInItem(AItem: TdxBarItem;
  AParentLinks: TdxBarItemLinks): Boolean;
begin
  Result := inherited IsBuiltInItem(AItem, AParentLinks) and
    (TcxBarEditItem(AItem).PropertiesClass = GetEditProperties);
...
class function TdxUIGeneratorBarColorComboItemInfo.GetEditProperties
  : TcxCustomEditPropertiesClass;
begin
...
class procedure TdxUIGeneratorBarColorComboItemInfo.Initialize
  (AItem: TdxBarItem; ACommandInfo: TdxUIGeneratorCommandInfo;
  AAdapter: TdxUIGeneratorAdapter);
begin
  inherited;
  TcxColorComboBoxProperties(TcxBarEditItem(AItem).Properties)
    .AllowSelectColor := True;
  TcxColorComboBoxProperties(TcxBarEditItem(AItem).Properties).ColorDialogType
    := cxcdtAdvanced;
  TcxColorComboBoxProperties(TcxBarEditItem(AItem).Properties)
    .ColorDialogShowFull := True;
...
begin
  Result := inherited IsBuiltInCommand(AAction, ACommandInfo) and
    Supports(AAction, IdxActionColorValue);
end;
...
class function TdxUIGeneratorBarFontNameEditItemInfo.GetEditProperties
  : TcxCustomEditPropertiesClass;
begin
...
begin
  inherited;
  TcxFontNameComboBoxProperties(TcxBarEditItem(AItem).Properties)
    .FontPreview.Visible := False;
  TcxFontNameComboBoxProperties(TcxBarEditItem(AItem).Properties).FontTypes :=
    [cxftTTF];
end;
...
begin
  Result := inherited IsBuiltInCommand(AAction, ACommandInfo) and
    Supports(AAction, IdxActionFontNameValue);
end;
...
class function TdxUIGeneratorBarFontSizeEditItemInfo.GetEditProperties
  : TcxCustomEditPropertiesClass;
begin
...
begin
  Result := inherited IsBuiltInCommand(AAction, ACommandInfo) and
    Supports(AAction, IdxActionFontSizeValue);
end;
...
class function TdxUIGeneratorCustomBarAdapter.GetComponentClass
  : TComponentClass;
begin
  Result := TdxBarManager;
end;

function TdxUIGeneratorCustomBarAdapter.FindBarItem(AAction: TAction;
  ACommandInfo: TdxUIGeneratorCommandInfo; AParentItemLinks: TdxBarItemLinks;
  ABarItemInfo: TdxUIGeneratorBarItemInfoClass): TdxBarItem;
var
  ABarItem: TdxBarItem;
  I: Integer;
begin
  ...
  begin
    ...
    if (AAction <> nil) and (ABarItem.Action = AAction) or (AAction = nil) and
      (ABarItem.Caption = ACommandInfo.Caption) then
    begin
...
function TdxUIGeneratorCustomBarAdapter.FindSubItem(const ACaption: string;
  AItemLinks: TdxBarItemLinks): TdxBarItem;
var
...
function TdxUIGeneratorCustomBarAdapter.GetBarPopupMenuClass
  : TdxBarCustomPopupMenuClass;
begin
  Result := TdxBarPopupMenu;
end;

function TdxUIGeneratorCustomBarAdapter.GetCategoryIndex
  (ACommandInfo: TdxUIGeneratorCommandInfo): Integer;
var
  ACategory: string;
begin
  ACategory := Format('%s | %s', [ACommandInfo.Category.TabName,
    ACommandInfo.Category.BarName]);
...
begin
  ...
  if BarManager.ImageOptions.Images = nil then
    BarManager.ImageOptions.Images := TdxUIGeneratorHelper.CreateImageList
      (OwnerForm, 16);
  if BarManager.ImageOptions.LargeImages = nil then
    BarManager.ImageOptions.LargeImages := TdxUIGeneratorHelper.CreateImageList
      (OwnerForm, 32);
...
procedure TdxUIGeneratorCustomBarAdapter.PlaceCommand(AAction: TAction;
  ACommandInfo: TdxUIGeneratorCommandInfo);
  ...
  begin
    ...
    begin
      ...
      TdxUIGeneratorHelper.LoadImage(Result.Glyph, ACategory.BarGlyphFileName,
        ImageSet);
    end;
  end;

begin
  PlaceCommand(GetToolbar(ACommandInfo.Category).ItemLinks, AAction,
    ACommandInfo);
end;

procedure TdxUIGeneratorCustomBarAdapter.PlaceCommand
  (AItemLinks: TdxBarItemLinks; AAction: TAction;
  ACommandInfo: TdxUIGeneratorCommandInfo);
const
  ButtonStyleMap: array [Boolean] of TdxBarButtonStyle = (bsDropDown,
    bsCheckedDropDown);
var
  ABarItem: TdxBarItem;
  ...
  try
    ...
    begin
      ...
      try
        ...
        AItemLink.ButtonGroup := TdxBarButtonGroupPosition
          (ACommandInfo.GroupPosition);
        AItemLink.Position := TdxBarItemPosition(ACommandInfo.Position);
        AItemLink.ViewLevels := ConvertViewLevels(ACommandInfo.ViewLevels,
          ABarItem);
        if ABarItemInfo.GetDefaultWidth > 0 then
          AItemLink.UserWidth := dxGetScaleFactor(AItemLinks.Owner)
            .Apply(ABarItemInfo.GetDefaultWidth);
      finally
    ...
    begin
      ...
      begin
        ...
        begin
          TdxBarCustomButton(ABarItem).DropDownMenu :=
            TdxBarCustomPopupMenu(TdxUIGeneratorHelper.CreateComponent
            (OwnerForm, GetBarPopupMenuClass));
          TdxBarCustomButton(ABarItem).ButtonStyle :=
            ButtonStyleMap[TdxBarCustomButton(ABarItem)
      ...
      try
        for I := 0 to ACommandInfo.Commands.Count - 1 do
          PlaceCommand(AItemLinks, GetAction(ACommandInfo.Commands[I]),
            ACommandInfo.Commands[I]);
      finally
        AItemLinks.EndUpdate;
      end;
    end;
...
begin
  ...
  begin
    if [csAncestor, csDesigning] * Screen.Forms[I].ComponentState =
      [csAncestor, csDesigning] then
      Exit(True);
  end;
  Result := False;
end;
...
function TdxUIGeneratorCustomBarAdapter.ConvertViewLevels
  (AViewLevels: TdxUIGeneratorItemViewLevels; ABarItem: TdxBarItem)
...
begin
  ...
  begin
    ...
    if (ugivlSmallIcon in AViewLevels) and (ABarItem.ImageIndex < 0) and
      not(ABarItem is TdxCustomBarEdit) then
      Result := Result + [ivlSmallIconWithText];
  end;
end;

function TdxUIGeneratorCustomBarAdapter.GetBarItem(AAction: TAction;
  ACommandInfo: TdxUIGeneratorCommandInfo; AParentItemLinks: TdxBarItemLinks;
  ABarItemInfo: TdxUIGeneratorBarItemInfoClass): TdxBarItem;
var
...
begin
  ...
  if Result = nil then
  begin
    Result := TdxBarManagerAccess(BarManager)
      .CreateItem(ABarItemInfo.GetBarItemClass, BarManager.Owner, nil);
    Result.Category := GetCategoryIndex(ACommandInfo);
    Result.Action := AAction;
    Result.Name := TdxUIGeneratorHelper.GenerateName(Result);
    ABarItemInfo.Initialize(Result, ACommandInfo, Self);

    AddImage(AAction, ACommandInfo.ImageFileName, ASmallImageIndex,
      ALargeImageIndex);
