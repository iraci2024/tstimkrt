...
type
  ...
  TdxStyleDescriptionTopologicalComparer = class
    (TComparer<TdxStyleDescriptionBase>)
  public
    function Compare(const Left, Right: TdxStyleDescriptionBase)
      : Integer; override;
  end;
  ...
  public
    ...
    constructor Create(ACharacterStyle: TdxCharacterStyle;
      ACharacterStyleIndex: Integer; AFontNameIndex: Integer); overload;
    class function FromStream(AReader: TBinaryReader; ABaseSize: SmallInt;
      AIsExtended: Boolean): TdxCharacterStyleDescription; static;
  ...
  public
    constructor Create(ACharacterFormattingInfo: TdxCharacterFormattingInfo;
      ...
      ANumberingListIndex, AListLevelIndex, AFontNameIndex: Integer;
      ADocumentModel: TdxCustomDocumentModel); overload;
    constructor Create(AStyle: TdxParagraphStyle;
      AFontNameIndex: Integer); overload;
    destructor Destroy; override;

    property CharacterFormattingInfo: TdxCharacterFormattingInfo
      read FCharacterFormattingInfo;
    property CharacterFormattingOptions: TdxCharacterFormattingOptions
      read FCharacterFormattingOptions;
    property ParagraphFormattingInfo: TdxParagraphFormattingInfo
      read FParagraphFormattingInfo;
    property ParagraphFormattingOptions: TdxParagraphFormattingOptions
      read FParagraphFormattingOptions;
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader; ABaseSize: SmallInt;
      AIsExtended: Boolean): TdxParagraphStyleDescription; static;
  ...
  public
    constructor Create; overload;
    constructor Create(ATableStyle: TdxTableStyle;
      AFontNameIndex: Integer); overload;
    class function FromStream(AReader: TBinaryReader; ABaseSize: SmallInt;
      AIsExtended: Boolean): TdxTableStyleDescription; static;
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader; ABaseSize: SmallInt;
      AIsExtended: Boolean): TdxListStyleDescription; static;
...
function TdxStyleDescriptionTopologicalComparer.Compare(const Left,
  Right: TdxStyleDescriptionBase): Integer;
begin
...
constructor TdxCharacterStyleDescription.Create(ACharacterStyle
  : TdxCharacterStyle; ACharacterStyleIndex: Integer; AFontNameIndex: Integer);
var
...
begin
  ...
  try
    AActions := TdxDocCharacterPropertiesActions.Create(ACharacterMemoryStream,
      ACharacterStyle.CharacterProperties, AFontNameIndex);
    try
...
class function TdxCharacterStyleDescription.FromStream(AReader: TBinaryReader;
  ABaseSize: SmallInt; AIsExtended: Boolean): TdxCharacterStyleDescription;
begin
...
constructor TdxDocParagraphStyleInfo.Create(AStyle: TdxParagraphStyle;
  AFontNameIndex: Integer);
begin
  Create(AStyle.CharacterProperties.Info.Info,
    AStyle.CharacterProperties.Info.Options,
    AStyle.ParagraphProperties.Info.Info,
    AStyle.ParagraphProperties.Info.Options, AStyle.Tabs.Info,
    AStyle.GetNumberingListIndex, AStyle.GetListLevelIndex, AFontNameIndex,
    AStyle.DocumentModel);
end;

constructor TdxDocParagraphStyleInfo.Create(ACharacterFormattingInfo
...
constructor TdxParagraphStyleDescription.Create(AParagraphStyleInfo
  : TdxDocParagraphStyleInfo);
var
...
begin
  ...
  try
    AParagraphPropertiesActions := TdxDocParagraphPropertiesActions.Create
      (AParagraphMemoryStream, AParagraphStyleInfo);
    try
  ...
  ACharacterMemoryStream := TdxMemoryStream.Create;
  try
    ACharacterPropertiesActions := TdxDocCharacterPropertiesActions.Create
      (ACharacterMemoryStream, AParagraphStyleInfo);
    try
...
class function TdxParagraphStyleDescription.FromStream(AReader: TBinaryReader;
  ABaseSize: SmallInt; AIsExtended: Boolean): TdxParagraphStyleDescription;
begin
...
constructor TdxTableStyleDescription.Create(ATableStyle: TdxTableStyle;
  AFontNameIndex: Integer);
var
  ACharacterMemoryStream, AParagraphMemoryStream, ATableMemoryStream
    : TdxMemoryStream;
...
begin
  ...
  ACharacterMemoryStream := TdxMemoryStream.Create;
  try
    ACharacterActions := TdxDocCharacterPropertiesActions.Create
      (ACharacterMemoryStream, ATableStyle.CharacterProperties, AFontNameIndex);
    try
  ...
  AParagraphMemoryStream := TdxMemoryStream.Create;
  try
    AParagraphActions := TdxDocParagraphPropertiesActions.Create
      (AParagraphMemoryStream, ATableStyle.ParagraphProperties,
      ATableStyle.Tabs.Info);
    try
...
class function TdxTableStyleDescription.FromStream(AReader: TBinaryReader;
  ABaseSize: SmallInt; AIsExtended: Boolean): TdxTableStyleDescription;
begin
...
begin
  ...
  FParagraphUPX := TdxDocCommandHelper.CreateSinglePropertyModifier($460B,
    TdxByteArrayHelper.From<SmallInt>(AValue));
end;
...
class function TdxListStyleDescription.FromStream(AReader: TBinaryReader;
  ABaseSize: SmallInt; AIsExtended: Boolean): TdxListStyleDescription;
begin
