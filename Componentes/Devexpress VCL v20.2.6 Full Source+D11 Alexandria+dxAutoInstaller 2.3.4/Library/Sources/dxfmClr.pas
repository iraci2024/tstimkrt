...
{$ENDIF}
  ...
  Dialogs, ExtCtrls, Buttons, MultiMon,
  ...
  dxLayoutContainer, cxClasses, dxGalleryControl,
  dxColorGallery, dxLayoutControl, dxLayoutControlAdapters, Menus, StdCtrls,
  cxButtons, dxForms, dxLayoutcxEditAdapters,
...
type
  ...
  protected
    ...
    procedure Initialize(ABackground: TdxBackground; const APosition: TPoint;
      AData: TdxBackgroundDlgData); virtual;
  ...
  public
    ...
    property BorderStyle: TFormBorderStyle read FBorderStyle
      write SetBorderStyle;
    property NoBtnCaption: string read FNoBtnCaption write SetNoBtnCaption;
    property ShowFillEffects: Boolean read FShowFillEffects
      write SetShowFillEffects;
    property ShowMoreColors: Boolean read FShowMoreColors
      write SetShowMoreColors;
  end;
...
procedure TdxfmColorPalette.cgColorsItemClick(Sender: TObject;
