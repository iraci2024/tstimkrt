...
{$REGION 'PaperSizeTable'}
    PaperSizeTable: array [TdxPaperKind] of TSize = ((cx: 0; cy: 0), (cx: 12240;
      cy: 15840), (cx: 12240; cy: 15840), (cx: 15840; cy: 24480), (cx: 24480;
      cy: 15840), (cx: 12240; cy: 20160), (cx: 7920; cy: 12240), (cx: 10440;
      cy: 15120), (cx: 16839; cy: 23814), (cx: 11907; cy: 16839), (cx: 11907;
      cy: 16839), (cx: 8391; cy: 11907), (cx: 14572; cy: 20639), (cx: 10319;
      cy: 14571), (cx: 12240; cy: 18720), (cx: 12189; cy: 15591), (cx: 14400;
      cy: 20160), (cx: 15840; cy: 24480), (cx: 12240; cy: 15840), (cx: 5580;
      cy: 12780), (cx: 5940; cy: 13680), (cx: 6480; cy: 14940), (cx: 6840;
      cy: 15840), (cx: 7200; cy: 16560), (cx: 24480; cy: 31680), (cx: 31680;
      cy: 48960), (cx: 48960; cy: 63360), (cx: 6237; cy: 12474), (cx: 9185;
      cy: 12984), (cx: 18369; cy: 25965), (cx: 12983; cy: 18369), (cx: 6463;
      cy: 9184), (cx: 6463; cy: 12983), (cx: 14173; cy: 20013), (cx: 9978;
      cy: 14173), (cx: 9978; cy: 7087), (cx: 6236; cy: 13039), (cx: 5580;
      cy: 10800), (cx: 5220; cy: 9360), (cx: 21420; cy: 15840), (cx: 12240;
      cy: 17280), (cx: 12240; cy: 18720), (cx: 14173; cy: 20013), (cx: 5669;
      cy: 8391), (cx: 12960; cy: 15840), (cx: 14400; cy: 15840), (cx: 21600;
      cy: 15840), (cx: 12472; cy: 12472), (cx: - 1; cy: - 1), (cx: - 1;
      cy: - 1), (cx: 13680; cy: 17280), (cx: 13680; cy: 21600), (cx: 16834;
      cy: 25920), (cx: 13349; cy: 18274), (cx: 12240; cy: 15840), (cx: 11907;
      cy: 16839), (cx: 13680; cy: 17280), (cx: 12869; cy: 20183), (cx: 17291;
      cy: 27609), (cx: 12240; cy: 18274), (cx: 11907; cy: 18709), (cx: 8391;
      cy: 11907), (cx: 10319; cy: 14571), (cx: 18255; cy: 25228), (cx: 9865;
      cy: 13323), (cx: 11395; cy: 15647), (cx: 23811; cy: 33676), (cx: 16839;
      cy: 23814), (cx: 18255; cy: 25228), (cx: 11339; cy: 8391), (cx: 5953;
      cy: 8391), (cx: 12240; cy: 15840), (cx: 12240; cy: 15840), (cx: 12240;
      cy: 15840), (cx: 12240; cy: 15840), (cx: 15840; cy: 12240), (cx: 23814;
      cy: 16839), (cx: 16839; cy: 11907), (cx: 11907; cy: 8391), (cx: 20636;
      cy: 14570), (cx: 14570; cy: 10318), (cx: 8391; cy: 5669), (cx: 8391;
      cy: 11339), (cx: 8391; cy: 5953), (cx: 12240; cy: 15840), (cx: 12240;
      cy: 15840), (cx: 12240; cy: 15840), (cx: 12240; cy: 15840), (cx: 7257;
      cy: 10318), (cx: 10318; cy: 7257), (cx: 17280; cy: 15840), (cx: 12240;
      cy: 15840), (cx: 15840; cy: 12240), (cx: 8277; cy: 12189), (cx: 5499;
      cy: 8561), (cx: 5499; cy: 8561), (cx: 5783; cy: 9354), (cx: 5783;
      cy: 9978), (cx: 7087; cy: 9978), (cx: 6236; cy: 11792), (cx: 6236;
      cy: 12472), (cx: 6803; cy: 13039), (cx: 9071; cy: 13039), (cx: 6803;
      cy: 17518), (cx: 12983; cy: 18369), (cx: 18369; cy: 25965), (cx: 12189;
      cy: 8277), (cx: 8561; cy: 5499), (cx: 8561; cy: 5499), (cx: 9354;
      cy: 5783), (cx: 9978; cy: 5783), (cx: 9978; cy: 7087), (cx: 11792;
      cy: 6236), (cx: 12472; cy: 6236), (cx: 13039; cy: 6803), (cx: 13039;
      cy: 9071), (cx: 17518; cy: 6803), (cx: 18369; cy: 12983), (cx: 25965;
      cy: 18369));
{$ENDREGION}
  strict protected
    class function TryGetValue(AKind: TdxPaperKind; out ASize: TSize)
      : Boolean; static;
  public
    class function CalculatePaperKind(const ASize: TSize;
      const ADefaultValue: TdxPaperKind): TdxPaperKind; overload;
    class function CalculatePaperKind(const ASize: TSize;
      const ADefaultValue: TdxPaperKind; ATolerance: Integer;
      const ABadSizeDefaultValue: TdxPaperKind): TdxPaperKind; overload;
  ...
  public
    ...
    property GutterAlignment: TdxSectionGutterAlignment read FGutterAlignment
      write FGutterAlignment;
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxMarginsInfo; override;
  end;
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxPageInfo; override;
  end;
  ...
  public
    ...
    property DifferentFirstPage: Boolean read FDifferentFirstPage
      write FDifferentFirstPage;
    property FirstPagePaperSource: Integer read FFirstPagePaperSource
      write FFirstPagePaperSource;
    property OnlyAllowEditingOfFormFields: Boolean
      read FOnlyAllowEditingOfFormFields write FOnlyAllowEditingOfFormFields;
    property OtherPagePaperSource: Integer read FOtherPagePaperSource
      write FOtherPagePaperSource;
    ...
    property VerticalTextAlignment: TdxVerticalAlignment
      read FVerticalTextAlignment write FVerticalTextAlignment;
  end;
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxGeneralSectionInfo; override;
  end;
  ...
  public
    ...
    property ChapterSeparator: Char read FChapterSeparator
      write FChapterSeparator;
    property ChapterHeaderStyle: Integer read FChapterHeaderStyle
      write FChapterHeaderStyle;
    property NumberingFormat: TdxRichEditNumberingFormat read FNumberingFormat
      write FNumberingFormat;
    property FirstPageNumber: Integer read FFirstPageNumber
      write FFirstPageNumber;
    property ContinueNumbering: Boolean read FContinueNumbering
      write SetContinueNumbering default True;
  end;
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxPageNumberingInfo; override;
  end;
  ...
  public
    class function CalculateChangeActions(AChange: TdxSectionMarginsChangeType)
  ...
  strict protected
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxMarginsInfo>; override;
    function GetBatchUpdateChangeActions
      : TdxDocumentModelChangeActions; override;

    function SetLeftCore(const AMargins: TdxMarginsInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions; virtual;
    function SetRightCore(const AMargins: TdxMarginsInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions; virtual;
    function SetTopCore(const AMargins: TdxMarginsInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions; virtual;
    function SetBottomCore(const AMargins: TdxMarginsInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetGutterCore(const AMargins: TdxMarginsInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetGutterAlignmentCore(const AMargins: TdxMarginsInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetHeaderOffsetCore(const AMargins: TdxMarginsInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetFooterOffsetCore(const AMargins: TdxMarginsInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
  public
  ...
  public
    ...
    property DrawVerticalSeparator: Boolean read FDrawVerticalSeparator
      write FDrawVerticalSeparator;
    property EqualWidthColumns: Boolean read FEqualWidthColumns
      write FEqualWidthColumns;
    property Space: Integer read FSpace write FSpace;
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxColumnsInfo; override;
  end;
  ...
  public
    ...
    property NumberingRestartType: TdxLineNumberingRestart
      read FNumberingRestartType write FNumberingRestartType;
    property StartingLineNumber: Integer read FStartingLineNumber
      write FStartingLineNumber;
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxLineNumberingInfo; override;
  end;

  { TdxSectionLineNumbering }

  TdxSectionLineNumbering = class
    (TdxRichEditIndexBasedObject<TdxLineNumberingInfo>)
  strict protected
    function SetDistanceCore(const AInfo: TdxLineNumberingInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetStartingLineNumberCore(const AInfo: TdxLineNumberingInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetStepCore(const AInfo: TdxLineNumberingInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetNumberingRestartTypeCore(const AInfo: TdxLineNumberingInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxLineNumberingInfo>; override;
  ...
  public
    ...
    property StartingLineNumber: Integer read GetStartingLineNumber
      write SetStartingLineNumber;
  ...
  protected
    function CreateDefaultItem(const AUnitConverter
      : IdxDocumentModelUnitConverter): TdxFootNoteInfo; override;
  ...
  strict protected
    function SetWidthCore(const AInfo: TdxPageInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions; virtual;
    function SetHeightCore(const AInfo: TdxPageInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions; virtual;
    function SetLandscapeCore(const AInfo: TdxPageInfo; const AValue: Boolean)
      : TdxDocumentModelChangeActions; virtual;
    function SetPaperKindCore(const AInfo: TdxPageInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions; virtual;

    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxPageInfo>; override;
    function GetBatchUpdateChangeActions
      : TdxDocumentModelChangeActions; override;
  public
    constructor Create(const ADocumentModel: TdxCustomDocumentModel);
  ...
  strict protected
    function SetEqualWidthColumnsCore(const AInfo: TdxColumnsInfo;
      const AValue: Boolean): TdxDocumentModelChangeActions; virtual;
    function SetDrawVerticalSeparatorCore(const AInfo: TdxColumnsInfo;
      const AValue: Boolean): TdxDocumentModelChangeActions; virtual;
    function SetSpaceCore(const AInfo: TdxColumnsInfo; const AValue: Integer)
      : TdxDocumentModelChangeActions; virtual;
    function SetColumnCountCore(const AInfo: TdxColumnsInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxColumnsInfo>; override;
    function GetBatchUpdateChangeActions
      : TdxDocumentModelChangeActions; override;
  public
    constructor Create(ADocumentModel: TdxCustomDocumentModel); reintroduce;

    property EqualWidthColumns: Boolean read GetEqualWidthColumns
      write SetEqualWidthColumns;
    property DrawVerticalSeparator: Boolean read GetDrawVerticalSeparator
      write SetDrawVerticalSeparator;
  ...
  TdxSectionGeneralSettings = class
    (TdxRichEditIndexBasedObject<TdxGeneralSectionInfo>)
  strict private
  ...
  strict protected
    function SetOnlyAllowEditingOfFormFieldsCore(const AInfo
      : TdxGeneralSectionInfo; const AValue: Boolean)
      : TdxDocumentModelChangeActions; virtual;
    function SetDifferentFirstPageCore(const AInfo: TdxGeneralSectionInfo;
      const AValue: Boolean): TdxDocumentModelChangeActions; virtual;
    function SetFirstPagePaperSourceCore(const AInfo: TdxGeneralSectionInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetOtherPagePaperSourceCore(const AInfo: TdxGeneralSectionInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetTextDirectionCore(const AInfo: TdxGeneralSectionInfo;
      const AValue: TdxTextDirection): TdxDocumentModelChangeActions; virtual;
    function SetVerticalTextAlignmentCore(const AInfo: TdxGeneralSectionInfo;
      const AValue: TdxVerticalAlignment)
      : TdxDocumentModelChangeActions; virtual;
    function SetStartTypeCore(const AInfo: TdxGeneralSectionInfo;
      const AValue: TdxSectionStartType)
      : TdxDocumentModelChangeActions; virtual;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxGeneralSectionInfo>; override;
    function GetBatchUpdateChangeActions
      : TdxDocumentModelChangeActions; override;
  public
    constructor Create(ADocumentModel: TdxCustomDocumentModel); reintroduce;
    ...
    property OnlyAllowEditingOfFormFields: Boolean
      read GetOnlyAllowEditingOfFormFields
      write SetOnlyAllowEditingOfFormFields;
    property DifferentFirstPage: Boolean read GetDifferentFirstPage
      write SetDifferentFirstPage;
    property FirstPagePaperSource: Integer read GetFirstPagePaperSource
      write SetFirstPagePaperSource;
    property OtherPagePaperSource: Integer read GetOtherPagePaperSource
      write SetOtherPagePaperSource;
  ...
  TdxSectionPageNumbering = class
    (TdxRichEditIndexBasedObject<TdxPageNumberingInfo>)
  strict protected
    function SetChapterHeaderStyleCore(const AInfo: TdxPageNumberingInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetNumberingFormatCore(const AInfo: TdxPageNumberingInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetChapterSeparatorCore(const AInfo: TdxPageNumberingInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetFirstPageNumberCore(const AInfo: TdxPageNumberingInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetContinueNumberingCore(const AInfo: TdxPageNumberingInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxPageNumberingInfo>; override;
  ...
  strict protected
    function SetPositionCore(const AInfo: TdxFootNoteInfo;
      const AValue: TdxFootNotePosition)
      : TdxDocumentModelChangeActions; virtual;
    function SetNumberingFormatCore(const AInfo: TdxFootNoteInfo;
      const AValue: TdxRichEditNumberingFormat)
      : TdxDocumentModelChangeActions; virtual;
    function SetNumberingRestartTypeCore(const AInfo: TdxFootNoteInfo;
      const AValue: TdxLineNumberingRestart)
      : TdxDocumentModelChangeActions; virtual;
    function SetStartingNumberCore(const AInfo: TdxFootNoteInfo;
      const AValue: Integer): TdxDocumentModelChangeActions; virtual;
    function SetCustomMarkCore(const AInfo: TdxFootNoteInfo;
      const AValue: string): TdxDocumentModelChangeActions; virtual;
    function GetCache(const ADocumentModel: TdxCustomDocumentModel)
      : TdxUniqueItemsCache<TdxFootNoteInfo>; override;
    function GetBatchUpdateChangeActions
      : TdxDocumentModelChangeActions; override;
  public
    constructor Create(ADocumentModel: TdxCustomDocumentModel); reintroduce;
    ...
    property NumberingRestartType: TdxLineNumberingRestart
      read GetNumberingRestartType write SetNumberingRestartType;
    property StartingNumber: Integer read GetStartingNumber
      write SetStartingNumber;
...
type
  ...
  public
    class function CalculateChangeActions(AChange: TdxSectionFootNoteChangeType)
      : TdxDocumentModelChangeActions; static;
  end;
  ...
  public
    class function CalculateChangeActions
      (AChange: TdxSectionLineNumberingChangeType)
      : TdxDocumentModelChangeActions; static;
  end;
  ...
  public
    class function CalculateChangeActions(AChange: TdxSectionPageChangeType)
      : TdxDocumentModelChangeActions; static;
  end;
  ...
  public
    class function CalculateChangeActions(AChange: TdxSectionColumnsChangeType)
      : TdxDocumentModelChangeActions; static;
  end;
  ...
  public
    class function CalculateChangeActions
      (AChange: TdxSectionGeneralSettingsChangeType)
      : TdxDocumentModelChangeActions; static;
  end;
  ...
  public
    class function CalculateChangeActions
      (AChange: TdxSectionPageNumberingChangeType)
      : TdxDocumentModelChangeActions; static;
  end;

  { TdxSectionFootNoteChangeActionsCalculator }

class function TdxSectionFootNoteChangeActionsCalculator.CalculateChangeActions
  (AChange: TdxSectionFootNoteChangeType): TdxDocumentModelChangeActions;
const
  SectionFootNoteChangeActionsMap: array [TdxSectionFootNoteChangeType]
    of TdxDocumentModelChangeActions = ([TdxDocumentModelChangeAction.Redraw,
...
class function TdxSectionGeneralSettingsChangeActionsCalculator.
  CalculateChangeActions(AChange: TdxSectionGeneralSettingsChangeType)
  : TdxDocumentModelChangeActions;
const
  SectionGeneralSettingsChangeActionsMap
    : array [TdxSectionGeneralSettingsChangeType]
...
class function TdxSectionPageNumberingChangeActionsCalculator.
  CalculateChangeActions(AChange: TdxSectionPageNumberingChangeType)
  : TdxDocumentModelChangeActions;
const
  SectionPageNumberingChangeActionsMap
    : array [TdxSectionPageNumberingChangeType]
    of TdxDocumentModelChangeActions = ([],
    [TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetPrimaryLayout,
    TdxDocumentModelChangeAction.ResetSecondaryLayout],
...
class function TdxSectionColumnsChangeActionsCalculator.CalculateChangeActions
  (AChange: TdxSectionColumnsChangeType): TdxDocumentModelChangeActions;
const
  SectionColumnsChangeActionsMap: array [TdxSectionColumnsChangeType]
    of TdxDocumentModelChangeActions = ([],
    [TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetPrimaryLayout,
    TdxDocumentModelChangeAction.ResetSecondaryLayout,
...
class function TdxSectionLineNumberingChangeActionsCalculator.
  CalculateChangeActions(AChange: TdxSectionLineNumberingChangeType)
  : TdxDocumentModelChangeActions;
const
  SectionLineNumberingChangeActionsMap
    : array [TdxSectionLineNumberingChangeType]
    of TdxDocumentModelChangeActions = ([TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetPrimaryLayout,
    TdxDocumentModelChangeAction.ResetSecondaryLayout,
    TdxDocumentModelChangeAction.ResetSelectionLayout],
...
class function TdxSectionPageChangeActionsCalculator.CalculateChangeActions
  (AChange: TdxSectionPageChangeType): TdxDocumentModelChangeActions;
const
  SectionPageChangeActionsMap: array [TdxSectionPageChangeType]
    of TdxDocumentModelChangeActions = ([],
    [TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetPrimaryLayout,
    TdxDocumentModelChangeAction.ResetSecondaryLayout,
...
class function TdxPaperSizeCalculator.CalculatePaperKind(const ASize: TSize;
  const ADefaultValue: TdxPaperKind): TdxPaperKind;
begin
...
class function TdxPaperSizeCalculator.CalculatePaperKind(const ASize: TSize;
  const ADefaultValue: TdxPaperKind; ATolerance: Integer;
  const ABadSizeDefaultValue: TdxPaperKind): TdxPaperKind;
var
...
class function TdxPaperSizeCalculator.CalculatePaperSize(const APaperKind
  : TdxPaperKind): TSize;
begin
...
class function TdxPaperSizeCalculator.TryGetValue(AKind: TdxPaperKind;
  out ASize: TSize): Boolean;
begin
  Result := not(AKind in [TdxPaperKind.Custom, TdxPaperKind.Reserved_48,
    TdxPaperKind.Reserved_49]);
  if Result then
...
function TdxMarginsInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxMarginsInfo;
begin
  ...
  Result.HeaderOffset :=
    AUnitConverter.HundredthsOfMillimeterToModelUnits(1250);
  Result.FooterOffset :=
    AUnitConverter.HundredthsOfMillimeterToModelUnits(1250);
end;
...
procedure TdxPageInfo.ValidatePaperKind(AUnitConverter
...
begin
  ...
  PaperKind := TdxPaperSizeCalculator.CalculatePaperKind(ASize,
    TdxPaperKind.Custom, MSO2010_PageSizeTolerance, TdxPaperKind.Letter);
end;

{ TdxPageInfoCache }

function TdxPageInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxPageInfo;
begin
...
function TdxGeneralSectionInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxGeneralSectionInfo;
begin
...
function TdxPageNumberingInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxPageNumberingInfo;
begin
...
class function TdxSectionMarginsChangeActionsCalculator.CalculateChangeActions
  (AChange: TdxSectionMarginsChangeType): TdxDocumentModelChangeActions;
const
  SectionMarginsChangeActionsMap: array [TdxSectionMarginsChangeType]
    of TdxDocumentModelChangeActions = ([],
    [TdxDocumentModelChangeAction.Redraw,
    TdxDocumentModelChangeAction.ResetPrimaryLayout,
    TdxDocumentModelChangeAction.ResetSecondaryLayout,
...
constructor TdxSectionMargins.Create(const ADocumentModel
  : TdxCustomDocumentModel);
begin
  inherited Create(ADocumentModel.MainPart);
end;

function TdxSectionMargins.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxSectionMarginsChangeActionsCalculator.CalculateChangeActions
    (TdxSectionMarginsChangeType.BatchUpdate);
end;
...
function TdxSectionMargins.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxMarginsInfo>;
begin
...
begin
  ...
  Result := TdxSectionMarginsChangeActionsCalculator.CalculateChangeActions
    (TdxSectionMarginsChangeType.Bottom);
end;
...
begin
  ...
  Result := TdxSectionMarginsChangeActionsCalculator.CalculateChangeActions
    (TdxSectionMarginsChangeType.FooterOffset);
end;
...
procedure TdxSectionMargins.SetGutterAlignment(const Value
...
function TdxSectionMargins.SetGutterAlignmentCore(const AMargins
  : TdxMarginsInfo; const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AMargins.GutterAlignment := TdxSectionGutterAlignment(AValue);
  Result := TdxSectionMarginsChangeActionsCalculator.CalculateChangeActions
    (TdxSectionMarginsChangeType.GutterAlignment);
end;
...
begin
  ...
  Result := TdxSectionMarginsChangeActionsCalculator.CalculateChangeActions
    (TdxSectionMarginsChangeType.Gutter);
end;
...
begin
  ...
  Result := TdxSectionMarginsChangeActionsCalculator.CalculateChangeActions
    (TdxSectionMarginsChangeType.HeaderOffset);
end;
...
function TdxSectionMargins.SetLeftCore(const AMargins: TdxMarginsInfo;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AMargins.Left := AValue;
  Result := TdxSectionMarginsChangeActionsCalculator.CalculateChangeActions
    (TdxSectionMarginsChangeType.Left);
end;
...
function TdxSectionMargins.SetRightCore(const AMargins: TdxMarginsInfo;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AMargins.Right := AValue;
  Result := TdxSectionMarginsChangeActionsCalculator.CalculateChangeActions
    (TdxSectionMarginsChangeType.Right);
end;
...
function TdxSectionMargins.SetTopCore(const AMargins: TdxMarginsInfo;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AMargins.Top := AValue;
  Result := TdxSectionMarginsChangeActionsCalculator.CalculateChangeActions
    (TdxSectionMarginsChangeType.Top);
end;
...
var
  ...
  ACount, I: Integer;
begin
  if (AInfo.EqualWidthColumns <> EqualWidthColumns) or
    (AInfo.DrawVerticalSeparator <> DrawVerticalSeparator) or
...
function TdxColumnsInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxColumnsInfo;
begin
...
function TdxLineNumberingInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxLineNumberingInfo;
begin
...
constructor TdxSectionLineNumbering.Create(ADocumentModel
  : TdxCustomDocumentModel);
begin
  inherited Create(ADocumentModel.MainPart);
end;

function TdxSectionLineNumbering.SetDistanceCore(const AInfo
  : TdxLineNumberingInfo; const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.Distance := AValue;
  Result := TdxSectionLineNumberingChangeActionsCalculator.
    CalculateChangeActions(TdxSectionLineNumberingChangeType.Distance);
end;

function TdxSectionLineNumbering.SetStartingLineNumberCore
  (const AInfo: TdxLineNumberingInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.StartingLineNumber := AValue;
  Result := TdxSectionLineNumberingChangeActionsCalculator.
    CalculateChangeActions
    (TdxSectionLineNumberingChangeType.StartingLineNumber);
end;

function TdxSectionLineNumbering.SetStepCore(const AInfo: TdxLineNumberingInfo;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.Step := AValue;
  Result := TdxSectionLineNumberingChangeActionsCalculator.
    CalculateChangeActions(TdxSectionLineNumberingChangeType.Step);
end;

function TdxSectionLineNumbering.SetNumberingRestartTypeCore
  (const AInfo: TdxLineNumberingInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  ...
  Result := TdxSectionLineNumberingChangeActionsCalculator.
    CalculateChangeActions
    (TdxSectionLineNumberingChangeType.NumberingRestartType);
end;

function TdxSectionLineNumbering.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxLineNumberingInfo>;
begin
  Result := TdxDocumentCache(ADocumentModel.Cache).LineNumberingInfoCache;
end;

function TdxSectionLineNumbering.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxSectionLineNumberingChangeActionsCalculator.
    CalculateChangeActions(TdxSectionLineNumberingChangeType.BatchUpdate);
end;
...
function TdxSectionLineNumbering.GetNumberingRestartType
  : TdxLineNumberingRestart;
begin
  Result := Info.NumberingRestartType;
end;

procedure TdxSectionLineNumbering.SetNumberingRestartType
  (const AValue: TdxLineNumberingRestart);
begin
...
begin
  Result := (Position = AInfo.Position) and
    (NumberingFormat = AInfo.NumberingFormat) and
    (NumberingRestartType = AInfo.NumberingRestartType) and
    (StartingNumber = AInfo.StartingNumber) and (CustomMark = AInfo.CustomMark);
end;

function TdxFootNoteInfo.GetHashCode: Integer;
begin
  Result := Ord(Position) xor Ord(NumberingFormat) xor Ord(NumberingRestartType)
    xor StartingNumber;
  if FCustomMark <> '' then
...
function TdxFootNoteInfoCache.CreateDefaultItem(const AUnitConverter
  : IdxDocumentModelUnitConverter): TdxFootNoteInfo;
begin
...
procedure TdxFootNoteInfoCache.InitItems(const AUnitConverter
...
function TdxSectionPage.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxSectionPageChangeActionsCalculator.CalculateChangeActions
    (TdxSectionPageChangeType.BatchUpdate);
end;

function TdxSectionPage.GetCache(const ADocumentModel: TdxCustomDocumentModel)
  : TdxUniqueItemsCache<TdxPageInfo>;
begin
...
function TdxSectionPage.SetWidthCore(const AInfo: TdxPageInfo;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.Width := AValue;
  Result := TdxSectionPageChangeActionsCalculator.CalculateChangeActions
    (TdxSectionPageChangeType.Width);
end;

function TdxSectionPage.SetHeightCore(const AInfo: TdxPageInfo;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.Height := AValue;
  Result := TdxSectionPageChangeActionsCalculator.CalculateChangeActions
    (TdxSectionPageChangeType.Height);
end;
...
function TdxSectionPage.SetLandscapeCore(const AInfo: TdxPageInfo;
  const AValue: Boolean): TdxDocumentModelChangeActions;
begin
  AInfo.Landscape := AValue;
  Result := TdxSectionPageChangeActionsCalculator.CalculateChangeActions
    (TdxSectionPageChangeType.Landscape);
end;
...
function TdxSectionPage.SetPaperKindCore(const AInfo: TdxPageInfo;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.PaperKind := TdxPaperKind(AValue);
  Result := TdxSectionPageChangeActionsCalculator.CalculateChangeActions
    (TdxSectionPageChangeType.PaperKind);
end;
...
function TdxSectionColumns.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxSectionColumnsChangeActionsCalculator.CalculateChangeActions
    (TdxSectionColumnsChangeType.BatchUpdate);
end;

function TdxSectionColumns.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxColumnsInfo>;
begin
...
begin
  ...
  Result := TdxSectionColumnsChangeActionsCalculator.CalculateChangeActions
    (TdxSectionColumnsChangeType.ColumnCount);
end;
...
function TdxSectionColumns.SetDrawVerticalSeparatorCore
  (const AInfo: TdxColumnsInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.DrawVerticalSeparator := AValue;
  Result := TdxSectionColumnsChangeActionsCalculator.CalculateChangeActions
    (TdxSectionColumnsChangeType.DrawVerticalSeparator);
end;
...
begin
  ...
  Result := TdxSectionColumnsChangeActionsCalculator.CalculateChangeActions
    (TdxSectionColumnsChangeType.EqualWidthColumns);
end;
...
function TdxSectionColumns.SetSpaceCore(const AInfo: TdxColumnsInfo;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.Space := AValue;
  Result := TdxSectionColumnsChangeActionsCalculator.CalculateChangeActions
    (TdxSectionColumnsChangeType.Space);
end;

{ TdxSectionGeneralSettings }

constructor TdxSectionGeneralSettings.Create(ADocumentModel
  : TdxCustomDocumentModel);
begin
  inherited Create(ADocumentModel.MainPart);
end;
...
procedure TdxSectionGeneralSettings.SetStartType(const AValue
  : TdxSectionStartType);
begin
...
function TdxSectionGeneralSettings.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxSectionGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions(TdxSectionGeneralSettingsChangeType.BatchUpdate);
end;

function TdxSectionGeneralSettings.SetStartTypeCore
  (const AInfo: TdxGeneralSectionInfo; const AValue: TdxSectionStartType)
  : TdxDocumentModelChangeActions;
begin
  AInfo.StartType := AValue;
  Result := TdxSectionGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions(TdxSectionGeneralSettingsChangeType.StartType);
end;

function TdxSectionGeneralSettings.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxGeneralSectionInfo>;
begin
...
procedure TdxSectionGeneralSettings.SetOnlyAllowEditingOfFormFields
...
function TdxSectionGeneralSettings.SetOnlyAllowEditingOfFormFieldsCore
  (const AInfo: TdxGeneralSectionInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  AInfo.OnlyAllowEditingOfFormFields := AValue;
  Result := TdxSectionGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions
    (TdxSectionGeneralSettingsChangeType.OnlyAllowEditingOfFormFields);
end;
...
procedure TdxSectionGeneralSettings.SetDifferentFirstPage
  (const AValue: Boolean);
begin
...
function TdxSectionGeneralSettings.SetDifferentFirstPageCore
  (const AInfo: TdxGeneralSectionInfo; const AValue: Boolean)
  : TdxDocumentModelChangeActions;
begin
  ...
  Result := TdxSectionGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions
    (TdxSectionGeneralSettingsChangeType.DifferentFirstPage);
end;
...
procedure TdxSectionGeneralSettings.SetFirstPagePaperSource
...
function TdxSectionGeneralSettings.SetFirstPagePaperSourceCore
  (const AInfo: TdxGeneralSectionInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.FirstPagePaperSource := AValue;
  Result := TdxSectionGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions
    (TdxSectionGeneralSettingsChangeType.FirstPagePaperSource);
end;
...
procedure TdxSectionGeneralSettings.SetOtherPagePaperSource
  (const AValue: Integer);
begin
...
function TdxSectionGeneralSettings.SetOtherPagePaperSourceCore
  (const AInfo: TdxGeneralSectionInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  ...
  Result := TdxSectionGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions
    (TdxSectionGeneralSettingsChangeType.OtherPagePaperSource);
end;
...
procedure TdxSectionGeneralSettings.SetTextDirection(const AValue
  : TdxTextDirection);
begin
...
function TdxSectionGeneralSettings.SetTextDirectionCore
  (const AInfo: TdxGeneralSectionInfo; const AValue: TdxTextDirection)
  : TdxDocumentModelChangeActions;
begin
  AInfo.TextDirection := AValue;
  Result := TdxSectionGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions(TdxSectionGeneralSettingsChangeType.TextDirection);
end;

function TdxSectionGeneralSettings.GetVerticalTextAlignment
  : TdxVerticalAlignment;
begin
  Result := Info.VerticalTextAlignment;
end;

procedure TdxSectionGeneralSettings.SetVerticalTextAlignment
  (const AValue: TdxVerticalAlignment);
begin
...
function TdxSectionGeneralSettings.SetVerticalTextAlignmentCore
  (const AInfo: TdxGeneralSectionInfo; const AValue: TdxVerticalAlignment)
  : TdxDocumentModelChangeActions;
begin
  AInfo.VerticalTextAlignment := AValue;
  Result := TdxSectionGeneralSettingsChangeActionsCalculator.
    CalculateChangeActions
    (TdxSectionGeneralSettingsChangeType.VerticalTextAlignment);
end;

{ TdxSectionPageNumbering }

constructor TdxSectionPageNumbering.Create(ADocumentModel
  : TdxCustomDocumentModel);
begin
  inherited Create(ADocumentModel.MainPart);
end;

function TdxSectionPageNumbering.SetChapterHeaderStyleCore
  (const AInfo: TdxPageNumberingInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.ChapterHeaderStyle := AValue;
  Result := TdxSectionPageNumberingChangeActionsCalculator.
    CalculateChangeActions
    (TdxSectionPageNumberingChangeType.ChapterHeaderStyle);
end;

function TdxSectionPageNumbering.SetNumberingFormatCore
  (const AInfo: TdxPageNumberingInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.NumberingFormat := TdxRichEditNumberingFormat(AValue);
  Result := TdxSectionPageNumberingChangeActionsCalculator.
    CalculateChangeActions(TdxSectionPageNumberingChangeType.NumberingFormat);
end;

function TdxSectionPageNumbering.SetChapterSeparatorCore
  (const AInfo: TdxPageNumberingInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  AInfo.ChapterSeparator := Char(AValue);
  Result := TdxSectionPageNumberingChangeActionsCalculator.
    CalculateChangeActions(TdxSectionPageNumberingChangeType.ChapterSeparator);
end;
...
function TdxSectionPageNumbering.SetContinueNumberingCore
  (const AInfo: TdxPageNumberingInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
  ...
  Result := TdxSectionPageNumberingChangeActionsCalculator.
    CalculateChangeActions
    (TdxSectionPageNumberingChangeType.StartingPageNumber);
end;

function TdxSectionPageNumbering.SetFirstPageNumberCore
  (const AInfo: TdxPageNumberingInfo; const AValue: Integer)
  : TdxDocumentModelChangeActions;
begin
...
function TdxSectionPageNumbering.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxPageNumberingInfo>;
begin
  Result := TdxDocumentCache(ADocumentModel.Cache).PageNumberingInfoCache;
end;

function TdxSectionPageNumbering.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxSectionPageNumberingChangeActionsCalculator.
    CalculateChangeActions(TdxSectionPageNumberingChangeType.BatchUpdate);
end;
...
procedure TdxSectionPageNumbering.SetNumberingFormat(const AValue
...
function TdxSectionFootNote.SetPositionCore(const AInfo: TdxFootNoteInfo;
  const AValue: TdxFootNotePosition): TdxDocumentModelChangeActions;
begin
  AInfo.Position := AValue;
  Result := TdxSectionFootNoteChangeActionsCalculator.CalculateChangeActions
    (TdxSectionFootNoteChangeType.Position);
end;
...
procedure TdxSectionFootNote.SetNumberingFormat(const AValue
  : TdxNumberingFormat);
begin
  if NumberingFormat = AValue then
    Exit;
...
function TdxSectionFootNote.SetNumberingFormatCore(const AInfo: TdxFootNoteInfo;
  const AValue: TdxNumberingFormat): TdxDocumentModelChangeActions;
begin
  AInfo.NumberingFormat := AValue;
  Result := TdxSectionFootNoteChangeActionsCalculator.CalculateChangeActions
    (TdxSectionFootNoteChangeType.NumberingFormat);
end;
...
procedure TdxSectionFootNote.SetNumberingRestartType(const AValue
  : TdxLineNumberingRestart);
begin
  if NumberingRestartType = AValue then
    Exit;
  SetPropertyValue<TdxLineNumberingRestart>
    (SetNumberingRestartTypeCore, AValue);
end;

function TdxSectionFootNote.SetNumberingRestartTypeCore
  (const AInfo: TdxFootNoteInfo; const AValue: TdxLineNumberingRestart)
  : TdxDocumentModelChangeActions;
begin
  AInfo.NumberingRestartType := AValue;
  Result := TdxSectionFootNoteChangeActionsCalculator.CalculateChangeActions
    (TdxSectionFootNoteChangeType.NumberingRestartType);
end;
...
function TdxSectionFootNote.SetStartingNumberCore(const AInfo: TdxFootNoteInfo;
  const AValue: Integer): TdxDocumentModelChangeActions;
begin
  AInfo.StartingNumber := AValue;
  Result := TdxSectionFootNoteChangeActionsCalculator.CalculateChangeActions
    (TdxSectionFootNoteChangeType.StartingNumber);
end;
...
function TdxSectionFootNote.SetCustomMarkCore(const AInfo: TdxFootNoteInfo;
  const AValue: string): TdxDocumentModelChangeActions;
begin
  AInfo.CustomMark := AValue;
  Result := TdxSectionFootNoteChangeActionsCalculator.CalculateChangeActions
    (TdxSectionFootNoteChangeType.CustomMark);
end;

function TdxSectionFootNote.GetCache(const ADocumentModel
  : TdxCustomDocumentModel): TdxUniqueItemsCache<TdxFootNoteInfo>;
begin
  Result := TdxDocumentCache(ADocumentModel.Cache).FootNoteInfoCache;
end;

function TdxSectionFootNote.GetBatchUpdateChangeActions
  : TdxDocumentModelChangeActions;
begin
  Result := TdxSectionFootNoteChangeActionsCalculator.CalculateChangeActions
    (TdxSectionFootNoteChangeType.BatchUpdate);
end;
...
begin
  AConverter := TdxOrdinalBasedNumberConverter.CreateConverter(NumberingFormat,
    TdxLanguageId.English);
  try
