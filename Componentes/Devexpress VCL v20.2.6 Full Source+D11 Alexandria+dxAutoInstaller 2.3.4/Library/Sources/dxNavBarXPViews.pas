...
{$ENDIF}
  ...
  dxNavBarCustomPainters, dxNavBarBaseViews, dxNavBarExplorerViews,
  dxNavBarOfficeViews,
...
type
  ...
  protected
    class procedure CreateBitmap(var ADC: HDC; var ABitmap, AOldBitmap: HBITMAP;
      var AData: Pointer; AWidth, AHeight: Integer);
    class procedure deleteBitmap(var ADC: HDC; var ABitmap, AOldBitmap: HBITMAP;
      var AData: Pointer); // DeleteBitmap conflicts with C++ macro
    class procedure DrawMaskBitmap(DestX, DestY: Integer; DestHandle: THandle;
      Bitmap: TBitmap);
  ...
  public
    class function DrawObject(ACanvas: TCanvas; ARect: TRect;
      AObject: TdxThemedObjectType; iPartId, iStateId: Integer;
  ...
  TdxNavBarXPGroupBackgroundPainter = class
  ...
  TdxNavBarXPExplorerBarBackgroundPainter = class
...
begin
  ...
  begin
    if Group = NavBar.HotTrackedGroup then
      ...
      Result := DarkColor(clActiveCaption);
  end
  else
...
procedure TdxNavBarXP1Painter.DrawGroupCaptionButton(AGroupViewInfo
...
begin
  ...
  begin
    ...
    ButtonPainterClass.DrawButton(Canvas, CaptionRect, CaptionImage, Color1,
      Color2, CaptionAlphaBlend, CaptionAlphaBlend2, CaptionGradientMode,
      CaptionBorderColor, State, ScaleFactor);
  end;
end;
...
class function TdxNavBarXP1Painter.GetGroupViewInfoClass
  : TdxNavBarGroupViewInfoClass;
begin
  Result := TdxNavBarXP1GroupViewInfo;
end;

class function TdxNavBarXP1Painter.ScrollButtonsPainterClass
  : TdxNavBarCustomScrollButtonsPainterClass;
begin
  Result := TdxNavBarXPScrollButtonsPainter;
end;

class function TdxNavBarXP1Painter.SelectionPainterClass
...
class function TdxNavBarXP2Painter.BackgroundPainterClass
  : TdxNavBarCustomBackgroundPainterClass;
begin
  Result := TdxNavBarXPBackgroundPainter;
end;

class function TdxNavBarXP2Painter.ButtonPainterClass
  : TdxNavBarCustomButtonPainterClass;
begin
  Result := TdxNavBarXPButtonPainter;
end;

class function TdxNavBarXP2Painter.GroupBackgroundPainterClass
  : TdxNavBarCustomGroupBackgroundPainterClass;
begin
  Result := TdxNavBarXPGroupBackgroundPainter;
end;

class function TdxNavBarXP2Painter.ScrollButtonsPainterClass
  : TdxNavBarCustomScrollButtonsPainterClass;
begin
  Result := TdxNavBarXPScrollButtonsPainter;
end;

class function TdxNavBarXP2Painter.SelectionPainterClass
  : TdxNavBarCustomSelectionPainterClass;
begin
  Result := TdxNavBarXPSelectionPainter;
end;
...
begin
  ...
  else if cxGetThemeColor(totExplorerBar, EBP_NORMALGROUPBACKGROUND, 0,
    TMT_BORDERCOLOR, AColor) then
    Result := AColor
  else
...
var
  AColor: TColor;
begin
  if cxGetThemeColor(totExplorerBar, EBP_NORMALGROUPBACKGROUND, 0,
    TMT_FILLCOLOR, AColor) then
    Result := AColor
  else if cxGetThemeColor(totExplorerBar, EBP_NORMALGROUPBACKGROUND, 0,
    TMT_GRADIENTCOLOR1, AColor) then
    Result := AColor
  else
    Result := inherited BgBackColor;
end;
...
begin
  if cxGetThemeColor(totExplorerBar, EBP_NORMALGROUPBACKGROUND, 0,
    ...
    TMT_GRADIENTCOLOR2, AColor) then
    Result := AColor
  else
    Result := inherited BgBackColor2;
end;
...
function TdxNavBarXPExplorerBarGroupViewInfo.BgGradientMode
...
begin
  ...
  if cxGetThemeColor(totExplorerBar, APart, 0, TMT_FILLCOLOR, AColor) then
    Result := AColor
  else if cxGetThemeColor(totExplorerBar, APart, 0, TMT_GRADIENTCOLOR1, AColor)
  then
    Result := AColor
  else
    Result := inherited CaptionBackColor;
...
begin
  ...
  if cxGetThemeColor(totExplorerBar, APart, 0, TMT_FILLCOLOR, AColor) then
    Result := AColor
  else if cxGetThemeColor(totExplorerBar, APart, 0, TMT_GRADIENTCOLOR2, AColor)
  then
    Result := AColor
  else
    Result := inherited CaptionBackColor;
...
function TdxNavBarXPExplorerBarGroupViewInfo.CaptionGradientMode
  : TdxBarStyleGradientMode;
begin
  if OpenTheme(totExplorerBar) <> 0 then
    Result := gmHorizontal
...
var
  AColor: TColor;
begin
  if cxGetThemeColor(totExplorerBar, EBP_HEADERBACKGROUND, -1,
    TMT_GRADIENTCOLOR1, AColor) then
    Result := AColor
  else
    Result := inherited BgBackColor;
...
class function TdxNavBarXPExplorerBarPainter.GetViewInfoClass
  : TdxNavBarViewInfoClass;
begin
  Result := TdxNavBarXPExplorerBarViewInfo;
end;

class function TdxNavBarXPExplorerBarPainter.GetGroupViewInfoClass
  : TdxNavBarGroupViewInfoClass;
begin
  Result := TdxNavBarXPExplorerBarGroupViewInfo;
end;

class function TdxNavBarXPExplorerBarPainter.GetLinkViewInfoClass
  : TdxNavBarLinkViewInfoClass;
begin
  Result := TdxNavBarXPExplorerBarLinkViewInfo;
end;

class function TdxNavBarXPExplorerBarPainter.BackgroundPainterClass
  : TdxNavBarCustomBackgroundPainterClass;
begin
  Result := TdxNavBarXPExplorerBarBackgroundPainter;
end;

class function TdxNavBarXPExplorerBarPainter.ButtonPainterClass
  : TdxNavBarCustomButtonPainterClass;
begin
  Result := TdxNavBarXPExplorerBarButtonPainter;
end;

class function TdxNavBarXPExplorerBarPainter.SignPainterClass
...
class function TdxNavBarXPExplorerBarButtonPainter.GetButtonBitmap
...
class procedure TdxNavBarXPExplorerBarSignPainter.DrawMaskBitmap(DestX,
  DestY: Integer; DestHandle: THandle; Bitmap: TBitmap);
var
  I, J: Integer;
  DC1, DC2: HDC;
...
begin
  ...
  try
    BitBlt(DC1, 0, 0, Bitmap.Width, Bitmap.Height, Bitmap.Canvas.Handle, 0,
      0, SRCCOPY);
    BitBlt(DC2, 0, 0, Bitmap.Width, Bitmap.Height, DestHandle, DestX,
      DestY, SRCCOPY);

    ASourceData := Pointer(TdxNativeInt(Data1) +
      ((Bitmap.Height - 1) * Bitmap.Width * 4));
    ADestData := Pointer(TdxNativeInt(Data2) +
      ((Bitmap.Height - 1) * Bitmap.Width * 4));
    ...
    begin
      ...
      begin
        ...
        PByte(TdxNativeInt(ADestData) + 3)^ :=
          PByte(TdxNativeInt(ASourceData) + 3)^;
    ...
    BitBlt(DestHandle, DestX, DestY, Bitmap.Width, Bitmap.Height, DC2, 0,
      0, SRCCOPY);
  finally
...
class function TdxNavBarXPExplorerBarSignPainter.GetSignBitmap
  (AState: TdxNavBarObjectStates): TBitmap;
begin
  ...
  begin
    ...
    begin
      if (sSpecial in AState) and (dxXPExplorerBarSpecialGroupCollapseHot <> nil)
      then
        Result := dxXPExplorerBarSpecialGroupCollapseHot
      else
        Result := dxXPExplorerBarNormalGroupCollapseHot
    end
    else if (sSpecial in AState) and (dxXPExplorerBarSpecialGroupCollapse <> nil)
    then
  ...
  begin
    if (sSpecial in AState) and (dxXPExplorerBarSpecialGroupExpandHot <> nil)
    then
      Result := dxXPExplorerBarSpecialGroupExpandHot
    else
      Result := dxXPExplorerBarNormalGroupExpandHot
  end
  else if (sSpecial in AState) and (dxXPExplorerBarSpecialGroupExpand <> nil)
  then
...
begin
  ...
  begin
    ...
    else if AScaleFactor.Assigned then
    begin
      ABitmap := CloneBitmap(ABitmap, AScaleFactor.Apply(cxSize(ABitmap.Width,
        ABitmap.Height)));
      try
...
class function TdxNavBarXPPainter.DrawText(ACanvas: TCanvas; ARect: TRect;
  ACaption: string; ADrawTextFlag: Integer; AObject: TdxThemedObjectType;
  iPartId, iStateId: Integer): Boolean;
var
  ATheme: TdxTheme;
begin
  ...
  Result := ATheme <> 0;
  if Result then
    DrawThemeText(ATheme, ACanvas.Handle, iPartId, iStateId, ACaption, -1,
      ADrawTextFlag, 0, ARect);
end;

{ TdxNavBarXPBackgroundPainter }

class procedure TdxNavBarXPBackgroundPainter.InternalDrawBackground
  (ACanvas: TCanvas; ARect: TRect; APicture: TPicture;
  AEraseBackground: Boolean; ABackgroundColor: TColor; AColor1, AColor2: TColor;
  AAlphaBlend1, AAlphaBlend2: Byte; AGradientMode: TdxBarStyleGradientMode;
  AScaleFactor: TdxScaleFactor);
begin
  if not TdxNavBarXPPainter.DrawObject(ACanvas, ARect, totTab, TABP_BODY, 0,
    AScaleFactor) then
    inherited;
end;
...
class procedure TdxNavBarXPGroupBackgroundPainter.InternalDrawBackground
  (ACanvas: TCanvas; ARect: TRect; APicture: TPicture; AColor1, AColor2: TColor;
  AAlphaBlend1, AAlphaBlend2: Byte; AGradientMode: TdxBarStyleGradientMode;
  AScaleFactor: TdxScaleFactor);
begin
  TdxNavBarXPBackgroundPainter.DrawBackground(ACanvas, ARect, APicture, False,
    clNone, AColor1, AColor2, AAlphaBlend1, AAlphaBlend2, AGradientMode,
    AScaleFactor);
end;

{ TdxNavBarXPSelectionPainter }

class procedure TdxNavBarXPSelectionPainter.InternalDrawSelection
...
begin
  ...
  if not TdxNavBarXPPainter.DrawObject(ACanvas, ARect, totToolBar, TP_BUTTON,
    AStateID, AScaleFactor) then
    inherited;
end;
...
begin
  ...
  if not TdxNavBarXPPainter.DrawObject(ACanvas, ARect, totButton, BP_PUSHBUTTON,
    AStateID, AScaleFactor) then
    inherited;
end;
...
begin
  ...
  begin
    ...
    TdxNavBarXPPainter.DrawObject(ACanvas, ARect, totScrollBar, SBP_ARROWBTN,
      AStateID, AScaleFactor);
...
class function TdxNavBarXPExplorerBarBackgroundPainter.
  GetBackgroundBitmap: TBitmap;
begin
  Result := dxXPExplorerBarBackground;
end;

class procedure TdxNavBarXPExplorerBarBackgroundPainter.InternalDrawBackground
  (ACanvas: TCanvas; ARect: TRect; APicture: TPicture;
  AEraseBackground: Boolean; ABackgroundColor: TColor; AColor1, AColor2: TColor;
  AAlphaBlend1, AAlphaBlend2: Byte; AGradientMode: TdxBarStyleGradientMode;
  AScaleFactor: TdxScaleFactor);
...
RegisterView(dxNavBarXPExplorerBarView, 'XPExplorerBarView',
  TdxNavBarXPExplorerBarPainter);
