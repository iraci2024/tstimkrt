...
resourcestring
  ...
  sdxOutsideMarginsMessage =
    ...
    #13#10 + 'Do you want to continue ?';
  sdxOutsideMarginsMessage2 =
    'One or more margins are set outside the printable area of the page.' +
    #13#10 + 'Choose the Fix button to increase the appropriate margins.';
  ...
  sdxDefinePrintStylesWarningClear =
  ...
  sdxPrintDialogRangeLegend = 'Enter page number and/or page ranges' + #13#10 +
  ...
  sdxPrintDialogNoPrinters = 'No printers are installed. To install a printer, '
  ...
  sdxPDFDialogSecurityAllowPrintHiResolution =
  ...
  sdxPDFDialogSignatureUseCertificateFromFileStore =
    'Use Certificate from File';
  sdxPDFDialogSignatureUseCertificateFromSystemStore =
  ...
  sdxCannotUseOnEveryPageMode = 'Cannot Use OnEveryPage Mode' + #13#10 + #13#10
    + 'You should or(and)' + #13#10 + '  - Collapse all Master Records' + #13#10
    + '  - Toggle "Unwrap" Option off on "Behaviors" Tab';

  sdxIncorrectBandHeadersState = 'Cannot Use BandHeaders OnEveryPage Mode' +
    #13#10 + #13#10 + 'You should either:' + #13#10 +
    '  - Set Caption OnEveryPage Option On' + #13#10 +
    '  - Set Caption Visible Option Off';
  sdxIncorrectHeadersState = 'Cannot Use Headers OnEveryPage Mode' + #13#10 +
    #13#10 + 'You should either:' + #13#10 +
    '  - Set Caption and Band OnEveryPage Option On' + #13#10 +
    '  - Set Caption and Band Visible Option Off';
  sdxIncorrectFootersState = 'Cannot Use Footers OnEveryPage Mode' + #13#10 +
    #13#10 + 'You should either:' + #13#10 +
  ...
  sdxLinkIsNotIncludedInUsesClause = 'ReportFile contains ReportLink "%0:s"' +
    #13#10 + 'Unit with declaration of "%0:s" must be included in uses clause';
  sdxInvalidStorageVersion = 'Invalid Storage Verison: %d';
  sdxPSReportFiles = 'Report Files';
  sdxReportFileLoadError = 'Cannot load Report File "%s".' + #13#10 +
    'File is corrupted or is locked by another User or Application.' + #13#10 +
    #13#10 + 'Original Report will be restored.';
  ...
  sdxDBBasedExplorerItemDataLoadError = 'Cannot load Report Data.' + #13#10 +
    'Data are corrupted or are locked';
  sdxFileBasedExplorerItemDataLoadError = 'Cannot load Report Data.' + #13#10 +
    'File is corrupted or is locked by another User or Application';
  sdxDeleteNonEmptyFolderMessageText =
    'Folder "%s" is not Empty. Delete anyway?';
  sdxDeleteFolderMessageText = 'Delete Folder "%s" ?';
  sdxDeleteItemMessageText = 'Delete Item "%s" ?';
  sdxCannotRenameFolderText =
    'Cannot rename folder "%s". A folder with name "%s" already exists. Specify a different name.';
  sdxCannotRenameItemText =
    'Cannot rename item "%s". An item with name "%s" already exists. Specify a different name.';
  sdxOverwriteFolderMessageText =
    'This folder "%s" already contains folder named "%s".' + #13#10 + #13#10 +
    'If the items in existing folder have the same name as items in the' +
    #13#10 + 'folder you are moving or copying, they will be replaced. Do you still?'
    + #13#10 + 'want to move or copy the folder?';
  sdxOverwriteItemMessageText =
    'This Folder "%s" already contains item named "%s".' + #13#10 + #13#10 +
    'Would you like to overwrite existing item?';
  sdxSelectNewRoot =
    'Select new Root Directory where the Reports will be stored';
  ...
  sdxHintListViewDesignerMessage =
    ' Most Options Are Being Taken Into Account Only In Detailed View';
  ...
  sdx760V12Engine =
    '6.0L DOHC V12 438 HP 48V DI Valvetronic 12-cylinder engine with 6.0-liter displacement, dual overhead cam valvetrain';
  sdx760V12Transmission = 'Elec 6-Speed Automatic w/Steptronic';
  sdx760V12Tires =
    'P245/45R19 Fr - P275/40R19 Rr Performance. Low Profile tires with 245mm width, 19.0" rim';
  ...
  sdxCannotUseOnEveryPageModeInAggregatedState = 'Cannot Use OnEveryPage Mode' +
    #13#10 + 'While Performing in Aggregated State';
  ...
  sdxTLIncorrectHeadersState = 'Cannot Use Headers OnEveryPage Mode' + #13#10 +
    #13#10 + 'You should either:' + #13#10 +
  ...
  sdxInvalidRootDirectory =
    'Directory "%s" does not exists. Continue selection ?';
  ...
  sdxNewStyleRepositoryWasCreated =
    'New StyleRepository "%s" was created and assigned';
  ...
  sdxIncorrectFilterBarState = 'Cannot Use FilterBar OnEveryPage Mode' + #13#10
    + #13#10 + 'You should either:' + #13#10 +
    '  - Set Caption OnEveryPage Option On' + #13#10 +
    '  - Set Caption Visible Option Off';
  sdxIncorrectBandHeadersState2 = 'Cannot Use BandHeaders OnEveryPage Mode' +
    #13#10 + #13#10 + 'You should either:' + #13#10 +
    '  - Set Caption and FilterBar OnEveryPage Option On' + #13#10 +
    '  - Set Caption and FilterBar Visible Option Off';
  sdxIncorrectHeadersState2 = 'Cannot Use Headers OnEveryPage Mode' + #13#10 +
    #13#10 + 'You should either:' + #13#10 +
  ...
  // error messages
  sdxInconsistentTrifoldStyle =
    'The Tri-fold style requires at least one calendar section. ' +
    'Select Daily, Weekly, or Monthly Calendar for one of section under Options.';
  sdxBadTimePrintRange =
    'The hours to print are not valid. The start time must precede the end time.';
  sdxBadDatePrintRange =
    'The date in the End box cannot be prior to the date in the Start box.';
  sdxCannotPrintNoSelectedItems =
    'Cannot print unless an item is selected. Select an item, and then try to print again.';
  sdxCannotPrintNoItemsAvailable =
    'No items available within the specified print range.';
...
begin
  ...
  AProduct.Add('sdxFootnotesModeOnEveryBottomPage',
    @sdxFootnotesModeOnEveryBottomPage);
  ...
  AProduct.Add('sdxReportCellClassNotRegistered',
    @sdxReportCellClassNotRegistered);
  ...
  AProduct.Add('sdxDefinePrintStylesWarningDelete',
    @sdxDefinePrintStylesWarningDelete);
  AProduct.Add('sdxDefinePrintStylesWarningClear',
    @sdxDefinePrintStylesWarningClear);
  ...
  AProduct.Add('sdxPrintDialogOpenDlgPrinterFiles',
    @sdxPrintDialogOpenDlgPrinterFiles);
  AProduct.Add('sdxPrintDialogPageNumbersOutOfRange',
    @sdxPrintDialogPageNumbersOutOfRange);
  AProduct.Add('sdxPrintDialogInvalidPageRanges',
    @sdxPrintDialogInvalidPageRanges);
  AProduct.Add('sdxPrintDialogRequiredPageNumbers',
    @sdxPrintDialogRequiredPageNumbers);
  ...
  AProduct.Add('sdxPrintDialogPSPendingDeletion',
    @sdxPrintDialogPSPendingDeletion);
  ...
  AProduct.Add('sdxPrintDialogPSUserIntervention',
    @sdxPrintDialogPSUserIntervention);
  ...
  AProduct.Add('sdxPrintDialogPSPrintingAndWaiting',
  ...
  AProduct.Add('sdxCompositionStartEachItemFromNewPage',
    @sdxCompositionStartEachItemFromNewPage);
  AProduct.Add('sdxComponentNotSupportedByLink',
    @sdxComponentNotSupportedByLink);
end;
...
begin
  ...
  AProduct.Add('sdxMenuViewLargeToolBarButtons',
    @sdxMenuViewLargeToolBarButtons);
  ...
  AProduct.Add('sdxMenuViewHFSwitchHeaderFooter',
    @sdxMenuViewHFSwitchHeaderFooter);
  ...
  AProduct.Add('sdxHintInsertEditAutoTextEntries',
  ...
  AProduct.Add('sdxHintViewHFSwitchHeaderFooter',
    @sdxHintViewHFSwitchHeaderFooter);
  ...
  AProduct.Add('sdxHintDoubleClickForChangePaperSize',
    @sdxHintDoubleClickForChangePaperSize);
  AProduct.Add('sdxHintDoubleClickForChangeMargins',
    @sdxHintDoubleClickForChangeMargins);
  AProduct.Add('sdxDTFormatsCaption', @sdxDTFormatsCaption);
  AProduct.Add('sdxDTFormatsAvailableDateFormats',
    @sdxDTFormatsAvailableDateFormats);
  AProduct.Add('sdxDTFormatsAvailableTimeFormats',
    @sdxDTFormatsAvailableTimeFormats);
  AProduct.Add('sdxDTFormatsAutoUpdate', @sdxDTFormatsAutoUpdate);
  AProduct.Add('sdxDTFormatsChangeDefaultFormat',
    @sdxDTFormatsChangeDefaultFormat);
  ...
  AProduct.Add('sdxPNFormatsContinueFromPrevious',
    @sdxPNFormatsContinueFromPrevious);
  AProduct.Add('sdxPNFormatsStartAt', @sdxPNFormatsStartAt);
  AProduct.Add('sdxPNFormatsChangeDefaultFormat',
    @sdxPNFormatsChangeDefaultFormat);
  ...
  AProduct.Add('sdxPreferenceDlgMargingWhileDragging',
    @sdxPreferenceDlgMargingWhileDragging);
  ...
  AProduct.Add('sdxPreferenceDlgMeasurementUnits',
    @sdxPreferenceDlgMeasurementUnits);
  AProduct.Add('sdxPreferenceDlgSaveForRunTimeToo',
    @sdxPreferenceDlgSaveForRunTimeToo);
  ...
  AProduct.Add('sdxHFFunctionTemplatePageNumber',
    @sdxHFFunctionTemplatePageNumber);
  AProduct.Add('sdxHFFunctionTemplateTotalPages',
    @sdxHFFunctionTemplateTotalPages);
  AProduct.Add('sdxHFFunctionTemplatePageOfPages',
    @sdxHFFunctionTemplatePageOfPages);
  ...
  AProduct.Add('sdxHFFunctionTemplateMachineName',
  ...
  AProduct.Add('sdxMediumDashDotDotEdgePattern',
    @sdxMediumDashDotDotEdgePattern);
  ...
  AProduct.Add('sdxHorizontalStripeFillPattern',
    @sdxHorizontalStripeFillPattern);
  AProduct.Add('sdxVerticalStripeFillPattern', @sdxVerticalStripeFillPattern);
  AProduct.Add('sdxReverseDiagonalStripeFillPattern',
    @sdxReverseDiagonalStripeFillPattern);
  AProduct.Add('sdxDiagonalStripeFillPattern', @sdxDiagonalStripeFillPattern);
  AProduct.Add('sdxDiagonalCrossHatchFillPattern',
    @sdxDiagonalCrossHatchFillPattern);
  AProduct.Add('sdxThickCrossHatchFillPattern', @sdxThickCrossHatchFillPattern);
  AProduct.Add('sdxThinHorizontalStripeFillPattern',
    @sdxThinHorizontalStripeFillPattern);
  AProduct.Add('sdxThinVerticalStripeFillPattern',
    @sdxThinVerticalStripeFillPattern);
  AProduct.Add('sdxThinReverseDiagonalStripeFillPattern',
    @sdxThinReverseDiagonalStripeFillPattern);
  AProduct.Add('sdxThinDiagonalStripeFillPattern',
    @sdxThinDiagonalStripeFillPattern);
  AProduct.Add('sdxThinHorizontalCrossHatchFillPattern',
    @sdxThinHorizontalCrossHatchFillPattern);
  AProduct.Add('sdxThinDiagonalCrossHatchFillPattern',
    @sdxThinDiagonalCrossHatchFillPattern);
  ...
  AProduct.Add('sdxManufacturerNameColumnCaption',
    @sdxManufacturerNameColumnCaption);
  AProduct.Add('sdxManufacturerLogoColumnCaption',
...
begin
  ...
  AProduct.Add('sdxLinkIsNotIncludedInUsesClause',
  ...
  AProduct.Add('sdxDBBasedExplorerItemDataLoadError',
    @sdxDBBasedExplorerItemDataLoadError);
  AProduct.Add('sdxFileBasedExplorerItemDataLoadError',
    @sdxFileBasedExplorerItemDataLoadError);
  AProduct.Add('sdxDeleteNonEmptyFolderMessageText',
    @sdxDeleteNonEmptyFolderMessageText);
  ...
  AProduct.Add('sdxHintListViewDesignerMessage',
    @sdxHintListViewDesignerMessage);
  AProduct.Add('sdxColumnHeaders', @sdxColumnHeaders);
  AProduct.Add('sdxReportGroupNullLookAndFeel', @sdxReportGroupNullLookAndFeel);
  AProduct.Add('sdxReportGroupStandardLookAndFeel',
    @sdxReportGroupStandardLookAndFeel);
  AProduct.Add('sdxReportGroupOfficeLookAndFeel',
    @sdxReportGroupOfficeLookAndFeel);
  ...
  AProduct.Add('sdxCreateNewStyleQueryNamePrompt',
    @sdxCreateNewStyleQueryNamePrompt);
  AProduct.Add('sdxStyleSheetNameAlreadyExists',
  ...
  AProduct.Add('sdxCannotUseOnEveryPageModeInAggregatedState',
  ...
  AProduct.Add('sdxNewStyleRepositoryWasCreated',
    @sdxNewStyleRepositoryWasCreated);
  ...
  AProduct.Add('sdxSchedulerDateNavigatorContent',
    @sdxSchedulerDateNavigatorContent);
  AProduct.Add('sdxSchedulerDateNavigatorHeader',
    @sdxSchedulerDateNavigatorHeader);
  ...
  AProduct.Add('sdxPrintStyleShowResourceImages',
    @sdxPrintStyleShowResourceImages);
  AProduct.Add('sdxTabPrintStyles', @sdxTabPrintStyles);
  AProduct.Add('sdxPrintStyleDontPrintWeekEnds',
  ...
  AProduct.Add('sdxPrintStyleIncludeNotesAreaBlank',
  ...
  AProduct.Add('sdxPrintStyleWeeklyDaysLayoutTC',
    @sdxPrintStyleWeeklyDaysLayoutTC);
  AProduct.Add('sdxPrintStyleWeeklyDaysLayoutOC',
  ...
  AProduct.Add('sdxPrintStyleMemoPrintOnlySelectedEvents',
    @sdxPrintStyleMemoPrintOnlySelectedEvents);
  AProduct.Add('sdxPrintStyleMonthlyLayout1PPM',
    @sdxPrintStyleMonthlyLayout1PPM);
  AProduct.Add('sdxPrintStyleMonthlyLayout2PPM',
  ...
  AProduct.Add('sdxPrintStyleTrifoldSectionModeWeeklyCalendar',
    @sdxPrintStyleTrifoldSectionModeWeeklyCalendar);
  AProduct.Add('sdxPrintStyleTrifoldSectionModeMonthlyCalendar',
    @sdxPrintStyleTrifoldSectionModeMonthlyCalendar);
  AProduct.Add('sdxPrintStyleTrifoldSectionModeTaskPad',
    @sdxPrintStyleTrifoldSectionModeTaskPad);
  AProduct.Add('sdxPrintStyleTrifoldSectionModeNotesBlank',
    @sdxPrintStyleTrifoldSectionModeNotesBlank);
  AProduct.Add('sdxPrintStyleTrifoldSectionModeNotesLined',
    @sdxPrintStyleTrifoldSectionModeNotesLined);
  AProduct.Add('sdxPrintStyleTrifoldSectionLeft',
    @sdxPrintStyleTrifoldSectionLeft);
  AProduct.Add('sdxPrintStyleTrifoldSectionMiddle',
    @sdxPrintStyleTrifoldSectionMiddle);
  AProduct.Add('sdxPrintStyleTrifoldSectionRight',
  ...
  AProduct.Add('sdxPrintStylePrimaryPageScalesOnly',
    @sdxPrintStylePrimaryPageScalesOnly);
  AProduct.Add('sdxPrintStylePrimaryPageHeadersOnly',
    @sdxPrintStylePrimaryPageHeadersOnly);
  AProduct.Add('sdxPrintStyleDetailsStartNewPageEach',
  ...
  AProduct.Add('sdxHideDetailsOfPrivateAppointments',
  ...
  AProduct.Add('sdxRecurrencePatternLabelCaption',
    @sdxRecurrencePatternLabelCaption);
  ...
  AProduct.Add('sdxShowTimeAsOutOfOfficeMessage',
  ...
  AProduct.Add('sdxCannotPrintNoItemsAvailable',
    @sdxCannotPrintNoItemsAvailable);
...
begin
  ...
  AProduct.Add('sdxPDFDialogDocumentInfoTabSheet',
    @sdxPDFDialogDocumentInfoTabSheet);
  ...
  AProduct.Add('sdxPDFDialogSecurityAllowChanging',
    @sdxPDFDialogSecurityAllowChanging);
  AProduct.Add('sdxPDFDialogSecurityAllowComments',
    @sdxPDFDialogSecurityAllowComments);
  AProduct.Add('sdxPDFDialogSecurityAllowCopy', @sdxPDFDialogSecurityAllowCopy);
  AProduct.Add('sdxPDFDialogSecurityAllowDocumentAssemble',
    @sdxPDFDialogSecurityAllowDocumentAssemble);
  AProduct.Add('sdxPDFDialogSecurityAllowPrint',
    @sdxPDFDialogSecurityAllowPrint);
  AProduct.Add('sdxPDFDialogSecurityAllowPrintHiResolution',
    @sdxPDFDialogSecurityAllowPrintHiResolution);
  ...
  AProduct.Add('sdxPDFDialogSecurityOwnerPassword',
    @sdxPDFDialogSecurityOwnerPassword);
  AProduct.Add('sdxPDFDialogSecuritySettings', @sdxPDFDialogSecuritySettings);
  AProduct.Add('sdxPDFDialogSecurityUserPassword',
    @sdxPDFDialogSecurityUserPassword);
  AProduct.Add('sdxPDFDialogSignatureViewCertificate',
    @sdxPDFDialogSignatureViewCertificate);
  AProduct.Add('sdxPDFDialogSignatureRequiredDigitalID',
    @sdxPDFDialogSignatureRequiredDigitalID);
  AProduct.Add('sdxPDFDialogSignatureRequiredDigitalIDPassword',
    @sdxPDFDialogSignatureRequiredDigitalIDPassword);
  AProduct.Add('sdxPDFDialogSignatureContactInfo',
    @sdxPDFDialogSignatureContactInfo);
  AProduct.Add('sdxPDFDialogSignatureDetails', @sdxPDFDialogSignatureDetails);
  AProduct.Add('sdxPDFDialogSignatureDigitalID',
    @sdxPDFDialogSignatureDigitalID);
  AProduct.Add('sdxPDFDialogSignatureOpenDlgDigitalIDFile',
    @sdxPDFDialogSignatureOpenDlgDigitalIDFile);
  AProduct.Add('sdxPDFDialogSignatureOpenDlgTitle',
    @sdxPDFDialogSignatureOpenDlgTitle);
  ...
  AProduct.Add('sdxPDFDialogSignatureIssuerColumnCaption',
    @sdxPDFDialogSignatureIssuerColumnCaption);
  AProduct.Add('sdxPDFDialogSignatureExpirationDateColumnCaption',
    @sdxPDFDialogSignatureExpirationDateColumnCaption);
  ...
  AProduct.Add('sdxPDFDialogSignaturePasswordDialogCaption',
    @sdxPDFDialogSignaturePasswordDialogCaption);
  AProduct.Add('sdxPDFDialogSignatureSettings', @sdxPDFDialogSignatureSettings);
  AProduct.Add('sdxPDFDialogSignatureUseCertificateFromFileStore',
    @sdxPDFDialogSignatureUseCertificateFromFileStore);
  AProduct.Add('sdxPDFDialogSignatureUseCertificateFromSystemStore',
    @sdxPDFDialogSignatureUseCertificateFromSystemStore);
  ...
  AProduct.Add('sdxPDFDialogUseJPEGCompression',
    @sdxPDFDialogUseJPEGCompression);
end;

procedure AddResourceStringsForRibbonPreview
  (AProduct: TdxProductResourceStrings);
begin
  AProduct.Add('sdxRibbonPrintPreviewClosePrintPreview',
    @sdxRibbonPrintPreviewClosePrintPreview);
  AProduct.Add('sdxRibbonPrintPreviewGroupFormat',
    @sdxRibbonPrintPreviewGroupFormat);
  AProduct.Add('sdxRibbonPrintPreviewGroupInsertName',
    @sdxRibbonPrintPreviewGroupInsertName);
  AProduct.Add('sdxRibbonPrintPreviewGroupInsertPageNumber',
    @sdxRibbonPrintPreviewGroupInsertPageNumber);
  AProduct.Add('sdxRibbonPrintPreviewGroupNavigation',
    @sdxRibbonPrintPreviewGroupNavigation);
  AProduct.Add('sdxRibbonPrintPreviewGroupOutput',
    @sdxRibbonPrintPreviewGroupOutput);
  AProduct.Add('sdxRibbonPrintPreviewGroupParts',
    @sdxRibbonPrintPreviewGroupParts);
  AProduct.Add('sdxRibbonPrintPreviewGroupReport',
    @sdxRibbonPrintPreviewGroupReport);
  AProduct.Add('sdxRibbonPrintPreviewGroupScaleToFit',
    @sdxRibbonPrintPreviewGroupScaleToFit);
  AProduct.Add('sdxRibbonPrintPreviewGroupZoom',
    @sdxRibbonPrintPreviewGroupZoom);
  AProduct.Add('sdxRibbonPrintPreviewPagesSubItem',
    @sdxRibbonPrintPreviewPagesSubItem);
end;

procedure AddExpressPrintingSystemResourceStringNames
  (AProduct: TdxProductResourceStrings);
begin
...
dxResourceStringsRepository.RegisterProduct('ExpressPrinting System',
  @AddExpressPrintingSystemResourceStringNames);
