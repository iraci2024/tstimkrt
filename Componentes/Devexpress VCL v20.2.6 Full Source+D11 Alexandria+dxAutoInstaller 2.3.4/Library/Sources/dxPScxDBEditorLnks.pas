...
dxPSRegisterReportLink(TcxDBListBoxReportLink, TcxDBListBox,
  dxPSLbxLnk.TdxLBxReportLinkDesignWindow);
dxPSRegisterReportLink(TcxDBImageReportLink, TcxDBImage, nil);
dxPSRegisterReportLink(TcxDBMemoReportLink, TcxDBMemo,
...
dxPSUnregisterReportLink(TcxDBMemoReportLink, TcxDBMemo,
  TdxfmTextReportLinkDesignWindow);
dxPSUnregisterReportLink(TcxDBImageReportLink, TcxDBImage, nil);
dxPSUnregisterReportLink(TcxDBListBoxReportLink, TcxDBListBox,
  dxPSLbxLnk.TdxLBxReportLinkDesignWindow);
