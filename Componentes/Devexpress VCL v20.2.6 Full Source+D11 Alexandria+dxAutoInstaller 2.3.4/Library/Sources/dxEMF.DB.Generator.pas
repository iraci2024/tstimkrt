...
type
  ...
  public
    ...
    function PatchCriteria(AEntityInfo: TdxEntityInfo;
      const AOriginalCriteria: IdxCriteriaOperator): IdxCriteriaOperator;
  ...
  public
    constructor Create(AEntityInfo: TdxEntityInfo;
      ...
      const ASortByExpressions: IdxSortByExpressions;
    ...
    property TopSelectedRecords: Integer read FTopSelectedRecords
      write FTopSelectedRecords;
    property SkipSelectedRecords: Integer read FSkipSelectedRecords
      write FSkipSelectedRecords;
    property CollectionCriteriaPatcher: TdxCollectionCriteriaPatcher
      read FCollectionCriteriaPatcher write FCollectionCriteriaPatcher;
  ...
  public
    ...
    function Accept(const AVisitor: IdxCriteriaOperatorVisitor)
      : IdxCriteriaOperator; override;
  ...
  public
    constructor Create(ANode: TdxJoinNode; AMember: TdxMappingMemberInfo;
      ASub: Boolean); overload;
    constructor Create(ANode: TdxJoinNode; AMember: TdxMappingMemberInfo;
      ASubMembers: TdxMemberInfoList; const APrefix: string); overload;
    constructor Create(ANode: TdxJoinNode;
      AMember: TdxMappingMemberInfo); overload;
  ...
  public
    ...
    function GetParameter(const AValue: TValue): IdxOperandValue;
      virtual; abstract;
  end;
  ...
  strict private
    ...
    FUpdatedMembersBeforeDeleteDictionary
      : TdxObjectDictionary<TdxMemberInfoCollection>;
    FQueryOperandsCache: TDictionary<IdxQueryOperand, IdxQueryOperand>;
  protected
    function CacheQueryOperand(const AToCache: IdxQueryOperand)
      : IdxQueryOperand;
  public
    destructor Destroy; override;
    ...
    function GetParameter(const AValue: TValue): IdxOperandValue; override;
    procedure RegisterUpdatedMembersBeforeDelete(AObject: TObject;
      AMembers: TdxMemberInfoCollection);
    function TryGetUpdatedMembersBeforeDelete(AObject: TObject;
      out AMembers: TdxMemberInfoCollection): Boolean;
  ...
  strict private
    class var FNodeAliasCache: TArray<string>;
  strict private
    ...
    FIndexCount: Integer;
    FInheritanceSubNodes
      : TObjectDictionary<string, TDictionary<TdxDBTable, TdxJoinNode>>;
    FReferenceSubNodes: TObjectDictionary<string, TdxNamedJoinNodeDictionary>;
    FSingleAggregateSubNodes
      : TObjectDictionary<string, TDictionary<TdxSingleAggregateItem,
      TdxJoinNode>>;
    ...
    procedure AddMultiColumnAlias(const AOperator: IdxCriteriaOperator;
      const AAlias: IdxPropertyAlias);
    function AppendInheritanceJoinNode(ABranch: TdxEntityInfo;
      AProperty: TdxMappingMemberInfo; APrevNode: TdxJoinNode): TdxJoinNode;
    function AppendJoinNode(AProperty: TdxMappingMemberInfo;
      APrevNode: TdxJoinNode; AType: TdxJoinType): TdxJoinNode;
    function BuildInGroup(const ADefaultMembers: IdxPropertyAlias;
      AValues: TdxCriteriaOperatorList;
      const ALeftOperator: IdxCriteriaOperator): IdxCriteriaOperator;
    function CreateBinary(const ALeftOperator: IdxCriteriaOperator;
      const ALeftMembers: IdxPropertyAlias;
      const ARightOperator: IdxCriteriaOperator;
      const ARightMembers: IdxPropertyAlias;
      AOperatorType: TdxBinaryOperatorType; AIndex: Integer)
      : IdxBinaryOperator; overload;
    function CreateBinaryGroup(const ASubMembers: IdxPropertyAlias;
      const ALeftOperator: IdxCriteriaOperator;
      const ALeftMembers: IdxPropertyAlias;
      const ARightOperator: IdxCriteriaOperator;
      const ARightMembers: IdxPropertyAlias;
      AOperatorType: TdxBinaryOperatorType): IdxCriteriaOperator;
    function CollectInValues(const AOperands: IdxCriteriaOperatorCollection;
      AValues: TdxCriteriaOperatorList): IdxPropertyAlias;
    function GetClassInfoStack: TStack<TdxEntityInfo>;
    function GetConstParameter(AMember: TdxMappingMemberInfo;
      const AOperand: IdxOperandValue; ATargetMember: TdxMappingMemberInfo)
      : IdxOperandValue; overload;
    function GetJoinCondition(const ALeftAlias, ARightAlias: string;
    ...
    function ProcessTopSubSelect(const AAggregateProperty, AOperandClause
      : IdxCriteriaOperator; AAggregateFunctionType: TdxAggregateFunctionType)
      : TdxQuerySubQueryContainer;
    class procedure SetJoinTypeWithSubNodes(ANode: TdxJoinNode;
      AType: TdxJoinType); static;
    function TryGetMultiColumnAlias(const AOperator: IdxCriteriaOperator;
      out AAlias: IdxPropertyAlias): Boolean;
  protected
    procedure BuildAssociationTree(const ACriteria: IdxCriteriaOperator);
    function CreateBinary(AType: TdxBinaryOperatorType;
      const ALeftOperator, ARightOperator: IdxCriteriaOperator)
      : IdxCriteriaOperator; overload;
    function CreateRootStatement(ATable: TdxDBTable; const AAlias: string)
      : TdxBaseStatement; virtual; abstract;
    function CreateOperand(AMember: TdxMappingMemberInfo;
      const ANodeAlias: string): IdxQueryOperand; overload;
    function CreateOperand(const AMappingField, ANodeAlias: string)
      : IdxQueryOperand; overload;
    function ConvertViaDefaultValueConverter(var AOperandValue: TValue)
      : Boolean;
    function ExecuteWithPropertyNameDiving(const APropertyName: string;
      const AWorker: TFunc<string, IdxCriteriaOperator>;
      AThrowOnEmptyStack: Boolean = True): IdxCriteriaOperator;
    function GenerateSQL(const ACriteria: IdxCriteriaOperator)
      : TdxBaseStatement;
    function GetConstParameter(const AValue: TValue): IdxOperandValue; overload;
    function GetMembers(ANode: TdxJoinNode; AMember: TdxMappingMemberInfo)
      : IdxPropertyAlias; overload;
    function GetMembers(AMember: TdxMappingMemberInfo; out APrefix: string)
      : TdxMemberInfoList; overload;
    function GetSubMembers(AMember: TdxMappingMemberInfo; const APrefix: string)
      : TdxMemberInfoList;
    function GetNextNodeAlias: string; virtual;
    function GetParameter(const AParam: IdxCriteriaOperator;
      const AAlias: IdxPropertyAlias; AIndex: Integer): IdxCriteriaOperator;
    function GetPropertyNode(APropertyPath: TdxMemberInfoCollection;
      AType: TdxJoinType): IdxPropertyAlias; overload;
    function GetPropertyNode(const AProperty: IdxOperandProperty;
      AType: TdxJoinType): IdxPropertyAlias; overload; virtual;
    function GetSubJoinCriteria(AGena: TdxBaseQueryGenerator)
      : IdxCriteriaOperator; virtual;
    function GetQueryOperandFromAlias(const AAliasFromParam,
      AAlias: IdxPropertyAlias; AIndex: Integer): IdxCriteriaOperator;
    class function GetProjectedMemberColumn(const AMappingField: string;
      ANode: TdxJoinNode; AProjectedNodeList: TdxJoinNodeList;
      const AParentCriteria: IdxCriteriaOperator = nil): TdxDBColumn; static;
    function IsGrouped: Boolean; virtual;
    procedure InitData; virtual;
    procedure InternalGenerateSQL(const ACriteria: IdxCriteriaOperator);
      virtual; abstract;
    function AppendSingleAggregateJoinNode(AEntityInfo: TdxEntityInfo;
      ACollectionProperty: TdxMappingMemberInfo;
      const ACondition: IdxCriteriaOperator; APrevNode: TdxJoinNode;
      AType: TdxJoinType): TdxJoinNode;
    function PatchCriteria(const AOriginalCriteria: IdxCriteriaOperator)
      : IdxCriteriaOperator; overload; inline;
    function PatchCriteria(const AOriginalCriteria: IdxCriteriaOperator;
      AEntityInfo: TdxEntityInfo): IdxCriteriaOperator; overload;
    function Process(const AOperand: IdxCriteriaOperator): IdxCriteriaOperator;
    function ProcessLogical(const AOperand: IdxCriteriaOperator)
      : IdxCriteriaOperator;
    function ProcessLogicalInContext(AEntityInfo: TdxEntityInfo;
      ASingleNode: TdxJoinNode; const ACriteria: IdxCriteriaOperator)
      : IdxCriteriaOperator;
    function ProcessSingleAggregateOperand(const ACollectionProperty
      : IdxOperandProperty; const ACondition, AAggregatedExpression
      : IdxCriteriaOperator): IdxCriteriaOperator;
    function ProcessSubSelectOperator(const ACollectionProperty
      : IdxOperandProperty; const AOperandClause: IdxCriteriaOperator;
      const AAggregateProperty: IdxCriteriaOperator;
      AAggregateFunctionType: TdxAggregateFunctionType)
      : TdxQuerySubQueryContainer; overload;
    function ProcessSubSelectOperator(const AJoinTypeName: string;
      const AOperandClause, AAggregateProperty: IdxCriteriaOperator;
      AAggregateFunctionType: TdxAggregateFunctionType)
      : TdxQuerySubQueryContainer; overload;
    function ProcessSingleJoinOperand(const AJoinTypeName: string;
      const ACondition, AAggregatedExpression: IdxCriteriaOperator)
      : IdxCriteriaOperator;
    procedure TryAddNodeIntoProjection(APrevNode: TdxJoinNode;
      ANode: TdxJoinNode);
    { IdxCriteriaOperatorVisitor }
    function Visit(const AOperator: IdxBetweenOperator)
      : IdxCriteriaOperator; overload;
    function Visit(const AOperator: IdxBinaryOperator)
      : IdxCriteriaOperator; overload;
    function Visit(const AOperator: IdxUnaryOperator)
      : IdxCriteriaOperator; overload;
    function Visit(const AOperator: IdxInOperator)
      : IdxCriteriaOperator; overload;
    function Visit(const AOperator: IdxGroupOperator)
      : IdxCriteriaOperator; overload;
    function Visit(const AOperand: IdxOperandValue)
      : IdxCriteriaOperator; overload;
    function Visit(const AOperator: IdxFunctionOperator)
      : IdxCriteriaOperator; overload;

    function Visit(const AOperand: IdxOperandProperty)
      : IdxCriteriaOperator; overload;
    function Visit(const AOperator: IdxAggregateOperand)
      : IdxCriteriaOperator; overload;
    function Visit(const AOperator: IdxJoinOperand)
      : IdxCriteriaOperator; overload;
  ...
  public
    constructor Create(AEntityInfo: TdxEntityInfo;
      ABatchWideData: TdxBatchWideDataHolder); overload;
    constructor Create(AEntityInfo: TdxEntityInfo;
      ABatchWideData: TdxBatchWideDataHolder;
  ...
  strict private
    ...
    FSorting: IdxSortByExpressions;
    function BuildAssociation(const AProperties: IdxCriteriaOperatorCollection)
      : TArray<IdxCriteriaOperator>;
    procedure BuildAssociationByProperties(const AProperties
  ...
  protected
    FCurrentJoinType: TdxJoinType;
    function CreateRootStatement(ATable: TdxDBTable; const AAlias: string)
      : TdxBaseStatement; override;
    function GetSubJoinCriteria(AGena: TdxBaseQueryGenerator)
      : IdxCriteriaOperator; override;
    procedure InternalGenerateSQL(const ACriteria
      : IdxCriteriaOperator); override;
  ...
  public
    constructor Create(AEntityInfo: TdxEntityInfo;
      ...
      const AProperties: IdxCriteriaOperatorCollection;
      const ASortByExpressions: IdxSortByExpressions;
      const AGrouping: IdxCriteriaOperatorCollection;
      const AGroupCriteria: IdxCriteriaOperator;
      const ACollectionCriteriaPatcher: TdxCollectionCriteriaPatcher);
    class function GenerateSelect(AQuery: TdxObjectsQuery;
      ...
      overload; static;
    class function GenerateSelect(AEntityInfo: TdxEntityInfo;
      const ACriteria: IdxCriteriaOperator;
      const AProperties: IdxCriteriaOperatorCollection;
      const ASortByExpressions: IdxSortByExpressions;
      const AGrouping: IdxCriteriaOperatorCollection;
    ...
    class function GenerateSelect(AEntityInfo: TdxEntityInfo;
      const ACriteria: IdxCriteriaOperator;
      AProperties: TdxMemberPathCollection;
      const ASortByExpressions: IdxSortByExpressions;
      const AGrouping: IdxCriteriaOperatorCollection;
      const AGroupCriteria: IdxCriteriaOperator;
      const ACollectionCriteriaPatcher: TdxCollectionCriteriaPatcher;
  ...
  protected
    function GenerateSQL(ACriteriaSet: TdxObjectGeneratorCriteriaSet;
      const AProperties: TArray<TdxMappingMemberInfo>; AReverse: Boolean = True)
      : TList<TdxModificationStatement>; overload;
    function GetClasses: TList<TdxEntityInfo>;
    function GetMemberParameter(AMember: TdxMappingMemberInfo; AObject: TObject)
      : IdxOperandValue;
    ...
    property BatchWideData: TdxBatchWideDataHolderForModification
      read GetBatchWideData;
  ...
  public
    ...
    constructor Create(ABatchWideData: TdxBatchWideDataHolderForModification;
      AObject: TObject); overload;
    class function BuildKeyCriteria(AObject: TObject)
  ...
  public
    constructor Create(APool: TDictionary<TdxEntityInfo, TdxRefHolder>;
      AMe: TdxEntityInfo);
    destructor Destroy; override;
    class function GetNonReferenced
      (APool: TDictionary<TdxEntityInfo, TdxRefHolder>)
      : TArray<TdxEntityInfo>; static;
    class function CreatePool(AObjects: TList<TObject>)
      : TDictionary<TdxEntityInfo, TdxRefHolder>; static;
    class procedure ProcessDelete(APool: TDictionary<TdxEntityInfo,
      TdxRefHolder>; AEntityInfo: TdxEntityInfo); static;
    class function GenerateUpdatesBeforeDelete(AEntityInfo: TdxEntityInfo;
      AUpdateList: TdxMemberInfoCollection; const AKeys: TArray<TObject>;
      ABatchWideData: TdxBatchWideDataHolderForModification;
      ALocking: TdxLockingOption): TArray<TdxModificationStatement>; static;
    function CanReach(ATarget: TdxEntityInfo): Boolean; overload;
    function CanReach(AProcessed: TDictionary<TdxEntityInfo, TdxEntityInfo>;
      ATarget: TdxEntityInfo): Boolean; overload;
    function IsInLoop: Boolean;
    procedure FillDirectlyRefs;
    function DoUpdates(ALocking: TdxLockingOption;
      ABatchWideData: TdxBatchWideDataHolderForModification)
      : TArray<TdxModificationStatement>;
    property Objects: TList<TObject> read FObjects;
    property DirectlyAssignableNotDeleted
      : TDictionary<TdxEntityInfo, TdxRefHolder>
      read FDirectlyAssignableNotDeleted;
  end;
  ...
  protected
    class function GenerateDeleteCore(AEntityInfo: TdxEntityInfo;
      const AKeys: TArray<TObject>; ALocking: TdxLockingOption;
      ABatchWideData: TdxBatchWideDataHolderForModification)
      : TList<TdxModificationStatement>; static;
    procedure InitData; override;
    procedure InternalGenerateSQL(const ACriteria
      : IdxCriteriaOperator); override;
    function CreateRootStatement(ATable: TdxDBTable; const AAlias: string)
  ...
  public
    class function GenerateDelete(AObject: TObject; ALocking: TdxLockingOption;
      ABatchWideData: TdxBatchWideDataHolderForModification)
      : TList<TdxModificationStatement>; overload; static;
    class function GenerateDelete(AEntityInfo: TdxEntityInfo;
      const AKeys: TList<TObject>; ALocking: TdxLockingOption;
      ABatchWideData: TdxBatchWideDataHolderForModification)
      : TList<TdxModificationStatement>; overload; static;
    class function GenerateDelete(const AObjects: TList<TObject>;
      ALocking: TdxLockingOption;
      ABatchWideData: TdxBatchWideDataHolderForModification)
      : TList<TdxModificationStatement>; overload; static;
    class function GenerateDelete(AEntityInfo: TdxEntityInfo;
      ...
      ABatchWideData: TdxBatchWideDataHolderForModification)
      : TList<TdxModificationStatement>; overload; static;
    class procedure GenerateDeletes(AEntityInfo: TdxEntityInfo;
      ACriteriaSet: TdxObjectGeneratorCriteriaSet;
      ARes: TList<TdxModificationStatement>; ACount: Integer;
      ABatchWideData: TdxBatchWideDataHolderForModification); static;
  end;
  ...
  public
    class function GenerateUpdate(ABatchWideData
      : TdxBatchWideDataHolderForModification; AObject: TObject;
      const AProperties: TArray<TdxMappingMemberInfo>;
      ACriteriaSet: TdxObjectGeneratorCriteriaSet)
      : TList<TdxModificationStatement>; overload; static;
    class function GenerateUpdate(AObject: TObject;
      const AProperties: TArray<TdxMappingMemberInfo>;
      ACriteriaSet: TdxObjectGeneratorCriteriaSet)
      : TList<TdxModificationStatement>; overload; static;
    class function GenerateUpdate(AEntityInfo: TdxEntityInfo;
      const AProperties: TArray<TdxMappingMemberInfo>;
      ACriteriaSet: TdxObjectGeneratorCriteriaSet;
      ABatchWideData: TdxBatchWideDataHolderForModification)
      : TList<TdxModificationStatement>; overload; static;
  ...
  public
    class function GenerateInsert(AObject: TObject;
      const AProperties: TArray<TdxMappingMemberInfo>)
      : TList<TdxModificationStatement>; overload; static;
    class function GenerateInsert(ABatchWideData
      : TdxBatchWideDataHolderForModification; AObject: TObject;
      const AProperties: TArray<TdxMappingMemberInfo>)
      : TList<TdxModificationStatement>; overload; static;
  end;
  ...
  public
    constructor Create(const AAliases: TArray<string>;
...
type
  ...
  public
    class function Create(AColumn: TdxDBColumn; const ANodeAlias: string;
      const AParentCriteria: IdxCriteriaOperator = nil): IdxQueryOperand;
      overload; static;
  end;
  ...
  public
    class function GetRange(ASrc: TList<TObject>; AIndex, ACount: Integer)
      : TArray<TObject>; overload; static;
    class function GetRange(const ASrc: array of TObject;
      AIndex, ACount: Integer): TArray<TObject>; overload; static;
  end;
  ...
  public
    constructor Create(ARoot: TdxBaseStatement;
      AProjectedNodes: TdxNamedJoinNodeDictionary;
      AProjectionNodes: TdxNamedOrdinalDictionary<TdxProjectionNodeItem>);
    destructor Destroy; override;
    class procedure Patch(ARoot: TdxBaseStatement;
      AProjectedNodes: TdxNamedJoinNodeDictionary;
      AProjectionNodes: TdxNamedOrdinalDictionary<TdxProjectionNodeItem>);
      overload; static;
  ...
  public
    constructor Create(const ARootNode: string; const ANodes: TArray<string>;
      const ACriteria: TEnumerable<TdxPlanAliasCriteriaInfo>;
  ...
  strict private
    FNodeCriteriaInfoDictionary
      : TDictionary<string, TList<TdxPlanAliasCriteriaInfo>>;
    FNodeDictionary: TdxNamedJoinNodeDictionary;
    FRoot: TdxBaseStatement;
  protected
    class procedure CollectNodes(ANode: TdxJoinNode;
      ACollectedNodes: TdxNamedJoinNodeDictionary); static;
    ...
    procedure NormalizeNodeTree(AParentNode: TdxJoinNode; ASubNode: TdxJoinNode;
  ...
  protected
    ...
    function GetPropertyNode(const AProperty: IdxOperandProperty;
      AType: TdxJoinType): IdxPropertyAlias; override;
    function CreateRootStatement(ATable: TdxDBTable; const AAlias: string)
      : TdxBaseStatement; override;
  public
    constructor Create(AParent: TdxBaseQueryGenerator;
      ABatchWideData: TdxBatchWideDataHolder; const APropertyName: string;
      AObjectInfo: TdxEntityInfo; const AAggregateProperty: IdxCriteriaOperator;
      AAggregate: TdxAggregateFunctionType;
      ACollectionCriteriaPatcher: TdxCollectionCriteriaPatcher);
    function GenerateSelect(const ACriteria: IdxCriteriaOperator)
      : TdxBaseStatement;
  end;

  { TdxSingleAggregateItemComparer }

  TdxSingleAggregateItemComparer = class
    (TEqualityComparer<TdxSingleAggregateItem>)
  public
    function Equals(const ALeftItem, ARightItem: TdxSingleAggregateItem)
      : Boolean; override;
    function GetHashCode(const AValue: TdxSingleAggregateItem)
      : Integer; override;
  end;

  { TdxEntityManagerHelper }

function TdxEntityManagerHelper.QueryEntityInfo(const AValue: TValue)
  : TdxEntityInfo;
begin
...
procedure TdxInsertQueryGenerator.AddParameter(const AParameter
  : IdxOperandValue);
begin
  Root.Parameters.Add(AParameter);
end;

function TdxInsertQueryGenerator.ShouldPersist
  (AMember: TdxMappingMemberInfo): Boolean;
begin
...
procedure TdxInsertQueryGenerator.InternalGenerateSQL(const ACriteria
  : IdxCriteriaOperator);
begin
  BuildFieldList;
end;
...
class function TdxInsertQueryGenerator.GenerateInsert(AObject: TObject;
  const AProperties: TArray<TdxMappingMemberInfo>)
  : TList<TdxModificationStatement>;
var
...
class function TdxInsertQueryGenerator.GenerateInsert(ABatchWideData
  : TdxBatchWideDataHolderForModification; AObject: TObject;
  const AProperties: TArray<TdxMappingMemberInfo>)
  : TList<TdxModificationStatement>;
var
...
function TdxInsertQueryGenerator.CreateRootStatement(ATable: TdxDBTable;
  const AAlias: string): TdxBaseStatement;
begin
...
constructor TdxBaseObjectQueryGenerator.Create(ABatchWideData
  : TdxBatchWideDataHolderForModification; AObject: TObject);
begin
  Create(EntityManager.GetEntityInfo(AObject.ClassType),
    ABatchWideData, AObject);
end;
...
function TdxBaseObjectQueryGenerator.GetBatchWideData
  : TdxBatchWideDataHolderForModification;
begin
  Result := TdxBatchWideDataHolderForModification(inherited BatchWideData);
end;

function TdxBaseObjectQueryGenerator.GenerateSQL(ACriteriaSet
...
function TdxBaseObjectQueryGenerator.GetMemberParameter
  (AMember: TdxMappingMemberInfo; AObject: TObject): IdxOperandValue;
var
  AValue: TValue;
...
begin
  ...
  if AMember.ReferenceType <> nil then
    Exit(GetMemberParameter(AMember.ReferenceType.KeyProperty.Member,
      AMember.GetValue(AObject).AsObject));
...
function TdxBaseObjectQueryGenerator.ShouldPersist
  (AMember: TdxMappingMemberInfo): Boolean;
begin
  Result := AMember.IsMappingClass(EntityInfo);
end;

procedure TdxBaseObjectQueryGenerator.AddParameter(const AParameter
  : IdxOperandValue);
begin
end;
...
begin
  ...
  begin
    ...
    begin
      Root.Operands.Add(BatchWideData.CacheQueryOperand
        (TdxQueryOperand.Create(Root.GetColumn(APropertyMember.MappingField),
        '', TdxMemberOperand.Create(APropertyMember))));
      AddParameter(GetMemberParameter(APropertyMember, FTheObject));
    end
    else
    begin
      if (APropertyMember.ReferenceType = nil) or (AMembers[0] = APropertyMember)
      then
        AObject := FTheObject
      else
      ...
      begin
        ...
        Root.Operands.Add(BatchWideData.CacheQueryOperand
          (TdxQueryOperand.Create(Root.GetColumn(APrefix +
          AMember.MappingField), '', TdxMemberOperand.Create(AMember))));
...
class function TdxBaseObjectQueryGenerator.BuildKeyCriteria(AObject: TObject)
  : IdxCriteriaOperator;
var
  AEntityInfo: TdxEntityInfo;
...
begin
  ...
  begin
    ...
    begin
      ...
      ACondition := TdxBinaryOperator.Create
        (TdxOperandProperty.Create(AMappingMemberInfo.MemberName),
        TdxOperandValue.Create(AMappingMemberInfo.GetValue(AObject)),
...
function TdxMemberOperand.Accept(const AVisitor: IdxCriteriaOperatorVisitor)
  : IdxCriteriaOperator;
begin
  raise ENotSupportedException.Create('');
end;

function TdxMemberOperand.Accept(const AVisitor
  : IdxSQLGeneratorVisitor): string;
begin
  raise ENotSupportedException.Create('');
end;
...
procedure TdxQueryOperandCollector.Visit(const AOperand
...
procedure TdxQueryOperandCollector.ProcessList(const AOperands
  : IdxCriteriaOperatorCollection);
var
...
procedure TdxUpdateQueryGenerator.AddParameter(const AParameter
  : IdxOperandValue);
begin
  TdxUpdateStatement(Root).Parameters.Add(AParameter);
end;

procedure TdxUpdateQueryGenerator.InternalGenerateSQL(const ACriteria
  : IdxCriteriaOperator);
begin
...
class function TdxUpdateQueryGenerator.GenerateUpdate(ABatchWideData
  : TdxBatchWideDataHolderForModification; AObject: TObject;
  const AProperties: TArray<TdxMappingMemberInfo>;
...
begin
  ABatchWideDataHolder := TdxBatchWideDataHolderForModification.Create;
  try
    Result := GenerateUpdate(ABatchWideDataHolder, AObject, AProperties,
      ACriteriaSet);
  finally
    ABatchWideDataHolder.Free;
  end;
...
class function TdxUpdateQueryGenerator.GenerateUpdate
  (AEntityInfo: TdxEntityInfo; const AProperties: TArray<TdxMappingMemberInfo>;
  ACriteriaSet: TdxObjectGeneratorCriteriaSet;
  ABatchWideData: TdxBatchWideDataHolderForModification)
  : TList<TdxModificationStatement>;
var
  AQueryGenerator: TdxUpdateQueryGenerator;
begin
  AQueryGenerator := TdxUpdateQueryGenerator.Create(AEntityInfo,
    ABatchWideData);
  try
    Result := AQueryGenerator.GenerateSQL(ACriteriaSet, AProperties);
  finally
...
begin
  ...
  try
    Result := GenerateUpdate(ABatchWideData, AObject, AProperties,
      ACriteriaSet);
  finally
    ACriteriaSet.Free;
  end;
...
function TdxUpdateQueryGenerator.CreateRootStatement(ATable: TdxDBTable;
  const AAlias: string): TdxBaseStatement;
begin
...
constructor TdxClientSelectSQLGenerator.Create(AEntityInfo: TdxEntityInfo;
  ABatchWideData: TdxBatchWideDataHolderForSelect;
  const AProperties: IdxCriteriaOperatorCollection;
  const ASortByExpressions: IdxSortByExpressions;
  const AGrouping: IdxCriteriaOperatorCollection;
...
function TdxClientSelectSQLGenerator.CreateRootStatement(ATable: TdxDBTable;
  const AAlias: string): TdxBaseStatement;
begin
  Result := TdxSelectStatement.Create(ATable, AAlias);
end;

function TdxClientSelectSQLGenerator.GetSubJoinCriteria
  (AGena: TdxBaseQueryGenerator): IdxCriteriaOperator;
var
...
begin
  ...
  begin
    ...
    for I := 0 to FGrouping.Count - 1 do
      ACriteria[I] := CreateBinary(TdxBinaryOperatorType.Equal,
        Root.GroupProperties[I], (FGrouping[I] as TdxCriteriaOperator)
        .Accept(AGena));
...
class function TdxClientSelectSQLGenerator.GenerateSelect
  (AEntityInfo: TdxEntityInfo; const ACriteria: IdxCriteriaOperator;
  const AProperties: IdxCriteriaOperatorCollection;
  const ASortByExpressions: IdxSortByExpressions;
  const AGrouping: IdxCriteriaOperatorCollection;
  const AGroupCriteria: IdxCriteriaOperator;
...
begin
  Result := GenerateSelect(AEntityInfo, ACriteria, AProperties,
    ASortByExpressions, AGrouping, AGroupCriteria, ACollectionCriteriaPatcher,
    0, ATopSelectedRecords);
end;
...
begin
  ...
  ASQLGenerator := TdxClientSelectSQLGenerator.Create(AEntityInfo,
    ABatchWideData, AProperties, ASortByExpressions, AGrouping, AGroupCriteria,
    ACollectionCriteriaPatcher);
  try
...
class function TdxClientSelectSQLGenerator.GenerateSelect
  (AQuery: TdxObjectsQuery; const AProperties, AGroupProperties
  : IdxCriteriaOperatorCollection; const AGroupCriteria: IdxCriteriaOperator)
  : TdxSelectStatement;
begin
  Result := GenerateSelect(AQuery.EntityInfo, AQuery.Criteria, AProperties,
    AQuery.Sorting, AGroupProperties, AGroupCriteria,
    AQuery.CollectionCriteriaPatcher, AQuery.SkipSelectedRecords,
    AQuery.TopSelectedRecords);
end;
...
begin
  ...
  Result := GenerateSelect(AEntityInfo, ACriteria, AProps, ASortByExpressions,
    AGrouping, AGroupCriteria, ACollectionCriteriaPatcher, ASkipSelectedRecords,
    ATopSelectedRecords);
end;

function TdxClientSelectSQLGenerator.BuildAssociation(const AProperties
  : IdxCriteriaOperatorCollection): TArray<IdxCriteriaOperator>;
var
...
procedure TdxClientSelectSQLGenerator.BuildAssociationByProperties
  (const AProperties: IdxCriteriaOperatorCollection);
begin
  ...
  try
    ...
    begin
      ...
      begin
        ...
        for I := 0 to ACount - 1 do
          ASortProperties.Add
            (TdxSortingColumn.Create(GetQueryOperandFromAlias(ANode, ANode, I),
            ASortProperty.SortDirection));
      end
      else
        ASortProperties.Add(TdxSortingColumn.Create(ARes,
          ASortProperty.SortDirection));
    end;
  finally
    FCurrentJoinType := TdxJoinType.Inner;
...
procedure TdxClientSelectSQLGenerator.InternalGenerateSQL(const ACriteria
  : IdxCriteriaOperator);
var
...
constructor TdxPathFinder.Create(const ARootNode: string;
  const ANodes: TArray<string>;
  const ACriteria: TEnumerable<TdxPlanAliasCriteriaInfo>;
  ANodeRelations: TDictionary<string, TdxStringList>);
var
  ANode: string;
...
class function TdxPathFinder.Find(const ARootNode: string;
  const ANodes: TArray<string>;
  ACriteria: TEnumerable<TdxPlanAliasCriteriaInfo>;
  ANodeRelations: TDictionary<string, TdxStringList>): TArray<TdxPathInfo>;
begin
  Result := TdxPathFinder.Create(ARootNode, ANodes, ACriteria,
    ANodeRelations).Find;
end;
...
function TdxPathFinder.MoveUp(const ALeftNode: string;
  const ARightNode: string): Boolean;
var
...
class function TdxQueryOperandHelper.Create(AColumn: TdxDBColumn;
  const ANodeAlias: string; const AParentCriteria: IdxCriteriaOperator)
  : IdxQueryOperand;
begin
  Result := TdxQueryOperand.Create(AColumn.Name, ANodeAlias, AColumn.ColumnType,
    AParentCriteria);
end;
...
procedure TdxBatchWideDataHolderForModification.RegisterDeletedObjects
  (const AObjects4Delete: TArray<TObject>);
begin
  FDeletedObjects := AObjects4Delete;
end;

function TdxBatchWideDataHolderForModification.CreateIdentityParameter
  (AObject: TObject): IdxParameterValue;
begin
  if AObject = nil then
...
function TdxBatchWideDataHolderForModification.IsObjectAlreadyInserted
...
procedure TdxBatchWideDataHolderForModification.RegisterInsertedObject
  (AObject: TObject);
begin
  if FInsertedObjects = nil then
...
function TdxBatchWideDataHolderForModification.GetParameter
  (const AValue: TValue): IdxOperandValue;
var
  AEntityInfo: TdxEntityInfo;
...
begin
  ...
  begin
    ...
    if (FIdentityParameters <> nil) and FIdentityParameters.TryGetValue(AObject,
      AResult) then
      Result := AResult
    else
    begin
...
procedure TdxBatchWideDataHolderForModification.
  RegisterUpdatedMembersBeforeDelete(AObject: TObject;
  AMembers: TdxMemberInfoCollection);
begin
  if FUpdatedMembersBeforeDeleteDictionary = nil then
    FUpdatedMembersBeforeDeleteDictionary :=
      TdxObjectDictionary<TdxMemberInfoCollection>.Create;
  FUpdatedMembersBeforeDeleteDictionary[AObject] := AMembers;
end;

function TdxBatchWideDataHolderForModification.TryGetUpdatedMembersBeforeDelete
  (AObject: TObject; out AMembers: TdxMemberInfoCollection): Boolean;
begin
  if FUpdatedMembersBeforeDeleteDictionary = nil then
  begin
    AMembers := nil;
    ...
    Result := FUpdatedMembersBeforeDeleteDictionary.TryGetValue(AObject,
      AMembers);
end;

function TdxBatchWideDataHolderForModification.CacheQueryOperand
  (const AToCache: IdxQueryOperand): IdxQueryOperand;
begin
...
function TdxCollectionCriteriaPatcher.PatchCriteria(AEntityInfo: TdxEntityInfo;
  const AOriginalCriteria: IdxCriteriaOperator): IdxCriteriaOperator;
begin
  Result := AOriginalCriteria;
  if AEntityInfo.ClassAttributes.IsParentTable then
  begin
    Result := TdxGroupOperator.And
      (TdxBinaryOperator.Create(AEntityInfo.ServiceFields.DiscriminatorField.
      Discriminator.ColumnName,
      TValue.FromVariant(AEntityInfo.ClassAttributes.DiscriminatorValue)
      ), Result);
  end;
end;
...
constructor TdxRefHolder.Create(APool: TDictionary<TdxEntityInfo, TdxRefHolder>;
  AMe: TdxEntityInfo);
begin
  inherited Create;
...
class function TdxRefHolder.GetNonReferenced
  (APool: TDictionary<TdxEntityInfo, TdxRefHolder>): TArray<TdxEntityInfo>;
var
...
function TdxRefHolder.CanReach(AProcessed: TDictionary<TdxEntityInfo,
  TdxEntityInfo>; ATarget: TdxEntityInfo): Boolean;
var
  ARh: TdxRefHolder;
begin
...
begin
  FDirectlyAssignableNotDeleted :=
    TDictionary<TdxEntityInfo, TdxRefHolder>.Create;
  ...
  begin
    for ARefHolder in FPool.Values do
      if ARefHolder.FEntityInfo.IsAssignableTo(AMemberInfo.ReferenceType) then
        DirectlyAssignableNotDeleted.AddOrSetValue(ARefHolder.FEntityInfo,
          ARefHolder);
  end;
end;

class function TdxRefHolder.CreatePool(AObjects: TList<TObject>)
  : TDictionary<TdxEntityInfo, TdxRefHolder>;
var
  AObject: TObject;
  AEntityInfo: TdxEntityInfo;
...
begin
  Result := TObjectDictionary<TdxEntityInfo, TdxRefHolder>.Create
    ([doOwnsValues]);
...
class procedure TdxRefHolder.ProcessDelete
  (APool: TDictionary<TdxEntityInfo, TdxRefHolder>; AEntityInfo: TdxEntityInfo);
var
  ARh: TdxRefHolder;
begin
...
class function TdxRefHolder.GenerateUpdatesBeforeDelete
  (AEntityInfo: TdxEntityInfo; AUpdateList: TdxMemberInfoCollection;
  const AKeys: TArray<TObject>;
  ABatchWideData: TdxBatchWideDataHolderForModification;
  ALocking: TdxLockingOption): TArray<TdxModificationStatement>;
var
...
begin
  ...
  try
    AInSize := TdxEMFDefault.GetTerminalInSize(Length(AKeys),
      AEntityInfo.KeyProperty.KeyFieldCount);
    if Length(AKeys) <> AInSize then
    begin
      AResult.AddRange(GenerateUpdatesBeforeDelete(AEntityInfo, AUpdateList,
        TdxGetRangeHelper.GetRange(AKeys, 0, AInSize), ABatchWideData,
        ALocking));
      AResult.AddRange(GenerateUpdatesBeforeDelete(AEntityInfo, AUpdateList,
        TdxGetRangeHelper.GetRange(AKeys, AInSize, Length(AKeys) - AInSize),
        ABatchWideData, ALocking));
    end
    else
    begin
      AKind := AEntityInfo.OptimisticLockingBehavior;
      if (ALocking = TdxLockingOption.None) or
        (AKind in [TdxOptimisticLockingBehavior.ConsiderOptimisticLockingField,
        TdxOptimisticLockingBehavior.NoLocking]) then
      begin
        ACriteria := TdxInOperator.Create
          (AEntityInfo.KeyProperty.Member.MemberName, AKeys);
        ACriteriaSet := TdxObjectGeneratorCriteriaSet.GetCommonCriteriaSet
          (ACriteria);
        try
          AUpdates := TdxUpdateQueryGenerator.GenerateUpdate(AEntityInfo,
            AUpdateList.ToArray, ACriteriaSet, ABatchWideData);
          try
...
begin
  ...
  try
    ...
    try
      ...
      Result := GenerateUpdatesBeforeDelete(FEntityInfo, AUpdateList,
        Objects.ToArray, ABatchWideData, ALocking);
    finally
      AUpdateList.Free;
    end;
  finally
...
constructor TdxSingleAggregateItem.Create(const ACondition: IdxCriteriaOperator;
  AEntityInfo: TdxEntityInfo);
begin
...
procedure TdxDeleteQueryGenerator.InternalGenerateSQL(const ACriteria
  : IdxCriteriaOperator);
begin
  BuildAssociationTree(ACriteria);
end;

class function TdxDeleteQueryGenerator.GenerateDelete(AObject: TObject;
  ALocking: TdxLockingOption;
  ABatchWideData: TdxBatchWideDataHolderForModification)
  : TList<TdxModificationStatement>;
var
...
begin
  ...
  if ACriteriaSet = nil then
    ACriteriaSet := TdxObjectGeneratorCriteriaSet.GetCommonCriteriaSet
      (BuildKeyCriteria(AObject))
  else
    ACriteriaSet.UpdateCommonCriteria(BuildKeyCriteria(AObject));
  try
    AQueryGenerator := TdxDeleteQueryGenerator.Create(AEntityInfo,
      ABatchWideData, AObject);
    try
...
class procedure TdxDeleteQueryGenerator.GenerateDeletes
  (AEntityInfo: TdxEntityInfo; ACriteriaSet: TdxObjectGeneratorCriteriaSet;
  ARes: TList<TdxModificationStatement>; ACount: Integer;
  ABatchWideData: TdxBatchWideDataHolderForModification);
var
  AQueryGenerator: TdxDeleteQueryGenerator;
...
class function TdxDeleteQueryGenerator.GenerateDelete
  (AEntityInfo: TdxEntityInfo; const AKeys: TList<TObject>;
  ALocking: TdxLockingOption;
  ABatchWideData: TdxBatchWideDataHolderForModification)
  : TList<TdxModificationStatement>;
var
...
begin
  ...
  begin
    ...
    ADeletes := GenerateDeleteCore(AEntityInfo,
      TdxGetRangeHelper.GetRange(AKeys, AStartPos, AInSize), ALocking,
      ABatchWideData);
    try
...
class function TdxDeleteQueryGenerator.GenerateDeleteCore
  (AEntityInfo: TdxEntityInfo; const AKeys: TArray<TObject>;
  ALocking: TdxLockingOption;
  ABatchWideData: TdxBatchWideDataHolderForModification)
  : TList<TdxModificationStatement>;
var
...
begin
  ...
  begin
    Result := TList<TdxModificationStatement>.Create;
    ACriteria := TdxInOperator.Create
      (AEntityInfo.KeyProperty.MemberName, AKeys);
    ADeleteQueryGenerator := TdxDeleteQueryGenerator.Create(AEntityInfo,
      ABatchWideData);
    try
      AObjectGeneratorCriteriaSet :=
        TdxObjectGeneratorCriteriaSet.GetCommonCriteriaSet(ACriteria);
      try
        ADeletes := ADeleteQueryGenerator.GenerateSQL
          (AObjectGeneratorCriteriaSet, nil, False);
        try
          for AStatement in ADeletes do
...
class function TdxDeleteQueryGenerator.GenerateDelete(const AObjects
  : TList<TObject>; ALocking: TdxLockingOption;
  ABatchWideData: TdxBatchWideDataHolderForModification)
  : TList<TdxModificationStatement>;
var
  ...
  try
    ...
    begin
      ...
      begin
        ...
        begin
          ADeletes := GenerateDelete(AEntityInfo, APool[AEntityInfo].Objects,
            ALocking, ABatchWideData);
          try
      ...
      begin
        ...
        for ARh in APool.Values do
        begin
          if (AVictim <> nil) and (ARh.Objects.Count >= AVictim.Objects.Count)
          then
            Continue;
...
function TdxDeleteQueryGenerator.CreateRootStatement(ATable: TdxDBTable;
  const AAlias: string): TdxBaseStatement;
begin
...
constructor TdxSubSelectQueryGenerator.Create(AParent: TdxBaseQueryGenerator;
  ABatchWideData: TdxBatchWideDataHolder; const APropertyName: string;
  AObjectInfo: TdxEntityInfo; const AAggregateProperty: IdxCriteriaOperator;
  AAggregate: TdxAggregateFunctionType;
  ACollectionCriteriaPatcher: TdxCollectionCriteriaPatcher);
...
procedure TdxSubSelectQueryGenerator.InternalGenerateSQL(const ACriteria
  : IdxCriteriaOperator);
var
  APatchedCriteria: IdxCriteriaOperator;
begin
...
function TdxSubSelectQueryGenerator.GetPropertyNode(const AProperty
  : IdxOperandProperty; AType: TdxJoinType): IdxPropertyAlias;
begin
  Result := IdxPropertyAlias(ExecuteWithPropertyNameDiving
    ...
    begin
      if {$IFDEF DELPHIXE3}APropertyPath.StartsWith('^.'){$ELSE}TdxStringHelper.
        StartsWith(APropertyPath, '^.'){$ENDIF} then
      begin
        ALength := Length(FPropertyName);
        I := {$IFDEF DELPHIXE3}APropertyPath.LastIndexOf
          ('^.'){$ELSE}TdxStringHelper.LastIndexOf(APropertyPath,
          '^.'){$ENDIF} div 2 + 1;
        if I >= ALength then
          APropertyPath :=
          {$IFDEF DELPHIXE3}APropertyPath.Remove(0,
            ALength * 2){$ELSE}TdxStringHelper.Remove(APropertyPath, 0,
            ALength * 2){$ENDIF}
        else
        begin
{$IFDEF DELPHIXE3}
          APropertyPath := APropertyPath.Remove(0, I * 2 - 1);
          APropertyPath := string.Join('.', FPropertyName, 0, ALength - I) +
            APropertyPath;
{$ELSE}
          APropertyPath := TdxStringHelper.Remove(APropertyPath, 0, I * 2 - 1);
          APropertyPath := TdxStringHelper.Join('.', FPropertyName, 0,
            ALength - I) + APropertyPath;
{$ENDIF};
        end;
...
function TdxSubSelectQueryGenerator.GenerateSelect(const ACriteria
  : IdxCriteriaOperator): TdxBaseStatement;
begin
  Result := GenerateSQL(ACriteria);
end;

function TdxSubSelectQueryGenerator.CreateRootStatement(ATable: TdxDBTable;
const AAlias: string): TdxBaseStatement;
begin
  Result := TdxSelectStatement.Create(ATable, AAlias);
end;
...
begin
  ...
  FNodeCriteriaInfoDictionary := TObjectDictionary < string,
    TList < TdxPlanAliasCriteriaInfo >>.Create([doOwnsValues]);
  FRoot := ARoot;
...
procedure TdxStatementNormalizer.FindNode(ASubNode: TdxJoinNode;
AParentNode: TdxJoinNode);
var
...
class procedure TdxStatementNormalizer.CollectNodes(ANode: TdxJoinNode;
ACollectedNodes: TdxNamedJoinNodeDictionary);
var
...
procedure TdxStatementNormalizer.NormalizeNodeTree(AParentNode: TdxJoinNode;
ASubNode: TdxJoinNode; ACollectedNodes: TdxNamedJoinNodeDictionary);
var
  ANodeRelations: TDictionary<string, TdxStringList>;
...
begin
  ...
  if not ANodeRelations.TryGetValue(AParentNode.Alias, AParentNodeRelationList)
  then
  begin
  ...
  AResult := TdxPathFinder.Find(AParentNode.Alias, ACollectedNodes.Keys,
    ACriteriaList, ANodeRelations);
  if AResult = nil then
...
constructor TdxObjectsQuery.Create(AEntityInfo: TdxEntityInfo;
const ACriteria: IdxCriteriaOperator;
const ASortByExpressions: IdxSortByExpressions; ASkipSelectedRecords: Integer;
ATopSelectedRecords: Integer; const ACollectionCriteriaPatcher
  : TdxCollectionCriteriaPatcher; AForce: Boolean);
begin
  inherited Create;
  if AEntityInfo = nil then
    raise EArgumentNilException.Create('');
...
constructor TdxObjectsQuery.Create(AEntityInfo: TdxEntityInfo;
const ACriteria: IdxCriteriaOperator;
const ASortByExpressions: IdxSortByExpressions; ATopSelectedRecords: Integer;
const ACollectionCriteriaPatcher: TdxCollectionCriteriaPatcher;
AForce: Boolean);
begin
  Create(AEntityInfo, ACriteria, ASortByExpressions, 0, ATopSelectedRecords,
    ACollectionCriteriaPatcher, AForce);
end;

{ TdxProjectionAliasPatcher }

constructor TdxProjectionAliasPatcher.Create(ARoot: TdxBaseStatement;
AProjectedNodes: TdxNamedJoinNodeDictionary;
AProjectionNodes: TdxNamedOrdinalDictionary<TdxProjectionNodeItem>);
begin
  inherited Create;
...
begin
  APatcher := TdxProjectionAliasPatcher.Create(ARoot, AProjectedNodes,
    AProjectionNodes);
  try
    APatcher.Patch;
  finally
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if (FUsedProjectionNodes <> nil) and FUsedProjectionNodes.Contains
            (AProjectionNodeAlias) then
            Continue;
          (AOperand as TdxQueryOperand).NodeAlias := AProjectionNodeAlias;
          if (FProjectionNodes <> nil) and FProjectionNodes.TryGetValue
            (AProjectionNodeAlias, AProjectionNodeItem) then
            TdxBaseQueryGenerator.GetProjectedMemberColumn(AOperand.ColumnName,
              AProjectionNode, AProjectionNodeItem.ProjectedNodes,
              AParentCriteria);
        end
        else if FProjectionNodes.TryGetValue(AOperand.NodeAlias,
          AProjectionNodeItem) then
          TdxBaseQueryGenerator.GetProjectedMemberColumn(AOperand.ColumnName,
            AProjectionNodeItem.Node, AProjectionNodeItem.ProjectedNodes,
            AParentCriteria);
      end;
    end;
    for ANode in ANodes do
...
constructor TdxPlanAliasCriteriaInfo.Create(const AAliases: TArray<string>;
ACriteria: TdxCriteriaOperatorList);
begin
  inherited Create;
  FAliases := AAliases;
...
class function TdxGetRangeHelper.GetRange(ASrc: TList<TObject>; AIndex: Integer;
ACount: Integer): TArray<TObject>;
var
  I: Integer;
begin
...
class function TdxGetRangeHelper.GetRange(const ASrc: array of TObject;
AIndex: Integer; ACount: Integer): TArray<TObject>;
var
  I: Integer;
begin
  SetLength(Result, ACount);
...
constructor TdxPropertyAlias.Create(ANode: TdxJoinNode;
...
constructor TdxPropertyAlias.Create(ANode: TdxJoinNode;
AMember: TdxMappingMemberInfo; ASubMembers: TdxMemberInfoList;
...
constructor TdxPropertyAlias.Create(ANode: TdxJoinNode;
AMember: TdxMappingMemberInfo; ASub: Boolean);
begin
  Create(ANode, AMember);
...
constructor TdxProjectionNodeItem.Create(ANode: TdxJoinNode;
AProjectedNodes: TdxJoinNodeList);
begin
  FNode := ANode;
  FProjectedNodes := AProjectedNodes;
end;
...
function TdxSingleAggregateItemComparer.Equals(const ALeftItem,
  ARightItem: TdxSingleAggregateItem): Boolean;
begin
  Result := (ALeftItem.EntityInfo = ARightItem.EntityInfo) and
    TdxCriteriaOperator.CriterionEquals
    (ALeftItem.Condition as TdxCriteriaOperator,
    ARightItem.Condition as TdxCriteriaOperator);
end;

function TdxSingleAggregateItemComparer.GetHashCode(const AValue
  : TdxSingleAggregateItem): Integer;
var
  AHash: Integer;
begin
...
function TdxBatchWideDataHolderForSelect.GetParameter(const AValue: TValue)
  : IdxOperandValue;
var
  AEntityInfo: TdxEntityInfo;
  AResult: IdxParameterValue;
...
constructor TdxBaseQueryGenerator.Create(AEntityInfo: TdxEntityInfo;
ABatchWideData: TdxBatchWideDataHolder;
const ACollectionCriteriaPatcher: TdxCollectionCriteriaPatcher);
begin
  inherited Create;
...
function TdxBaseQueryGenerator.CollectInValues(const AOperands
  : IdxCriteriaOperatorCollection; AValues: TdxCriteriaOperatorList)
  : IdxPropertyAlias;
var
  ADefaultMembers: IdxPropertyAlias;
  ACriteria: IdxCriteriaOperator;
  Var1: IdxCriteriaOperator;
begin
  ADefaultMembers := TdxPropertyAlias.Empty;
  for ACriteria in AOperands do
  begin
    Var1 := Process(ACriteria);
    AValues.Add(Var1);
    Supports(Var1,
      IdxPropertyAlias, ADefaultMembers);
  end;
  Result := ADefaultMembers;
end;

function TdxBaseQueryGenerator.ConvertViaDefaultValueConverter(var AOperandValue
  : TValue): Boolean;
begin
  Result := False;
end;

function TdxBaseQueryGenerator.ExecuteWithPropertyNameDiving(const APropertyName
  : string; const AWorker: TFunc<string, IdxCriteriaOperator>;
AThrowOnEmptyStack: Boolean = True): IdxCriteriaOperator;
var
...
{$IFDEF DELPHIXE3}
    while (ACurrentPropertyName <> '') and
      ACurrentPropertyName.StartsWith('^.') do
{$ELSE}
    while (ACurrentPropertyName <> '') and TdxStringHelper.StartsWith
      (ACurrentPropertyName, '^.') do
{$ENDIF}
    begin
...
{$ELSE}
      ACurrentPropertyName := TdxStringHelper.Substring
        (ACurrentPropertyName, 2);
{$ENDIF}
    end;
...
procedure TdxBaseQueryGenerator.AddMultiColumnAlias(const AOperator
  : IdxCriteriaOperator; const AAlias: IdxPropertyAlias);
begin
  if FMultiColumnAliases = nil then
    FMultiColumnAliases :=
      TDictionary<IdxCriteriaOperator, IdxPropertyAlias>.Create;
  FMultiColumnAliases.AddOrSetValue(AOperator, AAlias);
end;

function TdxBaseQueryGenerator.AppendInheritanceJoinNode(ABranch: TdxEntityInfo;
AProperty: TdxMappingMemberInfo; APrevNode: TdxJoinNode): TdxJoinNode;
var
  AUpClasses, AClasses: TList<TdxEntityInfo>;
  AUpCast: Boolean;
  ATop: TdxEntityInfo;
  APos, I: Integer;
  ...
  try
    ...
    begin
      ...
      if (APrevNode.Table = AMappingTable) or
        (((FProjectionNodes <> nil) and FProjectionNodes.TryGetValue
        (APrevNode.Alias, AProjectionNodeItem)) and
        AProjectionNodeItem.ProjectedNodes.Any(
        function(AJoinNode: TdxJoinNode): Boolean
        begin
      ...
      begin
        if ((FNakedSingleNodes <> nil) and FNakedSingleNodes.ContainsKey
          (APrevNode.Alias)) and ((FProjectedSingleNodes = nil) or
          (not FProjectedSingleNodes.ContainsKey(APrevNode.Alias))) then
        begin
          ...
          if FProjectionNodes = nil then
            FProjectionNodes :=
              TdxNamedOrdinalDictionary<TdxProjectionNodeItem>.Create;
          AProjectionNode := APrevNode;
          AInnerNode := TdxSelectStatement.Create(APrevNode.Table,
            APrevNode.Alias);
          ...
          FProjectionNodes.Add(AProjectionNode.Alias,
            TdxProjectionNodeItem.Create(AProjectionNode, AJoinNodeList));
        end;

        if FInheritanceSubNodes = nil then
          FInheritanceSubNodes := TObjectDictionary < string,
            TDictionary < TdxDBTable, TdxJoinNode >>.Create([doOwnsValues]);
        if not FInheritanceSubNodes.TryGetValue(APrevNode.Alias, AInheritedCache)
        then
        begin
        ...
        begin
          ...
          Result := TdxJoinNode.Create(AMappingTable, GetNextNodeAlias,
            AJoinType);
          Result.Condition := GetJoinCondition(AOnClauseAlias, Result.Alias,
            ABranch.KeyProperty.Member, ABranch.KeyProperty.Member);
...
function TdxBaseQueryGenerator.AppendJoinNode(AProperty: TdxMappingMemberInfo;
APrevNode: TdxJoinNode; AType: TdxJoinType): TdxJoinNode;
var
...
begin
  ...
  begin
    ...
    ANode := TdxJoinNode.Create(AProperty.ReferenceType.DBTable,
      GetNextNodeAlias, ANodeType);
    ANode.Condition := GetJoinCondition(APrevNode.Alias, ANode.Alias, AProperty,
      AProperty.ReferenceType.KeyAttributes[0]) as TdxCriteriaOperator;
...
procedure TdxBaseQueryGenerator.BuildAssociationTree(const ACriteria
  : IdxCriteriaOperator);
begin
  Root.Condition := ProcessLogical(ACriteria as TdxCriteriaOperator);
end;

function TdxBaseQueryGenerator.BuildInGroup(const ADefaultMembers
  : IdxPropertyAlias; AValues: TdxCriteriaOperatorList;
const ALeftOperator: IdxCriteriaOperator): IdxCriteriaOperator;
var
...
begin
  ...
  begin
    ...
    ABinaryGroup := CreateBinaryGroup(ADefaultMembers, ALeftOperator,
      ADefaultMembers, AValue, ARightMembers, TdxBinaryOperatorType.Equal);
    Result := TdxGroupOperator.Or(Result, ABinaryGroup);
  end;
end;

function TdxBaseQueryGenerator.CreateBinary(const ALeftOperator
  : IdxCriteriaOperator; const ALeftMembers: IdxPropertyAlias;
const ARightOperator: IdxCriteriaOperator;
const ARightMembers: IdxPropertyAlias; AOperatorType: TdxBinaryOperatorType;
AIndex: Integer): IdxBinaryOperator;
begin
  Result := TdxBinaryOperator.Create(GetParameter(ALeftOperator, ALeftMembers,
    AIndex), GetParameter(ARightOperator, ARightMembers, AIndex),
    AOperatorType);
end;
...
begin
  ...
  if not Supports(ALeft, IdxPropertyAlias) and TryGetMultiColumnAlias(ALeft,
    AAlias) then
    ALeft := TdxCriteriaOperator(AAlias);
  if not Supports(ARight, IdxPropertyAlias) and
    TryGetMultiColumnAlias(TdxCriteriaOperator(ARight), AAlias) then
  ...
  if ADefaultMembers.Count > 1 then
    Result := CreateBinaryGroup(ADefaultMembers, ALeft, ALeftMembers, ARight,
      ADefaultMembers, AType)
  else
    Result := CreateBinary(ALeft, ALeftMembers, ARight, ADefaultMembers,
      AType, 0);
end;

function TdxBaseQueryGenerator.CreateBinaryGroup(const ASubMembers
  : IdxPropertyAlias; const ALeftOperator: IdxCriteriaOperator;
const ALeftMembers: IdxPropertyAlias; const ARightOperator: IdxCriteriaOperator;
const ARightMembers: IdxPropertyAlias; AOperatorType: TdxBinaryOperatorType)
  : IdxCriteriaOperator;
var
...
begin
  if AOperatorType <> TdxBinaryOperatorType.Equal then
    raise ENotSupportedException.Create
      (TdxFormatterHelper.GetName(AOperatorType));
  Result := nil;
  for I := 0 to ASubMembers.Count - 1 do
  begin
    ASubMemberResult := CreateBinary(ALeftOperator, ALeftMembers,
      ARightOperator, ARightMembers, AOperatorType, I);
    Result := TdxGroupOperator.And(Result, ASubMemberResult);
  end;
end;

function TdxBaseQueryGenerator.CreateOperand(AMember: TdxMappingMemberInfo;
const ANodeAlias: string): IdxQueryOperand;
begin
  Result := TdxQueryOperand.Create(AMember.MappingField, ANodeAlias);
end;

function TdxBaseQueryGenerator.CreateOperand(const AMappingField,
  ANodeAlias: string): IdxQueryOperand;
begin
  Result := TdxQueryOperand.Create(AMappingField, ANodeAlias);
end;

function TdxBaseQueryGenerator.GenerateSQL(const ACriteria: IdxCriteriaOperator)
  : TdxBaseStatement;
begin
  ...
  if FRoot.Alias <> '' then
  begin
    TdxProjectionAliasPatcher.Patch(FRoot, FProjectedSingleNodes,
      FProjectionNodes);
...
function TdxBaseQueryGenerator.GetConstParameter(AMember: TdxMappingMemberInfo;
const AOperand: IdxOperandValue; ATargetMember: TdxMappingMemberInfo)
  : IdxOperandValue;
var
  AValue: TValue;
...
begin
  ...
  AEntityInfo := EntityManager.QueryEntityInfo(AValue);
  if ((AEntityInfo <> nil) and (AEntityInfo.KeyProperty <> nil)) and
    not AEntityInfo.KeyProperty.IsIdentity then
...
function TdxBaseQueryGenerator.GetConstParameter(const AValue: TValue)
  : IdxOperandValue;
begin
  if AValue.IsNullOrEmpty then
...
function TdxBaseQueryGenerator.GetJoinCondition(const ALeftAlias,
  ARightAlias: string; ALeftMember, ARightMember: TdxMappingMemberInfo)
  : IdxCriteriaOperator;
var
...
begin
  if Length(ARightMember.SubMembers) = 0 then
    Result := TdxBinaryOperator.Create(CreateOperand(ALeftMember, ALeftAlias),
      CreateOperand(ARightMember, ARightAlias), TdxBinaryOperatorType.Equal)
  else
  begin
    ACondition := nil;
    ...
    begin
      ...
      begin
        ...
        AMiCondition := TdxBinaryOperator.Create
          (CreateOperand(ALeftMemberMappingPrefix + AMemberInfo.MappingField,
          ALeftAlias), CreateOperand(AMemberInfo, ARightAlias),
          TdxBinaryOperatorType.Equal);
...
function TdxBaseQueryGenerator.GetSubMembers(AMember: TdxMappingMemberInfo;
const APrefix: string): TdxMemberInfoList;
var
  ACount, I: Integer;
  AMemberInfo: TdxMappingMemberInfo;
begin
  ...
  begin
    ...
    if AMemberInfo.IsPersistent then
    begin
      if (AMemberInfo.ReferenceType <> nil) and
        (Length(AMemberInfo.ReferenceType.KeyProperty.SubMembers) > 0) then
        raise ENotSupportedException.CreateFmt('MetaData_ReferenceTooComplex',
          [AMember.Owner.FullName, AMember.MemberName]);
      Result.Add(AMemberInfo);
    end;
  end;
end;

function TdxBaseQueryGenerator.GetMembers(AMember: TdxMappingMemberInfo;
out APrefix: string): TdxMemberInfoList;
begin
  APrefix := '';
  Result := nil;
end;

function TdxBaseQueryGenerator.GetMembers(ANode: TdxJoinNode;
AMember: TdxMappingMemberInfo): IdxPropertyAlias;
var
  APrefix: string;
  AMembers: TdxMemberInfoList;
begin
...
begin
  if AAlias.Member = nil then
    Result := AParam
  else if Supports(AParam, IdxOperandValue, AOperandValue) then
    Result := GetConstParameter(AAlias.GetMember(AIndex), AOperandValue,
      AAlias.Member)
  else if Supports(AParam, IdxPropertyAlias, AParamPropertyAlias) then
    Result := GetQueryOperandFromAlias(AParamPropertyAlias, AAlias, AIndex)
  else
    Result := AParam;
end;

class function TdxBaseQueryGenerator.GetProjectedMemberColumn
  (const AMappingField: string; ANode: TdxJoinNode;
AProjectedNodeList: TdxJoinNodeList; const AParentCriteria: IdxCriteriaOperator)
  : TdxDBColumn;
var
...
begin
  ...
  begin
    ...
    ASelect.Operands.Add(TdxQueryOperand.Create(AMemberColumn, AFoundNode.Alias,
      AParentCriteria));
  end;
  Result := AMemberColumn;
end;

function TdxBaseQueryGenerator.GetPropertyNode(APropertyPath
  : TdxMemberInfoCollection; AType: TdxJoinType): IdxPropertyAlias;
var
  ANode: TdxJoinNode;
  AMember: TdxMappingMemberInfo;
...
function TdxBaseQueryGenerator.GetPropertyNode(const AProperty
  : IdxOperandProperty; AType: TdxJoinType): IdxPropertyAlias;
var
...
begin
  ...
  if AOperand <> nil then
    ...
    Result := ExecuteWithPropertyNameDiving(AProperty.PropertyName,
      ...
      begin
        Result := GetPropertyNode(EntityInfo.ParsePersistentPath
          (APropertyName), AType);
      end) as IdxPropertyAlias;
end;

function TdxBaseQueryGenerator.GetSubJoinCriteria(AGena: TdxBaseQueryGenerator)
  : IdxCriteriaOperator;
begin
  Result := CreateBinary(TdxBinaryOperatorType.Equal,
    TdxCriteriaOperator(GetPropertyNode(TdxOperandProperty.Create
    (EntityInfo.KeyProperty.Member.MemberName), FCurrentJoinType)),
    TdxCriteriaOperator(AGena.Process(TdxOperandProperty.Create
    (EntityInfo.KeyProperty.Member.MemberName))));
end;

function TdxBaseQueryGenerator.GetQueryOperandFromAlias(const AAliasFromParam,
  AAlias: IdxPropertyAlias; AIndex: Integer): IdxCriteriaOperator;
var
  ANode: TdxJoinNode;
...
begin
  ...
  if ((FProjectedSingleNodes <> nil) and FProjectedSingleNodes.TryGetValue
    (ANodeAlias, AFoundProjectionNode)) and not NodeStackHashSet.Contains
    (ANodeAlias) then
  begin
    ANode := AFoundProjectionNode;
    ANodeAlias := ANode.Alias;
  end;
  if (FProjectionNodes <> nil) and FProjectionNodes.TryGetValue(ANodeAlias,
    AProjectionNodeItem) then
    AMemberColumn := GetProjectedMemberColumn(AMappingField, ANode,
      AProjectionNodeItem.ProjectedNodes, AMemberOperand)
  else
...
begin
  FIndexCount := 0;
  ABranch := FEntityInfo;
  if not ABranch.ClassAttributes.IsPersistent and
    (ABranch.ClassAttributes.PersistentBaseClass <> nil) then
    ABranch := EntityManager.GetEntityInfo
      (ABranch.ClassAttributes.PersistentBaseClass);
  FRoot.Free;
  FRoot := CreateRootStatement(ABranch.DBTable, GetNextNodeAlias);
  FRootNode := FRoot;
end;

function TdxBaseQueryGenerator.PatchCriteria(const AOriginalCriteria
  : IdxCriteriaOperator): IdxCriteriaOperator;
begin
  Result := PatchCriteria(AOriginalCriteria, FEntityInfo);
end;

function TdxBaseQueryGenerator.AppendSingleAggregateJoinNode
  (AEntityInfo: TdxEntityInfo; ACollectionProperty: TdxMappingMemberInfo;
const ACondition: IdxCriteriaOperator; APrevNode: TdxJoinNode;
AType: TdxJoinType): TdxJoinNode;
var
...
begin
  if FSingleNesting > 0 then
    raise EInvalidOperation.Create
      (sdxGeneratorTheUseOfNestedSingleAggregatesIsProhibited);
  Inc(FSingleNesting);
  try
    if FSingleAggregateSubNodes = nil then
      FSingleAggregateSubNodes := TObjectDictionary < string,
        TDictionary < TdxSingleAggregateItem,
        TdxJoinNode >>.Create([doOwnsValues]);
    if not FSingleAggregateSubNodes.TryGetValue(APrevNode.Alias,
      ASingleNodeCache) then
    begin
      ASingleNodeCache := TDictionary<TdxSingleAggregateItem, TdxJoinNode>.
        Create(TdxSingleAggregateItemComparer.Create);
    ...
    begin
      ...
      ASingleNode := TdxJoinNode.Create(AEntityInfo.DBTable,
        GetNextNodeAlias, AType);
      ...
      if ACollectionProperty <> nil then
        AJoinCondition := GetJoinCondition(APrevNode.Alias, ASingleNode.Alias,
          FEntityInfo.KeyProperty.Member, ACollectionProperty.AssociatedMember);
      ASingleNode.Condition := TdxGroupOperator.And
        (AJoinCondition, ProcessLogicalInContext(AEntityInfo, ASingleNode,
        PatchCriteria(ACondition, AEntityInfo)) as TdxCriteriaOperator);
...
function TdxBaseQueryGenerator.PatchCriteria(const AOriginalCriteria
  : IdxCriteriaOperator; AEntityInfo: TdxEntityInfo): IdxCriteriaOperator;
begin
  if not FCollectionCriteriaPatcher.HasValue then
    Result := AOriginalCriteria
  else
  begin
    Result := FCollectionCriteriaPatcher.PatchCriteria(AEntityInfo,
      AOriginalCriteria);
  end;
end;

function TdxBaseQueryGenerator.ProcessTopSubSelect(const AAggregateProperty,
  AOperandClause: IdxCriteriaOperator;
...
begin
  AGena := TdxSubSelectQueryGenerator.Create(Self, BatchWideData, '', ClassInfo,
    AAggregateProperty, AAggregateFunctionType, FCollectionCriteriaPatcher);
  AQueryStatement := AGena.GenerateSelect(AOperandClause);
  AQueryStatement.Condition := TdxGroupOperator.And
    (GetSubJoinCriteria(AGena), AQueryStatement.Condition);
  ...
  Result := TdxQuerySubQueryContainer.Create(AQueryStatement,
    AAggregatedOperand, AAggregateFunctionType);
end;

function TdxBaseQueryGenerator.Process(const AOperand: IdxCriteriaOperator)
  : IdxCriteriaOperator;
begin
  if AOperand = nil then
    Result := nil
...
function TdxBaseQueryGenerator.ProcessLogical(const AOperand
  : IdxCriteriaOperator): IdxCriteriaOperator;
var
...
begin
  ...
  if Supports(AOperator, IdxOperandProperty) or
    Supports(AOperator, IdxOperandValue) then
    Result := CreateBinary(TdxBinaryOperatorType.Equal, AProcessedOperand,
      TdxConstantValue.Create(True))
  else
    Result := AOperator;
end;

function TdxBaseQueryGenerator.ProcessLogicalInContext
  (AEntityInfo: TdxEntityInfo; ASingleNode: TdxJoinNode;
...
function TdxBaseQueryGenerator.ProcessSingleAggregateOperand
  (const ACollectionProperty: IdxOperandProperty;
const ACondition, AAggregatedExpression: IdxCriteriaOperator)
  : IdxCriteriaOperator;
begin
  if ACollectionProperty = nil then
  ...
  Result := ExecuteWithPropertyNameDiving(ACollectionProperty.PropertyName,
    ...
    begin
      ...
      try
        ...
        begin
          AAlias := GetPropertyNode(TdxMemberInfoCollection.Create(FEntityInfo,
            [AMic[I], AMic[I + 1]]), FCurrentJoinType);
          ClassInfoStack.Push(FEntityInfo);
          NodeStack.Push(FRootNode);
          NodeStackHashSet.Add(FRootNode.Alias);
        ...
        ACollectionAlias := GetPropertyNode(TdxMemberInfoCollection.Create
          (FEntityInfo, [AMic[AMic.Count - 1]]), FCurrentJoinType);
        ...
        begin
          ASingleNode := AppendSingleAggregateJoinNode
            (AMember.CollectionElementType, AMember, ACondition, FRootNode,
            FCurrentJoinType);
          Exit(ProcessLogicalInContext(AMember.CollectionElementType,
            ASingleNode, AAggregatedExpression) as TdxCriteriaOperator);
        end;
      finally
        for I := 0 to AMic.Count - 1 - 1 do
        begin
...
function TdxBaseQueryGenerator.ProcessSubSelectOperator
  (const ACollectionProperty: IdxOperandProperty;
const AOperandClause, AAggregateProperty: IdxCriteriaOperator;
AAggregateFunctionType: TdxAggregateFunctionType): TdxQuerySubQueryContainer;
var
...
begin
  ...
  begin
    ...
    AGena := TdxSubSelectQueryGenerator.Create(Self, BatchWideData,
      ACollectionProperty.PropertyName, AMember.CollectionElementType,
      AAggregateProperty, AAggregateFunctionType, FCollectionCriteriaPatcher);
  end;
  try
    AQueryStatement := AGena.GenerateSelect(AOperandClause);
    ...
    try
      ALeftOperator := GetMembers(AAlias.Node,
        AMember.Owner.KeyProperty.Member);
      ARightOperator := AGena.Process(AOperandProperty);
      AQueryStatement.Condition := TdxGroupOperator.And
        (CreateBinary(TdxBinaryOperatorType.Equal, ALeftOperator,
        ARightOperator), AQueryStatement.Condition);
    finally
...
function TdxBaseQueryGenerator.ProcessSubSelectOperator(const AJoinTypeName
  : string; const AOperandClause, AAggregateProperty: IdxCriteriaOperator;
AAggregateFunctionType: TdxAggregateFunctionType): TdxQuerySubQueryContainer;
var
...
begin
  AJoinEntityInfo := nil;
  if not TdxMemberInfoCollection.TryResolveTypeAlsoByShortName(AJoinTypeName,
    FEntityInfo, AJoinEntityInfo) then
    raise EdxCannotResolveClassInfoException.CreateFmt
      (sdxMetadataCannotResolveEntityInfo, [AJoinTypeName]);
  AGena := TdxSubSelectQueryGenerator.Create(Self, BatchWideData, '',
    AJoinEntityInfo, AAggregateProperty, AAggregateFunctionType,
    FCollectionCriteriaPatcher);
  try
    AQueryStatement := AGena.GenerateSelect(AOperandClause);
  finally
    AGena.Free;
...
function TdxBaseQueryGenerator.ProcessSingleJoinOperand(const AJoinTypeName
  : string; const ACondition, AAggregatedExpression: IdxCriteriaOperator)
  : IdxCriteriaOperator;
var
  AJoinEntityInfo: TdxEntityInfo;
...
begin
  ...
  if not TdxMemberInfoCollection.TryResolveTypeAlsoByShortName(AJoinTypeName,
    ...
    raise EdxCannotResolveClassInfoException.CreateFmt
      (sdxMetadataCannotResolveEntityInfo, [AJoinTypeName]);
  AJoinNode := AppendSingleAggregateJoinNode(AJoinEntityInfo, nil, ACondition,
    FRootNode, FCurrentJoinType);
  Result := ProcessLogicalInContext(AJoinEntityInfo, AJoinNode,
    AAggregatedExpression);
end;

class procedure TdxBaseQueryGenerator.SetJoinTypeWithSubNodes
  (ANode: TdxJoinNode; AType: TdxJoinType);
var
  ASubNode: TdxJoinNode;
begin
  ANode.&Type := AType;
...
procedure TdxBaseQueryGenerator.TryAddNodeIntoProjection(APrevNode,
  ANode: TdxJoinNode);
var
  AProjectionNode: TdxJoinNode;
...
begin
  if (FProjectedSingleNodes <> nil) and FProjectedSingleNodes.TryGetValue
    (APrevNode.Alias, AProjectionNode) then
  begin
    FProjectedSingleNodes.Add(ANode.Alias, AProjectionNode);
    if (FProjectionNodes <> nil) and FProjectionNodes.TryGetValue
      (AProjectionNode.Alias, AProjectedNodeItem) then
      AProjectedNodeItem.ProjectedNodes.Add(ANode);
  end;
end;

function TdxBaseQueryGenerator.TryGetMultiColumnAlias(const AOperator
  : IdxCriteriaOperator; out AAlias: IdxPropertyAlias): Boolean;
begin
  if FMultiColumnAliases = nil then
  begin
    AAlias := nil;
...
function TdxBaseQueryGenerator.Visit(const AOperand: IdxOperandValue)
  : IdxCriteriaOperator;
begin
...
function TdxBaseQueryGenerator.Visit(const AOperator: IdxBetweenOperator)
  : IdxCriteriaOperator;
var
  AGroupOperator: IdxCriteriaOperator;
begin
  AGroupOperator := TdxGroupOperator.And
    (TdxBinaryOperator.Create(AOperator.TestExpression,
    AOperator.BeginExpression, TdxBinaryOperatorType.GreaterOrEqual),
    TdxBinaryOperator.Create(AOperator.TestExpression, AOperator.EndExpression,
    TdxBinaryOperatorType.LessOrEqual));
  Result := Process(AGroupOperator as TdxCriteriaOperator);
end;

function TdxBaseQueryGenerator.Visit(const AOperator: IdxBinaryOperator)
  : IdxCriteriaOperator;
var
...
begin
  ...
  try
    ...
    if (AOperator.LeftOperand = nil) or (AOperator.RightOperand = nil) then
      raise EArgumentNilException.Create
        (sdxGeneratorOneOfBinaryOperatorsOperandsIsNull);
    ...
    Result := CreateBinary(AOperator.OperatorType, ALeftOperator,
      ARightOperator);
  finally
...
function TdxBaseQueryGenerator.Visit(const AOperator: IdxInOperator)
  : IdxCriteriaOperator;
var
    ...
    try
      ...
      begin
        ...
        try
          ...
          Result := TdxInOperator.Create(GetParameter(ALeftOperator,
            ADefaultMembers, 0), AList);
        finally
          AList.Free;
        end;
      end;
...
function TdxBaseQueryGenerator.Visit(const AOperator: IdxGroupOperator)
  : IdxCriteriaOperator;
var
  APrevJoinType: TdxJoinType;
...
begin
  APrevJoinType := FCurrentJoinType;
  if (AOperator.OperatorType = FCurrentLeftJoinEnforcer) and
    (AOperator.Operands.Count > 1) then
    FCurrentJoinType := TdxJoinType.LeftOuter;
  try
    Result := nil;
    ...
    begin
      ...
      Result := TdxGroupOperator.Combine(AOperator.OperatorType, Result,
        AProcessed) as TdxCriteriaOperator;
    end;
  finally
    FCurrentJoinType := APrevJoinType;
  end;
...
function TdxBaseQueryGenerator.Visit(const AOperator: IdxUnaryOperator)
  : IdxCriteriaOperator;
var
  APrevLeftJoinEnforcer: TdxGroupOperatorType;
  APrevJoinType: TdxJoinType;
  ...
  try
    if AOperator.OperatorType = TdxUnaryOperatorType.Not then
      if (FCurrentLeftJoinEnforcer = TdxGroupOperatorType.Or) then
        ...
        FCurrentLeftJoinEnforcer := TdxGroupOperatorType.Or;
    if (AOperator.OperatorType = TdxUnaryOperatorType.IsNull) and
      (FCurrentLeftJoinEnforcer = TdxGroupOperatorType.Or) then
      FCurrentJoinType := TdxJoinType.LeftOuter;
    AOperandProperty := Safe<TdxOperandProperty>.Cast
      (AOperator.Operand as TdxCriteriaOperator);
    if AOperandProperty = nil then
    begin
      if AOperator.OperatorType = TdxUnaryOperatorType.Not then
        Result := TdxUnaryOperator.Create(TdxUnaryOperatorType.Not,
          ProcessLogical(AOperator.Operand as TdxCriteriaOperator))
      else
      begin
        ...
        Result := TdxUnaryOperator.Create(AOperator.OperatorType,
          GetParameter(AProcessedOperand, AAlias, 0));
      end;
    end
    else
    begin
      ...
      for I := 0 to ACount - 1 do
        Result := TdxGroupOperator.And
          (Result, TdxUnaryOperator.Create(AOperator.OperatorType,
          GetQueryOperandFromAlias(ANode, ANode, I))) as TdxCriteriaOperator;
    end;
  finally
    FCurrentLeftJoinEnforcer := APrevLeftJoinEnforcer;
    FCurrentJoinType := APrevJoinType;
...
function TdxBaseQueryGenerator.Visit(const AOperator: IdxFunctionOperator)
  : IdxCriteriaOperator;
var
  APrevJoinType: TdxJoinType;
...
begin
  ...
  try
    ...
    if (AOperator.OperatorType = TdxFunctionOperatorType.Custom) and
      (AOperator.Operands.Count = 3) then
      NotImplemented
    else if AOperator.OperatorType in [TdxFunctionOperatorType.IsNull,
      TdxFunctionOperatorType.IsNullOrEmpty, TdxFunctionOperatorType.Iif] then
      FCurrentJoinType := TdxJoinType.LeftOuter
    else if (AOperator.OperatorType = TdxFunctionOperatorType.AddTimeSpan) and
      not TdxSQLConnectionProvider.UseLegacyTimeSpanSupport then
...
function TdxBaseQueryGenerator.Visit(const AOperand: IdxOperandProperty)
  : IdxCriteriaOperator;
begin
  Result := GetPropertyNode(AOperand, FCurrentJoinType);
end;

function TdxBaseQueryGenerator.Visit(const AOperator: IdxAggregateOperand)
  : IdxCriteriaOperator;
var
  ARes: IdxCriteriaOperator;
...
begin
  ...
  begin
    ...
    begin
      if IsGrouped then
        Exit(ProcessTopSubSelect(AOperator.AggregatedExpression,
          AOperator.Condition, AOperator.AggregateFunctionType));
      Exit(Process(TdxBinaryOperator.Create(TdxAggregateOperand.Create(nil,
        AOperator.AggregatedExpression, TdxAggregateFunctionType.Count,
        AOperator.Condition), TdxOperandValue.Create(0),
        TdxBinaryOperatorType.Greater)));
    end;
    if AOperator.AggregateFunctionType = TdxAggregateFunctionType.Single then
      raise EInvalidOperation.Create
        (sdxGeneratorTheUseOfATopLevelSingleAggregateIsProhibited);
    ...
    if AOperator.AggregatedExpression = nil then
      AProp := nil;
    Exit(TdxQuerySubQueryContainer.Create(nil, AProp,
      AOperator.AggregateFunctionType));
  end;
  if AOperator.AggregateFunctionType = TdxAggregateFunctionType.Single then
    Result := ProcessSingleAggregateOperand(AOperator.CollectionProperty,
      AOperator.Condition, AOperator.AggregatedExpression)
      as TdxCriteriaOperator
  else
    Result := ProcessSubSelectOperator(AOperator.CollectionProperty,
      AOperator.Condition, AOperator.AggregatedExpression,
      AOperator.AggregateFunctionType) as TdxCriteriaOperator;
end;

function TdxBaseQueryGenerator.Visit(const AOperator: IdxJoinOperand)
  : IdxCriteriaOperator;
begin
  if AOperator.AggregateFunctionType = TdxAggregateFunctionType.Single then
    Result := ProcessSingleJoinOperand(AOperator.JoinTypeName,
      AOperator.Condition, AOperator.AggregatedExpression)
      as TdxCriteriaOperator
  else
    Result := ProcessSubSelectOperator(AOperator.JoinTypeName,
      AOperator.Condition, AOperator.AggregatedExpression,
      AOperator.AggregateFunctionType) as TdxCriteriaOperator;
end;
