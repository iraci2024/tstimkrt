...
{$ENDIF}
  ...
  dxCore, dxCoreClasses, cxControls, cxEdit, cxGraphics, cxStyles, cxGeometry,
  cxLookAndFeels,
  cxLookAndFeelPainters, cxSchedulerCustomControls,
  cxSchedulerCustomResourceView,
  cxSchedulerUtils, dxRangeControl, cxSchedulerStorage, cxSchedulerStrs,
  cxDateUtils, cxClasses,
  cxDrawTextUtils, dxOffice11, cxScrollBar, dxGenerics, cxVariants;
...
type
  ...
  //
  TcxSchedulerTimeGridScaleUnit = (suHour, suDay, suWeek, suMonth,
    suQuarter, suYear);
  TcxSchedulerTimeGridScaleUnits = set of TcxSchedulerTimeGridScaleUnit;
  TcxSchedulerTimeGridScaleTextType = (sttUnknown, sttShort, sttMiddle,
    sttLong);
  ...
  TcxSchedulerTimeGridViewController = class
  ...
  protected
    ...
    procedure MouseUp(Button: TMouseButton; Shift: TShiftState;
      X, Y: Integer); override;
    procedure Scrolling(AScrollCode: TScrollCode;
  ...
  TcxSchedulerTimeGridViewNavigation = class
  ...
  protected
    ...
    function GetSelectionBarParamsEx(const ADateTime: TDateTime;
      ASelected: Boolean): TcxViewParams; virtual;
  ...
  published
    property MajorScale: TcxStyle index cxcsMajorScale read GetValue
      write SetValue;
    property MajorScaleUnitSeparator: TcxStyle index cxcsMajorScaleUnitSeparator
      read GetValue write SetValue;
    property MinorScale: TcxStyle index cxcsMinorScale read GetValue
      write SetValue;
    property SelectionBar: TcxStyle index cxcsSelectionBar read GetValue
      write SetValue;
    property OnGetMajorScaleParams: TcxSchedulerGetScaleItemStyleEvent
      read FOnGetMajorScaleParams write FOnGetMajorScaleParams;
    property OnGetMinorScaleParams: TcxSchedulerGetScaleItemStyleEvent
      read FOnGetMinorScaleParams write FOnGetMinorScaleParams;
    property OnGetSelectionBarParams: TcxSchedulerGetScaleItemStyleEvent
      read FOnGetSelectionBarParams write FOnGetSelectionBarParams;
  end;
  ...
  published
    ...
    property MajorUnit: TcxSchedulerTimeGridScaleUnit read FMajorUnit
      write SetMajorUnit default suDay;
    property MajorUnitSeparatorWidth: Integer read FMajorUnitSeparatorWidth
      write SetMajorUnitSeparatorWidth default cxDefaultSplitterWidth;
    property Minor: Boolean read FMinor write SetMinor default True;
    property MinorUnit: TcxSchedulerTimeGridScaleUnit read FMinorUnit
      write SetMinorUnit default suHour;
    property MinorUnitWidth: Integer read FMinorUnitWidth
      write SetMinorUnitWidth default cxDefaultMinorUnitWidth;
  ...
  public
    ...
    property HitAtMajorSeparator: Boolean index htcMajorSeparator
      read GetBitState;
  ...
  TcxSchedulerTimeGridViewTreeBrowserSplitterController = class
  ...
  protected
    ...
    function CreateSplitter
      : TcxSchedulerTimeGridViewTreeBrowserSplitter; virtual;
  ...
  public
    ...
    property Splitter: TcxSchedulerTimeGridViewTreeBrowserSplitter
      read FSplitter; // for internal use
  ...
  TcxSchedulerCustomDrawMajorUnitEvent = procedure(Sender: TObject;
    ACanvas: TcxCanvas; AViewInfo: TcxSchedulerTimeGridMajorScaleCell;
    var ADone: Boolean) of object;
  TcxSchedulerCustomDrawMinorUnitEvent = procedure(Sender: TObject;
    ACanvas: TcxCanvas; AViewInfo: TcxSchedulerTimeGridMinorScaleCell;
    var ADone: Boolean) of object;
  TcxSchedulerCustomDrawSelectionBarEvent = procedure(Sender: TObject;
    ACanvas: TcxCanvas; AViewInfo: TcxSchedulerTimeGridSelectionBarCell;
    var ADone: Boolean) of object;

  TcxSchedulerTimeGridViewGetUnitDisplayTextEvent = procedure
    (Sender: TcxSchedulerTimeGridView; const AStart, AFinish: TDateTime;
    ATextType: TcxSchedulerTimeGridScaleTextType; var AText: string) of object;
  ...
  protected
    ...
    procedure DoDrawSelectionBarCell
      (AItem: TcxSchedulerTimeGridSelectionBarCell;
      var ADone: Boolean); virtual;
    procedure DoDrawTimeLineCell(AItem: TcxSchedulerTimeGridMinorScaleCell;
      var ADone: Boolean); virtual;
    procedure DoDrawTimeLineHeaderCell
      (AItem: TcxSchedulerTimeGridMajorScaleCell; var ADone: Boolean); virtual;
    ...
    function GetControlEventLineStart(AEvent: TcxSchedulerControlEvent)
      : Integer;
    ...
    procedure GetRangeControlScales(AScales: TdxRangeControlDateTimeScales;
      AValues: TdxRangeControlDateTimeScaleList); override;
    ...
    //
    property TreeBrowser: TcxSchedulerTimeGridViewTreeBrowser read FTreeBrowser
      write SetTreeBrowser;
    property ViewInfo: TcxSchedulerTimeGridViewViewInfo read GetViewInfo;
  public
  ...
  published
    ...
    property EventMaxLineCount: Integer read FEventMaxLineCount
      write SetEventMaxLineCount default 0;
    property Scales: TcxSchedulerTimeGridViewScales read FScales
      write SetScales;
    property ShowMoreEventsButton: Boolean read FShowMoreEventsButton
      write SetShowMoreEventsButton default True;
    property ShowResourceScrollBar: Boolean read FShowResourceScrollBar
      write SetShowResourceScrollBar default True;
    property Styles: TcxSchedulerTimeGridViewStyles read FStyles
      write SetStyles;
    property EventDetailInfo: Boolean read FEventDetailInfo
      write SetEventDetailInfo default False;
    property ShowTimeAsClock;
    property SnapEventsToTimeSlots: Boolean read FSnapEventsToTimeSlots
      write SetSnapEventsToTimeSlots default True;
    property WorkDaysOnly: Boolean read FWorkDaysOnly write SetWorkDaysOnly
      default False;
    property WorkTimeOnly: Boolean read FWorkTimeOnly write SetWorkTimeOnly
      default False;
    property OnCustomDrawMajorUnit: TcxSchedulerCustomDrawMajorUnitEvent
      read FOnCustomDrawMajorUnit write FOnCustomDrawMajorUnit;
    property OnCustomDrawMinorUnit: TcxSchedulerCustomDrawMinorUnitEvent
      read FOnCustomDrawMinorUnit write FOnCustomDrawMinorUnit;
    property OnCustomDrawSelectionBar: TcxSchedulerCustomDrawSelectionBarEvent
      read FOnCustomDrawSelectionBar write FOnCustomDrawSelectionBar;
    property OnGetMajorUnitDisplayText
      : TcxSchedulerTimeGridViewGetUnitDisplayTextEvent
      read FOnGetMajorUnitDisplayText write FOnGetMajorUnitDisplayText;
    property OnGetMinorUnitDisplayText
      : TcxSchedulerTimeGridViewGetUnitDisplayTextEvent
      read FOnGetMinorUnitDisplayText write FOnGetMinorUnitDisplayText;
  end;
  ...
  protected
    ...
    WorkStart: TDateTime;
    function CalculateDateTime(const ADateTime: TDateTime; AInc: Integer)
      : TDateTime;
    function CalculateDateTimeDateTimeWithoutCheckWorkDays(const ADateTime
      : TDateTime; AInc: Integer): TDateTime;
    function CalculateScaleUnit(const AScaleUnit: Integer): Integer;
    procedure CalculateWorkTime(AIsWorkTimeOnly: Boolean;
    ...
    function ValidateTime(var ADateTime: TDateTime; AGoForward: Boolean;
      AInc: Integer = 1): Boolean; inline;
    procedure ValidateUnits(var AMajorUnit, AMinorUnit
      : TcxSchedulerTimeGridScaleUnit); inline;
  public
    ...
    procedure Initialize(AView: TcxSchedulerTimeGridView;
      AWorkTimeOnly, AWorkDaysOnly: Boolean);
    function IsPeriodChanged(const AFirst, ANext: TDateTime): Boolean;
    function TimeCorrected(var AStart, AFinish: TDateTime;
  ...
  TcxSchedulerTimeGridViewEventCellCustomViewInfo = class
  ...
  protected
    ...
    function GetImagesVerticalOffset(AImageHeight: Integer;
      AIsAbsolute: Boolean): Integer; override;
  ...
  TcxSchedulerTimeGridViewEventCellViewInfo = class
    (TcxSchedulerTimeGridViewEventCellCustomViewInfo)
  protected
  ...
  TcxSchedulerTimeGridViewEventCellModernViewInfo = class
    (TcxSchedulerTimeGridViewEventCellCustomViewInfo)
  private
  ...
  protected
    ...
    procedure CalculateHeaderEventNeededCaptionWidth(var AFullWidth,
      ACaptionOnlyWidth: Integer); override;
    ...
    function CheckAutoLayoutImagesSingleLineCaption(const ACaptionWidth,
      AAvailableWidth: Integer): Boolean; override;
    procedure CheckItemsAfterAutoLayoutImagesCalculation
      (AFactuallyImagesRowCount, AImagesWidth: Integer); override;
  ...
  TcxSchedulerTimeGridViewAdapter = class(TcxCustomResourceViewAdapter,
    IcxSchedulerTimeGridViewAdapter)
  protected
    FVisibleStart: TDateTime;
    function GetLineOffset: Integer;
  ...
  TcxSchedulerTimeGridViewContentCellViewInfo = class
  ...
  protected
    ...
    procedure SetBorderColor(const AResourceColor: Integer;
      AIsHourSeparator, AIsWorkTime: Boolean); virtual;
  ...
  TcxSchedulerTimeGridViewModernContentCellViewInfo = class
    (TcxSchedulerTimeGridViewContentCellViewInfo)
  protected
  ...
  TcxSchedulerForEachForEventUniqueResourceIDsFunc = reference to procedure
    (AResourceIndex: Integer);

  TcxSchedulerTimeGridViewViewInfo = class
    (TcxSchedulerCustomResourceViewViewInfo)
  private
    FEventUniqueResourceIDsMap
      : TObjectDictionary<TcxSchedulerEvent, TdxVariantList>;
    FResourceMap: TdxNamedObjectDictionary<TdxIntegerList>;

    FResourceViewShift: TcxObjectList;
    procedure CalculateResourceViewShifts
    ...
    function GetResourceViewShift(Index: Integer)
  ...
  protected
    ...
    function AddContentCell(const ARect: TRect; const AStart: TDateTime;
      const AFinish: TDateTime; AResourceIndex: Integer)
      : TcxSchedulerContentCellViewInfo; override;
    procedure AddEventForCalculation(ABuilder: TcxSchedulerEventLayoutBuilder;
      AEvent: TcxSchedulerControlEvent;
      AResource: TcxSchedulerStorageResourceItem;
      AResourceIndex: Integer); virtual;
    procedure AddEventsForCalculation(ABuilder: TcxSchedulerEventLayoutBuilder);
    function AddEventViewInfo(APlace: TcxSchedulerEventPlace;
      AResourceIndex: Integer; const AStart, AFinish: TDateTime)
      : TcxSchedulerEventCellViewInfo;
    procedure AddMajorScaleCell(ABounds: TRect;
      const AStart, AFinish: TDateTime); virtual;
    procedure AddMajorSeparator(var ALeft: Integer);
    procedure AddMinorScaleCell(const ABounds: TRect;
      const AStart, AFinish: TDateTime); virtual;
    function AddSelectionBarCell(const ABounds: TRect;
      const AStart, AFinish: TDateTime)
      : TcxSchedulerTimeGridSelectionBarCell; virtual;
    procedure AddTimeLineItem(AClass: TcxSchedulerCustomViewInfoItemClass;
      const ABounds: TRect; AType: Byte; const AStart, AFinish: TDateTime;
    ...
    procedure CalculateEventPosition(AEvent: TcxSchedulerControlEvent;
      AColIndex: Integer; out AStartX, AFinishX: Integer;
      out AStart, AFinish: TDateTime);
    ...
    procedure CalculateResourceTopBottom(AResourceIndex: Integer;
      var ABounds: TRect);
    procedure CalculateScales; virtual;
    procedure CalculateScalesHeight;
    procedure CheckEventVisibility(ACell: TcxSchedulerEventCellViewInfo;
      AIndex: Integer); virtual;
    function CheckFinishTime(const ATime: TDateTime;
      AUnit: TcxSchedulerTimeGridScaleUnit): TDateTime; virtual;
    ...
    procedure CustomProcessPreviouslyCalculatedEvent
      (AEventCell: TcxSchedulerEventCellViewInfo); override;
    procedure DoCalculate; override;
    procedure DoContentNavigationButtonClick
      (Sender: TcxSchedulerContentNavigationButtonViewInfo); override;
    procedure DoMoreEventsButtonClick
      (Sender: TcxSchedulerMoreEventsButtonViewInfo); override;
    procedure DoResourceVerticalScroll(Sender: TObject; ScrollCode: TScrollCode;
    ...
    function IsColumnEvent(AEvent: TcxSchedulerControlEvent;
    ...
    function GetActualPos(const APos: Integer;
      const ATime, AStart, AFinish: TDateTime): Integer; virtual;
    function GetEventClipRect(AEventViewInfo
      : TcxSchedulerEventCellViewInfo): TRect;
    function GetGroupingKind: TcxSchedulerGroupingKind; override;
    ...
    function GetMoreEventButtonClass
      : TcxSchedulerMoreEventsButtonViewInfoClass; override;
    ...
    function MeasureFontHeight(AStyle: TcxStyle; AHeight: Integer;
      Borders: TcxBorders): Integer;
  ...
  public
    ...
    property MajorTextType: TcxSchedulerTimeGridScaleTextType
      read FMajorTextType;
    property MinorTextType: TcxSchedulerTimeGridScaleTextType
      read FMinorTextType;
    property Scales: TcxSchedulerTimeGridViewScales read FScales;
    ...
    property ResourceViewShift[Index: Integer]
      : TcxSchedulerTimeGridResourceScroll read GetResourceViewShift;
  ...
  public
    property DisplayText;
    property HideDisplayText: Boolean read FHideDisplayText
      write FHideDisplayText;
  ...
  TcxSchedulerMajorSeparatorCellViewInfo = class
  ...
  private
    ...
    function GetViewInfo: TcxSchedulerTimeGridViewViewInfo;
  protected
    procedure DrawTimeLineCellItem(AItem: TcxSchedulerCustomViewInfoItem;
      var ADone: Boolean); virtual;
    //
  public
  ...
  TcxSchedulerTimeGridMoreEventsModernButtonViewInfo = class
  ...
  TcxSchedulerTimeGridResourceScroll = class(TcxIUnknownObject,
  ...
  public
    constructor Create(ATimeGridView: TcxSchedulerTimeGridView;
      AResourceIndex: Integer);
    destructor Destroy; override;
    procedure HideScrollBar;
    procedure SetScrollBarParams(ATimeGridView: TcxSchedulerTimeGridView;
      AResourceIndex: Integer);
...
const
  ...
  ValidMinorUnits: array [TcxSchedulerTimeGridScaleUnit]
    of TcxSchedulerTimeGridScaleUnits = ([], [suHour], [suDay], [suDay],
    [suDay, suMonth], [suDay, suMonth, suQuarter]);
  ...
  MonthTextFormats: array [TcxSchedulerTimeGridScaleTextType]
    of string = ('mmmm, yyyy', 'mm, yy', 'mmm, yy', 'mmmm, yyyy');
  QuarterTextFormats: array [TcxSchedulerTimeGridScaleTextType, 0 .. 3]
    of string = (('Q1{ ''yy}', 'Q2{ ''yy}', 'Q3{ ''yy}', 'Q4{ ''yy}'),
    ('Q1{ ''yy}', 'Q2{ ''yy}', 'Q3{ ''yy}', 'Q4{ ''yy}'),
    ('Q1{ ''yyyy}', 'Q2{ ''yyyy}', 'Q3 ''{yyyy}', 'Q4{ ''yyyy}'),
    ('1st Quarter{, yyyy}', '2nd Quarter{, yyyy}', '3rd Quarter{, yyyy}',
    '4th Quarter{, yyyy}'));
...
const
  ...
  SchedulerTimeGridScaleUnitDuration: array [TcxSchedulerTimeGridScaleUnit]
    of Double = (1 / 24, 1, 7, 31, 92, 366);
...
function cxTimeLineCellsCompare(ACell1,
  ACell2: TcxSchedulerTimeGridMinorScaleCell): Integer;
begin
...
function GetMinorCellDisplayText(ATextType: TcxSchedulerTimeGridScaleTextType;
  AScale, AMajorScale: TcxSchedulerTimeGridScaleUnit;
  const AStart, AFinish: TDateTime): string;
begin
  case AScale of
    suHour:
    ...
    suDay:
      begin
        ...
        else if AMajorScale <= suMonth then
          Result := FormatDateTime('d ddd', AStart)
        else
          Result := FormatDateTime('d/m', AStart);
      end;
    suWeek:
      Result := GetMinorCellDisplayText(ATextType, suDay, AMajorScale, AStart,
        AStart) + '-' + GetMinorCellDisplayText(ATextType, suDay, AMajorScale,
        AFinish, AFinish);
    suMonth:
...
function GetMajorCellDisplayText(ATextType: TcxSchedulerTimeGridScaleTextType;
  AScale: TcxSchedulerTimeGridScaleUnit;
  const AStart, AFinish: TDateTime): string;
begin
  case AScale of
    suDay:
    ...
    suYear:
      Result := GetMinorCellDisplayText(ATextType, suYear, suYear,
        AStart, AFinish);
  else
    Result := '';
  end;
...
begin
  ...
  begin
    ...
    with AEvent do
    begin
      AllDay := (dxTimeOf(Start) = 0) and (dxTimeOf(Finish) = 0) and
        (Duration >= 1) and ((AEvent.Source = nil) or AEvent.AllDayEvent or
        (AEvent.Source.Duration <> AEvent.Duration));
...
begin
  ...
  begin
    ATime := Max(Event.Start,
      TimeBuilder.CalculateDateTimeDateTimeWithoutCheckWorkDays(ATime, 1));
...
begin
  Result := TcxSchedulerTimeGridView(Scheduler.CurrentView)
    .ViewInfo.TimeBuilder;
end;

{ TcxSchedulerTimeGridViewController }

constructor TcxSchedulerTimeGridViewController.Create
...
function TcxSchedulerTimeGridViewController.CreateDragEventHelper
  : TcxDragEventHelper;
begin
  Result := TcxTimeGridDragEventHelper.Create(Scheduler);
end;

function TcxSchedulerTimeGridViewController.CreateNavigation
  : TcxSchedulerViewNavigation;
begin
  Result := TcxSchedulerTimeGridViewNavigation.Create(View);
end;

function TcxSchedulerTimeGridViewController.CreateResizeEventHelper
...
begin
  ...
  else if APos.X >= (R.Right - cxScrollZoneSize) then
...
begin
  ...
  FDownScrollArea := cxRectSetTop(FDownScrollArea, ViewInfo.FScalesHeight -
    cxScrollZoneSize);
end;

procedure TcxSchedulerTimeGridViewController.InitTimer(AllowStart: Boolean;
  AScrollCode: TScrollCode);
begin
...
begin
  ...
  if CanProcessMouseMove and (Button = mbLeft) and not NavigationButtonClicked
  then
    CheckScrolling(cxPoint(X, Y))
end;

procedure TcxSchedulerTimeGridViewController.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
  if (DragKind = edkNone) and HitTest.HitAtScale and HitTest.HitAtTime then
    HitTest.FResource := Scheduler.SelResource;
  inherited MouseMove(Shift, X, Y);
  if CanProcessMouseMove and (ssLeft in Shift) and not NavigationButtonClicked
  then
    CheckScrolling(cxPoint(X, Y))
end;

procedure TcxSchedulerTimeGridViewController.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited MouseUp(Button, Shift, X, Y);
end;

procedure TcxSchedulerTimeGridViewController.Scrolling(AScrollCode: TScrollCode;
...
begin
  ...
  if HitTest.HitAtEvent and (HitTest.EventCell <> nil) and
    (HitTest.Event = AEvent) then
    AViewInfo := HitTest.EventCell
  else if not View.FindEventViewInfo(AEvent.Source, AEvent.Start,
    AEvent.GetResourceItem, AViewInfo) then
    AViewInfo := nil;
  ...
  begin
    ...
    TcxSchedulerTimeGridViewNavigation(Navigation).ReplaceSelParams(AStart,
      AFinish, AResourceItem);
  end
  else
...
function TcxSchedulerTimeGridViewController.GetHitTest
  : TcxSchedulerTimeGridViewHitTest;
begin
  Result := TcxSchedulerTimeGridViewHitTest(inherited HitTest);
end;
...
function TcxSchedulerTimeGridViewController.GetViewInfo
  : TcxSchedulerTimeGridViewViewInfo;
begin
...
procedure TcxSchedulerTimeGridViewNavigation.KeyDown(var AKey: Word;
  AShift: TShiftState);
const
...
begin
  case AKey of
    VK_LEFT, VK_RIGHT:
      with TimeBuilder do
      begin
        AFinish := CalculateDateTime(FCurrentAnchor,
          Direction[AKey = ANextCellKey[View.UseRightToLeftAlignment]]);
        if CheckTime and
          (((AFinish > SelAnchor) and (RoundTime(dxTimeOf(AFinish))
          = WorkFinish)) { or
            IsPeriodChanged(AFinish, FCurrentAnchor) } ) then
          AFinish := CalculateDateTime(AFinish,
            Direction[AKey = ANextCellKey[View.UseRightToLeftAlignment]]);
        TimeBuilder.CheckWorkDays(AFinish,
          AKey = ANextCellKey[View.UseRightToLeftAlignment]);
    ...
    VK_UP, VK_DOWN:
      if not(ssShift in AShift) and
        (GetNextResource(AKey = VK_DOWN) <> FCurrentResource) then
        SetSelAnchor(FCurrentAnchor, AShift, GetNextResource(AKey = VK_DOWN))
      else if ScrollResourcesEx(AKey = VK_DOWN, FCurrentResource) then
        ReplaceSelParams(FCurrentResource);
  end;
  View.CheckRefresh;
end;

procedure TcxSchedulerTimeGridViewNavigation.ValidateSelection(var ASelStart,
...
function TcxSchedulerTimeGridViewNavigation.GetTimeBuilder
  : TcxSchedulerTimeBuilder;
begin
...
function TcxSchedulerTimeGridViewNavigation.GetViewInfo
  : TcxSchedulerTimeGridViewViewInfo;
begin
  Result := View.ViewInfo;
end;
...
function TcxSchedulerTimeGridViewStyles.GetMajorScaleParams(const ADateTime
...
function TcxSchedulerTimeGridViewStyles.GetMajorScaleUnitSeparatorParams
  : TcxViewParams;
begin
  GetViewParams(cxcsMajorScaleUnitSeparator, nil, nil, Result);
end;

function TcxSchedulerTimeGridViewStyles.GetMinorScaleParams(const ADateTime
  : TDateTime): TcxViewParams;
var
  AStyle: TcxStyle;
begin
...
function TcxSchedulerTimeGridViewStyles.GetSelectionBarParams(const ADateTime
  : TDateTime): TcxViewParams;
begin
...
procedure TcxSchedulerTimeGridViewStyles.GetDefaultViewParams(Index: Integer;
...
function TcxSchedulerTimeGridViewStyles.GetSelectionBarParamsEx(const ADateTime
  : TDateTime; ASelected: Boolean): TcxViewParams;
var
  AStyle: TcxStyle;
begin
  AStyle := nil;
...
function TcxSchedulerTimeGridViewStyles.IsTimeSelected(const ADateTime
  : TDateTime): Boolean;
begin
...
procedure TcxSchedulerTimeGridViewScales.SetMajorUnitSeparatorWidth
  (AValue: Integer);
begin
  AValue := Max(0, AValue);
...
procedure TcxSchedulerTimeGridViewScales.SetMajorUnit
  (AValue: TcxSchedulerTimeGridScaleUnit);
begin
...
procedure TcxSchedulerTimeGridViewScales.SetMinorUnit
  (AValue: TcxSchedulerTimeGridScaleUnit);
begin
...
begin
  AValue := Max(TcxCustomSchedulerAccess(Scheduler)
    .ScaleFactor.Apply(cxMinColumnWidth), AValue);
...
begin
  ...
  begin
    ...
    while cxMaxHourScale mod FTimeStep <> 0 do
      Inc(FTimeStep);
    Changed;
  end;
end;
...
function TcxSchedulerTimeGridViewTreeBrowserSplitterController.
  IsIntegralSizing: Boolean;
begin
  Result := False;
end;

procedure TcxSchedulerTimeGridViewTreeBrowserSplitterController.SetSizeDelta
  (ADelta: Integer);
begin
  TcxSchedulerTimeGridViewTreeBrowserSplitter(Splitter).Browser.Width :=
    Max(0, TcxSchedulerTimeGridViewTreeBrowserSplitter(Splitter).Browser.Width
    - ADelta);
  Modified;
end;
...
function TcxSchedulerTimeGridViewTreeBrowserSplitter.GetView
  : TcxSchedulerTimeGridView;
begin
  Result := FBrowser.View;
end;

function TcxSchedulerTimeGridViewTreeBrowserSplitter.CreateController
...
function TcxSchedulerTimeGridViewTreeBrowser.CreateSplitter
  : TcxSchedulerTimeGridViewTreeBrowserSplitter;
begin
...
begin
  ...
  begin
    ...
    SetControlLookAndFeel(FInnerControl, TcxCustomSchedulerAccess(Scheduler)
      .LookAndFeel);
    InitializeInnerControl;
  end;
end;
...
begin
  Result := (View <> nil) and View.Visible and Visible and
    (SchedulerTreeBrowserClass <> nil);
end;

function TcxSchedulerTimeGridViewTreeBrowser.GetBrowser
  : IcxSchedulerTreeBrowserControl;
begin
  ValidateInnerControl;
...
function TcxSchedulerTimeGridView.GetMajorUnitDisplayText(const AStart,
  AFinish: TDateTime; ATextType: TcxSchedulerTimeGridScaleTextType): string;
begin
  Result := GetMajorCellDisplayText(ATextType, Scales.MajorUnit,
    AStart, AFinish);
  DoGetMajorUnitDisplayText(AStart, AFinish, ATextType, Result);
end;

function TcxSchedulerTimeGridView.GetMinorUnitDisplayText(const AStart,
  AFinish: TDateTime; ATextType: TcxSchedulerTimeGridScaleTextType): string;
begin
...
procedure TcxSchedulerTimeGridView.SetBounds(ALeft, ATop, AWidth,
  AHeight: Integer);
var
...
function TcxSchedulerTimeGridView.
...
begin
  if (FirstVisibleDate < EventList.SelStart) or
    (LastVisibleDate >= EventList.SelFinish) then
  begin
...
function TcxSchedulerTimeGridView.CreateController
  : TcxSchedulerSubControlController;
begin
...
function TcxSchedulerTimeGridView.CreateTreeBrowser
  : TcxSchedulerTimeGridViewTreeBrowser;
begin
  Result := TcxSchedulerTimeGridViewTreeBrowser.Create(Scheduler);
end;

function TcxSchedulerTimeGridView.CreateViewAdapter
  : TcxCustomResourceViewAdapter;
begin
  Result := TcxSchedulerTimeGridViewAdapter.Create(Self);
end;

function TcxSchedulerTimeGridView.CreateViewInfo
...
procedure TcxSchedulerTimeGridView.DoGetMajorUnitDisplayText(const AStart,
  AFinish: TDateTime; ATextType: TcxSchedulerTimeGridScaleTextType;
  var AText: string);
begin
...
procedure TcxSchedulerTimeGridView.DoGetMinorUnitDisplayText(const AStart,
  AFinish: TDateTime; ATextType: TcxSchedulerTimeGridScaleTextType;
  var AText: string);
begin
...
begin
  ...
  Result := Result + cxTimeToStr(LastVisibleTime,
    dxFormatSettings.ShortTimeFormat);
end;
...
begin
  ...
  else if Scales.MinorUnit = suMonth then
    Result := 31;
end;
...
begin
  ...
  SetScrollBarInfo(sbHorizontal, 0, ScrollMaxPos, 1, ScrollPage, Position,
    True, True);
end;
...
begin
  ...
  else if AnEventLineIndex >= ViewInfo.GetVisibleLineCount(AResourceIndex) - 1
  then
    ADelta := -(AnEventLineIndex - ViewInfo.GetVisibleLineCount
      (AResourceIndex) + 1);
  if ADelta <> 0 then
...
var
  AStart: TDateTime;
begin
  if (Scales = nil) or (ViewInfo = nil) then
    Exit;
  ...
  begin
    ...
    Controller.Navigation.ReplaceSelParams(AStart, AStart,
      Scheduler.SelResource);
  end;
  Changed;
  Scheduler.FullRefresh;
end;
  ...
  case AScrollCode of
    scLineDown, scLineUp:
      ...
      begin
        ...
        AStartTime := CalculateDateTime(AStartTime,
          Direction[AScrollCode = scLineDown]);
    ...
    scBottom, scTop, scPosition, scTrack:
      ...
      begin
        ...
        begin
          if CheckTime and (RoundTime(dxTimeOf(AStartTime)) = WorkFinish) then
            AStartTime := CalculateDateTime(AStartTime,
              Direction[AScrollPos - FScrollPosition > 0]);
        end;
        FScrollPosition := AScrollPos;
      end;
  end;
  VisibleStart := DateTimeHelper.RoundTime(AStartTime);
  if IsScrollingContent or IsGestureScrolling or (AScrollCode = scEndScroll)
  then
    AScrollPos := Max(Min(FScrollPosition, ScrollMaxPos - (ScrollPage * 2 - 1)),
      ScrollPage);
...
begin
  ...
  begin
    ...
    if FLockSelectionCounter = 0 then
      Controller.Navigation.ReplaceSelParams(NullDate, NullDate,
        Scheduler.SelResource);
    Changed;
  end;
end;
...
function TcxSchedulerTimeGridView.GetTouchScrollUIOwner(const APoint: TPoint)
  : IdxTouchScrollUIOwner;
var
  I: Integer;
  R: TRect;
...
procedure TcxSchedulerTimeGridView.GetRangeControlRange(out AMin,
  AMax: TDateTime);
begin
...
procedure TcxSchedulerTimeGridView.GetRangeControlScales
  (AScales: TdxRangeControlDateTimeScales;
  AValues: TdxRangeControlDateTimeScaleList);
const
  RangeControlScale: array [TcxSchedulerTimeGridScaleUnit]
    of TdxRangeControlDateTimeScaleUnit = (rcduHour, rcduDay, rcduWeek,
    rcduMonth, rcduQuarter, rcduYear);
begin
...
procedure TcxSchedulerTimeGridView.GetRangeControlTotalRange(out AMin,
  AMax: TDateTime);
var
  AStart, AFinish: TDateTime;
  ADuration: Int64;
...
begin
  ...
  begin
    ...
    try
      ...
      if EventList.UseTimeRange and ((FirstVisibleDate < EventList.SelStart) or
        (LastVisibleDate >= EventList.SelFinish)) then
        Scheduler.FullRefresh;
    end;
  end;
...
procedure TcxSchedulerTimeGridViewEventCellCustomViewInfo.
  CalculateEventTimeAsClockLayout(const ABounds: TRect;
  const ACaptionWidth, AImagesWidth: Integer; var ALeft: Integer);
var
...
begin
  ...
  ASpaceWidth := cxRectWidth(CaptionRect) -
    (ACaptionWidth + AImagesWidth + cxEventImagesOffset);
...
function TcxSchedulerTimeGridViewEventCellCustomViewInfo.
  CalculateNonDetailEventImages(const ACaptionWidth: Integer;
  out AImagesWidth: Integer): TRect;
begin
...
function TcxSchedulerTimeGridViewEventCellCustomViewInfo.
  GetDetailCaptionFlagValue: Boolean;
begin
  Result := FIsDetailInfo;
end;

function TcxSchedulerTimeGridViewEventCellCustomViewInfo.
  GetDetailInfoFlagValue: Boolean;
begin
...
function TcxSchedulerTimeGridViewEventCellCustomViewInfo.GetImagesVerticalOffset
  (AImageHeight: Integer; AIsAbsolute: Boolean): Integer;
begin
  Result := Max(ScaleFactor.Apply(cxEventImagesOffset),
    (cxRectHeight(Bounds) - 2 * cxEventBorderWidth - AImageHeight) div 2);
  if AIsAbsolute then
    Inc(Result, Bounds.Top + cxEventBorderWidth);
end;

function TcxSchedulerTimeGridViewEventCellCustomViewInfo.
  GetNonDetailEventImagesTopOffset: Integer;
begin
...
begin
  ...
  else if not ShowTimeAsClock then
    inherited CalculateCaptions;
end;
...
begin
  ...
  else if IsHeaderEvent then
  begin
    ViewData.ShowFinishTime := (dxTimeOf(EventFinish) <> 0) and
      (ContentFinish <> EventFinish);
    ViewData.ShowStartTime := (dxTimeOf(EventStart) <> 0) and
      (ContentStart <> EventStart);
  end
  else
  begin
    ViewData.ShowFinishTime := (ContentFinish <> EventFinish) or
      (ContentStart <> EventStart);
...
begin
  ViewData.ShowTimeAsClock := ViewData.ShowTimeAsClock and
    not ViewData.AutoHeight;
end;
...
procedure TcxSchedulerTimeGridViewEventCellModernViewInfo.
...
begin
  inherited CalculateCaptions;
  FCaptionIsBold := True;
  FCaptionAndLocationCanPlaceOneLineOnly := IsHeaderEvent or
    not ViewData.AutoHeight;
...
procedure TcxSchedulerTimeGridViewEventCellModernViewInfo.CalculateCellBounds
...
procedure TcxSchedulerTimeGridViewEventCellModernViewInfo.
  CalculateHeaderEventNeededCaptionWidth(var AFullWidth, ACaptionOnlyWidth
  : Integer);
var
  AStyle: TFontStyles;
begin
...
function TcxSchedulerTimeGridViewEventCellModernViewInfo.
...
begin
  ...
  if cxRectIsNull(FCaptionRect) and cxRectIsNull(FLocationRect) then
    Result := Result + GetHorizontalImagesMessageAutoHeight
      (Bounds.Top + ScaleFactor.Apply(cxEventImagesGap) + Result)
  else
  begin
    if NeedCaptionVerticalCentering then
    begin
      if FShowMessage and FCaptionAndLocationCanPlaceOneLineOnly and
        (AImages.VisibleImageCount > 0) then
        Inc(Result, 2 * ScaleFactor.Apply(cxTextOffset - cxEventImagesOffset));
      Result := Max(Result, GetCaptionAutoHeight(CaptionRect) + 2 *
        ScaleFactor.Apply(cxTextOffset));
      if not FCaptionAndLocationCanPlaceOneLineOnly then
        FCaptionRect.Bottom := Max(FCaptionRect.Bottom,
          Bounds.Bottom - (FCaptionRect.Top - Bounds.Top));
    end
    else
      Result := Max(Result, LocationRect.Bottom - Bounds.Top +
        ScaleFactor.Apply(cxTextOffset));
    Result := Result + GetHorizontalImagesMessageAutoHeight
      (Bounds.Top + Result);
  end;
...
procedure TcxSchedulerTimeGridViewEventCellModernViewInfo.
  ...
  begin
    if not cxRectIsEmpty(ARect) then
      OffsetRect(ARect, FCaptionRect.Left - FTimeLineRect.Right -
        ATextOffset, 0);
  end;
...
var
  ATextOffset, ALeft, ACompressing, AFullCaptionWidth, ACaptionOnlyWidth,
    AVertOffset: Integer;
...
begin
  ...
  begin
    ...
    InternalCorrectStartContinueArrowAttributeRect(FStartContinueArrowRect,
      ATextOffset);
    InternalCorrectStartContinueArrowAttributeRect
      (FStartContinueArrowCaptionRect, ATextOffset);
    ...
    begin
      if ACanShowClock then
        FStartRect := cxRectOffset(R, ACaptionRect.Left +
          ScaleFactor.Apply(cxEventImagesOffset), AVertOffset)
      else
      begin
    ...
    begin
      if ACanShowClock then
        FFinishRect := cxRectOffset(R, ACaptionRect.Right - R.Right -
          ScaleFactor.Apply(cxEventImagesOffset), AVertOffset)
      else
      begin
    ...
    if (ShowStartTime or ShowFinishTime) and
      (AFullCaptionWidth > cxRectWidth(ACaptionRect)) and not GetForceShowClockInHeaderEvent
    then
    begin
    ...
    ACaptionRect.Left := GetHeaderEventCaptionLeft(ACaptionRect,
      AFullCaptionWidth);
...
var
  ...
  begin
    ...
    if AImages.TotalVisibleImageCount = 1 then
      AImagesRect := cxRectOffset(AImagesRect, 0,
        GetImagesVerticalOffset(AImages.ItemHeight, False));
...
begin
  ...
  if not NeedCaptionVerticalCentering and
    (AImages.ItemHeight > cxTextHeight(Canvas.Font, '0')) then
...
procedure TcxSchedulerTimeGridViewEventCellModernViewInfo.
  CalculateNonHeaderModernEventHorizontalImagesAutoHeight;
var
  AImagesRight, ADelta, ACaptionMinWidth, AImagesWidth,
...
begin
  AImages := TcxSchedulerEventImagesAccess(Images);
  FCaptionRect := GetNonDetailEventPossibleCaptionRect;
  if (FLocation <> '') and (AImages.ItemHeight > cxTextHeight(Canvas.Font, '0'))
  then
    Inc(FCaptionRect.Top);
  AEventImagesOffset := ScaleFactor.Apply(cxEventImagesOffset);
  AImagesRect := cxRectInflate(GetAvailableBounds,
  ...
  if (AImages.ForceVisibleWidth > 0) and
    (AImagesRect.Left + AImages.ForceVisibleWidth + AEventImagesOffset >
    CaptionRect.Right - cxTextWidth(Canvas.Font, '0')) then
  begin
  ...
  begin
    AImagesRight := AImagesRect.Left + AImages.ForceVisibleWidth +
      AEventImagesOffset;
    ...
    AImagesRect.Right := Min(AImagesRight, CaptionRect.Right -
      ACaptionMinWidth);
    AImagesWidth := AImages.CalculateSingleLineImages(AImagesRect);
    AImagesRect.Right := AImagesRect.Left + AImagesWidth;
    FCaptionRect.Left := Max(AImagesRect.Right + IfThen(AImagesWidth > 0,
      AEventImagesOffset), GetMessageRectLeft + GetMessageSeparatorLeftIndent);
...
begin
  ...
  begin
    ViewData.ShowStartTime := (dxTimeOf(EventStart) <> 0) and
      ((EventStart >= ViewData.ViewContentStart) or
      (DayOf(EventStart) = DayOf(ViewData.ViewContentStart)));
    ViewData.ShowFinishTime := (dxTimeOf(EventFinish) <> 0) and
      ((EventFinish <= ViewData.ViewContentFinish) or
      (DayOf(EventFinish) = DayOf(ViewData.ViewContentFinish)));
  end
  else
  begin
    ViewData.ShowStartTime := False;
...
begin
  ...
  if FCaptionAndLocationCanPlaceOneLineOnly then
    FLocationRect.Left := Min(CaptionRect.Left + cxTextWidth(Canvas.Font,
      Caption + ' '), FLocationRect.Right)
  else
  begin
    FLocationRect.Top := FRealCaptionBottom;
    Canvas.Font.Style := AStyle;
    FLocationRect.Bottom := FLocationRect.Top + GetLocationAutoHeight
      (FLocationRect);
  end;
  Canvas.Font.Style := AStyle;
end;
...
function TcxSchedulerTimeGridViewEventCellModernViewInfo.
  CanBeHeaderEventContinueArrows: Boolean;
begin
  Result := True;
end;

function TcxSchedulerTimeGridViewEventCellModernViewInfo.
  CheckAutoLayoutImagesSingleLineCaption(const ACaptionWidth, AAvailableWidth
  : Integer): Boolean;
begin
...
begin
  AImages := TcxSchedulerEventImagesAccess(Images);
  Inc(FCaptionRect.Left, AImagesWidth + IfThen(AImagesWidth > 0,
    ScaleFactor.Apply(cxEventImagesOffset)));
  if AFactuallyImagesRowCount = 1 then
  begin
    FCaptionRect.Bottom := Bounds.Bottom - ScaleFactor.Apply
      (cxEventImagesOffset);
    AImages.Offset(ScaleFactor.Apply(cxTextOffset),
      GetImagesVerticalOffset(AImages.ItemHeight, False));
  end;
end;
...
begin
  cxTextOut(Canvas.Canvas, Caption, FCaptionRect, GetCaptionFlags, 0, 0,
...
function TcxSchedulerTimeGridViewEventCellModernViewInfo.
  EnableModernSelection: Boolean;
begin
  Result := not ViewData.IsMilestone;
end;

function TcxSchedulerTimeGridViewEventCellModernViewInfo.
  GetAvailableBounds: TRect;
begin
  Result := Bounds;
...
function TcxSchedulerTimeGridViewEventCellModernViewInfo.
  GetBoundsWithoutTimeLineRect: TRect;
begin
  Result := Bounds;
...
function TcxSchedulerTimeGridViewEventCellModernViewInfo.GetCaptionFlags
  : Cardinal;
const
  AHorizontalAlignment: array [Boolean] of Cardinal = (CXTO_LEFT, CXTO_RIGHT);
  AFlags: array [Boolean] of Cardinal = (CXTO_TOP or CXTO_WORDBREAK or
    CXTO_EDITCONTROL or CXTO_EXPANDTABS, CXTO_CENTER_VERTICALLY or
    CXTO_WORDBREAK or CXTO_SINGLELINE or CXTO_END_ELLIPSIS);
begin
  Result := AHorizontalAlignment[UseRightToLeftAlignment] or
    AFlags[NeedCaptionVerticalCentering];
end;

function TcxSchedulerTimeGridViewEventCellModernViewInfo.GetCaptionFontStyle
  : TFontStyles;
begin
...
function TcxSchedulerTimeGridViewEventCellModernViewInfo.
  GetForceShowClockInHeaderEvent: Boolean;
begin
  Result := False;
end;
...
begin
  ...
  begin
    Result := cxRectInflate(Bounds, -ScaleFactor.Apply(cxTextOffset + 1),
...
begin
  Result := TdxTextMeasurer.TextWidthTO(Canvas.Font, ViewData.Caption,
    GetCaptionFontStyle);
  if FLocation <> '' then
...
function TcxSchedulerTimeGridViewEventCellModernViewInfo.
  GetNonHeaderEventRealCaptionBottom(const R: TRect): Integer;
begin
...
function TcxSchedulerTimeGridViewEventCellModernViewInfo.GetStartTextJustify
  : Cardinal;
begin
...
function TcxSchedulerTimeGridViewEventCellModernViewInfo.
  GetTimeLineRectBaseBounds: TRect;
begin
  Result := ClipRect;
end;

function TcxSchedulerTimeGridViewEventCellModernViewInfo.
  GetTimeLineRectRight: Integer;
begin
  Result := Max(ClipRect.Left, ViewData.Bounds.Left) +
    ScaleFactor.Apply(cxTimeLineWidth) + BorderSize;
  if ActualBorderColorIsNone then
    Dec(Result, BorderSize);
end;

function TcxSchedulerTimeGridViewEventCellModernViewInfo.GetViewStyle
...
function TcxSchedulerTimeGridViewEventCellModernViewInfo.
  MeasureAutoLayoutImagesLocationHeight(const R: TRect): Integer;
begin
...
function TcxSchedulerTimeGridViewEventCellModernViewInfo.
  NeedBorderAroundOfTimeLineRect: Boolean;
begin
  Result := True;
end;

function TcxSchedulerTimeGridViewEventCellModernViewInfo.
  NeedCaptionVerticalCentering: Boolean;
begin
...
begin
  Result := not HasLeftBorder and IsHeaderEvent and
    ((Event.Duration > 1) or (dxTimeOf(EventStart) <> 0) or
    (dxTimeOf(EventFinish) <> 0)) and
...
function TcxSchedulerTimeGridViewEventCellModernViewInfo.
  NeedLeftSizingHandler: Boolean;
begin
  Result := HasLeftBorder;
end;

function TcxSchedulerTimeGridViewEventCellModernViewInfo.
  NeedRightSizingHandler: Boolean;
begin
...
function TcxSchedulerTimeGridViewAdapter.GetPrintRange(Index: Integer)
  : TDateTime;
begin
...
function TcxSchedulerTimeGridViewContentCellViewInfo.GetViewStyle
  : TcxSchedulerViewStyle;
begin
  Result := svsClassic;
end;

procedure TcxSchedulerTimeGridViewContentCellViewInfo.SetBorderColor
  (const AResourceColor: Integer; AIsHourSeparator, AIsWorkTime: Boolean);
begin
  FIsHourSeparator := AIsHourSeparator;
  BorderColor := PainterHelper.GetSeparatorColor(AResourceColor,
    AIsHourSeparator, AIsWorkTime, GetViewStyle);
end;
...
function TcxSchedulerTimeGridViewModernContentCellViewInfo.GetViewStyle
  : TcxSchedulerViewStyle;
begin
  Result := svsModern;
end;
...
constructor TcxSchedulerTimeGridViewViewInfo.Create
  (AOwner: TcxSchedulerSubControl);
begin
  inherited Create(AOwner);
...
procedure TcxSchedulerTimeGridViewViewInfo.ChangeResourceShift(AResourceIndex,
  ADelta: Integer);
begin
  GetResourceViewShift(AResourceIndex).Shift :=
    GetResourceViewShift(AResourceIndex).Shift + ADelta;
  View.Changed;
end;

function TcxSchedulerTimeGridViewViewInfo.IsEventExpanded
  (AEvent: TcxSchedulerEvent): Boolean;
begin
  Result := True;
end;

function TcxSchedulerTimeGridViewViewInfo.AddContentCell(const ARect: TRect;
  const AStart: TDateTime; const AFinish: TDateTime; AResourceIndex: Integer)
  : TcxSchedulerContentCellViewInfo;
...
begin
  CreateCellInstance(ContentCellClass, ARect,
    StylesAdapter.GetContentParams(AStart, True, GetResourceItem),
  ...
  if not View.IsWorkTime(GetResourceItem, AStart) then
    AContentCell.FViewParams.Color := PainterHelper.GetContentColor
      (AContentCell.FViewParams.Color, False, ViewStyle);
  if not HiddenSelection and IsTimeSelected(AContentCell.TimeStart,
    GetResourceViewInfo) then
...
procedure TcxSchedulerTimeGridViewViewInfo.AddEventForCalculation
  ...
  begin
    APlace := ABuilder.AddEventPlace(AEvent, AStartCol, AFinishCol, 1,
      TObject(AResourceIndex));
  ...
  begin
    ...
    begin
      mid := L + (H - L) shr 1;
      AStart := TcxSchedulerTimeGridSelectionBarCell(FTimeLineCells[mid])
        .TimeStart;
      AFinish := TcxSchedulerTimeGridSelectionBarCell(FTimeLineCells[mid])
        .TimeFinish;
      if AEventStart < AStart then
        cmp := 1
      else if AEventStart >= AFinish then
        cmp := -1
      else
        cmp := 0;
      if cmp < 0 then
...
begin
  if not IsEventVisible(AEvent) then
    Exit;
  if not Adapter.IsPrinting and ((AEvent.Finish <= View.VisibleStart) and
    not IsColumnEvent(AEvent, FirstVisibleIndex)) or
    (AEvent.Start >= FLastVisibleTime) then
  begin
    if not View.CheckEventsVisibility then
      if AEvent.Start >= FLastVisibleTime then
        AddEventPlace(Bounds.Right + Delta, Bounds.Right + Delta + 1,
  ...
  begin
    ...
    begin
      ...
      begin
        CalculateEventPosition(AEvent, AColumnIndex, AStartCol, AFinishCol,
          AStart, AFinish);
...
procedure TcxSchedulerTimeGridViewViewInfo.AddEventsForCalculation
  (ABuilder: TcxSchedulerEventLayoutBuilder);
var
  AEventIndex: Integer;
  I: Integer;
...
begin
  ...
  FEventUniqueResourceIDsMap :=
    TObjectDictionary<TcxSchedulerEvent, TdxVariantList>.Create([doOwnsValues]);
  try
    ...
    begin
      ...
      begin
        ...
        begin
          ForEachEventUniqueResourceIDs(AEvent, AShowEventsWithoutResource,
            AHasNullResourceID, procedure(AResourceIndex: Integer)
            begin
              AddEventForCalculation(ABuilder, AEvent,
                Resources[AResourceIndex].ResourceItem, AResourceIndex);
            end);
        end;
      end;
    end;
...
begin
  ...
  ABounds := cxRect(APlace.ColStart, AVisibleBounds.Top + IndentBetweenLines,
    APlace.ColFinish, AVisibleBounds.Top + IndentBetweenLines +
    FContentLineHeight);
  if Adapter.IsPrinting then
    Inc(ABounds.Left);
  ...
  AViewData.ShowTimeAsClock := AViewData.ShowTimeAsClock and
  ...
  begin
    ...
    APlace.LineFinish := Max(0, (I div (ContentLineHeight +
      {$IFDEF DELPHIXE8}ScaleFactor.Apply{$ENDIF}(cxTextOffset))) - 1);
    if (I mod ContentLineHeight > 0) then
      Inc(APlace.LineFinish);
    if View.EventMaxLineCount > 0 then
      APlace.LineFinish := Min(View.EventMaxLineCount,
        APlace.LineFinish + 1) - 1;
  end;
end;

procedure TcxSchedulerTimeGridViewViewInfo.AddMajorScaleCell(ABounds: TRect;
const AStart, AFinish: TDateTime);
var
...
begin
  ...
  AddTimeLineItem(TcxSchedulerTimeGridMajorScaleCell, ABounds, 0, AStart,
    AFinish, View.Styles.GetMajorScaleParams(AStart), AItem);
...
begin
  Dec(ALeft);
  ARect := cxRect(ALeft, Bounds.Top, ALeft + FSeparatorWidth, Bounds.Bottom);
  CreateCellInstance(TcxSchedulerMajorSeparatorCellViewInfo,
    cxRectInflate(ARect, -1, 0), Bounds,
    View.Styles.GetMajorScaleUnitSeparatorParams,
    UseRightToLeftAlignment, ACell);
...
procedure TcxSchedulerTimeGridViewViewInfo.AddMinorScaleCell
  (const ABounds: TRect; const AStart, AFinish: TDateTime);
var
  AItem: TcxSchedulerTimeGridMinorScaleCell;
begin
  AddTimeLineItem(TcxSchedulerTimeGridMinorScaleCell, ABounds, 1, AStart,
    AFinish, View.Styles.GetMinorScaleParams(AStart), AItem);
  AItem.Borders := [bBottom];
  if Adapter.IsPrinting or (Scales.MajorUnitSeparatorWidth = 0) and
    (Scales.MajorUnit = suDay) then
  begin
    if TimeBuilder.IsPeriodChanged(AFinish,
      TimeBuilder.CalculateDateTime(AFinish, 2)) then
...
function TcxSchedulerTimeGridViewViewInfo.AddSelectionBarCell
  (const ABounds: TRect; const AStart, AFinish: TDateTime)
  : TcxSchedulerTimeGridSelectionBarCell;
begin
  AddTimeLineItem(TcxSchedulerTimeGridSelectionBarCell, ABounds, 2, AStart,
    AFinish, View.Styles.GetSelectionBarParams(AStart), Result);
...
AType: Byte; const AStart, AFinish: TDateTime; const AViewParams: TcxViewParams;
var Instance);
var
  ACell: TcxSchedulerTimeGridMinorScaleCell;
begin
  CreateCellInstance(AClass, ABounds, FScalesBounds, AViewParams,
    UseRightToLeftAlignment, Instance);
  ...
  if not ACell.Visible and Adapter.IsPrinting and
    (AClass = TcxSchedulerTimeGridSelectionBarCell) then
  begin
    if cxRectIntersect(cxRectInflate(ABounds, 0, 1),
      cxRectInflate(FScalesBounds, 0, 1)) then
      ACell.FVisible := True;
  end;
end;
...
var
  ...
  const
    RevertTypes: array [TcxSchedulerTimeGridScaleTextType]
      of TcxSchedulerTimeGridScaleTextType = (sttLong, sttUnknown, sttShort,
      sttMiddle);
  var
    S: string;
  begin
    ...
    if (ATextType <> sttShort) and
      (cxTextWidth(ACell.Font, S) > (cxRectWidth(ACell.Bounds) - cxTextOffset
      * 2)) then
    begin
...
begin
  ...
  begin
    ...
    begin
      ...
      AContentCell.SetBorderColor(AColor, IsMinorUnitBreak(J + 1),
...
var
  ...
  begin
    ...
    while (AEventFinish > ALast) or
      ((AEventStart = ALast) and View.SnapEventsToTimeSlots) do
    begin
      AStartValue := ALast;
      APrevFinish := ALast;
      ...
      ALast := TimeBuilder.CalculateDateTimeDateTimeWithoutCheckWorkDays
        (AFirst, 1);
      if (ARoundedEventFinish < ALast) and (ARoundedEventFinish > AFirst) and
        TimeBuilder.IsPeriodChanged(APrevFinish, AFirst) then
      begin
      ...
      begin
        AFinish := ALast;
        if (ARoundedEventFinish > ALast) and TimeBuilder.IsPeriodChanged
          (AStartValue, ALast) then
        begin
          Inc(AFinishX, FSeparatorWidth - 1);
          Inc(AFinishCellRight, FSeparatorWidth - 1);
        end;
    ...
    if not View.IsSnapEventsToTimeSlots and (ARoundedEventFinish <= AActualLast)
    then
    begin
      AFinishX := GetActualPos(AFinishX - FColumnWidth, ARoundedEventFinish,
        TimeBuilder.CalculateDateTimeDateTimeWithoutCheckWorkDays(AActualLast,
        -1), AActualLast);
    end;
  ...
  begin
    ...
    begin
      AStartX := GetActualPos(AStartX, ARoundedEventStart, AFirst,
        TimeBuilder.Inc(AFirst));
      Exit;
    end;
    ABreak := False;
    ...
    begin
      ...
      AFirstWithoutCheckWorkDays :=
        TimeBuilder.CalculateDateTimeDateTimeWithoutCheckWorkDays(AFirst, -1);
      AIsWorkDays := AFinish <> AFirstWithoutCheckWorkDays;
      ACorrected := TimeBuilder.TimeCorrected(AFirst, ALast, False);
      if (ARoundedEventStart <= AFirst) or
        ((ARoundedEventStart > AFirst) and (ARoundedEventStart < ALast) and
      ...
      begin
        ...
        begin
          ...
          AStart := AFirst;
        if not TimeBuilder.IsPeriodChanged(AFirst, ALast) or
          (ARoundedEventStart <
          TimeBuilder.CalculateDateTimeDateTimeWithoutCheckWorkDays(AFirst, 1))
        then
          AStartX := AStartX - FColumnWidth;
      end;
      if not View.IsSnapEventsToTimeSlots and (ARoundedEventStart >= AFirst) and
        not AIsWorkDays and not ACorrected then
        AStartX := GetActualPos(AStartX, ARoundedEventStart, AFirst, ALast);
      if TimeBuilder.IsPeriodChanged(AFirst, ALast) and
        (ARoundedEventStart <= AFirst) and not AIsWorkDays then
...
begin
  ...
  begin
    FResourceMap := CreateResourceMap;
    FEventUniqueResourceIDsMap :=
      TObjectDictionary<TcxSchedulerEvent, TdxVariantList>.Create
      ([doOwnsValues]);
    try
  ...
  try
    ...
    begin
      ...
      TcxSchedulerControlEventAccess(ABuilder.EventPlaces[I].Event)
        .VisibleIndex := I;
    end;
...
begin
  ...
  with Bounds do
    FScalesBounds := cxRect(Left + FResourceHeaderWidth, Top, Right,
      Top + FScalesHeight);
...
begin
  ...
  AddResourceHeader(-1, cxRectSetSize(Bounds, ResourceHeaderWidth,
    FScalesHeight));
  for I := 0 to ResourceCount - 1 do
  begin
    CalculateResourceTopBottom(I, R);
...
begin
  ...
  begin
    FMajorScaleHeight := MeasureFontHeight(View.Styles.MajorScale, -1,
      [bBottom]);
    if not Scales.Major then
      FMajorScaleHeight := 0;
    FMinorScaleHeight := MeasureFontHeight(View.Styles.MinorScale, -1,
      [bBottom]);
    if not Scales.Minor then
      FMinorScaleHeight := 0;
    FSelectionBarHeight := MeasureFontHeight(View.Styles.SelectionBar, -1,
      [bBottom]);
    FSelectionBarHeight := Max(ScaleFactor.Apply(cxMinSelectionBarHeight),
      Round(FSelectionBarHeight / 1.5));
  end;
...
begin
  if not IsEventCellLayoutCalculatingLocked then
    ...
    for I := 0 to Buttons.Count - 1 do
      TcxSchedulerCustomViewInfoItemAccess(Buttons[I])
        .AllowRightToLeftConversion := False;
end;
...
function TcxSchedulerTimeGridViewViewInfo.ContentCellClass
...
function TcxSchedulerTimeGridViewViewInfo.CreateLayoutBuilder
  : TcxSchedulerEventLayoutBuilder;
begin
  Result := TcxSchedulerEventLayoutBuilder.Create(svsClassic);
end;

function TcxSchedulerTimeGridViewViewInfo.CreateResourceMap
  : TdxNamedObjectDictionary<TdxIntegerList>;
var
  I: Integer;
...
procedure TcxSchedulerTimeGridViewViewInfo.
  ...
  : TcxSchedulerEventCellViewInfo);
begin
  TcxSchedulerEventCellViewInfoAccess(AEventCell).ViewData.ViewParams :=
    StylesAdapter.GetEventParams(AEventCell.Event);
end;
...
begin
  ATimeGridButtonViewInfo :=
    TcxSchedulerTimeGridMoreEventsButtonViewInfo(Sender);
...
begin
  ResourceViewShift[(Sender as TcxSchedulerTimeGridScrollBarWrapper)
    .ResourceIndex].FShift := -ScrollPos;
  View.Changed;
end;

function TcxSchedulerTimeGridViewViewInfo.DoSetResourceHasVisibleEvent
  (AEvent: TcxSchedulerControlEvent): Boolean;
var
...
function TcxSchedulerTimeGridViewViewInfo.EventCellClass
...
begin
  ...
  if (AEvent.Duration < 1) and View.WorkTimeOnly and
    ((dxTimeOf(AEventFinish) < View.WorkStart) and
    (dxTimeOf(AEventStart) > View.WorkFinish)) then
    Exit;
  AStart := TcxSchedulerTimeGridSelectionBarCell(FTimeLineCells[AColumnIndex])
    .TimeStart;
  AFinish := TcxSchedulerTimeGridSelectionBarCell(FTimeLineCells[AColumnIndex])
    .TimeFinish;
  if Scales.MinorUnit = suDay then
    Result := AEvent.IsDayEvent(Trunc(AStart))
  else if Scales.MinorUnit > suDay then
    Result := ((AEventFinish > AStart) and (AEventStart < AFinish)) or
      ((AEventFinish = AStart) and (AEvent.Duration = 0))
  else if AEventFinish = AEventStart then
  ...
  begin
    ...
    else if AEventFinish = AStart then
...
begin
  ...
  if TcxSchedulerTimeGridViewController(View.Controller).ConsiderHiddenEvents or
    (Events.Clones.Count = 0) or (not FHideClones and not FHideSource) then
    Exit;
  if AEvent.IsClone then
    Result := not FHideClones
  else if FHideSource then
  begin
    Result := True;
...
function TcxSchedulerTimeGridViewViewInfo.IsMinorUnitBreak
...
begin
  ...
  begin
    ...
    if not Result then
    begin
      Result := not IsHourEqual(TcxSchedulerTimeGridSelectionBarCell
        (FTimeLineCells[AColumn - 1]).TimeStart,
        TcxSchedulerTimeGridSelectionBarCell(FTimeLineCells[AColumn])
        .TimeStart);
    end;
  end;
end;

function TcxSchedulerTimeGridViewViewInfo.IsMilestone
  (AEvent: TcxSchedulerControlEvent): Boolean;
begin
  Result := False;
end;

function TcxSchedulerTimeGridViewViewInfo.GetActualPos(const APos: Integer;
const ATime, AStart, AFinish: TDateTime): Integer;
begin
  Result := APos;
  if DateTimeHelper.RoundTime(ATime) >= DateTimeHelper.RoundTime(AFinish) then
    Inc(Result, FColumnWidth)
  else if (ATime > AStart) and (ATime < AFinish) then
    Result := APos + Round((ATime - AStart) * FColumnWidth /
      (AFinish - AStart));
end;

function TcxSchedulerTimeGridViewViewInfo.GetEventClipRect(AEventViewInfo
  : TcxSchedulerEventCellViewInfo): TRect;
var
  I: Integer;
...
begin
  ...
  Result := cxRect(Bounds.Left + ResourceHeaderWidth, ScalesHeight,
    Bounds.Right, Bounds.Bottom);
  ...
  else if not TcxCustomSchedulerAccess(Scheduler).IsPopupScrollBars and
    (ResourceViewShiftList.Count > 0) then
    Dec(Result.Right, GetScaledScrollBarSize(ScaleFactor).cx);
end;

function TcxSchedulerTimeGridViewViewInfo.GetGroupingKind
...
procedure TcxSchedulerTimeGridViewViewInfo.GetItemInfo(AIndex1, AIndex2, ATop,
  AHeight: Integer; var ABounds: TRect; var AStart, AFinish: TDateTime);
begin
...
function TcxSchedulerTimeGridViewViewInfo.GetMoreEventButtonClass
...
function TcxSchedulerTimeGridViewViewInfo.GetResourceScrollBarMax
  (I: Integer): Integer;
begin
  Result := -1;
...
function TcxSchedulerTimeGridViewViewInfo.GetResourceScrollBarKind
  : TScrollBarKind;
begin
  Result := sbVertical;
end;
...
begin
  Result := inherited GetShowEventsWithoutResource or
    View.TreeBrowser.ActuallyVisible;
end;
...
begin
  ...
  else if ATime > View.VisibleFinish then
  begin
...
function TcxSchedulerTimeGridViewViewInfo.MeasureFontHeight(AStyle: TcxStyle;
AHeight: Integer; Borders: TcxBorders): Integer;
begin
  Result := AHeight;
  if Result = -1 then
...
procedure TcxSchedulerTimeGridViewViewInfo.Realign
  (APlace: TcxSchedulerEventPlace);

  function GetButton(AColumnIndex: Integer; IsDown: Boolean)
    : TcxSchedulerMoreEventsButtonViewInfo;
  begin
    Result := GetResourceViewShift(Integer(APlace.Resource)).FMoreEventButtons
      [AColumnIndex * 2 + IfThen(IsDown, 1)];
  end;
  ...
  begin
    Result := View.ExternalPainter.MoreButtonSize
      ...
      PainterHelper.MoreButtonHeight), ScaleFactor).cy;
  end;
  ...
  begin
    ...
    if (AColumnIndex < 0) or
      (AColumnIndex * 2 >= Length(GetResourceViewShift(Integer(APlace.Resource))
      .FMoreEventButtons)) then
      Exit;
    ADelta := 0;
    ...
    else if AnEventLineIndex >= ALineCount then
    begin
    ...
    if ADelta <> 0 then
    begin
      AButton := GetButton(AColumnIndex, ADownDirection)
        as TcxSchedulerTimeGridMoreEventsButtonViewInfo;
      if AButton = nil then
      begin
        AButton := AddButton(AColumnIndex, R, ADateTime, ADownDirection,
          APlace.Event) as TcxSchedulerTimeGridMoreEventsButtonViewInfo;
        AButton.FVisible := IsVisible;
        AButton.Delta := ADelta;
        AButton.ResourceIndex := Integer(APlace.Resource);
        GetResourceViewShift(Integer(APlace.Resource)).FMoreEventButtons
          [AColumnIndex * 2 + IfThen(ADownDirection, 1)] := AButton;
      end
      else if CanChangeDelta and ((Abs(AButton.Delta) < Abs(ADelta)) or
        not AButton.ValidDelta) then
        AButton.Delta := ADelta;
...
begin
  ...
  AnEventLineIndex := APlace.LineStart + GetResourceViewShift
    (Integer(APlace.Resource)).FShift - FLineOffset;
  ...
  if (ViewStyle = svsClassic) and not View.IsSnapEventsToTimeSlots and
    not AViewData.IsMilestone then
  ...
  begin
    ...
    begin
      if not Adapter.IsPrinting and ((AButtonRect.Left >= AClipRect.Left) and
        (AButtonRect.Right <= AClipRect.Right)) then
      begin
        AddMoreEventButton(AnEventLineIndex, ALineCount, AButtonRect,
          ACell.Event.Start,
...
procedure TcxSchedulerTimeGridViewViewInfo.ReturnVisibleInterval(var AStart,
  AEnd: TDateTime);
begin
...
begin
  ...
  begin
    ...
    begin
      FResourceViewShiftChanged := FResourceViewShiftChanged or
        (AResourceViewShift.FShift <> 0);
      AResourceViewShift.FShift := 0;
      AResourceViewShift.HideScrollBar;
    end
    else if TcxSchedulerTimeGridView(Owner).ShowResourceScrollBar then
...
var
  I: Integer;
begin
  if FResourceViewShift = nil then
    Exit;
  for I := 0 to FResourceViewShift.Count - 1 do
...
begin
  ...
  begin
    ...
    if not Adapter.IsPrinting then
      View.Controller.Navigation.ReplaceSelParams(View.FVisibleStart,
        View.FVisibleStart, View.Scheduler.SelResource)
  end;
  FActualStartTime := FTimeBuilder.ValidateStartTime(Adapter.ActualStart);
  FTimeBuilder.CalculateActualStart(FActualStartTime, View.FVisibleStart,
    FFirstVisibleIndex);
  if not Adapter.IsPrinting then
  begin
    SelectedDays.Clear;
    SelectedDays.Add(View.FVisibleStart);
    TcxSchedulerTimeGridViewAdapter(Adapter).FVisibleStart :=
      View.FVisibleStart;
  end;
end;
...
procedure TcxSchedulerTimeGridViewViewInfo.CalculateResourceViewShifts
  ...
  begin
    ...
    for I := 0 to ABuilder.EventPlaceCount - 1 do
      ...
      begin
        Result := TcxSchedulerEventCellViewInfo(ABuilder.EventPlaces[I].Data)
          .EventViewData.VisibleRect;
  ...
  begin
    ...
    begin
      ...
      GetResourceViewShift(AResourceIndex)
        .SetEventMaxLine(ABuilder.EventPlaces[I].LineStart);
    end;
  end;
...
procedure TcxSchedulerTimeGridViewViewInfo.ForEachEventUniqueResourceIDs
  (AEvent: TcxSchedulerControlEvent; AShowEventsWithoutResource,
  AHasNullResourceID: Boolean;
const AFunc: TcxSchedulerForEachForEventUniqueResourceIDsFunc);
var
  AResourceIndex: Integer;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if not AIsIDEmpty or AEvent.IsResourceEvent
          (Resources[AResourceIndex].ResourceItem, AShowEventsWithoutResource)
        then
...
function TcxSchedulerTimeGridViewViewInfo.GetEventUniqueResourceIDs
  (AEvent: TcxSchedulerControlEvent; ANeedAddNull: Boolean = False)
  : TdxVariantList;
var
  I: Integer;
begin
...
begin
  Result := Max(0, Bounds.Bottom - Bounds.Top - SeparatorWidth *
    (ResourceCount - 1) - ScalesHeight);
end;

function TcxSchedulerTimeGridViewViewInfo.GetResourceViewShift(Index: Integer)
  : TcxSchedulerTimeGridResourceScroll;
begin
  if ResourceCount = 0 then
    Index := 0;
...
function TcxSchedulerTimeGridViewViewInfo.GetTimeGridView
  : TcxSchedulerTimeGridView;
begin
  Result := TcxSchedulerTimeGridView(inherited View);
end;

function TcxSchedulerTimeGridViewViewInfo.GetVisibleLineCount
...
begin
  ...
  begin
    AFinish := TcxSchedulerTimeGridSelectionBarCell(FTimeLineCells[I])
      .TimeStart;
    if TimeBuilder.IsPeriodChanged(AStart, AFinish) or (I = ColumnCount) then
    begin
      APrevFinish := AFinish;
      GetItemInfo(AIndex, I - 1, FBounds.Top, FMajorScaleHeight, R,
        AStart, AFinish);
...
begin
  AIndex := 0;
  AStart := ActualStartTime;
  ALeft := Bounds.Left + FResourceHeaderWidth - FColumnWidth *
    FirstVisibleIndex;
  ASelBounds := cxRectSetBottom(Bounds, Bounds.Top + FScalesHeight,
    FSelectionBarHeight);
  ...
  repeat
    ...
    if (AIndex >= FirstVisibleIndex) and ((ALeft + FColumnWidth) <= Bounds.Right)
    then
    ...
    Inc(AIndex);
    if (AIndex > FirstVisibleIndex) and TimeBuilder.IsPeriodChanged(AStart,
      AFinish) then
      AddMajorSeparator(ALeft);
    AStart := AFinish;
...
procedure TcxSchedulerTimeGridScaleCell.DoRightToLeftConversion
...
begin
  ...
  begin
    ...
    if (MinuteOf(TimeFinish) = 0) or AHasBorder then
      Canvas.FrameRect(Bounds, clBtnShadow, 1,
        ABorders[UseRightToLeftAlignment])
    else
      Canvas.FrameRect(Rect(Bounds.Left, Bounds.Bottom - cxTextOffset * 2,
        Bounds.Right, Bounds.Bottom - 1), clBtnShadow, 1,
        ABorders[UseRightToLeftAlignment]);
  end;
end;

procedure TcxSchedulerTimeGridMinorScaleCell.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited DoRightToLeftConversion(AClientBounds);
...
const
  Horz: array [TAlignment] of Integer = (CXTO_LEFT, CXTO_RIGHT,
...
var
  ...
  R: TRect;
begin
  FExternalPainter.DrawTimeGridHeader(Canvas, BorderColor, Self, Borders,
    IsSelected);
...
begin
  inherited InitHitTest(AHitTest);
  TcxSchedulerTimeGridViewHitTest(AHitTest).SetHitTime(htcMinorScale,
    TimeStart);
end;
...
begin
  inherited InitHitTest(AHitTest);
  TcxSchedulerTimeGridViewHitTest(AHitTest).SetHitTime(htcMajorScale,
    TimeStart);
end;
...
begin
  ACurrentTime := Now;
  FIsCurrentTimeCell := (ACurrentTime >= TimeStart) and
    (ACurrentTime < TimeFinish);
...
begin
  inherited InitHitTest(AHitTest);
  TcxSchedulerTimeGridViewHitTest(AHitTest).SetHitTime(htcSelectionBar,
    TimeStart);
end;
...
begin
  ...
  Canvas.FrameRect(ContentBounds, Painter.DefaultSchedulerBorderColor, 1,
    [bLeft, bRight]);
end;

procedure TcxSchedulerMajorSeparatorCellViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
  inherited DoRightToLeftConversion(AClientBounds);
...
begin
  inherited InitHitTest(AHitTest);
  TcxSchedulerTimeGridViewHitTest(AHitTest)
    .SetBitState(htcMajorSeparator, True);
end;
...
begin
  case TcxSchedulerTimeGridMinorScaleCell(AItem).ItemType of
    0:
      View.DoDrawTimeLineHeaderCell(TcxSchedulerTimeGridMajorScaleCell
        (AItem), ADone);
    1:
      View.DoDrawTimeLineCell(TcxSchedulerTimeGridMinorScaleCell(AItem), ADone);
    2:
      View.DoDrawSelectionBarCell(TcxSchedulerTimeGridSelectionBarCell
        (AItem), ADone);
  end;
end;

function TcxSchedulerTimeGridViewPainter.GetViewInfo
  : TcxSchedulerTimeGridViewViewInfo;
begin
  Result := TcxSchedulerTimeGridViewViewInfo(inherited ViewInfo);
end;
...
procedure TcxSchedulerTimeBuilder.CalculateActualStart(var ActualStart,
  AVisibleStart: TDateTime; var AStartIndex: Integer);
var
  AStart: TDateTime;
begin
  AStartIndex := 0;
...
procedure TcxSchedulerTimeBuilder.CheckWorkDays(var ADateTime: TDateTime;
AGoForward: Boolean);
begin
  if MinorUnit > suDay then
    Exit;
...
function TcxSchedulerTimeBuilder.IsPeriodChanged(const AFirst,
  ANext: TDateTime): Boolean;
begin
  Result := False;
  case MajorUnit of
    suDay:
...
function TcxSchedulerTimeBuilder.TimeCorrected(var AStart, AFinish: TDateTime;
AGoForward: Boolean = True): Boolean;
begin
...
function TcxSchedulerTimeBuilder.CalculateDateTime(const ADateTime: TDateTime;
AInc: Integer): TDateTime;
begin
...
begin
  ...
  begin
    ...
    if (ATimeInc = 1) and CheckTime and
      (Abs(Trunc(ADateTime) - Trunc(Result)) >= 1) then
      ATimeInc := 0;
    if CheckMidnight then
      ValidateMidnightForward(Result);
  end
  else if MinorUnit <= suWeek then
...
function TcxSchedulerTimeBuilder.CalculateScaleUnit(const AScaleUnit
  : Integer): Integer;
const
  TimeScales: array [TcxSchedulerTimeGridScaleUnit] of Integer = (1, 1, 7,
    1, 3, 12);
begin
  Result := AScaleUnit;
...
var AWorkStart, AWorkFinish: TDateTime);
  ...
  begin
    ...
    Result := RoundTime(DateOf(ADateTime) + Round(TimeOf(ADateTime) / AScale)
      * AScale);
  end;
...
begin
  ...
  CheckTime := (dxTimeOf(WorkStart) > 0) or (dxTimeOf(WorkFinish) < AMidnight)
    and (MinorUnit = suHour);
...
procedure TcxSchedulerTimeBuilder.CalculateWorkDays(AIsWorkDaysOnly: Boolean;
var AWorkDays: TDays);
const
...
function TcxSchedulerTimeBuilder.RoundTime(const ADateTime: TDateTime)
  : TDateTime;
begin
  Result := DateTimeHelper.RoundTime(ADateTime);
end;

function TcxSchedulerTimeBuilder.ValidateStartTime(const ADateTime: TDateTime)
  : TDateTime;
begin
  Result := ADateTime;
  if CheckTime then
  begin
    ...
    else if (RoundTime(dxTimeOf(Result)) < WorkStart) then
      Result := Trunc(Result) + WorkStart
  end;
  ValidateVisibleStart(Result);
end;

function TcxSchedulerTimeBuilder.ValidateTime(var ADateTime: TDateTime;
AGoForward: Boolean; AInc: Integer = 1): Boolean;
var
...
procedure TcxSchedulerTimeBuilder.ValidateUnits(var AMajorUnit,
  AMinorUnit: TcxSchedulerTimeGridScaleUnit);
var
...
procedure TcxSchedulerTimeBuilder.ValidateVisibleStart(var ADateTime
  : TDateTime);
begin
  case MinorUnit of
    suHour:
      begin
        ADateTime := Trunc(ADateTime) +
          (Round(dxTimeOf(ADateTime) / MinuteToTime) div TimeScale * TimeScale)
          * MinuteToTime;
      end;
    suDay:
      ADateTime := Trunc(ADateTime);
    suWeek:
      begin
        ADateTime := Trunc(ADateTime);
        while Byte(DayOfWeek(ADateTime)) <> 1 do
          ADateTime := ADateTime - 1;
      end;
    suMonth:
...
constructor TcxSchedulerTimeGridResourceScroll.Create(ATimeGridView
  : TcxSchedulerTimeGridView; AResourceIndex: Integer);
begin
  inherited Create;
  FView := ATimeGridView;
...
procedure TcxSchedulerTimeGridResourceScroll.SetScrollBarParams
  (ATimeGridView: TcxSchedulerTimeGridView; AResourceIndex: Integer);
var
  AHeight, AWidth, ALeft: Integer;
  ABounds: TRect;
begin
  ScrollBar.LargeChange := ATimeGridView.ViewInfo.GetVisibleLineCount
    (AResourceIndex);
  ScrollBar.SetScrollParams(0, FEventMaxLine, -Shift,
    ScrollBar.LargeChange, False);
...
begin
  Result := TcxCustomSchedulerAccess(FView.Scheduler)
    .GetHybridScrollbarBaseColor;
end;

function TcxSchedulerTimeGridResourceScroll.GetManager
...
begin
  if ((FScrollBar = nil) or (Abs(AValue) <= ScrollBar.Max)) and (AValue <= 0)
  then
    FShift := AValue;
end;
