...
uses
  ...
  dxRibbonSkins, dxForms, cxGraphics, cxControls, cxLookAndFeels,
  cxLookAndFeelPainters, cxPC, cxButtons,
  cxContainer, cxEdit, cxImage;

const
  dxRibbonFormWizardResType = 'DXWIZARDTEMPLATES';
  dxRibbonStyleNamePrefixMap: array [TdxRibbonStyle] of string = ('2007',
    '2010', '2013', '2016', '2016Tablet', '2019');
  dxRibbonStyleDisplayNameMap: array [TdxRibbonStyle] of string =
    ('Office 2007', 'Office 2010', 'Office 2013', 'Office 2016',
    'Office 2016 Tablet', 'Office 2019');
...
type
  ...
  public
    property SelectedRibbonStyle: TdxRibbonStyle read GetSelectedRibbonStyle
      write SetSelectedRibbonStyle;
  end;

function ExecuteSelectRibbonStyleDialog(var ARibbonStyle: TdxRibbonStyle;
  const ACaption, APrompt: string): Boolean;
...
procedure TfrmRibbonFormWizard.SetSelectedRibbonStyle
  (const Value: TdxRibbonStyle);
begin
...
begin
  ...
  begin
    ...
    try
      AImage.LoadFromResource(HInstance, 'RIBBON' + dxRibbonStyleNamePrefixMap
        [SelectedRibbonStyle] + 'PREVIEW', dxRibbonFormWizardResType);
