...
type
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader; AOffset: Integer;
      ASize: Integer): TdxDocFieldTable; static;
    ...
    procedure AddEntry(ACharacterPosition: Integer;
      const AFieldDescriptor: IdxDocFieldDescriptor);
  ...
  strict private
    class var FUnsupportedFieldCodes: TdxStringList;
  ...
  public
    ...
    procedure Reset;
    function GetFieldObjects(ADocObjects: TdxDocObjectCollection)
      : TStack<IdxDocObject>;
  ...
  protected
    ...
    function ShouldNormalizeFields(ADocObjects: TdxDocObjectCollection)
      : Boolean;
    procedure NormalizeFieldsCore(ADocObjects: TdxDocObjectCollection); virtual;

    property OwnsDestination: Boolean read FOwnsDestination
      write FOwnsDestination;
  public
    constructor Create(AThreshold: Integer;
      ADestination: TdxDocObjectCollection); overload; virtual;
    ...
    property Destination: TdxDocObjectCollection read FDestination
      write SetDestination;
    property FieldIterator: TdxDocFieldsIterator read FFieldIterator
      write SetFieldIterator;
  end;
  ...
  public
    constructor Create(AThreshold: Integer;
      ...
      APositions: TdxDocHeadersFootersPositions);
  ...
  protected
    ...
    function GetPositions(AReader: TBinaryReader; AFib: TdxFileInformationBlock)
      : TdxIntegerList; virtual; abstract;
    function GetPositionsCore(AReader: TBinaryReader; AOffset: Integer;
      ASize: Integer): TdxIntegerList;
  ...
  public
    constructor Create(AThreshold: Integer;
      ...
      AReferences: TdxIntegerList; AReader: TBinaryReader;
      AFib: TdxFileInformationBlock);
    destructor Destroy; override;

    property CompositeObjects: TdxDocObjectCollectionDictionary
      read FCompositeObjects;
  end;
  ...
  TdxTextBoxesIteratorStateBase = class abstract
    (TdxCompositeObjectIteratorState)
  protected
  ...
  protected
    procedure ReadFileShapeAddresses(AReader: TBinaryReader;
      AFib: TdxFileInformationBlock);
    procedure ReadTextBoxReferences(AReader: TBinaryReader;
      AFib: TdxFileInformationBlock);
    procedure ReadTextBoxBreakDescriptors(AReader: TBinaryReader;
      AFib: TdxFileInformationBlock);
    function ReadTextBoxReferencesCore(AReader: TBinaryReader; AOffset: Integer;
      ASize: Integer): TdxIntegerList;
    ...
    property BlipsWithProperties: TdxBlipsWithProperties
      read GetBlipsWithProperties;
    property TextBoxReferences: TdxIntegerList read GetTextBoxReferences;
    property HeaderDocumentTextBoxReferences: TdxIntegerList
      read FHeaderDocumentTextBoxReferences;
    property MainDocumentTextBoxReferences: TdxIntegerList
      read FMainDocumentTextBoxReferences;
    property HeaderDocumentTextBoxes: TdxDocObjectCollectionDictionary
      read FHeaderDocumentTextBoxes;
    property MainDocumentTextBoxes: TdxDocObjectCollectionDictionary
      read FMainDocumentTextBoxes;
    property HeaderDocumentTextBoxesBreakTable: TdxBreakDescriptorTable
      read FHeaderDocumentBreakDescriptors;
  public
    constructor Create(AReader: TBinaryReader; AFib: TdxFileInformationBlock;
      AArtContent: TdxOfficeArtContent;
      AFormatting: TdxFloatingObjectFormatting);
    destructor Destroy; override;
    function GetFloatingObject(ACharacterPosition: Integer;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer): TdxDocFloatingObjectBase;
    function GetBlip(APosition: Integer): TdxBlipBase;
    function GetFloatingObjectCore(AAddress: TdxFileShapeAddress;
      var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer): TdxDocFloatingObjectBase;
    ...
    property MainTextBoxesBreakTable: TdxBreakDescriptorTable
      read FMainDocumentBreakDescriptors;
  end;
  ...
  protected
    ...
    property HeadersFootersPositions: TdxDocHeadersFootersPositions
      read FHeadersFootersPositions;
  public
    constructor Create(AFib: TdxFileInformationBlock;
      AMainStreamReader: TBinaryReader; ATableStreamReader: TBinaryReader;
      AIterator: TdxDocContentIterator);
    destructor Destroy; override;
    ...
    function CreateFieldIterator(AStateType: TdxDocContentState)
      : TdxDocFieldsIterator;
  end;
  ...
  protected
    procedure GetReferences(AReader: TBinaryReader;
      AFib: TdxFileInformationBlock);
    function GetNoteReferencesCore(AReader: TBinaryReader; AOffset: Integer;
      ASize: Integer): TdxIntegerList;
  ...
  public
    ...
    function GetNoteObject(AInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer): IdxDocObject;
    function GetFootNoteObjects(ACharacterPosition: Integer)
      : TdxDocObjectCollection;
    function GetEndNoteObjects(ACharacterPosition: Integer)
      : TdxDocObjectCollection;
  ...
  protected
    ...
    property CurrentCharacterPosition: Integer read FCurrentCharacterPosition
      write FCurrentCharacterPosition;
    property MainDocumentLength: Integer read FMainDocumentLength
      write FMainDocumentLength;
    property FootNotesTextLength: Integer read FFootNotesTextLength
      write FFootNotesTextLength;
    property HeadersFootersTextLength: Integer read FHeadersFootersTextLength
      write FHeadersFootersTextLength;
    property CommentsTextLength: Integer read FCommentsTextLength
      write FCommentsTextLength;
    property EndNotesTextLength: Integer read FEndNotesTextLength
      write FEndNotesTextLength;
    property TextBoxesTextLength: Integer read FTextBoxesTextLength
      write FTextBoxesTextLength;
    property HeaderTextBoxesTextLength: Integer read FHeaderTextBoxesTextLength
      write FHeaderTextBoxesTextLength;
    ...
    property HeaderTextBoxesDocumentOrigin: Integer
      read GetHeaderTextBoxesDocumentOrigin;
  public
    constructor Create(ABuilder: TObject { TdxDocContentBuilder };
      AFib: TdxFileInformationBlock; AMainStreamReader: TBinaryReader;
      ATableStreamReader: TBinaryReader; AModel: TdxDocumentModel);
    destructor Destroy; override;
    procedure AddToGC(AObject: TObject);
    procedure SetTextStreamBorders(AFib: TdxFileInformationBlock);
    procedure InitializeIterators(AFib: TdxFileInformationBlock;
      AMainStreamReader: TBinaryReader; ATableStreamReader: TBinaryReader;
    ...
    procedure CheckFieldCompatibility(ADestination: TdxDocObjectCollection);
    function GetFloatingObject(var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer): TdxDocFloatingObjectBase;
    function GetNoteObject(var AObjectInfo: TdxDocObjectInfo;
      APropertyContainer: TdxDocPropertyContainer): IdxDocObject;
    function GetCurrentFieldType: TdxFieldType;
    procedure AdvancePosition(ALogPosition: TdxDocumentLogPosition;
      AOriginalPosition: Integer; ALength: Integer);
    ...
    property MainTextDocObjects: TdxDocObjectCollection
      read FMainTextDocObjects;
    ...
    property FloatingObjectsIterator: TdxDocFloatingObjectsIterator
      read FFloatingObjectsIterator;
    property NotesIterator: TdxDocNotesIterator read FNotesIterator;
    property PermissionsIterator: TdxDocRangeEditPermissionIterator
      read FPermissionsIterator;
...
class function TdxDocFieldTable.FromStream(AReader: TBinaryReader;
  AOffset: Integer; ASize: Integer): TdxDocFieldTable;
begin
  Result := TdxDocFieldTable.Create;
  Result.Read(AReader, AOffset, ASize);
end;

procedure TdxDocFieldTable.Read(AReader: TBinaryReader; AOffset: Integer;
  ASize: Integer);
var
  ACount, I: Integer;
begin
  AReader.BaseStream.Seek(AOffset, TSeekOrigin.soBeginning);
  ACount := (ASize - TdxDocConstants.CharacterPositionSize)
    div (TdxDocConstants.CharacterPositionSize + FieldDescriptorSize);
...
function TdxDocFieldTable.GetFieldDescriptorByIndex(AIndex: Integer)
  : IdxDocFieldDescriptor;
begin
...
procedure TdxDocFieldTable.AddEntry(ACharacterPosition: Integer;
  const AFieldDescriptor: IdxDocFieldDescriptor);
begin
...
constructor TdxDocFieldsIterator.Create(AReader: TBinaryReader;
...
function TdxDocFieldsIterator.MoveNext(APropertyContainer
  : TdxDocPropertyContainer): Boolean;
var
...
procedure TdxDocFieldsIterator.CheckFieldCompatibility
  (ADestination: TdxDocObjectCollection);
var
  AFieldObjects: TStack<IdxDocObject>;
  AFieldLength, ARemoveFrom, AFieldStartPosition, AFieldEndPosition, ACount,
    I: Integer;
  AFieldCode: string;
...
begin
  ...
  try
    ...
    begin
      ...
      AFieldStartPosition := ADestination
        [ADestination.Count - AFieldLength].Position;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            AUnsupportedObject.Length := AFieldEndPosition -
              AFieldStartPosition;
          end;
        end;
      end;
...
function TdxDocFieldsIterator.GetFieldObjects(ADocObjects
  : TdxDocObjectCollection): TStack<IdxDocObject>;
var
  ACount, I: Integer;
  AObject: TObject;
...
function TdxDocFieldsIterator.GetFieldCode(AFieldObjects
  : TStack<IdxDocObject>): string;
var
...
procedure TdxDocFieldsIterator.SetShapeField(ADestination
  : TdxDocObjectCollection);
var
  AFieldObjects: TStack<IdxDocObject>;
  AFieldCode: string;
begin
  ...
  try
    AFieldCode := GetFieldCode(AFieldObjects);
    FShapeField := (AFieldCode <> '') and TdxStringHelper.StartsWith
      (Trim(AFieldCode), FShapeFieldName);
  finally
    AFieldObjects.Free;
  end;
end;
...
procedure TdxDocIteratorState.SetDestination(const AValue
  : TdxDocObjectCollection);
begin
  if FOwnsDestination then
    FDestination.Free;
...
procedure TdxDocIteratorState.SetFieldIterator(const AValue
  : TdxDocFieldsIterator);
begin
...
function TdxDocIteratorState.ShouldChangeState(ACharacterPosition
  : Integer): Boolean;
begin
...
function TdxDocIteratorState.ShouldNormalizeFields
  (ADocObjects: TdxDocObjectCollection): Boolean;
var
...
procedure TdxDocIteratorState.NormalizeFieldsCore
...
begin
  ...
  begin
    ...
    if AType in [TdxDocObjectType.FieldBegin, TdxDocObjectType.FieldSeparator,
      TdxDocObjectType.FieldEnd] then
      FieldIterator.MoveNext(nil);
    if AType in [TdxDocObjectType.ExpectedFieldBegin,
      TdxDocObjectType.ExpectedFieldSeparator, TdxDocObjectType.ExpectedFieldEnd]
    then
...
constructor TdxHeaderFooterIteratorStoryState.Create(AThreshold: Integer;
  ADestination: TdxDocObjectCollection;
  APositions: TdxDocHeadersFootersPositions);
begin
...
function TdxCompositeObjectIteratorState.GetPositionsCore
  (AReader: TBinaryReader; AOffset: Integer; ASize: Integer): TdxIntegerList;
var
  ACount, I: Integer;
begin
...
begin
  if not ShouldChangeItem then
    Exit;
  FShouldNormalizeFields := FShouldNormalizeFields or
    ShouldNormalizeFields(Destination);
...
begin
  ...
  if (ANextItemIndex >= Positions.Count) or
    (CurrentItemIndex >= References.Count) then
    Exit(False);
...
function TdxFootNotesIteratorState.GetPositions(AReader: TBinaryReader;
  AFib: TdxFileInformationBlock): TdxIntegerList;
begin
  Result := GetPositionsCore(AReader, AFib.FootNotesTextOffset,
...
function TdxCommentsIteratorState.GetPositions(AReader: TBinaryReader;
  AFib: TdxFileInformationBlock): TdxIntegerList;
begin
  Result := GetPositionsCore(AReader, AFib.CommentsTextOffset,
    AFib.CommentsTextSize);
end;
...
function TdxEndnotesIteratorState.GetPositions(AReader: TBinaryReader;
  AFib: TdxFileInformationBlock): TdxIntegerList;
begin
  Result := GetPositionsCore(AReader, AFib.EndnotesTextOffset,
...
function TdxTextBoxesIteratorState.GetPositions(AReader: TBinaryReader;
  AFib: TdxFileInformationBlock): TdxIntegerList;
var
  ASize, ACount, I: Integer;
begin
  Result := TdxIntegerList.Create;
  AReader.BaseStream.Seek(AFib.MainDocumentTextBoxesTextOffset,
    TSeekOrigin.soBeginning);
  ASize := AFib.MainDocumentTextBoxesTextSize;
  if ASize = 0 then
    Exit;
  ACount := (ASize - TdxDocConstants.CharacterPositionSize)
    div (TdxDocConstants.CharacterPositionSize +
    TdxDocFloatingObjectsIterator.TextBoxInfoSize) + 1;
  for I := 0 to ACount - 1 do
    Result.Add(AReader.ReadInt32);
end;
...
function TdxHeaderTextBoxesIteratorState.GetPositions(AReader: TBinaryReader;
  AFib: TdxFileInformationBlock): TdxIntegerList;
var
  ASize, ACount, I: Integer;
begin
  Result := TdxIntegerList.Create;
  AReader.BaseStream.Seek(AFib.HeaderTextBoxesTextOffset,
    TSeekOrigin.soBeginning);
...
function TdxFinalIteratorState.ShouldChangeState(ACharacterPosition
  : Integer): Boolean;
begin
  Result := False;
end;
...
constructor TdxDocFloatingObjectsIterator.Create(AReader: TBinaryReader;
  AFib: TdxFileInformationBlock; AArtContent: TdxOfficeArtContent;
  AFormatting: TdxFloatingObjectFormatting);
begin
  inherited Create;
  FArtContent := AArtContent;
  FFormatting := AFormatting;
  FHeaderDocumentTextBoxes := TdxDocObjectCollectionDictionary.Create
    ([doOwnsValues]);
  FMainDocumentTextBoxes := TdxDocObjectCollectionDictionary.Create
    ([doOwnsValues]);
...
function TdxDocFloatingObjectsIterator.GetShapeAddresses
...
function TdxDocFloatingObjectsIterator.GetBlipsWithProperties
...
procedure TdxDocFloatingObjectsIterator.ReadFileShapeAddresses
  (AReader: TBinaryReader; AFib: TdxFileInformationBlock);
begin
  FHeaderShapeAddresses := TdxFileShapeAddressTable.FromStream(AReader,
    AFib.HeadersFootersFileShapeTableOffset,
    AFib.HeadersFootersFileShapeTableSize);
  FMainShapeAddresses := TdxFileShapeAddressTable.FromStream(AReader,
    AFib.MainDocumentFileShapeTableOffset, AFib.MainDocumentFileShapeTableSize);
end;

procedure TdxDocFloatingObjectsIterator.ReadTextBoxReferences
  (AReader: TBinaryReader; AFib: TdxFileInformationBlock);
begin
  FMainDocumentTextBoxReferences := ReadTextBoxReferencesCore(AReader,
    AFib.MainDocumentTextBoxesTextOffset, AFib.MainDocumentTextBoxesTextSize);
  FHeaderDocumentTextBoxReferences := ReadTextBoxReferencesCore(AReader,
    AFib.HeaderTextBoxesTextOffset, AFib.HeaderTextBoxesTextSize);
end;

procedure TdxDocFloatingObjectsIterator.ReadTextBoxBreakDescriptors
  (AReader: TBinaryReader; AFib: TdxFileInformationBlock);
begin
  FMainDocumentBreakDescriptors := TdxBreakDescriptorTable.FromStream(AReader,
    AFib.MainTextBoxBreakTableOffset, AFib.MainTextBoxBreakTableSize);
  FHeaderDocumentBreakDescriptors := TdxBreakDescriptorTable.FromStream(AReader,
    AFib.HeadersFootersFieldTableOffset, AFib.HeadersFootersFieldTableSize);
end;

function TdxDocFloatingObjectsIterator.ReadTextBoxReferencesCore
  (AReader: TBinaryReader; AOffset: Integer; ASize: Integer): TdxIntegerList;
var
  ACount, I: Integer;
begin
  ...
  if ASize = 0 then
    Exit(Result);
  ACount := (ASize - TdxDocConstants.CharacterPositionSize)
    div (TdxDocConstants.CharacterPositionSize + TextBoxInfoSize);
  AReader.BaseStream.Seek(AOffset + (ACount + 1) *
    TdxDocConstants.CharacterPositionSize, TSeekOrigin.soBeginning);
  for I := 0 to ACount - 1 do
  begin
...
function TdxDocFloatingObjectsIterator.GetFloatingObject(ACharacterPosition
  : Integer; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer): TdxDocFloatingObjectBase;
var
  AAddress: TdxFileShapeAddress;
begin
  if not ShapeAddresses.TranslationTable.TryGetValue(ACharacterPosition,
    AAddress) then
    Exit(nil);
...
begin
  if not ShapeAddresses.TranslationTable.TryGetValue(APosition, AAddress) then
    Exit(nil);
  if (BlipsWithProperties = nil) or not BlipsWithProperties.Blips.TryGetValue
    (AAddress.ShapeIdentifier, Result) then
    Exit(nil);
end;

function TdxDocFloatingObjectsIterator.GetFloatingObjectCore
  (AAddress: TdxFileShapeAddress; var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer): TdxDocFloatingObjectBase;
var
...
begin
  ...
  if (BlipsWithProperties <> nil) and BlipsWithProperties.Blips.TryGetValue
    (AShapeIdentifier, ABlip) then
    Result := TdxDocPictureFloatingObject.Create(AObjectInfo,
      APropertyContainer, ABlip);

  AIsOlePicture := False;
  if BlipsWithProperties.ShapeRecords.TryGetValue(AShapeIdentifier, AShapeRecord)
  then
  ...
  begin
    Result.Free;
    Result := TdxDocTextBoxFloatingObject.Create(AObjectInfo,
      APropertyContainer, AShapeIdentifier);
  end;
  if Result = nil then
    Exit;
  ...
  if BlipsWithProperties.ShapeArtProperties.TryGetValue(AShapeIdentifier,
    AProperties) then
    Result.SetOfficeArtProperties(AProperties);
  if BlipsWithProperties.ShapeArtTertiaryProperties.TryGetValue
    (AShapeIdentifier, ATertiaryProperties) then
    Result.SetOfficeArtTertiaryProperties(ATertiaryProperties);
end;

function TdxDocFloatingObjectsIterator.GetMainTextBoxObjects(AShapeId: Integer)
  : TdxDocObjectCollection;
begin
...
function TdxDocFloatingObjectsIterator.GetHeaderTextBoxObjects
  (AShapeId: Integer): TdxDocObjectCollection;
begin
...
constructor TdxDocIteratorStateFactory.Create(AFib: TdxFileInformationBlock;
  AMainStreamReader: TBinaryReader; ATableStreamReader: TBinaryReader;
  AIterator: TdxDocContentIterator);
begin
  FFib := AFib;
  ...
  FHeadersFootersPositions := TdxDocHeadersFootersPositions.FromStream
    (ATableStreamReader, AFib.HeadersFootersPositionsOffset,
    AFib.HeadersFootersPositionsSize);
...
begin
  ...
  FCreators.Add(TdxDocContentState.HeadersFootersStory,
    CreateHeadersFootersStoryState);
  FCreators.Add(TdxDocContentState.HeadersFootersEnd,
    CreateHeadersFootersEndState);
...
function TdxDocIteratorStateFactory.CreateState(AStateType: TdxDocContentState)
  : TdxDocIteratorState;
var
...
function TdxDocIteratorStateFactory.CreateMainDocumentState
  : TdxDocIteratorState;
var
  AResult: TdxMainDocumentIteratorState;
begin
  AResult := TdxMainDocumentIteratorState.Create(FileInfo.MainDocumentLength,
    ContentIterator.MainTextDocObjects);
...
begin
  ...
  AResult := TdxFootNotesIteratorState.Create(AThreshold,
    ANotesIterator.FootNotes, ANotesIterator.FootNoteReferences,
    TableStreamReader, FileInfo);
...
function TdxDocIteratorStateFactory.CreateHeadersFootersStoryState
  : TdxDocIteratorState;
var
  AThreshold: Integer;
...
begin
  AThreshold := FileInfo.HeadersFootersStart +
    HeadersFootersPositions.GetNextStoryPosition;
  AHeadersFooters := ContentIterator.HeadersFooters;
  AHeadersFooters.HeadersFooters.Add(TdxDocObjectCollection.Create);
  AResult := TdxHeaderFooterIteratorStoryState.Create(AThreshold,
    AHeadersFooters.ActiveCollection, HeadersFootersPositions);
  AResult.FieldIterator := CreateFieldIterator
    (TdxDocContentState.HeadersFootersStory);
  Result := AResult;
end;

function TdxDocIteratorStateFactory.CreateHeadersFootersEndState
  : TdxDocIteratorState;
var
  AThreshold: Integer;
...
begin
  ...
  AResult := TdxHeaderFooterEndIteratorState.Create(AThreshold,
    TdxDocObjectCollection.Create);
...
begin
  ...
  AResult := TdxMacroIteratorState.Create(AThreshold,
    ContentIterator.MacroObjects);
  Result := AResult;
end;
...
begin
  ...
  Result := TdxCommentsIteratorState.Create(AThreshold,
    ACommentsIterator.CommentsContent, ACommentsIterator.CommentsReferences,
    TableStreamReader, FileInfo);
...
begin
  ...
  ANotesIterator := ContentIterator.NotesIterator;
  AResult := TdxEndnotesIteratorState.Create(AThreshold,
    ANotesIterator.EndNotes, ANotesIterator.EndNoteReferences,
    TableStreamReader, FileInfo);
...
begin
  AThreshold := FileInfo.MainDocumentTextBoxesStart +
    FileInfo.MainDocumentTextBoxesLength;
  ATextBoxes := ContentIterator.FloatingObjectsIterator.MainDocumentTextBoxes;
  AReferences := ContentIterator.FloatingObjectsIterator.
    MainDocumentTextBoxReferences;
  AResult := TdxTextBoxesIteratorState.Create(AThreshold, ATextBoxes,
    AReferences, TableStreamReader, FileInfo);
  AResult.FieldIterator := CreateFieldIterator(TdxDocContentState.TextBoxes);
  Result := AResult;
end;

function TdxDocIteratorStateFactory.CreateHeaderTextBoxesState
  : TdxDocIteratorState;
var
  AThreshold: Integer;
  ATextBoxes: TdxDocObjectCollectionDictionary;
...
begin
  ...
  AReferences := ContentIterator.FloatingObjectsIterator.
    HeaderDocumentTextBoxReferences;
  AResult := TdxHeaderTextBoxesIteratorState.Create(AThreshold, ATextBoxes,
    AReferences, TableStreamReader, FileInfo);
  AResult.FieldIterator := CreateFieldIterator
...
function TdxDocIteratorStateFactory.CreateFieldIterator
  (AStateType: TdxDocContentState): TdxDocFieldsIterator;
begin
  case AStateType of
    TdxDocContentState.MainDocument:
      Result := TdxDocFieldsIterator.Create(TableStreamReader,
        FileInfo.MainDocumentFieldTableOffset,
        FileInfo.MainDocumentFieldTableSize);
    TdxDocContentState.FootNotes:
      Result := TdxDocFieldsIterator.Create(TableStreamReader,
        FileInfo.FootNotesFieldTableOffset, FileInfo.FootNotesFieldTableSize);
    TdxDocContentState.HeadersFootersStory:
      Result := TdxDocFieldsIterator.Create(TableStreamReader,
        FileInfo.HeadersFootersFieldTableOffset,
        FileInfo.HeadersFootersFieldTableSize);
    TdxDocContentState.Comments:
      Result := TdxDocFieldsIterator.Create(TableStreamReader,
        FileInfo.CommentsFieldTableOffset, FileInfo.CommentsFieldTableSize);
    TdxDocContentState.EndNotes:
      Result := TdxDocFieldsIterator.Create(TableStreamReader,
        FileInfo.EndNotesFieldTableOffset, FileInfo.EndNotesFieldTableSize);
    TdxDocContentState.TextBoxes:
      Result := TdxDocFieldsIterator.Create(TableStreamReader,
        FileInfo.MainDocumentTextBoxesFieldTableOffset,
        FileInfo.MainDocumentTextBoxesFieldTableSize);
    TdxDocContentState.HeaderTextBoxes:
      Result := TdxDocFieldsIterator.Create(TableStreamReader,
        FileInfo.HeaderTextBoxesFieldTableOffset,
        FileInfo.HeaderTextBoxesFieldTableSize);
  else
    Result := nil;
  end;
end;
...
constructor TdxDocNotesIterator.Create(AFib: TdxFileInformationBlock;
...
procedure TdxDocNotesIterator.GetReferences(AReader: TBinaryReader;
  AFib: TdxFileInformationBlock);
begin
  FFootNotesReferences := GetNoteReferencesCore(AReader,
    AFib.FootNotesReferenceOffset, AFib.FootNotesReferenceSize);
  FEndNoteReferences := GetNoteReferencesCore(AReader,
    AFib.EndNotesReferenceOffset, AFib.EndNotesReferenceSize);
end;

function TdxDocNotesIterator.GetNoteReferencesCore(AReader: TBinaryReader;
  AOffset: Integer; ASize: Integer): TdxIntegerList;
var
  ACount, I: Integer;
begin
  Result := TdxIntegerList.Create;
  ACount := (ASize - TdxDocConstants.CharacterPositionSize)
    div (TdxDocConstants.CharacterPositionSize + FlagSize);
  AReader.BaseStream.Seek(AOffset, TSeekOrigin.soBeginning);
  for I := 0 to ACount - 1 do
    Result.Add(AReader.ReadInt32);
end;

function TdxDocNotesIterator.GetNoteObject(AInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer): IdxDocObject;
var
...
begin
  ...
  if FootNoteReferences.Contains(ACharacterPosition) then
    Exit(TdxDocObjectFactory.Instance.CreateDocObject
      (TdxDocObjectType.AutoNumberedFootnoteReference, AInfo,
      APropertyContainer));
  if EndNoteReferences.Contains(ACharacterPosition) then
    Exit(TdxDocObjectFactory.Instance.CreateDocObject
      (TdxDocObjectType.EndnoteReference, AInfo, APropertyContainer));
  Result := TdxDocObjectFactory.Instance.CreateDocObject
    (TdxDocObjectType.NoteNumber, AInfo, APropertyContainer);
end;

function TdxDocNotesIterator.GetFootNoteObjects(ACharacterPosition: Integer)
  : TdxDocObjectCollection;
begin
...
function TdxDocNotesIterator.GetEndNoteObjects(ACharacterPosition: Integer)
  : TdxDocObjectCollection;
begin
...
constructor TdxDocContentIterator.Create
  (ABuilder: TObject { TdxDocContentBuilder }; AFib: TdxFileInformationBlock;
  AMainStreamReader: TBinaryReader; ATableStreamReader: TBinaryReader;
  AModel: TdxDocumentModel);
begin
  FBuilder := ABuilder;
  ...
  FFactory := TdxDocIteratorStateFactory.Create(AFib, AMainStreamReader,
    ATableStreamReader, Self);
...
procedure TdxDocContentIterator.SetTextStreamBorders
  (AFib: TdxFileInformationBlock);
begin
...
procedure TdxDocContentIterator.InitializeIterators
  (AFib: TdxFileInformationBlock; AMainStreamReader: TBinaryReader;
  ATableStreamReader: TBinaryReader; AModel: TdxDocumentModel);
var
...
begin
  ...
  FBookmarkIterator := TdxDocBookmarkIterator.Create(AFib, ATableStreamReader,
    AOptions.KeepBookmarksForRemovedRanges);
  FCommentsIterator := TdxDocCommentsIterator.Create(AFib, ATableStreamReader,
    False { AOptions.KeepCommentsForRemovedRanges } );
  FNotesIterator := TdxDocNotesIterator.Create(AFib, ATableStreamReader);
  if AFib.DrawingObjectTableSize <> 0 then
    FArtContent := TdxOfficeArtContent.FromStream(ATableStreamReader,
      AMainStreamReader, AFib.DrawingObjectTableOffset,
      AFib.DrawingObjectTableSize, TdxDocContentBuilder(FBuilder));
  AFormatting := TdxFloatingObjectFormatting
    (AModel.Cache.FloatingObjectFormattingCache.DefaultItem.Clone);
  FFloatingObjectsIterator := TdxDocFloatingObjectsIterator.Create
    (ATableStreamReader, AFib, FArtContent, AFormatting);
  FPermissionsIterator := TdxDocRangeEditPermissionIterator.Create(AFib,
    ATableStreamReader, AOptions.KeepPermissionsForRemovedRanges);
...
begin
  ...
  for I := 0 to ACount - 1 do
  begin
    ABackgroundShape := FArtContent.Drawings[I].DrawingObjectsContainer.
      BackgroundShape;
    if (ABackgroundShape = nil) or (ABackgroundShape.ShapeRecord.ShapeIdentifier
      <> TdxOfficeArtConstants.DefaultMainDocumentShapeIdentifier) then
      Continue;
...
function TdxDocContentIterator.AdvanceField(APropertyContainer
  : TdxDocPropertyContainer): Boolean;
begin
...
procedure TdxDocContentIterator.CheckFieldCompatibility
  (ADestination: TdxDocObjectCollection);
begin
  State.FieldIterator.CheckFieldCompatibility(ADestination);
end;

function TdxDocContentIterator.GetFloatingObject(var AObjectInfo
  : TdxDocObjectInfo; APropertyContainer: TdxDocPropertyContainer)
  : TdxDocFloatingObjectBase;
begin
  Result := FloatingObjectsIterator.GetFloatingObject
    (GetRelativeCharacterPosition(AObjectInfo), AObjectInfo,
    APropertyContainer);
end;

function TdxDocContentIterator.GetNoteObject(var AObjectInfo: TdxDocObjectInfo;
  APropertyContainer: TdxDocPropertyContainer): IdxDocObject;
begin
...
procedure TdxDocContentIterator.AdvancePosition(ALogPosition
  : TdxDocumentLogPosition; AOriginalPosition: Integer; ALength: Integer);
begin
...
function TdxDocContentIterator.GetRelativeCharacterPosition
  (AInfo: TdxDocObjectInfo): Integer;
var
  APosition: Integer;
begin
...
procedure TdxDocContentIterator.BeginEmbeddedContent
  (AContent: TdxDocObjectCollection);
var
  AStart, AEnd: Integer;
