...
type
  ...
  protected
    ...
    function LookupPage(APages: TdxPageCollection; ARunIndex: TdxRunIndex)
      : TdxPage; virtual;
    function LookupPageArea(APage: TdxPage; AParagraph: TdxParagraph;
      ARunIndex: TdxRunIndex): TdxPageArea; virtual;
    function LookupColumn(AColumns: TdxColumnCollection; ARunIndex: TdxRunIndex)
      : TdxColumn; virtual;
    function LookupRow(ARows: TdxRowCollection; ARunIndex: TdxRunIndex)
      : TdxRow; virtual;
    function LookupBoxIndex(ABoxes: TdxBoxCollection; ARunIndex: TdxRunIndex)
      : Integer; virtual;
    function LookupBoxCore(ABoxes: TdxBoxListBase;
      const AComparer: TdxBoxComparableFunc): TdxBoxBase; virtual;
    function LookupBoxIndexCore(ABoxes: TdxBoxListBase;
      const AComparer: TdxBoxComparableFunc): Integer; virtual;
  ...
  private
    ...
    FParagraphLayoutPosition
      : TObjectDictionary<TdxParagraphIndex, TdxParagraphLayoutPosition>;
    FContinueList: Boolean;
    function GetNumberingListsTemplate: TdxAbstractNumberingListCollection;
    procedure ClearCore;
  protected
    procedure ModifyModel; override;
    procedure ModifyParagraphs(AParagraphIntervals
      : TdxParagraphIntervalList); virtual;

    procedure ModifyParagraphsCore(AStartParagraphIndex, AEndParagraphIndex
    ...
    function GetBox(ABoxIndex: Integer; ABoxes: TdxBoxCollection)
      : TdxBox; virtual;
    function EqualLeftIndent: Boolean;
    function GetRowParentIndent(ARow: TdxRow;
      AParagraphLayoutPosition: TdxParagraphLayoutPosition): Integer; virtual;
    function GetRowIndent(ARow: TdxRow;
      AParagraphLayoutPosition: TdxParagraphLayoutPosition): Integer; virtual;
    function CreateAndUpdateParagraphLayoutPosition(AParagraph: TdxParagraph)
      : TdxParagraphLayoutPosition;
    function CreateParagraphLayoutPositionCore(AParagraph: TdxParagraph)
      : TdxParagraphLayoutPosition;
    function GetUpdateCaretPositionBeforeChangeSelectionDetailsLevel
      : TdxDocumentLayoutDetailsLevel; override;

    property ParagraphsLevelIndex: TdxIntegersDictionary
      read FParagraphsLevelIndex write FParagraphsLevelIndex;
    property ParagraphLayoutPositionIndex
      : TObjectDictionary<TdxParagraphIndex, TdxParagraphLayoutPosition>
      read FParagraphLayoutPosition write FParagraphLayoutPosition;
  ...
  private
    ...
    function GetActualNumberingPosition(const AListLevel
      : IdxOverrideListLevel): Integer;
  protected
    function GetNumberingListType: TdxNumberingType; virtual;
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
    procedure ModifyParagraphs(AParagraphIntervals
      : TdxParagraphIntervalList); override;
    procedure ModifyParagraphsCore(AStartParagraphIndex, AEndParagraphIndex
      : TdxParagraphIndex); override;
    function ShouldAddNumberingListToParagraphs(AParagraphIntervals
      : TdxParagraphIntervalList): Boolean; virtual;
    function GetNumberingListIndex: TdxAbstractNumberingListIndex; virtual;
    function GetListIndex(AParagraphIntervals: TdxParagraphIntervalList)
    ...
    function GetEqualsTemplateListIndex(ANumberingList: TdxNumberingList)
      : TdxAbstractNumberingListIndex;
    procedure FillParagraphsLevelIndex(AParagraphIntervals
      : TdxParagraphIntervalList); virtual;
    function CalculateParagraphListLevel(AParagraph: TdxParagraphBase;
      ALeftIndent: Integer): Integer; virtual;
    function HaveCurrentNumberingListType: Boolean;
    function IsStartWhiteSpaceParagraph(AStartParagraphIndex, AEndParagraphIndex
      : TdxParagraphIndex; AParagraph: TdxParagraphBase): Boolean;
    procedure InsertNumberingRangeForParagraph(AParagraphIntervals
      : TdxParagraphIntervalList);
    procedure AddNumberingListToParagraph(AParagraph: TdxParagraph;
      AListIndex: TdxNumberingListIndex; AListLevelIndex: Integer); virtual;
    procedure AddParagraphLayoutPositionIndex(AParagraphIntervals
      : TdxParagraphIntervalList); virtual;
    procedure AddParagraphLayoutPositionIndexCore
      (AParagraph: TdxParagraph); virtual;
    procedure DeleteWhiteSpaceBox(ABoxIndex: Integer;
      ABoxes: TdxBoxCollection); virtual;
    function GetLevelByCurrentIndent(ALeftIndent: Integer;
      AListIndex: TdxNumberingListIndex): Integer; virtual;
    ...
    procedure AssignLevelsIndentsCore(ALevels: TdxListLevelCollection;
  ...
  public
    constructor Create(const AControl: IdxRichEditControl;
      ...
      AbstractNumberingListIndexInvalidValue); reintroduce;
  ...
  protected
    ...
    procedure FillParagraphsLevelIndex(AParagraphIntervals
      : TdxParagraphIntervalList); override;
    procedure StoreOriginalLevelLeftIndent(const ALevel: IdxListLevel);
      override;
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
  public
    class function GetDescription: string; override;
  ...
  protected
    function GetInsertNumerationCommand: TdxNumberingListCommandBase;
      virtual; abstract;
    procedure ExecuteCore; override;
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;

    property InsertNumerationCommand: TdxNumberingListCommandBase
      read GetInsertNumerationCommand;
  public
    constructor Create(const AControl: IdxRichEditControl); override;
    destructor Destroy; override;
  ...
  TdxIncrementNumerationFromParagraphCommand = class
    (TdxNumberingListCommandBase)
  protected
    procedure ModifyParagraphsCore(AStartParagraphIndex, AEndParagraphIndex
      : TdxParagraphIndex); override;
    procedure IncrementNumerationFromParagraph(AParagraph: TdxParagraph;
  ...
  TdxNumerationParagraphIndentCommandBase = class abstract
    (TdxChangeParagraphIndentCommandBase<Integer>)
  protected
    procedure ModifyDocumentModelCore(const AState: IdxCommandUIState);
      override;
    procedure AssignNewIndentCore(AAbstractNumberingList
      : TdxAbstractNumberingList; ACurrentNumberingOrBulletPosition: Integer);
      virtual; abstract;
    function CalculateCurrentBulletOrNumberingPosition(ALeftIndent,
      AFirstLineIndent: Integer;
      AFirstLineIndentType: TdxParagraphFirstLineIndent): Integer; virtual;
    function CalculateLeftIndentDelta(ATargetNumerationOrBulletPosition,
      ACurrentLeftIndent, AFirstLineIndent: Integer;
      AFirstLineIndentType: TdxParagraphFirstLineIndent): Integer; virtual;
    procedure AssignNumberingListLeftIndentModifier(AAbstractNumberingList
      : TdxAbstractNumberingList; ATargetNumberingOrBulletPosition
      : Integer); virtual;
  end;

  { TdxIncrementNumerationParagraphIndentCommand }

  TdxIncrementNumerationParagraphIndentCommand = class
    (TdxNumerationParagraphIndentCommandBase)
  protected
    procedure AssignNewIndentCore(AAbstractNumberingList
      : TdxAbstractNumberingList; ACurrentNumberingOrBulletPosition
      : Integer); override;
    function CreateModifier(const AState: IdxCommandUIState)
      : TdxParagraphPropertyModifier<Integer>; override;
  ...
  TdxDecrementNumerationFromParagraphCommand = class
    (TdxNumberingListCommandBase)
  protected
    procedure ModifyParagraphsCore(AStartParagraphIndex, AEndParagraphIndex
      : TdxParagraphIndex); override;
  ...
  TdxDecrementNumerationParagraphIndentCommand = class
    (TdxNumerationParagraphIndentCommandBase)
  protected
    procedure AssignNewIndentCore(AAbstractNumberingList
      : TdxAbstractNumberingList; ACurrentNumberingOrBulletPosition
  ...
  TdxInsertListMode = (KeepLevelIndex, CalculateLevelIndexByIndent,
    ChangeLevelIndex);
  ...
  protected
    function ShouldAddNumberingListToParagraphs(AParagraphIntervals
      : TdxParagraphIntervalList): Boolean; override;
    function GetListIndex(AParagraphIntervals: TdxParagraphIntervalList)
      : TdxNumberingListIndex; override;
    procedure AddNumberingListToParagraph(AParagraph: TdxParagraph;
      AListIndex: TdxNumberingListIndex; AListLevelIndex: Integer); override;
    function CalculateParagraphListLevel(AParagraph: TdxParagraphBase;
      ALeftIndent: Integer): Integer; override;
  public
    constructor Create(const AControl: IdxRichEditControl;
      AList: TdxAbstractNumberingList; ALevelIndex: Integer;
      AMode: TdxInsertListMode); reintroduce;
  end;
  ...
  protected
    function LookupPage(APages: TdxPageCollection; ARunIndex: TdxRunIndex)
      : TdxPage; override;
    function LookupPageArea(APage: TdxPage; AParagraph: TdxParagraph;
      ARunIndex: TdxRunIndex): TdxPageArea; override;
  public
    constructor Create(const AControl: IdxRichEditControl; APage: TdxPage;
      AArea: TdxPageArea);
  end;
  ...
  TdxSetPredefinedSectionLineNumberingCommand = class abstract
    (TdxToggleChangeSectionFormattingCommandBase<TdxLineNumberingRestart>)
  protected
    function GetLineNumberingRestart: TdxLineNumberingRestart; virtual;
      abstract;
    function CreateModifier(const AState: IdxCommandUIState)
      : TdxSectionPropertyModifier<TdxLineNumberingRestart>; override;
    function IsCheckedValue(AValue: TdxLineNumberingRestart): Boolean; override;

    property LineNumberingRestart: TdxLineNumberingRestart
      read GetLineNumberingRestart;
  end;

  { TdxSetSectionLineNumberingNoneCommand }

  TdxSetSectionLineNumberingNoneCommand = class
    (TdxSetPredefinedSectionLineNumberingCommand)
  protected
  ...
  TdxSetSectionLineNumberingContinuousCommand = class
    (TdxSetPredefinedSectionLineNumberingCommand)
  protected
    function GetLineNumberingRestart: TdxLineNumberingRestart; override;
  public
  ...
  TdxSetSectionLineNumberingRestartNewPageCommand = class
    (TdxSetPredefinedSectionLineNumberingCommand)
  protected
    function GetLineNumberingRestart: TdxLineNumberingRestart; override;
  public
  ...
  TdxSetSectionLineNumberingRestartNewSectionCommand = class
    (TdxSetPredefinedSectionLineNumberingCommand)
  protected
    function GetLineNumberingRestart: TdxLineNumberingRestart; override;
  public
...
begin
  if IsRunBeforeBox(ABox) then
    Result := 1
  else if IsRunAfterBox(ABox) then
    Result := -1
  else
    Result := 0;
end;
...
begin
  Result := (FIndex < ABox.StartPos.RunIndex) or
    ((FIndex = ABox.StartPos.RunIndex) and (ABox.StartPos.Offset > 0));
end;

{ TdxParagraphLayoutPosition }

constructor TdxParagraphLayoutPosition.Create(const AControl
  : IdxRichEditControl);
begin
  inherited Create;
  Assert(AControl <> nil);
...
procedure TdxParagraphLayoutPosition.GetParagraphLayoutPosition
  (AParagraph: TdxParagraph);
var
...
begin
  ...
  FPage := LookupPage(FControl.InnerControl.ActiveView.DocumentLayout.Pages,
    ARunIndex);
...
function TdxParagraphLayoutPosition.LookupBoxCore(ABoxes: TdxBoxListBase;
  const AComparer: TdxBoxComparableFunc): TdxBoxBase;
var
  ABoxIndex: Integer;
begin
...
function TdxParagraphLayoutPosition.LookupBoxIndex(ABoxes: TdxBoxCollection;
...
function TdxParagraphLayoutPosition.LookupBoxIndexCore(ABoxes: TdxBoxListBase;
  const AComparer: TdxBoxComparableFunc): Integer;
begin
  TdxAlgorithms1<TdxBoxBase>.BinarySearch(ABoxes, AComparer, Result);
  Assert(Result < ABoxes.Count);
end;

function TdxParagraphLayoutPosition.LookupColumn(AColumns: TdxColumnCollection;
  ARunIndex: TdxRunIndex): TdxColumn;
var
...
function TdxParagraphLayoutPosition.LookupPage(APages: TdxPageCollection;
  ARunIndex: TdxRunIndex): TdxPage;
var
...
function TdxParagraphLayoutPosition.LookupPageArea(APage: TdxPage;
  AParagraph: TdxParagraph; ARunIndex: TdxRunIndex): TdxPageArea;
var
  AComparer: TdxPageAreaRunComparer;
begin
  if (APage.Header <> nil) and (APage.Header.PieceTable = AParagraph.PieceTable)
  then
    Exit(APage.Header);
  if (APage.Footer <> nil) and (APage.Footer.PieceTable = AParagraph.PieceTable)
  then
    Exit(APage.Footer);
...
function TdxParagraphLayoutPosition.LookupRow(ARows: TdxRowCollection;
  ARunIndex: TdxRunIndex): TdxRow;
var
...
function TdxParagraphInterval.CompareTo(const AOther
  : TdxParagraphInterval): Integer;
begin
...
constructor TdxNumberingListCommandBase.Create(const AControl
  : IdxRichEditControl);
begin
  inherited Create(AControl);
  FParagraphsLevelIndex := TdxIntegersDictionary.Create;
  FParagraphLayoutPosition :=
    TObjectDictionary<TdxParagraphIndex, TdxParagraphLayoutPosition>.Create
    ([doOwnsValues]);
end;
...
begin
  ...
  begin
    Assert(CaretPosition.LayoutPosition.DetailsLevel >=
      UpdateCaretPositionBeforeChangeSelectionDetailsLevel);
    Result := TdxHeaderFooterParagraphLayoutPosition.Create(RichEditControl,
      CaretPosition.LayoutPosition.Page, CaretPosition.LayoutPosition.PageArea);
  end;
end;
...
begin
  ...
  ALeftIndent := (AList.Levels[1] as IdxParagraphProperties).LeftIndent -
    (AList.Levels[0] as IdxParagraphProperties).LeftIndent;
  Result := AMaxLeftIndent - AMinLeftIndent < ALeftIndent;
end;

function TdxNumberingListCommandBase.GetBox(ABoxIndex: Integer;
  ABoxes: TdxBoxCollection): TdxBox;
var
  I: Integer;
begin
...
function TdxNumberingListCommandBase.GetLevelType(AParagraph: TdxParagraph)
  : TdxNumberingType;
var
...
begin
  ...
  Result := TdxNumberingListHelper.GetLevelType(ANumberingList,
    AParagraph.GetListLevelIndex);
end;

function TdxNumberingListCommandBase.GetNumberingListsTemplate
  : TdxAbstractNumberingListCollection;
begin
  Result := RichEditControl.InnerControl.DocumentModelTemplate.
    AbstractNumberingLists;
end;
...
begin
  Result := ARow.Bounds.Left - GetRowParentIndent(ARow,
    AParagraphLayoutPosition);
end;
...
begin
  if ARow is TdxTableCellRow then
    Result := TdxTableCellRow(ARow).CellViewInfo.TextLeft +
      AParagraphLayoutPosition.Column.Bounds.Left
  else
    Result := AParagraphLayoutPosition.Column.Bounds.Left;
end;

function TdxNumberingListCommandBase.
...
begin
  ...
  try
    ...
    begin
      ...
      AIntervals.Add(TdxParagraphInterval.Create(AStartParagraphIndex,
        AEndParagraphIndex));
    end;
    AIntervals.Sort;
...
procedure TdxNumberingListCommandBase.ModifyParagraphs(AParagraphIntervals
  : TdxParagraphIntervalList);
var
  I: Integer;
...
procedure TdxNumberingListCommandBase.UpdateUIStateCore
...
procedure TdxInsertMultiLevelListCommand.AddNumberingListToParagraph
  (AParagraph: TdxParagraph; AListIndex: TdxNumberingListIndex;
  AListLevelIndex: Integer);
var
  ACell: TdxTableCell;
begin
  ...
  if (ACell <> nil) and (ACell.VerticalMerging = TdxMergingState.Continue) then
    Exit;
  ActivePieceTable.AddNumberingListToParagraph(AParagraph, AListIndex,
    AListLevelIndex);
...
procedure TdxInsertMultiLevelListCommand.AddParagraphLayoutPositionIndexCore
  (AParagraph: TdxParagraph);
var
  AParagraphPosition: TdxParagraphLayoutPosition;
begin
...
function TdxInsertMultiLevelListCommand.
  AreAllParagraphsHasValidNumberingListType: Boolean;
var
  AParagraph: TdxParagraph;
  I, AStartParagraphIndex, AEndParagraphIndex: TdxParagraphIndex;
begin
  AStartParagraphIndex := DocumentModel.Selection.Interval.NormalizedStart.
    ParagraphIndex;
  ...
  begin
    ...
    if not AParagraph.IsInList or (GetLevelType(AParagraph) <> NumberingListType)
    then
      Exit(False);
  end;
  Result := True;
...
procedure TdxInsertMultiLevelListCommand.AssignLevelsIndents
...
procedure TdxInsertMultiLevelListCommand.AssignLevelsIndentsCore
  (ALevels: TdxListLevelCollection; AParagraph: TdxParagraph);
var
  I: Integer;
  ALevel: IdxListLevel;
...
begin
  ...
  begin
    ...
    ALevel.ListLevelProperties.OriginalLeftIndent :=
      ALevelParagraphProperties.LeftIndent;
    ALevelParagraphProperties.LeftIndent := ALevelParagraphProperties.LeftIndent
      + AParagraph.LeftIndent;
  end;
end;

function TdxInsertMultiLevelListCommand.CalculateParagraphListLevel
  (AParagraph: TdxParagraphBase; ALeftIndent: Integer): Integer;
begin
  if NestingLevel <> 0 then
    Result := NestingLevel
  else
    Result := GetLevelByCurrentIndent
      (DocumentModel.ToDocumentLayoutUnitConverter.ToModelUnits(ALeftIndent),
      ListIndex);
end;

procedure TdxInsertMultiLevelListCommand.ChangeSelection
  (ASelection: TdxSelection);
begin
end;

constructor TdxInsertMultiLevelListCommand.Create(const AControl
  : IdxRichEditControl; ATemplateListIndex: TdxAbstractNumberingListIndex);
begin
  inherited Create(AControl);
  FTemplateListIndex := ATemplateListIndex;
end;

procedure TdxInsertMultiLevelListCommand.DeleteOldNumberingListRange
  (AIndex: TdxParagraphIndex);
begin
  if ActivePieceTable.Paragraphs[AIndex].IsInList then
    ActivePieceTable.RemoveNumberingFromParagraph
      (ActivePieceTable.Paragraphs[AIndex]);
end;

procedure TdxInsertMultiLevelListCommand.DeleteWhiteSpaceBox(ABoxIndex: Integer;
...
begin
  ...
  ALogPosition := ActivePieceTable.Runs[ABoxes[ABoxIndex].StartPos.RunIndex]
    .Paragraph.LogPosition;
  ActivePieceTable.DeleteContent(ALogPosition, ALength, False);
end;

procedure TdxInsertMultiLevelListCommand.FillParagraphsLevelIndex
  (AParagraphIntervals: TdxParagraphIntervalList);
var
  ARow: TdxRow;
  ABox: TdxBox;
  ...
  AParagraphInterval: TdxParagraphInterval;
  I, AStartParagraphIndex, AEndParagraphIndex: TdxParagraphIndex;
  AParagraphIntervalIndex, ABoxIndex, ARowIndent, AWhiteSpaceBoxLength,
    ALeftIndent: Integer;
begin
  ...
  begin
    ...
    begin
      ...
      if (ABox is TdxParagraphMarkBox) and not IsStartWhiteSpaceParagraph
        (AStartParagraphIndex, AEndParagraphIndex, AParagraph) then
        Continue;
      ARowIndent := GetRowIndent(ARow, ParagraphLayoutPositionIndex[I]);
      AWhiteSpaceBoxLength := ABox.Bounds.Left - ARow.Boxes[ABoxIndex]
        .Bounds.Left;
      ALeftIndent := ARowIndent + AWhiteSpaceBoxLength;
      ParagraphsLevelIndex.Add(I, CalculateParagraphListLevel(AParagraph,
        ALeftIndent));
    end;
  end;
end;

function TdxInsertMultiLevelListCommand.GetActualNumberingPosition
  (const AListLevel: IdxOverrideListLevel): Integer;
var
  AParagraphProperties: IdxParagraphProperties;
begin
  AParagraphProperties := AListLevel as IdxParagraphProperties;
  if AParagraphProperties.FirstLineIndentType = TdxParagraphFirstLineIndent.Hanging
  then
...
function TdxInsertMultiLevelListCommand.GetEndSelectedParagraphIndex
  : TdxParagraphIndex;
var
  AParagraph: TdxParagraph;
...
function TdxInsertMultiLevelListCommand.GetLevelByCurrentIndent
  (ALeftIndent: Integer; AListIndex: TdxNumberingListIndex): Integer;
var
  ALevels: TdxListLevelCollection;
...
begin
  ...
  for I := 0 to ALevels.Count - 1 do
  begin
    AActualNumberingPosition := GetActualNumberingPosition
      (ALevels[I] as IdxOverrideListLevel);
...
function TdxInsertMultiLevelListCommand.GetListIndex(AParagraphIntervals
  : TdxParagraphIntervalList): TdxNumberingListIndex;
var
...
begin
  ...
  ACalculator := DocumentModel.CommandsCreationStrategy.
    CreateNumberingListIndexCalculator(DocumentModel, NumberingListType);
  try
    Result := ACalculator.GetListIndex(AStartParagraphIndex,
      AEndParagraphIndex);
    if Result >= 0 then
    begin
    ...
    Result := ACalculator.CreateNewList
      (NumberingListsTemplate[FTemplateListIndex]);
  finally
    ACalculator.Free;
  end;
end;
...
function TdxInsertMultiLevelListCommand.GetNumberingListIndex
  : TdxAbstractNumberingListIndex;
begin
  Result := TdxNumberingListHelper.GetAbstractListIndexByType
    (NumberingListsTemplate, NumberingListType);
end;
...
begin
  Result := DocumentModel.AbstractNumberingLists.HasListOfType
    (NumberingListType);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      DeleteWhiteSpaceBox(ParagraphLayoutPositionIndex[I].BoxIndex,
        ParagraphLayoutPositionIndex[I].Row.Boxes);
    end;
  end;
  for AKey in ParagraphsLevelIndex.Keys do
  begin
    AParagraph := ActivePieceTable.Paragraphs[AKey];
    AddNumberingListToParagraph(AParagraph, ListIndex,
      ParagraphsLevelIndex[AKey]);
  end;
end;

function TdxInsertMultiLevelListCommand.IsStartWhiteSpaceParagraph
  (AStartParagraphIndex, AEndParagraphIndex: TdxParagraphIndex;
  AParagraph: TdxParagraphBase): Boolean;
begin
  if (AStartParagraphIndex <> AEndParagraphIndex) and
    (AParagraph.Index <> AStartParagraphIndex) then
    Result := False
  else if (AParagraph.Length <= 1) and
    (AStartParagraphIndex <> AEndParagraphIndex) then
    Result := False
  else
    Result := True;
end;

procedure TdxInsertMultiLevelListCommand.ModifyParagraphs(AParagraphIntervals
  : TdxParagraphIntervalList);
begin
...
procedure TdxInsertMultiLevelListCommand.ModifyParagraphsCore
  (AStartParagraphIndex, AEndParagraphIndex: TdxParagraphIndex);
begin
end;
...
procedure TdxInsertMultiLevelListCommand.StoreOriginalLevelLeftIndent
  (const ALevel: IdxListLevel);
begin
  ALevel.ListLevelProperties.OriginalLeftIndent := 0;
end;

procedure TdxInsertMultiLevelListCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  inherited UpdateUIStateCore(AState);
  ApplyCommandRestrictionOnEditableControl(AState,
    DocumentModel.DocumentCapabilities.Numbering.MultiLevel, AState.Enabled);
  ApplyDocumentProtectionToSelectedParagraphs(AState);
...
procedure TdxInsertSimpleListCommand.FillParagraphsLevelIndex
  (AParagraphIntervals: TdxParagraphIntervalList);
var
  AParagraphIntervalIndex: Integer;
  I, AStartParagraphIndex, AEndParagraphIndex: TdxParagraphIndex;
...
procedure TdxInsertSimpleListCommand.StoreOriginalLevelLeftIndent
  (const ALevel: IdxListLevel);
begin
  ALevel.ListLevelProperties.OriginalLeftIndent :=
    ALevel.ParagraphProperties.LeftIndent;
end;

procedure TdxInsertSimpleListCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  inherited UpdateUIStateCore(AState);
  ApplyCommandRestrictionOnEditableControl(AState,
    DocumentModel.DocumentCapabilities.Numbering.Simple);
  ApplyDocumentProtectionToSelectedParagraphs(AState);
end;
...
procedure TdxInsertBulletListCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  inherited UpdateUIStateCore(AState);
  ApplyCommandRestrictionOnEditableControl(AState,
    DocumentModel.DocumentCapabilities.Numbering.Bulleted);
  ApplyDocumentProtectionToSelectedParagraphs(AState);
end;

{ TdxDeleteNumerationFromParagraphCommand }

procedure TdxDeleteNumerationFromParagraphCommand.ChangeSelection
  (ASelection: TdxSelection);
begin
end;

procedure TdxDeleteNumerationFromParagraphCommand.DeleteNumerationFromParagraph
  (AParagraph: TdxParagraph);
begin
...
procedure TdxDeleteNumerationFromParagraphCommand.ModifyParagraphsCore
  (AStartParagraphIndex, AEndParagraphIndex: TdxParagraphIndex);
var
  I: TdxParagraphIndex;
  AParagraph: TdxParagraph;
...
begin
  inherited Create(AControl);
  FDeleteNumerationCommand := TdxDeleteNumerationFromParagraphCommand.Create
    (AControl);
end;
...
procedure TdxToggleListCommandBase.ForceExecute(const AState
  : IdxCommandUIState);
begin
...
procedure TdxToggleListCommandBase.UpdateUIState(const AState
  : IdxCommandUIState);
begin
  InsertNumerationCommand.UpdateUIState(AState);
end;

procedure TdxToggleListCommandBase.UpdateUIStateCore(const AState
  : IdxCommandUIState);
begin
end;
...
constructor TdxToggleBulletedListCommand.Create(const AControl
  : IdxRichEditControl);
begin
  inherited Create(AControl);
...
function TdxToggleBulletedListCommand.GetInsertNumerationCommand
  : TdxNumberingListCommandBase;
begin
...
constructor TdxToggleSimpleNumberingListCommand.Create(const AControl
  : IdxRichEditControl);
begin
  inherited Create(AControl);
...
function TdxToggleSimpleNumberingListCommand.GetInsertNumerationCommand
  : TdxNumberingListCommandBase;
begin
  Result := FInsertNumerationCommand;
end;
...
constructor TdxToggleMultiLevelListCommand.Create(const AControl
  : IdxRichEditControl);
begin
  inherited Create(AControl);
...
function TdxToggleMultiLevelListCommand.GetInsertNumerationCommand
  : TdxNumberingListCommandBase;
begin
  Result := FInsertNumerationCommand;
end;
...
procedure TdxIncrementNumerationFromParagraphCommand.ChangeSelection
  (ASelection: TdxSelection);
begin
end;

class function TdxIncrementNumerationFromParagraphCommand.
...
class function TdxIncrementNumerationFromParagraphCommand.Id
  : TdxRichEditCommandId;
begin
  Result := TdxRichEditCommandId.IncrementNumerationFromParagraph;
end;

procedure TdxIncrementNumerationFromParagraphCommand.
  IncrementNumerationFromParagraph(AParagraph: TdxParagraph;
...
begin
  ...
  AParagraph.ParagraphProperties.ResetUse
    ([TdxUsedParagraphFormattingOption.UseFirstLineIndent,
    TdxUsedParagraphFormattingOption.UseLeftIndent]);
  ActivePieceTable.AddNumberingListToParagraph(AParagraph, ANumberingListIndex,
    AListLevelIndex);
end;

procedure TdxIncrementNumerationFromParagraphCommand.ModifyParagraphsCore
  (AStartParagraphIndex, AEndParagraphIndex: TdxParagraphIndex);
var
  AParagraph: TdxParagraph;
...
begin
  ...
  begin
    ...
    begin
      ...
      IncrementNumerationFromParagraph(AParagraph, AListLevelIndex,
        ANumberingListIndex);
    end;
  end;
end;
...
procedure TdxNumerationParagraphIndentCommandBase.
  AssignNumberingListLeftIndentModifier(AAbstractNumberingList
  : TdxAbstractNumberingList; ATargetNumberingOrBulletPosition: Integer);
var
  ALevels: TdxListLevelCollection;
...
begin
  ...
  ADelta := CalculateLeftIndentDelta(ATargetNumberingOrBulletPosition,
    AFirstLevel.LeftIndent, AFirstLevel.FirstLineIndent,
    AFirstLevel.FirstLineIndentType);
  for I := 0 to ALevels.Count - 1 do
  begin
...
function TdxNumerationParagraphIndentCommandBase.
  CalculateCurrentBulletOrNumberingPosition(ALeftIndent, AFirstLineIndent
  : Integer; AFirstLineIndentType: TdxParagraphFirstLineIndent): Integer;
begin
...
function TdxNumerationParagraphIndentCommandBase.CalculateLeftIndentDelta
  (ATargetNumerationOrBulletPosition, ACurrentLeftIndent, AFirstLineIndent
  : Integer; AFirstLineIndentType: TdxParagraphFirstLineIndent): Integer;
begin
  Result := ATargetNumerationOrBulletPosition -
    CalculateCurrentBulletOrNumberingPosition(ACurrentLeftIndent,
    AFirstLineIndent, AFirstLineIndentType);
end;

procedure TdxNumerationParagraphIndentCommandBase.ModifyDocumentModelCore
  (const AState: IdxCommandUIState);
var
  AParagraph: TdxParagraph;
...
begin
  ...
  if ANumberingListIndex < 0 then
    Exit;
  AAbstractNumberingList := DocumentModel.NumberingLists[ANumberingListIndex]
    .AbstractNumberingList;
  AFirstLevel := TdxListLevel(AAbstractNumberingList.Levels[0]);
  ACurrentBulletOrNumberingPosition := CalculateCurrentBulletOrNumberingPosition
    (AFirstLevel.LeftIndent, AFirstLevel.FirstLineIndent,
    AFirstLevel.FirstLineIndentType);
  AssignNewIndentCore(AAbstractNumberingList,
    ACurrentBulletOrNumberingPosition);
end;
...
procedure TdxIncrementNumerationParagraphIndentCommand.AssignNewIndentCore
  (AAbstractNumberingList: TdxAbstractNumberingList;
  ACurrentNumberingOrBulletPosition: Integer);
var
  ANearestRightDefaultTab, ANearestRightTab: Integer;
begin
  ANearestRightDefaultTab := GetNearRightDefaultTab
    (ACurrentNumberingOrBulletPosition);
  ANearestRightTab := GetNearRightTab(ACurrentNumberingOrBulletPosition);
  if (ANearestRightDefaultTab < ANearestRightTab) or
    (ANearestRightTab = ACurrentNumberingOrBulletPosition) then
    AssignNumberingListLeftIndentModifier(AAbstractNumberingList,
      ANearestRightDefaultTab)
  else
    AssignNumberingListLeftIndentModifier(AAbstractNumberingList,
      ANearestRightTab);
end;
...
class function TdxIncrementNumerationParagraphIndentCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
procedure TdxDecrementNumerationFromParagraphCommand.ChangeSelection
  (ASelection: TdxSelection);
begin
end;

class function TdxDecrementNumerationFromParagraphCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
class function TdxDecrementNumerationFromParagraphCommand.Id
  : TdxRichEditCommandId;
begin
  Result := TdxRichEditCommandId.DecrementNumerationFromParagraph;
end;

procedure TdxDecrementNumerationFromParagraphCommand.ModifyParagraphsCore
  (AStartParagraphIndex, AEndParagraphIndex: TdxParagraphIndex);
var
  I: TdxParagraphIndex;
  AListLevelIndex: Integer;
  ...
  begin
    ...
    begin
      ...
      AParagraph.ParagraphProperties.ResetUse
        ([TdxUsedParagraphFormattingOption.UseFirstLineIndent,
        TdxUsedParagraphFormattingOption.UseLeftIndent]);
      ActivePieceTable.AddNumberingListToParagraph(AParagraph,
        ANumberingListIndex, AListLevelIndex);
    end;
  end;
end;
...
begin
  ANearLeftDefaultTab := GetNearLeftDefaultTab
    (ACurrentNumberingOrBulletPosition);
  ANearLeftTab := GetNearLeftTab(ACurrentNumberingOrBulletPosition);

  if (ANearLeftDefaultTab > ANearLeftTab) or
    (ANearLeftTab = ACurrentNumberingOrBulletPosition) then
    AssignNumberingListLeftIndentModifier(AAbstractNumberingList,
      ANearLeftDefaultTab)
  else
...
class function TdxDecrementNumerationParagraphIndentCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
begin
  if IsRunBeforePage(APage) then
    Result := 1
  else if IsRunAfterPage(APage) then
    Result := -1
  else
    Result := 0;
end;
...
begin
  ...
  Result := (FIndex < AStartPos.RunIndex) or
    ((FIndex = AStartPos.RunIndex) and (AStartPos.Offset > 0));
end;
...
begin
  if IsRunBeforeColumn(AColumn) then
    Result := 1
  else if IsRunAfterColumn(AColumn) then
    Result := -1
  else
    Result := 0;
end;
...
function TdxPageAreaRunComparer.IsRunAfterPageArea
  (APageArea: TdxPageArea): Boolean;
var
  AEndPos: TdxFormatterPosition;
begin
...
function TdxPageAreaRunComparer.IsRunBeforePageArea
  (APageArea: TdxPageArea): Boolean;
var
  AStartPos: TdxFormatterPosition;
begin
...
begin
  if IsRunBeforePageArea(APageArea) then
    Result := 1
  else if IsRunAfterPageArea(APageArea) then
    Result := -1
  else
    Result := 0;
end;
...
begin
  if IsRunBeforeRow(ARow) then
    Result := 1
  else if IsRunAfterRow(ARow) then
    Result := -1
  else
    Result := 0;
end;
...
constructor TdxInsertListFormCommand.Create(const AControl: IdxRichEditControl;
  AList: TdxAbstractNumberingList; ALevelIndex: Integer;
...
function TdxInsertListFormCommand.ShouldAddNumberingListToParagraphs
  (AParagraphIntervals: TdxParagraphIntervalList): Boolean;
begin
  Result := True;
end;

function TdxInsertListFormCommand.GetListIndex(AParagraphIntervals
  : TdxParagraphIntervalList): TdxNumberingListIndex;
var
  ACalculator: TdxNumberingListIndexCalculator;
begin
...
procedure TdxInsertListFormCommand.AddNumberingListToParagraph
  (AParagraph: TdxParagraph; AListIndex: TdxNumberingListIndex;
  AListLevelIndex: Integer);
begin
  inherited AddNumberingListToParagraph(AParagraph, AListIndex,
    AListLevelIndex);
  AParagraph.ParagraphProperties.ResetUse
    ([TdxUsedParagraphFormattingOption.UseFirstLineIndent,
    TdxUsedParagraphFormattingOption.UseLeftIndent]);
...
function TdxInsertListFormCommand.CalculateParagraphListLevel
  (AParagraph: TdxParagraphBase; ALeftIndent: Integer): Integer;
begin
  case FMode of
    TdxInsertListMode.KeepLevelIndex:
      if AParagraph.IsInList then
        ...
        Result := inherited CalculateParagraphListLevel(AParagraph,
          ALeftIndent);
...
constructor TdxHeaderFooterParagraphLayoutPosition.Create(const AControl
  : IdxRichEditControl; APage: TdxPage; AArea: TdxPageArea);
begin
  inherited Create(AControl);
  Assert(APage <> nil);
  Assert(AArea <> nil);
...
function TdxHeaderFooterParagraphLayoutPosition.LookupPage
  (APages: TdxPageCollection; ARunIndex: TdxRunIndex): TdxPage;
begin
  Result := FPage;
end;

function TdxHeaderFooterParagraphLayoutPosition.LookupPageArea(APage: TdxPage;
  AParagraph: TdxParagraph; ARunIndex: TdxRunIndex): TdxPageArea;
begin
  Result := FArea;
end;
...
procedure TdxChangeSectionLineNumberingCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  AState.Enabled := IsContentEditable;
  AState.Visible := True;
  ApplyCommandRestrictionOnEditableControl(AState,
    DocumentModel.DocumentCapabilities.Sections, AState.Enabled);
...
function TdxSetPredefinedSectionLineNumberingCommand.CreateModifier
  (const AState: IdxCommandUIState)
  : TdxSectionPropertyModifier<TdxLineNumberingRestart>;
begin
  Result := TdxPieceTableModifiers.
    CreateSectionLineNumberingStepAndRestartModifier(LineNumberingRestart);
end;

function TdxSetPredefinedSectionLineNumberingCommand.IsCheckedValue
  (AValue: TdxLineNumberingRestart): Boolean;
begin
...
function TdxSetSectionLineNumberingNoneCommand.GetLineNumberingRestart
...
class function TdxSetSectionLineNumberingContinuousCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
function TdxSetSectionLineNumberingContinuousCommand.GetLineNumberingRestart
  : TdxLineNumberingRestart;
begin
...
class function TdxSetSectionLineNumberingContinuousCommand.Id
  : TdxRichEditCommandId;
begin
...
class function TdxSetSectionLineNumberingRestartNewPageCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
function TdxSetSectionLineNumberingRestartNewPageCommand.GetLineNumberingRestart
  : TdxLineNumberingRestart;
begin
...
class function TdxSetSectionLineNumberingRestartNewPageCommand.Id
  : TdxRichEditCommandId;
begin
...
class function TdxSetSectionLineNumberingRestartNewSectionCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString
...
function TdxSetSectionLineNumberingRestartNewSectionCommand.
  GetLineNumberingRestart: TdxLineNumberingRestart;
begin
...
class function TdxSetSectionLineNumberingRestartNewSectionCommand.Id
  : TdxRichEditCommandId;
begin
