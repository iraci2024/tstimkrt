...
type
  ...
  strict private
    ...
    procedure SetSectionStartType(const AValue
      : TdxNullableValue<TdxSectionStartType>);
  ...
  public
    ...
    property ValueUnitConverter: TdxDocumentModelUnitConverter
      read FValueUnitConverter write FValueUnitConverter;

    property AvailableApplyType: TdxSectionPropertiesApplyTypes
      read GetAvailableApplyType;
    property ApplyType: TdxSectionPropertiesApplyType read GetApplyType
      write SetApplyType;
    property LeftMargin: TdxNullableInteger read GetLeftMargin
      write SetLeftMargin;
    property RightMargin: TdxNullableInteger read GetRightMargin
      write SetRightMargin;
    property TopMargin: TdxNullableInteger read GetTopMargin write SetTopMargin;
    property BottomMargin: TdxNullableInteger read GetBottomMargin
      write SetBottomMargin;
    property PaperWidth: TdxNullableInteger read GetPaperWidth
      write SetPaperWidth;
    property PaperHeight: TdxNullableInteger read GetPaperHeight
      write SetPaperHeight;
    property DifferentFirstPage: TdxNullableBoolean read GetDifferentFirstPage
      write SetDifferentFirstPage;
    property DifferentOddAndEvenPages: TdxNullableBoolean
      read GetDifferentOddAndEvenPages write SetDifferentOddAndEvenPages;
    property SectionStartType: TdxNullableValue<TdxSectionStartType>
      read GetSectionStartType write SetSectionStartType;
    ...
    property PaperKind: TdxNullableValue<TdxPaperKind> read GetPaperKind
      write SetPaperKind;
...
constructor TdxPageSetupFormControllerParameters.Create(const AControl
  : IdxRichEditControl; APageSetupInfo: TdxPageSetupInfo);
begin
...
constructor TdxPageSetupFormController.Create(AControllerParameters
  : TdxPageSetupFormControllerParameters);
var
...
begin
  ...
  if PaperWidth.HasValue then
    ...
    FCustomWidth := AUnitConverter.TwipsToModelUnits
      (TdxPaperSizeCalculator.CalculatePaperSize(TdxPaperKind.Letter).Width);
  if PaperHeight.HasValue then
    FCustomHeight := PaperHeight.Value
  else
    FCustomHeight := AUnitConverter.TwipsToModelUnits
      (TdxPaperSizeCalculator.CalculatePaperSize(TdxPaperKind.Letter).Height);
...
function TdxPageSetupFormController.GetAvailableApplyType
...
procedure TdxPageSetupFormController.SetApplyType(const AValue
...
procedure TdxPageSetupFormController.SetLeftMargin(const AValue
  : TdxNullableInteger);
begin
...
procedure TdxPageSetupFormController.SetRightMargin(const AValue
  : TdxNullableInteger);
begin
...
procedure TdxPageSetupFormController.SetTopMargin(const AValue
  : TdxNullableInteger);
begin
...
procedure TdxPageSetupFormController.SetBottomMargin(const AValue
  : TdxNullableInteger);
begin
...
procedure TdxPageSetupFormController.SetPaperWidth(const AValue
  : TdxNullableInteger);
begin
...
procedure TdxPageSetupFormController.SetPaperHeight(const AValue
  : TdxNullableInteger);
begin
...
procedure TdxPageSetupFormController.SetDifferentFirstPage
  (const AValue: TdxNullableBoolean);
begin
  FPageSetupInfo.DifferentFirstPage := AValue;
end;

function TdxPageSetupFormController.GetDifferentOddAndEvenPages
  : TdxNullableBoolean;
begin
  Result := FPageSetupInfo.DifferentOddAndEvenPages;
end;

procedure TdxPageSetupFormController.SetDifferentOddAndEvenPages
  (const AValue: TdxNullableBoolean);
begin
  FPageSetupInfo.DifferentOddAndEvenPages := AValue;
end;

function TdxPageSetupFormController.GetSectionStartType
  : TdxNullableValue<TdxSectionStartType>;
begin
  Result := FPageSetupInfo.SectionStartType;
end;

procedure TdxPageSetupFormController.SetSectionStartType
  (const AValue: TdxNullableValue<TdxSectionStartType>);
begin
...
function TdxPageSetupFormController.GetPaperKind
  : TdxNullableValue<TdxPaperKind>;
begin
  Result := FPageSetupInfo.PaperKind;
end;

procedure TdxPageSetupFormController.SetPaperKind(const AValue
  : TdxNullableValue<TdxPaperKind>);
var
  ASize: TSize;
  AUnitConverter: TdxDocumentModelUnitConverter;
...
begin
  ...
  begin
    AUnitConverter := FControl.InnerControl.DocumentModel.UnitConverter;
    ASize := AUnitConverter.TwipsToModelUnits
      (TdxPaperSizeCalculator.CalculatePaperSize(PaperKind.Value));
...
procedure TdxPageSetupFormController.SetLandscape(const AValue
  : TdxNullableBoolean);
begin
...
begin
  ...
  FPageSetupInfo.PaperKind := TdxPaperSizeCalculator.CalculatePaperKind(ASize,
    TdxPaperKind.Custom);
end;
