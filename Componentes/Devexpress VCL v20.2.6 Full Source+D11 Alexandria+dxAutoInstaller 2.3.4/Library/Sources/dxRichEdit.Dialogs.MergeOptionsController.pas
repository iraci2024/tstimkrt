...
type
  ...
  public
    ...
    property MergeRecordsParameters: TdxMergeRecordsParameters
      read FMergeRecordsParameters;
  end;
  ...
  public
    ...
    property MergeRecordsParameters: TdxMergeRecordsParameters
      read GetMergeRecordsParameters;
...
constructor TdxMergeOptionsFormControllerParameters.Create(const AControl
  : IdxRichEditControl; const AMergeRecordsParameters
...
constructor TdxMergeOptionsFormController.Create(AControllerParameters
  : TdxMergeOptionsFormControllerParameters);
begin
  inherited Create;
  FControl := AControllerParameters.Control;
  FMergeDestination := AControllerParameters.MergeRecordsParameters.
    MergeDestination;
  FMergeRecords := AControllerParameters.MergeRecordsParameters.MergeRecords;
end;

function TdxMergeOptionsFormController.GetMergeRecordsParameters
  : TdxMergeRecordsParameters;
begin
