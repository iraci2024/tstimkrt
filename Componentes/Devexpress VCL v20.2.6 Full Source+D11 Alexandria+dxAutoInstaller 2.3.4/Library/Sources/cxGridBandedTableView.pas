...
type
  ...
  public
    ...
    property VisibleRowIndex: Integer read FVisibleRowIndex
      write FVisibleRowIndex;
  end;
  ...
  public
    ...
    ColIndex: Integer;
    RowIndex: Integer;
    constructor Create(AColumnIndex: Integer; ABand: TcxGridBand;
  ...
  protected
    ...
    property SourceItem: TcxGridBandedColumn read GetSourceItem
      write SetSourceItem;
  ...
  protected
    ...
    property CustomizationForm: TcxGridBandedTableCustomizationForm
      read GetCustomizationForm;
    property DestBand: TcxGridBand read FDestBand write SetDestBand;
    property DestBandContainerKind: TcxGridBandContainerKind
      read FDestBandContainerKind write SetDestBandContainerKind;
    ...
    property IsEmptyViewInsert: Boolean read FIsEmptyViewInsert
      write SetIsEmptyViewInsert;
    ...
    property SourceBandContainerKind: TcxGridBandContainerKind
      read FSourceBandContainerKind write FSourceBandContainerKind;
    property ViewInfo: TcxGridBandedTableViewInfo read GetViewInfo;
  public
  ...
  TcxGridBandedColumnsCustomizationPopup = class
  ...
  protected
    function FindNextItemFollowVisualOrder(AFocusedItemIndex: Integer;
      AGoForward, AGoOnCycle: Boolean; out ACycleChanged: Boolean;
      ARecord: TcxCustomGridRecord): Integer; virtual;
    function FindNextItemTabOrder(AFocusedItemIndex: Integer;
      AGoForward, AGoOnCycle: Boolean; out ACycleChanged: Boolean;
      ARecord: TcxCustomGridRecord): Integer; virtual;
    function GetBandsCustomizationPopupClass
      : TcxGridBandsCustomizationPopupClass; virtual;
    ...
    function GetColumnHeaderDragAndDropObjectClass
      : TcxGridColumnHeaderMovingObjectClass; override;
    procedure GetColumnNeighbors(AColumn: TcxGridBandedColumn;
      AGoForward: Boolean; AList: TList); virtual;
    ...
    property ForcingWidthBand: TcxGridBand read FForcingWidthBand
  ...
  public
    ...
    property BandsCustomizationPopup: TcxGridBandsCustomizationPopup
  ...
  TcxGridIndicatorBandHeaderItemPainter = class
  ...
  protected
    ...
    function ExcludeFromClipRect: Boolean; override;
    procedure Paint; override;
    property ViewInfo: TcxGridBandedDataRowCellsAreaItemViewInfo
      read GetViewInfo;
  end;
  ...
  public
    class procedure DrawDataRowCells(ARowViewInfo
      : TcxCustomGridRowViewInfo); override;
  end;
  ...
  TcxGridBandedColumnHeaderVertSizingEdgeViewInfo = class
  ...
  public
    constructor Create(AContainer: TcxGridColumnContainerViewInfo;
      AColumn: TcxGridColumn); override;
    //
    property Column: TcxGridBandedColumn read GetColumn;
  ...
  public
    constructor Create(ABandViewInfo: TcxGridBandViewInfo);
      reintroduce; virtual;
  ...
  private
    ...
    function GetBandViewInfo: TcxGridBandViewInfo;
    function GetColumnViewInfo(Index: Integer)
  ...
  public
    Bounds: TRect;
    constructor Create(ARowsViewInfo: TcxGridBandRowsViewInfo;
    ...
    property ColumnViewInfos[Index: Integer]: TcxGridBandedColumnHeaderViewInfo
      read GetColumnViewInfo; default;
  ...
  public
    ...
    property IsRightToLeftConverted: Boolean read FIsRightToLeftConverted
      write FIsRightToLeftConverted;
    property Items[Index: Integer]: TcxGridBandRowViewInfo
  ...
  protected
    ...
    class function GetHeaderViewInfoClass
      : TcxGridBandHeaderViewInfoClass; virtual;
    function GetHitTestClass: TcxCustomGridHitTestClass; override;
  ...
  public
    constructor Create(ABandsViewInfo: TcxGridBandsViewInfo;
      AIndex: Integer); virtual;
    destructor Destroy; override;
    ...
    property ChildBandViewInfos[Index: Integer]: TcxGridBandViewInfo
      read GetChildBandViewInfo;
    property ColumnViewInfoCount: Integer read GetColumnViewInfoCount;
    property ColumnViewInfos[Index: Integer]: TcxGridBandedColumnHeaderViewInfo
      read GetColumnViewInfo; default;
    property ContainerViewInfo: TcxGridBandedHeaderViewInfo
    ...
    property SameLevelItems[Index: Integer]: TcxGridBandViewInfo
      read GetSameLevelItem;
  ...
  private
    ...
    function GetLastFixedItem(AFixedKind: TcxGridBandFixedKind;
    ...
    procedure DestroyItems;
  protected
    function AddIndicatorItems(AIndicatorViewInfo: TcxGridIndicatorViewInfo;
      ATopBound: Integer): Boolean; virtual;
    procedure AddAdornerTargetElements(AList: TStrings); virtual;
    procedure Calculate; virtual;
    function CalculateBandHeaderHeight(ABandHeaderViewInfo
      : TcxGridBandHeaderViewInfo): Integer; virtual;
    procedure CalculateBandHeaderRowHeights; virtual;
    function CalculateBandHeadersAreaHeight: Integer; virtual;
    procedure CalculateColumnWidths; virtual;
    function CalculateHeight: Integer; virtual;
    function CalculateWidth: Integer; virtual;
    function DrawBandHeaderBackgroundHandler(ACanvas: TcxCanvas;
    ...
    property InternalItems[Index: Integer]: TcxGridBandViewInfo
      read GetInternalItem;
  public
    constructor Create(AContainerViewInfo
      : TcxGridBandedHeaderViewInfo); virtual;
    destructor Destroy; override;
    ...
    property BandHeaderBackgroundBitmap: TBitmap
      read GetBandHeaderBackgroundBitmap;
    property BandHeaderRowCount: Integer read GetBandHeaderRowCount;
    property BandHeaderRowHeights[Index: Integer]: Integer
      read GetBandHeaderRowHeight write SetBandHeaderRowHeight;
    property Bands: TcxGridBands read GetBands;
    property BottomItemCount: Integer read GetBottomItemCount;
    property BottomItems[Index: Integer]: TcxGridBandViewInfo
      read GetBottomItem;
    property ContainerViewInfo: TcxGridBandedHeaderViewInfo
    ...
    property LastFixedItems[AFixedKind: TcxGridBandFixedKind;
      ALevelIndex: Integer]: TcxGridBandViewInfo read GetLastFixedItem;
  ...
  public
    ...
    property GridView: TcxGridBandedTableView read GetGridView;
    property GridViewInfo: TcxGridBandedTableViewInfo read GetGridViewInfo;
    property Items[Index: Integer]: TcxGridBandedColumnHeaderViewInfo
      read GetItem; default;
    property LineCount: Integer read GetLineCount;
    property RowCount: Integer read GetRowCount;
  ...
  TcxGridBandedDataRowCellsAreaItemViewInfoClass = class of
  ...
  protected
    ...
    property BandViewInfo: TcxGridBandViewInfo read FBandViewInfo;
    property CellsAreaViewInfo: TcxGridBandedDataRowCellsAreaViewInfo
  ...
  public
    constructor Create(ACellsAreaViewInfo
    ...
    property FixedBandsSeparatorLocation: TcxGridFixedBandsSeparatorLocation
      read GetFixedBandsSeparatorLocation;
  ...
  protected
    ...
    function GetItemClass
      : TcxGridBandedDataRowCellsAreaItemViewInfoClass; virtual;
    procedure Offset(DX, DY: Integer); override;
    property BandsViewInfo: TcxGridBandsViewInfo read GetBandsViewInfo;
    property GridViewInfo: TcxGridBandedTableViewInfo read GetGridViewInfo;
  public
    ...
    property Count: Integer read GetCount;
    property Items[Index: Integer]: TcxGridBandedDataRowCellsAreaItemViewInfo
      read GetItem; default;
  end;
  ...
  protected
    function GetColumnFooterWidth(AFooterViewInfo: TcxGridFooterViewInfo;
      AColumn: TcxGridColumn): Integer; override;
    ...
    function GetHeaderViewInfoSpecificClass
      : TcxGridHeaderViewInfoSpecificClass; override;
  ...
  public
    ...
    property GridView: TcxGridBandedTableView read GetGridView;
  published
    property Options: TcxGridBandedColumnOptions read GetOptions
      write SetOptions;
    property Position: TcxGridBandedColumnPosition read FPosition
      write SetPosition;
  ...
  public
    ...
    property VisibleItems[Index: Integer]: TcxGridBandedColumn
      read GetVisibleItem;
  end;
  ...
  public
    ...
    procedure MoveColumn(AColumn: TcxGridBandedColumn;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property HoldOwnColumnsOnly: Boolean read FHoldOwnColumnsOnly
      write SetHoldOwnColumnsOnly default False;
  ...
  TcxGridBandGetHeaderStyle = procedure(Sender: TcxGridBandedTableView;
    ABand: TcxGridBand;
{$IFDEF BCBCOMPATIBLE}var {$ELSE}out {$ENDIF} AStyle: TcxStyle) of object;
  ...
  published
    property Background: TcxStyle index bsBackground read GetValue
      write SetValue;
  ...
  private
    ...
    procedure SetOnGetStoredPropertyValue
      (Value: TcxGridBandGetStoredPropertyValueEvent);
    procedure SetOnSetStoredPropertyValue
      (Value: TcxGridBandSetStoredPropertyValueEvent);
  ...
  protected
    ...
    property ChildItemVisibles[Index: Integer]: Boolean
      read GetChildItemVisible;
    ...
    property ParentBandWithAssignedWidth: TcxGridBand
      read GetParentBandWithAssignedWidth;
  public
    ...
    property FirstVisibleChildBottomBand: TcxGridBand
      read GetFirstVisibleChildBottomBand;
    property GridView: TcxGridBandedTableView read GetGridView;
    ...
    property VisibleChildBands[Index: Integer]: TcxGridBand
      read GetVisibleChildBand;
    property VisibleIndex: Integer read FVisibleIndex;
    property VisibleRootIndex: Integer read FVisibleRootIndex;
  published
    property Alignment: TAlignment read FHeaderAlignmentHorz
      write SetHeaderAlignmentHorz stored False; // for compatibility
    property AlternateCaption: string read FAlternateCaption
      write SetAlternateCaption;
    property Caption: string read FCaption write SetCaption;
    property FixedKind: TcxGridBandFixedKind read FFixedKind write SetFixedKind
      default fkNone;
    property HeaderAlignmentHorz: TAlignment read FHeaderAlignmentHorz
      write SetHeaderAlignmentHorz default taCenter;
    property HeaderAlignmentVert: TcxAlignmentVert read FHeaderAlignmentVert
      write SetHeaderAlignmentVert default vaCenter;
  ...
  TcxGridBandsLayout = (blNonFixed, blLeftFixed, blRightFixed,
    blLeftRightFixed);

  TcxGridBandsClass = class of TcxGridBands;

  TcxGridBands = class(TcxOwnedInterfacedCollection, IcxStoredObject,
    IcxStoredParent)
  private
    FBottomItems: TList;
    FGridView: TcxGridBandedTableView;
  ...
  protected
    ...
    procedure BandVisibilityChanged(ABand: TcxGridBand;
  ...
  public
    ...
    function GetFirstVisibleRootIndex(AFixedKind: TcxGridBandFixedKind)
      : Integer;
    ...
    property GridView: TcxGridBandedTableView read FGridView;
    property Items[Index: Integer]: TcxGridBand read GetItem
    ...
    property VisibleBottomItems[Index: Integer]: TcxGridBand
      read GetVisibleBottomItem;
    property VisibleCount: Integer read GetVisibleCount;
    ...
    property VisibleRootItems[Index: Integer]: TcxGridBand
  ...
  public
    procedure Assign(Source: TPersistent); override;
  published
    property BandBackground: TBitmap index bbBandBackground read GetValue
      write SetValue;
    property BandHeader: TBitmap index bbBandHeader read GetValue
      write SetValue;
  end;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property BandHeaderHints: Boolean read FBandHeaderHints
      write SetBandHeaderHints default True;
  end;
  ...
  private
    ...
    procedure SetBandsQuickCustomizationReordering
  ...
  published
    ...
    property BandMoving: Boolean read FBandMoving write SetBandMoving
      default True;
    property BandSizing: Boolean read FBandSizing write SetBandSizing
      default True;
    ...
    property BandsQuickCustomizationReordering
      : TcxGridQuickCustomizationReordering
      read FBandsQuickCustomizationReordering
      write SetBandsQuickCustomizationReordering default qcrDefault;
  ...
  public
    ...
    property GridView: TcxGridBandedTableView read GetGridView;
  published
    property BandCaptionsInColumnAlternateCaption: Boolean
      read FBandCaptionsInColumnAlternateCaption
    ...
    property BandHeaderHeight: Integer read FBandHeaderHeight
      write SetBandHeaderHeight default 0;
    property BandHeaderLineCount: Integer read FBandHeaderLineCount
      write SetBandHeaderLineCount default 1;
    property BandHeaders: Boolean read FBandHeaders write SetBandHeaders
      default True;
    ...
    property FixedBandSeparatorWidth: Integer read FFixedBandSeparatorWidth
      write SetFixedBandSeparatorWidth
  ...
  public
    ...
    property GridView: TcxGridBandedTableView read GetGridViewValue;
  published
    property BandBackground: TcxStyle index vsBandBackground read GetValue
      write SetValue;
    property BandHeader: TcxStyle index vsBandHeader read GetValue
      write SetValue;
    property StyleSheet;
    property OnGetBandHeaderStyle: TcxGridBandGetHeaderStyle
      read FOnGetBandHeaderStyle write SetOnGetBandHeaderStyle;
  end;
  ...
  published
    property Styles: TcxGridBandedTableViewStyles read GetStylesValue
  ...
  TcxGridBandEvent = procedure(Sender: TcxGridBandedTableView;
    ABand: TcxGridBand) of object;

  TcxGridBandQuickCustomizationColumnCompareEvent = procedure
    (var ACompareFunction: TListSortCompare) of object;
  ...
  strict private
    ...
    FOnQuickCustomizationColumnCompare
      : TcxGridBandQuickCustomizationColumnCompareEvent;
    ...
    procedure SetOnCustomDrawBandHeader
  ...
  protected
    ...
    procedure AssignColumnsParams(AAssignBandIndexes, AAssignOtherIndexes
      : Boolean);
    ...
    procedure DoCustomDrawBandHeader(ACanvas: TcxCanvas;
      AViewInfo: TcxGridBandHeaderViewInfo; var ADone: Boolean); virtual;
  ...
  public
    ...
    property Columns[Index: Integer]: TcxGridBandedColumn read GetColumn
      write SetColumn;
    property Controller: TcxGridBandedTableController read GetController;
    property GroupedColumns[Index: Integer]: TcxGridBandedColumn
      read GetGroupedColumn;
    property ViewInfo: TcxGridBandedTableViewInfo read GetViewInfo;
    property VisibleColumns[Index: Integer]: TcxGridBandedColumn
      read GetVisibleColumn;
  published
    property BackgroundBitmaps: TcxGridBandedTableBackgroundBitmaps
      read GetBackgroundBitmaps write SetBackgroundBitmaps;
    property Bands: TcxGridBands read FBands write SetBands;
    property OptionsBehavior: TcxGridBandedTableOptionsBehavior
      read GetOptionsBehavior write SetOptionsBehavior;
    property OptionsCustomize: TcxGridBandedTableOptionsCustomize
    ...
    property Styles: TcxGridBandedTableViewStyles read GetStyles
      write SetStyles;
    property OnBandPosChanged: TcxGridBandEvent read FOnBandPosChanged
      write SetOnBandPosChanged;
    property OnBandSizeChanged: TcxGridBandEvent read FOnBandSizeChanged
      write SetOnBandSizeChanged;
    property OnCustomDrawBandHeader: TcxGridBandCustomDrawHeaderEvent
      read FOnCustomDrawBandHeader write SetOnCustomDrawBandHeader;
    property OnQuickCustomizationColumnCompare
      : TcxGridBandQuickCustomizationColumnCompareEvent
      read FOnQuickCustomizationColumnCompare
      write FOnQuickCustomizationColumnCompare;
  end;

implementation

uses
  SysUtils, Math, Contnrs, cxGridStrs, cxCustomData, cxCheckListBox,
  cxLibraryConsts;
...
type
  TdxCustomGridQuickCustomizationControlAccess = class
...
procedure CheckItemIndexForInsert(var AIndex: Integer; ACount: Integer;
  AExistingItem: Boolean);
begin
  if AIndex < 0 then
    AIndex := 0;
  if AIndex > ACount - Ord(AExistingItem) then
    AIndex := ACount - Ord(AExistingItem);
end;

function CompareVisibleColumnPositions(APosition1,
  APosition2: TcxGridBandedColumnPosition): Integer;
begin
...
function TcxGridColumnHeaderVertSizingEdgeHitTest.DragAndDropObjectClass
...
function TcxGridBandHeaderHitTest.DragAndDropObjectClass
  : TcxCustomGridDragAndDropObjectClass;
begin
...
function TcxGridBandHeaderSizingEdgeHitTest.DragAndDropObjectClass
  : TcxCustomGridDragAndDropObjectClass;
begin
...
function TcxGridBandedColumnContainerZone.IsEqual
...
begin
  ...
  Result := inherited IsEqual(Value) and (ClassType = Value.ClassType) and
    (Band = AValue.Band) and (ColIndex = AValue.ColIndex) and
    (RowIndex = AValue.RowIndex);
end;
...
function TcxGridBandedColumnHeaderMovingObject.GetDestZone
  : TcxGridBandedColumnContainerZone;
begin
  Result := TcxGridBandedColumnContainerZone(inherited DestZone);
end;

function TcxGridBandedColumnHeaderMovingObject.GetSourceItem
  : TcxGridBandedColumn;
begin
  Result := TcxGridBandedColumn(inherited SourceItem);
end;

function TcxGridBandedColumnHeaderMovingObject.GetSourcePosition
  : TcxGridBandedColumnPosition;
begin
  Result := TcxGridBandedColumn(SourceItem).Position;
end;

function TcxGridBandedColumnHeaderMovingObject.GetViewInfo
  : TcxGridBandedTableViewInfo;
begin
  Result := TcxGridBandedTableViewInfo(inherited ViewInfo);
end;

procedure TcxGridBandedColumnHeaderMovingObject.SetSourceItem
...
procedure TcxGridBandedColumnHeaderMovingObject.CheckDestItemContainerKind
  (var AValue: TcxGridItemContainerKind);
begin
  inherited;
  if (AValue = ckHeader) and (DestZone.Band.Options.HoldOwnColumnsOnly or
    (SourceItem.Position.Band <> nil) and
    SourceItem.Position.Band.Options.HoldOwnColumnsOnly) and
...
procedure TcxGridBandedColumnHeaderMovingObject.DoColumnMovingToHeader;
  ...
  begin
    ...
    begin
      ...
      if SourcePosition.ColIndex < Result then
        Dec(Result);
    end;
  end;
...
function TcxGridBandedColumnHeaderMovingObject.GetArrowAreaBoundsForHeader
...
begin
  if DestZone.IsInsertion then
  begin
    ARowsViewInfo := ViewInfo.HeaderViewInfo.BandsViewInfo
      [DestZone.Band.VisibleIndex].RowsViewInfo;
...
begin
  ...
  if (DestItemContainerKind = ckHeader) and (DestZone.Band.FixedKind = fkNone)
  then
    Result := ViewInfo.ScrollableAreaBoundsHorz;
end;

function TcxGridBandedColumnHeaderMovingObject.
  IsValidDestinationForVisibleSource: Boolean;

  function IsValidForInsertion: Boolean;
  begin
    Result := (SourcePosition.Row.VisibleCount <> 1) or
  ...
  begin
    Result := (DestZone.RowIndex <> SourcePosition.VisibleRowIndex) or
...
begin
  if DestItemContainerKind = ckHeader then
    Result := (SourceItemContainerKind = ckGroupByBox) or
      (DestZone.Band <> SourcePosition.Band) or DestZone.IsInsertion and
      IsValidForInsertion or not DestZone.IsInsertion and IsValidForMoving
  else
...
function TcxGridBandHeaderMovingObject.GetController
  : TcxGridBandedTableController;
begin
  Result := TcxGridBandedTableController(inherited Controller);
end;

function TcxGridBandHeaderMovingObject.GetCustomizationForm
...
procedure TcxGridBandHeaderMovingObject.SetDestBandContainerKind
  (Value: TcxGridBandContainerKind);
begin
...
procedure TcxGridBandHeaderMovingObject.SetDestInsertPosition
  (Value: TcxPosition);
begin
...
function TcxGridBandHeaderMovingObject.CalculateIsEmptyViewInsert
  (ACheckMousePos: Boolean): Boolean;
begin
  Result := (DestBandContainerKind = bcHeader) and
    (GridView.Bands.VisibleRootItemCount = 0) and
    (not ACheckMousePos or PtInRect(GridView.ViewInfo.ScrollableAreaBoundsHorz,
    CurMousePos));
end;
...
begin
  ...
  begin
    ...
    else if SourceBand.IsBottom and (SourceBand.ColumnCount <> 0) then
    begin
    ...
    if (AColumnsSource <> AColumnsDestination) and
      ...
      (AColumnsDestination <> nil) and
      AColumnsDestination.Options.HoldOwnColumnsOnly) then
      DestBand := nil;
  end;
end;

function TcxGridBandHeaderMovingObject.GetArrowAreaBounds
  (APlace: TcxGridArrowPlace): TRect;
begin
  ...
  begin
    Result := ViewInfo.HeaderViewInfo.BandsViewInfo[DestBand.VisibleIndex]
      .HeaderViewInfo.Bounds;
...
function TcxGridBandHeaderMovingObject.GetCustomizationFormListBox
  : TcxCustomGridItemsListBox;
begin
  Result := CustomizationForm.BandsListBox;
end;

function TcxGridBandHeaderMovingObject.GetSourceItemViewInfo
  : TcxCustomGridCellViewInfo;
begin
  if SourceBandContainerKind = bcHeader then
    Result := ViewInfo.HeaderViewInfo.BandsViewInfo[SourceBand.VisibleIndex]
      .HeaderViewInfo
  else
...
function TcxGridBandHeaderMovingObject.IsValidDestination: Boolean;
  ...
  begin
    with GridView.Bands do
      Result := GetLastVisibleIndex(AFixedKind) - GetFirstVisibleIndex
        (AFixedKind) + 1;
  end;
  ...
  begin
    ...
    if not Result and not SourceBand.Visible and
      ...
      case SourceBand.FixedKind of
        fkLeft:
          Result := ViewInfo.UseRightToLeftAlignment and
            (DestInsertPosition = posRight) and
            (DestBand.VisibleRootIndex = GridView.Bands.GetFirstVisibleRootIndex
            (fkNone)) or not ViewInfo.UseRightToLeftAlignment and
            (DestInsertPosition = posLeft) and
            (DestBand.VisibleRootIndex = GridView.Bands.
            GetFirstVisibleRootIndex(fkNone));
        fkNone:
          Result := (DestInsertPosition = posRight) and
            (ViewInfo.UseRightToLeftAlignment and
            (DestBand.VisibleRootIndex = GridView.Bands.GetLastVisibleRootIndex
            (fkRight)) or not ViewInfo.UseRightToLeftAlignment and
            (DestBand.VisibleRootIndex = GridView.Bands.GetLastVisibleRootIndex
            (fkLeft))) or (DestInsertPosition = posLeft) and
            (ViewInfo.UseRightToLeftAlignment and
            (DestBand.VisibleRootIndex = GridView.Bands.GetFirstVisibleRootIndex
            (fkLeft)) or not ViewInfo.UseRightToLeftAlignment and
            (DestBand.VisibleRootIndex = GridView.Bands.GetFirstVisibleRootIndex
            (fkRight)));
        fkRight:
          Result := ViewInfo.UseRightToLeftAlignment and
            ...
            (DestInsertPosition = posRight) and
            (DestBand.VisibleRootIndex = GridView.Bands.
            GetLastVisibleRootIndex(fkNone));
      end;
        ...
        posLeft, posRight:
          begin
            ...
            Result := (DestBand.ParentBand <> SourceBand.ParentBand) or
              (DestBand.Position.VisibleColIndex <>
              GetNearestColIndex(DestInsertPosition = APos));
          end;
        posTop:
          Result := (DestBand.ParentBand <> SourceBand) or
            (SourceBand.VisibleChildBandCount > 1);
        posBottom:
          Result := (SourceBand.ParentBand <> DestBand) or
            (DestBand.VisibleChildBandCount > 1);
      end;
  end;
end;
...
procedure TcxGridBandHeaderMovingObject.DragAndDrop(const P: TPoint;
...
begin
  ...
  begin
    ...
    ViewInfo.HeaderViewInfo.BandsViewInfo.InsertPositionAtPos(P, ABand,
      AInsertPosition);
    DestBand := ABand;
  ...
  CheckDestParams;
  Accepted := (DestBandContainerKind = bcCustomizationForm) or (DestBand <> nil)
    or IsEmptyViewInsert;
  inherited;
end;
...
var
  ...
  begin
    ...
    begin
      ...
      if ViewInfo.UseRightToLeftAlignment then
        ...
        APos := posRight;
      if FDestInsertPosition = APos then
        Inc(Result);
      if SourceBand.Position.ColIndex < Result then
        Dec(Result);
    end;
  end;
  ...
  var
    AColIndex, I: Integer;
  begin
    if (DestInsertPosition <> posBottom) and
      (GetParentBandIndex = SourceBand.Index) then
    begin
        ...
        begin
          ...
          while I < DestBand.VisibleChildBandCount do
            if DestBand.VisibleChildBands[I] <> SourceBand then
              DestBand.VisibleChildBands[I].Position.BandIndex :=
                SourceBand.Index
            else
              Inc(I);
        end;
  ...
  begin
    ...
    try
      if DestBand = nil then
        ...
        else if IsEmptyViewInsert then
        begin
...
procedure TcxGridBandHeaderMovingObject.Init(const P: TPoint;
...
function TcxGridColumnVertSizingObject.GetController
  : TcxGridBandedTableController;
begin
  Result := TcxGridBandedTableController(inherited Controller);
end;
...
begin
  Result := TcxGridBandedTableViewInfo(ViewInfo).HeaderViewInfo.BandsViewInfo
    [Band.VisibleIndex];
end;
...
procedure TcxGridBandSizingObject.Init(const P: TPoint;
  AParams: TcxCustomGridHitTest);
begin
  inherited;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        if ABand.CanMove and ABand.VisibleForCustomization and not ABand.Visible
        then
...
function TcxGridBandedTableBandsListBox.DrawItemDrawBackgroundHandler
  (ACanvas: TcxCanvas; const ABounds: TRect): Boolean;
begin
  Result := GridView.ViewInfo.HeaderViewInfo.BandsViewInfo.
    DrawBandHeaderBackgroundHandler(ACanvas, ABounds);
end;

function TcxGridBandedTableBandsListBox.GetDragAndDropParams
...
begin
  ...
  FBandsPage := CreatePage
    (cxGetResourceString(@scxGridCustomizationFormBandsPageCaption),
    AIsBandsVisible);
...
function TcxGridBandedTableCustomizationForm.GetBandsListBoxClass
  : TcxGridBandedTableBandsListBoxClass;
begin
...
procedure TcxGridBandsCustomizationPopup.AddCheckListBoxItems;
  ...
  procedure AddBandToItems(AItems: TdxCustomCheckListBoxItems;
    ABand: TcxGridBand);
  var
    I: Integer;
  begin
    if ABand.VisibleForCustomization then
      AItems.AddObject(ABand.GetAlternateCaption, ABand).Checked :=
        ABand.Visible;
...
begin
  Result := TcxGridBand(AItem).Options.Moving and
    not GridView.OptionsCustomize.BandsQuickCustomizationSorted;
end;
...
function TcxGridBandsCustomizationPopup.IsVisibleGridItem
  (AItem: TObject): Boolean;
begin
  Result := IsGridItem(AItem) and TcxGridBand(AItem).Visible;
end;

procedure TcxGridBandsCustomizationPopup.SetQuickCustomizationSorted
  (AValue: Boolean);
begin
...
procedure TcxGridBandsCustomizationPopup.HandleItemClicked(AItem: TObject;
  AChecked: Boolean);
var
  AItems: TList;
...
procedure TcxGridBandsCustomizationPopup.
  SynchronizeTableItemsVisibilityWithListBox;
var
  I: Integer;
begin
  for I := 0 to CheckListBox.Count - 1 do
    (CheckListBox.Items[I].Data as TcxGridBand).Visible :=
...
procedure TcxGridBandsCustomizationPopup.SetItemIndex(AItem: TObject;
  AIndex: Integer);
begin
...
function dxCompareBandedColumnsByActualPosition(AItem1,
  AItem2: TdxCustomCheckListBoxItem): Integer;
...
begin
  ...
  Result := GetRootBandIndexOf(AColumn1.Position.Band) -
    GetRootBandIndexOf(AColumn2.Position.Band);
  if Result = 0 then
    Result := AColumn1.Position.Band.Position.BandIndex -
      AColumn2.Position.Band.Position.BandIndex;
  if Result = 0 then
    Result := AColumn1.Position.Band.Position.ColIndex -
      AColumn2.Position.Band.Position.ColIndex;
  if Result = 0 then
...
function TcxGridBandedColumnsCustomizationPopup.GetGridView
  : TcxGridBandedTableView;
begin
  Result := TcxGridBandedTableView(inherited GridView);
end;
...
function TcxGridBandedTableController.GetBandsCustomizationPopup
  : TcxGridBandsCustomizationPopup;
begin
  if FBandsCustomizationPopup = nil then
    FBandsCustomizationPopup := GetBandsCustomizationPopupClass.Create
      (GridView);
...
var
  ...
  begin
    if FPressedBand.VisibleIndex = -1 then
      ...
      Result := ViewInfo.HeaderViewInfo.BandsViewInfo[FPressedBand.VisibleIndex]
        .HeaderViewInfo.Bounds;
  end;
...
begin
  Result := TcxGridBandedColumn(TData(AData).Columns[AItemIndex])
    .CanFocus(TData(AData).GridRecord);
end;

function TcxGridBandedTableController.FindNextItemFollowVisualOrder
  (AFocusedItemIndex: Integer; AGoForward, AGoOnCycle: Boolean;
...
begin
  ...
  try
    ...
    try
      ...
      if FindNextCustomItem(-1, AColumns.Count, True, False, @CanFocusColumn,
        AData, Result, ACycleChanged) then
        Result := TcxGridBandedColumn(AColumns[Result]).VisibleIndex
      else if AGoOnCycle then
      begin
        Result := FindNextItem(-1, AGoForward, False, True,
          ACycleChanged, ARecord);
        ACycleChanged := True;
      end
      else
        Result := -1;
...
function TcxGridBandedTableController.FindNextItemTabOrder(AFocusedItemIndex
  : Integer; AGoForward, AGoOnCycle: Boolean; out ACycleChanged: Boolean;
...
begin
  ...
  try
    ...
    try
      ...
      AData.GridRecord := ARecord;
      AItemIndex := GetItemIndexInTabOrderList(ATabOrderList,
        AFocusedItemIndex);
      if FindNextCustomItem(AItemIndex, ATabOrderList.Count, AGoForward,
        AGoOnCycle, @CanFocusColumn, AData, AItemIndex, ACycleChanged) then
...
function TcxGridBandedTableController.GetBandsCustomizationPopupClass
  : TcxGridBandsCustomizationPopupClass;
begin
  Result := TcxGridBandsCustomizationPopup;
end;

function TcxGridBandedTableController.GetItemsCustomizationPopupClass
  : TcxCustomGridItemsCustomizationPopupClass;
begin
  Result := TcxGridBandedColumnsCustomizationPopup;
end;

function TcxGridBandedTableController.GetColumnHeaderDragAndDropObjectClass
  : TcxGridColumnHeaderMovingObjectClass;
begin
  Result := TcxGridBandedColumnHeaderMovingObject;
end;

procedure TcxGridBandedTableController.GetColumnNeighbors
  (AColumn: TcxGridBandedColumn; AGoForward: Boolean; AList: TList);
var
  ABands: TcxGridBands;
  ...
  var
    ...
    begin
      Result := (AColumn <> nil) and (AGoForward and not AColumn.IsRight or
        not AGoForward and not AColumn.IsLeft) or (AColumn = nil) and
        (ARow.VisibleCount <> 0);
      if Result then
    ...
    var
      ...
      begin
        ...
        else if not AGoForward and ABand.IsFirst then
        begin
          ABand := ABands.LastVisibleNonEmpty;
          ARowIndex := AOriginalRowIndex - 1;
          ARowChanged := True;
        ...
        begin
          ABand := ABands.VisibleBottomItems
            [ABand.VisibleBottomIndex + 2 * Ord(AGoForward) - 1];
    ...
    begin
      ...
      until Result or AGoForward and ABand.IsFirstNonEmpty and
        (ARowIndex = ABands.VisibleRowCount) or not AGoForward and
        ABand.IsLastNonEmpty and (ARowIndex = -1);
      if Result then
      begin
        AColumn := nil;
  ...
  begin
    Result := nil;
    if not InitializeValues then
      Exit;
    while not ProcessRow do
      if not ProcessBand then
        Break;
  end;

begin
  AList.Clear;
  if (AColumn <> nil) and not AColumn.ActuallyVisible then
    Exit;
...
function TcxGridBandedTableController.GetCustomizationFormClass
  : TcxCustomGridCustomizationFormClass;
begin
  Result := TcxGridBandedTableCustomizationForm;
end;

function TcxGridBandedTableController.GetDesignHitTest
...
function TcxGridBandedTableController.GetPatternObject(AObject: TPersistent)
  : TPersistent;
begin
  if AObject is TcxGridBand then
    Result := TcxGridBandedTableView(GridView.PatternGridView)
      .Bands.FindItemID(TcxGridBand(AObject).ID)
  else
    Result := inherited GetPatternObject(AObject);
end;

function TcxGridBandedTableController.IsBandFixedDuringSizing
  (ABand: TcxGridBand): Boolean;
begin
  Result := (ABand = ForcingWidthBand) or not ForcingWidthBand.IsLastAsChild and
    (ABand.ParentBand = ForcingWidthBand.ParentBand) and
    (ABand.Position.VisibleColIndex <
    ForcingWidthBand.Position.VisibleColIndex);
end;

function TcxGridBandedTableController.IsColumnFixedDuringHorzSizing
...
begin
  ...
  Result := (APosition1 = APosition2) or not APosition2.Item.IsRight and
    (APosition1.Row = APosition2.Row) and
...
begin
  with GridView do
    if Preview.Active and Preview.AutoHeight and (Bands.Layout <> blNonFixed)
    then
      SizeChanged
    else
      inherited;
...
begin
  ...
  else if TcxGridBandedColumn(Item1).Position.Band <> nil then
  ...
  else if TcxGridBandedColumn(Item2).Position.Band <> nil then
...
begin
  ...
  begin
    ...
    try
      ...
      AColumn := CreateViewItem(AGridView as TcxGridBandedTableView)
        as TcxGridBandedColumn;
...
procedure TcxGridBandedTableController.CreateChildBandForSelection
  (Sender: TObject);
var
  AList: TObjectList;
  I: Integer;
...
procedure TcxGridBandedTableController.CreateParentBandForSelection
  (Sender: TObject);
  ...
  function HasAsChild(AParentBand: TcxGridBand; AColumn: TcxGridBandedColumn)
    : Boolean; overload;
  var
    ABand: TcxGridBand;
  begin
  ...
  procedure UpdateCommonParentBand(var AParentBand: TcxGridBand;
    ABand: TcxGridBand); overload;
  begin
  ...
  procedure UpdateCommonParentBand(var AParentBand: TcxGridBand;
    AColumn: TcxGridBandedColumn); overload;
  var
    ABand: TcxGridBand;
  begin
    if AParentBand = nil then
...
begin
  ...
  try
    ...
    begin
      ...
      else if TObject(AList[I]) is TcxGridBandedColumn then
      begin
...
procedure TcxGridBandedTableController.PopulateColumnHeaderDesignPopupMenu
  (AMenu: TPopupMenu);
...
begin
  ...
  AMenu.Items.Add(NewItem('Create Child Band', 0, False,
    CanCreateChildBandForSelection, CreateChildBandForSelection, 0,
    'chmiCreateChildBand'));
...
begin
  Result := inherited GetCellMultiSelect and
    (ViewInfo.HeaderViewInfo.RowCount = 1);
end;
...
function TcxGridBandedTableController.FindNextColumnVertically(AFocusedItemIndex
  : Integer; AGoForward, AGoOnCycle: Boolean): Integer;
var
  AColumn: TcxGridBandedColumn;
  AColumns: TList;
...
begin
  if AFollowVisualOrder then
    Result := FindNextItemFollowVisualOrder(AFocusedItemIndex, AGoForward,
      AGoOnCycle, ACycleChanged, ARecord)
  else
    Result := FindNextItemTabOrder(AFocusedItemIndex, AGoForward, AGoOnCycle,
      ACycleChanged, ARecord);
end;

function TcxGridBandedTableController.FocusNextColumnVertically
  (AFocusedColumnIndex: Integer; AGoForward, AGoOnCycle: Boolean): Boolean;
var
  ANextItemIndex: Integer;
begin
  ANextItemIndex := FindNextColumnVertically(AFocusedColumnIndex, AGoForward,
    AGoOnCycle);
...
procedure TcxGridBandedTableController.KeyDown(var Key: Word;
  Shift: TShiftState);
var
  ...
  begin
    Result := (FocusedRowIndex <> APrevFocusedRowIndex) or
      ...
      ((Key = VK_UP) and not DataController.IsBOF or (Key = VK_DOWN) and
      not DataController.IsEOF);
  end;
...
begin
  ...
  begin
    ...
    APrevFocusedRowHasColumns := (FocusedRow <> nil) and FocusedRow.HasCells and
      GridView.OptionsSelection.CellSelect;
...
begin
  ...
  begin
    ...
    LookAndFeelPainter.DrawScaledHeader(Self.Canvas, Bounds, TextAreaBounds, [],
      Borders, AState, AlignmentHorz, AlignmentVert, MultiLinePainting,
      ShowEndEllipsis, Text, Params.Font, Params.TextColor, Params.Color,
      ScaleFactor, BandViewInfo.BandsViewInfo.DrawBandHeaderBackgroundHandler,
      Band.IsMostRight);
  end;
end;
...
begin
  inherited;
  if ViewInfo.IsPressed and IsMainCanvasInUse then
    DrawPressed;
end;
...
var
  ...
  var
    ARegion: TcxRegion;
  begin
    if not AFixedPartExcluded[AFixedKind] then
      Exit;
...
begin
  Result := TcxGridBandedHeaderViewInfo(ViewInfo.GridViewInfo.HeaderViewInfo)
    .BandsViewInfo;
end;

{ TcxGridIndicatorBandHeaderItemPainter }

function TcxGridIndicatorBandHeaderItemPainter.GetViewInfo
  : TcxGridIndicatorBandHeaderItemViewInfo;
begin
  Result := TcxGridIndicatorBandHeaderItemViewInfo(inherited ViewInfo);
end;

function TcxGridIndicatorBandHeaderItemPainter.DrawBackgroundHandler
  (ACanvas: TcxCanvas; const ABounds: TRect): Boolean;
begin
  Result := ViewInfo.GridView.ViewInfo.HeaderViewInfo.BandsViewInfo.
    DrawBandHeaderBackgroundHandler(ACanvas, ABounds);
end;

{ TcxGridBandedDataRowCellsAreaItemPainter }

function TcxGridBandedDataRowCellsAreaItemPainter.GetViewInfo
  : TcxGridBandedDataRowCellsAreaItemViewInfo;
begin
...
class procedure TcxGridBandedRowsPainter.DrawDataRowCells
...
var
  ...
  begin
    ...
    begin
      ACellViewInfo := ADataRowViewInfo.InternalCellViewInfos
        [ABandViewInfo[I].Index];
  ...
  var
    ...
    ABandViewInfo: TcxGridBandViewInfo;
  begin
    with TcxGridBandedTableViewInfo(ARowViewInfo.GridViewInfo)
      .HeaderViewInfo.BandsViewInfo do
...
begin
  ...
  ACellsAreaViewInfo := TcxGridBandedDataRowCellsAreaViewInfo
    (ADataRowViewInfo.CellsAreaViewInfo);
  ...
  begin
    ...
    // for layout with the fixed bands
  end
  else
    AClipRegion := nil;
  try
...
function TcxGridBandedTablePainter.CanOffset(AItemsOffset, DX,
  DY: Integer): Boolean;
begin
  with ViewInfo.HeaderViewInfo.BandsViewInfo do
    Result := inherited CanOffset(AItemsOffset, DX, DY) and
      ((AItemsOffset <> 0) or (BandBackgroundBitmap = nil) and
      (BandHeaderBackgroundBitmap = nil) and
      ((GridView.Bands.Layout = blNonFixed) or (GridView.GroupedColumnCount = 0)
      and not GridView.Preview.Active));
end;

{ TcxGridBandedColumnHeaderVertSizingEdgeViewInfo }

function TcxGridBandedColumnHeaderVertSizingEdgeViewInfo.
  CalculateHeight: Integer;
begin
  Result := ScaleFactor.Apply(cxGridHeaderSizingEdgeSize);
end;

function TcxGridBandedColumnHeaderVertSizingEdgeViewInfo.CalculateWidth
  : Integer;
begin
  Result := 0;
end;

function TcxGridBandedColumnHeaderVertSizingEdgeViewInfo.GetAlignmentVert
  : TcxAlignmentVert;
begin
  Result := vaBottom;
end;

function TcxGridBandedColumnHeaderVertSizingEdgeViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
  Result := TcxGridColumnHeaderVertSizingEdgeHitTest;
end;

function TcxGridBandedColumnHeaderVertSizingEdgeViewInfo.GetPainterClass
...
function TcxGridBandedColumnHeaderVertSizingEdgeViewInfo.
  ResidesInContent: Boolean;
begin
  Result := False;
end;

procedure TcxGridBandedColumnHeaderVertSizingEdgeViewInfo.Calculate
...
constructor TcxGridBandedColumnHeaderViewInfo.Create
...
function TcxGridBandedColumnHeaderViewInfo.GetContainer
  : TcxGridBandedHeaderViewInfo;
begin
  Result := TcxGridBandedHeaderViewInfo(inherited Container);
end;

function TcxGridBandedColumnHeaderViewInfo.GetRowViewInfo
...
procedure TcxGridBandedColumnHeaderViewInfo.GetAreaViewInfoClasses
...
var
  AColIndex, I: Integer;
begin
  if (BandViewInfo.Band.Width <> 0) or BandViewInfo.Band.HasParentWithAssignedWidth
  then
  begin
    ...
    AColIndex := ColumnPosition.VisibleColIndex;
...
constructor TcxGridBandHeaderViewInfo.Create(ABandViewInfo
  : TcxGridBandViewInfo);
begin
...
var
  ANumOverlap: Integer;
begin
  ANumOverlap := (BandViewInfo.BandsViewInfo.BandHeaderRowCount -
    Band.BandLevelIndex) - 1;
...
begin
  if FBandViewInfo.IsBottom then
    Result := FBandViewInfo.BandsViewInfo.BandHeaderRowCount -
      Band.BandLevelIndex
  else
    Result := 1;
end;
...
begin
  ...
  begin
    Result := 0;
    for I := Band.BandLevelIndex to FBandViewInfo.BandsViewInfo.
      BandHeaderRowCount - 1 do
      Inc(Result, BandViewInfo.BandsViewInfo.BandHeaderRowHeights[I]);
    if Result > 0 then
      Dec(Result, GetVerticalBorderOverlapSize);
  end
  else
    Result := FBandViewInfo.BandsViewInfo.BandHeaderRowHeights
      [Band.BandLevelIndex];
end;
...
function TcxGridBandHeaderViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  ...
  Result.Left := Result.Right - ScaleFactor.Apply
    (cxGridHeaderSizingEdgeSize) div 2;
...
begin
  Result := cxRectContent(ContentBounds, LookAndFeelPainter.HeaderContentOffsets
    (ScaleFactor));
end;
...
function TcxGridBandHeaderViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
...
begin
      ...
      htBandHeader:
        ...
        begin
          if GridView.IsDesigning then
            GridView.Controller.DesignController.SelectObject(Band,
  ...
  else if (AButton = mbRight) and GridView.IsDesigning then
...
constructor TcxGridBandRowViewInfo.Create(ARowsViewInfo
  : TcxGridBandRowsViewInfo; AIndex: Integer);
begin
  inherited Create;
...
function TcxGridBandRowViewInfo.GetColumnViewInfo(Index: Integer)
  : TcxGridBandedColumnHeaderViewInfo;
begin
...
begin
  ...
  begin
    ...
    AColumnViewInfo.Calculate(ALeftBound, ATopBound, AWidth,
      AColumnViewInfo.ColumnPosition.LineCount * ALineHeight);
...
function TcxGridBandRowsViewInfo.GetItem(Index: Integer)
  : TcxGridBandRowViewInfo;
begin
...
function TcxGridBandRowsViewInfo.GetBandRowViewInfoClass
  : TcxGridBandRowViewInfoClass;
begin
...
begin
  ...
  begin
    for Result := 0 to Count - 1 do
      if PtInRect(Items[Result].Bounds, P) then
        Exit;
    Result := Count;
  end
  else
...
constructor TcxGridBandViewInfo.Create(ABandsViewInfo: TcxGridBandsViewInfo;
  AIndex: Integer);
begin
...
function TcxGridBandViewInfo.GetChildBandViewInfo(Index: Integer)
  : TcxGridBandViewInfo;
begin
...
function TcxGridBandViewInfo.GetColumnViewInfo(Index: Integer)
  : TcxGridBandedColumnHeaderViewInfo;
begin
  Result := TcxGridBandedColumnHeaderViewInfo(FColumnViewInfos[Index]);
end;
...
begin
  ...
  else if ParentBandViewInfo.Band.Width = 0 then
    Result := ParentBandViewInfo.MaxWidth
  else
    Result := ParentBandViewInfo.Width;
end;

function TcxGridBandViewInfo.GetSameLevelItem(Index: Integer)
  : TcxGridBandViewInfo;
begin
  if IsRoot then
...
begin
  ...
  begin
    AColumnHeaderViewInfo := TcxGridBandedColumnHeaderViewInfo
      (AContainerViewInfo.FItems.List[I]);
...
begin
  ...
  try
    ...
    AAutoWidthObject.AvailableWidth := Width +
      GetChildBandsHorizontalBorderOverlapSize;
    AAutoWidthObject.Calculate;
    for I := 0 to ChildBandViewInfoCount - 1 do
...
begin
  ...
  begin
    ...
    if FWidth = 0 then
      if IsBottom then
        FWidth := BorderSize[bLeft] + FRowsViewInfo.CalculateWidth +
          BorderSize[bRight]
      else
...
begin
  if Value < MinContentWidth then
    Value := MinContentWidth;
  if Value > MaxContentWidth then
...
class function TcxGridBandViewInfo.GetHeaderViewInfoClass
  : TcxGridBandHeaderViewInfoClass;
begin
...
var
  AIndex, I: Integer;
begin
  if GridView.OptionsView.ColumnAutoWidth or Band.HasParentWithAssignedWidth
  then
  begin
...
begin
  ...
  FExcludeBounds := TdxRightToLeftLayoutConverter.ConvertRect
    (FExcludeBounds, ABounds);
...
procedure TcxGridBandViewInfo.InitAutoWidthItem(AAutoWidthItem
  : TcxAutoWidthItem);
begin
...
begin
  ...
  begin
    ABand := Band;
    AInsertPosition := GetPointPosition(FHeaderViewInfo.Bounds, P, True,
      GridView.OptionsCustomize.NestedBands);
  end
  else if GridView.OptionsCustomize.NestedBands and not IsBottom then
    for I := 0 to ChildBandViewInfoCount - 1 do
    begin
      Result := ChildBandViewInfos[I].InsertPositionAtPos(P, ABand,
        AInsertPosition);
      if Result then
        Break;
    end;
...
constructor TcxGridBandsViewInfo.Create(AContainerViewInfo
  : TcxGridBandedHeaderViewInfo);
begin
  inherited Create;
...
function TcxGridBandsViewInfo.GetBottomItem(Index: Integer)
  : TcxGridBandViewInfo;
begin
...
function TcxGridBandsViewInfo.GetInternalItem(Index: Integer)
  : TcxGridBandViewInfo;
begin
...
procedure TcxGridBandsViewInfo.SetBandHeaderRowHeight(Index: Integer;
  Value: Integer);
begin
...
function TcxGridBandsViewInfo.AddIndicatorItems(AIndicatorViewInfo
  : TcxGridIndicatorViewInfo; ATopBound: Integer): Boolean;
begin
  ...
  if ShowBandHeaders then
  begin
    AIndicatorViewInfo.AddItem(ATopBound, BandHeadersAreaHeight,
      TcxGridIndicatorBandHeaderItemViewInfo);
  ...
  begin
    ...
    AIndicatorViewInfo.AddItem(ATopBound, ColumnHeadersAreaHeight,
      TcxGridIndicatorHeaderItemViewInfo);
  end;
end;
...
begin
  for I := 0 to Count - 1 do
    AList.AddObject('BandHeader' + IntToStr(Items[I].Index),
      Items[I].HeaderViewInfo);
end;
...
function TcxGridBandsViewInfo.CalculateBandHeaderHeight(ABandHeaderViewInfo
  : TcxGridBandHeaderViewInfo): Integer;
  ...
  begin
    ...
    begin
      ...
      Result := GetItemClass.GetHeaderViewInfoClass.GetCellHeight
        (GridViewInfo.GetFontHeight(AParams.Font),
        FContainerViewInfo.LookAndFeelPainter, GridViewInfo.ScaleFactor);
    end
    else
    ...
    begin
      ...
      Dec(ATouchableElementHeight, 2 * GridViewInfo.ScaleFactor.Apply
        (cxGridCellTextOffset));
      dxAdjustToTouchableSize(ATouchableElementHeight,
        GridViewInfo.ScaleFactor);
      Inc(ATouchableElementHeight, 2 * GridViewInfo.ScaleFactor.Apply
        (cxGridCellTextOffset));
...
begin
  if IsBandHeaderHeightAssigned then
    ...
    Result := GetBaseBandHeaderHeight *
      GridView.OptionsView.BandHeaderLineCount;
end;
...
function TcxGridBandsViewInfo.DrawBandHeaderBackgroundHandler
  (ACanvas: TcxCanvas; const ABounds: TRect): Boolean;
begin
...
begin
  ...
  for I := 0 to RootItemCount - 1 do
    if RootItems[I].InsertPositionAtPos(P, ABand, AInsertPosition) then
      Break;
end;
...
function TcxGridBandedHeaderViewInfoSpecific.GetGridViewInfo
  : TcxGridBandedTableViewInfo;
begin
...
constructor TcxGridBandedHeaderViewInfo.Create(AGridViewInfo
...
procedure TcxGridBandedHeaderViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
  inherited DoRightToLeftConversion(ABounds);
...
function TcxGridBandedHeaderViewInfo.GetGridViewInfo
  : TcxGridBandedTableViewInfo;
begin
  Result := TcxGridBandedTableViewInfo(inherited GridViewInfo);
end;

function TcxGridBandedHeaderViewInfo.GetItem(Index: Integer)
  : TcxGridBandedColumnHeaderViewInfo;
begin
...
function TcxGridBandedHeaderViewInfo.GetSpecific
  : TcxGridBandedHeaderViewInfoSpecific;
begin
  Result := TcxGridBandedHeaderViewInfoSpecific(inherited Specific);
end;

procedure TcxGridBandedHeaderViewInfo.AddIndicatorItems(AIndicatorViewInfo
...
begin
  ...
  try
    ...
    AAutoWidthObject.AvailableWidth := GridViewInfo.ClientWidth +
      ...
      IfThen(FBandsViewInfo.RootItemCount > 0,
      GridView.GetVerticalScrollBarAreaWidth);
...
function TcxGridBandedHeaderViewInfo.GetBandsViewInfoClass
  : TcxGridBandsViewInfoClass;
begin
  Result := TcxGridBandsViewInfo;
end;

function TcxGridBandedHeaderViewInfo.GetColumnNeighbors(AColumn: TcxGridColumn)
  : TcxNeighbors;
begin
  Result := [];
...
function TcxGridBandedHeaderViewInfo.GetColumnAdditionalWidth
  (AColumn: TcxGridColumn): Integer;
begin
  if AColumn.IsMostLeft then
    Result := GridViewInfo.FirstItemAdditionalWidth
  else if AColumn.IsLeft then
    Result := GridViewInfo.BorderOverlapSize
  else
    Result := 0;
end;

function TcxGridBandedHeaderViewInfo.GetColumnWidth
  (AColumn: TcxGridColumn): Integer;
begin
...
begin
  Result := inherited GetIsScrollable and
    (FBandsViewInfo.Bands.Layout in [blNonFixed, blRightFixed]);
end;

function TcxGridBandedHeaderViewInfo.GetItemAreaBounds
  (AItem: TcxGridColumnHeaderViewInfo): TRect;
begin
  Result := FBandsViewInfo.GetItemAreaBounds(TcxGridBandedColumn(AItem.Column)
    .Position.Band);
end;

function TcxGridBandedHeaderViewInfo.GetItemClass
  : TcxGridColumnHeaderViewInfoClass;
begin
  Result := TcxGridBandedColumnHeaderViewInfo;
end;

function TcxGridBandedHeaderViewInfo.GetItemMultiLinePainting
...
function TcxGridBandedHeaderViewInfo.GetItemsHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
  Result := nil;
end;

function TcxGridBandedHeaderViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
function TcxGridBandedHeaderViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
begin
...
function TcxGridBandedHeaderViewInfo.GetZone(const P: TPoint)
...
begin
  ...
  if GridViewInfo.Controller.CanHandleHitTest(AHitTest) then
    ...
    begin
      AColumn := TcxGridBandedColumn
        (TcxCustomGridColumnHitTest(AHitTest).Column);
      ABounds := Items[AColumn.VisibleIndex].Bounds;
      APosition := AColumn.Position;
      if UseRightToLeftAlignment then
        AColIndex := APosition.VisibleColIndex +
          Ord(P.X <= (ABounds.Left + ABounds.Right) div 2)
      else
        AColIndex := APosition.VisibleColIndex +
          Ord(P.X >= (ABounds.Left + ABounds.Right) div 2);
      Result := TcxGridBandedColumnContainerZone.Create(AColumn.VisibleIndex,
        APosition.Band, AColIndex, APosition.VisibleRowIndex);
    end
    else if AHitTest is TcxGridBandHitTest then
    begin
      ...
      begin
        if ARowIndex <> ABand.Rows.VisibleCount then
          Inc(ARowIndex);
        Result := TcxGridBandedColumnContainerZone.Create(-1, ABand, 0,
          ARowIndex);
      end;
    end;
end;
...
function TcxGridBandedFooterViewInfo.GetItemMultiLinePainting
  (AItem: TcxGridColumnHeaderViewInfo): Boolean;
begin
  Result := inherited GetItemMultiLinePainting(AItem) or
    (TcxGridBandedColumn(AItem.Column).Position.LineCount > 1);
...
function TcxGridBandedFooterViewInfo.IsColumnOnFirstLayer
  (AColumnIndex: Integer): Boolean;
begin
  Result := TcxGridBandedColumn(GridView.VisibleColumns[AColumnIndex])
    .Position.Band.FixedKind <> fkNone;
end;
...
function TcxGridBandedFooterViewInfo.CompareCellData(Item1,
...
function TcxGridIndicatorBandHeaderItemViewInfo.GetGridView
  : TcxGridBandedTableView;
begin
  Result := TcxGridBandedTableView(inherited GridView);
end;

function TcxGridIndicatorBandHeaderItemViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
  Result := TcxGridIndicatorBandHeaderHitTest;
end;

function TcxGridIndicatorBandHeaderItemViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
procedure TcxGridIndicatorBandHeaderItemViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
  GridView.Styles.GetBandHeaderParams(nil, AParams);
end;

function TcxGridIndicatorBandHeaderItemViewInfo.
  SupportsQuickCustomization: Boolean;
begin
...
function TcxGridIndicatorBandHeaderItemViewInfo.GetDropDownWindow
...
begin
  Result := inherited GetAlwaysVisible or TcxGridBandedTableView(GridView)
    .OptionsCustomize.BandsQuickCustomization;
end;

{ TcxGridBandedDataRowCellsAreaItemViewInfo }

constructor TcxGridBandedDataRowCellsAreaItemViewInfo.Create(ACellsAreaViewInfo
  : TcxGridBandedDataRowCellsAreaViewInfo; ABandViewInfo: TcxGridBandViewInfo);
begin
...
function TcxGridBandedDataRowCellsAreaItemViewInfo.
  GetFixedBandsSeparatorLocation: TcxGridFixedBandsSeparatorLocation;
begin
  if bLeft in FBandViewInfo.Borders then
    Result := slLeft
  else if bRight in FBandViewInfo.Borders then
    Result := slRight
  else
    Result := slNone;
end;

function TcxGridBandedDataRowCellsAreaItemViewInfo.GetGridViewInfo
  : TcxGridBandedTableViewInfo;
begin
  Result := TcxGridBandedTableViewInfo(inherited GridViewInfo);
end;

function TcxGridBandedDataRowCellsAreaItemViewInfo.GetLineBounds
  (Index: Integer): TRect;
begin
...
function TcxGridBandedDataRowCellsAreaItemViewInfo.GetRecordsViewInfo
  : TcxGridBandedRowsViewInfo;
begin
  Result := TcxGridBandedRowsViewInfo(RecordViewInfo.RecordsViewInfo);
end;

function TcxGridBandedDataRowCellsAreaItemViewInfo.GetRecordViewInfo
...
procedure TcxGridBandedDataRowCellsAreaItemViewInfo.AddLine
  (const ABounds: TRect);
var
  ALineBounds: PRect;
begin
...
procedure TcxGridBandedDataRowCellsAreaItemViewInfo.AddLines;
  ...
  begin
    if not(AShowLeftLines or AShowTopLines) then
      Exit;
    for I := 0 to FBandViewInfo.ColumnViewInfoCount - 1 do
    begin
      ACellViewInfo := RecordViewInfo.InternalCellViewInfos
        [FBandViewInfo[I].Index];
      if ACellViewInfo <> nil then
      begin
...
begin
  if Borders <> [] then
    AddCellsLines(RecordsViewInfo.ShowCellLeftLines,
      RecordsViewInfo.ShowCellTopLines);
end;
...
begin
  Result := RecordViewInfo.GetCellBorders(FBandViewInfo.IsRight,
    CellsAreaViewInfo.IsBottom);
  if GridViewInfo.FixedBandSeparatorWidth <> 0 then
    if FBandViewInfo.IsRightToLeftConverted then
      Result := Result - TdxRightToLeftLayoutConverter.ConvertBorders
        (FBandViewInfo.Borders)
    else
      Result := Result - FBandViewInfo.Borders;
end;

function TcxGridBandedDataRowCellsAreaItemViewInfo.
  GetFixedBandsSeparatorBounds: TRect;
begin
  Result := ContentBounds;
  with Result do
...
function TcxGridBandedDataRowCellsAreaItemViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
  Result := TcxGridBandedDataRowCellsAreaItemPainter;
end;

procedure TcxGridBandedDataRowCellsAreaItemViewInfo.GetViewParams
  (var AParams: TcxViewParams);
var
...
begin
  ...
  begin
    ...
    try
      FBandViewInfo.Band.Styles.GetViewParams(bsContent, ACellPos, nil,
        AParams);
    finally
      ACellPos.Free;
    end;
...
procedure TcxGridBandedDataRowCellsAreaItemViewInfo.Calculate(ALeftBound,
...
begin
  ...
  else if FixedBandsSeparatorLocation = slLeft then
  begin
...
procedure TcxGridBandedDataRowCellsAreaItemViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
  inherited DoRightToLeftConversion(ABounds);
  for I := 0 to LineCount - 1 do
    PRect(FLineBounds[I])^ := TdxRightToLeftLayoutConverter.ConvertRect
      (LineBounds[I], ABounds);
end;

{ TcxGridBandedDataRowCellsAreaViewInfo }

constructor TcxGridBandedDataRowCellsAreaViewInfo.Create(ARecordViewInfo
...
function TcxGridBandedDataRowCellsAreaViewInfo.GetBandsViewInfo
  : TcxGridBandsViewInfo;
begin
...
function TcxGridBandedDataRowCellsAreaViewInfo.GetGridViewInfo
  : TcxGridBandedTableViewInfo;
begin
  Result := TcxGridBandedTableViewInfo(inherited GridViewInfo);
end;

function TcxGridBandedDataRowCellsAreaViewInfo.GetItem(Index: Integer)
  : TcxGridBandedDataRowCellsAreaItemViewInfo;
begin
...
function TcxGridBandedDataRowCellsAreaViewInfo.GetItemClass
  : TcxGridBandedDataRowCellsAreaItemViewInfoClass;
begin
...
procedure TcxGridBandedDataRowCellsAreaViewInfo.Calculate(ALeftBound,
  ATopBound: Integer; AWidth: Integer = -1; AHeight: Integer = -1);
var
  R, ABandBounds: TRect;
  I: Integer;
...
procedure TcxGridBandedDataRowCellsAreaViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
var
  I: Integer;
begin
...
function TcxGridBandedRowsViewInfo.GetHeaderViewInfo
  : TcxGridBandedHeaderViewInfo;
begin
  Result := TcxGridBandedHeaderViewInfo(inherited HeaderViewInfo);
end;

function TcxGridBandedRowsViewInfo.CalculateDataRowHeight(AConsideLayout
  : Boolean = True): Integer;
begin
  Result := inherited CalculateDataRowHeight(AConsideLayout);
  if (HeaderViewInfo.LineCount <> 0) and
    (not GridView.RowLayout.Active or not AConsideLayout) then
  ...
  begin
    ...
    if not Result then
      if Count = 0 then
        ...
        for I := 0 to Count - 1 do
          with Items[I] do
            if (ColumnViewInfoCount = 0) or (FixedKind <> fkNone) or AreAllColumnsFixed
            then
            begin
              Result := True;
              Break;
...
function TcxGridBandedRowsViewInfo.GetAreaBoundsForCell(ACellViewInfo
  : TcxGridTableDataCellViewInfo): TRect;
var
  ABand: TcxGridBand;
begin
...
function TcxGridBandedRowsViewInfo.GetPainterClass
...
begin
  Result := (HeaderViewInfo.LineCount > 1) and
    (GridLines in [glBoth, glVertical]);
end;
...
function TcxGridBandedRowsViewInfo.IsCellMultiLine
...
function TcxGridBandedTableViewInfo.GetHeaderViewInfo
  : TcxGridBandedHeaderViewInfo;
begin
  Result := TcxGridBandedHeaderViewInfo(inherited HeaderViewInfo);
end;

function TcxGridBandedTableViewInfo.GetColumnFooterWidth(AFooterViewInfo
  ...
  begin
    ...
    if ABands.VisibleLeftFixedCount <> 0 then
      if IsRightToLeftConverted then
        Result.Right := HeaderViewInfo.BandsViewInfo.LastFixedItems[fkLeft, 0]
          .Bounds.Left
      else
        Result.Left := HeaderViewInfo.BandsViewInfo.LastFixedItems[fkLeft, 0]
          .Bounds.Right;
    if ABands.VisibleRightFixedCount <> 0 then
      if IsRightToLeftConverted then
        Result.Left := HeaderViewInfo.BandsViewInfo.LastFixedItems[fkRight, 0]
          .Bounds.Right
      else
        Result.Right := HeaderViewInfo.BandsViewInfo.LastFixedItems[fkRight, 0]
          .Bounds.Left;
  end;
end;
...
function TcxGridBandedTableViewInfo.
  SupportsGroupSummariesAlignedWithColumns: Boolean;
begin
...
begin
  Result := inherited SupportsMultipleFooterSummaries and
    (HeaderViewInfo.RowCount = 1);
end;

function TcxGridBandedTableViewInfo.GetFooterPainterClass
  : TcxGridFooterPainterClass;
begin
  Result := TcxGridBandedFooterPainter;
end;

function TcxGridBandedTableViewInfo.GetFooterViewInfoClass
  : TcxGridFooterViewInfoClass;
begin
  Result := TcxGridBandedFooterViewInfo;
end;

function TcxGridBandedTableViewInfo.GetHeaderViewInfoClass
  : TcxGridHeaderViewInfoClass;
begin
  Result := TcxGridBandedHeaderViewInfo;
end;

function TcxGridBandedTableViewInfo.GetHeaderViewInfoSpecificClass
  : TcxGridHeaderViewInfoSpecificClass;
begin
  Result := TcxGridBandedHeaderViewInfoSpecific;
end;

function TcxGridBandedTableViewInfo.GetIndicatorViewInfoClass
  : TcxGridIndicatorViewInfoClass;
begin
  Result := TcxGridBandedIndicatorViewInfo;
end;

function TcxGridBandedTableViewInfo.GetRecordsViewInfoClass
  : TcxCustomGridRecordsViewInfoClass;
begin
  Result := TcxGridBandedRowsViewInfo;
end;

function TcxGridBandedTableViewInfo.CanOffset(ARecordCountDelta,
  APixelScrollRecordOffsetDelta, DX, DY: Integer): Boolean;
begin
  Result := inherited CanOffset(ARecordCountDelta,
    APixelScrollRecordOffsetDelta, DX, DY) and
    ((ARecordCountDelta <> 0) or (APixelScrollRecordOffsetDelta <> 0) or
    (GridView.Bands.Layout = blNonFixed));
end;

function TcxGridBandedTableViewInfo.GetCellHeight(AIndex,
  ACellHeight: Integer): Integer;
begin
  Result := HeaderViewInfo[AIndex].ColumnPosition.LineCount * ACellHeight;
end;

function TcxGridBandedTableViewInfo.GetCellTopOffset(AIndex,
  ACellHeight: Integer): Integer;
begin
...
constructor TcxCustomGridBandedColumnOptions.Create
...
procedure TcxGridBandedColumnStyles.GetDefaultViewParams(Index: Integer;
  ...
  begin
    ...
    begin
      ADataCellPos := TcxGridDataCellPos.Create
        (TcxCustomGridRecord(AData), AItem);
      try
        AItem.Position.Band.Styles.GetViewParams(bsContent, ADataCellPos,
          nil, AParams);
      finally
        ADataCellPos.Free;
      end;
...
begin
  if Item.IsLoading or Item.IsUpdating or GridView.IsAssigningItems then
    FColIndex := Value
  else if (FBand <> nil) and (Value >= 0) then
  begin
...
procedure TcxGridBandedColumnPosition.SaveParams(ABandIndexOnly
  : Boolean = False);
begin
  FBandIndex := BandIndex;
...
function TcxGridBandedColumn.GetStoredProperties(AProperties: TStrings)
  : Boolean;
begin
  with AProperties do
  begin
...
procedure TcxGridBandedColumn.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
  if AName = 'BandIndex' then
    AValue := Position.BandIndex
  else if AName = 'ColIndex' then
    AValue := Position.ColIndex
  else if AName = 'RowIndex' then
    AValue := Position.RowIndex
  else if AName = 'LineCount' then
    AValue := Position.LineCount
  else
    inherited;
end;

procedure TcxGridBandedColumn.SetPropertyValue(const AName: string;
...
function TcxGridBandedColumn.GetOptionsClass
...
procedure TcxGridBandedColumn.AssignColumnWidths;
  ...
  begin
    Result := GridView.ViewInfo.HeaderViewInfo.BandsViewInfo
      [Position.VisibleBandIndex].RowsViewInfo[Position.VisibleRowIndex];
  end;

begin
  if Position.Band.Width <> 0 then
    GetRowViewInfo.AssignColumnWidths
  else if Position.Band.HasParentWithAssignedWidth then
    Position.Band.ParentBandWithAssignedWidth.AssignColumnWidths
  else if (Position.Band.Rows.VisibleCount > 1) and
...
begin
  Result := inherited CanScroll and (Position.Band <> nil) and
    (Position.Band.FixedKind = fkNone);
end;
...
begin
  ...
  begin
    ...
    while ABand <> nil do
    begin
      Result := ABand.GetAlternateCaption +
        cxGridBandedTableViewAlternateCaptionSeparator + Result;
      ABand := ABand.ParentBand;
    end;
  end;
end;
...
begin
  Result := inherited GetActuallyVisible and (Position.Band <> nil) and
  ...
  if CanDataCellScroll then
    ...
    begin
      ...
      begin
        ...
        Result := not HasPoint(R.Left, R.Bottom - 1) or
          not HasPoint(R.Right - 1, R.Bottom - 1);
      end
      else
...
begin
  Result := (VisibleCount <> 0) or (Count = 0);
  // for new just inserted empty rows
end;
...
procedure TcxGridBandRow.CheckIndexForInsert(var AIndex: Integer;
  AExistingItem: Boolean);
begin
...
begin
  for Result := 0 to VisibleCount - 1 do
    with VisibleItems[Result] do
      if (LineOffset <= ALineIndex) and (ALineIndex < LineOffset + LineCount)
      then
        Exit;
  Result := -1;
end;
...
procedure TcxGridBandRows.MoveColumn(AColumn: TcxGridBandedColumn;
  ARowIndex, AColIndex: Integer);
var
...
begin
  ...
  else if (ARowIndex <> -1) and (AColumnColIndex <> AColIndex) then
...
begin
  if not FBand.IsDestroying and
    ((ParentBand = nil) or not ParentBand.IsDestroying) and
    (FBand.IsLoading or FBand.IsUpdating or GridView.IsAssigningBands) then
  begin
    FBandIndex := Value;
    if FBand.IsLoading or GridView.IsAssigningBands then
      Exit;
  end;
  if not CheckBandIndex(Value) then
    Exit;
  if BandIndex <> Value then
  begin
    FBand.SaveVisible;
    ...
    try
      ...
      if not GridView.IsDestroying and (0 <= Value) and
        (Value < GridView.Bands.Count) then
...
begin
  ...
  if Result then
    Exit;
  Result := (Value = -1) or (0 <= Value) and (Value < GridView.Bands.Count) and
    (FBand.Index <> Value);
...
procedure TcxGridBandStyles.SetOnGetHeaderStyle
  (Value: TcxGridBandGetHeaderStyle);
begin
...
begin
  if not(GridView.IsLoading or GridView.IsDestroying) and GridView.IsDesigning
  then
...
begin
  Result := not FIgnoreLoadingStatus and (GridView <> nil) and
    GridView.IsLoading;
end;
...
procedure TcxGridBand.SetOnGetStoredProperties
  (Value: TcxGridBandGetStoredPropertiesEvent);
begin
...
procedure TcxGridBand.SetOnGetStoredPropertyValue
  (Value: TcxGridBandGetStoredPropertyValueEvent);
begin
...
procedure TcxGridBand.SetOnSetStoredPropertyValue
  (Value: TcxGridBandSetStoredPropertyValueEvent);
begin
...
begin
  if not IsRoot or GridView.IsDestroying then
    Exit;
...
procedure TcxGridBand.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
  if AName = 'Width' then
    AValue := Width
...
procedure TcxGridBand.SetPropertyValue(const AName: string;
  const AValue: Variant);
begin
  if AName = 'Width' then
    Width := AValue
...
begin
  Result := GridView.IsDesigning or GridView.OptionsCustomize.BandMoving and
    FOptions.Moving;
end;
...
begin
  with GridView.Controller do
    Result := HasFixedWidth or (ForcingWidthBand <> nil) and
      IsBandFixedDuringSizing(Self) or (ForcingWidthItem <> nil) and
      (TcxGridBandedColumn(ForcingWidthItem)
      .Position.Band.ParentBandWithAssignedWidth = Self);
end;
...
begin
  if ACheckSizingAbility and not CanSize then
    Exit;
  Width := 0;
  ...
  try
    ...
    if GridView.OptionsView.BandHeaders and ActuallyVisible and GridView.Visible
    then
    begin
...
procedure TcxGridBand.MoveColumn(AColumn: TcxGridBandedColumn;
  ARowIndex, AColIndex: Integer);
begin
...
begin
  ...
  begin
    ...
    if Result.Rows.VisibleCount <> 0 then
      Exit;
  end;
  Result := nil;
end;
...
begin
  ...
  else if VisibleLeftFixedCount <> 0 then
    Result := blLeftFixed
  else if VisibleRightFixedCount <> 0 then
    Result := blRightFixed
  else
    Result := blNonFixed;
end;
...
begin
  ...
  begin
    FVisibleRowCount := 0;
    for I := 0 to VisibleBottomItemCount - 1 do
      FVisibleRowCount := Max(FVisibleRowCount,
        VisibleBottomItems[I].Rows.VisibleCount);
  end;
...
procedure TcxGridBands.AssignVisibleItemsIndexes;
var
  AItem: TcxGridBand;
  I: Integer;
begin
...
var
  I: Integer;
begin
  if FVisibleBottomItems = nil then
    Exit;
...
begin
  ...
  begin
    ...
    begin
      ...
      case ABand.FixedKind of
        fkNone:
          FVisibleItems.Move(VisibleCount - 1,
            VisibleCount - 1 - FVisibleRightFixedCount);
        fkLeft:
          begin
...
procedure TcxGridBands.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
end;

procedure TcxGridBands.SetPropertyValue(const AName: string;
  const AValue: Variant);
begin
end;

function TcxGridBands.CreateChild(const AObjectName,
...
procedure TcxGridBands.BandVisibilityChanged(ABand: TcxGridBand;
  Value: Boolean);
begin
  // do nothing
end;
...
function TcxGridBands.GetFirstVisibleIndex(AFixedKind
  : TcxGridBandFixedKind): Integer;
begin
  case AFixedKind of
    fkLeft:
      Result := 0;
...
function TcxGridBands.GetFirstVisibleRootIndex
  (AFixedKind: TcxGridBandFixedKind): Integer;
begin
  case AFixedKind of
    fkLeft:
      Result := 0;
...
function TcxGridBands.GetLastVisibleIndex(AFixedKind
  : TcxGridBandFixedKind): Integer;
begin
  case AFixedKind of
    fkLeft:
...
function TcxGridBands.GetLastVisibleRootIndex
  (AFixedKind: TcxGridBandFixedKind): Integer;
begin
  case AFixedKind of
    fkLeft:
...
function TcxGridBandedTableBackgroundBitmaps.GetBitmapStyleIndex
...
constructor TcxGridBandedTableOptionsBehavior.Create
  (AGridView: TcxCustomGridView);
begin
  inherited;
...
constructor TcxGridBandedTableOptionsCustomize.Create
  (AGridView: TcxCustomGridView);
begin
  inherited;
  FBandMoving := True;
...
procedure TcxGridBandedTableOptionsCustomize.SetBandsQuickCustomization
  (Value: Boolean);
begin
...
procedure TcxGridBandedTableOptionsCustomize.
  SetBandsQuickCustomizationMaxDropDownCount(Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
procedure TcxGridBandedTableOptionsCustomize.
  SetBandsQuickCustomizationMultiColumnMode(Value: Boolean);
begin
...
procedure TcxGridBandedTableOptionsCustomize.
  SetBandsQuickCustomizationReordering
  (Value: TcxGridQuickCustomizationReordering);
begin
...
procedure TcxGridBandedTableOptionsCustomize.SetColumnVertSizing
  (Value: Boolean);
begin
  ...
  if Source is TcxGridBandedTableOptionsCustomize then
    ...
    begin
      ...
      Self.BandsQuickCustomizationReordering :=
        BandsQuickCustomizationReordering;
...
function TcxGridBandedTableOptionsCustomize.
  SupportsBandsQuickCustomizationReordering: Boolean;
begin
  Result := not GridView.Bands.AreNested and
    not GridView.Bands.HaveFixedItems and
    (not BandsQuickCustomizationSorted and (GridView.IsDesigning or
...
procedure TcxGridBandedTableOptionsView.SetBandCaptionsInColumnAlternateCaption
  (Value: Boolean);
begin
...
procedure TcxGridBandedTableOptionsView.SetBandHeaderEndEllipsis
  (Value: Boolean);
begin
...
procedure TcxGridBandedTableOptionsView.SetFixedBandSeparatorColor
  (Value: TColor);
begin
...
procedure TcxGridBandedTableOptionsView.SetFixedBandSeparatorWidth
  (Value: Integer);
begin
  if Value < 0 then
    Value := 0;
...
begin
  if Source is TcxGridBandedTableOptionsView then
    ...
    begin
      Self.BandCaptionsInColumnAlternateCaption :=
...
procedure TcxGridBandedTableViewStyles.SetOnGetBandHeaderStyle
  (Value: TcxGridBandGetHeaderStyle);
begin
...
function TcxGridBandedTableViewStyleSheet.GetStylesValue
  : TcxGridBandedTableViewStyles;
begin
  Result := TcxGridBandedTableViewStyles(GetStyles);
end;

procedure TcxGridBandedTableViewStyleSheet.SetStylesValue
  (Value: TcxGridBandedTableViewStyles);
begin
  SetStyles(Value);
end;

class function TcxGridBandedTableViewStyleSheet.GetStylesClass
...
function TcxGridBandedTableView.GetBackgroundBitmaps
  : TcxGridBandedTableBackgroundBitmaps;
begin
...
function TcxGridBandedTableView.GetGroupedColumn(Index: Integer)
  : TcxGridBandedColumn;
begin
  Result := TcxGridBandedColumn(inherited GroupedColumns[Index]);
end;

function TcxGridBandedTableView.GetOptionsBehavior
  : TcxGridBandedTableOptionsBehavior;
begin
  Result := TcxGridBandedTableOptionsBehavior(inherited OptionsBehavior);
end;

function TcxGridBandedTableView.GetOptionsCustomize
  : TcxGridBandedTableOptionsCustomize;
begin
...
function TcxGridBandedTableView.GetVisibleColumn(Index: Integer)
  : TcxGridBandedColumn;
begin
  Result := TcxGridBandedColumn(inherited VisibleColumns[Index]);
end;

procedure TcxGridBandedTableView.SetBackgroundBitmaps
  (Value: TcxGridBandedTableBackgroundBitmaps);
begin
...
procedure TcxGridBandedTableView.SetOnCustomDrawBandHeader
  (Value: TcxGridBandCustomDrawHeaderEvent);
begin
...
procedure TcxGridBandedTableView.SetOptionsBehavior
  (Value: TcxGridBandedTableOptionsBehavior);
begin
  inherited OptionsBehavior := Value;
end;

procedure TcxGridBandedTableView.SetOptionsCustomize
  (Value: TcxGridBandedTableOptionsCustomize);
begin
  inherited OptionsCustomize := Value;
end;

procedure TcxGridBandedTableView.SetOptionsView
  (Value: TcxGridBandedTableOptionsView);
begin
...
procedure TcxGridBandedTableView.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
...
procedure TcxGridBandedTableView.SetPropertyValue(const AName: string;
  const AValue: Variant);
begin
  if AName = 'BandsQuickCustomizationSorted' then
...
procedure TcxGridBandedTableView.DeleteChild(const AObjectName: string;
  AObject: TObject);
begin
...
function TcxGridBandedTableView.CanOffset(ARecordCountDelta,
  APixelScrollRecordOffsetDelta: Integer): Boolean;
begin
  Result := inherited CanOffset(ARecordCountDelta,
    APixelScrollRecordOffsetDelta) and
    ((ARecordCountDelta <> 0) or (APixelScrollRecordOffsetDelta <> 0) or
    (Bands.Layout = blNonFixed));
end;
...
begin
  Result := inherited GetIsControlFocused or
    Controller.HasBandsCustomizationPopup and
    Controller.BandsCustomizationPopup.Visible;
end;
...
begin
  ...
  if not IsLoading and (FBands.VisibleBottomItemCount <> 0) then
    TcxGridBandedColumn(AItem).Position.BandIndex :=
      FBands.VisibleBottomItems[0].Index;
end;

function CompareLoadedBandPositions(Item1, Item2: Pointer): Integer;
var
...
function CompareLoadedBandIndexes(Item1, Item2: Pointer): Integer;
begin
...
procedure TcxGridBandedTableView.AssignColumnsParams(AAssignBandIndexes,
  AAssignOtherIndexes: Boolean);
var
...
begin
  ...
  if AFixedKind1 = AFixedKind2 then
    Result := CompareVisibleColumnPositions(AColumn1.Position,
      AColumn2.Position)
  else if AFixedKind1 = fkLeft then
    Result := -1
  else if AFixedKind2 = fkLeft then
    Result := 1
  else
...
procedure TcxGridBandedTableView.SaveColumnsParams(ABandIndexOnly
  : Boolean = False);
var
  I: Integer;
begin
...
function TcxGridBandedTableView.GetBackgroundBitmapsClass
...
function TcxGridBandedTableView.GetControllerClass
...
function TcxGridBandedTableView.GetOptionsBehaviorClass
  : TcxCustomGridOptionsBehaviorClass;
begin
  Result := TcxGridBandedTableOptionsBehavior;
end;

function TcxGridBandedTableView.GetOptionsCustomizeClass
  : TcxCustomGridTableOptionsCustomizeClass;
begin
  Result := TcxGridBandedTableOptionsCustomize;
end;

function TcxGridBandedTableView.GetOptionsViewClass
...
begin
  ...
  if (Owner <> nil) and ([csDesigning, csReading] * Owner.ComponentState =
    [csDesigning]) then
    Bands.Add;
end;

procedure TcxGridBandedTableView.ApplyBestFit
  ...
  begin
    ...
    try
      for I := 0 to FBands.VisibleRootItemCount - 1 do
        FBands.VisibleRootItems[I].ApplyBestFit(ACheckSizingAbility,
          AFireEvents);
    finally
      EndBestFitUpdate;
    end;
