...
procedure AddExpressDataControllerResourceStringNames
...
begin
  ...
  InternalAdd('cxSDBDetailFilterControllerNotFound',
    @cxSDBDetailFilterControllerNotFound);
...
dxResourceStringsRepository.RegisterProduct('ExpressDataController',
  @AddExpressDataControllerResourceStringNames);
