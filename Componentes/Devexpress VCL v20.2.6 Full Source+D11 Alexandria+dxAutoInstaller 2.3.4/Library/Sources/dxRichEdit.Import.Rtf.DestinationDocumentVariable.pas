...
function TdxDocumentVariableDestination.CreateEmptyClone
...
begin
  ...
  begin
    if FName <> TdxDocumentProperties.UpdateDocVariableFieldsBeforePrintDocVarName
    then
      Importer.DocumentModel.Variables.Add(FName, FValue)
    else
      Importer.DocumentModel.DocumentProperties.
        SetUpdateFieldsBeforePrintFromDocVar(FValue);
  end;
end;

procedure TdxDocumentVariableDestination.NestedGroupFinished(ANestedDestination
