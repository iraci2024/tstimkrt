...
{$ENDIF}
  ...
  cxGridCommon, cxGrid, dxCoreClasses, dxGDIPlusClasses, cxGeometry,
  dxFilterPopupWindow,
  cxGridCustomView, cxGridCustomTableView, dxLayoutLookAndFeels, cxDataStorage,
  cxCustomData, cxEdit, dxLayoutContainer, cxGridCustomLayoutView,
  dxLayoutSelection,
  dxLayoutCommon, Forms, cxNavigator, cxGridViewLayoutContainer, cxLookAndFeels,
  cxStorage;
...
type
  ...
  TcxGridBaseLayoutItemCaptionViewInfo = class
  ...
  protected
    ...
    property Item: TcxGridBaseLayoutItem read GetItem;
  public
    property GridItemViewInfo: TcxGridLayoutViewItemViewInfo
  ...
  protected
    ...
    property Item: TcxGridLayoutItem read GetItem;
  public
    property ContainerViewInfo: TcxGridLayoutContainerViewInfo
      read GetContainerViewInfo;
    property ControlViewInfo: TcxGridLayoutItemEditViewInfo
  ...
  public
    ...
    property GridViewItem: TcxGridLayoutViewItem read GetGridViewItem
      write SetGridViewItem;
  ...
  published
    property CaptionOptions: TcxGridLayoutItemCaptionOptions
  ...
  protected
    ...
    property OnCloneDataChanged: TNotifyEvent read FOnCloneDataChanged
      write FOnCloneDataChanged;
  public
    constructor Create(AContainer: TdxLayoutContainer;
      ARecordViewInfo: TcxCustomGridRecordViewInfo); override;

    function GetItemViewInfo(AItem: TdxCustomLayoutItem)
      : TdxCustomLayoutItemViewInfo; override;

    property RecordViewInfo: TcxGridLayoutViewRecordViewInfo
      read GetRecordViewInfo;
  end;

  { TcxGridLayoutContainerFocusController }

  TcxGridLayoutContainerFocusController = class
  ...
  protected
    ...
    function GetFocusControllerClass
      : TdxLayoutContainerFocusControllerClass; override;
  ...
  protected
    ...
    property ViewInfo: TcxGridLayoutViewItemFilterButtonViewInfo
      read GetViewInfo;
  end;
  ...
  protected
    ...
    property ViewInfo: TcxGridLayoutViewRecordExpandButtonViewInfo
      read GetViewInfo;
  end;
  ...
  public
    constructor Create(ALayoutViewItemViewInfo: TcxGridLayoutViewItemViewInfo);
      reintroduce; virtual;

    property GridView: TcxGridLayoutView read GetGridView;
  end;

  TcxGridLayoutViewItemFilterButtonViewInfoClass = class of
    TcxGridLayoutViewItemFilterButtonViewInfo;
  ...
  protected
    ...
    function GetFilterButtonViewInfoClass
      : TcxGridLayoutViewItemFilterButtonViewInfoClass; virtual;
    function GetHitTestClass: TcxCustomGridHitTestClass; override;
    function GetHotTrack: Boolean; override;
    ...
    property LayoutItemViewInfo: TcxGridLayoutItemViewInfo
      read GetLayoutItemViewInfo;
  public
    constructor Create(ARecordViewInfo: TcxGridLayoutViewRecordViewInfo;
      AItem: TcxGridLayoutViewItem); reintroduce; virtual;
    ...
    property FilterButtonViewInfo: TcxGridLayoutViewItemFilterButtonViewInfo
  ...
  TcxGridLayoutViewRecordExpandButtonViewInfoClass = class of
    TcxGridLayoutViewRecordExpandButtonViewInfo;
  ...
  TcxGridLayoutViewRecordCaptionViewInfoClass = class of
    TcxGridLayoutViewRecordCaptionViewInfo;

  { Cache }

  TcxGridLayoutViewRecordViewInfoCacheItem = class
    (TcxGridCustomLayoutViewInfoCacheItem)
  private
  ...
  public
    ...
    property RecordCaptionHeight: Integer read FRecordCaptionHeight
      write SetRecordCaptionHeight;
    property IsRecordCaptionHeightAssigned: Boolean
      read FIsRecordCaptionHeightAssigned write FIsRecordCaptionHeightAssigned;
  end;
  ...
  protected
    ...
    function GetExpandButtonAlignment
      : TcxGridLayoutViewRecordExpandButtonAlignment; virtual;
    ...
    function GetEditViewDataBounds(AItem: TcxGridLayoutViewItemViewInfo)
      : TRect; virtual;
    ...
    function HasItemFocusRect(AItem: TcxGridLayoutViewItemViewInfo)
      : Boolean; virtual;
    ...
    function GetExpandButtonViewInfoClass
      : TcxGridLayoutViewRecordExpandButtonViewInfoClass; virtual;
    function GetItemViewInfoClass: TcxGridLayoutViewItemViewInfoClass; virtual;
    function GetPainterClass: TcxCustomGridCellPainterClass; override;
    function GetRecordCaptionViewInfoClass
      : TcxGridLayoutViewRecordCaptionViewInfoClass; virtual;
    ...
    property CacheItem: TcxGridLayoutViewRecordViewInfoCacheItem
      read GetCacheItem;
    ...
    property LayoutCalculated: Boolean read FLayoutCalculated
      write SetLayoutCalculated;
    property RecordCaptionBounds: TRect read GetRecordCaptionBounds;
    property RecordCaptionPosition: TcxGroupBoxCaptionPosition
      read GetRecordCaptionPosition;
  public
    ...
    property CaptionViewInfo: TcxGridLayoutViewRecordCaptionViewInfo
      read FCaptionViewInfo;
    property ExpandButtonViewInfo: TcxGridLayoutViewRecordExpandButtonViewInfo
    ...
    property ItemViewInfos[Index: Integer]: TcxGridLayoutViewItemViewInfo
      read GetItemViewInfos;
    property LayoutViewInfo: TcxGridLayoutContainerCloneViewInfo
      read FLayoutViewInfo;
    property LayoutLookAndFeel: TcxGridLayoutLookAndFeel
      read FLayoutLookAndFeel;
    property RecordBorderWidth: Integer read GetRecordBorderWidth;
    property RecordsViewInfo: TcxGridLayoutViewRecordsViewInfo
  ...
  TcxGridLayoutViewInfoHorizontalCalculator = class
  ...
  TcxGridLayoutViewInfoVerticalCalculator = class
  ...
  TcxGridLayoutViewInfoSingleRecordCalculator = class
    (TcxGridLayoutViewInfoHorizontalCalculator)
  protected
    procedure AdjustContentBounds(var ABounds: TRect); override;
  ...
  TcxGridLayoutViewInfoSingleColumnCalculator = class
    (TcxGridLayoutViewInfoVerticalCalculator)
  protected
    procedure AdjustContentBounds(var ABounds: TRect); override;
  ...
  TcxGridLayoutViewInfoMultiColumnCalculator = class
    (TcxGridLayoutViewInfoHorizontalCalculator)
  protected
    procedure AdjustContentBounds(var ABounds: TRect); override;
    function CanCenterHorizontally: Boolean; override;
  ...
  TcxGridLayoutViewInfoSingleRowCalculator = class
    (TcxGridLayoutViewInfoHorizontalCalculator)
  protected
    procedure AdjustContentBounds(var ABounds: TRect); override;
    function CanCenterHorizontally: Boolean; override;
  ...
  TcxGridLayoutViewInfoMultiRowCalculator = class
    (TcxGridLayoutViewInfoVerticalCalculator)
  protected
    procedure AdjustContentBounds(var ABounds: TRect); override;
    function CanCenterVertically: Boolean; override;
  ...
  protected
    ...
    procedure CalculateVisibleRecordsBound(out AFirstRecordIndex,
      ALastRecordIndex: Integer); virtual;
    ...
    property ControllerHelper: TcxGridLayoutViewControllerHelper
      read GetControllerHelper;
    property GridView: TcxGridLayoutView read GetGridView;
    property GridViewInfo: TcxGridLayoutViewViewInfo read GetGridViewInfo;
    property Items[Index: Integer]: TcxGridLayoutViewRecordViewInfo
  ...
  TcxGridLayoutViewSeparatorsViewInfo = class
  ...
  TcxGridLayoutViewSingleRecordSeparatorsViewInfo = class
    (TcxGridLayoutViewSeparatorsViewInfo);

  { TcxGridLayoutViewSingleColumnRecordSeparatorsViewInfo }

  TcxGridLayoutViewSingleColumnRecordSeparatorsViewInfo = class
    (TcxGridLayoutViewSeparatorsViewInfo)
  public
  ...
  TcxGridLayoutViewSingleRowRecordSeparatorsViewInfo = class
    (TcxGridLayoutViewSeparatorsViewInfo)
  public
    procedure DoCalculate; override;
  end;
  ...
  TcxGridLayoutViewMultiColumnRecordSeparatorsViewInfo = class
    (TcxGridLayoutViewSingleRowRecordSeparatorsViewInfo)
  public
    procedure DoCalculate; override;
  end;
  ...
  TcxGridLayoutViewMultiRowRecordSeparatorsViewInfo = class
    (TcxGridLayoutViewSingleColumnRecordSeparatorsViewInfo)
  public
    procedure DoCalculate; override;
  end;
  ...
  protected
    ...
    function DisplayCaptionToCaption(const ADisplayCaption: string)
      : string; virtual;
  ...
  public
    ...
    property GridView: TcxGridLayoutView read GetGridView;
    property FocusedCellViewInfo: TcxGridLayoutViewItemViewInfo
      read GetFocusedLayoutViewItemViewInfo;
  published
    property LayoutItem: TcxGridLayoutItem read FLayoutItem write SetLayoutItem;
    property Options: TcxGridLayoutViewItemOptions read GetOptions
      write SetOptions;
    property SortIndex;
    property SortOrder;
  ...
  TcxGridLayoutViewControllerHelper = class
    (TcxGridCustomLayoutViewControllerHelper)
  private
    function GetController: TcxGridLayoutViewController;
    function GetLayoutContainerViewInfo(AHitTest: TcxGridRecordHitTest)
      : TcxGridLayoutContainerCloneViewInfo;
    function GetViewInfo: TcxGridLayoutViewViewInfo;
  protected
    function CanScrollBarVisible(AKind: TScrollBarKind): Boolean; override;
    procedure DoInitScrollBarParameters(AKind: TScrollBarKind;
      ACanHide: Boolean); override;
  ...
  TcxGridLayoutViewControllerHorizontalHelper = class
    (TcxGridLayoutViewControllerHelper)
  protected
  ...
  TcxGridLayoutViewControllerVerticalHelper = class
    (TcxGridLayoutViewControllerHelper)
  protected
    function IsDataScrollBar(AKind: TScrollBarKind): Boolean; override;
    function GetContentPageSize: Integer; override;
  ...
  TcxGridLayoutViewCustomizationController = class
  ...
  protected
    ...
    // scrolling
    procedure ScrollContentScrollBar(AScrollCode: TScrollCode;
    ...
    function GetNextIndex(AFocusedIndex: Integer;
      AGoForward, AGoOnCycle: Boolean; out ACycleChanged: Boolean): Integer;

    property ContentScrollBarPosition: Integer read FContentScrollBarPosition
      write SetContentScrollBarPosition;
    property FocusedRecordViewInfo: TcxGridLayoutViewRecordViewInfo
      read GetFocusedRecordViewInfo;
  ...
  public
    ...
    property FocusedItem: TcxGridLayoutViewItem read GetFocusedItem
  ...
  published
    ...
    property RecordBorderSelection: Boolean read FRecordBorderSelection
      write SetRecordBorderSelection default True;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property ExpandRecordOnDblClick: Boolean read FExpandRecordOnDblClick
      write SetExpandRecordOnDblClick default True;
  ...
  public
    ...
    property GridView: TcxGridLayoutView read GetGridView;
  published
    property GroupExpanding: Boolean read GetGroupExpanding
      write SetGroupExpanding default False;
    property ItemFiltering;
    property RecordExpanding: Boolean read GetRecordExpanding
      write SetRecordExpanding default False;
  end;
  ...
  public
    constructor Create(AOptionsView: TcxGridLayoutViewOptionsView);
      reintroduce; virtual;
    procedure Assign(Source: TPersistent); override;
    ...
    property GridView: TcxGridLayoutView read GetGridView;
  published
    property AnimationInterval: Cardinal read FAnimatedDelay
      write FAnimatedDelay
      default cxGridLayoutViewCarouselModeDefaultAnimatedDelay;
    property AutoPitchAngle: Boolean read FAutoPitchAngle
      write SetAutoPitchAngle default False;
    property BackgroundRecordAlphaLevel: Integer
      read FBackgroundRecordAlphaLevel write SetBackgroundRecordAlphaLevel
      default 0;
    property BackgroundRecordEndScale: Cardinal read FBackgroundRecordEndScale
      write SetBackgroundRecordEndScale
      default cxGridLayoutViewCarouselModeDefaultBackgroundRecordEndScale;
    property BackgroundRecordStartScale: Cardinal
      read FBackgroundRecordStartScale write SetBackgroundRecordStartScale
      default cxGridLayoutViewCarouselModeDefaultBackgroundRecordStartScale;
    property InterpolationMode: TdxGPInterpolationMode read FInterpolationMode
      write SetInterpolationMode default imDefault;
    property PitchAngle: Double read FPitchAngle write SetPitchAngle
      stored IsPitchAngleStored;
    ...
    property RecordCount: Integer read FRecordCount write SetRecordCount
      default cxGridLayoutViewCarouselModeDefaultRecordCount;
    property RollAngle: Double read FRollAngle write SetRollAngle
      stored IsRollAngleStored;
  end;
  ...
  strict private
    ...
    procedure SetExpandButtonAlignment
  ...
  public
    constructor Create(AOptionsView: TcxGridLayoutViewOptionsView);
      reintroduce; virtual;
    procedure Assign(Source: TPersistent); override;
    function GetFormattedText(AGridRecord: TcxGridLayoutViewRecord)
      : string; virtual;
  published
    property DisplayMask: string read FDisplayMask write SetDisplayMask
      stored IsDisplayMaskStored;
    property ExpandButtonAlignment: TcxGridLayoutViewRecordExpandButtonAlignment
      read FExpandButtonAlignment write SetExpandButtonAlignment
      default rebaRight;
    property Height: Integer read FHeight write SetHeight default 0;
    property TextAlignmentHorz: TAlignment read FTextAlignmentHorz
      write SetTextAlignmentHorz default taLeftJustify;
    property TextAlignmentVert: TcxAlignmentVert read FTextAlignmentVert
      write SetTextAlignmentVert default vaCenter;
  ...
  TcxGridLayoutViewSingleRecordStretch = (srsNone, srsHorizontal, srsVertical,
    srsClient);
  ...
  private
    ...
    procedure SetSingleRecordStretch
      (Value: TcxGridLayoutViewSingleRecordStretch);
  ...
  public
    ...
    property GridView: TcxGridLayoutView read GetGridView;
  published
    property CarouselMode: TcxGridLayoutViewCarouselMode read FCarouselMode
      write SetCarouselMode;
    property CenterRecords: Boolean read FCenterRecords write SetCenterRecords
      default True;
    property ItemPadding: TcxLayoutViewLookAndFeelItemPadding
      read GetItemPadding write SetItemPadding;
    property MaxColumnCount: Integer read FMaxColumnCount
      write SetMaxColumnCount default 0;
    ...
    property RecordBorderWidth: Integer read FRecordBorderWidth
      write SetRecordBorderWidth
      default cxGridLayoutViewDefaultRecordBorderWidth;
    property RecordCaption: TcxGridLayoutViewRecordCaption read FRecordCaption
      write SetRecordCaption;
    property RecordIndent: Integer read GetRecordIndent write SetRecordIndent
    ...
    property ShowOnlyEntireRecords: Boolean read FShowOnlyEntireRecords
      write SetShowOnlyEntireRecords default True;
    property SingleRecordStretch: TcxGridLayoutViewSingleRecordStretch
      read FSingleRecordStretch write SetSingleRecordStretch default srsNone;
    property ViewMode: TcxGridLayoutViewViewMode read FViewMode
      write SetViewMode default lvvmSingleRecord;
  end;
  ...
  public
    ...
    procedure GetItemParams(ARecord: TcxCustomGridRecord;
      AItem: TcxCustomGridTableItem; out AParams: TcxViewParams); virtual;
    procedure GetItemHotTrackParams(AItem: TcxCustomGridTableItem;
      out AParams: TcxViewParams); virtual;
    procedure GetRecordBorderParams(ARecord: TcxCustomGridRecord;
      out AParams: TcxViewParams); virtual;
    procedure GetRecordCaptionParams(ARecord: TcxCustomGridRecord;
      out AParams: TcxViewParams); virtual;
    procedure GetRecordBorderVisualParams(ARecord: TcxCustomGridRecord;
      out AParams: TcxViewParams); virtual;
  ...
  published
    ...
    property ItemHotTrack: TcxStyle index vsItemHotTrack read GetValue
      write SetValue;
    property RecordBorder: TcxStyle index vsRecordBorder read GetValue
      write SetValue;
    property RecordCaption: TcxStyle index vsRecordCaption read GetValue
      write SetValue;
    property Selection;
    property StyleSheet;
    property OnGetGroupStyle: TcxGridGetCellStyleEvent read FOnGetGroupStyle
      write FOnGetGroupStyle;
    property OnGetItemStyle: TcxGridGetCellStyleEvent read FOnGetItemStyle
      write SetOnGetItemStyle;
    property OnGetRecordBorderStyle: TcxGridGetRecordStyleEvent
      read FOnGetRecordBorderStyle write SetOnGetRecordBorderStyle;
    property OnGetRecordCaptionStyle: TcxGridGetRecordStyleEvent
      read FOnGetRecordCaptionStyle write SetOnGetRecordCaptionStyle;
  end;
  ...
  published
    property Styles: TcxGridLayoutViewStyles read GetStylesValue
      write SetStylesValue;
  end;

  TcxGridLayoutViewCustomDrawRecordHeaderEvent = procedure
  ...
  TcxGridLayoutView = class(TcxGridCustomLayoutView, IdxLayoutContainerOwner)
  strict private
    ...
    procedure SetDateTimeHandling
      (Value: TcxGridLayoutViewDateTimeHandling); inline;
    ...
    procedure SetOptionsBehavior
      (Value: TcxGridLayoutViewOptionsBehavior); inline;
    procedure SetOptionsCustomize
      (Value: TcxGridLayoutViewOptionsCustomize); inline;
    procedure SetOptionsData(Value: TcxGridLayoutViewOptionsData); inline;
    procedure SetOptionsSelection
      (Value: TcxGridLayoutViewOptionsSelection); inline;
    ...
    procedure SetOnCustomDrawRecordCaption
      (Value: TcxGridLayoutViewCustomDrawRecordHeaderEvent);
  protected
    procedure AfterRestoring; override;
    procedure BeforeRestoring; override;
    function HandleSetStoredPropertyValueError(Sender: TcxStorage;
    ...
    procedure AssignDefaultBounds(AViewInfo
      : TcxGridLayoutContainerCloneViewInfo);
    procedure RecalculateCloneData;
    procedure ResetCalculatedLayoutViewInfo;
    procedure ResetCloneData;
    procedure UpdateContainerStyles(ARecord: TcxCustomGridRecord;
      var ALayoutLookAndFeel: TcxGridLayoutLookAndFeel);
    ...
    procedure DoCustomDrawRecordHeader(ACanvas: TcxCanvas;
      AViewInfo: TcxGridLayoutViewRecordCaptionViewInfo;
      var ADone: Boolean); virtual;
    function HasCustomDrawRecordHeader: Boolean;
    function DrawRecordBorderSelected(ARecord: TcxCustomGridRecord)
      : Boolean; virtual;

    property DefaultCloneData: TMemoryStream read FDefaultCloneData;
    property DefaultLayoutViewInfo: TcxGridLayoutContainerCloneViewInfo
      read FDefaultLayoutViewInfo;
    property IsDefaultViewInfoCalculated: Boolean
      read FIsDefaultViewInfoCalculated write SetIsDefaultViewInfoCalculated;
    property Root: TdxLayoutGroup read GetRoot;
  public
    constructor Create(AOwner: TComponent); override;
    constructor CreateEx(AControl: TcxControl;
      AAssignOwner: Boolean = True); override;
    destructor Destroy; override;
    procedure GetChildren(Proc: TGetChildProc; Root: TComponent); override;
    function CreateItem: TcxGridLayoutViewItem;
    function SizeChanged(AUpdateSelfOnly: Boolean = False;
      AKeepMaster: Boolean = False): Boolean; override;
    ...
    property Items[Index: Integer]: TcxGridLayoutViewItem read GetItem
      write SetItem;
    property ViewInfo: TcxGridLayoutViewViewInfo read GetViewInfo;
    property VisibleItems[Index: Integer]: TcxGridLayoutViewItem
      read GetVisibleItem;
  published
    property DataController: TcxGridDataController read GetDataController
      write SetDataController;
    property DateTimeHandling: TcxGridLayoutViewDateTimeHandling
      read GetDateTimeHandling write SetDateTimeHandling;
    property Filtering: TcxGridLayoutViewFiltering read GetFiltering
      write SetFiltering;
    property Images;
    property OptionsBehavior: TcxGridLayoutViewOptionsBehavior
      read GetOptionsBehavior write SetOptionsBehavior;
    property OptionsCustomize: TcxGridLayoutViewOptionsCustomize
    ...
    property OptionsSelection: TcxGridLayoutViewOptionsSelection
    ...
    property OnCustomDrawRecordCaption
      : TcxGridLayoutViewCustomDrawRecordHeaderEvent
      read FOnCustomDrawRecordCaption write SetOnCustomDrawRecordCaption;
  end;
...
uses
  ...
  cxGridLayoutViewCarouselMode, cxGridLayoutViewCustomizationForm, Dialogs,
  dxDPIAwareUtils, dxCoreGraphics, RTLConsts;
...
type
  ...
  TdxLayoutLookAndFeelGroupOptionsAccess = class
    (TdxLayoutLookAndFeelGroupOptions);
  TcxLayoutViewLookAndFeelItemPaddingAccess = class
...
function TcxGridLayoutItemPainter.GetControlPainterClass
...
begin
  ...
  begin
    GridView.StylesAdapter.GetContentParams(GetRecord,
      Item.GridViewItem, AParams);
...
function TcxGridBaseLayoutItemEditViewInfo.GetDataViewInfo
  : TcxGridLayoutViewItemViewInfo;
begin
...
function TcxGridLayoutItemEditViewInfo.GetDataViewInfo
  : TcxGridLayoutViewItemViewInfo;
begin
  Result := TcxGridLayoutViewItemViewInfo(inherited DataViewInfo);
end;
...
begin
  ...
  begin
    TdxVisualRefinements.HeaderPadding.InflatePadding(Result,
      AItemViewInfo.ScaleFactor);
...
function TcxGridBaseLayoutItemCaptionViewInfo.GetItemViewInfo
  : TcxGridBaseLayoutItemViewInfo;
begin
...
function TcxGridLayoutItemCaptionViewInfo.GetItemViewInfo
  : TcxGridLayoutItemViewInfo;
begin
...
function TcxGridBaseLayoutItemViewInfo.GetCaptionViewInfoClass
  : TdxCustomLayoutItemCaptionViewInfoClass;
begin
  Result := TcxGridBaseLayoutItemCaptionViewInfo;
end;

function TcxGridBaseLayoutItemViewInfo.GetControlViewInfoClass
  : TdxLayoutControlItemControlViewInfoClass;
begin
  Result := TcxGridBaseLayoutItemEditViewInfo;
end;

function TcxGridBaseLayoutItemViewInfo.GetGridItemViewInfo
  : TcxGridLayoutViewItemViewInfo;
begin
...
function TcxGridLayoutItemViewInfo.GetCaptionViewInfoClass
  : TdxCustomLayoutItemCaptionViewInfoClass;
begin
  Result := TcxGridLayoutItemCaptionViewInfo;
end;

function TcxGridLayoutItemViewInfo.GetCurrentGridItemViewInfo
  : TcxGridTableDataCellViewInfo;
begin
  Result := ContainerViewInfo.GetGridItemViewInfo(Self);
end;

function TcxGridLayoutItemViewInfo.GetControlViewInfoClass
  : TdxLayoutControlItemControlViewInfoClass;
begin
  Result := TcxGridLayoutItemEditViewInfo;
end;

function TcxGridLayoutItemViewInfo.GetPainterClass
  : TdxCustomLayoutItemPainterClass;
begin
  Result := TcxGridLayoutItemPainter;
end;

function TcxGridLayoutItemViewInfo.GetContainerViewInfo
  : TcxGridLayoutContainerViewInfo;
begin
  Result := TcxGridLayoutContainerViewInfo(inherited ContainerViewInfo);
end;

function TcxGridLayoutItemViewInfo.GetControlViewInfo
  : TcxGridLayoutItemEditViewInfo;
begin
...
begin
  if not Container.IsDestroying and (GridViewItem <> nil) and
    GridViewItem.GridView.IsPattern and
...
begin
  Result := inherited IsVisibleForCustomization and
    GridViewItem.VisibleForCustomization
end;
...
function TcxGridBaseLayoutItem.GetViewInfoClass
...
class function TcxGridLayoutItem.GetCaptionOptionsClass
...
procedure TcxGridLayoutItem.SetCaptionOptions
  (Value: TcxGridLayoutItemCaptionOptions);
begin
...
constructor TcxGridLayoutContainerCloneViewInfo.Create
...
function TcxGridLayoutContainerCloneViewInfo.GetItemViewInfo
  (AItem: TdxCustomLayoutItem): TdxCustomLayoutItemViewInfo;
begin
  Result := ItemsViewInfo.FindItemViewInfo(AItem);
end;

function TcxGridLayoutContainerCloneViewInfo.CanAssignBounds
...
function TcxGridLayoutContainerCloneViewInfo.GetLayoutLookAndFeel
...
begin
  Result := inherited IsActuallyVisible and (RecordViewInfo <> nil) and
    RecordViewInfo.Visible;
end;
...
function TcxGridLayoutContainerCloneViewInfo.GetRecordViewInfo
  : TcxGridLayoutViewRecordViewInfo;
begin
  Result := TcxGridLayoutViewRecordViewInfo(inherited RecordViewInfo);
end;

procedure TcxGridLayoutContainerCloneViewInfo.ItemCloneDataListChangedHandler
  (Sender: TObject);
begin
...
function TcxGridLayoutContainerFocusController.IsFocused
  ...
  try
    ...
    begin
      ...
      begin
        ...
        AGridViewItem := TcxGridLayoutViewItem
          (GridView.FindItemByObjectName
          (AGridLayoutItem.LoadedGridViewItemName));
...
function TcxGridLayoutContainer.GetFocusControllerClass
...
function TcxGridLayoutContainer.GetViewInfoClass
...
function TcxGridLayoutViewItemFilterButtonPainter.GetViewInfo
  : TcxGridLayoutViewItemFilterButtonViewInfo;
begin
...
function TcxGridLayoutViewItemPainter.GetViewInfo
  : TcxGridLayoutViewItemViewInfo;
begin
...
function TcxGridLayoutViewRecordExpandButtonPainter.GetViewInfo
  : TcxGridLayoutViewRecordExpandButtonViewInfo;
begin
...
begin
  with ViewInfo do
    LookAndFeelPainter.LayoutViewDrawScaledRecordExpandButton(Self.Canvas,
      Bounds, ButtonState, RecordViewInfo.IsExpanded, ScaleFactor);
end;
...
begin
  ViewInfo.LookAndFeelPainter.LayoutViewDrawRecordCaption(Canvas,
    ViewInfo.Bounds, ViewInfo.TextBounds,
    ViewInfo.RecordViewInfo.RecordCaptionPosition, GetState,
...
begin
  with ViewInfo.RecordViewInfo do
    if not Selected then
      Result := cxbsNormal
    else if GridView.IsControlFocused then
      Result := cxbsHot
    else
      Result := cxbsDisabled;
end;

function TcxGridLayoutViewRecordCaptionPainter.GetViewInfo
  : TcxGridLayoutViewRecordCaptionViewInfo;
begin
...
begin
  if CanDrawBackground then
    with ViewInfo do
      LookAndFeelPainter.LayoutViewDrawRecordContent(Self.Canvas,
        LayoutAreaBounds, RecordCaptionPosition, GetState, LayoutAreaBorders);
end;
...
begin
  ...
  with TdxCustomLayoutItemViewInfoAccess(ARootViewInfo).GetPainterClass.Create
    (ARootViewInfo) do
    try
      Paint(Canvas);
    finally
...
function TcxGridLayoutViewRecordPainter.GetViewInfo
  : TcxGridLayoutViewRecordViewInfo;
begin
...
function TcxGridLayoutViewViewData.GetRecordClass(const ARecordInfo: TcxRowInfo)
...
function TcxGridLayoutViewItemFilterButtonViewInfo.
...
begin
  ...
  begin
    ...
    Result.Right := ItemViewInfo.LayoutItemViewInfo.CaptionViewInfo.
      Bounds.Right;
  end;
end;

function TcxGridLayoutViewItemFilterButtonViewInfo.GetFilterPopupMode
  : TdxFilterPopupWindowMode;
begin
  Result := ItemViewInfo.Item.GetFilterPopupMode;
end;

function TcxGridLayoutViewItemFilterButtonViewInfo.GetGridView
  : TcxGridLayoutView;
begin
  Result := TcxGridLayoutView(inherited GridView);
end;

function TcxGridLayoutViewItemFilterButtonViewInfo.GetHitTestClass
...
function TcxGridLayoutViewItemFilterButtonViewInfo.GetItem
  : TcxCustomGridTableItem;
begin
  Result := ItemViewInfo.Item;
end;

function TcxGridLayoutViewItemFilterButtonViewInfo.GetPainterClass
...
begin
  Result := ItemViewInfo.Visible and (ItemViewInfo.LayoutItemViewInfo <> nil)
    and ItemViewInfo.LayoutItemViewInfo.HasCaption and
...
constructor TcxGridLayoutViewItemViewInfo.Create(ARecordViewInfo
  : TcxGridLayoutViewRecordViewInfo; AItem: TcxGridLayoutViewItem);
begin
...
function TcxGridLayoutViewItemViewInfo.
  AllowRightToLeftConversionOnRecalculate: Boolean;
begin
  Result := False;
end;

procedure TcxGridLayoutViewItemViewInfo.Calculate(ALeftBound,
...
function TcxGridLayoutViewItemViewInfo.GetHitTest(const P: TPoint)
...
function TcxGridLayoutViewItemViewInfo.MouseDown(AHitTest: TcxCustomGridHitTest;
...
function TcxGridLayoutViewItemViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
procedure TcxGridLayoutViewItemViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
...
procedure TcxGridLayoutViewItemViewInfo.GetCaptionParams
...
begin
  ...
  Inc(Result.Top);
  AOffset := FilterButtonViewInfo.Width + ScaleFactor.Apply
    (cxGridCellTextOffset) - LayoutItemViewInfo.ElementOffsetHorz;
...
function TcxGridLayoutViewItemViewInfo.GetFilterButtonViewInfoClass
  : TcxGridLayoutViewItemFilterButtonViewInfoClass;
begin
  Result := TcxGridLayoutViewItemFilterButtonViewInfo;
end;

function TcxGridLayoutViewItemViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
begin
  Result := not GridView.IsDesigning and
    (HasFilterButton and FilterButtonViewInfo.NeedsContainerHotTrack) or
    inherited GetHotTrack;
end;

function TcxGridLayoutViewItemViewInfo.GetLayoutItemViewInfoInstance
  : TcxGridCustomLayoutItemViewInfo;
begin
  if FLayoutItemViewInfo = nil then
    FLayoutItemViewInfo := TcxGridLayoutItemViewInfo
      (RecordViewInfo.LayoutViewInfo.GetItemViewInfo(Item.LayoutItem));
...
begin
  Result := GridView.IsDesigning and
    ...
    GridView.Controller.DesignController.IsObjectSelected
    (Item.LayoutItem.GetObjectForSelect));
end;

function TcxGridLayoutViewItemViewInfo.GetLayoutItemViewInfo
  : TcxGridLayoutItemViewInfo;
begin
  Result := TcxGridLayoutItemViewInfo(inherited LayoutItemViewInfo);
end;

function TcxGridLayoutViewItemViewInfo.GetRecordViewInfo
  : TcxGridLayoutViewRecordViewInfo;
begin
  Result := TcxGridLayoutViewRecordViewInfo(inherited RecordViewInfo);
end;
...
constructor TcxGridLayoutViewRecordExpandButtonViewInfo.Create(ARecordViewInfo
  : TcxGridLayoutViewRecordViewInfo);
begin
...
function TcxGridLayoutViewRecordExpandButtonViewInfo.
...
function TcxGridLayoutViewRecordExpandButtonViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
...
function TcxGridLayoutViewRecordExpandButtonViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
constructor TcxGridLayoutViewRecordCaptionViewInfo.Create(ARecordViewInfo
  : TcxGridLayoutViewRecordViewInfo);
begin
  inherited Create(ARecordViewInfo.GridViewInfo);
  FRecordViewInfo := ARecordViewInfo;
...
function TcxGridLayoutViewRecordCaptionViewInfo.GetAlignmentVert
  : TcxAlignmentVert;
begin
  Result := GridView.OptionsView.RecordCaption.TextAlignmentVert;
end;

function TcxGridLayoutViewRecordCaptionViewInfo.GetGridRecord
  : TcxGridLayoutViewRecord;
begin
...
function TcxGridLayoutViewRecordCaptionViewInfo.GetHitTestClass
  : TcxCustomGridHitTestClass;
begin
  Result := TcxGridLayoutViewRecordCaptionHitTest;
end;

function TcxGridLayoutViewRecordCaptionViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
function TcxGridLayoutViewRecordCaptionViewInfo.GetDrawTextRotationAngle
  : TcxRotationAngle;
begin
  if RotatedText then
    Result := raPlus90
...
procedure TcxGridLayoutViewRecordCaptionViewInfo.GetViewParams
  (var AParams: TcxViewParams);
begin
...
procedure TcxGridLayoutViewRecordCaptionViewInfo.InitHitTest
  (AHitTest: TcxCustomGridHitTest);
begin
...
procedure TcxGridLayoutViewRecordCaptionViewInfo.PrepareCanvas
  (ACanvas: TcxCanvas);
begin
  inherited;
...
function TcxGridLayoutViewRecordViewInfoCacheItem.GetGridRecord
  : TcxGridLayoutViewRecord;
begin
...
constructor TcxGridLayoutViewRecordViewInfo.Create(ARecordsViewInfo
...
procedure TcxGridLayoutViewRecordViewInfo.Calculate(ALeftBound,
  ATopBound: Integer; AWidth: Integer = -1; AHeight: Integer = -1);
begin
  CalculateLayout;
  inherited;
  ...
  if IsGridViewInfoRightToLeftConverted then
    LayoutViewInfo.Offset :=
      Point(GridViewInfo.Bounds.Right - LayoutAreaBounds.Right,
      LayoutAreaBounds.Top)
  else
    LayoutViewInfo.Offset :=
      Point(LayoutAreaBounds.Left - GridViewInfo.Bounds.Left,
      LayoutAreaBounds.Top);
  CalculateItemViewInfos;
end;

procedure TcxGridLayoutViewRecordViewInfo.MainCalculate(ALeftBound,
  ATopBound: Integer);
begin
...
function TcxGridLayoutViewRecordViewInfo.GetBoundsForItem
...
function TcxGridLayoutViewRecordViewInfo.GetCacheItem
  : TcxGridLayoutViewRecordViewInfoCacheItem;
begin
  Result := TcxGridLayoutViewRecordViewInfoCacheItem(inherited CacheItem);
end;

function TcxGridLayoutViewRecordViewInfo.GetCellViewInfoByItem
...
function TcxGridLayoutViewRecordViewInfo.GetHitTest(const P: TPoint)
  : TcxCustomGridHitTest;
var
  I: Integer;
  AHitTest: TcxCustomGridHitTest;
...
procedure TcxGridLayoutViewRecordViewInfo.GetRecordBorderViewParams
  (var AParams: TcxViewParams);
begin
...
function TcxGridLayoutViewRecordViewInfo.GetEditViewDataBounds
  (AItem: TcxGridLayoutViewItemViewInfo): TRect;
begin
...
begin
  Result := LookAndFeelPainter.LayoutViewRecordCaptionTailSize
    (GetRecordCaptionPosition);
end;
...
function TcxGridLayoutViewRecordViewInfo.GetRecordCaptionPosition
  : TcxGroupBoxCaptionPosition;
begin
  if not HasRecordCaption then
    Result := cxgpCenter
  else if IsRecordCaptionRotated then
...
function TcxGridLayoutViewRecordViewInfo.HasItemFocusRect
  (AItem: TcxGridLayoutViewItemViewInfo): Boolean;
begin
  Result := True;
end;
...
function TcxGridLayoutViewRecordViewInfo.
  IsGridViewInfoRightToLeftConverted: Boolean;
begin
...
var
  I: Integer;
begin
  if GridViewInfo.CalculateDown and
    (GridView.Controller.FocusedRecordViewInfo = Self) and Visible then
    for I := 0 to ItemViewInfoCount - 1 do
...
procedure TcxGridLayoutViewRecordViewInfo.CloneDataChangedHandler
  (Sender: TObject);
var
...
begin
  Result := (GridRecord.CloneDataStream.Size = 0) or
    ...
    CompareMem(GridView.DefaultCloneData.Memory,
    GridRecord.CloneDataStream.Memory, GridRecord.CloneDataStream.Size));
end;
...
begin
  FLayoutViewInfo := TcxGridLayoutContainerCloneViewInfo.Create
    (GridView.Container, Self);
  FLayoutViewInfo.OnCloneDataChanged := CloneDataChangedHandler;
end;

function TcxGridLayoutViewRecordViewInfo.GetPainterClass
  : TcxCustomGridCellPainterClass;
begin
...
begin
  ...
  else if FIsPixelScrollSizeCalculating and IsDefaultCloneData then
...
function TcxGridLayoutViewRecordViewInfo.GetExpandButtonViewInfoClass
  : TcxGridLayoutViewRecordExpandButtonViewInfoClass;
begin
  Result := TcxGridLayoutViewRecordExpandButtonViewInfo;
end;

function TcxGridLayoutViewRecordViewInfo.GetItemViewInfoClass
  : TcxGridLayoutViewItemViewInfoClass;
begin
  Result := TcxGridLayoutViewItemViewInfo;
end;

function TcxGridLayoutViewRecordViewInfo.GetRecordCaptionViewInfoClass
  : TcxGridLayoutViewRecordCaptionViewInfoClass;
begin
...
begin
  if IsRecordCaptionRotated then
    Result := GetRecordCaptionHeight + 2 * RecordBorderWidth +
      GetRecordCaptionTailSize
  else
...
procedure TcxGridLayoutViewRecordViewInfo.CalculateExpandButtonBounds
  (var ABounds: TRect);
var
  ASize: Integer;
begin
...
function TcxGridLayoutViewRecordViewInfo.CanGenerateExpandButtonHitTest
  : Boolean;
begin
  Result := False;
end;
...
begin
  if (AButton = mbLeft) and (ssDouble in AShift) and
    (AHitTest.HitTestCode = htLayoutViewRecordCaption) and
    GridView.OptionsBehavior.ExpandRecordOnDblClick then
  begin
...
procedure TcxGridLayoutViewRecordViewInfo.DoRightToLeftConversion
  (const ABounds: TRect);
begin
...
function TcxGridLayoutViewRecordViewInfo.GetExpandButtonAlignment
...
function TcxGridLayoutViewRecordViewInfo.GetRecordsViewInfo
  : TcxGridLayoutViewRecordsViewInfo;
begin
...
function TcxGridLayoutViewRecordViewInfo.GetGridViewInfo
  : TcxGridLayoutViewViewInfo;
begin
...
function TcxGridLayoutViewRecordViewInfo.GetItemViewInfos(Index: Integer)
  : TcxGridLayoutViewItemViewInfo;
begin
...
procedure TcxGridLayoutViewInfoHorizontalCalculator.AdjustContentBounds
  (var ABounds: TRect);
begin
  inherited;
...
procedure TcxGridLayoutViewInfoHorizontalCalculator.DoCalculate
  (const AContentBounds: TRect);
begin
...
function TcxGridLayoutViewInfoHorizontalCalculator.
...
procedure TcxGridLayoutViewInfoHorizontalCalculator.CenterHorizontally
  (const AContentBounds: TRect);
var
  I, J: Integer;
...
begin
  ...
  for I := 0 to RecordsViewInfo.Bands.VisibleCount - 1 do
    for J := 0 to RecordsViewInfo.Bands[I].VisibleCount - 1 do
      ...
      begin
        CalculationPosition := cxPointOffset(CalculationPosition,
          AOffset * (1 + 2 * Col), 0);
        CalculationPosition := cxPointOffset(CalculationPosition,
          (Self.RecordsViewInfo.GetMaxRecordWidth(Col) - Width) div 2, 0);
      end;
end;

procedure TcxGridLayoutViewInfoHorizontalCalculator.CenterVertically
  (const AContentBounds: TRect);
var
  I, J: Integer;
  AColumnCount: Integer;
...
begin
  ...
  begin
    ...
    for J := 0 to ARowCount - 1 do
      with TcxGridLayoutViewRecordViewInfo(RecordsViewInfo.Bands[I][J]) do
        CalculationPosition := cxPointOffset(CalculationPosition, 0,
          AOffset * (1 + 2 * Row));
  end;
end;

function TcxGridLayoutViewInfoHorizontalCalculator.GetRecordsViewInfo
  : TcxGridLayoutViewRecordsViewInfo;
begin
  Result := TcxGridLayoutViewRecordsViewInfo(inherited RecordsViewInfo);
end;
...
procedure TcxGridLayoutViewInfoVerticalCalculator.AdjustContentBounds
  (var ABounds: TRect);
begin
  inherited;
  if RecordsViewInfo.GridView.OptionsView.CenterRecords then
...
procedure TcxGridLayoutViewInfoVerticalCalculator.DoCalculate
  (const AContentBounds: TRect);
begin
  inherited DoCalculate(AContentBounds);
  if CanCenterHorizontally then
...
procedure TcxGridLayoutViewInfoVerticalCalculator.CenterHorizontally
  (const AContentBounds: TRect);
var
...
procedure TcxGridLayoutViewInfoVerticalCalculator.CenterVertically
  (const AContentBounds: TRect);
var
...
begin
  ...
  for AColumn := 0 to RecordsViewInfo.Bands.Count - 1 do
    for ARow := 0 to RecordsViewInfo.Bands[AColumn].Count - 1 do
      if RecordsViewInfo.Bands.IsItemVisible(AColumn, ARow) then
        with TcxGridLayoutViewRecordViewInfo
          (RecordsViewInfo.Bands[AColumn][ARow]) do
        begin
          CalculationPosition := cxPointOffset(CalculationPosition, 0,
            AOffset * (1 + 2 * Row));
          CalculationPosition := cxPointOffset(CalculationPosition, 0,
            (Self.RecordsViewInfo.GetMaxRecordHeight(Row) - Height) div 2);
        end;
end;

function TcxGridLayoutViewInfoVerticalCalculator.GetRecordsViewInfo
  : TcxGridLayoutViewRecordsViewInfo;
begin
  Result := TcxGridLayoutViewRecordsViewInfo(inherited RecordsViewInfo);
end;
...
procedure TcxGridLayoutViewInfoSingleRecordCalculator.AdjustContentBounds
  (var ABounds: TRect);
begin
...
function TcxGridLayoutViewInfoSingleRecordCalculator.
  CanCenterVertically: Boolean;
begin
...
procedure TcxGridLayoutViewInfoSingleColumnCalculator.AdjustContentBounds
  (var ABounds: TRect);
begin
  inherited AdjustContentBounds(ABounds);
...
function TcxGridLayoutViewInfoSingleColumnCalculator.
  CanCenterHorizontally: Boolean;
begin
...
function TcxGridLayoutViewInfoMultiColumnCalculator.
  CanCenterHorizontally: Boolean;
begin
  Result := inherited CanCenterHorizontally and
    RecordsViewInfo.GridView.OptionsView.ShowOnlyEntireRecords and
    not RecordsViewInfo.ControllerHelper.NeedContentScrollBar;
end;

procedure TcxGridLayoutViewInfoMultiColumnCalculator.AdjustContentBounds
  (var ABounds: TRect);
begin
  inherited AdjustContentBounds(ABounds);
  Dec(ABounds.Left, RecordsViewInfo.Controller.ContentScrollBarPosition);
...
procedure TcxGridLayoutViewInfoSingleRowCalculator.AdjustContentBounds
  (var ABounds: TRect);
begin
  inherited AdjustContentBounds(ABounds);
  Dec(ABounds.Top, RecordsViewInfo.Controller.ContentScrollBarPosition);
...
function TcxGridLayoutViewInfoSingleRowCalculator.CanCenterHorizontally
  : Boolean;
begin
  Result := inherited CanCenterHorizontally and
    RecordsViewInfo.GridView.OptionsView.ShowOnlyEntireRecords;
...
procedure TcxGridLayoutViewInfoMultiRowCalculator.AdjustContentBounds
  (var ABounds: TRect);
begin
  inherited AdjustContentBounds(ABounds);
  Dec(ABounds.Top, RecordsViewInfo.Controller.ContentScrollBarPosition);
...
function TcxGridLayoutViewSeparatorsViewInfo.CalculateMaxBottom
...
function TcxGridLayoutViewSeparatorsViewInfo.CalculateMaxRight
...
function TcxGridLayoutViewSeparatorsViewInfo.CalculateMinLeft
  (AColumn: Integer): Integer;
var
  I: Integer;
begin
...
function TcxGridLayoutViewSeparatorsViewInfo.CalculateMinTop
  (ARow: Integer): Integer;
var
  I: Integer;
begin
...
function TcxGridLayoutViewSeparatorsViewInfo.GetRecordsViewInfo
  : TcxGridLayoutViewRecordsViewInfo;
begin
  Result := TcxGridLayoutViewRecordsViewInfo(inherited RecordsViewInfo);
end;
...
procedure TcxGridLayoutViewRecordsViewInfo.CalculateVisibleRecordsBound
...
function TcxGridLayoutViewRecordsViewInfo.GetCalculatorClass
  : TcxGridCustomLayoutRecordsViewInfoBasedCalculatorClass;
begin
  case GridView.OptionsView.ViewMode of
    lvvmSingleColumn:
      Result := TcxGridLayoutViewInfoSingleColumnCalculator;
    lvvmMultiColumn:
      Result := TcxGridLayoutViewInfoMultiColumnCalculator;
    lvvmSingleRow:
      Result := TcxGridLayoutViewInfoSingleRowCalculator;
    lvvmMultiRow:
      Result := TcxGridLayoutViewInfoMultiRowCalculator;
  else
    Result := TcxGridLayoutViewInfoSingleRecordCalculator;
  end;
end;

function TcxGridLayoutViewRecordsViewInfo.GetItemViewInfoClass
...
function TcxGridLayoutViewRecordsViewInfo.GetController
  : TcxGridLayoutViewController;
begin
  Result := TcxGridLayoutViewController(inherited Controller);
end;

function TcxGridLayoutViewRecordsViewInfo.GetControllerHelper
  : TcxGridLayoutViewControllerHelper;
begin
...
function TcxGridLayoutViewRecordsViewInfo.GetGridViewInfo
  : TcxGridLayoutViewViewInfo;
begin
  Result := TcxGridLayoutViewViewInfo(inherited GridViewInfo);
end;

function TcxGridLayoutViewRecordsViewInfo.GetItem(Index: Integer)
  : TcxGridLayoutViewRecordViewInfo;
begin
  Result := TcxGridLayoutViewRecordViewInfo(inherited Items[Index]);
end;

function TcxGridLayoutViewRecordsViewInfo.GetViewData
  : TcxGridLayoutViewViewData;
begin
...
procedure TcxGridLayoutViewViewInfo.CalculateHeight(const AMaxSize: TPoint;
...
begin
  Result := (GridView.Root.AlignHorz = ahClient) or
    (GridView.Root.AlignVert = avClient) or
...
function TcxGridLayoutViewViewInfo.GetRecordsViewInfoClass
...
function TcxGridLayoutViewViewInfo.GetSeparatorsViewInfoClass
  : TcxGridCustomLayoutViewSeparatorsViewInfoClass;
const
  SeparatorsViewInfoClasses: array [TcxGridLayoutViewViewMode]
    of TcxGridCustomLayoutViewSeparatorsViewInfoClass =
    (TcxGridLayoutViewSingleRecordSeparatorsViewInfo,
    TcxGridLayoutViewSingleRowRecordSeparatorsViewInfo,
    TcxGridLayoutViewMultiRowRecordSeparatorsViewInfo,
    TcxGridLayoutViewSingleColumnRecordSeparatorsViewInfo,
...
begin
  ...
  AHeight := cxGridLayoutViewRecordExpandButtonOffset * 2 +
    LookAndFeelPainter.ScaledGroupExpandButtonSize(ScaleFactor);
  dxAdjustToTouchableSize(AHeight, ScaleFactor);
  GridView.StylesAdapter.GetRecordCaptionParams(nil, AParams);
  AHeight := Max(AHeight, TdxTextMeasurer.TextLineHeight(AParams.Font));
...
function TcxGridLayoutViewViewInfo.GetRecordsViewInfo
  : TcxGridLayoutViewRecordsViewInfo;
begin
  Result := TcxGridLayoutViewRecordsViewInfo(inherited RecordsViewInfo);
end;
  ...
  begin
    ...
    for I := 0 to GridView.Container.AbsoluteItemCount - 1 do
      if (GridView.Container.AbsoluteItems[I] is TcxGridLayoutItem) and
        (TcxGridLayoutItem(GridView.Container.AbsoluteItems[I])
        .GridViewItem = Source) then
      begin
...
function TcxGridLayoutViewItem.GetStoredProperties
...
procedure TcxGridLayoutViewItem.GetPropertyValue(const AName: string;
  var AValue: Variant);
begin
...
procedure TcxGridLayoutViewItem.SetPropertyValue(const AName: string;
...
procedure TcxGridLayoutViewItem.Notification(AComponent: TComponent;
...
begin
  ...
  begin
    if Visible then
      ...
      AParent := nil;
    LayoutItem := GridView.Container.CreateItem(TcxGridLayoutItem, AParent)
      as TcxGridLayoutItem;
  end;
end;

function TcxGridLayoutViewItem.GetEditPropertiesClass
...
begin
  ...
  try
    ...
    Result := EditingProperties.GetEditSize(ACanvas, AEditStyle, True, Null,
      AEditSizeProperties);
    if Result.cx <> 0 then
    begin
      Result.cx := Max(Result.cx,
        GridView.ScaleFactor.Apply(cxGridLayoutViewEditMinWidth));
...
function TcxGridLayoutViewItem.GetFocusedLayoutViewItemViewInfo
  : TcxGridLayoutViewItemViewInfo;
begin
  Result := TcxGridLayoutViewItemViewInfo(inherited FocusedCellViewInfo);
end;

function TcxGridLayoutViewItem.GetOptionsClass
  : TcxCustomGridTableItemOptionsClass;
begin
  Result := TcxGridLayoutViewItemOptions;
end;

function TcxGridLayoutViewItem.GetStylesClass
...
begin
  inherited;
  if (LayoutItem <> nil) and ([csDestroying, csReading, csLoading] *
    GridView.ComponentState = []) and not GridView.IsAssigningItems then
    if Value then
...
begin
  Result := inherited IsFocusedCellViewInfoPartVisible or
    not cxRectContain(FocusedCellViewInfo.VisibleBounds,
    FocusedCellViewInfo.EditBounds);
end;

function TcxGridLayoutViewItem.GetVisible: Boolean;
begin
  if (LayoutItem = nil) or ([csDestroying, csReading, csLoading] *
    GridView.ComponentState <> []) or GridView.IsAssigningItems then
    Result := inherited GetVisible
  else
...
function TcxGridLayoutViewItem.CaptionToDisplayCaption(const ACaption
  : string): string;
begin
...
function TcxGridLayoutViewItem.DisplayCaptionToCaption(const ADisplayCaption
  : string): string;
begin
...
function TcxGridLayoutViewRecord.GetViewInfoCacheItemClass
...
begin
  Result := inherited GetExpanded or
    not GridView.OptionsView.RecordCaption.Visible;
end;

{ TcxGridLayoutViewControllerHelper }

function TcxGridLayoutViewControllerHelper.GetMouseWheelMajorScrollBarKind
  : TScrollBarKind;
const
...
begin
  if ViewInfo.RecordsViewInfo.Bands.VisibleCount > 0 then
    case ViewInfo.GetGridView.OptionsView.ViewMode of
      lvvmMultiRow:
        Result := ViewInfo.RecordsViewInfo.Bands.VisibleCount;
      lvvmMultiColumn:
        Result := ViewInfo.RecordsViewInfo.Bands[0].VisibleCount;
    else
      Result := 1;
    end
  else
...
procedure TcxGridLayoutViewControllerHelper.KeyDown(var Key: Word;
  Shift: TShiftState);
var
  AKey: Word;
begin
...
procedure TcxGridLayoutViewControllerHelper.MouseDown(Button: TMouseButton;
...
begin
  ...
  if Controller.MouseCaptureViewInfo = nil then
    ...
    begin
      ALayoutContainerViewInfo := GetLayoutContainerViewInfo
...
procedure TcxGridLayoutViewControllerHelper.MouseMove(Shift: TShiftState;
X, Y: Integer);
var
  AHitTest: TcxCustomGridHitTest;
begin
  ...
  if Controller.MouseCaptureViewInfo = nil then
    if AHitTest is TcxGridRecordHitTest then
      GetLayoutContainerViewInfo(TcxGridRecordHitTest(AHitTest))
        .MouseMove(Shift, X, Y);
end;

procedure TcxGridLayoutViewControllerHelper.MouseUp(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
var
  AHitTest: TcxCustomGridHitTest;
begin
...
function TcxGridLayoutViewControllerHelper.CanScrollBarVisible
  (AKind: TScrollBarKind): Boolean;
begin
  Result := inherited CanScrollBarVisible(AKind) or NeedContentScrollBar;
end;

procedure TcxGridLayoutViewControllerHelper.DoInitScrollBarParameters
  (AKind: TScrollBarKind; ACanHide: Boolean);
begin
...
function TcxGridLayoutViewControllerHelper.GetController
  : TcxGridLayoutViewController;
begin
  Result := TcxGridLayoutViewController(inherited Controller);
end;

function TcxGridLayoutViewControllerHelper.GetLayoutContainerViewInfo
  (AHitTest: TcxGridRecordHitTest): TcxGridLayoutContainerCloneViewInfo;
var
  ARecordViewInfo: TcxGridLayoutViewRecordViewInfo;
begin
  ARecordViewInfo := TcxGridLayoutViewRecordViewInfo
    (AHitTest.GridRecord.ViewInfo);
  Result := ARecordViewInfo.LayoutViewInfo;
end;

function TcxGridLayoutViewControllerHelper.GetViewInfo
  : TcxGridLayoutViewViewInfo;
begin
...
function TcxGridLayoutViewControllerHorizontalHelper.IsDataScrollBar
  (AKind: TScrollBarKind): Boolean;
begin
  Result := AKind = sbHorizontal;
end;

function TcxGridLayoutViewControllerHorizontalHelper.GetContentPageSize
  : Integer;
begin
  Result := cxRectHeight(Controller.GridView.ViewInfo.RecordsViewInfo.Bounds);
end;

function TcxGridLayoutViewControllerHorizontalHelper.
...
begin
  ...
  if (ARecordsViewInfo.FirstRecordIndex >= 0) and
    (ARecordsViewInfo.ViewData.RecordCount > 0) then
...
function TcxGridLayoutViewControllerVerticalHelper.IsDataScrollBar
  (AKind: TScrollBarKind): Boolean;
begin
...
function TcxGridLayoutViewControllerVerticalHelper.GetContentScrollSize
  : Integer;
var
  ARecordsViewInfo: TcxGridLayoutViewRecordsViewInfo;
begin
...
begin
  Result := GetNextIndex(AFocusedItemIndex, AGoForward, AGoOnCycle,
    ACycleChanged);
end;

function TcxGridLayoutViewController.FocusNextItemVertically(AGoForward,
...
function TcxGridLayoutViewController.IsDataFullyVisible(AIsCallFromMaster
  : Boolean = False): Boolean;
begin
  Result := (GridView.OptionsView.ViewMode in [lvvmSingleRecord, lvvmSingleRow])
    or inherited IsDataFullyVisible(AIsCallFromMaster);
end;

procedure TcxGridLayoutViewController.MakeItemVisible
  (AItem: TcxCustomGridTableItem);
var
  AViewInfo: TdxCustomLayoutItemViewInfo;
begin
  inherited;
  if (AItem <> nil) and (FocusedRecordViewInfo <> nil) and
    FocusedRecordViewInfo.LayoutViewInfo.FindItemViewInfo
    ((AItem as TcxGridLayoutViewItem).LayoutItem, AViewInfo) then
    TdxCustomLayoutItemViewInfoAccess(AViewInfo).MakeFullyVisible;
end;

function TcxGridLayoutViewController.GetDesignHitTest
  (AHitTest: TcxCustomGridHitTest): Boolean;
begin
  Result := inherited GetDesignHitTest(AHitTest);
  if not Result then
    Result := AHitTest.HitTestCode in [htExpandButton, htLayoutViewItem, htCell,
      htRecord];
end;

function TcxGridLayoutViewController.GetHelperClass
...
procedure TcxGridLayoutViewController.CheckFocusItem(AItemViewInfo
  : TcxGridLayoutViewItemViewInfo);

  function GetNextFocusedItem(AGroupViewInfo: TdxLayoutGroupViewInfo;
  out AFocusedItem: TcxGridLayoutViewItem): Boolean;
  var
    I: Integer;
  begin
    Result := TdxLayoutGroupViewInfoAccess(AGroupViewInfo).IsExpanded and
      TdxLayoutGroupViewInfoAccess(AGroupViewInfo).GetEnabled;
    if Result then
    begin
      Result := False;
      ...
      begin
        ...
        else if (AGroupViewInfo.ItemViewInfos[I] is TcxGridLayoutItemViewInfo)
          and TcxGridLayoutItemViewInfo(AGroupViewInfo.ItemViewInfos[I])
          .GridItemViewInfo.CanFocus then
        begin
          Result := True;
          AFocusedItem := TcxGridLayoutItemViewInfo
            (AGroupViewInfo.ItemViewInfos[I]).GridItemViewInfo.Item;
        end;
        if Result then
          Break;
      end;
  ...
  begin
    ...
    if Result then
    begin
      Result := TdxCustomLayoutItemViewInfoAccess(AItemViewInfo.ParentViewInfo)
        .IsExpanded and TdxCustomLayoutItemViewInfoAccess
        (AItemViewInfo.ParentViewInfo).ActuallyVisible;
      if Result then
...
begin
  ...
  begin
    if AItemViewInfo.Item.Visible and (AItemViewInfo.LayoutItemViewInfo <> nil)
      and GetParentViewInfo(AItemViewInfo.LayoutItemViewInfo, AParentViewInfo)
      and GetNextFocusedItem(AParentViewInfo, AFocusedItem) then
...
function TcxGridLayoutViewController.CreateCustomizationController
  : TcxCustomGridCustomizationController;
begin
  Result := TcxGridLayoutViewCustomizationController.Create(GridView);
end;

function TcxGridLayoutViewController.GetCustomizationFormClass
  : TcxCustomGridCustomizationFormClass;
begin
  Result := nil;
end;

procedure TcxGridLayoutViewController.ScrollContentScrollBar
...
begin
  ...
  case AScrollCode of
    ...
    scLineDown:
      ContentScrollBarPosition := ContentScrollBarPosition + 1;
    scPageUp:
      ContentScrollBarPosition := ContentScrollBarPosition -
        Helper.GetContentPageSize;
    scPageDown:
      ContentScrollBarPosition := ContentScrollBarPosition +
        Helper.GetContentPageSize;
  else
...
function TcxGridLayoutViewController.GetNextIndex(AFocusedIndex: Integer;
AGoForward, AGoOnCycle: Boolean; out ACycleChanged: Boolean): Integer;
var
  AList: TList;
...
function TcxGridLayoutViewController.GetFocusedRecordViewInfo
  : TcxGridLayoutViewRecordViewInfo;
begin
...
function TcxGridLayoutViewController.GetHelper
  : TcxGridLayoutViewControllerHelper;
begin
...
procedure TcxGridLayoutViewController.SetContentScrollBarPosition
  (Value: Integer);
begin
  Value := Min(Helper.GetContentScrollSize - Helper.GetContentPageSize,
    Max(0, Value));
...
procedure TcxGridLayoutViewController.SetFocusedItem
  (Value: TcxGridLayoutViewItem);
begin
...
constructor TcxGridLayoutViewOptionsSelection.Create
...
procedure TcxGridLayoutViewOptionsSelection.SetRecordBorderSelection
  (Value: Boolean);
begin
...
begin
  ...
  if Source is TcxGridLayoutViewOptionsSelection then
    RecordBorderSelection := TcxGridLayoutViewOptionsSelection(Source)
      .RecordBorderSelection;
end;

{ TcxGridLayoutViewOptionsBehavior }

constructor TcxGridLayoutViewOptionsBehavior.Create
  (AGridView: TcxCustomGridView);
begin
  inherited Create(AGridView);
...
begin
  ...
  begin
    ExpandRecordOnDblClick := TcxGridLayoutViewOptionsBehavior(Source)
      .ExpandRecordOnDblClick;
...
procedure TcxGridLayoutViewOptionsCustomize.SetGroupExpanding
  (const Value: Boolean);
begin
...
constructor TcxGridLayoutViewCarouselMode.Create(AOptionsView
  : TcxGridLayoutViewOptionsView);
begin
  inherited Create(AOptionsView.GridView);
  FAnimatedDelay := cxGridLayoutViewCarouselModeDefaultAnimatedDelay;
  FBackgroundRecordEndScale :=
    cxGridLayoutViewCarouselModeDefaultBackgroundRecordEndScale;
  FBackgroundRecordStartScale :=
    cxGridLayoutViewCarouselModeDefaultBackgroundRecordStartScale;
...
begin
  ...
  begin
    AnimationInterval := TcxGridLayoutViewCarouselMode(Source)
      .AnimationInterval;
    AutoPitchAngle := TcxGridLayoutViewCarouselMode(Source).AutoPitchAngle;
    BackgroundRecordAlphaLevel := TcxGridLayoutViewCarouselMode(Source)
      .BackgroundRecordAlphaLevel;
    BackgroundRecordEndScale := TcxGridLayoutViewCarouselMode(Source)
      .BackgroundRecordEndScale;
    BackgroundRecordStartScale := TcxGridLayoutViewCarouselMode(Source)
      .BackgroundRecordStartScale;
    InterpolationMode := TcxGridLayoutViewCarouselMode(Source)
      .InterpolationMode;
...
procedure TcxGridLayoutViewCarouselMode.SetBackgroundRecordAlphaLevel
  (Value: Integer);
begin
...
procedure TcxGridLayoutViewCarouselMode.SetBackgroundRecordEndScale
  (Value: Cardinal);
begin
...
procedure TcxGridLayoutViewCarouselMode.SetBackgroundRecordStartScale
...
procedure TcxGridLayoutViewCarouselMode.SetInterpolationMode
  (Value: TdxGPInterpolationMode);
begin
...
constructor TcxGridLayoutViewRecordCaption.Create(AOptionsView
  : TcxGridLayoutViewOptionsView);
begin
  inherited Create(AOptionsView.GridView);
  ...
  FVisible := True;
  DisplayMask := cxGetResourceString
...
begin
  ...
  begin
    ...
    ExpandButtonAlignment := TcxGridLayoutViewRecordCaption(Source)
      .ExpandButtonAlignment;
    Height := TcxGridLayoutViewRecordCaption(Source).Height;
    TextAlignmentHorz := TcxGridLayoutViewRecordCaption(Source)
      .TextAlignmentHorz;
    TextAlignmentVert := TcxGridLayoutViewRecordCaption(Source)
      .TextAlignmentVert;
...
function TcxGridLayoutViewOptionsView.GetCarouselModeClass
  : TcxGridLayoutViewCarouselModeClass;
begin
  Result := TcxGridLayoutViewCarouselMode;
end;

function TcxGridLayoutViewOptionsView.GetRecordCaptionClass
  : TcxGridLayoutViewRecordHeaderClass;
begin
...
begin
  Result := (ViewMode = lvvmSingleRecord) and
    (SingleRecordStretch in [srsVertical, srsClient]);
end;

function TcxGridLayoutViewOptionsView.NeedStretchRecordWidth: Boolean;
begin
  Result := (ViewMode = lvvmSingleRecord) and
    (SingleRecordStretch in [srsHorizontal, srsClient]);
end;
...
procedure TcxGridLayoutViewOptionsView.SetCarouselMode
  (Value: TcxGridLayoutViewCarouselMode);
begin
...
function TcxGridLayoutViewOptionsView.GetItemPadding
  : TcxLayoutViewLookAndFeelItemPadding;
begin
  Result := TcxLayoutViewLookAndFeelItemPadding
    (GridView.Container.LayoutLookAndFeel.ItemOptions.Padding);
end;
...
procedure TcxGridLayoutViewOptionsView.SetRecordCaption
  (Value: TcxGridLayoutViewRecordCaption);
begin
...
procedure TcxGridLayoutViewOptionsView.SetSingleRecordStretch
  (Value: TcxGridLayoutViewSingleRecordStretch);
begin
...
procedure TcxGridLayoutViewOptionsView.SetViewMode
  (Value: TcxGridLayoutViewViewMode);
begin
...
procedure TcxGridLayoutViewStyles.GetGroupParams(ARecord: TcxCustomGridRecord;
AItem: TcxCustomGridTableItem; out AParams: TcxViewParams);
var
  AStyle: TcxStyle;
...
procedure TcxGridLayoutViewStyles.SetOnGetRecordBorderStyle
...
procedure TcxGridLayoutViewStyles.SetOnGetRecordCaptionStyle
  (Value: TcxGridGetRecordStyleEvent);
begin
...
procedure TcxGridLayoutViewStylesAdapter.GetContentParams
...
procedure TcxGridLayoutViewStylesAdapter.GetGroupParams
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
out AParams: TcxViewParams);
begin
  if Helper <> nil then
...
procedure TcxGridLayoutViewStylesAdapter.GetItemParams
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
out AParams: TcxViewParams);
begin
  if Helper <> nil then
...
procedure TcxGridLayoutViewStylesAdapter.GetRecordCaptionParams
  (ARecord: TcxCustomGridRecord; out AParams: TcxViewParams);
begin
  if Helper <> nil then
...
constructor TcxGridLayoutView.CreateEx(AControl: TcxControl;
...
function TcxGridLayoutView.GetOptionsBehaviorClass
  : TcxCustomGridOptionsBehaviorClass;
begin
  Result := TcxGridLayoutViewOptionsBehavior;
end;

function TcxGridLayoutView.GetOptionsCustomizeClass
...
function TcxGridLayoutView.GetOptionsSelectionClass
...
function TcxGridLayoutView.CalculateDataCellSelected
  (ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem;
...
function TcxGridLayoutView.GetDateTimeHandling
  : TcxGridLayoutViewDateTimeHandling;
begin
  Result := TcxGridLayoutViewDateTimeHandling(inherited DateTimeHandling);
end;

function TcxGridLayoutView.GetDateTimeHandlingClass
...
procedure TcxGridLayoutView.SetDateTimeHandling
  (Value: TcxGridLayoutViewDateTimeHandling);
begin
...
function TcxGridLayoutView.HandleSetStoredPropertyValueError(Sender: TcxStorage;
const AName: string; const AValue: Variant): Boolean;
const
  SortOrderMap: array [0 .. 2] of TdxSortOrder = (soNone, soAscending,
    soDescending);
begin
  Result := (Sender.StoredObject is TcxGridLayoutViewItem) and
    (AName = 'SortOrder');
  if Result then
    TcxGridLayoutViewItem(Sender.StoredObject).SortOrder :=
      SortOrderMap[Integer(AValue)];
end;
...
begin
  Result := inherited IsRecordPixelScrolling and
    not OptionsView.ShowOnlyEntireRecords and
    not(OptionsView.ViewMode in [lvvmSingleRecord, lvvmMultiRow,
    lvvmMultiColumn, lvvmCarousel]);
end;
...
procedure TcxGridLayoutView.AssignDefaultBounds
  (AViewInfo: TcxGridLayoutContainerCloneViewInfo);
begin
...
procedure TcxGridLayoutView.UpdateContainerStyles(ARecord: TcxCustomGridRecord;
var ALayoutLookAndFeel: TcxGridLayoutLookAndFeel);
...
begin
  IsDefaultViewInfoCalculated := not UseRightToLeftAlignment and
    IsDefaultViewInfoCalculated and not(OptionsView.NeedStretchRecordHeight or
    OptionsView.NeedStretchRecordWidth);
end;
...
begin
  ...
  Result := cxRectInflate(Result, -OptionsView.RecordBorderWidth,
    -OptionsView.RecordBorderWidth);
...
begin
  ...
  FDefaultLayoutViewInfo := TcxGridLayoutContainerCloneViewInfo.Create
    (Container, nil);
end;
...
function TcxGridLayoutView.DrawRecordBorderSelected
...
function TcxGridLayoutView.GetOptionsCustomize
  : TcxGridLayoutViewOptionsCustomize;
begin
...
function TcxGridLayoutView.GetOptionsSelection
  : TcxGridLayoutViewOptionsSelection;
begin
...
function TcxGridLayoutView.GetTouchScrollUIOwner(const APoint: TPoint)
...
begin
  ...
  if Controller.MouseCaptureViewInfo = nil then
    if AHitTest is TcxGridRecordHitTest then
      AContainerViewInfo := Controller.Helper.GetLayoutContainerViewInfo
        (TcxGridRecordHitTest(AHitTest));
...
function TcxGridLayoutView.GetVisibleItem(Index: Integer)
  : TcxGridLayoutViewItem;
begin
...
procedure TcxGridLayoutView.SetItem(Index: Integer;
Value: TcxGridLayoutViewItem);
begin
  inherited Items[Index] := Value;
end;

procedure TcxGridLayoutView.SetOnCustomDrawRecordCaption
  (Value: TcxGridLayoutViewCustomDrawRecordHeaderEvent);
begin
...
procedure TcxGridLayoutView.SetOptionsBehavior
  (Value: TcxGridLayoutViewOptionsBehavior);
begin
  inherited OptionsBehavior := Value;
end;

procedure TcxGridLayoutView.SetOptionsCustomize
  (Value: TcxGridLayoutViewOptionsCustomize);
begin
...
procedure TcxGridLayoutView.SetOptionsSelection
  (Value: TcxGridLayoutViewOptionsSelection);
begin
...
RegisterClasses([TcxGridLayoutViewItem, TcxGridBaseLayoutItem,
  TcxGridLayoutItem]);
