...
type
  ...
  public
    property Items[Index: Integer]: TdxIndexedTreeNodeBase
  ...
  public
    ...
    function Insert(ARelativeIndex: Integer; AItem: TdxCustomParagraph)
      : TdxIndexedTreeNodeBase; virtual; abstract;
    function RemoveAt(ARelativeIndex: Integer): Boolean; virtual; abstract;
    function FindItemByIndex(ARelativeIndex: Integer): TdxCustomParagraph;
      virtual; abstract;
    function First: TdxCustomParagraph; virtual; abstract;
    function Last: TdxCustomParagraph; virtual; abstract;
    procedure RecalcParagraphsPositionsCore(ARelativeFrom, ARelativeTo,
      ATotalDescendantCount, ADeltaLength, ADeltaRunIndex: Integer);
      virtual; abstract;
    procedure OnEndMultipleRunSplit; virtual; abstract;

    property MaxChildrenCount: Integer read FMaxChildrenCount;
    property FirstRelativeIndex: Integer read FFirstRelativeIndex
      write FFirstRelativeIndex;
    property RelativeFirstRunIndex: Integer read FRelativeFirstRunIndex
      write FRelativeFirstRunIndex;
    property RelativeLastRunIndex: Integer read FRelativeLastRunIndex
      write FRelativeLastRunIndex;
    property RelativeLogPosition: Integer read FRelativeLogPosition
      write FRelativeLogPosition;
  ...
  public
    ...
    function Insert(ARelativeIndex: Integer; AItem: TdxCustomParagraph)
      : TdxIndexedTreeNodeBase; override;
    ...
    procedure RecalcParagraphsPositionsCore(ARelativeFrom, ARelativeTo,
      ATotalDescendantCount, ADeltaLength, ADeltaRunIndex: Integer); override;
  ...
  TdxCustomParagraph = class abstract(TdxParagraphBase,
  ...
  strict protected
    ...
    function CreateParagraphPropertiesChangedHistoryItem
      : TdxIndexChangedHistoryItemCore; virtual; abstract;
  ...
  public
    ...
    procedure AfterRemove(AFirstRunIndex, ALastRunIndex: TdxRunIndex;
      ALogPosition: TdxDocumentLogPosition);
    procedure AfterUndoRemove;

    procedure ShiftRelativeIndex(ADelta: Integer);
    procedure ShiftRelativePosition(ADeltaLength, ADeltaFirstRunIndex,
      ADeltaLastRunIndex: Integer);
    ...
    property RelativeFirstRunIndex: TdxRunIndex read FRelativeFirstRunIndex
      write SetRelativeFirstRunIndex;
    property RelativeLastRunIndex: Integer read FRelativeLastRunIndex
      write SetRelativeLastRunIndex;
    property RelativeLogPosition: TdxDocumentLogPosition
      read FRelativeLogPosition write SetRelativeLogPosition;
  end;
  ...
  public
    ...
    property Items[Index: Integer]: TdxCustomParagraph read GetItem
  ...
  public
    ...
    function Insert(ARelativeIndex: Integer; AItem: TdxCustomParagraph)
      : TdxIndexedTreeNodeBase; override;
    procedure InsertWithShiftIndex(ATargetIndex: Integer;
      AItem: TdxCustomParagraph);
    function SplitNode: TdxIndexedTreeNodeLeafLevel;
    function CreateNew: TdxIndexedTreeNodeLeafLevel;
    function RemoveAt(ARelativeIndex: Integer): Boolean; override;
    function FindItemByIndex(ARelativeIndex: Integer)
      : TdxCustomParagraph; override;
    function ToString: string; override;
    procedure RecalcParagraphsPositionsCore(AFrom, ATo, ATotalDescendantCount,
      ADeltaLength, ADeltaRunIndex: Integer); override;
    procedure ShiftRelativeFirstRunIndex(ADeltaRunIndex: Integer);
    procedure ShiftRelativeLogPosition(ADeltaLogPosition: Integer);
    procedure OnEndMultipleRunSplit; override;
    procedure EnsureValidRelativeFirstRunIndex(AItem: TdxCustomParagraph;
      ARelativeFirstRunIndex: Integer);
    procedure EnsureValidRelativeLogPosition(AItem: TdxCustomParagraph;
      ARelativeLogPosition: Integer);
  ...
  public
    ...
    procedure RecalcParagraphsPositionsCore(AFrom, ATo: TdxParagraphIndex;
...
procedure TdxCustomParagraphList.SetItem(Index: Integer;
  const Value: TdxCustomParagraph);
begin
...
function TdxIndexedTreeNodeBaseList.GetItem(Index: Integer)
  : TdxIndexedTreeNodeBase;
begin
...
procedure TdxIndexedTreeNodeMiddleLevel.AddChild
...
function TdxIndexedTreeNodeMiddleLevel.FindItemByIndex(ARelativeIndex: Integer)
  : TdxCustomParagraph;
var
  I: Integer;
...
begin
  ...
  begin
    if TdxIndexedTreeNodeBase(Children.List[I]).FirstRelativeIndex > ARelativeIndex
    then
      Break;
    Inc(I);
  end;
  APrevChildren := Children.List[I - 1];
  Result := APrevChildren.FindItemByIndex
    (ARelativeIndex - APrevChildren.FirstRelativeIndex);
end;
...
function TdxIndexedTreeNodeMiddleLevel.Insert(ARelativeIndex: Integer;
  AItem: TdxCustomParagraph): TdxIndexedTreeNodeBase;
var
...
begin
  ...
  begin
    Children[AChildIndex].FirstRelativeIndex := Children[AChildIndex]
      .FirstRelativeIndex + 1;
    Dec(AChildIndex);
  end;
  ANewChildNode := Children[AChildIndex]
    .Insert(ARelativeIndex - Children[AChildIndex].FirstRelativeIndex, AItem);
  ...
  begin
    ANewChildNode.FirstRelativeIndex := ANewChildNode.FirstRelativeIndex -
      ADeltaIndex;
    ARightNode.Children.Insert(ANewChildIndex - MaxChildrenCount div 2,
      ANewChildNode);
    ANewChildNode.Parent := ARightNode;
    ANewChildNode.RelativeFirstRunIndex := ANewChildNode.RelativeFirstRunIndex -
      (ARightNode.RelativeFirstRunIndex - RelativeFirstRunIndex);
    ANewChildNode.RelativeLastRunIndex := ANewChildNode.RelativeLastRunIndex -
      (ARightNode.RelativeLastRunIndex - RelativeLastRunIndex);
    ANewChildNode.RelativeLogPosition := ANewChildNode.RelativeLogPosition -
      (ARightNode.RelativeLogPosition - RelativeLogPosition);
  end
  else
  begin
...
procedure TdxIndexedTreeNodeMiddleLevel.RecalcParagraphsPositionsCore
  (ARelativeFrom, ARelativeTo, ATotalDescendantCount, ADeltaLength,
...
begin
  ...
  begin
    ...
    if ANextChildFirstRelativeIndex <= ARelativeFrom then
      Break;
    AChild.RecalcParagraphsPositionsCore
      (ARelativeFrom - AChild.FirstRelativeIndex,
      ARelativeTo - AChild.FirstRelativeIndex, ANextChildFirstRelativeIndex -
      Children[I].FirstRelativeIndex, ADeltaLength, ADeltaRunIndex);
    ANextChildFirstRelativeIndex := Children[I].FirstRelativeIndex;
  end;
end;

function TdxIndexedTreeNodeMiddleLevel.RemoveAt(ARelativeIndex
  : Integer): Boolean;
var
...
begin
  ...
  AShouldRemoveChild := Children[AChildIndex].RemoveAt
    (ARelativeIndex - Children[AChildIndex].FirstRelativeIndex);
  if AShouldRemoveChild then
  begin

    if Children[AChildIndex] is TdxIndexedTreeNodeLeafLevel then
      TdxIndexedTreeNodeLeafLevel(Children[AChildIndex]).Items.OwnsObjects
        := False;
...
procedure TdxIndexedTreeNodeMiddleLevel.ShiftRelativeFirstRunIndex
  (ADeltaRunIndex: Integer);
var
  I: Integer;
begin
  ...
  for I := 0 to FChildren.Count - 1 do
    Children[I].RelativeFirstRunIndex := Children[I].RelativeFirstRunIndex -
      ADeltaRunIndex;
  if (Parent <> nil) and ((RelativeFirstRunIndex < 0) or
    ((Parent.Children[0] = Self) and (RelativeFirstRunIndex > 0))) then
    Parent.ShiftRelativeFirstRunIndex(RelativeFirstRunIndex);
end;

procedure TdxIndexedTreeNodeMiddleLevel.ShiftRelativeLogPosition
  (ADeltaLogPosition: Integer);
var
  I: Integer;
begin
  RelativeLogPosition := RelativeLogPosition + ADeltaLogPosition;
  for I := 0 to FChildren.Count - 1 do
    FChildren[I].RelativeLogPosition := FChildren[I].RelativeLogPosition -
      ADeltaLogPosition;
  if (Parent <> nil) and ((RelativeLogPosition < 0) or
    ((Parent.Children[0] = Self) and (RelativeLogPosition > 0))) then
    Parent.ShiftRelativeLogPosition(RelativeLogPosition);
end;

function TdxIndexedTreeNodeMiddleLevel.SplitNode(ADeltaIndex: Integer)
  : TdxIndexedTreeNodeMiddleLevel;
var
  AChild: TdxIndexedTreeNodeBase;
  I, ADeltaFirstRunIndex, ADeltaLastRunIndex, ADeltaLogPosition,
    AHalfCount: Integer;
begin
  Result := CreateNew;
  ...
  begin
    ...
    AChild.RelativeFirstRunIndex := AChild.RelativeFirstRunIndex -
      ADeltaFirstRunIndex;
    AChild.RelativeLastRunIndex := AChild.RelativeLastRunIndex -
      ADeltaLastRunIndex;
    AChild.RelativeLogPosition := AChild.RelativeLogPosition -
      ADeltaLogPosition;
  end;
...
begin
  ...
  Result := Format('+%d,%d,%d:(%s)', [FirstRelativeIndex, RelativeFirstRunIndex,
    RelativeLogPosition, S]);
end;
...
procedure TdxCustomParagraph.AfterRemove(AFirstRunIndex, ALastRunIndex
  : TdxRunIndex; ALogPosition: TdxDocumentLogPosition);
begin
...
function TdxCustomParagraph.GetPropertiesContainerPieceTable
  : TdxCustomPieceTable;
begin
  Result := PieceTable;
end;
...
begin
  ...
  begin
    FRelativeFirstRunIndex := RelativeFirstRunIndex -
      AParentLevel.RelativeFirstRunIndex;
    AParentLevel := AParentLevel.Parent;
  end;
  (Parent as TdxIndexedTreeNodeLeafLevel).EnsureValidRelativeFirstRunIndex(Self,
    FRelativeFirstRunIndex);
end;
...
procedure TdxCustomParagraph.SetRelativeLastRunIndexWithoutCheck
...
begin
  ...
  TdxIndexedTreeNodeLeafLevel(Parent).EnsureValidRelativeLogPosition(Self,
    FRelativeLogPosition);
end;

procedure TdxCustomParagraph.SetRelativeLogPosition(ALogPosition
...
begin
  ...
  while AParentLevel <> nil do
  begin
    FRelativeLogPosition := RelativeLogPosition -
      AParentLevel.RelativeLogPosition;
    AParentLevel := AParentLevel.Parent;
  end;
  (Parent as TdxIndexedTreeNodeLeafLevel).EnsureValidRelativeLogPosition(Self,
    FRelativeLogPosition);
end;
...
procedure TdxCustomParagraph.ShiftRelativePosition(ADeltaLength,
  ADeltaFirstRunIndex, ADeltaLastRunIndex: Integer);
begin
  ...
  if FRelativeFirstRunIndex < 0 then
    TdxIndexedTreeNodeLeafLevel(Parent).ShiftRelativeFirstRunIndex
      (FRelativeFirstRunIndex);
end;
...
procedure TdxIndexedTreeNodeLeafLevel.EnsureValidRelativeFirstRunIndex
  (AItem: TdxCustomParagraph; ARelativeFirstRunIndex: Integer);
begin
  if (ARelativeFirstRunIndex < 0) or
    ((AItem = FItems[0]) and (ARelativeFirstRunIndex > 0)) then
    ShiftRelativeFirstRunIndex(ARelativeFirstRunIndex);
end;

procedure TdxIndexedTreeNodeLeafLevel.EnsureValidRelativeLogPosition
  (AItem: TdxCustomParagraph; ARelativeLogPosition: Integer);
begin
  if (ARelativeLogPosition < 0) or (AItem = FItems[0]) and
    (ARelativeLogPosition > 0) then
    ShiftRelativeLogPosition(ARelativeLogPosition);
end;

function TdxIndexedTreeNodeLeafLevel.FindItemByIndex(ARelativeIndex: Integer)
  : TdxCustomParagraph;
begin
...
function TdxIndexedTreeNodeLeafLevel.Insert(ARelativeIndex: Integer;
  AItem: TdxCustomParagraph): TdxIndexedTreeNodeBase;
var
...
procedure TdxIndexedTreeNodeLeafLevel.InsertWithShiftIndex
  (ATargetIndex: Integer; AItem: TdxCustomParagraph);
var
  I: Integer;
begin
...
procedure TdxIndexedTreeNodeLeafLevel.RecalcParagraphsPositionsCore(AFrom, ATo,
  ATotalDescendantCount, ADeltaLength, ADeltaRunIndex: Integer);
...
begin
  ACount := FItems.Count;
  if (AFrom <= 0) and (ATo >= ATotalDescendantCount - 1) and
    (Items[0].RelativeFirstRunIndex = 0) then
  begin
    RelativeFirstRunIndex := RelativeFirstRunIndex + ADeltaRunIndex;
  ...
  for I := AFrom to ATo do
    TdxCustomParagraph(Items[I]).ShiftRelativePosition(ADeltaLength,
      ADeltaRunIndex, ADeltaRunIndex);
end;
...
procedure TdxIndexedTreeNodeLeafLevel.ShiftRelativeFirstRunIndex
  (ADeltaRunIndex: Integer);
var
  I: Integer;
begin
...
procedure TdxIndexedTreeNodeLeafLevel.ShiftRelativeLogPosition(ADeltaLogPosition
  : Integer);
var
  I: Integer;
begin
  RelativeLogPosition := RelativeLogPosition + ADeltaLogPosition;
  for I := 0 to FItems.Count - 1 do
    TdxCustomParagraph(Items[I]).ShiftRelativePosition
      (-ADeltaLogPosition, 0, 0);
  if (Parent <> nil) and ((RelativeLogPosition < 0) or
    (Parent.Children[0] = Self) and (RelativeLogPosition > 0)) then
    Parent.ShiftRelativeLogPosition(RelativeLogPosition);
end;
...
var
  I, AHalfCount, ADeltaFirstRunIndex, ADeltaLastRunIndex,
    ADeltaLogPosition: Integer;
  AItem: TdxCustomParagraph;
begin
  Result := CreateNew;
  ...
  begin
    ...
    AItem.Parent := Result;
    AItem.ShiftRelativePosition(-ADeltaLogPosition, -ADeltaFirstRunIndex,
      -ADeltaLastRunIndex);
  end;
...
begin
  ...
  for I := 0 to ChildrenCount - 1 do
    if I = 0 then
      S := Format('%d,%d', [Items[I].RelativeFirstRunIndex,
        Items[I].RelativeLogPosition])
    else
      S := S + ',' + Format('%d,%d', [Items[I].RelativeFirstRunIndex,
        Items[I].RelativeLogPosition]);
  Result := Format('+%d,%d,%d:(%s)', [FirstRelativeIndex, RelativeFirstRunIndex,
    RelativeLogPosition, S]);
end;
...
constructor TdxIndexedTree.Create(AMaxChildrenCount
  : Integer = DefaultMaxChildrenCount);
begin
  inherited Create;
  FMaxChildrenCount := AMaxChildrenCount;
  Clear;
...
function TdxIndexedTree.FindItemByIndex(AIndex: TdxParagraphIndex)
  : TdxCustomParagraph;
begin
  if AIndex < 0 then
...
procedure TdxIndexedTree.Insert(AIndex: TdxParagraphIndex;
  AItem: TdxCustomParagraph);
begin
...
procedure TdxIndexedTree.AddRange(const ACollection
  : TdxList<TdxCustomParagraph>);
var
...
function TdxIndexedTree.GetRange(AIndex, ACount: Integer)
  : TdxList<TdxCustomParagraph>;
var
  I, AEndIndex: Integer;
begin
...
procedure TdxParagraphIndexedTree.RecalcParagraphsPositionsCore(AFrom,
  ATo: TdxParagraphIndex; ADeltaLength, ADeltaRunIndex: Integer);
begin
  if ATo < AFrom then
    Exit;
  Root.RecalcParagraphsPositionsCore(AFrom, ATo, Count, ADeltaLength,
    ADeltaRunIndex);
end;

function TdxParagraphIndexedTree.SearchByLogPosition(ALogPosition
