...
type
  ...
  protected
    ...
    class function OnBody(AImporter: TdxRichEditDestinationAndXmlBasedImporter;
    ...
    class function OnVersion(AImporter
      : TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
      : TdxDestination; static;
  end;
...
class function TdxDocumentDestination.CreateElementHandlerTable
...
class function TdxDocumentDestination.OnBody
...
class function TdxDocumentDestination.OnBackground
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
...
class function TdxDocumentDestination.OnVersion
  (AImporter: TdxRichEditDestinationAndXmlBasedImporter; AReader: TdxXmlReader)
  : TdxDestination;
begin
  Result := TdxWordProcessingMLBaseImporter(AImporter)
    .CreateVersionDestination(AReader);
end;

{ TdxDocumentBackgroundDestination }

procedure TdxDocumentBackgroundDestination.ProcessElementOpen
...
function TdxDocumentVersionDestination.GetElementHandlerTable
  : TdxElementHandlerTable;
begin
