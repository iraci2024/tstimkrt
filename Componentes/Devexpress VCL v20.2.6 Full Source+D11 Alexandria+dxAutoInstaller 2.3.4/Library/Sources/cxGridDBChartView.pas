...
type
  ...
  TcxGridDBChartDataController = class(TcxDBDataController,
    IcxCustomGridDataController, IcxGridChartViewItemsProvider)
  private
  ...
  protected
    ...
    function GetChartItem(AItemClass: TcxGridChartItemClass; AIndex: Integer)
      : TcxGridChartItem;
    ...
    procedure GetValidValueFields(AItemClass: TcxGridChartItemClass;
      AFields: TList);
  ...
  protected
    ...
    procedure InitDefaultValuesProvider(ADefaultValuesProvider
      : TcxCustomEditDefaultValuesProvider); override;
    function IsValueTypeStored: Boolean; override;
  public
    procedure Assign(Source: TPersistent); override;
    property DataController: TcxGridDBChartDataController
  ...
  published
    property DataBinding: TcxGridDBChartItemDataBinding read GetDataBinding
  ...
  protected
    ...
    function GetItemDataBindingClass: TcxGridChartItemDataBindingClass;
      override;

    function FindItemByFieldName(AItemClass: TcxGridChartItemClass;
      const AFieldName: string): TcxGridChartItem;
  public
    function CreateDataGroup: TcxGridDBChartDataGroup;
    function FindDataGroupByFieldName(const AFieldName: string)
      : TcxGridDBChartDataGroup;
    function GetDataGroupClass: TcxGridChartDataGroupClass; override;
    property DataGroups[Index: Integer]: TcxGridDBChartDataGroup
      read GetDataGroup write SetDataGroup;

    function CreateSeries: TcxGridDBChartSeries;
    function FindSeriesByFieldName(const AFieldName: string)
      : TcxGridDBChartSeries;
    function GetSeriesClass: TcxGridChartSeriesClass; override;
    property Series[Index: Integer]: TcxGridDBChartSeries read GetSeries
      write SetSeries;
  published
    property Categories: TcxGridDBChartCategories read GetCategories
      write SetCategories;
...
uses
  SysUtils, cxClasses, cxDBEdit, cxEditDBRegisteredRepositoryItems, RTLConsts;
...
procedure TcxGridDBChartDataController.SetOnAfterSummary
...
procedure TcxGridDBChartDataController.AssignData(ADataController
  : TcxCustomDataController);
begin
end;

procedure TcxGridDBChartDataController.CreateAllItems(AMissingItemsOnly
  : Boolean);
begin
end;
...
function TcxGridDBChartDataController.GetChartItem
...
begin
  ...
  try
    ...
    Result := GridView.FindItemByFieldName(AItemClass, TField(AFields[AIndex])
      .FieldName);
  finally
    AFields.Free;
  end;
...
procedure TcxGridDBChartDataController.GetItemCaptions
...
procedure TcxGridDBChartDataController.InitItem(AItem: TcxGridChartItem;
  AIndex: Integer);
var
  AFields: TList;
begin
  ...
  try
    ...
    TcxGridDBChartItemDataBinding(AItem.DataBinding).FieldName :=
      TField(AFields[AIndex]).FieldName;
  finally
    AFields.Free;
  end;
end;
...
procedure TcxGridDBChartDataController.DoValueTypeClassChanged
  (AItemIndex: Integer);
var
...
function TcxGridDBChartDataController.GetSortingBySummaryEngineClass
...
begin
  if TField(Item1).DisplayName < TField(Item2).DisplayName then
    Result := -1
  else if TField(Item1).DisplayName > TField(Item2).DisplayName then
    Result := 1
  else
    Result := 0;
end;

procedure TcxGridDBChartDataController.GetValidValueFields
...
begin
  ...
  begin
    ...
    if not AItemClass.IsValue or IsValueTypeClassValid
      (GetValueTypeClassByField(AField)) then
      AFields.Add(AField);
  end;
...
function TcxGridDBChartItemDataBinding.GetDataController
  : TcxGridDBChartDataController;
begin
...
function TcxGridDBChartItemDataBinding.GetDefaultRepositoryItem
  : TcxEditRepositoryItem;
begin
  Result := GetDefaultEditDBRepositoryItems.GetItemByField(Field);
end;

function TcxGridDBChartItemDataBinding.GetDefaultValuesProviderClass
  : TcxCustomEditDefaultValuesProviderClass;
begin
  Result := TcxCustomDBEditDefaultValuesProvider;
end;

function TcxGridDBChartItemDataBinding.GetDefaultValueTypeClass
  : TcxValueTypeClass;
begin
  Result := nil;
end;

procedure TcxGridDBChartItemDataBinding.InitDefaultValuesProvider
  (ADefaultValuesProvider: TcxCustomEditDefaultValuesProvider);
begin
  inherited;
  TcxCustomDBEditDefaultValuesProvider(ADefaultValuesProvider).DataSource :=
...
procedure TcxGridDBChartCategories.SetDataBinding
  (Value: TcxGridDBChartItemDataBinding);
begin
...
procedure TcxGridDBChartDataGroup.SetDataBinding
  (Value: TcxGridDBChartItemDataBinding);
begin
  inherited DataBinding := Value;
end;
...
procedure TcxGridDBChartSeries.SetDataBinding
  (Value: TcxGridDBChartItemDataBinding);
begin
  inherited DataBinding := Value;
end;
...
function TcxGridDBChartView.GetDataGroup(Index: Integer)
  : TcxGridDBChartDataGroup;
begin
...
procedure TcxGridDBChartView.SetDataController
  (Value: TcxGridDBChartDataController);
begin
  FDataController.Assign(Value);
end;

procedure TcxGridDBChartView.SetDataGroup(Index: Integer;
  Value: TcxGridDBChartDataGroup);
begin
  inherited DataGroups[Index] := Value;
end;

procedure TcxGridDBChartView.SetSeries(Index: Integer;
  Value: TcxGridDBChartSeries);
begin
...
function TcxGridDBChartView.GetDataControllerClass
  : TcxCustomDataControllerClass;
begin
  Result := TcxGridDBChartDataController;
end;

function TcxGridDBChartView.GetItemDataBindingClass
  : TcxGridChartItemDataBindingClass;
begin
  Result := TcxGridDBChartItemDataBinding;
end;

function TcxGridDBChartView.FindItemByFieldName
  (AItemClass: TcxGridChartItemClass; const AFieldName: string)
  : TcxGridChartItem;
var
  AItems: TList;
  I: Integer;
begin
  ...
  begin
    ...
    if SameText(TcxGridDBChartItemDataBinding(Result.DataBinding).FieldName,
      AFieldName) then
      Exit;
  end;
  Result := nil;
...
function TcxGridDBChartView.FindDataGroupByFieldName(const AFieldName: string)
  : TcxGridDBChartDataGroup;
begin
  Result := TcxGridDBChartDataGroup(FindItemByFieldName(GetDataGroupClass,
    AFieldName));
end;
...
function TcxGridDBChartView.FindSeriesByFieldName(const AFieldName: string)
  : TcxGridDBChartSeries;
begin
  Result := TcxGridDBChartSeries(FindItemByFieldName(GetSeriesClass,
    AFieldName));
end;
