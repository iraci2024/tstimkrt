...
type
  ...
  TdxCustomSelection = class abstract(TcxIUnknownObject, IdxBatchUpdateHandler)
  strict private
  type
    ...
    class var FRangeComparer: TRangeComparer;
  ...
  strict protected
    ...
    property OwnActiveSelectionChanged: Boolean read FActiveSelectionChanged
      write FActiveSelectionChanged;
  protected
...
constructor TdxSelectionRange.Create(AFrom: TdxDocumentLogPosition;
  ALength: Integer);
begin
  inherited Create;
  FFrom := AFrom;
...
constructor TdxSelectionRangeCollection.Create(AFrom: TdxDocumentLogPosition;
  ALength: Integer);
begin
  inherited Create;
...
function TdxCustomSelection.TRangeComparer.Compare(const Left,
  Right: TdxSelectionRange): Integer;
begin
