...
type
  TdxHookType = (htKeyboard, htMouse, htWndProc, htGetMessage, htCBT,
    htWndProcRet, htMouseLL);
  TdxHookProc = procedure(ACode: Integer; AWParam: WPARAM; ALParam: LPARAM;
...
type
  ...
  private
    ...
    function ProcessHookProcs(ACode: Integer; AWParam: WPARAM;
...
function dxSystemKeyboardHook(Code: Integer; WPARAM: WPARAM; LPARAM: LPARAM)
  : LRESULT; stdcall;
begin
  Result := dxHookController.FSystemHooks[htKeyboard].ProcessHookProcs(Code,
    WPARAM, LPARAM);
end;

function dxSystemMouseHook(Code: Integer; WPARAM: WPARAM; LPARAM: LPARAM)
  : LRESULT; stdcall;
begin
  Result := dxHookController.FSystemHooks[htMouse].ProcessHookProcs(Code,
    WPARAM, LPARAM);
end;

function dxSystemMouseLLHook(Code: Integer; WPARAM: WPARAM; LPARAM: LPARAM)
  : LRESULT; stdcall;
begin
  Result := dxHookController.FSystemHooks[htMouseLL].ProcessHookProcs(Code,
    WPARAM, LPARAM);
end;

function dxSystemWndProcHook(Code: Integer; WPARAM: WPARAM; LPARAM: LPARAM)
  : LRESULT; stdcall;
begin
  Result := dxHookController.FSystemHooks[htWndProc].ProcessHookProcs(Code,
    WPARAM, LPARAM);
end;

function dxSystemWndProcRetHook(Code: Integer; WPARAM: WPARAM; LPARAM: LPARAM)
  : LRESULT; stdcall;
begin
  Result := dxHookController.FSystemHooks[htWndProcRet].ProcessHookProcs(Code,
    WPARAM, LPARAM);
end;

function dxSystemGetMessageHook(Code: Integer; WPARAM: WPARAM; LPARAM: LPARAM)
  : LRESULT; stdcall;
begin
  Result := dxHookController.FSystemHooks[htGetMessage].ProcessHookProcs(Code,
    WPARAM, LPARAM);
end;

function dxSystemCBTHook(Code: Integer; WPARAM: WPARAM; LPARAM: LPARAM)
  : LRESULT; stdcall;
begin
  Result := dxHookController.FSystemHooks[htCBT].ProcessHookProcs(Code,
    WPARAM, LPARAM);
end;
...
const
  HooksData: TdxSystemHooksData = ((Proc: dxSystemKeyboardHook; ID: WH_KEYBOARD;
    ThreadID: - 1), // htKeyboard
    (Proc: dxSystemMouseHook; ID: WH_MOUSE; ThreadID: - 1), // htMouse
    (Proc: dxSystemWndProcHook; ID: WH_CALLWNDPROC; ThreadID: - 1), // htWndProc
    (Proc: dxSystemGetMessageHook; ID: WH_GETMESSAGE; ThreadID: - 1),
    // htGetMessage
    (Proc: dxSystemCBTHook; ID: WH_CBT; ThreadID: - 1), // htWCBT
    (Proc: dxSystemWndProcRetHook; ID: WH_CALLWNDPROCRET; ThreadID: - 1),
    // htWndProcRet
...
begin
  ...
  FHandle := SetWindowsHookEx(HooksData[FHookType].ID,
    HooksData[FHookType].Proc, 0, AThreadID);
end;
...
function TdxSystemHook.ProcessHookProcs(ACode: Integer; AWParam: WPARAM;
  ALParam: LPARAM): LRESULT;
var
...
procedure TdxHookController.SetHook(AHookType: TdxHookType;
  AHookProc: TdxHookProc);
begin
