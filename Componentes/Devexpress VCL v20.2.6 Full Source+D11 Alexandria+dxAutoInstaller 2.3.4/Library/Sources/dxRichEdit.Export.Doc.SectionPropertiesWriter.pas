...
procedure TdxSectionPropertiesWriter.WriteSection(ACharacterPosition: Integer;
  ASection: TdxSection);
var
  AGrpprl: TBytes;
  ASepxOffset: Integer;
...
function TdxSectionPropertiesWriter.GetSectionGroupPropertiesModifiers
  (ASection: TdxSection): TBytes;
var
