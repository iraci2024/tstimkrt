...
uses
  Types, Windows, SysUtils, Classes, Variants, DB, dxCore, cxClasses,
  dxCoreClasses,
...
type
  ...
  IdxProviderSupport =
  {$IFDEF DELPHI17}IProviderSupportNG{$ELSE}IProviderSupport{$ENDIF};
  ...
  TdxServerModeCriteriaGetValueEvent = procedure(AItem: TcxFilterCriteriaItem;
    const AValue: Variant; var ADisplayValue: string) of object;
  TdxServerModeCriteriaGetFieldCaptionEvent = procedure
    (AItem: TdxServerModeCriteriaItem; var AFieldCaption: string) of object;
  ...
  protected
    procedure DoGetFieldCaption(AItem: TdxServerModeCriteriaItem;
      var AFieldCaption: string);
    function FilterTextUsed: Boolean; override;
    procedure FormatFilterTextValue(AItem: TcxFilterCriteriaItem;
      const AValue: Variant; var ADisplayValue: string); override;
    ...
    procedure Operation(Value: TdxServerModeCriteria;
    ...
    property OnGetFieldCaption: TdxServerModeCriteriaGetFieldCaptionEvent
      read FOnGetFieldCaption write FOnGetFieldCaption;
    property OnGetValue: TdxServerModeCriteriaGetValueEvent read FOnGetValue
      write FOnGetValue;
  public
    constructor Create(ADataSource: TdxServerModeCustomDataSource);
      reintroduce; virtual;

    function AddItem(ADescriptor: TdxServerModeDescriptor;
      AOperatorKind: TcxFilterOperatorKind; const AValue: Variant)
      : TdxServerModeCriteriaItem; reintroduce; overload; virtual;
    function AddItem(AParent: TcxFilterCriteriaItemList;
      ADescriptor: TdxServerModeDescriptor;
      AOperatorKind: TcxFilterOperatorKind; const AValue: Variant)
      : TdxServerModeCriteriaItem; reintroduce; overload; virtual;
    procedure AndCriteria(Value: TdxServerModeCriteria;
      ADestroyValue: Boolean = False);
    procedure OrCriteria(Value: TdxServerModeCriteria;
      ADestroyValue: Boolean = False);
  ...
  public
    ...
    property DateTimeGrouping: TdxDateTimeGrouping read FDateTimeGrouping
      write SetDateTimeGrouping;
    property Field: TField read GetField;
    property Index: Integer read GetIndex write SetIndex;
    property Owner: TdxServerModeDescriptors read FOwner write SetOwner;
    property LinkedObject: TdxServerModeDescriptor read FLinkedObject
      write SetLinkedObject;
  end;
  ...
  TdxServerModeDescriptorsChangedEvent = procedure
    (Sender: TdxServerModeDescriptors; AItem: TdxServerModeDescriptor;
    AChanges: TdxServerModeDescriptorChanges) of object;
  ...
  protected
    ...
    procedure DoChanged(AItem: TdxServerModeDescriptor;
      AChanges: TdxServerModeDescriptorChanges); virtual;
  ...
  public
    ...
    function CreateLink(ALinkedObject: TdxServerModeDescriptor)
      : TdxServerModeDescriptor;
    ...
    property DataSource: TdxServerModeCustomDataSource read FDataSource;
    property Items[Index: Integer]: TdxServerModeDescriptor
      read GetItem; default;
    property OnChanged: TdxServerModeDescriptorsChangedEvent read FOnChanged
      write FOnChanged;
  end;
  ...
  public
    function Add(AField: TField; AKind: TcxSummaryKind)
      : TdxServerModeSummaryDescriptor; overload; virtual;
    function Add(const AFieldName: string; AKind: TcxSummaryKind)
      : TdxServerModeSummaryDescriptor; overload; virtual;

    function Clone: TdxServerModeSummaryDescriptors;
    function IsGroupLevelSorted(AGroupLevel: Integer): Boolean;

    property Items[Index: Integer]: TdxServerModeSummaryDescriptor
      read GetItem; default;
  end;

  TdxServerModeSummaryDescriptorsClass = class of
    TdxServerModeSummaryDescriptors;
  ...
  public
    property Items[Index: Integer]: TdxServerModeGroupInfoDescriptor
      read GetItem; default;
  end;

  TdxServerModeGroupInfoDescriptorsClass = class of
    TdxServerModeGroupInfoDescriptors;
  ...
  protected
    function Add(AField: TField; AIsDesc: Boolean; AIsKey: Boolean)
      : TdxServerModeSortInfoDescriptor; overload;
    function AddKeySortInfo(AField: TField; AIsDesc: Boolean)
      : TdxServerModeSortInfoDescriptor;
    function GetDescriptorClass: TdxServerModeDescriptorClass; override;
  public
    function Add(AField: TField; AIsDesc: Boolean)
      : TdxServerModeSortInfoDescriptor; overload;
    function Add(const AFieldName: string; AIsDesc: Boolean)
      : TdxServerModeSortInfoDescriptor; overload;
    procedure ClearKeySortInfo;
    function Clone(AReversed: Boolean): TdxServerModeSortInfoDescriptors;

    property Items[Index: Integer]: TdxServerModeSortInfoDescriptor
      read GetItem; default;
    property WithoutKeySortInfoCount: Integer read GetWithoutKeySortInfoCount;
  end;

  TdxServerModeSortInfoDescriptorsClass = class of
    TdxServerModeSortInfoDescriptors;
  ...
  public
    ...
    property Items[Index: Integer]: TdxServerModeFieldDescriptor
      read GetItem; default;
  end;
  ...
  private
    ...
    FGroupCount: Integer;
  public
    constructor Create(AGroupCount: Integer;
  ...
  TdxServerModeInconsistencyDetectedEvent = procedure
    (Sender: TdxServerModeCache; const AMessage: string) of object;
  TdxServerModeExceptionThrownEvent = procedure(Sender: TdxServerModeCache;
  ...
  private
    ...
    function PrepareTopGroupInfoWithTrick(ASummaries
      : TdxServerModeSummaryDescriptors): TdxServerModeGroupInfoData;
  protected
    function CanTrickCreateTopGroupFromNextGroups: Boolean;
    function EvaluateOnInstance(const ARow: TdxServerModeRow; AField: TField)
      : Variant; virtual;
    procedure Fatal(AException: Exception); virtual;
    function GetCount(ACriteria: TdxServerModeCriteria): Integer; virtual;
    function GetGroupWhere(AGroupInfo: TdxServerModeGroupInfo)
      : TdxServerModeCriteria;
    function GetInternalCount: Integer; virtual;
    function GetTopGroupInfo: TdxServerModeGroupInfo;
    procedure MakeStrongClause(ACriteria: TdxServerModeCriteria;
      AParentList: TcxFilterCriteriaItemList;
      ADescriptor: TdxServerModeDescriptor; AIsDesc, ACanEqual: Boolean;
      const AValue: Variant); overload;
    procedure MakeStrongClause(ACriteria: TdxServerModeCriteria;
      AParentList: TcxFilterCriteriaItemList;
      ASortInfoDescriptor: TdxServerModeSortInfoDescriptor;
      const AValue: Variant); overload;
    function PrepareChildren(AGroupWhere: TdxServerModeCriteria;
      AGroupByDescriptor: TdxServerModeSortInfoDescriptor;
      ASummaries: TdxServerModeSummaryDescriptors)
      : TdxServerModeGroupInfoDataList; virtual;
    function PrepareTopGroupCount: Integer; virtual;
    function PrepareTopGroupInfo(ASummaries: TdxServerModeSummaryDescriptors)
      : TdxServerModeGroupInfoData; virtual;
    procedure RaiseInconsistencyDetected(const AFormat: string;
  ...
  public
    ...
    function GetGroupInfoList(AParentGroup: TdxServerModeGroupInfo)
      : TdxServerModeGroupInfoList;
    function GetTotalSummary: TdxServerModeSummaryList;
    function IsNothingButCount(ASummaries
      : TdxServerModeSummaryDescriptors): Boolean;
    procedure RecalculateSummaries;
    procedure SoftReset; virtual;

    function Contains(const AValue: TdxServerModeRow): Boolean;
      virtual; abstract;
    ...
    function Indexer(ARecordIndex: Integer): TdxServerModeRow; virtual;
      abstract;
    function IndexOf(const AValue: TdxServerModeRow): Integer; virtual;
      abstract;
    ...
    property TotalSummaries: TdxServerModeSummaryDescriptors
      read GetTotalSummaries;
  ...
  private
    ...
    procedure FetchRowsTop(AGroupInfo: TdxServerModeGroupInfo;
      AIsFromBottom: Boolean; ATop: Integer);
    function FindFromCache(ARecordIndex: Integer;
      var ARow: TdxServerModeRow): Boolean;
    function GetCountBeforeRow(const ARow: TdxServerModeRow;
      AGroupInfo: TdxServerModeGroupInfo;
      ASortInfo: TdxServerModeSortInfoDescriptors): Integer;
    function GetGroupForKeysFetchingAround(Index: Integer)
    ...
    procedure CalculateModel(ARecordIndex, APositionInGroup: Integer;
      AGroupInfo: TdxServerModeGroupInfo; out ASkipTake, ASkipSkip: Integer;
      out ASkipIsFromBottom: Boolean);
    procedure CalculateTake(AGroupInfo: TdxServerModeGroupInfo;
      AFetchCount: Integer; AIsFromBottom: Boolean; out APureTake: Integer;
      out APureTakeIsFromBottom: Boolean);
    procedure DoFetchKeys(AGroupInfo: TdxServerModeGroupInfo;
      AIsFromBottom: Boolean; ASkip, ATake: Integer);
    procedure DoFetchKeysSkipWithTakeBackup(AGroupInfo: TdxServerModeGroupInfo;
      ASkipIsFromBottom: Boolean; ASkipSkip, ASkipTake: Integer;
      APureTakeIsFromBottom: Boolean; APureTake: Integer);
    procedure FetchKeysTimed(AKeys: TdxServerModeKeyList;
      AWhere: TdxServerModeCriteria;
      ASortInfo: TdxServerModeSortInfoDescriptors; ASkip, ATake: Integer);
    procedure FillKeys(AGroupInfo: TdxServerModeGroupInfo;
      AIsFromBottom: Boolean; ASkip, ATake: Integer;
      AKeys: TdxServerModeKeyList);
    function GetGlobalIndex(AGroupInfo: TdxServerModeGroupInfo; APos: Integer;
      AIsReversed: Boolean): Integer;
    ...
    procedure PopulateFetchKeys(AGroupInfo: TdxServerModeGroupInfo;
      APureTake, ASkipSkip, ASkipTake: Integer;
  ...
  protected
    ...
    procedure FetchRowsByKeys(ARows: TdxServerModeRowList;
      AKeys: TdxServerModeKeyList);
    ...
    function ResolveKeyType(ASingleKeyToResolve: TdxServerModeFieldDescriptors)
      : TdxKeyType; virtual; abstract;
    function ResolveRowType: TdxRowType; virtual; abstract;

    procedure FetchKeys(AKeys: TdxServerModeKeyList;
      AWhere: TdxServerModeCriteria;
      ASortInfo: TdxServerModeSortInfoDescriptors;
      ASkip, ATake: Integer); virtual;
    procedure FetchRows(ARows: TdxServerModeRowList;
      AWhere: TdxServerModeCriteria;
      ASortInfo: TdxServerModeSortInfoDescriptors; ATake: Integer);
      overload; virtual;
    procedure FetchRows(AWhere: TdxServerModeCriteria;
      ATake, AValidateCount, AFirstRecord: Integer;
    ...
    property MagicNumberAllowedSlowerThenBase: Double
      read GetMagicNumberAllowedSlowerThenBase;
    property MagicNumberAllowedSlowerThenBaseVariance: Double
      read GetMagicNumberAllowedSlowerThenBaseVariance;
    property MagicNumberFetchKeysAllThreshold: Integer
      read GetMagicNumberFetchKeysAllThreshold;
    property MagicNumberFetchKeysModulo: Integer
      read GetMagicNumberFetchKeysModulo;
    property MagicNumberFetchKeysTopPenaltyGap: Integer
      read GetMagicNumberFetchKeysTopPenaltyGap;
    property MagicNumberFetchRowsAllThreshold: Integer
      read GetMagicNumberFetchRowsAllThreshold;
    property MagicNumberFetchRowsInSize: Integer
      read GetMagicNumberFetchRowsInSize;
    property MagicNumberFetchRowsTop: Integer read GetMagicNumberFetchRowsTop;
    property MagicNumberFetchRowsTopThreshold: Integer
      read GetMagicNumberFetchRowsTopThreshold;
    property MagicNumberScanKeysBase: Integer read GetMagicNumberScanKeysBase;
    property MagicNumberTakeIncreaseStepMultiplier: Double
      read GetMagicNumberTakeIncreaseStepMultiplier;
    property MagicNumberTakeKeysBase: Integer read GetMagicNumberTakeKeysBase;
    property MagicNumberTakeKeysUpperLimitAfterSkip: Integer
      read GetMagicNumberTakeKeysUpperLimitAfterSkip;
    property MaxInSize: Integer read GetMaxInSize;

    property Regressor: TdxServerModeServerAndChannelModelBuilder
      read FRegressor;
  ...
  public
    ...
    function DecideIsFetchRowsGoodIdea(ASortInfo
      : TdxServerModeSortInfoDescriptors): Boolean;
  ...
  TdxServerModeDataSourceChangeType = (ctConnection, ctCache, ctGroups,
    ctOptions, ctSummaries, ctTotalSummaries, ctSortingSummaries, ctFiltering,
    ctSorting);
  TdxServerModeDataSourceChanges = set of TdxServerModeDataSourceChangeType;

  TdxSQLDatePart = (dpYear, dpQuarter, dpMonth, dpDayOfYear, dpDay, dpWeekDay,
    dpWeek, dpHour, dpMinute, dpSecond, dpMillisecond, dpMicrosecond,
    dpNanosecond);
  ...
  private
    FDataSource: TdxServerModeCustomDataSource;
  protected
    procedure Changed(const AChanges: TdxServerModeDataSourceChanges =
      [ctOptions]);
    procedure CheckParams(AParams: TdxServerModeParams;
      var ACommandText: string); virtual;
    procedure CheckRepeatedParams(AParams: TdxServerModeParams;
      var ACommandText: string); virtual;
    procedure CorrectCommandText(AParams: TdxServerModeParams;
      var ACommandText: string); virtual;
    function CreateParam(AParams: TdxServerModeParams; const AValue: Variant;
      const ADataType: TFieldType; out ADisplayValue: string)
      : TdxServerModeParam;
    ...
    procedure RenameParams(AParams: TdxServerModeParams;
      var ACommandText: string); virtual;
    procedure SortParams(AParams: TdxServerModeParams;
      var ACommandText: string); virtual;
    ...
    procedure CheckFilterFieldCaption(var AFieldCaption: string;
      AOperatorKind: TcxFilterOperatorKind); virtual;
    function DateDec(APart: TdxSQLDatePart;
      const ADateExpression, ADelta: string): string; virtual;
    function DateDiff(APart: TdxSQLDatePart;
      const ADateExpression1, ADateExpression2: string): string; virtual;
    function DateInc(APart: TdxSQLDatePart;
      const ADateExpression, ADelta: string): string; virtual;
    function DatePart(APart: TdxSQLDatePart; const ADateExpression: string)
      : string; virtual;
    ...
    function TruncGroupingDate(const ADate: string;
      ADateTimeGrouping: TdxDateTimeGrouping): string; virtual;
    ...
    procedure EscapeFakeParamName(AParam: TdxServerModeParam;
      ABuilder: TdxServerModeCustomSQLQueryBuilder); virtual;
    procedure EscapeLikeValue(AParam: TdxServerModeParam;
      APercentWildcard, AUnderscoreWildcard: Char);
    procedure GetLikeValue(ABuilder: TdxServerModeCustomSQLQueryBuilder;
      AParam: TdxServerModeParam; APercentWildcard, AUnderscoreWildcard
      : Char); virtual;
    function MakeEscapedValue(const AValue: string;
      AEscapePercentWildcard, AEscapeUnderscoreWildcard: Boolean)
      : string; virtual;
    function NeedEscapeFakeParamName(AParam: TdxServerModeParam)
      : Boolean; virtual;
    ...
    function GetSelectSQLString(const AFields, AFrom, AWhere, AGroup,
      ASortInfo: string; ATopRecords, ASkipRecords: Integer; ADistinct: Boolean)
      : string; virtual;
    function GetInsertSQLString(const AFrom, AOutRowKey, AFields,
      AValues: string): string; virtual;
    function GetUpdateSQLString(const AFrom, AOutRowKey, AValues,
      AWhere: string): string; virtual;
  ...
  public
    ...
    function GetSQLQueryKeyFieldNames(const ATableName: string)
      : string; virtual;
  ...
  TdxServerModeParamPosition = (ppCriteria, ppFields, ppGroupingByDateRange,
    ppSortInfo);
  ...
  public
    property EscapedValue: Boolean read FEscapedValue write FEscapedValue;
    property CriteriaOperatorKind: TcxFilterOperatorKind
      read FCriteriaOperatorKind write FCriteriaOperatorKind;
    property Position: TdxServerModeParamPositions read FPosition
      write FPosition;
  end;
  ...
  public
    constructor Create(AOwner: TdxServerModeCustomSQLQueryBuilder;
      AParamClass: TdxServerModeParamClass);

    function AddParameter: TdxServerModeParam;
    procedure AddParam(Value: TdxServerModeParam);
    function CreateParam(AFieldType: TFieldType; const ParamName: string;
    ...
    property Items[Index: Integer]: TdxServerModeParam read GetItem
  ...
  private
    ...
    procedure GetFilterFieldCaptionHandler(AItem: TdxServerModeCriteriaItem;
      var AFieldCaption: string);
    procedure GetFilterValueHandler(AItem: TcxFilterCriteriaItem;
  ...
  protected
    ...
    procedure ReplaceFakeParamNameWithText(AParam: TdxServerModeParam;
      const AValue: string);
    procedure ValidateCommandTextWithParams;

    function CreateDateTimeParam(const ADateTime: TDateTime): string;
    function DateTimeGroupingByRelativeToToday(const AFieldName
      : string): string;
    function GetGroupingStartDate(ADateTimeGrouping
      : TdxDateTimeGrouping): string;
    function GroupingByDateRange(const AFieldName: string;
    ...
    function DescriptorsToString(ADescriptors
      : TdxServerModeDescriptors): string;
    ...
    property GroupingByDateRangeCalculating: Boolean
      read FGroupingByDateRangeCalculating;
  ...
  public
    ...
    property GroupInfo: TdxServerModeGroupInfoDescriptors read FGroupInfo
      write FGroupInfo;
    property SortInfo: TdxServerModeSortInfoDescriptors read FSortInfo
      write FSortInfo;
  ...
  TdxServerModeCustomSQLQueryBuilderClass = class of
    TdxServerModeCustomSQLQueryBuilder;
  ...
  published
    property UseQueryParams: Boolean read FUseQueryParams write FUseQueryParams
      default True;
  end;
  ...
  TdxServerModeGetSQLAdapterClassEvent = procedure(Sender: TObject;
    var AClass: TdxServerModeCustomSQLAdapterClass) of object;
  TdxServerModeDataSourceNotifyEvent = procedure
    (Sender: TdxServerModeCustomDataSource) of object;
  TdxServerModeDataSourceFatalErrorEvent = procedure
    (Sender: TdxServerModeCustomDataSource; const AMessage: string) of object;
  TdxServerModeDataSourceInconsistentCacheEvent = procedure
    (Sender: TdxServerModeCustomDataSource; const AMessage: string;
    var ARecoverCache: Boolean) of object;
  ...
  protected
    ...
    function GetQueryBuilderClass
      : TdxServerModeCustomSQLQueryBuilderClass; virtual;

    procedure CheckParamValue(var AParam: TdxServerModeParam); virtual;
    procedure CheckSQLAdapter;
    procedure DoExecuteCommand(AResultSet: PDataSet; const ACommand: string;
      AParams: TParams; AParamCheck: Boolean); virtual;
  ...
  public
    constructor Create(ADataSource: TdxServerModeCustomDataSource);
    function ExecuteCommand(AResultSet: PDataSet; const ACommandText: string;
  ...
  TdxServerModeDataSourceCustomHelperClass = class of
    TdxServerModeDataSourceCustomHelper;
  ...
  private
    ...
    procedure SetSQLAdapterClass(const Value
      : TdxServerModeCustomSQLAdapterClass);
  ...
  protected
    ...
    procedure RemoveDataController(ADataController
    ...
    function CreateField(AFieldDef: TFieldDef; AOwner: TComponent)
      : TField; virtual;
    ...
    procedure MakeCriteriaWithBetweenOperator(var ACriteria
      : TdxServerModeCriteria; const AKeys: TdxServerModeKeyList);
    ...
    function GetGroupInfoDescriptorsClass
      : TdxServerModeGroupInfoDescriptorsClass; virtual;
    ...
    function GetSortInfoDescriptorsClass
      : TdxServerModeSortInfoDescriptorsClass; virtual;
    ...
    procedure DoExecuteCommand(AResultSet: PDataSet; const ACommand: string;
      AParams: TParams; AParamCheck: Boolean);
    function ExecuteCommand(AResultSet: PDataSet; const ACommandText: string;
      AParams: TParams; AParamCheck: Boolean; ACheckSettings: Boolean = True)
      : Boolean; overload;
    function ExecuteCommand(AResultSet: PDataSet;
      const AFields: TdxServerModeDescriptors; ACriteria: TdxServerModeCriteria;
      ASortInfo: TdxServerModeSortInfoDescriptors;
      AGroupInfo: TdxServerModeGroupInfoDescriptors; ATopRecords: Integer;
      ASkipRecords: Integer; ADistinct: Boolean): Boolean; overload;
    ...
    procedure FetchRows(ARows: TdxServerModeRowList;
      AWhere: TdxServerModeCriteria;
      ASortInfo: TdxServerModeSortInfoDescriptors;
      ATopRecords: Integer); virtual;
    procedure FetchRowsByKeys(ARows: TdxServerModeRowList;
      AKeys: TdxServerModeKeyList); virtual;
    function FindFirstKey(AWhere: TdxServerModeCriteria; ASearchDown: Boolean)
      : TdxServerModeRow;
    function GetCount(ACriteria: TdxServerModeCriteria): Integer; virtual;
    function GetFetchRowByIndexCondition(ARowIndex: Integer)
      : TdxServerModeCriteria;
    function GetFetchRowByKeyCondition(AKey: TdxServerModeRow)
      : TdxServerModeCriteria;
    function GetFetchRowsByKeysCondition(AKeys: TdxServerModeKeyList)
      : TdxServerModeCriteria;
    ...
    procedure Apply(AFilter: TdxServerModeCriteria;
    ...
    function FindIncremental(AField: TField; const ASubStr: string;
      AStartIndex: Integer; ASearchDown: Boolean = True;
      AIgnoreStartRow: Boolean = False): Integer; overload;
    function FindIncremental(const AFieldName, ASubStr: string;
      AStartIndex: Integer; ASearchDown: Boolean = True;
      AIgnoreStartRow: Boolean = False): Integer; overload;
    procedure PopulateFilterValues(AList: TcxDataFilterValueList;
      AField: TField; ACriteria: TcxFilterCriteria;
      var AUseFilteredRecords: Boolean; out ANullExists: Boolean); virtual;
    function PostEditingData(ARowIndex: Integer; const AEditingRow: Variant)
      : Variant; virtual;

    property Adapter: TdxServerModeCustomSQLAdapter read GetAdapter;
    property Cache: TdxServerModeCache read FCache;
    property CacheInconsistencyCount: Integer read FCacheInconsistencyCount
      write FCacheInconsistencyCount;
    ...
    property FieldDescriptors: TdxServerModeFieldDescriptors
      read FFieldDescriptors;
    ...
    property Summaries: TdxServerModeSummaryDescriptors read FSummaries;
    property TotalSummaries: TdxServerModeSummaryDescriptors
      read FTotalSummaries;
    property OnGetAdapterClass: TdxServerModeGetSQLAdapterClassEvent
      read FOnGetAdapterClass write FOnGetAdapterClass;
  public
    ...
    property SQLAdapterClass: TdxServerModeCustomSQLAdapterClass
      read FSQLAdapterClass write SetSQLAdapterClass;
  published
    property Active: Boolean read FActive write SetActive default False;
    property KeyFieldNames: string read GetKeyFieldNames write SetKeyFieldNames;
    property Options: TdxServerModeDataSourceOptions read FOptions
      write SetOptions;
    property SQLAdapterClassName: string read GetSQLAdapterClassName
      write SetSQLAdapterClassName;
    property SQLAdapter: TdxServerModeCustomSQLAdapter read FSQLAdapter
      write SetSQLAdapter;

    // events
    property BeforeOpen: TdxServerModeDataSourceNotifyEvent read FBeforeOpen
      write FBeforeOpen;
    property AfterOpen: TdxServerModeDataSourceNotifyEvent read FAfterOpen
      write FAfterOpen;
    property BeforeClose: TdxServerModeDataSourceNotifyEvent read FBeforeClose
      write FBeforeClose;
    property AfterClose: TdxServerModeDataSourceNotifyEvent read FAfterClose
      write FAfterClose;
    property SQLAdapterEvents: TNotifyEvent read FSQLAdapterEvents
      write FSQLAdapterEvents;
    property OnFatalError: TdxServerModeDataSourceFatalErrorEvent
  ...
  protected
    ...
    function SetEditingData(ARecordIndex: Integer;
    ...
    property Fields[Index: Integer]: TdxServerModeDataField
      read GetFieldItem; default;
  ...
  public
    procedure Assign(Source: TPersistent); override;
    property DataController: TdxServerModeDataController
      read GetServerModeDataController;
  ...
  private
    function GetDataController: TdxServerModeDataController;
    procedure PopulateSummary(ASummaryItems: TcxDataSummaryItems;
  ...
  public
    ...
    procedure UpdateGroupSummary(AParentGroup
      : TdxServerModeDataGroupInfo = nil);
  ...
  protected
    ...
    function SetEditingData(ARecordIndex, AFieldIndex: Integer;
      const AValue: Variant): Boolean;
    ...
    property CustomDataSource: TdxServerModeProviderDataSource
      read GetCustomDataSource write SetCustomDataSource;
    property DataController: TdxServerModeDataController read GetDataController;
    property DataSource: TdxServerModeCustomDataSource read GetDataSource;
  ...
  public
    ...
    property DataControllerInfo: TdxServerModeDataControllerInfo
  ...
  protected
    ...
    procedure AdjustByInsertingRecord(ARecordIndex: Integer;
      AAppending: Boolean);
  ...
  protected
    ...
    procedure CreateGroup(AList: TdxServerModeGroupInfoList;
      AParentGroup: TdxServerModeDataGroupInfo);
    procedure ExpandItem(AItem: TdxServerModeDataGroupInfo; AExpanded: Boolean);
    function FindByServerGroupInfo(const AServerGroupInfo
      : TdxServerModeGroupInfo): Integer;
  ...
  public
    procedure ChangeExpanding(ARowIndex: Integer;
      AExpanded, ARecursive: Boolean); override;
    ...
    property Items[Index: Integer]: TdxServerModeDataGroupInfo
      read GetItem; default;
  end;
  ...
  private
    ...
    procedure ConvertFilterItems(ADestination: TdxServerModeCriteria;
      ASource: TcxFilterCriteria);
    procedure ConvertFindCriteria(ADestination: TdxServerModeFindCriteria;
      ASource: TdxServerModeDataFindCriteria);
    function CreateCriteria: TdxServerModeCriteria;
    function CreateFindCriteria: TdxServerModeFindCriteria;
    function CreateSortInfo: TdxServerModeSortInfoDescriptors;
    function CreateSummariesByItems(AItems: TcxDataSummaryItems;
  ...
  protected
    ...
    function LocateDetail(AGroupIndex, ARecordListIndex: Integer;
      AMakeVisible: Boolean): Integer; override;
  ...
  TdxServerModeDataControllerOption = (sdcoAssignGroupingValues,
    sdcoGroupsAlwaysExpanded, sdcoImmediatePost, sdcoInsertOnNewItemRowFocusing,
    sdcoKeepFocusedRowOnUpdate, sdcoSaveExpanding);
  ...
  protected
    ...
    function GetFieldByFieldName(const AFieldName: string)
      : TdxServerModeDataField;
    ...
    procedure UpdateField(ADataField: TdxServerModeDataField;
      const AFieldNames: string; AIsLookup: Boolean);
    procedure UpdateInternalField(const AFieldName: string;
      var AField: TdxServerModeDataField);

    procedure DataSourceChanged;
    function DoGetGroupRowDisplayText(const ARowInfo: TcxRowInfo;
      var AItemIndex: Integer): string; override;
    procedure InitializeDescriptor(AField: TcxCustomDataField;
      var ADescriptor: TdxServerModeDescriptor); virtual;
    function GetGroupRowValueByItemIndex(const ARowInfo: TcxRowInfo;
      AItemIndex: Integer): Variant; override;
  ...
  public
    ...
    property DataSource: TdxServerModeCustomDataSource read FDataSource
      write SetDataSource;
    property Options: TdxServerModeDataControllerOptions read FOptions
      write SetOptions default [sdcoAssignGroupingValues,
      sdcoKeepFocusedRowOnUpdate, sdcoSaveExpanding];
  end;

procedure dxServerModeRegisterAdapter
  (AClass: TdxServerModeCustomSQLAdapterClass; const AName: string);
procedure dxServerModeUnregisterAdapter
  (AClass: TdxServerModeCustomSQLAdapterClass);
// design-time
...
uses
  RTLConsts, Math, cxDateUtils, StrUtils, dxServerModeConsts,
...
constructor TdxServerModeDataSetDesigner.Create(ADataSource
  : TdxServerModeCustomDataSource);
begin
...
procedure TdxServerModeDataSetDesigner.DataEvent(Event: TDataEvent;
  Info: TdxNativeInt);
begin
  inherited;
...
procedure TdxServerModeFindCriteria.AssignConditions(AFindCriteria
  : TdxServerModeFindCriteria);
begin
  Filter.Root.Assign(AFindCriteria.Filter.Root);
end;

function TdxServerModeFindCriteria.IsEqual(AFindCriteria
  : TdxServerModeFindCriteria): Boolean;
begin
...
function TdxServerModeCriteriaItem.GetFilterOperatorClass
  : TcxFilterOperatorClass;
const
  ANullOperatorClasses: array [Boolean] of TcxFilterOperatorClass =
    (TcxFilterSQLNullOperator, TcxFilterSQLNotNullOperator);
begin
  if (OperatorKind in [foEqual, foNotEqual, foLike, foNotLike, foContains,
    foNotContains, foBeginsWith, foEndsWith]) and (ValueIsNull(Value)) then
...
procedure TdxServerModeCriteriaItemList.Assign
  (Source: TdxServerModeCriteriaItemList);
begin
  Clear;
...
procedure TdxServerModeCriteriaItemList.AssignItems
  (Source: TdxServerModeCriteriaItemList);
var
...
constructor TdxServerModeCriteria.Create(ADataSource
  : TdxServerModeCustomDataSource);
begin
  inherited Create;
  FDataSource := ADataSource;
...
function TdxServerModeCriteria.AddItem(AParent: TcxFilterCriteriaItemList;
  ADescriptor: TdxServerModeDescriptor; AOperatorKind: TcxFilterOperatorKind;
  const AValue: Variant): TdxServerModeCriteriaItem;
begin
  Result := TdxServerModeCriteriaItem(inherited AddItem(AParent, nil,
    AOperatorKind, AValue, dxVarArrayToDelimitedText(AValue, ',', '"')));
  Result.FDescriptor := ADescriptor;
end;

procedure TdxServerModeCriteria.AndCriteria(Value: TdxServerModeCriteria;
  ADestroyValue: Boolean = False);
begin
  Operation(Value, fboAnd, ADestroyValue);
end;

procedure TdxServerModeCriteria.OrCriteria(Value: TdxServerModeCriteria;
  ADestroyValue: Boolean = False);
begin
...
procedure TdxServerModeCriteria.DoGetFieldCaption
  (AItem: TdxServerModeCriteriaItem; var AFieldCaption: string);
begin
...
procedure TdxServerModeCriteria.FormatFilterTextValue
...
begin
  try
    ...
    try
      AList := TdxServerModeCriteriaItemList
        (ACriteria.Root.AddItemList(fboAnd));
...
function TdxServerModeDescriptor.IsEqual
  (AValue: TdxServerModeDescriptor): Boolean;
begin
...
procedure TdxServerModeDescriptor.Changed
  (AChanges: TdxServerModeDescriptorChanges = []);
begin
...
begin
  Result := (DateTimeGrouping in [dgByDateAndTime, dgRelativeToToday, dgByHour,
    dgByDate, dgByMonth, dgByYear]) and
...
function TdxServerModeDescriptor.GetLink(Index: Integer)
  : TdxServerModeDescriptor;
begin
...
procedure TdxServerModeDescriptor.SetDateTimeGrouping
  (Value: TdxDateTimeGrouping);
begin
...
procedure TdxServerModeDescriptor.SetLinkedObject
  (Value: TdxServerModeDescriptor);
begin
...
constructor TdxServerModeDescriptors.Create(ADataSource
  : TdxServerModeCustomDataSource);
begin
  inherited Create;
  FDataSource := ADataSource;
...
function TdxServerModeDescriptors.CreateLink(ALinkedObject
  : TdxServerModeDescriptor): TdxServerModeDescriptor;
begin
  Result := Add(nil);
...
function TdxServerModeDescriptors.IndexOf
  (AItem: TdxServerModeDescriptor): Integer;
begin
...
function TdxServerModeDescriptors.IsEqual
  (AValue: TdxServerModeDescriptors): Boolean;
var
  I: Integer;
begin
  Result := (AValue = nil) and IsEmpty or (AValue <> nil) and
    (Count = AValue.Count);
  if Result then
    for I := 0 to Count - 1 do
    begin
...
procedure TdxServerModeDescriptors.DoChanged(AItem: TdxServerModeDescriptor;
  AChanges: TdxServerModeDescriptorChanges);
begin
...
function TdxServerModeDescriptors.GetDescriptorClass
  : TdxServerModeDescriptorClass;
begin
...
function TdxServerModeDescriptors.GetItem(Index: Integer)
  : TdxServerModeDescriptor;
begin
...
function TdxServerModeGroupInfoDescriptor.IsEqual
  (AValue: TdxServerModeDescriptor): Boolean;
begin
...
function TdxServerModeGroupInfoDescriptors.GetItem(Index: Integer)
  : TdxServerModeGroupInfoDescriptor;
begin
...
function TdxServerModeSortInfoDescriptor.IsEqual
  (AValue: TdxServerModeDescriptor): Boolean;
begin
  Result := inherited IsEqual(AValue) and
    (AValue is TdxServerModeSortInfoDescriptor) and
    (IsDesc = TdxServerModeSortInfoDescriptor(AValue).IsDesc);
end;

procedure TdxServerModeSortInfoDescriptor.CheckGroupValue(var AValue: Variant;
  AIsGroupValue: Boolean);

  function GetGroupValueRelativeToToday(const AValue: Variant): Variant;
  var
    ADate, ACheckDate: TDateTime;
    AToday: TDateTime;
    AYesterday, ALastYear, ALastMonth, ALastWeek, AStartOfYear, AStartOfMonth,
      AStartOfWeek: TDateTime;
    ATomorrow, ANextYear, ANext2Year, ANextMonth, ANext2Month, ANextWeek,
      ANext2Week: TDateTime;
  begin
    ADate := Today;
    ...
    if ACheckDate = AToday then
      Result := ACheckDate
    else if ACheckDate > AToday then
    begin
      ATomorrow := ADate + 1;
      ...
      if ACheckDate = ATomorrow then
        Result := ATomorrow
      else if ACheckDate < ANextWeek then
        Result := ANextWeek
      else if ACheckDate < ANext2Week then
        Result := ANext2Week
      else if ACheckDate < ANextMonth then
        Result := ANextMonth
      else if ACheckDate < ANext2Month then
        Result := ANext2Month
      else if ACheckDate < ANextYear then
        Result := ANextYear
      else if ACheckDate < ANext2Year then
        Result := ANext2Year
      else
        Result := ACheckDate;
    end
    ...
    begin
      ...
      if ACheckDate >= AYesterday then
        Result := AYesterday
      else if ACheckDate >= AStartOfWeek then
        Result := AStartOfWeek
      else if ACheckDate >= ALastWeek then
        Result := ALastWeek
      else if ACheckDate >= AStartOfMonth then
        Result := AStartOfMonth
      else if ACheckDate >= ALastMonth then
        Result := ALastMonth
      else if ACheckDate >= AStartOfYear then
        Result := AStartOfYear
      else if ACheckDate >= ALastYear then
        Result := ALastYear
      else
        Result := ACheckDate;
    end;
...
procedure TdxServerModeSortInfoDescriptor.DoAssign
  (Source: TdxServerModeDescriptor);
begin
...
function TdxServerModeSortInfoDescriptors.Clone(AReversed: Boolean)
  : TdxServerModeSortInfoDescriptors;
var
  I: Integer;
begin
...
function TdxServerModeSortInfoDescriptors.GetDescriptorClass
  : TdxServerModeDescriptorClass;
begin
  Result := TdxServerModeSortInfoDescriptor;
end;

function TdxServerModeSortInfoDescriptors.GetItem(Index: Integer)
  : TdxServerModeSortInfoDescriptor;
begin
...
function TdxServerModeSummaryDescriptor.IsEqual
  (AValue: TdxServerModeDescriptor): Boolean;
begin
  Result := inherited IsEqual(AValue) and
...
procedure TdxServerModeSummaryDescriptor.DoAssign
  (Source: TdxServerModeDescriptor);
begin
...
function TdxServerModeSummaryDescriptors.Add(AField: TField;
...
function TdxServerModeSummaryDescriptors.IsGroupLevelSorted
  (AGroupLevel: Integer): Boolean;
var
  I: Integer;
begin
  Result := False;
...
function TdxServerModeSummaryDescriptors.GetDescriptorClass
  : TdxServerModeDescriptorClass;
begin
  Result := TdxServerModeSummaryDescriptor;
end;

function TdxServerModeSummaryDescriptors.GetItem(Index: Integer)
  : TdxServerModeSummaryDescriptor;
begin
...
procedure TdxServerModeFieldDescriptor.DoAssign
  (Source: TdxServerModeDescriptor);
begin
...
function TdxServerModeFieldDescriptors.Add(AField: TField)
  : TdxServerModeDescriptor;
begin
...
function TdxServerModeFieldDescriptors.FieldByName(const AFieldName
  : string): TField;
var
  I: Integer;
begin
...
function TdxServerModeFieldDescriptors.IndexByName(const AFieldName
  : string): Integer;
var
  I: Integer;
begin
...
function TdxServerModeFieldDescriptors.ItemByField(AField: TField)
  : TdxServerModeDescriptor;
var
  I: Integer;
begin
...
function TdxServerModeFieldDescriptors.GetItem(Index: Integer)
  : TdxServerModeFieldDescriptor;
begin
  Result := TdxServerModeFieldDescriptor(inherited Items[Index]);
end;

function TdxServerModeFieldDescriptors.GetDescriptorClass
  : TdxServerModeDescriptorClass;
begin
...
constructor TdxServerModeStateInfo.Create(AGroupCount: Integer;
  ASortInfo: TdxServerModeSortInfoDescriptors);
begin
  inherited Create;
...
function TdxServerModeStateInfo.GetMaxEqualDepth
  (ACache: TdxServerModeCache): Integer;
var
  I: Integer;
begin
  ...
  for I := 0 to Result - 1 do
    if (SortInfo[I].Field <> ACache.SortInfo[I].Field) or
      (SortInfo[I].IsDateTimeGrouping and (SortInfo[I].DateTimeGrouping <>
      ACache.SortInfo[I].DateTimeGrouping)) then
    begin
      Result := I;
      Break;
    end;
...
constructor TdxServerModeCache.Create(ADataSource
  : TdxServerModeCustomDataSource);
begin
  inherited Create;
  FDataSource := ADataSource;
...
function TdxServerModeCache.GetGroupInfoList(AParentGroup
  : TdxServerModeGroupInfo): TdxServerModeGroupInfoList;
var
  AGroupInfo: TdxServerModeGroupInfo;
begin
...
function TdxServerModeCache.IsNothingButCount
  (ASummaries: TdxServerModeSummaryDescriptors): Boolean;
var
  I: Integer;
begin
...
procedure TdxServerModeCache.RecalculateSummaries;
  ...
  begin
    if IsLanded or (AParentGroup.ChildrenGroups = nil) or
      (AParentGroup.ChildrenGroups.Count = 0) then
      Exit;
...
function TdxServerModeCache.GetKeyFromRow(const ARow: TdxServerModeRow)
  : Variant;
var
  I: Integer;
begin
  if KeyFields.Count = 0 then
    Result := Null
  else if KeyFields.Count = 1 then
...
function TdxServerModeCache.EvaluateOnInstance(const ARow: TdxServerModeRow;
...
function TdxServerModeCache.GetGroupWhere(AGroupInfo: TdxServerModeGroupInfo)
  : TdxServerModeCriteria;
var
...
begin
  ...
  begin
    ...
    begin
      Result.AddItem(SortInfo[ACurrentGroup.Level], foEqual,
        ACurrentGroup.GroupValue);
...
procedure TdxServerModeCache.MakeStrongClause(ACriteria: TdxServerModeCriteria;
  AParentList: TcxFilterCriteriaItemList; ADescriptor: TdxServerModeDescriptor;
  AIsDesc, ACanEqual: Boolean; const AValue: Variant);
const
  AOperationMap: array [Boolean, Boolean] of TcxFilterOperatorKind =
    ((foLess, foLessEqual), (foGreater, foGreaterEqual));
var
...
begin
  ...
  begin
    if AIsDesc and (DataSource.SQLAdapter.GetNullsSortOrder = nsoFirstIfAsc) or
      not AIsDesc and (DataSource.SQLAdapter.GetNullsSortOrder = nsoFirstIfDesc)
    then
...
procedure TdxServerModeCache.MakeStrongClause(ACriteria: TdxServerModeCriteria;
  AParentList: TcxFilterCriteriaItemList;
  ASortInfoDescriptor: TdxServerModeSortInfoDescriptor; const AValue: Variant);
begin
  MakeStrongClause(ACriteria, AParentList, ASortInfoDescriptor,
    ASortInfoDescriptor.IsDesc, False, AValue);
end;
...
begin
  Result := DataSource.PrepareChildren(AGroupWhere, AGroupByDescriptor,
    ASummaries);
end;
...
function TdxServerModeCache.PrepareTopGroupInfo
  (ASummaries: TdxServerModeSummaryDescriptors): TdxServerModeGroupInfoData;
begin
  Result := DataSource.PrepareTopGroupInfo(ASummaries);
end;

procedure TdxServerModeCache.RaiseInconsistencyDetected(const AFormat: string;
  Args: array of const);
var
  AMessage: string;
begin
...
procedure TdxServerModeCache.CalculateTotalSummaries
  (AGroupInfo: TdxServerModeGroupInfo);
var
...
begin
  ...
  begin
    ...
    ATopGroupInfoData := TdxServerModeGroupInfoData.Create(Null, ATotalCount,
      ASummaries);
  end
  else
    try
...
procedure TdxServerModeCache.CheckTopGroupInfo(APrevStateInfo
  : TdxServerModeStateInfo);

  procedure CheckChildren(AParent: TdxServerModeGroupInfo;
    ANewSortInfo, APrevSortInfo: TdxServerModeSortInfoDescriptors;
  ...
  begin
    ...
    if AChildren = nil then
      Exit;
    if (ACurrentDepth = AMaxDepth) or (AChildren.Count = 0) and
      (ACurrentDepth < AMaxDepth) then
    begin
      AParent.ResetChildren;
      Exit;
    end;
    if ANewSortInfo[ACurrentDepth].IsDesc <> APrevSortInfo[ACurrentDepth].IsDesc
    then
      AChildren.Reverse;
    AChildren.UpdateDataRowIndexes;
    for I := 0 to AChildren.Count - 1 do
      CheckChildren(AChildren[I], ANewSortInfo, APrevSortInfo,
        ACurrentDepth + 1, AMaxDepth);
  end;
...
procedure TdxServerModeCache.FillChildrenIfNeeded
  (AGroupInfo: TdxServerModeGroupInfo);
var
  AGroupWhere: TdxServerModeCriteria;
  AOrdDs: TdxServerModeSortInfoDescriptor;
...
begin
  ...
  if IsLanded or (AGroupInfo.Level + 1 >= GroupCount) or
    (AGroupInfo.DataRowCount = 0) then
    Exit;
  AChildren := nil;
  ...
  try
    ...
    try
      ...
      begin
        AGroupSrc := AChildren[J];
        ANextGroup := TdxServerModeGroupInfo.Create(AGroupInfo,
          AGroupSrc.GroupValue, AGroupInfo.Level + 1, ACurrentTop);
  ...
  else if ACurrentTop - AGroupInfo.TopDataRowIndex <> AGroupInfo.DataRowCount
  then
...
function TdxServerModeCache.PrepareTopGroupInfoWithTrick
  (ASummaries: TdxServerModeSummaryDescriptors): TdxServerModeGroupInfoData;
var
...
constructor TdxServerModeKeyedCache.Create(ADataSource
  : TdxServerModeCustomDataSource);
begin
  inherited;
...
function TdxServerModeKeyedCache.DecideIsFetchRowsGoodIdea
  (ASortInfo: TdxServerModeSortInfoDescriptors): Boolean;
begin
...
var
  ...
  APositionInGroup, APositionFromBottom, AFetchPosition, AFetchCount, APureTake,
    ASkipSkip, ASkipTake: Integer;
begin
  Result := Unassigned;
  ...
  if IsLanded then
    Exit;
  if (AGroupInfo.DataRowCount <= MagicNumberFetchRowsAllThreshold) and IsFetchRowsGoodIdeaForSure
  then
  begin
  ...
  if (AFetchCount <= MagicNumberFetchRowsTopThreshold) and IsFetchRowsGoodIdeaForSure
  then
  begin
  ...
  CalculateTake(AGroupInfo, AFetchCount, AIsFromBottom, APureTake,
    APureTakeIsFromBottom);
  CalculateModel(ARecordIndex, APositionInGroup, AGroupInfo, ASkipTake,
    ASkipSkip, ASkipIsFromBottom);
  PopulateFetchKeys(AGroupInfo, APureTake, ASkipSkip, ASkipTake,
    ASkipIsFromBottom, APureTakeIsFromBottom);
  if not KeysByIndex.TryGetValue(ARecordIndex, Result) and not IsLanded then
    InvalidOperation(sdxInternalErrorKeyAbsentDoFetchKeys);
end;

function TdxServerModeKeyedCache.Indexer(ARecordIndex: Integer)
  : TdxServerModeRow;
var
...
begin
  ...
  try
    ...
    try
      ...
      PopulateDownKeysToFetch(AKeysToFetch, AIndexesByKeys, ARecordIndex,
        ASplitLen, AFillFromSplit);
      if IsLanded then
        Exit;
      Assert(AKeysToFetch.Count > 0, 'KeysToFetch.Count = 0!');
      PopulateUpKeysToFetch(AKeysToFetch, AIndexesByKeys, ARecordIndex,
        AInSize);
      if IsLanded then
        Exit;
...
function TdxServerModeKeyedCache.Contains(const AValue
  : TdxServerModeRow): Boolean;
begin
...
begin
  ...
  begin
    ...
    RaiseInconsistencyDetected
      (sdxInconsistencyCantFindKeyInCompletelyFetchedGroup,
      [dxKeyToText(AKey)]);
    Exit;
  end;
...
function TdxServerModeKeyedCache.IndexOf(const AValue
  : TdxServerModeRow): Integer;
begin
  if VarIsNull(AValue) then
    Result := -1
  else
...
function TdxServerModeKeyedCache.KeyEquals(const AKey1, AKey2: Variant)
  : Boolean;
begin
...
procedure TdxServerModeKeyedCache.FetchRowsByKeys(ARows: TdxServerModeRowList;
  AKeys: TdxServerModeKeyList);
begin
...
function TdxServerModeKeyedCache.
  GetMagicNumberTakeIncreaseStepMultiplier: Double;
begin
  Result := dxDefaultMagicNumberTakeIncreaseStepMultiplier;
end;

function TdxServerModeKeyedCache.
  GetMagicNumberTakeKeysUpperLimitAfterSkip: Integer;
begin
...
procedure TdxServerModeKeyedCache.FetchKeys(AKeys: TdxServerModeKeyList;
  AWhere: TdxServerModeCriteria; ASortInfo: TdxServerModeSortInfoDescriptors;
  ASkip, ATake: Integer);
begin
  DataSource.FetchKeys(AKeys, AWhere, ASortInfo, ASkip, ATake);
end;

procedure TdxServerModeKeyedCache.FetchRows(ARows: TdxServerModeRowList;
  AWhere: TdxServerModeCriteria; ASortInfo: TdxServerModeSortInfoDescriptors;
  ATake: Integer);
begin
...
begin
  ...
  try
    ...
    try
      ...
      KeysByIndex.LoadedRecordsHelper.Add(AFirstRecord, ARows.Count,
        AIsFromBottom);
    finally
      ARows.Free;
    end;
...
function TdxServerModeKeyedCache.FetchRowByKey(const AKey: Variant)
  : TdxServerModeRow;
var
  AKeys: TdxServerModeKeyList;
  ACriteria: TdxServerModeCriteria;
...
function TdxServerModeKeyedCache.GetRowGroup(const ARow: TdxServerModeRow)
  : TdxServerModeGroupInfo;
var
...
procedure TdxServerModeKeyedCache.FetchRowsAll
  (AGroupInfo: TdxServerModeGroupInfo);
var
  AWhere: TdxServerModeCriteria;
begin
  ...
  try
    FetchRows(AWhere, AGroupInfo.DataRowCount + 1, AGroupInfo.DataRowCount,
      AGroupInfo.TopDataRowIndex, False);
  finally
    AWhere.Free;
  end;
end;

procedure TdxServerModeKeyedCache.FetchRowsTop
  (AGroupInfo: TdxServerModeGroupInfo; AIsFromBottom: Boolean; ATop: Integer);
var
  AWhere: TdxServerModeCriteria;
...
function TdxServerModeKeyedCache.FindFromCache(ARecordIndex: Integer;
  var ARow: TdxServerModeRow): Boolean;
var
  AKey: Variant;
begin
...
function TdxServerModeKeyedCache.GetCountBeforeRow(const ARow: TdxServerModeRow;
  ...
  function FindGroupInfo(AField: TField; AInfo: TdxServerModeGroupInfo)
    : TdxServerModeGroupInfo;
  begin
...
begin
  ...
  try
    ...
    begin
      ...
      ADescriptorIsGroup := FindGroupInfo(ASortInfoDescriptor.Field,
        AGroupInfo) <> nil;
      ...
      else if ASortInfoDescriptor.IsDateTimeGrouping then
      begin
        ASortInfoDescriptor := TdxServerModeSortInfoDescriptor
          (ASortInfoDescriptor.Clone);
...
function TdxServerModeKeyedCache.GetGroupForKeysFetchingAround(Index: Integer)
  : TdxServerModeGroupInfo;
var
...
begin
  ...
  repeat
    ...
    begin
      RaiseInconsistencyDetected
        (sdxInconsistencyCantFindAppropriateGroupForRow, [Index]);
      Break;
    end;
...
function TdxServerModeKeyedCache.
  GetMagicNumberAllowedSlowerThenBaseVariance: Double;
begin
  Result := 0.5;
end;
...
procedure TdxServerModeKeyedCache.CalculateModel(ARecordIndex, APositionInGroup
  : Integer; AGroupInfo: TdxServerModeGroupInfo;
  out ASkipTake, ASkipSkip: Integer; out ASkipIsFromBottom: Boolean);
var
  ADraftScan, AMinPosInGroupToFetch, ARealScan, AMaxPosInGroupToFetch,
    AMaxAllowedTake, AMaxObservableTake, AStartPopulatedIndex,
    AFinishPopulatedIndex: Integer;
...
begin
  ...
  begin
    ...
    try
      if AModel = nil then
        AModel := SafeModel;
      KeysByIndex.LoadedRecordsHelper.GetClosestPopulatedIndexes(ARecordIndex,
        AStartPopulatedIndex, AFinishPopulatedIndex);
      AMinPosInGroupToFetch :=
        Math.Max(AStartPopulatedIndex - AGroupInfo.TopDataRowIndex + 1, 0);
      AMaxPosInGroupToFetch :=
        Math.Min(AFinishPopulatedIndex - AGroupInfo.TopDataRowIndex,
        AGroupInfo.DataRowCount) - 1;
      ...
      if MinimizeSingleRequestTransferSizeInsteadOfOverallOptimization then
        AOptimalFetchParam := TdxServerModeOptimalFetchParam.Create(SafeModel,
          APositionInGroup, AMinPosInGroupToFetch, AMaxPosInGroupToFetch,
          AGroupInfo.DataRowCount, 64, AMaxAllowedTake, 1, 1, 1)
      else
        AOptimalFetchParam := TdxServerModeOptimalFetchParam.Create(AModel,
          APositionInGroup, AMinPosInGroupToFetch, AMaxPosInGroupToFetch,
          AGroupInfo.DataRowCount, 128, AMaxAllowedTake, 1.66, 1.33, 1.15);
      try
        AChosenResult := TdxServerModeOptimalFetchHelper.
          CalculateOptimalFetchResult(AOptimalFetchParam);
        try
          ASkipIsFromBottom := AChosenResult.IsFromEnd;
          ASkipSkip := AChosenResult.Skip div MagicNumberFetchKeysModulo *
            MagicNumberFetchKeysModulo;
    ...
    ARealScan := ADraftScan div MagicNumberFetchKeysModulo *
      MagicNumberFetchKeysModulo + 1;
...
procedure TdxServerModeKeyedCache.CalculateTake
  (AGroupInfo: TdxServerModeGroupInfo; AFetchCount: Integer;
  AIsFromBottom: Boolean; out APureTake: Integer;
  out APureTakeIsFromBottom: Boolean);
var
...
begin
  ...
  begin
    ...
    if ATake < AFetchCount then
      InvalidOperation(Format(sdxInternalErrorTakeLessFetchCount,
        [APureTake, AFetchCount, AGroupInfo.DataRowCount]));
    if ATake > AGroupInfo.DataRowCount then
      InvalidOperation(Format(sdxInternalErrorTakeGreaterChildDataRowCount,
        [APureTake, AGroupInfo.DataRowCount]));
    APureTake := ATake;
...
procedure TdxServerModeKeyedCache.DoFetchKeys
  (AGroupInfo: TdxServerModeGroupInfo; AIsFromBottom: Boolean;
  ASkip, ATake: Integer);
var
  AKeys: TdxServerModeKeyList;
  AGroupWhere: TdxServerModeCriteria;
...
procedure TdxServerModeKeyedCache.DoFetchKeysSkipWithTakeBackup
  (AGroupInfo: TdxServerModeGroupInfo; ASkipIsFromBottom: Boolean;
  ASkipSkip, ASkipTake: Integer; APureTakeIsFromBottom: Boolean;
  APureTake: Integer);
var
  AKeys: TdxServerModeKeyList;
  AGroupWhere: TdxServerModeCriteria;
  ...
  try
    ...
    try
      try
        ...
        if (ASkipTake = 0) or (ASkipSkip + ASkipTake = AGroupInfo.DataRowCount)
        then
          APatchedTake := AGroupInfo.DataRowCount - ASkipSkip + 1;
        AKeys := TdxServerModeKeyList.Create;
        try
          FetchKeysTimed(AKeys, AGroupWhere, ASortInfo, ASkipSkip,
            APatchedTake);
...
procedure TdxServerModeKeyedCache.FetchKeysTimed(AKeys: TdxServerModeKeyList;
  AWhere: TdxServerModeCriteria; ASortInfo: TdxServerModeSortInfoDescriptors;
  ASkip, ATake: Integer);
var
...
begin
  ...
  Regressor.RegisterSample(AActualFetch, AActualScan,
    GetPerformanceMilliSeconds(ATime) / 1000);
end;

procedure TdxServerModeKeyedCache.FillKeys(AGroupInfo: TdxServerModeGroupInfo;
  AIsFromBottom: Boolean; ASkip, ATake: Integer; AKeys: TdxServerModeKeyList);
var
...
begin
  ...
  begin
    RaiseInconsistencyDetected(sdxInconsistencyUnexpectedNumberOfKeys,
      [AKeys.Count, AValidateCount]);
    Exit;
  end;
  ACurrentRow := AFirstRecord;
  if AIsFromBottom then
...
function TdxServerModeKeyedCache.GetGlobalIndex
  (AGroupInfo: TdxServerModeGroupInfo; APos: Integer;
  AIsReversed: Boolean): Integer;
begin
  if AIsReversed then
...
procedure TdxServerModeKeyedCache.PopulateDownKeysToFetch
  (AKeysToFetch: TdxServerModeKeyList;
  AIndexesByKeys: TdxServerModeLoadedKeysChunkDictionary; ARecordIndex: Integer;
  ASplitLen: Integer; out AFillFromSplit: Boolean);
var
  I, AOldIndex: Integer;
  AFillKey: TdxServerModeRow;
begin
...
procedure TdxServerModeKeyedCache.PopulateFetchKeys
  (AGroupInfo: TdxServerModeGroupInfo; APureTake, ASkipSkip, ASkipTake: Integer;
  ASkipIsFromBottom, APureTakeIsFromBottom: Boolean);
begin
  if IsLanded then
    Exit;
  ...
  begin
    if (ASkipSkip = 0) or (APureTake < 0) then
      ...
      DoFetchKeysSkipWithTakeBackup(AGroupInfo, ASkipIsFromBottom, ASkipSkip,
        ASkipTake, APureTakeIsFromBottom, APureTake);
  end
  else if APureTake >= 0 then
    DoFetchKeys(AGroupInfo, APureTakeIsFromBottom, 0, APureTake)
  else
...
procedure TdxServerModeKeyedCache.PopulateUpKeysToFetch
  (AKeysToFetch: TdxServerModeKeyList;
  AIndexesByKeys: TdxServerModeLoadedKeysChunkDictionary; ARecordIndex: Integer;
  AInSize: Integer);
var
...
function TdxServerModeKeyedCache.PopulateRowsByIndex
  (const ARows: TdxServerModeRowList;
  AIndexesByKeys: TdxServerModeLoadedKeysChunkDictionary;
  AReturnRecordIndex: Integer): TdxServerModeRow;
var
  I, ARowIndex: Integer;
...
constructor TdxServerModeCustomSQLAdapter.Create(ADataSource
  : TdxServerModeCustomDataSource);
begin
...
begin
  ...
  Result := dxCompareValues(PosEx(AParamName1, AStr, 1),
    PosEx(AParamName2, AStr, 1));
end;

procedure TdxServerModeCustomSQLAdapter.CheckParams
  (AParams: TdxServerModeParams; var ACommandText: string);
begin
...
procedure TdxServerModeCustomSQLAdapter.CheckRepeatedParams
  (AParams: TdxServerModeParams; var ACommandText: string);
var
  I, J: Integer;
  AParamName1, AParamName2: string;
begin
  for I := 0 to AParams.Count - 1 do
    for J := AParams.Count - 1 downto I + 1 do
      if (AParams[I].DataType = AParams[J].DataType) and
        VarEquals(AParams[I].Value, AParams[J].Value) then
      begin
        AParamName1 := Format(GetParamFormat, [AParams[I].Name]);
        AParamName2 := Format(GetParamFormat, [AParams[J].Name]);
        ACommandText := StringReplace(ACommandText, AParamName2, AParamName1,
          [rfReplaceAll, rfIgnoreCase]);
        AParams.Delete(J);
      end;
end;

procedure TdxServerModeCustomSQLAdapter.CorrectCommandText
  (AParams: TdxServerModeParams; var ACommandText: string);
var
  I: Integer;
  APos: Integer;
    ...
    begin
      ...
      begin
        ...
        ACommandText := Copy(ACommandText, 1, APos - 1) + ANewName +
          Copy(ACommandText, APos + Length(AParamName),
          Length(ACommandText) - APos - Length(AParamName) + 1);
      end;
    end;
  end;
end;

function TdxServerModeCustomSQLAdapter.CreateParam(AParams: TdxServerModeParams;
  const AValue: Variant; const ADataType: TFieldType; out ADisplayValue: string)
  : TdxServerModeParam;
begin
...
procedure TdxServerModeCustomSQLAdapter.Changed(const AChanges
  : TdxServerModeDataSourceChanges);
begin
...
procedure TdxServerModeCustomSQLAdapter.RenameParams
  (AParams: TdxServerModeParams; var ACommandText: string);
var
  I: Integer;
...
begin
  ...
  begin
    ...
    ACommandText := StringReplace(ACommandText, AParamName, ANewName,
      [rfReplaceAll, rfIgnoreCase]);
  end;
end;

procedure TdxServerModeCustomSQLAdapter.SortParams(AParams: TdxServerModeParams;
  var ACommandText: string);
var
  I: Integer;
  AList: TList;
begin
...
function TdxServerModeCustomSQLAdapter.CanUseParam
  (AParam: TdxServerModeParam): Boolean;
begin
  Result := True;
end;
...
function TdxServerModeCustomSQLAdapter.ConvertBoolToStr
...
procedure TdxServerModeCustomSQLAdapter.CheckFilterFieldCaption
  (var AFieldCaption: string; AOperatorKind: TcxFilterOperatorKind);
begin
  // do nothing
end;

function TdxServerModeCustomSQLAdapter.DateDec(APart: TdxSQLDatePart;
  const ADateExpression, ADelta: string): string;
begin
  Result := Format('DATEADD(%s, -(%s), %s)', [GetDatePart(APart), ADelta,
    ADateExpression]);
end;
...
begin
  Result := Format('DATEDIFF(%s, %s, %s)',
    [GetDatePart(APart), ADateExpression1, ADateExpression2]);
end;

function TdxServerModeCustomSQLAdapter.DateInc(APart: TdxSQLDatePart;
  const ADateExpression, ADelta: string): string;
begin
  Result := Format('DATEADD(%s, %s, %s)', [GetDatePart(APart), ADelta,
    ADateExpression]);
...
function TdxServerModeCustomSQLAdapter.DatePart(APart: TdxSQLDatePart;
  const ADateExpression: string): string;
begin
  Result := Format('DATEPART(%s, %s)', [GetDatePart(APart), ADateExpression]);
end;

function TdxServerModeCustomSQLAdapter.DateTimeToString(const ADateTime
  : TDateTime): string;
begin
...
function TdxServerModeCustomSQLAdapter.GetDatePart
  (APart: TdxSQLDatePart): string;
const
  AResultMap: array [TdxSQLDatePart] of string = ('year', 'quarter', 'month',
    'dayofyear', 'day', 'weekday', 'week', 'hour', 'minute', 'second',
...
function TdxServerModeCustomSQLAdapter.
  GetDateTimeGroupingResultFieldFormat: string;
begin
  Result := '%s as %s';
end;

function TdxServerModeCustomSQLAdapter.GetDateTimeGroupingResultFieldName
  (AField: TField): string;
begin
  Result := Format(GetFieldNameFormat,
    ['GroupingBy' + GetServerFieldName(AField)]);
end;
...
function TdxServerModeCustomSQLAdapter.IsNull(const AExpression
  : string): string;
begin
      ...
      begin
        ...
        begin
          ...
          if ADateTimeGrouping <> dgByMonth then
            Result := DateDec(dpMonth, Result, DatePart(dpMonth, ADate)
              + ' - 1');
        end;
      end;
    end;
...
function TdxServerModeCustomSQLAdapter.GetCaseOperatorFormat
...
procedure TdxServerModeCustomSQLAdapter.EscapeFakeParamName
  (AParam: TdxServerModeParam; ABuilder: TdxServerModeCustomSQLQueryBuilder);
var
  AParamName: string;
begin
  AParamName := Format(GetParamFormat, [AParam.Name]);
  ABuilder.ReplaceFakeParamNameWithText(AParam,
    AParamName + GetEscapeTextForParamName);
end;

procedure TdxServerModeCustomSQLAdapter.EscapeLikeValue
  (AParam: TdxServerModeParam; APercentWildcard, AUnderscoreWildcard: Char);
var
  AEscapePercentWildcard, AEscapeUnderscoreWildcard: Boolean;
begin
  AEscapePercentWildcard := (AParam.CriteriaOperatorKind
    in [foContains .. foEndsWith]) or (APercentWildcard <> GetPercentWildcard);
  AEscapeUnderscoreWildcard :=
    (AParam.CriteriaOperatorKind in [foContains .. foEndsWith]) or
    (AUnderscoreWildcard <> GetUnderscoreWildcard);
  AParam.Value := MakeEscapedValue(AParam.Value, AEscapePercentWildcard,
    AEscapeUnderscoreWildcard);
    ...
    foLike, foNotLike:
      begin
        if AEscapePercentWildcard then
          AParam.Value := StringReplace(AParam.Value, APercentWildcard,
            GetPercentWildcard, [rfReplaceAll]);
        if AEscapeUnderscoreWildcard then
          AParam.Value := StringReplace(AParam.Value, AUnderscoreWildcard,
            GetUnderscoreWildcard, [rfReplaceAll]);
      end;
  end;
end;

procedure TdxServerModeCustomSQLAdapter.GetLikeValue
  (ABuilder: TdxServerModeCustomSQLQueryBuilder; AParam: TdxServerModeParam;
  APercentWildcard, AUnderscoreWildcard: Char);
begin
...
begin
  ...
  if AEscapePercentWildcard then
    Result := StringReplace(Result, GetPercentWildcard,
      '\' + GetPercentWildcard, [rfReplaceAll]);
  if AEscapeUnderscoreWildcard then
    Result := StringReplace(Result, GetUnderscoreWildcard,
      '\' + GetUnderscoreWildcard, [rfReplaceAll]);
end;

function TdxServerModeCustomSQLAdapter.NeedEscapeFakeParamName
  (AParam: TdxServerModeParam): Boolean;
begin
...
function TdxServerModeCustomSQLAdapter.GetInsertingRowOutKey
  (const AKey: string): string;
begin
  Result := AKey;
end;

function TdxServerModeCustomSQLAdapter.GetServerFieldName
  (AField: TField): string;
begin
...
function TdxServerModeCustomSQLAdapter.GetSummaryFormat
  (AKind: TcxSummaryKind): string;
const
...
function TdxServerModeCustomSQLAdapter.GetDeleteSQLString(const AFrom,
  AWhere: string): string;
begin
  Result := Format('DELETE FROM %s %s', [AFrom, AWhere]);
end;

function TdxServerModeCustomSQLAdapter.GetSelectSQLString(const AFields, AFrom,
  AWhere, AGroup, ASortInfo: string; ATopRecords, ASkipRecords: Integer;
...
function TdxServerModeCustomSQLAdapter.GetInsertSQLString(const AFrom,
  AOutRowKey, AFields, AValues: string): string;
begin
  Result := Format('INSERT INTO %s (%s) VALUES (%s)',
    [AFrom, AFields, AValues]);
end;

function TdxServerModeCustomSQLAdapter.GetUpdateSQLString(const AFrom,
  AOutRowKey, AValues, AWhere: string): string;
begin
...
function TdxServerModeCustomSQLAdapter.GetSQLQueryKeyFieldNames(const ATableName
  : string): string;
begin
  Result := '';
end;
...
function TdxServerModeCustomSQLAdapter.QuotedString(const AParamValue
  : string): string;
begin
...
constructor TdxServerModeParams.Create
  (AOwner: TdxServerModeCustomSQLQueryBuilder;
  AParamClass: TdxServerModeParamClass);
begin
...
function TdxServerModeParams.CreateParam(AFieldType: TFieldType;
  const ParamName: string; ParamType: TParamType): TdxServerModeParam;
begin
  Result := TdxServerModeParam(inherited CreateParam(AFieldType, ParamName,
    ParamType));
end;
...
function TdxServerModeParams.ParamByName(const Value: string)
  : TdxServerModeParam;
begin
...
procedure TdxServerModeParams.SetItem(Index: Integer;
  const Value: TdxServerModeParam);
begin
...
constructor TdxServerModeCustomSQLQueryBuilder.Create
  ...
  case FQueryType of
    qtInsert:
      begin
        ...
        Result := Adapter.GetInsertSQLString(AFrom, AOutRowKey,
          AFields, AValues);
      end;
    qtUpdate:
      begin
        ...
        AOutRowKey := GetInsertingRowOutKeys;
        Result := Adapter.GetUpdateSQLString(AFrom, AOutRowKey,
          AValues, AWhere);
      end;
    qtDelete:
      begin
    ...
    Result := Adapter.GetSelectSQLString(AFields, AFrom, AWhere, AGroup,
      ASortInfo, TopRecords, SkipRecords, Distinct);
  end;
end;
...
function TdxServerModeCustomSQLQueryBuilder.CanUseParam
  (AParam: TdxServerModeParam): Boolean;
begin
  Result := CanUseParams and not VarIsNull(AParam.Value) and
    (not((ppGroupingByDateRange in AParam.Position) and
    not(ppCriteria in AParam.Position)) or
    Adapter.CanUseGroupingByDateRangeParams) and Adapter.CanUseParam(AParam);
end;

function TdxServerModeCustomSQLQueryBuilder.CanDateTimeGrouping
  (ADescriptor: TdxServerModeDescriptor): Boolean;
begin
  Result := Adapter.IsDateRangeGroupingSupported and
    ADescriptor.IsDateTimeGrouping and
...
function TdxServerModeCustomSQLQueryBuilder.CanSorting
  (ADescriptor: TdxServerModeDescriptor): Boolean;
begin
...
function TdxServerModeCustomSQLQueryBuilder.CreateParam(const ADataType
  : TFieldType; const AValue: Variant; out ADisplayValue: string)
  : TdxServerModeParam;
begin
  Result := DoCreateParam(ADataType, AValue, ADisplayValue)
end;

function TdxServerModeCustomSQLQueryBuilder.DoCreateParam(const ADataType
  : TFieldType; const AValue: Variant; out ADisplayValue: string)
  : TdxServerModeParam;
var
...
begin
  ...
  begin
    Result := Adapter.GetInsertingRowOutKey
      (DescriptorToString(DataSource.KeyFields[0]));
    for I := 1 to DataSource.KeyFields.Count - 1 do
      Result := Format('%s, %s',
        [Result, Adapter.GetInsertingRowOutKey(DescriptorToString
        (DataSource.KeyFields[I]))]);
  end
  else
    Result := '';
end;
    ...
    begin
      ...
      begin
        if Result = '' then
          ...
          Result := Format('%s, %s = %s',
            [Result, DescriptorToString(Fields[I]), AValue]);
      end;
    end;
end;

function TdxServerModeCustomSQLQueryBuilder.DescriptorToString
  (ADescriptor: TdxServerModeDescriptor): string;
var
...
begin
  ...
  else if ADescriptor.Field = nil then
    Result := '*'
  else
    ...
    begin
      ...
      begin
        Result := Format(Adapter.GetDateTimeGroupingResultFieldFormat,
          [Result, Adapter.GetDateTimeGroupingResultFieldName
          (ADescriptor.Field)]);
      end;
    end
    else if Adapter.CanUseResultFieldName then
      Result := Adapter.GetDateTimeGroupingResultFieldName(ADescriptor.Field);
  end;

  if ADescriptor.IsSummary then
  begin
    if (TdxServerModeSummaryDescriptor(ADescriptor).Kind = skCount) and
      not DataSource.IsIgnoreNullOnSummary then
      Result := Format(Adapter.GetSummaryFormat(TdxServerModeSummaryDescriptor
        (ADescriptor).Kind), ['*'])
    else
      Result := Format(Adapter.GetSummaryFormat(TdxServerModeSummaryDescriptor
        (ADescriptor).Kind), [Result]);
  end;

  if CanSorting(ADescriptor) then
  begin
    AResult := Result;
    Result := Format(Adapter.GetOrderFormat(TdxServerModeSortInfoDescriptor
      (ADescriptor).IsDesc), [Result]);
    ...
    begin
      ...
      begin
        ...
        Result := Format('%s, %s',
          [Result, Format(Adapter.GetOrderFormat(TdxServerModeSortInfoDescriptor
          (ADescriptor).IsDesc), [AFieldName])]);
      end;
    end;
  end;
end;

function TdxServerModeCustomSQLQueryBuilder.DescriptorsToString
  (ADescriptors: TdxServerModeDescriptors): string;
var
  I: Integer;
begin
  Result := '';
...
function TdxServerModeCustomSQLQueryBuilder.GetAdapter
  : TdxServerModeCustomSQLAdapter;
begin
...
procedure TdxServerModeCustomSQLQueryBuilder.GetFilterFieldCaptionHandler
  (AItem: TdxServerModeCriteriaItem; var AFieldCaption: string);
begin
...
procedure TdxServerModeCustomSQLQueryBuilder.GetFilterValueHandler
  (AItem: TcxFilterCriteriaItem; const AValue: Variant;
  var ADisplayValue: string);
var
...
function TdxServerModeCustomSQLQueryBuilder.GetParamValueText
  (AParam: TdxServerModeParam): string;
var
  AVarType: TVarType;
begin
  ...
  else if AVarType = varBoolean then
    Result := Adapter.ConvertBoolToStr(AParam.Value)
  else if AVarType = varNull then
    Result := 'NULL'
  else if VarIsDate(AParam.Value) then
    Result := Adapter.DateTimeToString(AParam.Value)
  else
    Result := VarToStr(AParam.Value);
end;

procedure TdxServerModeCustomSQLQueryBuilder.ReplaceFakeParamNameWithText
  (AParam: TdxServerModeParam; const AValue: string);
begin
  FCommandText := StringReplace(FCommandText, Format(Adapter.GetParamFormat,
    [AParam.Name]), AValue, [rfReplaceAll]);
end;
...
begin
  ...
  begin
    ...
    begin
      if AParam.CriteriaOperatorKind in [foLike, foNotLike, foContains,
        foNotContains, foBeginsWith, foEndsWith] then
      begin
        if VarIsStr(AParam.Value) then
        begin
          V := AParam.Value;
...
function TdxServerModeCustomSQLQueryBuilder.CreateDateTimeParam(const ADateTime
  : TDateTime): string;
begin
  CreateParam(ftDateTime, ADateTime, Result);
end;

function TdxServerModeCustomSQLQueryBuilder.DateTimeGroupingByRelativeToToday
...
begin
  ...
  ALastMonth := CreateDateTimeParam
    (StartOfTheMonth(StartOfTheMonth(ADate) - 1));
  ...
  ANext := Format(Adapter.GetCaseFullFormat,
    [Format(Adapter.GetCaseOperatorFormat(foLess), [ACheckDate, ANext2Year]),
    ANext2Year, ACheckDate]);
  ANext := Format(Adapter.GetCaseFullFormat,
    [Format(Adapter.GetCaseOperatorFormat(foLess), [ACheckDate, ANextYear]),
    ANextYear, ANext]);
  ANext := Format(Adapter.GetCaseFullFormat,
    [Format(Adapter.GetCaseOperatorFormat(foLess), [ACheckDate, ANext2Month]),
    ANext2Month, ANext]);
  ANext := Format(Adapter.GetCaseFullFormat,
    [Format(Adapter.GetCaseOperatorFormat(foLess), [ACheckDate, ANextMonth]),
    ANextMonth, ANext]);
  ANext := Format(Adapter.GetCaseFullFormat,
    [Format(Adapter.GetCaseOperatorFormat(foLess), [ACheckDate, ANext2Week]),
    ANext2Week, ANext]);
  ANext := Format(Adapter.GetCaseFullFormat,
    [Format(Adapter.GetCaseOperatorFormat(foLess), [ACheckDate, ANextWeek]),
    ANextWeek, ANext]);
  ANext := Format(Adapter.GetCaseFullFormat,
    [Format(Adapter.GetCaseOperatorFormat(foEqual), [ACheckDate, ATomorrow]),
    ATomorrow, ANext]);

  ALast := Format(Adapter.GetCaseFullFormat,
    [Format(Adapter.GetCaseOperatorFormat(foLess), [ACheckDate, ALastYear]),
    ACheckDate, ALastYear]);
  ALast := Format(Adapter.GetCaseFullFormat,
    [Format(Adapter.GetCaseOperatorFormat(foLess), [ACheckDate, AStartOfYear]),
    ALast, AStartOfYear]);
  ALast := Format(Adapter.GetCaseFullFormat,
    [Format(Adapter.GetCaseOperatorFormat(foLess), [ACheckDate, ALastMonth]),
    ALast, ALastMonth]);
  ALast := Format(Adapter.GetCaseFullFormat,
    [Format(Adapter.GetCaseOperatorFormat(foLess), [ACheckDate, AStartOfMonth]),
    ALast, AStartOfMonth]);
  ALast := Format(Adapter.GetCaseFullFormat,
    [Format(Adapter.GetCaseOperatorFormat(foLess), [ACheckDate, ALastWeek]),
    ALast, ALastWeek]);
  ALast := Format(Adapter.GetCaseFullFormat,
    [Format(Adapter.GetCaseOperatorFormat(foLess), [ACheckDate, AStartOfWeek]),
    ALast, AStartOfWeek]);
  ALast := Format(Adapter.GetCaseFullFormat,
    [Format(Adapter.GetCaseOperatorFormat(foLess), [ACheckDate, AYesterday]),
    ALast, AYesterday]);

  Result := Format(Adapter.GetCaseFullFormat,
    [Format(Adapter.GetCaseOperatorFormat(foLess), [ACheckDate, AToday]),
    ALast, ANext]);
  Result := Format(Adapter.GetCaseFullFormat,
    [Format(Adapter.GetCaseOperatorFormat(foEqual), [ACheckDate, AToday]),
    ACheckDate, Result]);
end;

function TdxServerModeCustomSQLQueryBuilder.GetGroupingStartDate
  (ADateTimeGrouping: TdxDateTimeGrouping): string;
var
  ADate: TDateTime;
begin
...
function TdxServerModeCustomSQLQueryBuilder.GroupingByDateRange(const AFieldName
  : string; ADescriptor: TdxServerModeDescriptor): string;
var
  AStartDate: string;
...
begin
  ...
  try
    ...
    if ADateTimeGrouping in [dgRelativeToToday, dgByHour, dgByDate, dgByMonth,
      dgByYear] then
      Result := Format(Adapter.GetCaseFullFormat,
        [Adapter.IsNull(Adapter.GetFieldName(ADescriptor.Field)),
        'NULL', Result]);
  finally
...
procedure TdxServerModeCustomSQLQueryBuilder.SetCriteria
  (Value: TdxServerModeCriteria);
begin
  Criteria.Clear;
...
constructor TdxServerModeDataSourceOptions.Create
  (AOwner: TdxServerModeCustomDataSource);
begin
  inherited Create;
  FOwner := AOwner;
...
procedure TdxServerModeDataSourceOptions.Changed(const AChanges
  : TdxServerModeDataSourceChanges = [ctOptions]);
begin
...
begin
  ASQLAdapterClass := TdxServerModeCustomSQLAdapterClass
    (dxGetServerModeSQLAdapters.FindByDescription(Reader.ReadString));
...
constructor TdxServerModeDataSourceCustomHelper.Create
  (ADataSource: TdxServerModeCustomDataSource);
begin
  inherited Create;
  FDataSource := ADataSource;
...
function TdxServerModeDataSourceCustomHelper.GetOptionsClass
  : TdxServerModeDataSourceOptionsClass;
begin
  Result := TdxServerModeDataSourceOptions;
end;

function TdxServerModeDataSourceCustomHelper.GetQueryBuilderClass
  : TdxServerModeCustomSQLQueryBuilderClass;
begin
  Result := TdxServerModeCustomSQLQueryBuilder;
end;

procedure TdxServerModeDataSourceCustomHelper.CheckParamValue
  (var AParam: TdxServerModeParam);
begin
  // do nothing
end;
...
procedure TdxServerModeDataSourceCustomHelper.DoExecuteCommand
...
function TdxServerModeDataSourceCustomHelper.ExecuteCommand
  (AResultSet: PDataSet; const ACommandText: string; AParams: TParams;
  AParamCheck: Boolean; ACheckSettings: Boolean = True): Boolean;
begin
  Result := DataSource.ExecuteCommand(AResultSet, ACommandText, AParams,
    AParamCheck, ACheckSettings);
end;
...
procedure TdxServerModeDataSourceCustomHelper.PrepareDatasetForIterate
  (ADataSet: TDataSet);
begin
...
procedure TdxServerModeCustomDataSource.Delete
  (ACriteria: TdxServerModeCriteria);
begin
  // do nothing
end;

function TdxServerModeCustomDataSource.FindIncremental(AField: TField;
  const ASubStr: string; AStartIndex: Integer; ASearchDown: Boolean = True;
  AIgnoreStartRow: Boolean = False): Integer;

  function CalculateCriteria(const ARow: TdxServerModeRow)
    : TdxServerModeCriteria;
  var
    AList: TdxServerModeCriteriaItemList;
    I: Integer;
  ...
  begin
    ...
    AItem := Result.AddItem(AList, FieldDescriptors.ItemByField(AField), foLike,
      ALikeValue + Adapter.GetPercentWildcard);
    ...
    begin
      ...
      Cache.MakeStrongClause(Result, AList, SortInfo[I], AIsDown,
        (I = SortInfo.Count - 1) and not AIgnoreStartRow, AValue);
  ...
  try
    ...
    begin
      ...
      if (AStartIndex >= 0) and (Result >= 0) and
        ((ASearchDown and (AStartIndex > Result)) or
        (not ASearchDown and (AStartIndex < Result))) then
        Result := -1;
    end;
  finally
    ACriteria.Free;
...
function TdxServerModeCustomDataSource.FindIncremental(const AFieldName,
  ASubStr: string; AStartIndex: Integer; ASearchDown: Boolean = True;
  AIgnoreStartRow: Boolean = False): Integer;
var
  AField: TField;
begin
  ...
  if AField <> nil then
    Result := FindIncremental(AField, ASubStr, AStartIndex, ASearchDown,
      AIgnoreStartRow)
  else
    Result := -1;
end;

procedure TdxServerModeCustomDataSource.AddDataController(ADataController
  : TdxServerModeDataController);
var
...
procedure TdxServerModeCustomDataSource.RemoveDataController(ADataController
  : TdxServerModeDataController);
begin
  if FDataController = ADataController then
  begin
...
procedure TdxServerModeCustomDataSource.PopulateFilterValues
  (AList: TcxDataFilterValueList; AField: TField; ACriteria: TcxFilterCriteria;
  var AUseFilteredRecords: Boolean; out ANullExists: Boolean);
var
...
begin
  ...
  try
    ...
    try
      ...
      if ExecuteCommand(@ADataSet, AFields, AFilterCriteria, ASortInfo, nil,
        ACriteria.MaxValueListCount, 0, True) then
        try
...
function TdxServerModeCustomDataSource.PostEditingData(ARowIndex: Integer;
  const AEditingRow: Variant): Variant;
begin
  Result := Unassigned;
end;
...
begin
  inherited DefineProperties(Filer);
  Filer.DefineProperty('Fields', ReadFields, WriteFields,
    FDataSet.Fields.Count > 0);
end;

procedure TdxServerModeCustomDataSource.GetChildren(Proc: TGetChildProc;
  Root: TComponent);
var
  I: Integer;
begin
...
procedure TdxServerModeCustomDataSource.Notification(AComponent: TComponent;
...
procedure TdxServerModeCustomDataSource.CheckCacheInconsistency
...
procedure TdxServerModeCustomDataSource.CheckParamValue
  (var AParam: TdxServerModeParam);
begin
...
function TdxServerModeCustomDataSource.CreateField(AFieldDef: TFieldDef;
...
function TdxServerModeCustomDataSource.CreateFindCriteria
  : TdxServerModeFindCriteria;
begin
  Result := TdxServerModeFindCriteria.Create(Self);
end;

function TdxServerModeCustomDataSource.CreateGroupInfo
  : TdxServerModeGroupInfoDescriptors;
begin
...
function TdxServerModeCustomDataSource.CreateSortInfo
  : TdxServerModeSortInfoDescriptors;
begin
  Result := GetSortInfoDescriptorsClass.Create(Self);
end;

function TdxServerModeCustomDataSource.CreateSummaries
  : TdxServerModeSummaryDescriptors;
begin
...
procedure TdxServerModeCustomDataSource.DoSynchronizeDataSetConnection
  (ADataSet: TDataSet);
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      else if ([ctSorting, ctGroups] * FChanges <> []) then
...
function TdxServerModeCustomDataSource.GetFieldUniqueName
  (AField: TField): string;
begin
...
begin
  Result := (DataController <> nil) and
    (soNullIgnore in DataController.Summary.Options);
end;

function TdxServerModeCustomDataSource.IsPersistentField
  (AField: TField): Boolean;
begin
  Result := (AField.Owner = Owner) or
    (FLoadingFieldNames.IndexOf(AField.FieldName) <> -1);
end;
...
function TdxServerModeCustomDataSource.GetBookmark(ARecordIndex
  : Integer): Variant;
begin
  Result := Cache.GetRowKey(ARecordIndex);
end;

function TdxServerModeCustomDataSource.BookmarkValid
  (ABookmark: Variant): Boolean;
begin
...
procedure TdxServerModeCustomDataSource.DoInconsistentCache(out ARecoverCache
  : Boolean);
begin
  ARecoverCache := True;
...
function TdxServerModeCustomDataSource.GetCriteriaClass
  : TdxServerModeCriteriaClass;
begin
  Result := TdxServerModeCriteria;
end;

function TdxServerModeCustomDataSource.GetGroupInfoDescriptorsClass
  : TdxServerModeGroupInfoDescriptorsClass;
begin
  Result := TdxServerModeGroupInfoDescriptors;
end;

function TdxServerModeCustomDataSource.GetHelperClass
  : TdxServerModeDataSourceCustomHelperClass;
begin
...
function TdxServerModeCustomDataSource.GetOptionsClass
  : TdxServerModeDataSourceOptionsClass;
begin
  Result := Helper.GetOptionsClass;
end;

function TdxServerModeCustomDataSource.GetSortInfoDescriptorsClass
  : TdxServerModeSortInfoDescriptorsClass;
begin
  Result := TdxServerModeSortInfoDescriptors;
end;

function TdxServerModeCustomDataSource.GetQueryBuilderClass
  : TdxServerModeCustomSQLQueryBuilderClass;
begin
...
function TdxServerModeCustomDataSource.GetSummariesClass
  : TdxServerModeSummaryDescriptorsClass;
begin
...
function TdxServerModeCustomDataSource.ExecuteCommand(AResultSet: PDataSet;
  ...
  ASortInfo: TdxServerModeSortInfoDescriptors;
  AGroupInfo: TdxServerModeGroupInfoDescriptors; ATopRecords: Integer;
  ASkipRecords: Integer; ADistinct: Boolean): Boolean;
var
  I: Integer;
  ABuilder: TdxServerModeCustomSQLQueryBuilder;
begin
  ...
  begin
    ...
    try
      ...
      ABuilder.Calculate;
      Result := ExecuteCommand(AResultSet, ABuilder.CommandText,
        ABuilder.Params, ABuilder.ParamCheck);
...
begin
  ABuilder := GetQueryBuilderClass.Create(Self);
  try
    Result := Format(Adapter.GetFieldsRetrieveQueryFormat,
      [ABuilder.GetFromSQLString]);
  finally
    ABuilder.Free;
  end;
end;

procedure TdxServerModeCustomDataSource.FetchKeys(AKeys: TdxServerModeKeyList;
  AWhere: TdxServerModeCriteria; ASortInfo: TdxServerModeSortInfoDescriptors;
  ASkip, ATake: Integer);
var
  ADataSet: TDataSet;
begin
  if ExecuteCommand(@ADataSet, KeyFields, AWhere, ASortInfo, nil, ATake, ASkip,
    False) then
    try
      while not ADataSet.Eof do
      begin
...
procedure TdxServerModeCustomDataSource.FetchRows(ARows: TdxServerModeRowList;
  AWhere: TdxServerModeCriteria; ASortInfo: TdxServerModeSortInfoDescriptors;
  ATopRecords: Integer);
var
  ADataSet: TDataSet;
begin
  if ExecuteCommand(@ADataSet, FieldDescriptors, AWhere, ASortInfo, nil,
    ATopRecords, 0, False) then
    try
      while not ADataSet.Eof do
      begin
...
procedure TdxServerModeCustomDataSource.FetchRowsByKeys
  (ARows: TdxServerModeRowList; AKeys: TdxServerModeKeyList);
var
  ACriteria: TdxServerModeCriteria;
begin
...
function TdxServerModeCustomDataSource.FindFirstKey
  (AWhere: TdxServerModeCriteria; ASearchDown: Boolean): TdxServerModeRow;
var
  ADataSet: TDataSet;
  ASortInfo: TdxServerModeSortInfoDescriptors;
begin
  ...
  try
    if ExecuteCommand(@ADataSet, KeyFields, AWhere, ASortInfo, nil, 1, 0, False)
    then
      try
...
function TdxServerModeCustomDataSource.GetCount
  (ACriteria: TdxServerModeCriteria): Integer;
var
  ADataSet: TDataSet;
...
function TdxServerModeCustomDataSource.GetFetchRowByIndexCondition
  (ARowIndex: Integer): TdxServerModeCriteria;
var
...
function TdxServerModeCustomDataSource.GetFetchRowByKeyCondition
  (AKey: TdxServerModeRow): TdxServerModeCriteria;
var
  I: Integer;
begin
  Result := CreateCriteria;
...
function TdxServerModeCustomDataSource.GetFetchRowsByKeysCondition
  (AKeys: TdxServerModeKeyList): TdxServerModeCriteria;
var
  I, J: Integer;
...
procedure TdxServerModeCustomDataSource.DoPopulateKeyFields(AList: TStrings);
begin
  // do nothing
end;

function TdxServerModeCustomDataSource.PrepareChildren
  (AGroupWhere: TdxServerModeCriteria;
  AGroupByDescriptor: TdxServerModeSortInfoDescriptor;
  ASummaries: TdxServerModeSummaryDescriptors): TdxServerModeGroupInfoDataList;

  procedure PopulateChildren(var AList: TdxServerModeGroupInfoDataList;
    ADataSet: TDataSet; ASummaryCount: Integer);
  var
    ARow: TdxServerModeRow;
    I, ACount: Integer;
    AGroupValue: Variant;
...
begin
  ...
  try
    ...
    ASortInfo := TdxServerModeSortInfoDescriptors.Create(Self);
    try
      AGroupLevelSorted := ASummaries.IsGroupLevelSorted
        (AGroupByDescriptor.Index);
      ...
      begin
        if (ASummaries[I].Sorted) and (ASummaries[I].Kind <> skNone) and
          ...
          (AGroupLevelSorted and (ASummaries[I].GroupLevel = AGroupByDescriptor.
          Index))) then
        begin
      ...
      try
        ...
        try
          try
            AExecuted := ExecuteCommand(@ADataSet, AFields, AGroupWhere,
              ASortInfo, AGroups, 0, 0, False);
          except
            AFields.Clear;
            AFields.AddItem(TdxServerModeSummaryDescriptor.Create(skCount));
            AFields.CreateLink(AGroupByDescriptor);
...
begin
  ...
  try
    ...
    try
      try
        AExecuted := ExecuteCommand(@ADataSet, AFields, GeneralFilter, nil, nil,
          0, 0, False);
      except
        AFields.Clear;
        AFields.AddItem(TdxServerModeSummaryDescriptor.Create(skCount));
...
procedure TdxServerModeCustomDataSource.Change
  (AChanges: TdxServerModeDataSourceChanges);
begin
  FChanges := FChanges + AChanges;
  Changed;
end;
...
procedure TdxServerModeCustomDataSource.UpdateFieldIndex
...
procedure TdxServerModeCustomDataSource.MakeCriteriaWithBetweenOperator
  ...
  procedure AddKeys(const AKeyField: TdxServerModeFieldDescriptor;
    const AKeyValues: TVariantArray);
  var
    AKeyValue: Variant;
  begin
...
procedure TdxServerModeCustomDataSource.ConnectionChangedHandler
  (Sender: TObject; Connecting: Boolean);
begin
...
procedure TdxServerModeCustomDataSource.SortInfoChangedHandler
  (Sender: TdxServerModeDescriptors; AItem: TdxServerModeDescriptor;
  AChanges: TdxServerModeDescriptorChanges);
begin
...
procedure TdxServerModeCustomDataSource.SummariesChangedHandler
  (Sender: TdxServerModeDescriptors; AItem: TdxServerModeDescriptor;
  AChanges: TdxServerModeDescriptorChanges);
begin
  if (dctSorting in AChanges) or
    (TdxServerModeSummaryDescriptor(AItem).Sorted and
    ([dctLink, dctSummaryKind] * AChanges <> [])) then
    Include(FChanges, ctSortingSummaries);
  Include(FChanges, ctSummaries);
  Changed;
end;

procedure TdxServerModeCustomDataSource.TotalSummariesChangedHandler
  (Sender: TdxServerModeDescriptors; AItem: TdxServerModeDescriptor;
  AChanges: TdxServerModeDescriptorChanges);
begin
...
function TdxServerModeCustomDataSource.
  GetDataControllerUnderscoreWildcard: Char;
begin
  if DataController <> nil then
...
function TdxServerModeCustomDataSource.GetAdapter
  : TdxServerModeCustomSQLAdapter;
begin
  CheckSQLAdapter;
  Result := SQLAdapter;
...
begin
  if not IsLocked and Assigned(DataController) and not DataController.DataChangedNotifyLocked
  then
...
begin
  ...
  begin
    ...
    begin
      ...
      TCustomConnectionAccess(Connection).RegisterClient(Self,
...
procedure TdxServerModeCustomDataSource.SetOptions
  (Value: TdxServerModeDataSourceOptions);
begin
...
begin
  ...
  begin
    with dxGetServerModeSQLAdapters do
      SQLAdapterClass := TdxServerModeCustomSQLAdapterClass
...
begin
  ...
  try
    ABuilder.Criteria := ACriteria;
    ABuilder.Calculate;
    ExecuteCommand(nil, ABuilder.CommandText, ABuilder.Params,
      ABuilder.ParamCheck);
  finally
    ABuilder.Free;
  end;
...
function TdxServerModeDataSource.PostEditingData(ARowIndex: Integer;
  const AEditingRow: Variant): Variant;
var
  ABuilder: TdxServerModeCustomSQLQueryBuilder;
  ACriteria: TdxServerModeCriteria;
...
begin
  ...
  try
    ...
    try
      ...
      else if not VarIsEmpty(AKey) then
        Result := AKey;
      ABuilder.Criteria := ACriteria;
    ...
    if Adapter.CanIdentifyInsertingRow then
    begin
      if ExecuteCommand(@ADataSet, ABuilder.CommandText, ABuilder.Params,
        ABuilder.ParamCheck) then
        try
          if not ADataSet.Eof then
            Result := dxCreateServerModeRow(ADataSet.Fields);
        finally
...
function TdxServerModeDataField.CanModify(AEditValueSource
...
procedure TdxServerModeDataField.RemoveField(ADataField
  : TdxServerModeDataField);
begin
  if FFields <> nil then
...
function TdxServerModeDataField.SetEditingData(ARecordIndex: Integer;
  const AValue: Variant): Boolean;
begin
  FModified := (FieldIndex > -1) and Provider.SetEditingData(ARecordIndex,
    FieldIndex, AValue);
  Result := FModified;
end;

procedure TdxServerModeDataField.SetPropertiesByField(AField: TField;
  AFieldChanged: Boolean);
var
...
begin
  ...
  repeat
    if not IsInternal then
      ATextStored := IsFieldFormatted(AField,
    ...
    AValueTypeClassChanged := (ValueTypeClass <> AValueTypeClass) or
...
function TdxServerModeDataField.GetFieldItem(Index: Integer)
  : TdxServerModeDataField;
begin
  if Assigned(ReferenceField) then
...
function TdxServerModeSummaryItem.GetServerModeDataController
  : TdxServerModeDataController;
begin
  Result := inherited DataController as TdxServerModeDataController;
end;
...
begin
  Result := not DataController.Active or DataController.IsLoading or
    (DataField = nil) or
...
begin
  ...
  if (DataField <> nil) and (DataController.Fields[DataField.Index].Field <> nil)
  then
...
procedure TdxServerModeDataSummary.UpdateGroupSummary
  (AParentGroup: TdxServerModeDataGroupInfo = nil);
var
...
begin
  ...
  begin
    ...
    if ((AParentGroup <> nil) and (ADataGroupInfo.ParentGroup <> AParentGroup))
      or (ADataGroupInfo.ServerGroupInfo = nil) then
      Continue;
    ALevel := ADataGroupInfo.Level;
    for ALevelGroupedIndex := 0 to ADataGroups.GetLevelGroupedFieldCount
      (ALevel) - 1 do
    begin
...
procedure TdxServerModeDataSummary.CalculateSummary(ASummaryItems
  : TcxDataSummaryItems; ABeginIndex, AEndIndex: Integer;
  var ACountValues: TcxDataSummaryCountValues;
  var ASummaryValues: TcxDataSummaryValues);
begin
  if (DataController.DataSource <> nil) and DataController.DataSource.Active and
    ...
    PopulateSummary(ASummaryItems,
      DataController.DataSource.Cache.GetTotalSummary, ACountValues,
      ASummaryValues);
end;

function TdxServerModeDataSummary.GetDataController
  : TdxServerModeDataController;
begin
  Result := TdxServerModeDataController(inherited DataController);
end;

procedure TdxServerModeDataSummary.PopulateSummary(ASummaryItems
  : TcxDataSummaryItems; AValues: TdxServerModeSummaryList;
  var ACountValues: TcxDataSummaryCountValues;
  var ASummaryValues: TcxDataSummaryValues);
var
  I: Integer;
...
constructor TdxCustomServerModeDataProvider.Create(ADataController
...
begin
  ...
  try
    ...
    SetChanging;
    // Update Navigator
    if DataController.UseNewItemRowForEditing and DataController.NewItemRowFocused
    then
...
function TdxCustomServerModeDataProvider.CanModify: Boolean;
  ...
  begin
    ...
    Result := (AGroupCount = 0) or (AGroupCount > 0) and
      (DataController.RecordCount > 0);
  end;

begin
  Result := DataController.Active and DataController.DataSource.CanModify and
    CanGetGroupValue;
end;
...
procedure TdxCustomServerModeDataProvider.DeleteRecords
  (ACriteria: TdxServerModeCriteria);
begin
  ...
  try
    ...
    try
      ...
      begin
        ...
        // It's Group Row
          ACriteria.OrCriteria(DataController.Groups.GetCriteria
            (ARowIndex), True)
        else
          AKeys.Add(DataSource.Cache.GetRowKey(ARowInfo.RecordIndex));
      end;
      if AKeys.Count > 0 then
        ACriteria.OrCriteria(DataSource.GetFetchRowsByKeysCondition
          (AKeys), True);
      DeleteRecords(ACriteria);
    finally
      AKeys.Free;
...
procedure TdxCustomServerModeDataProvider.DoInsertingRecord
  (AIsAppending: Boolean);
begin
...
begin
  if IsUnboundColumnMode then
    inherited Edit
  else if Assigned(DataSource) and not IsEditing then
  begin
...
function TdxCustomServerModeDataProvider.GetCustomDataSource
  : TdxServerModeProviderDataSource;
begin
  Result := TdxServerModeProviderDataSource(inherited CustomDataSource);
end;

function TdxCustomServerModeDataProvider.GetDataController
  : TdxServerModeDataController;
begin
  Result := TdxServerModeDataController(inherited DataController);
end;

function TdxCustomServerModeDataProvider.GetDataSource
  : TdxServerModeCustomDataSource;
begin
...
function TdxCustomServerModeDataProvider.SetEditingData(ARecordIndex,
  AFieldIndex: Integer; const AValue: Variant): Boolean;
begin
...
function TdxCustomServerModeDataProvider.GetRowIndexByKey
  (AKey: Variant): Integer;
begin
  if DataSource = nil then
    Result := -1
  else if IsInserting and VarEquals(AKey, GetEditingRowKey) then
    Result := EditingRecordIndex
  else
    Result := DataSource.Cache.GetRowIndexByKey(AKey);
end;

function TdxCustomServerModeDataProvider.GetRowKey(ARecordIndex
  : Integer): Variant;
begin
...
function TdxCustomServerModeDataProvider.GetServerRowValue(ARecordIndex,
  AFieldIndex: Integer): Variant;
begin
  if (ARecordIndex = EditingRecordIndex) and
    (IsInserting or (IsEditing and not VarIsEmpty(EditingRow[AFieldIndex])))
  then
    Result := EditingRow[AFieldIndex]
  else if not DataSource.IsConsistentCache then
    Result := Null
  else
  begin
    if IsInserting and (ARecordIndex > EditingRecordIndex) then
...
begin
  ...
  begin
    ...
    try
      ...
      DataController.DataControllerInfo.FChanges :=
        DataController.DataControllerInfo.FChanges + [dcicFocusedRow, dcicLoad,
        dcicGrouping, dcicSummary];
      ResetEditing;
    finally
      DataController.UnlockStateInfo;
    end;
...
function TdxServerModeProviderDataSource.GetRecordHandleByIndex
  (ARecordIndex: Integer): TcxDataRecordHandle;
begin
  Result := TcxDataRecordHandle(ARecordIndex);
end;

function TdxServerModeProviderDataSource.GetDataController
  : TdxServerModeDataController;
begin
  Result := TdxServerModeDataController(inherited DataController);
end;

function TdxServerModeProviderDataSource.GetProvider
  : TdxCustomServerModeDataProvider;
begin
...
constructor TdxServerModeDataFocusingInfo.Create(ADataControllerInfo
...
procedure TdxServerModeDataFocusingInfo.Assign(AFocusingInfo
  : TcxDataFocusingInfo);
begin
...
function TdxServerModeDataFocusingInfo.GetDataControllerInfo
  : TdxServerModeDataControllerInfo;
begin
  Result := TdxServerModeDataControllerInfo(inherited DataControllerInfo);
end;

function TdxServerModeDataFocusingInfo.IsEqual(AFocusingInfo
  : TcxDataFocusingInfo): Boolean;
var
  AServerModeFocusingInfo: TdxServerModeDataFocusingInfo absolute AFocusingInfo;
begin
  Result := (Level = AServerModeFocusingInfo.Level) and
    (IsGroupKey = AServerModeFocusingInfo.IsGroupKey) and
    VarEquals(Key, AServerModeFocusingInfo.Key);
  if Result and (dcicSorting in DataControllerInfo.Changes) and
    (RowIndex <> AServerModeFocusingInfo.RowIndex) then
    Result := False;
end;
...
constructor TdxServerModeDataGroupInfo.Create(AOwner: TcxDataGroups;
  AParentGroup: TdxServerModeDataGroupInfo;
  AServerGroupInfo: TdxServerModeGroupInfo);
begin
  inherited Create(AOwner);
  ...
  LastRecordListIndex := FirstRecordListIndex +
    AServerGroupInfo.DataRowCount - 1;
end;
...
procedure TdxServerModeDataGroupInfo.AdjustByInsertingRecord
  (ARecordIndex: Integer; AAppending: Boolean);
begin
  ...
  else if ARecordIndex <= LastRecordListIndex then
    Inc(LastRecordListIndex)
  else if AAppending and (ARecordIndex = LastRecordListIndex + 1) then
    Inc(LastRecordListIndex);
end;
...
procedure TdxServerModeDataGroupInfo.ServerGroupInfoDestroyHandler
  (Sender: TObject);
begin
  FServerGroupInfo := nil;
end;

procedure TdxServerModeDataGroupInfo.SetServerGroupInfo
  (const Value: TdxServerModeGroupInfo);
begin
...
procedure TdxServerModeDataGroups.ChangeExpanding(ARowIndex: Integer;
...
procedure TdxServerModeDataGroups.CreateGroup(AList: TdxServerModeGroupInfoList;
  AParentGroup: TdxServerModeDataGroupInfo);
var
  ALastLevel: Boolean;
  AGroup: TdxServerModeDataGroupInfo;
  AGroupInfo: TdxServerModeGroupInfo;
  I, AParentIndex, ALastChildGroupIndex,
    AGroupCountBeforeRequestChildren: Integer;
begin
  if AParentGroup = nil then
  ...
  begin
    ...
    begin
      ...
      Inc(ALastChildGroupIndex, FItems.Count -
        AGroupCountBeforeRequestChildren);
    end;
  end;
end;
...
function TdxServerModeDataGroups.GetChildIndex(AParentIndex,
...
function TdxServerModeDataGroups.GetDataControllerInfo
  : TdxServerModeDataControllerInfo;
begin
  Result := TdxServerModeDataControllerInfo(inherited DataControllerInfo);
end;

function TdxServerModeDataGroups.GetItem(Index: Integer)
  : TdxServerModeDataGroupInfo;
begin
...
function TdxServerModeDataGroups.FindByServerGroupInfo(const AServerGroupInfo
  : TdxServerModeGroupInfo): Integer;
var
  I: Integer;
begin
...
function TdxServerModeDataGroups.FindInnerGroup(ARecordListIndex
  : Integer): Integer;
...
function TdxServerModeDataGroups.GetFirstDataRecordListIndex
  (AInfo: TcxDataGroupInfo): Integer;
begin
  Result := AInfo.FirstRecordListIndex;
end;

function TdxServerModeDataGroups.GetLastDataRecordListIndex
  (AInfo: TcxDataGroupInfo): Integer;
begin
  Result := AInfo.LastRecordListIndex;
end;

function TdxServerModeDataGroups.GetRowIndexByGroupValue(const AGroupValue
  : Variant): Integer;
var
...
begin
  Result := -1;
  AStartIndex := 0;
  for AGroupLevel := VarArrayLowBound(AGroupValue, 1)
    to VarArrayHighBound(AGroupValue, 1) do
  begin
    ...
    begin
      with Items[I] do
        if (Level = AGroupLevel) and IsEqual(ALevelGroupValue, AGroupValueHash)
        then
        begin
          Result := RowIndex;
          AStartIndex := I + 1;
...
function TdxServerModeDataGroups.MakeVisible(AIndex: Integer;
...
procedure TdxServerModeDataGroups.RequestChildren(AParentGroup
  : TdxServerModeDataGroupInfo);
var
  AList: TdxServerModeGroupInfoList;
begin
  if AParentGroup.ChildrenIsReady then
    Exit;
  AList := DataControllerInfo.Source.GetGroupInfoList
    (AParentGroup.ServerGroupInfo);
  if AList.Empty then
    Exit;
...
procedure TdxServerModeDataGroups.UpdateGroupSummary(AParentGroup
  : TdxServerModeDataGroupInfo);
begin
...
function TdxServerModeDataSelection.GetDataController
  : TdxServerModeDataController;
begin
  Result := TdxServerModeDataController(inherited DataController);
end;
...
constructor TdxServerModeDataControllerInfo.Create(ADataController
  : TcxCustomDataController);
begin
  inherited Create(ADataController);
...
procedure TdxServerModeDataControllerInfo.ConvertFilterItems
  (ADestination: TdxServerModeCriteria; ASource: TcxFilterCriteria);

  procedure ConvertItems(ADestinationList: TdxServerModeCriteriaItemList;
    ASourceList: TcxFilterCriteriaItemList);
  var
    I: Integer;
    AField: TdxServerModeDataField;
  ...
  begin
    ...
    for I := 0 to ASourceList.Count - 1 do
      ...
      begin
        ConvertItems(ADestinationList.AddItemList(TcxFilterCriteriaItemList
          (ASourceList[I]).BoolOperatorKind) as TdxServerModeCriteriaItemList,
      ...
      begin
        ...
        if AField.Field <> nil then
          ADestination.AddItem(ADestinationList,
            DataSource.FieldDescriptors.ItemByField(AField.Field),
...
procedure TdxServerModeDataControllerInfo.ConvertFindCriteria
  (ADestination: TdxServerModeFindCriteria;
  ASource: TdxServerModeDataFindCriteria);
begin
...
function TdxServerModeDataControllerInfo.CreateFindCriteria
  : TdxServerModeFindCriteria;
begin
...
function TdxServerModeDataControllerInfo.CreateSortInfo
  : TdxServerModeSortInfoDescriptors;
var
  I: Integer;
...
begin
  ...
  begin
    AItem := Result.Add(TdxServerModeDataField(TotalSortingFieldList.Items[I]
      .Field).FieldName, TotalSortingFieldList.Items[I]
      .SortOrder = soDescending);
    DataController.InitializeDescriptor(TotalSortingFieldList.Items[I]
      .Field, AItem);
  end;
end;

function TdxServerModeDataControllerInfo.CreateSummariesByItems
  (AItems: TcxDataSummaryItems; ALevel: Integer)
  : TdxServerModeSummaryDescriptors;
begin
...
function TdxServerModeDataControllerInfo.CreateTotalSummaries
  : TdxServerModeSummaryDescriptors;
begin
  Result := CreateSummariesByItems
    (DataController.Summary.FooterSummaryItems, -1);
end;

function TdxServerModeDataControllerInfo.CreateGroupSummaries
  : TdxServerModeSummaryDescriptors;
var
  ALevel: Integer;
...
begin
  Result := CreateSummariesByItems
    (DataController.Summary.DefaultGroupSummaryItems, -1);
  ASummaryGroups := DataController.Summary.SummaryGroups;
  for ALevel := 0 to DataController.DataControllerInfo.GroupingFieldList.
    Count - 1 do
  begin
    ASummaryGroup := ASummaryGroups.FindByItemLink
      (DataController.DataControllerInfo.GroupingFieldList[ALevel].Field.Item);
    if ASummaryGroup <> nil then
      PopulateSummariesByItems(Result, ASummaryGroup.SummaryItems, ALevel);
  end;
end;

function TdxServerModeDataControllerInfo.GetDataController
  : TdxServerModeDataController;
begin
  Result := TdxServerModeDataController(inherited DataController);
end;
...
function TdxServerModeDataControllerInfo.GetSelection
  : TdxServerModeDataSelection;
begin
...
function TdxServerModeDataControllerInfo.GetDataFocusingInfoClass
...
function TdxServerModeDataControllerInfo.GetDataSource
  : TdxServerModeCustomDataSource;
begin
  Result := DataController.DataSource;
end;

function TdxServerModeDataControllerInfo.GetFocusingInfo
  : TdxServerModeDataFocusingInfo;
begin
  Result := TdxServerModeDataFocusingInfo(inherited FocusingInfo);
end;

procedure TdxServerModeDataControllerInfo.PopulateSummariesByItems
  (AList: TdxServerModeSummaryDescriptors; AItems: TcxDataSummaryItems;
  ALevel: Integer);
var
  I: Integer;
...
begin
  ...
  begin
    ...
    if not ASummary.IsDataBinded then
      Continue;
    AItem := TdxServerModeSummaryDescriptor
      (AList.CreateLink(DataController.DataSource.FieldDescriptors.ItemByField
      (ASummary.ServerModeDataField.Field)));
...
begin
  Result := IsDataSourceValid and DataSource.Active and
...
var
  ...
  begin
    Result := (eisExpanded in AExpandingInfo.State) and
      (eisExpanded in ExpandingInfo.SaveStates)
  end;
  ...
  begin
    ...
    begin
      while (AExpandingInfoIndex < ExpandingInfo.Count) and
        (ExpandingInfo[AExpandingInfoIndex].GroupIndex >
        AParentGroupInfo.Level) do
        Inc(AExpandingInfoIndex);
      Exit;
    end;
    ...
    begin
      ...
      if GroupNeedsRestoration(AExpandingInfo) and
        (AExpandingInfo.GroupIndex > AParentGroupInfo.Level) then
  ...
  begin
    ...
    begin
      AExpandingInfo := ExpandingInfo[AExpandingInfoIndex];
      if GroupNeedsRestoration(AExpandingInfo) and
        (AExpandingInfo.GroupIndex = 0) then
...
begin
  ...
  if (dcicFocusedRow in Changes) and (PrevFocusingInfo.RowIndex >= GetRowCount)
  then
...
function TdxServerModeDataControllerInfo.FindDataGroup(ARecordListIndex
  : Integer): Integer;
begin
...
begin
  ...
  else if DataController.RecordCount > 0 then
    Result := 0
  else
    Result := -1;
end;

function TdxServerModeDataControllerInfo.FindFocusedRow
...
function TdxServerModeDataControllerInfo.
  GetRecordListIndexByFocusingInfo: Integer;
begin
  if FocusingInfo.IsUndefined then
    Result := -1
  else
...
function TdxServerModeDataControllerInfo.LocateDetail(AGroupIndex,
  ARecordListIndex: Integer; AMakeVisible: Boolean): Integer;
begin
  Result := inherited LocateDetail(AGroupIndex, ARecordListIndex, AMakeVisible);
end;

function TdxServerModeDataControllerInfo.LocateGroupByLevel(AGroupIndex,
...
begin
  repeat
    ...
    if (AParentGroupIndex <> -1) and
      (DataGroups[AParentGroupIndex].FirstRecordListIndex = DataGroups
      [AGroupIndex].FirstRecordListIndex) then
...
procedure TdxServerModeDataControllerInfo.SaveExpanding
  ...
  procedure AddGroup(ADataGroupInfo: TdxServerModeDataGroupInfo;
    AGroupIndex: Integer; AExpanded: Boolean);
  var
    ARecordIndex: Integer;
  ...
  begin
    ...
    begin
      ...
      if AStateSet <> [] then
        ExpandingInfo.AddItem(ADataGroupInfo.Level, ADataGroupInfo.GroupValue,
          AStateSet);
    end;
  end;
...
begin
  Result := IsDataSourceValid and
    ([dcicLoad, dcicGrouping, dcicSorting, dcicSummary, dcicView] *
    Changes <> []);
end;
      ...
      try
        ...
        try
          ...
          try
            ...
            try
              DataController.DataSource.Apply(ACriteria, AFindCriteria,
                ASortInfo, GroupingFieldList.Count, ASummaries,
                ATotalSummaries);
            finally
...
function TdxServerModeDataControllerInfo.GetRowInfo(ARowIndex: Integer)
  : TcxRowInfo;
var
...
procedure TdxServerModeDataControllerInfo.RemoveField
...
function TdxServerModeDataControllerSearch.DoSearch(AStartFilteredRecordIndex,
  AEndFilteredRecordIndex: Integer; const ASubText: string;
  AForward, AIsAnywhere: Boolean): Integer;
begin
  Result := DataController.DataSource.FindIncremental
    (DataController.Fields[ItemIndex].FieldName, ASubText,
    AStartFilteredRecordIndex, AForward, AIsAnywhere);
end;

function TdxServerModeDataControllerSearch.GetDataController
  : TdxServerModeDataController;
begin
  Result := TdxServerModeDataController(inherited DataController);
end;
...
function TdxServerModeDataControllerGroups.GetCriteria(ARowIndex: Integer)
  : TdxServerModeCriteria;
var
  AIndex: Integer;
  AServerGroupInfo: TdxServerModeGroupInfo;
begin
  ...
  AServerGroupInfo := TdxServerModeDataGroupInfo(DataGroups[AIndex])
    .ServerGroupInfo;
  Result := DataController.DataSource.Cache.GetGroupWhere(AServerGroupInfo);
end;

function TdxServerModeDataControllerGroups.GetGroupDisplayText(ADataGroupIndex
  : TcxDataGroupIndex): string;
begin
  Result := TdxServerModeDataGroupInfo(DataGroups[ADataGroupIndex]).DisplayText;
end;

function TdxServerModeDataControllerGroups.GetGroupValue(ADataGroupIndex
  : TcxDataGroupIndex): Variant;
begin
  Result := TdxServerModeDataGroupInfo(DataGroups[ADataGroupIndex]).GroupValue;
end;

function TdxServerModeDataControllerGroups.GetDataController
  : TdxServerModeDataController;
begin
  Result := TdxServerModeDataController(inherited DataController);
end;
...
function TdxServerModeDataFilterCriteriaItem.GetFilterOperatorClass
  : TcxFilterOperatorClass;
const
  ANullOperatorClasses: array [Boolean] of TcxFilterOperatorClass =
    (TcxFilterSQLNullOperator, TcxFilterSQLNotNullOperator);
...
function TdxServerModeDataFilterCriteria.GetItemClass
...
begin
  Result := DataController.DataSource.Adapter.MakeEscapedValue(AText,
    not UseExtendedSyntax, not UseExtendedSyntax);
end;
...
function TdxServerModeDataFindCriteria.GetDataController
  : TdxServerModeDataController;
begin
  Result := TdxServerModeDataController(inherited DataController);
end;
...
begin
  inherited Create(AOwner);
  FOptions := [sdcoAssignGroupingValues, sdcoKeepFocusedRowOnUpdate,
    sdcoSaveExpanding];
...
function TdxServerModeDataController.CreateDataControllerInfo
  : TcxCustomDataControllerInfo;
begin
  Result := TdxServerModeDataControllerInfo.Create(Self);
end;

procedure TdxServerModeDataController.RemoveNotification
  (AComponent: TComponent);
begin
...
function TdxServerModeDataController.TryFocusRecord(ARecordIndex
  : Integer): Boolean;
begin
...
function TdxServerModeDataController.InternalCheckBookmark(ADeletedRecordIndex
  : Integer): Boolean;
begin
...
begin
  if (Provider.EditingRecordIndex = cxNullEditingRecordIndex)
  { or not Provider.CanModify } then
    Exit;
...
begin
  ...
  Provider.Freeze;
  try
    AGroupIndex := DataControllerInfo.DataGroups.GetIndexByRowIndex
      (ARowInfo.RowIndex);
...
procedure TdxServerModeDataController.InitializeDescriptor
  (AField: TcxCustomDataField; var ADescriptor: TdxServerModeDescriptor);
begin
  // do nothing
end;
...
procedure TdxServerModeDataController.SetOptions(const Value
  : TdxServerModeDataControllerOptions);
begin
...
function TdxServerModeDataController.IsDataSourcePersistentField
  (AField: TField): Boolean;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          if IsEqualFieldNames(ACurrentField.FieldName, ADataField.FieldName)
          then
          begin
    ...
    if (ADataField.ValueTypeClass <> APrevValueTypeClass) and not ADataField.IsInternal
    then
...
procedure TdxServerModeDataController.UpdateInternalField(const AFieldName
  : string; var AField: TdxServerModeDataField);
begin
  if AFieldName = '' then
  begin
    AField.Free;
...
function TdxServerModeDataController.GetDataControllerInfo
  : TdxServerModeDataControllerInfo;
begin
  Result := TdxServerModeDataControllerInfo(inherited DataControllerInfo);
end;
...
procedure TdxServerModeDataController.SetSummary
  (Value: TdxServerModeDataSummary);
begin
  inherited Summary := Value;
end;

function TdxServerModeDataController.GetDataProviderClass
  : TcxCustomDataProviderClass;
begin
  Result := TdxCustomServerModeDataProvider;
end;

function TdxServerModeDataController.GetDataSelectionClass
  : TcxDataSelectionClass;
begin
  Result := TdxServerModeDataSelection;
end;

function TdxServerModeDataController.GetFilterCriteriaClass
  : TcxDataFilterCriteriaClass;
begin
  Result := TdxServerModeDataFilterCriteria;
end;

function TdxServerModeDataController.GetSearchClass
  : TcxDataControllerSearchClass;
begin
...
function TdxServerModeDataController.GetSummaryItemClass
  : TcxDataSummaryItemClass;
begin
...
function TdxServerModeDataController.CanFocusRecord(ARecordIndex
  : Integer): Boolean;
begin
...
begin
  ...
  if (DataSource <> nil) and not DataSource.IsDestroying and
    not Assigned(AField.ReferenceField) then
  begin
    ...
    begin
      ...
      ADataField.SetPropertiesByField(ADataField.Field,
        ADataField.ValueTypeClass <> AValueTypeClass);
    end;
  end;
end;

function TdxServerModeDataController.GetField(Index: Integer)
  : TdxServerModeDataField;
begin
...
function TdxServerModeDataController.GetFieldByFieldName(const AFieldName
  : string): TdxServerModeDataField;
var
  I: Integer;
begin
  Result := nil;
...
function TdxServerModeDataController.GetGroupsClass
  : TcxDataControllerGroupsClass;
begin
...
begin
  Provider.Freeze;
  try
    if (ARecordIndex >= 0) and IsDataField(AField) and
      Assigned(TdxServerModeDataField(AField).ValueDef) then
      try
...
begin
  Result := not GetKeepFocusedRowOnUpdatingSetting and
    (GroupingChangedFlag or SortingChangedFlag or FilteredRecordCountChanged or
    LoadedStorage);
end;
...
procedure TdxServerModeDataController.PopulateFilterValues
...
begin
  if (DataSource <> nil) and (Fields[AItemIndex].Field <> nil) and DataSource.Active
  then
    DataSource.PopulateFilterValues(AList, Fields[AItemIndex].Field, ACriteria,
      AUseFilteredRecords, ANullExists)
  else
    inherited PopulateFilterValues(AList, AItemIndex, ACriteria,
      AUseFilteredRecords, ANullExists, AUniqueOnly,
...
function TdxServerModeDataController.
  GetInsertOnNewItemRowFocusingSetting: Boolean;
begin
  Result := sdcoInsertOnNewItemRowFocusing in Options;
end;

function TdxServerModeDataController.GetKeepFocusedRowOnUpdatingSetting
  : Boolean;
begin
  Result := sdcoKeepFocusedRowOnUpdate in Options;
end;

function TdxServerModeDataController.GetItemByFieldName(const AFieldName
  : string): TObject;
var
  I: Integer;
begin
...
begin
  CheckItemRange(AItemIndex);
  if (Fields[AItemIndex].Field = nil) and (Fields[AItemIndex].FieldName <> '')
  then
...
function TdxServerModeDataController.IsDataField
  (AField: TcxCustomDataField): Boolean;
begin
  Result := (TdxServerModeDataField(AField).Field <> nil) and
    inherited IsDataField(AField);
end;

function TdxServerModeDataController.GetFindCriteria
  : TdxServerModeDataFindCriteria;
begin
  Result := TdxServerModeDataFindCriteria(inherited FindCriteria);
end;

function TdxServerModeDataController.GetGroups
  : TdxServerModeDataControllerGroups;
begin
  Result := TdxServerModeDataControllerGroups(inherited Groups);
end;

function TdxServerModeDataController.GetProvider
  : TdxCustomServerModeDataProvider;
begin
  Result := TdxCustomServerModeDataProvider(inherited Provider);
end;

function TdxServerModeDataController.GetFilterItemFieldName
        ...
        if AField.FieldCount > 0 then
          ...
          begin
            ...
            for I := 1 to AFieldCount - 1 do
              Result := Result + ';' + GetFilterFieldName
                (AField[I].Field, True);
          end
        else
          Result := '';
...
function TdxServerModeDataController.InsertRecord(ARecordIndex
  : Integer): Integer;
begin
  Result := ARecordIndex;
end;
...
begin
  Result := (DataSource <> nil) and
    (DataSource.KeyFields.IndexOf(AField) <> -1);
end;
...
function TdxServerModeDataController.
  MultiSelectionSyncGroupWithChildren: Boolean;
begin
  Result := False;
end;

function TdxServerModeDataController.FindRecordIndexByKey(const AKeyFieldValues
  : Variant): Integer;
begin
  if DataSource <> nil then
...
function TdxServerModeDataController.GetRecordId(ARecordIndex: Integer)
  : Variant;
begin
...
function TdxServerModeDataController.LocateByKey(const AKeyFieldValues
  : Variant): Boolean;
var
