...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Classes, Types, IniFiles, Registry, Windows, Messages, RTLConsts, SysUtils,
  Math, Menus,
  ...
  dxCoreClasses, dxAnimation, dxGdiPlusClasses, cxControls, dxThemeManager,
  cxLookAndFeels,
  cxAccessibility, cxLibraryConsts, dxCustomHint, dxCoreGraphics, cxContainer,
  dxGdiPlusApi,
...
type
  ...
  public
    constructor Create(ANavigationBar
      : TdxNavBarCustomOfficeNavigationBar); virtual;

    property NavigationBar: TdxNavBarCustomOfficeNavigationBar
      read FNavigationBar;
  ...
  protected
    property NavigationBar: TdxNavBarCustomOfficeNavigationBar
      read GetNavigationBar;
  end;

  TdxNavBarOfficeNavigationBarCustomizationButtonVisibility =
    (cbvShowAfterItems, cbvShowBeforeItems, cbvHidden);

  TdxNavBarOfficeNavigationBarOptionsView = class
    (TdxNavBarOfficeNavigationBarPersistent)
  private
    FOrientation: TdxOrientation;
    FCustomizationButtonVisibility
      : TdxNavBarOfficeNavigationBarCustomizationButtonVisibility;
    ...
    procedure SetCustomizationButtonVisibility(const Value
      : TdxNavBarOfficeNavigationBarCustomizationButtonVisibility);
  ...
  published
    property CompactNavigation: Boolean read FCompactNavigation
      write SetCompactNavigation default False;
    property CustomizationButtonVisibility
      : TdxNavBarOfficeNavigationBarCustomizationButtonVisibility
      read FCustomizationButtonVisibility write SetCustomizationButtonVisibility
      default cbvShowAfterItems;
    property DrawParentBackground: Boolean read FDrawParentBackground
      write SetDrawParentBackground default True;
    property ItemAlignment: TcxAlignment read FItemAlignment
      write SetItemAlignment;
    property ItemSpacing: Integer read FItemSpacing write SetItemSpacing
      default 4;
    property MaxVisibleItemCount: Integer read FMaxVisibleItemCount
      write SetMaxVisibleItemCount default 0;
    property Orientation: TdxOrientation read FOrientation write SetOrientation
      default orHorizontal;
    property Paddings: TcxMargin read FPaddings write SetPaddings;
    property ShowItemsAsButtons: Boolean read FShowItemsAsButtons
      write SetShowItemsAsButtons default False;
  end;

  TdxNavBarOfficeNavigationBarOptionsBehavior = class
    (TdxNavBarOfficeNavigationBarPersistent)
  private
  ...
  published
    ...
    property ShowPeekFormOnItemHover: Boolean read FShowPeekFormOnItemHover
      write FShowPeekFormOnItemHover default True;
  end;

  { TdxNavBarOfficeNavigationBarCustomViewInfo }

  TdxNavBarOfficeNavigationBarCustomViewInfo = class
  ...
  public
    ...
    property Controller: TdxNavBarOfficeNavigationBarController
      read GetController;
  ...
  TdxNavBarOfficeNavigationBarCustomItemViewInfo = class
    (TdxNavBarOfficeNavigationBarCustomViewInfo)
  private
    FIsDragging: Boolean;
  ...
  protected
    ...
    function DoCalculateRequiredSize(const AAvailableSize: TSize)
      : TSize; virtual;
  ...
  public
    constructor Create(ANavigationBar
      : TdxNavBarCustomOfficeNavigationBar); override;
    destructor Destroy; override;
  ...
  TdxNavBarOfficeNavigationBarItemViewInfo = class
    (TdxNavBarOfficeNavigationBarCustomItemViewInfo)
  private const
    MoveAnimationTime = 100;
    MoveAnimationTransitionEffect
      : TdxAnimationTransitionEffect = ateAccelerateDecelerate;
    PressedAnimationTime = 100;
    PressedAnimationFrameCount = 100;
    PressedAnimationScaleFactor = 0.9;
    PressedImageScaleFactor = PressedAnimationFrameCount /
      (1 - PressedAnimationScaleFactor);
    PressedAnimationTransitionEffect
      : TdxAnimationTransitionEffect = ateAccelerateDecelerate;
  private
  ...
  public
    constructor Create(ANavigationBar: TdxNavBarCustomOfficeNavigationBar;
      AItem: TObject); reintroduce; virtual;
    destructor Destroy; override;
  ...
  TdxNavBarOfficeNavigationBarItemsViewInfo = class
    (TdxNavBarOfficeNavigationBarCustomItemViewInfo)
  private
  ...
  protected
    function CreateItemInfo(AItem: TObject)
      : TdxNavBarOfficeNavigationBarItemViewInfo; virtual;
  ...
  TdxNavBarOfficeNavigationBarCustomizationButtonViewInfo = class
    (TdxNavBarOfficeNavigationBarCustomItemViewInfo)
  protected
    function DoCalculateRequiredSize(const AAvailableSize: TSize)
      : TSize; override;
  ...
  TdxNavBarOfficeNavigationBarDragItemViewInfo = class
    (TdxNavBarOfficeNavigationBarCustomViewInfo)
  private
    ...
    FDragOffset: TPoint;
    procedure DoAnimate(Sender: TdxAnimationTransition; var APosition: Integer;
      var AFinished: Boolean);
  protected
    procedure DoEndDragAnimation;
  public
    constructor Create(ANavigationBar: TdxNavBarCustomOfficeNavigationBar;
      ADraggedItem: TdxNavBarOfficeNavigationBarCustomItemViewInfo;
      const ADragPoint: TPoint); reintroduce; virtual;
    destructor Destroy; override;
  ...
  TdxNavBarOfficeNavigationBarViewInfo = class
    (TdxNavBarOfficeNavigationBarCustomItemViewInfo)
  private
    FCustomizationButtonViewInfo
  ...
  protected
    function CreateCustomizationButtonInfo
      : TdxNavBarOfficeNavigationBarCustomizationButtonViewInfo; virtual;
    function CreateItemsInfo
      : TdxNavBarOfficeNavigationBarItemsViewInfo; virtual;
  ...
  public
    ...
    procedure CreateDragItem(ADraggedItem
      : TdxNavBarOfficeNavigationBarCustomItemViewInfo;
      const ADragPoint: TPoint);
  ...
  TdxNavBarOfficeNavigationBarHitTest = class
    (TdxNavBarOfficeNavigationBarSubclass)
  private
  ...
  public
    ...
    property HitAtCustomizationButton: Boolean index nbhtCustomizationButton
      read GetBitState;
    property HitObject: TdxNavBarOfficeNavigationBarCustomItemViewInfo
      read FHitObject write FHitObject;
  ...
  private type
    ...
    public
      ...
      destructor Destroy; override;
      procedure Check(AHotElement
        : TdxNavBarOfficeNavigationBarCustomItemViewInfo);
      procedure ElementDestroying(AElement
        : TdxNavBarOfficeNavigationBarCustomItemViewInfo);
      procedure Hide;
  ...
  private
    ...
    procedure SetHotElement(const Value
      : TdxNavBarOfficeNavigationBarCustomItemViewInfo);
    procedure SetPressedElement(const Value
      : TdxNavBarOfficeNavigationBarCustomItemViewInfo);
    procedure HidePeekForm;
    function CanShowPeekForm: Boolean;
    procedure DoShowPeekForm(AItemInfo
      : TdxNavBarOfficeNavigationBarCustomItemViewInfo;
  ...
  protected
    ...
    function IsDragged(AItem
      : TdxNavBarOfficeNavigationBarCustomItemViewInfo): Boolean;
    function StartDragAndDrop(const P: TPoint): Boolean;

    property DragItemInfo: TdxNavBarOfficeNavigationBarCustomItemViewInfo
      read FDragItemInfo;
    property HotElement: TdxNavBarOfficeNavigationBarCustomItemViewInfo
      read FHotElement write SetHotElement;
    property PressedElement: TdxNavBarOfficeNavigationBarCustomItemViewInfo
  ...
  TdxNavBarOfficeNavigationBarItem = class(TcxInterfacedCollectionItem,
    IdxNavigationItem)
  private
    FText: string;
    FVisible: Boolean;
  ...
  private type
    TNavigationItemEnumerator = class(TInterfacedObject,
      IEnumerator<IdxNavigationItem>, IEnumerator)
    private
      FIndex: Integer;
    ...
    public
      ...
      function IEnumerator<IdxNavigationItem>.GetCurrent =
  ...
  protected
    ...
    function IEnumerable<IdxNavigationItem>.GetEnumerator =
      GetNavigationItemEnumerator;
  ...
  public
    ...
    property Items[Index: Integer]: TdxNavBarOfficeNavigationBarItem
      read GetItem write SetItem; default;
    property SelectedItem: TdxNavBarOfficeNavigationBarItem read FSelectedItem
  ...
  TdxNavBarCustomOfficeNavigationBar = class(TcxControl, IdxSkinSupport,
  ...
  private
    ...
    procedure SetOptionsBehavior(const Value
      : TdxNavBarOfficeNavigationBarOptionsBehavior);
    procedure SetOptionsView(const Value
  ...
  protected
    ...
    function CreateOptionsBehavior
      : TdxNavBarOfficeNavigationBarOptionsBehavior; virtual;
    function CreateOptionsView
      : TdxNavBarOfficeNavigationBarOptionsView; virtual;
    ...
    procedure DoShowPeekForm(AItem: IdxNavigationItem;
      var AControl: TWinControl);
  ...
  public
    ...
    property Items: TdxNavBarOfficeNavigationBarItems read FItems
      write SetItems;
    property ItemProvider: TComponent read FItemProvider write SetItemProvider;
    property OptionsBehavior: TdxNavBarOfficeNavigationBarOptionsBehavior
      read FOptionsBehavior write SetOptionsBehavior;
    property OptionsView: TdxNavBarOfficeNavigationBarOptionsView
      read FOptionsView write SetOptionsView;
    ...
    property OnQueryPeekFormContent
      : TdxNavBarOfficeNavigationBarQueryPeekFormContent
      read FOnQueryPeekFormContent write FOnQueryPeekFormContent;
    property OnSelectionChanged: TNotifyEvent read FOnSelectionChanged
      write FOnSelectionChanged;
    property OnSelectionChanging: TdxNavBarOfficeNavigationBarSelectionChanging
...
constructor TdxNavBarOfficeNavigationBarSubclass.Create(ANavigationBar
...
function TdxNavBarOfficeNavigationBarPersistent.GetNavigationBar
  : TdxNavBarCustomOfficeNavigationBar;
begin
  ...
  begin
    ...
    try
      ...
      CustomizationButtonVisibility :=
        ASourceOptions.CustomizationButtonVisibility;
...
procedure TdxNavBarOfficeNavigationBarOptionsView.PaddingsChanged
  (Sender: TObject);
begin
  Changed;
end;
...
procedure TdxNavBarOfficeNavigationBarOptionsView.
  SetCustomizationButtonVisibility(const Value
  : TdxNavBarOfficeNavigationBarCustomizationButtonVisibility);
begin
...
function TdxNavBarOfficeNavigationBarCustomViewInfo.GetController
  : TdxNavBarOfficeNavigationBarController;
begin
  Result := NavigationBar.Controller;
end;

function TdxNavBarOfficeNavigationBarCustomViewInfo.GetPainter
  : TcxCustomLookAndFeelPainter;
begin
  Result := NavigationBar.LookAndFeelPainter;
end;

procedure TdxNavBarOfficeNavigationBarCustomViewInfo.DoRightToLeftConversion
...
procedure TdxNavBarOfficeNavigationBarCustomViewInfo.RightToLeftConversion
  (const AClientBounds: TRect);
begin
...
begin
  ...
  CreateElements;
  FVisibleElements :=
    TList<TdxNavBarOfficeNavigationBarCustomItemViewInfo>.Create;
end;
...
procedure TdxNavBarOfficeNavigationBarCustomItemViewInfo.
  CalculateChildRequiredSizes(const AAvailableSize: TSize);
var
  I: Integer;
begin
...
procedure TdxNavBarOfficeNavigationBarCustomItemViewInfo.CalculateRequiredSize
  (const AAvailableSize: TSize);
begin
...
function TdxNavBarOfficeNavigationBarCustomItemViewInfo.CreateDragImage
  : TdxSmartImage;
var
...
function TdxNavBarOfficeNavigationBarCustomItemViewInfo.DoCalculateRequiredSize
  (const AAvailableSize: TSize): TSize;
begin
  Result := cxNullSize;
end;

procedure TdxNavBarOfficeNavigationBarCustomItemViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
var
  I: Integer;
begin
...
procedure TdxNavBarOfficeNavigationBarCustomItemViewInfo.DoSetIsDragging
  (Value: Boolean);
begin
end;

procedure TdxNavBarOfficeNavigationBarCustomItemViewInfo.DoSetState
...
function TdxNavBarOfficeNavigationBarCustomItemViewInfo.GetDrawState
...
var
  I: Integer;
begin
  Result := (GetHitTestIndex <> nbhtNone) and
    PtInElement((AHitTest as TdxNavBarOfficeNavigationBarHitTest).HitPoint);
  if Result then
    SetHitTest(AHitTest);
...
function TdxNavBarOfficeNavigationBarCustomItemViewInfo.GetHitTestIndex
  : Integer;
begin
  Result := nbhtNone;
end;
...
procedure TdxNavBarOfficeNavigationBarCustomItemViewInfo.DoPaintDragImage
  (ACanvas: TcxCanvas);
begin
end;
...
function TdxNavBarOfficeNavigationBarCustomItemViewInfo.GetTextColor
  : TdxAlphaColor;
begin
  Result := dxColorToAlphaColor(Painter.OfficeNavigationBarItemTextColor
    (GetDrawState));
end;

procedure TdxNavBarOfficeNavigationBarCustomItemViewInfo.SetState
...
constructor TdxNavBarOfficeNavigationBarItemViewInfo.Create(ANavigationBar
  : TdxNavBarCustomOfficeNavigationBar; AItem: TObject);
begin
  inherited Create(ANavigationBar);
  FItem := AItem;
end;
...
function TdxNavBarOfficeNavigationBarItemViewInfo.DoCalculateRequiredSize
  (const AAvailableSize: TSize): TSize;
begin
...
begin
  ...
  FMoveAnimation := TdxAnimationTransition.Create(MoveAnimationTime,
    MoveAnimationTransitionEffect, Abs(FMoveAnimationLength));
...
procedure TdxNavBarOfficeNavigationBarItemViewInfo.DoPaintDragImage
  (ACanvas: TcxCanvas);
...
begin
  if IsButton then
  begin
    Painter.OfficeNavigationBarDrawScaledButtonItemBackground(ACanvas, Bounds,
      GetDrawState, ScaleFactor);
    CorrectDragBitmap;
  end
  else if IsCompact then
  begin
...
procedure TdxNavBarOfficeNavigationBarItemViewInfo.DoRightToLeftConversion
  (const AClientBounds: TRect);
begin
...
procedure TdxNavBarOfficeNavigationBarItemViewInfo.DoSetIsDragging
  (Value: Boolean);
begin
...
procedure TdxNavBarOfficeNavigationBarItemViewInfo.DoSetState
  ...
  begin
    ...
    FPressAnimation := TdxAnimationTransition.Create(ATime,
      PressedAnimationTransitionEffect, ALength);
...
begin
  ...
  begin
    ...
    try
      dxGPGetTextRect(AGpCanvas, FText, NavigationBar.ViewInfo.ItemFont, False,
        cxNullRect, ATextRect);
      if NavigationBar.OptionsView.Orientation = orHorizontal then
...
function TdxNavBarOfficeNavigationBarItemViewInfo.GetDrawState
  : TcxCalendarElementState;
begin
...
begin
  ...
  begin
    ...
    else if NavigationBar.OptionsBehavior.Animation and
      (FPressAnimationActive or (State = cesPressed)) then
    begin
      APressedImageScaleFactor := 1 - (FPressAnimationPosition) /
        PressedImageScaleFactor;
      AWidth := Round(cxRectWidth(Bounds) * APressedImageScaleFactor);
      AHeight := Round(cxRectHeight(Bounds) * APressedImageScaleFactor);
      FPressedItemImage.StretchDraw(ACanvas.Handle, cxRectCenter(Bounds, AWidth,
        AHeight));
    end
    else
    begin
      if IsButton then
        Painter.OfficeNavigationBarDrawScaledButtonItemBackground(ACanvas,
          Bounds, GetDrawState, ScaleFactor)
      else
      begin
        Painter.OfficeNavigationBarDrawScaledItemBackground(ACanvas, Bounds,
          GetDrawState, ScaleFactor);
        if IsCompact then
          DrawImageSelection(ACanvas);
      end;
...
procedure TdxNavBarOfficeNavigationBarItemViewInfo.DoDrawItemText
  ...
  const
    ARendering: array [Boolean] of TdxGpTextRenderingHint =
      (TextRenderingHintSystemDefault, TextRenderingHintAntiAliasGridFit);
  begin
    dxGPDrawText(AGpCanvas, Text, R, NavigationBar.ViewInfo.ItemFont,
      dxColorToAlphaColor(AColor),
      AAlignment[NavigationBar.UseRightToLeftAlignment], taVerticalCenter,
      False, ARendering[IsDragImagePainting], StringTrimmingNone,
      NavigationBar.UseRightToLeftReading);
  end;
...
procedure TdxNavBarOfficeNavigationBarItemViewInfo.DoPressAnimate
  (Sender: TdxAnimationTransition; var APosition: Integer;
  var AFinished: Boolean);
begin
  if FPressAnimationDirection = dirDown then
...
procedure TdxNavBarOfficeNavigationBarItemViewInfo.DoPressAnimationTerminate
  (Sender: TObject);
begin
  FPressAnimationActive := False;
  Invalidate;
...
procedure TdxNavBarOfficeNavigationBarItemViewInfo.DrawImageSelection
  (ACanvas: TcxCanvas);
begin
  Painter.OfficeNavigationBarDrawScaledImageSelection(ACanvas, Bounds,
    GetDrawState, ScaleFactor);
end;

procedure TdxNavBarOfficeNavigationBarItemViewInfo.DrawItemContent
  (ACanvas: TcxCanvas);

  procedure DrawItemImage(ACanvas: TcxCanvas; const R: TRect);
  begin
    cxDrawImage(ACanvas, R, nil, NavigationBar.Images, ImageIndex, True, nil,
      ScaleFactor);
  end;
  ...
  begin
    ...
    try
      cxBitBlt(ABitmap.Canvas.Handle, ACanvas.Handle, ABitmap.ClientRect,
        FContentBounds.TopLeft, SRCCOPY);
...
begin
  if IsButton or IsCompact then
    Result := Painter.OfficeNavigationBarScaledButtonItemContentOffsets
      (ScaleFactor)
  else
    Result := cxNullRect;
...
begin
  Result := NavigationBar.OptionsView.CompactNavigation and
    (NavigationBar.Images <> nil);
end;
...
procedure TdxNavBarOfficeNavigationBarItemsViewInfo.DragAndDrop(const P: TPoint;
  ...
  var
    ...
    I: Integer;
  begin
    AItem := FVisibleElements[ADestinationIndex]
      as TdxNavBarOfficeNavigationBarItemViewInfo;
...
begin
  ASourceIndex := FVisibleElements.IndexOf
    (NavigationBar.Controller.DragItemInfo);
  ...
  begin
    ...
    else if P.X > ADraggedItemBounds.Right then
      if not NavigationBar.UseRightToLeftAlignment then
        for I := FVisibleElements.Count - 1 downto ASourceIndex + 1 do
        begin
          if P.X > cxRectCenter(FVisibleElements[I].Bounds).X then
  ...
  begin
    ...
    else if P.Y < ADraggedItemBounds.Top then
      for I := FVisibleElements.Count - 1 downto ASourceIndex + 1 do
      begin
        if P.Y < cxRectCenter(FVisibleElements[I].Bounds).Y then
        begin
...
function TdxNavBarOfficeNavigationBarItemsViewInfo.CreateItemInfo
  (AItem: TObject): TdxNavBarOfficeNavigationBarItemViewInfo;
begin
  Result := TdxNavBarOfficeNavigationBarItemViewInfo.Create
    (NavigationBar, AItem);
end;
...
begin
  ...
  if NavigationBar.OptionsView.MaxVisibleItemCount = 0 then
    ...
    AVisibleItemCount := Min(FItems.Count,
      NavigationBar.OptionsView.MaxVisibleItemCount);
...
function TdxNavBarOfficeNavigationBarItemsViewInfo.DoCalculateRequiredSize
  (const AAvailableSize: TSize): TSize;
var
  I: Integer;
  ASize: Integer;
...
begin
  ...
  for I := 0 to FVisibleElements.Count - 1 do
    if NavigationBar.OptionsView.Orientation = orHorizontal then
    begin
      ASize := Result.cx + FVisibleElements[I].RequiredSize.cx +
        IfThen(I < FVisibleElements.Count - 1, GetItemDistance);
    ...
    begin
      ASize := Result.cy + FVisibleElements[I].RequiredSize.cy +
        IfThen(I < FVisibleElements.Count - 1, GetItemDistance);
...
function TdxNavBarOfficeNavigationBarCustomizationButtonViewInfo.
  DoCalculateRequiredSize(const AAvailableSize: TSize): TSize;
begin
  Result := Painter.OfficeNavigationBarScaledCustomizationButtonSize
    (ScaleFactor);
end;
...
procedure TdxNavBarOfficeNavigationBarCustomizationButtonViewInfo.Paint
  (ACanvas: TcxCanvas);
begin
  Painter.OfficeNavigationBarDrawScaledCustomizationButton(ACanvas, Bounds,
    State, ScaleFactor, GetTextColor);
end;
...
begin
  inherited Create(ANavigationBar);
  FDragOffset := cxPointOffset(ADragPoint, ADraggedItem.Bounds.TopLeft, False);
...
begin
  APos := cxPointOffset(NavigationBar.ScreenToClient(GetMouseCursorPos),
    FDragOffset, False);
...
begin
  ...
  ADragObjectAnimation := TdxAnimationTransition.Create(100,
    ateAccelerateDecelerate, Abs(AEndPos - FAnimationStartPos));
...
constructor TdxNavBarOfficeNavigationBarViewInfo.Create(ANavigationBar
  : TdxNavBarCustomOfficeNavigationBar);
begin
  inherited Create(ANavigationBar);
...
procedure TdxNavBarOfficeNavigationBarViewInfo.CreateDragItem
  ...
  const ADragPoint: TPoint);
begin
  FDragItem := TdxNavBarOfficeNavigationBarDragItemViewInfo.Create
    (NavigationBar, ADraggedItem, ADragPoint);
  IsDragging := True;
end;
...
begin
  ...
  if NavigationBar.OptionsView.CustomizationButtonVisibility <> cbvHidden then
    if NavigationBar.OptionsView.Orientation = orHorizontal then
      ACustomizationButtonRequiredSize :=
        FCustomizationButtonViewInfo.RequiredSize.cx
    else
      ACustomizationButtonRequiredSize :=
        FCustomizationButtonViewInfo.RequiredSize.cy
  else
  ...
  begin
    ...
    FItems.CalculateRequiredSize(cxSize(AAvailableSize,
      cxRectHeight(AContentRect)));
    AVisibleElementsSize := FItems.RequiredSize.cx +
      ACustomizationButtonRequiredSize;
    case NavigationBar.OptionsView.ItemAlignment.Horz of
      ...
      ALeft := cxHalfCoordinate(AContentRect.Left + AContentRect.Right -
        AVisibleElementsSize);
    end;
    for I := 0 to FVisibleElements.Count - 1 do
    begin
      AItemSize := FVisibleElements[I].RequiredSize;
  ...
  begin
    ...
    Dec(AAvailableSize, ACustomizationButtonRequiredSize);
    FItems.CalculateRequiredSize(cxSize(cxRectWidth(AContentRect),
      AAvailableSize));
    AVisibleElementsSize := FItems.RequiredSize.cy +
      ACustomizationButtonRequiredSize;
    case NavigationBar.OptionsView.ItemAlignment.Horz of
      taLeftJustify:
      ...
      ABottom := cxHalfCoordinate(AContentRect.Bottom + AContentRect.Top +
        AVisibleElementsSize);
    end;
    for I := 0 to FVisibleElements.Count - 1 do
    begin
...
function TdxNavBarOfficeNavigationBarViewInfo.CreateCustomizationButtonInfo
  : TdxNavBarOfficeNavigationBarCustomizationButtonViewInfo;
begin
  Result := TdxNavBarOfficeNavigationBarCustomizationButtonViewInfo.Create
    (NavigationBar);
end;

function TdxNavBarOfficeNavigationBarViewInfo.CreateItemsInfo
  : TdxNavBarOfficeNavigationBarItemsViewInfo;
begin
...
begin
  if NavigationBar.OptionsView.CustomizationButtonVisibility = cbvShowBeforeItems
  then
    Add(FCustomizationButtonViewInfo);
  Add(FItems);
  if NavigationBar.OptionsView.CustomizationButtonVisibility = cbvShowAfterItems
  then
    Add(FCustomizationButtonViewInfo);
end;
...
function TdxNavBarOfficeNavigationBarViewInfo.DoCalculateRequiredSize
  (const AAvailableSize: TSize): TSize;
var
  I: Integer;
begin
...
constructor TdxNavBarOfficeNavigationBarController.Create(ANavigationBar
  : TdxNavBarCustomOfficeNavigationBar);
begin
  inherited;
...
procedure TdxNavBarOfficeNavigationBarController.DoShowPeekForm
  (AItemInfo: TdxNavBarOfficeNavigationBarCustomItemViewInfo;
  var AControl: TWinControl);
begin
  NavigationBar.DoShowPeekForm
    ((AItemInfo as TdxNavBarOfficeNavigationBarItemViewInfo).Item, AControl);
end;
...
begin
  FDragItemInfo := HitTest.HitObject as
    TdxNavBarOfficeNavigationBarCustomItemViewInfo;
...
function TdxNavBarOfficeNavigationBarController.StartDragAndDrop
...
constructor TdxNavBarOfficeNavigationBarController.
  TPeekFormVisibilityController.Create(AController
  : TdxNavBarOfficeNavigationBarController);
begin
  inherited Create;
...
destructor TdxNavBarOfficeNavigationBarController.
  TPeekFormVisibilityController.Destroy;
begin
...
procedure TdxNavBarOfficeNavigationBarController.TPeekFormVisibilityController.
  Check(AHotElement: TdxNavBarOfficeNavigationBarCustomItemViewInfo);
var
...
procedure TdxNavBarOfficeNavigationBarController.TPeekFormVisibilityController.
  ElementDestroying(AElement: TdxNavBarOfficeNavigationBarCustomItemViewInfo);
begin
...
procedure TdxNavBarOfficeNavigationBarController.
  TPeekFormVisibilityController.Hide;
begin
  StopShowTimer;
  if IsVisible then
    FPeekForm.CloseUp;
...
procedure TdxNavBarOfficeNavigationBarController.TPeekFormVisibilityController.
  HideTimerExpired(Sender: TObject);
begin
  StopHideTimer;
  Hide;
end;

function TdxNavBarOfficeNavigationBarController.TPeekFormVisibilityController.
  IsVisible: Boolean;
begin
...
procedure TdxNavBarOfficeNavigationBarController.TPeekFormVisibilityController.
  ShowTimerExpired(Sender: TObject);
var
...
begin
  ...
  begin
    ...
    begin
      FPeekForm := TdxNavBarOfficeNavigationBarPeekForm.Create
        (FController.NavigationBar);
    ...
    FPeekForm.OwnerBounds := cxRectSetOrigin(FPeekFormOwnerElement.Bounds,
      FController.NavigationBar.ClientToParent
      (FPeekFormOwnerElement.Bounds.TopLeft));
    FPeekForm.OwnerParent := FController.NavigationBar.Parent;
    FPeekForm.FadeAnimation :=
      FController.NavigationBar.OptionsBehavior.Animation;
    FPeekForm.MoveAnimation :=
      FController.NavigationBar.OptionsBehavior.Animation;
...
procedure TdxNavBarOfficeNavigationBarController.TPeekFormVisibilityController.
  TrackTimerExpired(Sender: TObject);
var
  AHandle: HWND;
begin
  StopTrackTimer;
...
function TdxNavBarOfficeNavigationBarItems.TNavigationItemEnumerator.
  GetCurrent: TObject;
begin
...
function TdxNavBarOfficeNavigationBarItems.TNavigationItemEnumerator.
  GetCurrentNavigationItem: IdxNavigationItem;
begin
...
constructor TdxNavBarOfficeNavigationBarItems.Create(ANavigationBar
  : TdxNavBarCustomOfficeNavigationBar; AItemClass: TCollectionItemClass);
begin
  inherited Create(AItemClass);
  FNavigationBar := ANavigationBar;
end;

function TdxNavBarOfficeNavigationBarItems.Add
  : TdxNavBarOfficeNavigationBarItem;
begin
  Result := TdxNavBarOfficeNavigationBarItem(inherited Add);
end;

procedure TdxNavBarOfficeNavigationBarItems.Notify(Item: TCollectionItem;
...
function TdxNavBarOfficeNavigationBarItems.GetNavigationItemEnumerator
  : IEnumerator<IdxNavigationItem>;
begin
  Result := TNavigationItemEnumerator.Create(Self);
end;

function TdxNavBarOfficeNavigationBarItems.GetNavigationClientItems
  : IEnumerable<IdxNavigationItem>;
begin
  Result := Self;
end;
...
function TdxNavBarOfficeNavigationBarItems.GetNavigationClientSelectedItem
  : IdxNavigationItem;
begin
...
function TdxNavBarOfficeNavigationBarItems.GetItem(Index: Integer)
  : TdxNavBarOfficeNavigationBarItem;
begin
...
begin
  ...
  FItems := TdxNavBarOfficeNavigationBarItems.Create(Self,
    TdxNavBarOfficeNavigationBarItem);
...
function TdxNavBarCustomOfficeNavigationBar.GetActiveItemProvider
  : IdxNavigationClient;
begin
...
begin
  if FCustomizationButtonPopup = nil then
    FCustomizationButtonPopup := TdxBuiltInPopupMenuAdapterManager.
      GetActualAdapterClass.Create(nil);
  FCustomizationButtonPopup.Clear;
  FCustomizationButtonPopup.SetLookAndFeel(LookAndFeel);
  FCustomizationButtonPopup.Add
    (cxGetResourceString(@sdxOfficeNavigationBarNavigationOptionsMenuItem),
    DoCustomizationButtonClick);
...
procedure TdxNavBarCustomOfficeNavigationBar.DoShowPeekForm
  (AItem: IdxNavigationItem; var AControl: TWinControl);
begin
...
procedure TdxNavBarCustomOfficeNavigationBar.ItemClick
  (AItem: TdxNavBarOfficeNavigationBarItemViewInfo);
var
...
function TdxNavBarCustomOfficeNavigationBar.CreateController
  : TdxNavBarOfficeNavigationBarController;
begin
  Result := TdxNavBarOfficeNavigationBarController.Create(Self);
end;

function TdxNavBarCustomOfficeNavigationBar.CreateViewInfo
  : TdxNavBarOfficeNavigationBarViewInfo;
begin
  Result := TdxNavBarOfficeNavigationBarViewInfo.Create(Self);
end;

function TdxNavBarCustomOfficeNavigationBar.CreateOptionsBehavior
  : TdxNavBarOfficeNavigationBarOptionsBehavior;
begin
  Result := TdxNavBarOfficeNavigationBarOptionsBehavior.Create(Self);
end;

function TdxNavBarCustomOfficeNavigationBar.CreateOptionsView
  : TdxNavBarOfficeNavigationBarOptionsView;
begin
...
function TdxNavBarCustomOfficeNavigationBar.CanResize(var NewWidth,
...
procedure TdxNavBarCustomOfficeNavigationBar.ChangeScaleEx(M, D: Integer;
  isDpiChange: Boolean);
begin
...
procedure TdxNavBarCustomOfficeNavigationBar.LookAndFeelChanged
...
procedure TdxNavBarCustomOfficeNavigationBar.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TdxNavBarCustomOfficeNavigationBar.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
...
procedure TdxNavBarCustomOfficeNavigationBar.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
...
procedure TdxNavBarCustomOfficeNavigationBar.Notification
...
begin
  ...
  begin
    ...
    for I := 0 to ViewInfo.FItems.FVisibleElements.Count - 1 do
      FOrderList[I] := (ViewInfo.FItems.FVisibleElements[I]
        as TdxNavBarOfficeNavigationBarItemViewInfo).Item.ID;
...
function TdxNavBarCustomOfficeNavigationBar.PtInCaller(const P: TPoint)
  : Boolean;
begin
...
function TdxNavBarCustomOfficeNavigationBar.GetSortedItems(Index: Integer)
  : IdxNavigationItem;
begin
...
procedure TdxNavBarCustomOfficeNavigationBar.SetItemProvider(Value: TComponent);
begin
  if IsLoading then
