...
type
  ...
  TdxOpenHyperlinkAtCaretPositionCommand = class
  ...
  TdxInsertCopyrightSymbolCoreCommand = class
  ...
  TdxInsertRegisteredTrademarkSymbolCommand = class
  ...
  TdxInsertRegisteredTrademarkSymbolCoreCommand = class
    (TdxInsertSpecialCharacterCommandBase)
  protected
    function GetCharacter: Char; override;
  public
  ...
  TdxInsertTrademarkSymbolCoreCommand = class
    (TdxInsertSpecialCharacterCommandBase)
  protected
    function GetCharacter: Char; override;
  public
...
function TdxEnterKeyCommand.GetUpdateUIStateMode
...
function TdxOpenHyperlinkAtCaretPositionCommand.GetHyperlinkFieldAtCaretPosition
  : TdxField;
var
...
begin
  ...
  begin
    ...
    begin
      ...
      APosition.Update;
      if (APosition.RunIndex = AField.Code.Start) and (APosition.RunOffset = 0)
      then
        Exit;
      Result := AField;
    end;
...
procedure TdxOpenHyperlinkAtCaretPositionCommand.UpdateUIStateCore
...
class function TdxInsertCopyrightSymbolCommand.GetInsertObjectCommandClass
...
class function TdxInsertRegisteredTrademarkSymbolCommand.
  GetInsertObjectCommandClass: TdxRichEditCommandClass;
begin
  Result := TdxInsertRegisteredTrademarkSymbolCoreCommand;
end;

class function TdxInsertRegisteredTrademarkSymbolCommand.Id
...
class function TdxInsertRegisteredTrademarkSymbolCoreCommand.
...
class function TdxInsertTrademarkSymbolCommand.GetInsertObjectCommandClass
  : TdxRichEditCommandClass;
begin
...
class function TdxInsertEllipsisCommand.GetInsertObjectCommandClass
  : TdxRichEditCommandClass;
begin
...
procedure TdxToggleOvertypeCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
begin
...
procedure TdxInsertTabCoreCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
begin
  inherited UpdateUIStateCore(AState);
  ApplyCommandRestrictionOnEditableControl(AState,
    DocumentModel.DocumentCapabilities.TabSymbol, AState.Enabled);
  ApplyDocumentProtectionToSelectedCharacters(AState);
end;

{ TdxInsertTabCommand }

class function TdxInsertTabCommand.GetInsertObjectCommandClass
  : TdxRichEditCommandClass;
begin
