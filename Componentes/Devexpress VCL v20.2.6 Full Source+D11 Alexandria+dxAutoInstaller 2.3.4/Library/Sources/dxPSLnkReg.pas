...
function TdxCheckListBoxOptionsPropertyEditor.GetAttributes
  : TPropertyAttributes;
begin
  Result := inherited GetAttributes + [paDialog];
end;
...
begin
  ...
  RegisterPropertyEditor(TypeInfo(TdxGridPaintOptions), TdxDrawGridReportLink,
    'Options', TdxGridOptionsPropertyEditor);
  RegisterPropertyEditor(TypeInfo(TdxListBoxPaintOptions), TdxListBoxReportLink,
    'Options', TdxListBoxOptionsPropertyEditor);
  ...
  RegisterPropertyEditor(TypeInfo(string), TAbstractdxRichEditReportLink,
    'DesignerCaption', nil);
  RegisterPropertyEditor(TypeInfo(THelpContext), TAbstractdxRichEditReportLink,
    'DesignerHelpContext', nil);
