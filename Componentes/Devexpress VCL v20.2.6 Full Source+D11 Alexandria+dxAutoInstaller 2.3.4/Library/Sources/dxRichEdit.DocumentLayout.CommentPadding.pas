...
type
  ...
  TdxMoreButtonHorizontalAlignment = (Left, Right, Center);
  ...
  public
    constructor Create(ACommentLeft: Integer; ACommentRight: Integer;
      AContentLeft: Integer; AContentTop: Integer; AContentRight: Integer;
      AContentBottom: Integer; ADistanceBetweenComments: Integer;
      const AMoreButtonSize: TSize; AMoreButtonOffsetX: Integer;
      AMoreButtonOffsetY: Integer;
      AMoreButtonHorizontalAlignment: TdxMoreButtonHorizontalAlignment);
    class function GetDefaultCommentPadding(ADocumentModel
      : TdxCustomDocumentModel): TdxCommentPadding; static;
    ...
    property MoreButtonHorizontalAlignment: TdxMoreButtonHorizontalAlignment
      read FMoreButtonHorizontalAlignment;
...
constructor TdxCommentPadding.Create(ACommentLeft: Integer;
  ACommentRight: Integer; AContentLeft: Integer; AContentTop: Integer;
  AContentRight: Integer; AContentBottom: Integer;
  ADistanceBetweenComments: Integer; const AMoreButtonSize: TSize;
...
class function TdxCommentPadding.GetDefaultCommentPadding(ADocumentModel
  : TdxCustomDocumentModel): TdxCommentPadding;
var
  AConverter: TdxDocumentLayoutUnitConverter;
begin
  AConverter := ADocumentModel.LayoutUnitConverter;
  Result := TdxCommentPadding.Create(AConverter.DocumentsToLayoutUnits(112),
    AConverter.DocumentsToLayoutUnits(37),
    AConverter.DocumentsToLayoutUnits(20),
    AConverter.DocumentsToLayoutUnits(10),
    AConverter.DocumentsToLayoutUnits(20),
    AConverter.DocumentsToLayoutUnits(10), AConverter.DocumentsToLayoutUnits(6),
    cxSize(AConverter.PixelsToLayoutUnits(23, 96),
    AConverter.PixelsToLayoutUnits(14, 96)), 0, 0,
