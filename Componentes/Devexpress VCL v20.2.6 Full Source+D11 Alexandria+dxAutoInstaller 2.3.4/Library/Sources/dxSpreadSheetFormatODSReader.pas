...
uses
  ...
  Graphics, dxCore, cxGraphics, dxXMLDoc, dxCustomTree,
  dxSpreadSheetCore, dxSpreadSheetClasses, dxSpreadSheetPackedFileFormatCore,
  dxSpreadSheetFormatODSHelpers, cxClasses,
  dxGDIPlusClasses, dxCoreGraphics, dxSpreadSheetPrinting, cxGeometry,
  dxSpreadSheetConditionalFormattingRules,
  dxSpreadSheetContainers, dxSpreadSheetGraphics, dxSpreadSheetHyperlinks,
  dxCoreClasses, dxSpreadSheetCoreStyles,
...
type
  ...
  TdxSpreadSheetODSReaderCustomStyleClass = class of
    TdxSpreadSheetODSReaderCustomStyle;
  ...
  public
    constructor Create(ANode: TdxXMLNode;
      AOwner: TdxSpreadSheetODSReader); virtual;
  ...
  TdxSpreadSheetODSReaderStyleRepository<T
    : TdxSpreadSheetODSReaderCustomStyle> = class
    (TObjectDictionary<TdxXMLString, T>)
  strict private
    FOwner: TdxSpreadSheetODSReader;
  public
  ...
  TdxSpreadSheetODSReaderColumnStyle = class
    (TdxSpreadSheetODSReaderTableItemStyle)
  public
    constructor Create(ANode: TdxXMLNode;
      AOwner: TdxSpreadSheetODSReader); override;
  ...
  TdxSpreadSheetODSReaderGradientStyle = class
    (TdxSpreadSheetODSReaderCustomStyle)
  strict private
    function DecodeColor(ANode: TdxXMLNode;
      const AColorValueName, AColorIntensityName: TdxXMLString): TColor;
  public
    Color1: TColor;
    Color2: TColor;
  ...
  TdxSpreadSheetODSReaderParagraphStyle = class
    (TdxSpreadSheetODSReaderCustomStyle)
  public
  ...
  TdxSpreadSheetODSReaderGraphicStyle = class
    (TdxSpreadSheetODSReaderCustomStyle)
  strict private
  ...
  strict private
    function DetectBrushPattern(ANode: TdxXMLNode)
      : TdxSpreadSheetODSBrushPattern;
  public
    Color: TColor;
  ...
  TdxSpreadSheetODSReaderMasterPageStyle = class
    (TdxSpreadSheetODSReaderCustomStyle)
  strict private
    procedure ParseText(AText
      : TdxSpreadSheetTableViewOptionsPrintHeaderFooterText; ANode: TdxXMLNode);
  public
    DisplayName: string;
  ...
  TdxSpreadSheetODSStyles = class
    (TDictionary<string, TdxSpreadSheetCellStyleHandle>)
  strict private
    FDisplayNameMap: TDictionary<string, string>;
  protected
    procedure ValueNotify(const Value: TdxSpreadSheetCellStyleHandle;
      Action: TCollectionNotification); override;
  public
    constructor Create; virtual;
    destructor Destroy; override;
    procedure Add(const AName, ADisplayName: string;
      AHandle: TdxSpreadSheetCellStyleHandle);
    function TryGetValue(const AName: string;
      out AHandle: TdxSpreadSheetCellStyleHandle): Boolean;
  end;

  { TdxSpreadSheetODSFormulaAsTextInfoList }

  TdxSpreadSheetODSFormulaAsTextInfoList = class
  ...
  strict private
    ...
    FParagraphStyles
      ...
      TdxSpreadSheetODSReaderParagraphStyle>;
    FRowStyles
      : TdxSpreadSheetODSReaderStyleRepository<TdxSpreadSheetODSReaderRowStyle>;
    FStrokeDashStyles
      : TdxSpreadSheetODSReaderStyleRepository<
      TdxSpreadSheetODSReaderStrokeDashStyle>;
  ...
  public
    ...
    property ColumnStyles
      : TdxSpreadSheetODSReaderStyleRepository<
      TdxSpreadSheetODSReaderColumnStyle> read FColumnStyles;
    property DataFormatConverter: TdxSpreadSheetODSReaderDataFormatConverter
      read FDataFormatConverter;
    ...
    property GradientStyles
      : TdxSpreadSheetODSReaderStyleRepository<
      TdxSpreadSheetODSReaderGradientStyle> read FGradientStyles;
    property GraphicStyles
      : TdxSpreadSheetODSReaderStyleRepository<
      TdxSpreadSheetODSReaderGraphicStyle> read FGraphicStyles;
    property HatchStyles
      : TdxSpreadSheetODSReaderStyleRepository<
      TdxSpreadSheetODSReaderHatchStyle> read FHatchStyles;
    property Hyperlinks: TStringList read FHyperlinks;
    property ImageStyles
      : TdxSpreadSheetODSReaderStyleRepository<
      TdxSpreadSheetODSReaderImageStyle> read FImageStyles;
    property MasterPageStyles
      : TdxSpreadSheetODSReaderStyleRepository<
      TdxSpreadSheetODSReaderMasterPageStyle> read FMasterPageStyles;
    property PageLayouts
      : TdxSpreadSheetODSReaderStyleRepository<
      TdxSpreadSheetODSReaderPageLayoutStyle> read FPageLayouts;
    property ParagraphStyles
      : TdxSpreadSheetODSReaderStyleRepository<
      TdxSpreadSheetODSReaderParagraphStyle> read FParagraphStyles;
    property RowStyles
      : TdxSpreadSheetODSReaderStyleRepository<TdxSpreadSheetODSReaderRowStyle>
      read FRowStyles;
    property StrokeDashStyles
      : TdxSpreadSheetODSReaderStyleRepository<
      TdxSpreadSheetODSReaderStrokeDashStyle> read FStrokeDashStyles;
    property Styles: TdxSpreadSheetODSStyles read FStyles;
    property TableStyles
      : TdxSpreadSheetODSReaderStyleRepository<
      TdxSpreadSheetODSReaderTableStyle> read FTableStyles;
    property Version: Double read FVersion;
  end;

  { TdxSpreadSheetODSReaderCustomParser }

  TdxSpreadSheetODSReaderCustomParser = class
  ...
  TdxSpreadSheetODSReaderCustomNodeParser = class
    (TdxSpreadSheetODSReaderCustomParser)
  protected
    FNode: TdxXMLNode;
  public
  ...
  TdxSpreadSheetODSReaderCustomDocumentParser = class
    (TdxSpreadSheetODSReaderCustomNodeParser)
  strict private
  ...
  public
    constructor Create(const AFileName: AnsiString;
      AOwner: TdxSpreadSheetODSReader);
    destructor Destroy; override;
    //
  ...
  TdxSpreadSheetODSReaderContentFileParser = class
    (TdxSpreadSheetODSReaderCustomDocumentParser)
  public
  ...
  TdxSpreadSheetODSReaderContentSpreadSheetParser = class
    (TdxSpreadSheetODSReaderCustomNodeParser)
  protected
  ...
  TdxSpreadSheetODSReaderCustomContainerParserClass = class of
    TdxSpreadSheetODSReaderCustomContainerParser;

  TdxSpreadSheetODSReaderCustomContainerParser = class
    (TdxSpreadSheetODSReaderCustomNodeParser)
  strict private
  ...
  public
    constructor Create(ANode: TdxXMLNode;
      AViewParser: TdxSpreadSheetODSReaderTableViewParser;
    ...
    property ViewParser: TdxSpreadSheetODSReaderTableViewParser
      read FViewParser;
  end;

  { TdxSpreadSheetODSReaderShapeContainerParser }

  TdxSpreadSheetODSReaderShapeContainerParser = class
    (TdxSpreadSheetODSReaderCustomContainerParser)
  strict private
  ...
  TdxSpreadSheetODSReaderCustomTextBoxContainerParser = class
    (TdxSpreadSheetODSReaderShapeContainerParser)
  strict private
    function GetTextBox: TdxSpreadSheetCustomTextBox;
  protected
    procedure ApplyStyleToTextBox
      (AStyle: TdxSpreadSheetODSReaderGraphicStyle); virtual;
  public
    procedure Execute; override;
    //
  ...
  TdxSpreadSheetODSReaderTextBoxContainerParser = class
    (TdxSpreadSheetODSReaderCustomTextBoxContainerParser)
  protected
    procedure ApplyStyleToTextBox
      (AStyle: TdxSpreadSheetODSReaderGraphicStyle); override;
    function CreateContainer: TdxSpreadSheetContainer; override;
  end;

  { TdxSpreadSheetODSReaderCommentContainerParser }

  TdxSpreadSheetODSReaderCommentContainerParser = class
    (TdxSpreadSheetODSReaderCustomTextBoxContainerParser)
  protected
    function CreateContainer: TdxSpreadSheetContainer; override;
  ...
  TdxSpreadSheetODSReaderPictureContainerParser = class
    (TdxSpreadSheetODSReaderShapeContainerParser)
  strict private
  ...
  TdxSpreadSheetODSReaderDataFormatConverterProc = function
    (ANode: TdxXMLNode): string;

  TdxSpreadSheetODSReaderDataFormatConverter = class
    (TDictionary<TdxXMLString, TdxSpreadSheetODSReaderDataFormatConverterProc>)
  strict private
    FProcs: TDictionary<TdxXMLString,
      TdxSpreadSheetODSReaderDataFormatConverterProc>;
  ...
  TdxSpreadSheetODSReaderDefinedNamesParser = class
    (TdxSpreadSheetODSReaderCustomNodeParser)
  strict private
    FView: TdxSpreadSheetTableView;
  protected
    procedure ParseNamedExpression(ANode: TdxXMLNode);
    procedure ParseNamedRange(ANode: TdxXMLNode;
      const AValueName: TdxXMLString);
    procedure ProcessSubNodes(ANode: TdxXMLNode; AUserData: Pointer);
  public
    constructor Create(ANode: TdxXMLNode; AOwner: TdxSpreadSheetODSReader;
      AView: TdxSpreadSheetTableView = nil);
    procedure Execute; override;
  end;

  { TdxSpreadSheetODSReaderMasterStylesParser }

  TdxSpreadSheetODSReaderMasterStylesParser = class
    (TdxSpreadSheetODSReaderCustomNodeParser)
  protected
    procedure ProcessSubNodes(ANode: TdxXMLNode; AUserData: Pointer);
  public
  ...
  TdxSpreadSheetODSReaderNumberFormatParser = class
    (TdxSpreadSheetODSReaderCustomNodeParser)
  strict private
  ...
  strict private
    procedure AddPart(const AText: string;
      AFont: TdxSpreadSheetFontHandle = nil);
    procedure ProcessSubNode(ANode: TdxXMLNode; AUserData: Pointer);
  ...
  TdxSpreadSheetODSReaderSettingsParserProc = procedure(const AValue: string)
    of object;

  TdxSpreadSheetODSReaderSettingsFileParser = class
    (TdxSpreadSheetODSReaderCustomDocumentParser)
  strict private
    FProcs: TDictionary<TdxXMLString,
      TdxSpreadSheetODSReaderSettingsParserProc>;
  ...
  protected
    ...
    procedure ProcessConfigSetViewSettings(ANode: TdxXMLNode;
      AUserData: Pointer);
  public
    destructor Destroy; override;
  ...
  TdxSpreadSheetODSReaderMetadataFileParser = class
    (TdxSpreadSheetODSReaderCustomDocumentParser)
  strict private
    function GetMetadata: TdxSpreadSheetOptionsMetadata;
    function ReadDateTime(AParentNode: TdxXMLNode; const AValueName: AnsiString)
      : TDateTime; inline;
    function ReadText(AParentNode: TdxXMLNode; const AValueName: AnsiString)
      : string; inline;
  public
    procedure Execute; override;
    //
  ...
  TdxSpreadSheetODSReaderStyleParser = class
    (TdxSpreadSheetODSReaderCustomNodeParser)
  protected
    procedure ParseBackgroundProperties(AHandle: TdxSpreadSheetCellStyleHandle;
      ANode: TdxXMLNode);
    procedure ParseBorder(AHandle: TdxSpreadSheetBordersHandle;
      ASide: TcxBorder; const S: string);
    procedure ParseBorders(AHandle: TdxSpreadSheetCellStyleHandle;
      ANode: TdxXMLNode);
    procedure ParseBrush(AHandle: TdxSpreadSheetCellStyleHandle;
      ANode: TdxXMLNode);
    procedure ParseFontProperties(AHandle: TdxSpreadSheetCellStyleHandle;
      ANode: TdxXMLNode);
    procedure ParseParagraphProperties(AHandle: TdxSpreadSheetCellStyleHandle;
      ANode: TdxXMLNode);
    function ParseStyle(out AStyleHandle
      : TdxSpreadSheetCellStyleHandle): Boolean;
  public
    procedure Execute; override;
  end;
  ...
  TdxSpreadSheetODSReaderStylesParser = class
    (TdxSpreadSheetODSReaderCustomNodeParser)
  protected
  ...
  TdxSpreadSheetODSReaderStylesFileParser = class
    (TdxSpreadSheetODSReaderCustomDocumentParser)
  public
    procedure Execute; override;
  end;
  ...
  public
    ...
    property ContainersZOrder: TList<TdxSpreadSheetContainer>
      read FContainersZOrder;
  ...
  TdxSpreadSheetODSReaderTableItemParser = class
    (TdxSpreadSheetODSReaderCustomNodeParser)
  strict private
  ...
  protected
    ...
    function GetCellStyle(ANode: TdxXMLNode; const AAttrName: TdxXMLString;
      ACanBeNil: Boolean): TdxSpreadSheetCellStyleHandle;
  public
    constructor Create(ANode: TdxXMLNode;
      ATableViewParser: TdxSpreadSheetODSReaderTableViewParser);
    //
    property TableView: TdxSpreadSheetTableView read GetTableView;
    property TableViewParser: TdxSpreadSheetODSReaderTableViewParser
      read FTableViewParser;
  end;

  { TdxSpreadSheetODSReaderTableColumnParser }

  TdxSpreadSheetODSReaderTableColumnParser = class
    (TdxSpreadSheetODSReaderTableItemParser)
  public
    procedure Execute; override;
  end;
  ...
  protected
    ...
    procedure ParseCellTextValue(ATextNode: TdxXMLNode;
    ...
    procedure ProcessCellRange(ANode: TdxXMLNode; ARow: TdxSpreadSheetTableRow;
      ARangeSize: Integer);
  public
    procedure Execute; override;
  end;
  ...
  TdxSpreadSheetODSReaderConditionalFormatParser = class
    (TdxSpreadSheetODSReaderTableItemParser)
  strict private
    ...
    function CreateCellIsRule(AComparisonOperator
      : TdxSpreadSheetConditionalFormattingRuleCellIsComparisonOperator;
      const AExpression1, AExpression2: string; ANode: TdxXMLNode)
      : TdxSpreadSheetConditionalFormattingRuleCellIs;
    function CreateDuplicateValuesRule(ANode: TdxXMLNode)
      : TdxSpreadSheetConditionalFormattingRuleDuplicateValues;
    function CreateExpressionRule(const AExpression: string; ANode: TdxXMLNode)
    ...
    function CreateUniqueValuesRule(ANode: TdxXMLNode)
      : TdxSpreadSheetConditionalFormattingRuleUniqueValues;
    function TryCreateCellIsRule(const ACondition: string; ANode: TdxXMLNode)
      : TdxSpreadSheetCustomConditionalFormattingRule;
    function TryCreateTopBottomRule(const AFuncName, ACondition: string;
      ANode: TdxXMLNode;
      ADirection
      : TdxSpreadSheetConditionalFormattingRuleTopBottomValuesDirection;
      AValueType
    ...
    function CheckFunctionAndExtractParams(const AFuncName, ACondition: string;
      out AParams: TStringList): Boolean;
    function IsBeginsWith(const ATestString, AFullString: string): Boolean;
    procedure ReadColorScaleStop
      (AStop: TdxSpreadSheetConditionalFormattingRuleColorScaleStop;
      ANode: TdxXMLNode);
    procedure ReadCustomScaleStop
      (AStop: TdxSpreadSheetConditionalFormattingRuleCustomScaleStop;
      ANode: TdxXMLNode);
    procedure ReadStyle(ANode: TdxXMLNode;
      ARule: TdxSpreadSheetConditionalFormattingRuleStyleBased);

    function CreateColorScaleRule(ANode: TdxXMLNode)
      : TdxSpreadSheetCustomConditionalFormattingRule;
    function CreateConditionBasedRule(ANode: TdxXMLNode)
      : TdxSpreadSheetCustomConditionalFormattingRule;
    function CreateDataBarRule(ANode: TdxXMLNode)
      : TdxSpreadSheetConditionalFormattingRuleDataBar;
    function CreateIconSetRule(ANode: TdxXMLNode)
...
uses
  dxSpreadSheetFormatODSTags, dxSpreadSheetStrs, dxSpreadSheetTypes,
  dxColorPicker, Math, dxHashUtils,
  StrUtils, AnsiStrings, dxSpreadSheetUtils, dxSpreadSheetFormatUtils,
  dxSpreadSheetFormatODSFormulas,
  dxSpreadSheetConditionalFormattingIconSet, dxSpreadSheetCoreStrs;

type
  TdxSpreadSheetConditionalFormattingRuleCustomColorScaleAccess = class
    (TdxSpreadSheetConditionalFormattingRuleCustomColorScale);
  TdxSpreadSheetCustomTextBoxContainerAccess = class
...
constructor TdxSpreadSheetODSReaderCustomStyle.Create(ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetODSReader);
begin
  inherited Create;
  FOwner := AOwner;
...
class function TdxSpreadSheetODSReaderCustomStyle.GetStyleName
  (ANode: TdxXMLNode): TdxXMLString;
begin
...
constructor TdxSpreadSheetODSReaderStyleRepository<T>.Create
  (AOwner: TdxSpreadSheetODSReader);
begin
...
begin
  inherited Add(TdxSpreadSheetODSReaderCustomStyleClass(T).GetStyleName(ANode),
    TdxSpreadSheetODSReaderCustomStyleClass(T).Create(ANode, FOwner));
end;

function TdxSpreadSheetODSReaderStyleRepository<T>.GetValueOrNil
  (const S: TdxXMLString): T;
begin
  if not TryGetValue(S, Result) then
    Result := Default (T);
end;

function TdxSpreadSheetODSReaderStyleRepository<T>.TryGetValue
  (const S: TdxXMLString; out AValue: T): Boolean;
begin
...
constructor TdxSpreadSheetODSReaderTableStyle.Create(ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetODSReader);
begin
  inherited Create(ANode, AOwner);
  PageStyle := AOwner.MasterPageStyles.GetValueOrNil
    (ANode.Parent.Attributes.GetValue(sdxODSAttrStyleMasterPageName));
  Visible := ANode.Attributes.GetValueAsBoolean(sdxODSAttrTableDisplay, True);
end;

procedure TdxSpreadSheetODSReaderTableStyle.ApplyTo
...
procedure TdxSpreadSheetODSReaderTableItemStyle.ApplyTo
...
constructor TdxSpreadSheetODSReaderColumnStyle.Create(ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetODSReader);
begin
  inherited Create(ANode, AOwner);
  Size := TdxSpreadSheetODSHelper.StringToSize
    (ANode.Attributes.GetValueAsString(sdxODSAttrStyleColumnWidth));
end;

{ TdxSpreadSheetODSReaderGradientStyle }

constructor TdxSpreadSheetODSReaderGradientStyle.Create(ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetODSReader);
var
  AInverseOrder: Boolean;
begin
  inherited Create(ANode, AOwner);
  Mode := dxGetNearestGradientMode(ANode.Attributes.GetValueAsInteger
    (sdxODSAttrDrawAngle) / 10 - 90, AInverseOrder);
  Color1 := DecodeColor(ANode, sdxODSAttrDrawStartColor,
    sdxODSAttrDrawStartIntensity);
  Color2 := DecodeColor(ANode, sdxODSAttrDrawEndColor,
    sdxODSAttrDrawEndIntensity);
end;

function TdxSpreadSheetODSReaderGradientStyle.DecodeColor(ANode: TdxXMLNode;
  const AColorValueName, AColorIntensityName: TdxXMLString): TColor;
var
  ...
  Q: TRGBQuad;
begin
  Result := TdxSpreadSheetODSHelper.StringToColor
    (ANode.Attributes.GetValueAsString(AColorValueName));
  if ANode.Attributes.Find(AColorIntensityName, AAttr) then
  begin
    AColorIntensity := TdxSpreadSheetODSHelper.StringToPercents
      (AAttr.ValueAsString);
...
class function TdxSpreadSheetODSReaderGradientStyle.GetStyleName
  (ANode: TdxXMLNode): TdxXMLString;
begin
...
constructor TdxSpreadSheetODSReaderParagraphStyle.Create(ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetODSReader);
begin
  inherited Create(ANode, AOwner);
  Alignment := TdxSpreadSheetODSHelper.StringToAlignHorz
    (ANode.Attributes.GetValue(sdxODSAttrFOTextAlign));
end;

{ TdxSpreadSheetODSReaderGraphicStyle }

constructor TdxSpreadSheetODSReaderGraphicStyle.Create(ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetODSReader);
begin
  inherited Create(ANode, AOwner);
  LoadFill(ANode);
  LoadStroke(ANode);
  ProtectSize := Pos(sdxODSValueStyleProtectSize,
    ANode.Attributes.GetValue(sdxODSAttrStyleProtect)) > 0;
  ProtectPosition := Pos(sdxODSValueStyleProtectPosition,
    ANode.Attributes.GetValue(sdxODSAttrStyleProtect)) > 0;

  AutoSize := ANode.Attributes.GetValueAsBoolean(sdxODSAttrDrawAutoGrowHeight);
  TextAreaHorzAlign := TdxSpreadSheetODSHelper.StringToAlignment
    (ANode.Attributes.GetValue(sdxODSAttrDrawTextAreaHorizontalAlign));
  TextAreaVertAlign := TdxSpreadSheetODSHelper.StringToVerticalAlignment
    (ANode.Attributes.GetValue(sdxODSAttrDrawTextAreaVerticalAlign));
  Padding.Bottom := TdxSpreadSheetODSHelper.StringToSize
    (ANode.Attributes.GetValueAsString(sdxODSAttrFOPaddingBottom));
  Padding.Left := TdxSpreadSheetODSHelper.StringToSize
    (ANode.Attributes.GetValueAsString(sdxODSAttrFOPaddingLeft));
  Padding.Right := TdxSpreadSheetODSHelper.StringToSize
    (ANode.Attributes.GetValueAsString(sdxODSAttrFOPaddingRight));
  Padding.Top := TdxSpreadSheetODSHelper.StringToSize
    (ANode.Attributes.GetValueAsString(sdxODSAttrFOPaddingTop));
...
begin
  case FillMode of
    ...
    sofmHatch:
      ...
      begin
        dxSpreadSheetLoadBrushPattern(ABrush, HInstance,
          sdxODSBrushPatterns[FillHatch.Pattern],
...
begin
  FillMode := TdxSpreadSheetODSHelper.StringToFillStyle
    (ANode.Attributes.GetValue(sdxODSNodeFill));
  case FillMode of
    sofmGradient:
      FillGradient := Owner.GradientStyles.GetValueOrNil
        (ANode.Attributes.GetValue(sdxODSAttrDrawFillGradientName));
    sofmTexture:
      FillTexture := Owner.ImageStyles.GetValueOrNil
        (ANode.Attributes.GetValue(sdxODSAttrDrawFillImageName));
    sofmSolid:
      FillColor := TdxSpreadSheetODSHelper.StringToColor
        (ANode.Attributes.GetValueAsString(sdxODSAttrDrawFillColor));
    sofmHatch:
      begin
        FillHatch := Owner.HatchStyles.GetValueOrNil
          (ANode.Attributes.GetValue(sdxODSAttrDrawHatchName));
...
begin
  ...
  begin
    StrokeWidth := Max(1, TdxSpreadSheetODSHelper.StringToSize
      (ANode.Attributes.GetValueAsString(sdxODSAttrSvgStrokeWidth)));

    if ANode.Attributes.Find(sdxODSAttrSvgStrokeColor, AAttribute) then
    begin
      if ANode.Attributes.Find(sdxODSAttrSvgStrokeOpacity, AOpacityAttribute)
      then
        AOpacity := TdxSpreadSheetODSHelper.StringToPercents
          (AOpacityAttribute.ValueAsString)
      else
        AOpacity := 100;

      StrokeColor := dxColorToAlphaColor
        (TdxSpreadSheetODSHelper.StringToColor(AAttribute.ValueAsString),
        MulDiv(AOpacity, MaxByte, 100));
    end
    else
      StrokeColor := $FF41719C;

    if AStrokeStyle = sdxODSValueDrawStrokeDash then
      StrokeStyle := Owner.StrokeDashStyles.GetValueOrNil
        (ANode.Attributes.GetValue(sdxODSAttrDrawStrokeDash));
  end;
end;

{ TdxSpreadSheetODSReaderHatchStyle }

constructor TdxSpreadSheetODSReaderHatchStyle.Create(ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetODSReader);
begin
  inherited Create(ANode, AOwner);
  Color := TdxSpreadSheetODSHelper.StringToColor
    (ANode.Attributes.GetValueAsString(sdxODSAttrDrawColor));
  Pattern := DetectBrushPattern(ANode);
end;

class function TdxSpreadSheetODSReaderHatchStyle.GetStyleName(ANode: TdxXMLNode)
  : TdxXMLString;
begin
  Result := ANode.Attributes.GetValue(sdxODSAttrDrawName);
end;

function TdxSpreadSheetODSReaderHatchStyle.DetectBrushPattern(ANode: TdxXMLNode)
  : TdxSpreadSheetODSBrushPattern;
var
  AStyle: TdxXMLString;
  AUnused: Boolean;
begin
  ...
  begin
    if ANode.Attributes.GetValueAsInteger(sdxODSAttrDrawRotation) mod 900 = 0
    then
      Result := sobpCell
    else
      Result := sobpDiagonal
    ...
    case dxGetNearestGradientMode(ANode.Attributes.GetValueAsInteger
      (sdxODSAttrDrawRotation) / 10, AUnused) of
      gpbgmHorizontal:
        Result := sobpSingle0;
      gpbgmVertical:
        Result := sobpSingle90;
      gpbgmForwardDiagonal:
        if TdxSpreadSheetODSHelper.StringToSize
          (ANode.Attributes.GetValueAsString(sdxODSAttrDrawDistance)) > 10 then
...
constructor TdxSpreadSheetODSReaderImageStyle.Create(ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetODSReader);
begin
  inherited Create(ANode, AOwner);
...
class function TdxSpreadSheetODSReaderImageStyle.GetStyleName(ANode: TdxXMLNode)
  : TdxXMLString;
begin
  Result := ANode.Attributes.GetValue(sdxODSAttrDrawName);
end;
...
constructor TdxSpreadSheetODSReaderMasterPageStyle.Create(ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetODSReader);
begin
  inherited Create(ANode, AOwner);
  ...
  PageLayout := Owner.PageLayouts.GetValueOrNil
    (ANode.Attributes.GetValue(sdxODSAttrStylePageLayoutName));

  if ANode.FindChild(sdxODSNodeStyleFooterLeft) <> nil then
  begin
    ParseText(HeaderFooter.EvenPagesFooter,
      ANode.FindChild(sdxODSNodeStyleFooter));
    ParseText(HeaderFooter.CommonFooter,
      ANode.FindChild(sdxODSNodeStyleFooterLeft));
  end
  else
    ParseText(HeaderFooter.CommonFooter,
      ANode.FindChild(sdxODSNodeStyleFooter));
  ...
  begin
    ParseText(HeaderFooter.CommonHeader,
      ANode.FindChild(sdxODSNodeStyleHeaderLeft));
    ParseText(HeaderFooter.EvenPagesHeader,
      ANode.FindChild(sdxODSNodeStyleHeader));
  end
  else
    ParseText(HeaderFooter.CommonHeader,
      ANode.FindChild(sdxODSNodeStyleHeader));
...
procedure TdxSpreadSheetODSReaderMasterPageStyle.ApplyTo
  (AOptions: TdxSpreadSheetTableViewOptionsPrint);
begin
...
class function TdxSpreadSheetODSReaderMasterPageStyle.GetStyleName
  (ANode: TdxXMLNode): TdxXMLString;
begin
...
begin
  ...
  begin
    ...
    else if ANode.HasChildren and (ANode.First.Name = sdxODSNodeText) then
...
constructor TdxSpreadSheetODSReaderPageLayoutStyle.Create(ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetODSReader);
var
  ASubNode: TdxXMLNode;
begin
...
procedure TdxSpreadSheetODSReaderPageLayoutStyle.ApplyTo
  (AOptions: TdxSpreadSheetTableViewOptionsPrint);
begin
...
class function TdxSpreadSheetODSReaderPageLayoutStyle.GetStyleName
  (ANode: TdxXMLNode): TdxXMLString;
begin
  Result := ANode.Attributes.GetValue(sdxODSAttrStyleName);
end;
...
var
  ...
  ASubNode: TdxXMLNode;
begin
  if ANode.FindChild(sdxODSNodeStyleHeaderStyle, ASubNode) and
    ASubNode.Attributes.Find(sdxODSAttrFOMinHeight, AAttr) then
    Margins.Header := TdxValueUnitsHelper.ValueToInches(AAttr.ValueAsString);
  if ANode.FindChild(sdxODSNodeStyleFooterStyle, ASubNode) and
    ASubNode.Attributes.Find(sdxODSAttrFOMinHeight, AAttr) then
    Margins.Footer := TdxValueUnitsHelper.ValueToInches(AAttr.ValueAsString);
  if ANode.FindChild(sdxODSNodeStylePageLayoutProperties, ASubNode) then
  begin
    if ASubNode.HasAttribute(sdxODSAttrFOMarginLeft) or
      ASubNode.HasAttribute(sdxODSAttrFOMarginRight) or
      ASubNode.HasAttribute(sdxODSAttrFOMarginBottom) or
      ASubNode.HasAttribute(sdxODSAttrFOMarginTop) then
    begin
      Margins.Left := TdxValueUnitsHelper.ValueToInchesF
        (ASubNode.Attributes.GetValueAsString(sdxODSAttrFOMarginLeft));
      Margins.Bottom := TdxValueUnitsHelper.ValueToInchesF
        (ASubNode.Attributes.GetValueAsString(sdxODSAttrFOMarginBottom));
      Margins.Right := TdxValueUnitsHelper.ValueToInchesF
        (ASubNode.Attributes.GetValueAsString(sdxODSAttrFOMarginRight));
      Margins.Top := TdxValueUnitsHelper.ValueToInchesF
        (ASubNode.Attributes.GetValueAsString(sdxODSAttrFOMarginTop));
    end;
  end;
end;

procedure TdxSpreadSheetODSReaderPageLayoutStyle.ReadPageLayoutProperties
  (ANode: TdxXMLNode);
var
  AAttr: TdxXMLNodeAttribute;
begin
  FirstPageNumber := StrToIntDef(ANode.Attributes.GetValueAsString
    (sdxODSAttrStyleFirstPageNumber), 0);

  PageSize.X := TdxValueUnitsHelper.ValueToInchesF
    (ANode.Attributes.GetValueAsString(sdxODSAttrFOPageWidth));
  PageSize.Y := TdxValueUnitsHelper.ValueToInchesF
    (ANode.Attributes.GetValueAsString(sdxODSAttrFOPageHeight));
  ...
  begin
    PageCenterHorz := dxBooleanToDefaultBoolean(SameText(AAttr.ValueAsString,
      sdxODSTableCenteringHorz) or SameText(AAttr.ValueAsString,
      sdxODSTableCenteringBoth));
    PageCenterVert := dxBooleanToDefaultBoolean(SameText(AAttr.ValueAsString,
      sdxODSTableCenteringVert) or SameText(AAttr.ValueAsString,
      sdxODSTableCenteringBoth));
  end;
end;

procedure TdxSpreadSheetODSReaderPageLayoutStyle.ReadPrintElements
  (ANode: TdxXMLNode);
var
  AAttr: TdxXMLNodeAttribute;
  AList: TStringList;
begin
  ...
  begin
    ...
    try
      AList.Text := StringReplace(AAttr.ValueAsString, ' ', #13#10,
        [rfReplaceAll]);
      Headers := dxBooleanToDefaultBoolean
        (AList.IndexOf(sdxODSValuePrintObjectHeaders) >= 0);
      GridLines := dxBooleanToDefaultBoolean
        (AList.IndexOf(sdxODSValuePrintObjectGridLines) >= 0);
    finally
      AList.Free;
    end;
  end;
...
constructor TdxSpreadSheetODSReaderRowStyle.Create(ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetODSReader);
begin
  inherited Create(ANode, AOwner);
  AutoSize := ANode.Attributes.GetValueAsBoolean(sdxODSAttrStyleRowAutoHeight);
  Size := TdxSpreadSheetODSHelper.StringToSize
    (ANode.Attributes.GetValueAsString(sdxODSAttrStyleRowHeight));
end;

{ TdxSpreadSheetODSReaderStrokeDashStyle }

constructor TdxSpreadSheetODSReaderStrokeDashStyle.Create(ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetODSReader);
begin
  inherited Create(ANode, AOwner);
...
class function TdxSpreadSheetODSReaderStrokeDashStyle.GetStyleName
  (ANode: TdxXMLNode): TdxXMLString;
begin
  Result := ANode.Attributes.GetValue(sdxODSAttrDrawName);
end;

function TdxSpreadSheetODSReaderStrokeDashStyle.DetectPenStyle
  (ANode: TdxXMLNode): TdxGPPenStyle;
const
  MaxDotSize = 4;
var
...
begin
  ...
  ADotsLength[0] := TdxSpreadSheetODSHelper.StringToSize
    (ANode.Attributes.GetValueAsString(sdxODSAttrDrawDots1Length));
  ADotsLength[1] := TdxSpreadSheetODSHelper.StringToSize
    (ANode.Attributes.GetValueAsString(sdxODSAttrDrawDots2Length));
...
procedure TdxSpreadSheetODSStyles.Add(const AName, ADisplayName: string;
  AHandle: TdxSpreadSheetCellStyleHandle);
begin
...
function TdxSpreadSheetODSStyles.TryGetValue(const AName: string;
  out AHandle: TdxSpreadSheetCellStyleHandle): Boolean;
var
  S: string;
begin
...
procedure TdxSpreadSheetODSStyles.ValueNotify(const Value
  : TdxSpreadSheetCellStyleHandle; Action: TCollectionNotification);
begin
...
constructor TdxSpreadSheetODSReader.Create(ASpreadSheet: TdxCustomSpreadSheet;
  AStream: TStream);
begin
  ...
  FParagraphStyles :=
    TdxSpreadSheetODSReaderStyleRepository<
    TdxSpreadSheetODSReaderParagraphStyle>.Create(Self);
  FStrokeDashStyles :=
    TdxSpreadSheetODSReaderStyleRepository<
    TdxSpreadSheetODSReaderStrokeDashStyle>.Create(Self);
  FMasterPageStyles :=
    TdxSpreadSheetODSReaderStyleRepository<
    TdxSpreadSheetODSReaderMasterPageStyle>.Create(Self);
  FHatchStyles :=
    TdxSpreadSheetODSReaderStyleRepository<TdxSpreadSheetODSReaderHatchStyle>.
    Create(Self);
  FHyperlinks := TStringList.Create;
  FImageStyles :=
    TdxSpreadSheetODSReaderStyleRepository<TdxSpreadSheetODSReaderImageStyle>.
    Create(Self);
  FColumnStyles :=
    TdxSpreadSheetODSReaderStyleRepository<TdxSpreadSheetODSReaderColumnStyle>.
    Create(Self);
  FRowStyles :=
    TdxSpreadSheetODSReaderStyleRepository<TdxSpreadSheetODSReaderRowStyle>.
    Create(Self);
  FTableStyles :=
    TdxSpreadSheetODSReaderStyleRepository<TdxSpreadSheetODSReaderTableStyle>.
    Create(Self);
  FGraphicStyles :=
    TdxSpreadSheetODSReaderStyleRepository<TdxSpreadSheetODSReaderGraphicStyle>.
    Create(Self);
  FGradientStyles :=
    TdxSpreadSheetODSReaderStyleRepository<
    TdxSpreadSheetODSReaderGradientStyle>.Create(Self);
  FPageLayouts :=
    TdxSpreadSheetODSReaderStyleRepository<
    TdxSpreadSheetODSReaderPageLayoutStyle>.Create(Self);
...
begin
  ...
  Result := (AMimeType = sdxODSMimeTypeSpreadSheet) or
    (AMimeType = sdxODSMimeTypeSpreadSheetTemplate);
end;
...
begin
  ...
  begin
    ExecuteSubTask(TdxSpreadSheetODSReaderStylesFileParser.Create
      (sdxODSStylesFile, Self));
    ExecuteSubTask(TdxSpreadSheetODSReaderContentFileParser.Create
      (sdxODSContentFile, Self));
    if PackageReader.Exists(sdxODSSettingsFile) then
      ExecuteSubTask(TdxSpreadSheetODSReaderSettingsFileParser.Create
        (sdxODSSettingsFile, Self));
    if PackageReader.Exists(sdxODSMetadataFile) then
      ExecuteSubTask(TdxSpreadSheetODSReaderMetadataFileParser.Create
        (sdxODSMetadataFile, Self));
...
function TdxSpreadSheetODSReader.CreateProgressHelper
...
begin
  ...
  begin
    ...
    begin
      ...
      AValue := TdxSpreadSheetODSFormula.Convert(SpreadSheet,
        TdxSpreadSheetODSFormulaParser.Tag + '[' + AValue + ']');
...
constructor TdxSpreadSheetODSReaderCustomNodeParser.Create(ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetODSReader);
begin
...
constructor TdxSpreadSheetODSReaderCustomDocumentParser.Create(const AFileName
  : AnsiString; AOwner: TdxSpreadSheetODSReader);
begin
...
begin
  ...
  if Node.FindChild([sdxODSNodeOfficeBody, sdxODSNodeOfficeSpreadSheet], ANode)
  then
    ExecuteSubTask(TdxSpreadSheetODSReaderContentSpreadSheetParser.Create
      (ANode, Owner));
end;
...
begin
  ...
  try
    ...
    SpreadSheet.OptionsBehavior.Protected := Node.Attributes.GetValueAsBoolean
      (sdxODSAttrTableStructureProtected);
  finally
    Owner.ProgressHelper.EndStage;
  end;
end;

procedure TdxSpreadSheetODSReaderContentSpreadSheetParser.
  ProcessCalculationSettings(ANode: TdxXMLNode);
const
...
begin
  ...
  begin
    AIterateCount := ASubNode.Attributes.GetValueAsInteger
      (sdxODSAttrTableSteps, 100);
    AIterate := ASubNode.Attributes.GetValue(sdxODSAttrTableStatus)
      = sdxODSValueEnable;
  end
  else
  begin
  ...
  if ANode.FindChild(sdxODSNodeTableNullDate, ASubNode) then
    AIs1904DateSystem := ASubNode.Attributes.GetValue(sdxODSAttrTableDateValue)
      = sdxODSValueNullDate1904
  else
...
procedure TdxSpreadSheetODSReaderContentSpreadSheetParser.ProcessSubNode
  (ANode: TdxXMLNode; AUserData: Pointer);
begin
  if ANode.Name = sdxODSNodeTable then
  begin
    if ANode.FindChild(sdxODSNodeTableSource) = nil then
      ExecuteSubTask(TdxSpreadSheetODSReaderTableViewParser.Create
        (ANode, Owner));
  end
  else
    ...
    if (ANode.Name = sdxODSNodeTableNamedExpressions) or
    (ANode.Name = sdxODSNodeTableDataBaseRanges) then
    ExecuteSubTask(TdxSpreadSheetODSReaderDefinedNamesParser.Create
      (ANode, Owner));
...
constructor TdxSpreadSheetODSReaderCustomContainerParser.Create
  (ANode: TdxXMLNode; AViewParser: TdxSpreadSheetODSReaderTableViewParser;
  ABaseCell: TdxSpreadSheetCell = nil);
begin
...
function TdxSpreadSheetODSReaderCustomContainerParser.CreateContainer
...
begin
  ...
  Container.AnchorPoint1.Offset :=
    cxPoint(TdxSpreadSheetODSHelper.StringToSize
    (Node.Attributes.GetValueAsString(sdxODSAttrSvgX)),
    TdxSpreadSheetODSHelper.StringToSize(Node.Attributes.GetValueAsString
    (sdxODSAttrSvgY)));
  Container.AnchorPoint2.Offset :=
    cxPoint(TdxSpreadSheetODSHelper.StringToSize
    (Node.Attributes.GetValueAsString(sdxODSAttrSvgWidth)),
    TdxSpreadSheetODSHelper.StringToSize(Node.Attributes.GetValueAsString
    (sdxODSAttrSvgHeight)));

  if Node.Attributes.Find(sdxODSAttrDrawTransform, AAttr) then
  begin
    TdxSpreadSheetODSHelper.ParseTransform(AAttr.ValueAsString, AAngle,
      AOffset);
    Dec(AOffset.Y, ColumnHeaderHeight);
    Container.AnchorPoint1.Offset :=
      cxPointOffset(Container.AnchorPoint1.Offset, AOffset);
  ...
  begin
    ...
    ViewParser.ContainersZOrder.Count := Max(ViewParser.ContainersZOrder.Count,
      AIndex + 1);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Container.AnchorPoint2.Offset :=
          cxPoint(TdxSpreadSheetODSHelper.StringToSize
          (Node.Attributes.GetValueAsString(sdxODSAttrTableEndX)),
          TdxSpreadSheetODSHelper.StringToSize(Node.Attributes.GetValueAsString
          (sdxODSAttrTableEndY)));
      end;
    end;
...
function TdxSpreadSheetODSReaderCustomContainerParser.GetCellByRef
  (const ARef: string): TdxSpreadSheetCell;
var
  AColumnIndex: Integer;
  ARowIndex: Integer;
begin
  dxStringToReference(Copy(ARef, Pos('.', ARef) + 1, MaxInt), AColumnIndex,
    ARowIndex);
...
begin
  inherited Execute;
  Container.Shape.ShapeType := TdxSpreadSheetODSHelper.DetectShapeType
    (Node.Attributes.GetValue(sdxODSAttrDrawName, Node.Name));
  if Owner.GraphicStyles.TryGetValue
    (Node.Attributes.GetValue(sdxODSAttrDrawStyleName), AStyle) then
  begin
...
function TdxSpreadSheetODSReaderShapeContainerParser.CreateContainer
  : TdxSpreadSheetContainer;
begin
  Result := ViewParser.View.Containers.Add(TdxSpreadSheetShapeContainer);
end;

function TdxSpreadSheetODSReaderShapeContainerParser.GetContainer
...
const
  Map: array [TdxSpreadSheetDataAlignHorz] of TAlignment = (taLeftJustify,
...
begin
  ...
  if Node.FindChild(sdxODSNodeText, ATextNode) or
    Node.FindChild([sdxODSAttrDrawTextBox, sdxODSNodeText], ATextNode) then
  begin
    ...
    try
      ...
      if Owner.ParagraphStyles.TryGetValue
        (ATextNode.Attributes.GetValue(sdxODSAttrTextStyleName), AParagraphStyle)
      then
...
procedure TdxSpreadSheetODSReaderCustomTextBoxContainerParser.
  ApplyStyleToTextBox(AStyle: TdxSpreadSheetODSReaderGraphicStyle);
begin
...
function TdxSpreadSheetODSReaderCustomTextBoxContainerParser.GetTextBox
...
function TdxSpreadSheetODSReaderTextBoxContainerParser.CreateContainer
  : TdxSpreadSheetContainer;
begin
...
function TdxSpreadSheetODSReaderCommentContainerParser.CreateContainer
  : TdxSpreadSheetContainer;
begin
...
begin
  ...
  Container.Visible := Node.Attributes.GetValueAsBoolean
    (sdxODSAttrOfficeDisplay);
end;
...
begin
  ...
  begin
    try
      AStream := Owner.ReadFile
        (ASubNode.Attributes.GetValue(sdxODSAttrXLinkHRef));
      try
        TdxSpreadSheetPictureAccess(Container.Picture).ImageHandle :=
          Owner.AddImage(AStream);
      finally
        AStream.Free;
      end;
    except
...
function TdxSpreadSheetODSReaderPictureContainerParser.CreateContainer
  : TdxSpreadSheetContainer;
begin
  Result := ViewParser.View.Containers.Add(TdxSpreadSheetPictureContainer);
end;

function TdxSpreadSheetODSReaderPictureContainerParser.GetContainer
...
begin
  inherited Create;
  FProcs := TDictionary<TdxXMLString,
    TdxSpreadSheetODSReaderDataFormatConverterProc>.Create;
...
function TdxSpreadSheetODSReaderDataFormatConverter.Convert
  (ANode: TdxXMLNode): string;
var
...
class function TdxSpreadSheetODSReaderDataFormatConverter.ConvertDay
  (ANode: TdxXMLNode): string;
begin
...
class function TdxSpreadSheetODSReaderDataFormatConverter.ConvertDayOfWeek
  (ANode: TdxXMLNode): string;
begin
  if IsLongStyle(ANode) then
    Result := 'dddd'
...
class function TdxSpreadSheetODSReaderDataFormatConverter.ConvertHours
  (ANode: TdxXMLNode): string;
begin
  if IsLongStyle(ANode) then
    Result := 'hh'
...
class function TdxSpreadSheetODSReaderDataFormatConverter.ConvertMinutes
  (ANode: TdxXMLNode): string;
begin
  if IsLongStyle(ANode) then
    Result := 'mm'
...
class function TdxSpreadSheetODSReaderDataFormatConverter.ConvertMonth
  (ANode: TdxXMLNode): string;
var
  AIsTextual: Boolean;
begin
  ...
  if not AIsTextual then
    Result := 'mm'
  else if IsLongStyle(ANode) then
    Result := 'mmmm'
  else
    Result := 'mmm';
end;

class function TdxSpreadSheetODSReaderDataFormatConverter.ConvertNumber
  (ANode: TdxXMLNode): string;
var
  ADecimalPlaces: Integer;
  AMinIntegerDigits: Integer;
begin
  ADecimalPlaces := ANode.Attributes.GetValueAsInteger
    (sdxODSAttrNumberDecimalPlaces);
  AMinIntegerDigits := ANode.Attributes.GetValueAsInteger
    (sdxODSAttrNumberMinIntegerDigits);

  if ADecimalPlaces > 0 then
    Result := DupeString('0', AMinIntegerDigits) + '.' +
      DupeString('0', ADecimalPlaces)
  else
    Result := DupeString('0', AMinIntegerDigits);
end;

class function TdxSpreadSheetODSReaderDataFormatConverter.ConvertSeconds
  (ANode: TdxXMLNode): string;
begin
  if IsLongStyle(ANode) then
    Result := 'ss'
...
class function TdxSpreadSheetODSReaderDataFormatConverter.ConvertText
  (ANode: TdxXMLNode): string;
begin
  Result := ANode.TextAsString;
end;

class function TdxSpreadSheetODSReaderDataFormatConverter.ConvertTextColor
  (ANode: TdxXMLNode): string;
var
  AColorIndex: Integer;
begin
  AColorIndex := dxSpreadSheetGetStandardColorIndex
    (TdxSpreadSheetODSHelper.StringToColor(ANode.Attributes.GetValueAsString
    (sdxODSAttrFOColor)));
...
class function TdxSpreadSheetODSReaderDataFormatConverter.ConvertYear
  (ANode: TdxXMLNode): string;
begin
  if IsLongStyle(ANode) then
    Result := 'yyyy'
...
class function TdxSpreadSheetODSReaderDataFormatConverter.IsLongStyle
  (ANode: TdxXMLNode): Boolean;
begin
  Result := ANode.Attributes.GetValue(sdxODSAttrNumberStyle)
    = sdxODSValueNumberStyleLong;
end;

{ TdxSpreadSheetODSReaderDefinedNamesParser }

constructor TdxSpreadSheetODSReaderDefinedNamesParser.Create(ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetODSReader; AView: TdxSpreadSheetTableView = nil);
begin
  inherited Create(ANode, AOwner);
  FView := AView;
end;
...
procedure TdxSpreadSheetODSReaderDefinedNamesParser.ParseNamedExpression
  (ANode: TdxXMLNode);
begin
end;

procedure TdxSpreadSheetODSReaderDefinedNamesParser.ParseNamedRange
  (ANode: TdxXMLNode; const AValueName: TdxXMLString);
var
  AValue: string;
begin
  ...
  SpreadSheet.DefinedNames.Add(ANode.Attributes.GetValueAsString
    (sdxODSAttrTableName), TdxSpreadSheetODSFormula.Convert(SpreadSheet,
    AValue), FView);
end;

procedure TdxSpreadSheetODSReaderDefinedNamesParser.ProcessSubNodes
  (ANode: TdxXMLNode; AUserData: Pointer);
begin
...
procedure TdxSpreadSheetODSReaderMasterStylesParser.ProcessSubNodes
  (ANode: TdxXMLNode; AUserData: Pointer);
begin
...
begin
  ...
  begin
    ...
    Owner.DataFormats.Add(Node.Attributes.GetValue(sdxODSAttrStyleName),
      AFormatCode);
  end;
end;

procedure TdxSpreadSheetODSReaderNumberFormatParser.CheckStyleMapping
  (var AFormatCode: string);
var
  ...
  try
    ...
    begin
      if ASubStyles.TryGetValue(sdxODSValueConditionAboveOrEqual, AValue1) then
        ...
        if ASubStyles.TryGetValue(sdxODSValueConditionBelowOrEqual, AValue1)
      then
        AFormatCode := AFormatCode + ';' + AFormatCode
      else

        if ASubStyles.TryGetValue(sdxODSValueConditionAbove, AValue1) and
        ASubStyles.TryGetValue(sdxODSValueConditionBelow, AValue2) then
        AFormatCode := AValue1 + ';' + AValue2 + ';' + AFormatCode
      else

        if ASubStyles.TryGetValue(sdxODSValueConditionAbove, AValue1) and
        ASubStyles.TryGetValue(sdxODSValueConditionEqual, AValue2) then
...
function TdxSpreadSheetODSReaderNumberFormatParser.PopulateSubStyles
  : TDictionary<TdxXMLString, string>;
var
  ASubNode: TdxXMLNode;
begin
  ...
  begin
    ...
    begin
      Result.Add(LowerCase(ASubNode.Attributes.GetValue
        (sdxODSAttrStyleCondition)), Owner.DataFormats.Items
        [ASubNode.Attributes.GetValue(sdxODSAttrStyleApplyStyleName)]);
    end;
    ASubNode := ASubNode.Next;
  end;
end;
...
constructor TdxSpreadSheetODSReaderRichTextHelper.Create
  (AOwner: TdxSpreadSheetODSReader);
begin
  inherited Create;
  Owner := AOwner;
...
procedure TdxSpreadSheetODSReaderRichTextHelper.Process(ANode: TdxXMLNode;
  AFont: TdxSpreadSheetFontHandle = nil);
var
...
procedure TdxSpreadSheetODSReaderRichTextHelper.AddPart(const AText: string;
  AFont: TdxSpreadSheetFontHandle = nil);
begin
  if AText <> '' then
  begin
...
procedure TdxSpreadSheetODSReaderRichTextHelper.ProcessSubNode
  (ANode: TdxXMLNode; AUserData: Pointer);
var
...
begin
  ...
  begin
    ...
    HyperlinkValue := dxXMLStringToString
      (ANode.Attributes.GetValue(sdxODSAttrXLinkHRef));
  end
  else
  begin
...
function TdxSpreadSheetODSReaderRichTextHelper.GetDefaultFontHandle
...
function TdxSpreadSheetODSReaderRichTextHelper.GetFontHandle(ANode: TdxXMLNode)
  : TdxSpreadSheetFontHandle;
var
  AStyleHandle: TdxSpreadSheetCellStyleHandle;
begin
  if (Owner <> nil) and Owner.Styles.TryGetValue
    (ANode.Attributes.GetValueAsString(sdxODSAttrTextStyleName), AStyleHandle)
  then
...
begin
  ...
  FProcs := TDictionary<TdxXMLString,
    TdxSpreadSheetODSReaderSettingsParserProc>.Create;
  ...
  FProcs.Add(sdxODSValueConfigHasColumnRowHeaders,
    CommonProcessHasColumnRowsHeaders);
  ...
  FProcs.Add(sdxODSValueConfigHorizontalSplitPosition,
    ViewProcessHorzSplitPosition);
  FProcs.Add(sdxODSValueConfigVerticalSplitPosition,
    ViewProcessVertSplitPosition);
...
procedure TdxSpreadSheetODSReaderSettingsFileParser.ProcessConfigItem
  (ANode: TdxXMLNode; AUserData: Pointer);
var
  AProc: TdxSpreadSheetODSReaderSettingsParserProc;
begin
  if FProcs.TryGetValue(ANode.Attributes.GetValue(sdxODSAttrConfigName), AProc)
  then
    AProc(ANode.TextAsString);
end;

procedure TdxSpreadSheetODSReaderSettingsFileParser.ProcessConfigSet
  (ANode: TdxXMLNode; AUserData: Pointer);
begin
  if ANode.Name = sdxODSNodeConfigConfigItemSet then
  begin
    if ANode.Attributes.GetValue(sdxODSAttrConfigName) = sdxODSValueConfigViewSettings
    then
      ANode.ForEach(ProcessConfigSetViewSettings, AUserData);
  end;
end;

procedure TdxSpreadSheetODSReaderSettingsFileParser.ProcessConfigSetTables
  (ANode: TdxXMLNode; AUserData: Pointer);
begin
  FCurrentView := SpreadSheet.GetSheetByName
    (ANode.Attributes.GetValueAsString(sdxODSAttrConfigName))
    as TdxSpreadSheetTableView;
  if FCurrentView <> nil then
    ANode.ForEach(ProcessConfigItem);
end;

procedure TdxSpreadSheetODSReaderSettingsFileParser.ProcessConfigSetViews
  (ANode: TdxXMLNode; AUserData: Pointer);
begin
  if ANode.Name = sdxODSNodeConfigConfigItem then
    ProcessConfigItem(ANode, nil)
  else if ANode.Name = sdxODSNodeConfigConfigItemMapNamed then
  begin
    if ANode.Attributes.GetValue(sdxODSAttrConfigName) = sdxODSValueConfigTables
    then
      ANode.ForEach(ProcessConfigSetTables);
  end;
end;

procedure TdxSpreadSheetODSReaderSettingsFileParser.ProcessConfigSetViewSettings
  (ANode: TdxXMLNode; AUserData: Pointer);
begin
  if ANode.Name = sdxODSNodeConfigConfigItemMapIndexed then
  begin
    if ANode.Attributes.GetValue(sdxODSAttrConfigName) = sdxODSValueConfigViews
    then
    begin
...
procedure TdxSpreadSheetODSReaderSettingsFileParser.BothProcessShowGrid
  (const AValue: string);
begin
  if FCurrentView <> nil then
    FCurrentView.Options.GridLines := dxBooleanToDefaultBoolean
      (TdxXMLHelper.DecodeBoolean(AValue))
  else
    SpreadSheet.OptionsView.GridLines := TdxXMLHelper.DecodeBoolean(AValue);
end;

procedure TdxSpreadSheetODSReaderSettingsFileParser.BothProcessZoomValue
  (const AValue: string);
begin
  if FCurrentView <> nil then
...
procedure TdxSpreadSheetODSReaderSettingsFileParser.CommonProcessActiveTable
  (const AValue: string);
begin
  SpreadSheet.ActiveSheet := SpreadSheet.GetSheetByName(AValue);
end;

procedure TdxSpreadSheetODSReaderSettingsFileParser.
  CommonProcessHasColumnRowsHeaders(const AValue: string);
begin
  SpreadSheet.OptionsView.Headers := TdxXMLHelper.DecodeBoolean(AValue);
end;

procedure TdxSpreadSheetODSReaderSettingsFileParser.CommonProcessShowZeroValues
  (const AValue: string);
begin
  SpreadSheet.OptionsView.ZeroValues := TdxXMLHelper.DecodeBoolean(AValue);
end;

procedure TdxSpreadSheetODSReaderSettingsFileParser.ViewProcessCursorX
  (const AValue: string);
begin
  if FCurrentView <> nil then
...
procedure TdxSpreadSheetODSReaderSettingsFileParser.ViewProcessCursorY
  (const AValue: string);
begin
  if FCurrentView <> nil then
...
procedure TdxSpreadSheetODSReaderSettingsFileParser.ViewProcessPositionBottom
  (const AValue: string);
begin
  if FCurrentView <> nil then
    TdxSpreadSheetTableViewAccess(FCurrentView).ViewInfo.FirstScrollableRow :=
      StrToIntDef(AValue, 0);
end;

procedure TdxSpreadSheetODSReaderSettingsFileParser.ViewProcessPositionLeft
  (const AValue: string);
begin
  if (FCurrentView <> nil) and (FCurrentView.FrozenColumn < 0) then
    TdxSpreadSheetTableViewAccess(FCurrentView).ViewInfo.FirstScrollableColumn
      := StrToIntDef(AValue, 0);
end;

procedure TdxSpreadSheetODSReaderSettingsFileParser.ViewProcessPositionRight
  (const AValue: string);
begin
  if (FCurrentView <> nil) and (FCurrentView.FrozenColumn >= 0) then
    TdxSpreadSheetTableViewAccess(FCurrentView).ViewInfo.FirstScrollableColumn
...
procedure TdxSpreadSheetODSReaderSettingsFileParser.ViewProcessHorzSplitPosition
  (const AValue: string);
begin
  if FCurrentView <> nil then
...
procedure TdxSpreadSheetODSReaderSettingsFileParser.ViewProcessVertSplitPosition
  (const AValue: string);
begin
  if FCurrentView <> nil then
...
function TdxSpreadSheetODSReaderMetadataFileParser.ReadDateTime
  (AParentNode: TdxXMLNode; const AValueName: AnsiString): TDateTime;
begin
...
function TdxSpreadSheetODSReaderMetadataFileParser.ReadText
  (AParentNode: TdxXMLNode; const AValueName: AnsiString): string;
begin
  if AParentNode.FindChild(AValueName, AParentNode) then
...
function TdxSpreadSheetODSReaderMetadataFileParser.GetMetadata
...
begin
  ...
  if ParseStyle(AStyleHandle) then
    Owner.Styles.Add(Node.Attributes.GetValueAsString(sdxODSAttrStyleName),
      Node.Attributes.GetValueAsString(sdxODSAttrStyleDisplayName),
      AStyleHandle);
end;

procedure TdxSpreadSheetODSReaderStyleParser.ParseBackgroundProperties
  (AHandle: TdxSpreadSheetCellStyleHandle; ANode: TdxXMLNode);
var
  AAttr: TdxXMLNodeAttribute;
begin
  ...
  if ANode.Attributes.Find(sdxODSAttrStyleShrinkToFit, AAttr) and AAttr.ValueAsBoolean
  then
...
procedure TdxSpreadSheetODSReaderStyleParser.ParseBorder
  (AHandle: TdxSpreadSheetBordersHandle; ASide: TcxBorder; const S: string);
var
  AList: TStringList;
begin
  AList := TStringList.Create;
  try
    ...
    begin
      if AList.Count > 1 then
        AHandle.BorderStyle[ASide] :=
          TdxSpreadSheetODSHelper.StringToBorderStyle(AList[0], AList[1])
      else
        AHandle.BorderStyle[ASide] :=
          TdxSpreadSheetODSHelper.StringToBorderStyle(AList[0], '');

      if AList.Count > 2 then
        AHandle.BorderColor[ASide] := TdxSpreadSheetODSHelper.StringToColor
          (AList[2]);
    end;
  finally
    AList.Free;
...
procedure TdxSpreadSheetODSReaderStyleParser.ParseBorders
  (AHandle: TdxSpreadSheetCellStyleHandle; ANode: TdxXMLNode);
var
  AAttr: TdxXMLNodeAttribute;
...
procedure TdxSpreadSheetODSReaderStyleParser.ParseBrush
  (AHandle: TdxSpreadSheetCellStyleHandle; ANode: TdxXMLNode);
var
  AAttr: TdxXMLNodeAttribute;
...
begin
  ...
  begin
    ...
    ABrushHandle.BackgroundColor := TdxSpreadSheetODSHelper.StringToColor
      (AAttr.ValueAsString);
    AHandle.Brush := Owner.AddBrush(ABrushHandle);
  end;
end;

procedure TdxSpreadSheetODSReaderStyleParser.ParseFontProperties
  (AHandle: TdxSpreadSheetCellStyleHandle; ANode: TdxXMLNode);
var
  AAttr: TdxXMLNodeAttribute;
...
begin
  ...
  if ANode.Attributes.Find(sdxODSAttrFOColor, AAttr) then
    AFontHandle.Color := TdxSpreadSheetODSHelper.StringToColor
      (AAttr.ValueAsString);
  if ANode.Attributes.Find(sdxODSAttrFOFontSize, AAttr) then
    AFontHandle.Size := TdxSpreadSheetODSHelper.StringToFontSize
      (AAttr.ValueAsString);
  ...
  if ANode.Attributes.Find(sdxODSAttrFOFontStyle, AAttr) and
    (AAttr.Value = sdxODSValueFontStyleItalic) then
    Include(AFontHandle.Style, fsItalic);
  if ANode.Attributes.Find(sdxODSAttrStyleTextUnderlineStyle, AAttr) and
    (AAttr.Value <> sdxODSValueBorderStyleNone) then
    Include(AFontHandle.Style, fsUnderline);
  if ANode.Attributes.Find(sdxODSAttrStyleTextLineThroughStyle, AAttr) and
    (AAttr.Value <> sdxODSValueBorderStyleNone) then
    Include(AFontHandle.Style, fsStrikeOut);
  if ANode.Attributes.Find(sdxODSAttrFOFontWeight, AAttr) and
    TdxSpreadSheetODSHelper.IsBoldFontStyle(AAttr.Value) then
    Include(AFontHandle.Style, fsBold);
  AHandle.Font := Owner.AddFont(AFontHandle);
end;

procedure TdxSpreadSheetODSReaderStyleParser.ParseParagraphProperties
  (AHandle: TdxSpreadSheetCellStyleHandle; ANode: TdxXMLNode);
begin
  AHandle.AlignHorz := TdxSpreadSheetODSHelper.StringToAlignHorz
    (ANode.Attributes.GetValue(sdxODSAttrFOTextAlign));
  AHandle.AlignHorzIndent := TdxSpreadSheetODSHelper.StringToSize
    (ANode.Attributes.GetValueAsString(sdxODSAttrFOMarginLeft));
end;

function TdxSpreadSheetODSReaderStyleParser.ParseStyle(out AStyleHandle
  : TdxSpreadSheetCellStyleHandle): Boolean;

  function CheckStyleHandle(var AHandle: TdxSpreadSheetCellStyleHandle)
...
begin
  ...
  begin
    if Owner.DataFormats.TryGetValue(AAttr.Value, ADataFormat) then
      CheckStyleHandle(AStyleHandle).DataFormat :=
        Owner.AddNumberFormat(ADataFormat);
  end;
...
procedure TdxSpreadSheetODSReaderStylesParser.ProcessSubNode(ANode: TdxXMLNode;
  AUserData: Pointer);
begin
  if ANode.Name = sdxODSNodeStyle then
    ...
    ExecuteSubTask(TdxSpreadSheetODSReaderNumberFormatParser.Create
      (ANode, Owner))
  else
...
begin
  ...
  if Node.FindChild(sdxODSNodeOfficeMasterStyles, ASubNode) then
    ExecuteSubTask(TdxSpreadSheetODSReaderMasterStylesParser.Create
      (ASubNode, Owner));
end;

{ TdxSpreadSheetODSReaderTableViewParser }

constructor TdxSpreadSheetODSReaderTableViewParser.Create(ANode: TdxXMLNode;
  AOwner: TdxSpreadSheetODSReader);
begin
  inherited Create(ANode, AOwner);
  FView := Owner.AddTableView(Node.Attributes.GetValueAsString
    (sdxODSAttrTableName));
...
var
  ...
  ASubNode: TdxXMLNode;
begin
  View.Options.Protected := Node.Attributes.GetValueAsBoolean
    (sdxODSAttrTableProtected);
  if Owner.TableStyles.TryGetValue
    (Node.Attributes.GetValue(sdxODSAttrTableStyleName), AStyle) then
    AStyle.ApplyTo(View);
  ...
  if Node.FindChild(sdxODSNodeTableNamedExpressions, ASubNode) then
    ExecuteSubTask(TdxSpreadSheetODSReaderDefinedNamesParser.Create(ASubNode,
      Owner, FView));
  Node.ForEach(ProcessSubNode);
...
begin
  ...
  begin
    ...
    begin
      if (ADefinedName.Caption = sdxODSValuePrintArea) or
        (ADefinedName.Caption = sdxODSValuePrintArea2) then
        TdxSpreadSheetPrintAreasHelper.ImportPrintArea(ADefinedName);
    end;
  end;

  if Node.Attributes.Find(sdxODSAttrTablePrintRanges, AAttr) and
    (AAttr.Value <> '') then
  begin
    TdxSpreadSheetPrintAreasHelper.ImportPrintArea
      (SpreadSheet.DefinedNames.Add(sdxODSValuePrintArea,
      TdxSpreadSheetODSFormula.Convert(SpreadSheet,
      TdxSpreadSheetODSFormulaParser.Tag + '[' + AAttr.ValueAsString +
      ']'), View));
  end;
end;

procedure TdxSpreadSheetODSReaderTableViewParser.ProcessColumnGroup
  (ANode: TdxXMLNode);
var
...
begin
  ...
  try
    ...
    AGroup := TdxSpreadSheetTableItemGroupAccess
      (ColumnGroups.Find(FColumnIndex));
    ANode.ForEach(ProcessSubNode);
    if AGroup.StartIndex < FColumnIndex then
    begin
      AGroup.FCollapsedByUser := not ANode.Attributes.GetValueAsBoolean
        (sdxODSAttrTableDisplay, True);
...
procedure TdxSpreadSheetODSReaderTableViewParser.ProcessConditionalFormat
  (ANode: TdxXMLNode; AUserData: Pointer);
begin
  ExecuteSubTask(TdxSpreadSheetODSReaderConditionalFormatParser.Create
    (ANode, Self));
end;

procedure TdxSpreadSheetODSReaderTableViewParser.ProcessDrawObject
  (ANode: TdxXMLNode; AUserData: Pointer);
var
...
begin
  ...
  if AParserClass <> nil then
    ExecuteSubTask(AParserClass.Create(ANode, Self,
      TdxSpreadSheetCell(AUserData)));
end;

procedure TdxSpreadSheetODSReaderTableViewParser.ProcessRowGroup
  (ANode: TdxXMLNode);
var
  AGroup: TdxSpreadSheetTableItemGroupAccess;
begin
...
procedure TdxSpreadSheetODSReaderTableViewParser.ProcessSubNode
  (ANode: TdxXMLNode; AUserData: Pointer);
begin
...
function TdxSpreadSheetODSReaderTableViewParser.GetColumnGroups
  : TdxSpreadSheetTableItemGroups;
begin
  Result := View.Columns.Groups;
end;

function TdxSpreadSheetODSReaderTableViewParser.GetRowGroups
  : TdxSpreadSheetTableItemGroups;
begin
...
constructor TdxSpreadSheetODSReaderTableItemParser.Create(ANode: TdxXMLNode;
  ATableViewParser: TdxSpreadSheetODSReaderTableViewParser);
begin
...
function TdxSpreadSheetODSReaderTableItemParser.ConvertReference
  (const S: string): string;
begin
  Result := TdxSpreadSheetODSFormula.Convert(SpreadSheet,
    TdxSpreadSheetODSFormulaParser.Tag + S);
end;

function TdxSpreadSheetODSReaderTableItemParser.GetCellStyle(ANode: TdxXMLNode;
  const AAttrName: TdxXMLString; ACanBeNil: Boolean)
  : TdxSpreadSheetCellStyleHandle;
begin
  if not Owner.Styles.TryGetValue(ANode.Attributes.GetValueAsString(AAttrName),
    Result) then
  begin
    if ACanBeNil then
      Result := nil
...
function TdxSpreadSheetODSReaderTableItemParser.GetTableView
...
begin
  ...
  AColumnStyle := Owner.ColumnStyles.GetValueOrNil
    (Node.Attributes.GetValue(sdxODSAttrTableStyleName));
  ACount := Max(1, Node.Attributes.GetValueAsInteger
    (sdxODSAttrTableNumberColumnsRepeated));
  AVisible := Node.Attributes.GetValue(sdxODSAttrTableVisibility) <>
    sdxODSValueTableVisibilityHidden;
...
begin
  ACount := Max(1, Node.Attributes.GetValueAsInteger
    (sdxODSAttrTableNumberRowsRepeated));
  ARowStyle := Owner.RowStyles.GetValueOrNil
    (Node.Attributes.GetValue(sdxODSAttrTableStyleName));
  AVisible := Node.Attributes.GetValue(sdxODSAttrTableVisibility) <>
    sdxODSValueTableVisibilityHidden;
...
procedure TdxSpreadSheetODSReaderTableRowParser.ParseCellTextValue
  (ATextNode: TdxXMLNode; ACell: TdxSpreadSheetCell);
var
  AFormattedString: TdxSpreadSheetFormattedSharedString;
  AHelper: TdxSpreadSheetODSReaderRichTextHelper;
begin
  ...
  begin
    ...
    try
      ...
      if AHelper.HyperlinkValue <> '' then
        Owner.Hyperlinks.AddObject(AHelper.HyperlinkValue,
          TableView.Hyperlinks.Add(ACell.RowIndex, ACell.ColumnIndex));
    finally
      AHelper.Free;
    end;
  end
...
procedure TdxSpreadSheetODSReaderTableRowParser.ParseCellValue
  (ANode: TdxXMLNode; ACell: TdxSpreadSheetCell);
var
  AAttr: TdxXMLNodeAttribute;
begin
  ...
  begin
    Owner.Formulas.Add(ACell, AAttr.ValueAsString,
      (ANode.Attributes.GetValueAsInteger(sdxODSAttrTableNumberColumnsSpanned) >
      0) or (ANode.Attributes.GetValueAsInteger
      (sdxODSAttrTableNumberRowsSpanned) > 0), False, cxNullRect);
  end
  else
    case TdxSpreadSheetODSHelper.StringToValueType
      (ANode.Attributes.GetValue(sdxODSAttrOfficeValueType)) of
      sovtBoolean:
        ACell.AsBoolean := ANode.Attributes.GetValueAsBoolean
          (sdxODSAttrOfficeBooleanValue);
      sovtTime:
        ACell.AsFloat := TdxSpreadSheetODSHelper.StringToTime
          (ANode.Attributes.GetValue(sdxODSAttrOfficeTimeValue));
      sovtCurrency:
        ACell.AsCurrency := ANode.Attributes.GetValueAsFloat
          (sdxODSAttrOfficeValue);
      sovtDate:
        ACell.AsDateTime := dxRealDateTimeToDateTime
          (TdxSpreadSheetODSHelper.StringToDate(ANode.Attributes.GetValue
          (sdxODSAttrOfficeDateValue)),
          SpreadSheet.OptionsView.ActualDateTimeSystem);
      sovtPercentage, sovtFloat:
        ACell.AsFloat :=
          StrToFloatDef(ANode.Attributes.GetValueAsString
          (sdxODSAttrOfficeValue), 0, dxInvariantFormatSettings);
      sovtString:
        if ANode.Attributes.Find(sdxODSAttrOfficeStringValue, AAttr) then
          ACell.AsString := AAttr.ValueAsString
        else if ANode.FindChild(sdxODSNodeText, ANode) then
          ParseCellTextValue(ANode, ACell);
    end;
end;

procedure TdxSpreadSheetODSReaderTableRowParser.PostProcessCells
  (ARow: TdxSpreadSheetTableRow);
begin
  TdxSpreadSheetTableRowCellsAccess(TdxSpreadSheetTableRowAccess(ARow).RowCells)
    ...
    begin
      ...
      begin
        if not(Owner.Formulas.HasCell(ACell) or ACell.View.Containers.IsCellUsed
          (ACell)) then
          AItem.Free;
      end;
    end);
...
procedure TdxSpreadSheetODSReaderTableRowParser.ProcessCell(ANode: TdxXMLNode;
AUserData: Pointer);
var
  ACell: TdxSpreadSheetCell;
  AColsSpan: Integer;
...
begin
  ...
  ARangeSize := ANode.Attributes.GetValueAsInteger
    (sdxODSAttrTableNumberColumnsRepeated);
  ...
  AColsSpan := Max(1, ANode.Attributes.GetValueAsInteger
    (sdxODSAttrTableNumberColumnsSpanned));
  ARowsSpan := Max(1, ANode.Attributes.GetValueAsInteger
    (sdxODSAttrTableNumberRowsSpanned));
  if (ARowsSpan > 1) or (AColsSpan > 1) then
    TableView.MergedCells.Add(cxRectBounds(ACell.ColumnIndex, ACell.RowIndex,
      AColsSpan - 1, ARowsSpan - 1));
...
begin
  ...
  if ACellStyle <> nil then
  begin
    if ARow.Style.IsDefault and (ARangeSize > 100) and not ANode.HasChildren
    then
...
begin
  ...
  begin
    ...
    if ARule <> nil then
      ARule.Area := dxStringToReferenceArea
        (StringReplace(Node.Attributes.GetValueAsString
        (sdxODSAttrCalcExtTargetRangeAddress), TableView.Caption + '.', '',
...
function TdxSpreadSheetODSReaderConditionalFormatParser.CreateAverageRule
  (ANode: TdxXMLNode;
AOperator:
  TdxSpreadSheetConditionalFormattingRuleAboveOrBelowAverageComparisonOperator)
  : TdxSpreadSheetConditionalFormattingRuleAboveOrBelowAverage;
begin
  Result := TdxSpreadSheetConditionalFormattingRuleAboveOrBelowAverage.Create
    (TableView.ConditionalFormatting);
  Result.BeginUpdate;
  try
...
const AExpression1, AExpression2: string; ANode: TdxXMLNode)
  : TdxSpreadSheetConditionalFormattingRuleCellIs;
begin
  Result := TdxSpreadSheetConditionalFormattingRuleCellIs.Create
    (TableView.ConditionalFormatting);
  Result.BeginUpdate;
  try
...
function TdxSpreadSheetODSReaderConditionalFormatParser.
  CreateDuplicateValuesRule(ANode: TdxXMLNode)
  : TdxSpreadSheetConditionalFormattingRuleDuplicateValues;
begin
  Result := TdxSpreadSheetConditionalFormattingRuleDuplicateValues.Create
    (TableView.ConditionalFormatting);
  ReadStyle(ANode, Result);
end;

function TdxSpreadSheetODSReaderConditionalFormatParser.CreateExpressionRule
  (const AExpression: string; ANode: TdxXMLNode)
  : TdxSpreadSheetConditionalFormattingRuleExpression;
begin
  Result := TdxSpreadSheetConditionalFormattingRuleExpression.Create
    (TableView.ConditionalFormatting);
  Result.BeginUpdate;
  try
...
function TdxSpreadSheetODSReaderConditionalFormatParser.CreateTopBottomRule
  (ANode: TdxXMLNode;
...
AValue: Integer): TdxSpreadSheetConditionalFormattingRuleTopBottomValues;
begin
  Result := TdxSpreadSheetConditionalFormattingRuleTopBottomValues.Create
    (TableView.ConditionalFormatting);
  Result.BeginUpdate;
  try
...
begin
  Result := TdxSpreadSheetConditionalFormattingRuleUniqueValues.Create
    (TableView.ConditionalFormatting);
  ReadStyle(ANode, Result);
end;

function TdxSpreadSheetODSReaderConditionalFormatParser.TryCreateCellIsRule
  (const ACondition: string; ANode: TdxXMLNode)
  : TdxSpreadSheetCustomConditionalFormattingRule;
const
  BetweenOpName = 'between';
  BetweenOpMap: array [Boolean]
    of TdxSpreadSheetConditionalFormattingRuleCellIsComparisonOperator =
...
begin
  for AComparisonOperator := Low(AComparisonOperator)
    to High(AComparisonOperator) do
  begin
    if IsBeginsWith(CellIsOpMap[AComparisonOperator], ACondition) then
      Exit(CreateCellIsRule(AComparisonOperator,
        ConvertReference(Copy(ACondition,
        Length(CellIsOpMap[AComparisonOperator]), MaxInt)), '', ANode));
  end;

  if CheckFunctionAndExtractParams(BetweenOpName, ACondition, AExpressions) or
    CheckFunctionAndExtractParams('not-' + BetweenOpName, ACondition,
    AExpressions) then
    try
      if AExpressions.Count = 2 then
      begin
        Exit(CreateCellIsRule(BetweenOpMap[IsBeginsWith(BetweenOpName,
          ACondition)], ConvertReference(AExpressions[0]),
          ConvertReference(AExpressions[1]), ANode));
      end;
    finally
      AExpressions.Free;
    end;
...
begin
  ...
  if CheckFunctionAndExtractParams(AFuncName, ACondition, AExpressions) then
    try
      ...
      if Result then
        ARule := CreateTopBottomRule(ANode, ADirection, AValueType,
          StrToIntDef(AExpressions[0], 10));
    finally
      AExpressions.Free;
    end;
end;
...
function TdxSpreadSheetODSReaderConditionalFormatParser.
  CheckFunctionAndExtractParams(const AFuncName, ACondition: string;
out AParams: TStringList): Boolean;
var
...
begin
  ...
  begin
    ...
    try
      AParams := AParser.ExtractParams(Copy(ACondition, Length(AFuncName) + 2,
        Length(ACondition) - Length(AFuncName) - 2));
    finally
      AParser.Free;
    end;
  end;
...
function TdxSpreadSheetODSReaderConditionalFormatParser.IsBeginsWith
  (const ATestString, AFullString: string): Boolean;
begin
  Result := (Length(AFullString) > Length(ATestString)) and
    CompareMem(@ATestString[1], @AFullString[1], Length(ATestString) *
    SizeOf(Char));
end;
...
begin
  ...
  AStop.Color := TdxSpreadSheetODSHelper.StringToColor
    (ANode.Attributes.GetValueAsString(sdxODSAttrCalcExtColor));
end;
...
ANode: TdxXMLNode);
  ...
  function ReadValueType(const S: AnsiString)
    : TdxSpreadSheetConditionalFormattingRuleCustomScaleStopValueType;
  const
    Map: array [TdxSpreadSheetConditionalFormattingRuleCustomScaleStopValueType]
      of AnsiString = ('', sdxODSValueTypeNumber, sdxODSValueTypePercent,
      sdxODSValueTypeFormula, sdxODSValueTypePercentile);
  var
...
begin
  AStop.ValueType := ReadValueType
    (ANode.Attributes.GetValue(sdxODSAttrCalcExtType));
  case AStop.ValueType of
    cssvtFormula:
      AStop.Value := ConvertReference
        (Copy(ANode.Attributes.GetValueAsString(sdxODSAttrCalcExtValue),
        2, MaxInt));
...
var
  AStyleHandle: TdxSpreadSheetCellStyleHandle;
begin
  if Owner.Styles.TryGetValue(ANode.Attributes.GetValueAsString
    (sdxODSAttrCalcExtStyleName), AStyleHandle) then
...
begin
  case ANode.Count of
    2:
      Result := TdxSpreadSheetConditionalFormattingRuleTwoColorScale.Create
        (TableView.ConditionalFormatting);
    3:
      Result := TdxSpreadSheetConditionalFormattingRuleThreeColorScale.Create
        (TableView.ConditionalFormatting);
  else
    Result := nil;
  end;
  ...
  begin
    ...
    begin
      ReadColorScaleStop
        (TdxSpreadSheetConditionalFormattingRuleCustomColorScaleAccess(Result)
        .Stops[AIndex], ANode);
      ANode := ANode.Next;
      Inc(AIndex);
    end;
...
function TdxSpreadSheetODSReaderConditionalFormatParser.CreateDataBarRule
  ...
  function ReadColor(const AAttrName: TdxXMLString;
  ...
  function DecodeAxisPosition(const S: TdxXMLString)
...
begin
  Result := TdxSpreadSheetConditionalFormattingRuleDataBar.Create
    (TableView.ConditionalFormatting);
  Result.Style.AxisPosition := DecodeAxisPosition
    (ANode.Attributes.GetValue(sdxODSAttrCalcExtAxisPosition));
  Result.Style.AxisColor := ReadColor(sdxODSAttrCalcExtAxisColor, clNone);
  Result.Style.NegativeBarColor := ReadColor(sdxODSAttrCalcExtNegativeColor,
    clDefault);
  Result.Style.PositiveBarColor :=
    ReadColor(sdxODSAttrCalcExtPositiveColor, $EF8B00);
...
var
  I: Integer;
begin
  Result := TdxSpreadSheetConditionalFormattingRuleIconSet.Create
    (TableView.ConditionalFormatting);
  Result.PresetName := ANode.Attributes.GetValueAsString
    (sdxODSAttrCalcExtIconSetType);
...
begin
  ...
  if TryCreateTopBottomRule('top', ACondition, ANode, tbvdTop, tbvvtRank,
    Result) or TryCreateTopBottomRule('top-percent', ACondition, ANode, tbvdTop,
    tbvvtPercent, Result) or TryCreateTopBottomRule('bottom', ACondition, ANode,
    tbvdBottom, tbvvtRank, Result) or TryCreateTopBottomRule('bottom-percent',
    ACondition, ANode, tbvdBottom, tbvvtPercent, Result) then
    Exit;
