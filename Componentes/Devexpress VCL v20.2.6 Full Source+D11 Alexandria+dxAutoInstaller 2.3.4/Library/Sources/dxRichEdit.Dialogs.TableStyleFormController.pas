...
uses
  SysUtils, Classes, Graphics, Types, Generics.Defaults, Generics.Collections,
  dxCoreGraphics,
...
type
  ...
  TdxTableStyleFormControllerParametersBase = class abstract
    (TdxFormControllerParameters)
  strict private
    FCurrentStyleEnabled: Boolean;
  public
    constructor Create(const AControl: IdxRichEditControl);
    property CurrentStyleEnabled: Boolean read FCurrentStyleEnabled
      write FCurrentStyleEnabled;
  end;

  { TdxTableStyleFormControllerParameters }

  TdxTableStyleFormControllerParameters = class
    (TdxTableStyleFormControllerParametersBase)
  strict private
    FTableSourceStyle: TdxTableStyle;
  public
    constructor Create(const AControl: IdxRichEditControl;
      ASourceStyle: TdxTableStyle);
    property TableSourceStyle: TdxTableStyle read FTableSourceStyle
      write FTableSourceStyle;
  end;
  ...
  protected
    ...
    function GetColumnWidth(const ARichEditControl: IdxRichEditControl)
      : Integer;
    function InitializeTable(const ARichEditControl: IdxRichEditControl)
      : TdxTable;
    procedure SetCurrentStyle(ATempTable: TdxTable); virtual; abstract;
  public
    constructor Create(const APreviewStyleControl: IdxRichEditControl;
      AParameters: TdxFormControllerParameters);
    ...
    function GetMergedWithDefaultCharacterProperties
      : TdxMergedCharacterProperties; virtual; abstract;
    ...
    function GetParentParagraphProperties: TdxParagraphFormattingInfo;
      virtual; abstract;
    function GetParentParagraphPropertiesOptions: TdxParagraphFormattingOptions;
      virtual; abstract;
    function GetParentTableCellProperties: TdxTableCellGeneralSettingsInfo;
      virtual; abstract;
    function GetParentTableCellPropertiesOptions: TdxTableCellPropertiesOptions;
      virtual; abstract;
    procedure AddStyle; virtual; abstract;
    procedure ChangeConditionalCurrentBackgroundColorValue
      (AIsChecked: TdxAlphaColor);
    ...
    procedure ChangeConditionalCurrentFontUnderlineTypeValue
      (AIsChecked: TdxUnderlineType);
    ...
    procedure ChangeConditionalCurrentAlignmentValue(AVerticalAlignment
      : TdxVerticalAlignment; AParagraphAlignment: TdxParagraphAlignment);
    procedure CopyCharacterPropertiesFromMerged(const AMergedProperties
      : TdxMergedCharacterProperties); overload;
    procedure CopyParagraphPropertiesFromMerged(const AMergedProperties
    ...
    property ConditionalStyleType: TdxConditionalTableStyleFormattingType
      read FConditionalStyleType write FConditionalStyleType;
  ...
  protected
    ...
    function GetConditionalStyleProperties
      : TdxTableConditionalStyleProperties; override;
  ...
  public
    ...
    function GetMergedTableCellProperties
      : TdxMergedTableCellProperties; override;
    ...
    function GetParentParagraphPropertiesOptions
      : TdxParagraphFormattingOptions; override;
    function GetParentTableCellProperties
      : TdxTableCellGeneralSettingsInfo; override;
    function GetParentTableCellPropertiesOptions
      : TdxTableCellPropertiesOptions; override;
    function GetParentConditionalCharacterProperties
      : TdxCharacterFormattingInfo;
    function GetParentConditionalParagraphProperties
      : TdxParagraphFormattingInfo;
    function GetParentConditionalParagraphPropertiesOptions
      : TdxParagraphFormattingOptions;
    function GetParentConditionalTableCellProperties
      : TdxTableCellGeneralSettingsInfo;
    function GetParentConditionalTableCellPropertiesOptions
    ...
    property ConditionalStyleParent: TdxTableStyle
      read GetConditionalStyleParent;
...
constructor TdxTableStyleFormControllerParametersBase.Create(const AControl
  : IdxRichEditControl);
begin
...
constructor TdxTableStyleFormControllerParameters.Create(const AControl
  : IdxRichEditControl; ASourceStyle: TdxTableStyle);
begin
  inherited Create(AControl);
...
constructor TdxTableStyleFormControllerBase.Create(const APreviewStyleControl
  : IdxRichEditControl; AParameters: TdxFormControllerParameters);
begin
  inherited Create;
  ...
  FTableContent := TArray<string>.Create(' ',
    ...
    cxGetResourceString(@sdxRichEditTableStyleDialogPreviewTableRow1), '7', '7',
    '5', '19', cxGetResourceString
    (@sdxRichEditTableStyleDialogPreviewTableRow2), '6', '4', '7', '17',
    cxGetResourceString(@sdxRichEditTableStyleDialogPreviewTableRow3), '8', '7',
    '9', '24', cxGetResourceString
    (@sdxRichEditTableStyleDialogPreviewTableTotal), '21', '18', '21', '60');
end;

function TdxTableStyleFormControllerBase.GetCharacterPropertyAccessor
  : TdxCharacterPropertyAccessor;
begin
  Result := TdxCharacterPropertyAccessor.Create(CharacterProperties,
    GetParentCharacterProperties);
end;

procedure TdxTableStyleFormControllerBase.ChangeConditionalCurrentAlignmentValue
...
function TdxTableStyleFormControllerBase.GetColumnWidth(const ARichEditControl
  : IdxRichEditControl): Integer;
var
...
function TdxTableStyleFormControllerBase.GetParagraphPropertyAccessor
  : TdxParagraphPropertyAccessor;
begin
  Result := TdxParagraphPropertyAccessor.Create(ParagraphProperties,
    GetParentParagraphProperties, GetParentParagraphPropertiesOptions);
end;

function TdxTableStyleFormControllerBase.GetTableCellPropertyAccessor
  : TdxTableCellPropertyAccessor;
begin
  Result := TdxTableCellPropertyAccessor.Create(TableCellProperties,
    GetParentTableCellProperties, GetParentTableCellPropertiesOptions);
end;

function TdxTableStyleFormControllerBase.InitializeTable(const ARichEditControl
  : IdxRichEditControl): TdxTable;
var
  AModel: TdxDocumentModel;
...
begin
  ...
  ATempTable := ATarget.InsertTable(AModel.Selection.&End, 5, 5,
    TdxTableAutoFitBehaviorType.FixedColumnWidth, MinInt,
...
procedure TdxTableStyleFormControllerBase.FillTempRichEdit
...
begin
  ...
  AAllTypes := [TdxConditionalTableStyleFormattingType.WholeTable ..
    TdxConditionalTableStyleFormattingType.BottomLeftCell];
  TdxEditStyleHelper.ChangeConditionalType(ATempTable, AAllTypes);
end;

procedure TdxTableStyleFormControllerBase.
  ChangeConditionalCurrentBackgroundColorValue(AIsChecked: TdxAlphaColor);
var
...
procedure TdxTableStyleFormControllerBase.
  ChangeConditionalCurrentDoubleFontSizeValue(AIsChecked: Integer);
var
...
procedure TdxTableStyleFormControllerBase.ChangeConditionalCurrentFontBoldValue
  (AIsChecked: Boolean);
var
  AAccessor: TdxCharacterPropertyAccessor;
begin
...
procedure TdxTableStyleFormControllerBase.
  ChangeConditionalCurrentFontItalicValue(AIsChecked: Boolean);
var
  AAccessor: TdxCharacterPropertyAccessor;
begin
  AddStyle;
...
procedure TdxTableStyleFormControllerBase.ChangeConditionalCurrentFontNameValue
  (const AIsChecked: string);
var
  AAccessor: TdxCharacterPropertyAccessor;
begin
  AddStyle;
...
procedure TdxTableStyleFormControllerBase.
  ChangeConditionalCurrentFontUnderlineTypeValue(AIsChecked: TdxUnderlineType);
var
  AAccessor: TdxCharacterPropertyAccessor;
begin
  AddStyle;
...
procedure TdxTableStyleFormControllerBase.ChangeConditionalCurrentForeColorValue
  (AIsChecked: TdxAlphaColor);
var
  AAccessor: TdxCharacterPropertyAccessor;
begin
...
procedure TdxTableStyleFormControllerBase.CopyCharacterPropertiesFromMerged
  (const AMergedProperties: TdxMergedCharacterProperties);
var
...
begin
  ...
  try
    AAccessor := GetCharacterPropertyAccessor;
    try
      if ACharacterProperties.Info.FontName <> AMergedCharacterProperties.FontName
      then
        AAccessor.ChangeFontName(AMergedCharacterProperties.FontName);
      if ACharacterProperties.Info.FontBold <> AMergedCharacterProperties.FontBold
      then
        AAccessor.ChangeFontBold(AMergedCharacterProperties.FontBold);
      if ACharacterProperties.Info.FontItalic <> AMergedCharacterProperties.FontItalic
      then
        AAccessor.ChangeFontItalic(AMergedCharacterProperties.FontItalic);
      if ACharacterProperties.Info.DoubleFontSize <> AMergedCharacterProperties.DoubleFontSize
      then
        AAccessor.ChangeDoubleFontSize
          (AMergedCharacterProperties.DoubleFontSize);
      if ACharacterProperties.Info.ForeColor <> AMergedCharacterProperties.ForeColor
      then
        AAccessor.ChangeForeColor(AMergedCharacterProperties.ForeColor);
      if ACharacterProperties.Info.FontUnderlineType <>
        AMergedCharacterProperties.FontUnderlineType then
        AAccessor.ChangeFontUnderlineType
          (AMergedCharacterProperties.FontUnderlineType);
      if ACharacterProperties.Info.UnderlineColor <> AMergedCharacterProperties.UnderlineColor
      then
        AAccessor.ChangeUnderlineColor
          (AMergedCharacterProperties.UnderlineColor);
      if ACharacterProperties.Info.FontStrikeoutType <>
        AMergedCharacterProperties.FontStrikeoutType then
        AAccessor.ChangeFontStrikeoutType
          (AMergedCharacterProperties.FontStrikeoutType);
      if ACharacterProperties.Info.UnderlineWordsOnly <>
        AMergedCharacterProperties.UnderlineWordsOnly then
        AAccessor.ChangeUnderlineWordsOnly
          (AMergedCharacterProperties.UnderlineWordsOnly);
      if ACharacterProperties.Info.Script <> AMergedCharacterProperties.Script
      then
        AAccessor.ChangeScript(AMergedCharacterProperties.Script);
      if ACharacterProperties.Info.AllCaps <> AMergedCharacterProperties.AllCaps
      then
        AAccessor.ChangeAllCaps(AMergedCharacterProperties.AllCaps);
      if ACharacterProperties.Info.Hidden <> AMergedCharacterProperties.Hidden
      then
...
procedure TdxTableStyleFormControllerBase.CopyParagraphPropertiesFromMerged
  (const AMergedProperties: TdxMergedParagraphProperties);
var
...
begin
  ...
  try
    AAccessor := GetParagraphPropertyAccessor;
    try
      if AParagraphProperties.Info.Alignment <> AMergedParagraphProperties.Alignment
      then
        AAccessor.ChangeAlignment(AMergedParagraphProperties.Alignment);
      if AParagraphProperties.Info.OutlineLevel <> AMergedParagraphProperties.OutlineLevel
      then
        AAccessor.ChangeOutlineLevel(AMergedParagraphProperties.OutlineLevel);
      if AParagraphProperties.Info.LeftIndent <> AMergedParagraphProperties.LeftIndent
      then
        AAccessor.ChangeLeftIndent(AMergedParagraphProperties.LeftIndent);
      if AParagraphProperties.Info.RightIndent <> AMergedParagraphProperties.RightIndent
      then
        AAccessor.ChangeRightIndent(AMergedParagraphProperties.RightIndent);
      if AParagraphProperties.Info.FirstLineIndentType <>
        AMergedParagraphProperties.FirstLineIndentType then
        ParagraphProperties.FirstLineIndentType :=
          AMergedParagraphProperties.FirstLineIndentType;
      if AParagraphProperties.Info.FirstLineIndent <>
        AMergedParagraphProperties.FirstLineIndent then
        AAccessor.ChangeFirstLineIndent
          (AMergedParagraphProperties.FirstLineIndent);
      if AParagraphProperties.Info.SpacingBefore <> AMergedParagraphProperties.SpacingBefore
      then
        AAccessor.ChangeSpacingBefore(AMergedParagraphProperties.SpacingBefore);
      if AParagraphProperties.Info.SpacingAfter <> AMergedParagraphProperties.SpacingAfter
      then
        AAccessor.ChangeSpacingAfter(AMergedParagraphProperties.SpacingAfter);
      if AParagraphProperties.Info.LineSpacing <> AMergedParagraphProperties.LineSpacing
      then
        AAccessor.ChangeLineSpacing(AMergedParagraphProperties.LineSpacing);
      if AParagraphProperties.Info.LineSpacingType <>
        AMergedParagraphProperties.LineSpacingType then
        ParagraphProperties.LineSpacingType :=
          AMergedParagraphProperties.LineSpacingType;

      if AParagraphProperties.Info.BeforeAutoSpacing <>
        AMergedParagraphProperties.BeforeAutoSpacing then
        AAccessor.ChangeBeforeAutoSpacing
          (AMergedParagraphProperties.BeforeAutoSpacing);
      if AParagraphProperties.Info.AfterAutoSpacing <>
        AMergedParagraphProperties.AfterAutoSpacing then
        AAccessor.ChangeAfterAutoSpacing
          (AMergedParagraphProperties.AfterAutoSpacing);
      if AParagraphProperties.Info.ContextualSpacing <>
        AMergedParagraphProperties.ContextualSpacing then
        AAccessor.ChangeContextualSpacing
          (AMergedParagraphProperties.ContextualSpacing);
      if AParagraphProperties.Info.KeepLinesTogether <>
        AMergedParagraphProperties.KeepLinesTogether then
        AAccessor.ChangeKeepLinesTogether
          (AMergedParagraphProperties.KeepLinesTogether);
      if AParagraphProperties.Info.KeepWithNext <> AMergedParagraphProperties.KeepWithNext
      then
        AAccessor.ChangeKeepWithNext(AMergedParagraphProperties.KeepWithNext);
      if AParagraphProperties.Info.PageBreakBefore <>
        AMergedParagraphProperties.PageBreakBefore then
        AAccessor.ChangePageBreakBefore
          (AMergedParagraphProperties.PageBreakBefore);
      if AParagraphProperties.Info.SuppressLineNumbers <>
        AMergedParagraphProperties.SuppressLineNumbers then
        AAccessor.ChangeSuppressLineNumbers
          (AMergedParagraphProperties.SuppressLineNumbers);
      if AParagraphProperties.Info.SuppressHyphenation <>
        AMergedParagraphProperties.SuppressHyphenation then
        AAccessor.ChangeSuppressHyphenation
          (AMergedParagraphProperties.SuppressHyphenation);
      if AParagraphProperties.Info.WidowOrphanControl <>
        AMergedParagraphProperties.WidowOrphanControl then
        AAccessor.ChangeWidowOrphanControl
          (AMergedParagraphProperties.WidowOrphanControl);
      if AParagraphProperties.Info.BackColor <> AMergedParagraphProperties.BackColor
      then
...
constructor TdxTableStyleFormController.Create(const APreviewStyleControl
  : IdxRichEditControl; AParameters: TdxFormControllerParameters);
var
...
begin
  ...
  ASourceTableStyles := AParameters.Control.InnerControl.DocumentModel.
    TableStyles;
  ...
  begin
    ...
    ASourceStyle := TdxTableStyle(ASourceTableStyles.GetStyleByName
      (AStyle.StyleName));
    AStyle.ConditionalStyleProperties.CopyFrom
      (ASourceStyle.ConditionalStyleProperties);
  end;
  FEditedTableStyleIndex := (TdxTableStyleFormControllerParameters(AParameters))
    .TableSourceStyle.Copy(APreviewModel);
...
begin
  Result := (TdxTableStyleFormControllerParameters(Parameters))
    .TableSourceStyle;
end;

function TdxTableStyleFormController.GetCharacterProperties
...
function TdxTableStyleFormController.GetParagraphProperties
...
function TdxTableStyleFormController.GetTableCellProperties
...
function TdxTableStyleFormController.GetConditionalStyleProperties
...
begin
  if ConditionalStyleType = TdxConditionalTableStyleFormattingType.WholeTable
  then
...
function TdxTableStyleFormController.GetCurrentConditionalStyle
...
function TdxTableStyleFormController.GetMergedCharacterProperties
  : TdxMergedCharacterProperties;
begin
  Result := CurrentConditionalStyle.GetMergedWithDefaultCharacterProperties;
end;

function TdxTableStyleFormController.GetMergedParagraphProperties
  : TdxMergedParagraphProperties;
begin
  Result := CurrentConditionalStyle.GetMergedWithDefaultParagraphProperties;
end;

function TdxTableStyleFormController.GetMergedWithDefaultCharacterProperties
  : TdxMergedCharacterProperties;
begin
  if CurrentConditionalStyle <> nil then
    Result := CurrentConditionalStyle.GetMergedWithDefaultCharacterProperties
  else
    Result := IntermediateTableStyle.GetMergedWithDefaultCharacterProperties
      (TdxConditionalRowType.Normal, TdxConditionalColumnType.Normal);
end;

function TdxTableStyleFormController.GetMergedTableCellProperties
...
begin
  ...
  try
    ...
    TableSourceStyle.ConditionalStyleProperties.CopyFrom
      (IntermediateTableStyle.ConditionalStyleProperties);
    TableSourceStyle.StyleName := IntermediateTableStyle.StyleName;
    if IntermediateTableStyle.Parent <> nil then
      TableSourceStyle.Parent :=
        TdxTableStyle(TdxDocumentModel(TableSourceStyle.DocumentModel)
        .TableStyles.GetStyleByName(IntermediateTableStyle.Parent.StyleName))
    else
...
function TdxTableStyleFormController.GetParentCharacterProperties
  : TdxCharacterFormattingInfo;
begin
  if IntermediateTableStyle.Parent <> nil then
...
function TdxTableStyleFormController.GetParentParagraphProperties
  : TdxParagraphFormattingInfo;
begin
  if IntermediateTableStyle.Parent <> nil then
...
function TdxTableStyleFormController.GetParentParagraphPropertiesOptions
  : TdxParagraphFormattingOptions;
begin
  if IntermediateTableStyle.Parent <> nil then
...
function TdxTableStyleFormController.GetParentTableCellProperties
  : TdxTableCellGeneralSettingsInfo;
begin
  if IntermediateTableStyle.Parent <> nil then
...
function TdxTableStyleFormController.GetParentTableCellPropertiesOptions
  : TdxTableCellPropertiesOptions;
begin
  if IntermediateTableStyle.Parent <> nil then
...
function TdxTableStyleFormController.GetParentConditionalCharacterProperties
  : TdxCharacterFormattingInfo;
var
  ACharacterProperties: TdxMergedCharacterProperties;
begin
...
function TdxTableStyleFormController.GetParentConditionalParagraphProperties
  : TdxParagraphFormattingInfo;
var
  AParagraphProperties: TdxMergedParagraphProperties;
begin
...
function TdxTableStyleFormController.
  GetParentConditionalParagraphPropertiesOptions: TdxParagraphFormattingOptions;
var
  AParagraphProperties: TdxMergedParagraphProperties;
begin
  if ConditionalStyleParent <> nil then
...
function TdxTableStyleFormController.GetParentConditionalTableCellProperties
  : TdxTableCellGeneralSettingsInfo;
var
...
function TdxTableStyleFormController.
  GetParentConditionalTableCellPropertiesOptions: TdxTableCellPropertiesOptions;
var
...
begin
  if CurrentConditionalStyle <> nil then
  begin
    CurrentConditionalStyle.CharacterProperties.OnObtainAffectedRange.Remove
      (IntermediateTableStyle.OnObtainAffectedRange);
    CurrentConditionalStyle.ParagraphProperties.OnObtainAffectedRange.Remove
      (IntermediateTableStyle.OnObtainAffectedRange);
    CurrentConditionalStyle.TableCellProperties.OnObtainAffectedRange.Remove
      (IntermediateTableStyle.OnObtainAffectedRange);
    CurrentConditionalStyle.TableProperties.OnObtainAffectedRange.Remove
      (IntermediateTableStyle.OnObtainAffectedRange);
    CurrentConditionalStyle.TableRowProperties.OnObtainAffectedRange.Remove
      (IntermediateTableStyle.OnObtainAffectedRange);
  end;
end;
...
begin
  if CurrentConditionalStyle <> nil then
  begin
    CurrentConditionalStyle.CharacterProperties.OnObtainAffectedRange.Add
      (IntermediateTableStyle.OnObtainAffectedRange);
    CurrentConditionalStyle.ParagraphProperties.OnObtainAffectedRange.Add
      (IntermediateTableStyle.OnObtainAffectedRange);
    CurrentConditionalStyle.TableCellProperties.OnObtainAffectedRange.Add
      (IntermediateTableStyle.OnObtainAffectedRange);
    CurrentConditionalStyle.TableProperties.OnObtainAffectedRange.Add
      (IntermediateTableStyle.OnObtainAffectedRange);
    CurrentConditionalStyle.TableRowProperties.OnObtainAffectedRange.Add
      (IntermediateTableStyle.OnObtainAffectedRange);
  end;
end;
...
begin
  ...
  begin
    ...
    ConditionalStyleProperties.AddStyle
      (TdxTableConditionalStyle.Create(IntermediateTableStyle,
...
begin
  ...
  Result := TdxEditStyleHelper.IsValidStyleName(AName, TableSourceStyle,
    AModel.TableStyles);
end;
