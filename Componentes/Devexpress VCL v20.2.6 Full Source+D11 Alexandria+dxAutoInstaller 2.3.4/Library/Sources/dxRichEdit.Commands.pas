...
uses
  Types, SysUtils, Graphics, Classes, Controls, Generics.Defaults,
  Generics.Collections, ImgList,
...
type
  ...
  protected
    ...
    function CanPerformHistoryOperation(AHistory: TdxDocumentHistory): Boolean;
      virtual; abstract;
    procedure InvalidateDocumentLayout;
    procedure PerformHistoryOperation(AHistory: TdxDocumentHistory);
      virtual; abstract;
  public
  ...
  protected
    function CanPerformHistoryOperation(AHistory: TdxDocumentHistory)
      : Boolean; override;
  ...
  protected
    procedure ApplyLayoutPreferredPageIndex(APreferredPageIndex
      : Integer); virtual;
    function UpdateCaretPosition(ADetailLevel: TdxDocumentLayoutDetailsLevel)
      : Boolean; virtual;
  ...
  protected
    ...
    function CalculateOptimalCaretHorizontalPosition
      (const ALogicalVisibleBounds, ACaretBounds: TRect): Integer;
    function IsCaretVisible(const ALogicalVisibleBounds,
      ACaretBounds: TRect): Boolean;
    procedure ScrollToMakeCaretVisible(const ALogicalVisibleBounds,
      ACaretBounds: TRect);
  public
    procedure ExecuteCore; override;
    class function GetDescription: string; override;
  ...
  protected
    ...
    function BothPositionsWillValid(ACurrentCaretPosition,
      AAdjustedCaretPosition: TdxCaretPosition): Boolean;
    function CalculateActualInvisiblePageBounds(APageViewInfo: TdxPageViewInfo;
      ADirection: TdxSelectionMovementVerticalDirection): TRect;
    function CalculateDirectionToInvisibleCaret
      : TdxSelectionMovementVerticalDirection;
    function CalculateOffsetToVisibleArea(AInitialCaretPhysicalTop
      : Integer): Integer;
    ...
    function CalculatePhysicalOffsetForCaretPositionRowVisibilityCore
      (APageViewInfo: TdxPageViewInfo; const ARow: TdxCurrentRowInfo): Integer;
    function CalculatePhysicalOffsetForRowBoundsVisibility(const AViewBounds,
      APhysicalRowBounds: TRect): Integer; virtual;
    function CalculateScrollDirectionToCaret(APos: TdxCaretPosition)
      : TdxCaretScrollDirection;
    function CalculateTargetRowLogicalBounds(APageViewInfo: TdxPageViewInfo;
      const ARow: TdxCurrentRowInfo): TRect; virtual;
    function CreateAdjustedCaretPosition: TdxCaretPosition;
    function IsCaretVisible: Boolean;
    function LookupInvisiblePageWithCaret(ADirection
      : TdxSelectionMovementVerticalDirection): TdxPageViewInfo;
    ...
    function ValidateRowBounds(APageViewInfo: TdxPageViewInfo;
      const ARowBounds: TRect): TRect;
  ...
  public
    ...
    property RelativeCaretPosition: Single read FRelativeCaretPosition
      write SetRelativeCaretPosition;
  end;

  TdxEnsureCaretVisibleVerticallyForMovePrevNextPageCommand = class
    (TdxEnsureCaretVisibleVerticallyCommand)
  private
    FPhysicalOffsetAboveTargetRow: Integer;
  protected
    function CalculatePhysicalOffsetForRowBoundsVisibility(const AViewBounds
      : TRect; const APhysicalRowBounds: TRect): Integer; override;
    function CalculateTargetRowLogicalBounds(APageViewInfo: TdxPageViewInfo;
      const ARow: TdxCurrentRowInfo): TRect; override;
    function CalculateTopmostRow(APage: TdxPage): TdxRow;
  public
    property PhysicalOffsetAboveTargetRow: Integer
      read FPhysicalOffsetAboveTargetRow write FPhysicalOffsetAboveTargetRow;
  end;
  ...
  private
    ...
    function CalculatePreferredPageIndex(AHitTestResult
      : TdxRichEditHitTestResult): Integer;
  protected
    procedure ChangeSelection(ASelection: TdxSelection;
      ALogPosition: TdxDocumentLogPosition;
      AHitTestResult: TdxRichEditHitTestResult); virtual;
    function ChangeSelectionEnd(ASelection: TdxSelection;
      ALogPosition: TdxDocumentLogPosition;
    ...
    procedure ChangeSelectionStart(ASelection: TdxSelection;
      ...
      ASelectionItemCountBeforeChangeEnd: Integer); virtual;
    function SelectToTheEndOfRow(ASelection: TdxSelection; ARow: TdxRow;
      AExtendSelection: Boolean): Boolean;
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
  ...
  TdxPlaceCaretToPhysicalPointCommand2 = class
    (TdxPlaceCaretToPhysicalPointCommand)
  protected
    function ChangeSelectionEnd(ASelection: TdxSelection;
      ALogPosition: TdxDocumentLogPosition;
  ...
  TdxScrollVerticallyByPhysicalOffsetCommandBase = class
    (TdxRichEditMenuItemSimpleCommand)
  private
  ...
  protected
    ...
    procedure GeneratePagesToEnsureScrollingSuccessfully
      (ADelta: Int64); virtual;
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
    function CreateScrollDeltaCalculator(AScrollUp: Boolean)
      : TdxScrollByPhysicalHeightCalculator; virtual;
  ...
  public
    ...
    property AbsolutePhysicalVerticalOffset: Integer
      read GetAbsolutePhysicalVerticalOffset;
    property UpdateScrollBarBeforeExecution: Boolean
      read FUpdateScrollBarBeforeExecution
      write FUpdateScrollBarBeforeExecution;
  end;

  { TdxScrollVerticallyByLogicalOffsetCommand }

  TdxScrollVerticallyByLogicalOffsetCommand = class
    (TdxScrollVerticallyByPhysicalOffsetCommandBase)
  private
  ...
  TdxScrollVerticallyByPhysicalOffsetCommand = class
    (TdxScrollVerticallyByPhysicalOffsetCommandBase)
  private
  ...
  TdxScrollVerticallyByPhysicalOffsetEnsurePageGenerationCommand = class
    (TdxScrollVerticallyByPhysicalOffsetCommand)
  protected
    procedure GeneratePagesToEnsureScrollingSuccessfully
      (ADelta: Int64); override;
    function CalculateNewTopInvisibleHeight(ADelta: Int64): Int64;
  end;

  { TdxScrollHorizontallyByPhysicalOffsetCommand }

  TdxScrollHorizontallyByPhysicalOffsetCommand = class
    (TdxRichEditMenuItemSimpleCommand)
  strict private
    FPhysicalOffset: Integer;
    FExecutedSuccessfully: Boolean;
  ...
  protected
    function CalculateOffset(AParagraphIndex: TdxParagraphIndex;
      AIncrementIndex: Boolean): Integer;
    procedure ChangeFieldSelection(ASelection: TdxSelection;
      ASelectedInterval: TdxRunInfo; AField: TdxField);
    procedure ChangeFieldSelectionCore(ASelection: TdxSelection;
      AField: TdxField); virtual; abstract;
    function IsSelectedItemCovered(AItem: TdxSelectionItem): Boolean;
    function ShouldChangeInterval(AInterval: TdxRunInfo;
      AStart, AEnd: TdxRunIndex): Boolean; virtual;
    function ShouldExtendInterval(AInterval: TdxRunInfo; AField: TdxField)
      : Boolean; virtual;
  ...
  private
    function FindTableCellViewInfoInTableRowByX
    ...
    function GetTargetCellViewInfoFromNextTableRow(ACell: TdxTableCellViewInfo;
      X: Integer): TdxTableCellViewInfo;
    function GetNextCellViewInfoInTargetRowWithNonZeroRows(AColumn: TdxColumn;
      ATargetRow: TdxTableRowViewInfoBase;
      ACellWithZeroRows: TdxTableCellViewInfo): TdxTableCellViewInfo;
    function IsCellFromPreviousRowIsInNestedTableInSourceCellViewInfo
      (ASourceCellViewInfo, ACellFromPreviousLayoutRow
      : TdxTableCellViewInfo): Boolean;
    function ShouldJumpToCellInNestedTable(ARows: TdxRowCollection;
      ACurrentCellNestedLevel, ASourceRowIndexInColumn,
  ...
  protected
    ...
    procedure CorrectRowAndCellViewInfo(APos: TdxCaretPosition;
      var ARowIndexInColumn: Integer;
      var ASourceCellViewInfo: TdxTableCellViewInfo);
    procedure CorrectGeneratedRowPagesHorizontalLocation(ALayoutManager
      : TdxPageGeneratorLayoutManager; ARow: TdxPageViewInfoRow);
      virtual; abstract;
    procedure CorrectCaretXOnExtendSelection(ASourceCellViewInfo
      : TdxTableCellViewInfo; var ACaretX: Integer); virtual;
    function GenerateTargetPageViewInfoRow: TdxPageViewInfoRow;
    function GetDefaultPosition: TdxDocumentModelPosition; virtual;
    function GetPageViewInfoRowIndex(APageRows: TdxPageViewInfoRowCollection;
      APageViewInfo: TdxPageViewInfo): Integer;
    function GetTargetLayoutRowObtainTargetPageViewInfo(APos: TdxCaretPosition;
      var ACaretX: Integer): TdxRow;
    function GetTargetLayoutRowObtainTargetPageViewInfoCore
    ...
    function GetNextLayoutRowByDirection(ARows: TdxRowCollection;
      ASourceRowIndex: Integer): TdxRow;
    function IsBoundaryTableCellRowOnCurrentPage(ACell: TdxTableCellViewInfo;
      AColumn: TdxColumn; ASourceRowIndexInColumn, ACaretX: Integer): Boolean;
    function IsCaretAtTheBeginningOfAnotherCell(APos: TdxCaretPosition;
      ADocumentModel: TdxDocumentModel): Boolean;
    function IsBoundaryRowInCell(AColumn: TdxColumn;
      ACell: TdxTableCellViewInfo; ASourceRow: TdxRow): Boolean;
      virtual; abstract;
    function IsCellInBoundaryRow(AColumn: TdxColumn;
      ACell: TdxTableCellViewInfo; ACaretX: Integer): Boolean; virtual;
      abstract;
    function ObtainTargetLayoutRow(ARowIndexInColumn, ACaretX: Integer;
      AColumn: TdxColumn; ASourceCell: TdxTableCellViewInfo): TdxRow;
    function ObtainTargetLayoutRowFromNextCellInCurrentTable(ARowIndexInColumn
      : Integer; ACaretX: Integer; AColumn: TdxColumn;
      ASourceCellViewInfo: TdxTableCellViewInfo): TdxRow;
    function ObtainExistingTargetPageViewInfoRow
      (APageRows: TdxPageViewInfoRowCollection; ACurrentRowIndex: Integer)
      : TdxPageViewInfoRow; virtual; abstract;
    function ShouldObtainTargetPageViewInfo(ASourceRowIndex, ASourceRowCount
      : Integer): Boolean; virtual; abstract;
    function ObtainTargetPageViewInfo(ACurrentPageViewInfo: TdxPageViewInfo;
      APhysicalCaretX: Integer): TdxPageViewInfo; virtual;
    function ObtainTargetLayoutRowFromNextCellInCurrentTableCore
      (ACaretX: Integer; AColumn: TdxColumn;
      ASourceCellViewInfo: TdxTableCellViewInfo;
      ANextCell: TdxTableCellViewInfo): TdxRow; virtual;
    function ObtainLayoutRowFromValidCellInFirstRowNestedTable(ARowIndex,
      ACaretX: Integer; AColumn: TdxColumn; ASourceNestedLevel: Integer)
      : TdxRow; virtual;
    function ObtainRowFromOuterTextRowOrOuterTableWhenCellsInInnerTable
      (AColumn: TdxColumn; AInnerSourceCellViewInfo: TdxTableCellViewInfo;
      ACaretX: Integer; AFirstOrLastCellInRow: TdxTableCellViewInfo)
      : TdxRow; virtual;
    function GetTargetPageArea(APage: TdxPage): TdxPageArea; virtual; abstract;
    function GetTargetLayoutRowCore(ARows: TdxRowCollection): TdxRow;
      virtual; abstract;
    function GetNextLayoutRowIndexInDirection(ASourceRowIndex: Integer)
      : Integer; virtual; abstract;
    function GetTargetLayoutRowInCell(ARows: TdxRowCollection): TdxRow;
      virtual; abstract;
    function GetBoundaryRowInColumn(AColumn: TdxColumn): TdxRow;
      virtual; abstract;
    function GetCellBoundaryRowIndex(AColumn: TdxColumn;
      AParentCell: TdxTableCellViewInfo): Integer; virtual; abstract;
    function GetLastTableRowInDirection(ACell: TdxTableCellViewInfo; X: Integer)
      : TdxTableRowViewInfoBase; virtual;
    function GetLastNonCoveredByVerticalMergingCell
      (ARow: TdxTableRowViewInfoBase): TdxTableCellViewInfo; virtual;
    function GetPreviousNonVerticalMergedCellInRow(ASourceCellViewInfo
      : TdxTableCellViewInfo): TdxTableCellViewInfo; virtual;
    function GetTargetTableRowCore(ARow: TdxTableRowViewInfoBase)
      : TdxTableRowViewInfoBase; virtual; abstract;
    function GetFirstOrLastCellViewInfoInRow(ARow: TdxTableRowViewInfoBase)
      : TdxTableCellViewInfo; virtual; abstract;
    function GetTargetCellViewInfoInNestedTable(ANextLayoutRow: TdxRow;
      ACaretX, ACurrentNestedLevel: Integer): TdxTableCellViewInfo;
      virtual; abstract;
    function GetFirstOrLastLayoutRowInCell(ACellRows: TdxRowCollection): TdxRow;
      virtual; abstract;
    function IsCellViewInfoContinuesOnAnotherPage(ACell: TdxTableCellViewInfo)
      : Boolean; virtual; abstract;
    function IsLastOrFirstLayoutRowInCell(ARowIndexInCell, ACellsRowsCount
      : Integer): Boolean;
    function MoveFromInnerIntoOuterTable(AInnerSourceCellViewInfo
      : TdxTableCellViewInfo; AColumn: TdxColumn;
      AFirstOrLastCellInRow: TdxTableCellViewInfo; ACaretX: Integer): TdxRow;
      virtual; abstract;
    function MoveBetweenRowsInsideCell(ACellRows: TdxRowCollection;
      ARowIndexInCell: Integer): TdxRow; virtual;
    function ShouldJumpToNextCellInCurrentTable(AShouldJumpToCellInNestedTable
      : Boolean; ANextCell: TdxTableCellViewInfo;
      AIsLastOrFirstLayoutRowInCell: Boolean): Boolean; virtual;
    function ShouldObtainNextLayoutRowInsideCell(AIsLastOrFirstLayoutRowInCell
      : Boolean; ANextCell: TdxTableCellViewInfo): Boolean; virtual;
    function FindMostParentTableRowViewInfo(ATargetTable: TdxTable;
      AFirstColumnRowCell: TdxTableCellViewInfo)
      : TdxTableRowViewInfoBase; virtual;

    property CurrentPageRow: TdxPageViewInfoRow read FCurrentPageRow
      write SetCurrentPageRow;
    property View: TdxRichEditView read GetView;
  public
    constructor Create(const AControl: IdxRichEditControl);
    destructor Destroy; override;

    function CalculateNextPosition(ACaretPosition: TdxCaretPosition)
      : TdxDocumentModelPosition; // for internal use
    function GetTargetCharacter(ARow: TdxRow; ACaretX: Integer)
      : TdxCharacterBox;
    function GetTargetColumn(APage: TdxPage; ACaretX: Integer): TdxColumn;
    function ObtainTargetRowFromCurrentPageViewInfoAndCaretX
      (APageViewInfo: TdxPageViewInfo; ACellViewInfoFromPreviousTableViewInfo
      : TdxTableCellViewInfo; var ACaretX: Integer): TdxRow;
  ...
  TdxNextCaretPositionUpDirectionCalculator = class abstract
    (TdxNextCaretPositionVerticalDirectionCalculator)
  private
    function ShouldJumpUpFromMultipleInnerTableToOuter(AFirstCellInTableRow
      : TdxTableCellViewInfo): Boolean;
    function ObtainRowInNextCellWhenFirstCellInTableRowIsInMultipleInnerTable
      (AColumn: TdxColumn; ACaretX: Integer;
      ATableViewInfo: TdxTableViewInfo): TdxRow;
  protected
    function GetBottomRightTableCellViewInfoByNestedLevel(ANextLayoutRow
      : TdxRow; ADesiredNestedLevel: Integer): TdxTableCellViewInfo; virtual;
    function GetBoundaryRowInColumn(AColumn: TdxColumn): TdxRow; override;
    function IsBoundaryRowInCell(AColumn: TdxColumn;
      ACell: TdxTableCellViewInfo; ASourceRow: TdxRow): Boolean; override;
    function GetCellBoundaryRowIndex(AColumn: TdxColumn;
      AParentCell: TdxTableCellViewInfo): Integer; override;

    function IsCellInBoundaryRow(AColumn: TdxColumn;
      ACell: TdxTableCellViewInfo; ACaretX: Integer): Boolean; override;
    procedure CorrectGeneratedRowPagesHorizontalLocation(ALayoutManager
      : TdxPageGeneratorLayoutManager; ARow: TdxPageViewInfoRow); override;
    ...
    function GetFirstOrLastCellViewInfoInRow(ARow: TdxTableRowViewInfoBase)
      : TdxTableCellViewInfo; override;
    function GetTargetTableRowCore(ARow: TdxTableRowViewInfoBase)
      : TdxTableRowViewInfoBase; override;
    function GetTargetCellViewInfoInNestedTable(ANextLayoutRow: TdxRow;
      ACaretX: Integer; ACurrentNestedLevel: Integer)
      : TdxTableCellViewInfo; override;
    function GetFirstOrLastLayoutRowInCell(ACellRows: TdxRowCollection)
      : TdxRow; override;
    function IsCellViewInfoContinuesOnAnotherPage(ACell: TdxTableCellViewInfo)
      : Boolean; override;
    function MoveFromInnerIntoOuterTable(AInnerSourceCellViewInfo
      : TdxTableCellViewInfo; AColumn: TdxColumn;
      AFirstOrLastCellInRow: TdxTableCellViewInfo; ACaretX: Integer)
      : TdxRow; override;
  end;

  TdxNextCaretPositionDownDirectionCalculator = class abstract
    (TdxNextCaretPositionVerticalDirectionCalculator)
  private
    function GetTopLeftTableCellViewInfoByNestedLevel(ANextLayoutRow: TdxRow;
      ADesiredNestedLevel: Integer): TdxTableCellViewInfo;
  protected
    function GetBoundaryRowInColumn(AColumn: TdxColumn): TdxRow; override;
    function IsBoundaryRowInCell(AColumn: TdxColumn;
      ACell: TdxTableCellViewInfo; ASourceRow: TdxRow): Boolean; override;
    ...
    function MoveFromInnerIntoOuterTable(AInnerSourceCellViewInfo
      : TdxTableCellViewInfo; AColumn: TdxColumn;
      ALastCellInTableRow: TdxTableCellViewInfo; ACaretX: Integer)
      : TdxRow; override;
  end;

  { TdxNextCaretPositionLineUpCalculator }

  TdxNextCaretPositionLineUpCalculator = class
    (TdxNextCaretPositionUpDirectionCalculator)
  protected
    ...
    function ObtainExistingTargetPageViewInfoRow
      (APageRows: TdxPageViewInfoRowCollection; ACurrentRowIndex: Integer)
      : TdxPageViewInfoRow; override;
  end;

  { TdxExtendNextCaretPositionLineUpCalculator }

  TdxExtendNextCaretPositionLineUpCalculator = class
    (TdxNextCaretPositionLineUpCalculator)
  private
  ...
  protected
    ...
    property SelectedCells: TdxSelectedTableStructureBase read GetSelectedCells
      write SetSelectedCells;
  end;

  { TdxNextCaretPositionLineDownCalculator }

  TdxNextCaretPositionLineDownCalculator = class
  ...
  TdxExtendNextCaretPositionLineDownCalculator = class
    (TdxNextCaretPositionLineDownCalculator)
  private
    function GetSelection: TdxSelection;
    function GetSelectedCells: TdxSelectedTableStructureBase;
  ...
  protected
    procedure CorrectCaretXOnExtendSelection(ASourceCellViewInfo
      : TdxTableCellViewInfo; var ACaretX: Integer); override;
    function GetDefaultPosition: TdxDocumentModelPosition; override;
    function MoveFromInnerIntoOuterTable(AInnerSourceCellViewInfo
      : TdxTableCellViewInfo; AColumn: TdxColumn;
      ALastCellInTableRow: TdxTableCellViewInfo; ACaretX: Integer)
  ...
  public
    ...
    function CalculateNextPosition(ALogPosition: TdxDocumentLogPosition)
      : TdxDocumentLogPosition;
    function CalculatePrevPosition(ALogPosition: TdxDocumentLogPosition)
      : TdxDocumentLogPosition;
  ...
  TdxToggleShowRulersCommandBase = class abstract
    (TdxRichEditMenuItemSimpleCommand)
  protected
    function GetShowRulerByDefault: Boolean; virtual; abstract;
    procedure ExecuteCore; override;
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
    function IsRulerVisible(AVisibility: TdxRichEditRulerVisibility)
      : Boolean; virtual;
  ...
  protected
    function CalculateNewZoomFactor(AOldZoomFactor: Single): Single;
      virtual; abstract;
    procedure ExecuteCore; override;
    procedure UpdateUIStateCore(const AState: IdxCommandUIState); override;
  public
...
const
  ChangeActions = [TdxDocumentModelChangeAction.RaiseSelectionChanged,
...
begin
  ...
  begin
    if DocumentModel.IsUpdateLockedOrOverlapped then
      TdxHeaderFooterCaretPosition(CaretPosition)
        .LayoutPosition.PieceTable.ApplyChangesCore(ChangeActions, -1, -1);
  end;
...
begin
  if AHitTestResult.PieceTable.IsMain and
    AHitTestResult.IsValid(TdxDocumentLayoutDetailsLevel.Page) then
    Exit(AHitTestResult.Page.PageIndex);

  AHitTestRequest := TdxRichEditHitTestRequest.Create
  ...
  AHitTestRequest.Accuracy := NearestPage or NearestPageArea or NearestColumn or
    NearestTableRow or NearestTableCell or NearestRow or NearestBox or
    NearestCharacter;
  if HitTestOnlyInPageClientBounds then
    AHitTestRequest.Accuracy := AHitTestRequest.Accuracy or
      ActiveView.DefaultHitTestPageAccuracy;

  ANewHitTestResult := ActiveView.HitTestCore(AHitTestRequest,
    HitTestOnlyInPageClientBounds);
  try
...
begin
  ...
  AUsePreviousBoxBounds := ChangeSelectionEnd(ASelection, ALogPosition,
    AHitTestResult);

  ChangeSelectionStart(ASelection, ALogPosition, AHitTestResult,
    ASelectionItemCountBeforeChangeEnd);
...
begin
  ...
  begin
    ASelectionManager := TdxEnhancedSelectionManager.Create(ActivePieceTable);
    try
      ASelection.Start := ASelectionManager.ExtendSelectionStartToParagraphMark
        (ASelection, ALogPosition);
...
constructor TdxPlaceCaretToPhysicalPointCommand.Create(const ARichEditControl
  : IdxRichEditControl);
begin
...
begin
  ...
  AHitTestResult := ActiveView.HitTestCore(AHitTestRequest,
    HitTestOnlyInPageClientBounds);
  try
    ...
    begin
      ALogPosition := AHitTestResult.Character.GetFirstPosition
        (AHitTestResult.PieceTable).LogPosition;
      ASelection := DocumentModel.Selection;
      DocumentModel.BeginUpdate;
      try
        DocumentModel.DeferredChanges.SuppressClearOutdatedSelectionItems :=
          SuppressClearOutdatedSelectionItems;
        ChangeSelection(ASelection, ALogPosition, AHitTestResult);
        if UpdateCaretX then
          ApplyLayoutPreferredPageIndex
            (CalculatePreferredPageIndex(AHitTestResult));
      finally
      ...
      begin
        ...
        Assert(CaretPosition.LayoutPosition.IsValid
          (TdxDocumentLayoutDetailsLevel.Character));
        APageViewInfo := CaretPosition.PageViewInfo;
        if APageViewInfo <> nil then
        begin
          CaretPosition.X := ActiveView.CreateLogicalPoint
            (APageViewInfo.ClientBounds, PhysicalPoint).X;
...
function TdxPlaceCaretToPhysicalPointCommand.
  HitTestOnlyInPageClientBounds: Boolean;
begin
  Result := True;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      ALineBreak := ActivePieceTable.TextBuffer
        [ARun.StartIndex + APos.RunOffset] = TdxCharacters.LineBreak;
...
procedure TdxPlaceCaretToPhysicalPointCommand.UpdateUIStateCore
...
constructor TdxScrollVerticallyByPhysicalOffsetCommand.Create
  (const AControl: IdxRichEditControl);
begin
  inherited Create(AControl);
  FPhysicalOffset := DocumentModel.LayoutUnitConverter.
    DocumentsToLayoutUnits(50);
end;

function TdxScrollVerticallyByPhysicalOffsetCommand.
  GetAbsolutePhysicalVerticalOffset: Integer;
begin
...
constructor TdxScrollVerticallyByPhysicalOffsetCommandBase.Create
  (const AControl: IdxRichEditControl);
begin
  inherited Create(AControl);
...
function TdxScrollVerticallyByPhysicalOffsetCommandBase.
  CreateScrollDeltaCalculator(AScrollUp: Boolean)
...
begin
  ...
  try
    ...
    View.VerticalScrollController.ScrollByTopInvisibleHeightDelta
      (ADelta * Sign(AOffset));
    View.OnVerticalScroll;
    FExecutedSuccessfully := APreviousValue <>
      View.VerticalScrollController.ScrollBarAdapter.Value;
  finally
    ACalculator.Free;
  end;
end;

procedure TdxScrollVerticallyByPhysicalOffsetCommandBase.
  GeneratePagesToEnsureScrollingSuccessfully(ADelta: Int64);
begin
end;

class function TdxScrollVerticallyByPhysicalOffsetCommandBase.
...
procedure TdxScrollVerticallyByPhysicalOffsetCommandBase.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  AState.Enabled := True;
  AState.Visible := True;
...
constructor TdxScrollVerticallyByLogicalOffsetCommand.Create(const AControl
  : IdxRichEditControl);
begin
  inherited Create(AControl);
...
function TdxScrollVerticallyByLogicalOffsetCommand.
  GetAbsolutePhysicalVerticalOffset: Integer;
begin
...
procedure TdxRichEditMenuItemSimpleCommand.ForceExecute
  (const AState: IdxCommandUIState);
begin
  CheckExecutedAtUIThread;
...
function TdxRichEditMenuItemSimpleCommand.GetSelectedCellsCollection
...
begin
  ...
  begin
    ...
    begin
      AStartPos := TdxPositionConverter.ToDocumentModelPosition
        (ASelectionPieceTable, ASelection.Items[I].NormalizedStart);
      AStartCell := ASelectionPieceTable.Paragraphs
        [AStartPos.ParagraphIndex].GetCell;
      AEndPos := TdxPositionConverter.ToDocumentModelPosition
        (ASelectionPieceTable, ASelection.Items[I].NormalizedEnd - 1);
      AEndCell := ASelectionPieceTable.Paragraphs
        [AEndPos.ParagraphIndex].GetCell;
      if (AStartCell = nil) or (AEndCell = nil) then
      begin
        ACells.Free;
        Exit(nil);
      end;
      ACells.AddSelectedCells(AStartCell.Row, AStartCell.IndexInRow,
        AEndCell.IndexInRow);
    end;
  end
  else
  begin
    ASelectedCells := TdxSelectedCellsCollection
      (DocumentModel.Selection.SelectedCells);
    ...
    begin
      ...
      ACells.AddSelectedCells(ASelectedCell.Row,
        ASelectedCell.NormalizedStartCellIndex,
        ASelectedCell.NormalizedEndCellIndex);
    end;
  end;
  Result := ACells;
end;
...
constructor TdxScrollHorizontallyByPhysicalOffsetCommand.Create
  (const AControl: IdxRichEditControl);
begin
  inherited Create(AControl);
  FPhysicalOffset := DocumentModel.LayoutUnitConverter.
...
function TdxScrollHorizontallyByPhysicalOffsetCommand.GetActiveView
  : TdxRichEditView;
begin
  Result := InnerControl.ActiveView;
end;

class function TdxScrollHorizontallyByPhysicalOffsetCommand.
  GetDescription: string;
begin
  Result := cxGetResourceString(@sdxRichEditExceptionThrowInternalException);
end;
...
begin
  ...
  View.HorizontalScrollController.ScrollByLeftInvisibleWidthDelta
    (PhysicalOffset);
  FExecutedSuccessfully := APreviousValue <> View.HorizontalScrollController.
    ScrollBarAdapter.Value;
end;

procedure TdxScrollHorizontallyByPhysicalOffsetCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  AState.Enabled := True;
  AState.Visible := True;
...
function TdxSelectionValidator.CalculateOffset(AParagraphIndex
  : TdxParagraphIndex; AIncrementIndex: Boolean): Integer;
var
  ACell: TdxTableCell;
begin
  Result := 0;
...
function TdxSelectionValidator.IsSelectedItemCovered
...
begin
  Result := ((AInterval.Start.RunIndex > AStart) and
    (AInterval.&End.RunIndex >= AEnd)) or
...
begin
  if AField.IsCodeView then
    Result := ShouldChangeInterval(AInterval, AField.Code.Start,
      AField.Code.&End)
  else
    Result := ShouldChangeInterval(AInterval, AField.Code.&End,
      AField.Result.&End);
end;
...
begin
  ASelectedInterval := PieceTable.FindRunInfo(ASelection.NormalizedStart,
    ASelection.Length);
  try
    ALastField := PieceTable.FindFieldByRunIndex
      (ASelectedInterval.&End.RunIndex);
    if ALastField <> nil then
      ChangeFieldSelection(ASelection, ASelectedInterval, ALastField);
    AFirstField := PieceTable.FindFieldByRunIndex
      (ASelectedInterval.Start.RunIndex);
...
begin
  ...
  begin
    ...
    AParagraphIndex := PieceTable.FindParagraphIndex
      (ASelectionItem.NormalizedStart);
    ALeftOffset := CalculateOffset(AParagraphIndex, True);
    AParagraphIndex := PieceTable.FindParagraphIndex
      (ASelectionItem.NormalizedEnd);
...
begin
  AStartPos := TdxDocumentModelPosition.FromRunStart(PieceTable,
    AField.FirstRunIndex);
  AEndPos := TdxDocumentModelPosition.FromRunEnd(PieceTable,
    AField.LastRunIndex);
  ...
  else if ASelection.&End < ASelection.Start then
  begin
...
function TdxEnsureCaretVisibleHorizontallyCommand.
  CalculateOptimalCaretHorizontalPosition(const ALogicalVisibleBounds,
  ACaretBounds: TRect): Integer;
var
...
begin
  ...
  AOptimalLogicalVisibleBounds.MoveToLeft(ACaretBounds.Left - 2 *
    ALogicalVisibleBounds.Width div 3);
...
begin
  ...
  if CaretPosition.PageViewInfo = nil then
    Exit;
  ALogicalVisibleBounds := ActiveView.CreateLogicalRectangle
    (CaretPosition.PageViewInfo, ActiveView.Bounds);
  if CaretPosition.LayoutPosition.DetailsLevel >= TdxDocumentLayoutDetailsLevel.Character
  then
  begin
...
begin
  AOptimalHorizontalPosition := CalculateOptimalCaretHorizontalPosition
    (ALogicalVisibleBounds, ACaretBounds);
  ...
  begin
    ...
    ActiveView.PageViewInfoGenerator.LeftInvisibleWidth :=
      ActiveView.HorizontalScrollController.GetLeftInvisibleWidth;
    ActiveView.OnHorizontalScroll;
  end;
end;

procedure TdxEnsureCaretVisibleHorizontallyCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  CheckExecutedAtUIThread;
  AState.Enabled := True;
...
constructor TdxCurrentRowInfo.Create(ARow: TdxRow;
  const ABoundsRelativeToPage: TRect);
begin
  Row := ARow;
...
constructor TdxEnsureCaretVisibleVerticallyCommand.Create(const ARichEditControl
  : IdxRichEditControl);
begin
  inherited Create(ARichEditControl);
...
begin
  ...
  begin
    APhysicalCaretRowBounds := ActiveView.CreatePhysicalRectangle
      (ACurrentCaretPosition.PageViewInfo,
      ACurrentCaretPosition.LayoutPosition.Row.Bounds);
    APhysicalAdjustedCaretRowBounds := ActiveView.CreatePhysicalRectangle
      (AAdjustedCaretPosition.PageViewInfo,
      AAdjustedCaretPosition.LayoutPosition.Row.Bounds);
    AViewBounds := ActiveView.Bounds;
    Assert(APhysicalAdjustedCaretRowBounds.Top < AViewBounds.Top);
    Result := APhysicalCaretRowBounds.Top + AViewBounds.Top -
      APhysicalAdjustedCaretRowBounds.Top <= AViewBounds.Bottom;
  end;
end;

function TdxEnsureCaretVisibleVerticallyCommand.
  CalculateActualInvisiblePageBounds(APageViewInfo: TdxPageViewInfo;
  ADirection: TdxSelectionMovementVerticalDirection): TRect;
var
  APageOffset: Integer;
begin
  if ADirection = TdxSelectionMovementVerticalDirection.Down then
    APageOffset := ActiveView.PageViewInfoGenerator.ActiveGenerator.PageRows.
      Last.Bounds.Bottom
  else
    APageOffset := ActiveView.PageViewInfoGenerator.ActiveGenerator.PageRows.
      First.Bounds.Top - 2 * APageViewInfo.Bounds.Bottom +
      APageViewInfo.Bounds.Height;
  Result := ActiveView.PageViewInfoGenerator.OffsetRectangle
    (APageViewInfo.Bounds, 0, APageOffset);
end;

function TdxEnsureCaretVisibleVerticallyCommand.
  CalculateDirectionToInvisibleCaret: TdxSelectionMovementVerticalDirection;
var
...
begin
  ...
  begin
    AViewBounds := ActiveView.Bounds;
    APhysicalCaretRowBounds := ActiveView.CreatePhysicalRectangle
      (TRect.CreateSize(0, 0, 100, 100), CurrentRow.BoundsRelativeToPage);
...
function TdxEnsureCaretVisibleVerticallyCommand.
  CalculatePhysicalOffsetForCaretPositionRowVisibilityCore
  (APageViewInfo: TdxPageViewInfo; const ARow: TdxCurrentRowInfo): Integer;
var
  ALogicalRowBounds, APhysicalRowBounds: TRect;
begin
  ALogicalRowBounds := CalculateTargetRowLogicalBounds(APageViewInfo, ARow);
  APhysicalRowBounds := ActiveView.CreatePhysicalRectangle(APageViewInfo,
    ALogicalRowBounds);
  Result := CalculatePhysicalOffsetForRowBoundsVisibility(ActiveView.Bounds,
    APhysicalRowBounds);
end;

function TdxEnsureCaretVisibleVerticallyCommand.
  CalculatePhysicalOffsetForRowBoundsVisibility(const AViewBounds,
  APhysicalRowBounds: TRect): Integer;
begin
  if (AViewBounds.Top <= APhysicalRowBounds.Top) and
    (APhysicalRowBounds.Bottom <= AViewBounds.Bottom) then
    Result := 0
  else
  begin
...
function TdxEnsureCaretVisibleVerticallyCommand.
  CalculatePhysicalOffsetToCaret: Integer;
begin
...
function TdxEnsureCaretVisibleVerticallyCommand.
  CalculatePhysicalOffsetToCaretAtInvisiblePage: Integer;
var
  APageViewInfo: TdxPageViewInfo;
...
begin
  ...
  APageViewInfo.Bounds := CalculateActualInvisiblePageBounds(APageViewInfo,
    ADirection);
  ActiveView.PageViewInfoGenerator.UpdatePageClientBounds(APageViewInfo);
  Result := CalculatePhysicalOffsetForCaretPositionRowVisibilityCore
    (APageViewInfo, CurrentRow);
  TdxPageViewInfo.Release(APageViewInfo);
end;

function TdxEnsureCaretVisibleVerticallyCommand.
  CalculatePhysicalOffsetToCaretAtVisiblePage: Integer;
begin
  Result := CalculatePhysicalOffsetForCaretPositionRowVisibilityCore
    (CurrentPageViewInfo, CurrentRow);
end;
...
begin
  ...
  begin
    APhysicalCaretRowBounds := ActiveView.CreatePhysicalRectangle
      (APos.PageViewInfo, APos.LayoutPosition.Row.Bounds);
    AViewBounds := ActiveView.Bounds;
    if APhysicalCaretRowBounds.Top < AViewBounds.Top then
      Result := TdxCaretScrollDirection.Up
    else if APhysicalCaretRowBounds.Bottom > AViewBounds.Bottom then
...
function TdxEnsureCaretVisibleVerticallyCommand.CreateAdjustedCaretPosition
  : TdxCaretPosition;
var
  ALogPosition: TdxDocumentLogPosition;
begin
  ALogPosition := ActivePieceTable.NavigationVisibleTextFilter.
    GetPrevVisibleLogPosition(CaretPosition.LogPosition, False);
...
begin
  ...
  if CaretPosition.LayoutPosition.DetailsLevel >= TdxDocumentLayoutDetailsLevel.Row
  then
  begin
    ARedraw := False;
...
begin
  ...
  if (ACaretScrollDirection = TdxCaretScrollDirection.Down) or
    (ACaretScrollDirection = TdxCaretScrollDirection.Unknown) then
  begin
    SaveCaretPosition(CaretPosition);
    Exit(False);
  end;
  ...
  try
    ...
    begin
      if (ACaretScrollDirection = TdxCaretScrollDirection.Up) or
        (ACaretScrollDirection = TdxCaretScrollDirection.Down) then
      begin
...
begin
  if ADirection = TdxSelectionMovementVerticalDirection.Up then
    ...
    ACalculator := TdxNextCaretPositionLineDownCalculator.Create
      (RichEditControl);
  try
    ACalculator.FixedDirection := False;
...
begin
  ...
  CurrentRow := TdxCurrentRowInfo.Create(APos.LayoutPosition.Row,
    APos.GetRowBoundsRelativeToPage);
  CurrentPageViewInfo := APos.PageViewInfo;
end;

procedure TdxEnsureCaretVisibleVerticallyCommand.
  ScrollToAlreadyFormattedContentCore(AVerticalOffset: Integer);
var
...
begin
  ...
  begin
    APhysicalCaretRowBounds := ActiveView.CreatePhysicalRectangle
      (CurrentPageViewInfo, TRect.CreateSize(0, AVerticalOffset, 100, 100));

    APageIndex := ActiveView.FormattingController.PageController.Pages.IndexOf
      (CurrentPage);
    Assert(APageIndex >= 0);
    ...
    APageViewInfoGenerator.FirstPageOffsetAnchor.VerticalOffset :=
      Math.Max(0, APageViewInfoGenerator.FirstPageOffsetAnchor.VerticalOffset
      + AOffset);
  end;
...
begin
  ...
  APageViewInfoGenerator := ActiveView.PageViewInfoGenerator;
  if APageViewInfoGenerator.TopInvisibleHeight >= APageViewInfoGenerator.TotalHeight
  then
  ...
  begin
    ...
    if AOffset < 0 then
      ...
      Inc(AOffset, CalculateOffsetToVisibleArea(ActiveView.Bounds.Height -
        ActiveView.CreatePhysicalRectangle(TRect.CreateSize(0, 0, 100, 100),
        CurrentRow.BoundsRelativeToPage).Height));
...
begin
  if CurrentPageViewInfo = nil then
    Exit;
  APhysicalCaretRowBounds := ActiveView.CreatePhysicalRectangle
    (CurrentPageViewInfo, CurrentRow.BoundsRelativeToPage);
...
procedure TdxEnsureCaretVisibleVerticallyCommand.
  ScrollVerticallyByPhysicalOffset(AOffset: Integer);
var
...
procedure TdxEnsureCaretVisibleVerticallyCommand.SetCurrentPage
  (const Value: TdxPage);
begin
...
procedure TdxEnsureCaretVisibleVerticallyCommand.SetCurrentPageViewInfo
...
procedure TdxEnsureCaretVisibleVerticallyCommand.SetCurrentRow
  (const Value: TdxCurrentRowInfo);
begin
...
function TdxEnsureCaretVisibleVerticallyCommand.
  ShouldAdjustCaretPosition: Boolean;
begin
  if DocumentModel.Selection.&End <= DocumentModel.Selection.Start then
    Result := False
  else
    Result := CaretPosition.LogPosition = CaretPosition.LayoutPosition.Row.
      GetFirstPosition(ActivePieceTable).LogPosition;
end;

procedure TdxEnsureCaretVisibleVerticallyCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  CheckExecutedAtUIThread;
  AState.Enabled := True;
...
procedure TdxNextCaretPositionVerticalDirectionCalculator.
  CorrectCaretXOnExtendSelection(ASourceCellViewInfo: TdxTableCellViewInfo;
  var ACaretX: Integer);
begin
  if ASourceCellViewInfo = nil then
    Exit;
  ACaretX := Max(ACaretX, ASourceCellViewInfo.TextLeft);
  ACaretX := Min(ACaretX, ASourceCellViewInfo.TextLeft +
    ASourceCellViewInfo.TextWidth);
end;

procedure TdxNextCaretPositionVerticalDirectionCalculator.
  CorrectRowAndCellViewInfo(APos: TdxCaretPosition;
  var ARowIndexInColumn: Integer;
  var ASourceCellViewInfo: TdxTableCellViewInfo);
var
...
begin
  ...
  begin
    ...
    ACellFromPreviousLayoutRow := APos.LayoutPosition.Column.Rows
      [ARowIndexInColumn].GetCellViewInfo;
    ATableRow := ASourceCellViewInfo.GetTableRow;
    ACellsInDifferentTables := (ACellFromPreviousLayoutRow <> nil) and
      not(ASourceCellViewInfo.TableViewInfo.Table = ACellFromPreviousLayoutRow.
      TableViewInfo.Table);
    if ACellsInDifferentTables and
      ASelection.
    ...
    else if IsCellFromPreviousRowIsInNestedTableInSourceCellViewInfo
      (ASourceCellViewInfo, ACellFromPreviousLayoutRow) then
    begin
      ASourceCellViewInfo := ACellFromPreviousLayoutRow;
    end
    else if ASourceCellViewInfo.Cell.IsFirstCellInRow and
      (ATableRow.Previous <> nil) then
    begin
      ATableRow := ATableRow.Previous;
      ASourceCellViewInfo := GetLastNonCoveredByVerticalMergingCell(ATableRow);
    end
    else if ACellFromPreviousLayoutRow = nil then
      ASourceCellViewInfo := nil
    else
      ASourceCellViewInfo := GetPreviousNonVerticalMergedCellInRow
        (ASourceCellViewInfo);
    if ASourceCellViewInfo <> nil then
    begin
...
begin
  ...
  try
    ...
    if (Result.LogPosition < ATargetRow.GetLastPosition(ActivePieceTable)
      .LogPosition) and (ACharacter.Bounds.Right > X) and
      (ACharacter.Bounds.Left <= X) then
    begin
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  CreateInvisiblePageRowsGenerator: TdxInvisiblePageRowsGenerator;
var
  ABounds: TRect;
begin
  Result := TdxInvisiblePageRowsGenerator.Create
  ...
  begin
    ...
    Result.FirstInvalidPageIndex := View.FormattingController.PageController.
      Pages.Count;
  end
  else
...
function TdxNextCaretPositionVerticalDirectionCalculator.FindMostNestedTableCell
  (ACell: TdxTableCellViewInfo; AColumn: TdxColumn; ACaretX: Integer)
...
begin
  Result := ACell;
  while (Result.InnerTables.Count > 0) and
    (Result.InnerTables[0].FirstContentInParentCell) do
  begin
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  FindMostParentTableRowViewInfo(ATargetTable: TdxTable;
...
begin
  ...
  AParentCellViewInfo := AFirstColumnRowCell.TableViewInfo.
    ParentTableCellViewInfo;
  ...
  begin
    ...
    AParentCellViewInfo := AParentCellViewInfo.TableViewInfo.
      ParentTableCellViewInfo;
  end;
end;

function TdxNextCaretPositionVerticalDirectionCalculator.
  FindTableCellViewInfoInTableRowByX(ATableRow: TdxTableRowViewInfoBase;
  X: Integer): TdxTableCellViewInfo;
var
...
begin
  ...
  if TdxAlgorithms1<TdxTableCellViewInfo>.BinarySearch(ACells,
    APredicate.CompareTo, AIndex) then
    Exit(ACells[AIndex]);
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  GenerateTargetPageViewInfoRow: TdxPageViewInfoRow;
var
  AGenerator: TdxInvisiblePageRowsGenerator;
begin
  ...
  try
    ...
    if Result <> nil then
      CorrectGeneratedRowPagesHorizontalLocation
        (AGenerator.LayoutManager, Result);
...
function TdxNextCaretPositionVerticalDirectionCalculator.GetActivePieceTable
  : TdxPieceTable;
begin
  Result := Control.InnerControl.DocumentModel.ActivePieceTable;
end;

function TdxNextCaretPositionVerticalDirectionCalculator.GetDefaultPosition
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  GetLastNonCoveredByVerticalMergingCell(ARow: TdxTableRowViewInfoBase)
  : TdxTableCellViewInfo;
var
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  GetLastTableRowInDirection(ACell: TdxTableCellViewInfo; X: Integer)
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  GetNextCellViewInfoInTargetRowWithNonZeroRows(AColumn: TdxColumn;
  ATargetRow: TdxTableRowViewInfoBase; ACellWithZeroRows: TdxTableCellViewInfo)
  : TdxTableCellViewInfo;
var
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  GetNextLayoutRowByDirection(ARows: TdxRowCollection;
  ASourceRowIndex: Integer): TdxRow;
var
  ANewIndex: Integer;
begin
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  GetPreviousNonVerticalMergedCellInRow(ASourceCellViewInfo
  : TdxTableCellViewInfo): TdxTableCellViewInfo;
var
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  GetTargetCellViewInfoFromNextTableRow(ACell: TdxTableCellViewInfo; X: Integer)
  : TdxTableCellViewInfo;
var
...
begin
  ...
  AHitTestRequest.LogicalPoint :=
    Point(ACaretX, ARow.Bounds.Top + ARow.BaseLineOffset);

  AHitTestResult := TdxRichEditHitTestResult.Create(View.DocumentLayout,
    ActivePieceTable);
  try
    AHitTestCalculator := View.CreateHitTestCalculator(AHitTestRequest,
      AHitTestResult);
    try
      AComparable := TdxBoxAndPointXComparable.Create
        (AHitTestRequest.LogicalPoint);
      ABoxIndex := AHitTestCalculator.FastHitTestIndexCore(ARow.Boxes,
        AComparable.CompareTo, False);
      Assert(ABoxIndex >= 0);
      ADetailRow := View.DocumentLayout.CreateDetailRowForBox(ARow,
        ARow.Boxes[ABoxIndex], False);
      try
...
begin
  ...
  AHitTestResult := TdxRichEditHitTestResult.Create(View.DocumentLayout,
    ActivePieceTable);
  try
    ACalculator := View.CreateHitTestCalculator(AHitTestRequest,
      AHitTestResult);
    try
      ACalculator.FastHitTestAssumingArrangedHorizontally
        (APageArea.Columns, False);
    finally
      ACalculator.Free;
    end;
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  GetTargetLayoutRowObtainTargetPageViewInfo(APos: TdxCaretPosition;
  var ACaretX: Integer): TdxRow;
var
...
begin
  ...
  Result := GetTargetLayoutRowObtainTargetPageViewInfoCore(APos.PageViewInfo,
    ACaretX, ALayoutPosition.Column, ARowIndexInColumn, ASourceCellViewInfo);
end;

function TdxNextCaretPositionVerticalDirectionCalculator.
  GetTargetLayoutRowObtainTargetPageViewInfoCore(APageViewInfo: TdxPageViewInfo;
  var ACaretX: Integer; AColumn: TdxColumn; ARowIndexInColumn: Integer;
  ASourceCellViewInfo: TdxTableCellViewInfo): TdxRow;
begin
  if ShouldObtainTargetPageViewInfo(ARowIndexInColumn, AColumn.Rows.Count) or
    IsBoundaryTableCellRowOnCurrentPage(ASourceCellViewInfo, AColumn,
    ARowIndexInColumn, ACaretX) then
    Result := ObtainTargetRowFromCurrentPageViewInfoAndCaretX(APageViewInfo,
      ASourceCellViewInfo, ACaretX)
  else
    Result := ObtainTargetLayoutRow(ARowIndexInColumn, ACaretX, AColumn,
      ASourceCellViewInfo);
end;

function TdxNextCaretPositionVerticalDirectionCalculator.GetView
  : TdxRichEditView;
begin
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  IsBoundaryTableCellRowOnCurrentPage(ACell: TdxTableCellViewInfo;
  AColumn: TdxColumn; ASourceRowIndexInColumn, ACaretX: Integer): Boolean;
var
  ARows: TdxRowCollection;
...
begin
  ...
  begin
    ...
    if not ASourceRowIsLastInCurrentCell and
      (GetCellBoundaryRowIndex(AColumn, AParentCell) <> ASourceRowIndexInColumn)
    then
      Exit(False);
    if not IsCellInBoundaryRow(AColumn, AParentCell, ACaretX) then
      Exit(False)
    else if ASourceRowIsLastInCurrentCell then
    begin
      ...
      begin
        ...
        while (ALastRowCellViewInfo.TableViewInfo <> AParentCell.TableViewInfo)
          and (ALastRowCellViewInfo.TableViewInfo <>
          ACurrentCell.TableViewInfo) do
          ALastRowCellViewInfo := ALastRowCellViewInfo.TableViewInfo.
            ParentTableCellViewInfo;
  ...
  ABoundaryOuterTableViewInfo := ABoundaryRowInColumn.CellViewInfo.
    TableViewInfo;
  while ABoundaryOuterTableViewInfo.ParentTableCellViewInfo <> nil do
    ABoundaryOuterTableViewInfo :=
      ABoundaryOuterTableViewInfo.ParentTableCellViewInfo.TableViewInfo;
  Result := AOuterTableViewInfo = ABoundaryOuterTableViewInfo;
end;

function TdxNextCaretPositionVerticalDirectionCalculator.
  IsCaretAtTheBeginningOfAnotherCell(APos: TdxCaretPosition;
  ADocumentModel: TdxDocumentModel): Boolean;
var
  ASelection: TdxSelection;
begin
  ...
  Result := (ASelection.Length > 0) and (ASelection.&End > ASelection.Start) and
    (APos.LayoutPosition.Row.GetFirstPosition(ADocumentModel.ActivePieceTable)
    .LogPosition = APos.LogPosition);
end;

function TdxNextCaretPositionVerticalDirectionCalculator.
  IsCellFromPreviousRowIsInNestedTableInSourceCellViewInfo(ASourceCellViewInfo,
  ACellFromPreviousLayoutRow: TdxTableCellViewInfo): Boolean;
begin
  Result := False;
  if ACellFromPreviousLayoutRow = nil then
    Exit;
  Result := TdxDocumentModel(ASourceCellViewInfo.Cell.DocumentModel)
    .Selection.FirstCellIsParentCellForSecondCellsTable
    (ASourceCellViewInfo.Cell, ACellFromPreviousLayoutRow.Cell);
end;

function TdxNextCaretPositionVerticalDirectionCalculator.
  IsLastOrFirstLayoutRowInCell(ARowIndexInCell, ACellsRowsCount
  : Integer): Boolean;
begin
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  MoveBetweenRowsInsideCell(ACellRows: TdxRowCollection;
  ARowIndexInCell: Integer): TdxRow;
begin
  Result := GetNextLayoutRowByDirection(ACellRows, ARowIndexInCell);
end;

function TdxNextCaretPositionVerticalDirectionCalculator.
  ObtainLayoutRowFromValidCellInFirstRowNestedTable(ARowIndex, ACaretX: Integer;
  AColumn: TdxColumn; ASourceNestedLevel: Integer): TdxRow;
var
  ANextLayoutRow: TdxRow;
  ARows: TdxRowCollection;
...
begin
  ...
  AFirstCellInInnerTable := GetTargetCellViewInfoInNestedTable(ANextLayoutRow,
    ACaretX, ASourceNestedLevel);
  ...
  while AFirstCellInInnerTable.TableViewInfo.Table.NestedLevel <>
    ACandidateCell.TableViewInfo.Table.NestedLevel do
  begin
    AFirstCellInInnerTable := FindTableCellViewInfoInTableRowByX
      (ACandidateCell.GetTableRow, ACaretX);
    ARows := AFirstCellInInnerTable.GetRows(AColumn);
    try
      AFirstLayoutRowInInnerTableCell := GetFirstOrLastLayoutRowInCell(ARows);
    finally
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  ObtainRowFromOuterTextRowOrOuterTableWhenCellsInInnerTable(AColumn: TdxColumn;
  AInnerSourceCellViewInfo: TdxTableCellViewInfo; ACaretX: Integer;
  AFirstOrLastCellInRow: TdxTableCellViewInfo): TdxRow;
var
...
begin
  ...
  try
    AFirstOrLastTextRowInCell := GetTargetLayoutRowInCell
      (AFirstLastTextRowsCollection);
  finally
...
begin
  ...
  begin
    ...
    begin
      ATargetCell := FindTableCellViewInfoInTableRowByX
        (ANextCell.GetTableRow, ACaretX);
      ATargetCellLayoutRows := ATargetCell.GetRows(AColumn);
      try
        if ATargetCellLayoutRows.Count = 0 then
        begin
          ANextCellWithNonZeroRows :=
            GetNextCellViewInfoInTargetRowWithNonZeroRows(AColumn,
    ...
    Result := ObtainTargetLayoutRowFromNextCellInCurrentTable(ARowIndexInColumn,
      ACaretX, AColumn, ANextCell);
end;

function TdxNextCaretPositionVerticalDirectionCalculator.
  ObtainTargetLayoutRowFromNextCellInCurrentTable(ARowIndexInColumn,
  ACaretX: Integer; AColumn: TdxColumn;
  ASourceCellViewInfo: TdxTableCellViewInfo): TdxRow;
var
  ANextCell: TdxTableCellViewInfo;
...
begin
  ANextCell := GetTargetCellViewInfoFromNextTableRow
    (ASourceCellViewInfo, ACaretX);
  ACellRows := ASourceCellViewInfo.GetRows(AColumn);
  try
    ARowIndexInCell := ACellRows.IndexOf(AColumn.Rows[ARowIndexInColumn]);
    AShouldJumpToCellInNestedTable := ShouldJumpToCellInNestedTable
      (AColumn.Rows, ASourceCellViewInfo.Cell.Table.NestedLevel,
      ARowIndexInColumn, ACaretX);
    AIsLastOrFirstLayoutRowInCell := IsLastOrFirstLayoutRowInCell
      (ARowIndexInCell, ACellRows.Count);
    if ShouldJumpToNextCellInCurrentTable(AShouldJumpToCellInNestedTable,
      ANextCell, AIsLastOrFirstLayoutRowInCell) then
      Exit(ObtainTargetLayoutRowFromNextCellInCurrentTableCore(ACaretX, AColumn,
        ASourceCellViewInfo, ANextCell));
    if AShouldJumpToCellInNestedTable then
      Exit(ObtainLayoutRowFromValidCellInFirstRowNestedTable(ARowIndexInColumn,
        ACaretX, AColumn, ASourceCellViewInfo.TableViewInfo.Table.NestedLevel));
    if ShouldObtainNextLayoutRowInsideCell(AIsLastOrFirstLayoutRowInCell,
      ANextCell) then
    begin
    ...
    begin
      ...
      Result := MoveFromInnerIntoOuterTable(ASourceCellViewInfo, AColumn,
        AFirstOrLastCellInRow, ACaretX);
    end;
  finally
    ACellRows.Free;
  end;
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  ObtainTargetLayoutRowFromNextCellInCurrentTableCore(ACaretX: Integer;
  AColumn: TdxColumn; ASourceCellViewInfo,
...
begin
  ...
  ANextCellViewInfoNestedLevel := AFirstOrLastRowInCell.GetCellViewInfo.
    TableViewInfo.Table.NestedLevel;
  AIsLayoutRowInNestedTable := ANextCellViewInfoNestedLevel <>
    ASourceCellViewInfo.Cell.Table.NestedLevel;
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  ObtainTargetPageViewInfo(ACurrentPageViewInfo: TdxPageViewInfo;
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  ObtainTargetRowFromCurrentPageViewInfoAndCaretX(APageViewInfo
  : TdxPageViewInfo; ACellViewInfoFromPreviousTableViewInfo
  : TdxTableCellViewInfo; var ACaretX: Integer): TdxRow;
var
  ...
  AFirstColumnRowCell, ACellFromNextPage, ANextCell, AMostNestedTableCell
    : TdxTableCellViewInfo;
  ATargetTable, AParentTargetTable: TdxTable;
  ATargetTableFromPreviousPageNestedLevel,
    AFirstColumnRowCellTableNestedLevel: Integer;
  AIsExpectedTheNestedTableEndsOnPreviousPageAndOuterTableContinuesOnTheNextPage
    : Boolean;
  ATargetRow: TdxTableRowViewInfoBase;
begin
  APhysicalCaretPoint := View.CreatePhysicalPoint(APageViewInfo,
    TPoint.Create(ACaretX, 0));
  ATargetPageViewInfo := ObtainTargetPageViewInfo(APageViewInfo,
    APhysicalCaretPoint.X);
  if ATargetPageViewInfo = nil then
    Exit(nil);
  ALogicalCaretPoint := View.CreateLogicalPoint
    (ATargetPageViewInfo.ClientBounds, TPoint.Create(APhysicalCaretPoint.X, 0));
  ...
  AFirstColumnRowCellTableNestedLevel :=
    AFirstColumnRowCell.TableViewInfo.Table.NestedLevel;
  AIsExpectedTheNestedTableEndsOnPreviousPageAndOuterTableContinuesOnTheNextPage
    := ATargetTableFromPreviousPageNestedLevel -
    1 = AFirstColumnRowCellTableNestedLevel;
  if AIsExpectedTheNestedTableEndsOnPreviousPageAndOuterTableContinuesOnTheNextPage
  then
  begin
    AParentTargetTable := ATargetTable.ParentCell.Table;
    ATargetTable := AParentTargetTable;
  end;
  ATargetRow := FindMostParentTableRowViewInfo(ATargetTable,
    AFirstColumnRowCell);
  ACellFromNextPage := FindTableCellViewInfoInTableRowByX(ATargetRow, ACaretX);
  ARows := ACellFromNextPage.GetRows(AColumn);
  try
    if ACellFromNextPage.IsStartOnPreviousTableViewInfo and (ARows.Count = 0)
    then
    begin
      ANextCell := GetTargetCellViewInfoFromNextTableRow
        (ACellFromNextPage, ACaretX);
      if ANextCell = nil then
      begin
        ANextCell := GetNextCellViewInfoInTargetRowWithNonZeroRows(AColumn,
          ATargetRow, ACellFromNextPage);
        Exit(ObtainTargetLayoutRowFromNextCellInCurrentTableCore(ACaretX,
          AColumn, ACellFromNextPage, ANextCell));
      end;
      Exit(ObtainTargetLayoutRowFromNextCellInCurrentTableCore(ACaretX, AColumn,
        ACellFromNextPage, ANextCell));
    end;
  finally
    ARows.Free;
  end;
  AMostNestedTableCell := FindMostNestedTableCell(ACellFromNextPage,
    AColumn, ACaretX);
...
procedure TdxNextCaretPositionVerticalDirectionCalculator.SetCurrentPageRow
  (const Value: TdxPageViewInfoRow);
begin
...
function TdxNextCaretPositionVerticalDirectionCalculator.
  ShouldJumpToCellInNestedTable(ARows: TdxRowCollection;
...
begin
  ...
  ATargetCell := GetTargetCellViewInfoInNestedTable(ANextLayoutRow, ACaretX,
    ACurrentCellNestedLevel);
  ...
  if not ANextCellIsNested then
    Exit;
  AParentCellViewInfoForTargetCell :=
    ATargetCell.TableViewInfo.ParentTableCellViewInfo;
  ...
  begin
    ...
    if Result then
      Break;
    AParentCellViewInfoForTargetCell :=
      AParentCellViewInfoForTargetCell.TableViewInfo.ParentTableCellViewInfo;
  end;
end;

function TdxNextCaretPositionVerticalDirectionCalculator.
  ShouldJumpToNextCellInCurrentTable(AShouldJumpToCellInNestedTable: Boolean;
  ANextCell: TdxTableCellViewInfo;
  AIsLastOrFirstLayoutRowInCell: Boolean): Boolean;
var
  AShouldJumpToNextCellInCurrentTable: Boolean;
begin
  AShouldJumpToNextCellInCurrentTable := (ANextCell <> nil) and
    AIsLastOrFirstLayoutRowInCell;
  Result := not AShouldJumpToCellInNestedTable and
    AShouldJumpToNextCellInCurrentTable;
end;

function TdxNextCaretPositionVerticalDirectionCalculator.
  ShouldObtainNextLayoutRowInsideCell(AIsLastOrFirstLayoutRowInCell: Boolean;
...
function TdxNextCaretPositionLineUpCalculator.
  ObtainExistingTargetPageViewInfoRow(APageRows: TdxPageViewInfoRowCollection;
...
function TdxNextCaretPositionUpDirectionCalculator.
...
procedure TdxNextCaretPositionUpDirectionCalculator.
  CorrectGeneratedRowPagesHorizontalLocation(ALayoutManager
  : TdxPageGeneratorLayoutManager; ARow: TdxPageViewInfoRow);
var
  X: Integer;
  I: Integer;
...
function TdxNextCaretPositionUpDirectionCalculator.
  GetBottomRightTableCellViewInfoByNestedLevel(ANextLayoutRow: TdxRow;
  ADesiredNestedLevel: Integer): TdxTableCellViewInfo;
var
...
function TdxNextCaretPositionUpDirectionCalculator.GetBoundaryRowInColumn
  (AColumn: TdxColumn): TdxRow;
begin
  Result := AColumn.Rows.First;
end;

function TdxNextCaretPositionUpDirectionCalculator.GetCellBoundaryRowIndex
  (AColumn: TdxColumn; AParentCell: TdxTableCellViewInfo): Integer;
begin
  Result := AParentCell.GetFirstRowIndex(AColumn);
end;

function TdxNextCaretPositionUpDirectionCalculator.
  GetFirstOrLastCellViewInfoInRow(ARow: TdxTableRowViewInfoBase)
  : TdxTableCellViewInfo;
begin
...
function TdxNextCaretPositionUpDirectionCalculator.
  GetTargetCellViewInfoInNestedTable(ANextLayoutRow: TdxRow;
  ACaretX, ACurrentNestedLevel: Integer): TdxTableCellViewInfo;
var
  ATopLeftCell: TdxTableCellViewInfo;
begin
  ATopLeftCell := GetBottomRightTableCellViewInfoByNestedLevel(ANextLayoutRow,
    ACurrentNestedLevel + 1);
  if ATopLeftCell = nil then
    Result := nil
  else
    Result := FindTableCellViewInfoInTableRowByX
      (ATopLeftCell.GetTableRow, ACaretX);
end;
...
function TdxNextCaretPositionUpDirectionCalculator.IsBoundaryRowInCell
  (AColumn: TdxColumn; ACell: TdxTableCellViewInfo; ASourceRow: TdxRow)
  : Boolean;
var
  ARows: TdxRowCollection;
begin
...
function TdxNextCaretPositionUpDirectionCalculator.
  IsCellViewInfoContinuesOnAnotherPage(ACell: TdxTableCellViewInfo): Boolean;
begin
...
begin
  if ShouldJumpUpFromMultipleInnerTableToOuter(AFirstOrLastCellInRow) then
    Result := ObtainRowInNextCellWhenFirstCellInTableRowIsInMultipleInnerTable
      (AColumn, ACaretX, AFirstOrLastCellInRow.TableViewInfo)
  else
    Result := ObtainRowFromOuterTextRowOrOuterTableWhenCellsInInnerTable
      (AColumn, AInnerSourceCellViewInfo, ACaretX, AFirstOrLastCellInRow);
end;

function TdxNextCaretPositionUpDirectionCalculator.
  ObtainRowInNextCellWhenFirstCellInTableRowIsInMultipleInnerTable
  (AColumn: TdxColumn; ACaretX: Integer;
  ATableViewInfo: TdxTableViewInfo): TdxRow;
var
  ARow: TdxRow;
...
begin
  ...
  Result := ObtainTargetLayoutRowFromNextCellInCurrentTable(ARowIndexInColumn,
    ACaretX, AColumn, AParentCellViewInfo);
end;

function TdxNextCaretPositionUpDirectionCalculator.
  ShouldJumpUpFromMultipleInnerTableToOuter(AFirstCellInTableRow
  : TdxTableCellViewInfo): Boolean;
begin
...
function TdxNextCaretPositionLineDownCalculator.
  ObtainExistingTargetPageViewInfoRow(APageRows: TdxPageViewInfoRowCollection;
  ACurrentRowIndex: Integer): TdxPageViewInfoRow;
begin
  Result := APageRows[ACurrentRowIndex + 1];
...
function TdxNextCaretPositionDownDirectionCalculator.
  CalculateFirstInvalidPageIndex: Integer;
begin
...
procedure TdxNextCaretPositionDownDirectionCalculator.
  CorrectGeneratedRowPagesHorizontalLocation(ALayoutManager
  : TdxPageGeneratorLayoutManager; ARow: TdxPageViewInfoRow);
begin
end;

function TdxNextCaretPositionDownDirectionCalculator.GetBoundaryRowInColumn
  (AColumn: TdxColumn): TdxRow;
begin
  Result := AColumn.Rows.Last;
end;

function TdxNextCaretPositionDownDirectionCalculator.GetCellBoundaryRowIndex
  (AColumn: TdxColumn; AParentCell: TdxTableCellViewInfo): Integer;
begin
...
function TdxNextCaretPositionDownDirectionCalculator.
  GetFirstOrLastLayoutRowInCell(ACellRows: TdxRowCollection): TdxRow;
begin
...
var
  ATopLeftCell: TdxTableCellViewInfo;
begin
  ATopLeftCell := GetTopLeftTableCellViewInfoByNestedLevel(ANextLayoutRow,
    ACurrentNestedLevel + 1);
  if ATopLeftCell = nil then
    Result := nil
  else
...
function TdxNextCaretPositionDownDirectionCalculator.GetTargetPageArea
  (APage: TdxPage): TdxPageArea;
begin
...
function TdxNextCaretPositionDownDirectionCalculator.
  GetTopLeftTableCellViewInfoByNestedLevel(ANextLayoutRow: TdxRow;
  ADesiredNestedLevel: Integer): TdxTableCellViewInfo;
var
  ANextLayoutRowTableNestedLevel: Integer;
begin
...
function TdxNextCaretPositionDownDirectionCalculator.IsBoundaryRowInCell
  (AColumn: TdxColumn; ACell: TdxTableCellViewInfo; ASourceRow: TdxRow)
  : Boolean;
var
  ARows: TdxRowCollection;
...
begin
  Result := (ACell <> nil) and
    (ACell.BottomAnchorIndex + 1 = ACell.TableViewInfo.Anchors.Count);
end;
...
begin
  ...
  AFirstLastTextRowsCollection := ATargetLastCellViewInfoWithNonZeroRows.
    GetRows(AColumn);
  try
...
function TdxScrollVerticallyByPhysicalOffsetEnsurePageGenerationCommand.
  CalculateNewTopInvisibleHeight(ADelta: Int64): Int64;
begin
  Result := View.PageViewInfoGenerator.TopInvisibleHeight + ADelta;
end;

procedure TdxScrollVerticallyByPhysicalOffsetEnsurePageGenerationCommand.
  GeneratePagesToEnsureScrollingSuccessfully(ADelta: Int64);
var
...
begin
  ...
  if ANewTopInvisibleHeight <= APageViewInfoGenerator.TotalHeight -
    APageViewInfoGenerator.VisibleHeight + 1 then
    Exit;
...
function TdxExtendKeyboardSelectionHorizontalDirectionCalculator.
  CalculateNextPosition(ALogPosition: TdxDocumentLogPosition)
  : TdxDocumentLogPosition;
begin
  Result := ALogPosition;
end;
...
function TdxExtendKeyboardSelectionHorizontalDirectionCalculator.
  CalculatePrevPosition(ALogPosition: TdxDocumentLogPosition)
  : TdxDocumentLogPosition;
begin
  Result := ALogPosition;
end;
...
function TdxEnsureCaretVisibleVerticallyForMovePrevNextPageCommand.
  CalculatePhysicalOffsetForRowBoundsVisibility(const AViewBounds,
  APhysicalRowBounds: TRect): Integer;
begin
  if (AViewBounds.Top <= APhysicalRowBounds.Top) and
...
function TdxEnsureCaretVisibleVerticallyForMovePrevNextPageCommand.
  CalculateTargetRowLogicalBounds(APageViewInfo: TdxPageViewInfo;
  const ARow: TdxCurrentRowInfo): TRect;
var
  ALogicalRowBounds, ATopmostRowBounds: TRect;
begin
  ALogicalRowBounds := ValidateRowBounds(APageViewInfo,
    ARow.BoundsRelativeToPage);
  ATopmostRowBounds := ValidateRowBounds(APageViewInfo,
    CalculateTopmostRow(APageViewInfo.Page).Bounds);
  ALogicalRowBounds.MoveToTop(ALogicalRowBounds.Top -
    Round(PhysicalOffsetAboveTargetRow * ActiveView.ScaleFactor));
...
function TdxEnsureCaretVisibleVerticallyForMovePrevNextPageCommand.
  CalculateTopmostRow(APage: TdxPage): TdxRow;
var
...
procedure TdxHistoryCommandBase.UpdateUIStateCore(const AState
  : IdxCommandUIState);
begin
  CheckExecutedAtUIThread;
  AState.Enabled := IsContentEditable and CanPerformHistoryOperation
...
begin
  ...
  ApplyCommandRestrictionOnEditableControl(AState,
    DocumentModel.DocumentCapabilities.Undo,
...
procedure TdxClearUndoCommand.PerformHistoryOperation
  (AHistory: TdxDocumentHistory);
begin
  AHistory.SmartClear;
end;

function TdxClearUndoCommand.CanPerformHistoryOperation
  (AHistory: TdxDocumentHistory): Boolean;
begin
  Result := True;
end;

procedure TdxClearUndoCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
begin
  CheckExecutedAtUIThread;
  ApplyCommandRestrictionOnEditableControl(AState,
    Options.DocumentCapabilities.Undo,
    CanPerformHistoryOperation(DocumentModel.History));
end;
...
begin
  DocumentModel.BeginUpdate;
  try
    DocumentModel.FormattingMarkVisibilityOptions.ShowHiddenText :=
      not DocumentModel.FormattingMarkVisibilityOptions.ShowHiddenText;
...
procedure TdxToggleShowWhitespaceCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
  AState.Enabled := True;
  AState.Visible := True;
  AState.Checked := DocumentModel.FormattingMarkVisibilityOptions.
    ShowHiddenText;
end;
...
begin
  ASelection := DocumentModel.Selection;
  if (ASelection.NormalizedEnd > 0) and
    (ASelection.NormalizedEnd <> ASelection.NormalizedStart) then
    Result := ActivePieceTable.FindParagraphIndex(ASelection.NormalizedEnd
      - 1, False)
  else
    Result := ActivePieceTable.FindParagraphIndex
      (ASelection.NormalizedEnd, False);
end;
...
function TdxChangeIndentCommand.GetStartParagraphLayoutPosition
  : TdxDocumentLayoutPosition;
var
  AParagraph: TdxParagraph;
begin
  AParagraph := ActivePieceTable.Paragraphs[StartIndex];
  Result := TdxDocumentLayoutPosition
    (ActiveView.DocumentLayout.CreateLayoutPosition(ActivePieceTable,
    AParagraph.LogPosition, 0));
  Result.Update(ActiveView.DocumentLayout.Pages,
    TdxDocumentLayoutDetailsLevel.Row);
end;
...
begin
  ...
  begin
    ...
    if AParagraph.IsInList and (AParagraph.GetNumberingListIndex = AListIndex)
    then
      Exit(False);
  end;
  Result := True;
...
procedure TdxChangeIndentCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
begin
  ApplyCommandRestrictionOnEditableControl(AState,
    DocumentModel.DocumentCapabilities.ParagraphFormatting);
...
begin
  ACommand := TdxIncrementNumerationFromParagraphCommand.Create
    (RichEditControl);
  try
    ACommand.Execute;
  finally
...
begin
  ACommand := TdxIncrementNumerationParagraphIndentCommand.Create
    (RichEditControl);
  try
    ACommand.Execute;
  finally
...
begin
  ACommand := TdxDecrementNumerationFromParagraphCommand.Create
    (RichEditControl);
  try
...
begin
  ACommand := TdxDecrementNumerationParagraphIndentCommand.Create
    (RichEditControl);
  try
    ACommand.ForceExecute(CreateDefaultCommandUIState);
  finally
...
function TdxExtendNextCaretPositionLineUpCalculator.GetDefaultPosition
  : TdxDocumentModelPosition;
begin
  Result := TdxDocumentModelPosition.FromParagraphStart(ActivePieceTable,
    ActivePieceTable.Paragraphs.First.Index);
end;

function TdxExtendNextCaretPositionLineUpCalculator.GetSelectedCells
...
function TdxExtendNextCaretPositionLineUpCalculator.
  ShouldJumpToNextCellInCurrentTable(AShouldJumpToCellInNestedTable: Boolean;
  ANextCell: TdxTableCellViewInfo;
  AIsLastOrFirstLayoutRowInCell: Boolean): Boolean;
var
  ...
  ASelectedCells: TdxSelectedCellsCollection;
begin
  ABaseCondition := inherited ShouldJumpToNextCellInCurrentTable
    (AShouldJumpToCellInNestedTable, ANextCell, AIsLastOrFirstLayoutRowInCell);
...
procedure TdxExtendNextCaretPositionLineDownCalculator.
  CorrectCaretXOnExtendSelection(ASourceCellViewInfo: TdxTableCellViewInfo;
  var ACaretX: Integer);
begin
  if ASourceCellViewInfo = nil then
...
function TdxExtendNextCaretPositionLineDownCalculator.GetDefaultPosition
  : TdxDocumentModelPosition;
begin
  Result := TdxDocumentModelPosition.FromParagraphEnd(ActivePieceTable,
    ActivePieceTable.Paragraphs.Last.Index);
end;

function TdxExtendNextCaretPositionLineDownCalculator.
  MoveFromInnerIntoOuterTable(AInnerSourceCellViewInfo: TdxTableCellViewInfo;
  AColumn: TdxColumn; ALastCellInTableRow: TdxTableCellViewInfo;
  ACaretX: Integer): TdxRow;
begin
  if Selection.SelectedCells is TdxStartSelectedCellInTable then
  begin
    if (Selection.SelectedCells.FirstSelectedCell <> nil) and
      (TObject(ALastCellInTableRow.TableViewInfo.ParentTableCellViewInfo)
      = TObject(Selection.SelectedCells.FirstSelectedCell)) then
      Selection.SelectedCells := TdxSelectedCellsCollection.Create
        (TdxStartSelectedCellInTable(Selection.SelectedCells));
  end;
  Result := inherited MoveFromInnerIntoOuterTable(AInnerSourceCellViewInfo,
    AColumn, ALastCellInTableRow, ACaretX);
end;
...
begin
  ...
  ASelectedCells := TdxSelectedCellsCollection(Selection.SelectedCells);
  ASelectingOneCell := ASelectedCells.SelectedOnlyOneCell;
  Result := ABaseCondition or (not ASelectingOneCell and (ANextCell <> nil));
end;

function TdxExtendNextCaretPositionLineDownCalculator.GetSelection
  : TdxSelection;
begin
  Result := Control.InnerControl.DocumentModel.Selection;
end;

function TdxExtendNextCaretPositionLineDownCalculator.GetSelectedCells
  : TdxSelectedTableStructureBase;
begin
  Result := Selection.SelectedCells;
end;

procedure TdxExtendNextCaretPositionLineDownCalculator.SetSelectedCells
  (const Value: TdxSelectedTableStructureBase);
begin
  Selection.SelectedCells := Value;
end;
...
procedure TdxToggleShowRulersCommandBase.UpdateUIStateCore
  (const AState: IdxCommandUIState);
var
  ARulerOptions: TdxRulerOptions;
...
function TdxToggleShowRulersCommandBase.IsRulerVisible
  (AVisibility: TdxRichEditRulerVisibility): Boolean;
begin
  Result := (AVisibility = TdxRichEditRulerVisibility.Visible) or
    (((AVisibility = TdxRichEditRulerVisibility.Auto) and ShowRulerByDefault));
end;
...
function TdxZoomInCommand.CalculateNewZoomFactor(AOldZoomFactor
  : Single): Single;
var
...
function TdxZoomOutCommand.CalculateNewZoomFactor(AOldZoomFactor
  : Single): Single;
begin
...
function TdxZoomPercentCommand.CalculateNewZoomFactor(AOldZoomFactor
  : Single): Single;
begin
...
procedure TdxZoomPercentCommand.UpdateUIStateCore(const AState
  : IdxCommandUIState);
var
  AValueState: IdxValueBasedCommandUIState<Single>;
begin
...
procedure TdxSwitchActiveViewCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
...
function TdxChangePageColorCommand.CreateDefaultCommandUIState
  : IdxCommandUIState;
begin
...
procedure TdxChangePageColorCommand.ForceExecute(const AState
  : IdxCommandUIState);
var
...
procedure TdxChangePageColorCommand.UpdateUIStateCore
  (const AState: IdxCommandUIState);
begin
