...
type
  ...
  public
    ...
    property Items[Index: Integer]: IdxSelectionLayoutItem
  ...
  strict private
    ...
    function CalculateCore(AStartCell: TdxTableCell; AEndCell: TdxTableCell;
      ATable: TdxTable; AIsColumnSelected: Boolean): TdxSelectedCellsCollection;
  public
    constructor Create(APieceTable: TdxPieceTable);
    function CalculateSelectedCells(AResult: TdxSelectedCellsCollection;
      ARow: TdxTableRow; ALeftColumnIndex: Integer; ARightColumnIndex: Integer;
      AIsLeftToRight: Boolean): Boolean;
    function SetStartCell(APos: TdxDocumentLogPosition)
      : TdxSelectedTableStructureBase;
    function Calculate(AStartCell: TdxTableCell; AEndCell: TdxTableCell)
      : TdxSelectedCellsCollection; overload;
    function Calculate(AStartCell: TdxTableCell; AEndCell: TdxTableCell;
      AIsColumnSelected: Boolean): TdxSelectedCellsCollection; overload;
  ...
  public
    ...
    procedure SetFirstSelectedCell(AStartCell: TdxTableCell;
      APos: TdxDocumentLogPosition); override;
  ...
  TdxRowSelectionLayoutBase = class abstract(TInterfacedObject,
    IdxSelectionLayoutItem)
  strict private
    FBounds: TRect;
    FPage: TdxPage;
  ...
  TdxRectangularObjectSelectionLayoutBase = class abstract(TInterfacedObject,
    IdxSelectionLayoutItem)
  private
    FView: TObject;
    FBox: TdxBox;
  ...
  protected
    ...
    function Update: Boolean; virtual; abstract;
    function HitTest(ALogPosition: TdxDocumentLogPosition;
      const ALogicalPoint: TPoint): Boolean; virtual; abstract;
    function GetType: TClass;

  public
    constructor Create(AView: TObject; ABox: TdxBox;
      AStart: TdxDocumentLogPosition; APieceTable: TdxPieceTable);
    destructor Destroy; override;
  ...
  public
    destructor Destroy; override;
    class function CreateResizableLayout(AView: TObject { TdxRichEditView };
      ABox: TdxBox; AStart: TdxDocumentLogPosition; APieceTable: TdxPieceTable)
      : TdxRectangularObjectSelectionLayout; static;
    property HitTestTransform: TdxTransformMatrix read FHitTestTransform
      write FHitTestTransform;
    property Anchor: TdxFloatingObjectAnchorSelectionLayout read FAnchor
      write FAnchor;
    ...
    function Update: Boolean; override;
    function HitTest(ALogPosition: TdxDocumentLogPosition;
      const ALogicalPoint: TPoint): Boolean; override;
  end;
  ...
  protected
    ...
    function GetIsNotEmpty: Boolean; override;
    function GetRowsCount: Integer; override;
    function GetSelectedColumnsCountInRow(ASelectionInterval
  ...
  public
    ...
    destructor Destroy; override;
    procedure AddSelectedCells(ARow: TdxTableRow; AStart: Integer;
      AEnd: Integer);
    ...
    property Items[Index: Integer]: TdxSelectedCellsIntervalInRow read GetItem
      write SetItem; default;
    property NormalizedFirst: TdxSelectedCellsIntervalInRow
      read GetNormalizedFirst;
    property NormalizedLast: TdxSelectedCellsIntervalInRow
      read GetNormalizedLast;
...
type
  ...
  TdxResizableRectangularObjectSelectionLayout = class
    (TdxRectangularObjectSelectionLayout)
  public const
  ...
  public
    constructor Create(AView: TObject { TdxRichEditView }; ABox: TdxBox;
      AStart: TdxDocumentLogPosition; APieceTable: TdxPieceTable);
    function Update: Boolean; override;
    procedure AddHotZone(AHotZone: TdxHotZone; const ABounds: TRect);
    function TryCreateAnchorSelectionItem
      : TdxFloatingObjectAnchorSelectionLayout;
    function CalculateExtendedBounds(const R: TRect): TRect;
    function RectangleFromCenter(X: Integer; Y: Integer;
      ALargeHotZoneSize: Integer): TRect;
    function AlignSizeToPixel(ALayoutSize: Integer): Integer;
  end;

  { TdxRectangularObjectSelectionLayoutBaseHelper }

  TdxRectangularObjectSelectionLayoutBaseHelper = class helper for
    TdxRectangularObjectSelectionLayoutBase
  private
...
function TdxSelectionLayoutItemList.GetItem(Index: Integer)
  : IdxSelectionLayoutItem;
begin
  Result := inherited Items[Index] as IdxSelectionLayoutItem;
end;

procedure TdxSelectionLayoutItemList.AddRange
  (ARange: TdxSelectionLayoutItemList);
var
  I: Integer;
begin
...
function TdxTableStructureBySelectionCalculator.CalculateSelectedCells
  (AResult: TdxSelectedCellsCollection; ARow: TdxTableRow;
  ALeftColumnIndex: Integer; ARightColumnIndex: Integer;
  AIsLeftToRight: Boolean): Boolean;
var
...
function TdxTableStructureBySelectionCalculator.Calculate
...
function TdxTableStructureBySelectionCalculator.Calculate
  (AStartCell: TdxTableCell; AEndCell: TdxTableCell; AIsColumnSelected: Boolean)
  : TdxSelectedCellsCollection;
var
  ATable: TdxTable;
begin
...
function TdxTableStructureBySelectionCalculator.CalculateCore
  (AStartCell: TdxTableCell; AEndCell: TdxTableCell; ATable: TdxTable;
  AIsColumnSelected: Boolean): TdxSelectedCellsCollection;
var
  AStartCellColumnIndex, AEndCellColumnIndex, AStartCellRowIndex,
    AEndCellRowIndex, ANormalizedLeft, ANormalizedRight, ARightColumnIndex,
    I: Integer;
...
begin
  ...
  begin
    ...
    for I := AStartCellRowIndex to AEndCellRowIndex do
      if not CalculateSelectedCells(Result, ATable.Rows[I], ANormalizedLeft,
        ARightColumnIndex, AIsLeftToRightDirection) then
        Break;
  end
  else
  begin
...
constructor TdxStartSelectedCellInTable.Create
  (AOld: TdxSelectedTableStructureBase);
begin
...
procedure TdxRowSelectionLayoutBase.Draw(const ASelectionPainter
  : IdxSelectionPainter);
begin
...
constructor TdxRectangularObjectSelectionLayoutBase.Create(AView: TObject;
  ABox: TdxBox; AStart: TdxDocumentLogPosition; APieceTable: TdxPieceTable);
begin
  inherited Create;
  Assert(AView <> nil);
...
class function TdxRectangularObjectSelectionLayout.CreateResizableLayout
  (AView: TObject; ABox: TdxBox; AStart: TdxDocumentLogPosition;
  APieceTable: TdxPieceTable): TdxRectangularObjectSelectionLayout;
begin
  Result := TdxResizableRectangularObjectSelectionLayout.Create(AView, ABox,
    AStart, APieceTable);
end;

procedure TdxRectangularObjectSelectionLayout.Draw(const ASelectionPainter
  : IdxSelectionPainter);
begin
  ASelectionPainter.Draw(Self);
  if FAnchor <> nil then
...
function TdxRectangularObjectSelectionLayout.HitTest(ALogPosition
...
constructor TdxResizableRectangularObjectSelectionLayout.Create
  (AView: TObject { TdxRichEditView }; ABox: TdxBox;
  AStart: TdxDocumentLogPosition; APieceTable: TdxPieceTable);
begin
  inherited Create(AView, ABox, AStart, APieceTable);
  FHotZoneSize := AlignSizeToPixel(UnitConverter.DocumentsToLayoutUnits
    (DefaultHotZoneSizeDocuments));
end;
...
begin
  ...
  Supports(View.Control.InnerControl, IdxGestureStateIndicator,
    AGestureIndicator);

  if Box is TdxFloatingObjectBox then
  begin
    ARotationHotZone := TdxRectangularObjectRotationHotZone.Create(Box,
      PieceTable, AGestureIndicator);
    ARotationHotZone.LineEnd :=
      TPoint.Create(APictureBounds.Left + APictureBounds.Width div 2,
      APictureBounds.Top);
    AddHotZone(ARotationHotZone, RectangleFromCenter(APictureBounds.Left +
      APictureBounds.Width div 2, APictureBounds.Top - 2 * ALargeHotZoneSize,
      ALargeHotZoneSize));
  end;

  AddHotZone(TdxRectangularObjectTopLeftHotZone.Create(Box, PieceTable,
    AGestureIndicator), RectangleFromCenter(APictureBounds.Left,
    APictureBounds.Top, ALargeHotZoneSize));
  AddHotZone(TdxRectangularObjectTopRightHotZone.Create(Box, PieceTable,
    AGestureIndicator), RectangleFromCenter(APictureBounds.Right - 1,
    APictureBounds.Top, ALargeHotZoneSize));
  AddHotZone(TdxRectangularObjectBottomLeftHotZone.Create(Box, PieceTable,
    AGestureIndicator), RectangleFromCenter(APictureBounds.Left,
    APictureBounds.Bottom - 1, ALargeHotZoneSize));
  AddHotZone(TdxRectangularObjectBottomRightHotZone.Create(Box, PieceTable,
    AGestureIndicator), RectangleFromCenter(APictureBounds.Right - 1,
    APictureBounds.Bottom - 1, ALargeHotZoneSize));
  AddHotZone(TdxRectangularObjectTopMiddleHotZone.Create(Box, PieceTable,
    AGestureIndicator), RectangleFromCenter(APictureBounds.Left +
    APictureBounds.Width div 2, APictureBounds.Top, ALargeHotZoneSize));
  AddHotZone(TdxRectangularObjectBottomMiddleHotZone.Create(Box, PieceTable,
    AGestureIndicator), RectangleFromCenter(APictureBounds.Left +
    APictureBounds.Width div 2, APictureBounds.Bottom - 1, ALargeHotZoneSize));
  AddHotZone(TdxRectangularObjectMiddleLeftHotZone.Create(Box, PieceTable,
    AGestureIndicator), RectangleFromCenter(APictureBounds.Left,
    APictureBounds.Top + APictureBounds.Height div 2, ALargeHotZoneSize));
  AddHotZone(TdxRectangularObjectMiddleRightHotZone.Create(Box, PieceTable,
    AGestureIndicator), RectangleFromCenter(APictureBounds.Right - 1,
    APictureBounds.Top + APictureBounds.Height div 2, ALargeHotZoneSize));
  Result := True;
end;

procedure TdxResizableRectangularObjectSelectionLayout.AddHotZone
  (AHotZone: TdxHotZone; const ABounds: TRect);
var
...
function TdxResizableRectangularObjectSelectionLayout.
  TryCreateAnchorSelectionItem: TdxFloatingObjectAnchorSelectionLayout;
var
...
begin
  ...
  ALayoutPosition := TdxDocumentLayoutPosition
    (View.DocumentLayout.CreateLayoutPosition(AAnchorPieceTable, LogStart, 0));
  try
    if not ALayoutPosition.Update(View.DocumentLayout.Pages,
    ...
    Result := TdxFloatingObjectAnchorSelectionLayout.Create(View, Box, LogStart,
      AAnchorPieceTable);
...
function TdxResizableRectangularObjectSelectionLayout.CalculateExtendedBounds
  (const R: TRect): TRect;
begin
  Result.InitSize(R.X - DeltaRadiusForExtendedHotZone,
    R.Y - DeltaRadiusForExtendedHotZone,
    R.Width + 2 * DeltaRadiusForExtendedHotZone,
    R.Height + 2 * DeltaRadiusForExtendedHotZone);
end;

function TdxResizableRectangularObjectSelectionLayout.RectangleFromCenter
  (X: Integer; Y: Integer; ALargeHotZoneSize: Integer): TRect;
var
  AHalfLargeHotZoneSize: Integer;
begin
  AHalfLargeHotZoneSize := ALargeHotZoneSize div 2;
  Result.InitSize(X - AHalfLargeHotZoneSize, Y - AHalfLargeHotZoneSize,
    ALargeHotZoneSize, ALargeHotZoneSize);
end;

function TdxResizableRectangularObjectSelectionLayout.AlignSizeToPixel
  (ALayoutSize: Integer): Integer;
begin
  Result := UnitConverter.LayoutUnitsToPixels(ALayoutSize,
    TdxDocumentModel.Dpi);
...
procedure TdxFloatingObjectAnchorSelectionLayout.Draw(const ASelectionPainter
  : IdxSelectionPainter);
begin
  ASelectionPainter.Draw(Self);
end;

function TdxFloatingObjectAnchorSelectionLayout.HitTest
  (ALogPosition: TdxDocumentLogPosition; const ALogicalPoint: TPoint): Boolean;
begin
...
constructor TdxSelectedCellsCollection.Create
  (AOld: TdxStartSelectedCellInTable);
begin
  Create(AOld.FirstSelectedCell, AOld.OriginalStartLogPosition);
end;

constructor TdxSelectedCellsCollection.Create(AFirstSelectedCell: TdxTableCell;
  AOriginalStartLogPosition: TdxDocumentLogPosition);
begin
  inherited Create(AOriginalStartLogPosition);
  FInnerList := TdxSelectedCellsIntervalInRowList.Create;
...
function TdxSelectedCellsCollection.GetNormalizedFirst
...
function TdxSelectedCellsCollection.GetNormalizedLast
  : TdxSelectedCellsIntervalInRow;
begin
...
function TdxSelectedCellsCollection.GetItem(Index: Integer)
  : TdxSelectedCellsIntervalInRow;
begin
...
begin
  if not IsNotEmpty then
    Exit(False);
  AStartColumnIndexInFirstInterval :=
    TopLeftCell.GetStartColumnIndexConsiderRowGrid;
  AEndColumnIndexInFirstInterval := NormalizedFirst.NormalizedEndCell.
  ...
  begin
    ...
    AStartColumnIndex := ACurrentInterval.NormalizedStartCell.
      GetStartColumnIndexConsiderRowGrid;
    AEndColumnIndex := ACurrentInterval.NormalizedEndCell.
      GetEndColumnIndexConsiderRowGrid;
    if (AStartColumnIndexInFirstInterval <> AStartColumnIndex) or
      (AEndColumnIndexInFirstInterval <> AEndColumnIndex) then
      Exit(False);
  end;
  ASelectedRowsCountInFirstColumn :=
    GetSelectedRowsCount(AStartColumnIndexInFirstInterval);
  for I := AStartColumnIndexInFirstInterval +
    1 to AEndColumnIndexInFirstInterval do
  begin
...
function TdxSelectedCellsCollection.GetSelectedColumnsCountInRow
  (ASelectionInterval: TdxSelectedCellsIntervalInRow): Integer;
var
  ACellId: Integer;
...
begin
  ...
  for ACellId := ASelectionInterval.NormalizedStartCellIndex to
    ASelectionInterval.NormalizedEndCellIndex do
    Inc(Result, ACells[ACellId].ColumnSpan);
end;

function TdxSelectedCellsCollection.GetSelectedRowsCount
...
begin
  ...
  begin
    ACurrentCell := TdxTableCellVerticalBorderCalculator.GetCellByColumnIndex
      (Self[I].Row, AColumnIndex);
...
function TdxSelectedCellsCollection.GetSelectedRowsCountCore
...
function TdxSelectedCellsCollection.GetMergedCellsCount
  (ACurrentCell: TdxTableCell): Integer;
var
  AStartColumnIndex: Integer;
  ACells: TdxTableCellList;
begin
  AStartColumnIndex := TdxTableCellVerticalBorderCalculator.GetStartColumnIndex
    (ACurrentCell, False);
  ACells := TdxTableCellVerticalBorderCalculator.GetVerticalSpanCells
    (ACurrentCell, AStartColumnIndex, False);
  try
    Result := ACells.Count;
  finally
    ACells.Free;
...
procedure TdxSelectedCellsCollection.AddSelectedCells(ARow: TdxTableRow;
  AStart: Integer; AEnd: Integer);
begin
...
procedure TdxSelectedCellsCollection.Remove
  (AItem: TdxSelectedCellsIntervalInRow);
begin
  FInnerList.Remove(AItem);
end;

procedure TdxSelectedCellsCollection.SetFirstSelectedCell
  (AStartCell: TdxTableCell; APos: TdxDocumentLogPosition);
var
  AStartCellIndex: Integer;
begin
  AStartCellIndex := AStartCell.IndexInRow;
  Add(TdxSelectedCellsIntervalInRow.Create(AStartCell.Row, AStartCellIndex,
    AStartCellIndex));
  OriginalStartLogPosition := APos;
end;
...
begin
  Result := (RowsCount > 0) and
    (NormalizedFirst.NormalizedStartCell.IsFirstCellInTable) and
    (NormalizedLast.NormalizedEndCell.IsLastCellInTable);
end;
...
begin
  ...
  begin
    ...
    if (not ACurrentInterval.NormalizedStartCell.IsFirstCellInRow) or
      (not ACurrentInterval.NormalizedEndCell.IsLastCellInRow) then
    begin
      Result := False;
      Break;
    end;
...
function TdxSelectedCellsCollection.IsWholeCellSelected
...
begin
  ...
  begin
    ...
    ACellContentLength := AEndParagraph.EndLogPosition -
      AStartParagraph.LogPosition + 1;
    Exit((ASelection.NormalizedStart = AStartParagraph.LogPosition) and
      (ASelection.Length = ACellContentLength));
  end;
  ARow := ACell.Row;
  ACount := RowsCount;
