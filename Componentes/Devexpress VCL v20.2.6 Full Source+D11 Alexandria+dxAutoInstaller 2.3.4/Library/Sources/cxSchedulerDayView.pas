...
{$ENDIF}
  ...
  Controls, ExtCtrls, RTLConsts,
  Generics.Collections, Generics.Defaults,
  cxClasses, dxCore, cxControls, cxGraphics, dxCoreGraphics, cxStyles,
  cxGeometry, Menus,
...
type
  ...
  protected
    ...
    procedure GetDefaultHeaderContainerViewParams
      (var AParams: TcxViewParams); virtual;
    procedure GetDefaultSelectedHeaderContainerViewParams
      (var AParams: TcxViewParams);
    procedure GetDefaultTimeRulerViewParams(var AParams
  ...
  public
    ...
    function GetHeaderContainerParams(const ADate: TDateTime;
      AResource: TcxSchedulerStorageResourceItem; ASelected: Boolean)
      : TcxViewParams;
    function GetTimeRulerParams: TcxViewParams;
  ...
  published
    property HeaderContainer: TcxStyle index cxcsHeaderContainer read GetValue
      write SetValue;
    property SelectedHeaderContainer: TcxStyle index cxcsSelectedHeaderContainer
      read GetValue write SetValue;
    property TimeLine: TcxStyle index cxcsTimeLine read GetValue write SetValue;
    property TimeRuler: TcxStyle index cxcsTimeRuler read GetValue
      write SetValue;
  end;
  ...
  TcxSchedulerDayView = class(TcxSchedulerCustomResourceView,
    IcxSchedulerViewTimeScaleStep, IdxTouchScrollUIOwner,
    IdxHybridScrollbarOwner)
  private
    FAllDayAreaScrollBar: TcxSchedulerAllDayAreaScrollBar;
    FAllDayContainerGestureScrollHelper
    ...
    FDayHeaderModernStyleDisplayMode
    ...
    procedure DoAllDayScroll(Sender: TObject; ScrollCode: TScrollCode;
    ...
    procedure SetDayHeaderModernStyleDisplayMode
      (AValue: TcxSchedulerDayHeaderModernStyleDisplayMode);
  ...
  protected
    ...
    procedure DoCustomDrawTimeRuler(ACell: TcxSchedulerTimeRulerCellViewInfo;
      var ADone: Boolean); virtual;
  ...
  published
    ...
    property AllDayAreaScrollBar: TcxSchedulerAllDayAreaScrollBar
      read FAllDayAreaScrollBar write SetAllDayAreaScrollBar
      default adsbDefault;
    property AlwaysShowEventTime: Boolean read FAlwaysShowEventTime
      write SetAlwaysShowEventTime default False;
    property AutoContentHeight: Boolean read FAutoContentHeight
      write SetAutoContentHeight default False;
    property DayHeaderArea: Boolean read FDayHeaderArea write SetDayHeaderArea
      default True;
    property DayHeaderModernStyleDisplayMode
      : TcxSchedulerDayHeaderModernStyleDisplayMode
      read FDayHeaderModernStyleDisplayMode
      write SetDayHeaderModernStyleDisplayMode default hdmDefault;

    property EventImagesLayout default eilAuto;
    property EventShadows: Boolean read FEventShadows write SetEventShadows
      default True;
    property GroupingKind;
    property HeaderContainer: Boolean read FHeaderContainer
      write SetHeaderContainer default True;
    property ShowAllDayEventsInContentArea: Boolean
      read FShowAllDayEventsInContentArea write SetShowAllDayEventsInContentArea
      default False;
    property Styles: TcxSchedulerDayViewStyles read FStyles write SetStyles;
    property TimeRulerMinutes: Boolean read FTimeRulerMinutes
      write SetTimeRulerMinutes default False;
    property TimeRulerPopupMenu: TcxSchedulerTimeRulerPopupMenu
      read FTimeRulerPopupMenu write SetTimeRulerPopupMenu;
    property TimeScale: Integer read FTimeScale write SetTimeScale
      default cxDefaultTimeScale;
    property WorkTimeOnly: Boolean read FWorkTimeOnly write SetWorkTimeOnly
      default False;
    property OnCustomDrawContainer: TcxSchedulerCustomDrawContainerEvent
      read FOnCustomDrawContainer write FOnCustomDrawContainer;
    property OnCustomDrawTimeRuler: TcxSchedulerCustomDrawTimeRulerEvent
      read FOnCustomDrawTimeRuler write FOnCustomDrawTimeRuler;
  end;

  TcxSchedulerAllDayContainerGestureScrollHelper = class(TcxIUnknownObject,
    IdxGestureClient)
  private
  ...
  TcxSchedulerDayViewContentCellCustomViewInfo = class
  ...
  TcxSchedulerDayViewContentCellViewInfo = class
    (TcxSchedulerDayViewContentCellCustomViewInfo)
  protected
  ...
  TcxSchedulerDayViewContentCellModernViewInfo = class
    (TcxSchedulerDayViewContentCellCustomViewInfo)
  private
  ...
  protected
    ...
    function GetViewStyle: TcxSchedulerViewStyle; override;
    procedure SetBorderColor(const AResourceColor: Integer;
      AIsHourSeparator, AIsWorkTime: Boolean); override;
  public
    ...
    property LeftBorderColor: TColor read FLeftBorderColor
      write FLeftBorderColor;
  end;

  { TcxSchedulerDayViewEventCellCustomViewInfo }

  TcxSchedulerDayViewEventCellCustomViewInfo = class
  ...
  TcxSchedulerDayViewEventCellViewInfo = class
    (TcxSchedulerDayViewEventCellCustomViewInfo)
  protected
  ...
  TcxSchedulerDayViewEventCellModernViewInfo = class
    (TcxSchedulerDayViewEventCellCustomViewInfo)
  strict private
  ...
  protected
    ...
    function GetHeaderEventCaptionLeft(const ARect: TRect;
      AContentWidth: Integer): Integer; override;
    function GetHeaderImagesPossibleRect(const ACaptionRect: TRect;
      ATextWidth: Integer): TRect; override;
  ...
  protected
    ...
    procedure AddHeaderContainerEventPlace(AEvent: TcxSchedulerControlEvent;
      var AColIndex: Integer);
    procedure AddMoreEventsButton(AColumnIndex: Integer;
      const AContainerBounds: TRect; const ARowIndex: Integer; AIsTop: Boolean;
    ...
    procedure CalculateEventsForColumn(AIndex: Integer;
      ...
      AEvents: TcxSchedulerEventList); virtual;
    ...
    procedure CheckEventRowsVisibility(AColumnIndex: Integer;
      const AContainerBounds: TRect; AEvent: TcxSchedulerControlEvent;
    ...
    function CreateHeaderEventViewData(AEvent: TcxSchedulerControlEvent;
    ...
    function GetActualDayHeaderModernStyleDisplayMode
      : TcxSchedulerDayHeaderModernStyleDisplayMode; virtual;
    function GetCalculateEventLayoutClass: TcxCalculateEventLayoutClass;
    function GetContentParams(const ATime: TDateTime;
      AResource: TcxSchedulerResourceViewInfo; var AIsSelected: Boolean)
      : TcxViewParams; reintroduce; virtual;
    function GetColumnDate(AIndex: Integer): Integer;
    function GetColumnPositionInResource(AColumnIndex, AResourceIndex: Integer)
      : TcxSchedulerColumnPositionInResource;
    ...
    function GetContainer(AIndex: Integer)
      : TcxSchedulerContainerCellViewInfo; virtual;
    ...
    function GetEventColumnRow(const ATime: TDateTime; AColIndex: Integer;
      AStart: Boolean): Integer;
    ...
    function HeaderContainerCellClass
      : TcxSchedulerContainerCellViewInfoClass; virtual;
    function IsColumnEvent(AEvent: TcxSchedulerEvent; AIndex: Integer)
      : Boolean; overload;
    function IsColumnEvent(AEvent: TcxSchedulerEvent; AIndex: Integer;
      IsHeaderEvent: Boolean): Boolean; overload;
    function IsContainerSelected(AResource: TcxSchedulerStorageResourceItem;
      ADate: TDateTime): Boolean;
    function IsEventVisible(AEvent: TcxSchedulerEvent): Boolean; overload;
    function IsEventVisible(var AStartRow, AStopRow: Integer): Boolean;
      overload;
    ...
    procedure SetColumnTimeLineStyle(AEventInfo: TcxSchedulerEventCellViewInfo;
      AColIndex: Integer);
    procedure SetContainerCellHeaderEvent(AEventInfo
      : TcxSchedulerEventCellViewInfo);
    ...
    property Containers[AIndex: Integer]: TcxSchedulerContainerCellViewInfo
      read GetContainer;
  ...
  public
    property ContainerCell: TcxSchedulerContainerCellViewInfo
      read GetContainerCell;
    ...
    property TimeRulerCell: TcxSchedulerTimeRulerCellViewInfo
      read GetTimeRulerCell;
  ...
  protected
    ...
    procedure SetCloneEventsTimeDelta(AStart, ACurrent: TDateTime;
      AInHeader: Boolean);
  ...
  protected
    ...
    function GetColumnByDate(const ADate: TDateTime;
      AResource: TObject): Integer;
    function GetColumnDate(AColumn: Integer): TDateTime;
    function GetColumnResource(AColumn: Integer)
      : TcxSchedulerStorageResourceItem;
    function GetRowTime(const ARow: Integer; AFinish: Boolean = False)
      : TDateTime;
    function GetTimeRow(const ATime: TDateTime): Integer;
    function IsResourceNavigation(AGoToNext: Boolean; AColumn: Integer;
      const ATime: TDateTime): Boolean;
  public
  ...
  private
    ...
    function GetViewInfo: TcxSchedulerDayViewViewInfo;
  protected
    procedure DrawContainerCell(AItem: TcxSchedulerCustomViewInfoItem;
      var ADone: Boolean); virtual;
    procedure DrawDayViewEventCell(AItem: TcxSchedulerCustomViewInfoItem;
      var ADone: Boolean); virtual;
    procedure DrawTimeRulerCell(AItem: TcxSchedulerCustomViewInfoItem;
      var ADone: Boolean); virtual;
  public
  ...
  protected
    ...
    procedure CalculateDisplayRect(AFullColWidth, ARowHeight: Integer;
      AScaleFactor: TdxScaleFactor); virtual;
    procedure CalculateTimes(const ADate: TDateTime; AScale, AOffset: Integer);
  public
    constructor Create(AEvent: TcxSchedulerControlEvent; const ADate: TDateTime;
      AScale: Integer); virtual;
  ...
  protected
    ...
    property IntersectedInfo[AIndex: Integer]: TcxEventModernLayoutInfo
      read GetIntersectedInfo;
  ...
  protected
    ...
    procedure CalculateColStart(AInfo: TcxEventLayoutInfo;
      AIndex: Integer); virtual;
    procedure CalculateColStartAndColCount(AInfo: TcxEventLayoutInfo;
      AIndex: Integer); virtual;
    procedure CalculateInfoRowsAndTimes(AInfo: TcxEventLayoutInfo);
    function CreateEventInfo(AEvent: TcxSchedulerControlEvent)
      : TcxEventLayoutInfo;
    ...
    procedure PrepareInfoBeforeCalculateColStartAndColCount
      (AInfo: TcxEventLayoutInfo); virtual;
    procedure PrepareInfoBeforeCalculateDisplayRect
      (AInfo: TcxEventLayoutInfo); virtual;
  ...
  protected
    ...
    procedure PrepareInfoBeforeCalculateColStartAndColCount
      (AInfo: TcxEventLayoutInfo); override;
    procedure PrepareInfoBeforeCalculateDisplayRect
      (AInfo: TcxEventLayoutInfo); override;
  ...
  TcxSchedulerTimeRulerPopupMenuItem = (rpmiNewEvent, rpmiNewAllDayEvent,
    rpmiNewReccuringEvent, rpmi60min, rpmi30min, rpmi15min, rpmi10min, rpmi6min,
    rpmi5min);
  TcxSchedulerTimeRulerPopupMenuItems = set of
  ...
  published
    property Items: TcxSchedulerTimeRulerPopupMenuItems read FItems write FItems
      default [rpmiNewEvent, rpmiNewAllDayEvent, rpmiNewReccuringEvent,
      rpmi60min, rpmi30min, rpmi15min, rpmi10min, rpmi6min, rpmi5min];
    property PopupMenu;
    property UseBuiltInPopupMenu;

    property OnClick: TcxSchedulerTimeRulerPopupMenuClickEvent read FOnClick
      write FOnClick;
    property OnPopup: TcxSchedulerTimeRulerPopupMenuPopupEvent read FOnPopup
      write FOnPopup;
  end;
...
type
  ...
  TcxSchedulerContentCellViewInfoAccess = class
    (TcxSchedulerContentCellViewInfo);
  TcxSchedulerCustomDateNavigatorAccess = class
    (TcxSchedulerCustomDateNavigator);
  TcxSchedulerContainerCellViewInfoAccess = class
...
constructor TcxSchedulerDayViewEventCellContainerInfo.Create(AContainerIndex
  : Integer; AInfo: TcxEventLayoutInfo);
begin
...
procedure TcxSchedulerDayViewStyles.GetDefaultHeaderContainerViewParams
  (var AParams: TcxViewParams);
begin
  ...
  begin
    AParams.Color :=
      Painter.DefaultSchedulerHeaderContainerBackgroundColor(False);
    AParams.TextColor :=
      Painter.DefaultSchedulerHeaderContainerTextColor(False);
  end
end;

procedure TcxSchedulerDayViewStyles.GetDefaultSelectedHeaderContainerViewParams
  (var AParams: TcxViewParams);
begin
  if SchedulerViewStyle = svsClassic then
  begin
  ...
  begin
    AParams.Color :=
      Painter.DefaultSchedulerHeaderContainerBackgroundColor(True);
    AParams.TextColor := Painter.DefaultSchedulerHeaderContainerTextColor(True);
  end
end;

procedure TcxSchedulerDayViewStyles.GetDefaultTimeRulerViewParams
  (var AParams: TcxViewParams);
begin
  if SchedulerViewStyle = svsClassic then
  begin
...
begin
  ...
  if ATime1 < ATime2 then
    Result := -1
  else if ATime1 > ATime2 then
    Result := 1;
end;

function cxCompareButtons(AItem1,
  AItem2: TcxSchedulerMoreEventsButtonViewInfo): Integer;
begin
...
function cxCompareEventViewInfoOrders(AInfo1,
  AInfo2: TcxSchedulerEventCellViewInfo): Integer;
var
...
begin
  ...
  if (StopRow <> StartRow) and (ADate = dxDateOf(Event.Finish)) and
    (AFinish mod AScale = 0) then
    Dec(StopRow);
  ...
  IsBreakEvent := (StopRow = cxMinutesPerDay div AScale - 1) and
    (ADate = dxDateOf(Event.Finish));
end;
...
procedure TcxEventLayoutInfo.CalculateDisplayRect(AFullColWidth,
  ARowHeight: Integer; AScaleFactor: TdxScaleFactor);
begin
  FDisplayRect := Rect(MulDiv(AFullColWidth, ColStart, ColCount),
    StartRow * ARowHeight, MulDiv(AFullColWidth, ColEnd, ColCount) -
    ShadowSize(AScaleFactor), (StopRow + 1) * ARowHeight + Byte(IsBreakEvent));
end;

procedure TcxEventLayoutInfo.CalculateTimes(const ADate: TDateTime;
  AScale, AOffset: Integer);
begin
...
constructor TcxEventModernLayoutInfo.Create(AEvent: TcxSchedulerControlEvent;
  const ADate: TDateTime; AScale: Integer);
begin
...
procedure TcxEventModernLayoutInfo.AddIntersectedInfo
  (AInfo: TcxEventModernLayoutInfo);
begin
  FIntersectedInfos.Add(AInfo);
  AInfo.FIntersectedInfos.Add(Self);
end;

procedure TcxEventModernLayoutInfo.CalculateDisplayRect(AFullColWidth,
  ARowHeight: Integer; AScaleFactor: TdxScaleFactor);

  function GetRectLeft(const AInternalColStart, AInternalColWidth
    : Integer): Integer;
  begin
...
begin
  ...
  if (StartRow = StopRow) and (Abs(Finish - Int(Event.Start + 1)) <= 1 / 24 / 60
    / 60) then
  begin
...
begin
  Result := Round(dxTimeOf(Max(Event.Finish, Min(dxDateOf(Event.Start + 1),
    Event.Start + AScale / cxMinutesPerDay))) / MinuteToTime);
  Result := IfThen(Result = 0, cxMinutesPerDay, Result);
end;

function TcxEventModernLayoutInfo.GetIntersectedInfo(AIndex: Integer)
  : TcxEventModernLayoutInfo;
begin
  Result := nil;
...
begin
  ...
  begin
    ...
    AInfo.FDisplayRect.Right := Max(AInfo.FDisplayRect.Right,
      AInfo.FDisplayRect.Left + ScaleFactor.Apply(cxTimeLineWidth +
      cxTextOffset));
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if AInfo.ColEnd = AInfo.ColStart + 1 then
        Break;
    end;
  end;
end;

procedure TcxCalculateEventLayout.CalculateColStart(AInfo: TcxEventLayoutInfo;
  AIndex: Integer);
var
  I: Integer;
begin
  repeat
    ...
    for I := AIndex - 1 downto 0 do
      if (Infos[I].ColStart = AInfo.ColStart) and Intersect(Infos[I], AInfo)
      then
      begin
        Inc(AInfo.ColStart);
        Break;
      end;
  until (AInfo.ColStart = AInfo.ColEnd) or
    (AInfo.ColStart = (AInfo.ColCount - 1));
end;

procedure TcxCalculateEventLayout.CalculateColStartAndColCount
...
procedure TcxCalculateEventLayout.CalculateInfoRowsAndTimes
  (AInfo: TcxEventLayoutInfo);
begin
  AInfo.StartRow := Max(0, AInfo.StartRow - FViewInfo.PrintStartRow);
  AInfo.StopRow := Min(FViewInfo.FRowCount,
    AInfo.StopRow - FViewInfo.PrintStartRow);
...
begin
  ...
  with FViewInfo do
    if HasVisibleBounds and not IsEventVisible(Result.StartRow, Result.StopRow)
    then
      FreeAndNil(Result);
end;
...
function TcxCalculateEventLayout.Intersect(AInfo1,
  AInfo2: TcxEventLayoutInfo): Boolean;
begin
...
begin
  OffsetRect(AInfo.FDisplayRect, Left,
    Top - Byte(FViewInfo.Adapter.IsPrinting));
end;

procedure TcxCalculateEventLayout.PrepareInfoBeforeCalculateColStartAndColCount
  (AInfo: TcxEventLayoutInfo);
begin
  //
end;

procedure TcxCalculateEventLayout.PrepareInfoBeforeCalculateDisplayRect
  (AInfo: TcxEventLayoutInfo);
begin
  CalculateInfoRowsAndTimes(AInfo);
end;

procedure TcxCalculateEventLayout.SetColCount(AInfo: TcxEventLayoutInfo);
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
...
function TcxCalculateEventLayout.GetInfo(AIndex: Integer): TcxEventLayoutInfo;
begin
...
procedure TcxCalculateModernEventLayout.CalculateColEnd
  (AInfo: TcxEventLayoutInfo);
var
  I, ACount: Integer;
  AEventInfo: TcxEventLayoutInfo;
...
procedure TcxCalculateModernEventLayout.CalculateColStartAndColCount
  (AInfo: TcxEventLayoutInfo; AIndex: Integer);
...
begin
  ...
  begin
    ...
    begin
      ...
      (AInfo as TcxEventModernLayoutInfo).AddIntersectedInfo
        (AEventInfo as TcxEventModernLayoutInfo);
    end;
  end;
end;

function TcxCalculateModernEventLayout.GetLayoutInfoClass
  : TcxEventLayoutInfoClass;
begin
  Result := TcxEventModernLayoutInfo;
end;

function TcxCalculateModernEventLayout.Intersect(AInfo1,
  AInfo2: TcxEventLayoutInfo): Boolean;
begin
  AInfo1.CalculateDisplayRect(FWidth, FRowHeight, ScaleFactor);
  AInfo2.CalculateDisplayRect(FWidth, FRowHeight, ScaleFactor);
  Result := Min(AInfo1.DisplayRect.Bottom, AInfo2.DisplayRect.Bottom) >=
    Max(AInfo1.DisplayRect.Top, AInfo2.DisplayRect.Top);
end;

procedure TcxCalculateModernEventLayout.OffsetDisplayRect
  (AInfo: TcxEventLayoutInfo);
begin
  OffsetRect(AInfo.FDisplayRect, Left,
    Top - Byte(FViewInfo.Adapter.IsPrinting) - 1);
end;

procedure TcxCalculateModernEventLayout.
  PrepareInfoBeforeCalculateColStartAndColCount(AInfo: TcxEventLayoutInfo);
begin
  CalculateInfoRowsAndTimes(AInfo);
end;

procedure TcxCalculateModernEventLayout.PrepareInfoBeforeCalculateDisplayRect
  (AInfo: TcxEventLayoutInfo);
begin
  //
end;
...
begin
  ...
  FAllDayContainerGestureScrollHelper :=
    TcxSchedulerAllDayContainerGestureScrollHelper.Create(Self);
end;
...
function TcxSchedulerDayView.CreateTimeRulerPopupMenu
  : TcxSchedulerTimeRulerPopupMenu;
begin
...
function TcxSchedulerDayView.GetGestureClient(const APoint: TPoint)
  : IdxGestureClient;
begin
...
begin
  Result := GetFirstVisibleTime + (ViewInfo.VisibleRowCount - 1) * TimeScale
    / 24 / 60;
end;
...
begin
  if Visible and AEvent.IsAllDayOrLonger then
    Exit;
  for I := 0 to 1 do
  begin
    if FindEventViewInfo(AEvent, ADate, AResource, AViewInfo) and not AViewInfo.Hidden
    then
    begin
...
function TcxSchedulerDayView.NeedPanningFeedback(AScrollKind
...
function TcxSchedulerDayView.GetTouchScrollUIOwner(const APoint: TPoint)
  : IdxTouchScrollUIOwner;
begin
  if cxRectPtIn(ViewInfo.FAllDayAreaBounds, APoint) then
    Result := Self
...
procedure TcxSchedulerDayView.SetAllDayAreaScrollBar
  (AValue: TcxSchedulerAllDayAreaScrollBar);
begin
...
procedure TcxSchedulerDayView.SetDayHeaderArea(AValue: Boolean);
begin
...
procedure TcxSchedulerDayView.SetDayHeaderModernStyleDisplayMode
  (AValue: TcxSchedulerDayHeaderModernStyleDisplayMode);
begin
...
function TcxSchedulerAllDayContainerGestureScrollHelper.AllowGesture
  (AGestureId: Integer): Boolean;
begin
  Result := AGestureId = GID_PAN;
end;

function TcxSchedulerAllDayContainerGestureScrollHelper.AllowPan
  (AScrollKind: TScrollBarKind): Boolean;
begin
  Result := AScrollKind = sbVertical;
end;

procedure TcxSchedulerAllDayContainerGestureScrollHelper.BeginGestureScroll
  (APos: TPoint);
begin
...
procedure TcxSchedulerAllDayContainerGestureScrollHelper.GestureScroll(ADeltaX,
  ADeltaY: Integer);
var
  ANewPos: Integer;
begin
  ANewPos := FView.AllDayScrollBar.Position - ADeltaY div 10;
  TcxCustomSchedulerAccess(FView.Scheduler).GestureHelper.CheckOverpan
    (FView.AllDayScrollBar.Kind, ANewPos, 0, FView.AllDayScrollBar.Max,
    ADeltaX, ADeltaY);
...
function TcxSchedulerAllDayContainerGestureScrollHelper.IsPanArea
  (const APoint: TPoint): Boolean;
begin
  Result := True;
end;

function TcxSchedulerAllDayContainerGestureScrollHelper.NeedPanningFeedback
  (AScrollKind: TScrollBarKind): Boolean;
begin
  Result := AScrollKind = sbVertical;
end;
...
procedure TcxSchedulerDayViewContentCellCustomViewInfo.SetBorderColor
  (const AResourceColor: Integer; AIsHourSeparator, AIsWorkTime: Boolean);
begin
  FIsHourSeparator := AIsHourSeparator;
  FBorderColor := PainterHelper.GetSeparatorColor(AResourceColor,
    AIsHourSeparator, AIsWorkTime, GetViewStyle);
end;

{ TcxSchedulerDayViewContentCellViewInfo }

function TcxSchedulerDayViewContentCellViewInfo.GetViewStyle
...
constructor TcxSchedulerDayViewContentCellModernViewInfo.Create
...
begin
  ...
  begin
    ABorderColor1 := ExternalPainter.GetColorizedColor(ABorderColor1,
      TimeEvent);
    ...
    if TimeEvent.Event.State = 1 then
      cxFillRectWithCustomBrush(Canvas.Canvas, StateBrushes[9], Bounds,
  ...
  begin
    SpecialDrawRect(Bounds, Borders - ALeftBorderRTL[UseRightToLeftAlignment],
      AContentColor, ABorderColor1);
    Canvas.FrameRect(Bounds, LeftBorderColor, 1,
      ALeftBorderRTL[UseRightToLeftAlignment]);
  end
  else
  begin
    SpecialDrawRect(Bounds, Borders - [bBottom], AContentColor,
      LeftBorderColor);
...
function TcxSchedulerDayViewContentCellModernViewInfo.GetViewStyle
  : TcxSchedulerViewStyle;
begin
  Result := svsModern;
end;

procedure TcxSchedulerDayViewContentCellModernViewInfo.SetBorderColor
  (const AResourceColor: Integer; AIsHourSeparator, AIsWorkTime: Boolean);
begin
  inherited SetBorderColor(AResourceColor, AIsHourSeparator, AIsWorkTime);
  if not AIsHourSeparator then
    FLeftBorderColor := PainterHelper.GetSeparatorColor(AResourceColor, False,
      AIsWorkTime, GetViewStyle)
  else
    FLeftBorderColor := BorderColor;
end;
...
procedure TcxSchedulerDayViewEventCellCustomViewInfo.
...
begin
  ViewData.ShowTimeAsClock := IsHorzSizing or
    (ViewData.ShowTimeAsClock and not IsDetailInfo);
end;

function TcxSchedulerDayViewEventCellCustomViewInfo.
  GetDetailCaptionFlagValue: Boolean;
begin
  Result := inherited GetDetailCaptionFlagValue or
...
procedure TcxSchedulerDayViewEventCellCustomViewInfo.InitHitTest
...
begin
  ...
  begin
    ...
    begin
      ...
      else if (Bounds.Bottom - AHitTest.HitY) <= cxHitDelta then
        AHitTest.SetDragKind(edkResizeEnd);
    end;
  end
  else if IsHeaderEvent and not IsShowHeaderEventsInContentArea then
...
function TcxSchedulerDayViewEventCellCustomViewInfo.
  IsShowHeaderEventsInContentArea: Boolean;
begin
...
procedure TcxSchedulerDayViewEventCellViewInfo.
...
begin
  ...
  FTimeLineRect := cxRectSetRight(FBounds, FBounds.Left,
    ScaleFactor.Apply(cxTimeLineWidth));
  FEventTimeRect := cxRectBounds(FTimeLineRect.Left, ATop,
    ScaleFactor.Apply(cxTimeLineWidth), AHeight);
end;
...
begin
  ...
  begin
    R := cxRectSetTop(Bounds, Bounds.Top - ScaleFactor.Apply(cxTimeLineWidth -
      1), ScaleFactor.Apply(cxTimeLineWidth));
...
begin
  ...
  FCaptionAndLocationCanPlaceOneLineOnly :=
    (cxRectHeight(Bounds) < 2 * (Canvas.FontHeight(Canvas.Font) +
    FDetailCaptionVertOffset));
  Canvas.Font.Style := AStyle;
end;

procedure TcxSchedulerDayViewEventCellModernViewInfo.
...
begin
  if not FCaptionIsBold then
    inherited CalculateHeaderEventNeededCaptionWidth(AFullWidth,
      ACaptionOnlyWidth)
  else
  begin
    ACaptionOnlyWidth := 0;
...
begin
  ...
  if FCaptionAndLocationCanPlaceOneLineOnly then
    ...
    FLocationRect.Top := Min(CaptionRect.Top + GetCaptionAutoHeight(CaptionRect)
      + 1, FLocationRect.Bottom);
  Canvas.Font.Style := AStyle;
end;

function TcxSchedulerDayViewEventCellModernViewInfo.
...
function TcxSchedulerDayViewEventCellModernViewInfo.CanShowHeaderEventClock
...
const
  ABorders: array [Boolean] of TcxBorders = ([bLeft, bTop, bBottom],
    [bTop, bRight, bBottom]);
var
  R, R1: TRect;
  ARgn: TcxRegion;
begin
  ...
  try
    ...
    try
      ...
      R1.Bottom := Min(R1.Bottom, SelectionBorderRect.Bottom -
        SelectionBorderSize);
      if not UseRightToLeftAlignment then
      begin
      ...
      R1.Bottom := Min(SelectionBorderRect.Bottom,
        R1.Bottom + SelectionBorderSize);
      if not UseRightToLeftAlignment then
      begin
      ...
      Canvas.FrameRect(R1, GetSelectedBorderColor, SelectionBorderSize,
...
const
  ...
  AVerticalAlignment: array [Boolean] of Cardinal = (CXTO_TOP,
...
begin
  Result := AHorizontalAlignment[UseRightToLeftAlignment] or
    AVerticalAlignment[not IsDetailInfo] or CXTO_EXCELSTYLE or
    CXTO_END_ELLIPSIS or ASingleLine[not IsDetailInfo] or CXTO_EDITCONTROL;
end;

function TcxSchedulerDayViewEventCellModernViewInfo.GetCaptionFontStyle
  : TFontStyles;
begin
...
function TcxSchedulerDayViewEventCellModernViewInfo.GetHeaderImagesPossibleRect
...
function TcxSchedulerDayViewEventCellModernViewInfo.
  GetImagesHorizontalOffset: Integer;
begin
...
function TcxSchedulerDayViewEventCellModernViewInfo.GetViewStyle
  : TcxSchedulerViewStyle;
begin
  Result := svsModern;
end;
...
procedure TcxSchedulerDayViewEventCellModernViewInfo.TuneClipping
  (var AClipRgn: TcxRegion);
var
  R: TRect;
begin
  ...
  begin
    ...
    if TimeLineRect.Bottom + Integer(not ActualBorderColorIsNone) < Bounds.Bottom
    then
    begin
      FBelowOfTimeLineRect := R;
      FBelowOfTimeLineRect.Top := TimeLineRect.Bottom +
        Integer(not ActualBorderColorIsNone) * SelectionBorderSize;
    ...
    begin
      ...
      FAboveOfTimeLineRect.Bottom := TimeLineRect.Top -
        Integer(not ActualBorderColorIsNone) * SelectionBorderSize;
...
begin
  if (FVisibleRowCount = 0) or (FVisibleRowCount >= FRowCount) or
    ...
    DayView.SetScrollBarInfo(sbVertical, 0, FRowCount - 1, 1, FVisibleRowCount,
      TopIndex, True, True);
  inherited InitScrollBarsParameters;
end;

procedure TcxSchedulerDayViewViewInfo.ScrollVertical(AScrollCode: TScrollCode;
  var AScrollPos: Integer);
var
  APositionCount, AAllDayScrollPos: Integer;
begin
  if (TcxCustomSchedulerAccess(Scheduler).MouseWheelScrollingKind <> mwskNone)
    and NeedAllDayScrollBar and cxRectPtIn(FAllDayAreaBounds,
    View.ScreenToClient(GetMouseCursorPos)) then
  begin
...
procedure TcxSchedulerDayViewViewInfo.AllDayScroll(AScrollCode: TScrollCode;
  var AScrollPos: Integer);
begin
...
function TcxSchedulerDayViewViewInfo.AddContentCell(const ARect: TRect;
  const AStart, AFinish: TDateTime; AResourceIndex: Integer)
  : TcxSchedulerContentCellViewInfo;
var
  R: TRect;
...
begin
  ...
  CreateCellInstance(ContentCellClass, ARect, R, P,
...
procedure TcxSchedulerDayViewViewInfo.AddContainerCell(AColumn: Integer;
  const ABounds: TRect);
var
...
begin
  ...
  AParams := DayView.Styles.GetHeaderContainerParams(ADate, AResource,
    ASelected);
  CreateCellInstance(HeaderContainerCellClass, ABounds, AParams,
    UseRightToLeftAlignment, ACell);
  ACell.Calculate(ADate, ASelected, GetActualDayHeaderModernStyleDisplayMode,
    Byte(GroupByResource or GroupByDate) * FResourceHeaderHeight +
    DayHeaderHeight);
  ...
  if HasVisibleBounds and (AColumn = FColCount) then
    ACell.Borders := [bBottom, bRight];
  TcxSchedulerContainerCellViewInfoAccess(ACell).FFirstEventTop :=
    FHeaderContainerContentOffset;
...
begin
  if APlace.LineStart >= FHeaderLineCount then
    Exit;
  ...
  if (GetActualDayHeaderModernStyleDisplayMode = hdmDefault) and not Adapter.IsPrinting
  then
    ATopOffset := Integer(APlace.LineStart > 0);
  OffsetRect(ABounds, 0, APlace.LineStart * (FHeaderLineHeight + ATopOffset));
  if (APlace.ColFinish >= FColCount - 1) and NeedAllDayScrollBar and
    not TcxCustomSchedulerAccess(Scheduler).IsPopupScrollBars then
    if Scheduler.UseRightToLeftScrollBar then
      Inc(ABounds.Left, TcxCustomSchedulerAccess(Scheduler).GetScrollBarSize.cx)
    else
      Dec(ABounds.Right, TcxCustomSchedulerAccess(Scheduler)
        .GetScrollBarSize.cx);
  ACell := AddEventCell(CreateHeaderEventViewData
    (TcxSchedulerControlEvent(APlace.Event), ABounds, AStart, AFinish,
    GetColumnResource(APlace.ColStart)));
  ...
  begin
    for I := 0 to FButtons.Count - 1 do
      ...
      begin
        ...
        begin
          if (ViewStyle = TcxSchedulerViewStyle.svsClassic) or
            (AColumnIndex = Result.ColumnIndex) then
            Exit;
        end;
      end;
    Result := nil;
...
begin
  ...
  begin
    ...
    FAllDayAreaBounds.Top := FResourceHeaderHeight *
      Byte(GroupingKind <> gkNone) + DayHeaderHeight;
    FAllDayAreaBounds.Bottom := FContentOffset;
    if Scheduler.ControlBox.Visible or TcxSchedulerCustomDateNavigatorAccess
      (Scheduler.DateNavigator).Visible then
      FAllDayAreaBounds := cxRectOffset(FAllDayAreaBounds,
        IfThen(Scheduler.OptionsView.ViewPosition = vpRight,
        cxRectWidth(Scheduler.ControlBox.Bounds) +
        Scheduler.OptionsView.VertSplitterWidth),
        IfThen(Scheduler.OptionsView.ViewPosition = vpBottom,
        cxRectHeight(Scheduler.ControlBox.Bounds) +
        Scheduler.OptionsView.HorzSplitterWidth));
  end;
end;
...
begin
  ...
  begin
    ...
    Inc(ARect.Top);
    if Scheduler.UseRightToLeftScrollBar then
      ARect.Right := ARect.Left + TcxCustomSchedulerAccess(Scheduler)
        .GetScrollBarSize.cx
    else
      ARect.Left := ARect.Right - TcxCustomSchedulerAccess(Scheduler)
        .GetScrollBarSize.cx;
...
procedure TcxSchedulerDayViewViewInfo.CalculateBackground;
  ...
  begin
    ...
    begin
      CreateCellInstance(TcxSchedulerBackgroundCellViewInfo, ABounds,
        Styles.GetBackgroundParams, UseRightToLeftAlignment, FBackground);
  ...
  begin
    if ABounds.Top >= ABounds.Bottom then
      Exit;
    TcxSchedulerTimeRulerCellViewInfo(TimeRulerCells[TimeRulerCells.Count - 1])
      .SetBottom(ABounds.Top);
    for J := -1 to ColCount - 1 do
    begin
      for I := 0 to UnusedRowCount - 1 do
      begin
        R := cxRectSetTop(ABounds, ABounds.Top + I * FContentLineHeight,
          FContentLineHeight);
        if J = -1 then
          R.Right := FHeaderOffsetLeft
        else
          R := cxRectSetLeft(R, GetContainer(J).Bounds.Left,
            cxRectWidth(GetContainer(J).Bounds));
...
begin
  FreeAndNil(FBackground);
  if AutoHeight and not HasVisibleBounds then
    Exit;
  R := Bounds;
  if Adapter.IsPrinting then
  begin
    R.Top := FContentOffset + (PrintFinishRow - PrintStartRow + 1) *
      FContentLineHeight;
...
const
  AIsPrintingBorders: array [Boolean] of TcxBorders = ([bRight],
    [bLeft, bRight]);
  AIsNoPrintingBorders: array [Boolean] of TcxBorders = ([bBottom],
    [bLeft, bBottom]);
var
  I, J: Integer;
...
begin
  ...
  begin
    ...
    AColor := StylesAdapter.GetContentParams(GetColumnDate(I), True,
      AResource).Color;
    ...
    begin
      if (ColumnInGroup > 1) or
        ((ColumnInGroup = 1) and (DayView.OptionsView.GroupSeparatorWidth = 0))
      then
      begin
    ...
    for J := 0 to FDayRowCount - 1 do
      ...
      begin
        ACell := AddContentCell(ARect, GetRowTime(I, J), GetRowTime(I, J + 1),
          AIndex) as TcxSchedulerDayViewContentCellCustomViewInfo;
        ACell.Borders := [];
        ...
        if not Adapter.IsPrinting or (J <> PrintFinishRow) then
          ACell.Borders := ACell.Borders + AIsNoPrintingBorders
            [ViewStyle = svsModern];
        ACell.SetBorderColor(AColor, (J + 1) mod LinePerHour = 0,
          DayView.IsWorkTime(AResource, ACell.TimeStart));
...
procedure TcxSchedulerDayViewViewInfo.CalculateContentNavigationButtons;
  ...
  begin
    Result := Containers[AContainerID].Bounds.Right - Containers[AContainerID]
      .Bounds.Left;
  end;

  function GetResourceWidth(AContainerID: Integer;
    out TheSameResource: Boolean): Integer;
  var
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        CalculateNavigationButtonParams(ANewColumnRect, nbkPrevious,
          AButtonWidth1);
...
begin
  if AEvents.Count = 0 then
    Exit;
  FEventLayout.Clear;
  I := Byte(((AIndex mod ColumnInGroup <> 0) or not HasSeparator) and
    not(ColCount = 1));
  ATop := FContentOffset;
  if not Adapter.IsPrinting then
    Dec(ATop, TopIndex * FContentLineHeight);
  FEventLayout.SetParams(dxDateOf(AContainer.DateTime), TimeScale,
    FContentLineHeight, AContainer.Bounds.Left - I, ATop,
    cxRectWidth(AContainer.Bounds));
  ...
  begin
    ...
    CheckEventRowsVisibility(AIndex, AContainer.Bounds, AInfo.Event,
      AInfo.StartRow, AInfo.StopRow + 1);
    AViewData := CreateContentEventViewData(AInfo, AContainer.Resource);
    if Adapter.IsPrinting and (FColCount > 1) then
      if (AIndex mod ColumnInGroup > 0) or
        ((ColumnInGroup = 1) and (DayView.OptionsView.GroupSeparatorWidth = 0))
      then
        OffsetRect(AViewData.Bounds, 1, 0);
    AViewData.DrawShadows := DayView.EventShadows and
      (SchedulerStyle = svsClassic);
    if ViewStyle = svsClassic then
      AEventCell := AddEventCell(AViewData)
    else
    begin
      AEventCell := AddEventCell(AViewData, False);
      (AEventCell as TcxSchedulerDayViewEventCellModernViewInfo).FTimeLineHeight
        := (AInfo as TcxEventModernLayoutInfo).RealHeight;
      (AEventCell as TcxSchedulerDayViewEventCellModernViewInfo).FTimeLineShift
        := (AInfo as TcxEventModernLayoutInfo).TimeLineShift;
      TcxSchedulerEventCellViewInfoAccess(AEventCell).Calculate;
    end;
    TcxSchedulerEventCellViewInfoAccess(AEventCell).FContainerInfo :=
      TcxSchedulerDayViewEventCellContainerInfo.Create(AIndex, AInfo);
  end;
end;
...
var
  I, J: Integer;
begin
  if not HeaderContainer or DayView.ShowAllDayEventsInContentArea then
    Exit;
    ...
    for I := 0 to Builder.EventPlaceCount - 1 do
      with Builder.EventPlaces[I] do
        ...
        begin
          ...
          else if (FAllDayTopIndex + FHeaderLineCount - 1) < LineFinish then
...
begin
  ...
  FHeaderLineCount := 1;
  for I := 0 to Builder.EventPlaceCount - 1 do
    FHeaderLineCount := Max(Builder.EventPlaces[I].LineFinish + 1,
      FHeaderLineCount);
  if cxSchedulerAllDayEventContainerMaxLineCount = 0 then
    I := (Bounds.Bottom - Bounds.Top - DayHeaderHeight - FResourceHeaderHeight)
      div FContentLineHeight div 2
  else
...
const
  ANeighbors: array [TcxSchedulerGroupingKind, 0 .. 1] of TcxNeighbors =
    (([], []), ([], []), ([nTop], []), ([], [nTop]));
begin
  AGroupBounds := cxRectSetHeight(Bounds, Byte(GroupByResource) *
    FResourceHeaderHeight + Byte(GroupByDate) * DayHeaderHeight);
  AHeaderBounds := cxRectSetTop(Bounds, AGroupBounds.Bottom,
    Byte(GroupByDate) * FResourceHeaderHeight + Byte(not GroupByDate) *
    DayHeaderHeight);
  W := Bounds.Right - FHeaderOffsetLeft - (GroupCount - 1) * SeparatorWidth;
  for I := 0 to GroupCount - 1 do
  begin
    AGroupBounds.Left := MulDiv(W, I, GroupCount) + FHeaderOffsetLeft +
      SeparatorWidth * I;
    AGroupBounds.Right := MulDiv(W, I + 1, GroupCount) + FHeaderOffsetLeft +
      SeparatorWidth * I;
    ...
    begin
      ...
      if GroupByDate then
        ...
        AddDayHeader(GetColumnDate(I * ColumnInGroup + J), AHeaderBounds,
          ...
          GetActualDayHeaderModernStyleDisplayMode);
      AddContainerCell(I * ColumnInGroup + J, cxRectSetTop(AHeaderBounds,
        Bounds.Top, FContentOffset - Bounds.Top));
    end;
    if GroupByResource then
    ...
    if HasSeparator then
      AddGroupVertSeparator(AGroupBounds.Right);
  end;
...
procedure TcxSchedulerDayViewViewInfo.CalculateMetrics;
  ...
  begin
    if HeaderContainer then
      Result := ScaleFactor.Apply(cxTextOffset) + FHeaderLineCount *
        (FHeaderLineHeight + ScaleFactor.Apply(cxTextOffset))
    else
      Result := 0;
  end;
...
begin
  ...
  if (GetActualDayHeaderModernStyleDisplayMode = hdmDefault) and not Adapter.IsPrinting
  then
    FHeaderContainerCaptionHeight := LookAndFeelPainter.ScaledHeaderHeight
      (GetFontHeight(DayView.Styles.HeaderContainer), ScaleFactor)
  else
  ...
  begin
    if AutoHeight and (FVisibleRowCount > (FRowCount + FHeaderLineCount)) then
      FContentLineHeight := (ContentHeight - GetExtraContentOffset)
        div FRowCount;

    FContentOffset := FContentOffset + GetExtraContentOffset;
    FVisibleRowCount := Min(FRowCount,
      Max(1, ContentHeight div FContentLineHeight));
    if AutoHeight or (ContentHeight div FContentLineHeight < FRowCount) then
      Inc(FContentOffset, ContentHeight - FContentLineHeight *
        FVisibleRowCount);
  end;
  if not HeaderContainer then
    FDayHeaderHeight := FContentOffset - Byte(GroupingKind <> gkNone) *
      FResourceHeaderHeight;
  while (FTopIndex > 0) and ((FTopIndex + FVisibleRowCount) > FRowCount) do
    Dec(FTopIndex);
  FHeaderContainerContentOffset := DayHeaderHeight +
    FHeaderContainerCaptionHeight + FResourceHeaderHeight *
    Byte(GroupingKind <> gkNone)
end;
...
begin
  FContentOffset := Byte(GroupingKind <> gkNone) * FResourceHeaderHeight *
    Byte(ResourceCount >= 1) + FHeaderLineCount *
    (FHeaderLineHeight + ScaleFactor.Apply(cxTextOffset)) +
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        while 60 mod FTimeScale <> 0 do
          Inc(FTimeScale);
      end
      else if UnusedRowCount > 0 then
        Dec(FUnusedRowCount)
      else
        Break;
    end;
...
var
  ...
  function AddRulerCell(ARegularHour, ADisplayedHour: Integer)
    : TcxSchedulerTimeRulerCellViewInfo;
  begin
    CreateCellInstance(TimeRulerCellClass,
      cxRectSetTop(R, R.Bottom * ARegularHour - AOffset), ABounds, AViewParams,
      UseRightToLeftAlignment, Result);
    Result.ShowMinutes := DayView.TimeRulerMinutes;
    TcxSchedulerTimeRulerCellAccess(Result).FAdditionalTimeZoneMinutesOffset :=
      AAdditionalMinutesOffset;
    Result.Calculate(ADisplayedHour, LinePerHour, FCurrentTimeZone,
    ...
    begin
      TcxSchedulerTimeRulerCellAccess(Result).FBounds[False] :=
        cxRectOffsetVert(Result.Bounds[False],
        Round(cxRectHeight(Result.Bounds[False]) *
        AAdditionalMinutesOffset / 60));
...
begin
  ...
  FHeaderOffsetLeft := R.Left + TimeRulerCellClass.CalculateWidth
    (1 + Byte(FAdditionalTimeZone >= 0), LinePerHour, AViewParams.Font,
    LargeFont, ScaleFactor, DayView.TimeRulerMinutes);
  Dec(R.Left, Byte(UseRightToLeftAlignment));
  R.Right := FHeaderOffsetLeft;
  CalculateTimeZoneBiasDelta;
  // add common area
  CreateCellInstance(TimeRulerCellClass, cxRectSetTop(R, 0, R.Top), AViewParams,
    UseRightToLeftAlignment, ACommonCell);
  ...
  ABounds.Bottom := Min(FContentOffset + FRowCount * FContentLineHeight,
    Bounds.Bottom);
  FTimeRulerCells.Add(ACommonCell);
  ABiasDelta := IfThen(FAdditionalTimeZone >= 0,
    TdxTimeZoneHelper.TimeZoneInfo(FCurrentTimeZone).TZI.Bias -
    TdxTimeZoneHelper.TimeZoneInfo(FAdditionalTimeZone).TZI.Bias, 0);
  if ABiasDelta mod 60 = 0 then
    AAdditionalMinutesOffset := 0
  else if ABiasDelta < 0 then
    AAdditionalMinutesOffset := IfThen(ABiasDelta mod 60 <> 0,
      -(60 - Abs(ABiasDelta) mod 60), 0)
  else
    AAdditionalMinutesOffset := IfThen(ABiasDelta mod 60 <> 0,
      -Abs(ABiasDelta) mod 60, 0);
  AFirstRulerCell := nil;
  AHour := 0;
  I := 0;
...
begin
  ...
  begin
    ...
    if AdditionalTimeZoneDaylightSaving then
      Dec(FAdditionalTimeZoneBiasDelta,
        GetDaylightBiasDelta(FAdditionalTimeZone));
  end;
end;
...
begin
  ...
  begin
    FTimeScale := DayView.TimeScale;
    CalculateDisplayRows;
    FContentOffset := DayHeaderHeight + FHeaderContainerCaptionHeight +
...
function TcxSchedulerDayViewViewInfo.CheckDisplayRows(var AStartRow,
  AFinishRow: Integer): Boolean;
begin
...
procedure TcxSchedulerDayViewViewInfo.CheckEventRowsVisibility
  (AColumnIndex: Integer; const AContainerBounds: TRect;
  AEvent: TcxSchedulerControlEvent; AStartRow, AFinishRow: Integer);
begin
  if Adapter.IsPrinting then
    Exit;
  if AStartRow < FTopIndex then
    AddMoreEventsButton(AColumnIndex, AContainerBounds, AStartRow,
      True, AEvent);
  if (AFinishRow > (FTopIndex + VisibleRowCount)) then
  begin
    if AFinishRow <= FRowCount then
      AddMoreEventsButton(AColumnIndex, AContainerBounds, AFinishRow,
        False, AEvent)
    else if AStartRow > (FTopIndex + VisibleRowCount) then
      AddMoreEventsButton(AColumnIndex, AContainerBounds, AStartRow,
        False, AEvent);
  end;
end;

function TcxSchedulerDayViewViewInfo.ContentCellClass
...
function TcxSchedulerDayViewViewInfo.HeaderContainerCellClass
  : TcxSchedulerContainerCellViewInfoClass;
const
...
procedure TcxSchedulerDayViewViewInfo.DoContentNavigationButtonClick
  ...
  procedure ShowEvent(ANavigationButtonKind
  ...
  begin
    ...
    for I := 0 to Buttons.Count - 1 do
      ...
      begin
        AEventStart := TcxSchedulerMoreEventsButtonViewInfo(Buttons[I])
          .Event.Start;
...
procedure TcxSchedulerDayViewViewInfo.DoIntradayEventCellsVerticalScroll
  (APositionCount: Integer);
var
  I: Integer;
...
function TcxSchedulerDayViewViewInfo.CreateContentEventViewData
  (AEventInfo: TcxEventLayoutInfo; AResource: TcxSchedulerResourceViewInfo)
  : TcxSchedulerEventViewData;
begin
  Result := CreateEventViewData(AEventInfo.Event, AEventInfo.DisplayRect,
    AEventInfo.Start, AEventInfo.Finish, AResource);
...
begin
  ...
  Result.VisibleRect := cxRect(FHeaderOffsetLeft, DayHeaderHeight, Bounds.Right,
    FContentOffset);
...
procedure TcxSchedulerDayViewViewInfo.ExtractEvents(ASource,
  ADest: TcxSchedulerEventList; AIndex: Integer);
begin
...
function TcxSchedulerDayViewViewInfo.GetCalculateEventLayoutClass
  : TcxCalculateEventLayoutClass;
const
  AClass: array [Boolean] of TcxCalculateEventLayoutClass =
    (TcxCalculateEventLayout, TcxCalculateModernEventLayout);
begin
  Result := AClass[ViewStyle = svsModern];
end;
...
begin
  ...
  AIsSelected := not HiddenSelection and not FIsContainerSelected and
    IsTimeSelected(ATime, AResource);
  if AIsSelected then
...
begin
  ...
  else if GroupingKind = gkByResource then
...
begin
  ...
  begin
        ...
        gkByDate:
          begin
            if AColumnIndex = AResourceIndex then
              Result := cprFirst
            else if AColumnIndex > FColCount - 1 - ResourceCount then
              Result := cprLast;
          end;
        gkByResource:
          begin
            if AColumnIndex = DayCount * AResourceIndex then
              Result := cprFirst
            else if AColumnIndex = DayCount * (AResourceIndex + 1) - 1 then
              Result := cprLast;
          end;
      end;
  end
    ...
    Result := cprSingle
  else if AColumnIndex = 0 then
    Result := cprFirst
  else if AColumnIndex = FColCount - 1 then
    Result := cprLast;
end;

function TcxSchedulerDayViewViewInfo.GetColumnResource(AIndex: Integer)
...
function TcxSchedulerDayViewViewInfo.GetContainer(AIndex: Integer)
  : TcxSchedulerContainerCellViewInfo;
begin
...
begin
  ...
  if ((SelectedDays.Count = 1) and Adapter.IsPrinting and
    (GroupingKind <> gkByResource)) or not DayView.DayHeaderArea then
    Result := 0;
end;
...
function TcxSchedulerDayViewViewInfo.EventCellClass
...
function TcxSchedulerDayViewViewInfo.GetActualDayHeaderModernStyleDisplayMode
  : TcxSchedulerDayHeaderModernStyleDisplayMode;
var
  AMode: TcxSchedulerDayHeaderModernStyleDisplayMode;
begin
...
function TcxSchedulerDayViewViewInfo.GetEventColumnRow(const ATime: TDateTime;
AColIndex: Integer; AStart: Boolean): Integer;
...
begin
  if AStart and (ATime <= GetColumnDate(AColIndex)) then
    Result := 0
  else if not AStart and (ATime >= GetColumnDate(AColIndex)) then
  begin
    if HasVisibleBounds then
      Result := FRowCount - 1
    else
...
procedure TcxSchedulerDayViewViewInfo.GetHeaderEventInfo
  (APlace: TcxSchedulerEventPlace; out ALeft, ARight: Integer;
...
begin
  ...
  begin
    ...
    else if APlace.Event.Finish <= AFinish then
...
function TcxSchedulerDayViewViewInfo.GetTimeRow(const ATime: TDateTime;
AIsStart: Boolean): Integer;
var
  ACount: Double;
begin
  ACount := Min(FRowCount - 1, dxTimeOf(ATime) / MinuteToTime / TimeScale -
    FPrintStartRow);
  Result := Round(ACount);
...
begin
  ...
  Result := (Bounds.Right - Bounds.Top) - TimeRulerCellClass.CalculateWidth
    (1 + Byte(FAdditionalTimeZone >= 0), 60 div DayView.TimeScale, AFont,
    LargeFont, ScaleFactor, DayView.TimeRulerMinutes);
  if GroupByDate then
    Result := Result div DayCount;
end;

function TcxSchedulerDayViewViewInfo.GetRowTime(AColumn, ARow: Integer)
  : TDateTime;
begin
...
begin
  ...
  if Result then
    Result := AEvent.IsResourceEvent
      (GetResourceItemByIndex(GetColumnResourceIndex(AIndex)),
      ShowEventsWithoutResource);
end;
...
begin
  Result := AEvent.IsDayEvent(GetColumnDate(AIndex)) and
    (IsHeaderEvent = AEvent.IsAllDayOrLonger);
  if Result then
    Result := AEvent.IsResourceEvent
      (GetResourceItemByIndex(GetColumnResourceIndex(AIndex)),
      ShowEventsWithoutResource);
...
begin
  ...
  begin
    if SelectedEventCount > 0 then
      Exit;
    if (AResource = SelResource) and (dxDateOf(ADate + 1) <= dxDateOf(SelFinish))
    then
    begin
...
begin
  Result := (dxTimeOf(AEvent.Start) <= PrintTo) and
    (dxTimeOf(AEvent.Finish) >= PrintFrom);
end;

function TcxSchedulerDayViewViewInfo.IsEventVisible(var AStartRow,
  AStopRow: Integer): Boolean;
begin
...
function TcxSchedulerDayViewViewInfo.IsHeaderEventCell
  (ACell: TcxSchedulerEventCellViewInfo): Boolean;
begin
  Result := not DayView.ShowAllDayEventsInContentArea and
    ACell.Event.IsAllDayOrLonger;
end;

function TcxSchedulerDayViewViewInfo.IsHourVisible(AIndex: Integer): Boolean;
begin
  Result := not HasVisibleBounds or
    ((PrintStartRow div LinePerHour <= AIndex) and
...
procedure TcxSchedulerDayViewViewInfo.MakeTimeVisible(const ATime: TDateTime);
var
  ARow: Integer;
begin
...
begin
  if (AKind = nbkNext) and GroupByDate and (AResourceIndex < ResourceCount - 1)
  then
...
procedure TcxSchedulerDayViewViewInfo.CustomProcessPreviouslyCalculatedEvent
  (AEventCell: TcxSchedulerEventCellViewInfo);
var
...
begin
  ...
  CheckEventRowsVisibility(AContainerInfo.ContainerIndex, AContainerBounds,
    AEventCell.Event, AContainerInfo.StartRow, AContainerInfo.FinishRow);
...
begin
  ...
  StartRow := GetEventColumnRow(AEventInfo.Event.Start, AColIndex, True)
    + AOffset;
  StopRow := GetEventColumnRow(AEventInfo.Event.Finish - 1, AColIndex, False)
    + AOffset;
  for I := StartRow to StopRow do
    ...
    begin
      ...
      else if (ACell.TimeEvent = nil) or ((ACell.TimeEvent.Event.State <> 3) and
        (ACell.TimeEvent.Event.State < AEventInfo.Event.State)) then
        ACell.TimeEvent := AEventInfo;
    end;
end;

procedure TcxSchedulerDayViewViewInfo.SetContainerCellHeaderEvent
  (AEventInfo: TcxSchedulerEventCellViewInfo);
var
  I: Integer;
...
begin
  ...
  begin
    ...
    if TcxSchedulerDateTimeHelper.Intersect(AEventInfo.Event.Start,
      AEventInfo.Event.Finish, ADate, ADate + 1) then
      if SchedulerStyle = svsClassic then
      begin
        if AContainerCell.HeaderEvent = nil then
          AContainerCell.HeaderEvent := AEventInfo
      end
      else if ((AContainerCell.HeaderEvent = nil) or
        ((AContainerCell.HeaderEvent <> nil) and
        (AContainerCell.HeaderEvent.Event.State <> 3) and
        (AContainerCell.HeaderEvent.Event.State < AEventInfo.Event.State))) and
        ((AContainerCell.Resource = nil) or
        VarEquals(AContainerCell.Resource.ResourceID,
        AEventInfo.Event.ResourceID)) then
        AContainerCell.HeaderEvent := AEventInfo;
  end;
end;
...
function TcxSchedulerDayViewViewInfo.TimeRulerCellClass
  : TcxSchedulerTimeRulerCellViewInfoClass;
const
...
begin
  ...
  begin
    ACount := 0;
    for I := 0 to Builder.EventPlaceCount - 1 do
      if (Builder.EventPlaces[I].ColStart <= J) and
        (Builder.EventPlaces[I].ColFinish >= J) and not DayView.ShowAllDayEventsInContentArea
      then
        Inc(ACount);
...
function TcxSchedulerDayViewViewInfo.GetController
  : TcxSchedulerDayViewController;
begin
...
begin
  ...
  AScrollBar.Min := 0;
  AScrollBar.Max := Math.Max(AScrollBar.Min, GetAllDayEventMaxCount -
    FHeaderLineCount);
...
function TcxSchedulerDayViewHitTest.GetContainerCell
  : TcxSchedulerContainerCellViewInfo;
begin
...
function TcxSchedulerDayViewHitTest.GetTimeRulerCell
  : TcxSchedulerTimeRulerCellViewInfo;
begin
...
const
  Mask = (1 shl htcControl) or (1 shl htcDayHeader) or (1 shl htcTimeRuler) or
    (1 shl htcContainer) or (1 shl htcContent);
begin
  Result := Mask;
end;
...
begin
  Result := inherited IsAtOrigin or
    (((not ShowHeaderContainer and HitTest.HitAtDayHeader) or
    (FStartInHeader and InHeader)) and
    (Controller.StartDragHitTime = HitTest.Time) and ((FStartResource = nil) or
    (FStartResource = HitTest.Resource)));
...
procedure TcxDayViewDragEventHelper.SetCloneEventsTimeDelta(AStart,
  ACurrent: TDateTime; AInHeader: Boolean);
var
  I: Integer;
  ADelta: TDateTime;
begin
  ...
  begin
    with Clones[I] do
    begin
      AllDayEvent := AInHeader and
        (Source.AllDayEvent or (Source.Duration < 1));
      if AInHeader then
      begin
      ...
      else if not IsHeaderEvent(Source) or Controller.View.ShowAllDayEventsInContentArea
      then
      begin
        Duration := Source.Duration;
...
begin
  with Event do
  begin
    AllDayEvent := (HitTest.HitAtContainer or
      ((dxTimeOf(GetSizingTime) = 0) { and
        not Controller.View.ShowAllDayEventsInContentArea } )) and
      (Source.AllDayEvent or (dxTimeOf(FFixedBoundTime) = 0));
...
begin
  ...
  else if HitTest.HitAtContent then
    Result := Result + TcxSchedulerDayView(Scheduler.CurrentView).TimeScale *
      MinuteToTime
  else if (Controller.DragKind = edkResizeEnd) and not Event.AllDayEvent and
    HitTest.HitAtContainer and (dxTimeOf(Result) = 0) then
    Result := Result + 1;
end;
...
procedure TcxSchedulerDayNavigation.KeyDown(var AKey: Word;
AShift: TShiftState);
const
...
begin
  ...
  case AKey of
    ...
    VK_LEFT, VK_RIGHT:
      begin
        DoNextColumn(AKey = ANextCellKey[DayView.UseRightToLeftAlignment],
          GetColumnByDate(ATime, ResourceObject), ATime, FCurrentResource);
        Exit;
      end;
    VK_NEXT, VK_PRIOR:
      if not DoNextPage(AKey = VK_NEXT, ATime, FCurrentResource) then
        Exit;
  end;
...
begin
  ...
  begin
    ...
    if (ADate >= AStart) and (ADate <= AFinish) then
      Exit
  end;
...
procedure TcxSchedulerDayNavigation.DoNextColumn(AGoToNext: Boolean;
AColumn: Integer; const ATime: TDateTime;
AResource: TcxSchedulerStorageResourceItem);
const
...
begin
  ...
  begin
    ...
    else if not(ssShift in FShift) then
      ReplaceDate(GetColumnDate(AColumn), GetColumnResource(AColumn))
    else
      SetSelAnchor(GetColumnDate(AColumn) + dxTimeOf(FCurrentAnchor), FShift,
        AResource);
  end;
end;
  ...
  begin
    ...
    begin
      ...
      ViewInfo.FTopIndex := Min(ViewInfo.FTopIndex + ViewInfo.VisibleRowCount,
        ViewInfo.FRowCount - 1 - ViewInfo.VisibleRowCount)
    end
    else
    begin
      ARow := Max(0, FSelRow - ViewInfo.VisibleRowCount);
      ViewInfo.FTopIndex :=
        Max(0, ViewInfo.FTopIndex - ViewInfo.VisibleRowCount);
    end;
    ATime := ATime + GetRowTime(ARow);
  end;
end;

function TcxSchedulerDayNavigation.GetColumnByDate(const ADate: TDateTime;
AResource: TObject): Integer;
begin
  for Result := 0 to ViewInfo.ColCount - 1 do
    if (ViewInfo.GetColumnDate(Result) >= dxDateOf(ADate)) and
      (ViewInfo.GetColumnResource(Result) = AResource) then
      Exit;
  Result := 0;
end;
...
function TcxSchedulerDayNavigation.GetColumnResource(AColumn: Integer)
  : TcxSchedulerStorageResourceItem;
begin
  Result := GetResourceFromViewInfo(ViewInfo.Containers[AColumn].Resource);
end;

function TcxSchedulerDayNavigation.GetRowTime(const ARow: Integer;
AFinish: Boolean = False): TDateTime;
begin
  Result := RoundTime((ARow + ViewInfo.PrintStartRow + Byte(AFinish)) *
    DayView.TimeScale * MinuteToTime);
end;
...
begin
  ...
  else if ViewInfo.GroupByDate and ((IsLastResource and AGoToNext) or
  ...
  begin
    ...
    else if not((AGoToNext and (AColumn = ColCount - 1)) or
      (not AGoToNext and (AColumn = 0))) and ScrollResourcesCycled(AGoToNext,
      AResource) then
      ReplaceSelParams(AResource);
  end;
  Result := False;
...
procedure TcxSchedulerDayViewController.BeforeMouseDown(Button: TMouseButton;
...
begin
  ...
  else if (APos.Y < R.Bottom) and (APos.Y >= (R.Bottom - cxScrollZoneSize)) then
...
begin
  if HitTest.HitAtTime and HitTest.HitAtTimeRuler and (DragEventHelper = nil)
  then
    HitTest.SetHitTime(htcTime, dxDateOf(Navigation.SelAnchor) +
      dxTimeOf(HitTest.Time));
end;

function TcxSchedulerDayViewController.CreateDragEventHelper
  : TcxDragEventHelper;
begin
  Result := TcxDayViewDragEventHelper.Create(Scheduler);
end;

function TcxSchedulerDayViewController.CreateNavigation
  : TcxSchedulerViewNavigation;
begin
  Result := TcxSchedulerDayNavigation.Create(View);
end;

function TcxSchedulerDayViewController.CreateResizeEventHelper
  : TcxEventSizingHelper;
begin
  Result := TcxDayViewEventSizing.Create(Scheduler);
end;

procedure TcxSchedulerDayViewController.InitTimer(AllowStart: Boolean;
AScrollCode: TScrollCode);
begin
...
procedure TcxSchedulerDayViewController.MouseDown(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Navigation.ReplaceSelParams(DateTime,
          DateTime + 1 - Navigation.TimeIncrement, HitTest.Resource);
    ...
    else if HitTest.HitAtTimeRuler then
    begin
...
procedure TcxSchedulerDayViewController.MouseMove(Shift: TShiftState;
X, Y: Integer);
var
  AStart, AFinish: TDateTime;
begin
    ...
    begin
      ...
      begin
        if AFinish >= AStart then
          Navigation.ReplaceSelParams(AStart,
            AFinish + 1 - Navigation.TimeIncrement)
        else
          Navigation.ReplaceSelParams
            (AStart + 1 - Navigation.TimeIncrement, AFinish);
      end
      else
        Navigation.ReplaceSelParams(AStart,
          AStart + 1 - Navigation.TimeIncrement, Navigation.SelResource);
      View.LockEventLayoutCalculating;
      View.Refresh;
      View.UnlockEventLayoutCalculating;
      Exit;
...
procedure TcxSchedulerDayViewController.MouseUp(Button: TMouseButton;
Shift: TShiftState; X, Y: Integer);
begin
  FLockScrolling := False;
  CancelScroll;
...
begin
  ...
  if (ASelectedIndex < View.EventList.Count) and (ASelectedIndex >= 0) then
  begin
    AAllDayTopIndex := ViewInfo.AllDayTopIndex;
    AEventInHeaderIndex := GetEventInHeaderIndex
      (View.EventList[ASelectedIndex]);
    while ((ASelectedIndex < View.EventList.Count) and (ASelectedIndex >= 0))
      and (not View.GetEventVisibility(View.EventList[ASelectedIndex]) and
      (AEventInHeaderIndex = -1)) do
    begin
      GetNextSelectedIndex(ASelectedIndex);
      AEventInHeaderIndex := GetEventInHeaderIndex
        (View.EventList[ASelectedIndex]);
...
procedure TcxSchedulerDayViewController.CheckNavigatorScrollArea
  ...
  begin
    ...
    begin
      ...
      begin
        if I mod 2 <> Byte(AIsUpArea) then
          Continue;
        if not AIsUpArea then
          R := cxRectSetLeft(ARect, Integer(FScrollAreaRects[I]) - DW,
            cxScrollZoneSize)
        else
          R := cxRectSetRight(ARect, Integer(FScrollAreaRects[I]) + DW + 1,
            cxScrollZoneSize);
...
begin
  if CheckArea(FUpScrollArea, False) then
    ACode := scLineDown
  else if CheckArea(FDownScrollArea, True) then
    ACode := scLineUp
  else
    ACode := scEndScroll;
...
function TcxSchedulerDayViewController.GetDragEventHelper
  : TcxDayViewDragEventHelper;
begin
...
begin
  ...
  if Items * [rpmi60min, rpmi30min, rpmi15min, rpmi10min, rpmi6min, rpmi5min]
    <> [] then
  begin
...
var
  AIndex: Integer;
begin
  if ACommand in [Ord(rpmiNewEvent), Ord(rpmiNewAllDayEvent),
    Ord(rpmiNewReccuringEvent)] then
