...
uses
  Types, Classes, SysUtils, Dialogs, Math, dxCore, cxClasses, Generics.Defaults,
  Generics.Collections, cxVariants, dxSpreadSheetFormatXLS,
  dxSpreadSheetFormatXLSTypes, dxSpreadSheetCore, dxSpreadSheetFormulas,
  dxSpreadSheetTypes, dxSpreadSheetFunctions,
  dxSpreadSheetClasses, dxSpreadSheetFormatXLSWriter,
  dxSpreadSheetFormatXLSReader, dxSpreadSheetCoreFormulas,
...
type
  ...
  TdxXLSFormulaParameterDataType = (fpdtUnused, fpdtReference, fpdtValue,
    fpdtArray, fpdtAuto, fpdtSource);
  ...
  protected
    procedure AddFormula(AInfo: TdxSpreadSheetFunctionInfo;
    ...
    procedure AddToken(AToken: TdxSpreadSheetFormulaToken;
      AIncOffset: Integer); overload;
    function CheckUnknownNameFunction(AToken: TdxSpreadSheetFormulaToken)
      : TdxSpreadSheetFormulaToken;
    procedure ClearTokens;
    procedure DecodeAreaReference(ASrcRow, ASrcColumn, ASrcRow2,
      ASrcColumn2: Word; var ARow, AColumn, ARow2, AColumn2: Integer;
      var AAbsRow, AAbsColumn, AAbsRow2, AAbsColumn2: Boolean); inline;
    procedure DecodeAreaReference2(ASrcRow, ASrcColumn, ASrcRow2,
      ASrcColumn2: Word; var ARow, AColumn, ARow2, AColumn2: Integer;
      var AAbsRow, AAbsColumn, AAbsRow2, AAbsColumn2: Boolean); inline;
  ...
  public
    ...
    function ReadFormula(AFormula: TdxSpreadSheetCustomFormula; ASize: Integer)
      : Boolean; overload;
    procedure ReadName(AName: TdxSpreadSheetDefinedName; ASize: Integer;
      ASource: PByteArray); virtual;

    property AnchorColumn: Integer read FAnchorColumn;
    property AnchorRow: Integer read FAnchorRow;
    property Arrays: TList < TPair < TdxSpreadSheetFormulaArrayToken,
      TSize >> read FArrays;
  ...
  TdxXLSFormulaTokenWriter = procedure(AToken: TdxSpreadSheetFormulaToken)
    of object;
  ...
  strict private
    ...
    procedure EncodeReference(ARefRow, ARefColumn: TdxSpreadSheetReference;
      var ARow, AColumn: Word);
    procedure EncodeReferenceN(ARefRow, ARefColumn: TdxSpreadSheetReference;
  ...
  protected
    ...
    property AcceptedDataTypes: TdxXLSFormulaParameterDataTypes
      read GetAcceptedDataTypes;
    property CurrentToken: TdxSpreadSheetFormulaToken read FCurrentToken;
  public
    constructor Create(AOwner: TdxSpreadSheetXLSWriter;
      AWriteSize: Boolean = True); virtual;
    destructor Destroy; override;
    procedure WriteFormula(ACell: TdxSpreadSheetCell); overload;
    procedure WriteFormula(AFormula: TdxSpreadSheetCustomFormula;
      AAbsolute: Boolean); overload;
    procedure WriteFormula(AFormula: TdxSpreadSheetCustomFormula;
      AAbsolute: Boolean; AAnchorColumn, AAnchorRow: Integer); overload;
    procedure WriteNameFormula(AName: TdxSpreadSheetDefinedName); virtual;

    property Formula: TdxSpreadSheetCustomFormulaAccess read FFormula;
    property Writer: TdxXLSWriter read FWriter;
    property Writers: TDictionary<TClass, TdxXLSFormulaTokenWriter>
      read FWriters;
  end;
...
type
  ...
  TdxSpreadSheetFormulaAreaReferenceTokenAccess = class
  ...
  public
    ...
    function GetFormulaParameterType(AID, AIndex: Integer)
      : TdxXLSFormulaParameterDataTypes;
  end;
...
const
  ...
  XLSFunctionsDefinition: array [0 .. 97]
    of TdxXLSFunctionParametersDefinition = ((ID: $0000; Name: 'COUNT';
    Parameters: (RefVal, Same, Same)), (ID: $0001; Name: 'IF';
    Parameters: (Val, RefVal, Same)),
    // (ID: $0004; Name: 'SUM';             Parameters: ([fpdtSource], Same,   Same)),
    (ID: $0004; Name: 'SUM'; Parameters: (RefVal, Same, Same)), (ID: $0008;
    Name: 'ROW'; Parameters: (Ref, Same, Same)), (ID: $0009; Name: 'COLUMN';
    Parameters: (Ref, Same, Same)), (ID: $000B; Name: 'NPV';
    Parameters: (RefVal, Same, Same)), (ID: $000C; Name: 'STDEV';
    Parameters: (RefVal, Same, Same)), (ID: $001C; Name: 'LOOKUP';
    Parameters: (Val, RefVal, RefVal)), (ID: $001D; Name: 'INDEX';
    Parameters: (RefVal, Val, Val)), (ID: $0024; Name: 'AND';
    Parameters: (RefVal, Same, Same)), (ID: $0025; Name: 'OR';
    Parameters: (RefVal, Same, Same)), (ID: $0028; Name: 'DCOUNT';
    Parameters: (Ref, RefVal, RefVal)), (ID: $0029; Name: 'DSUM';
    Parameters: (RefVal, Same, Same)), (ID: $002A; Name: 'DAVERAGE';
    Parameters: (Ref, RefVal, RefVal)), (ID: $002B; Name: 'DMIN';
    Parameters: (Ref, RefVal, RefVal)), (ID: $002C; Name: 'DMAX';
    Parameters: (Ref, RefVal, RefVal)), (ID: $002D; Name: 'DSTDEV';
    Parameters: (Ref, RefVal, RefVal)), (ID: $002E; Name: 'VAR';
    Parameters: (RefVal, Same, Same)), (ID: $002F; Name: 'DVAR';
    Parameters: (Ref, RefVal, RefVal)), (ID: $0031; Name: 'LINEST';
    Parameters: (RefVal, Same, Same)), (ID: $0032; Name: 'TREND';
    Parameters: (RefVal, Same, Same)), (ID: $0033; Name: 'LOGEST';
    Parameters: (RefVal, Same, Same)), (ID: $0034; Name: 'GROWTH';
    Parameters: (RefVal, Same, Same)), (ID: $0035; Name: 'GOTO';
    Parameters: (Ref, Unused, Unused)), (ID: $0037; Name: 'RETURN';
    Parameters: (RefVal, Unused, Unused)), (ID: $0040; Name: 'MATCH';
    Parameters: (Val, RefVal, RefVal)), (ID: $004B; Name: 'AREAS';
    Parameters: (Ref, Unused, Unused)), (ID: $004C; Name: 'ROWS';
    Parameters: (RefVal, Unused, Unused)), (ID: $004D; Name: 'COLUMNS';
    Parameters: (RefVal, Unused, Unused)), (ID: $004E; Name: 'OFFSET';
    Parameters: (Ref, Val, Val)), (ID: $004F; Name: 'ABSREF';
    Parameters: (Val, Ref, Unused)), (ID: $0050; Name: 'RELREF';
    Parameters: (Ref, Ref, Unused)), (ID: $0051; Name: 'ARGUMENT';
    Parameters: (Val, RefVal, Ref)), (ID: $0054; Name: 'ERROR';
    Parameters: (Val, RefVal, Unused)), (ID: $0058; Name: 'SET.NAME';
    Parameters: (Val, RefVal, Unused)), (ID: $005A; Name: 'DEREF';
    Parameters: (Ref, Unused, Unused)), (ID: $005C; Name: 'SERIES';
    Parameters: (RefVal, Same, Same)), (ID: $0064; Name: 'CHOOSE';
    Parameters: (Val, RefVal, RefVal)), (ID: $0065; Name: 'HLOOKUP';
    Parameters: (Val, RefVal, RefVal)), (ID: $0066; Name: 'VLOOKUP';
    Parameters: (Val, RefVal, RefVal)), (ID: $0069; Name: 'ISREF';
    Parameters: (RefVal, Unused, Unused)), (ID: $006A; Name: 'GET.FORMULA';
    Parameters: (RefVal, Unused, Unused)), (ID: $006C; Name: 'SET.VALUE';
    Parameters: (Ref, Val, Unused)), (ID: $007D; Name: 'CELL';
    Parameters: (Val, Ref, Unused)), (ID: $0082; Name: 'T';
    Parameters: (RefVal, Unused, Unused)), (ID: $0083; Name: 'N';
    Parameters: (RefVal, Unused, Unused)), (ID: $0092; Name: 'REFTEXT';
    Parameters: (Ref, Val, Unused)), (ID: $0096; Name: 'CALL';
    Parameters: (Val, RefVal, RefVal)), (ID: $0098; Name: 'ADD.MENU';
    Parameters: (Val, RefVal, RefVal)), (ID: $0099; Name: 'ADD.COMMAND';
    Parameters: (Val, RefVal, RefVal)), (ID: $00A1; Name: 'DIALOG.BOX';
    Parameters: (RefVal, Unused, Unused)), (ID: $00A9; Name: 'COUNTA';
    Parameters: (RefVal, Same, Same)), (ID: $00AA; Name: 'CANCEL.KEY';
    Parameters: (Val, Ref, Unused)), (ID: $00AB; Name: 'FOR';
    Parameters: (Val, Same, Same)), (ID: $00B1; Name: 'POKE';
    Parameters: (Val, RefVal, RefVal)), (ID: $00B7; Name: 'PRODUCT';
    Parameters: (RefVal, Same, Same)), (ID: $00B9; Name: 'GET.CELL';
    Parameters: (Val, Ref, Unused)), (ID: $00BD; Name: 'DPRODUCT';
    Parameters: (Ref, RefVal, RefVal)), (ID: $00BF; Name: 'GET.NOTE';
    Parameters: (RefVal, Same, Same)), (ID: $00C0; Name: 'NOTE';
    Parameters: (Val, RefVal, RefVal)), (ID: $00C1; Name: 'STDEVP';
    Parameters: (RefVal, Same, Same)), (ID: $00C2; Name: 'VARP';
    Parameters: (RefVal, Same, Same)), (ID: $00C3; Name: 'DSTDEVP';
    Parameters: (Ref, RefVal, RefVal)), (ID: $00C4; Name: 'DVARP';
    Parameters: (Ref, RefVal, RefVal)), (ID: $00C7; Name: 'DCOUNTA';
    Parameters: (Ref, RefVal, RefVal)), (ID: $00D8; Name: 'RANK';
    Parameters: (Val, Ref, Val)), (ID: $00E2; Name: 'FOR.CELL';
    Parameters: (Val, RefVal, RefVal)), (ID: $00E3; Name: 'MEDIAN';
    Parameters: (RefVal, Same, Same)), (ID: $00EB; Name: 'DGET';
    Parameters: (Ref, RefVal, RefVal)), (ID: $00EC; Name: 'CREATE.OBJECT';
    Parameters: (Val, RefVal, Unused)), (ID: $00F1; Name: 'FORMULA.CONVERT';
    Parameters: (Val, RefVal, RefVal)), (ID: $00FC; Name: 'FREQUENCY';
    Parameters: (RefVal, Same, Same)), (ID: $010D; Name: 'AVEDEV';
    Parameters: (RefVal, Same, Same)), (ID: $013E; Name: 'DEVSQ';
    Parameters: (RefVal, Same, Same)), (ID: $013F; Name: 'GEOMEAN';
    Parameters: (RefVal, Same, Same)), (ID: $0140; Name: 'HARMEAN';
    Parameters: (RefVal, Same, Same)), (ID: $0141; Name: 'SUMSQ';
    Parameters: (RefVal, Same, Same)), (ID: $0142; Name: 'KURT';
    Parameters: (RefVal, Same, Same)), (ID: $0143; Name: 'SKEW';
    Parameters: (RefVal, Same, Same)), (ID: $0144; Name: 'ZTEST';
    Parameters: (RefVal, Val, Val)), (ID: $0145; Name: 'LARGE';
    Parameters: (RefVal, Val, Unused)), (ID: $0146; Name: 'SMALL';
    Parameters: (RefVal, Val, Unused)), (ID: $0147; Name: 'QUARTILE';
    Parameters: (RefVal, Val, Unused)), (ID: $0148; Name: 'PERCENTILE';
    Parameters: (RefVal, Val, Unused)), (ID: $0149; Name: 'PERCENTRANK';
    Parameters: (RefVal, Val, Val)), (ID: $014B; Name: 'TRIMMEAN';
    Parameters: (RefVal, Val, Unused)), (ID: $0158; Name: 'SUBTOTAL';
    Parameters: (Val, Ref, Ref)), (ID: $0159; Name: 'SUMIF';
    Parameters: (Ref, Val, Ref)), (ID: $015A; Name: 'COUNTIF';
    Parameters: (Ref, Val, Unused)), (ID: $015B; Name: 'COUNTBLANK';
    Parameters: (Ref, Unused, Unused)), (ID: $0168; Name: 'PHONETIC';
    Parameters: (Ref, Unused, Unused)), (ID: $0169; Name: 'AVERAGEA';
    Parameters: (RefVal, Same, Same)), (ID: $016A; Name: 'MAXA';
    Parameters: (RefVal, Same, Same)), (ID: $016B; Name: 'MINA';
    Parameters: (RefVal, Same, Same)), (ID: $016C; Name: 'STDEVPA';
    Parameters: (RefVal, Same, Same)), (ID: $016D; Name: 'VARPA';
    Parameters: (RefVal, Same, Same)), (ID: $016E; Name: 'STDEVA';
    Parameters: (RefVal, Same, Same)), (ID: $016F; Name: 'VARA';
    Parameters: (RefVal, Same, Same)));
...
function TdxXLSFormulaReader.ReadFormula(AFormula: TdxSpreadSheetCustomFormula;
...
procedure TdxXLSFormulaReader.ReadName(AName: TdxSpreadSheetDefinedName;
  ASize: Integer; ASource: PByteArray);
begin
  FFormula := TdxSpreadSheetCustomFormulaAccess
    (TdxSpreadSheetDefinedNameFormula.Create(AName));
  try
    FSize := ASize;
    FAnchorRow := 0;
    FAnchorColumn := 0;
    ...
    TdxSpreadSheetDefinedNameAccess(AName).Formula :=
      TdxSpreadSheetDefinedNameFormula(Formula);
  end;
end;

procedure TdxXLSFormulaReader.AddFormula(AInfo: TdxSpreadSheetFunctionInfo;
  AParams: TdxSpreadSheetFormulaToken);
var
...
procedure TdxXLSFormulaReader.AddReader(AToken: Byte;
  AReader: TdxXLSTokenReaderProc);
begin
...
function TdxXLSFormulaReader.CheckUnknownNameFunction
...
begin
  ...
  if AToken is TdxSpreadSheetFormulaDefinedNameToken then
    try
      ...
      AddToken(TdxSpreadSheetFormulaUnknownFunctionToken.Create
        (TdxSpreadSheetFormulaDefinedNameToken(AToken).Value));
      Result := Tokens.Last;
    finally
      AToken.Free;
    end;
...
procedure TdxXLSFormulaReader.DecodeAreaReference(ASrcRow, ASrcColumn, ASrcRow2,
  ASrcColumn2: Word; var ARow, AColumn, ARow2, AColumn2: Integer;
  var AAbsRow, AAbsColumn, AAbsRow2, AAbsColumn2: Boolean);
begin
  DecodeReference(ASrcRow, ASrcColumn, ARow, AColumn, AAbsRow, AAbsColumn);
  DecodeReference(ASrcRow2, ASrcColumn2, ARow2, AColumn2, AAbsRow2,
    AAbsColumn2);
  if (AColumn = 0) and (AColumn2 >= 255) then
    AColumn2 := MaxInt;
end;

procedure TdxXLSFormulaReader.DecodeAreaReference2(ASrcRow, ASrcColumn,
  ASrcRow2, ASrcColumn2: Word; var ARow, AColumn, ARow2, AColumn2: Integer;
  var AAbsRow, AAbsColumn, AAbsRow2, AAbsColumn2: Boolean);
begin
  DecodeReference2(ASrcRow, ASrcColumn, ARow, AColumn, AAbsRow, AAbsColumn);
  DecodeReference2(ASrcRow2, ASrcColumn2, ARow2, AColumn2, AAbsRow2,
    AAbsColumn2);
end;

procedure TdxXLSFormulaReader.DecodeReference(ASrcRow, ASrcColumn: Word;
  var ARow, AColumn: Integer; var AAbsRow, AAbsColumn: Boolean);
begin
...
procedure TdxXLSFormulaReader.DecodeReference2(ASrcRow, ASrcColumn: Word;
  var ARow, AColumn: Integer; var AAbsRow, AAbsColumn: Boolean);
begin
  ARow := SmallInt(ASrcRow);
...
function TdxXLSFormulaReader.ExtractParameters(ACount: Integer)
  : TdxSpreadSheetFormulaToken;
var
  I: Integer;
...
function TdxXLSFormulaReader.ExtractToken(AIndex: Integer = MaxInt)
  : TdxSpreadSheetFormulaToken;
begin
...
begin
  ...
  Arrays.Add(TPair<TdxSpreadSheetFormulaArrayToken, TSize>.Create
    (AArray, ASize));
  AddToken(AArray, 7);
end;
...
begin
  ...
  DecodeAreaReference(ATokens^[0], ATokens^[2], ATokens^[1], ATokens^[3], ARow,
    AColumn, ARow2, AColumn2, AbsRow, AbsColumn, AbsRow2, AbsColumn2);
...
begin
  ATokens := @Source^[Offset];
  DecodeAreaReference2(ATokens^[0], ATokens^[2], ATokens^[1], ATokens^[3], ARow,
    AColumn, ARow2, AColumn2, AbsRow, AbsColumn, AbsRow2, AbsColumn2);
  AddToken(TdxSpreadSheetFormulaAreaReferenceToken.Create
    (TdxSpreadSheetReference.Create(ARow, AbsRow),
    TdxSpreadSheetReference.Create(AColumn, AbsColumn),
...
begin
  ...
  DecodeAreaReference(ATokens^[1], ATokens^[3], ATokens^[2], ATokens^[4], ARow,
    AColumn, ARow2, AColumn2, AbsRow, AbsColumn, AbsRow2, AbsColumn2);
...
begin
  ...
  else if (Source^[FOffset] and $40) <> 0 then
  begin
    // ASpaceAttribute := Source^[1];
    // Add(TdxSpreadSheetFormulaAttributeToken.Create(Source^[FOffset + 2])); todo:
  end
  else if (Source^[FOffset] and $10) <> 0 then
    AddFormula(dxSpreadSheetFunctionsRepository.GetInfoByID(4),
      ExtractParameters(1));
  Inc(FOffset, 3);
end;
...
begin
  AddToken(TdxSpreadSheetFormulaBooleanValueToken.Create
    (Boolean(Source^[FOffset])));
  Inc(FOffset);
end;
...
begin
  AddToken(TdxSpreadSheetFormulaErrorValueToken.Create
    (XLSErrorToErrorCode(Source^[FOffset])));
  Inc(FOffset);
end;
...
begin
  AInfo := dxSpreadSheetFunctionsRepository.GetInfoByID
    (PWord(@Source[Offset])^);
  Inc(FOffset, 2);
...
begin
  ...
  Inc(FOffset);
  AddFormula(dxSpreadSheetFunctionsRepository.GetInfoByID
    (PWord(@Source^[FOffset])^ and $7FFF), ExtractParameters(ACount));
  Inc(FOffset, 2);
end;
...
begin
  ...
  begin
    ...
    TdxSpreadSheetFormulaToken.AddChild
      (CheckUnknownNameFunction(Tokens.Last), AParams);
  end
  else
    AddFormula(dxSpreadSheetFunctionsRepository.GetInfoByID(ID),
...
begin
  AddToken(TdxSpreadSheetFormulaIntegerValueToken.Create
    (PWord(@FSource[FOffset])^), 2);
end;
...
begin
  ...
  if AInfo = nil then
    AddToken(TdxSpreadSheetFormulaDefinedNameToken.Create(AName,
      Owner.SpreadSheet.DefinedNames))
  else
...
begin
  AddToken(TdxSpreadSheetFormulaFloatValueToken.Create
    (PDouble(@Source^[Offset])^), 8);
end;
...
begin
  AOperation := TdxSpreadSheetFormulaOperationToken.Create
    (TdxSpreadSheetFormulaOperation(CurrentToken - ptgAdd));
...
begin
  DecodeReference(PWordArray(@FSource^[Offset])^[0],
    PWordArray(@FSource^[Offset])^[1], ARow, AColumn, AAbsRow, AAbsColumn);
...
var
  ...
  AAbsRow, AAbsColumn: Boolean;
begin
  DecodeReference2(PWordArray(@FSource^[Offset])^[0],
    PWordArray(@FSource^[Offset])^[1], ARow, AColumn, AAbsRow, AAbsColumn);
  AddToken(TdxSpreadSheetFormulaReferenceToken.Create
    (TdxSpreadSheetReference.Create(ARow, AAbsRow),
    TdxSpreadSheetReference.Create(AColumn, AAbsColumn)));
  ...
  begin
    ...
    begin
      ...
      if ARow < ASize.cy then
        TdxSpreadSheetFormulaToken.AddChild(AArray,
...
constructor TdxXLSFormulaWriter.Create(AOwner: TdxSpreadSheetXLSWriter;
  AWriteSize: Boolean = True);
begin
  inherited Create;
  FOwner := AOwner;
...
procedure TdxXLSFormulaWriter.WriteFormula
  (AFormula: TdxSpreadSheetCustomFormula; AAbsolute: Boolean);
begin
...
procedure TdxXLSFormulaWriter.WriteFormula
  (AFormula: TdxSpreadSheetCustomFormula; AAbsolute: Boolean;
  AAnchorColumn, AAnchorRow: Integer);
begin
  FFormula := TdxSpreadSheetCustomFormulaAccess(AFormula);
  FAbsolute := AAbsolute;
  ...
  begin
    ...
    Writer.XLS_WriteSimpleString(dxSpreadSheetFormulaExcludeEqualSymbol
      (AFormula.AsText), 1);
  end
  else
...
procedure TdxXLSFormulaWriter.WriteNameFormula
...
procedure TdxXLSFormulaWriter.DoWriteTokens
  (ATokens: TdxSpreadSheetFormulaToken);
var
  AToken: TdxSpreadSheetFormulaToken;
...
begin
  ...
  Writers.Add(TdxSpreadSheetFormulaUnknownFunctionToken,
    WriteUnknownFunctionToken);
...
procedure TdxXLSFormulaWriter.WriteAttributeToken
  (AToken: TdxSpreadSheetFormulaToken);
begin
  // TdxXLSFormulaWriter.
end;

procedure TdxXLSFormulaWriter.WriteArea3DToken
  (AToken: TdxSpreadSheetFormulaToken);
var
  AData: TObject;
  AIndex, ARow, AColumn, ARow2, AColumn2: Word;
begin
  AData := TdxSpreadSheet3DReferenceLink
    (TdxSpreadSheetFormula3DAreaReferenceToken(AToken).Link).Data;
  if TdxSpreadSheetFormula3DReferenceToken(AToken).IsError or
    TdxSpreadSheetInvalidObject.IsInvalid(AData) then
  begin
    AIndex := 0;
  ...
  EncodeReference(TdxSpreadSheetFormulaAreaReferenceTokenAccess(AToken).FRow,
    TdxSpreadSheetFormulaAreaReferenceTokenAccess(AToken).FColumn,
    ARow, AColumn);
  EncodeReference(TdxSpreadSheetFormulaAreaReferenceTokenAccess(AToken).FRow2,
    TdxSpreadSheetFormulaAreaReferenceTokenAccess(AToken).FColumn2, ARow2,
    AColumn2);
...
procedure TdxXLSFormulaWriter.WriteAreaToken
  (AToken: TdxSpreadSheetFormulaToken);
var
...
begin
  ...
  EncodeReference(TdxSpreadSheetFormulaAreaReferenceTokenAccess(AToken).FRow,
    TdxSpreadSheetFormulaAreaReferenceTokenAccess(AToken).FColumn,
    ARow, AColumn);
  if TdxSpreadSheetFormulaAreaReferenceTokenAccess(AToken)
    .FColumn.IsAllItems and (AColumn and $FF = $FF) then
...
procedure TdxXLSFormulaWriter.WriteBooleanToken
  (AToken: TdxSpreadSheetFormulaToken);
begin
...
procedure TdxXLSFormulaWriter.WriteCurrencyToken
  (AToken: TdxSpreadSheetFormulaToken);
begin
  WriteNumericToken(TdxSpreadSheetFormulaCurrencyValueToken(AToken).Value);
end;

procedure TdxXLSFormulaWriter.WriteDateTimeToken
  (AToken: TdxSpreadSheetFormulaToken);
begin
  WriteNumericToken(TdxSpreadSheetFormulaDateTimeValueToken(AToken).Value);
end;

procedure TdxXLSFormulaWriter.WriteErrorToken
  (AToken: TdxSpreadSheetFormulaToken);
begin
  Writer.WriteByte(ptgErr);
  Writer.WriteByte(ErrorCodeToErrorIndex[TdxSpreadSheetFormulaErrorValueToken
    (AToken).ErrorCode]);
end;

procedure TdxXLSFormulaWriter.WriteFloatToken
  (AToken: TdxSpreadSheetFormulaToken);
begin
  WriteNumericToken(TdxSpreadSheetFormulaFloatValueToken(AToken).Value);
end;

procedure TdxXLSFormulaWriter.WriteFunctionToken
  (AToken: TdxSpreadSheetFormulaToken);
...
begin
  ...
  if IsFixedParamsCount(TdxSpreadSheetFormulaFunctionToken(AToken)
    .Information.ParamInfo) then
  begin
...
procedure TdxXLSFormulaWriter.WriteUnknownFunctionToken
  (AToken: TdxSpreadSheetFormulaToken);
begin
  //
...
procedure TdxXLSFormulaWriter.WriteIntegerToken
  (AToken: TdxSpreadSheetFormulaToken);
begin
  if InRange(TdxSpreadSheetFormulaIntegerValueToken(AToken).Value, 0, $FFFF)
  then
  begin
...
procedure TdxXLSFormulaWriter.WriteNameToken
  (AToken: TdxSpreadSheetFormulaToken);
var
  AName: TdxSpreadSheetDefinedName;
begin
  ...
  else if not(AToken.Parent is TdxSpreadSheetFormulaOperationToken) and
...
procedure TdxXLSFormulaWriter.WriteNullToken
  (AToken: TdxSpreadSheetFormulaToken);
begin
  Writer.WriteByte(ptgMissArg);
end;

procedure TdxXLSFormulaWriter.WriteOperationToken
  (AToken: TdxSpreadSheetFormulaToken);
begin
  Writer.WriteByte(Byte(TdxSpreadSheetFormulaOperationToken(AToken).Operation)
    + ptgAdd);
end;

procedure TdxXLSFormulaWriter.WriteParenthesesToken
  (AToken: TdxSpreadSheetFormulaToken);
begin
  Writer.WriteByte(ptgParen);
end;

procedure TdxXLSFormulaWriter.WriteRef3DToken
  (AToken: TdxSpreadSheetFormulaToken);
var
...
begin
  AIndex := 0;
  ASheet := TdxSpreadSheetTableView
    (TdxSpreadSheet3DReferenceLink(TdxSpreadSheetFormula3DReferenceToken(AToken)
    .Link).Data);
  if (ASheet <> nil) and not TdxSpreadSheetInvalidObject.IsInvalid(ASheet) then
    AIndex := ASheet.Index;
  Writer.WriteByte(ValidateToken(ATokens[TdxSpreadSheetFormula3DReferenceToken
    (AToken).IsError or TdxSpreadSheetInvalidObject.IsInvalid(ASheet)]));
...
begin
  if TdxSpreadSheetFormulaReferenceTokenAccess(AToken).IsError then
    Writer.WriteByte
      (ValidateToken(ATokens[TdxSpreadSheetFormulaReferenceTokenAccess(AToken)
      .IsError]))
  else
    Writer.WriteByte(ATokens[TdxSpreadSheetFormulaReferenceTokenAccess(AToken)
      .IsError]);
  EncodeReference(TdxSpreadSheetFormulaReferenceTokenAccess(AToken).FRow,
    TdxSpreadSheetFormulaReferenceTokenAccess(AToken).FColumn, ARow, AColumn);
  Writer.WriteWord(ARow);
...
procedure TdxXLSFormulaWriter.WriteRefNToken
  (AToken: TdxSpreadSheetFormulaToken);
var
  ARow, AColumn: Integer;
const
...
procedure TdxXLSFormulaWriter.WriteStringToken
  (AToken: TdxSpreadSheetFormulaToken);
begin
  Writer.WriteByte(ptgStr);
  Writer.XLS_WriteSimpleString(TdxSpreadSheetFormulaStringValueToken(AToken)
    .Value, 1);
end;

procedure TdxXLSFormulaWriter.EncodeReference(ARefRow,
  ARefColumn: TdxSpreadSheetReference; var ARow, AColumn: Word);
begin
  ARow := Word(-1);
  AColumn := Word(255);
...
procedure TdxXLSFormulaWriter.EncodeReferenceN(ARefRow,
  ARefColumn: TdxSpreadSheetReference; var ARow, AColumn: Integer);
begin
  ARow := Word(-1);
  AColumn := Word(255);
  if not ARefRow.IsAllItems then
  ...
  if not ARefColumn.IsAllItems then
    AColumn := Byte(Shortint(ARefColumn.ActualValue(FAnchorColumn) -
      FAnchorColumn)) or $C000;
  if not(ARefRow.IsAbsolute or FAbsolute) then
...
function TdxXLSFormulaWriter.GetAcceptedDataTypes
  : TdxXLSFormulaParameterDataTypes;
...
begin
  ...
  while AToken <> nil do
  begin
    if (AToken.Parent <> nil) and (AToken.Parent is TdxSpreadSheetListToken)
    then
  ...
  Result := Repository.GetFormulaParameterType(AOwnerFormula.Information.Token,
    ATokenIndex);
end;

function TdxXLSFormulaWriter.ValidateToken(AToken: Byte): Byte;
const
  DefaultTypes: array [Boolean] of TdxXLSFormulaParameterDataTypes =
    ([fpdtReference], [fpdtValue]);
var
...
begin
  ...
  if fpdtArray in ATypes then
    ADataType := fpdtArray
  else if ATypes = [fpdtValue] then
    ADataType := fpdtValue;

  if (AToken in [ptgName, ptgFuncVar]) and
    not Formula.IsLinkedToCell { and (AcceptedDataTypes = [fpdtAuto]) } then
    ADataType := fpdtArray;
...
begin
  FDictionary :=
    TDictionary<Integer, PdxXLSFunctionParametersDefinition>.Create;
...
function TdxXLSFunctionsRepository.GetFormulaParameterType(AID, AIndex: Integer)
  : TdxXLSFormulaParameterDataTypes;
var
...
procedure TdxXLSFunctionsRepository.PrepareDefinition
  (AInfo: PdxXLSFunctionParametersDefinition);
var
  I: Integer;
