...
{$IFDEF DELPHI16}
  UITypes,
{$ENDIF}
  Types, Windows, Classes, Graphics, SysUtils, cxClasses, cxGraphics,
  cxLookAndFeels,
...
type
  ...
  TdxSkinFormIcon = (sfiMenu, sfiHelp, sfiMinimize, sfiMaximize, sfiRestore,
    sfiClose);
  ...
  public
    ...
    function DrawScaled(DC: HDC; const R: TRect; AImageIndex: Integer;
      AState: TdxSkinElementState; AScaleFactor: TdxScaleFactor)
      : Boolean; overload;
    function Draw(DC: HDC; const R: TRect; AImageIndex: Integer;
      AState: TdxSkinElementState): Boolean; overload;
    function DrawScaled(DC: HDC; const R: TRect; AState: TdxSkinElementState;
      AScaleFactor: TdxScaleFactor): Boolean; overload;
    function Draw(DC: HDC; const R: TRect; AState: TdxSkinElementState)
      : Boolean; overload;
  ...
  public
    class function CalculateCaptionButtonSize(ACaptionHeight: Integer;
      AElement: TdxSkinElement): TSize;
    class function IsAlternateImageSetUsed(AElement: TdxSkinElement;
  ...
  protected
    ...
    function CreateBlankElement(AGroup: TdxSkinControlGroup;
      const AName: string): TdxSkinElement;
    function CreateBlankGroup(const AName: string): TdxSkinControlGroup;
    function GetAlphaColorValueByName(AElement: TdxSkinPersistent;
      const AName: string): TdxAlphaColor;
    function GetBoolPropertyByName(AElement: TdxSkinPersistent;
      const AName: string): TdxSkinBooleanProperty;
    function GetColorByName(AElement: TdxSkinPersistent; const AName: string)
      : TdxSkinColor; overload;
    function GetColorByName(const AName: string): TdxSkinColor; overload;
    function GetColorValueByName(AElement: TdxSkinPersistent;
      const AName: string): TColor;
    function GetElementByName(AGroup: TdxSkinControlGroup; const AName: string;
      ACreateIfAbsent: Boolean = True): TdxSkinElement;
    function GetGroupByName(const AName: string): TdxSkinControlGroup;
    function GetIntegerPropertyByName(AElement: TdxSkinPersistent;
      const AName: string): TdxSkinIntegerProperty;
    function GetPropertyByName(AElement: TdxSkinPersistent; const AName: string)
      : TdxSkinProperty;
  ...
  public
    ...
    // BreadcrumbEdit
    BreadcrumbEditBackgroundColors: array [TdxBreadcrumbEditState]
      of TdxSkinColor;
    ...
    // GroupBox
    GroupBoxCaptionElements: array [TcxGroupBoxCaptionPosition]
      of TdxSkinElement;
    GroupBoxCaptionTailSizes: array [TcxGroupBoxCaptionPosition]
      of TdxSkinIntegerProperty;
    GroupBoxCaptionTextPadding: array [TcxGroupBoxCaptionPosition]
      of TdxSkinIntegerProperty;
    ...
    LayoutViewRecordCaptionElements: array [TcxGroupBoxCaptionPosition]
      of TdxSkinElement;
    LayoutViewRecordCaptionTailSizes: array [TcxGroupBoxCaptionPosition]
      of TdxSkinIntegerProperty;
    LayoutViewRecordCaptionTextPadding: array [TcxGroupBoxCaptionPosition]
      of TdxSkinIntegerProperty;
    LayoutViewRecordElements: array [TcxGroupBoxCaptionPosition]
      of TdxSkinElement;
    ...
    SchedulerResourceColors: array [0 .. dxSkinsSchedulerResourceColorsCount -
      1] of TdxSkinColor;
    ...
    RibbonQATCustomizeButtonOutsizeQAT: array [Boolean]
      of TdxSkinBooleanProperty;
    RibbonQATIndentBeforeCustomizeButton: array [Boolean]
      of TdxSkinIntegerProperty;
...
class function TdxSkinElementHelper.CalculateCaptionButtonSize
  (ACaptionHeight: Integer; AElement: TdxSkinElement): TSize;
...
class function TdxSkinElementHelper.IsAlternateImageSetUsed
  (AElement: TdxSkinElement; AImageIndex: Integer;
  AState: TdxSkinElementState): Boolean;
var
  AAttributes: TdxSkinAlternateImageAttributes;
begin
  Result := TdxSkinElementAccess(AElement).CanUseAlternateImageSet(AImageIndex,
    AState, dxGpIsDoubleBufferedNeeded(cxScreenCanvas.Handle), AAttributes);
...
function TdxSkinInfo.GetPropertyByName(AElement: TdxSkinPersistent;
  const AName: string): TdxSkinProperty;
begin
...
function TdxSkinInfo.GetColorByName(AElement: TdxSkinPersistent;
...
function TdxSkinInfo.GetColorValueByName(AElement: TdxSkinPersistent;
  const AName: string): TColor;
var
  AColor: TdxSkinColor;
begin
...
function TdxSkinInfo.GetAlphaColorValueByName(AElement: TdxSkinPersistent;
  const AName: string): TdxAlphaColor;
begin
...
function TdxSkinInfo.GetBoolPropertyByName(AElement: TdxSkinPersistent;
  const AName: string): TdxSkinBooleanProperty;
begin
  Result := GetPropertyByName(AElement, AName) as TdxSkinBooleanProperty;
end;

function TdxSkinInfo.GetIntegerPropertyByName(AElement: TdxSkinPersistent;
  const AName: string): TdxSkinIntegerProperty;
begin
...
begin
  ...
  if AObject <> nil then
  begin
    AProperty := AObject.GetPropertyByName(APropertyName)
      as TdxSkinIntegerProperty;
...
begin
  ...
  AlertWindowButtonGlyphs := GetElementByName(GroupCommon,
    sdxAlertWindowButtonGlyphs);
  AlertWindowCaption := GetElementByName(GroupCommon, sdxAlertWindowCaption);
  AlertWindowCornerRadius := GetIntegerPropertyValue(AlertWindow,
    sdxAlertWindowCornerRadius);
  AlertWindowNavigationPanel := GetElementByName(GroupCommon,
    sdxAlertWindowNavigationPanel);
  AlertWindowNavigationPanelButton := GetElementByName(GroupCommon,
    sdxAlertWindowNavigationPanelButton);
end;
...
begin
  ...
  BarCustomizeVertical := GetElementByName(GroupBars,
    sdxBarsBarCustomizeVertical);
  ...
  BarVerticalSeparator := GetElementByName(GroupBars,
    sdxBarsBarVerticalSeparator);
  ...
  MainMenuCustomize := GetElementByName(GroupBars,
    sdxBarsMainMenuCustomize, False);
  MainMenuDrag := GetElementByName(GroupBars, sdxBarsMainMenuDrag, False);
  MainMenuLinkSelected := GetElementByName(GroupBars,
    sdxBarsMainMenuLinkSelected);
  ...
  PopupMenuExpandButton := GetElementByName(GroupBars,
    sdxBarsPopupMenuExpandButton);
  PopupMenuLinkSelected := GetElementByName(GroupBars,
    sdxBarsPopupMenuLinkSelected);
  ...
  PopupMenuSideStripNonRecent := GetElementByName(GroupBars,
    sdxBarsPopupMenuSideStripNonRecent);
  PopupMenuSplitButton := GetElementByName(GroupBars,
    sdxBarsPopupMenuDropDownButtonLabel);
  PopupMenuSplitButton2 := GetElementByName(GroupBars,
...
begin
  BreadcrumbEditButton := GetElementByName(GroupEditors,
    sdxBreadcrumbEditButton);
  BreadcrumbEditButtonsAreaSeparator := GetElementByName(GroupEditors,
    sdxBreadcrumbEditButtonsAreaSeparator);
  BreadcrumbEditDropDownButton := GetElementByName(GroupEditors,
    sdxBreadcrumbEditDropDownButton);
  BreadcrumbEditNodeButton := GetElementByName(GroupEditors,
    sdxBreadcrumbEditNodeButton);
  BreadcrumbEditNodeSplitButtonLeft := GetElementByName(GroupEditors,
    sdxBreadcrumbEditNodeSplitButtonLeft);
  BreadcrumbEditNodeSplitButtonRight := GetElementByName(GroupEditors,
    sdxBreadcrumbEditNodeSplitButtonRight);
  BreadcrumbEditProgressChunk := GetElementByName(GroupEditors,
    sdxBreadcrumbEditProgressChunk);
  BreadcrumbEditProgressChunkOverlay := GetElementByName(GroupEditors,
    sdxBreadcrumbEditProgressChunkOverlay);
  BreadcrumbEditProgressChunkPadding := GetPropertyByName(GroupEditors,
    sdxBreadcrumbEditProgressChunkPadding) as TdxSkinRectProperty;
  for AIndex := Low(TdxBreadcrumbEditState) to High(TdxBreadcrumbEditState) do
  begin
    BreadcrumbEditBackgroundColors[AIndex] := GetColorByName(GroupEditors,
      BreadcrumbEditBackgroundColorsMap[AIndex]);
    BreadcrumbEditBordersColors[AIndex] := GetColorByName(GroupEditors,
      BreadcrumbEditBordersColorsMap[AIndex]);
  end;
  AProperty := GetBoolPropertyByName(BreadcrumbEditButton,
    sdxEditorButtonMergeBorders);
...
begin
  ...
  if ButtonElements <> nil then
    ButtonDisabled := GetColorByName(ButtonElements,
      sdxSkinsButtonDisabledTextColor);
...
begin
  for AType := Low(TcxCalcButtonKind) to High(TcxCalcButtonKind) do
    CalcEditButtonTextColors[AType] := GetColorByName(GroupEditors,
      CalcEditTextColorsMap[AType]);
end;

procedure TdxSkinInfo.InitializeCalendarElements;
begin
  CalendarNavigationButton := GetElementByName(GroupEditors,
    sdxSkinsCalendarNavigationButton);
  CalendarDayTextColor := GetColorByName(GroupEditors,
    sdxSkinsCalendarDayTextColor);
  CalendarHolidayTextColor := GetColorByName(GroupEditors,
    sdxSkinsCalendarHolidayTextColor);
  CalendarInactiveDayTextColor := GetColorByName(GroupEditors,
    sdxSkinsCalendarInactiveDayTextColor);
  CalendarSelectedDayTextColor := GetColorByName(GroupEditors,
    sdxSkinsCalendarSelectedDayTextColor);
  CalendarSelectedDayColor := GetColorByName(GroupEditors,
    sdxSkinsCalendarSelectedDayColor);
  CalendarSeparatorColor := GetColorByName(GroupEditors,
    sdxSkinsCalendarSeparatorColor);
  CalendarTodayFrameColor := GetColorByName(GroupEditors,
    sdxSkinsCalendarTodayFrameColor);
  CalendarTodayTextColor := GetColorByName(GroupEditors,
    sdxSkinsCalendarTodayTextColor);
end;
...
begin
  BarDisabledTextColor := GetColorByName(GroupBars,
    sdxSkinsBarDisabledTextColor);
  DockControlTabTextColor[False] := GetColorByName(GroupDocking,
    sdxSkinsTabTextColor);
  DockControlTabTextColor[True] := GetColorByName(GroupDocking,
    sdxSkinsTabTextColorActive);
  SchedulerNavigatorColor := GetColorByName(GroupScheduler,
    sdxSkinsSchedulerNavigatorColor);
  ...
  TabTextColorDisabled := GetColorByName(PageControlHeader,
    sdxTextColorDisabled);
  TabTextColorHot := GetColorByName(PageControlHeader, sdxTextColorHot);

  HyperLinkTextColor := GetColorByName(GroupEditors,
    sdxSkinsEditorHyperLinkTextColor);
  for AKind := Low(TcxEditStateColorKind) to High(TcxEditStateColorKind) do
  begin
    EditorTextColors[AKind] := GetColorByName(GroupEditors,
      EditTextColorsMap[AKind]);
    EditorBackgroundColors[AKind] := GetColorByName(GroupEditors,
      EditBackgroundColorsMap[AKind]);
  end;

  ContainerBorderColor := GetColorByName(sdxSkinsContainerBorderColor);
  ContainerHighlightBorderColor :=
    GetColorByName(sdxSkinsContainerHighlightBorderColor);
  ...
  DockControlHideBarTextColor[False] :=
    GetColorByName(sdxSkinsDCHiddenBarTextColor);
  DockControlHideBarTextColor[True] :=
    GetColorByName(sdxSkinsDCHiddenBarTextHotColor);
  HeaderBackgroundColor := GetColorByName(sdxSkinsHeaderBackgroundColor);
  HeaderBackgroundTextColor :=
    GetColorByName(sdxSkinsHeaderBackgroundTextColor);
  ...
  SpreadSheetContentTextColor :=
    GetColorByName(sdxSkinsSpreadSheetContentTextColor);
  SpreadSheetFrozenPaneSeparatorColor :=
    GetColorByName(sdxSkinsSpreadSheetFrozenPaneSeparatorColor);
  SpreadSheetSelectionColor :=
    GetColorByName(sdxSkinsSpreadSheetSelectionColor);
  SpreadSheetGroupLineColor :=
    GetColorByName(sdxSkinsSpreadSheetGroupLineColor);

  GridLikeControlContentColor :=
    GetColorByName(sdxSkinsGridLikeControlContentColor);
  GridLikeControlContentEvenColor :=
    GetColorByName(sdxSkinsGridLikeControlContentEvenColor);
  GridLikeControlContentOddColor :=
    GetColorByName(sdxSkinsGridLikeControlContentOddColor);
  GridLikeControlContentTextColor :=
    GetColorByName(sdxSkinsGridLikeControlContentTextColor);
  GridLikeControlBackgroundColor :=
    GetColorByName(sdxSkinsGridLikeControlBackgroundColor);
  ...
  FilterControlBackColor := GetColorByName(GroupCommon,
    sdxFilterControlBackColor);
end;

procedure TdxSkinInfo.InitializeDockControlElements;
begin
  DockControlHideBarButtons := GetElementByName(GroupDocking,
    sdxDockCtrlTabHeaderAutoHideBar);
  DockControlTabButtonHorz := GetElementByName(GroupDocking,
    sdxDockCtrlTabButtonHorz);
  DockControlTabButtonVert := GetElementByName(GroupDocking,
    sdxDockCtrlTabButtonVert);
  DockControlTabHeader := GetElementByName(GroupDocking, sdxDockCtrlTabHeader);
  DockControlTabHeaderBackground := GetElementByName(GroupDocking,
    sdxDockCtrlTabHeaderBackground);
  DockControlTabHeaderCloseButton := GetElementByName(GroupDocking,
    sdxDockCtrlTabHeaderCloseButton);
  DockControlTabHeaderLine := GetElementByName(GroupDocking,
    sdxDockCtrlTabHeaderLine);
  DockControlWindowButton := GetElementByName(GroupDocking,
    sdxDockCtrlWindowButton);
  DockControlWindowButtonGlyphs := GetElementByName(GroupDocking,
    sdxDockCtrlWindowGlyphs);
  ...
  DockControlHideBarLeft := GetElementByName(GroupDocking,
    sdxDockCtrlAutoHideBarLeft);
  DockControlHideBarRight := GetElementByName(GroupDocking,
    sdxDockCtrlAutoHideBarRight);
  DockControlHideBarBottom := GetElementByName(GroupDocking,
    sdxDockCtrlAutoHideBarBottom);
  ...
  DockControlCaptionNonFocusedTextColor :=
    GetColorValueByName(DockControlCaption,
    sdxDockCtrlInactiveCaptionTextColor);

  FillChar(DockControlIndents, SizeOf(DockControlIndents), 0);
  if GroupDocking <> nil then
  begin
    DockControlIndents[0] := GetIntegerPropertyValue(GroupDocking,
      sdxDCActiveTabHeaderDownGrow);
    DockControlIndents[1] := GetIntegerPropertyValue(GroupDocking,
      sdxDCActiveTabHeaderHGrow);
    DockControlIndents[2] := GetIntegerPropertyValue(GroupDocking,
      sdxDCActiveTabHeaderUpGrow);
  end;
end;

procedure TdxSkinInfo.InitializeEditButtonElements;
const
  SliderArrowNames: array [TcxArrowDirection] of string = (sdxSliderArrowTop,
    sdxSliderArrowBottom, sdxSliderArrowLeft, sdxSliderArrowRight);
var
...
begin
  ...
  for AKind := Low(TcxEditBtnKind) to High(TcxEditBtnKind) do
    EditButtonGlyphs[AKind] := GetElementByName(GroupEditors,
      EditButtonsMap[AKind]);
  EditButtonSearchGlyph := GetElementByName(GroupEditors, sdxSearchButtonGlyph);
  AProperty := GetBoolPropertyByName(EditButtonElements[False],
    sdxEditorButtonMergeBorders);
  ...
  for AArrowDirection := Low(TcxArrowDirection) to High(TcxArrowDirection) do
    SliderArrow[AArrowDirection] := GetElementByName(GroupEditors,
      SliderArrowNames[AArrowDirection]);
...
begin
  FilterBoolOperatorBackground := GetElementByName(GroupCommon,
    sdxFilterBoolOperatorBackground);
  FilterItemCaptionBackground := GetElementByName(GroupCommon,
    sdxFilterItemCaptionBackground);
  FilterOperatorBackground := GetElementByName(GroupCommon,
    sdxFilterOperatorBackground);
  ...
  FilterValueBackground := GetElementByName(GroupCommon,
    sdxFilterValueBackground);
end;
...
procedure TdxSkinInfo.InitializeFormElements;
  ...
  begin
    ...
    FormIcons[False, sfiClose] := GetElementByName(GroupForm,
      sdxSmallFormButtonClose);
    FormIcons[True, sfiClose] := GetElementByName(GroupForm,
      sdxFormButtonClose);
    FormIcons[True, sfiHelp] := GetElementByName(GroupForm, sdxFormButtonHelp);
    FormIcons[True, sfiMaximize] := GetElementByName(GroupForm,
      sdxFormButtonMaximize);
    FormIcons[True, sfiMinimize] := GetElementByName(GroupForm,
      sdxFormButtonMinimize);
    FormIcons[True, sfiRestore] := GetElementByName(GroupForm,
      sdxFormButtonRestore);
  end;
  ...
  begin
    for AStandard := False to True do
      for ASide := Low(TcxBorder) to High(TcxBorder) do
        FormFrames[AStandard, ASide] := GetElementByName(GroupForm,
...
begin
  ...
  FormCaptionFontDelta := Max(1, GetIntegerPropertyValue(FormFrames[True, bTop],
    sdxCaptionFontDelta));
  FormCaptionFontIsBold := GetBoolPropertyByName(FormFrames[True, bTop],
    sdxCaptionFontBold);
  FormSupportsNavigationControlExtensionToFormCaption :=
    GetBoolPropertyByName(Skin,
    sdxSupportsNavigationControlExtensionToFormCaption);
end;
...
const
  ...
  GroupBoxCaptionNamesMap: array [TcxGroupBoxCaptionPosition]
    of string = (sdxGroupPanelCaptionTop, sdxGroupPanelCaptionBottom,
...
begin
  ...
  GroupButtonExpandGlyph := GetElementByName(GroupCommon,
    sdxGroupButtonExpandGlyph);
  for APosition := Low(TcxGroupBoxCaptionPosition)
    to High(TcxGroupBoxCaptionPosition) do
  begin
    GroupBoxElements[APosition] := GetElementByName(GroupCommon,
      GroupBoxNamesMap[APosition]);
    GroupBoxCaptionElements[APosition] := GetElementByName(GroupCommon,
      GroupBoxCaptionNamesMap[APosition], APosition <> cxgpCenter);
    GroupBoxCaptionTailSizes[APosition] :=
      GetIntegerPropertyByName(GroupBoxCaptionElements[APosition],
      sdxGroupPanelCaptionTailSize);
    GroupBoxCaptionTextPadding[APosition] :=
      GetIntegerPropertyByName(GroupBoxCaptionElements[APosition],
      sdxGroupPanelCaptionTextPadding);
  end;
end;
...
begin
  ...
  GalleryItemGlyphFrame := GetElementByName(GroupEditors,
    sdxGalleryItemGlyphFrame);
end;

procedure TdxSkinInfo.InitializeGanttElements;
begin
  GanttDependencyEditPointLeft := GetElementByName(GroupGantt,
    sdxGanttDependencyEditPointLeft);
  GanttDependencyEditPointRight := GetElementByName(GroupGantt,
    sdxGanttDependencyEditPointRight);
  ...
  GanttSummaryTaskProgress := GetElementByName(GroupGantt,
    sdxGanttSummaryTaskProgress);
  ...
  GanttTaskTextLabelHorizontalIndent := GetIntegerPropertyByName
    (GanttTaskTextLabel, sdxGanttTaskTextLabelHorizontalIndent);
end;
...
begin
  ...
  GridGroupRowStyleOffice11ContentColor := GetColorByName(AGroupRow,
    sdxGridGroupRowStyleOffice11ContentColor);
  GridGroupRowStyleOffice11SeparatorColor :=
    GetColorByName(AGroupRow, sdxGridGroupRowStyleOffice11SeparatorColor);
  GridGroupRowStyleOffice11TextColor := GetColorByName(AGroupRow,
    sdxGridGroupRowStyleOffice11TextColor);

  GridWinExplorerViewGroup := GetElementByName(GroupGrid,
    sdxGridWinExplorerViewGroup);
  GridWinExplorerViewGroupCaptionLine := GetElementByName(GroupGrid,
    sdxGridWinExplorerViewGroupCaptionLine);
  GridWinExplorerViewGroupExpandButton := GetElementByName(GroupGrid,
    sdxGridWinExplorerViewGroupExpandButton);
  GridWinExplorerViewRecord := GetElementByName(GroupGrid,
    sdxGridWinExplorerViewRecord);
end;

procedure TdxSkinInfo.InitializeHamburgerMenuElements;
begin
  HamburgerMenuHamburgerButton := GetElementByName(GroupHamburgerMenu,
    sdxHamburgerMenuHamburgerButton);
  HamburgerMenuBackground := GetElementByName(GroupHamburgerMenu,
    sdxHamburgerMenuBackground);
  HamburgerMenuChildGroup := GetElementByName(GroupHamburgerMenu,
    sdxHamburgerMenuChildGroup);
  HamburgerMenuChildGroupCloseButton := GetElementByName(GroupHamburgerMenu,
    sdxHamburgerMenuChildGroupCloseButton);
  HamburgerMenuChildGroupOpenButton := GetElementByName(GroupHamburgerMenu,
    sdxHamburgerMenuChildGroupOpenButton);
  HamburgerMenuChildItemOffset := GetIntegerPropertyByName(GroupHamburgerMenu,
    sdxHamburgerMenuChildItemOffset);
  HamburgerMenuDistanceBetweenGroups := GetIntegerPropertyByName
    (GroupHamburgerMenu, sdxHamburgerMenuDistanceBetweenGroups);
  HamburgerMenuGroup := GetElementByName(GroupHamburgerMenu,
    sdxHamburgerMenuGroup);
  HamburgerMenuGroupCloseButton := GetElementByName(GroupHamburgerMenu,
    sdxHamburgerMenuGroupCloseButton);
  HamburgerMenuGroupOpenButton := GetElementByName(GroupHamburgerMenu,
    sdxHamburgerMenuGroupOpenButton);
  HamburgerMenuItem := GetElementByName(GroupHamburgerMenu,
    sdxHamburgerMenuItem);
  HamburgerMenuNavPaneBackground := GetElementByName(GroupHamburgerMenu,
    sdxHamburgerMenuNavPaneBackground);
  HamburgerMenuNavPaneItem := GetElementByName(GroupHamburgerMenu,
    sdxHamburgerMenuNavPaneItem);
  HamburgerMenuNavPaneExpandButton := GetElementByName(GroupHamburgerMenu,
    sdxHamburgerMenuNavPaneExpandButton);
  HamburgerMenuScrollDownButton := GetElementByName(GroupHamburgerMenu,
    sdxHamburgerMenuScrollDownButton);
  HamburgerMenuScrollUpButton := GetElementByName(GroupHamburgerMenu,
    sdxHamburgerMenuScrollUpButton);
end;
...
begin
  NavBarAccordionControlBackground := GetElementByName(GroupNavBar,
    sdxNavBarAccordionControlBackground);
  NavBarAccordionControlChildItemOffset := GetIntegerPropertyByName(GroupNavBar,
    sdxNavBarAccordionControlChildItemOffset);
  NavBarAccordionControlContentContainerPadding :=
    GetPropertyByName(GroupNavBar,
    sdxNavBarAccordionControlContentContainerPadding) as TdxSkinRectProperty;
  NavBarAccordionControlDistanceBetweenRootGroups :=
    GetIntegerPropertyByName(GroupNavBar,
    sdxNavBarAccordionControlDistanceBetweenRootGroups);
  NavBarAccordionControlGroup := GetElementByName(GroupNavBar,
    sdxNavBarAccordionControlGroup);
  NavBarAccordionControlGroupCloseButton := GetElementByName(GroupNavBar,
    sdxNavBarAccordionControlGroupCloseButton);
  NavBarAccordionControlGroupOpenButton := GetElementByName(GroupNavBar,
    sdxNavBarAccordionControlGroupOpenButton);
  NavBarAccordionControlItem := GetElementByName(GroupNavBar,
    sdxNavBarAccordionControlItem);
  NavBarAccordionControlRootGroup := GetElementByName(GroupNavBar,
    sdxNavBarAccordionControlRootGroup);
  NavBarAccordionControlRootGroupCloseButton := GetElementByName(GroupNavBar,
    sdxNavBarAccordionControlRootGroupCloseButton);
  NavBarAccordionControlRootGroupOpenButton := GetElementByName(GroupNavBar,
    sdxNavBarAccordionControlRootGroupOpenButton);
  NavBarAccordionControlSearchButton := GetElementByName(GroupNavBar,
    sdxNavBarAccordionControlSearchButton);
  NavBarAccordionControlSearchButtonGlyphToTextIndent :=
    GetIntegerPropertyByName(NavBarAccordionControlSearchButton,
    sdxNavBarAccordionControlGlyphToTextIndent);
  ...
  NavBarGroupButtons[True] := GetElementByName(GroupNavBar,
    sdxNavBarGroupCloseButton);
  NavBarGroupButtons[False] := GetElementByName(GroupNavBar,
    sdxNavBarGroupOpenButton);

  NavPaneCollapseButton := GetElementByName(GroupNavPane,
    sdxNavPaneCollapseButton);
  NavPaneCollapsedGroupClient := GetElementByName(GroupNavPane,
    sdxNavPaneCollapsedGroupClient);
  ...
  NavPaneGroupButton[False] := GetElementByName(GroupNavPane,
    sdxNavPaneGroupButton);
  NavPaneGroupButton[True] := GetElementByName(GroupNavPane,
  ...
  NavPaneScrollButtons[False] := GetElementByName(GroupNavPane,
    sdxNavPaneScrollUpBtn);
  NavPaneScrollButtons[True] := GetElementByName(GroupNavPane,
    sdxNavPaneScrollDownBtn);
  NavPaneOverflowPanel := GetElementByName(GroupNavPane,
    sdxNavPaneOverflowPanel);
  NavPaneOverflowPanelItem := GetElementByName(GroupNavPane,
    sdxNavPaneOverflowPanelItem);
  NavPaneOverflowPanelExpandedItem := GetElementByName(GroupNavPane,
    sdxNavPaneOverflowPanelExpandItem);
  ...
  NavPaneCaptionHeight := GetIntegerPropertyByName(NavPaneGroupCaption,
    sdxNavPaneCaptionHeight);
  NavPaneCaptionFontSize := GetIntegerPropertyByName(NavPaneGroupCaption,
    sdxFontSize);

  NavPaneOfficeNavigationBar := GetElementByName(GroupNavPane,
    sdxNavPaneOfficeNavigationBar);
  NavPaneOfficeNavigationBarItem := GetElementByName(GroupNavPane,
    sdxNavPaneOfficeNavigationBarItem);
  NavPaneOfficeNavigationBarItemFontDelta :=
    GetIntegerPropertyValue(NavPaneOfficeNavigationBarItem,
    sdxCaptionFontDelta);
  NavPaneOfficeNavigationBarSkinningItem := GetElementByName(GroupNavPane,
    sdxNavPaneOfficeNavigationBarSkinningItem);
  NavPaneOfficeNavigationBarSkinningItemFontDelta :=
    GetIntegerPropertyValue(NavPaneOfficeNavigationBarSkinningItem,
    sdxCaptionFontDelta);
...
begin
  ...
  NavigatorInfoPanelColor := GetColorByName(GroupEditors,
    sdxNavigatorInfoPanelColor);
  NavigatorInfoPanelTextColor := GetColorByName(GroupEditors,
    sdxNavigatorInfoPanelTextColor);
end;
...
begin
  ...
  PageControlHeaderButton := GetElementByName(GroupTabs,
    sdxPageControlHeaderButton);
  PageControlCloseButton := GetElementByName(GroupTabs,
    sdxPageControlHeaderCloseButton);
  ...
  begin
    PageControlIndents[0] := GetIntegerPropertyValue(GroupTabs,
      sdxRowIndentFar);
    PageControlIndents[1] := GetIntegerPropertyValue(GroupTabs,
      sdxRowIndentNear);
    PageControlIndents[2] := GetIntegerPropertyValue(GroupTabs,
      sdxSelectedHeaderDownGrow);
    PageControlIndents[3] := GetIntegerPropertyValue(GroupTabs,
      sdxSelectedHeaderHGrow);
    PageControlIndents[4] := GetIntegerPropertyValue(GroupTabs,
      sdxSelectedHeaderUpGrow);
    PageControlIndents[5] := GetIntegerPropertyValue(GroupTabs,
      sdxHeaderDownGrow);
    PageControlIndents[6] := GetIntegerPropertyValue(GroupTabs,
      sdxHeaderDownGrowBottomRight);
    PageControlIndents[7] := GetIntegerPropertyValue(GroupTabs,
      sdxSelectedHeaderDownGrowBottomRight);
  end;
end;

procedure TdxSkinInfo.InitializePDFViewerElements;
begin
  PDFViewerFindPanel := GetElementByName(GroupPDFViewer,
    sdxSkinsPDFViewerFindPanel);
  PDFViewerSelectionColor := GetColorByName(GroupPDFViewer,
    sdxSkinsPDFViewerSelectionColor);

  PDFViewerNavigationPaneBackground := GetElementByName(GroupPDFViewer,
    sdxSkinsPDFViewerNavigationPaneBackground);
  PDFViewerNavigationPaneButton := GetElementByName(GroupPDFViewer,
    sdxSkinsPDFViewerNavigationPaneButton);
  PDFViewerNavigationPaneButtonArrow := GetElementByName(GroupPDFViewer,
    sdxSkinsPDFViewerNavigationPaneButtonArrow);
  PDFViewerNavigationPaneButtonMinimized := GetElementByName(GroupPDFViewer,
    sdxSkinsPDFViewerNavigationPaneButtonMinimized);
  PDFViewerNavigationPanePageBackground := GetElementByName(GroupPDFViewer,
    sdxSkinsPDFViewerNavigationPanePageBackground);
  PDFViewerNavigationPanePageButton := GetElementByName(GroupPDFViewer,
    sdxSkinsPDFViewerNavigationPanePageButton);
  PDFViewerNavigationPanePageCaption := GetElementByName(GroupPDFViewer,
    sdxSkinsPDFViewerNavigationPanePageCaption);

  PDFViewerNavigationPaneSelectedPageExpandValue :=
    GetIntegerPropertyByName(GroupPDFViewer,
    sdxSkinsPDFViewerNavigationPaneSelectedPageExpandValue);
  PDFViewerNavigationPaneSelectedPageOverlapValue :=
    GetIntegerPropertyByName(GroupPDFViewer,
    sdxSkinsPDFViewerNavigationPaneSelectedPageOverlapValue);
end;

procedure TdxSkinInfo.InitializeProgressBarElements;
begin
  ProgressBarElements[False, False] := GetElementByName(GroupEditors,
    sdxProgressBorder);
  ProgressBarElements[False, True] := GetElementByName(GroupEditors,
    sdxProgressBorderVert);
  ProgressBarElements[True, False] := GetElementByName(GroupEditors,
    sdxProgressChunk);
  ProgressBarElements[True, True] := GetElementByName(GroupEditors,
    sdxProgressChunkVert);

  ProgressBarTextColors[False] := GetColorByName(GroupEditors,
    sdxSkinsProgressBarEmptyTextColor);
  ProgressBarTextColors[True] := GetColorByName(GroupEditors,
    sdxSkinsProgressBarFilledTextColor);
end;
...
begin
  ...
  RangeControlLeftThumb := GetElementByName(GroupEditors,
    sdxRangeControlLeftThumb);
  RangeControlRightThumb := GetElementByName(GroupEditors,
    sdxRangeControlRightThumb);
  RangeControlRulerHeader := GetElementByName(GroupEditors,
    sdxRangeControlRulerHeader);
  RangeControlSizingGlyph := GetElementByName(GroupEditors,
    sdxRangeControlSizingGlyph);

  RangeControlDefaultElementColor := GetColorByName(RangeControlBorder,
    sdxRangeControlDefaultElementColor);
  RangeControlElementBaseColor := GetColorByName(RangeControlBorder,
    sdxRangeControlElementBaseColor);
  RangeControlElementFontSize := GetIntegerPropertyByName(RangeControlBorder,
    sdxRangeControlElementFontSize);
  RangeControlElementForeColor := GetColorByName(RangeControlBorder,
    sdxRangeControlElementForeColor);
  RangeControlLabelColor := GetColorByName(RangeControlBorder,
    sdxRangeControlLabelColor);
  RangeControlOutOfRangeColorMask := GetAlphaColorValueByName
    (RangeControlBorder, sdxRangeControlOutOfRangeColorMask);
  RangeControlRangePreviewColor := GetColorByName(RangeControlBorder,
    sdxRangeControlRangePreviewColor);
  RangeControlRuleColor := GetAlphaColorValueByName(RangeControlBorder,
    sdxRangeControlRuleColor);
  RangeControlScrollAreaColor := GetColorByName(RangeControlBorder,
    sdxRangeControlScrollAreaColor);
  RangeControlScrollAreaHeight := GetIntegerPropertyByName(RangeControlBorder,
    sdxRangeControlScrollAreaHeight);
  RangeControlSelectionBorderColor := GetAlphaColorValueByName
    (RangeControlBorder, sdxRangeControlSelectionBorderColor);
  RangeControlSelectionColor := GetAlphaColorValueByName(RangeControlBorder,
    sdxRangeControlSelectionColor);
  RangeControlViewPortPreviewColor := GetColorByName(RangeControlBorder,
    sdxRangeControlViewPortPreviewColor);
  RangeControlBackColor := GetAlphaColorValueByName(RangeControlBorder,
    sdxRangeControlBackColor);
  RangeControlInnerBorderColor := GetAlphaColorValueByName(RangeControlBorder,
    sdxRangeControlInnerBorderColor);
end;
...
begin
  RibbonEditorBackground := GetColorByName(GroupRibbon,
    sdxRibbonEditorBackground);
  RibbonExtraPaneColor := GetColorByName(GroupRibbon, sdxRibbonExtraPaneColor);
  RibbonExtraPaneHeaderSeparator := GetColorByName(GroupRibbon,
    sdxRibbonExtraPaneHeaderSeparator);

  RibbonCaptionText[False] := GetColorValueByName(RibbonFormCaption,
    sdxTextColorInactive);
  ...
  RibbonContextualTabHeaderText[True] :=
    GetColorValueByName(RibbonContextualTabHeader, sdxTextColorSelected);
  RibbonContextualTabHeaderText[False] :=
    GetElementTextColor(RibbonContextualTabHeader);
  RibbonContextualTabHeaderTextHot :=
    GetColorValueByName(RibbonContextualTabHeader, sdxTextColorHot);
  RibbonDocumentNameTextColor[True] := GetColorValueByName(RibbonFormCaption,
    sdxRibbonDocumentNameTextColor);
  RibbonDocumentNameTextColor[False] := RibbonCaptionText[False];
  RibbonStatusBarTextSelected := GetColorValueByName(RibbonStatusBarButton,
    sdxTextColorSelected);

  RibbonButtonText[False] := GetElementTextColor(RibbonSmallButton);
  RibbonButtonText[True] := GetColorValueByName(GroupRibbon,
    sdxRibbonButtonDisabledText);
end;

procedure TdxSkinInfo.InitializeRichEditElements;
begin
  RichEditCornerPanel := GetElementByName(GroupRichEdit,
    sdxRichEditCornerPanel);
  RichEditRulerBackgroundHorz := GetElementByName(GroupRichEdit,
    sdxRichEditRulerBackgroundHorz);
  RichEditRulerBackgroundVert := GetElementByName(GroupRichEdit,
    sdxRichEditRulerBackgroundVert);
  RichEditRulerColumnResizer := GetElementByName(GroupRichEdit,
    sdxRichEditRulerColumnResizer);
  RichEditRulerDefaultTabColor := GetColorByName(GroupRichEdit,
    sdxRichEditRulerDefaultTabColor);
  RichEditRulerIndent := GetElementByName(GroupRichEdit,
    sdxRichEditRulerIndent);
  RichEditRulerIndentBottom := GetElementByName(GroupRichEdit,
    sdxRichEditRulerIndentBottom);
  RichEditRulerRightMargin := GetElementByName(GroupRichEdit,
    sdxRichEditRulerRightMargin);
  RichEditRulerSection := GetElementByName(GroupRichEdit,
    sdxRichEditRulerSection);
  RichEditRulerTab := GetElementByName(GroupRichEdit, sdxRichEditRulerTab);
  RichEditRulerTabTypeBackground := GetElementByName(GroupRichEdit,
    sdxRichEditRulerTabTypeBackground);
  RichEditRulerTextColor := GetColorByName(GroupRichEdit,
    sdxRichEditRulerTextColor);
end;

procedure TdxSkinInfo.InitializeRibbonElements;
begin
  RadialMenuBackgroundColor := GetColorByName(GroupRibbon,
    sdxSkinsRadialMenuBackgroundColor);
  RadialMenuBaseColor := GetColorByName(GroupRibbon,
    sdxSkinsRadialMenuBaseColor);

  RibbonApplicationBackground := GetElementByName(GroupRibbon,
    sdxRibbonAppMenuBackground);
  RibbonApplicationButton := GetElementByName(GroupRibbon,
    sdxRibbonApplicationButton);
  RibbonApplicationButton2010 := GetElementByName(GroupRibbon,
    sdxRibbonApplicationButton2010);
  RibbonApplicationFooterBackground := GetElementByName(GroupRibbon,
    sdxRibbonAppMenuFooterBackground);
  RibbonApplicationHeaderBackground := GetElementByName(GroupRibbon,
    sdxRibbonAppMenuHeaderBackground);
  RibbonExtraPanePinButtonGlyph := GetElementByName(GroupRibbon,
    sdxRibbonExtraPanePinButtonGlyph, False);
  RibbonExtraPaneButton := GetElementByName(GroupRibbon,
    sdxRibbonExtraPaneButton);

  RibbonBackstageView := GetElementByName(GroupRibbon,
    sdxRibbonBackstageViewBackground);
  RibbonBackstageViewBackButton := GetElementByName(GroupRibbon,
    sdxRibbonBackstageViewBackButton);
  RibbonBackstageViewImage := GetElementByName(GroupRibbon,
    sdxRibbonBackstageViewImage);
  RibbonBackstageViewMenu := GetElementByName(GroupRibbon,
    sdxRibbonBackstageViewMenuBackground);
  RibbonBackstageViewMenuHeader := GetElementByName(GroupRibbon,
    sdxRibbonBackstageViewMenuHeader);
  RibbonBackstageViewMenuButton := GetElementByName(GroupRibbon,
    sdxRibbonBackstageViewMenuButton);
  RibbonBackstageViewMenuSeparator := GetElementByName(GroupRibbon,
    sdxRibbonBackstageViewMenuSeparator);
  RibbonBackstageViewTab := GetElementByName(GroupRibbon,
    sdxRibbonBackstageViewTabHeader);
  RibbonBackstageViewTabArrow := GetElementByName(GroupRibbon,
    sdxRibbonBackstageViewTabHeaderArrow, False);

  RibbonCollapsedToolBarBackground := GetElementByName(GroupRibbon,
    sdxRibbonCollapsedToolBarBackground);
  RibbonCollapsedToolBarGlyphBackground := GetElementByName(GroupRibbon,
    sdxRibbonCollapsedToolBarGlyphBackground);

  RibbonFormButtonAutoHideModeShowUI := GetElementByName(GroupRibbon,
    sdxRibbonFormButtonAutoHideModeShowUI);
  RibbonFormButtonDisplayOptions := GetElementByName(GroupRibbon,
    sdxRibbonFormButtonDisplayOptions);
  ...
  RibbonFormButtonMaximize := GetElementByName(GroupRibbon,
    sdxFormButtonMaximize);
  RibbonFormButtonMinimize := GetElementByName(GroupRibbon,
    sdxFormButtonMinimize);
  RibbonFormButtonRestore := GetElementByName(GroupRibbon,
    sdxFormButtonRestore);

  RibbonFormCaption := GetElementByName(GroupRibbon, sdxRibbonFormCaption);
  RibbonFormCaptionRibbonHidden := GetElementByName(GroupRibbon,
    sdxRibbonFormCaptionRibbonHidden, False);
  ...
  RibbonFormBottom[True] := GetElementByName(GroupRibbon,
    sdxRibbonDialogFrameBottom);
  RibbonFormLeft[False] := GetElementByName(GroupRibbon,
    sdxRibbonFormFrameLeft);
  RibbonFormLeft[True] := GetElementByName(GroupRibbon,
    sdxRibbonDialogFrameLeft);
  RibbonFormRight[False] := GetElementByName(GroupRibbon,
    sdxRibbonFormFrameRight);
  RibbonFormRight[True] := GetElementByName(GroupRibbon,
    sdxRibbonDialogFrameRight);
  RibbonUseRoundedWindowCorners := GetBoolPropertyByName(GroupRibbon,
    sdxRibbonUseRoundedWindowCorners);
  RibbonMinimizeButtonGlyph := GetElementByName(GroupRibbon,
    sdxRibbonMinimizeButtonGlyph);
  ...
  RibbonTabPanelBottomIndent := GetIntegerPropertyByName(RibbonTabPanel,
    sdxRibbonTabPanelBottomIndent);
  RibbonTabPanelGroupButton := GetElementByName(GroupRibbon,
    sdxRibbonTabPanelGroupButton);
  RibbonTabSeparatorLine := GetElementByName(GroupRibbon,
    sdxRibbonTabSeparatorLine);
  RibbonTabGroup := GetElementByName(GroupRibbon, sdxRibbonTabGroup);
  RibbonTabGroupHeader := GetElementByName(GroupRibbon,
    sdxRibbonTabGroupHeader);
  RibbonTabGroupItemsSeparator := GetElementByName(GroupRibbon,
    sdxRibbonTabGroupItemsSeparator);
  RibbonGalleryBackground := GetElementByName(GroupRibbon,
    sdxRibbonGalleryBackground);
  RibbonGalleryButtonDown := GetElementByName(GroupRibbon,
    sdxRibbonGalleryButtonDown);
  RibbonGalleryButtonDropDown := GetElementByName(GroupRibbon,
    sdxRibbonGalleryButtonDropDown);
  RibbonGalleryButtonUp := GetElementByName(GroupRibbon,
    sdxRibbonGalleryButtonUp);
  RibbonGalleryGroupCaption := GetElementByName(GroupRibbon,
    sdxRibbonGalleryGroupCaption);
  RibbonGalleryPane := GetElementByName(GroupRibbon, sdxRibbonGalleryPane);
  RibbonGallerySizingPanel := GetElementByName(GroupRibbon,
    sdxRibbonGallerySizingPanel);
  RibbonGallerySizeGrips := GetElementByName(GroupRibbon,
    sdxRibbonGallerySizeGrips);
  RibbonHeaderBackground := GetElementByName(GroupRibbon,
    sdxRibbonHeaderBackground);
  RibbonHeaderBackgroundOnGlass := GetElementByName(GroupRibbon,
    sdxRibbonHeaderBackgroundOnGlass);
  RibbonSmallButton := GetElementByName(GroupRibbon, sdxRibbonSmallButton);
  RibbonSplitButtonLeft := GetElementByName(GroupRibbon,
    sdxRibbonSplitButtonLeft);
  RibbonSplitButtonRight := GetElementByName(GroupRibbon,
    sdxRibbonSplitButtonRight);
  ...
  RibbonLargeSplitButtonTop := GetElementByName(GroupRibbon,
    sdxRibbonLargeSplitButtonTop);
  RibbonLargeSplitButtonBottom := GetElementByName(GroupRibbon,
    sdxRibbonLargeSplitButtonBottom);
  ...
  RibbonStatusBarBackground := GetElementByName(GroupRibbon,
    sdxRibbonStatusBarBackground);
  RibbonStatusBarButton := GetElementByName(GroupRibbon,
    sdxRibbonStatusBarButton);
  RibbonStatusBarSeparator := GetElementByName(GroupRibbon,
    sdxRibbonStatusBarSeparator);
  RibbonQuickToolbar[True] := GetElementByName(GroupRibbon,
    sdxRibbonQuickToolbarInCaption);
  RibbonQuickToolbar[False] := GetElementByName(GroupRibbon,
    sdxRibbonQuickToolbarAbove);
  RibbonQuickToolbarBelow := GetElementByName(GroupRibbon,
    sdxRibbonQuickToolbarBelow);
  RibbonQuickToolbarButtonGlyph := GetElementByName(GroupRibbon,
    sdxRibbonQuickToolbarButtonGlyph);
  RibbonQuickToolbarDropDown := GetElementByName(GroupRibbon,
    sdxRibbonQuickToolbarDropDown);
  RibbonQuickToolbarGlyph := GetElementByName(GroupRibbon,
    sdxRibbonQuickToolbarGlyph);
  RibbonButtonGroupButton := GetElementByName(GroupRibbon,
    sdxRibbonButtonGroupButton);
  RibbonButtonGroupSeparator := GetElementByName(GroupRibbon,
    sdxRibbonButtonGroupSeparator);
  RibbonButtonGroupSplitButtonLeft := GetElementByName(GroupRibbon,
    sdxRibbonButtonGroupSplitButtonLeft);
  RibbonButtonGroupSplitButtonRight := GetElementByName(GroupRibbon,
    sdxRibbonButtonGroupSplitButtonRight);
  RibbonGroupScroll[True] := GetElementByName(GroupRibbon,
    sdxRibbonTabGroupLeftScroll);
  RibbonGroupScroll[False] := GetElementByName(GroupRibbon,
    sdxRibbonTabGroupRightScroll);
  RibbonContextualTabLabel := GetElementByName(GroupRibbon,
    sdxRibbonContextualTabLabel);
  RibbonContextualTabLabelShadowColor :=
    GetColorByName(RibbonContextualTabLabel, sdxTextShadowColor);
  RibbonContextualTabLabelOnGlass := GetElementByName(GroupRibbon,
    sdxRibbonContextualTabLabelOnGlass);
  RibbonContextualTabLabelOnGlassShadowColor :=
    GetColorByName(RibbonContextualTabLabelOnGlass, sdxTextShadowColor);
  RibbonContextualTabSeparator := GetElementByName(GroupRibbon,
    sdxRibbonContextualTabSeparator);
  RibbonContextualTabHeader := GetElementByName(GroupRibbon,
    sdxRibbonContextualTabHeader);
  RibbonContextualTabPanel := GetElementByName(GroupRibbon,
    sdxRibbonContextualTabPanel);
...
begin
  ...
  begin
    RibbonQATCustomizeButtonOutsizeQAT[AIndex] :=
      GetBoolPropertyByName(RibbonQuickToolbar[AIndex],
      sdxRibbonQATCustomizeButtonOutsideQAT);
    RibbonQATIndentBeforeCustomizeButton[AIndex] :=
      GetIntegerPropertyByName(RibbonQuickToolbar[AIndex],
      sdxRibbonQATIndentBeforeCustomizeItem);
  end;
  RibbonCaptionFontDelta := GetIntegerPropertyByName(RibbonFormCaption,
    sdxCaptionFontDelta);
  RibbonSpaceBetweenTabGroups := GetIntegerPropertyByName(GroupRibbon,
    sdxRibbonSpaceBetweenTabGroups);
  RibbonTabHeaderDownGrowIndent := GetIntegerPropertyByName(GroupRibbon,
    sdxRibbonTabHeaderDownGrowIndent);
  RibbonTabAeroSupport := GetBoolPropertyByName(GroupRibbon,
    sdxRibbonTabAeroSupport);
end;
...
procedure TdxSkinInfo.InitializeScrollBarElements;
  ...
  begin
    ...
    if Skin <> nil then
      ScrollBar_Elements[AHorz, APart] := TdxSkinScrollInfo.Create(AElement,
        AImageIndex, APart);
  end;
...
begin
  ...
  // Thumbnail
  SetInfo(False, sbpThumbnail, GetElementByName(GroupCommon,
    sdxScrollThumbButtonVert));
  SetInfo(True, sbpThumbnail, GetElementByName(GroupCommon,
    sdxScrollThumbButtonHorz));
  // Page
...
begin
  for I := 0 to dxSkinsSchedulerResourceColorsCount - 1 do
    SchedulerResourceColors[I] := GetColorByName(GroupScheduler,
      Format(sdxSchedulerResourceColor, [I + 1]));
  SchedulerTimeGridHeader[False] := GetElementByName(GroupScheduler,
    sdxSchedulerTimeGridHeader);
  SchedulerTimeGridHeader[True] := GetElementByName(GroupScheduler,
  ...
  SchedulerMoreButton := GetElementByName(GroupScheduler,
    sdxSchedulerMoreButton);
  SchedulerAppointment[False] := GetElementByName(GroupScheduler,
    sdxSchedulerAppointmentRight);
  SchedulerAppointment[True] := GetElementByName(GroupScheduler,
    sdxSchedulerAppointment);
  SchedulerAllDayArea[False] := GetElementByName(GroupScheduler,
    sdxSchedulerAllDayArea);
  SchedulerAllDayArea[True] := GetElementByName(GroupScheduler,
    sdxSchedulerAllDayAreaSelected);
  SchedulerCurrentTimeIndicator := GetElementByName(GroupScheduler,
    sdxSchedulerCurrentTimeIndicator);
  SchedulerAppointmentShadow[False] := GetElementByName(GroupScheduler,
    sdxSchedulerAppointmentBottomShadow);
  SchedulerAppointmentShadow[True] := GetElementByName(GroupScheduler,
    sdxSchedulerAppointmentRightShadow);
  SchedulerAppointmentBorderSize := GetIntegerPropertyByName
    (SchedulerAppointment[True], sdxSchedulerAppointmentBorderSize);
  SchedulerAppointmentMask := GetElementByName(GroupScheduler,
    sdxSchedulerAppointmentMask);
  ...
  SchedulerNavigationButtons[False] := GetElementByName(GroupScheduler,
    sdxSchedulerNavButtonPrev);
  SchedulerNavigationButtons[True] := GetElementByName(GroupScheduler,
    sdxSchedulerNavButtonNext);
  SchedulerNavigationButtonsArrow[False] := GetElementByName(GroupScheduler,
    sdxSchedulerNavButtonPrevArrow);
  SchedulerNavigationButtonsArrow[True] := GetElementByName(GroupScheduler,
    sdxSchedulerNavButtonNextArrow);
  SchedulerTimeGridCurrentTimeIndicator := GetElementByName(GroupScheduler,
    sdxSchedulerTimeGridCurrentTimeIndicator);
  SchedulerLabelCircle := GetElementByName(GroupScheduler,
    sdxSchedulerLabelCircle);
  SchedulerTaskExpandButton := GetElementByName(GroupScheduler,
    sdxSchedulerTaskExpandButton, False);
...
begin
  TileControlActionBar := GetElementByName(GroupTileControl,
    sdxTileControlActionBar);
  TileControlBackground := GetElementByName(GroupTileControl,
    sdxTileControlBackground);
  TileControlItem := GetElementByName(GroupTileControl, sdxTileControlItem);
  TileControlItemCheck := GetElementByName(GroupTileControl,
    sdxTileControlItemCheck);
  TileControlGroupCaption := GetElementByName(GroupTileControl,
    sdxTileControlGroupCaption);
  TileControlGroupCaptionFontDelta := GetIntegerPropertyValue
    (TileControlGroupCaption, sdxCaptionFontDelta);
  TileControlVirtualGroup := GetElementByName(GroupTileControl,
    sdxTileControlVirtualGroup);
  TileControlTitle := GetElementByName(GroupTileControl, sdxTileControlTitle);
  TileControlTitleFontDelta := GetIntegerPropertyValue(TileControlTitle,
    sdxCaptionFontDelta);
  TileControlTabHeader := GetElementByName(GroupTileControl,
    sdxTileControlTabHeader);
  TileControlTabHeaderFontDelta := GetIntegerPropertyValue(TileControlTabHeader,
    sdxCaptionFontDelta);
  TileControlSelectionFocusedColor := GetColorValueByName(GroupTileControl,
    sdxTileControlSelectionFocusedColor);
  TileControlSelectionHotColor := GetColorValueByName(GroupTileControl,
    sdxTileControlSelectionHotColor);
end;
...
begin
  ...
  ToggleSwitchTextMargin := GetIntegerPropertyByName(ToggleSwitch,
    sdxToggleSwitchTextMargin);
end;
...
const
  LayoutViewRecordElementNameMap: array [TcxGroupBoxCaptionPosition]
    of string = (sdxLayoutViewRecordTop, sdxLayoutViewRecordBottom,
    sdxLayoutViewRecordLeft, sdxLayoutViewRecordRight, sdxLayoutViewRecord);
  LayoutViewRecordElementCaptionNameMap: array [TcxGroupBoxCaptionPosition]
    of string = (sdxLayoutViewRecordCaptionTop,
    sdxLayoutViewRecordCaptionBottom, sdxLayoutViewRecordCaptionLeft,
    sdxLayoutViewRecordCaptionRight, '');
var
...
begin
  ...
  begin
    LayoutViewElementPadding[AElement] := GetPropertyByName(GroupGrid,
      LayoutViewElementPaddingMap[AElement]) as TdxSkinRectProperty;
    LayoutViewElementSpacing[AElement] := GetPropertyByName(GroupGrid,
      LayoutViewElementSpacingMap[AElement]) as TdxSkinRectProperty;
  end;

  LayoutViewRecordExpandButton := GetElementByName(GroupGrid,
    sdxLayoutViewRecordExpandButton);
  for ACaptionPosition := Low(ACaptionPosition) to High(ACaptionPosition) do
  begin
    LayoutViewRecordElements[ACaptionPosition] :=
      GetElementByName(GroupGrid, LayoutViewRecordElementNameMap
      [ACaptionPosition]);
    LayoutViewRecordCaptionElements[ACaptionPosition] :=
      GetElementByName(GroupGrid, LayoutViewRecordElementCaptionNameMap
      [ACaptionPosition], ACaptionPosition <> cxgpCenter);
    LayoutViewRecordCaptionTailSizes[ACaptionPosition] :=
      GetIntegerPropertyByName(LayoutViewRecordCaptionElements
      [ACaptionPosition], sdxGroupPanelCaptionTailSize);
    LayoutViewRecordCaptionTextPadding[ACaptionPosition] :=
      GetIntegerPropertyByName(GroupBoxCaptionElements[ACaptionPosition],
      sdxGroupPanelCaptionTextPadding);
  end;
end;
...
const
  NamesMap: array [TcxButtonState] of string = ('', '', 'Highlighted',
    'Selected', '');
var
  AElement: TdxSkinElement;
  AState: TcxButtonState;
begin
  MapControlBackColor := GetColorValueByName(GroupMapControl,
    sdxMapControlBackColor);

  MapControlCustomElement := GetElementByName(GroupMapControl,
    sdxMapControlCustomElement);
  MapControlCustomElementTextGlowColor := GetAlphaColorValueByName
    (MapControlCustomElement, sdxTextGlowColor);

  MapControlCallout := GetElementByName(GroupMapControl, sdxMapControlCallout);
  MapControlCalloutTextGlowColor := GetAlphaColorValueByName(MapControlCallout,
    sdxTextGlowColor);
  MapControlCalloutPointerHeight := GetIntegerPropertyValue(MapControlCallout,
    sdxMapControlCalloutPointerHeight);
  MapControlCalloutPointer := cxPoint(GetIntegerPropertyValue(MapControlCallout,
    sdxMapControlCalloutPointerX), GetIntegerPropertyValue(MapControlCallout,
    sdxMapControlCalloutPointerY));

  MapControlPushpin := GetElementByName(GroupMapControl, sdxMapControlPushpin);
  MapControlPushpinTextOrigin :=
    cxPoint(GetIntegerPropertyValue(MapControlPushpin,
    sdxMapControlPushpinTextOriginX), GetIntegerPropertyValue(MapControlPushpin,
    sdxMapControlPushpinTextOriginY));
  MapControlPushpinTextGlowColor := GetAlphaColorValueByName(MapControlPushpin,
    sdxTextGlowColor);

  AElement := GetElementByName(GroupMapControl, sdxMapControlSelectedRegion);
  MapControlSelectedRegionBackgroundColor := GetAlphaColorValueByName(AElement,
    'BackColor');
  MapControlSelectedRegionBorderColor := GetAlphaColorValueByName(AElement,
    sdxMapControlBorderColor);

  MapControlPanelBackColor := GetAlphaColorValueByName(GroupMapControl,
    sdxMapControlPanelBackColor);
  MapControlPanelHotTrackedTextColor := GetAlphaColorValueByName
    (GroupMapControl, sdxMapControlPanelHotTrackedTextColor);
  MapControlPanelPressedTextColor := GetAlphaColorValueByName(GroupMapControl,
    sdxMapControlPanelPressedTextColor);
  MapControlPanelTextColor := GetAlphaColorValueByName(GroupMapControl,
    sdxMapControlPanelTextColor);

  AElement := GetElementByName(GroupMapControl, sdxMapControlShape);
  for AState := Low(TcxButtonState) to High(TcxButtonState) do
  begin
    MapControlShapeBorderColor[AState] := GetAlphaColorValueByName(AElement,
      NamesMap[AState] + sdxMapControlBorderColor);
    MapControlShapeBorderWidth[AState] := GetIntegerPropertyValue(AElement,
      NamesMap[AState] + sdxMapControlBorderWidth);
    MapControlShapeColor[AState] := GetAlphaColorValueByName(AElement,
      IfThen(NamesMap[AState] <> '', NamesMap[AState], 'Back') + sdxColor);
  end;
end;

procedure TdxSkinInfo.InitializePrintingSystemElements;
begin
  PrintingPageBorder := GetElementByName(GroupPrintingSystem,
    sdxPrintingSystemPageBorder);
  if PrintingPageBorder <> nil then
    PrintingPageBorder.UseCache := True;
  PrintingPreviewBackground := GetElementByName(GroupPrintingSystem,
    sdxPrintingSystemPreviewBackground);
...
begin
  RangeTrackBarThumbLeft := GetElementByName(GroupEditors,
    sdxRangeTrackBarThumbLeft);
  RangeTrackBarThumbRight := GetElementByName(GroupEditors,
    sdxRangeTrackBarThumbRight);
  RangeTrackBarThumbBoth := GetElementByName(GroupEditors,
    sdxRangeTrackBarThumbBoth);
  ...
  TrackBarThumb[True, tbtaDown] := GetElementByName(GroupEditors,
    sdxTrackBarThumb);
  TrackBarThumb[True, tbtaUp] := GetElementByName(GroupEditors,
    sdxTrackBarThumbUp);
  TrackBarThumb[True, tbtaBoth] := GetElementByName(GroupEditors,
    sdxTrackBarThumbBoth);

  TrackBarThumb[False, tbtaDown] := GetElementByName(GroupEditors,
    sdxTrackBarThumbVert);
  TrackBarThumb[False, tbtaUp] := GetElementByName(GroupEditors,
    sdxTrackBarThumbVertUp);
  TrackBarThumb[False, tbtaBoth] := GetElementByName(GroupEditors,
    sdxTrackBarThumbVertBoth);
end;
...
procedure TdxSkinInfo.SetUseCache(AElement: TdxSkinElement;
  ACapacity: Integer = -1);
begin
  if AElement <> nil then
  begin
...
function TdxSkinScrollInfo.DrawScaled(DC: HDC; const R: TRect;
  AImageIndex: Integer; AState: TdxSkinElementState;
...
function TdxSkinScrollInfo.DrawScaled(DC: HDC; const R: TRect;
  AState: TdxSkinElementState; AScaleFactor: TdxScaleFactor): Boolean;
begin
