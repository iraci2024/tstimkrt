...
{$ENDIF}
  ...
  cxLookAndFeelPainters, dxLayoutLookAndFeels, cxClasses, dxLayoutContainer,
  dxLayoutControl, dxLayoutControlAdapters,
  dxLayoutcxEditAdapters, cxContainer, cxEdit, cxSpinEdit,
  dxMeasurementUnitEdit, cxTextEdit, cxMaskEdit, cxLabel,
...
type
  TdxFloatingObjectLayoutDialogForm = class(TdxRichEditCustomDialogForm)
    ...
    procedure cmbHorizontalAbsolutePositionRightOfPropertiesChange
      (Sender: TObject);
  ...
  private
    FPresetControls: array [0 .. PresetControlCount - 1]
      of TdxPresetControlInfo;
    function GetController
      : TdxFloatingObjectLayoutOptionsFormController; inline;
  ...
  protected
    ...
    function CreateController(AControllerParameters
      : TdxFormControllerParameters): TdxFormController; override;
    function GetUnitConverter: TdxDocumentModelUnitConverter; override;
    class function IndexToTextWrapSide(AValue: Integer)
      : TdxFloatingObjectTextWrapSide; static;

    procedure InitializeForm; override;
    procedure InitializeFormInitPresetControls;
    procedure InitializeFormHorizontalAlignmentComboBox;
    procedure InitializeFormAddItemInHorizontalPositionAlignmentComboBox
      (AItems: TStrings; AHorizontalPositionAlignment
      : TdxFloatingObjectHorizontalPositionAlignment);
    procedure InitializeFormFillHorizontalPositionTypeComboBox
      (ACombobox: TcxCustomComboBox);
    procedure InitializeFormAddItemToHorizontalPositionTypeComboBox
      (AItems: TStrings; AHorizontalPositionType
      : TdxFloatingObjectHorizontalPositionType);
    procedure InitializeFormFillVerticalAlignmentComboBox;
    procedure InitializeFormAddItemInVerticalPositionAlignmentComboBox
      (AItems: TStrings; AVerticalPositionAlignment
      : TdxFloatingObjectVerticalPositionAlignment);
    procedure InitializeFormFillVerticalPositionTypeComboBox
      (ACombobox: TcxCustomComboBox;
      AUseVerticalPositionTypeParagraph: Boolean);
    procedure InitializeFormAddItemToVerticalPositionTypeComboBox
      (AItems: TStrings;
    ...
    procedure UpdateTabPagePositionUpdateSelectedIndex
      (ACombobox: TcxCustomComboBox; const AValue: Integer); overload;
    procedure UpdateTabPagePositionUpdateSelectedIndex
      (ACombobox: TcxCustomComboBox; const AValue: Integer;
    ...
    procedure UpdateRichTextIndentEdit(AEdit: TdxMeasurementUnitEdit;
      AAllowNegativeValues: Boolean; const AValue: TdxNullableInteger);
      overload;
    procedure UpdateRichTextIndentEdit(AEdit: TdxMeasurementUnitEdit;
      AAllowNegativeValues: Boolean; AValue: Integer); overload;

    procedure EnableHorizontalPositionControls(AEnableAlignmentRow,
      AEnableAbsolutePositionRow: Boolean);
    procedure EnableVerticalPositionControls(AEnableAlignmentRow,
      AEnableAbsolutePositionRow: Boolean);
    function GetXCoordinate: Integer;
    function GetYCoordinate: Integer;
    function CalculateOffsetX(ANewHorizontalPositionType
      : TdxFloatingObjectHorizontalPositionType): Integer;
    function CalculateOffsetY(ANewVerticalPositionType
      : TdxFloatingObjectVerticalPositionType): Integer;
    procedure PresetControlsChecked;
    procedure WrapTextAndDistanceControlsEnabled(AIsHorizontalControlsEnabled,
  ...
  public
    property Controller: TdxFloatingObjectLayoutOptionsFormController
      read GetController;
  end;
...
const
  FloatingObjectSquareTextWrapTypePreset: TdxTextWrapTypeInfoPreset =
    (TextWrapType: TdxFloatingObjectTextWrapType.Square;
    IsBehindDocument: False);
  FloatingObjectTightTextWrapTypePreset: TdxTextWrapTypeInfoPreset =
    (TextWrapType: TdxFloatingObjectTextWrapType.Tight;
    IsBehindDocument: False);
  FloatingObjectThroughTextWrapTypePreset: TdxTextWrapTypeInfoPreset =
    (TextWrapType: TdxFloatingObjectTextWrapType.Through;
    IsBehindDocument: False);
  FloatingObjectTopAndBottomTextWrapTypePreset: TdxTextWrapTypeInfoPreset =
    (TextWrapType: TdxFloatingObjectTextWrapType.TopAndBottom;
    IsBehindDocument: False);
  FloatingObjectBehindTextWrapTypePreset: TdxTextWrapTypeInfoPreset =
    (TextWrapType: TdxFloatingObjectTextWrapType.None; IsBehindDocument: True);
  FloatingObjectInFrontOfTextWrapTypePreset: TdxTextWrapTypeInfoPreset =
    (TextWrapType: TdxFloatingObjectTextWrapType.None; IsBehindDocument: False);

  { TdxFloatingObjectLayoutFormDialog }

function TdxFloatingObjectLayoutDialogForm.GetController
  : TdxFloatingObjectLayoutOptionsFormController;
begin
  Result := TdxFloatingObjectLayoutOptionsFormController(inherited Controller);
end;

procedure TdxFloatingObjectLayoutDialogForm.btnPresetControlClick
  (Sender: TObject);
var
...
begin
  ...
  try
    ...
    if Controller.Rotation.HasValue then
      ...
      ARotationValue := 0;
    SetValueToEditor(seRotation,
      Controller.DocumentModel.UnitConverter.ModelUnitsToDegree
      (ARotationValue));
  finally
    SubscribeControlsEvents;
  end;
...
begin
  ...
  rgTextWrapSideBothSides.Caption :=
    cxGetResourceString
    (@sdxFloatingObjectLayoutFormDialogTextWrapSideBothSides);
  rbTextWrapSideLeftOnly.Caption :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogTextWrapSideLeftOnly);
  rbTextWrapSideRightOnly.Caption :=
    cxGetResourceString
    (@sdxFloatingObjectLayoutFormDialogTextWrapSideRightOnly);
  rbTextWrapSideLargestOnly.Caption :=
    cxGetResourceString
    (@sdxFloatingObjectLayoutFormDialogTextWrapSideLargestOnly);
  cbLockAspectRatio.Caption := cxGetResourceString
    (@sdxFloatingObjectLayoutFormDialogLockAspectRatio);
  btnReset.Caption := cxGetResourceString
  ...
  lcgTabPagePosition.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogTabPagePosition);
  lcgTabPageTextWrapping.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogTabPageTextWrapping);
  lcgTabPageSize.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogTabPageSize);
  lblHorizontal.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogHorizontal);
  lciVertical.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogVertical);
  lblHorizontalPositionType.CaptionOptions.Text :=
    cxGetResourceString
    (@sdxFloatingObjectLayoutFormDialogHorizontalPositionType);
  lciHorizontalAbsolutePosition.CaptionOptions.Text :=
    cxGetResourceString
    (@sdxFloatingObjectLayoutFormDialogHorizontalAbsolutePosition);
  lciOptions.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogOptions);
  lciVerticalAbsolutePosition.CaptionOptions.Text :=
    cxGetResourceString
    (@sdxFloatingObjectLayoutFormDialogVerticalAbsolutePosition);
  lciVerticalPositionType.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogVerticalPositionType);
  lciWrappingStyle.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogWrappingStyle);
  lciPresetControlSquare.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogPresetControlSquare);
  lciPresetControlTight.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogPresetControlTight);
  lciPresetControlThought.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogPresetControlThought);
  lciPresetControlTopAndBottom.CaptionOptions.Text :=
    cxGetResourceString
    (@sdxFloatingObjectLayoutFormDialogPresetControlTopAndBottom);
  lciPresetControlBehind.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogPresetControlBehind);
  lciPresetControlInFrontOf.CaptionOptions.Text :=
    cxGetResourceString
    (@sdxFloatingObjectLayoutFormDialogPresetControlInFrontOf);
  lciWrapText.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogWrapText);
  lciDistance.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogDistance);
  lciTop.CaptionOptions.Text := cxGetResourceString
    (@sdxFloatingObjectLayoutFormDialogTop);
  lciBottom.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogBottom);
  lciLeft.CaptionOptions.Text := cxGetResourceString
    (@sdxFloatingObjectLayoutFormDialogLeft);
  lciRight.CaptionOptions.Text := cxGetResourceString
    (@sdxFloatingObjectLayoutFormDialogRight);
  lciHeight.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogHeight);
  lciHeightAbsolute.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogHeightAbsolute);
  lciWidth.CaptionOptions.Text := cxGetResourceString
    (@sdxFloatingObjectLayoutFormDialogWidth);
  lciWidthAbsolute.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogWidthAbsolute);
  lciRotate.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogRotate);
  lciRotation.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogRotation);
  lciScale.CaptionOptions.Text := cxGetResourceString
    (@sdxFloatingObjectLayoutFormDialogScale);
  lciOriginalSize.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogOriginalSize);
  lblOriginalSizeWidth.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogOriginalSizeWidth);
  lciOriginalSizeHeight.CaptionOptions.Text :=
    cxGetResourceString(@sdxFloatingObjectLayoutFormDialogOriginalSizeHeight);
end;
...
begin
  ACalculator := TdxFloatingObjectHorizontalPositionCalculator.Create
    (Controller.ToDocumentLayoutUnitConverter);
  X := GetXCoordinate;
  if X = MinInt then
    Exit(MinInt);
  Result := ACalculator.CalculateFloatingObjectOffsetX
    (ANewHorizontalPositionType, X, Controller.PlacementInfo);
end;
...
begin
  ...
  if Y = MinInt then
    Exit(MinInt);
  Result := ACalculator.CalculateFloatingObjectOffsetY(ANewVerticalPositionType,
    Y, Controller.PlacementInfo);
end;

procedure TdxFloatingObjectLayoutDialogForm.cbLockAspectRatioClick
  (Sender: TObject);
begin
...
procedure TdxFloatingObjectLayoutDialogForm.cbLockPropertiesChange
  (Sender: TObject);
begin
  Controller.Locked := cbLock.Checked;
end;

procedure TdxFloatingObjectLayoutDialogForm.
  cmbHorizontalAbsolutePositionRightOfPropertiesChange(Sender: TObject);
var
  AOffsetX: Integer;
  ANewHorizontalPositionType: TdxFloatingObjectHorizontalPositionType;
begin
  AOffsetX := 0;
  ANewHorizontalPositionType := TdxFloatingObjectHorizontalPositionType
    (GetItemValueContainer(cmbHorizontalAbsolutePositionRightOf).Value);

  if (ANewHorizontalPositionType <> TdxFloatingObjectHorizontalPositionType.
    Character) and (Controller.HorizontalPositionType <>
    TdxFloatingObjectHorizontalPositionType.Character) then
...
procedure TdxFloatingObjectLayoutDialogForm.
  cmbHorizontalAlignmentPropertiesChange(Sender: TObject);
begin
  Controller.HorizontalPositionAlignment :=
    TdxFloatingObjectHorizontalPositionAlignment
    (GetItemValueContainer(cmbHorizontalAlignment).Value);
end;

procedure TdxFloatingObjectLayoutDialogForm.
  cmbHorizontalPositionTypePropertiesChange(Sender: TObject);
begin
  Controller.HorizontalPositionType := TdxFloatingObjectHorizontalPositionType
    (GetItemValueContainer(cmbHorizontalPositionType).Value);
end;

procedure TdxFloatingObjectLayoutDialogForm.
  cmbVerticalAbsolutePositionBelowPropertiesChange(Sender: TObject);
var
  AOffsetY: Integer;
...
begin
  AOffsetY := 0;
  ANewVerticalPositionType := TdxFloatingObjectVerticalPositionType
    (GetItemValueContainer(cmbVerticalAbsolutePositionBelow).Value);

  if (ANewVerticalPositionType <> TdxFloatingObjectVerticalPositionType.Line)
    and (Controller.VerticalPositionType <>
    TdxFloatingObjectVerticalPositionType.Line) then
...
procedure TdxFloatingObjectLayoutDialogForm.cmbVerticalAlignmentPropertiesChange
  (Sender: TObject);
begin
  Controller.VerticalPositionAlignment :=
    TdxFloatingObjectVerticalPositionAlignment
    (GetItemValueContainer(cmbVerticalAlignment).Value);
end;

procedure TdxFloatingObjectLayoutDialogForm.
  cmbVerticalPositionTypePropertiesChange(Sender: TObject);
begin
  Controller.VerticalPositionType := TdxFloatingObjectVerticalPositionType
    (GetItemValueContainer(cmbVerticalPositionType).Value);
end;
...
begin
  Result := TdxFloatingObjectLayoutOptionsFormController.Create
    (AControllerParameters as
    TdxFloatingInlineObjectLayoutOptionsFormControllerParameters);
end;

procedure TdxFloatingObjectLayoutDialogForm.
  seHorizontalAbsolutePositionPropertiesChange(Sender: TObject);
var
  AValue: Variant;
begin
  Controller.HorizontalPositionAlignment :=
...
procedure TdxFloatingObjectLayoutDialogForm.
  seVerticalAbsolutePositionPropertiesChange(Sender: TObject);
var
  AValue: Variant;
begin
  Controller.VerticalPositionAlignment :=
...
begin
  ...
  AOffset := Controller.ToDocumentLayoutUnitConverter.ToLayoutUnits
...
class function TdxFloatingObjectLayoutDialogForm.IndexToTextWrapSide
  (AValue: Integer): TdxFloatingObjectTextWrapSide;
begin
...
begin
  ...
  Populate(cmbHorizontalPositionType,
    InitializeFormFillHorizontalPositionTypeComboBox);
  cmbHorizontalAbsolutePositionRightOf.Properties.Items.Assign
    (cmbHorizontalPositionType.Properties.Items);

  InitializeFormFillVerticalAlignmentComboBox;
  InitializeFormFillVerticalPositionTypeComboBox
    (cmbVerticalPositionType, False);
  InitializeFormFillVerticalPositionTypeComboBox
    (cmbVerticalAbsolutePositionBelow, True);
...
procedure TdxFloatingObjectLayoutDialogForm.
  InitializeFormAddItemInHorizontalPositionAlignmentComboBox(AItems: TStrings;
  AHorizontalPositionAlignment: TdxFloatingObjectHorizontalPositionAlignment);
begin
  AddItemValue(AItems, Controller.HorizontalPositionAlignmentTable
    [AHorizontalPositionAlignment], Ord(AHorizontalPositionAlignment));
end;

procedure TdxFloatingObjectLayoutDialogForm.
  InitializeFormAddItemInVerticalPositionAlignmentComboBox(AItems: TStrings;
  AVerticalPositionAlignment: TdxFloatingObjectVerticalPositionAlignment);
begin
  AddItemValue(AItems, Controller.VerticalPositionAlignmentTable
    [AVerticalPositionAlignment], Ord(AVerticalPositionAlignment));
end;

procedure TdxFloatingObjectLayoutDialogForm.
  InitializeFormAddItemToHorizontalPositionTypeComboBox(AItems: TStrings;
  AHorizontalPositionType: TdxFloatingObjectHorizontalPositionType);
begin
  AddItemValue(AItems, Controller.HorizontalPositionTypeTable
    [AHorizontalPositionType], Ord(AHorizontalPositionType));
end;

procedure TdxFloatingObjectLayoutDialogForm.
  InitializeFormAddItemToVerticalPositionTypeComboBox(AItems: TStrings;
  AVerticalPositionType: TdxFloatingObjectVerticalPositionType);
begin
  AddItemValue(AItems, Controller.VerticalPositionTypeTable
    [AVerticalPositionType], Ord(AVerticalPositionType));
end;
...
procedure TdxFloatingObjectLayoutDialogForm.
  ...
  (ACombobox: TcxCustomComboBox);
begin
  InitializeFormAddItemToHorizontalPositionTypeComboBox
    (ACombobox.Properties.Items,
    TdxFloatingObjectHorizontalPositionType.Margin);
  InitializeFormAddItemToHorizontalPositionTypeComboBox
    (ACombobox.Properties.Items, TdxFloatingObjectHorizontalPositionType.Page);
  InitializeFormAddItemToHorizontalPositionTypeComboBox
    (ACombobox.Properties.Items,
    TdxFloatingObjectHorizontalPositionType.Column);
  InitializeFormAddItemToHorizontalPositionTypeComboBox
...
begin
  Populate(cmbVerticalAlignment, procedure(ACombobox: TcxCustomComboBox)
    begin
      InitializeFormAddItemInVerticalPositionAlignmentComboBox
        (ACombobox.Properties.Items,
...
procedure TdxFloatingObjectLayoutDialogForm.
  InitializeFormFillVerticalPositionTypeComboBox(ACombobox: TcxCustomComboBox;
AUseVerticalPositionTypeParagraph: Boolean);
begin
  InitializeFormAddItemToVerticalPositionTypeComboBox
    (ACombobox.Properties.Items, TdxFloatingObjectVerticalPositionType.Margin);
  InitializeFormAddItemToVerticalPositionTypeComboBox
    (ACombobox.Properties.Items, TdxFloatingObjectVerticalPositionType.Page);
  InitializeFormAddItemToVerticalPositionTypeComboBox
    (ACombobox.Properties.Items, TdxFloatingObjectVerticalPositionType.Line);
  InitializeFormAddItemToVerticalPositionTypeComboBox
    (ACombobox.Properties.Items,
    TdxFloatingObjectVerticalPositionType.TopMargin);
  InitializeFormAddItemToVerticalPositionTypeComboBox
...
begin
  Populate(cmbHorizontalAlignment, procedure(ACombobox: TcxCustomComboBox)
    begin
      InitializeFormAddItemInHorizontalPositionAlignmentComboBox
        (ACombobox.Properties.Items,
...
procedure TdxFloatingObjectLayoutDialogForm.InitializeFormInitPresetControls;
  ...
  procedure InitializePresetControl(AIndex: Integer; AControl: TcxButton;
  const APreset: TdxTextWrapTypeInfoPreset);
  begin
    AControl.Tag := AIndex;
...
begin
  InitializePresetControl(0, btnPresetControlSquare,
    FloatingObjectSquareTextWrapTypePreset);
  InitializePresetControl(1, btnPresetControlTight,
    FloatingObjectTightTextWrapTypePreset);
  InitializePresetControl(2, btnPresetControlThought,
    FloatingObjectThroughTextWrapTypePreset);
  InitializePresetControl(3, btnPresetControlTopAndBottom,
    FloatingObjectTopAndBottomTextWrapTypePreset);
  InitializePresetControl(4, btnPresetControlBehind,
    FloatingObjectBehindTextWrapTypePreset);
  InitializePresetControl(5, btnPresetControlInFrontOf,
    FloatingObjectInFrontOfTextWrapTypePreset);
end;
...
begin
  Result := IsValidEdit(seHorizontalAbsolutePosition) and
    IsValidEdit(seVerticalAbsolutePosition) and IsValidEdit(seTop) and
    IsValidEdit(seBottom) and IsValidEdit(seLeft) and IsValidEdit(seRight) and
    IsValidEdit(seHeightAbs) and IsValidEdit(seWidthAbs) and
    IsValidEdit(seRotation);
end;
...
begin
  ...
  begin
    ...
    if (Controller.TextWrapType = TdxFloatingObjectTextWrapType.None) and
      (ATextWrapTypePreset.TextWrapType = TdxFloatingObjectTextWrapType.None)
    then
      AIsSelected :=
        (Controller.IsBehindDocument = ATextWrapTypePreset.IsBehindDocument)
    else
      AIsSelected :=
        (ATextWrapTypePreset.TextWrapType = Controller.TextWrapType);

    FPresetControls[I].Control.SpeedButtonOptions.Down := AIsSelected;
    FPresetControls[I].Control.TabStop := AIsSelected;

    if ((Controller.TextWrapType = TdxFloatingObjectTextWrapType.Tight)) or
      ((Controller.TextWrapType = TdxFloatingObjectTextWrapType.Through)) then
      WrapTextAndDistanceControlsEnabled(True, False)
    else if Controller.TextWrapType = TdxFloatingObjectTextWrapType.Square then
      WrapTextAndDistanceControlsEnabled(True, True)
    else if Controller.TextWrapType = TdxFloatingObjectTextWrapType.TopAndBottom
    then
      WrapTextAndDistanceControlsEnabled(False, True)
    else if Controller.TextWrapType = TdxFloatingObjectTextWrapType.None then
      WrapTextAndDistanceControlsEnabled(False, False);
  end;
end;

procedure TdxFloatingObjectLayoutDialogForm.rbHorizontalAlignmentItemClick
  (Sender: TObject);
var
...
begin
  ...
  EnableHorizontalPositionControls(not AIsHorizontalAbsolutePosition,
    AIsHorizontalAbsolutePosition);
...
procedure TdxFloatingObjectLayoutDialogForm.rbVerticalAlignmentItemClick
  (Sender: TObject);
var
  ASelectedIndex: Integer;
...
begin
  ...
  EnableVerticalPositionControls(not AIsVerticalAbsolutePosition,
    AIsVerticalAbsolutePosition);
...
procedure TdxFloatingObjectLayoutDialogForm.rgTextWrapSideClick
  (Sender: TObject);
var
  ATag: Integer;
begin
...
procedure TdxFloatingObjectLayoutDialogForm.seBottomPropertiesChange
  (Sender: TObject);
var
  AValue: Variant;
begin
...
procedure TdxFloatingObjectLayoutDialogForm.seHeightAbsoluteValueChanged
  (Sender: TObject);
var
  ANewHeight: Variant;
begin
  ...
  if VarIsNull(ANewHeight) then
    ANewHeight := 0;
  Controller.RecalculateSizeDependingOnHeight(cbLockAspectRatio.Checked,
    ANewHeight);
  SetValueToEditor(seWidthAbs, Controller.ActualWidth);
  SubscribeControlsEvents;
end;

procedure TdxFloatingObjectLayoutDialogForm.seLeftPropertiesChange
  (Sender: TObject);
var
  AValue: Variant;
begin
...
procedure TdxFloatingObjectLayoutDialogForm.seRightPropertiesChange
  (Sender: TObject);
var
  AValue: Variant;
begin
...
procedure TdxFloatingObjectLayoutDialogForm.seRotationPropertiesChange
  (Sender: TObject);
var
  AValue: Integer;
begin
  ...
  try
    ...
    Controller.Rotation := Controller.DocumentModel.UnitConverter.
      DegreeToModelUnits(AValue);
    if (Controller.Rotation <> 0) and
      (Controller.TextWrapType = TdxFloatingObjectTextWrapType.Inline) then
    begin
      UnsubscribeControlsEvents;
...
procedure TdxFloatingObjectLayoutDialogForm.seTopPropertiesChange
  (Sender: TObject);
var
  AValue: Variant;
begin
...
procedure TdxFloatingObjectLayoutDialogForm.SetTextWrapSide
  (const Value: TdxFloatingObjectTextWrapSide);
begin
  case Value of
    TdxFloatingObjectTextWrapSide.Both:
      rgTextWrapSideBothSides.Checked := True;
    TdxFloatingObjectTextWrapSide.Left:
      rbTextWrapSideLeftOnly.Checked := True;
    TdxFloatingObjectTextWrapSide.Right:
      rbTextWrapSideRightOnly.Checked := True;
    TdxFloatingObjectTextWrapSide.Largest:
      rbTextWrapSideLargestOnly.Checked := True;
  end;
end;

procedure TdxFloatingObjectLayoutDialogForm.seWidthAbsoluteValueChanged
  (Sender: TObject);
var
  ANewWidth: Variant;
begin
  ...
  if VarIsNull(ANewWidth) then
    ANewWidth := 0;
  Controller.RecalculateSizeDependingOnWidth(cbLockAspectRatio.Checked,
    ANewWidth);
  SetValueToEditor(seHeightAbs, Controller.ActualHeight);
  SubscribeControlsEvents;
end;
...
begin
  ...
  cmbHorizontalAlignment.Properties.OnChange :=
    cmbHorizontalAlignmentPropertiesChange;
  cmbHorizontalPositionType.Properties.OnChange :=
    cmbHorizontalPositionTypePropertiesChange;
  cmbHorizontalAbsolutePositionRightOf.Properties.OnChange :=
    cmbHorizontalAbsolutePositionRightOfPropertiesChange;
  cmbVerticalAlignment.Properties.OnChange :=
    cmbVerticalAlignmentPropertiesChange;
  cmbVerticalPositionType.Properties.OnChange :=
    cmbVerticalPositionTypePropertiesChange;
  cmbVerticalAbsolutePositionBelow.Properties.OnChange :=
    cmbVerticalAbsolutePositionBelowPropertiesChange;
  seHorizontalAbsolutePosition.Properties.OnChange :=
    seHorizontalAbsolutePositionPropertiesChange;
  seVerticalAbsolutePosition.Properties.OnChange :=
    seVerticalAbsolutePositionPropertiesChange;
...
begin
  ...
  UpdateTabPageSize;
  if Control.InnerControl.Options.DocumentCapabilities.FloatingObjects =
    TdxDocumentCapability.Disabled then
  begin
...
procedure TdxFloatingObjectLayoutDialogForm.UpdateRichTextIndentEdit
  (AEdit: TdxMeasurementUnitEdit; AAllowNegativeValues: Boolean;
...
begin
  ...
  InitializeMeasurementUnitEdit(AEdit,
    ToMeasurementType(AProperties.DefaultUnitType),
    TdxMeasurementUnitEditHelper.Create(UnitTypeDescription, 0.1, 2,
    ModelUnitsToUIUnit(AMinValue), ModelUnitsToUIUnit(AMaxValue)));
...
begin
  if Controller.HorizontalPositionAlignment.HasValue then
    UpdateTabPagePositionUpdateSelectedIndex(cmbHorizontalAlignment,
      Ord(Controller.HorizontalPositionAlignment.Value),
      Ord(TdxFloatingObjectHorizontalPositionAlignment.Left))
  else
    UpdateTabPagePositionUpdateSelectedIndex(cmbHorizontalAlignment, -1,
      Ord(TdxFloatingObjectHorizontalPositionAlignment.Left));

  if Controller.HorizontalPositionType.HasValue then
    UpdateTabPagePositionUpdateSelectedIndex(cmbHorizontalPositionType,
      Ord(Controller.HorizontalPositionType.Value))
  else
    UpdateTabPagePositionUpdateSelectedIndex(cmbHorizontalPositionType, -1);

  if Controller.HorizontalPositionType.HasValue then
    UpdateTabPagePositionUpdateSelectedIndex
      (cmbHorizontalAbsolutePositionRightOf,
      Ord(Controller.HorizontalPositionType.Value))
  else
    UpdateTabPagePositionUpdateSelectedIndex
      (cmbHorizontalAbsolutePositionRightOf, -1);
  if Controller.HorizontalPositionAlignment.HasValue then
    if Controller.HorizontalPositionAlignment.Value =
  ...
  EnableHorizontalPositionControls(rbHorizontalAlignmentItem.Checked,
    not rbHorizontalAlignmentItem.Checked);
  UpdateRichTextIndentEdit(seHorizontalAbsolutePosition, True,
    Controller.OffsetX);
end;

procedure TdxFloatingObjectLayoutDialogForm.
  UpdateTabPagePositionUpdateSelectedIndex(ACombobox: TcxCustomComboBox;
...
begin
  if Controller.VerticalPositionAlignment.HasValue then
    UpdateTabPagePositionUpdateSelectedIndex(cmbVerticalAlignment,
      Ord(Controller.VerticalPositionAlignment.Value),
      Ord(TdxFloatingObjectVerticalPositionAlignment.Top))
  else
    UpdateTabPagePositionUpdateSelectedIndex(cmbVerticalAlignment, -1,
      Ord(TdxFloatingObjectVerticalPositionAlignment.Top));
  ...
  if Controller.VerticalPositionType.HasValue then
    UpdateTabPagePositionUpdateSelectedIndex(cmbVerticalPositionType,
      ...
      Ord(TdxFloatingObjectVerticalPositionType.Page))
  else
    UpdateTabPagePositionUpdateSelectedIndex(cmbVerticalPositionType, -1,
      Ord(TdxFloatingObjectVerticalPositionType.Page));
  ...
  if Controller.VerticalPositionType.HasValue then
    ...
    UpdateTabPagePositionUpdateSelectedIndex
      (cmbVerticalAbsolutePositionBelow, -1);

  if Controller.VerticalPositionAlignment <>
  ...
  EnableVerticalPositionControls(rbVerticalAlignmentItem.Checked,
    not rbVerticalAlignmentItem.Checked);
  UpdateRichTextIndentEdit(seVerticalAbsolutePosition, True,
    Controller.OffsetY);
end;
...
begin
  ...
  if Controller.Rotation.HasValue then
    ARotationValue := Controller.DocumentModel.UnitConverter.ModelUnitsToDegree
...
procedure TdxFloatingObjectLayoutDialogForm.WrapTextAndDistanceControlsEnabled
  (AIsHorizontalControlsEnabled, AIsVerticalControlsEnabled: Boolean);
begin
...
procedure TdxFloatingObjectLayoutDialogForm.EnableHorizontalPositionControls
  (AEnableAlignmentRow, AEnableAbsolutePositionRow: Boolean);
begin
...
procedure TdxFloatingObjectLayoutDialogForm.EnableVerticalPositionControls
  (AEnableAlignmentRow, AEnableAbsolutePositionRow: Boolean);
begin
...
procedure TdxFloatingObjectLayoutDialogForm.FormCloseQuery(Sender: TObject;
