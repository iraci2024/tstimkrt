...
type
  ...
  private
    ...
    function IsParent(ASource: TObject; const AParentClassName: string)
      : Boolean;
  ...
  protected
    function GetConverterClass(ASource: TObject)
      : TcxCustomConverterWithStylesClass;
    function GetConverterName(ASource: TObject): string;
    procedure InitializeConverter(AConverter
      : TcxCustomConverterWithStyles); virtual;
  ...
  public
    ...
    property GroupConverterName: string read FGroupConverterName
      write FGroupConverterName;
  end;

procedure ShowImportDialog(ADesigner: IDesigner; ADestination: TObject;
  const AGroupConverterName: string; AShowOptionsButton: Boolean = True);
...
procedure ShowImportDialog(ADesigner: IDesigner; ADestination: TObject;
  const AGroupConverterName: string; AShowOptionsButton: Boolean);
begin
...
function TcxImportDialogForm.GetConverterClass(ASource: TObject)
  : TcxCustomConverterWithStylesClass;
var
  AIndex: Integer;
begin
...
procedure TcxImportDialogForm.InitializeConverter
...
begin
  ...
  begin
    AConverter := GetConverterClass(ListBox1.Items.Objects[ListBox1.ItemIndex])
      .Create(FDestination);
    try
      ...
      begin
        if RadioButton1.Checked then
          ...
          AConverter.StyleRepository := ComboBox1.Items.Objects
            [ComboBox1.ItemIndex] as TcxStyleRepository;
      end;
...
function TcxImportDialogForm.IsParent(ASource: TObject;
