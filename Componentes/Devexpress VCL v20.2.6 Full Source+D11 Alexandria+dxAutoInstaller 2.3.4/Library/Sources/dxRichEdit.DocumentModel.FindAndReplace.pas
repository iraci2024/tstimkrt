...
type
  ...
  TdxSearchAction = (Find, Replace, ReplaceAll);
  ...
  TdxSearchLogicalAction = (None, FindReplaceForward, FindReplaceBackward,
    ReplaceAllForward, ReplaceAllBackward);

  { TdxSearchScope }

  TdxSearchScope = (None, SelectedText, AboveSelectedText, BelowSelectedText);

  { TdxSearchState }

  TdxSearchState = (FindStart, FindInSelection, FindAfterSelection,
    FindBeforeSelection, FindAfterCaret, FindBeforeCaret, FindFinish);
  ...
  public
    ...
    property LastResult: TdxDocumentLogPosition read FLastResult
      write FLastResult;
    property StartOfIntervalSearch: Boolean read FStartOfIntervalSearch
      write FStartOfIntervalSearch;
  end;
  ...
  strict private
    ...
    FContinue: Boolean;
  public
    constructor Create(AAction: TdxSearchAction; ADirection: TdxDirection;
      ASearchScope: TdxSearchScope);
  ...
  public
    ...
    property FindWholeWord: Boolean read GetFindWholeWord
      write SetFindWholeWord;
    property UseRegularExpression: Boolean read FUseRegularExpression
      write FUseRegularExpression;
    property FindInSelection: Boolean read FFindInSelection
      write FFindInSelection;
  ...
  TdxSearchCompleteEvent = procedure(Sender: TObject;
    E: TdxSearchCompleteEventArgs) of object;
...
constructor TdxSearchCompleteEventArgs.Create(AAction: TdxSearchAction;
  ADirection: TdxDirection; ASearchScope: TdxSearchScope);
begin
  inherited Create;
  FAction := AAction;
...
procedure TdxSearchParameters.SetOption(AOption: TdxSearchOption;
  AValue: Boolean);
begin
  if AValue then
