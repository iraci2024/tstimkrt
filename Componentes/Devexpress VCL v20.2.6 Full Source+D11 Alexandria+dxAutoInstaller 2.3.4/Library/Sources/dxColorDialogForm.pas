...
uses
  ...
  dxColorPicker, cxButtons, dxCoreGraphics,
  cxContainer, cxEdit, cxGroupBox, dxGalleryControl, dxGallery, cxClasses,
  cxGeometry, dxColorDialog, dxBevel, dxForms;
...
type
  ...
  protected
    ...
    procedure InitializePaletteItem(AItem: TdxGalleryControlItem;
    ...
    property PaletteBasicColorsGroup: TdxGalleryControlGroup
      read GetPaletteBasicColorsGroup;
    property PaletteCustomColorsGroup: TdxGalleryControlGroup
      read GetPaletteCustomColorsGroup;
  public
    constructor Create(AInvoker: TComponent; AOwnerWindow: HWND);
      reintroduce; virtual;
    ...
    property PreventShowFull: Boolean read FPreventShowFull
      write SetPreventShowFull;
...
procedure TdxColorDialogForm.LoadBasicColors(const AColors
...
procedure TdxColorDialogForm.LoadCustomColors(const AColors
  : TdxColorDialogCustomColors);
var
  AGroup: TdxGalleryControlGroup;
  I: Integer;
begin
...
procedure TdxColorDialogForm.SaveCustomColors(var AColors
  : TdxColorDialogCustomColors);
var
  AGroup: TdxGalleryControlGroup;
  I: Integer;
...
begin
  ...
  btnDefineCustomColors.Caption :=
    cxGetResourceString(@sdxColorDialogDefineCustomColor);
  btnAddToCustomColors.Caption := cxGetResourceString
    (@sdxColorDialogAddToCustomColors);
  PaletteBasicColorsGroup.Caption :=
    cxGetResourceString(@sdxColorDialogBasicColors);
  PaletteCustomColorsGroup.Caption :=
    cxGetResourceString(@sdxColorDialogCustomColors);
...
procedure TdxColorDialogForm.InitializePaletteItem(AItem: TdxGalleryControlItem;
  AAlphaColor: TdxAlphaColor);
var
  AAlpha: Byte;
  ABitmap: TcxBitmap32;
...
procedure TdxColorDialogForm.LookAndFeelChangeHandler(Sender: TcxLookAndFeel;
  AChangedValues: TcxLookAndFeelValues);
begin
  UpdateLayout;
end;
...
procedure TdxColorDialogForm.UpdateLayout;
  ...
  begin
    ...
    AButton.BoundsRect := cxRectBounds(R.Left, R.Bottom + BorderWidth,
      cxRectWidth(R), AButton.Height);
  end;
...
begin
  ...
  try
    ...
    begin
      ...
      cpColorPicker.BoundsRect := cxRectSetSize(R, cpColorPicker.Width,
        AMaxHeight);
...
begin
  InitializePaletteItem(PaletteCustomColorsGroup.Items[FCustomColorIndex],
    cpColorPicker.Color);
  FCustomColorIndex := (FCustomColorIndex + 1)
    mod PaletteCustomColorsGroup.ItemCount;
end;
...
procedure TdxColorDialogForm.gcPaletteItemClick(Sender: TObject;
