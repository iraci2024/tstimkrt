...
uses
  Types, SysUtils, Classes, StrUtils, Graphics, Generics.Defaults,
  Generics.Collections, ZLIB,
...
type
  ...
  TdxInlineDrawingObjectContent = class(TInterfacedObject,
    IdxOpenXMLDrawingObjectContent)
  strict private
  ...
  TdxFloatingObjectDrawingObject = class(TInterfacedObject,
    IdxOpenXMLDrawingObject)
  strict private
  ...
  TdxFloatingObjectDrawingObjectContent = class(TInterfacedObject,
    IdxOpenXMLDrawingObjectContent)
  strict private
  ...
  public
    constructor Create(AWidth: Integer; AHeight: Integer; ARotation: Integer;
  ...
  public const
    ...
    WordProcessingDrawingNamespace =
      'http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing';
    WordProcessingDrawing14Namespace =
      'http://schemas.microsoft.com/office/word/2010/wordprocessingDrawing';
    WordProcessingDrawingPrefix = 'wp';
    WordProcessingDrawingPrefix14 = 'wp14';
    WordProcessingDrawingNamespaceConst =
      'http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing';
    WordProcessingDrawing14NamespaceConst =
      'http://schemas.microsoft.com/office/word/2010/wordprocessingDrawing';
    DrawingMLPrefix = 'a';
    DrawingMLNamespace =
      'http://schemas.openxmlformats.org/drawingml/2006/main';
    DrawingMLPicturePrefix = 'pic';
    DrawingMLPictureNamespace =
  ...
  strict private
    ...
    FExportedImageTableStack
      : TdxObjectStack<TDictionary<TdxOfficeImage, string>>;
  ...
  protected
    ...
    function GetExportedImageTable
      : TDictionary<TdxOfficeImage, string>; override;
    ...
    function GetHorizontalPositionTypeAttributeTable
      : TdxMLDictionary<TdxFloatingObjectHorizontalPositionType>; override;
    function GetVerticalPositionTypeAttributeTable
      : TdxMLDictionary<TdxFloatingObjectVerticalPositionType>; override;
    ...
    procedure GenerateHeaderFooterRelationsContent
      (AWriter: TdxXmlWriter); virtual;
    procedure GenerateCommentRelationsContent(AWriter: TdxXmlWriter); virtual;
    procedure GenerateFileRelationsCore(AWriter: TdxXmlWriter;
      ARelationTable: TdxPairStringList; const ARelationType: string); overload;
    procedure GenerateFileRelationsCore(AWriter: TdxXmlWriter;
      ARelationTable: TdxStringsDictionary;
      const ARelationType: string); overload;
    ...
    procedure RegisterContentTypeOverride(const APartName,
      AContentType: string); virtual;
    ...
    procedure RegisterNamespace(const APrefix, ANs: string;
      AIgnorable: Boolean);
    procedure RegisterIgnorableNamespaces(const APrefixes
    ...
    procedure ExportImageReference(ARun: TdxInlinePictureRun);
      overload; override;
    procedure ExportImageReferenceCore(ARun: TdxInlinePictureRun;
      const AStartElement: string);
    function ExportImageData(AImage: TdxOfficeImageReference): string;
      overload; virtual;
    procedure ExportImageData(ARun: TdxInlinePictureRun); overload; virtual;
    function ExportImageData(AImage: TdxOfficeImage; const AImageId: string)
    ...
    procedure ExportImageReference(const AImageRelationId: string);
      overload; virtual;
    ...
    procedure ExportParagraphStyleListReference(ANumberingListIndex
      : TdxNumberingListIndex; AListLevelIndex: Integer); override;
    function HasNumberingProperties(ANumberingListIndex: TdxNumberingListIndex;
    ...
    procedure ExportAbstractNumberingList(AList: TdxAbstractNumberingList;
      AId: Integer); override;
    procedure ExportNumberingList(AList: TdxNumberingList;
      AId: Integer); override;
    procedure ExportNumberFormatValue(AProperties
      : TdxListLevelProperties); override;
    ...
    function CutNameToPermittedLength(const AName: string;
      ANamesHashSet: TdxStringSet; AMaxLength: Integer): string;
    ...
    procedure ExportHeaderCore(AWriter: TdxXmlWriter;
      AHeader: TdxSectionHeaderFooterBase); virtual;
    procedure ExportFooterCore(AWriter: TdxXmlWriter;
      AFooter: TdxSectionFooter); virtual;
    procedure ExportHeaderReference(const AType: string;
      const AHeaderRelationId: string); virtual;
    procedure ExportFooterReference(const AType: string;
      const AFooterRelationId: string); virtual;
    ...
    procedure WriteFloatingObjectAlternateContent
      (ARun: TdxFloatingObjectAnchorRun;
      ATextBoxContent: TdxTextBoxFloatingObjectContent);
    procedure WriteFloatingObjectAnchor(const ADrawingObject
      : IdxOpenXMLDrawingObject;
      const APictureContent: IdxOpenXMLDrawingObjectContent); overload;
    procedure ExportImageAsDrawing(ARun: TdxInlinePictureRun); virtual;
    procedure WriteFloatingObjectDrawing(const ADrawingObject
      : IdxOpenXMLDrawingObject;
      const APictureContent: IdxOpenXMLDrawingObjectContent); overload;
    function WriteFloatingObjectTextBoxContent2010
      (ARun: TdxFloatingObjectAnchorRun;
      ATextBoxContent: TdxTextBoxFloatingObjectContent): Integer;
    function WriteFloatingObjectDrawing(const ADrawingObject
      : IdxOpenXMLDrawingObject;
      ATextBoxContent: TdxTextBoxFloatingObjectContent): Integer; overload;
    function WriteFloatingObjectAnchor(const ADrawingObject
      : IdxOpenXMLDrawingObject;
      ATextBoxContent: TdxTextBoxFloatingObjectContent): Integer; overload;
    procedure WriteFloatingObjectTextBoxContent2007
      (ARun: TdxFloatingObjectAnchorRun;
      ATextBoxContent: TdxTextBoxFloatingObjectContent; ATextBoxId: Integer);
    procedure WriteFloatingObjectTextBoxContent
      (AContent: TdxTextBoxFloatingObjectContent;
      const ADrawingObject: IdxOpenXMLDrawingObject);
    procedure WriteFloatingObjectGraphicData
      (AContent: TdxTextBoxFloatingObjectContent;
      const ADrawingObject: IdxOpenXMLDrawingObject); overload;
    procedure WriteFloatingObjectWsp(AContent: TdxTextBoxFloatingObjectContent;
      const ADrawingObject: IdxOpenXMLDrawingObject);
    procedure WriteFloatingObjectBodyPr(AProperties: TdxTextBoxProperties);
    function ConvertTextBoxVerticalAlignment
      (AValue: TdxVerticalAlignment): string;
    procedure WriteFloatingObjectTxbx
      (AContent: TdxTextBoxFloatingObjectContent);
    procedure WriteFloatingObjectWpsSpPr(const ADrawingObject
      : IdxOpenXMLDrawingObject);
    ...
    procedure WriteFloatingObjectGraphicData(const AContent
      : IdxOpenXMLDrawingObjectContent; const ARun: IdxOpenXMLDrawingObject;
      AId: Integer); overload;
    ...
    procedure WriteFloatingObjectBlip(const AContent
      : IdxOpenXMLDrawingObjectContent);
    procedure WriteFloatingObjectStretch;
    procedure WriteFloatingObjectBlipFill(const AContent
      : IdxOpenXMLDrawingObjectContent);
    procedure WriteFloatingObjectXfrm(const ARun: IdxOpenXMLDrawingObject);
    procedure WriteFloatingObjectPrstGeom;
    procedure WriteFloatingObjectPicSpPr(const ADrawingObject
      : IdxOpenXMLDrawingObject);
    procedure WriteFloatingObjectSpPr(const ADrawingObject
      : IdxOpenXMLDrawingObject);
    procedure WriteFloatingObjectPic(const AContent
      : IdxOpenXMLDrawingObjectContent;
      const ADrawingObject: IdxOpenXMLDrawingObject; AId: Integer);
    procedure WriteInlinePictureRunContent(ARun: TdxInlinePictureRun;
      AId: Integer);
    procedure WriteFloatingObjectPictureContent(const AContent
      : IdxOpenXMLDrawingObjectContent;
      const ADrawingObject: IdxOpenXMLDrawingObject; AId: Integer);
    procedure ExportFloatingObjectProperties(const ADrawingObject
      : IdxOpenXMLDrawingObject; const AName: string; AId: Integer);
    procedure ExportInlinePictureRun(ARun: TdxInlinePictureRun;
      const AName: string; AId: Integer); overload;
    ...
    procedure WriteFloatingObjectCNvGraphicFramePr
      (const ARun: IdxOpenXMLDrawingObject);
    procedure WriteFloatingObjectGraphicFrameLocks
      (const ARun: IdxOpenXMLDrawingObject);
    ...
    procedure WriteWpDrawingElement(const ARun: IdxOpenXMLDrawingObject;
      const AElementName: string; AUseTextWrapSide: Boolean);
    procedure WriteFloatingObjectPercentWidth(ARelativeWidth
      : TdxFloatingObjectRelativeWidth);
    function ConvertFloatingObjectRelativeFromHorizontalType
      (AValue: TdxFloatingObjectRelativeFromHorizontal): string;
    procedure WriteFloatingObjectPercentHeight(ARelativeHeight
      : TdxFloatingObjectRelativeHeight);
    function ConvertFloatingObjectRelativeFromVerticalType
      (AValue: TdxFloatingObjectRelativeFromVertical): string;
    procedure WriteFloatingObjectPercentPositionV2010(const ADrawingObject
      : IdxOpenXMLDrawingObject);
    procedure WriteFloatingObjectPositionV(const ADrawingObject
      : IdxOpenXMLDrawingObject);
    procedure WriteFloatingObjectPositionVCore(const ADrawingObject
      : IdxOpenXMLDrawingObject; const AWriteVerticalOffsetAction
      : TdxAction<IdxOpenXMLDrawingObject>);
    procedure WriteFloatingObjectVerticalOffset(const ADrawingObject
      : IdxOpenXMLDrawingObject);
    procedure WriteFloatingObjectPercentVerticalOffset(const ADrawingObject
      : IdxOpenXMLDrawingObject);
    procedure WriteFloatingObjectVerticalPositionAlignment(const ADrawingObject
      : IdxOpenXMLDrawingObject);
    function ConvertFloatingObjectVerticalPositionAlignment
      (AValue: TdxFloatingObjectVerticalPositionAlignment): string;
    function ConvertFloatingObjectHorizontalPositionAlignment
      (AValue: TdxFloatingObjectHorizontalPositionAlignment): string;
    function ConvertFloatingObjectVerticalPositionType
      (AValue: TdxFloatingObjectVerticalPositionType): string;
    function ConvertFloatingObjectHorizontalPositionType
      (AValue: TdxFloatingObjectHorizontalPositionType): string;
    function ConvertFloatingObjectTextWrapSide
      (AValue: TdxFloatingObjectTextWrapSide): string;
    procedure WriteFloatingObjectPercentPositionH2010(const ADrawingObject
      : IdxOpenXMLDrawingObject);
    procedure WriteFloatingObjectPositionH(const ADrawingObject
      : IdxOpenXMLDrawingObject);
    procedure WriteFloatingObjectPositionHCore(const ADrawingObject
      : IdxOpenXMLDrawingObject; const AWriteHorizontalOffsetAction
      : TdxAction<IdxOpenXMLDrawingObject>);
    procedure WriteFloatingObjectHorizontalPositionAlignment
      (const ADrawingObject: IdxOpenXMLDrawingObject);
    procedure WriteFloatingObjectHorizontalOffset(const ADrawingObject
      : IdxOpenXMLDrawingObject);
    procedure WriteFloatingObjectPercentHorizontalOffset(const ADrawingObject
      : IdxOpenXMLDrawingObject);
    procedure WriteFloatingObjectExtent(const ADrawingObject
      : IdxOpenXMLDrawingObject);
    ...
    procedure WriteFloatingObjectEffectExtent
      (const ARun: IdxOpenXMLDrawingObject);
    ...
    function GetWordProcessingMLValue(AValue: TdxWordProcessingMLValue)
      : string; override;
    ...
    property HyperlinkRelationsTable: TdxPairStringList
      read FHyperlinkRelationsTable;
    ...
    property OverriddenContentTypes: TdxPairStringList
      read GetOverriddenContentTypes;
    property ImageRelationsTableStack: TdxObjectStack<TdxStringsDictionary>
      read FImageRelationsTableStack;
    property ExportedImageTableStack: TdxObjectStack < TDictionary <
      TdxOfficeImage, string >> read FExportedImageTableStack;
    property ImageRelationsTable: TdxStringsDictionary
      read GetImageRelationsTable;
    ...
    property FootNoteRelationsTable: TdxPairStringList
      read FFootNoteRelationsTable;
    property EndNoteRelationsTable: TdxPairStringList
      read FEndNoteRelationsTable;
    property CommentRelationsTable: TdxPairStringList
      read FCommentRelationsTable;
...
function TdxInlineDrawingObject.GetHorizontalPositionAlignment
  : TdxFloatingObjectHorizontalPositionAlignment;
begin
  Result := TdxFloatingObjectHorizontalPositionAlignment.None;
end;

function TdxInlineDrawingObject.GetHorizontalPositionType
...
function TdxInlineDrawingObject.GetVerticalPositionAlignment
  : TdxFloatingObjectVerticalPositionAlignment;
begin
  Result := TdxFloatingObjectVerticalPositionAlignment.None;
end;

function TdxInlineDrawingObject.GetVerticalPositionType
...
function TdxInlineDrawingObject.GetRelativeWidth
  : TdxFloatingObjectRelativeWidth;
begin
  Result := TdxFloatingObjectRelativeWidth.CreateEmpty;
end;

function TdxInlineDrawingObject.GetRelativeHeight
  : TdxFloatingObjectRelativeHeight;
begin
...
constructor TdxInlineDrawingObjectContent.Create
...
constructor TdxFloatingObjectDrawingObject.Create
  (ARun: TdxFloatingObjectAnchorRun);
begin
  FRun := ARun;
end;
...
function TdxFloatingObjectDrawingObject.GetHorizontalPositionAlignment
  : TdxFloatingObjectHorizontalPositionAlignment;
begin
...
function TdxFloatingObjectDrawingObject.GetVerticalPositionAlignment
  : TdxFloatingObjectVerticalPositionAlignment;
begin
...
function TdxFloatingObjectDrawingObject.GetTextWrapType
  : TdxFloatingObjectTextWrapType;
begin
  Result := FRun.FloatingObjectProperties.TextWrapType;
end;

function TdxFloatingObjectDrawingObject.GetTextWrapSide
...
function TdxFloatingObjectDrawingObject.GetRelativeWidth
  : TdxFloatingObjectRelativeWidth;
begin
  Result := FRun.FloatingObjectProperties.RelativeWidth;
end;

function TdxFloatingObjectDrawingObject.GetRelativeHeight
  : TdxFloatingObjectRelativeHeight;
begin
  Result := FRun.FloatingObjectProperties.RelativeHeight;
end;

function TdxFloatingObjectDrawingObject.GetHorizontalPositionType
  : TdxFloatingObjectHorizontalPositionType;
begin
  Result := FRun.FloatingObjectProperties.HorizontalPositionType;
end;

function TdxFloatingObjectDrawingObject.GetVerticalPositionType
  : TdxFloatingObjectVerticalPositionType;
begin
...
constructor TdxFloatingObjectDrawingObjectContent.Create
  (AContent: TdxPictureFloatingObjectContent);
begin
  FContent := AContent;
end;

function TdxFloatingObjectDrawingObjectContent.GetImage
...
function TdxPairStringList.TryGetValue(const AKey: string;
...
constructor TdxEffectExtent.Create(AWidth: Integer; AHeight: Integer;
  ARotation: Integer; AUnitConverter: TdxDocumentModelUnitConverter);
begin
  FWidth := AWidth;
  FHeight := AHeight;
  FRotation := ARotation;
...
function TdxOpenXmlExporter.GetExportedImageTable
  : TDictionary<TdxOfficeImage, string>;
begin
...
function TdxOpenXmlExporter.GetHorizontalPositionTypeAttributeTable
  : TdxMLDictionary<TdxFloatingObjectHorizontalPositionType>;
begin
  Result := TdxInlineObjectDestination.
    OpenXmlHorizontalPositionTypeAttributeTable;
end;

function TdxOpenXmlExporter.GetVerticalPositionTypeAttributeTable
  : TdxMLDictionary<TdxFloatingObjectVerticalPositionType>;
begin
  Result := TdxInlineObjectDestination.
    OpenXmlVerticalPositionTypeAttributeTable;
end;
...
begin
  ...
  begin
    ...
    try
      Export;
      TdxOLECryptoContainer.Encrypt(FOutputStream, AStream,
...
begin
  ...
  AddCompressedPackageContent('word\_rels\document.xml.rels',
    ExportDocumentRelations);
end;
...
begin
  ...
  if (FFootNotes.Count > 0) and DocumentModel.DocumentCapabilities.FootNotesAllowed
  then
  begin
    AddCompressedPackageContent('word\footnotes.xml', ExportFootNotes);
    RegisterContentTypeOverride('/word/footnotes.xml',
      'application/vnd.openxmlformats-officedocument.wordprocessingml.footnotes+xml');
    FootNoteRelationsTable.Add('RelFnt1', 'footnotes.xml');
  end;
  if (FEndNotes.Count > 0) and DocumentModel.DocumentCapabilities.EndNotesAllowed
  then
  begin
    AddCompressedPackageContent('word\endnotes.xml', ExportEndNotes);
    RegisterContentTypeOverride('/word/endnotes.xml',
...
begin
  ...
  RegisterContentTypeOverride('/word/webSettings.xml',
...
procedure TdxOpenXmlExporter.GenerateWebSettingsContent
  (AXmlWriter: TdxXmlWriter);
var
  AWebSettings: TdxWebSettings;
begin
  ...
  try
    ...
    try
      ...
      WriteWpIntValue('marLeft', UnitConverter.ModelUnitsToTwips
        (AWebSettings.LeftMargin));
      WriteWpIntValue('marRight',
        UnitConverter.ModelUnitsToTwips(AWebSettings.RightMargin));
      WriteWpIntValue('marTop', UnitConverter.ModelUnitsToTwips
        (AWebSettings.TopMargin));
      WriteWpIntValue('marBottom',
        UnitConverter.ModelUnitsToTwips(AWebSettings.BottomMargin));
    finally
      WriteWpEndElement;
    end;
  finally
...
begin
  ...
  FExportedImageTableStack := TdxObjectStack < TDictionary < TdxOfficeImage,
    string >>.Create(True);
  ...
  FUsedContentTypes.Add('rels',
    'application/vnd.openxmlformats-package.relationships+xml');
  RegisterContentTypeOverride('/word/document.xml',
...
procedure TdxOpenXmlExporter.GenerateDocumentRelationsContent
...
procedure TdxOpenXmlExporter.GenerateHeaderFooterRelationsContent
  (AWriter: TdxXmlWriter);
begin
  AWriter.WriteStartElement('Relationships', PackageRelsNamespace);
  GenerateFileRelationsCore(AWriter, ImageRelationsTable, RelsImage);
...
procedure TdxOpenXmlExporter.GenerateCommentRelationsContent
  (AWriter: TdxXmlWriter);
begin
  AWriter.WriteStartElement('Relationships', PackageRelsNamespace);
  GenerateFileRelationsCore(AWriter, ImageRelationsTable, RelsImage);
...
procedure TdxOpenXmlExporter.GenerateFileRelationsCore(AWriter: TdxXmlWriter;
  ARelationTable: TdxPairStringList; const ARelationType: string);
var
  ARelation: TdxPairString;
begin
...
procedure TdxOpenXmlExporter.GeneratePackageRelationsContent
  (AWriter: TdxXmlWriter);
begin
  AWriter.WriteStartElement('Relationships', PackageRelsNamespace);
  AWriter.WriteStartElement('Relationship');
...
var
  APair: TdxPairString;
begin
  RegisterContentTypeOverride('/word/styles.xml',
    'application/vnd.openxmlformats-officedocument.wordprocessingml.styles+xml');
  RegisterContentTypeOverride('/word/settings.xml',
    'application/vnd.openxmlformats-officedocument.wordprocessingml.settings+xml');
  RegisterContentTypeOverride('/word/numbering.xml',
...
procedure TdxOpenXmlExporter.RegisterContentTypeOverride(const APartName,
  AContentType: string);
begin
...
begin
  ...
  RegisterNamespace(WordProcessingDrawingPrefix14,
    WordProcessingDrawing14Namespace, True);
end;

procedure TdxOpenXmlExporter.RegisterNamespace(const APrefix, ANs: string;
  AIgnorable: Boolean);
begin
...
procedure TdxOpenXmlExporter.RegisterIgnorableNamespaces(const APrefixes
  : TArray<string>);
begin
  DocumentContentWriter.WriteAttributeString('mc', 'Ignorable', '',
    TdxStringHelper.Join(' ', APrefixes));
end;
...
procedure TdxOpenXmlExporter.ExportParagraphListReference
  (AParagraph: TdxParagraph);
begin
  WriteWpStartElement('numPr');
  try
    WriteWpIntValue('ilvl', AParagraph.GetListLevelIndex);
    WriteWpIntValue('numId', GetNumberingListIndexForExport
      (AParagraph.GetOwnNumberingListIndex));
  finally
    WriteWpEndElement;
  end;
end;
...
procedure TdxOpenXmlExporter.ExportImageReferenceCore(ARun: TdxInlinePictureRun;
  const AStartElement: string);
var
  ...
  try
    ...
    try
      ...
      AFinalHeight := UnitConverter.ModelUnitsToPointsF
        (ARun.ActualSizeF.Height);
      AImageStyle := TdxStringHelper.Format('width:%gpt;height:%gpt',
        [AFinalWidth, AFinalHeight]);
...
function TdxOpenXmlExporter.ExportImageData
  (AImage: TdxOfficeImageReference): string;
var
...
function TdxOpenXmlExporter.ExportImageData(AImage: TdxOfficeImage;
...
function TdxOpenXmlExporter.GetImageFileName(const AImageId,
...
function TdxOpenXmlExporter.GetImagePath(const AImageId,
  AExtension: string): string;
begin
  if DocumentModel.DocumentExportOptions.OpenXML.AlternateImageFolder then
    Result := '/word/media/' + AImageId + '.' + AExtension
...
procedure TdxOpenXmlExporter.ExportImageReference
  (const AImageRelationId: string);
begin
  DocumentContentWriter.WriteStartElement(VMLPrefix, 'imagedata', VMLNamespace);
  try
    DocumentContentWriter.WriteAttributeString(RelsPrefix, 'id', RelsNamespace,
      AImageRelationId);
...
begin
  ...
  try
    ...
    try
      ExportParagraphPropertiesCore(DocumentModel.DefaultParagraphProperties,
        True, nil, nil, nil);
    finally
      WriteWpEndElement;
    end;
...
procedure TdxOpenXmlExporter.ExportParagraphStyleListReference
...
begin
  ...
  try
    ...
    if (ANumberingListIndex >= NumberingListIndexMinValue) or
...
function TdxOpenXmlExporter.HasNumberingProperties(ANumberingListIndex
  : TdxNumberingListIndex; AListLevelIndex: Integer): Boolean;
begin
  Result := (ANumberingListIndex >= NumberingListIndexMinValue) or
    (ANumberingListIndex = NumberingListIndexNoNumberingList) or
    (AListLevelIndex > 0);
end;
...
procedure TdxOpenXmlExporter.ExportAbstractNumberingList
  (AList: TdxAbstractNumberingList; AId: Integer);
var
...
begin
  ...
  try
    ...
    WriteWpStringValue('multiLevelType',
      ConvertNumberingListType(TdxNumberingListHelper.GetListType(AList)));
    AStyleLinkIndex := AList.StyleLinkIndex;
    ANumberingStyleReferenceIndex := AList.NumberingStyleReferenceIndex;
    AShouldExportLevels := (AStyleLinkIndex >= 0) or
      (ANumberingStyleReferenceIndex < 0);
    ...
    else if ANumberingStyleReferenceIndex >= 0 then
    begin
      WriteWpStringValue('tmpl', ConvertToHexBinary(AList.TemplateCode));
...
procedure TdxOpenXmlExporter.ExportNumberingList(AList: TdxNumberingList;
  AId: Integer);
begin
...
procedure TdxOpenXmlExporter.ExportNumberFormatValue
...
begin
  ...
  if (AProperties.PasswordHash = nil) or (Length(AProperties.PasswordHash) <= 0)
  then
    Exit;
  ...
  WriteWpStringAttr('cryptSpinCount',
    IntToStr(Max(1, AProperties.HashIterationCount)));
  if AProperties.PasswordHash <> nil then
    WriteWpStringAttr('hash',
      TdxBase64.ToBase64String(AProperties.PasswordHash));
  if AProperties.PasswordPrefix <> nil then
    WriteWpStringAttr('salt',
      TdxBase64.ToBase64String(AProperties.PasswordPrefix));
end;
...
begin
  if not DocumentModel.DocumentExportOptions.OpenXML.LimitFontNameTo31Chars or
    (Length(AName) <= MaxFontNameLength) then
    Exit(AName);
...
begin
  if not DocumentModel.DocumentExportOptions.OpenXML.LimitBookmarkNameTo40Chars
    or (Length(AName) <= MaxBookmarkNameLength) then
    Exit(AName);
  Result := CutNameToPermittedLength(AName, FBookmarkNames,
    MaxBookmarkNameLength);
end;

function TdxOpenXmlExporter.PrepareStyleName(const AName: string): string;
begin
  if not DocumentModel.DocumentExportOptions.OpenXML.LimitStyleNameTo253Chars or
    (Length(AName) <= MaxStyleNameLength) then
    Exit(AName);
  Result := CutNameToPermittedLength(AName, FStyleNames, MaxStyleNameLength);
end;

function TdxOpenXmlExporter.CutNameToPermittedLength(const AName: string;
  ANamesHashSet: TdxStringSet; AMaxLength: Integer): string;
var
  AIndex: Integer;
  AIndexStr: string;
...
procedure TdxOpenXmlExporter.ExportFirstPageHeader(ASectionHeader
...
procedure TdxOpenXmlExporter.ExportOddPageHeader(ASectionHeader
  : TdxSectionHeader; ALinkedToPrevious: Boolean);
var
  ARelationId: string;
begin
...
procedure TdxOpenXmlExporter.ExportEvenPageHeader(ASectionHeader
  : TdxSectionHeader; ALinkedToPrevious: Boolean);
var
  ARelationId: string;
begin
...
procedure TdxOpenXmlExporter.ExportFirstPageFooter(ASectionFooter
...
procedure TdxOpenXmlExporter.ExportOddPageFooter(ASectionFooter
  : TdxSectionFooter; ALinkedToPrevious: Boolean);
var
  ARelationId: string;
begin
...
procedure TdxOpenXmlExporter.ExportEvenPageFooter(ASectionFooter
  : TdxSectionFooter; ALinkedToPrevious: Boolean);
var
  ARelationId: string;
begin
...
begin
  ...
  try
    ...
    RegisterContentTypeOverride('/word/' + AFileName,
...
procedure TdxOpenXmlExporter.GenerateFileRelationsCore(AWriter: TdxXmlWriter;
ARelationTable: TdxStringsDictionary; const ARelationType: string);
var
...
procedure TdxOpenXmlExporter.ExportHeaderCore(AWriter: TdxXmlWriter;
AHeader: TdxSectionHeaderFooterBase);
var
...
begin
  ...
  try
    ...
    try
      RegisterNamespaces;
      PerformExportPieceTable(TdxPieceTable(AHeader.PieceTable),
        ExportPieceTable);
    finally
      WriteWpEndElement;
    end;
...
procedure TdxOpenXmlExporter.ExportFooterCore(AWriter: TdxXmlWriter;
...
begin
  ...
  try
    ...
    try
      RegisterNamespaces;
      PerformExportPieceTable(TdxPieceTable(AFooter.PieceTable),
        ExportPieceTable);
    finally
      WriteWpEndElement;
    end;
...
procedure TdxOpenXmlExporter.ExportHeaderReference(const AType: string;
const AHeaderRelationId: string);
begin
...
procedure TdxOpenXmlExporter.ExportFooterReference(const AType: string;
const AFooterRelationId: string);
begin
...
begin
  ...
  try
    ...
    for I := 0 to ACount - 1 do
      ExportFootNoteCore(DocumentContentWriter, FFootNotes[I],
        DocumentModel.FootNotes.IndexOf(FFootNotes[I]));
  finally
    WriteWpEndElement;
  end;
end;
...
begin
  ...
  try
    ...
    for I := 0 to ACount - 1 do
      ExportEndNoteCore(DocumentContentWriter, FEndNotes[I],
        DocumentModel.EndNotes.IndexOf(FEndNotes[I]));
  finally
    WriteWpEndElement;
  end;
end;
...
begin
  ...
  DocumentContentWriter.WriteStartElement(WordProcessingDrawingPrefix14,
    ATag, '');
end;

procedure TdxOpenXmlExporter.WriteWpDrawingStartElement(const ATag: string);
begin
  DocumentContentWriter.WriteStartElement(WordProcessingDrawingPrefix, ATag,
    WordProcessingDrawingNamespace);
end;

procedure TdxOpenXmlExporter.WriteADrawingStartElement(const ATag: string);
begin
  DocumentContentWriter.WriteStartElement(DrawingMLPrefix, ATag,
    DrawingMLNamespace);
end;

procedure TdxOpenXmlExporter.WritePicDrawingStartElement(const ATag: string);
begin
  DocumentContentWriter.WriteStartElement(DrawingMLPicturePrefix, ATag,
    DrawingMLPictureNamespace);
end;
...
procedure TdxOpenXmlExporter.ExportFloatingObjectAnchorRun
  (ARun: TdxFloatingObjectAnchorRun);
var
...
procedure TdxOpenXmlExporter.WriteFloatingObjectAlternateContent
  (ARun: TdxFloatingObjectAnchorRun;
ATextBoxContent: TdxTextBoxFloatingObjectContent);
var
  ATextBoxId: Integer;
...
procedure TdxOpenXmlExporter.WriteFloatingObjectAnchor(const ADrawingObject
  : IdxOpenXMLDrawingObject;
...
begin
  ...
  try
    ...
    AName := GenerateFloatingObjectName(ADrawingObject.Name, 'Picture',
      DrawingElementId);
...
procedure TdxOpenXmlExporter.WriteFloatingObjectDrawing(const ADrawingObject
  : IdxOpenXMLDrawingObject;
const APictureContent: IdxOpenXMLDrawingObjectContent);
begin
...
function TdxOpenXmlExporter.WriteFloatingObjectTextBoxContent2010
  (ARun: TdxFloatingObjectAnchorRun;
ATextBoxContent: TdxTextBoxFloatingObjectContent): Integer;
var
...
function TdxOpenXmlExporter.WriteFloatingObjectDrawing(const ADrawingObject
  : IdxOpenXMLDrawingObject;
ATextBoxContent: TdxTextBoxFloatingObjectContent): Integer;
begin
  WriteWpStartElement('drawing');
...
function TdxOpenXmlExporter.WriteFloatingObjectAnchor(const ADrawingObject
  : IdxOpenXMLDrawingObject;
ATextBoxContent: TdxTextBoxFloatingObjectContent): Integer;
var
  AName: string;
begin
  ...
  try
    ...
    AName := GenerateFloatingObjectName(ADrawingObject.Name, 'Text Box',
      DrawingElementId);
    IncrementDrawingElementId;
...
procedure TdxOpenXmlExporter.WriteFloatingObjectTextBoxContent2007
  (ARun: TdxFloatingObjectAnchorRun;
ATextBoxContent: TdxTextBoxFloatingObjectContent; ATextBoxId: Integer);
var
  AName: string;
begin
  ...
  try
    ...
    WriteFloatingObjectPict(ARun.FloatingObjectProperties, ATextBoxContent, nil,
      ARun.Shape, AName);
  finally
    WriteMcEndElement;
  end;
...
procedure TdxOpenXmlExporter.WriteFloatingObjectTextBoxContent
  (AContent: TdxTextBoxFloatingObjectContent;
const ADrawingObject: IdxOpenXMLDrawingObject);
begin
...
procedure TdxOpenXmlExporter.WriteFloatingObjectGraphicData
  (AContent: TdxTextBoxFloatingObjectContent;
const ADrawingObject: IdxOpenXMLDrawingObject);
begin
...
procedure TdxOpenXmlExporter.WriteFloatingObjectWsp
  (AContent: TdxTextBoxFloatingObjectContent;
const ADrawingObject: IdxOpenXMLDrawingObject);
begin
...
procedure TdxOpenXmlExporter.WriteFloatingObjectBodyPr
...
begin
  ...
  try
    ...
    if AProperties.UseLeftMargin then
      WriteIntValue('lIns', UnitConverter.ModelUnitsToEMU
        (AProperties.LeftMargin));
    if AProperties.UseTopMargin then
      WriteIntValue('tIns', UnitConverter.ModelUnitsToEMU
        (AProperties.TopMargin));
    if AProperties.UseRightMargin then
      WriteIntValue('rIns', UnitConverter.ModelUnitsToEMU
        (AProperties.RightMargin));
    if AProperties.UseBottomMargin then
      WriteIntValue('bIns', UnitConverter.ModelUnitsToEMU
        (AProperties.BottomMargin));
    if AProperties.UseVerticalAlignment then
      WriteStringValue('anchor', ConvertTextBoxVerticalAlignment
        (AProperties.VerticalAlignment));
...
function TdxOpenXmlExporter.ConvertTextBoxVerticalAlignment
  (AValue: TdxVerticalAlignment): string;
var
...
begin
  if TextBoxVerticalAlignmentTable.TryGetValue(AValue, AResult) then
    ...
    Exit(GetWordProcessingMLValue(VerticalAlignmentTable
      [TdxVerticalAlignment.Top]));
end;

procedure TdxOpenXmlExporter.WriteFloatingObjectTxbx
  (AContent: TdxTextBoxFloatingObjectContent);
begin
...
procedure TdxOpenXmlExporter.WriteFloatingObjectWpsSpPr(const ADrawingObject
  : IdxOpenXMLDrawingObject);
begin
...
procedure TdxOpenXmlExporter.WriteFloatingObjectSolidFill
...
procedure TdxOpenXmlExporter.WriteFloatingObjectGraphicData(const AContent
  : IdxOpenXMLDrawingObjectContent; const ARun: IdxOpenXMLDrawingObject;
AId: Integer);
begin
  WriteADrawingStartElement('graphicData');
...
procedure TdxOpenXmlExporter.WriteFloatingObjectExt
  (const ARun: IdxOpenXMLDrawingObject);
begin
  WriteADrawingStartElement('ext');
  try
    WriteIntValue('cx', DocumentModel.UnitConverter.ModelUnitsToEMU(Max(0,
      ARun.ActualSize.Width)));
    WriteIntValue('cy', DocumentModel.UnitConverter.ModelUnitsToEMU(Max(0,
      ARun.ActualSize.Height)));
  finally
    WriteADrawingEndElement;
  end;
end;
...
procedure TdxOpenXmlExporter.WriteFloatingObjectBlip(const AContent
  : IdxOpenXMLDrawingObjectContent);
var
  AImageRelationId: string;
begin
...
procedure TdxOpenXmlExporter.WriteFloatingObjectBlipFill(const AContent
  : IdxOpenXMLDrawingObjectContent);
begin
...
procedure TdxOpenXmlExporter.WriteFloatingObjectXfrm
  (const ARun: IdxOpenXMLDrawingObject);
begin
...
procedure TdxOpenXmlExporter.WriteFloatingObjectPicSpPr(const ADrawingObject
  : IdxOpenXMLDrawingObject);
begin
...
procedure TdxOpenXmlExporter.WriteFloatingObjectSpPr(const ADrawingObject
  : IdxOpenXMLDrawingObject);
var
...
procedure TdxOpenXmlExporter.WriteFloatingObjectPic(const AContent
  : IdxOpenXMLDrawingObjectContent;
const ADrawingObject: IdxOpenXMLDrawingObject; AId: Integer);
begin
...
procedure TdxOpenXmlExporter.WriteInlinePictureRunContent
  (ARun: TdxInlinePictureRun; AId: Integer);
begin
  WriteADrawingStartElement('graphic');
  try
  finally
...
procedure TdxOpenXmlExporter.WriteFloatingObjectPictureContent
  (const AContent: IdxOpenXMLDrawingObjectContent;
const ADrawingObject: IdxOpenXMLDrawingObject; AId: Integer);
begin
  WriteADrawingStartElement('graphic');
  try
...
procedure TdxOpenXmlExporter.ExportFloatingObjectProperties(const ADrawingObject
  : IdxOpenXMLDrawingObject; const AName: string; AId: Integer);
begin
  if ADrawingObject.IsFloatingObject then
  begin
    ...
    if ADrawingObject.UseBottomDistance and (ADrawingObject.BottomDistance > 0)
    then
    ...
    if ADrawingObject.UseRightDistance and (ADrawingObject.RightDistance > 0)
    then
    ...
    if (ADrawingObject.HorizontalPositionAlignment =
      TdxFloatingObjectHorizontalPositionAlignment.None) and
      ADrawingObject.UsePercentOffset and (ADrawingObject.PercentOffsetX <> 0)
    then
      WriteFloatingObjectPercentPositionH2010(ADrawingObject)
    else
      WriteFloatingObjectPositionH(ADrawingObject);
    if (ADrawingObject.VerticalPositionAlignment =
      TdxFloatingObjectVerticalPositionAlignment.None) and
      ADrawingObject.UsePercentOffset and (ADrawingObject.PercentOffsetY <> 0)
    then
...
procedure TdxOpenXmlExporter.ExportInlinePictureRun(ARun: TdxInlinePictureRun;
...
procedure TdxOpenXmlExporter.ExportRelativeSize
  (const ARun: IdxOpenXMLDrawingObject);
begin
...
procedure TdxOpenXmlExporter.WriteInlinePictureCNvGraphicFramePr
...
procedure TdxOpenXmlExporter.WriteInlinePictureGraphicFrameLocks
  (ARun: TdxInlinePictureRun);
begin
...
procedure TdxOpenXmlExporter.WriteFloatingObjectCNvGraphicFramePr
  (const ARun: IdxOpenXMLDrawingObject);
begin
...
procedure TdxOpenXmlExporter.WriteFloatingObjectGraphicFrameLocks
  (const ARun: IdxOpenXMLDrawingObject);
begin
  WriteADrawingStartElement('graphicFrameLocks');
  try
...
procedure TdxOpenXmlExporter.WriteInlinePictureDocPr(const AName: string;
AId: Integer);
begin
  WriteElementDocPrCore(AName, AId);
end;

procedure TdxOpenXmlExporter.WriteFloatingObjectDocPr(const AName: string;
AId: Integer);
begin
...
procedure TdxOpenXmlExporter.WriteElementDocPrCore(const AName: string;
AId: Integer);
begin
...
procedure TdxOpenXmlExporter.WriteFloatingObjectWrap
  (const ARun: IdxOpenXMLDrawingObject);
var
...
begin
  ...
  if FloatingObjectTextWrapTypeTable.TryGetValue(ARun.TextWrapType,
    ATextWrapType) then
  begin
...
procedure TdxOpenXmlExporter.WriteWpWrapPolygonElement
  (const ARun: IdxOpenXMLDrawingObject);
begin
  if (ARun.TextWrapType <> TdxFloatingObjectTextWrapType.Through) and
    (ARun.TextWrapType <> TdxFloatingObjectTextWrapType.Tight) then
    Exit;
...
procedure TdxOpenXmlExporter.WriteWpLineToDrawingElement(X: Integer;
Y: Integer);
begin
...
procedure TdxOpenXmlExporter.WriteWpDrawingElement
  (const ARun: IdxOpenXMLDrawingObject; const AElementName: string;
AUseTextWrapSide: Boolean);
begin
  WriteWpDrawingStartElement(AElementName);
  try
    if AUseTextWrapSide then
      WriteStringValue('wrapText', ConvertFloatingObjectTextWrapSide
        (ARun.TextWrapSide));
...
procedure TdxOpenXmlExporter.WriteFloatingObjectPercentWidth(ARelativeWidth
  : TdxFloatingObjectRelativeWidth);
begin
  WriteWp14DrawingStartElement('sizeRelH');
  try
    WriteStringValue('relativeFrom',
      ConvertFloatingObjectRelativeFromHorizontalType(ARelativeWidth.From));
...
function TdxOpenXmlExporter.ConvertFloatingObjectRelativeFromHorizontalType
  (AValue: TdxFloatingObjectRelativeFromHorizontal): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FloatingObjectRelativeFromHorizontalTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue(FloatingObjectRelativeFromHorizontalTable
      [TdxFloatingObjectRelativeFromHorizontal.Page]);
end;

procedure TdxOpenXmlExporter.WriteFloatingObjectPercentHeight(ARelativeHeight
  : TdxFloatingObjectRelativeHeight);
begin
  WriteWp14DrawingStartElement('sizeRelV');
  try
    WriteStringValue('relativeFrom',
      ConvertFloatingObjectRelativeFromVerticalType(ARelativeHeight.From));
...
function TdxOpenXmlExporter.ConvertFloatingObjectRelativeFromVerticalType
  (AValue: TdxFloatingObjectRelativeFromVertical): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FloatingObjectRelativeFromVerticalTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue(FloatingObjectRelativeFromVerticalTable
      [TdxFloatingObjectRelativeFromVertical.Page]);
end;

procedure TdxOpenXmlExporter.WriteFloatingObjectPercentPositionV2010
  (const ADrawingObject: IdxOpenXMLDrawingObject);
begin
  WriteMcStartElement('AlternateContent');
  WriteMcStartElement('Choice');
  ...
  WriteFloatingObjectPositionVCore(ADrawingObject,
    WriteFloatingObjectPercentVerticalOffset);
  WriteMcEndElement;
  WriteMcStartElement('Fallback');
  WriteFloatingObjectPositionV(ADrawingObject);
  WriteMcEndElement;
...
procedure TdxOpenXmlExporter.WriteFloatingObjectPositionV(const ADrawingObject
  : IdxOpenXMLDrawingObject);
begin
  WriteFloatingObjectPositionVCore(ADrawingObject,
    WriteFloatingObjectVerticalOffset);
end;

procedure TdxOpenXmlExporter.WriteFloatingObjectPositionVCore
  (const ADrawingObject: IdxOpenXMLDrawingObject;
const AWriteVerticalOffsetAction: TdxAction<IdxOpenXMLDrawingObject>);
begin
  WriteWpDrawingStartElement('positionV');
  try
    WriteStringValue('relativeFrom', ConvertFloatingObjectVerticalPositionType
      (ADrawingObject.VerticalPositionType));
...
procedure TdxOpenXmlExporter.WriteFloatingObjectVerticalOffset
  (const ADrawingObject: IdxOpenXMLDrawingObject);
begin
  WriteWpDrawingStartElement('posOffset');
  DocumentContentWriter.WriteString
    (IntToStr(DocumentModel.UnitConverter.ModelUnitsToEMU
    (ADrawingObject.Offset.Y)));
  WriteWpDrawingEndElement;
end;

procedure TdxOpenXmlExporter.WriteFloatingObjectPercentVerticalOffset
  (const ADrawingObject: IdxOpenXMLDrawingObject);
begin
...
procedure TdxOpenXmlExporter.WriteFloatingObjectVerticalPositionAlignment
  (const ADrawingObject: IdxOpenXMLDrawingObject);
begin
  WriteWpDrawingStartElement('align');
  try
    DocumentContentWriter.WriteString
      (ConvertFloatingObjectVerticalPositionAlignment
      (ADrawingObject.VerticalPositionAlignment));
  finally
    WriteWpDrawingEndElement;
  end;
end;

function TdxOpenXmlExporter.ConvertFloatingObjectVerticalPositionAlignment
  (AValue: TdxFloatingObjectVerticalPositionAlignment): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FloatingObjectVerticalPositionAlignmentTable.TryGetValue(AValue, AResult)
  then
    Result := GetWordProcessingMLValue(AResult)
  else
    Result := '';
...
function TdxOpenXmlExporter.ConvertFloatingObjectHorizontalPositionAlignment
  (AValue: TdxFloatingObjectHorizontalPositionAlignment): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FloatingObjectHorizontalPositionAlignmentTable.TryGetValue(AValue, AResult)
  then
    Result := GetWordProcessingMLValue(AResult)
  else
    Result := '';
...
function TdxOpenXmlExporter.ConvertFloatingObjectVerticalPositionType
  (AValue: TdxFloatingObjectVerticalPositionType): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FloatingObjectVerticalPositionTypeTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue(FloatingObjectVerticalPositionTypeTable
      [TdxFloatingObjectVerticalPositionType.Page]);
end;

function TdxOpenXmlExporter.ConvertFloatingObjectHorizontalPositionType
  (AValue: TdxFloatingObjectHorizontalPositionType): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FloatingObjectHorizontalPositionTypeTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue(FloatingObjectHorizontalPositionTypeTable
      [TdxFloatingObjectHorizontalPositionType.Page]);
end;

function TdxOpenXmlExporter.ConvertFloatingObjectTextWrapSide
  (AValue: TdxFloatingObjectTextWrapSide): string;
var
  AResult: TdxWordProcessingMLValue;
begin
  if FloatingObjectTextWrapSideTable.TryGetValue(AValue, AResult) then
    ...
    Result := GetWordProcessingMLValue(FloatingObjectTextWrapSideTable
      [TdxFloatingObjectTextWrapSide.Both]);
end;

procedure TdxOpenXmlExporter.WriteFloatingObjectPercentPositionH2010
  (const ADrawingObject: IdxOpenXMLDrawingObject);
begin
  WriteMcStartElement('AlternateContent');
  WriteMcStartElement('Choice');
  ...
  WriteFloatingObjectPositionHCore(ADrawingObject,
    WriteFloatingObjectPercentHorizontalOffset);
  WriteMcEndElement;
  WriteMcStartElement('Fallback');
  WriteFloatingObjectPositionH(ADrawingObject);
  WriteMcEndElement;
...
procedure TdxOpenXmlExporter.WriteFloatingObjectPositionH(const ADrawingObject
  : IdxOpenXMLDrawingObject);
begin
  WriteFloatingObjectPositionHCore(ADrawingObject,
    WriteFloatingObjectHorizontalOffset);
end;

procedure TdxOpenXmlExporter.WriteFloatingObjectPositionHCore
  (const ADrawingObject: IdxOpenXMLDrawingObject;
const AWriteHorizontalOffsetAction: TdxAction<IdxOpenXMLDrawingObject>);
begin
  WriteWpDrawingStartElement('positionH');
  try
    WriteStringValue('relativeFrom', ConvertFloatingObjectHorizontalPositionType
      (ADrawingObject.HorizontalPositionType));
...
procedure TdxOpenXmlExporter.WriteFloatingObjectHorizontalPositionAlignment
  (const ADrawingObject: IdxOpenXMLDrawingObject);
begin
  WriteWpDrawingStartElement('align');
  try
    DocumentContentWriter.WriteString
      (ConvertFloatingObjectHorizontalPositionAlignment
      (ADrawingObject.HorizontalPositionAlignment));
  finally
    WriteWpDrawingEndElement;
  end;
end;

procedure TdxOpenXmlExporter.WriteFloatingObjectHorizontalOffset
  (const ADrawingObject: IdxOpenXMLDrawingObject);
begin
  WriteWpDrawingStartElement('posOffset');
  try
    DocumentContentWriter.WriteString
      (IntToStr(DocumentModel.UnitConverter.ModelUnitsToEMU
      (ADrawingObject.Offset.X)));
  finally
    WriteWpDrawingEndElement;
  end;
end;

procedure TdxOpenXmlExporter.WriteFloatingObjectPercentHorizontalOffset
  (const ADrawingObject: IdxOpenXMLDrawingObject);
begin
...
procedure TdxOpenXmlExporter.WriteFloatingObjectExtent(const ADrawingObject
  : IdxOpenXMLDrawingObject);
begin
  WriteWpDrawingStartElement('extent');
  try
    WriteIntValue('cx', DocumentModel.UnitConverter.ModelUnitsToEMU(Math.Max(0,
      ADrawingObject.ActualSize.Width)));
    WriteIntValue('cy', DocumentModel.UnitConverter.ModelUnitsToEMU
      (Math.Max(ADrawingObject.ActualSize.Height, 0)));
  finally
    WriteWpDrawingEndElement;
  end;
end;

procedure TdxOpenXmlExporter.WriteInlinePictureRunExtent
  (ARun: TdxInlinePictureRun);
begin
...
begin
  ...
  try
    WriteIntValue('cx', DocumentModel.UnitConverter.ModelUnitsToEMU(Math.Max(0,
      AActualSize.Width)));
    WriteIntValue('cy', DocumentModel.UnitConverter.ModelUnitsToEMU(Math.Max(0,
      AActualSize.Height)));
  finally
    WriteWpDrawingEndElement;
  end;
...
procedure TdxOpenXmlExporter.WriteInlinePictureEffectExtent
  (ARun: TdxInlinePictureRun);
begin
...
procedure TdxOpenXmlExporter.WriteFloatingObjectEffectExtent
  (const ARun: IdxOpenXMLDrawingObject);
var
...
begin
  ...
  try
    ...
    AEffectExtent := TdxEffectExtent.Create
      (DocumentModel.UnitConverter.ModelUnitsToEMU(ARun.ActualSize.Width),
      DocumentModel.UnitConverter.ModelUnitsToEMU(ARun.ActualSize.Height),
      ARun.Rotation, DocumentModel.UnitConverter);
...
function TdxOpenXmlExporter.GetAbstractNumberingId
  (AStyleIndex: Integer): string;
begin
  Result := 'C' + IntToStr(AStyleIndex);
end;

function TdxOpenXmlExporter.GetWordProcessingMLValue
  (AValue: TdxWordProcessingMLValue): string;
begin
...
begin
  if not DocumentModel.DocumentExportOptions.OpenXML.AllowAlternateStyleNames
    and not DocumentModel.DocumentExportOptions.OpenXML.LimitStyleNameTo253Chars
  then
    ...
    begin
      ...
      begin
        ...
        if Length(ANames) > 1 then
          WriteWpStringValue('aliases', TdxStringHelper.Join(',',
            Copy(ANames, 1, Length(ANames) - 1)));
      end;
    end;
  end;
end;
...
class function TdxExportOpenXmlFormat.GetDocumentFormat
  : TdxRichEditDocumentFormat;
begin
  Result := TdxRichEditDocumentFormat.OpenXML;
end;

function TdxExportOpenXmlFormat.GetExporter(ADocumentModel
