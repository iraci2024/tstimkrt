...
type
  ...
  public
    property Controller: TdxRangeEditingPermissionsFormController
      read GetController;
  end;
...
function TdxRangeEditingPermissionsForm.GetController
...
begin
  ...
  btnMoreUsers.Caption := cxGetResourceString
    (@sdxRangeEditingPermissionsMoreUsers);
  liGroups.CaptionOptions.Text := cxGetResourceString
    (@sdxRangeEditingPermissionsGroups);
  liUsers.CaptionOptions.Text := cxGetResourceString
...
var
  ...
  AText: string;
begin
  ANewUser := Trim(TdxRichEditDialogs.InputBox
    (cxGetResourceString(@sdxRangeEditingPermissionsAddUsers),
  ...
  else if Controller.AddUser(ANewUser) then
    PopulateUsers;
end;

function TdxRangeEditingPermissionsForm.CreateController(AControllerParameters
  : TdxFormControllerParameters): TdxFormController;
begin
  Result := TdxRangeEditingPermissionsFormController.Create
