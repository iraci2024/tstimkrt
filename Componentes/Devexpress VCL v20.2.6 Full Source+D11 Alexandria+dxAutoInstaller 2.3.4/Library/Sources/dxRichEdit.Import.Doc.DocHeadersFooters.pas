...
type
  ...
  public
    ...
    class function FromStream(AReader: TBinaryReader; AOffset, ASize: Integer)
      : TdxDocHeadersFootersPositions; static;
  ...
  public
    constructor Create;
    destructor Destroy; override;
    function GetEvenPageHeaderObjects(ASectionIndex: Integer)
      : TdxDocObjectCollection;
    function GetEvenPageFooterObjects(ASectionIndex: Integer)
      : TdxDocObjectCollection;
    function GetOddPageHeaderObjects(ASectionIndex: Integer)
      : TdxDocObjectCollection;
    function GetOddPageFooterObjects(ASectionIndex: Integer)
      : TdxDocObjectCollection;
    function GetFirstPageHeaderObjects(ASectionIndex: Integer)
      : TdxDocObjectCollection;
    function GetFirstPageFooterObjects(ASectionIndex: Integer)
      : TdxDocObjectCollection;
    function GetCollectionByIndex(ACollectionIndex: Integer)
      : TdxDocObjectCollection;

    property HeadersFooters: TdxObjectList<TdxDocObjectCollection>
      read FHeadersFooters;
...
class function TdxDocHeadersFootersPositions.FromStream(AReader: TBinaryReader;
  AOffset, ASize: Integer): TdxDocHeadersFootersPositions;
begin
...
procedure TdxDocHeadersFootersPositions.Read(AReader: TBinaryReader;
...
function TdxDocHeadersFooters.GetEvenPageHeaderObjects(ASectionIndex: Integer)
  : TdxDocObjectCollection;
var
  ACollectionIndex: Integer;
begin
  ACollectionIndex := FootnoteCollectionsCount +
    (ItemsPerSection * ASectionIndex) + EvenPageHeaderPosition;
  Result := GetCollectionByIndex(ACollectionIndex);
end;

function TdxDocHeadersFooters.GetEvenPageFooterObjects(ASectionIndex: Integer)
  : TdxDocObjectCollection;
var
  ACollectionIndex: Integer;
begin
  ACollectionIndex := FootnoteCollectionsCount +
    (ItemsPerSection * ASectionIndex) + EvenPageFooterPosition;
  Result := GetCollectionByIndex(ACollectionIndex);
end;

function TdxDocHeadersFooters.GetOddPageHeaderObjects(ASectionIndex: Integer)
  : TdxDocObjectCollection;
var
  ACollectionIndex: Integer;
begin
  ACollectionIndex := FootnoteCollectionsCount +
    (ItemsPerSection * ASectionIndex) + OddPageHeaderPosition;
  Result := GetCollectionByIndex(ACollectionIndex);
end;

function TdxDocHeadersFooters.GetOddPageFooterObjects(ASectionIndex: Integer)
  : TdxDocObjectCollection;
var
  ACollectionIndex: Integer;
begin
  ACollectionIndex := FootnoteCollectionsCount +
    (ItemsPerSection * ASectionIndex) + OddPageFooterPosition;
  Result := GetCollectionByIndex(ACollectionIndex);
end;

function TdxDocHeadersFooters.GetFirstPageHeaderObjects(ASectionIndex: Integer)
  : TdxDocObjectCollection;
var
  ACollectionIndex: Integer;
begin
  ACollectionIndex := FootnoteCollectionsCount +
    (ItemsPerSection * ASectionIndex) + FirstPageHeaderPosition;
  Result := GetCollectionByIndex(ACollectionIndex);
end;

function TdxDocHeadersFooters.GetFirstPageFooterObjects(ASectionIndex: Integer)
  : TdxDocObjectCollection;
var
  ACollectionIndex: Integer;
begin
  ACollectionIndex := FootnoteCollectionsCount +
    (ItemsPerSection * ASectionIndex) + FirstPageFooterPosition;
  Result := GetCollectionByIndex(ACollectionIndex);
end;

function TdxDocHeadersFooters.GetCollectionByIndex(ACollectionIndex: Integer)
  : TdxDocObjectCollection;
begin
