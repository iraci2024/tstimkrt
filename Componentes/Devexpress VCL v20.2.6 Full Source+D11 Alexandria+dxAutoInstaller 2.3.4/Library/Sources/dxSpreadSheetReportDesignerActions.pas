...
uses
  Classes, Controls, Types, SysUtils, dxCore, cxGraphics, cxGeometry, dxActions,
  dxHashUtils, Math,
  dxSpreadSheetCore, dxSpreadSheetReportDesigner, dxSpreadSheetActions,
...
type
  ...
  protected
    function CheckSection(ASectionType
      : TdxSpreadSheetReportSectionType): Boolean;
    function GetMaxSectionID(ASectionType
      : TdxSpreadSheetReportSectionType): Integer;
  ...
  TdxSpreadSheetReportDesignerModeAction = class
    (TdxSpreadSheetReportDesignerAction)
  protected
  ...
  TdxSpreadSheetReportDesignerSingleSheetReportMode = class
    (TdxSpreadSheetReportDesignerModeAction)
  protected
  ...
  TdxSpreadSheetReportDesignerMultipleSheetsReportMode = class
    (TdxSpreadSheetReportDesignerModeAction)
  protected
    procedure Initialize; override;
  end;
  ...
  TdxSpreadSheetReportDesignerMultipleDocumentsReportMode = class
    (TdxSpreadSheetReportDesignerModeAction)
  protected
    procedure Initialize; override;
  end;
  ...
  TdxSpreadSheetReportDesignerHorizontalOrientation = class
    (TdxSpreadSheetReportDesignerOrientationAction)
  protected
    procedure Initialize; override;
  end;
  ...
  TdxSpreadSheetReportDesignerVerticalOrientation = class
    (TdxSpreadSheetReportDesignerOrientationAction)
  protected
    procedure Initialize; override;
  end;
  ...
  TdxSpreadSheetReportDesignerFooterSection = class
    (TdxSpreadSheetReportDesignerAction)
  protected
    procedure DoExecute; override;
    procedure DoUpdateState; override;
  ...
  TdxSpreadSheetReportDesignerDetailSection = class
    (TdxSpreadSheetReportDesignerAction)
  protected
    procedure DoExecute; override;
    procedure DoUpdateState; override;
  ...
  TdxSpreadSheetReportDesignerDetailLevel = class
    (TdxSpreadSheetReportDesignerAction)
  protected
    procedure DoExecute; override;
    procedure Initialize; override;
  ...
  TdxSpreadSheetReportDesignerDataMember = class
    (TdxSpreadSheetReportDesignerAction)
  protected
    procedure Initialize; override;
    function IsEnabled: Boolean; override;
  ...
  TdxSpreadSheetReportDesignerGroupHeaderSection = class
    (TdxSpreadSheetReportDesignerAction)
  protected
    procedure DoExecute; override;
    procedure DoUpdateState; override;
  ...
  TdxSpreadSheetReportDesignerGroupFooterSection = class
    (TdxSpreadSheetReportDesignerAction)
  protected
    procedure DoExecute; override;
    procedure DoUpdateState; override;
  ...
  TdxSpreadSheetReportDesignerEditFilter = class
    (TdxSpreadSheetReportDesignerAction)
  protected
    procedure Initialize; override;
    function IsEnabled: Boolean; override;
  ...
  TdxSpreadSheetReportDesignerDesignView = class
    (TdxSpreadSheetReportDesignerAction)
  protected
    procedure DoExecute; override;
    procedure DoUpdateState; override;
...
resourcestring
  sdxSpreadSheetReportDesignerActionSingleSheetReportModeCaption =
    'Single Sheet';
  sdxSpreadSheetReportDesignerActionSingleSheetReportModeHint =
    'Insert all sections into a single worksheet according to the selected document orientation.';

  sdxSpreadSheetReportDesignerActionMultipleSheetsReportModeCaption =
    'Multiple Sheets';
  sdxSpreadSheetReportDesignerActionMultipleSheetsReportModeHint =
    'Create a separate worksheet in a single workbook for each record of the data source.';

  sdxSpreadSheetReportDesignerActionMultipleDocumentsReportModeCaption =
    'Multiple Documents';
  sdxSpreadSheetReportDesignerActionMultipleDocumentsReportModeHint =
    'Create a separate workbook for each record of the data source.';

  sdxSpreadSheetReportDesignerActionHorizontalOrientationCaption = 'Horizontal';
  sdxSpreadSheetReportDesignerActionHorizontalOrientationHint =
    'Insert sections one after the other from left to right. The header is on the left, and the footer is on the right of the sheet.';

  sdxSpreadSheetReportDesignerActionVerticalOrientationCaption = 'Vertical';
  sdxSpreadSheetReportDesignerActionVerticalOrientationHint =
    'Insert sections one under the other. The header is on the top, and the footer is on the bottom of the sheet.';

  sdxSpreadSheetReportDesignerActionOrientationCommandGroupCaption =
    'Document Orientation';
  sdxSpreadSheetReportDesignerActionOrientationCommandGroupHint =
    'Select either vertical or horizontal orientation for a resulting document.';

  sdxSpreadSheetReportDesignerActionHeaderSectionCaption = 'Header';
  sdxSpreadSheetReportDesignerActionHeaderSectionHint =
    'Specify a header section in the template.';

  sdxSpreadSheetReportDesignerActionFooterSectionCaption = 'Footer';
  sdxSpreadSheetReportDesignerActionFooterSectionHint =
    'Specify a footer section in the template.';

  sdxSpreadSheetReportDesignerActionDetailSectionCaption = 'Detail';
  sdxSpreadSheetReportDesignerActionDetailSectionHint =
    'Specify a detail section to repeat for each record of the data source.';

  sdxSpreadSheetReportDesignerActionDetailLevelSectionCaption = 'Detail Level';
  sdxSpreadSheetReportDesignerActionDetailLevelSectionHint =
    'Specify the detail section of the next level.';

  sdxSpreadSheetReportDesignerActionDetailDataMemberCaption = 'Data Member';
  sdxSpreadSheetReportDesignerActionDetailDataMemberHint =
    'Set a data member for a detail level.';

  sdxSpreadSheetReportDesignerActionResetSectionCaption = 'Reset';
  sdxSpreadSheetReportDesignerActionResetSectionHint =
    'Reset the selected template section.';

  sdxSpreadSheetReportDesignerActionSortFieldsCaption = 'Sort Fields';
  sdxSpreadSheetReportDesignerActionSortFieldsHint =
    'Specify sorting criteria for data in the selected detail section.';

  sdxSpreadSheetReportDesignerActionGroupHeaderCaption = 'Group Header';
  sdxSpreadSheetReportDesignerActionGroupHeaderHint =
    'Specify a group header. It is based on a sort field and displays information at the beginning of a group of records in a resulting document.';

  sdxSpreadSheetReportDesignerActionGroupFooterCaption = 'Group Footer';
  sdxSpreadSheetReportDesignerActionGroupFooterHint =
    'Specify a group footer. It is based on a sort field and displays information at the end of a group of records in a resulting document.';

  sdxSpreadSheetReportDesignerActionEditFilterCaption = 'Edit Filter';
  sdxSpreadSheetReportDesignerActionEditFilterHint =
    'Specify filter criteria for data in the selected detail section.';

  sdxSpreadSheetReportDesignerActionResetFilterCaption = 'Reset Filter';
  sdxSpreadSheetReportDesignerActionResetFilterHint =
    'Reset data filter in the selected detail section.';

  sdxSpreadSheetReportDesignerActionDesignViewCaption = 'Design View';
  sdxSpreadSheetReportDesignerActionDesignViewHint =
    'Highlight template sections.';

  sdxSpreadSheetReportDesignerActionReportPreviewCaption = 'Report Preview';
  sdxSpreadSheetReportDesignerActionReportPreviewHint =
    'Preview a resulting document.';
...
begin
  ...
  for I := 0 to Designer.Sections.Count - 1 do
    if Designer.Sections[I].SectionType = ASectionType then
      Result := Max(Result, TdxSpreadSheetReportSectionAccess(Designer.Sections
        [I]).Index);
end;
...
function TdxSpreadSheetReportDesignerAction.GetDataController
  : TdxSpreadSheetReportDataController;
begin
  Result := Designer.GetDataControllerForSection(Section);
end;

function TdxSpreadSheetReportDesignerAction.GetDesigner
  : TdxSpreadSheetReportDesignerAccess;
begin
...
begin
  Result := (Section <> nil) and
    (Section.SectionType in [rstDetail, rstDetailLevel]);
end;

function TdxSpreadSheetReportDesignerAction.GetSection
  : TdxSpreadSheetReportSectionAccess;
begin
...
begin
  ...
  FDefaultImageNameInIconLibrary :=
    'Report Designer\Mode\MultipleDocuments.png';
  FIsSelectionNeeded := False;
...
begin
  FDefaultCaptionResString :=
    @sdxSpreadSheetReportDesignerActionHorizontalOrientationCaption;
  FDefaultHintResString :=
    @sdxSpreadSheetReportDesignerActionHorizontalOrientationHint;
...
begin
  FDefaultCaptionResString :=
    @sdxSpreadSheetReportDesignerActionVerticalOrientationCaption;
  FDefaultHintResString :=
    @sdxSpreadSheetReportDesignerActionVerticalOrientationHint;
...
begin
  FDefaultCaptionResString :=
    @sdxSpreadSheetReportDesignerActionHeaderSectionCaption;
  FDefaultHintResString := @sdxSpreadSheetReportDesignerActionHeaderSectionHint;
  FDefaultImageNameInIconLibrary :=
    'Report Designer\TemplateRanges\SetHeaderRange.png';
end;
...
begin
  AutoCheck := False;
  FDefaultCaptionResString :=
    @sdxSpreadSheetReportDesignerActionFooterSectionCaption;
  FDefaultHintResString := @sdxSpreadSheetReportDesignerActionFooterSectionHint;
  FDefaultImageNameInIconLibrary :=
    'Report Designer\TemplateRanges\SetFooterRange.png';
end;
...
begin
  FDefaultCaptionResString :=
    @sdxSpreadSheetReportDesignerActionDetailSectionCaption;
  FDefaultHintResString := @sdxSpreadSheetReportDesignerActionDetailSectionHint;
  FDefaultImageNameInIconLibrary :=
    'Report Designer\TemplateRanges\SetDetailRange.png';
end;
...
begin
  AutoCheck := False;
  FDefaultCaptionResString :=
    @sdxSpreadSheetReportDesignerActionDetailLevelSectionCaption;
  FDefaultHintResString :=
    @sdxSpreadSheetReportDesignerActionDetailLevelSectionHint;
  FDefaultImageNameInIconLibrary :=
    'Report Designer\TemplateRanges\SetDetailLevel.png';
end;
...
begin
  AutoCheck := False;
  FDefaultCaptionResString :=
    @sdxSpreadSheetReportDesignerActionDetailDataMemberCaption;
  FDefaultHintResString :=
    @sdxSpreadSheetReportDesignerActionDetailDataMemberHint;
  FDefaultImageNameInIconLibrary :=
    'Report Designer\TemplateRanges\SetDetailDataMember.png';
end;
...
begin
  AutoCheck := False;
  FDefaultCaptionResString :=
    @sdxSpreadSheetReportDesignerActionResetSectionCaption;
  FDefaultHintResString := @sdxSpreadSheetReportDesignerActionResetSectionHint;
  FDefaultImageNameInIconLibrary :=
    'Report Designer\TemplateRanges\ResetRange.png';
end;
...
begin
  FDefaultCaptionResString :=
    @sdxSpreadSheetReportDesignerActionSortFieldsCaption;
  FDefaultHintResString := @sdxSpreadSheetReportDesignerActionSortFieldsHint;
  FDefaultImageNameInIconLibrary :=
    'Report Designer\SortAndGroup\SortFields.png';
end;
...
begin
  if CheckSection(rstGroupHeader) then
    Designer.SetGroupHeaderSection(Designer.ActiveSheetAsTable.Selection.Area,
      Section.Index)
  else
    Designer.SetGroupHeaderSection(Designer.ActiveSheetAsTable.Selection.Area,
      GetMaxSectionID(rstGroupHeader) + 1);
end;
...
begin
  FDefaultCaptionResString :=
    @sdxSpreadSheetReportDesignerActionGroupHeaderCaption;
  FDefaultHintResString := @sdxSpreadSheetReportDesignerActionGroupHeaderHint;
  FDefaultImageNameInIconLibrary :=
    'Report Designer\SortAndGroup\GroupHeader.png';
end;
...
begin
  if CheckSection(rstGroupFooter) then
    Designer.SetGroupFooterSection(Designer.ActiveSheetAsTable.Selection.Area,
      Section.Index)
  else
    Designer.SetGroupFooterSection(Designer.ActiveSheetAsTable.Selection.Area,
      GetMaxSectionID(rstGroupFooter) + 1);
end;
...
begin
  FDefaultCaptionResString :=
    @sdxSpreadSheetReportDesignerActionGroupFooterCaption;
  FDefaultHintResString := @sdxSpreadSheetReportDesignerActionGroupFooterHint;
  FDefaultImageNameInIconLibrary :=
    'Report Designer\SortAndGroup\GroupFooter.png';
end;
...
begin
  FDefaultCaptionResString :=
    @sdxSpreadSheetReportDesignerActionEditFilterCaption;
...
begin
  FDefaultCaptionResString :=
    @sdxSpreadSheetReportDesignerActionResetFilterCaption;
...
begin
  Result := (DataController <> nil) and
    (DataController.Filter.FilterText <> '');
end;
...
begin
  FDefaultCaptionResString :=
    @sdxSpreadSheetReportDesignerActionDesignViewCaption;
...
begin
  FDefaultCaptionResString :=
    @sdxSpreadSheetReportDesignerActionReportPreviewCaption;
...
procedure AddSpreadSheetDesignerResourceStringNames
  (AProduct: TdxProductResourceStrings);
begin
  AProduct.Add('sdxSpreadSheetReportDesignerActionSingleSheetReportModeCaption',
    @sdxSpreadSheetReportDesignerActionSingleSheetReportModeCaption);;
  AProduct.Add('sdxSpreadSheetReportDesignerActionSingleSheetReportModeHint',
    @sdxSpreadSheetReportDesignerActionSingleSheetReportModeHint);
  AProduct.Add
    ('sdxSpreadSheetReportDesignerActionMultipleSheetsReportModeCaption',
    @sdxSpreadSheetReportDesignerActionMultipleSheetsReportModeCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionMultipleSheetsReportModeHint',
    @sdxSpreadSheetReportDesignerActionMultipleSheetsReportModeHint);
  AProduct.Add
    ('sdxSpreadSheetReportDesignerActionMultipleDocumentsReportModeCaption',
    @sdxSpreadSheetReportDesignerActionMultipleDocumentsReportModeCaption);
  AProduct.Add
    ('sdxSpreadSheetReportDesignerActionMultipleDocumentsReportModeHint',
    @sdxSpreadSheetReportDesignerActionMultipleDocumentsReportModeHint);
  AProduct.Add('sdxSpreadSheetReportDesignerActionHorizontalOrientationCaption',
    @sdxSpreadSheetReportDesignerActionHorizontalOrientationCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionHorizontalOrientationHint',
    @sdxSpreadSheetReportDesignerActionHorizontalOrientationHint);
  AProduct.Add('sdxSpreadSheetReportDesignerActionVerticalOrientationCaption',
    @sdxSpreadSheetReportDesignerActionVerticalOrientationCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionVerticalOrientationHint',
    @sdxSpreadSheetReportDesignerActionVerticalOrientationHint);
  AProduct.Add
    ('sdxSpreadSheetReportDesignerActionOrientationCommandGroupCaption',
    @sdxSpreadSheetReportDesignerActionOrientationCommandGroupCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionOrientationCommandGroupHint',
    @sdxSpreadSheetReportDesignerActionOrientationCommandGroupHint);
  AProduct.Add('sdxSpreadSheetReportDesignerActionHeaderSectionCaption',
    @sdxSpreadSheetReportDesignerActionHeaderSectionCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionHeaderSectionHint',
    @sdxSpreadSheetReportDesignerActionHeaderSectionHint);
  AProduct.Add('sdxSpreadSheetReportDesignerActionFooterSectionCaption',
    @sdxSpreadSheetReportDesignerActionFooterSectionCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionFooterSectionHint',
    @sdxSpreadSheetReportDesignerActionFooterSectionHint);
  AProduct.Add('sdxSpreadSheetReportDesignerActionDetailSectionCaption',
    @sdxSpreadSheetReportDesignerActionDetailSectionCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionDetailSectionHint',
    @sdxSpreadSheetReportDesignerActionDetailSectionHint);
  AProduct.Add('sdxSpreadSheetReportDesignerActionDetailLevelSectionCaption',
    @sdxSpreadSheetReportDesignerActionDetailLevelSectionCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionDetailLevelSectionHint',
    @sdxSpreadSheetReportDesignerActionDetailLevelSectionHint);
  AProduct.Add('sdxSpreadSheetReportDesignerActionDetailDataMemberCaption',
    @sdxSpreadSheetReportDesignerActionDetailDataMemberCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionDetailDataMemberHint',
    @sdxSpreadSheetReportDesignerActionDetailDataMemberHint);
  AProduct.Add('sdxSpreadSheetReportDesignerActionResetSectionCaption',
    @sdxSpreadSheetReportDesignerActionResetSectionCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionResetSectionHint',
    @sdxSpreadSheetReportDesignerActionResetSectionHint);
  AProduct.Add('sdxSpreadSheetReportDesignerActionSortFieldsCaption',
    @sdxSpreadSheetReportDesignerActionSortFieldsCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionSortFieldsHint',
    @sdxSpreadSheetReportDesignerActionSortFieldsHint);
  AProduct.Add('sdxSpreadSheetReportDesignerActionGroupHeaderCaption',
    @sdxSpreadSheetReportDesignerActionGroupHeaderCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionGroupHeaderHint',
    @sdxSpreadSheetReportDesignerActionGroupHeaderHint);
  AProduct.Add('sdxSpreadSheetReportDesignerActionGroupFooterCaption',
    @sdxSpreadSheetReportDesignerActionGroupFooterCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionGroupFooterHint',
    @sdxSpreadSheetReportDesignerActionGroupFooterHint);
  AProduct.Add('sdxSpreadSheetReportDesignerActionEditFilterCaption',
    @sdxSpreadSheetReportDesignerActionEditFilterCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionEditFilterHint',
    @sdxSpreadSheetReportDesignerActionEditFilterHint);
  AProduct.Add('sdxSpreadSheetReportDesignerActionResetFilterCaption',
    @sdxSpreadSheetReportDesignerActionResetFilterCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionResetFilterHint',
    @sdxSpreadSheetReportDesignerActionResetFilterHint);
  AProduct.Add('sdxSpreadSheetReportDesignerActionDesignViewCaption',
    @sdxSpreadSheetReportDesignerActionDesignViewCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionDesignViewHint',
    @sdxSpreadSheetReportDesignerActionDesignViewHint);
  AProduct.Add('sdxSpreadSheetReportDesignerActionReportPreviewCaption',
    @sdxSpreadSheetReportDesignerActionReportPreviewCaption);
  AProduct.Add('sdxSpreadSheetReportDesignerActionReportPreviewHint',
    @sdxSpreadSheetReportDesignerActionReportPreviewHint);
end;
...
dxResourceStringsRepository.RegisterProduct('ExpressSpreadSheet 2',
  @AddSpreadSheetDesignerResourceStringNames);
