...
type
  ...
  TdxColumnWidthInfoDictionary = class(TcxIUnknownObject,
    IComparer < TPair < TdxCellPosition, TdxWidthsContentInfo >> )
  strict private
    FContainsCellWithSpan: Boolean;
    FInnerDictionary: TDictionary<TdxCellPosition, TdxWidthsContentInfo>;
  protected
    function Compare(const APair1,
      APair2: TPair<TdxCellPosition, TdxWidthsContentInfo>): Integer;
  public
    constructor Create;
    destructor Destroy; override;
    procedure Register(AFirstColumnIndex: Integer; AColumnSpan: Integer;
      const ACellWidths: TdxWidthsInfo);
    function CalculateTotalContentWidth: TdxWidthsContentInfo;
    function CellPositionComparer(const APosition1,
      APosition2: TdxCellPosition): Integer;
  end;
  ...
  protected
    ...
    function CalculateTableWidths(ATable: TdxTable; APercentBaseWidth: Integer;
      ASimpleView: Boolean): TdxWidthsContentInfo;
    procedure CalculateRowWidths(AColumnWidths: TdxColumnWidthInfoDictionary;
      ARow: TdxTableRow; APercentBaseWidth: Integer; ASimpleView: Boolean);
    function GetActualWidth(AUnitInfo: TdxWidthUnitInfo;
      APercentBaseWidth: Integer): TdxLayoutUnit;
    function GetMaxWidth(const AContentWidths: TdxWidthsContentInfo;
      AHorizontalMargins, ABordersWidth, ASpacing: TdxModelUnit)
      : TdxLayoutUnit; virtual;
    ...
    function CalculateCellContentWidthsCore(ACell: TdxTableCell;
      ...
      : TdxWidthsContentInfo; virtual;
    function CalculateParagraphWidths(AParagraph: TdxParagraph)
      : TdxWidthsContentInfo; virtual;
  ...
  public
    ...
    function CalculateCellWidths(ACell: TdxTableCell;
      APercentBaseWidth: Integer; ASimpleView: Boolean): TdxWidthsInfo;
    function CanUseCachedTableLayoutInfo(ATableLayoutInfo: TdxTableLayoutInfo)
      : Boolean; virtual; abstract;
    function CreateTableLayoutInfo(ATableGrid: TdxTableGrid;
      AMaxTableWidth: TdxLayoutUnit; AAllowTablesToExtendIntoMargins,
      ASimpleView: Boolean; APercentBaseWidth: TdxLayoutUnit)
      : TdxTableLayoutInfo; virtual; abstract;
  end;
  ...
  protected
    function CalculateParagraphWidths(AParagraph: TdxParagraph)
      : TdxWidthsContentInfo; override;
  public
    constructor Create(APieceTable: TdxPieceTable; AMeasurer: TdxBoxMeasurer;
      APercentBaseWidth: Integer); overload;
    function CanUseCachedTableLayoutInfo(ATableLayoutInfo: TdxTableLayoutInfo)
      : Boolean; override;
    function CreateTableLayoutInfo(ATableGrid: TdxTableGrid;
      AMaxTableWidth: TdxLayoutUnit; AAllowTablesToExtendIntoMargins,
      ASimpleView: Boolean; APercentBaseWidth: TdxLayoutUnit)
      : TdxTableLayoutInfo; override;
  end;
  ...
  private
    ...
    FSimpleView: Boolean;
    FFlex: Boolean;
    procedure ApplyPercentWidth(AIntervals: TdxTableGridIntervalList;
      APercentBaseWidth: Integer);
    function CalculateEstimatedTableWidth(ATable: TdxTable;
      AGridIntervals: TdxTableGridIntervalList; APercentBaseWidth: Integer)
      : TdxLayoutUnit;
    procedure EnlargeColumnsMinWidth(AGrid: TdxTableGrid;
      AStartColumnIndex, AEndColumnIndex, AOldWidth, ANewWidth: Integer);
    procedure EnlargeColumnsMaxWidth(AGrid: TdxTableGrid;
      AStartColumnIndex, AEndColumnIndex, AOldWidth, ANewWidth: Integer);
    procedure ApplyCellContentWidthWithoutSpan(AGrid: TdxTableGrid;
      ACell: TdxTableCell; AColumnIndex, APercentBaseWidth: Integer);
    procedure EnlargeColumnsWidths(AGrid: TdxTableGrid;
      AStartColumnIndex, AEndColumnIndex: Integer;
      AOldMinWidth, ANewMinWidth: TdxLayoutUnit);
    function GetTotalColumnsMinWidth(AGrid: TdxTableGrid;
      AStartColumnIndex, AEndColumnIndex: Integer): TdxLayoutUnit;
    function GetTotalGridWidth(AGrid: TdxTableGrid): TdxLayoutUnit;
    function GetTotalWidthCore(AGrid: TdxTableGrid;
      AStartColumnIndex, AEndColumnIndex: Integer): TdxLayoutUnit;
    function GetTotalMinWidthCore(AGrid: TdxTableGrid;
      AStartColumnIndex, AEndColumnIndex: Integer): TdxLayoutUnit;
    function GetTotalHorizontalMarginsCore(AGrid: TdxTableGrid;
      AStartColumnIndex, AEndColumnIndex: Integer): TdxLayoutUnit;
    function GetTotalMaxWidthCore(AGrid: TdxTableGrid;
      AStartColumnIndex, AEndColumnIndex: Integer): TdxLayoutUnit;
    function HasColumnsWithoutPreferredWidth(AGrid: TdxTableGrid;
      AStartColumnIndex, AEndColumnIndex: Integer): Boolean;
    function GetTotalPreferredWidth(AGrid: TdxTableGrid;
      AStartColumnIndex, AEndColumnIndex: Integer): TdxLayoutUnit;
    procedure ProcessIntervals(ACurrentRowIterator, ANextRowIterator
      : TdxTableGridIntervalIterator; AResult: TdxTableGridIntervalList);
    procedure ProcessDependedIntervals(const AMasterRowIterator,
      ASlaveRowIterator: TdxTableGridIntervalIterator;
      AResult: TdxTableGridIntervalList);
    function CalculateNewInterval(const ACurrentRowInterval, ANextRowInterval
      : TdxTableGridInterval): TdxTableGridInterval;
    function CalculateNewIntervalFromMixedIntervals(const APercentWidthInterval,
      AValueWidthInterval: TdxTableGridInterval; AColumnSpan: Integer)
      : TdxTableGridInterval;
    procedure CopyRestIntervals(ASource: TdxTableGridIntervalIterator;
      ACollection: TdxTableGridIntervalList);
    function GetActualWidth(AUnitInfo: TdxWidthUnitInfo;
      APercentBaseWidth: Integer): TdxLayoutUnit;
    procedure ApplyCellContentWidthWithSpan(AGrid: TdxTableGrid;
      ACell: TdxTableCell; AStartColumnIndex, APercentBaseWidth: Integer);
    procedure CompressTableGridToColumnWidth(AGrid: TdxTableGrid;
      AOldWidth, ANewWidth: TdxLayoutUnit);
    procedure CompressTableGridToPreferredWidth(AGrid: TdxTableGrid;
      AOldWidth, ANewWidth: TdxLayoutUnit);
    procedure EnlargeTableGridToPreferredWidth(AGrid: TdxTableGrid;
      AOldWidth, ANewWidth: TdxLayoutUnit);
    procedure AutofitTable(AGrid: TdxTableGrid; ATable: TdxTable;
      APercentBaseWidth: Integer);
    procedure ApplyCellContentWidth(AGrid: TdxTableGrid; ATable: TdxTable;
      APercentBaseWidth: Integer);
    procedure CompressRelativelySizedTable(AGrid: TdxTableGrid;
      ATable: TdxTable);
  protected
    function CalculateCellWidthsInfo(ACell: TdxTableCell;
      APercentBaseWidth: Integer): TdxWidthsInfo;
    procedure EnlargeColumnsHorizontalMargins(AGrid: TdxTableGrid;
      AStartColumnIndex, AEndColumnIndex, AOldWidth, ANewWidth: TdxLayoutUnit);
    function CreateTableGridInterval(AUnitConverter
      : TdxDocumentModelUnitToLayoutUnitConverter; AWidth: TdxWidthUnit;
      AColumnSpan: Integer): TdxTableGridInterval;
    function CreateIntervals(ARow: TdxTableRow): TdxTableGridIntervalList;
    procedure ConvertToIntervals(ACells: TdxTableCellCollection;
      AIntervals: TdxTableGridIntervalList;
      AUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter);
    function CalculateTableGridCore(ACurrentRow,
      ANextRow: TdxTableGridIntervalList; APercentBaseWidth: Integer)
      : TdxTableGridIntervalList;
    function CalculateTableGridPartially(ACurrentRow,
      ANextRow: TdxTableGridIntervalList; APercentBaseWidth: Integer)
      : TdxTableGridIntervalList;
    function CanUseCachedTableLayoutInfo(ATableLayoutInfo: TdxTableLayoutInfo;
      APercentBaseWidth: TdxLayoutUnit): Boolean;
    procedure ReplaceCachedTableLayoutInfoIfNeeded(ATable: TdxTable;
      ATableGrid: TdxTableGrid; APercentBaseWidth: TdxLayoutUnit);
  public
    constructor Create(ATableWidthsCalculator: TdxTableWidthsCalculatorBase;
      AMaxTableWidth: Integer; AAllowTablesToExtendIntoMargins: Boolean = False;
      ASimpleView: Boolean = False);
    function CalculateTableGrid(ATable: TdxTable; APercentBaseWidth: Integer)
      : TdxTableGrid;
    function CalculateGridIntervals(ATable: TdxTable;
      APercentBaseWidth: Integer): TdxTableGridIntervalList;
  ...
  public
    function GetTableGridColumns: TdxTableGridColumnCollection;
      virtual; abstract;
  end;
  ...
  public
    constructor Create(ACellWidths: TdxCellWidths;
  ...
  public
    ...
    function GetTableGrid(ATable: TdxTable; APercentWidthBase: Integer;
      AMeasurer: TdxBoxMeasurer): TdxTableGrid;
    function CalculateWidths: TdxTableWidthsContainer;
    function GetColumnsWidth(AGridColumns: TdxTableGridColumnCollection;
      AFirstIndex: Integer; ALastIndex: Integer): Integer;
  ...
  TdxTableColumnKnownWidthCalculator = class
  ...
  public
    ...
    function CreateColumnCollection(AListWidths: TdxIntegerList)
  ...
  protected
    ...
    function CalculateParagraphWidths(AParagraph: TdxParagraph)
      : TdxWidthsContentInfo; override;
  public
    constructor Create(AConverter
      : TdxDocumentModelUnitToLayoutUnitConverter); overload;
    function CanUseCachedTableLayoutInfo(ATableLayoutInfo: TdxTableLayoutInfo)
      : Boolean; override;
    function CreateTableLayoutInfo(ATableGrid: TdxTableGrid;
      AMaxTableWidth: Integer; AAllowTablesToExtendIntoMargins: Boolean;
      ASimpleView: Boolean; APercentBaseWidth: Integer)
      : TdxTableLayoutInfo; override;
  end;
...
type
  ...
  private
    class procedure CompressProportionallyWidthCore(AGrid: TdxTableGrid;
      AItems: TdxIntegerList; ATotalItemsWidth, ADeltaTableWidth
      : TdxLayoutUnit); static;
  public
    class procedure CompressTableGrid(AGrid: TdxTableGrid;
      AStartIndex, AEndIndex: Integer; ANewTableWidth: TdxLayoutUnit); static;
    class procedure EnlargeProportionallyAverageWidth(AGrid: TdxTableGrid;
      AStartIndex, AEndIndex: Integer; ANewWidth: TdxLayoutUnit); static;
    class procedure ChangeColumnsProportionally(AGrid: TdxTableGrid;
      AStartIndex, AEndIndex: Integer;
      AInitialWidth, ANewWidth: TdxLayoutUnit); static;
  end;
...
class procedure TdxAutofitTableLayoutCalculator.CompressTableGrid
  (AGrid: TdxTableGrid; AStartIndex, AEndIndex: Integer;
  ANewTableWidth: TdxLayoutUnit);
var
  ADeltas: TdxIntegerList;
  ADeltasTotalWidth, AInitialTableWidth, ADelta, ADeltaTableWidth
    : TdxLayoutUnit;
...
begin
  ...
  try
    ...
    if ADeltasTotalWidth > ADeltaTableWidth then
      CompressProportionallyWidthCore(AGrid, ADeltas, ADeltasTotalWidth,
        ADeltaTableWidth)
    else
    begin
      for I := AStartIndex to AEndIndex do
...
class procedure TdxAutofitTableLayoutCalculator.
  EnlargeProportionallyAverageWidth(AGrid: TdxTableGrid;
...
class procedure TdxAutofitTableLayoutCalculator.ChangeColumnsProportionally
  (AGrid: TdxTableGrid; AStartIndex, AEndIndex: Integer;
...
class procedure TdxAutofitTableLayoutCalculator.CompressProportionallyWidthCore
  (AGrid: TdxTableGrid; AItems: TdxIntegerList;
  ATotalItemsWidth, ADeltaTableWidth: TdxLayoutUnit);
var
  I, AColCount: Integer;
...
procedure TdxColumnWidthInfoDictionary.Register(AFirstColumnIndex: Integer;
  AColumnSpan: Integer; const ACellWidths: TdxWidthsInfo);
var
...
begin
  ...
  begin
    AContentWidths := TdxWidthsContentInfo.Create(Math.Max(ACellWidths.MinWidth,
      AExistingInfo.MinWidth), Math.Max(ACellWidths.MaxWidth,
      AExistingInfo.MaxWidth));
    FInnerDictionary[APosition] := AContentWidths;
  end
  else
    FInnerDictionary.Add(APosition,
      TdxWidthsContentInfo.Create(ACellWidths.MinWidth, ACellWidths.MaxWidth));
  FContainsCellWithSpan := FContainsCellWithSpan or (AColumnSpan > 1);
end;

function TdxColumnWidthInfoDictionary.CalculateTotalContentWidth
...
var
  ...
  AContentInfo, AExistingStartSummaryInfo, ANewSummaryInfo,
    AExistingEndSummaryInfo: TdxWidthsContentInfo;
begin
  APositions := TList < TPair < TdxCellPosition, TdxWidthsContentInfo >>
    .Create(FInnerDictionary);
  try
    ...
    begin
      ...
      ANewSummaryInfo := TdxWidthsContentInfo.Create
        (AExistingStartSummaryInfo.MinWidth + AContentInfo.MinWidth,
      ...
      begin
        ...
        if (ANewSummaryInfo.MinWidth <= AExistingEndSummaryInfo.MinWidth) and
          ...
          Break;
        ASummaryWidths[I] := TdxWidthsContentInfo.Create
          (Max(AExistingEndSummaryInfo.MinWidth, ANewSummaryInfo.MinWidth),
...
function TdxColumnWidthInfoDictionary.CellPositionComparer(const APosition1,
  APosition2: TdxCellPosition): Integer;
begin
...
constructor TdxTableWidthsCalculatorBase.Create
...
function TdxTableWidthsCalculatorBase.CalculateCellWidths(ACell: TdxTableCell;
  APercentBaseWidth: Integer; ASimpleView: Boolean): TdxWidthsInfo;
var
  ACellPreferredWidth: TdxPreferredWidth;
  APreferredWidth, AResultMinWidth, AResultMaxWidth, AOuterWidth,
...
begin
  ...
  APreferredWidth := GetActualWidth(ACellPreferredWidth.Info,
    APercentBaseWidth);

  AHorizontalMargins := ACell.GetActualLeftMargin.Value +
  ...
  try
    ABordersWidth := ACalculator.GetActualWidth(ALeftBorder) +
      ACalculator.GetActualWidth(ARightBorder);
  ...
  begin
    AContentWidths := CalculateCellContentWidthsCore(ACell, APercentBaseWidth,
      ASimpleView);
    ...
    AResultMinWidth := GetMinWidth(AContentWidths, AHorizontalMargins,
      ABordersWidth, ASpacing);
    AResultMinWidth := Min($7FFF, AResultMinWidth);
    AUnit := ACell.PreferredWidth;
    AResultMaxWidth := GetMaxWidth(AContentWidths, AHorizontalMargins,
      ABordersWidth, ASpacing);
    AResultMaxWidth := Min($7FFF, AResultMaxWidth);
    ACell.LayoutProperties.ContentWidthsInfo :=
      TdxWidthsContentInfo.Create(AResultMinWidth, AResultMaxWidth);
    if (AUnit.&Type = TdxWidthUnitType.ModelUnits) or
      (AUnit.&Type = TdxWidthUnitType.FiftiethsOfPercent) then
      AResultMaxWidth := Max(AResultMinWidth, APreferredWidth);
    AWidthsInfoResult := TdxWidthsContentInfo.Create(AResultMinWidth,
      AResultMaxWidth);
    ACell.LayoutProperties.ContainerWidthsInfo := AWidthsInfoResult;
    Result := TdxWidthsInfo.Create(AWidthsInfoResult.MinWidth,
      AWidthsInfoResult.MaxWidth, Converter.ToLayoutUnits(AHorizontalMargins));
  end
  else
  begin
    AOuterWidth := Converter.ToLayoutUnits(ABordersWidth + ASpacing +
      AHorizontalMargins);
    AWidth := Math.Max(AOuterWidth, APreferredWidth);
    ACell.LayoutProperties.ContainerWidthsInfo := TdxWidthsContentInfo.Empty;
    Result := TdxWidthsInfo.Create(AWidth, AWidth,
      Converter.ToLayoutUnits(AHorizontalMargins));
  end;
end;

function TdxTableWidthsCalculatorBase.GetLeftBorder(ACell: TdxTableCell)
  : TdxBorderInfo;
var
  ACalculator: TdxTableBorderCalculator;
...
begin
  ...
  try
    ...
    Result := ACalculator.GetVerticalBorderSource(ACell.Table, ALeftCellBorder,
      ARightCellBorder);
  finally
    ACalculator.Free;
  end;
...
function TdxTableWidthsCalculatorBase.GetRightBorder(ACell: TdxTableCell)
  : TdxBorderInfo;
var
  ACalculator: TdxTableBorderCalculator;
  ALeftCellBorder, ARightCellBorder: TdxBorderInfo;
...
function TdxTableWidthsCalculatorBase.CalculateTableWidths(ATable: TdxTable;
  APercentBaseWidth: Integer; ASimpleView: Boolean): TdxWidthsContentInfo;
var
  I, ARowCount: Integer;
...
begin
  ...
  try
    ...
    begin
      CalculateRowWidths(AColumnWidths, ARows[I], APercentBaseWidth,
        ASimpleView);
    end;
    Result := AColumnWidths.CalculateTotalContentWidth;
    APreferredWidth := ATable.GetActualPreferredWidth;
    if not(APreferredWidth.&Type in [TdxWidthUnitType.Nil,
      TdxWidthUnitType.Auto]) then
    begin
      ATableWidth := GetActualWidth(APreferredWidth, APercentBaseWidth);
      Result := TdxWidthsContentInfo.Create(Max(Result.MinWidth, ATableWidth),
        Max(Result.MinWidth, ATableWidth));
    end;
  finally
    AColumnWidths.Free;
  end;
...
procedure TdxTableWidthsCalculatorBase.CalculateRowWidths
  (AColumnWidths: TdxColumnWidthInfoDictionary; ARow: TdxTableRow;
  APercentBaseWidth: Integer; ASimpleView: Boolean);
var
  ACell: TdxTableCell;
...
function TdxTableWidthsCalculatorBase.GetActualWidth
  (AUnitInfo: TdxWidthUnitInfo; APercentBaseWidth: Integer): TdxLayoutUnit;
begin
...
function TdxTableWidthsCalculatorBase.GetMaxWidth(const AContentWidths
  : TdxWidthsContentInfo; AHorizontalMargins, ABordersWidth,
  ASpacing: TdxModelUnit): TdxLayoutUnit;
begin
  Result := AContentWidths.MaxWidth + Converter.ToLayoutUnits
    (AHorizontalMargins + ABordersWidth + ASpacing);
end;

function TdxTableWidthsCalculatorBase.GetMinWidth(const AContentWidths
  : TdxWidthsContentInfo; AHorizontalMargins, ABordersWidth,
  ASpacing: TdxModelUnit): TdxLayoutUnit;
begin
  Result := AContentWidths.MinWidth + Converter.ToLayoutUnits
    (AHorizontalMargins + ABordersWidth + ASpacing);
end;

function TdxTableWidthsCalculatorBase.CalculateCellContentWidthsCore
  (ACell: TdxTableCell; APercentBaseWidth: Integer; ASimpleView: Boolean)
  : TdxWidthsContentInfo;
var
...
function TdxTableWidthsCalculatorBase.CalculateParagraphWidths
...
begin
  ...
  Result := TdxWidthsContentInfo.Create(Max(AMaxFloatingObjectWidth, AMinWidth),
    Max(AMaxFloatingObjectWidth, AMaxWidth));
end;

{ TdxTableWidthsCalculator }

constructor TdxTableWidthsCalculator.Create(APieceTable: TdxPieceTable;
  AMeasurer: TdxBoxMeasurer; APercentBaseWidth: Integer);
begin
  inherited Create(APieceTable.DocumentModel.ToDocumentLayoutUnitConverter,
    APercentBaseWidth);
...
function TdxTableWidthsCalculator.CanUseCachedTableLayoutInfo(ATableLayoutInfo
  : TdxTableLayoutInfo): Boolean;
begin
  Result := True;
end;

function TdxTableWidthsCalculator.CreateTableLayoutInfo
  (ATableGrid: TdxTableGrid; AMaxTableWidth: TdxLayoutUnit;
  AAllowTablesToExtendIntoMargins, ASimpleView: Boolean;
  APercentBaseWidth: TdxLayoutUnit): TdxTableLayoutInfo;
begin
  Result := TdxTableLayoutInfo.Create(ATableGrid, AMaxTableWidth,
    AAllowTablesToExtendIntoMargins, ASimpleView, APercentBaseWidth);
end;

function TdxTableWidthsCalculator.CalculateParagraphWidths
  (AParagraph: TdxParagraph): TdxWidthsContentInfo;
begin
...
procedure TdxTableWidthsCalculator.EnsureParagraphBoxes
  (AParagraph: TdxParagraph);
var
...
begin
  ...
  begin
    ...
    ACharacterIterator := TdxParagraphCharacterIterator.Create(AParagraph,
      FPieceTable, AVisibleTextFilter);
    try
      if ACharacterIterator.RunIndex <= AParagraph.LastRunIndex then
      begin
        APreFormatter := TdxParagraphCharacterFormatter.Create(FPieceTable,
          FMeasurer);
        try
...
constructor TdxTableGridCalculatorCompressHelper.Create(ATable: TdxTable;
  AResult: TdxTableGrid);
begin
  FTable := ATable;
  FResult := AResult;
...
begin
  ...
  begin
    ...
    J := 1;
    while (ACol + J < FColsCount) and
      (FSpans[ACol + J][I] = FSpans[ACol][I] - J) do
    begin
      if FMatrix[ACol][I] = TMatrixItemType.Clear then
        FMatrix[ACol][I] := TMatrixItemType.White;
      Inc(J);
...
constructor TdxTableGridCalculator.Create(ATableWidthsCalculator
  : TdxTableWidthsCalculatorBase; AMaxTableWidth: Integer;
  AAllowTablesToExtendIntoMargins: Boolean = False;
  ASimpleView: Boolean = False);
begin
  inherited Create;
...
function TdxTableGridCalculator.CalculateTableGrid(ATable: TdxTable;
  APercentBaseWidth: Integer): TdxTableGrid;
var
...
begin
  ...
  try
    ...
    if APreferredWidth.&Type = TdxWidthUnitType.Auto then
      APercentBaseWidth := CalculateEstimatedTableWidth(ATable, AGridIntervals,
        APercentBaseWidth);
  ...
  if (APreferredWidth.&Type = TdxWidthUnitType.ModelUnits) and
    (APreferredWidth.Value > 0) and
    (ATable.TableLayout = TdxTableLayoutType.Fixed) then
  begin
    ANewWidth := FTableWidthsCalculator.Converter.ToLayoutUnits
      (APreferredWidth.Value);
    TdxAutofitTableLayoutCalculator.CompressTableGrid(Result, 0,
      Result.Columns.Count - 1, ANewWidth);
  end;
...
function TdxTableGridCalculator.CalculateGridIntervals(ATable: TdxTable;
  APercentBaseWidth: Integer): TdxTableGridIntervalList;
var
  I, ARowCount: Integer;
...
begin
  ...
  begin
    ...
    ACurrentRow := CalculateTableGridCore(ACurrentRow, ANextRow,
      APercentBaseWidth);
  end;
  Result := ACurrentRow;
end;

procedure TdxTableGridCalculator.ApplyPercentWidth
  (AIntervals: TdxTableGridIntervalList; APercentBaseWidth: Integer);
var
  I, ATotalPercentWidth, ATotalUnitWidth, ACount, AMaxPercentWidth, AUnsetCount,
    ARestUnitWidth, ARestPercentWidth, APercentWidth, ANewWidth: Integer;
      ...
      TdxTableGridIntervalType.PercentBased:
        begin
          ...
          begin
            ...
            AInterval.Width := Max(0, AMaxPercentWidth - ATotalPercentWidth +
              AIntervals[I].Width);
...
function TdxTableGridCalculator.CalculateEstimatedTableWidth(ATable: TdxTable;
  AGridIntervals: TdxTableGridIntervalList; APercentBaseWidth: Integer)
  : TdxLayoutUnit;
var
  AColumnsInModelUnitsWidth, ATotalPercentWidth, AEstimatedTableWidth,
    ARestOfWidthInPercent, ARowCount, ARowIndex, AColumnIndex, ACellIndex,
    ACellCount: Integer;
  AInterval: TdxTableGridInterval;
  ARows: TdxTableRowCollection;
  ARow: TdxTableRow;
  ...
  begin
    ...
    begin
      ...
      AEstimatedTableWidth := AColumnsInModelUnitsWidth *
        5000 div ARestOfWidthInPercent;
    end
    else
      AEstimatedTableWidth := AColumnsInModelUnitsWidth;
      ...
      begin
        ...
        begin
          ...
          if AInterval.Width > 0 then
            AEstimatedTableWidth :=
              Max(AInfo.MinWidth * 5000 div AInterval.Width,
              AEstimatedTableWidth);
        end;
        Inc(AColumnIndex, ACell.ColumnSpan);
      end;
    end;
    Result := Min(AEstimatedTableWidth, APercentBaseWidth) *
      5000 div ATotalPercentWidth;
  end;
end;

procedure TdxTableGridCalculator.EnlargeColumnsMinWidth(AGrid: TdxTableGrid;
  AStartColumnIndex, AEndColumnIndex, AOldWidth, ANewWidth: Integer);
var
  ...
  AEqualSpace: Boolean;
begin
  AHasColumnsWithoutPreferredWidth := HasColumnsWithoutPreferredWidth(AGrid,
    AStartColumnIndex, AEndColumnIndex);
  ...
  ARest := GetTotalMaxWidthCore(AGrid, AStartColumnIndex, AEndColumnIndex) +
    GetTotalMinWidthCore(AGrid, AStartColumnIndex, AEndColumnIndex);
  AEqualSpace := ARest = 0;
  ...
  for I := AEndColumnIndex downto AStartColumnIndex do
  begin
    if not AHasColumnsWithoutPreferredWidth or
      (AGrid.Columns[I].PreferredWidth = 0) then
    begin
      if (AZeroMinWidthCount > 0) and
        ((AGrid.Columns[I].MinWidth > 0) or (AGrid.Columns[I].MaxWidth > 0))
      then
        Continue;
      if AEqualSpace or (AZeroMinWidthCount > 0) then
        AFactor := 1
      ...
      AGrid.Columns[I].MaxWidth := Max(AGrid.Columns[I].MinWidth,
        AGrid.Columns[I].MaxWidth);
    end;
  end;
end;

procedure TdxTableGridCalculator.EnlargeColumnsMaxWidth(AGrid: TdxTableGrid;
  AStartColumnIndex, AEndColumnIndex, AOldWidth, ANewWidth: Integer);
var
  AHasColumnsWithoutPreferredWidth: Boolean;
  ARest: TdxLayoutUnit;
...
procedure TdxTableGridCalculator.ApplyCellContentWidthWithoutSpan
  (AGrid: TdxTableGrid; ACell: TdxTableCell;
  AColumnIndex, APercentBaseWidth: Integer);
var
  AInfo: TdxWidthsInfo;
  ACellMinWidth, ACellMaxWidth, APreferredWidth, ATotalColumnsMinWidth
    : TdxLayoutUnit;
begin
  ...
  APreferredWidth := GetActualWidth(ACell.PreferredWidth.Info,
    APercentBaseWidth);

  AGrid[AColumnIndex].MinWidth := Math.Max(ACellMinWidth,
    AGrid[AColumnIndex].MinWidth);
  AGrid[AColumnIndex].MaxWidth := Math.Max(ACellMaxWidth,
    AGrid[AColumnIndex].MaxWidth);
  AGrid[AColumnIndex].TotalHorizontalMargins :=
    Math.Max(AGrid[AColumnIndex].TotalHorizontalMargins,
    AInfo.TotalHorizontalMargins);
  ...
  begin
    ...
    AGrid[AColumnIndex].PreferredWidth :=
      Math.Max(AGrid[AColumnIndex].PreferredWidth, APreferredWidth);
    AGrid[AColumnIndex].MaxWidth := AGrid[AColumnIndex].PreferredWidth;
  end
  else
  begin
    ATotalColumnsMinWidth := GetTotalColumnsMinWidth(AGrid, AColumnIndex,
      AColumnIndex);
    if ACellMinWidth > ATotalColumnsMinWidth then
      EnlargeColumnsWidths(AGrid, AColumnIndex, AColumnIndex,
        ATotalColumnsMinWidth, ACellMinWidth);
  end;
end;

function TdxTableGridCalculator.CalculateCellWidthsInfo(ACell: TdxTableCell;
  APercentBaseWidth: Integer): TdxWidthsInfo;
begin
  Result := FTableWidthsCalculator.CalculateCellWidths(ACell, APercentBaseWidth,
    FSimpleView);
end;

procedure TdxTableGridCalculator.EnlargeColumnsWidths(AGrid: TdxTableGrid;
  AStartColumnIndex, AEndColumnIndex: Integer;
  AOldMinWidth, ANewMinWidth: TdxLayoutUnit);
var
  ARest, AAvailableWidth, ATotalRestMaxWidth, ADelta,
    ANewMaxWidth: TdxLayoutUnit;
  AColumns: TdxTableGridColumnCollection;
  I: Integer;
begin
  ...
  begin
    for I := AStartColumnIndex to AEndColumnIndex do
    begin
      ADelta := (AColumns[I].MaxWidth - AColumns[I].MinWidth) *
        ARest div AAvailableWidth;
...
function TdxTableGridCalculator.GetTotalColumnsMinWidth(AGrid: TdxTableGrid;
  AStartColumnIndex, AEndColumnIndex: Integer): TdxLayoutUnit;
var
  I: Integer;
begin
...
function TdxTableGridCalculator.GetTotalGridWidth(AGrid: TdxTableGrid)
  : TdxLayoutUnit;
begin
  Result := GetTotalWidthCore(AGrid, 0, AGrid.Columns.Count - 1);
end;

function TdxTableGridCalculator.GetTotalWidthCore(AGrid: TdxTableGrid;
  AStartColumnIndex, AEndColumnIndex: Integer): TdxLayoutUnit;
var
...
function TdxTableGridCalculator.GetTotalMinWidthCore(AGrid: TdxTableGrid;
  AStartColumnIndex, AEndColumnIndex: Integer): TdxLayoutUnit;
var
  AColumnIndex: Integer;
begin
...
function TdxTableGridCalculator.GetTotalHorizontalMarginsCore
  (AGrid: TdxTableGrid; AStartColumnIndex, AEndColumnIndex: Integer)
  : TdxLayoutUnit;
var
  AColumnIndex: Integer;
begin
...
function TdxTableGridCalculator.GetTotalMaxWidthCore(AGrid: TdxTableGrid;
  AStartColumnIndex, AEndColumnIndex: Integer): TdxLayoutUnit;
var
  AColumnIndex: Integer;
begin
...
function TdxTableGridCalculator.HasColumnsWithoutPreferredWidth
  (AGrid: TdxTableGrid; AStartColumnIndex, AEndColumnIndex: Integer): Boolean;
var
  AColumnIndex: Integer;
begin
  for AColumnIndex := AStartColumnIndex to AEndColumnIndex do
...
function TdxTableGridCalculator.GetTotalPreferredWidth(AGrid: TdxTableGrid;
  AStartColumnIndex, AEndColumnIndex: Integer): TdxLayoutUnit;
var
  AColumnIndex: Integer;
begin
...
procedure TdxTableGridCalculator.EnlargeColumnsHorizontalMargins
  (AGrid: TdxTableGrid; AStartColumnIndex, AEndColumnIndex, AOldWidth,
...
function TdxTableGridCalculator.CreateTableGridInterval(AUnitConverter
  : TdxDocumentModelUnitToLayoutUnitConverter; AWidth: TdxWidthUnit;
  AColumnSpan: Integer): TdxTableGridInterval;
begin
  if AWidth.&Type = TdxWidthUnitType.ModelUnits then
    Exit(TdxTableGridInterval.Create(AUnitConverter.ToLayoutUnits(AWidth.Value),
      AColumnSpan, TdxTableGridIntervalType.ModelUnit));
  if AWidth.&Type = TdxWidthUnitType.FiftiethsOfPercent then
    Exit(TdxTableGridInterval.Create(AWidth.Value, AColumnSpan,
      TdxTableGridIntervalType.PercentBased));
  Result := TdxTableGridInterval.Create(0, AColumnSpan,
    TdxTableGridIntervalType.NotSet);
end;

function TdxTableGridCalculator.CreateIntervals(ARow: TdxTableRow)
  : TdxTableGridIntervalList;
var
  AUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
begin
  ...
  if ARow.GridBefore > 0 then
    Result.Add(CreateTableGridInterval(AUnitConverter, ARow.WidthBefore,
      ARow.GridBefore));
  ConvertToIntervals(ARow.Cells, Result, AUnitConverter);
  if ARow.GridAfter > 0 then
    Result.Add(CreateTableGridInterval(AUnitConverter, ARow.WidthAfter,
      ARow.GridAfter));
end;

procedure TdxTableGridCalculator.ConvertToIntervals
  (ACells: TdxTableCellCollection; AIntervals: TdxTableGridIntervalList;
  AUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter);
var
...
begin
  ACellCount := ACells.Count;
  for I := 0 to ACellCount - 1 do
    AIntervals.Add(CreateTableGridInterval(AUnitConverter,
      ACells[I].PreferredWidth, ACells[I].ColumnSpan));
end;

function TdxTableGridCalculator.CalculateTableGridCore(ACurrentRow,
  ANextRow: TdxTableGridIntervalList; APercentBaseWidth: Integer)
  : TdxTableGridIntervalList;
begin
  Assert(ACurrentRow <> nil);
  Assert(ANextRow <> nil);
  Result := CalculateTableGridPartially(ACurrentRow, ANextRow,
    APercentBaseWidth);
end;

function TdxTableGridCalculator.CalculateTableGridPartially(ACurrentRow,
  ANextRow: TdxTableGridIntervalList; APercentBaseWidth: Integer)
  : TdxTableGridIntervalList;
var
...
begin
  Result := TdxTableGridIntervalList.Create;
  ACurrentRowIterator := TdxTableGridIntervalIterator.Create(ACurrentRow,
    APercentBaseWidth);
  ANextRowIterator := TdxTableGridIntervalIterator.Create(ANextRow,
    APercentBaseWidth);
  try
    while not ACurrentRowIterator.EndOfIntervals and
      not ANextRowIterator.EndOfIntervals do
    begin
      ...
      else if ACurrentRowSpan < ANextRowSpan then
...
function TdxTableGridCalculator.CanUseCachedTableLayoutInfo(ATableLayoutInfo
  : TdxTableLayoutInfo; APercentBaseWidth: TdxLayoutUnit): Boolean;
begin
  if ATableLayoutInfo = nil then
    Result := False
  else
    Result := FTableWidthsCalculator.CanUseCachedTableLayoutInfo
      (ATableLayoutInfo) and ATableLayoutInfo.CanUseTableGrid(FMaxTableWidth,
      FAllowTablesToExtendIntoMargins, FSimpleView, APercentBaseWidth);
end;

procedure TdxTableGridCalculator.ReplaceCachedTableLayoutInfoIfNeeded
  (ATable: TdxTable; ATableGrid: TdxTableGrid;
  APercentBaseWidth: TdxLayoutUnit);
var
  ACachedInfo: TdxTableLayoutInfo;
begin
  ACachedInfo := FTableWidthsCalculator.CreateTableLayoutInfo(ATableGrid,
    FMaxTableWidth, FAllowTablesToExtendIntoMargins, FSimpleView,
    APercentBaseWidth);
...
procedure TdxTableGridCalculator.ProcessIntervals(ACurrentRowIterator,
  ANextRowIterator: TdxTableGridIntervalIterator;
  AResult: TdxTableGridIntervalList);
var
...
procedure TdxTableGridCalculator.ProcessDependedIntervals
  (const AMasterRowIterator, ASlaveRowIterator: TdxTableGridIntervalIterator;
  AResult: TdxTableGridIntervalList);
var
...
begin
  ...
  try
    ...
    repeat
      ...
      ARestMasterInterval := TdxTableGridIntervalIterator.SubstructIntervals
        (ARestMasterInterval, ASlaveInterval,
        AMasterRowIterator.PercentBaseWidth,
        ASlaveRowIterator.PercentBaseWidth);
    until (ARestMasterInterval.ColumnSpan = 0) or
      ASlaveRowIterator.EndOfIntervals or
      (ASlaveRowIterator.CurrentInterval.Value.ColumnSpan >
      ARestMasterInterval.ColumnSpan);

    ACalculateNotSetIntervals :=
      (ARestMasterInterval.IntervalType = TdxTableGridIntervalType.ModelUnit)
      and (AAutoSizeIntervalsCount > 0);
    ...
    begin
      ...
      if ACalculateNotSetIntervals and
        (AInterval.IntervalType = TdxTableGridIntervalType.NotSet) then
      begin
        AInterval.IntervalType := TdxTableGridIntervalType.ModelUnit;
      ...
      if AMasterRowIterator.CurrentInterval.Value.ColumnSpan > 1 then
        ...
        AResult.Add(CalculateNewInterval(AMasterRowIterator.CurrentInterval.
          Value, AInterval));
...
function TdxTableGridCalculator.CalculateNewInterval(const ACurrentRowInterval,
  ANextRowInterval: TdxTableGridInterval): TdxTableGridInterval;
var
...
begin
  ...
  begin
    ...
    Result := TdxTableGridInterval.Create(AWidth, ACurrentRowSpan,
      ANextRowInterval.IntervalType);
  end
  else
  begin
    if ACurrentRowInterval.IntervalType = TdxTableGridIntervalType.PercentBased
    then
      Result := CalculateNewIntervalFromMixedIntervals(ACurrentRowInterval,
        ANextRowInterval, ACurrentRowSpan)
    else if ANextRowInterval.IntervalType = TdxTableGridIntervalType.PercentBased
    then
      Result := CalculateNewIntervalFromMixedIntervals(ANextRowInterval,
        ACurrentRowInterval, ACurrentRowSpan)
    else if ACurrentRowInterval.IntervalType = TdxTableGridIntervalType.ModelUnit
    then
    begin
      Assert(ANextRowInterval.IntervalType = TdxTableGridIntervalType.NotSet);
      Result := TdxTableGridInterval.Create(ACurrentRowInterval.Width,
        ACurrentRowSpan, TdxTableGridIntervalType.ModelUnit);
    end
    else
    begin
      Assert(ACurrentRowInterval.IntervalType =
        TdxTableGridIntervalType.NotSet);
      Assert(ANextRowInterval.IntervalType = TdxTableGridIntervalType.
        ModelUnit);
      Result := TdxTableGridInterval.Create(ANextRowInterval.Width,
        ACurrentRowSpan, TdxTableGridIntervalType.ModelUnit);
    end;
  end;
end;

function TdxTableGridCalculator.CalculateNewIntervalFromMixedIntervals
  (const APercentWidthInterval, AValueWidthInterval: TdxTableGridInterval;
  AColumnSpan: Integer): TdxTableGridInterval;
begin
  if AValueWidthInterval.Width > 0 then
    Result := TdxTableGridInterval.Create(AValueWidthInterval.Width,
      AColumnSpan, AValueWidthInterval.IntervalType)
  else
    Result := TdxTableGridInterval.Create(APercentWidthInterval.Width,
      AColumnSpan, APercentWidthInterval.IntervalType);
end;

procedure TdxTableGridCalculator.CopyRestIntervals
  (ASource: TdxTableGridIntervalIterator;
  ACollection: TdxTableGridIntervalList);
var
  AInterval: TdxTableGridInterval;
begin
...
function TdxTableGridCalculator.GetActualWidth(AUnitInfo: TdxWidthUnitInfo;
  APercentBaseWidth: Integer): TdxLayoutUnit;
begin
  if AUnitInfo.&Type = TdxWidthUnitType.ModelUnits then
...
procedure TdxTableGridCalculator.ApplyCellContentWidthWithSpan
  (AGrid: TdxTableGrid; ACell: TdxTableCell;
  AStartColumnIndex, APercentBaseWidth: Integer);
var
  AEndColumnIndex: Integer;
  AInfo: TdxWidthsInfo;
  AGridWidth, ACellMinWidth, ACellMaxWidth, APreferredWidth, AGridMinWidth,
    AGridMaxWidth, AGridTotalMargins: TdxLayoutUnit;
begin
  Assert(ACell.ColumnSpan > 1);
  ...
  AGridMinWidth := GetTotalMinWidthCore(AGrid, AStartColumnIndex,
    AEndColumnIndex);
  if ACellMinWidth > AGridMinWidth then
    EnlargeColumnsMinWidth(AGrid, AStartColumnIndex, AEndColumnIndex,
      AGridMinWidth, ACellMinWidth);

  AGridMaxWidth := GetTotalMaxWidthCore(AGrid, AStartColumnIndex,
    AEndColumnIndex);
  if ACellMaxWidth > AGridMaxWidth then
    EnlargeColumnsMaxWidth(AGrid, AStartColumnIndex, AEndColumnIndex,
      AGridMaxWidth, ACellMaxWidth);

  AGridTotalMargins := GetTotalHorizontalMarginsCore(AGrid, AStartColumnIndex,
    AEndColumnIndex);
  if AInfo.TotalHorizontalMargins > AGridTotalMargins then
    EnlargeColumnsHorizontalMargins(AGrid, AStartColumnIndex, AEndColumnIndex,
      AGridTotalMargins, AInfo.TotalHorizontalMargins);
end;

procedure TdxTableGridCalculator.CompressTableGridToColumnWidth
  (AGrid: TdxTableGrid; AOldWidth, ANewWidth: TdxLayoutUnit);
var
...
begin
  ...
  begin
    if ARest > 0 then
      ANewColumnWidth := Max(AGrid.Columns[I].MinWidth *
        ATotalWidth div ARest, 1)
    else
      ANewColumnWidth := 1;
...
procedure TdxTableGridCalculator.CompressTableGridToPreferredWidth
  (AGrid: TdxTableGrid; AOldWidth, ANewWidth: TdxLayoutUnit);
var
  ATotalMinWidth, ATotalMaxWidth, ATotalPreferredWidth,
    ATotalMinWidthForNonPreferredWidthColumn,
    ATotalMaxWidthForNonPreferredWidthColumn, ATotalDelta, AMinWidth,
    ARest: TdxLayoutUnit;
...
begin
  ...
  ATotalMaxWidthForNonPreferredWidthColumn := ATotalMaxWidth -
    ATotalPreferredWidth;
  ...
  if ANewWidth - ATotalMinWidthForNonPreferredWidthColumn < ATotalPreferredWidth
  then
  begin
    ...
    ARest := ATotalPreferredWidth -
      (ATotalMinWidth - ATotalMinWidthForNonPreferredWidthColumn);
    ...
    begin
      ...
      begin
        ...
        ADelta := Trunc
          (((AGrid.Columns[I].PreferredWidth - AGrid.Columns[I].MinWidth) /
          ARest) * ATotalDelta);
  ...
  begin
    ATotalDelta := AOldWidth - ANewWidth;
    ARest := ATotalMaxWidthForNonPreferredWidthColumn -
      ATotalMinWidthForNonPreferredWidthColumn;
    I := AGrid.Columns.Count - 1;
    while (I >= 0) and (ATotalDelta > 0) do
    begin
      ...
      begin
        ...
        ADelta := Trunc(((AGrid.Columns[I].MaxWidth - AGrid.Columns[I].MinWidth)
          / ARest) * ATotalDelta);
        AGrid.Columns[I].Width := AGrid.Columns[I].Width - ADelta;
...
procedure TdxTableGridCalculator.EnlargeTableGridToPreferredWidth
  (AGrid: TdxTableGrid; AOldWidth, ANewWidth: TdxLayoutUnit);
var
...
begin
  ...
  ATotalPreferredWidth := GetTotalPreferredWidth(AGrid, 0,
    AGrid.Columns.Count - 1);
  AHasColumnsWithoutPreferredWidth := HasColumnsWithoutPreferredWidth(AGrid, 0,
    AGrid.Columns.Count - 1);
  ATotalDelta := ANewWidth - AOldWidth;
...
procedure TdxTableGridCalculator.AutofitTable(AGrid: TdxTableGrid;
  ATable: TdxTable; APercentBaseWidth: Integer);
var
...
begin
  ...
  APreferredWidth := ATable.GetActualPreferredWidth;
  if APreferredWidth.&Type in [TdxWidthUnitType.ModelUnits,
    TdxWidthUnitType.FiftiethsOfPercent] then
  begin
    APreferredTableWidth := GetActualWidth(APreferredWidth, APercentBaseWidth);
    if AWidth >= APreferredTableWidth then
    begin
      if (AMinWidth < FMaxTableWidth) or (APreferredTableWidth > FMaxTableWidth)
      then
    ...
    else if AWidth < APreferredTableWidth then
      EnlargeTableGridToPreferredWidth(AGrid, AWidth, APreferredTableWidth);
  end
  else
  begin
    if (AWidth > FMaxTableWidth) and
      ((ATable.TableLayout = TdxTableLayoutType.Autofit) or SimpleView) then
      CompressTableGridToColumnWidth(AGrid, AWidth, FMaxTableWidth)
    else
...
procedure TdxTableGridCalculator.ApplyCellContentWidth(AGrid: TdxTableGrid;
  ATable: TdxTable; APercentBaseWidth: Integer);
var
  ARows: TdxTableRowCollection;
  ARowCount, ARowIndex, AColumnCount, AColumnIndex, ACellIndex, ACellCount,
    I: Integer;
  ARow: TdxTableRow;
  ACells: TdxTableCellCollection;
  ACell: TdxTableCell;
...
begin
  ...
  begin
    ...
    begin
      ...
      if ACell.ColumnSpan = 1 then
        ApplyCellContentWidthWithoutSpan(AGrid, ACell, AColumnIndex,
          APercentBaseWidth);
      Inc(AColumnIndex, ACell.ColumnSpan);
    end;
  end;
  ...
  begin
    ...
    begin
      ACell := ACells[ACellIndex];
      if ACell.ColumnSpan > 1 then
        ApplyCellContentWidthWithSpan(AGrid, ACell, AColumnIndex,
          APercentBaseWidth);
      Inc(AColumnIndex, ACell.ColumnSpan);
    end;
  end;
...
procedure TdxTableGridCalculator.CompressRelativelySizedTable
  (AGrid: TdxTableGrid; ATable: TdxTable);
var
  ARows: TdxTableRowCollection;
...
begin
  APreferredWidth := ATable.GetActualPreferredWidth;
  if not((APreferredWidth.&Type = TdxWidthUnitType.Auto) and
    (ATable.TableLayout = TdxTableLayoutType.Autofit) and FFlex) then
    Exit;
  ARows := ATable.Rows;
  ARowCount := ARows.Count;
  AColumns := AGrid.Columns;
  ...
  begin
    ...
    begin
      ...
      if ACell.VerticalMerging = TdxMergingState.Continue then
        Continue;
      if ACell.LayoutProperties.ContentWidthsInfo.MaxWidth >=
        ACell.LayoutProperties.ContainerWidthsInfo.MaxWidth then
        Exit;
      Q := ACell.LayoutProperties.ContentWidthsInfo.MaxWidth /
        ACell.LayoutProperties.ContainerWidthsInfo.MaxWidth;
      if Q > ARatio then
        ARatio := Q;
    end;
  end;
...
constructor TdxTableWidthsContainer.Create(ACellWidths: TdxCellWidths;
  AGridBeforeWidths: TdxGridBeforeWidths);
begin
...
constructor TdxTableColumnWidthCalculator.Create(ATable: TdxTable;
  const AServer: IdxInnerRichEditDocumentServerOwner);
begin
  inherited Create;
  FTable := ATable;
...
function TdxTableColumnWidthCalculator.GetTableGridColumns
  : TdxTableGridColumnCollection;
var
  AGrid: TdxTableGrid;
...
var
  ...
  AWidths: TdxRectList;
begin
  APosition := DocumentModel.ActivePieceTable.Paragraphs
    [Table.StartParagraphIndex].LogPosition;
  ...
  try
    ...
    try
      ...
      try
        AWidths := AColumnsBoundsCalculator.Calculate(ASection,
...
function TdxTableColumnWidthCalculator.GetTableGrid(ATable: TdxTable;
  APercentWidthBase: Integer; AMeasurer: TdxBoxMeasurer): TdxTableGrid;
var
...
begin
  ...
  try
    ...
    AWidthsCalculator := TdxTableWidthsCalculator.Create
      (TdxPieceTable(ATable.PieceTable), AMeasurer, APercentWidthBase);
    try
...
begin
  ...
  begin
    ACurrentRow := ARows[I];
    AGridBeforeWidths.Add(ACurrentRow, GetColumnsWidth(AGridColumns, 0,
      ACurrentRow.GridBefore - 1));
    ...
    begin
      ...
      ACellWidths.Add(ACurrentCell, GetColumnsWidth(AGridColumns,
        AFirstCellIndex, ALastCellIndex));
...
function TdxTableColumnWidthCalculator.GetColumnsWidth
  (AGridColumns: TdxTableGridColumnCollection; AFirstIndex: Integer;
...
constructor TdxTableColumnKnownWidthCalculator.Create(ATable: TdxTable;
  const AContainer: TdxTableWidthsContainer);
begin
  inherited Create;
  FTable := ATable;
...
function TdxTableColumnKnownWidthCalculator.GetTableGridColumns
  : TdxTableGridColumnCollection;
var
...
function TdxTableColumnKnownWidthCalculator.CreateColumnCollection
  (AListWidths: TdxIntegerList): TdxTableGridColumnCollection;
var
...
begin
  inherited Create(AConverter,
    AConverter.ToLayoutUnits(DefaultPercentBaseWidthInTwips));
end;
...
begin
  Result := inherited CalculateCellContentWidthsCore(ACell, APercentBaseWidth,
    ASimpleView);
  ...
  if APreferredWidth = 0 then
    APreferredWidth := Converter.ToLayoutUnits(DefaultPreferredWidthInTwips) *
      ACell.ColumnSpan;
...
function TdxJoinTableWidthsCalculator.GetMaxWidth(const AContentWidths
  : TdxWidthsContentInfo; AHorizontalMargins, ABordersWidth,
  ASpacing: TdxModelUnit): TdxLayoutUnit;
begin
...
function TdxJoinTableWidthsCalculator.GetMinWidth(const AContentWidths
  : TdxWidthsContentInfo; AHorizontalMargins, ABordersWidth,
  ASpacing: TdxModelUnit): TdxLayoutUnit;
begin
