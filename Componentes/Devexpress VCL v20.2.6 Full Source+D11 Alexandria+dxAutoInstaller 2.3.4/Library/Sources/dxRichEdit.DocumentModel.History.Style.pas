...
type
  ...
  TdxParagraphStyleChangeAutoUpdatePropertyHistoryItem = class
  ...
  TdxParagraphStyleChangeNextParagraphStylePropertyHistoryItem = class
    (TdxRichEditHistoryItem)
  strict private
    FStyle: TdxParagraphStyle;
  ...
  protected
    ...
    procedure RedoCore; override;
  public
    constructor Create(AStyle: TdxParagraphStyle; AOldValue: TdxParagraphStyle;
      ANewValue: TdxParagraphStyle); reintroduce;
...
constructor TdxChangeParagraphStyleIndexHistoryItem.Create
...
constructor TdxParagraphStyleChangeAutoUpdatePropertyHistoryItem.Create
...
constructor TdxParagraphStyleChangeNextParagraphStylePropertyHistoryItem.Create
  (AStyle: TdxParagraphStyle; AOldValue: TdxParagraphStyle;
  ANewValue: TdxParagraphStyle);
begin
  inherited Create(AStyle.DocumentModel.MainPart);
  FStyle := AStyle;
  FOldValue := AOldValue;
