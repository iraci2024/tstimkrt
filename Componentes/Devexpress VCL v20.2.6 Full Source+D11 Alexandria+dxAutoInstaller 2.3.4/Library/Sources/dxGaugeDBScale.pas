...
uses
  cxDB, cxDataUtils, dxGaugeCircularScale, dxGaugeDigitalScale,
  dxGaugeLinearScale;
...
procedure TdxGaugeDBCircularScale.SetDataBinding(const AValue
  : TcxDBDataBinding);
begin
...
function TdxGaugeDBCircularHalfScale.GetDataBindingClass
  : TcxCustomDataBindingClass;
begin
  Result := TcxDBDataBinding;
end;
...
procedure TdxGaugeDBCircularHalfScale.SetDataBinding(const AValue
  : TcxDBDataBinding);
begin
  inherited DataBinding := AValue;
end;
...
function TdxGaugeDBCircularQuarterLeftScale.GetDataBindingClass
  : TcxCustomDataBindingClass;
begin
  Result := TcxDBDataBinding;
end;
...
procedure TdxGaugeDBCircularQuarterLeftScale.SetDataBinding
  (const AValue: TcxDBDataBinding);
begin
  inherited DataBinding := AValue;
end;
...
function TdxGaugeDBCircularQuarterRightScale.GetDataBindingClass
  : TcxCustomDataBindingClass;
begin
  Result := TcxDBDataBinding;
end;
...
procedure TdxGaugeDBCircularQuarterRightScale.SetDataBinding
  (const AValue: TcxDBDataBinding);
begin
  inherited DataBinding := AValue;
end;
...
function TdxGaugeDBCircularThreeFourthScale.GetDataBindingClass
  : TcxCustomDataBindingClass;
begin
  Result := TcxDBDataBinding;
end;
...
procedure TdxGaugeDBCircularThreeFourthScale.SetDataBinding
  (const AValue: TcxDBDataBinding);
begin
  inherited DataBinding := AValue;
end;
...
function TdxGaugeDBCircularWideScale.GetDataBindingClass
  : TcxCustomDataBindingClass;
begin
  Result := TcxDBDataBinding;
end;
...
procedure TdxGaugeDBCircularWideScale.SetDataBinding(const AValue
  : TcxDBDataBinding);
begin
  inherited DataBinding := AValue;
end;
