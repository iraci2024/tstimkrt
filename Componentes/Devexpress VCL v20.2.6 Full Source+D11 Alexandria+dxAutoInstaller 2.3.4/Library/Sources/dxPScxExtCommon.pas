...
type
  ...
  protected
    ...
    function GetColorBoxFrameBounds(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; virtual;
    function GetColorBoxIntreriorBounds(ACanvas: TdxPSReportRenderCustomCanvas)
      : TRect; virtual;
  public
    constructor Create(AParent: TdxReportCell); override;
    procedure Assign(Source: TPersistent); override;

    function ActualColorBoxWidth(ACanvas: TdxPSReportRenderCustomCanvas)
      : Integer; virtual;
    ...
    property ColorBoxAlignment: TdxReportCellColorBoxAlignment
      read GetColorBoxAlignment write SetColorBoxAlignment;
    property ColorBoxFrameColor: TColor read FColorBoxFrameColor
      write FColorBoxFrameColor;
  ...
  protected
    ...
    function GetProgressBarOverloadBounds
      (ACanvas: TdxPSReportRenderCustomCanvas): TRect; virtual;
    function GetProgressBarProgressBounds
      (ACanvas: TdxPSReportRenderCustomCanvas): TRect; virtual;
    function GetProgressBarProgressRestBounds
      (ACanvas: TdxPSReportRenderCustomCanvas): TRect; virtual;
    function IsProgressBarDrawn(ACanvas: TdxPSReportRenderCustomCanvas)
      : Boolean; virtual;
  ...
  public
    ...
    property ShowPercentSymbol: Boolean read GetShowPercentSymbol
      write SetShowPercentSymbol;
  ...
  protected
    ...
    class procedure InitializeItem(AnItem: TAbstractdxReportCellData;
      ...
      ARecordIndex: Integer = -1; AOwner: TObject = nil); override;
...
{$ENDIF}
  ...
  protected
    class function GetValue(AProperties: TcxCustomEditProperties;
      const AValue: TcxEditValue): Double;
    class function HasText(AProperties: TcxCustomEditProperties;
      const AValue: TcxEditValue): Boolean; override;
    class procedure InitializeItem(AnItem: TAbstractdxReportCellData;
      AProperties: TcxCustomEditProperties; const AValue: TcxEditValue;
      const ACellParams: IdxPSCellParams;
      var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
...
function ColorComboBoxProperties_GetColor(AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue): TColor;
function ColorComboBoxProperties_GetColorBoxAlignment
  (AProperties: TcxCustomEditProperties): TdxReportCellColorBoxAlignment;
function ColorComboBoxProperties_GetColorBoxFrameColor
  (AProperties: TcxCustomEditProperties): TColor;
function ColorComboBoxProperties_GetColorBoxWidth
  (AProperties: TcxCustomEditProperties): Integer;
function ColorComboBoxProperties_GetShowDescriptions
  (AProperties: TcxCustomEditProperties): Boolean;
function ColorComboBoxProperties_GetText(AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue): string;
function FontNameComboBox_GetShowTypeIcon(AProperties
  : TcxCustomEditProperties): Boolean;
function FontNameComboBox_GetTypeIconImageIndex(AProperties
  : TcxCustomEditProperties; const AValue: TcxEditValue): Integer;
function ProgressBarProperties_GetMaxValue(AProperties
  : TcxCustomEditProperties): Double;
function ProgressBarProperties_GetMinValue(AProperties
  : TcxCustomEditProperties): Double;
function ProgressBarProperties_GetOrientation(AProperties
  : TcxCustomEditProperties): TdxOrientation;
function ProgressBarProperties_GetProgressBarColor
  (AProperties: TcxCustomEditProperties): TColor;
function ProgressBarProperties_GetShowPercentSymbol
  (AProperties: TcxCustomEditProperties): Boolean;
function ProgressBarProperties_GetShowText(AProperties
  : TcxCustomEditProperties): Boolean;
function ProgressBarProperties_GetText(AProperties
  : TcxCustomEditProperties): string;
function CheckGroupProperties_GetGlyph(AProperties: TcxCustomEditProperties)
  : TdxSmartGlyph;
function CheckGroupProperties_GetGlyphCount(AProperties
  : TcxCustomEditProperties): Integer;
function CheckGroupProperties_GetCheckPos(AProperties: TcxCustomEditProperties)
  : TdxCellCheckPos;
function CheckGroupProperties_GetCheckStates(AProperties
  : TcxCustomEditProperties; const AValue: TcxEditValue;
  out ACheckStates: TcxCheckStates): Boolean;
function CheckGroupProperties_GetIsItemEnabled(AProperties
...
const
  ...
  ColorBoxAlignmentMap: array [TcxColorBoxAlign]
    of TdxReportCellColorBoxAlignment = (ccbaLeft, ccbaRight);
  LeftRightMap: array [TLeftRight] of TdxCellCheckPos = (ccpLeft, ccpRight);

implementation

uses
  SysUtils, Controls, Variants, cxLabel, cxProgressBar, cxTrackBar,
  cxFontNameComboBox, dxRatingControl,
  cxExtEditUtils, {$IFDEF REGISTERCXSHELLCTRLS} cxShellComboBox, {$ENDIF}
  ComCtrls, Forms, cxContainer, cxRichEdit, dxPSRELnk, dxPSUtl, Math,
  cxDrawTextUtils, cxGraphics, cxVariants;

type
  TcxCustomColorComboBoxPropertiesAccess = class
    (TcxCustomColorComboBoxProperties);
  TcxCustomFontNameComboBoxPropertiesAccess = class
    (TcxCustomFontNameComboBoxProperties);
  TcxCustomProgressBarPropertiesAccess = class(TcxCustomProgressBarProperties);
{$IFDEF REGISTERCXSHELLCTRLS}
  TcxCustomShellComboBoxPropertiesAccess = class
...
const
  Eps: Double = 0.001;
  ProgressBarOrientationMap: array [TcxProgressBarOrientation]
    of TdxOrientation = (orHorizontal, orVertical);
  ...
  dxFormatColorBoxAlignmentMask = dxFormatColorBoxAlignmentLeft or
    dxFormatColorBoxAlignmentRight;

  dxFormatProgressBarShowPercentSymbol = dxPSGlbl.
    dxFormatMakeSpaceForEmptyImage;
  ...
  dxFormatProgressBarOrientationMask = dxFormatProgressBarOrientationHorizontal
    or dxFormatProgressBarOrientationVertical;
...
begin
  ...
  begin
    ...
    else if (ColorComboStyle = cxccsComboList) and not IsVarEmpty(AValue) then
      Result := DefaultColor
    else
...
function ColorComboBoxProperties_GetColorBoxAlignment
  (AProperties: TcxCustomEditProperties): TdxReportCellColorBoxAlignment;
begin
  Result := ColorBoxAlignmentMap
    [TcxCustomColorComboBoxPropertiesAccess(AProperties).ColorBoxAlign];
end;

function ColorComboBoxProperties_GetColorBoxFrameColor
  (AProperties: TcxCustomEditProperties): TColor;
begin
  Result := TcxCustomColorComboBoxPropertiesAccess(AProperties)
    .ColorBoxFrameColor;
end;
...
begin
  ...
  begin
    ItemIndex := IndexByValue(AValue);
    if (ItemIndex = -1) and ((ColorComboStyle <> cxccsComboList) or
      IsVarEmpty(AValue)) then
    begin
...
function FontNameComboBox_GetShowTypeIcon(AProperties
  : TcxCustomEditProperties): Boolean;
begin
  Result := ftiShowInCombo in TcxCustomFontNameComboBoxPropertiesAccess
    (AProperties).ShowFontTypeIcon;
end;
...
begin
  ...
  if FontNameComboBox_GetShowTypeIcon(AProperties) then
    ...
    begin
      ...
      if Index <> -1 then
        Result := ImageIndexes[Integer(Items.Objects[Index]) and
          TRUETYPE_FONTTYPE = 0];
    end;
end;
...
function ProgressBarProperties_GetOrientation(AProperties
  : TcxCustomEditProperties): TdxOrientation;
begin
  Result := ProgressBarOrientationMap
    [TcxCustomProgressBarPropertiesAccess(AProperties).Orientation];
end;
...
function ProgressBarProperties_GetShowPercentSymbol
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := TcxCustomProgressBarPropertiesAccess(AProperties)
    .ShowTextStyle = cxtsPercent;
end;
...
function CheckGroupProperties_GetCheckPos(AProperties: TcxCustomEditProperties)
  : TdxCellCheckPos;
begin
  Result := LeftRightMap[TcxCustomCheckGroupPropertiesAccess(AProperties)
    .ItemAlignment];
end;
...
begin
  with TcxCustomCheckGroupPropertiesAccess(AProperties) do
    Result := cxCheckBox.CalculateCheckStates(AValue, Items, EditValueFormat,
      ACheckStates)
end;
...
function CheckGroupProperties_GetIsItemEnabled(AProperties
  : TcxCustomEditProperties; AnIndex: Integer): Boolean;
begin
  Result := TcxCustomCheckGroupPropertiesAccess(AProperties)
    .Items[AnIndex].Enabled;
end;
...
procedure TdxReportCellColorBox.DrawImage
...
procedure TdxReportCellColorBox.ConvertCoords(APixelsNumerator,
...
begin
  ...
  if ShowDescription then
    if ColorBoxAlignment = ccbaLeft then
      Result.Right := Result.Left + ActualColorBoxWidth(ACanvas) + 2 *
        LineThickness
    else
      Result.Left := Result.Right - ActualColorBoxWidth(ACanvas) + 2 *
        LineThickness;
end;

function TdxReportCellColorBox.GetImageBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
...
procedure TdxReportCellColorBox.GetImageSizes(var AImageWidth,
...
function TdxReportCellColorBox.GetTextBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
  if ShowDescription then
  begin
...
procedure TdxReportCellColorBox.DrawColorBox
  (ACanvas: TdxPSReportRenderCustomCanvas);
begin
  Renderer.FrameRect(ACanvas, GetImageAreaBounds(ACanvas), Color);
  Renderer.FrameRect(ACanvas, GetColorBoxFrameBounds(ACanvas),
    ColorBoxFrameColor);
...
function TdxReportCellColorBox.GetColorBoxAlignment
  : TdxReportCellColorBoxAlignment;
begin
  Result := TdxReportCellColorBoxAlignment
    ((Format and dxFormatColorBoxAlignmentMask)
    shr dxFormatColorBoxAlignmentOffset);
end;
...
procedure TdxReportCellColorBox.SetColorBoxAlignment
  (Value: TdxReportCellColorBoxAlignment);
begin
...
procedure TdxReportCellProgressBar.DrawText
  (ACanvas: TdxPSReportRenderCustomCanvas);

  procedure DrawClippedText(var ATextRect, AClipRect: TRect;
    ATextColor: TColor);
  begin
    ACanvas.SaveClipRgn;
    try
      ...
      Renderer.DrawTextEx(ACanvas, ATextRect, 0, 0, 0, Text, nil,
        DTFormat and not CXTO_AUTOINDENTS);
    finally
...
begin
  ...
  try
    ...
    if IntersectRect(AClipRect, ATextRect, GetProgressBarOverloadBounds(ACanvas))
    then
    begin
      DrawClippedText(ATextRect, AClipRect, dxInvertColor(OverloadColor));
      ACanvas.ExcludeClipRect(AClipRect);
    end;
    if IntersectRect(AClipRect, ATextRect, GetProgressBarProgressBounds(ACanvas))
    then
      DrawClippedText(ATextRect, AClipRect, dxInvertColor(ProgressColor));
    if IntersectRect(AClipRect, ATextRect,
      GetProgressBarProgressRestBounds(ACanvas)) then
...
begin
  if not ShowText then
    ...
    Result := FText
  else if ShowPercentSymbol then
...
function TdxReportCellProgressBar.GetProgressBarOverloadBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
var
  ADelta: Double;
begin
  ...
  begin
    if Orientation = orHorizontal then
      ...
      Result.Bottom := Result.Top +
        Round(cxRectHeight(Result) * (1 - Progress));
...
begin
  Result := TdxOrientation((Format and dxFormatProgressBarOrientationMask)
    shr dxFormatProgressBarOrientationOffset);
end;
...
function TdxReportCellProgressBar.HasOverloadProperties(const AVersion
...
begin
  Format := Format and not dxFormatProgressBarOrientationMask or
    (Byte(Value) shl dxFormatProgressBarOrientationOffset);
end;
...
function TdxReportCellRichEditGraphicEx.MeasureContentHeight
  (ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
...
begin
  ...
  try
    ...
    Result := dxPSRELnk.GetRichEditAsGraphic(RichEdit.Handle, FBkColor,
      FMargins, FGraphicClass, FWidth, -1, FMaxHeight, 0,
...
function TdxReportCellTrackBar.GetTextBounds
  (ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
  Result := GetInnerBounds(ACanvas);
...
begin
  Result := not((ReportLink is TdxCustomcxControlReportLink) and
    TdxCustomcxControlReportLink(ReportLink)
    .OptionsRefinements.DisplayTrackBarsAsText);
end;
...
class function TdxPSColorComboBoxDataMap.DoesItemParticipateInBestFitCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := ColorComboBoxProperties_GetShowDescriptions(AProperties);
end;

class function TdxPSColorComboBoxDataMap.GetText(AProperties
  : TcxCustomEditProperties; const AValue: TcxEditValue): string;
begin
  Result := ColorComboBoxProperties_GetText(AProperties, AValue);
end;

class procedure TdxPSColorComboBoxDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = -1; AOwner: TObject = nil);
begin
  inherited;
  with TdxReportCellColorBox(AnItem) do
  begin
    ColorBoxAlignment := ColorComboBoxProperties_GetColorBoxAlignment
      (AProperties);
    ColorBoxFrameColor := ColorComboBoxProperties_GetColorBoxFrameColor
      (AProperties);
...
class function TdxPSColorComboBoxDataMap.ItemClass
...
class function TdxPSColorComboBoxDataMap.MeasureWidth
  (AProperties: TcxCustomEditProperties; const AValue: TcxEditValue;
...
class function TdxPSColorComboBoxDataMap.PropertiesClass
...
class procedure TdxPSFontNameComboBoxDataMap.GetImageLists
  (AProperties: TcxCustomEditProperties; AProc: TdxPSGetImageListProc);
begin
  AProc(GetImages(AProperties));
end;

class function TdxPSFontNameComboBoxDataMap.GetImages
  (AProperties: TcxCustomEditProperties): TCustomImageList;
begin
  Result := FontImages;
end;

class procedure TdxPSFontNameComboBoxDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = -1; AOwner: TObject = nil);
...
class function TdxPSFontNameComboBoxDataMap.ItemClass
  (AProperties: TcxCustomEditProperties; AnIsPreview: Boolean = False)
  : TdxReportCellDataClass;
begin
...
class function TdxPSFontNameComboBoxDataMap.MeasureWidth
  (AProperties: TcxCustomEditProperties; const AValue: TcxEditValue;
  const ACellParams: IdxPSCellParams; AFont: TFont;
  ARecordIndex: Integer = 0): Integer;
begin
...
class function TdxPSFontNameComboBoxDataMap.PropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
class function TdxPSShellComboBoxDataMap.GetImageIndex
  (AProperties: TcxCustomEditProperties; const AValue: TcxEditValue): Integer;
var
  Text: string;
  Stub: Integer;
begin
  TcxCustomShellComboBoxPropertiesAccess(AProperties)
    .GetShellDisplayValue(AValue, False, Text, Result, Stub);
end;

class procedure TdxPSShellComboBoxDataMap.GetImageLists
  (AProperties: TcxCustomEditProperties; AProc: TdxPSGetImageListProc);
begin
  AProc(GetImages(AProperties));
end;

class function TdxPSShellComboBoxDataMap.GetImages
  (AProperties: TcxCustomEditProperties): TCustomImageList;
begin
  Result := dxPSUtl.ShellSmallImages;
  // cxShellComboBox.cxShellComboBoxImageList
end;

class function TdxPSShellComboBoxDataMap.HasImages
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := GetImages(AProperties) <> nil;
end;

class procedure TdxPSShellComboBoxDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = -1; AOwner: TObject = nil);
...
class function TdxPSShellComboBoxDataMap.ItemClass
  (AProperties: TcxCustomEditProperties; AnIsPreview: Boolean = False)
  : TdxReportCellDataClass;
begin
  Result := TdxReportCellImage;
...
class function TdxPSShellComboBoxDataMap.PropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TcxCustomShellComboBoxProperties;
end;

class function TdxPSShellComboBoxDataMap.MeasureWidth
  (AProperties: TcxCustomEditProperties; const AValue: TcxEditValue;
  const ACellParams: IdxPSCellParams; AFont: TFont;
  ARecordIndex: Integer = 0): Integer;
begin
...
class function TdxPSLabelDataMap.DoesItemParticipateInAutoWidthCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := True;
end;

class function TdxPSLabelDataMap.DoesItemParticipateInBestFitCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := True;
end;
...
class function TdxPSProgressBarDataMap.HasText(AProperties
  : TcxCustomEditProperties; const AValue: TcxEditValue): Boolean;
begin
  Result := inherited HasText(AProperties, AValue) and
    ProgressBarProperties_GetShowText(AProperties);
end;

class procedure TdxPSProgressBarDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = -1; AOwner: TObject = nil);
...
begin
  ...
  AProgressBar.ProgressColor := ProgressBarProperties_GetProgressBarColor
    (AProperties);
  AProgressBar.ShowPercentSymbol := ProgressBarProperties_GetShowPercentSymbol
    (AProperties);
  ...
  AProgressBar.ShowOverload := TcxCustomProgressBarPropertiesAccess(AProperties)
    .ShowOverload;
  AProgressBar.OverloadColor := TcxCustomProgressBarPropertiesAccess
    (AProperties).OverloadBeginColor;
  AProgressBar.OverloadValue := TcxCustomProgressBarPropertiesAccess
    (AProperties).OverloadValue;
end;

class function TdxPSProgressBarDataMap.ItemClass(AProperties
...
class function TdxPSProgressBarDataMap.PropertiesClass
  : TcxCustomEditPropertiesClass;
begin
  Result := TcxCustomProgressBarProperties;
end;

class function TdxPSProgressBarDataMap.GetValue(AProperties
  : TcxCustomEditProperties; const AValue: TcxEditValue): Double;
var
...
begin
  ...
  if not TryStrToFloat(AProgressBarProperties.InternalGetDisplayText(AValue,
    False, cxtsPosition), Result) then
    Result := 0;
end;

{ TdxPSTrackBarDataMap }

class procedure TdxPSTrackBarDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  ...
  begin
    ...
    try
      ...
      try
        ...
        AViewData := TcxCustomTrackBarViewData
          (AProperties.CreateViewData(AStyle, True));
        try
          AcxCanvas := TcxCanvas.Create(ACanvas);
          try
            TcxCustomTrackBarProperties(AProperties).PrepareDisplayValue(AValue,
              ADisplayValue, False);
            AViewInfo.Position := ADisplayValue;
            AViewData.Style.Color := AnItem.Color;
            AViewData.Calculate(AcxCanvas,
...
class function TdxPSTrackBarDataMap.ItemClass(AProperties
  : TcxCustomEditProperties; AnIsPreview: Boolean): TdxReportCellDataClass;
begin
  Result := TdxReportCellTrackBar;
end;

class function TdxPSTrackBarDataMap.PropertiesClass
  : TcxCustomEditPropertiesClass;
begin
      ...
      try
        ...
        try
          ...
          try
            ...
            AViewData.Style.Color := AnItem.Color;
            AViewData.Calculate(AcxCanvas,
              cxRectSetNullOrigin(AnItem.BoundsRect), Point(0, 0), cxmbNone, [],
              AViewInfo, False);
            AViewInfo.Paint(AcxCanvas);
          finally
            AcxCanvas.Free;
...
class function TdxPSRatingControlDataMap.ItemClass
  (AProperties: TcxCustomEditProperties; AnIsPreview: Boolean)
  : TdxReportCellDataClass;
begin
  Result := TdxReportCellGraphic;
end;

class function TdxPSRatingControlDataMap.PropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
class procedure TdxPSCheckButtonGroupDataMap.InitializeGroupButton
  (AProperties: TcxCustomEditProperties; const AValue: TcxEditValue;
...
begin
  ...
  begin
    ...
    AButton.Enabled := (CheckStates[AnIndex] <> cbsGrayed) and
      CheckGroupProperties_GetIsItemEnabled(AProperties, AnIndex);
  end
  else
  begin
...
class procedure TdxPSCheckButtonGroupDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = -1; AOwner: TObject = nil);
...
class function TdxPSCheckButtonGroupDataMap.PropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
class function TdxPSRichEditDataMap.DataMapClass(AProperties
  : TcxCustomEditProperties): TdxPSDataMapClass;
const
  DataMapClasses: array [Boolean] of TdxPSDataMapClass = (TdxPSRichTextDataMap,
    TdxPSMemoDataMap);
begin
  Result := DataMapClasses[RichEditProperties_GetIsMemoMode(AProperties)];
end;

class function TdxPSRichEditDataMap.PropertiesClass
  : TcxCustomEditPropertiesClass;
begin
...
class function TdxPSRichTextDataMap.DoesItemParticipateInBestFitCalculation
  (AProperties: TcxCustomEditProperties): Boolean;
begin
  Result := False;
end;

class procedure TdxPSRichTextDataMap.InitializeItem
  (AnItem: TAbstractdxReportCellData; AProperties: TcxCustomEditProperties;
  const AValue: TcxEditValue; const ACellParams: IdxPSCellParams;
  var AViewParams: TdxReportItemViewParams; AnIsPreview: Boolean = False;
  ARecordIndex: Integer = -1; AOwner: TObject = nil);
  ...
  var
    CellParams2: IdxPSCellParams2;
  begin
    Result := Supports(ACellParams, IdxPSCellParams2, CellParams2) and
      CellParams2.GetRichEditTransparent;
  end;
...
begin
  ...
  begin
    ...
    TdxReportCellRichEditGraphicEx(AnItem).FBkColor :=
      AViewParams.NativeParams.Color;
...
class function TdxPSRichTextDataMap.ItemClass(AProperties
  : TcxCustomEditProperties; AnIsPreview: Boolean = False)
  : TdxReportCellDataClass;
begin
