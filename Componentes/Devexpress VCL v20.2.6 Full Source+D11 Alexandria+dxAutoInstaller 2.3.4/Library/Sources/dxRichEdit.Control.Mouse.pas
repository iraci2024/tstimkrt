...
uses
  Types, Classes, Controls, SysUtils, Generics.Defaults, Generics.Collections,
  ActiveX,
...
type
  ...
  IdxEndDocumentUpdateHandler = interface
    ...
    procedure HandleEndDocumentUpdate(const Args
  ...
  public
    constructor Create(const AValueProvider
    ...
    property ValueProvider: TdxRichEditMouseCustomVisualFeedbackState
      read FValueProvider;
  end;
  ...
  private
    ...
    function GetHighDetailLevelBox(AHitTestResult
      : TdxRichEditHitTestResult): TdxBox;
    function GetInnerControl: IdxInnerControl;
  protected
    function CalculateActiveObject(AHitTestResult: TdxRichEditHitTestResult)
      : TObject; virtual;
    function CalculateActiveObjectCore(ARunIndex: Integer): TObject; virtual;
    function CalculateHitTest(const P: TPoint)
      : TdxRichEditHitTestResult; virtual;

    procedure HandleMouseMoveCore(const Args: TdxMouseEventArgs;
      const P: TPoint; AHitTestResult: TdxRichEditHitTestResult); virtual;
    ...
    function GetTopLevelPage(AInitialHitTestResult
      : TdxRichEditHitTestResult): TdxPage;
  ...
  protected
    function GetVisualFeedbackValue: TdxRectangleVisualFeedbackValue;
      virtual; abstract;
  public
    property VisualFeedbackValue: TdxRectangleVisualFeedbackValue
      read GetVisualFeedbackValue;
  end;
  ...
  TdxRichEditMouseHandlerStateStrategyBase = class abstract
    (TdxRichEditMouseHandlerStrategyBase)
  strict private
  ...
  TdxRichEditMouseHandlerStrategy = class abstract
    (TdxRichEditMouseHandlerStrategyBase)
  protected
    function CreateFakeMouseMoveEventArgs: TdxMouseEventArgs; virtual; abstract;
    function ConvertMouseEventArgs(var Args: TdxMouseEventArgs)
      : TdxMouseEventArgs; virtual; abstract;
    function ConvertDragEventArgs(var AScreenDragEventArgs: TdxDragEventArgs)
      : TdxDragEventArgs; virtual; abstract;
  ...
  public
    ...
    function CanDropContentTo(AHitTestResult: TdxRichEditHitTestResult;
      APieceTable: TdxPieceTable): Boolean;
    function UpdateDocumentModelPosition(const APos: TdxDocumentModelPosition)
  ...
  public
    class function Create
      : TdxDragFloatingObjectMouseHandlerStateCalculator; static;
  ...
  protected
    ...
    function TryFindPageArea(AHitTestResult: TdxRichEditHitTestResult;
    ...
    function CreateInternalDragState: TdxRichEditMouseCustomState; virtual;
    function ConvertMouseEventArgs(const Args: TdxMouseEventArgs)
      : TdxMouseEventArgs; virtual;
    ...
    function GetMouseEventArgs(Buttons: TdxMouseButtons; Shift: TShiftState;
      const AMousePos: TPoint; AWheelDelta: Integer)
      : TdxMouseEventArgs; overload;
    function GetMouseEventArgs(Button: TMouseButton; Shift: TShiftState;
      X, Y: Integer): TdxMouseEventArgs; overload;
    function GetMouseEventArgs(Shift: TShiftState; X, Y: Integer)
      : TdxMouseEventArgs; overload;

    function GetDoubleClickSize: TSize;
    function GetDoubleClickTime: Integer;

    function CreateZoomCommand(const Args: TdxMouseEventArgs)
      : TdxCommand; virtual;
  ...
  public
    constructor Create(const ARichControl: IdxRichEditControl);
      reintroduce; virtual;
    destructor Destroy; override;

    procedure AfterConstruction; override;
    procedure ChangeActivePieceTable(APieceTable: TdxPieceTable;
      AHitTestResult: TdxRichEditHitTestResult = nil); override;
    function CreateDragFloatingObjectMouseHandlerStateCalculator
      : TdxDragFloatingObjectMouseHandlerStateCalculator;
    function CreateDragContentMouseHandlerStateCalculator
      : TdxDragContentMouseHandlerStateCalculator;

    function CreateFakeMouseMoveEventArgs: TdxMouseEventArgs;

    // for internal use
    function CreateRectangularObjectResizeState(const AHotZone: IdxHotZone;
      AResult: TdxRichEditHitTestResult): IdxCustomMouseState; override;
    function CreateRectangularObjectRotateState(const AHotZone: IdxHotZone;
      AResult: TdxRichEditHitTestResult): IdxCustomMouseState; override;
    procedure SwitchStateCore(const ANewState: IdxCustomMouseState;
  ...
  private
    FControl: IdxRichEditControl;
  protected
    function TryProcessHyperlinkClick(AHitTestResult
...
uses
  Windows, Math, RTLConsts, cxGeometry, cxControls, dxTypeHelpers,
  cxLibraryConsts,
...
type
  ...
  public
    class function GetBox(AHitTestResult: TdxRichEditHitTestResult;
      AKind: TdxBoxAccessorKind): TdxBox; static;
  end;
  ...
  private
    ...
    procedure BeginCharacterSelectionCore(AHitTestResult
      : TdxRichEditHitTestResult);
    procedure BeginDragExistingSelection(AHitTestResult
      : TdxRichEditHitTestResult; AResetSelectionOnMouseUp: Boolean);
    ...
    procedure BeginParagraphsSelection(AHitTestResult
      : TdxRichEditHitTestResult);
    procedure BeginTableRowsSelectionState(AHitTestResult
      : TdxRichEditHitTestResult);
    procedure BeginWordsSelection(AHitTestResult: TdxRichEditHitTestResult);
    function CalculateExactPageAreaHitTest(const P: TPoint)
      : TdxRichEditHitTestResult;
    procedure ClearMultiSelection;
    procedure DeactivateFloatingObject(AHitTestResult
      : TdxRichEditHitTestResult);
    procedure ExtendSelectionToCursor(AHitTestResult: TdxRichEditHitTestResult);
    procedure ExtendMultiSelection(AIterator: TdxPieceTableIterator;
      const ACurrentModelPosition: TdxDocumentModelPosition);
    procedure PerformEnhancedSelection(AHitTestResult
      : TdxRichEditHitTestResult);
    procedure SelectFloatingObject(AHitTestResult: TdxRichEditHitTestResult;
      AAllowDrag: Boolean; AAllowActivate: Boolean = True);
    ...
    function ShouldBeginDragExistingSelection(AHitTestResult
      : TdxRichEditHitTestResult): Boolean;
    function ShouldDeactivateFloatingObject(AHitTestResult
      : TdxRichEditHitTestResult): Boolean;
    function ShouldSelectFloatingObject(AHitTestResult
      : TdxRichEditHitTestResult): Boolean;
    function ShouldSelectPicture(AHitTestResult
      : TdxRichEditHitTestResult): Boolean;
    function ShouldStartMultiSelection: Boolean;
    function ShouldSwitchActivePieceTable(AHitTestResult
      : TdxRichEditHitTestResult): Boolean;
    function ShouldExtendSelectionToCursor: Boolean;
    function TryProcessHyperlinkClick(AHitTestResult
      : TdxRichEditHitTestResult): Boolean;
    procedure ValidateFieldSelection(ADocumentModel: TdxDocumentModel;
      ASelection: TdxSelection);
  protected
    procedure HandleMouseMoveCore(const Args: TdxMouseEventArgs;
      const P: TPoint; AHitTestResult: TdxRichEditHitTestResult); override;
    ...
    function CreateDragState(const ADataObject: IDataObject)
      : TdxRichEditMouseCustomState;
    function CreateDragContentState(AHitTestResult: TdxRichEditHitTestResult)
      : TdxRichEditMouseCustomState;
    ...
    procedure SwitchStateToDragState(AHitTestResult: TdxRichEditHitTestResult;
      ADragState: TdxRichEditMouseCustomState);

    function HandleHotZoneMouseDown(AHitTestResult
      : TdxRichEditHitTestResult): Boolean;
    function HandleHotZoneMouseDownCore(AHitTestResult
      : TdxRichEditHitTestResult; AHotZone: TdxHotZone): Boolean;
  public
    procedure HandleMouseDown(const P: TPoint); reintroduce; overload;
    procedure HandleMouseDown(const AHitTestResult: TdxRichEditHitTestResult);
      reintroduce; overload;
    procedure HandleMouseDown(const Args: TdxMouseEventArgs); overload;
      override;
    ...
    procedure BeginResizeTableRowState(AHitTestResult: TdxRichEditHitTestResult;
      ATableRow: TdxTableRowViewInfoBase);
    procedure BeginResizeTableCellsHorizontallyState(AHitTestResult
      : TdxRichEditHitTestResult; AColumn: TdxVirtualTableColumn);
    procedure BeginTableColumnsSelectionState(AHitTestResult
      : TdxRichEditHitTestResult);
    procedure BeginTableCellsSelectionState(AHitTestResult
      : TdxRichEditHitTestResult);

    function CreatePlaceCaretToPhysicalPointCommand(AShift: Boolean)
      : TdxPlaceCaretToPhysicalPointCommand;

    function HandlePopupMenu(const Args: TdxMouseEventArgs): Boolean; override;
    function IsFloatingObjectSelected(AFloatingObjectBox
      : TdxFloatingObjectBox): Boolean;
    function IsMouseDownInSelection(ALogPosition
      : TdxDocumentLogPosition): Boolean;
  protected
    function ShouldActivateFloatingObjectTextBox(AFloatingObjectBox
      : TdxFloatingObjectBox; ARun: TdxFloatingObjectAnchorRun;
      const ALogicalPoint: TPoint): Boolean;
    function ActivateFloatingObjectTextBox(ARun: TdxFloatingObjectAnchorRun;
  ...
  TdxContinueSelectionByRangesMouseHandlerState = class abstract
    (TdxRichEditMouseCustomState, IdxEndDocumentUpdateHandler)
  private
    ...
    procedure EndDocumentUpdateHandler(ASender: TObject;
  ...
  protected
    ...
    function CreateExtendSelectionCommand
      : TdxExtendSelectionByRangesCommandBase; virtual; abstract;
    function GetCurrentCell(const P: TPoint): TdxTableCell;
    function GetHitTestResult(const APhysicalPoint: TPoint)
      : TdxRichEditHitTestResult;
    function GetParagraph(const P: TPoint): TdxParagraph;
    function NeedSwitchStateToTableCellsMouseHandlerState
      (const P: TPoint): Boolean;
    function NeedSwitchStateToTableCellsMouseHandlerStateCore(ACurrentParagraph
      : TdxParagraph): Boolean;
    ...
    property InitialHitTestResult: TdxRichEditHitTestResult
      read GetInitialHitTestResult;
  ...
  TdxContinueSelectionByCharactersMouseHandlerState = class
    (TdxContinueSelectionByRangesMouseHandlerState)
  protected
    function CreateExtendSelectionCommand
      : TdxExtendSelectionByRangesCommandBase; override;
  public
    procedure ContinueSelection(const Args: TdxMouseEventArgs); override;
  end;
  ...
  TdxContinueSelectionByTableRowsMouseHandlerStateBase = class abstract
    (TdxContinueSelectionByRangesMouseHandlerState)
  strict private
  ...
  TdxContinueSelectionByStartTableRowsMouseHandlerState = class
    (TdxContinueSelectionByTableRowsMouseHandlerStateBase)
  strict private
  ...
  TdxContinueSelectionByTableRowsAfterCharactersMouseHandlerState = class
    (TdxContinueSelectionByTableRowsMouseHandlerStateBase)
  protected
    procedure SwitchState(const AMousePosition: TPoint); override;
  end;
  ...
  TdxContinueSelectionByTableRowsAfterRowMouseHandlerState = class
    (TdxContinueSelectionByTableRowsMouseHandlerStateBase)
  protected
    procedure SwitchState(const AMousePosition: TPoint); override;
  end;
  ...
  TdxContinueSelectionByTableColumnsMouseHandlerState = class
    (TdxContinueSelectionByRangesMouseHandlerState)
  strict private
  ...
  TdxContinueSelectionByWordsAndParagraphsMouseHandlerStateBase = class abstract
    (TdxContinueSelectionByRangesMouseHandlerState)
  protected
    function GetNewMouseHandlerState(AController: TdxRichEditMouseController;
      AInitialBoxAccessor: TdxBoxAccessorKind;
      AInitialHitTestResult: TdxRichEditHitTestResult; ANestingLevel: Integer)
      : TdxContinueSelectionByTableRowsMouseHandlerStateBase; virtual; abstract;
  public
    procedure ContinueSelection(const Args: TdxMouseEventArgs); override;
  end;
  ...
  TdxContinueSelectionByTableCellsMouseHandlerStateBase = class abstract
    (TdxContinueSelectionByRangesMouseHandlerState)
  protected
    function CreateExtendSelectionCommand
      : TdxExtendSelectionByRangesCommandBase; override;
  ...
  TdxContinueSelectionByStartTableCellsMouseHandlerState = class
    (TdxContinueSelectionByTableCellsMouseHandlerStateBase)
  protected
    function CalculateCursor(const E: TdxMouseEventArgs): TCursor; override;
  ...
  TdxContinueSelectionByTableCellsMouseHandlerState = class
    (TdxContinueSelectionByTableCellsMouseHandlerStateBase)
  protected
  ...
  TdxContinueSelectionByTableRowsAfterWordsMouseHandlerState = class
    (TdxContinueSelectionByTableRowsMouseHandlerStateBase)
  protected
    function CalculateCursor(const E: TdxMouseEventArgs): TCursor; override;
    procedure SwitchState(const AMousePosition: TPoint); override;
  ...
  TdxContinueSelectionByWordsMouseHandlerState = class
    (TdxContinueSelectionByWordsAndParagraphsMouseHandlerStateBase)
  protected
    function CreateExtendSelectionCommand
      : TdxExtendSelectionByRangesCommandBase; override;
    function GetNewMouseHandlerState(AController: TdxRichEditMouseController;
      AInitialBoxAccessor: TdxBoxAccessorKind;
      AInitialHitTestResult: TdxRichEditHitTestResult; ANestingLevel: Integer)
      : TdxContinueSelectionByTableRowsMouseHandlerStateBase; override;
  end;

  { TdxContinueSelectionByParagraphsMouseHandlerState }

  TdxContinueSelectionByParagraphsMouseHandlerState = class
    (TdxContinueSelectionByWordsAndParagraphsMouseHandlerStateBase)
  protected
    function CreateExtendSelectionCommand
      : TdxExtendSelectionByRangesCommandBase; override;
  ...
  TdxContinueSelectionByLinesMouseHandlerState = class
    (TdxContinueSelectionByRangesMouseHandlerState)
  protected
  ...
  TdxContinueSelectionByTableRowsAfterParagraphsMouseHandlerState = class
    (TdxContinueSelectionByTableRowsMouseHandlerStateBase)
  protected
    procedure SwitchState(const AMousePosition: TPoint); override;
  end;
...
constructor TdxVisualFeedback<T>.Create(const AValueProvider
  : TdxRichEditMouseCustomVisualFeedbackState);
begin
  inherited Create;
...
constructor TdxRectangleVisualFeedbackValue.Create(APageViewInfo
  : TdxPageViewInfo; const ABounds: TRect);
begin
  inherited Create;
...
constructor TdxRichEditMouseCustomState.Create(AController
  : TdxRichEditMouseController);
begin
  inherited Create;
...
procedure TdxRichEditMouseCustomState.HandleMouseDown
  (const Args: TdxMouseEventArgs);
begin
end;

procedure TdxRichEditMouseCustomState.HandleMouseDoubleClick
  (const Args: TdxMouseEventArgs);
begin
end;

procedure TdxRichEditMouseCustomState.HandleMouseTripleClick
  (const Args: TdxMouseEventArgs);
begin
end;

procedure TdxRichEditMouseCustomState.HandleMouseMove
  (const Args: TdxMouseEventArgs);
var
  P: TPoint;
...
procedure TdxRichEditMouseCustomState.HandleMouseUp
  (const Args: TdxMouseEventArgs);
begin
end;

procedure TdxRichEditMouseCustomState.HandleMouseWheel
  (const Args: TdxMouseEventArgs);
begin
end;
...
function TdxRichEditMouseCustomState.CalculateActiveObject(AHitTestResult
  : TdxRichEditHitTestResult): TObject;
begin
  Result := nil;
  if (AHitTestResult <> nil) and
    (AHitTestResult.DetailsLevel >= TdxDocumentLayoutDetailsLevel.Box) and
    ((AHitTestResult.Accuracy and ExactBox) <> 0) then
  begin
    Result := CalculateActiveObjectCore(GetHighDetailLevelBox(AHitTestResult)
      .StartPos.RunIndex);
  end;
end;

function TdxRichEditMouseCustomState.CalculateActiveObjectCore
  (ARunIndex: Integer): TObject;
begin
  Result := ActivePieceTable.FindFieldByRunIndex(ARunIndex);
end;

function TdxRichEditMouseCustomState.CalculateHitTest(const P: TPoint)
  : TdxRichEditHitTestResult;
begin
...
procedure TdxRichEditMouseCustomState.HandleMouseMoveCore
  (const Args: TdxMouseEventArgs; const P: TPoint;
  AHitTestResult: TdxRichEditHitTestResult);
begin
  if UseHover then
...
function TdxRichEditMouseCustomState.GetTopLevelPage(AInitialHitTestResult
  : TdxRichEditHitTestResult): TdxPage;
begin
  if (AInitialHitTestResult.FloatingObjectBox <> nil) and
    (AInitialHitTestResult.FloatingObjectBoxPage <> nil) then
    Result := AInitialHitTestResult.FloatingObjectBoxPage
  else
    Result := AInitialHitTestResult.Page;
end;

function TdxRichEditMouseCustomState.CanHandleMouseUp
  (const Args: TdxMouseEventArgs): Boolean;
begin
  Result := Args.Buttons = [mbLeft];
end;

procedure TdxRichEditMouseCustomState.ContinueSelection
  (const Args: TdxMouseEventArgs);
begin
end;

function TdxRichEditMouseCustomState.
  SuppressDefaultMouseWheelProcessing: Boolean;
begin
  Result := False;
end;
...
procedure TdxRichEditMouseCustomState.QueryContinueDrag
  (Args: PdxQueryContinueDragEventArgs);
begin
end;

procedure TdxRichEditMouseCustomState.UpdateHover(AHitTestResult
  : TdxRichEditHitTestResult);
begin
  Assert(False, 'not implemented');
end;

procedure TdxRichEditMouseCustomState.UpdateHoverLayout(AHitTestResult
  : TdxRichEditHitTestResult; AActiveView: TdxRichEditView;
  ABoxChanged: Boolean);
begin
  Assert(False, 'not implemented');
end;
...
function TdxRichEditMouseCustomState.GetHighDetailLevelBox(AHitTestResult
  : TdxRichEditHitTestResult): TdxBox;
begin
...
constructor TdxRichEditMouseHandlerStrategyBase.Create
...
constructor TdxRichEditMouseHandlerStateStrategyBase.Create
  (AState: TdxRichEditMouseCustomState);
begin
...
constructor TdxDragContentMouseHandlerStateCalculator.Create(const AControl
  : IdxRichEditControl);
begin
  FControl := AControl;
end;

function TdxDragContentMouseHandlerStateCalculator.CanDropContentTo
  (AHitTestResult: TdxRichEditHitTestResult;
  APieceTable: TdxPieceTable): Boolean;
var
...
begin
  ...
  if not APieceTable.ContentType.IsTextBox or
    (AHitTestResult.FloatingObjectBox = nil) then
    Exit(False);

  ARun := Safe<TdxFloatingObjectAnchorRun>.Cast
    (AHitTestResult.FloatingObjectBox.GetRun
    (AHitTestResult.FloatingObjectBox.PieceTable));
  if ARun = nil then
    Exit(False);
...
function TdxDragContentMouseHandlerStateCalculator.UpdateDocumentModelPosition
...
function TdxDragFloatingObjectMouseHandlerStateCalculator.CanDropTo
  (APoint: TdxRichEditHitTestResult): Boolean;
begin
  Result := True;
end;

class function TdxDragFloatingObjectMouseHandlerStateCalculator.Create
  : TdxDragFloatingObjectMouseHandlerStateCalculator;
begin
  Result := Default (TdxDragFloatingObjectMouseHandlerStateCalculator);
end;

procedure TdxDragFloatingObjectMouseHandlerStateCalculator.Init
  (AAnchor: TdxFloatingObjectAnchorRun; const AOffset: TPoint);
begin
  FAnchor := AAnchor;
...
constructor TdxRichEditMouseController.Create(const ARichControl
  : IdxRichEditControl);
begin
  inherited Create;
  FCreating := True;
...
function TdxRichEditMouseController.CreateDragContentMouseHandlerStateCalculator
  : TdxDragContentMouseHandlerStateCalculator;
begin
  Result := TdxDragContentMouseHandlerStateCalculator.Create(Control);
end;

function TdxRichEditMouseController.CreateInternalDragState
  : TdxRichEditMouseCustomState;
begin
...
begin
  ...
  ADelta := TdxZoomCommandBase.DefaultZoomFactorDelta *
    (Abs(Args.WheelDelta) / AMouseWheelScrollDelta);
  AZoomCommand.Delta := Round(ADelta * 100) / 100;
  Result := AZoomCommand;
end;

function TdxRichEditMouseController.
  CreateDragFloatingObjectMouseHandlerStateCalculator
  : TdxDragFloatingObjectMouseHandlerStateCalculator;
begin
...
function TdxRichEditMouseController.CreateFakeMouseMoveEventArgs
  : TdxMouseEventArgs;
var
  P: TPoint;
begin
...
function TdxRichEditMouseController.GetDefaultStateClass
  : TdxRichEditMouseCustomStateClass;
begin
...
function TdxRichEditMouseController.CreateRectangularObjectResizeState
  (const AHotZone: IdxHotZone; AResult: TdxRichEditHitTestResult)
  : IdxCustomMouseState;
begin
  Result := TdxRichEditRectangularObjectResizeMouseHandlerState.Create(Self,
    TdxRectangularObjectHotZone(AHotZone), AResult);
end;

function TdxRichEditMouseController.CreateRectangularObjectRotateState
  (const AHotZone: IdxHotZone; AResult: TdxRichEditHitTestResult)
  : IdxCustomMouseState;
begin
  Result := TdxRichEditRectangularObjectRotateMouseHandlerState.Create(Self,
    TdxRectangularObjectHotZone(AHotZone), AResult);
end;

procedure TdxRichEditMouseController.SwitchStateCore(const ANewState
  : IdxCustomMouseState; const AMousePosition: TPoint);
var
...
procedure TdxRichEditMouseController.CalculateAndSaveHitInfo
  (const Args: TdxMouseEventArgs);
begin
end;
...
function TdxRichEditMouseController.ConvertMouseEventArgs
  (const Args: TdxMouseEventArgs): TdxMouseEventArgs;
var
  APoint: TPoint;
begin
...
procedure TdxRichEditMouseController.ConvertMouseDragEventArgs
  (var Args: TdxDragEventArgs);
var
...
function TdxRichEditMouseController.GetMouseEventArgs(Buttons: TdxMouseButtons;
  Shift: TShiftState; const AMousePos: TPoint; AWheelDelta: Integer)
  : TdxMouseEventArgs;
begin
...
function TdxRichEditMouseController.GetMouseEventArgs(Shift: TShiftState;
  X, Y: Integer): TdxMouseEventArgs;
begin
  Result := GetMouseEventArgs(GetButtonsFromShiftState(Shift), Shift,
    Point(X, Y), 0);
end;
...
begin
  ...
  Result.X := DocumentModel.LayoutUnitConverter.PixelsToLayoutUnits(P.X,
    DocumentModel.DpiX) - R.Left;
  Result.Y := DocumentModel.LayoutUnitConverter.PixelsToLayoutUnits(P.Y,
    DocumentModel.DpiY) - R.Top;
end;

function TdxRichEditMouseController.IsDoubleClick
  (const Args: TdxMouseEventArgs): Boolean;
begin
  Result := IsMultipleClickCore(Args) and (ClickCount = 2);
end;

function TdxRichEditMouseController.TryFindPageArea(AHitTestResult
  : TdxRichEditHitTestResult; APieceTable: TdxPieceTable): TdxPageArea;
begin
...
function TdxRichEditMouseController.IsMultipleClickCore
  (const Args: TdxMouseEventArgs): Boolean;
begin
...
function TdxRichEditMouseController.IsTripleClick
  (const Args: TdxMouseEventArgs): Boolean;
begin
  Result := IsMultipleClickCore(Args) and SupportsTripleClick and
    (ClickCount = 3);
end;
...
function TdxRichEditMouseController.CalculateMouseWheelScrollRate
  (AWheelDelta: Integer): Single;
begin
  Result := Mouse.WheelScrollLines * Abs(AWheelDelta) / WHEEL_DELTA / 3.0;
end;

procedure TdxRichEditMouseController.ChangeActivePieceTable
  (APieceTable: TdxPieceTable; AHitTestResult: TdxRichEditHitTestResult = nil);
var
  AArea: TdxPageArea;
  ASection: TdxSection;
...
begin
  ...
  else if APieceTable.IsTextBox and (AHitTestResult.PageArea <> nil) then
    ASection := AHitTestResult.PageArea.Section;
  ACommand := TdxChangeActivePieceTableCommand.Create(Control, APieceTable,
    ASection, 0);
  try
...
procedure TdxRichEditMouseController.PerformWheelScroll
  (const Args: TdxMouseEventArgs);
begin
...
procedure TdxRichEditMouseController.PerformWheelZoom
  (const Args: TdxMouseEventArgs);
var
  ACommand: TdxCommand;
begin
...
procedure TdxRichEditMouseController.SmallScrollVerticallyCore
  (AScrollRate: Single);
var
...
begin
  ...
  ALogicalVisibleHeight := Round(AGenerator.ViewPortBounds.Height /
    AGenerator.ScaleFactor);

  ACommand := TdxScrollVerticallyByLogicalOffsetCommand.Create(Control);
  try
    ALogicalOffsetInModelUnits :=
      Trunc(Max(1, Control.InnerControl.DocumentModel.UnitConverter.
      DocumentsToModelUnits(150) * Abs(AScrollRate)));
    ACommand.LogicalOffset := Sign(AScrollRate) * Min(ALogicalVisibleHeight,
      Control.InnerControl.DocumentModel.ToDocumentLayoutUnitConverter.
      ToLayoutUnits(ALogicalOffsetInModelUnits));
    ACommand.Execute;
  finally
    ACommand.Free;
  end;
...
procedure TdxRichEditMouseController.SmallScrollHorizontallyCore
  (AScrollRate: Single);
var
  AGenerator: TdxPageViewInfoGenerator;
...
begin
  AGenerator := Control.InnerControl.ActiveView.PageViewInfoGenerator;
  AVisibleWidth := Round(AGenerator.ViewPortBounds.Width /
    AGenerator.ScaleFactor);

  ACommand := TdxScrollHorizontallyByPhysicalOffsetCommand.Create(Control);
  try
    APhysicalOffsetInModelUnits :=
      Trunc(Max(1, Control.InnerControl.DocumentModel.UnitConverter.
      DocumentsToModelUnits(150) * Abs(AScrollRate)));
    ACommand.PhysicalOffset := Sign(AScrollRate) *
      Min(AVisibleWidth, Control.InnerControl.DocumentModel.
      ToDocumentLayoutUnitConverter.ToLayoutUnits(APhysicalOffsetInModelUnits));
    ACommand.Execute;
  finally
    ACommand.Free;
  end;
...
procedure TdxRichEditMouseController.HandleMouseDoubleClick
  (const Args: TdxMouseEventArgs);
begin
  SaveHitInfo(Args);
  try
...
procedure TdxRichEditMouseController.HandleMouseDown
  (const Args: TdxMouseEventArgs);
begin
  SaveHitInfo(Args);
  try
...
procedure TdxRichEditMouseController.HandleMouseTripleClick
  (const Args: TdxMouseEventArgs);
begin
  SaveHitInfo(Args);
  try
...
procedure TdxRichEditMouseController.HandleMouseMove
  (const Args: TdxMouseEventArgs);
var
  P: TPoint;
begin
...
procedure TdxRichEditMouseController.HandleMouseUp
  (const Args: TdxMouseEventArgs);
begin
...
procedure TdxRichEditMouseController.HandleMouseWheel
  (const Args: TdxMouseEventArgs);
var
  ...
  begin
    ...
    begin
      if State is TdxBeginMouseDragHelperState then
        ...
        ADragState := nil;
      ASuppressWheelScroll := (ADragState <> nil) and
        (ADragState.DragState is TdxDragContentStandardMouseHandlerState);
...
begin
  ...
  else if IsDoubleClick(Args) then
  begin
    StopClickTimer;
...
procedure TdxRichEditMouseController.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
...
begin
  Result := True;
  HandleMouseWheel(ConvertMouseEventArgs
    (GetMouseEventArgs(GetButtonsFromShiftState(Shift), Shift, MousePos,
    WheelDelta)));
end;
...
function TdxRichEditMouseController.DoContextPopup
  (var Args: TdxMouseEventArgs): Boolean;
begin
...
procedure TdxRichEditMouseController.GiveFeedback
  (Args: PdxGiveFeedbackEventArgs);
begin
  State.GiveFeedback(Args);
end;

procedure TdxRichEditMouseController.QueryContinueDrag
  (Args: PdxQueryContinueDragEventArgs);
begin
...
function TdxRichEditMouseController.GetButtonsFromShiftState(Shift: TShiftState)
  : TdxMouseButtons;
begin
  Result := [];
...
begin
  ...
  try
    ...
    begin
      AHitTestResult := Controller.ActiveView.CalculateNearestPageHitTest
        (P, False);
      if AHitTestResult <> nil then
      begin
        ...
        begin
          ...
          else if ShouldDeactivateFloatingObject(AHitTestResult) then
...
procedure TdxRichEditMouseDefaultState.HandleMouseDown(const AHitTestResult
  : TdxRichEditHitTestResult);
var
...
begin
  ...
  try
    ...
    if ASelectionManager.ShouldResizeTableRow(Control, AHitTestResult, ATableRow)
    then
    begin
    ...
    AVirtualColumn := ASelectionManager.CalculateTableCellsToResizeHorizontally
      (AHitTestResult);
    if ASelectionManager.ShouldResizeTableCellsHorizontally(Control,
      AHitTestResult, AVirtualColumn) then
    begin
    ...
    else if ShouldExtendSelectionToCursor then
    begin
      if TryProcessHyperlinkClick(AHitTestResult) then
        Exit;
      ExtendSelectionToCursor(AHitTestResult);
    end
    else if ShouldSelectPicture(AHitTestResult) then
    begin
      if TryProcessHyperlinkClick(AHitTestResult) then
        Exit;
...
procedure TdxRichEditMouseDefaultState.HandleMouseDoubleClick
  (const Args: TdxMouseEventArgs);
var
...
begin
  ...
  try
    if (AHitTestResult <> nil) and ShouldSwitchActivePieceTable(AHitTestResult)
    then
    begin
      ACommand := TdxChangeActivePieceTableCommand.Create(Control,
        TdxPieceTable(AHitTestResult.PageArea.PieceTable),
...
procedure TdxRichEditMouseDefaultState.HandleMouseTripleClick
  (const Args: TdxMouseEventArgs);
var
  P: TPoint;
  AHitTestResult: TdxRichEditHitTestResult;
...
procedure TdxRichEditMouseDefaultState.HandleMouseMoveCore
  (const Args: TdxMouseEventArgs; const P: TPoint;
  AHitTestResult: TdxRichEditHitTestResult);
var
...
function TdxRichEditMouseDefaultState.IsExternalDrag(const ADataObject
  : IDataObject): Boolean;
begin
...
begin
  Result := (Controller.ActiveObject is TdxField) and
    DocumentModel.ActivePieceTable.IsHyperlinkField
    (TdxField(Controller.ActiveObject));
end;

function TdxRichEditMouseDefaultState.ActivateFloatingObjectTextBox
  (ARun: TdxFloatingObjectAnchorRun;
  AHitTestResult: TdxRichEditHitTestResult): Boolean;
var
  APhysicalPoint: TPoint;
...
begin
  ...
  begin
    Control.BeginUpdate;
    try
      Controller.ChangeActivePieceTable
        (TdxPieceTable(ATextBoxContent.TextBox.PieceTable), AHitTestResult);
      ClearMultiSelection;
...
procedure TdxRichEditMouseDefaultState.BeginCharacterSelection
  (AHitTestResult: TdxRichEditHitTestResult);
begin
...
begin
  ADragState := TdxContinueSelectionByCharactersMouseHandlerState.Create
    (Controller, TdxBoxAccessorKind.Character, AHitTestResult);
  ANewState := TdxBeginMouseDragHyperlinkClickHandleHelperState.Create
    (Controller, ADragState, AHitTestResult.PhysicalPoint);
  LockRelease;
  try
...
begin
  if Controller.DeactivateTextBoxPieceTableIfNeed(AHitTestResult.PieceTable,
    AHitTestResult) then
  begin
  ...
  if not Control.UseStandardDragDropMode and
    (not Control.InnerControl.Options.Behavior.DragAllowed or
    not Control.InnerControl.Options.Behavior.DropAllowed) then
    Exit;
  ADragState := CreateDragContentState(AHitTestResult);
  ANewState := TdxBeginContentDragHelperState.Create(Controller, ADragState,
    AHitTestResult.PhysicalPoint);
  ANewState.ResetSelectionOnMouseUp := AResetSelectionOnMouseUp;
  Controller.SwitchStateCore(ANewState, AHitTestResult.PhysicalPoint);
end;

procedure TdxRichEditMouseDefaultState.BeginLineSelection(AHitTestResult
  : TdxRichEditHitTestResult);
var
...
begin
  ...
  try
    ...
    ACommand.ExecuteCore;
    ClearMultiSelection;
    ADragState := TdxContinueSelectionByLinesMouseHandlerState.Create
      (Controller, TdxBoxAccessorKind.Row, AHitTestResult);
...
procedure TdxRichEditMouseDefaultState.BeginMultiSelection(AHitTestResult
  : TdxRichEditHitTestResult);
begin
  if AHitTestResult.PieceTable <> ActivePieceTable then
    Exit;
...
procedure TdxRichEditMouseDefaultState.BeginParagraphsSelection
  (AHitTestResult: TdxRichEditHitTestResult);
var
  ADragState: TdxRichEditMouseCustomState;
...
begin
  ADragState := TdxContinueSelectionByParagraphsMouseHandlerState.Create
    (Controller, TdxBoxAccessorKind.Character, AHitTestResult);
  ANewState := TdxRichEditBeginMouseDragHelperState.Create(Controller,
    ADragState, AHitTestResult.PhysicalPoint);
  Controller.SwitchStateCore(ANewState, AHitTestResult.PhysicalPoint);
...
procedure TdxRichEditMouseDefaultState.BeginTableRowsSelectionState
  (AHitTestResult: TdxRichEditHitTestResult);
var
...
begin
  ...
  try
    ...
    ARestartCell := ARow.Table.GetFirstCellInVerticalMergingGroup
      (ARow.FirstCell);
  ...
  ADragState := TdxContinueSelectionByStartTableRowsMouseHandlerState.Create
    (Controller, TdxBoxAccessorKind.Row, AHitTestResult);
  ADragState.StartRowIndex := ARowIndex;
  SwitchStateToDragState(AHitTestResult, ADragState);
end;

procedure TdxRichEditMouseDefaultState.BeginWordsSelection(AHitTestResult
  : TdxRichEditHitTestResult);
var
  ADragState: TdxRichEditMouseCustomState;
  ANewState: TdxBeginMouseDragHelperState;
...
begin
  ADragState := TdxContinueSelectionByWordsMouseHandlerState.Create(Controller,
    TdxBoxAccessorKind.Character, AHitTestResult);
  ANewState := TdxRichEditBeginMouseDragHelperState.Create(Controller,
    ADragState, AHitTestResult.PhysicalPoint);
  Controller.SwitchStateCore(ANewState, AHitTestResult.PhysicalPoint);
  ...
  try
    ...
    begin
      if AHitTestResult.PieceTable <> ActivePieceTable then
        Exit;
      APosition := TdxBoxAccessor.GetBox(AHitTestResult,
        TdxBoxAccessorKind.Character).GetFirstPosition(ActivePieceTable);
...
function TdxRichEditMouseDefaultState.CalculateExactPageAreaHitTest
...
begin
  ...
  ARequest.Accuracy := ExactPage or ExactPageArea or NearestColumn or
...
function TdxRichEditMouseDefaultState.CreateDragContentState(AHitTestResult
  : TdxRichEditHitTestResult): TdxRichEditMouseCustomState;
begin
  if (AHitTestResult.FloatingObjectBox <> nil) and
    not Controller.IsInlinePictureBoxHit(AHitTestResult) then
  begin
    Result := TdxDragFloatingObjectManuallyMouseHandlerState.Create(Controller,
      AHitTestResult);
    Exit;
  end;
...
function TdxRichEditMouseDefaultState.CreateDragState(const ADataObject
  : IDataObject): TdxRichEditMouseCustomState;
begin
...
function TdxRichEditMouseDefaultState.CreateExternalDragState
  : TdxRichEditMouseCustomState;
begin
  Result := TdxDragExternalContentMouseHandlerState.Create(Controller);
end;

function TdxRichEditMouseDefaultState.CreateInternalDragState
  : TdxRichEditMouseCustomState;
begin
  Result := Controller.CreateInternalDragState;
end;

procedure TdxRichEditMouseDefaultState.DeactivateFloatingObject
  (AHitTestResult: TdxRichEditHitTestResult);
var
  ...
  begin
    ...
    try
      ...
      begin
        ...
        Controller.ChangeActivePieceTable
          (TdxPieceTable(ATextBox.AnchorRun.PieceTable), AHitTestResult);
      end
      else
...
procedure TdxRichEditMouseDefaultState.BeginResizeTableRowState
  (AHitTestResult: TdxRichEditHitTestResult;
  ATableRow: TdxTableRowViewInfoBase);
var
  AResizeState: TdxResizeTableRowMouseHandlerState;
begin
  AResizeState := TdxResizeTableRowMouseHandlerState.Create(Controller,
    AHitTestResult, ATableRow);
  SwitchStateToDragState(AHitTestResult, AResizeState);
end;

procedure TdxRichEditMouseDefaultState.BeginResizeTableCellsHorizontallyState
  (AHitTestResult: TdxRichEditHitTestResult; AColumn: TdxVirtualTableColumn);
var
  AResizeState: TdxResizeTableVirtualColumnMouseHandlerState;
begin
  AResizeState := TdxResizeTableVirtualColumnMouseHandlerState.Create
    (Controller, AHitTestResult, AColumn);
  SwitchStateToDragState(AHitTestResult, AResizeState);
end;

procedure TdxRichEditMouseDefaultState.BeginTableColumnsSelectionState
  (AHitTestResult: TdxRichEditHitTestResult);
var
...
begin
  ...
  try
    ...
    AEndColumnIndex := ATableCell.GetEndColumnIndexConsiderRowGrid
      (AStartColumnIndex);
  ...
  ADragState := TdxContinueSelectionByTableColumnsMouseHandlerState.Create
    (Controller, TdxBoxAccessorKind.Box, AHitTestResult);
  ADragState.StartColumnIndex := AStartColumnIndex;
  ADragState.NestedLevel := ATableCell.Table.NestedLevel;
  SwitchStateToDragState(AHitTestResult, ADragState);
end;

procedure TdxRichEditMouseDefaultState.BeginTableCellsSelectionState
  (AHitTestResult: TdxRichEditHitTestResult);
var
...
begin
  ...
  ADragState := TdxContinueSelectionByStartTableCellsMouseHandlerState.Create
    (Controller, TdxBoxAccessorKind.Box, AHitTestResult);
  SwitchStateToDragState(AHitTestResult, ADragState);
end;

function TdxRichEditMouseDefaultState.CreatePlaceCaretToPhysicalPointCommand
  (AShift: Boolean): TdxPlaceCaretToPhysicalPointCommand;
begin
  if AShift then
...
function TdxRichEditMouseDefaultState.HandlePopupMenu
  (const Args: TdxMouseEventArgs): Boolean;
var
  AHitTestResult: TdxRichEditHitTestResult;
  AFloatingObjectBox: TdxFloatingObjectBox;
...
begin
  ...
  try
    ...
    AFloatingObjectBox := AHitTestResult.FloatingObjectBox;
    if ShouldSelectFloatingObject(AHitTestResult) or
      ((AFloatingObjectBox <> nil) and not ActivePieceTable.IsTextBox) then
    begin
    ...
    if AHitTestResult.PieceTable <> ActivePieceTable then
      Exit(False);
    ALogPosition := AHitTestResult.Character.GetFirstPosition(ActivePieceTable)
      .LogPosition;
...
function TdxRichEditMouseDefaultState.IsFloatingObjectSelected
  (AFloatingObjectBox: TdxFloatingObjectBox): Boolean;
var
  ASelection: TdxSelection;
  ARun: TdxFloatingObjectAnchorRun;
  ALogPosition: TdxDocumentLogPosition;
begin
  ...
  if ASelection.PieceTable <> ARun.PieceTable then
    Exit(False);
  ALogPosition := ARun.PieceTable.GetRunLogPosition
    (AFloatingObjectBox.StartPos.RunIndex);
  Result := (ASelection.Start = ALogPosition) and
    (ASelection.&End = (ALogPosition + 1));
end;

function TdxRichEditMouseDefaultState.IsMouseDownInSelection
...
begin
  ...
  begin
    ...
    if (ASelectionItem.NormalizedStart <= ALogPosition) and
      (ALogPosition <= ASelectionItem.NormalizedEnd) then
      Exit(True);
  end;
  Result := False;
end;
...
procedure TdxRichEditMouseDefaultState.ExtendSelectionToCursor
  (AHitTestResult: TdxRichEditHitTestResult);
var
  ACommand: TdxPlaceCaretToPhysicalPointCommand;
begin
...
procedure TdxRichEditMouseDefaultState.ExtendMultiSelection
  (AIterator: TdxPieceTableIterator;
  const ACurrentModelPosition: TdxDocumentModelPosition);
var
...
procedure TdxRichEditMouseDefaultState.PerformEnhancedSelection
  (AHitTestResult: TdxRichEditHitTestResult);
var
  ASelectionManager: TdxEnhancedSelectionManager;
begin
...
procedure TdxRichEditMouseDefaultState.PlaceCaretToPhysicalPoint
...
procedure TdxRichEditMouseDefaultState.SelectFloatingObject(AHitTestResult
  : TdxRichEditHitTestResult; AAllowDrag: Boolean;
  AAllowActivate: Boolean = True);
var
  AFloatingObjectBox: TdxFloatingObjectBox;
  ARun: TdxFloatingObjectAnchorRun;
...
begin
  ...
  if ActivePieceTable <> ARun.PieceTable then
    Controller.ChangeActivePieceTable(TdxPieceTable(ARun.PieceTable),
      AHitTestResult);
  AParagraph := ARun.PieceTable.Runs[AFloatingObjectBox.StartPos.RunIndex]
    .Paragraph;
  ACurrentFrameProperties := AParagraph.GetMergedFrameProperties;
  try
    AIsParagraphFrame := (ACurrentFrameProperties <> nil) and
      ACurrentFrameProperties.IsParagraphFrame;
    ...
    begin
      ...
      begin
        ...
        ANextFrameProperties := AParagraphs[ANextParagraphIndex]
  ...
  if AAllowActivate and ShouldActivateFloatingObjectTextBox(AFloatingObjectBox,
    ARun, AHitTestResult.LogicalPoint) and ActivateFloatingObjectTextBox(ARun,
    AHitTestResult) then
    AAllowDrag := False;
...
procedure TdxRichEditMouseDefaultState.SelectPicture(AHitTestResult
  : TdxRichEditHitTestResult);
var
...
procedure TdxRichEditMouseDefaultState.SetSelection(AStart,
  AEnd: TdxDocumentLogPosition; AClearMultiSelection: Boolean = True);
var
  ASelection: TdxSelection;
begin
  ...
  try
    ...
    DocumentModel.ActivePieceTable.ApplyChangesCore
...
function TdxRichEditMouseDefaultState.ShouldActivateFloatingObjectTextBox
  (AFloatingObjectBox: TdxFloatingObjectBox; ARun: TdxFloatingObjectAnchorRun;
  const ALogicalPoint: TPoint): Boolean;
var
  APoint: TPoint;
begin
...
function TdxRichEditMouseDefaultState.ShouldBeginDragExistingSelection
  (AHitTestResult: TdxRichEditHitTestResult): Boolean;
var
...
begin
  ...
  if (AHitTestResult.FloatingObjectBox <> nil) and
    not ActivePieceTable.ContentType.IsTextBox then
    APos := AHitTestResult.FloatingObjectBox.GetFirstPosition(ActivePieceTable)
  else if AHitTestResult.Character <> nil then
  begin
  ...
  Result := ASelectionLayout.HitTest(APos.LogPosition,
    AHitTestResult.LogicalPoint);
  if Result and (ASelectionLayout is TdxHeaderFooterSelectionLayout) then
    Result := TdxHeaderFooterSelectionLayout(ASelectionLayout)
      .PreferredPageIndex = AHitTestResult.Page.PageIndex;
end;

function TdxRichEditMouseDefaultState.ShouldDeactivateFloatingObject
  (AHitTestResult: TdxRichEditHitTestResult): Boolean;
var
  AFloatingObjectBox: TdxFloatingObjectBox;
begin
  ...
  if not ActivePieceTable.IsTextBox then
    Exit(False);
  AFloatingObjectBox := AHitTestResult.FloatingObjectBox;
  Result := (AFloatingObjectBox = nil) or
    (AFloatingObjectBox.GetFloatingObjectRun.PieceTable <> ActivePieceTable);
end;
...
begin
  ...
  AFloatingObjectBox := AHitTestResult.FloatingObjectBox;
  if (AFloatingObjectBox = nil) or Controller.IsInlinePictureBoxHit
    (AHitTestResult) then
    Exit(False);
  ...
  ASelectionManager := TdxEnhancedSelectionManager.Create(ActivePieceTable);
  try
    Result := ASelectionManager.ShouldSelectFloatingObject(AFloatingObjectBox,
      AHitTestResult.LogicalPoint);
  finally
    ASelectionManager.Free;
  end;
...
function TdxRichEditMouseDefaultState.ShouldSelectPicture(AHitTestResult
  : TdxRichEditHitTestResult): Boolean;
begin
  Result := False;
  if AHitTestResult.PieceTable <> ActivePieceTable then
  ...
  if AHitTestResult.DetailsLevel < TdxDocumentLayoutDetailsLevel.Box then
    Exit;
  if ((AHitTestResult.Accuracy and ExactBox) = 0) and
    ((AHitTestResult.Accuracy and ExactCharacter) = 0) then
    Exit;
...
begin
  Result := TdxKeyboardHelper.IsControlPressed and
    (DocumentModel.Selection.Length > 0);
end;

function TdxRichEditMouseDefaultState.ShouldSwitchActivePieceTable
  (AHitTestResult: TdxRichEditHitTestResult): Boolean;
var
  ARun: TdxFloatingObjectAnchorRun;
  AContent: TdxTextBoxFloatingObjectContent;
begin
  if (AHitTestResult.PageArea <> nil) and
    (ActivePieceTable = AHitTestResult.PageArea.PieceTable) then
    Result := False
  else
  begin
    ...
    begin
      ...
      AContent := Safe<TdxTextBoxFloatingObjectContent>.Cast(ARun.Content);
      Result := (AContent <> nil) and
        (AContent.TextBox.PieceTable <> ActivePieceTable);
    end
    else
      Result := Control.InnerControl.ActiveViewType = TdxRichEditViewType.
        PrintLayout;
  end;
end;
...
var
  ANewState: TdxBeginMouseDragHelperState;
begin
  ANewState := TdxBeginMouseDragHelperState.Create(Controller, ADragState,
    AHitTestResult.PhysicalPoint);
...
function TdxRichEditMouseDefaultState.HandleHotZoneMouseDown(AHitTestResult
  : TdxRichEditHitTestResult): Boolean;
var
  AHotZone: TdxHotZone;
begin
  AHotZone := Controller.ActiveView.SelectionLayout.CalculateHotZone
    (AHitTestResult, Controller.ActiveView);
  Result := HandleHotZoneMouseDownCore(AHitTestResult, AHotZone);
end;

function TdxRichEditMouseDefaultState.HandleHotZoneMouseDownCore
  (AHitTestResult: TdxRichEditHitTestResult; AHotZone: TdxHotZone): Boolean;
begin
  Result := False;
...
function TdxRichEditMouseDefaultState.TryProcessHyperlinkClick
  (AHitTestResult: TdxRichEditHitTestResult): Boolean;
var
...
procedure TdxRichEditMouseDefaultState.ValidateFieldSelection
  (ADocumentModel: TdxDocumentModel; ASelection: TdxSelection);
var
  AValidator: TdxFieldIsSelectValidator;
begin
  AValidator := TdxFieldIsSelectValidator.Create
    (ADocumentModel.ActivePieceTable);
  try
...
class function TdxBoxAccessor.GetBox(AHitTestResult: TdxRichEditHitTestResult;
  AKind: TdxBoxAccessorKind): TdxBox;
begin
  case AKind of
...
procedure TdxContinueSelectionByRangesMouseHandlerState.HandleMouseMove
  (const Args: TdxMouseEventArgs);
begin
...
procedure TdxContinueSelectionByRangesMouseHandlerState.HandleMouseUp
  (const Args: TdxMouseEventArgs);
begin
  Controller.SwitchToDefaultState;
end;

procedure TdxContinueSelectionByRangesMouseHandlerState.HandleMouseWheel
  (const Args: TdxMouseEventArgs);
begin
...
function TdxContinueSelectionByRangesMouseHandlerState.
...
function TdxContinueSelectionByRangesMouseHandlerState.CalculateStartCell
  : TdxTableCell;
var
  ALogPosition: TdxDocumentLogPosition;
begin
...
procedure TdxContinueSelectionByRangesMouseHandlerState.
...
function TdxContinueSelectionByRangesMouseHandlerState.GetInitialHitTestResult
  : TdxRichEditHitTestResult;
var
  APhysicalPoint: TPoint;
begin
...
function TdxContinueSelectionByRangesMouseHandlerState.
  GetStopClickTimerOnStart: Boolean;
begin
  Result := True;
end;

procedure TdxContinueSelectionByRangesMouseHandlerState.ContinueSelection
  (const Args: TdxMouseEventArgs);
var
...
function TdxContinueSelectionByRangesMouseHandlerState.GetCurrentCell
  (const P: TPoint): TdxTableCell;
var
...
function TdxContinueSelectionByRangesMouseHandlerState.GetHitTestResult
  (const APhysicalPoint: TPoint): TdxRichEditHitTestResult;
var
  ARequest: TdxRichEditHitTestRequest;
begin
  ARequest := TdxRichEditHitTestRequest.Create(ActivePieceTable);
...
function TdxContinueSelectionByRangesMouseHandlerState.GetParagraph
  (const P: TPoint): TdxParagraph;
var
  ARequest: TdxRichEditHitTestRequest;
  AHitTestResult: TdxRichEditHitTestResult;
  ALogPosition: TdxDocumentLogPosition;
...
function TdxContinueSelectionByRangesMouseHandlerState.
  NeedSwitchStateToTableCellsMouseHandlerState(const P: TPoint): Boolean;
var
  ACurrentParagraph: TdxParagraph;
begin
  ACurrentParagraph := GetParagraph(P);
  if (StartCell = nil) or (ACurrentParagraph = nil) or
    (ACurrentParagraph.GetCell = nil) then
    Result := False
  else
    Result := NeedSwitchStateToTableCellsMouseHandlerStateCore
      (ACurrentParagraph);
end;

function TdxContinueSelectionByRangesMouseHandlerState.
  NeedSwitchStateToTableCellsMouseHandlerStateCore(ACurrentParagraph
  : TdxParagraph): Boolean;
var
...
begin
  ...
  ActualCurrentCell := ACellManager.GetCellByNestingLevel(ACurrentParagraph.
    Index, StartCell.Table.NestedLevel);
  ACellConsiderNestedLevel := StartCell;
  if ActualCurrentCell.Table.NestedLevel <> StartCell.Table.NestedLevel then
    ACellConsiderNestedLevel := ACellManager.GetCellByNestingLevel
      (StartCell.StartParagraphIndex, ActualCurrentCell.Table.NestedLevel);
  Result := (ACellConsiderNestedLevel <> ActualCurrentCell) and
    (ACellConsiderNestedLevel.Table = ActualCurrentCell.Table);
end;

{ TdxContinueSelectionByCharactersMouseHandlerState }

procedure TdxContinueSelectionByCharactersMouseHandlerState.ContinueSelection
  (const Args: TdxMouseEventArgs);
var
  APhysicalPoint: TPoint;
...
begin
  ...
  begin
    ACellsMouseHandlerState :=
      TdxContinueSelectionByTableCellsMouseHandlerState.Create(Controller,
      InitialBoxAccessor, InitialHitTestResult);
    ACellsMouseHandlerState.StartCell :=
      ActivePieceTable.TableCellsManager.GetCellByNestingLevel
      (StartCell.StartParagraphIndex, ACurrentCell.Table.NestedLevel);
    Controller.SwitchStateCore(ACellsMouseHandlerState, APhysicalPoint);
    Exit;
  end;
  if (((ACurrentCell <> nil) and (StartCell = nil))) or (StartCell <> nil) and
    (ACurrentCell <> nil) and
  ...
  begin
    ...
    try
      ...
      ANewState :=
        TdxContinueSelectionByTableRowsAfterCharactersMouseHandlerState.Create
        (Controller, InitialBoxAccessor, InitialHitTestResult, ANestingLevel);
...
function TdxContinueSelectionByCharactersMouseHandlerState.
  CreateExtendSelectionCommand: TdxExtendSelectionByRangesCommandBase;
begin
...
constructor TdxContinueSelectionByTableRowsMouseHandlerStateBase.Create
  (AController: TdxRichEditMouseController;
  AInitialBoxAccessor: TdxBoxAccessorKind;
  AInitialHitTestResult: TdxRichEditHitTestResult; ANestingLevel: Integer);
begin
...
function TdxContinueSelectionByTableRowsMouseHandlerStateBase.CalculateCursor
  (const E: TdxMouseEventArgs): TCursor;
begin
  Result := TdxRichEditCursors.SelectRow;
end;

function TdxContinueSelectionByTableRowsMouseHandlerStateBase.
  CreateExtendSelectionCommand: TdxExtendSelectionByRangesCommandBase;
var
  ACommand: TdxExtendSelectionByTableRowsCommand;
  AInitialBoxLogPosition: TdxDocumentLogPosition;
begin
  ACommand := TdxExtendSelectionByTableRowsCommand.Create(Control,
    NestingLevel);
  AInitialBoxLogPosition := InitialBox.GetFirstPosition(ActivePieceTable)
    .LogPosition;
  if StartCell = nil then
    ACommand.StartLogPosition := AInitialBoxLogPosition
  else
    ACommand.StartLogPosition := DocumentModel.Selection.SelectedCells.
      OriginalStartLogPosition;
  ACommand.EndLogPosition := DocumentModel.Selection.NormalizedEnd;
  Result := ACommand;
end;

procedure TdxContinueSelectionByTableRowsMouseHandlerStateBase.ContinueSelection
...
function TdxContinueSelectionByTableRowsMouseHandlerStateBase.NeedSwitchState
  (const AMousePosition: TPoint): Boolean;
var
  ACurrentCell: TdxTableCell;
begin
  ACurrentCell := GetCurrentCell(AMousePosition);
  Result := (ACurrentCell = nil) or
    ((StartCell <> nil) and (StartCell.Table = ACurrentCell.Table));
end;
...
function TdxContinueSelectionByStartTableRowsMouseHandlerState.
  CreateExtendSelectionCommand: TdxExtendSelectionByRangesCommandBase;
var
  ACommand: TdxExtendSelectionByStartTableRowsCommand;
begin
  ACommand := TdxExtendSelectionByStartTableRowsCommand.Create(Control,
    NestingLevel);
  ACommand.StartRowIndex := StartRowIndex;
  Result := ACommand;
end;

function TdxContinueSelectionByStartTableRowsMouseHandlerState.NeedSwitchState
  (const AMousePosition: TPoint): Boolean;
var
  ACurrentCell: TdxTableCell;
begin
  ACurrentCell := GetCurrentCell(AMousePosition);
  Result := (ACurrentCell = nil) or
    (((StartCell <> nil) and (ACurrentCell.Table <> StartCell.Table)));
end;

procedure TdxContinueSelectionByStartTableRowsMouseHandlerState.SwitchState
  (const AMousePosition: TPoint);
var
  AByCharactersState: TdxContinueSelectionByCharactersMouseHandlerState;
begin
  AByCharactersState := TdxContinueSelectionByCharactersMouseHandlerState.Create
    (Controller, InitialBoxAccessor, InitialHitTestResult);
  Controller.SwitchStateCore(AByCharactersState, AMousePosition);
end;

{ TdxContinueSelectionByTableRowsAfterCharactersMouseHandlerState }

procedure TdxContinueSelectionByTableRowsAfterCharactersMouseHandlerState.
  SwitchState(const AMousePosition: TPoint);
var
  AByLinesState: TdxContinueSelectionByCharactersMouseHandlerState;
begin
  AByLinesState := TdxContinueSelectionByCharactersMouseHandlerState.Create
    (Controller, InitialBoxAccessor, InitialHitTestResult);
...
procedure TdxContinueSelectionByTableRowsAfterRowMouseHandlerState.SwitchState
  (const AMousePosition: TPoint);
var
  AByLinesState: TdxContinueSelectionByLinesMouseHandlerState;
begin
  AByLinesState := TdxContinueSelectionByLinesMouseHandlerState.Create
    (Controller, InitialBoxAccessor, InitialHitTestResult);
  Controller.SwitchStateCore(AByLinesState, AMousePosition);
end;
...
function TdxContinueSelectionByTableColumnsMouseHandlerState.CalculateCursor
  (const E: TdxMouseEventArgs): TCursor;
begin
  Result := TdxRichEditCursors.SelectTableColumn;
end;

function TdxContinueSelectionByTableColumnsMouseHandlerState.
  CreateExtendSelectionCommand: TdxExtendSelectionByRangesCommandBase;
begin
  Result := TdxExtendSelectionByTableColumnsCommand.Create(Control,
    StartColumnIndex, NestedLevel);
end;

procedure TdxContinueSelectionByTableColumnsMouseHandlerState.ContinueSelection
  (const E: TdxMouseEventArgs);
var
  AMousePosition: TPoint;
  ACurrentCell: TdxTableCell;
...
begin
  ...
  begin
    AByCharacterState := TdxContinueSelectionByCharactersMouseHandlerState.
      Create(Controller, InitialBoxAccessor, InitialHitTestResult);
...
procedure TdxContinueSelectionByWordsAndParagraphsMouseHandlerStateBase.
  ContinueSelection(const Args: TdxMouseEventArgs);
var
  ACell: TdxTableCell;
  APhysicalPoint: TPoint;
  ANewHitTestResult: TdxRichEditHitTestResult;
...
begin
  ...
  if ACell <> nil then
  begin
    if (ACell <> nil) and (StartCell = nil) or (StartCell <> nil) and
      (ACell <> nil) and (StartCell.Table.NestedLevel <> ACell.Table.NestedLevel)
    then
    begin
      ANewHitTestResult := GetHitTestResult(APhysicalPoint);
      try
        ANestingLevel := ANewHitTestResult.TableRow.Row.Table.NestedLevel;
        Controller.SwitchStateCore(GetNewMouseHandlerState(Controller,
    ...
    begin
      Controller.SwitchStateCore
        (TdxContinueSelectionByTableCellsMouseHandlerState.Create(Controller,
        InitialBoxAccessor, InitialHitTestResult), APhysicalPoint);
      Exit;
    end;
  end;
  inherited ContinueSelection(Args);
...
function TdxContinueSelectionByTableCellsMouseHandlerStateBase.
  CreateExtendSelectionCommand: TdxExtendSelectionByRangesCommandBase;
begin
  Result := TdxExtendSelectionByCellsCommand.Create(Control, StartCell);
end;

procedure TdxContinueSelectionByTableCellsMouseHandlerStateBase.
  ContinueSelection(const E: TdxMouseEventArgs);
var
  AMousePosition: TPoint;
...
begin
  ...
  begin
    ChangeSelection;
    ANewState := TdxContinueSelectionByCharactersMouseHandlerState.Create
      (Controller, InitialBoxAccessor, InitialHitTestResult);
...
function TdxContinueSelectionByTableCellsMouseHandlerStateBase.NeedSwitchState
...
begin
  ACurrentCell := GetCurrentCell(APhysicalPoint);
  Result := (ACurrentCell = nil) or
    (StartCell.Table.NestedLevel > ACurrentCell.Table.NestedLevel);
end;
...
function TdxContinueSelectionByStartTableCellsMouseHandlerState.CalculateCursor
  (const E: TdxMouseEventArgs): TCursor;
begin
  Result := TdxRichEditCursors.SelectTableCell;
end;

procedure TdxContinueSelectionByStartTableCellsMouseHandlerState.
  ChangeSelection;
begin
end;
...
function TdxContinueSelectionByTableCellsMouseHandlerState.NeedSwitchState
  (const APhysicalPoint: TPoint): Boolean;
begin
  Result := (inherited NeedSwitchState(APhysicalPoint)) or
    (StartCell = GetCurrentCell(APhysicalPoint));
end;
...
function TdxContinueSelectionByTableRowsAfterWordsMouseHandlerState.
  CalculateCursor(const E: TdxMouseEventArgs): TCursor;
begin
  Result := TdxRichEditCursors.IBeam;
end;

procedure TdxContinueSelectionByTableRowsAfterWordsMouseHandlerState.SwitchState
  (const AMousePosition: TPoint);
var
  AByWordsState: TdxContinueSelectionByWordsMouseHandlerState;
begin
  AByWordsState := TdxContinueSelectionByWordsMouseHandlerState.Create
    (Controller, InitialBoxAccessor, InitialHitTestResult);
...
constructor TdxHyperlinkMouseClickHandler.Create(const AControl
  : IdxRichEditControl);
begin
  inherited Create;
  FControl := AControl;
...
var
  AHitTestResult: TdxRichEditHitTestResult;
begin
  AHitTestResult := Control.InnerControl.ActiveView.CalculateHitTest
    (Args.MousePos, TdxDocumentLayoutDetailsLevel.Box);
  try
    if (AHitTestResult = nil) or not AHitTestResult.IsValid
      (TdxDocumentLayoutDetailsLevel.Box) then
      Exit;
...
function TdxContinueSelectionByWordsMouseHandlerState.
  CreateExtendSelectionCommand: TdxExtendSelectionByRangesCommandBase;
begin
  Result := TdxExtendSelectionByWordsCommand.Create(Control);
end;

function TdxContinueSelectionByWordsMouseHandlerState.GetNewMouseHandlerState
  (AController: TdxRichEditMouseController;
  AInitialBoxAccessor: TdxBoxAccessorKind;
  AInitialHitTestResult: TdxRichEditHitTestResult; ANestingLevel: Integer)
  : TdxContinueSelectionByTableRowsMouseHandlerStateBase;
begin
  Result := TdxContinueSelectionByTableRowsAfterWordsMouseHandlerState.Create
    (Controller, InitialBoxAccessor, InitialHitTestResult, ANestingLevel);
end;

{ TdxContinueSelectionByParagraphsMouseHandlerState }

function TdxContinueSelectionByParagraphsMouseHandlerState.
  CreateExtendSelectionCommand: TdxExtendSelectionByRangesCommandBase;
begin
...
function TdxContinueSelectionByParagraphsMouseHandlerState.
  GetNewMouseHandlerState(AController: TdxRichEditMouseController;
  AInitialBoxAccessor: TdxBoxAccessorKind;
  AInitialHitTestResult: TdxRichEditHitTestResult; ANestingLevel: Integer)
  : TdxContinueSelectionByTableRowsMouseHandlerStateBase;
begin
  Result := TdxContinueSelectionByTableRowsAfterParagraphsMouseHandlerState.
    Create(Controller, InitialBoxAccessor, InitialHitTestResult, ANestingLevel);
end;
...
begin
  ...
  try
    ...
    begin
      ANestingLevel := ANewHitTestResult.TableRow.Row.Table.NestedLevel;
      ANewState := TdxContinueSelectionByTableRowsAfterRowMouseHandlerState.
        Create(Controller, InitialBoxAccessor, InitialHitTestResult,
        ANestingLevel);
      Controller.SwitchStateCore(ANewState, APhysicalPoint);
    end
...
function TdxContinueSelectionByLinesMouseHandlerState.
  CreateExtendSelectionCommand: TdxExtendSelectionByRangesCommandBase;
begin
...
procedure TdxContinueSelectionByTableRowsAfterParagraphsMouseHandlerState.
  SwitchState(const AMousePosition: TPoint);
var
  AByParagraphs: TdxContinueSelectionByParagraphsMouseHandlerState;
begin
  AByParagraphs := TdxContinueSelectionByParagraphsMouseHandlerState.Create
    (Controller, InitialBoxAccessor, InitialHitTestResult);
