...
uses
  ...
  Dialogs, DB, cxGraphics, cxControls,
  cxLookAndFeels, cxLookAndFeelPainters, ComCtrls, StdCtrls, cxGrid,
  dxCustomWizardControl, dxWizardControl,
  cxGridWizardCustomHelper, cxGridCustomView, dxLayoutContainer,
...
type
  ...
  protected
    ...
    procedure SetCheckComboBoxValue(ACombo: TcxCheckComboBox;
      const AText: string);
    ...
    property MultiLevelStructureMasterViewName: string
      read GetMultiLevelStructureMasterViewName;
    property IsDetailViewCustomizing: Boolean read GetIsDetailViewCustomizing;
    property IsMultiLevelStructure: Boolean read GetIsMultiLevelStructure
      write SetIsMultiLevelStructure;
...
procedure TcxGridWizardCustomPageFrame.CreateHelperForGridView
  (AGridViewClass: TClass);
begin
...
procedure TcxGridWizardCustomPageFrame.SetDeleteExistingStructure
...
procedure TcxGridWizardCustomPageFrame.SetMasterGridView
  (AValue: TcxCustomGridView);
begin
...
function TcxGridWizardCustomPageFrame.GetCheckComboBoxValue
  (ACombo: TcxCheckComboBox): string;
begin
  if ((ACombo.Properties.EditValueFormat = cvfStatesString) and
    (ACombo.Text <> ACombo.Properties.EmptySelectionText)) or
    ((ACombo.Properties.EditValueFormat = cvfInteger) and
    (ACombo.EditValue <> 0)) then
    Result := ACombo.Text
  else
    Result := EmptyStr;
end;

procedure TcxGridWizardCustomPageFrame.SetCheckComboBoxValue
  (ACombo: TcxCheckComboBox; const AText: string);
var
  AList: TStringList;
  AValue: Integer;
  I: Integer;
...
function TcxGridWizardCustomPageFrame.GetHelperInfoList
...
function TcxGridWizardCustomPageFrame.
  GetMultiLevelStructureMasterViewName: string;
begin
...
procedure TcxGridWizardCustomPageFrame.SetIsMultiLevelStructure
  (const AValue: Boolean);
begin
