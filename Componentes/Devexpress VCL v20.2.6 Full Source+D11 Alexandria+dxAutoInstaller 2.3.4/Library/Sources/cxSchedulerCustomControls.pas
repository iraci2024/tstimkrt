...
{$ENDIF}
  ...
  dxCore, dxCoreClasses, cxControls, cxGraphics, cxGeometry, cxLookAndFeels,
  cxLookAndFeelPainters,
  dxCustomHint, cxFormats, cxSchedulerUtils, cxSchedulerStorage, cxStyles,
  cxClasses, cxEdit,
  cxDateUtils, cxStorage, cxTextEdit, cxNavigator, cxVariants, dxUxTheme,
  dxTouch, Contnrs,
...
const
  ...
  cxSchedulerNavigatorVisibility: array [0 .. 7] of Boolean = (True, False,
...
type
  ...
  protected
    ...
    //
    function AllowDesignHitTest(X, Y: Integer; AShift: TShiftState)
      : Boolean; virtual;
    ...
    procedure DoBeforeMouseDown(AButton: TMouseButton; AShift: TShiftState;
      X, Y: Integer);
  ...
  TcxSchedulerNavigatorButtonClickEvent = procedure
    (Sender: TcxSchedulerResourceNavigator;
  ...
  protected
    ...
    procedure Draw(APainter: TcxCustomLookAndFeelPainter;
  ...
  private
    ...
    procedure SetItem(AIndex: Integer;
      AValue: TcxSchedulerNavigatorCustomButton);
  protected
    function GetOwner: TPersistent; override;
    ...
    property Scheduler: TcxCustomScheduler read FScheduler;
  public
    constructor CreateEx(AOwner: TPersistent;
      AItemClass: TCollectionItemClass); virtual;

    property VisibleCount: Integer read GetVisibleCount;
    property Items[AIndex: Integer]: TcxSchedulerNavigatorCustomButton
  ...
  private
    ...
    procedure SetButtonByIndex(AIndex: Integer;
      AValue: TcxSchedulerNavigatorButton);
  protected
    function AddButton(ACommand: Integer; AVisible: Boolean = True)
      : TcxSchedulerNavigatorButton;
  ...
  published
    property First: TcxSchedulerNavigatorButton index cxSchedulerFirstButton
      read GetButtonByIndex write SetButtonByIndex;
    property PrevPage: TcxSchedulerNavigatorButton
      index cxSchedulerPrevPageButton read GetButtonByIndex
      write SetButtonByIndex;
    property Prev: TcxSchedulerNavigatorButton index cxSchedulerPrevButton
      read GetButtonByIndex write SetButtonByIndex;
    property Next: TcxSchedulerNavigatorButton index cxSchedulerNextButton
      read GetButtonByIndex write SetButtonByIndex;
    property NextPage: TcxSchedulerNavigatorButton
      index cxSchedulerNextPageButton read GetButtonByIndex
      write SetButtonByIndex;
    property Last: TcxSchedulerNavigatorButton index cxSchedulerLastButton
      read GetButtonByIndex write SetButtonByIndex;
    property ShowFewerResources: TcxSchedulerNavigatorButton
      index cxSchedulerShowFewerResourcesButton read GetButtonByIndex
      write SetButtonByIndex;
    property ShowMoreResources: TcxSchedulerNavigatorButton
      index cxSchedulerShowMoreResourcesButton read GetButtonByIndex
      write SetButtonByIndex;
  end;

  { TcxSchedulerResourceNavigatorController }

  TcxSchedulerResourceNavigatorController = class
    (TcxSchedulerSubControlController)
  private
  ...
  protected
    procedure BeforeMouseDown(Button: TMouseButton; Shift: TShiftState;
      X, Y: Integer); override;
    procedure CheckButtonDown(Button: TMouseButton;
      Shift: TShiftState); virtual;
    function GetHotTrackButton(ACanDisabled: Boolean = True)
      : TcxSchedulerNavigatorButton;
    procedure MouseDown(Button: TMouseButton; Shift: TShiftState;
      X, Y: Integer); override;
    ...
    property HotTrackButton: TcxSchedulerNavigatorButton read FHotTrackButton
      write SetHotTrackButton;
  ...
  private
    function GetCurrentButton(AButtons: TcxSchedulerNavigatorCustomButtons)
      : TcxSchedulerNavigatorButton;
  ...
  TcxSchedulerNavigatorCustomDrawButtonEvent = procedure
    (Sender: TcxSchedulerResourceNavigator; ACanvas: TcxCanvas;
    AButton: TcxSchedulerNavigatorButton; var ADone: Boolean) of object;
  ...
  protected
    ...
    function DoCustomDrawButton(AButton: TcxSchedulerNavigatorButton)
      : Boolean; virtual;
    ...
    procedure Scroll(AScrollCode: TScrollCode;
    ...
    property FirstVisibleResourceIndex: Integer
      read GetFirstVisibleResourceIndex write SetFirstVisibleResourceIndex;
    property HitTest: TcxSchedulerResourceNavigatorHitTest read GetHitTest;
    property ResourcesPerPage: Integer read GetResourcesPerPage
      write SetResourcesPerPage;
  ...
  published
    property ButtonImages: TCustomImageList read FButtonImages
      write SetButtonImages;
    property Buttons: TcxSchedulerNavigatorButtons read FButtons
      write SetButtons;
    property CustomButtons: TcxSchedulerNavigatorCustomButtons
      read FCustomButtons write SetCustomButtons stored IsCustomButtonsStored;
    property ShowButtons: Boolean read FShowButtons write SetShowButtons
      default True;
    property Visibility: TcxSchedulerNavigatorVisibilityMode read FVisibility
      write SetVisibility default snvAuto;
    property OnButtonClick: TcxSchedulerNavigatorButtonClickEvent
      read FOnButtonClick write FOnButtonClick;
    property OnCustomDrawButton: TcxSchedulerNavigatorCustomDrawButtonEvent
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
  published
    property Creating: Boolean read GetCreating write FCreating
      stored GetCreatingStored;
    property Deleting: Boolean read GetDeleting write FDeleting
      stored GetDeletingStored;
    property DialogEditing: Boolean read GetDialogEditing write FDialogEditing
      stored GetDialogEditingStored;
    property DialogShowing: Boolean read FDialogShowing write FDialogShowing
      default True;
    property InplaceEditing: Boolean read GetInplaceEditing
      write FInplaceEditing stored GetInplaceEditingStored;
    property Intersection: Boolean read FIntersection write FIntersection
      default True;
    property MovingBetweenResources: Boolean read GetMovingBetweenResources
      write FMovingBetweenResources stored GetMovingBetweenResourcesStored;
    property Moving: Boolean read GetMoving write FMoving
      stored GetMovingStored;
    property ReadOnly: Boolean read FReadOnly write FReadOnly default False;
    property Recurrence: Boolean read FRecurrence write FRecurrence
      default True;
    property SharingBetweenResources: Boolean read FSharingBetweenResources
      write FSharingBetweenResources default False;
    property Sizing: Boolean read GetSizing write FSizing
      stored GetSizingStored;
  end;
  ...
  public
    ...
    property Scheduler: TcxCustomScheduler read FScheduler;
  published
    property ControlsSizing: Boolean read FControlsSizing
      write SetControlsSizing default True;
    property DynamicSizing: Boolean read FDynamicSizing write FDynamicSizing
      default False;
    property IntegralSizing: Boolean read FIntegralSizing
      write SetIntegralSizing default True;
  end;
  ...
  published
    ...
    property MultilineCaptions: Boolean read FMultilineCaptions
      write SetMultilineCaptions default False;
    property ImagePosition: TcxSchedulerHeaderImagePosition read FImagePosition
      write SetImagePosition stored IsImagePositionStored;
    property RotateCaptions: Boolean read FRotateCaptions write SetRotateCations
      default True;
  end;
  ...
  protected
    ...
    function IsWorkTime(AResourceItem: TcxSchedulerStorageResourceItem;
      const ADateTime: TDateTime): Boolean; inline;
  ...
  public
    ...
    property Scheduler: TcxCustomScheduler read FScheduler;
  published
    property AdditionalTimeZone: Integer index 0 read GetTimeZone
      write SetTimeZone default -1;
    property AdditionalTimeZoneDaylightSaving: Boolean
      read FAdditionalTimeZoneDaylightSaving write SetATZDaylightSaving
      default False;
    property AdditionalTimeZoneLabel: string index 0 read GetTimeZoneLabel
      write SetTimeZoneLabel stored IsTimeZoneLabelStored;
    property CurrentTimeZone: Integer index 1 read GetTimeZone write SetTimeZone
      default -1;
    property CurrentTimeZoneDaylightSaving: Boolean
      read FCurrentTimeZoneDaylightSaving write SetCTZDaylightSaving
      default False;
    property CurrentTimeZoneLabel: string index 1 read GetTimeZoneLabel
      write SetTimeZoneLabel stored IsTimeZoneLabelStored;
    property DayBorderColor: TColor read FDayBorderColor write SetDayBorderColor
      default clDefault;
    property EventBorderColor: TColor read FEventBorderColor
      write SetEventBorderColor default clBlack;
    property EventHeight: Integer read FEventHeight write SetEventHeight
      default 0;
    property GroupingKind: TcxSchedulerGroupingKind read FGroupingKind
      write SetGroupingKind default gkDefault;
    property GroupSeparatorWidth: Integer read FGroupSeparatorWidth
      write SetGroupSeparatorWidth default cxDefaultGroupSeparatorWidth;
    property HideSelection: Boolean read FHideSelection write SetHideSelection
      default False;
    property HorzSplitterWidth: Integer read FHorzSplitterWidth
      write SetHorzSplitterWidth default cxDefaultSplitterWidth;
    property ResourceHeaders: TcxSchedulerResourceHeaders read FResourceHeaders
      write SetResourceHeaders;
    property ResourcesPerPage: Integer read FResourcesPerPage
      write SetResourcesPerPage default cxDefaultResourcesPerPage;
    property RotateResourceCaptions: Boolean read GetRotateResourceCaptions
      write SetRotateResourceCaptions default True;
    property ShowAdditionalTimeZone: Boolean read FShowAdditionalTimeZone
      write SetShowAdditionalTimeZone default False;
    property ShowEventsWithoutResource: Boolean read FShowEventsWithoutResource
      write SetShowEventsWithoutResource default False;
    property ShowHints: Boolean read FShowHints write FShowHints default True;
    property ShowNavigationButtons: Boolean read FShowNavigationButtons
      write SetShowNavigationButtons default True;
    property StartOfWeek: TcxStartOfWeek read FStartOfWeek write SetStartOfWeek
      default swSystem;
    property Style: TcxSchedulerViewStyle read FStyle write SetStyle
      default cxSchedulerDefaultViewStyle;
    property VertSplitterWidth: Integer read FVertSplitterWidth
      write SetVertSplitterWidth default cxDefaultSplitterWidth;
    property ViewPosition: TcxSchedulerViewPosition read FViewPosition
      write SetViewPosition default vpLeft;
    property WorkDays: TDays read FWorkDays write SetWorkDays
      stored IsWorkDaysStored;
    property WorkFinish: TTime read FWorkFinish write SetWorkFinish
      stored False;
  ...
  TcxEventDragKind = (edkNone, edkEventDragRect, edkMoveEvent, edkResizeStart,
    edkResizeEnd);
  ...
  protected
    function GetEditRect(var R: TRect; const ADate: TDateTime;
      AResource: TcxSchedulerStorageResourceItem; AMakeVisible: Boolean = False)
      : Boolean; virtual;
    ...
    function IsKeyForControl(var AKey: Word; Shift: TShiftState)
      : Boolean; virtual;
  ...
  public
    ...
    procedure Activate(AEvent: TcxSchedulerControlEvent; const APos: TPoint;
  ...
  private
    ...
    function GetVisibleResource(AIndex: Integer)
  ...
  protected
    ...
    function IsKeyNavigation(var AKey: Word; AShift: TShiftState)
      : Boolean; virtual;
    ...
    procedure ReplaceDate(ADate: TDateTime;
  ...
  public
    ...
    procedure ReplaceSelParams(AResource
      : TcxSchedulerStorageResourceItem); overload;
    function ScrollResources(AGoForward: Boolean): Boolean;
    function ScrollResourcesCycled(AGoForward: Boolean;
      var AResource: TcxSchedulerStorageResourceItem): Boolean;
    function ScrollResourcesEx(AGoForward: Boolean;
      var AResource: TcxSchedulerStorageResourceItem): Boolean; virtual;
    procedure SetSelAnchor(const Anchor: TDateTime;
      AShift: TShiftState); overload;
    ...
    property VisibleResources[AIndex: Integer]: TcxSchedulerStorageResourceItem
      read GetVisibleResource;
  end;
  ...
  protected
    ...
    procedure CheckOpenInplaceEditorOnMouseUp(Button: TMouseButton;
    ...
    function PtInArea(const ARect: TRect; const P: TPoint;
      IsUpArea: Boolean): Boolean;
  ...
  public
    ...
    function CanEditEvent(AEvent: TcxSchedulerControlEvent; AInplace: Boolean)
      : Boolean; virtual;
    function CanShowEventDialog: Boolean; virtual;
    procedure DeleteSelectedEvents;
    function IsEventEditing(AEvent: TcxSchedulerControlEvent;
      AResource: TcxSchedulerStorageResourceItem): Boolean;
    procedure SelectSingleEvent(AEvent: TcxSchedulerControlEvent;
      ADate: TDateTime; AMakeVisible: Boolean = True);
    ...
    property StartDragResource: TcxSchedulerStorageResourceItem
      read FStartDragResource;
  end;

  { TcxDragHelper }

  TcxSchedulerDragOverDestination = (dodView, dodControlBox, dodDateNavigator,
    dodOther);
  ...
  protected
    ...
    procedure DragOver(const P: TPoint; State: TDragState;
  ...
  public
    ...
    property Controller: TcxSchedulerViewController read GetController;
    property DateNavigator: TcxSchedulerCustomDateNavigator
  ...
  public
    ...
    procedure CalculateConflictsForDateNavigator(ADateNavigator
      : TcxSchedulerCustomDateNavigator);
    procedure DropToDateNavigator(ADateNavigator
      : TcxSchedulerCustomDateNavigator);
  ...
  protected
    ...
    procedure DeleteClone(AEvent: TcxSchedulerControlEvent;
    ...
    procedure ProcessDateNavigator(ADateNavigator
      : TcxSchedulerCustomDateNavigator);
    ...
    procedure UpdateDateNavigatorClones(ADateNavigator
      : TcxSchedulerCustomDateNavigator); virtual;
  ...
  protected
    ...
    property SchedulerViewStyle: TcxSchedulerViewStyle
      read GetSchedulerViewStyle;
  public
    constructor Create(AOwner: TcxCustomScheduler); virtual;
    destructor Destroy; override;
    procedure Activate(const AHintRect: TRect; const AHintText: string;
      AImmediateHint: Boolean = False; AAutoHide: Boolean = True);
      overload; virtual;
    procedure Activate(AEvent: TcxSchedulerControlEvent; const AHintRect: TRect;
      ...
      overload; virtual;
    function CalcHintRect(AMaxWidth: Integer; const AHintText: string;
      AFlags: Integer): TRect;
    procedure Hide;
    procedure Reset;
    property Scheduler: TcxCustomScheduler read FOwner;
  ...
  protected
    ...
    function CanEventEdit(AEvent: TcxSchedulerControlEvent; AInplace: Boolean)
      : Boolean; virtual;
    ...
    function EventContentSelected(AEvent: TcxSchedulerControlEvent)
      : Boolean; virtual;
    ...
    function GetEditRectForEvent(AEvent: TcxSchedulerControlEvent;
      ...
      : TRect; virtual;
    function GetEditStyle(AEvent: TcxSchedulerControlEvent)
      : TcxCustomEditStyle; virtual;
    function GetEditStyleViewParams(AEvent: TcxSchedulerControlEvent)
      : TcxViewParams; virtual;

    function GetEditProperties(AEvent: TcxSchedulerControlEvent)
      : TcxCustomEditProperties; virtual;
    function GetEditWithSingleLineEditor(AEvent: TcxSchedulerControlEvent)
      : Boolean; virtual;
    ...
    procedure GetRangeControlScales(AScales: TdxRangeControlDateTimeScales;
      AValues: TdxRangeControlDateTimeScaleList); virtual;
    ...
    procedure InitEventBySelectedTime(AEvent: TcxSchedulerEvent;
      AllDay, ARecurrence, AInplaceEditing: Boolean); virtual;
    ...
    procedure ScrollSelectedDays(AForward: Boolean; ANeedDate: TDateTime;
      AIsByPage: Boolean); overload; virtual;
    ...
    procedure ValidateContentPopupMenuItems(var AItems
      : TcxSchedulerContentPopupMenuItems); virtual;
    ...
    procedure ShowHintOnScroll(const AHintText: string;
      AScrollBarKind: TScrollBarKind); overload; virtual;
  ...
  public
    ...
    property DragCloneEventList: TcxSchedulerFilteredEventList
      read GetDragCloneEventList;
  ...
  protected
    ...
    procedure CheckResourceNavigatorKind; virtual;
    function DoGetEventDisplayText(AEvent: TcxSchedulerControlEvent)
      : string; virtual;
  ...
  protected
    ...
    procedure DoScrollSelection(AForward: Boolean; ANeedDate: TDateTime;
      AIsByPage: Boolean); overload; virtual; abstract;
    procedure DoScrollSelection(AScrollDelta: Integer); overload;
      virtual; abstract;
    procedure EnsureSelectionVisible; virtual; abstract;
    procedure GetCalendarDimension(out AColCount, ARowCount: Integer);
      virtual; abstract;
    ...
    procedure ScrollSelection(AForward: Boolean; ANeedDate: TDateTime;
      AIsByPage: Boolean); overload;
  ...
  protected
    ...
    function GetStreamAsEvents(AEvents: TcxSchedulerFilteredEventList;
      var Anchor: TDateTime): Boolean;
    function IsClipboardBusy: Boolean;
    procedure InsertEvents(AEvents: TcxSchedulerFilteredEventList;
      Anchor: TDateTime);
  ...
  private
    ...
    FCachedDataDefaultParams
      : TObjectDictionary<Integer, TDictionary<Integer, TcxViewParams>>;
    FScheduler: TcxCustomScheduler;
    ...
    procedure AddCachedDefaultViewParams(Index: Integer; AData: TObject;
    ...
    function GetCachedDefaultViewParams(Index: Integer; AData: TObject;
      out AParams: TcxViewParams): Boolean;
    function GetCachedDefaultViewParamsDataIndex(Index: Integer; AData: TObject)
      : Integer; inline;
  ...
  public
    ...
    property Scheduler: TcxCustomScheduler read FScheduler;
  published
    property Background: TcxStyle index cxcsBackground read GetValue
      write SetValue;
    ...
    property GroupSeparator: TcxStyle index cxcsGroupSeparator read GetValue
      write SetValue;
    property DayHeader: TcxStyle index cxcsDayHeader read GetValue
      write SetValue;
    property HorzSplitter: TcxStyle index cxcsHSplitter read GetValue
      write SetValue;
    property ResourceHeader: TcxStyle index cxcsResourceHeader read GetValue
      write SetValue;
    property Selection: TcxStyle index cxcsSelection read GetValue
      write SetValue;
    property VertSplitter: TcxStyle index cxcsVSplitter read GetValue
      write SetValue;

    property OnGetContentStyle: TcxSchedulerOnGetContentStyleEvent
      read FOnGetContentStyle write FOnGetContentStyle;
    property OnGetDayHeaderStyle: TcxSchedulerOnGetDayHeaderStyleEvent
      read FOnGetDayHeaderStyle write FOnGetDayHeaderStyle;
    property OnGetEventStyle: TcxSchedulerOnGetEventStyleEvent
      read FOnGetEventStyle write FOnGetEventStyle;
    property OnGetResourceHeaderStyle: TcxSchedulerOnGetResourceHeaderStyleEvent
      read FOnGetResourceHeaderStyle write FOnGetResourceHeaderStyle;
  end;
  ...
  published
    ...
    property ModalDialogs: Boolean read FModalDialogs write FModalDialogs
      default False;
  ...
  TcxSchedulerEventSelectionChangedEvent = procedure(Sender: TcxCustomScheduler;
    AEvent: TcxSchedulerControlEvent) of object;
  TcxSchedulerShowDateHintEvent = procedure(Sender: TObject;
    const ADate: TDateTime; var AHintText: string; var AAllow: Boolean)
    of object;

  TcxCustomScheduler = class(TcxControl, IcxSchedulerStorageListener,
    IcxFormatControllerListener, IcxFormatControllerListener2, IcxStoredObject,
    IdxSkinSupport)
  private
    ...
    procedure InitEventBySelection(AEvent: TcxSchedulerEvent; AllDay: Boolean;
  ...
  protected
    ...
    procedure DoStartOfWeekChanged(AOldStartOfWeek, ANewStartOfWeek
      : TDay); virtual;
    procedure FormatChanged; virtual;
    ...
    function CanDeactivateOnSelectionChanged(AView: TcxSchedulerCustomView)
      : Boolean; virtual;
    ...
    function CreateClipboardController
      : TcxSchedulerClipboardController; virtual;
    ...
    function CreateEventHitTestController
      : TcxSchedulerEventHitTestController; virtual;
    ...
    function CreateSplitter(AKind: TcxSchedulerSplitterKind)
      : TcxSchedulerSplitter; virtual;
    function CreateStyles: TcxSchedulerStyles; virtual;
    procedure CreateSubClasses; virtual;
    procedure DateNavigatorSelectionChanged; virtual;
    procedure DblClick; override;
    procedure DestroySubClasses; virtual;
    procedure DoAfterDragEvent(Target: TObject; X, Y: Integer;
      var Accept: Boolean); virtual;
    procedure DoAfterEditing(AEvent: TcxSchedulerControlEvent); virtual;
    procedure DoAfterSizingEvent(AEvent: TcxSchedulerControlEvent;
      X, Y: Integer; var Accept: Boolean); virtual;
    function DoBeforeDeleting(AEvent: TcxSchedulerControlEvent)
      : Boolean; virtual;
    function DoBeforeDragEvent(AEvent: TcxSchedulerControlEvent; X, Y: Integer)
      : Boolean; virtual;
    function DoBeforeEditing(AEvent: TcxSchedulerControlEvent;
      AInplace: Boolean): Boolean; virtual;
    function DoBeforeSizingEvent(AEvent: TcxSchedulerControlEvent;
    ...
    procedure DoGetEventDisplayText(AEvent: TcxSchedulerControlEvent;
      var AText: string); virtual;
    procedure DoGetEventEditProperties(AEvent: TcxSchedulerControlEvent;
    ...
    function DoIsWorkTime(AResourceItem: TcxSchedulerStorageResourceItem;
      const ADateTime: TDateTime): Boolean;
    procedure DoCanShowView(AView: TcxSchedulerCustomView;
      var Allow: Boolean); virtual;
    procedure DoLayoutChanged; virtual;
    procedure DoLayoutChangedEvent; virtual;
    function DoMoreEventsButtonClick: Boolean; virtual;
    function DoNavigationButtonClick(AnInterval: TDateTime;
      AResource: TcxSchedulerStorageResourceItem): Boolean; virtual;
    procedure DoSelectionChanged; virtual;
    procedure DoScaleScroll; virtual;
    function DoShowDateHint(const ADate: TDateTime; var AHintText: string)
      : Boolean; virtual;
    ...
    function GetControlFromPoint(const APoint: TPoint)
      : TcxSchedulerSubControl; virtual;
    ...
    function GetEventHintText(AEvent: TcxSchedulerControlEvent)
      : string; virtual;
    function GetEventModernStyleHintInfo(AEvent: TcxSchedulerControlEvent)
      : TcxSchedulerEventModernStyleHintInfo; virtual;
    function GetEventUserHintText(AEvent: TcxSchedulerControlEvent;
      var AText: string): Boolean; virtual;
    function GetEventUserModernStyleHintInfo(AEvent: TcxSchedulerControlEvent;
      AInfo: TcxSchedulerEventModernStyleHintInfo): Boolean; virtual;
    function GetHScrollBarBounds: TRect; override;
    ...
    function GetNextView(AView: TcxSchedulerCustomView)
      : TcxSchedulerCustomView; virtual;
    ...
    procedure InitScrollBarsParameters; override;
    procedure InternalDeleteEvent(AEvent: TcxSchedulerControlEvent;
      AIgnoreRecurring: Boolean);
    procedure InternalDeleteSelectedEvents(AForceDelete, ACheckReadOnly
      : Boolean);
    function InternalMouseWheel(Shift: TShiftState; WheelDelta: Integer;
    ...
    function NeedPanningFeedback(AScrollKind: TScrollBarKind): Boolean;
      override;
    function NeedShowHint(AEvent: TcxSchedulerControlEvent;
      var AHintText: string; AllowShow: Boolean): Boolean; virtual;
    procedure DoPaint; override;
    procedure PaintControl(AControl: TcxSchedulerSubControl;
      ASpecialPaint: Boolean = False); virtual;
    procedure PeriodChanged; virtual;
    ...
    property Capture: TcxSchedulerSubControl read GetCaptureControl
      write SetCaptureControl;
    property CaptureController: TcxSchedulerSubControlController
      read GetCaptureController;
    property ClipboardController: TcxSchedulerClipboardController
      read FClipboardController;
    property ControlFlags: TcxControlFlags read FControlFlags
      write FControlFlags;
    ...
    property EditStyle: TcxCustomEditStyle read FEditStyle;
    // remove to EditingController
    property EventHitTestController: TcxSchedulerEventHitTestController
      read FEventHitTestController write FEventHitTestController;
    ...
    property KeyboardListener: TcxSchedulerSubControl read FKeyboardListener
      write FKeyboardListener;
    ...
    property SubControls[Index: Integer]: TcxSchedulerSubControl
      read GetSubControl;
    ...
    property OnAfterDragEvent: TcxSchedulerAfterDragEvent read FOnAfterDragEvent
      write FOnAfterDragEvent;
    property OnAfterEditing: TcxSchedulerAfterEditing read FOnAfterEditing
      write FOnAfterEditing;
    property OnAfterSizingEvent: TcxSchedulerAfterSizingEvent
      read FOnAfterSizingEvent write FOnAfterSizingEvent;
    property OnBeforeDeleting: TcxSchedulerBeforeDeleting read FOnBeforeDeleting
      write FOnBeforeDeleting;
    property OnBeforeDragEvent: TcxSchedulerBeforeDragEvent
      read FOnBeforeDragEvent write FOnBeforeDragEvent;
    property OnBeforeEditing: TcxSchedulerBeforeEditing read FOnBeforeEditing
      write FOnBeforeEditing;
    property OnBeforeSizingEvent: TcxSchedulerBeforeSizingEvent
      read FOnBeforeSizingEvent write FOnBeforeSizingEvent;
    property OnCanShowView: TcxSchedulerCanShowViewEvent read FOnCanShowView
      write FOnCanShowView;
    property OnEventSelectionChanged: TcxSchedulerEventSelectionChangedEvent
      read FOnEventSelectionChanged write FOnEventSelectionChanged;
    property OnFirstVisibleResourceChanged: TNotifyEvent
      read FOnFirstVisibleResourceChanged write FOnFirstVisibleResourceChanged;
    property OnGetEventDisplayText: TcxSchedulerGetEventText
      read FOnGetEventDisplayText write FOnGetEventDisplayText;
    property OnGetEventHintText: TcxSchedulerGetEventText
      read FOnGetEventHintText write FOnGetEventHintText;
    property OnGetEventEditProperties: TcxSchedulerGetEventEditPropertiesEvent
      read FOnGetEventEditProperties write FOnGetEventEditProperties;
    property OnGetEventModernStyleHintInfo
      : TcxSchedulerGetEventModernStyleHintInfo
      read FOnGetEventModernStyleHintInfo write FOnGetEventModernStyleHintInfo;
    property OnInitEdit: TcxSchedulerInitEditEvent read FOnInitEdit
      write FOnInitEdit;
    property OnIsWorkTime: TcxSchedulerIsWorkTimeEvent read FOnIsWorkTime
      write FOnIsWorkTime;
    property OnLayoutChanged: TNotifyEvent read FOnLayoutChanged
      write FOnLayoutChanged;
    property OnMoreEventsButtonClick: TcxSchedulerMoreEventsButtonClickEvent
      read FOnMoreEventsButtonClick write FOnMoreEventsButtonClick;
    property OnNavigationButtonClick: TcxSchedulerNavigationButtonClickEvent
      read FOnNavigationButtonClick write FOnNavigationButtonClick;
    property OnScaleScroll: TcxSchedulerScaleScrollEvent read FOnScaleScroll
      write FOnScaleScroll;
    property OnSelectionChanged: TNotifyEvent read FOnSelectionChanged
      write FOnSelectionChanged;
    property OnShowDateHint: TcxSchedulerShowDateHintEvent
      read GetOnShowDateHint write FOnShowDateHint;
    property OnViewTypeChanged: TcxSchedulerViewTypeChangedEvent
      read FOnViewTypeChanged write FOnViewTypeChanged;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    procedure BeginUpdate;
    procedure CopyToClipboard;
    procedure CreateEventUsingDialog(AllDay: Boolean = False;
      ARecurrence: Boolean = False); virtual;
    ...
    function GoToDate(ADate: TDateTime; AViewMode: TcxSchedulerViewMode)
      : Boolean; overload; virtual;
    procedure LayoutChanged;
    procedure MakeEventVisible(AEvent: TcxSchedulerControlEvent;
      const ADate: TDateTime = NullDate;
      AResource: TcxSchedulerStorageResourceItem = nil);
    procedure MakeResourceVisible(AResource: TcxSchedulerStorageResourceItem);
    procedure PasteFromClipboard;
    procedure SelectEvent(AEvent: TcxSchedulerControlEvent;
      AShift: TShiftState = []);
    ...
    property Color;
    property ContentPopupMenu: TcxSchedulerContentPopupMenu
      read FContentPopupMenu write SetContentPopupMenu;
    property ControlBox: TcxSchedulerControlBox read FControlBox
      write SetControlBox;
    property CurrentView: TcxSchedulerCustomView read FCurrentView
      write SetCurrentView;
    ...
    property EventImages: TCustomImageList read FEventImages
      write SetEventImages;
    property EventOperations: TcxSchedulerEventOperations read FEventOperations
      write SetEventOperations;
    property EventPopupMenu: TcxSchedulerEventPopupMenu read FEventPopupMenu
      write SetEventPopupMenu;
    property FirstVisibleResourceIndex: Integer read FFirstVisibleResourceIndex
      write SetFirstVisibleResourceIndex default 0;
    property HolidayDays: TcxSchedulerDateList read FHolidayDays;
    property OptionsBehavior: TcxSchedulerOptionsBehavior read FOptionsBehavior
      write SetOptionsBehavior;
    property OptionsCustomize: TcxSchedulerOptionsCustomize
      read FOptionsCustomize write SetOptionsCustomize;
    property OptionsView: TcxSchedulerOptionsView read FOptionsView
      write SetOptionsView;
    property ResourceNavigator: TcxSchedulerResourceNavigator
      read FResourceNavigator write SetResourceNavigator;
    property SelectedDays: TcxSchedulerDateList read FSelectedDays;
    property SelectedEventCount: Integer read GetSelectedEventCount;
    property SelectedEvents[Index: Integer]: TcxSchedulerControlEvent
      read GetSelectedEvent;
    property SelFinish: TDateTime read GetSelFinish;
    ...
    property VisibleEvents[AIndex: Integer]: TcxSchedulerControlEvent
      read GetVisibleEvent;
    property TabStop default True;
    property Font;
  published
    property StylesEvents: TNotifyEvent read FStylesEvents write FStylesEvents;
    property ResourceNavigatorEvents: TNotifyEvent read FResourceNavigatorEvents
      write FResourceNavigatorEvents;
    property ContentPopupMenuEvents: TNotifyEvent read FContentPopupMenuEvents
      write FContentPopupMenuEvents;
    property EventPopupMenuEvents: TNotifyEvent read FEventPopupMenuEvents
      write FEventPopupMenuEvents;
  end;
  ...
  protected
    ...
    function CreateSubItem(AOwner: TMenuItem; const ACaption: string;
      ACommand: Integer = -1; AImageIndex: Integer = -1;
    ...
    function FindItemByCommand(AOwnerItem: TMenuItem; ACommand: Integer)
      : TMenuItem;
  ...
  published
    ...
    property UseBuiltInPopupMenu: Boolean read FUseBuiltInPopupMenu
      write FUseBuiltInPopupMenu default True;
  end;
  ...
  TcxSchedulerContentPopupMenuPopupEvent = procedure
    (Sender: TcxSchedulerContentPopupMenu; ABuiltInMenu: TPopupMenu;
    var AHandled: Boolean) of object;
  TcxSchedulerContentPopupMenuClickEvent = procedure
    (Sender: TcxSchedulerContentPopupMenu;
  ...
  published
    property Items: TcxSchedulerContentPopupMenuItems read FItems write FItems
      default [cpmiNewEvent, cpmiNewAllDayEvent, cpmiNewReccuringEvent,
      cpmiToday, cpmiGoToDate, cpmiGoToThisDay, cpmiResourcesLayout];
    property PopupMenu;
    property UseBuiltInPopupMenu;

    property OnClick: TcxSchedulerContentPopupMenuClickEvent read FOnClick
      write FOnClick;
    property OnPopup: TcxSchedulerContentPopupMenuPopupEvent read FOnPopup
      write FOnPopup;
  end;

  { TcxSchedulerEventPopupMenu }

  TcxSchedulerEventPopupMenuItem = (epmiOpen, epmiEditSeries, epmiShowTimeAs,
    epmiLabel, epmiDelete);
  TcxSchedulerEventPopupMenuItems = set of TcxSchedulerEventPopupMenuItem;

  TcxSchedulerEventPopupMenuPopupEvent = procedure
    (Sender: TcxSchedulerEventPopupMenu; ABuiltInMenu: TPopupMenu;
    var AHandled: Boolean) of object;
  TcxSchedulerEventPopupMenuClickEvent = procedure
    (Sender: TcxSchedulerEventPopupMenu; AItem: TcxSchedulerEventPopupMenuItem;
    ASubItemIndex: Integer; var AHandled: Boolean) of object;
  ...
  public
    ...
    property Event: TcxSchedulerControlEvent read FEvent;
  published
    property Items: TcxSchedulerEventPopupMenuItems read FItems write FItems
      default [epmiOpen, epmiEditSeries, epmiShowTimeAs, epmiLabel, epmiDelete];
    property PopupMenu;
    property UseBuiltInPopupMenu;

    property OnClick: TcxSchedulerEventPopupMenuClickEvent read FOnClick
      write FOnClick;
    property OnPopup: TcxSchedulerEventPopupMenuPopupEvent read FOnPopup
      write FOnPopup;
  end;
...
uses
  ...
  cxSchedulerRangeControlClientProperties,
  cxSchedulerEventModernInfoContainer, cxSchedulerCustomResourceView,
  dxDPIAwareUtils;
...
function cxCompareTabOrders(AEvent1, AEvent2: TcxSchedulerControlEvent)
  : Integer;
var
...
begin
  if not Scheduler.HandleAllocated then
    Exit;
  if not Visible then
    ViewInfo.Clear
  else
    Painter.InitializePainter;
  if not Visible or (Controller = nil) then
    Exit;
  Controller.Reset;
  DoLayoutChanged;
...
procedure TcxSchedulerSubControl.SetBounds(ALeft, ATop, AWidth,
  AHeight: Integer);
begin
...
function TcxSchedulerSubControl.AllowDesignHitTest(X, Y: Integer;
...
function TcxSchedulerSubControl.CreateController
  : TcxSchedulerSubControlController;
begin
...
procedure TcxSchedulerSubControl.DoMouseDown(AButton: TMouseButton;
  AShift: TShiftState; X, Y: Integer);
begin
  MousePositionChanged(X, Y);
...
procedure TcxSchedulerSubControl.DoMouseMove(AShift: TShiftState;
  X, Y: Integer);
begin
  MousePositionChanged(X, Y);
...
procedure TcxSchedulerSubControl.DoMouseUp(AButton: TMouseButton;
  AShift: TShiftState; X, Y: Integer);
begin
  MousePositionChanged(X, Y);
...
function TcxSchedulerSubControl.GetScrollBar(AKind: TScrollBarKind)
  : IcxControlScrollBar;
begin
...
var
  ASavePos: TPoint;
begin
  if not Visible or cxRectIsEmpty(Bounds) or not Canvas.RectVisible(Bounds) then
    Exit;
...
procedure TcxSchedulerSubControl.SetScrollBarInfo(AScrollBarKind
  : TScrollBarKind; AMin, AMax, AStep, APage, APos: Integer;
  AAllowShow, AAllowHide: Boolean);
begin
  Scheduler.SetScrollBarInfo(AScrollBarKind, AMin, AMax, AStep, APage, APos,
    AAllowShow and Visible, AAllowHide);
end;
...
function TcxSchedulerSubControl.GetDateTimeHelperClass
...
function TcxSchedulerSubControl.GetLookAndFeelPainter
  : TcxCustomLookAndFeelPainter;
begin
  Result := Scheduler.LookAndFeelPainter;
end;

function TcxSchedulerSubControl.GetPainterHelperClass
...
procedure TcxSchedulerSubControlController.DragAndDrop(const P: TPoint;
  var Accepted: Boolean);
begin
end;

procedure TcxSchedulerSubControlController.DragDrop(Source: TObject;
  X, Y: Integer);
begin
end;

procedure TcxSchedulerSubControlController.DragOver(Source: TObject;
  X, Y: Integer; State: TDragState; var Accept: Boolean);
begin
  Accept := False;
end;

procedure TcxSchedulerSubControlController.EndDrag(Target: TObject;
  X, Y: Integer);
begin
end;
...
function TcxSchedulerSubControlController.GetDragAndDropObjectClass
  : TcxDragAndDropObjectClass;
begin
  Result := nil;
end;

procedure TcxSchedulerSubControlController.StartDrag(var DragObject
  : TDragObject);
begin
end;
...
procedure TcxSchedulerSubControlController.BeforeMouseDown(Button: TMouseButton;
...
procedure TcxSchedulerSubControlController.KeyDown(var Key: Word;
  Shift: TShiftState);
begin
end;
...
procedure TcxSchedulerSubControlController.KeyUp(var Key: Word;
  Shift: TShiftState);
begin
end;
...
procedure TcxSchedulerSubControlController.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
end;

procedure TcxSchedulerSubControlController.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
end;

procedure TcxSchedulerSubControlController.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
function TcxSchedulerSubControlController.GetHitTest
  : TcxSchedulerSubControlHitTest;
begin
...
begin
  Clear;
  SetBitState(htcControl, cxRectPtIn(Owner.Bounds, cxPointOffset(HitPoint,
...
procedure TcxSchedulerSubControlHitTest.SetBitState(AIndex: Integer;
  AValue: Boolean);
begin
  if AValue then
...
procedure TcxSchedulerSubControlHitTest.SetMaskState(AMask: Integer;
  AValue: Boolean);
begin
  if AValue then
...
function TcxSchedulerSubControlPainter.GetViewInfo
  : TcxSchedulerSubControlViewInfo;
begin
...
begin
  if not IsSchedulerCreated then
    Exit;
...
function TcxSchedulerSubControlViewInfo.GetDateTimeHelperClass
  : TcxSchedulerDateTimeHelperClass;
begin
...
function TcxSchedulerSubControlViewInfo.GetLookAndFeelPainter
  : TcxCustomLookAndFeelPainter;
begin
  Result := Owner.Scheduler.LookAndFeelPainter;
end;

function TcxSchedulerSubControlViewInfo.GetPainterHelperClass
  : TcxSchedulerPainterHelperClass;
begin
...
function TcxSchedulerSubControlViewInfo.
  IsEventCellLayoutCalculatingLocked: Boolean;
begin
...
procedure TcxSchedulerEditController.Activate(AEvent: TcxSchedulerControlEvent;
  const APos: TPoint; AShift: TShiftState);
begin
  if InitEdit(AEvent) then
...
procedure TcxSchedulerEditController.DeleteEvent
  (AEvent: TcxSchedulerControlEvent);
begin
...
begin
  ...
  R := cxRectOffset(View.GetEditRectForEvent(Event, ADate, AResource),
    View.Bounds.TopLeft);
  Result := not cxRectIsEmpty(R);
end;

procedure TcxSchedulerEditController.EditAfterKeyDown(Sender: TObject;
...
procedure TcxSchedulerEditController.EditKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
...
procedure TcxSchedulerEditController.EditKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TcxSchedulerEditController.EditKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
begin
  ...
  if not(Scheduler.DoBeforeEditing(AEvent, True) and GetEditRect(R, FEditDate,
    FEditResource, True)) then
    Exit;
...
function TcxSchedulerEditController.IsKeyForControl(var AKey: Word;
...
const
  VertAlignments: array [Boolean] of TcxEditVertAlignment = (taTopJustify,
    taVCenter);
var
  R: TRect;
  AVisible: Boolean;
begin
  ...
  FEdit.InternalProperties.Alignment.Vert := VertAlignments
    [View.GetEditWithSingleLineEditor(Event)];
...
begin
  ...
  begin
    ...
    FMultilineCaptions := TcxSchedulerResourceHeaders(Source)
      .FMultilineCaptions;
...
begin
  ...
  Filer.DefineProperty('WorkStart', ReadWorkStart, WriteWorkStart,
    FWorkStartAssigned);
  Filer.DefineProperty('WorkFinish', ReadWorkFinish, WriteWorkFinish,
    FWorkFinishAssigned);
end;
...
function TcxSchedulerOptionsView.IsWorkTime(AResourceItem
  : TcxSchedulerStorageResourceItem; const ADateTime: TDateTime): Boolean;
var
  AWorkDays: TDays;
  AWorkFinish: TTime;
  AWorkStart: TTime;
...
begin
  ...
  Result := (ADateTime <> NullDate) and
    (TDay(DayOfWeek(ADateTime) - 1) in AWorkDays);
  if Result then
  begin
...
function TcxSchedulerOptionsView.GetDateTimeHelperClass
  : TcxSchedulerDateTimeHelperClass;
begin
  Result := Scheduler.DateTimeHelper;
end;
...
function TcxSchedulerOptionsView.IsTimeZoneLabelStored(AIndex: Integer)
  : Boolean;
begin
  Result := FTimeZoneLabels[AIndex] <> '';
end;
...
procedure TcxSchedulerOptionsView.SetSplitterWidth(AValue: Integer;
  var AWidth: Integer);
begin
...
procedure TcxSchedulerOptionsView.SetTimeZoneLabel(AIndex: Integer;
  const AValue: string);
begin
...
var
  AText: string;
begin
  Result := FNeedShowHint or (HitAtEvent and Scheduler.NeedShowHint(Event,
    AText, False));
end;
...
begin
  ...
  FCachedDataDefaultParams := TObjectDictionary < Integer,
    TDictionary < Integer, TcxViewParams >>.Create([doOwnsValues]);
end;
...
function TcxSchedulerStyles.GetContentParams(const ADateTime: TDateTime;
  AResource: TcxSchedulerStorageResourceItem = nil): TcxViewParams;
begin
  Result := GetContentParams(ADateTime, Scheduler.DoIsWorkTime(AResource,
    ADateTime), AResource);
end;

function TcxSchedulerStyles.GetContentParams(const ADateTime: TDateTime;
  ALightColor: Boolean; AResource: TcxSchedulerStorageResourceItem = nil)
  : TcxViewParams;
var
  AStyle: TcxStyle;
begin
...
function TcxSchedulerStyles.GetEventContentParams(AEvent: TcxSchedulerEvent)
  : TcxViewParams;
var
  AStyle: TcxStyle;
begin
...
function TcxSchedulerStyles.GetDayHeaderParams(const ADate: TDateTime)
  : TcxViewParams;
var
  AStyle: TcxStyle;
begin
...
function TcxSchedulerStyles.GetSplitterParams(AKind: TcxSchedulerSplitterKind)
  : TcxViewParams;
begin
...
function TcxSchedulerStyles.EventContentSelected
  (AEvent: TcxSchedulerControlEvent): Boolean;
begin
  Result := AEvent.Selected and
    Scheduler.CurrentView.EventContentSelected(AEvent);
  if Scheduler.EditController.IsEditing and
    (Scheduler.EditController.Event = AEvent) then
    Result := False;
end;

function TcxSchedulerStyles.GetDefaultContentColor(AResourceIndex
  : Integer): TColor;
begin
...
function TcxSchedulerStyles.GetDefaultEventColor(AIsHeaderEvent
  : Boolean): TColor;
begin
...
procedure TcxSchedulerStyles.GetDefaultHeaderViewParams
...
procedure TcxSchedulerStyles.GetDefaultViewParams(Index: Integer;
  ...
  case Index of
    ...
    cxcsContent:
      begin
        ...
        if AData <> nil then
          AParams.Color := GetDefaultContentColor
            (TcxSchedulerStorageResourceItem(AData).Index)
        else if SchedulerViewStyle = svsClassic then
    ...
    cxcsEvent:
      ...
      begin
        ...
        if (SchedulerViewStyle = svsClassic) and
          ((AEvent.ActualLabelColor = clDefault) or ASelected) then
        begin
          if ASelected then
          begin
...
function TcxSchedulerStyles.GetEventParams(AEvent: TcxSchedulerEvent)
  : TcxViewParams;
begin
...
procedure TcxSchedulerStyles.AddCachedDefaultViewParams(Index: Integer;
  AData: TObject; const AParams: TcxViewParams);
var
...
function TcxSchedulerStyles.CanCacheViewParams(Index: Integer;
...
function TcxSchedulerStyles.GetCachedDefaultViewParamsDataIndex(Index: Integer;
...
function TcxSchedulerStyles.GetCachedDefaultViewParams(Index: Integer;
  AData: TObject; out AParams: TcxViewParams): Boolean;
var
  ACachedData: TDictionary<Integer, TcxViewParams>;
begin
  if not CanCacheViewParams(Index, AData) then
  ...
  if AData = nil then
    ...
    Result := FCachedDataDefaultParams.TryGetValue(Index, ACachedData) and
      ACachedData.TryGetValue(GetCachedDefaultViewParamsDataIndex(Index,
      AData), AParams);
end;
...
function TcxSchedulerStyles.GetPainterHelperClass
  : TcxSchedulerPainterHelperClass;
begin
  Result := Scheduler.PainterHelper
end;
...
begin
  ...
  TcxSchedulerModernStyleHintForm(FModernHint).OnClosed :=
    OnModernStyleHintHide;
end;
...
procedure TcxSchedulerHintController.Activate(AEvent: TcxSchedulerControlEvent;
  const AHintRect: TRect; AImmediateHint: Boolean = False;
  AAutoHide: Boolean = False);
begin
  Hide;
  FEvent := AEvent;
  FHintRect := AHintRect;
...
begin
  Result := not FLockHint and Application.Active and
    Scheduler.OptionsView.ShowHints and (Scheduler.DragAndDropState = ddsNone);
end;
...
function TcxSchedulerHintController.GetSchedulerViewStyle
...
procedure TcxSchedulerHintController.ShowHint;
  ...
  function InitializeModernHintPopup(AEventCell
    : TcxSchedulerEventCellViewInfo): Boolean;
  var
    R: TRect;
    AIsTooLong: Boolean;
    APos: TPoint;
  ...
  begin
    ...
    FModernHintHelperContainer := cxSchedulerEventModernInfoContainerClass.
      Create(Scheduler);
    AContainer := FModernHintHelperContainer as
      TcxSchedulerEventModernInfoContainer;
    ...
    R := cxRectInflate(R, Scheduler.ScaleFactor.Apply(4),
      Scheduler.ScaleFactor.Apply(4));
    ...
    if AIsTooLong or (Scheduler.ClientToScreen(R.TopLeft).X -
      AModernHint.PopupControl.Width < GetDesktopWorkArea
      (Scheduler.ClientToScreen(R.TopLeft)).Left) and
      (Scheduler.ClientToScreen(R.BottomRight).X +
      AModernHint.PopupControl.Width > GetDesktopWorkArea
      (Scheduler.ClientToScreen(R.BottomRight)).Right) then
    begin
...
begin
  HideHint;
  if not CanShowHint or ((SchedulerViewStyle = svsModern) and (FEvent <> nil)
    and not PtInRect(cxRectOffset(FHintRect,
    Scheduler.CurrentView.Bounds.TopLeft),
    Scheduler.ScreenToClient(GetMouseCursorPos))) then
    Exit;
  AModernEvent := nil;
  if (SchedulerViewStyle = svsModern) and (FEvent <> nil) then
    AModernEvent :=
      (Scheduler.CurrentView.HitTest as TcxSchedulerCustomResourceViewHitTest)
      .EventCell;
  ...
  begin
    ...
    if cxProcessControlHintInfo(AHintInfo, FHintWindow, Scheduler, FHintText,
      FHintRect) then
    begin
  ...
  else if InitializeModernHintPopup(AModernEvent) then
  begin
...
constructor TcxSchedulerClipboardController.Create
...
var
  ...
  ADataPtr: Pointer;
begin
  Result := not IsClipboardBusy and IsClipboardFormatAvailable
    (CF_SCHEDULERDATA);
  if not Result then
    Exit;
  Clipboard.Open;
...
procedure TcxSchedulerClipboardController.CalculateAnchorForResource
  (AEvents: TcxSchedulerFilteredEventList; const AResourceID: Variant;
  var Anchor: TDateTime);
var
  I: Integer;
...
begin
  ...
  for I := 0 to AEvents.Count - 1 do
    if AEvents[I].IsSharedWithResource(AResourceID) and
      (ANewAnchor > AEvents[I].Start) then
...
begin
  if not Scheduler.EventOperations.Creating then
    Exit;
  IsDifferenceResources := False;
  for I := 1 to AEvents.Count - 1 do
  begin
    IsDifferenceResources := not VarEquals(AEvents[I - 1].ResourceID,
      AEvents[I].ResourceID);
    if IsDifferenceResources then
      Break;
  end;
  if IsDifferenceResources and (Scheduler.SelResource <> nil) then
    CalculateAnchorForResource(AEvents,
      Scheduler.SelResource.ResourceID, Anchor);
...
function TcxSchedulerClipboardController.KeyDown(var AKey: Word;
  AShift: TShiftState): Boolean;
begin
  Result := False;
  case AKey of
...
procedure TcxSchedulerClipboardController.RestoreEvent
  ...
  begin
    ...
    begin
      V := VarArrayCreate([VarArrayLowBound(AValue, 1),
        VarArrayHighBound(AValue, 1)], varByte);
...
var
  ...
  DataPtr: Pointer;
begin
  if (Stream.Size = 0) or IsClipboardBusy then
    Exit;
  Clipboard.Open;
  try
    EmptyClipboard;
...
begin
  CF_SCHEDULERDATA := Windows.RegisterClipboardFormat
    (SCF_SCHEDULERCLIPBOARDFORMAT);
end;
...
begin
  if not Scheduler.OptionsCustomize.ControlsSizing or not(ssLeft in Shift) or
    (Scheduler.CaptureController <> Self) or
    (Scheduler.KeyboardListener <> Splitter) or Scheduler.IsLocked then
    Exit;
...
var
  ...
  ACanvas: TcxCanvas;
begin
  if not cxRectIsEmpty(FPrevInvertRect) and
    cxRectIntersect(Temp, R, FPrevInvertRect) then
  begin
...
begin
  if cxRectIsEmpty(FPrevInvertRect) then
    Exit;
...
begin
  if not IsIntegralSizing then
    Result := 1
  else if Splitter.Kind = skVertical then
...
begin
  if IsIntegralSizing then
    R.Bottom := R.Top + ((R.Bottom - R.Top - Splitter.Height)
      div GetMonthSize.cy) * GetMonthSize.cy + Splitter.Height;
...
function TcxSchedulerSplitter.AllowDesignHitTest(X, Y: Integer;
  AShift: TShiftState): Boolean;
begin
  Result := True;
end;

function TcxSchedulerSplitter.CreateController
  : TcxSchedulerSubControlController;
begin
...
begin
  LookAndFeelPainter.DrawSchedulerSplitterBorder(Canvas, ClientRect, ViewParams,
    Kind = skHorizontal);
end;
...
const
  Cursors: array [TcxSchedulerSplitterKind] of TCursor = (crSchedulerVertSplit,
    crSchedulerHorzSplit);
begin
...
var
  ...
  ACallEvent: Boolean;
begin
  if (FSaveRealFirstDate <> GetRealFirstDate) or
    (FSaveRealLastDate <> GetRealLastDate) then
...
procedure TcxSchedulerCustomDateNavigator.ScrollSelection
  (AScrollDelta: Integer);
begin
  BeginUpdate;
  try
...
function TcxSchedulerCustomDateNavigator.GetHintController
  : TcxSchedulerHintController;
begin
...
function TcxSchedulerCustomView.
  CanDeactivateOnDateNavigatorSelectionChange: Boolean;
begin
  Result := True;
end;

function TcxSchedulerCustomView.CanEventEdit(AEvent: TcxSchedulerControlEvent;
  AInplace: Boolean): Boolean;
begin
  Result := (AEvent.Source <> nil) or
    (not AInplace or Scheduler.CanIntersect(AEvent));
end;
...
function TcxSchedulerCustomView.CreateController
  : TcxSchedulerSubControlController;
begin
...
procedure TcxSchedulerCustomView.DoBeforeReallyDeleting
  (AEvent: TcxSchedulerControlEvent);
begin
end;
...
begin
  TcxSchedulerCustomViewViewInfo(ViewInfo).FSelectedDays :=
    Scheduler.SelectedDays;
...
begin
  ...
  begin
    if IsResourceNavigatorAllowed and Scheduler.ResourceNavigator.NeedScrollBar
    then
    begin
...
function TcxSchedulerCustomView.GetGestureClient(const APoint: TPoint)
  : IdxGestureClient;
begin
  Result := nil;
end;
...
begin
  ...
  if not Scheduler.IsPopupScrollBars then
    if Scheduler.ResourceNavigator.NeedScrollBar and
      (Scheduler.ResourceNavigator.ScrollBarKind = sbHorizontal) then
  ...
  begin
    ...
    if Scheduler.VScrollBarVisible and
      (not Scheduler.IsPopupScrollBars or
      Scheduler.ResourceNavigator.NeedScrollBar and
      (Scheduler.ResourceNavigator.ScrollBarKind = sbVertical)) then
...
function TcxSchedulerCustomView.GetEditStyle(AEvent: TcxSchedulerControlEvent)
  : TcxCustomEditStyle;
begin
  Result := Scheduler.EditStyle;
end;

function TcxSchedulerCustomView.GetEditStyleViewParams
...
function TcxSchedulerCustomView.GetEventHintText
...
begin
  ...
  else if Scheduler.UseRightToLeftScrollBar then
  begin
...
procedure TcxSchedulerCustomView.InitEventBySelectedTime
  (AEvent: TcxSchedulerEvent; AllDay, ARecurrence, AInplaceEditing: Boolean);
var
...
function TcxSchedulerCustomView.InternalMouseWheel(Shift: TShiftState;
...
function TcxSchedulerCustomView.IsWorkTime(AResourceItem
  : TcxSchedulerStorageResourceItem; const ADateTime: TDateTime): Boolean;
begin
...
begin
  ViewInfo.FEventCellLayoutCalculateLockCount :=
    Max(0, ViewInfo.FEventCellLayoutCalculateLockCount - 1);
end;
...
function TcxSchedulerCustomView.NeedPanningFeedback
...
begin
  ...
  if AResourceNavigator.NeedScrollBar and
    (AResourceNavigator.ScrollBarKind = sbHorizontal) then
    ShowHintOnScroll(DateTimeToStr(ADate), sbVertical)
  else
    ShowHintOnScroll(DateTimeToStr(ADate), sbHorizontal);
end;

procedure TcxSchedulerCustomView.ShowHintOnScroll(const AHintText: string;
...
begin
  ...
  begin
    if Scheduler.UseRightToLeftScrollBar then
    begin
      P := Point(Scheduler.GetVScrollBarBounds.Right,
        Scheduler.GetVScrollBarBounds.Top);
      R := cxRectSetLeft(R, Scheduler.ClientToScreen(P).X + cxRectWidth(R) + 5);
    end
    else
      R := cxRectSetRight(R,
        Scheduler.ClientToScreen(Scheduler.GetVScrollBarBounds.TopLeft).X - 5);
    R := cxRectSetTop(R, Scheduler.HintController.HintWindowAnchor -
      ((R.Bottom - R.Top) div 2))
  end
  else
  begin
    R := cxRectSetBottom(R,
      Scheduler.ClientToScreen(Scheduler.GetHScrollBarBounds.TopLeft).Y - 5);
    if Scheduler.UseRightToLeftScrollBar then
      R := cxRectSetLeft(R, Scheduler.HintController.HintWindowAnchor +
...
function TcxSchedulerCustomView.GetDragCloneEventList
...
procedure TcxSchedulerCustomView.GetRangeControlScales
  (AScales: TdxRangeControlDateTimeScales;
  AValues: TdxRangeControlDateTimeScaleList);
begin
  AValues.Add(AScales.Week);
  AValues.Add(AScales.Day);
end;

procedure TcxSchedulerCustomView.GetRangeControlTotalRange(out AMin,
  AMax: TDateTime);
var
  AStart: TDateTime;
begin
...
function TcxSchedulerCustomView.GetTouchScrollUIOwner(const APoint: TPoint)
...
function TcxSchedulerCustomViewViewInfo.GetResourceScrollBarKind
  : TScrollBarKind;
begin
  Result := sbHorizontal;
end;
...
function TcxSchedulerCustomViewViewInfo.
  DoSchedulerMoreEventsButtonClick: Boolean;
begin
...
function TcxSchedulerCustomViewViewInfo.GetSchedulerEventsList
  : TcxSchedulerCachedEventList;
begin
  Result := Scheduler.EventList;
end;

procedure TcxSchedulerCustomViewViewInfo.DeleteClone
  (AEvent: TcxSchedulerControlEvent);
begin
...
procedure TcxSchedulerCustomViewViewInfo.SetEventsVisibility(AShowSources,
  AShowClones: Boolean; AForceRepaint: Boolean = False);
begin
end;

function TcxSchedulerCustomViewViewInfo.GetResourceNavigator
  : TcxSchedulerResourceNavigator;
begin
...
function TcxSchedulerCustomViewViewInfo.GetSchedulerStyle
  : TcxSchedulerViewStyle;
begin
  Result := Scheduler.OptionsView.Style;
end;
...
begin
  if (Scheduler <> nil) and (Scheduler.ResourceNavigator <> nil) and
    Scheduler.ResourceNavigator.NeedScrollBar then
    Scheduler.LayoutChanged;
end;
...
const
  InternalHint: array [0 .. 7] of Pointer = (@scxFirstButtonHint,
    @scxPrevPageButtonHint, @scxPrevButtonHint, @scxNextButtonHint,
    @scxNextPageButtonHint, @scxLastButtonHint, @scxShowMoreResourcesButtonHint,
    @scxShowFewerResourcesButtonHint);
begin
  Result := Hint;
...
var
  ...
  AImageIndex: Integer;
begin
  APainter.DrawSchedulerScaledNavigatorButton(ACanvas, Bounds, State,
    Scheduler.ScaleFactor);
  AImages := GetActualImageList;
  AImageIndex := GetActualImageIndex;
  if (AImages <> nil) and (AImageIndex >= 0) then
  begin
    AGlyphRect := cxRectCenter(Bounds, dxGetImageSize(AImages,
      Scheduler.ScaleFactor));
    if State = cxbsPressed then
      AGlyphRect := cxRectOffset(AGlyphRect,
        APainter.NavigatorButtonPressedGlyphOffset);
    ACanvas.SaveState;
    try
...
function TcxSchedulerNavigatorButton.GetState(ACanDisabled: Boolean = True)
  : TcxButtonState;
var
...
begin
  ...
  begin
    ...
    if PtInRect(FBounds, ANavigator.ScreenToClient(GetMouseCursorPos)) and
      Application.Active then
    begin
...
begin
  ...
  begin
    ...
    Result := ImageIndex;
  if (Result in [NBDI_FIRST, NBDI_PRIORPAGE, NBDI_PRIOR, NBDI_NEXT,
    NBDI_NEXTPAGE, NBDI_LAST]) and
    (Scheduler.CurrentView.UseRightToLeftAlignment) then
    case Result of
      NBDI_FIRST:
        Result := NBDI_LAST;
      NBDI_PRIORPAGE:
        Result := NBDI_NEXTPAGE;
      NBDI_PRIOR:
        Result := NBDI_NEXT;
      NBDI_NEXT:
        Result := NBDI_PRIOR;
      NBDI_NEXTPAGE:
        Result := NBDI_PRIORPAGE;
      NBDI_LAST:
        Result := NBDI_FIRST;
    end;
end;
...
constructor TcxSchedulerNavigatorCustomButtons.CreateEx(AOwner: TPersistent;
...
function TcxSchedulerNavigatorCustomButtons.GetItem(AIndex: Integer)
  : TcxSchedulerNavigatorCustomButton;
begin
...
procedure TcxSchedulerNavigatorCustomButtons.SetItem(AIndex: Integer;
  AValue: TcxSchedulerNavigatorCustomButton);
begin
...
function TcxSchedulerNavigatorButtons.AddButton(ACommand: Integer;
  AVisible: Boolean = True): TcxSchedulerNavigatorButton;
begin
...
function TcxSchedulerNavigatorButtons.GetButtonByIndex(AIndex: Integer)
  : TcxSchedulerNavigatorButton;
var
  I: Integer;
begin
  ...
  begin
    Result := Buttons[I];
    if Result.Command = AIndex then
      Break;
  end;
end;

procedure TcxSchedulerNavigatorButtons.SetButtonByIndex(AIndex: Integer;
  AValue: TcxSchedulerNavigatorButton);
begin
...
procedure TcxSchedulerResourceNavigatorController.MouseMove(AShift: TShiftState;
  X, Y: Integer);
begin
...
procedure TcxSchedulerResourceNavigatorController.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
function TcxSchedulerResourceNavigatorController.GetHintController
  : TcxSchedulerHintController;
begin
  Result := Owner.Scheduler.HintController;
end;

function TcxSchedulerResourceNavigatorController.GetResourceNavigator
  : TcxSchedulerResourceNavigator;
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      if AHintText <> '' then
      begin
        HintController.Activate(HintController.CalcHintRect(cxscMaxHintWidth,
          AHintText, cxAlignBottom), AHintText, AImmediate);
      end;
    end
    else
    begin
...
function TcxSchedulerResourceNavigatorHitTest.GetCurrentButton
  (AButtons: TcxSchedulerNavigatorCustomButtons): TcxSchedulerNavigatorButton;
var
  I: Integer;
begin
  Result := nil;
...
function TcxSchedulerResourceNavigatorHitTest.GetHitButton
  : TcxSchedulerNavigatorButton;
begin
...
function TcxSchedulerResourceNavigatorHitTest.GetResourceNavigator
  : TcxSchedulerResourceNavigator;
begin
  Result := TcxSchedulerResourceNavigator(Owner);
end;
...
begin
  ...
  if (Scheduler.CurrentView = nil) or
    (Scheduler.CurrentView.GetGroupingKind = gkNone) then
    Result := False;
  if not Result or (Visibility = snvAlways) then
    Exit;
...
begin
  ...
  begin
    FEmptyAreaBounds := cxRectSetBottom(R, R.Bottom,
      Scheduler.HScrollBar.Height);
    R.Top := FEmptyAreaBounds.Top;
    R.Right := R.Left + MeasureWidth;
    if Scheduler.UseRightToLeftAlignment then
      R := TdxRightToLeftLayoutConverter.ConvertRect(R,
        Scheduler.CurrentView.Bounds)
    else if Scheduler.UseRightToLeftScrollBar and
      not Scheduler.IsPopupScrollBars and Scheduler.VScrollBarVisible then
...
function TcxSchedulerResourceNavigator.CreateController
  : TcxSchedulerSubControlController;
begin
  Result := TcxSchedulerResourceNavigatorController.Create(Self);
end;

function TcxSchedulerResourceNavigator.CreateHitTest
  : TcxSchedulerSubControlHitTest;
begin
  Result := TcxSchedulerResourceNavigatorHitTest.Create(Self);
end;

function TcxSchedulerResourceNavigator.CreateButtons
  : TcxSchedulerNavigatorCustomButtons;
begin
  Result := TcxSchedulerNavigatorCustomButtons.CreateEx(Self,
    GetCustomButtonClass);
end;

function TcxSchedulerResourceNavigator.CreateStandardButtons
  : TcxSchedulerNavigatorButtons;
begin
  ...
  begin
    ...
    begin
      ...
      if AButton.FRotated then
        AButton.FBounds := Rect(0, ASize.cx * AIndex, ASize.cy,
          ASize.cx * (AIndex + 1))
      else
      begin
        AButton.FBounds := Rect(ASize.cx * AIndex, 0, ASize.cx * (AIndex + 1),
          ASize.cy);
        if Scheduler.UseRightToLeftAlignment then
          AButton.FBounds := TdxRightToLeftLayoutConverter.ConvertRect
            (AButton.FBounds, ClientRect);
      end;
...
function TcxSchedulerResourceNavigator.GetCustomButtonClass
  : TcxSchedulerNavigatorButtonClass;
begin
...
begin
  ...
  AIndex2 := Min(FirstVisibleResourceIndex + ResourcesPerPage - 1,
    ResourceCount - 1);
...
begin
  ...
  begin
    if (ResourcesPerPage = 0) or (ResourceCount = 0) then
      ...
      SetScrollBarInfo(ScrollBarKind, 0, ResourceCount - 1, 1, ResourcesPerPage,
        FirstVisibleResourceIndex, True, False);
    CalculateBounds;
  end;
end;
...
begin
  if Visible then
    Canvas.FillRect(EmptyAreaBounds,
      LookAndFeelPainter.DefaultSchedulerNavigatorColor);
  inherited Paint;
end;

procedure TcxSchedulerResourceNavigator.Scroll(AScrollCode: TScrollCode;
...
begin
  if ScrollBarKind = sbHorizontal then
  begin
    Result.cx := (Scheduler.HScrollBar.Height +
...
function TcxSchedulerResourceNavigator.GetHitTest
  : TcxSchedulerResourceNavigatorHitTest;
begin
  Result := TcxSchedulerResourceNavigatorHitTest(inherited HitTest);
end;

function TcxSchedulerResourceNavigator.GetItem(AIndex: Integer)
  : TcxSchedulerNavigatorButton;
begin
...
procedure TcxSchedulerResourceNavigator.SetButtonImages
...
procedure TcxSchedulerResourceNavigator.SetFirstVisibleResourceIndex
  (AValue: Integer);
begin
...
procedure TcxSchedulerEventHitTestController.MouseMove(X, Y: Integer;
  AShift: TShiftState);
var
  R: TRect;
  AHintText: string;
begin
  if Scheduler.IsDesigning then
    Exit;
  HitTest.HitPoint := Point(X, Y);
  if ((ssLeft in AShift) or not HitTest.HitAtEvent)
  { and HintController.ViewMode } then
    HideEventHint
  else if HitTest.HitAtEvent then
    if FPrevHintEvent <> HitTest.Event then
    begin
      HitTest.FNeedShowHint := Scheduler.NeedShowHint(HitTest.Event, AHintText,
        HitTest.NeedShowHint);
...
function TcxSchedulerEventHitTestController.GetHintController
  : TcxSchedulerHintController;
begin
  Result := Scheduler.HintController;
end;
...
function TcxSchedulerPopupMenu.CreateSubItem(AOwner: TMenuItem;
...
begin
  Result := nil;
  if (InternalMenu = nil) or (AOwnerItem = nil) then
    Exit;
  with AOwnerItem do
    for I := 0 to Count - 1 do
...
begin
  ...
  try
    ...
    begin
      ...
      else if TdxBuiltInPopupMenuAdapterManager.IsActualAdapterStandard then
      ...
      begin
        AAdapter := TdxBuiltInPopupMenuAdapterManager.GetActualAdapterClass.
          Create(Scheduler);
        try
          TdxBuiltInPopupMenuAdapterHelper.AddMenu(AAdapter, FInternalMenu,
            AdaptedMenuItemClickHandler);
...
begin
  ...
  begin
    if (FPopupMenu <> nil) and not(csDestroying in FPopupMenu.ComponentState)
    then
...
procedure TcxSchedulerCustomContentPopupMenu.CreateNewEventItems(ANew, AllDay,
  ARecurrence: Boolean; ANewID, AllDayID, ARecurrenceID: Integer);
var
  AEnabled: Boolean;
begin
  ...
  if ANew then
  begin
    CreateSubItem(Root, cxGetResourceString(@scxpmNewEvent), ANewID, 2,
      AEnabled);
    FNewID := ANewID;
  end;
  if AllDay then
  begin
    CreateSubItem(Root, cxGetResourceString(@scxpmNewAllDayEvent), AllDayID, -1,
      AEnabled);
    FAllDayID := AllDayID;
  end;
...
begin
  inherited Create(AScheduler);
  FItems := [cpmiNewEvent, cpmiNewAllDayEvent, cpmiNewReccuringEvent, cpmiToday,
    cpmiGoToDate, cpmiGoToThisDay, cpmiResourcesLayout];
end;
...
begin
  ...
  CreateNewEventItems(cpmiNewEvent in ActualItems, cpmiNewAllDayEvent
    in ActualItems, cpmiNewReccuringEvent in ActualItems, Ord(cpmiNewEvent),
    Ord(cpmiNewAllDayEvent), Ord(cpmiNewReccuringEvent));
  ...
  if (cpmiResourcesLayout in ActualItems) and Scheduler.CurrentView.IsShowResources
  then
  begin
    AddValidSeparator(Root);
    CreateSubItem(Root, cxGetResourceString(@scxpmResourcesLayout),
...
begin
  case ACommand of
    ...
    Ord(cpmiResourcesLayout):
      cxShowResourcesLayoutEditor(Scheduler.Storage,
        Scheduler.DialogsLookAndFeel);
    Ord(cpmiGoToThisDay):
    ...
    Ord(cpmiGoToDate):
      begin
        ...
        if cxShowGoToDateDialog(Scheduler, Scheduler.DialogsLookAndFeel, ADate,
          AViewMode) then
...
function TcxSchedulerContentPopupMenu.IsValidCommand(ACommand: Integer)
  : Boolean;
begin
  Result := (ACommand >= Ord(cpmiNewEvent)) and
    (ACommand <= Ord(cpmiResourcesLayout));
end;
...
var
  AItem: TMenuItem;
begin
  if (cpmiGoToThisDay in ActualItems) and not Scheduler.CurrentView.IsDayView
  then
  begin
    AItem := CreateSubItem(Root, cxGetResourceString(@scxpmGotoThisDay),
      Ord(cpmiGoToThisDay));
    AItem.Enabled := (Scheduler.ActiveHitTest <> nil) and
      Scheduler.ActiveHitTest.HitAtTime;
...
begin
  ...
  if epmiOpen in Items then
    CreateSubItem(Root, cxGetResourceString(@scxpmOpen), Ord(epmiOpen)).Enabled
      := GetEditEnabled;
  if (epmiEditSeries in Items) and (Event <> nil) and (Event.EventType <> etNone)
  then
    CreateSubItem(Root, cxGetResourceString(@scxpmEditSeries),
      Ord(epmiEditSeries), 8).Enabled := GetEditEnabled;
...
function TcxSchedulerEventPopupMenu.GetMenuItem
  (AItem: TcxSchedulerEventPopupMenuItem; ASubItemIndex: Integer = -1)
  : TMenuItem;
begin
  Result := FindItemByCommand(Root, Ord(AItem));
  if Result <> nil then
  begin
    ...
    else if (AItem = epmiShowTimeAs) and (ASubItemIndex in [0 .. 3]) then
      Result := FindItemByCommand(Result, ASubItemIndex + 10)
  end;
end;

function TcxSchedulerEventPopupMenu.IsValidCommand(ACommand: Integer): Boolean;
begin
...
begin
  ...
  begin
    AddValidSeparator(Root);
    CreateSubItem(Root, cxGetResourceString(@scxpmDelete), Ord(epmiDelete), 10)
      .Enabled := CanDelete;
  end;
end;
...
begin
  if not(epmiLabel in Items) or not Scheduler.StorageActive or
    not Storage.IsLabelColorAvailable or (EventLabels.Count = 0) then
    Exit;
  AOwner := CreateSubItem(Root, cxGetResourceString(@scxpmLabel),
    Ord(epmiLabel));
  // label colors
...
var
  ...
  begin
    ...
    CreateSubItem(AOwner, ACaption, GetCommand(epmiShowTimeAs, AIndex), AIndex,
      CanEdit and ((AIndex = 0) or (ACanSetNonFree)), AChecked).Default
      := AChecked;
  end;

begin
  if not(epmiShowTimeAs in Items) or not Scheduler.StorageActive or not Storage.IsStateAvailable
  then
    Exit;
  AOwner := CreateSubItem(Root, cxGetResourceString(@scxpmShowTimeAs),
    Ord(epmiShowTimeAs));
...
begin
  AItem := epmiOpen;
  ASubItemIndex := -1;
  if not IsValidCommand(ACommand) then
    Exit;
  ...
  else if ACommand in [10 .. 13] then
  begin
...
begin
  ...
  begin
    ...
    if CurrentView.Visible and
      cxRectPtIn(cxRectOffset(CurrentView.ViewInfo.Bounds,
      CurrentView.Bounds.TopLeft), P) then
      FDestination := dodView
    else if DateNavigator.Visible and cxRectPtIn(DateNavigator.Bounds, P) then
    begin
      FDestination := dodDateNavigator;
      DateNavigator.MousePositionChanged(P.X, P.Y);
    end
    else if ControlBox.Visible and cxRectPtIn(ControlBox.Bounds, P) then
...
procedure TcxSchedulerDragObject.DropToDateNavigator(ADateNavigator
  : TcxSchedulerCustomDateNavigator);
begin
  if not ADateNavigator.HitTest.HitAtTime then
    Exit;
...
procedure TcxSchedulerDragObject.Finished(Target: TObject; X, Y: Integer;
  Accepted: Boolean);
begin
  if not Accepted and (Target is TcxCustomScheduler) and (Target <> Scheduler)
  then
    TcxCustomScheduler(Target).DragCanceled;
  inherited Finished(Target, X, Y, Accepted);
end;

function TcxSchedulerDragObject.GetDragCursor(Accepted: Boolean;
  X, Y: Integer): TCursor;
...
begin
  ...
  if not Accepted or (Destination = dodControlBox) then
    Exit;
  if (Destination = dodView) and IsShowResources and HitTest.HitAtResource and
    not CanMoveBetweenResources then
    Accepted := False;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        Scheduler.DoAfterDragEvent(FTarget, HitTest.HitX, HitTest.HitY,
          Accepted);
        if Accepted then
        begin
          ApplyChanges;
...
begin
  ...
  try
    ...
    MessageBox(Scheduler.Handle, PChar(AMessage), nil,
...
begin
  Result := Accepted and ((Destination = dodView) and
    not(IsAtOrigin and not IsDragCopy));
end;
...
begin
  Result := not Accepted or ((Destination in [dodDateNavigator, dodControlBox])
    or IsAtOrigin or IsDragCopy);
end;
...
begin
  Result := (Destination = dodDateNavigator) and
    DateNavigator.HitTest.HitAtTime;
end;
...
begin
  ...
  begin
    ...
    if IsShowResources and (AResource <> nil) and
      (AResource <> ADragEventResource) then
      Events.Selection.Add(AEvent, [ssCtrl]);
  end;
  Events.CreateClones;
end;

procedure TcxDragEventHelper.ProcessDateNavigator(ADateNavigator
  : TcxSchedulerCustomDateNavigator);
begin
  try
    UpdateDateNavigatorClones(ADateNavigator);
...
begin
  DragOver(ViewInfo.Owner.ScreenToClient(GetMouseCursorPos), dsDragMove,
    Accepted);
end;
...
begin
  if Destination = dodView then
    UpdateViewClones
  else if Destination = dodDateNavigator then
    UpdateDateNavigatorClones(DateNavigator);
end;

procedure TcxDragEventHelper.UpdateDateNavigatorClones(ADateNavigator
  : TcxSchedulerCustomDateNavigator);
var
  ADelta: TDateTime;
  I: Integer;
begin
  ADelta := ADateNavigator.HitTest.Time -
    dxDateOf(Controller.DragEvent.{ Source. } Start);
  for I := 0 to Clones.Count - 1 do
    with Clones[I] do
    begin
      State := Source.State;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        AStatus := AEvent.Pattern.ValidateOccurrenceTimeBounds(AEvent.Source,
          AEvent.Start, AEvent.Finish);
...
begin
  with Scheduler.EventOperations do
    Result := Scheduler.StorageActive and Creating and InplaceEditing and
      not GetResourceReadOnly and IsCaptionAvailable and
      (Scheduler.SelectedEventCount = 0);
end;
...
begin
  ...
  begin
    if AInplace then
      Result := InplaceEditing and IsCaptionAvailable and
        View.IsInplaceEditingEnabled
    else
...
procedure TcxSchedulerViewController.SelectSingleEvent
  (AEvent: TcxSchedulerControlEvent; ADate: TDateTime;
...
begin
  Result := (DragKind in [edkEventDragRect, edkMoveEvent]) and
    HitTest.HitAtTime and (DragEvent <> nil);
  if Result then
  begin
    if Scheduler.EventList.Selection.IsSelected(DragEvent) and
      not Scheduler.HasConflict(True) and not DragEvent.OpenedInEditor then
...
var
  AEvent: TcxSchedulerControlEvent;
begin
  if (HitTest.HitAtEvent and (HitTest.Event = FBeforeFocusedEvent)) and
    (Button = mbLeft) and ([ssShift, ssCtrl] * Shift = []) and
    not(DragKind in [edkResizeStart, edkResizeEnd]) then
  begin
...
procedure TcxSchedulerViewController.CheckScrollOnDragOver(const P: TPoint;
  State: TDragState);
begin
  if State <> dsDragLeave then
    CheckScrolling(P)
...
begin
  ...
  begin
    ASizingHelper := TcxSchedulerDragAndDropObject(Scheduler.DragAndDropObject)
      .SizingHelper;
...
function TcxSchedulerViewController.CreateResizeEventHelper
  : TcxEventSizingHelper;
begin
...
function TcxSchedulerViewController.CreateNavigation
  : TcxSchedulerViewNavigation;
begin
...
function TcxSchedulerViewController.GetDragAndDropObjectClass
  : TcxDragAndDropObjectClass;
begin
...
begin
  with Scheduler do
    Result := not StorageValid or
      ...
      ((Storage.ResourceCount > 0) and ((SelResource = nil) and
      not View.GetShowEventsWithoutResource));
end;
...
begin
  ...
  begin
    ...
    case Key of
      ...
      VK_DELETE, VK_INSERT:
        if not Scheduler.ClipboardController.KeyDown(Key, Shift) and
          (Key = VK_DELETE) then
          DeleteSelectedEvents;
      VK_SHIFT:
...
begin
  ...
  begin
    if IsLocked or not StorageActive or GetResourceReadOnly or
      Scheduler.ClipboardController.KeyPress(Key) then
      Exit;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          else if CanCreateEventUsingDialog then
            CreateEventUsingDialog;
        end;
      end
      else if CanCreateEventUsingInplaceEdit then
        DoCreateEventUsingInplaceEdit(Key);
    end;
  end;
end;

procedure TcxSchedulerViewController.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  AEvent: TcxSchedulerControlEvent;
...
procedure TcxSchedulerViewController.MouseMove(Shift: TShiftState;
  X, Y: Integer);
begin
  inherited MouseMove(Shift, X, Y);
  if CanProcessMouseMove and (ssLeft in Shift) and not EditController.IsEditing
  then
  begin
...
begin
  ...
  if (ASelectedIndex >= 0) and (Scheduler.TabOrdersList.Count > 0) then
    ASelectedIndex := Scheduler.TabOrdersList.IndexOf
      (Scheduler.EventList[ASelectedIndex]);
  GetNextSelectedIndex(ASelectedIndex);
  if ASelectedIndex < -1 then
    ASelectedIndex := Scheduler.TabOrdersList.Count - 1;
  while (ASelectedIndex < Scheduler.TabOrdersList.Count) and
    (ASelectedIndex >= 0) and not Scheduler.CurrentView.GetEventVisibility
    (TcxSchedulerControlEvent(Scheduler.TabOrdersList[ASelectedIndex])) do
    GetNextSelectedIndex(ASelectedIndex);
  if (ASelectedIndex < Scheduler.EventList.Count) and (ASelectedIndex >= 0) then
    SelectSingleEvent(TcxSchedulerControlEvent(Scheduler.TabOrdersList
      [ASelectedIndex]), NullDate)
  else
    UnselectEvents;
  Scheduler.CurrentView.Refresh;
end;
...
begin
  Result := (DragKind in [edkResizeStart, edkResizeEnd]) and
    not DragEvent.OpenedInEditor and Scheduler.DoBeforeSizingEvent(DragEvent,
    P.X, P.Y);
end;
...
var
  AResource: TcxSchedulerStorageResourceItem;
begin
  if HitTest.HitAtResource and AEvent.IsResourceEvent(HitTest.Resource, True)
  then
    AResource := HitTest.Resource
  else
    AResource := AEvent.GetResourceItem;
  if View.GetTimeIncrement = 1 then
    Scheduler.ReplaceSelParams(dxDateOf(AEvent.Start), dxDateOf(AEvent.Finish) -
      Byte(AEvent.AllDayEvent or ((dxTimeOf(AEvent.Finish) = 0) and
      (AEvent.Start <> AEvent.Finish))) * View.GetTimeIncrement, AResource)
  else
  begin
...
procedure TcxSchedulerViewController.CheckNavigatorScrollArea
  (const APoint: TPoint);
var
  ACode: TScrollCode;
begin
  if PtInArea(FUpScrollArea, APoint, False) then
    ACode := scLineDown
  else if PtInArea(FDownScrollArea, APoint, True) then
    ACode := scLineUp
  else
    ACode := scEndScroll;
...
function TcxSchedulerViewController.PtInArea(const ARect: TRect;
  const P: TPoint; IsUpArea: Boolean): Boolean;
var
  AHorz: Boolean;
begin
...
function TcxSchedulerViewController.GetEditController
  : TcxSchedulerEditController;
begin
...
begin
  ...
  FEditShowingTimer := cxCreateTimer(EditShowingTimerHandler,
    GetDblClickInterval);
end;
...
procedure TcxSchedulerViewNavigation.ReplaceSelParams(const ASelStart,
...
function TcxSchedulerViewNavigation.ScrollResources
...
begin
  ...
  begin
    if not AGoForward then
      ...
      Result := (ResourcesPerPage <> 0) and
        ((ResourcesPerPage + FirstVisibleResourceIndex) < VisibleResourceCount);
    if Result then
    begin
...
function TcxSchedulerViewNavigation.ScrollResourcesEx(AGoForward: Boolean;
  var AResource: TcxSchedulerStorageResourceItem): Boolean;
begin
  ...
  begin
    if not AGoForward then
      ...
      AResource := VisibleResources[ResourceNavigator.ResourcesPerPage +
        ResourceNavigator.FirstVisibleResourceIndex - 1];
  end;
end;

function TcxSchedulerViewNavigation.ScrollResourcesCycled(AGoForward: Boolean;
  var AResource: TcxSchedulerStorageResourceItem): Boolean;
begin
  Result := False;
  ...
  else if not AGoForward and (ResourceNavigator.FirstVisibleResourceIndex = 0)
  then
  begin
    AResource := VisibleResources[VisibleResourceCount - 1];
    ResourceNavigator.FirstVisibleResourceIndex := VisibleResourceCount -
      ResourceNavigator.ResourcesPerPage;
    Result := True;
  end;
end;

procedure TcxSchedulerViewNavigation.SetSelAnchor(const Anchor: TDateTime;
  AShift: TShiftState);
begin
...
procedure TcxSchedulerViewNavigation.SetSelAnchor(const Anchor: TDateTime;
  AShift: TShiftState; AResource: TcxSchedulerStorageResourceItem);
var
...
procedure TcxSchedulerViewNavigation.DoKeyDown(var AKey: Word;
  AShift: TShiftState);
begin
  Scheduler.BeginUpdate;
  try
...
function TcxSchedulerViewNavigation.IsKeyNavigation(var AKey: Word;
  AShift: TShiftState): Boolean;
begin
...
begin
  Result := dxTimeOf(Abs(Scheduler.FSelStart - Scheduler.FSelFinish)) <=
    View.GetTimeIncrement;
end;

function TcxSchedulerViewNavigation.GetResourceItem
  : TcxSchedulerStorageResourceItem;
begin
  Result := nil;
end;

procedure TcxSchedulerViewNavigation.KeyDown(var AKey: Word;
  AShift: TShiftState);
begin
end;

procedure TcxSchedulerViewNavigation.ReplaceDate(ADate: TDateTime;
  AResource: TcxSchedulerStorageResourceItem);
begin
  if ADate >= LastAvailableDate then
    Exit;
  if AResource = nil then
...
function TcxSchedulerViewNavigation.GetResourceNavigator
  : TcxSchedulerResourceNavigator;
begin
  Result := Scheduler.ResourceNavigator;
end;
...
function TcxSchedulerViewNavigation.GetSelResource
  : TcxSchedulerStorageResourceItem;
begin
...
function TcxSchedulerViewNavigation.GetVisibleResource(AIndex: Integer)
  : TcxSchedulerStorageResourceItem;
begin
  if Scheduler.StorageValid then
...
begin
  if Scheduler.DateNavigator.Visible then
    Exit;
...
begin
  if (FControl = nil) or (csDestroying in Control.ComponentState) then
    Exit;
...
begin
  ...
  BeginUpdate;
  SetBounds(0, 0, ScaleFactor.Apply(cxDefaultSchedulerWidth),
    ScaleFactor.Apply(cxDefaultSchedulerHeight));
...
begin
  if not StorageActive or (AEvent = nil) or not EventOperations.Deleting or
    AEvent.ReadOnly then
    Exit;
  InternalDeleteEvent(AEvent, False);
end;

procedure TcxCustomScheduler.DeleteSelectedEvents(ACheckReadOnly
  : Boolean = True);
begin
...
begin
  if (AEvent = nil) or not StorageActive or (cxEventEditorClass = nil) or
    not DoBeforeEditing(AEvent, False) then
    Exit;
  ...
  try
    ...
    FEventEditInfo.ForcePatternEditing := AForcePatternEditing and
      AEvent.IsRecurring;
...
procedure TcxCustomScheduler.EditEventUsingInplaceEdit
  (AEvent: TcxSchedulerControlEvent);
begin
  if (AEvent = nil) or not StorageActive then
    Exit;
  if CanFocusEx then
  begin
    SetFocus;
...
procedure TcxCustomScheduler.MakeEventVisible(AEvent: TcxSchedulerControlEvent;
  const ADate: TDateTime = NullDate;
  AResource: TcxSchedulerStorageResourceItem = nil);
var
...
begin
  if (AResource = nil) or not AResource.Visible or
    (OptionsView.ResourcesPerPage = 0) then
    Exit;
  AVisibleIndex := -1;
  ...
  else if AVisibleIndex >= (FirstVisibleResourceIndex +
    OptionsView.ResourcesPerPage) then
    FirstVisibleResourceIndex :=
      Max(AVisibleIndex - (OptionsView.ResourcesPerPage - 1), 0);
end;
...
procedure TcxCustomScheduler.SelectEvent(AEvent: TcxSchedulerControlEvent;
  AShift: TShiftState = []);
begin
...
procedure TcxCustomScheduler.SelectTime(const ASelStart, ASelFinish: TDateTime;
  AResource: TcxSchedulerStorageResourceItem);
begin
  if DateTimeHelper.RoundTime(Abs(ASelStart - ASelFinish)) <= CurrentView.GetTimeIncrement
  then
    ReplaceSelParams(ASelStart, ASelStart, AResource)
  else
    ReplaceSelParams(ASelStart, (ASelFinish - CurrentView.GetTimeIncrement),
      AResource);
  LayoutChanged;
end;
...
begin
  if EventList.Selection.Count = 0 then
    Exit;
  EventList.Selection.Clear;
  CurrentView.LockEventLayoutCalculating;
...
procedure TcxCustomScheduler.Notification(AComponent: TComponent;
  Operation: TOperation);
var
  I: Integer;
begin
...
procedure TcxCustomScheduler.AddListener(AListener
  : IcxExternalDateNavigatorListener);
begin
...
begin
  if FAligningSubControls or IsLoading or not FSubControlsCreated then
    Exit;
...
begin
  ...
  case OptionsView.ViewPosition of
    vpRight:
      R := cxRectSetLeft(R, R.Left + DateNavigator.Width,
        OptionsView.VertSplitterWidth);
    vpLeft:
      R := cxRectSetRight(R, R.Right - DateNavigator.Width,
        OptionsView.VertSplitterWidth);
    vpTop:
      begin
  ...
  case OptionsView.ViewPosition of
    vpRight:
      begin
        ...
        R := cxRectSetTop(R, R.Top + DateNavigator.Height,
          OptionsView.HorzSplitterWidth);
      end;
    vpLeft:
      begin
    ...
    vpTop:
      R := cxRectSetBottom(R, R.Bottom - DateNavigator.Height,
        OptionsView.HorzSplitterWidth);
    vpBottom:
      R := cxRectSetTop(R, R.Top + DateNavigator.Height,
        OptionsView.HorzSplitterWidth);
...
begin
  ...
  begin
    ...
    R.Right := ClientBounds.Right -
      (OptionsView.VertSplitterWidth + DateNavigator.Width);
    R.Bottom := ClientBounds.Bottom;
  end;
  CurrentView.Bounds := GetActualBiDiModeRect(R);
end;
...
begin
  ...
  begin
    ...
    begin
      R.Right := ClientBounds.Right;
      if IsVertSplitterVisible then
        R.Left := ClientBounds.Left + DateNavigator.Width +
          OptionsView.VertSplitterWidth
      else
    ...
    R.TopLeft := ClientBounds.TopLeft;
    R.Bottom := ClientBounds.Bottom -
      (DateNavigator.Height + OptionsView.HorzSplitterWidth);
    R.Right := ClientBounds.Right;
  end;
  CurrentView.Bounds := GetActualBiDiModeRect(R);
end;
...
function TcxCustomScheduler.CanDeactivateOnSelectionChanged
  (AView: TcxSchedulerCustomView): Boolean;
begin
  Result := (AView <> nil) and
    AView.CanDeactivateOnDateNavigatorSelectionChange;
end;

function TcxCustomScheduler.CanIntersect
  (AEvent: TcxSchedulerControlEvent): Boolean;
begin
  Result := EventOperations.Intersection or
    not AEvent.Conflicts(OptionsView.ShowEventsWithoutResource or
    not HasResources);
end;
...
function TcxCustomScheduler.CreateClipboardController
  : TcxSchedulerClipboardController;
begin
  Result := TcxSchedulerClipboardController.Create(Self);
end;

function TcxCustomScheduler.CreateContentPopupMenu
  : TcxSchedulerContentPopupMenu;
begin
...
function TcxCustomScheduler.CreateDateNavigator
  : TcxSchedulerCustomDateNavigator;
begin
  Result := nil;
end;
...
function TcxCustomScheduler.CreateDefaultEditProperties
...
function TcxCustomScheduler.CreateEventHitTestController
  : TcxSchedulerEventHitTestController;
begin
...
function TcxCustomScheduler.CreateOptionsCustomize
  : TcxSchedulerOptionsCustomize;
begin
...
function TcxCustomScheduler.CreateResourceNavigator
  : TcxSchedulerResourceNavigator;
begin
  Result := TcxSchedulerResourceNavigator.Create(Self);
end;

function TcxCustomScheduler.CreateSplitter(AKind: TcxSchedulerSplitterKind)
  : TcxSchedulerSplitter;
begin
...
procedure TcxCustomScheduler.DoAfterDragEvent(Target: TObject; X, Y: Integer;
  var Accept: Boolean);
begin
...
function TcxCustomScheduler.DoBeforeDragEvent(AEvent: TcxSchedulerControlEvent;
  X, Y: Integer): Boolean;
begin
  Result := True;
...
function TcxCustomScheduler.DoBeforeEditing(AEvent: TcxSchedulerControlEvent;
  AInplace: Boolean): Boolean;
begin
...
begin
  ...
  if AControlEvent.Source <> nil then
    AControlEvent.MoveTo(AControlEvent.Start +
      GetTimeBias(AControlEvent.Start));
...
procedure TcxCustomScheduler.DoGestureScroll(AScrollKind: TScrollBarKind;
...
function TcxCustomScheduler.DoIsWorkTime(AResourceItem
  : TcxSchedulerStorageResourceItem; const ADateTime: TDateTime): Boolean;
begin
...
procedure TcxCustomScheduler.DoCanShowView(AView: TcxSchedulerCustomView;
  var Allow: Boolean);
begin
...
function TcxCustomScheduler.DoShowDateHint(const ADate: TDateTime;
  var AHintText: string): Boolean;
var
...
begin
  ...
  if not FOptionsView.ShowHints then
    Exit;
  Result := (Storage <> nil) and Storage.GetHolidayNamesByDate(ADate,
    AHintText);
...
begin
  with CurrentView do
    Result := Visible and cxRectPtIn(ViewInfo.Bounds,
      ScreenToClient(cxPoint(X, Y))) and DoShowPopupMenu(X, Y);
  if not Result then
...
begin
  if not FSubControlsCreated or not HandleAllocated then
    Exit;
...
function TcxCustomScheduler.GetControlFromPoint(const APoint: TPoint)
  : TcxSchedulerSubControl;
var
  I: Integer;
begin
...
begin
  ...
  begin
    ...
    Result := AControl.Controller.GetCursor(X - AControl.Left,
      Y - AControl.Top);
  end;
...
begin
  ...
  if UseRightToLeftAlignment then
    AStoredVertSplitterBounds := TdxRightToLeftLayoutConverter.ConvertRect
      (AStoredVertSplitterBounds, FStoredClientBounds);
  if IsViewAtLeft then
...
function TcxCustomScheduler.GetDesignHitTest(X, Y: Integer;
  Shift: TShiftState): Boolean;
begin
  ...
  begin
    ...
    if not Result then
      Result := GetControlFromPoint(cxPoint(X, Y)).AllowDesignHitTest(X,
        Y, Shift);
  end;
end;
...
begin
  ...
  Result.AllowHiddenEvents := OptionsView.ShowEventsWithoutResource or
    not HasResources;
  ...
  Result.ShowResources := EventOperations.SharingBetweenResources and
    AEvent.Storage.IsEventSharingAllowed;
...
begin
  ...
  begin
    with DateTimeHelper do
      Result := TimeToStr(AEvent.Start) + '-' + TimeToStr(AEvent.Finish) +
        ' ' + Result;
  end;
  GetEventUserHintText(AEvent, Result);
end;

function TcxCustomScheduler.GetEventModernStyleHintInfo
  (AEvent: TcxSchedulerControlEvent): TcxSchedulerEventModernStyleHintInfo;
begin
  ...
  Result.Start := Format('%s  %s', [DateToStr(Int(AEvent.Start)),
    TcxSchedulerDateTimeHelper.TimeToStr(AEvent.Start)]);
  Result.Finish := Format('%s  %s', [DateToStr(Int(AEvent.Finish)),
    TcxSchedulerDateTimeHelper.TimeToStr(AEvent.Finish)]);
...
function TcxCustomScheduler.GetEventUserHintText
  (AEvent: TcxSchedulerControlEvent; var AText: string): Boolean;
begin
...
function TcxCustomScheduler.GetEventUserModernStyleHintInfo
  (AEvent: TcxSchedulerControlEvent;
...
function TcxCustomScheduler.GetMainScrollBarsClass
...
function TcxCustomScheduler.GetNextView(AView: TcxSchedulerCustomView)
  : TcxSchedulerCustomView;
begin
  Result := AView;
end;
  ...
  begin
    ...
    begin
      ...
      if OptionsView.CurrentTimeZoneDaylightSaving then
        Result := Result + TimeZoneDaylightBias(AStart,
          OptionsView.CurrentTimeZone) * MinuteToTime;
    end;
  end;
end;
...
procedure TcxCustomScheduler.InternalDeleteEvent
  (AEvent: TcxSchedulerControlEvent; AIgnoreRecurring: Boolean);
var
  ADeleteOccurrence: Boolean;
begin
  if not DoBeforeDeleting(AEvent) then
    Exit;
  if not AIgnoreRecurring and AEvent.IsRecurring then
  begin
    if cxShowRecurrenceSelectionDialog(AEvent, rsmDeleting, DialogsLookAndFeel,
      ADeleteOccurrence) then
    begin
...
procedure TcxCustomScheduler.InternalDeleteSelectedEvents(AForceDelete,
...
var
  ...
  begin
    for Result := 0 to High(ASelectedIDs) do
      if VarEquals(AID, ASelectedIDs[Result]) then
        Exit;
    Result := -1;
  end;
      ...
      begin
        ...
        begin
          ...
          if not AForceDelete then
            DeleteEvent(AEvent)
          else if not(ACheckReadOnly and AEvent.ReadOnly) then
            InternalDeleteEvent(AEvent, True);
          if ACount <> SelectedEventCount then
            Break;
        end;
      end;
    end;
...
function TcxCustomScheduler.InternalMouseWheel(Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint): Boolean;
begin
  Result := False;
  if CurrentView <> nil then
...
function TcxCustomScheduler.IsDaysIntervalChanged(var AStart,
  AFinish: TDateTime): Boolean;
begin
  AStart := Min(CurrentView.FirstVisibleDate, DateNavigator.GetRealFirstDate) -
    CurrentView.GetVisibleDaysRange;
  AFinish := Max(CurrentView.GetLastAvailableDate + CurrentView.GetTimeIncrement
    * 2 + 7, DateNavigator.GetRealLastDate) + CurrentView.GetVisibleDaysRange;
...
begin
  ...
  else if EditController.Edit <> nil then
...
procedure TcxCustomScheduler.LookAndFeelChanged(Sender: TcxLookAndFeel;
  AChangedValues: TcxLookAndFeelValues);
var
  I: Integer;
begin
...
procedure TcxCustomScheduler.MouseDown(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
var
  AShift: TShiftState;
begin
...
var
  ...
  AShift: TShiftState;
begin
  if (FPrevMousePos.X = X) and (FPrevMousePos.Y = Y) then
    Exit;
  AShift := Shift;
  AShift := AShift - [ssPen, ssTouch];
  ...
  begin
    ...
    if (ssLeft in AShift) and not CurrentView.HitTest.HitAtControl and
      (FSelStart <> FSelFinish) then
    begin
...
procedure TcxCustomScheduler.MouseUp(Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
  inherited MouseUp(Button, Shift, X, Y);
...
function TcxCustomScheduler.NeedPanningFeedback(AScrollKind
  : TScrollBarKind): Boolean;
begin
  Result := ResourceNavigator.NeedScrollBar and
    (AScrollKind = ResourceNavigator.ScrollBarKind) or
...
procedure TcxCustomScheduler.PaintControl(AControl: TcxSchedulerSubControl;
  ASpecialPaint: Boolean = False);
begin
  if not AControl.Visible or (AControl.IsSpecialPaint <> ASpecialPaint) or
    not Canvas.RectVisible(AControl.Bounds) then
    Exit;
...
begin
  if EditController.IsEditing then
    Exit;
  if ResourceNavigator.NeedScrollBar and
    (AScrollBarKind = ResourceNavigator.ScrollBarKind) then
...
begin
  if not DateNavigator.Visible then
    Exit;
  if Accept then
...
begin
  ...
  FEventList.NeedForceUpdate := FEventList.NeedForceUpdate or
    (FEventList.TimeZone <> OptionsView.CurrentTimeZone);
  FEventList.TimeZone := OptionsView.CurrentTimeZone;
  FEventList.DaylightSaving := OptionsView.CurrentTimeZoneDaylightSaving;
  FEventList.ShowEventsWithoutResource :=
    OptionsView.ShowEventsWithoutResource or (VisibleGroupingKind = gkNone);
  AChanged := IsDaysIntervalChanged(AStart, AFinish);
  if ACheckDaysInterval and not AChanged then
    Exit;
  FEventList.BeforeUpdate;
  if FEventList.Clones.Count > 0 then
  begin
    FEventList.SelStart := Min(FEventList.Clones.First.Start,
      CurrentView.FirstVisibleDate) - 7;
    FEventList.SelFinish := Max(FEventList.Clones.Last.Finish,
      CurrentView.LastVisibleDate) + CurrentView.GetTimeIncrement * 2 + 7;
  ...
  begin
    ...
    FEventList.SelFinish := CurrentView.LastVisibleDate +
      CurrentView.GetTimeIncrement * 2 + 7;
  end;
...
begin
  if (OptionsView.ResourcesPerPage = 0) and (FFirstVisibleResourceIndex <> 0)
  then
  begin
    FFirstVisibleResourceIndex := 0;
    FirstVisibleResourceChanged;
  end
  else if FFirstVisibleResourceIndex + OptionsView.ResourcesPerPage >
    ResourceNavigator.ResourceCount then
  begin
    FFirstVisibleResourceIndex :=
      Max(0, ResourceNavigator.ResourceCount - OptionsView.ResourcesPerPage);
  end;
end;
...
begin
  ...
  try
    ...
    else if not FCurrentView.Visible and (FVisibleChangedCount = 1) then
...
begin
  ...
  begin
    for I := 0 to Storage.ResourceCount - 1 do
      if Storage.Resources.ResourceItems[I].Visible then
        Inc(C);
  end;
  if C = 0 then
    Result := gkNone
...
procedure TcxCustomScheduler.DragAndDrop(const P: TPoint;
  var Accepted: Boolean);
begin
...
procedure TcxCustomScheduler.DragOver(Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
var
...
begin
  ...
  if State <> dsDragMove then
    FPrevMousePos := cxInvalidPoint
  else if (FPrevMousePos.X = X) and (FPrevMousePos.Y = Y) and
    (FPrevCopyDragDrop = ACopyDragDrop) then
    Exit
  else
    FPrevMousePos := cxPoint(X, Y);
...
function TcxCustomScheduler.GetDragAndDropObjectClass
  : TcxDragAndDropObjectClass;
begin
...
function TcxCustomScheduler.GetGestureClient(const APoint: TPoint)
  : IdxGestureClient;
begin
...
// IcxFormatControllerListener
procedure TcxCustomScheduler.DoStartOfWeekChanged(AOldStartOfWeek,
  ANewStartOfWeek: TDay);
var
  I, ADelta: Integer;
begin
...
begin
  ...
  else if AName = 'ResourcesPerPage' then
...
function TcxCustomScheduler.GetCaptureController
  : TcxSchedulerSubControlController;
begin
...
function TcxCustomScheduler.GetSelectedEvent(AIndex: Integer)
...
function TcxCustomScheduler.GetSubControl(AIndex: Integer)
  : TcxSchedulerSubControl;
begin
...
function TcxCustomScheduler.GetTouchScrollUIOwner(const APoint: TPoint)
  : IdxTouchScrollUIOwner;
begin
...
function TcxCustomScheduler.GetVisibleEvent(AIndex: Integer)
  : TcxSchedulerControlEvent;
begin
  Result := EventList[AIndex];
end;

procedure TcxCustomScheduler.InitEventBySelection(AEvent: TcxSchedulerEvent;
...
begin
  ...
  CurrentView.InitEventBySelectedTime(AEvent, AllDay, ARecurrence,
    AInplaceEditing);
...
begin
  ...
  begin
    if FEventImages <> nil then
      FEventImages.RemoveFreeNotification(Self);
    FEventImages := AValue;
    if FEventImages <> nil then
      FEventImages.FreeNotification(Self);
  end;
end;
...
procedure TcxCustomScheduler.SetOptionsBehavior
  (AValue: TcxSchedulerOptionsBehavior);
begin
...
procedure TcxEventSizingHelper.DragOver(const P: TPoint; State: TDragState;
  var Accepted: Boolean);
begin
...
begin
  Result := HitTest.HitAtTime and
    (not HitTest.HitAtResource or (FStartResource = HitTest.Resource));
end;
...
function TcxEventSizingHelper.CanApplyBounds(const AStart,
  AFinish: TDateTime): Boolean;
begin
  Result := True;
  if Event.EventType in [etCustom, etOccurrence] then
    Result := Event.Pattern.ValidateOccurrenceTimeBounds(Event, AStart, AFinish)
      = odsValid;
end;
...
function TcxSchedulerDragAndDropObject.GetController
  : TcxSchedulerViewController;
begin
