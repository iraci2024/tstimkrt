...
type
  ...
  IdxRectangularObjectHotZoneVisitor = interface(IdxHotZoneVisitor)
    ...
    procedure Visit(AHotZone: TdxRectangularObjectBottomMiddleHotZone);
      overload;
  ...
  public
    ...
    function BeforeActivate(AController: TdxRichEditCustomMouseController;
      AResult: TdxRichEditHitTestResult): Boolean; virtual; abstract;
    procedure Activate(AController: TdxRichEditCustomMouseController;
      AResult: TdxRichEditHitTestResult); virtual; abstract;
    ...
    property GestureStateIndicator: IdxGestureStateIndicator
      read FGestureStateIndicator write FGestureStateIndicator;
  ...
  protected
    ...
    function ForceKeepOriginalAspectRatio(const ABounds: TRect;
      ADesiredWidth: Integer; ADesiredHeight: Integer): TRect;
      overload; virtual;
    function CreateValidBoxBoundsCore(const APoint: TPoint): TRect;
      virtual; abstract;
    function CalculateOffsetCore(const APoint: TPoint): TPoint;
      virtual; abstract;
  ...
  public
    ...
    function BeforeActivate(AController: TdxRichEditCustomMouseController;
      AResult: TdxRichEditHitTestResult): Boolean; override;
    procedure Accept(const AVisitor: IdxRectangularObjectHotZoneVisitor);
      virtual; abstract;
    procedure Activate(AController: TdxRichEditCustomMouseController;
      AResult: TdxRichEditHitTestResult); override;
    function CreateValidBoxBounds(APoint: TPoint): TRect;
    function CalculateOffset(APoint: TPoint): TPoint;
    function ForceKeepOriginalAspectRatio(const ABounds: TRect;
      const AOriginalSize: TSize): TRect; overload; virtual;
  ...
  protected
    ...
    function ForceKeepOriginalAspectRatio(const ABounds: TRect;
      ADesiredWidth: Integer; ADesiredHeight: Integer): TRect; override;
  public
    procedure Accept(const AVisitor
      : IdxRectangularObjectHotZoneVisitor); override;
  end;
...
function TdxHotZone.HitTest(const P: TPoint;
  ADpi, AScaleFactor: Single): Boolean;
var
  R: TRect;
  APoint: TPoint;
begin
...
constructor TdxRectangularObjectHotZone.Create(ABox: TdxBox;
  APieceTable: TdxPieceTable; const AGestureStateIndicator
...
begin
  ...
  begin
    ...
    ALockAspectRatio := AFloatingObjectBox.GetFloatingObjectRun.
      FloatingObjectProperties.LockAspectRatio
  end
  else
  begin
    ...
    begin
      ...
      ALockAspectRatio :=
        (TdxInlinePictureRun(AInlinePictureBox.GetRun(PieceTable)))
        .PictureProperties.LockAspectRatio;
    end;
  end;
...
function TdxRectangularObjectHotZone.BeforeActivate
  (AController: TdxRichEditCustomMouseController;
  AResult: TdxRichEditHitTestResult): Boolean;
begin
  Result := not AController.DeactivateTextBoxPieceTableIfNeed
    (PieceTable, AResult);
end;

procedure TdxRectangularObjectHotZone.Activate(AController
  : TdxRichEditCustomMouseController; AResult: TdxRichEditHitTestResult);
var
...
function TdxRectangularObjectHotZone.ForceKeepOriginalAspectRatio
  (const ABounds: TRect; const AOriginalSize: TSize): TRect;
var
...
begin
  ...
  if AAspectX > AAspectY then
    Result := ForceKeepOriginalAspectRatio(ABounds, ABounds.Width,
      Round(AOriginalSize.Height * AAspectX / 100.0))
  else
    Result := ForceKeepOriginalAspectRatio(ABounds,
      Round(AOriginalSize.Width * AAspectY / 100.0), ABounds.Height);
end;

function TdxRectangularObjectHotZone.ForceKeepOriginalAspectRatio
  (const ABounds: TRect; ADesiredWidth: Integer;
  ADesiredHeight: Integer): TRect;
begin
  Result := ABounds;
end;

function TdxRectangularObjectHotZone.CreateValidBoxBounds
  (APoint: TPoint): TRect;
begin
...
function TdxRectangularObjectHotZone.CalculateCursor(ADefaultCursor
  : TCursor): TCursor;
var
...
begin
  ...
  if ACursorAngle < 0 then
    Exit(ADefaultCursor);
  ARotationAngle := -PieceTable.DocumentModel.
    GetBoxEffectiveRotationAngleInDegrees(Box);
  Result := CalculateCursorByAngle(ARotationAngle + ACursorAngle);
end;

function TdxRectangularObjectHotZone.CalculateCursorAngle(ADefaultCursor
  : TCursor): Single;
begin
...
function TdxRectangularObjectHotZone.CalculateCursorByAngle
  (AAngle: Single): TCursor;
begin
...
procedure TdxRectangularObjectHotZone.AcceptCore(const AVisitor
  : IdxHotZoneVisitor);
begin
...
function TdxRectangularObjectTopLeftHotZone.CreateValidBoxBoundsCore
  (const APoint: TPoint): TRect;
var
  ABoxBounds: TRect;
begin
  ABoxBounds := Box.ActualSizeBounds;
  Result.Init(Min(APoint.X, ABoxBounds.Right - 1),
    Min(APoint.Y, ABoxBounds.Bottom - 1), ABoxBounds.Right, ABoxBounds.Bottom);
end;

function TdxRectangularObjectTopLeftHotZone.CalculateOffsetCore
...
function TdxRectangularObjectTopLeftHotZone.ForceKeepOriginalAspectRatio
  (const ABounds: TRect; ADesiredWidth: Integer;
  ADesiredHeight: Integer): TRect;
begin
  Result.InitSize(ABounds.Right - ADesiredWidth,
    ABounds.Bottom - ADesiredHeight, ADesiredWidth, ADesiredHeight);
end;

procedure TdxRectangularObjectTopLeftHotZone.Accept(const AVisitor
  : IdxRectangularObjectHotZoneVisitor);
begin
  AVisitor.Visit(Self);
end;
...
function TdxRectangularObjectBottomRightHotZone.CreateValidBoxBoundsCore
  (const APoint: TPoint): TRect;
var
  ABoxBounds: TRect;
begin
  ABoxBounds := Box.ActualSizeBounds;
  Result.Init(ABoxBounds.Left, ABoxBounds.Top,
    Math.Max(APoint.X, ABoxBounds.Left + 1),
    Math.Max(APoint.Y, ABoxBounds.Top + 1));
end;

function TdxRectangularObjectBottomRightHotZone.CalculateOffsetCore
  (const APoint: TPoint): TPoint;
var
  ABoxBounds: TRect;
begin
...
function TdxRectangularObjectBottomRightHotZone.ForceKeepOriginalAspectRatio
  (const ABounds: TRect; ADesiredWidth: Integer;
  ADesiredHeight: Integer): TRect;
begin
...
procedure TdxRectangularObjectBottomRightHotZone.Accept(const AVisitor
  : IdxRectangularObjectHotZoneVisitor);
begin
  AVisitor.Visit(Self);
end;
...
function TdxRectangularObjectTopRightHotZone.CreateValidBoxBoundsCore
  (const APoint: TPoint): TRect;
var
  ABoxBounds: TRect;
begin
  ABoxBounds := Box.ActualSizeBounds;
  Result.Init(ABoxBounds.Left, Math.Min(APoint.Y, ABoxBounds.Bottom - 1),
    Math.Max(APoint.X, ABoxBounds.Left + 1), ABoxBounds.Bottom);
end;

function TdxRectangularObjectTopRightHotZone.CalculateOffsetCore
  (const APoint: TPoint): TPoint;
var
  ABoxBounds: TRect;
begin
...
function TdxRectangularObjectTopRightHotZone.ForceKeepOriginalAspectRatio
  (const ABounds: TRect; ADesiredWidth: Integer;
  ADesiredHeight: Integer): TRect;
begin
  Result.InitSize(ABounds.Left, ABounds.Bottom - ADesiredHeight, ADesiredWidth,
    ADesiredHeight);
end;

procedure TdxRectangularObjectTopRightHotZone.Accept(const AVisitor
  : IdxRectangularObjectHotZoneVisitor);
begin
  AVisitor.Visit(Self);
end;
...
function TdxRectangularObjectBottomLeftHotZone.CreateValidBoxBoundsCore
  (const APoint: TPoint): TRect;
var
  ABoxBounds: TRect;
begin
  ABoxBounds := Box.ActualSizeBounds;
  Result.Init(Min(APoint.X, ABoxBounds.Right - 1), ABoxBounds.Top,
    ABoxBounds.Right, Max(APoint.Y, ABoxBounds.Top + 1));
end;

function TdxRectangularObjectBottomLeftHotZone.CalculateOffsetCore
  (const APoint: TPoint): TPoint;
var
  ABoxBounds: TRect;
begin
...
function TdxRectangularObjectBottomLeftHotZone.ForceKeepOriginalAspectRatio
  (const ABounds: TRect; ADesiredWidth: Integer;
  ADesiredHeight: Integer): TRect;
begin
  Result.InitSize(ABounds.Right - ADesiredWidth, ABounds.Top, ADesiredWidth,
    ADesiredHeight);
end;

procedure TdxRectangularObjectBottomLeftHotZone.Accept(const AVisitor
  : IdxRectangularObjectHotZoneVisitor);
begin
  AVisitor.Visit(Self);
end;
...
function TdxRectangularObjectTopMiddleHotZone.CreateValidBoxBoundsCore
  (const APoint: TPoint): TRect;
var
  ABoxBounds: TRect;
begin
  ABoxBounds := Box.ActualSizeBounds;
  Result.Init(ABoxBounds.Left, Min(APoint.Y, ABoxBounds.Bottom - 1),
    ABoxBounds.Right, ABoxBounds.Bottom);
end;

function TdxRectangularObjectTopMiddleHotZone.CalculateOffsetCore
  (const APoint: TPoint): TPoint;
var
  ABoxBounds: TRect;
begin
...
procedure TdxRectangularObjectTopMiddleHotZone.Accept(const AVisitor
  : IdxRectangularObjectHotZoneVisitor);
begin
  AVisitor.Visit(Self);
end;
...
function TdxRectangularObjectBottomMiddleHotZone.CreateValidBoxBoundsCore
  (const APoint: TPoint): TRect;
var
  ABoxBounds: TRect;
begin
  ABoxBounds := Box.ActualSizeBounds;
  Result.Init(ABoxBounds.Left, ABoxBounds.Top, ABoxBounds.Right,
    Max(APoint.Y, ABoxBounds.Top + 1));
end;

function TdxRectangularObjectBottomMiddleHotZone.CalculateOffsetCore
  (const APoint: TPoint): TPoint;
var
  ABoxBounds: TRect;
begin
...
procedure TdxRectangularObjectBottomMiddleHotZone.Accept(const AVisitor
  : IdxRectangularObjectHotZoneVisitor);
begin
  AVisitor.Visit(Self);
end;
...
function TdxRectangularObjectMiddleLeftHotZone.CreateValidBoxBoundsCore
  (const APoint: TPoint): TRect;
var
  ABoxBounds: TRect;
begin
...
function TdxRectangularObjectMiddleLeftHotZone.CalculateOffsetCore
  (const APoint: TPoint): TPoint;
var
  ABoxBounds: TRect;
begin
...
procedure TdxRectangularObjectMiddleLeftHotZone.Accept(const AVisitor
  : IdxRectangularObjectHotZoneVisitor);
begin
  AVisitor.Visit(Self);
end;
...
function TdxRectangularObjectMiddleRightHotZone.CreateValidBoxBoundsCore
  (const APoint: TPoint): TRect;
var
  ABoxBounds: TRect;
begin
...
function TdxRectangularObjectMiddleRightHotZone.CalculateOffsetCore
  (const APoint: TPoint): TPoint;
var
  ABoxBounds: TRect;
begin
...
procedure TdxRectangularObjectMiddleRightHotZone.Accept(const AVisitor
  : IdxRectangularObjectHotZoneVisitor);
begin
  AVisitor.Visit(Self);
end;
...
procedure TdxRectangularObjectRotationHotZone.Activate
  (AController: TdxRichEditCustomMouseController;
...
function TdxRectangularObjectRotationHotZone.CreateValidBoxBoundsCore
  (const APoint: TPoint): TRect;
begin
  Result := Box.ActualSizeBounds;
end;

function TdxRectangularObjectRotationHotZone.CalculateOffsetCore
  (const APoint: TPoint): TPoint;
var
...
function TdxRectangularObjectRotationHotZone.ForceKeepOriginalAspectRatio
  (const ABounds: TRect; ADesiredWidth: Integer;
  ADesiredHeight: Integer): TRect;
begin
  Result := ABounds;
...
procedure TdxRectangularObjectRotationHotZone.Accept(const AVisitor
  : IdxRectangularObjectHotZoneVisitor);
begin
  AVisitor.Visit(Self);
end;
