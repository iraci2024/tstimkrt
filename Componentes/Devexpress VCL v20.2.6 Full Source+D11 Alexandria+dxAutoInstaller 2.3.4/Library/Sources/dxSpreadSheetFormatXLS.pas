...
{$ENDIF}
  ...
  SysUtils, Math, Graphics, dxCore,
  dxSpreadSheetFormulas, dxSpreadSheetCore, dxSpreadSheetUtils,
  dxSpreadSheetTypes;
...
const
  ErrorCodeToErrorIndex: array [TdxSpreadSheetFormulaErrorCode] of Byte = (0, 0,
    7, 15, 23, 29, 36, 42);
...
uses
  dxSpreadSheetFormatXLSReader, dxSpreadSheetFormatXLSWriter,
  dxSpreadSheetFormatXLSTypes, dxOLEDocument;
...
class function TdxSpreadSheetXLSFormat.CanReadFromStream
...
class function TdxSpreadSheetXLSFormat.GetReader
  : TdxSpreadSheetCustomReaderClass;
begin
  Result := TdxSpreadSheetXLSReader;
end;

class function TdxSpreadSheetXLSFormat.GetWriter
