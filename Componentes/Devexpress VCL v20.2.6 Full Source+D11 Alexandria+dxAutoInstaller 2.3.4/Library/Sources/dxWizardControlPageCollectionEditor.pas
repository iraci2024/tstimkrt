...
function ExecutePageCollectionEditor(AWizardControl: TdxCustomWizardControl;
...
procedure TdxWizardControlPageCollectionEditorForm.acAddExecute
  (Sender: TObject);
begin
...
procedure TdxWizardControlPageCollectionEditorForm.acDeleteExecute
  (Sender: TObject);
begin
...
procedure TdxWizardControlPageCollectionEditorForm.acMoveUpExecute
  (Sender: TObject);
var
  I: Integer;
begin
...
function TdxWizardControlPageCollectionEditorForm.GetPageName
  (APage: TdxWizardControlCustomPage): string;
begin
  Result := Format('%s [%s]', [APage.Name, APage.Header.Title]);
end;

procedure TdxWizardControlPageCollectionEditorForm.acMoveDownExecute
  (Sender: TObject);
var
  I: Integer;
begin
...
procedure TdxWizardControlPageCollectionEditorForm.lbPagesClick
  (Sender: TObject);
begin
...
begin
  ...
  try
    ...
    for I := 0 to WizardControl.PageCount - 1 do
      lbPages.AddItem(GetPageName(WizardControl.Pages[I]),
        WizardControl.Pages[I]);
  finally
    lbPages.Items.EndUpdate;
    UpdateActionsState;
  end;
...
begin
  ...
  acMoveDown.Enabled := AHasSelection and not lbPages.Selected
    [lbPages.Count - 1];
